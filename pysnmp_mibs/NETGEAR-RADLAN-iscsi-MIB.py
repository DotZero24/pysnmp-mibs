# SNMP MIB module (NETGEAR-RADLAN-iscsi-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-iscsi-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:25:52 2025
...
rlIscsiSnoopQosEntry = _RlIscsiSnoopQosEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 126, 3, 1)
)
rlIscsiSnoopQosEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopQosKey"),
)
if mibBuilder.loadTexts:
...
rlIscsiSnoopTargetConfigEntry = _RlIscsiSnoopTargetConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 126, 4, 1)
)
rlIscsiSnoopTargetConfigEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopTargetConfigTcpPort"),
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopTargetConfigAddr"),
)
if mibBuilder.loadTexts:
...
rlIscsiSnoopTargetNameEntry = _RlIscsiSnoopTargetNameEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 126, 5, 1)
)
rlIscsiSnoopTargetNameEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopTargetNameId"),
)
if mibBuilder.loadTexts:
...
rlIscsiSnoopInitiatorNameEntry = _RlIscsiSnoopInitiatorNameEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 126, 6, 1)
)
rlIscsiSnoopInitiatorNameEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopInitiatorNameId"),
)
if mibBuilder.loadTexts:
...
rlIscsiSnoopSessionEntry = _RlIscsiSnoopSessionEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 126, 7, 1)
)
rlIscsiSnoopSessionEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopTargetNameId"),
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopInitiatorNameId"),
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopSessionISID"),
)
if mibBuilder.loadTexts:
...
rlIscsiSnoopConnectionEntry = _RlIscsiSnoopConnectionEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 126, 8, 1)
)
rlIscsiSnoopConnectionEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopTargetNameId"),
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopInitiatorNameId"),
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopSessionISID"),
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopConnectionTargetAddr"),
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopConnectionTargetPort"),
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopConnectionInitiatorAddr"),
    (0, "NETGEAR-RADLAN-iscsi-MIB", "rlIscsiSnoopConnectionInitiatorPort"),
)
if mibBuilder.loadTexts:
...
rlIscsiSnoopConnectionExpiryTime = _RlIscsiSnoopConnectionExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 126, 8, 1, 10),
...
rlIscsiSnoopConnectionCounterIndex = _RlIscsiSnoopConnectionCounterIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 126, 8, 1, 11),
