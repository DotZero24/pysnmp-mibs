...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/adva/F3-AMP-MIB
...
IpSourceAddrType, IpManagementTunnelEncapsulationType, IpManagementTunnelType = mibBuilder.importSymbols("CM-IP-MIB", "IpSourceAddrType", "IpManagementTunnelEncapsulationType", "IpManagementTunnelType")
...
mibBuilder.exportSymbols("F3-AMP-MIB", f3AmpStatsProvDataTx=f3AmpStatsProvDataTx, f3AmpConfigStatus=f3AmpConfigStatus, f3AmpStatsConfigSuccessTx=f3AmpStatsConfigSuccessTx, f3AmpConfigRemTunnelRip2PktsEnabled=f3AmpConfigRemTunnelRip2PktsEnabled, f3AmpGroups=f3AmpGroups, f3AmpConfigRemTunnelEncapType=f3AmpConfigRemTunnelEncapType, f3AmpConfigGroup=f3AmpConfigGroup, f3AmpCompliances=f3AmpCompliances, f3AmpStatsObjects=f3AmpStatsObjects, f3AmpStatsTxTimeStamp=f3AmpStatsTxTimeStamp, f3AmpConfigRemTunnelMtu=f3AmpConfigRemTunnelMtu, f3AmpConfigRowStatus=f3AmpConfigRowStatus, f3AmpConfigRole=f3AmpConfigRole, f3AmpConfigEnabled=f3AmpConfigEnabled, f3AmpConfigRemSysName=f3AmpConfigRemSysName, f3AmpConfigRemSysSNMPV1IfName=f3AmpConfigRemSysSNMPV1IfName, f3AmpConfigRemTunnelIpMask=f3AmpConfigRemTunnelIpMask, f3AmpStatsLastTxStatus=f3AmpStatsLastTxStatus, f3AmpConfigRemTunnelBufferSize=f3AmpConfigRemTunnelBufferSize, f3AmpConfigRemSysIpMask=f3AmpConfigRemSysIpMask, f3AmpConfigRemTunnelSVlanIdEnabled=f3AmpConfigRemTunnelSVlanIdEnabled, f3AmpConfigRemTunnelCOS=f3AmpConfigRemTunnelCOS, f3AmpCompliance=f3AmpCompliance, f3AmpConformance=f3AmpConformance, f3AmpConfigTable=f3AmpConfigTable, f3AmpConfigEntry=f3AmpConfigEntry, f3AmpConfigRemSysDefGateway=f3AmpConfigRemSysDefGateway, f3AmpStatsSpuriousMessageRx=f3AmpStatsSpuriousMessageRx, f3AmpStatsTable=f3AmpStatsTable, AMPRole=AMPRole, f3AmpStatsProvRequestRx=f3AmpStatsProvRequestRx, f3AmpConfigRemTunnelName=f3AmpConfigRemTunnelName, AMPConfigStatus=AMPConfigStatus, f3AmpStatsEntry=f3AmpStatsEntry, f3AmpStatsProvDataRx=f3AmpStatsProvDataRx, f3AmpStatsConfigFailTx=f3AmpStatsConfigFailTx, f3AmpConfigIndex=f3AmpConfigIndex, PYSNMP_MODULE_ID=f3AMPMIB, AMPStatus=AMPStatus, AMPConfigAction=AMPConfigAction, f3AmpConfigRemSysIpAddr=f3AmpConfigRemSysIpAddr, f3AmpStatsLastRxStatus=f3AmpStatsLastRxStatus, f3AmpStatsGroup=f3AmpStatsGroup, f3AmpStatsTimeoutRx=f3AmpStatsTimeoutRx, f3AMPMIB=f3AMPMIB, f3AmpConfigRemTunnelType=f3AmpConfigRemTunnelType, AMPProtocol=AMPProtocol, f3AmpConfigRemSysSrcIpAddrType=f3AmpConfigRemSysSrcIpAddrType, f3AmpStatsProvRequestTx=f3AmpStatsProvRequestTx, f3AmpStatsRxTimeStamp=f3AmpStatsRxTimeStamp, f3AmpConfigProtocol=f3AmpConfigProtocol, f3AmpConfigObjects=f3AmpConfigObjects, f3AmpConfigRemTunnelIpAddr=f3AmpConfigRemTunnelIpAddr, f3AmpStatsConfigFailRx=f3AmpStatsConfigFailRx, f3AmpConfigRemTunnelEIR=f3AmpConfigRemTunnelEIR, f3AmpConfigRemSysSrcIpAddrIfName=f3AmpConfigRemSysSrcIpAddrIfName, f3AmpConfigRemTunnelSVlanId=f3AmpConfigRemTunnelSVlanId, f3AmpConfigRemTunnelCIR=f3AmpConfigRemTunnelCIR, f3AmpConfigRemTunnelVlanId=f3AmpConfigRemTunnelVlanId, f3AmpConfigPort=f3AmpConfigPort, f3AmpConfigRemTunnelIndex=f3AmpConfigRemTunnelIndex, f3AmpConfigAction=f3AmpConfigAction, f3AmpConfigStorageType=f3AmpConfigStorageType, f3AmpStatsConfigSuccessRx=f3AmpStatsConfigSuccessRx)
