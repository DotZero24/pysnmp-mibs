...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-PROTOCOL-VLAN-MIB
...
h3cProtocolVlanCompliance.setObjects(
      *(("A3COM-HUAWEI-PROTOCOL-VLAN-MIB", "h3cProtocolVlanOperateGroup"),
        ("A3COM-HUAWEI-PROTOCOL-VLAN-MIB", "h3cProtocolVlanProtocolGroup"),
        ("A3COM-HUAWEI-PROTOCOL-VLAN-MIB", "h3cProtocolVlanPortGroup"))
)
if mibBuilder.loadTexts:
