#
# PySNMP MIB module LJ3530mfp-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/LJ3530mfp-MIB
...
deviceChannelTable = MibIdentifier((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 7, 2))
deviceChannelEntry = MibIdentifier((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 7, 2, 1))
...
print_internal_page = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 5, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 7, 8, 9, 100, 101, 250, 253, 254, 255, 256, 257, 258, 259, 260, 261, 350, 450))).clone(namedValues=NamedValues(("eNotPrintingAnInternalPage", 1), ("ePrintingAnUnknownInternalPage", 2), ("eDeviceDemoPage1ConfigurationPage", 3), ("eDeviceDemoPage2", 4), ("eDeviceDemoPage5ErrorLog", 7), ("eDeviceDemoPage6FileSystemDirectoryListing", 8), ("eDeviceDemoPage7MenuMap", 9), ("ePrintUsagePage", 100), ("eSuppliesPage", 101), ("eDeviceADFAdjustmentPages", 250), ("eDeviceCleaningPage", 253), ("eDevicePaperPathTest", 254), ("eDevicePageRegistrationPage", 255), ("ePrintQualityPages", 256), ("eHighVoltageTestPage", 257), ("eColorPaletteRGBPage", 258), ("eColorPaletteCMYKPage", 259), ("eDevicePageDiagnosticsPage", 260), ("eDevicePageStoredJobsPage", 261), ("ePCLFontList1", 350), ("ePSFontList", 450)))).setLabel("print-internal-page").setMaxAccess("readwrite")
...
default_media_size = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 3, 3, 1, 13), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 10, 15, 24, 25, 26, 33, 34, 38, 44, 45, 72, 74, 75, 80, 81, 90, 91, 92, 100, 101, 102, 32767))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eFoolscap", 10), ("eStatement", 15), ("eISOandJISA6", 24), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("ePRC8K270X390", 33), ("ePRC16K195X270", 34), ("eISOSRA3", 38), ("eJISB6", 44), ("eJISB5", 45), ("eJapanesePostcardDouble", 72), ("eIndexCard4x6", 74), ("eIndexCard5x8", 75), ("eMonarch", 80), ("eCommercial10", 81), ("eInternationalDL", 90), ("eInternationalC5", 91), ("eInternationalC6", 92), ("eInternationalB5", 100), ("eCustom", 101), ("eEnvelope9", 102), ("eUnknownMediaSize", 32767)))).setLabel("default-media-size").setMaxAccess("readwrite")
...
default_copier_image_type = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 1, 10), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("eText", 1), ("eGraphic", 2), ("eMixed", 3), ("ePhotograph", 4)))).setLabel("default-copier-image-type").setMaxAccess("readwrite")
...
job_info_accounting_media_size = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 28, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 10, 11, 15, 17, 18, 19, 24, 25, 26, 27, 33, 34, 35, 44, 45, 46, 65, 71, 72, 74, 75, 80, 81, 89, 90, 91, 92, 100, 101, 102, 257, 258, 281, 282, 301, 32765, 32767))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eFoolscap", 10), ("eLedger", 11), ("eStatementPaper", 15), ("eROC16K", 17), ("eJISExecutive", 18), ("eROC8K", 19), ("eISOandJISA6", 24), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eISOandJISA3", 27), ("eSize8K270x390", 33), ("eSize16K195x270", 34), ("eSize8K260x368", 35), ("eJISB6", 44), ("eJISB5", 45), ("eJISB4", 46), ("eISOB5", 65), ("eJapanesePostcardSingle", 71), ("eJapansePostcardDouble", 72), ("eFourBySixIndexCard", 74), ("eFiveByEightIndexCard", 75), ("eMonarch", 80), ("eCommercial10", 81), ("eSize16K184x260", 89), ("eInternationalDL", 90), ("eInternationalC5", 91), ("eInternationalC6", 92), ("eInternationalB5", 100), ("eCustom", 101), ("eEnvelope9", 102), ("eUSExecutiveR", 257), ("eUSLetterR", 258), ("eISOandJISA5R", 281), ("eISOandJISA4R", 282), ("eJISB5R", 301), ("eAnySize", 32765), ("eUnknownMediaSize", 32767)))).setLabel("job-info-accounting-media-size").setMaxAccess("readonly")
...
held_job_set_queue_size = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 7, 2, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 300))).setLabel("held-job-set-queue-size").setMaxAccess("readwrite")
...
override_a4_with_letter = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 1, 74), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("eMenusNO", 1), ("eMenusYES", 2)))).setLabel("override-a4-with-letter").setMaxAccess("readwrite")
if mibBuilder.loadTexts: override_a4_with_letter.setStatus('optional')
...
override_media_size = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 11, 34, 33, 18, 25, 26, 27, 45, 46, 65, 72, 80, 81, 90, 91, 100, 101, 258, 282, 32767))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eLedger", 11), ("ePRC16K195X270", 34), ("ePRC8K270X390", 33), ("eJISExecutive", 18), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eISOandJISA3", 27), ("eJISB5", 45), ("eJISB4", 46), ("eISOB5", 65), ("eJapanesePostcardDouble", 72), ("eMonarch", 80), ("eCommercial10", 81), ("eInternationalDL", 90), ("eInternationalC5", 91), ("eInternationalB5", 100), ("eCustom", 101), ("eUSLetterR", 258), ("eISOandJISA4R", 282), ("eUnknownMediaSize", 32767)))).setLabel("override-media-size").setMaxAccess("readwrite")
...
tray1_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 10, 15, 25, 26, 45, 72, 80, 81, 90, 91, 100, 101, 32764, 32765))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eFoolscap", 10), ("eStatement", 15), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45), ("eJapansePostcardDouble", 72), ("eMonarch", 80), ("eCommercial10", 81), ("eInternationalDL", 90), ("eInternationalC5", 91), ("eInternationalB5", 100), ("eCustom", 101), ("eAnyCustomSize", 32764), ("eAnySize", 32765)))).setLabel("tray1-media-size-loaded").setMaxAccess("readwrite")
...
tray2_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 2, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 34, 25, 26, 45, 101, 32764))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("ePRC16K195X270", 34), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45), ("eCustom", 101), ("eAnyCustomSize", 32764)))).setLabel("tray2-media-size-loaded").setMaxAccess("readwrite")
...
tray3_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 3, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 10, 34, 25, 26, 45, 101, 32764))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eFoolscap", 10), ("ePRC16K195X270", 34), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45), ("eCustom", 101), ("eAnyCustomSize", 32764)))).setLabel("tray3-media-size-loaded").setMaxAccess("readwrite")
...
media24_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 24, 1), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 54))).setLabel("media24-name").setMaxAccess("readwrite")
if mibBuilder.loadTexts: media24_name.setStatus('optional')
media24_short_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 24, 2), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 36))).setLabel("media24-short-name").setMaxAccess("readwrite")
...
media25_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 25, 1), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 54))).setLabel("media25-name").setMaxAccess("readwrite")
if mibBuilder.loadTexts: media25_name.setStatus('optional')
media25_short_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 25, 2), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 36))).setLabel("media25-short-name").setMaxAccess("readwrite")
...
media26_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 26, 1), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 54))).setLabel("media26-name").setMaxAccess("readwrite")
if mibBuilder.loadTexts: media26_name.setStatus('optional')
media26_short_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 26, 2), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 36))).setLabel("media26-short-name").setMaxAccess("readwrite")
...
media27_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 27, 1), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 54))).setLabel("media27-name").setMaxAccess("readwrite")
if mibBuilder.loadTexts: media27_name.setStatus('optional')
media27_short_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 27, 2), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 36))).setLabel("media27-short-name").setMaxAccess("readwrite")
...
media27_engine_media_mode = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 27, 4), Integer32()).setLabel("media27-engine-media-mode").setMaxAccess("readwrite")
if mibBuilder.loadTexts: media27_engine_media_mode.setStatus('optional')
media28_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 28, 1), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 54))).setLabel("media28-name").setMaxAccess("readwrite")
if mibBuilder.loadTexts: media28_name.setStatus('optional')
media28_short_name = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 28, 2), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 36))).setLabel("media28-short-name").setMaxAccess("readwrite")
...
media28_engine_media_mode = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 8, 3, 28, 4), Integer32()).setLabel("media28-engine-media-mode").setMaxAccess("readwrite")
...
cartridge_adaptive_gain_reset = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 1, 37), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("eFalse", 1), ("eTrue", 2)))).setLabel("cartridge-adaptive-gain-reset").setMaxAccess("writeonly")
...
consumable_status_toner_low_sensing_level = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 99), Integer32()).setLabel("consumable-status-toner-low-sensing-level").setMaxAccess("readonly")
if mibBuilder.loadTexts: consumable_status_toner_low_sensing_level.setStatus('optional')
...
firmware_download_current_state = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 18, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))).clone(namedValues=NamedValues(("eIdle", 1), ("eReceivingImage", 2), ("eReceivedImageError", 3), ("eVerifyingImage", 4), ("eVerifiedImageError", 5), ("eWritingImage", 6), ("eWritingImageError", 7), ("eDownloadComplete", 8)))).setLabel("firmware-download-current-state").setMaxAccess("readonly")
...
mibBuilder.exportSymbols("LJ3530mfp-MIB", mio1_type=mio1_type, dm=dm, media27_short_name=media27_short_name, media20=media20, error50_date_time=error50_date_time, error46_date_time=error46_date_time, DisplayString=DisplayString, media4_page_count=media4_page_count, error38_time_stamp=error38_time_stamp, total_kilo_pixels_per_cartridge=total_kilo_pixels_per_cartridge, media10_short_name=media10_short_name, error31_code=error31_code, media24_page_count=media24_page_count, error22=error22, postscript_total_page_count=postscript_total_page_count, settings_web_server=settings_web_server, media1=media1, media1_page_count=media1_page_count, error35_time_stamp=error35_time_stamp, media6_short_name=media6_short_name, media9=media9, error25_code=error25_code, usage_staple_count=usage_staple_count, error2_code=error2_code, scan_to_folder_count=scan_to_folder_count, destination_subsystem=destination_subsystem, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, web_server_url=web_server_url, error23_code=error23_code, clearable_warning=clearable_warning, job_info_attr_12=job_info_attr_12, firmware_download_write_status_supported=firmware_download_write_status_supported, service_id=service_id, north_edge_offset=north_edge_offset, channelprinteralert=channelprinteralert, printed_media_dimplex_count=printed_media_dimplex_count, error11=error11, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, error32_date_time=error32_date_time, interface=interface, default_scan_image_quality=default_scan_image_quality, consumable_status_tls_max_value=consumable_status_tls_max_value, ph=ph, error44_time_stamp=error44_time_stamp, error47_time_stamp=error47_time_stamp, held_job_security=held_job_security, error33_code=error33_code, error43=error43, settings_outbin=settings_outbin, tray3_media_size_loaded=tray3_media_size_loaded, error35_date_time=error35_date_time, media16_short_name=media16_short_name, print_meter=print_meter, firmware_download_name=firmware_download_name, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, media8=media8, held_job_delete=held_job_delete, job_info_pages_printed=job_info_pages_printed, error5_time_stamp=error5_time_stamp, error18_date_time=error18_date_time, usb_driver_name=usb_driver_name, usb_device_kind=usb_device_kind, tray2_phd=tray2_phd, job_info_physical_outbins_used=job_info_physical_outbins_used, media16_engine_media_mode=media16_engine_media_mode, cartridge_out_override_control=cartridge_out_override_control, on_off_line=on_off_line, status_scanner=status_scanner, default_scanner_speed=default_scanner_speed, error40_code=error40_code, color_copy_enabled=color_copy_enabled, media2_engine_media_mode=media2_engine_media_mode, printer_cal_customiq_factory_default=printer_cal_customiq_factory_default, error14_time_stamp=error14_time_stamp, media6_name=media6_name, simm2_bank1_capacity=simm2_bank1_capacity, settings_copier=settings_copier, pdl_pcl=pdl_pcl, print_internal_page=print_internal_page, supply_out_action_support=supply_out_action_support, job_info_accounting_black_dots=job_info_accounting_black_dots, daylight_savings_end=daylight_savings_end, spooler=spooler, intray=intray, override_media_name=override_media_name, consumable_pages_printed_with_supply=consumable_pages_printed_with_supply, rpc_bound_protocol_address=rpc_bound_protocol_address, default_vmi=default_vmi, consumable_string_information_reset=consumable_string_information_reset, marking_agent_highlights_density_setting=marking_agent_highlights_density_setting, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, device_name=device_name, error35=error35, default_staple_mode=default_staple_mode, mopy_mode=mopy_mode, channel_io_errors=channel_io_errors, device_used_while_cartridge_out_override_active=device_used_while_cartridge_out_override_active, background_status_msg_higher_priority=background_status_msg_higher_priority, job_input_auto_continue_mode=job_input_auto_continue_mode, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, error37_time_stamp=error37_time_stamp, error48=error48, simm1_bank1=simm1_bank1, settings_print_media=settings_print_media, mio1_manufacturing_info=mio1_manufacturing_info, media_info=media_info, media_names_available=media_names_available, media21_name=media21_name, media26_name=media26_name, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, media23_engine_media_mode=media23_engine_media_mode, channel_bytes_sent=channel_bytes_sent, settings_system=settings_system, printed_media_simplex_count=printed_media_simplex_count, source_tray_usage_count=source_tray_usage_count, error50=error50, default_copy_reset_timeout=default_copy_reset_timeout, usb_serial_number=usb_serial_number, autocleaning_page_frequency=autocleaning_page_frequency, destination_bin_usage_total=destination_bin_usage_total, channelEntry=channelEntry, printer_calibration_cpr=printer_calibration_cpr, error9_date_time=error9_date_time, error12_time_stamp=error12_time_stamp, page_frame_memory_available=page_frame_memory_available, form_feed_needed=form_feed_needed, upgradable_devices_version=upgradable_devices_version, channel_mio=channel_mio, marker_density_calibration=marker_density_calibration, ram_disk_mode=ram_disk_mode, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, held_job_pin=held_job_pin, custom_paper_feed_dim=custom_paper_feed_dim, error5_code=error5_code, media22_short_name=media22_short_name, settings_file_system=settings_file_system, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, error15_date_time=error15_date_time, media7_engine_media_mode=media7_engine_media_mode, error42_date_time=error42_date_time, media7_short_name=media7_short_name, media17_name=media17_name, error15=error15, media6_engine_media_mode=media6_engine_media_mode, error29_date_time=error29_date_time, error44=error44, resource_manager=resource_manager, error25_time_stamp=error25_time_stamp, tray1_media_size_loaded=tray1_media_size_loaded, printed_modes_accounting=printed_modes_accounting, control_panel_button_press=control_panel_button_press, default_copy_duplex_mode=default_copy_duplex_mode, error14_date_time=error14_date_time, engine_media_modes_supported1=engine_media_modes_supported1, media19_engine_media_mode=media19_engine_media_mode, error13_time_stamp=error13_time_stamp, error1=error1, consumables_life=consumables_life, error7=error7, job_input_auto_continue_timeout=job_input_auto_continue_timeout, print_engine_revision=print_engine_revision, usb=usb, simm=simm, media14=media14, scan_sharpening_coefficient=scan_sharpening_coefficient, settings_marking_agent=settings_marking_agent, device=device, error42=error42, mio1_model_name=mio1_model_name, error8_time_stamp=error8_time_stamp, error49_time_stamp=error49_time_stamp, mono_color_switching_mode=mono_color_switching_mode, faxjob_tx_count=faxjob_tx_count, held_job_user_name=held_job_user_name, printer_cal_cpr_page_count=printer_cal_cpr_page_count, cartridge_adaptive_gain_reset=cartridge_adaptive_gain_reset, media9_engine_media_mode=media9_engine_media_mode, default_scan_job_mode=default_scan_job_mode, finisher_image_rotation=finisher_image_rotation, background_message1=background_message1, error20=error20, operating_system=operating_system, job_info_accounting_finishing_options=job_info_accounting_finishing_options, port1_parallel_bidirectionality=port1_parallel_bidirectionality, total_color_page_count=total_color_page_count, default_scan_original_size=default_scan_original_size, rtc_time_zone=rtc_time_zone, media15_name=media15_name, error2=error2, media28_page_count=media28_page_count, active_print_jobs=active_print_jobs, source_tray_accounting=source_tray_accounting, pjl=pjl, printed_media_color_duplex_count=printed_media_color_duplex_count, usage_instructions_line4=usage_instructions_line4, status_mass_storage_bd=status_mass_storage_bd, error10_time_stamp=error10_time_stamp, first_copy_speed=first_copy_speed, error39_time_stamp=error39_time_stamp, error11_code=error11_code, mio4_manufacturing_info=mio4_manufacturing_info, error26_date_time=error26_date_time, simm1_bank2=simm1_bank2, media12_engine_media_mode=media12_engine_media_mode, web_server_security=web_server_security, error49_code=error49_code, cancel_job=cancel_job, held_job_print=held_job_print, control_panel_display_graphical_contents=control_panel_display_graphical_contents, outbin1=outbin1, media1_name=media1_name, copier_media_type=copier_media_type, fax_number_confirmation=fax_number_confirmation, consumables_status=consumables_status, error3_date_time=error3_date_time, usage_instructions_line3=usage_instructions_line3, media10=media10, error22_time_stamp=error22_time_stamp, error11_date_time=error11_date_time, media11_short_name=media11_short_name, consumable_status_web_service_access_control=consumable_status_web_service_access_control, job_output_auto_continue_timeout=job_output_auto_continue_timeout, error30=error30, scanner_accessory_adf_two_sided_sheet_count=scanner_accessory_adf_two_sided_sheet_count, scanner=scanner, media18=media18, error50_code=error50_code, marking_agent_midtones_density_setting=marking_agent_midtones_density_setting, io_switch=io_switch, error4_time_stamp=error4_time_stamp, error19_code=error19_code, copy_job_hold_off_print_jobs=copy_job_hold_off_print_jobs, error39_code=error39_code, override_a4_with_letter=override_a4_with_letter, mio4_model_name=mio4_model_name, tray1_phd=tray1_phd, error21=error21, media4=media4, error39_date_time=error39_date_time, remote_upgrade_enable=remote_upgrade_enable, copier=copier, file_systems=file_systems, error31_date_time=error31_date_time, error2_time_stamp=error2_time_stamp, error15_code=error15_code, error4_date_time=error4_date_time, consumable_status_web_service_access_data=consumable_status_web_service_access_data, consumable_reorder_url=consumable_reorder_url, scanner_accessory_digital_send_log_event_counter=scanner_accessory_digital_send_log_event_counter, duplex_page_count=duplex_page_count, media21_page_count=media21_page_count, media4_name=media4_name, usb_manufacturer_name=usb_manufacturer_name)
mibBuilder.exportSymbols("LJ3530mfp-MIB", device_system=device_system, background_status_msg_line3_part1=background_status_msg_line3_part1, media4_engine_media_mode=media4_engine_media_mode, upgradable_devices_current_state=upgradable_devices_current_state, media3_name=media3_name, media5_short_name=media5_short_name, media26=media26, media13_engine_media_mode=media13_engine_media_mode, color_supply_out_action=color_supply_out_action, error9=error9, mio=mio, media9_short_name=media9_short_name, settings_spooler=settings_spooler, default_media_size=default_media_size, usb_product_id=usb_product_id, media22_name=media22_name, printer_color_accounting=printer_color_accounting, job_info_accounting_scanned_media_simplex_count=job_info_accounting_scanned_media_simplex_count, file_system4_initialize_volume=file_system4_initialize_volume, file_system4=file_system4, error8=error8, error19_time_stamp=error19_time_stamp, hold_job_timeout=hold_job_timeout, firmware_download_version=firmware_download_version, media18_name=media18_name, consumable_status=consumable_status, held_job_enable=held_job_enable, default_copier_collate=default_copier_collate, source_subsystem=source_subsystem, media_modes=media_modes, outbin1_override_mode=outbin1_override_mode, printer_cal_dhalf_utc=printer_cal_dhalf_utc, error37_date_time=error37_date_time, media28_name=media28_name, background_message2=background_message2, settings_mass_storage_bd=settings_mass_storage_bd, background_status_msg_line2_part1=background_status_msg_line2_part1, default_authentication_timeout=default_authentication_timeout, deviceChannelTable=deviceChannelTable, simm2_bank1=simm2_bank1, default_lines_per_page=default_lines_per_page, media20_name=media20_name, error49_date_time=error49_date_time, job_info_requested_originals=job_info_requested_originals, error17_date_time=error17_date_time, display=display, mass_storage_resources=mass_storage_resources, error34=error34, job_info_accounting_media_type=job_info_accounting_media_type, media7=media7, error23_date_time=error23_date_time, held_job_quantity=held_job_quantity, error17_code=error17_code, default_copies=default_copies, printer_cal_cpr_data=printer_cal_cpr_data, settings_ph=settings_ph, error19=error19, media17=media17, date_display=date_display, job_info_attr_6=job_info_attr_6, error46_code=error46_code, job_info_attr_15=job_info_attr_15, media14_page_count=media14_page_count, error43_time_stamp=error43_time_stamp, install_date=install_date, printed_media_duplex_count=printed_media_duplex_count, localization_languages_supported=localization_languages_supported, printed_modes_usage_total=printed_modes_usage_total, scanner_accessory_total_copy_pages_printed=scanner_accessory_total_copy_pages_printed, error41_date_time=error41_date_time, menus=menus, error3=error3, pcl_total_page_count=pcl_total_page_count, error3_time_stamp=error3_time_stamp, status_prt_eng=status_prt_eng, error8_date_time=error8_date_time, id=id, printed_modes_mono_count=printed_modes_mono_count, consumable_string_information=consumable_string_information, error37=error37, show_address=show_address, printed_media_color_dimplex_count=printed_media_color_dimplex_count, job_info_change_id=job_info_change_id, os_execute_file=os_execute_file, printed_media_color_usage=printed_media_color_usage, daylight_savings_start=daylight_savings_start, media26_page_count=media26_page_count, error36=error36, background_message4=background_message4, auto_continue=auto_continue, media20_short_name=media20_short_name, media3_engine_media_mode=media3_engine_media_mode, cartridge_adaptive_gain=cartridge_adaptive_gain, media21_engine_media_mode=media21_engine_media_mode, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, media2=media2, error26_time_stamp=error26_time_stamp, error16=error16, settings_webserver=settings_webserver, media12_name=media12_name, error45_time_stamp=error45_time_stamp, media18_short_name=media18_short_name, error6_code=error6_code, pcl_default_font_height=pcl_default_font_height, tables=tables, marking_agent_density=marking_agent_density, media10_engine_media_mode=media10_engine_media_mode, channel_bytes_received=channel_bytes_received, error19_date_time=error19_date_time, intray3=intray3, error27_code=error27_code, media9_name=media9_name, scanned_media_duplex_charge=scanned_media_duplex_charge, scan_calibration_error=scan_calibration_error, error25_date_time=error25_date_time, itb_tensioning_status=itb_tensioning_status, error7_time_stamp=error7_time_stamp, control_panel_key_press=control_panel_key_press, media_number_of_type_supported=media_number_of_type_supported, fw_rom_datecode=fw_rom_datecode, faxjob_rx_status=faxjob_rx_status, io=io, default_scan_background_removal=default_scan_background_removal, model_number=model_number, pcl_default_font_width=pcl_default_font_width, simm2_bank2_capacity=simm2_bank2_capacity, printed_modes_color_count=printed_modes_color_count, copy_job_interrupt_copy_jobs=copy_job_interrupt_copy_jobs, error29_code=error29_code, scanned_media_simplex_count=scanned_media_simplex_count, error6_time_stamp=error6_time_stamp, cold_reset_media_size=cold_reset_media_size, media1_short_name=media1_short_name, media24_short_name=media24_short_name, settings_scanner=settings_scanner, error13_date_time=error13_date_time, scanned_media_total_charge=scanned_media_total_charge, printed_media_color_total_count=printed_media_color_total_count, current_job_parsing_id=current_job_parsing_id, error4_code=error4_code, error33_date_time=error33_date_time, override_media_size=override_media_size, scanner_accessory_adf_one_sided_sheet_count=scanner_accessory_adf_one_sided_sheet_count, default_copy_job_chromaticity=default_copy_job_chromaticity, printer_calibration_dhalf=printer_calibration_dhalf, media5_name=media5_name, media13=media13, upgradable_devices=upgradable_devices, printer_cal_dhalf_page_count=printer_cal_dhalf_page_count, errorlog=errorlog, hp=hp, job_info_attr_9=job_info_attr_9, error37_code=error37_code, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, media24_engine_media_mode=media24_engine_media_mode, job_info_stage=job_info_stage, error26=error26, intray2=intray2, duplex_blank_pages=duplex_blank_pages, media14_name=media14_name, simm2_capacity=simm2_capacity, media5=media5, status_fax_proc_sub=status_fax_proc_sub, destination_bin_usage=destination_bin_usage, job=job, default_reset_send_timeout=default_reset_send_timeout, error33=error33, scanner_accessory_digital_send_home_screen_status=scanner_accessory_digital_send_home_screen_status, status_pdl=status_pdl, held_job_control=held_job_control, printed_media_simplex_charge=printed_media_simplex_charge, default_scan_text_graphics_mix=default_scan_text_graphics_mix, settings_io=settings_io, background_status_msg_line1_part1=background_status_msg_line1_part1, scan_calibration_download=scan_calibration_download, usage_printer_total_charge=usage_printer_total_charge, job_info_attr_7=job_info_attr_7, sleep_mode=sleep_mode, background_message3=background_message3, job_info_attr_5=job_info_attr_5, mass_storage_resource_change_counter=mass_storage_resource_change_counter, host_application_available_memory=host_application_available_memory, media15_page_count=media15_page_count, supply_after_out_state=supply_after_out_state, job_info=job_info, remote_procedure_call=remote_procedure_call, error38_date_time=error38_date_time, error28_code=error28_code, error21_time_stamp=error21_time_stamp, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, ram_disk_size=ram_disk_size, default_copier_edge_to_edge=default_copier_edge_to_edge, job_info_accounting_media_size=job_info_accounting_media_size, error42_code=error42_code, media13_page_count=media13_page_count, printer_cal_cpr_utc=printer_cal_cpr_utc, media13_short_name=media13_short_name, simm1_bank1_type=simm1_bank1_type, outbins=outbins, error45_code=error45_code, pysmi_continue=pysmi_continue, consumable_current_state=consumable_current_state, display_status=display_status, error29_time_stamp=error29_time_stamp, scanned_media_duplex_count=scanned_media_duplex_count, printed_modes_total_count=printed_modes_total_count, media20_page_count=media20_page_count, error20_code=error20_code, error_log_clear=error_log_clear, source_tray_usage=source_tray_usage, media3=media3, printed_media_total_charge=printed_media_total_charge, fax_job_scan_count=fax_job_scan_count, ews_request_control_panel_supplies_status=ews_request_control_panel_supplies_status, media25=media25, channeltype=channeltype, control_panel_display=control_panel_display, mio4=mio4, usage_instructions_line1=usage_instructions_line1, media6=media6, media2_short_name=media2_short_name, media11_engine_media_mode=media11_engine_media_mode, media6_page_count=media6_page_count, job_info_attr_3=job_info_attr_3, error31=error31, error35_code=error35_code, media14_engine_media_mode=media14_engine_media_mode, supply_out_user_configured_override2_limit=supply_out_user_configured_override2_limit, job_info_pages_processed=job_info_pages_processed, job_info_outcome=job_info_outcome, accounting=accounting, supplies_replace_action_at_setting=supplies_replace_action_at_setting, error6=error6, media17_engine_media_mode=media17_engine_media_mode, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, error27_date_time=error27_date_time, error47=error47, not_ready_source_scanner=not_ready_source_scanner, media16=media16, error38=error38, channelprotocolversion=channelprotocolversion, media14_short_name=media14_short_name, consumables_1=consumables_1, media_counts=media_counts, printer_accounting=printer_accounting, source_tray_usage_total=source_tray_usage_total, outbin=outbin, energy_star=energy_star, job_info_accounting_job_type=job_info_accounting_job_type, media17_short_name=media17_short_name, error18=error18, file_system=file_system, job_info_attr_8=job_info_attr_8, consumable_status_partnumber=consumable_status_partnumber)
mibBuilder.exportSymbols("LJ3530mfp-MIB", error43_date_time=error43_date_time, error41=error41, media16_name=media16_name, webserver_proc_sub=webserver_proc_sub, engine_parameter=engine_parameter, error41_code=error41_code, deviceChannelEntry=deviceChannelEntry, consumable_notification_status=consumable_notification_status, destination_bin_usage_count=destination_bin_usage_count, printed_media_usage=printed_media_usage, default_media_name=default_media_name, port1=port1, error9_code=error9_code, error5_date_time=error5_date_time, error16_date_time=error16_date_time, media2_page_count=media2_page_count, usb_interface=usb_interface, printer_cal_dhalf_data2=printer_cal_dhalf_data2, status_rpc=status_rpc, remote_upgrade_version_checking_enable=remote_upgrade_version_checking_enable, intray1=intray1, default_custom_paper_dim_unit=default_custom_paper_dim_unit, media1_engine_media_mode=media1_engine_media_mode, usage_printer_color_total_charge=usage_printer_color_total_charge, scanner_accessory_copy_job_scan_count=scanner_accessory_copy_job_scan_count, settings_pdl=settings_pdl, error22_code=error22_code, media23=media23, scanner_accessory_digital_send_config_email_gateway=scanner_accessory_digital_send_config_email_gateway, error12=error12, error1_time_stamp=error1_time_stamp, ports=ports, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, error7_date_time=error7_date_time, firmware_download_write_time=firmware_download_write_time, file_system2=file_system2, mio1=mio1, background_status_msg_line4_part1=background_status_msg_line4_part1, supply_override_activated_date=supply_override_activated_date, error24_time_stamp=error24_time_stamp, job_info_io_source=job_info_io_source, settings_fax_proc_sub=settings_fax_proc_sub, job_info_outbins_used=job_info_outbins_used, scanner_accessory_digital_send_config_dsm_enabled_fax=scanner_accessory_digital_send_config_dsm_enabled_fax, held_job_info=held_job_info, error13_code=error13_code, media12_short_name=media12_short_name, job_info_accounting_scanned_media_duplex_count=job_info_accounting_scanned_media_duplex_count, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, reprint=reprint, test=test, automatic_daylight_savings=automatic_daylight_savings, firmware_download=firmware_download, settings_prt_eng=settings_prt_eng, pdl=pdl, printed_media_duplex_charge=printed_media_duplex_charge, scanner_accessory_flatbed_scan_count=scanner_accessory_flatbed_scan_count, media22_engine_media_mode=media22_engine_media_mode, media27_name=media27_name, fax_proc_sub=fax_proc_sub, file_system_max_open_files=file_system_max_open_files, error38_code=error38_code, web_server=web_server, media_size=media_size, media20_engine_media_mode=media20_engine_media_mode, media19_page_count=media19_page_count, default_copier_contrast=default_copier_contrast, job_info_attribute=job_info_attribute, job_info_attr_13=job_info_attr_13, upgradable_devices_write_time=upgradable_devices_write_time, tray3_phd=tray3_phd, error27_time_stamp=error27_time_stamp, media27_engine_media_mode=media27_engine_media_mode, usb_product_description=usb_product_description, media25_engine_media_mode=media25_engine_media_mode, simm1_bank1_capacity=simm1_bank1_capacity, error48_code=error48_code, media9_page_count=media9_page_count, error50_time_stamp=error50_time_stamp, faxjob_tx_status=faxjob_tx_status, default_copier_image_type=default_copier_image_type, asset_number=asset_number, default_custom_paper_feed_dim=default_custom_paper_feed_dim, printed_media_color_simplex_count=printed_media_color_simplex_count, simm1_bank=simm1_bank, media17_page_count=media17_page_count, simm1_bank2_capacity=simm1_bank2_capacity, media3_page_count=media3_page_count, job_info_attr_16=job_info_attr_16, background_message=background_message, media10_name=media10_name, fax_job_control=fax_job_control, supply_override_activated_pagecount=supply_override_activated_pagecount, media19=media19, error1_date_time=error1_date_time, device_configure=device_configure, io_timeout=io_timeout, media28=media28, default_scan_content_orientation=default_scan_content_orientation, default_mfp_color_space=default_mfp_color_space, scanner_accounting=scanner_accounting, media_types=media_types, supply_override_activated_level=supply_override_activated_level, engine_self_diagnostic=engine_self_diagnostic, media11_page_count=media11_page_count, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, media7_name=media7_name, error30_code=error30_code, media22=media22, media25_name=media25_name, error31_time_stamp=error31_time_stamp, error36_time_stamp=error36_time_stamp, scanner_accessory_digital_send_config_ldap_gateway=scanner_accessory_digital_send_config_ldap_gateway, media26_short_name=media26_short_name, held_job_job_name=held_job_job_name, control_panel_display_contents_crc=control_panel_display_contents_crc, error14_code=error14_code, maximum_ram_disk_memory=maximum_ram_disk_memory, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, error17=error17, error1_code=error1_code, media19_short_name=media19_short_name, usb_host_supported=usb_host_supported, settings_intray=settings_intray, media8_name=media8_name, error10_date_time=error10_date_time, auto_send_reset=auto_send_reset, copy_job_auto_interrupt=copy_job_auto_interrupt, upgradeable_devices_generic_name=upgradeable_devices_generic_name, media13_name=media13_name, job_info_accounting=job_info_accounting, job_info_name1=job_info_name1, default_horizontal_black_resolution=default_horizontal_black_resolution, error27=error27, error47_date_time=error47_date_time, error5=error5, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, default_copier_pages_per_sheet=default_copier_pages_per_sheet, channelstate=channelstate, marking_agent_shadows_density_setting=marking_agent_shadows_density_setting, supply_out_device_state=supply_out_device_state, usb_vendor_id=usb_vendor_id, media24=media24, media_size_count=media_size_count, error49=error49, error45=error45, printer_average=printer_average, held_job_retention=held_job_retention, mass_storage_resource_changed=mass_storage_resource_changed, settings_job=settings_job, error24=error24, simm2_bank2=simm2_bank2, simm2=simm2, tray_disable_use_instead=tray_disable_use_instead, error46=error46, simm1_type=simm1_type, error48_time_stamp=error48_time_stamp, error41_time_stamp=error41_time_stamp, error25=error25, form_feed=form_feed, media23_page_count=media23_page_count, consumable_life_low_threshold=consumable_life_low_threshold, intrays=intrays, daylight_savings_reset=daylight_savings_reset, media25_page_count=media25_page_count, media4_short_name=media4_short_name, consumables=consumables, error16_time_stamp=error16_time_stamp, perm_store_init_occurred=perm_store_init_occurred, default_copier_flip_pages_up=default_copier_flip_pages_up, error47_code=error47_code, job_info_state=job_info_state, media22_page_count=media22_page_count, consumable_status_printer_design_compatibility=consumable_status_printer_design_compatibility, processing_subsystem=processing_subsystem, destination_bin_accounting=destination_bin_accounting, pcl_default_font_source=pcl_default_font_source, job_info_attr_14=job_info_attr_14, default_copier_page_borders=default_copier_page_borders, error33_time_stamp=error33_time_stamp, error20_date_time=error20_date_time, error36_code=error36_code, pdl_postscript=pdl_postscript, error40_date_time=error40_date_time, printer_cal_dhalf_data1=printer_cal_dhalf_data1, media25_short_name=media25_short_name, print_media=print_media, error3_code=error3_code, media18_engine_media_mode=media18_engine_media_mode, daylight_savings_offset=daylight_savings_offset, media12_page_count=media12_page_count, error24_date_time=error24_date_time, error20_time_stamp=error20_time_stamp, simm1_bank2_type=simm1_bank2_type, held_job_set_queue_size=held_job_set_queue_size, media28_engine_media_mode=media28_engine_media_mode, postscript_print_errors=postscript_print_errors, media26_engine_media_mode=media26_engine_media_mode, mio4_type=mio4_type, media15_short_name=media15_short_name, media28_short_name=media28_short_name, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, scanner_accessory_digital_send_module_url=scanner_accessory_digital_send_module_url, media23_name=media23_name, error30_time_stamp=error30_time_stamp, printer_cal_dhalf_data=printer_cal_dhalf_data, usage_instructions_line2=usage_instructions_line2, firmware_download_current_state=firmware_download_current_state, date_and_time=date_and_time, error7_code=error7_code, marking_agent=marking_agent, simm2_bank=simm2_bank, error10_code=error10_code, scanner_accessory_adf_sheet_count=scanner_accessory_adf_sheet_count, overflow_bin=overflow_bin, ship_cartridge_installed_in_printer=ship_cartridge_installed_in_printer, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, simm2_bank1_type=simm2_bank1_type, rpc_bind_protocol_address=rpc_bind_protocol_address, error15_time_stamp=error15_time_stamp, afax_recv_page_count=afax_recv_page_count, error9_time_stamp=error9_time_stamp, error32_time_stamp=error32_time_stamp, error24_code=error24_code, error45_date_time=error45_date_time, error43_code=error43_code, direct_connect_ports_enable=direct_connect_ports_enable, scanned_media_usage=scanned_media_usage, error23_time_stamp=error23_time_stamp, postscript_defer_media=postscript_defer_media, media21_short_name=media21_short_name, port1_parallel_speed=port1_parallel_speed, file_system_delete_files=file_system_delete_files, error28_date_time=error28_date_time, error28=error28, held_job=held_job, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, media15=media15, error48_date_time=error48_date_time, job_info_name2=job_info_name2, time_display=time_display, error32_code=error32_code, upgradable_devices_name=upgradable_devices_name, media21=media21, formatter_serial_number=formatter_serial_number, channelnumberofchannels=channelnumberofchannels, file_system3=file_system3, localization_countries_supported=localization_countries_supported, job_info_attr_1=job_info_attr_1, media27=media27, file_system3_initialize_volume=file_system3_initialize_volume, job_info_size=job_info_size, media24_name=media24_name)
mibBuilder.exportSymbols("LJ3530mfp-MIB", channelstatus=channelstatus, model_name=model_name, consumable_status_toner_low_sensing_level=consumable_status_toner_low_sensing_level, default_copier_media_size=default_copier_media_size, job_info_pages_in_original=job_info_pages_in_original, channelifindex=channelifindex, error39=error39, error13=error13, faxjob_rx_count=faxjob_rx_count, error16_code=error16_code, media11_name=media11_name, error34_date_time=error34_date_time, media23_short_name=media23_short_name, error40=error40, fw_rom_revision=fw_rom_revision, device_configure_printer_parameters=device_configure_printer_parameters, media27_page_count=media27_page_count, media8_engine_media_mode=media8_engine_media_mode, default_vertical_black_resolution=default_vertical_black_resolution, job_info_attr_10=job_info_attr_10, error8_code=error8_code, error26_code=error26_code, autocleaning_page_size=autocleaning_page_size, error34_time_stamp=error34_time_stamp, scanner_accessory_digital_send_status=scanner_accessory_digital_send_status, channelinformation=channelinformation, channel_jobs_received=channel_jobs_received, print_engine=print_engine, printed_media_combined_total=printed_media_combined_total, afax_send_page_count=afax_send_page_count, media8_short_name=media8_short_name, input_tray_auto_select=input_tray_auto_select, default_copier_quantity=default_copier_quantity, default_copy_output_bin=default_copy_output_bin, error21_date_time=error21_date_time, error32=error32, job_info_printed_originals=job_info_printed_originals, job_being_parsed=job_being_parsed, default_audible_feedback=default_audible_feedback, collated_originals_support=collated_originals_support, scanned_media_simplex_charge=scanned_media_simplex_charge, control_panel_supplies_status_message=control_panel_supplies_status_message, media15_engine_media_mode=media15_engine_media_mode, error30_date_time=error30_date_time, pcl_default_font_number=pcl_default_font_number, default_copy_input_tray=default_copy_input_tray, media10_page_count=media10_page_count, copy_job_hold_time=copy_job_hold_time, supply_out_user_configured_override_limit=supply_out_user_configured_override_limit, channelTable=channelTable, scanner_accessory_digital_send_config_fax_embedded=scanner_accessory_digital_send_config_fax_embedded, error12_date_time=error12_date_time, error6_date_time=error6_date_time, consumable_string=consumable_string, error2_date_time=error2_date_time, media19_name=media19_name, imaging=imaging, scanner_accessory_send_job_scan_count=scanner_accessory_send_job_scan_count, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, mass_storage_block_driver=mass_storage_block_driver, error18_time_stamp=error18_time_stamp, tray_prompt=tray_prompt, media7_page_count=media7_page_count, error28_time_stamp=error28_time_stamp, tray2_media_size_loaded=tray2_media_size_loaded, media16_page_count=media16_page_count, faxjob=faxjob, error22_date_time=error22_date_time, error44_date_time=error44_date_time, error29=error29, error4=error4, file_system2_initialize_volume=file_system2_initialize_volume, configurable_low_threshold_setting=configurable_low_threshold_setting, job_info_attr_4=job_info_attr_4, error21_code=error21_code, error17_time_stamp=error17_time_stamp, non_assured_oht_page_count=non_assured_oht_page_count, simm1=simm1, media5_page_count=media5_page_count, simm2_type=simm2_type, error10=error10, error23=error23, error11_time_stamp=error11_time_stamp, error40_time_stamp=error40_time_stamp, printed_modes_usage=printed_modes_usage, error12_code=error12_code, error46_time_stamp=error46_time_stamp, serial_number=serial_number, media2_name=media2_name, media5_engine_media_mode=media5_engine_media_mode, channel=channel, copy_job_scan_ahead=copy_job_scan_ahead, error18_code=error18_code, copy_job_alternative_letterhead_mode=copy_job_alternative_letterhead_mode, job_info_attr_11=job_info_attr_11, device_location=device_location, consumable_life_usage_units=consumable_life_usage_units, media18_page_count=media18_page_count, custom_paper_xfeed_dim=custom_paper_xfeed_dim, error42_time_stamp=error42_time_stamp, usage_scanner_total_charge=usage_scanner_total_charge, error44_code=error44_code, job_info_page_count_current_original=job_info_page_count_current_original, simm1_capacity=simm1_capacity, simm2_bank2_type=simm2_bank2_type, status_system=status_system, settings_rpc=settings_rpc, error14=error14, job_info_accounting_color_usage_log=job_info_accounting_color_usage_log, media12=media12, media11=media11, error36_date_time=error36_date_time, usage_printer_mono_total_charge=usage_printer_mono_total_charge, media3_short_name=media3_short_name, job_info_attr_2=job_info_attr_2, error34_code=error34_code, media8_page_count=media8_page_count)
