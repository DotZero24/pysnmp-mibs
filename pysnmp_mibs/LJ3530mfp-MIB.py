# SNMP MIB module (LJ3530mfp-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hp/LJ3530mfp-MIB
...
class _Override_a4_with_letter_Type(Integer32):
    """Custom type override_a4_with_letter based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Override_a4_with_letter_Type.__name__ = "Integer32"
_Override_a4_with_letter_Object = MibScalar
override_a4_with_letter = _Override_a4_with_letter_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 1, 74),
    _Override_a4_with_letter_Type()
)
override_a4_with_letter.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    override_a4_with_letter.setStatus("optional")
...
class _Job_info_accounting_media_size_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("eUSExecutive", 1),
          ...
          ("eFourBySixIndexCard", 74),
          ("eFiveByEightIndexCard", 75),
          ("eMonarch", 80),
          ("eCommercial10", 81),
          ("eSize16K184x260", 89),
          ("eInternationalDL", 90),
...
cartridge_adaptive_gain_reset.setMaxAccess("write-only")
if mibBuilder.loadTexts:
...
media27_name.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
media27_short_name.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
media27_engine_media_mode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
media28_name.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
media28_short_name.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
media28_engine_media_mode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
consumable_status_toner_low_sensing_level = _Consumable_status_toner_low_sensing_level_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 99),
    _Consumable_status_toner_low_sensing_level_Type()
)
consumable_status_toner_low_sensing_level.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_toner_low_sensing_level.setStatus("optional")
...
deviceChannelTable = _DeviceChannelTable_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 7, 2)
)
_DeviceChannelEntry_ObjectIdentity = ObjectIdentity
deviceChannelEntry = _DeviceChannelEntry_ObjectIdentity(
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "override-a4-with-letter": override_a4_with_letter,
