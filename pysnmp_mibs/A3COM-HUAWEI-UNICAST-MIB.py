...
h3cURPFTable=_H3cURPFTable_Object((1,3,6,1,4,1,43,45,1,10,2,44,1))
if mibBuilder.loadTexts:h3cURPFTable.setStatus(_A)
_H3cURPFEntry_Object=MibTableRow
h3cURPFEntry=_H3cURPFEntry_Object((1,3,6,1,4,1,43,45,1,10,2,44,1,1))
...
h3cURPFIfIndex=_H3cURPFIfIndex_Object((1,3,6,1,4,1,43,45,1,10,2,44,1,1,1),_H3cURPFIfIndex_Type())
...
h3cURPFEnabled=_H3cURPFEnabled_Object((1,3,6,1,4,1,43,45,1,10,2,44,1,1,2),_H3cURPFEnabled_Type())
...
h3cURPFSlotID=_H3cURPFSlotID_Object((1,3,6,1,4,1,43,45,1,10,2,44,1,1,3),_H3cURPFSlotID_Type())
...
h3cURPFTotalReceivedPacket=_H3cURPFTotalReceivedPacket_Object((1,3,6,1,4,1,43,45,1,10,2,44,1,1,4),_H3cURPFTotalReceivedPacket_Type())
...
h3cURPFDroppedPacket=_H3cURPFDroppedPacket_Object((1,3,6,1,4,1,43,45,1,10,2,44,1,1,5),_H3cURPFDroppedPacket_Type())
...
h3cURPFClearStat=_H3cURPFClearStat_Object((1,3,6,1,4,1,43,45,1,10,2,44,1,1,6),_H3cURPFClearStat_Type())
