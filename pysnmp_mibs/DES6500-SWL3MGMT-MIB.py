# SNMP MIB module (DES6500-SWL3MGMT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES6500-SWL3MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:50:43 2025
...
swL3DevCtrlRIPState = _SwL3DevCtrlRIPState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 1, 1, 1),
...
swL3DevCtrlOSPFState = _SwL3DevCtrlOSPFState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 1, 1, 2),
...
swL3DevCtrlDVMRPState = _SwL3DevCtrlDVMRPState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 1, 1, 3),
...
swL3DevCtrlVrrpState = _SwL3DevCtrlVrrpState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 1, 1, 5),
...
swL3DevCtrlVrrpPingState = _SwL3DevCtrlVrrpPingState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 1, 1, 6),
...
swL3DevCtrlDHCPAutoConfigState = _SwL3DevCtrlDHCPAutoConfigState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 1, 1, 7),
...
class _SwL3DevCtrlPIMGlobalState_Type(Integer32):
    """Custom type swL3DevCtrlPIMGlobalState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwL3DevCtrlPIMGlobalState_Type.__name__ = "Integer32"
_SwL3DevCtrlPIMGlobalState_Object = MibScalar
swL3DevCtrlPIMGlobalState = _SwL3DevCtrlPIMGlobalState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 1, 1, 8),
    _SwL3DevCtrlPIMGlobalState_Type()
)
swL3DevCtrlPIMGlobalState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swL3DevCtrlPIMGlobalState.setStatus("current")
_SwL3IpMgmt_ObjectIdentity = ObjectIdentity
swL3IpMgmt = _SwL3IpMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2)
)
_SwL3IpCtrlMgmt_ObjectIdentity = ObjectIdentity
swL3IpCtrlMgmt = _SwL3IpCtrlMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1)
)
_SwL3IpCtrlTable_Object = MibTable
swL3IpCtrlTable = _SwL3IpCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1)
)
if mibBuilder.loadTexts:
    swL3IpCtrlTable.setStatus("current")
_SwL3IpCtrlEntry_Object = MibTableRow
swL3IpCtrlEntry = _SwL3IpCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1)
)
swL3IpCtrlEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3IpCtrlIpAddr"),
)
if mibBuilder.loadTexts:
...
swL3IpCtrlIpAddr = _SwL3IpCtrlIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 1),
...
swL3IpCtrlIfIndex = _SwL3IpCtrlIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 2),
...
swL3IpCtrlInterfaceName = _SwL3IpCtrlInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 3),
...
swL3IpCtrlIpSubnetMask = _SwL3IpCtrlIpSubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 4),
...
swL3IpCtrlVlanName = _SwL3IpCtrlVlanName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 5),
...
swL3IpCtrlMode = _SwL3IpCtrlMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 6),
...
swL3IpCtrlSecondary = _SwL3IpCtrlSecondary_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 7),
...
swL3IpCtrlState = _SwL3IpCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 8),
...
swL3IpCtrlOperState = _SwL3IpCtrlOperState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 9),
...
swL3IpCtrlAdminState = _SwL3IpCtrlAdminState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 1, 1, 1, 10),
    _SwL3IpCtrlAdminState_Type()
)
swL3IpCtrlAdminState.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
swL3IpFdbInfoIpAddr = _SwL3IpFdbInfoIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 2, 1, 1, 1),
...
swL3IpFdbInfoIpSubnetMask = _SwL3IpFdbInfoIpSubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 2, 1, 1, 2),
...
swL3IpFdbInfoPort = _SwL3IpFdbInfoPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 2, 1, 1, 3),
...
swL3IpFdbInfoType = _SwL3IpFdbInfoType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 2, 1, 1, 4),
...
swL3IpStaticRouteEntry = _SwL3IpStaticRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 5, 1)
)
swL3IpStaticRouteEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3IpStaticRouteDest"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3IpStaticRouteMask"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3IpStaticRouteBkupState"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3IpStaticRouteNextHop"),
)
if mibBuilder.loadTexts:
...
swL3IpStaticRouteDest = _SwL3IpStaticRouteDest_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 5, 1, 1),
...
swL3IpStaticRouteMask = _SwL3IpStaticRouteMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 5, 1, 2),
...
swL3IpStaticRouteNextHop = _SwL3IpStaticRouteNextHop_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 5, 1, 3),
...
swL3IpStaticRouteBkupState = _SwL3IpStaticRouteBkupState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 5, 1, 4),
...
swL3IpStaticRouteMetric = _SwL3IpStaticRouteMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 5, 1, 5),
...
swL3IpStaticRouteStatus = _SwL3IpStaticRouteStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 2, 5, 1, 6),
...
swL3RelayBootpState = _SwL3RelayBootpState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 1),
...
swL3RelayBootpHopCount = _SwL3RelayBootpHopCount_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 2),
...
swL3RelayBootpTimeThreshold = _SwL3RelayBootpTimeThreshold_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 3),
...
swL3RelayDhcpCtrlTable = _SwL3RelayDhcpCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 4)
)
if mibBuilder.loadTexts:
...
swL3RelayDhcpCtrlEntry = _SwL3RelayDhcpCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 4, 1)
)
swL3RelayDhcpCtrlEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3RelayDhcpCtrlInterfaceName"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3RelayDhcpCtrlServer"),
)
if mibBuilder.loadTexts:
...
swL3RelayDhcpCtrlInterfaceName = _SwL3RelayDhcpCtrlInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 4, 1, 1),
...
swL3RelayDhcpCtrlServer = _SwL3RelayDhcpCtrlServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 4, 1, 2),
...
swL3RelayDhcpCtrlState = _SwL3RelayDhcpCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 4, 1, 3),
...
swL3RelayDhcpOption82State = _SwL3RelayDhcpOption82State_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 5),
...
class _SwL3RelayDhcpOption82ChceckState_Type(Integer32):
    """Custom type swL3RelayDhcpOption82ChceckState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_SwL3RelayDhcpOption82ChceckState_Type.__name__ = "Integer32"
_SwL3RelayDhcpOption82ChceckState_Object = MibScalar
swL3RelayDhcpOption82ChceckState = _SwL3RelayDhcpOption82ChceckState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 6),
    _SwL3RelayDhcpOption82ChceckState_Type()
)
swL3RelayDhcpOption82ChceckState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swL3RelayDhcpOption82ChceckState.setStatus("current")
...
swL3RelayDhcpOption82Policy = _SwL3RelayDhcpOption82Policy_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 1, 7),
...
swL3RelayDnsState = _SwL3RelayDnsState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 1),
...
swL3RelayDnsPrimaryServer = _SwL3RelayDnsPrimaryServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 2),
...
swL3RelayDnsSecondaryServer = _SwL3RelayDnsSecondaryServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 3),
...
swL3RelayDnsCacheState = _SwL3RelayDnsCacheState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 4),
...
swL3RelayDnsStaticTableState = _SwL3RelayDnsStaticTableState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 5),
...
swL3RelayDnsCtrlTable = _SwL3RelayDnsCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 6)
)
if mibBuilder.loadTexts:
...
swL3RelayDnsCtrlEntry = _SwL3RelayDnsCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 6, 1)
)
swL3RelayDnsCtrlEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3RelayDnsCtrlDomainName"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3RelayDnsCtrlIpAddr"),
)
if mibBuilder.loadTexts:
...
swL3RelayDnsCtrlDomainName = _SwL3RelayDnsCtrlDomainName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 6, 1, 1),
...
swL3RelayDnsCtrlIpAddr = _SwL3RelayDnsCtrlIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 6, 1, 2),
...
swL3RelayDnsCtrlState = _SwL3RelayDnsCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 3, 2, 6, 1, 3),
...
swL3Md5KeyId = _SwL3Md5KeyId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 4, 1, 1),
    _SwL3Md5KeyId_Type()
)
...
swL3Md5Key = _SwL3Md5Key_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 4, 1, 2),
    _SwL3Md5Key_Type()
)
...
swL3Md5RowStatus = _SwL3Md5RowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 4, 1, 3),
...
swL3RouteRedistriEntry = _SwL3RouteRedistriEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 5, 1)
)
swL3RouteRedistriEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3RouteRedistriSrcProtocol"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3RouteRedistriDstProtocol"),
)
if mibBuilder.loadTexts:
...
swL3RouteRedistriSrcProtocol = _SwL3RouteRedistriSrcProtocol_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 5, 1, 1),
...
swL3RouteRedistriDstProtocol = _SwL3RouteRedistriDstProtocol_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 5, 1, 2),
...
swL3RouteRedistriType = _SwL3RouteRedistriType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 5, 1, 3),
...
swL3RouteRedistriMetric = _SwL3RouteRedistriMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 5, 1, 4),
...
swL3RouteRedistriRowStatus = _SwL3RouteRedistriRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 5, 1, 5),
...
swL3OspfHostIpAddress = _SwL3OspfHostIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 6, 1, 1),
...
swL3OspfHostTOS = _SwL3OspfHostTOS_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 6, 1, 2),
...
swL3OspfHostMetric = _SwL3OspfHostMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 6, 1, 3),
...
swL3OspfHostAreaID = _SwL3OspfHostAreaID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 6, 1, 4),
...
swL3OspfHostStatus = _SwL3OspfHostStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 6, 1, 5),
...
swL3ospfVirtIfEntry = _SwL3ospfVirtIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1)
)
swL3ospfVirtIfEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3ospfVirtIfAreaId"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3ospfVirtIfNeighbor"),
)
if mibBuilder.loadTexts:
...
swL3ospfVirtIfAreaId = _SwL3ospfVirtIfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 1),
...
swL3ospfVirtIfNeighbor = _SwL3ospfVirtIfNeighbor_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 2),
...
swL3ospfVirtIfTransitDelay = _SwL3ospfVirtIfTransitDelay_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 3),
...
swL3ospfVirtIfRetransInterval = _SwL3ospfVirtIfRetransInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 4),
...
swL3ospfVirtIfHelloInterval = _SwL3ospfVirtIfHelloInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 5),
...
swL3ospfVirtIfState = _SwL3ospfVirtIfState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 7),
...
swL3ospfVirtIfEvents = _SwL3ospfVirtIfEvents_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 8),
...
swL3ospfVirtIfAuthType = _SwL3ospfVirtIfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 9),
...
swL3ospfVirtIfAuthKey = _SwL3ospfVirtIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 10),
...
swL3ospfVirtIfAuthKeyID = _SwL3ospfVirtIfAuthKeyID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 11),
...
swL3ospfVirtIfStatus = _SwL3ospfVirtIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 7, 1, 12),
...
swL3ospfIfTable = _SwL3ospfIfTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8)
)
if mibBuilder.loadTexts:
    swL3ospfIfTable.setStatus("current")
_SwL3ospfIfEntry_Object = MibTableRow
swL3ospfIfEntry = _SwL3ospfIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1)
)
swL3ospfIfEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3ospfIfIpAddress"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3ospfAddressLessIf"),
)
if mibBuilder.loadTexts:
...
swL3ospfIfIpAddress = _SwL3ospfIfIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 1),
...
swL3ospfAddressLessIf = _SwL3ospfAddressLessIf_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 2),
...
swL3ospfIfAreaId = _SwL3ospfIfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 3),
...
swL3ospfIfType = _SwL3ospfIfType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 4),
...
swL3ospfIfAdminStat = _SwL3ospfIfAdminStat_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 5),
...
swL3ospfIfRtrPriority = _SwL3ospfIfRtrPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 6),
...
swL3ospfIfTransitDelay = _SwL3ospfIfTransitDelay_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 7),
...
swL3ospfIfRetransInterval = _SwL3ospfIfRetransInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 8),
...
swL3ospfIfHelloInterval = _SwL3ospfIfHelloInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 9),
...
swL3ospfIfRtrDeadInterval = _SwL3ospfIfRtrDeadInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 10),
...
swL3ospfIfPollInterval = _SwL3ospfIfPollInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 11),
...
swL3ospfIfState = _SwL3ospfIfState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 12),
...
swL3ospfIfDesignatedRouter = _SwL3ospfIfDesignatedRouter_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 13),
...
swL3ospfIfBackupDesignatedRouter = _SwL3ospfIfBackupDesignatedRouter_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 14),
...
swL3ospfIfEvents = _SwL3ospfIfEvents_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 15),
...
swL3ospfIfMulticastForwarding = _SwL3ospfIfMulticastForwarding_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 16),
...
swL3ospfIfDemand = _SwL3ospfIfDemand_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 17),
...
swL3ospfIfAuthType = _SwL3ospfIfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 18),
...
swL3ospfIfAuthKey = _SwL3ospfIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 19),
...
swL3ospfIfAuthKeyID = _SwL3ospfIfAuthKeyID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 20),
...
swL3ospfIfStatus = _SwL3ospfIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 8, 1, 21),
...
swL3dvmrpInterfaceEntry = _SwL3dvmrpInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 9, 1)
)
swL3dvmrpInterfaceEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3dvmrpInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
swL3dvmrpInterfaceIfIndex = _SwL3dvmrpInterfaceIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 9, 1, 1),
...
swL3dvmrpInterfaceLocalAddress = _SwL3dvmrpInterfaceLocalAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 9, 1, 2),
...
swL3dvmrpInterfaceMetric = _SwL3dvmrpInterfaceMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 9, 1, 3),
...
swL3dvmrpInterfaceProbe = _SwL3dvmrpInterfaceProbe_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 9, 1, 4),
...
swL3dvmrpInterfaceNbrTimeout = _SwL3dvmrpInterfaceNbrTimeout_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 9, 1, 5),
...
swL3dvmrpInterfaceStatus = _SwL3dvmrpInterfaceStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 9, 1, 6),
...
swL3dvmrpInterfaceRcvBadPkts = _SwL3dvmrpInterfaceRcvBadPkts_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 9, 1, 7),
...
swL3dvmrpInterfaceRcvBadRoutes = _SwL3dvmrpInterfaceRcvBadRoutes_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 9, 1, 8),
...
swL3pimCbsrBootStrapPeriod = _SwL3pimCbsrBootStrapPeriod_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 1, 1),
...
swL3pimCbsrHashMaskLen = _SwL3pimCbsrHashMaskLen_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 1, 2),
...
swL3pimCandidateRPMgmt = _SwL3pimCandidateRPMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 2)
)
...
swL3pimCandidateRPHoldtime = _SwL3pimCandidateRPHoldtime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 2, 1),
...
swL3pimCandidateRPPriority = _SwL3pimCandidateRPPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 2, 2),
...
swL3pimCandidateRPWildcardPrefixCnt = _SwL3pimCandidateRPWildcardPrefixCnt_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 2, 3),
...
swL3pimSptMgmt = _SwL3pimSptMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 3)
)
...
swL3pimLastHopSptThreshold = _SwL3pimLastHopSptThreshold_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 3, 1),
...
swL3pimRPSptThreshold = _SwL3pimRPSptThreshold_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 3, 2),
...
swL3pimRegChksumIncDataTable = _SwL3pimRegChksumIncDataTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 4)
)
if mibBuilder.loadTexts:
...
swL3pimRegChksumIncDataEntry = _SwL3pimRegChksumIncDataEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 4, 1)
)
swL3pimRegChksumIncDataEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3SwL3pimRegChksumIncDataRpAddr"),
)
if mibBuilder.loadTexts:
...
swL3SwL3pimRegChksumIncDataRpAddr = _SwL3SwL3pimRegChksumIncDataRpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 4, 1, 1),
...
swL3SwL3pimRegChksumIncDataState = _SwL3SwL3pimRegChksumIncDataState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 4, 1, 2),
...
swL3PimInfoMgmt = _SwL3PimInfoMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 5)
)
...
swL3pimRegisterProbeTime = _SwL3pimRegisterProbeTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 5, 1),
...
swL3pimRegisterSuppressionTime = _SwL3pimRegisterSuppressionTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 5, 2),
...
swL3pimInterface = _SwL3pimInterface_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 5, 3, 1, 1),
...
swL3pimDRPriority = _SwL3pimDRPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 5, 3, 1, 2),
...
swL3pimStaticRPTable = _SwL3pimStaticRPTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 6)
)
if mibBuilder.loadTexts:
...
swL3pimStaticRPEntry = _SwL3pimStaticRPEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 6, 1)
)
swL3pimStaticRPEntry.setIndexNames(
    (0, "DES6500-SWL3MGMT-MIB", "swL3pimStaticRPGroupAddress"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3pimStaticRPGroupMask"),
    (0, "DES6500-SWL3MGMT-MIB", "swL3pimStaticRPAddress"),
)
if mibBuilder.loadTexts:
...
swL3pimStaticRPGroupAddress = _SwL3pimStaticRPGroupAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 6, 1, 1),
...
swL3pimStaticRPGroupMask = _SwL3pimStaticRPGroupMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 6, 1, 2),
...
swL3pimStaticRPAddress = _SwL3pimStaticRPAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 6, 1, 3),
...
swL3pimStaticRPRowStatus = _SwL3pimStaticRPRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 78, 1, 3, 10, 6, 1, 4),
...
mibBuilder.exportSymbols(
    ...
    **{"NodeAddress": NodeAddress,
       ...
       "swL3DevCtrlPIMGlobalState": swL3DevCtrlPIMGlobalState,
       ...
       "swL3RelayDhcpOption82ChceckState": swL3RelayDhcpOption82ChceckState,
