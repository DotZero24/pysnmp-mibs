...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-MNGINF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:40:24 2025
...
rlMngInfApplBoundTable = _RlMngInfApplBoundTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 8)
)
if mibBuilder.loadTexts:
    rlMngInfApplBoundTable.setStatus("current")
_RlMngInfApplBoundEntry_Object = MibTableRow
rlMngInfApplBoundEntry = _RlMngInfApplBoundEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 8, 1)
)
rlMngInfApplBoundEntry.setIndexNames(
    (0, "CISCOSB-MNGINF-MIB", "rlMngInfApplBoundIndex"),
)
if mibBuilder.loadTexts:
    rlMngInfApplBoundEntry.setStatus("current")
_RlMngInfApplBoundIndex_Type = Integer32
_RlMngInfApplBoundIndex_Object = MibTableColumn
rlMngInfApplBoundIndex = _RlMngInfApplBoundIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 8, 1, 1),
    _RlMngInfApplBoundIndex_Type()
)
rlMngInfApplBoundIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    rlMngInfApplBoundIndex.setStatus("current")
_RlMngInfApplBoundAclName_Type = DisplayString
_RlMngInfApplBoundAclName_Object = MibTableColumn
rlMngInfApplBoundAclName = _RlMngInfApplBoundAclName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 8, 1, 2),
    _RlMngInfApplBoundAclName_Type()
)
rlMngInfApplBoundAclName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlMngInfApplBoundAclName.setStatus("current")
_RlMngInfApplBoundApplName_Type = DisplayString
_RlMngInfApplBoundApplName_Object = MibTableColumn
rlMngInfApplBoundApplName = _RlMngInfApplBoundApplName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 8, 1, 3),
    _RlMngInfApplBoundApplName_Type()
)
rlMngInfApplBoundApplName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlMngInfApplBoundApplName.setStatus("current")
_RlMngInfApplBoundIsActive_Type = TruthValue
_RlMngInfApplBoundIsActive_Object = MibTableColumn
rlMngInfApplBoundIsActive = _RlMngInfApplBoundIsActive_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 8, 1, 4),
    _RlMngInfApplBoundIsActive_Type()
)
rlMngInfApplBoundIsActive.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlMngInfApplBoundIsActive.setStatus("current")
_RlMngInfApplBoundSavedAclClass_Type = DisplayString
_RlMngInfApplBoundSavedAclClass_Object = MibTableColumn
rlMngInfApplBoundSavedAclClass = _RlMngInfApplBoundSavedAclClass_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 8, 1, 5),
    _RlMngInfApplBoundSavedAclClass_Type()
)
rlMngInfApplBoundSavedAclClass.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlMngInfApplBoundSavedAclClass.setStatus("current")
_RlMngInfApplBoundSavedEnable_Type = TruthValue
_RlMngInfApplBoundSavedEnable_Object = MibTableColumn
rlMngInfApplBoundSavedEnable = _RlMngInfApplBoundSavedEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 8, 1, 6),
    _RlMngInfApplBoundSavedEnable_Type()
)
rlMngInfApplBoundSavedEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlMngInfApplBoundSavedEnable.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlMngInfServiceType": RlMngInfServiceType,
       ...
       "rlMngInfApplBoundTable": rlMngInfApplBoundTable,
       "rlMngInfApplBoundEntry": rlMngInfApplBoundEntry,
       "rlMngInfApplBoundIndex": rlMngInfApplBoundIndex,
       "rlMngInfApplBoundAclName": rlMngInfApplBoundAclName,
       "rlMngInfApplBoundApplName": rlMngInfApplBoundApplName,
       "rlMngInfApplBoundIsActive": rlMngInfApplBoundIsActive,
       "rlMngInfApplBoundSavedAclClass": rlMngInfApplBoundSavedAclClass,
       "rlMngInfApplBoundSavedEnable": rlMngInfApplBoundSavedEnable}
)
