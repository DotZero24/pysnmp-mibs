...
myFileMIBObjects=_MyFileMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,11,1))
_MyFileTransTable_Object=MibTable
myFileTransTable=_MyFileTransTable_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1))
if mibBuilder.loadTexts:myFileTransTable.setStatus(_A)
_MyFileTransEntry_Object=MibTableRow
myFileTransEntry=_MyFileTransEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1))
...
myFileTransIndex=_MyFileTransIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,1),_MyFileTransIndex_Type())
...
myFileTransMeans=_MyFileTransMeans_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,2),_MyFileTransMeans_Type())
...
myFileTransOperType=_MyFileTransOperType_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,3),_MyFileTransOperType_Type())
...
myFileTransSrcFileName=_MyFileTransSrcFileName_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,4),_MyFileTransSrcFileName_Type())
...
myFileTransDescFileName=_MyFileTransDescFileName_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,5),_MyFileTransDescFileName_Type())
...
myFileTransServerAddr=_MyFileTransServerAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,6),_MyFileTransServerAddr_Type())
...
myFileTransResult=_MyFileTransResult_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,7),_MyFileTransResult_Type())
...
myFileTransComplete=_MyFileTransComplete_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,8),_MyFileTransComplete_Type())
...
myFileTransDataLength=_MyFileTransDataLength_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,9),_MyFileTransDataLength_Type())
...
myFileTransEntryStatus=_MyFileTransEntryStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,1,1,10),_MyFileTransEntryStatus_Type())
...
myFileSystemMaxRoom=_MyFileSystemMaxRoom_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,2),_MyFileSystemMaxRoom_Type())
...
myFileSystemAvailableRoom=_MyFileSystemAvailableRoom_Object((1,3,6,1,4,1,4881,1,1,10,2,11,1,3),_MyFileSystemAvailableRoom_Type())
...
myFileMIBConformance=_MyFileMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,11,2))
_MyFileMIBCompliances_ObjectIdentity=ObjectIdentity
myFileMIBCompliances=_MyFileMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,11,2,1))
_MyFileMIBGroups_ObjectIdentity=ObjectIdentity
myFileMIBGroups=_MyFileMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,11,2,2))
myFileMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,11,2,2,1))
...
myFileTransMeansMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,11,2,2,2))
myFileTransMeansMIBGroup.setObjects((_B,_Q))
if mibBuilder.loadTexts:myFileTransMeansMIBGroup.setStatus(_A)
myFileMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,11,2,1,1))
