...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/enterasys/ENTERASYS-MULTI-USER-8021X-MIB
...
etsysMultiUser8021xMIB.setRevisions(('2013-02-12 16:56', '2004-11-11 15:31',))
if mibBuilder.loadTexts: etsysMultiUser8021xMIB.setLastUpdated('201302121656Z')
...
etsysMulti1xSystemAccountEnable = MibScalar((1, 3, 6, 1, 4, 1, 5624, 1, 2, 53, 1, 1, 1), EnabledStatus().clone('enabled')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: etsysMulti1xSystemAccountEnable.setStatus('current')
...
etsysMultiUser8021xSystemGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 5624, 1, 2, 53, 2, 1, 8)).setObjects(("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMulti1xSystemAccountEnable"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    etsysMultiUser8021xSystemGroup = etsysMultiUser8021xSystemGroup.setStatus('current')
...
etsysMulti8021xCompliance2 = ModuleCompliance((1, 3, 6, 1, 4, 1, 5624, 1, 2, 53, 2, 2, 2)).setObjects(("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntityGroup"), ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntityStatsGroup"), ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntityDiagGroup"), ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntitySessionGroup"), ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xSupplicantAddressGroup"), ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xUserNameGroup"), ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xActiveAccessEntityGroup"), ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xSystemGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    etsysMulti8021xCompliance2 = etsysMulti8021xCompliance2.setStatus('current')
mibBuilder.exportSymbols("ENTERASYS-MULTI-USER-8021X-MIB", etsysMulti1xSessionTime=etsysMulti1xSessionTime, etsysMulti1xUserNameTable=etsysMulti1xUserNameTable, etsysMulti1xAeEapolReqFramesTx=etsysMulti1xAeEapolReqFramesTx, etsysMulti1xAeEapLogoffsWhileConnecting=etsysMulti1xAeEapLogoffsWhileConnecting, etsysMulti1xSessionStatsEntry=etsysMulti1xSessionStatsEntry, etsysMulti1xSessionOctetsRx=etsysMulti1xSessionOctetsRx, etsysMulti1xAccessEntityStatsTable=etsysMulti1xAccessEntityStatsTable, etsysMulti1xAeDiagEntry=etsysMulti1xAeDiagEntry, etsysMulti1xSupplicantUserName=etsysMulti1xSupplicantUserName, etsysMulti1xSupplicantAddressTable=etsysMulti1xSupplicantAddressTable, etsysMultiUser8021xSupplicantAddressGroup=etsysMultiUser8021xSupplicantAddressGroup, etsysMulti1xAeInitialize=etsysMulti1xAeInitialize, etsysMulti1xAeAuthReauthsWhileAuthenticated=etsysMulti1xAeAuthReauthsWhileAuthenticated, etsysMulti1xAeBackendAuthSuccesses=etsysMulti1xAeBackendAuthSuccesses, etsysMulti1xAeBackendResponses=etsysMulti1xAeBackendResponses, etsysMulti1xSessionAuthenticMethod=etsysMulti1xSessionAuthenticMethod, etsysMultiUser8021xMIB=etsysMultiUser8021xMIB, etsysMulti1xAeEapolFrameVersion=etsysMulti1xAeEapolFrameVersion, etsysMulti1xAeAuthSuccessWhileAuthenticating=etsysMulti1xAeAuthSuccessWhileAuthenticating, PYSNMP_MODULE_ID=etsysMultiUser8021xMIB, etsysMultiUser8021xAccessEntityStatsGroup=etsysMultiUser8021xAccessEntityStatsGroup, etsysMulti1xSessionUserName=etsysMulti1xSessionUserName, etsysMulti1xAeAuthEapLogoffWhileAuthenticated=etsysMulti1xAeAuthEapLogoffWhileAuthenticated, etsysMultiUser8021xConformance=etsysMultiUser8021xConformance, etsysMultiUser8021xUserNameGroup=etsysMultiUser8021xUserNameGroup, etsysMulti1xAeUserName=etsysMulti1xAeUserName, etsysMultiUser8021xAccessEntitySessionGroup=etsysMultiUser8021xAccessEntitySessionGroup, etsysMulti1xAeReAuthPeriod=etsysMulti1xAeReAuthPeriod, etsysMulti1xAeEapolStartFramesRx=etsysMulti1xAeEapolStartFramesRx, etsysMulti1xAeBackendAuthFails=etsysMulti1xAeBackendAuthFails, etsysMulti8021xCompliance2=etsysMulti8021xCompliance2, etsysMulti1xAeBackendOtherRequestsToSupplicant=etsysMulti1xAeBackendOtherRequestsToSupplicant, etsysMulti1xSessionFramesTx=etsysMulti1xSessionFramesTx, etsysMulti1xSessionFramesRx=etsysMulti1xSessionFramesRx, etsysMulti1xSupplicantAddressEntry=etsysMulti1xSupplicantAddressEntry, etsysMulti1xAeInvalidEapolFramesRx=etsysMulti1xAeInvalidEapolFramesRx, etsysMulti1xAeAuthTimeoutsWhileAuthenticating=etsysMulti1xAeAuthTimeoutsWhileAuthenticating, etsysMulti1xSessionStatsTable=etsysMulti1xSessionStatsTable, etsysMulti8021xCompliance=etsysMulti8021xCompliance, etsysMulti1xAeSupplicantAddress=etsysMulti1xAeSupplicantAddress, etsysMulti1xUserAddress=etsysMulti1xUserAddress, etsysMulti1xSessionId=etsysMulti1xSessionId, etsysMulti1xAeBackendNonNakResponsesFromSupplicant=etsysMulti1xAeBackendNonNakResponsesFromSupplicant, etsysMulti1xSessionActive=etsysMulti1xSessionActive, etsysMulti1xAeAuthFailWhileAuthenticating=etsysMulti1xAeAuthFailWhileAuthenticating, etsysMulti1xAeReauthenticate=etsysMulti1xAeReauthenticate, etsysMulti1xAeEntersAuthenticating=etsysMulti1xAeEntersAuthenticating, etsysMulti1xUserName=etsysMulti1xUserName, etsysMultiUser8021xSystemGroup=etsysMultiUser8021xSystemGroup, etsysMulti1xAeState=etsysMulti1xAeState, etsysMulti1xAeAuthEapStartsWhileAuthenticating=etsysMulti1xAeAuthEapStartsWhileAuthenticating, etsysMulti1xAeAuthEapStartsWhileAuthenticated=etsysMulti1xAeAuthEapStartsWhileAuthenticated, etsysMulti1xUserNameIndex=etsysMulti1xUserNameIndex, etsysMulti1xActiveSupplicantAddress=etsysMulti1xActiveSupplicantAddress, etsysMultiUser8021xObjects=etsysMultiUser8021xObjects, etsysMulti1xUserNameEntry=etsysMulti1xUserNameEntry, etsysMulti1xSupplicantActive=etsysMulti1xSupplicantActive, etsysMulti1xAeEapolFramesRx=etsysMulti1xAeEapolFramesRx, etsysMulti1xAccessEntityStatsEntry=etsysMulti1xAccessEntityStatsEntry, etsysMultiUser8021xGroups=etsysMultiUser8021xGroups, etsysMulti1xAeEapolReqIdFramesTx=etsysMulti1xAeEapolReqIdFramesTx, etsysMulti1xAeEapolFrameSource=etsysMulti1xAeEapolFrameSource, etsysMulti1xAeAuthEapLogoffWhileAuthenticating=etsysMulti1xAeAuthEapLogoffWhileAuthenticating, etsysMultiUser8021xSystem=etsysMultiUser8021xSystem, etsysMultiUser8021xCompliances=etsysMultiUser8021xCompliances, etsysMulti1xAccessEntityTable=etsysMulti1xAccessEntityTable, etsysMulti1xSessionTerminateCause=etsysMulti1xSessionTerminateCause, etsysMultiUser8021xActiveAccessEntityGroup=etsysMultiUser8021xActiveAccessEntityGroup, etsysMulti1xUserActive=etsysMulti1xUserActive, etsysMulti1xAeEapolFramesTx=etsysMulti1xAeEapolFramesTx, etsysMulti1xSessionOctetsTx=etsysMulti1xSessionOctetsTx, etsysMulti1xAeEapolRespFramesRx=etsysMulti1xAeEapolRespFramesRx, etsysMultiUser8021xAccessEntity=etsysMultiUser8021xAccessEntity, etsysMulti1xAccessEntityEntry=etsysMulti1xAccessEntityEntry, etsysMultiUser8021xAccessEntityGroup=etsysMultiUser8021xAccessEntityGroup, etsysMulti1xAeEapolLogoffFramesRx=etsysMulti1xAeEapolLogoffFramesRx, etsysMulti1xAeDiagTable=etsysMulti1xAeDiagTable, etsysMulti1xAeBackendAccessChallenges=etsysMulti1xAeBackendAccessChallenges, etsysMulti1xActiveAccessEntityTable=etsysMulti1xActiveAccessEntityTable, etsysMultiUser8021xAccessEntityDiagGroup=etsysMultiUser8021xAccessEntityDiagGroup, etsysMulti1xAeEapLengthErrorFramesRx=etsysMulti1xAeEapLengthErrorFramesRx, etsysMulti1xAeEapolRespIdFramesRx=etsysMulti1xAeEapolRespIdFramesRx, etsysMulti1xAeIndex=etsysMulti1xAeIndex, etsysMulti1xSystemAccountEnable=etsysMulti1xSystemAccountEnable, etsysMulti1xAeAuthReauthsWhileAuthenticating=etsysMulti1xAeAuthReauthsWhileAuthenticating, etsysMulti1xAeBackendAuthState=etsysMulti1xAeBackendAuthState, etsysMulti1xActiveAccessEntityEntry=etsysMulti1xActiveAccessEntityEntry, etsysMulti1xAeEntersConnecting=etsysMulti1xAeEntersConnecting, etsysMulti1xAeActive=etsysMulti1xAeActive)
