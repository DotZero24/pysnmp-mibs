...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-MULTI-USER-8021X-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:46:58 2025
...
class _EtsysMulti1xSystemAccountEnable_Type(EnabledStatus):
    """Custom type etsysMulti1xSystemAccountEnable based on EnabledStatus"""
    defaultValue = 1


_EtsysMulti1xSystemAccountEnable_Type.__name__ = "EnabledStatus"
_EtsysMulti1xSystemAccountEnable_Object = MibScalar
etsysMulti1xSystemAccountEnable = _EtsysMulti1xSystemAccountEnable_Object(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 53, 1, 1, 1),
    _EtsysMulti1xSystemAccountEnable_Type()
)
etsysMulti1xSystemAccountEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    etsysMulti1xSystemAccountEnable.setStatus("current")
...
_EtsysMulti1xAeReAuthPeriod_Type.__name__ = "Unsigned32"
...
etsysMultiUser8021xSystemGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 53, 2, 1, 8)
)
etsysMultiUser8021xSystemGroup.setObjects(
    ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMulti1xSystemAccountEnable")
)
if mibBuilder.loadTexts:
    etsysMultiUser8021xSystemGroup.setStatus("current")
...
etsysMulti8021xCompliance.setObjects(
      *(("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntityGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntityStatsGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntityDiagGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntitySessionGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xSupplicantAddressGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xUserNameGroup"),
...
etsysMulti8021xCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 53, 2, 2, 2)
)
etsysMulti8021xCompliance2.setObjects(
      *(("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntityGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntityStatsGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntityDiagGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xAccessEntitySessionGroup"),
        ...
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xUserNameGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xActiveAccessEntityGroup"),
        ("ENTERASYS-MULTI-USER-8021X-MIB", "etsysMultiUser8021xSystemGroup"))
)
if mibBuilder.loadTexts:
    etsysMulti8021xCompliance2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"etsysMultiUser8021xMIB": etsysMultiUser8021xMIB,
       ...
       "etsysMulti1xSystemAccountEnable": etsysMulti1xSystemAccountEnable,
       ...
       "etsysMultiUser8021xSystemGroup": etsysMultiUser8021xSystemGroup,
       "etsysMultiUser8021xCompliances": etsysMultiUser8021xCompliances,
       "etsysMulti8021xCompliance": etsysMulti8021xCompliance,
       "etsysMulti8021xCompliance2": etsysMulti8021xCompliance2}
)
