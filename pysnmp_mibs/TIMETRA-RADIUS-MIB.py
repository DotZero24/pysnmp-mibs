...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-RADIUS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:00:36 2025
...
class _TmnxRadProxSrvAttrMatAttrType_Type(TmnxSubRadiusAttrType):
    """Custom type tmnxRadProxSrvAttrMatAttrType based on TmnxSubRadiusAttrType"""
    defaultValue = 1

    subtypeSpec = TmnxSubRadiusAttrType.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )


_TmnxRadProxSrvAttrMatAttrType_Type.__name__ = "TmnxSubRadiusAttrType"
_TmnxRadProxSrvAttrMatAttrType_Object = MibTableColumn
tmnxRadProxSrvAttrMatAttrType = _TmnxRadProxSrvAttrMatAttrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 1, 1, 1, 38),
    _TmnxRadProxSrvAttrMatAttrType_Type()
)
tmnxRadProxSrvAttrMatAttrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadProxSrvAttrMatAttrType.setStatus("current")


class _TmnxRadProxSrvAttrMatVendorId_Type(TmnxSubRadiusVendorId):
    """Custom type tmnxRadProxSrvAttrMatVendorId based on TmnxSubRadiusVendorId"""
    defaultValue = 0


_TmnxRadProxSrvAttrMatVendorId_Type.__name__ = "TmnxSubRadiusVendorId"
_TmnxRadProxSrvAttrMatVendorId_Object = MibTableColumn
tmnxRadProxSrvAttrMatVendorId = _TmnxRadProxSrvAttrMatVendorId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 1, 1, 1, 39),
    _TmnxRadProxSrvAttrMatVendorId_Type()
)
tmnxRadProxSrvAttrMatVendorId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadProxSrvAttrMatVendorId.setStatus("current")
...
_TmnxRadPSStatsTxDroppedByAuthC_Type = Counter32
_TmnxRadPSStatsTxDroppedByAuthC_Object = MibTableColumn
tmnxRadPSStatsTxDroppedByAuthC = _TmnxRadPSStatsTxDroppedByAuthC_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 1, 3, 1, 39),
    _TmnxRadPSStatsTxDroppedByAuthC_Type()
)
tmnxRadPSStatsTxDroppedByAuthC.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxRadPSStatsTxDroppedByAuthC.setStatus("current")
...
class _TmnxRadSrvPlcyServerDownTimeout_Type(Unsigned32):
    """Custom type tmnxRadSrvPlcyServerDownTimeout based on Unsigned32"""
    defaultValue = 0
...
_TmnxRadSrvPlcyServerDownTimeout_Type.__name__ = "Unsigned32"
_TmnxRadSrvPlcyServerDownTimeout_Object = MibTableColumn
tmnxRadSrvPlcyServerDownTimeout = _TmnxRadSrvPlcyServerDownTimeout_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 2, 1, 121),
    _TmnxRadSrvPlcyServerDownTimeout_Type()
)
tmnxRadSrvPlcyServerDownTimeout.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyServerDownTimeout.setStatus("current")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyServerDownTimeout.setUnits("seconds")


class _TmnxRadSrvPlcyTestAccntChecking_Type(TmnxEnabledDisabled):
    """Custom type tmnxRadSrvPlcyTestAccntChecking based on TmnxEnabledDisabled"""
    defaultValue = 2


_TmnxRadSrvPlcyTestAccntChecking_Type.__name__ = "TmnxEnabledDisabled"
_TmnxRadSrvPlcyTestAccntChecking_Object = MibTableColumn
tmnxRadSrvPlcyTestAccntChecking = _TmnxRadSrvPlcyTestAccntChecking_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 2, 1, 122),
    _TmnxRadSrvPlcyTestAccntChecking_Type()
)
tmnxRadSrvPlcyTestAccntChecking.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyTestAccntChecking.setStatus("current")


class _TmnxRadSrvPlcyTestAccntIvl_Type(Unsigned32):
    """Custom type tmnxRadSrvPlcyTestAccntIvl based on Unsigned32"""
    defaultValue = 3
...
_TmnxRadSrvPlcyTestAccntIvl_Type.__name__ = "Unsigned32"
_TmnxRadSrvPlcyTestAccntIvl_Object = MibTableColumn
tmnxRadSrvPlcyTestAccntIvl = _TmnxRadSrvPlcyTestAccntIvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 2, 1, 123),
    _TmnxRadSrvPlcyTestAccntIvl_Type()
)
tmnxRadSrvPlcyTestAccntIvl.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyTestAccntIvl.setStatus("current")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyTestAccntIvl.setUnits("seconds")


class _TmnxRadSrvPlcyTestAccntUserName_Type(DisplayString):
    """Custom type tmnxRadSrvPlcyTestAccntUserName based on DisplayString"""
    defaultHexValue = ""
...
_TmnxRadSrvPlcyTestAccntUserName_Type.__name__ = "DisplayString"
_TmnxRadSrvPlcyTestAccntUserName_Object = MibTableColumn
tmnxRadSrvPlcyTestAccntUserName = _TmnxRadSrvPlcyTestAccntUserName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 2, 1, 124),
    _TmnxRadSrvPlcyTestAccntUserName_Type()
)
tmnxRadSrvPlcyTestAccntUserName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyTestAccntUserName.setStatus("current")


class _TmnxRadSrvPlcyTestAccntPassword_Type(TmnxAuthPassword):
    """Custom type tmnxRadSrvPlcyTestAccntPassword based on TmnxAuthPassword"""
    defaultHexValue = ""


_TmnxRadSrvPlcyTestAccntPassword_Type.__name__ = "TmnxAuthPassword"
_TmnxRadSrvPlcyTestAccntPassword_Object = MibTableColumn
tmnxRadSrvPlcyTestAccntPassword = _TmnxRadSrvPlcyTestAccntPassword_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 2, 1, 125),
    _TmnxRadSrvPlcyTestAccntPassword_Type()
)
tmnxRadSrvPlcyTestAccntPassword.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyTestAccntPassword.setStatus("current")


class _TmnxRadSrvPlcyDisableStickiness_Type(TruthValue):
    """Custom type tmnxRadSrvPlcyDisableStickiness based on TruthValue"""
    defaultValue = 2


_TmnxRadSrvPlcyDisableStickiness_Type.__name__ = "TruthValue"
_TmnxRadSrvPlcyDisableStickiness_Object = MibTableColumn
tmnxRadSrvPlcyDisableStickiness = _TmnxRadSrvPlcyDisableStickiness_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 2, 1, 126),
    _TmnxRadSrvPlcyDisableStickiness_Type()
)
tmnxRadSrvPlcyDisableStickiness.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyDisableStickiness.setStatus("current")


class _TmnxRadSrvPlcyAcctStartMinItvl_Type(Unsigned32):
    """Custom type tmnxRadSrvPlcyAcctStartMinItvl based on Unsigned32"""
    defaultValue = 0
...
_TmnxRadSrvPlcyAcctStartMinItvl_Type.__name__ = "Unsigned32"
_TmnxRadSrvPlcyAcctStartMinItvl_Object = MibTableColumn
tmnxRadSrvPlcyAcctStartMinItvl = _TmnxRadSrvPlcyAcctStartMinItvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 2, 1, 127),
    _TmnxRadSrvPlcyAcctStartMinItvl_Type()
)
tmnxRadSrvPlcyAcctStartMinItvl.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyAcctStartMinItvl.setStatus("current")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyAcctStartMinItvl.setUnits("seconds")


class _TmnxRadSrvPlcyAcctStartMaxItvl_Type(Unsigned32):
    """Custom type tmnxRadSrvPlcyAcctStartMaxItvl based on Unsigned32"""
    defaultValue = 0
...
_TmnxRadSrvPlcyAcctStartMaxItvl_Type.__name__ = "Unsigned32"
_TmnxRadSrvPlcyAcctStartMaxItvl_Object = MibTableColumn
tmnxRadSrvPlcyAcctStartMaxItvl = _TmnxRadSrvPlcyAcctStartMaxItvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 2, 1, 128),
    _TmnxRadSrvPlcyAcctStartMaxItvl_Type()
)
tmnxRadSrvPlcyAcctStartMaxItvl.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyAcctStartMaxItvl.setStatus("current")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyAcctStartMaxItvl.setUnits("seconds")


class _TmnxRadSrvPlcyAcctStartlifetim_Type(Unsigned32):
    """Custom type tmnxRadSrvPlcyAcctStartlifetim based on Unsigned32"""
    defaultValue = 0
...
_TmnxRadSrvPlcyAcctStartlifetim_Type.__name__ = "Unsigned32"
_TmnxRadSrvPlcyAcctStartlifetim_Object = MibTableColumn
tmnxRadSrvPlcyAcctStartlifetim = _TmnxRadSrvPlcyAcctStartlifetim_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 2, 1, 129),
    _TmnxRadSrvPlcyAcctStartlifetim_Type()
)
tmnxRadSrvPlcyAcctStartlifetim.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyAcctStartlifetim.setStatus("current")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyAcctStartlifetim.setUnits("hours")
...
_TmnxRadSrvPlcyNbrAcctStartBuf_Type = Counter32
_TmnxRadSrvPlcyNbrAcctStartBuf_Object = MibTableColumn
tmnxRadSrvPlcyNbrAcctStartBuf = _TmnxRadSrvPlcyNbrAcctStartBuf_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 8, 1, 7),
    _TmnxRadSrvPlcyNbrAcctStartBuf_Type()
)
tmnxRadSrvPlcyNbrAcctStartBuf.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyNbrAcctStartBuf.setStatus("current")
_TmnxRadSrvPlcyNbrAcctStartDrop_Type = Counter32
_TmnxRadSrvPlcyNbrAcctStartDrop_Object = MibTableColumn
tmnxRadSrvPlcyNbrAcctStartDrop = _TmnxRadSrvPlcyNbrAcctStartDrop_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 2, 8, 1, 8),
    _TmnxRadSrvPlcyNbrAcctStartDrop_Type()
)
tmnxRadSrvPlcyNbrAcctStartDrop.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyNbrAcctStartDrop.setStatus("current")
...
class _TmnxRadIsaPlcySrvAlgorithm_Type(TmnxSubRadIsaServAlgorithm):
    """Custom type tmnxRadIsaPlcySrvAlgorithm based on TmnxSubRadIsaServAlgorithm"""
    defaultValue = 1


_TmnxRadIsaPlcySrvAlgorithm_Type.__name__ = "TmnxSubRadIsaServAlgorithm"
...
class _TmnxRadIsaPlcyAcctUpdateTriggers_Type(Bits):
    """Custom type tmnxRadIsaPlcyAcctUpdateTriggers based on Bits"""
    defaultBinValue = "0"
...
_TmnxRadIsaPlcyAcctUpdateTriggers_Type.__name__ = "Bits"
_TmnxRadIsaPlcyAcctUpdateTriggers_Object = MibTableColumn
tmnxRadIsaPlcyAcctUpdateTriggers = _TmnxRadIsaPlcyAcctUpdateTriggers_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 6, 1, 1, 110),
    _TmnxRadIsaPlcyAcctUpdateTriggers_Type()
)
tmnxRadIsaPlcyAcctUpdateTriggers.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadIsaPlcyAcctUpdateTriggers.setStatus("current")


class _TmnxRadIsaPlcyPythonPolicy_Type(TNamedItemOrEmpty):
    """Custom type tmnxRadIsaPlcyPythonPolicy based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxRadIsaPlcyPythonPolicy_Type.__name__ = "TNamedItemOrEmpty"
_TmnxRadIsaPlcyPythonPolicy_Object = MibTableColumn
tmnxRadIsaPlcyPythonPolicy = _TmnxRadIsaPlcyPythonPolicy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 6, 1, 1, 111),
    _TmnxRadIsaPlcyPythonPolicy_Type()
)
tmnxRadIsaPlcyPythonPolicy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadIsaPlcyPythonPolicy.setStatus("current")


class _TmnxRadIsaPlcyInterval_Type(Unsigned32):
    """Custom type tmnxRadIsaPlcyInterval based on Unsigned32"""
    defaultValue = 0
...
_TmnxRadIsaPlcyInterval_Type.__name__ = "Unsigned32"
_TmnxRadIsaPlcyInterval_Object = MibTableColumn
tmnxRadIsaPlcyInterval = _TmnxRadIsaPlcyInterval_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 6, 1, 1, 112),
    _TmnxRadIsaPlcyInterval_Type()
)
tmnxRadIsaPlcyInterval.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadIsaPlcyInterval.setStatus("current")
if mibBuilder.loadTexts:
    tmnxRadIsaPlcyInterval.setUnits("hours")


class _TmnxRadIsaPlcyRateLimit_Type(Unsigned32):
    """Custom type tmnxRadIsaPlcyRateLimit based on Unsigned32"""
    defaultValue = 0
...
_TmnxRadIsaPlcyRateLimit_Type.__name__ = "Unsigned32"
_TmnxRadIsaPlcyRateLimit_Object = MibTableColumn
tmnxRadIsaPlcyRateLimit = _TmnxRadIsaPlcyRateLimit_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 6, 1, 1, 113),
    _TmnxRadIsaPlcyRateLimit_Type()
)
tmnxRadIsaPlcyRateLimit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRadIsaPlcyRateLimit.setStatus("current")
if mibBuilder.loadTexts:
    tmnxRadIsaPlcyRateLimit.setUnits("messages per second")
...
class _TmnxRadIsaSrvStatPurposeHoldDown_Type(Bits):
    """Custom type tmnxRadIsaSrvStatPurposeHoldDown based on Bits"""
    namedValues = NamedValues(
        *(("accounting", 0),
          ("authentication", 1),
          ("coa", 2))
...
_TmnxRadIsaSrvStatPurposeHoldDown_Type.__name__ = "Bits"
_TmnxRadIsaSrvStatPurposeHoldDown_Object = MibTableColumn
tmnxRadIsaSrvStatPurposeHoldDown = _TmnxRadIsaSrvStatPurposeHoldDown_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 79, 1, 6, 3, 1, 10),
    _TmnxRadIsaSrvStatPurposeHoldDown_Type()
)
tmnxRadIsaSrvStatPurposeHoldDown.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxRadIsaSrvStatPurposeHoldDown.setStatus("current")
...
tmnxRadIsaAuthGroup.setObjects(
      *(("TIMETRA-RADIUS-MIB", "tmnxRadIsaPlcyTableCh"),
        ...
        ("TIMETRA-RADIUS-MIB", "tmnxRadIsaPlcyAcctUpdateTriggers"),
...
tmnxRadProxSrvV12v0Group.setObjects(
      *(("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvCacheTrackAuth"),
        ...
        ("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvAttrMatAttrType"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvAttrMatVendorId"),
...
tmnxRadServHealthCheckGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 79, 2, 12)
)
tmnxRadServHealthCheckGroup.setObjects(
      *(("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyServerDownTimeout"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyTestAccntChecking"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyTestAccntIvl"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyTestAccntUserName"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyTestAccntPassword"))
)
if mibBuilder.loadTexts:
    tmnxRadServHealthCheckGroup.setStatus("current")

tmnxRadSrvPlcyV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 79, 2, 13)
)
tmnxRadSrvPlcyV14v0Group.setObjects(
    ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyDisableStickiness")
)
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyV14v0Group.setStatus("current")

tmnxRadIsaAuthV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 79, 2, 14)
)
tmnxRadIsaAuthV14v0Group.setObjects(
      *(("TIMETRA-RADIUS-MIB", "tmnxRadIsaPlcyPythonPolicy"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadIsaPlcyInterval"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadIsaPlcyRateLimit"))
)
if mibBuilder.loadTexts:
    tmnxRadIsaAuthV14v0Group.setStatus("current")

tmnxRadProxSrvV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 79, 2, 15)
)
tmnxRadProxSrvV14v0Group.setObjects(
    ("TIMETRA-RADIUS-MIB", "tmnxRadPSStatsTxDroppedByAuthC")
)
if mibBuilder.loadTexts:
    tmnxRadProxSrvV14v0Group.setStatus("current")

tmnxRadSrvPlcyV20v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 79, 2, 16)
)
tmnxRadSrvPlcyV20v0Group.setObjects(
      *(("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyAcctStartMinItvl"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyAcctStartMaxItvl"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyAcctStartlifetim"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyNbrAcctStartBuf"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyNbrAcctStartDrop"))
)
if mibBuilder.loadTexts:
    tmnxRadSrvPlcyV20v0Group.setStatus("current")
...
tmnxRadProxV13v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 79, 1, 6)
)
tmnxRadProxV13v0Compliance.setObjects(
      *(("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvV11v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvV12v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadServGroup"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadServV11v0Group"),
        ...
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyAcctOnOffV11v0Grp"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadServIpv6Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadServHealthCheckGroup"))
)
if mibBuilder.loadTexts:
    tmnxRadProxV13v0Compliance.setStatus(
        "obsolete"
    )

tmnxRadProxV14v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 79, 1, 7)
)
tmnxRadProxV14v0Compliance.setObjects(
      *(("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvV11v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvV12v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvV14v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadServGroup"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadServV11v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadScriptPlcyGroup"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadRouteDownlGroup"),
...
if mibBuilder.loadTexts:
    tmnxRadProxV14v0Compliance.setStatus(
        "obsolete"
    )

tmnxRadProxV20v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 79, 1, 8)
)
tmnxRadProxV20v0Compliance.setObjects(
      *(("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvV11v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvV12v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadProxSrvV14v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadServGroup"),
        ...
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyV14v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadIsaAuthV14v0Group"),
        ("TIMETRA-RADIUS-MIB", "tmnxRadSrvPlcyV20v0Group"))
)
if mibBuilder.loadTexts:
    tmnxRadProxV20v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TmnxAuthSecret": TmnxAuthSecret,
       "TmnxAuthSecretShort": TmnxAuthSecretShort,
       ...
       "tmnxRadProxV13v0Compliance": tmnxRadProxV13v0Compliance,
       "tmnxRadProxV14v0Compliance": tmnxRadProxV14v0Compliance,
       "tmnxRadProxV20v0Compliance": tmnxRadProxV20v0Compliance,
       ...
       "tmnxRadServHealthCheckGroup": tmnxRadServHealthCheckGroup,
       "tmnxRadSrvPlcyV14v0Group": tmnxRadSrvPlcyV14v0Group,
       "tmnxRadIsaAuthV14v0Group": tmnxRadIsaAuthV14v0Group,
       "tmnxRadProxSrvV14v0Group": tmnxRadProxSrvV14v0Group,
       "tmnxRadSrvPlcyV20v0Group": tmnxRadSrvPlcyV20v0Group,
       ...
       "tmnxRadProxSrvAttrMatAttrType": tmnxRadProxSrvAttrMatAttrType,
       "tmnxRadProxSrvAttrMatVendorId": tmnxRadProxSrvAttrMatVendorId,
       ...
       "tmnxRadPSStatsTxDroppedByAuthC": tmnxRadPSStatsTxDroppedByAuthC,
       ...
       "tmnxRadSrvPlcyServerDownTimeout": tmnxRadSrvPlcyServerDownTimeout,
       "tmnxRadSrvPlcyTestAccntChecking": tmnxRadSrvPlcyTestAccntChecking,
       "tmnxRadSrvPlcyTestAccntIvl": tmnxRadSrvPlcyTestAccntIvl,
       "tmnxRadSrvPlcyTestAccntUserName": tmnxRadSrvPlcyTestAccntUserName,
       "tmnxRadSrvPlcyTestAccntPassword": tmnxRadSrvPlcyTestAccntPassword,
       "tmnxRadSrvPlcyDisableStickiness": tmnxRadSrvPlcyDisableStickiness,
       "tmnxRadSrvPlcyAcctStartMinItvl": tmnxRadSrvPlcyAcctStartMinItvl,
       "tmnxRadSrvPlcyAcctStartMaxItvl": tmnxRadSrvPlcyAcctStartMaxItvl,
       "tmnxRadSrvPlcyAcctStartlifetim": tmnxRadSrvPlcyAcctStartlifetim,
       ...
       "tmnxRadSrvPlcyNbrAcctStartBuf": tmnxRadSrvPlcyNbrAcctStartBuf,
       ...
       "tmnxRadIsaPlcyAcctUpdateTriggers": tmnxRadIsaPlcyAcctUpdateTriggers,
       "tmnxRadIsaPlcyPythonPolicy": tmnxRadIsaPlcyPythonPolicy,
       "tmnxRadIsaPlcyInterval": tmnxRadIsaPlcyInterval,
       "tmnxRadIsaPlcyRateLimit": tmnxRadIsaPlcyRateLimit,
       ...
       "tmnxRadIsaSrvStatPurposeHoldDown": tmnxRadIsaSrvStatPurposeHoldDown,
