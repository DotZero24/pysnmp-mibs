...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MODULE-VIRTUALIZATION-MIB
...
class _CmVirtContextDescr_Type(SnmpAdminString):
    """Custom type cmVirtContextDescr based on SnmpAdminString"""
    defaultValue = OctetString("")


_CmVirtContextDescr_Type.__name__ = "SnmpAdminString"
...
_CmVirtContextStorageType_Type.__name__ = "StorageType"
...
_CmVirtContextIfMapStorageType_Type.__name__ = "StorageType"
...
cmVirtualizationCompliance.setObjects(
      *(("CISCO-MODULE-VIRTUALIZATION-MIB", "cmVirtContextconfigGroup"),
        ("CISCO-MODULE-VIRTUALIZATION-MIB", "cmVirtContextIfMapGroup"),
        ("CISCO-MODULE-VIRTUALIZATION-MIB", "cmVirtContextNotifControlGroup"),
        ("CISCO-MODULE-VIRTUALIZATION-MIB", "cmVirtContextNotificationGroup"))
)
if mibBuilder.loadTexts:
