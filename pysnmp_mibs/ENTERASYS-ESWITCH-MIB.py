...
mibBuilder.exportSymbols("ENTERASYS-ESWITCH-MIB", etsysESwitchRateLimitSwitch=etsysESwitchRateLimitSwitch, etsysESwitchRateLimit=etsysESwitchRateLimit, etsysESwitchProtocolGroup=etsysESwitchProtocolGroup, etsysESwitchCompliance=etsysESwitchCompliance, etsysESwitchBaseGroup=etsysESwitchBaseGroup, etsysESwitchEtherTypeEntry=etsysESwitchEtherTypeEntry, etsysESwitchAddrFilterTable=etsysESwitchAddrFilterTable, etsysESwitchEtherTypeTable=etsysESwitchEtherTypeTable, etsysESwitchProtocolReceivePort=etsysESwitchProtocolReceivePort, enterasysESwitchMIB=enterasysESwitchMIB, etsysESwitchEtherTypeIndex=etsysESwitchEtherTypeIndex, etsysESwitchObjects=etsysESwitchObjects, etsysESwitchEtherTypeStatus=etsysESwitchEtherTypeStatus, etsysESwitchProtocolTable=etsysESwitchProtocolTable, etsysESwitchGroups=etsysESwitchGroups, etsysESwitchEtherTypeGroup=etsysESwitchEtherTypeGroup, etsysESwitchEtherTypeValue=etsysESwitchEtherTypeValue, etsysESwitchFilter=etsysESwitchFilter, etsysESwitchRateLimitingEntry=etsysESwitchRateLimitingEntry, etsysESwitchProtocolStatus=etsysESwitchProtocolStatus, etsysESwitchAdminStatus=etsysESwitchAdminStatus, etsysESwitchProtocolIndex=etsysESwitchProtocolIndex, etsysESwitchProtocolObjects=etsysESwitchProtocolObjects, etsysESwitchProtocolType=etsysESwitchProtocolType, etsysESwitchProtocolAllowedToGoTo=etsysESwitchProtocolAllowedToGoTo, etsysESwitchParams=etsysESwitchParams, etsysESwitchAddrFilterEntry=etsysESwitchAddrFilterEntry, etsysESwitchRateLimitingTable=etsysESwitchRateLimitingTable, etsysESwitchCompliances=etsysESwitchCompliances, etsysESwitchProtocolVlanId=etsysESwitchProtocolVlanId, etsysESwitchAddressFilter=etsysESwitchAddressFilter, etsysESwitchConformance=etsysESwitchConformance, etsysESwitchRateLimiting=etsysESwitchRateLimiting, etsysESwitchEtherTypePreempted=etsysESwitchEtherTypePreempted, etsysESwitchProtocolConstraint=etsysESwitchProtocolConstraint, etsysESwitchProtocolPreempted=etsysESwitchProtocolPreempted, PYSNMP_MODULE_ID=enterasysESwitchMIB, etsysESwitchProtocolEntry=etsysESwitchProtocolEntry)
