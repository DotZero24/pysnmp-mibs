...
ifType, InterfaceIndexOrZero, ifName, ifIndex, ifAdminStatus, ifOperStatus = mibBuilder.importSymbols("IF-MIB", "ifType", "InterfaceIndexOrZero", "ifName", "ifIndex", "ifAdminStatus", "ifOperStatus")
...
mibBuilder.exportSymbols("CISCO-IF-EXTENSION-MIB", cieIfIndexPersistenceControl=cieIfIndexPersistenceControl, cieIfIndex=cieIfIndex, cieIfInPktRate=cieIfInPktRate, cieIfUtilTable=cieIfUtilTable, ciscoIfExtensionMIBCompliance2=ciscoIfExtensionMIBCompliance2, cieDelayedLinkUpDownNotif=cieDelayedLinkUpDownNotif, cieIfNameMappingTable=cieIfNameMappingTable, cieIfCarrierTransitionCount=cieIfCarrierTransitionCount, cieIfInOverrunErrs=cieIfInOverrunErrs, cieIfNameMappingEntry=cieIfNameMappingEntry, cieIfDuplexDetectStatus=cieIfDuplexDetectStatus, cieIfDropVlOutOctets=cieIfDropVlOutOctets, cieIfTransceiverFrequencyConfig=cieIfTransceiverFrequencyConfig, ciscoIfExtensionTableIntfGroup3=ciscoIfExtensionTableIntfGroup3, InterfaceOperModeList=InterfaceOperModeList, ciscoIfExtensionMIBGroups=ciscoIfExtensionMIBGroups, PYSNMP_MODULE_ID=ciscoIfExtensionMIB, cieIfMtu=cieIfMtu, ciscoIfExtIfNameMapping=ciscoIfExtIfNameMapping, cieIfDuplexCfgStatus=cieIfDuplexCfgStatus, cieIfVlStatsGroup=cieIfVlStatsGroup, cieIfName=cieIfName, cieLinkUpDownNotifEnableGroup=cieLinkUpDownNotifEnableGroup, cieIfIgnoreBitErrorsConfig=cieIfIgnoreBitErrorsConfig, cieIfDot1qCustomEtherTypeTable=cieIfDot1qCustomEtherTypeTable, ciscoIfExtensionMIBCompliance5=ciscoIfExtensionMIBCompliance5, cieIfIndexPersistenceTable=cieIfIndexPersistenceTable, cieLinkDown=cieLinkDown, cieIfInAbortErrs=cieIfInAbortErrs, cieIfInGiantsErrs=cieIfInGiantsErrs, cieIfDropVlInPkts=cieIfDropVlInPkts, cieLinkUpDownConfig=cieLinkUpDownConfig, cieIfOwner=cieIfOwner, cieIfLastOutHangTime=cieIfLastOutHangTime, cieIfIndexPersistence=cieIfIndexPersistence, cieIfDot1dBaseMappingTable=cieIfDot1dBaseMappingTable, cieIfOutOctetRate=cieIfOutOctetRate, ciscoIfExtensionTableIntfGroup=ciscoIfExtensionTableIntfGroup, cieIfStateChangeReason=cieIfStateChangeReason, cieDelayedLinkUpDownNotifNotifGroup=cieDelayedLinkUpDownNotifNotifGroup, cieIfInterfaceEntry=cieIfInterfaceEntry, cieIfLastOutTime=cieIfLastOutTime, cieIfResetCount=cieIfResetCount, ciscoIfExtensionAsymmetricalSpeedGroup=ciscoIfExtensionAsymmetricalSpeedGroup, cieIfOperStatusCauseDescr=cieIfOperStatusCauseDescr, ciscoIfExtensionSystemGroup=ciscoIfExtensionSystemGroup, cieIfPacketStatsEntry=cieIfPacketStatsEntry, ciscoIfExtUtilization=ciscoIfExtUtilization, ciscoIfExtensionMIBCompliance1=ciscoIfExtensionMIBCompliance1, cieIfStatusListEntry=cieIfStatusListEntry, cieIfOutputQueueDrops=cieIfOutputQueueDrops, cieIfDot1qCustomAdminEtherType=cieIfDot1qCustomAdminEtherType, cieStandardLinkUpDownVarbinds=cieStandardLinkUpDownVarbinds, cieDelayedLinkUpDownNotifNotifEnableGroup=cieDelayedLinkUpDownNotifNotifEnableGroup, cieIfUtilEntry=cieIfUtilEntry, ciscoIfExtensionMIBConformance=ciscoIfExtensionMIBConformance, ciscoIfExtensionMIBCompliance6=ciscoIfExtensionMIBCompliance6, cieIfDot1dBaseMappingEntry=cieIfDot1dBaseMappingEntry, cieIfDropVlOutPkts=cieIfDropVlOutPkts, ciscoIfExtensionTableIntfGroup1=ciscoIfExtensionTableIntfGroup1, cieIfIgnoreInterruptThresholdConfig=cieIfIgnoreInterruptThresholdConfig, cieIfStatusListTable=cieIfStatusListTable, cieLinkUp=cieLinkUp, cieIfNoDropVlOutOctets=cieIfNoDropVlOutOctets, IfIndexPersistenceState=IfIndexPersistenceState, cieIfInRuntsErrs=cieIfInRuntsErrs, ciscoIfExtensionMIBCompliance14=ciscoIfExtensionMIBCompliance14, ciscoIfExtensionTablePacketGroup=ciscoIfExtensionTablePacketGroup, cieLinkUpDownNotifGroup=cieLinkUpDownNotifGroup, cieIfContextName=cieIfContextName, ciscoIfExtDot1dBaseMappingGroup=ciscoIfExtDot1dBaseMappingGroup, cieIfHighSpeedReceive=cieIfHighSpeedReceive, cieInterfacesIndex=cieInterfacesIndex, cieIfKeepAliveEnabled=cieIfKeepAliveEnabled, ciscoIfExtensionMIBCompliance=ciscoIfExtensionMIBCompliance, ciscoIfExtensionMIBCompliance15=ciscoIfExtensionMIBCompliance15, cieIfNoDropVlInPkts=cieIfNoDropVlInPkts, cieIfDhcpMode=cieIfDhcpMode, cieInterfaceOwnershipBitmap=cieInterfaceOwnershipBitmap, cieIfLastInTime=cieIfLastInTime, ciscoIfExtensionMIBCompliance7=ciscoIfExtensionMIBCompliance7, ciscoIfExtensionTableIntfGroup3SupR02=ciscoIfExtensionTableIntfGroup3SupR02, cieIfVlStatsTable=cieIfVlStatsTable, InterfaceOwnershipList=InterfaceOwnershipList, ciscoIfExtensionMIBCompliance4=ciscoIfExtensionMIBCompliance4, ciscoIfExtensionStats=ciscoIfExtensionStats, ciscoIfExtIfNameMappingGroup=ciscoIfExtIfNameMappingGroup, cieLinkUpDownEnable=cieLinkUpDownEnable, cieIfInterfaceDiscontinuityTime=cieIfInterfaceDiscontinuityTime, cieIfVlStatsEntry=cieIfVlStatsEntry, ciscoIfExtensionTableIntfGroup3SupR01=ciscoIfExtensionTableIntfGroup3SupR01, cieIfDropVlInOctets=cieIfDropVlInOctets, cieIfIndexPersistenceEnabled=cieIfIndexPersistenceEnabled, cieIfSpeedReceive=cieIfSpeedReceive, cieIfNoDropVlInOctets=cieIfNoDropVlInOctets, ciscoIfExtensionMIBCompliance3=ciscoIfExtensionMIBCompliance3, cieIfSpeedGroupConfig=cieIfSpeedGroupConfig, cieIfInOctetRate=cieIfInOctetRate, ciscoIfExtUtilizationGroup=ciscoIfExtUtilizationGroup, ciscoIfExtDot1dBaseMapping=ciscoIfExtDot1dBaseMapping, cieIfInFramingErrs=cieIfInFramingErrs, cieIfIndexPersistenceGroup=cieIfIndexPersistenceGroup, cieIfInputQueueDrops=cieIfInputQueueDrops, cieLinkUpDownNotifConfigGroup=cieLinkUpDownNotifConfigGroup, cieIfInterval=cieIfInterval, ciscoIfExtensionTableIntfGroup2=ciscoIfExtensionTableIntfGroup2, ciscoIfExtensionMIBCompliance12=ciscoIfExtensionMIBCompliance12, ciscoIfExtensionMIBCompliance10=ciscoIfExtensionMIBCompliance10, InterfaceIndexList=InterfaceIndexList, cieSystemMtu=cieSystemMtu, cieIfIndexPersistenceEntry=cieIfIndexPersistenceEntry, cieIfIndexPersistenceControlGroup=cieIfIndexPersistenceControlGroup, cieIfPacketStatsTable=cieIfPacketStatsTable, ciscoIfExtUtilIntervalGroup=ciscoIfExtUtilIntervalGroup, ciscoIfExtensionMIBCompliances=ciscoIfExtensionMIBCompliances, ciscoIfExtDot1qCustomEtherType=ciscoIfExtDot1qCustomEtherType, cieInterfacesOperCause=cieInterfacesOperCause, cieDelayedLinkUpDownNotifEnable=cieDelayedLinkUpDownNotifEnable, ciscoIfExtSystemConfig=ciscoIfExtSystemConfig, cieIfStatusListGroupSup1=cieIfStatusListGroupSup1, cieIfOutPktRate=cieIfOutPktRate, cieIfStatusListIndex=cieIfStatusListIndex, cieIfStatusListGroup=cieIfStatusListGroup, cieDelayedLinkUpDownNotifDelay=cieDelayedLinkUpDownNotifDelay, cieInterfacesOperMode=cieInterfacesOperMode, cieIfInIgnored=cieIfInIgnored, ciscoIfExtensionMIBCompliance11=ciscoIfExtensionMIBCompliance11, cieIfDot1qCustomEtherTypeEntry=cieIfDot1qCustomEtherTypeEntry, cieIfSharedConfig=cieIfSharedConfig, ciscoIfExtensionMIBCompliance9=ciscoIfExtensionMIBCompliance9, ciscoIfExtDot1qEtherTypeGroup=ciscoIfExtDot1qEtherTypeGroup, ciscoIfExtensionMIBNotifications=ciscoIfExtensionMIBNotifications, ciscoIfExtensionMIBObjects=ciscoIfExtensionMIBObjects, cieIfDot1qCustomOperEtherType=cieIfDot1qCustomOperEtherType, cieIfInterfaceTable=cieIfInterfaceTable, InterfaceOperCauseList=InterfaceOperCauseList, cieIfPacketDiscontinuityTime=cieIfPacketDiscontinuityTime, cieIfIndexGlobalPersistence=cieIfIndexGlobalPersistence, ciscoIfExtensionMIBCompliance13=ciscoIfExtensionMIBCompliance13, ciscoIfExtensionMIBCompliance8=ciscoIfExtensionMIBCompliance8, ciscoIfExtensionMIB=ciscoIfExtensionMIB, cieIfNoDropVlOutPkts=cieIfNoDropVlOutPkts, cieIfFillPatternConfig=cieIfFillPatternConfig, cieIfOperStatusCause=cieIfOperStatusCause, cieIfDot1dBaseMappingPort=cieIfDot1dBaseMappingPort)
