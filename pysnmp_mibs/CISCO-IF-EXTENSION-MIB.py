...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-IF-EXTENSION-MIB
...
ifName, ifType, ifOperStatus, ifAdminStatus, InterfaceIndexOrZero, ifIndex = mibBuilder.importSymbols("IF-MIB", "ifName", "ifType", "ifOperStatus", "ifAdminStatus", "InterfaceIndexOrZero", "ifIndex")
...
cieIfSpeedGroupConfig = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 276, 1, 1, 2, 1, 15), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(("notApplicable", 1), ("tenG", 2), ("oneTwoFourEightG", 3), ("twoFourEightSixteenG", 4), ("fourEightSixteenThirtyTwoG", 5), ("eightSixteenThirtyTwoSixtyFourG", 6)))).setMaxAccess("readwrite")
...
cieIfDuplexCfgStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 276, 1, 1, 2, 1, 20), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3))).clone(namedValues=NamedValues(("full", 0), ("half", 1), ("auto", 2), ("unsupported", 3)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: cieIfDuplexCfgStatus.setStatus('current')
cieIfDuplexDetectStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 276, 1, 1, 2, 1, 21), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4))).clone(namedValues=NamedValues(("full", 0), ("half", 1), ("auto", 2), ("unknown", 3), ("invalid", 4)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: cieIfDuplexDetectStatus.setStatus('current')
...
mibBuilder.exportSymbols("CISCO-IF-EXTENSION-MIB", cieIfIndexPersistenceControlGroup=cieIfIndexPersistenceControlGroup, ciscoIfExtensionMIBCompliance9=ciscoIfExtensionMIBCompliance9, cieIfTransceiverFrequencyConfig=cieIfTransceiverFrequencyConfig, ciscoIfExtensionMIBCompliance6=ciscoIfExtensionMIBCompliance6, cieDelayedLinkUpDownNotifDelay=cieDelayedLinkUpDownNotifDelay, ciscoIfExtensionTablePacketGroup=ciscoIfExtensionTablePacketGroup, cieIfOperStatusCauseDescr=cieIfOperStatusCauseDescr, cieIfKeepAliveEnabled=cieIfKeepAliveEnabled, cieIfNoDropVlInPkts=cieIfNoDropVlInPkts, cieIfUtilTable=cieIfUtilTable, cieIfStatusListIndex=cieIfStatusListIndex, cieIfInOctetRate=cieIfInOctetRate, ciscoIfExtUtilizationGroup=ciscoIfExtUtilizationGroup, cieIfDropVlOutPkts=cieIfDropVlOutPkts, cieIfSpeedGroupConfig=cieIfSpeedGroupConfig, cieIfPacketStatsEntry=cieIfPacketStatsEntry, ciscoIfExtensionMIBCompliance14=ciscoIfExtensionMIBCompliance14, cieDelayedLinkUpDownNotifEnable=cieDelayedLinkUpDownNotifEnable, cieIfStatusListEntry=cieIfStatusListEntry, ciscoIfExtensionTableIntfGroup1=ciscoIfExtensionTableIntfGroup1, cieLinkUp=cieLinkUp, cieInterfacesOperCause=cieInterfacesOperCause, cieLinkUpDownNotifConfigGroup=cieLinkUpDownNotifConfigGroup, ciscoIfExtensionTableIntfGroup3SupR02=ciscoIfExtensionTableIntfGroup3SupR02, cieIfDropVlOutOctets=cieIfDropVlOutOctets, cieLinkUpDownConfig=cieLinkUpDownConfig, cieIfIndex=cieIfIndex, cieIfSpeedReceive=cieIfSpeedReceive, cieIfStatusListTable=cieIfStatusListTable, cieIfVlStatsTable=cieIfVlStatsTable, cieIfOutputQueueDrops=cieIfOutputQueueDrops, ciscoIfExtUtilIntervalGroup=ciscoIfExtUtilIntervalGroup, ciscoIfExtensionMIBCompliance15=ciscoIfExtensionMIBCompliance15, PYSNMP_MODULE_ID=ciscoIfExtensionMIB, ciscoIfExtSystemConfig=ciscoIfExtSystemConfig, cieIfDot1qCustomAdminEtherType=cieIfDot1qCustomAdminEtherType, ciscoIfExtensionMIBCompliance=ciscoIfExtensionMIBCompliance, ciscoIfExtensionMIBCompliance8=ciscoIfExtensionMIBCompliance8, cieLinkUpDownNotifGroup=cieLinkUpDownNotifGroup, ciscoIfExtensionTableIntfGroup3SupR01=ciscoIfExtensionTableIntfGroup3SupR01, cieIfIndexPersistence=cieIfIndexPersistence, InterfaceIndexList=InterfaceIndexList, cieIfLastInTime=cieIfLastInTime, cieIfInterfaceTable=cieIfInterfaceTable, cieIfVlStatsGroup=cieIfVlStatsGroup, cieIfLastOutTime=cieIfLastOutTime, ciscoIfExtDot1qEtherTypeGroup=ciscoIfExtDot1qEtherTypeGroup, cieIfContextName=cieIfContextName, cieDelayedLinkUpDownNotifNotifEnableGroup=cieDelayedLinkUpDownNotifNotifEnableGroup, cieIfDot1dBaseMappingPort=cieIfDot1dBaseMappingPort, cieIfInGiantsErrs=cieIfInGiantsErrs, cieIfVlStatsEntry=cieIfVlStatsEntry, cieInterfacesIndex=cieInterfacesIndex, cieIfOutPktRate=cieIfOutPktRate, cieIfInAbortErrs=cieIfInAbortErrs, cieIfStateChangeReason=cieIfStateChangeReason, cieIfIgnoreBitErrorsConfig=cieIfIgnoreBitErrorsConfig, ciscoIfExtensionMIBCompliances=ciscoIfExtensionMIBCompliances, cieIfStatusListGroupSup1=cieIfStatusListGroupSup1, ciscoIfExtensionTableIntfGroup2=ciscoIfExtensionTableIntfGroup2, InterfaceOperModeList=InterfaceOperModeList, ciscoIfExtDot1qCustomEtherType=ciscoIfExtDot1qCustomEtherType, cieIfNoDropVlOutOctets=cieIfNoDropVlOutOctets, cieIfOutOctetRate=cieIfOutOctetRate, cieIfSharedConfig=cieIfSharedConfig, ciscoIfExtensionMIBCompliance10=ciscoIfExtensionMIBCompliance10, cieIfInFramingErrs=cieIfInFramingErrs, cieIfIndexPersistenceControl=cieIfIndexPersistenceControl, cieIfDhcpMode=cieIfDhcpMode, ciscoIfExtensionMIB=ciscoIfExtensionMIB, cieIfDot1qCustomEtherTypeEntry=cieIfDot1qCustomEtherTypeEntry, cieIfCarrierTransitionCount=cieIfCarrierTransitionCount, cieSystemMtu=cieSystemMtu, ciscoIfExtensionMIBGroups=ciscoIfExtensionMIBGroups, ciscoIfExtensionMIBNotifications=ciscoIfExtensionMIBNotifications, cieIfNoDropVlOutPkts=cieIfNoDropVlOutPkts, cieIfStatusListGroup=cieIfStatusListGroup, cieIfDot1qCustomEtherTypeTable=cieIfDot1qCustomEtherTypeTable, ciscoIfExtensionMIBConformance=ciscoIfExtensionMIBConformance, ciscoIfExtensionMIBCompliance11=ciscoIfExtensionMIBCompliance11, ciscoIfExtensionMIBCompliance3=ciscoIfExtensionMIBCompliance3, cieIfFillPatternConfig=cieIfFillPatternConfig, cieIfDot1dBaseMappingEntry=cieIfDot1dBaseMappingEntry, cieIfIgnoreInterruptThresholdConfig=cieIfIgnoreInterruptThresholdConfig, cieIfNameMappingTable=cieIfNameMappingTable, ciscoIfExtensionMIBCompliance1=ciscoIfExtensionMIBCompliance1, ciscoIfExtensionMIBCompliance5=ciscoIfExtensionMIBCompliance5, cieIfInPktRate=cieIfInPktRate, cieIfOwner=cieIfOwner, cieIfIndexGlobalPersistence=cieIfIndexGlobalPersistence, cieLinkUpDownNotifEnableGroup=cieLinkUpDownNotifEnableGroup, cieIfIndexPersistenceGroup=cieIfIndexPersistenceGroup, cieIfLastOutHangTime=cieIfLastOutHangTime, cieIfDropVlInOctets=cieIfDropVlInOctets, cieLinkUpDownEnable=cieLinkUpDownEnable, ciscoIfExtensionMIBCompliance4=ciscoIfExtensionMIBCompliance4, cieIfOperStatusCause=cieIfOperStatusCause, ciscoIfExtensionMIBCompliance13=ciscoIfExtensionMIBCompliance13, cieInterfacesOperMode=cieInterfacesOperMode, cieIfPacketDiscontinuityTime=cieIfPacketDiscontinuityTime, ciscoIfExtensionAsymmetricalSpeedGroup=ciscoIfExtensionAsymmetricalSpeedGroup, cieIfInputQueueDrops=cieIfInputQueueDrops, cieIfDropVlInPkts=cieIfDropVlInPkts, cieIfInterval=cieIfInterval, ciscoIfExtDot1dBaseMapping=ciscoIfExtDot1dBaseMapping, cieIfInterfaceDiscontinuityTime=cieIfInterfaceDiscontinuityTime, cieIfResetCount=cieIfResetCount, ciscoIfExtensionMIBCompliance2=ciscoIfExtensionMIBCompliance2, ciscoIfExtensionTableIntfGroup=ciscoIfExtensionTableIntfGroup, cieIfInRuntsErrs=cieIfInRuntsErrs, cieIfPacketStatsTable=cieIfPacketStatsTable, ciscoIfExtensionMIBCompliance7=ciscoIfExtensionMIBCompliance7, cieIfInIgnored=cieIfInIgnored, ciscoIfExtensionMIBObjects=ciscoIfExtensionMIBObjects, cieStandardLinkUpDownVarbinds=cieStandardLinkUpDownVarbinds, cieIfIndexPersistenceEnabled=cieIfIndexPersistenceEnabled, cieDelayedLinkUpDownNotifNotifGroup=cieDelayedLinkUpDownNotifNotifGroup, cieIfMtu=cieIfMtu, cieIfInOverrunErrs=cieIfInOverrunErrs, IfIndexPersistenceState=IfIndexPersistenceState, cieIfName=cieIfName, ciscoIfExtUtilization=ciscoIfExtUtilization, cieIfDuplexCfgStatus=cieIfDuplexCfgStatus, ciscoIfExtensionMIBCompliance12=ciscoIfExtensionMIBCompliance12, cieIfDot1dBaseMappingTable=cieIfDot1dBaseMappingTable, cieIfDuplexDetectStatus=cieIfDuplexDetectStatus, cieLinkDown=cieLinkDown, cieIfDot1qCustomOperEtherType=cieIfDot1qCustomOperEtherType, cieIfIndexPersistenceTable=cieIfIndexPersistenceTable, cieIfNameMappingEntry=cieIfNameMappingEntry, cieIfUtilEntry=cieIfUtilEntry, ciscoIfExtensionStats=ciscoIfExtensionStats, InterfaceOperCauseList=InterfaceOperCauseList, cieIfNoDropVlInOctets=cieIfNoDropVlInOctets, cieIfInterfaceEntry=cieIfInterfaceEntry, ciscoIfExtensionSystemGroup=ciscoIfExtensionSystemGroup, InterfaceOwnershipList=InterfaceOwnershipList, ciscoIfExtIfNameMappingGroup=ciscoIfExtIfNameMappingGroup, ciscoIfExtensionTableIntfGroup3=ciscoIfExtensionTableIntfGroup3, cieInterfaceOwnershipBitmap=cieInterfaceOwnershipBitmap, ciscoIfExtDot1dBaseMappingGroup=ciscoIfExtDot1dBaseMappingGroup, cieDelayedLinkUpDownNotif=cieDelayedLinkUpDownNotif, cieIfHighSpeedReceive=cieIfHighSpeedReceive, cieIfIndexPersistenceEntry=cieIfIndexPersistenceEntry, ciscoIfExtIfNameMapping=ciscoIfExtIfNameMapping)
