...
mibBuilder.exportSymbols("RFC7777-MIB", wfOspfVirtIfRxLinkStateUpds=wfOspfVirtIfRxLinkStateUpds, wfOspfVirtIfTxLinkStateUpds=wfOspfVirtIfTxLinkStateUpds, wfOspfIfRtrDeadInterval=wfOspfIfRtrDeadInterval, wfOspfAreaState=wfOspfAreaState, wfOspfVirtIfHelloInterval=wfOspfVirtIfHelloInterval, wfOspfNbrAddressLessIndex=wfOspfNbrAddressLessIndex, wfOspfASBdrRtrStatus=wfOspfASBdrRtrStatus, wfOspfIfHelloInterval=wfOspfIfHelloInterval, wfOspfDynNbrIfAddr=wfOspfDynNbrIfAddr, wfOspfVirtIfRxDBDescripts=wfOspfVirtIfRxDBDescripts, wfOspfVirtNbrIpAddr=wfOspfVirtNbrIpAddr, wfOspfAddressLessIf=wfOspfAddressLessIf, wfOspfVirtNbrTable=wfOspfVirtNbrTable, wfOspfIfTxHellos=wfOspfIfTxHellos, wfOspfAreaRangeState=wfOspfAreaRangeState, wfOspfVirtNbrEvents=wfOspfVirtNbrEvents, wfOspfVirtIfRtrDeadInterval=wfOspfVirtIfRtrDeadInterval, wfOspfDynNbrState=wfOspfDynNbrState, wfOspfIfIpAddress=wfOspfIfIpAddress, wfOspfImportASExtern=wfOspfImportASExtern, wfOspfIfRxLinkStateAcks=wfOspfIfRxLinkStateAcks, wfOspfVirtIfRxLinkStateAcks=wfOspfVirtIfRxLinkStateAcks, wfOspfIfTxLinkStateReqs=wfOspfIfTxLinkStateReqs, wfOspfVirtIfDrops=wfOspfVirtIfDrops, wfOspfNbrIfAddr=wfOspfNbrIfAddr, wfOspfSpfCnt=wfOspfSpfCnt, wfOspfGeneralDelete=wfOspfGeneralDelete, wfOspfIfDesignatedRouter=wfOspfIfDesignatedRouter, wfOspfLsdbAdvLen=wfOspfLsdbAdvLen, wfOspfVirtIfRxHellos=wfOspfVirtIfRxHellos, wfOspfNbrOptions=wfOspfNbrOptions, wfOspfVirtNbrState=wfOspfVirtNbrState, wfOspfVirtIfDisable=wfOspfVirtIfDisable, wfOspfMtuSize=wfOspfMtuSize, wfOspfIfType=wfOspfIfType, wfOspfVirtIfEntry=wfOspfVirtIfEntry, wfOspfVirtIfTable=wfOspfVirtIfTable, wfOspfAreaBdrRtrStatus=wfOspfAreaBdrRtrStatus, wfOspfVirtIfAuthKey=wfOspfVirtIfAuthKey, wfOspfSlotMask=wfOspfSlotMask, wfOspfLsdbRouterId=wfOspfLsdbRouterId, wfOspfVirtNbrEntry=wfOspfVirtNbrEntry, wfOspfAreaRangeAreaID=wfOspfAreaRangeAreaID, wfOspfIfEntry=wfOspfIfEntry, wfOspfIfRetransInterval=wfOspfIfRetransInterval, wfOspfVirtIfRxLinkStateReqs=wfOspfVirtIfRxLinkStateReqs, wfOspfVirtNbrLSRetransQLen=wfOspfVirtNbrLSRetransQLen, wfOspfDynNbrEntry=wfOspfDynNbrEntry, wfOspfLsdbChecksum=wfOspfLsdbChecksum, wfOspfVirtIfDelete=wfOspfVirtIfDelete, wfOspfVirtIfTxHellos=wfOspfVirtIfTxHellos, wellfleet=wellfleet, wfOspfLsdbAreaId=wfOspfLsdbAreaId, wfOspfAreaRangeTable=wfOspfAreaRangeTable, wfOspfGeneralDisable=wfOspfGeneralDisable, wfOspfGeneralState=wfOspfGeneralState, wfOspfIfPollInterval=wfOspfIfPollInterval, wfOspfNbrEvents=wfOspfNbrEvents, wfOspfNbrDisable=wfOspfNbrDisable, wfOspfRouterId=wfOspfRouterId, wfOspfDynNbrAddressLessIndex=wfOspfDynNbrAddressLessIndex, wfOspfIfRxDBDescripts=wfOspfIfRxDBDescripts, wfOspfIfRxHellos=wfOspfIfRxHellos, wfOspfAreaRangeNet=wfOspfAreaRangeNet, wfOspfIfTable=wfOspfIfTable, wfOspfDynNbrEvents=wfOspfDynNbrEvents, wfOspfIfRxLinkStateUpds=wfOspfIfRxLinkStateUpds, wfOspfNbrLSRetransQLen=wfOspfNbrLSRetransQLen, wfOspfDynNbrPriority=wfOspfDynNbrPriority, wfOspfIfMetricCost=wfOspfIfMetricCost, wfOspfLsdbLSID=wfOspfLsdbLSID, wfOspfIfRtrPriority=wfOspfIfRtrPriority, wfOspfVirtIfNeighbor=wfOspfVirtIfNeighbor, wfOspfVirtIfTransitDelay=wfOspfVirtIfTransitDelay, wfOspfVirtNbrArea=wfOspfVirtNbrArea, wfOspfAreaTable=wfOspfAreaTable, wfOspfDynNbrTable=wfOspfDynNbrTable, wfOspfAreaDisable=wfOspfAreaDisable, wfOspfLsdbEntry=wfOspfLsdbEntry, wfOspfNbrPriority=wfOspfNbrPriority, wfOspfVirtIfState=wfOspfVirtIfState, wfOspfNbrDelete=wfOspfNbrDelete, wfOspfIfDisable=wfOspfIfDisable, wfOspfAreaRangeDisable=wfOspfAreaRangeDisable, wfOspfNbrEntry=wfOspfNbrEntry, wfOspfAreaRangeDelete=wfOspfAreaRangeDelete, wfOspfVirtNbrOptions=wfOspfVirtNbrOptions, wfOspfDynNbrIpAddr=wfOspfDynNbrIpAddr, wfOspfStubMetric=wfOspfStubMetric, wfOspfIfDelete=wfOspfIfDelete, wfOspfIfTxLinkStateAcks=wfOspfIfTxLinkStateAcks, wfOspfDynNbrLSRetransQLen=wfOspfDynNbrLSRetransQLen, wfOspfIfBackupDesignatedRouter=wfOspfIfBackupDesignatedRouter, wfOspfDynNbrOptions=wfOspfDynNbrOptions, wfOspfIfTxLinkStateUpds=wfOspfIfTxLinkStateUpds, wfOspfAuthType=wfOspfAuthType, wfOspfIfDrops=wfOspfIfDrops, wfOspfGeneralGroup=wfOspfGeneralGroup, wfOspfLsdbAge=wfOspfLsdbAge, wfOspfVirtIfRetransInterval=wfOspfVirtIfRetransInterval, wfOspfVirtIfTxDBDescripts=wfOspfVirtIfTxDBDescripts, wfOspfNbrRtrId=wfOspfNbrRtrId, wfOspfAreaDelete=wfOspfAreaDelete, wfOspfLsdbType=wfOspfLsdbType, wfOspfVirtNbrRtrId=wfOspfVirtNbrRtrId, wfOspfAreaId=wfOspfAreaId, wfOspfAreaRangeMask=wfOspfAreaRangeMask, wfOspfIfAuthKey=wfOspfIfAuthKey, wfOspfIfTransitDelay=wfOspfIfTransitDelay, wfOspfIfRxLinkStateReqs=wfOspfIfRxLinkStateReqs, wfOspfAreaEntry=wfOspfAreaEntry, wfOspfIfAreaId=wfOspfIfAreaId, wfOspfSpfHoldDown=wfOspfSpfHoldDown, wfOspfAreaRangeEntry=wfOspfAreaRangeEntry, wfOspfNbrIpAddr=wfOspfNbrIpAddr, wfOspfNbrTable=wfOspfNbrTable, wfOspfTOSSupport=wfOspfTOSSupport, wfOspfVirtIfTxLinkStateAcks=wfOspfVirtIfTxLinkStateAcks, wfOspfIfState=wfOspfIfState, wfOspfNbrState=wfOspfNbrState, wfOspfVersionNumber=wfOspfVersionNumber, wfOspfLsdbSequence=wfOspfLsdbSequence, wfOspfVirtIfTxLinkStateReqs=wfOspfVirtIfTxLinkStateReqs, wfOspfImportSum=wfOspfImportSum, wfOspfIfTxDBDescripts=wfOspfIfTxDBDescripts, wfOspfVirtIfAreaID=wfOspfVirtIfAreaID, wfOspfDynNbrRtrId=wfOspfDynNbrRtrId, wfOspfLsdbTable=wfOspfLsdbTable)
