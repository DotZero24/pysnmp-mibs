...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SYS-INFO-LOG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:32:57 2025
...
class _CsilServerRcpUserName_Type(SnmpAdminString):
    """Custom type csilServerRcpUserName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CsilServerRcpUserName_Type.__name__ = "SnmpAdminString"
...
_CsilServerInterval_Type.__name__ = "Unsigned32"
...
ciscoSysInfoLogMIBCompliance.setObjects(
      *(("CISCO-SYS-INFO-LOG-MIB", "csilGlobalConfigGroup"),
        ("CISCO-SYS-INFO-LOG-MIB", "csilServerConfigGroup"),
        ("CISCO-SYS-INFO-LOG-MIB", "csilCommandConfigGroup"))
)
if mibBuilder.loadTexts:
