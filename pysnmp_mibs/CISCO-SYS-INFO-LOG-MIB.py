...
mibBuilder.exportSymbols("CISCO-SYS-INFO-LOG-MIB", PYSNMP_MODULE_ID=ciscoSysInfoLogMIB, csilServerConfigGroup=csilServerConfigGroup, csilMaxServerAllowed=csilMaxServerAllowed, csilMaxProfilePerServerAllowed=csilMaxProfilePerServerAllowed, csilServerProfileIndex=csilServerProfileIndex, csilLoggingFailNotif=csilLoggingFailNotif, ciscoSysInfoLogMIBGroups=ciscoSysInfoLogMIBGroups, csilServerIndex=csilServerIndex, csilCommandsEntry=csilCommandsEntry, csilServerProtocol=csilServerProtocol, csilCommandIndex=csilCommandIndex, csilCommandConfigGroup=csilCommandConfigGroup, ciscoSysInfoLogMIB=ciscoSysInfoLogMIB, csilServerLoggingFileName=csilServerLoggingFileName, csilCommandStatus=csilCommandStatus, csilServerAddressType=csilServerAddressType, csilCommandsTable=csilCommandsTable, ciscoSysInfoLogMIBObjects=ciscoSysInfoLogMIBObjects, csilLoggingFailNotifGroup=csilLoggingFailNotifGroup, csilSysInfoLogNotifEnabled=csilSysInfoLogNotifEnabled, csilCommandConfig=csilCommandConfig, csilSysInfoLogEnabled=csilSysInfoLogEnabled, csilGlobalConfigGroup=csilGlobalConfigGroup, csilServerInterval=csilServerInterval, csilServerLastStatus=csilServerLastStatus, csilMaxCommandPerProfile=csilMaxCommandPerProfile, ciscoSysInfoLogMIBCompliances=ciscoSysInfoLogMIBCompliances, csilGlobalConfig=csilGlobalConfig, csilServerRcpUserName=csilServerRcpUserName, csilServerConfig=csilServerConfig, ciscoSysInfoLogMIBNotifs=ciscoSysInfoLogMIBNotifs, csilServerEntry=csilServerEntry, csilCommandProfileIndex=csilCommandProfileIndex, ciscoSysInfoLogMIBConform=ciscoSysInfoLogMIBConform, csilNotifControlGroup=csilNotifControlGroup, ciscoSysInfoLogMIBCompliance=ciscoSysInfoLogMIBCompliance, csilCommandString=csilCommandString, csilServerTable=csilServerTable, csilServerRowStatus=csilServerRowStatus, csilCommandExecOrder=csilCommandExecOrder, csilServerAddress=csilServerAddress)
