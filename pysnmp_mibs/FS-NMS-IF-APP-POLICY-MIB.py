...
nmsIfAppPolicy=_NmsIfAppPolicy_ObjectIdentity((1,3,6,1,4,1,52642,9,65))
_NmsIfAppPolicyTable_Object=MibTable
nmsIfAppPolicyTable=_NmsIfAppPolicyTable_Object((1,3,6,1,4,1,52642,9,65,1))
if mibBuilder.loadTexts:nmsIfAppPolicyTable.setStatus(_A)
_NmsIfAppPolicyEntry_Object=MibTableRow
nmsIfAppPolicyEntry=_NmsIfAppPolicyEntry_Object((1,3,6,1,4,1,52642,9,65,1,1))
...
nmsIfIndex=_NmsIfIndex_Object((1,3,6,1,4,1,52642,9,65,1,1,1),_NmsIfIndex_Type())
...
nmsIfDescr=_NmsIfDescr_Object((1,3,6,1,4,1,52642,9,65,1,1,2),_NmsIfDescr_Type())
...
nmsIfInMacACL=_NmsIfInMacACL_Object((1,3,6,1,4,1,52642,9,65,1,1,3),_NmsIfInMacACL_Type())
...
nmsIfOutMacACL=_NmsIfOutMacACL_Object((1,3,6,1,4,1,52642,9,65,1,1,4),_NmsIfOutMacACL_Type())
...
nmsIfInIpACL=_NmsIfInIpACL_Object((1,3,6,1,4,1,52642,9,65,1,1,5),_NmsIfInIpACL_Type())
...
nmsIfOutIpACL=_NmsIfOutIpACL_Object((1,3,6,1,4,1,52642,9,65,1,1,6),_NmsIfOutIpACL_Type())
...
nmsIfInQosPolicyName=_NmsIfInQosPolicyName_Object((1,3,6,1,4,1,52642,9,65,1,1,7),_NmsIfInQosPolicyName_Type())
...
nmsIfOutQosPolicyName=_NmsIfOutQosPolicyName_Object((1,3,6,1,4,1,52642,9,65,1,1,8),_NmsIfOutQosPolicyName_Type())
