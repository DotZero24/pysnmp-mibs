...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-STACK-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:18:42 2025
...
class _H3cStackDomainId_Type(Unsigned32):
    """Custom type h3cStackDomainId based on Unsigned32"""
...
_H3cStackDomainId_Type.__name__ = "Unsigned32"
_H3cStackDomainId_Object = MibScalar
h3cStackDomainId = _H3cStackDomainId_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 91, 1, 8),
    _H3cStackDomainId_Type()
)
h3cStackDomainId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cStackDomainId.setStatus("current")


class _H3cStackPortConfigActivate_Type(Integer32):
    """Custom type h3cStackPortConfigActivate based on Integer32"""
    defaultValue = 1
...
_H3cStackPortConfigActivate_Type.__name__ = "Integer32"
_H3cStackPortConfigActivate_Object = MibScalar
h3cStackPortConfigActivate = _H3cStackPortConfigActivate_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 91, 1, 9),
    _H3cStackPortConfigActivate_Type()
)
h3cStackPortConfigActivate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cStackPortConfigActivate.setStatus("current")
...
class _H3cStackPortForwardingPath_Type(OctetString):
    """Custom type h3cStackPortForwardingPath based on OctetString"""
...
_H3cStackPortForwardingPath_Type.__name__ = "OctetString"
_H3cStackPortForwardingPath_Object = MibTableColumn
h3cStackPortForwardingPath = _H3cStackPortForwardingPath_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 91, 4, 1, 5),
    _H3cStackPortForwardingPath_Type()
)
h3cStackPortForwardingPath.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cStackPortForwardingPath.setStatus("current")
...
h3cStackMadBfdChangeNormal = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 91, 6, 0, 3)
)
h3cStackMadBfdChangeNormal.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"))
)
if mibBuilder.loadTexts:
    h3cStackMadBfdChangeNormal.setStatus(
        "current"
    )

h3cStackMadBfdChangeFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 91, 6, 0, 4)
)
h3cStackMadBfdChangeFailure.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"))
)
if mibBuilder.loadTexts:
    h3cStackMadBfdChangeFailure.setStatus(
        "current"
    )

h3cStackMadLacpChangeNormal = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 91, 6, 0, 5)
)
h3cStackMadLacpChangeNormal.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"))
)
if mibBuilder.loadTexts:
    h3cStackMadLacpChangeNormal.setStatus(
        "current"
    )

h3cStackMadLacpChangeFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 91, 6, 0, 6)
)
h3cStackMadLacpChangeFailure.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"))
)
if mibBuilder.loadTexts:
    h3cStackMadLacpChangeFailure.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"h3cStack": h3cStack,
       ...
       "h3cStackDomainId": h3cStackDomainId,
       "h3cStackPortConfigActivate": h3cStackPortConfigActivate,
       ...
       "h3cStackPortForwardingPath": h3cStackPortForwardingPath,
       ...
       "h3cStackMadBfdChangeNormal": h3cStackMadBfdChangeNormal,
       "h3cStackMadBfdChangeFailure": h3cStackMadBfdChangeFailure,
       "h3cStackMadLacpChangeNormal": h3cStackMadLacpChangeNormal,
       "h3cStackMadLacpChangeFailure": h3cStackMadLacpChangeFailure}
)
