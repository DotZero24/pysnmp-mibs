...
mibBuilder.exportSymbols("FOUNDRY-SN-POS-GROUP-MIB", snPOSInfoFraming=snPOSInfoFraming, snPOSInfoFlagJ0=snPOSInfoFlagJ0, snPOScHDLCEntry=snPOScHDLCEntry, snPOSInfo2Encapsulation=snPOSInfo2Encapsulation, snPOSInfo2Clock=snPOSInfo2Clock, snPOSInOctets=snPOSInOctets, snPOSInfo2OverheadJ1TransmitMessage=snPOSInfo2OverheadJ1TransmitMessage, snPOSInfo2SSM=snPOSInfo2SSM, snPOSStatsInBitsPerSec=snPOSStatsInBitsPerSec, snPOSInfo2FlagC2=snPOSInfo2FlagC2, snPOSStatsFrameTooShorts=snPOSStatsFrameTooShorts, snPOSStatsInFrames=snPOSStatsInFrames, snPOSStatsB3=snPOSStatsB3, snPOSInfoFlagH1=snPOSInfoFlagH1, snPOSInfo2Entry=snPOSInfo2Entry, snPOSStatsLOS=snPOSStatsLOS, snPOSInfoPortNum=snPOSInfoPortNum, snPOSInfo2Table=snPOSInfo2Table, snPOSInfoSpeed=snPOSInfoSpeed, snPOSInfoClock=snPOSInfoClock, snPOScHDLCPeerSeqSeen=snPOScHDLCPeerSeqSeen, snPOSInfoFlagC2=snPOSInfoFlagC2, snPOSPPPTable=snPOSPPPTable, snPOSInfo2AlarmMonitoring=snPOSInfo2AlarmMonitoring, snPOSStatsFrameTooLongs=snPOSStatsFrameTooLongs, snPOSName=snPOSName, snPOScHDLCTable=snPOScHDLCTable, snPOS=snPOS, snPOSStatsLOF=snPOSStatsLOF, snPOSInfo2OverheadJ0TransmitMessage=snPOSInfo2OverheadJ0TransmitMessage, snPOSStatsOutFrames=snPOSStatsOutFrames, PYSNMP_MODULE_ID=snPOS, snPOSStatsAIS=snPOSStatsAIS, snPOSStatsFCSErrors=snPOSStatsFCSErrors, snPOSStatsAlignErrors=snPOSStatsAlignErrors, snPOSStatsB1=snPOSStatsB1, snPOScHDLCMySeq=snPOScHDLCMySeq, snPOSIfIndex=snPOSIfIndex, snPOSStatsOutPktsPerSec=snPOSStatsOutPktsPerSec, snPosPppLcp=snPosPppLcp, snPOScHDLCInLoopback=snPOScHDLCInLoopback, snPosPppOsInLcp=snPosPppOsInLcp, snPOSInfo2ScrambleATM=snPOSInfo2ScrambleATM, snPOSTagType=snPOSTagType, snPOSInfoLoopBack=snPOSInfoLoopBack, snPOSStatsOutUtilization=snPOSStatsOutUtilization, snPOSInfo2KeepAlive=snPOSInfo2KeepAlive, snPOSStatsOutDiscard=snPOSStatsOutDiscard, snPOScHDLCUniqueSent=snPOScHDLCUniqueSent, snPOSStatsB2=snPOSStatsB2, snPOSInfo2OverheadJ0ExpectedMessage=snPOSInfo2OverheadJ0ExpectedMessage, snPOScHDLCUniqueReceived=snPOScHDLCUniqueReceived, snPOSInfoLinkStatus=snPOSInfoLinkStatus, snPosPppIpv6Cp=snPosPppIpv6Cp, snPOSInfo2OverheadJ1MessageLength=snPOSInfo2OverheadJ1MessageLength, snPOSInfo2CRC=snPOSInfo2CRC, snPOSDescr=snPOSDescr, snPosPppIpCp=snPosPppIpCp, snPOSInfoCRC=snPOSInfoCRC, snPOSInfoAdminStatus=snPOSInfoAdminStatus, snPOSInfo2OverheadJ1ExpectedMessage=snPOSInfo2OverheadJ1ExpectedMessage, snPOSOutOctets=snPOSOutOctets, snPOSStatsOutBitsPerSec=snPOSStatsOutBitsPerSec, snPosPppMpLscp=snPosPppMpLscp, snPOSStatsInPktsPerSec=snPOSStatsInPktsPerSec, snPOSStatsInDiscard=snPOSStatsInDiscard, snPOSInfo=snPOSInfo, snPOSStatsLOP=snPOSStatsLOP, snPOScHDLCLineState=snPOScHDLCLineState, POSStatus=POSStatus, snPOScHDLCMySeqSeen=snPOScHDLCMySeqSeen, snPOSInfoScrambleATM=snPOSInfoScrambleATM, snPOSInfoKeepAlive=snPOSInfoKeepAlive, snPOSInfoEntry=snPOSInfoEntry, snPOSStatsRDI=snPOSStatsRDI, snPOSPPPEntry=snPOSPPPEntry, snPOSInfoTable=snPOSInfoTable, snPOSStatsInUtilization=snPOSStatsInUtilization)
