...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cabletron/CTRON-PRIORITY-EXTENSIONS-MIB
...
mibBuilder.exportSymbols("CTRON-PRIORITY-EXTENSIONS-MIB", ctPriorityExtMaxNumMACEntries=ctPriorityExtMaxNumMACEntries, ctPriorityExtPortInterfaceNum=ctPriorityExtPortInterfaceNum, ctPriorityExtMACPktType=ctPriorityExtMACPktType, ctPriorityExtMACStatus=ctPriorityExtMACStatus, ctPriorityExtMACConfig=ctPriorityExtMACConfig, ctPriorityExtMACVlanId=ctPriorityExtMACVlanId, ctPriorityExtPortSlotNum=ctPriorityExtPortSlotNum, ctPriorityExtPktTypeStatus=ctPriorityExtPktTypeStatus, ctPriorityExtPortTable=ctPriorityExtPortTable, ctPriorityExtMaxNumPktTypesPerMACEntry=ctPriorityExtMaxNumPktTypesPerMACEntry, ctPriorityExtMACAddr=ctPriorityExtMACAddr, ctPriorityExtMaxNumPktTypeEntries=ctPriorityExtMaxNumPktTypeEntries, ctPriorityExtPktTypeConfig=ctPriorityExtPktTypeConfig, ctPriorityExtMACEntry=ctPriorityExtMACEntry, ctPriorityExtInterfaceNum=ctPriorityExtInterfaceNum, ctPriorityExtNumPktTypeEntries=ctPriorityExtNumPktTypeEntries, ctPriorityExtPktTypePriority=ctPriorityExtPktTypePriority, ctPriorityExtFwdInboundPriority=ctPriorityExtFwdInboundPriority, ctPriorityExtTXQueueTable=ctPriorityExtTXQueueTable, ctPriorityExtPktTypeEntry=ctPriorityExtPktTypeEntry, ctPriorityExtPktTypeTable=ctPriorityExtPktTypeTable, ctPriorityExtPortEntry=ctPriorityExtPortEntry, ctPriorityExtMACPriority=ctPriorityExtMACPriority, ctPriorityExtPortPriority=ctPriorityExtPortPriority, ctPriorityExtNumMACEntries=ctPriorityExtNumMACEntries, ctPriorityExtNumTXQueues=ctPriorityExtNumTXQueues, ctPriorityExtMACTable=ctPriorityExtMACTable, ctPriorityExtPktType=ctPriorityExtPktType, ctPriorityExtPortStatus=ctPriorityExtPortStatus, ctPriorityExtSlotNum=ctPriorityExtSlotNum, ctPriorityExtPortConfig=ctPriorityExtPortConfig, ctPriorityExtPktTypeVlanId=ctPriorityExtPktTypeVlanId, ctPriorityExtTxQueue=ctPriorityExtTxQueue, ctPriorityExtAddrType=ctPriorityExtAddrType, ctPriorityExtTXQueueEntry=ctPriorityExtTXQueueEntry)
