# SNMP MIB module (NETGEAR-MVR-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-MVR-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:29:03 2025
...
mvrPortMembershipEntry = _MvrPortMembershipEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 50, 4, 1)
)
mvrPortMembershipEntry.setIndexNames(
    (0, "NETGEAR-MVR-PRIVATE-MIB", "mvrPortMembershipGroupIPAddress"),
    (0, "NETGEAR-MVR-PRIVATE-MIB", "mvrPortMembershipPortIfIndex"),
)
if mibBuilder.loadTexts:
