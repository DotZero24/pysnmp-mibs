...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FCIP-MGMT-MIB
...
cfmFcipCompliance.setObjects(
      *(("CISCO-FCIP-MGMT-MIB", "cfmFcipEntityScalarGroup"),
        ("CISCO-FCIP-MGMT-MIB", "cfmFcipEntityInstanceGroup"),
        ("CISCO-FCIP-MGMT-MIB", "cfmFcipLinkGroup"),
        ("CISCO-FCIP-MGMT-MIB", "cfmFcipTcpConnGroup"),
        ("CISCO-FCIP-MGMT-MIB", "cfmFcipDynamicRouteGroup"),
        ("CISCO-FCIP-MGMT-MIB", "cfmFcipStaticRouteGroup"),
        ("CISCO-FCIP-MGMT-MIB", "cfmFcipLinkErrorsGroup"))
)
if mibBuilder.loadTexts:
