...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VISM-DSX1-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:32:20 2025
...
_VismTrunkConditionEnable_Type.__name__ = "TruthValue"
...
_VismDsx1V110Enable_Type.__name__ = "TruthValue"
...
_VismDsx1AlarmLogEnable_Type.__name__ = "TruthValue"
...
_VismDsx1ElectricalSignalEnable_Type.__name__ = "TruthValue"
...
_VismSlipCntDiscontinuityTime_Type.__name__ = "TimeStamp"
...
cvDsx1Compliance.setObjects(
      *(("CISCO-VISM-DSX1-MIB", "cvDsx1ConfGroup"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1AlmHistoryGroup"))
)
if mibBuilder.loadTexts:
...
cvDsx1ComplianceRev1.setObjects(
      *(("CISCO-VISM-DSX1-MIB", "cvDsx1ConfGroupRev1"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1AlmHistoryGroup"))
)
if mibBuilder.loadTexts:
...
cvDsx1ComplianceRev2.setObjects(
      *(("CISCO-VISM-DSX1-MIB", "cvDsx1ConfGroupRev2"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1AlmHistoryGroup"))
)
if mibBuilder.loadTexts:
...
cvDsx1ComplianceRev3.setObjects(
      *(("CISCO-VISM-DSX1-MIB", "cvDsx1ConfGroupRev2"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1AlmHistoryGroupRev1"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1StatsGroup"))
)
if mibBuilder.loadTexts:
...
cvDsx1ComplianceRev4.setObjects(
      *(("CISCO-VISM-DSX1-MIB", "cvDsx1ConfGroupRev2"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1AlmHistoryGroupRev1"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1StatsGroup"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1ConfGroupSup1"))
)
if mibBuilder.loadTexts:
...
cvDsx1ComplianceRev5.setObjects(
      *(("CISCO-VISM-DSX1-MIB", "cvDsx1ConfGroupRev2"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1AlmHistoryGroupRev1"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1StatsGroup"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1ConfGroupSup1"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1AlarmLogGroup"),
        ("CISCO-VISM-DSX1-MIB", "cvDsx1ElecSigGroup"))
)
if mibBuilder.loadTexts:
