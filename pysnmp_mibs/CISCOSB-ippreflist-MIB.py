...
rlIpPrefList=_RlIpPrefList_ObjectIdentity((1,3,6,1,4,1,9,6,1,101,212))
_RlIpPrefListTable_Object=MibTable
rlIpPrefListTable=_RlIpPrefListTable_Object((1,3,6,1,4,1,9,6,1,101,212,1))
if mibBuilder.loadTexts:rlIpPrefListTable.setStatus(_A)
_RlIpPrefListEntry_Object=MibTableRow
rlIpPrefListEntry=_RlIpPrefListEntry_Object((1,3,6,1,4,1,9,6,1,101,212,1,1))
...
rlIpPrefListType=_RlIpPrefListType_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,1),_RlIpPrefListType_Type())
...
rlIpPrefListName=_RlIpPrefListName_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,2),_RlIpPrefListName_Type())
...
rlIpPrefListEntryIndex=_RlIpPrefListEntryIndex_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,3),_RlIpPrefListEntryIndex_Type())
...
rlIpPrefListEntryType=_RlIpPrefListEntryType_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,4),_RlIpPrefListEntryType_Type())
...
rlIpPrefListInetAddrType=_RlIpPrefListInetAddrType_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,5),_RlIpPrefListInetAddrType_Type())
...
rlIpPrefListInetAddr=_RlIpPrefListInetAddr_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,6),_RlIpPrefListInetAddr_Type())
...
rlIpPrefListPrefixLength=_RlIpPrefListPrefixLength_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,7),_RlIpPrefListPrefixLength_Type())
...
rlIpPrefListAction=_RlIpPrefListAction_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,8),_RlIpPrefListAction_Type())
...
rlIpPrefListGeLength=_RlIpPrefListGeLength_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,9),_RlIpPrefListGeLength_Type())
...
rlIpPrefListLeLength=_RlIpPrefListLeLength_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,10),_RlIpPrefListLeLength_Type())
...
rlIpPrefListDescription=_RlIpPrefListDescription_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,11),_RlIpPrefListDescription_Type())
...
rlIpPrefListHitCount=_RlIpPrefListHitCount_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,12),_RlIpPrefListHitCount_Type())
...
rlIpPrefListRowStatus=_RlIpPrefListRowStatus_Object((1,3,6,1,4,1,9,6,1,101,212,1,1,13),_RlIpPrefListRowStatus_Type())
...
rlIpPrefListInfoTable=_RlIpPrefListInfoTable_Object((1,3,6,1,4,1,9,6,1,101,212,2))
if mibBuilder.loadTexts:rlIpPrefListInfoTable.setStatus(_A)
_RlIpPrefListInfoEntry_Object=MibTableRow
rlIpPrefListInfoEntry=_RlIpPrefListInfoEntry_Object((1,3,6,1,4,1,9,6,1,101,212,2,1))
...
rlIpPrefListInfoType=_RlIpPrefListInfoType_Object((1,3,6,1,4,1,9,6,1,101,212,2,1,1),_RlIpPrefListInfoType_Type())
...
rlIpPrefListInfoName=_RlIpPrefListInfoName_Object((1,3,6,1,4,1,9,6,1,101,212,2,1,2),_RlIpPrefListInfoName_Type())
...
rlIpPrefListInfoEntriesNumber=_RlIpPrefListInfoEntriesNumber_Object((1,3,6,1,4,1,9,6,1,101,212,2,1,3),_RlIpPrefListInfoEntriesNumber_Type())
...
rlIpPrefListInfoRangeEntries=_RlIpPrefListInfoRangeEntries_Object((1,3,6,1,4,1,9,6,1,101,212,2,1,4),_RlIpPrefListInfoRangeEntries_Type())
...
rlIpPrefListInfoNextFreeIndex=_RlIpPrefListInfoNextFreeIndex_Object((1,3,6,1,4,1,9,6,1,101,212,2,1,5),_RlIpPrefListInfoNextFreeIndex_Type())
