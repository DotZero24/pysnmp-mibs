...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IKE-FLOW-EXT-MIB
...
cifeMIBCompliance.setObjects(
      *(("CISCO-IKE-FLOW-EXT-MIB", "cifeGlobalsGroup"),
        ("CISCO-IKE-FLOW-EXT-MIB", "cifeTunnelExtGroup"))
)
if mibBuilder.loadTexts:
