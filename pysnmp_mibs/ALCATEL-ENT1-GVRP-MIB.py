...
mibBuilder.exportSymbols("ALCATEL-ENT1-GVRP-MIB", gvrpVlanLimitReachedEvent=gvrpVlanLimitReachedEvent, alaGvrpPortConfigAllowRegistrationBitmap=alaGvrpPortConfigAllowRegistrationBitmap, alaGvrpPortStatsJoinInReceived=alaGvrpPortStatsJoinInReceived, alaGvrpPortStatsTotalPDUReceived=alaGvrpPortStatsTotalPDUReceived, alaGvrpPortConfigApplicantBitmap=alaGvrpPortConfigApplicantBitmap, gvrpPortConfigGroup=gvrpPortConfigGroup, alaGvrpPortStatsLeaveInReceived=alaGvrpPortStatsLeaveInReceived, alaGvrpPortStatsInvalidMsgsReceived=alaGvrpPortStatsInvalidMsgsReceived, gvrpPortStats=gvrpPortStats, alcatelIND1GVRPMIBGroups=alcatelIND1GVRPMIBGroups, alcatelIND1GVRPMIBConformance=alcatelIND1GVRPMIBConformance, alaGvrpPortStatsLeaveEmptyReceived=alaGvrpPortStatsLeaveEmptyReceived, alcatelIND1GVRPMIBCompliance=alcatelIND1GVRPMIBCompliance, alaGvrpPortConfigLeaveAllTimer=alaGvrpPortConfigLeaveAllTimer, alaGvrpTransparentSwitching=alaGvrpTransparentSwitching, alaGvrpPortConfigTable=alaGvrpPortConfigTable, alaGvrpPortStatsTotalMsgsTransmitted=alaGvrpPortStatsTotalMsgsTransmitted, alaGvrpPortConfigRestrictedRegistrationBitmap=alaGvrpPortConfigRestrictedRegistrationBitmap, alaGvrpPortStatsLeaveAllReceived=alaGvrpPortStatsLeaveAllReceived, alaGvrpPortStatsTotalPDUTransmitted=alaGvrpPortStatsTotalPDUTransmitted, alaGvrpPortStatsEmptyTransmitted=alaGvrpPortStatsEmptyTransmitted, alaGvrpPortStatsJoinEmptyReceived=alaGvrpPortStatsJoinEmptyReceived, gvrpNotificationGroup=gvrpNotificationGroup, alaGvrpPortStatsTotalMsgsReceived=alaGvrpPortStatsTotalMsgsReceived, alaGvrpGlobalClearStats=alaGvrpGlobalClearStats, alaGvrpPortStatsLeaveAllTransmitted=alaGvrpPortStatsLeaveAllTransmitted, alaGvrpPortConfigRestrictedApplicantBitmap=alaGvrpPortConfigRestrictedApplicantBitmap, alaGvrpPortStatsEmptyReceived=alaGvrpPortStatsEmptyReceived, alcatelIND1GVRPMIBNotifications=alcatelIND1GVRPMIBNotifications, alaGvrpPortConfigJoinTimer=alaGvrpPortConfigJoinTimer, alaGvrpPortStatsIfIndex=alaGvrpPortStatsIfIndex, alaGvrpPortStatsJoinInTransmitted=alaGvrpPortStatsJoinInTransmitted, alaGvrpPortConfigRegistrationBitmap=alaGvrpPortConfigRegistrationBitmap, gvrpPortStatsGroup=gvrpPortStatsGroup, alcatelIND1GVRPMIBObjects=alcatelIND1GVRPMIBObjects, alaGvrpPortConfigRegistrarMode=alaGvrpPortConfigRegistrarMode, gvrpPortBaseGroup=gvrpPortBaseGroup, alaGvrpPortStatsTable=alaGvrpPortStatsTable, alaGvrpPortStatsLeaveInTransmitted=alaGvrpPortStatsLeaveInTransmitted, alaGvrpPortConfigRegistrationToStaticVlanRestrict=alaGvrpPortConfigRegistrationToStaticVlanRestrict, PYSNMP_MODULE_ID=alcatelIND1GVRPMIB, alcatelIND1GVRPMIB=alcatelIND1GVRPMIB, alaGvrpPortStatsEntry=alaGvrpPortStatsEntry, alaGvrpPortConfigEntry=alaGvrpPortConfigEntry, alaGvrpPortConfigAllowApplicantBitmap=alaGvrpPortConfigAllowApplicantBitmap, alaGvrpPortConfigIfIndex=alaGvrpPortConfigIfIndex, alcatelIND1GVRPMIBCompliances=alcatelIND1GVRPMIBCompliances, gvrpPortConfig=gvrpPortConfig, alaGvrpPortConfigRegistrationToStaticVlan=alaGvrpPortConfigRegistrationToStaticVlan, alaGvrpPortConfigRegistrationToStaticVlanLearn=alaGvrpPortConfigRegistrationToStaticVlanLearn, alaGvrpPortConfigApplicantMode=alaGvrpPortConfigApplicantMode, alaGvrpPortStatsJoinEmptyTransmitted=alaGvrpPortStatsJoinEmptyTransmitted, alaGvrpPortStatsLeaveEmptyTransmitted=alaGvrpPortStatsLeaveEmptyTransmitted, alaGvrpMaxVlanLimit=alaGvrpMaxVlanLimit, alaGvrpPortStatsClearStats=alaGvrpPortStatsClearStats, alaGvrpPortConfigProviderBpduMac=alaGvrpPortConfigProviderBpduMac, alaGvrpPortConfigLeaveTimer=alaGvrpPortConfigLeaveTimer)
