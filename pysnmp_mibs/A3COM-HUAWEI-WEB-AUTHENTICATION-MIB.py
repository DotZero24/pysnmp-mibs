...
_C='IF-MIB'
_B='current'
_A='A3COM-HUAWEI-WEB-AUTHENTICATION-MIB'
...
h3cWaTrapObjects=_H3cWaTrapObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,93,1))
_H3cWaVlanID_Type=Integer32
_H3cWaVlanID_Object=MibScalar
h3cWaVlanID=_H3cWaVlanID_Object((1,3,6,1,4,1,43,45,1,10,2,93,1,1),_H3cWaVlanID_Type())
...
h3cWaReasonCode=_H3cWaReasonCode_Object((1,3,6,1,4,1,43,45,1,10,2,93,1,2),_H3cWaReasonCode_Type())
...
h3cWaActionCode=_H3cWaActionCode_Object((1,3,6,1,4,1,43,45,1,10,2,93,1,3),_H3cWaActionCode_Type())
...
h3cWaClientMacAddr=_H3cWaClientMacAddr_Object((1,3,6,1,4,1,43,45,1,10,2,93,1,4),_H3cWaClientMacAddr_Type())
...
h3cWaTrap=_H3cWaTrap_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,93,2))
_H3cWaTrapPrefix_ObjectIdentity=ObjectIdentity
h3cWaTrapPrefix=_H3cWaTrapPrefix_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,93,2,0))
h3cWaClientLogon=NotificationType((1,3,6,1,4,1,43,45,1,10,2,93,2,0,1))
h3cWaClientLogon.setObjects(*((_A,_F),(_C,_D),(_A,_G)))
if mibBuilder.loadTexts:h3cWaClientLogon.setStatus(_B)
h3cWaClientLogonFail=NotificationType((1,3,6,1,4,1,43,45,1,10,2,93,2,0,2))
h3cWaClientLogonFail.setObjects(*((_A,_F),(_C,_D),(_A,_G),(_A,_I)))
if mibBuilder.loadTexts:h3cWaClientLogonFail.setStatus(_B)
h3cWaClientLogout=NotificationType((1,3,6,1,4,1,43,45,1,10,2,93,2,0,3))
h3cWaClientLogout.setObjects(*((_A,_F),(_C,_D),(_A,_G),(_A,_I)))
if mibBuilder.loadTexts:h3cWaClientLogout.setStatus(_B)
h3cWaSysAction=NotificationType((1,3,6,1,4,1,43,45,1,10,2,93,2,0,4))
