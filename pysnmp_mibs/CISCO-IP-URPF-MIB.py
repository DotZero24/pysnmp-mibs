...
mibBuilder.exportSymbols("CISCO-IP-URPF-MIB", cipUrpfScalar=cipUrpfScalar, cipUrpfIfNotifyDropRateThreshold=cipUrpfIfNotifyDropRateThreshold, cipUrpfComputeInterval=cipUrpfComputeInterval, cipUrpfIfConfTable=cipUrpfIfConfTable, cipUrpfTable=cipUrpfTable, cipUrpfVrfName=cipUrpfVrfName, ciscoIpUrpfMIBCompliance=ciscoIpUrpfMIBCompliance, PYSNMP_MODULE_ID=ciscoIpUrpfMIB, cipUrpfVrfIfEntry=cipUrpfVrfIfEntry, ciscoIpUrpfMIBMainObjectGroup=ciscoIpUrpfMIBMainObjectGroup, cipUrpfIfWhichRouteTableID=cipUrpfIfWhichRouteTableID, ciscoIpUrpfMIBNotifs=ciscoIpUrpfMIBNotifs, cipUrpfEntry=cipUrpfEntry, cipUrpfDrops=cipUrpfDrops, ciscoIpUrpfMIBCompliances=ciscoIpUrpfMIBCompliances, ciscoIpUrpfMIBNotifyGroup=ciscoIpUrpfMIBNotifyGroup, cipUrpfStatistics=cipUrpfStatistics, cipUrpfInterfaceConfig=cipUrpfInterfaceConfig, cipUrpfVrf=cipUrpfVrf, cipUrpfIfNotifyDrHoldDownReset=cipUrpfIfNotifyDrHoldDownReset, cipUrpfVrfEntry=cipUrpfVrfEntry, cipUrpfIfDropRateNotify=cipUrpfIfDropRateNotify, cipUrpfVrfIfDrops=cipUrpfVrfIfDrops, cipUrpfIfDrops=cipUrpfIfDrops, cipUrpfIfConfEntry=cipUrpfIfConfEntry, cipUrpfIfVrfName=cipUrpfIfVrfName, UnicastRpfOptions=UnicastRpfOptions, UnicastRpfType=UnicastRpfType, cipUrpfVrfIfTable=cipUrpfVrfIfTable, cipUrpfIfDropRateNotifyEnable=cipUrpfIfDropRateNotifyEnable, ciscoIpUrpfMIBObjects=ciscoIpUrpfMIBObjects, ciscoIpUrpfMIB=ciscoIpUrpfMIB, cipUrpfDropRateWindow=cipUrpfDropRateWindow, cipUrpfDropNotifyHoldDownTime=cipUrpfDropNotifyHoldDownTime, cipUrpfIfIpVersion=cipUrpfIfIpVersion, cipUrpfVrfTable=cipUrpfVrfTable, cipUrpfIfDropRate=cipUrpfIfDropRate, cipUrpfIpVersion=cipUrpfIpVersion, cipUrpfIfMonEntry=cipUrpfIfMonEntry, cipUrpfIfMonTable=cipUrpfIfMonTable, ciscoIpUrpfMIBGroups=ciscoIpUrpfMIBGroups, ciscoIpUrpfMIBVrfObjectGroup=ciscoIpUrpfMIBVrfObjectGroup, cipUrpfIfCheckStrict=cipUrpfIfCheckStrict, cipUrpfIfSuppressedDrops=cipUrpfIfSuppressedDrops, cipUrpfIfDiscontinuityTime=cipUrpfIfDiscontinuityTime, ciscoIpUrpfMIBConformance=ciscoIpUrpfMIBConformance, cipUrpfDropRate=cipUrpfDropRate, cipUrpfVrfIfDiscontinuityTime=cipUrpfVrfIfDiscontinuityTime)
