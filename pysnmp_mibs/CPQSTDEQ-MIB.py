...
mibBuilder.exportSymbols("CPQSTDEQ-MIB", cpqSeEisaDmaChannel=cpqSeEisaDmaChannel, cpqSePartitionCoreCell=cpqSePartitionCoreCell, cpqSeOsCommonModuleDate=cpqSeOsCommonModuleDate, cpqSeCpuExtSpeed=cpqSeCpuExtSpeed, cpqSeCpuName=cpqSeCpuName, cpqSePciMemoryIndex=cpqSePciMemoryIndex, cpqSeOsCommonModuleName=cpqSeOsCommonModuleName, cpqSeCpuCacheWritePolicy=cpqSeCpuCacheWritePolicy, cpqSeCellReadyForReconfig=cpqSeCellReadyForReconfig, cpqSeSerialPortIndex=cpqSeSerialPortIndex, cpqSeEisaDmaEntry=cpqSeEisaDmaEntry, cpqSePCCardProductInfo=cpqSePCCardProductInfo, cpqSePciSlotWidth=cpqSePciSlotWidth, cpqSePciMaxSlotSpeed=cpqSePciMaxSlotSpeed, cpqSeCpuUncorrectableError=cpqSeCpuUncorrectableError, cpqSeUSBPortDeviceFailedSlot=cpqSeUSBPortDeviceFailedSlot, cpqSeEisaFunctCfgRev=cpqSeEisaFunctCfgRev, cpqSePCCardThermalFailure=cpqSePCCardThermalFailure, cpqSeEisaSlotType=cpqSeEisaSlotType, cpqSeUSBPortHwLocation=cpqSeUSBPortHwLocation, cpqSeFpuType=cpqSeFpuType, cpqSeCPUSerialNumberMfgr=cpqSeCPUSerialNumberMfgr, cpqSeEisaSlotBoardId=cpqSeEisaSlotBoardId, cpqSeFloppyDiskTable=cpqSeFloppyDiskTable, cpqSeCellBootInhibited=cpqSeCellBootInhibited, cpqSeEisaInitTable=cpqSeEisaInitTable, cpqSeEisaInitAddr=cpqSeEisaInitAddr, cpqSeLEDTable=cpqSeLEDTable, cpqSePciFunctDevStatus=cpqSePciFunctDevStatus, cpqSeNVMeSecureEraseFailed=cpqSeNVMeSecureEraseFailed, cpqSeCellSerialNumber=cpqSeCellSerialNumber, cpqSeCPUCoreIndex=cpqSeCPUCoreIndex, cpqSeCpuCacheHwLocation=cpqSeCpuCacheHwLocation, cpqSeUSBPortDevicePartNumber=cpqSeUSBPortDevicePartNumber, cpqSePCCardSlotPowerState=cpqSePCCardSlotPowerState, cpqSeTotalMem=cpqSeTotalMem, cpqSeCellIOCTablePtr=cpqSeCellIOCTablePtr, cpqSeSerialPortDesc=cpqSeSerialPortDesc, cpqSePCCardSlotEntry=cpqSePCCardSlotEntry, cpqSeCellToScanBusConnectionStatus=cpqSeCellToScanBusConnectionStatus, cpqSeComplexCellSlotPartitionName=cpqSeComplexCellSlotPartitionName, cpqSeUSBPortTable=cpqSeUSBPortTable, cpqSeBMCFwVer=cpqSeBMCFwVer, cpqSeLEDState=cpqSeLEDState, cpqSeLEDDescription=cpqSeLEDDescription, cpqSeFixedDiskHwLocation=cpqSeFixedDiskHwLocation, cpqSeOptRomSize=cpqSeOptRomSize, cpqSeEisaPortTable=cpqSeEisaPortTable, cpqSeComplexCellSlotStatusSlotNo=cpqSeComplexCellSlotStatusSlotNo, cpqSeEisaSlotEntry=cpqSeEisaSlotEntry, cpqSePCIeDiskCapacityMB=cpqSePCIeDiskCapacityMB, cpqSePCIeDiskPCIBusIndex=cpqSePCIeDiskPCIBusIndex, cpqSeBiosRomDataRaw=cpqSeBiosRomDataRaw, cpqSeEisaPortAllocIndex=cpqSeEisaPortAllocIndex, cpqSeEisaIntTable=cpqSeEisaIntTable, cpqSePciFunctHwLocation=cpqSePciFunctHwLocation, cpqSeEisaIntSlotIndex=cpqSeEisaIntSlotIndex, cpqSeFpuChipIndex=cpqSeFpuChipIndex, cpqSePciMemoryType=cpqSePciMemoryType, cpqSeParallelPortDesc=cpqSeParallelPortDesc, cpqSeSerialPortEntry=cpqSeSerialPortEntry, cpqSeFloppyDiskIndex=cpqSeFloppyDiskIndex, cpqSePartitionCLMRequestSize=cpqSePartitionCLMRequestSize, cpqSeRom=cpqSeRom, cpqSeCabinetIOXLED=cpqSeCabinetIOXLED, cpqSeOsCommonModuleIndex=cpqSeOsCommonModuleIndex, cpqSeIOCTable=cpqSeIOCTable, cpqSeUSBPortDeviceFaultTolerance=cpqSeUSBPortDeviceFaultTolerance, cpqSeComplexUUID=cpqSeComplexUUID, cpqSePcieTrainingFailed=cpqSePcieTrainingFailed, cpqSePCIeDiskPCIDeviceIndex=cpqSePCIeDiskPCIDeviceIndex, cpqSeUSBPort=cpqSeUSBPort, cpqSePCCardCondition=cpqSePCCardCondition, cpqSeEisaSlotIndex=cpqSeEisaSlotIndex, cpqSePCIeDiskTable=cpqSePCIeDiskTable, cpqSePartitionInterleaveAllocatedSize=cpqSePartitionInterleaveAllocatedSize, cpqSePciSlotHeaderType=cpqSePciSlotHeaderType, cpqSePCCardSlotTable=cpqSePCCardSlotTable, cpqSeIOCLEDState=cpqSeIOCLEDState, cpqSeIOCIOCNumber=cpqSeIOCIOCNumber, cpqSeCabinetLED=cpqSeCabinetLED, cpqSeCpuSlot=cpqSeCpuSlot, cpqSeFpuSpeed=cpqSeFpuSpeed, cpqSePCCardStatus=cpqSePCCardStatus, cpqSeMibRev=cpqSeMibRev, cpqSeMibRevMinor=cpqSeMibRevMinor, cpqSePartitionCLMAllocatedSize=cpqSePartitionCLMAllocatedSize, cpqSeCpuEntry=cpqSeCpuEntry, cpqSeLEDIndex=cpqSeLEDIndex, cpqSeEisaMemAccess=cpqSeEisaMemAccess, cpqSeUSBPortDeviceSerialNumber=cpqSeUSBPortDeviceSerialNumber, cpqSeEisaMemShare=cpqSeEisaMemShare, cpqSePCIeDiskTemperatureOk=cpqSePCIeDiskTemperatureOk, cpqSeCpuCore=cpqSeCpuCore, cpqSePartitionMemInterleavingType=cpqSePartitionMemInterleavingType, cpqSeComplexLockedProperty=cpqSeComplexLockedProperty, cpqSePciSlotSubSystemID=cpqSePciSlotSubSystemID, cpqSePciePhySlot=cpqSePciePhySlot, cpqSeEisaInitMask=cpqSeEisaInitMask, cpqSeCpuCondition=cpqSeCpuCondition, cpqSePCCardPhysLocation=cpqSePCCardPhysLocation, cpqSeUSBStorageDeviceRemoved=cpqSeUSBStorageDeviceRemoved, cpqSePciSlotEntry=cpqSePciSlotEntry, cpqSeEisaFreeFormEntry=cpqSeEisaFreeFormEntry, cpqSeFixedDiskType=cpqSeFixedDiskType, cpqSeCpuStatusChange=cpqSeCpuStatusChange, cpqSeCPUPartNumber=cpqSeCPUPartNumber, cpqSeEisaFreeFormValue=cpqSeEisaFreeFormValue, cpqSeCpuThreshPassed=cpqSeCpuThreshPassed, cpqSePcieFunctNegotiatedLinkWidth=cpqSePcieFunctNegotiatedLinkWidth, cpqSeEisaDmaXfer=cpqSeEisaDmaXfer, cpqSeSerialPortTable=cpqSeSerialPortTable, cpqSeEisaInitAllocIndex=cpqSeEisaInitAllocIndex, cpqSeEisaDmaAllocIndex=cpqSeEisaDmaAllocIndex, cpqSeEisaInitValue=cpqSeEisaInitValue, cpqSePCIeDiskHwLocation=cpqSePCIeDiskHwLocation, cpqSeIOCBayNumber=cpqSeIOCBayNumber, cpqSeCpuStatus=cpqSeCpuStatus, cpqSeEisaFunctIndex=cpqSeEisaFunctIndex, cpqSePCIeDiskCondition=cpqSePCIeDiskCondition, cpqSePciSlotExtendedInfo=cpqSePciSlotExtendedInfo, cpqSeEisaDmaFunctIndex=cpqSeEisaDmaFunctIndex, cpqSeFixedDiskEntry=cpqSeFixedDiskEntry, cpqSeEisaPortEntry=cpqSeEisaPortEntry, cpqSeComplexCellSlotStatusEntry=cpqSeComplexCellSlotStatusEntry, cpqSePciSlotIOCTablePtr=cpqSePciSlotIOCTablePtr, cpqSeCellBoardSpeed=cpqSeCellBoardSpeed, cpqSeKeyboardDesc=cpqSeKeyboardDesc, cpqSeUSBStorageDeviceSyncFailed=cpqSeUSBStorageDeviceSyncFailed, cpqSeEisaNvram=cpqSeEisaNvram, cpqSeFpuEntry=cpqSeFpuEntry, cpqSeEisaPortSlotIndex=cpqSeEisaPortSlotIndex, cpqSeUSBPortDeviceReadErrorCount=cpqSeUSBPortDeviceReadErrorCount, cpqSeMibCondition=cpqSeMibCondition, cpqSeEisaFunctInfo=cpqSeEisaFunctInfo, cpqSeCpuCellTablePtr=cpqSeCpuCellTablePtr, cpqSePciFunctClassDescription=cpqSePciFunctClassDescription, cpqSePartitionInstalledCells=cpqSePartitionInstalledCells, cpqSeUSBPortDeviceName=cpqSeUSBPortDeviceName, cpqSePciMemoryBusNumberIndex=cpqSePciMemoryBusNumberIndex, cpqSePciResetFail=cpqSePciResetFail, cpqSePCCardSlotThermalSensor=cpqSePCCardSlotThermalSensor, cpqSePciMemoryHwLocation=cpqSePciMemoryHwLocation, cpqSeSecureBootAuthFail=cpqSeSecureBootAuthFail, cpqSeCpuCacheLevelIndex=cpqSeCpuCacheLevelIndex, cpqSePciFunctRevID=cpqSePciFunctRevID, cpqSeEisaInitFunctIndex=cpqSeEisaInitFunctIndex, cpqSePCCardSlotThermalCapacity=cpqSePCCardSlotThermalCapacity, cpqSePciSlotBusNumberIndex=cpqSePciSlotBusNumberIndex, cpqSeUSBPortDeviceFeature=cpqSeUSBPortDeviceFeature, cpqSeEisaIntTrigger=cpqSeEisaIntTrigger, cpqSeOsCommonModulePurpose=cpqSeOsCommonModulePurpose, cpqSeCpuPowerpodStatus=cpqSeCpuPowerpodStatus, cpqSeCpuCacheStatus=cpqSeCpuCacheStatus, cpqSeUSBDeviceName=cpqSeUSBDeviceName, cpqSeFpuUnitIndex=cpqSeFpuUnitIndex, cpqSeEisaPortSize=cpqSeEisaPortSize, cpqSeLEDStateDuration=cpqSeLEDStateDuration, cpqSePciSlotSpeed=cpqSePciSlotSpeed, cpqSeUSBPortDeviceStatus=cpqSeUSBPortDeviceStatus, cpqSePciFunctClassCode=cpqSePciFunctClassCode, cpqSeProcessor=cpqSeProcessor, cpqSeFloppyDiskEntry=cpqSeFloppyDiskEntry, cpqSeCpuSpeed=cpqSeCpuSpeed, cpqSeMPFwVer=cpqSeMPFwVer, cpqSeUSBPortType=cpqSeUSBPortType, cpqSeCellTable=cpqSeCellTable, cpqSeLEDHardwareLocation=cpqSeLEDHardwareLocation, cpqSeUSBStorageDeviceAttached=cpqSeUSBStorageDeviceAttached, cpqSePciFunctDeviceID=cpqSePciFunctDeviceID, cpqSePCIeDiskOsName=cpqSePCIeDiskOsName, cpqSeEisaIntShare=cpqSeEisaIntShare, cpqSeEisaIntAllocIndex=cpqSeEisaIntAllocIndex, cpqSeEisaIntNum=cpqSeEisaIntNum, cpqSePCCardThermalSafe=cpqSePCCardThermalSafe, cpqSeCellInterleaveAllocatedSize=cpqSeCellInterleaveAllocatedSize, cpqSePciSlotType=cpqSePciSlotType, cpqSeComplexCellSlotStatusIndex=cpqSeComplexCellSlotStatusIndex, cpqSeCellCabinetNumber=cpqSeCellCabinetNumber, cpqSePCCardAssetTag=cpqSePCCardAssetTag, cpqSePCIeDiskWearStatus=cpqSePCIeDiskWearStatus, cpqSePciFunctDeviceNumberIndex=cpqSePciFunctDeviceNumberIndex, cpqSeCpuCurrentPerformanceState=cpqSeCpuCurrentPerformanceState, cpqSePartitionName=cpqSePartitionName, cpqSeVideoDesc=cpqSeVideoDesc, cpqSeComplexComputeCabinet=cpqSeComplexComputeCabinet, cpqSeCellCLMCondition=cpqSeCellCLMCondition, cpqSeOsCommon=cpqSeOsCommon, cpqSeSerialPortHwLocation=cpqSeSerialPortHwLocation, cpqSePciFunctTable=cpqSePciFunctTable, cpqSeFixedDiskHeads=cpqSeFixedDiskHeads, cpqSeCellLEDState=cpqSeCellLEDState, cpqSeCellPresent=cpqSeCellPresent, cpqSeInterface=cpqSeInterface, cpqSeCPUMaxSpeed=cpqSeCPUMaxSpeed, cpqSePcieFunctMaxLinkSpeed=cpqSePcieFunctMaxLinkSpeed, cpqSeInternalCpuError=cpqSeInternalCpuError, cpqStdEquipment=cpqStdEquipment, cpqSeComplexCellSlotPartitionNo=cpqSeComplexCellSlotPartitionNo, cpqSeEisaFreeFormSlotIndex=cpqSeEisaFreeFormSlotIndex, cpqSeCpuUnitIndex=cpqSeCpuUnitIndex, cpqSeEisaMemAllocIndex=cpqSeEisaMemAllocIndex, cpqSeUSBPortDeviceFWVersion=cpqSeUSBPortDeviceFWVersion, cpqSeEisaPortAddr=cpqSeEisaPortAddr, cpqSeCellState=cpqSeCellState, cpqSePCIeDiskWearStatusChange=cpqSePCIeDiskWearStatusChange, cpqSeCPUPartNumberMfgr=cpqSeCPUPartNumberMfgr, cpqSeEisaMemDecode=cpqSeEisaMemDecode, cpqSeSysRomVer=cpqSeSysRomVer, cpqSeCPUChipGenerationName=cpqSeCPUChipGenerationName, cpqSePCIeDiskPercntEndrnceUsed=cpqSePCIeDiskPercntEndrnceUsed, cpqSeSmbiosVer=cpqSeSmbiosVer, cpqSeMibRevMajor=cpqSeMibRevMajor, cpqSeEisaFreeFormFunctIndex=cpqSeEisaFreeFormFunctIndex, cpqSePciFunctIntLine=cpqSePciFunctIntLine, cpqSePCIeDiskTableCondition=cpqSePCIeDiskTableCondition, cpqSeLEDLocationType=cpqSeLEDLocationType, cpqSePciSegmentMode=cpqSePciSegmentMode, cpqSeUSBPortDeviceModel=cpqSeUSBPortDeviceModel, cpqSeEisaInitUseMask=cpqSeEisaInitUseMask, cpqSeCellEntry=cpqSeCellEntry, cpqSeUSBPortDeviceCapacity=cpqSeUSBPortDeviceCapacity, cpqSePciFunctEntry=cpqSePciFunctEntry, cpqSePartitionReadyForReconfigCells=cpqSePartitionReadyForReconfigCells, cpqSeEisaMemStartAddr=cpqSeEisaMemStartAddr, cpqSePCCardSlotWidth=cpqSePCCardSlotWidth, cpqSeParrallelPortHwLocation=cpqSeParrallelPortHwLocation, cpqSeEisaDmaSlotIndex=cpqSeEisaDmaSlotIndex, cpqSeCabinet=cpqSeCabinet, cpqSeParallelPortEntry=cpqSeParallelPortEntry, cpqSeFpuSlot=cpqSeFpuSlot, cpqSeEisaDmaShare=cpqSeEisaDmaShare, cpqSeCpuHwLocation=cpqSeCpuHwLocation, cpqSeComplexName=cpqSeComplexName, cpqSeFixedDiskSectors=cpqSeFixedDiskSectors, cpqSeCellPDHCFirmwareRevision=cpqSeCellPDHCFirmwareRevision, cpqSePCIeDiskCurrentTemperature=cpqSePCIeDiskCurrentTemperature, cpqSeKeyboard=cpqSeKeyboard, cpqSeFpuHwLocation=cpqSeFpuHwLocation, cpqSePCIeDiskPowerOnHours=cpqSePCIeDiskPowerOnHours, cpqSeCellCLMRequestSize=cpqSeCellCLMRequestSize, cpqSeEisaFunctType=cpqSeEisaFunctType, cpqSePCCardSlotType=cpqSePCCardSlotType, cpqSeEisaSlotTable=cpqSeEisaSlotTable, cpqSeUSBPortDeviceWriteErrorCount=cpqSeUSBPortDeviceWriteErrorCount, cpqSeCabinetTable=cpqSeCabinetTable, cpqSeUSBPortDeviceReadThreshold=cpqSeUSBPortDeviceReadThreshold, cpqSeParallelPortIndex=cpqSeParallelPortIndex, cpqSeIOC=cpqSeIOC, cpqSeIOCUnitIndex=cpqSeIOCUnitIndex, cpqSeFloppyDisk=cpqSeFloppyDisk, cpqSePciFunctVendorID=cpqSePciFunctVendorID, cpqSeCellHasCoreIO=cpqSeCellHasCoreIO, cpqSePartitionAvailableCellSlots=cpqSePartitionAvailableCellSlots)
mibBuilder.exportSymbols("CPQSTDEQ-MIB", cpqSeEisaSlotCfRev=cpqSeEisaSlotCfRev, cpqSePciSlotCurrentMode=cpqSePciSlotCurrentMode, cpqSeEisaFunctStatus=cpqSeEisaFunctStatus, cpqSeCPUCoreMaxThreads=cpqSeCPUCoreMaxThreads, cpqSeCpuCacheTable=cpqSeCpuCacheTable, cpqSeCPUCoreThreadIndex=cpqSeCPUCoreThreadIndex, cpqSePCIeDiskPCIFunctionIndex=cpqSePCIeDiskPCIFunctionIndex, cpqSePartitionCLMRequestPercentage=cpqSePartitionCLMRequestPercentage, cpqSeLED=cpqSeLED, cpqSeUSBStorageDeviceReadErrorOccurred=cpqSeUSBStorageDeviceReadErrorOccurred, cpqSeEisaPortShare=cpqSeEisaPortShare, cpqSePciSlotDeviceNumberIndex=cpqSePciSlotDeviceNumberIndex, cpqSePcieFunctNegotiatedLinkSpeed=cpqSePcieFunctNegotiatedLinkSpeed, cpqSePciDeviceRemovedOrPoweredOff=cpqSePciDeviceRemovedOrPoweredOff, cpqSePciDeviceAddedOrPoweredOn=cpqSePciDeviceAddedOrPoweredOn, cpqSeCpuStep=cpqSeCpuStep, cpqSeEisaMemFunctIndex=cpqSeEisaMemFunctIndex, cpqSeComponent=cpqSeComponent, cpqSeCpuCacheEntry=cpqSeCpuCacheEntry, cpqSeCpuMinPerformanceState=cpqSeCpuMinPerformanceState, cpqSeCpuPowerPodstatusChange=cpqSeCpuPowerPodstatusChange, cpqSeUSBDevice=cpqSeUSBDevice, cpqSeIsaCmosRaw=cpqSeIsaCmosRaw, cpqSeCpuCacheUnitIndex=cpqSeCpuCacheUnitIndex, cpqSeEisaFunctSlotIndex=cpqSeEisaFunctSlotIndex, cpqSeFpuTable=cpqSeFpuTable, cpqSeEisaDmaTable=cpqSeEisaDmaTable, cpqSeRedundantSysRomVer=cpqSeRedundantSysRomVer, cpqSeParallelPort=cpqSeParallelPort, cpqSeUSBPortDeviceCount=cpqSeUSBPortDeviceCount, cpqSeCellTotalMemory=cpqSeCellTotalMemory, cpqSeCpuMaxPerformanceState=cpqSeCpuMaxPerformanceState, cpqSeUSBPortDeviceLastSlotWithError=cpqSeUSBPortDeviceLastSlotWithError, cpqSeEisaIntFunctIndex=cpqSeEisaIntFunctIndex, cpqSeUSBPortEntry=cpqSeUSBPortEntry, cpqSeUSBPortDeviceWriteThreshold=cpqSeUSBPortDeviceWriteThreshold, cpqSePCCardThermalDegraded=cpqSePCCardThermalDegraded, cpqSeEisaMemType=cpqSeEisaMemType, cpqSeOptRomEntry=cpqSeOptRomEntry, cpqSeCabinetEntry=cpqSeCabinetEntry, cpqSeComplex=cpqSeComplex, cpqSePartitionNumber=cpqSePartitionNumber, cpqSePcieFunctMaxLinkWidth=cpqSePcieFunctMaxLinkWidth, cpqSeCell=cpqSeCell, cpqSeCPUSerialNumber=cpqSeCPUSerialNumber, cpqSeCellHasPower=cpqSeCellHasPower, cpqSeVideo=cpqSeVideo, cpqSeCabinetCPULED=cpqSeCabinetCPULED, cpqSePCIeDiskEntry=cpqSePCIeDiskEntry, cpqSeEisaDmaXferCount=cpqSeEisaDmaXferCount, cpqSeIOCEntry=cpqSeIOCEntry, cpqSeOptRomAddrIndex=cpqSeOptRomAddrIndex, cpqSeUSBPortDeviceManufacturer=cpqSeUSBPortDeviceManufacturer, cpqSePcieSlotMaxLinkWidth=cpqSePcieSlotMaxLinkWidth, cpqSeUSBPortIndex=cpqSeUSBPortIndex, cpqSeEisaIntEntry=cpqSeEisaIntEntry, cpqSeEisaSlotRaw=cpqSeEisaSlotRaw, cpqSePartitionCoreCellCabinet=cpqSePartitionCoreCellCabinet, cpqSeFloppyDiskHwLocation=cpqSeFloppyDiskHwLocation, cpqSePCIeDiskThresholdTemperature=cpqSePCIeDiskThresholdTemperature, cpqSeUSBStorageDeviceWriteErrorOccurred=cpqSeUSBStorageDeviceWriteErrorOccurred, cpqSePCIeDisk=cpqSePCIeDisk, cpqSePCIeDiskConditionChange=cpqSePCIeDiskConditionChange, cpqSePartitionPoweredOnCells=cpqSePartitionPoweredOnCells, cpqSePciCurrentSlotSpeed=cpqSePciCurrentSlotSpeed, cpqSeFloppyDiskType=cpqSeFloppyDiskType, cpqSeFpuName=cpqSeFpuName, cpqSeComplexCellSlotStatusCabinetNo=cpqSeComplexCellSlotStatusCabinetNo, cpqSeCpuCacheSpeed=cpqSeCpuCacheSpeed, cpqSeEisaInitAccess=cpqSeEisaInitAccess, cpqSeEisaFunctSels=cpqSeEisaFunctSels, cpqSePCCardDeviceInfo=cpqSePCCardDeviceInfo, cpqSeCpuCacheCpuCoreIndex=cpqSeCpuCacheCpuCoreIndex, cpqSeCpuCoreSteppingText=cpqSeCpuCoreSteppingText, cpqSeIOCPowerState=cpqSeIOCPowerState, cpqSePci=cpqSePci, cpqSeCellCLMAllocatedSize=cpqSeCellCLMAllocatedSize, TruthValue=TruthValue, cpqSeCellHasInterleaveMem=cpqSeCellHasInterleaveMem, cpqSePciXMaxSlotSpeed=cpqSePciXMaxSlotSpeed, cpqSeOsCommonModuleVersion=cpqSeOsCommonModuleVersion, cpqSeUSBStorageDeviceRedundancyRestored=cpqSeUSBStorageDeviceRedundancyRestored, cpqSeSerialPort=cpqSeSerialPort, cpqSeEisaInitSlotIndex=cpqSeEisaInitSlotIndex, cpqSeFixedDiskIndex=cpqSeFixedDiskIndex, cpqSeEisaFreeFormTable=cpqSeEisaFreeFormTable, cpqSeEisaMemSlotIndex=cpqSeEisaMemSlotIndex, cpqSePCCardSerialNumber=cpqSePCCardSerialNumber, cpqSeEisaMemSize=cpqSeEisaMemSize, cpqSeCpuThresholdPassed=cpqSeCpuThresholdPassed, cpqSeFixedDiskTable=cpqSeFixedDiskTable, cpqSe2CpuThresholdPassed=cpqSe2CpuThresholdPassed, cpqSeOsCommonModuleEntry=cpqSeOsCommonModuleEntry, cpqSePciFunctIndex=cpqSePciFunctIndex, cpqSeIsaCmos=cpqSeIsaCmos, cpqSeSerialPortAddr=cpqSeSerialPortAddr, cpqSePCIeDiskModel=cpqSePCIeDiskModel, cpqSeEisaMemEntry=cpqSeEisaMemEntry, cpqSeEisaFunctTable=cpqSeEisaFunctTable, cpqSeSecureBootCertAuthFail=cpqSeSecureBootCertAuthFail, cpqSeEisaSlotBoardName=cpqSeEisaSlotBoardName, cpqSeComplexIOXCabinet=cpqSeComplexIOXCabinet, cpqSeComplexCellSlotStatusTable=cpqSeComplexCellSlotStatusTable, cpqSeCPUMultiThreadStatus=cpqSeCPUMultiThreadStatus, cpqSeMemory=cpqSeMemory, cpqSeCabinetTypeNum=cpqSeCabinetTypeNum, cpqSeFixedDiskCyls=cpqSeFixedDiskCyls, cpqSePciSlotBoardName=cpqSePciSlotBoardName, cpqSeLEDEntry=cpqSeLEDEntry, cpqSeBaseMem=cpqSeBaseMem, cpqSeOsCommonModuleTable=cpqSeOsCommonModuleTable, cpqSeCpuTable=cpqSeCpuTable, cpqSePciMemoryTable=cpqSePciMemoryTable, cpqSeCellCellNumber=cpqSeCellCellNumber, cpqSeCpuCacheSize=cpqSeCpuCacheSize, cpqSeCpuCacheCpuSlot=cpqSeCpuCacheCpuSlot, cpqSeUSBPortStatus=cpqSeUSBPortStatus, cpqSeParallelPortTable=cpqSeParallelPortTable, cpqSePCIeDiskSerialNumber=cpqSePCIeDiskSerialNumber, cpqSePartition=cpqSePartition, cpqSePartitionTotalCPU=cpqSePartitionTotalCPU, cpqSeUSBStorageDeviceRedundancyLost=cpqSeUSBStorageDeviceRedundancyLost, cpqSePCIeDiskTemperatureFailed=cpqSePCIeDiskTemperatureFailed, cpqSeCpuSocketNumber=cpqSeCpuSocketNumber, cpqSePciPhysSlot=cpqSePciPhysSlot, cpqSePciMemoryDeviceNumberIndex=cpqSePciMemoryDeviceNumberIndex, cpqSeCpuDesigner=cpqSeCpuDesigner, cpqSeEisaInitEntry=cpqSeEisaInitEntry, cpqSeOptRomTable=cpqSeOptRomTable, cpqSePciHwLocation=cpqSePciHwLocation, cpqSeHPVMFwVer=cpqSeHPVMFwVer, cpqSeCpuLowPowerStatus=cpqSeCpuLowPowerStatus, cpqSeComplexTotalCabinet=cpqSeComplexTotalCabinet, cpqSePciMemoryFunctionIndex=cpqSePciMemoryFunctionIndex, cpqSeFixedDiskCapacity=cpqSeFixedDiskCapacity, cpqSeEisaMemDataSize=cpqSeEisaMemDataSize, cpqSePcieSlotMaxLinkSpeed=cpqSePcieSlotMaxLinkSpeed, cpqSeEisaMemCache=cpqSeEisaMemCache, cpqSeComplexCellSlotStatus=cpqSeComplexCellSlotStatus, cpqSePciMemoryBaseAddr=cpqSePciMemoryBaseAddr, cpqSeUSBDeviceType=cpqSeUSBDeviceType, cpqSeTotalMemMB=cpqSeTotalMemMB, cpqSeEisaDmaTiming=cpqSeEisaDmaTiming, cpqSeEisaPortFunctIndex=cpqSeEisaPortFunctIndex, cpqSePciFunctBusNumberIndex=cpqSePciFunctBusNumberIndex, cpqSeCpuArchitectureRevision=cpqSeCpuArchitectureRevision, cpqSePCIeDiskFwRev=cpqSePCIeDiskFwRev, cpqSeCpuPrimary=cpqSeCpuPrimary, cpqSePciSlotTable=cpqSePciSlotTable, cpqSeOsCommonPollFreq=cpqSeOsCommonPollFreq, cpqSeFixedDisk=cpqSeFixedDisk, cpqSePciIsSlot0Embedded=cpqSePciIsSlot0Embedded, cpqSeCellSysFwVersion=cpqSeCellSysFwVersion, cpqSePciMemoryEntry=cpqSePciMemoryEntry, cpqSeEisaMemTable=cpqSeEisaMemTable, cpqSeCellUnitIndex=cpqSeCellUnitIndex, cpqSeParallelPortAddr=cpqSeParallelPortAddr, cpqSeCabinetUnitIndex=cpqSeCabinetUnitIndex, cpqSePCCardSlotIndex=cpqSePCCardSlotIndex, cpqSePCCard=cpqSePCCard, cpqSeIOCCabinetNumber=cpqSeIOCCabinetNumber, cpqSeUSBPortDevicePresent=cpqSeUSBPortDevicePresent, cpqSeCellCLMRequestPercentage=cpqSeCellCLMRequestPercentage, cpqSePCIeEraseFailureType=cpqSePCIeEraseFailureType, cpqSeEisaFunctEntry=cpqSeEisaFunctEntry, cpqSePciMemorySize=cpqSePciMemorySize, cpqSePartitionHasInterleaveMem=cpqSePartitionHasInterleaveMem)
