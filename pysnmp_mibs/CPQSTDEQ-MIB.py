...
class _CpqSePciePhySlot_Type(Integer32):
    """Custom type cpqSePciePhySlot based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_CpqSePciePhySlot_Type.__name__ = "Integer32"
_CpqSePciePhySlot_Object = MibScalar
cpqSePciePhySlot = _CpqSePciePhySlot_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 13, 5),
    _CpqSePciePhySlot_Type()
)
cpqSePciePhySlot.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePciePhySlot.setStatus("mandatory")
...
class _CpqSePCIeEraseFailureType_Type(Integer32):
    """Custom type cpqSePCIeEraseFailureType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSePCIeEraseFailureType_Type.__name__ = "Integer32"
_CpqSePCIeEraseFailureType_Object = MibScalar
cpqSePCIeEraseFailureType = _CpqSePCIeEraseFailureType_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 3),
    _CpqSePCIeEraseFailureType_Type()
)
cpqSePCIeEraseFailureType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeEraseFailureType.setStatus("mandatory")
...
cpqSeNVMeSecureEraseFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1021)
)
cpqSeNVMeSecureEraseFailed.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIBusIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIDeviceIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIFunctionIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskSerialNumber"),
        ("CPQSTDEQ-MIB", "cpqSePCIeEraseFailureType"))
)
if mibBuilder.loadTexts:
    cpqSeNVMeSecureEraseFailed.setStatus(
        ""
    )

cpqSePcieTrainingFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1022)
)
cpqSePcieTrainingFailed.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePciePhySlot"))
)
if mibBuilder.loadTexts:
    cpqSePcieTrainingFailed.setStatus(
        ""
    )

cpqSePciResetFail = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1023)
)
cpqSePciResetFail.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePCCardSlotIndex"))
)
if mibBuilder.loadTexts:
    cpqSePciResetFail.setStatus(
        ""
    )

cpqSeSecureBootAuthFail = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1024)
)
cpqSeSecureBootAuthFail.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePciHwLocation"))
)
if mibBuilder.loadTexts:
    cpqSeSecureBootAuthFail.setStatus(
        ""
    )

cpqSeSecureBootCertAuthFail = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1025)
)
cpqSeSecureBootCertAuthFail.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePciHwLocation"))
)
if mibBuilder.loadTexts:
    cpqSeSecureBootCertAuthFail.setStatus(
        ""
    )

cpqSeCpuUncorrectableError = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1026)
)
cpqSeCpuUncorrectableError.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSeCpuUnitIndex"))
)
if mibBuilder.loadTexts:
    cpqSeCpuUncorrectableError.setStatus(
        ""
    )

cpqSeInternalCpuError = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1027)
)
cpqSeInternalCpuError.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"))
)
if mibBuilder.loadTexts:
    cpqSeInternalCpuError.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TruthValue": TruthValue,
       ...
       "cpqSeNVMeSecureEraseFailed": cpqSeNVMeSecureEraseFailed,
       "cpqSePcieTrainingFailed": cpqSePcieTrainingFailed,
       "cpqSePciResetFail": cpqSePciResetFail,
       "cpqSeSecureBootAuthFail": cpqSeSecureBootAuthFail,
       "cpqSeSecureBootCertAuthFail": cpqSeSecureBootCertAuthFail,
       "cpqSeCpuUncorrectableError": cpqSeCpuUncorrectableError,
       "cpqSeInternalCpuError": cpqSeInternalCpuError,
       ...
       "cpqSePciePhySlot": cpqSePciePhySlot,
       ...
       "cpqSePCIeEraseFailureType": cpqSePCIeEraseFailureType}
)
