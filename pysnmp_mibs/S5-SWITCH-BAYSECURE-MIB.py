...
mibBuilder.exportSymbols("S5-SWITCH-BAYSECURE-MIB", s5SbsCurrentPortSecurStatus=s5SbsCurrentPortSecurStatus, s5SbsSecurityListEntry=s5SbsSecurityListEntry, s5SbsSecurityListIndx=s5SbsSecurityListIndx, s5SbsSecurityListStatus=s5SbsSecurityListStatus, s5SbsAutoLearningConfigPort=s5SbsAutoLearningConfigPort, s5SbsMacViolation=s5SbsMacViolation, s5SbsAutoLearningConfigTable=s5SbsAutoLearningConfigTable, s5SbsAutoLearningAgingTime=s5SbsAutoLearningAgingTime, PortSet=PortSet, s5SbsAuthCfgStatus=s5SbsAuthCfgStatus, s5SbsMacViolationClear=s5SbsMacViolationClear, s5SbsSecurityMode=s5SbsSecurityMode, s5SbsMaxSecurityLists=s5SbsMaxSecurityLists, s5SbsDaFilteringIndx=s5SbsDaFilteringIndx, s5SbsAuthStatusBrdIndx=s5SbsAuthStatusBrdIndx, s5SbsMaxNodesAllowed=s5SbsMaxNodesAllowed, s5SbsDaFilteringTable=s5SbsDaFilteringTable, s5SbsAuthCtlPartTime=s5SbsAuthCtlPartTime, s5SbsCurrentActionMode=s5SbsCurrentActionMode, s5SbsMacViolationBrd=s5SbsMacViolationBrd, s5SbsAuthCfgSource=s5SbsAuthCfgSource, s5SbsAutoLearningConfigEnabled=s5SbsAutoLearningConfigEnabled, s5SbsMgmViolationIpAddress=s5SbsMgmViolationIpAddress, s5SbsAuthCfgSecureList=s5SbsAuthCfgSecureList, s5SbsPortLearnStatus=s5SbsPortLearnStatus, s5SbsAutoLearningSticky=s5SbsAutoLearningSticky, s5SbsCurrentAccessCtrlType=s5SbsCurrentAccessCtrlType, s5SbsAuthStatusEntry=s5SbsAuthStatusEntry, s5SbsDaFilteringAddress=s5SbsDaFilteringAddress, s5SbsAuthCfgAccessCtrlType=s5SbsAuthCfgAccessCtrlType, s5SbsViolationStatusBrdIndx=s5SbsViolationStatusBrdIndx, s5SbsViolationStatusTable=s5SbsViolationStatusTable, s5SbsSecurityListTable=s5SbsSecurityListTable, s5SbsAuthCfgTable=s5SbsAuthCfgTable, s5SbsCurrSecurityLists=s5SbsCurrSecurityLists, s5SbsSecurityListMembers=s5SbsSecurityListMembers, s5SbsAutoLearningConfigMaxMacs=s5SbsAutoLearningConfigMaxMacs, s5SbsCurrNodesAllowed=s5SbsCurrNodesAllowed, s5SbsMacViolationTable=s5SbsMacViolationTable, s5SbsAuthCfgMACIndx=s5SbsAuthCfgMACIndx, s5SbsMgmViolationType=s5SbsMgmViolationType, s5SbsAutoLearningPorts=s5SbsAutoLearningPorts, s5SbsSecurityLockoutPortList=s5SbsSecurityLockoutPortList, PYSNMP_MODULE_ID=s5SbsAuth, s5SbsMaxNodesBlocked=s5SbsMaxNodesBlocked, s5SbsSecurityAction=s5SbsSecurityAction, s5SbsSecurityStatus=s5SbsSecurityStatus, s5SbsViolationStatusEntry=s5SbsViolationStatusEntry, s5SbsViolationStatusMACAddress=s5SbsViolationStatusMACAddress, s5SbsAutoLearningConfigBrd=s5SbsAutoLearningConfigBrd, s5SbsDaFilteringEntry=s5SbsDaFilteringEntry, s5SbsCurrNodesBlocked=s5SbsCurrNodesBlocked, s5SbsAuth=s5SbsAuth, s5SbsMacViolationAddress=s5SbsMacViolationAddress, s5SbsAutoLearningConfigEntry=s5SbsAutoLearningConfigEntry, s5SbsAuthStatusMACIndx=s5SbsAuthStatusMACIndx, s5SbsMacViolationEntry=s5SbsMacViolationEntry, s5SbsAuthStatusPortIndx=s5SbsAuthStatusPortIndx, s5SbsMacViolationPort=s5SbsMacViolationPort, s5SbsAuthStatusTable=s5SbsAuthStatusTable, s5SbsAuthCfgPortIndx=s5SbsAuthCfgPortIndx, s5SbsDaFilteringStatus=s5SbsDaFilteringStatus, s5SbsAuthCfgEntry=s5SbsAuthCfgEntry, s5SbsAuthCfgLifetime=s5SbsAuthCfgLifetime, s5SbsViolationStatusPortIndx=s5SbsViolationStatusPortIndx, s5SbsAuthCfgTrunk=s5SbsAuthCfgTrunk, s5SbsPortSecurityStatus=s5SbsPortSecurityStatus, s5SbsAuthSecurityLock=s5SbsAuthSecurityLock, s5SbsAuthCfgBrdIndx=s5SbsAuthCfgBrdIndx)
