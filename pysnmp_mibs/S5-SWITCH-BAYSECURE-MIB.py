...
# Notes
# -----
# ASN.1 source file://mibs/nortel/S5-SWITCH-BAYSECURE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:18:45 2025
...
_S5SbsAutoLearningConfigEnabled_Type.__name__ = "TruthValue"
...
s5SbsDaFilteringTable = _S5SbsDaFilteringTable_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 5, 3, 26)
)
if mibBuilder.loadTexts:
    s5SbsDaFilteringTable.setStatus("current")
_S5SbsDaFilteringEntry_Object = MibTableRow
s5SbsDaFilteringEntry = _S5SbsDaFilteringEntry_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 5, 3, 26, 1)
)
s5SbsDaFilteringEntry.setIndexNames(
    (0, "S5-SWITCH-BAYSECURE-MIB", "s5SbsDaFilteringIndx"),
)
if mibBuilder.loadTexts:
    s5SbsDaFilteringEntry.setStatus("current")


class _S5SbsDaFilteringIndx_Type(Integer32):
    """Custom type s5SbsDaFilteringIndx based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_S5SbsDaFilteringIndx_Type.__name__ = "Integer32"
_S5SbsDaFilteringIndx_Object = MibTableColumn
s5SbsDaFilteringIndx = _S5SbsDaFilteringIndx_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 5, 3, 26, 1, 1),
    _S5SbsDaFilteringIndx_Type()
)
s5SbsDaFilteringIndx.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    s5SbsDaFilteringIndx.setStatus("current")
_S5SbsDaFilteringAddress_Type = MacAddress
_S5SbsDaFilteringAddress_Object = MibTableColumn
s5SbsDaFilteringAddress = _S5SbsDaFilteringAddress_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 5, 3, 26, 1, 2),
    _S5SbsDaFilteringAddress_Type()
)
s5SbsDaFilteringAddress.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    s5SbsDaFilteringAddress.setStatus("current")


class _S5SbsDaFilteringStatus_Type(Integer32):
    """Custom type s5SbsDaFilteringStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_S5SbsDaFilteringStatus_Type.__name__ = "Integer32"
_S5SbsDaFilteringStatus_Object = MibTableColumn
s5SbsDaFilteringStatus = _S5SbsDaFilteringStatus_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 5, 3, 26, 1, 3),
    _S5SbsDaFilteringStatus_Type()
)
s5SbsDaFilteringStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    s5SbsDaFilteringStatus.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"PortSet": PortSet,
       ...
       "s5SbsDaFilteringTable": s5SbsDaFilteringTable,
       "s5SbsDaFilteringEntry": s5SbsDaFilteringEntry,
       "s5SbsDaFilteringIndx": s5SbsDaFilteringIndx,
       "s5SbsDaFilteringAddress": s5SbsDaFilteringAddress,
       "s5SbsDaFilteringStatus": s5SbsDaFilteringStatus}
)
