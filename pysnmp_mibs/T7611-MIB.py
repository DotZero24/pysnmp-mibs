# SNMP MIB module (T7611-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T7611-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:16:21 2025
...
trapTest.setObjects(
      *(("T7611-MIB", "sensorName"),
        ("T7611-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
