...
mibBuilder.exportSymbols("HPN-ICF-LICENSE-MIB", hpnicfLicenseFeature=hpnicfLicenseFeature, hpnicfLicenseOpNotifyEnable=hpnicfLicenseOpNotifyEnable, hpnicfLicenseFeatureName=hpnicfLicenseFeatureName, hpnicfLicenseIndex=hpnicfLicenseIndex, hpnicfLicenseFeatureTable=hpnicfLicenseFeatureTable, hpnicfLicenseDevInfoEntry=hpnicfLicenseDevInfoEntry, hpnicfLicenseUninstActivationFile=hpnicfLicenseUninstActivationFile, hpnicfLicenseNotificationBindings=hpnicfLicenseNotificationBindings, hpnicfLicenseValidityEnd=hpnicfLicenseValidityEnd, hpnicfLicenseFileStoragePath=hpnicfLicenseFileStoragePath, hpnicfLicenseScalarObjects=hpnicfLicenseScalarObjects, hpnicfLicenseNextFreeOpIndex=hpnicfLicenseNextFreeOpIndex, hpnicfLicenseGeneralTable=hpnicfLicenseGeneralTable, hpnicfLicenseOpState=hpnicfLicenseOpState, hpnicfLicenseHardwareInfo=hpnicfLicenseHardwareInfo, hpnicfLicenseState=hpnicfLicenseState, hpnicfLicenseLicenseKey=hpnicfLicenseLicenseKey, hpnicfLicenseUsedNum=hpnicfLicenseUsedNum, hpnicfLicenseExpiredDays=hpnicfLicenseExpiredDays, hpnicfLicenseInstalledTime=hpnicfLicenseInstalledTime, hpnicfLicenseDevInfoTable=hpnicfLicenseDevInfoTable, hpnicfLicenseTables=hpnicfLicenseTables, hpnicfLicenseRecyclableNum=hpnicfLicenseRecyclableNum, hpnicfLicenseUninstalledTime=hpnicfLicenseUninstalledTime, hpnicfLicenseOpString=hpnicfLicenseOpString, PYSNMP_MODULE_ID=hpnicfLicense, hpnicfLicenseActivationFile=hpnicfLicenseActivationFile, hpnicfLicenseActivationKey=hpnicfLicenseActivationKey, hpnicfLicenseGeneralEntry=hpnicfLicenseGeneralEntry, hpnicfLicenseOpFailedReason=hpnicfLicenseOpFailedReason, hpnicfLicenseOpCompletion=hpnicfLicenseOpCompletion, hpnicfLicenseOpEntryMaxNum=hpnicfLicenseOpEntryMaxNum, hpnicfLicenseBindValidityPeriodRemaining=hpnicfLicenseBindValidityPeriodRemaining, hpnicfLicenseOpEntry=hpnicfLicenseOpEntry, hpnicfLicenseNotificationPrefix=hpnicfLicenseNotificationPrefix, hpnicfLicenseExpireWarning=hpnicfLicenseExpireWarning, hpnicfLicenseOpEndTime=hpnicfLicenseOpEndTime, hpnicfLicenseActivationFileRestored=hpnicfLicenseActivationFileRestored, hpnicfLicenseActivationFileLost=hpnicfLicenseActivationFileLost, hpnicfLicenseUninstActivationKey=hpnicfLicenseUninstActivationKey, hpnicfLicenseNotifyEnable=hpnicfLicenseNotifyEnable, hpnicfLicense=hpnicfLicense, hpnicfLicenseCount=hpnicfLicenseCount, hpnicfLicenseValidityStart=hpnicfLicenseValidityStart, hpnicfLicenseFeatureState=hpnicfLicenseFeatureState, hpnicfLicenseInstallType=hpnicfLicenseInstallType, hpnicfLicenseSN=hpnicfLicenseSN, hpnicfLicenseOpTable=hpnicfLicenseOpTable, hpnicfLicenseDeviceID=hpnicfLicenseDeviceID, hpnicfLicenseFeatureEntry=hpnicfLicenseFeatureEntry, hpnicfLicenseOpPhysicalIndex=hpnicfLicenseOpPhysicalIndex, hpnicfLicenseDeviceIDType=hpnicfLicenseDeviceIDType, hpnicfLicenseOpIndex=hpnicfLicenseOpIndex, hpnicfLicenseOpType=hpnicfLicenseOpType, hpnicfLicenseExpired=hpnicfLicenseExpired, hpnicfLicenseDaysLeft=hpnicfLicenseDaysLeft, hpnicfLicenseOpRowStatus=hpnicfLicenseOpRowStatus, hpnicfLicensePhysicalIndex=hpnicfLicensePhysicalIndex, hpnicfLicenseMaxNum=hpnicfLicenseMaxNum, hpnicfLicenseNotifications=hpnicfLicenseNotifications, hpnicfLicenseProductDescr=hpnicfLicenseProductDescr, hpnicfLicenseType=hpnicfLicenseType, hpnicfLicenseFileDescr=hpnicfLicenseFileDescr)
