...
entPhysicalIndex, entPhysicalContainedIn, entPhysicalEntry, entPhysicalName, entPhysicalDescr = mibBuilder.importSymbols("ENTITY-MIB", "entPhysicalIndex", "entPhysicalContainedIn", "entPhysicalEntry", "entPhysicalName", "entPhysicalDescr")
...
mibBuilder.exportSymbols("CISCO-ENTITY-EXT-MIB", ceExtUSBModemGroup=ceExtUSBModemGroup, ceExtConfigRegEntry=ceExtConfigRegEntry, ciscoEntityExtMIBObjects=ciscoEntityExtMIBObjects, ceExtProcessorRamOverflow=ceExtProcessorRamOverflow, ceExtKickstartImageList=ceExtKickstartImageList, ciscoEntityExtLEDGroup=ciscoEntityExtLEDGroup, ceExtUSBModemEntry=ceExtUSBModemEntry, ceExtEntDoorNotifControlGroup=ceExtEntDoorNotifControlGroup, ceExtEntDoorNotifGroup=ceExtEntDoorNotifGroup, ceExtPhyProcessorOverflowGroup=ceExtPhyProcessorOverflowGroup, ceExtSysBootImageListGroup=ceExtSysBootImageListGroup, ceExtUSBModemSignalStrength=ceExtUSBModemSignalStrength, ciscoEntityExtMIBComplianceRev3=ciscoEntityExtMIBComplianceRev3, ceExtEntUsbModemNotifEnable=ceExtEntUsbModemNotifEnable, ciscoEntityExtMIBCompliances=ciscoEntityExtMIBCompliances, ciscoEntityExtMIBComplianceRev2=ciscoEntityExtMIBComplianceRev2, ceExtUsbModemNotifControlGroup=ceExtUsbModemNotifControlGroup, ceExtSysBootImageList=ceExtSysBootImageList, ceExtUSBModemPlugInNotif=ceExtUSBModemPlugInNotif, ceExtHCNVRAMGroup=ceExtHCNVRAMGroup, ceEntPhysicalSecondSerialNum=ceEntPhysicalSecondSerialNum, ceExtUSBModemPlugOutNotif=ceExtUSBModemPlugOutNotif, ceExtMIBNotificationPrefix=ceExtMIBNotificationPrefix, ceExtNVRAMSizeOverflow=ceExtNVRAMSizeOverflow, ceExtConfigRegTable=ceExtConfigRegTable, ConfigRegisterValue=ConfigRegisterValue, ciscoEntityExtMIBComplianceRev6=ciscoEntityExtMIBComplianceRev6, BootImageList=BootImageList, ceExtEntityLEDColor=ceExtEntityLEDColor, ceExtConfigRegNext=ceExtConfigRegNext, ceExtBreakOutPortNotifGroup=ceExtBreakOutPortNotifGroup, ceExtEntBreakOutPortNotifEnable=ceExtEntBreakOutPortNotifEnable, ceExtEntityLEDEntry=ceExtEntityLEDEntry, ceExtHCNVRAMUsed=ceExtHCNVRAMUsed, ceExtUSBModemIMEI=ceExtUSBModemIMEI, ceExtUSBModemServiceProvider=ceExtUSBModemServiceProvider, ciscoEntityExtMIBConformance=ciscoEntityExtMIBConformance, ciscoEntityExtMIBGroups=ciscoEntityExtMIBGroups, ceExtNotificationControlObjects=ceExtNotificationControlObjects, ceExtHCProcessorRam=ceExtHCProcessorRam, ceExtEntityLEDType=ceExtEntityLEDType, ceExtHCNVRAMSize=ceExtHCNVRAMSize, ceExtEntPhysicalTable=ceExtEntPhysicalTable, ceExtEntDoorNotifEnable=ceExtEntDoorNotifEnable, ceExtSysBootImageListGroupRev1=ceExtSysBootImageListGroupRev1, ceExtEntityLEDTable=ceExtEntityLEDTable, ceExtNVRAMOverflowGroup=ceExtNVRAMOverflowGroup, PYSNMP_MODULE_ID=ciscoEntityExtMIB, ceExtBreakOutPortInserted=ceExtBreakOutPortInserted, ciscoEntityExtMIBComplianceRev5=ciscoEntityExtMIBComplianceRev5, ceExtBreakOutPortNotifControlGroup=ceExtBreakOutPortNotifControlGroup, ceExtNVRAMSize=ceExtNVRAMSize, ceExtNVRAMUsed=ceExtNVRAMUsed, ceExtBreakOutPortRemoved=ceExtBreakOutPortRemoved, ceExtPhyProcessorHCGroup=ceExtPhyProcessorHCGroup, ceExtUsbModemNotificationsGroup=ceExtUsbModemNotificationsGroup, ceExtUSBModemIMSI=ceExtUSBModemIMSI, ciscoEntityExtMIB=ciscoEntityExtMIB, ceExtProcessorRam=ceExtProcessorRam, ceExtPhysicalProcessorEntry=ceExtPhysicalProcessorEntry, ciscoEntityExtMIBNotifications=ciscoEntityExtMIBNotifications, ceExtEntDoorCloseNotif=ceExtEntDoorCloseNotif, ciscoEntityExtMIBComplianceRev4=ciscoEntityExtMIBComplianceRev4, ceExtPhysicalProcessorGroup=ceExtPhysicalProcessorGroup, ceExtPhysicalProcessorTable=ceExtPhysicalProcessorTable, ciscoEntityExtConfigRegGroup=ciscoEntityExtConfigRegGroup, ciscoExtEntityPhysicalGroup=ciscoExtEntityPhysicalGroup, ceExtEntPhysicalEntry=ceExtEntPhysicalEntry, ceExtConfigRegister=ceExtConfigRegister, ceExtNVRAMUsedOverflow=ceExtNVRAMUsedOverflow, ceExtEntDoorOpenNotif=ceExtEntDoorOpenNotif, ciscoEntityExtMIBCompliance=ciscoEntityExtMIBCompliance, ceExtUSBModemTable=ceExtUSBModemTable, ciscoEntityExtMIBComplianceRev1=ciscoEntityExtMIBComplianceRev1)
