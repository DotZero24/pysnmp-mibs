...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-DMN-DSG-AUDIO-MIB
...
mibBuilder.exportSymbols("CISCO-DMN-DSG-AUDIO-MIB", audioConsumerVolLeft=audioConsumerVolLeft, audioManualEntry=audioManualEntry, audioProfAttenuationRight=audioProfAttenuationRight, audioStatusTable=audioStatusTable, audioCtrlEntry=audioCtrlEntry, audioCtrlTable=audioCtrlTable, audioPmtSource=audioPmtSource, audioStatusDDPMode=audioStatusDDPMode, audioStatusLanguage=audioStatusLanguage, audioStatusEntry=audioStatusEntry, audioSelKey=audioSelKey, audioConsumerVolRight=audioConsumerVolRight, audioProfAttenuationLeft=audioProfAttenuationLeft, audioLangMenu=audioLangMenu, audioDolbyDigitalPlusMode=audioDolbyDigitalPlusMode, ciscoDSGAudio=ciscoDSGAudio, audioStatusBitRate=audioStatusBitRate, audioStatusSelKey=audioStatusSelKey, audioStatusSFR=audioStatusSFR, audioDigitalComp=audioDigitalComp, audioStatusBufferLevel=audioStatusBufferLevel, audioStatusDualMonoMode=audioStatusDualMonoMode, PYSNMP_MODULE_ID=ciscoDSGAudio, audioLangList=audioLangList, audioStatusFormat=audioStatusFormat, audioMuted=audioMuted, audioDolbyDigitalComp=audioDolbyDigitalComp, audioMode=audioMode, audioStatusMuted=audioStatusMuted)
