...
mibBuilder.exportSymbols("CISCO-DMN-DSG-AUDIO-MIB", audioStatusMuted=audioStatusMuted, audioProfAttenuationRight=audioProfAttenuationRight, audioManualEntry=audioManualEntry, audioStatusSelKey=audioStatusSelKey, audioDolbyDigitalPlusMode=audioDolbyDigitalPlusMode, ciscoDSGAudio=ciscoDSGAudio, audioStatusBufferLevel=audioStatusBufferLevel, audioSelKey=audioSelKey, audioStatusFormat=audioStatusFormat, audioStatusBitRate=audioStatusBitRate, audioCtrlTable=audioCtrlTable, audioStatusSFR=audioStatusSFR, audioStatusLanguage=audioStatusLanguage, audioConsumerVolLeft=audioConsumerVolLeft, audioDigitalComp=audioDigitalComp, audioCtrlEntry=audioCtrlEntry, audioProfAttenuationLeft=audioProfAttenuationLeft, audioLangMenu=audioLangMenu, audioStatusEntry=audioStatusEntry, audioStatusDualMonoMode=audioStatusDualMonoMode, audioMuted=audioMuted, PYSNMP_MODULE_ID=ciscoDSGAudio, audioPmtSource=audioPmtSource, audioDolbyDigitalComp=audioDolbyDigitalComp, audioMode=audioMode, audioConsumerVolRight=audioConsumerVolRight, audioStatusDDPMode=audioStatusDDPMode, audioLangList=audioLangList, audioStatusTable=audioStatusTable)
