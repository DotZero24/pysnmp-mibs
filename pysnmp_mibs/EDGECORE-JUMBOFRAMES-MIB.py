# SNMP MIB module (EDGECORE-JUMBOFRAMES-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/edgecore/EDGECORE-JUMBOFRAMES-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:51:59 2025
...
rlJumboFramesCurrentStatus = _RlJumboFramesCurrentStatus_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 91, 1),
...
rlJumboFramesStatusAfterReset = _RlJumboFramesStatusAfterReset_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 91, 2),
