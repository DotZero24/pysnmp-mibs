...
mibBuilder.exportSymbols("CISCO-VISM-DSX0-MIB", ciscoVismDsx0MIBCompliances=ciscoVismDsx0MIBCompliances, ds0InsertLocalCas=ds0InsertLocalCas, lineBlockDs0Count=lineBlockDs0Count, ciscoVismDsx0Compliance=ciscoVismDsx0Compliance, ds0ChanMapIfIndex=ds0ChanMapIfIndex, ds0CasVariantName=ds0CasVariantName, lineActiveDs0Count=lineActiveDs0Count, ds0CasCadenceOffTime=ds0CasCadenceOffTime, ciscoVismDsx0ChanMapGroup=ciscoVismDsx0ChanMapGroup, lineActiveHighWaterMark=lineActiveHighWaterMark, ds0InputGain=ds0InputGain, ds0Companding=ds0Companding, ds0CasOnHookMinMakeTime=ds0CasOnHookMinMakeTime, dsx0VismCnfEntry=dsx0VismCnfEntry, ds0LocalCasPattern=ds0LocalCasPattern, ds0MusicThreshold=ds0MusicThreshold, ds0StatusClrButton=ds0StatusClrButton, ciscoVismDsx0LineStatsGroup=ciscoVismDsx0LineStatsGroup, vismTotalDs0Count=vismTotalDs0Count, vismBlockDs0Count=vismBlockDs0Count, dsx1LineNum=dsx1LineNum, ds0RobbedBitSignalling=ds0RobbedBitSignalling, vismDs0CardStats=vismDs0CardStats, ds0SignalingType=ds0SignalingType, ds0CasDirectionality=ds0CasDirectionality, ds0CasOffHookMinMakeTime=ds0CasOffHookMinMakeTime, vismDs0LineStatsEntry=vismDs0LineStatsEntry, ciscoVismDsx0Compliance2=ciscoVismDsx0Compliance2, vismFreeDs0Count=vismFreeDs0Count, ds0CasDelayImmedStart=ds0CasDelayImmedStart, ds0IdleCode=ds0IdleCode, ds0ReceivedCode=ds0ReceivedCode, lineStatsClrButton=lineStatsClrButton, vismDs0CardStatsClrButton=vismDs0CardStatsClrButton, ds0CasWinkMaxMakeTime=ds0CasWinkMaxMakeTime, ciscoVismDsx0ConfGroup=ciscoVismDsx0ConfGroup, ds0CasWinkBreakTime=ds0CasWinkBreakTime, ds0TransmitCodesEnable=ds0TransmitCodesEnable, ds0LineNum=ds0LineNum, ds0Number=ds0Number, ds0Status=ds0Status, vismActiveHighWaterMark=vismActiveHighWaterMark, ciscoVismDsx0StatusGroup=ciscoVismDsx0StatusGroup, PYSNMP_MODULE_ID=ciscoVismDsx0MIB, ds0ExecDiag=ds0ExecDiag, ciscoVismDsx0MIBConformance=ciscoVismDsx0MIBConformance, ds0CasGaurdTime=ds0CasGaurdTime, ds0CasGlareTime=ds0CasGlareTime, ds0CasCadenceOnTime=ds0CasCadenceOnTime, ds0CasFlashMinMakeTime=ds0CasFlashMinMakeTime, dsx0VismChanMapEntry=dsx0VismChanMapEntry, ds0CasGlarePolicy=ds0CasGlarePolicy, lineTotalDs0Count=lineTotalDs0Count, ds0OutputAttenuation=ds0OutputAttenuation, vismDs0StatusEntry=vismDs0StatusEntry, ciscoVismDsx0MIBGroups=ciscoVismDsx0MIBGroups, ciscoVismDsx0ConfDeprecatedGroup=ciscoVismDsx0ConfDeprecatedGroup, ds0RxCasTransTblName=ds0RxCasTransTblName, ds0CasOutgoingMgcpPackage=ds0CasOutgoingMgcpPackage, ciscoVismDsx0ConfGroup2=ciscoVismDsx0ConfGroup2, ciscoVismDsx0MIB=ciscoVismDsx0MIB, ds0TxCasTransTblName=ds0TxCasTransTblName, ds0IfIndex=ds0IfIndex, vismActiveDs0Count=vismActiveDs0Count, vismDs0StatusTable=vismDs0StatusTable, dsx0VismChanMapTable=dsx0VismChanMapTable, dsx0VismCnfTable=dsx0VismCnfTable, lineFreeDs0Count=lineFreeDs0Count, ds0BundleMapped=ds0BundleMapped, ds0LineNumber=ds0LineNumber, ds0SeizedCode=ds0SeizedCode, ds0CasMinStartDialTime=ds0CasMinStartDialTime, ciscoVismCardStatsGroup=ciscoVismCardStatsGroup, ds0CasMinDelayDialTime=ds0CasMinDelayDialTime, ds0CasParameterSource=ds0CasParameterSource, ds0CasWinkMinMakeTime=ds0CasWinkMinMakeTime, ds0IfType=ds0IfType, ds0TxRxCasConfig=ds0TxRxCasConfig, vismDs0LineStatsTable=vismDs0LineStatsTable, ds0CasFlashMaxMakeTime=ds0CasFlashMaxMakeTime, ds0CasIncomingMgcpPackage=ds0CasIncomingMgcpPackage, ds0LoopbackCommand=ds0LoopbackCommand, ds0SidPacket=ds0SidPacket, ds0ChanNum=ds0ChanNum)
