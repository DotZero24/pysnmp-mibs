...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-VISM-DSX0-MIB
...
dsx0Vism, cardSpecific = mibBuilder.importSymbols("BASIS-MIB", "dsx0Vism", "cardSpecific")
...
mibBuilder.exportSymbols("CISCO-VISM-DSX0-MIB", ds0CasMinDelayDialTime=ds0CasMinDelayDialTime, ds0Status=ds0Status, ds0LocalCasPattern=ds0LocalCasPattern, ds0StatusClrButton=ds0StatusClrButton, lineBlockDs0Count=lineBlockDs0Count, ds0CasCadenceOffTime=ds0CasCadenceOffTime, ds0SidPacket=ds0SidPacket, lineActiveDs0Count=lineActiveDs0Count, ds0CasGaurdTime=ds0CasGaurdTime, vismDs0CardStats=vismDs0CardStats, ds0BundleMapped=ds0BundleMapped, ds0CasFlashMaxMakeTime=ds0CasFlashMaxMakeTime, ciscoVismDsx0MIBConformance=ciscoVismDsx0MIBConformance, ds0CasFlashMinMakeTime=ds0CasFlashMinMakeTime, vismActiveDs0Count=vismActiveDs0Count, ds0CasDirectionality=ds0CasDirectionality, dsx0VismCnfTable=dsx0VismCnfTable, vismDs0LineStatsTable=vismDs0LineStatsTable, ds0ReceivedCode=ds0ReceivedCode, lineTotalDs0Count=lineTotalDs0Count, ds0MusicThreshold=ds0MusicThreshold, ds0SignalingType=ds0SignalingType, ds0CasIncomingMgcpPackage=ds0CasIncomingMgcpPackage, ds0TxCasTransTblName=ds0TxCasTransTblName, ds0CasCadenceOnTime=ds0CasCadenceOnTime, ds0CasWinkMinMakeTime=ds0CasWinkMinMakeTime, ds0CasGlareTime=ds0CasGlareTime, ds0InsertLocalCas=ds0InsertLocalCas, ds0CasDelayImmedStart=ds0CasDelayImmedStart, ds0Number=ds0Number, dsx0VismChanMapEntry=dsx0VismChanMapEntry, ds0Companding=ds0Companding, vismDs0LineStatsEntry=vismDs0LineStatsEntry, ds0RxCasTransTblName=ds0RxCasTransTblName, vismTotalDs0Count=vismTotalDs0Count, ds0ChanMapIfIndex=ds0ChanMapIfIndex, ds0ExecDiag=ds0ExecDiag, PYSNMP_MODULE_ID=ciscoVismDsx0MIB, ds0CasVariantName=ds0CasVariantName, vismFreeDs0Count=vismFreeDs0Count, dsx1LineNum=dsx1LineNum, dsx0VismChanMapTable=dsx0VismChanMapTable, vismActiveHighWaterMark=vismActiveHighWaterMark, vismDs0CardStatsClrButton=vismDs0CardStatsClrButton, ciscoVismDsx0LineStatsGroup=ciscoVismDsx0LineStatsGroup, ds0RobbedBitSignalling=ds0RobbedBitSignalling, ciscoVismDsx0MIB=ciscoVismDsx0MIB, ds0InputGain=ds0InputGain, ciscoVismDsx0ConfGroup=ciscoVismDsx0ConfGroup, ciscoVismDsx0ConfGroup2=ciscoVismDsx0ConfGroup2, ds0CasParameterSource=ds0CasParameterSource, dsx0VismCnfEntry=dsx0VismCnfEntry, lineActiveHighWaterMark=lineActiveHighWaterMark, ds0IfIndex=ds0IfIndex, ds0ChanNum=ds0ChanNum, ds0CasMinStartDialTime=ds0CasMinStartDialTime, ds0CasOffHookMinMakeTime=ds0CasOffHookMinMakeTime, ciscoVismDsx0ChanMapGroup=ciscoVismDsx0ChanMapGroup, ciscoVismDsx0Compliance2=ciscoVismDsx0Compliance2, ds0TxRxCasConfig=ds0TxRxCasConfig, ds0CasGlarePolicy=ds0CasGlarePolicy, ds0CasOutgoingMgcpPackage=ds0CasOutgoingMgcpPackage, ds0LineNumber=ds0LineNumber, ciscoVismDsx0MIBCompliances=ciscoVismDsx0MIBCompliances, ciscoVismDsx0Compliance=ciscoVismDsx0Compliance, ciscoVismCardStatsGroup=ciscoVismCardStatsGroup, ds0OutputAttenuation=ds0OutputAttenuation, ds0IfType=ds0IfType, vismDs0StatusEntry=vismDs0StatusEntry, lineFreeDs0Count=lineFreeDs0Count, ds0LineNum=ds0LineNum, ds0CasWinkMaxMakeTime=ds0CasWinkMaxMakeTime, ciscoVismDsx0MIBGroups=ciscoVismDsx0MIBGroups, vismDs0StatusTable=vismDs0StatusTable, ds0SeizedCode=ds0SeizedCode, ds0LoopbackCommand=ds0LoopbackCommand, vismBlockDs0Count=vismBlockDs0Count, ds0CasWinkBreakTime=ds0CasWinkBreakTime, ds0IdleCode=ds0IdleCode, ds0CasOnHookMinMakeTime=ds0CasOnHookMinMakeTime, ciscoVismDsx0ConfDeprecatedGroup=ciscoVismDsx0ConfDeprecatedGroup, ciscoVismDsx0StatusGroup=ciscoVismDsx0StatusGroup, ds0TransmitCodesEnable=ds0TransmitCodesEnable, lineStatsClrButton=lineStatsClrButton)
