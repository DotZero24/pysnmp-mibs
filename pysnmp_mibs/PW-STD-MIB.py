...
PwOperStatusTC, PwStatus, PwIDType, PwIndexOrZeroType, PwAttachmentIdentifierType, PwGroupID, PwGenIdType, PwCwStatusTC, PwFragSize, PwIndexType, PwFragStatus = mibBuilder.importSymbols("PW-TC-STD-MIB", "PwOperStatusTC", "PwStatus", "PwIDType", "PwIndexOrZeroType", "PwAttachmentIdentifierType", "PwGroupID", "PwGenIdType", "PwCwStatusTC", "PwFragSize", "PwIndexType", "PwFragStatus")
...
mibBuilder.exportSymbols("PW-STD-MIB", pwPerfCurrentEntry=pwPerfCurrentEntry, pwGenLocalAIIType=pwGenLocalAIIType, pwPerfIntervalTimeElapsed=pwPerfIntervalTimeElapsed, pwPerfIntervalOutBytes=pwPerfIntervalOutBytes, pwPerf1DayIntervalTable=pwPerf1DayIntervalTable, pwEntry=pwEntry, pwGenFecIndexMappingRemoteAIIType=pwGenFecIndexMappingRemoteAIIType, pwRowStatus=pwRowStatus, pwPeerMappingPeerAddr=pwPeerMappingPeerAddr, pwUpDownNotifEnable=pwUpDownNotifEnable, pwCwStatus=pwCwStatus, pwPerfIntervalInHCBytes=pwPerfIntervalInHCBytes, pwPerfIntervalEntry=pwPerfIntervalEntry, pwAdminStatus=pwAdminStatus, pwPerfIntervalInBytes=pwPerfIntervalInBytes, pwGroupAttachmentID=pwGroupAttachmentID, pwTable=pwTable, pwPerfCurrentOutBytes=pwPerfCurrentOutBytes, pwLastChange=pwLastChange, pwAttachmentGroup=pwAttachmentGroup, pwPeerMappingEntry=pwPeerMappingEntry, pwNotifRate=pwNotifRate, pwModuleReadOnlyCompliance=pwModuleReadOnlyCompliance, pwBasicGroup=pwBasicGroup, pwSignalingGroup=pwSignalingGroup, pwPwStatusGroup=pwPwStatusGroup, pwGenRemoteAIIType=pwGenRemoteAIIType, pwOperStatus=pwOperStatus, pwGenFecIndexMappingLocalAII=pwGenFecIndexMappingLocalAII, pwSetUpPriority=pwSetUpPriority, pwLocalIfMtu=pwLocalIfMtu, pwPerfCurrentInPackets=pwPerfCurrentInPackets, pwPerfCurrentInBytes=pwPerfCurrentInBytes, pwPerfIntervalNumber=pwPerfIntervalNumber, pwGetNextGroup=pwGetNextGroup, pwPeformanceIntervalGroup=pwPeformanceIntervalGroup, pwPerfIntervalOutHCPackets=pwPerfIntervalOutHCPackets, pwPerfCurrentOutHCBytes=pwPerfCurrentOutHCBytes, pwIndexMappingPeerAddr=pwIndexMappingPeerAddr, pwHoldingPriority=pwHoldingPriority, pwRmtFragCapability=pwRmtFragCapability, pwFcsGroup=pwFcsGroup, pwPerfCurrentInHCPackets=pwPerfCurrentInHCPackets, pwPerf1DayIntervalTimeElapsed=pwPerf1DayIntervalTimeElapsed, pwGenFecIndexMappingAGIType=pwGenFecIndexMappingAGIType, pwPerfIntervalValidData=pwPerfIntervalValidData, pwStdMIB=pwStdMIB, pwConformance=pwConformance, pwPerf1DayIntervalInHCPackets=pwPerf1DayIntervalInHCPackets, pwRemoteCapabilities=pwRemoteCapabilities, pwPerfCurrentOutPackets=pwPerfCurrentOutPackets, pwRemoteGroupID=pwRemoteGroupID, pwPriorityGroup=pwPriorityGroup, pwUpTime=pwUpTime, pwIfIndex=pwIfIndex, pwOwner=pwOwner, pwIndexMappingPwIndex=pwIndexMappingPwIndex, pwPerfIntervalOutHCBytes=pwPerfIntervalOutHCBytes, pwLocalStatus=pwLocalStatus, pwIndex=pwIndex, pwRemoteStatusCapable=pwRemoteStatusCapable, pwType=pwType, pwPerfCurrentInHCBytes=pwPerfCurrentInHCBytes, pwModuleFullCompliance=pwModuleFullCompliance, pwPeerMappingPeerAddrType=pwPeerMappingPeerAddrType, pwPerf1DayIntervalInHCBytes=pwPerf1DayIntervalInHCBytes, pwFragGroup=pwFragGroup, pwPerfCurrentOutHCPackets=pwPerfCurrentOutHCPackets, pwPerf1DayIntervalValidData=pwPerf1DayIntervalValidData, pwGenFecIndexMappingAGI=pwGenFecIndexMappingAGI, pwGenAGIType=pwGenAGIType, PYSNMP_MODULE_ID=pwStdMIB, pwGenFecIndexMappingRemoteAII=pwGenFecIndexMappingRemoteAII, pwPerf1DayIntervalOutHCBytes=pwPerf1DayIntervalOutHCBytes, pwDescr=pwDescr, pwPeerMappingTable=pwPeerMappingTable, pwCreateTime=pwCreateTime, pwIndexMappingTable=pwIndexMappingTable, pwCwPreference=pwCwPreference, pwCompliances=pwCompliances, pwRemoteAttachmentID=pwRemoteAttachmentID, pwDown=pwDown, pwPeerMappingPwIndex=pwPeerMappingPwIndex, pwGenFecIndexMappingPwIndex=pwGenFecIndexMappingPwIndex, pwGeneralizedFecGroup=pwGeneralizedFecGroup, pwInboundLabel=pwInboundLabel, pwLocalAttachmentID=pwLocalAttachmentID, pwFragmentCfgSize=pwFragmentCfgSize, pwUp=pwUp, pwPerf1DayIntervalEntry=pwPerf1DayIntervalEntry, pwFcsRetentionCfg=pwFcsRetentionCfg, pwIndexMappingPwType=pwIndexMappingPwType, pwPerformanceIntervalGeneralGroup=pwPerformanceIntervalGeneralGroup, pwNotificationControlGroup=pwNotificationControlGroup, pwLocalIfString=pwLocalIfString, pwNotifications=pwNotifications, pwPeerAddr=pwPeerAddr, pwOutboundLabel=pwOutboundLabel, pwPerfIntervalInHCPackets=pwPerfIntervalInHCPackets, pwDeleted=pwDeleted, pwRemoteStatus=pwRemoteStatus, pwPeerAddrType=pwPeerAddrType, pwGenFecIndexMappingTable=pwGenFecIndexMappingTable, pwTimeElapsed=pwTimeElapsed, pwIndexMappingPeerAddrType=pwIndexMappingPeerAddrType, pwGenFecIndexMappingLocalAIIType=pwGenFecIndexMappingLocalAIIType, pwGenFecIndexMappingEntry=pwGenFecIndexMappingEntry, pwIndexMappingEntry=pwIndexMappingEntry, pwFcsRetentionStatus=pwFcsRetentionStatus, pwMappingTablesGroup=pwMappingTablesGroup, pwPsnType=pwPsnType, pwAttachedPwIndex=pwAttachedPwIndex, pwName=pwName, pwIndexMappingPwID=pwIndexMappingPwID, pwNotificationGroup=pwNotificationGroup, pwLocalGroupID=pwLocalGroupID, pwHCPeformanceIntervalGroup=pwHCPeformanceIntervalGroup, pwGroups=pwGroups, pwPerf1DayIntervalNumber=pwPerf1DayIntervalNumber, pwObjects=pwObjects, pwRemoteIfString=pwRemoteIfString, pwPerf1DayIntervalOutHCPackets=pwPerf1DayIntervalOutHCPackets, pwPerfIntervalInPackets=pwPerfIntervalInPackets, pwIndexNext=pwIndexNext, pwLocalCapabAdvert=pwLocalCapabAdvert, pwStorageType=pwStorageType, pwPerfIntervalTable=pwPerfIntervalTable, pwPerformanceGeneralGroup=pwPerformanceGeneralGroup, pwDeletedNotifEnable=pwDeletedNotifEnable, pwPwIdGroup=pwPwIdGroup, pwOamEnable=pwOamEnable, pwPerfTotalErrorPackets=pwPerfTotalErrorPackets, pwRemoteIfMtu=pwRemoteIfMtu, pwPeerMappingPwID=pwPeerMappingPwID, pwPerfIntervalOutPackets=pwPerfIntervalOutPackets, pwID=pwID, pwPeerMappingPwType=pwPeerMappingPwType, pwPerfCurrentTable=pwPerfCurrentTable, pwPeformance1DayIntervalGroup=pwPeformance1DayIntervalGroup, pwValidIntervals=pwValidIntervals)
