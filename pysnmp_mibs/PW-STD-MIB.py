...
# Notes
# -----
# ASN.1 source file://mibs/rfc/PW-STD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:48:53 2025
...
_PwGenAGIType_Type.__name__ = "PwGenIdType"
...
_PwGenLocalAIIType_Type.__name__ = "PwGenIdType"
...
_PwGenRemoteAIIType_Type.__name__ = "PwGenIdType"
...
pwModuleFullCompliance.setObjects(
      *(("PW-STD-MIB", "pwBasicGroup"),
        ("PW-STD-MIB", "pwPerformanceGeneralGroup"),
        ("PW-STD-MIB", "pwNotificationGroup"),
        ("PW-STD-MIB", "pwPwIdGroup"),
        ("PW-STD-MIB", "pwGeneralizedFecGroup"),
        ("PW-STD-MIB", "pwFcsGroup"),
        ("PW-STD-MIB", "pwFragGroup"),
        ("PW-STD-MIB", "pwPwStatusGroup"),
        ("PW-STD-MIB", "pwGetNextGroup"),
        ("PW-STD-MIB", "pwPriorityGroup"),
        ("PW-STD-MIB", "pwAttachmentGroup"),
        ("PW-STD-MIB", "pwPeformance1DayIntervalGroup"),
        ("PW-STD-MIB", "pwPerformanceIntervalGeneralGroup"),
        ("PW-STD-MIB", "pwPeformanceIntervalGroup"),
        ("PW-STD-MIB", "pwHCPeformanceIntervalGroup"),
        ("PW-STD-MIB", "pwMappingTablesGroup"),
        ("PW-STD-MIB", "pwSignalingGroup"),
        ("PW-STD-MIB", "pwNotificationControlGroup"))
)
if mibBuilder.loadTexts:
