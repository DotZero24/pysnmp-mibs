...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/rfc/PW-STD-MIB
...
PwIDType, PwFragSize, PwCwStatusTC, PwFragStatus, PwOperStatusTC, PwAttachmentIdentifierType, PwGroupID, PwGenIdType, PwStatus, PwIndexType, PwIndexOrZeroType = mibBuilder.importSymbols("PW-TC-STD-MIB", "PwIDType", "PwFragSize", "PwCwStatusTC", "PwFragStatus", "PwOperStatusTC", "PwAttachmentIdentifierType", "PwGroupID", "PwGenIdType", "PwStatus", "PwIndexType", "PwIndexOrZeroType")
...
mibBuilder.exportSymbols("PW-STD-MIB", pwRowStatus=pwRowStatus, pwPerfIntervalNumber=pwPerfIntervalNumber, pwPerf1DayIntervalNumber=pwPerf1DayIntervalNumber, pwGroupAttachmentID=pwGroupAttachmentID, pwPerfCurrentOutPackets=pwPerfCurrentOutPackets, pwOwner=pwOwner, pwTimeElapsed=pwTimeElapsed, pwPsnType=pwPsnType, pwIndexNext=pwIndexNext, pwPerf1DayIntervalOutHCBytes=pwPerf1DayIntervalOutHCBytes, pwPeerAddr=pwPeerAddr, pwHCPeformanceIntervalGroup=pwHCPeformanceIntervalGroup, pwPeerMappingPwType=pwPeerMappingPwType, pwLastChange=pwLastChange, pwPerfIntervalOutBytes=pwPerfIntervalOutBytes, pwSignalingGroup=pwSignalingGroup, pwRemoteCapabilities=pwRemoteCapabilities, pwPerfIntervalTimeElapsed=pwPerfIntervalTimeElapsed, pwGenFecIndexMappingRemoteAIIType=pwGenFecIndexMappingRemoteAIIType, pwUpTime=pwUpTime, pwInboundLabel=pwInboundLabel, pwLocalAttachmentID=pwLocalAttachmentID, pwPeerMappingPwIndex=pwPeerMappingPwIndex, pwCwStatus=pwCwStatus, pwModuleReadOnlyCompliance=pwModuleReadOnlyCompliance, pwFcsGroup=pwFcsGroup, pwLocalIfMtu=pwLocalIfMtu, pwPerfIntervalOutHCPackets=pwPerfIntervalOutHCPackets, pwUpDownNotifEnable=pwUpDownNotifEnable, pwUp=pwUp, pwPeformance1DayIntervalGroup=pwPeformance1DayIntervalGroup, pwOamEnable=pwOamEnable, pwCwPreference=pwCwPreference, pwIndexMappingPwType=pwIndexMappingPwType, pwHoldingPriority=pwHoldingPriority, pwPerfCurrentOutHCPackets=pwPerfCurrentOutHCPackets, pwRemoteGroupID=pwRemoteGroupID, pwGenFecIndexMappingTable=pwGenFecIndexMappingTable, pwLocalIfString=pwLocalIfString, pwRemoteStatusCapable=pwRemoteStatusCapable, pwPerfIntervalInHCBytes=pwPerfIntervalInHCBytes, pwType=pwType, pwPeerMappingPeerAddrType=pwPeerMappingPeerAddrType, pwIndexMappingPeerAddrType=pwIndexMappingPeerAddrType, pwFragmentCfgSize=pwFragmentCfgSize, pwPerf1DayIntervalValidData=pwPerf1DayIntervalValidData, pwAdminStatus=pwAdminStatus, pwPerfIntervalEntry=pwPerfIntervalEntry, pwPerfTotalErrorPackets=pwPerfTotalErrorPackets, pwCompliances=pwCompliances, pwPerf1DayIntervalTable=pwPerf1DayIntervalTable, pwAttachedPwIndex=pwAttachedPwIndex, pwPerfCurrentInBytes=pwPerfCurrentInBytes, pwCreateTime=pwCreateTime, pwRemoteStatus=pwRemoteStatus, pwDeleted=pwDeleted, pwPerfIntervalOutHCBytes=pwPerfIntervalOutHCBytes, pwPerf1DayIntervalOutHCPackets=pwPerf1DayIntervalOutHCPackets, pwAttachmentGroup=pwAttachmentGroup, pwGenFecIndexMappingAGI=pwGenFecIndexMappingAGI, pwPwStatusGroup=pwPwStatusGroup, pwGenFecIndexMappingEntry=pwGenFecIndexMappingEntry, pwRemoteIfString=pwRemoteIfString, pwConformance=pwConformance, pwPerfCurrentEntry=pwPerfCurrentEntry, pwObjects=pwObjects, pwOutboundLabel=pwOutboundLabel, pwGenRemoteAIIType=pwGenRemoteAIIType, pwGenFecIndexMappingPwIndex=pwGenFecIndexMappingPwIndex, pwNotificationControlGroup=pwNotificationControlGroup, pwNotifRate=pwNotifRate, pwModuleFullCompliance=pwModuleFullCompliance, pwPerfCurrentInHCBytes=pwPerfCurrentInHCBytes, pwPerformanceIntervalGeneralGroup=pwPerformanceIntervalGeneralGroup, pwPerf1DayIntervalInHCPackets=pwPerf1DayIntervalInHCPackets, pwDown=pwDown, pwBasicGroup=pwBasicGroup, pwDeletedNotifEnable=pwDeletedNotifEnable, pwPeformanceIntervalGroup=pwPeformanceIntervalGroup, pwIndexMappingPwID=pwIndexMappingPwID, pwPeerAddrType=pwPeerAddrType, pwIndexMappingEntry=pwIndexMappingEntry, pwPeerMappingPwID=pwPeerMappingPwID, pwGenFecIndexMappingAGIType=pwGenFecIndexMappingAGIType, pwRemoteAttachmentID=pwRemoteAttachmentID, pwMappingTablesGroup=pwMappingTablesGroup, pwPeerMappingEntry=pwPeerMappingEntry, pwPerfIntervalInBytes=pwPerfIntervalInBytes, pwDescr=pwDescr, pwName=pwName, pwGetNextGroup=pwGetNextGroup, pwIndexMappingPwIndex=pwIndexMappingPwIndex, pwGenFecIndexMappingLocalAII=pwGenFecIndexMappingLocalAII, pwNotificationGroup=pwNotificationGroup, pwPerfCurrentInPackets=pwPerfCurrentInPackets, pwPeerMappingTable=pwPeerMappingTable, pwRmtFragCapability=pwRmtFragCapability, pwID=pwID, pwPerfCurrentOutHCBytes=pwPerfCurrentOutHCBytes, pwNotifications=pwNotifications, pwPerfCurrentOutBytes=pwPerfCurrentOutBytes, pwGeneralizedFecGroup=pwGeneralizedFecGroup, pwStdMIB=pwStdMIB, pwRemoteIfMtu=pwRemoteIfMtu, pwPerformanceGeneralGroup=pwPerformanceGeneralGroup, pwFragGroup=pwFragGroup, pwSetUpPriority=pwSetUpPriority, pwIndex=pwIndex, pwPerfIntervalTable=pwPerfIntervalTable, pwValidIntervals=pwValidIntervals, pwPerfIntervalOutPackets=pwPerfIntervalOutPackets, pwOperStatus=pwOperStatus, pwPeerMappingPeerAddr=pwPeerMappingPeerAddr, pwGenFecIndexMappingRemoteAII=pwGenFecIndexMappingRemoteAII, pwTable=pwTable, pwPerfIntervalValidData=pwPerfIntervalValidData, pwIndexMappingTable=pwIndexMappingTable, pwGroups=pwGroups, pwFcsRetentionStatus=pwFcsRetentionStatus, pwFcsRetentionCfg=pwFcsRetentionCfg, pwGenLocalAIIType=pwGenLocalAIIType, pwPerfIntervalInHCPackets=pwPerfIntervalInHCPackets, pwPerf1DayIntervalInHCBytes=pwPerf1DayIntervalInHCBytes, pwPerf1DayIntervalEntry=pwPerf1DayIntervalEntry, pwIndexMappingPeerAddr=pwIndexMappingPeerAddr, pwLocalStatus=pwLocalStatus, pwIfIndex=pwIfIndex, pwGenFecIndexMappingLocalAIIType=pwGenFecIndexMappingLocalAIIType, pwLocalCapabAdvert=pwLocalCapabAdvert, pwPerf1DayIntervalTimeElapsed=pwPerf1DayIntervalTimeElapsed, pwPerfCurrentInHCPackets=pwPerfCurrentInHCPackets, pwEntry=pwEntry, pwLocalGroupID=pwLocalGroupID, pwPwIdGroup=pwPwIdGroup, pwPerfIntervalInPackets=pwPerfIntervalInPackets, pwGenAGIType=pwGenAGIType, pwPerfCurrentTable=pwPerfCurrentTable, pwPriorityGroup=pwPriorityGroup, pwStorageType=pwStorageType, PYSNMP_MODULE_ID=pwStdMIB)
