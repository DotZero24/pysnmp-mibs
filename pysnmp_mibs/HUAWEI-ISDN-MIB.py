...
hwIsdnMibObjects=_HwIsdnMibObjects_ObjectIdentity((1,3,6,1,4,1,2011,2,33,9,1))
_IsdnChannelB_ObjectIdentity=ObjectIdentity
isdnChannelB=_IsdnChannelB_ObjectIdentity((1,3,6,1,4,1,2011,2,33,9,1,1))
_HwChanbIsdnTable_Object=MibTable
hwChanbIsdnTable=_HwChanbIsdnTable_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1))
if mibBuilder.loadTexts:hwChanbIsdnTable.setStatus(_A)
_HwChanbIsdnEntry_Object=MibTableRow
hwChanbIsdnEntry=_HwChanbIsdnEntry_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1))
...
hwChanbIsdnIf=_HwChanbIsdnIf_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,1),_HwChanbIsdnIf_Type())
...
hwChanbIsdnPermit=_HwChanbIsdnPermit_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,2),_HwChanbIsdnPermit_Type())
...
hwChanbIsdnAddr=_HwChanbIsdnAddr_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,3),_HwChanbIsdnAddr_Type())
...
hwChanbIsdnCallerAddr=_HwChanbIsdnCallerAddr_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,4),_HwChanbIsdnCallerAddr_Type())
...
hwChanbIsdnCallType=_HwChanbIsdnCallType_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,5),_HwChanbIsdnCallType_Type())
...
hwChanbIsdnInfoType=_HwChanbIsdnInfoType_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,6),_HwChanbIsdnInfoType_Type())
...
hwChanbIsdnState=_HwChanbIsdnState_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,7),_HwChanbIsdnState_Type())
...
hwChanbIsdnCallFreeReason=_HwChanbIsdnCallFreeReason_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,8),_HwChanbIsdnCallFreeReason_Type())
...
hwChanbIsdnCallFreeCode=_HwChanbIsdnCallFreeCode_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,9),_HwChanbIsdnCallFreeCode_Type())
...
hwChanbIsdnCallAccept=_HwChanbIsdnCallAccept_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,10),_HwChanbIsdnCallAccept_Type())
...
hwChanbIsdnCallReject=_HwChanbIsdnCallReject_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,11),_HwChanbIsdnCallReject_Type())
...
hwChanbIsdnCallSuccess=_HwChanbIsdnCallSuccess_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,12),_HwChanbIsdnCallSuccess_Type())
...
hwChanbIsdnCallFailure=_HwChanbIsdnCallFailure_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,13),_HwChanbIsdnCallFailure_Type())
...
hwChanbIsdnMaxKeepTime=_HwChanbIsdnMaxKeepTime_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,14),_HwChanbIsdnMaxKeepTime_Type())
...
hwChanbIsdnLastKeepTime=_HwChanbIsdnLastKeepTime_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,15),_HwChanbIsdnLastKeepTime_Type())
...
hwChanbIsdnLastCallTime=_HwChanbIsdnLastCallTime_Object((1,3,6,1,4,1,2011,2,33,9,1,1,1,1,16),_HwChanbIsdnLastCallTime_Type())
...
hwChanbTrapEnable=_HwChanbTrapEnable_Object((1,3,6,1,4,1,2011,2,33,9,1,1,2),_HwChanbTrapEnable_Type())
...
isdnQ931=_IsdnQ931_ObjectIdentity((1,3,6,1,4,1,2011,2,33,9,1,2))
_HwQ931IsdnControl_ObjectIdentity=ObjectIdentity
hwQ931IsdnControl=_HwQ931IsdnControl_ObjectIdentity((1,3,6,1,4,1,2011,2,33,9,1,2,1))
...
hwQ931CallSetupTrapEnable=_HwQ931CallSetupTrapEnable_Object((1,3,6,1,4,1,2011,2,33,9,1,2,1,1),_HwQ931CallSetupTrapEnable_Type())
...
hwQ931CallClearTrapEnable=_HwQ931CallClearTrapEnable_Object((1,3,6,1,4,1,2011,2,33,9,1,2,1,2),_HwQ931CallClearTrapEnable_Type())
...
hwQ931IsdnTable=_HwQ931IsdnTable_Object((1,3,6,1,4,1,2011,2,33,9,1,2,2))
if mibBuilder.loadTexts:hwQ931IsdnTable.setStatus(_A)
_HwQ931IsdnEntry_Object=MibTableRow
hwQ931IsdnEntry=_HwQ931IsdnEntry_Object((1,3,6,1,4,1,2011,2,33,9,1,2,2,1))
...
hwQ931IsdnOpIndex=_HwQ931IsdnOpIndex_Object((1,3,6,1,4,1,2011,2,33,9,1,2,2,1,1),_HwQ931IsdnOpIndex_Type())
...
hwQ931IsdnLastCalled=_HwQ931IsdnLastCalled_Object((1,3,6,1,4,1,2011,2,33,9,1,2,2,1,2),_HwQ931IsdnLastCalled_Type())
...
hwQ931IsdnLastCalling=_HwQ931IsdnLastCalling_Object((1,3,6,1,4,1,2011,2,33,9,1,2,2,1,3),_HwQ931IsdnLastCalling_Type())
...
hwQ931IsdnLastCauseDisc=_HwQ931IsdnLastCauseDisc_Object((1,3,6,1,4,1,2011,2,33,9,1,2,2,1,4),_HwQ931IsdnLastCauseDisc_Type())
...
hwQ931IsdnCallDirection=_HwQ931IsdnCallDirection_Object((1,3,6,1,4,1,2011,2,33,9,1,2,2,1,5),_HwQ931IsdnCallDirection_Type())
...
hwQ931IsdnCallTimeOpen=_HwQ931IsdnCallTimeOpen_Object((1,3,6,1,4,1,2011,2,33,9,1,2,2,1,6),_HwQ931IsdnCallTimeOpen_Type())
...
hwQ931IsdnCallTimeClose=_HwQ931IsdnCallTimeClose_Object((1,3,6,1,4,1,2011,2,33,9,1,2,2,1,7),_HwQ931IsdnCallTimeClose_Type())
...
hwIsdnLapd=_HwIsdnLapd_ObjectIdentity((1,3,6,1,4,1,2011,2,33,9,1,3))
_HwLapdIsdnTable_Object=MibTable
hwLapdIsdnTable=_HwLapdIsdnTable_Object((1,3,6,1,4,1,2011,2,33,9,1,3,1))
if mibBuilder.loadTexts:hwLapdIsdnTable.setStatus(_A)
_HwLapdIsdnEntry_Object=MibTableRow
hwLapdIsdnEntry=_HwLapdIsdnEntry_Object((1,3,6,1,4,1,2011,2,33,9,1,3,1,1))
...
hwLapdIsdnIf=_HwLapdIsdnIf_Object((1,3,6,1,4,1,2011,2,33,9,1,3,1,1,1),_HwLapdIsdnIf_Type())
...
hwLapdIsdnProtocol=_HwLapdIsdnProtocol_Object((1,3,6,1,4,1,2011,2,33,9,1,3,1,1,2),_HwLapdIsdnProtocol_Type())
...
hwLapdIsdnIfMode=_HwLapdIsdnIfMode_Object((1,3,6,1,4,1,2011,2,33,9,1,3,1,1,3),_HwLapdIsdnIfMode_Type())
...
hwLapdIsdnLinkStatus=_HwLapdIsdnLinkStatus_Object((1,3,6,1,4,1,2011,2,33,9,1,3,1,1,4),_HwLapdIsdnLinkStatus_Type())
...
hwLapdIsdnControl=_HwLapdIsdnControl_ObjectIdentity((1,3,6,1,4,1,2011,2,33,9,1,3,2))
...
hwLapdStatusTrapEnable=_HwLapdStatusTrapEnable_Object((1,3,6,1,4,1,2011,2,33,9,1,3,2,1),_HwLapdStatusTrapEnable_Type())
...
hwIsdnMibTraps=_HwIsdnMibTraps_ObjectIdentity((1,3,6,1,4,1,2011,2,33,9,2))
hwChanbIsdnCall=NotificationType((1,3,6,1,4,1,2011,2,33,9,2,1))
...
hwQ931IsdnCallSetup=NotificationType((1,3,6,1,4,1,2011,2,33,9,2,2))
hwQ931IsdnCallSetup.setObjects(*((_B,_H),(_B,_K),(_B,_L),(_B,_M),(_B,_N)))
if mibBuilder.loadTexts:hwQ931IsdnCallSetup.setStatus(_A)
hwQ931IsdnCallClear=NotificationType((1,3,6,1,4,1,2011,2,33,9,2,3))
...
hwLapdIsdnStatusChange=NotificationType((1,3,6,1,4,1,2011,2,33,9,2,4))
