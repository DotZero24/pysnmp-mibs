# SNMP MIB module (HUAWEI-ISDN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/HUAWEI-ISDN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:17:39 2025
...
hwChanbIsdnIf = _HwChanbIsdnIf_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 1),
    _HwChanbIsdnIf_Type()
)
...
hwChanbIsdnPermit = _HwChanbIsdnPermit_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 2),
...
hwChanbIsdnAddr = _HwChanbIsdnAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 3),
...
hwChanbIsdnCallerAddr = _HwChanbIsdnCallerAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 4),
...
hwChanbIsdnCallType = _HwChanbIsdnCallType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 5),
...
hwChanbIsdnInfoType = _HwChanbIsdnInfoType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 6),
...
hwChanbIsdnState = _HwChanbIsdnState_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 7),
...
hwChanbIsdnCallFreeReason = _HwChanbIsdnCallFreeReason_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 8),
...
hwChanbIsdnCallFreeCode = _HwChanbIsdnCallFreeCode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 9),
...
hwChanbIsdnCallAccept = _HwChanbIsdnCallAccept_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 10),
...
hwChanbIsdnCallReject = _HwChanbIsdnCallReject_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 11),
...
hwChanbIsdnCallSuccess = _HwChanbIsdnCallSuccess_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 12),
...
hwChanbIsdnCallFailure = _HwChanbIsdnCallFailure_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 13),
...
hwChanbIsdnLastKeepTime = _HwChanbIsdnLastKeepTime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 15),
...
hwChanbIsdnLastCallTime = _HwChanbIsdnLastCallTime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 1, 1, 1, 16),
...
hwQ931CallSetupTrapEnable = _HwQ931CallSetupTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 2, 1, 1),
...
hwQ931CallClearTrapEnable = _HwQ931CallClearTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 2, 1, 2),
...
hwQ931IsdnOpIndex = _HwQ931IsdnOpIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 2, 2, 1, 1),
...
hwQ931IsdnLastCalled = _HwQ931IsdnLastCalled_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 2, 2, 1, 2),
...
hwQ931IsdnLastCalling = _HwQ931IsdnLastCalling_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 2, 2, 1, 3),
...
hwQ931IsdnCallDirection = _HwQ931IsdnCallDirection_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 2, 2, 1, 5),
...
hwQ931IsdnCallTimeOpen = _HwQ931IsdnCallTimeOpen_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 2, 2, 1, 6),
...
hwQ931IsdnCallTimeClose = _HwQ931IsdnCallTimeClose_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 2, 2, 1, 7),
...
hwLapdIsdnIf = _HwLapdIsdnIf_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 3, 1, 1, 1),
    _HwLapdIsdnIf_Type()
)
...
hwLapdIsdnIfMode = _HwLapdIsdnIfMode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 3, 1, 1, 3),
...
hwLapdStatusTrapEnable = _HwLapdStatusTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 1, 3, 2, 1),
...
hwChanbIsdnCall = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 2, 1)
)
hwChanbIsdnCall.setObjects(
      *(("HUAWEI-ISDN-MIB", "hwChanbIsdnIf"),
        ("HUAWEI-ISDN-MIB", "hwChanbIsdnAddr"),
        ("HUAWEI-ISDN-MIB", "hwChanbIsdnCallType"),
        ("HUAWEI-ISDN-MIB", "hwChanbIsdnCallerAddr"),
        ("HUAWEI-ISDN-MIB", "hwChanbIsdnInfoType"),
        ("HUAWEI-ISDN-MIB", "hwChanbIsdnLastKeepTime"),
        ("HUAWEI-ISDN-MIB", "hwChanbIsdnCallFreeReason"),
...
hwQ931IsdnCallSetup = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 2, 2)
)
hwQ931IsdnCallSetup.setObjects(
      *(("HUAWEI-ISDN-MIB", "hwQ931IsdnOpIndex"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnLastCalled"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnLastCalling"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnCallDirection"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnCallTimeOpen"))
)
if mibBuilder.loadTexts:
...
hwQ931IsdnCallClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 2, 3)
)
hwQ931IsdnCallClear.setObjects(
      *(("HUAWEI-ISDN-MIB", "hwQ931IsdnOpIndex"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnLastCalled"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnLastCalling"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnLastCauseDisc"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnCallDirection"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnCallTimeOpen"),
        ("HUAWEI-ISDN-MIB", "hwQ931IsdnCallTimeClose"))
)
if mibBuilder.loadTexts:
...
hwLapdIsdnStatusChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 2, 33, 9, 2, 4)
)
hwLapdIsdnStatusChange.setObjects(
      *(("HUAWEI-ISDN-MIB", "hwLapdIsdnIf"),
        ("HUAWEI-ISDN-MIB", "hwLapdIsdnLinkStatus"))
)
if mibBuilder.loadTexts:
