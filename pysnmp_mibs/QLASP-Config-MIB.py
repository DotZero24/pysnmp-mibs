...
mibBuilder.exportSymbols("QLASP-Config-MIB", btvPhysAddress=btvPhysAddress, btLiveLinkEnable=btLiveLinkEnable, btPhyAdapterNumber=btPhyAdapterNumber, btpAdapterIndex=btpAdapterIndex, btvLinkStatus=btvLinkStatus, btTeamType=btTeamType, qlaspPhyAdapter=qlaspPhyAdapter, btpMemberState=btpMemberState, btVirNumber=btVirNumber, btMode=btMode, btPhyAdapterTable=btPhyAdapterTable, btVirAdapterTable=btVirAdapterTable, qlaspTeam=qlaspTeam, btpAdapterDesc=btpAdapterDesc, btPhyAdapterEntry=btPhyAdapterEntry, btvTeamIndex=btvTeamIndex, btvLineSpeed=btvLineSpeed, btpMacAddress=btpMacAddress, btVirAdapterNumber=btVirAdapterNumber, btvAdapterDesc=btvAdapterDesc, btVirAdapterEntry=btVirAdapterEntry, btPhyNumber=btPhyNumber, btTeamIndex=btTeamIndex, btLinkTargetIpAddress1=btLinkTargetIpAddress1, btvVlanId=btvVlanId, btLinkTargetIpAddress2=btLinkTargetIpAddress2, btTeamNumber=btTeamNumber, btTeamName=btTeamName, btLinkRetryFrequency=btLinkRetryFrequency, btvAdapterIndex=btvAdapterIndex, btvSubnetMask=btvSubnetMask, enet=enet, btLinkTargetIpAddress3=btLinkTargetIpAddress3, qlasp=qlasp, btLinkPacketFrequency=btLinkPacketFrequency, qlogic=qlogic, btvIPAddress=btvIPAddress, btTeamEntry=btTeamEntry, qlaspVirAdapter=qlaspVirAdapter, btLinkMaxRetry=btLinkMaxRetry, btTeamTable=btTeamTable, btLinkTargetIpAddress4=btLinkTargetIpAddress4, qlaspConfig=qlaspConfig, btpMemberType=btpMemberType, btpLiveLinkIp=btpLiveLinkIp, btpTeamIndex=btpTeamIndex, btTeamMacAddress=btTeamMacAddress)
