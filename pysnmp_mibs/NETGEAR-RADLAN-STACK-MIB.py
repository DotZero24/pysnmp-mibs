...
rlStack=ModuleIdentity((1,3,6,1,4,1,4526,17,107))
if mibBuilder.loadTexts:rlStack.setRevisions(('2005-04-14 00:00',))
_RlStackActiveUnitIdTable_Object=MibTable
rlStackActiveUnitIdTable=_RlStackActiveUnitIdTable_Object((1,3,6,1,4,1,4526,17,107,1))
if mibBuilder.loadTexts:rlStackActiveUnitIdTable.setStatus(_A)
_RlStackActiveUnitIdEntry_Object=MibTableRow
rlStackActiveUnitIdEntry=_RlStackActiveUnitIdEntry_Object((1,3,6,1,4,1,4526,17,107,1,1))
...
rlStackCurrentUnitId=_RlStackCurrentUnitId_Object((1,3,6,1,4,1,4526,17,107,1,1,1),_RlStackCurrentUnitId_Type())
...
rlStackActiveUnitIdAfterReset=_RlStackActiveUnitIdAfterReset_Object((1,3,6,1,4,1,4526,17,107,1,1,2),_RlStackActiveUnitIdAfterReset_Type())
...
rlStackUnitModeAfterReset=_RlStackUnitModeAfterReset_Object((1,3,6,1,4,1,4526,17,107,2),_RlStackUnitModeAfterReset_Type())
...
rlStackUnitMode=_RlStackUnitMode_Object((1,3,6,1,4,1,4526,17,107,3),_RlStackUnitMode_Type())
...
rlStackUnitMacAddressAfterReset=_RlStackUnitMacAddressAfterReset_Object((1,3,6,1,4,1,4526,17,107,4),_RlStackUnitMacAddressAfterReset_Type())
...
rlStackTopology=_RlStackTopology_Object((1,3,6,1,4,1,4526,17,107,6),_RlStackTopology_Type())
