# SNMP MIB module (NETGEAR-RADLAN-STACK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-STACK-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:29:09 2025
...
rlStackActiveUnitIdEntry = _RlStackActiveUnitIdEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 107, 1, 1)
)
rlStackActiveUnitIdEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-STACK-MIB", "rlStackCurrentUnitId"),
)
if mibBuilder.loadTexts:
