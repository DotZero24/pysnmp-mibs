...
mibBuilder.exportSymbols("CTRON-VLAN-EXTENSIONS-MIB", ctVlanTriggerPortConfig=ctVlanTriggerPortConfig, ctVlanPortOperationalMode=ctVlanPortOperationalMode, ctVlanConfigTable=ctVlanConfigTable, ctVlanBridgeConfig=ctVlanBridgeConfig, ctVlanType=ctVlanType, ctVlanEgressList=ctVlanEgressList, ctVlanPortConfigEntry=ctVlanPortConfigEntry, ctVlanTriggerStatus=ctVlanTriggerStatus, ctVlanSupportedPortNum=ctVlanSupportedPortNum, ctVlanPortVID=ctVlanPortVID, ctVlanIdToFidMapping=ctVlanIdToFidMapping, ctVlanNumConfiguredEntries=ctVlanNumConfiguredEntries, ctVlanProtoEstablish=ctVlanProtoEstablish, ctVlanDefaultVIDStickyEgress=ctVlanDefaultVIDStickyEgress, ctVlanMaxNumEntries=ctVlanMaxNumEntries, ctVlanProtocolStatus=ctVlanProtocolStatus, ctVlanConfigEntry=ctVlanConfigEntry, ctVlanEstablish=ctVlanEstablish, ctVlanVersionNumber=ctVlanVersionNumber, ctVlanEgressPortsTable=ctVlanEgressPortsTable, ctVlanCurrentOperationalMode=ctVlanCurrentOperationalMode, ctVlanSupportedPortEntry=ctVlanSupportedPortEntry, ctVlanResetDefaults=ctVlanResetDefaults, ctVlanPortConfigTable=ctVlanPortConfigTable, ctVlanEgressPortEntry=ctVlanEgressPortEntry, ctVlanTriggerPortEntry=ctVlanTriggerPortEntry, ctVlanEgressVID=ctVlanEgressVID, ctVlanNumActiveEntries=ctVlanNumActiveEntries, ctVlanSupportedOperationalMode=ctVlanSupportedOperationalMode, ctVlanStatus=ctVlanStatus, ctVlanPortDiscardFrame=ctVlanPortDiscardFrame, ctVlanSupportedPortTable=ctVlanSupportedPortTable, ctVlanEgressPortSlotNum=ctVlanEgressPortSlotNum, ctVlanPortSlotNum=ctVlanPortSlotNum, ctVlanProtoEtherType=ctVlanProtoEtherType, ctVlanPortIngressFiltering=ctVlanPortIngressFiltering, ctVlanTriggerPortSetTable=ctVlanTriggerPortSetTable, ctVlanName=ctVlanName, ctVlanPortConfig=ctVlanPortConfig, ctVlanEgressUntaggedList=ctVlanEgressUntaggedList, ctVlanPortNum=ctVlanPortNum, ctVlanProtoAssignTable=ctVlanProtoAssignTable, ctMaxNumVlanProtoEntries=ctMaxNumVlanProtoEntries, ctVlanLearningMode=ctVlanLearningMode, ctVlanProtoPortList=ctVlanProtoPortList, ctVlanProtoAssignEntry=ctVlanProtoAssignEntry, ctVlanVID=ctVlanVID, ctVlanProtocolAssign=ctVlanProtocolAssign, ctVlanSupportedSlotNum=ctVlanSupportedSlotNum, ctVlanConfig=ctVlanConfig, ctVlanTriggerSlotNum=ctVlanTriggerSlotNum)
