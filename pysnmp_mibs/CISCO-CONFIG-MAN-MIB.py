...
mibBuilder.exportSymbols("CISCO-CONFIG-MAN-MIB", ciscoConfigManCTIDNotifyGroup=ciscoConfigManCTIDNotifyGroup, ccmHistoryEventEntry=ccmHistoryEventEntry, ccmHistoryEventVirtualHostName=ccmHistoryEventVirtualHostName, ccmHistoryEventCommandSource=ccmHistoryEventCommandSource, ccmHistoryEventCommandSourceAddrRev1=ccmHistoryEventCommandSourceAddrRev1, ccmHistoryEventTerminalLocation=ccmHistoryEventTerminalLocation, ccmCLIHistoryCmdEntries=ccmCLIHistoryCmdEntries, ccmCLIHistoryCommandTable=ccmCLIHistoryCommandTable, ccmCTIDLastChangeTime=ccmCTIDLastChangeTime, ccmHistoryEventTerminalNumber=ccmHistoryEventTerminalNumber, ccmCTIDRolledOverNotifEnable=ccmCTIDRolledOverNotifEnable, ciscoConfigManEvent=ciscoConfigManEvent, ccmHistoryRunningLastChanged=ccmHistoryRunningLastChanged, ccmHistoryEventCommandSourceAddrType=ccmHistoryEventCommandSourceAddrType, ccmCTIDRolledOver=ccmCTIDRolledOver, ciscoConfigManMIBGroups=ciscoConfigManMIBGroups, ciscoConfigManHistoryGroupRev2=ciscoConfigManHistoryGroupRev2, ciscoConfigManHistNotifyGroup=ciscoConfigManHistNotifyGroup, ccmCTID=ccmCTID, ccmCTIDWhoChanged=ccmCTIDWhoChanged, ccmHistoryEventIndex=ccmHistoryEventIndex, ccmCLIHistoryCommandEntry=ccmCLIHistoryCommandEntry, ccmHistoryEventTime=ccmHistoryEventTime, ccmHistoryEventRcpUser=ccmHistoryEventRcpUser, ccmHistoryCLICmdEntriesBumped=ccmHistoryCLICmdEntriesBumped, ciscoConfigManMIBComplianceRev3=ciscoConfigManMIBComplianceRev3, ciscoConfigManCTIDObjectGroup=ciscoConfigManCTIDObjectGroup, ciscoConfigManMIBCompliances=ciscoConfigManMIBCompliances, ccmHistoryEventConfigSource=ccmHistoryEventConfigSource, ciscoConfigManMIBConformance=ciscoConfigManMIBConformance, ccmHistoryEventEntriesBumped=ccmHistoryEventEntriesBumped, ccmHistoryEventCommandSourceAddress=ccmHistoryEventCommandSourceAddress, ccmCTIDObjects=ccmCTIDObjects, ccmCLICfgRunConfNotifEnable=ccmCLICfgRunConfNotifEnable, ciscoConfigManHistoryGroupRev1=ciscoConfigManHistoryGroupRev1, ciscoConfigManMIB=ciscoConfigManMIB, ccmHistoryEventConfigDestination=ccmHistoryEventConfigDestination, ccmCLIHistoryCommandIndex=ccmCLIHistoryCommandIndex, ccmHistoryEventServerAddrType=ccmHistoryEventServerAddrType, ciscoConfigManCLIHistCmdGroup=ciscoConfigManCLIHistCmdGroup, ciscoConfigManMIBNotifications=ciscoConfigManMIBNotifications, PYSNMP_MODULE_ID=ciscoConfigManMIB, ccmCLICfg=ccmCLICfg, ccmHistoryEventTerminalUser=ccmHistoryEventTerminalUser, ccmHistoryEventServerAddress=ccmHistoryEventServerAddress, ccmHistoryEventServerAddrRev1=ccmHistoryEventServerAddrRev1, ccmCLIHistoryMaxCmdEntries=ccmCLIHistoryMaxCmdEntries, ccmHistoryMaxEventEntries=ccmHistoryMaxEventEntries, ccmHistoryEventTerminalType=ccmHistoryEventTerminalType, ccmHistoryRunningLastSaved=ccmHistoryRunningLastSaved, ccmHistory=ccmHistory, ccmCLIHistoryCmdEntriesAllowed=ccmCLIHistoryCmdEntriesAllowed, ccmHistoryEventTable=ccmHistoryEventTable, ciscoConfigManMIBCompliance=ciscoConfigManMIBCompliance, HistoryEventMedium=HistoryEventMedium, ccmCLIHistory=ccmCLIHistory, ccmCLIHistoryCommand=ccmCLIHistoryCommand, ciscoConfigManMIBComplianceRev4=ciscoConfigManMIBComplianceRev4, ccmCLIRunningConfigChanged=ccmCLIRunningConfigChanged, ciscoConfigManMIBNotificationPrefix=ciscoConfigManMIBNotificationPrefix, ciscoConfigManMIBObjects=ciscoConfigManMIBObjects, ccmHistoryEventFile=ccmHistoryEventFile, ciscoConfigManHistoryGroup=ciscoConfigManHistoryGroup, ccmHistoryStartupLastChanged=ccmHistoryStartupLastChanged, ciscoConfigManMIBComplianceRev2=ciscoConfigManMIBComplianceRev2)
