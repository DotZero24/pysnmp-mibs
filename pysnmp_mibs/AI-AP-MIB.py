...
# Notes
# -----
# ASN.1 source file://mibs/aruba/AI-AP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:23:11 2025
...
if mibBuilder.loadTexts:
    aiMasterIPAddress.setStatus("obsolete")
...
aiConductorIPAddress = _AiConductorIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 1, 16),
    _AiConductorIPAddress_Type()
)
aiConductorIPAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    aiConductorIPAddress.setStatus("current")
...
wlsxTrapStationDenyListReason = _WlsxTrapStationDenyListReason_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 156),
...
wlsxTrapStationDenyListReasonStr = _WlsxTrapStationDenyListReasonStr_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 157),
...
wlsxTrapConductorIp = _WlsxTrapConductorIp_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 158),
    _WlsxTrapConductorIp_Type()
)
wlsxTrapConductorIp.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapConductorIp.setStatus("current")


class _WlsxTrapConductorName_Type(DisplayString):
    """Custom type wlsxTrapConductorName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_WlsxTrapConductorName_Type.__name__ = "DisplayString"
_WlsxTrapConductorName_Object = MibScalar
wlsxTrapConductorName = _WlsxTrapConductorName_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 159),
    _WlsxTrapConductorName_Type()
)
wlsxTrapConductorName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapConductorName.setStatus("current")
...
wlsxTrapApConductorStatus = _WlsxTrapApConductorStatus_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 160),
...
wlsxTrapAPHTMode = _WlsxTrapAPHTMode_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 161),
...
wlsxTrapAPPhyType = _WlsxTrapAPPhyType_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 162),
...
wlsxTrapAPPrevHTMode = _WlsxTrapAPPrevHTMode_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 163),
...
wlsxTrapAPPrevPhyType = _WlsxTrapAPPrevPhyType_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 164),
...
wlsxTrapAPSecChannel = _WlsxTrapAPSecChannel_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 165),
...
wlsxTrapAPBand = _WlsxTrapAPBand_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 166),
...
wlsxTrapTargetAPBand = _WlsxTrapTargetAPBand_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 167),
...
wlsxTrapMatchedIpv6 = _WlsxTrapMatchedIpv6_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 168),
...
wlsxNRadioAttributesChanged.setObjects(
      *(("AI-AP-MIB", "wlsxTrapTime"),
        ...
        ("AI-AP-MIB", "wlsxTrapAPSecChannel"),
        ("AI-AP-MIB", "wlsxTrapAPPhyType"),
        ("AI-AP-MIB", "wlsxTrapAPHTMode"))
)
if mibBuilder.loadTexts:
...
wlsxUnsecureAPDetected.setObjects(
      *(("AI-AP-MIB", "wlsxTrapTime"),
        ...
        ("AI-AP-MIB", "wlsxTrapMatchedIpv6"),
        ("AI-AP-MIB", "wlsxTrapAPBand"))
)
if mibBuilder.loadTexts:
...
wlsxMalformedFrameWrongChannelDetected.setObjects(
      *(("AI-AP-MIB", "wlsxTrapTime"),
        ...
        ("AI-AP-MIB", "wlsxTrapSnr"),
        ("AI-AP-MIB", "wlsxTrapAPBand"),
        ("AI-AP-MIB", "wlsxTrapTargetAPBand"))
)
if mibBuilder.loadTexts:
...
wlsxAPChannelChange.setObjects(
      *(("AI-AP-MIB", "wlsxTrapTime"),
        ...
        ("AI-AP-MIB", "wlsxTrapAPHTMode"),
        ("AI-AP-MIB", "wlsxTrapAPPhyType"),
        ("AI-AP-MIB", "wlsxTrapAPPrevHTMode"),
...
wlsxNStationAddedToDenyList.setObjects(
      *(("AI-AP-MIB", "wlsxTrapTime"),
        ("AI-AP-MIB", "wlsxTrapNodeMac"),
        ("AI-AP-MIB", "wlsxTrapStationDenyListReasonStr"),
        ("AI-AP-MIB", "wlsxTrapStationDenyListReason"))
)
if mibBuilder.loadTexts:
...
wlsxNAPConductorStatusChange.setObjects(
      *(("AI-AP-MIB", "wlsxTrapTime"),
        ("AI-AP-MIB", "wlsxTrapAPMacAddress"),
        ("AI-AP-MIB", "wlsxTrapApControllerIp"),
        ("AI-AP-MIB", "wlsxTrapApConductorStatus"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ArubaEnableValue": ArubaEnableValue,
       ...
       "ArubaDenyListReason": ArubaDenyListReason,
       "ArubaAPConductorStatus": ArubaAPConductorStatus,
       "aiMIB": aiMIB,
       ...
       "aiConductorIPAddress": aiConductorIPAddress,
       ...
       "wlsxTrapConductorIp": wlsxTrapConductorIp,
       "wlsxTrapConductorName": wlsxTrapConductorName,
