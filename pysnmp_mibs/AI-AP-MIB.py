...
DisplayString, MacAddress, TimeInterval, RowStatus, StorageType, TestAndIncr, DateAndTime, PhysAddress, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "MacAddress", "TimeInterval", "RowStatus", "StorageType", "TestAndIncr", "DateAndTime", "PhysAddress", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("AI-AP-MIB", wlsxUnsecureAPResolved=wlsxUnsecureAPResolved, ArubaSubAuthenticationMethods=ArubaSubAuthenticationMethods, aiTrapDefinitionsGroup=aiTrapDefinitionsGroup, aiRadioUtilization4=aiRadioUtilization4, wlsxTrapPrimaryControllerIp=wlsxTrapPrimaryControllerIp, aiInterferAPChannel=aiInterferAPChannel, ArubaAuthServerType=ArubaAuthServerType, wlsxTrapAPPrevTxPower=wlsxTrapAPPrevTxPower, wlsxNSignatureMatchDeauthBcast=wlsxNSignatureMatchDeauthBcast, wlsxSignAPDeauthBcast=wlsxSignAPDeauthBcast, wlsxTrapDBType=wlsxTrapDBType, ArubaSupportStatus=ArubaSupportStatus, wlsxTrapUserName=wlsxTrapUserName, wlsxNSignatureMatch=wlsxNSignatureMatch, wlsxTrapAPUplinkChangeReason=wlsxTrapAPUplinkChangeReason, aiManagedModeSinceLastSync=aiManagedModeSinceLastSync, wlsxTKIPReplayAttack=wlsxTKIPReplayAttack, aiAPMemoryFree=aiAPMemoryFree, wlsxTrapUpdateFailureReason=wlsxTrapUpdateFailureReason, ArubaAPUplinkChangeReason=ArubaAPUplinkChangeReason, wlsxTrapTargetAPChannel=wlsxTrapTargetAPChannel, wlsxTrapHostIp=wlsxTrapHostIp, wlsxMalformedFrameLargeDurationDetected=wlsxMalformedFrameLargeDurationDetected, aiInterferAPESSID=aiInterferAPESSID, wlsxNAuthServerTimedOut=wlsxNAuthServerTimedOut, ArubaARMChangeReason=ArubaARMChangeReason, wlsxTrapInterferingAPInfoURL=wlsxTrapInterferingAPInfoURL, aiMeshHops=aiMeshHops, wlsxNUserEntryDeAuthenticated=wlsxNUserEntryDeAuthenticated, ArubaAPMasterStatus=ArubaAPMasterStatus, ArubaHTExtChannel=ArubaHTExtChannel, wlsxNSignatureMatchDisassocBcast=wlsxNSignatureMatchDisassocBcast, wlsxTarpitContainment=wlsxTarpitContainment, ArubaOperStateValue=ArubaOperStateValue, wlsxNChannelChanged=wlsxNChannelChanged, wlsxReservedChannelViolation=wlsxReservedChannelViolation, wlsxTrapAPBSSID=wlsxTrapAPBSSID, wlsxNSuspectRogueAPResolved=wlsxNSuspectRogueAPResolved, wlsxTrapLocalIp=wlsxTrapLocalIp, wlsxAPDeauthContainment=wlsxAPDeauthContainment, wlsxTrapRogueInfoURL=wlsxTrapRogueInfoURL, wlsxTrapCTSTransferType=wlsxTrapCTSTransferType, wlsxTrapAPHTMode=wlsxTrapAPHTMode, wlsxRepeatWEPIVViolation=wlsxRepeatWEPIVViolation, wlsxValidClientMisassociation=wlsxValidClientMisassociation, aiClientMACAddress=aiClientMACAddress, wlsxTrapProcessName=wlsxTrapProcessName, wlsxTrapCardSlot=wlsxTrapCardSlot, wlsxAPTaggedWiredContainment=wlsxAPTaggedWiredContainment, aiMeshIndex=aiMeshIndex, aiRadioTxTotalFrames=aiRadioTxTotalFrames, aiRadioAPMACAddress=aiRadioAPMACAddress, wlsxTrapAPChannelSec=wlsxTrapAPChannelSec, wlsxWEPMisconfiguration=wlsxWEPMisconfiguration, wlsxTrapStationBlackListReason=wlsxTrapStationBlackListReason, aiClientPhyType=aiClientPhyType, aiRadioMode=aiRadioMode, ArubaRogueApType=ArubaRogueApType, wlsxSSIDMisconfiguration=wlsxSSIDMisconfiguration, ArubaAuthenticationMethods=ArubaAuthenticationMethods, wlsxTrapRogueIfoURL=wlsxTrapRogueIfoURL, wlsxTrapVlanId=wlsxTrapVlanId, wlsxTrapAPPrevMode=wlsxTrapAPPrevMode, wlsxUserEntryAttributesChanged=wlsxUserEntryAttributesChanged, aiClientTxRate=aiClientTxRate, aiClientTable=aiClientTable, wlsxChannelRateAnomaly=wlsxChannelRateAnomaly, ArubaMonEncryptionCipher=ArubaMonEncryptionCipher, wlsxInvalidAddressCombination=wlsxInvalidAddressCombination, wlsxTrapUserAttributeChangeType=wlsxTrapUserAttributeChangeType, aiInterferAPIndex=aiInterferAPIndex, wlsxTrapVrrpOperState=wlsxTrapVrrpOperState, ArubaUnprovisionedStatus=ArubaUnprovisionedStatus, wlsxDisconnectStationAttackSta=wlsxDisconnectStationAttackSta, wlsxTrapVoltageType=wlsxTrapVoltageType, wlsxAPImpersonation=wlsxAPImpersonation, wlsxSignStaNetstumbler=wlsxSignStaNetstumbler, wlsxTrapPortNumber=wlsxTrapPortNumber, wlsxSignAPNullProbeResp=wlsxSignAPNullProbeResp, wlsxNAdhocUsingValidSSID=wlsxNAdhocUsingValidSSID, aiAPModel=aiAPModel, ArubaVrrpState=ArubaVrrpState, wlsxNSignatureMatchAsleap=wlsxNSignatureMatchAsleap, ArubaEnableValue=ArubaEnableValue, wlsxAPInterferenceCleared=wlsxAPInterferenceCleared, wlsxTrapPortalServerName=wlsxTrapPortalServerName, aiClientUptime=aiClientUptime, wlsxTrapSourceMac=wlsxTrapSourceMac, ArubaVoiceCdrDirection=ArubaVoiceCdrDirection, wlsxStaPolicyViolation=wlsxStaPolicyViolation, aiAPSerialNum=aiAPSerialNum, wlsxTrapTunnelUpReason=wlsxTrapTunnelUpReason, ArubaESIServerMode=ArubaESIServerMode, wlsxChannelInterferenceDetected=wlsxChannelInterferenceDetected, wlsxDisconnectStationAttack=wlsxDisconnectStationAttack, aiAccessPointEntry=aiAccessPointEntry, wlsxSignAPAirjack=wlsxSignAPAirjack, wlsxClientDeauthContainment=wlsxClientDeauthContainment, wlsxSequenceNumberAnomalySta=wlsxSequenceNumberAnomalySta, wlsxNRogueAPDetected=wlsxNRogueAPDetected, aiClientName=aiClientName, wlsxTrapStationDenyListReason=wlsxTrapStationDenyListReason, aiWlanESSID=aiWlanESSID, ArubaVlanValidRange=ArubaVlanValidRange, ArubaDBType=ArubaDBType, wlsxTrapAPChannel=wlsxTrapAPChannel, ArubaDot1dState=ArubaDot1dState, wlsxNRogueAPResolved=wlsxNRogueAPResolved, wlsxHT40MHzIntoleranceAP=wlsxHT40MHzIntoleranceAP, ArubaPhyType=ArubaPhyType, wlsxTrapUserPhyAddress=wlsxTrapUserPhyAddress, wlsxFrameFragmentationRateExceeded=wlsxFrameFragmentationRateExceeded, aiWlanRxDataFrames=aiWlanRxDataFrames, aiVirtualControllerVersion=aiVirtualControllerVersion, wlsxWindowsBridgeDetected=wlsxWindowsBridgeDetected, wlsxTrapApConductorStatus=wlsxTrapApConductorStatus, wlsxTrapHostPort=wlsxTrapHostPort, aiClientAPMac=aiClientAPMac, aiVoiceClientTable=aiVoiceClientTable, wlsxTrapMissingLicenses=wlsxTrapMissingLicenses, aiAPMACAddress=aiAPMACAddress, wlsxTrapGlobalConfigObj=wlsxTrapGlobalConfigObj, wlsxChannelFrameFragmentationRateExceeded=wlsxChannelFrameFragmentationRateExceeded, ArubaAddressType=ArubaAddressType, wlsxHtGreenfieldSupported=wlsxHtGreenfieldSupported, ArubaHashAlgorithms=ArubaHashAlgorithms, wlsxTrapAPPrevChannelSec=wlsxTrapAPPrevChannelSec, wlsxTrapLocalName=wlsxTrapLocalName, wlsxNSignatureMatchNetstumbler=wlsxNSignatureMatchNetstumbler, aiRadioIndex=aiRadioIndex, wlsxMalformedAuthFrame=wlsxMalformedAuthFrame, ArubaFrameType=ArubaFrameType, wlsxNSuspectRogueAPDetected=wlsxNSuspectRogueAPDetected, wlsxTrapESIServerGrpName=wlsxTrapESIServerGrpName, wlsxTrapEssid=wlsxTrapEssid, ArubaIfType=ArubaIfType, wlsxChopChopAttack=wlsxChopChopAttack, wlsxTrapSwitchIp=wlsxTrapSwitchIp, wlsxTrapAPARMChangeReason=wlsxTrapAPARMChangeReason, wlsxSignatureMatchSta=wlsxSignatureMatchSta, aiRadioEntry=aiRadioEntry, wlsxClientFloodAttack=wlsxClientFloodAttack, aiAPTotalMemory=aiAPTotalMemory, wlsxAdhocNetworkDetected=wlsxAdhocNetworkDetected, aiWlanRxDataBytes=aiWlanRxDataBytes, wlsxTrapVrrpMasterIp=wlsxTrapVrrpMasterIp, wlsxClientTaggedWiredContainment=wlsxClientTaggedWiredContainment, wlsxAPChannelChange=wlsxAPChannelChange, ArubaActiveState=ArubaActiveState, wlsxStaAssociatedToUnsecureAP=wlsxStaAssociatedToUnsecureAP, aiRadioTxDataBytes=aiRadioTxDataBytes, aiStateGroup=aiStateGroup, wlsxTrapSwitchRole=wlsxTrapSwitchRole, aiWlanAPMACAddress=aiWlanAPMACAddress, aiRadioTxMgmtFrames=aiRadioTxMgmtFrames, wlsxTrapBackupControllerIp=wlsxTrapBackupControllerIp, wlsxTrapESIServerName=wlsxTrapESIServerName, wlsxAPBROADCASTSTORM=wlsxAPBROADCASTSTORM, wlsxNAdhocNetworkBridgeDetectedAP=wlsxNAdhocNetworkBridgeDetectedAP, wlsxWeakWEPIVViolation=wlsxWeakWEPIVViolation, aiClientTxDataFrames=aiClientTxDataFrames, wlsxPortalServerUp=wlsxPortalServerUp, wlsxOverflowEAPOLKeyDetected=wlsxOverflowEAPOLKeyDetected, wlsxOmertaAttack=wlsxOmertaAttack, wlsxNUserEntryCreated=wlsxNUserEntryCreated, ArubaCallStates=ArubaCallStates, aiClientRxRate=aiClientRxRate, ArubaACLNetworkServiceType=ArubaACLNetworkServiceType, wlsxWindowsBridgeDetectedSta=wlsxWindowsBridgeDetectedSta, wlsxMitMDetected=wlsxMitMDetected, wlsxTrapTunnelStatus=wlsxTrapTunnelStatus, wlsxTrapTargetAPBand=wlsxTrapTargetAPBand, wlsxTrapAuthServerName=wlsxTrapAuthServerName, wlsxValidSSIDViolation=wlsxValidSSIDViolation, wlsxWPAFTAttack=wlsxWPAFTAttack, aiWlanTxDataBytes=aiWlanTxDataBytes, wlsxAdhocNetwork=wlsxAdhocNetwork, wlsxHotspotterAttackDetected=wlsxHotspotterAttackDetected, wlsxTrapAuthServerAddress=wlsxTrapAuthServerAddress, wlsxTrapConductorName=wlsxTrapConductorName, aiRadioRxDataBytes=aiRadioRxDataBytes, wlsxNStationAddedToDenyList=wlsxNStationAddedToDenyList, wlsxTrapAuthServerTimeout=wlsxTrapAuthServerTimeout, ArubaMeshRole=ArubaMeshRole, wlsxWarmStart=wlsxWarmStart, wlsxTrapAPSecChannel=wlsxTrapAPSecChannel, wlsxWirelessBridge=wlsxWirelessBridge, wlsxNeighborAPDetected=wlsxNeighborAPDetected, wlsxAPSpoofingDetected=wlsxAPSpoofingDetected, aiSSIDIndex=aiSSIDIndex, wlsxTrapUserRole=wlsxTrapUserRole, aiRadioPhyEvents=aiRadioPhyEvents, aiRadioUtilization64=aiRadioUtilization64, wlsxTrapAPRadioNumber=wlsxTrapAPRadioNumber, ArubaMonitorMode=ArubaMonitorMode, wlsxStaUnAssociatedFromUnsecureAP=wlsxStaUnAssociatedFromUnsecureAP, ArubaAccessPointMode=ArubaAccessPointMode, aiAPCPUUtilization=aiAPCPUUtilization, wlsxTrapConfigurationState=wlsxTrapConfigurationState, wlsxSignStaDeauthBcast=wlsxSignStaDeauthBcast, aiClientMac=aiClientMac, aiAPStatus=aiAPStatus, wlsxTrapDBUserName=wlsxTrapDBUserName, wlsxTrapDBName=wlsxTrapDBName, aiMeshCost=aiMeshCost, wlsxFataJackAttack=wlsxFataJackAttack, ArubaVoipProtocolType=ArubaVoipProtocolType, wlsxStaInterferenceDetected=wlsxStaInterferenceDetected, aiMeshPointMac=aiMeshPointMac, aiRadioClientNum=aiRadioClientNum, wlsxNodeRateAnomaly=wlsxNodeRateAnomaly, wlsxTrapSpoofedFrameType=wlsxTrapSpoofedFrameType, wlsxSignalAnomaly=wlsxSignalAnomaly, ArubaDaysOfWeek=ArubaDaysOfWeek, aiClientAPIPAddress=aiClientAPIPAddress, wlsxTrapAPLocation=wlsxTrapAPLocation, wlsxNRadioAttributesChanged=wlsxNRadioAttributesChanged, wlsxTrapAPPreviousUplinkActiveTime=wlsxTrapAPPreviousUplinkActiveTime, aiRadioChannel=aiRadioChannel, aiVirtualControllerIPAddress=aiVirtualControllerIPAddress, wlsxTrapApSerialNumber=wlsxTrapApSerialNumber, ArubaPortMode=ArubaPortMode, wlsxStaImpersonation=wlsxStaImpersonation, aiManagedInfoGroup=aiManagedInfoGroup, wlsxChannelInterferenceCleared=wlsxChannelInterferenceCleared, wlsxAdhocNetworkBridgeDetectedAP=wlsxAdhocNetworkBridgeDetectedAP, wlsxSequenceNumberAnomalyAP=wlsxSequenceNumberAnomalyAP, ArubaACLDomain=ArubaACLDomain, wlsxTrapMasterName=wlsxTrapMasterName, wlsxCTSRateAnomaly=wlsxCTSRateAnomaly, wlsxNAuthServerAllInService=wlsxNAuthServerAllInService, ArubaAPMatchType=ArubaAPMatchType, aiInterferAPType=aiInterferAPType, aiSSIDStatus=aiSSIDStatus, wlsxTrapAPTxPower=wlsxTrapAPTxPower, wlsxTrapAPPhyType=wlsxTrapAPPhyType, wlsxTrapTargetAPSSID=wlsxTrapTargetAPSSID, ArubaESIServerStatus=ArubaESIServerStatus, wlsxStaRepeatWEPIVViolation=wlsxStaRepeatWEPIVViolation, ArubaDenyListReason=ArubaDenyListReason, aiClientRxDataBytes=aiClientRxDataBytes, wlsxTrapTransmitterMac=wlsxTrapTransmitterMac, aiMIB=aiMIB, ArubaPortSpeed=ArubaPortSpeed, aiMeshAge=aiMeshAge, wlsxTrapLicenseDaysRemaining=wlsxTrapLicenseDaysRemaining, wlsxFrameNonUnicastRateExceeded=wlsxFrameNonUnicastRateExceeded, wlsxAPPowerChange=wlsxAPPowerChange, wlsxAPInterferenceDetected=wlsxAPInterferenceDetected, wlsxNAPConductorStatusChange=wlsxNAPConductorStatusChange, aiRadioTxDrops=aiRadioTxDrops, wlsxTrapAdminStatus=wlsxTrapAdminStatus, wlsxNodeRateAnomalyAP=wlsxNodeRateAnomalyAP, aiWlanRxTotalFrames=aiWlanRxTotalFrames)
mibBuilder.exportSymbols("AI-AP-MIB", aiSSIDHide=aiSSIDHide, aiRadioTransmitPower=aiRadioTransmitPower, aiClientTxRetries=aiClientTxRetries, ArubaMonEncryptionType=ArubaMonEncryptionType, wlsxTrapTargetAPBSSID=wlsxTrapTargetAPBSSID, wlsxTrapUpdateFailedObj=wlsxTrapUpdateFailedObj, wlsxFrameRetryRateExceeded=wlsxFrameRetryRateExceeded, wlsxTrapAPPrevChannel=wlsxTrapAPPrevChannel, wlsxTrapVrrpID=wlsxTrapVrrpID, wlsxNDisconnectStationAttack=wlsxNDisconnectStationAttack, wlsxClientPskAuthenticationFailed=wlsxClientPskAuthenticationFailed, wlsxTrapApMasterStatus=wlsxTrapApMasterStatus, aiRadioTxDataFrames=aiRadioTxDataFrames, wlsxCLEARPASSSERVERINVALID=wlsxCLEARPASSSERVERINVALID, wlsxNAPMasterStatusChange=wlsxNAPMasterStatusChange, wlsxAPActiveUplinkChanged=wlsxAPActiveUplinkChanged, wlsxTrapUserIpAddress=wlsxTrapUserIpAddress, ArubaAPStatus=ArubaAPStatus, wlsxNSignatureMatchAirjack=wlsxNSignatureMatchAirjack, wlsxSignAPAsleap=wlsxSignAPAsleap, wlsxTrapMasterIp=wlsxTrapMasterIp, wlsxWindowsBridgeDetectedAP=wlsxWindowsBridgeDetectedAP, wlsxNUserAuthenticationFailed=wlsxNUserAuthenticationFailed, aiInterferAccessPointEntry=aiInterferAccessPointEntry, ArubaAntennaSetting=ArubaAntennaSetting, wlsxColdStart=wlsxColdStart, wlsxTrapSpoofedNewPhyAddress=wlsxTrapSpoofedNewPhyAddress, ArubaVoipProtocol=ArubaVoipProtocol, wlsxTrapAuthFailureReason=wlsxTrapAuthFailureReason, aiVirtualControllerName=aiVirtualControllerName, wlsxNAdhocNetwork=wlsxNAdhocNetwork, wlsxNSignatureMatchNullProbeResp=wlsxNSignatureMatchNullProbeResp, wlsxPortalServerDown=wlsxPortalServerDown, aiInterferAPEncr=aiInterferAPEncr, wlsxAPManagedModeConfigFailureTrap=wlsxAPManagedModeConfigFailureTrap, ArubaHTMode=ArubaHTMode, wlsxOUIMisconfiguration=wlsxOUIMisconfiguration, PYSNMP_MODULE_ID=aiMIB, aiInterferAPAvgSnr=aiInterferAPAvgSnr, wlsxTrapLicenseId=wlsxTrapLicenseId, aiTrapsGroup=aiTrapsGroup, aiWlanTable=aiWlanTable, wlsxAdhocNetworkBridgeDetectedSta=wlsxAdhocNetworkBridgeDetectedSta, wlsxNStationRemovedFromBlackList=wlsxNStationRemovedFromBlackList, aiRadioRxTotalFrames=aiRadioRxTotalFrames, aiClientIP=aiClientIP, wlsxTrapMatchedIp=wlsxTrapMatchedIp, ArubaEnet1Mode=ArubaEnet1Mode, aiWlanMACAddress=aiWlanMACAddress, wlsxMgmtUserAuthenticationFailed=wlsxMgmtUserAuthenticationFailed, wlsxTrapAPActiveUplinkType=wlsxTrapAPActiveUplinkType, wlsxTrapConfidenceLevel=wlsxTrapConfidenceLevel, aiMeshPortalMac=aiMeshPortalMac, ArubaHTRate=ArubaHTRate, ArubaConfigurationChangeType=ArubaConfigurationChangeType, wlsxSuspectUnsecureAPDetected=wlsxSuspectUnsecureAPDetected, wlsxTrapFrameType=wlsxTrapFrameType, aiWlanSSIDTable=aiWlanSSIDTable, wlsxAdhocNetworkBridgeDetected=wlsxAdhocNetworkBridgeDetected, wlsxTrapCrlName=wlsxTrapCrlName, ArubaBlackListReason=ArubaBlackListReason, wlsxPowerSaveDosAttack=wlsxPowerSaveDosAttack, wlsxFrameReceiveErrorRateExceeded=wlsxFrameReceiveErrorRateExceeded, wlsxTrapTableGenNumber=wlsxTrapTableGenNumber, aiVoiceClientEntry=aiVoiceClientEntry, wlsxNodeRateAnomalySta=wlsxNodeRateAnomalySta, aiSSID=aiSSID, aiClientIPAddress=aiClientIPAddress, wlsxNAccessPointIsUp=wlsxNAccessPointIsUp, aiWlanTxDataFrames=aiWlanTxDataFrames, wlsxFrameBandWidthRateExceeded=wlsxFrameBandWidthRateExceeded, aiRadioTable=aiRadioTable, aiWlanTxTotalFrames=aiWlanTxTotalFrames, wlsxTrapTimeStr=wlsxTrapTimeStr, aiConductorIPAddress=aiConductorIPAddress, aiRadioRxBad=aiRadioRxBad, aiClientWlanMACAddress=aiClientWlanMACAddress, aiRadioMACAddress=aiRadioMACAddress, aiWlanEntry=aiWlanEntry, wlsxNSignatureMatchWellenreiter=wlsxNSignatureMatchWellenreiter, wlsxSignAPNetstumbler=wlsxSignAPNetstumbler, aiMeshEntry=aiMeshEntry, wlsxTrapAPIpAddress=wlsxTrapAPIpAddress, wlsxInvalidMacOUIAP=wlsxInvalidMacOUIAP, wlsxTrapStationBlackListReasonStr=wlsxTrapStationBlackListReasonStr, wlsxApFloodAttack=wlsxApFloodAttack, wlsxTrapDBIpAddress=wlsxTrapDBIpAddress, wlsxLoadbalancingDisabled=wlsxLoadbalancingDisabled, ArubaAPUplinkType=ArubaAPUplinkType, ArubaAPMatchMethod=ArubaAPMatchMethod, wlsxEAPRateAnomaly=wlsxEAPRateAnomaly, ArubaVoiceCacBit=ArubaVoiceCacBit, aiSSIDClientNum=aiSSIDClientNum, aiAPUptime=aiAPUptime, wlsxTrapCaName=wlsxTrapCaName, aiTrapObjectsGroup=aiTrapObjectsGroup, ArubaSwitchRole=ArubaSwitchRole, wlsxSignatureMatchAP=wlsxSignatureMatchAP, aiRadioRxDataFrames=aiRadioRxDataFrames, wlsxTrapTunnelDownReason=wlsxTrapTunnelDownReason, wlsxAPLoopDetected=wlsxAPLoopDetected, wlsxBlockAckAttackDetected=wlsxBlockAckAttackDetected, ArubaUserForwardMode=ArubaUserForwardMode, wlsxTrapAPName=wlsxTrapAPName, aiAPRole=aiAPRole, aiWlanIndex=aiWlanIndex, wlsxTrapConfigurationId=wlsxTrapConfigurationId, wlsxTrapSnr=wlsxTrapSnr, wlsxTrapVcIpAddress=wlsxTrapVcIpAddress, wlsxWPAMisconfiguration=wlsxWPAMisconfiguration, aiMeshChannel=aiMeshChannel, aiInfoGroup=aiInfoGroup, wlsxTrapVoltageValue=wlsxTrapVoltageValue, wlsxTrapMatchedIpv6=wlsxTrapMatchedIpv6, wlsxTrapAPMacAddress=wlsxTrapAPMacAddress, wlsxAdhocUsingValidSSID=wlsxAdhocUsingValidSSID, aiAccessPointTable=aiAccessPointTable, wlsxTrapTime=wlsxTrapTime, wlsxAPWiredContainment=wlsxAPWiredContainment, aiClientRxDataFrames=aiClientRxDataFrames, wlsxTrapAddressType=wlsxTrapAddressType, wlsxMalformedHTIEDetected=wlsxMalformedHTIEDetected, wlsxInterferingApDetected=wlsxInterferingApDetected, wlsxTrapSpoofedIpAddress=wlsxTrapSpoofedIpAddress, wlsxNUserEntryDeleted=wlsxNUserEntryDeleted, wlsxTrapUSBVendorProductID=wlsxTrapUSBVendorProductID, wlsxTrapNodeMac=wlsxTrapNodeMac, aiVirtualControllerKey=aiVirtualControllerKey, wlsxClientWiredContainment=wlsxClientWiredContainment, ArubaStationType=ArubaStationType, aiClientOperatingSystem=aiClientOperatingSystem, wlsxTrapESIServerIpAddress=wlsxTrapESIServerIpAddress, aiAPHwopmode=aiAPHwopmode, wlsxLoadbalancingEnabled=wlsxLoadbalancingEnabled, wlsxTrapReceiverMac=wlsxTrapReceiverMac, ArubaEncryptionType=ArubaEncryptionType, ArubaPoeState=ArubaPoeState, wlsxTrapAPManagedModeConfigFailure=wlsxTrapAPManagedModeConfigFailure, aiAPName=aiAPName, aiAPModelName=aiAPModelName, wlsxNAccessPointIsDown=wlsxNAccessPointIsDown, ArubaPortDuplex=ArubaPortDuplex, wlsxTrapTableEntryChangeType=wlsxTrapTableEntryChangeType, wlsxTrapDeviceIpAddress=wlsxTrapDeviceIpAddress, wlsxSignStaAirjack=wlsxSignStaAirjack, wlsxTrapAPUSBStatus=wlsxTrapAPUSBStatus, wlsxSignStaNullProbeResp=wlsxSignStaNullProbeResp, wlsxNAuthServerIsUp=wlsxNAuthServerIsUp, ArubaVoipRegState=ArubaVoipRegState, wlsxTrapAPPreviousUplinkType=wlsxTrapAPPreviousUplinkType, wlsxAPModeChange=wlsxAPModeChange, ArubaMonAuthAlgorithm=ArubaMonAuthAlgorithm, wlsxTrapPortalServerDownReason=wlsxTrapPortalServerDownReason, wlsxClientRejectedByMaxClientCount=wlsxClientRejectedByMaxClientCount, wlsxTrapTemperatureValue=wlsxTrapTemperatureValue, ArubaPortalServerDownReason=ArubaPortalServerDownReason, aiInterferAccessPointTable=aiInterferAccessPointTable, ArubaAPConductorStatus=ArubaAPConductorStatus, aiInterferAPPhyType=aiInterferAPPhyType, wlsxUnsecureAPDetected=wlsxUnsecureAPDetected, aiAPIPAddress=aiAPIPAddress, aiClientTxDataBytes=aiClientTxDataBytes, wlsxRTSRateAnomaly=wlsxRTSRateAnomaly, wlsxStaWeakWEPIVViolation=wlsxStaWeakWEPIVViolation, wlsxTrapDeviceMac=wlsxTrapDeviceMac, aiRadioRxMgmtFrames=aiRadioRxMgmtFrames, wlsxTrapAPCurMode=wlsxTrapAPCurMode, wlsxTrapStationDenyListReasonStr=wlsxTrapStationDenyListReasonStr, ArubaConfigurationState=ArubaConfigurationState, wlsxFrameLowSpeedRateExceeded=wlsxFrameLowSpeedRateExceeded, wlsxChannelMisconfiguration=wlsxChannelMisconfiguration, aiWlanSSIDEntry=aiWlanSSIDEntry, wlsxTrapApControllerIp=wlsxTrapApControllerIp, wlsxStaInterferenceCleared=wlsxStaInterferenceCleared, wlsxClientAssociatingOnWrongChannel=wlsxClientAssociatingOnWrongChannel, wlsxNAuthServerAcctTimedOut=wlsxNAuthServerAcctTimedOut, wlsxMalformedFrameWrongChannelDetected=wlsxMalformedFrameWrongChannelDetected, wlsxTrapFanNumber=wlsxTrapFanNumber, wlsxTrapMatchedMac=wlsxTrapMatchedMac, wlsxTrapCount=wlsxTrapCount, wlsxShortPreableMisconfiguration=wlsxShortPreableMisconfiguration, aiVirtualControllerOrganization=aiVirtualControllerOrganization, wlsxNAuthServerIsDown=wlsxNAuthServerIsDown, wlsxNStationRemovedFromDenyList=wlsxNStationRemovedFromDenyList, aiRadioNoiseFloor=aiRadioNoiseFloor, wlsxTrapApMode=wlsxTrapApMode, ArubaEncryptionMethods=ArubaEncryptionMethods, aiMasterIPAddress=aiMasterIPAddress, ArubaACLAction=ArubaACLAction, wlsxChannelFrameRetryRateExceeded=wlsxChannelFrameRetryRateExceeded, wlsxAPUSBPLUGALARM=wlsxAPUSBPLUGALARM, wlsxSignStaAsleap=wlsxSignStaAsleap, wlsxTrapSpoofedOldPhyAddress=wlsxTrapSpoofedOldPhyAddress, aiRadioStatus=aiRadioStatus, aiMeshRelation=aiMeshRelation, wlsxTrapPortalServerAddress=wlsxTrapPortalServerAddress, wlsxTrapAPPrevPhyType=wlsxTrapAPPrevPhyType, aiClientHtMode=aiClientHtMode, wlsxTrapOperStatus=wlsxTrapOperStatus, wlsxValidClientNotUsingEncryption=wlsxValidClientNotUsingEncryption, wlsxReceiverMac=wlsxReceiverMac, wlsxNUserEntryAuthenticated=wlsxNUserEntryAuthenticated, wlsxNAdhocNetworkBridgeDetectedSta=wlsxNAdhocNetworkBridgeDetectedSta, wlsxVoiceCurrentNumCdr=wlsxVoiceCurrentNumCdr, aiClientRxRetries=aiClientRxRetries, wlsxInvalidMacOUISta=wlsxInvalidMacOUISta, wlsxDisconnectStationAttackAP=wlsxDisconnectStationAttackAP, wlsxTrapCTSURL=wlsxTrapCTSURL, wlsxSuspectUnsecureAPResolved=wlsxSuspectUnsecureAPResolved, ArubaPortType=ArubaPortType, aiClientAPName=aiClientAPName, wlsxHT40MHzIntoleranceSta=wlsxHT40MHzIntoleranceSta, wlsxTrapAPPrevHTMode=wlsxTrapAPPrevHTMode, aiMeshAvgRssi=aiMeshAvgRssi, wlsxTrapAssociationType=wlsxTrapAssociationType, wlsxNInterferingAPDetected=wlsxNInterferingAPDetected, wlsxTrapVcMacAddress=wlsxTrapVcMacAddress, wlsxIAPVoiceClientLocationUpdate=wlsxIAPVoiceClientLocationUpdate, wlsxTrapSignatureName=wlsxTrapSignatureName, wlsxNAuthServerReqTimedOut=wlsxNAuthServerReqTimedOut, wlsxChannelFrameErrorRateExceeded=wlsxChannelFrameErrorRateExceeded, wlsxAdhocNetworkRemoved=wlsxAdhocNetworkRemoved, wlsxOverflowIEDetected=wlsxOverflowIEDetected, ArubaCardType=ArubaCardType, aiClientEntry=aiClientEntry, wlsxTrapAPBand=wlsxTrapAPBand, wlsxTrapTunnelId=wlsxTrapTunnelId, aiInterferAPBSSID=aiInterferAPBSSID, aiMeshTable=aiMeshTable, aiClientSNR=aiClientSNR, wlsxNStationAddedToBlackList=wlsxNStationAddedToBlackList, wlsxTrapConductorIp=wlsxTrapConductorIp, wlsxNStaUnAssociatedFromUnsecureAP=wlsxNStaUnAssociatedFromUnsecureAP, wlsxMalformedAssocReqDetected=wlsxMalformedAssocReqDetected, ArubaUSBStatus=ArubaUSBStatus, wlsxTrapUserAuthenticationMethod=wlsxTrapUserAuthenticationMethod)
