...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/aruba/AI-AP-MIB
...
RowStatus, DateAndTime, TextualConvention, TimeInterval, MacAddress, StorageType, TestAndIncr, PhysAddress, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TextualConvention", "TimeInterval", "MacAddress", "StorageType", "TestAndIncr", "PhysAddress", "TruthValue", "DisplayString")
aiMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1))
aiMIB.setRevisions(('2020-08-14 17:45',))
if mibBuilder.loadTexts: aiMIB.setLastUpdated('202008141745Z')
...
if mibBuilder.loadTexts: aiMasterIPAddress.setStatus('obsolete')
...
aiMeshTable = MibTable((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 1, 15), )
if mibBuilder.loadTexts: aiMeshTable.setStatus('current')
aiMeshEntry = MibTableRow((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 1, 15, 1), ).setIndexNames((0, "AI-AP-MIB", "aiMeshIndex"))
...
aiInterferAccessPointTable = MibTable((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 1, 8), )
if mibBuilder.loadTexts: aiInterferAccessPointTable.setStatus('current')
aiInterferAccessPointEntry = MibTableRow((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 1, 8, 1), ).setIndexNames((0, "AI-AP-MIB", "aiInterferAPIndex"))
...
wlsxTrapAPBand = MibScalar((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 166), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 16))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: wlsxTrapAPBand.setStatus('current')
wlsxTrapTargetAPBand = MibScalar((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 167), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 16))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: wlsxTrapTargetAPBand.setStatus('current')
wlsxTrapMatchedIpv6 = MibScalar((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 1, 168), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 128))).setMaxAccess("accessiblefornotify")
...
wlsxUnsecureAPDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1053)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapMatchedMac"), ("AI-AP-MIB", "wlsxTrapMatchedIp"), ("AI-AP-MIB", "wlsxTrapRogueInfoURL"), ("AI-AP-MIB", "wlsxTrapMatchedIpv6"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxUnsecureAPDetected.setStatus('current')
wlsxUnsecureAPResolved = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1054)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxReservedChannelViolation = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1056)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxReservedChannelViolation.setStatus('current')
wlsxValidSSIDViolation = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1057)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxValidSSIDViolation.setStatus('current')
wlsxChannelMisconfiguration = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1058)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxChannelMisconfiguration.setStatus('current')
wlsxOUIMisconfiguration = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1059)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxOUIMisconfiguration.setStatus('current')
wlsxSSIDMisconfiguration = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1060)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxWPAMisconfiguration = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1062)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxStaPolicyViolation = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1065)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxStaPolicyViolation.setStatus('current')
wlsxRepeatWEPIVViolation = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1066)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxRepeatWEPIVViolation.setStatus('current')
wlsxWeakWEPIVViolation = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1067)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxAPInterferenceDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1070)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxAPInterferenceDetected.setStatus('current')
wlsxAPInterferenceCleared = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1071)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxAPInterferenceCleared.setStatus('current')
wlsxStaInterferenceDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1072)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxStaInterferenceDetected.setStatus('current')
wlsxStaInterferenceCleared = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1073)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxStaInterferenceCleared.setStatus('current')
wlsxFrameRetryRateExceeded = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1074)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxFrameRetryRateExceeded.setStatus('current')
wlsxFrameReceiveErrorRateExceeded = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1075)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapTargetAPChannel"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxFrameReceiveErrorRateExceeded.setStatus('current')
wlsxFrameFragmentationRateExceeded = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1076)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapTargetAPChannel"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxFrameFragmentationRateExceeded.setStatus('current')
wlsxFrameBandWidthRateExceeded = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1077)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxFrameBandWidthRateExceeded.setStatus('current')
wlsxFrameLowSpeedRateExceeded = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1078)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxFrameLowSpeedRateExceeded.setStatus('current')
wlsxFrameNonUnicastRateExceeded = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1079)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxChannelFrameRetryRateExceeded = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1082)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxChannelFrameRetryRateExceeded.setStatus('current')
wlsxChannelFrameFragmentationRateExceeded = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1083)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxChannelFrameFragmentationRateExceeded.setStatus('current')
wlsxChannelFrameErrorRateExceeded = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1084)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxChannelRateAnomaly = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1087)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapFrameType"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxEAPRateAnomaly = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1090)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxWEPMisconfiguration = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1100)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxWEPMisconfiguration.setStatus('current')
wlsxStaRepeatWEPIVViolation = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1101)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxStaRepeatWEPIVViolation.setStatus('current')
wlsxStaWeakWEPIVViolation = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1102)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxStaWeakWEPIVViolation.setStatus('current')
wlsxStaAssociatedToUnsecureAP = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1103)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapRogueInfoURL"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxInterferingApDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1106)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapInterferingAPInfoURL"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxAPImpersonation = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1113)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxWindowsBridgeDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1129)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxWindowsBridgeDetectedAP = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1144)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxWindowsBridgeDetectedAP.setStatus('current')
wlsxWindowsBridgeDetectedSta = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1145)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxHtGreenfieldSupported = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1157)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxHtGreenfieldSupported.setStatus('current')
wlsxHT40MHzIntoleranceAP = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1158)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxHT40MHzIntoleranceAP.setStatus('current')
wlsxHT40MHzIntoleranceSta = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1159)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapFrameType"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxNAdhocNetwork = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1161)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNAdhocNetwork.setStatus('current')
wlsxNAdhocNetworkBridgeDetectedAP = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1162)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNAdhocNetworkBridgeDetectedAP.setStatus('current')
wlsxNAdhocNetworkBridgeDetectedSta = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1163)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxAPSpoofingDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1173)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSpoofedFrameType"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxAPSpoofingDetected.setStatus('current')
wlsxClientAssociatingOnWrongChannel = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1174)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSpoofedFrameType"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxClientAssociatingOnWrongChannel.setStatus('current')
wlsxNDisconnectStationAttack = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1175)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNDisconnectStationAttack.setStatus('current')
wlsxNStaUnAssociatedFromUnsecureAP = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1176)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNStaUnAssociatedFromUnsecureAP.setStatus('current')
wlsxOmertaAttack = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1177)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxOmertaAttack.setStatus('current')
wlsxTKIPReplayAttack = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1178)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxTKIPReplayAttack.setStatus('current')
wlsxChopChopAttack = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1179)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxChopChopAttack.setStatus('current')
wlsxFataJackAttack = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1180)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxFataJackAttack.setStatus('current')
wlsxInvalidAddressCombination = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1181)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxInvalidAddressCombination.setStatus('current')
wlsxValidClientMisassociation = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1182)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAssociationType"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxValidClientMisassociation.setStatus('current')
wlsxMalformedHTIEDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1183)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxMalformedHTIEDetected.setStatus('current')
wlsxMalformedAssocReqDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1184)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxMalformedAssocReqDetected.setStatus('current')
wlsxOverflowIEDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1185)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxOverflowIEDetected.setStatus('current')
wlsxOverflowEAPOLKeyDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1186)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxOverflowEAPOLKeyDetected.setStatus('current')
wlsxMalformedFrameLargeDurationDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1187)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxMalformedFrameLargeDurationDetected.setStatus('current')
wlsxMalformedFrameWrongChannelDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1188)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPChannel"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"), ("AI-AP-MIB", "wlsxTrapTargetAPBand"))
if mibBuilder.loadTexts: wlsxMalformedFrameWrongChannelDetected.setStatus('current')
wlsxMalformedAuthFrame = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1189)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxMalformedAuthFrame.setStatus('current')
wlsxCTSRateAnomaly = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1190)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxCTSRateAnomaly.setStatus('current')
wlsxRTSRateAnomaly = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1191)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxRTSRateAnomaly.setStatus('current')
wlsxNRogueAPDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1192)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNRogueAPDetected.setStatus('current')
wlsxNRogueAPResolved = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1193)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNRogueAPResolved.setStatus('current')
wlsxNeighborAPDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1194)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNeighborAPDetected.setStatus('current')
wlsxNInterferingAPDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1195)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNInterferingAPDetected.setStatus('current')
wlsxNSuspectRogueAPDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1196)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapConfidenceLevel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSuspectRogueAPDetected.setStatus('current')
wlsxNSuspectRogueAPResolved = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1197)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSuspectRogueAPResolved.setStatus('current')
wlsxBlockAckAttackDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1198)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxBlockAckAttackDetected.setStatus('current')
wlsxHotspotterAttackDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1199)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxHotspotterAttackDetected.setStatus('current')
wlsxNSignatureMatch = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1200)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTransmitterMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSignatureName"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSignatureMatch.setStatus('current')
wlsxNSignatureMatchNetstumbler = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1201)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTransmitterMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSignatureName"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSignatureMatchNetstumbler.setStatus('current')
wlsxNSignatureMatchAsleap = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1202)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTransmitterMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSignatureName"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSignatureMatchAsleap.setStatus('current')
wlsxNSignatureMatchAirjack = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1203)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTransmitterMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSignatureName"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSignatureMatchAirjack.setStatus('current')
wlsxNSignatureMatchNullProbeResp = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1204)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTransmitterMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSignatureName"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSignatureMatchNullProbeResp.setStatus('current')
wlsxNSignatureMatchDeauthBcast = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1205)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTransmitterMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSignatureName"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSignatureMatchDeauthBcast.setStatus('current')
wlsxNSignatureMatchDisassocBcast = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1206)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTransmitterMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSignatureName"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSignatureMatchDisassocBcast.setStatus('current')
wlsxNSignatureMatchWellenreiter = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1207)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTransmitterMac"), ("AI-AP-MIB", "wlsxTrapReceiverMac"), ("AI-AP-MIB", "wlsxTrapSignatureName"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxNSignatureMatchWellenreiter.setStatus('current')
wlsxAPDeauthContainment = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1208)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxAPDeauthContainment.setStatus('current')
wlsxClientDeauthContainment = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1209)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxTarpitContainment = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1214)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapTargetAPChannel"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPBand"), ("AI-AP-MIB", "wlsxTrapTargetAPBand"))
...
wlsxPowerSaveDosAttack = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1220)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxNAdhocUsingValidSSID = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1222)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapTargetAPSSID"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
wlsxWPAFTAttack = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1267)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapNodeMac"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPBand"))
if mibBuilder.loadTexts: wlsxWPAFTAttack.setStatus('current')
wlsxMitMDetected = NotificationType((1, 3, 6, 1, 4, 1, 14823, 2, 3, 3, 1, 200, 2, 1268)).setObjects(("AI-AP-MIB", "wlsxTrapTime"), ("AI-AP-MIB", "wlsxTrapAPLocation"), ("AI-AP-MIB", "wlsxTrapAPMacAddress"), ("AI-AP-MIB", "wlsxTrapAPRadioNumber"), ("AI-AP-MIB", "wlsxTrapSourceMac"), ("AI-AP-MIB", "wlsxTrapTargetAPBSSID"), ("AI-AP-MIB", "wlsxTrapAPChannel"), ("AI-AP-MIB", "wlsxTrapSnr"), ("AI-AP-MIB", "wlsxTrapAPBand"))
...
mibBuilder.exportSymbols("AI-AP-MIB", wlsxWarmStart=wlsxWarmStart, wlsxHT40MHzIntoleranceAP=wlsxHT40MHzIntoleranceAP, wlsxTrapTableGenNumber=wlsxTrapTableGenNumber, wlsxHotspotterAttackDetected=wlsxHotspotterAttackDetected, aiWlanRxDataFrames=aiWlanRxDataFrames, ArubaCallStates=ArubaCallStates, wlsxTrapHostPort=wlsxTrapHostPort, aiRadioTxDataBytes=aiRadioTxDataBytes, wlsxTrapMatchedIpv6=wlsxTrapMatchedIpv6, wlsxTrapAuthServerName=wlsxTrapAuthServerName, wlsxSignalAnomaly=wlsxSignalAnomaly, aiRadioTxDataFrames=aiRadioTxDataFrames, aiClientMACAddress=aiClientMACAddress, wlsxTrapOperStatus=wlsxTrapOperStatus, wlsxTrapPortalServerName=wlsxTrapPortalServerName, wlsxTrapConductorName=wlsxTrapConductorName, wlsxTrapAPPreviousUplinkType=wlsxTrapAPPreviousUplinkType, wlsxTrapProcessName=wlsxTrapProcessName, aiMeshAvgRssi=aiMeshAvgRssi, aiVirtualControllerVersion=aiVirtualControllerVersion, wlsxAPManagedModeConfigFailureTrap=wlsxAPManagedModeConfigFailureTrap, ArubaAPStatus=ArubaAPStatus, wlsxTrapDBType=wlsxTrapDBType, wlsxSequenceNumberAnomalySta=wlsxSequenceNumberAnomalySta, wlsxFataJackAttack=wlsxFataJackAttack, aiVoiceClientEntry=aiVoiceClientEntry, aiRadioTable=aiRadioTable, aiRadioNoiseFloor=aiRadioNoiseFloor, wlsxTrapHostIp=wlsxTrapHostIp, wlsxTrapAPChannel=wlsxTrapAPChannel, wlsxSignatureMatchSta=wlsxSignatureMatchSta, wlsxNSignatureMatchNullProbeResp=wlsxNSignatureMatchNullProbeResp, wlsxCLEARPASSSERVERINVALID=wlsxCLEARPASSSERVERINVALID, aiMeshEntry=aiMeshEntry, wlsxTrapESIServerGrpName=wlsxTrapESIServerGrpName, wlsxTrapTunnelId=wlsxTrapTunnelId, wlsxTrapSpoofedNewPhyAddress=wlsxTrapSpoofedNewPhyAddress, wlsxChannelFrameFragmentationRateExceeded=wlsxChannelFrameFragmentationRateExceeded, wlsxAPSpoofingDetected=wlsxAPSpoofingDetected, wlsxNAdhocNetworkBridgeDetectedAP=wlsxNAdhocNetworkBridgeDetectedAP, ArubaAPUplinkChangeReason=ArubaAPUplinkChangeReason, aiClientAPName=aiClientAPName, wlsxStaInterferenceDetected=wlsxStaInterferenceDetected, ArubaOperStateValue=ArubaOperStateValue, ArubaMonEncryptionCipher=ArubaMonEncryptionCipher, aiClientHtMode=aiClientHtMode, ArubaVoiceCdrDirection=ArubaVoiceCdrDirection, ArubaVlanValidRange=ArubaVlanValidRange, wlsxTrapSourceMac=wlsxTrapSourceMac, aiClientRxRate=aiClientRxRate, ArubaPortalServerDownReason=ArubaPortalServerDownReason, aiAPModelName=aiAPModelName, wlsxTrapDBIpAddress=wlsxTrapDBIpAddress, aiMeshPortalMac=aiMeshPortalMac, ArubaHTMode=ArubaHTMode, wlsxTrapEssid=wlsxTrapEssid, wlsxNodeRateAnomalySta=wlsxNodeRateAnomalySta, wlsxTrapPortalServerDownReason=wlsxTrapPortalServerDownReason, aiSSIDIndex=aiSSIDIndex, wlsxTrapAPPrevMode=wlsxTrapAPPrevMode, ArubaMeshRole=ArubaMeshRole, aiWlanSSIDEntry=aiWlanSSIDEntry, wlsxTrapAPSecChannel=wlsxTrapAPSecChannel, ArubaVoipProtocol=ArubaVoipProtocol, wlsxVoiceCurrentNumCdr=wlsxVoiceCurrentNumCdr, ArubaCardType=ArubaCardType, aiAPIPAddress=aiAPIPAddress, ArubaSwitchRole=ArubaSwitchRole, wlsxValidClientMisassociation=wlsxValidClientMisassociation, aiMIB=aiMIB, ArubaVoipRegState=ArubaVoipRegState, aiAPCPUUtilization=aiAPCPUUtilization, aiRadioAPMACAddress=aiRadioAPMACAddress, aiRadioUtilization64=aiRadioUtilization64, ArubaFrameType=ArubaFrameType, wlsxAPBROADCASTSTORM=wlsxAPBROADCASTSTORM, aiClientIP=aiClientIP, wlsxAPLoopDetected=wlsxAPLoopDetected, wlsxSignAPAirjack=wlsxSignAPAirjack, aiAPRole=aiAPRole, ArubaESIServerStatus=ArubaESIServerStatus, wlsxNUserEntryCreated=wlsxNUserEntryCreated, aiTrapDefinitionsGroup=aiTrapDefinitionsGroup, wlsxTrapTunnelDownReason=wlsxTrapTunnelDownReason, wlsxTrapAPPrevPhyType=wlsxTrapAPPrevPhyType, aiClientPhyType=aiClientPhyType, aiClientRxDataFrames=aiClientRxDataFrames, wlsxNUserEntryDeAuthenticated=wlsxNUserEntryDeAuthenticated, wlsxUserEntryAttributesChanged=wlsxUserEntryAttributesChanged, wlsxNAccessPointIsDown=wlsxNAccessPointIsDown, ArubaSubAuthenticationMethods=ArubaSubAuthenticationMethods, wlsxNeighborAPDetected=wlsxNeighborAPDetected, aiMeshPointMac=aiMeshPointMac, wlsxTrapTargetAPSSID=wlsxTrapTargetAPSSID, wlsxChannelFrameRetryRateExceeded=wlsxChannelFrameRetryRateExceeded, wlsxFrameLowSpeedRateExceeded=wlsxFrameLowSpeedRateExceeded, wlsxWindowsBridgeDetectedAP=wlsxWindowsBridgeDetectedAP, wlsxTrapConfigurationId=wlsxTrapConfigurationId, wlsxNAdhocNetwork=wlsxNAdhocNetwork, wlsxEAPRateAnomaly=wlsxEAPRateAnomaly, wlsxTrapDeviceIpAddress=wlsxTrapDeviceIpAddress, wlsxHT40MHzIntoleranceSta=wlsxHT40MHzIntoleranceSta, aiWlanTable=aiWlanTable, wlsxTrapVrrpMasterIp=wlsxTrapVrrpMasterIp, ArubaARMChangeReason=ArubaARMChangeReason, aiRadioTransmitPower=aiRadioTransmitPower, aiRadioClientNum=aiRadioClientNum, aiClientName=aiClientName, aiRadioIndex=aiRadioIndex, wlsxTrapAuthFailureReason=wlsxTrapAuthFailureReason, ArubaAuthServerType=ArubaAuthServerType, wlsxTrapSpoofedIpAddress=wlsxTrapSpoofedIpAddress, aiRadioUtilization4=aiRadioUtilization4, wlsxTrapLicenseId=wlsxTrapLicenseId, wlsxTrapUserRole=wlsxTrapUserRole, wlsxAPPowerChange=wlsxAPPowerChange, ArubaActiveState=ArubaActiveState, wlsxTrapSpoofedOldPhyAddress=wlsxTrapSpoofedOldPhyAddress, wlsxSignStaNullProbeResp=wlsxSignStaNullProbeResp, wlsxAdhocNetworkDetected=wlsxAdhocNetworkDetected, aiInfoGroup=aiInfoGroup, aiMeshHops=aiMeshHops, wlsxWirelessBridge=wlsxWirelessBridge, wlsxFrameRetryRateExceeded=wlsxFrameRetryRateExceeded, wlsxTrapBackupControllerIp=wlsxTrapBackupControllerIp, wlsxTrapAPCurMode=wlsxTrapAPCurMode, aiClientTxDataBytes=aiClientTxDataBytes, wlsxNAuthServerReqTimedOut=wlsxNAuthServerReqTimedOut, aiRadioChannel=aiRadioChannel, wlsxTrapMasterName=wlsxTrapMasterName, wlsxNUserEntryDeleted=wlsxNUserEntryDeleted, wlsxNRadioAttributesChanged=wlsxNRadioAttributesChanged, wlsxTrapTemperatureValue=wlsxTrapTemperatureValue, wlsxNUserAuthenticationFailed=wlsxNUserAuthenticationFailed, aiConductorIPAddress=aiConductorIPAddress, wlsxAPUSBPLUGALARM=wlsxAPUSBPLUGALARM, wlsxTrapLocalIp=wlsxTrapLocalIp, wlsxTrapAPUSBStatus=wlsxTrapAPUSBStatus, wlsxTrapInterferingAPInfoURL=wlsxTrapInterferingAPInfoURL, ArubaUSBStatus=ArubaUSBStatus, aiWlanEntry=aiWlanEntry, wlsxTrapMissingLicenses=wlsxTrapMissingLicenses, wlsxNAuthServerTimedOut=wlsxNAuthServerTimedOut, ArubaEncryptionType=ArubaEncryptionType, wlsxTrapAPPreviousUplinkActiveTime=wlsxTrapAPPreviousUplinkActiveTime, wlsxInterferingApDetected=wlsxInterferingApDetected, wlsxStaWeakWEPIVViolation=wlsxStaWeakWEPIVViolation, aiClientTxDataFrames=aiClientTxDataFrames, wlsxSignAPNetstumbler=wlsxSignAPNetstumbler, aiClientTable=aiClientTable, wlsxAPDeauthContainment=wlsxAPDeauthContainment, aiInterferAPType=aiInterferAPType, wlsxTrapTransmitterMac=wlsxTrapTransmitterMac, wlsxSignAPNullProbeResp=wlsxSignAPNullProbeResp, aiClientAPIPAddress=aiClientAPIPAddress, wlsxDisconnectStationAttackSta=wlsxDisconnectStationAttackSta, wlsxTrapAPPrevTxPower=wlsxTrapAPPrevTxPower, wlsxFrameNonUnicastRateExceeded=wlsxFrameNonUnicastRateExceeded, aiVirtualControllerIPAddress=aiVirtualControllerIPAddress, wlsxTrapAPActiveUplinkType=wlsxTrapAPActiveUplinkType, wlsxChannelFrameErrorRateExceeded=wlsxChannelFrameErrorRateExceeded, ArubaPortType=ArubaPortType, wlsxTrapTime=wlsxTrapTime, aiInterferAPEncr=aiInterferAPEncr, wlsxNodeRateAnomalyAP=wlsxNodeRateAnomalyAP, aiInterferAccessPointEntry=aiInterferAccessPointEntry, wlsxNSuspectRogueAPResolved=wlsxNSuspectRogueAPResolved, wlsxAPTaggedWiredContainment=wlsxAPTaggedWiredContainment, wlsxAPInterferenceCleared=wlsxAPInterferenceCleared, wlsxWPAFTAttack=wlsxWPAFTAttack, wlsxTrapSpoofedFrameType=wlsxTrapSpoofedFrameType, wlsxNStationAddedToBlackList=wlsxNStationAddedToBlackList, wlsxTrapAPTxPower=wlsxTrapAPTxPower, wlsxAdhocNetwork=wlsxAdhocNetwork, wlsxCTSRateAnomaly=wlsxCTSRateAnomaly, wlsxSignAPAsleap=wlsxSignAPAsleap, aiInterferAPPhyType=aiInterferAPPhyType, wlsxTrapESIServerName=wlsxTrapESIServerName, aiRadioMACAddress=aiRadioMACAddress, wlsxTrapAPPrevChannel=wlsxTrapAPPrevChannel, wlsxStaInterferenceCleared=wlsxStaInterferenceCleared, wlsxTrapApMasterStatus=wlsxTrapApMasterStatus, aiClientIPAddress=aiClientIPAddress, aiRadioRxDataBytes=aiRadioRxDataBytes, wlsxPortalServerUp=wlsxPortalServerUp, aiInterferAPChannel=aiInterferAPChannel, ArubaAPMasterStatus=ArubaAPMasterStatus, wlsxTrapCount=wlsxTrapCount, aiWlanAPMACAddress=aiWlanAPMACAddress, wlsxTrapPortalServerAddress=wlsxTrapPortalServerAddress, wlsxNStationRemovedFromDenyList=wlsxNStationRemovedFromDenyList, aiAccessPointTable=aiAccessPointTable, aiVoiceClientTable=aiVoiceClientTable, wlsxTrapVoltageValue=wlsxTrapVoltageValue, aiRadioRxTotalFrames=aiRadioRxTotalFrames, wlsxAdhocNetworkBridgeDetected=wlsxAdhocNetworkBridgeDetected, aiClientAPMac=aiClientAPMac, wlsxInvalidAddressCombination=wlsxInvalidAddressCombination, wlsxNAPConductorStatusChange=wlsxNAPConductorStatusChange, ArubaAddressType=ArubaAddressType, ArubaDenyListReason=ArubaDenyListReason, aiManagedInfoGroup=aiManagedInfoGroup, aiWlanRxDataBytes=aiWlanRxDataBytes, wlsxTrapSnr=wlsxTrapSnr, wlsxTrapCardSlot=wlsxTrapCardSlot, ArubaAuthenticationMethods=ArubaAuthenticationMethods, aiAPMemoryFree=aiAPMemoryFree, ArubaVoiceCacBit=ArubaVoiceCacBit, aiClientWlanMACAddress=aiClientWlanMACAddress, wlsxTrapTableEntryChangeType=wlsxTrapTableEntryChangeType, aiAPStatus=aiAPStatus, wlsxApFloodAttack=wlsxApFloodAttack, ArubaACLAction=ArubaACLAction, wlsxAdhocUsingValidSSID=wlsxAdhocUsingValidSSID, wlsxAPModeChange=wlsxAPModeChange, ArubaAccessPointMode=ArubaAccessPointMode, aiClientUptime=aiClientUptime, wlsxNDisconnectStationAttack=wlsxNDisconnectStationAttack, aiClientRxRetries=aiClientRxRetries, wlsxAPImpersonation=wlsxAPImpersonation, wlsxTrapRogueInfoURL=wlsxTrapRogueInfoURL, aiAPModel=aiAPModel, aiRadioRxDataFrames=aiRadioRxDataFrames, wlsxHtGreenfieldSupported=wlsxHtGreenfieldSupported, wlsxTrapESIServerIpAddress=wlsxTrapESIServerIpAddress, wlsxTrapApMode=wlsxTrapApMode, wlsxChannelMisconfiguration=wlsxChannelMisconfiguration, wlsxTrapConfidenceLevel=wlsxTrapConfidenceLevel, wlsxSignatureMatchAP=wlsxSignatureMatchAP, wlsxStaImpersonation=wlsxStaImpersonation, ArubaMonitorMode=ArubaMonitorMode, wlsxReservedChannelViolation=wlsxReservedChannelViolation, wlsxTrapUserIpAddress=wlsxTrapUserIpAddress, aiWlanMACAddress=aiWlanMACAddress, wlsxFrameFragmentationRateExceeded=wlsxFrameFragmentationRateExceeded, wlsxTrapAPIpAddress=wlsxTrapAPIpAddress, aiMasterIPAddress=aiMasterIPAddress, wlsxNStationAddedToDenyList=wlsxNStationAddedToDenyList, aiClientSNR=aiClientSNR, wlsxTrapTunnelStatus=wlsxTrapTunnelStatus, wlsxTrapAPName=wlsxTrapAPName, aiRadioTxTotalFrames=aiRadioTxTotalFrames, wlsxTrapAPUplinkChangeReason=wlsxTrapAPUplinkChangeReason, wlsxNRogueAPDetected=wlsxNRogueAPDetected, ArubaEnet1Mode=ArubaEnet1Mode, wlsxTrapApConductorStatus=wlsxTrapApConductorStatus, ArubaPortDuplex=ArubaPortDuplex, ArubaAPUplinkType=ArubaAPUplinkType, wlsxTrapUpdateFailureReason=wlsxTrapUpdateFailureReason, ArubaHashAlgorithms=ArubaHashAlgorithms, aiRadioStatus=aiRadioStatus, aiAccessPointEntry=aiAccessPointEntry, wlsxChannelInterferenceCleared=wlsxChannelInterferenceCleared, wlsxTrapVrrpID=wlsxTrapVrrpID)
mibBuilder.exportSymbols("AI-AP-MIB", wlsxAdhocNetworkBridgeDetectedAP=wlsxAdhocNetworkBridgeDetectedAP, wlsxUnsecureAPResolved=wlsxUnsecureAPResolved, wlsxTrapAPMacAddress=wlsxTrapAPMacAddress, wlsxSuspectUnsecureAPResolved=wlsxSuspectUnsecureAPResolved, aiTrapObjectsGroup=aiTrapObjectsGroup, wlsxWindowsBridgeDetected=wlsxWindowsBridgeDetected, ArubaVrrpState=ArubaVrrpState, wlsxTrapGlobalConfigObj=wlsxTrapGlobalConfigObj, wlsxNChannelChanged=wlsxNChannelChanged, wlsxAPWiredContainment=wlsxAPWiredContainment, wlsxOUIMisconfiguration=wlsxOUIMisconfiguration, wlsxTrapAPChannelSec=wlsxTrapAPChannelSec, wlsxNAccessPointIsUp=wlsxNAccessPointIsUp, wlsxNAuthServerIsDown=wlsxNAuthServerIsDown, wlsxSignAPDeauthBcast=wlsxSignAPDeauthBcast, aiAPTotalMemory=aiAPTotalMemory, wlsxTrapTargetAPChannel=wlsxTrapTargetAPChannel, ArubaPhyType=ArubaPhyType, wlsxClientFloodAttack=wlsxClientFloodAttack, aiClientEntry=aiClientEntry, aiClientMac=aiClientMac, wlsxTrapAPBSSID=wlsxTrapAPBSSID, wlsxTrapCTSURL=wlsxTrapCTSURL, wlsxTrapLicenseDaysRemaining=wlsxTrapLicenseDaysRemaining, wlsxTrapAPARMChangeReason=wlsxTrapAPARMChangeReason, ArubaPortSpeed=ArubaPortSpeed, wlsxTarpitContainment=wlsxTarpitContainment, ArubaAPMatchType=ArubaAPMatchType, wlsxClientWiredContainment=wlsxClientWiredContainment, wlsxClientAssociatingOnWrongChannel=wlsxClientAssociatingOnWrongChannel, wlsxTrapStationDenyListReason=wlsxTrapStationDenyListReason, wlsxTrapStationDenyListReasonStr=wlsxTrapStationDenyListReasonStr, wlsxTrapAddressType=wlsxTrapAddressType, ArubaAntennaSetting=ArubaAntennaSetting, wlsxNSignatureMatchDeauthBcast=wlsxNSignatureMatchDeauthBcast, wlsxTrapAPRadioNumber=wlsxTrapAPRadioNumber, wlsxTrapSwitchIp=wlsxTrapSwitchIp, wlsxTrapUserName=wlsxTrapUserName, wlsxStaRepeatWEPIVViolation=wlsxStaRepeatWEPIVViolation, aiRadioRxBad=aiRadioRxBad, aiTrapsGroup=aiTrapsGroup, aiSSIDHide=aiSSIDHide, aiRadioPhyEvents=aiRadioPhyEvents, wlsxTrapDBUserName=wlsxTrapDBUserName, aiInterferAPESSID=aiInterferAPESSID, wlsxTrapVcIpAddress=wlsxTrapVcIpAddress, aiAPHwopmode=aiAPHwopmode, wlsxSignStaAirjack=wlsxSignStaAirjack, wlsxValidSSIDViolation=wlsxValidSSIDViolation, wlsxTrapApSerialNumber=wlsxTrapApSerialNumber, ArubaUnprovisionedStatus=ArubaUnprovisionedStatus, wlsxNStationRemovedFromBlackList=wlsxNStationRemovedFromBlackList, wlsxTrapTunnelUpReason=wlsxTrapTunnelUpReason, wlsxNSignatureMatchAsleap=wlsxNSignatureMatchAsleap, wlsxNInterferingAPDetected=wlsxNInterferingAPDetected, wlsxTrapConfigurationState=wlsxTrapConfigurationState, wlsxTrapAPPrevChannelSec=wlsxTrapAPPrevChannelSec, wlsxOverflowIEDetected=wlsxOverflowIEDetected, wlsxTrapCrlName=wlsxTrapCrlName, aiWlanSSIDTable=aiWlanSSIDTable, wlsxTrapAssociationType=wlsxTrapAssociationType, wlsxMalformedFrameLargeDurationDetected=wlsxMalformedFrameLargeDurationDetected, wlsxChannelRateAnomaly=wlsxChannelRateAnomaly, wlsxClientDeauthContainment=wlsxClientDeauthContainment, wlsxMalformedAuthFrame=wlsxMalformedAuthFrame, wlsxTrapCaName=wlsxTrapCaName, aiSSIDStatus=aiSSIDStatus, wlsxUnsecureAPDetected=wlsxUnsecureAPDetected, wlsxTrapUserAuthenticationMethod=wlsxTrapUserAuthenticationMethod, wlsxNAPMasterStatusChange=wlsxNAPMasterStatusChange, wlsxWeakWEPIVViolation=wlsxWeakWEPIVViolation, wlsxFrameReceiveErrorRateExceeded=wlsxFrameReceiveErrorRateExceeded, wlsxNAuthServerAcctTimedOut=wlsxNAuthServerAcctTimedOut, aiMeshAge=aiMeshAge, wlsxReceiverMac=wlsxReceiverMac, ArubaRogueApType=ArubaRogueApType, wlsxTrapAPManagedModeConfigFailure=wlsxTrapAPManagedModeConfigFailure, wlsxAdhocNetworkRemoved=wlsxAdhocNetworkRemoved, ArubaPortMode=ArubaPortMode, aiMeshChannel=aiMeshChannel, wlsxTrapSignatureName=wlsxTrapSignatureName, wlsxTrapVoltageType=wlsxTrapVoltageType, wlsxNSignatureMatchNetstumbler=wlsxNSignatureMatchNetstumbler, wlsxNSignatureMatch=wlsxNSignatureMatch, wlsxBlockAckAttackDetected=wlsxBlockAckAttackDetected, ArubaACLDomain=ArubaACLDomain, wlsxTrapAuthServerAddress=wlsxTrapAuthServerAddress, wlsxPortalServerDown=wlsxPortalServerDown, wlsxTrapMatchedIp=wlsxTrapMatchedIp, aiMeshTable=aiMeshTable, wlsxTrapFrameType=wlsxTrapFrameType, aiWlanTxDataBytes=aiWlanTxDataBytes, wlsxDisconnectStationAttackAP=wlsxDisconnectStationAttackAP, wlsxTrapStationBlackListReason=wlsxTrapStationBlackListReason, aiRadioTxMgmtFrames=aiRadioTxMgmtFrames, wlsxNSuspectRogueAPDetected=wlsxNSuspectRogueAPDetected, wlsxTKIPReplayAttack=wlsxTKIPReplayAttack, ArubaUserForwardMode=ArubaUserForwardMode, aiRadioEntry=aiRadioEntry, wlsxNSignatureMatchWellenreiter=wlsxNSignatureMatchWellenreiter, wlsxTrapUserAttributeChangeType=wlsxTrapUserAttributeChangeType, aiMeshRelation=aiMeshRelation, wlsxOmertaAttack=wlsxOmertaAttack, wlsxRTSRateAnomaly=wlsxRTSRateAnomaly, ArubaVoipProtocolType=ArubaVoipProtocolType, aiRadioTxDrops=aiRadioTxDrops, wlsxTrapDBName=wlsxTrapDBName, aiClientOperatingSystem=aiClientOperatingSystem, aiSSIDClientNum=aiSSIDClientNum, aiRadioRxMgmtFrames=aiRadioRxMgmtFrames, wlsxAPChannelChange=wlsxAPChannelChange, aiAPName=aiAPName, ArubaDBType=ArubaDBType, wlsxNAuthServerAllInService=wlsxNAuthServerAllInService, wlsxMgmtUserAuthenticationFailed=wlsxMgmtUserAuthenticationFailed, aiWlanTxDataFrames=aiWlanTxDataFrames, wlsxMitMDetected=wlsxMitMDetected, ArubaIfType=ArubaIfType, wlsxTrapUserPhyAddress=wlsxTrapUserPhyAddress, wlsxTrapAPPrevHTMode=wlsxTrapAPPrevHTMode, wlsxTrapAPPhyType=wlsxTrapAPPhyType, ArubaEncryptionMethods=ArubaEncryptionMethods, wlsxTrapLocalName=wlsxTrapLocalName, wlsxNUserEntryAuthenticated=wlsxNUserEntryAuthenticated, ArubaPoeState=ArubaPoeState, wlsxValidClientNotUsingEncryption=wlsxValidClientNotUsingEncryption, aiInterferAccessPointTable=aiInterferAccessPointTable, wlsxNAdhocUsingValidSSID=wlsxNAdhocUsingValidSSID, wlsxTrapTargetAPBSSID=wlsxTrapTargetAPBSSID, aiWlanESSID=aiWlanESSID, ArubaESIServerMode=ArubaESIServerMode, aiInterferAPIndex=aiInterferAPIndex, ArubaDaysOfWeek=ArubaDaysOfWeek, aiInterferAPAvgSnr=aiInterferAPAvgSnr, wlsxTrapConductorIp=wlsxTrapConductorIp, ArubaStationType=ArubaStationType, aiMeshIndex=aiMeshIndex, wlsxStaUnAssociatedFromUnsecureAP=wlsxStaUnAssociatedFromUnsecureAP, wlsxTrapRogueIfoURL=wlsxTrapRogueIfoURL, wlsxLoadbalancingDisabled=wlsxLoadbalancingDisabled, wlsxTrapVcMacAddress=wlsxTrapVcMacAddress, aiVirtualControllerOrganization=aiVirtualControllerOrganization, wlsxTrapAPBand=wlsxTrapAPBand, ArubaEnableValue=ArubaEnableValue, wlsxSignStaAsleap=wlsxSignStaAsleap, aiClientRxDataBytes=aiClientRxDataBytes, aiSSID=aiSSID, wlsxMalformedHTIEDetected=wlsxMalformedHTIEDetected, ArubaAPMatchMethod=ArubaAPMatchMethod, wlsxTrapCTSTransferType=wlsxTrapCTSTransferType, aiVirtualControllerName=aiVirtualControllerName, aiMeshCost=aiMeshCost, wlsxTrapTargetAPBand=wlsxTrapTargetAPBand, wlsxTrapAuthServerTimeout=wlsxTrapAuthServerTimeout, ArubaHTExtChannel=ArubaHTExtChannel, wlsxMalformedAssocReqDetected=wlsxMalformedAssocReqDetected, wlsxClientTaggedWiredContainment=wlsxClientTaggedWiredContainment, wlsxTrapPortNumber=wlsxTrapPortNumber, wlsxLoadbalancingEnabled=wlsxLoadbalancingEnabled, wlsxWEPMisconfiguration=wlsxWEPMisconfiguration, wlsxNAdhocNetworkBridgeDetectedSta=wlsxNAdhocNetworkBridgeDetectedSta, aiWlanIndex=aiWlanIndex, wlsxSuspectUnsecureAPDetected=wlsxSuspectUnsecureAPDetected, wlsxAPActiveUplinkChanged=wlsxAPActiveUplinkChanged, aiWlanRxTotalFrames=aiWlanRxTotalFrames, wlsxTrapAPHTMode=wlsxTrapAPHTMode, wlsxTrapMatchedMac=wlsxTrapMatchedMac, wlsxAPInterferenceDetected=wlsxAPInterferenceDetected, wlsxNStaUnAssociatedFromUnsecureAP=wlsxNStaUnAssociatedFromUnsecureAP, aiStateGroup=aiStateGroup, wlsxSequenceNumberAnomalyAP=wlsxSequenceNumberAnomalyAP, ArubaConfigurationChangeType=ArubaConfigurationChangeType, wlsxOverflowEAPOLKeyDetected=wlsxOverflowEAPOLKeyDetected, aiClientTxRate=aiClientTxRate, wlsxSSIDMisconfiguration=wlsxSSIDMisconfiguration, wlsxFrameBandWidthRateExceeded=wlsxFrameBandWidthRateExceeded, wlsxTrapSwitchRole=wlsxTrapSwitchRole, ArubaACLNetworkServiceType=ArubaACLNetworkServiceType, wlsxTrapReceiverMac=wlsxTrapReceiverMac, aiAPUptime=aiAPUptime, wlsxColdStart=wlsxColdStart, wlsxStaAssociatedToUnsecureAP=wlsxStaAssociatedToUnsecureAP, aiClientTxRetries=aiClientTxRetries, wlsxTrapFanNumber=wlsxTrapFanNumber, wlsxNAuthServerIsUp=wlsxNAuthServerIsUp, wlsxStaPolicyViolation=wlsxStaPolicyViolation, wlsxTrapUpdateFailedObj=wlsxTrapUpdateFailedObj, wlsxNRogueAPResolved=wlsxNRogueAPResolved, wlsxTrapVlanId=wlsxTrapVlanId, wlsxTrapNodeMac=wlsxTrapNodeMac, wlsxSignStaNetstumbler=wlsxSignStaNetstumbler, aiAPSerialNum=aiAPSerialNum, wlsxClientRejectedByMaxClientCount=wlsxClientRejectedByMaxClientCount, wlsxChannelInterferenceDetected=wlsxChannelInterferenceDetected, wlsxTrapUSBVendorProductID=wlsxTrapUSBVendorProductID, wlsxInvalidMacOUIAP=wlsxInvalidMacOUIAP, ArubaHTRate=ArubaHTRate, wlsxTrapPrimaryControllerIp=wlsxTrapPrimaryControllerIp, wlsxShortPreableMisconfiguration=wlsxShortPreableMisconfiguration, ArubaAPConductorStatus=ArubaAPConductorStatus, wlsxMalformedFrameWrongChannelDetected=wlsxMalformedFrameWrongChannelDetected, wlsxIAPVoiceClientLocationUpdate=wlsxIAPVoiceClientLocationUpdate, wlsxTrapAPLocation=wlsxTrapAPLocation, aiManagedModeSinceLastSync=aiManagedModeSinceLastSync, wlsxTrapTimeStr=wlsxTrapTimeStr, aiAPMACAddress=aiAPMACAddress, ArubaMonEncryptionType=ArubaMonEncryptionType, aiVirtualControllerKey=aiVirtualControllerKey, wlsxNodeRateAnomaly=wlsxNodeRateAnomaly, wlsxTrapAdminStatus=wlsxTrapAdminStatus, wlsxChopChopAttack=wlsxChopChopAttack, wlsxNSignatureMatchDisassocBcast=wlsxNSignatureMatchDisassocBcast, ArubaBlackListReason=ArubaBlackListReason, ArubaMonAuthAlgorithm=ArubaMonAuthAlgorithm, wlsxWindowsBridgeDetectedSta=wlsxWindowsBridgeDetectedSta, PYSNMP_MODULE_ID=aiMIB, aiInterferAPBSSID=aiInterferAPBSSID, ArubaSupportStatus=ArubaSupportStatus, wlsxAdhocNetworkBridgeDetectedSta=wlsxAdhocNetworkBridgeDetectedSta, wlsxDisconnectStationAttack=wlsxDisconnectStationAttack, wlsxTrapApControllerIp=wlsxTrapApControllerIp, wlsxTrapVrrpOperState=wlsxTrapVrrpOperState, wlsxPowerSaveDosAttack=wlsxPowerSaveDosAttack, aiRadioMode=aiRadioMode, wlsxInvalidMacOUISta=wlsxInvalidMacOUISta, wlsxWPAMisconfiguration=wlsxWPAMisconfiguration, wlsxClientPskAuthenticationFailed=wlsxClientPskAuthenticationFailed, ArubaConfigurationState=ArubaConfigurationState, wlsxRepeatWEPIVViolation=wlsxRepeatWEPIVViolation, wlsxSignStaDeauthBcast=wlsxSignStaDeauthBcast, ArubaDot1dState=ArubaDot1dState, aiWlanTxTotalFrames=aiWlanTxTotalFrames, wlsxNSignatureMatchAirjack=wlsxNSignatureMatchAirjack, wlsxTrapMasterIp=wlsxTrapMasterIp, wlsxTrapStationBlackListReasonStr=wlsxTrapStationBlackListReasonStr, wlsxTrapDeviceMac=wlsxTrapDeviceMac)
