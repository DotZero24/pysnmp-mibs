...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:29:44 2025
...
mibBuilder.exportSymbols("MPOA-MIB", mpcStatRxMpoaKeepAlives=mpcStatRxMpoaKeepAlives, mpsMappingTable=mpsMappingTable, mpcEgressCacheIDestAddr=mpcEgressCacheIDestAddr, mpcIngressCacheEntryState=mpcIngressCacheEntryState, mpcIngressCacheEgressCacheTag=mpcIngressCacheEgressCacheTag, mpsEgressCacheMpoaRequestId=mpsEgressCacheMpoaRequestId, deviceTypeRemoteLecAtmAddress=deviceTypeRemoteLecAtmAddress, mpcIngressCacheGroup=mpcIngressCacheGroup, mpoaMpcMibAdvancedPlusOctetsCompliance=mpoaMpcMibAdvancedPlusOctetsCompliance, mpcEgressCacheTotalOctetGroup=mpcEgressCacheTotalOctetGroup, mpcIngressCacheTable=mpcIngressCacheTable, mpcMappingEntry=mpcMappingEntry, mpcIngressCacheDestAtmAddr=mpcIngressCacheDestAtmAddr, mpcRowStatus=mpcRowStatus, LecIndex=LecIndex, mpoaMpsMibBasicCompliance=mpoaMpsMibBasicCompliance, mpcDataAtmAddressGroup=mpcDataAtmAddressGroup, mpcStatRxErrUnrecognizedExtensions=mpcStatRxErrUnrecognizedExtensions, deviceTypeMpsMacAddressTable=deviceTypeMpsMacAddressTable, mpcFlowDetectProtocol=mpcFlowDetectProtocol, mpsConfigMode=mpsConfigMode, mpsActualGroup=mpsActualGroup, deviceTypeTable=deviceTypeTable, mpcStatRxNhrpPurgeRequests=mpcStatRxNhrpPurgeRequests, mpcMpsAtmAddr=mpcMpsAtmAddr, mpcStatRxMpoaResolveReplyInsufSCResources=mpcStatRxMpoaResolveReplyInsufSCResources, mpcStatTxMpoaImpReplyUnspecifiedOther=mpcStatTxMpoaImpReplyUnspecifiedOther, mpcFlowDetectLecIndex=mpcFlowDetectLecIndex, mpsActualEntry=mpsActualEntry, mpcStatTxNhrpPurgeReplies=mpcStatTxNhrpPurgeReplies, mpcMpsMacAddressTable=mpcMpsMacAddressTable, mpsActualTable=mpsActualTable, mpcStatRxErrSduSizeExceededs=mpcStatRxErrSduSizeExceededs, mpcStatTxMpoaEgressCachePurgeRequests=mpcStatTxMpoaEgressCachePurgeRequests, mpsStatTxNhrpResolveRequests=mpsStatTxNhrpResolveRequests, mpsProtocolTable=mpsProtocolTable, mpcCtrlAtmAddr=mpcCtrlAtmAddr, mpcEgressCacheLecIndex=mpcEgressCacheLecIndex, mpsActualRetryTimeMaximum=mpsActualRetryTimeMaximum, mpoaMIB=mpoaMIB, mpsIngressCacheSourceMpcCtrlAtmAddr=mpsIngressCacheSourceMpcCtrlAtmAddr, mpsConfigEntry=mpsConfigEntry, deviceTypeLecIndex=deviceTypeLecIndex, mpcActualState=mpcActualState, mpcMpsMacAddressEntry=mpcMpsMacAddressEntry, mpcMpsMultipleMacAddressTable=mpcMpsMultipleMacAddressTable, mpcDataAtmAddressRowStatus=mpcDataAtmAddressRowStatus, mpcEgressCacheEntry=mpcEgressCacheEntry, mpcObjects=mpcObjects, mpsIngressCacheHoldTime=mpsIngressCacheHoldTime, mpsIngressCacheMpoaRequestId=mpsIngressCacheMpoaRequestId, mpcMpsMacAddressGroup=mpcMpsMacAddressGroup, mpsConfigGroup=mpsConfigGroup, mpcStatTxMpoaImpReplyUnsupportedMacEncaps=mpcStatTxMpoaImpReplyUnsupportedMacEncaps, mpcActualConfigMode=mpcActualConfigMode, mpcIngressCacheEntry=mpcIngressCacheEntry, mpcConfigEntry=mpcConfigEntry, mpsRowStatus=mpsRowStatus, mpsDefaultHoldingTime=mpsDefaultHoldingTime, mpsActualInitialRetryTime=mpsActualInitialRetryTime, mpsActualKeepAliveLifeTime=mpsActualKeepAliveLifeTime, mpsStatRxMpoaImpReplyInsufEitherResources=mpsStatRxMpoaImpReplyInsufEitherResources, mpcMappingTable=mpcMappingTable, mpsStatRxMpoaImpReplyUnsupportedInetProt=mpsStatRxMpoaImpReplyUnsupportedInetProt, mpcDataAtmAddress=mpcDataAtmAddress, mpsNextIndex=mpsNextIndex, mpcStatRxErrProtoAddrUnreachables=mpcStatRxErrProtoAddrUnreachables, mpcConfigTable=mpcConfigTable, mpcStatRxMpoaResolveReplyAcks=mpcStatRxMpoaResolveReplyAcks, mpsIngressCacheEntryState=mpsIngressCacheEntryState, mpcHoldDownTime=mpcHoldDownTime, mpcStatRxMpoaResolveReplyUnspecifiedOther=mpcStatRxMpoaResolveReplyUnspecifiedOther, mpsStatGiveupTimeExpireds=mpsStatGiveupTimeExpireds, mpsIndex=mpsIndex, mpsStatRxNhrpResolveReplies=mpsStatRxNhrpResolveReplies, mpcIndex=mpcIndex, mpcIngressCacheTimeUntilNextResolutionRequest=mpcIngressCacheTimeUntilNextResolutionRequest, deviceTypeMpsMacAddress=deviceTypeMpsMacAddress, InternetworkAddrType=InternetworkAddrType, mpcNextIndex=mpcNextIndex, mpcIngressCacheServiceCategory=mpcIngressCacheServiceCategory, mpcStatRxMpoaResolveReplyUnsupportedMacEncaps=mpcStatRxMpoaResolveReplyUnsupportedMacEncaps, mpcIngressCacheHoldingTime=mpcIngressCacheHoldingTime, mpcDiscontinuityTime=mpcDiscontinuityTime, mpcEgressCacheTable=mpcEgressCacheTable, mpsIngressCacheServiceCategory=mpsIngressCacheServiceCategory, mpsActualKeepAlive=mpsActualKeepAlive, mpcEgressCacheDataLinkHeader=mpcEgressCacheDataLinkHeader, mpsMpcCtrlAtmAddr=mpsMpcCtrlAtmAddr, mpsEgressCacheId=mpsEgressCacheId, mpcLecIndex=mpcLecIndex, mpcEgressCacheEgressCacheTag=mpcEgressCacheEgressCacheTag, mpsCtrlAtmAddr=mpsCtrlAtmAddr, mpcIngressCacheRetries=mpcIngressCacheRetries, mpcStatRxMpoaEgressCachePurgeReplies=mpcStatRxMpoaEgressCachePurgeReplies, mpcSCSetupFrameCount=mpcSCSetupFrameCount, mpcStatRxErrProtoErrors=mpcStatRxErrProtoErrors, mpsStatRxMpoaImpReplyOther=mpsStatRxMpoaImpReplyOther, mpoaMIBObjects=mpoaMIBObjects, mpsIngressCacheSrcAddr=mpsIngressCacheSrcAddr, mpsStatTxMpoaResolveReplyUnsupportedInetProt=mpsStatTxMpoaResolveReplyUnsupportedInetProt, mpcDataAtmAddressEntry=mpcDataAtmAddressEntry, mpsDiscontinuityTime=mpsDiscontinuityTime, mpcMpsGroup=mpcMpsGroup, mpcStatTxMpoaImpReplyUnsupportedInetProt=mpcStatTxMpoaImpReplyUnsupportedInetProt, mpsStatTxMpoaResolveReplyInsufECResources=mpsStatTxMpoaResolveReplyInsufECResources, mpcActualSCSetupFrameCount=mpcActualSCSetupFrameCount, mpcStatRxMpoaTriggers=mpcStatRxMpoaTriggers, mpcConfigGroup=mpcConfigGroup, mpsIngressCacheGroup=mpsIngressCacheGroup, mpsKeepAliveLifeTime=mpsKeepAliveLifeTime, mpsEgressCacheElanId=mpsEgressCacheElanId, mpsProtocolGroup=mpsProtocolGroup, mpcStatisticsEntry=mpcStatisticsEntry, mpsProtocolEntry=mpsProtocolEntry, mpsStatRxMpoaResolveRequests=mpsStatRxMpoaResolveRequests, mpsMappingIndex=mpsMappingIndex, atmfMpoa=atmfMpoa, mpcIngressCacheEgressCacheTagValid=mpcIngressCacheEgressCacheTagValid, mpsMpcEntry=mpsMpcEntry, mpoaMIBCompliances=mpoaMIBCompliances, mpsIngressCacheNhrpRequestId=mpsIngressCacheNhrpRequestId, mpsEgressCacheNextHopInternetworkAddrType=mpsEgressCacheNextHopInternetworkAddrType, mpcStatRxErrLoopDetecteds=mpcStatRxErrLoopDetecteds, mpsMpcGroup=mpsMpcGroup, deviceTypeMpsMacAddressEntry=deviceTypeMpsMacAddressEntry, mpoaMpcMibAdvancedCompliance=mpoaMpcMibAdvancedCompliance, mpcActualTable=mpcActualTable, mpcStatRxMpoaImpRequests=mpcStatRxMpoaImpRequests, mpcDataAtmAddressTable=mpcDataAtmAddressTable, mpcMpsObjects=mpcMpsObjects, mpsIngressCacheDestInternetworkAddrType=mpsIngressCacheDestInternetworkAddrType, mpcActualSCSetupFrameTime=mpcActualSCSetupFrameTime, AtmConfigAddr=AtmConfigAddr, mpcProtocolEntry=mpcProtocolEntry, mpsConfigTable=mpsConfigTable, mpsStatTxMpoaResolveReplyInsufSCResources=mpsStatTxMpoaResolveReplyInsufSCResources, deviceTypeType=deviceTypeType, mpcStatRxErrInvalidReplies=mpcStatRxErrInvalidReplies, mpsMpcTable=mpsMpcTable, mpsEgressCacheHoldTime=mpsEgressCacheHoldTime, mpsStatTxMpoaImpRequests=mpsStatTxMpoaImpRequests, mpcEgressCacheTotalPacketGroup=mpcEgressCacheTotalPacketGroup, mpcConfigMode=mpcConfigMode, mpsIngressCacheTable=mpsIngressCacheTable, mpsStatisticsGroup=mpsStatisticsGroup, mpcEgressCacheServiceCategory=mpcEgressCacheServiceCategory, mpcIngressCacheDestInetworkAddrType=mpcIngressCacheDestInetworkAddrType, mpsStatRxMpoaImpReplyAcks=mpsStatRxMpoaImpReplyAcks, mpcActualHoldDownTime=mpcActualHoldDownTime, mpsStatisticsTable=mpsStatisticsTable, mpcMappingGroup=mpcMappingGroup, AtmAddr=AtmAddr, mpcStatTxMpoaDataPlanePurges=mpcStatTxMpoaDataPlanePurges, atmForum=atmForum, mpsActualGiveupTime=mpsActualGiveupTime, mpcStatRxErrInvalidExtensions=mpcStatRxErrInvalidExtensions, mpcEgressCachePrefixLen=mpcEgressCachePrefixLen, mpcStatRxErrAuthenticationFailures=mpcStatRxErrAuthenticationFailures, mpcActualRetryTimeMaximum=mpcActualRetryTimeMaximum, mpsStatRxMpoaImpReplyUnsupportedMacEncaps=mpsStatRxMpoaImpReplyUnsupportedMacEncaps, mpsMpcIndex=mpsMpcIndex, mpoaDeviceTypeMpsMacGroup=mpoaDeviceTypeMpsMacGroup, mpcMpsMacAddressIndex=mpcMpsMacAddressIndex, deviceTypeIndex=deviceTypeIndex, mpsEgressCacheEntry=mpsEgressCacheEntry, MpsIndex=MpsIndex, mpcEgressCacheId=mpcEgressCacheId, mpsStatRxNhrpResolveRequests=mpsStatRxNhrpResolveRequests, mpoaMIBConformance=mpoaMIBConformance, mpcActualGroup=mpcActualGroup, mpsStatTxMpoaTriggers=mpsStatTxMpoaTriggers, mpcStatRxMpoaResolveReplyUnsupportedInetProt=mpcStatRxMpoaResolveReplyUnsupportedInetProt, mpsGiveupTime=mpsGiveupTime, mpcIngressCacheDestAddr=mpcIngressCacheDestAddr, mpcStatisticsGroup=mpcStatisticsGroup, mpcStatTxMpoaImpReplyInsufEitherResources=mpcStatTxMpoaImpReplyInsufEitherResources, mpcInitialRetryTime=mpcInitialRetryTime, mpcEgressCacheRxTotalOctets=mpcEgressCacheRxTotalOctets, mpsMappingEntry=mpsMappingEntry, MpcIndex=MpcIndex, mpcMappingRowStatus=mpcMappingRowStatus, mpsIngressCacheEntry=mpsIngressCacheEntry, mpcActualEntry=mpcActualEntry, mpcMpsEntry=mpcMpsEntry, mpcMpsMultipleMacAddressEntry=mpcMpsMultipleMacAddressEntry, mpsEgressCacheEntryState=mpsEgressCacheEntryState, mpcLECSValue=mpcLECSValue, mpcEgressCacheRxTotalPackets=mpcEgressCacheRxTotalPackets, mpsStatRxMpoaEgressCachePurgeRequests=mpsStatRxMpoaEgressCachePurgeRequests, mpsActualConfigMode=mpsActualConfigMode, mpsEgressCacheDestInternetworkAddrType=mpsEgressCacheDestInternetworkAddrType, InternetworkAddr=InternetworkAddr, mpcIngressCachePrefixLen=mpcIngressCachePrefixLen, mpcEgressCacheEntryState=mpcEgressCacheEntryState, mpsStatTxMpoaResolveReplyUnspecifiedOther=mpsStatTxMpoaResolveReplyUnspecifiedOther, mpcStatTxMpoaImpReplyInsufSCResources=mpcStatTxMpoaImpReplyInsufSCResources, mpsInitialRetryTime=mpsInitialRetryTime, PYSNMP_MODULE_ID=mpoaMIB, deviceTypeMpsAtmAddress=deviceTypeMpsAtmAddress, mpcStatRxErrHopCountExceededs=mpcStatRxErrHopCountExceededs, mpcProtocolRowStatus=mpcProtocolRowStatus, mpcIngressCacheTxTotalPackets=mpcIngressCacheTxTotalPackets, mpsProtocolRowStatus=mpsProtocolRowStatus, mpcEgressCacheIngressMpcDataAtmAddr=mpcEgressCacheIngressMpcDataAtmAddr, mpsEgressCacheNhrpRequestId=mpsEgressCacheNhrpRequestId, mpoaMpsMibAdvancedCompliance=mpoaMpsMibAdvancedCompliance, deviceTypeEntry=deviceTypeEntry, mpcMappingIndex=mpcMappingIndex, mpsStatTxMpoaEgressCachePurgeReplies=mpsStatTxMpoaEgressCachePurgeReplies, mpsMappingGroup=mpsMappingGroup, mpsEgressCacheDestAddr=mpsEgressCacheDestAddr, mpcRetryTimeMaximum=mpcRetryTimeMaximum, atmForumNetworkManagement=atmForumNetworkManagement, mpcActualInitialRetryTime=mpcActualInitialRetryTime, mpsStatRxMpoaImpReplyInsufECResources=mpsStatRxMpoaImpReplyInsufECResources, mpsEgressCacheDataLinkHeader=mpsEgressCacheDataLinkHeader, mpsEgressCacheSourceClientAtmAddr=mpsEgressCacheSourceClientAtmAddr, mpcEgressCacheInetworkAddrType=mpcEgressCacheInetworkAddrType, mpcStatTxMpoaImpReplyAcks=mpcStatTxMpoaImpReplyAcks, deviceTypeMpcAtmAddress=deviceTypeMpcAtmAddress, mpsStatTxNhrpResolveReplies=mpsStatTxNhrpResolveReplies, mpcIngressCacheSrcAtmAddr=mpcIngressCacheSrcAtmAddr, mpcEgressCacheHoldTime=mpcEgressCacheHoldTime, mpsLECSValue=mpsLECSValue, mpcMpsMultipleMacAddressGroup=mpcMpsMultipleMacAddressGroup, mpsStatTxMpoaResolveReplyAcks=mpsStatTxMpoaResolveReplyAcks, mpcStatRxMpoaDataPlanePurges=mpcStatRxMpoaDataPlanePurges, mpsEgressCachePrefixLen=mpsEgressCachePrefixLen, mpsEgressCacheTable=mpsEgressCacheTable, mpoaCommonObjects=mpoaCommonObjects, mpsRetryTimeMaximum=mpsRetryTimeMaximum, mpsIngressCacheResolvedAtmAddr=mpsIngressCacheResolvedAtmAddr, mpcSCSetupFrameTime=mpcSCSetupFrameTime, mpcStatisticsTable=mpcStatisticsTable, mpcStatRxMpoaResolveReplyInsufEitherResources=mpcStatRxMpoaResolveReplyInsufEitherResources, mpcStatRxMpoaResolveReplyInsufECResources=mpcStatRxMpoaResolveReplyInsufECResources, mpoaMpcMibBasicCompliance=mpoaMpcMibBasicCompliance, mpcMpsTable=mpcMpsTable, mpsStatRxMpoaImpReplyUnspecifiedOther=mpsStatRxMpoaImpReplyUnspecifiedOther, mpsMappingRowStatus=mpsMappingRowStatus, mpsStatTxMpoaResolveReplyInsufEitherResources=mpsStatTxMpoaResolveReplyInsufEitherResources, mpsEgressCacheGroup=mpsEgressCacheGroup, mpcMpsMacAddress=mpcMpsMacAddress, mpcEgressCacheEgressCacheTagValid=mpcEgressCacheEgressCacheTagValid, mpoaDeviceTypeGroup=mpoaDeviceTypeGroup, mpsActualDefaultHoldingTime=mpsActualDefaultHoldingTime, mpcProtocolGroup=mpcProtocolGroup, mpsIngressCacheSrcInternetworkAddrType=mpsIngressCacheSrcInternetworkAddrType, mpcIngressCacheTotalOctetGroup=mpcIngressCacheTotalOctetGroup, mpoaMIBGroups=mpoaMIBGroups, mpcStatTxMpoaImpReplyInsufECResources=mpcStatTxMpoaImpReplyInsufECResources, mpsKeepAliveTime=mpsKeepAliveTime, mpsInternetworkLayerProtocol=mpsInternetworkLayerProtocol)
mibBuilder.exportSymbols("MPOA-MIB", mpcIngressCacheSigErrCode=mpcIngressCacheSigErrCode, mpcEgressCacheGroup=mpcEgressCacheGroup, mpsEgressCacheServiceCategory=mpsEgressCacheServiceCategory, mpsEgressCacheNextHopAddr=mpsEgressCacheNextHopAddr, mpcMpsIndex=mpcMpsIndex, mpsStatRxMpoaImpReplyInsufSCResources=mpsStatRxMpoaImpReplyInsufSCResources, mpsIngressCachePrefixLen=mpsIngressCachePrefixLen, mpcStatTxMpoaResolveRequests=mpcStatTxMpoaResolveRequests, mpsActualState=mpsActualState, mpsStatTxMpoaResolveReplyOther=mpsStatTxMpoaResolveReplyOther, mpcIngressCacheTxTotalOctets=mpcIngressCacheTxTotalOctets, mpsIngressCacheDestAddr=mpsIngressCacheDestAddr, mpsStatTxMpoaResolveReplyUnsupportedMacEncaps=mpsStatTxMpoaResolveReplyUnsupportedMacEncaps, mpcIngressCacheLastNhrpCieCode=mpcIngressCacheLastNhrpCieCode, mpcProtocolTable=mpcProtocolTable, mpsStatisticsEntry=mpsStatisticsEntry, mpcIngressCacheTotalPacketGroup=mpcIngressCacheTotalPacketGroup, mpsObjects=mpsObjects, mpcMpsFlowDetectMacAddress=mpcMpsFlowDetectMacAddress)
