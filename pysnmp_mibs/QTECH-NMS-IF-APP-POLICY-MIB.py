# SNMP MIB module (QTECH-NMS-IF-APP-POLICY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-NMS-IF-APP-POLICY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:59:27 2025
...
nmsIfAppPolicyEntry = _NmsIfAppPolicyEntry_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 65, 1, 1)
)
nmsIfAppPolicyEntry.setIndexNames(
    (0, "QTECH-NMS-IF-APP-POLICY-MIB", "nmsIfIndex"),
)
if mibBuilder.loadTexts:
