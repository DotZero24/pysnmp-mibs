...
mibBuilder.exportSymbols("TRAPEZE-NETWORKS-CLIENT-SESSION-TC", TrpzClientDot1xState=TrpzClientDot1xState, TrpzClientSessionState=TrpzClientSessionState, TrpzClientAccessMode=TrpzClientAccessMode, TrpzClientDeviceGroupName=TrpzClientDeviceGroupName, TrpzClientAuthenProtocolType=TrpzClientAuthenProtocolType, TrpzClientDeviceProfileName=TrpzClientDeviceProfileName, TrpzUserAccessType=TrpzUserAccessType, PYSNMP_MODULE_ID=trpzClientSessionTc, TrpzClientDeviceType=TrpzClientDeviceType, trpzClientSessionTc=trpzClientSessionTc)
