...
mibBuilder.exportSymbols("HUAWEI-LswQos-MIB", hwExpMapTable=hwExpMapTable, hwBandwidthDirection=hwBandwidthDirection, hwMirrorUserAclNum=hwMirrorUserAclNum, hwMirroringGroupMonitorIfIndex=hwMirroringGroupMonitorIfIndex, hwFlowtempEnableIfIndex=hwFlowtempEnableIfIndex, hwPortWredEntry=hwPortWredEntry, hwPortMonitorBothIfIndex=hwPortMonitorBothIfIndex, hwFlowtempDIp=hwFlowtempDIp, hwFlowtempEnableVlanID=hwFlowtempEnableVlanID, hwMirrorIpAclRule=hwMirrorIpAclRule, hwRateLimitIpAclNum=hwRateLimitIpAclNum, hwStatisticDirection=hwStatisticDirection, hwPriorityIpAclNum=hwPriorityIpAclNum, hwFlowtempDPort=hwFlowtempDPort, hwRedVlanID=hwRedVlanID, hwStatisticUserAclRule=hwStatisticUserAclRule, hwMirroringGroupMirrorRowStatus=hwMirroringGroupMirrorRowStatus, hwStatisticAclIndex=hwStatisticAclIndex, hwRedirectLinkAclNum=hwRedirectLinkAclNum, hwRedIfIndex=hwRedIfIndex, hwRateLimitConformLocalPre=hwRateLimitConformLocalPre, hwRateLimitCIR=hwRateLimitCIR, hwLineRateEntry=hwLineRateEntry, hwPortWredIfIndex=hwPortWredIfIndex, hwPortMirrorTable=hwPortMirrorTable, hwPortQueueIfIndex=hwPortQueueIfIndex, hwStatisticIpAclNum=hwStatisticIpAclNum, hwFlowtempTcpFlag=hwFlowtempTcpFlag, hwDscpMapConformLevel=hwDscpMapConformLevel, hwPriorityAclIndex=hwPriorityAclIndex, hwQueueTable=hwQueueTable, hwFlowtempSIpMask=hwFlowtempSIpMask, hwMirrorGroupRowStatus=hwMirrorGroupRowStatus, hwFlowtempEnableFlowtempIndex=hwFlowtempEnableFlowtempIndex, hwMirrorLinkAclRule=hwMirrorLinkAclRule, hwMirroringGroupMirrorVlanTable=hwMirroringGroupMirrorVlanTable, hwLocalPrecedenceMapEntry=hwLocalPrecedenceMapEntry, hwMirroringGroupMonitorRowStatus=hwMirroringGroupMonitorRowStatus, hwFlowtempSPort=hwFlowtempSPort, hwWredRedMinThreshold=hwWredRedMinThreshold, hwMirroringGroupRprobeVlanEntry=hwMirroringGroupRprobeVlanEntry, hwStatisticEntry=hwStatisticEntry, hwBandwidthMinGuaranteedWidth=hwBandwidthMinGuaranteedWidth, hwRateLimitTargetRateKbps=hwRateLimitTargetRateKbps, hwStatisticPacketXCount=hwStatisticPacketXCount, hwRateLimitExceedDscp=hwRateLimitExceedDscp, hwPriorityTable=hwPriorityTable, hwRedirectToNestedVlanID=hwRedirectToNestedVlanID, hwMirrorGroupMonitorIfIndex=hwMirrorGroupMonitorIfIndex, hwDscpToDropPreMapDscpIndex=hwDscpToDropPreMapDscpIndex, hwRedirectIfIndex=hwRedirectIfIndex, hwQueueEntry=hwQueueEntry, hwMirroringGroupMirrorInboundIfIndexList=hwMirroringGroupMirrorInboundIfIndexList, hwExpMapExpValue=hwExpMapExpValue, hwFlowtempDMac=hwFlowtempDMac, hwLocalPrecedenceMapLocalPrecedenceIndex=hwLocalPrecedenceMapLocalPrecedenceIndex, hwQueueIfIndex=hwQueueIfIndex, hwRateLimitExceedActionType=hwRateLimitExceedActionType, hwTrafficShapeMaxRate=hwTrafficShapeMaxRate, hwRedirectToNextHop3=hwRedirectToNextHop3, hwDscpToDropPreMapTable=hwDscpToDropPreMapTable, hwRedDirection=hwRedDirection, hwFlowtempDIpMask=hwFlowtempDIpMask, hwQueueWeight1=hwQueueWeight1, hwBandwidthIfIndex=hwBandwidthIfIndex, hwWredQueueId=hwWredQueueId, hwQueueMaxDelay=hwQueueMaxDelay, hwMirroringGroupReflectorRowStatus=hwMirroringGroupReflectorRowStatus, hwRedirectRowStatus=hwRedirectRowStatus, hwRedirectTargetVlanID=hwRedirectTargetVlanID, hwTrafficShapeIfIndex=hwTrafficShapeIfIndex, hwPortWredTable=hwPortWredTable, hwMirrorToGroup=hwMirrorToGroup, hwPriorityRuntime=hwPriorityRuntime, hwExpMapExpIndex=hwExpMapExpIndex, hwMirrorDirection=hwMirrorDirection, hwPortMirrorEntry=hwPortMirrorEntry, hwRemarkVlanIDLinkAclRule=hwRemarkVlanIDLinkAclRule, hwPriorityLinkAclNum=hwPriorityLinkAclNum, hwPriorityPolicedServiceLoaclPre=hwPriorityPolicedServiceLoaclPre, hwPortQueueQueueID=hwPortQueueQueueID, hwRedRowStatus=hwRedRowStatus, hwWredExponent=hwWredExponent, hwDscpMapTable=hwDscpMapTable, hwDscpToCosMapDscpIndex=hwDscpToCosMapDscpIndex, HwMirrorOrMonitorType=HwMirrorOrMonitorType, hwMirroringGroupRowStatus=hwMirroringGroupRowStatus, hwMirrorToCpu=hwMirrorToCpu, hwMirroringGroupMirrorMac=hwMirroringGroupMirrorMac, hwMirrorIpAclNum=hwMirrorIpAclNum, hwDscpToDropPreMapReset=hwDscpToDropPreMapReset, hwRateLimitConformActionType=hwRateLimitConformActionType, hwLineRateRowStatus=hwLineRateRowStatus, hwRateLimitLinkAclRule=hwRateLimitLinkAclRule, hwMirroringGroupMonitorTable=hwMirroringGroupMonitorTable, hwDscpToDscpMapReset=hwDscpToDscpMapReset, hwMirroringGroupEntry=hwMirroringGroupEntry, hwRemarkVlanIDUserAclNum=hwRemarkVlanIDUserAclNum, hwRateLimitPIR=hwRateLimitPIR, hwStatisticByteXCount=hwStatisticByteXCount, hwMirroringGroupMirrorVlanEntry=hwMirroringGroupMirrorVlanEntry, hwExpMapDscpValue=hwExpMapDscpValue, hwDscpMapCosValue=hwDscpMapCosValue, hwFlowtempRowStatus=hwFlowtempRowStatus, hwStatisticIfIndex=hwStatisticIfIndex, hwRateLimitCBS=hwRateLimitCBS, hwRateLimitTargetRateMbps=hwRateLimitTargetRateMbps, hwPriorityIpPreFromCos=hwPriorityIpPreFromCos, hwTrafficShapeRowStatus=hwTrafficShapeRowStatus, hwPriorityIfIndex=hwPriorityIfIndex, hwStatisticVlanID=hwStatisticVlanID, hwPriorityUserAclRule=hwPriorityUserAclRule, hwMirroringGroupMirrorTable=hwMirroringGroupMirrorTable, hwRateLimitVlanID=hwRateLimitVlanID, hwRedirectToIfIndex=hwRedirectToIfIndex, hwTrafficShapeEntry=hwTrafficShapeEntry, hwRemarkVlanIDLinkAclNum=hwRemarkVlanIDLinkAclNum, hwMirroringGroupMirrorInTypeList=hwMirroringGroupMirrorInTypeList, hwRateLimitUserAclRule=hwRateLimitUserAclRule, hwStatisticTable=hwStatisticTable, hwCosToLocalPrecedenceMapTable=hwCosToLocalPrecedenceMapTable, hwPortQueueEntry=hwPortQueueEntry, hwDscpMapDropPrecedence=hwDscpMapDropPrecedence, hwQueueWeight8=hwQueueWeight8, hwPriorityVlanID=hwPriorityVlanID, hwPriorityPolicedServiceCos=hwPriorityPolicedServiceCos, hwPortWredQueueStartLength=hwPortWredQueueStartLength, hwRemarkVlanIDEntry=hwRemarkVlanIDEntry, hwFlowtempIpProtocol=hwFlowtempIpProtocol, hwFlowtempEthProtocol=hwFlowtempEthProtocol, hwRemarkVlanIDRowStatus=hwRemarkVlanIDRowStatus, hwRateLimitUserAclNum=hwRateLimitUserAclNum, hwWredGreenMaxThreshold=hwWredGreenMaxThreshold, hwPortTrustTable=hwPortTrustTable, hwQueueWeight3=hwQueueWeight3, hwRateLimitRuntime=hwRateLimitRuntime, hwRateLimitTable=hwRateLimitTable, hwPriorityPolicedServiceDscp=hwPriorityPolicedServiceDscp, hwTrafficShapeQueueId=hwTrafficShapeQueueId, hwTrafficShapeTable=hwTrafficShapeTable, hwBandwidthIpAclRule=hwBandwidthIpAclRule, hwLocalPrecedenceMapConformLevel=hwLocalPrecedenceMapConformLevel, hwStatisticRowStatus=hwStatisticRowStatus, hwMirrorIfIndex=hwMirrorIfIndex, hwMirroringGroupMirrorVlanDirection=hwMirroringGroupMirrorVlanDirection, hwDscpToLocalPreMapDscpIndex=hwDscpToLocalPreMapDscpIndex, hwPortMirrorRowStatus=hwPortMirrorRowStatus, hwMirrorRuntime=hwMirrorRuntime, hwWredEntry=hwWredEntry, hwDscpToCosMapTable=hwDscpToCosMapTable, hwPriorityLinkAclRule=hwPriorityLinkAclRule, hwMirroringGroupRprobeVlanID=hwMirroringGroupRprobeVlanID, hwPriorityCosFromIpPre=hwPriorityCosFromIpPre, hwPriorityUserAclNum=hwPriorityUserAclNum, hwRateLimitMeterStatByteCount=hwRateLimitMeterStatByteCount, hwCosToDscpMapTable=hwCosToDscpMapTable, hwFlowtempFragment=hwFlowtempFragment, hwRateLimitLinkAclNum=hwRateLimitLinkAclNum, hwCosToLocalPrecedenceMapCosIndex=hwCosToLocalPrecedenceMapCosIndex, hwRedAclIndex=hwRedAclIndex, hwMirrorRowStatus=hwMirrorRowStatus, hwMirroringGroupMirroMacStatus=hwMirroringGroupMirroMacStatus, hwRedirectTable=hwRedirectTable, hwPriorityPolicedServiceDropPriority=hwPriorityPolicedServiceDropPriority, hwFlowtempTable=hwFlowtempTable, hwMirrorVlanID=hwMirrorVlanID, hwRemarkVlanIDIpAclRule=hwRemarkVlanIDIpAclRule, PYSNMP_MODULE_ID=hwLswQosAclMib, hwMirrorToIfIndex=hwMirrorToIfIndex, hwLineRateDirection=hwLineRateDirection, hwStatisticByteCount=hwStatisticByteCount, hwMirrorGroupEntry=hwMirrorGroupEntry, hwPortMirrorIfIndex=hwPortMirrorIfIndex, hwMirroringGroupMirrorMacTable=hwMirroringGroupMirrorMacTable, hwPriorityTrustMode=hwPriorityTrustMode, hwCosToDropPrecedenceMapCosIndex=hwCosToDropPrecedenceMapCosIndex, hwRedirectToCpu=hwRedirectToCpu, hwRedStopQueueLen=hwRedStopQueueLen, hwPriorityEntry=hwPriorityEntry, hwPortQueueWeight=hwPortQueueWeight, hwMirroringGroupMirrorEntry=hwMirroringGroupMirrorEntry, hwBandwidthVlanID=hwBandwidthVlanID, hwBandwidthRuntime=hwBandwidthRuntime, hwBandwidthIpAclNum=hwBandwidthIpAclNum, hwPriorityPolicedServiceExp=hwPriorityPolicedServiceExp, hwRedLinkAclNum=hwRedLinkAclNum, hwRemarkVlanIDIfIndex=hwRemarkVlanIDIfIndex, hwMirrorGroupID=hwMirrorGroupID, hwStatisticRuntime=hwStatisticRuntime, hwQueueWeight6=hwQueueWeight6, hwMirroringGroupID=hwMirroringGroupID, hwFlowtempSMacMask=hwFlowtempSMacMask, hwRateLimitEBS=hwRateLimitEBS, hwMirrorGroupMirrorIfIndexList=hwMirrorGroupMirrorIfIndexList, hwDropModeMode=hwDropModeMode, hwPortWredQueueProbability=hwPortWredQueueProbability, hwMirroringGroupMirroVlanStatus=hwMirroringGroupMirroVlanStatus, hwQueueWeight2=hwQueueWeight2, hwBandwidthAclIndex=hwBandwidthAclIndex, hwMirroringGroupMirrorMacSeq=hwMirroringGroupMirrorMacSeq, hwFlowtempVpn=hwFlowtempVpn, hwDscpToDscpMapDscpIndex=hwDscpToDscpMapDscpIndex, hwStatisticLinkAclRule=hwStatisticLinkAclRule, hwPortTrustEntry=hwPortTrustEntry, hwPriorityCos=hwPriorityCos, hwRateLimitPeakRate=hwRateLimitPeakRate, hwMirroringGroupType=hwMirroringGroupType, hwMirrorMacVlanID=hwMirrorMacVlanID, hwWredYellowMaxProb=hwWredYellowMaxProb, hwStatisticPacketCount=hwStatisticPacketCount, hwFlowtempIcmpType=hwFlowtempIcmpType, hwWredRedMaxThreshold=hwWredRedMaxThreshold, hwMirrorUserAclRule=hwMirrorUserAclRule, hwQueueWeight7=hwQueueWeight7, hwFlowtempIndex=hwFlowtempIndex, hwPortTrustIfIndex=hwPortTrustIfIndex, hwRemarkVlanIDPacketType=hwRemarkVlanIDPacketType, hwRedIpAclNum=hwRedIpAclNum, hwRateLimitExceedCos=hwRateLimitExceedCos, hwMirroringGroupMirrorOutTypeList=hwMirroringGroupMirrorOutTypeList, hwFlowtempDscp=hwFlowtempDscp, hwDscpMapLocalPrecedence=hwDscpMapLocalPrecedence, hwPriorityIpAclRule=hwPriorityIpAclRule, hwPriorityPolicedServiceType=hwPriorityPolicedServiceType, hwRedirectEntry=hwRedirectEntry, hwLocalPrecedenceMapCosValue=hwLocalPrecedenceMapCosValue, hwCosToDscpMapEntry=hwCosToDscpMapEntry, hwMirrorTable=hwMirrorTable, hwFlowtempTos=hwFlowtempTos, hwMirrorGroupTable=hwMirrorGroupTable, hwRateLimitIfIndex=hwRateLimitIfIndex, hwPriorityDirection=hwPriorityDirection, hwFlowtempSIp=hwFlowtempSIp, hwDscpToDscpMapDscpValue=hwDscpToDscpMapDscpValue, hwLocalPrecedenceMapTable=hwLocalPrecedenceMapTable, hwRemarkVlanIDVlanID=hwRemarkVlanIDVlanID, hwRateLimitIpAclRule=hwRateLimitIpAclRule, hwDropModeIfIndex=hwDropModeIfIndex, hwDropModeEntry=hwDropModeEntry, hwRateLimitRowStatus=hwRateLimitRowStatus, hwDscpMapExpValue=hwDscpMapExpValue, hwWredYellowMaxThreshold=hwWredYellowMaxThreshold, hwRemarkVlanIDIpAclNum=hwRemarkVlanIDIpAclNum, hwTrafficShapeBufferLimit=hwTrafficShapeBufferLimit, hwRedIpAclRule=hwRedIpAclRule, hwRedirectRemarkedTos=hwRedirectRemarkedTos, hwRedLinkAclRule=hwRedLinkAclRule, hwRateLimitConformDscp=hwRateLimitConformDscp, hwRedirectToModifiedVlanID=hwRedirectToModifiedVlanID, hwPortTrustReset=hwPortTrustReset, hwTrafficShapeBurstSize=hwTrafficShapeBurstSize, hwDscpToLocalPreMapTable=hwDscpToLocalPreMapTable, hwPortQueueTable=hwPortQueueTable, hwFlowtempCos=hwFlowtempCos)
mibBuilder.exportSymbols("HUAWEI-LswQos-MIB", hwLineRateTable=hwLineRateTable, hwMirroringGroupMirrorVlanSeq=hwMirroringGroupMirrorVlanSeq, hwRedirectRuntime=hwRedirectRuntime, hwRemarkVlanIDTable=hwRemarkVlanIDTable, hwWredIndex=hwWredIndex, hwPortQueueWrrPriority=hwPortQueueWrrPriority, hwRemarkVlanIDDirection=hwRemarkVlanIDDirection, hwMirroringGroupMirrorVlanID=hwMirroringGroupMirrorVlanID, hwMirrorEntry=hwMirrorEntry, hwStatisticLinkAclNum=hwStatisticLinkAclNum, hwStatisticIpAclRule=hwStatisticIpAclRule, hwPriorityDscp=hwPriorityDscp, hwRedirectAclIndex=hwRedirectAclIndex, hwLswQosAclMib=hwLswQosAclMib, hwDscpToDscpMapEntry=hwDscpToDscpMapEntry, hwCosToLocalPrecedenceMapEntry=hwCosToLocalPrecedenceMapEntry, hwFlowtempVlanId=hwFlowtempVlanId, hwFlowtempEnableTable=hwFlowtempEnableTable, hwMirroringGroupRprobeVlanRowStatus=hwMirroringGroupRprobeVlanRowStatus, hwRemarkVlanIDUserAclRule=hwRemarkVlanIDUserAclRule, hwExpMapLocalPrecedence=hwExpMapLocalPrecedence, hwRedRuntime=hwRedRuntime, hwRateLimitDirection=hwRateLimitDirection, hwFlowtempEntry=hwFlowtempEntry, hwPriorityRowStatus=hwPriorityRowStatus, hwRedTable=hwRedTable, hwMirroringGroupStatus=hwMirroringGroupStatus, hwMirrorGroupDirection=hwMirrorGroupDirection, hwRedProbability=hwRedProbability, hwDscpToDropPreMapDropPreVal=hwDscpToDropPreMapDropPreVal, hwMirroringGroupTable=hwMirroringGroupTable, hwPortMirrorDirection=hwPortMirrorDirection, hwCosToDscpMapDscpValue=hwCosToDscpMapDscpValue, hwWredRedMaxProb=hwWredRedMaxProb, hwFlowtempIpPre=hwFlowtempIpPre, hwFlowtempSMac=hwFlowtempSMac, hwRedirectIpAclRule=hwRedirectIpAclRule, hwBandwidthMaxGuaranteedWidth=hwBandwidthMaxGuaranteedWidth, hwBandwidthTable=hwBandwidthTable, hwMirrorLinkAclNum=hwMirrorLinkAclNum, hwPriorityLocalPre=hwPriorityLocalPre, hwExpMapConformLevel=hwExpMapConformLevel, hwDscpToLocalPreMapEntry=hwDscpToLocalPreMapEntry, hwRedirectDirection=hwRedirectDirection, hwCosToDropPrecedenceMapDropPrecedenceValue=hwCosToDropPrecedenceMapDropPrecedenceValue, hwDscpToCosMapCosValue=hwDscpToCosMapCosValue, hwFlowtempDMacMask=hwFlowtempDMacMask, hwMirroringGroupMirrorOutboundIfIndexList=hwMirroringGroupMirrorOutboundIfIndexList, hwCosToDropPrecedenceMapEntry=hwCosToDropPrecedenceMapEntry, hwMirroringGroupRprobeVlanTable=hwMirroringGroupRprobeVlanTable, hwMirrorAclIndex=hwMirrorAclIndex, hwBandwidthLinkAclRule=hwBandwidthLinkAclRule, hwRemarkVlanIDAclIndex=hwRemarkVlanIDAclIndex, hwRedEntry=hwRedEntry, hwRedirectToNextHop2=hwRedirectToNextHop2, hwBandwidthRowStatus=hwBandwidthRowStatus, hwRedirectIpAclNum=hwRedirectIpAclNum, hwQueueScheduleMode=hwQueueScheduleMode, hwRedStartQueueLen=hwRedStartQueueLen, hwDscpMapEntry=hwDscpMapEntry, hwStatisticCountClear=hwStatisticCountClear, hwExpMapDropPrecedence=hwExpMapDropPrecedence, hwCosToDscpMapCosIndex=hwCosToDscpMapCosIndex, hwPortWredQueueID=hwPortWredQueueID, hwMirroringGroupReflectorIfIndex=hwMirroringGroupReflectorIfIndex, hwMirroringGroupReflectorEntry=hwMirroringGroupReflectorEntry, hwBandwidthWeight=hwBandwidthWeight, hwWredGreenMaxProb=hwWredGreenMaxProb, hwRedirectRemarkedPri=hwRedirectRemarkedPri, hwRedirectUserAclNum=hwRedirectUserAclNum, hwMirroringGroupMonitorType=hwMirroringGroupMonitorType, hwPortTrustOvercastType=hwPortTrustOvercastType, hwDscpToCosMapReset=hwDscpToCosMapReset, hwQueueWeight5=hwQueueWeight5, hwMirroringGroupMonitorEntry=hwMirroringGroupMonitorEntry, hwRedirectLinkAclRule=hwRedirectLinkAclRule, hwCosToDropPrecedenceMapTable=hwCosToDropPrecedenceMapTable, hwDscpMapDscpIndex=hwDscpMapDscpIndex, hwRedirectToNextHop1=hwRedirectToNextHop1, hwPortTrustTrustType=hwPortTrustTrustType, hwFlowtempIcmpCode=hwFlowtempIcmpCode, hwDscpToDropPreMapEntry=hwDscpToDropPreMapEntry, hwRemarkVlanIDRemarkVlanID=hwRemarkVlanIDRemarkVlanID, hwCosToLocalPrecedenceMapLocalPrecedenceValue=hwCosToLocalPrecedenceMapLocalPrecedenceValue, hwWredTable=hwWredTable, hwRedirectVlanID=hwRedirectVlanID, hwDscpMapDscpValue=hwDscpMapDscpValue, hwRateLimitMeterStatState=hwRateLimitMeterStatState, hwRateLimitConformCos=hwRateLimitConformCos, hwLineRateIfIndex=hwLineRateIfIndex, hwRedirectUserAclRule=hwRedirectUserAclRule, hwStatisticUserAclNum=hwStatisticUserAclNum, hwDropModeTable=hwDropModeTable, hwRateLimitEntry=hwRateLimitEntry, hwWredYellowMinThreshold=hwWredYellowMinThreshold, hwRedirectMode=hwRedirectMode, hwDscpToLocalPreMapLocalPreVal=hwDscpToLocalPreMapLocalPreVal, hwRateLimitAclIndex=hwRateLimitAclIndex, hwRateLimitMeterStatByteXCount=hwRateLimitMeterStatByteXCount, hwPriorityIpPre=hwPriorityIpPre, hwMirroringGroupReflectorTable=hwMirroringGroupReflectorTable, hwBandwidthLinkAclNum=hwBandwidthLinkAclNum, hwDscpToCosMapEntry=hwDscpToCosMapEntry, hwDscpToDscpMapTable=hwDscpToDscpMapTable, hwFlowtempEnableEntry=hwFlowtempEnableEntry, hwLineRateValue=hwLineRateValue, hwMirroringGroupMirrorMacEntry=hwMirroringGroupMirrorMacEntry, hwLswQosMibObject=hwLswQosMibObject, hwBandwidthEntry=hwBandwidthEntry, hwExpMapCosValue=hwExpMapCosValue, hwQueueWeight4=hwQueueWeight4, hwDscpToLocalPreMapReset=hwDscpToLocalPreMapReset, hwWredGreenMinThreshold=hwWredGreenMinThreshold, hwExpMapEntry=hwExpMapEntry, hwRedirectToSlotNo=hwRedirectToSlotNo, hwRedirectRemarkedDSCP=hwRedirectRemarkedDSCP, hwDropModeWredIndex=hwDropModeWredIndex, hwCosToDscpMapReSet=hwCosToDscpMapReSet)
