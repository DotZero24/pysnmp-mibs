...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/h3c/HUAWEI-LswQos-MIB
...
if mibBuilder.loadTexts: hwLswQosAclMib.setOrganization('Hangzhou H3C Tech. Co., Ltd.')
...
mibBuilder.exportSymbols("HUAWEI-LswQos-MIB", hwPriorityLocalPre=hwPriorityLocalPre, hwBandwidthTable=hwBandwidthTable, hwMirrorUserAclNum=hwMirrorUserAclNum, hwRedirectToCpu=hwRedirectToCpu, hwFlowtempRowStatus=hwFlowtempRowStatus, hwFlowtempEnableFlowtempIndex=hwFlowtempEnableFlowtempIndex, hwRedDirection=hwRedDirection, hwTrafficShapeIfIndex=hwTrafficShapeIfIndex, hwPriorityTable=hwPriorityTable, hwFlowtempEnableTable=hwFlowtempEnableTable, hwQueueWeight3=hwQueueWeight3, hwPriorityPolicedServiceExp=hwPriorityPolicedServiceExp, hwMirrorGroupEntry=hwMirrorGroupEntry, hwDropModeEntry=hwDropModeEntry, hwRemarkVlanIDLinkAclNum=hwRemarkVlanIDLinkAclNum, hwLineRateRowStatus=hwLineRateRowStatus, hwMirrorIpAclRule=hwMirrorIpAclRule, hwPortMirrorTable=hwPortMirrorTable, hwRedirectLinkAclNum=hwRedirectLinkAclNum, hwRateLimitTargetRateMbps=hwRateLimitTargetRateMbps, hwRateLimitCIR=hwRateLimitCIR, hwPortWredEntry=hwPortWredEntry, hwPriorityVlanID=hwPriorityVlanID, hwFlowtempSMac=hwFlowtempSMac, hwStatisticCountClear=hwStatisticCountClear, hwPriorityPolicedServiceType=hwPriorityPolicedServiceType, hwRedirectRemarkedTos=hwRedirectRemarkedTos, hwRateLimitEBS=hwRateLimitEBS, hwMirroringGroupRprobeVlanID=hwMirroringGroupRprobeVlanID, hwRedirectToNextHop2=hwRedirectToNextHop2, hwMirrorEntry=hwMirrorEntry, hwMirroringGroupRprobeVlanRowStatus=hwMirroringGroupRprobeVlanRowStatus, hwMirroringGroupReflectorIfIndex=hwMirroringGroupReflectorIfIndex, hwWredYellowMaxThreshold=hwWredYellowMaxThreshold, hwFlowtempDMacMask=hwFlowtempDMacMask, hwRemarkVlanIDRowStatus=hwRemarkVlanIDRowStatus, hwPriorityTrustMode=hwPriorityTrustMode, hwDscpToDropPreMapReset=hwDscpToDropPreMapReset, hwRedTable=hwRedTable, hwPriorityRowStatus=hwPriorityRowStatus, hwPortMirrorDirection=hwPortMirrorDirection, hwPortMirrorRowStatus=hwPortMirrorRowStatus, hwWredRedMaxThreshold=hwWredRedMaxThreshold, hwDscpToLocalPreMapReset=hwDscpToLocalPreMapReset, hwPriorityCosFromIpPre=hwPriorityCosFromIpPre, hwQueueWeight6=hwQueueWeight6, hwPriorityDscp=hwPriorityDscp, hwPortQueueQueueID=hwPortQueueQueueID, hwPriorityUserAclRule=hwPriorityUserAclRule, hwMirrorToGroup=hwMirrorToGroup, hwPriorityLinkAclNum=hwPriorityLinkAclNum, hwRemarkVlanIDPacketType=hwRemarkVlanIDPacketType, hwRateLimitEntry=hwRateLimitEntry, hwStatisticIfIndex=hwStatisticIfIndex, hwStatisticRuntime=hwStatisticRuntime, hwMirroringGroupReflectorTable=hwMirroringGroupReflectorTable, hwLineRateDirection=hwLineRateDirection, hwMirrorGroupDirection=hwMirrorGroupDirection, hwBandwidthMaxGuaranteedWidth=hwBandwidthMaxGuaranteedWidth, hwDscpMapEntry=hwDscpMapEntry, hwRedStopQueueLen=hwRedStopQueueLen, hwMirroringGroupMirrorTable=hwMirroringGroupMirrorTable, hwRateLimitConformActionType=hwRateLimitConformActionType, hwQueueWeight2=hwQueueWeight2, hwRedIpAclNum=hwRedIpAclNum, hwRedirectDirection=hwRedirectDirection, hwPriorityPolicedServiceCos=hwPriorityPolicedServiceCos, hwRedirectTable=hwRedirectTable, hwRedRuntime=hwRedRuntime, hwBandwidthEntry=hwBandwidthEntry, hwFlowtempSMacMask=hwFlowtempSMacMask, hwDscpMapDscpValue=hwDscpMapDscpValue, hwDscpToDscpMapTable=hwDscpToDscpMapTable, hwMirroringGroupMirrorVlanEntry=hwMirroringGroupMirrorVlanEntry, hwRedAclIndex=hwRedAclIndex, hwFlowtempVpn=hwFlowtempVpn, hwMirrorTable=hwMirrorTable, hwPortTrustReset=hwPortTrustReset, hwRedEntry=hwRedEntry, hwRedirectToSlotNo=hwRedirectToSlotNo, hwWredYellowMaxProb=hwWredYellowMaxProb, hwMirroringGroupMirroMacStatus=hwMirroringGroupMirroMacStatus, hwDscpToDscpMapReset=hwDscpToDscpMapReset, hwLswQosAclMib=hwLswQosAclMib, hwFlowtempTcpFlag=hwFlowtempTcpFlag, hwRateLimitRuntime=hwRateLimitRuntime, hwQueueScheduleMode=hwQueueScheduleMode, hwRedirectMode=hwRedirectMode, hwDscpToDropPreMapDropPreVal=hwDscpToDropPreMapDropPreVal, hwMirroringGroupMirroVlanStatus=hwMirroringGroupMirroVlanStatus, hwFlowtempEnableIfIndex=hwFlowtempEnableIfIndex, hwWredGreenMinThreshold=hwWredGreenMinThreshold, hwPriorityCos=hwPriorityCos, hwDscpToLocalPreMapEntry=hwDscpToLocalPreMapEntry, hwWredGreenMaxProb=hwWredGreenMaxProb, hwRemarkVlanIDVlanID=hwRemarkVlanIDVlanID, hwStatisticPacketXCount=hwStatisticPacketXCount, hwPortWredQueueProbability=hwPortWredQueueProbability, hwMirroringGroupReflectorEntry=hwMirroringGroupReflectorEntry, hwRateLimitAclIndex=hwRateLimitAclIndex, hwFlowtempSIpMask=hwFlowtempSIpMask, hwMirroringGroupReflectorRowStatus=hwMirroringGroupReflectorRowStatus, hwMirrorUserAclRule=hwMirrorUserAclRule, hwMirroringGroupMirrorInTypeList=hwMirroringGroupMirrorInTypeList, hwFlowtempSPort=hwFlowtempSPort, hwMirrorToIfIndex=hwMirrorToIfIndex, hwExpMapDscpValue=hwExpMapDscpValue, hwCosToLocalPrecedenceMapCosIndex=hwCosToLocalPrecedenceMapCosIndex, hwRemarkVlanIDIpAclNum=hwRemarkVlanIDIpAclNum, hwMirroringGroupRprobeVlanEntry=hwMirroringGroupRprobeVlanEntry, hwFlowtempEnableEntry=hwFlowtempEnableEntry, hwRedirectToNestedVlanID=hwRedirectToNestedVlanID, hwLocalPrecedenceMapCosValue=hwLocalPrecedenceMapCosValue, hwRateLimitDirection=hwRateLimitDirection, hwMirrorRowStatus=hwMirrorRowStatus, hwRedRowStatus=hwRedRowStatus, hwMirrorGroupMonitorIfIndex=hwMirrorGroupMonitorIfIndex, hwMirroringGroupMirrorRowStatus=hwMirroringGroupMirrorRowStatus, hwTrafficShapeTable=hwTrafficShapeTable, hwMirroringGroupMirrorOutboundIfIndexList=hwMirroringGroupMirrorOutboundIfIndexList, hwMirroringGroupMirrorEntry=hwMirroringGroupMirrorEntry, hwMirroringGroupTable=hwMirroringGroupTable, HwMirrorOrMonitorType=HwMirrorOrMonitorType, hwBandwidthIpAclNum=hwBandwidthIpAclNum, hwFlowtempEthProtocol=hwFlowtempEthProtocol, hwWredEntry=hwWredEntry, hwDscpToLocalPreMapTable=hwDscpToLocalPreMapTable, hwStatisticAclIndex=hwStatisticAclIndex, hwTrafficShapeMaxRate=hwTrafficShapeMaxRate, hwRedirectIpAclNum=hwRedirectIpAclNum, hwStatisticEntry=hwStatisticEntry, hwWredIndex=hwWredIndex, hwRedirectUserAclRule=hwRedirectUserAclRule, hwPortTrustTrustType=hwPortTrustTrustType, hwFlowtempIndex=hwFlowtempIndex, hwQueueEntry=hwQueueEntry, hwCosToDropPrecedenceMapCosIndex=hwCosToDropPrecedenceMapCosIndex, hwMirroringGroupMirrorMacSeq=hwMirroringGroupMirrorMacSeq, hwStatisticDirection=hwStatisticDirection, hwMirrorLinkAclNum=hwMirrorLinkAclNum, hwStatisticUserAclRule=hwStatisticUserAclRule, hwBandwidthLinkAclRule=hwBandwidthLinkAclRule, hwMirrorGroupTable=hwMirrorGroupTable, hwQueueWeight1=hwQueueWeight1, hwMirroringGroupMonitorType=hwMirroringGroupMonitorType, hwFlowtempEnableVlanID=hwFlowtempEnableVlanID, hwRemarkVlanIDDirection=hwRemarkVlanIDDirection, hwPortQueueTable=hwPortQueueTable, hwQueueWeight8=hwQueueWeight8, hwStatisticUserAclNum=hwStatisticUserAclNum, hwRateLimitMeterStatState=hwRateLimitMeterStatState, hwDscpToDropPreMapTable=hwDscpToDropPreMapTable, hwRateLimitUserAclNum=hwRateLimitUserAclNum, hwRateLimitTargetRateKbps=hwRateLimitTargetRateKbps, hwMirrorMacVlanID=hwMirrorMacVlanID, hwWredQueueId=hwWredQueueId, hwStatisticLinkAclRule=hwStatisticLinkAclRule, hwCosToDropPrecedenceMapDropPrecedenceValue=hwCosToDropPrecedenceMapDropPrecedenceValue, hwMirrorLinkAclRule=hwMirrorLinkAclRule, hwMirroringGroupMonitorTable=hwMirroringGroupMonitorTable, hwRedirectRuntime=hwRedirectRuntime, hwRedVlanID=hwRedVlanID, hwFlowtempSIp=hwFlowtempSIp, hwExpMapExpIndex=hwExpMapExpIndex, hwFlowtempIcmpType=hwFlowtempIcmpType, hwDropModeTable=hwDropModeTable, hwPortMirrorIfIndex=hwPortMirrorIfIndex, hwRedirectAclIndex=hwRedirectAclIndex, hwRedirectVlanID=hwRedirectVlanID, hwDscpMapDscpIndex=hwDscpMapDscpIndex, hwRateLimitPeakRate=hwRateLimitPeakRate, hwQueueWeight4=hwQueueWeight4, hwMirrorIpAclNum=hwMirrorIpAclNum, hwBandwidthIpAclRule=hwBandwidthIpAclRule, hwPriorityIfIndex=hwPriorityIfIndex, hwRemarkVlanIDTable=hwRemarkVlanIDTable, hwMirrorGroupMirrorIfIndexList=hwMirrorGroupMirrorIfIndexList, hwQueueIfIndex=hwQueueIfIndex, hwRateLimitMeterStatByteXCount=hwRateLimitMeterStatByteXCount, hwMirrorToCpu=hwMirrorToCpu, hwMirroringGroupEntry=hwMirroringGroupEntry, hwLocalPrecedenceMapLocalPrecedenceIndex=hwLocalPrecedenceMapLocalPrecedenceIndex, hwRemarkVlanIDIpAclRule=hwRemarkVlanIDIpAclRule, hwMirrorAclIndex=hwMirrorAclIndex, hwQueueWeight5=hwQueueWeight5, hwStatisticIpAclRule=hwStatisticIpAclRule, hwPriorityRuntime=hwPriorityRuntime, hwCosToDscpMapEntry=hwCosToDscpMapEntry, hwMirroringGroupMirrorMacTable=hwMirroringGroupMirrorMacTable, hwLineRateIfIndex=hwLineRateIfIndex, hwExpMapLocalPrecedence=hwExpMapLocalPrecedence, hwRedirectUserAclNum=hwRedirectUserAclNum, hwRedirectTargetVlanID=hwRedirectTargetVlanID, hwFlowtempDIp=hwFlowtempDIp, hwMirroringGroupMirrorVlanDirection=hwMirroringGroupMirrorVlanDirection, hwDscpToDropPreMapEntry=hwDscpToDropPreMapEntry, hwMirroringGroupMirrorMacEntry=hwMirroringGroupMirrorMacEntry, hwRedirectToIfIndex=hwRedirectToIfIndex, hwBandwidthRuntime=hwBandwidthRuntime, hwMirrorRuntime=hwMirrorRuntime, hwPriorityDirection=hwPriorityDirection, hwDscpToCosMapEntry=hwDscpToCosMapEntry, hwRateLimitExceedCos=hwRateLimitExceedCos, hwQueueTable=hwQueueTable, hwMirrorGroupRowStatus=hwMirrorGroupRowStatus, hwMirroringGroupMirrorOutTypeList=hwMirroringGroupMirrorOutTypeList, hwRedirectToNextHop1=hwRedirectToNextHop1, hwWredRedMinThreshold=hwWredRedMinThreshold, hwExpMapTable=hwExpMapTable, hwRedIpAclRule=hwRedIpAclRule, hwPortTrustTable=hwPortTrustTable, hwRemarkVlanIDIfIndex=hwRemarkVlanIDIfIndex, hwLswQosMibObject=hwLswQosMibObject, hwMirroringGroupRowStatus=hwMirroringGroupRowStatus, hwPortWredTable=hwPortWredTable, hwFlowtempDscp=hwFlowtempDscp, hwRedirectRemarkedDSCP=hwRedirectRemarkedDSCP, hwRedLinkAclNum=hwRedLinkAclNum, hwDscpMapLocalPrecedence=hwDscpMapLocalPrecedence, hwDscpMapCosValue=hwDscpMapCosValue, hwMirrorIfIndex=hwMirrorIfIndex, hwFlowtempVlanId=hwFlowtempVlanId, hwRemarkVlanIDUserAclRule=hwRemarkVlanIDUserAclRule, hwBandwidthLinkAclNum=hwBandwidthLinkAclNum, hwRateLimitExceedDscp=hwRateLimitExceedDscp, hwRateLimitTable=hwRateLimitTable, hwDropModeWredIndex=hwDropModeWredIndex, hwRedirectIpAclRule=hwRedirectIpAclRule, hwExpMapCosValue=hwExpMapCosValue, hwLineRateValue=hwLineRateValue, hwDscpMapExpValue=hwDscpMapExpValue, hwDscpMapConformLevel=hwDscpMapConformLevel, hwLocalPrecedenceMapConformLevel=hwLocalPrecedenceMapConformLevel, hwPriorityIpPre=hwPriorityIpPre, hwBandwidthWeight=hwBandwidthWeight, hwRemarkVlanIDRemarkVlanID=hwRemarkVlanIDRemarkVlanID, hwMirroringGroupType=hwMirroringGroupType, hwCosToLocalPrecedenceMapEntry=hwCosToLocalPrecedenceMapEntry, hwLineRateEntry=hwLineRateEntry, PYSNMP_MODULE_ID=hwLswQosAclMib, hwCosToDscpMapCosIndex=hwCosToDscpMapCosIndex, hwFlowtempTable=hwFlowtempTable, hwWredGreenMaxThreshold=hwWredGreenMaxThreshold, hwTrafficShapeQueueId=hwTrafficShapeQueueId, hwDscpToCosMapTable=hwDscpToCosMapTable, hwBandwidthVlanID=hwBandwidthVlanID, hwBandwidthIfIndex=hwBandwidthIfIndex, hwPriorityUserAclNum=hwPriorityUserAclNum, hwFlowtempTos=hwFlowtempTos, hwFlowtempIcmpCode=hwFlowtempIcmpCode, hwFlowtempDPort=hwFlowtempDPort, hwDscpToCosMapReset=hwDscpToCosMapReset, hwPortTrustOvercastType=hwPortTrustOvercastType, hwDscpToLocalPreMapDscpIndex=hwDscpToLocalPreMapDscpIndex)
mibBuilder.exportSymbols("HUAWEI-LswQos-MIB", hwFlowtempCos=hwFlowtempCos, hwDscpToCosMapCosValue=hwDscpToCosMapCosValue, hwExpMapEntry=hwExpMapEntry, hwPriorityAclIndex=hwPriorityAclIndex, hwMirroringGroupMonitorRowStatus=hwMirroringGroupMonitorRowStatus, hwBandwidthMinGuaranteedWidth=hwBandwidthMinGuaranteedWidth, hwDropModeMode=hwDropModeMode, hwRemarkVlanIDAclIndex=hwRemarkVlanIDAclIndex, hwPriorityIpAclRule=hwPriorityIpAclRule, hwStatisticTable=hwStatisticTable, hwMirrorGroupID=hwMirrorGroupID, hwMirroringGroupMonitorEntry=hwMirroringGroupMonitorEntry, hwRateLimitLinkAclRule=hwRateLimitLinkAclRule, hwPortQueueWeight=hwPortQueueWeight, hwLocalPrecedenceMapTable=hwLocalPrecedenceMapTable, hwPortQueueIfIndex=hwPortQueueIfIndex, hwRateLimitVlanID=hwRateLimitVlanID, hwCosToDropPrecedenceMapEntry=hwCosToDropPrecedenceMapEntry, hwPortTrustEntry=hwPortTrustEntry, hwMirroringGroupMonitorIfIndex=hwMirroringGroupMonitorIfIndex, hwRemarkVlanIDEntry=hwRemarkVlanIDEntry, hwFlowtempDMac=hwFlowtempDMac, hwCosToDscpMapTable=hwCosToDscpMapTable, hwBandwidthDirection=hwBandwidthDirection, hwRateLimitMeterStatByteCount=hwRateLimitMeterStatByteCount, hwFlowtempEntry=hwFlowtempEntry, hwRedIfIndex=hwRedIfIndex, hwPriorityPolicedServiceDropPriority=hwPriorityPolicedServiceDropPriority, hwTrafficShapeEntry=hwTrafficShapeEntry, hwDropModeIfIndex=hwDropModeIfIndex, hwRateLimitIpAclNum=hwRateLimitIpAclNum, hwExpMapConformLevel=hwExpMapConformLevel, hwDscpToDscpMapDscpValue=hwDscpToDscpMapDscpValue, hwStatisticByteXCount=hwStatisticByteXCount, hwStatisticRowStatus=hwStatisticRowStatus, hwPortWredIfIndex=hwPortWredIfIndex, hwMirroringGroupRprobeVlanTable=hwMirroringGroupRprobeVlanTable, hwLineRateTable=hwLineRateTable, hwFlowtempIpPre=hwFlowtempIpPre, hwRateLimitRowStatus=hwRateLimitRowStatus, hwTrafficShapeRowStatus=hwTrafficShapeRowStatus, hwFlowtempDIpMask=hwFlowtempDIpMask, hwCosToLocalPrecedenceMapLocalPrecedenceValue=hwCosToLocalPrecedenceMapLocalPrecedenceValue, hwRateLimitConformCos=hwRateLimitConformCos, hwRateLimitIfIndex=hwRateLimitIfIndex, hwMirrorDirection=hwMirrorDirection, hwRedProbability=hwRedProbability, hwPortMonitorBothIfIndex=hwPortMonitorBothIfIndex, hwPortWredQueueStartLength=hwPortWredQueueStartLength, hwPriorityIpPreFromCos=hwPriorityIpPreFromCos, hwMirroringGroupMirrorVlanTable=hwMirroringGroupMirrorVlanTable, hwMirroringGroupStatus=hwMirroringGroupStatus, hwWredRedMaxProb=hwWredRedMaxProb, hwRedLinkAclRule=hwRedLinkAclRule, hwRedirectIfIndex=hwRedirectIfIndex, hwDscpMapTable=hwDscpMapTable, hwPortWredQueueID=hwPortWredQueueID, hwPriorityPolicedServiceDscp=hwPriorityPolicedServiceDscp, hwRedirectEntry=hwRedirectEntry, hwRateLimitIpAclRule=hwRateLimitIpAclRule, hwMirroringGroupID=hwMirroringGroupID, hwRedirectRowStatus=hwRedirectRowStatus, hwWredExponent=hwWredExponent, hwStatisticVlanID=hwStatisticVlanID, hwRateLimitConformDscp=hwRateLimitConformDscp, hwPortMirrorEntry=hwPortMirrorEntry, hwTrafficShapeBufferLimit=hwTrafficShapeBufferLimit, hwLocalPrecedenceMapEntry=hwLocalPrecedenceMapEntry, hwCosToDscpMapDscpValue=hwCosToDscpMapDscpValue, hwRedirectToNextHop3=hwRedirectToNextHop3, hwRemarkVlanIDLinkAclRule=hwRemarkVlanIDLinkAclRule, hwStatisticIpAclNum=hwStatisticIpAclNum, hwRedirectLinkAclRule=hwRedirectLinkAclRule, hwPriorityLinkAclRule=hwPriorityLinkAclRule, hwRateLimitPIR=hwRateLimitPIR, hwDscpToCosMapDscpIndex=hwDscpToCosMapDscpIndex, hwRemarkVlanIDUserAclNum=hwRemarkVlanIDUserAclNum, hwExpMapDropPrecedence=hwExpMapDropPrecedence, hwCosToDropPrecedenceMapTable=hwCosToDropPrecedenceMapTable, hwRateLimitExceedActionType=hwRateLimitExceedActionType, hwFlowtempFragment=hwFlowtempFragment, hwPriorityIpAclNum=hwPriorityIpAclNum, hwStatisticPacketCount=hwStatisticPacketCount, hwDscpMapDropPrecedence=hwDscpMapDropPrecedence, hwPriorityPolicedServiceLoaclPre=hwPriorityPolicedServiceLoaclPre, hwWredYellowMinThreshold=hwWredYellowMinThreshold, hwPortQueueWrrPriority=hwPortQueueWrrPriority, hwQueueWeight7=hwQueueWeight7, hwTrafficShapeBurstSize=hwTrafficShapeBurstSize, hwDscpToDropPreMapDscpIndex=hwDscpToDropPreMapDscpIndex, hwBandwidthAclIndex=hwBandwidthAclIndex, hwRedirectToModifiedVlanID=hwRedirectToModifiedVlanID, hwPortTrustIfIndex=hwPortTrustIfIndex, hwFlowtempIpProtocol=hwFlowtempIpProtocol, hwRateLimitConformLocalPre=hwRateLimitConformLocalPre, hwDscpToDscpMapEntry=hwDscpToDscpMapEntry, hwRateLimitCBS=hwRateLimitCBS, hwRedirectRemarkedPri=hwRedirectRemarkedPri, hwMirroringGroupMirrorMac=hwMirroringGroupMirrorMac, hwCosToDscpMapReSet=hwCosToDscpMapReSet, hwRateLimitLinkAclNum=hwRateLimitLinkAclNum, hwPortQueueEntry=hwPortQueueEntry, hwMirroringGroupMirrorVlanID=hwMirroringGroupMirrorVlanID, hwRateLimitUserAclRule=hwRateLimitUserAclRule, hwCosToLocalPrecedenceMapTable=hwCosToLocalPrecedenceMapTable, hwRedStartQueueLen=hwRedStartQueueLen, hwWredTable=hwWredTable, hwQueueMaxDelay=hwQueueMaxDelay, hwDscpToLocalPreMapLocalPreVal=hwDscpToLocalPreMapLocalPreVal, hwBandwidthRowStatus=hwBandwidthRowStatus, hwMirroringGroupMirrorVlanSeq=hwMirroringGroupMirrorVlanSeq, hwPriorityEntry=hwPriorityEntry, hwMirrorVlanID=hwMirrorVlanID, hwDscpToDscpMapDscpIndex=hwDscpToDscpMapDscpIndex, hwStatisticByteCount=hwStatisticByteCount, hwStatisticLinkAclNum=hwStatisticLinkAclNum, hwMirroringGroupMirrorInboundIfIndexList=hwMirroringGroupMirrorInboundIfIndexList, hwExpMapExpValue=hwExpMapExpValue)
