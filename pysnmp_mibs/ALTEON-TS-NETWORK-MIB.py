...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/nortel/ALTEON-TS-NETWORK-MIB
...
operCmds, information, stats = mibBuilder.importSymbols("ALTEON-TIGON-SWITCH-MIB", "operCmds", "information", "stats")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaIntfBackup=ospfAreaIntfBackup, arpInfoEntry=arpInfoEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routerLSAId=routerLSAId, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIfWaitInterval=ospfIfWaitInterval, ipRouteInfoTag=ipRouteInfoTag, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrp_info=vrrp_info, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxHello=ospfCumTxHello, ospfArea=ospfArea, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgState=ipFwdNewCfgState, vrrpStats=vrrpStats, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routeStatMaxEntries=routeStatMaxEntries, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfinfo=ospfinfo, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrp=vrrp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrChange=ospfIntfNbrChange, routeStats=routeStats, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipRouteInfoType=ipRouteInfoType, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrDown=ospfAreaNbrDown, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfUnloop=ospfIntfUnloop, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfDown=ospfIntfDown, routerLSALinkData=routerLSALinkData, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfLsTypesSupported=ospfLsTypesSupported, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpStats=arpStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripStatInPkts=ripStatInPkts, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCfg=ospfCfg, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipGatewayTableMax=ipGatewayTableMax, dnsStats=dnsStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumRxHello=ospfCumRxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfInterface=ospfInterface, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgState=ripCurCfgState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgDefListen=ripNewCfgDefListen, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpGeneral=vrrpGeneral, ipRouteInfoMask=ipRouteInfoMask, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfStats=ospfStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routeStatHighWater=routeStatHighWater, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfBackup=ospfIntfBackup, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumRxPkts=ospfCumRxPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfStartTime=ospfStartTime, ripStats=ripStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfLoop=ospfIntfLoop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfIndex=ospfIntfIndex, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpStatMaxEntries=arpStatMaxEntries, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfTxHello=ospfIntfTxHello, ripConfig=ripConfig, ospfCumIntfChangeStats=ospfCumIntfChangeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNbrInExchState=ospfNbrInExchState, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumIntfDown=ospfCumIntfDown, arpStatHighWater=arpStatHighWater, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ip_info=ip_info, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgVip=ripCurCfgVip, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, iprouting=iprouting, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumTxDatabase=ospfCumTxDatabase, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgIntfState=ipNewCfgIntfState, arpStatEntries=arpStatEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgListen=ripNewCfgListen, routerLSALinkID=routerLSALinkID, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrDown=ospfCumNbrDown, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpOper=vrrpOper, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgVip=ripNewCfgVip, ripStatOutPkts=ripStatOutPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfGeneral=ospfGeneral, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfHello=ospfIntfHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, routeStatEntries=routeStatEntries, ipForward=ipForward, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgBootpState=ipNewCfgBootpState, arpInfoTable=arpInfoTable, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgListen=ripCurCfgListen, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr)
