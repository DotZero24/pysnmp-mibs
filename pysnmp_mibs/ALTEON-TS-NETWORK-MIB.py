...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoVLAN=arpInfoVLAN, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripCurCfgState=ripCurCfgState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTotalAreas=ospfTotalAreas, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNbrInInitState=ospfNbrInInitState, arpInfoTable=arpInfoTable, arpInfoFlag=arpInfoFlag, ipCurCfgBootpAddr=ipCurCfgBootpAddr, routerLSAId=routerLSAId, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTotalTransitAreas=ospfTotalTransitAreas, routeStatHighWater=routeStatHighWater, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoTag=ipRouteInfoTag, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrN1way=ospfCumNbrN1way, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumNbrhello=ospfCumNbrhello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpStats=vrrpStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpStatHighWater=arpStatHighWater, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfArea=ospfArea, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfInterface=ospfInterface, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ip_info=ip_info, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfStartTime=ospfStartTime, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpStats=arpStats, ospfAreaTxHello=ospfAreaTxHello, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrp_info=vrrp_info, routeStatEntries=routeStatEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfUnloop=ospfIntfUnloop, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfLsTypesSupported=ospfLsTypesSupported, iprouting=iprouting, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgState=ripNewCfgState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgListen=ripCurCfgListen, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfLoop=ospfIntfLoop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgListen=ripNewCfgListen, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumIntfLoop=ospfCumIntfLoop, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripStats=ripStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpInfoEntry=arpInfoEntry, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgGwEntry=ipCurCfgGwEntry, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrChange=ospfIntfNbrChange, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwState=ipNewCfgGwState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgBootpState=ipCurCfgBootpState, routeStats=routeStats, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxHello=ospfCumTxHello, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipForward=ipForward, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfDown=ospfIntfDown, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrp=vrrp, ospfCfg=ospfCfg, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwArp=ipNewCfgGwArp, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpOper=vrrpOper, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaInfoTable=ospfAreaInfoTable, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipInterfaceTableMax=ipInterfaceTableMax, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStatEntries=arpStatEntries, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfStats=ospfStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumRxPkts=ospfCumRxPkts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, dnsStats=dnsStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfGeneral=ospfGeneral, ospfIntfNbrStart=ospfIntfNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripStatOutPkts=ripStatOutPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripStatInPkts=ripStatInPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfinfo=ospfinfo, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfIndex=ospfIntfIndex, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState)
