...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-RADIUS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:16:52 2025
...
rbnRadiusCompliance.setObjects(
      *(("RBN-RADIUS-MIB", "rbnRadiusAuthGroup"),
        ("RBN-RADIUS-MIB", "rbnRadiusAcctGroup"),
        ("RBN-RADIUS-MIB", "rbnRadiusNotifyGroup"),
        ("RBN-RADIUS-MIB", "rbnRadiusAuthNotifyGroup"),
        ("RBN-RADIUS-MIB", "rbnRadiusAcctNotifyGroup"))
)
if mibBuilder.loadTexts:
...
rbnRadiusCompliance2.setObjects(
      *(("RBN-RADIUS-MIB", "rbnRadiusAuthGroup2"),
        ("RBN-RADIUS-MIB", "rbnRadiusAcctGroup2"),
        ("RBN-RADIUS-MIB", "rbnRadiusNotifyGroup"),
        ("RBN-RADIUS-MIB", "rbnRadiusAuthNotifyGroup"),
        ("RBN-RADIUS-MIB", "rbnRadiusAcctNotifyGroup"))
)
