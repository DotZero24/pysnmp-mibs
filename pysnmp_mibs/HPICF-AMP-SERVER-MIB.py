...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPICF-AMP-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:39:24 2025
...
hpicfAMPServerRetryInterval = _HpicfAMPServerRetryInterval_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 125, 1, 7),
    _HpicfAMPServerRetryInterval_Type()
)
hpicfAMPServerRetryInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfAMPServerRetryInterval.setStatus("current")
if mibBuilder.loadTexts:
    hpicfAMPServerRetryInterval.setUnits("Seconds")
...
hpicfAMPServerConfigGroup.setObjects(
      *(("HPICF-AMP-SERVER-MIB", "hpicfAMPServerIP"),
        ...
        ("HPICF-AMP-SERVER-MIB", "hpicfAMPServerRetryInterval"))
)
if mibBuilder.loadTexts:
...
hpicfAMPServerMIBCompliance.setObjects(
      *(("HPICF-AMP-SERVER-MIB", "hpicfAMPServerConfigGroup"),
        ("HPICF-AMP-SERVER-MIB", "hpicfArubaVPNConfigGroup"))
)
if mibBuilder.loadTexts:
...
hpicfAMPServerMIBCompliance1.setObjects(
      *(("HPICF-AMP-SERVER-MIB", "hpicfAMPServerConfigGroup"),
        ("HPICF-AMP-SERVER-MIB", "hpicfArubaVPNConfigGroup"),
        ("HPICF-AMP-SERVER-MIB", "hpicfDefaultGatewayGroup"))
)
if mibBuilder.loadTexts:
...
hpicfAMPServerMIBCompliance2.setObjects(
      *(("HPICF-AMP-SERVER-MIB", "hpicfAMPServerConfigGroup"),
        ("HPICF-AMP-SERVER-MIB", "hpicfArubaVPNConfigGroup1"),
        ("HPICF-AMP-SERVER-MIB", "hpicfDefaultGatewayGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"HpicfArubaVPNType": HpicfArubaVPNType,
       ...
       "hpicfAMPServerRetryInterval": hpicfAMPServerRetryInterval,
