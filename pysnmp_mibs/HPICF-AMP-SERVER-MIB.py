...
mibBuilder.exportSymbols("HPICF-AMP-SERVER-MIB", hpicfAMPServerRetryInterval=hpicfAMPServerRetryInterval, hpicfArubaVPNTtl=hpicfArubaVPNTtl, hpicfArubaVPNObjects=hpicfArubaVPNObjects, hpicfAMPServerObjects=hpicfAMPServerObjects, hpicfAMPServerConfigStatus=hpicfAMPServerConfigStatus, hpicfArubaVPNEntry=hpicfArubaVPNEntry, hpicfAMPServerConfigGroup=hpicfAMPServerConfigGroup, PYSNMP_MODULE_ID=hpicfAMPServerMIB, hpicfArubaVPNTos=hpicfArubaVPNTos, hpicfAMPServerIP=hpicfAMPServerIP, hpicfAMPServerFolder=hpicfAMPServerFolder, hpicfArubaVPNBkpIPType=hpicfArubaVPNBkpIPType, hpicfAMPServerSecret=hpicfAMPServerSecret, hpicfArubaVPNIndex=hpicfArubaVPNIndex, hpicfArubaVPNGateway=hpicfArubaVPNGateway, hpicfArubaVPNConfigGroup1=hpicfArubaVPNConfigGroup1, hpicfDefaultGatewayGroup=hpicfDefaultGatewayGroup, hpicfAMPServerGroup=hpicfAMPServerGroup, hpicfAMPServerMIB=hpicfAMPServerMIB, hpicfAMPServerIPType=hpicfAMPServerIPType, hpicfAMPServerMIBCompliance1=hpicfAMPServerMIBCompliance1, hpicfArubaVPNConfigGroup=hpicfArubaVPNConfigGroup, hpicfArubaVPNRowStatus=hpicfArubaVPNRowStatus, HpicfArubaVPNType=HpicfArubaVPNType, hpicfArubaVPNBkpIP=hpicfArubaVPNBkpIP, hpicfArubaVPNDefaultGateway=hpicfArubaVPNDefaultGateway, hpicfAMPServerMIBCompliances=hpicfAMPServerMIBCompliances, hpicfAMPServerConformance=hpicfAMPServerConformance, hpicfAMPServerMIBCompliance2=hpicfAMPServerMIBCompliance2, hpicfArubaVPNIPType=hpicfArubaVPNIPType, hpicfAMPServerMIBGroups=hpicfAMPServerMIBGroups, hpicfAMPServerMIBCompliance=hpicfAMPServerMIBCompliance, hpicfArubaVPNTable=hpicfArubaVPNTable, hpicfArubaVPNIP=hpicfArubaVPNIP)
