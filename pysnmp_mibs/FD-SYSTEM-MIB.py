...
DeviceStatus, epon, DeviceOperation, DeviceType, LedStatus = mibBuilder.importSymbols("EPON-EOC-MIB", "DeviceStatus", "epon", "DeviceOperation", "DeviceType", "LedStatus")
...
mibBuilder.exportSymbols("FD-SYSTEM-MIB", sysCfgRestoreFilename=sysCfgRestoreFilename, onuAuthLoidCfgEntry=onuAuthLoidCfgEntry, loginTimeout=loginTimeout, sysCfgRestoreServer=sysCfgRestoreServer, systemInfo=systemInfo, sysCfgBackupServer=sysCfgBackupServer, ponCardUpgradeStat=ponCardUpgradeStat, ftpServerUserName=ftpServerUserName, ponCardTable=ponCardTable, userPermission=userPermission, trapDstIpAddr1=trapDstIpAddr1, oltId=oltId, sysOperate=sysOperate, sysLogLevel=sysLogLevel, sysLogEntry=sysLogEntry, nonAuthOnuMac=nonAuthOnuMac, cfgAutoBackup=cfgAutoBackup, endMacAddr=endMacAddr, onuAuthMacRowStatus=onuAuthMacRowStatus, authLoidEntryId=authLoidEntryId, cardModuleGroup=cardModuleGroup, outbandIpAddr=outbandIpAddr, consolePortSpd=consolePortSpd, systemUpgradeGroup=systemUpgradeGroup, ftpOperFileName=ftpOperFileName, ponCardRunningStatus=ponCardRunningStatus, fdSystemCompliance=fdSystemCompliance, sysCfgRestoreType=sysCfgRestoreType, sysBaseInfo=sysBaseInfo, trapDstIpAddr3=trapDstIpAddr3, sysBaseManageGroup=sysBaseManageGroup, ponCardHwRev=ponCardHwRev, mainCard=mainCard, snmpReadCommunity=snmpReadCommunity, chassisTemperature=chassisTemperature, onuAuthWhitelistMacAddr=onuAuthWhitelistMacAddr, chassisInfoGroup=chassisInfoGroup, onuAuth=onuAuth, userManage=userManage, authMethodV2=authMethodV2, ponCardFwVer=ponCardFwVer, nonAuthOper=nonAuthOper, date=date, fdSystemCompliances=fdSystemCompliances, sysAlarmDesc=sysAlarmDesc, userPassword=userPassword, sysConfig=sysConfig, upgradeOperation=upgradeOperation, sysAutoBackupType=sysAutoBackupType, chassisInfo=chassisInfo, cfgRestore=cfgRestore, ponCardEntry=ponCardEntry, onuAuthLoidCfgTable=onuAuthLoidCfgTable, mainCardRunningStatus=mainCardRunningStatus, sysCpuUtilization=sysCpuUtilization, onuAuthLoidStrings=onuAuthLoidStrings, mainCardSWVersion=mainCardSWVersion, userEntryRowStatus=userEntryRowStatus, PYSNMP_MODULE_ID=systemInfo, sysAutoBackupEnable=sysAutoBackupEnable, authMacEntryId=authMacEntryId, ponCard=ponCard, onuAuthBlacklistMacCfgEntry=onuAuthBlacklistMacCfgEntry, onuAuthWhitelistMacCfgEntry=onuAuthWhitelistMacCfgEntry, onuAuthLoidCfgRowStatus=onuAuthLoidCfgRowStatus, userName=userName, onuAuthPasswordStrings=onuAuthPasswordStrings, userAccessDeviceMap=userAccessDeviceMap, manageGateway=manageGateway, mainCardOperate=mainCardOperate, powerStatusBit=powerStatusBit, macAttr=macAttr, onuAuthWhitelistMacCfgTable=onuAuthWhitelistMacCfgTable, fanStatusBit=fanStatusBit, nonAuthOnuListEntry=nonAuthOnuListEntry, onuAuthWhitelistMacCfgRowStatus=onuAuthWhitelistMacCfgRowStatus, trapDstIpAddr4=trapDstIpAddr4, onuAuthMacCfgTable=onuAuthMacCfgTable, onuAuthMacCfgEntry=onuAuthMacCfgEntry, mainCardFactorySerial=mainCardFactorySerial, onuAuthGroup=onuAuthGroup, sysMajAlarmLed=sysMajAlarmLed, sysContact=sysContact, authMethod=authMethod, mainCardHWRevision=mainCardHWRevision, sysCfgBackupType=sysCfgBackupType, cardModule=cardModule, sysAutoBackupInterval=sysAutoBackupInterval, sysLogTable=sysLogTable, sysDesc=sysDesc, authBlacklistMacEntryId=authBlacklistMacEntryId, authWhitelistMacEntryId=authWhitelistMacEntryId, dwLoadFileCrcValue=dwLoadFileCrcValue, userManageEntry=userManageEntry, fdSystemGroups=fdSystemGroups, mainCardRunningTime=mainCardRunningTime, outbandNetMask=outbandNetMask, ponCardType=ponCardType, mainCardType=mainCardType, ftpProgress=ftpProgress, ftpOperTarget=ftpOperTarget, chassisRevision=chassisRevision, ftpServerIp=ftpServerIp, chassisType=chassisType, upgrade=upgrade, chassisFactorySerial=chassisFactorySerial, onuAuthBlacklistMacAddr=onuAuthBlacklistMacAddr, sysCriAlarmLed=sysCriAlarmLed, ponCardOperate=ponCardOperate, sysLog=sysLog, trapDstIpAddr2=trapDstIpAddr2, operDeviceMap=operDeviceMap, onuAuthBlacklistMacCfgRowStatus=onuAuthBlacklistMacCfgRowStatus, manageIpAddr=manageIpAddr, sysMTU=sysMTU, sysLocation=sysLocation, sysConfigurations=sysConfigurations, userId=userId, sysLogEntryIndex=sysLogEntryIndex, ponCardSlotId=ponCardSlotId, userManageTable=userManageTable, beginMacAddr=beginMacAddr, ftpServerUserPasswd=ftpServerUserPasswd, sysAutoBackupServer=sysAutoBackupServer, nonAuthOnuListTable=nonAuthOnuListTable, manageNetMask=manageNetMask, nonAuthOnuTries=nonAuthOnuTries, nonAuthOnuMacIndex=nonAuthOnuMacIndex, fdSysConformance=fdSysConformance, cfgBackup=cfgBackup, upgradeStatus=upgradeStatus, sysModel=sysModel, dwLoadFileCrcCheck=dwLoadFileCrcCheck, ponCardFactorySerial=ponCardFactorySerial, snmpRWCommunity=snmpRWCommunity, onuAuthBlacklistMacCfgTable=onuAuthBlacklistMacCfgTable, ponCardRuningTime=ponCardRuningTime, sysLogEntryEnable=sysLogEntryEnable, userManageGroup=userManageGroup)
