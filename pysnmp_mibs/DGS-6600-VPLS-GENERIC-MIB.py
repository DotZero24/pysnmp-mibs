# SNMP MIB module (DGS-6600-VPLS-GENERIC-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DGS-6600-VPLS-GENERIC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:48:52 2025
...
(dgs6600_mpls,) = mibBuilder.importSymbols(
    "DGS-6600-ID-MIB",
    "dgs6600-mpls")
...
dgs6600VplsGenericMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1)
)
if mibBuilder.loadTexts:
    dgs6600VplsGenericMIB.setRevisions(
        ("2012-09-29 12:00",
         "2006-06-04 12:00")
    )
...
vplsConfigIndex = _VplsConfigIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 1),
...
vplsConfigName = _VplsConfigName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 2),
...
vplsConfigDescr = _VplsConfigDescr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 3),
...
vplsConfigAdminStatus = _VplsConfigAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 4),
...
vplsConfigMacLearning = _VplsConfigMacLearning_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 6),
...
vplsConfigDiscardUnknownDest = _VplsConfigDiscardUnknownDest_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 7),
...
vplsConfigMacAging = _VplsConfigMacAging_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 8),
...
vplsConfigFwdFullHighWatermark = _VplsConfigFwdFullHighWatermark_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 10),
...
vplsConfigFwdFullLowWatermark = _VplsConfigFwdFullLowWatermark_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 11),
...
vplsConfigRowStatus = _VplsConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 12),
...
vplsConfigMtu = _VplsConfigMtu_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 13),
    _VplsConfigMtu_Type()
)
...
vplsConfigVpnId = _VplsConfigVpnId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 14),
...
vplsConfigStorageType = _VplsConfigStorageType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 2, 1, 15),
...
vplsStatusOperStatus = _VplsStatusOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 3, 1, 1),
...
vplsStatusPeerCount = _VplsStatusPeerCount_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 3, 1, 2),
...
vplsPwBindConfigType = _VplsPwBindConfigType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 4, 1, 1),
...
vplsPwBindType = _VplsPwBindType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 4, 1, 2),
...
vplsPwBindRowStatus = _VplsPwBindRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 4, 1, 3),
...
vplsPwBindStorageType = _VplsPwBindStorageType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 4, 1, 4),
...
vplsBgpADConfigTable = _VplsBgpADConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 5)
)
if mibBuilder.loadTexts:
...
vplsBgpADConfigEntry = _VplsBgpADConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 5, 1)
)
...
vplsBgpADConfigRouteDistinguisher = _VplsBgpADConfigRouteDistinguisher_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 5, 1, 1),
...
vplsBgpADConfigPrefix = _VplsBgpADConfigPrefix_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 5, 1, 2),
...
vplsBgpADConfigVplsId = _VplsBgpADConfigVplsId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 5, 1, 3),
...
vplsBgpADConfigRowStatus = _VplsBgpADConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 5, 1, 4),
...
vplsStatusNotifEnable = _VplsStatusNotifEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 7),
...
vplsNotificationMaxRate = _VplsNotificationMaxRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 1, 8),
...
vplsConformance = _VplsConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 2)
)
_VplsCompliances_ObjectIdentity = ObjectIdentity
vplsCompliances = _VplsCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 2, 1)
)
_VplsGroups_ObjectIdentity = ObjectIdentity
vplsGroups = _VplsGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 2, 2)
)

# Managed Objects groups

vplsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 2, 2, 1)
)
vplsGroup.setObjects(
      *(("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigName"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigDescr"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigAdminStatus"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigMacLearning"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigDiscardUnknownDest"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigMacAging"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigVpnId"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigFwdFullHighWatermark"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigFwdFullLowWatermark"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigRowStatus"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigIndexNext"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigMtu"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsConfigStorageType"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsStatusOperStatus"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsStatusPeerCount"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsStatusNotifEnable"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsNotificationMaxRate"))
)
if mibBuilder.loadTexts:
    vplsGroup.setStatus("current")

vplsPwBindGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 2, 2, 2)
)
vplsPwBindGroup.setObjects(
      *(("DGS-6600-VPLS-GENERIC-MIB", "vplsPwBindConfigType"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsPwBindType"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsPwBindRowStatus"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsPwBindStorageType"))
)
if mibBuilder.loadTexts:
...
vplsStatusChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 0, 1)
)
...
vplsFwdFullAlarmRaised = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 0, 2)
)
...
vplsFwdFullAlarmCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 0, 3)
)
...
vplsNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 2, 2, 3)
)
vplsNotificationGroup.setObjects(
      *(("DGS-6600-VPLS-GENERIC-MIB", "vplsStatusChanged"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsFwdFullAlarmRaised"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsFwdFullAlarmCleared"))
)
if mibBuilder.loadTexts:
...
vplsModuleFullCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 2, 1, 1)
)
vplsModuleFullCompliance.setObjects(
      *(("DGS-6600-VPLS-GENERIC-MIB", "vplsGroup"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsPwBindGroup"),
        ("DGS-6600-VPLS-GENERIC-MIB", "vplsNotificationGroup"))
)
if mibBuilder.loadTexts:
...
vplsModuleReadOnlyCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 4, 1, 2, 1, 2)
)
...
mibBuilder.exportSymbols(
    ...
    **{"VplsBgpRouteDistinguisher": VplsBgpRouteDistinguisher,
       ...
       "dgs6600VplsGenericMIB": dgs6600VplsGenericMIB,
