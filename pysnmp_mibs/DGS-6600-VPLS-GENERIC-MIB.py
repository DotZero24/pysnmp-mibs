...
mibBuilder.exportSymbols("DGS-6600-VPLS-GENERIC-MIB", vplsPwBindEntry=vplsPwBindEntry, vplsPwBindType=vplsPwBindType, vplsBgpADConfigVplsId=vplsBgpADConfigVplsId, vplsPwBindTable=vplsPwBindTable, vplsStatusPeerCount=vplsStatusPeerCount, vplsBgpADConfigPrefix=vplsBgpADConfigPrefix, dgs6600VplsGenericMIB=dgs6600VplsGenericMIB, vplsPwBindConfigType=vplsPwBindConfigType, vplsConfigMtu=vplsConfigMtu, VplsBgpRouteDistinguisher=VplsBgpRouteDistinguisher, vplsConfigFwdFullLowWatermark=vplsConfigFwdFullLowWatermark, VplsBgpRouteTargetType=VplsBgpRouteTargetType, vplsCompliances=vplsCompliances, vplsConfigDescr=vplsConfigDescr, vplsNotificationMaxRate=vplsNotificationMaxRate, vplsStatusChanged=vplsStatusChanged, vplsConfigIndexNext=vplsConfigIndexNext, vplsConformance=vplsConformance, PYSNMP_MODULE_ID=dgs6600VplsGenericMIB, vplsConfigMacAging=vplsConfigMacAging, vplsFwdFullAlarmRaised=vplsFwdFullAlarmRaised, vplsStatusOperStatus=vplsStatusOperStatus, VplsBgpRouteTarget=VplsBgpRouteTarget, vplsConfigIndex=vplsConfigIndex, vplsBgpADConfigEntry=vplsBgpADConfigEntry, vplsConfigRowStatus=vplsConfigRowStatus, vplsStatusEntry=vplsStatusEntry, vplsStatusTable=vplsStatusTable, vplsConfigName=vplsConfigName, vplsFwdFullAlarmCleared=vplsFwdFullAlarmCleared, vplsStatusNotifEnable=vplsStatusNotifEnable, vplsConfigStorageType=vplsConfigStorageType, vplsPwBindRowStatus=vplsPwBindRowStatus, vplsModuleFullCompliance=vplsModuleFullCompliance, vplsPwBindStorageType=vplsPwBindStorageType, vplsGroup=vplsGroup, vplsConfigTable=vplsConfigTable, vplsConfigEntry=vplsConfigEntry, vplsPwBindGroup=vplsPwBindGroup, vplsGroups=vplsGroups, vplsConfigDiscardUnknownDest=vplsConfigDiscardUnknownDest, vplsConfigAdminStatus=vplsConfigAdminStatus, vplsConfigMacLearning=vplsConfigMacLearning, vplsConfigFwdFullHighWatermark=vplsConfigFwdFullHighWatermark, vplsBgpADConfigTable=vplsBgpADConfigTable, vplsNotificationGroup=vplsNotificationGroup, vplsBgpADConfigRouteDistinguisher=vplsBgpADConfigRouteDistinguisher, vplsConfigVpnId=vplsConfigVpnId, vplsModuleReadOnlyCompliance=vplsModuleReadOnlyCompliance, vplsNotifications=vplsNotifications, vplsObjects=vplsObjects, vplsBgpADConfigRowStatus=vplsBgpADConfigRowStatus)
