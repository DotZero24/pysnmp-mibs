...
mibBuilder.exportSymbols("CYCLADES-ACS-INFO-MIB", PYSNMP_MODULE_ID=cyACSInfo, cyISPortSigRI=cyISPortSigRI, cyisPortEntry=cyisPortEntry, cyISPortSigCTS=cyISPortSigCTS, cyISPortErrFrame=cyISPortErrFrame, cyISPortErrParity=cyISPortErrParity, cyISPortErrBreaks=cyISPortErrBreaks, cyISPortErrOverrun=cyISPortErrOverrun, cyISPortRXBytes=cyISPortRXBytes, cyISPortTty=cyISPortTty, cyISPortSigCD=cyISPortSigCD, cyISPortName=cyISPortName, cyISPortSigDTR=cyISPortSigDTR, cyISPortSpeed=cyISPortSpeed, cyISPortNumber=cyISPortNumber, cyInfoSerialTable=cyInfoSerialTable, cyISPortSigDSR=cyISPortSigDSR, cyISPortSigRTS=cyISPortSigRTS, cyISPortTxBytes=cyISPortTxBytes, cyACSInfo=cyACSInfo)
