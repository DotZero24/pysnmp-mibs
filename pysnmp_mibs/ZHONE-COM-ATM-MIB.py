...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:19:38 2025
...
atmVplReceiveTrafficDescrIndex, atmInterfaceDs3PlcpAlarmState, atmVplCastType, atmInterfaceTCEntry, atmVclReceiveTrafficDescrIndex, atmVclAdminStatus, atmVplRowStatus, atmVclVpi, atmVccAalType, atmVclTransmitTrafficDescrIndex, atmVclEntry, atmInterfaceTCAlarmState, atmVclCrossConnectIdentifier, atmVclConnKind, atmVccAal5EncapsType, atmVplEntry, atmVplCrossConnectIdentifier, atmVclOperStatus, atmVccAal5CpcsTransmitSduSize, atmVclRowStatus, atmTrafficDescrParamEntry, atmVclVci, atmVplLastChange, atmVplTransmitTrafficDescrIndex, atmVclCastType, atmVclLastChange, atmVplConnKind, atmVplAdminStatus, atmVccAal5CpcsReceiveSduSize, atmVcCrossConnectEntry, atmVplOperStatus, atmVplVpi = mibBuilder.importSymbols("ATM-MIB", "atmVplReceiveTrafficDescrIndex", "atmInterfaceDs3PlcpAlarmState", "atmVplCastType", "atmInterfaceTCEntry", "atmVclReceiveTrafficDescrIndex", "atmVclAdminStatus", "atmVplRowStatus", "atmVclVpi", "atmVccAalType", "atmVclTransmitTrafficDescrIndex", "atmVclEntry", "atmInterfaceTCAlarmState", "atmVclCrossConnectIdentifier", "atmVclConnKind", "atmVccAal5EncapsType", "atmVplEntry", "atmVplCrossConnectIdentifier", "atmVclOperStatus", "atmVccAal5CpcsTransmitSduSize", "atmVclRowStatus", "atmTrafficDescrParamEntry", "atmVclVci", "atmVplLastChange", "atmVplTransmitTrafficDescrIndex", "atmVclCastType", "atmVclLastChange", "atmVplConnKind", "atmVplAdminStatus", "atmVccAal5CpcsReceiveSduSize", "atmVcCrossConnectEntry", "atmVplOperStatus", "atmVplVpi")
...
zhoneSlotIndex, zhoneAtm, zhoneShelfIndex, zhoneModules = mibBuilder.importSymbols("Zhone", "zhoneSlotIndex", "zhoneAtm", "zhoneShelfIndex", "zhoneModules")
...
mibBuilder.exportSymbols("ZHONE-COM-ATM-MIB", zhoneAtmVclRateExtParam14=zhoneAtmVclRateExtParam14, zhoneAtmVclRateExtParam5Grp2=zhoneAtmVclRateExtParam5Grp2, zhoneAtmVplExtEntry=zhoneAtmVplExtEntry, zhoneAtmVclRateExtParam3Grp2=zhoneAtmVclRateExtParam3Grp2, zhoneAtmVclRateExtParam8Grp2=zhoneAtmVclRateExtParam8Grp2, zhoneAtmVplExtFaultDetectionType=zhoneAtmVplExtFaultDetectionType, zhoneAtmVplPonTrafficContainerIndex=zhoneAtmVplPonTrafficContainerIndex, zhoneAtmInterfaceNCDEvents=zhoneAtmInterfaceNCDEvents, atmDsx3PlcpAlarmStatusChange=atmDsx3PlcpAlarmStatusChange, zhoneAtmInterfaceFeNCDEvents=zhoneAtmInterfaceFeNCDEvents, zhoneAtmTrafficDescrParamExtEntry=zhoneAtmTrafficDescrParamExtEntry, zhoneAtmTraps=zhoneAtmTraps, atmVclToMulticastMapVci=atmVclToMulticastMapVci, zhoneAtmVclMulticastGroup=zhoneAtmVclMulticastGroup, atmVclToMulticastMapIndex=atmVclToMulticastMapIndex, zhoneAtmVclRateExtParam4Grp2=zhoneAtmVclRateExtParam4Grp2, zhoneAtmVclExtFaultDetectionType=zhoneAtmVclExtFaultDetectionType, zhoneAtmVplPonExtEntry=zhoneAtmVplPonExtEntry, zhoneAtmInterfaceFeOCDEvents=zhoneAtmInterfaceFeOCDEvents, zhoneAtmVclRateExtParam16Grp2=zhoneAtmVclRateExtParam16Grp2, zhoneAtmVcCrossConnectExtEntry=zhoneAtmVcCrossConnectExtEntry, zhoneAtmVclRateExtParam16=zhoneAtmVclRateExtParam16, atmVclToMulticastMapRowStatus=atmVclToMulticastMapRowStatus, zhoneAtmVclRateExtParam2=zhoneAtmVclRateExtParam2, zhoneAtmVclRateExtParam9Grp2=zhoneAtmVclRateExtParam9Grp2, zhoneAtmVclPonTrafficContainerIndex=zhoneAtmVclPonTrafficContainerIndex, zhoneAtmVclRateExtParam15Grp2=zhoneAtmVclRateExtParam15Grp2, atmVclToMulticastMapIfIndex=atmVclToMulticastMapIfIndex, zhoneAtmVclExtEntry=zhoneAtmVclExtEntry, atmVplOperStatusChange=atmVplOperStatusChange, zhoneAtmVclRateExtParam2Grp2=zhoneAtmVclRateExtParam2Grp2, zhoneAtmVclRateExtParam5=zhoneAtmVclRateExtParam5, atmVclBandwidthUnavailable=atmVclBandwidthUnavailable, zhoneAtmInterfaceFeHECEvents=zhoneAtmInterfaceFeHECEvents, zhoneAtmVclRateExtParam10Grp2=zhoneAtmVclRateExtParam10Grp2, zhoneAtmInterfaceHECEvents=zhoneAtmInterfaceHECEvents, atmVclToMulticastMapMulticastAddress=atmVclToMulticastMapMulticastAddress, atmVpiAutoCreateComplete=atmVpiAutoCreateComplete, zhoneAtmVpiOamF4PingStatus=zhoneAtmVpiOamF4PingStatus, zhoneAtmVpiRowStatus=zhoneAtmVpiRowStatus, zhoneAtmVclRateExtParam11Grp2=zhoneAtmVclRateExtParam11Grp2, zhoneAtmConnectionStatsGroup=zhoneAtmConnectionStatsGroup, zhoneAtmConnectionsAllocated=zhoneAtmConnectionsAllocated, zhoneAtmVclRateExtParam6=zhoneAtmVclRateExtParam6, atmOamF5PingStatus=atmOamF5PingStatus, zhoneAtmExtension=zhoneAtmExtension, zhoneAtmVclRateExtParam14Grp2=zhoneAtmVclRateExtParam14Grp2, atmVclToMulticastMap=atmVclToMulticastMap, atmVclOperStatusChange=atmVclOperStatusChange, zhoneAtmPonExtTable=zhoneAtmPonExtTable, zhoneAtmVpiTable=zhoneAtmVpiTable, zhoneAtmVclRateExtParam4=zhoneAtmVclRateExtParam4, zhoneAtmTrafficDescrParamExtTrnkVclRate=zhoneAtmTrafficDescrParamExtTrnkVclRate, zhoneAtmVclRateExtParam13Grp2=zhoneAtmVclRateExtParam13Grp2, zhoneAtmVclExtOamF4Ping=zhoneAtmVclExtOamF4Ping, zhoneAtmVclRateExtParam12=zhoneAtmVclRateExtParam12, PYSNMP_MODULE_ID=comAtmExtension, zhoneAtmVclRateExtParam1=zhoneAtmVclRateExtParam1, zhoneAtmStatsTotalFabricCellsTx=zhoneAtmStatsTotalFabricCellsTx, zhoneAtmStatsTotalFinalCLP0CellsTx=zhoneAtmStatsTotalFinalCLP0CellsTx, zhoneAtmTrafficDescrParamExtCacDivider=zhoneAtmTrafficDescrParamExtCacDivider, zhoneAtmVpiMaxVci=zhoneAtmVpiMaxVci, zhoneAtmVplExtGroup=zhoneAtmVplExtGroup, zhoneAtmConnectionStatsEntry=zhoneAtmConnectionStatsEntry, atmVclToMulticastMapTable=atmVclToMulticastMapTable, zhoneAtmInterfaceTcExtTable=zhoneAtmInterfaceTcExtTable, zhoneAtmVpiOamF4Ping=zhoneAtmVpiOamF4Ping, zhoneAtmVclRateExtParam10=zhoneAtmVclRateExtParam10, zhoneAtmVclRateExtParamGroup=zhoneAtmVclRateExtParamGroup, zhoneAtmVclRateExtParam6Grp2=zhoneAtmVclRateExtParam6Grp2, zhoneAtmVclRateExtParam7=zhoneAtmVclRateExtParam7, zhoneAtmVplExtTable=zhoneAtmVplExtTable, atmOamF4PingStatus=atmOamF4PingStatus, zhoneAtmTrafficDescrParamExtTable=zhoneAtmTrafficDescrParamExtTable, atmVclExtOamF4PingStatus=atmVclExtOamF4PingStatus, zhoneAtmVclRateExtParam13=zhoneAtmVclRateExtParam13, zhoneAtmStatsTotalFabricCellsRx=zhoneAtmStatsTotalFabricCellsRx, zhoneAtmVclRateExtParam11=zhoneAtmVclRateExtParam11, zhoneAtmInterfaceTcExtEntry=zhoneAtmInterfaceTcExtEntry, atmVclToMulticastMapVpi=atmVclToMulticastMapVpi, zhoneAtmGroups=zhoneAtmGroups, zhoneAtmVclRateExtParam8=zhoneAtmVclRateExtParam8, zhoneAtmTrafficDescrParamExtGroup=zhoneAtmTrafficDescrParamExtGroup, zhoneAtmVclRateExtParam15=zhoneAtmVclRateExtParam15, zhoneAtmStatsTotalFinalCLP1CellsTx=zhoneAtmStatsTotalFinalCLP1CellsTx, zhoneAtmPonGroup=zhoneAtmPonGroup, atmVclToMulticastMapRoutingDomain=atmVclToMulticastMapRoutingDomain, zhoneAtmVcCrossConnectExtTable=zhoneAtmVcCrossConnectExtTable, zhoneAtmPonExtEntry=zhoneAtmPonExtEntry, zhoneAtmVclRateExtParam=zhoneAtmVclRateExtParam, zhoneAtmTrapsGroup=zhoneAtmTrapsGroup, comAtmExtension=comAtmExtension, zhoneAtmVclRateExtParam3=zhoneAtmVclRateExtParam3, zhoneAtmVclExtTable=zhoneAtmVclExtTable, zhoneAtmVclExtTrafficContainerIndex=zhoneAtmVclExtTrafficContainerIndex, zhoneAtmVclExtGroup=zhoneAtmVclExtGroup, atmVclToMulticastMapEntry=atmVclToMulticastMapEntry, zhoneAtmConnectionStatsTable=zhoneAtmConnectionStatsTable, atmVpiAutoCreateDone=atmVpiAutoCreateDone, atmVpiAutoCreateCount=atmVpiAutoCreateCount, zhoneAtmVclRateExtParam12Grp2=zhoneAtmVclRateExtParam12Grp2, zhoneAtmVpiMaxVciPerVp=zhoneAtmVpiMaxVciPerVp, zhoneAtmVplPonExtTable=zhoneAtmVplPonExtTable, atmVclToMulticastMapIndexNext=atmVclToMulticastMapIndexNext, zhoneAtmVpiEntry=zhoneAtmVpiEntry, atmVci=atmVci, zhoneAtmV2Traps=zhoneAtmV2Traps, atmInterfaceTCAlarmStateChange=atmInterfaceTCAlarmStateChange, zhoneAtmVplExtTrafficContainerIndex=zhoneAtmVplExtTrafficContainerIndex, zhoneAtmVclExtOamF5PingStatus=zhoneAtmVclExtOamF5PingStatus, zhoneAtmVclExtOamF4PingStatus=zhoneAtmVclExtOamF4PingStatus, zhoneAtmVclRateExtParam9=zhoneAtmVclRateExtParam9, zhoneAtmStatsTotalFinalCLP1CellsRx=zhoneAtmStatsTotalFinalCLP1CellsRx, zhoneAtmVclRateExtParam7Grp2=zhoneAtmVclRateExtParam7Grp2, zhoneAtmStatsTotalInitialCellsRx=zhoneAtmStatsTotalInitialCellsRx, zhoneAtmStatsTotalFinalCLP0CellsRx=zhoneAtmStatsTotalFinalCLP0CellsRx, zhoneAtmStatsExtTableGroup=zhoneAtmStatsExtTableGroup, zhoneAtmVclRateExtParam1Grp2=zhoneAtmVclRateExtParam1Grp2, zhoneAtmVpiGroup=zhoneAtmVpiGroup, zhoneAtmStatsTotalInitialCellsTx=zhoneAtmStatsTotalInitialCellsTx, atmVpi=atmVpi, zhoneAtmConnectionsAvailable=zhoneAtmConnectionsAvailable, zhoneAtmVpiSwitched=zhoneAtmVpiSwitched, zhoneAtmStatsExtEntry=zhoneAtmStatsExtEntry, zhoneAtmVcCrossConnectExtHandleId=zhoneAtmVcCrossConnectExtHandleId, zhoneAtmVclExtOamF5Ping=zhoneAtmVclExtOamF5Ping, zhoneAtmTrafficDescrParamExtUsageParameterControl=zhoneAtmTrafficDescrParamExtUsageParameterControl, zhoneAtmStatsExtTable=zhoneAtmStatsExtTable)
