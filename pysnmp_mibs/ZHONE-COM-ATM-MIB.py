...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/zhone/ZHONE-COM-ATM-MIB
...
atmVccAal5CpcsReceiveSduSize, atmVplRowStatus, atmVccAalType, atmVplCastType, atmVclLastChange, atmVclCastType, atmVccAal5EncapsType, atmInterfaceTCAlarmState, atmVclVpi, atmVclReceiveTrafficDescrIndex, atmVclCrossConnectIdentifier, atmVclConnKind, atmVclVci, atmVplCrossConnectIdentifier, atmVclTransmitTrafficDescrIndex, atmTrafficDescrParamEntry, atmVclOperStatus, atmVclEntry, atmVplAdminStatus, atmVplReceiveTrafficDescrIndex, atmVccAal5CpcsTransmitSduSize, atmInterfaceDs3PlcpAlarmState, atmVplTransmitTrafficDescrIndex, atmVclAdminStatus, atmVplLastChange, atmInterfaceTCEntry, atmVcCrossConnectEntry, atmVplEntry, atmVplConnKind, atmVclRowStatus, atmVplVpi, atmVplOperStatus = mibBuilder.importSymbols("ATM-MIB", "atmVccAal5CpcsReceiveSduSize", "atmVplRowStatus", "atmVccAalType", "atmVplCastType", "atmVclLastChange", "atmVclCastType", "atmVccAal5EncapsType", "atmInterfaceTCAlarmState", "atmVclVpi", "atmVclReceiveTrafficDescrIndex", "atmVclCrossConnectIdentifier", "atmVclConnKind", "atmVclVci", "atmVplCrossConnectIdentifier", "atmVclTransmitTrafficDescrIndex", "atmTrafficDescrParamEntry", "atmVclOperStatus", "atmVclEntry", "atmVplAdminStatus", "atmVplReceiveTrafficDescrIndex", "atmVccAal5CpcsTransmitSduSize", "atmInterfaceDs3PlcpAlarmState", "atmVplTransmitTrafficDescrIndex", "atmVclAdminStatus", "atmVplLastChange", "atmInterfaceTCEntry", "atmVcCrossConnectEntry", "atmVplEntry", "atmVplConnKind", "atmVclRowStatus", "atmVplVpi", "atmVplOperStatus")
...
zhoneModules, zhoneAtm, zhoneShelfIndex, zhoneSlotIndex = mibBuilder.importSymbols("Zhone", "zhoneModules", "zhoneAtm", "zhoneShelfIndex", "zhoneSlotIndex")
...
mibBuilder.exportSymbols("ZHONE-COM-ATM-MIB", zhoneAtmVpiRowStatus=zhoneAtmVpiRowStatus, zhoneAtmVclRateExtParam6=zhoneAtmVclRateExtParam6, zhoneAtmStatsTotalInitialCellsRx=zhoneAtmStatsTotalInitialCellsRx, zhoneAtmStatsTotalFabricCellsRx=zhoneAtmStatsTotalFabricCellsRx, zhoneAtmVclRateExtParam12=zhoneAtmVclRateExtParam12, zhoneAtmVclRateExtParam4Grp2=zhoneAtmVclRateExtParam4Grp2, zhoneAtmTrafficDescrParamExtEntry=zhoneAtmTrafficDescrParamExtEntry, atmVclToMulticastMapTable=atmVclToMulticastMapTable, zhoneAtmVclRateExtParam15Grp2=zhoneAtmVclRateExtParam15Grp2, zhoneAtmVpiOamF4Ping=zhoneAtmVpiOamF4Ping, zhoneAtmStatsTotalFinalCLP0CellsRx=zhoneAtmStatsTotalFinalCLP0CellsRx, atmVclToMulticastMapIndex=atmVclToMulticastMapIndex, zhoneAtmVplPonExtTable=zhoneAtmVplPonExtTable, atmVclToMulticastMapMulticastAddress=atmVclToMulticastMapMulticastAddress, zhoneAtmVplExtTrafficContainerIndex=zhoneAtmVplExtTrafficContainerIndex, zhoneAtmVclExtOamF4PingStatus=zhoneAtmVclExtOamF4PingStatus, zhoneAtmV2Traps=zhoneAtmV2Traps, zhoneAtmVclRateExtParam7Grp2=zhoneAtmVclRateExtParam7Grp2, zhoneAtmVpiMaxVciPerVp=zhoneAtmVpiMaxVciPerVp, zhoneAtmStatsTotalInitialCellsTx=zhoneAtmStatsTotalInitialCellsTx, zhoneAtmVclExtFaultDetectionType=zhoneAtmVclExtFaultDetectionType, zhoneAtmVclRateExtParam13=zhoneAtmVclRateExtParam13, zhoneAtmVclExtOamF5PingStatus=zhoneAtmVclExtOamF5PingStatus, atmVclToMulticastMapVpi=atmVclToMulticastMapVpi, zhoneAtmVclRateExtParam=zhoneAtmVclRateExtParam, zhoneAtmVclRateExtParam1=zhoneAtmVclRateExtParam1, zhoneAtmVplExtEntry=zhoneAtmVplExtEntry, zhoneAtmStatsTotalFinalCLP1CellsTx=zhoneAtmStatsTotalFinalCLP1CellsTx, zhoneAtmInterfaceTcExtTable=zhoneAtmInterfaceTcExtTable, zhoneAtmVplExtTable=zhoneAtmVplExtTable, zhoneAtmConnectionStatsGroup=zhoneAtmConnectionStatsGroup, zhoneAtmVclExtTable=zhoneAtmVclExtTable, zhoneAtmVcCrossConnectExtTable=zhoneAtmVcCrossConnectExtTable, zhoneAtmTrafficDescrParamExtGroup=zhoneAtmTrafficDescrParamExtGroup, zhoneAtmInterfaceFeNCDEvents=zhoneAtmInterfaceFeNCDEvents, zhoneAtmVpiEntry=zhoneAtmVpiEntry, zhoneAtmInterfaceTcExtEntry=zhoneAtmInterfaceTcExtEntry, zhoneAtmVclRateExtParam10=zhoneAtmVclRateExtParam10, atmVclBandwidthUnavailable=atmVclBandwidthUnavailable, zhoneAtmVclMulticastGroup=zhoneAtmVclMulticastGroup, atmInterfaceTCAlarmStateChange=atmInterfaceTCAlarmStateChange, zhoneAtmTrapsGroup=zhoneAtmTrapsGroup, atmVclToMulticastMapRoutingDomain=atmVclToMulticastMapRoutingDomain, zhoneAtmVclRateExtParam13Grp2=zhoneAtmVclRateExtParam13Grp2, zhoneAtmVclRateExtParam14Grp2=zhoneAtmVclRateExtParam14Grp2, zhoneAtmInterfaceFeOCDEvents=zhoneAtmInterfaceFeOCDEvents, atmVpi=atmVpi, atmOamF5PingStatus=atmOamF5PingStatus, zhoneAtmPonGroup=zhoneAtmPonGroup, atmVclToMulticastMapRowStatus=atmVclToMulticastMapRowStatus, zhoneAtmVclRateExtParam2=zhoneAtmVclRateExtParam2, zhoneAtmInterfaceNCDEvents=zhoneAtmInterfaceNCDEvents, zhoneAtmVclRateExtParam5=zhoneAtmVclRateExtParam5, zhoneAtmVclExtEntry=zhoneAtmVclExtEntry, zhoneAtmVclRateExtParam2Grp2=zhoneAtmVclRateExtParam2Grp2, zhoneAtmConnectionStatsTable=zhoneAtmConnectionStatsTable, zhoneAtmVpiSwitched=zhoneAtmVpiSwitched, zhoneAtmExtension=zhoneAtmExtension, atmVclExtOamF4PingStatus=atmVclExtOamF4PingStatus, zhoneAtmTraps=zhoneAtmTraps, zhoneAtmInterfaceFeHECEvents=zhoneAtmInterfaceFeHECEvents, zhoneAtmVclRateExtParam5Grp2=zhoneAtmVclRateExtParam5Grp2, zhoneAtmStatsExtTable=zhoneAtmStatsExtTable, zhoneAtmVclRateExtParam3Grp2=zhoneAtmVclRateExtParam3Grp2, atmOamF4PingStatus=atmOamF4PingStatus, zhoneAtmVplExtFaultDetectionType=zhoneAtmVplExtFaultDetectionType, atmVclToMulticastMapVci=atmVclToMulticastMapVci, zhoneAtmVclRateExtParam11=zhoneAtmVclRateExtParam11, zhoneAtmVclRateExtParam14=zhoneAtmVclRateExtParam14, zhoneAtmVpiOamF4PingStatus=zhoneAtmVpiOamF4PingStatus, zhoneAtmVclRateExtParam4=zhoneAtmVclRateExtParam4, zhoneAtmVclRateExtParam10Grp2=zhoneAtmVclRateExtParam10Grp2, zhoneAtmVclRateExtParam12Grp2=zhoneAtmVclRateExtParam12Grp2, zhoneAtmVclExtOamF4Ping=zhoneAtmVclExtOamF4Ping, zhoneAtmStatsTotalFinalCLP1CellsRx=zhoneAtmStatsTotalFinalCLP1CellsRx, zhoneAtmVclRateExtParam6Grp2=zhoneAtmVclRateExtParam6Grp2, zhoneAtmVclRateExtParam16Grp2=zhoneAtmVclRateExtParam16Grp2, zhoneAtmPonExtEntry=zhoneAtmPonExtEntry, zhoneAtmVclPonTrafficContainerIndex=zhoneAtmVclPonTrafficContainerIndex, zhoneAtmVclRateExtParam1Grp2=zhoneAtmVclRateExtParam1Grp2, zhoneAtmTrafficDescrParamExtTable=zhoneAtmTrafficDescrParamExtTable, atmVclToMulticastMap=atmVclToMulticastMap, zhoneAtmVpiTable=zhoneAtmVpiTable, atmVpiAutoCreateCount=atmVpiAutoCreateCount, zhoneAtmConnectionsAllocated=zhoneAtmConnectionsAllocated, zhoneAtmConnectionStatsEntry=zhoneAtmConnectionStatsEntry, zhoneAtmPonExtTable=zhoneAtmPonExtTable, zhoneAtmStatsTotalFinalCLP0CellsTx=zhoneAtmStatsTotalFinalCLP0CellsTx, atmVclToMulticastMapIndexNext=atmVclToMulticastMapIndexNext, zhoneAtmVclRateExtParamGroup=zhoneAtmVclRateExtParamGroup, zhoneAtmVclRateExtParam11Grp2=zhoneAtmVclRateExtParam11Grp2, zhoneAtmVcCrossConnectExtEntry=zhoneAtmVcCrossConnectExtEntry, zhoneAtmStatsExtTableGroup=zhoneAtmStatsExtTableGroup, zhoneAtmVclRateExtParam8=zhoneAtmVclRateExtParam8, atmVpiAutoCreateComplete=atmVpiAutoCreateComplete, zhoneAtmVplPonTrafficContainerIndex=zhoneAtmVplPonTrafficContainerIndex, zhoneAtmVclRateExtParam9Grp2=zhoneAtmVclRateExtParam9Grp2, zhoneAtmStatsExtEntry=zhoneAtmStatsExtEntry, atmVclToMulticastMapEntry=atmVclToMulticastMapEntry, zhoneAtmVcCrossConnectExtHandleId=zhoneAtmVcCrossConnectExtHandleId, atmVclToMulticastMapIfIndex=atmVclToMulticastMapIfIndex, zhoneAtmVplPonExtEntry=zhoneAtmVplPonExtEntry, zhoneAtmTrafficDescrParamExtTrnkVclRate=zhoneAtmTrafficDescrParamExtTrnkVclRate, zhoneAtmVclExtGroup=zhoneAtmVclExtGroup, zhoneAtmTrafficDescrParamExtCacDivider=zhoneAtmTrafficDescrParamExtCacDivider, zhoneAtmGroups=zhoneAtmGroups, zhoneAtmVclExtTrafficContainerIndex=zhoneAtmVclExtTrafficContainerIndex, zhoneAtmVclExtOamF5Ping=zhoneAtmVclExtOamF5Ping, zhoneAtmVplExtGroup=zhoneAtmVplExtGroup, zhoneAtmStatsTotalFabricCellsTx=zhoneAtmStatsTotalFabricCellsTx, zhoneAtmVpiMaxVci=zhoneAtmVpiMaxVci, atmDsx3PlcpAlarmStatusChange=atmDsx3PlcpAlarmStatusChange, PYSNMP_MODULE_ID=comAtmExtension, zhoneAtmVclRateExtParam3=zhoneAtmVclRateExtParam3, zhoneAtmVclRateExtParam9=zhoneAtmVclRateExtParam9, zhoneAtmVclRateExtParam16=zhoneAtmVclRateExtParam16, zhoneAtmVclRateExtParam8Grp2=zhoneAtmVclRateExtParam8Grp2, zhoneAtmVclRateExtParam15=zhoneAtmVclRateExtParam15, atmVplOperStatusChange=atmVplOperStatusChange, zhoneAtmVclRateExtParam7=zhoneAtmVclRateExtParam7, atmVpiAutoCreateDone=atmVpiAutoCreateDone, zhoneAtmTrafficDescrParamExtUsageParameterControl=zhoneAtmTrafficDescrParamExtUsageParameterControl, zhoneAtmInterfaceHECEvents=zhoneAtmInterfaceHECEvents, atmVclOperStatusChange=atmVclOperStatusChange, atmVci=atmVci, zhoneAtmConnectionsAvailable=zhoneAtmConnectionsAvailable, zhoneAtmVpiGroup=zhoneAtmVpiGroup, comAtmExtension=comAtmExtension)
