...
h3cIpv6AddressObjects=_H3cIpv6AddressObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,71,1))
_H3cIpv6AddressConfig_ObjectIdentity=ObjectIdentity
h3cIpv6AddressConfig=_H3cIpv6AddressConfig_ObjectIdentity((1,3,6,1,4,1,2011,10,2,71,1,1))
_H3cIpv6AddrSetTable_Object=MibTable
h3cIpv6AddrSetTable=_H3cIpv6AddrSetTable_Object((1,3,6,1,4,1,2011,10,2,71,1,1,1))
if mibBuilder.loadTexts:h3cIpv6AddrSetTable.setStatus(_A)
_H3cIpv6AddrSetEntry_Object=MibTableRow
h3cIpv6AddrSetEntry=_H3cIpv6AddrSetEntry_Object((1,3,6,1,4,1,2011,10,2,71,1,1,1,1))
...
h3cIpv6AddrSetIfIndex=_H3cIpv6AddrSetIfIndex_Object((1,3,6,1,4,1,2011,10,2,71,1,1,1,1,1),_H3cIpv6AddrSetIfIndex_Type())
...
h3cIpv6AddrSetAddrType=_H3cIpv6AddrSetAddrType_Object((1,3,6,1,4,1,2011,10,2,71,1,1,1,1,2),_H3cIpv6AddrSetAddrType_Type())
...
h3cIpv6AddrSetAddr=_H3cIpv6AddrSetAddr_Object((1,3,6,1,4,1,2011,10,2,71,1,1,1,1,3),_H3cIpv6AddrSetAddr_Type())
...
h3cIpv6AddrSetPfxLength=_H3cIpv6AddrSetPfxLength_Object((1,3,6,1,4,1,2011,10,2,71,1,1,1,1,4),_H3cIpv6AddrSetPfxLength_Type())
...
h3cIpv6AddrSetSourceType=_H3cIpv6AddrSetSourceType_Object((1,3,6,1,4,1,2011,10,2,71,1,1,1,1,5),_H3cIpv6AddrSetSourceType_Type())
...
h3cIpv6AddrSetRowStatus=_H3cIpv6AddrSetRowStatus_Object((1,3,6,1,4,1,2011,10,2,71,1,1,1,1,6),_H3cIpv6AddrSetRowStatus_Type())
...
h3cIpv6AddrReadTable=_H3cIpv6AddrReadTable_Object((1,3,6,1,4,1,2011,10,2,71,1,1,2))
if mibBuilder.loadTexts:h3cIpv6AddrReadTable.setStatus(_A)
_H3cIpv6AddrReadEntry_Object=MibTableRow
h3cIpv6AddrReadEntry=_H3cIpv6AddrReadEntry_Object((1,3,6,1,4,1,2011,10,2,71,1,1,2,1))
...
h3cIpv6AddrReadIfIndex=_H3cIpv6AddrReadIfIndex_Object((1,3,6,1,4,1,2011,10,2,71,1,1,2,1,1),_H3cIpv6AddrReadIfIndex_Type())
...
h3cIpv6AddrReadAddrType=_H3cIpv6AddrReadAddrType_Object((1,3,6,1,4,1,2011,10,2,71,1,1,2,1,2),_H3cIpv6AddrReadAddrType_Type())
...
h3cIpv6AddrReadAddr=_H3cIpv6AddrReadAddr_Object((1,3,6,1,4,1,2011,10,2,71,1,1,2,1,3),_H3cIpv6AddrReadAddr_Type())
...
h3cIpv6AddrReadPfxLength=_H3cIpv6AddrReadPfxLength_Object((1,3,6,1,4,1,2011,10,2,71,1,1,2,1,4),_H3cIpv6AddrReadPfxLength_Type())
...
h3cIpv6AddrReadSourceType=_H3cIpv6AddrReadSourceType_Object((1,3,6,1,4,1,2011,10,2,71,1,1,2,1,5),_H3cIpv6AddrReadSourceType_Type())
...
h3cIpv6AddrReadCatalog=_H3cIpv6AddrReadCatalog_Object((1,3,6,1,4,1,2011,10,2,71,1,1,2,1,6),_H3cIpv6AddrReadCatalog_Type())
