...
mibBuilder.exportSymbols("WATCHGUARD-CLIENT-MIB", wgClientDHCPClientDomainName=wgClientDHCPClientDomainName, wgClientDHCPServerNum=wgClientDHCPServerNum, wgClientDHCPServerStartIpAddress=wgClientDHCPServerStartIpAddress, wgClientPPPoEClientEnable=wgClientPPPoEClientEnable, wgClientDHCPClientEnable=wgClientDHCPClientEnable, wgClientPPPoEClientADSLStatus=wgClientPPPoEClientADSLStatus, wgClientDHCPServerConnEntry=wgClientDHCPServerConnEntry, wgClientPPPoEClientNetMask=wgClientPPPoEClientNetMask, wgClientDHCPServerConnMACAddr=wgClientDHCPServerConnMACAddr, wgClientDHCPServerConnLeaseTimeStart=wgClientDHCPServerConnLeaseTimeStart, wgClientDHCPClient=wgClientDHCPClient, wgClientMIB=wgClientMIB, wgClientPPPoEClientRemoteIPAddr=wgClientPPPoEClientRemoteIPAddr, wgInfoModule=wgInfoModule, wgClientDHCPServerRelayServer=wgClientDHCPServerRelayServer, wgClientDHCPServerLeaseTime=wgClientDHCPServerLeaseTime, wgClientPPPoEClientConnTime=wgClientPPPoEClientConnTime, wgClientDHCPServer=wgClientDHCPServer, wgClientPPPoEClient=wgClientPPPoEClient, wgClientDHCPClientDNSOne=wgClientDHCPClientDNSOne, wgClientPPPoEClientDNSTwo=wgClientPPPoEClientDNSTwo, wgClientDHCPServerConnClientHostName=wgClientDHCPServerConnClientHostName, wgClientPPPoEADSLPeerMACAddr=wgClientPPPoEADSLPeerMACAddr, wgClientDHCPServerEnable=wgClientDHCPServerEnable, wgClientDHCPServerConnTable=wgClientDHCPServerConnTable, wgClientDHCPClientDNSTwo=wgClientDHCPClientDNSTwo, wgClientDHCPClientDefaultGateway=wgClientDHCPClientDefaultGateway, wgClientDHCPServerEndIpAddress=wgClientDHCPServerEndIpAddress, wgClientPPPoEClientLocalIPAddr=wgClientPPPoEClientLocalIPAddr, wgClientDHCPServerConnIPAddr=wgClientDHCPServerConnIPAddr, wgClientDHCPServerConnLeaseTimeEnd=wgClientDHCPServerConnLeaseTimeEnd, PYSNMP_MODULE_ID=wgInfoModule, wgClientPPPoEClientDNSOne=wgClientPPPoEClientDNSOne)
