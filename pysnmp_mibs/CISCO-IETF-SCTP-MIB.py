...
mibBuilder.exportSymbols("CISCO-IETF-SCTP-MIB", cSctpStatFragmentedUsrMessages=cSctpStatFragmentedUsrMessages, cSctpRtoInitial=cSctpRtoInitial, cSctpStatRecOrderChunks=cSctpStatRecOrderChunks, cSctpLookupRemIPAddrStartTime=cSctpLookupRemIPAddrStartTime, cSctpAssocOutStreams=cSctpAssocOutStreams, cSctpLookupRemPortTable=cSctpLookupRemPortTable, cSctpOtherStatGroup=cSctpOtherStatGroup, cSctpGeneralVariablesGroup=cSctpGeneralVariablesGroup, cSctpStatRecCtrlChunks=cSctpStatRecCtrlChunks, cSctpLookupRemPrimIPAddrTable=cSctpLookupRemPrimIPAddrTable, cSctpRtoAlgorithm=cSctpRtoAlgorithm, cSctpAssocLocalAddressIPType=cSctpAssocLocalAddressIPType, cSctpAssocStartTime=cSctpAssocStartTime, cSctpAssocStatGroup=cSctpAssocStatGroup, cSctpLookupRemHostNameStartTime=cSctpLookupRemHostNameStartTime, cSctpAssocId=cSctpAssocId, cSctpMaxAssoc=cSctpMaxAssoc, cSctpLookupLocalPortStartTime=cSctpLookupLocalPortStartTime, cSctpMaxInitRetr=cSctpMaxInitRetr, cSctpAssocRemAddressRtx=cSctpAssocRemAddressRtx, cSctpMIB=cSctpMIB, cSctpAssocRemAddressStartTime=cSctpAssocRemAddressStartTime, cSctpConformance=cSctpConformance, cSctpAssocRtxChunks=cSctpAssocRtxChunks, cSctpStatRecSCTPPacks=cSctpStatRecSCTPPacks, cSctpLookupRemPortEntry=cSctpLookupRemPortEntry, cSctpLookupRemPrimIPAddrStartTime=cSctpLookupRemPrimIPAddrStartTime, cSctpAssocState=cSctpAssocState, cSctpObjects=cSctpObjects, cSctpStatReassembledUsrMessages=cSctpStatReassembledUsrMessages, cSctpInverseGroup=cSctpInverseGroup, cSctpCurrEstab=cSctpCurrEstab, cSctpLookupLocalPortEntry=cSctpLookupLocalPortEntry, cSctpAssocRemSCTPPort=cSctpAssocRemSCTPPort, cSctpLookupRemHostNameTable=cSctpLookupRemHostNameTable, cSctpAssocRemAddressEntry=cSctpAssocRemAddressEntry, cSctpAssocRemAddressMaxPathRtx=cSctpAssocRemAddressMaxPathRtx, cSctpAssocRemAddressIPType=cSctpAssocRemAddressIPType, cSctpShutdowns=cSctpShutdowns, cSctpAssocT1expireds=cSctpAssocT1expireds, cSctpStatSentOrderChunks=cSctpStatSentOrderChunks, cSctpRtoMax=cSctpRtoMax, cSctpCompliances=cSctpCompliances, cSctpLookupLocalPortTable=cSctpLookupLocalPortTable, cSctpLookupRemIPAddrEntry=cSctpLookupRemIPAddrEntry, cSctpAssocHeartBeatTimer=cSctpAssocHeartBeatTimer, cSctpAssocRemPrimaryAddressType=cSctpAssocRemPrimaryAddressType, cSctpLookupRemPrimIPAddrEntry=cSctpLookupRemPrimIPAddrEntry, cSctpAssocLocalAddressStartTime=cSctpAssocLocalAddressStartTime, cSctpLookupRemPortStartTime=cSctpLookupRemPortStartTime, cSctpAssocTablesVariablesGroup=cSctpAssocTablesVariablesGroup, cSctpAssocT2expireds=cSctpAssocT2expireds, cSctpAssocInStreams=cSctpAssocInStreams, cSctpAssocMaxRetr=cSctpAssocMaxRetr, cSctpLookupRemHostNameEntry=cSctpLookupRemHostNameEntry, cSctpAssocRemPrimaryAddress=cSctpAssocRemPrimaryAddress, cSctpStateStatGroup=cSctpStateStatGroup, cSctpStatSentSCTPPacks=cSctpStatSentSCTPPacks, cSctpCompliance=cSctpCompliance, cSctpAssocRemAddressIP=cSctpAssocRemAddressIP, cSctpAssocRemAddressRTO=cSctpAssocRemAddressRTO, cSctpAssocLocalAddressTable=cSctpAssocLocalAddressTable, cSctpAborteds=cSctpAborteds, cSctpAssocRemAddressStatus=cSctpAssocRemAddressStatus, cSctpAssocLocalAddressIP=cSctpAssocLocalAddressIP, cSctpLookupRemIPAddrTable=cSctpLookupRemIPAddrTable, cSctpTables=cSctpTables, cSctpAssocLocalSCTPPort=cSctpAssocLocalSCTPPort, cSctpStatOutOfBlues=cSctpStatOutOfBlues, cSctpActiveEstabs=cSctpActiveEstabs, cSctpAssocTable=cSctpAssocTable, cSctpAssocRemHostName=cSctpAssocRemHostName, cSctpStatSentUnorderChunks=cSctpStatSentUnorderChunks, cSctpAssocEntry=cSctpAssocEntry, InetPortNumber=InetPortNumber, cSctpStatChecksumErrors=cSctpStatChecksumErrors, cSctpAssocLocalAddressEntry=cSctpAssocLocalAddressEntry, cSctpStatSentCtrlChunks=cSctpStatSentCtrlChunks, cSctpGroups=cSctpGroups, cSctpAssocRemAddressHBFlag=cSctpAssocRemAddressHBFlag, cSctpRtoMin=cSctpRtoMin, cSctpValCookieLife=cSctpValCookieLife, cSctpAssocRemAddressTable=cSctpAssocRemAddressTable, PYSNMP_MODULE_ID=cSctpMIB, cSctpStatRecUnorderChunks=cSctpStatRecUnorderChunks, cSctpScalars=cSctpScalars, cSctpPassiveEstabs=cSctpPassiveEstabs)
