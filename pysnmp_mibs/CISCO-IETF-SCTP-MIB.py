...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-SCTP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:33:17 2025
...
cSctpCompliance.setObjects(
      *(("CISCO-IETF-SCTP-MIB", "cSctpGeneralVariablesGroup"),
        ("CISCO-IETF-SCTP-MIB", "cSctpAssocTablesVariablesGroup"),
        ("CISCO-IETF-SCTP-MIB", "cSctpStateStatGroup"),
        ("CISCO-IETF-SCTP-MIB", "cSctpOtherStatGroup"),
        ("CISCO-IETF-SCTP-MIB", "cSctpAssocStatGroup"),
        ("CISCO-IETF-SCTP-MIB", "cSctpInverseGroup"))
)
if mibBuilder.loadTexts:
