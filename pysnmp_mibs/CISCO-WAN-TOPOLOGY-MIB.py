...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-TOPOLOGY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:35 2025
...
cwtMIBCompliance.setObjects(
      *(("CISCO-WAN-TOPOLOGY-MIB", "cwtSystemMIBGroups"),
        ("CISCO-WAN-TOPOLOGY-MIB", "cwtNodalMIBGroups"))
)
if mibBuilder.loadTexts:
...
cwtMIBCompliance2.setObjects(
      *(("CISCO-WAN-TOPOLOGY-MIB", "cwtSystemMIBGroups"),
        ("CISCO-WAN-TOPOLOGY-MIB", "cwtNodalMIBGroups"),
        ("CISCO-WAN-TOPOLOGY-MIB", "cwtFeederMIBGroups"))
)
if mibBuilder.loadTexts:
...
cwtMIBCompliance3.setObjects(
      *(("CISCO-WAN-TOPOLOGY-MIB", "cwtSystemMIBGroups"),
        ("CISCO-WAN-TOPOLOGY-MIB", "cwtNodalMIBGroups"),
        ("CISCO-WAN-TOPOLOGY-MIB", "cwtFeederMIBGroups"),
        ("CISCO-WAN-TOPOLOGY-MIB", "cwtLinkMIBGroups"))
)
if mibBuilder.loadTexts:
