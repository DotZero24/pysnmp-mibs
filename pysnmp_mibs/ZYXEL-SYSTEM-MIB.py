...
# Notes
# -----
# ASN.1 source file://mibs/zyxel/ZYXEL-SYSTEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:01:44 2025
...
zyDateTimeServerInetAddressType = _ZyDateTimeServerInetAddressType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 82, 1, 11),
    _ZyDateTimeServerInetAddressType_Type()
)
zyDateTimeServerInetAddressType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDateTimeServerInetAddressType.setStatus("current")
_ZyDateTimeServerInetAddress_Type = InetAddress
_ZyDateTimeServerInetAddress_Object = MibScalar
zyDateTimeServerInetAddress = _ZyDateTimeServerInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 82, 1, 12),
    _ZyDateTimeServerInetAddress_Type()
)
zyDateTimeServerInetAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDateTimeServerInetAddress.setStatus("current")
_ZyDateTimeZoneHourMinute_Type = OctetString
_ZyDateTimeZoneHourMinute_Object = MibScalar
zyDateTimeZoneHourMinute = _ZyDateTimeZoneHourMinute_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 82, 1, 13),
    _ZyDateTimeZoneHourMinute_Type()
)
zyDateTimeZoneHourMinute.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDateTimeZoneHourMinute.setStatus("current")
_ZyDateTimeSyncInterval_Type = Integer32
_ZyDateTimeSyncInterval_Object = MibScalar
zyDateTimeSyncInterval = _ZyDateTimeSyncInterval_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 82, 1, 14),
    _ZyDateTimeSyncInterval_Type()
)
zyDateTimeSyncInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDateTimeSyncInterval.setStatus("current")
...
zySysServiceStatus = _ZySysServiceStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 82, 2, 12),
    _ZySysServiceStatus_Type()
)
zySysServiceStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    zySysServiceStatus.setStatus("current")
_ZySysRegisterMacAddress_Type = MacAddress
_ZySysRegisterMacAddress_Object = MibScalar
zySysRegisterMacAddress = _ZySysRegisterMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 82, 2, 13),
    _ZySysRegisterMacAddress_Type()
)
zySysRegisterMacAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    zySysRegisterMacAddress.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"zyxelSystem": zyxelSystem,
       ...
       "zyDateTimeServerInetAddressType": zyDateTimeServerInetAddressType,
       "zyDateTimeServerInetAddress": zyDateTimeServerInetAddress,
       "zyDateTimeZoneHourMinute": zyDateTimeZoneHourMinute,
       "zyDateTimeSyncInterval": zyDateTimeSyncInterval,
       ...
       "zySysServiceStatus": zySysServiceStatus,
       "zySysRegisterMacAddress": zySysRegisterMacAddress,
