...
rlRs232MibVersion=_RlRs232MibVersion_Object((1,3,6,1,4,1,4526,17,104,1),_RlRs232MibVersion_Type())
...
rlRs232AutoBaudRateStatus=_RlRs232AutoBaudRateStatus_Object((1,3,6,1,4,1,4526,17,104,2),_RlRs232AutoBaudRateStatus_Type())
...
rlRs232AutoBaudRateStatusAfterReset=_RlRs232AutoBaudRateStatusAfterReset_Object((1,3,6,1,4,1,4526,17,104,3),_RlRs232AutoBaudRateStatusAfterReset_Type())
...
rlRs232BaudRate=_RlRs232BaudRate_Object((1,3,6,1,4,1,4526,17,104,4),_RlRs232BaudRate_Type())
rlRs232BaudRate.setMaxAccess(_F)
if mibBuilder.loadTexts:rlRs232BaudRate.setStatus(_B)
mibBuilder.exportSymbols('NETGEAR-RADLAN-BaudRate-MIB',**{'rlRs232':rlRs232,'rlRs232MibVersion':rlRs232MibVersion,'rlRs232AutoBaudRateStatus':rlRs232AutoBaudRateStatus,'rlRs232AutoBaudRateStatusAfterReset':rlRs232AutoBaudRateStatusAfterReset,'rlRs232BaudRate':rlRs232BaudRate})