...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IMA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:25:19 2025
...
_CimaGroupClearAccDelay_Type.__name__ = "TruthValue"
...
_CimaGrpRestarting_Type.__name__ = "TruthValue"
...
_CimaGrpVerFallbackEnable_Type.__name__ = "TruthValue"
...
_CimaVerFallbackEnable_Type.__name__ = "TruthValue"
...
_CimaAutoRestartEnable_Type.__name__ = "TruthValue"
...
ciscoImaMIBCompliance.setObjects(
      *(("CISCO-IMA-MIB", "ciscoImaGroupGroup"),
        ("CISCO-IMA-MIB", "ciscoImaLinkGroup"))
)
if mibBuilder.loadTexts:
...
ciscoImaMIBCompliance1.setObjects(
      *(("CISCO-IMA-MIB", "ciscoImaGroupGroup"),
        ("CISCO-IMA-MIB", "ciscoImaLinkGroup"),
        ("CISCO-IMA-MIB", "ciscoImaLinkMappingGroup"),
        ("CISCO-IMA-MIB", "ciscoImaFeatureGroup"),
        ("CISCO-IMA-MIB", "ciscoImaAutoRestartGroup"),
        ("CISCO-IMA-MIB", "ciscoImaVerFallbackSupportGroup"))
)
if mibBuilder.loadTexts:
