...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-SWITCH-ENGINE-MIB
...
ifIndex, OwnerString, InterfaceIndexOrZero = mibBuilder.importSymbols("IF-MIB", "ifIndex", "OwnerString", "InterfaceIndexOrZero")
...
ciscoSwitchEngineMIB.setRevisions(('2024-01-09 00:00', '2021-08-01 00:00', '2020-05-26 00:00', '2020-03-06 00:00', '2019-07-11 00:00', '2018-06-20 00:00', '2017-12-07 00:00', '2013-02-13 00:00', '2012-03-12 00:00', '2010-12-17 00:00', '2008-11-11 00:00', '2008-01-29 00:00', '2005-09-16 00:00', '2005-04-12 00:00', '2004-11-15 00:00', '2004-06-09 00:00', '2003-11-07 00:00', '2003-08-20 00:00', '2003-06-10 00:00', '2003-05-06 00:00', '2003-02-21 00:00', '2002-08-05 00:00', '2002-02-07 00:00', '2001-10-26 00:00', '2001-09-13 00:00', '2001-05-16 00:00', '2001-03-09 00:00', '2000-06-23 00:00', '2000-01-31 11:30', '1999-12-09 11:30', '1998-06-24 11:30', '1998-05-28 11:30',))
if mibBuilder.loadTexts: ciscoSwitchEngineMIB.setLastUpdated('202401090000Z')
...
mibBuilder.exportSymbols("CISCO-SWITCH-ENGINE-MIB", cseFlowQueryIndex=cseFlowQueryIndex, cseFlowFastAgePktThreshold=cseFlowFastAgePktThreshold, cseFlowQuerySource=cseFlowQuerySource, cseFlowQueryTotalFlows=cseFlowQueryTotalFlows, cseL3VlanInPkts=cseL3VlanInPkts, cseL2HCAssignedProtoPkts=cseL2HCAssignedProtoPkts, cseMcastCacheIndex=cseMcastCacheIndex, cseFlowExcludeStatus=cseFlowExcludeStatus, cseMcastCacheStatus=cseMcastCacheStatus, cseRouterEntry=cseRouterEntry, cseFlowMcastResultHFlag3k4k=cseFlowMcastResultHFlag3k4k, cseFlowOperIPXAgingTime=cseFlowOperIPXAgingTime, cseNetflowLSExportNDEVersionNumber=cseNetflowLSExportNDEVersionNumber, cseL2StatsEntry=cseL2StatsEntry, cseFlowMcastQuerySrc=cseFlowMcastQuerySrc, cseCefFibTable=cseCefFibTable, cseRouterIndex=cseRouterIndex, cseFlowOperFastAgePktThreshold=cseFlowOperFastAgePktThreshold, cseMetUsageGroup=cseMetUsageGroup, cseMIBCompliance4=cseMIBCompliance4, cseL2HCForwardedLocalPkts=cseL2HCForwardedLocalPkts, cseMIBCompliance7=cseMIBCompliance7, ControlStatus=ControlStatus, cseFlowDataSource=cseFlowDataSource, cseFlowFastAgingTime=cseFlowFastAgingTime, cseFlowMgmtGroup=cseFlowMgmtGroup, cseFlowSwitchControlEntry=cseFlowSwitchControlEntry, cseRouterTable=cseRouterTable, cseCefAdjacencyNextHopMac=cseCefAdjacencyNextHopMac, cseL2StatsHCTable=cseL2StatsHCTable, cseFlowDataIndex=cseFlowDataIndex, cseUcastCacheDestMask=cseUcastCacheDestMask, cseL3SwitchedAggrPktsPerSec=cseL3SwitchedAggrPktsPerSec, cseFlowMcastMgmtGroup2=cseFlowMcastMgmtGroup2, cseL3EstablishedFlowHits=cseL3EstablishedFlowHits, cseProtocolFilterPortOperStatus=cseProtocolFilterPortOperStatus, cseUcastCacheIndex=cseUcastCacheIndex, cseCefAdjacencyPkts=cseCefAdjacencyPkts, cseStaticIpxRouterOwner=cseStaticIpxRouterOwner, cseMIBCompliance3=cseMIBCompliance3, cseStaticRouterOwner=cseStaticRouterOwner, cseStatsFlowAged=cseStatsFlowAged, cseL3VlanInUnicastOctets=cseL3VlanInUnicastOctets, cseCefAdjacencyAddrType=cseCefAdjacencyAddrType, cseL3ErrorsGroup=cseL3ErrorsGroup, cseFlowExcludeProtocol=cseFlowExcludeProtocol, cseFlowMcastQueryGrp=cseFlowMcastQueryGrp, cseFlowMcastResultFlowType=cseFlowMcastResultFlowType, cseFlowQueryCreateTime=cseFlowQueryCreateTime, cseTcamUsageEntry=cseTcamUsageEntry, cseFlowQueryResultTotalOctets=cseFlowQueryResultTotalOctets, cseL3FlowLearnFailures=cseL3FlowLearnFailures, cseFlowMgmtGroupRev1=cseFlowMgmtGroupRev1, cseFlowQueryTransport=cseFlowQueryTransport, cseL2DstAddrLookupMisses=cseL2DstAddrLookupMisses, cseMcastCacheOwner=cseMcastCacheOwner, cseFlow=cseFlow, cseCacheUtilization=cseCacheUtilization, cseL3VlanIndex=cseL3VlanIndex, cseNDESingleFilterGroup=cseNDESingleFilterGroup, cseFlowDataSrcMac=cseFlowDataSrcMac, cseRouterGroup=cseRouterGroup, cseErrorStatsLCTable=cseErrorStatsLCTable, cseStaticRouterStatus=cseStaticRouterStatus, cseMetAllocatedSpcFreeEntries=cseMetAllocatedSpcFreeEntries, cseUcastCacheStatus=cseUcastCacheStatus, cseErrorStatsEntry=cseErrorStatsEntry, cseLCIpCheckSumErrors=cseLCIpCheckSumErrors, cseNDEMultipleFiltersGroup=cseNDEMultipleFiltersGroup, cseCacheUtilTable=cseCacheUtilTable, cseL2HCOverflowAssignedProtoPkts=cseL2HCOverflowAssignedProtoPkts, cseL3SwitchedTotalOctets=cseL3SwitchedTotalOctets, cseFlowIPXEstablishedAgingTime=cseFlowIPXEstablishedAgingTime, cseMcastCacheSrc=cseMcastCacheSrc, cseL2AddrLearnFailures=cseL2AddrLearnFailures, cseTcamUsageGroup=cseTcamUsageGroup, cseProtocolFilterExtGroup=cseProtocolFilterExtGroup, cseLCIpxTooShortErrors=cseLCIpxTooShortErrors, cseMIBCompliance8=cseMIBCompliance8, cseL3VlanInOctets=cseL3VlanInOctets, cseL3VlanOutUnicastPkts=cseL3VlanOutUnicastPkts, cseProtocolFilterPortProtocol=cseProtocolFilterPortProtocol, cseFlowBridgedFlowStatsEnable=cseFlowBridgedFlowStatsEnable, cseL2StatsTable=cseL2StatsTable, cseFlowMcastQuerySrcVlan=cseFlowMcastQuerySrcVlan, cseFlowQueryDestination=cseFlowQueryDestination, cseL2HCForwardedTotalPkts=cseL2HCForwardedTotalPkts, cseFlowIPFlowMask=cseFlowIPFlowMask, cseNetflowLSExportDataSource=cseNetflowLSExportDataSource, cseStaticRouterName=cseStaticRouterName, cseFlowSwitchStatus=cseFlowSwitchStatus, cseFlowMcastResultRtrIp=cseFlowMcastResultRtrIp, cseFlowDataEncapType=cseFlowDataEncapType, cseUcastCache=cseUcastCache, cseFlowMgmtExtGroup2=cseFlowMgmtExtGroup2, cseFlowTotalFlows=cseFlowTotalFlows, cseBridgedFlowStatsCtrlEntry=cseBridgedFlowStatsCtrlEntry, cseNetflowASInfoExportGroup=cseNetflowASInfoExportGroup, cseMcastCache=cseMcastCache, cseNetFlowIfIndexEnable=cseNetFlowIfIndexEnable, PYSNMP_MODULE_ID=ciscoSwitchEngineMIB, cseFlowMcastQuerySkipNFlows=cseFlowMcastQuerySkipNFlows, cseFlowDataIpQOSPolicy=cseFlowDataIpQOSPolicy, cseL2ForwardedTotalPkts=cseL2ForwardedTotalPkts, cseNetflowPerVlanIfGlobalEnable=cseNetflowPerVlanIfGlobalEnable, cseFlowMcastResultSrc=cseFlowMcastResultSrc, cseFlowMcastQueryTotalFlows=cseFlowMcastQueryTotalFlows, cseCefFibDestIp=cseCefFibDestIp, cseNetflowLSExportDataFilterSelection=cseNetflowLSExportDataFilterSelection, cseNetflowLSExportTransportNumber=cseNetflowLSExportTransportNumber, cseFlowMcastMaxQueries=cseFlowMcastMaxQueries, cseRouterIpxFlowMask=cseRouterIpxFlowMask, cseUcastCacheOwner=cseUcastCacheOwner, cseNetflowLSFilterDataProtocol=cseNetflowLSFilterDataProtocol, cseFlowMcastResultOctets=cseFlowMcastResultOctets, cseL3ActiveFlows=cseL3ActiveFlows, cseL2StatsHCEntry=cseL2StatsHCEntry, cseL3SwitchedTotalPkts=cseL3SwitchedTotalPkts, cseL3SwitchedPktsPerSec=cseL3SwitchedPktsPerSec, cseFlowMcastResultSrcVlan=cseFlowMcastResultSrcVlan, cseL3VlanOutOctets=cseL3VlanOutOctets, cseMIBConformance=cseMIBConformance, cseL3StatsTable=cseL3StatsTable, cseFlowMcastQueryRtrIndex=cseFlowMcastQueryRtrIndex, cseNetflowLS=cseNetflowLS, cseFlowMcastResultMvrf=cseFlowMcastResultMvrf, cseUcastCacheDest=cseUcastCacheDest, cseStaticIpxExtRouterTable=cseStaticIpxExtRouterTable, cseFlowMcastRtrMgmtGroup=cseFlowMcastRtrMgmtGroup, cseTcamResourceDescr=cseTcamResourceDescr, cseErrorStatsTable=cseErrorStatsTable, cseRouterStatic=cseRouterStatic, cseNetflowPerVlanIfCtrlVlan=cseNetflowPerVlanIfCtrlVlan, cseFlowOperEstablishedAgingTime=cseFlowOperEstablishedAgingTime, cseL3ExtFlowInvalids=cseL3ExtFlowInvalids, cseL2HCOtherProtoPkts=cseL2HCOtherProtoPkts, cseMIBCompliance=cseMIBCompliance, cseStaticExtRouterEntry=cseStaticExtRouterEntry, cseMcastCacheGrp=cseMcastCacheGrp, cseFlowDataDestVlan=cseFlowDataDestVlan, cseIpxTooShortErrors=cseIpxTooShortErrors, cseIpxPlenErrors=cseIpxPlenErrors, cseFlowExcludeEntry=cseFlowExcludeEntry, FlowAddressComponent=FlowAddressComponent, cseTcamResourceType=cseTcamResourceType, cseLCIpxPlenErrors=cseLCIpxPlenErrors, cseUcastCacheRtrIp=cseUcastCacheRtrIp, CiscoGauge64=CiscoGauge64, cseFlowStatsEntry=cseFlowStatsEntry, cseCefAdjacencyMTU=cseCefAdjacencyMTU, cseFlowDataTable=cseFlowDataTable, cseFlowStatsTable=cseFlowStatsTable, cseMetUnallocatedSpcFreeEntries=cseMetUnallocatedSpcFreeEntries, cseUcastCacheResult=cseUcastCacheResult, cseRouterVlanEntry=cseRouterVlanEntry, cseL3IntFlowInvalids=cseL3IntFlowInvalids, cseMetUsageEntry=cseMetUsageEntry, cseFlowMcastResultHFlag1k2k=cseFlowMcastResultHFlag1k2k, cseL3CandidateFlowHits=cseL3CandidateFlowHits, cseRouterVlanTable=cseRouterVlanTable, cseFlowQueryResultTotalPkts=cseFlowQueryResultTotalPkts, cseFlowMcastMgmtGroup=cseFlowMcastMgmtGroup, cseNetflowLSFilterDataDestMask=cseNetflowLSFilterDataDestMask, cseProtocolFilterPortAdminStatus=cseProtocolFilterPortAdminStatus, cseCefFibType=cseCefFibType, cseL3ErrorsLCGroup=cseL3ErrorsLCGroup, cseFlowMcastResultDstVlans3k=cseFlowMcastResultDstVlans3k, cse4kVlanGroup=cse4kVlanGroup, cseFlowMcastQueryEntry=cseFlowMcastQueryEntry, cseFlowMcastResultCreatedTS=cseFlowMcastResultCreatedTS, cseL3VlanStatsEntry=cseL3VlanStatsEntry, cseFlowQueryResultAvgDuration=cseFlowQueryResultAvgDuration, cseCacheEntriesCreated=cseCacheEntriesCreated, cseUcastCacheFlowType=cseUcastCacheFlowType, cseTcamUsageTable=cseTcamUsageTable, cseRouterName=cseRouterName, cseFlowMcastResultRtrMac=cseFlowMcastResultRtrMac, cseCefAdjacencyNextHopIfIndex=cseCefAdjacencyNextHopIfIndex, cseFlowEstablishedAgingTime=cseFlowEstablishedAgingTime, cseCefFibAddrType=cseCefFibAddrType, cseMIBCompliance5=cseMIBCompliance5, cseFlowExcludePort=cseFlowExcludePort, cseFlowQuerySourceMask=cseFlowQuerySourceMask, cseL3VlanOutUnicastOctets=cseL3VlanOutUnicastOctets, cseFlowMcastSwitchStatus=cseFlowMcastSwitchStatus, cseFlowDataPkts=cseFlowDataPkts, cseNetflowLSExportDataDest=cseNetflowLSExportDataDest, cseStatisticsGroup=cseStatisticsGroup, cseMet=cseMet, cseNetflowLSFilterSelection=cseNetflowLSFilterSelection, cseL2OtherProtoPkts=cseL2OtherProtoPkts, cseCefFibAdjacencyGroup=cseCefFibAdjacencyGroup, cseCacheUtilEntry=cseCacheUtilEntry, cseNetflowLSFilterDataSourceMask=cseNetflowLSFilterDataSourceMask, cseFlowQueryTable=cseFlowQueryTable, cseBridgedFlowGroup=cseBridgedFlowGroup, cseFlowDataLastUsed=cseFlowDataLastUsed, cseIpPlenErrors=cseIpPlenErrors, cseL2ForwardedLocalPkts=cseL2ForwardedLocalPkts, cseL3Objects=cseL3Objects, cseNetflowPerVlanIfCtrlTable=cseNetflowPerVlanIfCtrlTable, cseStaticIpxExtRouterEntry=cseStaticIpxExtRouterEntry, cseFlowMcastResultPkts=cseFlowMcastResultPkts, cseProtocolFilterEnable=cseProtocolFilterEnable, cseFlowQueryOwner=cseFlowQueryOwner, cseCefAdjacencyIndex=cseCefAdjacencyIndex, cseFlowQuerySkipNFlows=cseFlowQuerySkipNFlows, cseFlowMcastQueryIndex=cseFlowMcastQueryIndex, cseMetUsageTable=cseMetUsageTable, cseLCIpPlenErrors=cseLCIpPlenErrors, cseFlowQueryEntry=cseFlowQueryEntry, cseMcastCacheFlowType=cseMcastCacheFlowType, cseMcastCacheTable=cseMcastCacheTable, cseFlowMaxQueries=cseFlowMaxQueries, cseFlowMcastQueryCreateTime=cseFlowMcastQueryCreateTime, cseNetflowPerVlanIfEnable=cseNetflowPerVlanIfEnable, cseStaticExtRouterTable=cseStaticExtRouterTable, cseFlowQueryStatus=cseFlowQueryStatus, cseL2HCOverflowForwardedLocalPkts=cseL2HCOverflowForwardedLocalPkts, cseCacheEntriesFailed=cseCacheEntriesFailed, cseL3VlanInUnicastPkts=cseL3VlanInUnicastPkts, cseStatsFlowEntry=cseStatsFlowEntry, cseFlowDataStaticFlow=cseFlowDataStaticFlow, cseNDEMandatoryGroup=cseNDEMandatoryGroup, cseFlowMcastResultIndex=cseFlowMcastResultIndex, cseFlowDataOctets=cseFlowDataOctets, cseCefAdjacencyNextHopIp=cseCefAdjacencyNextHopIp, cseMIBCompliances=cseMIBCompliances, cseL2NewAddressLearns=cseL2NewAddressLearns, cseMcastCachePurgeGroup=cseMcastCachePurgeGroup, cseFlowLongAgingTime=cseFlowLongAgingTime, cseMetTotalEntries=cseMetTotalEntries, cseTcamUsage=cseTcamUsage, cseNetflowLSFilterTable=cseNetflowLSFilterTable, cseFlowSwitchProtocol=cseFlowSwitchProtocol, cseRouterMac=cseRouterMac, cseFlowOperFastAgingTime=cseFlowOperFastAgingTime, cseCacheStatisticsGroup=cseCacheStatisticsGroup, cseL2HCIpPkts=cseL2HCIpPkts, cseTcamResourceTotal=cseTcamResourceTotal, cseMIBObjects=cseMIBObjects, cseNDEReportGroup=cseNDEReportGroup, cseL3SwitchedPktsPerSecGroup=cseL3SwitchedPktsPerSecGroup, cseUcastCacheEntry=cseUcastCacheEntry, cseL2HCOverflowOtherProtoPkts=cseL2HCOverflowOtherProtoPkts, cseMIBNotifications=cseMIBNotifications, cseBridgedFlowVlan=cseBridgedFlowVlan, cseFlowMcastQueryGroup=cseFlowMcastQueryGroup, cseNetflowASInfoExportCtrl=cseNetflowASInfoExportCtrl, cseFlowQueryMask=cseFlowQueryMask, cseStaticRouterType=cseStaticRouterType, cseRouterFlowMask=cseRouterFlowMask, cseFlowExcludeTable=cseFlowExcludeTable, cseFlowDataDstMac=cseFlowDataDstMac)
mibBuilder.exportSymbols("CISCO-SWITCH-ENGINE-MIB", cseStatsFlowTable=cseStatsFlowTable, cseMcastCacheEntry=cseMcastCacheEntry, cseRouterProtocol=cseRouterProtocol, cseMcastCacheResult=cseMcastCacheResult, cseL2HCOverflowForwardedTotalPkts=cseL2HCOverflowForwardedTotalPkts, cseUcastCacheTransport=cseUcastCacheTransport, cseStatisticsFlowGroup1=cseStatisticsFlowGroup1, cseFlowDataWhenCreated=cseFlowDataWhenCreated, cseFlowMgmtExtGroup=cseFlowMgmtExtGroup, cseFlowMcastResultGrp=cseFlowMcastResultGrp, cseL2HCOverflowIpPkts=cseL2HCOverflowIpPkts, cseL3StatsEntry=cseL3StatsEntry, cseNetflowLSExportHost=cseNetflowLSExportHost, cseStatisticsGroup2=cseStatisticsGroup2, cseUcastCachePurgeGroup=cseUcastCachePurgeGroup, cseFlowMcastQueryMask=cseFlowMcastQueryMask, cseNetflowLSFilterSupport=cseNetflowLSFilterSupport, cseStaticIpxRouterName=cseStaticIpxRouterName, cseUcastCacheSource=cseUcastCacheSource, cseFlowSwitchControlTable=cseFlowSwitchControlTable, cseFlowDataEntry=cseFlowDataEntry, cseNetflowPerVlanIfCtrlEntry=cseNetflowPerVlanIfCtrlEntry, ciscoSwitchEngineMIB=ciscoSwitchEngineMIB, cseStatsFlowParityFail=cseStatsFlowParityFail, cseFlowIPXFlowMask=cseFlowIPXFlowMask, cseMetIndex=cseMetIndex, cseL3VlanOutPkts=cseL3VlanOutPkts, cseFlowMcastQueryStatus=cseFlowMcastQueryStatus, cseL2ForwardedLocalOctets=cseL2ForwardedLocalOctets, cseTcamResourceUsed=cseTcamResourceUsed, cseCefAdjacencyTable=cseCefAdjacencyTable, cseStatisticsFlowGroup=cseStatisticsFlowGroup, cseCefAdjacencyMTUGroup=cseCefAdjacencyMTUGroup, cseNetflowPerVlanIfGroup=cseNetflowPerVlanIfGroup, cseUcastCacheTable=cseUcastCacheTable, cseL2AssignedProtoPkts=cseL2AssignedProtoPkts, cseFlowMcastResultSource=cseFlowMcastResultSource, cseMIBCompliance6=cseMIBCompliance6, cseNetflowLSExportDataDestMask=cseNetflowLSExportDataDestMask, cseNetflowLSFilterDataSource=cseNetflowLSFilterDataSource, cseProtocolFilterPortEntry=cseProtocolFilterPortEntry, cseFlowMgmtExtGroup1=cseFlowMgmtExtGroup1, cseFlowMcastResultEntry=cseFlowMcastResultEntry, cseStatsFlowPurged=cseStatsFlowPurged, cseL2IpPkts=cseL2IpPkts, cseIpCheckSumErrors=cseIpCheckSumErrors, cseErrorStatsLCEntry=cseErrorStatsLCEntry, cseProtocolFilterPortTable=cseProtocolFilterPortTable, cseNetflowLSFilterEntry=cseNetflowLSFilterEntry, cseNetflowLSFilterIndex=cseNetflowLSFilterIndex, cseL2Objects=cseL2Objects, cseL3VlanStatsTable=cseL3VlanStatsTable, cseFlowMcastResultDstVlans=cseFlowMcastResultDstVlans, cseUcastCacheSrcMask=cseUcastCacheSrcMask, cseCef=cseCef, cseCefAdjacencyOctets=cseCefAdjacencyOctets, cseFlowQueryDestinationMask=cseFlowQueryDestinationMask, McastGroupIp=McastGroupIp, cseFlowMcastResultDstVlans4k=cseFlowMcastResultDstVlans4k, cseCefAdjacencyType=cseCefAdjacencyType, cseFlowMcastQueryRows=cseFlowMcastQueryRows, cseFlowMcastQueryTable=cseFlowMcastQueryTable, cseFlowMcastQueryAddrType=cseFlowMcastQueryAddrType, cseFlowMcastMgmtGroup1=cseFlowMcastMgmtGroup1, cseNDESingleFilterGroupRev1=cseNDESingleFilterGroupRev1, cseL2HCOverflowIpxPkts=cseL2HCOverflowIpxPkts, cseFlowMcastQuerySource=cseFlowMcastQuerySource, cseCefFibEntry=cseCefFibEntry, cseFlowTotalIpv4Flows=cseFlowTotalIpv4Flows, cseCefAdjacencyEncap=cseCefAdjacencyEncap, cseBridgedFlowStatsCtrlTable=cseBridgedFlowStatsCtrlTable, cseFlowMcastResultGroup=cseFlowMcastResultGroup, cseIpTooShortErrors=cseIpTooShortErrors, cseRouterVlan=cseRouterVlan, cseL2IpxPkts=cseL2IpxPkts, cseMIBGroups=cseMIBGroups, cseMIBCompliance2=cseMIBCompliance2, cseL2HCIpxPkts=cseL2HCIpxPkts, cseNetflowLSExportStatus=cseNetflowLSExportStatus, cseCefAdjacencyEncapGroup=cseCefAdjacencyEncapGroup, cseFlowMcastQueryMvrf=cseFlowMcastQueryMvrf, cseNetflowLSFilterDataDest=cseNetflowLSFilterDataDest, cseFlowQueryRouterIndex=cseFlowQueryRouterIndex, cseFlowDataDestination=cseFlowDataDestination, cseFlowMcastResultDstVlans2k=cseFlowMcastResultDstVlans2k, cseFlowMgmtOperStatusGroup=cseFlowMgmtOperStatusGroup, cseFlowDataIpQOS=cseFlowDataIpQOS, cseCefAdjacencyEntry=cseCefAdjacencyEntry, cseStaticIpxRouterStatus=cseStaticIpxRouterStatus, cseLCIpTooShortErrors=cseLCIpTooShortErrors, cseFlowQueryResultAvgIdle=cseFlowQueryResultAvgIdle, cseNetflowLSExportDataSourceMask=cseNetflowLSExportDataSourceMask, cseVlanStatisticsGroup=cseVlanStatisticsGroup, cseProtocolFilterGroup=cseProtocolFilterGroup, cseNetflowLSGroup=cseNetflowLSGroup, cseFlowMcastQueryOwner=cseFlowMcastQueryOwner, cseFlowQueryResultingRows=cseFlowQueryResultingRows, cseNetflowLSFilterStatus=cseNetflowLSFilterStatus, cseFlowMcastResultAddrType=cseFlowMcastResultAddrType, cseFlowMcastResultLastUsedTS=cseFlowMcastResultLastUsedTS, cseNetflowLSExportDataProtocol=cseNetflowLSExportDataProtocol, cseCefFibIndex=cseCefFibIndex, cseMcastCacheRtrIp=cseMcastCacheRtrIp, cseCefFibDestIpMask=cseCefFibDestIpMask, cseProtocolFilter=cseProtocolFilter, cseFlowMcastResultTable=cseFlowMcastResultTable, cseVlanStatisticsExtGroup=cseVlanStatisticsExtGroup)
