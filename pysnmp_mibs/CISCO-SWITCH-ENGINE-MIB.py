...
OwnerString, InterfaceIndexOrZero, ifIndex = mibBuilder.importSymbols("IF-MIB", "OwnerString", "InterfaceIndexOrZero", "ifIndex")
...
mibBuilder.exportSymbols("CISCO-SWITCH-ENGINE-MIB", cseUcastCacheSrcMask=cseUcastCacheSrcMask, cseFlowMcastResultFlowType=cseFlowMcastResultFlowType, cseL3ExtFlowInvalids=cseL3ExtFlowInvalids, cseFlowDataOctets=cseFlowDataOctets, PYSNMP_MODULE_ID=ciscoSwitchEngineMIB, cseFlowQueryTotalFlows=cseFlowQueryTotalFlows, cseStaticIpxRouterOwner=cseStaticIpxRouterOwner, cseFlowQueryTransport=cseFlowQueryTransport, cseRouterMac=cseRouterMac, cseTcamResourceDescr=cseTcamResourceDescr, cseL3VlanInUnicastOctets=cseL3VlanInUnicastOctets, cseVlanStatisticsGroup=cseVlanStatisticsGroup, cseMIBCompliance8=cseMIBCompliance8, cseL2ForwardedTotalPkts=cseL2ForwardedTotalPkts, cseFlowMcastResultSrcVlan=cseFlowMcastResultSrcVlan, cseL3VlanOutUnicastPkts=cseL3VlanOutUnicastPkts, cseFlowMcastQueryGroup=cseFlowMcastQueryGroup, cseFlowQueryResultAvgIdle=cseFlowQueryResultAvgIdle, cseFlowMcastQueryGrp=cseFlowMcastQueryGrp, cseUcastCacheEntry=cseUcastCacheEntry, cseTcamUsageTable=cseTcamUsageTable, cseFlowDataStaticFlow=cseFlowDataStaticFlow, cseTcamUsage=cseTcamUsage, cseMcastCacheTable=cseMcastCacheTable, ControlStatus=ControlStatus, cseFlowMcastResultCreatedTS=cseFlowMcastResultCreatedTS, cseCefFibAdjacencyGroup=cseCefFibAdjacencyGroup, cseNetflowLSExportDataFilterSelection=cseNetflowLSExportDataFilterSelection, cseL3Objects=cseL3Objects, cseNetflowPerVlanIfCtrlEntry=cseNetflowPerVlanIfCtrlEntry, cseFlowOperFastAgingTime=cseFlowOperFastAgingTime, cseCefFibIndex=cseCefFibIndex, cseFlowMcastQuerySource=cseFlowMcastQuerySource, cseUcastCacheTransport=cseUcastCacheTransport, cseL2DstAddrLookupMisses=cseL2DstAddrLookupMisses, cseNDESingleFilterGroup=cseNDESingleFilterGroup, cseRouterProtocol=cseRouterProtocol, cseFlowMcastResultPkts=cseFlowMcastResultPkts, cseNDEMandatoryGroup=cseNDEMandatoryGroup, cseBridgedFlowStatsCtrlEntry=cseBridgedFlowStatsCtrlEntry, cseFlowFastAgePktThreshold=cseFlowFastAgePktThreshold, cseMIBCompliance=cseMIBCompliance, cseL3StatsTable=cseL3StatsTable, cseFlowMgmtOperStatusGroup=cseFlowMgmtOperStatusGroup, cseFlowMgmtGroupRev1=cseFlowMgmtGroupRev1, cseFlowMcastResultRtrMac=cseFlowMcastResultRtrMac, cseFlowMcastResultOctets=cseFlowMcastResultOctets, cseL3VlanInOctets=cseL3VlanInOctets, cseMcastCacheGrp=cseMcastCacheGrp, cseMIBCompliance7=cseMIBCompliance7, cseL3IntFlowInvalids=cseL3IntFlowInvalids, cseMIBNotifications=cseMIBNotifications, cseL3VlanInPkts=cseL3VlanInPkts, cseUcastCacheResult=cseUcastCacheResult, cseL3ErrorsLCGroup=cseL3ErrorsLCGroup, cseFlowMcastResultDstVlans3k=cseFlowMcastResultDstVlans3k, cseUcastCacheTable=cseUcastCacheTable, cseFlowMcastResultRtrIp=cseFlowMcastResultRtrIp, cseTcamUsageGroup=cseTcamUsageGroup, cseRouterStatic=cseRouterStatic, cseFlowMcastQueryStatus=cseFlowMcastQueryStatus, cseL3VlanStatsTable=cseL3VlanStatsTable, cseFlowExcludePort=cseFlowExcludePort, cseUcastCacheIndex=cseUcastCacheIndex, cseRouterFlowMask=cseRouterFlowMask, ciscoSwitchEngineMIB=ciscoSwitchEngineMIB, cseProtocolFilter=cseProtocolFilter, cseNetflowLSFilterSelection=cseNetflowLSFilterSelection, cseTcamResourceType=cseTcamResourceType, cseIpCheckSumErrors=cseIpCheckSumErrors, cseL2HCOverflowIpPkts=cseL2HCOverflowIpPkts, cseCefAdjacencyEntry=cseCefAdjacencyEntry, cseMIBObjects=cseMIBObjects, cseMetUsageGroup=cseMetUsageGroup, cseUcastCacheOwner=cseUcastCacheOwner, cseFlowMcastResultMvrf=cseFlowMcastResultMvrf, cseLCIpxPlenErrors=cseLCIpxPlenErrors, cseNetflowLSExportStatus=cseNetflowLSExportStatus, cseStatsFlowPurged=cseStatsFlowPurged, cseNetflowLSFilterDataDest=cseNetflowLSFilterDataDest, cseL2HCOverflowOtherProtoPkts=cseL2HCOverflowOtherProtoPkts, cseFlowQueryMask=cseFlowQueryMask, cseFlowMcastMaxQueries=cseFlowMcastMaxQueries, cseUcastCacheSource=cseUcastCacheSource, cseProtocolFilterPortEntry=cseProtocolFilterPortEntry, cseUcastCacheRtrIp=cseUcastCacheRtrIp, cseStatisticsGroup2=cseStatisticsGroup2, cseRouterName=cseRouterName, cseL2StatsHCEntry=cseL2StatsHCEntry, cseFlowMcastResultTable=cseFlowMcastResultTable, cseMcastCacheIndex=cseMcastCacheIndex, cseFlowMcastResultDstVlans2k=cseFlowMcastResultDstVlans2k, cseCefAdjacencyEncapGroup=cseCefAdjacencyEncapGroup, cseL2HCOverflowIpxPkts=cseL2HCOverflowIpxPkts, cseStatisticsFlowGroup=cseStatisticsFlowGroup, cseFlowMcastResultHFlag1k2k=cseFlowMcastResultHFlag1k2k, cseFlowMcastQuerySrcVlan=cseFlowMcastQuerySrcVlan, cseBridgedFlowStatsCtrlTable=cseBridgedFlowStatsCtrlTable, cseNetflowLSFilterDataSourceMask=cseNetflowLSFilterDataSourceMask, cseCefFibAddrType=cseCefFibAddrType, cseRouterIpxFlowMask=cseRouterIpxFlowMask, cseProtocolFilterEnable=cseProtocolFilterEnable, cseCefAdjacencyMTUGroup=cseCefAdjacencyMTUGroup, cseUcastCacheFlowType=cseUcastCacheFlowType, cseNetflowLSFilterIndex=cseNetflowLSFilterIndex, cseFlowMcastResultAddrType=cseFlowMcastResultAddrType, cseL2AddrLearnFailures=cseL2AddrLearnFailures, cseRouterEntry=cseRouterEntry, cseL3VlanStatsEntry=cseL3VlanStatsEntry, cseL2ForwardedLocalOctets=cseL2ForwardedLocalOctets, cseFlowTotalIpv4Flows=cseFlowTotalIpv4Flows, cseStatsFlowParityFail=cseStatsFlowParityFail, cseFlowDataIpQOSPolicy=cseFlowDataIpQOSPolicy, cseLCIpCheckSumErrors=cseLCIpCheckSumErrors, cseNDESingleFilterGroupRev1=cseNDESingleFilterGroupRev1, cseNetflowLSFilterDataSource=cseNetflowLSFilterDataSource, cseUcastCachePurgeGroup=cseUcastCachePurgeGroup, cseFlowIPXFlowMask=cseFlowIPXFlowMask, cseNetflowLSExportDataDest=cseNetflowLSExportDataDest, cseL3VlanOutPkts=cseL3VlanOutPkts, cseFlowMcastQueryMask=cseFlowMcastQueryMask, cseRouterVlan=cseRouterVlan, cseFlowMcastSwitchStatus=cseFlowMcastSwitchStatus, cseFlowSwitchControlEntry=cseFlowSwitchControlEntry, cseMIBCompliances=cseMIBCompliances, cseNetflowLSExportTransportNumber=cseNetflowLSExportTransportNumber, cseFlowMcastResultSrc=cseFlowMcastResultSrc, cseNetflowLSFilterStatus=cseNetflowLSFilterStatus, cseCefFibType=cseCefFibType, cseCefAdjacencyAddrType=cseCefAdjacencyAddrType, cseFlowBridgedFlowStatsEnable=cseFlowBridgedFlowStatsEnable, cseProtocolFilterPortProtocol=cseProtocolFilterPortProtocol, cseFlowIPXEstablishedAgingTime=cseFlowIPXEstablishedAgingTime, CiscoGauge64=CiscoGauge64, cseFlowMcastResultDstVlans=cseFlowMcastResultDstVlans, cseStatisticsGroup=cseStatisticsGroup, cseFlowMcastResultLastUsedTS=cseFlowMcastResultLastUsedTS, cseNetflowPerVlanIfGroup=cseNetflowPerVlanIfGroup, cseFlowQueryIndex=cseFlowQueryIndex, cseL3SwitchedTotalOctets=cseL3SwitchedTotalOctets, cseProtocolFilterGroup=cseProtocolFilterGroup, cseL2Objects=cseL2Objects, cseFlowQueryResultingRows=cseFlowQueryResultingRows, cseErrorStatsEntry=cseErrorStatsEntry, cseFlowMcastResultDstVlans4k=cseFlowMcastResultDstVlans4k, cseFlowQueryResultAvgDuration=cseFlowQueryResultAvgDuration, cseL2HCOverflowForwardedLocalPkts=cseL2HCOverflowForwardedLocalPkts, cseUcastCacheDest=cseUcastCacheDest, cseMcastCacheRtrIp=cseMcastCacheRtrIp, cseTcamUsageEntry=cseTcamUsageEntry, cseCefAdjacencyOctets=cseCefAdjacencyOctets, cseCefAdjacencyIndex=cseCefAdjacencyIndex, cseMetTotalEntries=cseMetTotalEntries, cseFlowQuerySourceMask=cseFlowQuerySourceMask, cseFlowMcastResultGrp=cseFlowMcastResultGrp, cseRouterGroup=cseRouterGroup, cseNetflowLSFilterSupport=cseNetflowLSFilterSupport, cseNetflowLSFilterDataProtocol=cseNetflowLSFilterDataProtocol, cseFlowMcastMgmtGroup=cseFlowMcastMgmtGroup, cseNetflowLSExportNDEVersionNumber=cseNetflowLSExportNDEVersionNumber, cseFlowQueryResultTotalOctets=cseFlowQueryResultTotalOctets, cseMetAllocatedSpcFreeEntries=cseMetAllocatedSpcFreeEntries, cseLCIpxTooShortErrors=cseLCIpxTooShortErrors, cseL3ActiveFlows=cseL3ActiveFlows, cseCef=cseCef, cseL2AssignedProtoPkts=cseL2AssignedProtoPkts, cseFlowOperEstablishedAgingTime=cseFlowOperEstablishedAgingTime, cseFlowTotalFlows=cseFlowTotalFlows, cseNetFlowIfIndexEnable=cseNetFlowIfIndexEnable, cseL2HCAssignedProtoPkts=cseL2HCAssignedProtoPkts, cseStatsFlowEntry=cseStatsFlowEntry, cseFlowQueryStatus=cseFlowQueryStatus, cseIpPlenErrors=cseIpPlenErrors, cseMcastCache=cseMcastCache, cseFlowQueryDestinationMask=cseFlowQueryDestinationMask, cseMcastCacheSrc=cseMcastCacheSrc, cseCefAdjacencyType=cseCefAdjacencyType, cseCefFibDestIp=cseCefFibDestIp, cseFlowDataDestVlan=cseFlowDataDestVlan, cseFlowMcastQueryAddrType=cseFlowMcastQueryAddrType, cseUcastCacheStatus=cseUcastCacheStatus, cseBridgedFlowGroup=cseBridgedFlowGroup, cseCefAdjacencyTable=cseCefAdjacencyTable, cseBridgedFlowVlan=cseBridgedFlowVlan, cseCacheEntriesCreated=cseCacheEntriesCreated, cseL2ForwardedLocalPkts=cseL2ForwardedLocalPkts, cseStaticRouterName=cseStaticRouterName, cseCacheEntriesFailed=cseCacheEntriesFailed, cseRouterIndex=cseRouterIndex, cseL2HCForwardedLocalPkts=cseL2HCForwardedLocalPkts, cseFlowQueryResultTotalPkts=cseFlowQueryResultTotalPkts, cseFlowIPFlowMask=cseFlowIPFlowMask, cseL3ErrorsGroup=cseL3ErrorsGroup, cseL2StatsTable=cseL2StatsTable, cseFlowQueryEntry=cseFlowQueryEntry, cseLCIpPlenErrors=cseLCIpPlenErrors, cseNetflowLSExportDataProtocol=cseNetflowLSExportDataProtocol, cseFlowSwitchStatus=cseFlowSwitchStatus, cseMcastCacheOwner=cseMcastCacheOwner, cseMIBCompliance2=cseMIBCompliance2, cseFlowEstablishedAgingTime=cseFlowEstablishedAgingTime, cseUcastCache=cseUcastCache, cseFlowMgmtExtGroup2=cseFlowMgmtExtGroup2, cseCefAdjacencyNextHopMac=cseCefAdjacencyNextHopMac, cseUcastCacheDestMask=cseUcastCacheDestMask, cseFlowMgmtExtGroup=cseFlowMgmtExtGroup, cseNetflowPerVlanIfCtrlVlan=cseNetflowPerVlanIfCtrlVlan, cseL3SwitchedPktsPerSecGroup=cseL3SwitchedPktsPerSecGroup, cseL2IpPkts=cseL2IpPkts, cseFlowStatsEntry=cseFlowStatsEntry, cseErrorStatsLCEntry=cseErrorStatsLCEntry, cseFlowQuerySource=cseFlowQuerySource, cseFlowMcastResultGroup=cseFlowMcastResultGroup, cseMcastCacheStatus=cseMcastCacheStatus, cseStatsFlowTable=cseStatsFlowTable, cseMIBCompliance6=cseMIBCompliance6, cseVlanStatisticsExtGroup=cseVlanStatisticsExtGroup, cseStaticIpxExtRouterEntry=cseStaticIpxExtRouterEntry, cseFlowDataIpQOS=cseFlowDataIpQOS, cseNetflowLS=cseNetflowLS, cseFlowLongAgingTime=cseFlowLongAgingTime, cseNetflowLSExportHost=cseNetflowLSExportHost, cseFlowMcastQueryCreateTime=cseFlowMcastQueryCreateTime, cseL2HCOverflowAssignedProtoPkts=cseL2HCOverflowAssignedProtoPkts, cseNetflowLSGroup=cseNetflowLSGroup, cseNetflowPerVlanIfGlobalEnable=cseNetflowPerVlanIfGlobalEnable, cseNetflowLSFilterTable=cseNetflowLSFilterTable, cseFlowDataEncapType=cseFlowDataEncapType, cseFlowMcastResultSource=cseFlowMcastResultSource, cseFlowMcastQueryTotalFlows=cseFlowMcastQueryTotalFlows, cseStatsFlowAged=cseStatsFlowAged, cseStaticIpxExtRouterTable=cseStaticIpxExtRouterTable, cseProtocolFilterExtGroup=cseProtocolFilterExtGroup, cseStaticExtRouterEntry=cseStaticExtRouterEntry, cseFlowMcastQueryEntry=cseFlowMcastQueryEntry, cseMetUsageTable=cseMetUsageTable, cseTcamResourceTotal=cseTcamResourceTotal, cseCefFibDestIpMask=cseCefFibDestIpMask, cseCacheUtilization=cseCacheUtilization, cseNetflowLSExportDataSource=cseNetflowLSExportDataSource, cseL3CandidateFlowHits=cseL3CandidateFlowHits, cseFlowDataWhenCreated=cseFlowDataWhenCreated, cseCefAdjacencyNextHopIp=cseCefAdjacencyNextHopIp, cseFlowExcludeTable=cseFlowExcludeTable, cseIpxTooShortErrors=cseIpxTooShortErrors, cseProtocolFilterPortAdminStatus=cseProtocolFilterPortAdminStatus, cseStaticRouterStatus=cseStaticRouterStatus, cseStaticRouterType=cseStaticRouterType, cseIpxPlenErrors=cseIpxPlenErrors, cseFlowDataPkts=cseFlowDataPkts, cseMcastCachePurgeGroup=cseMcastCachePurgeGroup, cseL2HCOverflowForwardedTotalPkts=cseL2HCOverflowForwardedTotalPkts, cseFlowQueryCreateTime=cseFlowQueryCreateTime, cseFlowMcastQuerySkipNFlows=cseFlowMcastQuerySkipNFlows)
mibBuilder.exportSymbols("CISCO-SWITCH-ENGINE-MIB", cseL2StatsEntry=cseL2StatsEntry, cseL3SwitchedAggrPktsPerSec=cseL3SwitchedAggrPktsPerSec, cseErrorStatsLCTable=cseErrorStatsLCTable, cseL3VlanOutOctets=cseL3VlanOutOctets, cseFlowSwitchProtocol=cseFlowSwitchProtocol, cseFlowMcastQueryRows=cseFlowMcastQueryRows, cseMIBConformance=cseMIBConformance, cseL3EstablishedFlowHits=cseL3EstablishedFlowHits, cseFlowMcastQueryMvrf=cseFlowMcastQueryMvrf, cseFlowExcludeEntry=cseFlowExcludeEntry, cseNetflowPerVlanIfCtrlTable=cseNetflowPerVlanIfCtrlTable, cseFlowStatsTable=cseFlowStatsTable, cse4kVlanGroup=cse4kVlanGroup, cseFlowQueryDestination=cseFlowQueryDestination, cseStaticIpxRouterName=cseStaticIpxRouterName, cseMIBCompliance4=cseMIBCompliance4, cseFlowMcastQueryTable=cseFlowMcastQueryTable, FlowAddressComponent=FlowAddressComponent, cseFlowMcastMgmtGroup1=cseFlowMcastMgmtGroup1, cseFlowDataLastUsed=cseFlowDataLastUsed, cseStaticExtRouterTable=cseStaticExtRouterTable, cseFlowMcastResultIndex=cseFlowMcastResultIndex, cseMIBCompliance3=cseMIBCompliance3, cseFlowMcastQuerySrc=cseFlowMcastQuerySrc, cseL2StatsHCTable=cseL2StatsHCTable, cseL3SwitchedPktsPerSec=cseL3SwitchedPktsPerSec, cseFlowExcludeProtocol=cseFlowExcludeProtocol, cseFlowMgmtExtGroup1=cseFlowMgmtExtGroup1, cseFlowMcastMgmtGroup2=cseFlowMcastMgmtGroup2, cseFlowQuerySkipNFlows=cseFlowQuerySkipNFlows, cseMetIndex=cseMetIndex, cseMet=cseMet, cseFlowMcastQueryOwner=cseFlowMcastQueryOwner, cseL3FlowLearnFailures=cseL3FlowLearnFailures, cseL3StatsEntry=cseL3StatsEntry, cseFlowDataSrcMac=cseFlowDataSrcMac, cseCacheUtilTable=cseCacheUtilTable, cseNDEMultipleFiltersGroup=cseNDEMultipleFiltersGroup, cseFlowDataIndex=cseFlowDataIndex, cseFlowMcastRtrMgmtGroup=cseFlowMcastRtrMgmtGroup, cseFlowDataDestination=cseFlowDataDestination, cseL2OtherProtoPkts=cseL2OtherProtoPkts, cseFlowMaxQueries=cseFlowMaxQueries, cseStatisticsFlowGroup1=cseStatisticsFlowGroup1, cseNetflowLSExportDataDestMask=cseNetflowLSExportDataDestMask, cseRouterTable=cseRouterTable, cseFlowDataDstMac=cseFlowDataDstMac, cseFlowOperFastAgePktThreshold=cseFlowOperFastAgePktThreshold, cseL2HCOtherProtoPkts=cseL2HCOtherProtoPkts, cseL2HCIpxPkts=cseL2HCIpxPkts, cseL2IpxPkts=cseL2IpxPkts, cseFlowSwitchControlTable=cseFlowSwitchControlTable, cseFlowFastAgingTime=cseFlowFastAgingTime, cseCefAdjacencyNextHopIfIndex=cseCefAdjacencyNextHopIfIndex, cseStaticRouterOwner=cseStaticRouterOwner, McastGroupIp=McastGroupIp, cseCefAdjacencyPkts=cseCefAdjacencyPkts, cseFlowDataTable=cseFlowDataTable, cseCefAdjacencyEncap=cseCefAdjacencyEncap, cseProtocolFilterPortTable=cseProtocolFilterPortTable, cseProtocolFilterPortOperStatus=cseProtocolFilterPortOperStatus, cseStaticIpxRouterStatus=cseStaticIpxRouterStatus, cseCefAdjacencyMTU=cseCefAdjacencyMTU, cseCefFibEntry=cseCefFibEntry, cseMIBCompliance5=cseMIBCompliance5, cseMetUsageEntry=cseMetUsageEntry, cseFlowMcastResultHFlag3k4k=cseFlowMcastResultHFlag3k4k, cseL2HCForwardedTotalPkts=cseL2HCForwardedTotalPkts, cseFlowQueryTable=cseFlowQueryTable, cseNetflowLSExportDataSourceMask=cseNetflowLSExportDataSourceMask, cseFlowExcludeStatus=cseFlowExcludeStatus, cseMcastCacheEntry=cseMcastCacheEntry, cseCefFibTable=cseCefFibTable, cseFlowMcastResultEntry=cseFlowMcastResultEntry, cseMcastCacheResult=cseMcastCacheResult, cseNDEReportGroup=cseNDEReportGroup, cseFlowMgmtGroup=cseFlowMgmtGroup, cseFlowOperIPXAgingTime=cseFlowOperIPXAgingTime, cseFlow=cseFlow, cseFlowMcastQueryRtrIndex=cseFlowMcastQueryRtrIndex, cseNetflowLSFilterDataDestMask=cseNetflowLSFilterDataDestMask, cseL3VlanInUnicastPkts=cseL3VlanInUnicastPkts, cseTcamResourceUsed=cseTcamResourceUsed, cseMetUnallocatedSpcFreeEntries=cseMetUnallocatedSpcFreeEntries, cseL3SwitchedTotalPkts=cseL3SwitchedTotalPkts, cseMIBGroups=cseMIBGroups, cseFlowMcastQueryIndex=cseFlowMcastQueryIndex, cseFlowQueryOwner=cseFlowQueryOwner, cseFlowDataEntry=cseFlowDataEntry, cseCacheStatisticsGroup=cseCacheStatisticsGroup, cseErrorStatsTable=cseErrorStatsTable, cseNetflowASInfoExportCtrl=cseNetflowASInfoExportCtrl, cseL3VlanIndex=cseL3VlanIndex, cseMcastCacheFlowType=cseMcastCacheFlowType, cseRouterVlanTable=cseRouterVlanTable, cseLCIpTooShortErrors=cseLCIpTooShortErrors, cseFlowDataSource=cseFlowDataSource, cseL2NewAddressLearns=cseL2NewAddressLearns, cseL3VlanOutUnicastOctets=cseL3VlanOutUnicastOctets, cseL2HCIpPkts=cseL2HCIpPkts, cseCacheUtilEntry=cseCacheUtilEntry, cseNetflowASInfoExportGroup=cseNetflowASInfoExportGroup, cseNetflowPerVlanIfEnable=cseNetflowPerVlanIfEnable, cseRouterVlanEntry=cseRouterVlanEntry, cseIpTooShortErrors=cseIpTooShortErrors, cseNetflowLSFilterEntry=cseNetflowLSFilterEntry, cseFlowQueryRouterIndex=cseFlowQueryRouterIndex)
