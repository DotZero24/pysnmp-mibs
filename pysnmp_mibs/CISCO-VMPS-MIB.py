...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VMPS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:19 2025
...
_VmpsDownloadServerAddress_Type.__name__ = "IpAddress"
...
_VmpsConfigFileName_Type.__name__ = "DisplayString"
...
_VmpsFallbackVlan_Type.__name__ = "VlanName"
...
ciscoVlanMemberPolicyServerMIBCompliance.setObjects(
    ("CISCO-VMPS-MIB", "ciscoVlanMemberPolicyServerGroup")
)
if mibBuilder.loadTexts:
...
ciscoVmpsMIBCompliance2.setObjects(
      *(("CISCO-VMPS-MIB", "ciscoVlanMemberPolicyServerGroup"),
        ("CISCO-VMPS-MIB", "ciscoVlanMemberPolicyServerRcpGroup"),
        ("CISCO-VMPS-MIB", "ciscoVmpsAutoBackupGroup"))
)
if mibBuilder.loadTexts:
...
ciscoVmpsMIBCompliance3.setObjects(
      *(("CISCO-VMPS-MIB", "ciscoVlanMemberPolicyServerGroup"),
        ("CISCO-VMPS-MIB", "ciscoVmpsAutoBackupGroup"),
        ("CISCO-VMPS-MIB", "ciscoVlanMemberPolicyServerRcpGroup2"))
)
if mibBuilder.loadTexts:
