...
mibBuilder.exportSymbols("CISCO-VMPS-MIB", ciscoVlanMemberPolicyServerRcpGroup2=ciscoVlanMemberPolicyServerRcpGroup2, ciscoVmpsMIBCompliance3=ciscoVmpsMIBCompliance3, vmpsMacConfigEntry=vmpsMacConfigEntry, vmpsVlanConfigStatus=vmpsVlanConfigStatus, vmpsOperStatus=vmpsOperStatus, ciscoVlanMemberPolicyServerMIBGroups=ciscoVlanMemberPolicyServerMIBGroups, vmpsMacConfigAddress=vmpsMacConfigAddress, ciscoVmpsMIB=ciscoVmpsMIB, vmpsAutoBackupFileName=vmpsAutoBackupFileName, ciscoVlanMemberPolicyServerMIBCompliance=ciscoVlanMemberPolicyServerMIBCompliance, ciscoVlanMemberPolicyServerMIBObjects=ciscoVlanMemberPolicyServerMIBObjects, vmpsVlanConfigEntry=vmpsVlanConfigEntry, vmpsMacConfigStatus=vmpsMacConfigStatus, PYSNMP_MODULE_ID=ciscoVmpsMIB, ciscoVmpsMIBCompliance2=ciscoVmpsMIBCompliance2, vmpsStatsEntry=vmpsStatsEntry, vmpsMacConfigTable=vmpsMacConfigTable, vmpsConfigEntry=vmpsConfigEntry, vmpsVlanName=vmpsVlanName, ciscoVlanMemberPolicyServerGroup=ciscoVlanMemberPolicyServerGroup, ciscoVlanMemberPolicyServerMIBNotifications=ciscoVlanMemberPolicyServerMIBNotifications, vmpsSecureMode=vmpsSecureMode, vmpsIndex=vmpsIndex, vmpsInfo=vmpsInfo, ciscoVmpsAutoBackupGroup=ciscoVmpsAutoBackupGroup, ciscoVlanMemberPolicyServerRcpGroup=ciscoVlanMemberPolicyServerRcpGroup, vmpsAutoBackupEnable=vmpsAutoBackupEnable, vmpsConfigTable=vmpsConfigTable, vmpsRcpRemoteUserName=vmpsRcpRemoteUserName, vmpsOutConfigFails=vmpsOutConfigFails, vmpsGlobalConfig=vmpsGlobalConfig, vmpsMacConfigLastRequestPortId=vmpsMacConfigLastRequestPortId, vmpsVlanConfigTable=vmpsVlanConfigTable, vmpsLastFailClient=vmpsLastFailClient, vmpsDeviceId=vmpsDeviceId, vmpsAdminStatus=vmpsAdminStatus, vmpsStatsTable=vmpsStatsTable, vmpsDownloadServerAddress=vmpsDownloadServerAddress, vmpsConfigFileName=vmpsConfigFileName, VlanName=VlanName, vmpsInConfigReqs=vmpsInConfigReqs, vmpsPortName=vmpsPortName, vmpsFallbackVlan=vmpsFallbackVlan, vmpsMacConfigLastAccessed=vmpsMacConfigLastAccessed, vmpsMacConfigLastResponseStatus=vmpsMacConfigLastResponseStatus, ciscoVlanMemberPolicyServerMIBConformance=ciscoVlanMemberPolicyServerMIBConformance, vmpsInConfigErrors=vmpsInConfigErrors, vmpsDatabase=vmpsDatabase, vmpsTriggerDownload=vmpsTriggerDownload, vmpsRcpRemoteUserName2=vmpsRcpRemoteUserName2, vmpsLastRestart=vmpsLastRestart, vmpsMacConfigLastRequestor=vmpsMacConfigLastRequestor, ciscoVlanMemberPolicyServerMIBCompliances=ciscoVlanMemberPolicyServerMIBCompliances, vmpsRowStatus=vmpsRowStatus, vmpsMacConfigVlan=vmpsMacConfigVlan, vmpsManagementDomain=vmpsManagementDomain)
