...
mibBuilder.exportSymbols("MARVELL-SCT-MIB", rlSctMib=rlSctMib, rlSctCpuRate=rlSctCpuRate, PYSNMP_MODULE_ID=rlSctMib, rlSctCpuRateEnabled=rlSctCpuRateEnabled)
