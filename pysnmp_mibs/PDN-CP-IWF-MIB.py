...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-CP-IWF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:01:49 2025
...
pdnCpIwfMIBCompliance.setObjects(
      *(("PDN-CP-IWF-MIB", "pdnCpIwfGeneralConfigGroup"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfPotsPortConfigGroup"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfAal2StatsGroup"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfPotsPortStatsGroup"))
)
if mibBuilder.loadTexts:
...
pdnCpIwfMIBComplianceV2.setObjects(
      *(("PDN-CP-IWF-MIB", "pdnCpIwfGeneralConfigGroupV2"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfIADConfigGroupV2"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfAal2StatsGroup"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfPotsPortStatsGroupV2"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfPotsPortConfigGroupV2"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfPotsPortTestGroupV2"))
)
if mibBuilder.loadTexts:
...
pdnCpIwfMIBComplianceV3.setObjects(
      *(("PDN-CP-IWF-MIB", "pdnCpIwfGeneralConfigGroupV2"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfIADConfigGroupV3"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfAal2StatsGroup"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfPotsPortStatsGroupV2"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfPotsPortConfigGroupV2"),
        ("PDN-CP-IWF-MIB", "pdnCpIwfPotsPortTestGroupV2"),
