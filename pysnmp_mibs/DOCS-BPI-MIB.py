...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/rfc/DOCS-BPI-MIB
...
docsBpiCmAuthState = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 127, 5, 1, 1, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(("start", 1), ("authWait", 2), ("authorized", 3), ("reauthWait", 4), ("authRejectWait", 5)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("DOCS-BPI-MIB", docsBpiCmtsKeyRequests=docsBpiCmtsKeyRequests, docsBpiCmtsAuthInvalids=docsBpiCmtsAuthInvalids, docsBpiCmTEKGraceTime=docsBpiCmTEKGraceTime, docsBpiCmAuthInvalidErrorCode=docsBpiCmAuthInvalidErrorCode, docsBpiCmtsAuthRejects=docsBpiCmtsAuthRejects, docsBpiCmtsAuthCmRequests=docsBpiCmtsAuthCmRequests, docsBpiCmAuthRejects=docsBpiCmAuthRejects, docsBpiMulticastControl=docsBpiMulticastControl, docsBpiCmtsAuthTable=docsBpiCmtsAuthTable, docsBpiConformance=docsBpiConformance, docsBpiCmtsAuthCmPublicKey=docsBpiCmtsAuthCmPublicKey, docsBpiCmtsDefaultTEKLifetime=docsBpiCmtsDefaultTEKLifetime, docsBpiCmTEKKeyRejectErrorCode=docsBpiCmTEKKeyRejectErrorCode, docsBpiCmTEKKeyRequests=docsBpiCmTEKKeyRequests, docsBpiCmtsAuthCmExpires=docsBpiCmtsAuthCmExpires, docsBpiIpMulticastMapTable=docsBpiIpMulticastMapTable, docsBpiCmtsDefaultAuthGraceTime=docsBpiCmtsDefaultAuthGraceTime, docsBpiCmAuthRejectErrorCode=docsBpiCmAuthRejectErrorCode, docsBpiMIB=docsBpiMIB, docsBpiCmtsTEKExpiresOld=docsBpiCmtsTEKExpiresOld, docsBpiCmTEKKeyRejects=docsBpiCmTEKKeyRejects, docsBpiCmAuthInvalidErrorString=docsBpiCmAuthInvalidErrorString, docsBpiCmtsAuthCmKeySequenceNumber=docsBpiCmtsAuthCmKeySequenceNumber, docsBpiCmAuthReset=docsBpiCmAuthReset, docsBpiCmOpWaitTimeout=docsBpiCmOpWaitTimeout, docsBpiCmAuthReplies=docsBpiCmAuthReplies, docsBpiCmAuthInvalids=docsBpiCmAuthInvalids, docsBpiCmtsKeyRejectErrorCode=docsBpiCmtsKeyRejectErrorCode, docsBpiCmtsTEKGraceTime=docsBpiCmtsTEKGraceTime, docsBpiCmtsAuthCmReset=docsBpiCmtsAuthCmReset, docsBpiCmPublicKey=docsBpiCmPublicKey, docsBpiObsoleteObjectsGroup=docsBpiObsoleteObjectsGroup, docsBpiCmtsAuthCmRejects=docsBpiCmtsAuthCmRejects, docsBpiCmtsBaseEntry=docsBpiCmtsBaseEntry, docsBpiCmtsTEKTable=docsBpiCmtsTEKTable, docsBpiCmTEKExpiresNew=docsBpiCmTEKExpiresNew, docsBpiCmTEKInvalids=docsBpiCmTEKInvalids, docsBpiNotification=docsBpiNotification, docsBpiIpMulticastAddress=docsBpiIpMulticastAddress, docsBpiCmtsAuthCmGraceTime=docsBpiCmtsAuthCmGraceTime, docsBpiCmAuthRejectErrorString=docsBpiCmAuthRejectErrorString, docsBpiCmtsAuthCmMacAddress=docsBpiCmtsAuthCmMacAddress, docsBpiMulticastServiceId=docsBpiMulticastServiceId, docsBpiIpMulticastServiceId=docsBpiIpMulticastServiceId, docsBpiMulticastAuthEntry=docsBpiMulticastAuthEntry, docsBpiIpMulticastPrefixLength=docsBpiIpMulticastPrefixLength, docsBpiCmBaseTable=docsBpiCmBaseTable, docsBpiCmTEKKeyRejectErrorString=docsBpiCmTEKKeyRejectErrorString, docsBpiMulticastAuthControl=docsBpiMulticastAuthControl, docsBpiCmTEKInvalidErrorCode=docsBpiCmTEKInvalidErrorCode, docsBpiCmBaseEntry=docsBpiCmBaseEntry, docsBpiCmtsAuthEntry=docsBpiCmtsAuthEntry, docsBpiCmAuthKeySequenceNumber=docsBpiCmAuthKeySequenceNumber, docsBpiCmtsTEKEntry=docsBpiCmtsTEKEntry, docsBpiCmAuthRequests=docsBpiCmAuthRequests, docsBpiCmtsAuthRejectErrorCode=docsBpiCmtsAuthRejectErrorCode, docsBpiCmtsKeyReplies=docsBpiCmtsKeyReplies, docsBpiMulticastCmMacAddress=docsBpiMulticastCmMacAddress, docsBpiGroups=docsBpiGroups, docsBpiMulticastAuthTable=docsBpiMulticastAuthTable, docsBpiCmtsAuthCmInvalids=docsBpiCmtsAuthCmInvalids, docsBpiCmTEKTable=docsBpiCmTEKTable, docsBpiCmtsTEKLifetime=docsBpiCmtsTEKLifetime, docsBpiIpMulticastMapControl=docsBpiIpMulticastMapControl, docsBpiCmTEKState=docsBpiCmTEKState, docsBpiCmTEKExpiresOld=docsBpiCmTEKExpiresOld, docsBpiCmTEKInvalidErrorString=docsBpiCmTEKInvalidErrorString, docsBpiCmAuthWaitTimeout=docsBpiCmAuthWaitTimeout, docsBpiIpMulticastMapEntry=docsBpiIpMulticastMapEntry, docsBpiCmReauthWaitTimeout=docsBpiCmReauthWaitTimeout, docsBpiCmtsTEKExpiresNew=docsBpiCmtsTEKExpiresNew, docsBpiCmtsDefaultAuthLifetime=docsBpiCmtsDefaultAuthLifetime, docsBpiCmAuthRejectWaitTimeout=docsBpiCmAuthRejectWaitTimeout, docsBpiCmtsTEKInvalidErrorString=docsBpiCmtsTEKInvalidErrorString, docsBpiCmAuthState=docsBpiCmAuthState, docsBpiCmAuthGraceTime=docsBpiCmAuthGraceTime, docsBpiCmTEKKeyReplies=docsBpiCmTEKKeyReplies, docsBpiCmtsKeyRejects=docsBpiCmtsKeyRejects, docsBpiCmGroup=docsBpiCmGroup, docsBpiCmTEKPrivacyEnable=docsBpiCmTEKPrivacyEnable, docsBpiCmRekeyWaitTimeout=docsBpiCmRekeyWaitTimeout, docsBpiCmtsTEKInvalids=docsBpiCmtsTEKInvalids, docsBpiCmtsKeyRejectErrorString=docsBpiCmtsKeyRejectErrorString, docsBpiCompliances=docsBpiCompliances, docsBpiCmtsAuthCmLifetime=docsBpiCmtsAuthCmLifetime, docsBpiBasicCompliance=docsBpiBasicCompliance, docsBpiCmtsDefaultTEKGraceTime=docsBpiCmtsDefaultTEKGraceTime, PYSNMP_MODULE_ID=docsBpiMIB, docsBpiMIBObjects=docsBpiMIBObjects, docsBpiCmPrivacyEnable=docsBpiCmPrivacyEnable, docsBpiCmtsAuthRejectErrorString=docsBpiCmtsAuthRejectErrorString, docsBpiCmTEKAuthPends=docsBpiCmTEKAuthPends, docsBpiCmtsAuthCmReplies=docsBpiCmtsAuthCmReplies, docsBpiCmtsObjects=docsBpiCmtsObjects, docsBpiCmAuthExpires=docsBpiCmAuthExpires, docsBpiCmtsAuthInvalidErrorString=docsBpiCmtsAuthInvalidErrorString, docsBpiCmtsAuthReplies=docsBpiCmtsAuthReplies, docsBpiCmTEKEntry=docsBpiCmTEKEntry, docsBpiCmtsTEKInvalidErrorCode=docsBpiCmtsTEKInvalidErrorCode, docsBpiCmtsBaseTable=docsBpiCmtsBaseTable, docsBpiCmtsGroup=docsBpiCmtsGroup, docsBpiCmObjects=docsBpiCmObjects, docsBpiCmtsTEKReset=docsBpiCmtsTEKReset, docsBpiCmtsAuthInvalidErrorCode=docsBpiCmtsAuthInvalidErrorCode, docsBpiCmtsAuthRequests=docsBpiCmtsAuthRequests)
