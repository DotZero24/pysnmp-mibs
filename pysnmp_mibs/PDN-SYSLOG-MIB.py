...
mibBuilder.exportSymbols("PDN-SYSLOG-MIB", pdnSyslogTable=pdnSyslogTable, pdnSyslogDeprecatedGroup=pdnSyslogDeprecatedGroup, pdnSyslogNumber=pdnSyslogNumber, pdnEntitySyslogMessage=pdnEntitySyslogMessage, pdnEntitySyslogTable=pdnEntitySyslogTable, pdnEntitySyslogEntry=pdnEntitySyslogEntry, pdnSyslogNumOfMsgInTable=pdnSyslogNumOfMsgInTable, PYSNMP_MODULE_ID=pdnSyslog, pdnSyslogCompliance=pdnSyslogCompliance, pdnSyslogEntry=pdnSyslogEntry, pdnSyslogMessage=pdnSyslogMessage, pdnSyslogMsgToConsole=pdnSyslogMsgToConsole, pdnSyslogOptionalGroup=pdnSyslogOptionalGroup, pdnSyslogPort=pdnSyslogPort, pdnSyslogConformance=pdnSyslogConformance, pdnEntitySyslogNumber=pdnEntitySyslogNumber, pdnSyslogRemoteDaemon=pdnSyslogRemoteDaemon, pdnSyslogSeverityThreshold=pdnSyslogSeverityThreshold, pdnSyslogRateLimiting=pdnSyslogRateLimiting, pdnSyslogGroups=pdnSyslogGroups, pdnSyslogStatus=pdnSyslogStatus, pdnSyslogClearTable=pdnSyslogClearTable, pdnSyslogCompliances=pdnSyslogCompliances, pdnSyslog=pdnSyslog, pdnSyslogIPAddr=pdnSyslogIPAddr, pdnSyslogGroup=pdnSyslogGroup, pdnSyslogMaxTableSize=pdnSyslogMaxTableSize, pdnSyslogLevel=pdnSyslogLevel)
