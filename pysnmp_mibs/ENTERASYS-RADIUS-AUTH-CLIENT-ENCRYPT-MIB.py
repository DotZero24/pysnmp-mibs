...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-RADIUS-AUTH-CLIENT-ENCRYPT-MIB
...
etsysRadiusClientEncryptMIBCompliance.setObjects(
    ("ENTERASYS-RADIUS-AUTH-CLIENT-ENCRYPT-MIB", "etsysRadiusAuthClientEncryptMIBGroup")
)
if mibBuilder.loadTexts:
