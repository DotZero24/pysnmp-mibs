# SNMP MIB module (NETGEAR-RADLAN-STORMCTRL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-STORMCTRL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:27:37 2025
...
rlStormCtrlRateLimCfgEntry = _RlStormCtrlRateLimCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 77, 12, 1)
)
rlStormCtrlRateLimCfgEntry.setIndexNames(
    (0, "BRIDGE-MIB", "dot1dBasePort"),
    (0, "NETGEAR-RADLAN-STORMCTRL-MIB", "rlStormCtrlRateLimCfgTraffic"),
)
if mibBuilder.loadTexts:
...
rlStormCtrlClearCountersEntry = _RlStormCtrlClearCountersEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 77, 14, 1)
)
rlStormCtrlClearCountersEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-STORMCTRL-MIB", "rlStormCtrlClearCountersIndex"),
)
if mibBuilder.loadTexts:
