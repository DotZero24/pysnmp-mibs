...
vlanPort, vlanAPI, vlanAMRRules, vlanSystem, vlanAMRStats, vlanName, vlanTestAPI, vlanCountAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAPI", "vlanAMRRules", "vlanSystem", "vlanAMRStats", "vlanName", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPITotal=vlanCountAPITotal, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAdminReset=vlanSystemAdminReset, SfpsAddress=SfpsAddress, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemEntry=vlanSystemEntry, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortRouterPort=vlanPortRouterPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanId=vlanNameVlanId, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortVlanName=vlanPortVlanName, HexInteger=HexInteger, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesStatus=vlanAMRRulesStatus, SfpsSwitchPort=SfpsSwitchPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPollCount=vlanSystemPollCount, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameNHash=vlanNameNHash, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortTable=vlanPortTable, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEntry=vlanNameEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameTable=vlanNameTable, vlanSystemDomainName=vlanSystemDomainName, vlanNameNumUsers=vlanNameNumUsers)
