...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cabletron/CTRON-SFPS-VLAN-MIB
...
vlanAMRRules, vlanName, vlanAPI, vlanTestAPI, vlanAMRSubnets, vlanAMRStats, vlanPort, vlanCountAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanName", "vlanAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanPort", "vlanCountAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNHash=vlanNameNHash, HexInteger=HexInteger, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNumUsers=vlanNameNumUsers, vlanSystemOperTime=vlanSystemOperTime, vlanSystemTable=vlanSystemTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputTap=vlanTestAPIOutputTap, VlanSwitchInstance=VlanSwitchInstance, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortPortNum=vlanPortPortNum, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDomainName=vlanSystemDomainName, vlanPortEntry=vlanPortEntry, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortVlanName=vlanPortVlanName, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanPortUniPolicy=vlanPortUniPolicy, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortVlanId=vlanPortVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanName=vlanNameVlanName, vlanNameTable=vlanNameTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIPort=vlanTestAPIPort, vlanNameEntry=vlanNameEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortTable=vlanPortTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortStatus=vlanPortPortStatus, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias)
