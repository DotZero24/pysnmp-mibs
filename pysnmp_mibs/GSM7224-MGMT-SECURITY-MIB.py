# SNMP MIB module (GSM7224-MGMT-SECURITY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/GSM7224-MGMT-SECURITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:29:04 2025
...
gsm7224MgmtSecurity = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 1, 8, 11)
)
if mibBuilder.loadTexts:
    gsm7224MgmtSecurity.setRevisions(
        ("2003-11-21 00:00",)
    )
...
mibBuilder.exportSymbols(
    "GSM7224-MGMT-SECURITY-MIB",
    **{"gsm7224MgmtSecurity": gsm7224MgmtSecurity,
