# SNMP MIB module (CISCOSB-SNA-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-SNA-MIB
...
rlSnaClientAgentPollingEntry.setIndexNames(
    (0, "CISCOSB-SNA-MIB", "rlSnaClientAgentClientSessionId"),
    (0, "CISCOSB-SNA-MIB", "rlSnaClientAgentAgentAddressType"),
    (0, "CISCOSB-SNA-MIB", "rlSnaClientAgentAgentAddress"),
    (1, "CISCOSB-SNA-MIB", "rlSnaClientAgentMibName"),
)
if mibBuilder.loadTexts:
