...
dhcpClientConfig=_DhcpClientConfig_ObjectIdentity((1,3,6,1,4,1,2076,87,1))
_DhcpClientConfigTable_Object=MibTable
dhcpClientConfigTable=_DhcpClientConfigTable_Object((1,3,6,1,4,1,2076,87,1,1))
if mibBuilder.loadTexts:dhcpClientConfigTable.setStatus(_A)
_DhcpClientConfigEntry_Object=MibTableRow
dhcpClientConfigEntry=_DhcpClientConfigEntry_Object((1,3,6,1,4,1,2076,87,1,1,1))
...
dhcpClientConfigIfIndex=_DhcpClientConfigIfIndex_Object((1,3,6,1,4,1,2076,87,1,1,1,1),_DhcpClientConfigIfIndex_Type())
...
dhcpClientRenew=_DhcpClientRenew_Object((1,3,6,1,4,1,2076,87,1,1,1,2),_DhcpClientRenew_Type())
...
dhcpClientRebind=_DhcpClientRebind_Object((1,3,6,1,4,1,2076,87,1,1,1,3),_DhcpClientRebind_Type())
...
dhcpClientInform=_DhcpClientInform_Object((1,3,6,1,4,1,2076,87,1,1,1,4),_DhcpClientInform_Type())
...
dhcpClientRelease=_DhcpClientRelease_Object((1,3,6,1,4,1,2076,87,1,1,1,5),_DhcpClientRelease_Type())
...
dhcpClientIdentifier=_DhcpClientIdentifier_Object((1,3,6,1,4,1,2076,87,1,1,1,6),_DhcpClientIdentifier_Type())
...
dhcpClientDebugTrace=_DhcpClientDebugTrace_Object((1,3,6,1,4,1,2076,87,1,2),_DhcpClientDebugTrace_Type())
...
dhcpClientOptTable=_DhcpClientOptTable_Object((1,3,6,1,4,1,2076,87,1,3))
if mibBuilder.loadTexts:dhcpClientOptTable.setStatus(_A)
_DhcpClientOptEntry_Object=MibTableRow
dhcpClientOptEntry=_DhcpClientOptEntry_Object((1,3,6,1,4,1,2076,87,1,3,1))
...
dhcpClientOptIfIndex=_DhcpClientOptIfIndex_Object((1,3,6,1,4,1,2076,87,1,3,1,1),_DhcpClientOptIfIndex_Type())
...
dhcpClientOptType=_DhcpClientOptType_Object((1,3,6,1,4,1,2076,87,1,3,1,2),_DhcpClientOptType_Type())
...
dhcpClientOptLen=_DhcpClientOptLen_Object((1,3,6,1,4,1,2076,87,1,3,1,3),_DhcpClientOptLen_Type())
dhcpClientOptLen.setMaxAccess(_D)
...
dhcpClientOptVal=_DhcpClientOptVal_Object((1,3,6,1,4,1,2076,87,1,3,1,4),_DhcpClientOptVal_Type())
dhcpClientOptVal.setMaxAccess(_D)
...
dhcpClientOptRowStatus=_DhcpClientOptRowStatus_Object((1,3,6,1,4,1,2076,87,1,3,1,5),_DhcpClientOptRowStatus_Type())
...
dhcpClientFastAccess=_DhcpClientFastAccess_Object((1,3,6,1,4,1,2076,87,1,4),_DhcpClientFastAccess_Type())
...
dhcpClientFastAccessDiscoverTimeOut=_DhcpClientFastAccessDiscoverTimeOut_Object((1,3,6,1,4,1,2076,87,1,5),_DhcpClientFastAccessDiscoverTimeOut_Type())
...
dhcpClientFastAccessNullStateTimeOut=_DhcpClientFastAccessNullStateTimeOut_Object((1,3,6,1,4,1,2076,87,1,6),_DhcpClientFastAccessNullStateTimeOut_Type())
...
dhcpClientFastAccessArpCheckTimeOut=_DhcpClientFastAccessArpCheckTimeOut_Object((1,3,6,1,4,1,2076,87,1,7),_DhcpClientFastAccessArpCheckTimeOut_Type())
...
dhcpClientCounters=_DhcpClientCounters_ObjectIdentity((1,3,6,1,4,1,2076,87,2))
_DhcpClientCounterTable_Object=MibTable
dhcpClientCounterTable=_DhcpClientCounterTable_Object((1,3,6,1,4,1,2076,87,2,1))
if mibBuilder.loadTexts:dhcpClientCounterTable.setStatus(_A)
_DhcpClientCounterEntry_Object=MibTableRow
dhcpClientCounterEntry=_DhcpClientCounterEntry_Object((1,3,6,1,4,1,2076,87,2,1,1))
...
dhcpClientIfIndex=_DhcpClientIfIndex_Object((1,3,6,1,4,1,2076,87,2,1,1,1),_DhcpClientIfIndex_Type())
...
dhcpClientCountDiscovers=_DhcpClientCountDiscovers_Object((1,3,6,1,4,1,2076,87,2,1,1,2),_DhcpClientCountDiscovers_Type())
...
dhcpClientCountRequests=_DhcpClientCountRequests_Object((1,3,6,1,4,1,2076,87,2,1,1,3),_DhcpClientCountRequests_Type())
...
dhcpClientCountReleases=_DhcpClientCountReleases_Object((1,3,6,1,4,1,2076,87,2,1,1,4),_DhcpClientCountReleases_Type())
...
dhcpClientCountDeclines=_DhcpClientCountDeclines_Object((1,3,6,1,4,1,2076,87,2,1,1,5),_DhcpClientCountDeclines_Type())
...
dhcpClientCountInforms=_DhcpClientCountInforms_Object((1,3,6,1,4,1,2076,87,2,1,1,6),_DhcpClientCountInforms_Type())
...
dhcpClientCountOffers=_DhcpClientCountOffers_Object((1,3,6,1,4,1,2076,87,2,1,1,7),_DhcpClientCountOffers_Type())
...
dhcpCountAcksInReqState=_DhcpCountAcksInReqState_Object((1,3,6,1,4,1,2076,87,2,1,1,8),_DhcpCountAcksInReqState_Type())
...
dhcpCountNacksInReqState=_DhcpCountNacksInReqState_Object((1,3,6,1,4,1,2076,87,2,1,1,9),_DhcpCountNacksInReqState_Type())
...
dhcpCountAcksInRenewState=_DhcpCountAcksInRenewState_Object((1,3,6,1,4,1,2076,87,2,1,1,10),_DhcpCountAcksInRenewState_Type())
...
dhcpCountNacksInRenewState=_DhcpCountNacksInRenewState_Object((1,3,6,1,4,1,2076,87,2,1,1,11),_DhcpCountNacksInRenewState_Type())
...
dhcpCountAcksInRebindState=_DhcpCountAcksInRebindState_Object((1,3,6,1,4,1,2076,87,2,1,1,12),_DhcpCountAcksInRebindState_Type())
...
dhcpCountNacksInRebindState=_DhcpCountNacksInRebindState_Object((1,3,6,1,4,1,2076,87,2,1,1,13),_DhcpCountNacksInRebindState_Type())
...
dhcpCountAcksInRebootState=_DhcpCountAcksInRebootState_Object((1,3,6,1,4,1,2076,87,2,1,1,14),_DhcpCountAcksInRebootState_Type())
...
dhcpCountNacksInRebootState=_DhcpCountNacksInRebootState_Object((1,3,6,1,4,1,2076,87,2,1,1,15),_DhcpCountNacksInRebootState_Type())
...
dhcpCountErrorInHeader=_DhcpCountErrorInHeader_Object((1,3,6,1,4,1,2076,87,2,1,1,16),_DhcpCountErrorInHeader_Type())
...
dhcpCountErrorInXid=_DhcpCountErrorInXid_Object((1,3,6,1,4,1,2076,87,2,1,1,17),_DhcpCountErrorInXid_Type())
...
dhcpCountErrorInOptions=_DhcpCountErrorInOptions_Object((1,3,6,1,4,1,2076,87,2,1,1,18),_DhcpCountErrorInOptions_Type())
...
dhcpClientIpAddress=_DhcpClientIpAddress_Object((1,3,6,1,4,1,2076,87,2,1,1,19),_DhcpClientIpAddress_Type())
...
dhcpClientLeaseTime=_DhcpClientLeaseTime_Object((1,3,6,1,4,1,2076,87,2,1,1,20),_DhcpClientLeaseTime_Type())
...
dhcpClientCounterReset=_DhcpClientCounterReset_Object((1,3,6,1,4,1,2076,87,2,1,1,21),_DhcpClientCounterReset_Type())
...
dhcpClientRemainLeaseTime=_DhcpClientRemainLeaseTime_Object((1,3,6,1,4,1,2076,87,2,1,1,22),_DhcpClientRemainLeaseTime_Type())
