# SNMP MIB module (ARICENT-DHCP-CLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-DHCP-CLIENT-MIB
...
dhcpClientConfigEntry = _DhcpClientConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 87, 1, 1, 1)
)
dhcpClientConfigEntry.setIndexNames(
    (0, "ARICENT-DHCP-CLIENT-MIB", "dhcpClientConfigIfIndex"),
)
if mibBuilder.loadTexts:
...
dhcpClientOptLen.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
dhcpClientOptVal = _DhcpClientOptVal_Object(
    (1, 3, 6, 1, 4, 1, 2076, 87, 1, 3, 1, 4),
    _DhcpClientOptVal_Type()
)
dhcpClientOptVal.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
dhcpClientCounterEntry = _DhcpClientCounterEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 87, 2, 1, 1)
)
dhcpClientCounterEntry.setIndexNames(
    (0, "ARICENT-DHCP-CLIENT-MIB", "dhcpClientIfIndex"),
)
if mibBuilder.loadTexts:
