...
# Notes
# -----
# ASN.1 source file://mibs/raritan/LHX-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:21:17 2025
...
_OldOperationalState_Type.__name__ = "OperationalStateEnumeration"
...
deviceSerialNumber = _DeviceSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 13742, 9, 0, 0, 14),
    _DeviceSerialNumber_Type()
)
deviceSerialNumber.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
_OperationalState_Type.__name__ = "OperationalStateEnumeration"
...
_SetpointVentilators_Type.__name__ = "Integer32"
...
_SetpointWaterValve_Type.__name__ = "Integer32"
...
_DefaultFanSpeed_Type.__name__ = "Integer32"
...
_MaximumCoolingState_Type.__name__ = "TruthValue"
...
_AlertState_Type.__name__ = "TruthValue"
...
complianceRev1.setObjects(
      *(("LHX-MIB", "configurationGroup"),
        ("LHX-MIB", "measurementsGroup"),
        ("LHX-MIB", "trapInformationGroup"),
        ("LHX-MIB", "trapsGroup"))
)
if mibBuilder.loadTexts:
