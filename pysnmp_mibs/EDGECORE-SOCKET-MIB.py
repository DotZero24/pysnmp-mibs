...
mibBuilder.exportSymbols("EDGECORE-SOCKET-MIB", rlSocket=rlSocket, rlSocketUpTime=rlSocketUpTime, PYSNMP_MODULE_ID=rlSocket, rlSocketTable=rlSocketTable, rlSocketEntry=rlSocketEntry, rlSocketMibVersion=rlSocketMibVersion, rlSocketType=rlSocketType, rlSocketState=rlSocketState, rlSocketId=rlSocketId, rlSocketBlockMode=rlSocketBlockMode)
