...
agentPfcCfgGroup=_AgentPfcCfgGroup_ObjectIdentity((1,3,6,1,4,1,7244,2,47,1))
_AgentPfcTable_Object=MibTable
agentPfcTable=_AgentPfcTable_Object((1,3,6,1,4,1,7244,2,47,1,1))
if mibBuilder.loadTexts:agentPfcTable.setStatus(_A)
_AgentPfcEntry_Object=MibTableRow
agentPfcEntry=_AgentPfcEntry_Object((1,3,6,1,4,1,7244,2,47,1,1,1))
...
agentPfcIntfIndex=_AgentPfcIntfIndex_Object((1,3,6,1,4,1,7244,2,47,1,1,1,1),_AgentPfcIntfIndex_Type())
agentPfcIntfIndex.setMaxAccess(_H)
if mibBuilder.loadTexts:agentPfcIntfIndex.setStatus(_A)
class _AgentPfcIntfAdminMode_Type(Integer32):defaultValue=3;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('enable',1),('disable',2),('auto',3)))
_AgentPfcIntfAdminMode_Type.__name__=_C
_AgentPfcIntfAdminMode_Object=MibTableColumn
agentPfcIntfAdminMode=_AgentPfcIntfAdminMode_Object((1,3,6,1,4,1,7244,2,47,1,1,1,2),_AgentPfcIntfAdminMode_Type())
...
agentPfcIntfPfcStatus=_AgentPfcIntfPfcStatus_Object((1,3,6,1,4,1,7244,2,47,1,1,1,3),_AgentPfcIntfPfcStatus_Type())
...
agentPfcTotalIntfPfcFramesRx=_AgentPfcTotalIntfPfcFramesRx_Object((1,3,6,1,4,1,7244,2,47,1,1,1,4),_AgentPfcTotalIntfPfcFramesRx_Type())
...
agentPfcTotalIntfPfcFramesTx=_AgentPfcTotalIntfPfcFramesTx_Object((1,3,6,1,4,1,7244,2,47,1,1,1,5),_AgentPfcTotalIntfPfcFramesTx_Type())
...
agentPfcActionTable=_AgentPfcActionTable_Object((1,3,6,1,4,1,7244,2,47,1,2))
if mibBuilder.loadTexts:agentPfcActionTable.setStatus(_A)
_AgentPfcActionEntry_Object=MibTableRow
agentPfcActionEntry=_AgentPfcActionEntry_Object((1,3,6,1,4,1,7244,2,47,1,2,1))
...
agentPfcPriority=_AgentPfcPriority_Object((1,3,6,1,4,1,7244,2,47,1,2,1,1),_AgentPfcPriority_Type())
...
agentPfcAction=_AgentPfcAction_Object((1,3,6,1,4,1,7244,2,47,1,2,1,2),_AgentPfcAction_Type())
...
agentPfcIntfStatsPerPriorityTable=_AgentPfcIntfStatsPerPriorityTable_Object((1,3,6,1,4,1,7244,2,47,1,3))
...
agentPfcIntfStatsPerPriorityEntry=_AgentPfcIntfStatsPerPriorityEntry_Object((1,3,6,1,4,1,7244,2,47,1,3,1))
