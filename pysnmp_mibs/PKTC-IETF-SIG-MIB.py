...
mibBuilder.exportSymbols("PKTC-IETF-SIG-MIB", pktcSigDevToneFreqOffDuration=pktcSigDevToneFreqOffDuration, pktcSigDevR4Cadence=pktcSigDevR4Cadence, pktcSigEndPntConfigTable=pktcSigEndPntConfigTable, pktcSigEndPntConfigMaxHookFlash=pktcSigEndPntConfigMaxHookFlash, pktcSigDefNcsReceiveUdpPort=pktcSigDefNcsReceiveUdpPort, pktcSigDevrpAsDtsDuration=pktcSigDevrpAsDtsDuration, pktcSigDevToneDbLevel=pktcSigDevToneDbLevel, pktcSigCapabilityVersion=pktcSigCapabilityVersion, pktcSigPulseSignalEntry=pktcSigPulseSignalEntry, PktcCodecType=PktcCodecType, pktcSigDevCodecEntry=pktcSigDevCodecEntry, pktcSigEndPntConfigMinHookFlash=pktcSigEndPntConfigMinHookFlash, pktcSigDevToneSteady=pktcSigDevToneSteady, pktcSigEndPntConfigRingBackTO=pktcSigEndPntConfigRingBackTO, pktcELinePackageGroup=pktcELinePackageGroup, pktcSigEndPntConfigOffHookWarnToneTO=pktcSigEndPntConfigOffHookWarnToneTO, pktcSigEndPntConfigLongDurationKeepAlive=pktcSigEndPntConfigLongDurationKeepAlive, pktcSigCapabilityVendorExt=pktcSigCapabilityVendorExt, pktcSigDevMultiFreqToneEntry=pktcSigDevMultiFreqToneEntry, pktcSigDevToneFreqGroup=pktcSigDevToneFreqGroup, pktcSigDevCodecComboIndex=pktcSigDevCodecComboIndex, pktcSigDevR0Cadence=pktcSigDevR0Cadence, pktcSigCapabilityEntry=pktcSigCapabilityEntry, DtmfCode=DtmfCode, pktcSigNotification=pktcSigNotification, pktcSigDevVmwiMode=pktcSigDevVmwiMode, pktcSigDevCodecTable=pktcSigDevCodecTable, PktcSigType=PktcSigType, pktcSigDevVmwiDTASAfterLR=pktcSigDevVmwiDTASAfterLR, PktcRingCadence=PktcRingCadence, pktcSigDevObjects=pktcSigDevObjects, pktcSigDevCidDTASAfterLR=pktcSigDevCidDTASAfterLR, pktcSigDevRgCadence=pktcSigDevRgCadence, pktcSigEndPntConfigCriticalDialTO=pktcSigEndPntConfigCriticalDialTO, pktcSigEndPntConfigPartialDialTO=pktcSigEndPntConfigPartialDialTO, pktcSigDevRingCadenceEntry=pktcSigDevRingCadenceEntry, pktcSigDevToneFourthFreqValue=pktcSigDevToneFourthFreqValue, pktcSigEndPntConfigTdmin=pktcSigEndPntConfigTdmin, pktcSigCapabilityTable=pktcSigCapabilityTable, pktcSigEndPntConfigPulseDialMaxMakeTime=pktcSigEndPntConfigPulseDialMaxMakeTime, PYSNMP_MODULE_ID=pktcIetfSigMib, pktcSigDevToneFreqRepeatCount=pktcSigDevToneFreqRepeatCount, pktcSigEndPntConfigThist=pktcSigEndPntConfigThist, pktcSigDevVmwiSigProtocol=pktcSigDevVmwiSigProtocol, pktcSigEndPntConfigStatus=pktcSigEndPntConfigStatus, pktcSigDevToneThirdFreqValue=pktcSigDevToneThirdFreqValue, pktcSigEndPntConfigMax2=pktcSigEndPntConfigMax2, pktcSigDevVmwiAfterDTAS=pktcSigDevVmwiAfterDTAS, pktcSigDevToneTable=pktcSigDevToneTable, pktcSigDevRingCadenceIndex=pktcSigDevRingCadenceIndex, pktcSigCompliances=pktcSigCompliances, pktcSigDevVmwiDtmfEndCode=pktcSigDevVmwiDtmfEndCode, pktcSigEndPntConfigMax2QEnable=pktcSigEndPntConfigMax2QEnable, pktcSigDevToneFreqOnDuration=pktcSigDevToneFreqOnDuration, pktcSigEndPntConfigBusyToneTO=pktcSigEndPntConfigBusyToneTO, pktcSigDevToneType=pktcSigDevToneType, pktcSigDevToneFreqCounter=pktcSigDevToneFreqCounter, pktcSigEndPntConfigMWD=pktcSigEndPntConfigMWD, pktcSigDevR5Cadence=pktcSigDevR5Cadence, pktcSigEndPntConfigCallAgentUdpPort=pktcSigEndPntConfigCallAgentUdpPort, pktcSigPulseSignalTable=pktcSigPulseSignalTable, pktcSigEndPntConfigRingingTO=pktcSigEndPntConfigRingingTO, TenthdBm=TenthdBm, pktcSigPulseSignalPulseInterval=pktcSigPulseSignalPulseInterval, pktcSigDevCidDtmfEndCode=pktcSigDevCidDtmfEndCode, pktcSigDevRsCadence=pktcSigDevRsCadence, pktcSigEndPntConfigCallWaitingDelay=pktcSigEndPntConfigCallWaitingDelay, pktcSigCapabilityType=pktcSigCapabilityType, PktcSubscriberSideSigProtocol=PktcSubscriberSideSigProtocol, pktcSigEndPntConfigCallWaitingMaxRep=pktcSigEndPntConfigCallWaitingMaxRep, pktcSigDevR3Cadence=pktcSigDevR3Cadence, pktcSigDevCodecType=pktcSigDevCodecType, pktcSigDevRingCadenceTable=pktcSigDevRingCadenceTable, pktcSigDevRingAfterCID=pktcSigDevRingAfterCID, pktcSigDevR7Cadence=pktcSigDevR7Cadence, pktcSigDevCidDtmfStartCode=pktcSigDevCidDtmfStartCode, pktcSigMibObjects=pktcSigMibObjects, pktcSigPulseSignalFrequency=pktcSigPulseSignalFrequency, pktcSigDefCallSigDscp=pktcSigDefCallSigDscp, pktcSigEndPntConfigObjects=pktcSigEndPntConfigObjects, pktcSigDevCodecMax=pktcSigDevCodecMax, pktcSigDevToneFreqAmpModePrtg=pktcSigDevToneFreqAmpModePrtg, pktcSigEndPntConfigTSMax=pktcSigEndPntConfigTSMax, pktcSigEndPntConfigPulseDialMinMakeTime=pktcSigEndPntConfigPulseDialMinMakeTime, pktcSigEndPntStatusCallIpAddress=pktcSigEndPntStatusCallIpAddress, pktcSigDefMediaStreamDscp=pktcSigDefMediaStreamDscp, pktcSigDevMultiFreqToneTable=pktcSigDevMultiFreqToneTable, pktcSigEndPntConfigCallAgentId=pktcSigEndPntConfigCallAgentId, pktcSigDeviceGroup=pktcSigDeviceGroup, pktcSigPulseSignalType=pktcSigPulseSignalType, pktcSigEndPntConfigMessageWaitingTO=pktcSigEndPntConfigMessageWaitingTO, pktcSigEndPntConfigRtoMax=pktcSigEndPntConfigRtoMax, pktcSigDevVmwiAfterRPAS=pktcSigDevVmwiAfterRPAS, pktcSigGroups=pktcSigGroups, pktcSigDevCidMode=pktcSigDevCidMode, pktcSigDevCidAfterDTAS=pktcSigDevCidAfterDTAS, pktcSigDevR6Cadence=pktcSigDevR6Cadence, pktcSigEndPntConfigPulseDialMaxBreakTime=pktcSigEndPntConfigPulseDialMaxBreakTime, pktcIetfSigMib=pktcIetfSigMib, pktcSigEndPntConfigStutterDialToneTO=pktcSigEndPntConfigStutterDialToneTO, pktcSigEndPntConfigRtoInit=pktcSigEndPntConfigRtoInit, pktcSigDevToneEntry=pktcSigDevToneEntry, pktcSigEndPntConfigTdinit=pktcSigEndPntConfigTdinit, pktcSigEndPntConfigReorderToneTO=pktcSigEndPntConfigReorderToneTO, pktcSigDevRingCadence=pktcSigDevRingCadence, pktcSigEndPntConfigPulseDialInterdigitTime=pktcSigEndPntConfigPulseDialInterdigitTime, pktcSigPowerRingFrequency=pktcSigPowerRingFrequency, pktcSigDevToneSecondFreqValue=pktcSigDevToneSecondFreqValue, pktcSigDevVmwiDelayAfterLR=pktcSigDevVmwiDelayAfterLR, pktcSigConformance=pktcSigConformance, pktcSigDevToneFirstFreqValue=pktcSigDevToneFirstFreqValue, pktcSigEndPntConfigEntry=pktcSigEndPntConfigEntry, pktcSigEndPntStatusError=pktcSigEndPntStatusError, pktcSigDevEchoCancellation=pktcSigDevEchoCancellation, pktcSigDevCidAfterRing=pktcSigDevCidAfterRing, pktcSigCapabilityIndex=pktcSigCapabilityIndex, pktcSigDevSilenceSuppression=pktcSigDevSilenceSuppression, pktcSigDevR1Cadence=pktcSigDevR1Cadence, pktcSigPulseSignalRepeatCount=pktcSigPulseSignalRepeatCount, pktcInternationalGroup=pktcInternationalGroup, pktcSigEndpointGroup=pktcSigEndpointGroup, pktcSigDevR2Cadence=pktcSigDevR2Cadence, pktcSigEndPntStatusCallIpAddressType=pktcSigEndPntStatusCallIpAddressType, pktcSigEndPntConfigDialToneTO=pktcSigEndPntConfigDialToneTO, pktcSigDevCidSigProtocol=pktcSigDevCidSigProtocol, pktcSigEndPntConfigTdmax=pktcSigEndPntConfigTdmax, pktcSigEndPntConfigMax1=pktcSigEndPntConfigMax1, pktcSigEndPntConfigPulseDialMinBreakTime=pktcSigEndPntConfigPulseDialMinBreakTime, pktcSigDevToneFreqMode=pktcSigDevToneFreqMode, pktcSigEndPntConfigMax1QEnable=pktcSigEndPntConfigMax1QEnable, pktcSigBasicCompliance=pktcSigBasicCompliance, pktcSigDevToneNumber=pktcSigDevToneNumber, pktcSigDevToneWholeToneRepeatCount=pktcSigDevToneWholeToneRepeatCount, pktcSigPulseSignalDuration=pktcSigPulseSignalDuration, pktcLLinePackageGroup=pktcLLinePackageGroup, pktcSigDevCidDelayAfterLR=pktcSigDevCidDelayAfterLR, pktcSigPulseSignalDbLevel=pktcSigPulseSignalDbLevel, pktcSigDevCidAfterRPAS=pktcSigDevCidAfterRPAS, pktcSigDevVmwiDtmfStartCode=pktcSigDevVmwiDtmfStartCode)
