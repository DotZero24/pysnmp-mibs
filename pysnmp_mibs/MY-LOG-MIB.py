...
ConfigStatus,IfIndex,MyTrapType=mibBuilder.importSymbols('MY-TC','ConfigStatus','IfIndex','MyTrapType')
...
myLogMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,4))
...
myLogMIBObjects=_MyLogMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,4,1))
...
myLogGlobalStatus=_MyLogGlobalStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,1),_MyLogGlobalStatus_Type())
...
myLogSendConsoleStatus=_MyLogSendConsoleStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,2),_MyLogSendConsoleStatus_Type())
...
myLogSendConsoleMaxSeverity=_MyLogSendConsoleMaxSeverity_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,3),_MyLogSendConsoleMaxSeverity_Type())
...
myLogSendMonitorStatus=_MyLogSendMonitorStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,4),_MyLogSendMonitorStatus_Type())
...
myLogSendMonitorMaxSeverity=_MyLogSendMonitorMaxSeverity_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,5),_MyLogSendMonitorMaxSeverity_Type())
...
myLogSaveFileName=_MyLogSaveFileName_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,6),_MyLogSaveFileName_Type())
...
myLogFileMaxSeverity=_MyLogFileMaxSeverity_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,7),_MyLogFileMaxSeverity_Type())
...
myLogFileMaxSize=_MyLogFileMaxSize_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,8),_MyLogFileMaxSize_Type())
...
myLogSendBufferStatus=_MyLogSendBufferStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,9),_MyLogSendBufferStatus_Type())
...
myLogSendBufferMaxSeverity=_MyLogSendBufferMaxSeverity_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,10),_MyLogSendBufferMaxSeverity_Type())
...
myLogClearBuffer=_MyLogClearBuffer_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,11),_MyLogClearBuffer_Type())
...
myLogHisRecordMaxNum=_MyLogHisRecordMaxNum_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,12),_MyLogHisRecordMaxNum_Type())
...
myLogHisTable=_MyLogHisTable_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,13))
if mibBuilder.loadTexts:myLogHisTable.setStatus(_A)
_MyLogHisEntry_Object=MibTableRow
myLogHisEntry=_MyLogHisEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,13,1))
...
myLogHisIndex=_MyLogHisIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,13,1,1),_MyLogHisIndex_Type())
...
myLogHisSeverity=_MyLogHisSeverity_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,13,1,2),_MyLogHisSeverity_Type())
...
myLogHisMsgName=_MyLogHisMsgName_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,13,1,3),_MyLogHisMsgName_Type())
...
myLogHisDescription=_MyLogHisDescription_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,13,1,4),_MyLogHisDescription_Type())
...
myLogHisTime=_MyLogHisTime_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,13,1,5),_MyLogHisTime_Type())
...
myLogHisStamps=_MyLogHisStamps_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,13,1,6),_MyLogHisStamps_Type())
...
myLogSequenceGlobalStatus=_MyLogSequenceGlobalStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,14),_MyLogSequenceGlobalStatus_Type())
...
myLogTimeStampGlobalStatus=_MyLogTimeStampGlobalStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,15),_MyLogTimeStampGlobalStatus_Type())
...
myLogSyslogRelayGlobalStatus=_MyLogSyslogRelayGlobalStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,16),_MyLogSyslogRelayGlobalStatus_Type())
...
myLogSyslogFacility=_MyLogSyslogFacility_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,17),_MyLogSyslogFacility_Type())
...
myLogSyslogSeverity=_MyLogSyslogSeverity_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,18),_MyLogSyslogSeverity_Type())
...
myLogSyslogServerTable=_MyLogSyslogServerTable_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,19))
if mibBuilder.loadTexts:myLogSyslogServerTable.setStatus(_A)
_MyLogSyslogServerEntry_Object=MibTableRow
myLogSyslogServerEntry=_MyLogSyslogServerEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,19,1))
...
myLogSyslogServerIpAddr=_MyLogSyslogServerIpAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,19,1,1),_MyLogSyslogServerIpAddr_Type())
...
myLogSyslogServerIpStatus=_MyLogSyslogServerIpStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,19,1,2),_MyLogSyslogServerIpStatus_Type())
...
myLogSyslogSendSrcIfindex=_MyLogSyslogSendSrcIfindex_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,20),_MyLogSyslogSendSrcIfindex_Type())
...
myLogSyslogSendSrcIp=_MyLogSyslogSendSrcIp_Object((1,3,6,1,4,1,4881,1,1,10,2,4,1,21),_MyLogSyslogSendSrcIp_Type())
...
myLogMIBConformance=_MyLogMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,4,4))
_MyLogMIBCompliances_ObjectIdentity=ObjectIdentity
myLogMIBCompliances=_MyLogMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,4,4,1))
_MyLogMIBGroups_ObjectIdentity=ObjectIdentity
myLogMIBGroups=_MyLogMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,4,4,2))
myLogMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,4,4,2,1))
...
myLogHisStampsMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,4,4,2,2))
myLogHisStampsMIBGroup.setObjects((_B,_k))
if mibBuilder.loadTexts:myLogHisStampsMIBGroup.setStatus(_A)
myLogMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,4,4,1,1))
