...
dhcpsnooping=_Dhcpsnooping_ObjectIdentity((1,3,6,1,4,1,3320,2,233))
...
dhcpSnoopingStatus=_DhcpSnoopingStatus_Object((1,3,6,1,4,1,3320,2,233,1),_DhcpSnoopingStatus_Type())
...
nmsBindingsTable=_NmsBindingsTable_Object((1,3,6,1,4,1,3320,2,233,2))
if mibBuilder.loadTexts:nmsBindingsTable.setStatus(_A)
_NmsBindingsEntry_Object=MibTableRow
nmsBindingsEntry=_NmsBindingsEntry_Object((1,3,6,1,4,1,3320,2,233,2,1))
...
nmsBindingsIpAddress=_NmsBindingsIpAddress_Object((1,3,6,1,4,1,3320,2,233,2,1,1),_NmsBindingsIpAddress_Type())
...
nmsBindingsMacAddress=_NmsBindingsMacAddress_Object((1,3,6,1,4,1,3320,2,233,2,1,2),_NmsBindingsMacAddress_Type())
...
nmsBindingsVlan=_NmsBindingsVlan_Object((1,3,6,1,4,1,3320,2,233,2,1,3),_NmsBindingsVlan_Type())
...
nmsBindingsInterface=_NmsBindingsInterface_Object((1,3,6,1,4,1,3320,2,233,2,1,4),_NmsBindingsInterface_Type())
...
nmsBindingsLeasedTime=_NmsBindingsLeasedTime_Object((1,3,6,1,4,1,3320,2,233,2,1,5),_NmsBindingsLeasedTime_Type())
...
nmsBindingsType=_NmsBindingsType_Object((1,3,6,1,4,1,3320,2,233,2,1,6),_NmsBindingsType_Type())
...
nmsBindingsStatus=_NmsBindingsStatus_Object((1,3,6,1,4,1,3320,2,233,2,1,7),_NmsBindingsStatus_Type())
...
nmsBindingsrowstatus=_NmsBindingsrowstatus_Object((1,3,6,1,4,1,3320,2,233,2,1,8),_NmsBindingsrowstatus_Type())
...
nmsipsourceBindingsTable=_NmsipsourceBindingsTable_Object((1,3,6,1,4,1,3320,2,233,3))
if mibBuilder.loadTexts:nmsipsourceBindingsTable.setStatus(_A)
_NmsipsourceBindingsEntry_Object=MibTableRow
nmsipsourceBindingsEntry=_NmsipsourceBindingsEntry_Object((1,3,6,1,4,1,3320,2,233,3,1))
...
nmsipsourceBindingsrowstatus=_NmsipsourceBindingsrowstatus_Object((1,3,6,1,4,1,3320,2,233,3,1,1),_NmsipsourceBindingsrowstatus_Type())
...
nmsipsourceBindingsIpAddress=_NmsipsourceBindingsIpAddress_Object((1,3,6,1,4,1,3320,2,233,3,1,2),_NmsipsourceBindingsIpAddress_Type())
...
nmsipsourceBindingsMacAddress=_NmsipsourceBindingsMacAddress_Object((1,3,6,1,4,1,3320,2,233,3,1,3),_NmsipsourceBindingsMacAddress_Type())
...
nmsipsourceBindingsInterface=_NmsipsourceBindingsInterface_Object((1,3,6,1,4,1,3320,2,233,3,1,4),_NmsipsourceBindingsInterface_Type())
...
nmsipsourceBindingsVlanID=_NmsipsourceBindingsVlanID_Object((1,3,6,1,4,1,3320,2,233,3,1,5),_NmsipsourceBindingsVlanID_Type())
