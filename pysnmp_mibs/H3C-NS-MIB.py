...
h3cNSMibObjects=_H3cNSMibObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,20,1))
_H3cNSMibScalarObjects_ObjectIdentity=ObjectIdentity
h3cNSMibScalarObjects=_H3cNSMibScalarObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,20,1,1))
...
h3cNSActiveTime=_H3cNSActiveTime_Object((1,3,6,1,4,1,2011,10,2,20,1,1,1),_H3cNSActiveTime_Type())
...
h3cNSInactiveTime=_H3cNSInactiveTime_Object((1,3,6,1,4,1,2011,10,2,20,1,1,2),_H3cNSInactiveTime_Type())
...
h3cNSVersion=_H3cNSVersion_Object((1,3,6,1,4,1,2011,10,2,20,1,1,3),_H3cNSVersion_Type())
...
h3cNSAsType=_H3cNSAsType_Object((1,3,6,1,4,1,2011,10,2,20,1,1,4),_H3cNSAsType_Type())
...
h3cNSTemplateRefreshRate=_H3cNSTemplateRefreshRate_Object((1,3,6,1,4,1,2011,10,2,20,1,1,5),_H3cNSTemplateRefreshRate_Type())
...
h3cNSTemplateTimeout=_H3cNSTemplateTimeout_Object((1,3,6,1,4,1,2011,10,2,20,1,1,6),_H3cNSTemplateTimeout_Type())
...
h3cNSExportVlanOrIfIndex=_H3cNSExportVlanOrIfIndex_Object((1,3,6,1,4,1,2011,10,2,20,1,1,7),_H3cNSExportVlanOrIfIndex_Type())
...
h3cNSProcessSlotTable=_H3cNSProcessSlotTable_Object((1,3,6,1,4,1,2011,10,2,20,1,2))
if mibBuilder.loadTexts:h3cNSProcessSlotTable.setStatus(_A)
_H3cNSProcessSlotEntry_Object=MibTableRow
h3cNSProcessSlotEntry=_H3cNSProcessSlotEntry_Object((1,3,6,1,4,1,2011,10,2,20,1,2,1))
...
h3cNSProcessSlot=_H3cNSProcessSlot_Object((1,3,6,1,4,1,2011,10,2,20,1,2,1,1),_H3cNSProcessSlot_Type())
...
h3cNSExportConfigTable=_H3cNSExportConfigTable_Object((1,3,6,1,4,1,2011,10,2,20,1,3))
if mibBuilder.loadTexts:h3cNSExportConfigTable.setStatus(_A)
_H3cNSExportConfigEntry_Object=MibTableRow
h3cNSExportConfigEntry=_H3cNSExportConfigEntry_Object((1,3,6,1,4,1,2011,10,2,20,1,3,1))
...
h3cNSAggregationType=_H3cNSAggregationType_Object((1,3,6,1,4,1,2011,10,2,20,1,3,1,1),_H3cNSAggregationType_Type())
...
h3cNSHostIPAddr=_H3cNSHostIPAddr_Object((1,3,6,1,4,1,2011,10,2,20,1,3,1,2),_H3cNSHostIPAddr_Type())
...
h3cNSHostPort=_H3cNSHostPort_Object((1,3,6,1,4,1,2011,10,2,20,1,3,1,3),_H3cNSHostPort_Type())
...
h3cNSSrcIpAddr=_H3cNSSrcIpAddr_Object((1,3,6,1,4,1,2011,10,2,20,1,3,1,4),_H3cNSSrcIpAddr_Type())
...
h3cNSState=_H3cNSState_Object((1,3,6,1,4,1,2011,10,2,20,1,3,1,5),_H3cNSState_Type())
h3cNSState.setMaxAccess(_D)
if mibBuilder.loadTexts:h3cNSState.setStatus(_A)
_H3cNSExportInformationTable_Object=MibTable
h3cNSExportInformationTable=_H3cNSExportInformationTable_Object((1,3,6,1,4,1,2011,10,2,20,1,4))
if mibBuilder.loadTexts:h3cNSExportInformationTable.setStatus(_A)
_H3cNSExportInformationEntry_Object=MibTableRow
h3cNSExportInformationEntry=_H3cNSExportInformationEntry_Object((1,3,6,1,4,1,2011,10,2,20,1,4,1))
...
h3cNSExportType=_H3cNSExportType_Object((1,3,6,1,4,1,2011,10,2,20,1,4,1,1),_H3cNSExportType_Type())
...
h3cNSExportSlot=_H3cNSExportSlot_Object((1,3,6,1,4,1,2011,10,2,20,1,4,1,2),_H3cNSExportSlot_Type())
...
h3cNSExportStream=_H3cNSExportStream_Object((1,3,6,1,4,1,2011,10,2,20,1,4,1,3),_H3cNSExportStream_Type())
...
h3cNSExportNum=_H3cNSExportNum_Object((1,3,6,1,4,1,2011,10,2,20,1,4,1,4),_H3cNSExportNum_Type())
...
h3cNSExportFail=_H3cNSExportFail_Object((1,3,6,1,4,1,2011,10,2,20,1,4,1,5),_H3cNSExportFail_Type())
h3cNSExportFail.setMaxAccess(_C)
if mibBuilder.loadTexts:h3cNSExportFail.setStatus(_A)
_H3cNSConfigTable_Object=MibTable
h3cNSConfigTable=_H3cNSConfigTable_Object((1,3,6,1,4,1,2011,10,2,20,1,5))
if mibBuilder.loadTexts:h3cNSConfigTable.setStatus(_A)
_H3cNSConfigEntry_Object=MibTableRow
h3cNSConfigEntry=_H3cNSConfigEntry_Object((1,3,6,1,4,1,2011,10,2,20,1,5,1))
...
h3cNSSourceSlot=_H3cNSSourceSlot_Object((1,3,6,1,4,1,2011,10,2,20,1,5,1,1),_H3cNSSourceSlot_Type())
...
h3cNSSourceIfIndex=_H3cNSSourceIfIndex_Object((1,3,6,1,4,1,2011,10,2,20,1,5,1,2),_H3cNSSourceIfIndex_Type())
...
h3cNSDestSlot=_H3cNSDestSlot_Object((1,3,6,1,4,1,2011,10,2,20,1,5,1,3),_H3cNSDestSlot_Type())
...
h3cNSDirect=_H3cNSDirect_Object((1,3,6,1,4,1,2011,10,2,20,1,5,1,4),_H3cNSDirect_Type())
...
h3cNSACLNumber=_H3cNSACLNumber_Object((1,3,6,1,4,1,2011,10,2,20,1,5,1,5),_H3cNSACLNumber_Type())
...
h3cNSACLName=_H3cNSACLName_Object((1,3,6,1,4,1,2011,10,2,20,1,5,1,6),_H3cNSACLName_Type())
...
h3cNSACLRule=_H3cNSACLRule_Object((1,3,6,1,4,1,2011,10,2,20,1,5,1,7),_H3cNSACLRule_Type())
...
h3cNSConfigRowStatus=_H3cNSConfigRowStatus_Object((1,3,6,1,4,1,2011,10,2,20,1,5,1,8),_H3cNSConfigRowStatus_Type())
...
h3cNSStatusTable=_H3cNSStatusTable_Object((1,3,6,1,4,1,2011,10,2,20,1,6))
if mibBuilder.loadTexts:h3cNSStatusTable.setStatus(_A)
_H3cNSStatusEntry_Object=MibTableRow
h3cNSStatusEntry=_H3cNSStatusEntry_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1))
...
h3cNSSlot=_H3cNSSlot_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,1),_H3cNSSlot_Type())
...
h3cNSActiveStreamNumber=_H3cNSActiveStreamNumber_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,2),_H3cNSActiveStreamNumber_Type())
...
h3cNSTotalStreamNumber=_H3cNSTotalStreamNumber_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,3),_H3cNSTotalStreamNumber_Type())
...
h3cNSTotalPacketNumber=_H3cNSTotalPacketNumber_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,4),_H3cNSTotalPacketNumber_Type())
...
h3cNSTotalOctetNumber=_H3cNSTotalOctetNumber_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,5),_H3cNSTotalOctetNumber_Type())
...
h3cNSMPLSActiveStreamNumber=_H3cNSMPLSActiveStreamNumber_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,6),_H3cNSMPLSActiveStreamNumber_Type())
...
h3cNSMPLSTotalStreamNumber=_H3cNSMPLSTotalStreamNumber_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,7),_H3cNSMPLSTotalStreamNumber_Type())
...
h3cNSMPLSTotalPacketNumber=_H3cNSMPLSTotalPacketNumber_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,8),_H3cNSMPLSTotalPacketNumber_Type())
...
h3cNSMPLSTotalOctetNumber=_H3cNSMPLSTotalOctetNumber_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,9),_H3cNSMPLSTotalOctetNumber_Type())
h3cNSMPLSTotalOctetNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:h3cNSMPLSTotalOctetNumber.setStatus(_A)
class _H3cNSResetFlag_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_J,1),(_K,2)))
_H3cNSResetFlag_Type.__name__=_B
_H3cNSResetFlag_Object=MibTableColumn
h3cNSResetFlag=_H3cNSResetFlag_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,10),_H3cNSResetFlag_Type())
...
h3cNSResetTime=_H3cNSResetTime_Object((1,3,6,1,4,1,2011,10,2,20,1,6,1,11),_H3cNSResetTime_Type())
