...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/h3c/H3C-NS-MIB
...
if mibBuilder.loadTexts: h3cNS.setOrganization('Hangzhou H3C Tech. Co., Ltd.')
...
h3cNSResetFlag = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 20, 1, 6, 1, 10), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2))).clone('disabled')).setMaxAccess("readcreate")
