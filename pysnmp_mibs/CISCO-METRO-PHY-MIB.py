...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-METRO-PHY-MIB
...
mibBuilder.exportSymbols("CISCO-METRO-PHY-MIB", cmPhyCRCErrorsGroup=cmPhyCRCErrorsGroup, cmPhyHCTxEncapFarEndPktErrors=cmPhyHCTxEncapFarEndPktErrors, cmPhySonetSectionTraceReceived=cmPhySonetSectionTraceReceived, cmPhyStatisticsEntry=cmPhyStatisticsEntry, PYSNMP_MODULE_ID=ciscoMetroPhyMIB, cmPhyIf2Group=cmPhyIf2Group, cmPhyIfRate=cmPhyIfRate, cmPhyMIBCompliance=cmPhyMIBCompliance, cmPhyMIBComplianceRev5=cmPhyMIBComplianceRev5, cmPhyIfOverSubscription=cmPhyIfOverSubscription, cmPhyIfMode=cmPhyIfMode, cmPhyStatisticsTable=cmPhyStatisticsTable, cmPhyTxEncapFarEndPktErrors=cmPhyTxEncapFarEndPktErrors, cmPhyTxEncapFarEndPktErrOverflow=cmPhyTxEncapFarEndPktErrOverflow, cmPhyIfTxBufferSizeGroup=cmPhyIfTxBufferSizeGroup, ProtocolType=ProtocolType, cmPhyIfLoopback=cmPhyIfLoopback, cmPhyRxCVRD=cmPhyRxCVRD, cmPhyHCRxCVRD=cmPhyHCRxCVRD, cmPhySonetSectionTraceGroup=cmPhySonetSectionTraceGroup, cmPhyIfGroupSup1=cmPhyIfGroupSup1, cmPhyIfTable=cmPhyIfTable, cmPhyIfClientSubrateLock=cmPhyIfClientSubrateLock, cmPhyIf=cmPhyIf, ciscoMetroPhyMIBCompliances=ciscoMetroPhyMIBCompliances, cmPhyIfGroup=cmPhyIfGroup, cmPhyMIBCompliance3=cmPhyMIBCompliance3, cmPhyRxHECOverflow=cmPhyRxHECOverflow, cmPhyIfForwardLaserControl=cmPhyIfForwardLaserControl, cmPhyIfClockRate=cmPhyIfClockRate, cmPhyRxHEC=cmPhyRxHEC, TransmissionType=TransmissionType, cmPhyIfProtocol=cmPhyIfProtocol, cmPhySonetSectionTraceEntry=cmPhySonetSectionTraceEntry, ciscoMetroPhyMIBGroups=ciscoMetroPhyMIBGroups, cmPhyIfRateGroup=cmPhyIfRateGroup, ciscoMetroPhyMIBConformance=ciscoMetroPhyMIBConformance, CmNegotiatedRateType=CmNegotiatedRateType, cmPhyMIBCompliance2=cmPhyMIBCompliance2, CmRateType=CmRateType, cmPhyRxCRC=cmPhyRxCRC, cmPhyRxCVRDOverflow=cmPhyRxCVRDOverflow, ciscoMetroPhyMIB=ciscoMetroPhyMIB, cmPhySonetSectionTrace=cmPhySonetSectionTrace, cmPhySonetSectionTraceTable=cmPhySonetSectionTraceTable, cmPhySonetSectionTraceExpected=cmPhySonetSectionTraceExpected, cmPhyStatisticsGroup=cmPhyStatisticsGroup, cmPhyIfClientOvsGroup=cmPhyIfClientOvsGroup, cmPhyHCRxCRC=cmPhyHCRxCRC, cmPhyStatistics=cmPhyStatistics, cmPhyRxPower=cmPhyRxPower, cmPhyHCRxHEC=cmPhyHCRxHEC, cmPhyIfTransType=cmPhyIfTransType, cmPhyIfNegotiatedRate=cmPhyIfNegotiatedRate, cmPhyIfTxBufferSize=cmPhyIfTxBufferSize, cmPhyIfAutoNegotiation=cmPhyIfAutoNegotiation, cmPhyCVRDErrorsGroup=cmPhyCVRDErrorsGroup, cmPhyIfMonitor=cmPhyIfMonitor, cmPhyRxCRCOverflow=cmPhyRxCRCOverflow, cmPhyMIBComplianceRev6=cmPhyMIBComplianceRev6, TriValue=TriValue, cmPhyIfEntry=cmPhyIfEntry, cmPhyIfLaserSafetyControl=cmPhyIfLaserSafetyControl, cmPhyIfClientSubrateGroup=cmPhyIfClientSubrateGroup, cmPhyIfOFC=cmPhyIfOFC, cmPhyIfClientSubrate=cmPhyIfClientSubrate, cmPhyEncapFarEndPktErrorsGroup=cmPhyEncapFarEndPktErrorsGroup, cmPhyMIBComplianceRev4=cmPhyMIBComplianceRev4, cmPhyIfAutoNegGroup=cmPhyIfAutoNegGroup, ciscoMetroPhyMIBObjects=ciscoMetroPhyMIBObjects)
