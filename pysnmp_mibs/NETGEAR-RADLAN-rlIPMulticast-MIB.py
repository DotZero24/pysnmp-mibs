...
_L='not-accessible'
_K='DisplayString'
_J='NETGEAR-RADLAN-rlIPMulticast-MIB'
_I='read-only'
_H='enabled'
_G='disabled'
_F='rndErrorSeverity'
...
_D='Integer32'
_C='read-write'
_B='NETGEAR-RADLAN-DEVICEPARAMS-MIB'
_A='current'
...
rlIPmulticast=ModuleIdentity((1,3,6,1,4,1,4526,17,46))
...
rlIpmRouterEnable=_RlIpmRouterEnable_Object((1,3,6,1,4,1,4526,17,46,1),_RlIpmRouterEnable_Type())
...
rlIgmp=_RlIgmp_ObjectIdentity((1,3,6,1,4,1,4526,17,46,2))
_RlIgmpMibVersion_Type=Integer32
_RlIgmpMibVersion_Object=MibScalar
rlIgmpMibVersion=_RlIgmpMibVersion_Object((1,3,6,1,4,1,4526,17,46,2,1),_RlIgmpMibVersion_Type())
...
rlIgmpProxyDownOnly=_RlIgmpProxyDownOnly_Object((1,3,6,1,4,1,4526,17,46,2,2),_RlIgmpProxyDownOnly_Type())
...
rlMldProxyDownOnly=_RlMldProxyDownOnly_Object((1,3,6,1,4,1,4526,17,46,2,3),_RlMldProxyDownOnly_Type())
...
rlIgmpProxySsmAcl=_RlIgmpProxySsmAcl_Object((1,3,6,1,4,1,4526,17,46,2,4),_RlIgmpProxySsmAcl_Type())
...
rlMldProxySsmAcl=_RlMldProxySsmAcl_Object((1,3,6,1,4,1,4526,17,46,2,5),_RlMldProxySsmAcl_Type())
...
rlPim=_RlPim_ObjectIdentity((1,3,6,1,4,1,4526,17,46,3))
_RlPimMibVersion_Type=Integer32
_RlPimMibVersion_Object=MibScalar
rlPimMibVersion=_RlPimMibVersion_Object((1,3,6,1,4,1,4526,17,46,3,2),_RlPimMibVersion_Type())
...
rlPimEnable=_RlPimEnable_Object((1,3,6,1,4,1,4526,17,46,3,7),_RlPimEnable_Type())
rlPimEnable.setMaxAccess(_C)
if mibBuilder.loadTexts:rlPimEnable.setStatus(_A)
_RlDvmrp_ObjectIdentity=ObjectIdentity
rlDvmrp=_RlDvmrp_ObjectIdentity((1,3,6,1,4,1,4526,17,46,4))
_RlIgmpFilter_ObjectIdentity=ObjectIdentity
rlIgmpFilter=_RlIgmpFilter_ObjectIdentity((1,3,6,1,4,1,4526,17,46,6))
...
rlIgmpFilterEnable=_RlIgmpFilterEnable_Object((1,3,6,1,4,1,4526,17,46,6,1),_RlIgmpFilterEnable_Type())
...
rlIgmpFilterTable=_RlIgmpFilterTable_Object((1,3,6,1,4,1,4526,17,46,6,2))
if mibBuilder.loadTexts:rlIgmpFilterTable.setStatus(_A)
_RlIgmpFilterEntry_Object=MibTableRow
rlIgmpFilterEntry=_RlIgmpFilterEntry_Object((1,3,6,1,4,1,4526,17,46,6,2,1))
...
rlIgmpFilterIfIndex=_RlIgmpFilterIfIndex_Object((1,3,6,1,4,1,4526,17,46,6,2,1,1),_RlIgmpFilterIfIndex_Type())
...
rlIgmpFilterAddressFrom=_RlIgmpFilterAddressFrom_Object((1,3,6,1,4,1,4526,17,46,6,2,1,2),_RlIgmpFilterAddressFrom_Type())
...
rlIgmpFilterAddressTo=_RlIgmpFilterAddressTo_Object((1,3,6,1,4,1,4526,17,46,6,2,1,3),_RlIgmpFilterAddressTo_Type())
...
rlIgmpFilterUpTime=_RlIgmpFilterUpTime_Object((1,3,6,1,4,1,4526,17,46,6,2,1,4),_RlIgmpFilterUpTime_Type())
...
rlIgmpFilterStatus=_RlIgmpFilterStatus_Object((1,3,6,1,4,1,4526,17,46,6,2,1,5),_RlIgmpFilterStatus_Type())
...
rlIgmpFilterAction=_RlIgmpFilterAction_Object((1,3,6,1,4,1,4526,17,46,6,2,1,6),_RlIgmpFilterAction_Type())
...
rlPimSM=_RlPimSM_ObjectIdentity((1,3,6,1,4,1,4526,17,46,7))
...
rlPimSMEnable=_RlPimSMEnable_Object((1,3,6,1,4,1,4526,17,46,7,1),_RlPimSMEnable_Type())
...
rlPimSMMibVersion=_RlPimSMMibVersion_Object((1,3,6,1,4,1,4526,17,46,7,2),_RlPimSMMibVersion_Type())
...
rlPimSMDREnable=_RlPimSMDREnable_Object((1,3,6,1,4,1,4526,17,46,7,4),_RlPimSMDREnable_Type())
...
rlPimSMDirectedConnectedSourceEnable=_RlPimSMDirectedConnectedSourceEnable_Object((1,3,6,1,4,1,4526,17,46,7,5),_RlPimSMDirectedConnectedSourceEnable_Type())
...
rlPimSMRPEnable=_RlPimSMRPEnable_Object((1,3,6,1,4,1,4526,17,46,7,6),_RlPimSMRPEnable_Type())
...
rlPimSMSPTSwitchEnable=_RlPimSMSPTSwitchEnable_Object((1,3,6,1,4,1,4526,17,46,7,7),_RlPimSMSPTSwitchEnable_Type())
...
rlPimSmRPSetConfigurationType=_RlPimSmRPSetConfigurationType_Object((1,3,6,1,4,1,4526,17,46,7,8),_RlPimSmRPSetConfigurationType_Type())
