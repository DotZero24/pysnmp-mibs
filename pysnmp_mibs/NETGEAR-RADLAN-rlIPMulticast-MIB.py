# SNMP MIB module (NETGEAR-RADLAN-rlIPMulticast-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-rlIPMulticast-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:43 2025
...
rlIgmpFilterTable = _RlIgmpFilterTable_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 46, 6, 2)
)
if mibBuilder.loadTexts:
    rlIgmpFilterTable.setStatus("current")
_RlIgmpFilterEntry_Object = MibTableRow
rlIgmpFilterEntry = _RlIgmpFilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 46, 6, 2, 1)
)
rlIgmpFilterEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-rlIPMulticast-MIB", "rlIgmpFilterIfIndex"),
    (0, "NETGEAR-RADLAN-rlIPMulticast-MIB", "rlIgmpFilterAddressFrom"),
    (0, "NETGEAR-RADLAN-rlIPMulticast-MIB", "rlIgmpFilterAddressTo"),
)
if mibBuilder.loadTexts:
...
rlIgmpFilterIfIndex = _RlIgmpFilterIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 46, 6, 2, 1, 1),
...
rlIgmpFilterAddressFrom = _RlIgmpFilterAddressFrom_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 46, 6, 2, 1, 2),
...
rlIgmpFilterAddressTo = _RlIgmpFilterAddressTo_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 46, 6, 2, 1, 3),
...
rlIgmpFilterUpTime = _RlIgmpFilterUpTime_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 46, 6, 2, 1, 4),
...
rlIgmpFilterStatus = _RlIgmpFilterStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 46, 6, 2, 1, 5),
...
rlIgmpFilterAction = _RlIgmpFilterAction_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 46, 6, 2, 1, 6),
...
mibBuilder.exportSymbols(
    "NETGEAR-RADLAN-rlIPMulticast-MIB",
