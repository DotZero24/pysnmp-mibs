...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/nortel/ALTEON-TIGON-SWITCH-MIB
...
mibBuilder.exportSymbols("ALTEON-TIGON-SWITCH-MIB", memStatsPoolBytes=memStatsPoolBytes, agCurCfgNTPResyncInterval=agCurCfgNTPResyncInterval, agImage1Ver=agImage1Ver, agTftpServer=agTftpServer, radCurCfgTelnet=radCurCfgTelnet, agCurCfgSyslog2Host=agCurCfgSyslog2Host, radCurCfgPrimaryIpAddr=radCurCfgPrimaryIpAddr, pktStatsJumbos=pktStatsJumbos, agNewCfgSyslogTrapVlan=agNewCfgSyslogTrapVlan, agCurCfgSmtpHost=agCurCfgSmtpHost, agCurCfgSyslogTrapVrrp=agCurCfgSyslogTrapVrrp, agNewCfgLoginBanner=agNewCfgLoginBanner, agNewCfgTrapHostIndx=agNewCfgTrapHostIndx, agNewCfgSyslog2Fac=agNewCfgSyslog2Fac, agCurCfgHttpServerPort=agCurCfgHttpServerPort, agCurCfgLoginBanner=agCurCfgLoginBanner, agGeneral=agGeneral, radNewCfgRetries=radNewCfgRetries, agNewCfgSyslogTrapVrrp=agNewCfgSyslogTrapVrrp, agNewCfgSmtpHost=agNewCfgSmtpHost, agCurCfgNTPTzone=agCurCfgNTPTzone, agNewCfgSyslogTrapNtp=agNewCfgSyslogTrapNtp, agLastSetErrorReason=agLastSetErrorReason, agNewCfgNTPTzone=agNewCfgNTPTzone, agEnabledRurlKey=agEnabledRurlKey, agRevertApply=agRevertApply, agNewCfgSyslogTrapMgmt=agNewCfgSyslogTrapMgmt, agNewCfgSyslogTrapIp=agNewCfgSyslogTrapIp, agNewCfgSyslogTrapSsh=agNewCfgSyslogTrapSsh, information=information, agCurCfgSyslogTrapSynAtk=agCurCfgSyslogTrapSynAtk, stats=stats, agGeneralConfig=agGeneralConfig, agNewCfgSyslogFac=agNewCfgSyslogFac, radCurCfgTimeout=radCurCfgTimeout, agCurCfgSyslogTrapMgmt=agCurCfgSyslogTrapMgmt, agNewCfgSyslogHost=agNewCfgSyslogHost, agNewCfgConsole=agNewCfgConsole, radNewCfgAuthenString=radNewCfgAuthenString, agNewCfgSyslogTrapWeb=agNewCfgSyslogTrapWeb, agTftpLastActionStatus=agTftpLastActionStatus, agCurCfgMgmtNetwork=agCurCfgMgmtNetwork, mpCpuAStatsUtil64Seconds=mpCpuAStatsUtil64Seconds, agNewCfgSyslogTrapConsole=agNewCfgSyslogTrapConsole, agCurCfgSyslogTrapIp=agCurCfgSyslogTrapIp, agCurCfgSyslogTrapSsh=agCurCfgSyslogTrapSsh, agNewCfgTrapHostIpAddr=agNewCfgTrapHostIpAddr, agTrapHostTableMaxEnt=agTrapHostTableMaxEnt, hwRevision=hwRevision, hwRedundantPSPresent=hwRedundantPSPresent, pktStatsAllocs=pktStatsAllocs, agNewCfgHttpServerPort=agNewCfgHttpServerPort, agTftpAction=agTftpAction, altswitchTraps=altswitchTraps, agReset=agReset, radCurCfgRetries=radCurCfgRetries, memStatsAllocs=memStatsAllocs, mpCpuBStatsUtil64Seconds=mpCpuBStatsUtil64Seconds, agCurCfgSyslogTrapFilter=agCurCfgSyslogTrapFilter, memStatsFrees=memStatsFrees, agNewCfgSyslogTrapFilter=agNewCfgSyslogTrapFilter, agLog=agLog, agRtcTime=agRtcTime, agNewCfgSyslogTrapStp=agNewCfgSyslogTrapStp, agCurCfgTrapHostEntry=agCurCfgTrapHostEntry, pktStatsSmalls=pktStatsSmalls, hwSensor2Temp=hwSensor2Temp, operCmds=operCmds, agCurCfgSyslogFac=agCurCfgSyslogFac, hwSensor3Temp=hwSensor3Temp, mpCpuAStatsUtil4Seconds=mpCpuAStatsUtil4Seconds, agCurCfgNTPServer=agCurCfgNTPServer, agNewCfgMgmtNetwork=agNewCfgMgmtNetwork, agConfigForNxtReset=agConfigForNxtReset, agCurCfgNTPDlight=agCurCfgNTPDlight, agNewCfgTrapHostEntry=agNewCfgTrapHostEntry, radCurCfgPort=radCurCfgPort, agCurCfgSyslogTrapConsole=agCurCfgSyslogTrapConsole, agSoftwareVersion=agSoftwareVersion, agNewCfgSyslogTrapBgp=agNewCfgSyslogTrapBgp, agent=agent, radNewCfgSecondaryIpAddr=radNewCfgSecondaryIpAddr, memStatsBytesHiwat=memStatsBytesHiwat, agCurCfgTrapHostTable=agCurCfgTrapHostTable, agNewCfgNTPResyncInterval=agNewCfgNTPResyncInterval, agNewCfgMgmtMask=agNewCfgMgmtMask, agNewCfgSyslogTrapSlb=agNewCfgSyslogTrapSlb, agCurCfgBootp=agCurCfgBootp, agCurCfgTrapHostIndx=agCurCfgTrapHostIndx, agNewCfgTrapHostCommString=agNewCfgTrapHostCommString, memStatsAllocFails=memStatsAllocFails, agCurCfgSyslogTrapCli=agCurCfgSyslogTrapCli, agNewCfgSyslogTrapGslb=agNewCfgSyslogTrapGslb, agCurCfgSyslogTrapSlb=agCurCfgSyslogTrapSlb, agCurCfgTrapHostIpAddr=agCurCfgTrapHostIpAddr, agNewCfgSyslog2Host=agNewCfgSyslog2Host, agNewCfgSyslogTrapSynAtk=agNewCfgSyslogTrapSynAtk, agNewCfgBootp=agNewCfgBootp, hwPartNumber=hwPartNumber, agBootVer=agBootVer, agCurCfgTrapHostCommString=agCurCfgTrapHostCommString, radNewCfgState=radNewCfgState, pktStats=pktStats, pktStatsAllocFails=pktStatsAllocFails, radNewCfgPrimaryIpAddr=radNewCfgPrimaryIpAddr, agNewCfgSyslogTrapSystem=agNewCfgSyslogTrapSystem, agNewCfgNTPDlight=agNewCfgNTPDlight, agCurCfgSyslogTrapSystem=agCurCfgSyslogTrapSystem, agRevert=agRevert, agNewCfgSyslogTrapCli=agNewCfgSyslogTrapCli, agTftpImageFileName=agTftpImageFileName, agTftpImage=agTftpImage, agNewCfgTrapHostTable=agNewCfgTrapHostTable, agCurCfgSyslogTrapVlan=agCurCfgSyslogTrapVlan, agCurCfgSyslogTrapGslb=agCurCfgSyslogTrapGslb, radNewCfgTelnet=radNewCfgTelnet, agSavePending=agSavePending, radNewCfgPort=radNewCfgPort, agApplyPending=agApplyPending, radius=radius, agCurCfgSyslogHost=agCurCfgSyslogHost, agCurCfgSyslogTrapBgp=agCurCfgSyslogTrapBgp, agCurCfgSyslogTrapWeb=agCurCfgSyslogTrapWeb, agCurCfgConsole=agCurCfgConsole, hwSensor4Temp=hwSensor4Temp, radCurCfgState=radCurCfgState, memStats=memStats, agTftpDownload=agTftpDownload, radCurCfgAuthenString=radCurCfgAuthenString, agCurCfgSyslog2Fac=agCurCfgSyslog2Fac, agCurCfgSpanningTree=agCurCfgSpanningTree, agCurCfgNTPService=agCurCfgNTPService, agImageForNxtReset=agImageForNxtReset, agTftpServerIpAddr=agTftpServerIpAddr, hardware=hardware, agNewCfgSpanningTree=agNewCfgSpanningTree, pktStatsFrees=pktStatsFrees, agCurCfgSyslogTrapNtp=agCurCfgSyslogTrapNtp, agCurCfgMgmtMask=agCurCfgMgmtMask, mpCpuAStatsUtil1Second=mpCpuAStatsUtil1Second, agNewCfgNTPService=agNewCfgNTPService, agTftpCfgFileName=agTftpCfgFileName, agNewCfgNTPServer=agNewCfgNTPServer, memStatsBytesCurr=memStatsBytesCurr, radNewCfgTimeout=radNewCfgTimeout, mpCpuStats=mpCpuStats, pktStatsMediums=pktStatsMediums, agImage2Ver=agImage2Ver, agSlotNumber=agSlotNumber, hwRedundantPSStatus=hwRedundantPSStatus, mpCpuBStatsUtil4Seconds=mpCpuBStatsUtil4Seconds, radCurCfgSecondaryIpAddr=radCurCfgSecondaryIpAddr, agEnabledBwmKey=agEnabledBwmKey, agNTP=agNTP, hwPowerSupplyStatus=hwPowerSupplyStatus, agCurCfgSyslogTrapStp=agCurCfgSyslogTrapStp, agClrSyslogMsgs=agClrSyslogMsgs, agCurCfgSyslogTrapIsd=agCurCfgSyslogTrapIsd, memStatsLargest=memStatsLargest, mpCpuBStatsUtil1Second=mpCpuBStatsUtil1Second, agTftpDumpFileName=agTftpDumpFileName, agNewCfgSyslogTrapIsd=agNewCfgSyslogTrapIsd, agRtcDate=agRtcDate, agCurCfgSyslogTrapTcpLim=agCurCfgSyslogTrapTcpLim, agNewCfgSyslogTrapTcpLim=agNewCfgSyslogTrapTcpLim, agApplyConfiguration=agApplyConfiguration, hwSensor1Temp=hwSensor1Temp, agSaveConfiguration=agSaveConfiguration, agEnabledGslbKey=agEnabledGslbKey, agEnabledSwFeatures=agEnabledSwFeatures)
