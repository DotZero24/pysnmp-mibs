...
mibBuilder.exportSymbols("ALTEON-TIGON-SWITCH-MIB", agNewCfgNTPDlight=agNewCfgNTPDlight, agCurCfgSyslogTrapCli=agCurCfgSyslogTrapCli, pktStatsAllocFails=pktStatsAllocFails, agEnabledRurlKey=agEnabledRurlKey, agRevertApply=agRevertApply, agCurCfgSyslogTrapSlb=agCurCfgSyslogTrapSlb, agNewCfgLoginBanner=agNewCfgLoginBanner, agNewCfgTrapHostIndx=agNewCfgTrapHostIndx, agSaveConfiguration=agSaveConfiguration, hwSensor3Temp=hwSensor3Temp, agCurCfgNTPDlight=agCurCfgNTPDlight, agCurCfgSyslogTrapBgp=agCurCfgSyslogTrapBgp, radNewCfgTelnet=radNewCfgTelnet, memStatsBytesCurr=memStatsBytesCurr, hwPowerSupplyStatus=hwPowerSupplyStatus, agCurCfgTrapHostCommString=agCurCfgTrapHostCommString, operCmds=operCmds, agNewCfgSyslogTrapSynAtk=agNewCfgSyslogTrapSynAtk, memStatsBytesHiwat=memStatsBytesHiwat, agCurCfgSpanningTree=agCurCfgSpanningTree, agNewCfgSyslogTrapSystem=agNewCfgSyslogTrapSystem, agClrSyslogMsgs=agClrSyslogMsgs, agNTP=agNTP, agCurCfgSyslogTrapMgmt=agCurCfgSyslogTrapMgmt, mpCpuStats=mpCpuStats, agNewCfgSyslogTrapBgp=agNewCfgSyslogTrapBgp, agApplyPending=agApplyPending, mpCpuAStatsUtil64Seconds=mpCpuAStatsUtil64Seconds, agEnabledGslbKey=agEnabledGslbKey, agNewCfgConsole=agNewCfgConsole, agNewCfgSyslogTrapVrrp=agNewCfgSyslogTrapVrrp, memStatsPoolBytes=memStatsPoolBytes, radNewCfgSecondaryIpAddr=radNewCfgSecondaryIpAddr, agNewCfgSyslogTrapStp=agNewCfgSyslogTrapStp, memStatsAllocFails=memStatsAllocFails, agGeneral=agGeneral, agNewCfgSyslogTrapIsd=agNewCfgSyslogTrapIsd, radCurCfgRetries=radCurCfgRetries, agNewCfgNTPTzone=agNewCfgNTPTzone, radCurCfgSecondaryIpAddr=radCurCfgSecondaryIpAddr, pktStatsMediums=pktStatsMediums, altswitchTraps=altswitchTraps, agSavePending=agSavePending, mpCpuAStatsUtil1Second=mpCpuAStatsUtil1Second, agNewCfgSyslog2Fac=agNewCfgSyslog2Fac, radCurCfgPort=radCurCfgPort, agCurCfgSyslogTrapStp=agCurCfgSyslogTrapStp, agNewCfgSyslogTrapVlan=agNewCfgSyslogTrapVlan, radCurCfgTelnet=radCurCfgTelnet, agNewCfgSyslogTrapGslb=agNewCfgSyslogTrapGslb, agNewCfgSmtpHost=agNewCfgSmtpHost, hwPartNumber=hwPartNumber, hardware=hardware, agLog=agLog, agReset=agReset, agTrapHostTableMaxEnt=agTrapHostTableMaxEnt, agSoftwareVersion=agSoftwareVersion, agRtcTime=agRtcTime, agNewCfgSyslogTrapCli=agNewCfgSyslogTrapCli, radNewCfgState=radNewCfgState, pktStatsFrees=pktStatsFrees, agent=agent, agEnabledSwFeatures=agEnabledSwFeatures, agCurCfgSyslog2Host=agCurCfgSyslog2Host, agLastSetErrorReason=agLastSetErrorReason, agCurCfgSyslogTrapWeb=agCurCfgSyslogTrapWeb, agCurCfgMgmtNetwork=agCurCfgMgmtNetwork, agNewCfgSyslogTrapFilter=agNewCfgSyslogTrapFilter, memStatsAllocs=memStatsAllocs, agNewCfgNTPResyncInterval=agNewCfgNTPResyncInterval, agCurCfgMgmtMask=agCurCfgMgmtMask, agCurCfgSyslogHost=agCurCfgSyslogHost, radCurCfgPrimaryIpAddr=radCurCfgPrimaryIpAddr, agSlotNumber=agSlotNumber, mpCpuBStatsUtil4Seconds=mpCpuBStatsUtil4Seconds, agCurCfgNTPServer=agCurCfgNTPServer, agCurCfgSyslog2Fac=agCurCfgSyslog2Fac, hwRedundantPSStatus=hwRedundantPSStatus, agNewCfgSyslogTrapIp=agNewCfgSyslogTrapIp, agTftpLastActionStatus=agTftpLastActionStatus, agImageForNxtReset=agImageForNxtReset, agGeneralConfig=agGeneralConfig, agCurCfgNTPResyncInterval=agCurCfgNTPResyncInterval, agImage1Ver=agImage1Ver, agCurCfgNTPService=agCurCfgNTPService, radCurCfgAuthenString=radCurCfgAuthenString, agCurCfgBootp=agCurCfgBootp, agCurCfgSyslogTrapIsd=agCurCfgSyslogTrapIsd, agCurCfgTrapHostEntry=agCurCfgTrapHostEntry, information=information, agImage2Ver=agImage2Ver, agNewCfgSyslogTrapSlb=agNewCfgSyslogTrapSlb, agTftpAction=agTftpAction, agNewCfgSyslogTrapTcpLim=agNewCfgSyslogTrapTcpLim, mpCpuBStatsUtil1Second=mpCpuBStatsUtil1Second, hwRevision=hwRevision, agCurCfgTrapHostIndx=agCurCfgTrapHostIndx, agCurCfgHttpServerPort=agCurCfgHttpServerPort, agCurCfgNTPTzone=agCurCfgNTPTzone, pktStatsSmalls=pktStatsSmalls, agNewCfgMgmtMask=agNewCfgMgmtMask, agNewCfgSyslogFac=agNewCfgSyslogFac, agConfigForNxtReset=agConfigForNxtReset, agNewCfgMgmtNetwork=agNewCfgMgmtNetwork, hwRedundantPSPresent=hwRedundantPSPresent, agNewCfgNTPService=agNewCfgNTPService, agCurCfgSyslogTrapFilter=agCurCfgSyslogTrapFilter, agNewCfgTrapHostEntry=agNewCfgTrapHostEntry, radCurCfgTimeout=radCurCfgTimeout, agCurCfgTrapHostIpAddr=agCurCfgTrapHostIpAddr, mpCpuAStatsUtil4Seconds=mpCpuAStatsUtil4Seconds, agTftpImage=agTftpImage, hwSensor1Temp=hwSensor1Temp, agCurCfgSyslogFac=agCurCfgSyslogFac, agCurCfgTrapHostTable=agCurCfgTrapHostTable, agCurCfgSyslogTrapSsh=agCurCfgSyslogTrapSsh, agCurCfgSyslogTrapSynAtk=agCurCfgSyslogTrapSynAtk, agCurCfgSyslogTrapIp=agCurCfgSyslogTrapIp, agNewCfgSyslog2Host=agNewCfgSyslog2Host, mpCpuBStatsUtil64Seconds=mpCpuBStatsUtil64Seconds, agNewCfgTrapHostTable=agNewCfgTrapHostTable, agCurCfgSmtpHost=agCurCfgSmtpHost, agTftpImageFileName=agTftpImageFileName, agTftpServerIpAddr=agTftpServerIpAddr, radNewCfgPort=radNewCfgPort, memStatsLargest=memStatsLargest, stats=stats, agNewCfgTrapHostCommString=agNewCfgTrapHostCommString, agTftpDownload=agTftpDownload, agNewCfgBootp=agNewCfgBootp, agCurCfgSyslogTrapGslb=agCurCfgSyslogTrapGslb, pktStatsAllocs=pktStatsAllocs, agNewCfgNTPServer=agNewCfgNTPServer, agTftpServer=agTftpServer, hwSensor4Temp=hwSensor4Temp, agNewCfgSpanningTree=agNewCfgSpanningTree, agBootVer=agBootVer, agNewCfgSyslogTrapConsole=agNewCfgSyslogTrapConsole, agNewCfgSyslogTrapNtp=agNewCfgSyslogTrapNtp, radNewCfgRetries=radNewCfgRetries, agNewCfgSyslogTrapMgmt=agNewCfgSyslogTrapMgmt, agCurCfgSyslogTrapVrrp=agCurCfgSyslogTrapVrrp, agCurCfgConsole=agCurCfgConsole, agCurCfgSyslogTrapConsole=agCurCfgSyslogTrapConsole, agCurCfgLoginBanner=agCurCfgLoginBanner, agCurCfgSyslogTrapVlan=agCurCfgSyslogTrapVlan, agRevert=agRevert, radNewCfgTimeout=radNewCfgTimeout, agTftpDumpFileName=agTftpDumpFileName, agApplyConfiguration=agApplyConfiguration, agNewCfgSyslogHost=agNewCfgSyslogHost, agEnabledBwmKey=agEnabledBwmKey, agNewCfgHttpServerPort=agNewCfgHttpServerPort, agNewCfgTrapHostIpAddr=agNewCfgTrapHostIpAddr, agCurCfgSyslogTrapNtp=agCurCfgSyslogTrapNtp, radCurCfgState=radCurCfgState, pktStats=pktStats, agTftpCfgFileName=agTftpCfgFileName, agCurCfgSyslogTrapSystem=agCurCfgSyslogTrapSystem, memStatsFrees=memStatsFrees, pktStatsJumbos=pktStatsJumbos, agNewCfgSyslogTrapSsh=agNewCfgSyslogTrapSsh, agNewCfgSyslogTrapWeb=agNewCfgSyslogTrapWeb, radNewCfgAuthenString=radNewCfgAuthenString, radNewCfgPrimaryIpAddr=radNewCfgPrimaryIpAddr, radius=radius, memStats=memStats, agCurCfgSyslogTrapTcpLim=agCurCfgSyslogTrapTcpLim, agRtcDate=agRtcDate, hwSensor2Temp=hwSensor2Temp)
