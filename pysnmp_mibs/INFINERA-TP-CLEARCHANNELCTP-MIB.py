...
InfnSMQ, InfnServiceType, InfnServiceMode, FloatTenths = mibBuilder.importSymbols("INFINERA-TC-MIB", "InfnSMQ", "InfnServiceType", "InfnServiceMode", "FloatTenths")
...
mibBuilder.exportSymbols("INFINERA-TP-CLEARCHANNELCTP-MIB", clearChannelCtpServiceModeQualifier=clearChannelCtpServiceModeQualifier, clearChannelCtpPmHistStatsEnable=clearChannelCtpPmHistStatsEnable, clearChannelCtpGroups=clearChannelCtpGroups, PYSNMP_MODULE_ID=clearChannelCtpMIB, clearChannelCtpConformance=clearChannelCtpConformance, clearChannelCtpLoopback=clearChannelCtpLoopback, clearChannelCtpConfiguredServiceType=clearChannelCtpConfiguredServiceType, clearChannelCtpEntry=clearChannelCtpEntry, clearChannelCtpTable=clearChannelCtpTable, clearChannelCtpGroup=clearChannelCtpGroup, clearChannelCtpMIB=clearChannelCtpMIB, clearChannelCtpServiceMode=clearChannelCtpServiceMode, clearChannelCtpCompliances=clearChannelCtpCompliances, clearChannelCtpSupportingCircuitIdList=clearChannelCtpSupportingCircuitIdList, clearChannelCtpCompliance=clearChannelCtpCompliance)
