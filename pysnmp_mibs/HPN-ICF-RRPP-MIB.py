...
mibBuilder.exportSymbols("HPN-ICF-RRPP-MIB", hpnicfRrppRingTable=hpnicfRrppRingTable, hpnicfRrppDomainInstanceListLow=hpnicfRrppDomainInstanceListLow, hpnicfRrppPortTXCommonFlush=hpnicfRrppPortTXCommonFlush, hpnicfRrppRingRecover=hpnicfRrppRingRecover, hpnicfRrppPortTXMajorFault=hpnicfRrppPortTXMajorFault, hpnicfRrppPortRXEdgeHello=hpnicfRrppPortRXEdgeHello, hpnicfRrppEnableStatus=hpnicfRrppEnableStatus, hpnicfRrppRingSecondaryPort=hpnicfRrppRingSecondaryPort, hpnicfRrppRingPrimaryPort=hpnicfRrppRingPrimaryPort, hpnicfRrppScalarGroup=hpnicfRrppScalarGroup, hpnicfRrppMajorFault=hpnicfRrppMajorFault, hpnicfRrppPortRXCompleteFlush=hpnicfRrppPortRXCompleteFlush, hpnicfRrppRingNodeMode=hpnicfRrppRingNodeMode, hpnicfRrppDomainFailTime=hpnicfRrppDomainFailTime, hpnicfRrpp=hpnicfRrpp, hpnicfRrppDomainProtectVlanListLow=hpnicfRrppDomainProtectVlanListLow, hpnicfRrppRingLevel=hpnicfRrppRingLevel, hpnicfRrppTable=hpnicfRrppTable, hpnicfRrppDomainControlVlanID=hpnicfRrppDomainControlVlanID, hpnicfRrppDomainRowStatus=hpnicfRrppDomainRowStatus, hpnicfRrppRingRowStatus=hpnicfRrppRingRowStatus, hpnicfRrppPassword=hpnicfRrppPassword, hpnicfRrppPortTXHello=hpnicfRrppPortTXHello, hpnicfRrppPortRXMajorFault=hpnicfRrppPortRXMajorFault, EnabledStatus=EnabledStatus, hpnicfRrppDomainInstanceListHigh=hpnicfRrppDomainInstanceListHigh, hpnicfRrppPortTXCompleteFlush=hpnicfRrppPortTXCompleteFlush, hpnicfRrppDomainTable=hpnicfRrppDomainTable, hpnicfRrppPortRXLinkUp=hpnicfRrppPortRXLinkUp, hpnicfRrppPortRXLinkDown=hpnicfRrppPortRXLinkDown, hpnicfRrppPortTXEdgeHello=hpnicfRrppPortTXEdgeHello, hpnicfRrppPortTable=hpnicfRrppPortTable, hpnicfRrppPortState=hpnicfRrppPortState, hpnicfRrppDomainHelloTime=hpnicfRrppDomainHelloTime, hpnicfRrppDomainProtectVlanListHigh=hpnicfRrppDomainProtectVlanListHigh, hpnicfRrppPortRXCommonFlush=hpnicfRrppPortRXCommonFlush, hpnicfRrppDomainEntry=hpnicfRrppDomainEntry, hpnicfRrppDomainID=hpnicfRrppDomainID, hpnicfRrppNotifications=hpnicfRrppNotifications, hpnicfRrppProtectVlanConfigMode=hpnicfRrppProtectVlanConfigMode, hpnicfRrppRingEnableStatus=hpnicfRrppRingEnableStatus, hpnicfRrppPortRXHello=hpnicfRrppPortRXHello, hpnicfRrppPortID=hpnicfRrppPortID, PYSNMP_MODULE_ID=hpnicfRrpp, hpnicfRrppPortRXError=hpnicfRrppPortRXError, hpnicfRrppPortRole=hpnicfRrppPortRole, hpnicfRrppRingFail=hpnicfRrppRingFail, hpnicfRrppRingActive=hpnicfRrppRingActive, hpnicfRrppPasswordType=hpnicfRrppPasswordType, hpnicfRrppPortEntry=hpnicfRrppPortEntry, hpnicfRrppPortTXLinkUp=hpnicfRrppPortTXLinkUp, hpnicfRrppMultiMaster=hpnicfRrppMultiMaster, hpnicfRrppRingState=hpnicfRrppRingState, hpnicfRrppRingEntry=hpnicfRrppRingEntry, hpnicfRrppPortTXLinkDown=hpnicfRrppPortTXLinkDown, hpnicfRrppRingID=hpnicfRrppRingID)
