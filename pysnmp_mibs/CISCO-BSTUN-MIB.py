...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-BSTUN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:57 2025
...
_BstunRouteBIPPassive_Type.__name__ = "TruthValue"
...
bstunMibCompliance.setObjects(
      *(("CISCO-BSTUN-MIB", "bstunGlobalGroup"),
        ("CISCO-BSTUN-MIB", "bstunGroupGroup"),
        ("CISCO-BSTUN-MIB", "bstunPortGroup"),
        ("CISCO-BSTUN-MIB", "bstunRouteGroup"))
)
if mibBuilder.loadTexts:
...
bstunMibComplianceRev1.setObjects(
      *(("CISCO-BSTUN-MIB", "bstunGlobalGroupRev1"),
        ("CISCO-BSTUN-MIB", "bstunGroupGroup"),
        ("CISCO-BSTUN-MIB", "bstunPortGroup"),
        ("CISCO-BSTUN-MIB", "bstunRouteGroupRev1"))
)
if mibBuilder.loadTexts:
...
bstunMibComplianceRev2.setObjects(
      *(("CISCO-BSTUN-MIB", "bstunGlobalGroupRev1"),
        ("CISCO-BSTUN-MIB", "bstunGroupGroup"),
        ("CISCO-BSTUN-MIB", "bstunPortGroup"),
        ("CISCO-BSTUN-MIB", "bstunRouteGroupRev2"),
        ("CISCO-BSTUN-MIB", "bstunNotificationGroupRev1"))
)
if mibBuilder.loadTexts:
...
bstunMibComplianceRev3.setObjects(
      *(("CISCO-BSTUN-MIB", "bstunGlobalGroupRev1"),
        ("CISCO-BSTUN-MIB", "bstunGroupGroup"),
        ("CISCO-BSTUN-MIB", "bstunPortGroup"),
        ("CISCO-BSTUN-MIB", "bstunRouteGroupRev1"),
        ("CISCO-BSTUN-MIB", "bstunNotificationGroupRev1"),
        ("CISCO-BSTUN-MIB", "bstunRouteBipGroup"),
        ("CISCO-BSTUN-MIB", "bstunRoutePortsGroup"),
        ("CISCO-BSTUN-MIB", "bstunRouteApipGroup"))
)
if mibBuilder.loadTexts:
