# SNMP MIB module (LUM-TC) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/infinera/LUM-TC
...
lumTcModule = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 8708, 1, 1, 2)
)
...
class Unsigned32WithNA(TextualConvention, Unsigned32):
    ...
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 4294967292),
        ValueRangeConstraint(4294967293, 4294967293),
...
class Signed32WithNA(TextualConvention, Integer32):
    ...
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-2147483648, 2147483645),
        ValueRangeConstraint(2147483646, 2147483646),
        ValueRangeConstraint(2147483647, 2147483647),
    )
...
mibBuilder.exportSymbols(
    "LUM-TC",
    **{"MgmtNameString": MgmtNameString,
       "FaultStatus": FaultStatus,
       "SubrackNumber": SubrackNumber,
       "SlotNumber": SlotNumber,
       "PortNumber": PortNumber,
       "SignalType": SignalType,
       "PortType": PortType,
       "LambdaType": LambdaType,
       "LambdaFrequency": LambdaFrequency,
       "BoardOrInterfaceAdminStatus": BoardOrInterfaceAdminStatus,
       "BoardOrInterfaceOperStatus": BoardOrInterfaceOperStatus,
       "CommandString": CommandString,
       "SignalFormat": SignalFormat,
       "TrxMedia": TrxMedia,
       "OtnMonitorType": OtnMonitorType,
       "OtnMonitorConfig": OtnMonitorConfig,
       "OtnTIMDetMode": OtnTIMDetMode,
       "ObjectProperty": ObjectProperty,
       "PmReset": PmReset,
       "EnableDisable": EnableDisable,
       "SyncSourceState": SyncSourceState,
       "SyncSourceMode": SyncSourceMode,
       "AdminStatusWithNA": AdminStatusWithNA,
       "OperStatusWithNA": OperStatusWithNA,
       "SignalStatusWithNA": SignalStatusWithNA,
       "Unsigned32WithNA": Unsigned32WithNA,
       "EnabledDisabledWithNA": EnabledDisabledWithNA,
       "Layer": Layer,
       "Time7200min": Time7200min,
       "Time7200minNo0": Time7200minNo0,
       "Integer32WithNA": Integer32WithNA,
       "Activated": Activated,
       "ResetWithNA": ResetWithNA,
       "FaultStatusWithNA": FaultStatusWithNA,
       "MgmtNameStringWithNA": MgmtNameStringWithNA,
       "DisplayStringWithNA": DisplayStringWithNA,
       "SignalStructure": SignalStructure,
       "Signed32WithNA": Signed32WithNA,
       "LaserMode": LaserMode,
       "OnOff": OnOff,
       "LaneFrequency": LaneFrequency,
       "Frequency": Frequency,
       "FrequencyOnlyNotApplicable": FrequencyOnlyNotApplicable,
       "Rate": Rate,
       "TrxMediaWithNA": TrxMediaWithNA,
       "FecType": FecType,
       "TruthValueWithNA": TruthValueWithNA,
       "TcmMode": TcmMode,
       "TcmNumber": TcmNumber,
       "OtnTIMDetModeWithNA": OtnTIMDetModeWithNA,
       "OtnDirectionWithNA": OtnDirectionWithNA,
       "OtnAlarmMode": OtnAlarmMode,
       "CcType": CcType,
       "AutoNegotiationStatus": AutoNegotiationStatus,
       "FlowControlMode": FlowControlMode,
       "OtnType": OtnType,
       "OtnTypeWithNA": OtnTypeWithNA,
       "AuType": AuType,
       "VcType": VcType,
       "StsType": StsType,
       "StsSpeType": StsSpeType,
       "AdminStatus": AdminStatus,
       "BerLevelMTOSI": BerLevelMTOSI,
       "BerLevel": BerLevel,
       "AutoAlarmStatus": AutoAlarmStatus,
       "InterfaceStatus": InterfaceStatus,
       "OpticalLayerMappingType": OpticalLayerMappingType,
       "PhysicalLayerMappingType": PhysicalLayerMappingType,
       "TribPortIdType": TribPortIdType,
       "ServiceIdWithNotUsed": ServiceIdWithNotUsed,
       "TrxRxState": TrxRxState,
       "TrxTxState": TrxTxState,
       "DispersionSearchLimit": DispersionSearchLimit,
       "SignalDirection": SignalDirection,
       "RsFecMode": RsFecMode,
       "RsFecOnOff": RsFecOnOff,
       "MplsLabel": MplsLabel,
       "InterfaceType": InterfaceType,
       "ConnectorType": ConnectorType,
       "Platform": Platform,
       "lumTcModule": lumTcModule}
)
