...
# Notes
# -----
# ASN.1 source file://mibs/rfc/DOT3-EPON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:19:11 2025
...
_Dot3ExtPkgObjectPowerDown_Type.__name__ = "TruthValue"
...
dot3MPCPCompliance.setObjects(
      *(("DOT3-EPON-MIB", "dot3MpcpGroupBase"),
        ("DOT3-EPON-MIB", "dot3MpcpGroupStat"))
)
if mibBuilder.loadTexts:
...
dot3OmpeCompliance.setObjects(
      *(("DOT3-EPON-MIB", "dot3OmpeGroupID"),
        ("DOT3-EPON-MIB", "dot3OmpeGroupStat"))
)
if mibBuilder.loadTexts:
...
dot3EponFecCompliance.setObjects(
    ("DOT3-EPON-MIB", "dot3EponFecGroupAll")
)
if mibBuilder.loadTexts:
...
dot3ExtPkgCompliance.setObjects(
      *(("DOT3-EPON-MIB", "dot3ExtPkgGroupControl"),
        ("DOT3-EPON-MIB", "dot3ExtPkgGroupQueue"),
        ("DOT3-EPON-MIB", "dot3ExtPkgGroupQueueSets"),
        ("DOT3-EPON-MIB", "dot3ExtPkgGroupOptIf"))
)
if mibBuilder.loadTexts:
