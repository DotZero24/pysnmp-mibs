...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-PIM-NG-MIB
...
class _VRtrPimNgGenEcmpHashRebalance_Type(TruthValue):
    """Custom type vRtrPimNgGenEcmpHashRebalance based on TruthValue"""
    defaultValue = 2


_VRtrPimNgGenEcmpHashRebalance_Type.__name__ = "TruthValue"
_VRtrPimNgGenEcmpHashRebalance_Object = MibTableColumn
vRtrPimNgGenEcmpHashRebalance = _VRtrPimNgGenEcmpHashRebalance_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 2, 1, 18),
    _VRtrPimNgGenEcmpHashRebalance_Type()
)
vRtrPimNgGenEcmpHashRebalance.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgGenEcmpHashRebalance.setStatus("current")
_VRtrPimNgGenMultiStreamSpmsi_Type = TruthValue
_VRtrPimNgGenMultiStreamSpmsi_Object = MibTableColumn
vRtrPimNgGenMultiStreamSpmsi = _VRtrPimNgGenMultiStreamSpmsi_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 2, 1, 19),
    _VRtrPimNgGenMultiStreamSpmsi_Type()
)
vRtrPimNgGenMultiStreamSpmsi.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgGenMultiStreamSpmsi.setStatus("current")


class _VRtrPimNgGenBgpNhOverride_Type(TruthValue):
    """Custom type vRtrPimNgGenBgpNhOverride based on TruthValue"""
    defaultValue = 2


_VRtrPimNgGenBgpNhOverride_Type.__name__ = "TruthValue"
_VRtrPimNgGenBgpNhOverride_Object = MibTableColumn
vRtrPimNgGenBgpNhOverride = _VRtrPimNgGenBgpNhOverride_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 2, 1, 20),
    _VRtrPimNgGenBgpNhOverride_Type()
)
vRtrPimNgGenBgpNhOverride.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgGenBgpNhOverride.setStatus("current")


class _VRtrPimNgGenPimSsmScaling_Type(TruthValue):
    """Custom type vRtrPimNgGenPimSsmScaling based on TruthValue"""
    defaultValue = 2


_VRtrPimNgGenPimSsmScaling_Type.__name__ = "TruthValue"
_VRtrPimNgGenPimSsmScaling_Object = MibTableColumn
vRtrPimNgGenPimSsmScaling = _VRtrPimNgGenPimSsmScaling_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 2, 1, 21),
    _VRtrPimNgGenPimSsmScaling_Type()
)
vRtrPimNgGenPimSsmScaling.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgGenPimSsmScaling.setStatus("current")


class _VRtrPimNgGenMtuOverHead_Type(Integer32):
    """Custom type vRtrPimNgGenMtuOverHead based on Integer32"""
    defaultValue = 0
    ...
    subtypeSpec += ConstraintsUnion(
        ...
        ValueRangeConstraint(268, 268),
        ValueRangeConstraint(536, 536),
    )


_VRtrPimNgGenMtuOverHead_Type.__name__ = "Integer32"
_VRtrPimNgGenMtuOverHead_Object = MibTableColumn
vRtrPimNgGenMtuOverHead = _VRtrPimNgGenMtuOverHead_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 2, 1, 22),
    _VRtrPimNgGenMtuOverHead_Type()
)
vRtrPimNgGenMtuOverHead.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgGenMtuOverHead.setStatus("current")
...
class _VRtrPimNgAFGenMvpnOperCMcastSig_Type(Integer32):
    """Custom type vRtrPimNgAFGenMvpnOperCMcastSig based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VRtrPimNgAFGenMvpnOperCMcastSig_Type.__name__ = "Integer32"
_VRtrPimNgAFGenMvpnOperCMcastSig_Object = MibTableColumn
vRtrPimNgAFGenMvpnOperCMcastSig = _VRtrPimNgAFGenMvpnOperCMcastSig_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 4, 1, 55),
    _VRtrPimNgAFGenMvpnOperCMcastSig_Type()
)
vRtrPimNgAFGenMvpnOperCMcastSig.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgAFGenMvpnOperCMcastSig.setStatus("current")


class _VRtrPimNgAfGenAutoRPCandidate_Type(TruthValue):
    """Custom type vRtrPimNgAfGenAutoRPCandidate based on TruthValue"""
    defaultValue = 2


_VRtrPimNgAfGenAutoRPCandidate_Type.__name__ = "TruthValue"
_VRtrPimNgAfGenAutoRPCandidate_Object = MibTableColumn
vRtrPimNgAfGenAutoRPCandidate = _VRtrPimNgAfGenAutoRPCandidate_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 4, 1, 56),
    _VRtrPimNgAfGenAutoRPCandidate_Type()
)
vRtrPimNgAfGenAutoRPCandidate.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgAfGenAutoRPCandidate.setStatus("current")


class _VRtrPimNgAfGenAutoRPMappingAgent_Type(TruthValue):
    """Custom type vRtrPimNgAfGenAutoRPMappingAgent based on TruthValue"""
    defaultValue = 2


_VRtrPimNgAfGenAutoRPMappingAgent_Type.__name__ = "TruthValue"
_VRtrPimNgAfGenAutoRPMappingAgent_Object = MibTableColumn
vRtrPimNgAfGenAutoRPMappingAgent = _VRtrPimNgAfGenAutoRPMappingAgent_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 4, 1, 57),
    _VRtrPimNgAfGenAutoRPMappingAgent_Type()
)
vRtrPimNgAfGenAutoRPMappingAgent.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgAfGenAutoRPMappingAgent.setStatus("current")
_VRtrPimNgAfGenAutoRPMAIUAddrType_Type = InetAddressType
_VRtrPimNgAfGenAutoRPMAIUAddrType_Object = MibTableColumn
vRtrPimNgAfGenAutoRPMAIUAddrType = _VRtrPimNgAfGenAutoRPMAIUAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 4, 1, 58),
    _VRtrPimNgAfGenAutoRPMAIUAddrType_Type()
)
vRtrPimNgAfGenAutoRPMAIUAddrType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgAfGenAutoRPMAIUAddrType.setStatus("current")


class _VRtrPimNgAfGenAutoRPMAIUAddress_Type(InetAddress):
    """Custom type vRtrPimNgAfGenAutoRPMAIUAddress based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_VRtrPimNgAfGenAutoRPMAIUAddress_Type.__name__ = "InetAddress"
_VRtrPimNgAfGenAutoRPMAIUAddress_Object = MibTableColumn
vRtrPimNgAfGenAutoRPMAIUAddress = _VRtrPimNgAfGenAutoRPMAIUAddress_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 4, 1, 59),
    _VRtrPimNgAfGenAutoRPMAIUAddress_Type()
)
vRtrPimNgAfGenAutoRPMAIUAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgAfGenAutoRPMAIUAddress.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrPimNgGrpSrcGrpSptThreshold.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrPimNgGrpSrcGrpAdminBw.setUnits("kilobps")
...
class _VRtrPimNgGrpSrcMode_Type(Integer32):
    """Custom type vRtrPimNgGrpSrcMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VRtrPimNgGrpSrcMode_Type.__name__ = "Integer32"
_VRtrPimNgGrpSrcMode_Object = MibTableColumn
vRtrPimNgGrpSrcMode = _VRtrPimNgGrpSrcMode_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 9, 1, 64),
    _VRtrPimNgGrpSrcMode_Type()
)
vRtrPimNgGrpSrcMode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgGrpSrcMode.setStatus("current")
_VRtrPimNgGrpSrcPruneLimitTimer_Type = Unsigned32
_VRtrPimNgGrpSrcPruneLimitTimer_Object = MibTableColumn
vRtrPimNgGrpSrcPruneLimitTimer = _VRtrPimNgGrpSrcPruneLimitTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 9, 1, 65),
    _VRtrPimNgGrpSrcPruneLimitTimer_Type()
)
vRtrPimNgGrpSrcPruneLimitTimer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgGrpSrcPruneLimitTimer.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimNgGrpSrcPruneLimitTimer.setUnits("seconds")
_VRtrPimNgGrpSrcGraftRetryTimer_Type = Unsigned32
_VRtrPimNgGrpSrcGraftRetryTimer_Object = MibTableColumn
vRtrPimNgGrpSrcGraftRetryTimer = _VRtrPimNgGrpSrcGraftRetryTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 9, 1, 66),
    _VRtrPimNgGrpSrcGraftRetryTimer_Type()
)
vRtrPimNgGrpSrcGraftRetryTimer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgGrpSrcGraftRetryTimer.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimNgGrpSrcGraftRetryTimer.setUnits("seconds")
...
_VRtrPimNgGenStatRxActvPsuedoMdts_Type = Counter32
_VRtrPimNgGenStatRxActvPsuedoMdts_Object = MibTableColumn
vRtrPimNgGenStatRxActvPsuedoMdts = _VRtrPimNgGenStatRxActvPsuedoMdts_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 15, 1, 26),
    _VRtrPimNgGenStatRxActvPsuedoMdts_Type()
)
vRtrPimNgGenStatRxActvPsuedoMdts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgGenStatRxActvPsuedoMdts.setStatus("current")
_VRtrPimNgGenStatTxMsActiveMdts_Type = Counter32
_VRtrPimNgGenStatTxMsActiveMdts_Object = MibTableColumn
vRtrPimNgGenStatTxMsActiveMdts = _VRtrPimNgGenStatTxMsActiveMdts_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 15, 1, 27),
    _VRtrPimNgGenStatTxMsActiveMdts_Type()
)
vRtrPimNgGenStatTxMsActiveMdts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgGenStatTxMsActiveMdts.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrPimNgSptSwitchoverThd.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrPimNgDataMtThd.setUnits("kilobps")


class _VRtrPimNgDataMtSpmsiAddRxThd_Type(Unsigned32):
    """Custom type vRtrPimNgDataMtSpmsiAddRxThd based on Unsigned32"""
    defaultValue = 65535
...
_VRtrPimNgDataMtSpmsiAddRxThd_Type.__name__ = "Unsigned32"
_VRtrPimNgDataMtSpmsiAddRxThd_Object = MibTableColumn
vRtrPimNgDataMtSpmsiAddRxThd = _VRtrPimNgDataMtSpmsiAddRxThd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 25, 1, 7),
    _VRtrPimNgDataMtSpmsiAddRxThd_Type()
)
vRtrPimNgDataMtSpmsiAddRxThd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtSpmsiAddRxThd.setStatus("current")


class _VRtrPimNgDataMtSpmsiDelRxThd_Type(Unsigned32):
    """Custom type vRtrPimNgDataMtSpmsiDelRxThd based on Unsigned32"""
    defaultValue = 65535
...
_VRtrPimNgDataMtSpmsiDelRxThd_Type.__name__ = "Unsigned32"
_VRtrPimNgDataMtSpmsiDelRxThd_Object = MibTableColumn
vRtrPimNgDataMtSpmsiDelRxThd = _VRtrPimNgDataMtSpmsiDelRxThd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 25, 1, 8),
    _VRtrPimNgDataMtSpmsiDelRxThd_Type()
)
vRtrPimNgDataMtSpmsiDelRxThd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtSpmsiDelRxThd.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrPimNgIfMcacLevelBW.setUnits("kilobps")
...
class _VRtrPimNgExtranetCDStarGFlag_Type(TruthValue):
    """Custom type vRtrPimNgExtranetCDStarGFlag based on TruthValue"""
    defaultValue = 2


_VRtrPimNgExtranetCDStarGFlag_Type.__name__ = "TruthValue"
_VRtrPimNgExtranetCDStarGFlag_Object = MibTableColumn
vRtrPimNgExtranetCDStarGFlag = _VRtrPimNgExtranetCDStarGFlag_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 44, 1, 7),
    _VRtrPimNgExtranetCDStarGFlag_Type()
)
vRtrPimNgExtranetCDStarGFlag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgExtranetCDStarGFlag.setStatus("current")
_VRtrPimNgDataMtPlcyTblLstChg_Type = TimeStamp
_VRtrPimNgDataMtPlcyTblLstChg_Object = MibScalar
vRtrPimNgDataMtPlcyTblLstChg = _VRtrPimNgDataMtPlcyTblLstChg_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 45),
    _VRtrPimNgDataMtPlcyTblLstChg_Type()
)
vRtrPimNgDataMtPlcyTblLstChg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyTblLstChg.setStatus("current")
_VRtrPimNgDataMtPlcyTable_Object = MibTable
vRtrPimNgDataMtPlcyTable = _VRtrPimNgDataMtPlcyTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46)
)
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyTable.setStatus("current")
_VRtrPimNgDataMtPlcyEntry_Object = MibTableRow
vRtrPimNgDataMtPlcyEntry = _VRtrPimNgDataMtPlcyEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1)
)
vRtrPimNgDataMtPlcyEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyIndex"),
)
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyEntry.setStatus("current")
_VRtrPimNgDataMtPlcyIndex_Type = Unsigned32
_VRtrPimNgDataMtPlcyIndex_Object = MibTableColumn
vRtrPimNgDataMtPlcyIndex = _VRtrPimNgDataMtPlcyIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 1),
    _VRtrPimNgDataMtPlcyIndex_Type()
)
vRtrPimNgDataMtPlcyIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyIndex.setStatus("current")
_VRtrPimNgDataMtPlcyRowStatus_Type = RowStatus
_VRtrPimNgDataMtPlcyRowStatus_Object = MibTableColumn
vRtrPimNgDataMtPlcyRowStatus = _VRtrPimNgDataMtPlcyRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 2),
    _VRtrPimNgDataMtPlcyRowStatus_Type()
)
vRtrPimNgDataMtPlcyRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyRowStatus.setStatus("current")
_VRtrPimNgDataMtPlcyRowLastChg_Type = TimeStamp
_VRtrPimNgDataMtPlcyRowLastChg_Object = MibTableColumn
vRtrPimNgDataMtPlcyRowLastChg = _VRtrPimNgDataMtPlcyRowLastChg_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 3),
    _VRtrPimNgDataMtPlcyRowLastChg_Type()
)
vRtrPimNgDataMtPlcyRowLastChg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyRowLastChg.setStatus("current")


class _VRtrPimNgDataMtPlcyLspTemplate_Type(TNamedItemOrEmpty):
    """Custom type vRtrPimNgDataMtPlcyLspTemplate based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_VRtrPimNgDataMtPlcyLspTemplate_Type.__name__ = "TNamedItemOrEmpty"
_VRtrPimNgDataMtPlcyLspTemplate_Object = MibTableColumn
vRtrPimNgDataMtPlcyLspTemplate = _VRtrPimNgDataMtPlcyLspTemplate_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 4),
    _VRtrPimNgDataMtPlcyLspTemplate_Type()
)
vRtrPimNgDataMtPlcyLspTemplate.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyLspTemplate.setStatus("current")


class _VRtrPimNgDataMtPlcyAdminState_Type(TmnxAdminState):
    """Custom type vRtrPimNgDataMtPlcyAdminState based on TmnxAdminState"""
    defaultValue = 2


_VRtrPimNgDataMtPlcyAdminState_Type.__name__ = "TmnxAdminState"
_VRtrPimNgDataMtPlcyAdminState_Object = MibTableColumn
vRtrPimNgDataMtPlcyAdminState = _VRtrPimNgDataMtPlcyAdminState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 5),
    _VRtrPimNgDataMtPlcyAdminState_Type()
)
vRtrPimNgDataMtPlcyAdminState.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyAdminState.setStatus("current")


class _VRtrPimNgDataMtPlcyGrpAddrMode_Type(Integer32):
    """Custom type vRtrPimNgDataMtPlcyGrpAddrMode based on Integer32"""
    defaultValue = 1
...
_VRtrPimNgDataMtPlcyGrpAddrMode_Type.__name__ = "Integer32"
_VRtrPimNgDataMtPlcyGrpAddrMode_Object = MibTableColumn
vRtrPimNgDataMtPlcyGrpAddrMode = _VRtrPimNgDataMtPlcyGrpAddrMode_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 6),
    _VRtrPimNgDataMtPlcyGrpAddrMode_Type()
)
vRtrPimNgDataMtPlcyGrpAddrMode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyGrpAddrMode.setStatus("current")


class _VRtrPimNgDataMtPlcyGrpAddrType_Type(InetAddressType):
    """Custom type vRtrPimNgDataMtPlcyGrpAddrType based on InetAddressType"""
    defaultValue = 0


_VRtrPimNgDataMtPlcyGrpAddrType_Type.__name__ = "InetAddressType"
_VRtrPimNgDataMtPlcyGrpAddrType_Object = MibTableColumn
vRtrPimNgDataMtPlcyGrpAddrType = _VRtrPimNgDataMtPlcyGrpAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 7),
    _VRtrPimNgDataMtPlcyGrpAddrType_Type()
)
vRtrPimNgDataMtPlcyGrpAddrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyGrpAddrType.setStatus("current")


class _VRtrPimNgDataMtPlcyGrpAddr_Type(InetAddress):
    """Custom type vRtrPimNgDataMtPlcyGrpAddr based on InetAddress"""
    defaultHexValue = ""
...
_VRtrPimNgDataMtPlcyGrpAddr_Type.__name__ = "InetAddress"
_VRtrPimNgDataMtPlcyGrpAddr_Object = MibTableColumn
vRtrPimNgDataMtPlcyGrpAddr = _VRtrPimNgDataMtPlcyGrpAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 8),
    _VRtrPimNgDataMtPlcyGrpAddr_Type()
)
vRtrPimNgDataMtPlcyGrpAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcyGrpAddr.setStatus("current")


class _VRtrPimNgDataMtSpmsiStaticPlcy_Type(TNamedItemOrEmpty):
    """Custom type vRtrPimNgDataMtSpmsiStaticPlcy based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_VRtrPimNgDataMtSpmsiStaticPlcy_Type.__name__ = "TNamedItemOrEmpty"
_VRtrPimNgDataMtSpmsiStaticPlcy_Object = MibTableColumn
vRtrPimNgDataMtSpmsiStaticPlcy = _VRtrPimNgDataMtSpmsiStaticPlcy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 9),
    _VRtrPimNgDataMtSpmsiStaticPlcy_Type()
)
vRtrPimNgDataMtSpmsiStaticPlcy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtSpmsiStaticPlcy.setStatus("current")


class _VRtrPimNgDataMtSpmsiSRPlcy_Type(TruthValue):
    """Custom type vRtrPimNgDataMtSpmsiSRPlcy based on TruthValue"""
    defaultValue = 2


_VRtrPimNgDataMtSpmsiSRPlcy_Type.__name__ = "TruthValue"
_VRtrPimNgDataMtSpmsiSRPlcy_Object = MibTableColumn
vRtrPimNgDataMtSpmsiSRPlcy = _VRtrPimNgDataMtSpmsiSRPlcy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 46, 1, 10),
    _VRtrPimNgDataMtSpmsiSRPlcy_Type()
)
vRtrPimNgDataMtSpmsiSRPlcy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtSpmsiSRPlcy.setStatus("current")
_VRtrPimNgDataMtPlcySGTblLstChg_Type = TimeStamp
_VRtrPimNgDataMtPlcySGTblLstChg_Object = MibScalar
vRtrPimNgDataMtPlcySGTblLstChg = _VRtrPimNgDataMtPlcySGTblLstChg_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 47),
    _VRtrPimNgDataMtPlcySGTblLstChg_Type()
)
vRtrPimNgDataMtPlcySGTblLstChg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGTblLstChg.setStatus("current")
_VRtrPimNgDataMtPlcySGTable_Object = MibTable
vRtrPimNgDataMtPlcySGTable = _VRtrPimNgDataMtPlcySGTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48)
)
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGTable.setStatus("current")
_VRtrPimNgDataMtPlcySGEntry_Object = MibTableRow
vRtrPimNgDataMtPlcySGEntry = _VRtrPimNgDataMtPlcySGEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48, 1)
)
vRtrPimNgDataMtPlcySGEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyIndex"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcySGGrpPfxType"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcySGGrpPfxAddr"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcySGGrpPfxLen"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcySGSrcPfxType"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcySGSrcPfxAddr"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcySGSrcPfxLen"),
)
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGEntry.setStatus("current")
_VRtrPimNgDataMtPlcySGGrpPfxType_Type = InetAddressType
_VRtrPimNgDataMtPlcySGGrpPfxType_Object = MibTableColumn
vRtrPimNgDataMtPlcySGGrpPfxType = _VRtrPimNgDataMtPlcySGGrpPfxType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48, 1, 1),
    _VRtrPimNgDataMtPlcySGGrpPfxType_Type()
)
vRtrPimNgDataMtPlcySGGrpPfxType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGGrpPfxType.setStatus("current")


class _VRtrPimNgDataMtPlcySGGrpPfxAddr_Type(InetAddress):
    """Custom type vRtrPimNgDataMtPlcySGGrpPfxAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
        ValueSizeConstraint(16, 16),
...
_VRtrPimNgDataMtPlcySGGrpPfxAddr_Type.__name__ = "InetAddress"
_VRtrPimNgDataMtPlcySGGrpPfxAddr_Object = MibTableColumn
vRtrPimNgDataMtPlcySGGrpPfxAddr = _VRtrPimNgDataMtPlcySGGrpPfxAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48, 1, 2),
    _VRtrPimNgDataMtPlcySGGrpPfxAddr_Type()
)
vRtrPimNgDataMtPlcySGGrpPfxAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGGrpPfxAddr.setStatus("current")
_VRtrPimNgDataMtPlcySGGrpPfxLen_Type = InetAddressPrefixLength
_VRtrPimNgDataMtPlcySGGrpPfxLen_Object = MibTableColumn
vRtrPimNgDataMtPlcySGGrpPfxLen = _VRtrPimNgDataMtPlcySGGrpPfxLen_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48, 1, 3),
    _VRtrPimNgDataMtPlcySGGrpPfxLen_Type()
)
vRtrPimNgDataMtPlcySGGrpPfxLen.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGGrpPfxLen.setStatus("current")
_VRtrPimNgDataMtPlcySGSrcPfxType_Type = InetAddressType
_VRtrPimNgDataMtPlcySGSrcPfxType_Object = MibTableColumn
vRtrPimNgDataMtPlcySGSrcPfxType = _VRtrPimNgDataMtPlcySGSrcPfxType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48, 1, 4),
    _VRtrPimNgDataMtPlcySGSrcPfxType_Type()
)
vRtrPimNgDataMtPlcySGSrcPfxType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGSrcPfxType.setStatus("current")


class _VRtrPimNgDataMtPlcySGSrcPfxAddr_Type(InetAddress):
    """Custom type vRtrPimNgDataMtPlcySGSrcPfxAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
        ValueSizeConstraint(16, 16),
...
_VRtrPimNgDataMtPlcySGSrcPfxAddr_Type.__name__ = "InetAddress"
_VRtrPimNgDataMtPlcySGSrcPfxAddr_Object = MibTableColumn
vRtrPimNgDataMtPlcySGSrcPfxAddr = _VRtrPimNgDataMtPlcySGSrcPfxAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48, 1, 5),
    _VRtrPimNgDataMtPlcySGSrcPfxAddr_Type()
)
vRtrPimNgDataMtPlcySGSrcPfxAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGSrcPfxAddr.setStatus("current")
_VRtrPimNgDataMtPlcySGSrcPfxLen_Type = InetAddressPrefixLength
_VRtrPimNgDataMtPlcySGSrcPfxLen_Object = MibTableColumn
vRtrPimNgDataMtPlcySGSrcPfxLen = _VRtrPimNgDataMtPlcySGSrcPfxLen_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48, 1, 6),
    _VRtrPimNgDataMtPlcySGSrcPfxLen_Type()
)
vRtrPimNgDataMtPlcySGSrcPfxLen.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGSrcPfxLen.setStatus("current")
_VRtrPimNgDataMtPlcySGRowStatus_Type = RowStatus
_VRtrPimNgDataMtPlcySGRowStatus_Object = MibTableColumn
vRtrPimNgDataMtPlcySGRowStatus = _VRtrPimNgDataMtPlcySGRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48, 1, 7),
    _VRtrPimNgDataMtPlcySGRowStatus_Type()
)
vRtrPimNgDataMtPlcySGRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGRowStatus.setStatus("current")
_VRtrPimNgDataMtPlcySGRowLstChg_Type = TimeStamp
_VRtrPimNgDataMtPlcySGRowLstChg_Object = MibTableColumn
vRtrPimNgDataMtPlcySGRowLstChg = _VRtrPimNgDataMtPlcySGRowLstChg_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 1, 48, 1, 8),
    _VRtrPimNgDataMtPlcySGRowLstChg_Type()
)
vRtrPimNgDataMtPlcySGRowLstChg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtPlcySGRowLstChg.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrPimNgIfMcacUnconstrainedBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrPimNgIfMcacPreRsvdMandBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrPimNgIfMcacinUseMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrPimNgIfMcacinUseOpnlBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrPimNgIfMcacAvailMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrPimNgIfMcacAvailOpnlBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrPimNgIfP2mpLdpTreeJoin.setStatus("obsolete")
...
class _VRtrPimNgIfP2mpLdpTreeJoinType_Type(Bits):
    """Custom type vRtrPimNgIfP2mpLdpTreeJoinType based on Bits"""
    defaultBinValue = "0"
...
_VRtrPimNgIfP2mpLdpTreeJoinType_Type.__name__ = "Bits"
_VRtrPimNgIfP2mpLdpTreeJoinType_Object = MibTableColumn
vRtrPimNgIfP2mpLdpTreeJoinType = _VRtrPimNgIfP2mpLdpTreeJoinType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 2, 1, 34),
    _VRtrPimNgIfP2mpLdpTreeJoinType_Type()
)
vRtrPimNgIfP2mpLdpTreeJoinType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgIfP2mpLdpTreeJoinType.setStatus("current")


class _VRtrPimNgIfPmsiType_Type(Integer32):
    """Custom type vRtrPimNgIfPmsiType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VRtrPimNgIfPmsiType_Type.__name__ = "Integer32"
_VRtrPimNgIfPmsiType_Object = MibTableColumn
vRtrPimNgIfPmsiType = _VRtrPimNgIfPmsiType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 2, 1, 35),
    _VRtrPimNgIfPmsiType_Type()
)
vRtrPimNgIfPmsiType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfPmsiType.setStatus("current")


class _VRtrPimNgIfMcacIfPolicyName_Type(TPolicyStatementNameOrEmpty):
    """Custom type vRtrPimNgIfMcacIfPolicyName based on TPolicyStatementNameOrEmpty"""
    defaultValue = OctetString("")


_VRtrPimNgIfMcacIfPolicyName_Type.__name__ = "TPolicyStatementNameOrEmpty"
_VRtrPimNgIfMcacIfPolicyName_Object = MibTableColumn
vRtrPimNgIfMcacIfPolicyName = _VRtrPimNgIfMcacIfPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 2, 1, 36),
    _VRtrPimNgIfMcacIfPolicyName_Type()
)
vRtrPimNgIfMcacIfPolicyName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgIfMcacIfPolicyName.setStatus("current")


class _VRtrPimNgIfBierSignalingType_Type(Bits):
    """Custom type vRtrPimNgIfBierSignalingType based on Bits"""
    defaultBinValue = "0"
...
_VRtrPimNgIfBierSignalingType_Type.__name__ = "Bits"
_VRtrPimNgIfBierSignalingType_Object = MibTableColumn
vRtrPimNgIfBierSignalingType = _VRtrPimNgIfBierSignalingType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 2, 1, 37),
    _VRtrPimNgIfBierSignalingType_Type()
)
vRtrPimNgIfBierSignalingType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgIfBierSignalingType.setStatus("current")


class _VRtrPimNgIfBierSigTransportType_Type(Integer32):
    """Custom type vRtrPimNgIfBierSigTransportType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VRtrPimNgIfBierSigTransportType_Type.__name__ = "Integer32"
_VRtrPimNgIfBierSigTransportType_Object = MibTableColumn
vRtrPimNgIfBierSigTransportType = _VRtrPimNgIfBierSigTransportType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 2, 1, 38),
    _VRtrPimNgIfBierSigTransportType_Type()
)
vRtrPimNgIfBierSigTransportType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfBierSigTransportType.setStatus("current")
...
class _VRtrPimNgAFIfOperGroup_Type(TNamedItemOrEmpty):
    """Custom type vRtrPimNgAFIfOperGroup based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_VRtrPimNgAFIfOperGroup_Type.__name__ = "TNamedItemOrEmpty"
_VRtrPimNgAFIfOperGroup_Object = MibTableColumn
vRtrPimNgAFIfOperGroup = _VRtrPimNgAFIfOperGroup_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 3, 1, 13),
    _VRtrPimNgAFIfOperGroup_Type()
)
vRtrPimNgAFIfOperGroup.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgAFIfOperGroup.setStatus("current")


class _VRtrPimNgAFIfOperGroupDPAction_Type(Integer32):
    """Custom type vRtrPimNgAFIfOperGroupDPAction based on Integer32"""
    defaultValue = 0
...
_VRtrPimNgAFIfOperGroupDPAction_Type.__name__ = "Integer32"
_VRtrPimNgAFIfOperGroupDPAction_Object = MibTableColumn
vRtrPimNgAFIfOperGroupDPAction = _VRtrPimNgAFIfOperGroupDPAction_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 3, 1, 14),
    _VRtrPimNgAFIfOperGroupDPAction_Type()
)
vRtrPimNgAFIfOperGroupDPAction.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgAFIfOperGroupDPAction.setStatus("current")


class _VRtrPimNgAFIfOpGrpDeltaPriority_Type(Unsigned32):
    """Custom type vRtrPimNgAFIfOpGrpDeltaPriority based on Unsigned32"""
    defaultValue = 0


_VRtrPimNgAFIfOpGrpDeltaPriority_Type.__name__ = "Unsigned32"
_VRtrPimNgAFIfOpGrpDeltaPriority_Object = MibTableColumn
vRtrPimNgAFIfOpGrpDeltaPriority = _VRtrPimNgAFIfOpGrpDeltaPriority_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 3, 1, 15),
    _VRtrPimNgAFIfOpGrpDeltaPriority_Type()
)
vRtrPimNgAFIfOpGrpDeltaPriority.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrPimNgAFIfOpGrpDeltaPriority.setStatus("current")
...
_VRtrPimNgIfGraftsRx_Type = Counter32
_VRtrPimNgIfGraftsRx_Object = MibTableColumn
vRtrPimNgIfGraftsRx = _VRtrPimNgIfGraftsRx_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 6, 1, 79),
    _VRtrPimNgIfGraftsRx_Type()
)
vRtrPimNgIfGraftsRx.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfGraftsRx.setStatus("current")
_VRtrPimNgIfGraftsTx_Type = Counter32
_VRtrPimNgIfGraftsTx_Object = MibTableColumn
vRtrPimNgIfGraftsTx = _VRtrPimNgIfGraftsTx_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 6, 1, 80),
    _VRtrPimNgIfGraftsTx_Type()
)
vRtrPimNgIfGraftsTx.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfGraftsTx.setStatus("current")
_VRtrPimNgIfGraftsRxErrors_Type = Counter32
_VRtrPimNgIfGraftsRxErrors_Object = MibTableColumn
vRtrPimNgIfGraftsRxErrors = _VRtrPimNgIfGraftsRxErrors_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 6, 1, 81),
    _VRtrPimNgIfGraftsRxErrors_Type()
)
vRtrPimNgIfGraftsRxErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfGraftsRxErrors.setStatus("current")
_VRtrPimNgIfGraftsAckRx_Type = Counter32
_VRtrPimNgIfGraftsAckRx_Object = MibTableColumn
vRtrPimNgIfGraftsAckRx = _VRtrPimNgIfGraftsAckRx_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 6, 1, 82),
    _VRtrPimNgIfGraftsAckRx_Type()
)
vRtrPimNgIfGraftsAckRx.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfGraftsAckRx.setStatus("current")
_VRtrPimNgIfGraftsAckTx_Type = Counter32
_VRtrPimNgIfGraftsAckTx_Object = MibTableColumn
vRtrPimNgIfGraftsAckTx = _VRtrPimNgIfGraftsAckTx_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 6, 1, 83),
    _VRtrPimNgIfGraftsAckTx_Type()
)
vRtrPimNgIfGraftsAckTx.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfGraftsAckTx.setStatus("current")
_VRtrPimNgIfGraftsAckRxErrors_Type = Counter32
_VRtrPimNgIfGraftsAckRxErrors_Object = MibTableColumn
vRtrPimNgIfGraftsAckRxErrors = _VRtrPimNgIfGraftsAckRxErrors_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 6, 1, 84),
    _VRtrPimNgIfGraftsAckRxErrors_Type()
)
vRtrPimNgIfGraftsAckRxErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfGraftsAckRxErrors.setStatus("current")
_VRtrPimNgIfRxAutoRpMappingRpfMM_Type = Counter32
_VRtrPimNgIfRxAutoRpMappingRpfMM_Object = MibTableColumn
vRtrPimNgIfRxAutoRpMappingRpfMM = _VRtrPimNgIfRxAutoRpMappingRpfMM_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 6, 1, 85),
    _VRtrPimNgIfRxAutoRpMappingRpfMM_Type()
)
vRtrPimNgIfRxAutoRpMappingRpfMM.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfRxAutoRpMappingRpfMM.setStatus("current")
_VRtrPimNgIfRxAutoRpAnnounceRpfMM_Type = Counter32
_VRtrPimNgIfRxAutoRpAnnounceRpfMM_Object = MibTableColumn
vRtrPimNgIfRxAutoRpAnnounceRpfMM = _VRtrPimNgIfRxAutoRpAnnounceRpfMM_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 6, 1, 86),
    _VRtrPimNgIfRxAutoRpAnnounceRpfMM_Type()
)
vRtrPimNgIfRxAutoRpAnnounceRpfMM.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgIfRxAutoRpAnnounceRpfMM.setStatus("current")
...
_VRtrPimNgDataMtMultiStreamId_Type = Unsigned32
_VRtrPimNgDataMtMultiStreamId_Object = MibTableColumn
vRtrPimNgDataMtMultiStreamId = _VRtrPimNgDataMtMultiStreamId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 7, 1, 8),
    _VRtrPimNgDataMtMultiStreamId_Type()
)
vRtrPimNgDataMtMultiStreamId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgDataMtMultiStreamId.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrPimNgDataMtCGrpSrcDataMtThreshold.setUnits("kilobps")
...
_VRtrPimNgRsvpPmsiOperState_Type = TmnxOperState
_VRtrPimNgRsvpPmsiOperState_Object = MibTableColumn
vRtrPimNgRsvpPmsiOperState = _VRtrPimNgRsvpPmsiOperState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 11, 1, 9),
    _VRtrPimNgRsvpPmsiOperState_Type()
)
vRtrPimNgRsvpPmsiOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgRsvpPmsiOperState.setStatus("current")
_VRtrPimNgRsvpPmsiMultiStreamId_Type = Unsigned32
_VRtrPimNgRsvpPmsiMultiStreamId_Object = MibTableColumn
vRtrPimNgRsvpPmsiMultiStreamId = _VRtrPimNgRsvpPmsiMultiStreamId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 11, 1, 10),
    _VRtrPimNgRsvpPmsiMultiStreamId_Type()
)
vRtrPimNgRsvpPmsiMultiStreamId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgRsvpPmsiMultiStreamId.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrPimDataMtCGrpSrcDataThresh.setUnits("kilobps")
...
_VRtrPimRsvpPmsiCGrpSrcRxThresEn_Type = TruthValue
_VRtrPimRsvpPmsiCGrpSrcRxThresEn_Object = MibTableColumn
vRtrPimRsvpPmsiCGrpSrcRxThresEn = _VRtrPimRsvpPmsiCGrpSrcRxThresEn_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 12, 1, 12),
    _VRtrPimRsvpPmsiCGrpSrcRxThresEn_Type()
)
vRtrPimRsvpPmsiCGrpSrcRxThresEn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimRsvpPmsiCGrpSrcRxThresEn.setStatus("current")
_VRtrPimRsvpPmsiCGrpSrcRxCount_Type = Unsigned32
_VRtrPimRsvpPmsiCGrpSrcRxCount_Object = MibTableColumn
vRtrPimRsvpPmsiCGrpSrcRxCount = _VRtrPimRsvpPmsiCGrpSrcRxCount_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 12, 1, 13),
    _VRtrPimRsvpPmsiCGrpSrcRxCount_Type()
)
vRtrPimRsvpPmsiCGrpSrcRxCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimRsvpPmsiCGrpSrcRxCount.setStatus("current")
...
_VRtrPimNgLdpPmsiOperState_Type = TmnxOperState
_VRtrPimNgLdpPmsiOperState_Object = MibTableColumn
vRtrPimNgLdpPmsiOperState = _VRtrPimNgLdpPmsiOperState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 13, 1, 9),
    _VRtrPimNgLdpPmsiOperState_Type()
)
vRtrPimNgLdpPmsiOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgLdpPmsiOperState.setStatus("current")
_VRtrPimNgLdpPmsiMultiStreamId_Type = Unsigned32
_VRtrPimNgLdpPmsiMultiStreamId_Object = MibTableColumn
vRtrPimNgLdpPmsiMultiStreamId = _VRtrPimNgLdpPmsiMultiStreamId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 13, 1, 10),
    _VRtrPimNgLdpPmsiMultiStreamId_Type()
)
vRtrPimNgLdpPmsiMultiStreamId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgLdpPmsiMultiStreamId.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrPimLdpDataMtCGrpSrcDataThres.setUnits("kilobps")
...
_VRtrPimLdpPmsiCGrpSrcRxThresEnbl_Type = TruthValue
_VRtrPimLdpPmsiCGrpSrcRxThresEnbl_Object = MibTableColumn
vRtrPimLdpPmsiCGrpSrcRxThresEnbl = _VRtrPimLdpPmsiCGrpSrcRxThresEnbl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 14, 1, 12),
    _VRtrPimLdpPmsiCGrpSrcRxThresEnbl_Type()
)
vRtrPimLdpPmsiCGrpSrcRxThresEnbl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimLdpPmsiCGrpSrcRxThresEnbl.setStatus("current")
_VRtrPimLdpPmsiCGrpSrcRxCount_Type = Unsigned32
_VRtrPimLdpPmsiCGrpSrcRxCount_Object = MibTableColumn
vRtrPimLdpPmsiCGrpSrcRxCount = _VRtrPimLdpPmsiCGrpSrcRxCount_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 14, 1, 13),
    _VRtrPimLdpPmsiCGrpSrcRxCount_Type()
)
vRtrPimLdpPmsiCGrpSrcRxCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimLdpPmsiCGrpSrcRxCount.setStatus("current")
...
_VRtrPimNgBierPmsiTable_Object = MibTable
vRtrPimNgBierPmsiTable = _VRtrPimNgBierPmsiTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19)
)
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiTable.setStatus("current")
_VRtrPimNgBierPmsiEntry_Object = MibTableRow
vRtrPimNgBierPmsiEntry = _VRtrPimNgBierPmsiEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1)
)
vRtrPimNgBierPmsiEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiRootAddrType"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiRootAddr"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiSubDomainId"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierBfrId"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiMplsLabel"),
)
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiEntry.setStatus("current")
_VRtrPimNgBierPmsiRootAddrType_Type = InetAddressType
_VRtrPimNgBierPmsiRootAddrType_Object = MibTableColumn
vRtrPimNgBierPmsiRootAddrType = _VRtrPimNgBierPmsiRootAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 1),
    _VRtrPimNgBierPmsiRootAddrType_Type()
)
vRtrPimNgBierPmsiRootAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiRootAddrType.setStatus("current")


class _VRtrPimNgBierPmsiRootAddr_Type(InetAddress):
    """Custom type vRtrPimNgBierPmsiRootAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_VRtrPimNgBierPmsiRootAddr_Type.__name__ = "InetAddress"
_VRtrPimNgBierPmsiRootAddr_Object = MibTableColumn
vRtrPimNgBierPmsiRootAddr = _VRtrPimNgBierPmsiRootAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 2),
    _VRtrPimNgBierPmsiRootAddr_Type()
)
vRtrPimNgBierPmsiRootAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiRootAddr.setStatus("current")
_VRtrPimNgBierPmsiSubDomainId_Type = Unsigned32
_VRtrPimNgBierPmsiSubDomainId_Object = MibTableColumn
vRtrPimNgBierPmsiSubDomainId = _VRtrPimNgBierPmsiSubDomainId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 3),
    _VRtrPimNgBierPmsiSubDomainId_Type()
)
vRtrPimNgBierPmsiSubDomainId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiSubDomainId.setStatus("current")
_VRtrPimNgBierBfrId_Type = Unsigned32
_VRtrPimNgBierBfrId_Object = MibTableColumn
vRtrPimNgBierBfrId = _VRtrPimNgBierBfrId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 4),
    _VRtrPimNgBierBfrId_Type()
)
vRtrPimNgBierBfrId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgBierBfrId.setStatus("current")
_VRtrPimNgBierPmsiMplsLabel_Type = Unsigned32
_VRtrPimNgBierPmsiMplsLabel_Object = MibTableColumn
vRtrPimNgBierPmsiMplsLabel = _VRtrPimNgBierPmsiMplsLabel_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 5),
    _VRtrPimNgBierPmsiMplsLabel_Type()
)
vRtrPimNgBierPmsiMplsLabel.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiMplsLabel.setStatus("current")
_VRtrPimNgBierPmsiIfIndex_Type = InterfaceIndex
_VRtrPimNgBierPmsiIfIndex_Object = MibTableColumn
vRtrPimNgBierPmsiIfIndex = _VRtrPimNgBierPmsiIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 6),
    _VRtrPimNgBierPmsiIfIndex_Type()
)
vRtrPimNgBierPmsiIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiIfIndex.setStatus("current")
_VRtrPimNgBierPmsiUptime_Type = Unsigned32
_VRtrPimNgBierPmsiUptime_Object = MibTableColumn
vRtrPimNgBierPmsiUptime = _VRtrPimNgBierPmsiUptime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 7),
    _VRtrPimNgBierPmsiUptime_Type()
)
vRtrPimNgBierPmsiUptime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiUptime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiUptime.setUnits("seconds")
_VRtrPimNgBierPmsiNumVpnSGs_Type = Unsigned32
_VRtrPimNgBierPmsiNumVpnSGs_Object = MibTableColumn
vRtrPimNgBierPmsiNumVpnSGs = _VRtrPimNgBierPmsiNumVpnSGs_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 8),
    _VRtrPimNgBierPmsiNumVpnSGs_Type()
)
vRtrPimNgBierPmsiNumVpnSGs.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiNumVpnSGs.setStatus("current")


class _VRtrPimNgBierPmsiIfType_Type(Integer32):
    """Custom type vRtrPimNgBierPmsiIfType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VRtrPimNgBierPmsiIfType_Type.__name__ = "Integer32"
_VRtrPimNgBierPmsiIfType_Object = MibTableColumn
vRtrPimNgBierPmsiIfType = _VRtrPimNgBierPmsiIfType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 9),
    _VRtrPimNgBierPmsiIfType_Type()
)
vRtrPimNgBierPmsiIfType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiIfType.setStatus("current")
_VRtrPimNgBierPmsiOperState_Type = TmnxOperState
_VRtrPimNgBierPmsiOperState_Object = MibTableColumn
vRtrPimNgBierPmsiOperState = _VRtrPimNgBierPmsiOperState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 10),
    _VRtrPimNgBierPmsiOperState_Type()
)
vRtrPimNgBierPmsiOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiOperState.setStatus("current")
_VRtrPimNgBierPmsiMultiStreamId_Type = Unsigned32
_VRtrPimNgBierPmsiMultiStreamId_Object = MibTableColumn
vRtrPimNgBierPmsiMultiStreamId = _VRtrPimNgBierPmsiMultiStreamId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 19, 1, 11),
    _VRtrPimNgBierPmsiMultiStreamId_Type()
)
vRtrPimNgBierPmsiMultiStreamId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiMultiStreamId.setStatus("current")
_VRtrPimNgBierPmsiCGrpSrcTable_Object = MibTable
vRtrPimNgBierPmsiCGrpSrcTable = _VRtrPimNgBierPmsiCGrpSrcTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20)
)
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiCGrpSrcTable.setStatus("current")
_VRtrPimNgBierPmsiCGrpSrcEntry_Object = MibTableRow
vRtrPimNgBierPmsiCGrpSrcEntry = _VRtrPimNgBierPmsiCGrpSrcEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1)
)
vRtrPimNgBierPmsiCGrpSrcEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiRootAddrType"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiRootAddr"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiSubDomainId"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiMplsLbl"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgBierBfrId"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimBierPmsiCGrpSrcGrpAdType"),
...
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiCGrpSrcEntry.setStatus("current")
_VRtrPimNgBierPmsiMplsLbl_Type = Unsigned32
_VRtrPimNgBierPmsiMplsLbl_Object = MibTableColumn
vRtrPimNgBierPmsiMplsLbl = _VRtrPimNgBierPmsiMplsLbl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 1),
    _VRtrPimNgBierPmsiMplsLbl_Type()
)
vRtrPimNgBierPmsiMplsLbl.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgBierPmsiMplsLbl.setStatus("current")
_VRtrPimBierPmsiCGrpSrcGrpAdType_Type = InetAddressType
_VRtrPimBierPmsiCGrpSrcGrpAdType_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcGrpAdType = _VRtrPimBierPmsiCGrpSrcGrpAdType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 2),
    _VRtrPimBierPmsiCGrpSrcGrpAdType_Type()
)
vRtrPimBierPmsiCGrpSrcGrpAdType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcGrpAdType.setStatus("current")


class _VRtrPimBierPmsiCGrpSrcGrpAddr_Type(InetAddress):
    """Custom type vRtrPimBierPmsiCGrpSrcGrpAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
        ValueSizeConstraint(16, 16),
...
_VRtrPimBierPmsiCGrpSrcGrpAddr_Type.__name__ = "InetAddress"
_VRtrPimBierPmsiCGrpSrcGrpAddr_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcGrpAddr = _VRtrPimBierPmsiCGrpSrcGrpAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 3),
    _VRtrPimBierPmsiCGrpSrcGrpAddr_Type()
)
vRtrPimBierPmsiCGrpSrcGrpAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcGrpAddr.setStatus("current")
_VRtrPimBierPmsiCGrpSrcSrcAdType_Type = InetAddressType
_VRtrPimBierPmsiCGrpSrcSrcAdType_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcSrcAdType = _VRtrPimBierPmsiCGrpSrcSrcAdType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 4),
    _VRtrPimBierPmsiCGrpSrcSrcAdType_Type()
)
vRtrPimBierPmsiCGrpSrcSrcAdType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcSrcAdType.setStatus("current")


class _VRtrPimBierPmsiCGrpSrcSrcAddr_Type(InetAddress):
    """Custom type vRtrPimBierPmsiCGrpSrcSrcAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
        ValueSizeConstraint(16, 16),
...
_VRtrPimBierPmsiCGrpSrcSrcAddr_Type.__name__ = "InetAddress"
_VRtrPimBierPmsiCGrpSrcSrcAddr_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcSrcAddr = _VRtrPimBierPmsiCGrpSrcSrcAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 5),
    _VRtrPimBierPmsiCGrpSrcSrcAddr_Type()
)
vRtrPimBierPmsiCGrpSrcSrcAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcSrcAddr.setStatus("current")


class _VRtrPimBierPmsiCGrpSrcState_Type(Integer32):
    """Custom type vRtrPimBierPmsiCGrpSrcState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VRtrPimBierPmsiCGrpSrcState_Type.__name__ = "Integer32"
_VRtrPimBierPmsiCGrpSrcState_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcState = _VRtrPimBierPmsiCGrpSrcState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 6),
    _VRtrPimBierPmsiCGrpSrcState_Type()
)
vRtrPimBierPmsiCGrpSrcState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcState.setStatus("current")
_VRtrPimBierPmsiCGrpSrcJoinTimer_Type = Unsigned32
_VRtrPimBierPmsiCGrpSrcJoinTimer_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcJoinTimer = _VRtrPimBierPmsiCGrpSrcJoinTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 7),
    _VRtrPimBierPmsiCGrpSrcJoinTimer_Type()
)
vRtrPimBierPmsiCGrpSrcJoinTimer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcJoinTimer.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcJoinTimer.setUnits("seconds")
_VRtrPimBierPmsiCGrpSrcHldDnTimer_Type = Unsigned32
_VRtrPimBierPmsiCGrpSrcHldDnTimer_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcHldDnTimer = _VRtrPimBierPmsiCGrpSrcHldDnTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 8),
    _VRtrPimBierPmsiCGrpSrcHldDnTimer_Type()
)
vRtrPimBierPmsiCGrpSrcHldDnTimer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcHldDnTimer.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcHldDnTimer.setUnits("seconds")
_VRtrPimBierPmsiCGrpSrcExpTimer_Type = Unsigned32
_VRtrPimBierPmsiCGrpSrcExpTimer_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcExpTimer = _VRtrPimBierPmsiCGrpSrcExpTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 9),
    _VRtrPimBierPmsiCGrpSrcExpTimer_Type()
)
vRtrPimBierPmsiCGrpSrcExpTimer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcExpTimer.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcExpTimer.setUnits("seconds")
_VRtrPimBierPmsiCGrpSrcUptime_Type = Unsigned32
_VRtrPimBierPmsiCGrpSrcUptime_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcUptime = _VRtrPimBierPmsiCGrpSrcUptime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 10),
    _VRtrPimBierPmsiCGrpSrcUptime_Type()
)
vRtrPimBierPmsiCGrpSrcUptime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcUptime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcUptime.setUnits("seconds")
_VRtrPimBierDataMtCGrpSrcDataTh_Type = Unsigned32
_VRtrPimBierDataMtCGrpSrcDataTh_Object = MibTableColumn
vRtrPimBierDataMtCGrpSrcDataTh = _VRtrPimBierDataMtCGrpSrcDataTh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 11),
    _VRtrPimBierDataMtCGrpSrcDataTh_Type()
)
vRtrPimBierDataMtCGrpSrcDataTh.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimBierDataMtCGrpSrcDataTh.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimBierDataMtCGrpSrcDataTh.setUnits("kilobps")
_VRtrPimBierPmsiCGrpSrcIfIndex_Type = InterfaceIndex
_VRtrPimBierPmsiCGrpSrcIfIndex_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcIfIndex = _VRtrPimBierPmsiCGrpSrcIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 12),
    _VRtrPimBierPmsiCGrpSrcIfIndex_Type()
)
vRtrPimBierPmsiCGrpSrcIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcIfIndex.setStatus("current")
_VRtrPimBierPmsiCGrpSrcRxThEnbl_Type = TruthValue
_VRtrPimBierPmsiCGrpSrcRxThEnbl_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcRxThEnbl = _VRtrPimBierPmsiCGrpSrcRxThEnbl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 13),
    _VRtrPimBierPmsiCGrpSrcRxThEnbl_Type()
)
vRtrPimBierPmsiCGrpSrcRxThEnbl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcRxThEnbl.setStatus("current")
_VRtrPimBierPmsiCGrpSrcRxCount_Type = Unsigned32
_VRtrPimBierPmsiCGrpSrcRxCount_Object = MibTableColumn
vRtrPimBierPmsiCGrpSrcRxCount = _VRtrPimBierPmsiCGrpSrcRxCount_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 20, 1, 14),
    _VRtrPimBierPmsiCGrpSrcRxCount_Type()
)
vRtrPimBierPmsiCGrpSrcRxCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimBierPmsiCGrpSrcRxCount.setStatus("current")
_VRtrPimNgBierIPmsiTable_Object = MibTable
vRtrPimNgBierIPmsiTable = _VRtrPimNgBierIPmsiTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 21)
)
if mibBuilder.loadTexts:
    vRtrPimNgBierIPmsiTable.setStatus("current")
_VRtrPimNgBierIPmsiEntry_Object = MibTableRow
vRtrPimNgBierIPmsiEntry = _VRtrPimNgBierIPmsiEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 21, 1)
)
vRtrPimNgBierIPmsiEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-VRTR-MIB", "vRtrIfIndex"),
)
if mibBuilder.loadTexts:
    vRtrPimNgBierIPmsiEntry.setStatus("current")
_VRtrPimNgBierIPmsiRootAddrType_Type = InetAddressType
_VRtrPimNgBierIPmsiRootAddrType_Object = MibTableColumn
vRtrPimNgBierIPmsiRootAddrType = _VRtrPimNgBierIPmsiRootAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 21, 1, 1),
    _VRtrPimNgBierIPmsiRootAddrType_Type()
)
vRtrPimNgBierIPmsiRootAddrType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierIPmsiRootAddrType.setStatus("current")


class _VRtrPimNgBierIPmsiRootAddr_Type(InetAddress):
    """Custom type vRtrPimNgBierIPmsiRootAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_VRtrPimNgBierIPmsiRootAddr_Type.__name__ = "InetAddress"
_VRtrPimNgBierIPmsiRootAddr_Object = MibTableColumn
vRtrPimNgBierIPmsiRootAddr = _VRtrPimNgBierIPmsiRootAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 21, 1, 2),
    _VRtrPimNgBierIPmsiRootAddr_Type()
)
vRtrPimNgBierIPmsiRootAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierIPmsiRootAddr.setStatus("current")
_VRtrPimNgBierIPmsiSubDomainId_Type = Unsigned32
_VRtrPimNgBierIPmsiSubDomainId_Object = MibTableColumn
vRtrPimNgBierIPmsiSubDomainId = _VRtrPimNgBierIPmsiSubDomainId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 21, 1, 3),
    _VRtrPimNgBierIPmsiSubDomainId_Type()
)
vRtrPimNgBierIPmsiSubDomainId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierIPmsiSubDomainId.setStatus("current")
_VRtrPimNgBierIPmsiMplsLbl_Type = Unsigned32
_VRtrPimNgBierIPmsiMplsLbl_Object = MibTableColumn
vRtrPimNgBierIPmsiMplsLbl = _VRtrPimNgBierIPmsiMplsLbl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 21, 1, 4),
    _VRtrPimNgBierIPmsiMplsLbl_Type()
)
vRtrPimNgBierIPmsiMplsLbl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierIPmsiMplsLbl.setStatus("current")
_VRtrPimNgBierIPmsiBfrId_Type = Unsigned32
_VRtrPimNgBierIPmsiBfrId_Object = MibTableColumn
vRtrPimNgBierIPmsiBfrId = _VRtrPimNgBierIPmsiBfrId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 21, 1, 5),
    _VRtrPimNgBierIPmsiBfrId_Type()
)
vRtrPimNgBierIPmsiBfrId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgBierIPmsiBfrId.setStatus("current")
_VRtrPimNgTSidPmsiTable_Object = MibTable
vRtrPimNgTSidPmsiTable = _VRtrPimNgTSidPmsiTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22)
)
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiTable.setStatus("current")
_VRtrPimNgTSidPmsiEntry_Object = MibTableRow
vRtrPimNgTSidPmsiEntry = _VRtrPimNgTSidPmsiEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1)
)
vRtrPimNgTSidPmsiEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiRootAddrType"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiRootAddr"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiTreeIdx"),
)
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiEntry.setStatus("current")
_VRtrPimNgTSidPmsiRootAddrType_Type = InetAddressType
_VRtrPimNgTSidPmsiRootAddrType_Object = MibTableColumn
vRtrPimNgTSidPmsiRootAddrType = _VRtrPimNgTSidPmsiRootAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1, 1),
    _VRtrPimNgTSidPmsiRootAddrType_Type()
)
vRtrPimNgTSidPmsiRootAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiRootAddrType.setStatus("current")


class _VRtrPimNgTSidPmsiRootAddr_Type(InetAddress):
    """Custom type vRtrPimNgTSidPmsiRootAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_VRtrPimNgTSidPmsiRootAddr_Type.__name__ = "InetAddress"
_VRtrPimNgTSidPmsiRootAddr_Object = MibTableColumn
vRtrPimNgTSidPmsiRootAddr = _VRtrPimNgTSidPmsiRootAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1, 2),
    _VRtrPimNgTSidPmsiRootAddr_Type()
)
vRtrPimNgTSidPmsiRootAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiRootAddr.setStatus("current")
_VRtrPimNgTSidPmsiTreeIdx_Type = Unsigned32
_VRtrPimNgTSidPmsiTreeIdx_Object = MibTableColumn
vRtrPimNgTSidPmsiTreeIdx = _VRtrPimNgTSidPmsiTreeIdx_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1, 3),
    _VRtrPimNgTSidPmsiTreeIdx_Type()
)
vRtrPimNgTSidPmsiTreeIdx.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiTreeIdx.setStatus("current")
_VRtrPimNgTSidPmsiIfIndex_Type = InterfaceIndex
_VRtrPimNgTSidPmsiIfIndex_Object = MibTableColumn
vRtrPimNgTSidPmsiIfIndex = _VRtrPimNgTSidPmsiIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1, 4),
    _VRtrPimNgTSidPmsiIfIndex_Type()
)
vRtrPimNgTSidPmsiIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiIfIndex.setStatus("current")
_VRtrPimNgTSidPmsiUptime_Type = Unsigned32
_VRtrPimNgTSidPmsiUptime_Object = MibTableColumn
vRtrPimNgTSidPmsiUptime = _VRtrPimNgTSidPmsiUptime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1, 5),
    _VRtrPimNgTSidPmsiUptime_Type()
)
vRtrPimNgTSidPmsiUptime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiUptime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiUptime.setUnits("seconds")
_VRtrPimNgTSidPmsiNumVpnSGs_Type = Unsigned32
_VRtrPimNgTSidPmsiNumVpnSGs_Object = MibTableColumn
vRtrPimNgTSidPmsiNumVpnSGs = _VRtrPimNgTSidPmsiNumVpnSGs_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1, 6),
    _VRtrPimNgTSidPmsiNumVpnSGs_Type()
)
vRtrPimNgTSidPmsiNumVpnSGs.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiNumVpnSGs.setStatus("current")


class _VRtrPimNgTSidPmsiIfType_Type(Integer32):
    """Custom type vRtrPimNgTSidPmsiIfType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VRtrPimNgTSidPmsiIfType_Type.__name__ = "Integer32"
_VRtrPimNgTSidPmsiIfType_Object = MibTableColumn
vRtrPimNgTSidPmsiIfType = _VRtrPimNgTSidPmsiIfType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1, 7),
    _VRtrPimNgTSidPmsiIfType_Type()
)
vRtrPimNgTSidPmsiIfType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiIfType.setStatus("current")
_VRtrPimNgTSidPmsiOperState_Type = TmnxOperState
_VRtrPimNgTSidPmsiOperState_Object = MibTableColumn
vRtrPimNgTSidPmsiOperState = _VRtrPimNgTSidPmsiOperState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1, 9),
    _VRtrPimNgTSidPmsiOperState_Type()
)
vRtrPimNgTSidPmsiOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiOperState.setStatus("current")
_VRtrPimNgTSidPmsiMultiStreamId_Type = Unsigned32
_VRtrPimNgTSidPmsiMultiStreamId_Object = MibTableColumn
vRtrPimNgTSidPmsiMultiStreamId = _VRtrPimNgTSidPmsiMultiStreamId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 22, 1, 10),
    _VRtrPimNgTSidPmsiMultiStreamId_Type()
)
vRtrPimNgTSidPmsiMultiStreamId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiMultiStreamId.setStatus("current")
_VRtrPimNgTSidPmsiCGrpSrcTable_Object = MibTable
vRtrPimNgTSidPmsiCGrpSrcTable = _VRtrPimNgTSidPmsiCGrpSrcTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23)
)
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiCGrpSrcTable.setStatus("current")
_VRtrPimNgTSidPmsiCGrpSrcEntry_Object = MibTableRow
vRtrPimNgTSidPmsiCGrpSrcEntry = _VRtrPimNgTSidPmsiCGrpSrcEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1)
)
vRtrPimNgTSidPmsiCGrpSrcEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiRootAddrType"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiRootAddr"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiTreeIdx"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcGrpAdType"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcGrpAddr"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcSrcAdType"),
    (0, "TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcSrcAddr"),
)
if mibBuilder.loadTexts:
    vRtrPimNgTSidPmsiCGrpSrcEntry.setStatus("current")
_VRtrPimTSidPmsiCGrpSrcGrpAdType_Type = InetAddressType
_VRtrPimTSidPmsiCGrpSrcGrpAdType_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcGrpAdType = _VRtrPimTSidPmsiCGrpSrcGrpAdType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 1),
    _VRtrPimTSidPmsiCGrpSrcGrpAdType_Type()
)
vRtrPimTSidPmsiCGrpSrcGrpAdType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcGrpAdType.setStatus("current")


class _VRtrPimTSidPmsiCGrpSrcGrpAddr_Type(InetAddress):
    """Custom type vRtrPimTSidPmsiCGrpSrcGrpAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
        ValueSizeConstraint(16, 16),
...
_VRtrPimTSidPmsiCGrpSrcGrpAddr_Type.__name__ = "InetAddress"
_VRtrPimTSidPmsiCGrpSrcGrpAddr_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcGrpAddr = _VRtrPimTSidPmsiCGrpSrcGrpAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 2),
    _VRtrPimTSidPmsiCGrpSrcGrpAddr_Type()
)
vRtrPimTSidPmsiCGrpSrcGrpAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcGrpAddr.setStatus("current")
_VRtrPimTSidPmsiCGrpSrcSrcAdType_Type = InetAddressType
_VRtrPimTSidPmsiCGrpSrcSrcAdType_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcSrcAdType = _VRtrPimTSidPmsiCGrpSrcSrcAdType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 3),
    _VRtrPimTSidPmsiCGrpSrcSrcAdType_Type()
)
vRtrPimTSidPmsiCGrpSrcSrcAdType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcSrcAdType.setStatus("current")


class _VRtrPimTSidPmsiCGrpSrcSrcAddr_Type(InetAddress):
    """Custom type vRtrPimTSidPmsiCGrpSrcSrcAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
        ValueSizeConstraint(16, 16),
...
_VRtrPimTSidPmsiCGrpSrcSrcAddr_Type.__name__ = "InetAddress"
_VRtrPimTSidPmsiCGrpSrcSrcAddr_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcSrcAddr = _VRtrPimTSidPmsiCGrpSrcSrcAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 4),
    _VRtrPimTSidPmsiCGrpSrcSrcAddr_Type()
)
vRtrPimTSidPmsiCGrpSrcSrcAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcSrcAddr.setStatus("current")


class _VRtrPimTSidPmsiCGrpSrcState_Type(Integer32):
    """Custom type vRtrPimTSidPmsiCGrpSrcState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VRtrPimTSidPmsiCGrpSrcState_Type.__name__ = "Integer32"
_VRtrPimTSidPmsiCGrpSrcState_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcState = _VRtrPimTSidPmsiCGrpSrcState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 5),
    _VRtrPimTSidPmsiCGrpSrcState_Type()
)
vRtrPimTSidPmsiCGrpSrcState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcState.setStatus("current")
_VRtrPimTSidPmsiCGrpSrcJoinTimer_Type = Unsigned32
_VRtrPimTSidPmsiCGrpSrcJoinTimer_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcJoinTimer = _VRtrPimTSidPmsiCGrpSrcJoinTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 6),
    _VRtrPimTSidPmsiCGrpSrcJoinTimer_Type()
)
vRtrPimTSidPmsiCGrpSrcJoinTimer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcJoinTimer.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcJoinTimer.setUnits("seconds")
_VRtrPimTSidPmsiCGrpSrcHldDnTimer_Type = Unsigned32
_VRtrPimTSidPmsiCGrpSrcHldDnTimer_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcHldDnTimer = _VRtrPimTSidPmsiCGrpSrcHldDnTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 7),
    _VRtrPimTSidPmsiCGrpSrcHldDnTimer_Type()
)
vRtrPimTSidPmsiCGrpSrcHldDnTimer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcHldDnTimer.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcHldDnTimer.setUnits("seconds")
_VRtrPimTSidPmsiCGrpSrcExpTimer_Type = Unsigned32
_VRtrPimTSidPmsiCGrpSrcExpTimer_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcExpTimer = _VRtrPimTSidPmsiCGrpSrcExpTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 8),
    _VRtrPimTSidPmsiCGrpSrcExpTimer_Type()
)
vRtrPimTSidPmsiCGrpSrcExpTimer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcExpTimer.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcExpTimer.setUnits("seconds")
_VRtrPimTSidPmsiCGrpSrcUptime_Type = Unsigned32
_VRtrPimTSidPmsiCGrpSrcUptime_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcUptime = _VRtrPimTSidPmsiCGrpSrcUptime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 9),
    _VRtrPimTSidPmsiCGrpSrcUptime_Type()
)
vRtrPimTSidPmsiCGrpSrcUptime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcUptime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcUptime.setUnits("seconds")
_VRtrPimTSidDataMtCGrpSrcDataTh_Type = Unsigned32
_VRtrPimTSidDataMtCGrpSrcDataTh_Object = MibTableColumn
vRtrPimTSidDataMtCGrpSrcDataTh = _VRtrPimTSidDataMtCGrpSrcDataTh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 10),
    _VRtrPimTSidDataMtCGrpSrcDataTh_Type()
)
vRtrPimTSidDataMtCGrpSrcDataTh.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimTSidDataMtCGrpSrcDataTh.setStatus("current")
if mibBuilder.loadTexts:
    vRtrPimTSidDataMtCGrpSrcDataTh.setUnits("kilobps")
_VRtrPimTSidPmsiCGrpSrcIfIndex_Type = InterfaceIndex
_VRtrPimTSidPmsiCGrpSrcIfIndex_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcIfIndex = _VRtrPimTSidPmsiCGrpSrcIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 11),
    _VRtrPimTSidPmsiCGrpSrcIfIndex_Type()
)
vRtrPimTSidPmsiCGrpSrcIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcIfIndex.setStatus("current")
_VRtrPimTSidPmsiCGrpSrcRxThEnbl_Type = TruthValue
_VRtrPimTSidPmsiCGrpSrcRxThEnbl_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcRxThEnbl = _VRtrPimTSidPmsiCGrpSrcRxThEnbl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 12),
    _VRtrPimTSidPmsiCGrpSrcRxThEnbl_Type()
)
vRtrPimTSidPmsiCGrpSrcRxThEnbl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcRxThEnbl.setStatus("current")
_VRtrPimTSidPmsiCGrpSrcRxCount_Type = Unsigned32
_VRtrPimTSidPmsiCGrpSrcRxCount_Object = MibTableColumn
vRtrPimTSidPmsiCGrpSrcRxCount = _VRtrPimTSidPmsiCGrpSrcRxCount_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 23, 1, 13),
    _VRtrPimTSidPmsiCGrpSrcRxCount_Type()
)
vRtrPimTSidPmsiCGrpSrcRxCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimTSidPmsiCGrpSrcRxCount.setStatus("current")
_VRtrPimNgTSidIPmsiTable_Object = MibTable
vRtrPimNgTSidIPmsiTable = _VRtrPimNgTSidIPmsiTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 24)
)
if mibBuilder.loadTexts:
    vRtrPimNgTSidIPmsiTable.setStatus("current")
_VRtrPimNgTSidIPmsiEntry_Object = MibTableRow
vRtrPimNgTSidIPmsiEntry = _VRtrPimNgTSidIPmsiEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 24, 1)
)
vRtrPimNgTSidIPmsiEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-VRTR-MIB", "vRtrIfIndex"),
)
if mibBuilder.loadTexts:
    vRtrPimNgTSidIPmsiEntry.setStatus("current")
_VRtrPimNgTSidIPmsiRootAddrType_Type = InetAddressType
_VRtrPimNgTSidIPmsiRootAddrType_Object = MibTableColumn
vRtrPimNgTSidIPmsiRootAddrType = _VRtrPimNgTSidIPmsiRootAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 24, 1, 1),
    _VRtrPimNgTSidIPmsiRootAddrType_Type()
)
vRtrPimNgTSidIPmsiRootAddrType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidIPmsiRootAddrType.setStatus("current")


class _VRtrPimNgTSidIPmsiRootAddr_Type(InetAddress):
    """Custom type vRtrPimNgTSidIPmsiRootAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_VRtrPimNgTSidIPmsiRootAddr_Type.__name__ = "InetAddress"
_VRtrPimNgTSidIPmsiRootAddr_Object = MibTableColumn
vRtrPimNgTSidIPmsiRootAddr = _VRtrPimNgTSidIPmsiRootAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 24, 1, 2),
    _VRtrPimNgTSidIPmsiRootAddr_Type()
)
vRtrPimNgTSidIPmsiRootAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidIPmsiRootAddr.setStatus("current")
_VRtrPimNgTSidIPmsiTreeIdx_Type = Unsigned32
_VRtrPimNgTSidIPmsiTreeIdx_Object = MibTableColumn
vRtrPimNgTSidIPmsiTreeIdx = _VRtrPimNgTSidIPmsiTreeIdx_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 24, 1, 3),
    _VRtrPimNgTSidIPmsiTreeIdx_Type()
)
vRtrPimNgTSidIPmsiTreeIdx.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidIPmsiTreeIdx.setStatus("current")
_VRtrPimNgTSidIPmsiLspName_Type = TNamedItem
_VRtrPimNgTSidIPmsiLspName_Object = MibTableColumn
vRtrPimNgTSidIPmsiLspName = _VRtrPimNgTSidIPmsiLspName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 2, 24, 1, 4),
    _VRtrPimNgTSidIPmsiLspName_Type()
)
vRtrPimNgTSidIPmsiLspName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrPimNgTSidIPmsiLspName.setStatus("current")
...
_VRtrPimNgNumGraftRetriesExcd_Type = Unsigned32
_VRtrPimNgNumGraftRetriesExcd_Object = MibScalar
vRtrPimNgNumGraftRetriesExcd = _VRtrPimNgNumGraftRetriesExcd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 3, 24),
    _VRtrPimNgNumGraftRetriesExcd_Type()
)
vRtrPimNgNumGraftRetriesExcd.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrPimNgNumGraftRetriesExcd.setStatus("current")
_VRtrPimNgNotifyBierInbInvSDId_Type = Unsigned32
_VRtrPimNgNotifyBierInbInvSDId_Object = MibScalar
vRtrPimNgNotifyBierInbInvSDId = _VRtrPimNgNotifyBierInbInvSDId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 3, 25),
    _VRtrPimNgNotifyBierInbInvSDId_Type()
)
vRtrPimNgNotifyBierInbInvSDId.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrPimNgNotifyBierInbInvSDId.setStatus("current")
_VRtrPimNgNotifyBierInbInvBfrId_Type = Unsigned32
_VRtrPimNgNotifyBierInbInvBfrId_Object = MibScalar
vRtrPimNgNotifyBierInbInvBfrId = _VRtrPimNgNotifyBierInbInvBfrId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 3, 26),
    _VRtrPimNgNotifyBierInbInvBfrId_Type()
)
vRtrPimNgNotifyBierInbInvBfrId.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrPimNgNotifyBierInbInvBfrId.setStatus("current")
_VRtrPimNgNotifyBierInbSAddrTyp_Type = InetAddressType
_VRtrPimNgNotifyBierInbSAddrTyp_Object = MibScalar
vRtrPimNgNotifyBierInbSAddrTyp = _VRtrPimNgNotifyBierInbSAddrTyp_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 3, 27),
    _VRtrPimNgNotifyBierInbSAddrTyp_Type()
)
vRtrPimNgNotifyBierInbSAddrTyp.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrPimNgNotifyBierInbSAddrTyp.setStatus("current")
_VRtrPimNgNotifyBierInbSAddr_Type = InetAddress
_VRtrPimNgNotifyBierInbSAddr_Object = MibScalar
vRtrPimNgNotifyBierInbSAddr = _VRtrPimNgNotifyBierInbSAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 3, 28),
    _VRtrPimNgNotifyBierInbSAddr_Type()
)
vRtrPimNgNotifyBierInbSAddr.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrPimNgNotifyBierInbSAddr.setStatus("current")
_VRtrPimNgNotifyBierInbGAddrTyp_Type = InetAddressType
_VRtrPimNgNotifyBierInbGAddrTyp_Object = MibScalar
vRtrPimNgNotifyBierInbGAddrTyp = _VRtrPimNgNotifyBierInbGAddrTyp_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 3, 29),
    _VRtrPimNgNotifyBierInbGAddrTyp_Type()
)
vRtrPimNgNotifyBierInbGAddrTyp.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrPimNgNotifyBierInbGAddrTyp.setStatus("current")
_VRtrPimNgNotifyBierInbGAddr_Type = InetAddress
_VRtrPimNgNotifyBierInbGAddr_Object = MibScalar
vRtrPimNgNotifyBierInbGAddr = _VRtrPimNgNotifyBierInbGAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 3, 30),
    _VRtrPimNgNotifyBierInbGAddr_Type()
)
vRtrPimNgNotifyBierInbGAddr.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrPimNgNotifyBierInbGAddr.setStatus("current")
_VRtrPimNgNotifyBierInbIAddrTyp_Type = InetAddressType
_VRtrPimNgNotifyBierInbIAddrTyp_Object = MibScalar
vRtrPimNgNotifyBierInbIAddrTyp = _VRtrPimNgNotifyBierInbIAddrTyp_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 3, 31),
    _VRtrPimNgNotifyBierInbIAddrTyp_Type()
)
vRtrPimNgNotifyBierInbIAddrTyp.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrPimNgNotifyBierInbIAddrTyp.setStatus("current")
_VRtrPimNgNotifyBierInbIAddr_Type = InetAddress
_VRtrPimNgNotifyBierInbIAddr_Object = MibScalar
vRtrPimNgNotifyBierInbIAddr = _VRtrPimNgNotifyBierInbIAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 50, 3, 32),
    _VRtrPimNgNotifyBierInbIAddr_Type()
)
vRtrPimNgNotifyBierInbIAddr.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrPimNgNotifyBierInbIAddr.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxPimNgIfV10v0Group.setStatus("obsolete")
...
tmnxPimNgMcastInbandSigV13v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 47)
)
tmnxPimNgMcastInbandSigV13v0Grp.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfP2mpLdpTreeJoinType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgAFGenMvpnOperCMcastSig"))
)
if mibBuilder.loadTexts:
    tmnxPimNgMcastInbandSigV13v0Grp.setStatus("current")

tmnxPimNgMulticastSpmsiV13v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 48)
)
tmnxPimNgMulticastSpmsiV13v0Grp.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfPmsiType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtSpmsiAddRxThd"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtSpmsiDelRxThd"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimLdpPmsiCGrpSrcRxCount"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimRsvpPmsiCGrpSrcRxCount"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimLdpPmsiCGrpSrcRxThresEnbl"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimRsvpPmsiCGrpSrcRxThresEn"))
)
if mibBuilder.loadTexts:
    tmnxPimNgMulticastSpmsiV13v0Grp.setStatus("current")

tmnxPimAsmExtranetV13v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 49)
)
tmnxPimAsmExtranetV13v0Grp.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgExtranetCDStarGFlag")
)
if mibBuilder.loadTexts:
    tmnxPimAsmExtranetV13v0Grp.setStatus("current")

tmnxPimNgIfV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 50)
)
tmnxPimNgIfV13v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfExtranetType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfExtranetMvpnId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgRsvpPmsiIfType"))
)
if mibBuilder.loadTexts:
    tmnxPimNgIfV13v0Group.setStatus("current")

tmnxPimNgObsoletedV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 51)
)
tmnxPimNgObsoletedV13v0Group.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfP2mpLdpTreeJoin")
)
if mibBuilder.loadTexts:
    tmnxPimNgObsoletedV13v0Group.setStatus("current")

tmnxPimNgIfV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 52)
)
tmnxPimNgIfV14v0Group.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfMcacIfPolicyName")
)
if mibBuilder.loadTexts:
    tmnxPimNgIfV14v0Group.setStatus("current")

tmnxPimNgGenV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 53)
)
tmnxPimNgGenV14v0Group.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgGenEcmpHashRebalance")
)
if mibBuilder.loadTexts:
    tmnxPimNgGenV14v0Group.setStatus("current")

tmnxPimNgDataMtPlcyV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 54)
)
tmnxPimNgDataMtPlcyV14v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyTblLstChg"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyLspTemplate"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyAdminState"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyRowStatus"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyRowLastChg"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcySGTblLstChg"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcySGRowStatus"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcySGRowLstChg"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgRsvpPmsiOperState"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgRsvpPmsiMultiStreamId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgLdpPmsiOperState"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgLdpPmsiMultiStreamId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgGenMultiStreamSpmsi"))
)
if mibBuilder.loadTexts:
    tmnxPimNgDataMtPlcyV14v0Group.setStatus("current")

tmnxPimNgGenStatMdtsV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 55)
)
tmnxPimNgGenStatMdtsV14v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgGenStatRxActvPsuedoMdts"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgGenStatTxMsActiveMdts"))
)
if mibBuilder.loadTexts:
    tmnxPimNgGenStatMdtsV14v0Group.setStatus("current")

tmnxPimNgDMAutoRpV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 56)
)
tmnxPimNgDMAutoRpV14v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfGraftsRx"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfGraftsTx"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfGraftsRxErrors"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfGraftsAckRx"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfGraftsAckTx"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfGraftsAckRxErrors"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfRxAutoRpMappingRpfMM"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfRxAutoRpAnnounceRpfMM"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgGrpSrcMode"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgGrpSrcPruneLimitTimer"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgGrpSrcGraftRetryTimer"))
)
if mibBuilder.loadTexts:
    tmnxPimNgDMAutoRpV14v0Group.setStatus("current")

tmnxPimNgNotifyObjsV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 57)
)
tmnxPimNgNotifyObjsV14v0Group.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNumGraftRetriesExcd")
)
if mibBuilder.loadTexts:
    tmnxPimNgNotifyObjsV14v0Group.setStatus("current")

tmnxPimNgVRRPAwarePim15v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 59)
)
tmnxPimNgVRRPAwarePim15v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgAFIfOperGroup"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgAFIfOperGroupDPAction"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgAFIfOpGrpDeltaPriority"))
)
if mibBuilder.loadTexts:
    tmnxPimNgVRRPAwarePim15v0Group.setStatus("current")

tmnxPimNgDataMtPlcyV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 60)
)
tmnxPimNgDataMtPlcyV16v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyGrpAddrMode"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyGrpAddrType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtPlcyGrpAddr"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtMultiStreamId"))
)
if mibBuilder.loadTexts:
    tmnxPimNgDataMtPlcyV16v0Group.setStatus("current")

tmnxPimNgBIERV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 61)
)
tmnxPimNgBIERV16v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiIfIndex"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiUptime"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiNumVpnSGs"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiIfType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiOperState"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierPmsiMultiStreamId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimBierPmsiCGrpSrcState"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimBierPmsiCGrpSrcJoinTimer"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimBierPmsiCGrpSrcHldDnTimer"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimBierPmsiCGrpSrcExpTimer"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimBierPmsiCGrpSrcUptime"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimBierDataMtCGrpSrcDataTh"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimBierPmsiCGrpSrcIfIndex"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimBierPmsiCGrpSrcRxThEnbl"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimBierPmsiCGrpSrcRxCount"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierIPmsiRootAddrType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierIPmsiRootAddr"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierIPmsiSubDomainId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierIPmsiMplsLbl"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierIPmsiBfrId"))
)
if mibBuilder.loadTexts:
    tmnxPimNgBIERV16v0Group.setStatus("current")

tmnxPimNgGlobalGroupV19v0 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 62)
)
tmnxPimNgGlobalGroupV19v0.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgGenBgpNhOverride")
)
if mibBuilder.loadTexts:
    tmnxPimNgGlobalGroupV19v0.setStatus("current")

tmnxPimNgIfV19v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 63)
)
tmnxPimNgIfV19v0Group.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfBierSignalingType")
)
if mibBuilder.loadTexts:
    tmnxPimNgIfV19v0Group.setStatus("current")

tmnxPimNgSsmScalingV19v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 64)
)
tmnxPimNgSsmScalingV19v0Group.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgGenPimSsmScaling")
)
if mibBuilder.loadTexts:
    tmnxPimNgSsmScalingV19v0Group.setStatus("current")

tmnxPimNgIfBierSigV19v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 65)
)
tmnxPimNgIfBierSigV19v0Group.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfBierSigTransportType")
)
if mibBuilder.loadTexts:
    tmnxPimNgIfBierSigV19v0Group.setStatus("current")

tmnxPimNgIfTSidV19v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 66)
)
tmnxPimNgIfTSidV19v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiIfIndex"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiUptime"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiNumVpnSGs"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiIfType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiOperState"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidPmsiMultiStreamId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcState"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcJoinTimer"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcHldDnTimer"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcExpTimer"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcUptime"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimTSidDataMtCGrpSrcDataTh"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcIfIndex"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcRxThEnbl"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimTSidPmsiCGrpSrcRxCount"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidIPmsiRootAddrType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidIPmsiRootAddr"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidIPmsiTreeIdx"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgTSidIPmsiLspName"))
)
if mibBuilder.loadTexts:
    tmnxPimNgIfTSidV19v0Group.setStatus("current")

tmnxPimNotifyObjsV19v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 67)
)
tmnxPimNotifyObjsV19v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbInvSDId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbInvBfrId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbSAddrTyp"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbSAddr"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbGAddrTyp"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbGAddr"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbIAddrTyp"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbIAddr"))
)
if mibBuilder.loadTexts:
    tmnxPimNotifyObjsV19v0Group.setStatus("current")

tmnxPimNgMulticastSpmsiV19v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 69)
)
tmnxPimNgMulticastSpmsiV19v0Grp.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtSpmsiStaticPlcy")
)
if mibBuilder.loadTexts:
    tmnxPimNgMulticastSpmsiV19v0Grp.setStatus("current")

tmnxPimNgGlobalGroupV20v0 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 70)
)
tmnxPimNgGlobalGroupV20v0.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgGenMtuOverHead")
)
if mibBuilder.loadTexts:
    tmnxPimNgGlobalGroupV20v0.setStatus("current")

tmnxPimNgMulticastSpmsiV20v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 71)
)
tmnxPimNgMulticastSpmsiV20v0Grp.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgIfPmsiType")
)
if mibBuilder.loadTexts:
    tmnxPimNgMulticastSpmsiV20v0Grp.setStatus("current")

tmnxPimNgMsSpmsiTreeSidV20v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 72)
)
tmnxPimNgMsSpmsiTreeSidV20v0Grp.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgDataMtSpmsiSRPlcy")
)
if mibBuilder.loadTexts:
    tmnxPimNgMsSpmsiTreeSidV20v0Grp.setStatus("current")

tmnxPimNgAfGenAutoRPV20v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 73)
)
tmnxPimNgAfGenAutoRPV20v0Grp.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgAfGenAutoRPCandidate"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgAfGenAutoRPMappingAgent"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgAfGenAutoRPMAIUAddrType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgAfGenAutoRPMAIUAddress"))
)
if mibBuilder.loadTexts:
    tmnxPimNgAfGenAutoRPV20v0Grp.setStatus("current")
...
vRtrPimNgMaxGraftRetry = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 50, 0, 15)
)
vRtrPimNgMaxGraftRetry.setObjects(
      *(("TIMETRA-VRTR-MIB", "vRtrID"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyGroupAddrType"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyGroupAddr"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifySourceAddrType"),
...
if mibBuilder.loadTexts:
    vRtrPimNgMaxGraftRetry.setStatus(
        "current"
    )

vRtrPimNgBierInbInvSD = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 50, 0, 16)
)
vRtrPimNgBierInbInvSD.setObjects(
      *(("TIMETRA-VRTR-MIB", "vRtrID"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbInvSDId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbSAddrTyp"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbSAddr"),
...
if mibBuilder.loadTexts:
    vRtrPimNgBierInbInvSD.setStatus(
        "current"
    )

vRtrPimNgBierInbInvBfrId = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 50, 0, 17)
)
vRtrPimNgBierInbInvBfrId.setObjects(
      *(("TIMETRA-VRTR-MIB", "vRtrID"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbInvBfrId"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbSAddrTyp"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgNotifyBierInbSAddr"),
...
if mibBuilder.loadTexts:
    vRtrPimNgBierInbInvBfrId.setStatus(
        "current"
    )
...
tmnxPimNgNotificationV14v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 58)
)
tmnxPimNgNotificationV14v0Group.setObjects(
    ("TIMETRA-PIM-NG-MIB", "vRtrPimNgMaxGraftRetry")
)
if mibBuilder.loadTexts:
    tmnxPimNgNotificationV14v0Group.setStatus(
        "current"
    )

tmnxPimNgNotificationV19v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 2, 68)
)
tmnxPimNgNotificationV19v0Group.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierInbInvSD"),
        ("TIMETRA-PIM-NG-MIB", "vRtrPimNgBierInbInvBfrId"))
)
if mibBuilder.loadTexts:
    tmnxPimNgNotificationV19v0Group.setStatus(
        "current"
    )
...
tmnxPimNgV13v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 1, 8)
)
tmnxPimNgV13v0Compliance.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "tmnxPimNgGlobalGrpSrcV9v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfGroup"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgNotificationGroup"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimIfSecNbrV6v0Group"),
        ...
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgSgStatcExtrntV12v0Grp"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgUnicastRtRemV12v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgMcastInbandSigV13v0Grp"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgMulticastSpmsiV13v0Grp"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimAsmExtranetV13v0Grp"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfV13v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgObsoletedV13v0Group"))
)
if mibBuilder.loadTexts:
    tmnxPimNgV13v0Compliance.setStatus(
        "obsolete"
    )

tmnxPimNgV14v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 1, 9)
)
tmnxPimNgV14v0Compliance.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "tmnxPimNgGlobalGrpSrcV9v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfGroup"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfV14v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgNotificationGroup"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimIfSecNbrV6v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgEmbeddedRPV7v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgV7v0Group"),
        ...
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfV13v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgObsoletedV13v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgGenV14v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgDataMtPlcyV14v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgGenStatMdtsV14v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgDMAutoRpV14v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgNotifyObjsV14v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgNotificationV14v0Group"))
)
if mibBuilder.loadTexts:
    tmnxPimNgV14v0Compliance.setStatus(
        "current"
    )

tmnxPimNgV15v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 1, 10)
)
tmnxPimNgV15v0Compliance.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "tmnxPimNgGlobalGrpSrcV9v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfGroup"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfV14v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgNotificationGroup"),
        ...
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgNotifyObjsV14v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgNotificationV14v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgVRRPAwarePim15v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNotifyObjsV19v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgNotificationV19v0Group"))
)
if mibBuilder.loadTexts:
    tmnxPimNgV15v0Compliance.setStatus(
        "current"
    )

tmnxPimNgV16v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 1, 11)
)
tmnxPimNgV16v0Compliance.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "tmnxPimNgDataMtPlcyV16v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgBIERV16v0Group"))
)
if mibBuilder.loadTexts:
    tmnxPimNgV16v0Compliance.setStatus(
        "current"
    )

tmnxPimNgV19v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 1, 12)
)
tmnxPimNgV19v0Compliance.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "tmnxPimNgGlobalGroupV19v0"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfV19v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgSsmScalingV19v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfBierSigV19v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgIfTSidV19v0Group"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgMulticastSpmsiV19v0Grp"))
)
if mibBuilder.loadTexts:
    tmnxPimNgV19v0Compliance.setStatus(
        "current"
    )

tmnxPimNgV20v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 50, 1, 13)
)
tmnxPimNgV20v0Compliance.setObjects(
      *(("TIMETRA-PIM-NG-MIB", "tmnxPimNgGlobalGroupV20v0"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgMulticastSpmsiV20v0Grp"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgMsSpmsiTreeSidV20v0Grp"),
        ("TIMETRA-PIM-NG-MIB", "tmnxPimNgAfGenAutoRPV20v0Grp"))
)
if mibBuilder.loadTexts:
    tmnxPimNgV20v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"timetraPimNgMIBModule": timetraPimNgMIBModule,
       ...
       "tmnxPimNgV13v0Compliance": tmnxPimNgV13v0Compliance,
       "tmnxPimNgV14v0Compliance": tmnxPimNgV14v0Compliance,
       "tmnxPimNgV15v0Compliance": tmnxPimNgV15v0Compliance,
       "tmnxPimNgV16v0Compliance": tmnxPimNgV16v0Compliance,
       "tmnxPimNgV19v0Compliance": tmnxPimNgV19v0Compliance,
       "tmnxPimNgV20v0Compliance": tmnxPimNgV20v0Compliance,
       ...
       "tmnxPimNgMcastInbandSigV13v0Grp": tmnxPimNgMcastInbandSigV13v0Grp,
       "tmnxPimNgMulticastSpmsiV13v0Grp": tmnxPimNgMulticastSpmsiV13v0Grp,
       "tmnxPimAsmExtranetV13v0Grp": tmnxPimAsmExtranetV13v0Grp,
       "tmnxPimNgIfV13v0Group": tmnxPimNgIfV13v0Group,
       "tmnxPimNgObsoletedV13v0Group": tmnxPimNgObsoletedV13v0Group,
       "tmnxPimNgIfV14v0Group": tmnxPimNgIfV14v0Group,
       "tmnxPimNgGenV14v0Group": tmnxPimNgGenV14v0Group,
       "tmnxPimNgDataMtPlcyV14v0Group": tmnxPimNgDataMtPlcyV14v0Group,
       "tmnxPimNgGenStatMdtsV14v0Group": tmnxPimNgGenStatMdtsV14v0Group,
       "tmnxPimNgDMAutoRpV14v0Group": tmnxPimNgDMAutoRpV14v0Group,
       "tmnxPimNgNotifyObjsV14v0Group": tmnxPimNgNotifyObjsV14v0Group,
       "tmnxPimNgNotificationV14v0Group": tmnxPimNgNotificationV14v0Group,
       "tmnxPimNgVRRPAwarePim15v0Group": tmnxPimNgVRRPAwarePim15v0Group,
       "tmnxPimNgDataMtPlcyV16v0Group": tmnxPimNgDataMtPlcyV16v0Group,
       "tmnxPimNgBIERV16v0Group": tmnxPimNgBIERV16v0Group,
       "tmnxPimNgGlobalGroupV19v0": tmnxPimNgGlobalGroupV19v0,
       "tmnxPimNgIfV19v0Group": tmnxPimNgIfV19v0Group,
       "tmnxPimNgSsmScalingV19v0Group": tmnxPimNgSsmScalingV19v0Group,
       "tmnxPimNgIfBierSigV19v0Group": tmnxPimNgIfBierSigV19v0Group,
       "tmnxPimNgIfTSidV19v0Group": tmnxPimNgIfTSidV19v0Group,
       "tmnxPimNotifyObjsV19v0Group": tmnxPimNotifyObjsV19v0Group,
       "tmnxPimNgNotificationV19v0Group": tmnxPimNgNotificationV19v0Group,
       "tmnxPimNgMulticastSpmsiV19v0Grp": tmnxPimNgMulticastSpmsiV19v0Grp,
       "tmnxPimNgGlobalGroupV20v0": tmnxPimNgGlobalGroupV20v0,
       "tmnxPimNgMulticastSpmsiV20v0Grp": tmnxPimNgMulticastSpmsiV20v0Grp,
       "tmnxPimNgMsSpmsiTreeSidV20v0Grp": tmnxPimNgMsSpmsiTreeSidV20v0Grp,
       "tmnxPimNgAfGenAutoRPV20v0Grp": tmnxPimNgAfGenAutoRPV20v0Grp,
       ...
       "vRtrPimNgGenEcmpHashRebalance": vRtrPimNgGenEcmpHashRebalance,
       "vRtrPimNgGenMultiStreamSpmsi": vRtrPimNgGenMultiStreamSpmsi,
       "vRtrPimNgGenBgpNhOverride": vRtrPimNgGenBgpNhOverride,
       "vRtrPimNgGenPimSsmScaling": vRtrPimNgGenPimSsmScaling,
       "vRtrPimNgGenMtuOverHead": vRtrPimNgGenMtuOverHead,
       ...
       "vRtrPimNgAFGenMvpnOperCMcastSig": vRtrPimNgAFGenMvpnOperCMcastSig,
       "vRtrPimNgAfGenAutoRPCandidate": vRtrPimNgAfGenAutoRPCandidate,
       "vRtrPimNgAfGenAutoRPMappingAgent": vRtrPimNgAfGenAutoRPMappingAgent,
       "vRtrPimNgAfGenAutoRPMAIUAddrType": vRtrPimNgAfGenAutoRPMAIUAddrType,
       "vRtrPimNgAfGenAutoRPMAIUAddress": vRtrPimNgAfGenAutoRPMAIUAddress,
       ...
       "vRtrPimNgGrpSrcMode": vRtrPimNgGrpSrcMode,
       "vRtrPimNgGrpSrcPruneLimitTimer": vRtrPimNgGrpSrcPruneLimitTimer,
       "vRtrPimNgGrpSrcGraftRetryTimer": vRtrPimNgGrpSrcGraftRetryTimer,
       ...
       "vRtrPimNgGenStatRxActvPsuedoMdts": vRtrPimNgGenStatRxActvPsuedoMdts,
       "vRtrPimNgGenStatTxMsActiveMdts": vRtrPimNgGenStatTxMsActiveMdts,
       ...
       "vRtrPimNgDataMtSpmsiAddRxThd": vRtrPimNgDataMtSpmsiAddRxThd,
       "vRtrPimNgDataMtSpmsiDelRxThd": vRtrPimNgDataMtSpmsiDelRxThd,
       ...
       "vRtrPimNgExtranetCDStarGFlag": vRtrPimNgExtranetCDStarGFlag,
       "vRtrPimNgDataMtPlcyTblLstChg": vRtrPimNgDataMtPlcyTblLstChg,
       "vRtrPimNgDataMtPlcyTable": vRtrPimNgDataMtPlcyTable,
       "vRtrPimNgDataMtPlcyEntry": vRtrPimNgDataMtPlcyEntry,
       "vRtrPimNgDataMtPlcyIndex": vRtrPimNgDataMtPlcyIndex,
       "vRtrPimNgDataMtPlcyRowStatus": vRtrPimNgDataMtPlcyRowStatus,
       "vRtrPimNgDataMtPlcyRowLastChg": vRtrPimNgDataMtPlcyRowLastChg,
       "vRtrPimNgDataMtPlcyLspTemplate": vRtrPimNgDataMtPlcyLspTemplate,
       "vRtrPimNgDataMtPlcyAdminState": vRtrPimNgDataMtPlcyAdminState,
       "vRtrPimNgDataMtPlcyGrpAddrMode": vRtrPimNgDataMtPlcyGrpAddrMode,
       "vRtrPimNgDataMtPlcyGrpAddrType": vRtrPimNgDataMtPlcyGrpAddrType,
       "vRtrPimNgDataMtPlcyGrpAddr": vRtrPimNgDataMtPlcyGrpAddr,
       "vRtrPimNgDataMtSpmsiStaticPlcy": vRtrPimNgDataMtSpmsiStaticPlcy,
       "vRtrPimNgDataMtSpmsiSRPlcy": vRtrPimNgDataMtSpmsiSRPlcy,
       "vRtrPimNgDataMtPlcySGTblLstChg": vRtrPimNgDataMtPlcySGTblLstChg,
       "vRtrPimNgDataMtPlcySGTable": vRtrPimNgDataMtPlcySGTable,
       "vRtrPimNgDataMtPlcySGEntry": vRtrPimNgDataMtPlcySGEntry,
       "vRtrPimNgDataMtPlcySGGrpPfxType": vRtrPimNgDataMtPlcySGGrpPfxType,
       "vRtrPimNgDataMtPlcySGGrpPfxAddr": vRtrPimNgDataMtPlcySGGrpPfxAddr,
       "vRtrPimNgDataMtPlcySGGrpPfxLen": vRtrPimNgDataMtPlcySGGrpPfxLen,
       "vRtrPimNgDataMtPlcySGSrcPfxType": vRtrPimNgDataMtPlcySGSrcPfxType,
       "vRtrPimNgDataMtPlcySGSrcPfxAddr": vRtrPimNgDataMtPlcySGSrcPfxAddr,
       "vRtrPimNgDataMtPlcySGSrcPfxLen": vRtrPimNgDataMtPlcySGSrcPfxLen,
       "vRtrPimNgDataMtPlcySGRowStatus": vRtrPimNgDataMtPlcySGRowStatus,
       "vRtrPimNgDataMtPlcySGRowLstChg": vRtrPimNgDataMtPlcySGRowLstChg,
       ...
       "vRtrPimNgIfP2mpLdpTreeJoinType": vRtrPimNgIfP2mpLdpTreeJoinType,
       "vRtrPimNgIfPmsiType": vRtrPimNgIfPmsiType,
       "vRtrPimNgIfMcacIfPolicyName": vRtrPimNgIfMcacIfPolicyName,
       "vRtrPimNgIfBierSignalingType": vRtrPimNgIfBierSignalingType,
       "vRtrPimNgIfBierSigTransportType": vRtrPimNgIfBierSigTransportType,
       ...
       "vRtrPimNgAFIfOperGroup": vRtrPimNgAFIfOperGroup,
       "vRtrPimNgAFIfOperGroupDPAction": vRtrPimNgAFIfOperGroupDPAction,
       "vRtrPimNgAFIfOpGrpDeltaPriority": vRtrPimNgAFIfOpGrpDeltaPriority,
       ...
       "vRtrPimNgIfGraftsRx": vRtrPimNgIfGraftsRx,
       "vRtrPimNgIfGraftsTx": vRtrPimNgIfGraftsTx,
       "vRtrPimNgIfGraftsRxErrors": vRtrPimNgIfGraftsRxErrors,
       "vRtrPimNgIfGraftsAckRx": vRtrPimNgIfGraftsAckRx,
       "vRtrPimNgIfGraftsAckTx": vRtrPimNgIfGraftsAckTx,
       "vRtrPimNgIfGraftsAckRxErrors": vRtrPimNgIfGraftsAckRxErrors,
       "vRtrPimNgIfRxAutoRpMappingRpfMM": vRtrPimNgIfRxAutoRpMappingRpfMM,
       "vRtrPimNgIfRxAutoRpAnnounceRpfMM": vRtrPimNgIfRxAutoRpAnnounceRpfMM,
       ...
       "vRtrPimNgDataMtMultiStreamId": vRtrPimNgDataMtMultiStreamId,
       ...
       "vRtrPimNgRsvpPmsiOperState": vRtrPimNgRsvpPmsiOperState,
       "vRtrPimNgRsvpPmsiMultiStreamId": vRtrPimNgRsvpPmsiMultiStreamId,
       ...
       "vRtrPimRsvpPmsiCGrpSrcRxThresEn": vRtrPimRsvpPmsiCGrpSrcRxThresEn,
       "vRtrPimRsvpPmsiCGrpSrcRxCount": vRtrPimRsvpPmsiCGrpSrcRxCount,
       ...
       "vRtrPimNgLdpPmsiOperState": vRtrPimNgLdpPmsiOperState,
       "vRtrPimNgLdpPmsiMultiStreamId": vRtrPimNgLdpPmsiMultiStreamId,
       ...
       "vRtrPimLdpPmsiCGrpSrcRxThresEnbl": vRtrPimLdpPmsiCGrpSrcRxThresEnbl,
       "vRtrPimLdpPmsiCGrpSrcRxCount": vRtrPimLdpPmsiCGrpSrcRxCount,
       ...
       "vRtrPimNgBierPmsiTable": vRtrPimNgBierPmsiTable,
       "vRtrPimNgBierPmsiEntry": vRtrPimNgBierPmsiEntry,
       "vRtrPimNgBierPmsiRootAddrType": vRtrPimNgBierPmsiRootAddrType,
       "vRtrPimNgBierPmsiRootAddr": vRtrPimNgBierPmsiRootAddr,
       "vRtrPimNgBierPmsiSubDomainId": vRtrPimNgBierPmsiSubDomainId,
       "vRtrPimNgBierBfrId": vRtrPimNgBierBfrId,
       "vRtrPimNgBierPmsiMplsLabel": vRtrPimNgBierPmsiMplsLabel,
       "vRtrPimNgBierPmsiIfIndex": vRtrPimNgBierPmsiIfIndex,
       "vRtrPimNgBierPmsiUptime": vRtrPimNgBierPmsiUptime,
       "vRtrPimNgBierPmsiNumVpnSGs": vRtrPimNgBierPmsiNumVpnSGs,
       "vRtrPimNgBierPmsiIfType": vRtrPimNgBierPmsiIfType,
       "vRtrPimNgBierPmsiOperState": vRtrPimNgBierPmsiOperState,
       "vRtrPimNgBierPmsiMultiStreamId": vRtrPimNgBierPmsiMultiStreamId,
       "vRtrPimNgBierPmsiCGrpSrcTable": vRtrPimNgBierPmsiCGrpSrcTable,
       "vRtrPimNgBierPmsiCGrpSrcEntry": vRtrPimNgBierPmsiCGrpSrcEntry,
       "vRtrPimNgBierPmsiMplsLbl": vRtrPimNgBierPmsiMplsLbl,
       "vRtrPimBierPmsiCGrpSrcGrpAdType": vRtrPimBierPmsiCGrpSrcGrpAdType,
       "vRtrPimBierPmsiCGrpSrcGrpAddr": vRtrPimBierPmsiCGrpSrcGrpAddr,
       "vRtrPimBierPmsiCGrpSrcSrcAdType": vRtrPimBierPmsiCGrpSrcSrcAdType,
       "vRtrPimBierPmsiCGrpSrcSrcAddr": vRtrPimBierPmsiCGrpSrcSrcAddr,
       "vRtrPimBierPmsiCGrpSrcState": vRtrPimBierPmsiCGrpSrcState,
       "vRtrPimBierPmsiCGrpSrcJoinTimer": vRtrPimBierPmsiCGrpSrcJoinTimer,
       "vRtrPimBierPmsiCGrpSrcHldDnTimer": vRtrPimBierPmsiCGrpSrcHldDnTimer,
       "vRtrPimBierPmsiCGrpSrcExpTimer": vRtrPimBierPmsiCGrpSrcExpTimer,
       "vRtrPimBierPmsiCGrpSrcUptime": vRtrPimBierPmsiCGrpSrcUptime,
       "vRtrPimBierDataMtCGrpSrcDataTh": vRtrPimBierDataMtCGrpSrcDataTh,
       "vRtrPimBierPmsiCGrpSrcIfIndex": vRtrPimBierPmsiCGrpSrcIfIndex,
       "vRtrPimBierPmsiCGrpSrcRxThEnbl": vRtrPimBierPmsiCGrpSrcRxThEnbl,
       "vRtrPimBierPmsiCGrpSrcRxCount": vRtrPimBierPmsiCGrpSrcRxCount,
       "vRtrPimNgBierIPmsiTable": vRtrPimNgBierIPmsiTable,
       "vRtrPimNgBierIPmsiEntry": vRtrPimNgBierIPmsiEntry,
       "vRtrPimNgBierIPmsiRootAddrType": vRtrPimNgBierIPmsiRootAddrType,
       "vRtrPimNgBierIPmsiRootAddr": vRtrPimNgBierIPmsiRootAddr,
       "vRtrPimNgBierIPmsiSubDomainId": vRtrPimNgBierIPmsiSubDomainId,
       "vRtrPimNgBierIPmsiMplsLbl": vRtrPimNgBierIPmsiMplsLbl,
       "vRtrPimNgBierIPmsiBfrId": vRtrPimNgBierIPmsiBfrId,
       "vRtrPimNgTSidPmsiTable": vRtrPimNgTSidPmsiTable,
       "vRtrPimNgTSidPmsiEntry": vRtrPimNgTSidPmsiEntry,
       "vRtrPimNgTSidPmsiRootAddrType": vRtrPimNgTSidPmsiRootAddrType,
       "vRtrPimNgTSidPmsiRootAddr": vRtrPimNgTSidPmsiRootAddr,
       "vRtrPimNgTSidPmsiTreeIdx": vRtrPimNgTSidPmsiTreeIdx,
       "vRtrPimNgTSidPmsiIfIndex": vRtrPimNgTSidPmsiIfIndex,
       "vRtrPimNgTSidPmsiUptime": vRtrPimNgTSidPmsiUptime,
       "vRtrPimNgTSidPmsiNumVpnSGs": vRtrPimNgTSidPmsiNumVpnSGs,
       "vRtrPimNgTSidPmsiIfType": vRtrPimNgTSidPmsiIfType,
       "vRtrPimNgTSidPmsiOperState": vRtrPimNgTSidPmsiOperState,
       "vRtrPimNgTSidPmsiMultiStreamId": vRtrPimNgTSidPmsiMultiStreamId,
       "vRtrPimNgTSidPmsiCGrpSrcTable": vRtrPimNgTSidPmsiCGrpSrcTable,
       "vRtrPimNgTSidPmsiCGrpSrcEntry": vRtrPimNgTSidPmsiCGrpSrcEntry,
       "vRtrPimTSidPmsiCGrpSrcGrpAdType": vRtrPimTSidPmsiCGrpSrcGrpAdType,
       "vRtrPimTSidPmsiCGrpSrcGrpAddr": vRtrPimTSidPmsiCGrpSrcGrpAddr,
       "vRtrPimTSidPmsiCGrpSrcSrcAdType": vRtrPimTSidPmsiCGrpSrcSrcAdType,
       "vRtrPimTSidPmsiCGrpSrcSrcAddr": vRtrPimTSidPmsiCGrpSrcSrcAddr,
       "vRtrPimTSidPmsiCGrpSrcState": vRtrPimTSidPmsiCGrpSrcState,
       "vRtrPimTSidPmsiCGrpSrcJoinTimer": vRtrPimTSidPmsiCGrpSrcJoinTimer,
       "vRtrPimTSidPmsiCGrpSrcHldDnTimer": vRtrPimTSidPmsiCGrpSrcHldDnTimer,
       "vRtrPimTSidPmsiCGrpSrcExpTimer": vRtrPimTSidPmsiCGrpSrcExpTimer,
       "vRtrPimTSidPmsiCGrpSrcUptime": vRtrPimTSidPmsiCGrpSrcUptime,
       "vRtrPimTSidDataMtCGrpSrcDataTh": vRtrPimTSidDataMtCGrpSrcDataTh,
       "vRtrPimTSidPmsiCGrpSrcIfIndex": vRtrPimTSidPmsiCGrpSrcIfIndex,
       "vRtrPimTSidPmsiCGrpSrcRxThEnbl": vRtrPimTSidPmsiCGrpSrcRxThEnbl,
       "vRtrPimTSidPmsiCGrpSrcRxCount": vRtrPimTSidPmsiCGrpSrcRxCount,
       "vRtrPimNgTSidIPmsiTable": vRtrPimNgTSidIPmsiTable,
       "vRtrPimNgTSidIPmsiEntry": vRtrPimNgTSidIPmsiEntry,
       "vRtrPimNgTSidIPmsiRootAddrType": vRtrPimNgTSidIPmsiRootAddrType,
       "vRtrPimNgTSidIPmsiRootAddr": vRtrPimNgTSidIPmsiRootAddr,
       "vRtrPimNgTSidIPmsiTreeIdx": vRtrPimNgTSidIPmsiTreeIdx,
       "vRtrPimNgTSidIPmsiLspName": vRtrPimNgTSidIPmsiLspName,
       ...
       "vRtrPimNgNumGraftRetriesExcd": vRtrPimNgNumGraftRetriesExcd,
       "vRtrPimNgNotifyBierInbInvSDId": vRtrPimNgNotifyBierInbInvSDId,
       "vRtrPimNgNotifyBierInbInvBfrId": vRtrPimNgNotifyBierInbInvBfrId,
       "vRtrPimNgNotifyBierInbSAddrTyp": vRtrPimNgNotifyBierInbSAddrTyp,
       "vRtrPimNgNotifyBierInbSAddr": vRtrPimNgNotifyBierInbSAddr,
       "vRtrPimNgNotifyBierInbGAddrTyp": vRtrPimNgNotifyBierInbGAddrTyp,
       "vRtrPimNgNotifyBierInbGAddr": vRtrPimNgNotifyBierInbGAddr,
       "vRtrPimNgNotifyBierInbIAddrTyp": vRtrPimNgNotifyBierInbIAddrTyp,
       "vRtrPimNgNotifyBierInbIAddr": vRtrPimNgNotifyBierInbIAddr,
       ...
       "vRtrPimNgMaxGraftRetry": vRtrPimNgMaxGraftRetry,
       "vRtrPimNgBierInbInvSD": vRtrPimNgBierInbInvSD,
       "vRtrPimNgBierInbInvBfrId": vRtrPimNgBierInbInvBfrId}
)
