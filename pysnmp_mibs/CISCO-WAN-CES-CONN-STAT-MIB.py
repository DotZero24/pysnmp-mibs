...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-CES-CONN-STAT-MIB
...
cwcConnStatCompliance.setObjects(
      *(("CISCO-WAN-CES-CONN-STAT-MIB", "cwcConnGenStatsGroup"),
        ("CISCO-WAN-CES-CONN-STAT-MIB", "cwcConnStatsGroup"))
)
if mibBuilder.loadTexts:
