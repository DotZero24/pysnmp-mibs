...
mibBuilder.exportSymbols('MY-TC',**{'IfIndex':IfIndex,'MyTrapType':MyTrapType,'ConfigStatus':ConfigStatus,'MemberMap':MemberMap,'myTextualConventions':myTextualConventions})