...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-APPNAV-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:23:22 2025
...
ciscoAppNavMIBCompliance.setObjects(
      *(("CISCO-APPNAV-MIB", "cAppNavServiceContextGroup"),
        ("CISCO-APPNAV-MIB", "cAppNavACGGroup"),
        ("CISCO-APPNAV-MIB", "cAppNavSNGGroup"),
        ("CISCO-APPNAV-MIB", "cAppNavACGroup"),
        ("CISCO-APPNAV-MIB", "cAppNavSNGroup"))
)
if mibBuilder.loadTexts:
...
ciscoAppNavMIBComplianceRev1.setObjects(
      *(("CISCO-APPNAV-MIB", "cAppNavServiceContextGroup"),
        ("CISCO-APPNAV-MIB", "cAppNavACGGroup"),
        ("CISCO-APPNAV-MIB", "cAppNavSNGGroup"),
        ("CISCO-APPNAV-MIB", "cAppNavACGroup"),
        ("CISCO-APPNAV-MIB", "cAppNavSNGroup"),
        ("CISCO-APPNAV-MIB", "cAppNavServiceContextGroupRev1"))
)
if mibBuilder.loadTexts:
