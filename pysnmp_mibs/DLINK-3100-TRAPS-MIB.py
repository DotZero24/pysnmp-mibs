...
_E='DLINK-3100-BRIDGEMIBOBJECTS-MIB'
_D='current'
_C='rndErrorSeverity'
_B='rndErrorDesc'
_A='DLINK-3100-DEVICEPARAMS-MIB'
...
rsIpZhrReqStaticConnNotAccepted=NotificationType((1,3,6,1,4,1,171,10,94,89,89,0,71))
...
rsIpZhrVirtualIpAsSource=NotificationType((1,3,6,1,4,1,171,10,94,89,89,0,72))
rsIpZhrVirtualIpAsSource.setObjects(*((_A,_B),(_A,_C)))
if mibBuilder.loadTexts:rsIpZhrVirtualIpAsSource.setStatus(_D)
rsIpZhrNotAllocVirtualIp=NotificationType((1,3,6,1,4,1,171,10,94,89,89,0,73))
rsIpZhrNotAllocVirtualIp.setObjects(*((_A,_B),(_A,_C)))
if mibBuilder.loadTexts:rsIpZhrNotAllocVirtualIp.setStatus(_D)
rsSnmpSetRequestInSpecialCfgState=NotificationType((1,3,6,1,4,1,171,10,94,89,89,0,74))
...
rldot1dStpPortStateNotForwarding=NotificationType((1,3,6,1,4,1,171,10,94,89,89,0,152))
...
rldot1xPortStatusUnauthorizedTrap=NotificationType((1,3,6,1,4,1,171,10,94,89,89,0,185))
...
rldot1xSupplicantMacUnauthorizedTrap=NotificationType((1,3,6,1,4,1,171,10,94,89,89,0,204))
