...
rndEndOfMib=_RndEndOfMib_Object((1,3,6,1,4,1,9,6,1,101,1000,1),_RndEndOfMib_Type())
rndEndOfMib.setMaxAccess('read-only')
if mibBuilder.loadTexts:rndEndOfMib.setStatus('current')
mibBuilder.exportSymbols('CISCOSB-ENDOFMIB-MIB',**{'rndEndOfMibGroup':rndEndOfMibGroup,'rndEndOfMib':rndEndOfMib})