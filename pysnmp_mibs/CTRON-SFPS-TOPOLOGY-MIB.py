...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cabletron/CTRON-SFPS-TOPOLOGY-MIB
...
sfpsNeighborEvents, sfpsTopologyServerTestIn, sfpsVLANTopAgentPortTableAPIIn, sfpsTPMPortTableAPIOut, sfpsESPTopologyAgent, sfpsRATopAgentPortTableAPIOut, sfpsTPMPortTableAPIIn, sfpsTopologyServerPortEventRelay, sfpsTopologyAgentCommon, sfpsRATopAgentPortTableAPIIn, sfpsDirViolationAPI, sfpsDirLockStats, sfpsVLANTopologyAgent, sfpsTopologyFCL, sfpsDapiNvramStats, sfpsRestrictedMobilityAPI, sfpsTAPITestOut, sfpsRestrictedMobility, sfpsTopologyPortManager, sfpsServiceCenter, sfpsDirViolationDeltaAPI, sfpsDirRestriction, sfpsVMTopologyServer, sfpsTAPITestIn, sfpsTopologyServerTest, sfpsRATopologyAgent, sfpsDirLockConfig, sfpsDirViolation, sfpsTopologyVNSNeighbors = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "sfpsNeighborEvents", "sfpsTopologyServerTestIn", "sfpsVLANTopAgentPortTableAPIIn", "sfpsTPMPortTableAPIOut", "sfpsESPTopologyAgent", "sfpsRATopAgentPortTableAPIOut", "sfpsTPMPortTableAPIIn", "sfpsTopologyServerPortEventRelay", "sfpsTopologyAgentCommon", "sfpsRATopAgentPortTableAPIIn", "sfpsDirViolationAPI", "sfpsDirLockStats", "sfpsVLANTopologyAgent", "sfpsTopologyFCL", "sfpsDapiNvramStats", "sfpsRestrictedMobilityAPI", "sfpsTAPITestOut", "sfpsRestrictedMobility", "sfpsTopologyPortManager", "sfpsServiceCenter", "sfpsDirViolationDeltaAPI", "sfpsDirRestriction", "sfpsVMTopologyServer", "sfpsTAPITestIn", "sfpsTopologyServerTest", "sfpsRATopologyAgent", "sfpsDirLockConfig", "sfpsDirViolation", "sfpsTopologyVNSNeighbors")
...
mibBuilder.exportSymbols("CTRON-SFPS-TOPOLOGY-MIB", sfpsIncompatibleNeighborLocalPortState=sfpsIncompatibleNeighborLocalPortState, HexInteger=HexInteger, sfpsRATopAgentPortTableAPIInVerb=sfpsRATopAgentPortTableAPIInVerb, sfpsVLANTopAgentPortPortOptions=sfpsVLANTopAgentPortPortOptions, sfpsCommonNeighborSwitchMAC=sfpsCommonNeighborSwitchMAC, sfpsTopologyServerTestTopRelayIPAddr=sfpsTopologyServerTestTopRelayIPAddr, sfpsTopologyFCLTable=sfpsTopologyFCLTable, sfpsIncompatibleNeighborChassisMAC=sfpsIncompatibleNeighborChassisMAC, sfpsDirViolationAPIVerb=sfpsDirViolationAPIVerb, sfpsIncompatibleNeighborSeqNumLossCount=sfpsIncompatibleNeighborSeqNumLossCount, sfpsIncompatibleNeighborFalseAgingCount=sfpsIncompatibleNeighborFalseAgingCount, sfpsDirLockStatsNumViolators=sfpsDirLockStatsNumViolators, sfpsRATopAgentPortTableAPIOutLogicalPort=sfpsRATopAgentPortTableAPIOutLogicalPort, sfpsVLANTopAgentPortSendFrequency=sfpsVLANTopAgentPortSendFrequency, sfpsRestrictedMobilityTable=sfpsRestrictedMobilityTable, sfpsTPMPortEntry=sfpsTPMPortEntry, sfpsRATopAgentPortStateChangeCount=sfpsRATopAgentPortStateChangeCount, sfpsIncompatibleNeighborTwoWayLossTime=sfpsIncompatibleNeighborTwoWayLossTime, sfpsRATopAgentNeighborEntry=sfpsRATopAgentNeighborEntry, sfpsTopologyServerTestInVerb=sfpsTopologyServerTestInVerb, sfpsDirViolationDeltaSrcPort=sfpsDirViolationDeltaSrcPort, sfpsCommonNeighborSwitchType=sfpsCommonNeighborSwitchType, sfpsRATopAgentPortTable=sfpsRATopAgentPortTable, sfpsVMTopServerChangeCnt=sfpsVMTopServerChangeCnt, sfpsTopologyServerPortEventRelayNewState=sfpsTopologyServerPortEventRelayNewState, sfpsTPMPortVlanAttributes=sfpsTPMPortVlanAttributes, sfpsIncompatibleNeighborFirstHeard=sfpsIncompatibleNeighborFirstHeard, sfpsTopologyServerTestTopRelayFLevel=sfpsTopologyServerTestTopRelayFLevel, sfpsDapiNvramStatsTotalEntries=sfpsDapiNvramStatsTotalEntries, sfpsTAPITestOutOutputInteger=sfpsTAPITestOutOutputInteger, sfpsDirViolationAOType=sfpsDirViolationAOType, sfpsVLANTopAgentPortHelloVersion=sfpsVLANTopAgentPortHelloVersion, sfpsRATopAgentNeighborNetHellosRcvd=sfpsRATopAgentNeighborNetHellosRcvd, sfpsTAPITestInSwitchID=sfpsTAPITestInSwitchID, sfpsTopologyServerTestOldState=sfpsTopologyServerTestOldState, sfpsRATopAgentPortLogicalPort=sfpsRATopAgentPortLogicalPort, sfpsDirViolationDeltaIndex=sfpsDirViolationDeltaIndex, sfpsCommonNeighborReceiveFrequency=sfpsCommonNeighborReceiveFrequency, sfpsVLANTopAgentPortTableAPIInHelloVersion=sfpsVLANTopAgentPortTableAPIInHelloVersion, sfpsDirViolationLocalPort=sfpsDirViolationLocalPort, sfpsDirViolationDeltaAOType=sfpsDirViolationDeltaAOType, sfpsDirLockConfigRouterPortLock=sfpsDirLockConfigRouterPortLock, sfpsCommonNeighborSwitchID=sfpsCommonNeighborSwitchID, sfpsRestrictedMobilityHash=sfpsRestrictedMobilityHash, sfpsRATopAgentPortTableAPIOutPortState=sfpsRATopAgentPortTableAPIOutPortState, sfpsCommonNeighborCompatibility=sfpsCommonNeighborCompatibility, sfpsVMTopServerDeltaCount=sfpsVMTopServerDeltaCount, sfpsTopologyFCLSendPortState=sfpsTopologyFCLSendPortState, sfpsDirViolationHashIndex=sfpsDirViolationHashIndex, sfpsTopologyServerTestServerFlavor=sfpsTopologyServerTestServerFlavor, sfpsDirViolationAPIAOValue=sfpsDirViolationAPIAOValue, sfpsVLANTopAgentNeighborTable=sfpsVLANTopAgentNeighborTable, sfpsTopologyServerTestEntry=sfpsTopologyServerTestEntry, sfpsDirViolationAPISourcePort=sfpsDirViolationAPISourcePort, sfpsVMTopServerDeltaAgent=sfpsVMTopServerDeltaAgent, sfpsCommonNeighborNotifyState=sfpsCommonNeighborNotifyState, sfpsESPTopAgentPortPort=sfpsESPTopAgentPortPort, sfpsHistoryTopologyServerFCL=sfpsHistoryTopologyServerFCL, sfpsRATopAgentPortEntry=sfpsRATopAgentPortEntry, sfpsVMTopServerDeltaSwitchID=sfpsVMTopServerDeltaSwitchID, sfpsCommonNeighborFirstHeard=sfpsCommonNeighborFirstHeard, sfpsTopologyServerTestNewState=sfpsTopologyServerTestNewState, sfpsServiceCenterTopologyResponses=sfpsServiceCenterTopologyResponses, sfpsDapiNvramStatsNvramUsed=sfpsDapiNvramStatsNvramUsed, sfpsServiceCenterTopologyEntry=sfpsServiceCenterTopologyEntry, sfpsCommonNeighborRcvdPortState=sfpsCommonNeighborRcvdPortState, sfpsHistoryTopologyServerSwitchID=sfpsHistoryTopologyServerSwitchID, sfpsRATopAgentNeighborNetHelloNetPortChanges=sfpsRATopAgentNeighborNetHelloNetPortChanges, sfpsRATopAgentPortTableAPIOutPrimarySwitch=sfpsRATopAgentPortTableAPIOutPrimarySwitch, sfpsRATopAgentPortTableAPIOutNetHelloRecvFreq=sfpsRATopAgentPortTableAPIOutNetHelloRecvFreq, sfpsVMTopServerTableFull=sfpsVMTopServerTableFull, sfpsRATopAgentPortTableAPIInNetHelloRecvFreq=sfpsRATopAgentPortTableAPIInNetHelloRecvFreq, sfpsTAPITestInUNIT321=sfpsTAPITestInUNIT321, sfpsTopologyServerTestInServer=sfpsTopologyServerTestInServer, sfpsIncompatibleNeighborLogicalPort=sfpsIncompatibleNeighborLogicalPort, sfpsIncompatibleNeighborCompatibility=sfpsIncompatibleNeighborCompatibility, sfpsRATopAgentNeighborSwitchID=sfpsRATopAgentNeighborSwitchID, sfpsDirViolationAPIViolType=sfpsDirViolationAPIViolType, sfpsTopologyServerTestTopRelayEntry=sfpsTopologyServerTestTopRelayEntry, sfpsHistoryTopologyServerChassisMAC=sfpsHistoryTopologyServerChassisMAC, sfpsDirViolationAPIAOType=sfpsDirViolationAPIAOType, sfpsVMTopServerPortChange=sfpsVMTopServerPortChange, sfpsTopologyServerTestPortNumber=sfpsTopologyServerTestPortNumber, sfpsRATopAgentPortNetHelloRecvFreq=sfpsRATopAgentPortNetHelloRecvFreq, sfpsServiceCenterTopologyRequests=sfpsServiceCenterTopologyRequests, sfpsCommonNeighborFalseAgingCount=sfpsCommonNeighborFalseAgingCount, sfpsTopologyServerTestTopRelayChassisIP=sfpsTopologyServerTestTopRelayChassisIP, sfpsCommonNeighborSendPortState=sfpsCommonNeighborSendPortState, sfpsRestrictedMobilitySwitch=sfpsRestrictedMobilitySwitch, sfpsRATopAgentNeighborNetHelloNetPortLosses=sfpsRATopAgentNeighborNetHelloNetPortLosses, sfpsTPMPortTableAPIInAdminPortDown=sfpsTPMPortTableAPIInAdminPortDown, sfpsTopologyServerTestIpAddr=sfpsTopologyServerTestIpAddr, sfpsIncompatibleNeighborSwitchIP=sfpsIncompatibleNeighborSwitchIP, sfpsRATopAgentNeighborCallTag=sfpsRATopAgentNeighborCallTag, sfpsServiceCenterTopologyTable=sfpsServiceCenterTopologyTable, sfpsTopologyServerTestLostPort=sfpsTopologyServerTestLostPort, sfpsRATopAgentPortSendFrequency=sfpsRATopAgentPortSendFrequency, sfpsTopologyFCLEntry=sfpsTopologyFCLEntry, sfpsTopologyServerTestTopRelayDeltaOptions=sfpsTopologyServerTestTopRelayDeltaOptions, sfpsVLANTopAgentNeighborEntry=sfpsVLANTopAgentNeighborEntry, sfpsCommonNeighborSwitchIP=sfpsCommonNeighborSwitchIP, sfpsTopologyFCLCompatability=sfpsTopologyFCLCompatability, sfpsVMTopServerDeltaIPAddress=sfpsVMTopServerDeltaIPAddress, sfpsVMTopServerTableLock=sfpsVMTopServerTableLock, sfpsTopologyServerTestTopologyAgent=sfpsTopologyServerTestTopologyAgent, sfpsHistoryTopologyServerDeltaOptionsMask=sfpsHistoryTopologyServerDeltaOptionsMask, sfpsVLANTopAgentPortTableAPIInLogicalPort=sfpsVLANTopAgentPortTableAPIInLogicalPort, sfpsDirViolationHash=sfpsDirViolationHash, sfpsDirLockStatsRestrictMobTblSize=sfpsDirLockStatsRestrictMobTblSize, sfpsTPMPortTableAPIInCorePortVID=sfpsTPMPortTableAPIInCorePortVID, sfpsRATopAgentPortPrimarySwitch=sfpsRATopAgentPortPrimarySwitch, sfpsCommonNeighborEntry=sfpsCommonNeighborEntry, sfpsVLANTopAgentNeighborOptions=sfpsVLANTopAgentNeighborOptions, sfpsVLANTopAgentPortRecvFrequency=sfpsVLANTopAgentPortRecvFrequency, sfpsDirViolationAOValue=sfpsDirViolationAOValue, sfpsDirLockStatsRestrictPortTblSize=sfpsDirLockStatsRestrictPortTblSize, sfpsESPTopAgentPortEntry=sfpsESPTopAgentPortEntry, sfpsDirViolationDeltaTable=sfpsDirViolationDeltaTable, sfpsHistoryTopologyServerIndex=sfpsHistoryTopologyServerIndex, sfpsTopologyServerTestTable=sfpsTopologyServerTestTable, sfpsTopologyServerTestTopRelayTable=sfpsTopologyServerTestTopRelayTable, sfpsRestrictedMobilityHashIndex=sfpsRestrictedMobilityHashIndex, sfpsTPMPortTableAPIInLogicalPort=sfpsTPMPortTableAPIInLogicalPort, sfpsCommonNeighborChassisMAC=sfpsCommonNeighborChassisMAC, sfpsTPMPortMediaType=sfpsTPMPortMediaType, sfpsVLANTopAgentPortTableAPIInRecvFrequency=sfpsVLANTopAgentPortTableAPIInRecvFrequency, sfpsIncompatibleNeighborNotifyState=sfpsIncompatibleNeighborNotifyState, sfpsDirLockStatsNumRestrictMob=sfpsDirLockStatsNumRestrictMob, sfpsHistoryTopologyServerEvent=sfpsHistoryTopologyServerEvent, sfpsRestrictedPortHashIndex=sfpsRestrictedPortHashIndex, sfpsTPMPortLogicalPort=sfpsTPMPortLogicalPort, sfpsRATopAgentPortNVRAMStatus=sfpsRATopAgentPortNVRAMStatus, sfpsServiceCenterTopologyStatusTime=sfpsServiceCenterTopologyStatusTime, sfpsDirLockStatsNumAliasLocked=sfpsDirLockStatsNumAliasLocked, sfpsServiceCenterTopologyName=sfpsServiceCenterTopologyName, sfpsDirViolationLastSeen=sfpsDirViolationLastSeen, sfpsESPTopAgentPortRecvFrequency=sfpsESPTopAgentPortRecvFrequency, sfpsRATopAgentPortTableAPIInLogicalPort=sfpsRATopAgentPortTableAPIInLogicalPort, sfpsDirViolationDeltaAPIVerb=sfpsDirViolationDeltaAPIVerb, sfpsESPTopAgentPortSendFrequency=sfpsESPTopAgentPortSendFrequency, sfpsCommonNeighborTwoWayLossCount=sfpsCommonNeighborTwoWayLossCount, sfpsVMTopServerDeltaEntry=sfpsVMTopServerDeltaEntry, sfpsTopologyFCLFunctionalLevel=sfpsTopologyFCLFunctionalLevel, sfpsTopologyServerTestTopRelayRelayNumber=sfpsTopologyServerTestTopRelayRelayNumber, sfpsCommonNeighborHellosReceived=sfpsCommonNeighborHellosReceived, sfpsNeighborEventsLostEvents=sfpsNeighborEventsLostEvents, sfpsRATopAgentPortPortState=sfpsRATopAgentPortPortState, sfpsRATopAgentPortRecvFrequency=sfpsRATopAgentPortRecvFrequency, sfpsRATopAgentPortTableAPIInHelloVersion=sfpsRATopAgentPortTableAPIInHelloVersion, sfpsServiceCenterTopologyOperStatus=sfpsServiceCenterTopologyOperStatus, sfpsHistoryTopologyServerEntry=sfpsHistoryTopologyServerEntry, sfpsTPMPortTableAPIInTopologyAgent=sfpsTPMPortTableAPIInTopologyAgent, sfpsDirViolationCount=sfpsDirViolationCount, sfpsDapiNvramStatsMacEntries=sfpsDapiNvramStatsMacEntries, sfpsDapiNvramStatsAliasEntries=sfpsDapiNvramStatsAliasEntries, sfpsTopologyServerTestTopRelayPortName=sfpsTopologyServerTestTopRelayPortName, sfpsCommonNeighborLastHeard=sfpsCommonNeighborLastHeard, sfpsTopologyServerTestTopRelayTopologyAgent=sfpsTopologyServerTestTopRelayTopologyAgent, sfpsDirLockConfigRAPortLock=sfpsDirLockConfigRAPortLock, sfpsRATopAgentNeighborPriority=sfpsRATopAgentNeighborPriority, sfpsCommonNeighborChassisIP=sfpsCommonNeighborChassisIP, sfpsVMTopServerDeltaIndex=sfpsVMTopServerDeltaIndex, sfpsTAPITestInPortTypeState=sfpsTAPITestInPortTypeState, sfpsTAPITestOutOutPutString=sfpsTAPITestOutOutPutString, sfpsRATopAgentPortTableAPIOutRecvFrequency=sfpsRATopAgentPortTableAPIOutRecvFrequency, sfpsTAPITestInLogicalPort=sfpsTAPITestInLogicalPort, sfpsDirLockConfigRestrictedPort=sfpsDirLockConfigRestrictedPort, sfpsRestrictedMobilityPort=sfpsRestrictedMobilityPort, sfpsHistoryTopologyServerChassisIP=sfpsHistoryTopologyServerChassisIP, sfpsHistoryTopologyServerLogicalPort=sfpsHistoryTopologyServerLogicalPort, sfpsIncompatibleNeighborSeqNumLossTime=sfpsIncompatibleNeighborSeqNumLossTime, sfpsDirViolationTable=sfpsDirViolationTable, sfpsDirViolationDeltaAOValue=sfpsDirViolationDeltaAOValue, sfpsVMTopServerDeltaState=sfpsVMTopServerDeltaState, sfpsVLANTopAgentPortPort=sfpsVLANTopAgentPortPort, sfpsTopologyServerTestRelayNumber=sfpsTopologyServerTestRelayNumber, sfpsTAPITestInTopologyAgentID=sfpsTAPITestInTopologyAgentID, sfpsHistoryTopologyServerTable=sfpsHistoryTopologyServerTable, sfpsTPMPortNVRAMStatus=sfpsTPMPortNVRAMStatus, sfpsIncompatibleNeighborSwitchID=sfpsIncompatibleNeighborSwitchID, sfpsIncompatibleNeighborSwitchMAC=sfpsIncompatibleNeighborSwitchMAC, sfpsDirViolationAPICPId=sfpsDirViolationAPICPId, sfpsDirLockStatsViolationTblSize=sfpsDirLockStatsViolationTblSize, sfpsRATopAgentPortTableAPIOutSendFrequency=sfpsRATopAgentPortTableAPIOutSendFrequency, sfpsRATopAgentPortTableAPIOutPriority=sfpsRATopAgentPortTableAPIOutPriority, sfpsTopologyServerTestTopRelayChassisMAC=sfpsTopologyServerTestTopRelayChassisMAC, SfpsAddress=SfpsAddress, sfpsRATopAgentNeighborTable=sfpsRATopAgentNeighborTable, sfpsIncompatibleNeighborOptionsMask=sfpsIncompatibleNeighborOptionsMask, sfpsRestrictedMobilityAPISrcMac=sfpsRestrictedMobilityAPISrcMac, sfpsServiceCenterTopologyMetric=sfpsServiceCenterTopologyMetric, sfpsTPMPortTable=sfpsTPMPortTable, sfpsCommonNeighborFalseAgingTime=sfpsCommonNeighborFalseAgingTime, sfpsIncompatibleNeighborFCL=sfpsIncompatibleNeighborFCL, sfpsTPMPortTopologyAgent=sfpsTPMPortTopologyAgent, sfpsRestrictedPortHash=sfpsRestrictedPortHash, sfpsDirLockConfigUserLocking=sfpsDirLockConfigUserLocking, sfpsCommonNeighborSeqNumLossCount=sfpsCommonNeighborSeqNumLossCount, sfpsTAPITestInMAC=sfpsTAPITestInMAC, sfpsTopologyServerTestInNumberOfRelays=sfpsTopologyServerTestInNumberOfRelays, sfpsCommonNeighborTwoWayLossTime=sfpsCommonNeighborTwoWayLossTime, sfpsVLANTopAgentPortTableAPIInVerb=sfpsVLANTopAgentPortTableAPIInVerb, sfpsTPMPortTableAPIInVerb=sfpsTPMPortTableAPIInVerb, sfpsIncompatibleNeighborSwitchType=sfpsIncompatibleNeighborSwitchType, sfpsDirViolationType=sfpsDirViolationType, sfpsCommonNeighborSeqNumLossTime=sfpsCommonNeighborSeqNumLossTime, sfpsIncompatibleNeighborEntry=sfpsIncompatibleNeighborEntry, sfpsTopologyServerPortEventRelayLogicalPort=sfpsTopologyServerPortEventRelayLogicalPort, sfpsIncompatibleNeighborTable=sfpsIncompatibleNeighborTable, sfpsHistoryTopologyServerAgent=sfpsHistoryTopologyServerAgent, sfpsDirViolationFirstSeen=sfpsDirViolationFirstSeen, sfpsVLANTopAgentNeighborInPort=sfpsVLANTopAgentNeighborInPort, sfpsDirLockStatsNumRestrictedPort=sfpsDirLockStatsNumRestrictedPort, sfpsDirViolationDeltaEntryType=sfpsDirViolationDeltaEntryType, sfpsTopologyServerPortEventRelayOldState=sfpsTopologyServerPortEventRelayOldState, sfpsIncompatibleNeighborHellosReceived=sfpsIncompatibleNeighborHellosReceived, sfpsDirViolationSrcMac=sfpsDirViolationSrcMac, sfpsRestrictedPortTable=sfpsRestrictedPortTable, sfpsIncompatibleNeighborTwoWayLossCount=sfpsIncompatibleNeighborTwoWayLossCount, sfpsDapiNvramStatsMaxEntries=sfpsDapiNvramStatsMaxEntries, sfpsRATopAgentPortTableAPIInSendFrequency=sfpsRATopAgentPortTableAPIInSendFrequency, sfpsESPTopAgentPortTable=sfpsESPTopAgentPortTable, sfpsIncompatibleNeighborTopologyAgent=sfpsIncompatibleNeighborTopologyAgent, sfpsTopologyServerTestTopRelayEvent=sfpsTopologyServerTestTopRelayEvent, sfpsCommonNeighborCommState=sfpsCommonNeighborCommState, sfpsIncompatibleNeighborCommState=sfpsIncompatibleNeighborCommState, sfpsRATopAgentPortTableAPIInPriority=sfpsRATopAgentPortTableAPIInPriority, sfpsCommonNeighborTable=sfpsCommonNeighborTable, sfpsESPTopAgentPortHelloVersion=sfpsESPTopAgentPortHelloVersion, sfpsVLANTopAgentPortEntry=sfpsVLANTopAgentPortEntry, sfpsRestrictedPortPort=sfpsRestrictedPortPort, sfpsTopologyServerTestTopRelayLogicalPort=sfpsTopologyServerTestTopRelayLogicalPort, sfpsIncompatibleNeighborRemotePortState=sfpsIncompatibleNeighborRemotePortState, sfpsIncompatibleNeighborReceiveFrequency=sfpsIncompatibleNeighborReceiveFrequency, sfpsCommonNeighborCorePortVID=sfpsCommonNeighborCorePortVID, sfpsCommonNeighborLogicalPort=sfpsCommonNeighborLogicalPort, sfpsServiceCenterTopologyAdminStatus=sfpsServiceCenterTopologyAdminStatus, sfpsIncompatibleNeighborChassisIP=sfpsIncompatibleNeighborChassisIP, sfpsVMTopServerDeltaTable=sfpsVMTopServerDeltaTable, sfpsTAPITestInVerb=sfpsTAPITestInVerb, sfpsRATopAgentNeighborInPort=sfpsRATopAgentNeighborInPort, sfpsDirViolationDeltaEntry=sfpsDirViolationDeltaEntry, sfpsRestrictedMobilitySrcMac=sfpsRestrictedMobilitySrcMac, sfpsIncompatibleNeighborLastHeard=sfpsIncompatibleNeighborLastHeard, sfpsTopologyFCLThisPortState=sfpsTopologyFCLThisPortState, sfpsHistoryTopologyServerSwitchIP=sfpsHistoryTopologyServerSwitchIP, sfpsRestrictedPortEntry=sfpsRestrictedPortEntry, sfpsDapiNvramStatsVerb=sfpsDapiNvramStatsVerb, sfpsServiceCenterTopologyHashLeaf=sfpsServiceCenterTopologyHashLeaf, sfpsTPMPortTableAPIOutLogicalPort=sfpsTPMPortTableAPIOutLogicalPort, sfpsHistoryTopologyServerCurrentOptionsMask=sfpsHistoryTopologyServerCurrentOptionsMask, sfpsNeighborEventsFoundEvents=sfpsNeighborEventsFoundEvents, sfpsRATopAgentNeighborNetHelloAgeTimeOuts=sfpsRATopAgentNeighborNetHelloAgeTimeOuts, sfpsVLANTopAgentPortNVRAMStatus=sfpsVLANTopAgentPortNVRAMStatus)
mibBuilder.exportSymbols("CTRON-SFPS-TOPOLOGY-MIB", sfpsTPMPortTableAPIInAdminPortUp=sfpsTPMPortTableAPIInAdminPortUp, sfpsVMTopServerDeltaInPort=sfpsVMTopServerDeltaInPort, sfpsCommonNeighborFCL=sfpsCommonNeighborFCL, sfpsRATopAgentPortHelloVersion=sfpsRATopAgentPortHelloVersion, sfpsDirViolationCPId=sfpsDirViolationCPId, sfpsDirViolationAPIChangeCount=sfpsDirViolationAPIChangeCount, sfpsRATopAgentNeighborSeqNumMismatch=sfpsRATopAgentNeighborSeqNumMismatch, sfpsCommonNeighborTopologyAgent=sfpsCommonNeighborTopologyAgent, sfpsVLANTopAgentPortTable=sfpsVLANTopAgentPortTable, sfpsHistoryTopologyServerSysTime=sfpsHistoryTopologyServerSysTime, sfpsTPMPortCorePortVID=sfpsTPMPortCorePortVID, sfpsRATopAgentPortTableAPIOutPortStateChangeCount=sfpsRATopAgentPortTableAPIOutPortStateChangeCount, sfpsVLANTopAgentPortTableAPIInSendFrequency=sfpsVLANTopAgentPortTableAPIInSendFrequency, sfpsRestrictedMobilityEntry=sfpsRestrictedMobilityEntry, sfpsRATopAgentPortTableAPIInRecvFrequency=sfpsRATopAgentPortTableAPIInRecvFrequency, sfpsTopologyServerTestTopRelayCurrentOptions=sfpsTopologyServerTestTopRelayCurrentOptions, sfpsDirViolationEntry=sfpsDirViolationEntry, sfpsRestrictedPortSrcMac=sfpsRestrictedPortSrcMac, sfpsRestrictedMobilityAPIVerb=sfpsRestrictedMobilityAPIVerb, sfpsCommonNeighborOptionsMask=sfpsCommonNeighborOptionsMask, sfpsDirViolationDeltaAPINumEntries=sfpsDirViolationDeltaAPINumEntries, sfpsDirLockStatsNumNodeLocked=sfpsDirLockStatsNumNodeLocked, sfpsIncompatibleNeighborFalseAgingTime=sfpsIncompatibleNeighborFalseAgingTime, sfpsTopologyServerTestPortName=sfpsTopologyServerTestPortName, sfpsDirViolationSrcPort=sfpsDirViolationSrcPort, sfpsRATopAgentPortTableAPIOutHelloVersion=sfpsRATopAgentPortTableAPIOutHelloVersion, sfpsTPMPortTableAPIOutTopologyAgent=sfpsTPMPortTableAPIOutTopologyAgent, sfpsRestrictedMobilityAPISwitch=sfpsRestrictedMobilityAPISwitch, sfpsRestrictedMobilityAPISourcePort=sfpsRestrictedMobilityAPISourcePort, sfpsVLANTopAgentNeighborSwitchID=sfpsVLANTopAgentNeighborSwitchID, sfpsRATopAgentPortPriority=sfpsRATopAgentPortPriority, sfpsRATopAgentNeighborNetworkPort=sfpsRATopAgentNeighborNetworkPort)
