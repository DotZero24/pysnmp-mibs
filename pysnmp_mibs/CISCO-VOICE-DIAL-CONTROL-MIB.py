...
CvcFaxTransmitRate, CvcInBandSignaling, CvcCallReferenceIdOrZero, CvcGUid, CvcCoderTypeRate, cvCommonDcCallHistoryCoderTypeRate, CvcSpeechCoderRate = mibBuilder.importSymbols("CISCO-VOICE-COMMON-DIAL-CONTROL-MIB", "CvcFaxTransmitRate", "CvcInBandSignaling", "CvcCallReferenceIdOrZero", "CvcGUid", "CvcCoderTypeRate", "cvCommonDcCallHistoryCoderTypeRate", "CvcSpeechCoderRate")
DnisMapname, = mibBuilder.importSymbols("CISCO-VOICE-DNIS-MIB", "DnisMapname")
callActiveIndex, callActivePeerAddress, callActiveSetupTime, callActivePeerId, AbsoluteCounter32 = mibBuilder.importSymbols("DIAL-CONTROL-MIB", "callActiveIndex", "callActivePeerAddress", "callActiveSetupTime", "callActivePeerId", "AbsoluteCounter32")
...
mibBuilder.exportSymbols("CISCO-VOICE-DIAL-CONTROL-MIB", cvVoIPCallActiveConnectionId=cvVoIPCallActiveConnectionId, cvVoIPCallActiveMaxPtime=cvVoIPCallActiveMaxPtime, cvVoIPCallGroupSup1=cvVoIPCallGroupSup1, cvCallRateStatsMaxVal=cvCallRateStatsMaxVal, cvVoIPCallHistoryCRC=cvVoIPCallHistoryCRC, cvCallActiveSessionTarget=cvCallActiveSessionTarget, cvCallRateStatsIntvlDur=cvCallRateStatsIntvlDur, cvCallVolumeGroup=cvCallVolumeGroup, cvVoIPCallGroupRev1=cvVoIPCallGroupRev1, cvCallHistoryCallId=cvCallHistoryCallId, cvGeneralMediaPolicyNotificationEnable=cvGeneralMediaPolicyNotificationEnable, cvVoicePeerCfgForwardDigits=cvVoicePeerCfgForwardDigits, cvdcNotificationGroup=cvdcNotificationGroup, cvVoIPPeerCfgCoderRate=cvVoIPPeerCfgCoderRate, cvVoIPCallActiveCallReferenceId=cvVoIPCallActiveCallReferenceId, CvAmrNbBitRateMode=CvAmrNbBitRateMode, cvCallVolumeWMTableSize=cvCallVolumeWMTableSize, cvCallVolPeerTable=cvCallVolPeerTable, cvVoIPPeerCfgMediaPolicyNotificationEnable=cvVoIPPeerCfgMediaPolicyNotificationEnable, cvCallActiveNoiseLevel=cvCallActiveNoiseLevel, cvPeerCommonCfgSourceTrunkGrpLabel=cvPeerCommonCfgSourceTrunkGrpLabel, cvCallHistorySessionTarget=cvCallHistorySessionTarget, cvVoIPCallHistoryRobustSorting=cvVoIPCallHistoryRobustSorting, cvVoIPPeerCfgMinAcceptableQoSVideo=cvVoIPPeerCfgMinAcceptableQoSVideo, cvPeerCommonCfgEntry=cvPeerCommonCfgEntry, cvCallGroup=cvCallGroup, cvVoIPCallActiveModeChgPeriod=cvVoIPCallActiveModeChgPeriod, cvVoIPCallActiveInterleaving=cvVoIPCallActiveInterleaving, cvActiveCallStatsIntvlDurUnits=cvActiveCallStatsIntvlDurUnits, cvVoIPCallHistorySelectedQoS=cvVoIPCallHistorySelectedQoS, cvGeneralFallbackNotificationEnable=cvGeneralFallbackNotificationEnable, cvActiveCallWMValue=cvActiveCallWMValue, cvCallActiveTable=cvCallActiveTable, cvVoIPCallHistoryInterleaving=cvVoIPCallHistoryInterleaving, cvVoIPCallHistoryCallReferenceId=cvVoIPCallHistoryCallReferenceId, cvVoIPCallActiveProtocolCallId=cvVoIPCallActiveProtocolCallId, cvActiveCallStatsIntvlDur=cvActiveCallStatsIntvlDur, cvdcMIBComplianceRev7=cvdcMIBComplianceRev7, cvdcVoIPCfgIlbcGroup=cvdcVoIPCfgIlbcGroup, cvVoIPCallActiveVADEnable=cvVoIPCallActiveVADEnable, cvActiveCallWMIndex=cvActiveCallWMIndex, cvVoIPCallActiveEarlyPackets=cvVoIPCallActiveEarlyPackets, cvPeerCfgIfIndex=cvPeerCfgIfIndex, cvVoIPCallHistoryRemMediaPort=cvVoIPCallHistoryRemMediaPort, cvVoicePeerCfgCasGroup=cvVoicePeerCfgCasGroup, cvCallVolPeerOutgoingCalls=cvCallVolPeerOutgoingCalls, cvdcMIBComplianceRev20=cvdcMIBComplianceRev20, cvCallRateStatsTable=cvCallRateStatsTable, cvVoIPCallHistoryRemoteIPAddress=cvVoIPCallHistoryRemoteIPAddress, cvSipMsgRateWMIntvlDurUnits=cvSipMsgRateWMIntvlDurUnits, cvdcMIBComplianceRev18=cvdcMIBComplianceRev18, cvVoIPCallHistoryCallId=cvVoIPCallHistoryCallId, cvVoIPCallGroupSup3=cvVoIPCallGroupSup3, cvCallActiveFaxTxDuration=cvCallActiveFaxTxDuration, cvCallActiveTxDuration=cvCallActiveTxDuration, CvAmrNbRtpEncap=CvAmrNbRtpEncap, cvVoIPCallActiveReceiveDelay=cvVoIPCallActiveReceiveDelay, cvdcPolicyViolationNotification=cvdcPolicyViolationNotification, cvdcMIBCompliance=cvdcMIBCompliance, cvCallActiveACOMLevel=cvCallActiveACOMLevel, cvCallGroupRev2=cvCallGroupRev2, cvVoIPPeerCfgExpectFactor=cvVoIPPeerCfgExpectFactor, cvCallRateWMValue=cvCallRateWMValue, cvCallLegRateWMTable=cvCallLegRateWMTable, cvdcMIBComplianceRev11=cvdcMIBComplianceRev11, cvCallDurationStatsIntvlDurUnits=cvCallDurationStatsIntvlDurUnits, cvVoIPCallHistorySessionId=cvVoIPCallHistorySessionId, cvCallVolConnActiveConnection=cvCallVolConnActiveConnection, cvCallDurationStatsTable=cvCallDurationStatsTable, cvdcMIBComplianceRev14=cvdcMIBComplianceRev14, cvVoIPCallActiveOctetAligned=cvVoIPCallActiveOctetAligned, cvPeerCfgEntry=cvPeerCfgEntry, cvCallActiveDS0s=cvCallActiveDS0s, cvVoIPCallActiveLoWaterPlayoutDelay=cvVoIPCallActiveLoWaterPlayoutDelay, cvVoIPCallActiveLostPackets=cvVoIPCallActiveLostPackets, cvVoIPCallActiveCallId=cvVoIPCallActiveCallId, cvVoIPCallHistoryEntry=cvVoIPCallHistoryEntry, cvPeerCommonCfgIncomingDnisDigits=cvPeerCommonCfgIncomingDnisDigits, cvCallActiveEntry=cvCallActiveEntry, cvVoIPCallHistoryConnectionId=cvVoIPCallHistoryConnectionId, cvCallLegRateWMEntry=cvCallLegRateWMEntry, cvCallLegRateWMts=cvCallLegRateWMts, cvdcVoiceCfgGroup=cvdcVoiceCfgGroup, cvVoIPCallActiveSelectedQoS=cvVoIPCallActiveSelectedQoS, cvdcCallVolumeStatsHistory=cvdcCallVolumeStatsHistory, cvCallVolConnTotalActiveConnections=cvCallVolConnTotalActiveConnections, cvVoIPPeerCfgFaxRate=cvVoIPPeerCfgFaxRate, cvCallVolMediaIncomingCalls=cvCallVolMediaIncomingCalls, CvCallConnectionType=CvCallConnectionType, cvVoIPCallActiveRemMediaPort=cvVoIPCallActiveRemMediaPort, cvVoIPPeerCfgFaxBytes=cvVoIPPeerCfgFaxBytes, cvCallVolMediaOutgoingCalls=cvCallVolMediaOutgoingCalls, cvdcMIBComplianceRev2=cvdcMIBComplianceRev2, cvVoIPPeerCfgMinAcceptableQoS=cvVoIPPeerCfgMinAcceptableQoS, cvVoIPCallHistorySessionProtocol=cvVoIPCallHistorySessionProtocol, CvCallVolumeStatsIntvlType=CvCallVolumeStatsIntvlType, cvVoIPCallActiveSessionTarget=cvVoIPCallActiveSessionTarget, cvdcMIBCompliances=cvdcMIBCompliances, cvPeer=cvPeer, cvCallHistoryTable=cvCallHistoryTable, cvCallVolPeerIncomingCalls=cvCallVolPeerIncomingCalls, cvCallHistoryTxDuration=cvCallHistoryTxDuration, cvVoIPCallActiveChannels=cvVoIPCallActiveChannels, cvdcGeneralCfgGroupRev5=cvdcGeneralCfgGroupRev5, cvActiveCallWMts=cvActiveCallWMts, cvCallLegRateStatsIntvlDur=cvCallLegRateStatsIntvlDur, cvCallDurationStatsMaxVal=cvCallDurationStatsMaxVal, cvdcMIBConformance=cvdcMIBConformance, cvVoIPCallActiveRemSigIPAddr=cvVoIPCallActiveRemSigIPAddr, cvActiveCallWMEntry=cvActiveCallWMEntry, cvCallRateMonitorTime=cvCallRateMonitorTime, cvVoIPPeerCfgUDPChecksumEnable=cvVoIPPeerCfgUDPChecksumEnable, cvVoIPCallActiveReversedDirectionPeerAddress=cvVoIPCallActiveReversedDirectionPeerAddress, CvCasGroup=CvCasGroup, cvdcNotificationGroupRev3=cvdcNotificationGroupRev3, cvVoIPCallHistorySessionTarget=cvVoIPCallHistorySessionTarget, cvSipMsgRateStatsEntry=cvSipMsgRateStatsEntry, cvVoIPCallHistoryCoderTypeRate=cvVoIPCallHistoryCoderTypeRate, cvSipMsgRateWMIndex=cvSipMsgRateWMIndex, cvVoIPCallActiveLatePackets=cvVoIPCallActiveLatePackets, cvdcVoIPCfgGroup=cvdcVoIPCfgGroup, cvVoIPCallGroupSup2=cvVoIPCallGroupSup2, cvVoIPCallIlbcGroup=cvVoIPCallIlbcGroup, cvdcMIBComplianceRev1=cvdcMIBComplianceRev1, cvCallLegRateStatsTable=cvCallLegRateStatsTable, cvdcVoiceCfgGroupRev1=cvdcVoiceCfgGroupRev1, cvVoIPCallHistoryRoundTripDelay=cvVoIPCallHistoryRoundTripDelay, cvSipMsgRateWMEntry=cvSipMsgRateWMEntry, cvdcActiveDS0sLowNotification=cvdcActiveDS0sLowNotification, cvCallVolume=cvCallVolume, cvCallVolIfEntry=cvCallVolIfEntry, cvSipMsgRateWMValue=cvSipMsgRateWMValue, cvdcMIBComplianceRev17=cvdcMIBComplianceRev17, cvCallActiveOutSignalLevel=cvCallActiveOutSignalLevel, cvPeerCommonCfgTable=cvPeerCommonCfgTable, cvCallHistoryConnectionId=cvCallHistoryConnectionId, cvdcMIBComplianceRev21=cvdcMIBComplianceRev21, cvVoIPPeerCfgBitRates=cvVoIPPeerCfgBitRates, cvVoIPCallActiveModeChgNeighbor=cvVoIPCallActiveModeChgNeighbor, cvVoIPCallHistoryFallbackIcpif=cvVoIPCallHistoryFallbackIcpif, cvVoIPCallActiveRemoteIPAddress=cvVoIPCallActiveRemoteIPAddress, cvdcMIBComplianceRev22=cvdcMIBComplianceRev22, cvdcPoorQoVNotification=cvdcPoorQoVNotification, cvVoIPCallGroupRev5=cvVoIPCallGroupRev5, cvCallHistoryACOMLevel=cvCallHistoryACOMLevel, cvActiveCallStatsAvgVal=cvActiveCallStatsAvgVal, cvCallActiveInSignalLevel=cvCallActiveInSignalLevel, cvVoIPCallHistoryRemMediaIPAddr=cvVoIPCallHistoryRemMediaIPAddr, cvdcMIBComplianceRev6=cvdcMIBComplianceRev6, cvCallVolIfTable=cvCallVolIfTable, cvVoIPPeerCfgCoderMode=cvVoIPPeerCfgCoderMode, cvVoicePeerCfgTable=cvVoicePeerCfgTable, cvVoIPCallActiveRobustSorting=cvVoIPCallActiveRobustSorting, cvVoIPCallHistorySRTPEnable=cvVoIPCallHistorySRTPEnable, cvVoIPPeerCfgDigitRelay=cvVoIPPeerCfgDigitRelay, cvCallRateMonitorEnable=cvCallRateMonitorEnable, ciscoVoiceDialControlMIB=ciscoVoiceDialControlMIB, cvPeerCommonCfgMaxConnections=cvPeerCommonCfgMaxConnections, cvVoIPPeerCfgCoderBytes=cvVoIPPeerCfgCoderBytes, cvCallHistoryEntry=cvCallHistoryEntry, cvVoIPPeerCfgSessionProtocol=cvVoIPPeerCfgSessionProtocol, cvdcFallbackNotification=cvdcFallbackNotification, cvVoIPPeerCfgCodingMode=cvVoIPPeerCfgCodingMode, cvVoIPCallActiveGapFillWithRedundancy=cvVoIPCallActiveGapFillWithRedundancy, cvCallRateWMTable=cvCallRateWMTable, cvVoIPPeerCfgVADEnable=cvVoIPPeerCfgVADEnable, cvdcVoIPCfgGroupRev3=cvdcVoIPCfgGroupRev3, cvVoicePeerCfgSessionTarget=cvVoicePeerCfgSessionTarget, cvVoIPCallActiveTable=cvVoIPCallActiveTable, cvGatewayCallHistory=cvGatewayCallHistory, cvdcNotificationGroupRev1=cvdcNotificationGroupRev1, cvdcMIBComplianceRev10=cvdcMIBComplianceRev10, cvVoIPCallHistoryChannels=cvVoIPCallHistoryChannels, cvCallVolConnEntry=cvCallVolConnEntry, cvVoIPCallHistoryRemSigIPAddr=cvVoIPCallHistoryRemSigIPAddr, cvdcMIBComplianceRev5=cvdcMIBComplianceRev5, cvCallLegRateStatsMaxVal=cvCallLegRateStatsMaxVal, cvVoIPCallHistoryTable=cvVoIPCallHistoryTable, cvCallHistoryNoiseLevel=cvCallHistoryNoiseLevel, cvCallActiveDS0sHighThreshold=cvCallActiveDS0sHighThreshold, cvVoIPCallHistoryUsername=cvVoIPCallHistoryUsername, cvVoIPPeerCfgInBandSignaling=cvVoIPPeerCfgInBandSignaling, cvVoIPCallHistoryReceiveDelay=cvVoIPCallHistoryReceiveDelay, cvdcMIBComplianceRev9=cvdcMIBComplianceRev9, cvdcMIBNotifications=cvdcMIBNotifications, cvCallActiveCallId=cvCallActiveCallId, cvVoIPPeerCfgIPPrecedence=cvVoIPPeerCfgIPPrecedence, PYSNMP_MODULE_ID=ciscoVoiceDialControlMIB, cvVoIPCallHistoryRemMediaIPAddrT=cvVoIPCallHistoryRemMediaIPAddrT, cvCallActiveERLLevel=cvCallActiveERLLevel, cvVoIPCallHistoryGapFillWithRedundancy=cvVoIPCallHistoryGapFillWithRedundancy, cvVoIPCallHistoryMaxPtime=cvVoIPCallHistoryMaxPtime, cvCallActiveCoderTypeRate=cvCallActiveCoderTypeRate, cvPeerCfgTable=cvPeerCfgTable, cvPeerCommonCfgApplicationName=cvPeerCommonCfgApplicationName, cvVoIPCallActiveRoundTripDelay=cvVoIPCallActiveRoundTripDelay, cvSipMsgRateStatsAvgVal=cvSipMsgRateStatsAvgVal, cvGeneralDSCPPolicyNotificationEnable=cvGeneralDSCPPolicyNotificationEnable, cvVoIPCallHistoryRemoteUDPPort=cvVoIPCallHistoryRemoteUDPPort, cvdcMIBComplianceRev4=cvdcMIBComplianceRev4, cvdcMIBComplianceRev12=cvdcMIBComplianceRev12, cvCallGroupRev5=cvCallGroupRev5, CvSessionProtocol=CvSessionProtocol, cvGatewayCallActive=cvGatewayCallActive, cvCallHistoryCoderTypeRate=cvCallHistoryCoderTypeRate, cvCallLegRateWMValue=cvCallLegRateWMValue, cvdcMIBComplianceRev19=cvdcMIBComplianceRev19, cvdcGeneralCfgGroupRev1=cvdcGeneralCfgGroupRev1, cvVoIPCallAmrNbGroup=cvVoIPCallAmrNbGroup, cvVoIPCallActiveRemMediaIPAddrT=cvVoIPCallActiveRemMediaIPAddrT, cvVoIPCallHistoryPtime=cvVoIPCallHistoryPtime, cvdcVoIPCfgGroupRev1=cvdcVoIPCfgGroupRev1, cvPeerCommonCfgSourceCarrierId=cvPeerCommonCfgSourceCarrierId, cvCallActiveCallingName=cvCallActiveCallingName, cvSipMsgRateStatsIntvlDur=cvSipMsgRateStatsIntvlDur, cvSipMsgRateStatsMaxVal=cvSipMsgRateStatsMaxVal, cvCallVolumeStatsHistory=cvCallVolumeStatsHistory, cvdcMIBComplianceRev8=cvdcMIBComplianceRev8, cvCallHistoryCallerIDBlock=cvCallHistoryCallerIDBlock, cvdcMIBObjects=cvdcMIBObjects, cvCallRateWMts=cvCallRateWMts, cvCallActiveCallerIDBlock=cvCallActiveCallerIDBlock, cvPeerCommonCfgHuntStop=cvPeerCommonCfgHuntStop, cvVoIPPeerCfgPoorQoVNotificationEnable=cvVoIPPeerCfgPoorQoVNotificationEnable, cvCallRateWMIndex=cvCallRateWMIndex, cvVoicePeerCfgDIDCallEnable=cvVoicePeerCfgDIDCallEnable, cvPeerCfgPeerType=cvPeerCfgPeerType, cvCallGroupRev1=cvCallGroupRev1, cvVoIPCallActiveBitRates=cvVoIPCallActiveBitRates, cvVoIPCallGroupRev4=cvVoIPCallGroupRev4, cvdcVoIPCfgISACGroup=cvdcVoIPCfgISACGroup, cvdcPoorQoVNotificationRev1=cvdcPoorQoVNotificationRev1, cvdcMIBNotificationPrefix=cvdcMIBNotificationPrefix, cvCallActiveImgPageCount=cvCallActiveImgPageCount, cvCallActiveVoiceTxDuration=cvCallActiveVoiceTxDuration, cvPeerCfgType=cvPeerCfgType, cvVoIPPeerCfgTechPrefix=cvVoIPPeerCfgTechPrefix, cvCallRateStatsEntry=cvCallRateStatsEntry, cvVoIPCallGroup=cvVoIPCallGroup, cvVoIPCallActiveHiWaterPlayoutDelay=cvVoIPCallActiveHiWaterPlayoutDelay, cvCallHistoryAccountCode=cvCallHistoryAccountCode, cvCallActiveEcanReflectorLocation=cvCallActiveEcanReflectorLocation, cvCallHistoryVoiceTxDuration=cvCallHistoryVoiceTxDuration, cvVoIPCallHistoryModeChgNeighbor=cvVoIPCallHistoryModeChgNeighbor, cvVoicePeerCfgEchoCancellerTest=cvVoicePeerCfgEchoCancellerTest, cvCallHistoryFaxTxDuration=cvCallHistoryFaxTxDuration, cvVoIPCallHistoryProtocolCallId=cvVoIPCallHistoryProtocolCallId, cvSipMsgRateWMTable=cvSipMsgRateWMTable, cvPeerCommonCfgDnisMappingName=cvPeerCommonCfgDnisMappingName, cvVoIPCallHistoryRemSigPort=cvVoIPCallHistoryRemSigPort, cvdcGeneralCfgGroupRev6=cvdcGeneralCfgGroupRev6, cvVoIPPeerCfgMediaSetting=cvVoIPPeerCfgMediaSetting, cvVoIPPeerCfgFrameSize=cvVoIPPeerCfgFrameSize, cvCallGroupRev3=cvCallGroupRev3)
mibBuilder.exportSymbols("CISCO-VOICE-DIAL-CONTROL-MIB", cvVoicePeerCfgRegisterE164=cvVoicePeerCfgRegisterE164, cvPeerCommonCfgTargetCarrierId=cvPeerCommonCfgTargetCarrierId, cvActiveCallStatsEntry=cvActiveCallStatsEntry, cvActiveCallStatsTable=cvActiveCallStatsTable, cvVoIPCallActiveSRTPEnable=cvVoIPCallActiveSRTPEnable, cvVoIPCallGroupRev6=cvVoIPCallGroupRev6, cvCallGroupRev4=cvCallGroupRev4, cvCallVolPeerEntry=cvCallVolPeerEntry, cvVoIPCallHistoryGapFillWithSilence=cvVoIPCallHistoryGapFillWithSilence, cvCallVolConnTable=cvCallVolConnTable, cvdcVoIPCfgGroupRev4=cvdcVoIPCfgGroupRev4, cvCallRateMonitor=cvCallRateMonitor, cvActiveCallStatsMaxVal=cvActiveCallStatsMaxVal, cvVoIPPeerCfgRedirectip2ip=cvVoIPPeerCfgRedirectip2ip, cvVoIPCallActiveSessionId=cvVoIPCallActiveSessionId, cvVoIPCallActiveCRC=cvVoIPCallActiveCRC, cvVoIPCallActiveCoderTypeRate=cvVoIPCallActiveCoderTypeRate, cvdcVoIPCfgAmrNbGroup=cvdcVoIPCfgAmrNbGroup, cvVoIPPeerCfgCRC=cvVoIPPeerCfgCRC, cvVoIPCallActiveRemMediaIPAddr=cvVoIPCallActiveRemMediaIPAddr, cvdcMIBComplianceRev15=cvdcMIBComplianceRev15, cvCallLegRateWMIndex=cvCallLegRateWMIndex, CvCallVolumeWMIntvlType=CvCallVolumeWMIntvlType, cvCallRateStatsAvgVal=cvCallRateStatsAvgVal, cvCallActiveDS0sHighNotifyEnable=cvCallActiveDS0sHighNotifyEnable, CvIlbcFrameMode=CvIlbcFrameMode, cvVoIPCallHistoryVADEnable=cvVoIPCallHistoryVADEnable, cvdcGeneralCfgGroupRev3=cvdcGeneralCfgGroupRev3, cvCallRateWMEntry=cvCallRateWMEntry, cvVoIPCallHistoryHiWaterPlayoutDelay=cvVoIPCallHistoryHiWaterPlayoutDelay, cvVoIPCallHistoryGapFillWithPrediction=cvVoIPCallHistoryGapFillWithPrediction, cvVoIPCallActiveEncap=cvVoIPCallActiveEncap, cvVoIPPeerCfgEntry=cvVoIPPeerCfgEntry, cvVoIPCallActiveCoderMode=cvVoIPCallActiveCoderMode, cvCallLegRateStatsAvgVal=cvCallLegRateStatsAvgVal, cvVoIPCallActiveUsername=cvVoIPCallActiveUsername, cvActiveCallWMIntvlDurUnits=cvActiveCallWMIntvlDurUnits, cvVoIPCallHistoryRemSigIPAddrT=cvVoIPCallHistoryRemSigIPAddrT, cvdcMIBComplianceRev13=cvdcMIBComplianceRev13, cvCallRateWMIntvlDurUnits=cvCallRateWMIntvlDurUnits, cvVoIPCallActiveGapFillWithInterpolation=cvVoIPCallActiveGapFillWithInterpolation, cvVoIPPeerCfgBitRate=cvVoIPPeerCfgBitRate, cvGeneralConfiguration=cvGeneralConfiguration, cvVoIPCallHistoryIcpif=cvVoIPCallHistoryIcpif, cvActiveCallWMTable=cvActiveCallWMTable, cvVoIPPeerCfgSessionTarget=cvVoIPPeerCfgSessionTarget, cvVoIPCallHistoryGapFillWithInterpolation=cvVoIPCallHistoryGapFillWithInterpolation, cvCallDurationStatsThreshold=cvCallDurationStatsThreshold, cvCallActiveERLLevelRev1=cvCallActiveERLLevelRev1, cvCallRateHiWaterMark=cvCallRateHiWaterMark, cvPeerCfgRowStatus=cvPeerCfgRowStatus, cvdcNotificationGroupRev4=cvdcNotificationGroupRev4, cvPeerCfgIndex=cvPeerCfgIndex, cvVoIPCallActiveGapFillWithSilence=cvVoIPCallActiveGapFillWithSilence, cvVoIPCallHistoryEarlyPackets=cvVoIPCallHistoryEarlyPackets, cvVoIPCallHistoryLatePackets=cvVoIPCallHistoryLatePackets, cvPeerCommonCfgPreference=cvPeerCommonCfgPreference, cvCallDurationStatsAvgVal=cvCallDurationStatsAvgVal, cvCallLegRateWMIntvlDurUnits=cvCallLegRateWMIntvlDurUnits, cvVoIPCallHistoryEncap=cvVoIPCallHistoryEncap, cvCallActiveDS0sLowNotifyEnable=cvCallActiveDS0sLowNotifyEnable, cvCallLegRateStatsEntry=cvCallLegRateStatsEntry, cvdcVoiceCfgGroupRev2=cvdcVoiceCfgGroupRev2, cvCallActiveConnectionId=cvCallActiveConnectionId, cvVoIPCallActiveGapFillWithPrediction=cvVoIPCallActiveGapFillWithPrediction, cvVoIPPeerCfgTable=cvVoIPPeerCfgTable, cvPeerCommonCfgTargetTrunkGrpLabel=cvPeerCommonCfgTargetTrunkGrpLabel, cvCallHistoryCallingName=cvCallHistoryCallingName, cvVoIPCallActiveEntry=cvVoIPCallActiveEntry, cvCallVolConnMaxCallConnectionLicenese=cvCallVolConnMaxCallConnectionLicenese, ccVoIPCallActivePolicyName=ccVoIPCallActivePolicyName, cvSipMsgRateStatsIntvlDurUnits=cvSipMsgRateStatsIntvlDurUnits, cvVoIPPeerCfgOctetAligned=cvVoIPPeerCfgOctetAligned, cvdcVoIPCfgGroupRev2=cvdcVoIPCfgGroupRev2, cvdcGeneralCfgGroupRev2=cvdcGeneralCfgGroupRev2, cvVoIPCallHistoryCoderMode=cvVoIPCallHistoryCoderMode, cvVoIPPeerCfgIcpif=cvVoIPPeerCfgIcpif, cvVoIPPeerCfgDesiredQoS=cvVoIPPeerCfgDesiredQoS, cvVoIPPeerCfgDesiredQoSVideo=cvVoIPPeerCfgDesiredQoSVideo, cvVoIPCallActiveRemSigIPAddrT=cvVoIPCallActiveRemSigIPAddrT, cvCallLegRateStatsIntvlDurUnits=cvCallLegRateStatsIntvlDurUnits, cvCallVolConnIndex=cvCallVolConnIndex, cvCallRate=cvCallRate, cvdcMIBComplianceRev16=cvdcMIBComplianceRev16, cvSipMsgRateStatsTable=cvSipMsgRateStatsTable, cvVoicePeerCfgEntry=cvVoicePeerCfgEntry, cvCallActiveAccountCode=cvCallActiveAccountCode, cvCallDurationStatsEntry=cvCallDurationStatsEntry, cvdcMIBComplianceRev3=cvdcMIBComplianceRev3, cvVoIPCallActiveRemSigPort=cvVoIPCallActiveRemSigPort, cvdcNotificationGroupRev2=cvdcNotificationGroupRev2, cvVoIPCallHistoryOnTimeRvPlayout=cvVoIPCallHistoryOnTimeRvPlayout, cvGeneralPoorQoVNotificationEnable=cvGeneralPoorQoVNotificationEnable, cvCallRateStatsIntvlDurUnits=cvCallRateStatsIntvlDurUnits, cvCallHistoryImgPageCount=cvCallHistoryImgPageCount, cvVoIPCallActiveOnTimeRvPlayout=cvVoIPCallActiveOnTimeRvPlayout, cvVoIPCallHistoryModeChgPeriod=cvVoIPCallHistoryModeChgPeriod, cvCallRateMonitorGroup=cvCallRateMonitorGroup, cvdcGeneralCfgGroupRev4=cvdcGeneralCfgGroupRev4, cvVoIPCallHistoryLoWaterPlayoutDelay=cvVoIPCallHistoryLoWaterPlayoutDelay, cvVoIPCallHistoryOctetAligned=cvVoIPCallHistoryOctetAligned, cvVoIPCallGroupRev3=cvVoIPCallGroupRev3, cvdcActiveDS0sHighNotification=cvdcActiveDS0sHighNotification, cvVoIPCallActiveSessionProtocol=cvVoIPCallActiveSessionProtocol, cvVoIPCallHistoryFallbackDelay=cvVoIPCallHistoryFallbackDelay, cvdcMIBGroups=cvdcMIBGroups, cvVoIPCallHistoryFallbackLoss=cvVoIPCallHistoryFallbackLoss, cvVoIPCallActivePtime=cvVoIPCallActivePtime, cvVoIPPeerCfgDSCPPolicyNotificationEnable=cvVoIPPeerCfgDSCPPolicyNotificationEnable, cvdcGeneralCfgGroup=cvdcGeneralCfgGroup, cvSipMsgRateWMts=cvSipMsgRateWMts, cvVoicePeerCfgDialDigitsPrefix=cvVoicePeerCfgDialDigitsPrefix, cvVoIPCallHistoryLostPackets=cvVoIPCallHistoryLostPackets, cvVoIPCallActiveRemoteUDPPort=cvVoIPCallActiveRemoteUDPPort, cvCallActiveDS0sLowThreshold=cvCallActiveDS0sLowThreshold, cvCallGroupSup1=cvCallGroupSup1, cvCallDurationStatsIntvlDur=cvCallDurationStatsIntvlDur, cvVoIPCallHistoryBitRates=cvVoIPCallHistoryBitRates)
