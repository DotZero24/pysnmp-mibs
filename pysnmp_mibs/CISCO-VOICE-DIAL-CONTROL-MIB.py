...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-VOICE-DIAL-CONTROL-MIB
...
cvCommonDcCallHistoryCoderTypeRate, CvcGUid, CvcCallReferenceIdOrZero, CvcSpeechCoderRate, CvcCoderTypeRate, CvcInBandSignaling, CvcFaxTransmitRate = mibBuilder.importSymbols("CISCO-VOICE-COMMON-DIAL-CONTROL-MIB", "cvCommonDcCallHistoryCoderTypeRate", "CvcGUid", "CvcCallReferenceIdOrZero", "CvcSpeechCoderRate", "CvcCoderTypeRate", "CvcInBandSignaling", "CvcFaxTransmitRate")
DnisMapname, = mibBuilder.importSymbols("CISCO-VOICE-DNIS-MIB", "DnisMapname")
callActivePeerAddress, callActiveSetupTime, callActivePeerId, callActiveIndex, AbsoluteCounter32 = mibBuilder.importSymbols("DIAL-CONTROL-MIB", "callActivePeerAddress", "callActiveSetupTime", "callActivePeerId", "callActiveIndex", "AbsoluteCounter32")
...
mibBuilder.exportSymbols("CISCO-VOICE-DIAL-CONTROL-MIB", cvVoIPCallActiveRoundTripDelay=cvVoIPCallActiveRoundTripDelay, cvVoIPPeerCfgDSCPPolicyNotificationEnable=cvVoIPPeerCfgDSCPPolicyNotificationEnable, cvPeerCfgPeerType=cvPeerCfgPeerType, cvCallActiveOutSignalLevel=cvCallActiveOutSignalLevel, cvdcVoIPCfgGroupRev4=cvdcVoIPCfgGroupRev4, cvVoIPPeerCfgMediaPolicyNotificationEnable=cvVoIPPeerCfgMediaPolicyNotificationEnable, cvVoIPCallHistoryRemSigPort=cvVoIPCallHistoryRemSigPort, cvVoIPCallHistoryRemMediaIPAddrT=cvVoIPCallHistoryRemMediaIPAddrT, cvGeneralDSCPPolicyNotificationEnable=cvGeneralDSCPPolicyNotificationEnable, cvVoIPPeerCfgSessionProtocol=cvVoIPPeerCfgSessionProtocol, cvCallRateStatsIntvlDur=cvCallRateStatsIntvlDur, cvCallRateMonitorTime=cvCallRateMonitorTime, cvGatewayCallHistory=cvGatewayCallHistory, cvVoIPPeerCfgMinAcceptableQoS=cvVoIPPeerCfgMinAcceptableQoS, cvActiveCallStatsAvgVal=cvActiveCallStatsAvgVal, cvVoIPCallActiveCallId=cvVoIPCallActiveCallId, cvdcActiveDS0sHighNotification=cvdcActiveDS0sHighNotification, cvdcVoiceCfgGroupRev1=cvdcVoiceCfgGroupRev1, cvCallActiveNoiseLevel=cvCallActiveNoiseLevel, cvVoIPCallHistoryFallbackIcpif=cvVoIPCallHistoryFallbackIcpif, cvVoIPPeerCfgCRC=cvVoIPPeerCfgCRC, cvPeerCommonCfgDnisMappingName=cvPeerCommonCfgDnisMappingName, cvCallRateWMValue=cvCallRateWMValue, cvVoIPCallActiveOctetAligned=cvVoIPCallActiveOctetAligned, cvActiveCallStatsEntry=cvActiveCallStatsEntry, cvGeneralConfiguration=cvGeneralConfiguration, cvVoIPCallHistoryConnectionId=cvVoIPCallHistoryConnectionId, cvdcMIBComplianceRev17=cvdcMIBComplianceRev17, CvIlbcFrameMode=CvIlbcFrameMode, cvCallActiveAccountCode=cvCallActiveAccountCode, cvVoIPCallHistorySelectedQoS=cvVoIPCallHistorySelectedQoS, cvVoIPCallHistoryOnTimeRvPlayout=cvVoIPCallHistoryOnTimeRvPlayout, cvdcMIBComplianceRev20=cvdcMIBComplianceRev20, cvVoIPCallGroupRev1=cvVoIPCallGroupRev1, cvCallVolumeGroup=cvCallVolumeGroup, cvdcGeneralCfgGroupRev4=cvdcGeneralCfgGroupRev4, cvVoIPPeerCfgOctetAligned=cvVoIPPeerCfgOctetAligned, cvSipMsgRateStatsIntvlDur=cvSipMsgRateStatsIntvlDur, cvdcMIBConformance=cvdcMIBConformance, cvdcMIBGroups=cvdcMIBGroups, cvdcNotificationGroupRev1=cvdcNotificationGroupRev1, cvVoIPCallHistoryEncap=cvVoIPCallHistoryEncap, cvVoIPPeerCfgCodingMode=cvVoIPPeerCfgCodingMode, cvCallLegRateWMts=cvCallLegRateWMts, cvdcMIBComplianceRev10=cvdcMIBComplianceRev10, cvCallRateMonitorEnable=cvCallRateMonitorEnable, cvSipMsgRateStatsTable=cvSipMsgRateStatsTable, cvCallLegRateWMValue=cvCallLegRateWMValue, cvdcGeneralCfgGroupRev6=cvdcGeneralCfgGroupRev6, cvVoIPCallHistoryEntry=cvVoIPCallHistoryEntry, cvVoIPCallHistoryLatePackets=cvVoIPCallHistoryLatePackets, cvPeer=cvPeer, cvPeerCommonCfgSourceCarrierId=cvPeerCommonCfgSourceCarrierId, cvCallVolPeerIncomingCalls=cvCallVolPeerIncomingCalls, cvCallVolConnEntry=cvCallVolConnEntry, cvCallHistoryTable=cvCallHistoryTable, cvVoIPCallGroupRev5=cvVoIPCallGroupRev5, cvVoIPCallHistoryFallbackDelay=cvVoIPCallHistoryFallbackDelay, cvCallVolConnIndex=cvCallVolConnIndex, cvCallRateStatsEntry=cvCallRateStatsEntry, CvCallConnectionType=CvCallConnectionType, cvPeerCommonCfgHuntStop=cvPeerCommonCfgHuntStop, cvVoIPCallActiveMaxPtime=cvVoIPCallActiveMaxPtime, cvVoIPPeerCfgInBandSignaling=cvVoIPPeerCfgInBandSignaling, cvCallRateWMIndex=cvCallRateWMIndex, cvdcGeneralCfgGroupRev2=cvdcGeneralCfgGroupRev2, cvVoIPCallHistoryReceiveDelay=cvVoIPCallHistoryReceiveDelay, cvCallGroupRev3=cvCallGroupRev3, cvVoIPCallIlbcGroup=cvVoIPCallIlbcGroup, cvVoicePeerCfgCasGroup=cvVoicePeerCfgCasGroup, cvCallRateStatsTable=cvCallRateStatsTable, cvActiveCallStatsIntvlDur=cvActiveCallStatsIntvlDur, cvdcMIBComplianceRev7=cvdcMIBComplianceRev7, cvdcMIBComplianceRev4=cvdcMIBComplianceRev4, cvVoIPCallHistoryRemoteIPAddress=cvVoIPCallHistoryRemoteIPAddress, cvCallHistoryCallId=cvCallHistoryCallId, cvSipMsgRateWMts=cvSipMsgRateWMts, cvVoIPCallActiveRemSigIPAddr=cvVoIPCallActiveRemSigIPAddr, cvCallRateWMIntvlDurUnits=cvCallRateWMIntvlDurUnits, cvCallHistoryVoiceTxDuration=cvCallHistoryVoiceTxDuration, cvVoIPCallActiveEarlyPackets=cvVoIPCallActiveEarlyPackets, cvActiveCallWMIntvlDurUnits=cvActiveCallWMIntvlDurUnits, cvCallActiveSessionTarget=cvCallActiveSessionTarget, cvCallGroupRev5=cvCallGroupRev5, cvdcMIBComplianceRev16=cvdcMIBComplianceRev16, cvPeerCommonCfgApplicationName=cvPeerCommonCfgApplicationName, cvVoIPCallActiveConnectionId=cvVoIPCallActiveConnectionId, cvVoicePeerCfgDialDigitsPrefix=cvVoicePeerCfgDialDigitsPrefix, cvPeerCommonCfgTargetCarrierId=cvPeerCommonCfgTargetCarrierId, cvdcMIBComplianceRev3=cvdcMIBComplianceRev3, cvVoIPCallHistoryEarlyPackets=cvVoIPCallHistoryEarlyPackets, cvCallLegRateStatsIntvlDur=cvCallLegRateStatsIntvlDur, cvCallHistoryImgPageCount=cvCallHistoryImgPageCount, cvVoIPCallActiveEncap=cvVoIPCallActiveEncap, cvdcVoIPCfgAmrNbGroup=cvdcVoIPCfgAmrNbGroup, cvVoIPCallActiveGapFillWithRedundancy=cvVoIPCallActiveGapFillWithRedundancy, cvVoIPCallActiveProtocolCallId=cvVoIPCallActiveProtocolCallId, cvCallActiveCallId=cvCallActiveCallId, cvdcNotificationGroupRev3=cvdcNotificationGroupRev3, cvVoIPCallHistoryProtocolCallId=cvVoIPCallHistoryProtocolCallId, CvCasGroup=CvCasGroup, cvdcNotificationGroup=cvdcNotificationGroup, cvPeerCommonCfgTargetTrunkGrpLabel=cvPeerCommonCfgTargetTrunkGrpLabel, cvCallGroupSup1=cvCallGroupSup1, cvCallDurationStatsTable=cvCallDurationStatsTable, cvdcGeneralCfgGroupRev5=cvdcGeneralCfgGroupRev5, CvAmrNbRtpEncap=CvAmrNbRtpEncap, cvVoIPPeerCfgIcpif=cvVoIPPeerCfgIcpif, cvVoIPPeerCfgBitRate=cvVoIPPeerCfgBitRate, cvCallActiveDS0s=cvCallActiveDS0s, cvCallRateMonitorGroup=cvCallRateMonitorGroup, cvVoIPPeerCfgEntry=cvVoIPPeerCfgEntry, cvVoIPCallActiveSelectedQoS=cvVoIPCallActiveSelectedQoS, cvPeerCommonCfgSourceTrunkGrpLabel=cvPeerCommonCfgSourceTrunkGrpLabel, cvCallGroup=cvCallGroup, cvVoIPCallActiveRemSigIPAddrT=cvVoIPCallActiveRemSigIPAddrT, cvVoIPPeerCfgMediaSetting=cvVoIPPeerCfgMediaSetting, cvCallLegRateStatsTable=cvCallLegRateStatsTable, cvVoIPCallHistoryRemSigIPAddrT=cvVoIPCallHistoryRemSigIPAddrT, cvVoIPCallHistoryInterleaving=cvVoIPCallHistoryInterleaving, cvVoIPPeerCfgDigitRelay=cvVoIPPeerCfgDigitRelay, cvCallActiveTable=cvCallActiveTable, cvdcMIBComplianceRev13=cvdcMIBComplianceRev13, cvdcGeneralCfgGroup=cvdcGeneralCfgGroup, cvCallDurationStatsAvgVal=cvCallDurationStatsAvgVal, cvVoIPCallActiveHiWaterPlayoutDelay=cvVoIPCallActiveHiWaterPlayoutDelay, cvPeerCfgTable=cvPeerCfgTable, cvPeerCfgEntry=cvPeerCfgEntry, cvVoIPCallHistoryGapFillWithInterpolation=cvVoIPCallHistoryGapFillWithInterpolation, cvCallLegRateWMIntvlDurUnits=cvCallLegRateWMIntvlDurUnits, cvCallHistoryAccountCode=cvCallHistoryAccountCode, cvActiveCallWMValue=cvActiveCallWMValue, cvPeerCfgType=cvPeerCfgType, cvdcMIBNotificationPrefix=cvdcMIBNotificationPrefix, cvPeerCfgRowStatus=cvPeerCfgRowStatus, cvActiveCallWMTable=cvActiveCallWMTable, cvGatewayCallActive=cvGatewayCallActive, cvdcMIBComplianceRev22=cvdcMIBComplianceRev22, cvCallActiveFaxTxDuration=cvCallActiveFaxTxDuration, cvVoicePeerCfgForwardDigits=cvVoicePeerCfgForwardDigits, cvdcMIBComplianceRev14=cvdcMIBComplianceRev14, cvCallRate=cvCallRate, cvCallRateWMEntry=cvCallRateWMEntry, cvdcVoIPCfgISACGroup=cvdcVoIPCfgISACGroup, cvCallRateStatsMaxVal=cvCallRateStatsMaxVal, cvSipMsgRateWMIntvlDurUnits=cvSipMsgRateWMIntvlDurUnits, cvdcMIBComplianceRev5=cvdcMIBComplianceRev5, cvdcVoIPCfgIlbcGroup=cvdcVoIPCfgIlbcGroup, cvVoIPCallGroupRev6=cvVoIPCallGroupRev6, cvCallHistoryCallingName=cvCallHistoryCallingName, cvVoIPCallActiveBitRates=cvVoIPCallActiveBitRates, cvCallHistoryEntry=cvCallHistoryEntry, cvVoIPCallActiveSRTPEnable=cvVoIPCallActiveSRTPEnable, cvdcPoorQoVNotificationRev1=cvdcPoorQoVNotificationRev1, cvCallActiveACOMLevel=cvCallActiveACOMLevel, cvActiveCallWMts=cvActiveCallWMts, cvVoIPCallHistoryMaxPtime=cvVoIPCallHistoryMaxPtime, cvVoIPCallGroup=cvVoIPCallGroup, cvVoIPCallHistoryCallReferenceId=cvVoIPCallHistoryCallReferenceId, cvdcPoorQoVNotification=cvdcPoorQoVNotification, cvVoIPCallGroupRev3=cvVoIPCallGroupRev3, cvVoIPCallHistorySessionId=cvVoIPCallHistorySessionId, cvVoIPCallActiveCoderTypeRate=cvVoIPCallActiveCoderTypeRate, cvVoIPCallActiveSessionId=cvVoIPCallActiveSessionId, cvCallHistoryCoderTypeRate=cvCallHistoryCoderTypeRate, cvCallLegRateWMTable=cvCallLegRateWMTable, cvCallDurationStatsThreshold=cvCallDurationStatsThreshold, cvCallDurationStatsEntry=cvCallDurationStatsEntry, cvPeerCommonCfgTable=cvPeerCommonCfgTable, cvVoIPPeerCfgPoorQoVNotificationEnable=cvVoIPPeerCfgPoorQoVNotificationEnable, cvVoIPCallHistoryRemMediaPort=cvVoIPCallHistoryRemMediaPort, cvVoIPCallHistoryRoundTripDelay=cvVoIPCallHistoryRoundTripDelay, cvCallVolConnTable=cvCallVolConnTable, cvVoIPCallActiveRemoteIPAddress=cvVoIPCallActiveRemoteIPAddress, cvVoIPCallHistorySessionProtocol=cvVoIPCallHistorySessionProtocol, cvVoIPCallActiveRemoteUDPPort=cvVoIPCallActiveRemoteUDPPort, cvCallActiveDS0sHighThreshold=cvCallActiveDS0sHighThreshold, cvSipMsgRateWMValue=cvSipMsgRateWMValue, cvVoIPCallActiveRemMediaIPAddr=cvVoIPCallActiveRemMediaIPAddr, cvCallActiveDS0sLowNotifyEnable=cvCallActiveDS0sLowNotifyEnable, cvCallHistorySessionTarget=cvCallHistorySessionTarget, cvVoIPCallActiveRobustSorting=cvVoIPCallActiveRobustSorting, CvSessionProtocol=CvSessionProtocol, cvCallLegRateWMIndex=cvCallLegRateWMIndex, cvVoicePeerCfgSessionTarget=cvVoicePeerCfgSessionTarget, cvCallHistoryConnectionId=cvCallHistoryConnectionId, cvVoIPCallHistoryRemMediaIPAddr=cvVoIPCallHistoryRemMediaIPAddr, cvVoIPCallHistoryModeChgNeighbor=cvVoIPCallHistoryModeChgNeighbor, cvdcMIBNotifications=cvdcMIBNotifications, cvVoIPCallActiveGapFillWithPrediction=cvVoIPCallActiveGapFillWithPrediction, cvVoIPPeerCfgFaxRate=cvVoIPPeerCfgFaxRate, cvVoIPCallActiveModeChgNeighbor=cvVoIPCallActiveModeChgNeighbor, cvCallDurationStatsIntvlDur=cvCallDurationStatsIntvlDur, cvVoIPPeerCfgRedirectip2ip=cvVoIPPeerCfgRedirectip2ip, cvVoIPCallActiveLostPackets=cvVoIPCallActiveLostPackets, cvCallGroupRev1=cvCallGroupRev1, cvCallActiveCoderTypeRate=cvCallActiveCoderTypeRate, cvVoIPCallActiveOnTimeRvPlayout=cvVoIPCallActiveOnTimeRvPlayout, cvVoIPCallHistoryLostPackets=cvVoIPCallHistoryLostPackets, cvSipMsgRateWMIndex=cvSipMsgRateWMIndex, cvCallVolIfEntry=cvCallVolIfEntry, CvAmrNbBitRateMode=CvAmrNbBitRateMode, cvCallActiveInSignalLevel=cvCallActiveInSignalLevel, cvVoIPCallActiveCallReferenceId=cvVoIPCallActiveCallReferenceId, cvCallActiveVoiceTxDuration=cvCallActiveVoiceTxDuration, cvVoIPPeerCfgBitRates=cvVoIPPeerCfgBitRates, cvCallVolConnTotalActiveConnections=cvCallVolConnTotalActiveConnections, cvVoIPCallGroupSup2=cvVoIPCallGroupSup2, cvVoIPCallHistoryCoderMode=cvVoIPCallHistoryCoderMode, cvCallVolume=cvCallVolume, CvCallVolumeWMIntvlType=CvCallVolumeWMIntvlType, cvVoIPPeerCfgExpectFactor=cvVoIPPeerCfgExpectFactor, cvCallHistoryTxDuration=cvCallHistoryTxDuration, cvCallVolConnMaxCallConnectionLicenese=cvCallVolConnMaxCallConnectionLicenese, cvCallActiveConnectionId=cvCallActiveConnectionId, cvCallActiveCallingName=cvCallActiveCallingName, cvdcMIBComplianceRev8=cvdcMIBComplianceRev8, cvdcGeneralCfgGroupRev3=cvdcGeneralCfgGroupRev3, cvVoIPCallActiveUsername=cvVoIPCallActiveUsername, cvVoIPCallActiveLatePackets=cvVoIPCallActiveLatePackets, cvVoIPCallActiveSessionTarget=cvVoIPCallActiveSessionTarget, cvSipMsgRateStatsMaxVal=cvSipMsgRateStatsMaxVal, cvVoicePeerCfgDIDCallEnable=cvVoicePeerCfgDIDCallEnable, ccVoIPCallActivePolicyName=ccVoIPCallActivePolicyName, cvVoIPCallHistoryCallId=cvVoIPCallHistoryCallId, cvdcVoIPCfgGroupRev3=cvdcVoIPCfgGroupRev3, cvVoIPPeerCfgFrameSize=cvVoIPPeerCfgFrameSize, cvVoIPCallHistoryGapFillWithPrediction=cvVoIPCallHistoryGapFillWithPrediction, cvCallHistoryFaxTxDuration=cvCallHistoryFaxTxDuration, cvCallRateStatsIntvlDurUnits=cvCallRateStatsIntvlDurUnits, cvdcMIBComplianceRev12=cvdcMIBComplianceRev12, cvCallActiveERLLevelRev1=cvCallActiveERLLevelRev1, cvVoIPPeerCfgFaxBytes=cvVoIPPeerCfgFaxBytes, cvCallActiveCallerIDBlock=cvCallActiveCallerIDBlock, cvCallActiveEntry=cvCallActiveEntry, cvVoicePeerCfgRegisterE164=cvVoicePeerCfgRegisterE164, cvdcMIBObjects=cvdcMIBObjects, cvdcMIBComplianceRev18=cvdcMIBComplianceRev18, cvVoIPCallActiveCoderMode=cvVoIPCallActiveCoderMode, cvVoIPCallHistoryGapFillWithRedundancy=cvVoIPCallHistoryGapFillWithRedundancy, cvdcMIBComplianceRev15=cvdcMIBComplianceRev15, CvCallVolumeStatsIntvlType=CvCallVolumeStatsIntvlType, cvSipMsgRateWMTable=cvSipMsgRateWMTable, cvVoIPCallActiveRemMediaIPAddrT=cvVoIPCallActiveRemMediaIPAddrT, cvVoIPCallHistoryModeChgPeriod=cvVoIPCallHistoryModeChgPeriod, cvActiveCallStatsTable=cvActiveCallStatsTable, cvActiveCallStatsIntvlDurUnits=cvActiveCallStatsIntvlDurUnits, cvActiveCallWMIndex=cvActiveCallWMIndex, cvVoIPPeerCfgUDPChecksumEnable=cvVoIPPeerCfgUDPChecksumEnable, cvActiveCallStatsMaxVal=cvActiveCallStatsMaxVal, cvVoIPCallHistoryFallbackLoss=cvVoIPCallHistoryFallbackLoss, cvdcGeneralCfgGroupRev1=cvdcGeneralCfgGroupRev1, cvVoIPCallActivePtime=cvVoIPCallActivePtime, cvVoIPCallHistoryLoWaterPlayoutDelay=cvVoIPCallHistoryLoWaterPlayoutDelay)
mibBuilder.exportSymbols("CISCO-VOICE-DIAL-CONTROL-MIB", cvPeerCfgIfIndex=cvPeerCfgIfIndex, cvVoIPPeerCfgCoderRate=cvVoIPPeerCfgCoderRate, cvVoIPCallActiveGapFillWithInterpolation=cvVoIPCallActiveGapFillWithInterpolation, cvVoIPPeerCfgTable=cvVoIPPeerCfgTable, cvVoicePeerCfgTable=cvVoicePeerCfgTable, cvVoIPCallActiveGapFillWithSilence=cvVoIPCallActiveGapFillWithSilence, cvCallLegRateWMEntry=cvCallLegRateWMEntry, cvVoIPPeerCfgVADEnable=cvVoIPPeerCfgVADEnable, cvdcMIBComplianceRev1=cvdcMIBComplianceRev1, cvdcMIBComplianceRev19=cvdcMIBComplianceRev19, cvdcFallbackNotification=cvdcFallbackNotification, cvCallVolumeWMTableSize=cvCallVolumeWMTableSize, cvVoIPCallActiveReversedDirectionPeerAddress=cvVoIPCallActiveReversedDirectionPeerAddress, cvCallGroupRev2=cvCallGroupRev2, cvGeneralMediaPolicyNotificationEnable=cvGeneralMediaPolicyNotificationEnable, cvCallRateHiWaterMark=cvCallRateHiWaterMark, cvVoIPCallHistoryTable=cvVoIPCallHistoryTable, cvCallActiveImgPageCount=cvCallActiveImgPageCount, cvdcPolicyViolationNotification=cvdcPolicyViolationNotification, cvPeerCommonCfgEntry=cvPeerCommonCfgEntry, cvVoIPPeerCfgCoderBytes=cvVoIPPeerCfgCoderBytes, cvVoIPCallActiveRemMediaPort=cvVoIPCallActiveRemMediaPort, cvdcVoiceCfgGroupRev2=cvdcVoiceCfgGroupRev2, cvCallActiveTxDuration=cvCallActiveTxDuration, cvdcNotificationGroupRev4=cvdcNotificationGroupRev4, cvCallLegRateStatsAvgVal=cvCallLegRateStatsAvgVal, cvVoIPPeerCfgTechPrefix=cvVoIPPeerCfgTechPrefix, cvVoIPCallGroupRev4=cvVoIPCallGroupRev4, cvVoIPCallActiveSessionProtocol=cvVoIPCallActiveSessionProtocol, cvVoIPCallHistoryIcpif=cvVoIPCallHistoryIcpif, cvPeerCommonCfgMaxConnections=cvPeerCommonCfgMaxConnections, cvCallDurationStatsIntvlDurUnits=cvCallDurationStatsIntvlDurUnits, cvVoIPCallAmrNbGroup=cvVoIPCallAmrNbGroup, cvVoIPCallHistorySessionTarget=cvVoIPCallHistorySessionTarget, cvVoIPCallHistoryUsername=cvVoIPCallHistoryUsername, cvCallVolMediaOutgoingCalls=cvCallVolMediaOutgoingCalls, cvdcMIBComplianceRev11=cvdcMIBComplianceRev11, cvdcMIBCompliances=cvdcMIBCompliances, cvVoIPPeerCfgDesiredQoS=cvVoIPPeerCfgDesiredQoS, cvVoIPCallHistoryChannels=cvVoIPCallHistoryChannels, cvVoIPCallHistoryOctetAligned=cvVoIPCallHistoryOctetAligned, cvCallRateStatsAvgVal=cvCallRateStatsAvgVal, cvSipMsgRateStatsIntvlDurUnits=cvSipMsgRateStatsIntvlDurUnits, cvCallRateWMTable=cvCallRateWMTable, cvVoIPCallHistoryCRC=cvVoIPCallHistoryCRC, cvSipMsgRateStatsEntry=cvSipMsgRateStatsEntry, cvVoIPCallHistoryPtime=cvVoIPCallHistoryPtime, cvVoIPCallActiveCRC=cvVoIPCallActiveCRC, cvdcMIBComplianceRev21=cvdcMIBComplianceRev21, cvdcActiveDS0sLowNotification=cvdcActiveDS0sLowNotification, cvdcMIBComplianceRev9=cvdcMIBComplianceRev9, cvCallActiveDS0sLowThreshold=cvCallActiveDS0sLowThreshold, cvVoicePeerCfgEchoCancellerTest=cvVoicePeerCfgEchoCancellerTest, cvdcMIBComplianceRev6=cvdcMIBComplianceRev6, cvdcVoIPCfgGroupRev2=cvdcVoIPCfgGroupRev2, cvPeerCommonCfgIncomingDnisDigits=cvPeerCommonCfgIncomingDnisDigits, cvCallVolConnActiveConnection=cvCallVolConnActiveConnection, cvdcVoIPCfgGroupRev1=cvdcVoIPCfgGroupRev1, cvVoIPCallActiveModeChgPeriod=cvVoIPCallActiveModeChgPeriod, cvGeneralPoorQoVNotificationEnable=cvGeneralPoorQoVNotificationEnable, cvVoIPPeerCfgMinAcceptableQoSVideo=cvVoIPPeerCfgMinAcceptableQoSVideo, cvVoIPCallActiveTable=cvVoIPCallActiveTable, cvActiveCallWMEntry=cvActiveCallWMEntry, cvVoIPPeerCfgIPPrecedence=cvVoIPPeerCfgIPPrecedence, cvCallLegRateStatsIntvlDurUnits=cvCallLegRateStatsIntvlDurUnits, cvVoIPCallHistoryRemSigIPAddr=cvVoIPCallHistoryRemSigIPAddr, cvCallVolPeerEntry=cvCallVolPeerEntry, cvdcMIBComplianceRev2=cvdcMIBComplianceRev2, cvVoIPCallHistoryGapFillWithSilence=cvVoIPCallHistoryGapFillWithSilence, cvVoIPCallActiveRemSigPort=cvVoIPCallActiveRemSigPort, cvVoIPCallGroupSup3=cvVoIPCallGroupSup3, cvVoIPCallGroupSup1=cvVoIPCallGroupSup1, cvCallLegRateStatsEntry=cvCallLegRateStatsEntry, cvVoIPPeerCfgDesiredQoSVideo=cvVoIPPeerCfgDesiredQoSVideo, cvCallHistoryACOMLevel=cvCallHistoryACOMLevel, cvdcMIBCompliance=cvdcMIBCompliance, cvCallLegRateStatsMaxVal=cvCallLegRateStatsMaxVal, cvCallVolIfTable=cvCallVolIfTable, cvVoIPCallHistoryBitRates=cvVoIPCallHistoryBitRates, cvVoIPCallHistoryCoderTypeRate=cvVoIPCallHistoryCoderTypeRate, cvVoIPCallHistorySRTPEnable=cvVoIPCallHistorySRTPEnable, cvVoIPCallHistoryVADEnable=cvVoIPCallHistoryVADEnable, cvCallVolumeStatsHistory=cvCallVolumeStatsHistory, cvVoIPCallActiveEntry=cvVoIPCallActiveEntry, cvCallHistoryNoiseLevel=cvCallHistoryNoiseLevel, cvVoIPCallHistoryRemoteUDPPort=cvVoIPCallHistoryRemoteUDPPort, cvCallGroupRev4=cvCallGroupRev4, cvVoIPCallHistoryRobustSorting=cvVoIPCallHistoryRobustSorting, cvGeneralFallbackNotificationEnable=cvGeneralFallbackNotificationEnable, cvVoIPCallActiveChannels=cvVoIPCallActiveChannels, cvCallVolPeerTable=cvCallVolPeerTable, cvVoIPPeerCfgSessionTarget=cvVoIPPeerCfgSessionTarget, cvCallActiveEcanReflectorLocation=cvCallActiveEcanReflectorLocation, cvCallActiveERLLevel=cvCallActiveERLLevel, cvVoIPCallHistoryHiWaterPlayoutDelay=cvVoIPCallHistoryHiWaterPlayoutDelay, PYSNMP_MODULE_ID=ciscoVoiceDialControlMIB, cvSipMsgRateWMEntry=cvSipMsgRateWMEntry, cvVoIPPeerCfgCoderMode=cvVoIPPeerCfgCoderMode, cvPeerCommonCfgPreference=cvPeerCommonCfgPreference, cvVoicePeerCfgEntry=cvVoicePeerCfgEntry, cvdcCallVolumeStatsHistory=cvdcCallVolumeStatsHistory, cvCallActiveDS0sHighNotifyEnable=cvCallActiveDS0sHighNotifyEnable, cvCallRateMonitor=cvCallRateMonitor, cvPeerCfgIndex=cvPeerCfgIndex, cvVoIPCallActiveReceiveDelay=cvVoIPCallActiveReceiveDelay, cvdcNotificationGroupRev2=cvdcNotificationGroupRev2, cvCallVolMediaIncomingCalls=cvCallVolMediaIncomingCalls, cvVoIPCallActiveVADEnable=cvVoIPCallActiveVADEnable, cvCallVolPeerOutgoingCalls=cvCallVolPeerOutgoingCalls, cvCallHistoryCallerIDBlock=cvCallHistoryCallerIDBlock, cvSipMsgRateStatsAvgVal=cvSipMsgRateStatsAvgVal, cvCallDurationStatsMaxVal=cvCallDurationStatsMaxVal, cvVoIPCallActiveInterleaving=cvVoIPCallActiveInterleaving, cvVoIPCallActiveLoWaterPlayoutDelay=cvVoIPCallActiveLoWaterPlayoutDelay, cvdcVoiceCfgGroup=cvdcVoiceCfgGroup, cvdcVoIPCfgGroup=cvdcVoIPCfgGroup, ciscoVoiceDialControlMIB=ciscoVoiceDialControlMIB, cvCallRateWMts=cvCallRateWMts)
