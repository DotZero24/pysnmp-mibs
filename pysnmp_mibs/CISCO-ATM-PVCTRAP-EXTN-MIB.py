...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ATM-PVCTRAP-EXTN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:25:50 2025
...
ciscoAtmPvcTrapExtnMIBCompliance.setObjects(
      *(("CISCO-ATM-PVCTRAP-EXTN-MIB", "ciscoAtmPvcTrapExtnGroup"),
        ("CISCO-ATM-PVCTRAP-EXTN-MIB", "ciscoAtmPvcTrapExtnNotifGroup"))
)
if mibBuilder.loadTexts:
...
ciscoAtmPvcTrapExtnMIBCompliance1.setObjects(
      *(("CISCO-ATM-PVCTRAP-EXTN-MIB", "ciscoAtmPvcTrapExtnGroup"),
        ("CISCO-ATM-PVCTRAP-EXTN-MIB", "ciscoAtmPvcTrapExtnNotifGroup1"))
)
if mibBuilder.loadTexts:
...
ciscoAtmPvcTrapExtnMIBCompliance2.setObjects(
      *(("CISCO-ATM-PVCTRAP-EXTN-MIB", "ciscoAtmPvcTrapExtnGroup1"),
        ("CISCO-ATM-PVCTRAP-EXTN-MIB", "ciscoAtmPvcTrapExtnNotifGroup2"))
)
if mibBuilder.loadTexts:
