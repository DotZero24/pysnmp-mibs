...
MibIdentifier, enterprises, NotificationType, Integer32, Bits, Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, ModuleIdentity, Counter64, TimeTicks, snmpModules, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "NotificationType", "Integer32", "Bits", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "TimeTicks", "snmpModules", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-AP-MIB", PYSNMP_MODULE_ID=cnPilotMIB, cambiumRadioWlan=cambiumRadioWlan, cambiumMeshClientTotalRxPackets=cambiumMeshClientTotalRxPackets, cambiumMeshClientEntry=cambiumMeshClientEntry, cambiumClientVendorName=cambiumClientVendorName, cambiumClientRxDataBytes=cambiumClientRxDataBytes, cambiumClientName=cambiumClientName, cambiumRadioEntry=cambiumRadioEntry, cambiumWlanRxDataBytes=cambiumWlanRxDataBytes, cambiumMeshClientRadioBand=cambiumMeshClientRadioBand, cambiumMeshClientName=cambiumMeshClientName, cambiumWlanSecurity=cambiumWlanSecurity, cambiumAPUptime=cambiumAPUptime, cambiumRadioTotalTxPackets=cambiumRadioTotalTxPackets, cambiumAPCPUUtilization=cambiumAPCPUUtilization, cambiumRadioInterference=cambiumRadioInterference, cambium=cambium, cambiumMeshClientBaseMACAddress=cambiumMeshClientBaseMACAddress, cambiumRadioTable=cambiumRadioTable, cambiumClientVlan=cambiumClientVlan, cambiumClientRadioIndex=cambiumClientRadioIndex, cambiumRadioNumClients=cambiumRadioNumClients, cambiumClientSNR=cambiumClientSNR, cambiumAPTotalClients=cambiumAPTotalClients, cambiumClientEntry=cambiumClientEntry, cambiumWlanTxDataBytes=cambiumWlanTxDataBytes, cambiumRadioIndex=cambiumRadioIndex, cambiumMeshClientRSSI=cambiumMeshClientRSSI, cambiumWlanVlan=cambiumWlanVlan, cambiumClientMACAddress=cambiumClientMACAddress, cambiumAPName=cambiumAPName, cambiumClientWlan=cambiumClientWlan, cambiumClientTable=cambiumClientTable, cambiumAPMACAddress=cambiumAPMACAddress, cambiumMeshClientMACAddress=cambiumMeshClientMACAddress, cambiumClientTotalTxPackets=cambiumClientTotalTxPackets, cambiumMeshClientTable=cambiumMeshClientTable, cambiumMeshClientTotalTxPackets=cambiumMeshClientTotalTxPackets, cambiumWlanEntry=cambiumWlanEntry, cambiumRadioBandType=cambiumRadioBandType, cambiumRadioChannel=cambiumRadioChannel, cambiumAPHWType=cambiumAPHWType, cambiumStateGroup=cambiumStateGroup, cambiumRadioNoiseFloor=cambiumRadioNoiseFloor, cambiumAPIPAddress=cambiumAPIPAddress, cambiumMeshClientMACAddressIndex=cambiumMeshClientMACAddressIndex, cambiumAPCnmAccID=cambiumAPCnmAccID, cambiumMeshClientTxDataBytes=cambiumMeshClientTxDataBytes, cambiumWlanGuestAccess=cambiumWlanGuestAccess, cambiumClientSsid=cambiumClientSsid, cambiumRadioMACAddress=cambiumRadioMACAddress, cambiumAccessPointEntry=cambiumAccessPointEntry, cambiumRadioDfsStatus=cambiumRadioDfsStatus, cambiumWlanTotalTxPackets=cambiumWlanTotalTxPackets, cambiumRadioRxDataBytes=cambiumRadioRxDataBytes, cambiumRadioTotalRxPackets=cambiumRadioTotalRxPackets, cambiumMeshClientSsid=cambiumMeshClientSsid, cambiumMeshClientSNR=cambiumMeshClientSNR, cambiumRadioAirtime=cambiumRadioAirtime, cambiumAPSWVersion=cambiumAPSWVersion, cambiumRadioDfsDetect=cambiumRadioDfsDetect, cnPilotMIB=cnPilotMIB, cambiumAPRegulatory=cambiumAPRegulatory, cambiumAPReboot=cambiumAPReboot, cambiumWlanSsid=cambiumWlanSsid, cambiumClientTotalRxPackets=cambiumClientTotalRxPackets, cambiumMeshClientStatus=cambiumMeshClientStatus, cambiumAPSetIPAddress=cambiumAPSetIPAddress, cambiumClientMACAddressIndex=cambiumClientMACAddressIndex, cambiumRadioTxDataBytes=cambiumRadioTxDataBytes, cambiumClientIPAddress=cambiumClientIPAddress, cambiumWlanTotalRxPackets=cambiumWlanTotalRxPackets, cambiumMeshClientDataRate=cambiumMeshClientDataRate, cambiumAPCheckUpgradeStatus=cambiumAPCheckUpgradeStatus, cambiumAPMemoryFree=cambiumAPMemoryFree, cambiumClientHwmode=cambiumClientHwmode, cambiumAPModel=cambiumAPModel, cambiumRadioTransmitPower=cambiumRadioTransmitPower, cambiumRadioChannelWidth=cambiumRadioChannelWidth, cambiumAPCnmConstaus=cambiumAPCnmConstaus, cambiumClientTxDataBytes=cambiumClientTxDataBytes, cambiumMeshClientRxDataBytes=cambiumMeshClientRxDataBytes, cambiumWlanIndex=cambiumWlanIndex, cambiumWlanTable=cambiumWlanTable, cambiumMeshClientIPAddress=cambiumMeshClientIPAddress, cambiumAPSerialNum=cambiumAPSerialNum, cambiumWlanBand=cambiumWlanBand, cambiumRadioState=cambiumRadioState, cambiumClientTxRate=cambiumClientTxRate, cambiumAccessPointTable=cambiumAccessPointTable, cambiumWlanNumClients=cambiumWlanNumClients)
