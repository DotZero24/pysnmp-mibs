# SNMP MIB module (CAMBIUM-AP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/cambium/CAMBIUM-AP-MIB
...
cambiumAccessPointEntry.setIndexNames(
    (0, "CAMBIUM-AP-MIB", "cambiumAPMACAddress"),
)
if mibBuilder.loadTexts:
...
cambiumRadioEntry.setIndexNames(
    (0, "CAMBIUM-AP-MIB", "cambiumRadioIndex"),
)
if mibBuilder.loadTexts:
...
cambiumClientEntry.setIndexNames(
    (0, "CAMBIUM-AP-MIB", "cambiumClientMACAddressIndex"),
)
if mibBuilder.loadTexts:
...
cambiumWlanEntry.setIndexNames(
    (0, "CAMBIUM-AP-MIB", "cambiumWlanIndex"),
)
if mibBuilder.loadTexts:
...
cambiumMeshClientEntry.setIndexNames(
    (0, "CAMBIUM-AP-MIB", "cambiumMeshClientMACAddressIndex"),
)
if mibBuilder.loadTexts:
