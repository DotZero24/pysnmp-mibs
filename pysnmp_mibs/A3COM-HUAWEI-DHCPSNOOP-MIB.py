# SNMP MIB module (A3COM-HUAWEI-DHCPSNOOP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-DHCPSNOOP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:18 2025
...
h3cDhcpSnoopEnable = _H3cDhcpSnoopEnable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 36, 1, 1),
...
h3cDhcpSnoopTable = _H3cDhcpSnoopTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 36, 1, 2)
)
if mibBuilder.loadTexts:
    h3cDhcpSnoopTable.setStatus("current")
_H3cDhcpSnoopEntry_Object = MibTableRow
h3cDhcpSnoopEntry = _H3cDhcpSnoopEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 36, 1, 2, 1)
)
h3cDhcpSnoopEntry.setIndexNames(
    (0, "A3COM-HUAWEI-DHCPSNOOP-MIB", "h3cDhcpSnoopClientIpAddressType"),
    (0, "A3COM-HUAWEI-DHCPSNOOP-MIB", "h3cDhcpSnoopClientIpAddress"),
)
if mibBuilder.loadTexts:
...
_H3cDhcpSnoopClientIpAddressType_Type.__name__ = "InetAddressType"
...
h3cDhcpSnoopClientUnitNum = _H3cDhcpSnoopClientUnitNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 36, 1, 2, 1, 5),
...
h3cDhcpSnoopTrustTable = _H3cDhcpSnoopTrustTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 36, 1, 3)
)
if mibBuilder.loadTexts:
...
h3cDhcpSnoopTrustEntry = _H3cDhcpSnoopTrustEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 36, 1, 3, 1)
)
...
h3cDhcpSnoopTrustStatus = _H3cDhcpSnoopTrustStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 36, 1, 3, 1, 1),
...
h3cDhcpSnoopVlanTable = _H3cDhcpSnoopVlanTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 36, 1, 4)
)
if mibBuilder.loadTexts:
...
h3cDhcpSnoopVlanEntry.setIndexNames(
    (0, "A3COM-HUAWEI-DHCPSNOOP-MIB", "h3cDhcpSnoopVlanIndex"),
)
if mibBuilder.loadTexts:
...
h3cDhcpSnoopVlanIndex = _H3cDhcpSnoopVlanIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 36, 1, 4, 1, 1),
...
_H3cDhcpSnoopVlanEnable_Type.__name__ = "TruthValue"
...
h3cDhcpSnoopSpoofServerDetected.setObjects(
      *(("IF-MIB", "ifIndex"),
        ...
        ("A3COM-HUAWEI-DHCPSNOOP-MIB", "h3cDhcpSnoopSpoofServerMac"),
        ("A3COM-HUAWEI-DHCPSNOOP-MIB", "h3cDhcpSnoopSpoofServerIP"))
)
if mibBuilder.loadTexts:
