...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-FLASH-MAN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:20:50 2025
...
if mibBuilder.loadTexts:
    h3cFlhSize.setStatus("deprecated")
if mibBuilder.loadTexts:
...
h3cFlhHCSize = _H3cFlhHCSize_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 1, 2, 1, 16),
    _H3cFlhHCSize_Type()
)
h3cFlhHCSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cFlhHCSize.setStatus("current")
if mibBuilder.loadTexts:
    h3cFlhHCSize.setUnits("bytes")
...
if mibBuilder.loadTexts:
    h3cFlhPartSpace.setStatus("deprecated")
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    h3cFlhPartSpaceFree.setStatus("deprecated")
if mibBuilder.loadTexts:
...
h3cFlhPartBootable = _H3cFlhPartBootable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 1, 4, 1, 1, 13),
    _H3cFlhPartBootable_Type()
)
h3cFlhPartBootable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cFlhPartBootable.setStatus("current")
_H3cFlhPartPathForGlobalOpt_Type = TruthValue
_H3cFlhPartPathForGlobalOpt_Object = MibTableColumn
h3cFlhPartPathForGlobalOpt = _H3cFlhPartPathForGlobalOpt_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 1, 4, 1, 1, 14),
    _H3cFlhPartPathForGlobalOpt_Type()
)
h3cFlhPartPathForGlobalOpt.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cFlhPartPathForGlobalOpt.setStatus("current")
_H3cFlhPartHCSpace_Type = CounterBasedGauge64
_H3cFlhPartHCSpace_Object = MibTableColumn
h3cFlhPartHCSpace = _H3cFlhPartHCSpace_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 1, 4, 1, 1, 15),
    _H3cFlhPartHCSpace_Type()
)
h3cFlhPartHCSpace.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cFlhPartHCSpace.setStatus("current")
if mibBuilder.loadTexts:
    h3cFlhPartHCSpace.setUnits("bytes")
_H3cFlhPartHCSpaceFree_Type = CounterBasedGauge64
_H3cFlhPartHCSpaceFree_Object = MibTableColumn
h3cFlhPartHCSpaceFree = _H3cFlhPartHCSpaceFree_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 1, 4, 1, 1, 16),
    _H3cFlhPartHCSpaceFree_Type()
)
h3cFlhPartHCSpaceFree.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cFlhPartHCSpaceFree.setStatus("current")
if mibBuilder.loadTexts:
    h3cFlhPartHCSpaceFree.setUnits("bytes")
...
if mibBuilder.loadTexts:
    h3cFlhFileSize.setStatus("deprecated")
...
h3cFlhFileHCSize = _H3cFlhFileHCSize_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 1, 4, 2, 1, 1, 6),
    _H3cFlhFileHCSize_Type()
)
h3cFlhFileHCSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cFlhFileHCSize.setStatus("current")
if mibBuilder.loadTexts:
    h3cFlhFileHCSize.setUnits("bytes")


class _H3cFlhFileType_Type(Integer32):
    """Custom type h3cFlhFileType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cFlhFileType_Type.__name__ = "Integer32"
_H3cFlhFileType_Object = MibTableColumn
h3cFlhFileType = _H3cFlhFileType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 1, 4, 2, 1, 1, 7),
    _H3cFlhFileType_Type()
)
h3cFlhFileType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cFlhFileType.setStatus("current")
...
h3cFlhOperSrvAddrType = _H3cFlhOperSrvAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 2, 1, 1, 15),
...
h3cFlhOperSrvAddrRev = _H3cFlhOperSrvAddrRev_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 2, 1, 1, 16),
...
h3cFlhOperSrvVPNName = _H3cFlhOperSrvVPNName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 5, 1, 2, 1, 1, 17),
...
h3cFlhPartitionGroup.setObjects(
      *(("H3C-FLASH-MAN-MIB", "h3cFlhPartFirstChip"),
        ...
        ("H3C-FLASH-MAN-MIB", "h3cFlhPartBootable"),
        ("H3C-FLASH-MAN-MIB", "h3cFlhPartPathForGlobalOpt"))
)
if mibBuilder.loadTexts:
...
h3cFlhMIBCompliance.setObjects(
      *(("H3C-FLASH-MAN-MIB", "h3cFlhGroup"),
        ("H3C-FLASH-MAN-MIB", "h3cFlhPartitionGroup"),
        ("H3C-FLASH-MAN-MIB", "h3cFlhFileGroup"),
        ("H3C-FLASH-MAN-MIB", "h3cFlhOperationGroup"),
        ("H3C-FLASH-MAN-MIB", "h3cFlhNotificationGroup"),
        ("H3C-FLASH-MAN-MIB", "h3cFlhChipGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"H3cFlashOperationStatus": H3cFlashOperationStatus,
       ...
       "h3cFlhPartBootable": h3cFlhPartBootable,
       "h3cFlhPartPathForGlobalOpt": h3cFlhPartPathForGlobalOpt,
       "h3cFlhPartHCSpace": h3cFlhPartHCSpace,
       "h3cFlhPartHCSpaceFree": h3cFlhPartHCSpaceFree,
       ...
       "h3cFlhFileHCSize": h3cFlhFileHCSize,
       "h3cFlhFileType": h3cFlhFileType,
