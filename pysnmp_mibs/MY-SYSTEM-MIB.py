...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-SYSTEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:34:43 2025
...
mySystemTemperatureWarningValue = _MySystemTemperatureWarningValue_Object(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 2, 1, 1, 23, 1, 4),
    _MySystemTemperatureWarningValue_Type()
)
mySystemTemperatureWarningValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    mySystemTemperatureWarningValue.setStatus("current")
_MySystemTemperatureCritialValue_Type = Integer32
_MySystemTemperatureCritialValue_Object = MibTableColumn
mySystemTemperatureCritialValue = _MySystemTemperatureCritialValue_Object(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 2, 1, 1, 23, 1, 5),
    _MySystemTemperatureCritialValue_Type()
)
mySystemTemperatureCritialValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    mySystemTemperatureCritialValue.setStatus("current")
...
mySystemMIBCompliance.setObjects(
    ("MY-SYSTEM-MIB", "mySystemMIBGroup")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"mySystemMIB": mySystemMIB,
       ...
       "mySystemTemperatureWarningValue": mySystemTemperatureWarningValue,
       "mySystemTemperatureCritialValue": mySystemTemperatureCritialValue,
