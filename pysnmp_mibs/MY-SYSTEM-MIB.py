...
mySystemMIBObjects=_MySystemMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,1,1))
...
mySystemHwVersion=_MySystemHwVersion_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,1),_MySystemHwVersion_Type())
...
mySystemSwVersion=_MySystemSwVersion_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,2),_MySystemSwVersion_Type())
...
mySystemBootVersion=_MySystemBootVersion_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,3),_MySystemBootVersion_Type())
...
mySystemSysCtrlVersion=_MySystemSysCtrlVersion_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,4),_MySystemSysCtrlVersion_Type())
...
mySystemParametersSave=_MySystemParametersSave_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,5),_MySystemParametersSave_Type())
...
mySystemOutBandRate=_MySystemOutBandRate_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,6),_MySystemOutBandRate_Type())
...
mySystemReset=_MySystemReset_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,7),_MySystemReset_Type())
...
mySwitchLayer=_MySwitchLayer_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,8),_MySwitchLayer_Type())
...
mySystemHwPower=_MySystemHwPower_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,9),_MySystemHwPower_Type())
...
mySystemHwFan=_MySystemHwFan_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,10),_MySystemHwFan_Type())
...
mySystemOutBandTimeout=_MySystemOutBandTimeout_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,11),_MySystemOutBandTimeout_Type())
...
mySystemTelnetTimeout=_MySystemTelnetTimeout_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,12),_MySystemTelnetTimeout_Type())
...
mySystemMainFile=_MySystemMainFile_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,13),_MySystemMainFile_Type())
...
mySystemCurrentPower=_MySystemCurrentPower_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,14),_MySystemCurrentPower_Type())
...
mySystemRemainPower=_MySystemRemainPower_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,15),_MySystemRemainPower_Type())
...
mySystemTemperature=_MySystemTemperature_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,16),_MySystemTemperature_Type())
...
mySystemElectricalSourceNum=_MySystemElectricalSourceNum_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,17),_MySystemElectricalSourceNum_Type())
...
mySystemElectricalSourceIsNormalTable=_MySystemElectricalSourceIsNormalTable_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,18))
...
mySystemElectricalSourceIsNormalEntry=_MySystemElectricalSourceIsNormalEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,18,1))
...
mySystemElectricalSourceIsNormalIndex=_MySystemElectricalSourceIsNormalIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,18,1,1),_MySystemElectricalSourceIsNormalIndex_Type())
...
mySystemElectricalSourceIsNormal=_MySystemElectricalSourceIsNormal_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,18,1,2),_MySystemElectricalSourceIsNormal_Type())
...
mySystemElectricalSourceName=_MySystemElectricalSourceName_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,18,1,3),_MySystemElectricalSourceName_Type())
...
mySystemCurrentVoltage=_MySystemCurrentVoltage_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,19),_MySystemCurrentVoltage_Type())
...
mySystemFanNUM=_MySystemFanNUM_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,20),_MySystemFanNUM_Type())
...
mySystemFanIsNormalTable=_MySystemFanIsNormalTable_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,21))
if mibBuilder.loadTexts:mySystemFanIsNormalTable.setStatus(_A)
_MySystemFanIsNormalEntry_Object=MibTableRow
mySystemFanIsNormalEntry=_MySystemFanIsNormalEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,21,1))
...
mySystemFanIsNormalIndex=_MySystemFanIsNormalIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,21,1,1),_MySystemFanIsNormalIndex_Type())
...
mySystemFanIsNormal=_MySystemFanIsNormal_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,21,1,2),_MySystemFanIsNormal_Type())
...
mySystemFanName=_MySystemFanName_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,21,1,3),_MySystemFanName_Type())
...
mySystemReloadTimeRemain=_MySystemReloadTimeRemain_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,22),_MySystemReloadTimeRemain_Type())
...
mySystemTemperatureTable=_MySystemTemperatureTable_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,23))
if mibBuilder.loadTexts:mySystemTemperatureTable.setStatus(_A)
_MySystemTemperatureEntry_Object=MibTableRow
mySystemTemperatureEntry=_MySystemTemperatureEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,23,1))
...
mySystemTemperatureIndex=_MySystemTemperatureIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,23,1,1),_MySystemTemperatureIndex_Type())
...
mySystemTemperatureName=_MySystemTemperatureName_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,23,1,2),_MySystemTemperatureName_Type())
...
mySystemTemperatureCurrent=_MySystemTemperatureCurrent_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,23,1,3),_MySystemTemperatureCurrent_Type())
mySystemTemperatureCurrent.setMaxAccess(_B)
if mibBuilder.loadTexts:mySystemTemperatureCurrent.setStatus(_A)
_MySystemTemperatureWarningValue_Type=Integer32
_MySystemTemperatureWarningValue_Object=MibTableColumn
mySystemTemperatureWarningValue=_MySystemTemperatureWarningValue_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,23,1,4),_MySystemTemperatureWarningValue_Type())
mySystemTemperatureWarningValue.setMaxAccess(_E)
if mibBuilder.loadTexts:mySystemTemperatureWarningValue.setStatus(_A)
_MySystemTemperatureCritialValue_Type=Integer32
_MySystemTemperatureCritialValue_Object=MibTableColumn
mySystemTemperatureCritialValue=_MySystemTemperatureCritialValue_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,23,1,5),_MySystemTemperatureCritialValue_Type())
mySystemTemperatureCritialValue.setMaxAccess(_E)
if mibBuilder.loadTexts:mySystemTemperatureCritialValue.setStatus(_A)
_MySystemSerialno_Type=DisplayString
_MySystemSerialno_Object=MibScalar
mySystemSerialno=_MySystemSerialno_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,24),_MySystemSerialno_Type())
...
mySystemVersionTable=_MySystemVersionTable_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,25))
if mibBuilder.loadTexts:mySystemVersionTable.setStatus(_A)
_MySystemVersionEntry_Object=MibTableRow
mySystemVersionEntry=_MySystemVersionEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,25,1))
...
mySystemVersionIndex=_MySystemVersionIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,25,1,1),_MySystemVersionIndex_Type())
...
mySystemVersionName=_MySystemVersionName_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,25,1,2),_MySystemVersionName_Type())
...
mySystemVersionSwBoot=_MySystemVersionSwBoot_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,25,1,3),_MySystemVersionSwBoot_Type())
...
mySystemVersionSwCtrl=_MySystemVersionSwCtrl_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,25,1,4),_MySystemVersionSwCtrl_Type())
...
mySystemVersionSwMain=_MySystemVersionSwMain_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,25,1,5),_MySystemVersionSwMain_Type())
...
mySystemVersionHw=_MySystemVersionHw_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,25,1,6),_MySystemVersionHw_Type())
...
mySystemVersionSerialno=_MySystemVersionSerialno_Object((1,3,6,1,4,1,4881,1,1,10,2,1,1,25,1,7),_MySystemVersionSerialno_Type())
...
mySystemMIBTraps=_MySystemMIBTraps_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,1,2))
_MySystemHardChangeDesc_Type=DisplayString
_MySystemHardChangeDesc_Object=MibScalar
mySystemHardChangeDesc=_MySystemHardChangeDesc_Object((1,3,6,1,4,1,4881,1,1,10,2,1,2,1),_MySystemHardChangeDesc_Type())
...
mySystemMIBConformance=_MySystemMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,1,3))
_MySystemMIBCompliances_ObjectIdentity=ObjectIdentity
mySystemMIBCompliances=_MySystemMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,1,3,1))
_MySystemMIBGroups_ObjectIdentity=ObjectIdentity
mySystemMIBGroups=_MySystemMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,1,3,2))
mySystemMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,1,3,2,1))
