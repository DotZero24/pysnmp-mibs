# SNMP MIB module (NORTEL-ALARM-EXT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/nortel/NORTEL-ALARM-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:18:09 2025
...
nnExtAlarmMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 562, 29, 6)
)
if mibBuilder.loadTexts:
    nnExtAlarmMIB.setRevisions(
        ("2004-01-27 00:00",
         "2005-04-13 00:00",
         "2005-10-11 00:00",
         "2005-10-20 00:00",
...
class NnExtAlarmEventType(TextualConvention, Integer32):
    status = "current"
...
class NnExtAlarmProbableCause(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
_NnExtAlarmObjects_ObjectIdentity = ObjectIdentity
nnExtAlarmObjects = _NnExtAlarmObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1)
)
_NnExtNotificationPrefix_ObjectIdentity = ObjectIdentity
nnExtNotificationPrefix = _NnExtNotificationPrefix_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 0)
)
if mibBuilder.loadTexts:
    nnExtNotificationPrefix.setStatus("current")
_NnExtAlarmActiveTable_Object = MibTable
nnExtAlarmActiveTable = _NnExtAlarmActiveTable_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 1)
)
if mibBuilder.loadTexts:
    nnExtAlarmActiveTable.setStatus("current")
_NnExtAlarmActiveEntry_Object = MibTableRow
nnExtAlarmActiveEntry = _NnExtAlarmActiveEntry_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 1, 1)
)
nnExtAlarmActiveEntry.setIndexNames(
    (0, "NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveEventType"),
)
if mibBuilder.loadTexts:
    nnExtAlarmActiveEntry.setStatus("current")
_NnExtAlarmActiveEventType_Type = NnExtAlarmEventType
_NnExtAlarmActiveEventType_Object = MibTableColumn
nnExtAlarmActiveEventType = _NnExtAlarmActiveEventType_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 1, 1, 1),
    _NnExtAlarmActiveEventType_Type()
)
nnExtAlarmActiveEventType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    nnExtAlarmActiveEventType.setStatus("current")
_NnExtAlarmActiveProbableCause_Type = NnExtAlarmProbableCause
_NnExtAlarmActiveProbableCause_Object = MibTableColumn
nnExtAlarmActiveProbableCause = _NnExtAlarmActiveProbableCause_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 1, 1, 2),
    _NnExtAlarmActiveProbableCause_Type()
)
nnExtAlarmActiveProbableCause.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    nnExtAlarmActiveProbableCause.setStatus("current")
_NnExtAlarmActiveAdditionalText_Type = SnmpAdminString
_NnExtAlarmActiveAdditionalText_Object = MibTableColumn
nnExtAlarmActiveAdditionalText = _NnExtAlarmActiveAdditionalText_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 1, 1, 3),
    _NnExtAlarmActiveAdditionalText_Type()
)
nnExtAlarmActiveAdditionalText.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    nnExtAlarmActiveAdditionalText.setStatus("current")
_NnExtAlarmActiveDocumentationPointer_Type = SnmpAdminString
_NnExtAlarmActiveDocumentationPointer_Object = MibTableColumn
nnExtAlarmActiveDocumentationPointer = _NnExtAlarmActiveDocumentationPointer_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 1, 1, 4),
    _NnExtAlarmActiveDocumentationPointer_Type()
)
nnExtAlarmActiveDocumentationPointer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnExtAlarmActiveDocumentationPointer.setStatus("current")
_NnExtAlarmActiveResourceDescription_Type = SnmpAdminString
_NnExtAlarmActiveResourceDescription_Object = MibTableColumn
nnExtAlarmActiveResourceDescription = _NnExtAlarmActiveResourceDescription_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 1, 1, 5),
    _NnExtAlarmActiveResourceDescription_Type()
)
nnExtAlarmActiveResourceDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnExtAlarmActiveResourceDescription.setStatus("current")


class _NnExtAlarmActiveManualClear_Type(Integer32):
    """Custom type nnExtAlarmActiveManualClear based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_NnExtAlarmActiveManualClear_Type.__name__ = "Integer32"
_NnExtAlarmActiveManualClear_Object = MibTableColumn
nnExtAlarmActiveManualClear = _NnExtAlarmActiveManualClear_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 1, 1, 6),
    _NnExtAlarmActiveManualClear_Type()
)
nnExtAlarmActiveManualClear.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnExtAlarmActiveManualClear.setStatus("current")


class _NnExtAlarmActiveSequenceNumber_Type(Integer32):
    """Custom type nnExtAlarmActiveSequenceNumber based on Integer32"""
    defaultValue = 0


_NnExtAlarmActiveSequenceNumber_Type.__name__ = "Integer32"
_NnExtAlarmActiveSequenceNumber_Object = MibTableColumn
nnExtAlarmActiveSequenceNumber = _NnExtAlarmActiveSequenceNumber_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 1, 1, 7),
    _NnExtAlarmActiveSequenceNumber_Type()
)
nnExtAlarmActiveSequenceNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnExtAlarmActiveSequenceNumber.setStatus("current")
_NnExtAlarmMessageTable_Object = MibTable
nnExtAlarmMessageTable = _NnExtAlarmMessageTable_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 3)
)
if mibBuilder.loadTexts:
    nnExtAlarmMessageTable.setStatus("current")
_NnExtAlarmMessageEntry_Object = MibTableRow
nnExtAlarmMessageEntry = _NnExtAlarmMessageEntry_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 3, 1)
)
nnExtAlarmMessageEntry.setIndexNames(
    (0, "NOTIFICATION-LOG-MIB", "nlmLogName"),
    (0, "NOTIFICATION-LOG-MIB", "nlmLogIndex"),
)
if mibBuilder.loadTexts:
    nnExtAlarmMessageEntry.setStatus("current")
_NnExtAlarmMessageResource_Type = ResourceId
_NnExtAlarmMessageResource_Object = MibTableColumn
nnExtAlarmMessageResource = _NnExtAlarmMessageResource_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 3, 1, 1),
    _NnExtAlarmMessageResource_Type()
)
nnExtAlarmMessageResource.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnExtAlarmMessageResource.setStatus("current")
_NnExtAlarmMessageResourceDescription_Type = SnmpAdminString
_NnExtAlarmMessageResourceDescription_Object = MibTableColumn
nnExtAlarmMessageResourceDescription = _NnExtAlarmMessageResourceDescription_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 3, 1, 2),
    _NnExtAlarmMessageResourceDescription_Type()
)
nnExtAlarmMessageResourceDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnExtAlarmMessageResourceDescription.setStatus("current")
_NnExtAlarmMessageDateAndTime_Type = DateAndTime
_NnExtAlarmMessageDateAndTime_Object = MibTableColumn
nnExtAlarmMessageDateAndTime = _NnExtAlarmMessageDateAndTime_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 3, 1, 3),
    _NnExtAlarmMessageDateAndTime_Type()
)
nnExtAlarmMessageDateAndTime.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    nnExtAlarmMessageDateAndTime.setStatus("current")
_NnExtAlarmMessageDocumentationPointer_Type = SnmpAdminString
_NnExtAlarmMessageDocumentationPointer_Object = MibTableColumn
nnExtAlarmMessageDocumentationPointer = _NnExtAlarmMessageDocumentationPointer_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 3, 1, 4),
    _NnExtAlarmMessageDocumentationPointer_Type()
)
nnExtAlarmMessageDocumentationPointer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnExtAlarmMessageDocumentationPointer.setStatus("current")
_NnExtAlarmMessageInfo_Type = SnmpAdminString
_NnExtAlarmMessageInfo_Object = MibTableColumn
nnExtAlarmMessageInfo = _NnExtAlarmMessageInfo_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 3, 1, 5),
    _NnExtAlarmMessageInfo_Type()
)
nnExtAlarmMessageInfo.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnExtAlarmMessageInfo.setStatus("current")
_NnAlarmObjects_ObjectIdentity = ObjectIdentity
nnAlarmObjects = _NnAlarmObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 2)
)
_NnAlarmActiveResourceId_Type = ResourceId
_NnAlarmActiveResourceId_Object = MibScalar
nnAlarmActiveResourceId = _NnAlarmActiveResourceId_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 2, 1),
    _NnAlarmActiveResourceId_Type()
)
nnAlarmActiveResourceId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnAlarmActiveResourceId.setStatus("current")
_NnAlarmActiveDateAndTime_Type = DateAndTime
_NnAlarmActiveDateAndTime_Object = MibScalar
nnAlarmActiveDateAndTime = _NnAlarmActiveDateAndTime_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 2, 2),
    _NnAlarmActiveDateAndTime_Type()
)
nnAlarmActiveDateAndTime.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    nnAlarmActiveDateAndTime.setStatus("current")
_NnAlarmActiveDescription_Type = SnmpAdminString
_NnAlarmActiveDescription_Object = MibScalar
nnAlarmActiveDescription = _NnAlarmActiveDescription_Object(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 2, 3),
    _NnAlarmActiveDescription_Type()
)
nnAlarmActiveDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnAlarmActiveDescription.setStatus("current")
...
nnExtAlarmClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 0, 301)
)
nnExtAlarmClear.setObjects(
      *(("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveResourceId"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDateAndTime"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDescription"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveEventType"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveProbableCause"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveAdditionalText"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveDocumentationPointer"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveResourceDescription"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveSequenceNumber"))
)
if mibBuilder.loadTexts:
    nnExtAlarmClear.setStatus(
        "current"
    )

nnExtAlarmWarning = NotificationType(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 0, 302)
)
nnExtAlarmWarning.setObjects(
      *(("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveResourceId"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDateAndTime"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDescription"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveEventType"),
        ...
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveDocumentationPointer"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveResourceDescription"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveManualClear"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveSequenceNumber"))
)
if mibBuilder.loadTexts:
    nnExtAlarmWarning.setStatus(
        "current"
    )

nnExtAlarmMinor = NotificationType(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 0, 303)
)
nnExtAlarmMinor.setObjects(
      *(("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveResourceId"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDateAndTime"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDescription"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveEventType"),
...
if mibBuilder.loadTexts:
    nnExtAlarmMinor.setStatus(
        "current"
    )

nnExtAlarmMajor = NotificationType(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 0, 304)
)
nnExtAlarmMajor.setObjects(
      *(("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveResourceId"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDateAndTime"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDescription"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveEventType"),
...
if mibBuilder.loadTexts:
    nnExtAlarmMajor.setStatus(
        "current"
    )

nnExtAlarmCritical = NotificationType(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 0, 305)
)
nnExtAlarmCritical.setObjects(
      *(("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveResourceId"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDateAndTime"),
        ("NORTEL-ALARM-EXT-MIB", "nnAlarmActiveDescription"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmActiveEventType"),
...
if mibBuilder.loadTexts:
    nnExtAlarmCritical.setStatus(
        "current"
    )

nnExtAlarmMessage = NotificationType(
    (1, 3, 6, 1, 4, 1, 562, 29, 6, 1, 0, 306)
)
nnExtAlarmMessage.setObjects(
      *(("NORTEL-ALARM-EXT-MIB", "nnExtAlarmMessageResource"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmMessageResourceDescription"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmMessageDateAndTime"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmMessageDocumentationPointer"),
        ("NORTEL-ALARM-EXT-MIB", "nnExtAlarmMessageInfo"))
)
if mibBuilder.loadTexts:
    nnExtAlarmMessage.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"NnExtAlarmEventType": NnExtAlarmEventType,
       "NnExtAlarmProbableCause": NnExtAlarmProbableCause,
       "nnExtAlarmMIB": nnExtAlarmMIB,
       "nnExtAlarmObjects": nnExtAlarmObjects,
       "nnExtNotificationPrefix": nnExtNotificationPrefix,
       "nnExtAlarmClear": nnExtAlarmClear,
       "nnExtAlarmWarning": nnExtAlarmWarning,
       "nnExtAlarmMinor": nnExtAlarmMinor,
       "nnExtAlarmMajor": nnExtAlarmMajor,
       "nnExtAlarmCritical": nnExtAlarmCritical,
       "nnExtAlarmMessage": nnExtAlarmMessage,
       "nnExtAlarmActiveTable": nnExtAlarmActiveTable,
       "nnExtAlarmActiveEntry": nnExtAlarmActiveEntry,
       "nnExtAlarmActiveEventType": nnExtAlarmActiveEventType,
       "nnExtAlarmActiveProbableCause": nnExtAlarmActiveProbableCause,
       "nnExtAlarmActiveAdditionalText": nnExtAlarmActiveAdditionalText,
       "nnExtAlarmActiveDocumentationPointer": nnExtAlarmActiveDocumentationPointer,
       "nnExtAlarmActiveResourceDescription": nnExtAlarmActiveResourceDescription,
       "nnExtAlarmActiveManualClear": nnExtAlarmActiveManualClear,
       "nnExtAlarmActiveSequenceNumber": nnExtAlarmActiveSequenceNumber,
       "nnExtAlarmMessageTable": nnExtAlarmMessageTable,
       "nnExtAlarmMessageEntry": nnExtAlarmMessageEntry,
       "nnExtAlarmMessageResource": nnExtAlarmMessageResource,
       "nnExtAlarmMessageResourceDescription": nnExtAlarmMessageResourceDescription,
       "nnExtAlarmMessageDateAndTime": nnExtAlarmMessageDateAndTime,
       "nnExtAlarmMessageDocumentationPointer": nnExtAlarmMessageDocumentationPointer,
       "nnExtAlarmMessageInfo": nnExtAlarmMessageInfo,
       "nnAlarmObjects": nnAlarmObjects,
       "nnAlarmActiveResourceId": nnAlarmActiveResourceId,
       "nnAlarmActiveDateAndTime": nnAlarmActiveDateAndTime,
       "nnAlarmActiveDescription": nnAlarmActiveDescription}
)
