...
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartAge=ospfRestartAge, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartSupport=ospfRestartSupport, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExternalType1=ospfExternalType1, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfAuthKey=ospfIfAuthKey, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbType=ospfLsdbType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfMulticastForwarding=ospfIfMulticastForwarding, Metric=Metric, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfObsoleteGroup=ospfObsoleteGroup, ospfRouterId=ospfRouterId, ospfNbrState=ospfNbrState, ospfHostGroup2=ospfHostGroup2, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, RouterID=RouterID, PYSNMP_MODULE_ID=ospf, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricValue=ospfIfMetricValue, ospfNbrEntry=ospfNbrEntry, ospfRestartStatus=ospfRestartStatus, ospfStubMetric=ospfStubMetric, ospfNbrTable=ospfNbrTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfImportAsExtern=ospfImportAsExtern, ospfGroups=ospfGroups, ospfStubMetricType=ospfStubMetricType, ospfLsdbGroup=ospfLsdbGroup, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfState=ospfVirtIfState, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbType=ospfLocalLsdbType, BigMetric=BigMetric, ospfIfTransitDelay=ospfIfTransitDelay, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbSequence=ospfLocalLsdbSequence, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostIpAddress=ospfHostIpAddress, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfIpAddress=ospfIfIpAddress, ospfAreaId=ospfAreaId, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAuthType=ospfAuthType, ospfAreaStatus=ospfAreaStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfGroup2=ospfIfGroup2, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, TOSType=TOSType, ospfConformance=ospfConformance, ospfCompliances=ospfCompliances, ospfDemandExtensions=ospfDemandExtensions, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfLsaCount=ospfIfLsaCount, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfStubAreaId=ospfStubAreaId, ospfStubAreaTable=ospfStubAreaTable, ospfRouteGroup=ospfRouteGroup, ospfAdminStat=ospfAdminStat, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaSummary=ospfAreaSummary, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRestartInterval=ospfRestartInterval, ospfHostEntry=ospfHostEntry, ospfIfStatus=ospfIfStatus, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbSequence=ospfLsdbSequence, ospfLsdbEntry=ospfLsdbEntry, ospfAreaGroup=ospfAreaGroup, ospfIfEntry=ospfIfEntry, ospfAreaTable=ospfAreaTable, ospfLsdbLsid=ospfLsdbLsid, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfState=ospfIfState, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, HelloRange=HelloRange, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfHostTOS=ospfHostTOS, ospfHostMetric=ospfHostMetric, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubTOS=ospfStubTOS, ospfHostAreaID=ospfHostAreaID, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbTable=ospfLsdbTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfCompliance=ospfCompliance, ospfIfMetricStatus=ospfIfMetricStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAsLsdbAge=ospfAsLsdbAge, AreaID=AreaID, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfGroup=ospfIfGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfAreaId=ospfIfAreaId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfNbrGroup=ospfNbrGroup, ospfIfRtrPriority=ospfIfRtrPriority, UpToMaxAge=UpToMaxAge, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfAuthType=ospfIfAuthType, ospfIntraArea=ospfIntraArea, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfHostGroup=ospfHostGroup, ospf=ospf, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfCompliance2=ospfCompliance2, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfBasicGroup2=ospfBasicGroup2, ospfGeneralGroup=ospfGeneralGroup, ospfAddressLessIf=ospfAddressLessIf, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaGroup2=ospfAreaGroup2, ospfIfDemand=ospfIfDemand, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaEntry=ospfAreaEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfTable=ospfIfTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, Status=Status, ospfIfEvents=ospfIfEvents, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfAdminStat=ospfIfAdminStat, ospfLsdbAge=ospfLsdbAge, ospfIfMetricTOS=ospfIfMetricTOS, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfTable=ospfVirtIfTable, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfBasicGroup=ospfBasicGroup, ospfNbrEvents=ospfNbrEvents, ospfAsLsaCount=ospfAsLsaCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfHostStatus=ospfHostStatus, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrGroup2=ospfNbrGroup2, ospfIfType=ospfIfType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, PositiveInteger=PositiveInteger, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge)
