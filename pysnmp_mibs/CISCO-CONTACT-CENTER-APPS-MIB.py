...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:27:23 2025
...
mibBuilder.exportSymbols("CISCO-CONTACT-CENTER-APPS-MIB", cccaPgAgentsReady=cccaPgAgentsReady, cccaEventTimestamp=cccaEventTimestamp, cccaRouterDBWorkerEnabled=cccaRouterDBWorkerEnabled, cccaCtiOsActiveMonitors=cccaCtiOsActiveMonitors, cccaPgID=cccaPgID, cccaPimTable=cccaPimTable, cccaCtiOsCgSideBName=cccaCtiOsCgSideBName, cccaDistAwLoggerSideBName=cccaDistAwLoggerSideBName, cccaCtiOsServerName=cccaCtiOsServerName, cccaDialerQueueDepth=cccaDialerQueueDepth, cccaEventSeverity=cccaEventSeverity, CcaComponentSide=CcaComponentSide, cccaRouterCallsInProgress=cccaRouterCallsInProgress, cccaLoggerRouterSideAName=cccaLoggerRouterSideAName, cccaEventState=cccaEventState, cccaEventOriginatingProcessName=cccaEventOriginatingProcessName, cccaPgPimCount=cccaPgPimCount, cccaGeneralInfoGroup=cccaGeneralInfoGroup, cccaCgTableGroupSup1=cccaCgTableGroupSup1, ciscoCcaMIBObjects=ciscoCcaMIBObjects, cccaLoggerType=cccaLoggerType, cccaDialerIdlePorts=cccaDialerIdlePorts, cccaDialerCtiServerStatus=cccaDialerCtiServerStatus, cccaComponents=cccaComponents, cccaRouterEntry=cccaRouterEntry, cccaGeneralInfoGroupSup1=cccaGeneralInfoGroupSup1, cccaTimeZoneOffsetHours=cccaTimeZoneOffsetHours, cccaTimeZoneName=cccaTimeZoneName, cccaDescription=cccaDescription, cccaCgSide=cccaCgSide, cccaCgID=cccaCgID, cccaInstanceTableGroup=cccaInstanceTableGroup, cccaPimPeripheralType=cccaPimPeripheralType, cccaRouterAppGwEnabled=cccaRouterAppGwEnabled, cccaPgRouterSideAName=cccaPgRouterSideAName, cccaCtiOsTableGroupSup1=cccaCtiOsTableGroupSup1, cccaDialerBusyCustomerPorts=cccaDialerBusyCustomerPorts, cccaPgAgentsLoggedOn=cccaPgAgentsLoggedOn, cccaDialerAvgQueueTime=cccaDialerAvgQueueTime, cccaNicIndex=cccaNicIndex, cccaComponentTableGroup=cccaComponentTableGroup, cccaNicTableGroup=cccaNicTableGroup, cccaPgCallsInProgress=cccaPgCallsInProgress, ciscoCcaMIB=ciscoCcaMIB, cccaPgSide=cccaPgSide, cccaLoggerRouterSideBName=cccaLoggerRouterSideBName, cccaRouterSide=cccaRouterSide, cccaRouterTable=cccaRouterTable, cccaEventComponentId=cccaEventComponentId, ciscoCccaMIBComplianceRev2=ciscoCccaMIBComplianceRev2, cccaCtiOsCallsFailed=cccaCtiOsCallsFailed, cccaComponentInfo=cccaComponentInfo, cccaNotificationsEnabled=cccaNotificationsEnabled, cccaDialerTable=cccaDialerTable, cccaDistAwTableGroup=cccaDistAwTableGroup, cccaComponentElmtStatus=cccaComponentElmtStatus, cccaDialerEntry=cccaDialerEntry, cccaEventDmpId=cccaEventDmpId, cccaDistAwAdminSiteName=cccaDistAwAdminSiteName, cccaEventOriginatingSide=cccaEventOriginatingSide, cccaDialerTableGroup=cccaDialerTableGroup, cccaEventText=cccaEventText, cccaDistAwSide=cccaDistAwSide, cccaCampaignMgrDbUtilization=cccaCampaignMgrDbUtilization, cccaCgPgSideAName=cccaCgPgSideAName, cccaCgNumber=cccaCgNumber, cccaRouterPublicNonHighAddr=cccaRouterPublicNonHighAddr, cccaCgDuplexPairName=cccaCgDuplexPairName, cccaDialerBusyReservationPorts=cccaDialerBusyReservationPorts, cccaCampaignMgrTableGroup=cccaCampaignMgrTableGroup, cccaLoggerTableGroup=cccaLoggerTableGroup, PYSNMP_MODULE_ID=ciscoCcaMIB, cccaCgOpenSessions=cccaCgOpenSessions, cccaRouterPGsEnabledCount=cccaRouterPGsEnabledCount, cccaCampaignMgrAvgQueueTime=cccaCampaignMgrAvgQueueTime, cccaDialerCampaignMgrStatus=cccaDialerCampaignMgrStatus, cccaGeneralInfo=cccaGeneralInfo, ciscoCcaMIBCompliances=ciscoCcaMIBCompliances, cccaInstanceName=cccaInstanceName, CcaPeripheralType=CcaPeripheralType, cccaSupportToolsURL=cccaSupportToolsURL, cccaDialerCallAttemptsPerSec=cccaDialerCallAttemptsPerSec, CcaIndex=CcaIndex, cccaLoggerSide=cccaLoggerSide, cccaDialerCtiServerAName=cccaDialerCtiServerAName, cccaRouterAgentsLoggedOn=cccaRouterAgentsLoggedOn, cccaRouterTableGroup=cccaRouterTableGroup, cccaRouterPrivateNonHighAddr=cccaRouterPrivateNonHighAddr, cccaLoggerEntry=cccaLoggerEntry, cccaPgRouterSideBName=cccaPgRouterSideBName, cccaLoggerHDSReplication=cccaLoggerHDSReplication, cccaPimEntry=cccaPimEntry, cccaDistAwRouterSideBName=cccaDistAwRouterSideBName, cccaComponentName=cccaComponentName, cccaNotificationInfo=cccaNotificationInfo, cccaCtiOsCallsInProgress=cccaCtiOsCallsInProgress, cccaCtiOsPeerName=cccaCtiOsPeerName, cccaCampaignMgrQueueDepth=cccaCampaignMgrQueueDepth, cccaDialerConfiguredPorts=cccaDialerConfiguredPorts, cccaComponentEntry=cccaComponentEntry, cccaCgEntry=cccaCgEntry, cccaComponentElmtName=cccaComponentElmtName, cccaComponentElmtRunID=cccaComponentElmtRunID, cccaPgDuplexPairName=cccaPgDuplexPairName, cccaPgTable=cccaPgTable, cccaPimNumber=cccaPimNumber, cccaInstanceEntry=cccaInstanceEntry, cccaPimStatus=cccaPimStatus, cccaEventMessageId=cccaEventMessageId, cccaComponentElmtEntry=cccaComponentElmtEntry, cccaDistAwDuplexPairName=cccaDistAwDuplexPairName, cccaDistAwLoggerSideAName=cccaDistAwLoggerSideAName, cccaCtiOsPeripheralType=cccaCtiOsPeripheralType, cccaDialerBlockedPorts=cccaDialerBlockedPorts, cccaIcmNotificationInfoGroup=cccaIcmNotificationInfoGroup, cccaNicTable=cccaNicTable, cccaRouterPublicHighAddr=cccaRouterPublicHighAddr, cccaPgAgentsTalking=cccaPgAgentsTalking, cccaCgOtherSessions=cccaCgOtherSessions, cccaDistAwHDSEnabled=cccaDistAwHDSEnabled, cccaRouterNicCount=cccaRouterNicCount, cccaEventOriginatingNodeType=cccaEventOriginatingNodeType, cccaRouterTableGroupSup1=cccaRouterTableGroupSup1, cccaCtiOsTable=cccaCtiOsTable, cccaDistAwWebReskillingURL=cccaDistAwWebReskillingURL, cccaDistAwRouterSideAName=cccaDistAwRouterSideAName, ciscoCcaMIBGroups=ciscoCcaMIBGroups, cccaDialerTalkingAgents=cccaDialerTalkingAgents, cccaLoggerAvgDBWriteTime=cccaLoggerAvgDBWriteTime, ciscoCcaMIBNotifs=ciscoCcaMIBNotifs, cccaTimeZoneOffsetMinutes=cccaTimeZoneOffsetMinutes, ciscoCcaMIBConform=ciscoCcaMIBConform, cccaRouterDuplexPairName=cccaRouterDuplexPairName, cccaRouterPrivateHighAddr=cccaRouterPrivateHighAddr, cccaCtiOsPeripheralName=cccaCtiOsPeripheralName, cccaPimTableGroup=cccaPimTableGroup, cccaDialerCampaignMgrName=cccaDialerCampaignMgrName, cccaPgEntry=cccaPgEntry, cccaComponentElmtTable=cccaComponentElmtTable, cccaInstanceTable=cccaInstanceTable, CcaComponentStatus=CcaComponentStatus, cccaComponentElmtIndex=cccaComponentElmtIndex, CcaComponentType=CcaComponentType, cccaName=cccaName, cccaComponentStatus=cccaComponentStatus, cccaDistAwWebViewServerName=cccaDistAwWebViewServerName, cccaCtiOsEntry=cccaCtiOsEntry, cccaInstanceNumber=cccaInstanceNumber, cccaCtiOsTableGroup=cccaCtiOsTableGroup, cccaPgTableGroup=cccaPgTableGroup, cccaLoggerDuplexPairName=cccaLoggerDuplexPairName, cccaWebSetupURL=cccaWebSetupURL, cccaRouterCallsInQueue=cccaRouterCallsInQueue, cccaVersion=cccaVersion, cccaCtiOsActiveClients=cccaCtiOsActiveClients, cccaCtiOsCgSideAName=cccaCtiOsCgSideAName, cccaComponentType=cccaComponentType, cccaIcmEventsGroup=cccaIcmEventsGroup, cccaEventOriginatingNode=cccaEventOriginatingNode, cccaCampaignMgrTable=cccaCampaignMgrTable, cccaComponentTable=cccaComponentTable, cccaNicStatus=cccaNicStatus, cccaLoggerTableGroupSup1=cccaLoggerTableGroupSup1, cccaNicEntry=cccaNicEntry, cccaComponentIndex=cccaComponentIndex, cccaDistAwType=cccaDistAwType, cccaPgNumber=cccaPgNumber, cccaComponentElmtTableGroup=cccaComponentElmtTableGroup, cccaCgTableGroup=cccaCgTableGroup, cccaRouterCallsPerSec=cccaRouterCallsPerSec, cccaCampaignMgrEntry=cccaCampaignMgrEntry, cccaIcmEvent=cccaIcmEvent, cccaDistAwWebViewEnabled=cccaDistAwWebViewEnabled, cccaLoggerTable=cccaLoggerTable, cccaPimPeripheralHostName=cccaPimPeripheralHostName, cccaDistAwEntry=cccaDistAwEntry, cccaCgPgSideBName=cccaCgPgSideBName, cccaDistAwTableGroupSup1=cccaDistAwTableGroupSup1, cccaDistAwTable=cccaDistAwTable, cccaNicType=cccaNicType, cccaPimPeripheralName=cccaPimPeripheralName, cccaCgTable=cccaCgTable, cccaDialerCtiServerBName=cccaDialerCtiServerBName, cccaDialerMediaRouterStatus=cccaDialerMediaRouterStatus, cccaCampaignMgrActiveDialers=cccaCampaignMgrActiveDialers, ciscoCccaMIBComplianceRev1=ciscoCccaMIBComplianceRev1, cccaPgTableGroupSup1=cccaPgTableGroupSup1)
