# SNMP MIB module (QLASP-Statistics-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/QLASP-Statistics-MIB
...
btsTeamIndex = _BtsTeamIndex_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 1),
    _BtsTeamIndex_Type()
)
...
btsTeamName = _BtsTeamName_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 2),
    _BtsTeamName_Type()
)
...
btsPhyNumber = _BtsPhyNumber_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 3),
    _BtsPhyNumber_Type()
)
...
btsVirNumber = _BtsVirNumber_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 4),
    _BtsVirNumber_Type()
)
...
btsPacketSends = _BtsPacketSends_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 5),
...
btsPacketSendDiscardeds = _BtsPacketSendDiscardeds_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 6),
...
btsPacketSendQueueds = _BtsPacketSendQueueds_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 7),
...
btsPacketRecvs = _BtsPacketRecvs_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 8),
...
btsPacketRecvDiscardeds = _BtsPacketRecvDiscardeds_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 9),
...
btsLinkPacketsSents = _BtsLinkPacketsSents_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 10),
...
btsLinkPacketsRetrieds = _BtsLinkPacketsRetrieds_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 1, 2, 1, 11),
...
btsPhyAdapterStatEntry = _BtsPhyAdapterStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1)
)
btsPhyAdapterStatEntry.setIndexNames(
    (0, "QLASP-Statistics-MIB", "btspTeamIndex"),
    (0, "QLASP-Statistics-MIB", "btspAdapterIndex"),
)
if mibBuilder.loadTexts:
...
btspTeamIndex = _BtspTeamIndex_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1, 1),
    _BtspTeamIndex_Type()
)
...
btspAdapterIndex = _BtspAdapterIndex_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1, 2),
...
btspAdapterDesc = _BtspAdapterDesc_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1, 3),
...
btspPacketSends = _BtspPacketSends_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1, 4),
...
btspPacketSendDiscardeds = _BtspPacketSendDiscardeds_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1, 5),
...
btspPacketRecvs = _BtspPacketRecvs_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1, 6),
...
btspPacketRecvDiscardeds = _BtspPacketRecvDiscardeds_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1, 7),
...
btspLinkPacketsSents = _BtspLinkPacketsSents_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1, 8),
...
btspLinkPacketsRetrieds = _BtspLinkPacketsRetrieds_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 2, 2, 1, 9),
...
btsVirAdapterStatEntry = _BtsVirAdapterStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 3, 2, 1)
)
btsVirAdapterStatEntry.setIndexNames(
    (0, "QLASP-Statistics-MIB", "btsvTeamIndex"),
    (0, "QLASP-Statistics-MIB", "btsvAdapterIndex"),
)
if mibBuilder.loadTexts:
...
btsvTeamIndex = _BtsvTeamIndex_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 3, 2, 1, 1),
    _BtsvTeamIndex_Type()
)
...
btsvAdapterIndex = _BtsvAdapterIndex_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 3, 2, 1, 2),
...
btsvAdapterDesc = _BtsvAdapterDesc_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 3, 2, 1, 3),
...
btsvPacketSends = _BtsvPacketSends_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 3, 2, 1, 4),
...
btsvPacketSendQueueds = _BtsvPacketSendQueueds_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 3, 2, 1, 5),
...
btsvPacketRecvs = _BtsvPacketRecvs_Object(
    (1, 3, 6, 1, 4, 1, 3873, 1, 2, 2, 3, 2, 1, 6),
...
mibBuilder.exportSymbols(
    ...
    **{"qlogic": qlogic,
       ...
       "qlaspPhyAdapterStat": qlaspPhyAdapterStat,
       ...
       "qlaspVirAdapterStat": qlaspVirAdapterStat,
