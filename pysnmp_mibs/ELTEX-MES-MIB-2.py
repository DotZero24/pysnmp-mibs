...
mibBuilder.exportSymbols("ELTEX-MES-MIB-2", elt_mes_mib_2=elt_mes_mib_2, eltMesSystem=eltMesSystem, PYSNMP_MODULE_ID=elt_mes_mib_2, eltMesIfMIB=eltMesIfMIB, eltSysDescr=eltSysDescr)
