...
mibBuilder.exportSymbols("CTRMONXT-MIB", ctDiscoveryControlEntry=ctDiscoveryControlEntry, ctProtIP=ctProtIP, ctDiscoveryControlProtocol=ctDiscoveryControlProtocol, ctProtDecNet=ctProtDecNet, ctDiscoveryControlIndex=ctDiscoveryControlIndex, ctDiscoveryNMPort=ctDiscoveryNMPort, ctDiscoveryMNNetworkAddress=ctDiscoveryMNNetworkAddress, ctDiscoveryControlTableSize=ctDiscoveryControlTableSize, ctDiscoveryMNTable=ctDiscoveryMNTable, ctDiscoveryNMCreationTime=ctDiscoveryNMCreationTime, ctDiscoveryControlOwner=ctDiscoveryControlOwner, ctDiscoveryControlLastDeleteTime=ctDiscoveryControlLastDeleteTime, ctDiscoveryNMEntry=ctDiscoveryNMEntry, ctDiscoveryNMIndex=ctDiscoveryNMIndex, ctDiscoveryProtocol=ctDiscoveryProtocol, ctDiscoveryMNMACAddress=ctDiscoveryMNMACAddress, ctDiscovery=ctDiscovery, ctProtNetware=ctProtNetware, ctDiscoveryMNEntry=ctDiscoveryMNEntry, ctDiscoveryMNCreationTime=ctDiscoveryMNCreationTime, ctDiscoveryMNIndex=ctDiscoveryMNIndex, ctDiscoveryNMBoard=ctDiscoveryNMBoard, ctDiscoveryControlAgeInterval=ctDiscoveryControlAgeInterval, ctDiscoveryControlTable=ctDiscoveryControlTable, ctDiscoveryNMMACAddress=ctDiscoveryNMMACAddress, ctDiscoveryMNPort=ctDiscoveryMNPort, ctDiscoveryNMNetworkAddress=ctDiscoveryNMNetworkAddress, ctDiscoveryControlStatus=ctDiscoveryControlStatus, ctDiscoveryMNLastTransmitTime=ctDiscoveryMNLastTransmitTime, ctDiscoveryControlDataSource=ctDiscoveryControlDataSource, ctDiscoveryNMLastTransmitTime=ctDiscoveryNMLastTransmitTime, ctDiscoveryNMTable=ctDiscoveryNMTable, ctDiscoveryMNBoard=ctDiscoveryMNBoard)
