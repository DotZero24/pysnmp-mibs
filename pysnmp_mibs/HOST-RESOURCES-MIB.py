...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrNetworkIfIndex=hrNetworkIfIndex, hrPrinterStatus=hrPrinterStatus, hrDeviceID=hrDeviceID, hrSWRunPerfTable=hrSWRunPerfTable, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWInstalledGroup=hrSWInstalledGroup, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrProcessorFrwID=hrProcessorFrwID, hrDeviceTypes=hrDeviceTypes, hrSWRunEntry=hrSWRunEntry, hrPartitionID=hrPartitionID, hrStorageDescr=hrStorageDescr, hrProcessorTable=hrProcessorTable, hrSWInstalledID=hrSWInstalledID, hrSWRunGroup=hrSWRunGroup, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceDescr=hrDeviceDescr, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWInstalledName=hrSWInstalledName, hrStorageTypes=hrStorageTypes, hrDiskStorageEntry=hrDiskStorageEntry, hrDiskStorageAccess=hrDiskStorageAccess, hrDeviceGroup=hrDeviceGroup, hrPrinterTable=hrPrinterTable, hrFSEntry=hrFSEntry, hrSWOSIndex=hrSWOSIndex, hrDevice=hrDevice, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWInstalledEntry=hrSWInstalledEntry, hrSystem=hrSystem, hrStorageAllocationFailures=hrStorageAllocationFailures, ProductID=ProductID, hrSWInstalledTable=hrSWInstalledTable, hrSWRunPerf=hrSWRunPerf, hrSWRun=hrSWRun, hrFSType=hrFSType, hrProcessorLoad=hrProcessorLoad, hrDeviceErrors=hrDeviceErrors, hrSWRunParameters=hrSWRunParameters, hrSWInstalled=hrSWInstalled, hrSWInstalledDate=hrSWInstalledDate, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrNetworkEntry=hrNetworkEntry, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWInstalledType=hrSWInstalledType, hrDeviceTable=hrDeviceTable, hrFSTable=hrFSTable, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSWRunPath=hrSWRunPath, hrSystemNumUsers=hrSystemNumUsers, hrDeviceType=hrDeviceType, hrStorageUsed=hrStorageUsed, hrFSIndex=hrFSIndex, hrStorageTable=hrStorageTable, hrDeviceEntry=hrDeviceEntry, hrSWRunType=hrSWRunType, PYSNMP_MODULE_ID=hostResourcesMibModule, hrPartitionEntry=hrPartitionEntry, host=host, hrStorage=hrStorage, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hostResourcesMibModule=hostResourcesMibModule, hrFSTypes=hrFSTypes, hrStorageSize=hrStorageSize, hrPrinterEntry=hrPrinterEntry, hrSystemProcesses=hrSystemProcesses, hrSWRunID=hrSWRunID, hrSWRunPerfGroup=hrSWRunPerfGroup, hrPartitionLabel=hrPartitionLabel, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrStorageType=hrStorageType, hrMIBGroups=hrMIBGroups, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrDiskStorageCapacity=hrDiskStorageCapacity, hrPartitionSize=hrPartitionSize, hrSWRunTable=hrSWRunTable, hrSystemUptime=hrSystemUptime, hrNetworkTable=hrNetworkTable, hrMemorySize=hrMemorySize, hrSystemDate=hrSystemDate, hrDiskStorageTable=hrDiskStorageTable, InternationalDisplayString=InternationalDisplayString, hrDeviceIndex=hrDeviceIndex, hrStorageGroup=hrStorageGroup, hrFSStorageIndex=hrFSStorageIndex, hrStorageIndex=hrStorageIndex, hrDiskStorageMedia=hrDiskStorageMedia, hrPartitionIndex=hrPartitionIndex, hrFSMountPoint=hrFSMountPoint, hrStorageEntry=hrStorageEntry, hrSystemGroup=hrSystemGroup, hrDeviceStatus=hrDeviceStatus, hrSWRunIndex=hrSWRunIndex, hrMIBAdminInfo=hrMIBAdminInfo, hrFSBootable=hrFSBootable, hrProcessorEntry=hrProcessorEntry, hrMIBCompliance=hrMIBCompliance, KBytes=KBytes, hrFSAccess=hrFSAccess, hrMIBCompliances=hrMIBCompliances, hrSWRunPerfMem=hrSWRunPerfMem, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWRunName=hrSWRunName, hrPartitionFSIndex=hrPartitionFSIndex, hrPartitionTable=hrPartitionTable, hrSWRunStatus=hrSWRunStatus)
