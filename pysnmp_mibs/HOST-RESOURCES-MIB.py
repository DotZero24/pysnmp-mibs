...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrNetworkTable=hrNetworkTable, hrSWRunIndex=hrSWRunIndex, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrDeviceEntry=hrDeviceEntry, KBytes=KBytes, hrSWRunPerfCPU=hrSWRunPerfCPU, hrProcessorEntry=hrProcessorEntry, hrDeviceErrors=hrDeviceErrors, hrNetworkEntry=hrNetworkEntry, hrSystemUptime=hrSystemUptime, hrSystemNumUsers=hrSystemNumUsers, hrProcessorFrwID=hrProcessorFrwID, hrPrinterEntry=hrPrinterEntry, hrPartitionIndex=hrPartitionIndex, hrSWInstalledGroup=hrSWInstalledGroup, hrStorageIndex=hrStorageIndex, hrDiskStorageCapacity=hrDiskStorageCapacity, hrPartitionSize=hrPartitionSize, hrSWInstalledID=hrSWInstalledID, hrSystemGroup=hrSystemGroup, hrDiskStorageAccess=hrDiskStorageAccess, hrSWInstalled=hrSWInstalled, hrDeviceID=hrDeviceID, hrSWInstalledLastChange=hrSWInstalledLastChange, hrFSAccess=hrFSAccess, InternationalDisplayString=InternationalDisplayString, hrSWRunGroup=hrSWRunGroup, hrDiskStorageEntry=hrDiskStorageEntry, hrPrinterTable=hrPrinterTable, hrProcessorLoad=hrProcessorLoad, PYSNMP_MODULE_ID=hostResourcesMibModule, hrPartitionEntry=hrPartitionEntry, hrFSTable=hrFSTable, hrStorageEntry=hrStorageEntry, hrSWRunPerfMem=hrSWRunPerfMem, hrSWRunPerf=hrSWRunPerf, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrMemorySize=hrMemorySize, ProductID=ProductID, hrMIBCompliances=hrMIBCompliances, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWRunEntry=hrSWRunEntry, hrFSEntry=hrFSEntry, hrStorageAllocationUnits=hrStorageAllocationUnits, hrPrinterStatus=hrPrinterStatus, hrSWRunName=hrSWRunName, hrSWInstalledType=hrSWInstalledType, hrSWInstalledDate=hrSWInstalledDate, hrFSTypes=hrFSTypes, hrSystem=hrSystem, hrSWInstalledEntry=hrSWInstalledEntry, hrMIBCompliance=hrMIBCompliance, hrSWInstalledIndex=hrSWInstalledIndex, hrSWRunPath=hrSWRunPath, hrPartitionFSIndex=hrPartitionFSIndex, hrStorageTypes=hrStorageTypes, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDeviceGroup=hrDeviceGroup, hrSWInstalledName=hrSWInstalledName, hrSystemProcesses=hrSystemProcesses, hrStorageType=hrStorageType, hrSWRunStatus=hrSWRunStatus, hrSWRunPerfTable=hrSWRunPerfTable, hrSWRunType=hrSWRunType, hrFSType=hrFSType, hrDeviceTypes=hrDeviceTypes, hrDiskStorageTable=hrDiskStorageTable, hrStorageUsed=hrStorageUsed, hrSWRunID=hrSWRunID, hrSWInstalledTable=hrSWInstalledTable, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrFSBootable=hrFSBootable, hrProcessorTable=hrProcessorTable, hrFSIndex=hrFSIndex, host=host, hrSWRunTable=hrSWRunTable, hostResourcesMibModule=hostResourcesMibModule, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrPartitionID=hrPartitionID, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrNetworkIfIndex=hrNetworkIfIndex, hrFSMountPoint=hrFSMountPoint, hrMIBGroups=hrMIBGroups, hrDeviceDescr=hrDeviceDescr, hrSWRunParameters=hrSWRunParameters, hrStorageDescr=hrStorageDescr, hrSWRun=hrSWRun, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrDiskStorageMedia=hrDiskStorageMedia, hrSWOSIndex=hrSWOSIndex, hrFSStorageIndex=hrFSStorageIndex, hrMIBAdminInfo=hrMIBAdminInfo, hrDevice=hrDevice, hrDeviceIndex=hrDeviceIndex, hrPartitionLabel=hrPartitionLabel, hrDeviceType=hrDeviceType, hrSWRunPerfGroup=hrSWRunPerfGroup, hrDeviceTable=hrDeviceTable, hrStorageSize=hrStorageSize, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrStorageGroup=hrStorageGroup, hrSystemDate=hrSystemDate, hrSystemMaxProcesses=hrSystemMaxProcesses, hrDeviceStatus=hrDeviceStatus, hrStorageTable=hrStorageTable, hrPartitionTable=hrPartitionTable, hrStorage=hrStorage)
