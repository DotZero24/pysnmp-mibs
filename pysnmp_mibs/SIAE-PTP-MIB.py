...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/siaemic/SIAE-PTP-MIB
...
mibBuilder.exportSymbols("SIAE-PTP-MIB", ClockInstanceType=ClockInstanceType, ptpSpecificDataSetEntry=ptpSpecificDataSetEntry, ptpPortTxAsymmetryCompensation=ptpPortTxAsymmetryCompensation, ptpClockAccuracy=ptpClockAccuracy, ptpPortListeningAlarmSeverityCode=ptpPortListeningAlarmSeverityCode, ptpMibVersion=ptpMibVersion, ptpParentDataSet=ptpParentDataSet, ptpClockPPSInstanceIndex=ptpClockPPSInstanceIndex, ptpParentGMPriority1=ptpParentGMPriority1, ClockDomainType=ClockDomainType, ptpPortLogAnnounceInterval=ptpPortLogAnnounceInterval, ptpParentClockIdentity=ptpParentClockIdentity, ptpCurrentMeanPathDelay=ptpCurrentMeanPathDelay, ptpPortAlarmEntry=ptpPortAlarmEntry, ptpClockDataSetTable=ptpClockDataSetTable, ptpHoldoverOutOfSpecAlarm=ptpHoldoverOutOfSpecAlarm, ClockPortNumber=ClockPortNumber, ptpStaticPortRole=ptpStaticPortRole, ptpClockInstanceIndex=ptpClockInstanceIndex, ptpSpecificAlarmTable=ptpSpecificAlarmTable, ptpParentGMClockAccuracy=ptpParentGMClockAccuracy, ptpPortListeningAlarm=ptpPortListeningAlarm, ptpClockOffsetScaledLogVariance=ptpClockOffsetScaledLogVariance, ptpProfilePrimaryVersion=ptpProfilePrimaryVersion, ClockQualityAccuracyType=ClockQualityAccuracyType, ptpClockToDLabel=ptpClockToDLabel, ptpClockDomainIndex=ptpClockDomainIndex, ptpSpecificDataSet=ptpSpecificDataSet, ptpPortInitializingAlarmSeverityCode=ptpPortInitializingAlarmSeverityCode, ptpSpecificAlarmEntry=ptpSpecificAlarmEntry, ptpPortActiveStatusSeverityCode=ptpPortActiveStatusSeverityCode, ptpRadioOffset=ptpRadioOffset, ptpTimeTimeTraceable=ptpTimeTimeTraceable, ptpClockTypeIndex=ptpClockTypeIndex, ptpClockRowStatus=ptpClockRowStatus, ptpClockPPSInstanceCapability=ptpClockPPSInstanceCapability, ptpClockNumberPorts=ptpClockNumberPorts, ptpPortRxAsymmetryCompensation=ptpPortRxAsymmetryCompensation, ptpHoldoverInSpecAlarm=ptpHoldoverInSpecAlarm, ClockTimeInterval=ClockTimeInterval, ptpClockDataSetEntry=ptpClockDataSetEntry, ptpClockPPSAdminStatus=ptpClockPPSAdminStatus, ptpClockPPSDirection=ptpClockPPSDirection, ptpPortMinDelayReqInterval=ptpPortMinDelayReqInterval, ptpPortRowStatus=ptpPortRowStatus, ptpClockPPSOffsetValue=ptpClockPPSOffsetValue, ptpClockToDAdminStatus=ptpClockToDAdminStatus, ptpRadioAsymmetryDataSetEntry=ptpRadioAsymmetryDataSetEntry, ptpPortLocalPriority=ptpPortLocalPriority, ptpPortRadioCapacityAlarm=ptpPortRadioCapacityAlarm, ptpTimeLeap61=ptpTimeLeap61, ptpClockPPSDataSetEntry=ptpClockPPSDataSetEntry, ptpFreeRunningAlarmSeverityCode=ptpFreeRunningAlarmSeverityCode, ptpPortAnnounceReceiptTimeout=ptpPortAnnounceReceiptTimeout, ptpTimeDataSetEntry=ptpTimeDataSetEntry, ptpClockToDFormat=ptpClockToDFormat, ClockPortState=ClockPortState, ptpClockSlaveOnly=ptpClockSlaveOnly, ptpPortAlarmTable=ptpPortAlarmTable, ptpPortClockIdentity=ptpPortClockIdentity, ClockMechanismType=ClockMechanismType, ClockType=ClockType, ptpParentGMClockOffsetScaledLogVariance=ptpParentGMClockOffsetScaledLogVariance, ptpParentDataSetTable=ptpParentDataSetTable, ptpTimeCurrentUTCOffsetValid=ptpTimeCurrentUTCOffsetValid, ptpPortDataSet=ptpPortDataSet, ptpClockPriority2=ptpClockPriority2, ptpPortStaticRole=ptpPortStaticRole, ptpPortDataSetEntry=ptpPortDataSetEntry, ptpProfileDataSet=ptpProfileDataSet, ptpClockPPSDataSet=ptpClockPPSDataSet, ClockQualityClassType=ClockQualityClassType, ptpPortActiveStatus=ptpPortActiveStatus, ptpCurrentDataSet=ptpCurrentDataSet, ptpTimeFrequencyTraceable=ptpTimeFrequencyTraceable, ptpProfileIdentifier=ptpProfileIdentifier, ptpParentGMClockIdentity=ptpParentGMClockIdentity, ptpTimePropertiesDataSet=ptpTimePropertiesDataSet, ptpPortVersionNumber=ptpPortVersionNumber, ptpCurrentStepsRemoved=ptpCurrentStepsRemoved, ClockProfileType=ClockProfileType, ptpPortIfIndex=ptpPortIfIndex, ptpSystemProfile=ptpSystemProfile, ptpProfileRevisionNumber=ptpProfileRevisionNumber, ClockStateType=ClockStateType, ptpClockPriority1=ptpClockPriority1, ptpPortRadioAlarmTable=ptpPortRadioAlarmTable, ptp=ptp, ptpPortRadioAlarmEntry=ptpPortRadioAlarmEntry, ptpRadioBrIndex=ptpRadioBrIndex, ptpPortDataSetTable=ptpPortDataSetTable, ptpHoldoverInSpecAlarmSeverityCode=ptpHoldoverInSpecAlarmSeverityCode, ptpPortState=ptpPortState, ptpPortNotSlave=ptpPortNotSlave, ptpPortSyncInterval=ptpPortSyncInterval, ptpAdminStatus=ptpAdminStatus, ptpCompliance=ptpCompliance, ptpClockIdentity=ptpClockIdentity, PtpClockToDFormatType=PtpClockToDFormatType, ptpPortDestMacAddress=ptpPortDestMacAddress, ptpClockTwoStepFlag=ptpClockTwoStepFlag, ptpPortRadioCapacityAlarmSeverityCode=ptpPortRadioCapacityAlarmSeverityCode, ptpCurrentDataSetEntry=ptpCurrentDataSetEntry, ptpPortFaultyAlarm=ptpPortFaultyAlarm, ClockPPSInstanceType=ClockPPSInstanceType, ptpRadioAsymmetryDataSet=ptpRadioAsymmetryDataSet, ptpTimeDataSetTable=ptpTimeDataSetTable, ptpPortInitializingAlarm=ptpPortInitializingAlarm, ptpPortFaultyAlarmSeverityCode=ptpPortFaultyAlarmSeverityCode, ptpProfileName=ptpProfileName, ptpDefaultDataSet=ptpDefaultDataSet, ptpParentPortNumber=ptpParentPortNumber, ptpClockPPSLabel=ptpClockPPSLabel, ptpPortUncalibratedAlarm=ptpPortUncalibratedAlarm, ptpParentDataSetEntry=ptpParentDataSetEntry, ptpClockLocalPriority=ptpClockLocalPriority, ptpHoldoverOutOfSpecAlarmSeverityCode=ptpHoldoverOutOfSpecAlarmSeverityCode, ptpClockToDBaudrate=ptpClockToDBaudrate, ptpSpecificDataSetTable=ptpSpecificDataSetTable, ptpPortDelayMechanism=ptpPortDelayMechanism, PYSNMP_MODULE_ID=ptp, ptpRadioAsymmetryDataSetTable=ptpRadioAsymmetryDataSetTable, ptpTimeLeap59=ptpTimeLeap59, ptpParentGMPriority2=ptpParentGMPriority2, ptpTimescale=ptpTimescale, ptpClockPPSDataSetTable=ptpClockPPSDataSetTable, ptpFreeRunningAlarm=ptpFreeRunningAlarm, ptpParentGMClockClass=ptpParentGMClockClass, ptpClockPPSOffsetEnabled=ptpClockPPSOffsetEnabled, ClockTimeSourceType=ClockTimeSourceType, ptpClockClass=ptpClockClass, ptpClockToDDelay=ptpClockToDDelay, ptpPortUncalibratedAlarmSeverityCode=ptpPortUncalibratedAlarmSeverityCode, ptpPortAdminStatus=ptpPortAdminStatus, ptpPortIndex=ptpPortIndex, ptpCurrentOffsetFromMaster=ptpCurrentOffsetFromMaster, ptpClockState=ptpClockState, ptpCurrentDataSetTable=ptpCurrentDataSetTable, ptpTimeCurrentUTCOffset=ptpTimeCurrentUTCOffset, ptpTimeTimeSource=ptpTimeTimeSource)
