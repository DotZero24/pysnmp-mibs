...
mibBuilder.exportSymbols("SIAE-PTP-MIB", ptpPortAlarmEntry=ptpPortAlarmEntry, ptpTimePropertiesDataSet=ptpTimePropertiesDataSet, ptpPortIfIndex=ptpPortIfIndex, ptpStaticPortRole=ptpStaticPortRole, ptpPortNotSlave=ptpPortNotSlave, ClockType=ClockType, ptpClockTwoStepFlag=ptpClockTwoStepFlag, ptpPortDestMacAddress=ptpPortDestMacAddress, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=ptp, ptpPortDataSet=ptpPortDataSet, ptpSpecificDataSet=ptpSpecificDataSet, ptpRadioOffset=ptpRadioOffset, ptpClockToDLabel=ptpClockToDLabel, ptpPortAdminStatus=ptpPortAdminStatus, ptpPortUncalibratedAlarmSeverityCode=ptpPortUncalibratedAlarmSeverityCode, ClockProfileType=ClockProfileType, ptpClockRowStatus=ptpClockRowStatus, ptpProfilePrimaryVersion=ptpProfilePrimaryVersion, ptpPortMinDelayReqInterval=ptpPortMinDelayReqInterval, ptpClockTypeIndex=ptpClockTypeIndex, ptpTimeFrequencyTraceable=ptpTimeFrequencyTraceable, ptpHoldoverInSpecAlarmSeverityCode=ptpHoldoverInSpecAlarmSeverityCode, ptp=ptp, ptpPortInitializingAlarm=ptpPortInitializingAlarm, ptpClockPPSInstanceIndex=ptpClockPPSInstanceIndex, ptpPortInitializingAlarmSeverityCode=ptpPortInitializingAlarmSeverityCode, ptpClockSlaveOnly=ptpClockSlaveOnly, ptpParentDataSetTable=ptpParentDataSetTable, ptpCurrentDataSetEntry=ptpCurrentDataSetEntry, ptpTimeDataSetEntry=ptpTimeDataSetEntry, ptpPortUncalibratedAlarm=ptpPortUncalibratedAlarm, ptpPortListeningAlarm=ptpPortListeningAlarm, ptpProfileName=ptpProfileName, ptpClockState=ptpClockState, ptpClockDataSetEntry=ptpClockDataSetEntry, ptpParentGMPriority1=ptpParentGMPriority1, ptpClockIdentity=ptpClockIdentity, ptpPortDataSetTable=ptpPortDataSetTable, ptpClockLocalPriority=ptpClockLocalPriority, ptpPortStaticRole=ptpPortStaticRole, ptpParentGMClockClass=ptpParentGMClockClass, ptpClockPPSDataSetTable=ptpClockPPSDataSetTable, ClockDomainType=ClockDomainType, ptpFreeRunningAlarmSeverityCode=ptpFreeRunningAlarmSeverityCode, ClockStateType=ClockStateType, ClockPortState=ClockPortState, ptpPortLogAnnounceInterval=ptpPortLogAnnounceInterval, ptpClockPPSDataSetEntry=ptpClockPPSDataSetEntry, ptpPortTxAsymmetryCompensation=ptpPortTxAsymmetryCompensation, ptpParentGMClockIdentity=ptpParentGMClockIdentity, ptpPortRadioAlarmEntry=ptpPortRadioAlarmEntry, ptpClockPPSOffsetValue=ptpClockPPSOffsetValue, ptpPortRowStatus=ptpPortRowStatus, ptpPortAlarmTable=ptpPortAlarmTable, ptpPortClockIdentity=ptpPortClockIdentity, ClockQualityClassType=ClockQualityClassType, ClockPortNumber=ClockPortNumber, ptpAdminStatus=ptpAdminStatus, ptpClockPPSAdminStatus=ptpClockPPSAdminStatus, ptpClockPPSDataSet=ptpClockPPSDataSet, ptpPortActiveStatus=ptpPortActiveStatus, ClockMechanismType=ClockMechanismType, ClockQualityAccuracyType=ClockQualityAccuracyType, ptpPortAnnounceReceiptTimeout=ptpPortAnnounceReceiptTimeout, ptpPortRxAsymmetryCompensation=ptpPortRxAsymmetryCompensation, ptpClockDomainIndex=ptpClockDomainIndex, ptpSpecificDataSetTable=ptpSpecificDataSetTable, ptpClockAccuracy=ptpClockAccuracy, ptpPortDataSetEntry=ptpPortDataSetEntry, ptpMibVersion=ptpMibVersion, ptpHoldoverInSpecAlarm=ptpHoldoverInSpecAlarm, ptpDefaultDataSet=ptpDefaultDataSet, ptpCurrentMeanPathDelay=ptpCurrentMeanPathDelay, ptpCurrentDataSet=ptpCurrentDataSet, ptpTimeCurrentUTCOffsetValid=ptpTimeCurrentUTCOffsetValid, ptpPortRadioAlarmTable=ptpPortRadioAlarmTable, ptpRadioBrIndex=ptpRadioBrIndex, ClockInstanceType=ClockInstanceType, ptpClockClass=ptpClockClass, ptpTimeTimeSource=ptpTimeTimeSource, ptpPortFaultyAlarm=ptpPortFaultyAlarm, ClockTimeInterval=ClockTimeInterval, ptpPortLocalPriority=ptpPortLocalPriority, ptpClockPPSInstanceCapability=ptpClockPPSInstanceCapability, ptpTimeTimeTraceable=ptpTimeTimeTraceable, ptpRadioAsymmetryDataSetTable=ptpRadioAsymmetryDataSetTable, ptpTimeCurrentUTCOffset=ptpTimeCurrentUTCOffset, ptpParentGMClockOffsetScaledLogVariance=ptpParentGMClockOffsetScaledLogVariance, ptpClockToDAdminStatus=ptpClockToDAdminStatus, ptpProfileDataSet=ptpProfileDataSet, ptpPortVersionNumber=ptpPortVersionNumber, ptpPortActiveStatusSeverityCode=ptpPortActiveStatusSeverityCode, ptpClockInstanceIndex=ptpClockInstanceIndex, ptpClockPriority2=ptpClockPriority2, ptpParentGMClockAccuracy=ptpParentGMClockAccuracy, ptpClockPriority1=ptpClockPriority1, ptpRadioAsymmetryDataSet=ptpRadioAsymmetryDataSet, ptpHoldoverOutOfSpecAlarmSeverityCode=ptpHoldoverOutOfSpecAlarmSeverityCode, ptpRadioAsymmetryDataSetEntry=ptpRadioAsymmetryDataSetEntry, ptpSpecificDataSetEntry=ptpSpecificDataSetEntry, ptpPortState=ptpPortState, ptpTimeLeap61=ptpTimeLeap61, ptpPortListeningAlarmSeverityCode=ptpPortListeningAlarmSeverityCode, ptpClockOffsetScaledLogVariance=ptpClockOffsetScaledLogVariance, ptpClockNumberPorts=ptpClockNumberPorts, ptpParentDataSetEntry=ptpParentDataSetEntry, ptpProfileRevisionNumber=ptpProfileRevisionNumber, ptpParentClockIdentity=ptpParentClockIdentity, ptpTimeLeap59=ptpTimeLeap59, ptpHoldoverOutOfSpecAlarm=ptpHoldoverOutOfSpecAlarm, ptpPortSyncInterval=ptpPortSyncInterval, ptpSpecificAlarmEntry=ptpSpecificAlarmEntry, ptpPortRadioCapacityAlarmSeverityCode=ptpPortRadioCapacityAlarmSeverityCode, ptpTimeDataSetTable=ptpTimeDataSetTable, ptpClockPPSLabel=ptpClockPPSLabel, ClockPPSInstanceType=ClockPPSInstanceType, ptpCurrentDataSetTable=ptpCurrentDataSetTable, ptpParentDataSet=ptpParentDataSet, ptpProfileIdentifier=ptpProfileIdentifier, ptpClockToDBaudrate=ptpClockToDBaudrate, ptpPortRadioCapacityAlarm=ptpPortRadioCapacityAlarm, ptpPortIndex=ptpPortIndex, ptpClockPPSDirection=ptpClockPPSDirection, ptpFreeRunningAlarm=ptpFreeRunningAlarm, ptpClockDataSetTable=ptpClockDataSetTable, ptpSystemProfile=ptpSystemProfile, ptpPortDelayMechanism=ptpPortDelayMechanism, ptpClockToDFormat=ptpClockToDFormat, ptpParentGMPriority2=ptpParentGMPriority2, ptpPortFaultyAlarmSeverityCode=ptpPortFaultyAlarmSeverityCode, ptpSpecificAlarmTable=ptpSpecificAlarmTable, ptpCurrentOffsetFromMaster=ptpCurrentOffsetFromMaster, ptpClockPPSOffsetEnabled=ptpClockPPSOffsetEnabled, PtpClockToDFormatType=PtpClockToDFormatType, ClockTimeSourceType=ClockTimeSourceType, ptpTimescale=ptpTimescale, ptpParentPortNumber=ptpParentPortNumber, ptpClockToDDelay=ptpClockToDDelay, ptpCurrentStepsRemoved=ptpCurrentStepsRemoved)
