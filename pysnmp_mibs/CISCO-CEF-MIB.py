...
CefCCStatus, CefCCType, CefForwardingElementSpecialType, CefMplsLabelList, CefAdminStatus, CefCCAction, CefIpVersion, CefPathType, CefOperStatus, CefPrefixSearchState, CefFailureReason, CefAdjLinkType, CefAdjacencySource = mibBuilder.importSymbols("CISCO-CEF-TC", "CefCCStatus", "CefCCType", "CefForwardingElementSpecialType", "CefMplsLabelList", "CefAdminStatus", "CefCCAction", "CefIpVersion", "CefPathType", "CefOperStatus", "CefPrefixSearchState", "CefFailureReason", "CefAdjLinkType", "CefAdjacencySource")
...
mibBuilder.exportSymbols("CISCO-CEF-MIB", cefFESelectionName=cefFESelectionName, cefFIB=cefFIB, cefSwitchingPunt2Host=cefSwitchingPunt2Host, cefResourceFailure=cefResourceFailure, cefPrefixExternalNRPkts=cefPrefixExternalNRPkts, cefInconsistencyRecordTable=cefInconsistencyRecordTable, cefSwitchingStatsTable=cefSwitchingStatsTable, cefNotifCntl=cefNotifCntl, cefSwitchingPath=cefSwitchingPath, cefStatsPrefixLen=cefStatsPrefixLen, cefFESelectionEntry=cefFESelectionEntry, cefStatsPrefixLenEntry=cefStatsPrefixLenEntry, cefPathType=cefPathType, cefCfgOperState=cefCfgOperState, cefCfgLoadSharingAlgorithm=cefCfgLoadSharingAlgorithm, cefCCEnabled=cefCCEnabled, cefInconsistencyResetStatus=cefInconsistencyResetStatus, cefFIBSummaryEntry=cefFIBSummaryEntry, cefCfgTrafficStatsUpdateRate=cefCfgTrafficStatsUpdateRate, cefLMPrefixEntry=cefLMPrefixEntry, cefPathInterface=cefPathInterface, cefFIBSummary=cefFIBSummary, cefPrefixForwardingInfo=cefPrefixForwardingInfo, cefPathEntry=cefPathEntry, cefPathRecurseVrfName=cefPathRecurseVrfName, cefInconsistencyPrefixType=cefInconsistencyPrefixType, cefIntTable=cefIntTable, cefHCStatsGroup=cefHCStatsGroup, cefAdjSource=cefAdjSource, cefCfgAdminState=cefCfgAdminState, cefCCGlobalAutoRepairHoldDown=cefCCGlobalAutoRepairHoldDown, cefInconsistencyPrefixLen=cefInconsistencyPrefixLen, cefCfgDistributionOperState=cefCfgDistributionOperState, cefCCTypeTable=cefCCTypeTable, cefFESelectionAdjNextHopAddrType=cefFESelectionAdjNextHopAddrType, cefAdjFixup=cefAdjFixup, cefPrefixHCBytes=cefPrefixHCBytes, cefPrefixExternalNRHCPkts=cefPrefixExternalNRHCPkts, cefLMPrefixAddr=cefLMPrefixAddr, cefFIBIpVersion=cefFIBIpVersion, cefCfgEntry=cefCfgEntry, cefAdjSummaryIncomplete=cefAdjSummaryIncomplete, cefSwitchingPunt=cefSwitchingPunt, ciscoCefMIB=ciscoCefMIB, PYSNMP_MODULE_ID=ciscoCefMIB, cefAdjNextHopAddr=cefAdjNextHopAddr, cefMIBGroups=cefMIBGroups, cefAdjHCPkts=cefAdjHCPkts, cefInconsistencyCCType=cefInconsistencyCCType, cefCCGlobalAutoRepairEnabled=cefCCGlobalAutoRepairEnabled, cefFIBSummaryTable=cefFIBSummaryTable, cefPrefixInternalNRPkts=cefPrefixInternalNRPkts, cefPrefixInternalNRBytes=cefPrefixInternalNRBytes, cefLMPrefixDestAddrType=cefLMPrefixDestAddrType, cefFESelectionVrfName=cefFESelectionVrfName, cefInconsistencyReason=cefInconsistencyReason, cefSwitchingHCDrop=cefSwitchingHCDrop, cefNotifCntlGroup=cefNotifCntlGroup, cefLMPrefixTable=cefLMPrefixTable, cefLMPrefixState=cefLMPrefixState, cefPeerFIBStateChange=cefPeerFIBStateChange, cefNotificationGroup=cefNotificationGroup, cefResourceTable=cefResourceTable, cefCCGlobalAutoRepairDelay=cefCCGlobalAutoRepairDelay, cefInconsistencyRecId=cefInconsistencyRecId, cefAdjSummaryRedirect=cefAdjSummaryRedirect, cefAdjNextHopAddrType=cefAdjNextHopAddrType, cefAdjMTU=cefAdjMTU, cefPeerNumberOfResets=cefPeerNumberOfResets, cefAdjConnId=cefAdjConnId, cefPeer=cefPeer, cefIntEntry=cefIntEntry, cefNotifThrottlingInterval=cefNotifThrottlingInterval, cefCCGlobalFullScanAction=cefCCGlobalFullScanAction, ciscoCefMIBObjects=ciscoCefMIBObjects, cefCCQueriesIgnored=cefCCQueriesIgnored, cefCfgDistributionAdminState=cefCfgDistributionAdminState, cefInconsistencyPrefixAddr=cefInconsistencyPrefixAddr, cefResourceFailureNotifEnable=cefResourceFailureNotifEnable, cefFESelectionId=cefFESelectionId, cefAdjHCBytes=cefAdjHCBytes, cefStatsPrefixHCQueries=cefStatsPrefixHCQueries, cefMIBCompliances=cefMIBCompliances, cefCCGlobalFullScanStatus=cefCCGlobalFullScanStatus, cefAdjSummaryComplete=cefAdjSummaryComplete, cefStatsPrefixQueries=cefStatsPrefixQueries, cefPrefixPkts=cefPrefixPkts, cefPrefixExternalNRHCBytes=cefPrefixExternalNRHCBytes, cefSwitchingHCPunt2Host=cefSwitchingHCPunt2Host, cefPrefixExternalNRBytes=cefPrefixExternalNRBytes, cefInterface=cefInterface, cefFESelectionAdjNextHopAddr=cefFESelectionAdjNextHopAddr, cefCCGlobalEntry=cefCCGlobalEntry, cefPeerOperState=cefPeerOperState, cefCCTypeEntry=cefCCTypeEntry, cefPrefixAddr=cefPrefixAddr, cefPeerFIBEntry=cefPeerFIBEntry, cefPathId=cefPathId, cefAdjSummaryLinkType=cefAdjSummaryLinkType, cefCfgTrafficStatsLoadInterval=cefCfgTrafficStatsLoadInterval, cefCCPeriod=cefCCPeriod, ciscoCefMIBNotifs=ciscoCefMIBNotifs, cefAdjBytes=cefAdjBytes, cefAdjPkts=cefAdjPkts, cefAdjEncap=cefAdjEncap, cefPrefixType=cefPrefixType, cefCC=cefCC, cefPeerTable=cefPeerTable, cefCfgTable=cefCfgTable, cefPrefixTable=cefPrefixTable, cefPeerStateChange=cefPeerStateChange, cefMIBCompliance=cefMIBCompliance, cefPrefixInternalNRHCPkts=cefPrefixInternalNRHCPkts, cefFESelectionSpecial=cefFESelectionSpecial, cefStatsPrefixDeletes=cefStatsPrefixDeletes, cefResourceMemoryUsed=cefResourceMemoryUsed, entPeerPhysicalIndex=entPeerPhysicalIndex, cefCCCount=cefCCCount, cefAdjEntry=cefAdjEntry, cefFESelectionAdjLinkType=cefFESelectionAdjLinkType, cefResourceFailureReason=cefResourceFailureReason, cefSwitchingHCPunt=cefSwitchingHCPunt, cefPeerStateChangeNotifEnable=cefPeerStateChangeNotifEnable, cefAdjSummary=cefAdjSummary, cefLMPrefixSpinLock=cefLMPrefixSpinLock, cefIntNonrecursiveAccouting=cefIntNonrecursiveAccouting, cefCCGlobalErrorMsgEnabled=cefCCGlobalErrorMsgEnabled, cefFESelectionAdjInterface=cefFESelectionAdjInterface, cefStatsPrefixHCDeletes=cefStatsPrefixHCDeletes, cefFE=cefFE, cefCCGlobalTable=cefCCGlobalTable, cefStatsPrefixLenTable=cefStatsPrefixLenTable, cefLMPrefixLen=cefLMPrefixLen, cefPrefixBytes=cefPrefixBytes, cefLMPrefixRowStatus=cefLMPrefixRowStatus, cefAdjForwardingInfo=cefAdjForwardingInfo, cefFESelectionAdjConnId=cefFESelectionAdjConnId, cefPrefixEntry=cefPrefixEntry, cefAdjSummaryEntry=cefAdjSummaryEntry, cefInconsistencyRecordEntry=cefInconsistencyRecordEntry, cefInconsistencyReset=cefInconsistencyReset, cefFESelectionLabels=cefFESelectionLabels, cefCCQueriesChecked=cefCCQueriesChecked, cefCfgAccountingMap=cefCfgAccountingMap, cefInconsistencyVrfName=cefInconsistencyVrfName, cefIntSwitchingState=cefIntSwitchingState, cefAdjTable=cefAdjTable, cefGlobal=cefGlobal, cefPeerFIBStateChangeNotifEnable=cefPeerFIBStateChangeNotifEnable, cefAdj=cefAdj, cefPrefixHCPkts=cefPrefixHCPkts, cefLMPrefixDestAddr=cefLMPrefixDestAddr, cefStatsPrefixHCElements=cefStatsPrefixHCElements, cefGroup=cefGroup, cefAdjSummaryFixup=cefAdjSummaryFixup, cefSwitchingDrop=cefSwitchingDrop, cefCfgLoadSharingID=cefCfgLoadSharingID, cefStatsPrefixHCInserts=cefStatsPrefixHCInserts, cefFESelectionWeight=cefFESelectionWeight, cefPeerFIBTable=cefPeerFIBTable, cefInconsistencyDetection=cefInconsistencyDetection, cefPeerFIBOperState=cefPeerFIBOperState, cefFIBSummaryFwdPrefixes=cefFIBSummaryFwdPrefixes, cefResourceEntry=cefResourceEntry, cefPrefixInternalNRHCBytes=cefPrefixInternalNRHCBytes, ciscoCefMIBConform=ciscoCefMIBConform, cefPeerEntry=cefPeerEntry, cefIntLoadSharing=cefIntLoadSharing, cefStatsPrefixElements=cefStatsPrefixElements, cefInconsistencyEntity=cefInconsistencyEntity, cefPrefixLen=cefPrefixLen, cefStats=cefStats, cefDistributedGroup=cefDistributedGroup, cefCCQueriesIterated=cefCCQueriesIterated, cefCCQueriesSent=cefCCQueriesSent, cefAdjSummaryTable=cefAdjSummaryTable, cefStatsPrefixInserts=cefStatsPrefixInserts, cefSwitchingStatsEntry=cefSwitchingStatsEntry, cefInconsistencyNotifEnable=cefInconsistencyNotifEnable, cefCCType=cefCCType, cefPathNextHopAddr=cefPathNextHopAddr, cefSwitchingIndex=cefSwitchingIndex, cefPathTable=cefPathTable, cefFESelectionTable=cefFESelectionTable, entLastInconsistencyDetectTime=entLastInconsistencyDetectTime)
