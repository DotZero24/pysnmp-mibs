...
poe=_Poe_ObjectIdentity((1,3,6,1,4,1,52642,2,236))
_PowerEtherTable_Object=MibTable
powerEtherTable=_PowerEtherTable_Object((1,3,6,1,4,1,52642,2,236,1))
if mibBuilder.loadTexts:powerEtherTable.setStatus(_A)
_PowerEtherTableEntry_Object=MibTableRow
powerEtherTableEntry=_PowerEtherTableEntry_Object((1,3,6,1,4,1,52642,2,236,1,1))
...
ifIndex=_IfIndex_Object((1,3,6,1,4,1,52642,2,236,1,1,1),_IfIndex_Type())
...
ifDescr=_IfDescr_Object((1,3,6,1,4,1,52642,2,236,1,1,2),_IfDescr_Type())
...
ifPethPortControlAbility=_IfPethPortControlAbility_Object((1,3,6,1,4,1,52642,2,236,1,1,3),_IfPethPortControlAbility_Type())
...
ifPethPortMaxPower=_IfPethPortMaxPower_Object((1,3,6,1,4,1,52642,2,236,1,1,4),_IfPethPortMaxPower_Type())
...
ifPethPortConsumptionPower=_IfPethPortConsumptionPower_Object((1,3,6,1,4,1,52642,2,236,1,1,5),_IfPethPortConsumptionPower_Type())
