# SNMP MIB module (Dell-VRTX-TRUNK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-VRTX-TRUNK-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:11 2025
...
rlDot3adAggBalanceEntry = _RlDot3adAggBalanceEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 65, 2, 1)
)
rlDot3adAggBalanceEntry.setIndexNames(
    (0, "IEEE8023-LAG-MIB", "dot3adAggIndex"),
    (0, "Dell-VRTX-TRUNK-MIB", "rlDot3adAggBalanceForwardType"),
)
if mibBuilder.loadTexts:
