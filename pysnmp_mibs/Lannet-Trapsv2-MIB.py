...
#
vnsPacketDetectedVLAN, vnsPacketBoxAgentIP, vnsPacketIPAddress, vnsPacketMACAddress, vnsPacketExpectedIfName, vnsPacketExpectedVLAN, lseIntPortCAMLastChange, vnsPacketIPNetMask, vnsPacketDetectedIfName = mibBuilder.importSymbols("APPLIC-MIB", "vnsPacketDetectedVLAN", "vnsPacketBoxAgentIP", "vnsPacketIPAddress", "vnsPacketMACAddress", "vnsPacketExpectedIfName", "vnsPacketExpectedVLAN", "lseIntPortCAMLastChange", "vnsPacketIPNetMask", "vnsPacketDetectedIfName")
ObjectIdentifier, OctetString, Integer = mibBuilder.importSymbols("ASN1", "ObjectIdentifier", "OctetString", "Integer")
NamedValues, = mibBuilder.importSymbols("ASN1-ENUMERATION", "NamedValues")
ValueRangeConstraint, SingleValueConstraint, ConstraintsUnion, ConstraintsIntersection, ValueSizeConstraint = mibBuilder.importSymbols("ASN1-REFINEMENT", "ValueRangeConstraint", "SingleValueConstraint", "ConstraintsUnion", "ConstraintsIntersection", "ValueSizeConstraint")
chHWIntTempThresh, chHWIntTempWarning, genGroupId, genPortFunctionalStatus, genPortGroupId, genPortFaultMask, softRedundancyStatus, genGroupMPSActivityStatus, genGroupCascadDownStatus, softRedundancyPortId1, softRedundancyGroupId1, genPortId, softRedundancyGroupId2, genGroupFaultMask, softRedundancyName, genGroupCascadUpStatus, softRedundancyPortId2, chLntAgIntTemp, genGroupBUPSActivityStatus = mibBuilder.importSymbols("CONFIG-MIB", "chHWIntTempThresh", "chHWIntTempWarning", "genGroupId", "genPortFunctionalStatus", "genPortGroupId", "genPortFaultMask", "softRedundancyStatus", "genGroupMPSActivityStatus", "genGroupCascadDownStatus", "softRedundancyPortId1", "softRedundancyGroupId1", "genPortId", "softRedundancyGroupId2", "genGroupFaultMask", "softRedundancyName", "genGroupCascadUpStatus", "softRedundancyPortId2", "chLntAgIntTemp", "genGroupBUPSActivityStatus")
...
ipPolicyListID, ipPolicyActivationSubContext, ipPolicyAccessControlViolationRuleType, ipPolicyAccessControlViolationSubCtxt, ipPolicyActivationList, ipPolicyAccessControlViolationEntID, ipPolicyAccessControlViolationL4SrcPort, ipPolicyAccessControlViolationEstablished, ipPolicyRuleID, ipPolicyAccessControlViolationDstAddr, ipPolicyAccessControlViolationProtocol, ipPolicyControlSlot, ipPolicyRuleListID, ipPolicyAccessControlViolationIfIndex, ipPolicyAccessControlViolationTime, ipPolicyRuleDescription, ipPolicyAccessControlViolationL4DstPort, ipPolicyActivationEntID, ipPolicyActivationifIndex, ipPolicyAccessControlViolationSrcAddr = mibBuilder.importSymbols("POLICY-MIB", "ipPolicyListID", "ipPolicyActivationSubContext", "ipPolicyAccessControlViolationRuleType", "ipPolicyAccessControlViolationSubCtxt", "ipPolicyActivationList", "ipPolicyAccessControlViolationEntID", "ipPolicyAccessControlViolationL4SrcPort", "ipPolicyAccessControlViolationEstablished", "ipPolicyRuleID", "ipPolicyAccessControlViolationDstAddr", "ipPolicyAccessControlViolationProtocol", "ipPolicyControlSlot", "ipPolicyRuleListID", "ipPolicyAccessControlViolationIfIndex", "ipPolicyAccessControlViolationTime", "ipPolicyRuleDescription", "ipPolicyAccessControlViolationL4DstPort", "ipPolicyActivationEntID", "ipPolicyActivationifIndex", "ipPolicyAccessControlViolationSrcAddr")
...
scGenLinkAggregationStatus, scEthPortId, scGenGroupDot1xSystemMaxNumSupplicant, scGenLinkAggregationId, scGenPortLastIntruderSourceAddr, scEthPortGroupId, scGenLinkAggregationFaultMask, scGenPortId, scGenLinkAggregationName, scGenGroupFansStatus, scGenPortGroupId, scGenLinkAggregationFunctionalStatus, scEthPortFunctionalStatus, scGenGroupBUPSFansStatus, scGenPortDot1xMAC, scGenLinkAggregationAutoNegResults, scGenSwitchDot1xPortMaxSuppNum = mibBuilder.importSymbols("XSWITCH-MIB", "scGenLinkAggregationStatus", "scEthPortId", "scGenGroupDot1xSystemMaxNumSupplicant", "scGenLinkAggregationId", "scGenPortLastIntruderSourceAddr", "scEthPortGroupId", "scGenLinkAggregationFaultMask", "scGenPortId", "scGenLinkAggregationName", "scGenGroupFansStatus", "scGenPortGroupId", "scGenLinkAggregationFunctionalStatus", "scEthPortFunctionalStatus", "scGenGroupBUPSFansStatus", "scGenPortDot1xMAC", "scGenLinkAggregationAutoNegResults", "scGenSwitchDot1xPortMaxSuppNum")
...
mibBuilder.exportSymbols("Lannet-Trapsv2-MIB", lntP130TrapAgentCapabilities=lntP130TrapAgentCapabilities, lntL3FaultsPrefix=lntL3FaultsPrefix, lntMainFansFlt=lntMainFansFlt, lntTempratureWarningPrefix=lntTempratureWarningPrefix, lntNotificationVarbinds=lntNotificationVarbinds, lntPolicyChangeEvent=lntPolicyChangeEvent, lntLAGDeleteEvent=lntLAGDeleteEvent, lntSWRedundancyEvents=lntSWRedundancyEvents, lntSecurityNotificationGroup=lntSecurityNotificationGroup, lntWanPrefix=lntWanPrefix, lntWanRemoteAlarmOff=lntWanRemoteAlarmOff, lntWanMinorAlarmOff=lntWanMinorAlarmOff, lntEthPortNotificationGroup=lntEthPortNotificationGroup, lntConfigChangeValue=lntConfigChangeValue, lntSecurityEvents=lntSecurityEvents, lntLAGEvents=lntLAGEvents, lntEthVPortAutoNegotiationFlt=lntEthVPortAutoNegotiationFlt, lntLAGPrefix=lntLAGPrefix, lntLAGAutoNegOk=lntLAGAutoNegOk, lntPolicyAccessControlViolationFlt=lntPolicyAccessControlViolationFlt, lntDot1xMaxAuthPortNumReachedEvent=lntDot1xMaxAuthPortNumReachedEvent, lntWanLocalAlarmOn=lntWanLocalAlarmOn, lntEthPortAutoNegotiationFlt=lntEthPortAutoNegotiationFlt, scGenPortDot1xFailureString=scGenPortDot1xFailureString, lntConfigChangeEvent=lntConfigChangeEvent, lntFansNotificationGroup=lntFansNotificationGroup, lntLAGConnLostFlt=lntLAGConnLostFlt, lntPortAutoPartOk=lntPortAutoPartOk, lntDot1xAuthFailureEvent=lntDot1xAuthFailureEvent, lntCAMChangePrefix=lntCAMChangePrefix, lntEthPortAutoNegotiationOK=lntEthPortAutoNegotiationOK, lntLinkDownNotificationGroup=lntLinkDownNotificationGroup, lntCascadUpConnOk=lntCascadUpConnOk, lntG350NotificationAgentCapability=lntG350NotificationAgentCapability, lntAccountLockoutEvent=lntAccountLockoutEvent, lntUnAuthAccessEvent=lntUnAuthAccessEvent, lntDuplicateIPFlt=lntDuplicateIPFlt, lntPolicyEvents=lntPolicyEvents, lntVPortAutoPartFlt=lntVPortAutoPartFlt, lntUnauthProtocol=lntUnauthProtocol, lntL3Events=lntL3Events, lntP330L2NotificationAgentCapabilities=lntP330L2NotificationAgentCapabilities, lntWanEvents=lntWanEvents, lntWanMinorAlarmOn=lntWanMinorAlarmOn, lntBackupPSUOk=lntBackupPSUOk, lntLAGPartialConnLostFlt=lntLAGPartialConnLostFlt, lntLAGPartialConnLostOk=lntLAGPartialConnLostOk, lntEthPortFaultEvents=lntEthPortFaultEvents, lntTraps=lntTraps, lntEthPortFaultPrefix=lntEthPortFaultPrefix, lntPortLinkUpEvent=lntPortLinkUpEvent, lntPSUEvents=lntPSUEvents, lntVPortLinkUpEvent=lntVPortLinkUpEvent, lntNotificationGroups=lntNotificationGroups, lntLAGCreateEvent=lntLAGCreateEvent, lntSWRedundancyNotificationGroup=lntSWRedundancyNotificationGroup, lntEthVPortAutoNegotiationOK=lntEthVPortAutoNegotiationOK, lntPolicyPrefix=lntPolicyPrefix, lntPortFEOk=lntPortFEOk, lntCascadDownConnOk=lntCascadDownConnOk, lntCascadeFaultsPrefix=lntCascadeFaultsPrefix, lntFansEvents=lntFansEvents, lntBackupFansFlt=lntBackupFansFlt, lntLAGAutoNegFlt=lntLAGAutoNegFlt, lntLinkEvents=lntLinkEvents, lntUnknownHostCopyEvent=lntUnknownHostCopyEvent, lntSoftRedNewEvent=lntSoftRedNewEvent, lntStackMasterReelection=lntStackMasterReelection, lntP330L3NotificationAgentCapabilities=lntP330L3NotificationAgentCapabilities, lntPolicyAccessControlListLvlRuleTrap=lntPolicyAccessControlListLvlRuleTrap, lntCascadUpConnFlt=lntCascadUpConnFlt, lntMainFansOK=lntMainFansOK, lntBackupPSUFlt=lntBackupPSUFlt, lntCAMNotificationGroup=lntCAMNotificationGroup, lntDot1xMaxAuthRateReachedEvent=lntDot1xMaxAuthRateReachedEvent, lntPSUFaultNotificationGroup=lntPSUFaultNotificationGroup, lntPortFEFlt=lntPortFEFlt, lntCascadDownConnFlt=lntCascadDownConnFlt, lntWanPhysicalAlarmOff=lntWanPhysicalAlarmOff, lntUnauthIpAddress=lntUnauthIpAddress, lntBackupFansOK=lntBackupFansOK, lntWanLocalAlarmOff=lntWanLocalAlarmOff, lntConfigChangeVarbinds=lntConfigChangeVarbinds, lntPortAutoPartFlt=lntPortAutoPartFlt, lntP330MLNotificationAgentCapabilities=lntP330MLNotificationAgentCapabilities, lntCAMChangeEvents=lntCAMChangeEvents, lntConfigChangeOID=lntConfigChangeOID, lntNotificationAgentCapabilities=lntNotificationAgentCapabilities, PYSNMP_MODULE_ID=lntTraps, lntDot1xMaxAuthModuleNumReachedEvent=lntDot1xMaxAuthModuleNumReachedEvent, lntSWRedundancyPrefix=lntSWRedundancyPrefix, lntUnauthUserName=lntUnauthUserName, lntVPortLinkDownEvent=lntVPortLinkDownEvent, lntVPortAutoPartOK=lntVPortAutoPartOK, lntSoftRedDelEvent=lntSoftRedDelEvent, lntPortLinkDownEvent=lntPortLinkDownEvent, lntMACSecurityEvent=lntMACSecurityEvent, lntLinkEventsPrefix=lntLinkEventsPrefix, lntLAGConnLostOk=lntLAGConnLostOk, lntWanNotificationGroup=lntWanNotificationGroup, lntPortInlinePowerOK=lntPortInlinePowerOK, lntLagNotificationGroup=lntLagNotificationGroup, lntConfigChangeEvents=lntConfigChangeEvents, lntPolicyNotificationGroup=lntPolicyNotificationGroup, lntWanRemoteAlarmOn=lntWanRemoteAlarmOn, lntCascadeEvents=lntCascadeEvents, lntSCPStrictCheckingMode=lntSCPStrictCheckingMode, lntTempratureOk=lntTempratureOk, lntSecurityPrefix=lntSecurityPrefix, lntTempratureEvents=lntTempratureEvents, lntCascadeNotificationGroup=lntCascadeNotificationGroup, lntMainPSUFlt=lntMainPSUFlt, lntTempratureWarning=lntTempratureWarning, lntPSUPrefix=lntPSUPrefix, lntTempratureNotificationGroup=lntTempratureNotificationGroup, lntConfigChangeNotificationGroup=lntConfigChangeNotificationGroup, lntLicenseDownloadValidationFlt=lntLicenseDownloadValidationFlt, lntVPortFEFlt=lntVPortFEFlt, lntWanPhysicalAlarmOn=lntWanPhysicalAlarmOn, lntPortInlinePowerFlt=lntPortInlinePowerFlt, lntL3FaultNotificationGroup=lntL3FaultNotificationGroup, lntVPortFEOk=lntVPortFEOk, lntVLANViolationEvent=lntVLANViolationEvent, lntARPViolationEvent=lntARPViolationEvent, lntLicenseStartupValidationFlt=lntLicenseStartupValidationFlt, lntPortCAMLastChange=lntPortCAMLastChange, lntFansPrefix=lntFansPrefix, lntConfigChangePrefix=lntConfigChangePrefix, lntLicenseErrorCodes=lntLicenseErrorCodes, lntMainPSUOk=lntMainPSUOk)
