...
mibBuilder.exportSymbols("HPN-ICF-EPON-MIB", hpnicfOltDbaCycleLengthMaxVal=hpnicfOltDbaCycleLengthMaxVal, hpnicfOnuSlaMaxBandWidthMinVal=hpnicfOnuSlaMaxBandWidthMinVal, hpnicfOnuPriorityQueueBandwidthMaxVal=hpnicfOnuPriorityQueueBandwidthMaxVal, hpnicfOnuQueueId=hpnicfOnuQueueId, hpnicfOnuInCRCErrPkts=hpnicfOnuInCRCErrPkts, hpnicfOnuLinkTestFrameNum=hpnicfOnuLinkTestFrameNum, hpnicfOnuRS485DataBits=hpnicfOnuRS485DataBits, hpnicfEponAutoUpdateTable=hpnicfEponAutoUpdateTable, hpnicfOnuDownStreamShortFrameFirst=hpnicfOnuDownStreamShortFrameFirst, hpnicfOnuChipSetVendorId=hpnicfOnuChipSetVendorId, hpnicfOltInfoTable=hpnicfOltInfoTable, hpnicfOltUsingOnuRowStatus=hpnicfOltUsingOnuRowStatus, hpnicfOltHardMajorVersion=hpnicfOltHardMajorVersion, hpnicfOnuChipSetModel=hpnicfOnuChipSetModel, hpnicfOnuInfoTable=hpnicfOnuInfoTable, hpnicfOnuCapabilityTable=hpnicfOnuCapabilityTable, hpnicfOnuFirstPonMac=hpnicfOnuFirstPonMac, hpnicfOltDbaDiscovryFrequency=hpnicfOltDbaDiscovryFrequency, hpnicfOnuRS485BaudRate=hpnicfOnuRS485BaudRate, hpnicfOltWorkMode=hpnicfOltWorkMode, hpnicfOnuSlaMinBandWidthMaxVal=hpnicfOnuSlaMinBandWidthMaxVal, hpnicfEponModeSwitch=hpnicfEponModeSwitch, hpnicfOnuRS485SessionTable=hpnicfOnuRS485SessionTable, hpnicfEponPortAlarmFerRecoverTrap=hpnicfEponPortAlarmFerRecoverTrap, hpnicfOnuMacAddress=hpnicfOnuMacAddress, hpnicfOnuFirmwareUpdateByTypeTable=hpnicfOnuFirmwareUpdateByTypeTable, hpnicfOnuDistance=hpnicfOnuDistance, hpnicfOltLaserOnTimeMaxVal=hpnicfOltLaserOnTimeMaxVal, hpnicfOltPortAlarmLocalStableEnabled=hpnicfOltPortAlarmLocalStableEnabled, hpnicfOamEventLogType=hpnicfOamEventLogType, hpnicfOnuChipSetDesignDate=hpnicfOnuChipSetDesignDate, hpnicfDot3OamThresholdRecoverEvent=hpnicfDot3OamThresholdRecoverEvent, hpnicfOltPortAlarmLlidMismatchThreshold=hpnicfOltPortAlarmLlidMismatchThreshold, hpnicfOnuGrantFifoDep=hpnicfOnuGrantFifoDep, hpnicfOnuFEPortNumber=hpnicfOnuFEPortNumber, hpnicfOnuP2PHighPriorityFirst=hpnicfOnuP2PHighPriorityFirst, hpnicfEponBatchOperationBySlotResult=hpnicfEponBatchOperationBySlotResult, hpnicfOnuSmlkFirstPonStatus=hpnicfOnuSmlkFirstPonStatus, hpnicfOnuRS485SessionRemotePort=hpnicfOnuRS485SessionRemotePort, hpnicfOnuReAuthorize=hpnicfOnuReAuthorize, hpnicfOnuSlaFixedPacketSize=hpnicfOnuSlaFixedPacketSize, hpnicfOnuRS485RXErrOctets=hpnicfOnuRS485RXErrOctets, hpnicfOnuMacAddrInfoEntry=hpnicfOnuMacAddrInfoEntry, hpnicfOnuIgspFastLeaveSupported=hpnicfOnuIgspFastLeaveSupported, hpnicfEponSysManTable=hpnicfEponSysManTable, hpnicfOltPortAlarmBerMinVal=hpnicfOltPortAlarmBerMinVal, hpnicfEponBatchOperationByOLTEntry=hpnicfEponBatchOperationByOLTEntry, hpnicfOnuDownStreamMaxBandWidth=hpnicfOnuDownStreamMaxBandWidth, hpnicfOnuSlaDelay=hpnicfOnuSlaDelay, hpnicfEponMulticastVlanId=hpnicfEponMulticastVlanId, hpnicfOltPortAlarmLlidMisMaxVal=hpnicfOltPortAlarmLlidMisMaxVal, hpnicfEponOamDisconnectionTrap=hpnicfEponOamDisconnectionTrap, hpnicfOltMultiCopyBrdCast=hpnicfOltMultiCopyBrdCast, hpnicfOnuPCBVersion=hpnicfOnuPCBVersion, hpnicfEponOnuSilenceRecoverTrap=hpnicfEponOnuSilenceRecoverTrap, hpnicfOnuUpstreamQueueNumber=hpnicfOnuUpstreamQueueNumber, hpnicfOnuBindType=hpnicfOnuBindType, hpnicfEponOltDFETrap=hpnicfEponOltDFETrap, hpnicfOnuPortBerStatus=hpnicfOnuPortBerStatus, hpnicfEponSoftwareErrRecoverTrap=hpnicfEponSoftwareErrRecoverTrap, hpnicfOnuSlaFixedBandWidth=hpnicfOnuSlaFixedBandWidth, hpnicfOnuLinkTestResultRetFrameNum=hpnicfOnuLinkTestResultRetFrameNum, hpnicfEponOuiTable=hpnicfEponOuiTable, hpnicfOnuSlaMaxBandWidthMaxVal=hpnicfOnuSlaMaxBandWidthMaxVal, hpnicfEponOnuRegSilentMac=hpnicfEponOnuRegSilentMac, hpnicfOnuQueuePolicyStatus=hpnicfOnuQueuePolicyStatus, hpnicfOnuQueueBandwidthTable=hpnicfOnuQueueBandwidthTable, hpnicfOnuUpdateByTypeOnuType=hpnicfOnuUpdateByTypeOnuType, hpnicfOnuCosToLocalPrecedenceCosIndex=hpnicfOnuCosToLocalPrecedenceCosIndex, hpnicfOnuLinkTestResultRetErrFrameNum=hpnicfOnuLinkTestResultRetErrFrameNum, hpnicfOnuQueueMaxBurstsize=hpnicfOnuQueueMaxBurstsize, hpnicfEponSoftwareErrTrap=hpnicfEponSoftwareErrTrap, hpnicfOnuLinkTestResultSentFrameNum=hpnicfOnuLinkTestResultSentFrameNum, hpnicfEponMulticastControlTable=hpnicfEponMulticastControlTable, hpnicfOnuRS485SessionRowStatus=hpnicfOnuRS485SessionRowStatus, hpnicfOnuLinkTestVlanTag=hpnicfOnuLinkTestVlanTag, hpnicfOnuInfoEntry=hpnicfOnuInfoEntry, hpnicfEponOnuStpPortEntry=hpnicfEponOnuStpPortEntry, hpnicfOltLaserOffTimeMinVal=hpnicfOltLaserOffTimeMinVal, hpnicfEponMonitorCycleMaxVal=hpnicfEponMonitorCycleMaxVal, hpnicfOltPortAlarmFerMinVal=hpnicfOltPortAlarmFerMinVal, hpnicfOltOpticalPowerRx=hpnicfOltOpticalPowerRx, hpnicfOnuRegType=hpnicfOnuRegType, hpnicfOnuBandWidthEntry=hpnicfOnuBandWidthEntry, hpnicfOltPortAlarmLlidMisMinVal=hpnicfOltPortAlarmLlidMisMinVal, hpnicfOltUsingOnuTable=hpnicfOltUsingOnuTable, hpnicfEponMonitorCycle=hpnicfEponMonitorCycle, hpnicfOltInfoEntry=hpnicfOltInfoEntry, hpnicfOnuRS485SessionAddType=hpnicfOnuRS485SessionAddType, hpnicfEponMonitorCycleEnable=hpnicfEponMonitorCycleEnable, hpnicfOnuRtt=hpnicfOnuRtt, hpnicfEponOuiEntry=hpnicfEponOuiEntry, hpnicfOltPortAlarmBerMaxVal=hpnicfOltPortAlarmBerMaxVal, hpnicfOnuPacketManEntry=hpnicfOnuPacketManEntry, hpnicfOnuRS485SessionType=hpnicfOnuRS485SessionType, hpnicfEponMsgTimeOutMinVal=hpnicfEponMsgTimeOutMinVal, hpnicfOnuLaserOffTime=hpnicfOnuLaserOffTime, hpnicfOnuUpdateByOnuTypeIndex=hpnicfOnuUpdateByOnuTypeIndex, hpnicfOnuUpdateByTypeNextIndex=hpnicfOnuUpdateByTypeNextIndex, hpnicfOltAgcLockTime=hpnicfOltAgcLockTime, hpnicfOltDbaDiscovryFrequencyMaxVal=hpnicfOltDbaDiscovryFrequencyMaxVal, hpnicfEponMsgTimeOutMaxVal=hpnicfEponMsgTimeOutMaxVal, hpnicfOltPortAlarmBerEnabled=hpnicfOltPortAlarmBerEnabled, hpnicfEponBatchOperationByOLTTable=hpnicfEponBatchOperationByOLTTable, hpnicfOltFirmMinorVersion=hpnicfOltFirmMinorVersion, hpnicfOnuSlaMaxBandWidth=hpnicfOnuSlaMaxBandWidth, hpnicfOnuPppoe=hpnicfOnuPppoe, hpnicfOnuLinkTestFrameSize=hpnicfOnuLinkTestFrameSize, hpnicfOnuRS485SessionRemoteIP=hpnicfOnuRS485SessionRemoteIP, hpnicfEponOnuScalarGroup=hpnicfEponOnuScalarGroup, hpnicfEponOuiIndexNextTable=hpnicfEponOuiIndexNextTable, hpnicfOnuSmlkGroupID=hpnicfOnuSmlkGroupID, hpnicfEponSoftwareErrorCode=hpnicfEponSoftwareErrorCode, hpnicfOnuDownStreamHighPriorityFirst=hpnicfOnuDownStreamHighPriorityFirst, hpnicfEponEncryptionUpdateTime=hpnicfEponEncryptionUpdateTime, hpnicfOltPortAlarmLlidMismatchEnabled=hpnicfOltPortAlarmLlidMismatchEnabled, hpnicfEponAutoBindStatus=hpnicfEponAutoBindStatus, hpnicfOnuMCtrlFastLeaveSupported=hpnicfOnuMCtrlFastLeaveSupported, hpnicfOltPortAlarmBer=hpnicfOltPortAlarmBer, hpnicfOnuIpAddress=hpnicfOnuIpAddress, hpnicfEponOltSoftwareErrAlmEnable=hpnicfEponOltSoftwareErrAlmEnable, hpnicfOltDbaDiscovryFrequencyMinVal=hpnicfOltDbaDiscovryFrequencyMinVal, hpnicfOnuDot1xTable=hpnicfOnuDot1xTable, hpnicfOnuBindMacAddrTable=hpnicfOnuBindMacAddrTable, hpnicfOnuPriorityQueueBurstsizeMaxVal=hpnicfOnuPriorityQueueBurstsizeMaxVal, hpnicfOnuSlaManTable=hpnicfOnuSlaManTable, hpnicfOltPortAlarmRemoteStableEnabled=hpnicfOltPortAlarmRemoteStableEnabled, hpnicfEponOnuTypeManTable=hpnicfEponOnuTypeManTable, hpnicfOnuBatteryBackup=hpnicfOnuBatteryBackup, hpnicfEponOnuStpPortTable=hpnicfEponOnuStpPortTable, hpnicfOnuLinkTestTable=hpnicfOnuLinkTestTable, hpnicfEponMsgTimeOut=hpnicfEponMsgTimeOut, hpnicfEponMsgLoseNumMaxVal=hpnicfEponMsgLoseNumMaxVal, hpnicfOnuPOTSPortNumber=hpnicfOnuPOTSPortNumber, hpnicfOltDbaDiscoveryLengthMaxVal=hpnicfOltDbaDiscoveryLengthMaxVal, hpnicfEponOnuPowerOffTrap=hpnicfEponOnuPowerOffTrap, hpnicfEponOnuPortStpStateTrap=hpnicfEponOnuPortStpStateTrap, hpnicfOnuLinkTestResultMaxDelay=hpnicfOnuLinkTestResultMaxDelay, hpnicfOltLaserOnTimeMinVal=hpnicfOltLaserOnTimeMinVal, hpnicfOnuQueueMaxBandwidth=hpnicfOnuQueueMaxBandwidth, hpnicfOnuUpdateByTypeFileName=hpnicfOnuUpdateByTypeFileName, hpnicfEponStpPortState=hpnicfEponStpPortState, hpnicfEponOltSwitchoverTrap=hpnicfEponOltSwitchoverTrap, hpnicfOnuWorkMode=hpnicfOnuWorkMode, hpnicfEponOamDiscoveryTimeout=hpnicfEponOamDiscoveryTimeout, hpnicfOnuCountEntry=hpnicfOnuCountEntry, hpnicfOnuSilentTime=hpnicfOnuSilentTime, hpnicfEponOperationResult=hpnicfEponOperationResult, hpnicfEponOuiIndex=hpnicfEponOuiIndex, hpnicfOltPortAlarmOamDisconnectionEnabled=hpnicfOltPortAlarmOamDisconnectionEnabled, hpnicfOnuPacketManTable=hpnicfOnuPacketManTable, hpnicfOnuDbaReportTable=hpnicfOnuDbaReportTable, hpnicfOltPortAlarmFerDirect=hpnicfOltPortAlarmFerDirect, hpnicfEponDbaUpdateFileName=hpnicfEponDbaUpdateFileName, hpnicfEponLoopBackEnableRecoverTrap=hpnicfEponLoopBackEnableRecoverTrap, hpnicfEponOamVendorSpecificRecoverTrap=hpnicfEponOamVendorSpecificRecoverTrap, hpnicfOnuQueueSize=hpnicfOnuQueueSize, hpnicfOnuLinkTestFrameNumMinVal=hpnicfOnuLinkTestFrameNumMinVal, PYSNMP_MODULE_ID=hpnicfEponMibObjects, hpnicfEponBatchOperationBySlot=hpnicfEponBatchOperationBySlot, hpnicfEponTrapPrefix=hpnicfEponTrapPrefix, hpnicfOnuSecondPonRegState=hpnicfOnuSecondPonRegState, hpnicfEponOuiRowStatus=hpnicfEponOuiRowStatus, hpnicfDot3OamNonThresholdRecoverEvent=hpnicfDot3OamNonThresholdRecoverEvent, hpnicfOltPortAlarmEncryptionKeyEnabled=hpnicfOltPortAlarmEncryptionKeyEnabled, hpnicfOnuPhysicalEntry=hpnicfOnuPhysicalEntry, hpnicfOnuPriorityQueueTable=hpnicfOnuPriorityQueueTable, hpnicfOnuIgmpSnoopingRouterAgingT=hpnicfOnuIgmpSnoopingRouterAgingT, hpnicfEponOnuRegExcessTrap=hpnicfEponOnuRegExcessTrap, hpnicfOltSelfTestResult=hpnicfOltSelfTestResult, hpnicfEponMibObjects=hpnicfEponMibObjects, hpnicfOnuLinkTestEntry=hpnicfOnuLinkTestEntry, hpnicfOnuDhcpsnooping=hpnicfOnuDhcpsnooping, hpnicfEponFileName=hpnicfEponFileName, hpnicfOltMacAddress=hpnicfOltMacAddress, hpnicfEponBatchOperationMan=hpnicfEponBatchOperationMan, hpnicfOltSysManEntry=hpnicfOltSysManEntry, hpnicfEponStatTable=hpnicfEponStatTable, hpnicfOnuEncryptMan=hpnicfOnuEncryptMan, hpnicfOnuSlaMinBandWidthMinVal=hpnicfOnuSlaMinBandWidthMinVal, hpnicfEponAutoUpdateSchedStatus=hpnicfEponAutoUpdateSchedStatus, hpnicfOnuRS485StopBits=hpnicfOnuRS485StopBits, hpnicfEponOuiIndexNextEntry=hpnicfEponOuiIndexNextEntry, hpnicfEponErrorInfo=hpnicfEponErrorInfo, hpnicfEponMulticastControlEntry=hpnicfEponMulticastControlEntry, hpnicfOnuE1PortsNumber=hpnicfOnuE1PortsNumber, hpnicfEponPortAlarmFerTrap=hpnicfEponPortAlarmFerTrap, hpnicfOnuRS485TXOctets=hpnicfOnuRS485TXOctets, hpnicfEponOamVendorSpecificTrap=hpnicfEponOamVendorSpecificTrap, hpnicfEponMonitorCycleMinVal=hpnicfEponMonitorCycleMinVal, hpnicfOnuRS485SessionMaxNum=hpnicfOnuRS485SessionMaxNum, hpnicfOnuSlaBandWidthStepVal=hpnicfOnuSlaBandWidthStepVal, hpnicfOltUsingOnuIfIndex=hpnicfOltUsingOnuIfIndex, hpnicfOnuSmlkSwitchoverTrap=hpnicfOnuSmlkSwitchoverTrap, hpnicfOnuFirmwareUpdateEntry=hpnicfOnuFirmwareUpdateEntry, hpnicfOnuRS485SessionEntry=hpnicfOnuRS485SessionEntry, hpnicfOnuPriorityQueueBandwidthMinVal=hpnicfOnuPriorityQueueBandwidthMinVal, hpnicfEponLoopbackPortIndex=hpnicfEponLoopbackPortIndex, hpnicfEponAutoUpdateFileName=hpnicfEponAutoUpdateFileName, hpnicfOnuIpAddressMask=hpnicfOnuIpAddressMask, hpnicfOnuFirmwareVersion=hpnicfOnuFirmwareVersion, hpnicfOnuLinkTestResultMeanDelay=hpnicfOnuLinkTestResultMeanDelay, hpnicfOltDbaDiscoveryLengthMinVal=hpnicfOltDbaDiscoveryLengthMinVal, hpnicfOnuUniUpDownTrapStatus=hpnicfOnuUniUpDownTrapStatus, hpnicfOltSelfTest=hpnicfOltSelfTest, hpnicfEponSysMan=hpnicfEponSysMan, hpnicfOltFirmMajorVersion=hpnicfOltFirmMajorVersion, hpnicfOnuSysManEntry=hpnicfOnuSysManEntry, hpnicfEponStpPortIndex=hpnicfEponStpPortIndex, hpnicfOnuProtocolTable=hpnicfOnuProtocolTable, hpnicfOnuAccessVlan=hpnicfOnuAccessVlan, hpnicfOnuOpticalPowerReceivedByOlt=hpnicfOnuOpticalPowerReceivedByOlt, hpnicfOltDbaManTable=hpnicfOltDbaManTable, hpnicfOltDbaUpdate=hpnicfOltDbaUpdate, hpnicfOnuSlaPriorityClass=hpnicfOnuSlaPriorityClass, hpnicfEponOnuRegistrationErrRecoverTrap=hpnicfEponOnuRegistrationErrRecoverTrap, hpnicfOnuHostType=hpnicfOnuHostType, hpnicfOnuBandWidthTable=hpnicfOnuBandWidthTable, hpnicfOnuRS485SessionIndex=hpnicfOnuRS485SessionIndex, hpnicfOnuSmlkFirstPonRole=hpnicfOnuSmlkFirstPonRole, hpnicfOnuPortIsolateEnable=hpnicfOnuPortIsolateEnable, hpnicfEponErrorLLIDFrameTrap=hpnicfEponErrorLLIDFrameTrap, hpnicfOnuIgmpSnoopingHostAgingT=hpnicfOnuIgmpSnoopingHostAgingT, hpnicfOnuRS485TXErrOctets=hpnicfOnuRS485TXErrOctets, hpnicfOnuDbaReportQueueSetNumber=hpnicfOnuDbaReportQueueSetNumber, hpnicfEponBatchOperationByOLTType=hpnicfEponBatchOperationByOLTType, hpnicfEponStatBER=hpnicfEponStatBER, hpnicfOnuDbaReportThreshold=hpnicfOnuDbaReportThreshold, hpnicfOnuManageVID=hpnicfOnuManageVID, hpnicfEponSysManEntry=hpnicfEponSysManEntry, hpnicfEponStatFER=hpnicfEponStatFER, hpnicfOltPortAlarmBerDirect=hpnicfOltPortAlarmBerDirect, hpnicfOltDbaDiscoveryLength=hpnicfOltDbaDiscoveryLength, hpnicfOnuReset=hpnicfOnuReset, hpnicfEponOltDFERecoverTrap=hpnicfEponOltDFERecoverTrap, hpnicfEponStatEntry=hpnicfEponStatEntry, hpnicfOnuRS485Parity=hpnicfOnuRS485Parity, hpnicfOltPortAlarmThresholdTable=hpnicfOltPortAlarmThresholdTable, hpnicfOnuRS485FlowControl=hpnicfOnuRS485FlowControl, hpnicfOnuLinkTestDelay=hpnicfOnuLinkTestDelay, hpnicfOltDbaVersion=hpnicfOltDbaVersion, hpnicfEponPortAlarmBerRecoverTrap=hpnicfEponPortAlarmBerRecoverTrap, hpnicfEponSysHasEPONBoard=hpnicfEponSysHasEPONBoard, hpnicfOnuFecStatus=hpnicfOnuFecStatus, hpnicfOnuDot1xAccount=hpnicfOnuDot1xAccount, hpnicfOnuChipSetRevision=hpnicfOnuChipSetRevision, hpnicfOnuRS485PropertiesTable=hpnicfOnuRS485PropertiesTable, hpnicfOltUsingOnuNum=hpnicfOltUsingOnuNum, hpnicfOnuP2PMaxBandWidth=hpnicfOnuP2PMaxBandWidth, hpnicfOltPortAlarmThresholdEntry=hpnicfOltPortAlarmThresholdEntry, hpnicfOnuDbaReportQueueId=hpnicfOnuDbaReportQueueId, hpnicfEponOnuMan=hpnicfEponOnuMan, hpnicfOnuRS485SessionErrInfo=hpnicfOnuRS485SessionErrInfo, hpnicfOltHardMinorVersion=hpnicfOltHardMinorVersion)
mibBuilder.exportSymbols("HPN-ICF-EPON-MIB", hpnicfEponOuiValue=hpnicfEponOuiValue, hpnicfOltAgcCdrTime=hpnicfOltAgcCdrTime, hpnicfOnuCosToLocalPrecedenceValue=hpnicfOnuCosToLocalPrecedenceValue, hpnicfOnuCapabilityEntry=hpnicfOnuCapabilityEntry, hpnicfOamEventLogLocation=hpnicfOamEventLogLocation, hpnicfOnuUpdateByTypeRowStatus=hpnicfOnuUpdateByTypeRowStatus, hpnicfEponAutoUpdateSchedTime=hpnicfEponAutoUpdateSchedTime, hpnicfEponRemoteStableTrap=hpnicfEponRemoteStableTrap, hpnicfOltMaxRtt=hpnicfOltMaxRtt, hpnicfOnuCountTable=hpnicfOnuCountTable, hpnicfOnuDownstreamQueueNumber=hpnicfOnuDownstreamQueueNumber, hpnicfOnuPriorityQueueSizeMinVal=hpnicfOnuPriorityQueueSizeMinVal, hpnicfOnuPriorityTrust=hpnicfOnuPriorityTrust, hpnicfOnuEEPROMVersion=hpnicfOnuEEPROMVersion, hpnicfOnuSilentMacAddr=hpnicfOnuSilentMacAddr, hpnicfOnuBridgeMac=hpnicfOnuBridgeMac, hpnicfEponAutoUpdateRealTimeStatus=hpnicfEponAutoUpdateRealTimeStatus, hpnicfOnuLinkTestResultMinDelay=hpnicfOnuLinkTestResultMinDelay, hpnicfOnuSmlkEntry=hpnicfOnuSmlkEntry, hpnicfOnuIpAddressTable=hpnicfOnuIpAddressTable, hpnicfOnuSmlkSecondPonRole=hpnicfOnuSmlkSecondPonRole, hpnicfOnuMulticastFastLeaveEnable=hpnicfOnuMulticastFastLeaveEnable, hpnicfOnuGEPortNumber=hpnicfOnuGEPortNumber, hpnicfOnuRS485SessionLocalPort=hpnicfOnuRS485SessionLocalPort, hpnicfOnuPriorityQueueBurstsizeMinVal=hpnicfOnuPriorityQueueBurstsizeMinVal, hpnicfOnuDot1xPassword=hpnicfOnuDot1xPassword, hpnicfOnuChipSetInfoTable=hpnicfOnuChipSetInfoTable, hpnicfOltLaserOnTime=hpnicfOltLaserOnTime, hpnicfEponAutomaticMode=hpnicfEponAutomaticMode, hpnicfOltPortAlarmRegExcessEnabled=hpnicfOltPortAlarmRegExcessEnabled, hpnicfOnuPriorityQueueEntry=hpnicfOnuPriorityQueueEntry, hpnicfEponTrap=hpnicfEponTrap, hpnicfEponAutoAuthorize=hpnicfEponAutoAuthorize, hpnicfEponOnuAutoBindTrap=hpnicfEponOnuAutoBindTrap, hpnicfOnuMulticastFilterStatus=hpnicfOnuMulticastFilterStatus, hpnicfOnuQueueBandwidthEntry=hpnicfOnuQueueBandwidthEntry, hpnicfOnuIgmpSnoopingAggReportS=hpnicfOnuIgmpSnoopingAggReportS, hpnicfOltPortAlarmFerThreshold=hpnicfOltPortAlarmFerThreshold, hpnicfEponSlotIndex=hpnicfEponSlotIndex, hpnicfEponAutoUpdateSchedType=hpnicfEponAutoUpdateSchedType, hpnicfOnuSlaMinBandWidth=hpnicfOnuSlaMinBandWidth, hpnicfOnuLinkTestVlanTagID=hpnicfOnuLinkTestVlanTagID, hpnicfOnuHardMinorVersion=hpnicfOnuHardMinorVersion, hpnicfOnuDhcpsnoopingOption82=hpnicfOnuDhcpsnoopingOption82, hpnicfOnuMaxUpstreamQueuePerPort=hpnicfOnuMaxUpstreamQueuePerPort, hpnicfOltDbaCycleLength=hpnicfOltDbaCycleLength, hpnicfOnuUpdateResult=hpnicfOnuUpdateResult, hpnicfOnuLinkTestVlanPriority=hpnicfOnuLinkTestVlanPriority, hpnicfOnuUpdate=hpnicfOnuUpdate, hpnicfOltDbaEnabledType=hpnicfOltDbaEnabledType, hpnicfOnuDbaReportStatus=hpnicfOnuDbaReportStatus, hpnicfOnuFirmwareUpdateTable=hpnicfOnuFirmwareUpdateTable, hpnicfOnuUniMacType=hpnicfOnuUniMacType, hpnicfOnuP2PMaxBurstSize=hpnicfOnuP2PMaxBurstSize, hpnicfEponLoopBackEnableTrap=hpnicfEponLoopBackEnableTrap, hpnicfEponOltMan=hpnicfEponOltMan, hpnicfOnuBindMacAddrEntry=hpnicfOnuBindMacAddrEntry, hpnicfEponErrorLLIDFrameRecoverTrap=hpnicfEponErrorLLIDFrameRecoverTrap, hpnicfEponBatchOperationByOLT=hpnicfEponBatchOperationByOLT, hpnicfEponOnuTypeIndex=hpnicfEponOnuTypeIndex, hpnicfEponMsgLoseNum=hpnicfEponMsgLoseNum, hpnicfEponEncryptionNoReplyTimeOut=hpnicfEponEncryptionNoReplyTimeOut, hpnicfOnuCosToLocalPrecedenceTable=hpnicfOnuCosToLocalPrecedenceTable, hpnicfEponOnuUpdateResultTrap=hpnicfEponOnuUpdateResultTrap, hpnicfOnuP2PBandWidthPolicy=hpnicfOnuP2PBandWidthPolicy, hpnicfEponStpPortDescr=hpnicfEponStpPortDescr, hpnicfEponLocalStableTrap=hpnicfEponLocalStableTrap, hpnicfEponSysScalarGroup=hpnicfEponSysScalarGroup, hpnicfOltPortAlarmRegistrationEnabled=hpnicfOltPortAlarmRegistrationEnabled, hpnicfOltPortAlarmFer=hpnicfOltPortAlarmFer, hpnicfOnuSoftwareVersion=hpnicfOnuSoftwareVersion, hpnicfEponOamDisconnectionRecoverTrap=hpnicfEponOamDisconnectionRecoverTrap, hpnicfOltOpticalPowerTx=hpnicfOltOpticalPowerTx, hpnicfOnuOutDroppedFrames=hpnicfOnuOutDroppedFrames, hpnicfEponEncryptionKeyErrTrap=hpnicfEponEncryptionKeyErrTrap, hpnicfEponOuiIndexNext=hpnicfEponOuiIndexNext, hpnicfEponBatchOperationBySlotIndex=hpnicfEponBatchOperationBySlotIndex, hpnicfOltPortAlarmDFEEnabled=hpnicfOltPortAlarmDFEEnabled, hpnicfOnuUpdateFileName=hpnicfOnuUpdateFileName, hpnicfOnuRS485SessionSummaryEntry=hpnicfOnuRS485SessionSummaryEntry, hpnicfEponMsgLoseNumMinVal=hpnicfEponMsgLoseNumMinVal, hpnicfOltPortAlarmVendorSpecificEnabled=hpnicfOltPortAlarmVendorSpecificEnabled, hpnicfEponBatchOperationBySlotEntry=hpnicfEponBatchOperationBySlotEntry, hpnicfOltPortAlarmBerThreshold=hpnicfOltPortAlarmBerThreshold, hpnicfOnuDownStreamMaxBurstSize=hpnicfOnuDownStreamMaxBurstSize, hpnicfEponLocalStableRecoverTrap=hpnicfEponLocalStableRecoverTrap, hpnicfOnuRS485SerialIndex=hpnicfOnuRS485SerialIndex, hpnicfOnuRemoteFecStatus=hpnicfOnuRemoteFecStatus, hpnicfOnuLlid=hpnicfOnuLlid, hpnicfEponOnuTypeDescr=hpnicfEponOnuTypeDescr, hpnicfOnuHardMajorVersion=hpnicfOnuHardMajorVersion, hpnicfOnuDhcpallocate=hpnicfOnuDhcpallocate, hpnicfEponOamVersion=hpnicfEponOamVersion, hpnicfEponOnuRegistrationErrTrap=hpnicfEponOnuRegistrationErrTrap, hpnicfEponPortAlarmBerTrap=hpnicfEponPortAlarmBerTrap, hpnicfEponOnuRegExcessRecoverTrap=hpnicfEponOnuRegExcessRecoverTrap, hpnicfEponOnuRegErrorMacAddr=hpnicfEponOnuRegErrorMacAddr, hpnicfEponOnuLaserState=hpnicfEponOnuLaserState, hpnicfEponAutoUpdateEntry=hpnicfEponAutoUpdateEntry, hpnicfEponLoopbackPortDescr=hpnicfEponLoopbackPortDescr, hpnicfOltDbaManEntry=hpnicfOltDbaManEntry, hpnicfOltDbaUpdateResult=hpnicfOltDbaUpdateResult, hpnicfEponOnuLaserFailedTrap=hpnicfEponOnuLaserFailedTrap, hpnicfOnuMcastCtrlHostAgingTime=hpnicfOnuMcastCtrlHostAgingTime, hpnicfOltPortAlarmFerEnabled=hpnicfOltPortAlarmFerEnabled, hpnicfOltLaserOffTime=hpnicfOltLaserOffTime, hpnicfOnuRS485SessionNextIndex=hpnicfOnuRS485SessionNextIndex, hpnicfOnuMacAddrInfoTable=hpnicfOnuMacAddrInfoTable, hpnicfOnuMacAddrFlag=hpnicfOnuMacAddrFlag, hpnicfEponMulticastStatus=hpnicfEponMulticastStatus, hpnicfOnuIgmpSnoopingStatus=hpnicfOnuIgmpSnoopingStatus, hpnicfOnuIpAddressEntry=hpnicfOnuIpAddressEntry, hpnicfOnuManageVlanIntfS=hpnicfOnuManageVlanIntfS, hpnicfOnuIgmpSnoopingMaxRespT=hpnicfOnuIgmpSnoopingMaxRespT, hpnicfOnuP2PShortFrameFirst=hpnicfOnuP2PShortFrameFirst, hpnicfOltSysManTable=hpnicfOltSysManTable, hpnicfOnuLinkTestFrameNumMaxVal=hpnicfOnuLinkTestFrameNumMaxVal, hpnicfOnuVendorId=hpnicfOnuVendorId, hpnicfOnuSmlkTable=hpnicfOnuSmlkTable, hpnicfOnuChipSetInfoEntry=hpnicfOnuChipSetInfoEntry, hpnicfEponRemoteStableRecoverTrap=hpnicfEponRemoteStableRecoverTrap, hpnicfOnuServiceSupported=hpnicfOnuServiceSupported, hpnicfOnuEncryptKey=hpnicfOnuEncryptKey, hpnicfOltUsingOnuEntry=hpnicfOltUsingOnuEntry, hpnicfEponPortLoopBackAlmEnable=hpnicfEponPortLoopBackAlmEnable, hpnicfOnuQueueScheduler=hpnicfOnuQueueScheduler, hpnicfOnuMacIndex=hpnicfOnuMacIndex, hpnicfEponEncryptionKeyErrRecoverTrap=hpnicfEponEncryptionKeyErrRecoverTrap, hpnicfOnuSecondPonMac=hpnicfOnuSecondPonMac, hpnicfOnuIpAddressGateway=hpnicfOnuIpAddressGateway, hpnicfOnuProtocolEntry=hpnicfOnuProtocolEntry, hpnicfOnuRS485SessionSummaryTable=hpnicfOnuRS485SessionSummaryTable, hpnicfOnuBindMacAddress=hpnicfOnuBindMacAddress, hpnicfOnuMulticastControlMode=hpnicfOnuMulticastControlMode, hpnicfOnuCosToLocalPrecedenceEntry=hpnicfOnuCosToLocalPrecedenceEntry, hpnicfOnuLaserOnTime=hpnicfOnuLaserOnTime, hpnicfOnuFirmwareUpdateByTypeEntry=hpnicfOnuFirmwareUpdateByTypeEntry, hpnicfOnuDbaReportEntry=hpnicfOnuDbaReportEntry, hpnicfOnuRS485SessionErrInfoEntry=hpnicfOnuRS485SessionErrInfoEntry, hpnicfOamVendorSpecificAlarmCode=hpnicfOamVendorSpecificAlarmCode, hpnicfOnuRS485RXOctets=hpnicfOnuRS485RXOctets, hpnicfOnuSlaManEntry=hpnicfOnuSlaManEntry, hpnicfOnuPhysicalTable=hpnicfOnuPhysicalTable, hpnicfOltLaserOffTimeMaxVal=hpnicfOltLaserOffTimeMaxVal, hpnicfOltEnableDiscardPacket=hpnicfOltEnableDiscardPacket, hpnicfOnuRS485ResetStatistics=hpnicfOnuRS485ResetStatistics, hpnicfEponStat=hpnicfEponStat, hpnicfEponOnuUpdateFileName=hpnicfEponOnuUpdateFileName, hpnicfOnuStpStatus=hpnicfOnuStpStatus, hpnicfEponOnuSilenceTrap=hpnicfEponOnuSilenceTrap, hpnicfOltDbaCycleLengthMinVal=hpnicfOltDbaCycleLengthMinVal, hpnicfOnuDownStreamBandWidthPolicy=hpnicfOnuDownStreamBandWidthPolicy, hpnicfOnuMaxDownstreamQueuePerPort=hpnicfOnuMaxDownstreamQueuePerPort, hpnicfEponBatchOperationBySlotType=hpnicfEponBatchOperationBySlotType, hpnicfEponBatchOperationByOLTResult=hpnicfEponBatchOperationByOLTResult, hpnicfOnuSilentTable=hpnicfOnuSilentTable, hpnicfOnuDot1xEntry=hpnicfOnuDot1xEntry, hpnicfOnuPriorityQueueSizeMaxVal=hpnicfOnuPriorityQueueSizeMaxVal, hpnicfOnuIgmpSnoopingAggLeaveS=hpnicfOnuIgmpSnoopingAggLeaveS, hpnicfEponMulticastAddressList=hpnicfEponMulticastAddressList, hpnicfOnuQueueDirection=hpnicfOnuQueueDirection, hpnicfOnuSilentEntry=hpnicfOnuSilentEntry, hpnicfOnuFirstPonRegState=hpnicfOnuFirstPonRegState, hpnicfEponBatchOperationBySlotTable=hpnicfEponBatchOperationBySlotTable, hpnicfOnuRS485SessionErrInfoTable=hpnicfOnuRS485SessionErrInfoTable, hpnicfOltPortAlarmFerMaxVal=hpnicfOltPortAlarmFerMaxVal, hpnicfOnuRS485PropertiesEntry=hpnicfOnuRS485PropertiesEntry, hpnicfOltPortAlarmLlidMisFrames=hpnicfOltPortAlarmLlidMisFrames, hpnicfOnuSmlkSecondPonStatus=hpnicfOnuSmlkSecondPonStatus, hpnicfOnuSysManTable=hpnicfOnuSysManTable, hpnicfEponOnuTypeManEntry=hpnicfEponOnuTypeManEntry)
