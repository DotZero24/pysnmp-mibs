...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hp/HPN-ICF-EPON-MIB
...
mibBuilder.exportSymbols("HPN-ICF-EPON-MIB", hpnicfOnuSysManTable=hpnicfOnuSysManTable, hpnicfOnuAccessVlan=hpnicfOnuAccessVlan, hpnicfEponOnuStpPortEntry=hpnicfEponOnuStpPortEntry, hpnicfEponMibObjects=hpnicfEponMibObjects, hpnicfOnuPriorityQueueBandwidthMaxVal=hpnicfOnuPriorityQueueBandwidthMaxVal, hpnicfOnuUpdateByTypeNextIndex=hpnicfOnuUpdateByTypeNextIndex, hpnicfOnuIgspFastLeaveSupported=hpnicfOnuIgspFastLeaveSupported, hpnicfEponEncryptionNoReplyTimeOut=hpnicfEponEncryptionNoReplyTimeOut, hpnicfOnuIgmpSnoopingAggLeaveS=hpnicfOnuIgmpSnoopingAggLeaveS, hpnicfEponBatchOperationMan=hpnicfEponBatchOperationMan, hpnicfEponOnuUpdateResultTrap=hpnicfEponOnuUpdateResultTrap, hpnicfOnuPhysicalEntry=hpnicfOnuPhysicalEntry, hpnicfOnuReAuthorize=hpnicfOnuReAuthorize, hpnicfOnuLinkTestFrameNum=hpnicfOnuLinkTestFrameNum, hpnicfEponStpPortDescr=hpnicfEponStpPortDescr, hpnicfEponMsgTimeOut=hpnicfEponMsgTimeOut, hpnicfOnuRS485PropertiesEntry=hpnicfOnuRS485PropertiesEntry, hpnicfOnuRS485SessionEntry=hpnicfOnuRS485SessionEntry, hpnicfEponOnuStpPortTable=hpnicfEponOnuStpPortTable, hpnicfDot3OamThresholdRecoverEvent=hpnicfDot3OamThresholdRecoverEvent, hpnicfOltPortAlarmBerDirect=hpnicfOltPortAlarmBerDirect, hpnicfOnuOpticalPowerReceivedByOlt=hpnicfOnuOpticalPowerReceivedByOlt, hpnicfOnuP2PMaxBurstSize=hpnicfOnuP2PMaxBurstSize, hpnicfOnuMacIndex=hpnicfOnuMacIndex, hpnicfOnuDot1xEntry=hpnicfOnuDot1xEntry, hpnicfEponPortLoopBackAlmEnable=hpnicfEponPortLoopBackAlmEnable, hpnicfOnuLinkTestVlanTag=hpnicfOnuLinkTestVlanTag, hpnicfEponOnuAutoBindTrap=hpnicfEponOnuAutoBindTrap, hpnicfEponAutoAuthorize=hpnicfEponAutoAuthorize, hpnicfEponLoopBackEnableRecoverTrap=hpnicfEponLoopBackEnableRecoverTrap, hpnicfOnuIpAddress=hpnicfOnuIpAddress, hpnicfOnuFirmwareUpdateEntry=hpnicfOnuFirmwareUpdateEntry, hpnicfOnuInfoEntry=hpnicfOnuInfoEntry, hpnicfOltPortAlarmFer=hpnicfOltPortAlarmFer, hpnicfOnuSmlkTable=hpnicfOnuSmlkTable, hpnicfOltPortAlarmOamDisconnectionEnabled=hpnicfOltPortAlarmOamDisconnectionEnabled, hpnicfOltHardMinorVersion=hpnicfOltHardMinorVersion, hpnicfOltUsingOnuTable=hpnicfOltUsingOnuTable, hpnicfEponOuiIndexNext=hpnicfEponOuiIndexNext, hpnicfOnuProtocolEntry=hpnicfOnuProtocolEntry, hpnicfOnuPriorityQueueSizeMinVal=hpnicfOnuPriorityQueueSizeMinVal, hpnicfEponErrorLLIDFrameTrap=hpnicfEponErrorLLIDFrameTrap, hpnicfEponMulticastControlTable=hpnicfEponMulticastControlTable, hpnicfOnuDownStreamShortFrameFirst=hpnicfOnuDownStreamShortFrameFirst, hpnicfOltLaserOnTimeMinVal=hpnicfOltLaserOnTimeMinVal, hpnicfEponBatchOperationByOLTResult=hpnicfEponBatchOperationByOLTResult, hpnicfEponMsgTimeOutMinVal=hpnicfEponMsgTimeOutMinVal, hpnicfEponLocalStableTrap=hpnicfEponLocalStableTrap, hpnicfEponStatTable=hpnicfEponStatTable, hpnicfOnuUpdateResult=hpnicfOnuUpdateResult, hpnicfOltPortAlarmLlidMisMaxVal=hpnicfOltPortAlarmLlidMisMaxVal, hpnicfOnuSlaMinBandWidthMaxVal=hpnicfOnuSlaMinBandWidthMaxVal, hpnicfEponMulticastVlanId=hpnicfEponMulticastVlanId, hpnicfOnuQueuePolicyStatus=hpnicfOnuQueuePolicyStatus, hpnicfOnuMaxUpstreamQueuePerPort=hpnicfOnuMaxUpstreamQueuePerPort, hpnicfOnuE1PortsNumber=hpnicfOnuE1PortsNumber, hpnicfOnuSlaBandWidthStepVal=hpnicfOnuSlaBandWidthStepVal, hpnicfOnuIgmpSnoopingStatus=hpnicfOnuIgmpSnoopingStatus, hpnicfOltFirmMinorVersion=hpnicfOltFirmMinorVersion, hpnicfEponOuiIndexNextTable=hpnicfEponOuiIndexNextTable, hpnicfOltSelfTest=hpnicfOltSelfTest, hpnicfOnuLinkTestResultMinDelay=hpnicfOnuLinkTestResultMinDelay, hpnicfEponErrorInfo=hpnicfEponErrorInfo, hpnicfEponLoopBackEnableTrap=hpnicfEponLoopBackEnableTrap, hpnicfEponOnuSilenceRecoverTrap=hpnicfEponOnuSilenceRecoverTrap, hpnicfOnuGrantFifoDep=hpnicfOnuGrantFifoDep, hpnicfEponStatFER=hpnicfEponStatFER, hpnicfOltDbaCycleLength=hpnicfOltDbaCycleLength, hpnicfOltFirmMajorVersion=hpnicfOltFirmMajorVersion, hpnicfOnuDownstreamQueueNumber=hpnicfOnuDownstreamQueueNumber, hpnicfOltHardMajorVersion=hpnicfOltHardMajorVersion, hpnicfOnuProtocolTable=hpnicfOnuProtocolTable, hpnicfOltLaserOffTime=hpnicfOltLaserOffTime, hpnicfEponOuiEntry=hpnicfEponOuiEntry, hpnicfOnuRS485SessionSummaryTable=hpnicfOnuRS485SessionSummaryTable, hpnicfEponSoftwareErrTrap=hpnicfEponSoftwareErrTrap, hpnicfOnuPacketManEntry=hpnicfOnuPacketManEntry, hpnicfEponAutoUpdateEntry=hpnicfEponAutoUpdateEntry, PYSNMP_MODULE_ID=hpnicfEponMibObjects, hpnicfOnuCountTable=hpnicfOnuCountTable, hpnicfOltLaserOffTimeMaxVal=hpnicfOltLaserOffTimeMaxVal, hpnicfOnuServiceSupported=hpnicfOnuServiceSupported, hpnicfOltMacAddress=hpnicfOltMacAddress, hpnicfOnuPriorityTrust=hpnicfOnuPriorityTrust, hpnicfOnuDbaReportQueueSetNumber=hpnicfOnuDbaReportQueueSetNumber, hpnicfOnuPhysicalTable=hpnicfOnuPhysicalTable, hpnicfEponMsgLoseNum=hpnicfEponMsgLoseNum, hpnicfEponRemoteStableTrap=hpnicfEponRemoteStableTrap, hpnicfOnuLinkTestFrameNumMaxVal=hpnicfOnuLinkTestFrameNumMaxVal, hpnicfEponOnuSilenceTrap=hpnicfEponOnuSilenceTrap, hpnicfOltDbaEnabledType=hpnicfOltDbaEnabledType, hpnicfOnuRS485PropertiesTable=hpnicfOnuRS485PropertiesTable, hpnicfOnuUniMacType=hpnicfOnuUniMacType, hpnicfOamVendorSpecificAlarmCode=hpnicfOamVendorSpecificAlarmCode, hpnicfEponOamVendorSpecificTrap=hpnicfEponOamVendorSpecificTrap, hpnicfOnuSmlkGroupID=hpnicfOnuSmlkGroupID, hpnicfOnuPortIsolateEnable=hpnicfOnuPortIsolateEnable, hpnicfEponBatchOperationBySlotTable=hpnicfEponBatchOperationBySlotTable, hpnicfEponBatchOperationByOLTType=hpnicfEponBatchOperationByOLTType, hpnicfOltPortAlarmRemoteStableEnabled=hpnicfOltPortAlarmRemoteStableEnabled, hpnicfEponAutoUpdateSchedTime=hpnicfEponAutoUpdateSchedTime, hpnicfOltPortAlarmThresholdEntry=hpnicfOltPortAlarmThresholdEntry, hpnicfOltUsingOnuRowStatus=hpnicfOltUsingOnuRowStatus, hpnicfOnuRS485SessionSummaryEntry=hpnicfOnuRS485SessionSummaryEntry, hpnicfOnuRS485SessionMaxNum=hpnicfOnuRS485SessionMaxNum, hpnicfEponMulticastStatus=hpnicfEponMulticastStatus, hpnicfOnuBindMacAddrEntry=hpnicfOnuBindMacAddrEntry, hpnicfOnuMcastCtrlHostAgingTime=hpnicfOnuMcastCtrlHostAgingTime, hpnicfOnuRtt=hpnicfOnuRtt, hpnicfOnuSmlkSecondPonRole=hpnicfOnuSmlkSecondPonRole, hpnicfOnuLinkTestResultRetFrameNum=hpnicfOnuLinkTestResultRetFrameNum, hpnicfOnuDhcpsnooping=hpnicfOnuDhcpsnooping, hpnicfOltOpticalPowerRx=hpnicfOltOpticalPowerRx, hpnicfOnuSlaFixedBandWidth=hpnicfOnuSlaFixedBandWidth, hpnicfOnuDhcpallocate=hpnicfOnuDhcpallocate, hpnicfEponRemoteStableRecoverTrap=hpnicfEponRemoteStableRecoverTrap, hpnicfEponFileName=hpnicfEponFileName, hpnicfOltPortAlarmLlidMisFrames=hpnicfOltPortAlarmLlidMisFrames, hpnicfEponBatchOperationBySlotResult=hpnicfEponBatchOperationBySlotResult, hpnicfEponBatchOperationByOLTTable=hpnicfEponBatchOperationByOLTTable, hpnicfOltDbaDiscoveryLengthMaxVal=hpnicfOltDbaDiscoveryLengthMaxVal, hpnicfEponMsgTimeOutMaxVal=hpnicfEponMsgTimeOutMaxVal, hpnicfOnuSecondPonRegState=hpnicfOnuSecondPonRegState, hpnicfOltPortAlarmVendorSpecificEnabled=hpnicfOltPortAlarmVendorSpecificEnabled, hpnicfOnuSmlkEntry=hpnicfOnuSmlkEntry, hpnicfOnuRS485SessionRowStatus=hpnicfOnuRS485SessionRowStatus, hpnicfEponOnuRegErrorMacAddr=hpnicfEponOnuRegErrorMacAddr, hpnicfOnuBindMacAddrTable=hpnicfOnuBindMacAddrTable, hpnicfOnuBatteryBackup=hpnicfOnuBatteryBackup, hpnicfEponOnuLaserFailedTrap=hpnicfEponOnuLaserFailedTrap, hpnicfOnuSlaDelay=hpnicfOnuSlaDelay, hpnicfOnuQueueBandwidthTable=hpnicfOnuQueueBandwidthTable, hpnicfOnuRS485SessionRemotePort=hpnicfOnuRS485SessionRemotePort, hpnicfOnuUpdate=hpnicfOnuUpdate, hpnicfEponBatchOperationByOLT=hpnicfEponBatchOperationByOLT, hpnicfOnuFecStatus=hpnicfOnuFecStatus, hpnicfOnuSecondPonMac=hpnicfOnuSecondPonMac, hpnicfOnuFirmwareUpdateByTypeTable=hpnicfOnuFirmwareUpdateByTypeTable, hpnicfEponOnuRegExcessRecoverTrap=hpnicfEponOnuRegExcessRecoverTrap, hpnicfEponOnuUpdateFileName=hpnicfEponOnuUpdateFileName, hpnicfEponAutoUpdateFileName=hpnicfEponAutoUpdateFileName, hpnicfOnuLinkTestResultRetErrFrameNum=hpnicfOnuLinkTestResultRetErrFrameNum, hpnicfOnuRegType=hpnicfOnuRegType, hpnicfOnuDbaReportThreshold=hpnicfOnuDbaReportThreshold, hpnicfEponErrorLLIDFrameRecoverTrap=hpnicfEponErrorLLIDFrameRecoverTrap, hpnicfOltDbaUpdateResult=hpnicfOltDbaUpdateResult, hpnicfOnuMulticastFilterStatus=hpnicfOnuMulticastFilterStatus, hpnicfOnuReset=hpnicfOnuReset, hpnicfOnuMulticastFastLeaveEnable=hpnicfOnuMulticastFastLeaveEnable, hpnicfOnuSmlkFirstPonRole=hpnicfOnuSmlkFirstPonRole, hpnicfOnuMacAddrInfoEntry=hpnicfOnuMacAddrInfoEntry, hpnicfOnuCosToLocalPrecedenceTable=hpnicfOnuCosToLocalPrecedenceTable, hpnicfEponOuiTable=hpnicfEponOuiTable, hpnicfOnuP2PMaxBandWidth=hpnicfOnuP2PMaxBandWidth, hpnicfOnuMulticastControlMode=hpnicfOnuMulticastControlMode, hpnicfOnuRS485SessionIndex=hpnicfOnuRS485SessionIndex, hpnicfEponBatchOperationBySlotType=hpnicfEponBatchOperationBySlotType, hpnicfOnuRS485TXErrOctets=hpnicfOnuRS485TXErrOctets, hpnicfOnuFEPortNumber=hpnicfOnuFEPortNumber, hpnicfEponAutoUpdateSchedStatus=hpnicfEponAutoUpdateSchedStatus, hpnicfOltInfoTable=hpnicfOltInfoTable, hpnicfOnuHardMajorVersion=hpnicfOnuHardMajorVersion, hpnicfEponPortAlarmBerTrap=hpnicfEponPortAlarmBerTrap, hpnicfEponEncryptionUpdateTime=hpnicfEponEncryptionUpdateTime, hpnicfOltPortAlarmBerEnabled=hpnicfOltPortAlarmBerEnabled, hpnicfOnuLinkTestFrameNumMinVal=hpnicfOnuLinkTestFrameNumMinVal, hpnicfOnuRS485SessionTable=hpnicfOnuRS485SessionTable, hpnicfOltPortAlarmThresholdTable=hpnicfOltPortAlarmThresholdTable, hpnicfEponOltSwitchoverTrap=hpnicfEponOltSwitchoverTrap, hpnicfOnuDot1xAccount=hpnicfOnuDot1xAccount, hpnicfOnuSlaFixedPacketSize=hpnicfOnuSlaFixedPacketSize, hpnicfOnuLinkTestVlanPriority=hpnicfOnuLinkTestVlanPriority, hpnicfOnuLinkTestResultMeanDelay=hpnicfOnuLinkTestResultMeanDelay, hpnicfEponOamVendorSpecificRecoverTrap=hpnicfEponOamVendorSpecificRecoverTrap, hpnicfOnuIgmpSnoopingRouterAgingT=hpnicfOnuIgmpSnoopingRouterAgingT, hpnicfOnuSilentTable=hpnicfOnuSilentTable, hpnicfOnuVendorId=hpnicfOnuVendorId, hpnicfOltPortAlarmFerMinVal=hpnicfOltPortAlarmFerMinVal, hpnicfEponAutoBindStatus=hpnicfEponAutoBindStatus, hpnicfEponSlotIndex=hpnicfEponSlotIndex, hpnicfOnuDistance=hpnicfOnuDistance, hpnicfOnuChipSetRevision=hpnicfOnuChipSetRevision, hpnicfOltLaserOnTime=hpnicfOltLaserOnTime, hpnicfEponTrapPrefix=hpnicfEponTrapPrefix, hpnicfOnuChipSetDesignDate=hpnicfOnuChipSetDesignDate, hpnicfOnuRS485SerialIndex=hpnicfOnuRS485SerialIndex, hpnicfOltPortAlarmFerMaxVal=hpnicfOltPortAlarmFerMaxVal, hpnicfOnuBandWidthEntry=hpnicfOnuBandWidthEntry, hpnicfOnuIgmpSnoopingMaxRespT=hpnicfOnuIgmpSnoopingMaxRespT, hpnicfEponOnuTypeManEntry=hpnicfEponOnuTypeManEntry, hpnicfOltAgcCdrTime=hpnicfOltAgcCdrTime, hpnicfOnuSlaMaxBandWidth=hpnicfOnuSlaMaxBandWidth, hpnicfEponSoftwareErrorCode=hpnicfEponSoftwareErrorCode, hpnicfOltSysManTable=hpnicfOltSysManTable, hpnicfOnuMCtrlFastLeaveSupported=hpnicfOnuMCtrlFastLeaveSupported, hpnicfOnuPriorityQueueBurstsizeMinVal=hpnicfOnuPriorityQueueBurstsizeMinVal, hpnicfOltDbaDiscoveryLength=hpnicfOltDbaDiscoveryLength, hpnicfOnuDot1xTable=hpnicfOnuDot1xTable, hpnicfOnuChipSetVendorId=hpnicfOnuChipSetVendorId, hpnicfOnuSlaMinBandWidthMinVal=hpnicfOnuSlaMinBandWidthMinVal, hpnicfEponOnuRegExcessTrap=hpnicfEponOnuRegExcessTrap, hpnicfEponOltDFERecoverTrap=hpnicfEponOltDFERecoverTrap, hpnicfOltEnableDiscardPacket=hpnicfOltEnableDiscardPacket, hpnicfOnuLlid=hpnicfOnuLlid, hpnicfOnuFirstPonRegState=hpnicfOnuFirstPonRegState, hpnicfOltPortAlarmBerMinVal=hpnicfOltPortAlarmBerMinVal, hpnicfEponOnuRegSilentMac=hpnicfEponOnuRegSilentMac, hpnicfOnuQueueBandwidthEntry=hpnicfOnuQueueBandwidthEntry, hpnicfOnuFirmwareUpdateByTypeEntry=hpnicfOnuFirmwareUpdateByTypeEntry, hpnicfOnuUpdateByTypeFileName=hpnicfOnuUpdateByTypeFileName, hpnicfOltPortAlarmLlidMismatchThreshold=hpnicfOltPortAlarmLlidMismatchThreshold, hpnicfOnuDownStreamBandWidthPolicy=hpnicfOnuDownStreamBandWidthPolicy, hpnicfEponSysManTable=hpnicfEponSysManTable, hpnicfOltDbaManTable=hpnicfOltDbaManTable, hpnicfOnuDownStreamHighPriorityFirst=hpnicfOnuDownStreamHighPriorityFirst, hpnicfOnuRS485SessionLocalPort=hpnicfOnuRS485SessionLocalPort, hpnicfOnuIpAddressTable=hpnicfOnuIpAddressTable, hpnicfOltPortAlarmFerThreshold=hpnicfOltPortAlarmFerThreshold, hpnicfOltDbaCycleLengthMinVal=hpnicfOltDbaCycleLengthMinVal, hpnicfOnuFirmwareVersion=hpnicfOnuFirmwareVersion, hpnicfOltLaserOnTimeMaxVal=hpnicfOltLaserOnTimeMaxVal, hpnicfOnuUpdateByTypeRowStatus=hpnicfOnuUpdateByTypeRowStatus, hpnicfOnuManageVlanIntfS=hpnicfOnuManageVlanIntfS, hpnicfOnuLinkTestFrameSize=hpnicfOnuLinkTestFrameSize, hpnicfOnuRS485SessionAddType=hpnicfOnuRS485SessionAddType, hpnicfEponAutoUpdateRealTimeStatus=hpnicfEponAutoUpdateRealTimeStatus, hpnicfOltMultiCopyBrdCast=hpnicfOltMultiCopyBrdCast, hpnicfOnuQueueScheduler=hpnicfOnuQueueScheduler, hpnicfOnuPriorityQueueBandwidthMinVal=hpnicfOnuPriorityQueueBandwidthMinVal, hpnicfOnuPacketManTable=hpnicfOnuPacketManTable, hpnicfEponOltDFETrap=hpnicfEponOltDFETrap, hpnicfOnuRS485SessionErrInfoEntry=hpnicfOnuRS485SessionErrInfoEntry, hpnicfEponOperationResult=hpnicfEponOperationResult, hpnicfOnuDhcpsnoopingOption82=hpnicfOnuDhcpsnoopingOption82, hpnicfOnuFirmwareUpdateTable=hpnicfOnuFirmwareUpdateTable, hpnicfOnuDbaReportStatus=hpnicfOnuDbaReportStatus, hpnicfOnuQueueMaxBandwidth=hpnicfOnuQueueMaxBandwidth, hpnicfOamEventLogType=hpnicfOamEventLogType, hpnicfEponOamVersion=hpnicfEponOamVersion, hpnicfOnuSlaManEntry=hpnicfOnuSlaManEntry, hpnicfOnuGEPortNumber=hpnicfOnuGEPortNumber, hpnicfOnuPriorityQueueBurstsizeMaxVal=hpnicfOnuPriorityQueueBurstsizeMaxVal, hpnicfEponOnuTypeManTable=hpnicfEponOnuTypeManTable, hpnicfOnuRS485DataBits=hpnicfOnuRS485DataBits, hpnicfOnuDownStreamMaxBandWidth=hpnicfOnuDownStreamMaxBandWidth, hpnicfOnuIpAddressEntry=hpnicfOnuIpAddressEntry, hpnicfEponOnuTypeIndex=hpnicfEponOnuTypeIndex, hpnicfEponSysManEntry=hpnicfEponSysManEntry, hpnicfOnuManageVID=hpnicfOnuManageVID, hpnicfOamEventLogLocation=hpnicfOamEventLogLocation, hpnicfEponOnuPortStpStateTrap=hpnicfEponOnuPortStpStateTrap, hpnicfOnuSlaManTable=hpnicfOnuSlaManTable, hpnicfOnuLinkTestResultSentFrameNum=hpnicfOnuLinkTestResultSentFrameNum, hpnicfOnuUniUpDownTrapStatus=hpnicfOnuUniUpDownTrapStatus)
mibBuilder.exportSymbols("HPN-ICF-EPON-MIB", hpnicfEponMsgLoseNumMaxVal=hpnicfEponMsgLoseNumMaxVal, hpnicfEponOnuRegistrationErrTrap=hpnicfEponOnuRegistrationErrTrap, hpnicfEponOnuRegistrationErrRecoverTrap=hpnicfEponOnuRegistrationErrRecoverTrap, hpnicfEponDbaUpdateFileName=hpnicfEponDbaUpdateFileName, hpnicfOnuCosToLocalPrecedenceCosIndex=hpnicfOnuCosToLocalPrecedenceCosIndex, hpnicfEponBatchOperationBySlotEntry=hpnicfEponBatchOperationBySlotEntry, hpnicfOltDbaDiscovryFrequency=hpnicfOltDbaDiscovryFrequency, hpnicfOnuRS485Parity=hpnicfOnuRS485Parity, hpnicfOltDbaDiscovryFrequencyMaxVal=hpnicfOltDbaDiscovryFrequencyMaxVal, hpnicfEponSysScalarGroup=hpnicfEponSysScalarGroup, hpnicfOnuP2PHighPriorityFirst=hpnicfOnuP2PHighPriorityFirst, hpnicfEponBatchOperationByOLTEntry=hpnicfEponBatchOperationByOLTEntry, hpnicfOnuPriorityQueueSizeMaxVal=hpnicfOnuPriorityQueueSizeMaxVal, hpnicfEponStpPortIndex=hpnicfEponStpPortIndex, hpnicfOltLaserOffTimeMinVal=hpnicfOltLaserOffTimeMinVal, hpnicfEponAutomaticMode=hpnicfEponAutomaticMode, hpnicfEponEncryptionKeyErrTrap=hpnicfEponEncryptionKeyErrTrap, hpnicfOnuCosToLocalPrecedenceEntry=hpnicfOnuCosToLocalPrecedenceEntry, hpnicfEponMsgLoseNumMinVal=hpnicfEponMsgLoseNumMinVal, hpnicfOnuOutDroppedFrames=hpnicfOnuOutDroppedFrames, hpnicfOltDbaUpdate=hpnicfOltDbaUpdate, hpnicfOnuSilentTime=hpnicfOnuSilentTime, hpnicfOnuBindType=hpnicfOnuBindType, hpnicfEponPortAlarmFerRecoverTrap=hpnicfEponPortAlarmFerRecoverTrap, hpnicfOnuBandWidthTable=hpnicfOnuBandWidthTable, hpnicfOnuLaserOnTime=hpnicfOnuLaserOnTime, hpnicfEponOamDisconnectionRecoverTrap=hpnicfEponOamDisconnectionRecoverTrap, hpnicfOnuSlaMaxBandWidthMinVal=hpnicfOnuSlaMaxBandWidthMinVal, hpnicfEponOnuMan=hpnicfEponOnuMan, hpnicfEponOuiIndexNextEntry=hpnicfEponOuiIndexNextEntry, hpnicfOnuRS485SessionType=hpnicfOnuRS485SessionType, hpnicfOnuSlaPriorityClass=hpnicfOnuSlaPriorityClass, hpnicfOltPortAlarmFerDirect=hpnicfOltPortAlarmFerDirect, hpnicfOltInfoEntry=hpnicfOltInfoEntry, hpnicfEponMulticastControlEntry=hpnicfEponMulticastControlEntry, hpnicfOltPortAlarmBerMaxVal=hpnicfOltPortAlarmBerMaxVal, hpnicfEponStatEntry=hpnicfEponStatEntry, hpnicfOnuFirstPonMac=hpnicfOnuFirstPonMac, hpnicfOltWorkMode=hpnicfOltWorkMode, hpnicfEponPortAlarmFerTrap=hpnicfEponPortAlarmFerTrap, hpnicfOnuBindMacAddress=hpnicfOnuBindMacAddress, hpnicfEponOamDisconnectionTrap=hpnicfEponOamDisconnectionTrap, hpnicfOltPortAlarmDFEEnabled=hpnicfOltPortAlarmDFEEnabled, hpnicfEponOnuTypeDescr=hpnicfEponOnuTypeDescr, hpnicfEponOuiRowStatus=hpnicfEponOuiRowStatus, hpnicfEponBatchOperationBySlotIndex=hpnicfEponBatchOperationBySlotIndex, hpnicfOltDbaManEntry=hpnicfOltDbaManEntry, hpnicfEponOuiValue=hpnicfEponOuiValue, hpnicfOnuPOTSPortNumber=hpnicfOnuPOTSPortNumber, hpnicfEponOnuScalarGroup=hpnicfEponOnuScalarGroup, hpnicfOnuMacAddress=hpnicfOnuMacAddress, hpnicfOnuUpdateFileName=hpnicfOnuUpdateFileName, hpnicfOltSelfTestResult=hpnicfOltSelfTestResult, hpnicfDot3OamNonThresholdRecoverEvent=hpnicfDot3OamNonThresholdRecoverEvent, hpnicfOnuPortBerStatus=hpnicfOnuPortBerStatus, hpnicfOnuIpAddressMask=hpnicfOnuIpAddressMask, hpnicfOnuRS485ResetStatistics=hpnicfOnuRS485ResetStatistics, hpnicfEponMonitorCycleMaxVal=hpnicfEponMonitorCycleMaxVal, hpnicfOnuSmlkSwitchoverTrap=hpnicfOnuSmlkSwitchoverTrap, hpnicfEponEncryptionKeyErrRecoverTrap=hpnicfEponEncryptionKeyErrRecoverTrap, hpnicfOltPortAlarmRegExcessEnabled=hpnicfOltPortAlarmRegExcessEnabled, hpnicfOnuDbaReportTable=hpnicfOnuDbaReportTable, hpnicfOnuLinkTestResultMaxDelay=hpnicfOnuLinkTestResultMaxDelay, hpnicfOnuEncryptMan=hpnicfOnuEncryptMan, hpnicfEponLoopbackPortIndex=hpnicfEponLoopbackPortIndex, hpnicfOnuChipSetInfoEntry=hpnicfOnuChipSetInfoEntry, hpnicfEponPortAlarmBerRecoverTrap=hpnicfEponPortAlarmBerRecoverTrap, hpnicfOnuQueueMaxBurstsize=hpnicfOnuQueueMaxBurstsize, hpnicfEponOltSoftwareErrAlmEnable=hpnicfEponOltSoftwareErrAlmEnable, hpnicfEponOamDiscoveryTimeout=hpnicfEponOamDiscoveryTimeout, hpnicfOnuLinkTestTable=hpnicfOnuLinkTestTable, hpnicfOnuIgmpSnoopingHostAgingT=hpnicfOnuIgmpSnoopingHostAgingT, hpnicfOnuQueueId=hpnicfOnuQueueId, hpnicfEponStpPortState=hpnicfEponStpPortState, hpnicfOnuEEPROMVersion=hpnicfOnuEEPROMVersion, hpnicfEponMonitorCycleMinVal=hpnicfEponMonitorCycleMinVal, hpnicfEponSoftwareErrRecoverTrap=hpnicfEponSoftwareErrRecoverTrap, hpnicfOnuUpstreamQueueNumber=hpnicfOnuUpstreamQueueNumber, hpnicfOnuP2PBandWidthPolicy=hpnicfOnuP2PBandWidthPolicy, hpnicfOnuPriorityQueueEntry=hpnicfOnuPriorityQueueEntry, hpnicfEponAutoUpdateTable=hpnicfEponAutoUpdateTable, hpnicfOnuWorkMode=hpnicfOnuWorkMode, hpnicfOnuLinkTestEntry=hpnicfOnuLinkTestEntry, hpnicfOnuMacAddrFlag=hpnicfOnuMacAddrFlag, hpnicfOnuDbaReportEntry=hpnicfOnuDbaReportEntry, hpnicfOnuRS485RXErrOctets=hpnicfOnuRS485RXErrOctets, hpnicfOltSysManEntry=hpnicfOltSysManEntry, hpnicfOnuCapabilityTable=hpnicfOnuCapabilityTable, hpnicfOnuRS485SessionErrInfoTable=hpnicfOnuRS485SessionErrInfoTable, hpnicfOnuSlaMinBandWidth=hpnicfOnuSlaMinBandWidth, hpnicfOltPortAlarmBer=hpnicfOltPortAlarmBer, hpnicfOnuIpAddressGateway=hpnicfOnuIpAddressGateway, hpnicfEponStatBER=hpnicfEponStatBER, hpnicfOnuDot1xPassword=hpnicfOnuDot1xPassword, hpnicfOnuRS485SessionRemoteIP=hpnicfOnuRS485SessionRemoteIP, hpnicfOnuLinkTestVlanTagID=hpnicfOnuLinkTestVlanTagID, hpnicfEponStat=hpnicfEponStat, hpnicfEponSysMan=hpnicfEponSysMan, hpnicfEponAutoUpdateSchedType=hpnicfEponAutoUpdateSchedType, hpnicfEponModeSwitch=hpnicfEponModeSwitch, hpnicfOnuSilentMacAddr=hpnicfOnuSilentMacAddr, hpnicfOltUsingOnuIfIndex=hpnicfOltUsingOnuIfIndex, hpnicfOnuMaxDownstreamQueuePerPort=hpnicfOnuMaxDownstreamQueuePerPort, hpnicfOnuCountEntry=hpnicfOnuCountEntry, hpnicfOnuLaserOffTime=hpnicfOnuLaserOffTime, hpnicfOnuPriorityQueueTable=hpnicfOnuPriorityQueueTable, hpnicfOnuRS485StopBits=hpnicfOnuRS485StopBits, hpnicfEponMonitorCycleEnable=hpnicfEponMonitorCycleEnable, hpnicfEponBatchOperationBySlot=hpnicfEponBatchOperationBySlot, hpnicfOnuUpdateByTypeOnuType=hpnicfOnuUpdateByTypeOnuType, hpnicfOnuP2PShortFrameFirst=hpnicfOnuP2PShortFrameFirst, hpnicfOnuStpStatus=hpnicfOnuStpStatus, hpnicfOnuMacAddrInfoTable=hpnicfOnuMacAddrInfoTable, hpnicfOnuQueueDirection=hpnicfOnuQueueDirection, hpnicfEponMulticastAddressList=hpnicfEponMulticastAddressList, hpnicfOltPortAlarmFerEnabled=hpnicfOltPortAlarmFerEnabled, hpnicfOnuRemoteFecStatus=hpnicfOnuRemoteFecStatus, hpnicfOnuRS485TXOctets=hpnicfOnuRS485TXOctets, hpnicfEponLocalStableRecoverTrap=hpnicfEponLocalStableRecoverTrap, hpnicfOnuSoftwareVersion=hpnicfOnuSoftwareVersion, hpnicfOnuPCBVersion=hpnicfOnuPCBVersion, hpnicfOnuSmlkFirstPonStatus=hpnicfOnuSmlkFirstPonStatus, hpnicfOnuSysManEntry=hpnicfOnuSysManEntry, hpnicfOltPortAlarmRegistrationEnabled=hpnicfOltPortAlarmRegistrationEnabled, hpnicfEponOltMan=hpnicfEponOltMan, hpnicfOltUsingOnuEntry=hpnicfOltUsingOnuEntry, hpnicfEponMonitorCycle=hpnicfEponMonitorCycle, hpnicfOnuChipSetModel=hpnicfOnuChipSetModel, hpnicfOnuBridgeMac=hpnicfOnuBridgeMac, hpnicfEponOuiIndex=hpnicfEponOuiIndex, hpnicfOnuSilentEntry=hpnicfOnuSilentEntry, hpnicfOnuInCRCErrPkts=hpnicfOnuInCRCErrPkts, hpnicfEponOnuPowerOffTrap=hpnicfEponOnuPowerOffTrap, hpnicfOnuRS485SessionErrInfo=hpnicfOnuRS485SessionErrInfo, hpnicfEponOnuLaserState=hpnicfEponOnuLaserState, hpnicfOnuPppoe=hpnicfOnuPppoe, hpnicfOnuSlaMaxBandWidthMaxVal=hpnicfOnuSlaMaxBandWidthMaxVal, hpnicfOnuCosToLocalPrecedenceValue=hpnicfOnuCosToLocalPrecedenceValue, hpnicfOltPortAlarmBerThreshold=hpnicfOltPortAlarmBerThreshold, hpnicfOnuQueueSize=hpnicfOnuQueueSize, hpnicfOnuChipSetInfoTable=hpnicfOnuChipSetInfoTable, hpnicfOnuRS485RXOctets=hpnicfOnuRS485RXOctets, hpnicfOltUsingOnuNum=hpnicfOltUsingOnuNum, hpnicfOltAgcLockTime=hpnicfOltAgcLockTime, hpnicfEponTrap=hpnicfEponTrap, hpnicfOnuUpdateByOnuTypeIndex=hpnicfOnuUpdateByOnuTypeIndex, hpnicfOnuDbaReportQueueId=hpnicfOnuDbaReportQueueId, hpnicfOltPortAlarmLocalStableEnabled=hpnicfOltPortAlarmLocalStableEnabled, hpnicfOnuHostType=hpnicfOnuHostType, hpnicfOltDbaVersion=hpnicfOltDbaVersion, hpnicfEponSysHasEPONBoard=hpnicfEponSysHasEPONBoard, hpnicfOltPortAlarmLlidMismatchEnabled=hpnicfOltPortAlarmLlidMismatchEnabled, hpnicfOltDbaCycleLengthMaxVal=hpnicfOltDbaCycleLengthMaxVal, hpnicfOnuIgmpSnoopingAggReportS=hpnicfOnuIgmpSnoopingAggReportS, hpnicfOnuDownStreamMaxBurstSize=hpnicfOnuDownStreamMaxBurstSize, hpnicfOltDbaDiscoveryLengthMinVal=hpnicfOltDbaDiscoveryLengthMinVal, hpnicfOltDbaDiscovryFrequencyMinVal=hpnicfOltDbaDiscovryFrequencyMinVal, hpnicfOltMaxRtt=hpnicfOltMaxRtt, hpnicfOnuLinkTestDelay=hpnicfOnuLinkTestDelay, hpnicfOnuCapabilityEntry=hpnicfOnuCapabilityEntry, hpnicfEponLoopbackPortDescr=hpnicfEponLoopbackPortDescr, hpnicfOnuSmlkSecondPonStatus=hpnicfOnuSmlkSecondPonStatus, hpnicfOltOpticalPowerTx=hpnicfOltOpticalPowerTx, hpnicfOnuHardMinorVersion=hpnicfOnuHardMinorVersion, hpnicfOnuRS485SessionNextIndex=hpnicfOnuRS485SessionNextIndex, hpnicfOltPortAlarmLlidMisMinVal=hpnicfOltPortAlarmLlidMisMinVal, hpnicfOltPortAlarmEncryptionKeyEnabled=hpnicfOltPortAlarmEncryptionKeyEnabled, hpnicfOnuInfoTable=hpnicfOnuInfoTable, hpnicfOnuEncryptKey=hpnicfOnuEncryptKey, hpnicfOnuRS485FlowControl=hpnicfOnuRS485FlowControl, hpnicfOnuRS485BaudRate=hpnicfOnuRS485BaudRate)
