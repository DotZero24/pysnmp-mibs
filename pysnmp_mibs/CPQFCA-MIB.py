...
# Notes
# -----
# ASN.1 source file://mibs/hp/CPQFCA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:38:32 2025
...
class _CpqFcaHostCntlrPciLocation_Type(DisplayString):
    """Custom type cpqFcaHostCntlrPciLocation based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqFcaHostCntlrPciLocation_Type.__name__ = "DisplayString"
_CpqFcaHostCntlrPciLocation_Object = MibTableColumn
cpqFcaHostCntlrPciLocation = _CpqFcaHostCntlrPciLocation_Object(
    (1, 3, 6, 1, 4, 1, 232, 16, 2, 7, 1, 1, 15),
    _CpqFcaHostCntlrPciLocation_Type()
)
cpqFcaHostCntlrPciLocation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqFcaHostCntlrPciLocation.setStatus("optional")
...
mibBuilder.exportSymbols(
    ...
    **{"cpqFcaLogDrvStatusChange": cpqFcaLogDrvStatusChange,
       ...
       "cpqFcaHostCntlrPciLocation": cpqFcaHostCntlrPciLocation,
