...
mibBuilder.exportSymbols("CPQFCA-MIB", cpqFcaCntlrEntry=cpqFcaCntlrEntry, cpqFcSwitchWorldWidePortName=cpqFcSwitchWorldWidePortName, cpqFcaPhyDrvHotPlugs=cpqFcaPhyDrvHotPlugs, cpqFcaInterface=cpqFcaInterface, cpqFcaSpareDrv=cpqFcaSpareDrv, cpqFcaHostCntlr=cpqFcaHostCntlr, cpqFcaPhyDrvMediaErrs=cpqFcaPhyDrvMediaErrs, cpqFcaPhyDrvBadTargetErrs=cpqFcaPhyDrvBadTargetErrs, cpqFcaHostCntlrSerialNumber=cpqFcaHostCntlrSerialNumber, cpqFcaLogDrvPhyDrvIDs=cpqFcaLogDrvPhyDrvIDs, cpqFca2CntlrStatusChange=cpqFca2CntlrStatusChange, cpqFcaPhyDrvNegotiatedLinkRate=cpqFcaPhyDrvNegotiatedLinkRate, cpqFcTapeDriveCleanTapeRepl=cpqFcTapeDriveCleanTapeRepl, cpqFcaSpareReplacedDrvBusNumber=cpqFcaSpareReplacedDrvBusNumber, cpqFcSwitchWorldWideNodeName=cpqFcSwitchWorldWideNodeName, cpqFcaMibRevMinor=cpqFcaMibRevMinor, cpqFcaPhyDrvTable=cpqFcaPhyDrvTable, cpqExtArrRsrcVolTable=cpqExtArrRsrcVolTable, cpqFcTapeDriveEntry=cpqFcTapeDriveEntry, cpqFcaLogDrvIndex=cpqFcaLogDrvIndex, cpqFcTapeLibraryScsiBus=cpqFcTapeLibraryScsiBus, cpqFcaPhyDrvFunctTest2=cpqFcaPhyDrvFunctTest2, cpqFcTapeCountersTotalErrors=cpqFcTapeCountersTotalErrors, cpqFcTapeDriveCleanTapeReplace=cpqFcTapeDriveCleanTapeReplace, cpqFcaAccelBadData=cpqFcaAccelBadData, cpqFcTapeCntlrStatus=cpqFcTapeCntlrStatus, cpqFca2PhyDrvStatusChange=cpqFca2PhyDrvStatusChange, cpqFcaPhyDrvThrSpinupTime=cpqFcaPhyDrvThrSpinupTime, cpqFcaPhyDrvHWrites=cpqFcaPhyDrvHWrites, cpqFcaCntlrFWRev=cpqFcaCntlrFWRev, cpqFcTapeDriveScsiBus=cpqFcTapeDriveScsiBus, cpqFcaPhyDrvSeekErrs=cpqFcaPhyDrvSeekErrs, cpqFcTapeCntlrTable=cpqFcTapeCntlrTable, cpqFcaPhyDrvSeeks=cpqFcaPhyDrvSeeks, cpqFcaPhyDrvThrUsedReallocs=cpqFcaPhyDrvThrUsedReallocs, cpqFcaCntlrSerialNumber=cpqFcaCntlrSerialNumber, cpqFcaLogDrvStatus=cpqFcaLogDrvStatus, cpqFcTapeCntlrEntry=cpqFcTapeCntlrEntry, cpqExtArrRsrcVolFreeActiveSpace=cpqExtArrRsrcVolFreeActiveSpace, cpqFcTapeLibraryScsiLun=cpqFcTapeLibraryScsiLun, cpqFcaCntlr=cpqFcaCntlr, cpqFcaAccelTotalMemory=cpqFcaAccelTotalMemory, cpqFcTapeDriveCleaningRequired=cpqFcTapeDriveCleaningRequired, cpqFcTapeCountersEntry=cpqFcTapeCountersEntry, cpqFcaPhyDrvCurrentWidth=cpqFcaPhyDrvCurrentWidth, cpqExtArrRsrcVolEntry=cpqExtArrRsrcVolEntry, cpqFcTapeLibrarySerialNumber=cpqFcTapeLibrarySerialNumber, cpqFcaSparePercentRebuild=cpqFcaSparePercentRebuild, cpqFcaPhyDrvSpinUpErrs=cpqFcaPhyDrvSpinUpErrs, cpqFcaCntlrProductRev=cpqFcaCntlrProductRev, cpqFcaOsCommonModuleTable=cpqFcaOsCommonModuleTable, cpqFcaSpareReplacedDrvBay=cpqFcaSpareReplacedDrvBay, cpqExtArrSnapshotIndex=cpqExtArrSnapshotIndex, cpqFcaHostCntlrFirmwareVersion=cpqFcaHostCntlrFirmwareVersion, cpqFcTapeCntlrStatusChange=cpqFcTapeCntlrStatusChange, cpqFcaHostCntlrPciLocation=cpqFcaHostCntlrPciLocation, cpqFcaPhyDrvThr=cpqFcaPhyDrvThr, cpqFcaSpareBoxIndex=cpqFcaSpareBoxIndex, cpqFcaSpareEntry=cpqFcaSpareEntry, cpqFcaSpareBusNumber=cpqFcaSpareBusNumber, cpqFcSwitchChassisIndex=cpqFcSwitchChassisIndex, cpqExtArrRsrcVolFreeNewSpace=cpqExtArrRsrcVolFreeNewSpace, cpqFcaCntlrActive=cpqFcaCntlrActive, cpqFcaPhyDrvStatus=cpqFcaPhyDrvStatus, cpqFcaLogDrvHasAccel=cpqFcaLogDrvHasAccel, cpqFcaPhyDrvSpinupTime=cpqFcaPhyDrvSpinupTime, cpqFcaPhyDrvRecvReadErrs=cpqFcaPhyDrvRecvReadErrs, cpqFcaPhyDrvIndex=cpqFcaPhyDrvIndex, cpqFcTapeLibraryStatus=cpqFcTapeLibraryStatus, cpqFcSwitchFibreConnectStatus=cpqFcSwitchFibreConnectStatus, cpqFcTapeCountersScsiBus=cpqFcTapeCountersScsiBus, cpqFcaPhyDrvBusNumber=cpqFcaPhyDrvBusNumber, cpqFcaLogDrvStripeSize=cpqFcaLogDrvStripeSize, cpqFcTapeCntlrIndex=cpqFcTapeCntlrIndex, cpqFcaMibRev=cpqFcaMibRev, cpqFca2AccelBadDataTrap=cpqFca2AccelBadDataTrap, cpqFcaSpareStatus=cpqFcaSpareStatus, cpqFcTapeLibraryModel=cpqFcTapeLibraryModel, cpqFcaHostCntlrTapeCntlrList=cpqFcaHostCntlrTapeCntlrList, cpqFcaMibCondition=cpqFcaMibCondition, cpqFcaLogDrvPercentRebuild=cpqFcaLogDrvPercentRebuild, cpqFcaPhyDrvOtherTimeouts=cpqFcaPhyDrvOtherTimeouts, cpqFcaPhyDrvWrites=cpqFcaPhyDrvWrites, cpqFcTapeCountersScsiLun=cpqFcTapeCountersScsiLun, cpqFcTapeDriveFWSubtype=cpqFcTapeDriveFWSubtype, cpqExtArrRsrcVolTotalSpace=cpqExtArrRsrcVolTotalSpace, cpqExtArrRsrcVolSourceVolumeId=cpqExtArrRsrcVolSourceVolumeId, cpqFcaCntlrBoxIoSlot=cpqFcaCntlrBoxIoSlot, cpqFcaPhyDrvRefHours=cpqFcaPhyDrvRefHours, cpqFcaPhyDrvPreFailMonitoring=cpqFcaPhyDrvPreFailMonitoring, cpqFcaCntlrStatusChange=cpqFcaCntlrStatusChange, cpqFcaHostCntlrEntry=cpqFcaHostCntlrEntry, cpqFcTapeLibraryEntry=cpqFcTapeLibraryEntry, cpqFcaOsCommonPollFreq=cpqFcaOsCommonPollFreq, cpqFcTapeCntlrType=cpqFcTapeCntlrType, cpqFcTapeDriveType=cpqFcTapeDriveType, cpqFcaAccelBatteryFailed=cpqFcaAccelBatteryFailed, cpqFcaAccelStatus=cpqFcaAccelStatus, cpqFcTapeDriveCntlrIndex=cpqFcTapeDriveCntlrIndex, cpqFcaLogDrvPreferredPath=cpqFcaLogDrvPreferredPath, cpqFcaCntlrRedundancyError=cpqFcaCntlrRedundancyError, cpqFcaMibRevMajor=cpqFcaMibRevMajor, cpqFcaAccelBadDataTrap=cpqFcaAccelBadDataTrap, cpqFcaPhyDrvUsedReallocs=cpqFcaPhyDrvUsedReallocs, cpqFcaPhyDrvHardwareErrs=cpqFcaPhyDrvHardwareErrs, cpqFcTapeCntlrModel=cpqFcTapeCntlrModel, cpqExtArrSnapshotDateTime=cpqExtArrSnapshotDateTime, cpqFcaPhyDrvPhyCount=cpqFcaPhyDrvPhyCount, cpqFcTapeComponent=cpqFcTapeComponent, cpqFcTapeDriveCurrentWidth=cpqFcTapeDriveCurrentWidth, cpqFcTapeLibraryOverallCondition=cpqFcTapeLibraryOverallCondition, cpqFcTapeCountersTable=cpqFcTapeCountersTable, cpqFcSwitchNetworkLinkStatus=cpqFcSwitchNetworkLinkStatus, cpqFcTapeCountersCntlrIndex=cpqFcTapeCountersCntlrIndex, cpqFcaPhyDrvFunctTest3=cpqFcaPhyDrvFunctTest3, cpqExtArrSnapshotTable=cpqExtArrSnapshotTable, cpqFcaPhyDrvUnsupportedDrive=cpqFcaPhyDrvUnsupportedDrive, cpqFcTapeDriveModel=cpqFcTapeDriveModel, cpqFcTapeCntlrCondition=cpqFcTapeCntlrCondition, cpqFcTapeCntlrFWRev=cpqFcTapeCntlrFWRev, cpqFcaPhyDrvThrTable=cpqFcaPhyDrvThrTable, cpqFca2AccelBatteryFailed=cpqFca2AccelBatteryFailed, cpqFcaLogDrvTable=cpqFcaLogDrvTable, cpqFcaAccelReadErrs=cpqFcaAccelReadErrs, cpqFcaCntlrRebuildPriority=cpqFcaCntlrRebuildPriority, cpqFcTapeLibraryCntlrIndex=cpqFcTapeLibraryCntlrIndex, cpqFcaPhyDrvHotPlug=cpqFcaPhyDrvHotPlug, cpqFcaOsCommonModuleVersion=cpqFcaOsCommonModuleVersion, cpqFcTapeLibraryStatusChange=cpqFcTapeLibraryStatusChange, cpqFcaCntlrCurrentRole=cpqFcaCntlrCurrentRole, cpqFcSwitchTable=cpqFcSwitchTable, cpqFcaPhyDrvCurrentSpeed=cpqFcaPhyDrvCurrentSpeed, cpqFcSwitchLocation=cpqFcSwitchLocation, cpqFcaPhyDrvBadRecvReads=cpqFcaPhyDrvBadRecvReads, cpqFcaAccelStatusChange=cpqFcaAccelStatusChange, cpqFcTapeCountersTotalBytes=cpqFcTapeCountersTotalBytes, cpqFcaPhyDrvHReads=cpqFcaPhyDrvHReads, cpqFcaAccelCondition=cpqFcaAccelCondition, cpqFcSwitchIndex=cpqFcSwitchIndex, cpqFcTapeLibraryDoorStatus=cpqFcTapeLibraryDoorStatus, cpqFcaPhyDrvSataVersion=cpqFcaPhyDrvSataVersion, cpqFcaCntlrCondition=cpqFcaCntlrCondition, cpqFcTapeLibraryStatMoves=cpqFcTapeLibraryStatMoves, cpqFcaAccelWriteCache=cpqFcaAccelWriteCache, cpqFcTapeDriveLibraryDrive=cpqFcTapeDriveLibraryDrive, cpqFca2HostCntlrStatusChange=cpqFca2HostCntlrStatusChange, cpqFcaLogDrvSnapshotSourceDrvIndex=cpqFcaLogDrvSnapshotSourceDrvIndex, cpqFcaAccelTable=cpqFcaAccelTable, cpqFcaHostCntlrStatus=cpqFcaHostCntlrStatus, cpqFcTapeDrive=cpqFcTapeDrive, cpqExtArrSnapshotMounted=cpqExtArrSnapshotMounted, cpqFcaCntlrRedundancyType=cpqFcaCntlrRedundancyType, cpqFcaCntlrWorldWideNodeName=cpqFcaCntlrWorldWideNodeName, cpqFcaPhyDrvThrViUsedReallocs=cpqFcaPhyDrvThrViUsedReallocs, cpqFcSwitchName=cpqFcSwitchName, cpqExtArrSnapshot=cpqExtArrSnapshot, cpqExtTapeDriveCleaningRequired=cpqExtTapeDriveCleaningRequired, cpqFcaSpareCondition=cpqFcaSpareCondition, cpqFcaPhyDrvSmartStatus=cpqFcaPhyDrvSmartStatus, cpqExtArrSnapshotAccess=cpqExtArrSnapshotAccess, cpqFcTapeLibraryDriveList=cpqFcTapeLibraryDriveList, cpqFcaHostCntlrIndex=cpqFcaHostCntlrIndex, cpqFcTapeLibraryLastError=cpqFcTapeLibraryLastError, cpqFcaPhyDrvLocationString=cpqFcaPhyDrvLocationString, cpqFcTapeCntlrSerialNumber=cpqFcTapeCntlrSerialNumber, cpqExtArrRsrcVolBoxIndex=cpqExtArrRsrcVolBoxIndex, cpqFcSwitchIpGateway=cpqFcSwitchIpGateway, cpqFcaLogDrvAutoRel=cpqFcaLogDrvAutoRel, cpqFcaAccelReadCache=cpqFcaAccelReadCache, cpqFcTapeDriveCondition=cpqFcTapeDriveCondition, cpqFcaCntlrBlinkTime=cpqFcaCntlrBlinkTime, cpqFcaPhyDrvThrFunctTest1=cpqFcaPhyDrvThrFunctTest1, cpqFcTapeLibraryStatHours=cpqFcTapeLibraryStatHours, cpqFcaPhyDrvThrViFunctTest2=cpqFcaPhyDrvThrViFunctTest2, cpqExtArrRsrcVolStatus=cpqExtArrRsrcVolStatus, cpqFcaOsCommonModulePurpose=cpqFcaOsCommonModulePurpose, cpqExtArrSnapshotEntry=cpqExtArrSnapshotEntry, cpqFcaHostCntlrStatusChange=cpqFcaHostCntlrStatusChange, cpqFcaSpareLocationString=cpqFcaSpareLocationString, cpqFcaPhyDrvPlacement=cpqFcaPhyDrvPlacement, cpqExtArrSnapshotUsedSpace=cpqExtArrSnapshotUsedSpace, cpqFcSwitchChassisSlot=cpqFcSwitchChassisSlot, cpqFcaPhyDrvThrFunctTest2=cpqFcaPhyDrvThrFunctTest2, cpqFcTapeDriveScsiTarget=cpqFcTapeDriveScsiTarget, cpqFcTapeCounters=cpqFcTapeCounters, cpqExtArrSnapshotBoxIndex=cpqExtArrSnapshotBoxIndex, cpqFcSwitchComponent=cpqFcSwitchComponent, cpqFcaPhyDrvCondition=cpqFcaPhyDrvCondition, cpqFcTapeLibraryTable=cpqFcTapeLibraryTable, cpqFcaOsCommon=cpqFcaOsCommon, cpqFcaPhyDrvThrViSpinupTime=cpqFcaPhyDrvThrViSpinupTime, cpqFcaLogDrvSize=cpqFcaLogDrvSize, cpqFcaLogDrvOsName=cpqFcaLogDrvOsName, cpqFcaPhyDrvThrViFunctTest1=cpqFcaPhyDrvThrViFunctTest1, cpqFcaPhyDrvThrEntry=cpqFcaPhyDrvThrEntry, cpqFcTapeLibraryDoorStatusChange=cpqFcTapeLibraryDoorStatusChange, cpqExtArrSnapshotRsrcVolIndex=cpqExtArrSnapshotRsrcVolIndex, cpqFcSwitchFWRev=cpqFcSwitchFWRev, cpqFcaOsCommonModuleName=cpqFcaOsCommonModuleName, cpqFcTapeLibraryScsiTarget=cpqFcTapeLibraryScsiTarget, cpqFcTapeDriveSerialNumber=cpqFcTapeDriveSerialNumber, cpqFcaSpareTable=cpqFcaSpareTable, cpqFcaCntlrTable=cpqFcaCntlrTable, cpqFcaPhyDrvRotationalSpeed=cpqFcaPhyDrvRotationalSpeed, cpqFcaHostCntlrWorldWideName=cpqFcaHostCntlrWorldWideName, cpqFcTapeDriveFWRev=cpqFcTapeDriveFWRev, cpqFcTapeDriveCurrentSpeed=cpqFcTapeDriveCurrentSpeed, cpqFcaPhyDrvHardReadErrs=cpqFcaPhyDrvHardReadErrs, cpqFcaLogDrv=cpqFcaLogDrv, cpqFcaPhyDrvHSeeks=cpqFcaPhyDrvHSeeks, cpqFcaPhyDrvBlinkTime=cpqFcaPhyDrvBlinkTime, cpqFcaPhyDrvSize=cpqFcaPhyDrvSize, cpqFcaCntlrModel=cpqFcaCntlrModel, cpqFcaPhyDrvStatusChange=cpqFcaPhyDrvStatusChange, cpqFcaLogDrvSpareReplaceMap=cpqFcaLogDrvSpareReplaceMap, cpqFcTapeDriveScsiLun=cpqFcTapeDriveScsiLun, cpqFcaPhyDrvHSeekErrs=cpqFcaPhyDrvHSeekErrs, cpqFcaPhyDrvBadRecvWrites=cpqFcaPhyDrvBadRecvWrites, cpqFcaPhyDrvAbortedCmds=cpqFcaPhyDrvAbortedCmds, cpqFcaLogDrvRebuildingPhyDrv=cpqFcaLogDrvRebuildingPhyDrv, cpqFcaPhyDrvBoxConnector=cpqFcaPhyDrvBoxConnector, cpqFcaHostCntlrHwLocation=cpqFcaHostCntlrHwLocation, cpqFcaLogDrvBlinkTime=cpqFcaLogDrvBlinkTime, cpqFcTapeCountersReReads=cpqFcTapeCountersReReads, cpqFcTapeLibraryFWRev=cpqFcTapeLibraryFWRev, cpqFcaLogDrvBoxIndex=cpqFcaLogDrvBoxIndex, cpqFcTapeLibraryHotSwap=cpqFcTapeLibraryHotSwap, cpqFcTapeDriveBay=cpqFcTapeDriveBay, cpqFcaCntlrStatus=cpqFcaCntlrStatus, cpqFcaHostCntlrStorBoxList=cpqFcaHostCntlrStorBoxList, cpqFibreArray=cpqFibreArray, cpqFcaAccelFailedBatteries=cpqFcaAccelFailedBatteries, cpqFcTapeLibraryTemperature=cpqFcTapeLibraryTemperature, cpqFcaPhyDrvReads=cpqFcaPhyDrvReads, cpqExtArrRsrcVolDisabledInstances=cpqExtArrRsrcVolDisabledInstances, cpqFcaPhyDrvEntry=cpqFcaPhyDrvEntry, cpqFcSwitchIpSubnet=cpqFcSwitchIpSubnet, cpqFcTapeDriveTable=cpqFcTapeDriveTable, cpqFcaAccelBoxIoSlot=cpqFcaAccelBoxIoSlot, cpqFcaAccelEntry=cpqFcaAccelEntry, cpqFcaHostCntlrOverallCondition=cpqFcaHostCntlrOverallCondition, cpqFcaAccelWriteErrs=cpqFcaAccelWriteErrs, cpqFcTapeLibraryRedundancy=cpqFcTapeLibraryRedundancy, cpqFcaAccelSerialNumber=cpqFcaAccelSerialNumber, cpqFcaPhyDrvBusFaults=cpqFcaPhyDrvBusFaults, cpqFcTapeCntlrOverallCondition=cpqFcTapeCntlrOverallCondition, cpqFcaPhyDrvFormatErrs=cpqFcaPhyDrvFormatErrs, cpqFcTapeCountersScsiTarget=cpqFcTapeCountersScsiTarget, cpqFcaPhyDrvThrFunctTest3=cpqFcaPhyDrvThrFunctTest3, cpqFcaOsCommonModuleDate=cpqFcaOsCommonModuleDate, cpqFcaHostCntlrModel=cpqFcaHostCntlrModel, cpqFcTapeLibrary=cpqFcTapeLibrary, cpqFcaOsCommonModuleIndex=cpqFcaOsCommonModuleIndex, cpqFcaPhyDrvHardWriteErrs=cpqFcaPhyDrvHardWriteErrs)
mibBuilder.exportSymbols("CPQFCA-MIB", cpqFcaSparePhyDrvIndex=cpqFcaSparePhyDrvIndex, cpqFcaPhyDrvBay=cpqFcaPhyDrvBay, cpqFcaPhyDrvSerialNum=cpqFcaPhyDrvSerialNum, cpqExtTapeDriveStatusChange=cpqExtTapeDriveStatusChange, cpqFcaHostCntlrSlot=cpqFcaHostCntlrSlot, cpqFcaPhyDrvFWRev=cpqFcaPhyDrvFWRev, cpqFcTapeDriveCleanTapeCount=cpqFcTapeDriveCleanTapeCount, cpqExtArrSnapshotType=cpqExtArrSnapshotType, cpqFcaSpareBay=cpqFcaSpareBay, cpqFcaLogDrvEntry=cpqFcaLogDrvEntry, cpqFcaAccelErrCode=cpqFcaAccelErrCode, cpqExtArrSnapshotInstance=cpqExtArrSnapshotInstance, cpqFcaPhyDrvThrViFunctTest3=cpqFcaPhyDrvThrViFunctTest3, cpqFcTapeCntlrWWN=cpqFcTapeCntlrWWN, cpqExtArrRsrcVolVolumeId=cpqExtArrRsrcVolVolumeId, cpqFcaHostCntlrWorldWidePortName=cpqFcaHostCntlrWorldWidePortName, cpqExtTapeLibraryDoorStatusChange=cpqExtTapeLibraryDoorStatusChange, cpqFcaLogDrvFaultTol=cpqFcaLogDrvFaultTol, cpqExtArrayLogDrvStatusChange=cpqExtArrayLogDrvStatusChange, cpqFcaAccelBatteryStatus=cpqFcaAccelBatteryStatus, cpqFcaPhyDrv=cpqFcaPhyDrv, cpqFca3HostCntlrStatusChange=cpqFca3HostCntlrStatusChange, cpqFcTapeDriveStatusChange=cpqFcTapeDriveStatusChange, cpqFcSwitchIpAddress=cpqFcSwitchIpAddress, cpqFcTapeLibraryCondition=cpqFcTapeLibraryCondition, cpqFcaCntlrBoxIndex=cpqFcaCntlrBoxIndex, cpqFcaPhyDrvBoxIndex=cpqFcaPhyDrvBoxIndex, cpqFcTapeDriveCleanReq=cpqFcTapeDriveCleanReq, cpqFcaPhyDrvType=cpqFcaPhyDrvType, cpqFcaHostCntlrOptionRomVersion=cpqFcaHostCntlrOptionRomVersion, cpqFcSwitchEntry=cpqFcSwitchEntry, cpqFcTapeDriveHotPlug=cpqFcTapeDriveHotPlug, cpqFcaPhyDrvFailureCode=cpqFcaPhyDrvFailureCode, cpqExtArrRsrcVolAllowCreation=cpqExtArrRsrcVolAllowCreation, cpqFcTapeLibraryLocation=cpqFcTapeLibraryLocation, cpqFca2AccelStatusChange=cpqFca2AccelStatusChange, cpqFcaCntlrExpandPriority=cpqFcaCntlrExpandPriority, cpqFcaPhyDrvThrBoxIndex=cpqFcaPhyDrvThrBoxIndex, cpqExtArrRsrcVol=cpqExtArrRsrcVol, cpqFcTapeCountersTotalUncorrectable=cpqFcTapeCountersTotalUncorrectable, cpqFcaPhyDrvThrIndex=cpqFcaPhyDrvThrIndex, cpqExtArrRsrcVolIndex=cpqExtArrRsrcVolIndex, cpqFcaLogDrvCondition=cpqFcaLogDrvCondition, cpqFcaLogDrvCurrentPath=cpqFcaLogDrvCurrentPath, cpqFcaLogDrvStatusChange=cpqFcaLogDrvStatusChange, cpqExtTapeLibraryStatusChange=cpqExtTapeLibraryStatusChange, cpqFcaPhyDrvNotReadyErrs=cpqFcaPhyDrvNotReadyErrs, cpqFcTapeDriveLocation=cpqFcTapeDriveLocation, cpqFcTapeCntlr=cpqFcTapeCntlr, cpqFcSwitch=cpqFcSwitch, cpqFcaLogDrvAvailSpares=cpqFcaLogDrvAvailSpares, cpqFcaHostCntlrTable=cpqFcaHostCntlrTable, cpqFcTapeCountersReWrites=cpqFcTapeCountersReWrites, cpqFcaHostCntlrCondition=cpqFcaHostCntlrCondition, cpqFcaPhyDrvHasMonInfo=cpqFcaPhyDrvHasMonInfo, cpqFcaPhyDrvBoxOnConnector=cpqFcaPhyDrvBoxOnConnector, cpqFcaComponent=cpqFcaComponent, cpqFcTapeDriveStatus=cpqFcTapeDriveStatus, cpqExtTapeDriveCleanTapeReplace=cpqExtTapeDriveCleanTapeReplace, cpqFcaSpareStatusChange=cpqFcaSpareStatusChange, cpqFcaLogDrvSnapshotResourceDrvIndex=cpqFcaLogDrvSnapshotResourceDrvIndex, cpqFcaCntlrWorldWideName=cpqFcaCntlrWorldWideName, cpqFcaOsCommonModuleEntry=cpqFcaOsCommonModuleEntry, cpqFcaPhyDrvModel=cpqFcaPhyDrvModel, cpqFcaPhyDrvFunctTest1=cpqFcaPhyDrvFunctTest1, cpqFcaAccelBoxIndex=cpqFcaAccelBoxIndex, cpqExtArrRsrcVolActiveInstances=cpqExtArrRsrcVolActiveInstances, cpqFcaPhyDrvRecvWriteErrs=cpqFcaPhyDrvRecvWriteErrs)
