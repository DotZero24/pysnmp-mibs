...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hp/CPQFCA-MIB
...
cpqSsChassisTime, cpqSsChassisName = mibBuilder.importSymbols("CPQSTSYS-MIB", "cpqSsChassisTime", "cpqSsChassisName")
...
cpqFcaHostCntlrPciLocation = MibTableColumn((1, 3, 6, 1, 4, 1, 232, 16, 2, 7, 1, 1, 15), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 255))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("CPQFCA-MIB", cpqFcTapeCntlrOverallCondition=cpqFcTapeCntlrOverallCondition, cpqFcaPhyDrv=cpqFcaPhyDrv, cpqFcaPhyDrvThrFunctTest2=cpqFcaPhyDrvThrFunctTest2, cpqFcTapeDriveFWRev=cpqFcTapeDriveFWRev, cpqFcaCntlrExpandPriority=cpqFcaCntlrExpandPriority, cpqFcaPhyDrvThrSpinupTime=cpqFcaPhyDrvThrSpinupTime, cpqFcaOsCommonModuleDate=cpqFcaOsCommonModuleDate, cpqFcTapeLibraryStatHours=cpqFcTapeLibraryStatHours, cpqFcaAccelWriteErrs=cpqFcaAccelWriteErrs, cpqExtArrRsrcVolTotalSpace=cpqExtArrRsrcVolTotalSpace, cpqFcTapeDriveCleanTapeCount=cpqFcTapeDriveCleanTapeCount, cpqFcaPhyDrvReads=cpqFcaPhyDrvReads, cpqFcaSpareReplacedDrvBay=cpqFcaSpareReplacedDrvBay, cpqFcaAccelBatteryFailed=cpqFcaAccelBatteryFailed, cpqFcaOsCommonModuleEntry=cpqFcaOsCommonModuleEntry, cpqFcaPhyDrvBoxIndex=cpqFcaPhyDrvBoxIndex, cpqFcTapeCounters=cpqFcTapeCounters, cpqFcSwitchFibreConnectStatus=cpqFcSwitchFibreConnectStatus, cpqFcaSparePhyDrvIndex=cpqFcaSparePhyDrvIndex, cpqFcaSpareBusNumber=cpqFcaSpareBusNumber, cpqFcTapeCntlrEntry=cpqFcTapeCntlrEntry, cpqFcaLogDrvSpareReplaceMap=cpqFcaLogDrvSpareReplaceMap, cpqExtArrayLogDrvStatusChange=cpqExtArrayLogDrvStatusChange, cpqFcaPhyDrvBlinkTime=cpqFcaPhyDrvBlinkTime, cpqFcTapeCntlrFWRev=cpqFcTapeCntlrFWRev, cpqFcaPhyDrvPlacement=cpqFcaPhyDrvPlacement, cpqFcaPhyDrvFormatErrs=cpqFcaPhyDrvFormatErrs, cpqFcaLogDrvOsName=cpqFcaLogDrvOsName, cpqFcTapeCountersTotalUncorrectable=cpqFcTapeCountersTotalUncorrectable, cpqFcaPhyDrvHardWriteErrs=cpqFcaPhyDrvHardWriteErrs, cpqFcaHostCntlrStatus=cpqFcaHostCntlrStatus, cpqExtArrSnapshotDateTime=cpqExtArrSnapshotDateTime, cpqFcTapeCountersTotalErrors=cpqFcTapeCountersTotalErrors, cpqFcaHostCntlrModel=cpqFcaHostCntlrModel, cpqExtArrRsrcVolBoxIndex=cpqExtArrRsrcVolBoxIndex, cpqFcaPhyDrvHasMonInfo=cpqFcaPhyDrvHasMonInfo, cpqExtArrSnapshotUsedSpace=cpqExtArrSnapshotUsedSpace, cpqFcaSpareTable=cpqFcaSpareTable, cpqFcaHostCntlr=cpqFcaHostCntlr, cpqExtTapeLibraryDoorStatusChange=cpqExtTapeLibraryDoorStatusChange, cpqFcaLogDrvIndex=cpqFcaLogDrvIndex, cpqFcaCntlrProductRev=cpqFcaCntlrProductRev, cpqFcTapeDriveScsiTarget=cpqFcTapeDriveScsiTarget, cpqFcSwitchIpAddress=cpqFcSwitchIpAddress, cpqFcaPhyDrvOtherTimeouts=cpqFcaPhyDrvOtherTimeouts, cpqFca3HostCntlrStatusChange=cpqFca3HostCntlrStatusChange, cpqExtArrRsrcVolEntry=cpqExtArrRsrcVolEntry, cpqFcSwitchChassisIndex=cpqFcSwitchChassisIndex, cpqFcaLogDrvAvailSpares=cpqFcaLogDrvAvailSpares, cpqFcTapeCntlrIndex=cpqFcTapeCntlrIndex, cpqFcaPhyDrvSerialNum=cpqFcaPhyDrvSerialNum, cpqFcTapeDriveCleanReq=cpqFcTapeDriveCleanReq, cpqFcaHostCntlrTapeCntlrList=cpqFcaHostCntlrTapeCntlrList, cpqFcSwitchName=cpqFcSwitchName, cpqFcTapeComponent=cpqFcTapeComponent, cpqFcTapeDriveCleanTapeRepl=cpqFcTapeDriveCleanTapeRepl, cpqFcaPhyDrvHWrites=cpqFcaPhyDrvHWrites, cpqFcTapeLibraryDoorStatusChange=cpqFcTapeLibraryDoorStatusChange, cpqFcaHostCntlrFirmwareVersion=cpqFcaHostCntlrFirmwareVersion, cpqFcaAccelReadCache=cpqFcaAccelReadCache, cpqFcaLogDrvEntry=cpqFcaLogDrvEntry, cpqFcTapeCountersReWrites=cpqFcTapeCountersReWrites, cpqFcaPhyDrvHotPlug=cpqFcaPhyDrvHotPlug, cpqFcaHostCntlrIndex=cpqFcaHostCntlrIndex, cpqFcaLogDrvSnapshotSourceDrvIndex=cpqFcaLogDrvSnapshotSourceDrvIndex, cpqFcaMibRevMinor=cpqFcaMibRevMinor, cpqFcaPhyDrvBadTargetErrs=cpqFcaPhyDrvBadTargetErrs, cpqFcTapeDriveSerialNumber=cpqFcTapeDriveSerialNumber, cpqFcaCntlrEntry=cpqFcaCntlrEntry, cpqFcaAccelWriteCache=cpqFcaAccelWriteCache, cpqFcaAccelErrCode=cpqFcaAccelErrCode, cpqFcaCntlrFWRev=cpqFcaCntlrFWRev, cpqFca2AccelStatusChange=cpqFca2AccelStatusChange, cpqFcTapeDriveCurrentWidth=cpqFcTapeDriveCurrentWidth, cpqFcTapeDriveScsiBus=cpqFcTapeDriveScsiBus, cpqFcTapeLibraryLastError=cpqFcTapeLibraryLastError, cpqFcaPhyDrvThrIndex=cpqFcaPhyDrvThrIndex, cpqFcaPhyDrvThrUsedReallocs=cpqFcaPhyDrvThrUsedReallocs, cpqFcaCntlrStatus=cpqFcaCntlrStatus, cpqFcaPhyDrvRecvReadErrs=cpqFcaPhyDrvRecvReadErrs, cpqFcaPhyDrvThrTable=cpqFcaPhyDrvThrTable, cpqFcaCntlrSerialNumber=cpqFcaCntlrSerialNumber, cpqFcaHostCntlrCondition=cpqFcaHostCntlrCondition, cpqExtArrRsrcVolTable=cpqExtArrRsrcVolTable, cpqFcaPhyDrvThrViFunctTest2=cpqFcaPhyDrvThrViFunctTest2, cpqFcaLogDrvCurrentPath=cpqFcaLogDrvCurrentPath, cpqFcaHostCntlrOverallCondition=cpqFcaHostCntlrOverallCondition, cpqFcaPhyDrvCurrentWidth=cpqFcaPhyDrvCurrentWidth, cpqFcaInterface=cpqFcaInterface, cpqExtTapeDriveCleanTapeReplace=cpqExtTapeDriveCleanTapeReplace, cpqFcTapeLibraryDoorStatus=cpqFcTapeLibraryDoorStatus, cpqFcaAccelTable=cpqFcaAccelTable, cpqFcTapeDriveHotPlug=cpqFcTapeDriveHotPlug, cpqFcTapeLibraryScsiTarget=cpqFcTapeLibraryScsiTarget, cpqFcaPhyDrvHReads=cpqFcaPhyDrvHReads, cpqFcTapeLibraryStatMoves=cpqFcTapeLibraryStatMoves, cpqFcaCntlrRedundancyError=cpqFcaCntlrRedundancyError, cpqFcaSpareCondition=cpqFcaSpareCondition, cpqFcTapeDriveEntry=cpqFcTapeDriveEntry, cpqFcaAccelSerialNumber=cpqFcaAccelSerialNumber, cpqFcaPhyDrvStatusChange=cpqFcaPhyDrvStatusChange, cpqFcTapeCountersEntry=cpqFcTapeCountersEntry, cpqExtArrSnapshotBoxIndex=cpqExtArrSnapshotBoxIndex, cpqFcaPhyDrvSpinUpErrs=cpqFcaPhyDrvSpinUpErrs, cpqFcaPhyDrvBoxConnector=cpqFcaPhyDrvBoxConnector, cpqFcaLogDrvFaultTol=cpqFcaLogDrvFaultTol, cpqFcaPhyDrvRefHours=cpqFcaPhyDrvRefHours, cpqFcTapeLibraryFWRev=cpqFcTapeLibraryFWRev, cpqFcaPhyDrvHardReadErrs=cpqFcaPhyDrvHardReadErrs, cpqFcaLogDrvPercentRebuild=cpqFcaLogDrvPercentRebuild, cpqFcaPhyDrvBay=cpqFcaPhyDrvBay, cpqFcaPhyDrvType=cpqFcaPhyDrvType, cpqFcaOsCommon=cpqFcaOsCommon, cpqFcSwitchFWRev=cpqFcSwitchFWRev, cpqFcaSpareStatusChange=cpqFcaSpareStatusChange, cpqExtArrRsrcVolSourceVolumeId=cpqExtArrRsrcVolSourceVolumeId, cpqFcaPhyDrvAbortedCmds=cpqFcaPhyDrvAbortedCmds, cpqFcSwitchIpSubnet=cpqFcSwitchIpSubnet, cpqFcTapeLibraryTable=cpqFcTapeLibraryTable, cpqFcTapeCntlrWWN=cpqFcTapeCntlrWWN, cpqFcaHostCntlrEntry=cpqFcaHostCntlrEntry, cpqFcTapeLibraryScsiLun=cpqFcTapeLibraryScsiLun, cpqFcaCntlrCondition=cpqFcaCntlrCondition, cpqFcaAccelBadData=cpqFcaAccelBadData, cpqFcTapeLibraryStatus=cpqFcTapeLibraryStatus, cpqFcaPhyDrvFailureCode=cpqFcaPhyDrvFailureCode, cpqFcTapeDriveCondition=cpqFcTapeDriveCondition, cpqFcTapeCntlrModel=cpqFcTapeCntlrModel, cpqFcaPhyDrvRecvWriteErrs=cpqFcaPhyDrvRecvWriteErrs, cpqFcaPhyDrvFunctTest1=cpqFcaPhyDrvFunctTest1, cpqFcTapeDriveBay=cpqFcTapeDriveBay, cpqFcaHostCntlrOptionRomVersion=cpqFcaHostCntlrOptionRomVersion, cpqExtArrSnapshotMounted=cpqExtArrSnapshotMounted, cpqFcaPhyDrvThrViSpinupTime=cpqFcaPhyDrvThrViSpinupTime, cpqFca2AccelBadDataTrap=cpqFca2AccelBadDataTrap, cpqFcaSpareStatus=cpqFcaSpareStatus, cpqFcaCntlrStatusChange=cpqFcaCntlrStatusChange, cpqExtArrRsrcVolFreeActiveSpace=cpqExtArrRsrcVolFreeActiveSpace, cpqFcaAccelFailedBatteries=cpqFcaAccelFailedBatteries, cpqFcTapeDriveCleanTapeReplace=cpqFcTapeDriveCleanTapeReplace, cpqFcaOsCommonModuleName=cpqFcaOsCommonModuleName, cpqFcaLogDrvPreferredPath=cpqFcaLogDrvPreferredPath, cpqFcaPhyDrvThrBoxIndex=cpqFcaPhyDrvThrBoxIndex, cpqFcaPhyDrvSize=cpqFcaPhyDrvSize, cpqExtArrRsrcVol=cpqExtArrRsrcVol, cpqFcTapeLibraryCntlrIndex=cpqFcTapeLibraryCntlrIndex, cpqFcaOsCommonModulePurpose=cpqFcaOsCommonModulePurpose, cpqFcTapeDriveLocation=cpqFcTapeDriveLocation, cpqFcTapeLibrarySerialNumber=cpqFcTapeLibrarySerialNumber, cpqFcaLogDrvBoxIndex=cpqFcaLogDrvBoxIndex, cpqFcaPhyDrvThr=cpqFcaPhyDrvThr, cpqFcaLogDrvSize=cpqFcaLogDrvSize, cpqFcaPhyDrvStatus=cpqFcaPhyDrvStatus, cpqFcaPhyDrvHSeeks=cpqFcaPhyDrvHSeeks, cpqExtArrRsrcVolAllowCreation=cpqExtArrRsrcVolAllowCreation, cpqExtArrSnapshotEntry=cpqExtArrSnapshotEntry, cpqFcaLogDrvBlinkTime=cpqFcaLogDrvBlinkTime, cpqFcaHostCntlrSerialNumber=cpqFcaHostCntlrSerialNumber, cpqFcaAccelBoxIndex=cpqFcaAccelBoxIndex, cpqFcaPhyDrvThrViUsedReallocs=cpqFcaPhyDrvThrViUsedReallocs, cpqFcaCntlrBlinkTime=cpqFcaCntlrBlinkTime, cpqFcaPhyDrvSataVersion=cpqFcaPhyDrvSataVersion, cpqFcTapeCntlrSerialNumber=cpqFcTapeCntlrSerialNumber, cpqFibreArray=cpqFibreArray, cpqFcaPhyDrvThrViFunctTest1=cpqFcaPhyDrvThrViFunctTest1, cpqFcaPhyDrvSeeks=cpqFcaPhyDrvSeeks, cpqFcTapeLibraryHotSwap=cpqFcTapeLibraryHotSwap, cpqFcaPhyDrvIndex=cpqFcaPhyDrvIndex, cpqFcaAccelStatus=cpqFcaAccelStatus, cpqFca2AccelBatteryFailed=cpqFca2AccelBatteryFailed, cpqExtArrSnapshotType=cpqExtArrSnapshotType, cpqFcaSpareLocationString=cpqFcaSpareLocationString, cpqFca2CntlrStatusChange=cpqFca2CntlrStatusChange, cpqFcaSpareBay=cpqFcaSpareBay, cpqFcaPhyDrvUsedReallocs=cpqFcaPhyDrvUsedReallocs, cpqFcaPhyDrvPreFailMonitoring=cpqFcaPhyDrvPreFailMonitoring, cpqFcSwitchLocation=cpqFcSwitchLocation, cpqExtArrRsrcVolFreeNewSpace=cpqExtArrRsrcVolFreeNewSpace, cpqExtTapeDriveStatusChange=cpqExtTapeDriveStatusChange, cpqFcaPhyDrvPhyCount=cpqFcaPhyDrvPhyCount, cpqFcTapeCntlrStatusChange=cpqFcTapeCntlrStatusChange, cpqFcaAccelEntry=cpqFcaAccelEntry, cpqFcaLogDrvPhyDrvIDs=cpqFcaLogDrvPhyDrvIDs, cpqFcTapeDriveLibraryDrive=cpqFcTapeDriveLibraryDrive, cpqFcaAccelTotalMemory=cpqFcaAccelTotalMemory, cpqFcaLogDrvAutoRel=cpqFcaLogDrvAutoRel, cpqFcaCntlrBoxIndex=cpqFcaCntlrBoxIndex, cpqExtArrSnapshotInstance=cpqExtArrSnapshotInstance, cpqFcaPhyDrvEntry=cpqFcaPhyDrvEntry, cpqFcaLogDrvHasAccel=cpqFcaLogDrvHasAccel, cpqFcaHostCntlrHwLocation=cpqFcaHostCntlrHwLocation, cpqFcaPhyDrvBusNumber=cpqFcaPhyDrvBusNumber, cpqFcaSpareBoxIndex=cpqFcaSpareBoxIndex, cpqFcaPhyDrvMediaErrs=cpqFcaPhyDrvMediaErrs, cpqFcSwitchComponent=cpqFcSwitchComponent, cpqFcaPhyDrvCurrentSpeed=cpqFcaPhyDrvCurrentSpeed, cpqExtArrSnapshotAccess=cpqExtArrSnapshotAccess, cpqFcaHostCntlrWorldWideName=cpqFcaHostCntlrWorldWideName, cpqFcaLogDrvSnapshotResourceDrvIndex=cpqFcaLogDrvSnapshotResourceDrvIndex, cpqFcTapeDriveCntlrIndex=cpqFcTapeDriveCntlrIndex, cpqFcaPhyDrvHotPlugs=cpqFcaPhyDrvHotPlugs, cpqFcaCntlrWorldWideName=cpqFcaCntlrWorldWideName, cpqFcaMibRev=cpqFcaMibRev, cpqFcaPhyDrvThrFunctTest1=cpqFcaPhyDrvThrFunctTest1, cpqFcTapeLibraryScsiBus=cpqFcTapeLibraryScsiBus, cpqFcaAccelReadErrs=cpqFcaAccelReadErrs, cpqFcTapeLibrary=cpqFcTapeLibrary, cpqFcaLogDrvRebuildingPhyDrv=cpqFcaLogDrvRebuildingPhyDrv, cpqFcSwitchIndex=cpqFcSwitchIndex, cpqFcaOsCommonModuleIndex=cpqFcaOsCommonModuleIndex, cpqFcaPhyDrvThrEntry=cpqFcaPhyDrvThrEntry, cpqFcTapeCountersReReads=cpqFcTapeCountersReReads, cpqFcTapeDriveStatusChange=cpqFcTapeDriveStatusChange, cpqFcSwitch=cpqFcSwitch, cpqFcaPhyDrvWrites=cpqFcaPhyDrvWrites, cpqFcTapeDriveTable=cpqFcTapeDriveTable, cpqFcaComponent=cpqFcaComponent, cpqFcTapeDriveStatus=cpqFcTapeDriveStatus, cpqFcaOsCommonModuleVersion=cpqFcaOsCommonModuleVersion, cpqFcaPhyDrvBadRecvReads=cpqFcaPhyDrvBadRecvReads, cpqFca2HostCntlrStatusChange=cpqFca2HostCntlrStatusChange, cpqFcaPhyDrvThrFunctTest3=cpqFcaPhyDrvThrFunctTest3, cpqFcaOsCommonModuleTable=cpqFcaOsCommonModuleTable, cpqFcaCntlrRedundancyType=cpqFcaCntlrRedundancyType, cpqFcTapeDriveModel=cpqFcTapeDriveModel, cpqFcTapeDriveType=cpqFcTapeDriveType, cpqFcaSpareDrv=cpqFcaSpareDrv, cpqFcTapeLibraryDriveList=cpqFcTapeLibraryDriveList, cpqFcTapeLibraryRedundancy=cpqFcTapeLibraryRedundancy, cpqFcSwitchTable=cpqFcSwitchTable, cpqFcaMibCondition=cpqFcaMibCondition, cpqFcTapeLibraryStatusChange=cpqFcTapeLibraryStatusChange, cpqFcaAccelStatusChange=cpqFcaAccelStatusChange, cpqFcTapeLibraryCondition=cpqFcTapeLibraryCondition, cpqFcaOsCommonPollFreq=cpqFcaOsCommonPollFreq, cpqFcTapeCntlrTable=cpqFcTapeCntlrTable, cpqFcSwitchWorldWideNodeName=cpqFcSwitchWorldWideNodeName, cpqFcTapeCountersScsiBus=cpqFcTapeCountersScsiBus, cpqExtArrRsrcVolDisabledInstances=cpqExtArrRsrcVolDisabledInstances, cpqFcTapeLibraryModel=cpqFcTapeLibraryModel, cpqFcTapeCntlrType=cpqFcTapeCntlrType, cpqFcSwitchEntry=cpqFcSwitchEntry, cpqFcaPhyDrvCondition=cpqFcaPhyDrvCondition, cpqFcTapeCountersTotalBytes=cpqFcTapeCountersTotalBytes, cpqFcaCntlrBoxIoSlot=cpqFcaCntlrBoxIoSlot, cpqExtTapeDriveCleaningRequired=cpqExtTapeDriveCleaningRequired, cpqFcaHostCntlrStatusChange=cpqFcaHostCntlrStatusChange, cpqFcaPhyDrvSmartStatus=cpqFcaPhyDrvSmartStatus, cpqExtArrSnapshotIndex=cpqExtArrSnapshotIndex, cpqFcaPhyDrvLocationString=cpqFcaPhyDrvLocationString, cpqFcTapeLibraryLocation=cpqFcTapeLibraryLocation, cpqFcSwitchNetworkLinkStatus=cpqFcSwitchNetworkLinkStatus, cpqFcaPhyDrvBoxOnConnector=cpqFcaPhyDrvBoxOnConnector, cpqFcaPhyDrvFunctTest2=cpqFcaPhyDrvFunctTest2)
mibBuilder.exportSymbols("CPQFCA-MIB", cpqFcSwitchIpGateway=cpqFcSwitchIpGateway, cpqFcTapeCountersScsiLun=cpqFcTapeCountersScsiLun, cpqFcTapeLibraryTemperature=cpqFcTapeLibraryTemperature, cpqExtArrRsrcVolIndex=cpqExtArrRsrcVolIndex, cpqFcaHostCntlrWorldWidePortName=cpqFcaHostCntlrWorldWidePortName, cpqFca2PhyDrvStatusChange=cpqFca2PhyDrvStatusChange, cpqFcaCntlrWorldWideNodeName=cpqFcaCntlrWorldWideNodeName, cpqFcTapeCntlrCondition=cpqFcTapeCntlrCondition, cpqFcaCntlrTable=cpqFcaCntlrTable, cpqFcaAccelBatteryStatus=cpqFcaAccelBatteryStatus, cpqFcaPhyDrvHardwareErrs=cpqFcaPhyDrvHardwareErrs, cpqFcTapeDriveCurrentSpeed=cpqFcTapeDriveCurrentSpeed, cpqFcaPhyDrvBusFaults=cpqFcaPhyDrvBusFaults, cpqExtArrRsrcVolStatus=cpqExtArrRsrcVolStatus, cpqFcaPhyDrvRotationalSpeed=cpqFcaPhyDrvRotationalSpeed, cpqFcaAccelBoxIoSlot=cpqFcaAccelBoxIoSlot, cpqFcaMibRevMajor=cpqFcaMibRevMajor, cpqFcaLogDrvStatus=cpqFcaLogDrvStatus, cpqFcaCntlrCurrentRole=cpqFcaCntlrCurrentRole, cpqFcTapeDriveFWSubtype=cpqFcTapeDriveFWSubtype, cpqFcaPhyDrvThrViFunctTest3=cpqFcaPhyDrvThrViFunctTest3, cpqFcaHostCntlrSlot=cpqFcaHostCntlrSlot, cpqFcaPhyDrvHSeekErrs=cpqFcaPhyDrvHSeekErrs, cpqFcaPhyDrvTable=cpqFcaPhyDrvTable, cpqFcTapeCountersTable=cpqFcTapeCountersTable, cpqFcaPhyDrvNotReadyErrs=cpqFcaPhyDrvNotReadyErrs, cpqFcSwitchChassisSlot=cpqFcSwitchChassisSlot, cpqFcaAccelBadDataTrap=cpqFcaAccelBadDataTrap, cpqFcTapeDriveCleaningRequired=cpqFcTapeDriveCleaningRequired, cpqFcaHostCntlrPciLocation=cpqFcaHostCntlrPciLocation, cpqFcTapeCountersScsiTarget=cpqFcTapeCountersScsiTarget, cpqFcaPhyDrvUnsupportedDrive=cpqFcaPhyDrvUnsupportedDrive, cpqFcTapeDriveScsiLun=cpqFcTapeDriveScsiLun, cpqFcaCntlrActive=cpqFcaCntlrActive, cpqExtTapeLibraryStatusChange=cpqExtTapeLibraryStatusChange, cpqExtArrSnapshotRsrcVolIndex=cpqExtArrSnapshotRsrcVolIndex, cpqFcTapeCntlrStatus=cpqFcTapeCntlrStatus, cpqFcaPhyDrvSpinupTime=cpqFcaPhyDrvSpinupTime, cpqFcTapeCntlr=cpqFcTapeCntlr, cpqFcaSpareEntry=cpqFcaSpareEntry, cpqFcaPhyDrvNegotiatedLinkRate=cpqFcaPhyDrvNegotiatedLinkRate, cpqFcaLogDrvStripeSize=cpqFcaLogDrvStripeSize, cpqFcTapeLibraryEntry=cpqFcTapeLibraryEntry, cpqFcaHostCntlrStorBoxList=cpqFcaHostCntlrStorBoxList, cpqFcaLogDrvStatusChange=cpqFcaLogDrvStatusChange, cpqFcaLogDrv=cpqFcaLogDrv, cpqFcTapeDrive=cpqFcTapeDrive, cpqFcaLogDrvTable=cpqFcaLogDrvTable, cpqFcaCntlr=cpqFcaCntlr, cpqFcaPhyDrvModel=cpqFcaPhyDrvModel, cpqFcaPhyDrvBadRecvWrites=cpqFcaPhyDrvBadRecvWrites, cpqFcaCntlrModel=cpqFcaCntlrModel, cpqExtArrRsrcVolVolumeId=cpqExtArrRsrcVolVolumeId, cpqFcSwitchWorldWidePortName=cpqFcSwitchWorldWidePortName, cpqFcTapeLibraryOverallCondition=cpqFcTapeLibraryOverallCondition, cpqFcaSpareReplacedDrvBusNumber=cpqFcaSpareReplacedDrvBusNumber, cpqExtArrRsrcVolActiveInstances=cpqExtArrRsrcVolActiveInstances, cpqFcaAccelCondition=cpqFcaAccelCondition, cpqExtArrSnapshotTable=cpqExtArrSnapshotTable, cpqFcaPhyDrvFWRev=cpqFcaPhyDrvFWRev, cpqFcaPhyDrvFunctTest3=cpqFcaPhyDrvFunctTest3, cpqFcaHostCntlrTable=cpqFcaHostCntlrTable, cpqFcaSparePercentRebuild=cpqFcaSparePercentRebuild, cpqFcTapeCountersCntlrIndex=cpqFcTapeCountersCntlrIndex, cpqExtArrSnapshot=cpqExtArrSnapshot, cpqFcaPhyDrvSeekErrs=cpqFcaPhyDrvSeekErrs, cpqFcaLogDrvCondition=cpqFcaLogDrvCondition, cpqFcaCntlrRebuildPriority=cpqFcaCntlrRebuildPriority)
