...
myAuthenKeyMIBObjects=_MyAuthenKeyMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,24,1))
_MyAuthenKeyChainTable_Object=MibTable
myAuthenKeyChainTable=_MyAuthenKeyChainTable_Object((1,3,6,1,4,1,171,10,97,2,24,1,1))
if mibBuilder.loadTexts:myAuthenKeyChainTable.setStatus(_A)
_MyAuthenKeyChainEntry_Object=MibTableRow
myAuthenKeyChainEntry=_MyAuthenKeyChainEntry_Object((1,3,6,1,4,1,171,10,97,2,24,1,1,1))
...
myAuthenKeyChainName=_MyAuthenKeyChainName_Object((1,3,6,1,4,1,171,10,97,2,24,1,1,1,1),_MyAuthenKeyChainName_Type())
...
myAuthenKeyChainEntryStatus=_MyAuthenKeyChainEntryStatus_Object((1,3,6,1,4,1,171,10,97,2,24,1,1,1,2),_MyAuthenKeyChainEntryStatus_Type())
...
myAuthenKeyTable=_MyAuthenKeyTable_Object((1,3,6,1,4,1,171,10,97,2,24,1,2))
if mibBuilder.loadTexts:myAuthenKeyTable.setStatus(_A)
_MyAuthenKeyEntry_Object=MibTableRow
myAuthenKeyEntry=_MyAuthenKeyEntry_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1))
...
myKeyChainName=_MyKeyChainName_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,1),_MyKeyChainName_Type())
...
myAuthenKeyNumber=_MyAuthenKeyNumber_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,2),_MyAuthenKeyNumber_Type())
...
myKeyString=_MyKeyString_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,3),_MyKeyString_Type())
...
myAuthenKeyReceiveMyTime=_MyAuthenKeyReceiveMyTime_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,4),_MyAuthenKeyReceiveMyTime_Type())
...
myAuthenKeyReceiveTimeMode=_MyAuthenKeyReceiveTimeMode_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,5),_MyAuthenKeyReceiveTimeMode_Type())
...
myAuthenKeyReceiveEndTime=_MyAuthenKeyReceiveEndTime_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,6),_MyAuthenKeyReceiveEndTime_Type())
...
myAuthenKeyReceiveDuration=_MyAuthenKeyReceiveDuration_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,7),_MyAuthenKeyReceiveDuration_Type())
...
myAuthenKeySendMyTime=_MyAuthenKeySendMyTime_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,8),_MyAuthenKeySendMyTime_Type())
...
myAuthenKeySendTimeMode=_MyAuthenKeySendTimeMode_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,9),_MyAuthenKeySendTimeMode_Type())
...
myAuthenKeySendEndTime=_MyAuthenKeySendEndTime_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,10),_MyAuthenKeySendEndTime_Type())
...
myAuthenKeySendDuration=_MyAuthenKeySendDuration_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,11),_MyAuthenKeySendDuration_Type())
...
myAuthenReceiveKeyState=_MyAuthenReceiveKeyState_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,12),_MyAuthenReceiveKeyState_Type())
...
myAuthenSendKeyState=_MyAuthenSendKeyState_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,13),_MyAuthenSendKeyState_Type())
...
myAuthenKeyEntryStauts=_MyAuthenKeyEntryStauts_Object((1,3,6,1,4,1,171,10,97,2,24,1,2,1,14),_MyAuthenKeyEntryStauts_Type())
...
myAuthenKeyChainMIBConformance=_MyAuthenKeyChainMIBConformance_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,24,2))
_MyAuthenKeyChainMIBCompliances_ObjectIdentity=ObjectIdentity
myAuthenKeyChainMIBCompliances=_MyAuthenKeyChainMIBCompliances_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,24,2,1))
_MyAuthenKeyChainMIBGroups_ObjectIdentity=ObjectIdentity
myAuthenKeyChainMIBGroups=_MyAuthenKeyChainMIBGroups_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,24,2,2))
myAuthenKeyChainMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,24,2,2,1))
...
myAuthenKeyChainMIBCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,97,2,24,2,1,1))
