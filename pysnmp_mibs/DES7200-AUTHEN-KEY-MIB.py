# SNMP MIB module (DES7200-AUTHEN-KEY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-AUTHEN-KEY-MIB
...
myAuthenKeyChainEntry = _MyAuthenKeyChainEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 1, 1)
)
myAuthenKeyChainEntry.setIndexNames(
    (0, "DES7200-AUTHEN-KEY-MIB", "myAuthenKeyChainName"),
)
if mibBuilder.loadTexts:
...
myAuthenKeyChainName = _MyAuthenKeyChainName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 1, 1, 1),
...
myAuthenKeyChainEntryStatus = _MyAuthenKeyChainEntryStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 1, 1, 2),
...
myAuthenKeyTable = _MyAuthenKeyTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2)
)
if mibBuilder.loadTexts:
    myAuthenKeyTable.setStatus("current")
_MyAuthenKeyEntry_Object = MibTableRow
myAuthenKeyEntry = _MyAuthenKeyEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1)
)
myAuthenKeyEntry.setIndexNames(
    (0, "DES7200-AUTHEN-KEY-MIB", "myKeyChainName"),
    (0, "DES7200-AUTHEN-KEY-MIB", "myAuthenKeyNumber"),
)
if mibBuilder.loadTexts:
...
myKeyChainName = _MyKeyChainName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 1),
...
myAuthenKeyNumber = _MyAuthenKeyNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 2),
...
myKeyString = _MyKeyString_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 3),
    _MyKeyString_Type()
)
...
myAuthenKeyReceiveMyTime = _MyAuthenKeyReceiveMyTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 4),
...
myAuthenKeyReceiveTimeMode = _MyAuthenKeyReceiveTimeMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 5),
...
myAuthenKeyReceiveEndTime = _MyAuthenKeyReceiveEndTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 6),
...
myAuthenKeyReceiveDuration = _MyAuthenKeyReceiveDuration_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 7),
...
myAuthenKeySendMyTime = _MyAuthenKeySendMyTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 8),
...
myAuthenKeySendTimeMode = _MyAuthenKeySendTimeMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 9),
...
myAuthenKeySendEndTime = _MyAuthenKeySendEndTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 10),
...
myAuthenKeySendDuration = _MyAuthenKeySendDuration_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 11),
...
myAuthenReceiveKeyState = _MyAuthenReceiveKeyState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 12),
...
myAuthenSendKeyState = _MyAuthenSendKeyState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 13),
...
myAuthenKeyEntryStauts = _MyAuthenKeyEntryStauts_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 1, 2, 1, 14),
...
myAuthenKeyChainMIBCompliances = _MyAuthenKeyChainMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 2, 1)
)
...
myAuthenKeyChainMIBGroups = _MyAuthenKeyChainMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 2, 2)
)

# Managed Objects groups

myAuthenKeyChainMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 2, 2, 1)
)
myAuthenKeyChainMIBGroup.setObjects(
      *(("DES7200-AUTHEN-KEY-MIB", "myAuthenKeyChainName"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeyChainEntryStatus"),
        ("DES7200-AUTHEN-KEY-MIB", "myKeyChainName"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeyNumber"),
        ("DES7200-AUTHEN-KEY-MIB", "myKeyString"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeyReceiveMyTime"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeyReceiveTimeMode"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeyReceiveEndTime"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeyReceiveDuration"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeySendMyTime"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeySendTimeMode"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeySendEndTime"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeySendDuration"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenReceiveKeyState"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenSendKeyState"),
        ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeyEntryStauts"))
)
if mibBuilder.loadTexts:
...
myAuthenKeyChainMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 24, 2, 1, 1)
)
myAuthenKeyChainMIBCompliance.setObjects(
    ("DES7200-AUTHEN-KEY-MIB", "myAuthenKeyChainMIBGroup")
)
if mibBuilder.loadTexts:
