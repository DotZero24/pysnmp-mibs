...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SM-FILE-DOWNLOAD-MIB
...
csFileMIBCompliance.setObjects(
      *(("CISCO-SM-FILE-DOWNLOAD-MIB", "csDefineFileGroup"),
        ("CISCO-SM-FILE-DOWNLOAD-MIB", "csFileStatusGroup"))
)
if mibBuilder.loadTexts:
