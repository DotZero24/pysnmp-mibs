...
DisplayString, VariablePointer, TimeStamp, RowStatus, TextualConvention, DateAndTime, TruthValue, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "VariablePointer", "TimeStamp", "RowStatus", "TextualConvention", "DateAndTime", "TruthValue", "StorageType")
...
mibBuilder.exportSymbols("ENTERASYS-FIREWALL-MIB", etsysFWAuthAddressEntry=etsysFWAuthAddressEntry, etsysFWUdpTimeout=etsysFWUdpTimeout, etsysFWNetworkGroupRowStatus=etsysFWNetworkGroupRowStatus, etsysFWDoSSrcIPAddress=etsysFWDoSSrcIPAddress, etsysFWFirewallOnIntfEntry=etsysFWFirewallOnIntfEntry, etsysFWFirewallIntfFilterStorageType=etsysFWFirewallIntfFilterStorageType, etsysFWServiceNumEntries=etsysFWServiceNumEntries, etsysFWNetworkRealm=etsysFWNetworkRealm, etsysFWNetworkIPAddressMask=etsysFWNetworkIPAddressMask, etsysFWDoSBlockedGroup=etsysFWDoSBlockedGroup, etsysFWServiceEntry=etsysFWServiceEntry, etsysFWFirewallIntfGroup=etsysFWFirewallIntfGroup, etsysFWNetworkGroup=etsysFWNetworkGroup, etsysFWFilterDefMaxEntries=etsysFWFilterDefMaxEntries, etsysFWPolicyRuleDefBidirectional=etsysFWPolicyRuleDefBidirectional, etsysFWSessTotProtocolID=etsysFWSessTotProtocolID, etsysFWFilterDefNumEntries=etsysFWFilterDefNumEntries, etsysFWNetworkIPAddressEnd=etsysFWNetworkIPAddressEnd, etsysFWSessionTotalsNumEntries=etsysFWSessionTotalsNumEntries, etsysFWCLSFilterIndex=etsysFWCLSFilterIndex, etsysFWPolicyRuleDefName=etsysFWPolicyRuleDefName, etsysFWFirewallOnIntfTable=etsysFWFirewallOnIntfTable, etsysFWServiceTable=etsysFWServiceTable, etsysFirewallConformance=etsysFirewallConformance, etsysFWDoSBlockedEntry=etsysFWDoSBlockedEntry, etsysFWPolicyRuleDefEntry=etsysFWPolicyRuleDefEntry, etsysFWFilterDefDstNetwork=etsysFWFilterDefDstNetwork, etsysFWPolicyRuleTrueEvents=etsysFWPolicyRuleTrueEvents, etsysFWGroupPolicyTable=etsysFWGroupPolicyTable, etsysFWPolicyRuleDefLastChange=etsysFWPolicyRuleDefLastChange, etsysFWServiceGroup=etsysFWServiceGroup, etsysFWNetwkInNetGrpRowStatus=etsysFWNetwkInNetGrpRowStatus, etsysFWPolicyRuleDefLogging=etsysFWPolicyRuleDefLogging, etsysFWFilterDefProtocol=etsysFWFilterDefProtocol, etsysFWCLSFilterLastChange=etsysFWCLSFilterLastChange, etsysFWHTMLFilterType=etsysFWHTMLFilterType, etsysFWSessionTotalsEntry=etsysFWSessionTotalsEntry, etsysFWAuthTimeout=etsysFWAuthTimeout, etsysFWIpSessionProtocolID=etsysFWIpSessionProtocolID, etsysFWPolicyRuleDefTable=etsysFWPolicyRuleDefTable, etsysFWServiceStorageType=etsysFWServiceStorageType, etsysFWHTMLFilterTable=etsysFWHTMLFilterTable, etsysFWHTMLFilterNetwork=etsysFWHTMLFilterNetwork, etsysFWHTMLFilterGroup=etsysFWHTMLFilterGroup, etsysFWNetworkGroupGroup=etsysFWNetworkGroupGroup, etsysFWSessionTotalsTable=etsysFWSessionTotalsTable, etsysFWPolicyFilters=etsysFWPolicyFilters, etsysFWServiceSrcLowPort=etsysFWServiceSrcLowPort, etsysFWPolicyRuleDefService=etsysFWPolicyRuleDefService, etsysFWNetworkGroupLastChange=etsysFWNetworkGroupLastChange, etsysFWPolicyRuleTrueEntry=etsysFWPolicyRuleTrueEntry, etsysFWNetworkGroupEntry=etsysFWNetworkGroupEntry, etsysFWServiceGroupMaxServices=etsysFWServiceGroupMaxServices, etsysFWIntfToGroupRowStatus=etsysFWIntfToGroupRowStatus, etsysFWNetworkGroupStorageType=etsysFWNetworkGroupStorageType, etsysFWIpSessionCreation=etsysFWIpSessionCreation, etsysFWFirewallIntfFilterDirection=etsysFWFirewallIntfFilterDirection, etsysFWIpSessionNumEntries=etsysFWIpSessionNumEntries, etsysFWFirewallIntfFilterTable=etsysFWFirewallIntfFilterTable, etsysFirewallMIB=etsysFirewallMIB, etsysFWPolicyNetworks=etsysFWPolicyNetworks, etsysFWNetwkInNetGrpEntry=etsysFWNetwkInNetGrpEntry, etsysFWFilterDefStorageType=etsysFWFilterDefStorageType, etsysFWSystemPolicyNameGroup=etsysFWSystemPolicyNameGroup, etsysFWAuthAddressTable=etsysFWAuthAddressTable, etsysFWNetworkGroupName=etsysFWNetworkGroupName, etsysFWPolicyRuleDefNumEntries=etsysFWPolicyRuleDefNumEntries, etsysFWNetworkName=etsysFWNetworkName, etsysFWLoggingThreshold=etsysFWLoggingThreshold, etsysFWIntfToGroupStorageType=etsysFWIntfToGroupStorageType, etsysFWIpSessionEntry=etsysFWIpSessionEntry, etsysFWAuthPort=etsysFWAuthPort, etsysFirewallGroups=etsysFirewallGroups, etsysFWIpSessionTable=etsysFWIpSessionTable, etsysFWNetworkIPAddressBegin=etsysFWNetworkIPAddressBegin, etsysFWServiceInSvcGrpEntry=etsysFWServiceInSvcGrpEntry, etsysFWServiceMaxEntries=etsysFWServiceMaxEntries, etsysFWFilterDefLastChange=etsysFWFilterDefLastChange, etsysFWFirewallIntfFilterEntry=etsysFWFirewallIntfFilterEntry, etsysFWServiceInSvcGrpTable=etsysFWServiceInSvcGrpTable, etsysFWServiceGroupRowStatus=etsysFWServiceGroupRowStatus, etsysFWAuthAddressGroupName=etsysFWAuthAddressGroupName, etsysFWInterfacePolicyGroup=etsysFWInterfacePolicyGroup, etsysFWDoSBlockedNumEntries=etsysFWDoSBlockedNumEntries, etsysFWServiceLastChange=etsysFWServiceLastChange, etsysFWServiceGroupName=etsysFWServiceGroupName, etsysFWIntfToGroupName=etsysFWIntfToGroupName, etsysFWHTMLFilterLogging=etsysFWHTMLFilterLogging, etsysFWSystemPolicyGroupName=etsysFWSystemPolicyGroupName, etsysFWHTMLFilterName=etsysFWHTMLFilterName, etsysFWPolicyRuleDefDstNetwork=etsysFWPolicyRuleDefDstNetwork, etsysFWIpSessionDstAddress=etsysFWIpSessionDstAddress, etsysFWGroupPolicyEntry=etsysFWGroupPolicyEntry, etsysFWCLSFilterEntry=etsysFWCLSFilterEntry, etsysFWCLSFilterStorageType=etsysFWCLSFilterStorageType, etsysFWFirewallEnabledGroup=etsysFWFirewallEnabledGroup, etsysFWPolicyGroups=etsysFWPolicyGroups, etsysFWFirewallIntfFilterLastChange=etsysFWFirewallIntfFilterLastChange, etsysFWDoSAttackName=etsysFWDoSAttackName, etsysFWFirewallIntfFilterRowStatus=etsysFWFirewallIntfFilterRowStatus, etsysFWServiceGroupTable=etsysFWServiceGroupTable, etsysFWNetwkInNetGrpStorageType=etsysFWNetwkInNetGrpStorageType, etsysFWIpSessionSrcAddress=etsysFWIpSessionSrcAddress, etsysFirewallCompliance=etsysFirewallCompliance, etsysFWSessTotLastBlock=etsysFWSessTotLastBlock, etsysFWGroupPolicyGroup=etsysFWGroupPolicyGroup, etsysFWPolicyRuleDefRowStatus=etsysFWPolicyRuleDefRowStatus, etsysFWServiceRowStatus=etsysFWServiceRowStatus, etsysFWIpSessionSrcPort=etsysFWIpSessionSrcPort, etsysFWCLSFilterGroup=etsysFWCLSFilterGroup, etsysFWServiceGroupStorageType=etsysFWServiceGroupStorageType, etsysFWNetworkGroupNumEntries=etsysFWNetworkGroupNumEntries, etsysFWDoSBlockedTable=etsysFWDoSBlockedTable, etsysFWIpSessionIPVersion=etsysFWIpSessionIPVersion, etsysFWIntfToGroupLastChange=etsysFWIntfToGroupLastChange, etsysFWPolicyRuleDefMaxEntries=etsysFWPolicyRuleDefMaxEntries, etsysFWNetworkIPVersion=etsysFWNetworkIPVersion, etsysFWServiceInSvcGrpLastChange=etsysFWServiceInSvcGrpLastChange, etsysFWPolicyRuleDefSrcNetwork=etsysFWPolicyRuleDefSrcNetwork, etsysFWPolicyRuleTrueTable=etsysFWPolicyRuleTrueTable, etsysFWNetworkGroupMaxNetworks=etsysFWNetworkGroupMaxNetworks, etsysFWNetworkTable=etsysFWNetworkTable, etsysFWPolicyRuleDefGroup=etsysFWPolicyRuleDefGroup, etsysFWIntfToGroupTable=etsysFWIntfToGroupTable, etsysFWServiceInSvcGrpRowStatus=etsysFWServiceInSvcGrpRowStatus, etsysFWServiceDstLowPort=etsysFWServiceDstLowPort, etsysFWSessionTotalsGroup=etsysFWSessionTotalsGroup, etsysFWCLSFilterWord=etsysFWCLSFilterWord, etsysFWGroupPolicyPriority=etsysFWGroupPolicyPriority, etsysFWPolicyObjects=etsysFWPolicyObjects, etsysFWConfigurationObjects=etsysFWConfigurationObjects, etsysFWServiceGroupEntry=etsysFWServiceGroupEntry, etsysFWFilterDefTable=etsysFWFilterDefTable, etsysFWCLSFilterTable=etsysFWCLSFilterTable, etsysFWIpSessionDstPort=etsysFWIpSessionDstPort, etsysFWPolicyServices=etsysFWPolicyServices, etsysFWSessTotActiveSessions=etsysFWSessTotActiveSessions, etsysFWSessTotBlockedSessions=etsysFWSessTotBlockedSessions, etsysFWIpSessionIndex=etsysFWIpSessionIndex, etsysFWFirewallEnabled=etsysFWFirewallEnabled, etsysFWFilterDefLogging=etsysFWFilterDefLogging, etsysFWRPCSunTimeout=etsysFWRPCSunTimeout, etsysFWHTMLFilterEntry=etsysFWHTMLFilterEntry, etsysFWNetworkNumEntries=etsysFWNetworkNumEntries, etsysFirewallCompliances=etsysFirewallCompliances, etsysFWNetworkRowStatus=etsysFWNetworkRowStatus, etsysFWServiceInSvcGrpSubService=etsysFWServiceInSvcGrpSubService, etsysFWAuthAddressGroup=etsysFWAuthAddressGroup, etsysFWSessionTotalsLastChange=etsysFWSessionTotalsLastChange, etsysFWServiceInSvcGrpStorageType=etsysFWServiceInSvcGrpStorageType, etsysFWNetworkMaxEntries=etsysFWNetworkMaxEntries, etsysFWCLSFilterRowStatus=etsysFWCLSFilterRowStatus, etsysFWServiceProtocol=etsysFWServiceProtocol, etsysFWCLSFilterMaxFilters=etsysFWCLSFilterMaxFilters, etsysFWGroupPolicyStorageType=etsysFWGroupPolicyStorageType, etsysFWFilterGroup=etsysFWFilterGroup, etsysFWFirewallConfigGroup=etsysFWFirewallConfigGroup, etsysFWTcpTimeout=etsysFWTcpTimeout, PYSNMP_MODULE_ID=etsysFirewallMIB, etsysFWFilterDefRowStatus=etsysFWFilterDefRowStatus, etsysFWDoSBlockedLastChange=etsysFWDoSBlockedLastChange, etsysFWPolicyRuleTrueNumEntries=etsysFWPolicyRuleTrueNumEntries, etsysFWServiceName=etsysFWServiceName, etsysFWMonitoringObjects=etsysFWMonitoringObjects, etsysFWPolicyRuleDefAction=etsysFWPolicyRuleDefAction, etsysFWNetwkInNetGrpLastChange=etsysFWNetwkInNetGrpLastChange, etsysFWFilterDefName=etsysFWFilterDefName, etsysFWFirewallOnIntfStorageType=etsysFWFirewallOnIntfStorageType, etsysFWIpSessionGroup=etsysFWIpSessionGroup, etsysFWDoSBlockedAttacks=etsysFWDoSBlockedAttacks, etsysFWNetwkInNetGrpTable=etsysFWNetwkInNetGrpTable, etsysFWNetworkLastChange=etsysFWNetworkLastChange, etsysFWFilterDefEntry=etsysFWFilterDefEntry, etsysFWRPCMicrosoftTimeout=etsysFWRPCMicrosoftTimeout, etsysFWGroupPolicyRuleDef=etsysFWGroupPolicyRuleDef, etsysFWServiceSrcHighPort=etsysFWServiceSrcHighPort, etsysFWHTMLFilterRowStatus=etsysFWHTMLFilterRowStatus, etsysFWHTMLFilterStorageType=etsysFWHTMLFilterStorageType, etsysFWNetwkInNetGrpSubNetwork=etsysFWNetwkInNetGrpSubNetwork, etsysFWAuthAddressIPVersion=etsysFWAuthAddressIPVersion, etsysFWDoSAttackTime=etsysFWDoSAttackTime, etsysFWAuthAddressIdleTime=etsysFWAuthAddressIdleTime, etsysFWServiceGroupNumEntries=etsysFWServiceGroupNumEntries, etsysFWNetworkGroupMaxEntries=etsysFWNetworkGroupMaxEntries, etsysFWPolicyRuleDefStorageType=etsysFWPolicyRuleDefStorageType, etsysFWFilterDefSrcNetwork=etsysFWFilterDefSrcNetwork, etsysFWIpSessionLastChange=etsysFWIpSessionLastChange, etsysFWFirewallOnIntfEnabled=etsysFWFirewallOnIntfEnabled, etsysFWFirewallOnIntfLastChange=etsysFWFirewallOnIntfLastChange, etsysFWPolicyRules=etsysFWPolicyRules, etsysFWIntfToGroupEntry=etsysFWIntfToGroupEntry, etsysFWFirewallIntfFilterType=etsysFWFirewallIntfFilterType, etsysFWServiceGroupLastChange=etsysFWServiceGroupLastChange, etsysFWGroupPolicyName=etsysFWGroupPolicyName, etsysFWFilterDefBidirectional=etsysFWFilterDefBidirectional, etsysFWPolicyRuleAuthName=etsysFWPolicyRuleAuthName, etsysFWPolicyRuleTrueGroup=etsysFWPolicyRuleTrueGroup, etsysFWAuthAddressLastChange=etsysFWAuthAddressLastChange, etsysFWServiceGroupGroup=etsysFWServiceGroupGroup, etsysFWDoSSrcIPVersion=etsysFWDoSSrcIPVersion, etsysFWAuthAddressIPAddress=etsysFWAuthAddressIPAddress, etsysFWIcmpTimeout=etsysFWIcmpTimeout, etsysFWServiceDstHighPort=etsysFWServiceDstHighPort, etsysFWFirewallOnIntfRowStatus=etsysFWFirewallOnIntfRowStatus, etsysFWIntfToGroupIntfDirection=etsysFWIntfToGroupIntfDirection, etsysFWNetworkGroupTable=etsysFWNetworkGroupTable, etsysFWFilterDefICMPType=etsysFWFilterDefICMPType, etsysFWPolicyRuleTrueIndex=etsysFWPolicyRuleTrueIndex, etsysFWAuthAddressIndex=etsysFWAuthAddressIndex, etsysFWPolicyRuleTrueName=etsysFWPolicyRuleTrueName, etsysFWGroupPolicyLastChange=etsysFWGroupPolicyLastChange, etsysFWNetworkStorageType=etsysFWNetworkStorageType, etsysFWServiceGroupMaxEntries=etsysFWServiceGroupMaxEntries, etsysFWAuthAddressNumEntries=etsysFWAuthAddressNumEntries, etsysFWGroupPolicyRowStatus=etsysFWGroupPolicyRowStatus, etsysFWPolicyRuleTrueLastChange=etsysFWPolicyRuleTrueLastChange, etsysFWSessTotIndex=etsysFWSessTotIndex, etsysFWPolicyRuleTrueLastEvent=etsysFWPolicyRuleTrueLastEvent, etsysFWSessTotPeakSessions=etsysFWSessTotPeakSessions, etsysFWNetworkEntry=etsysFWNetworkEntry, etsysFWNetworkRangeOrMask=etsysFWNetworkRangeOrMask)
