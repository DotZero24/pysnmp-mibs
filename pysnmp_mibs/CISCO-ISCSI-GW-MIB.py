...
cIscsiInstIndex, cIscsiNodeAttributesEntry, cIscsiInstanceAttributesEntry, cIscsiSessionAttributesEntry = mibBuilder.importSymbols("CISCO-ISCSI-MIB", "cIscsiInstIndex", "cIscsiNodeAttributesEntry", "cIscsiInstanceAttributesEntry", "cIscsiSessionAttributesEntry")
ScsiLUNOrZero, ciscoScsiLuEntry, ScsiName = mibBuilder.importSymbols("CISCO-SCSI-MIB", "ScsiLUNOrZero", "ciscoScsiLuEntry", "ScsiName")
...
mibBuilder.exportSymbols("CISCO-ISCSI-GW-MIB", fc2IscsiNodeName=fc2IscsiNodeName, CIscsiTargetDomains=CIscsiTargetDomains, fcAddressListIndex=fcAddressListIndex, iscsiIfTcpSACKEnable=iscsiIfTcpSACKEnable, fc2IscsiNodeTable=fc2IscsiNodeTable, cIscsiStatsSessionIndex=cIscsiStatsSessionIndex, scsiLuExtLocalLun=scsiLuExtLocalLun, fcAddressRowStatus=fcAddressRowStatus, fcAddress=fcAddress, ciscoiScsiGwMIBCompliances=ciscoiScsiGwMIBCompliances, CIscsiNodeRoles=CIscsiNodeRoles, cIscsiStatsConnectionTxBytes=cIscsiStatsConnectionTxBytes, fc2IscsiNodeRowStatus=fc2IscsiNodeRowStatus, cigIscsiIfGroupSup1=cigIscsiIfGroupSup1, iscsiIntrIdentificationMode=iscsiIntrIdentificationMode, cigIscsiIfGroupRev2=cigIscsiIfGroupRev2, iscsiImprtExprtTgtsConfEntry=iscsiImprtExprtTgtsConfEntry, PYSNMP_MODULE_ID=ciscoIscsiGwMIB, fcAddressIndex=fcAddressIndex, ciScsiStatistics=ciScsiStatistics, ciscoiScsiGwMIBGroups=ciscoiScsiGwMIBGroups, scsiLuExtRemoteLun=scsiLuExtRemoteLun, ciscoiScsiGwMIBNotifications=ciscoiScsiGwMIBNotifications, iscsiGigEIfTable=iscsiGigEIfTable, fc2IscsiNodeAdvIntfListIndex=fc2IscsiNodeAdvIntfListIndex, iscsiIfIntrProxyModeFcAddrAsgnmt=iscsiIfIntrProxyModeFcAddrAsgnmt, cigLuConfigurationGroup=cigLuConfigurationGroup, cigConfigurationGroupRev3=cigConfigurationGroupRev3, iscsiIfTcpMinBandwidth=iscsiIfTcpMinBandwidth, fcAddressListTable=fcAddressListTable, IscsiName=IscsiName, iscsi2FcPortFCAddrListIndex=iscsi2FcPortFCAddrListIndex, iscsiGigEIfEntry=iscsiGigEIfEntry, iscsiInitiatorIdleTimeout=iscsiInitiatorIdleTimeout, iscsiGigEIfIscsiSessions=iscsiGigEIfIscsiSessions, iscsi2FcNodeIndex=iscsi2FcNodeIndex, iscsiIfTcpMaxBandwidth=iscsiIfTcpMaxBandwidth, cigSessionStatsGroup=cigSessionStatsGroup, cigIscsiAuthGroupSup1=cigIscsiAuthGroupSup1, iscsi2FcNodeName=iscsi2FcNodeName, ciscoiScsiGwMIBObjects=ciscoiScsiGwMIBObjects, CIscsiIntrIdentificationMode=CIscsiIntrIdentificationMode, ciscoiScsiGwMIBCompliance3=ciscoiScsiGwMIBCompliance3, cigConfigurationGroupSup1=cigConfigurationGroupSup1, iscsiIfTcpLocalPort=iscsiIfTcpLocalPort, iscsiImprtExprtTgtsConfImport=iscsiImprtExprtTgtsConfImport, cigIscsiIfGroupRev3=cigIscsiIfGroupRev3, iscsiNodeNameListTable=iscsiNodeNameListTable, iscsi2FcNodeRole=iscsi2FcNodeRole, iscsiSessionAttributesExtEntry=iscsiSessionAttributesExtEntry, iscsiIfTcpPMTUResetTimeout=iscsiIfTcpPMTUResetTimeout, iscsiAuthMethod=iscsiAuthMethod, ciscoiScsiGwMIBCompliance2=ciscoiScsiGwMIBCompliance2, cIscsiStatsNodeIndex=cIscsiStatsNodeIndex, iscsi2FcNodeTable=iscsi2FcNodeTable, iscsiNodeName=iscsiNodeName, iscsiIfIntrProxyMode=iscsiIfIntrProxyMode, cigConfigurationGroupRev2=cigConfigurationGroupRev2, iscsi2FcPortPersistentFCAddr=iscsi2FcPortPersistentFCAddr, cigIscsiIfGroupRev1=cigIscsiIfGroupRev1, iscsi2FcNodePersistentFCAddr=iscsi2FcNodePersistentFCAddr, iscsiIfTcpMaxRetransmissions=iscsiIfTcpMaxRetransmissions, ciscoiScsiGwMIBCompliance4=ciscoiScsiGwMIBCompliance4, scsiLuExtLocalTargetAddress=scsiLuExtLocalTargetAddress, cigConnectionStatsGroup=cigConnectionStatsGroup, iscsiIfTable=iscsiIfTable, iscsiIfIntrIdentificationMode=iscsiIfIntrIdentificationMode, iscsiIfEntry=iscsiIfEntry, iscsiImprtExprtTgtsConfTable=iscsiImprtExprtTgtsConfTable, fc2IscsiNodeDiscovered=fc2IscsiNodeDiscovered, ciscoiScsiGwMIBConformance=ciscoiScsiGwMIBConformance, iscsi2FcPortNumFCAddr=iscsi2FcPortNumFCAddr, cigLuConfigurationGroupRev1=cigLuConfigurationGroupRev1, iscsi2FcTargetUserName=iscsi2FcTargetUserName, iscsiIfTcpSendBufferSize=iscsiIfTcpSendBufferSize, ciscsiConnectionStatsEntry=ciscsiConnectionStatsEntry, fc2IscsiNodeAllIntrAccessAllowed=fc2IscsiNodeAllIntrAccessAllowed, fc2IscsiNodeRevertToPrimaryPort=fc2IscsiNodeRevertToPrimaryPort, iscsiNodeNameRowStatus=iscsiNodeNameRowStatus, iscsiIfTcpPMTUEnable=iscsiIfTcpPMTUEnable, iscsiIfTcpLocalTcpPort=iscsiIfTcpLocalTcpPort, cigIscsiGigEIfGroup=cigIscsiGigEIfGroup, iscsiIfTcpCWMEnable=iscsiIfTcpCWMEnable, iscsiNodeNameListIndex=iscsiNodeNameListIndex, ciscoiScsiGwMIBCompliance5=ciscoiScsiGwMIBCompliance5, nodeAdvIntfListEntry=nodeAdvIntfListEntry, iscsiTargetPassword=iscsiTargetPassword, fcSecondaryAddress=fcSecondaryAddress, iscsiIfTcpKeepAliveTimeout=iscsiIfTcpKeepAliveTimeout, cigIscsiIfGroup=cigIscsiIfGroup, scsiLuExtRemoteSecLun=scsiLuExtRemoteSecLun, iscsi2FcNodeEntry=iscsi2FcNodeEntry, scsiLuExtRowStatus=scsiLuExtRowStatus, iscsiIfNumDiscovConnections=iscsiIfNumDiscovConnections, iscsiIfNumNormalConnections=iscsiIfNumNormalConnections, scsiLuExtEntry=scsiLuExtEntry, cigIscsiAuthGroup=cigIscsiAuthGroup, iscsiImprtExprtTgtsConfExport=iscsiImprtExprtTgtsConfExport, iscsiSessionAttributesExtTable=iscsiSessionAttributesExtTable, cigConfigurationGroup=cigConfigurationGroup, ciscoIscsiGwMIB=ciscoIscsiGwMIB, iscsi2FcNodeFCAddr=iscsi2FcNodeFCAddr, iscsiIfTcpQOS=iscsiIfTcpQOS, nodeAdvIntfListTable=nodeAdvIntfListTable, fc2IscsiNodeTrespassMode=fc2IscsiNodeTrespassMode, iscsiIfTcpCWMBurstSize=iscsiIfTcpCWMBurstSize, nodeAdvIntfListIndex=nodeAdvIntfListIndex, iscsiGigEIfAuthMethod=iscsiGigEIfAuthMethod, iscsiIfIntrProxyModeNodeFcAddr=iscsiIfIntrProxyModeNodeFcAddr, iscsiTargetUserName=iscsiTargetUserName, fcAddressListEntry=fcAddressListEntry, ciscsiConnectionStatsTable=ciscsiConnectionStatsTable, cigIscsiIfGroupRev4=cigIscsiIfGroupRev4, ciScsiConfig=ciScsiConfig, ciscoiScsiGwMIBCompliance1=ciscoiScsiGwMIBCompliance1, fc2IscsiPortFCAddrListIndex=fc2IscsiPortFCAddrListIndex, iscsiNodeNameListEntry=iscsiNodeNameListEntry, fc2IscsiNodeRole=fc2IscsiNodeRole, iscsi2FcNodeVsanList4k=iscsi2FcNodeVsanList4k, iscsiIfTcpMinRetransmitTime=iscsiIfTcpMinRetransmitTime, cIscsiStatsIpSecInUse=cIscsiStatsIpSecInUse, iscsi2FcNodeRowStatus=iscsi2FcNodeRowStatus, iscsiIfTcpRndTrpTimeEst=iscsiIfTcpRndTrpTimeEst, iscsiIfTcpMaxJitter=iscsiIfTcpMaxJitter, cIscsiStatsConnectionIndex=cIscsiStatsConnectionIndex, fc2IscsiNodePermitListIndex=fc2IscsiNodePermitListIndex, ciscoiScsiGwMIBCompliance=ciscoiScsiGwMIBCompliance, nodeAdvIntfIndex=nodeAdvIntfIndex, cIscsiStatsConnectionRxBytes=cIscsiStatsConnectionRxBytes, iscsiNodeNameIndex=iscsiNodeNameIndex, scsiLuExtRemotePortFcAddress=scsiLuExtRemotePortFcAddress, fc2IscsiNodeEntry=fc2IscsiNodeEntry, scsiLuExtTable=scsiLuExtTable, iscsi2FcNodeVsanList2k=iscsi2FcNodeVsanList2k, iscsi2FcNodeDiscovered=iscsi2FcNodeDiscovered, iscsi2FcNodeAuthUser=iscsi2FcNodeAuthUser, iscsiSsnVsan=iscsiSsnVsan, scsiLuExtRemotePortSecFcAddress=scsiLuExtRemotePortSecFcAddress, iscsiGigEIfIsnsServerProfileName=iscsiGigEIfIsnsServerProfileName, nodeAdvIntfIfIndex=nodeAdvIntfIfIndex, iscsi2FcNodeFcAddrAssignment=iscsi2FcNodeFcAddrAssignment, iscsiIfForwardingMode=iscsiIfForwardingMode, nodeAdvIntfIfRowStatus=nodeAdvIntfIfRowStatus, iscsiIfIntrProxyModePortFcAddr=iscsiIfIntrProxyModePortFcAddr, IscsiAuthMethod=IscsiAuthMethod, cigConfigurationGroupRev1=cigConfigurationGroupRev1, iscsi2FcTargetPassword=iscsi2FcTargetPassword)
