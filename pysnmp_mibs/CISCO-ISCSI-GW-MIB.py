...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ISCSI-GW-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:23:00 2025
...
_IscsiImprtExprtTgtsConfImport_Type.__name__ = "CIscsiTargetDomains"
...
_IscsiImprtExprtTgtsConfExport_Type.__name__ = "CIscsiTargetDomains"
...
_IscsiAuthMethod_Type.__name__ = "IscsiAuthMethod"
...
_Iscsi2FcNodeVsanList2k_Type.__name__ = "FcList"
...
_Iscsi2FcNodeVsanList4k_Type.__name__ = "FcList"
...
_Iscsi2FcNodeAuthUser_Type.__name__ = "SnmpAdminString"
...
_Iscsi2FcTargetUserName_Type.__name__ = "SnmpAdminString"
...
_Iscsi2FcTargetPassword_Type.__name__ = "SnmpAdminString"
...
_Fc2IscsiNodeAllIntrAccessAllowed_Type.__name__ = "TruthValue"
...
_Fc2IscsiNodeTrespassMode_Type.__name__ = "TruthValue"
...
_Fc2IscsiNodeRevertToPrimaryPort_Type.__name__ = "TruthValue"
...
_FcSecondaryAddress_Type.__name__ = "FcNameIdOrZero"
...
_ScsiLuExtRemotePortSecFcAddress_Type.__name__ = "FcNameIdOrZero"
...
_IscsiIfTcpCWMEnable_Type.__name__ = "TruthValue"
...
_IscsiTargetUserName_Type.__name__ = "SnmpAdminString"
...
_IscsiTargetPassword_Type.__name__ = "SnmpAdminString"
...
ciscoiScsiGwMIBCompliance.setObjects(
      *(("CISCO-ISCSI-GW-MIB", "cigConfigurationGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigLuConfigurationGroup"))
)
if mibBuilder.loadTexts:
...
ciscoiScsiGwMIBCompliance1.setObjects(
      *(("CISCO-ISCSI-GW-MIB", "cigConfigurationGroupRev1"),
        ("CISCO-ISCSI-GW-MIB", "cigSessionStatsGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiIfGroup"),
...
ciscoiScsiGwMIBCompliance2.setObjects(
      *(("CISCO-ISCSI-GW-MIB", "cigConfigurationGroupRev2"),
        ("CISCO-ISCSI-GW-MIB", "cigSessionStatsGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiIfGroupRev1"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiAuthGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiGigEIfGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigLuConfigurationGroupRev1"))
)
if mibBuilder.loadTexts:
...
ciscoiScsiGwMIBCompliance3.setObjects(
      *(("CISCO-ISCSI-GW-MIB", "cigConfigurationGroupRev3"),
        ("CISCO-ISCSI-GW-MIB", "cigSessionStatsGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiIfGroupRev3"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiAuthGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiGigEIfGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigLuConfigurationGroupRev1"))
)
...
ciscoiScsiGwMIBCompliance4.setObjects(
      *(("CISCO-ISCSI-GW-MIB", "cigConfigurationGroupRev3"),
        ("CISCO-ISCSI-GW-MIB", "cigSessionStatsGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiIfGroupRev4"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiAuthGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiGigEIfGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigLuConfigurationGroupRev1"))
)
...
ciscoiScsiGwMIBCompliance5.setObjects(
      *(("CISCO-ISCSI-GW-MIB", "cigConfigurationGroupRev3"),
        ("CISCO-ISCSI-GW-MIB", "cigConfigurationGroupSup1"),
        ("CISCO-ISCSI-GW-MIB", "cigSessionStatsGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiIfGroupRev4"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiIfGroupSup1"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiAuthGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiAuthGroupSup1"),
        ("CISCO-ISCSI-GW-MIB", "cigIscsiGigEIfGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigConnectionStatsGroup"),
        ("CISCO-ISCSI-GW-MIB", "cigLuConfigurationGroupRev1"))
)
if mibBuilder.loadTexts:
