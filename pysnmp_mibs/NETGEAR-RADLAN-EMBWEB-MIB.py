# SNMP MIB module (NETGEAR-RADLAN-EMBWEB-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-EMBWEB-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:27:30 2025
...
rlEmWebSecurityEntry = _RlEmWebSecurityEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 66, 3, 1)
)
rlEmWebSecurityEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-EMBWEB-MIB", "rlEmWebSecurityUserName"),
)
if mibBuilder.loadTexts:
...
rlEmWebServiceEntry = _RlEmWebServiceEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 66, 30, 1)
)
rlEmWebServiceEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-EMBWEB-MIB", "rlEmWebServiceId"),
)
if mibBuilder.loadTexts:
