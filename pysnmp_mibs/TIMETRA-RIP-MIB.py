...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-RIP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:00:49 2025
...
if mibBuilder.loadTexts:
    vRtrRipInstanceExpLmtLogPercent.setUnits("percent")
...
class _VRtrRipInstanceBfdEnable_Type(TruthValue):
    """Custom type vRtrRipInstanceBfdEnable based on TruthValue"""
    defaultValue = 2


_VRtrRipInstanceBfdEnable_Type.__name__ = "TruthValue"
_VRtrRipInstanceBfdEnable_Object = MibTableColumn
vRtrRipInstanceBfdEnable = _VRtrRipInstanceBfdEnable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 9, 2, 1, 31),
    _VRtrRipInstanceBfdEnable_Type()
)
vRtrRipInstanceBfdEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrRipInstanceBfdEnable.setStatus("current")
...
class _VRtrRipGroupBfdEnable_Type(TruthValue):
    """Custom type vRtrRipGroupBfdEnable based on TruthValue"""
    defaultValue = 2


_VRtrRipGroupBfdEnable_Type.__name__ = "TruthValue"
_VRtrRipGroupBfdEnable_Object = MibTableColumn
vRtrRipGroupBfdEnable = _VRtrRipGroupBfdEnable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 9, 3, 1, 30),
    _VRtrRipGroupBfdEnable_Type()
)
vRtrRipGroupBfdEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrRipGroupBfdEnable.setStatus("current")
...
class _VRtrRipIfBfdEnable_Type(TruthValue):
    """Custom type vRtrRipIfBfdEnable based on TruthValue"""
    defaultValue = 2


_VRtrRipIfBfdEnable_Type.__name__ = "TruthValue"
_VRtrRipIfBfdEnable_Object = MibTableColumn
vRtrRipIfBfdEnable = _VRtrRipIfBfdEnable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 9, 4, 1, 30),
    _VRtrRipIfBfdEnable_Type()
)
vRtrRipIfBfdEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrRipIfBfdEnable.setStatus("current")
...
tmnxRipV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 9, 2, 13)
)
tmnxRipV16v0Group.setObjects(
      *(("TIMETRA-RIP-MIB", "vRtrRipInstanceBfdEnable"),
        ("TIMETRA-RIP-MIB", "vRtrRipGroupBfdEnable"),
        ("TIMETRA-RIP-MIB", "vRtrRipIfBfdEnable"))
)
if mibBuilder.loadTexts:
    tmnxRipV16v0Group.setStatus("current")
...
vRtrRipPeerBfdDown = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 9, 0, 8)
)
vRtrRipPeerBfdDown.setObjects(
    ("TIMETRA-RIP-MIB", "vRtrRipPeerLastUpdate")
)
if mibBuilder.loadTexts:
    vRtrRipPeerBfdDown.setStatus(
        "current"
    )
...
tmnxRipNotificationV16v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 9, 2, 14)
)
tmnxRipNotificationV16v0Group.setObjects(
    ("TIMETRA-RIP-MIB", "vRtrRipPeerBfdDown")
)
if mibBuilder.loadTexts:
    tmnxRipNotificationV16v0Group.setStatus(
        "current"
    )
...
tmnxRipComplianceV16v0Group = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 9, 1, 2)
)
tmnxRipComplianceV16v0Group.setObjects(
      *(("TIMETRA-RIP-MIB", "tmnxRipV16v0Group"),
        ("TIMETRA-RIP-MIB", "tmnxRipNotificationV16v0Group"))
)
if mibBuilder.loadTexts:
    tmnxRipComplianceV16v0Group.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TmnxRipAuthType": TmnxRipAuthType,
       ...
       "tmnxRipComplianceV16v0Group": tmnxRipComplianceV16v0Group,
       ...
       "tmnxRipV16v0Group": tmnxRipV16v0Group,
       "tmnxRipNotificationV16v0Group": tmnxRipNotificationV16v0Group,
       ...
       "vRtrRipInstanceBfdEnable": vRtrRipInstanceBfdEnable,
       ...
       "vRtrRipGroupBfdEnable": vRtrRipGroupBfdEnable,
       ...
       "vRtrRipIfBfdEnable": vRtrRipIfBfdEnable,
       ...
       "vRtrRipPeerBfdDown": vRtrRipPeerBfdDown}
)
