...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/zhone/ZHONE-MAU-MIB
...
InterfaceIndexOrZero, ifName, ifIndex, ifAdminStatus, ifOperStatus = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero", "ifName", "ifIndex", "ifAdminStatus", "ifOperStatus")
...
mibBuilder.exportSymbols("ZHONE-MAU-MIB", zhoneMauMediaAvailable=zhoneMauMediaAvailable, zhoneLinkAggPartnerSystem=zhoneLinkAggPartnerSystem, zhoneMauMediaAvailStateExits=zhoneMauMediaAvailStateExits, zhoneMauIfIndex=zhoneMauIfIndex, zhoneMauEgressRate=zhoneMauEgressRate, zhoneMauAutoNegEntry=zhoneMauAutoNegEntry, zhoneMauAutoNegCapabilityBits=zhoneMauAutoNegCapabilityBits, zhoneMauSetPauseTime=zhoneMauSetPauseTime, zhoneLinkAggIfIndex=zhoneLinkAggIfIndex, zhoneMauAutoNegRemoteFaultRecv=zhoneMauAutoNegRemoteFaultRecv, zhoneMauPauseFlowControl=zhoneMauPauseFlowControl, enetV2Traps=enetV2Traps, zhoneMauMaxFrameSize=zhoneMauMaxFrameSize, zhoneMauAutoNegCapAdvertBits=zhoneMauAutoNegCapAdvertBits, zhoneMauDefaultType=zhoneMauDefaultType, rprWestSpanTrap=rprWestSpanTrap, linkAggLink1Trap=linkAggLink1Trap, zhoneIfMauTable=zhoneIfMauTable, zhoneMauType=zhoneMauType, zhoneMauFalseCarriers=zhoneMauFalseCarriers, zhoneMauAutoNegRemoteFaultAdvert=zhoneMauAutoNegRemoteFaultAdvert, rprEastSpanTrap=rprEastSpanTrap, zhoneLinkAggEntry=zhoneLinkAggEntry, zhoneMauTypeListBits=zhoneMauTypeListBits, zhoneMauAutoNegConfig=zhoneMauAutoNegConfig, zhoneLinkAggPartnerSystemPriority=zhoneLinkAggPartnerSystemPriority, zhoneMauClkSrc=zhoneMauClkSrc, zhoneMauJabberState=zhoneMauJabberState, zhoneMauEgressBurstSize=zhoneMauEgressBurstSize, zhoneLinkAggTable=zhoneLinkAggTable, zhoneMauAutoNegSupported=zhoneMauAutoNegSupported, zhoneEnetTraps=zhoneEnetTraps, zhoneMauOperStatus=zhoneMauOperStatus, zhoneMauAutoNegCapRecvBits=zhoneMauAutoNegCapRecvBits, linkAggLinkGroup=linkAggLinkGroup, zhoneLinkAggPartnerGroupId=zhoneLinkAggPartnerGroupId, zhoneMauLinkStateMirror=zhoneMauLinkStateMirror, zhoneIfMauEntry=zhoneIfMauEntry, zhoneMauAutoNegTable=zhoneMauAutoNegTable, zhoneMauAggregationMode=zhoneMauAggregationMode, zhoneMauIngressRate=zhoneMauIngressRate, rprSpanGroup=rprSpanGroup, phyEnetMauMib=phyEnetMauMib, zhoneMauIngressBurstSize=zhoneMauIngressBurstSize, linkAggLink2Trap=linkAggLink2Trap, zhoneMauAutoNegAdminStatus=zhoneMauAutoNegAdminStatus, zhoneMauAutoNegRemoteSignaling=zhoneMauAutoNegRemoteSignaling, zhoneMauAutoNegRestart=zhoneMauAutoNegRestart, zhoneMauJabberingStateEnters=zhoneMauJabberingStateEnters, PYSNMP_MODULE_ID=phyEnetMauMib)
