# SNMP MIB module (ARICENT-PTP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-PTP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:44:52 2025
...
fsPtpContextId = _FsPtpContextId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 1, 4, 1, 1),
...
fsPtpAdminStatus = _FsPtpAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 1, 4, 1, 2),
...
fsPtpTraceOption = _FsPtpTraceOption_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 1, 4, 1, 3),
...
fsPtpContextType = _FsPtpContextType_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 1, 4, 1, 4),
...
fsPtpPrimaryDomain = _FsPtpPrimaryDomain_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 1, 4, 1, 5),
...
fsPtpContextRowStatus = _FsPtpContextRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 1, 4, 1, 6),
...
fsPtpDomainDataSetEntry = _FsPtpDomainDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 2, 1, 1)
)
fsPtpDomainDataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
)
if mibBuilder.loadTexts:
...
fsPtpDomainNumber = _FsPtpDomainNumber_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 2, 1, 1, 1),
...
fsPtpDomainClockMode = _FsPtpDomainClockMode_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 2, 1, 1, 2),
...
fsPtpDomainClockIdentity = _FsPtpDomainClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 2, 1, 1, 3),
...
fsPtpDomainGMClusterQueryInterval = _FsPtpDomainGMClusterQueryInterval_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 2, 1, 1, 4),
...
fsPtpDomainRowStatus = _FsPtpDomainRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 2, 1, 1, 5),
...
fsPtpClockDataSetEntry = _FsPtpClockDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1)
)
if mibBuilder.loadTexts:
...
fsPtpClockIdentity = _FsPtpClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 1),
...
fsPtpClockTwoStepFlag = _FsPtpClockTwoStepFlag_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 2),
...
fsPtpClockNumberPorts = _FsPtpClockNumberPorts_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 3),
...
fsPtpClockClass = _FsPtpClockClass_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 4),
...
fsPtpClockAccuracy = _FsPtpClockAccuracy_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 5),
...
fsPtpClockOffsetScaledLogVariance = _FsPtpClockOffsetScaledLogVariance_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 6),
...
fsPtpClockPriority1 = _FsPtpClockPriority1_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 7),
...
fsPtpClockPriority2 = _FsPtpClockPriority2_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 8),
...
fsPtpClockSlaveOnly = _FsPtpClockSlaveOnly_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 9),
...
fsPtpClockPathTraceOption = _FsPtpClockPathTraceOption_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 10),
...
fsPtpClockAccMasterMaxSize = _FsPtpClockAccMasterMaxSize_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 11),
...
fsPtpClockSecurityEnabled = _FsPtpClockSecurityEnabled_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 12),
...
fsPtpClockNumOfSA = _FsPtpClockNumOfSA_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 3, 1, 1, 13),
...
fsPtpCurrentDataSetEntry = _FsPtpCurrentDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 4, 1, 1)
)
if mibBuilder.loadTexts:
...
fsPtpCurrentStepsRemoved = _FsPtpCurrentStepsRemoved_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 4, 1, 1, 1),
...
fsPtpCurrentOffsetFromMaster = _FsPtpCurrentOffsetFromMaster_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 4, 1, 1, 2),
...
fsPtpCurrentMeanPathDelay = _FsPtpCurrentMeanPathDelay_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 4, 1, 1, 3),
...
fsPtpCurrentMasterToSlaveDelay = _FsPtpCurrentMasterToSlaveDelay_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 4, 1, 1, 4),
...
fsPtpCurrentSlaveToMasterDelay = _FsPtpCurrentSlaveToMasterDelay_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 4, 1, 1, 5),
...
fsPtpParentDataSetEntry = _FsPtpParentDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1)
)
if mibBuilder.loadTexts:
...
fsPtpParentClockIdentity = _FsPtpParentClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 1),
...
fsPtpParentPortNumber = _FsPtpParentPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 2),
...
fsPtpParentStats = _FsPtpParentStats_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 3),
...
fsPtpParentObservedOffsetScaledLogVariance = _FsPtpParentObservedOffsetScaledLogVariance_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 4),
...
fsPtpParentObservedClockPhaseChangeRate = _FsPtpParentObservedClockPhaseChangeRate_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 5),
...
fsPtpParentGMClockIdentity = _FsPtpParentGMClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 6),
...
fsPtpParentGMClockClass = _FsPtpParentGMClockClass_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 7),
...
fsPtpParentGMClockAccuracy = _FsPtpParentGMClockAccuracy_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 8),
...
fsPtpParentGMClockOffsetScaledLogVariance = _FsPtpParentGMClockOffsetScaledLogVariance_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 9),
...
fsPtpParentGMPriority1 = _FsPtpParentGMPriority1_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 10),
...
fsPtpParentGMPriority2 = _FsPtpParentGMPriority2_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 11),
...
fsPtpParentClockObservedDrift = _FsPtpParentClockObservedDrift_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 5, 1, 1, 12),
...
fsPtpTimeDataSetEntry = _FsPtpTimeDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 6, 1, 1)
)
if mibBuilder.loadTexts:
...
fsPtpTimeCurrentUTCOffset = _FsPtpTimeCurrentUTCOffset_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 6, 1, 1, 1),
...
fsPtpTimeCurrentUTCOffsetValid = _FsPtpTimeCurrentUTCOffsetValid_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 6, 1, 1, 2),
...
fsPtpTimeLeap59 = _FsPtpTimeLeap59_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 6, 1, 1, 3),
...
fsPtpTimeLeap61 = _FsPtpTimeLeap61_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 6, 1, 1, 4),
...
fsPtpTimeTimeTraceable = _FsPtpTimeTimeTraceable_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 6, 1, 1, 5),
...
fsPtpTimeFrequencyTraceable = _FsPtpTimeFrequencyTraceable_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 6, 1, 1, 6),
...
fsPtpTimeTimeSource = _FsPtpTimeTimeSource_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 6, 1, 1, 7),
...
fsPtpPortConfigDataSetEntry = _FsPtpPortConfigDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1)
)
fsPtpPortConfigDataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
    (0, "ARICENT-PTP-MIB", "fsPtpPortIndex"),
)
if mibBuilder.loadTexts:
...
fsPtpPortIndex = _FsPtpPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 1),
...
fsPtpPortClockIdentity = _FsPtpPortClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 2),
...
fsPtpPortInterfaceType = _FsPtpPortInterfaceType_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 3),
...
fsPtpPortIfaceNumber = _FsPtpPortIfaceNumber_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 4),
...
fsPtpPortState = _FsPtpPortState_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 5),
...
fsPtpPortMinDelayReqInterval = _FsPtpPortMinDelayReqInterval_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 6),
...
fsPtpPortPeerMeanPathDelay = _FsPtpPortPeerMeanPathDelay_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 7),
...
fsPtpPortAnnounceInterval = _FsPtpPortAnnounceInterval_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 8),
...
fsPtpPortAnnounceReceiptTimeout = _FsPtpPortAnnounceReceiptTimeout_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 9),
...
fsPtpPortSyncInterval = _FsPtpPortSyncInterval_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 10),
...
fsPtpPortSynclimit = _FsPtpPortSynclimit_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 11),
...
fsPtpPortDelayMechanism = _FsPtpPortDelayMechanism_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 12),
...
fsPtpPortMinPdelayReqInterval = _FsPtpPortMinPdelayReqInterval_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 13),
...
fsPtpPortVersionNumber = _FsPtpPortVersionNumber_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 14),
...
fsPtpPortUnicastNegOption = _FsPtpPortUnicastNegOption_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 15),
...
fsPtpPortUnicastMasterMaxSize = _FsPtpPortUnicastMasterMaxSize_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 16),
...
fsPtpPortAccMasterEnabled = _FsPtpPortAccMasterEnabled_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 17),
...
fsPtpPortNumOfAltMaster = _FsPtpPortNumOfAltMaster_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 18),
...
fsPtpPortAltMulcastSync = _FsPtpPortAltMulcastSync_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 19),
...
fsPtpPortAltMulcastSyncInterval = _FsPtpPortAltMulcastSyncInterval_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 20),
...
fsPtpPortPtpStatus = _FsPtpPortPtpStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 21),
...
fsPtpPortRcvdAnnounceMsgCnt = _FsPtpPortRcvdAnnounceMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 22),
...
fsPtpPortRcvdSyncMsgCnt = _FsPtpPortRcvdSyncMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 23),
...
fsPtpPortRcvdDelayReqMsgCnt = _FsPtpPortRcvdDelayReqMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 24),
...
fsPtpPortRcvdDelayRespMsgCnt = _FsPtpPortRcvdDelayRespMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 25),
...
fsPtpPortTransDelayReqMsgCnt = _FsPtpPortTransDelayReqMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 26),
...
fsPtpPortDiscardedMsgCnt = _FsPtpPortDiscardedMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 27),
...
fsPtpPortTransAnnounceMsgCnt = _FsPtpPortTransAnnounceMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 28),
    _FsPtpPortTransAnnounceMsgCnt_Type()
)
fsPtpPortTransAnnounceMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortTransAnnounceMsgCnt.setStatus("current")
_FsPtpPortTransSyncMsgCnt_Type = Unsigned32
_FsPtpPortTransSyncMsgCnt_Object = MibTableColumn
fsPtpPortTransSyncMsgCnt = _FsPtpPortTransSyncMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 29),
    _FsPtpPortTransSyncMsgCnt_Type()
)
fsPtpPortTransSyncMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortTransSyncMsgCnt.setStatus("current")
_FsPtpPortRcvdPeerDelayReqMsgCnt_Type = Unsigned32
_FsPtpPortRcvdPeerDelayReqMsgCnt_Object = MibTableColumn
fsPtpPortRcvdPeerDelayReqMsgCnt = _FsPtpPortRcvdPeerDelayReqMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 30),
    _FsPtpPortRcvdPeerDelayReqMsgCnt_Type()
)
fsPtpPortRcvdPeerDelayReqMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortRcvdPeerDelayReqMsgCnt.setStatus("current")
_FsPtpPortTransPeerDelayReqMsgCnt_Type = Unsigned32
_FsPtpPortTransPeerDelayReqMsgCnt_Object = MibTableColumn
fsPtpPortTransPeerDelayReqMsgCnt = _FsPtpPortTransPeerDelayReqMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 31),
    _FsPtpPortTransPeerDelayReqMsgCnt_Type()
)
fsPtpPortTransPeerDelayReqMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortTransPeerDelayReqMsgCnt.setStatus("current")
_FsPtpPortRcvdPeerDelayRespMsgCnt_Type = Unsigned32
_FsPtpPortRcvdPeerDelayRespMsgCnt_Object = MibTableColumn
fsPtpPortRcvdPeerDelayRespMsgCnt = _FsPtpPortRcvdPeerDelayRespMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 32),
    _FsPtpPortRcvdPeerDelayRespMsgCnt_Type()
)
fsPtpPortRcvdPeerDelayRespMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortRcvdPeerDelayRespMsgCnt.setStatus("current")
_FsPtpPortTransPeerDelayRespMsgCnt_Type = Unsigned32
_FsPtpPortTransPeerDelayRespMsgCnt_Object = MibTableColumn
fsPtpPortTransPeerDelayRespMsgCnt = _FsPtpPortTransPeerDelayRespMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 33),
    _FsPtpPortTransPeerDelayRespMsgCnt_Type()
)
fsPtpPortTransPeerDelayRespMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortTransPeerDelayRespMsgCnt.setStatus("current")
_FsPtpPortTransDelayRespMsgCnt_Type = Unsigned32
_FsPtpPortTransDelayRespMsgCnt_Object = MibTableColumn
fsPtpPortTransDelayRespMsgCnt = _FsPtpPortTransDelayRespMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 34),
    _FsPtpPortTransDelayRespMsgCnt_Type()
)
fsPtpPortTransDelayRespMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortTransDelayRespMsgCnt.setStatus("current")
...
fsPtpPortTransPeerDelayRespFollowUpMsgCnt = _FsPtpPortTransPeerDelayRespFollowUpMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 35),
    _FsPtpPortTransPeerDelayRespFollowUpMsgCnt_Type()
)
fsPtpPortTransPeerDelayRespFollowUpMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortTransPeerDelayRespFollowUpMsgCnt.setStatus("current")
_FsPtpPortTransFollowUpMsgCnt_Type = Unsigned32
_FsPtpPortTransFollowUpMsgCnt_Object = MibTableColumn
fsPtpPortTransFollowUpMsgCnt = _FsPtpPortTransFollowUpMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 36),
    _FsPtpPortTransFollowUpMsgCnt_Type()
)
fsPtpPortTransFollowUpMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortTransFollowUpMsgCnt.setStatus("current")
_FsPtpPortRcvdPeerDelayRespFollowUpMsgCnt_Type = Unsigned32
_FsPtpPortRcvdPeerDelayRespFollowUpMsgCnt_Object = MibTableColumn
fsPtpPortRcvdPeerDelayRespFollowUpMsgCnt = _FsPtpPortRcvdPeerDelayRespFollowUpMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 37),
    _FsPtpPortRcvdPeerDelayRespFollowUpMsgCnt_Type()
)
fsPtpPortRcvdPeerDelayRespFollowUpMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortRcvdPeerDelayRespFollowUpMsgCnt.setStatus("current")
_FsPtpPortRcvdFollowUpMsgCnt_Type = Unsigned32
_FsPtpPortRcvdFollowUpMsgCnt_Object = MibTableColumn
fsPtpPortRcvdFollowUpMsgCnt = _FsPtpPortRcvdFollowUpMsgCnt_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 38),
    _FsPtpPortRcvdFollowUpMsgCnt_Type()
)
fsPtpPortRcvdFollowUpMsgCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPtpPortRcvdFollowUpMsgCnt.setStatus("current")
_FsPtpPortRowStatus_Type = RowStatus
_FsPtpPortRowStatus_Object = MibTableColumn
fsPtpPortRowStatus = _FsPtpPortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 7, 1, 1, 39),
...
fsPtpForeignMasterDataSetEntry = _FsPtpForeignMasterDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 8, 1, 1)
)
fsPtpForeignMasterDataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
    (0, "ARICENT-PTP-MIB", "fsPtpForeignMasterClockIdentity"),
    (0, "ARICENT-PTP-MIB", "fsPtpForeignMasterPortIndex"),
    (0, "ARICENT-PTP-MIB", "fsPtpPortIndex"),
)
if mibBuilder.loadTexts:
...
fsPtpForeignMasterClockIdentity = _FsPtpForeignMasterClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 8, 1, 1, 1),
...
fsPtpForeignMasterPortIndex = _FsPtpForeignMasterPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 8, 1, 1, 2),
...
fsPtpForeignMasterAnnounceMsgs = _FsPtpForeignMasterAnnounceMsgs_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 8, 1, 1, 3),
...
fsPtpTransparentDataSetEntry = _FsPtpTransparentDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 9, 1, 1)
)
if mibBuilder.loadTexts:
...
fsPtpTransparentClockIdentity = _FsPtpTransparentClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 9, 1, 1, 1),
...
fsPtpTransparentClockTwoStepFlag = _FsPtpTransparentClockTwoStepFlag_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 9, 1, 1, 2),
...
fsPtpTransparentClockNumberPorts = _FsPtpTransparentClockNumberPorts_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 9, 1, 1, 3),
...
fsPtpTransparentClockDelaymechanism = _FsPtpTransparentClockDelaymechanism_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 9, 1, 1, 4),
...
fsPtpTransparentClockPrimaryDomain = _FsPtpTransparentClockPrimaryDomain_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 9, 1, 1, 5),
...
fsPtpTransparentPortDataSetEntry = _FsPtpTransparentPortDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1)
)
fsPtpTransparentPortDataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
    (0, "ARICENT-PTP-MIB", "fsPtpTransparentPortIndex"),
)
if mibBuilder.loadTexts:
...
fsPtpTransparentPortIndex = _FsPtpTransparentPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1, 1),
...
fsPtpTransparentPortInterfaceType = _FsPtpTransparentPortInterfaceType_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1, 2),
...
fsPtpTransparentPortIfaceNumber = _FsPtpTransparentPortIfaceNumber_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1, 3),
...
fsPtpTransparentPortClockIdentity = _FsPtpTransparentPortClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1, 4),
...
fsPtpTransparentPortMinPdelayReqInterval = _FsPtpTransparentPortMinPdelayReqInterval_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1, 5),
...
fsPtpTransparentPortFaultyFlag = _FsPtpTransparentPortFaultyFlag_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1, 6),
...
fsPtpTransparentPortPeerMeanPathDelay = _FsPtpTransparentPortPeerMeanPathDelay_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1, 7),
...
fsPtpTransparentPortPtpStatus = _FsPtpTransparentPortPtpStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1, 8),
...
fsPtpTransparentPortRowStatus = _FsPtpTransparentPortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 10, 1, 1, 9),
...
fsPtpGrandMasterClusterDataSetEntry = _FsPtpGrandMasterClusterDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 11, 1, 1)
)
fsPtpGrandMasterClusterDataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
    (0, "ARICENT-PTP-MIB", "fsPtpGrandMasterClusterNetworkProtocol"),
    (0, "ARICENT-PTP-MIB", "fsPtpGrandMasterClusterAddLength"),
    (0, "ARICENT-PTP-MIB", "fsPtpGrandMasterClusterAddr"),
)
if mibBuilder.loadTexts:
...
fsPtpGrandMasterClusterNetworkProtocol = _FsPtpGrandMasterClusterNetworkProtocol_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 11, 1, 1, 1),
...
fsPtpGrandMasterClusterAddLength = _FsPtpGrandMasterClusterAddLength_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 11, 1, 1, 2),
...
fsPtpGrandMasterClusterAddr = _FsPtpGrandMasterClusterAddr_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 11, 1, 1, 3),
...
fsPtpGrandMasterClusterRowStatus = _FsPtpGrandMasterClusterRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 11, 1, 1, 4),
...
fsPtpUnicastMasterDataSetEntry = _FsPtpUnicastMasterDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 12, 1, 1)
)
fsPtpUnicastMasterDataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
    (0, "ARICENT-PTP-MIB", "fsPtpPortIndex"),
    (0, "ARICENT-PTP-MIB", "fsPtpUnicastMasterNetworkProtocol"),
    (0, "ARICENT-PTP-MIB", "fsPtpUnicastMasterAddLength"),
    (0, "ARICENT-PTP-MIB", "fsPtpUnicastMasterAddr"),
)
if mibBuilder.loadTexts:
...
fsPtpUnicastMasterNetworkProtocol = _FsPtpUnicastMasterNetworkProtocol_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 12, 1, 1, 1),
...
fsPtpUnicastMasterAddLength = _FsPtpUnicastMasterAddLength_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 12, 1, 1, 2),
...
fsPtpUnicastMasterAddr = _FsPtpUnicastMasterAddr_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 12, 1, 1, 3),
...
fsPtpUnicastMasterRowStatus = _FsPtpUnicastMasterRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 12, 1, 1, 4),
...
fsPtpAccMasterDataSetEntry = _FsPtpAccMasterDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 13, 1, 1)
)
fsPtpAccMasterDataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
    (0, "ARICENT-PTP-MIB", "fsPtpAccMasterNetworkProtocol"),
    (0, "ARICENT-PTP-MIB", "fsPtpAccMasterAddLength"),
    (0, "ARICENT-PTP-MIB", "fsPtpAccMasterAddr"),
)
if mibBuilder.loadTexts:
...
fsPtpAccMasterNetworkProtocol = _FsPtpAccMasterNetworkProtocol_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 13, 1, 1, 1),
...
fsPtpAccMasterAddLength = _FsPtpAccMasterAddLength_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 13, 1, 1, 2),
...
fsPtpAccMasterAddr = _FsPtpAccMasterAddr_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 13, 1, 1, 3),
...
fsPtpAccMasterAlternatePriority = _FsPtpAccMasterAlternatePriority_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 13, 1, 1, 4),
...
fsPtpAccMasterRowStatus = _FsPtpAccMasterRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 13, 1, 1, 5),
...
fsPtpSecKeyDataSetEntry = _FsPtpSecKeyDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 14, 1, 1)
)
fsPtpSecKeyDataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
    (0, "ARICENT-PTP-MIB", "fsPtpSecKeyId"),
)
if mibBuilder.loadTexts:
...
fsPtpSecKeyId = _FsPtpSecKeyId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 14, 1, 1, 1),
    _FsPtpSecKeyId_Type()
)
...
fsPtpSecKeyAlgorithmId = _FsPtpSecKeyAlgorithmId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 14, 1, 1, 2),
...
fsPtpSecKeyLength = _FsPtpSecKeyLength_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 14, 1, 1, 3),
...
fsPtpSecKey = _FsPtpSecKey_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 14, 1, 1, 4),
    _FsPtpSecKey_Type()
)
...
fsPtpSecKeyStartTime = _FsPtpSecKeyStartTime_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 14, 1, 1, 5),
...
fsPtpSecKeyExpirationTime = _FsPtpSecKeyExpirationTime_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 14, 1, 1, 6),
...
fsPtpSecKeyValid = _FsPtpSecKeyValid_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 14, 1, 1, 7),
...
fsPtpSADataSetEntry = _FsPtpSADataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1)
)
fsPtpSADataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
    (0, "ARICENT-PTP-MIB", "fsPtpSAId"),
)
if mibBuilder.loadTexts:
...
fsPtpSAId = _FsPtpSAId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 1),
    _FsPtpSAId_Type()
)
...
fsPtpSASrcPortNumber = _FsPtpSASrcPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 2),
...
fsPtpSASrcAddrLength = _FsPtpSASrcAddrLength_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 3),
...
fsPtpSASrcAddr = _FsPtpSASrcAddr_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 4),
...
fsPtpSADstPortNumber = _FsPtpSADstPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 5),
...
fsPtpSADstAddrLength = _FsPtpSADstAddrLength_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 6),
...
fsPtpSADstAddr = _FsPtpSADstAddr_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 7),
...
fsPtpSASrcClockIdentity = _FsPtpSASrcClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 8),
...
fsPtpSADstClockIdentity = _FsPtpSADstClockIdentity_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 9),
...
fsPtpSAReplayCounter = _FsPtpSAReplayCounter_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 10),
...
fsPtpSALifeTimeId = _FsPtpSALifeTimeId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 11),
...
fsPtpSAKeyId = _FsPtpSAKeyId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 12),
    _FsPtpSAKeyId_Type()
)
...
fsPtpSANextLifeTimeId = _FsPtpSANextLifeTimeId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 13),
...
fsPtpSANextKeyId = _FsPtpSANextKeyId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 14),
...
fsPtpSATrustState = _FsPtpSATrustState_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 15),
...
fsPtpSATrustTimer = _FsPtpSATrustTimer_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 16),
...
fsPtpSATrustTimeout = _FsPtpSATrustTimeout_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 17),
...
fsPtpSAChallengeState = _FsPtpSAChallengeState_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 18),
...
fsPtpSAChallengeTimer = _FsPtpSAChallengeTimer_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 19),
...
fsPtpSAChallengeTimeOut = _FsPtpSAChallengeTimeOut_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 20),
...
fsPtpSARequestNonce = _FsPtpSARequestNonce_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 21),
...
fsPtpSAResponseNonce = _FsPtpSAResponseNonce_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 22),
...
fsPtpSAChallengeRequired = _FsPtpSAChallengeRequired_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 23),
...
fsPtpSAResponseRequired = _FsPtpSAResponseRequired_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 24),
...
fsPtpSATypeField = _FsPtpSATypeField_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 25),
...
fsPtpSADirection = _FsPtpSADirection_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 26),
...
fsPtpSARowStatus = _FsPtpSARowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 15, 1, 1, 27),
...
fsPtpAltTimeScaleDataSetEntry = _FsPtpAltTimeScaleDataSetEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 16, 1, 1)
)
fsPtpAltTimeScaleDataSetEntry.setIndexNames(
    (0, "ARICENT-PTP-MIB", "fsPtpContextId"),
    (0, "ARICENT-PTP-MIB", "fsPtpDomainNumber"),
    (0, "ARICENT-PTP-MIB", "fsPtpAltTimeScaleKeyId"),
)
if mibBuilder.loadTexts:
...
fsPtpAltTimeScaleKeyId = _FsPtpAltTimeScaleKeyId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 16, 1, 1, 1),
...
fsPtpAltTimeScalecurrentOffset = _FsPtpAltTimeScalecurrentOffset_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 16, 1, 1, 2),
...
fsPtpAltTimeScalejumpSeconds = _FsPtpAltTimeScalejumpSeconds_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 16, 1, 1, 3),
...
fsPtpAltTimeScaletimeOfNextJump = _FsPtpAltTimeScaletimeOfNextJump_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 16, 1, 1, 4),
...
fsPtpAltTimeScaledisplayName = _FsPtpAltTimeScaledisplayName_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 16, 1, 1, 5),
...
fsPtpAltTimeScaleRowStatus = _FsPtpAltTimeScaleRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 1, 16, 1, 1, 6),
...
fsPtpPortStateChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 2, 0, 1)
)
fsPtpPortStateChangeTrap.setObjects(
      *(("ARICENT-PTP-MIB", "fsPtpTrapContextName"),
        ("ARICENT-PTP-MIB", "fsPtpPortState"))
)
if mibBuilder.loadTexts:
...
fsPtpGlobalErrorTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 2, 0, 2)
)
fsPtpGlobalErrorTrap.setObjects(
    ("ARICENT-PTP-MIB", "fsPtpGlobalErrTrapType")
)
if mibBuilder.loadTexts:
...
fsPtpAdminChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 2, 0, 3)
)
fsPtpAdminChangeTrap.setObjects(
      *(("ARICENT-PTP-MIB", "fsPtpTrapContextName"),
        ("ARICENT-PTP-MIB", "fsPtpAdminStatus"))
)
if mibBuilder.loadTexts:
...
fsPtpSysCtrlChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 2, 0, 4)
)
fsPtpSysCtrlChangeTrap.setObjects(
      *(("ARICENT-PTP-MIB", "fsPtpTrapContextName"),
        ("ARICENT-PTP-MIB", "fsPtpContextRowStatus"))
)
if mibBuilder.loadTexts:
...
fsPtpUnicastOptionTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 2, 0, 5)
)
fsPtpUnicastOptionTrap.setObjects(
      *(("ARICENT-PTP-MIB", "fsPtpTrapContextName"),
        ("ARICENT-PTP-MIB", "fsPtpPortUnicastNegOption"))
)
if mibBuilder.loadTexts:
...
fsPtpPortPtpStatusTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 2, 0, 6)
)
fsPtpPortPtpStatusTrap.setObjects(
      *(("ARICENT-PTP-MIB", "fsPtpTrapContextName"),
        ("ARICENT-PTP-MIB", "fsPtpPortPtpStatus"))
)
if mibBuilder.loadTexts:
...
fsPtpSyncFaultTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 29601, 2, 45, 2, 0, 7)
)
fsPtpSyncFaultTrap.setObjects(
      *(("ARICENT-PTP-MIB", "fsPtpTrapContextName"),
        ("ARICENT-PTP-MIB", "fsPtpTrapDomainNumber"),
        ("ARICENT-PTP-MIB", "fsPtpGlobalErrTrapType"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"FsPtpPortNumber": FsPtpPortNumber,
       ...
       "fsPtpPortTransAnnounceMsgCnt": fsPtpPortTransAnnounceMsgCnt,
       "fsPtpPortTransSyncMsgCnt": fsPtpPortTransSyncMsgCnt,
       "fsPtpPortRcvdPeerDelayReqMsgCnt": fsPtpPortRcvdPeerDelayReqMsgCnt,
       "fsPtpPortTransPeerDelayReqMsgCnt": fsPtpPortTransPeerDelayReqMsgCnt,
       "fsPtpPortRcvdPeerDelayRespMsgCnt": fsPtpPortRcvdPeerDelayRespMsgCnt,
       "fsPtpPortTransPeerDelayRespMsgCnt": fsPtpPortTransPeerDelayRespMsgCnt,
       "fsPtpPortTransDelayRespMsgCnt": fsPtpPortTransDelayRespMsgCnt,
       "fsPtpPortTransPeerDelayRespFollowUpMsgCnt": fsPtpPortTransPeerDelayRespFollowUpMsgCnt,
       "fsPtpPortTransFollowUpMsgCnt": fsPtpPortTransFollowUpMsgCnt,
       "fsPtpPortRcvdPeerDelayRespFollowUpMsgCnt": fsPtpPortRcvdPeerDelayRespFollowUpMsgCnt,
       "fsPtpPortRcvdFollowUpMsgCnt": fsPtpPortRcvdFollowUpMsgCnt,
