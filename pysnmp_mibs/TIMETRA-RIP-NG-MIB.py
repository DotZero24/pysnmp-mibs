...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-RIP-NG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:53:34 2025
...
(TItemDescription,
 ...
 TmnxOperState,
 TmnxRipNgAuthKey,
 TmnxRipNgAuthType) = mibBuilder.importSymbols(
    "TIMETRA-TC-MIB",
    "TItemDescription",
    "TNamedItem",
    "TNamedItemOrEmpty",
...
if mibBuilder.loadTexts:
    tmnxRipNgInstExpLmtLogPct.setUnits("percent")
...
class _TmnxRipNgInstBfdEnable_Type(TruthValue):
    """Custom type tmnxRipNgInstBfdEnable based on TruthValue"""
    defaultValue = 2


_TmnxRipNgInstBfdEnable_Type.__name__ = "TruthValue"
_TmnxRipNgInstBfdEnable_Object = MibTableColumn
tmnxRipNgInstBfdEnable = _TmnxRipNgInstBfdEnable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 89, 2, 1, 1, 32),
    _TmnxRipNgInstBfdEnable_Type()
)
tmnxRipNgInstBfdEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRipNgInstBfdEnable.setStatus("current")
...
class _TmnxRipNgGroupBfdEnable_Type(TruthValue):
    """Custom type tmnxRipNgGroupBfdEnable based on TruthValue"""
    defaultValue = 2


_TmnxRipNgGroupBfdEnable_Type.__name__ = "TruthValue"
_TmnxRipNgGroupBfdEnable_Object = MibTableColumn
tmnxRipNgGroupBfdEnable = _TmnxRipNgGroupBfdEnable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 89, 2, 2, 1, 30),
    _TmnxRipNgGroupBfdEnable_Type()
)
tmnxRipNgGroupBfdEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRipNgGroupBfdEnable.setStatus("current")
...
class _TmnxRipNgIfBfdEnable_Type(TruthValue):
    """Custom type tmnxRipNgIfBfdEnable based on TruthValue"""
    defaultValue = 2


_TmnxRipNgIfBfdEnable_Type.__name__ = "TruthValue"
_TmnxRipNgIfBfdEnable_Object = MibTableColumn
tmnxRipNgIfBfdEnable = _TmnxRipNgIfBfdEnable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 89, 2, 3, 1, 30),
    _TmnxRipNgIfBfdEnable_Type()
)
tmnxRipNgIfBfdEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxRipNgIfBfdEnable.setStatus("current")
...
tmnxRipNgV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 89, 2, 9)
)
tmnxRipNgV16v0Group.setObjects(
      *(("TIMETRA-RIP-NG-MIB", "tmnxRipNgInstBfdEnable"),
        ("TIMETRA-RIP-NG-MIB", "tmnxRipNgGroupBfdEnable"),
        ("TIMETRA-RIP-NG-MIB", "tmnxRipNgIfBfdEnable"))
)
if mibBuilder.loadTexts:
    tmnxRipNgV16v0Group.setStatus("current")
...
tmnxRipNgPeerBfdDown = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 89, 0, 9)
)
tmnxRipNgPeerBfdDown.setObjects(
    ("TIMETRA-RIP-NG-MIB", "tmnxRipNgPeerLastUpdate")
)
if mibBuilder.loadTexts:
    tmnxRipNgPeerBfdDown.setStatus(
        "current"
    )
...
tmnxRipNgNotificationV16v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 89, 2, 10)
)
tmnxRipNgNotificationV16v0Group.setObjects(
    ("TIMETRA-RIP-NG-MIB", "tmnxRipNgPeerBfdDown")
)
if mibBuilder.loadTexts:
    tmnxRipNgNotificationV16v0Group.setStatus(
        "current"
    )
...
tmnxRipNgV16v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 89, 1, 2)
)
tmnxRipNgV16v0Compliance.setObjects(
      *(("TIMETRA-RIP-NG-MIB", "tmnxRipNgV16v0Group"),
        ("TIMETRA-RIP-NG-MIB", "tmnxRipNgNotificationV16v0Group"))
)
if mibBuilder.loadTexts:
    tmnxRipNgV16v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TmnxRipNgInstVersion": TmnxRipNgInstVersion,
       ...
       "tmnxRipNgV16v0Compliance": tmnxRipNgV16v0Compliance,
       ...
       "tmnxRipNgV16v0Group": tmnxRipNgV16v0Group,
       "tmnxRipNgNotificationV16v0Group": tmnxRipNgNotificationV16v0Group,
       ...
       "tmnxRipNgInstBfdEnable": tmnxRipNgInstBfdEnable,
       ...
       "tmnxRipNgGroupBfdEnable": tmnxRipNgGroupBfdEnable,
       ...
       "tmnxRipNgIfBfdEnable": tmnxRipNgIfBfdEnable,
       ...
       "tmnxRipNgPeerBfdDown": tmnxRipNgPeerBfdDown}
)
