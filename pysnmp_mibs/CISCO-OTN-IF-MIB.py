...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-OTN-IF-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:28:38 2025
...
mibBuilder.exportSymbols("CISCO-OTN-IF-MIB", coiFECIntervalPreFECMax=coiFECIntervalPreFECMax, coiOtnFarEndIntervalBBEs=coiOtnFarEndIntervalBBEs, coiFECThreshType=coiFECThreshType, coiFECThreshIntervalType=coiFECThreshIntervalType, CoiMonitorType=CoiMonitorType, coiOtnFarEndThreshStorageType=coiOtnFarEndThreshStorageType, CoiOtnThresholdType=CoiOtnThresholdType, coiIfOtnNotifEnableGroup=coiIfOtnNotifEnableGroup, coiOtnFarEndThreshMonType=coiOtnFarEndThreshMonType, coiFECIntervalValidData=coiFECIntervalValidData, coiIfControllerQMargin=coiIfControllerQMargin, coiIfControllerTable=coiIfControllerTable, coiOtnFarEndIntervalBBERs=coiOtnFarEndIntervalBBERs, coiFECCurrentPostFECAvg=coiFECCurrentPostFECAvg, ciscoOtnIfMIBCompliance2=ciscoOtnIfMIBCompliance2, coiFECIntervalPostFECMax=coiFECIntervalPostFECMax, coiIfFECCurrentGroup1=coiIfFECCurrentGroup1, coiOtnNearEndIntervalSESRs=coiOtnNearEndIntervalSESRs, coiOtnFarEndIntervalFCs=coiOtnFarEndIntervalFCs, coiDwdmInterface=coiDwdmInterface, coiOtnFarEndThresholdsEntry=coiOtnFarEndThresholdsEntry, coiFECIntervalPostFECMin=coiFECIntervalPostFECMin, coiFECThreshStatus=coiFECThreshStatus, coiIfOtnNotifStatusObjectGroup=coiIfOtnNotifStatusObjectGroup, coiOtnFarEndIntervalNum=coiOtnFarEndIntervalNum, coiOtnNearEndCurrentESs=coiOtnNearEndCurrentESs, coiOtnNearEndIntervalFCs=coiOtnNearEndIntervalFCs, coiFECCurrentDetZeroErrs=coiFECCurrentDetZeroErrs, coiOtnFarEndThresholdsTable=coiOtnFarEndThresholdsTable, coiIfFECGroup=coiIfFECGroup, coiOtnFarEndIntervalTable=coiOtnFarEndIntervalTable, coiOtnFarEndIntervalUASs=coiOtnFarEndIntervalUASs, coiOtnNearEndIntervalESs=coiOtnNearEndIntervalESs, coiOtnIfNotifEnabled=coiOtnIfNotifEnabled, coiOtnNearEndIntervalNum=coiOtnNearEndIntervalNum, coiIfControllerPreFECBERExponent=coiIfControllerPreFECBERExponent, coiOtnFarEndThresholdType=coiOtnFarEndThresholdType, PYSNMP_MODULE_ID=ciscoOtnIfMIB, coiOtnFarEndIntervalType=coiOtnFarEndIntervalType, coiFECIntervalEntry=coiFECIntervalEntry, coiIfFECIntervalGroup=coiIfFECIntervalGroup, coiOtnFarEndCurrentSESs=coiOtnFarEndCurrentSESs, coiOtnFarEndIntervalValidData=coiOtnFarEndIntervalValidData, coiOtnFarEndCurrentUASs=coiOtnFarEndCurrentUASs, ciscoOtnIfMIBGroups=ciscoOtnIfMIBGroups, coiOtnFarEndIntervalESs=coiOtnFarEndIntervalESs, coiOtnIfODUStatus=coiOtnIfODUStatus, coiOtnNearEndIntervalSESs=coiOtnNearEndIntervalSESs, coiFECCurrentDetOneErrs=coiFECCurrentDetOneErrs, coiIfFECIntervalGroup1=coiIfFECIntervalGroup1, coiOtnFarEndIntervalESRs=coiOtnFarEndIntervalESRs, coiOtnFarEndThreshValue=coiOtnFarEndThreshValue, coiFECCurrentPostFECMin=coiFECCurrentPostFECMin, coiIfOtnNearEndCurrentGroup=coiIfOtnNearEndCurrentGroup, coiIfOtnFarEndIntervalGroup=coiIfOtnFarEndIntervalGroup, coiIfOtnNearEndIntervalGroup=coiIfOtnNearEndIntervalGroup, coiIfOtnNotifGroup=coiIfOtnNotifGroup, coiOtnFarEndIntervalSESs=coiOtnFarEndIntervalSESs, coiIfControllerEntry=coiIfControllerEntry, coiFECCurrentQFactorMin=coiFECCurrentQFactorMin, coiFECIntervalCorByteErrs=coiFECIntervalCorByteErrs, coiDwdmIfOtn=coiDwdmIfOtn, coiFECCurrentQMarginMin=coiFECCurrentQMarginMin, coiOtnNearEndThresholdsEntry=coiOtnNearEndThresholdsEntry, coiFECIntervalQMarginMax=coiFECIntervalQMarginMax, coiOtnNearEndCurrentMonType=coiOtnNearEndCurrentMonType, coiIfControllerOTNValidIntervals=coiIfControllerOTNValidIntervals, coiOtnIfOTUStatusChange=coiOtnIfOTUStatusChange, coiFECIntervalUncorWords=coiFECIntervalUncorWords, coiOtnNearEndIntervalUASs=coiOtnNearEndIntervalUASs, coiOtnNearEndCurrentEntry=coiOtnNearEndCurrentEntry, coiIfOtnGroup=coiIfOtnGroup, coiOtnNearEndIntervalESRs=coiOtnNearEndIntervalESRs, ciscoOtnIfMIBNotifs=ciscoOtnIfMIBNotifs, coiOtnFarEndCurIntervalType=coiOtnFarEndCurIntervalType, coiFECIntervalPreFECAvg=coiFECIntervalPreFECAvg, coiFECIntervalQMarginMin=coiFECIntervalQMarginMin, coiIfControllerLoopback=coiIfControllerLoopback, coiOtnNearEndIntervalTable=coiOtnNearEndIntervalTable, coiFECCurrentCorBitErrs=coiFECCurrentCorBitErrs, coiIfControllerTDCOperStatus=coiIfControllerTDCOperStatus, coiFECCurrentQFactorAvg=coiFECCurrentQFactorAvg, coiOtnNearEndCurrentSESs=coiOtnNearEndCurrentSESs, coiFECIntervalQMarginAvg=coiFECIntervalQMarginAvg, coiOtnFarEndThreshStatus=coiOtnFarEndThreshStatus, coiOtnFarEndCurrentEntry=coiOtnFarEndCurrentEntry, coiFECIntervalPreFECMin=coiFECIntervalPreFECMin, coiFECIntervalQFactorMax=coiFECIntervalQFactorMax, ciscoOtnIfMIBCompliance1=ciscoOtnIfMIBCompliance1, coiOtnNearEndThreshMonType=coiOtnNearEndThreshMonType, coiFECCurrentQFactorMax=coiFECCurrentQFactorMax, coiOtnFarEndThreshIntervalType=coiOtnFarEndThreshIntervalType, coiOtnNearEndCurrentFCs=coiOtnNearEndCurrentFCs, coiOtnNearEndThreshStatus=coiOtnNearEndThreshStatus, coiOtnIfODUStatusChange=coiOtnIfODUStatusChange, coiOtnNearEndIntervalBBEs=coiOtnNearEndIntervalBBEs, coiFECIntervalDetOneErrs=coiFECIntervalDetOneErrs, coiFECCurrentPostFECMax=coiFECCurrentPostFECMax, coiFECThreshStorageType=coiFECThreshStorageType, coiOtnFarEndIntervalEntry=coiOtnFarEndIntervalEntry, coiFECCurrentPreFECMin=coiFECCurrentPreFECMin, coiIfControllerQFactor=coiIfControllerQFactor, coiFECThresholdsEntry=coiFECThresholdsEntry, ciscoOtnIfMIBCompliances=ciscoOtnIfMIBCompliances, coiOtnFarEndCurrentFCs=coiOtnFarEndCurrentFCs, coiFECThresholdsTable=coiFECThresholdsTable, coiFECIntervalNum=coiFECIntervalNum, coiOtnNearEndThresholdType=coiOtnNearEndThresholdType, coiIfControllerFECMode=coiIfControllerFECMode, coiOtnFarEndCurrentSESRs=coiOtnFarEndCurrentSESRs, coiOtnIfOTUStatus=coiOtnIfOTUStatus, coiFECIntervalDetZeroErrs=coiFECIntervalDetZeroErrs, CoiIntervalType=CoiIntervalType, coiOtnNearEndCurrentTable=coiOtnNearEndCurrentTable, coiIfControllerGroup=coiIfControllerGroup, coiOtnNearEndCurrentESRs=coiOtnNearEndCurrentESRs, coiIfControllerFECValidIntervals=coiIfControllerFECValidIntervals, coiOtnNearEndCurrentBBERs=coiOtnNearEndCurrentBBERs, coiOtnNearEndCurrentBBEs=coiOtnNearEndCurrentBBEs, coiIfFECCurrentGroup=coiIfFECCurrentGroup, coiOtnNearEndThresholdsTable=coiOtnNearEndThresholdsTable, ciscoOtnIfMIB=ciscoOtnIfMIB, coiFECIntervalQFactorMin=coiFECIntervalQFactorMin, coiOtnNearEndIntervalEntry=coiOtnNearEndIntervalEntry, coiIfOtnFarEndCurrentGroup=coiIfOtnFarEndCurrentGroup, coiFECCurrentUncorWords=coiFECCurrentUncorWords, coiFECIntervalPostFECAvg=coiFECIntervalPostFECAvg, coiOtnNearEndIntervalBBERs=coiOtnNearEndIntervalBBERs, coiFECCurIntervalType=coiFECCurIntervalType, ciscoOtnIfMIBObjects=ciscoOtnIfMIBObjects, coiIfControllerOtnStatus=coiIfControllerOtnStatus, coiOtnFarEndIntervalSESRs=coiOtnFarEndIntervalSESRs, coiOtnNearEndThreshStorageType=coiOtnNearEndThreshStorageType, coiDwdmIfFEC=coiDwdmIfFEC, coiOtnFarEndCurrentESRs=coiOtnFarEndCurrentESRs, coiFECIntervalTable=coiFECIntervalTable, coiOtnNearEndIntervalValidData=coiOtnNearEndIntervalValidData, coiIfControllerTDCOperSetting=coiIfControllerTDCOperSetting, coiOtnNearEndThreshIntervalType=coiOtnNearEndThreshIntervalType, coiIfControllerPreFECBERMantissa=coiIfControllerPreFECBERMantissa, coiOtnFarEndCurrentMonType=coiOtnFarEndCurrentMonType, coiOtnFarEndCurrentBBEs=coiOtnFarEndCurrentBBEs, coiOtnNearEndIntervalType=coiOtnNearEndIntervalType, coiFECThreshValue=coiFECThreshValue, ciscoOtnIfMIBConformance=ciscoOtnIfMIBConformance, CoiOpticalWavelength=CoiOpticalWavelength, coiOtnFarEndCurrentESs=coiOtnFarEndCurrentESs, coiOtnNearEndIntervalMonType=coiOtnNearEndIntervalMonType, coiIfControllerWavelength=coiIfControllerWavelength, coiFECCurrentEntry=coiFECCurrentEntry, ciscoOtnIfMIBCompliance=ciscoOtnIfMIBCompliance, coiFECCurrentQMarginAvg=coiFECCurrentQMarginAvg, coiOtnNearEndCurrentSESRs=coiOtnNearEndCurrentSESRs, coiFECIntervalCorBitErrs=coiFECIntervalCorBitErrs, coiOtnNearEndCurrentUASs=coiOtnNearEndCurrentUASs, coiOtnFarEndIntervalMonType=coiOtnFarEndIntervalMonType, coiOtnFarEndCurrentTable=coiOtnFarEndCurrentTable, coiFECCurrentQMarginMax=coiFECCurrentQMarginMax, coiOtnNearEndThreshValue=coiOtnNearEndThreshValue, coiIfControllerLaserAdminStatus=coiIfControllerLaserAdminStatus, coiOtnNearEndCurIntervalType=coiOtnNearEndCurIntervalType, coiFECCurrentPreFECMax=coiFECCurrentPreFECMax, coiFECCurrentPreFECAvg=coiFECCurrentPreFECAvg, coiIfControllerTDCOperMode=coiIfControllerTDCOperMode, coiFECIntervalType=coiFECIntervalType, coiOtnFarEndCurrentBBERs=coiOtnFarEndCurrentBBERs, coiFECIntervalQFactorAvg=coiFECIntervalQFactorAvg, coiFECCurrentTable=coiFECCurrentTable, coiFECCurrentCorByteErrs=coiFECCurrentCorByteErrs, coiIfControllerLaserOperStatus=coiIfControllerLaserOperStatus)
