...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-OTN-IF-MIB
...
_CoiIfControllerWavelength_Type.__name__ = "CoiOpticalWavelength"
...
_CoiIfControllerOtnStatus_Type.__name__ = "TruthValue"
...
_CoiOtnNearEndThreshStorageType_Type.__name__ = "StorageType"
...
_CoiOtnFarEndThreshStorageType_Type.__name__ = "StorageType"
...
_CoiFECThreshStorageType_Type.__name__ = "StorageType"
...
ciscoOtnIfMIBCompliance.setObjects(
      *(("CISCO-OTN-IF-MIB", "coiIfControllerGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfFECGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNearEndCurrentGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNearEndIntervalGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnFarEndCurrentGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnFarEndIntervalGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfFECCurrentGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfFECIntervalGroup"))
)
if mibBuilder.loadTexts:
...
ciscoOtnIfMIBCompliance1.setObjects(
      *(("CISCO-OTN-IF-MIB", "coiIfControllerGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfFECGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNearEndCurrentGroup"),
        ...
        ("CISCO-OTN-IF-MIB", "coiIfFECCurrentGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfFECIntervalGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNotifGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNotifEnableGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNotifStatusObjectGroup"))
)
if mibBuilder.loadTexts:
...
ciscoOtnIfMIBCompliance2.setObjects(
      *(("CISCO-OTN-IF-MIB", "coiIfControllerGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfFECGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNearEndCurrentGroup"),
        ...
        ("CISCO-OTN-IF-MIB", "coiIfOtnFarEndCurrentGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnFarEndIntervalGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfFECCurrentGroup1"),
        ("CISCO-OTN-IF-MIB", "coiIfFECIntervalGroup1"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNotifGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNotifEnableGroup"),
        ("CISCO-OTN-IF-MIB", "coiIfOtnNotifStatusObjectGroup"))
)
