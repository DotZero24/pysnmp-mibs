...
mibBuilder.exportSymbols("CISCO-OTN-IF-MIB", coiIfControllerOTNValidIntervals=coiIfControllerOTNValidIntervals, coiFECThresholdsEntry=coiFECThresholdsEntry, coiOtnNearEndIntervalType=coiOtnNearEndIntervalType, coiIfFECCurrentGroup1=coiIfFECCurrentGroup1, coiOtnNearEndCurIntervalType=coiOtnNearEndCurIntervalType, coiOtnFarEndCurIntervalType=coiOtnFarEndCurIntervalType, coiOtnNearEndIntervalNum=coiOtnNearEndIntervalNum, coiDwdmIfOtn=coiDwdmIfOtn, coiFECIntervalQMarginMax=coiFECIntervalQMarginMax, coiIfControllerTDCOperMode=coiIfControllerTDCOperMode, coiOtnNearEndIntervalESs=coiOtnNearEndIntervalESs, coiOtnNearEndThresholdsEntry=coiOtnNearEndThresholdsEntry, coiIfControllerQFactor=coiIfControllerQFactor, coiOtnNearEndCurrentBBEs=coiOtnNearEndCurrentBBEs, coiIfControllerQMargin=coiIfControllerQMargin, coiFECIntervalCorByteErrs=coiFECIntervalCorByteErrs, coiIfFECIntervalGroup1=coiIfFECIntervalGroup1, coiOtnFarEndIntervalSESs=coiOtnFarEndIntervalSESs, coiOtnIfOTUStatus=coiOtnIfOTUStatus, coiFECIntervalPreFECMin=coiFECIntervalPreFECMin, coiOtnFarEndThresholdsEntry=coiOtnFarEndThresholdsEntry, coiFECThresholdsTable=coiFECThresholdsTable, coiOtnNearEndIntervalBBEs=coiOtnNearEndIntervalBBEs, coiOtnNearEndIntervalMonType=coiOtnNearEndIntervalMonType, CoiMonitorType=CoiMonitorType, coiOtnNearEndThreshStorageType=coiOtnNearEndThreshStorageType, coiOtnFarEndThreshMonType=coiOtnFarEndThreshMonType, ciscoOtnIfMIBConformance=ciscoOtnIfMIBConformance, ciscoOtnIfMIBNotifs=ciscoOtnIfMIBNotifs, coiOtnFarEndIntervalMonType=coiOtnFarEndIntervalMonType, coiOtnFarEndThreshValue=coiOtnFarEndThreshValue, PYSNMP_MODULE_ID=ciscoOtnIfMIB, coiOtnFarEndThreshStorageType=coiOtnFarEndThreshStorageType, coiFECCurrentCorByteErrs=coiFECCurrentCorByteErrs, coiOtnFarEndThresholdType=coiOtnFarEndThresholdType, coiOtnNearEndCurrentMonType=coiOtnNearEndCurrentMonType, coiIfControllerLaserAdminStatus=coiIfControllerLaserAdminStatus, coiIfOtnGroup=coiIfOtnGroup, coiOtnIfOTUStatusChange=coiOtnIfOTUStatusChange, ciscoOtnIfMIBObjects=ciscoOtnIfMIBObjects, coiIfControllerTable=coiIfControllerTable, coiOtnFarEndIntervalTable=coiOtnFarEndIntervalTable, coiOtnNearEndCurrentBBERs=coiOtnNearEndCurrentBBERs, coiOtnFarEndIntervalType=coiOtnFarEndIntervalType, coiFECIntervalUncorWords=coiFECIntervalUncorWords, coiOtnFarEndIntervalEntry=coiOtnFarEndIntervalEntry, coiOtnFarEndIntervalESRs=coiOtnFarEndIntervalESRs, coiFECIntervalNum=coiFECIntervalNum, coiOtnFarEndCurrentESs=coiOtnFarEndCurrentESs, coiFECIntervalPostFECMax=coiFECIntervalPostFECMax, coiOtnNearEndCurrentSESs=coiOtnNearEndCurrentSESs, coiIfControllerPreFECBERMantissa=coiIfControllerPreFECBERMantissa, coiFECCurrentPostFECAvg=coiFECCurrentPostFECAvg, coiFECCurrentTable=coiFECCurrentTable, CoiIntervalType=CoiIntervalType, coiOtnFarEndThreshStatus=coiOtnFarEndThreshStatus, coiIfControllerGroup=coiIfControllerGroup, coiOtnFarEndIntervalNum=coiOtnFarEndIntervalNum, coiIfOtnNotifGroup=coiIfOtnNotifGroup, coiIfControllerTDCOperSetting=coiIfControllerTDCOperSetting, coiOtnNearEndIntervalSESRs=coiOtnNearEndIntervalSESRs, coiFECCurrentUncorWords=coiFECCurrentUncorWords, coiOtnNearEndIntervalBBERs=coiOtnNearEndIntervalBBERs, coiFECCurrentPreFECMax=coiFECCurrentPreFECMax, coiIfControllerLaserOperStatus=coiIfControllerLaserOperStatus, coiOtnNearEndCurrentUASs=coiOtnNearEndCurrentUASs, coiOtnNearEndIntervalTable=coiOtnNearEndIntervalTable, coiOtnNearEndCurrentSESRs=coiOtnNearEndCurrentSESRs, coiOtnNearEndThreshIntervalType=coiOtnNearEndThreshIntervalType, coiIfFECIntervalGroup=coiIfFECIntervalGroup, ciscoOtnIfMIBCompliance2=ciscoOtnIfMIBCompliance2, coiOtnNearEndCurrentFCs=coiOtnNearEndCurrentFCs, coiFECCurrentPreFECMin=coiFECCurrentPreFECMin, coiIfOtnNotifEnableGroup=coiIfOtnNotifEnableGroup, coiFECIntervalDetOneErrs=coiFECIntervalDetOneErrs, coiFECThreshIntervalType=coiFECThreshIntervalType, coiFECIntervalPreFECMax=coiFECIntervalPreFECMax, coiFECIntervalQFactorMax=coiFECIntervalQFactorMax, coiOtnNearEndThresholdsTable=coiOtnNearEndThresholdsTable, coiFECIntervalPostFECMin=coiFECIntervalPostFECMin, coiOtnFarEndIntervalUASs=coiOtnFarEndIntervalUASs, coiOtnNearEndCurrentESRs=coiOtnNearEndCurrentESRs, coiDwdmInterface=coiDwdmInterface, coiFECIntervalType=coiFECIntervalType, coiFECCurrentPreFECAvg=coiFECCurrentPreFECAvg, coiOtnFarEndCurrentBBEs=coiOtnFarEndCurrentBBEs, coiFECIntervalTable=coiFECIntervalTable, coiFECIntervalQMarginMin=coiFECIntervalQMarginMin, coiOtnNearEndThreshStatus=coiOtnNearEndThreshStatus, CoiOtnThresholdType=CoiOtnThresholdType, coiFECIntervalCorBitErrs=coiFECIntervalCorBitErrs, coiFECCurrentQMarginMin=coiFECCurrentQMarginMin, coiFECCurrentQMarginAvg=coiFECCurrentQMarginAvg, ciscoOtnIfMIBCompliances=ciscoOtnIfMIBCompliances, coiOtnFarEndCurrentBBERs=coiOtnFarEndCurrentBBERs, coiOtnFarEndThreshIntervalType=coiOtnFarEndThreshIntervalType, coiOtnNearEndIntervalEntry=coiOtnNearEndIntervalEntry, coiIfFECCurrentGroup=coiIfFECCurrentGroup, coiOtnFarEndIntervalValidData=coiOtnFarEndIntervalValidData, coiIfOtnNearEndIntervalGroup=coiIfOtnNearEndIntervalGroup, coiFECIntervalPostFECAvg=coiFECIntervalPostFECAvg, coiOtnFarEndThresholdsTable=coiOtnFarEndThresholdsTable, coiFECCurrentDetZeroErrs=coiFECCurrentDetZeroErrs, coiFECIntervalPreFECAvg=coiFECIntervalPreFECAvg, coiFECCurrentDetOneErrs=coiFECCurrentDetOneErrs, coiIfFECGroup=coiIfFECGroup, coiIfOtnNotifStatusObjectGroup=coiIfOtnNotifStatusObjectGroup, coiFECIntervalQMarginAvg=coiFECIntervalQMarginAvg, coiIfControllerTDCOperStatus=coiIfControllerTDCOperStatus, coiOtnFarEndCurrentFCs=coiOtnFarEndCurrentFCs, coiIfOtnFarEndCurrentGroup=coiIfOtnFarEndCurrentGroup, coiFECCurIntervalType=coiFECCurIntervalType, coiIfControllerOtnStatus=coiIfControllerOtnStatus, ciscoOtnIfMIBCompliance1=ciscoOtnIfMIBCompliance1, coiFECThreshStatus=coiFECThreshStatus, coiOtnIfODUStatus=coiOtnIfODUStatus, coiOtnIfODUStatusChange=coiOtnIfODUStatusChange, ciscoOtnIfMIBGroups=ciscoOtnIfMIBGroups, coiOtnNearEndThresholdType=coiOtnNearEndThresholdType, coiOtnFarEndCurrentEntry=coiOtnFarEndCurrentEntry, coiFECIntervalDetZeroErrs=coiFECIntervalDetZeroErrs, coiOtnFarEndIntervalBBEs=coiOtnFarEndIntervalBBEs, coiOtnFarEndIntervalSESRs=coiOtnFarEndIntervalSESRs, coiOtnNearEndIntervalFCs=coiOtnNearEndIntervalFCs, ciscoOtnIfMIBCompliance=ciscoOtnIfMIBCompliance, coiOtnNearEndCurrentEntry=coiOtnNearEndCurrentEntry, coiFECIntervalQFactorMin=coiFECIntervalQFactorMin, coiOtnNearEndCurrentTable=coiOtnNearEndCurrentTable, coiOtnNearEndCurrentESs=coiOtnNearEndCurrentESs, coiFECCurrentPostFECMax=coiFECCurrentPostFECMax, coiOtnNearEndThreshValue=coiOtnNearEndThreshValue, CoiOpticalWavelength=CoiOpticalWavelength, coiFECThreshStorageType=coiFECThreshStorageType, coiIfControllerLoopback=coiIfControllerLoopback, coiFECThreshValue=coiFECThreshValue, coiDwdmIfFEC=coiDwdmIfFEC, coiIfControllerWavelength=coiIfControllerWavelength, coiFECThreshType=coiFECThreshType, coiFECIntervalValidData=coiFECIntervalValidData, coiOtnNearEndIntervalUASs=coiOtnNearEndIntervalUASs, coiIfControllerFECMode=coiIfControllerFECMode, ciscoOtnIfMIB=ciscoOtnIfMIB, coiOtnFarEndIntervalBBERs=coiOtnFarEndIntervalBBERs, coiFECCurrentQFactorMax=coiFECCurrentQFactorMax, coiIfOtnFarEndIntervalGroup=coiIfOtnFarEndIntervalGroup, coiOtnFarEndIntervalFCs=coiOtnFarEndIntervalFCs, coiOtnIfNotifEnabled=coiOtnIfNotifEnabled, coiFECIntervalEntry=coiFECIntervalEntry, coiOtnFarEndCurrentSESs=coiOtnFarEndCurrentSESs, coiOtnFarEndCurrentMonType=coiOtnFarEndCurrentMonType, coiFECCurrentCorBitErrs=coiFECCurrentCorBitErrs, coiFECCurrentEntry=coiFECCurrentEntry, coiOtnFarEndIntervalESs=coiOtnFarEndIntervalESs, coiOtnFarEndCurrentSESRs=coiOtnFarEndCurrentSESRs, coiIfControllerPreFECBERExponent=coiIfControllerPreFECBERExponent, coiOtnNearEndIntervalESRs=coiOtnNearEndIntervalESRs, coiFECCurrentQMarginMax=coiFECCurrentQMarginMax, coiFECCurrentQFactorMin=coiFECCurrentQFactorMin, coiOtnFarEndCurrentTable=coiOtnFarEndCurrentTable, coiIfOtnNearEndCurrentGroup=coiIfOtnNearEndCurrentGroup, coiFECCurrentQFactorAvg=coiFECCurrentQFactorAvg, coiOtnNearEndIntervalSESs=coiOtnNearEndIntervalSESs, coiIfControllerEntry=coiIfControllerEntry, coiIfControllerFECValidIntervals=coiIfControllerFECValidIntervals, coiOtnNearEndThreshMonType=coiOtnNearEndThreshMonType, coiOtnFarEndCurrentESRs=coiOtnFarEndCurrentESRs, coiOtnNearEndIntervalValidData=coiOtnNearEndIntervalValidData, coiFECCurrentPostFECMin=coiFECCurrentPostFECMin, coiOtnFarEndCurrentUASs=coiOtnFarEndCurrentUASs, coiFECIntervalQFactorAvg=coiFECIntervalQFactorAvg)
