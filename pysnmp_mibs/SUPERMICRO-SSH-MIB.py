# SNMP MIB module (SUPERMICRO-SSH-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-SSH-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:03:29 2025
...
sshMacList = _SshMacList_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 97, 1, 3),
    _SshMacList_Type()
)
...
sshStatus = _SshStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 97, 1, 5),
    _SshStatus_Type()
)
...
sshTransportMaxAllowedBytes = _SshTransportMaxAllowedBytes_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 97, 1, 6),
...
sshSrvBindAddr = _SshSrvBindAddr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 97, 1, 7),
...
sshServerBindPortNo = _SshServerBindPortNo_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 97, 1, 8),
