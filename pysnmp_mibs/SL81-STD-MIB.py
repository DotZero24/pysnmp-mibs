...
# Notes
# -----
# ASN.1 source file://mibs/asentria/SL81-STD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:19:43 2025
...
class _DeFieldIndex_Type(Integer32):
    """Custom type deFieldIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_DeFieldIndex_Type.__name__ = "Integer32"
...
class _DeConfigIndex_Type(Integer32):
    """Custom type deConfigIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 100),
    )
...
_DeConfigIndex_Type.__name__ = "Integer32"
...
class _SmIndex_Type(Integer32):
    """Custom type smIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_SmIndex_Type.__name__ = "Integer32"
...
class _PagerIndex_Type(Integer32):
    """Custom type pagerIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_PagerIndex_Type.__name__ = "Integer32"
...
sl81StockAuthFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 5, 0, 180)
)
sl81StockAuthFailTrap.setObjects(
      *(("SL81-STD-MIB", "siteID"),
        ("SL81-STD-MIB", "stockTrapString"))
)
if mibBuilder.loadTexts:
    sl81StockAuthFailTrap.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"omnitronix": omnitronix,
       ...
       "sl81StockAuthFailTrap": sl81StockAuthFailTrap,
