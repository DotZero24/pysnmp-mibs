...
mibBuilder.exportSymbols("ICT-PLATINUM-SERIES-MIB", deviceMacAddress=deviceMacAddress, batteryTestComplete=batteryTestComplete, fanFailAlarmClear=fanFailAlarmClear, acFailAlarmTrap=acFailAlarmTrap, commFailAlarmClear=commFailAlarmClear, deviceHardware=deviceHardware, dcFailAlarmTrap=dcFailAlarmTrap, sysFailAlarmTrap=sysFailAlarmTrap, outputVoltageX100=outputVoltageX100, outputCurrent=outputCurrent, outputEnable=outputEnable, batterySoc=batterySoc, batteryTestFail=batteryTestFail, batteryVoltageX100=batteryVoltageX100, deviceModel=deviceModel, outputCurrentX100=outputCurrentX100, inputVoltage=inputVoltage, deviceName=deviceName, batteryAlarmTrap=batteryAlarmTrap, batteryEqualizeComplete=batteryEqualizeComplete, batteryRunTime=batteryRunTime, batteryCurrentX100=batteryCurrentX100, dcFailAlarmClear=dcFailAlarmClear, batteryCurrentAlarmTrap=batteryCurrentAlarmTrap, inputVoltageX1=inputVoltageX1, batteryTemperature=batteryTemperature, overtemperatureAlarmTrap=overtemperatureAlarmTrap, batteryNetAh=batteryNetAh, deviceFirmware=deviceFirmware, commFailAlarmTrap=commFailAlarmTrap, batteryAlarmClear=batteryAlarmClear, ictPower=ictPower, outputVoltage=outputVoltage, batteryVoltage=batteryVoltage, platinumSeries=platinumSeries, fanFailAlarmTrap=fanFailAlarmTrap, overtemperatureAlarmClear=overtemperatureAlarmClear, batteryCurrent=batteryCurrent, sysFailAlarmClear=sysFailAlarmClear, batteryEqualizeStart=batteryEqualizeStart, acFailAlarmClear=acFailAlarmClear, batteryTestStart=batteryTestStart)
