# SNMP MIB module (ICT-PLATINUM-SERIES-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ict/ICT-PLATINUM-SERIES-MIB
...
batteryCurrentAlarmTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 39145, 11, 0, 108)
)
if mibBuilder.loadTexts:
    batteryCurrentAlarmTrap.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"ictPower": ictPower,
       ...
       "batteryCurrentAlarmTrap": batteryCurrentAlarmTrap,
