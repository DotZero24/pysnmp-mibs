...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:12:00 2025
...
vlanVoiceOUIEntry.setIndexNames(
    (0, "RADLAN-vlan-MIB", "vlanVoiceOUIPrefix"),
)
if mibBuilder.loadTexts:
...
vlanInetTriplePlayEntry.setIndexNames(
    (0, "RADLAN-vlan-MIB", "vlanInetTriplePlayInetAddressType"),
    (0, "RADLAN-vlan-MIB", "vlanTriplePlayInnerVID"),
)
if mibBuilder.loadTexts:
...
vlanPrivateEntry.setIndexNames(
    (0, "RADLAN-vlan-MIB", "vlanPrivateVid"),
)
if mibBuilder.loadTexts:
...
vlanPrivateMapEntry.setIndexNames(
    (0, "RADLAN-vlan-MIB", "vlanPrivateMapPrimaryVid"),
    (0, "RADLAN-vlan-MIB", "vlanPrivateMapSecondaryVid"),
)
if mibBuilder.loadTexts:
...
vlanRsvlMapEntry.setIndexNames(
    (0, "RADLAN-vlan-MIB", "vlanRsvlMapPrimaryVid"),
    (0, "RADLAN-vlan-MIB", "vlanRsvlMapSecondaryVid"),
)
if mibBuilder.loadTexts:
...
rldot1qVlanStaticListEntry.setIndexNames(
    (0, "RADLAN-vlan-MIB", "rldot1qVlanStaticListIndex"),
)
if mibBuilder.loadTexts:
