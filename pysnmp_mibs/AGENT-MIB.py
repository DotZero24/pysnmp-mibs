...
mibBuilder.exportSymbols("AGENT-MIB", agentGeneralMgmt=agentGeneralMgmt, agentMibCapabilityIndex=agentMibCapabilityIndex, agentStatusFileTransfer=agentStatusFileTransfer, agentBscSwFileEntry=agentBscSwFileEntry, agentBscSwFileTransferType=agentBscSwFileTransferType, agentIpGetIpFrom=agentIpGetIpFrom, agentMibCapabilityTable=agentMibCapabilityTable, agentTrustHostIndex=agentTrustHostIndex, agentBscSwFile=agentBscSwFile, agentARPMgmt=agentARPMgmt, agentPORTutilizationRX=agentPORTutilizationRX, PYSNMP_MODULE_ID=agentGeneralMgmt, agentIpNumOfIf=agentIpNumOfIf, agentBscSwFileLocateId=agentBscSwFileLocateId, agentTrustHostRowStatus=agentTrustHostRowStatus, agentFileTransfer=agentFileTransfer, agentFDBMgmt=agentFDBMgmt, agentPORTutilizationUtil=agentPORTutilizationUtil, agentPORTutilizationTable=agentPORTutilizationTable, agentARPClearAllState=agentARPClearAllState, agentPORTutilizationTX=agentPORTutilizationTX, agentConsoleModeManagerStopBits=agentConsoleModeManagerStopBits, agentConsoleModeManagerLogoutTime=agentConsoleModeManagerLogoutTime, agentBscSwFileLoadType=agentBscSwFileLoadType, agentConsoleModeManagerDataBits=agentConsoleModeManagerDataBits, agentPORTutilizationEntry=agentPORTutilizationEntry, agentConsoleModeManager=agentConsoleModeManager, agentMibCapabilityVersion=agentMibCapabilityVersion, agentBscSwFileAddr=agentBscSwFileAddr, agentStatusConsoleInUse=agentStatusConsoleInUse, agentBscSwFileIndex=agentBscSwFileIndex, agentTrustHostMgmt=agentTrustHostMgmt, agentStatusSaveCfg=agentStatusSaveCfg, agentSaveCfg=agentSaveCfg, agentBasicConfig=agentBasicConfig, agentTrustHostIPSubnetMask=agentTrustHostIPSubnetMask, agentPORTutilizationProtIndex=agentPORTutilizationProtIndex, agentConsoleModeManagerBaudRate=agentConsoleModeManagerBaudRate, agentIpProtoConfig=agentIpProtoConfig, agentMibCapabilityDescr=agentMibCapabilityDescr, agentTrustHostIPAddress=agentTrustHostIPAddress, agentConsoleModeManagerParity=agentConsoleModeManagerParity, agentBasicInfo=agentBasicInfo, agentTrustHostEntry=agentTrustHostEntry, agentSystemReset=agentSystemReset, agentMibCapabilityType=agentMibCapabilityType, agentBscSwFileDscr=agentBscSwFileDscr, agentTrustHostTable=agentTrustHostTable, agentMgmtProtocolCapability=agentMgmtProtocolCapability, agentMibCapabilityEntry=agentMibCapabilityEntry, agentOutOfBandBaudRateConfig=agentOutOfBandBaudRateConfig, agentFDBClearAllState=agentFDBClearAllState, agentBscSwFileCtrl=agentBscSwFileCtrl, agentRs232PortConfig=agentRs232PortConfig, agentTrustHostDelAllState=agentTrustHostDelAllState, agentBscSwFileTable=agentBscSwFileTable, agentIpTftpServerAddr=agentIpTftpServerAddr)
