#
# PySNMP MIB module NMS-QOS-PIB-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/bdcom/NMS-QOS-PIB-MIB
...
Unsigned32, = mibBuilder.importSymbols("NMS-TC", "Unsigned32")
...
qosDevicePibIncarnationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 2, 1, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosDeviceIncarnationId"))
...
qosDeviceAttributeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 2, 2, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosDeviceAttributeId"))
...
qosInterfaceTypeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 2, 3, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosInterfaceTypeId"))
...
qosDiffServMappingEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 3, 1, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosDscp"))
...
qosCosToDscpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 3, 2, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosCosToDscpCos"))
...
qosUnmatchedPolicyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 4, 1, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosUnmatchedPolicyId"))
...
qosPolicerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 5, 1, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosPolicerId"))
...
qosAggregateEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 5, 2, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosAggregateId"))
...
qosMacClassificationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 6, 1, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosMacClassificationId"))
...
qosIpAceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 7, 1, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosIpAceId"))
...
qosIpAclDefinitionEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 7, 2, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosIpAclDefinitionId"))
...
qosIpAclActionEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 7, 3, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosIpAclActionId"))
...
qosIfSchedulingPreferenceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 8, 1, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosIfSchedulingPreferenceId"))
...
qosIfDropPreferenceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 8, 2, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosIfDropPreferenceId"))
...
qosIfDscpAssignmentEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 8, 3, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosIfDscpAssignmentId"))
...
qosIfRedEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 8, 4, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosIfRedId"))
...
qosIfTailDropEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 8, 5, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosIfTailDropId"))
...
qosIfWeightsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3320, 18, 2, 1, 8, 6, 1), ).setIndexNames((0, "NMS-QOS-PIB-MIB", "qosIfWeightsId"))
