# SNMP MIB module (EAP-CLIENTTABLE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/tplink/EAP-CLIENTTABLE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:55:22 2025
...
(clientStatis,) = mibBuilder.importSymbols(
    "EAP-CLIENT-MIB",
    "clientStatis")
...
clientEntry = _ClientEntry_Object(
    (1, 3, 6, 1, 4, 1, 11863, 10, 1, 1, 2, 1)
)
clientEntry.setIndexNames(
    (0, "EAP-CLIENTTABLE-MIB", "clientIndex"),
)
if mibBuilder.loadTexts:
...
clientIndex = _ClientIndex_Object(
    (1, 3, 6, 1, 4, 1, 11863, 10, 1, 1, 2, 1, 1),
    _ClientIndex_Type()
)
...
macAddress = _MacAddress_Object(
    (1, 3, 6, 1, 4, 1, 11863, 10, 1, 1, 2, 1, 2),
    _MacAddress_Type()
)
