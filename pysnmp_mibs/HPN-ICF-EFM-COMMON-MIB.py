...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-EFM-COMMON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:42:39 2025
...
hpnicfDot3OamCompliance.setObjects(
      *(("HPN-ICF-EFM-COMMON-MIB", "hpnicfDot3OamControlGroup"),
        ("HPN-ICF-EFM-COMMON-MIB", "hpnicfDot3OamPeerGroup"),
        ("HPN-ICF-EFM-COMMON-MIB", "hpnicfDot3OamStatsBaseGroup"),
        ("HPN-ICF-EFM-COMMON-MIB", "hpnicfDot3OamLoopbackGroup"),
        ...
        ("HPN-ICF-EFM-COMMON-MIB", "hpnicfDot3OamErrFrameEventGroup"),
        ("HPN-ICF-EFM-COMMON-MIB", "hpnicfDot3OamErrFrameSecsSummaryEventGroup"),
        ("HPN-ICF-EFM-COMMON-MIB", "hpnicfDot3OamEventLogGroup"),
        ("HPN-ICF-EFM-COMMON-MIB", "hpnicfDot3OamNotificationGroup"))
)
if mibBuilder.loadTexts:
