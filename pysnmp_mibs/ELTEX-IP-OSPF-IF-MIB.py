# SNMP MIB module (ELTEX-IP-OSPF-IF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/eltex/ELTEX-IP-OSPF-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:48:42 2025
...
eltIpOspfIfEntry.setIndexNames(
    (0, "ELTEX-IP-OSPF-IF-MIB", "eltOspfIfAddress"),
)
if mibBuilder.loadTexts:
