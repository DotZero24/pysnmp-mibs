...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DHCP-RELAY-MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:46:37 2025
...
class _SwDHCPRelayOption82CircuitIDType_Type(Integer32):
    """Custom type swDHCPRelayOption82CircuitIDType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwDHCPRelayOption82CircuitIDType_Type.__name__ = "Integer32"
_SwDHCPRelayOption82CircuitIDType_Object = MibScalar
swDHCPRelayOption82CircuitIDType = _SwDHCPRelayOption82CircuitIDType_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 6),
    _SwDHCPRelayOption82CircuitIDType_Type()
)
swDHCPRelayOption82CircuitIDType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swDHCPRelayOption82CircuitIDType.setStatus("current")
_SwDHCPRelayOption82CircuitID_Type = DisplayString
_SwDHCPRelayOption82CircuitID_Object = MibScalar
swDHCPRelayOption82CircuitID = _SwDHCPRelayOption82CircuitID_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 7),
    _SwDHCPRelayOption82CircuitID_Type()
)
swDHCPRelayOption82CircuitID.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swDHCPRelayOption82CircuitID.setStatus("current")
_SwDHCPRelayOption82PerPortRemoteIdTable_Object = MibTable
swDHCPRelayOption82PerPortRemoteIdTable = _SwDHCPRelayOption82PerPortRemoteIdTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 8)
)
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortRemoteIdTable.setStatus("current")
_SwDHCPRelayOption82PerPortRemoteIdEntry_Object = MibTableRow
swDHCPRelayOption82PerPortRemoteIdEntry = _SwDHCPRelayOption82PerPortRemoteIdEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 8, 1)
)
swDHCPRelayOption82PerPortRemoteIdEntry.setIndexNames(
    (0, "DHCP-RELAY-MGMT-MIB", "swDHCPRelayOption82PerPortRemoteIdPortIndex"),
)
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortRemoteIdEntry.setStatus("current")
...
swDHCPRelayOption82PerPortRemoteIdPortIndex = _SwDHCPRelayOption82PerPortRemoteIdPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 8, 1, 1),
    _SwDHCPRelayOption82PerPortRemoteIdPortIndex_Type()
)
swDHCPRelayOption82PerPortRemoteIdPortIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortRemoteIdPortIndex.setStatus("current")


class _SwDHCPRelayOption82PerPortRemoteIdType_Type(Integer32):
    """Custom type swDHCPRelayOption82PerPortRemoteIdType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            5
...
_SwDHCPRelayOption82PerPortRemoteIdType_Type.__name__ = "Integer32"
_SwDHCPRelayOption82PerPortRemoteIdType_Object = MibTableColumn
swDHCPRelayOption82PerPortRemoteIdType = _SwDHCPRelayOption82PerPortRemoteIdType_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 8, 1, 2),
    _SwDHCPRelayOption82PerPortRemoteIdType_Type()
)
swDHCPRelayOption82PerPortRemoteIdType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortRemoteIdType.setStatus("current")
...
swDHCPRelayOption82PerPortRemoteIdValue = _SwDHCPRelayOption82PerPortRemoteIdValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 8, 1, 3),
    _SwDHCPRelayOption82PerPortRemoteIdValue_Type()
)
swDHCPRelayOption82PerPortRemoteIdValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortRemoteIdValue.setStatus("current")
_SwDHCPRelayOption82PerPortCircuitIdTable_Object = MibTable
swDHCPRelayOption82PerPortCircuitIdTable = _SwDHCPRelayOption82PerPortCircuitIdTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 9)
)
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortCircuitIdTable.setStatus("current")
_SwDHCPRelayOption82PerPortCircuitIdEntry_Object = MibTableRow
swDHCPRelayOption82PerPortCircuitIdEntry = _SwDHCPRelayOption82PerPortCircuitIdEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 9, 1)
)
swDHCPRelayOption82PerPortCircuitIdEntry.setIndexNames(
    (0, "DHCP-RELAY-MGMT-MIB", "swDHCPRelayOption82PerPortCircuitIdPortIndex"),
)
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortCircuitIdEntry.setStatus("current")
...
swDHCPRelayOption82PerPortCircuitIdPortIndex = _SwDHCPRelayOption82PerPortCircuitIdPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 9, 1, 1),
    _SwDHCPRelayOption82PerPortCircuitIdPortIndex_Type()
)
swDHCPRelayOption82PerPortCircuitIdPortIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortCircuitIdPortIndex.setStatus("current")


class _SwDHCPRelayOption82PerPortCircuitIdType_Type(Integer32):
    """Custom type swDHCPRelayOption82PerPortCircuitIdType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            5
...
_SwDHCPRelayOption82PerPortCircuitIdType_Type.__name__ = "Integer32"
_SwDHCPRelayOption82PerPortCircuitIdType_Object = MibTableColumn
swDHCPRelayOption82PerPortCircuitIdType = _SwDHCPRelayOption82PerPortCircuitIdType_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 9, 1, 2),
    _SwDHCPRelayOption82PerPortCircuitIdType_Type()
)
swDHCPRelayOption82PerPortCircuitIdType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortCircuitIdType.setStatus("current")
...
swDHCPRelayOption82PerPortCircuitIdValue = _SwDHCPRelayOption82PerPortCircuitIdValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 2, 9, 1, 3),
    _SwDHCPRelayOption82PerPortCircuitIdValue_Type()
)
swDHCPRelayOption82PerPortCircuitIdValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swDHCPRelayOption82PerPortCircuitIdValue.setStatus("current")
...
swDHCPRelayPortStateCtrlTable = _SwDHCPRelayPortStateCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 6)
)
if mibBuilder.loadTexts:
    swDHCPRelayPortStateCtrlTable.setStatus("current")
_SwDHCPRelayPortStateCtrlEntry_Object = MibTableRow
swDHCPRelayPortStateCtrlEntry = _SwDHCPRelayPortStateCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 6, 1)
)
swDHCPRelayPortStateCtrlEntry.setIndexNames(
    (0, "DHCP-RELAY-MGMT-MIB", "swDHCPRelayPortStateCtrlPortIndex"),
)
if mibBuilder.loadTexts:
    swDHCPRelayPortStateCtrlEntry.setStatus("current")
_SwDHCPRelayPortStateCtrlPortIndex_Type = Integer32
_SwDHCPRelayPortStateCtrlPortIndex_Object = MibTableColumn
swDHCPRelayPortStateCtrlPortIndex = _SwDHCPRelayPortStateCtrlPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 6, 1, 1),
    _SwDHCPRelayPortStateCtrlPortIndex_Type()
)
swDHCPRelayPortStateCtrlPortIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    swDHCPRelayPortStateCtrlPortIndex.setStatus("current")


class _SwDHCPRelayPortStateCtrlState_Type(Integer32):
    """Custom type swDHCPRelayPortStateCtrlState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwDHCPRelayPortStateCtrlState_Type.__name__ = "Integer32"
_SwDHCPRelayPortStateCtrlState_Object = MibTableColumn
swDHCPRelayPortStateCtrlState = _SwDHCPRelayPortStateCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 6, 1, 2),
    _SwDHCPRelayPortStateCtrlState_Type()
)
swDHCPRelayPortStateCtrlState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swDHCPRelayPortStateCtrlState.setStatus("current")
_SwDHCPRelaySendArpByCidTable_Object = MibTable
swDHCPRelaySendArpByCidTable = _SwDHCPRelaySendArpByCidTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 7)
)
if mibBuilder.loadTexts:
    swDHCPRelaySendArpByCidTable.setStatus("current")
_SwDHCPRelaySendArpByCidEntry_Object = MibTableRow
swDHCPRelaySendArpByCidEntry = _SwDHCPRelaySendArpByCidEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 7, 1)
)
swDHCPRelaySendArpByCidEntry.setIndexNames(
    (0, "DHCP-RELAY-MGMT-MIB", "swDHCPRelayCtrlServer"),
)
if mibBuilder.loadTexts:
    swDHCPRelaySendArpByCidEntry.setStatus("current")


class _SwDHCPRelaySendArpByCidInnerVid_Type(Integer32):
    """Custom type swDHCPRelaySendArpByCidInnerVid based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_SwDHCPRelaySendArpByCidInnerVid_Type.__name__ = "Integer32"
_SwDHCPRelaySendArpByCidInnerVid_Object = MibTableColumn
swDHCPRelaySendArpByCidInnerVid = _SwDHCPRelaySendArpByCidInnerVid_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 3, 7, 1, 1),
    _SwDHCPRelaySendArpByCidInnerVid_Type()
)
swDHCPRelaySendArpByCidInnerVid.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swDHCPRelaySendArpByCidInnerVid.setStatus("current")
...
swDHCPLocalRelayOption82Table = _SwDHCPLocalRelayOption82Table_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 4, 3)
)
if mibBuilder.loadTexts:
    swDHCPLocalRelayOption82Table.setStatus("current")
_SwDHCPLocalRelayOption82Entry_Object = MibTableRow
swDHCPLocalRelayOption82Entry = _SwDHCPLocalRelayOption82Entry_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 4, 3, 1)
)
swDHCPLocalRelayOption82Entry.setIndexNames(
    (0, "DHCP-RELAY-MGMT-MIB", "swDHCPLocalRelayOption82PortIndex"),
)
if mibBuilder.loadTexts:
    swDHCPLocalRelayOption82Entry.setStatus("current")


class _SwDHCPLocalRelayOption82PortIndex_Type(Integer32):
    """Custom type swDHCPLocalRelayOption82PortIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_SwDHCPLocalRelayOption82PortIndex_Type.__name__ = "Integer32"
_SwDHCPLocalRelayOption82PortIndex_Object = MibTableColumn
swDHCPLocalRelayOption82PortIndex = _SwDHCPLocalRelayOption82PortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 4, 3, 1, 1),
    _SwDHCPLocalRelayOption82PortIndex_Type()
)
swDHCPLocalRelayOption82PortIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    swDHCPLocalRelayOption82PortIndex.setStatus("current")


class _SwDHCPLocalRelayOption82Policy_Type(Integer32):
    """Custom type swDHCPLocalRelayOption82Policy based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwDHCPLocalRelayOption82Policy_Type.__name__ = "Integer32"
_SwDHCPLocalRelayOption82Policy_Object = MibTableColumn
swDHCPLocalRelayOption82Policy = _SwDHCPLocalRelayOption82Policy_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 42, 4, 3, 1, 2),
    _SwDHCPLocalRelayOption82Policy_Type()
)
swDHCPLocalRelayOption82Policy.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swDHCPLocalRelayOption82Policy.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"swDHCPRelayMIB": swDHCPRelayMIB,
       ...
       "swDHCPRelayOption82CircuitIDType": swDHCPRelayOption82CircuitIDType,
       "swDHCPRelayOption82CircuitID": swDHCPRelayOption82CircuitID,
       "swDHCPRelayOption82PerPortRemoteIdTable": swDHCPRelayOption82PerPortRemoteIdTable,
       "swDHCPRelayOption82PerPortRemoteIdEntry": swDHCPRelayOption82PerPortRemoteIdEntry,
       "swDHCPRelayOption82PerPortRemoteIdPortIndex": swDHCPRelayOption82PerPortRemoteIdPortIndex,
       "swDHCPRelayOption82PerPortRemoteIdType": swDHCPRelayOption82PerPortRemoteIdType,
       "swDHCPRelayOption82PerPortRemoteIdValue": swDHCPRelayOption82PerPortRemoteIdValue,
       "swDHCPRelayOption82PerPortCircuitIdTable": swDHCPRelayOption82PerPortCircuitIdTable,
       "swDHCPRelayOption82PerPortCircuitIdEntry": swDHCPRelayOption82PerPortCircuitIdEntry,
       "swDHCPRelayOption82PerPortCircuitIdPortIndex": swDHCPRelayOption82PerPortCircuitIdPortIndex,
       "swDHCPRelayOption82PerPortCircuitIdType": swDHCPRelayOption82PerPortCircuitIdType,
       "swDHCPRelayOption82PerPortCircuitIdValue": swDHCPRelayOption82PerPortCircuitIdValue,
       ...
       "swDHCPRelayPortStateCtrlTable": swDHCPRelayPortStateCtrlTable,
       "swDHCPRelayPortStateCtrlEntry": swDHCPRelayPortStateCtrlEntry,
       "swDHCPRelayPortStateCtrlPortIndex": swDHCPRelayPortStateCtrlPortIndex,
       "swDHCPRelayPortStateCtrlState": swDHCPRelayPortStateCtrlState,
       "swDHCPRelaySendArpByCidTable": swDHCPRelaySendArpByCidTable,
       "swDHCPRelaySendArpByCidEntry": swDHCPRelaySendArpByCidEntry,
       "swDHCPRelaySendArpByCidInnerVid": swDHCPRelaySendArpByCidInnerVid,
       ...
       "swDHCPLocalRelayOption82Table": swDHCPLocalRelayOption82Table,
       "swDHCPLocalRelayOption82Entry": swDHCPLocalRelayOption82Entry,
       "swDHCPLocalRelayOption82PortIndex": swDHCPLocalRelayOption82PortIndex,
