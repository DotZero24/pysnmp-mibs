...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB
...
_EtsysStpDiagDisputedBpduTrapThreshold_Type.__name__ = "Unsigned32"
...
etsysStpDiagCompliance.setObjects(
      *(("ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB", "etsysStpDiagDot1dGroup"),
        ("ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB", "etsysStpDiagDot1dBridgePortGroup"),
        ("ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB", "etsysStpDiagDot1wGroup"),
        ("ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB", "etsysStpDiagDot1wBridgePortGroup"),
        ("ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB", "etsysStpDiagDot1sGroup"),
        ("ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB", "etsysStpDiagDot1sBridgePortGroup"),
        ("ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB", "etsysStpDiagHistoryGroup"),
        ("ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB", "etsysStpDiagTrapConfigGroup"),
        ("ENTERASYS-SPANNING-TREE-DIAGNOSTIC-MIB", "etsysStpDiagNotificationGroup"))
)
if mibBuilder.loadTexts:
