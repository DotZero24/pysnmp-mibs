# SNMP MIB module (DNOS-INTERFACE-APP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/DNOS-INTERFACE-APP-MIB
...
fastPathInterfaceApp = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 70)
)
...
agentLinkFlapAdminMode = _AgentLinkFlapAdminMode_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 70, 1, 1, 1),
...
agentLinkFlapDuration = _AgentLinkFlapDuration_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 70, 1, 1, 2),
...
agentLinkFlapMaxCount = _AgentLinkFlapMaxCount_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 70, 1, 1, 3),
