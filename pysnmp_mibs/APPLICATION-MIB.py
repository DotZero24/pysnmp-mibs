...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/APPLICATION-MIB
...
ModuleIdentity, Integer32, Gauge32, Unsigned32, zeroDotZero, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, TimeTicks, ObjectIdentity, MibIdentifier, Counter64, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Gauge32", "Unsigned32", "zeroDotZero", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter64", "Bits", "mib-2", "IpAddress")
DisplayString, TDomain, TimeStamp, TestAndIncr, DateAndTime, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TDomain", "TimeStamp", "TestAndIncr", "DateAndTime", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("APPLICATION-MIB", applOpenFileEntry=applOpenFileEntry, applPastChannelWriteRequests=applPastChannelWriteRequests, applicationMonitorGroup=applicationMonitorGroup, applOpenChannelWriteRequestsLow=applOpenChannelWriteRequestsLow, applSrvNameToSrvInstTable=applSrvNameToSrvInstTable, applSrvInstToSrvNameTable=applSrvInstToSrvNameTable, applTransactFlowTransLow=applTransactFlowTransLow, applPastFileEntry=applPastFileEntry, applOpenConnectionFarEndpoint=applOpenConnectionFarEndpoint, applOpenChannelReadFailures=applOpenChannelReadFailures, applOpenChannelReadRequests=applOpenChannelReadRequests, applTransactStreamPrfCumTimes=applTransactStreamPrfCumTimes, applicationFastTransHistoryGroup=applicationFastTransHistoryGroup, applPastTransFlowDirection=applPastTransFlowDirection, applPastFileTable=applPastFileTable, applPastTransKindTable=applPastTransKindTable, applPastTransFlowTime=applPastTransFlowTime, applTransactFlowTrans=applTransactFlowTrans, applElmtRunControlEntry=applElmtRunControlEntry, applTransactKind=applTransactKind, applElmtOrSvcId=applElmtOrSvcId, applRunApplElmtToSrvInstEntry=applRunApplElmtToSrvInstEntry, applPastTransFlowTransLow=applPastTransFlowTransLow, applElmtRunStatusEntry=applElmtRunStatusEntry, applPastChannelBytesReadLow=applPastChannelBytesReadLow, applPastChannelWriteFailures=applPastChannelWriteFailures, applSrvInstance=applSrvInstance, applPastConNearEndAddr=applPastConNearEndAddr, applTransactFlowTime=applTransactFlowTime, applTransactKindTable=applTransactKindTable, applTransactFlowTable=applTransactFlowTable, applPastConTransport=applPastConTransport, applPastChannelControlMaxRows=applPastChannelControlMaxRows, Unsigned64TC=Unsigned64TC, applOpenConnectionTable=applOpenConnectionTable, applElmtOrSvc=applElmtOrSvc, applPastConTable=applPastConTable, applTransactKindTransLow=applTransactKindTransLow, applPastTransStreamEntry=applPastTransStreamEntry, applTransactFlowBytesLow=applTransactFlowBytesLow, applPastTransFlowTrans=applPastTransFlowTrans, applSrvInstToRunApplElmtTable=applSrvInstToRunApplElmtTable, applSrvInstToRunApplElmtEntry=applSrvInstToRunApplElmtEntry, applOpenChannelReadRequestsLow=applOpenChannelReadRequestsLow, applPastChannelTable=applPastChannelTable, applTransactStreamInvokes=applTransactStreamInvokes, applPastTransFlowTable=applPastTransFlowTable, applPastTransKindEntry=applPastTransKindEntry, applPastConFarEndpoint=applPastConFarEndpoint, applPastTransKindTime=applPastTransKindTime, applPastChannelBytesRead=applPastChannelBytesRead, applElmtRunStatusOpenFiles=applElmtRunStatusOpenFiles, applPastTransStreamTable=applPastTransStreamTable, applTransactKindBytes=applTransactKindBytes, applPastChannelControlTimeLimit=applPastChannelControlTimeLimit, applChannelGroup=applChannelGroup, applPastChannelControlTable=applPastChannelControlTable, applTransactFlowEntry=applTransactFlowEntry, applPastChannelOpenTime=applPastChannelOpenTime, applPastTransStreamInvRspTimes=applPastTransStreamInvRspTimes, applicationRunGroup=applicationRunGroup, applPastChannelReadRequests=applPastChannelReadRequests, applSrvName=applSrvName, applOpenConnectionNearEndAddr=applOpenConnectionNearEndAddr, applPastTransStreamUnitOfWork=applPastTransStreamUnitOfWork, applTransactStreamInvCumTimes=applTransactStreamInvCumTimes, applPastTransStreamPrfCumTimes=applPastTransStreamPrfCumTimes, applTransactStreamPerformsLow=applTransactStreamPerformsLow, applOpenChannelWriteRequests=applOpenChannelWriteRequests, applPastConFarEndAddr=applPastConFarEndAddr, applPastTransStreamPrfRspTimes=applPastTransStreamPrfRspTimes, applOpenFileSizeLow=applOpenFileSizeLow, applElmtRunStatusHeapUsage=applElmtRunStatusHeapUsage, applTransactStreamDescr=applTransactStreamDescr, applElmtRunStatusTable=applElmtRunStatusTable, applPastTransKind=applPastTransKind, applPastTransKindTransLow=applPastTransKindTransLow, applSrvIndex=applSrvIndex, applTransactKindTime=applTransactKindTime, applOpenFileName=applOpenFileName, applOpenChannelBytesReadLow=applOpenChannelBytesReadLow, applRunApplElmtToSrvInstTable=applRunApplElmtToSrvInstTable, applPastChannelLastWriteTime=applPastChannelLastWriteTime, applElmtRunStatusLastErrorMsg=applElmtRunStatusLastErrorMsg, applTransactionStreamTable=applTransactionStreamTable, applPastTransKindTrans=applPastTransKindTrans, applPastTransKindBytesLow=applPastTransKindBytesLow, applPastConNearEndpoint=applPastConNearEndpoint, applOpenConnectionApplication=applOpenConnectionApplication, applPastFileMode=applPastFileMode, applPastFileSizeLow=applPastFileSizeLow, applPastTransStreamPerformsLow=applPastTransStreamPerformsLow, applPastTransFlowBytes=applPastTransFlowBytes, applOpenChannelEntry=applOpenChannelEntry, applOpenConnectionNearEndpoint=applOpenConnectionNearEndpoint, applSrvNameToSrvInstEntry=applSrvNameToSrvInstEntry, applPastFileName=applPastFileName, applicationTransactGroup=applicationTransactGroup, applElmtRunControlTerminate=applElmtRunControlTerminate, applOpenFileMode=applOpenFileMode, applSrvInstQual=applSrvInstQual, applPastChannelCloseTime=applPastChannelCloseTime, applicationMibGroups=applicationMibGroups, applPastTransStreamInvokes=applPastTransStreamInvokes, applElmtRunStatusLastErrorTime=applElmtRunStatusLastErrorTime, applTransactStreamInvRspTimes=applTransactStreamInvRspTimes, applPastTransKindBytes=applPastTransKindBytes, applTransactKindEntry=applTransactKindEntry, applElmtRunControlSuspend=applElmtRunControlSuspend, applElmtRunControlGroup=applElmtRunControlGroup, applPastChannelEntry=applPastChannelEntry, applPastChannelIndex=applPastChannelIndex, applicationHistoryGroup=applicationHistoryGroup, applicationFastHistoryGroup=applicationFastHistoryGroup, applTransactFlowDirection=applTransactFlowDirection, applPastChannelControlCollect=applPastChannelControlCollect, applPastTransFlowBytesLow=applPastTransFlowBytesLow, applOpenChannelIndex=applOpenChannelIndex, applTransactFlowBytes=applTransactFlowBytes, applPastChannelReadFailures=applPastChannelReadFailures, applOpenConnectionFarEndAddr=applOpenConnectionFarEndAddr, applPastTransFlowReqRsp=applPastTransFlowReqRsp, applicationMibConformance=applicationMibConformance, applPastChannelGroup=applPastChannelGroup, applOpenFileTable=applOpenFileTable, applicationMibObjects=applicationMibObjects, applTransactStreamPerforms=applTransactStreamPerforms, applSrvInstToSrvNameEntry=applSrvInstToSrvNameEntry, applPastTransStreamInvCumTimes=applPastTransStreamInvCumTimes, applPastTransStreamPerforms=applPastTransStreamPerforms, applElmtRunStatusOpenConnections=applElmtRunStatusOpenConnections, applServiceGroup=applServiceGroup, applOpenChannelBytesRead=applOpenChannelBytesRead, applOpenChannelWriteFailures=applOpenChannelWriteFailures, applTransactionStreamEntry=applTransactionStreamEntry, applicationFastTransactGroup=applicationFastTransactGroup, applTransactKindTrans=applTransactKindTrans, applPastConEntry=applPastConEntry, applTransactFlowReqRsp=applTransactFlowReqRsp, applOpenChannelTable=applOpenChannelTable, applOpenChannelLastReadTime=applOpenChannelLastReadTime, applOpenChannelBytesWrittenLow=applOpenChannelBytesWrittenLow, applPastTransFlowEntry=applPastTransFlowEntry, applPastChannelBytesWritten=applPastChannelBytesWritten, applTransactStreamUnitOfWork=applTransactStreamUnitOfWork, applElmtRunControlTable=applElmtRunControlTable, applicationMibCompliance=applicationMibCompliance, applPastFileSizeHigh=applPastFileSizeHigh, applPastChannelWriteReqsLow=applPastChannelWriteReqsLow, applOpenChannelOpenTime=applOpenChannelOpenTime, applOpenConnectionTransport=applOpenConnectionTransport, applicationFastMonitorGroup=applicationFastMonitorGroup, applTransactStreamPrfRspTimes=applTransactStreamPrfRspTimes, applPastChannelControlEntry=applPastChannelControlEntry, applElmtRunStatusSuspended=applElmtRunStatusSuspended, applTransactKindBytesLow=applTransactKindBytesLow, applPastChannelControlRemItems=applPastChannelControlRemItems, applPastConApplication=applPastConApplication, PYSNMP_MODULE_ID=applicationMib, applPastTransStreamDescr=applPastTransStreamDescr, applOpenFileSizeHigh=applOpenFileSizeHigh, ApplTAddress=ApplTAddress, applOpenChannelBytesWritten=applOpenChannelBytesWritten, applOpenChannelLastWriteTime=applOpenChannelLastWriteTime, applicationTransHistoryGroup=applicationTransHistoryGroup, applPastChannelBytesWritLow=applPastChannelBytesWritLow, applPastTransStreamInvokesLow=applPastTransStreamInvokesLow, applElmtRunControlReconfigure=applElmtRunControlReconfigure, applPastChannelReadReqsLow=applPastChannelReadReqsLow, applTransactStreamInvokesLow=applTransactStreamInvokesLow, applicationMib=applicationMib, applPastChannelLastReadTime=applPastChannelLastReadTime, applOpenConnectionEntry=applOpenConnectionEntry)
