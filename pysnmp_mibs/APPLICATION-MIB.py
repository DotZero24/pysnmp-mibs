...
MibIdentifier, zeroDotZero, NotificationType, Bits, Integer32, Unsigned32, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, Counter64, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "zeroDotZero", "NotificationType", "Bits", "Integer32", "Unsigned32", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "TimeTicks", "Gauge32")
TDomain, DateAndTime, TextualConvention, TestAndIncr, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TDomain", "DateAndTime", "TextualConvention", "TestAndIncr", "TruthValue", "TimeStamp", "DisplayString")
sysApplElmtRunIndex, LongUtf8String = mibBuilder.importSymbols("SYSAPPL-MIB", "sysApplElmtRunIndex", "LongUtf8String")
...
mibBuilder.exportSymbols("APPLICATION-MIB", applTransactStreamPerforms=applTransactStreamPerforms, applPastChannelControlMaxRows=applPastChannelControlMaxRows, applPastTransKind=applPastTransKind, applicationFastTransactGroup=applicationFastTransactGroup, applSrvIndex=applSrvIndex, applOpenChannelWriteRequests=applOpenChannelWriteRequests, applPastChannelWriteRequests=applPastChannelWriteRequests, Unsigned64TC=Unsigned64TC, applPastTransStreamPrfRspTimes=applPastTransStreamPrfRspTimes, applTransactFlowTrans=applTransactFlowTrans, applPastTransFlowReqRsp=applPastTransFlowReqRsp, applElmtRunControlReconfigure=applElmtRunControlReconfigure, applElmtRunControlTerminate=applElmtRunControlTerminate, applPastChannelWriteFailures=applPastChannelWriteFailures, applTransactKindTrans=applTransactKindTrans, applicationRunGroup=applicationRunGroup, applPastTransFlowBytesLow=applPastTransFlowBytesLow, applTransactFlowTransLow=applTransactFlowTransLow, applElmtRunControlEntry=applElmtRunControlEntry, applElmtRunControlGroup=applElmtRunControlGroup, applElmtOrSvc=applElmtOrSvc, applPastTransStreamDescr=applPastTransStreamDescr, applOpenChannelBytesWritten=applOpenChannelBytesWritten, applPastTransFlowBytes=applPastTransFlowBytes, applPastChannelIndex=applPastChannelIndex, applSrvInstToSrvNameTable=applSrvInstToSrvNameTable, ApplTAddress=ApplTAddress, applPastChannelControlCollect=applPastChannelControlCollect, applPastChannelReadRequests=applPastChannelReadRequests, applPastChannelWriteReqsLow=applPastChannelWriteReqsLow, applOpenChannelTable=applOpenChannelTable, applTransactStreamUnitOfWork=applTransactStreamUnitOfWork, applTransactKindBytesLow=applTransactKindBytesLow, applPastTransFlowTransLow=applPastTransFlowTransLow, applOpenChannelLastWriteTime=applOpenChannelLastWriteTime, applPastFileTable=applPastFileTable, applPastTransKindTransLow=applPastTransKindTransLow, applicationMibGroups=applicationMibGroups, applPastFileMode=applPastFileMode, applicationFastHistoryGroup=applicationFastHistoryGroup, applTransactKindTime=applTransactKindTime, applTransactStreamInvCumTimes=applTransactStreamInvCumTimes, applPastChannelLastReadTime=applPastChannelLastReadTime, applTransactionStreamTable=applTransactionStreamTable, applOpenConnectionEntry=applOpenConnectionEntry, applTransactionStreamEntry=applTransactionStreamEntry, applTransactFlowDirection=applTransactFlowDirection, applOpenChannelBytesReadLow=applOpenChannelBytesReadLow, applPastChannelOpenTime=applPastChannelOpenTime, applPastConFarEndpoint=applPastConFarEndpoint, applPastFileEntry=applPastFileEntry, applTransactFlowBytes=applTransactFlowBytes, applTransactFlowReqRsp=applTransactFlowReqRsp, applPastTransKindTime=applPastTransKindTime, applTransactStreamDescr=applTransactStreamDescr, applOpenChannelReadRequestsLow=applOpenChannelReadRequestsLow, applPastFileSizeHigh=applPastFileSizeHigh, applicationTransactGroup=applicationTransactGroup, applElmtRunControlSuspend=applElmtRunControlSuspend, applSrvInstQual=applSrvInstQual, applPastConNearEndpoint=applPastConNearEndpoint, applicationHistoryGroup=applicationHistoryGroup, applPastTransKindEntry=applPastTransKindEntry, applOpenConnectionFarEndpoint=applOpenConnectionFarEndpoint, applPastChannelBytesWritten=applPastChannelBytesWritten, applSrvInstance=applSrvInstance, applPastTransFlowTable=applPastTransFlowTable, applElmtRunControlTable=applElmtRunControlTable, applicationFastMonitorGroup=applicationFastMonitorGroup, applOpenFileMode=applOpenFileMode, applPastConNearEndAddr=applPastConNearEndAddr, applSrvNameToSrvInstTable=applSrvNameToSrvInstTable, applOpenConnectionFarEndAddr=applOpenConnectionFarEndAddr, applSrvInstToRunApplElmtTable=applSrvInstToRunApplElmtTable, applPastTransKindTable=applPastTransKindTable, applPastChannelControlRemItems=applPastChannelControlRemItems, applPastFileName=applPastFileName, applPastTransStreamPerforms=applPastTransStreamPerforms, applPastChannelBytesReadLow=applPastChannelBytesReadLow, applElmtRunStatusHeapUsage=applElmtRunStatusHeapUsage, applElmtRunStatusLastErrorMsg=applElmtRunStatusLastErrorMsg, applPastFileSizeLow=applPastFileSizeLow, applPastChannelTable=applPastChannelTable, applChannelGroup=applChannelGroup, applPastTransKindBytesLow=applPastTransKindBytesLow, applPastTransStreamUnitOfWork=applPastTransStreamUnitOfWork, applPastConEntry=applPastConEntry, applPastChannelLastWriteTime=applPastChannelLastWriteTime, applPastTransStreamInvokes=applPastTransStreamInvokes, applicationMonitorGroup=applicationMonitorGroup, applicationMib=applicationMib, applPastChannelCloseTime=applPastChannelCloseTime, applTransactFlowEntry=applTransactFlowEntry, applOpenChannelReadRequests=applOpenChannelReadRequests, applPastTransStreamEntry=applPastTransStreamEntry, applPastTransFlowTime=applPastTransFlowTime, applPastTransStreamPrfCumTimes=applPastTransStreamPrfCumTimes, applTransactStreamInvokesLow=applTransactStreamInvokesLow, applOpenFileSizeHigh=applOpenFileSizeHigh, applOpenChannelEntry=applOpenChannelEntry, applOpenConnectionNearEndpoint=applOpenConnectionNearEndpoint, applTransactKindEntry=applTransactKindEntry, applOpenChannelWriteRequestsLow=applOpenChannelWriteRequestsLow, applPastChannelControlTimeLimit=applPastChannelControlTimeLimit, applElmtRunStatusEntry=applElmtRunStatusEntry, applSrvInstToSrvNameEntry=applSrvInstToSrvNameEntry, applTransactStreamPrfRspTimes=applTransactStreamPrfRspTimes, applOpenChannelOpenTime=applOpenChannelOpenTime, applSrvInstToRunApplElmtEntry=applSrvInstToRunApplElmtEntry, applPastConApplication=applPastConApplication, applElmtRunStatusOpenFiles=applElmtRunStatusOpenFiles, applOpenChannelReadFailures=applOpenChannelReadFailures, applServiceGroup=applServiceGroup, applicationMibObjects=applicationMibObjects, applOpenFileEntry=applOpenFileEntry, applTransactStreamInvokes=applTransactStreamInvokes, applPastConFarEndAddr=applPastConFarEndAddr, applPastTransStreamInvRspTimes=applPastTransStreamInvRspTimes, applOpenChannelWriteFailures=applOpenChannelWriteFailures, applicationMibCompliance=applicationMibCompliance, applElmtRunStatusOpenConnections=applElmtRunStatusOpenConnections, applPastChannelEntry=applPastChannelEntry, applElmtRunStatusTable=applElmtRunStatusTable, applRunApplElmtToSrvInstEntry=applRunApplElmtToSrvInstEntry, applPastTransFlowDirection=applPastTransFlowDirection, applPastConTable=applPastConTable, applTransactKindTransLow=applTransactKindTransLow, applRunApplElmtToSrvInstTable=applRunApplElmtToSrvInstTable, applOpenChannelBytesWrittenLow=applOpenChannelBytesWrittenLow, applTransactFlowTable=applTransactFlowTable, applTransactKind=applTransactKind, applPastTransStreamPerformsLow=applPastTransStreamPerformsLow, applPastTransKindBytes=applPastTransKindBytes, applicationMibConformance=applicationMibConformance, applElmtOrSvcId=applElmtOrSvcId, applOpenFileTable=applOpenFileTable, applPastTransFlowTrans=applPastTransFlowTrans, applicationFastTransHistoryGroup=applicationFastTransHistoryGroup, applPastConTransport=applPastConTransport, applElmtRunStatusSuspended=applElmtRunStatusSuspended, applOpenConnectionNearEndAddr=applOpenConnectionNearEndAddr, applTransactKindTable=applTransactKindTable, applTransactStreamPerformsLow=applTransactStreamPerformsLow, applTransactStreamInvRspTimes=applTransactStreamInvRspTimes, applicationTransHistoryGroup=applicationTransHistoryGroup, applOpenConnectionTable=applOpenConnectionTable, applTransactKindBytes=applTransactKindBytes, applPastTransStreamInvCumTimes=applPastTransStreamInvCumTimes, applPastChannelGroup=applPastChannelGroup, applSrvNameToSrvInstEntry=applSrvNameToSrvInstEntry, applOpenChannelIndex=applOpenChannelIndex, applElmtRunStatusLastErrorTime=applElmtRunStatusLastErrorTime, applPastTransKindTrans=applPastTransKindTrans, applOpenConnectionTransport=applOpenConnectionTransport, applOpenFileName=applOpenFileName, applOpenFileSizeLow=applOpenFileSizeLow, applTransactFlowTime=applTransactFlowTime, applOpenChannelLastReadTime=applOpenChannelLastReadTime, applTransactStreamPrfCumTimes=applTransactStreamPrfCumTimes, applPastTransStreamTable=applPastTransStreamTable, applPastChannelBytesRead=applPastChannelBytesRead, applPastChannelReadReqsLow=applPastChannelReadReqsLow, applPastTransStreamInvokesLow=applPastTransStreamInvokesLow, applOpenConnectionApplication=applOpenConnectionApplication, applPastChannelReadFailures=applPastChannelReadFailures, PYSNMP_MODULE_ID=applicationMib, applPastChannelControlEntry=applPastChannelControlEntry, applPastChannelBytesWritLow=applPastChannelBytesWritLow, applTransactFlowBytesLow=applTransactFlowBytesLow, applPastChannelControlTable=applPastChannelControlTable, applOpenChannelBytesRead=applOpenChannelBytesRead, applSrvName=applSrvName, applPastTransFlowEntry=applPastTransFlowEntry)
