...
mibBuilder.exportSymbols("DES2218-MIB", swPortCtrlPartitionStatus=swPortCtrlPartitionStatus, agentIpBootProtocol=agentIpBootProtocol, swPortFrames128To255Bytes=swPortFrames128To255Bytes, agentIpUnauthAddr=agentIpUnauthAddr, swPortCounterTable=swPortCounterTable, agentIpIfDefaultRouter=agentIpIfDefaultRouter, swPortFramesReceived=swPortFramesReceived, agentRs232PortConfig=agentRs232PortConfig, agentIpTrapManagerStatus=agentIpTrapManagerStatus, agentIpTrapManagerEntry=agentIpTrapManagerEntry, agentIpBootServerAddr=agentIpBootServerAddr, swPortFrames512To1023Bytes=swPortFrames512To1023Bytes, agentIpIfAddress=agentIpIfAddress, des2218MIB=des2218MIB, agentRuntimeSwVersion=agentRuntimeSwVersion, swDevCtrlReset=swDevCtrlReset, swDevicePackage=swDevicePackage, swPortFrames65To127Bytes=swPortFrames65To127Bytes, swPortInfoIndex=swPortInfoIndex, agentOutOfBandBaudRateConfig=agentOutOfBandBaudRateConfig, swPortInfoTable=swPortInfoTable, swPortCtrlIndex=swPortCtrlIndex, agentMibCapabilityIndex=agentMibCapabilityIndex, dlink_products=dlink_products, swPortCtrlTable=swPortCtrlTable, agentPromFwVersion=agentPromFwVersion, agentBasicConfig=agentBasicConfig, swPortCtrlLinkStatusAlarmState=swPortCtrlLinkStatusAlarmState, agentIpIfTable=agentIpIfTable, swPortCRCError=swPortCRCError, swPortCtrlForwardUnknowState=swPortCtrlForwardUnknowState, swPortBroadcastFramesReceived=swPortBroadcastFramesReceived, swPortCounterEntry=swPortCounterEntry, swDeviceCtl=swDeviceCtl, swPortBytesSent=swPortBytesSent, swPortFragments=swPortFragments, swDevInfoPortType=swDevInfoPortType, swPortCtrlFilterBcastState=swPortCtrlFilterBcastState, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, agentMibCapabilityVersion=agentMibCapabilityVersion, agentIpIfIndex=agentIpIfIndex, agentIpLastIpAddr=agentIpLastIpAddr, des2218SwHub=des2218SwHub, swPortBytesReceived=swPortBytesReceived, swPortMulticastFramesReceived=swPortMulticastFramesReceived, agentIpIfType=agentIpIfType, swDevInfoSystemUpTime=swDevInfoSystemUpTime, swPortCtrlDuplexState=swPortCtrlDuplexState, agentMibCapabilityEntry=agentMibCapabilityEntry, swPortPackage=swPortPackage, swPortInfoNegotiationStatus=swPortInfoNegotiationStatus, agentSystemReset=agentSystemReset, agentIpTrapManagerTable=agentIpTrapManagerTable, swPortInfoEntry=swPortInfoEntry, swPortJabber=swPortJabber, swPortFrames64Bytes=swPortFrames64Bytes, agentIpIfNetMask=agentIpIfNetMask, swPortCtrlAdminState=swPortCtrlAdminState, agentIpUnauthComm=agentIpUnauthComm, swPortCounterIndex=swPortCounterIndex, swPortInfoType=swPortInfoType, swPortTotalFramesReceived=swPortTotalFramesReceived, swDevCtrlSpanningTree=swDevCtrlSpanningTree, swPortInfoPartitionStatus=swPortInfoPartitionStatus, agentMibCapabilityTable=agentMibCapabilityTable, linkChangeEvent=linkChangeEvent, agentIpNumOfIf=agentIpNumOfIf, swDevInfoNumOfPortOnUse=swDevInfoNumOfPortOnUse, swPortCtrlEntry=swPortCtrlEntry, agentIpTrapManagerComm=agentIpTrapManagerComm, agentIpIfMacAddr=agentIpIfMacAddr, swPortFramesSent=swPortFramesSent, agentIpProtoConfig=agentIpProtoConfig, swDevInfoDesc=swDevInfoDesc, swPortLateCollision=swPortLateCollision, agentBasicInfo=agentBasicInfo, dlink_mgmt=dlink_mgmt, swDevInfoHwRev=swDevInfoHwRev, swPortCtrlNegotiationStatus=swPortCtrlNegotiationStatus, swPortInfoGroupIndex=swPortInfoGroupIndex, agentOutOfBandDialNumber=agentOutOfBandDialNumber, swDevCtrlDisableLearningState=swDevCtrlDisableLearningState, agentIpTrapManagerIpAddr=agentIpTrapManagerIpAddr, agentIpLastBootServerAddr=agentIpLastBootServerAddr, portPartition=portPartition, swPortInfoSpeedStatus=swPortInfoSpeedStatus, agentBootFile=agentBootFile, swDevInfoFrontPanelLedStatus=swDevInfoFrontPanelLedStatus, swPortCounterGroupIndex=swPortCounterGroupIndex, agentMibCapabilityDescr=agentMibCapabilityDescr, agentIpIfEntry=agentIpIfEntry, swPortCollision=swPortCollision, agentConfigInfo=agentConfigInfo, agentMibCapabilityType=agentMibCapabilityType, dlink_Des2218ProdId=dlink_Des2218ProdId, swDeviceInfo=swDeviceInfo, swPortCtrlGroupIndex=swPortCtrlGroupIndex, agentIpGetIpFromBootpServer=agentIpGetIpFromBootpServer, swPortFrames256To511Bytes=swPortFrames256To511Bytes, agentSwUpdateMode=agentSwUpdateMode, swPortTotalBytesReceived=swPortTotalBytesReceived, swPortFrames1024To1522Bytes=swPortFrames1024To1522Bytes, agentSwUpdateCtrl=agentSwUpdateCtrl, agentHwRevision=agentHwRevision, des2218series=des2218series, swDevInfoDramSize=swDevInfoDramSize, agentMgmtProtocolCapability=agentMgmtProtocolCapability, dlink=dlink, swPortCtrlSpeedStatus=swPortCtrlSpeedStatus, swPortOversizeFrames=swPortOversizeFrames, dlink_Des2218Prod=dlink_Des2218Prod, swPortMACRxError=swPortMACRxError, swPortInfoLinkStatus=swPortInfoLinkStatus, swPortInfoDuplexMode=swPortInfoDuplexMode)
