...
DisplayString,PhysAddress,RowStatus,TextualConvention,TruthValue=mibBuilder.importSymbols('SNMPv2-TC',_J,'PhysAddress','RowStatus','TextualConvention',_H)
futureDhcpSrvMIB=ModuleIdentity((1,3,6,1,4,1,2076,84))
if mibBuilder.loadTexts:futureDhcpSrvMIB.setRevisions(('2012-09-05 00:00',))
_DhcpSrvConfig_ObjectIdentity=ObjectIdentity
dhcpSrvConfig=_DhcpSrvConfig_ObjectIdentity((1,3,6,1,4,1,2076,84,1))
_DhcpSrvEnable_Type=TruthValue
_DhcpSrvEnable_Object=MibScalar
dhcpSrvEnable=_DhcpSrvEnable_Object((1,3,6,1,4,1,2076,84,1,1),_DhcpSrvEnable_Type())
...
dhcpSrvDebugLevel=_DhcpSrvDebugLevel_Object((1,3,6,1,4,1,2076,84,1,2),_DhcpSrvDebugLevel_Type())
...
dhcpSrvOfferReuseTimeOut=_DhcpSrvOfferReuseTimeOut_Object((1,3,6,1,4,1,2076,84,1,3),_DhcpSrvOfferReuseTimeOut_Type())
...
dhcpSrvIcmpEchoEnable=_DhcpSrvIcmpEchoEnable_Object((1,3,6,1,4,1,2076,84,1,4),_DhcpSrvIcmpEchoEnable_Type())
...
dhcpSrvBootServerAddress=_DhcpSrvBootServerAddress_Object((1,3,6,1,4,1,2076,84,1,5),_DhcpSrvBootServerAddress_Type())
dhcpSrvBootServerAddress.setMaxAccess(_B)
if mibBuilder.loadTexts:dhcpSrvBootServerAddress.setStatus(_A)
class _DhcpSrvDefBootFilename_Type(OctetString):subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,64))
_DhcpSrvDefBootFilename_Type.__name__=_I
_DhcpSrvDefBootFilename_Object=MibScalar
dhcpSrvDefBootFilename=_DhcpSrvDefBootFilename_Object((1,3,6,1,4,1,2076,84,1,6),_DhcpSrvDefBootFilename_Type())
...
dhcpSrvBootpClientsSupported=_DhcpSrvBootpClientsSupported_Object((1,3,6,1,4,1,2076,84,1,7),_DhcpSrvBootpClientsSupported_Type())
...
dhcpSrvAutomaticBootpEnabled=_DhcpSrvAutomaticBootpEnabled_Object((1,3,6,1,4,1,2076,84,1,8),_DhcpSrvAutomaticBootpEnabled_Type())
...
dhcpSrvSubnetPoolConfigTable=_DhcpSrvSubnetPoolConfigTable_Object((1,3,6,1,4,1,2076,84,1,9))
if mibBuilder.loadTexts:dhcpSrvSubnetPoolConfigTable.setStatus(_A)
_DhcpSrvSubnetPoolConfigEntry_Object=MibTableRow
dhcpSrvSubnetPoolConfigEntry=_DhcpSrvSubnetPoolConfigEntry_Object((1,3,6,1,4,1,2076,84,1,9,1))
...
dhcpSrvSubnetPoolIndex=_DhcpSrvSubnetPoolIndex_Object((1,3,6,1,4,1,2076,84,1,9,1,1),_DhcpSrvSubnetPoolIndex_Type())
...
dhcpSrvSubnetSubnet=_DhcpSrvSubnetSubnet_Object((1,3,6,1,4,1,2076,84,1,9,1,2),_DhcpSrvSubnetSubnet_Type())
...
dhcpSrvSubnetPortNumber=_DhcpSrvSubnetPortNumber_Object((1,3,6,1,4,1,2076,84,1,9,1,3),_DhcpSrvSubnetPortNumber_Type())
...
dhcpSrvSubnetMask=_DhcpSrvSubnetMask_Object((1,3,6,1,4,1,2076,84,1,9,1,4),_DhcpSrvSubnetMask_Type())
...
dhcpSrvSubnetStartIpAddress=_DhcpSrvSubnetStartIpAddress_Object((1,3,6,1,4,1,2076,84,1,9,1,5),_DhcpSrvSubnetStartIpAddress_Type())
...
dhcpSrvSubnetEndIpAddress=_DhcpSrvSubnetEndIpAddress_Object((1,3,6,1,4,1,2076,84,1,9,1,6),_DhcpSrvSubnetEndIpAddress_Type())
...
dhcpSrvSubnetLeaseTime=_DhcpSrvSubnetLeaseTime_Object((1,3,6,1,4,1,2076,84,1,9,1,7),_DhcpSrvSubnetLeaseTime_Type())
...
_DhcpSrvSubnetPoolName_Type.__name__=_J
_DhcpSrvSubnetPoolName_Object=MibTableColumn
dhcpSrvSubnetPoolName=_DhcpSrvSubnetPoolName_Object((1,3,6,1,4,1,2076,84,1,9,1,8),_DhcpSrvSubnetPoolName_Type())
...
dhcpSrvSubnetUtlThreshold=_DhcpSrvSubnetUtlThreshold_Object((1,3,6,1,4,1,2076,84,1,9,1,9),_DhcpSrvSubnetUtlThreshold_Type())
...
dhcpSrvSubnetPoolRowStatus=_DhcpSrvSubnetPoolRowStatus_Object((1,3,6,1,4,1,2076,84,1,9,1,10),_DhcpSrvSubnetPoolRowStatus_Type())
...
dhcpSrvExcludeIpAddressTable=_DhcpSrvExcludeIpAddressTable_Object((1,3,6,1,4,1,2076,84,1,10))
if mibBuilder.loadTexts:dhcpSrvExcludeIpAddressTable.setStatus(_A)
_DhcpSrvExcludeIpAddressEntry_Object=MibTableRow
dhcpSrvExcludeIpAddressEntry=_DhcpSrvExcludeIpAddressEntry_Object((1,3,6,1,4,1,2076,84,1,10,1))
...
dhcpSrvExcludeStartIpAddress=_DhcpSrvExcludeStartIpAddress_Object((1,3,6,1,4,1,2076,84,1,10,1,1),_DhcpSrvExcludeStartIpAddress_Type())
...
dhcpSrvExcludeEndIpAddress=_DhcpSrvExcludeEndIpAddress_Object((1,3,6,1,4,1,2076,84,1,10,1,2),_DhcpSrvExcludeEndIpAddress_Type())
...
dhcpSrvExcludeAddressRowStatus=_DhcpSrvExcludeAddressRowStatus_Object((1,3,6,1,4,1,2076,84,1,10,1,3),_DhcpSrvExcludeAddressRowStatus_Type())
...
dhcpSrvGblOptTable=_DhcpSrvGblOptTable_Object((1,3,6,1,4,1,2076,84,1,11))
if mibBuilder.loadTexts:dhcpSrvGblOptTable.setStatus(_A)
_DhcpSrvGblOptEntry_Object=MibTableRow
dhcpSrvGblOptEntry=_DhcpSrvGblOptEntry_Object((1,3,6,1,4,1,2076,84,1,11,1))
...
dhcpSrvGblOptType=_DhcpSrvGblOptType_Object((1,3,6,1,4,1,2076,84,1,11,1,1),_DhcpSrvGblOptType_Type())
...
dhcpSrvGblOptLen=_DhcpSrvGblOptLen_Object((1,3,6,1,4,1,2076,84,1,11,1,2),_DhcpSrvGblOptLen_Type())
...
dhcpSrvGblOptVal=_DhcpSrvGblOptVal_Object((1,3,6,1,4,1,2076,84,1,11,1,3),_DhcpSrvGblOptVal_Type())
...
dhcpSrvGblOptRowStatus=_DhcpSrvGblOptRowStatus_Object((1,3,6,1,4,1,2076,84,1,11,1,4),_DhcpSrvGblOptRowStatus_Type())
...
dhcpSrvSubnetOptTable=_DhcpSrvSubnetOptTable_Object((1,3,6,1,4,1,2076,84,1,12))
if mibBuilder.loadTexts:dhcpSrvSubnetOptTable.setStatus(_A)
_DhcpSrvSubnetOptEntry_Object=MibTableRow
dhcpSrvSubnetOptEntry=_DhcpSrvSubnetOptEntry_Object((1,3,6,1,4,1,2076,84,1,12,1))
...
dhcpSrvSubnetOptType=_DhcpSrvSubnetOptType_Object((1,3,6,1,4,1,2076,84,1,12,1,1),_DhcpSrvSubnetOptType_Type())
...
dhcpSrvSubnetOptLen=_DhcpSrvSubnetOptLen_Object((1,3,6,1,4,1,2076,84,1,12,1,2),_DhcpSrvSubnetOptLen_Type())
...
dhcpSrvSubnetOptVal=_DhcpSrvSubnetOptVal_Object((1,3,6,1,4,1,2076,84,1,12,1,3),_DhcpSrvSubnetOptVal_Type())
...
dhcpSrvSubnetOptRowStatus=_DhcpSrvSubnetOptRowStatus_Object((1,3,6,1,4,1,2076,84,1,12,1,4),_DhcpSrvSubnetOptRowStatus_Type())
...
dhcpSrvHostOptTable=_DhcpSrvHostOptTable_Object((1,3,6,1,4,1,2076,84,1,13))
if mibBuilder.loadTexts:dhcpSrvHostOptTable.setStatus(_A)
_DhcpSrvHostOptEntry_Object=MibTableRow
dhcpSrvHostOptEntry=_DhcpSrvHostOptEntry_Object((1,3,6,1,4,1,2076,84,1,13,1))
dhcpSrvHostOptEntry.setIndexNames((0,_D,_K),(0,_D,_L),(0,_D,_G),(0,_D,_Q))
...
dhcpSrvHostType=_DhcpSrvHostType_Object((1,3,6,1,4,1,2076,84,1,13,1,1),_DhcpSrvHostType_Type())
...
_DhcpSrvHostId_Type.__name__=_I
_DhcpSrvHostId_Object=MibTableColumn
dhcpSrvHostId=_DhcpSrvHostId_Object((1,3,6,1,4,1,2076,84,1,13,1,2),_DhcpSrvHostId_Type())
...
dhcpSrvHostOptType=_DhcpSrvHostOptType_Object((1,3,6,1,4,1,2076,84,1,13,1,3),_DhcpSrvHostOptType_Type())
...
dhcpSrvHostOptLen=_DhcpSrvHostOptLen_Object((1,3,6,1,4,1,2076,84,1,13,1,4),_DhcpSrvHostOptLen_Type())
...
dhcpSrvHostOptVal=_DhcpSrvHostOptVal_Object((1,3,6,1,4,1,2076,84,1,13,1,5),_DhcpSrvHostOptVal_Type())
...
dhcpSrvHostOptRowStatus=_DhcpSrvHostOptRowStatus_Object((1,3,6,1,4,1,2076,84,1,13,1,6),_DhcpSrvHostOptRowStatus_Type())
...
dhcpSrvHostConfigTable=_DhcpSrvHostConfigTable_Object((1,3,6,1,4,1,2076,84,1,14))
if mibBuilder.loadTexts:dhcpSrvHostConfigTable.setStatus(_A)
_DhcpSrvHostConfigEntry_Object=MibTableRow
dhcpSrvHostConfigEntry=_DhcpSrvHostConfigEntry_Object((1,3,6,1,4,1,2076,84,1,14,1))
dhcpSrvHostConfigEntry.setIndexNames((0,_D,_K),(0,_D,_L),(0,_D,_G))
...
dhcpSrvHostIpAddress=_DhcpSrvHostIpAddress_Object((1,3,6,1,4,1,2076,84,1,14,1,1),_DhcpSrvHostIpAddress_Type())
...
dhcpSrvHostPoolName=_DhcpSrvHostPoolName_Object((1,3,6,1,4,1,2076,84,1,14,1,2),_DhcpSrvHostPoolName_Type())
...
_DhcpSrvHostBootFileName_Type.__name__=_J
_DhcpSrvHostBootFileName_Object=MibTableColumn
dhcpSrvHostBootFileName=_DhcpSrvHostBootFileName_Object((1,3,6,1,4,1,2076,84,1,14,1,3),_DhcpSrvHostBootFileName_Type())
...
dhcpSrvHostBootServerAddress=_DhcpSrvHostBootServerAddress_Object((1,3,6,1,4,1,2076,84,1,14,1,4),_DhcpSrvHostBootServerAddress_Type())
...
dhcpSrvHostConfigRowStatus=_DhcpSrvHostConfigRowStatus_Object((1,3,6,1,4,1,2076,84,1,14,1,5),_DhcpSrvHostConfigRowStatus_Type())
...
dhcpSrvBinding=_DhcpSrvBinding_ObjectIdentity((1,3,6,1,4,1,2076,84,2))
_DhcpSrvBindingTable_Object=MibTable
dhcpSrvBindingTable=_DhcpSrvBindingTable_Object((1,3,6,1,4,1,2076,84,2,1))
if mibBuilder.loadTexts:dhcpSrvBindingTable.setStatus(_A)
_DhcpSrvBindingEntry_Object=MibTableRow
dhcpSrvBindingEntry=_DhcpSrvBindingEntry_Object((1,3,6,1,4,1,2076,84,2,1,1))
...
dhcpSrvBindIpAddress=_DhcpSrvBindIpAddress_Object((1,3,6,1,4,1,2076,84,2,1,1,1),_DhcpSrvBindIpAddress_Type())
...
dhcpSrvBindHwType=_DhcpSrvBindHwType_Object((1,3,6,1,4,1,2076,84,2,1,1,2),_DhcpSrvBindHwType_Type())
...
dhcpSrvBindHwAddress=_DhcpSrvBindHwAddress_Object((1,3,6,1,4,1,2076,84,2,1,1,3),_DhcpSrvBindHwAddress_Type())
...
dhcpSrvBindExpireTime=_DhcpSrvBindExpireTime_Object((1,3,6,1,4,1,2076,84,2,1,1,4),_DhcpSrvBindExpireTime_Type())
...
dhcpSrvBindAllocMethod=_DhcpSrvBindAllocMethod_Object((1,3,6,1,4,1,2076,84,2,1,1,5),_DhcpSrvBindAllocMethod_Type())
...
dhcpSrvBindState=_DhcpSrvBindState_Object((1,3,6,1,4,1,2076,84,2,1,1,6),_DhcpSrvBindState_Type())
...
dhcpSrvBindXid=_DhcpSrvBindXid_Object((1,3,6,1,4,1,2076,84,2,1,1,7),_DhcpSrvBindXid_Type())
...
dhcpSrvBindEntryStatus=_DhcpSrvBindEntryStatus_Object((1,3,6,1,4,1,2076,84,2,1,1,8),_DhcpSrvBindEntryStatus_Type())
...
dhcpSrvCounters=_DhcpSrvCounters_ObjectIdentity((1,3,6,1,4,1,2076,84,3))
_DhcpCountDiscovers_Type=Counter32
_DhcpCountDiscovers_Object=MibScalar
dhcpCountDiscovers=_DhcpCountDiscovers_Object((1,3,6,1,4,1,2076,84,3,1),_DhcpCountDiscovers_Type())
...
dhcpCountRequests=_DhcpCountRequests_Object((1,3,6,1,4,1,2076,84,3,2),_DhcpCountRequests_Type())
...
dhcpCountReleases=_DhcpCountReleases_Object((1,3,6,1,4,1,2076,84,3,3),_DhcpCountReleases_Type())
...
dhcpCountDeclines=_DhcpCountDeclines_Object((1,3,6,1,4,1,2076,84,3,4),_DhcpCountDeclines_Type())
...
dhcpCountInforms=_DhcpCountInforms_Object((1,3,6,1,4,1,2076,84,3,5),_DhcpCountInforms_Type())
...
dhcpCountInvalids=_DhcpCountInvalids_Object((1,3,6,1,4,1,2076,84,3,6),_DhcpCountInvalids_Type())
...
dhcpCountOffers=_DhcpCountOffers_Object((1,3,6,1,4,1,2076,84,3,7),_DhcpCountOffers_Type())
...
dhcpCountAcks=_DhcpCountAcks_Object((1,3,6,1,4,1,2076,84,3,8),_DhcpCountAcks_Type())
...
dhcpCountNacks=_DhcpCountNacks_Object((1,3,6,1,4,1,2076,84,3,9),_DhcpCountNacks_Type())
...
dhcpCountDroppedUnknownClient=_DhcpCountDroppedUnknownClient_Object((1,3,6,1,4,1,2076,84,3,10),_DhcpCountDroppedUnknownClient_Type())
...
dhcpCountDroppedNotServingSubnet=_DhcpCountDroppedNotServingSubnet_Object((1,3,6,1,4,1,2076,84,3,11),_DhcpCountDroppedNotServingSubnet_Type())
...
dhcpCountResetCounters=_DhcpCountResetCounters_Object((1,3,6,1,4,1,2076,84,3,12),_DhcpCountResetCounters_Type())
