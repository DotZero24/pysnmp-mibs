...
ospfAreaEntry, ospfVirtIfEntry, ospfIfEntry, ospfAddressLessIf, ospfNbrEntry, ospfIfIpAddress = mibBuilder.importSymbols("OSPF-MIB", "ospfAreaEntry", "ospfVirtIfEntry", "ospfIfEntry", "ospfAddressLessIf", "ospfNbrEntry", "ospfIfIpAddress")
...
mibBuilder.exportSymbols("Juniper-OSPF-MIB", juniOspfTotalRcv=juniOspfTotalRcv, juniOspfIfBfdMinRxInterval=juniOspfIfBfdMinRxInterval, juniOspfLsuPktsSent=juniOspfLsuPktsSent, juniOspfSummImportTable=juniOspfSummImportTable, juniOspfLsrPktsRcv=juniOspfLsrPktsRcv, juniOspfSummAggNet=juniOspfSummAggNet, juniOspfNbrBDR=juniOspfNbrBDR, juniOspfVirtIfMd5AuthKeyId=juniOspfVirtIfMd5AuthKeyId, juniOspfProcessId=juniOspfProcessId, juniOspfOperState=juniOspfOperState, juniOspfMd5VirtIntfNeighbor=juniOspfMd5VirtIntfNeighbor, juniOspfAreaGroup=juniOspfAreaGroup, juniOspfAreaTable=juniOspfAreaTable, juniOspfBasicGroup2=juniOspfBasicGroup2, juniOspfSummAggMask=juniOspfSummAggMask, juniOspfNbrLocalIpAddr=juniOspfNbrLocalIpAddr, juniOspfNetRangeGroup=juniOspfNetRangeGroup, juniOspfObjects=juniOspfObjects, juniOspfMIB=juniOspfMIB, juniOspfAreaTeCapable=juniOspfAreaTeCapable, juniOspfIfTable=juniOspfIfTable, juniOspfMd5VirtIntfEntry=juniOspfMd5VirtIntfEntry, juniOspfNetworkRangeEntry=juniOspfNetworkRangeEntry, juniOspfIfMd5AuthKeyId=juniOspfIfMd5AuthKeyId, juniOspfSummRowStatus=juniOspfSummRowStatus, juniOspfTotalSent=juniOspfTotalSent, juniOspfHelloPktsRcv=juniOspfHelloPktsRcv, juniOspfAllocFailCirc=juniOspfAllocFailCirc, juniOspfDomainId=juniOspfDomainId, juniOspfLsrPktsSent=juniOspfLsrPktsSent, juniOspfNetRangeNet=juniOspfNetRangeNet, juniOspfDDPktsSent=juniOspfDDPktsSent, juniOspfAllocFailNbr=juniOspfAllocFailNbr, juniOspfLsuPktsRcv=juniOspfLsuPktsRcv, juniOspfCsumErrPkts=juniOspfCsumErrPkts, juniOspfIfBFDTable=juniOspfIfBFDTable, juniOspfLsaDiscardCnt=juniOspfLsaDiscardCnt, juniOspfNbrEntry=juniOspfNbrEntry, juniOspfCompliance3=juniOspfCompliance3, PYSNMP_MODULE_ID=juniOspfMIB, juniOspfIfCost=juniOspfIfCost, juniOspfSpfHoldInterval=juniOspfSpfHoldInterval, juniOspfAutoVlink=juniOspfAutoVlink, juniOspfVirtIfGroup=juniOspfVirtIfGroup, juniOspfMd5VirtIntfTable=juniOspfMd5VirtIntfTable, juniOspfNetRangeRowStatus=juniOspfNetRangeRowStatus, juniOspfCompliances=juniOspfCompliances, juniOspfIfEntry=juniOspfIfEntry, juniOspfMaxPathSplits=juniOspfMaxPathSplits, juniOspfMd5IntfGroup=juniOspfMd5IntfGroup, juniOspfIfBfdEnable=juniOspfIfBfdEnable, juniOspfNetRangeAreaId=juniOspfNetRangeAreaId, juniOspfAllocFailPkt=juniOspfAllocFailPkt, juniOspfGroups=juniOspfGroups, juniOspfAreaEntry=juniOspfAreaEntry, juniOspfAllocFailDbRequest=juniOspfAllocFailDbRequest, juniOspfNetRangeMask=juniOspfNetRangeMask, juniOspfCompliance=juniOspfCompliance, juniOspfIfBfdMinTxInterval=juniOspfIfBfdMinTxInterval, juniOspfMd5VirtIntfGroup=juniOspfMd5VirtIntfGroup, juniOspfErrPktsSent=juniOspfErrPktsSent, juniOspfAllocFailAck=juniOspfAllocFailAck, juniOspfIfPassiveFlag=juniOspfIfPassiveFlag, juniOspfNbrGroup=juniOspfNbrGroup, juniOspfIfNbrCount=juniOspfIfNbrCount, juniOspfLsAckPktsRcv=juniOspfLsAckPktsRcv, juniOspfMd5VirtIntfKeyId=juniOspfMd5VirtIntfKeyId, juniOspfIfBFDGroup=juniOspfIfBFDGroup, juniOspfNbrDR=juniOspfNbrDR, juniOspfAllocFailLsd=juniOspfAllocFailLsd, juniOspfRefBw=juniOspfRefBw, juniOspfSummImportEntry=juniOspfSummImportEntry, juniOspfAllocFailDbPkt=juniOspfAllocFailDbPkt, juniOspfDDPktsRcv=juniOspfDDPktsRcv, juniOspfIfGroup=juniOspfIfGroup, juniOspfConformance=juniOspfConformance, juniOspfMd5IntfAuthKey=juniOspfMd5IntfAuthKey, juniOspfMplsTeRtrIdIfIndex=juniOspfMplsTeRtrIdIfIndex, juniOspfBasicGroup=juniOspfBasicGroup, juniOspfIfMask=juniOspfIfMask, juniOspfMd5IntfEntry=juniOspfMd5IntfEntry, juniOspfCompliance2=juniOspfCompliance2, juniOspfSpfTime=juniOspfSpfTime, juniOspfIfBfdMultiplier=juniOspfIfBfdMultiplier, juniOspfVirtIfEntry=juniOspfVirtIfEntry, juniOspfMd5IntfKeyId=juniOspfMd5IntfKeyId, juniOspfGeneralGroup=juniOspfGeneralGroup, juniOspfIntraDistance=juniOspfIntraDistance, juniOspfMd5VirtIntfKeyActive=juniOspfMd5VirtIntfKeyActive, juniOspfAllocFailLsa=juniOspfAllocFailLsa, juniOspfMd5VirtIntfRowStatus=juniOspfMd5VirtIntfRowStatus, juniOspfNbrTable=juniOspfNbrTable, juniOspfNumActiveAreas=juniOspfNumActiveAreas, juniOspfIfMd5AuthKey=juniOspfIfMd5AuthKey, juniOspfMd5VirtIntfAreaId=juniOspfMd5VirtIntfAreaId, juniOspfVirtIfMd5AuthKey=juniOspfVirtIfMd5AuthKey, juniOspfMd5IntfKeyActive=juniOspfMd5IntfKeyActive, juniOspfIfBFDEntry=juniOspfIfBFDEntry, juniOspfMd5IntfRowStatus=juniOspfMd5IntfRowStatus, juniOspfInterDistance=juniOspfInterDistance, juniOspfSummImportGroup=juniOspfSummImportGroup, juniOspfAllocFailRtx=juniOspfAllocFailRtx, juniOspfNetworkRangeTable=juniOspfNetworkRangeTable, juniOspfExtDistance=juniOspfExtDistance, juniOspfVpnRouteTag=juniOspfVpnRouteTag, juniOspfAreaType=juniOspfAreaType, juniOspfIfAdjNbrCount=juniOspfIfAdjNbrCount, juniOspfMd5IntfTable=juniOspfMd5IntfTable, juniOspfLsAckPktsSent=juniOspfLsAckPktsSent, juniOspfVirtIfTable=juniOspfVirtIfTable, juniOspfHelloPktsSent=juniOspfHelloPktsSent, juniOspfSummAdminStat=juniOspfSummAdminStat, juniOspfMd5VirtIntfAuthKey=juniOspfMd5VirtIntfAuthKey)
