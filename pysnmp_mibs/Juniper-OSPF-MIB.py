...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/junose/Juniper-OSPF-MIB
...
ospfIfIpAddress, ospfAddressLessIf, ospfAreaEntry, ospfVirtIfEntry, ospfIfEntry, ospfNbrEntry = mibBuilder.importSymbols("OSPF-MIB", "ospfIfIpAddress", "ospfAddressLessIf", "ospfAreaEntry", "ospfVirtIfEntry", "ospfIfEntry", "ospfNbrEntry")
...
mibBuilder.exportSymbols("Juniper-OSPF-MIB", juniOspfIfBfdEnable=juniOspfIfBfdEnable, juniOspfSpfHoldInterval=juniOspfSpfHoldInterval, juniOspfLsuPktsRcv=juniOspfLsuPktsRcv, juniOspfNbrGroup=juniOspfNbrGroup, juniOspfMd5IntfGroup=juniOspfMd5IntfGroup, juniOspfLsuPktsSent=juniOspfLsuPktsSent, juniOspfMd5VirtIntfEntry=juniOspfMd5VirtIntfEntry, juniOspfSummImportEntry=juniOspfSummImportEntry, juniOspfAllocFailCirc=juniOspfAllocFailCirc, juniOspfMd5IntfKeyId=juniOspfMd5IntfKeyId, juniOspfAllocFailRtx=juniOspfAllocFailRtx, juniOspfMd5IntfAuthKey=juniOspfMd5IntfAuthKey, juniOspfCompliance=juniOspfCompliance, juniOspfAllocFailPkt=juniOspfAllocFailPkt, juniOspfVirtIfGroup=juniOspfVirtIfGroup, juniOspfNbrEntry=juniOspfNbrEntry, juniOspfMd5VirtIntfRowStatus=juniOspfMd5VirtIntfRowStatus, juniOspfVirtIfEntry=juniOspfVirtIfEntry, juniOspfBasicGroup2=juniOspfBasicGroup2, juniOspfLsrPktsSent=juniOspfLsrPktsSent, juniOspfSpfTime=juniOspfSpfTime, juniOspfMd5IntfEntry=juniOspfMd5IntfEntry, juniOspfNbrDR=juniOspfNbrDR, PYSNMP_MODULE_ID=juniOspfMIB, juniOspfHelloPktsRcv=juniOspfHelloPktsRcv, juniOspfIfBfdMinRxInterval=juniOspfIfBfdMinRxInterval, juniOspfNetRangeNet=juniOspfNetRangeNet, juniOspfIfPassiveFlag=juniOspfIfPassiveFlag, juniOspfDDPktsRcv=juniOspfDDPktsRcv, juniOspfNbrLocalIpAddr=juniOspfNbrLocalIpAddr, juniOspfMd5VirtIntfAreaId=juniOspfMd5VirtIntfAreaId, juniOspfNetworkRangeEntry=juniOspfNetworkRangeEntry, juniOspfRefBw=juniOspfRefBw, juniOspfHelloPktsSent=juniOspfHelloPktsSent, juniOspfVirtIfMd5AuthKey=juniOspfVirtIfMd5AuthKey, juniOspfNbrBDR=juniOspfNbrBDR, juniOspfCompliance2=juniOspfCompliance2, juniOspfIfTable=juniOspfIfTable, juniOspfMd5VirtIntfKeyId=juniOspfMd5VirtIntfKeyId, juniOspfNetRangeAreaId=juniOspfNetRangeAreaId, juniOspfCsumErrPkts=juniOspfCsumErrPkts, juniOspfCompliances=juniOspfCompliances, juniOspfErrPktsSent=juniOspfErrPktsSent, juniOspfSummAdminStat=juniOspfSummAdminStat, juniOspfLsAckPktsSent=juniOspfLsAckPktsSent, juniOspfSummAggMask=juniOspfSummAggMask, juniOspfConformance=juniOspfConformance, juniOspfAllocFailDbRequest=juniOspfAllocFailDbRequest, juniOspfNbrTable=juniOspfNbrTable, juniOspfInterDistance=juniOspfInterDistance, juniOspfMplsTeRtrIdIfIndex=juniOspfMplsTeRtrIdIfIndex, juniOspfNetRangeGroup=juniOspfNetRangeGroup, juniOspfCompliance3=juniOspfCompliance3, juniOspfIfNbrCount=juniOspfIfNbrCount, juniOspfOperState=juniOspfOperState, juniOspfExtDistance=juniOspfExtDistance, juniOspfIntraDistance=juniOspfIntraDistance, juniOspfIfBfdMultiplier=juniOspfIfBfdMultiplier, juniOspfAllocFailAck=juniOspfAllocFailAck, juniOspfIfCost=juniOspfIfCost, juniOspfMd5VirtIntfGroup=juniOspfMd5VirtIntfGroup, juniOspfAllocFailLsa=juniOspfAllocFailLsa, juniOspfMd5VirtIntfTable=juniOspfMd5VirtIntfTable, juniOspfMd5IntfRowStatus=juniOspfMd5IntfRowStatus, juniOspfNetRangeRowStatus=juniOspfNetRangeRowStatus, juniOspfAreaEntry=juniOspfAreaEntry, juniOspfSummImportGroup=juniOspfSummImportGroup, juniOspfMIB=juniOspfMIB, juniOspfAreaTeCapable=juniOspfAreaTeCapable, juniOspfSummImportTable=juniOspfSummImportTable, juniOspfIfMask=juniOspfIfMask, juniOspfIfMd5AuthKey=juniOspfIfMd5AuthKey, juniOspfNetRangeMask=juniOspfNetRangeMask, juniOspfMd5IntfTable=juniOspfMd5IntfTable, juniOspfSummRowStatus=juniOspfSummRowStatus, juniOspfMd5VirtIntfAuthKey=juniOspfMd5VirtIntfAuthKey, juniOspfAllocFailDbPkt=juniOspfAllocFailDbPkt, juniOspfLsAckPktsRcv=juniOspfLsAckPktsRcv, juniOspfLsaDiscardCnt=juniOspfLsaDiscardCnt, juniOspfAreaType=juniOspfAreaType, juniOspfDomainId=juniOspfDomainId, juniOspfMd5IntfKeyActive=juniOspfMd5IntfKeyActive, juniOspfGeneralGroup=juniOspfGeneralGroup, juniOspfIfBfdMinTxInterval=juniOspfIfBfdMinTxInterval, juniOspfIfBFDGroup=juniOspfIfBFDGroup, juniOspfMaxPathSplits=juniOspfMaxPathSplits, juniOspfBasicGroup=juniOspfBasicGroup, juniOspfAutoVlink=juniOspfAutoVlink, juniOspfIfMd5AuthKeyId=juniOspfIfMd5AuthKeyId, juniOspfAllocFailLsd=juniOspfAllocFailLsd, juniOspfDDPktsSent=juniOspfDDPktsSent, juniOspfMd5VirtIntfKeyActive=juniOspfMd5VirtIntfKeyActive, juniOspfLsrPktsRcv=juniOspfLsrPktsRcv, juniOspfAllocFailNbr=juniOspfAllocFailNbr, juniOspfVpnRouteTag=juniOspfVpnRouteTag, juniOspfMd5VirtIntfNeighbor=juniOspfMd5VirtIntfNeighbor, juniOspfObjects=juniOspfObjects, juniOspfTotalRcv=juniOspfTotalRcv, juniOspfIfEntry=juniOspfIfEntry, juniOspfIfBFDEntry=juniOspfIfBFDEntry, juniOspfNumActiveAreas=juniOspfNumActiveAreas, juniOspfVirtIfTable=juniOspfVirtIfTable, juniOspfIfBFDTable=juniOspfIfBFDTable, juniOspfAreaGroup=juniOspfAreaGroup, juniOspfGroups=juniOspfGroups, juniOspfSummAggNet=juniOspfSummAggNet, juniOspfIfGroup=juniOspfIfGroup, juniOspfProcessId=juniOspfProcessId, juniOspfTotalSent=juniOspfTotalSent, juniOspfVirtIfMd5AuthKeyId=juniOspfVirtIfMd5AuthKeyId, juniOspfNetworkRangeTable=juniOspfNetworkRangeTable, juniOspfAreaTable=juniOspfAreaTable, juniOspfIfAdjNbrCount=juniOspfIfAdjNbrCount)
