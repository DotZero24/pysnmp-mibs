...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-HWENVIROMENT
...
class _RlEnvSystemLed_Type(Integer32):
    """Custom type rlEnvSystemLed based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_RlEnvSystemLed_Type.__name__ = "Integer32"
_RlEnvSystemLed_Object = MibScalar
rlEnvSystemLed = _RlEnvSystemLed_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 8),
    _RlEnvSystemLed_Type()
)
rlEnvSystemLed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlEnvSystemLed.setStatus("current")
