...
fastPathQOSCOS=ModuleIdentity((1,3,6,1,4,1,4526,10,3,3))
...
agentCosMapCfgGroup=_AgentCosMapCfgGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,3,3,1))
_AgentCosMapIpPrecTable_Object=MibTable
agentCosMapIpPrecTable=_AgentCosMapIpPrecTable_Object((1,3,6,1,4,1,4526,10,3,3,1,1))
if mibBuilder.loadTexts:agentCosMapIpPrecTable.setStatus(_A)
_AgentCosMapIpPrecEntry_Object=MibTableRow
agentCosMapIpPrecEntry=_AgentCosMapIpPrecEntry_Object((1,3,6,1,4,1,4526,10,3,3,1,1,1))
...
agentCosMapIpPrecIntfIndex=_AgentCosMapIpPrecIntfIndex_Object((1,3,6,1,4,1,4526,10,3,3,1,1,1,1),_AgentCosMapIpPrecIntfIndex_Type())
...
agentCosMapIpPrecValue=_AgentCosMapIpPrecValue_Object((1,3,6,1,4,1,4526,10,3,3,1,1,1,2),_AgentCosMapIpPrecValue_Type())
...
agentCosMapIpPrecTrafficClass=_AgentCosMapIpPrecTrafficClass_Object((1,3,6,1,4,1,4526,10,3,3,1,1,1,3),_AgentCosMapIpPrecTrafficClass_Type())
...
agentCosMapIpDscpTable=_AgentCosMapIpDscpTable_Object((1,3,6,1,4,1,4526,10,3,3,1,2))
if mibBuilder.loadTexts:agentCosMapIpDscpTable.setStatus(_A)
_AgentCosMapIpDscpEntry_Object=MibTableRow
agentCosMapIpDscpEntry=_AgentCosMapIpDscpEntry_Object((1,3,6,1,4,1,4526,10,3,3,1,2,1))
...
agentCosMapIpDscpIntfIndex=_AgentCosMapIpDscpIntfIndex_Object((1,3,6,1,4,1,4526,10,3,3,1,2,1,1),_AgentCosMapIpDscpIntfIndex_Type())
...
agentCosMapIpDscpValue=_AgentCosMapIpDscpValue_Object((1,3,6,1,4,1,4526,10,3,3,1,2,1,2),_AgentCosMapIpDscpValue_Type())
...
agentCosMapIpDscpTrafficClass=_AgentCosMapIpDscpTrafficClass_Object((1,3,6,1,4,1,4526,10,3,3,1,2,1,3),_AgentCosMapIpDscpTrafficClass_Type())
...
agentCosMapIntfTrustTable=_AgentCosMapIntfTrustTable_Object((1,3,6,1,4,1,4526,10,3,3,1,3))
if mibBuilder.loadTexts:agentCosMapIntfTrustTable.setStatus(_A)
_AgentCosMapIntfTrustEntry_Object=MibTableRow
agentCosMapIntfTrustEntry=_AgentCosMapIntfTrustEntry_Object((1,3,6,1,4,1,4526,10,3,3,1,3,1))
...
agentCosMapIntfTrustIntfIndex=_AgentCosMapIntfTrustIntfIndex_Object((1,3,6,1,4,1,4526,10,3,3,1,3,1,1),_AgentCosMapIntfTrustIntfIndex_Type())
...
agentCosMapIntfTrustMode=_AgentCosMapIntfTrustMode_Object((1,3,6,1,4,1,4526,10,3,3,1,3,1,2),_AgentCosMapIntfTrustMode_Type())
...
agentCosMapUntrustedTrafficClass=_AgentCosMapUntrustedTrafficClass_Object((1,3,6,1,4,1,4526,10,3,3,1,3,1,3),_AgentCosMapUntrustedTrafficClass_Type())
...
agentCosQueueCfgGroup=_AgentCosQueueCfgGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,3,3,2))
_AgentCosQueueNumQueuesPerPort_Type=Unsigned32
_AgentCosQueueNumQueuesPerPort_Object=MibScalar
agentCosQueueNumQueuesPerPort=_AgentCosQueueNumQueuesPerPort_Object((1,3,6,1,4,1,4526,10,3,3,2,1),_AgentCosQueueNumQueuesPerPort_Type())
...
agentCosQueueNumDropPrecedenceLevels=_AgentCosQueueNumDropPrecedenceLevels_Object((1,3,6,1,4,1,4526,10,3,3,2,2),_AgentCosQueueNumDropPrecedenceLevels_Type())
...
agentCosQueueControlTable=_AgentCosQueueControlTable_Object((1,3,6,1,4,1,4526,10,3,3,2,3))
if mibBuilder.loadTexts:agentCosQueueControlTable.setStatus(_A)
_AgentCosQueueControlEntry_Object=MibTableRow
agentCosQueueControlEntry=_AgentCosQueueControlEntry_Object((1,3,6,1,4,1,4526,10,3,3,2,3,1))
...
agentCosQueueIntfIndex=_AgentCosQueueIntfIndex_Object((1,3,6,1,4,1,4526,10,3,3,2,3,1,1),_AgentCosQueueIntfIndex_Type())
...
agentCosQueueIntfShapingRate=_AgentCosQueueIntfShapingRate_Object((1,3,6,1,4,1,4526,10,3,3,2,3,1,2),_AgentCosQueueIntfShapingRate_Type())
...
agentCosQueueMgmtTypeIntf=_AgentCosQueueMgmtTypeIntf_Object((1,3,6,1,4,1,4526,10,3,3,2,3,1,3),_AgentCosQueueMgmtTypeIntf_Type())
...
agentCosQueueWredDecayExponent=_AgentCosQueueWredDecayExponent_Object((1,3,6,1,4,1,4526,10,3,3,2,3,1,4),_AgentCosQueueWredDecayExponent_Type())
...
agentCosQueueDefaultsRestore=_AgentCosQueueDefaultsRestore_Object((1,3,6,1,4,1,4526,10,3,3,2,3,1,5),_AgentCosQueueDefaultsRestore_Type())
...
agentCosQueueIntfShapingRateUnits=_AgentCosQueueIntfShapingRateUnits_Object((1,3,6,1,4,1,4526,10,3,3,2,3,1,6),_AgentCosQueueIntfShapingRateUnits_Type())
...
agentCosQueueTable=_AgentCosQueueTable_Object((1,3,6,1,4,1,4526,10,3,3,2,4))
if mibBuilder.loadTexts:agentCosQueueTable.setStatus(_A)
_AgentCosQueueEntry_Object=MibTableRow
agentCosQueueEntry=_AgentCosQueueEntry_Object((1,3,6,1,4,1,4526,10,3,3,2,4,1))
...
agentCosQueueIndex=_AgentCosQueueIndex_Object((1,3,6,1,4,1,4526,10,3,3,2,4,1,1),_AgentCosQueueIndex_Type())
...
agentCosQueueSchedulerType=_AgentCosQueueSchedulerType_Object((1,3,6,1,4,1,4526,10,3,3,2,4,1,2),_AgentCosQueueSchedulerType_Type())
...
agentCosQueueMinBandwidth=_AgentCosQueueMinBandwidth_Object((1,3,6,1,4,1,4526,10,3,3,2,4,1,3),_AgentCosQueueMinBandwidth_Type())
...
agentCosQueueMaxBandwidth=_AgentCosQueueMaxBandwidth_Object((1,3,6,1,4,1,4526,10,3,3,2,4,1,4),_AgentCosQueueMaxBandwidth_Type())
...
agentCosQueueMgmtType=_AgentCosQueueMgmtType_Object((1,3,6,1,4,1,4526,10,3,3,2,4,1,5),_AgentCosQueueMgmtType_Type())
...
agentCosQueueMgmtTable=_AgentCosQueueMgmtTable_Object((1,3,6,1,4,1,4526,10,3,3,2,5))
if mibBuilder.loadTexts:agentCosQueueMgmtTable.setStatus(_A)
_AgentCosQueueMgmtEntry_Object=MibTableRow
agentCosQueueMgmtEntry=_AgentCosQueueMgmtEntry_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1))
...
agentCosQueueDropPrecIndex=_AgentCosQueueDropPrecIndex_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1,1),_AgentCosQueueDropPrecIndex_Type())
...
agentCosQueueMgmtTailDropThreshold=_AgentCosQueueMgmtTailDropThreshold_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1,2),_AgentCosQueueMgmtTailDropThreshold_Type())
...
agentCosQueueMgmtWredMinThreshold=_AgentCosQueueMgmtWredMinThreshold_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1,3),_AgentCosQueueMgmtWredMinThreshold_Type())
...
agentCosQueueMgmtWredMaxThreshold=_AgentCosQueueMgmtWredMaxThreshold_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1,4),_AgentCosQueueMgmtWredMaxThreshold_Type())
...
agentCosQueueMgmtWredDropProbScale=_AgentCosQueueMgmtWredDropProbScale_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1,5),_AgentCosQueueMgmtWredDropProbScale_Type())
...
agentCosQueueMgmtPercentTailDropThreshold=_AgentCosQueueMgmtPercentTailDropThreshold_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1,6),_AgentCosQueueMgmtPercentTailDropThreshold_Type())
...
agentCosQueueMgmtPercentWredMinThreshold=_AgentCosQueueMgmtPercentWredMinThreshold_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1,7),_AgentCosQueueMgmtPercentWredMinThreshold_Type())
...
agentCosQueueMgmtPercentWredMaxThreshold=_AgentCosQueueMgmtPercentWredMaxThreshold_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1,8),_AgentCosQueueMgmtPercentWredMaxThreshold_Type())
...
agentCosQueueMgmtWredDropProbability=_AgentCosQueueMgmtWredDropProbability_Object((1,3,6,1,4,1,4526,10,3,3,2,5,1,9),_AgentCosQueueMgmtWredDropProbability_Type())
