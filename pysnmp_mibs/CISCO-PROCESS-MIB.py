...
mibBuilder.exportSymbols("CISCO-PROCESS-MIB", cpmProcExtUtil1Min=cpmProcExtUtil1Min, ciscoProcessMIBObjects=ciscoProcessMIBObjects, cpmProcessExtRevOverflowGroup=cpmProcessExtRevOverflowGroup, cpmCoreEntry=cpmCoreEntry, cpmCPUTotal5secRev=cpmCPUTotal5secRev, cpmVirtualProcessUtil1Min=cpmVirtualProcessUtil1Min, cpmProcessPID=cpmProcessPID, cpmCPUFallingThreshold=cpmCPUFallingThreshold, cpmVirtualProcessInvokeCount=cpmVirtualProcessInvokeCount, cpmCPUTotal1min=cpmCPUTotal1min, cpmCPUProcessHistoryIndex=cpmCPUProcessHistoryIndex, cpmProcessRespawnCount=cpmProcessRespawnCount, cpmProcess=cpmProcess, cpmProcExtUtil5Sec=cpmProcExtUtil5Sec, cpmCPUTotalHCGroup=cpmCPUTotalHCGroup, cpmCPUTotal5sec=cpmCPUTotal5sec, cpmProcessMemoryCore=cpmProcessMemoryCore, cpmCPUTotalTable=cpmCPUTotalTable, cpmProcExtMemAllocatedRevOvrflw=cpmProcExtMemAllocatedRevOvrflw, cpmProcExtHCMemFreedRev=cpmProcExtHCMemFreedRev, cpmCompliances=cpmCompliances, cpmProcExtUtil5Min=cpmProcExtUtil5Min, cpmProcessLastRestartUser=cpmProcessLastRestartUser, cpmProcessDynamicMemorySizeOvrflw=cpmProcessDynamicMemorySizeOvrflw, cpmProcessHCDynamicMemorySize=cpmProcessHCDynamicMemorySize, cpmCPUThresholdNotificationGroup=cpmCPUThresholdNotificationGroup, cpmVirtualProcessHCGroup=cpmVirtualProcessHCGroup, cpmThreadName=cpmThreadName, cpmCPUThresholdClass=cpmCPUThresholdClass, cpmCPURisingThresholdValue=cpmCPURisingThresholdValue, cpmCPUMemoryHCKernelReserved=cpmCPUMemoryHCKernelReserved, cpmCPULoadAvg5min=cpmCPULoadAvg5min, cProcessMIBComplianceRev5=cProcessMIBComplianceRev5, cpmCPUTotal5min=cpmCPUTotal5min, ciscoProcessMIBNotifs=ciscoProcessMIBNotifs, cpmCoreTable=cpmCoreTable, cpmCPUFallingThresholdValue=cpmCPUFallingThresholdValue, cpmCPUHistoryEntry=cpmCPUHistoryEntry, cpmVirtualProcessTable=cpmVirtualProcessTable, cpmCPUInterruptMonIntervalValue=cpmCPUInterruptMonIntervalValue, CPULoadAverage=CPULoadAverage, cpmCPUHistoryTable=cpmCPUHistoryTable, cpmProcExtMemFreedRevOvrflw=cpmProcExtMemFreedRevOvrflw, cpmProcessAverageUSecs=cpmProcessAverageUSecs, cProcessMIBComplianceRev4=cProcessMIBComplianceRev4, cpmCPUMemoryKernelReservedOvrflw=cpmCPUMemoryKernelReservedOvrflw, cpmProcessState=cpmProcessState, cpmVirtualProcessUtil5Min=cpmVirtualProcessUtil5Min, cpmProcessExtGroup=cpmProcessExtGroup, cpmProcessuSecs=cpmProcessuSecs, cpmVirtualProcessOverflowGroup=cpmVirtualProcessOverflowGroup, cpmProcExtMemFreedRev=cpmProcExtMemFreedRev, cpmProcessTimeCreated=cpmProcessTimeCreated, cpmCoreLoadAvg5min=cpmCoreLoadAvg5min, cpmThreadHCStackSize=cpmThreadHCStackSize, cpmCPULoadAvgGroup=cpmCPULoadAvgGroup, cpmProcessExtEntry=cpmProcessExtEntry, cpmProcessExtRevEntry=cpmProcessExtRevEntry, cProcessMIBComplianceRev=cProcessMIBComplianceRev, cpmCPUHistoryReportId=cpmCPUHistoryReportId, cpmCPU=cpmCPU, cpmCPULoadAvg15min=cpmCPULoadAvg15min, cpmProcessHCDataSegmentSize=cpmProcessHCDataSegmentSize, cProcessMIBComplianceRev2=cProcessMIBComplianceRev2, cpmProcExtRuntimeRev=cpmProcExtRuntimeRev, cpmCPUMemoryLowestOvrflw=cpmCPUMemoryLowestOvrflw, cpmCPUProcessHistoryTable=cpmCPUProcessHistoryTable, cpmCPUMemoryFree=cpmCPUMemoryFree, cpmCPURisingThresholdPeriod=cpmCPURisingThresholdPeriod, cpmCPUTotal1minRev=cpmCPUTotal1minRev, cpmCPURisingThreshold=cpmCPURisingThreshold, cpmThreadTable=cpmThreadTable, cpmCPULoadAvg1min=cpmCPULoadAvg1min, cpmCPUProcessHistoryEntry=cpmCPUProcessHistoryEntry, cpmProcessName=cpmProcessName, cpmProcessStateTrap=cpmProcessStateTrap, cpmGroups=cpmGroups, cpmCPUHistory=cpmCPUHistory, cpmVirtualProcessMemFreed=cpmVirtualProcessMemFreed, cpmCPUHistoryGroup=cpmCPUHistoryGroup, cpmCPUHistoryThreshold=cpmCPUHistoryThreshold, cpmCPUTotalMonIntervalValue=cpmCPUTotalMonIntervalValue, cpmThreadBlockingProcess=cpmThreadBlockingProcess, cpmVirtualProcessMemFreedOvrflw=cpmVirtualProcessMemFreedOvrflw, cpmCPUHistoryCreatedTime=cpmCPUHistoryCreatedTime, cpmCPUTotalGroup=cpmCPUTotalGroup, cpmCPUThresholdEntry=cpmCPUThresholdEntry, cpmCPUMemoryCommittedOvrflw=cpmCPUMemoryCommittedOvrflw, cpmProcessHCTextSegmentSize=cpmProcessHCTextSegmentSize, cpmProcExtMemFreed=cpmProcExtMemFreed, cpmCPUHistoryProcId=cpmCPUHistoryProcId, cpmCoreIndex=cpmCoreIndex, cpmThreadEntry=cpmThreadEntry, cpmVirtualProcessName=cpmVirtualProcessName, cpmProcExtPriorityRev=cpmProcExtPriorityRev, cpmVirtualProcessGroup=cpmVirtualProcessGroup, cpmCPUPosixMemoryGroup=cpmCPUPosixMemoryGroup, cpmCPUTotalPhysicalIndex=cpmCPUTotalPhysicalIndex, cpmVirtualProcessUtil5Sec=cpmVirtualProcessUtil5Sec, cpmCPUThresholdEntryStatus=cpmCPUThresholdEntryStatus, cpmThreadStackSize=cpmThreadStackSize, cProcessMIBComplianceRev1=cProcessMIBComplianceRev1, cpmCore5min=cpmCore5min, cpmCPUTotalGroupRev=cpmCPUTotalGroupRev, cpmCPUTotalMemoryCommitGroup=cpmCPUTotalMemoryCommitGroup, cpmProcessEntry=cpmProcessEntry, cpmProcessGroupRev=cpmProcessGroupRev, cpmProcessExtGroupRev=cpmProcessExtGroupRev, cpmProcessType=cpmProcessType, cpmThreadPriority=cpmThreadPriority, cpmPosixProcessGroup=cpmPosixProcessGroup, cpmCPUMonInterval=cpmCPUMonInterval, cpmThreadStackSizeOvrflw=cpmThreadStackSizeOvrflw, cpmCPUMemoryHCUsed=cpmCPUMemoryHCUsed, cpmProcExtHCMemAllocatedRev=cpmProcExtHCMemAllocatedRev, cpmCoreGroup=cpmCoreGroup, cpmVirtualProcess=cpmVirtualProcess, cpmProcessDynamicMemorySize=cpmProcessDynamicMemorySize, cpmVirtualProcessEntry=cpmVirtualProcessEntry, cpmVirtualProcessHCMemAllocated=cpmVirtualProcessHCMemAllocated, cpmThreadOverflowGroup=cpmThreadOverflowGroup, cpmProcExtPriority=cpmProcExtPriority, cProcessMIBComplianceRev3=cProcessMIBComplianceRev3, cpmThread=cpmThread, cpmProcessTable=cpmProcessTable, cpmCPUTotalIndex=cpmCPUTotalIndex, cpmCore5sec=cpmCore5sec, cpmThreadID=cpmThreadID, cpmCPUMemoryHCFree=cpmCPUMemoryHCFree, cpmProcessStackSize=cpmProcessStackSize, cpmCPUHistoryProcUtil=cpmCPUHistoryProcUtil, cpmThreadHCGroup=cpmThreadHCGroup, cpmProcExtMemAllocatedRev=cpmProcExtMemAllocatedRev, cpmProcExtRuntime=cpmProcExtRuntime, cpmProcessHCStackSize=cpmProcessHCStackSize, cpmCPUTotal5minRev=cpmCPUTotal5minRev, cpmProcessExtTable=cpmProcessExtTable, cpmProcessExtRevHCGroup=cpmProcessExtRevHCGroup, cpmProcExtUtil1MinRev=cpmProcExtUtil1MinRev, cpmCPUThresholdGroup=cpmCPUThresholdGroup, cpmCPUMemoryCommitted=cpmCPUMemoryCommitted, cpmProcessRespawn=cpmProcessRespawn, cProcessMIBCompliance=cProcessMIBCompliance, cpmProcessExtRevTable=cpmProcessExtRevTable, cpmVirtualProcessMemAllocated=cpmVirtualProcessMemAllocated, cpmProcExtUtil5SecRev=cpmProcExtUtil5SecRev, cpmCPUMemoryKernelReserved=cpmCPUMemoryKernelReserved, cpmCPUTotalEntry=cpmCPUTotalEntry, cpmCPUFallingThresholdPeriod=cpmCPUFallingThresholdPeriod, cpmProcessStackSizeOvrflw=cpmProcessStackSizeOvrflw, cpmProcExtMemAllocated=cpmProcExtMemAllocated, cpmProcExtInvoked=cpmProcExtInvoked, cpmThreadState=cpmThreadState, PYSNMP_MODULE_ID=ciscoProcessMIB, cpmThreadCpuUtilization=cpmThreadCpuUtilization, cpmCPUHistoryProcCreated=cpmCPUHistoryProcCreated, cpmVirtualProcessHCMemFreed=cpmVirtualProcessHCMemFreed, cpmCPUMemoryFreeOvrflw=cpmCPUMemoryFreeOvrflw, cpmProcessRespawnAfterLastPatch=cpmProcessRespawnAfterLastPatch, cpmCPUHistoryReportSize=cpmCPUHistoryReportSize, cpmCPUMemoryUsed=cpmCPUMemoryUsed, ciscoProcessMIBNotifPrefix=ciscoProcessMIBNotifPrefix, cpmCPUHistoryTotalUtil=cpmCPUHistoryTotalUtil, cpmVirtualProcessMemAllocatedOvrflw=cpmVirtualProcessMemAllocatedOvrflw, cpmCore1min=cpmCore1min, cpmCoreLoadAvg1min=cpmCoreLoadAvg1min, cpmVirtualProcessID=cpmVirtualProcessID, cpmCPUHistoryProcName=cpmCPUHistoryProcName, cpmProcessDataSegmentSizeOvrflw=cpmProcessDataSegmentSizeOvrflw, cpmProcessTextSegmentSize=cpmProcessTextSegmentSize, cpmProcessTextSegmentSizeOvrflw=cpmProcessTextSegmentSizeOvrflw, cpmCPUThresholdTable=cpmCPUThresholdTable, cpmProcExtInvokedRev=cpmProcExtInvokedRev, cpmCPUMemoryUsedOvrflw=cpmCPUMemoryUsedOvrflw, cpmCoreLoadAvg15min=cpmCoreLoadAvg15min, cpmCPUHistoryInterruptUtil=cpmCPUHistoryInterruptUtil, cpmProcessGroup=cpmProcessGroup, cpmVirtualProcessRuntime=cpmVirtualProcessRuntime, cpmCPUHistorySize=cpmCPUHistorySize, cpmProcExtUtil5MinRev=cpmProcExtUtil5MinRev, cpmCPUMemoryHCCommitted=cpmCPUMemoryHCCommitted, ciscoProcessMIBConformance=ciscoProcessMIBConformance, cpmCPUMemoryLowest=cpmCPUMemoryLowest, cpmProcessDataSegmentSize=cpmProcessDataSegmentSize, ciscoProcessMIB=ciscoProcessMIB, cpmCPUTotalGroupRev1=cpmCPUTotalGroupRev1, cpmThreadGroup=cpmThreadGroup, cpmCPUMemoryHCLowest=cpmCPUMemoryHCLowest, cpmCPUTotalOverflowGroup=cpmCPUTotalOverflowGroup, cpmCorePhysicalIndex=cpmCorePhysicalIndex)
