...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-PROCESS-MIB
...
if mibBuilder.loadTexts: ciscoProcessMIB.setLastUpdated('202004210000Z')
...
mibBuilder.exportSymbols("CISCO-PROCESS-MIB", cpmVirtualProcess=cpmVirtualProcess, cpmCPUMemoryFree=cpmCPUMemoryFree, cpmThreadStackSizeOvrflw=cpmThreadStackSizeOvrflw, cpmCPURisingThresholdValue=cpmCPURisingThresholdValue, cpmProcessExtEntry=cpmProcessExtEntry, ciscoProcessMIBNotifPrefix=ciscoProcessMIBNotifPrefix, cpmProcExtMemFreed=cpmProcExtMemFreed, cProcessMIBComplianceRev2=cProcessMIBComplianceRev2, cpmProcessEntry=cpmProcessEntry, cpmProcExtUtil5MinRev=cpmProcExtUtil5MinRev, cpmVirtualProcessInvokeCount=cpmVirtualProcessInvokeCount, cpmCPUTotal5secRev=cpmCPUTotal5secRev, cpmCPUTotalTable=cpmCPUTotalTable, cpmCore5min=cpmCore5min, cProcessMIBComplianceRev5=cProcessMIBComplianceRev5, cpmCPUMemoryUsedOvrflw=cpmCPUMemoryUsedOvrflw, cpmProcExtUtil5SecRev=cpmProcExtUtil5SecRev, cpmProcessExtRevTable=cpmProcessExtRevTable, ciscoProcessMIB=ciscoProcessMIB, cpmThreadName=cpmThreadName, cpmCPUTotalIndex=cpmCPUTotalIndex, cpmVirtualProcessMemAllocated=cpmVirtualProcessMemAllocated, cpmCPUHistory=cpmCPUHistory, cpmCPULoadAvg5min=cpmCPULoadAvg5min, cpmProcessExtRevEntry=cpmProcessExtRevEntry, cProcessMIBComplianceRev1=cProcessMIBComplianceRev1, cpmCPUHistoryThreshold=cpmCPUHistoryThreshold, cpmCPUTotalGroupRev=cpmCPUTotalGroupRev, cpmCPU=cpmCPU, cpmProcessTextSegmentSize=cpmProcessTextSegmentSize, cpmCPUHistoryReportId=cpmCPUHistoryReportId, cpmVirtualProcessUtil1Min=cpmVirtualProcessUtil1Min, cpmCPUHistoryProcId=cpmCPUHistoryProcId, cpmProcessRespawn=cpmProcessRespawn, cpmProcessTextSegmentSizeOvrflw=cpmProcessTextSegmentSizeOvrflw, cpmCore1min=cpmCore1min, cpmCPURisingThresholdPeriod=cpmCPURisingThresholdPeriod, cpmGroups=cpmGroups, cpmProcessTable=cpmProcessTable, cpmCPUThresholdClass=cpmCPUThresholdClass, ciscoProcessMIBNotifs=ciscoProcessMIBNotifs, cpmCPUMemoryKernelReservedOvrflw=cpmCPUMemoryKernelReservedOvrflw, cpmVirtualProcessGroup=cpmVirtualProcessGroup, cpmVirtualProcessMemFreedOvrflw=cpmVirtualProcessMemFreedOvrflw, cpmCPUTotal5minRev=cpmCPUTotal5minRev, cpmCPUTotalGroup=cpmCPUTotalGroup, cpmCPUTotalHCGroup=cpmCPUTotalHCGroup, cpmCPUMemoryHCKernelReserved=cpmCPUMemoryHCKernelReserved, cpmCPUMemoryKernelReserved=cpmCPUMemoryKernelReserved, cpmProcessStackSizeOvrflw=cpmProcessStackSizeOvrflw, cpmProcessDynamicMemorySizeOvrflw=cpmProcessDynamicMemorySizeOvrflw, cpmVirtualProcessName=cpmVirtualProcessName, cpmCPUHistoryInterruptUtil=cpmCPUHistoryInterruptUtil, cpmProcessTimeCreated=cpmProcessTimeCreated, cpmProcessHCDataSegmentSize=cpmProcessHCDataSegmentSize, cpmProcessDataSegmentSize=cpmProcessDataSegmentSize, cpmProcessPID=cpmProcessPID, cpmProcExtRuntimeRev=cpmProcExtRuntimeRev, cpmProcessuSecs=cpmProcessuSecs, cpmProcExtPriorityRev=cpmProcExtPriorityRev, cpmCPUHistoryProcCreated=cpmCPUHistoryProcCreated, cpmCoreGroup=cpmCoreGroup, cpmCPUThresholdEntry=cpmCPUThresholdEntry, cpmVirtualProcessHCMemFreed=cpmVirtualProcessHCMemFreed, cpmCPUMemoryLowest=cpmCPUMemoryLowest, cpmProcExtMemFreedRev=cpmProcExtMemFreedRev, cpmProcExtMemAllocatedRev=cpmProcExtMemAllocatedRev, cpmThreadID=cpmThreadID, cpmProcessHCStackSize=cpmProcessHCStackSize, cpmCPUHistoryEntry=cpmCPUHistoryEntry, cpmVirtualProcessOverflowGroup=cpmVirtualProcessOverflowGroup, cpmProcExtRuntime=cpmProcExtRuntime, cpmCPUTotal5sec=cpmCPUTotal5sec, CPULoadAverage=CPULoadAverage, cProcessMIBComplianceRev3=cProcessMIBComplianceRev3, cpmCPULoadAvg1min=cpmCPULoadAvg1min, cpmProcessDataSegmentSizeOvrflw=cpmProcessDataSegmentSizeOvrflw, cpmVirtualProcessUtil5Sec=cpmVirtualProcessUtil5Sec, cpmCoreLoadAvg1min=cpmCoreLoadAvg1min, cpmProcExtMemAllocatedRevOvrflw=cpmProcExtMemAllocatedRevOvrflw, cpmCPUThresholdGroup=cpmCPUThresholdGroup, cpmProcessGroup=cpmProcessGroup, cpmCPUTotalPhysicalIndex=cpmCPUTotalPhysicalIndex, cpmProcessAverageUSecs=cpmProcessAverageUSecs, cpmProcessDynamicMemorySize=cpmProcessDynamicMemorySize, cpmProcessHCTextSegmentSize=cpmProcessHCTextSegmentSize, cpmCPUThresholdTable=cpmCPUThresholdTable, cpmThreadTable=cpmThreadTable, cpmVirtualProcessHCMemAllocated=cpmVirtualProcessHCMemAllocated, cpmProcessName=cpmProcessName, cpmCPUMemoryHCFree=cpmCPUMemoryHCFree, cpmCPUProcessHistoryTable=cpmCPUProcessHistoryTable, cpmCoreEntry=cpmCoreEntry, cpmCPUFallingThreshold=cpmCPUFallingThreshold, cpmCPUTotalOverflowGroup=cpmCPUTotalOverflowGroup, cpmThreadOverflowGroup=cpmThreadOverflowGroup, cpmProcExtPriority=cpmProcExtPriority, cpmCorePhysicalIndex=cpmCorePhysicalIndex, cpmCPUTotalMonIntervalValue=cpmCPUTotalMonIntervalValue, cpmCPUMemoryHCCommitted=cpmCPUMemoryHCCommitted, cpmCPUHistoryReportSize=cpmCPUHistoryReportSize, cpmVirtualProcessEntry=cpmVirtualProcessEntry, cpmCPUMemoryLowestOvrflw=cpmCPUMemoryLowestOvrflw, cpmCPUTotalGroupRev1=cpmCPUTotalGroupRev1, cpmCPUHistoryTotalUtil=cpmCPUHistoryTotalUtil, cpmCPURisingThreshold=cpmCPURisingThreshold, cpmVirtualProcessHCGroup=cpmVirtualProcessHCGroup, cpmThreadBlockingProcess=cpmThreadBlockingProcess, cpmCPUMonInterval=cpmCPUMonInterval, cpmProcExtUtil1Min=cpmProcExtUtil1Min, cpmCPULoadAvgGroup=cpmCPULoadAvgGroup, cpmCPUMemoryHCLowest=cpmCPUMemoryHCLowest, cpmCPUHistorySize=cpmCPUHistorySize, cpmCPUProcessHistoryIndex=cpmCPUProcessHistoryIndex, cpmCPUMemoryFreeOvrflw=cpmCPUMemoryFreeOvrflw, cpmThreadPriority=cpmThreadPriority, cpmCPUTotal1min=cpmCPUTotal1min, cpmCPUFallingThresholdPeriod=cpmCPUFallingThresholdPeriod, cpmProcessRespawnAfterLastPatch=cpmProcessRespawnAfterLastPatch, cpmThread=cpmThread, cpmProcessStateTrap=cpmProcessStateTrap, cpmProcessExtRevHCGroup=cpmProcessExtRevHCGroup, cpmCore5sec=cpmCore5sec, cpmCoreLoadAvg15min=cpmCoreLoadAvg15min, cpmProcessMemoryCore=cpmProcessMemoryCore, cpmProcExtMemFreedRevOvrflw=cpmProcExtMemFreedRevOvrflw, cpmCPUMemoryCommittedOvrflw=cpmCPUMemoryCommittedOvrflw, cpmVirtualProcessMemAllocatedOvrflw=cpmVirtualProcessMemAllocatedOvrflw, cpmCoreTable=cpmCoreTable, cpmThreadGroup=cpmThreadGroup, cpmThreadState=cpmThreadState, cpmCPUMemoryCommitted=cpmCPUMemoryCommitted, cpmCPUHistoryTable=cpmCPUHistoryTable, cpmProcessLastRestartUser=cpmProcessLastRestartUser, cpmThreadEntry=cpmThreadEntry, cpmThreadCpuUtilization=cpmThreadCpuUtilization, cpmProcExtUtil5Sec=cpmProcExtUtil5Sec, cpmProcExtInvokedRev=cpmProcExtInvokedRev, cpmCPUInterruptMonIntervalValue=cpmCPUInterruptMonIntervalValue, cpmCPUHistoryProcUtil=cpmCPUHistoryProcUtil, cpmCPUMemoryHCUsed=cpmCPUMemoryHCUsed, cpmCPUTotal5min=cpmCPUTotal5min, cpmVirtualProcessID=cpmVirtualProcessID, cpmCPUHistoryProcName=cpmCPUHistoryProcName, cpmCPUThresholdNotificationGroup=cpmCPUThresholdNotificationGroup, cpmProcessExtRevOverflowGroup=cpmProcessExtRevOverflowGroup, cpmCPUTotalEntry=cpmCPUTotalEntry, cpmProcExtHCMemFreedRev=cpmProcExtHCMemFreedRev, cpmCoreIndex=cpmCoreIndex, cpmCPUThresholdEntryStatus=cpmCPUThresholdEntryStatus, cpmVirtualProcessRuntime=cpmVirtualProcessRuntime, cpmVirtualProcessTable=cpmVirtualProcessTable, cpmCPUHistoryCreatedTime=cpmCPUHistoryCreatedTime, cpmThreadStackSize=cpmThreadStackSize, cpmProcExtUtil5Min=cpmProcExtUtil5Min, cpmCPUPosixMemoryGroup=cpmCPUPosixMemoryGroup, cpmProcExtUtil1MinRev=cpmProcExtUtil1MinRev, cpmCoreLoadAvg5min=cpmCoreLoadAvg5min, cpmProcessState=cpmProcessState, cpmThreadHCStackSize=cpmThreadHCStackSize, cpmCompliances=cpmCompliances, PYSNMP_MODULE_ID=ciscoProcessMIB, cProcessMIBComplianceRev=cProcessMIBComplianceRev, cProcessMIBComplianceRev4=cProcessMIBComplianceRev4, cpmProcess=cpmProcess, cpmProcExtMemAllocated=cpmProcExtMemAllocated, cpmProcessExtTable=cpmProcessExtTable, ciscoProcessMIBConformance=ciscoProcessMIBConformance, cpmCPUMemoryUsed=cpmCPUMemoryUsed, cpmVirtualProcessMemFreed=cpmVirtualProcessMemFreed, cpmProcessType=cpmProcessType, cpmProcessStackSize=cpmProcessStackSize, ciscoProcessMIBObjects=ciscoProcessMIBObjects, cpmProcessHCDynamicMemorySize=cpmProcessHCDynamicMemorySize, cpmProcExtInvoked=cpmProcExtInvoked, cpmCPUProcessHistoryEntry=cpmCPUProcessHistoryEntry, cpmProcessGroupRev=cpmProcessGroupRev, cpmThreadHCGroup=cpmThreadHCGroup, cpmCPUHistoryGroup=cpmCPUHistoryGroup, cpmCPUFallingThresholdValue=cpmCPUFallingThresholdValue, cpmProcessExtGroup=cpmProcessExtGroup, cProcessMIBCompliance=cProcessMIBCompliance, cpmProcessRespawnCount=cpmProcessRespawnCount, cpmProcExtHCMemAllocatedRev=cpmProcExtHCMemAllocatedRev, cpmProcessExtGroupRev=cpmProcessExtGroupRev, cpmCPUTotalMemoryCommitGroup=cpmCPUTotalMemoryCommitGroup, cpmPosixProcessGroup=cpmPosixProcessGroup, cpmCPULoadAvg15min=cpmCPULoadAvg15min, cpmCPUTotal1minRev=cpmCPUTotal1minRev, cpmVirtualProcessUtil5Min=cpmVirtualProcessUtil5Min)
