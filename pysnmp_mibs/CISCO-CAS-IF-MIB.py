...
mibBuilder.exportSymbols("CISCO-CAS-IF-MIB", ccasGrpStaCfgNumberRings=ccasGrpStaCfgNumberRings, ccasGrpEMObjects=ccasGrpEMObjects, ccasChannelCfgGroup=ccasChannelCfgGroup, ccasGrpABCDObjects=ccasGrpABCDObjects, ccasIfMIBComplianceRev3=ccasIfMIBComplianceRev3, ccasGrpGeneralObjects=ccasGrpGeneralObjects, ccasXgcpCfgCotToneCo1=ccasXgcpCfgCotToneCo1, ccasGrpCfgEntry=ccasGrpCfgEntry, ccasGrpLineTmPulseRate=ccasGrpLineTmPulseRate, ccasGrpEMTmMinDelayPulseWidth=ccasGrpEMTmMinDelayPulseWidth, ccasGrpLineCfgEntry=ccasGrpLineCfgEntry, ccasGrpEMTmPulseRate=ccasGrpEMTmPulseRate, ccasGrpLineTmDigitDuration=ccasGrpLineTmDigitDuration, ccasGeneralInfoGroup=ccasGeneralInfoGroup, ccasVoiceCfgEchoCancelEnable=ccasVoiceCfgEchoCancelEnable, ccasIfMIBConformance=ccasIfMIBConformance, ccasGrpEMCfgEntry=ccasGrpEMCfgEntry, ccasGrpStaTmEntry=ccasGrpStaTmEntry, ccasVoiceCfgNoiseRegEnable=ccasVoiceCfgNoiseRegEnable, ciscoCasIfMIB=ciscoCasIfMIB, ccasGeneralInfoGroupRev1=ccasGeneralInfoGroupRev1, ccasGrpCfgServiceType=ccasGrpCfgServiceType, ccasGrpLineTmInterDigitDuration=ccasGrpLineTmInterDigitDuration, ccasGrpLineCfgDialType=ccasGrpLineCfgDialType, ccasGrpEMTmTable=ccasGrpEMTmTable, ccasChannelObjects=ccasChannelObjects, ccasGrpStaCfgEntry=ccasGrpStaCfgEntry, ccasIfMIBCompliance=ccasIfMIBCompliance, ccasGrpEMTmPttXmt=ccasGrpEMTmPttXmt, ccasChannelCfgDS1IfIndex=ccasChannelCfgDS1IfIndex, ccasIfMIBGroups=ccasIfMIBGroups, ccasGrpEMTmInterDigitDuration=ccasGrpEMTmInterDigitDuration, ccasGrpCfgType=ccasGrpCfgType, ccasChannelStatusRecvSignalBits=ccasChannelStatusRecvSignalBits, ccasGrpStaCfgTable=ccasGrpStaCfgTable, ccasVoiceGroup=ccasVoiceGroup, ccasChannelCfgBusyOut=ccasChannelCfgBusyOut, ccasIfObjects=ccasIfObjects, ccasVoiceCfgOutAttn=ccasVoiceCfgOutAttn, ccasGrpLineTmPulseInterDigitDuration=ccasGrpLineTmPulseInterDigitDuration, ccasVoiceCfgInitialDigitTimeOut=ccasVoiceCfgInitialDigitTimeOut, ccasXgcpCfgEntry=ccasXgcpCfgEntry, ccasGrpCfgTable=ccasGrpCfgTable, ccasStaGroup=ccasStaGroup, ccasChannelStatusEntry=ccasChannelStatusEntry, ccasChannelStatusInfoType=ccasChannelStatusInfoType, ccasChannelCfgTable=ccasChannelCfgTable, ccasGrpLineTmTable=ccasGrpLineTmTable, ccasGrpCfgIndex=ccasGrpCfgIndex, ccasGrpEMCfgAutoGainControl=ccasGrpEMCfgAutoGainControl, ccasGrpEMCfgDnisAni=ccasGrpEMCfgDnisAni, ccasCustomABCDGroup=ccasCustomABCDGroup, ccasGrpEMTmEntry=ccasGrpEMTmEntry, ccasGrpStaTmInterDigitDuration=ccasGrpStaTmInterDigitDuration, ccasVoiceCfgNonLinearProcEnable=ccasVoiceCfgNonLinearProcEnable, ccasEMGroupRev2=ccasEMGroupRev2, ccasDs1IfCfgEntry=ccasDs1IfCfgEntry, ccasGrpEMTmMaxWinkWaitDuration=ccasGrpEMTmMaxWinkWaitDuration, ccasXgcpCfgGroup=ccasXgcpCfgGroup, ccasGrpEMTmLmrTeardown=ccasGrpEMTmLmrTeardown, ccasGrpABCDCfgTable=ccasGrpABCDCfgTable, ccasGrpEMTmMaxDelayDuration=ccasGrpEMTmMaxDelayDuration, ccasGrpStaObjects=ccasGrpStaObjects, ccasVoiceCfgConnectionNumber=ccasVoiceCfgConnectionNumber, ccasGrpObjects=ccasGrpObjects, ccasVoiceCfgEchoCancelCoverage=ccasVoiceCfgEchoCancelCoverage, ccasXgcpCfgObjects=ccasXgcpCfgObjects, ccasVoiceCfgInterDigitTimeOut=ccasVoiceCfgInterDigitTimeOut, ccasChannelStatusTable=ccasChannelStatusTable, ccasGrpEMTmClearWaitDuration=ccasGrpEMTmClearWaitDuration, ccasGrpEMTmDelayStart=ccasGrpEMTmDelayStart, ccasGrpEMTmVoiceHangover=ccasGrpEMTmVoiceHangover, ccasDS1Objects=ccasDS1Objects, ccasGrpABCDCfgUnusedBits=ccasGrpABCDCfgUnusedBits, ccasGrpCfgDs0Channels=ccasGrpCfgDs0Channels, ccasDs1IfCfgDs0ChannelsConfigurable=ccasDs1IfCfgDs0ChannelsConfigurable, ccasChannelInfoGroup=ccasChannelInfoGroup, ccasIfMIBCompliances=ccasIfMIBCompliances, ccasGrpStaTmPulseInterDigitDuration=ccasGrpStaTmPulseInterDigitDuration, ccasGrpLineObjects=ccasGrpLineObjects, ccasGrpLineCfgSupDisconnect=ccasGrpLineCfgSupDisconnect, ccasGrpEMTmDigitDuration=ccasGrpEMTmDigitDuration, ccasEMGroup=ccasEMGroup, ccasChannelCfgTimeSlot=ccasChannelCfgTimeSlot, ccasVoiceCfgMusicOnHoldThreshold=ccasVoiceCfgMusicOnHoldThreshold, ccasVoiceCfgTable=ccasVoiceCfgTable, ccasGrpStaTmDigitDuration=ccasGrpStaTmDigitDuration, ccasGrpCfgRowStatus=ccasGrpCfgRowStatus, ccasGrpLineTmEntry=ccasGrpLineTmEntry, ccasVoiceCfgEntry=ccasVoiceCfgEntry, ccasGrpStaCfgDialType=ccasGrpStaCfgDialType, ccasGrpStaTmTable=ccasGrpStaTmTable, ccasGrpLineCfgTable=ccasGrpLineCfgTable, ccasChannelStatusXmitSignalBits=ccasChannelStatusXmitSignalBits, ccasGrpEMTmMaxWinkDuration=ccasGrpEMTmMaxWinkDuration, ccasChannelStatusBusyOut=ccasChannelStatusBusyOut, ccasIfDS1Group=ccasIfDS1Group, PYSNMP_MODULE_ID=ciscoCasIfMIB, ccasEMGroupRev1=ccasEMGroupRev1, ccasLineGroup=ccasLineGroup, ccasGrpEMCfgLmrMCap=ccasGrpEMCfgLmrMCap, ccasGrpEMCfgLmrECap=ccasGrpEMCfgLmrECap, ccasGrpEMTmDelayVoice=ccasGrpEMTmDelayVoice, ccasGrpStaTmPulseRate=ccasGrpStaTmPulseRate, ccasDs1IfCfgTable=ccasDs1IfCfgTable, ccasGrpABCDCfgEntry=ccasGrpABCDCfgEntry, ccasChannelCfgEntry=ccasChannelCfgEntry, ccasXgcpCfgCotToneCo2=ccasXgcpCfgCotToneCo2, ccasVoiceCfgInGain=ccasVoiceCfgInGain, ccasGrpEMTmPulseInterDigitDuration=ccasGrpEMTmPulseInterDigitDuration, ccasVoiceCfgRegionalTone=ccasVoiceCfgRegionalTone, ccasVoiceCfgConnectionMode=ccasVoiceCfgConnectionMode, ccasIfMIBComplianceRev1=ccasIfMIBComplianceRev1, ccasGrpEMCfgDialType=ccasGrpEMCfgDialType, ccasIfMIBComplianceRev2=ccasIfMIBComplianceRev2, ccasGrpEMCfgTable=ccasGrpEMCfgTable, ccasGrpABCDCfgInvertBits=ccasGrpABCDCfgInvertBits, ccasXgcpCfgTable=ccasXgcpCfgTable, ccasGrpEMTmPttRcv=ccasGrpEMTmPttRcv, ccasGrpLineCfgNumberRings=ccasGrpLineCfgNumberRings, ccasVoiceCfgObjects=ccasVoiceCfgObjects)
