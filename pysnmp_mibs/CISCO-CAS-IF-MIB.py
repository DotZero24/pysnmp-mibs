...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CAS-IF-MIB
...
_CcasGrpEMCfgAutoGainControl_Type.__name__ = "TruthValue"
...
ccasIfMIBCompliance.setObjects(
      *(("CISCO-CAS-IF-MIB", "ccasIfDS1Group"),
        ("CISCO-CAS-IF-MIB", "ccasGeneralInfoGroup"),
        ("CISCO-CAS-IF-MIB", "ccasEMGroup"),
        ("CISCO-CAS-IF-MIB", "ccasLineGroup"),
        ("CISCO-CAS-IF-MIB", "ccasStaGroup"),
        ("CISCO-CAS-IF-MIB", "ccasCustomABCDGroup"),
        ("CISCO-CAS-IF-MIB", "ccasVoiceGroup"))
)
if mibBuilder.loadTexts:
...
ccasIfMIBComplianceRev1.setObjects(
      *(("CISCO-CAS-IF-MIB", "ccasIfDS1Group"),
        ("CISCO-CAS-IF-MIB", "ccasGeneralInfoGroupRev1"),
        ("CISCO-CAS-IF-MIB", "ccasEMGroupRev1"),
        ("CISCO-CAS-IF-MIB", "ccasLineGroup"),
        ("CISCO-CAS-IF-MIB", "ccasStaGroup"),
        ("CISCO-CAS-IF-MIB", "ccasCustomABCDGroup"),
        ("CISCO-CAS-IF-MIB", "ccasVoiceGroup"),
        ("CISCO-CAS-IF-MIB", "ccasChannelInfoGroup"),
        ("CISCO-CAS-IF-MIB", "ccasXgcpCfgGroup"))
)
if mibBuilder.loadTexts:
...
ccasIfMIBComplianceRev2.setObjects(
      *(("CISCO-CAS-IF-MIB", "ccasIfDS1Group"),
        ("CISCO-CAS-IF-MIB", "ccasGeneralInfoGroupRev1"),
        ("CISCO-CAS-IF-MIB", "ccasEMGroupRev1"),
        ("CISCO-CAS-IF-MIB", "ccasLineGroup"),
...
ccasIfMIBComplianceRev3.setObjects(
      *(("CISCO-CAS-IF-MIB", "ccasIfDS1Group"),
        ("CISCO-CAS-IF-MIB", "ccasGeneralInfoGroupRev1"),
        ("CISCO-CAS-IF-MIB", "ccasEMGroupRev2"),
        ("CISCO-CAS-IF-MIB", "ccasLineGroup"),
        ("CISCO-CAS-IF-MIB", "ccasStaGroup"),
        ("CISCO-CAS-IF-MIB", "ccasCustomABCDGroup"),
        ("CISCO-CAS-IF-MIB", "ccasVoiceGroup"),
