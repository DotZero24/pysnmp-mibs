...
if mibBuilder.loadTexts:fastPathIpv6Tunnel.setRevisions(('2011-01-26 00:00','2007-05-23 00:00'))
_AgentTunnelIPV6Group_ObjectIdentity=ObjectIdentity
agentTunnelIPV6Group=_AgentTunnelIPV6Group_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1))
_AgentTunnelIPV6Table_Object=MibTable
agentTunnelIPV6Table=_AgentTunnelIPV6Table_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1))
if mibBuilder.loadTexts:agentTunnelIPV6Table.setStatus(_A)
_AgentTunnelIPV6Entry_Object=MibTableRow
agentTunnelIPV6Entry=_AgentTunnelIPV6Entry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1,1))
...
agentTunnelID=_AgentTunnelID_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1,1,1),_AgentTunnelID_Type())
...
agentTunnelIfIndex=_AgentTunnelIfIndex_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1,1,2),_AgentTunnelIfIndex_Type())
...
agentTunnelMode=_AgentTunnelMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1,1,3),_AgentTunnelMode_Type())
...
agentTunnelLocalIP4Addr=_AgentTunnelLocalIP4Addr_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1,1,4),_AgentTunnelLocalIP4Addr_Type())
...
agentTunnelRemoteIP4Addr=_AgentTunnelRemoteIP4Addr_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1,1,5),_AgentTunnelRemoteIP4Addr_Type())
...
agentTunnelLocalIfIndex=_AgentTunnelLocalIfIndex_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1,1,6),_AgentTunnelLocalIfIndex_Type())
...
agentTunnelStatus=_AgentTunnelStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1,1,7),_AgentTunnelStatus_Type())
...
agentTunnelIcmpUnreachableMode=_AgentTunnelIcmpUnreachableMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,1,1,8),_AgentTunnelIcmpUnreachableMode_Type())
...
agentTunnelIPV6PrefixTable=_AgentTunnelIPV6PrefixTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,2))
if mibBuilder.loadTexts:agentTunnelIPV6PrefixTable.setStatus(_A)
_AgentTunnelIPV6PrefixEntry_Object=MibTableRow
agentTunnelIPV6PrefixEntry=_AgentTunnelIPV6PrefixEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,2,1))
...
agentTunnelIPV6PrefixPrefix=_AgentTunnelIPV6PrefixPrefix_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,2,1,1),_AgentTunnelIPV6PrefixPrefix_Type())
...
agentTunnelIPV6PrefixPrefixLen=_AgentTunnelIPV6PrefixPrefixLen_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,27,1,2,1,2),_AgentTunnelIPV6PrefixPrefixLen_Type())
