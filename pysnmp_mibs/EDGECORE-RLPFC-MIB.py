# SNMP MIB module (EDGECORE-RLPFC-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/edgecore/EDGECORE-RLPFC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:53:47 2025
...
rlPfcGlobalEnable = _RlPfcGlobalEnable_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 148, 1),
...
rlPfcPortEnableAdmin = _RlPfcPortEnableAdmin_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 148, 2, 1, 1),
...
rlPfcPortEnableOper = _RlPfcPortEnableOper_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 148, 2, 1, 2),
...
rlPfcPriority = _RlPfcPriority_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 148, 3, 1, 1),
    _RlPfcPriority_Type()
)
...
rlPfcPriorityEnable = _RlPfcPriorityEnable_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 148, 3, 1, 2),
...
rlPfcPriorityEnableOperStatus = _RlPfcPriorityEnableOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 148, 3, 1, 3),
...
rlPfcPriorityEnableOperStatusReason = _RlPfcPriorityEnableOperStatusReason_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 148, 3, 1, 4),
