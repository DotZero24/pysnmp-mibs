...
mibBuilder.exportSymbols("FS-PROCESS-MIB", fsCPUMaxUtilization1Min=fsCPUMaxUtilization1Min, fsCPUMaxUtilization5Min=fsCPUMaxUtilization5Min, fsNodeCPUTotal5min=fsNodeCPUTotal5min, fsProcessMIB=fsProcessMIB, fsLankApCPUUtilizationCritical=fsLankApCPUUtilizationCritical, fsCPUMIBObjects=fsCPUMIBObjects, fsLankApCPUMacAddr=fsLankApCPUMacAddr, fsLankApCPUUtilizationWarning=fsLankApCPUUtilizationWarning, Percent=Percent, fsNodeCPUTotalGroups=fsNodeCPUTotalGroups, fsLankApCPUTotalTable=fsLankApCPUTotalTable, fsLankApCPUUtilizationCurrent=fsLankApCPUUtilizationCurrent, fsLankApCPUUtilizationCollectSwitch=fsLankApCPUUtilizationCollectSwitch, fsCPUUtilizationCollectSwitch=fsCPUUtilizationCollectSwitch, fsNodeCPUTotalName=fsNodeCPUTotalName, fsProcessMIBCompliance=fsProcessMIBCompliance, fsNodeCPUTotalWarning=fsNodeCPUTotalWarning, fsNodeCPUTotalCritical=fsNodeCPUTotalCritical, fsNodeCPUTotalIndex=fsNodeCPUTotalIndex, fsNodeCPUTotalEntry=fsNodeCPUTotalEntry, fsCPUMaxUtilization5Sec=fsCPUMaxUtilization5Sec, fsCPUUtilizationMIBGroup=fsCPUUtilizationMIBGroup, fsCPUUtilizationCurrent=fsCPUUtilizationCurrent, fsCPUUtilization5Sec=fsCPUUtilization5Sec, fsNodeCPUTotal1min=fsNodeCPUTotal1min, fsProcessMIBCompliances=fsProcessMIBCompliances, fsNodeCPUTotal5sec=fsNodeCPUTotal5sec, fsLankApCPUUtilization5Min=fsLankApCPUUtilization5Min, fsLankApCPUTotalEntry=fsLankApCPUTotalEntry, fsCpuGeneralMibsGroup=fsCpuGeneralMibsGroup, fsNodeCPUTotalTable=fsNodeCPUTotalTable, fsCPUUtilizationCritical=fsCPUUtilizationCritical, PYSNMP_MODULE_ID=fsProcessMIB, fsCPUUtilizationWarning=fsCPUUtilizationWarning, fsProcessMIBGroups=fsProcessMIBGroups, fsCPUUtilization5Min=fsCPUUtilization5Min, fsProcessMIBConformance=fsProcessMIBConformance, fsCPUUtilization1Min=fsCPUUtilization1Min)
