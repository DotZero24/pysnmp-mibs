...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DOT3-OAM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:32:41 2025
...
cdot3OamCompliance.setObjects(
      *(("CISCO-DOT3-OAM-MIB", "cdot3OamControlGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamPeerGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamStatsBaseGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamLoopbackGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamErrSymbolPeriodEventGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamErrFramePeriodEventGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamErrFrameEventGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamErrFrameSecsSummaryEventGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamFlagEventGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamEventLogGroup"),
        ("CISCO-DOT3-OAM-MIB", "cdot3OamNotificationGroup"))
)
if mibBuilder.loadTexts:
