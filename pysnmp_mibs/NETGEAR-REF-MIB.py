...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-REF-MIB
...
_M4300_8x8f_ObjectIdentity = ObjectIdentity
m4300_8x8f = _M4300_8x8f_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 27)
)
_M4300_12x12f_ObjectIdentity = ObjectIdentity
m4300_12x12f = _M4300_12x12f_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 28)
)
_M4300_24x24f_ObjectIdentity = ObjectIdentity
m4300_24x24f = _M4300_24x24f_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 29)
)
_M4300_28g_ObjectIdentity = ObjectIdentity
m4300_28g = _M4300_28g_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 30)
)
_M4300_52g_ObjectIdentity = ObjectIdentity
m4300_52g = _M4300_52g_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 31)
)
_M4300_28g_poe_ObjectIdentity = ObjectIdentity
m4300_28g_poe = _M4300_28g_poe_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 32)
)
_M4300_52g_poe_ObjectIdentity = ObjectIdentity
m4300_52g_poe = _M4300_52g_poe_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 33)
)
_M4300_24x_ObjectIdentity = ObjectIdentity
m4300_24x = _M4300_24x_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 34)
)
_M4300_48x_ObjectIdentity = ObjectIdentity
m4300_48x = _M4300_48x_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 35)
)
_M4300_96x_ObjectIdentity = ObjectIdentity
m4300_96x = _M4300_96x_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 36)
)
_M4300_16x_ObjectIdentity = ObjectIdentity
m4300_16x = _M4300_16x_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 37)
)
_M4300_24xf_ObjectIdentity = ObjectIdentity
m4300_24xf = _M4300_24xf_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 38)
)
_M4300_48xf_ObjectIdentity = ObjectIdentity
m4300_48xf = _M4300_48xf_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 1, 39)
)
...
_M4200_10mg_poe_ObjectIdentity = ObjectIdentity
m4200_10mg_poe = _M4200_10mg_poe_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 3, 8)
)
...
_Fs752tp_ObjectIdentity = ObjectIdentity
fs752tp = _Fs752tp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 4, 22)
)
_Gs110t_ObjectIdentity = ObjectIdentity
gs110t = _Gs110t_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 4, 23)
)
_Gs510tp_ObjectIdentity = ObjectIdentity
gs510tp = _Gs510tp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 4, 24)
)
...
_Xs716t_ObjectIdentity = ObjectIdentity
xs716t = _Xs716t_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 4, 38)
)
_Xs708t_ObjectIdentity = ObjectIdentity
xs708t = _Xs708t_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 4, 39)
)
_Gs418tpp_ObjectIdentity = ObjectIdentity
gs418tpp = _Gs418tpp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 4, 41)
)
_Gs510tlp_ObjectIdentity = ObjectIdentity
gs510tlp = _Gs510tlp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 4, 42)
)
_Gs510tpp_ObjectIdentity = ObjectIdentity
gs510tpp = _Gs510tpp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 4, 43)
)
_Xs712tv2_ObjectIdentity = ObjectIdentity
xs712tv2 = _Xs712tv2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 4, 47)
)
...
_InsightSwitch_ObjectIdentity = ObjectIdentity
insightSwitch = _InsightSwitch_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 14)
)
_Gc728x_ObjectIdentity = ObjectIdentity
gc728x = _Gc728x_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 14, 5)
)
_Gc728xp_ObjectIdentity = ObjectIdentity
gc728xp = _Gc728xp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 14, 6)
)
_Gc752x_ObjectIdentity = ObjectIdentity
gc752x = _Gc752x_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 14, 7)
)
_Gc752xp_ObjectIdentity = ObjectIdentity
gc752xp = _Gc752xp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 100, 14, 8)
)
...
mibBuilder.exportSymbols(
    ...
    **{"AgentPortMask": AgentPortMask,
       ...
       "m530028g": m530028g,
       "m530052g": m530052g,
       "m4300-8x8f": m4300_8x8f,
       "m4300-12x12f": m4300_12x12f,
       "m4300-24x24f": m4300_24x24f,
       "m4300-28g": m4300_28g,
       "m4300-52g": m4300_52g,
       "m4300-28g-poe": m4300_28g_poe,
       "m4300-52g-poe": m4300_52g_poe,
       "m4300-24x": m4300_24x,
       "m4300-48x": m4300_48x,
       "m4300-96x": m4300_96x,
       "m4300-16x": m4300_16x,
       "m4300-24xf": m4300_24xf,
       "m4300-48xf": m4300_48xf,
       "l2switch": l2switch,
       "gsm7248": gsm7248,
       "gsm7212": gsm7212,
       "gsm7224i": gsm7224i,
