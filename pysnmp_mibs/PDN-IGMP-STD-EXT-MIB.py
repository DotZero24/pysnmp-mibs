...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-IGMP-STD-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:59:37 2025
...
_PdnIgmpInterfaceSnoopEnableDisable_Type.__name__ = "SwitchState"
...
_PdnIgmpSnoopingSelection_Type.__name__ = "SwitchState"
...
_PdnIgmpGeneralQueryInterval_Type.__name__ = "Unsigned32"
...
pdnIgmpStdExtMIBCompliance.setObjects(
      *(("PDN-IGMP-STD-EXT-MIB", "pdnIgmpStdExtConfigGroup"),
        ("PDN-IGMP-STD-EXT-MIB", "pdnIgmpStdExtStatsGroup"),
        ("PDN-IGMP-STD-EXT-MIB", "pdnIgmpStdExtGeneralConfigGroup"))
)
if mibBuilder.loadTexts:
...
pdnIgmpStdExtMIBComplianceV2.setObjects(
      *(("PDN-IGMP-STD-EXT-MIB", "pdnIgmpStdExtConfigGroup"),
        ("PDN-IGMP-STD-EXT-MIB", "pdnIgmpStdExtStatsGroup"),
        ("PDN-IGMP-STD-EXT-MIB", "pdnIgmpStdExtGeneralConfigGroupV2"))
)
if mibBuilder.loadTexts:
