...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/rfc/LISP-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:49:27 2025
...
mibBuilder.exportSymbols("LISP-MIB", lispMappingDatabaseLsb=lispMappingDatabaseLsb, lispMapCacheEidLength=lispMapCacheEidLength, lispMapCacheLocatorRlocRtt=lispMapCacheLocatorRlocRtt, lispEidRegistrationLocatorPriority=lispEidRegistrationLocatorPriority, lispMIBEtrExtendedGroup=lispMIBEtrExtendedGroup, lispFeaturesInstanceID=lispFeaturesInstanceID, lispEidRegistrationLocatorRlocLength=lispEidRegistrationLocatorRlocLength, lispMapCacheEidEncapOctets=lispMapCacheEidEncapOctets, lispMapCacheLocatorEntry=lispMapCacheLocatorEntry, lispConfiguredLocatorTable=lispConfiguredLocatorTable, lispUseMapServerAddress=lispUseMapServerAddress, lispMIBMapServerGroup=lispMIBMapServerGroup, lispMapCacheLocatorRlocLength=lispMapCacheLocatorRlocLength, lispMappingDatabaseLocatorRlocWeight=lispMappingDatabaseLocatorRlocWeight, lispGlobalStatsEntry=lispGlobalStatsEntry, lispMIBItrGroup=lispMIBItrGroup, lispConfiguredLocatorRlocEncapOctets=lispConfiguredLocatorRlocEncapOctets, lispEidRegistrationEtrEntry=lispEidRegistrationEtrEntry, lispEidRegistrationEtrLastTimeStamp=lispEidRegistrationEtrLastTimeStamp, lispMappingDatabaseLocatorRlocEncapPackets=lispMappingDatabaseLocatorRlocEncapPackets, lispMIBPitrGroup=lispMIBPitrGroup, lispFeaturesMapServerEnabled=lispFeaturesMapServerEnabled, lispMappingDatabaseLocatorRlocDecapOctets=lispMappingDatabaseLocatorRlocDecapOctets, lispFeaturesEtrEnabled=lispFeaturesEtrEnabled, lispMappingDatabaseDecapPackets=lispMappingDatabaseDecapPackets, lispMIBPetrGroup=lispMIBPetrGroup, lispCompliances=lispCompliances, lispFeaturesMapCacheSize=lispFeaturesMapCacheSize, lispMapCacheEidTimeStamp=lispMapCacheEidTimeStamp, lispFeaturesEtrAcceptMapDataEnabled=lispFeaturesEtrAcceptMapDataEnabled, lispMappingDatabaseLocatorEntry=lispMappingDatabaseLocatorEntry, lispEidRegistrationIsRegistered=lispEidRegistrationIsRegistered, lispFeaturesRlocProbeEnabled=lispFeaturesRlocProbeEnabled, lispObjects=lispObjects, lispMIBCompliancePetr=lispMIBCompliancePetr, lispMIBItrExtendedGroup=lispMIBItrExtendedGroup, lispEidRegistrationLocatorWeight=lispEidRegistrationLocatorWeight, lispEidRegistrationLastRegisterSender=lispEidRegistrationLastRegisterSender, lispMappingDatabaseLocatorRlocPriority=lispMappingDatabaseLocatorRlocPriority, lispMappingDatabaseLocatorRlocDecapPackets=lispMappingDatabaseLocatorRlocDecapPackets, lispEidRegistrationAuthenticationErrors=lispEidRegistrationAuthenticationErrors, lispEidRegistrationEtrTable=lispEidRegistrationEtrTable, lispMapCacheLocatorTable=lispMapCacheLocatorTable, lispUseMapServerAddressLength=lispUseMapServerAddressLength, lispMapCacheLocatorRlocDecapOctets=lispMapCacheLocatorRlocDecapOctets, lispMappingDatabaseEncapOctets=lispMappingDatabaseEncapOctets, lispMapCacheLocatorRlocMPriority=lispMapCacheLocatorRlocMPriority, lispEidRegistrationSiteDescription=lispEidRegistrationSiteDescription, lispUseProxyEtrMPriority=lispUseProxyEtrMPriority, lispMapCacheEidDecapPackets=lispMapCacheEidDecapPackets, lispUseProxyEtrAddress=lispUseProxyEtrAddress, lispEidRegistrationLocatorRlocState=lispEidRegistrationLocatorRlocState, lispIidToVrfName=lispIidToVrfName, lispUseProxyEtrState=lispUseProxyEtrState, lispMappingDatabaseEid=lispMappingDatabaseEid, lispFeaturesEtrMapCacheTtl=lispFeaturesEtrMapCacheTtl, lispMapCacheLocatorRlocLastPriorityChange=lispMapCacheLocatorRlocLastPriorityChange, lispFeaturesMapCacheLimit=lispFeaturesMapCacheLimit, lispMapCacheLocatorRlocWeight=lispMapCacheLocatorRlocWeight, lispMappingDatabaseTable=lispMappingDatabaseTable, lispGlobalStatsMapRequestsIn=lispGlobalStatsMapRequestsIn, lispMappingDatabaseLocatorRlocLocal=lispMappingDatabaseLocatorRlocLocal, lispGlobalStatsMapRepliesIn=lispGlobalStatsMapRepliesIn, lispConfiguredLocatorRlocDecapPackets=lispConfiguredLocatorRlocDecapPackets, lispMapCacheLocatorRlocDecapPackets=lispMapCacheLocatorRlocDecapPackets, lispUseMapResolverAddressLength=lispUseMapResolverAddressLength, lispEidRegistrationTable=lispEidRegistrationTable, lispFeaturesEntry=lispFeaturesEntry, lispMapCacheLocatorRloc=lispMapCacheLocatorRloc, lispEidRegistrationEtrSender=lispEidRegistrationEtrSender, lispMIBComplianceMapResolver=lispMIBComplianceMapResolver, lispEidRegistrationLastTimeStamp=lispEidRegistrationLastTimeStamp, lispUseProxyEtrEntry=lispUseProxyEtrEntry, lispMIBVrfGroup=lispMIBVrfGroup, lispEidRegistrationSiteName=lispEidRegistrationSiteName, lispUseMapServerState=lispUseMapServerState, lispGroups=lispGroups, lispEidRegistrationEtrWantsMapNotify=lispEidRegistrationEtrWantsMapNotify, lispMapCacheLocatorRlocLastMWeightChange=lispMapCacheLocatorRlocLastMWeightChange, lispUseMapResolverEntry=lispUseMapResolverEntry, lispMappingDatabaseDecapOctets=lispMappingDatabaseDecapOctets, LispAddressType=LispAddressType, lispEidRegistrationLocatorTable=lispEidRegistrationLocatorTable, lispUseProxyEtrWeight=lispUseProxyEtrWeight, lispConfiguredLocatorRlocEncapPackets=lispConfiguredLocatorRlocEncapPackets, lispUseMapServerEntry=lispUseMapServerEntry, lispEidRegistrationEtrSenderLength=lispEidRegistrationEtrSenderLength, lispMIBMapServerExtendedGroup=lispMIBMapServerExtendedGroup, lispEidRegistrationEtrProxyReply=lispEidRegistrationEtrProxyReply, lispEidRegistrationLastRegisterSenderLength=lispEidRegistrationLastRegisterSenderLength, lispFeaturesAddressFamily=lispFeaturesAddressFamily, lispFeaturesRouterTimeStamp=lispFeaturesRouterTimeStamp, lispMapCacheEidExpiryTime=lispMapCacheEidExpiryTime, lispConfiguredLocatorRlocTimeStamp=lispConfiguredLocatorRlocTimeStamp, lispMappingDatabaseTimeStamp=lispMappingDatabaseTimeStamp, lispConfiguredLocatorRlocDecapOctets=lispConfiguredLocatorRlocDecapOctets, lispEidRegistrationEidLength=lispEidRegistrationEidLength, lispMappingDatabaseLocatorRlocLength=lispMappingDatabaseLocatorRlocLength, lispEidRegistrationEid=lispEidRegistrationEid, lispEidRegistrationFirstTimeStamp=lispEidRegistrationFirstTimeStamp, lispConfiguredLocatorRloc=lispConfiguredLocatorRloc, lispEidRegistrationLocatorMPriority=lispEidRegistrationLocatorMPriority, lispMappingDatabaseEntry=lispMappingDatabaseEntry, lispMIBDiagnosticsGroup=lispMIBDiagnosticsGroup, lispUseProxyEtrMWeight=lispUseProxyEtrMWeight, lispMapCacheEid=lispMapCacheEid, lispMIBTuningParametersGroup=lispMIBTuningParametersGroup, lispMapCacheLocatorRlocEncapPackets=lispMapCacheLocatorRlocEncapPackets, lispMIBEtrGroup=lispMIBEtrGroup, lispUseProxyEtrPriority=lispUseProxyEtrPriority, lispConfiguredLocatorRlocLocal=lispConfiguredLocatorRlocLocal, lispUseMapResolverTable=lispUseMapResolverTable, lispMIBCompliancePitr=lispMIBCompliancePitr, lispMIB=lispMIB, lispMapCacheLocatorRlocPriority=lispMapCacheLocatorRlocPriority, lispFeaturesItrEnabled=lispFeaturesItrEnabled, lispMappingDatabaseLocatorRlocEncapOctets=lispMappingDatabaseLocatorRlocEncapOctets, lispMapCacheLocatorRlocLastMPriorityChange=lispMapCacheLocatorRlocLastMPriorityChange, lispMappingDatabaseLocatorTable=lispMappingDatabaseLocatorTable, lispIidToVrfEntry=lispIidToVrfEntry, lispUseMapServerTable=lispUseMapServerTable, lispEidRegistrationLocatorIsLocal=lispEidRegistrationLocatorIsLocal, lispIidToVrfTable=lispIidToVrfTable, lispEidRegistrationLocatorEntry=lispEidRegistrationLocatorEntry, lispUseMapResolverAddress=lispUseMapResolverAddress, PYSNMP_MODULE_ID=lispMIB, lispMapCacheEidDecapOctets=lispMapCacheEidDecapOctets, lispEidRegistrationEtrTtl=lispEidRegistrationEtrTtl, lispEidRegistrationLocatorRloc=lispEidRegistrationLocatorRloc, lispConformance=lispConformance, lispGlobalStatsMapRegistersIn=lispGlobalStatsMapRegistersIn, lispGlobalStatsTable=lispGlobalStatsTable, lispMapCacheEidState=lispMapCacheEidState, lispUseProxyEtrTable=lispUseProxyEtrTable, lispMappingDatabaseLocatorRlocTimeStamp=lispMappingDatabaseLocatorRlocTimeStamp, lispMIBEncapStatisticsGroup=lispMIBEncapStatisticsGroup, lispMapCacheTable=lispMapCacheTable, lispFeaturesEtrAcceptMapDataVerifyEnabled=lispFeaturesEtrAcceptMapDataVerifyEnabled, lispEidRegistrationEntry=lispEidRegistrationEntry, lispMappingDatabaseLocatorRloc=lispMappingDatabaseLocatorRloc, lispFeaturesProxyEtrEnabled=lispFeaturesProxyEtrEnabled, lispMapCacheLocatorRlocEncapOctets=lispMapCacheLocatorRlocEncapOctets, lispMIBMapResolverGroup=lispMIBMapResolverGroup, lispMappingDatabaseLocatorRlocState=lispMappingDatabaseLocatorRlocState, lispMapCacheLocatorRlocTimeStamp=lispMapCacheLocatorRlocTimeStamp, lispUseMapResolverState=lispUseMapResolverState, lispMappingDatabaseLocatorRlocMPriority=lispMappingDatabaseLocatorRlocMPriority, lispMappingDatabaseEidLength=lispMappingDatabaseEidLength, lispMapCacheLocatorRlocLastStateChange=lispMapCacheLocatorRlocLastStateChange, lispGlobalStatsMapRequestsOut=lispGlobalStatsMapRequestsOut, lispEidRegistrationLocatorMWeight=lispEidRegistrationLocatorMWeight, lispMapCacheEidAuthoritative=lispMapCacheEidAuthoritative, lispFeaturesMapResolverEnabled=lispFeaturesMapResolverEnabled, lispMIBComplianceEtr=lispMIBComplianceEtr, lispMIBComplianceMapServer=lispMIBComplianceMapServer, lispMapCacheLocatorRlocMWeight=lispMapCacheLocatorRlocMWeight, lispMapCacheLocatorRlocLastWeightChange=lispMapCacheLocatorRlocLastWeightChange, lispMappingDatabaseEncapPackets=lispMappingDatabaseEncapPackets, lispMappingDatabaseLocatorRlocMWeight=lispMappingDatabaseLocatorRlocMWeight, lispMapCacheLocatorRlocState=lispMapCacheLocatorRlocState, lispConfiguredLocatorRlocLength=lispConfiguredLocatorRlocLength, lispMIBDecapStatisticsGroup=lispMIBDecapStatisticsGroup, lispMIBComplianceItr=lispMIBComplianceItr, lispMapCacheEntry=lispMapCacheEntry, lispGlobalStatsMapRegistersOut=lispGlobalStatsMapRegistersOut, lispUseProxyEtrAddressLength=lispUseProxyEtrAddressLength, lispFeaturesProxyItrEnabled=lispFeaturesProxyItrEnabled, lispGlobalStatsMapRepliesOut=lispGlobalStatsMapRepliesOut, lispEidRegistrationRlocsMismatch=lispEidRegistrationRlocsMismatch, lispMapCacheEidEncapPackets=lispMapCacheEidEncapPackets, lispConfiguredLocatorEntry=lispConfiguredLocatorEntry, lispConfiguredLocatorRlocState=lispConfiguredLocatorRlocState, lispFeaturesTable=lispFeaturesTable, lispMappingDatabaseEidPartitioned=lispMappingDatabaseEidPartitioned)
