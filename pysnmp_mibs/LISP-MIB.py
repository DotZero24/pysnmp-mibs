...
# Notes
# -----
# ASN.1 source file://mibs/rfc/LISP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:22:35 2025
...
_LispFeaturesRouterTimeStamp_Type.__name__ = "TimeStamp"
...
_LispMappingDatabaseTimeStamp_Type.__name__ = "TimeStamp"
...
_LispMappingDatabaseLocatorRlocTimeStamp_Type.__name__ = "TimeStamp"
...
_LispMapCacheEidTimeStamp_Type.__name__ = "TimeStamp"
...
_LispMapCacheLocatorRlocTimeStamp_Type.__name__ = "TimeStamp"
...
_LispConfiguredLocatorRlocTimeStamp_Type.__name__ = "TimeStamp"
...
_LispEidRegistrationFirstTimeStamp_Type.__name__ = "TimeStamp"
...
_LispEidRegistrationLastTimeStamp_Type.__name__ = "TimeStamp"
...
_LispEidRegistrationEtrLastTimeStamp_Type.__name__ = "TimeStamp"
...
lispMIBComplianceEtr.setObjects(
      *(("LISP-MIB", "lispMIBEtrGroup"),
        ("LISP-MIB", "lispMIBItrGroup"),
        ("LISP-MIB", "lispMIBPetrGroup"),
        ("LISP-MIB", "lispMIBPitrGroup"),
        ("LISP-MIB", "lispMIBMapServerGroup"),
        ("LISP-MIB", "lispMIBMapResolverGroup"),
        ("LISP-MIB", "lispMIBEtrExtendedGroup"),
        ("LISP-MIB", "lispMIBItrExtendedGroup"),
        ("LISP-MIB", "lispMIBMapServerExtendedGroup"),
        ("LISP-MIB", "lispMIBTuningParametersGroup"),
        ("LISP-MIB", "lispMIBEncapStatisticsGroup"),
        ("LISP-MIB", "lispMIBDecapStatisticsGroup"),
        ("LISP-MIB", "lispMIBDiagnosticsGroup"),
        ("LISP-MIB", "lispMIBVrfGroup"))
)
if mibBuilder.loadTexts:
...
lispMIBComplianceItr.setObjects(
      *(("LISP-MIB", "lispMIBItrGroup"),
        ("LISP-MIB", "lispMIBEtrGroup"),
        ("LISP-MIB", "lispMIBPetrGroup"),
        ("LISP-MIB", "lispMIBPitrGroup"),
...
lispMIBCompliancePetr.setObjects(
      *(("LISP-MIB", "lispMIBPetrGroup"),
        ("LISP-MIB", "lispMIBEtrGroup"),
        ("LISP-MIB", "lispMIBItrGroup"),
        ("LISP-MIB", "lispMIBPitrGroup"),
...
lispMIBCompliancePitr.setObjects(
      *(("LISP-MIB", "lispMIBPitrGroup"),
        ("LISP-MIB", "lispMIBEtrGroup"),
        ("LISP-MIB", "lispMIBItrGroup"),
        ("LISP-MIB", "lispMIBPetrGroup"),
...
lispMIBComplianceMapServer.setObjects(
      *(("LISP-MIB", "lispMIBMapServerGroup"),
        ("LISP-MIB", "lispMIBEtrGroup"),
        ("LISP-MIB", "lispMIBItrGroup"),
        ("LISP-MIB", "lispMIBPetrGroup"),
...
lispMIBComplianceMapResolver.setObjects(
      *(("LISP-MIB", "lispMIBMapResolverGroup"),
        ("LISP-MIB", "lispMIBEtrGroup"),
        ("LISP-MIB", "lispMIBItrGroup"),
        ("LISP-MIB", "lispMIBPetrGroup"),
