...
if mibBuilder.loadTexts:snVrrp.setRevisions(('2009-09-30 00:00','2017-08-07 00:00'))
class MacAddress(TextualConvention,OctetString):status=_A;displayHint='1x:';subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(6,6));fixedLength=6
_SnVrrpGlobal_ObjectIdentity=ObjectIdentity
snVrrpGlobal=_SnVrrpGlobal_ObjectIdentity((1,3,6,1,4,1,1991,1,2,12,1))
...
snVrrpGroupOperMode=_SnVrrpGroupOperMode_Object((1,3,6,1,4,1,1991,1,2,12,1,1),_SnVrrpGroupOperMode_Type())
...
snVrrpIfStateChangeTrap=_SnVrrpIfStateChangeTrap_Object((1,3,6,1,4,1,1991,1,2,12,1,2),_SnVrrpIfStateChangeTrap_Type())
...
snVrrpIfMaxNumVridPerIntf=_SnVrrpIfMaxNumVridPerIntf_Object((1,3,6,1,4,1,1991,1,2,12,1,3),_SnVrrpIfMaxNumVridPerIntf_Type())
...
snVrrpIfMaxNumVridPerSystem=_SnVrrpIfMaxNumVridPerSystem_Object((1,3,6,1,4,1,1991,1,2,12,1,4),_SnVrrpIfMaxNumVridPerSystem_Type())
...
snVrrpClearVrrpStat=_SnVrrpClearVrrpStat_Object((1,3,6,1,4,1,1991,1,2,12,1,5),_SnVrrpClearVrrpStat_Type())
...
snVrrpGroupOperModeVrrpextended=_SnVrrpGroupOperModeVrrpextended_Object((1,3,6,1,4,1,1991,1,2,12,1,6),_SnVrrpGroupOperModeVrrpextended_Type())
...
snVrrpIntf=_SnVrrpIntf_ObjectIdentity((1,3,6,1,4,1,1991,1,2,12,2))
_SnVrrpIfTable_Object=MibTable
snVrrpIfTable=_SnVrrpIfTable_Object((1,3,6,1,4,1,1991,1,2,12,2,1))
if mibBuilder.loadTexts:snVrrpIfTable.setStatus(_C)
_SnVrrpIfEntry_Object=MibTableRow
snVrrpIfEntry=_SnVrrpIfEntry_Object((1,3,6,1,4,1,1991,1,2,12,2,1,1))
...
snVrrpIfPort=_SnVrrpIfPort_Object((1,3,6,1,4,1,1991,1,2,12,2,1,1,1),_SnVrrpIfPort_Type())
...
snVrrpIfAuthType=_SnVrrpIfAuthType_Object((1,3,6,1,4,1,1991,1,2,12,2,1,1,2),_SnVrrpIfAuthType_Type())
...
snVrrpIfAuthPassword=_SnVrrpIfAuthPassword_Object((1,3,6,1,4,1,1991,1,2,12,2,1,1,3),_SnVrrpIfAuthPassword_Type())
...
snVrrpIfRxHeaderErrCnts=_SnVrrpIfRxHeaderErrCnts_Object((1,3,6,1,4,1,1991,1,2,12,2,1,1,4),_SnVrrpIfRxHeaderErrCnts_Type())
...
snVrrpIfRxAuthTypeErrCnts=_SnVrrpIfRxAuthTypeErrCnts_Object((1,3,6,1,4,1,1991,1,2,12,2,1,1,5),_SnVrrpIfRxAuthTypeErrCnts_Type())
...
snVrrpIfRxAuthPwdMismatchErrCnts=_SnVrrpIfRxAuthPwdMismatchErrCnts_Object((1,3,6,1,4,1,1991,1,2,12,2,1,1,6),_SnVrrpIfRxAuthPwdMismatchErrCnts_Type())
...
snVrrpIfRxVridErrCnts=_SnVrrpIfRxVridErrCnts_Object((1,3,6,1,4,1,1991,1,2,12,2,1,1,7),_SnVrrpIfRxVridErrCnts_Type())
...
snVrrpVirRtr=_SnVrrpVirRtr_ObjectIdentity((1,3,6,1,4,1,1991,1,2,12,3))
_SnVrrpVirRtrTable_Object=MibTable
snVrrpVirRtrTable=_SnVrrpVirRtrTable_Object((1,3,6,1,4,1,1991,1,2,12,3,1))
if mibBuilder.loadTexts:snVrrpVirRtrTable.setStatus(_C)
_SnVrrpVirRtrEntry_Object=MibTableRow
snVrrpVirRtrEntry=_SnVrrpVirRtrEntry_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1))
...
snVrrpVirRtrPort=_SnVrrpVirRtrPort_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,1),_SnVrrpVirRtrPort_Type())
...
snVrrpVirRtrId=_SnVrrpVirRtrId_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,2),_SnVrrpVirRtrId_Type())
...
snVrrpVirRtrOwnership=_SnVrrpVirRtrOwnership_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,3),_SnVrrpVirRtrOwnership_Type())
...
snVrrpVirRtrCfgPriority=_SnVrrpVirRtrCfgPriority_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,4),_SnVrrpVirRtrCfgPriority_Type())
...
snVrrpVirRtrTrackPriority=_SnVrrpVirRtrTrackPriority_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,5),_SnVrrpVirRtrTrackPriority_Type())
...
snVrrpVirRtrCurrPriority=_SnVrrpVirRtrCurrPriority_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,6),_SnVrrpVirRtrCurrPriority_Type())
...
snVrrpVirRtrHelloInt=_SnVrrpVirRtrHelloInt_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,7),_SnVrrpVirRtrHelloInt_Type())
...
snVrrpVirRtrDeadInt=_SnVrrpVirRtrDeadInt_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,8),_SnVrrpVirRtrDeadInt_Type())
...
snVrrpVirRtrPreemptMode=_SnVrrpVirRtrPreemptMode_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,9),_SnVrrpVirRtrPreemptMode_Type())
...
snVrrpVirRtrState=_SnVrrpVirRtrState_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,10),_SnVrrpVirRtrState_Type())
...
snVrrpVirRtrActivate=_SnVrrpVirRtrActivate_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,11),_SnVrrpVirRtrActivate_Type())
...
snVrrpVirRtrIpAddrMask=_SnVrrpVirRtrIpAddrMask_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,12),_SnVrrpVirRtrIpAddrMask_Type())
...
snVrrpVirRtrTrackPortMask=_SnVrrpVirRtrTrackPortMask_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,13),_SnVrrpVirRtrTrackPortMask_Type())
...
snVrrpVirRtrTrackVifMask=_SnVrrpVirRtrTrackVifMask_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,14),_SnVrrpVirRtrTrackVifMask_Type())
...
snVrrpVirRtrRowStatus=_SnVrrpVirRtrRowStatus_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,15),_SnVrrpVirRtrRowStatus_Type())
...
snVrrpVirRtrRxArpPktDropCnts=_SnVrrpVirRtrRxArpPktDropCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,16),_SnVrrpVirRtrRxArpPktDropCnts_Type())
...
snVrrpVirRtrRxIpPktDropCnts=_SnVrrpVirRtrRxIpPktDropCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,17),_SnVrrpVirRtrRxIpPktDropCnts_Type())
...
snVrrpVirRtrRxPortMismatchCnts=_SnVrrpVirRtrRxPortMismatchCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,18),_SnVrrpVirRtrRxPortMismatchCnts_Type())
...
snVrrpVirRtrRxNumOfIpMismatchCnts=_SnVrrpVirRtrRxNumOfIpMismatchCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,19),_SnVrrpVirRtrRxNumOfIpMismatchCnts_Type())
...
snVrrpVirRtrRxIpMismatchCnts=_SnVrrpVirRtrRxIpMismatchCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,20),_SnVrrpVirRtrRxIpMismatchCnts_Type())
...
snVrrpVirRtrRxHelloIntMismatchCnts=_SnVrrpVirRtrRxHelloIntMismatchCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,21),_SnVrrpVirRtrRxHelloIntMismatchCnts_Type())
...
snVrrpVirRtrRxPriorityZeroFromMasterCnts=_SnVrrpVirRtrRxPriorityZeroFromMasterCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,22),_SnVrrpVirRtrRxPriorityZeroFromMasterCnts_Type())
...
snVrrpVirRtrRxHigherPriorityCnts=_SnVrrpVirRtrRxHigherPriorityCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,23),_SnVrrpVirRtrRxHigherPriorityCnts_Type())
...
snVrrpVirRtrTransToMasterStateCnts=_SnVrrpVirRtrTransToMasterStateCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,24),_SnVrrpVirRtrTransToMasterStateCnts_Type())
...
snVrrpVirRtrTransToBackupStateCnts=_SnVrrpVirRtrTransToBackupStateCnts_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,25),_SnVrrpVirRtrTransToBackupStateCnts_Type())
...
snVrrpVirRtrCurrDeadInt=_SnVrrpVirRtrCurrDeadInt_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,26),_SnVrrpVirRtrCurrDeadInt_Type())
...
snVrrpVirRtrTrackPortList=_SnVrrpVirRtrTrackPortList_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,27),_SnVrrpVirRtrTrackPortList_Type())
...
snVrrpVirRtrTrackVifPortList=_SnVrrpVirRtrTrackVifPortList_Object((1,3,6,1,4,1,1991,1,2,12,3,1,1,28),_SnVrrpVirRtrTrackVifPortList_Type())
...
snVrrpIntf2=_SnVrrpIntf2_ObjectIdentity((1,3,6,1,4,1,1991,1,2,12,4))
_SnVrrpIf2Table_Object=MibTable
snVrrpIf2Table=_SnVrrpIf2Table_Object((1,3,6,1,4,1,1991,1,2,12,4,1))
if mibBuilder.loadTexts:snVrrpIf2Table.setStatus(_A)
_SnVrrpIf2Entry_Object=MibTableRow
snVrrpIf2Entry=_SnVrrpIf2Entry_Object((1,3,6,1,4,1,1991,1,2,12,4,1,1))
...
snVrrpIf2AuthType=_SnVrrpIf2AuthType_Object((1,3,6,1,4,1,1991,1,2,12,4,1,1,1),_SnVrrpIf2AuthType_Type())
...
snVrrpIf2AuthPassword=_SnVrrpIf2AuthPassword_Object((1,3,6,1,4,1,1991,1,2,12,4,1,1,2),_SnVrrpIf2AuthPassword_Type())
...
snVrrpIf2RxHeaderErrCnts=_SnVrrpIf2RxHeaderErrCnts_Object((1,3,6,1,4,1,1991,1,2,12,4,1,1,3),_SnVrrpIf2RxHeaderErrCnts_Type())
...
snVrrpIf2RxAuthTypeErrCnts=_SnVrrpIf2RxAuthTypeErrCnts_Object((1,3,6,1,4,1,1991,1,2,12,4,1,1,4),_SnVrrpIf2RxAuthTypeErrCnts_Type())
...
snVrrpIf2RxAuthPwdMismatchErrCnts=_SnVrrpIf2RxAuthPwdMismatchErrCnts_Object((1,3,6,1,4,1,1991,1,2,12,4,1,1,5),_SnVrrpIf2RxAuthPwdMismatchErrCnts_Type())
...
snVrrpIf2RxVridErrCnts=_SnVrrpIf2RxVridErrCnts_Object((1,3,6,1,4,1,1991,1,2,12,4,1,1,6),_SnVrrpIf2RxVridErrCnts_Type())
...
snVrrpVirRtr2=_SnVrrpVirRtr2_ObjectIdentity((1,3,6,1,4,1,1991,1,2,12,5))
_SnVrrpVirRtr2Table_Object=MibTable
snVrrpVirRtr2Table=_SnVrrpVirRtr2Table_Object((1,3,6,1,4,1,1991,1,2,12,5,1))
if mibBuilder.loadTexts:snVrrpVirRtr2Table.setStatus(_A)
_SnVrrpVirRtr2Entry_Object=MibTableRow
snVrrpVirRtr2Entry=_SnVrrpVirRtr2Entry_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1))
...
snVrrpVirRtr2Id=_SnVrrpVirRtr2Id_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,1),_SnVrrpVirRtr2Id_Type())
...
snVrrpVirRtr2Ownership=_SnVrrpVirRtr2Ownership_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,2),_SnVrrpVirRtr2Ownership_Type())
...
snVrrpVirRtr2CfgPriority=_SnVrrpVirRtr2CfgPriority_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,3),_SnVrrpVirRtr2CfgPriority_Type())
...
snVrrpVirRtr2TrackPriority=_SnVrrpVirRtr2TrackPriority_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,4),_SnVrrpVirRtr2TrackPriority_Type())
...
snVrrpVirRtr2CurrPriority=_SnVrrpVirRtr2CurrPriority_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,5),_SnVrrpVirRtr2CurrPriority_Type())
...
snVrrpVirRtr2HelloInt=_SnVrrpVirRtr2HelloInt_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,6),_SnVrrpVirRtr2HelloInt_Type())
...
snVrrpVirRtr2DeadInt=_SnVrrpVirRtr2DeadInt_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,7),_SnVrrpVirRtr2DeadInt_Type())
...
snVrrpVirRtr2PreemptMode=_SnVrrpVirRtr2PreemptMode_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,8),_SnVrrpVirRtr2PreemptMode_Type())
...
snVrrpVirRtr2State=_SnVrrpVirRtr2State_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,9),_SnVrrpVirRtr2State_Type())
snVrrpVirRtr2State.setMaxAccess(_B)
if mibBuilder.loadTexts:snVrrpVirRtr2State.setStatus(_A)
class _SnVrrpVirRtr2IpAddrMask_Type(OctetString):subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(4,64))
_SnVrrpVirRtr2IpAddrMask_Type.__name__=_H
_SnVrrpVirRtr2IpAddrMask_Object=MibTableColumn
snVrrpVirRtr2IpAddrMask=_SnVrrpVirRtr2IpAddrMask_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,10),_SnVrrpVirRtr2IpAddrMask_Type())
...
snVrrpVirRtr2Activate=_SnVrrpVirRtr2Activate_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,11),_SnVrrpVirRtr2Activate_Type())
...
snVrrpVirRtr2BackupInt=_SnVrrpVirRtr2BackupInt_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,12),_SnVrrpVirRtr2BackupInt_Type())
...
snVrrpVirRtr2RowStatus=_SnVrrpVirRtr2RowStatus_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,13),_SnVrrpVirRtr2RowStatus_Type())
...
snVrrpVirRtr2RxArpPktDropCnts=_SnVrrpVirRtr2RxArpPktDropCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,14),_SnVrrpVirRtr2RxArpPktDropCnts_Type())
...
snVrrpVirRtr2RxIpPktDropCnts=_SnVrrpVirRtr2RxIpPktDropCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,15),_SnVrrpVirRtr2RxIpPktDropCnts_Type())
...
snVrrpVirRtr2RxPortMismatchCnts=_SnVrrpVirRtr2RxPortMismatchCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,16),_SnVrrpVirRtr2RxPortMismatchCnts_Type())
...
snVrrpVirRtr2RxNumOfIpMismatchCnts=_SnVrrpVirRtr2RxNumOfIpMismatchCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,17),_SnVrrpVirRtr2RxNumOfIpMismatchCnts_Type())
...
snVrrpVirRtr2RxIpMismatchCnts=_SnVrrpVirRtr2RxIpMismatchCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,18),_SnVrrpVirRtr2RxIpMismatchCnts_Type())
...
snVrrpVirRtr2RxHelloIntMismatchCnts=_SnVrrpVirRtr2RxHelloIntMismatchCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,19),_SnVrrpVirRtr2RxHelloIntMismatchCnts_Type())
...
snVrrpVirRtr2RxPriorityZeroFromMasterCnts=_SnVrrpVirRtr2RxPriorityZeroFromMasterCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,20),_SnVrrpVirRtr2RxPriorityZeroFromMasterCnts_Type())
...
snVrrpVirRtr2RxHigherPriorityCnts=_SnVrrpVirRtr2RxHigherPriorityCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,21),_SnVrrpVirRtr2RxHigherPriorityCnts_Type())
...
snVrrpVirRtr2TransToMasterStateCnts=_SnVrrpVirRtr2TransToMasterStateCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,22),_SnVrrpVirRtr2TransToMasterStateCnts_Type())
...
snVrrpVirRtr2TransToBackupStateCnts=_SnVrrpVirRtr2TransToBackupStateCnts_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,23),_SnVrrpVirRtr2TransToBackupStateCnts_Type())
...
snVrrpVirRtr2CurrDeadInt=_SnVrrpVirRtr2CurrDeadInt_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,24),_SnVrrpVirRtr2CurrDeadInt_Type())
...
snVrrpVirRtr2TrackPortList=_SnVrrpVirRtr2TrackPortList_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,25),_SnVrrpVirRtr2TrackPortList_Type())
...
snVrrpVirRtr2AdvertiseBackup=_SnVrrpVirRtr2AdvertiseBackup_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,26),_SnVrrpVirRtr2AdvertiseBackup_Type())
...
snVrrpVirRtr2MasterIpAddr=_SnVrrpVirRtr2MasterIpAddr_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,27),_SnVrrpVirRtr2MasterIpAddr_Type())
...
snVrrpVirRtr2IpAddrCount=_SnVrrpVirRtr2IpAddrCount_Object((1,3,6,1,4,1,1991,1,2,12,5,1,1,28),_SnVrrpVirRtr2IpAddrCount_Type())
