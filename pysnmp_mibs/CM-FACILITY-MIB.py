...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:00:42 2025
...
if mibBuilder.loadTexts:
    cmEthernetTrafficPortPriorityVlanId.setStatus("current")
...
if mibBuilder.loadTexts:
    cmEthernetTrafficPortIngressCOSPriority.setStatus("current")
...
if mibBuilder.loadTexts:
    f3GPSReceiverPortAntennaCableLength.setStatus("current")
...
if mibBuilder.loadTexts:
    f3GPSReceiverPortGnssSystem.setStatus("current")
