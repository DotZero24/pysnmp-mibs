...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:23:07 2025
...
mibBuilder.exportSymbols("CISCO-CVP-MIB", ccvpJvmRtUpTime=ccvpJvmRtUpTime, ccvpSipAggFailedXferPost=ccvpSipAggFailedXferPost, ccvpTimeZoneOffsetHours=ccvpTimeZoneOffsetHours, ccvpJvmRtMaxThreadsUsed=ccvpJvmRtMaxThreadsUsed, ccvpSipIntWhisperFailed=ccvpSipIntWhisperFailed, ccvpH323RtCallsInProgress=ccvpH323RtCallsInProgress, ccvpIcmRtActiveCalls=ccvpIcmRtActiveCalls, ccvpVxmlRtActiveSessions=ccvpVxmlRtActiveSessions, ccvpH323Entry=ccvpH323Entry, ccvpEventText=ccvpEventText, ccvpVxmlAggIcmLookupReqs=ccvpVxmlAggIcmLookupReqs, ccvpIvrTable=ccvpIvrTable, ccvpIcmAggH323CallLegs=ccvpIcmAggH323CallLegs, ccvpReptTable=ccvpReptTable, ccvpVxmlAggIcmLookupSuccess=ccvpVxmlAggIcmLookupSuccess, CcvpIndex=CcvpIndex, ccvpSipRtBasicVideoAnswered=ccvpSipRtBasicVideoAnswered, ccvpH323IntMaxCpuUsage=ccvpH323IntMaxCpuUsage, ccvpVxmlIntReptEvents=ccvpVxmlIntReptEvents, ccvpVxmlTableGroup=ccvpVxmlTableGroup, ciscoCvpMIBConform=ciscoCvpMIBConform, ccvpIvrRtActiveHttpReqs=ccvpIvrRtActiveHttpReqs, ccvpReptIntVxmlEvents=ccvpReptIntVxmlEvents, ccvpIcmAggCalls=ccvpIcmAggCalls, ccvpIvrIntHttpReqs=ccvpIvrIntHttpReqs, ccvpVxmlIntIcmLookupReqs=ccvpVxmlIntIcmLookupReqs, ccvpJvmInfo=ccvpJvmInfo, ccvpVxmlAggSessions=ccvpVxmlAggSessions, ccvpSipRtActiveCalls=ccvpSipRtActiveCalls, ccvpIvrIntAvgHttpReqRate=ccvpIvrIntAvgHttpReqRate, ccvpLicRtPortsAvail=ccvpLicRtPortsAvail, ccvpSipTableGroup=ccvpSipTableGroup, ccvpServiceTableGroup=ccvpServiceTableGroup, ccvpSipIntGreetingAnswered=ccvpSipIntGreetingAnswered, ccvpIcmIntH323CallLegs=ccvpIcmIntH323CallLegs, ccvpStartTime=ccvpStartTime, ccvpSipAggAvgLatency1=ccvpSipAggAvgLatency1, ccvpIvrIntCallsFinished=ccvpIvrIntCallsFinished, ccvpIvrTableGroup=ccvpIvrTableGroup, ccvpSipIntBasicVideoOffered=ccvpSipIntBasicVideoOffered, ccvpServiceType=ccvpServiceType, ccvpSipAggAvgLatency2=ccvpSipAggAvgLatency2, ccvpH323IntArrivalRate=ccvpH323IntArrivalRate, ccvpH323IntRedirected=ccvpH323IntRedirected, ccvpVxmlRtActiveIcmLookups=ccvpVxmlRtActiveIcmLookups, ccvpSipTable=ccvpSipTable, ccvpEnableNotifications=ccvpEnableNotifications, ccvpServerName=ccvpServerName, ccvpSipEntry=ccvpSipEntry, ccvpIcmEntry=ccvpIcmEntry, ccvpReptTableGroup=ccvpReptTableGroup, ccvpH323IntCriticalMedia=ccvpH323IntCriticalMedia, ccvpIvrAggNewCalls=ccvpIvrAggNewCalls, ccvpSipIntAvgLatency1=ccvpSipIntAvgLatency1, ccvpH323IntTransferred=ccvpH323IntTransferred, ccvpIvrEntry=ccvpIvrEntry, ccvpIcmIntNewCalls=ccvpIcmIntNewCalls, ciscoCvpMIB=ciscoCvpMIB, ccvpLicPortUsageCritical=ccvpLicPortUsageCritical, ccvpServiceIndex=ccvpServiceIndex, CcvpServiceStatus=CcvpServiceStatus, ccvpJvmRtCurrMemAvail=ccvpJvmRtCurrMemAvail, ccvpSupportToolsURL=ccvpSupportToolsURL, ccvpIvrIntMaxCallLatency=ccvpIvrIntMaxCallLatency, ccvpIcmAggAcceptedBasicVideoCalls=ccvpIcmAggAcceptedBasicVideoCalls, ccvpTimeZoneOffsetMinutes=ccvpTimeZoneOffsetMinutes, ccvpH323IntMaxXferToAnswer=ccvpH323IntMaxXferToAnswer, ccvpIvrIntMinCallLatency=ccvpIvrIntMinCallLatency, ccvpIcmRtActiveSIPCallLegs=ccvpIcmRtActiveSIPCallLegs, ccvpLicRtPortsInUse=ccvpLicRtPortsInUse, ccvpLicIntPortReqs=ccvpLicIntPortReqs, ccvpJvmRtMaxMemUsed=ccvpJvmRtMaxMemUsed, ccvpVxmlAggIcmLookupResp=ccvpVxmlAggIcmLookupResp, ccvpTPoolRtMaxThreadsAvail=ccvpTPoolRtMaxThreadsAvail, ccvpH323IntMaxXferToAlert=ccvpH323IntMaxXferToAlert, ccvpIvrAggAgentPushedVideo=ccvpIvrAggAgentPushedVideo, ccvpIvrIntNewCalls=ccvpIvrIntNewCalls, ccvpReptIntSipEvents=ccvpReptIntSipEvents, ccvpIcmAggVruCallLegs=ccvpIcmAggVruCallLegs, ccvpTPoolRtIdleThreads=ccvpTPoolRtIdleThreads, ccvpServices=ccvpServices, ccvpGeneralInfo=ccvpGeneralInfo, ccvpLicRtPortState=ccvpLicRtPortState, ccvpServiceInfo=ccvpServiceInfo, ccvpIcmRtOfferedBasicVideoCalls=ccvpIcmRtOfferedBasicVideoCalls, ccvpIvrRtActiveCalls=ccvpIvrRtActiveCalls, ccvpEventState=ccvpEventState, ccvpLicIntLastUpdate=ccvpLicIntLastUpdate, ccvpIcmTable=ccvpIcmTable, ciscoCcvpMIBComplianceRev2=ciscoCcvpMIBComplianceRev2, ccvpServiceIntPeriod=ccvpServiceIntPeriod, ccvpSipIntNewCalls=ccvpSipIntNewCalls, ccvpVxmlIntIcmLookupFails=ccvpVxmlIntIcmLookupFails, ccvpServiceTable=ccvpServiceTable, ccvpLicAggAvgPortReqs=ccvpLicAggAvgPortReqs, ccvpSipIntConnectsRcv=ccvpSipIntConnectsRcv, ccvpEventTimestamp=ccvpEventTimestamp, ccvpSipAggBasicVideoAnswered=ccvpSipAggBasicVideoAnswered, ccvpSipIntFailedXferPre=ccvpSipIntFailedXferPre, ccvpTimeZoneName=ccvpTimeZoneName, ccvpH323IntAvgXferToAnswer=ccvpH323IntAvgXferToAnswer, ccvpSipIntWhisperAnswered=ccvpSipIntWhisperAnswered, ccvpIvrAggMaxFullVideoCalls=ccvpIvrAggMaxFullVideoCalls, ccvpIcmRtAcceptedBasicVideoCalls=ccvpIcmRtAcceptedBasicVideoCalls, ccvpIcmIntFullVideoCalls=ccvpIcmIntFullVideoCalls, ccvpH323RtMemoryInUse=ccvpH323RtMemoryInUse, ccvpIvrAggAgentVCRControlInvocations=ccvpIvrAggAgentVCRControlInvocations, ccvpSipIntGreetingFailed=ccvpSipIntGreetingFailed, ccvpVxmlIntSessions=ccvpVxmlIntSessions, ccvpTPoolRtRunningThreads=ccvpTPoolRtRunningThreads, ccvpReptAggDatabaseWrites=ccvpReptAggDatabaseWrites, ccvpSipAggNewCalls=ccvpSipAggNewCalls, ccvpIcmAggFullVideoCalls=ccvpIcmAggFullVideoCalls, ccvpH323IntAvgCpuUsage=ccvpH323IntAvgCpuUsage, ccvpIcmAggIcmLookupReqs=ccvpIcmAggIcmLookupReqs, ccvpLicIntPortReqsDenied=ccvpLicIntPortReqsDenied, ccvpLicAggPortReqs=ccvpLicAggPortReqs, ccvpH323IntAvgNewCallLatency=ccvpH323IntAvgNewCallLatency, ccvpIvrAggAgentInitiatedRecordings=ccvpIvrAggAgentInitiatedRecordings, ciscoCcvpMIBComplianceRev1=ciscoCcvpMIBComplianceRev1, PYSNMP_MODULE_ID=ciscoCvpMIB, ccvpIcmIntVruCallLegs=ccvpIcmIntVruCallLegs, ccvpEventAppName=ccvpEventAppName, ccvpVxmlAggReptEvents=ccvpVxmlAggReptEvents, ccvpTPoolRtCoreThreads=ccvpTPoolRtCoreThreads, ccvpLicensingInfoGroup=ccvpLicensingInfoGroup, ccvpJvmRtCurrMemUsed=ccvpJvmRtCurrMemUsed, ccvpCvpEvent=ccvpCvpEvent, ccvpH323TableGroup=ccvpH323TableGroup, ciscoCvpMIBObjects=ciscoCvpMIBObjects, ccvpSipIntFailedXferPost=ccvpSipIntFailedXferPost, ccvpIcmVideoTableGroup=ccvpIcmVideoTableGroup, ccvpSipAggConnectsRcv=ccvpSipAggConnectsRcv, ccvpH323IntPromptsNotFound=ccvpH323IntPromptsNotFound, ccvpSipIntPostCallAnswered=ccvpSipIntPostCallAnswered, ccvpIcmIntIcmLookupReqs=ccvpIcmIntIcmLookupReqs, ccvpSipVideoTableGroup=ccvpSipVideoTableGroup, ccvpLicIntPeriod=ccvpLicIntPeriod, ciscoCvpMIBCompliances=ciscoCvpMIBCompliances, ccvpIcmRtActiveVRUCallLegs=ccvpIcmRtActiveVRUCallLegs, ccvpServiceName=ccvpServiceName, ccvpCvpEventsGroup=ccvpCvpEventsGroup, ccvpLicensingInfo=ccvpLicensingInfo, ccvpSipIntAvgLatency2=ccvpSipIntAvgLatency2, ccvpServiceIntLastUpdate=ccvpServiceIntLastUpdate, ccvpH323IntTransferRate=ccvpH323IntTransferRate, ccvpH323IntNewCalls=ccvpH323IntNewCalls, ccvpReptAggSipEvents=ccvpReptAggSipEvents, ccvpEventMessageName=ccvpEventMessageName, ccvpSipAggFailedXferPre=ccvpSipAggFailedXferPre, ciscoCvpMIBNotifs=ciscoCvpMIBNotifs, ccvpIcmTableGroup=ccvpIcmTableGroup, ccvpH323IntAvgXferToAlert=ccvpH323IntAvgXferToAlert, ccvpLicAggMaxPortsInUse=ccvpLicAggMaxPortsInUse, ccvpSipAggBasicVideoOffered=ccvpSipAggBasicVideoOffered, ccvpIvrRtFullVideoCalls=ccvpIvrRtFullVideoCalls, ccvpJvmRtMaxMemAvail=ccvpJvmRtMaxMemAvail, ccvpReptIntIvrEvents=ccvpReptIntIvrEvents, ciscoCvpMIBGroups=ciscoCvpMIBGroups, ccvpEventHostName=ccvpEventHostName, CcvpServiceType=CcvpServiceType, ccvpIvrIntFullVideoCalls=ccvpIvrIntFullVideoCalls, ccvpLicIntAvgPortReqs=ccvpLicIntAvgPortReqs, ccvpIcmAggOfferedBasicVideoCalls=ccvpIcmAggOfferedBasicVideoCalls, ccvpGeneralInfoGroup=ccvpGeneralInfoGroup, ccvpH323IntCallsFinished=ccvpH323IntCallsFinished, ccvpIvrIntMaxHttpReqRate=ccvpIvrIntMaxHttpReqRate, ccvpVxmlEntry=ccvpVxmlEntry, ccvpEventMessageId=ccvpEventMessageId, ccvpThreadPoolInfoGroup=ccvpThreadPoolInfoGroup, ccvpTPoolRtMaxThreadsUsed=ccvpTPoolRtMaxThreadsUsed, ccvpVersion=ccvpVersion, ccvpIcmRtActiveH323CallLegs=ccvpIcmRtActiveH323CallLegs, ccvpJvmRtCurrThreadsInUse=ccvpJvmRtCurrThreadsInUse, ccvpSipRtBasicVideoOffered=ccvpSipRtBasicVideoOffered, ccvpVxmlIntIcmLookupResp=ccvpVxmlIntIcmLookupResp, ccvpOpsConsoleURL=ccvpOpsConsoleURL, ccvpIvrAggHttpReqs=ccvpIvrAggHttpReqs, ccvpIvrVideoTableGroup=ccvpIvrVideoTableGroup, ccvpIcmRtActiveICMLookupReqs=ccvpIcmRtActiveICMLookupReqs, ccvpVxmlAggIcmLookupFails=ccvpVxmlAggIcmLookupFails, ccvpIcmIntOfferedBasicVideoCalls=ccvpIcmIntOfferedBasicVideoCalls, ccvpSipIntBasicVideoAnswered=ccvpSipIntBasicVideoAnswered, ccvpReptIntDatabaseWrites=ccvpReptIntDatabaseWrites, ccvpIcmIntSipCallLegs=ccvpIcmIntSipCallLegs, ccvpIcmRtFullVideoCalls=ccvpIcmRtFullVideoCalls, ccvpIvrIntMaxFullVideoCalls=ccvpIvrIntMaxFullVideoCalls, ccvpLicPortUsageWarning=ccvpLicPortUsageWarning, ccvpEventSeverity=ccvpEventSeverity, ccvpServiceStatus=ccvpServiceStatus, ccvpReptAggVxmlEvents=ccvpReptAggVxmlEvents, ccvpIcmIntAcceptedBasicVideoCalls=ccvpIcmIntAcceptedBasicVideoCalls, ccvpSipRtTotalCallLegs=ccvpSipRtTotalCallLegs, ccvpDescription=ccvpDescription, ccvpIvrIntMaxActiveHttpReqs=ccvpIvrIntMaxActiveHttpReqs, ccvpNotificationInfo=ccvpNotificationInfo, ccvpH323IntNotTransferred=ccvpH323IntNotTransferred, ccvpVxmlTable=ccvpVxmlTable, ccvpReptAggIvrEvents=ccvpReptAggIvrEvents, ccvpReptEntry=ccvpReptEntry, ccvpJvmInfoGroup=ccvpJvmInfoGroup, ccvpIvrIntAvgCallLatency=ccvpIvrIntAvgCallLatency, ccvpCvpNotificationInfoGroup=ccvpCvpNotificationInfoGroup, ccvpIvrAggFullVideoCalls=ccvpIvrAggFullVideoCalls, ccvpIvrAggMaxActiveCalls=ccvpIvrAggMaxActiveCalls, ccvpThreadPoolInfo=ccvpThreadPoolInfo, ccvpLicAggPortReqsDenied=ccvpLicAggPortReqsDenied, ccvpServiceEntry=ccvpServiceEntry, ccvpIvrAggMaxHttpReqs=ccvpIvrAggMaxHttpReqs, ccvpLicIntMaxPortsInUse=ccvpLicIntMaxPortsInUse, ccvpVxmlIntIcmLookupSuccess=ccvpVxmlIntIcmLookupSuccess, ccvpIcmAggSipCallLegs=ccvpIcmAggSipCallLegs, ccvpIvrIntMaxActiveCalls=ccvpIvrIntMaxActiveCalls, ccvpH323Table=ccvpH323Table, ccvpH323IntMaxNewCallLatency=ccvpH323IntMaxNewCallLatency)
