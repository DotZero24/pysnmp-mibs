...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-CVP-MIB
...
mibBuilder.exportSymbols("CISCO-CVP-MIB", ccvpLicPortUsageCritical=ccvpLicPortUsageCritical, ccvpSipAggNewCalls=ccvpSipAggNewCalls, ccvpIvrTable=ccvpIvrTable, ccvpGeneralInfo=ccvpGeneralInfo, ccvpSipIntBasicVideoOffered=ccvpSipIntBasicVideoOffered, ccvpVxmlRtActiveSessions=ccvpVxmlRtActiveSessions, ccvpSipVideoTableGroup=ccvpSipVideoTableGroup, ccvpOpsConsoleURL=ccvpOpsConsoleURL, ccvpIvrRtActiveCalls=ccvpIvrRtActiveCalls, ccvpServiceInfo=ccvpServiceInfo, ccvpH323IntAvgCpuUsage=ccvpH323IntAvgCpuUsage, ccvpSipIntConnectsRcv=ccvpSipIntConnectsRcv, ccvpIcmIntOfferedBasicVideoCalls=ccvpIcmIntOfferedBasicVideoCalls, ccvpEventHostName=ccvpEventHostName, ccvpTPoolRtRunningThreads=ccvpTPoolRtRunningThreads, ccvpH323IntAvgXferToAnswer=ccvpH323IntAvgXferToAnswer, ccvpSipAggFailedXferPost=ccvpSipAggFailedXferPost, ccvpStartTime=ccvpStartTime, ccvpServiceTableGroup=ccvpServiceTableGroup, ccvpH323IntTransferred=ccvpH323IntTransferred, ccvpVxmlIntReptEvents=ccvpVxmlIntReptEvents, ccvpGeneralInfoGroup=ccvpGeneralInfoGroup, ccvpIcmRtOfferedBasicVideoCalls=ccvpIcmRtOfferedBasicVideoCalls, ccvpIcmRtActiveSIPCallLegs=ccvpIcmRtActiveSIPCallLegs, PYSNMP_MODULE_ID=ciscoCvpMIB, ccvpIvrIntMaxFullVideoCalls=ccvpIvrIntMaxFullVideoCalls, ccvpIvrTableGroup=ccvpIvrTableGroup, ccvpLicIntLastUpdate=ccvpLicIntLastUpdate, ccvpH323IntPromptsNotFound=ccvpH323IntPromptsNotFound, ccvpH323IntNewCalls=ccvpH323IntNewCalls, ccvpIvrIntHttpReqs=ccvpIvrIntHttpReqs, ccvpIvrRtFullVideoCalls=ccvpIvrRtFullVideoCalls, ccvpServices=ccvpServices, ciscoCvpMIBConform=ciscoCvpMIBConform, ccvpIvrIntMaxActiveHttpReqs=ccvpIvrIntMaxActiveHttpReqs, ccvpVxmlEntry=ccvpVxmlEntry, ccvpLicPortUsageWarning=ccvpLicPortUsageWarning, ccvpReptIntSipEvents=ccvpReptIntSipEvents, ccvpH323IntMaxXferToAlert=ccvpH323IntMaxXferToAlert, ccvpTPoolRtIdleThreads=ccvpTPoolRtIdleThreads, ccvpSipAggBasicVideoOffered=ccvpSipAggBasicVideoOffered, ccvpIvrVideoTableGroup=ccvpIvrVideoTableGroup, ccvpSupportToolsURL=ccvpSupportToolsURL, ccvpVxmlAggReptEvents=ccvpVxmlAggReptEvents, ccvpVxmlIntIcmLookupSuccess=ccvpVxmlIntIcmLookupSuccess, ccvpIvrIntNewCalls=ccvpIvrIntNewCalls, ccvpIcmRtActiveH323CallLegs=ccvpIcmRtActiveH323CallLegs, ccvpIvrEntry=ccvpIvrEntry, ccvpCvpEvent=ccvpCvpEvent, ccvpLicAggPortReqsDenied=ccvpLicAggPortReqsDenied, ccvpLicIntPeriod=ccvpLicIntPeriod, ccvpSipTable=ccvpSipTable, ccvpServiceName=ccvpServiceName, ccvpIvrAggMaxActiveCalls=ccvpIvrAggMaxActiveCalls, ccvpJvmRtMaxMemAvail=ccvpJvmRtMaxMemAvail, ccvpIcmIntAcceptedBasicVideoCalls=ccvpIcmIntAcceptedBasicVideoCalls, ccvpH323IntTransferRate=ccvpH323IntTransferRate, ccvpIvrAggMaxFullVideoCalls=ccvpIvrAggMaxFullVideoCalls, ccvpNotificationInfo=ccvpNotificationInfo, ccvpReptAggDatabaseWrites=ccvpReptAggDatabaseWrites, ccvpLicIntMaxPortsInUse=ccvpLicIntMaxPortsInUse, ccvpJvmRtCurrMemAvail=ccvpJvmRtCurrMemAvail, ccvpReptIntDatabaseWrites=ccvpReptIntDatabaseWrites, ciscoCvpMIBCompliances=ciscoCvpMIBCompliances, ciscoCcvpMIBComplianceRev2=ciscoCcvpMIBComplianceRev2, ccvpIcmVideoTableGroup=ccvpIcmVideoTableGroup, ciscoCvpMIB=ciscoCvpMIB, ccvpH323IntNotTransferred=ccvpH323IntNotTransferred, ccvpH323RtCallsInProgress=ccvpH323RtCallsInProgress, ccvpH323IntCriticalMedia=ccvpH323IntCriticalMedia, ccvpLicRtPortsInUse=ccvpLicRtPortsInUse, ccvpIvrIntAvgCallLatency=ccvpIvrIntAvgCallLatency, ccvpSipAggAvgLatency2=ccvpSipAggAvgLatency2, ccvpSipIntAvgLatency1=ccvpSipIntAvgLatency1, CcvpServiceType=CcvpServiceType, ccvpIcmAggFullVideoCalls=ccvpIcmAggFullVideoCalls, ccvpLicIntPortReqs=ccvpLicIntPortReqs, ciscoCvpMIBGroups=ciscoCvpMIBGroups, ccvpTPoolRtMaxThreadsAvail=ccvpTPoolRtMaxThreadsAvail, ccvpSipRtActiveCalls=ccvpSipRtActiveCalls, ccvpH323IntMaxCpuUsage=ccvpH323IntMaxCpuUsage, CcvpIndex=CcvpIndex, ccvpServiceIntPeriod=ccvpServiceIntPeriod, ccvpVxmlAggSessions=ccvpVxmlAggSessions, ccvpCvpEventsGroup=ccvpCvpEventsGroup, ccvpReptEntry=ccvpReptEntry, ccvpEventSeverity=ccvpEventSeverity, ciscoCcvpMIBComplianceRev1=ciscoCcvpMIBComplianceRev1, ccvpJvmInfoGroup=ccvpJvmInfoGroup, ccvpLicAggMaxPortsInUse=ccvpLicAggMaxPortsInUse, ccvpIvrIntMaxActiveCalls=ccvpIvrIntMaxActiveCalls, ccvpH323IntArrivalRate=ccvpH323IntArrivalRate, ccvpLicAggAvgPortReqs=ccvpLicAggAvgPortReqs, ccvpSipAggFailedXferPre=ccvpSipAggFailedXferPre, ccvpEventText=ccvpEventText, ccvpIcmTable=ccvpIcmTable, ccvpIcmRtAcceptedBasicVideoCalls=ccvpIcmRtAcceptedBasicVideoCalls, ccvpIcmAggOfferedBasicVideoCalls=ccvpIcmAggOfferedBasicVideoCalls, ccvpJvmInfo=ccvpJvmInfo, ccvpIvrRtActiveHttpReqs=ccvpIvrRtActiveHttpReqs, ccvpServiceEntry=ccvpServiceEntry, ccvpIvrAggAgentInitiatedRecordings=ccvpIvrAggAgentInitiatedRecordings, ccvpIcmAggSipCallLegs=ccvpIcmAggSipCallLegs, ccvpIvrAggNewCalls=ccvpIvrAggNewCalls, ccvpReptAggSipEvents=ccvpReptAggSipEvents, ccvpCvpNotificationInfoGroup=ccvpCvpNotificationInfoGroup, ccvpSipIntNewCalls=ccvpSipIntNewCalls, ciscoCvpMIBNotifs=ciscoCvpMIBNotifs, ccvpSipRtBasicVideoAnswered=ccvpSipRtBasicVideoAnswered, ccvpSipAggAvgLatency1=ccvpSipAggAvgLatency1, ccvpSipIntWhisperAnswered=ccvpSipIntWhisperAnswered, CcvpServiceStatus=CcvpServiceStatus, ccvpLicIntAvgPortReqs=ccvpLicIntAvgPortReqs, ccvpReptTable=ccvpReptTable, ccvpH323IntAvgXferToAlert=ccvpH323IntAvgXferToAlert, ccvpLicensingInfoGroup=ccvpLicensingInfoGroup, ccvpH323RtMemoryInUse=ccvpH323RtMemoryInUse, ciscoCvpMIBObjects=ciscoCvpMIBObjects, ccvpH323TableGroup=ccvpH323TableGroup, ccvpTimeZoneOffsetHours=ccvpTimeZoneOffsetHours, ccvpH323IntAvgNewCallLatency=ccvpH323IntAvgNewCallLatency, ccvpIvrIntFullVideoCalls=ccvpIvrIntFullVideoCalls, ccvpReptIntVxmlEvents=ccvpReptIntVxmlEvents, ccvpTimeZoneName=ccvpTimeZoneName, ccvpIvrIntMinCallLatency=ccvpIvrIntMinCallLatency, ccvpThreadPoolInfo=ccvpThreadPoolInfo, ccvpIcmAggAcceptedBasicVideoCalls=ccvpIcmAggAcceptedBasicVideoCalls, ccvpSipIntWhisperFailed=ccvpSipIntWhisperFailed, ccvpLicRtPortsAvail=ccvpLicRtPortsAvail, ccvpEventMessageName=ccvpEventMessageName, ccvpSipIntGreetingFailed=ccvpSipIntGreetingFailed, ccvpSipRtBasicVideoOffered=ccvpSipRtBasicVideoOffered, ccvpServiceTable=ccvpServiceTable, ccvpEventTimestamp=ccvpEventTimestamp, ccvpVxmlIntIcmLookupFails=ccvpVxmlIntIcmLookupFails, ccvpH323IntMaxXferToAnswer=ccvpH323IntMaxXferToAnswer, ccvpVxmlAggIcmLookupFails=ccvpVxmlAggIcmLookupFails, ccvpServiceType=ccvpServiceType, ccvpIcmAggIcmLookupReqs=ccvpIcmAggIcmLookupReqs, ccvpServiceStatus=ccvpServiceStatus, ccvpIcmRtActiveICMLookupReqs=ccvpIcmRtActiveICMLookupReqs, ccvpVxmlAggIcmLookupSuccess=ccvpVxmlAggIcmLookupSuccess, ccvpVxmlRtActiveIcmLookups=ccvpVxmlRtActiveIcmLookups, ccvpThreadPoolInfoGroup=ccvpThreadPoolInfoGroup, ccvpSipIntBasicVideoAnswered=ccvpSipIntBasicVideoAnswered, ccvpServerName=ccvpServerName, ccvpIcmIntIcmLookupReqs=ccvpIcmIntIcmLookupReqs, ccvpLicIntPortReqsDenied=ccvpLicIntPortReqsDenied, ccvpSipIntPostCallAnswered=ccvpSipIntPostCallAnswered, ccvpVxmlTableGroup=ccvpVxmlTableGroup, ccvpVersion=ccvpVersion, ccvpSipIntAvgLatency2=ccvpSipIntAvgLatency2, ccvpSipIntFailedXferPre=ccvpSipIntFailedXferPre, ccvpIcmEntry=ccvpIcmEntry, ccvpIcmAggVruCallLegs=ccvpIcmAggVruCallLegs, ccvpServiceIntLastUpdate=ccvpServiceIntLastUpdate, ccvpIvrAggFullVideoCalls=ccvpIvrAggFullVideoCalls, ccvpIcmIntSipCallLegs=ccvpIcmIntSipCallLegs, ccvpIcmRtActiveCalls=ccvpIcmRtActiveCalls, ccvpReptAggIvrEvents=ccvpReptAggIvrEvents, ccvpVxmlIntIcmLookupReqs=ccvpVxmlIntIcmLookupReqs, ccvpIcmIntH323CallLegs=ccvpIcmIntH323CallLegs, ccvpIcmIntFullVideoCalls=ccvpIcmIntFullVideoCalls, ccvpEventAppName=ccvpEventAppName, ccvpSipIntFailedXferPost=ccvpSipIntFailedXferPost, ccvpEventState=ccvpEventState, ccvpIvrIntCallsFinished=ccvpIvrIntCallsFinished, ccvpSipRtTotalCallLegs=ccvpSipRtTotalCallLegs, ccvpServiceIndex=ccvpServiceIndex, ccvpH323Table=ccvpH323Table, ccvpIcmIntVruCallLegs=ccvpIcmIntVruCallLegs, ccvpLicensingInfo=ccvpLicensingInfo, ccvpJvmRtCurrMemUsed=ccvpJvmRtCurrMemUsed, ccvpVxmlIntIcmLookupResp=ccvpVxmlIntIcmLookupResp, ccvpSipAggBasicVideoAnswered=ccvpSipAggBasicVideoAnswered, ccvpIvrIntMaxCallLatency=ccvpIvrIntMaxCallLatency, ccvpSipTableGroup=ccvpSipTableGroup, ccvpEnableNotifications=ccvpEnableNotifications, ccvpSipAggConnectsRcv=ccvpSipAggConnectsRcv, ccvpIcmRtFullVideoCalls=ccvpIcmRtFullVideoCalls, ccvpIvrAggAgentVCRControlInvocations=ccvpIvrAggAgentVCRControlInvocations, ccvpIcmRtActiveVRUCallLegs=ccvpIcmRtActiveVRUCallLegs, ccvpLicRtPortState=ccvpLicRtPortState, ccvpJvmRtMaxThreadsUsed=ccvpJvmRtMaxThreadsUsed, ccvpIcmTableGroup=ccvpIcmTableGroup, ccvpIcmIntNewCalls=ccvpIcmIntNewCalls, ccvpSipIntGreetingAnswered=ccvpSipIntGreetingAnswered, ccvpEventMessageId=ccvpEventMessageId, ccvpLicAggPortReqs=ccvpLicAggPortReqs, ccvpTimeZoneOffsetMinutes=ccvpTimeZoneOffsetMinutes, ccvpJvmRtCurrThreadsInUse=ccvpJvmRtCurrThreadsInUse, ccvpIvrIntMaxHttpReqRate=ccvpIvrIntMaxHttpReqRate, ccvpDescription=ccvpDescription, ccvpTPoolRtMaxThreadsUsed=ccvpTPoolRtMaxThreadsUsed, ccvpH323IntRedirected=ccvpH323IntRedirected, ccvpH323IntCallsFinished=ccvpH323IntCallsFinished, ccvpH323Entry=ccvpH323Entry, ccvpSipEntry=ccvpSipEntry, ccvpVxmlTable=ccvpVxmlTable, ccvpIvrAggMaxHttpReqs=ccvpIvrAggMaxHttpReqs, ccvpReptAggVxmlEvents=ccvpReptAggVxmlEvents, ccvpVxmlIntSessions=ccvpVxmlIntSessions, ccvpIcmAggH323CallLegs=ccvpIcmAggH323CallLegs, ccvpIvrAggAgentPushedVideo=ccvpIvrAggAgentPushedVideo, ccvpReptTableGroup=ccvpReptTableGroup, ccvpVxmlAggIcmLookupResp=ccvpVxmlAggIcmLookupResp, ccvpJvmRtMaxMemUsed=ccvpJvmRtMaxMemUsed, ccvpJvmRtUpTime=ccvpJvmRtUpTime, ccvpIcmAggCalls=ccvpIcmAggCalls, ccvpReptIntIvrEvents=ccvpReptIntIvrEvents, ccvpIvrIntAvgHttpReqRate=ccvpIvrIntAvgHttpReqRate, ccvpIvrAggHttpReqs=ccvpIvrAggHttpReqs, ccvpVxmlAggIcmLookupReqs=ccvpVxmlAggIcmLookupReqs, ccvpH323IntMaxNewCallLatency=ccvpH323IntMaxNewCallLatency, ccvpTPoolRtCoreThreads=ccvpTPoolRtCoreThreads)
