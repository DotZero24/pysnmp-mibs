...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CVP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:21:49 2025
...
_CcvpLicPortUsageWarning_Type.__name__ = "Gauge32"
...
_CcvpLicPortUsageCritical_Type.__name__ = "Gauge32"
...
ciscoCcvpMIBComplianceRev1.setObjects(
      *(("CISCO-CVP-MIB", "ccvpGeneralInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpLicensingInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpThreadPoolInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpJvmInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpServiceTableGroup"),
        ("CISCO-CVP-MIB", "ccvpSipTableGroup"),
        ("CISCO-CVP-MIB", "ccvpH323TableGroup"),
        ("CISCO-CVP-MIB", "ccvpIvrTableGroup"),
        ("CISCO-CVP-MIB", "ccvpIcmTableGroup"),
        ("CISCO-CVP-MIB", "ccvpReptTableGroup"),
        ("CISCO-CVP-MIB", "ccvpVxmlTableGroup"),
        ("CISCO-CVP-MIB", "ccvpCvpNotificationInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpCvpEventsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCcvpMIBComplianceRev2.setObjects(
      *(("CISCO-CVP-MIB", "ccvpGeneralInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpLicensingInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpThreadPoolInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpJvmInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpServiceTableGroup"),
        ("CISCO-CVP-MIB", "ccvpSipTableGroup"),
        ("CISCO-CVP-MIB", "ccvpSipVideoTableGroup"),
        ("CISCO-CVP-MIB", "ccvpH323TableGroup"),
        ("CISCO-CVP-MIB", "ccvpIvrTableGroup"),
        ("CISCO-CVP-MIB", "ccvpIvrVideoTableGroup"),
        ("CISCO-CVP-MIB", "ccvpIcmTableGroup"),
        ("CISCO-CVP-MIB", "ccvpIcmVideoTableGroup"),
        ("CISCO-CVP-MIB", "ccvpReptTableGroup"),
        ("CISCO-CVP-MIB", "ccvpVxmlTableGroup"),
        ("CISCO-CVP-MIB", "ccvpCvpNotificationInfoGroup"),
        ("CISCO-CVP-MIB", "ccvpCvpEventsGroup"))
