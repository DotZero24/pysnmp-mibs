...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/smartoptics/SL-SONET-MIB
...
if mibBuilder.loadTexts: slSonetMib.setOrganization('Smartoptics AS')
...
mibBuilder.exportSymbols("SL-SONET-MIB", slSonetTraceToExpect=slSonetTraceToExpect, slSonetOhSl=slSonetOhSl, PYSNMP_MODULE_ID=slSonetMib, slSonetFsSts=slSonetFsSts, slSonetConfigTable=slSonetConfigTable, slSonetFs=slSonetFs, slSonetResetPmThreshold=slSonetResetPmThreshold, slSonetConfigSdThreshold=slSonetConfigSdThreshold, slSonetPos=slSonetPos, slSonetSlTable=slSonetSlTable, slSonetSlFailure=slSonetSlFailure, slSonetPosTable=slSonetPosTable, slSonetTestPulseTime=slSonetTestPulseTime, slSonetResetAlsParams=slSonetResetAlsParams, slSonetFsIfIndex=slSonetFsIfIndex, slSonetManualPulseTime=slSonetManualPulseTime, slSonetAls=slSonetAls, slSonetOh=slSonetOh, slSonetTxLte=slSonetTxLte, slSonetPosFcs=slSonetPosFcs, slSonetAlsMode=slSonetAlsMode, slSonetFsEntry=slSonetFsEntry, slSonetPosEntry=slSonetPosEntry, slSonetConfig=slSonetConfig, slSonetConfigSfThreshold=slSonetConfigSfThreshold, SignalLabel=SignalLabel, slSonetTdmTrunk=slSonetTdmTrunk, slSonetReceivedLte=slSonetReceivedLte, slSonetTraceToTransmit=slSonetTraceToTransmit, slSonetPosMaxViolation=slSonetPosMaxViolation, slSonetFsTableChange=slSonetFsTableChange, slSonetPosPacketReceivedOk=slSonetPosPacketReceivedOk, slSonetFsTable=slSonetFsTable, slSonetTraceTable=slSonetTraceTable, slSonetConfigEntry=slSonetConfigEntry, slSonetConfigFrameScramble=slSonetConfigFrameScramble, slSonetLopBitmask=slSonetLopBitmask, slSonetPosRxfifoDiscard=slSonetPosRxfifoDiscard, slSonetTraps=slSonetTraps, slSonetTraceMode=slSonetTraceMode, slSonetPosAbort=slSonetPosAbort, slSonetFsApply=slSonetFsApply, slSonetFsFullPathTermination=slSonetFsFullPathTermination, slSonetOhTrace=slSonetOhTrace, slSonetAlsEntry=slSonetAlsEntry, slSonetOhTraps=slSonetOhTraps, slSonetLaserManualActivate=slSonetLaserManualActivate, slSonetResetAllCounters=slSonetResetAllCounters, slSonetTransceiverType=slSonetTransceiverType, slSonetConfigType=slSonetConfigType, slSonetTransceiverMedia=slSonetTransceiverMedia, slSonetFsWidth=slSonetFsWidth, slSonetSlReceived=slSonetSlReceived, slSonetPosMinViolation=slSonetPosMinViolation, slSonetSlToTransmit=slSonetSlToTransmit, slSonetPortThresholdTrapEnable=slSonetPortThresholdTrapEnable, slSonetSlEntry=slSonetSlEntry, slSonetAutomaticDelayTime=slSonetAutomaticDelayTime, slSonetTraceFailure=slSonetTraceFailure, slSonetConfigDccSelection=slSonetConfigDccSelection, slSonetCompression=slSonetCompression, slSonetMib=slSonetMib, slSonetOverheadTunneling=slSonetOverheadTunneling, slSonetAlsTable=slSonetAlsTable, slSonetLosDeclareTime=slSonetLosDeclareTime, slSonetAutomaticPulseTime=slSonetAutomaticPulseTime, slSonetTraceEntry=slSonetTraceEntry, slSonetTraceReceived=slSonetTraceReceived, slSonetLaserTestActivate=slSonetLaserTestActivate, slSonetFsGranularity=slSonetFsGranularity, slSonetPosPacketReceived=slSonetPosPacketReceived, slSonetSlToExpect=slSonetSlToExpect)
