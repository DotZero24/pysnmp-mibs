...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:39:09 2025
...
tmnxChassisNotifyHwIndex, tmnxChassisIndex = mibBuilder.importSymbols("TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex", "tmnxChassisIndex")
alcatelCommonMIBModules, alcatelObjects, alcatelNotifyPrefix, alcatelConformance = mibBuilder.importSymbols("TIMETRA-GLOBAL-MIB", "alcatelCommonMIBModules", "alcatelObjects", "alcatelNotifyPrefix", "alcatelConformance")
...
mibBuilder.exportSymbols("ALU-DISCOVERY-MIB", aluDiscoveryFailureFlags=aluDiscoveryFailureFlags, aluDiscoveryComp7705=aluDiscoveryComp7705, aluDiscoveryStarted=aluDiscoveryStarted, aluDiscoverySystemSubnet=aluDiscoverySystemSubnet, aluDiscoveryComp7705V1v0=aluDiscoveryComp7705V1v0, PYSNMP_MODULE_ID=aluDiscoveryMIBModule, AluDiscoveryStage=AluDiscoveryStage, aluDiscoveryEntry=aluDiscoveryEntry, aluDiscoveryEndTime=aluDiscoveryEndTime, aluDiscoveryMIBModule=aluDiscoveryMIBModule, aluDiscoveryGroup=aluDiscoveryGroup, aluDiscoveryStatus=aluDiscoveryStatus, aluDiscoveryNotificationGroup=aluDiscoveryNotificationGroup, aluDiscoveryBofInfo=aluDiscoveryBofInfo, aluDiscoveryLocalCircId=aluDiscoveryLocalCircId, aluDiscoveryTable=aluDiscoveryTable, aluDiscoveryTerminated=aluDiscoveryTerminated, aluDiscoveryGatewayRemId=aluDiscoveryGatewayRemId, aluDiscoveryNotifications=aluDiscoveryNotifications, aluDiscoveryNotificationsPrefix=aluDiscoveryNotificationsPrefix, aluSbiAutoDiscover=aluSbiAutoDiscover, aluDiscoverySuccessful=aluDiscoverySuccessful, aluSbiAutoDiscoverVlan=aluSbiAutoDiscoverVlan, aluDiscoveryMIBConformance=aluDiscoveryMIBConformance, aluDiscoverySystemIpAddr=aluDiscoverySystemIpAddr, aluDiscoveryConformance=aluDiscoveryConformance, AluDiscoveryStatus=AluDiscoveryStatus, aluDiscoveryLocalSubnet=aluDiscoveryLocalSubnet, aluSbiAutoDiscoverId=aluSbiAutoDiscoverId, aluDiscoveryStartTime=aluDiscoveryStartTime, aluDiscoveryServerIpAddr=aluDiscoveryServerIpAddr, aluDiscoveryLocalIpAddr=aluDiscoveryLocalIpAddr, aluDiscoveryStage=aluDiscoveryStage, aluDiscoveryGroups=aluDiscoveryGroups, AluDiscoveryFailureFlags=AluDiscoveryFailureFlags, AluDiscoveryCircuitId=AluDiscoveryCircuitId, aluDiscoveryGatewayIpAddr=aluDiscoveryGatewayIpAddr, aluDiscoveryGatewayCircId=aluDiscoveryGatewayCircId, aluDiscoveryObjs=aluDiscoveryObjs, aluDiscoveryCompliances=aluDiscoveryCompliances)
