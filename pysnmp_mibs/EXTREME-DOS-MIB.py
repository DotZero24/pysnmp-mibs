...
mibBuilder.exportSymbols("EXTREME-DOS-MIB", extremeDosPortTrusted=extremeDosPortTrusted, extremeDosPortTable=extremeDosPortTable, extremeDosThresholdReached=extremeDosThresholdReached, extremeDosNoticeLevel=extremeDosNoticeLevel, extremeDosIsDosActive=extremeDosIsDosActive, extremeDosThresholdCleared=extremeDosThresholdCleared, extremeDosIfIndex=extremeDosIfIndex, extremeDosTrapsPrefix=extremeDosTrapsPrefix, extremeDosAclTimeout=extremeDosAclTimeout, extremeDosPortEntry=extremeDosPortEntry, extremeDosProtect=extremeDosProtect, extremeDosFilterType=extremeDosFilterType, extremeDosAclRulePrecedence=extremeDosAclRulePrecedence, extremeDosEnable=extremeDosEnable, extremeDosTraps=extremeDosTraps, extremeDosMib=extremeDosMib, extremeDosAlertLevel=extremeDosAlertLevel, extremeDosMessagesEnable=extremeDosMessagesEnable, PYSNMP_MODULE_ID=extremeDosMib)
