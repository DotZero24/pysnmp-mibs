...
mibBuilder.exportSymbols("DELLTRAPS-MIB", dellEventWarningTrap=dellEventWarningTrap, dell=dell, dellEventCriticalTrap=dellEventCriticalTrap, dellEventErrorTrap=dellEventErrorTrap, dellEventInfoTrap=dellEventInfoTrap, dellEventResolvedTrap=dellEventResolvedTrap)
