...
# Notes
# -----
# ASN.1 source file://mibs/tplink/TPLINK-DLDP-MIB
...
tpDldpDetectUnidirectionalNeighor = NotificationType(
    (1, 3, 6, 1, 4, 1, 11863, 6, 58, 2, 1)
)
if mibBuilder.loadTexts:
    tpDldpDetectUnidirectionalNeighor.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"tplinkDldpMIB": tplinkDldpMIB,
       ...
       "tpDldpDetectUnidirectionalNeighor": tpDldpDetectUnidirectionalNeighor}
)
