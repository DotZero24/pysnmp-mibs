...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-vlan-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:40:21 2025
...
class _VlanAutoSurveillanceVlanId_Type(Integer32):
    """Custom type vlanAutoSurveillanceVlanId based on Integer32"""
    defaultValue = 0
...
_VlanAutoSurveillanceVlanId_Type.__name__ = "Integer32"
_VlanAutoSurveillanceVlanId_Object = MibScalar
vlanAutoSurveillanceVlanId = _VlanAutoSurveillanceVlanId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 80),
    _VlanAutoSurveillanceVlanId_Type()
)
vlanAutoSurveillanceVlanId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceVlanId.setStatus("current")


class _VlanAutoSurveillanceAdminPriority_Type(VlanPriority):
    """Custom type vlanAutoSurveillanceAdminPriority based on VlanPriority"""
    defaultValue = 5


_VlanAutoSurveillanceAdminPriority_Type.__name__ = "VlanPriority"
_VlanAutoSurveillanceAdminPriority_Object = MibScalar
vlanAutoSurveillanceAdminPriority = _VlanAutoSurveillanceAdminPriority_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 81),
    _VlanAutoSurveillanceAdminPriority_Type()
)
vlanAutoSurveillanceAdminPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceAdminPriority.setStatus("current")


class _VlanAutoSurveillanceAgingTimeout_Type(Integer32):
    """Custom type vlanAutoSurveillanceAgingTimeout based on Integer32"""
    defaultValue = 1440
...
_VlanAutoSurveillanceAgingTimeout_Type.__name__ = "Integer32"
_VlanAutoSurveillanceAgingTimeout_Object = MibScalar
vlanAutoSurveillanceAgingTimeout = _VlanAutoSurveillanceAgingTimeout_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 82),
    _VlanAutoSurveillanceAgingTimeout_Type()
)
vlanAutoSurveillanceAgingTimeout.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceAgingTimeout.setStatus("current")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceAgingTimeout.setUnits("minutes")
_VlanAutoSurveillanceTrafficSourceTable_Object = MibTable
vlanAutoSurveillanceTrafficSourceTable = _VlanAutoSurveillanceTrafficSourceTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 83)
)
if mibBuilder.loadTexts:
    vlanAutoSurveillanceTrafficSourceTable.setStatus("current")
_VlanAutoSurveillanceTrafficSourceEntry_Object = MibTableRow
vlanAutoSurveillanceTrafficSourceEntry = _VlanAutoSurveillanceTrafficSourceEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 83, 1)
)
vlanAutoSurveillanceTrafficSourceEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "vlanAutoSurveillanceTrafficSourceAddress"),
    (0, "CISCOSB-vlan-MIB", "vlanAutoSurveillanceTrafficSourceIsOUI"),
)
if mibBuilder.loadTexts:
    vlanAutoSurveillanceTrafficSourceEntry.setStatus("current")
_VlanAutoSurveillanceTrafficSourceAddress_Type = MacAddress
_VlanAutoSurveillanceTrafficSourceAddress_Object = MibTableColumn
vlanAutoSurveillanceTrafficSourceAddress = _VlanAutoSurveillanceTrafficSourceAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 83, 1, 1),
    _VlanAutoSurveillanceTrafficSourceAddress_Type()
)
vlanAutoSurveillanceTrafficSourceAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceTrafficSourceAddress.setStatus("current")
_VlanAutoSurveillanceTrafficSourceIsOUI_Type = TruthValue
_VlanAutoSurveillanceTrafficSourceIsOUI_Object = MibTableColumn
vlanAutoSurveillanceTrafficSourceIsOUI = _VlanAutoSurveillanceTrafficSourceIsOUI_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 83, 1, 2),
    _VlanAutoSurveillanceTrafficSourceIsOUI_Type()
)
vlanAutoSurveillanceTrafficSourceIsOUI.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceTrafficSourceIsOUI.setStatus("current")


class _VlanAutoSurveillanceTrafficSourceDescription_Type(DisplayString):
    """Custom type vlanAutoSurveillanceTrafficSourceDescription based on DisplayString"""
    defaultValue = OctetString("")
...
_VlanAutoSurveillanceTrafficSourceDescription_Type.__name__ = "DisplayString"
_VlanAutoSurveillanceTrafficSourceDescription_Object = MibTableColumn
vlanAutoSurveillanceTrafficSourceDescription = _VlanAutoSurveillanceTrafficSourceDescription_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 83, 1, 3),
    _VlanAutoSurveillanceTrafficSourceDescription_Type()
)
vlanAutoSurveillanceTrafficSourceDescription.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceTrafficSourceDescription.setStatus("current")
...
vlanAutoSurveillanceTrafficSourceIsActive = _VlanAutoSurveillanceTrafficSourceIsActive_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 83, 1, 4),
    _VlanAutoSurveillanceTrafficSourceIsActive_Type()
)
vlanAutoSurveillanceTrafficSourceIsActive.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceTrafficSourceIsActive.setStatus("current")
...
vlanAutoSurveillanceTrafficSourceInterfaces = _VlanAutoSurveillanceTrafficSourceInterfaces_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 83, 1, 5),
    _VlanAutoSurveillanceTrafficSourceInterfaces_Type()
)
vlanAutoSurveillanceTrafficSourceInterfaces.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceTrafficSourceInterfaces.setStatus("current")
...
vlanAutoSurveillanceTrafficSourceRowStatus = _VlanAutoSurveillanceTrafficSourceRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 83, 1, 6),
    _VlanAutoSurveillanceTrafficSourceRowStatus_Type()
)
vlanAutoSurveillanceTrafficSourceRowStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceTrafficSourceRowStatus.setStatus("current")
_VlanAutoSurveillanceInterfaceTable_Object = MibTable
vlanAutoSurveillanceInterfaceTable = _VlanAutoSurveillanceInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 84)
)
if mibBuilder.loadTexts:
    vlanAutoSurveillanceInterfaceTable.setStatus("current")
_VlanAutoSurveillanceInterfaceEntry_Object = MibTableRow
vlanAutoSurveillanceInterfaceEntry = _VlanAutoSurveillanceInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 84, 1)
)
vlanAutoSurveillanceInterfaceEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    vlanAutoSurveillanceInterfaceEntry.setStatus("current")
_VlanAutoSurveillanceInterfaceEnable_Type = TruthValue
_VlanAutoSurveillanceInterfaceEnable_Object = MibTableColumn
vlanAutoSurveillanceInterfaceEnable = _VlanAutoSurveillanceInterfaceEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 84, 1, 1),
    _VlanAutoSurveillanceInterfaceEnable_Type()
)
vlanAutoSurveillanceInterfaceEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceInterfaceEnable.setStatus("current")
_VlanAutoSurveillanceInterfaceIsActive_Type = TruthValue
_VlanAutoSurveillanceInterfaceIsActive_Object = MibTableColumn
vlanAutoSurveillanceInterfaceIsActive = _VlanAutoSurveillanceInterfaceIsActive_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 84, 1, 2),
    _VlanAutoSurveillanceInterfaceIsActive_Type()
)
vlanAutoSurveillanceInterfaceIsActive.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceInterfaceIsActive.setStatus("current")
_VlanAutoSurveillanceRestoreDefaultOUIs_Type = TruthValue
_VlanAutoSurveillanceRestoreDefaultOUIs_Object = MibScalar
vlanAutoSurveillanceRestoreDefaultOUIs = _VlanAutoSurveillanceRestoreDefaultOUIs_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 85),
    _VlanAutoSurveillanceRestoreDefaultOUIs_Type()
)
vlanAutoSurveillanceRestoreDefaultOUIs.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanAutoSurveillanceRestoreDefaultOUIs.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"VlanMappingTunnelPortType": VlanMappingTunnelPortType,
       ...
       "vlanAutoSurveillanceVlanId": vlanAutoSurveillanceVlanId,
       "vlanAutoSurveillanceAdminPriority": vlanAutoSurveillanceAdminPriority,
       "vlanAutoSurveillanceAgingTimeout": vlanAutoSurveillanceAgingTimeout,
       "vlanAutoSurveillanceTrafficSourceTable": vlanAutoSurveillanceTrafficSourceTable,
       "vlanAutoSurveillanceTrafficSourceEntry": vlanAutoSurveillanceTrafficSourceEntry,
       "vlanAutoSurveillanceTrafficSourceAddress": vlanAutoSurveillanceTrafficSourceAddress,
       "vlanAutoSurveillanceTrafficSourceIsOUI": vlanAutoSurveillanceTrafficSourceIsOUI,
       "vlanAutoSurveillanceTrafficSourceDescription": vlanAutoSurveillanceTrafficSourceDescription,
       "vlanAutoSurveillanceTrafficSourceIsActive": vlanAutoSurveillanceTrafficSourceIsActive,
       "vlanAutoSurveillanceTrafficSourceInterfaces": vlanAutoSurveillanceTrafficSourceInterfaces,
       "vlanAutoSurveillanceTrafficSourceRowStatus": vlanAutoSurveillanceTrafficSourceRowStatus,
       "vlanAutoSurveillanceInterfaceTable": vlanAutoSurveillanceInterfaceTable,
       "vlanAutoSurveillanceInterfaceEntry": vlanAutoSurveillanceInterfaceEntry,
       "vlanAutoSurveillanceInterfaceEnable": vlanAutoSurveillanceInterfaceEnable,
       "vlanAutoSurveillanceInterfaceIsActive": vlanAutoSurveillanceInterfaceIsActive,
       "vlanAutoSurveillanceRestoreDefaultOUIs": vlanAutoSurveillanceRestoreDefaultOUIs}
)
