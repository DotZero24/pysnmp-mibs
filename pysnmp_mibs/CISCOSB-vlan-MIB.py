...
switch001, VlanPriority = mibBuilder.importSymbols("CISCOSB-MIB", "switch001", "VlanPriority")
...
mibBuilder.exportSymbols("CISCOSB-vlan-MIB", vlanMacBaseVlanGroupEntry=vlanMacBaseVlanGroupEntry, vlanMappingTunnelEdgePortConfigForwardSTP=vlanMappingTunnelEdgePortConfigForwardSTP, vlanPrivateTableOld=vlanPrivateTableOld, vlanMappingTunnelNniPortConfigRowStatus=vlanMappingTunnelNniPortConfigRowStatus, vlanMappingTunnelEdgePortRowStatus=vlanMappingTunnelEdgePortRowStatus, vlanTrunkModeList1025to2048=vlanTrunkModeList1025to2048, rldot1qPortVlanStaticForbiddenList1to1024=rldot1qPortVlanStaticForbiddenList1to1024, vlanDynamicVlanMacAddress=vlanDynamicVlanMacAddress, vlanPrivateMapPrimaryVid=vlanPrivateMapPrimaryVid, vlanTriplePlayTable=vlanTriplePlayTable, vlanTrunkPortModeNativeVlanId=vlanTrunkPortModeNativeVlanId, vlanAutoSurveillanceInterfaceTable=vlanAutoSurveillanceInterfaceTable, vlanPrivateEdgeGroupIfIndexDomainID=vlanPrivateEdgeGroupIfIndexDomainID, vlanPrivateMapPrimaryOperPorts=vlanPrivateMapPrimaryOperPorts, vlanPrivatePrimaryVid=vlanPrivatePrimaryVid, rldot1qPortVlanStaticUntaggedEgressList3073to4094=rldot1qPortVlanStaticUntaggedEgressList3073to4094, vlanPrivateEdgeTable=vlanPrivateEdgeTable, vlanPortModeExtTable=vlanPortModeExtTable, vlanPrivateMapStatus=vlanPrivateMapStatus, vlanMibVersion=vlanMibVersion, vlanPrivateEdgeUplink=vlanPrivateEdgeUplink, VlanMappingTunnelPortMode=VlanMappingTunnelPortMode, PYSNMP_MODULE_ID=vlan, rldot1qVlanStaticList1025to2048=rldot1qVlanStaticList1025to2048, vlanPrivateEdgeGroupStatus=vlanPrivateEdgeGroupStatus, vlanRsvlMapSecondaryVid=vlanRsvlMapSecondaryVid, vlanAutoSurveillanceVlanId=vlanAutoSurveillanceVlanId, rlPortVlanTriplePlayMulticastTvList2049to3072=rlPortVlanTriplePlayMulticastTvList2049to3072, vlanAutoSurveillanceTrafficSourceIsOUI=vlanAutoSurveillanceTrafficSourceIsOUI, vlanPrivateMapTable=vlanPrivateMapTable, vlanAutoSurveillanceTrafficSourceTable=vlanAutoSurveillanceTrafficSourceTable, vlanPortModeExtEntry=vlanPortModeExtEntry, vlanMulticastTvEntry=vlanMulticastTvEntry, vlanSubnetPortGroupVid=vlanSubnetPortGroupVid, vlanVoiceRowStatus=vlanVoiceRowStatus, rldot1qVlanMembershipTypeBitmap=rldot1qVlanMembershipTypeBitmap, vlanSpecialTagCurrentEntry=vlanSpecialTagCurrentEntry, vlanPrivateEntryOld=vlanPrivateEntryOld, vlanAccessPortModeEntry=vlanAccessPortModeEntry, vlanMappingTunnelEdgePortActionConfig=vlanMappingTunnelEdgePortActionConfig, vlanPrivateMapSecondaryOperPorts=vlanPrivateMapSecondaryOperPorts, vlanPortModeEntry=vlanPortModeEntry, vlanSpecialTagTable=vlanSpecialTagTable, vlanAutoSurveillanceTrafficSourceDescription=vlanAutoSurveillanceTrafficSourceDescription, vlanMacBaseVlanPortGroupId=vlanMacBaseVlanPortGroupId, vlanPrivateEdgeVersion=vlanPrivateEdgeVersion, vlanPrivateTable=vlanPrivateTable, vlanSubnetPortEntry=vlanSubnetPortEntry, vlanCustomerPortModeTable=vlanCustomerPortModeTable, vlanVoiceOUITable=vlanVoiceOUITable, vlanMappingOneToOneEdgePortRowStatus=vlanMappingOneToOneEdgePortRowStatus, vlanPrivateEdgeGroupIfIndexID=vlanPrivateEdgeGroupIfIndexID, vlanDefault=vlanDefault, vlanInetTriplePlayRowStatus=vlanInetTriplePlayRowStatus, vlanVoiceOUIEntry=vlanVoiceOUIEntry, vlanMappingTunnelEdgePortConfigVlanId=vlanMappingTunnelEdgePortConfigVlanId, vlanMappingTunnelEdgePortConfigCos=vlanMappingTunnelEdgePortConfigCos, vlanSpecialTagCurrentActive=vlanSpecialTagCurrentActive, vlanSpecialTagEntry=vlanSpecialTagEntry, vlanPrivateEdgeStatus=vlanPrivateEdgeStatus, vlanMacBaseVlanPortEntry=vlanMacBaseVlanPortEntry, vlanSwitchPortModeCategory=vlanSwitchPortModeCategory, vlanTrunkModeList1to1024=vlanTrunkModeList1to1024, vlanAccessPortModeMcstTvVlanId=vlanAccessPortModeMcstTvVlanId, vlanPrivateStatus=vlanPrivateStatus, vlanMappingTunnelNniPortConfigTable=vlanMappingTunnelNniPortConfigTable, vlanSubnetPortGroupId=vlanSubnetPortGroupId, vlanPortModeExtStatus=vlanPortModeExtStatus, vlanDefaultEnabledPorts=vlanDefaultEnabledPorts, rldot1qVlanMembershipTypeTable=rldot1qVlanMembershipTypeTable, vlanAutoSurveillanceTrafficSourceAddress=vlanAutoSurveillanceTrafficSourceAddress, vlanInetTriplePlayEntry=vlanInetTriplePlayEntry, vlanMacBaseVlanPortTable=vlanMacBaseVlanPortTable, vlanMaxTableNumber=vlanMaxTableNumber, vlanVoiceEntry=vlanVoiceEntry, vlanSpecialTagCurrentTable=vlanSpecialTagCurrentTable, vlanVoiceTable=vlanVoiceTable, vlanMacBaseVlanMacMask=vlanMacBaseVlanMacMask, vlanRsvlEnable=vlanRsvlEnable, vlanMacBaseVlanGroupRowStatus=vlanMacBaseVlanGroupRowStatus, vlanInetTriplePlayTable=vlanInetTriplePlayTable, vlanDefaultTaggedPorts=vlanDefaultTaggedPorts, vlanAutoSurveillanceAgingTimeout=vlanAutoSurveillanceAgingTimeout, vlanTrunkPortModeTable=vlanTrunkPortModeTable, vlanAutoSurveillanceTrafficSourceIsActive=vlanAutoSurveillanceTrafficSourceIsActive, vlanMappingOneToOneEdgePortCVlanTag=vlanMappingOneToOneEdgePortCVlanTag, vlanMappingTunnelEdgePortConfigShutdownThreshold=vlanMappingTunnelEdgePortConfigShutdownThreshold, vlanPrivateEdgeGroupIfIndexTable=vlanPrivateEdgeGroupIfIndexTable, vlanTriplePlayInnerVID=vlanTriplePlayInnerVID, vlanMappingTunnelEdgePortConfigForwardVTP=vlanMappingTunnelEdgePortConfigForwardVTP, vlanPrivateEdgeGroupIfIndexEntry=vlanPrivateEdgeGroupIfIndexEntry, vlanTriplePlayRowStatus=vlanTriplePlayRowStatus, vlanTrunkModeList2049to3072=vlanTrunkModeList2049to3072, vlanPortModeExtState=vlanPortModeExtState, vlanVoiceAgingTimeout=vlanVoiceAgingTimeout, rlPortVlanTriplePlayMulticastTvTable=rlPortVlanTriplePlayMulticastTvTable, vlanPrivateEdgeGroupUplink=vlanPrivateEdgeGroupUplink, vlanSubnetPortTable=vlanSubnetPortTable, rldot1qVlanStaticList2049to3072=rldot1qVlanStaticList2049to3072, vlanPrivateEdgeGroupSource=vlanPrivateEdgeGroupSource, rldot1qVlanMembershipTypeEntry=rldot1qVlanMembershipTypeEntry, vlanVoicePortCurrentMembership=vlanVoicePortCurrentMembership, vlanMappingTunnelEdgePortConfigDropThreshold=vlanMappingTunnelEdgePortConfigDropThreshold, vlanTrunkModeList3073to4094=vlanTrunkModeList3073to4094, vlanMappingOneToOneEdgePortEntry=vlanMappingOneToOneEdgePortEntry, vlanPrivateEdgeGroupEntry=vlanPrivateEdgeGroupEntry, rldot1qPortVlanStaticForbiddenList3073to4094=rldot1qPortVlanStaticForbiddenList3073to4094, vlanPrivateCommunityTable=vlanPrivateCommunityTable, VlanMappingDefaultConfigMode=VlanMappingDefaultConfigMode, vlanInetTriplePlayInnerVID=vlanInetTriplePlayInnerVID, vlanAccessPortModeTable=vlanAccessPortModeTable, vlanMappingEthType=vlanMappingEthType, vlanDynamicVlanSupported=vlanDynamicVlanSupported, vlanDynamicVlanEntry=vlanDynamicVlanEntry, vlanPrivateCommunityStatus=vlanPrivateCommunityStatus, vlanDot1vSupported=vlanDot1vSupported, vlanDefaultExtManagment=vlanDefaultExtManagment, vlanVoicePortTable=vlanVoicePortTable, vlanTriplePlayMulticastTvMulticastTvPortList=vlanTriplePlayMulticastTvMulticastTvPortList, VlanMappingActionConfigMode=VlanMappingActionConfigMode, vlanPortModeContextTable=vlanPortModeContextTable, vlanAutoSurveillanceTrafficSourceRowStatus=vlanAutoSurveillanceTrafficSourceRowStatus, vlanVoicePriorityRemark=vlanVoicePriorityRemark, vlan=vlan, vlanVoicePriority=vlanVoicePriority, vlanMacBaseVlanGroupId=vlanMacBaseVlanGroupId, vlanInetTriplePlayMulticastTvMulticastTvVID=vlanInetTriplePlayMulticastTvMulticastTvVID, vlanAutoSurveillanceTrafficSourceEntry=vlanAutoSurveillanceTrafficSourceEntry, vlanRsvlMapEntry=vlanRsvlMapEntry, vlanNameTag=vlanNameTag, vlanSpecialTagCurrentReserved=vlanSpecialTagCurrentReserved, vlanTriplePlayMulticastTvTable=vlanTriplePlayMulticastTvTable, vlanMappingCosValue=vlanMappingCosValue, vlanVoicePortEnable=vlanVoicePortEnable, vlanInetTriplePlayMulticatTvEntry=vlanInetTriplePlayMulticatTvEntry, vlanSpecialTagStatus=vlanSpecialTagStatus, rlPortVlanTriplePlayMulticastTvList1to1024=rlPortVlanTriplePlayMulticastTvList1to1024, rlRspanRemoteVlan=rlRspanRemoteVlan, vlanMappingTunnelNniPortConfigEntry=vlanMappingTunnelNniPortConfigEntry, vlanMappingTunnelEdgePortConfigTable=vlanMappingTunnelEdgePortConfigTable, vlanMappingTunnelEdgePortCVlanTag=vlanMappingTunnelEdgePortCVlanTag, vlanAutoSurveillanceInterfaceIsActive=vlanAutoSurveillanceInterfaceIsActive, vlanMappingTunnelEdgePortDefaultConfig=vlanMappingTunnelEdgePortDefaultConfig, vlanMulticastTvTable=vlanMulticastTvTable, vlanMulticastTvStatus=vlanMulticastTvStatus, vlanDynamicVlanTable=vlanDynamicVlanTable, rldot1qPortVlanStaticEgressList1to1024=rldot1qPortVlanStaticEgressList1to1024, vlanMappingOneToOneEdgePortSVlanTag=vlanMappingOneToOneEdgePortSVlanTag, vlanPrivateCommunityVlanTag=vlanPrivateCommunityVlanTag, vlanRsvlMapTable=vlanRsvlMapTable, vlanMacBaseVlanPortGroupVid=vlanMacBaseVlanPortGroupVid, vlanPrivateEdgeEntry=vlanPrivateEdgeEntry, vlanCustomerPortModeVlanId=vlanCustomerPortModeVlanId, vlanPrivateType=vlanPrivateType, vlanTriplePlayMulticatTvEntry=vlanTriplePlayMulticatTvEntry, vlanPortModeState=vlanPortModeState, vlanAccessPortModeVlanId=vlanAccessPortModeVlanId, rldot1qVlanStaticListIndex=rldot1qVlanStaticListIndex, vlanSubnetRangeEntry=vlanSubnetRangeEntry, rldot1qPortVlanStaticEgressList3073to4094=rldot1qPortVlanStaticEgressList3073to4094, vlanVoicePortVlanIndex=vlanVoicePortVlanIndex, vlanRsvlMapStatus=vlanRsvlMapStatus, rlPortVlanTriplePlayMulticastTvList1025to2048=rlPortVlanTriplePlayMulticastTvList1025to2048, vlanInetTriplePlayMulticastTvMulticastTvPortList=vlanInetTriplePlayMulticastTvMulticastTvPortList, vlanTriplePlayEntry=vlanTriplePlayEntry, rlPortVlanTriplePlayMulticastTvEntry=rlPortVlanTriplePlayMulticastTvEntry, vlanPrivateOldIsolatedVlanTag=vlanPrivateOldIsolatedVlanTag, vlanCustomerPortModeMtvList1025to2048=vlanCustomerPortModeMtvList1025to2048, vlanPortModeTable=vlanPortModeTable, vlanCustomerPortModeMtvList2049to3072=vlanCustomerPortModeMtvList2049to3072, vlanMacBaseVlanPortRowStatus=vlanMacBaseVlanPortRowStatus, vlanSpecialTagVID=vlanSpecialTagVID, vlanVoicePortEntry=vlanVoicePortEntry, rldot1qPortVlanStaticUntaggedEgressList1to1024=rldot1qPortVlanStaticUntaggedEgressList1to1024, vlanAutoSurveillanceAdminPriority=vlanAutoSurveillanceAdminPriority, vlanMappingOneToOneEdgePortIsActiveEdge=vlanMappingOneToOneEdgePortIsActiveEdge, vlanSubnetPortRowStatus=vlanSubnetPortRowStatus, vlanTriplePlayMulticastTvMulticastTvVID=vlanTriplePlayMulticastTvMulticastTvVID, vlanPrivateMapEntry=vlanPrivateMapEntry, vlanSubnetRangeGroupId=vlanSubnetRangeGroupId, vlanPrivateMapSecondaryPorts=vlanPrivateMapSecondaryPorts, rldot1qVlanStaticName=rldot1qVlanStaticName, vlanPrivateOldStatus=vlanPrivateOldStatus, vlanNameTable=vlanNameTable, vlanPrivateVid=vlanPrivateVid, vlanCustomerPortModeEntry=vlanCustomerPortModeEntry, vlanPrivateCommunityEntry=vlanPrivateCommunityEntry, vlanDefaultEnabled=vlanDefaultEnabled, vlanCustomerPortModeMtvList1to1024=vlanCustomerPortModeMtvList1to1024, rldot1qPortVlanStaticEgressList1025to2048=rldot1qPortVlanStaticEgressList1025to2048, rldot1qPortVlanStaticEgressList2049to3072=rldot1qPortVlanStaticEgressList2049to3072, vlanMappingTunnelEdgePortConfigEntry=vlanMappingTunnelEdgePortConfigEntry, vlanMappingTunnelEdgePortSVlanTag=vlanMappingTunnelEdgePortSVlanTag, vlanMappingTunnelEdgePortMapMode=vlanMappingTunnelEdgePortMapMode, vlanAutoSurveillanceTrafficSourceInterfaces=vlanAutoSurveillanceTrafficSourceInterfaces, vlanMappingTunnelEdgePortConfigForwardLLDP=vlanMappingTunnelEdgePortConfigForwardLLDP, rldot1qPortVlanStaticEntry=rldot1qPortVlanStaticEntry, vlanSubnetRangeAddr=vlanSubnetRangeAddr, vlanCustomerPortModeMtvList3073to4094=vlanCustomerPortModeMtvList3073to4094, vlanSendUnknownToAllPorts=vlanSendUnknownToAllPorts, vlanNameEntry=vlanNameEntry, vlanVoice=vlanVoice, vlanPrivateSupported=vlanPrivateSupported, vlanPrivateEdgeGroupTable=vlanPrivateEdgeGroupTable, vlanPrivateMapSecondaryVid=vlanPrivateMapSecondaryVid, vlanVoicePortSecure=vlanVoicePortSecure, vlanMulticastTvVID=vlanMulticastTvVID, vlanNameName=vlanNameName, vlanDynamicVlanTag=vlanDynamicVlanTag, vlanAutoSurveillanceInterfaceEntry=vlanAutoSurveillanceInterfaceEntry, vlanAsymmetricEnabled=vlanAsymmetricEnabled, vlanMappingTunnelNniPortConfigEthTypeValue=vlanMappingTunnelNniPortConfigEthTypeValue, vlanVoiceOUIEntryRowStatus=vlanVoiceOUIEntryRowStatus, vlanPortModeContextValue=vlanPortModeContextValue, rldot1qVlanStaticNameTable=rldot1qVlanStaticNameTable, rldot1qVlanStaticList1to1024=rldot1qVlanStaticList1to1024, rldot1qPortVlanStaticUntaggedEgressList2049to3072=rldot1qPortVlanStaticUntaggedEgressList2049to3072, rldot1qVlanStaticNameEntry=rldot1qVlanStaticNameEntry, vlanMappingTunnelEdgePortIsActiveEdge=vlanMappingTunnelEdgePortIsActiveEdge, rldot1qPortVlanStaticTable=rldot1qPortVlanStaticTable, vlanSubnetRangeTable=vlanSubnetRangeTable, vlanPrivateMapPrimaryPorts=vlanPrivateMapPrimaryPorts, vlanAutoSurveillanceInterfaceEnable=vlanAutoSurveillanceInterfaceEnable, vlanInetTriplePlayMulticastTvVID=vlanInetTriplePlayMulticastTvVID, vlanMacBaseVlanMacAddress=vlanMacBaseVlanMacAddress, VlanMappingTunnelPortType=VlanMappingTunnelPortType, vlanVoicePortQosMode=vlanVoicePortQosMode, vlanSubnetRangeRowStatus=vlanSubnetRangeRowStatus, rldot1qVlanStaticList3073to4094=rldot1qVlanStaticList3073to4094, vlanPrivateEdgeSupported=vlanPrivateEdgeSupported, rldot1qPortVlanStaticForbiddenList2049to3072=rldot1qPortVlanStaticForbiddenList2049to3072, vlanMacBaseVlanGroupTable=vlanMacBaseVlanGroupTable, vlanVoiceOUIDescription=vlanVoiceOUIDescription, vlanInetTriplePlayMulticastTvTable=vlanInetTriplePlayMulticastTvTable, vlanVoiceOUISetToDefault=vlanVoiceOUISetToDefault, vlanSpecialTagCurrentVID=vlanSpecialTagCurrentVID, vlanDynamicVlanStatus=vlanDynamicVlanStatus, vlanDefaultSupported=vlanDefaultSupported, vlanSubnetRangeMask=vlanSubnetRangeMask, vlanMappingOneToOneEdgePortTable=vlanMappingOneToOneEdgePortTable, rldot1qPortVlanStaticUntaggedEgressList1025to2048=rldot1qPortVlanStaticUntaggedEgressList1025to2048, vlanMappingTunnelEdgePortTable=vlanMappingTunnelEdgePortTable, vlanNameIfIndex=vlanNameIfIndex, rlPortVlanTriplePlayMulticastTvList3073to4094=rlPortVlanTriplePlayMulticastTvList3073to4094, vlanSwitchPortModeTable=vlanSwitchPortModeTable, vlanSwitchPortModeEntry=vlanSwitchPortModeEntry, vlanVoiceOUIPrefix=vlanVoiceOUIPrefix, vlanInetTriplePlayInetAddressType=vlanInetTriplePlayInetAddressType, vlanPrivateEntry=vlanPrivateEntry, vlanRsvlMapPrimaryVid=vlanRsvlMapPrimaryVid, rldot1qVlanStaticListTable=rldot1qVlanStaticListTable, vlanTrunkPortModeEntry=vlanTrunkPortModeEntry, rldot1qVlanStaticListEntry=rldot1qVlanStaticListEntry, vlanAutoSurveillanceRestoreDefaultOUIs=vlanAutoSurveillanceRestoreDefaultOUIs)
mibBuilder.exportSymbols("CISCOSB-vlan-MIB", vlanMappingTunnelEdgePortEntry=vlanMappingTunnelEdgePortEntry, rldot1qPortVlanStaticForbiddenList1025to2048=rldot1qPortVlanStaticForbiddenList1025to2048, vlanMappingTunnelEdgePortConfigForwardCDP=vlanMappingTunnelEdgePortConfigForwardCDP, vlanTriplePlayMulticastTvVID=vlanTriplePlayMulticastTvVID, vlanPortModeContextEntry=vlanPortModeContextEntry)
