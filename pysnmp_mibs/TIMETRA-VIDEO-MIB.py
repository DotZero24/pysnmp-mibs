...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-VIDEO-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:59:00 2025
...
class _TmnxVdoIfIngressIpFilterId_Type(TFilterID):
    """Custom type tmnxVdoIfIngressIpFilterId based on TFilterID"""
    defaultValue = 0


_TmnxVdoIfIngressIpFilterId_Type.__name__ = "TFilterID"
...
class _TmnxVdoIfIngressMacFilterId_Type(TFilterID):
    """Custom type tmnxVdoIfIngressMacFilterId based on TFilterID"""
    defaultValue = 0


_TmnxVdoIfIngressMacFilterId_Type.__name__ = "TFilterID"
...
class _TmnxVdoIfEgressIpFilterId_Type(TFilterID):
    """Custom type tmnxVdoIfEgressIpFilterId based on TFilterID"""
    defaultValue = 0


_TmnxVdoIfEgressIpFilterId_Type.__name__ = "TFilterID"
...
class _TmnxVdoIfEgressMacFilterId_Type(TFilterID):
    """Custom type tmnxVdoIfEgressMacFilterId based on TFilterID"""
    defaultValue = 0


_TmnxVdoIfEgressMacFilterId_Type.__name__ = "TFilterID"
...
if mibBuilder.loadTexts:
    tmnxVdoGrpResvRet.setUnits("megabps")
...
class _TmnxVdoGrpEnableRtClient_Type(TruthValue):
    """Custom type tmnxVdoGrpEnableRtClient based on TruthValue"""
    defaultValue = 1


_TmnxVdoGrpEnableRtClient_Type.__name__ = "TruthValue"
_TmnxVdoGrpEnableRtClient_Object = MibTableColumn
tmnxVdoGrpEnableRtClient = _TmnxVdoGrpEnableRtClient_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 3, 1, 13),
    _TmnxVdoGrpEnableRtClient_Type()
)
tmnxVdoGrpEnableRtClient.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVdoGrpEnableRtClient.setStatus("current")


class _TmnxVdoGrpWmBwFcc_Type(TmnxWmPercent):
    """Custom type tmnxVdoGrpWmBwFcc based on TmnxWmPercent"""
    defaultValue = 90


_TmnxVdoGrpWmBwFcc_Type.__name__ = "TmnxWmPercent"
_TmnxVdoGrpWmBwFcc_Object = MibTableColumn
tmnxVdoGrpWmBwFcc = _TmnxVdoGrpWmBwFcc_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 3, 1, 14),
    _TmnxVdoGrpWmBwFcc_Type()
)
tmnxVdoGrpWmBwFcc.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmBwFcc.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmBwFcc.setUnits("percent")


class _TmnxVdoGrpWmBwRet_Type(TmnxWmPercent):
    """Custom type tmnxVdoGrpWmBwRet based on TmnxWmPercent"""
    defaultValue = 90


_TmnxVdoGrpWmBwRet_Type.__name__ = "TmnxWmPercent"
_TmnxVdoGrpWmBwRet_Object = MibTableColumn
tmnxVdoGrpWmBwRet = _TmnxVdoGrpWmBwRet_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 3, 1, 15),
    _TmnxVdoGrpWmBwRet_Type()
)
tmnxVdoGrpWmBwRet.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmBwRet.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmBwRet.setUnits("percent")


class _TmnxVdoGrpWmBwTotal_Type(TmnxWmPercent):
    """Custom type tmnxVdoGrpWmBwTotal based on TmnxWmPercent"""
    defaultValue = 90


_TmnxVdoGrpWmBwTotal_Type.__name__ = "TmnxWmPercent"
_TmnxVdoGrpWmBwTotal_Object = MibTableColumn
tmnxVdoGrpWmBwTotal = _TmnxVdoGrpWmBwTotal_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 3, 1, 16),
    _TmnxVdoGrpWmBwTotal_Type()
)
tmnxVdoGrpWmBwTotal.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmBwTotal.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmBwTotal.setUnits("percent")


class _TmnxVdoGrpWmSesFcc_Type(TmnxWmPercent):
    """Custom type tmnxVdoGrpWmSesFcc based on TmnxWmPercent"""
    defaultValue = 90


_TmnxVdoGrpWmSesFcc_Type.__name__ = "TmnxWmPercent"
_TmnxVdoGrpWmSesFcc_Object = MibTableColumn
tmnxVdoGrpWmSesFcc = _TmnxVdoGrpWmSesFcc_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 3, 1, 17),
    _TmnxVdoGrpWmSesFcc_Type()
)
tmnxVdoGrpWmSesFcc.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmSesFcc.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmSesFcc.setUnits("percent")


class _TmnxVdoGrpWmSesRet_Type(TmnxWmPercent):
    """Custom type tmnxVdoGrpWmSesRet based on TmnxWmPercent"""
    defaultValue = 90


_TmnxVdoGrpWmSesRet_Type.__name__ = "TmnxWmPercent"
_TmnxVdoGrpWmSesRet_Object = MibTableColumn
tmnxVdoGrpWmSesRet = _TmnxVdoGrpWmSesRet_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 3, 1, 18),
    _TmnxVdoGrpWmSesRet_Type()
)
tmnxVdoGrpWmSesRet.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmSesRet.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmSesRet.setUnits("percent")


class _TmnxVdoGrpWmSesTotal_Type(TmnxWmPercent):
    """Custom type tmnxVdoGrpWmSesTotal based on TmnxWmPercent"""
    defaultValue = 90


_TmnxVdoGrpWmSesTotal_Type.__name__ = "TmnxWmPercent"
_TmnxVdoGrpWmSesTotal_Object = MibTableColumn
tmnxVdoGrpWmSesTotal = _TmnxVdoGrpWmSesTotal_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 3, 1, 19),
    _TmnxVdoGrpWmSesTotal_Type()
)
tmnxVdoGrpWmSesTotal.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmSesTotal.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpWmSesTotal.setUnits("percent")
...
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaBwInUse.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaBwPeak.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaCurTotalRetBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakRetBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaCurFccBw.setUnits("kilobps")
...
_TmnxVdoGrpMdaPeakFccBw_Type = Gauge32
_TmnxVdoGrpMdaPeakFccBw_Object = MibTableColumn
tmnxVdoGrpMdaPeakFccBw = _TmnxVdoGrpMdaPeakFccBw_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 67),
    _TmnxVdoGrpMdaPeakFccBw_Type()
)
tmnxVdoGrpMdaPeakFccBw.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakFccBw.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakFccBw.setUnits("kilobps")
_TmnxVdoGrpMdaPeakFccBwTime_Type = TimeStamp
_TmnxVdoGrpMdaPeakFccBwTime_Object = MibTableColumn
tmnxVdoGrpMdaPeakFccBwTime = _TmnxVdoGrpMdaPeakFccBwTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 68),
    _TmnxVdoGrpMdaPeakFccBwTime_Type()
)
tmnxVdoGrpMdaPeakFccBwTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakFccBwTime.setStatus("current")
_TmnxVdoGrpMdaPeakAbsRetBw_Type = Gauge32
_TmnxVdoGrpMdaPeakAbsRetBw_Object = MibTableColumn
tmnxVdoGrpMdaPeakAbsRetBw = _TmnxVdoGrpMdaPeakAbsRetBw_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 69),
    _TmnxVdoGrpMdaPeakAbsRetBw_Type()
)
tmnxVdoGrpMdaPeakAbsRetBw.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakAbsRetBw.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakAbsRetBw.setUnits("kilobps")
_TmnxVdoGrpMdaPeakAbsRetBwTime_Type = TimeStamp
_TmnxVdoGrpMdaPeakAbsRetBwTime_Object = MibTableColumn
tmnxVdoGrpMdaPeakAbsRetBwTime = _TmnxVdoGrpMdaPeakAbsRetBwTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 70),
    _TmnxVdoGrpMdaPeakAbsRetBwTime_Type()
)
tmnxVdoGrpMdaPeakAbsRetBwTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakAbsRetBwTime.setStatus("current")
_TmnxVdoGrpMdaPeakFccSession_Type = Gauge32
_TmnxVdoGrpMdaPeakFccSession_Object = MibTableColumn
tmnxVdoGrpMdaPeakFccSession = _TmnxVdoGrpMdaPeakFccSession_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 71),
    _TmnxVdoGrpMdaPeakFccSession_Type()
)
tmnxVdoGrpMdaPeakFccSession.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakFccSession.setStatus("current")
_TmnxVdoGrpMdaPeakFccSessionTime_Type = TimeStamp
_TmnxVdoGrpMdaPeakFccSessionTime_Object = MibTableColumn
tmnxVdoGrpMdaPeakFccSessionTime = _TmnxVdoGrpMdaPeakFccSessionTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 72),
    _TmnxVdoGrpMdaPeakFccSessionTime_Type()
)
tmnxVdoGrpMdaPeakFccSessionTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakFccSessionTime.setStatus("current")
_TmnxVdoGrpMdaPeakRetSession_Type = Gauge32
_TmnxVdoGrpMdaPeakRetSession_Object = MibTableColumn
tmnxVdoGrpMdaPeakRetSession = _TmnxVdoGrpMdaPeakRetSession_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 73),
    _TmnxVdoGrpMdaPeakRetSession_Type()
)
tmnxVdoGrpMdaPeakRetSession.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakRetSession.setStatus("current")
_TmnxVdoGrpMdaPeakRetSessionTime_Type = TimeStamp
_TmnxVdoGrpMdaPeakRetSessionTime_Object = MibTableColumn
tmnxVdoGrpMdaPeakRetSessionTime = _TmnxVdoGrpMdaPeakRetSessionTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 74),
    _TmnxVdoGrpMdaPeakRetSessionTime_Type()
)
tmnxVdoGrpMdaPeakRetSessionTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakRetSessionTime.setStatus("current")
_TmnxVdoGrpMdaPeakFccRetTotBw_Type = Gauge32
_TmnxVdoGrpMdaPeakFccRetTotBw_Object = MibTableColumn
tmnxVdoGrpMdaPeakFccRetTotBw = _TmnxVdoGrpMdaPeakFccRetTotBw_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 75),
    _TmnxVdoGrpMdaPeakFccRetTotBw_Type()
)
tmnxVdoGrpMdaPeakFccRetTotBw.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakFccRetTotBw.setStatus("current")
_TmnxVdoGrpMdaPeakFccRetTotBwTime_Type = TimeStamp
_TmnxVdoGrpMdaPeakFccRetTotBwTime_Object = MibTableColumn
tmnxVdoGrpMdaPeakFccRetTotBwTime = _TmnxVdoGrpMdaPeakFccRetTotBwTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 76),
    _TmnxVdoGrpMdaPeakFccRetTotBwTime_Type()
)
tmnxVdoGrpMdaPeakFccRetTotBwTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakFccRetTotBwTime.setStatus("current")
_TmnxVdoGrpMdaPeakFccRetTotSess_Type = Gauge32
_TmnxVdoGrpMdaPeakFccRetTotSess_Object = MibTableColumn
tmnxVdoGrpMdaPeakFccRetTotSess = _TmnxVdoGrpMdaPeakFccRetTotSess_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 77),
    _TmnxVdoGrpMdaPeakFccRetTotSess_Type()
)
tmnxVdoGrpMdaPeakFccRetTotSess.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakFccRetTotSess.setStatus("current")
_TmnxVdoGrpMdaPeakFccRetTotSeTime_Type = TimeStamp
_TmnxVdoGrpMdaPeakFccRetTotSeTime_Object = MibTableColumn
tmnxVdoGrpMdaPeakFccRetTotSeTime = _TmnxVdoGrpMdaPeakFccRetTotSeTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 78),
    _TmnxVdoGrpMdaPeakFccRetTotSeTime_Type()
)
tmnxVdoGrpMdaPeakFccRetTotSeTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaPeakFccRetTotSeTime.setStatus("current")
_TmnxVdoGrpMdaCurAbsRetBw_Type = Gauge32
_TmnxVdoGrpMdaCurAbsRetBw_Object = MibTableColumn
tmnxVdoGrpMdaCurAbsRetBw = _TmnxVdoGrpMdaCurAbsRetBw_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 79),
    _TmnxVdoGrpMdaCurAbsRetBw_Type()
)
tmnxVdoGrpMdaCurAbsRetBw.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaCurAbsRetBw.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaCurAbsRetBw.setUnits("kilobps")
_TmnxVdoGrpMdaCurFccRetTotalBw_Type = Gauge32
_TmnxVdoGrpMdaCurFccRetTotalBw_Object = MibTableColumn
tmnxVdoGrpMdaCurFccRetTotalBw = _TmnxVdoGrpMdaCurFccRetTotalBw_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 80),
    _TmnxVdoGrpMdaCurFccRetTotalBw_Type()
)
tmnxVdoGrpMdaCurFccRetTotalBw.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaCurFccRetTotalBw.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaCurFccRetTotalBw.setUnits("kilobps")
_TmnxVdoGrpMdaActFccSess_Type = Gauge32
_TmnxVdoGrpMdaActFccSess_Object = MibTableColumn
tmnxVdoGrpMdaActFccSess = _TmnxVdoGrpMdaActFccSess_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 81),
    _TmnxVdoGrpMdaActFccSess_Type()
)
tmnxVdoGrpMdaActFccSess.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaActFccSess.setStatus("current")
_TmnxVdoGrpMdaActRetSess_Type = Gauge32
_TmnxVdoGrpMdaActRetSess_Object = MibTableColumn
tmnxVdoGrpMdaActRetSess = _TmnxVdoGrpMdaActRetSess_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 82),
    _TmnxVdoGrpMdaActRetSess_Type()
)
tmnxVdoGrpMdaActRetSess.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaActRetSess.setStatus("current")
_TmnxVdoGrpMdaActFccRetTotalSess_Type = Gauge32
_TmnxVdoGrpMdaActFccRetTotalSess_Object = MibTableColumn
tmnxVdoGrpMdaActFccRetTotalSess = _TmnxVdoGrpMdaActFccRetTotalSess_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 61, 1, 4, 1, 83),
    _TmnxVdoGrpMdaActFccRetTotalSess_Type()
)
tmnxVdoGrpMdaActFccRetTotalSess.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVdoGrpMdaActFccRetTotalSess.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxVdoGrpSrcAdminBW.setUnits("kilobps")
...
class _TmnxVdoGrpSrcRTClientPort_Type(Unsigned32):
    ...
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(6000, 7451),
    )
...
if mibBuilder.loadTexts:
    tmnxVdoGrpSrcStatOperBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    tmnxVdoPIDBitrate.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    tmnxVdoSGSpliceRate.setUnits("kilobps")
...
tmnxVdoGrpV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 61, 2, 16)
)
tmnxVdoGrpV13v0Group.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpEnableRtClient")
)
if mibBuilder.loadTexts:
    tmnxVdoGrpV13v0Group.setStatus("current")

tmnxVdoGrpV15v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 61, 2, 17)
)
tmnxVdoGrpV15v0Group.setObjects(
      *(("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakFccBw"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakFccBwTime"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakAbsRetBw"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakAbsRetBwTime"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakFccSession"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakFccSessionTime"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakRetSession"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakRetSessionTime"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakFccRetTotBw"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakFccRetTotBwTime"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakFccRetTotSess"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaPeakFccRetTotSeTime"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpWmBwFcc"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpWmBwRet"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpWmBwTotal"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpWmSesFcc"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpWmSesRet"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpWmSesTotal"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaCurAbsRetBw"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaCurFccRetTotalBw"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaActFccSess"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaActRetSess"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaActFccRetTotalSess"))
)
if mibBuilder.loadTexts:
    tmnxVdoGrpV15v0Group.setStatus("current")
...
tmnxVdoMdaFccBwLimitExceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 11)
)
tmnxVdoMdaFccBwLimitExceeded.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaCurFccBw")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaFccBwLimitExceeded.setStatus(
        "current"
    )

tmnxVdoMdaFccBwLimitCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 12)
)
tmnxVdoMdaFccBwLimitCleared.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaCurFccBw")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaFccBwLimitCleared.setStatus(
        "current"
    )

tmnxVdoMdaRetBwLimitExceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 13)
)
tmnxVdoMdaRetBwLimitExceeded.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaCurAbsRetBw")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaRetBwLimitExceeded.setStatus(
        "current"
    )

tmnxVdoMdaRetBwLimitCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 14)
)
tmnxVdoMdaRetBwLimitCleared.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaCurAbsRetBw")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaRetBwLimitCleared.setStatus(
        "current"
    )

tmnxVdoMdaFccRetTotBwLmtExceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 15)
)
tmnxVdoMdaFccRetTotBwLmtExceeded.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaCurFccRetTotalBw")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaFccRetTotBwLmtExceeded.setStatus(
        "current"
    )

tmnxVdoMdaFccRetTotBwLmtCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 16)
)
tmnxVdoMdaFccRetTotBwLmtCleared.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaCurFccRetTotalBw")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaFccRetTotBwLmtCleared.setStatus(
        "current"
    )

tmnxVdoMdaFccSesLimitExceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 17)
)
tmnxVdoMdaFccSesLimitExceeded.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaActFccSess")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaFccSesLimitExceeded.setStatus(
        "current"
    )

tmnxVdoMdaFccSesLimitCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 18)
)
tmnxVdoMdaFccSesLimitCleared.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaActFccSess")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaFccSesLimitCleared.setStatus(
        "current"
    )

tmnxVdoMdaRetSesLimitExceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 19)
)
tmnxVdoMdaRetSesLimitExceeded.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaActRetSess")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaRetSesLimitExceeded.setStatus(
        "current"
    )

tmnxVdoMdaRetSesLimitCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 20)
)
tmnxVdoMdaRetSesLimitCleared.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaActRetSess")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaRetSesLimitCleared.setStatus(
        "current"
    )

tmnxVdoMdaFccRetTotSeLmtExceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 21)
)
tmnxVdoMdaFccRetTotSeLmtExceeded.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaActFccRetTotalSess")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaFccRetTotSeLmtExceeded.setStatus(
        "current"
    )

tmnxVdoMdaFccRetTotSeLmtCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 61, 0, 22)
)
tmnxVdoMdaFccRetTotSeLmtCleared.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpMdaActFccRetTotalSess")
)
if mibBuilder.loadTexts:
    tmnxVdoMdaFccRetTotSeLmtCleared.setStatus(
        "current"
    )
...
tmnxVdoNotificationsV15v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 61, 2, 18)
)
tmnxVdoNotificationsV15v0Group.setObjects(
      *(("TIMETRA-VIDEO-MIB", "tmnxVdoMdaFccBwLimitExceeded"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaFccBwLimitCleared"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaRetBwLimitExceeded"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaRetBwLimitCleared"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaFccRetTotBwLmtExceeded"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaFccRetTotBwLmtCleared"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaFccSesLimitExceeded"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaFccSesLimitCleared"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaRetSesLimitExceeded"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaRetSesLimitCleared"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaFccRetTotSeLmtExceeded"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoMdaFccRetTotSeLmtCleared"))
)
if mibBuilder.loadTexts:
    tmnxVdoNotificationsV15v0Group.setStatus(
        "current"
    )
...
tmnxVdoV13v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 61, 1, 4)
)
tmnxVdoV13v0Compliance.setObjects(
    ("TIMETRA-VIDEO-MIB", "tmnxVdoGrpV13v0Group")
)
if mibBuilder.loadTexts:
    tmnxVdoV13v0Compliance.setStatus(
        "current"
    )

tmnxVdoV15v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 61, 1, 5)
)
tmnxVdoV15v0Compliance.setObjects(
      *(("TIMETRA-VIDEO-MIB", "tmnxVdoGrpV15v0Group"),
        ("TIMETRA-VIDEO-MIB", "tmnxVdoNotificationsV15v0Group"))
)
if mibBuilder.loadTexts:
    tmnxVdoV15v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TmnxVdoPIDType": TmnxVdoPIDType,
       ...
       "tmnxVdoV13v0Compliance": tmnxVdoV13v0Compliance,
       "tmnxVdoV15v0Compliance": tmnxVdoV15v0Compliance,
       ...
       "tmnxVdoGrpV13v0Group": tmnxVdoGrpV13v0Group,
       "tmnxVdoGrpV15v0Group": tmnxVdoGrpV15v0Group,
       "tmnxVdoNotificationsV15v0Group": tmnxVdoNotificationsV15v0Group,
       "tmnxVdo": tmnxVdo,
       ...
       "tmnxVdoGrpEnableRtClient": tmnxVdoGrpEnableRtClient,
       "tmnxVdoGrpWmBwFcc": tmnxVdoGrpWmBwFcc,
       "tmnxVdoGrpWmBwRet": tmnxVdoGrpWmBwRet,
       "tmnxVdoGrpWmBwTotal": tmnxVdoGrpWmBwTotal,
       "tmnxVdoGrpWmSesFcc": tmnxVdoGrpWmSesFcc,
       "tmnxVdoGrpWmSesRet": tmnxVdoGrpWmSesRet,
       "tmnxVdoGrpWmSesTotal": tmnxVdoGrpWmSesTotal,
       ...
       "tmnxVdoGrpMdaPeakFccBw": tmnxVdoGrpMdaPeakFccBw,
       "tmnxVdoGrpMdaPeakFccBwTime": tmnxVdoGrpMdaPeakFccBwTime,
       "tmnxVdoGrpMdaPeakAbsRetBw": tmnxVdoGrpMdaPeakAbsRetBw,
       "tmnxVdoGrpMdaPeakAbsRetBwTime": tmnxVdoGrpMdaPeakAbsRetBwTime,
       "tmnxVdoGrpMdaPeakFccSession": tmnxVdoGrpMdaPeakFccSession,
       "tmnxVdoGrpMdaPeakFccSessionTime": tmnxVdoGrpMdaPeakFccSessionTime,
       "tmnxVdoGrpMdaPeakRetSession": tmnxVdoGrpMdaPeakRetSession,
       "tmnxVdoGrpMdaPeakRetSessionTime": tmnxVdoGrpMdaPeakRetSessionTime,
       "tmnxVdoGrpMdaPeakFccRetTotBw": tmnxVdoGrpMdaPeakFccRetTotBw,
       "tmnxVdoGrpMdaPeakFccRetTotBwTime": tmnxVdoGrpMdaPeakFccRetTotBwTime,
       "tmnxVdoGrpMdaPeakFccRetTotSess": tmnxVdoGrpMdaPeakFccRetTotSess,
       "tmnxVdoGrpMdaPeakFccRetTotSeTime": tmnxVdoGrpMdaPeakFccRetTotSeTime,
       "tmnxVdoGrpMdaCurAbsRetBw": tmnxVdoGrpMdaCurAbsRetBw,
       "tmnxVdoGrpMdaCurFccRetTotalBw": tmnxVdoGrpMdaCurFccRetTotalBw,
       "tmnxVdoGrpMdaActFccSess": tmnxVdoGrpMdaActFccSess,
       "tmnxVdoGrpMdaActRetSess": tmnxVdoGrpMdaActRetSess,
       "tmnxVdoGrpMdaActFccRetTotalSess": tmnxVdoGrpMdaActFccRetTotalSess,
       ...
       "tmnxVdoMdaFccBwLimitExceeded": tmnxVdoMdaFccBwLimitExceeded,
       "tmnxVdoMdaFccBwLimitCleared": tmnxVdoMdaFccBwLimitCleared,
       "tmnxVdoMdaRetBwLimitExceeded": tmnxVdoMdaRetBwLimitExceeded,
       "tmnxVdoMdaRetBwLimitCleared": tmnxVdoMdaRetBwLimitCleared,
       "tmnxVdoMdaFccRetTotBwLmtExceeded": tmnxVdoMdaFccRetTotBwLmtExceeded,
       "tmnxVdoMdaFccRetTotBwLmtCleared": tmnxVdoMdaFccRetTotBwLmtCleared,
       "tmnxVdoMdaFccSesLimitExceeded": tmnxVdoMdaFccSesLimitExceeded,
       "tmnxVdoMdaFccSesLimitCleared": tmnxVdoMdaFccSesLimitCleared,
       "tmnxVdoMdaRetSesLimitExceeded": tmnxVdoMdaRetSesLimitExceeded,
       "tmnxVdoMdaRetSesLimitCleared": tmnxVdoMdaRetSesLimitCleared,
       "tmnxVdoMdaFccRetTotSeLmtExceeded": tmnxVdoMdaFccRetTotSeLmtExceeded,
       "tmnxVdoMdaFccRetTotSeLmtCleared": tmnxVdoMdaFccRetTotSeLmtCleared}
)
