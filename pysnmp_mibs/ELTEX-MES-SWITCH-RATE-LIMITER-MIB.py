...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/eltex/ELTEX-MES-SWITCH-RATE-LIMITER-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:12:15 2025
...
eltMesCpuRateLimiterNotifications = MibIdentifier((1, 3, 6, 1, 4, 1, 35265, 1, 23, 1, 773, 1, 0))
...
class EltCpuRateLimiterTrafficType(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("http", 1), ("telnet", 2), ("ssh", 3), ("snmp", 4), ("ip", 5), ("linkLocal", 6), ("arp", 7), ("arpInspec", 8), ("stpBpdu", 9), ("otherBpdu", 10), ("ipRouting", 11), ("ipOptions", 12), ("dhcpSnoop", 13), ("igmpSnoop", 14), ("mldSnoop", 15), ("sflow", 16), ("ace", 17), ("ipErrors", 18), ("other", 19), ("dhcpv6Snoop", 20), ("vrrp", 21), ("mcRouting", 22), ("mcRpfFailed", 23), ("tcpSyn", 24))
...
eltCpuRateDefaultLimiterValue = MibTableColumn((1, 3, 6, 1, 4, 1, 35265, 1, 23, 1, 773, 1, 1, 1, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
if mibBuilder.loadTexts: eltCpuRateDefaultLimiterValue.setStatus('current')
...
eltCpuRateLimiterTrap = NotificationType((1, 3, 6, 1, 4, 1, 35265, 1, 23, 1, 773, 1, 0, 1)).setObjects(("ELTEX-MES-SWITCH-RATE-LIMITER-MIB", "eltCpuRateLimiterIndex"), ("ELTEX-MES-SWITCH-RATE-LIMITER-MIB", "eltCpuRateLimiterValue"))
if mibBuilder.loadTexts: eltCpuRateLimiterTrap.setStatus('current')
mibBuilder.exportSymbols("ELTEX-MES-SWITCH-RATE-LIMITER-MIB", EltCpuRateStatisticsTrafficType=EltCpuRateStatisticsTrafficType, eltMesCpuRateLimiterNotifications=eltMesCpuRateLimiterNotifications, eltCpuRateLimiterValue=eltCpuRateLimiterValue, eltMesSwitchRateLimiterStatistics=eltMesSwitchRateLimiterStatistics, eltMesSwitchRateLimiterConfig=eltMesSwitchRateLimiterConfig, eltCpuRateStatisticsIndex=eltCpuRateStatisticsIndex, eltCpuRateStatisticsEntry=eltCpuRateStatisticsEntry, eltCpuRateLimiterTrap=eltCpuRateLimiterTrap, eltCpuRateStatisticsCounter=eltCpuRateStatisticsCounter, eltCpuRateLimiterTable=eltCpuRateLimiterTable, eltCpuRateStatisticsTable=eltCpuRateStatisticsTable, eltCpuRateStatisticsRate=eltCpuRateStatisticsRate, eltMesSwitchRateLimiterObjects=eltMesSwitchRateLimiterObjects, EltCpuRateLimiterTrafficType=EltCpuRateLimiterTrafficType, eltCpuRateLimiterIndex=eltCpuRateLimiterIndex, eltCpuRateLimiterEntry=eltCpuRateLimiterEntry, eltCpuRateDefaultLimiterValue=eltCpuRateDefaultLimiterValue)
