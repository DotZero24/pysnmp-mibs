...
# Notes
# -----
# ASN.1 source file://mibs/rfc/DIRECTORY-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:24:30 2025
...
dsEntryCompliance.setObjects(
    ("DIRECTORY-SERVER-MIB", "dsEntryGroup")
)
if mibBuilder.loadTexts:
...
dsOpsCompliance.setObjects(
      *(("DIRECTORY-SERVER-MIB", "dsEntryGroup"),
        ("DIRECTORY-SERVER-MIB", "dsOpsGroup"))
)
if mibBuilder.loadTexts:
...
dsIntCompliance.setObjects(
      *(("DIRECTORY-SERVER-MIB", "dsEntryGroup"),
        ("DIRECTORY-SERVER-MIB", "dsIntGroup"))
)
if mibBuilder.loadTexts:
