...
mibBuilder.exportSymbols("DIRECTORY-SERVER-MIB", dsIntEntFailures=dsIntEntFailures, dsIntEntFailuresSinceLastSuccess=dsIntEntFailuresSinceLastSuccess, dsIntEntURL=dsIntEntURL, dsApplIfWholeSubtreeSearchOps=dsApplIfWholeSubtreeSearchOps, dsOpsCompliance=dsOpsCompliance, dsApplIfOutBytes=dsApplIfOutBytes, dsApplIfSecurityErrors=dsApplIfSecurityErrors, dsTable=dsTable, dsEntryGroup=dsEntryGroup, dsOpsGroup=dsOpsGroup, dsIntEntSuccesses=dsIntEntSuccesses, dsApplIfOneLevelSearchOps=dsApplIfOneLevelSearchOps, dsApplIfModifyRDNOps=dsApplIfModifyRDNOps, dsApplIfReplicationUpdatesOut=dsApplIfReplicationUpdatesOut, dsSlaveHits=dsSlaveHits, dsServerType=dsServerType, dsApplIfChainings=dsApplIfChainings, dsApplIfInBytes=dsApplIfInBytes, dsServerDescription=dsServerDescription, PYSNMP_MODULE_ID=dsMIB, dsIntEntDirectoryName=dsIntEntDirectoryName, dsCacheHits=dsCacheHits, dsCopyEntries=dsCopyEntries, dsCacheEntries=dsCacheEntries, dsApplIfModifyEntryOps=dsApplIfModifyEntryOps, dsApplIfSearchOps=dsApplIfSearchOps, dsCompliances=dsCompliances, dsEntryCompliance=dsEntryCompliance, dsApplIfSimpleAuthBinds=dsApplIfSimpleAuthBinds, dsTableEntry=dsTableEntry, dsApplIfErrors=dsApplIfErrors, dsApplIfReadOps=dsApplIfReadOps, dsIntEntry=dsIntEntry, dsIntEntTimeOfCreation=dsIntEntTimeOfCreation, dsConformance=dsConformance, dsGroups=dsGroups, dsApplIfUnauthBinds=dsApplIfUnauthBinds, dsApplIfCompareOps=dsApplIfCompareOps, dsApplIfReferrals=dsApplIfReferrals, dsIntEntTimeOfLastAttempt=dsIntEntTimeOfLastAttempt, dsIntGroup=dsIntGroup, dsMasterEntries=dsMasterEntries, dsApplIfOpsEntry=dsApplIfOpsEntry, dsApplIfAddEntryOps=dsApplIfAddEntryOps, dsApplIfStrongAuthBinds=dsApplIfStrongAuthBinds, dsApplIfListOps=dsApplIfListOps, dsIntCompliance=dsIntCompliance, dsOpsIntCompliance=dsOpsIntCompliance, dsApplIfReplicationUpdatesIn=dsApplIfReplicationUpdatesIn, dsIntEntTimeOfLastSuccess=dsIntEntTimeOfLastSuccess, dsMIB=dsMIB, dsApplIfInOps=dsApplIfInOps, dsApplIfOpsTable=dsApplIfOpsTable, dsApplIfProtocol=dsApplIfProtocol, dsApplIfRemoveEntryOps=dsApplIfRemoveEntryOps, dsIntEntIndex=dsIntEntIndex, dsApplIfProtocolIndex=dsApplIfProtocolIndex, dsIntTable=dsIntTable, dsApplIfBindSecurityErrors=dsApplIfBindSecurityErrors)
