...
mibBuilder.exportSymbols("DELL-NETWORKING-TC", DellNetCycloneVersion=DellNetCycloneVersion, DellNetPortPipeID=DellNetPortPipeID, DellNetSlotState=DellNetSlotState, DellNetChassisType=DellNetChassisType, DellNetVlanID=DellNetVlanID, DellNetChassisMode=DellNetChassisMode, DellNetMfgDate=DellNetMfgDate, dellNetTextualConventions=dellNetTextualConventions, DellNetCamPartitionType=DellNetCamPartitionType, DellNetCSeriesCardType=DellNetCSeriesCardType, DellNetSystemCardType=DellNetSystemCardType, DellNetInterfaceType=DellNetInterfaceType, DellNetProcessorModuleType=DellNetProcessorModuleType, DellNetDeviceType=DellNetDeviceType, DellNetPEOperStatus=DellNetPEOperStatus, DellNetCardOperStatus=DellNetCardOperStatus, DellNetHundredthdB=DellNetHundredthdB, DellNetSystemPortType=DellNetSystemPortType, PYSNMP_MODULE_ID=dellNetTextualConventions, DellNetIfType=DellNetIfType, PortList=PortList, DellNetQueueID=DellNetQueueID, DellNetSwDate=DellNetSwDate, DellNetSlotID=DellNetSlotID)
