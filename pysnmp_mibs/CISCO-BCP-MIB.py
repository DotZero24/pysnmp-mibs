...
mibBuilder.exportSymbols("CISCO-BCP-MIB", bcpConfigLineIdControl=bcpConfigLineIdControl, bcpConfigMgmtInline=bcpConfigMgmtInline, bcpConfigTable=bcpConfigTable, bcpOperTable=bcpOperTable, bcpConfigSpanTree=bcpConfigSpanTree, bcpConfigMacSupport=bcpConfigMacSupport, bcpConfigBCPacketIndicator=bcpConfigBCPacketIndicator, cBcpMIBCompliances=cBcpMIBCompliances, bcpConfigLineId=bcpConfigLineId, cBcpMIBGroup=cBcpMIBGroup, ciscoBcpMIBObjects=ciscoBcpMIBObjects, bcpConfigMacAddressControl=bcpConfigMacAddressControl, cBcpMIBGroups=cBcpMIBGroups, bcpConfigMacType=bcpConfigMacType, bcpOperEntry=bcpOperEntry, bcpConfigEntry=bcpConfigEntry, cBcpMIBConformance=cBcpMIBConformance, bcpOperStatus=bcpOperStatus, PYSNMP_MODULE_ID=ciscoBcpMIB, bcpConfigTinygram=bcpConfigTinygram, bcpConfigIeee802dot1qTagged=bcpConfigIeee802dot1qTagged, cBcpMIBCompliance=cBcpMIBCompliance, ciscoBcpMIB=ciscoBcpMIB, bcpConfigSpanTreeControl=bcpConfigSpanTreeControl, bcpConfigBridgeId=bcpConfigBridgeId, bcpConfigBridgeIdControl=bcpConfigBridgeIdControl, bcpConfigMacAddress=bcpConfigMacAddress)
