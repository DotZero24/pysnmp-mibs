...
mibBuilder.exportSymbols("DOT3-OAM-MIB", dot3OamOrgSpecificRx=dot3OamOrgSpecificRx, dot3OamMode=dot3OamMode, dot3OamEventLogWindowLo=dot3OamEventLogWindowLo, dot3OamPeerMaxOamPduSize=dot3OamPeerMaxOamPduSize, dot3OamErrFramePeriodWindow=dot3OamErrFramePeriodWindow, dot3OamGroups=dot3OamGroups, dot3OamObjects=dot3OamObjects, dot3OamDyingGaspEnable=dot3OamDyingGaspEnable, dot3OamPeerMacAddress=dot3OamPeerMacAddress, dot3OamEventLogThresholdHi=dot3OamEventLogThresholdHi, dot3OamDuplicateEventNotificationRx=dot3OamDuplicateEventNotificationRx, dot3OamEventLogWindowHi=dot3OamEventLogWindowHi, dot3OamVariableRequestTx=dot3OamVariableRequestTx, dot3OamEventLogEntry=dot3OamEventLogEntry, dot3OamErrSymbolPeriodEventGroup=dot3OamErrSymbolPeriodEventGroup, dot3OamThresholdEvent=dot3OamThresholdEvent, dot3OamEventLogGroup=dot3OamEventLogGroup, dot3OamErrSymPeriodWindowLo=dot3OamErrSymPeriodWindowLo, dot3OamErrFrameEventGroup=dot3OamErrFrameEventGroup, dot3OamErrFrameEvNotifEnable=dot3OamErrFrameEvNotifEnable, dot3OamLoopbackIgnoreRx=dot3OamLoopbackIgnoreRx, dot3OamEventLogIndex=dot3OamEventLogIndex, dot3OamEventLogTable=dot3OamEventLogTable, dot3OamControlGroup=dot3OamControlGroup, dot3OamConformance=dot3OamConformance, dot3OamStatsBaseGroup=dot3OamStatsBaseGroup, dot3OamErrFrameSecsSummaryEventGroup=dot3OamErrFrameSecsSummaryEventGroup, dot3OamErrFrameWindow=dot3OamErrFrameWindow, dot3OamPeerVendorOui=dot3OamPeerVendorOui, dot3OamInformationRx=dot3OamInformationRx, dot3OamMIB=dot3OamMIB, dot3OamNonThresholdEvent=dot3OamNonThresholdEvent, dot3OamLoopbackStatus=dot3OamLoopbackStatus, dot3OamPeerVendorInfo=dot3OamPeerVendorInfo, dot3OamLoopbackControlTx=dot3OamLoopbackControlTx, dot3OamEventLogThresholdLo=dot3OamEventLogThresholdLo, dot3OamErrFrameSecsSummaryThreshold=dot3OamErrFrameSecsSummaryThreshold, dot3OamVariableRequestRx=dot3OamVariableRequestRx, dot3OamPeerEntry=dot3OamPeerEntry, dot3OamOperStatus=dot3OamOperStatus, dot3OamEventConfigTable=dot3OamEventConfigTable, dot3OamErrSymPeriodThresholdHi=dot3OamErrSymPeriodThresholdHi, dot3OamVariableResponseRx=dot3OamVariableResponseRx, dot3OamEventLogTimestamp=dot3OamEventLogTimestamp, dot3OamLoopbackControlRx=dot3OamLoopbackControlRx, dot3OamConfigRevision=dot3OamConfigRevision, dot3OamInformationTx=dot3OamInformationTx, dot3OamUnsupportedCodesTx=dot3OamUnsupportedCodesTx, dot3OamFramesLostDueToOam=dot3OamFramesLostDueToOam, dot3OamEventLogOui=dot3OamEventLogOui, dot3OamLoopbackGroup=dot3OamLoopbackGroup, dot3OamCompliances=dot3OamCompliances, dot3OamErrFrameThreshold=dot3OamErrFrameThreshold, dot3OamEntry=dot3OamEntry, dot3OamErrFrameSecsEvNotifEnable=dot3OamErrFrameSecsEvNotifEnable, dot3OamPeerTable=dot3OamPeerTable, dot3OamUniqueEventNotificationTx=dot3OamUniqueEventNotificationTx, dot3OamErrSymPeriodEvNotifEnable=dot3OamErrSymPeriodEvNotifEnable, dot3OamUnsupportedCodesRx=dot3OamUnsupportedCodesRx, dot3OamNotifications=dot3OamNotifications, EightOTwoOui=EightOTwoOui, dot3OamStatsTable=dot3OamStatsTable, dot3OamVariableResponseTx=dot3OamVariableResponseTx, dot3OamCriticalEventEnable=dot3OamCriticalEventEnable, dot3OamPeerGroup=dot3OamPeerGroup, dot3OamErrSymPeriodThresholdLo=dot3OamErrSymPeriodThresholdLo, dot3OamFunctionsSupported=dot3OamFunctionsSupported, dot3OamStatsEntry=dot3OamStatsEntry, dot3OamUniqueEventNotificationRx=dot3OamUniqueEventNotificationRx, dot3OamErrFramePeriodThreshold=dot3OamErrFramePeriodThreshold, dot3OamLoopbackTable=dot3OamLoopbackTable, dot3OamNotificationGroup=dot3OamNotificationGroup, dot3OamEventLogValue=dot3OamEventLogValue, dot3OamEventLogEventTotal=dot3OamEventLogEventTotal, dot3OamPeerConfigRevision=dot3OamPeerConfigRevision, dot3OamLoopbackEntry=dot3OamLoopbackEntry, dot3OamErrFramePeriodEvNotifEnable=dot3OamErrFramePeriodEvNotifEnable, dot3OamEventLogLocation=dot3OamEventLogLocation, dot3OamMaxOamPduSize=dot3OamMaxOamPduSize, dot3OamDuplicateEventNotificationTx=dot3OamDuplicateEventNotificationTx, dot3OamPeerFunctionsSupported=dot3OamPeerFunctionsSupported, dot3OamErrSymPeriodWindowHi=dot3OamErrSymPeriodWindowHi, dot3OamTable=dot3OamTable, dot3OamOrgSpecificTx=dot3OamOrgSpecificTx, dot3OamEventLogType=dot3OamEventLogType, dot3OamPeerMode=dot3OamPeerMode, PYSNMP_MODULE_ID=dot3OamMIB, dot3OamErrFramePeriodEventGroup=dot3OamErrFramePeriodEventGroup, dot3OamAdminState=dot3OamAdminState, dot3OamCompliance=dot3OamCompliance, dot3OamEventConfigEntry=dot3OamEventConfigEntry, dot3OamFlagEventGroup=dot3OamFlagEventGroup, dot3OamEventLogRunningTotal=dot3OamEventLogRunningTotal, dot3OamErrFrameSecsSummaryWindow=dot3OamErrFrameSecsSummaryWindow)
