...
mibBuilder.exportSymbols("HPN-ICF-MPLSOAM-PS-MIB", hpnicfMplsPsSwitchWtoP=hpnicfMplsPsSwitchWtoP, hpnicfMplsPsWorkLspDetectState=hpnicfMplsPsWorkLspDetectState, hpnicfMplsPsGroupID=hpnicfMplsPsGroupID, hpnicfMplsPsSwitchResult=hpnicfMplsPsSwitchResult, hpnicfMplsPsWorkLspUpDownState=hpnicfMplsPsWorkLspUpDownState, hpnicfMplsPsSwitchCondition=hpnicfMplsPsSwitchCondition, hpnicfMplsPsRevertiveMode=hpnicfMplsPsRevertiveMode, hpnicfMplsPsProtLspUpDownState=hpnicfMplsPsProtLspUpDownState, hpnicfMplsPsProtectLspName=hpnicfMplsPsProtectLspName, hpnicfMplsOamPsScalarGroup=hpnicfMplsOamPsScalarGroup, hpnicfMplsPsRowStatus=hpnicfMplsPsRowStatus, PYSNMP_MODULE_ID=hpnicfMplsOamPs, hpnicfMplsPsTable=hpnicfMplsPsTable, hpnicfMplsPsHoldOff=hpnicfMplsPsHoldOff, hpnicfMplsPsProtLspDetectState=hpnicfMplsPsProtLspDetectState, hpnicfMplsPsEntry=hpnicfMplsPsEntry, hpnicfMplsOamPsNotifications=hpnicfMplsOamPsNotifications, hpnicfMplsPsWorkLspName=hpnicfMplsPsWorkLspName, hpnicfMplsPsSwitchPtoW=hpnicfMplsPsSwitchPtoW, hpnicfMplsOamPsTrapOpen=hpnicfMplsOamPsTrapOpen, hpnicfMplsPsIndex=hpnicfMplsPsIndex, hpnicfMplsOamPs=hpnicfMplsOamPs, hpnicfMplsPsWTR=hpnicfMplsPsWTR, hpnicfMplsOamPsTable=hpnicfMplsOamPsTable)
