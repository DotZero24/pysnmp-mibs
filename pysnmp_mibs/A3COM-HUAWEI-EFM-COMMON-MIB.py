...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-EFM-COMMON-MIB
...
h3cDot3OamCompliance.setObjects(
      *(("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamControlGroup"),
        ("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamPeerGroup"),
        ("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamStatsBaseGroup"),
        ("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamLoopbackGroup"),
        ("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamErrSymbolPeriodEventGroup"),
        ("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamErrFramePeriodEventGroup"),
        ("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamErrFrameEventGroup"),
        ("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamErrFrameSecsSummaryEventGroup"),
        ("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamEventLogGroup"),
        ("A3COM-HUAWEI-EFM-COMMON-MIB", "h3cDot3OamNotificationGroup"))
)
if mibBuilder.loadTexts:
