...
mibBuilder.exportSymbols("CISCO-MMAIL-DIAL-CONTROL-MIB", PYSNMP_MODULE_ID=ciscoMediaMailDialControlMIB, cmmdcMIBObjects=cmmdcMIBObjects, cmmFaxCfgRightHeadingString=cmmFaxCfgRightHeadingString, cmmIpPeerCfgTable=cmmIpPeerCfgTable, cmmIpPeerCfgSessionProtocol=cmmIpPeerCfgSessionProtocol, cmmIpCallHistoryEntry=cmmIpCallHistoryEntry, cmmIpCallHistoryConnectionId=cmmIpCallHistoryConnectionId, cmmIpCallActiveTable=cmmIpCallActiveTable, cmmIpCallActiveImgResolution=cmmIpCallActiveImgResolution, cmmdcMIBConformance=cmmdcMIBConformance, CmmImgEncoding=CmmImgEncoding, cmmIpPeerCfgImgEncodingType=cmmIpPeerCfgImgEncodingType, cmmFaxCfgCenterHeadingString=cmmFaxCfgCenterHeadingString, CmmFaxHeadingString=CmmFaxHeadingString, cmmIpPeerCfgImgResolution=cmmIpPeerCfgImgResolution, cmmFaxCfgFaxProfile=cmmFaxCfgFaxProfile, cmmIpCallActiveEntry=cmmIpCallActiveEntry, ciscoMediaMailDialControlMIB=ciscoMediaMailDialControlMIB, cmmIpPeerCfgEntry=cmmIpPeerCfgEntry, cmmIpCallHistoryMessageId=cmmIpCallHistoryMessageId, cmmIpPeerCfgSessionTarget=cmmIpPeerCfgSessionTarget, cmmIpCallHistoryAccountId=cmmIpCallHistoryAccountId, cmmIpCallActiveSessionProtocol=cmmIpCallActiveSessionProtocol, CmmImgResolution=CmmImgResolution, cmmIpCallActiveAccountId=cmmIpCallActiveAccountId, cmmIpCallActiveAcceptMimeTypes=cmmIpCallActiveAcceptMimeTypes, cmmdcMIBCompliance=cmmdcMIBCompliance, cmmIpCallActiveDiscdMimeTypes=cmmIpCallActiveDiscdMimeTypes, cmmdcPeerCfgGroup=cmmdcPeerCfgGroup, cmmFaxGroup=cmmFaxGroup, cmmCallActive=cmmCallActive, cmmPeer=cmmPeer, cmmIpCallHistoryAcceptMimeTypes=cmmIpCallHistoryAcceptMimeTypes, cmmFaxGeneralCfg=cmmFaxGeneralCfg, cmmIpCallHistorySessionTarget=cmmIpCallHistorySessionTarget, cmmIpCallActiveMessageId=cmmIpCallActiveMessageId, cmmFaxCfgCalledSubscriberId=cmmFaxCfgCalledSubscriberId, cmmIpCallHistorySessionProtocol=cmmIpCallHistorySessionProtocol, cmmIpCallHistoryRemoteIPAddress=cmmIpCallHistoryRemoteIPAddress, CmmImgResolutionOrTransparent=CmmImgResolutionOrTransparent, cmmIpCallActiveNotification=cmmIpCallActiveNotification, cmmIpCallHistoryDiscdMimeTypes=cmmIpCallHistoryDiscdMimeTypes, cmmIpCallHistoryTable=cmmIpCallHistoryTable, cmmFaxCfgLeftHeadingString=cmmFaxCfgLeftHeadingString, cmmIpCallActiveImgEncodingType=cmmIpCallActiveImgEncodingType, cmmCallHistory=cmmCallHistory, cmmFaxCfgCovergPageComment=cmmFaxCfgCovergPageComment, cmmFaxCfgXmitSubscriberId=cmmFaxCfgXmitSubscriberId, cmmIpCallHistoryNotification=cmmIpCallHistoryNotification, cmmIpCallHistoryImgEncodingType=cmmIpCallHistoryImgEncodingType, cmmIpCallActiveRemoteIPAddress=cmmIpCallActiveRemoteIPAddress, cmmIpPeerCfgMsgDispoNotification=cmmIpPeerCfgMsgDispoNotification, cmmIpCallHistoryImgResolution=cmmIpCallHistoryImgResolution, cmmdcMIBGroups=cmmdcMIBGroups, cmmIpCallImageGroup=cmmIpCallImageGroup, cmmIpPeerCfgDeliStatNotification=cmmIpPeerCfgDeliStatNotification, cmmdcMIBCompliances=cmmdcMIBCompliances, cmmIpCallActiveSessionTarget=cmmIpCallActiveSessionTarget, cmmIpCallGeneralGroup=cmmIpCallGeneralGroup, cmmIpCallActiveConnectionId=cmmIpCallActiveConnectionId, cmmFaxCfgCovergPageControl=cmmFaxCfgCovergPageControl, CmmImgEncodingOrTransparent=CmmImgEncodingOrTransparent)
