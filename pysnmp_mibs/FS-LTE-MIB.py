# SNMP MIB module (FS-LTE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/fscom/FS-LTE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:15:37 2025
...
fsLteMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148)
)
if mibBuilder.loadTexts:
    fsLteMIB.setRevisions(
        ("2010-02-28 00:00",)
    )
...
lteEnbGeneralInfoConfigEntry = _LteEnbGeneralInfoConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1)
)
lteEnbGeneralInfoConfigEntry.setIndexNames(
    (0, "FS-LTE-MIB", "lteEnbMacAddr"),
)
if mibBuilder.loadTexts:
...
lteEnbMacAddr = _LteEnbMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 1),
    _LteEnbMacAddr_Type()
)
...
lteEnbName = _LteEnbName_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 2),
    _LteEnbName_Type()
)
...
lteEnbDLBandWidth = _LteEnbDLBandWidth_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 3),
...
lteEnbMCC = _LteEnbMCC_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 4),
    _LteEnbMCC_Type()
)
...
lteEnbMNC = _LteEnbMNC_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 5),
    _LteEnbMNC_Type()
)
...
lteEnbTac = _LteEnbTac_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 6),
    _LteEnbTac_Type()
)
...
lteEnbFrameType = _LteEnbFrameType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 7),
...
lteEnbTddConfig = _LteEnbTddConfig_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 8),
...
lteEnbTddConfigS = _LteEnbTddConfigS_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 9),
...
lteEnbPrefixType = _LteEnbPrefixType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 10),
...
lteEnbFreqBandIndicator = _LteEnbFreqBandIndicator_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 11),
...
lteEnbDownlinkFrequency = _LteEnbDownlinkFrequency_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 12),
...
lteEnbUplinkFrequencyOffset = _LteEnbUplinkFrequencyOffset_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 13),
...
lteEnbTxmode = _LteEnbTxmode_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 14),
    _LteEnbTxmode_Type()
)
...
lteEnbNidCell = _LteEnbNidCell_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 15),
    _LteEnbNidCell_Type()
)
...
lteEnbRsPower = _LteEnbRsPower_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 16),
    _LteEnbRsPower_Type()
)
...
lteEnbReset = _LteEnbReset_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 17),
    _LteEnbReset_Type()
)
...
lteEnbTxpower = _LteEnbTxpower_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 18),
    _LteEnbTxpower_Type()
)
...
lteEnbqRxLvlmin = _LteEnbqRxLvlmin_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 19),
...
lteEnbPdschRsPower = _LteEnbPdschRsPower_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 20),
...
lteEnbPuschP0Nominal = _LteEnbPuschP0Nominal_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 21),
...
lteEnbPuschAlpha = _LteEnbPuschAlpha_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 22),
...
lteEnbPucchP0Nominal = _LteEnbPucchP0Nominal_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 23),
...
lteEnbDtchTimer = _LteEnbDtchTimer_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 24),
...
lteEnbLB = _LteEnbLB_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 25),
    _LteEnbLB_Type()
)
...
lteEnbICIC = _LteEnbICIC_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 26),
    _LteEnbICIC_Type()
)
...
lteEnbEdgeRbStart = _LteEnbEdgeRbStart_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 27),
...
lteEnbEdgeRbEnd = _LteEnbEdgeRbEnd_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 28),
...
lteEnbEdgeRsrpThold = _LteEnbEdgeRsrpThold_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 29),
...
lteEnbEdgeDifThold = _LteEnbEdgeDifThold_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 30),
...
lteEnbMeas = _LteEnbMeas_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 31),
    _LteEnbMeas_Type()
)
...
lteEnbMeasGap = _LteEnbMeasGap_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 32),
    _LteEnbMeasGap_Type()
)
...
lteEnbMeasCarrfreq1 = _LteEnbMeasCarrfreq1_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 33),
...
lteEnbMeasCarrfreq2 = _LteEnbMeasCarrfreq2_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 34),
...
lteEnbMeasA1Thold = _LteEnbMeasA1Thold_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 35),
...
lteEnbMeasA2Thold = _LteEnbMeasA2Thold_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 36),
...
lteEnbMeasA3Offset = _LteEnbMeasA3Offset_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 37),
...
lteEnbMeasA3Hys = _LteEnbMeasA3Hys_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 38),
...
lteEnbMeasA3TimeTrig = _LteEnbMeasA3TimeTrig_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 39),
...
lteEnbMeasA3RpIntval = _LteEnbMeasA3RpIntval_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 40),
...
lteEnbID = _LteEnbID_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 1, 1, 1, 41),
    _LteEnbID_Type()
)
...
lteUEImsi = _LteUEImsi_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 1),
    _LteUEImsi_Type()
)
...
lteUEIpaddr = _LteUEIpaddr_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 2),
    _LteUEIpaddr_Type()
)
...
lteUEGuti = _LteUEGuti_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 3),
    _LteUEGuti_Type()
)
...
lteUEUptime = _LteUEUptime_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 4),
    _LteUEUptime_Type()
)
...
lteUERxpkt = _LteUERxpkt_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 5),
    _LteUERxpkt_Type()
)
...
lteUETxpkt = _LteUETxpkt_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 6),
    _LteUETxpkt_Type()
)
...
lteUECellId = _LteUECellId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 7),
    _LteUECellId_Type()
)
...
lteUEIsAttached = _LteUEIsAttached_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 8),
...
lteUECapbility = _LteUECapbility_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 9),
...
lteUEAssoEnbMac = _LteUEAssoEnbMac_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 10),
...
lteUERrcState = _LteUERrcState_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 11),
    _LteUERrcState_Type()
)
...
lteUERxbytes = _LteUERxbytes_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 12),
    _LteUERxbytes_Type()
)
...
lteUETxbytes = _LteUETxbytes_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 2, 1, 1, 13),
    _LteUETxbytes_Type()
)
...
lteEnbNameInfo = _LteEnbNameInfo_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 3, 1, 1, 1),
...
lteEnbFreqBandNumber = _LteEnbFreqBandNumber_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 3, 1, 1, 2),
...
lteEnbUENumber = _LteEnbUENumber_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 3, 1, 1, 3),
...
lteEpcStatusEntry = _LteEpcStatusEntry_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 4)
)
...
lteEpcAttachUENumber = _LteEpcAttachUENumber_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 4, 1),
...
lteEpcEIA = _LteEpcEIA_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 5, 2),
    _LteEpcEIA_Type()
)
...
lteEpcMMECode = _LteEpcMMECode_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 5, 3),
    _LteEpcMMECode_Type()
)
...
lteEpcMMEGid = _LteEpcMMEGid_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 5, 4),
    _LteEpcMMEGid_Type()
)
...
lteEpcMCC = _LteEpcMCC_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 5, 5),
    _LteEpcMCC_Type()
)
...
lteEpcMNC = _LteEpcMNC_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 5, 6),
    _LteEpcMNC_Type()
)
...
lteEpcEnbKeepalivetimer = _LteEpcEnbKeepalivetimer_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 5, 7),
...
lteEpcDNS = _LteEpcDNS_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 5, 8),
    _LteEpcDNS_Type()
)
...
lteUEIMSIMapIpEntry = _LteUEIMSIMapIpEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 6, 1, 1)
)
...
_LteUEIMSI_Object = MibTableColumn
lteUEIMSI = _LteUEIMSI_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 6, 1, 1, 1),
    _LteUEIMSI_Type()
)
...
lteUEIP = _LteUEIP_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 6, 1, 1, 2),
    _LteUEIP_Type()
)
...
lteUERowStatus = _LteUERowStatus_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 6, 1, 1, 3),
...
lteFSAlarmTraps = _LteFSAlarmTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 7)
)
_LteFSAlarmTrapObjects_ObjectIdentity = ObjectIdentity
lteFSAlarmTrapObjects = _LteFSAlarmTrapObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 8)
)
_ENodeBmac_Type = MacAddress
_ENodeBmac_Object = MibScalar
eNodeBmac = _ENodeBmac_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 8, 1),
    _ENodeBmac_Type()
)
...
eNodeBname = _ENodeBname_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 8, 2),
    _ENodeBname_Type()
)
...
ueIMSI = _UeIMSI_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 8, 3),
    _UeIMSI_Type()
)
...
ueIpaddr = _UeIpaddr_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 8, 4),
    _UeIpaddr_Type()
)
...
lteEnbOnlineTraps = NotificationType(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 7, 1)
)
lteEnbOnlineTraps.setObjects(
      *(("FS-LTE-MIB", "eNodeBmac"),
        ("FS-LTE-MIB", "eNodeBname"))
)
if mibBuilder.loadTexts:
...
lteEnbOfflineTraps = NotificationType(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 7, 2)
)
...
lteUEAttachedTraps = NotificationType(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 7, 3)
)
...
lteUEDetachedTraps = NotificationType(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 148, 7, 4)
)
...
mibBuilder.exportSymbols(
    ...
    **{"fsLteMIB": fsLteMIB,
       ...
       "lteFSAlarmTraps": lteFSAlarmTraps,
       ...
       "lteFSAlarmTrapObjects": lteFSAlarmTrapObjects,
       "eNodeBmac": eNodeBmac,
