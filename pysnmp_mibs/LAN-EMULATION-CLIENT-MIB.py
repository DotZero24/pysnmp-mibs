...
# Notes
# -----
# ASN.1 source file://mibs/cisco/LAN-EMULATION-CLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:04:28 2025
...
leClientMIBCompliance.setObjects(
      *(("LAN-EMULATION-CLIENT-MIB", "leClientConfigGroup"),
        ("LAN-EMULATION-CLIENT-MIB", "leClientStatusGroup"),
        ("LAN-EMULATION-CLIENT-MIB", "leClientMappingGroup"),
        ("LAN-EMULATION-CLIENT-MIB", "leClientStatisticsGroup"),
        ("LAN-EMULATION-CLIENT-MIB", "leClientServerVccGroup"),
        ("LAN-EMULATION-CLIENT-MIB", "leClientAtmAddressesGroup"),
        ("LAN-EMULATION-CLIENT-MIB", "leClientMacAddressesGroup"),
        ("LAN-EMULATION-CLIENT-MIB", "leClientArpGroup"),
        ("LAN-EMULATION-CLIENT-MIB", "leClientRouteDescriptorsGroup"),
        ("LAN-EMULATION-CLIENT-MIB", "leClientRDArpGroup"))
)
if mibBuilder.loadTexts:
