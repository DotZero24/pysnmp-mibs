...
sfpsPathMaskObj, sfpsSwitchPathAPI, sfpsSwitchPath, sfpsISPSwitchPath, sfpsStaticPath, sfpsSwitchPathStats, sfpsChassisRIPPath, sfpsPathAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "sfpsPathMaskObj", "sfpsSwitchPathAPI", "sfpsSwitchPath", "sfpsISPSwitchPath", "sfpsStaticPath", "sfpsSwitchPathStats", "sfpsChassisRIPPath", "sfpsPathAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-PATH-MIB", sfpsSwitchPathTableRcvDblBackCnt=sfpsSwitchPathTableRcvDblBackCnt, sfpsSwitchPathTablePort=sfpsSwitchPathTablePort, sfpsStaticPathPort=sfpsStaticPathPort, sfpsSwitchPathStatsPathUnk=sfpsSwitchPathStatsPathUnk, sfpsPathMaskObjPyhsIsolatedSwitchMask=sfpsPathMaskObjPyhsIsolatedSwitchMask, sfpsSwitchPathStatsRcdDblBack=sfpsSwitchPathStatsRcdDblBack, sfpsSwitchPathTableDirReapTime=sfpsSwitchPathTableDirReapTime, sfpsPathMaskObjCoreUplinkMask=sfpsPathMaskObjCoreUplinkMask, SfpsAddress=SfpsAddress, sfpsPathMaskObjPhysResolveMask=sfpsPathMaskObjPhysResolveMask, sfpsPathMaskObjLogDownlinkMask=sfpsPathMaskObjLogDownlinkMask, sfpsServiceCenterPathStatusTime=sfpsServiceCenterPathStatusTime, sfpsStaticPathDownlinkEnabled=sfpsStaticPathDownlinkEnabled, sfpsSwitchPathStatsDeadLocal=sfpsSwitchPathStatsDeadLocal, sfpsSwitchPathStatsPathNak=sfpsSwitchPathStatsPathNak, sfpsSwitchPathTableSwitchMAC=sfpsSwitchPathTableSwitchMAC, sfpsSwitchPathAPIBaseMAC=sfpsSwitchPathAPIBaseMAC, sfpsChassisRIPPathNumInTable=sfpsChassisRIPPathNumInTable, HexInteger=HexInteger, sfpsPathAPICost=sfpsPathAPICost, sfpsSwitchPathStatsNumEntries=sfpsSwitchPathStatsNumEntries, sfpsSwitchPathStatsLocateAck=sfpsSwitchPathStatsLocateAck, sfpsStaticPathTable=sfpsStaticPathTable, sfpsSwitchPathTable=sfpsSwitchPathTable, sfpsSwitchPathStatsReapReady=sfpsSwitchPathStatsReapReady, sfpsServiceCenterPathEntry=sfpsServiceCenterPathEntry, sfpsSwitchPathStatsLocateUnk=sfpsSwitchPathStatsLocateUnk, sfpsSwitchPathTableFoundTime=sfpsSwitchPathTableFoundTime, sfpsSwitchPathStatsActiveLocal=sfpsSwitchPathStatsActiveLocal, sfpsServiceCenterPathAdminStatus=sfpsServiceCenterPathAdminStatus, sfpsSwitchPathTableRefTime=sfpsSwitchPathTableRefTime, sfpsPathAPIInPort=sfpsPathAPIInPort, sfpsSwitchPathAPIVerb=sfpsSwitchPathAPIVerb, sfpsSwitchPathTableIsStatic=sfpsSwitchPathTableIsStatic, sfpsServiceCenterPathTable=sfpsServiceCenterPathTable, sfpsSwitchPathStatsMemUsage=sfpsSwitchPathStatsMemUsage, sfpsSwitchPathTableIsActive=sfpsSwitchPathTableIsActive, sfpsChassisRIPPathNumReplyUnk=sfpsChassisRIPPathNumReplyUnk, sfpsSwitchPathStatsActiveRemote=sfpsSwitchPathStatsActiveRemote, sfpsSwitchPathTableSrcDblBackCnt=sfpsSwitchPathTableSrcDblBackCnt, sfpsPathMaskObjLastChangeTime=sfpsPathMaskObjLastChangeTime, sfpsSwitchPathStatsPathAck=sfpsSwitchPathStatsPathAck, sfpsSwitchPathAPIReapAt=sfpsSwitchPathAPIReapAt, sfpsServiceCenterPathHashLeaf=sfpsServiceCenterPathHashLeaf, sfpsStaticPathFloodEnabled=sfpsStaticPathFloodEnabled, sfpsPathMaskObjLogFloodNoINB=sfpsPathMaskObjLogFloodNoINB, sfpsSwitchPathStatsReapCount=sfpsSwitchPathStatsReapCount, sfpsPathAPIID=sfpsPathAPIID, sfpsSwitchPathStatsLocateReq=sfpsSwitchPathStatsLocateReq, sfpsSwitchPathTableIsLocal=sfpsSwitchPathTableIsLocal, sfpsSwitchPathStatsTableSize=sfpsSwitchPathStatsTableSize, sfpsPathMaskObjPhysPortMask=sfpsPathMaskObjPhysPortMask, sfpsPathAPISwitchMac=sfpsPathAPISwitchMac, sfpsSwitchPathStatsLocateNak=sfpsSwitchPathStatsLocateNak, sfpsPathMaskObjIsolatedSwitchMask=sfpsPathMaskObjIsolatedSwitchMask, sfpsSwitchPathTableRefCnt=sfpsSwitchPathTableRefCnt, sfpsPathAPIVerb=sfpsPathAPIVerb, sfpsPathMaskObjOldLogPortMask=sfpsPathMaskObjOldLogPortMask, sfpsServiceCenterPathOperStatus=sfpsServiceCenterPathOperStatus, sfpsPathMaskObjLogPortMask=sfpsPathMaskObjLogPortMask, sfpsSwitchPathTableSrcDblBackTime=sfpsSwitchPathTableSrcDblBackTime, sfpsServiceCenterPathResponses=sfpsServiceCenterPathResponses, sfpsSwitchPathStatsSndDblBack=sfpsSwitchPathStatsSndDblBack, sfpsSwitchPathStatsStaticRemote=sfpsSwitchPathStatsStaticRemote, sfpsChassisRIPPathNumRequests=sfpsChassisRIPPathNumRequests, sfpsPathAPIPortName=sfpsPathAPIPortName, sfpsChassisRIPPathNumReplyAck=sfpsChassisRIPPathNumReplyAck, sfpsSwitchPathTableLostTime=sfpsSwitchPathTableLostTime, sfpsStaticPathEntry=sfpsStaticPathEntry, sfpsServiceCenterPathRequests=sfpsServiceCenterPathRequests, sfpsPathMaskObjPathChangeEvent=sfpsPathMaskObjPathChangeEvent, sfpsSwitchPathTableLostCnt=sfpsSwitchPathTableLostCnt, sfpsSwitchPathStatsDeadRemote=sfpsSwitchPathStatsDeadRemote, sfpsSwitchPathTableFoundCnt=sfpsSwitchPathTableFoundCnt, sfpsPathMaskObjLogResolveMask=sfpsPathMaskObjLogResolveMask, sfpsSwitchPathTableEntry=sfpsSwitchPathTableEntry, sfpsServiceCenterPathMetric=sfpsServiceCenterPathMetric, sfpsSwitchPathAPIPort=sfpsSwitchPathAPIPort, sfpsPathAPIHop=sfpsPathAPIHop, sfpsPathMaskObjPhysFloodNoINB=sfpsPathMaskObjPhysFloodNoINB, sfpsSwitchPathTableRcvDblBackTime=sfpsSwitchPathTableRcvDblBackTime, sfpsSwitchPathStatsPathReq=sfpsSwitchPathStatsPathReq, sfpsPathAPIDstMac=sfpsPathAPIDstMac, sfpsSwitchPathTableDirReapCnt=sfpsSwitchPathTableDirReapCnt, sfpsSwitchPathStatsReapAt=sfpsSwitchPathStatsReapAt, sfpsStaticPathUplinkEnabled=sfpsStaticPathUplinkEnabled, sfpsPathMaskObjOverrideFloodMask=sfpsPathMaskObjOverrideFloodMask, sfpsPathMaskObjPathChangeCounter=sfpsPathMaskObjPathChangeCounter, sfpsPathMaskObjPathCounterReset=sfpsPathMaskObjPathCounterReset, sfpsSwitchPathAPIMaxRcvDblBack=sfpsSwitchPathAPIMaxRcvDblBack, sfpsPathAPISrcMac=sfpsPathAPISrcMac, sfpsServiceCenterPathName=sfpsServiceCenterPathName, sfpsSwitchPathStatsMaxEntries=sfpsSwitchPathStatsMaxEntries)
