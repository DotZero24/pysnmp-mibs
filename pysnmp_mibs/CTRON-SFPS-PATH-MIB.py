...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cabletron/CTRON-SFPS-PATH-MIB
...
mibBuilder.exportSymbols("CTRON-SFPS-PATH-MIB", HexInteger=HexInteger, sfpsServiceCenterPathHashLeaf=sfpsServiceCenterPathHashLeaf, sfpsSwitchPathStatsTableSize=sfpsSwitchPathStatsTableSize, sfpsSwitchPathAPIReapAt=sfpsSwitchPathAPIReapAt, sfpsPathAPIVerb=sfpsPathAPIVerb, sfpsSwitchPathTableSwitchMAC=sfpsSwitchPathTableSwitchMAC, sfpsSwitchPathTableSrcDblBackTime=sfpsSwitchPathTableSrcDblBackTime, sfpsSwitchPathTablePort=sfpsSwitchPathTablePort, sfpsSwitchPathStatsReapAt=sfpsSwitchPathStatsReapAt, sfpsPathMaskObjLogResolveMask=sfpsPathMaskObjLogResolveMask, sfpsStaticPathEntry=sfpsStaticPathEntry, sfpsServiceCenterPathEntry=sfpsServiceCenterPathEntry, sfpsSwitchPathStatsPathReq=sfpsSwitchPathStatsPathReq, sfpsServiceCenterPathTable=sfpsServiceCenterPathTable, sfpsSwitchPathStatsStaticRemote=sfpsSwitchPathStatsStaticRemote, sfpsPathMaskObjCoreUplinkMask=sfpsPathMaskObjCoreUplinkMask, sfpsPathMaskObjPathChangeCounter=sfpsPathMaskObjPathChangeCounter, sfpsSwitchPathTableRefTime=sfpsSwitchPathTableRefTime, sfpsSwitchPathStatsReapCount=sfpsSwitchPathStatsReapCount, sfpsPathAPIInPort=sfpsPathAPIInPort, sfpsServiceCenterPathOperStatus=sfpsServiceCenterPathOperStatus, sfpsPathAPISrcMac=sfpsPathAPISrcMac, sfpsSwitchPathStatsActiveRemote=sfpsSwitchPathStatsActiveRemote, sfpsSwitchPathStatsLocateNak=sfpsSwitchPathStatsLocateNak, sfpsServiceCenterPathAdminStatus=sfpsServiceCenterPathAdminStatus, sfpsPathAPIPortName=sfpsPathAPIPortName, sfpsPathMaskObjPhysResolveMask=sfpsPathMaskObjPhysResolveMask, sfpsPathMaskObjOldLogPortMask=sfpsPathMaskObjOldLogPortMask, sfpsSwitchPathAPIBaseMAC=sfpsSwitchPathAPIBaseMAC, sfpsPathMaskObjOverrideFloodMask=sfpsPathMaskObjOverrideFloodMask, sfpsSwitchPathTableRcvDblBackTime=sfpsSwitchPathTableRcvDblBackTime, sfpsPathMaskObjPathCounterReset=sfpsPathMaskObjPathCounterReset, sfpsStaticPathTable=sfpsStaticPathTable, sfpsSwitchPathStatsMaxEntries=sfpsSwitchPathStatsMaxEntries, sfpsSwitchPathTableLostCnt=sfpsSwitchPathTableLostCnt, sfpsSwitchPathTableIsLocal=sfpsSwitchPathTableIsLocal, sfpsServiceCenterPathResponses=sfpsServiceCenterPathResponses, sfpsSwitchPathStatsActiveLocal=sfpsSwitchPathStatsActiveLocal, sfpsSwitchPathStatsLocateAck=sfpsSwitchPathStatsLocateAck, sfpsServiceCenterPathRequests=sfpsServiceCenterPathRequests, sfpsStaticPathUplinkEnabled=sfpsStaticPathUplinkEnabled, sfpsPathMaskObjLogPortMask=sfpsPathMaskObjLogPortMask, sfpsPathAPICost=sfpsPathAPICost, sfpsSwitchPathStatsLocateReq=sfpsSwitchPathStatsLocateReq, sfpsSwitchPathTableFoundCnt=sfpsSwitchPathTableFoundCnt, sfpsChassisRIPPathNumReplyUnk=sfpsChassisRIPPathNumReplyUnk, sfpsServiceCenterPathName=sfpsServiceCenterPathName, sfpsPathMaskObjLogFloodNoINB=sfpsPathMaskObjLogFloodNoINB, sfpsChassisRIPPathNumInTable=sfpsChassisRIPPathNumInTable, sfpsChassisRIPPathNumRequests=sfpsChassisRIPPathNumRequests, sfpsPathMaskObjLastChangeTime=sfpsPathMaskObjLastChangeTime, sfpsSwitchPathTableLostTime=sfpsSwitchPathTableLostTime, sfpsPathMaskObjIsolatedSwitchMask=sfpsPathMaskObjIsolatedSwitchMask, sfpsStaticPathFloodEnabled=sfpsStaticPathFloodEnabled, sfpsSwitchPathTableSrcDblBackCnt=sfpsSwitchPathTableSrcDblBackCnt, sfpsSwitchPathStatsPathNak=sfpsSwitchPathStatsPathNak, sfpsSwitchPathAPIPort=sfpsSwitchPathAPIPort, sfpsSwitchPathTableRefCnt=sfpsSwitchPathTableRefCnt, sfpsSwitchPathTableRcvDblBackCnt=sfpsSwitchPathTableRcvDblBackCnt, sfpsSwitchPathStatsSndDblBack=sfpsSwitchPathStatsSndDblBack, sfpsSwitchPathTableIsStatic=sfpsSwitchPathTableIsStatic, SfpsAddress=SfpsAddress, sfpsSwitchPathAPIMaxRcvDblBack=sfpsSwitchPathAPIMaxRcvDblBack, sfpsStaticPathDownlinkEnabled=sfpsStaticPathDownlinkEnabled, sfpsSwitchPathTableFoundTime=sfpsSwitchPathTableFoundTime, sfpsSwitchPathStatsPathAck=sfpsSwitchPathStatsPathAck, sfpsStaticPathPort=sfpsStaticPathPort, sfpsPathAPIID=sfpsPathAPIID, sfpsSwitchPathTable=sfpsSwitchPathTable, sfpsSwitchPathTableIsActive=sfpsSwitchPathTableIsActive, sfpsSwitchPathTableDirReapCnt=sfpsSwitchPathTableDirReapCnt, sfpsServiceCenterPathMetric=sfpsServiceCenterPathMetric, sfpsSwitchPathStatsPathUnk=sfpsSwitchPathStatsPathUnk, sfpsChassisRIPPathNumReplyAck=sfpsChassisRIPPathNumReplyAck, sfpsSwitchPathStatsNumEntries=sfpsSwitchPathStatsNumEntries, sfpsSwitchPathTableEntry=sfpsSwitchPathTableEntry, sfpsSwitchPathStatsReapReady=sfpsSwitchPathStatsReapReady, sfpsPathAPIHop=sfpsPathAPIHop, sfpsSwitchPathStatsDeadLocal=sfpsSwitchPathStatsDeadLocal, sfpsPathMaskObjPathChangeEvent=sfpsPathMaskObjPathChangeEvent, sfpsSwitchPathStatsDeadRemote=sfpsSwitchPathStatsDeadRemote, sfpsSwitchPathStatsMemUsage=sfpsSwitchPathStatsMemUsage, sfpsSwitchPathTableDirReapTime=sfpsSwitchPathTableDirReapTime, sfpsPathMaskObjPhysPortMask=sfpsPathMaskObjPhysPortMask, sfpsSwitchPathStatsRcdDblBack=sfpsSwitchPathStatsRcdDblBack, sfpsSwitchPathStatsLocateUnk=sfpsSwitchPathStatsLocateUnk, sfpsPathAPIDstMac=sfpsPathAPIDstMac, sfpsPathMaskObjLogDownlinkMask=sfpsPathMaskObjLogDownlinkMask, sfpsPathMaskObjPyhsIsolatedSwitchMask=sfpsPathMaskObjPyhsIsolatedSwitchMask, sfpsPathAPISwitchMac=sfpsPathAPISwitchMac, sfpsServiceCenterPathStatusTime=sfpsServiceCenterPathStatusTime, sfpsSwitchPathAPIVerb=sfpsSwitchPathAPIVerb, sfpsPathMaskObjPhysFloodNoINB=sfpsPathMaskObjPhysFloodNoINB)
