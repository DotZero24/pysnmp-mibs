...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-Physicaldescription-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:40:17 2025
...
class PhdBeaconLightMode(Integer32):
    """Custom type PhdBeaconLightMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
rlPhdUnitGenParamMcuVersion = _RlPhdUnitGenParamMcuVersion_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 14, 1, 18),
    _RlPhdUnitGenParamMcuVersion_Type()
)
rlPhdUnitGenParamMcuVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlPhdUnitGenParamMcuVersion.setStatus("current")
...
rlPhdUnitEnvParamLedColor = _RlPhdUnitEnvParamLedColor_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 15, 1, 24),
    _RlPhdUnitEnvParamLedColor_Type()
)
rlPhdUnitEnvParamLedColor.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlPhdUnitEnvParamLedColor.setStatus("current")
...
rlCascadePortRow = _RlCascadePortRow_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 23, 1, 7),
    _RlCascadePortRow_Type()
)
rlCascadePortRow.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlCascadePortRow.setStatus("current")
_RlCascadePortColumn_Type = Integer32
_RlCascadePortColumn_Object = MibTableColumn
rlCascadePortColumn = _RlCascadePortColumn_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 23, 1, 8),
    _RlCascadePortColumn_Type()
)
rlCascadePortColumn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlCascadePortColumn.setStatus("current")


class _RlCascadePortMediaType_Type(Integer32):
    """Custom type rlCascadePortMediaType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_RlCascadePortMediaType_Type.__name__ = "Integer32"
_RlCascadePortMediaType_Object = MibTableColumn
rlCascadePortMediaType = _RlCascadePortMediaType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 23, 1, 9),
    _RlCascadePortMediaType_Type()
)
rlCascadePortMediaType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlCascadePortMediaType.setStatus("current")
...
rlCascadeSupportedPortList = _RlCascadeSupportedPortList_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 24, 1, 4),
    _RlCascadeSupportedPortList_Type()
)
rlCascadeSupportedPortList.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlCascadeSupportedPortList.setStatus("current")
...
class _RlPhdResetButtonStatus_Type(Integer32):
    """Custom type rlPhdResetButtonStatus based on Integer32"""
    defaultValue = 0
...
_RlPhdResetButtonStatus_Type.__name__ = "Integer32"
_RlPhdResetButtonStatus_Object = MibScalar
rlPhdResetButtonStatus = _RlPhdResetButtonStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 29),
    _RlPhdResetButtonStatus_Type()
)
rlPhdResetButtonStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlPhdResetButtonStatus.setStatus("current")
_RlPhdBeaconLightTable_Object = MibTable
rlPhdBeaconLightTable = _RlPhdBeaconLightTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 30)
)
if mibBuilder.loadTexts:
    rlPhdBeaconLightTable.setStatus("current")
_RlPhdBeaconLightEntry_Object = MibTableRow
rlPhdBeaconLightEntry = _RlPhdBeaconLightEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 30, 1)
)
rlPhdBeaconLightEntry.setIndexNames(
    (0, "CISCOSB-Physicaldescription-MIB", "rlPhdBeaconLightIndex"),
)
if mibBuilder.loadTexts:
    rlPhdBeaconLightEntry.setStatus("current")
_RlPhdBeaconLightIndex_Type = Integer32
_RlPhdBeaconLightIndex_Object = MibTableColumn
rlPhdBeaconLightIndex = _RlPhdBeaconLightIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 30, 1, 1),
    _RlPhdBeaconLightIndex_Type()
)
rlPhdBeaconLightIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlPhdBeaconLightIndex.setStatus("current")
_RlPhdBeaconLightPortList_Type = PortList
_RlPhdBeaconLightPortList_Object = MibTableColumn
rlPhdBeaconLightPortList = _RlPhdBeaconLightPortList_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 30, 1, 2),
    _RlPhdBeaconLightPortList_Type()
)
rlPhdBeaconLightPortList.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlPhdBeaconLightPortList.setStatus("current")
_RlPhdBeaconLightMode_Type = PhdBeaconLightMode
_RlPhdBeaconLightMode_Object = MibTableColumn
rlPhdBeaconLightMode = _RlPhdBeaconLightMode_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 30, 1, 3),
    _RlPhdBeaconLightMode_Type()
)
rlPhdBeaconLightMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlPhdBeaconLightMode.setStatus("current")


class _RlPhdBeaconLightDuration_Type(Unsigned32):
    """Custom type rlPhdBeaconLightDuration based on Unsigned32"""
    defaultValue = 300


_RlPhdBeaconLightDuration_Type.__name__ = "Unsigned32"
_RlPhdBeaconLightDuration_Object = MibTableColumn
rlPhdBeaconLightDuration = _RlPhdBeaconLightDuration_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 53, 30, 1, 4),
    _RlPhdBeaconLightDuration_Type()
)
rlPhdBeaconLightDuration.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlPhdBeaconLightDuration.setStatus("current")
...
rlPhdBeaconLightChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 0, 196)
)
rlPhdBeaconLightChange.setObjects(
      *(("CISCOSB-DEVICEPARAMS-MIB", "rndErrorDesc"),
        ("CISCOSB-DEVICEPARAMS-MIB", "rndErrorSeverity"))
)
if mibBuilder.loadTexts:
    rlPhdBeaconLightChange.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"CascadePortState": CascadePortState,
       ...
       "PhdBeaconLightMode": PhdBeaconLightMode,
       ...
       "rlPhdBeaconLightChange": rlPhdBeaconLightChange,
       ...
       "rlPhdUnitGenParamMcuVersion": rlPhdUnitGenParamMcuVersion,
       ...
       "rlPhdUnitEnvParamLedColor": rlPhdUnitEnvParamLedColor,
       ...
       "rlCascadePortRow": rlCascadePortRow,
       "rlCascadePortColumn": rlCascadePortColumn,
       "rlCascadePortMediaType": rlCascadePortMediaType,
       ...
       "rlCascadeSupportedPortList": rlCascadeSupportedPortList,
       ...
       "rlPhdResetButtonStatus": rlPhdResetButtonStatus,
       "rlPhdBeaconLightTable": rlPhdBeaconLightTable,
       "rlPhdBeaconLightEntry": rlPhdBeaconLightEntry,
       "rlPhdBeaconLightIndex": rlPhdBeaconLightIndex,
       "rlPhdBeaconLightPortList": rlPhdBeaconLightPortList,
       "rlPhdBeaconLightMode": rlPhdBeaconLightMode,
       "rlPhdBeaconLightDuration": rlPhdBeaconLightDuration}
)
