...
mibBuilder.exportSymbols("COLUBRIS-DEVICE-MIB", coDevStCpuUse20Sec=coDevStCpuUse20Sec, colubrisDeviceMIBCompliance=colubrisDeviceMIBCompliance, coDevInfoProductName=coDevInfoProductName, coDevStLoadAverage5Min=coDevStLoadAverage5Min, coDevInfoBootRevision=coDevInfoBootRevision, coDevStCpuUse10Sec=coDevStCpuUse10Sec, coDevDisIndex=coDevDisIndex, colubrisDeviceMIBGroups=colubrisDeviceMIBGroups, coDeviceSecurityFailureNotificationEnabled=coDeviceSecurityFailureNotificationEnabled, coDevDisState=coDevDisState, coDeviceInfoEntry=coDeviceInfoEntry, coDevInfoFirmwareRevision=coDevInfoFirmwareRevision, colubrisDeviceMIBCompliances=colubrisDeviceMIBCompliances, colubrisDeviceInformationMIBGroup=colubrisDeviceInformationMIBGroup, colubrisDeviceStatusMIBGroup=colubrisDeviceStatusMIBGroup, coDevStStorageUsePermanent=coDevStStorageUsePermanent, coDevDisControllerIndex=coDevDisControllerIndex, coDevDisSystemName=coDevDisSystemName, coDevDisContact=coDevDisContact, coDevInfoProductType=coDevInfoProductType, coDeviceDiscoveryEntry=coDeviceDiscoveryEntry, colubrisDeviceMIBNotificationPrefix=colubrisDeviceMIBNotificationPrefix, coDevStRamFree=coDevStRamFree, PYSNMP_MODULE_ID=colubrisDeviceMIB, coDeviceAuthorizationFailureNotificationEnabled=coDeviceAuthorizationFailureNotificationEnabled, coDevStLoadAverage1Min=coDevStLoadAverage1Min, coDeviceConfigurationFailureNotification=coDeviceConfigurationFailureNotification, colubrisDeviceMIBNotifications=colubrisDeviceMIBNotifications, coDeviceInfoTable=coDeviceInfoTable, coDeviceAuthorizationFailureNotification=coDeviceAuthorizationFailureNotification, coDeviceStateChangeNotification=coDeviceStateChangeNotification, colubrisDeviceDiscoveryMIBGroup=colubrisDeviceDiscoveryMIBGroup, coDevDisGroupName=coDevDisGroupName, colubrisDeviceMIB=colubrisDeviceMIB, coDeviceStatusEntry=coDeviceStatusEntry, coDevDisSerialNumber=coDevDisSerialNumber, coDevDisIpAddress=coDevDisIpAddress, coDevDisConnectionTime=coDevDisConnectionTime, coDeviceFirmwareFailureNotificationEnabled=coDeviceFirmwareFailureNotificationEnabled, coDevStRamCached=coDevStRamCached, coDeviceConfigGroup=coDeviceConfigGroup, coDeviceDiscoveryTable=coDeviceDiscoveryTable, coDevInfoHardwareRevision=coDevInfoHardwareRevision, colubrisDeviceMIBObjects=colubrisDeviceMIBObjects, coDeviceStatusTable=coDeviceStatusTable, coDevStLoadAverage15Min=coDevStLoadAverage15Min, colubrisDeviceMIBConformance=colubrisDeviceMIBConformance, coDevDisMacAddress=coDevDisMacAddress, coDevStCpuUse5Sec=coDevStCpuUse5Sec, coDevStUpTime=coDevStUpTime, coDevStRamBuffer=coDevStRamBuffer, coDevDisLocation=coDevDisLocation, coDeviceDiscoveryGroup=coDeviceDiscoveryGroup, coDeviceStateChangeNotificationEnabled=coDeviceStateChangeNotificationEnabled, coDevStRamTotal=coDevStRamTotal, coDevStStorageUseTemporary=coDevStStorageUseTemporary, coDeviceStatusGroup=coDeviceStatusGroup, coDeviceConfigurationFailureNotificationEnabled=coDeviceConfigurationFailureNotificationEnabled, coDeviceFirmwareFailureNotification=coDeviceFirmwareFailureNotification, colubrisDeviceConfigMIBGroup=colubrisDeviceConfigMIBGroup, coDevStCpuUseNow=coDevStCpuUseNow, coDeviceSecurityFailureNotification=coDeviceSecurityFailureNotification, coDeviceInformationGroup=coDeviceInformationGroup, colubrisDeviceNotificationGroup=colubrisDeviceNotificationGroup)
