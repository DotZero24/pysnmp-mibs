# SNMP MIB module (ARICENT-IPSECV6-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-IPSECV6-MIB
...
fsIpv6SecSelectorEntry = _FsIpv6SecSelectorEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 29, 2, 1, 1)
)
fsIpv6SecSelectorEntry.setIndexNames(
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SelIfIndex"),
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SelProtoIndex"),
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SelAccessIndex"),
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SelPort"),
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SelPktDirection"),
)
if mibBuilder.loadTexts:
...
fsIpv6SecAccessEntry = _FsIpv6SecAccessEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 29, 2, 2, 1)
)
fsIpv6SecAccessEntry.setIndexNames(
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SecAccessIndex"),
)
if mibBuilder.loadTexts:
...
fsIpv6SecPolicyEntry = _FsIpv6SecPolicyEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 29, 2, 3, 1)
)
fsIpv6SecPolicyEntry.setIndexNames(
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SecPolicyIndex"),
)
if mibBuilder.loadTexts:
...
fsipv6SecAssocEntry = _Fsipv6SecAssocEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 29, 2, 4, 1)
)
fsipv6SecAssocEntry.setIndexNames(
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SecAssocIndex"),
)
if mibBuilder.loadTexts:
...
fsIpv6SecIfStatsEntry = _FsIpv6SecIfStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 29, 3, 1, 1)
)
fsIpv6SecIfStatsEntry.setIndexNames(
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SecIfIndex"),
)
if mibBuilder.loadTexts:
...
fsIpv6SecAhEspStatsEntry = _FsIpv6SecAhEspStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 29, 3, 2, 1)
)
fsIpv6SecAhEspStatsEntry.setIndexNames(
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SecAhEspIfIndex"),
)
if mibBuilder.loadTexts:
...
fsIpv6SecAhEspIntruEntry = _FsIpv6SecAhEspIntruEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 29, 3, 3, 1)
)
fsIpv6SecAhEspIntruEntry.setIndexNames(
    (0, "ARICENT-IPSECV6-MIB", "fsipv6SecAhEspIntruIndex"),
)
if mibBuilder.loadTexts:
