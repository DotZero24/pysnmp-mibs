...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-DOT11S-MESH-MIB
...
_H3cDot11sMeshPflBindIntNum_Type.__name__ = "Integer32"
...
_H3cDot11sMeshMkdServEnable_Type.__name__ = "TruthValue"
...
_H3cDot11sMeshPflEnable_Type.__name__ = "TruthValue"
...
class _H3cDot11sMeshAKMMode_Type(H3cDot11AKMType):
    """Custom type h3cDot11sMeshAKMMode based on H3cDot11AKMType"""
    defaultValue = 1


_H3cDot11sMeshAKMMode_Type.__name__ = "H3cDot11AKMType"
_H3cDot11sMeshAKMMode_Object = MibTableColumn
h3cDot11sMeshAKMMode = _H3cDot11sMeshAKMMode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 1, 2, 1, 9),
    _H3cDot11sMeshAKMMode_Type()
)
h3cDot11sMeshAKMMode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cDot11sMeshAKMMode.setStatus("current")
_H3cDot11sMeshSimpleKey_Type = OctetString
_H3cDot11sMeshSimpleKey_Object = MibTableColumn
h3cDot11sMeshSimpleKey = _H3cDot11sMeshSimpleKey_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 1, 2, 1, 10),
    _H3cDot11sMeshSimpleKey_Type()
)
h3cDot11sMeshSimpleKey.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cDot11sMeshSimpleKey.setStatus("current")
...
_H3cDot11sMpPlcyInitEnable_Type.__name__ = "TruthValue"
...
_H3cDot11sMlspEnable_Type.__name__ = "TruthValue"
...
_H3cDot11sRoleAuthEnable_Type.__name__ = "TruthValue"
...
_H3cDot11sMeshPflMap_Type.__name__ = "Integer32"
...
_H3cDot11sMpPlcyMap_Type.__name__ = "Integer32"
...
class _H3cDot11sBindInterface_Type(Integer32):
    """Custom type h3cDot11sBindInterface based on Integer32"""
    defaultValue = -1


_H3cDot11sBindInterface_Type.__name__ = "Integer32"
_H3cDot11sBindInterface_Object = MibTableColumn
h3cDot11sBindInterface = _H3cDot11sBindInterface_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 1, 5, 1, 4),
    _H3cDot11sBindInterface_Type()
)
h3cDot11sBindInterface.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cDot11sBindInterface.setStatus("current")
...
_H3cDot11sPortalEnable_Type.__name__ = "TruthValue"
...
class _H3cDot11sMeshLinkType_Type(Integer32):
    """Custom type h3cDot11sMeshLinkType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cDot11sMeshLinkType_Type.__name__ = "Integer32"
_H3cDot11sMeshLinkType_Object = MibTableColumn
h3cDot11sMeshLinkType = _H3cDot11sMeshLinkType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 3, 1, 1, 6),
    _H3cDot11sMeshLinkType_Type()
)
h3cDot11sMeshLinkType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11sMeshLinkType.setStatus("current")
_H3cDot11sMeshLinkSNR_Type = Integer32
_H3cDot11sMeshLinkSNR_Object = MibTableColumn
h3cDot11sMeshLinkSNR = _H3cDot11sMeshLinkSNR_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 3, 1, 1, 7),
    _H3cDot11sMeshLinkSNR_Type()
)
h3cDot11sMeshLinkSNR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11sMeshLinkSNR.setStatus("current")
if mibBuilder.loadTexts:
    h3cDot11sMeshLinkSNR.setUnits("percent")
_H3cDot11sMeshLinkNoise_Type = Integer32
_H3cDot11sMeshLinkNoise_Object = MibTableColumn
h3cDot11sMeshLinkNoise = _H3cDot11sMeshLinkNoise_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 3, 1, 1, 8),
    _H3cDot11sMeshLinkNoise_Type()
)
h3cDot11sMeshLinkNoise.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11sMeshLinkNoise.setStatus("current")
_H3cDot11sMeshLinkPeerSNR_Type = Integer32
_H3cDot11sMeshLinkPeerSNR_Object = MibTableColumn
h3cDot11sMeshLinkPeerSNR = _H3cDot11sMeshLinkPeerSNR_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 3, 1, 1, 9),
    _H3cDot11sMeshLinkPeerSNR_Type()
)
h3cDot11sMeshLinkPeerSNR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11sMeshLinkPeerSNR.setStatus("current")
if mibBuilder.loadTexts:
    h3cDot11sMeshLinkPeerSNR.setUnits("percent")
_H3cDot11sMeshLinkPeerNoise_Type = Integer32
_H3cDot11sMeshLinkPeerNoise_Object = MibTableColumn
h3cDot11sMeshLinkPeerNoise = _H3cDot11sMeshLinkPeerNoise_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 3, 1, 1, 10),
    _H3cDot11sMeshLinkPeerNoise_Type()
)
h3cDot11sMeshLinkPeerNoise.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11sMeshLinkPeerNoise.setStatus("current")
_H3cDot11sMeshLinkPeerIPAddress_Type = IpAddress
_H3cDot11sMeshLinkPeerIPAddress_Object = MibTableColumn
h3cDot11sMeshLinkPeerIPAddress = _H3cDot11sMeshLinkPeerIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 3, 1, 1, 11),
    _H3cDot11sMeshLinkPeerIPAddress_Type()
)
h3cDot11sMeshLinkPeerIPAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11sMeshLinkPeerIPAddress.setStatus("current")
_H3cDot11sMeshLinkPeerSystemName_Type = OctetString
_H3cDot11sMeshLinkPeerSystemName_Object = MibTableColumn
h3cDot11sMeshLinkPeerSystemName = _H3cDot11sMeshLinkPeerSystemName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 11, 3, 1, 1, 12),
    _H3cDot11sMeshLinkPeerSystemName_Type()
)
h3cDot11sMeshLinkPeerSystemName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11sMeshLinkPeerSystemName.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"h3cDot11sMesh": h3cDot11sMesh,
       ...
       "h3cDot11sMeshAKMMode": h3cDot11sMeshAKMMode,
       "h3cDot11sMeshSimpleKey": h3cDot11sMeshSimpleKey,
       ...
       "h3cDot11sBindInterface": h3cDot11sBindInterface,
       ...
       "h3cDot11sMeshLinkType": h3cDot11sMeshLinkType,
       "h3cDot11sMeshLinkSNR": h3cDot11sMeshLinkSNR,
       "h3cDot11sMeshLinkNoise": h3cDot11sMeshLinkNoise,
       "h3cDot11sMeshLinkPeerSNR": h3cDot11sMeshLinkPeerSNR,
       "h3cDot11sMeshLinkPeerNoise": h3cDot11sMeshLinkPeerNoise,
