...
# Notes
# -----
# ASN.1 source file://mibs/avaya/APPLIC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:04:41 2025
...
lseIntPortMACVlanTable = _LseIntPortMACVlanTable_Object(
    (1, 3, 6, 1, 4, 1, 81, 19, 1, 2, 4)
)
if mibBuilder.loadTexts:
    lseIntPortMACVlanTable.setStatus("mandatory")
_LseIntPortMACVlanEntry_Object = MibTableRow
lseIntPortMACVlanEntry = _LseIntPortMACVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 81, 19, 1, 2, 4, 1)
)
lseIntPortMACVlanEntry.setIndexNames(
    (0, "APPLIC-MIB", "lseIntPortMACVlanGroupId"),
    (0, "APPLIC-MIB", "lseIntPortMACAddPortId"),
    (0, "APPLIC-MIB", "lseIntPortMACVlanVlan"),
    (0, "APPLIC-MIB", "lseIntPortMACVlanLAId"),
)
if mibBuilder.loadTexts:
    lseIntPortMACVlanEntry.setStatus("mandatory")


class _LseIntPortMACVlanGroupId_Type(Integer32):
    """Custom type lseIntPortMACVlanGroupId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_LseIntPortMACVlanGroupId_Type.__name__ = "Integer32"
_LseIntPortMACVlanGroupId_Object = MibTableColumn
lseIntPortMACVlanGroupId = _LseIntPortMACVlanGroupId_Object(
    (1, 3, 6, 1, 4, 1, 81, 19, 1, 2, 4, 1, 1),
    _LseIntPortMACVlanGroupId_Type()
)
lseIntPortMACVlanGroupId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    lseIntPortMACVlanGroupId.setStatus("mandatory")


class _LseIntPortMACVlanPortId_Type(Integer32):
    """Custom type lseIntPortMACVlanPortId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_LseIntPortMACVlanPortId_Type.__name__ = "Integer32"
_LseIntPortMACVlanPortId_Object = MibTableColumn
lseIntPortMACVlanPortId = _LseIntPortMACVlanPortId_Object(
    (1, 3, 6, 1, 4, 1, 81, 19, 1, 2, 4, 1, 2),
    _LseIntPortMACVlanPortId_Type()
)
lseIntPortMACVlanPortId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lseIntPortMACVlanPortId.setStatus("mandatory")


class _LseIntPortMACVlanVlan_Type(Integer32):
    """Custom type lseIntPortMACVlanVlan based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_LseIntPortMACVlanVlan_Type.__name__ = "Integer32"
_LseIntPortMACVlanVlan_Object = MibTableColumn
lseIntPortMACVlanVlan = _LseIntPortMACVlanVlan_Object(
    (1, 3, 6, 1, 4, 1, 81, 19, 1, 2, 4, 1, 3),
    _LseIntPortMACVlanVlan_Type()
)
lseIntPortMACVlanVlan.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lseIntPortMACVlanVlan.setStatus("mandatory")


class _LseIntPortMACVlanLAId_Type(Integer32):
    """Custom type lseIntPortMACVlanLAId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_LseIntPortMACVlanLAId_Type.__name__ = "Integer32"
_LseIntPortMACVlanLAId_Object = MibTableColumn
lseIntPortMACVlanLAId = _LseIntPortMACVlanLAId_Object(
    (1, 3, 6, 1, 4, 1, 81, 19, 1, 2, 4, 1, 4),
    _LseIntPortMACVlanLAId_Type()
)
lseIntPortMACVlanLAId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lseIntPortMACVlanLAId.setStatus("mandatory")


class _LseIntPortMACVlanMAClist_Type(OctetString):
    """Custom type lseIntPortMACVlanMAClist based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 452),
    )


_LseIntPortMACVlanMAClist_Type.__name__ = "OctetString"
_LseIntPortMACVlanMAClist_Object = MibTableColumn
lseIntPortMACVlanMAClist = _LseIntPortMACVlanMAClist_Object(
    (1, 3, 6, 1, 4, 1, 81, 19, 1, 2, 4, 1, 5),
    _LseIntPortMACVlanMAClist_Type()
)
lseIntPortMACVlanMAClist.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lseIntPortMACVlanMAClist.setStatus("mandatory")
...
vnsPacketExpectedIfName = _VnsPacketExpectedIfName_Object(
    (1, 3, 6, 1, 4, 1, 81, 19, 7, 1, 1, 13),
    _VnsPacketExpectedIfName_Type()
)
vnsPacketExpectedIfName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vnsPacketExpectedIfName.setStatus("mandatory")
_VnsPacketDetectedIfName_Type = DisplayString
_VnsPacketDetectedIfName_Object = MibTableColumn
vnsPacketDetectedIfName = _VnsPacketDetectedIfName_Object(
    (1, 3, 6, 1, 4, 1, 81, 19, 7, 1, 1, 14),
    _VnsPacketDetectedIfName_Type()
)
vnsPacketDetectedIfName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vnsPacketDetectedIfName.setStatus("mandatory")
...
_TopDiscoveryTimeOut_Type.__name__ = "Integer32"
...
mibBuilder.exportSymbols(
    ...
    **{"lntLanSwitch": lntLanSwitch,
       ...
       "lseIntPortMACVlanTable": lseIntPortMACVlanTable,
       "lseIntPortMACVlanEntry": lseIntPortMACVlanEntry,
       "lseIntPortMACVlanGroupId": lseIntPortMACVlanGroupId,
       "lseIntPortMACVlanPortId": lseIntPortMACVlanPortId,
       "lseIntPortMACVlanVlan": lseIntPortMACVlanVlan,
       "lseIntPortMACVlanLAId": lseIntPortMACVlanLAId,
       "lseIntPortMACVlanMAClist": lseIntPortMACVlanMAClist,
       "lsePort": lsePort,
       ...
       "vnsPacketExpectedIfName": vnsPacketExpectedIfName,
       "vnsPacketDetectedIfName": vnsPacketDetectedIfName,
