...
mibBuilder.exportSymbols("APPLIC-MIB", lsHistorySampleIndex=lsHistorySampleIndex, lsPortExtendedStatsTable=lsPortExtendedStatsTable, lseIntPortGlobalSuperNet=lseIntPortGlobalSuperNet, lsPortExtendedStatsEntry=lsPortExtendedStatsEntry, vnsPacketIPNetMask=vnsPacketIPNetMask, ethTopMACFindResultEntry=ethTopMACFindResultEntry, lsPortFilterTableClear=lsPortFilterTableClear, lhsGroupId=lhsGroupId, lsBusStatsVirtualNetOctets=lsBusStatsVirtualNetOctets, ethTopLSATable=ethTopLSATable, lsPortControlTableSize=lsPortControlTableSize, vnsPacketProtocolTypeMask=vnsPacketProtocolTypeMask, lseGroupCAMClear=lseGroupCAMClear, lhs=lhs, lstIntPortRxEmpty2=lstIntPortRxEmpty2, ethTopAddressEntry=ethTopAddressEntry, vnsPacketExpectedVLAN=vnsPacketExpectedVLAN, lsMonitor=lsMonitor, lsBusStatsGoodEthOctets=lsBusStatsGoodEthOctets, lntLanSwitch=lntLanSwitch, lseIntPortMACAddList=lseIntPortMACAddList, lstIntPortRxEmpty0=lstIntPortRxEmpty0, lseIntPortTable=lseIntPortTable, lhsRxMCast=lhsRxMCast, lsHistoryStatsOctets=lsHistoryStatsOctets, lstIntPortRxFull=lstIntPortRxFull, lsPortControlEntry=lsPortControlEntry, lsPortFilterEntry=lsPortFilterEntry, lsMatrixFilterStatus=lsMatrixFilterStatus, lsPortControlTable=lsPortControlTable, scPortHistoryBadPkts=scPortHistoryBadPkts, lstIntPortOutTraffic=lstIntPortOutTraffic, lstIntPortOutOctets=lstIntPortOutOctets, lseIntPortMACVlanTable=lseIntPortMACVlanTable, portHistory=portHistory, lsHostFilterEntry=lsHostFilterEntry, lsePortPolarity=lsePortPolarity, lsePortId=lsePortId, lseIntPortJabber=lseIntPortJabber, lseIntPortSuperPriority=lseIntPortSuperPriority, lsHistoryIndex=lsHistoryIndex, lseIntPortFilteringMethod=lseIntPortFilteringMethod, lseIntPortCompanyMAC=lseIntPortCompanyMAC, lsPortInPkts=lsPortInPkts, ethTopMessageResultId=ethTopMessageResultId, ethTopClearMessageResult=ethTopClearMessageResult, lseIntPort=lseIntPort, lseIntPortMACAddPortId=lseIntPortMACAddPortId, lseWANGroupId=lseWANGroupId, lseGroupCParameter=lseGroupCParameter, ethTopAddress=ethTopAddress, lseIntPortRxSafetyZone=lseIntPortRxSafetyZone, lseIntPortRxEmpty2=lseIntPortRxEmpty2, lsHistoryStatsBadEthOctets=lsHistoryStatsBadEthOctets, ethTopLSAEntry=ethTopLSAEntry, lsHistoryEntry=lsHistoryEntry, lsBusStatsGoodEthPkts=lsBusStatsGoodEthPkts, lseIntPortFilterGroupId=lseIntPortFilterGroupId, lsPortControlStatus=lsPortControlStatus, lseIntPortFilter=lseIntPortFilter, lseIntPortRxEmpty0=lseIntPortRxEmpty0, lsVNChangeGroup=lsVNChangeGroup, smon=smon, lseIntPortMACAddEntry=lseIntPortMACAddEntry, alarmMonitorStatusTable=alarmMonitorStatusTable, lseIntPortMACAddLAId=lseIntPortMACAddLAId, lstIntPortPurgeFrames=lstIntPortPurgeFrames, lsMatrixFilterTable=lsMatrixFilterTable, lseGroupJamPrevent=lseGroupJamPrevent, lseGroupIPGJamLength=lseGroupIPGJamLength, lseGroupSetDefaults=lseGroupSetDefaults, lsHostFilterStatus=lsHostFilterStatus, vnsPacket=vnsPacket, lseGroupEnableHSBReset=lseGroupEnableHSBReset, lstIntPortMACAddress=lstIntPortMACAddress, alarmMonitorStatus=alarmMonitorStatus, lseIntPortVideoPacket=lseIntPortVideoPacket, lseGroupHSBMonStatus=lseGroupHSBMonStatus, lsBusStatsNonEthPkts=lsBusStatsNonEthPkts, lseIntPortMACAddress=lseIntPortMACAddress, ethTopHSBMonitor=ethTopHSBMonitor, lseGroupAutoPartitionEnable=lseGroupAutoPartitionEnable, lhsTxUCast=lhsTxUCast, portHistoryExtendedControlLastBucketIndex=portHistoryExtendedControlLastBucketIndex, hostTimePortConnection=hostTimePortConnection, lstIntPortRouteSideband=lstIntPortRouteSideband, scPortHistoryGoodPktsRec=scPortHistoryGoodPktsRec, lseIntPortTransmitWeight=lseIntPortTransmitWeight, lsPortHistoryEntry=lsPortHistoryEntry, lstIntPortGroupId=lstIntPortGroupId, lsPortHistoryCollisions=lsPortHistoryCollisions, lseIntPortId=lseIntPortId, lseIntPortLearnIOCAM=lseIntPortLearnIOCAM, alarmUtilitiesCommand=alarmUtilitiesCommand, lseGroupWorkState=lseGroupWorkState, lseIntPortTxBurstLength=lseIntPortTxBurstLength, lstIntPortLostFrames=lstIntPortLostFrames, lstIntPortNormalPriority=lstIntPortNormalPriority, lsPortNumber=lsPortNumber, lhsTxMCast=lhsTxMCast, lseGroupAssignSlots=lseGroupAssignSlots, vnsPacketMACAddress=vnsPacketMACAddress, lsPortInBroadcastPkts=lsPortInBroadcastPkts, scPortHistoryTable=scPortHistoryTable, lsHistoryBusUtilization=lsHistoryBusUtilization, lseIntPortMACAdd=lseIntPortMACAdd, vnsPacketIPAddress=vnsPacketIPAddress, lsPortInMulticastPkts=lsPortInMulticastPkts, lsBusStatsOctets=lsBusStatsOctets, lsBusStatsVirtualNetPackets=lsBusStatsVirtualNetPackets, scPortHistoryIndex=scPortHistoryIndex, topDiscoveryTimeOut=topDiscoveryTimeOut, lsPortHistoryTable=lsPortHistoryTable, lsBusStatsNonEthOctets=lsBusStatsNonEthOctets, lhsGroupEntry=lhsGroupEntry, lseGroup10MSqlt=lseGroup10MSqlt, lsBusStatsBadEthOctets=lsBusStatsBadEthOctets, ethTopDiscoveryTx=ethTopDiscoveryTx, lseIntPortClearFilter=lseIntPortClearFilter, lstIntPortClaimFrames=lstIntPortClaimFrames, lsBusStatsEthBroadcastPkts=lsBusStatsEthBroadcastPkts, lseGroupBackbone12=lseGroupBackbone12, lsPortTable=lsPortTable, lhsTxUrunErr=lhsTxUrunErr, lstIntPortTxConsecutiveBusiesThresh=lstIntPortTxConsecutiveBusiesThresh, lsBusStats=lsBusStats, lseIntPortEntry=lseIntPortEntry, lsMatrixFilterAddress=lsMatrixFilterAddress, lstIntPortIPGLength=lstIntPortIPGLength, portHistoryExtendedControlTable=portHistoryExtendedControlTable, portHistoryExtendedControlName=portHistoryExtendedControlName, lsHostPortFilterEntry=lsHostPortFilterEntry, lsPortHistoryIndex=lsPortHistoryIndex, lsPortHistoryPkts=lsPortHistoryPkts, lsePortEntry=lsePortEntry, lsPortInTooLongPkts=lsPortInTooLongPkts, lsHistoryStatsPriority2Octets=lsHistoryStatsPriority2Octets, lsHistoryStatsPriority1Pkts=lsHistoryStatsPriority1Pkts, lhsTxParErr=lhsTxParErr, topDiscovery=topDiscovery, ethTop=ethTop, alarms=alarms, lstIntPortSMPTransmitEnable=lstIntPortSMPTransmitEnable, lstIntPortId=lstIntPortId, vnsPacketPortGroupId=vnsPacketPortGroupId, lseIntPortMACVlanGroupId=lseIntPortMACVlanGroupId, lseIntPortMACVlanMAClist=lseIntPortMACVlanMAClist, vnsPacketEntry=vnsPacketEntry, lsBusStatsPriorityIndex=lsBusStatsPriorityIndex, lsHistoryStatsPriority3Octets=lsHistoryStatsPriority3Octets, ethTopLSAId=ethTopLSAId, lsePortGroupId=lsePortGroupId, portHistoryExtendedControlCreateTime=portHistoryExtendedControlCreateTime, lseIntPortRetryPriorityLevel1=lseIntPortRetryPriorityLevel1, lstIntPortBlockingPriority=lstIntPortBlockingPriority, lseIntPortCAM=lseIntPortCAM, lsBusStatsPriorityEntry=lsBusStatsPriorityEntry, lseWANTable=lseWANTable, vnsPacketBackbonePort=vnsPacketBackbonePort, lsHostPortFilterTableClear=lsHostPortFilterTableClear, lhsPortTable=lhsPortTable, lstIntPortInTraffic=lstIntPortInTraffic, lstIntPortBPTokenWindow=lstIntPortBPTokenWindow, lseIntPortRxReject=lseIntPortRxReject, vnsPacketBoxAgentIP=vnsPacketBoxAgentIP, hostTimeAddress=hostTimeAddress, lsBusStatsPkts=lsBusStatsPkts, lseGroupSmartSqlt=lseGroupSmartSqlt, lseGroupBITResult=lseGroupBITResult, lsPortControlOwner=lsPortControlOwner, lstIntPortNormallyCloseOpen=lstIntPortNormallyCloseOpen, ethTopNumOfMessageResults=ethTopNumOfMessageResults, lseIntPortAlignment=lseIntPortAlignment, lseGroupBackbone34=lseGroupBackbone34, lseIntPortTxSafetyZone=lseIntPortTxSafetyZone, lsVNChangePort=lsVNChangePort, lsBusStatsUtilization=lsBusStatsUtilization, lsBusStatsDropEvents=lsBusStatsDropEvents, lsPortInTotalErrors=lsPortInTotalErrors, lseGroupActiveMonitor=lseGroupActiveMonitor, lsHistoryStatsDropEvents=lsHistoryStatsDropEvents, ethTopMACFindResult=ethTopMACFindResult, lsHistoryTable=lsHistoryTable, lsHostTimePortCorrEntry=lsHostTimePortCorrEntry, hostTimeCreationOrder=hostTimeCreationOrder, lseIntPortSecurity=lseIntPortSecurity, lsHostTimePortCorrTable=lsHostTimePortCorrTable, lsBusStatsVirtualNetList=lsBusStatsVirtualNetList, scPortHistoryEntry=scPortHistoryEntry, ethTopMessageResult=ethTopMessageResult, lsHostPortFilterStatus=lsHostPortFilterStatus, lseIntPortCopiedPort=lseIntPortCopiedPort, lsMonitorResourceAllocation=lsMonitorResourceAllocation, lsBusStatsPriorityOctets=lsBusStatsPriorityOctets, lsHostFilterAddress=lsHostFilterAddress, lsHistoryIntervalTime=lsHistoryIntervalTime, lse=lse, lhsPortGroupId=lhsPortGroupId, lsPortControlIndex=lsPortControlIndex, lsVNChangeExpected=lsVNChangeExpected, lstIntPortInOctets=lstIntPortInOctets, lseIntPortRetryPriorityLevel3=lseIntPortRetryPriorityLevel3, lstIntPortSidebandMode=lstIntPortSidebandMode, lseIntPortBroadcastBehavior=lseIntPortBroadcastBehavior, lhsRxRscErr=lhsRxRscErr, lsBusStatsVirtualNet=lsBusStatsVirtualNet, lsHistoryStatsNonEthPkts=lsHistoryStatsNonEthPkts, lseWANConnection=lseWANConnection, lhsPortId=lhsPortId, lseIntPortIOMode=lseIntPortIOMode, lseWANPortId=lseWANPortId, ethTopMACFindResultTable=ethTopMACFindResultTable, scPortHistoryCollisions=scPortHistoryCollisions, lsHistoryStatsPriority3Pkts=lsHistoryStatsPriority3Pkts, lsMatrixFilterEntry=lsMatrixFilterEntry, lstIntPortTransmitWindow=lstIntPortTransmitWindow, lsPortHistoryIntervalTime=lsPortHistoryIntervalTime, lsPortHistoryBoxConfiguration=lsPortHistoryBoxConfiguration, lsePort=lsePort, lseIntPortRxEmpty1=lseIntPortRxEmpty1, lsBusStatsVirtualNetTable=lsBusStatsVirtualNetTable, lstIntPortTotalOctets=lstIntPortTotalOctets, lsHistoryStatsPriority4Pkts=lsHistoryStatsPriority4Pkts, vnsPacketPortId=vnsPacketPortId, lstIntPortTotalFrames=lstIntPortTotalFrames, lstIntPortEntry=lstIntPortEntry, lseIntPortGlobal=lseIntPortGlobal, lhsRxParErr=lhsRxParErr, lsPortOutPkts=lsPortOutPkts, lsHistoryStatsPkts=lsHistoryStatsPkts, lseGroupEntry=lseGroupEntry, vnsPacketIPXnetwork=vnsPacketIPXnetwork, lsBusStatsPriorityPkts=lsBusStatsPriorityPkts, lseIntPortMACAddTable=lseIntPortMACAddTable, scPortHistoryIntervalTime=scPortHistoryIntervalTime, lsHostFilterTableClear=lsHostFilterTableClear, lstIntPortTable=lstIntPortTable, lseIntPortMACVlanEntry=lseIntPortMACVlanEntry, lsPortFilterStatus=lsPortFilterStatus, lseIntPortMACVlanLAId=lseIntPortMACVlanLAId, ethTopMACFindList=ethTopMACFindList, lhsGroupTable=lhsGroupTable, portHistoryMemoryAvailability=portHistoryMemoryAvailability, lseIntPortFilterList=lseIntPortFilterList, hostTimeIndex=hostTimeIndex, ethTopMACFindBus=ethTopMACFindBus, lsBusStatsMulticastPkts=lsBusStatsMulticastPkts, lsMatrixFilterTableClear=lsMatrixFilterTableClear, lsPortExtendedStatsNumber=lsPortExtendedStatsNumber, lseIntPortFilterTable=lseIntPortFilterTable, lseIntPortIgnoreBusy=lseIntPortIgnoreBusy, lsBusStatsVirtualNetEntry=lsBusStatsVirtualNetEntry, lseIntPortFilterPortId=lseIntPortFilterPortId, portHistoryExtendedControlNumberOfBuckets=portHistoryExtendedControlNumberOfBuckets)
mibBuilder.exportSymbols("APPLIC-MIB", scPortHistoryGoodPktsSent=scPortHistoryGoodPktsSent, lhsRxOrunErr=lhsRxOrunErr, lseGroupBackoffFromJam=lseGroupBackoffFromJam, lsHistoryStatsEthBroadcastPkts=lsHistoryStatsEthBroadcastPkts, lseGroupJamLength=lseGroupJamLength, scPortHistorySampleIndex=scPortHistorySampleIndex, lstIntPortUNAddr=lstIntPortUNAddr, lsVNChange=lsVNChange, lsPortHistoryTotalErrors=lsPortHistoryTotalErrors, lseIntPortResetSwitchCAM=lseIntPortResetSwitchCAM, ethTopAddressTable=ethTopAddressTable, lsPortInCollisions=lsPortInCollisions, lsePortTable=lsePortTable, lsPortControlLastDeleteTime=lsPortControlLastDeleteTime, lseIntPortTxReject=lseIntPortTxReject, lsBusStatsBadEthPkts=lsBusStatsBadEthPkts, lstIntPortTotalTraffic=lstIntPortTotalTraffic, lstIntPortLocalOctets=lstIntPortLocalOctets, lsPortHistorySampleIndex=lsPortHistorySampleIndex, lhsRxBadTypeErr=lhsRxBadTypeErr, lsPortEntry=lsPortEntry, lseIntPortPriorityStateMachine=lseIntPortPriorityStateMachine, lseIntPortIgnoreRoutingMode=lseIntPortIgnoreRoutingMode, lsPortIndex=lsPortIndex, lsPortFilterTable=lsPortFilterTable, lseIntPortIgnoreProtocolType=lseIntPortIgnoreProtocolType, lsHistoryStatsGoodEthOctets=lsHistoryStatsGoodEthOctets, lstIntPortSlicingEnable=lstIntPortSlicingEnable, lsHistoryStatsNonEthOctets=lsHistoryStatsNonEthOctets, lsHostPortFilter=lsHostPortFilter, lntTopology=lntTopology, lhsLinkStatus=lhsLinkStatus, lseIntPortSetFilter=lseIntPortSetFilter, lseGroupDataBlinderLength=lseGroupDataBlinderLength, portHistoryExtendedControlEntry=portHistoryExtendedControlEntry, lstIntPortBPDummyWindow=lstIntPortBPDummyWindow, lhsGroupMainSWVersion=lhsGroupMainSWVersion, lstIntPortSliceLength=lstIntPortSliceLength, lhsTxBCast=lhsTxBCast, scPortHistoryBoxConfiguration=scPortHistoryBoxConfiguration, lstIntPortLocalTraffic=lstIntPortLocalTraffic, lseIntPortMonitorMissedEvents=lseIntPortMonitorMissedEvents, lseIntPortMACVlanPortId=lseIntPortMACVlanPortId, ethTopLSA=ethTopLSA, scPortHistoryGoodNonUnicastPktsRec=scPortHistoryGoodNonUnicastPktsRec, lseGroupBackboneRedun12=lseGroupBackboneRedun12, lhsGroupProtocolType=lhsGroupProtocolType, lseIntPortSecurityIntruder=lseIntPortSecurityIntruder, lsHistoryStatsPriority4Octets=lsHistoryStatsPriority4Octets, lseGroupTable=lseGroupTable, lseIntPortFilterEntry=lseIntPortFilterEntry, lsHostFilterTable=lsHostFilterTable, lsHistoryStatsBadEthPkts=lsHistoryStatsBadEthPkts, vnsPacketExpectedIfName=vnsPacketExpectedIfName, lseIntPortRetryPriorityLevel2=lseIntPortRetryPriorityLevel2, vnsPacketTable=vnsPacketTable, vnsPacketStationType=vnsPacketStationType, lsPortStats=lsPortStats, lseIntPortMACAddGroupId=lseIntPortMACAddGroupId, ethTopMessageResultEntry=ethTopMessageResultEntry, lstIntPortTxBufFullThresh=lstIntPortTxBufFullThresh, lseIntPortCAMLastChange=lseIntPortCAMLastChange, vnsPacketDetectedIfName=vnsPacketDetectedIfName, lstIntPortDummyMV=lstIntPortDummyMV, lseGroupId=lseGroupId, lhsRxBCast=lhsRxBCast, lhsRxUCast=lhsRxUCast, lseIntPortSuperPriorityEnable=lseIntPortSuperPriorityEnable, lsVNChangeMACAddress=lsVNChangeMACAddress, lseGroupNormOpDelay=lseGroupNormOpDelay, lsPortInFCSErrors=lsPortInFCSErrors, lseIntPortRemoveFilter=lseIntPortRemoveFilter, lstIntPort=lstIntPort, vnsPacketDetectedVLAN=vnsPacketDetectedVLAN, lseIntPortFilterLAId=lseIntPortFilterLAId, lseIntPortPriorityLevel=lseIntPortPriorityLevel, lseIntPortSuperNetNumber=lseIntPortSuperNetNumber, lsPortCreationOrder=lsPortCreationOrder, alarmMonitorStatusIndex=alarmMonitorStatusIndex, lseIntPortActiveBroadcastPriority=lseIntPortActiveBroadcastPriority, lsHistoryStatsGoodEthPkts=lsHistoryStatsGoodEthPkts, lseWANEntry=lseWANEntry, lsHostPortFilterTable=lsHostPortFilterTable, lsePortBackboneStatus=lsePortBackboneStatus, lsPortInOctets=lsPortInOctets, lseIntPortMACVlanVlan=lseIntPortMACVlanVlan, lseIntPortRoutingMode=lseIntPortRoutingMode, lseIntPortGroupId=lseIntPortGroupId, alarmMonitorStatusEntry=alarmMonitorStatusEntry, lstIntPortBPEnable=lstIntPortBPEnable, lsVNChangeDetected=lsVNChangeDetected, lseGroupFastOpen=lseGroupFastOpen, lhsPortEntry=lhsPortEntry, lsPortExtendedReportingList=lsPortExtendedReportingList, lsBusStatsPriorityTable=lsBusStatsPriorityTable, ethTopBus=ethTopBus, lst=lst, lsHistoryStatsPriority2Pkts=lsHistoryStatsPriority2Pkts, lsHistoryStatsEthMulticastPkts=lsHistoryStatsEthMulticastPkts, lseIntPortVideoStateMachine=lseIntPortVideoStateMachine, lseGroupNormOpCl=lseGroupNormOpCl, lsPortFilter=lsPortFilter, lseGroupIPGDataLength=lseGroupIPGDataLength, lstIntPortRxEmpty1=lstIntPortRxEmpty1, ethTopMessageResultTable=ethTopMessageResultTable, lsPortControlDataSource=lsPortControlDataSource, lsHistoryStatsPriority1Octets=lsHistoryStatsPriority1Octets)
