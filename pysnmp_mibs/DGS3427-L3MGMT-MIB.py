...
swL3DevMgmt=_SwL3DevMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,1))
_SwL3DevCtrl_ObjectIdentity=ObjectIdentity
swL3DevCtrl=_SwL3DevCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,1,1))
...
swL3DevCtrlRIPState=_SwL3DevCtrlRIPState_Object((1,3,6,1,4,1,171,11,70,2,3,1,1,1),_SwL3DevCtrlRIPState_Type())
...
swL3IpMgmt=_SwL3IpMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,2))
_SwL3IpCtrlMgmt_ObjectIdentity=ObjectIdentity
swL3IpCtrlMgmt=_SwL3IpCtrlMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,2,1))
_SwL3IpCtrlTable_Object=MibTable
swL3IpCtrlTable=_SwL3IpCtrlTable_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3))
if mibBuilder.loadTexts:swL3IpCtrlTable.setStatus(_A)
_SwL3IpCtrlEntry_Object=MibTableRow
swL3IpCtrlEntry=_SwL3IpCtrlEntry_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1))
...
swL3IpCtrlInterfaceName=_SwL3IpCtrlInterfaceName_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,1),_SwL3IpCtrlInterfaceName_Type())
...
swL3IpCtrlIfIndex=_SwL3IpCtrlIfIndex_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,2),_SwL3IpCtrlIfIndex_Type())
...
swL3IpCtrlIpAddr=_SwL3IpCtrlIpAddr_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,3),_SwL3IpCtrlIpAddr_Type())
...
swL3IpCtrlIpSubnetMask=_SwL3IpCtrlIpSubnetMask_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,4),_SwL3IpCtrlIpSubnetMask_Type())
...
swL3IpCtrlVlanName=_SwL3IpCtrlVlanName_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,5),_SwL3IpCtrlVlanName_Type())
...
swL3IpCtrlProxyArp=_SwL3IpCtrlProxyArp_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,6),_SwL3IpCtrlProxyArp_Type())
...
swL3IpCtrlSecondary=_SwL3IpCtrlSecondary_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,7),_SwL3IpCtrlSecondary_Type())
...
swL3IpCtrlMode=_SwL3IpCtrlMode_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,8),_SwL3IpCtrlMode_Type())
...
swL3IpCtrlAdminState=_SwL3IpCtrlAdminState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,9),_SwL3IpCtrlAdminState_Type())
...
swL3IpCtrlIpv6LinkLocalAddress=_SwL3IpCtrlIpv6LinkLocalAddress_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,14),_SwL3IpCtrlIpv6LinkLocalAddress_Type())
...
swL3IpCtrlIpv6LinkLocalPrefixLen=_SwL3IpCtrlIpv6LinkLocalPrefixLen_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,15),_SwL3IpCtrlIpv6LinkLocalPrefixLen_Type())
...
swL3IpCtrlState=_SwL3IpCtrlState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,16),_SwL3IpCtrlState_Type())
...
swL3IpCtrlIpv6LinkLocalAutoState=_SwL3IpCtrlIpv6LinkLocalAutoState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,17),_SwL3IpCtrlIpv6LinkLocalAutoState_Type())
...
swL3IpCtrlLocalProxyArp=_SwL3IpCtrlLocalProxyArp_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,18),_SwL3IpCtrlLocalProxyArp_Type())
...
swL3IpCtrlDhcpv6ClientState=_SwL3IpCtrlDhcpv6ClientState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,20),_SwL3IpCtrlDhcpv6ClientState_Type())
...
swL3IpCtrlIpDirectedBroadcastState=_SwL3IpCtrlIpDirectedBroadcastState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,21),_SwL3IpCtrlIpDirectedBroadcastState_Type())
...
swL3IpCtrlIpDhcpOption12State=_SwL3IpCtrlIpDhcpOption12State_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,22),_SwL3IpCtrlIpDhcpOption12State_Type())
...
swL3IpCtrlIpDhcpOption12HostName=_SwL3IpCtrlIpDhcpOption12HostName_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,23),_SwL3IpCtrlIpDhcpOption12HostName_Type())
...
swL3IpCtrlDhcpv6ClientPDState=_SwL3IpCtrlDhcpv6ClientPDState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,24),_SwL3IpCtrlDhcpv6ClientPDState_Type())
...
swL3IpCtrlDhcpv6ClientPDPrefixName=_SwL3IpCtrlDhcpv6ClientPDPrefixName_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,25),_SwL3IpCtrlDhcpv6ClientPDPrefixName_Type())
...
swL3IpCtrlDhcpv6ClientPDPrefix=_SwL3IpCtrlDhcpv6ClientPDPrefix_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,26),_SwL3IpCtrlDhcpv6ClientPDPrefix_Type())
...
swL3IpCtrlDhcpv6ClientPDPrefixLen=_SwL3IpCtrlDhcpv6ClientPDPrefixLen_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,3,1,27),_SwL3IpCtrlDhcpv6ClientPDPrefixLen_Type())
...
swL3Ipv6CtrlTable=_SwL3Ipv6CtrlTable_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4))
if mibBuilder.loadTexts:swL3Ipv6CtrlTable.setStatus(_A)
_SwL3Ipv6CtrlEntry_Object=MibTableRow
swL3Ipv6CtrlEntry=_SwL3Ipv6CtrlEntry_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1))
...
swL3Ipv6CtrlInterfaceName=_SwL3Ipv6CtrlInterfaceName_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,1),_SwL3Ipv6CtrlInterfaceName_Type())
...
swL3Ipv6CtrlMaxReassmblySize=_SwL3Ipv6CtrlMaxReassmblySize_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,2),_SwL3Ipv6CtrlMaxReassmblySize_Type())
...
swL3Ipv6CtrlNsRetransTimer=_SwL3Ipv6CtrlNsRetransTimer_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,3),_SwL3Ipv6CtrlNsRetransTimer_Type())
...
swL3Ipv6CtrlRaState=_SwL3Ipv6CtrlRaState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,5),_SwL3Ipv6CtrlRaState_Type())
...
swL3Ipv6CtrlRaMinRtrAdvInterval=_SwL3Ipv6CtrlRaMinRtrAdvInterval_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,6),_SwL3Ipv6CtrlRaMinRtrAdvInterval_Type())
...
swL3Ipv6CtrlRaMaxRtrAdvInterval=_SwL3Ipv6CtrlRaMaxRtrAdvInterval_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,7),_SwL3Ipv6CtrlRaMaxRtrAdvInterval_Type())
...
swL3Ipv6CtrlRaLifeTime=_SwL3Ipv6CtrlRaLifeTime_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,8),_SwL3Ipv6CtrlRaLifeTime_Type())
...
swL3Ipv6CtrlRaReachableTime=_SwL3Ipv6CtrlRaReachableTime_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,9),_SwL3Ipv6CtrlRaReachableTime_Type())
...
swL3Ipv6CtrlRaRetransTime=_SwL3Ipv6CtrlRaRetransTime_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,10),_SwL3Ipv6CtrlRaRetransTime_Type())
...
swL3Ipv6CtrlRaHopLimit=_SwL3Ipv6CtrlRaHopLimit_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,11),_SwL3Ipv6CtrlRaHopLimit_Type())
...
swL3Ipv6CtrlRaManagedFlag=_SwL3Ipv6CtrlRaManagedFlag_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,12),_SwL3Ipv6CtrlRaManagedFlag_Type())
...
swL3Ipv6CtrlRaOtherConfigFlag=_SwL3Ipv6CtrlRaOtherConfigFlag_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,4,1,13),_SwL3Ipv6CtrlRaOtherConfigFlag_Type())
...
swL3Ipv6AddressCtrlTable=_SwL3Ipv6AddressCtrlTable_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5))
if mibBuilder.loadTexts:swL3Ipv6AddressCtrlTable.setStatus(_A)
_SwL3Ipv6AddressCtrlEntry_Object=MibTableRow
swL3Ipv6AddressCtrlEntry=_SwL3Ipv6AddressCtrlEntry_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1))
...
swL3Ipv6AddressCtrlInterfaceName=_SwL3Ipv6AddressCtrlInterfaceName_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1,1),_SwL3Ipv6AddressCtrlInterfaceName_Type())
...
swL3Ipv6Address=_SwL3Ipv6Address_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1,2),_SwL3Ipv6Address_Type())
...
swL3Ipv6AddressCtrlPrefixLen=_SwL3Ipv6AddressCtrlPrefixLen_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1,3),_SwL3Ipv6AddressCtrlPrefixLen_Type())
...
swL3Ipv6AddressCtrlPreferredLifeTime=_SwL3Ipv6AddressCtrlPreferredLifeTime_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1,4),_SwL3Ipv6AddressCtrlPreferredLifeTime_Type())
...
swL3Ipv6AddressCtrlValidLifeTime=_SwL3Ipv6AddressCtrlValidLifeTime_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1,5),_SwL3Ipv6AddressCtrlValidLifeTime_Type())
...
swL3Ipv6AddressCtrlOnLinkFlag=_SwL3Ipv6AddressCtrlOnLinkFlag_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1,6),_SwL3Ipv6AddressCtrlOnLinkFlag_Type())
...
swL3Ipv6AddressCtrlAutonomousFlag=_SwL3Ipv6AddressCtrlAutonomousFlag_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1,7),_SwL3Ipv6AddressCtrlAutonomousFlag_Type())
...
swL3Ipv6AddressCtrlState=_SwL3Ipv6AddressCtrlState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1,8),_SwL3Ipv6AddressCtrlState_Type())
...
swL3Ipv6AddressCtrlAddressType=_SwL3Ipv6AddressCtrlAddressType_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,5,1,9),_SwL3Ipv6AddressCtrlAddressType_Type())
...
swL3Ipv6DHCPv6CPDAddrCtrlTable=_SwL3Ipv6DHCPv6CPDAddrCtrlTable_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,6))
if mibBuilder.loadTexts:swL3Ipv6DHCPv6CPDAddrCtrlTable.setStatus(_A)
_SwL3Ipv6DHCPv6CPDAddrCtrlEntry_Object=MibTableRow
swL3Ipv6DHCPv6CPDAddrCtrlEntry=_SwL3Ipv6DHCPv6CPDAddrCtrlEntry_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,6,1))
...
swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=_SwL3Ipv6DHCPv6CPDAddrCtrlInterfaceName_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,6,1,1),_SwL3Ipv6DHCPv6CPDAddrCtrlInterfaceName_Type())
...
swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=_SwL3Ipv6DHCPv6CPDAddrCtrlPrefixName_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,6,1,2),_SwL3Ipv6DHCPv6CPDAddrCtrlPrefixName_Type())
...
swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=_SwL3Ipv6DHCPv6CPDAddrCtrlIPv6addr_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,6,1,3),_SwL3Ipv6DHCPv6CPDAddrCtrlIPv6addr_Type())
...
swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=_SwL3Ipv6DHCPv6CPDAddrCtrlPrefixLen_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,6,1,4),_SwL3Ipv6DHCPv6CPDAddrCtrlPrefixLen_Type())
...
swL3Ipv6DHCPv6CPDAddrCtrlState=_SwL3Ipv6DHCPv6CPDAddrCtrlState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,6,1,5),_SwL3Ipv6DHCPv6CPDAddrCtrlState_Type())
...
swL3IpCtrlAllIpIfState=_SwL3IpCtrlAllIpIfState_Object((1,3,6,1,4,1,171,11,70,2,3,2,1,7),_SwL3IpCtrlAllIpIfState_Type())
...
swL3IpFdbMgmt=_SwL3IpFdbMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,2,2))
_SwL3IpFdbInfoTable_Object=MibTable
swL3IpFdbInfoTable=_SwL3IpFdbInfoTable_Object((1,3,6,1,4,1,171,11,70,2,3,2,2,1))
if mibBuilder.loadTexts:swL3IpFdbInfoTable.setStatus(_A)
_SwL3IpFdbInfoEntry_Object=MibTableRow
swL3IpFdbInfoEntry=_SwL3IpFdbInfoEntry_Object((1,3,6,1,4,1,171,11,70,2,3,2,2,1,1))
...
swL3IpFdbInfoIpAddr=_SwL3IpFdbInfoIpAddr_Object((1,3,6,1,4,1,171,11,70,2,3,2,2,1,1,1),_SwL3IpFdbInfoIpAddr_Type())
...
swL3IpFdbInfoIpSubnetMask=_SwL3IpFdbInfoIpSubnetMask_Object((1,3,6,1,4,1,171,11,70,2,3,2,2,1,1,2),_SwL3IpFdbInfoIpSubnetMask_Type())
...
swL3IpFdbInfoPort=_SwL3IpFdbInfoPort_Object((1,3,6,1,4,1,171,11,70,2,3,2,2,1,1,3),_SwL3IpFdbInfoPort_Type())
...
swL3IpFdbInfoType=_SwL3IpFdbInfoType_Object((1,3,6,1,4,1,171,11,70,2,3,2,2,1,1,4),_SwL3IpFdbInfoType_Type())
...
swL3IpArpAgingTime=_SwL3IpArpAgingTime_Object((1,3,6,1,4,1,171,11,70,2,3,2,4),_SwL3IpArpAgingTime_Type())
...
swL3IpStaticRouteTable=_SwL3IpStaticRouteTable_Object((1,3,6,1,4,1,171,11,70,2,3,2,5))
if mibBuilder.loadTexts:swL3IpStaticRouteTable.setStatus(_A)
_SwL3IpStaticRouteEntry_Object=MibTableRow
swL3IpStaticRouteEntry=_SwL3IpStaticRouteEntry_Object((1,3,6,1,4,1,171,11,70,2,3,2,5,1))
...
swL3IpStaticRouteDest=_SwL3IpStaticRouteDest_Object((1,3,6,1,4,1,171,11,70,2,3,2,5,1,1),_SwL3IpStaticRouteDest_Type())
...
swL3IpStaticRouteMask=_SwL3IpStaticRouteMask_Object((1,3,6,1,4,1,171,11,70,2,3,2,5,1,2),_SwL3IpStaticRouteMask_Type())
...
swL3IpStaticRouteBkupState=_SwL3IpStaticRouteBkupState_Object((1,3,6,1,4,1,171,11,70,2,3,2,5,1,3),_SwL3IpStaticRouteBkupState_Type())
...
swL3IpStaticRouteNextHop=_SwL3IpStaticRouteNextHop_Object((1,3,6,1,4,1,171,11,70,2,3,2,5,1,4),_SwL3IpStaticRouteNextHop_Type())
...
swL3IpStaticRouteMetric=_SwL3IpStaticRouteMetric_Object((1,3,6,1,4,1,171,11,70,2,3,2,5,1,5),_SwL3IpStaticRouteMetric_Type())
...
swL3IpStaticRouteStatus=_SwL3IpStaticRouteStatus_Object((1,3,6,1,4,1,171,11,70,2,3,2,5,1,6),_SwL3IpStaticRouteStatus_Type())
...
swL3RelayMgmt=_SwL3RelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,3))
_SwL3RelayDhcpMgmt_ObjectIdentity=ObjectIdentity
swL3RelayDhcpMgmt=_SwL3RelayDhcpMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,3,1))
...
swL3RelayDhcpState=_SwL3RelayDhcpState_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,1),_SwL3RelayDhcpState_Type())
...
swL3RelayDhcpHopCount=_SwL3RelayDhcpHopCount_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,2),_SwL3RelayDhcpHopCount_Type())
...
swL3RelayDhcpTimeThreshold=_SwL3RelayDhcpTimeThreshold_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,3),_SwL3RelayDhcpTimeThreshold_Type())
...
swL3RelayDhcpCtrlTable=_SwL3RelayDhcpCtrlTable_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,4))
if mibBuilder.loadTexts:swL3RelayDhcpCtrlTable.setStatus(_A)
_SwL3RelayDhcpCtrlEntry_Object=MibTableRow
swL3RelayDhcpCtrlEntry=_SwL3RelayDhcpCtrlEntry_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,4,1))
...
swL3RelayDhcpCtrlInterfaceName=_SwL3RelayDhcpCtrlInterfaceName_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,4,1,1),_SwL3RelayDhcpCtrlInterfaceName_Type())
...
swL3RelayDhcpCtrlServer=_SwL3RelayDhcpCtrlServer_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,4,1,2),_SwL3RelayDhcpCtrlServer_Type())
...
swL3RelayDhcpCtrlState=_SwL3RelayDhcpCtrlState_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,4,1,3),_SwL3RelayDhcpCtrlState_Type())
...
swL3RelayDhcpOption82State=_SwL3RelayDhcpOption82State_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,5),_SwL3RelayDhcpOption82State_Type())
...
swL3RelayDhcpOption82CheckState=_SwL3RelayDhcpOption82CheckState_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,6),_SwL3RelayDhcpOption82CheckState_Type())
...
swL3RelayDhcpOption82Policy=_SwL3RelayDhcpOption82Policy_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,7),_SwL3RelayDhcpOption82Policy_Type())
...
swL3DHCPRelayOption60=_SwL3DHCPRelayOption60_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,3,1,8))
...
swL3DHCPRelayOption60State=_SwL3DHCPRelayOption60State_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,1),_SwL3DHCPRelayOption60State_Type())
...
swL3DHCPRelayOption60DefMode=_SwL3DHCPRelayOption60DefMode_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,2),_SwL3DHCPRelayOption60DefMode_Type())
...
swL3DHCPRelayOption60DefTable=_SwL3DHCPRelayOption60DefTable_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,3))
if mibBuilder.loadTexts:swL3DHCPRelayOption60DefTable.setStatus(_A)
_SwL3DHCPRelayOption60DefEntry_Object=MibTableRow
swL3DHCPRelayOption60DefEntry=_SwL3DHCPRelayOption60DefEntry_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,3,1))
...
swL3DHCPRelayOption60DefRelayIp=_SwL3DHCPRelayOption60DefRelayIp_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,3,1,1),_SwL3DHCPRelayOption60DefRelayIp_Type())
...
swL3DHCPRelayOption60DefRowStatus=_SwL3DHCPRelayOption60DefRowStatus_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,3,1,2),_SwL3DHCPRelayOption60DefRowStatus_Type())
...
swL3DHCPRelayOption60Table=_SwL3DHCPRelayOption60Table_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,4))
if mibBuilder.loadTexts:swL3DHCPRelayOption60Table.setStatus(_A)
_SwL3DHCPRelayOption60Entry_Object=MibTableRow
swL3DHCPRelayOption60Entry=_SwL3DHCPRelayOption60Entry_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,4,1))
...
swL3DHCPRelayOption60String=_SwL3DHCPRelayOption60String_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,4,1,1),_SwL3DHCPRelayOption60String_Type())
...
swL3DHCPRelayOption60RelayIp=_SwL3DHCPRelayOption60RelayIp_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,4,1,2),_SwL3DHCPRelayOption60RelayIp_Type())
...
swL3DHCPRelayOption60MatchType=_SwL3DHCPRelayOption60MatchType_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,4,1,3),_SwL3DHCPRelayOption60MatchType_Type())
...
swL3DHCPRelayOption60RowStatus=_SwL3DHCPRelayOption60RowStatus_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,8,4,1,4),_SwL3DHCPRelayOption60RowStatus_Type())
...
swL3DHCPRelayOption61=_SwL3DHCPRelayOption61_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,3,1,9))
...
swL3DHCPRelayOption61State=_SwL3DHCPRelayOption61State_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,1),_SwL3DHCPRelayOption61State_Type())
...
swL3DHCPRelayOption61DefMode=_SwL3DHCPRelayOption61DefMode_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,2),_SwL3DHCPRelayOption61DefMode_Type())
...
swL3DHCPRelayOption61DefRelayIp=_SwL3DHCPRelayOption61DefRelayIp_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,3),_SwL3DHCPRelayOption61DefRelayIp_Type())
...
swL3DHCPRelayOption61Table=_SwL3DHCPRelayOption61Table_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,4))
if mibBuilder.loadTexts:swL3DHCPRelayOption61Table.setStatus(_A)
_SwL3DHCPRelayOption61Entry_Object=MibTableRow
swL3DHCPRelayOption61Entry=_SwL3DHCPRelayOption61Entry_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,4,1))
...
swL3DHCPRelayOption61ClientType=_SwL3DHCPRelayOption61ClientType_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,4,1,1),_SwL3DHCPRelayOption61ClientType_Type())
...
swL3DHCPRelayOption61ClientID=_SwL3DHCPRelayOption61ClientID_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,4,1,2),_SwL3DHCPRelayOption61ClientID_Type())
...
swL3DHCPRelayOption61Mode=_SwL3DHCPRelayOption61Mode_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,4,1,3),_SwL3DHCPRelayOption61Mode_Type())
...
swL3DHCPRelayOption61RelayIp=_SwL3DHCPRelayOption61RelayIp_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,4,1,4),_SwL3DHCPRelayOption61RelayIp_Type())
...
swL3DHCPRelayOption61RowStatus=_SwL3DHCPRelayOption61RowStatus_Object((1,3,6,1,4,1,171,11,70,2,3,3,1,9,4,1,5),_SwL3DHCPRelayOption61RowStatus_Type())
...
swL3RelayDnsMgmt=_SwL3RelayDnsMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,3,2))
...
swL3RelayDnsState=_SwL3RelayDnsState_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,1),_SwL3RelayDnsState_Type())
...
swL3RelayDnsPrimaryServer=_SwL3RelayDnsPrimaryServer_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,2),_SwL3RelayDnsPrimaryServer_Type())
...
swL3RelayDnsSecondaryServer=_SwL3RelayDnsSecondaryServer_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,3),_SwL3RelayDnsSecondaryServer_Type())
...
swL3RelayDnsCacheState=_SwL3RelayDnsCacheState_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,4),_SwL3RelayDnsCacheState_Type())
...
swL3RelayDnsStaticTableState=_SwL3RelayDnsStaticTableState_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,5),_SwL3RelayDnsStaticTableState_Type())
...
swL3RelayDnsCtrlTable=_SwL3RelayDnsCtrlTable_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,6))
if mibBuilder.loadTexts:swL3RelayDnsCtrlTable.setStatus(_A)
_SwL3RelayDnsCtrlEntry_Object=MibTableRow
swL3RelayDnsCtrlEntry=_SwL3RelayDnsCtrlEntry_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,6,1))
...
swL3RelayDnsCtrlDomainName=_SwL3RelayDnsCtrlDomainName_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,6,1,1),_SwL3RelayDnsCtrlDomainName_Type())
...
swL3RelayDnsCtrlIpAddr=_SwL3RelayDnsCtrlIpAddr_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,6,1,2),_SwL3RelayDnsCtrlIpAddr_Type())
...
swL3RelayDnsCtrlState=_SwL3RelayDnsCtrlState_Object((1,3,6,1,4,1,171,11,70,2,3,3,2,6,1,3),_SwL3RelayDnsCtrlState_Type())
...
swL3RouteRedistriTable=_SwL3RouteRedistriTable_Object((1,3,6,1,4,1,171,11,70,2,3,5))
if mibBuilder.loadTexts:swL3RouteRedistriTable.setStatus(_A)
_SwL3RouteRedistriEntry_Object=MibTableRow
swL3RouteRedistriEntry=_SwL3RouteRedistriEntry_Object((1,3,6,1,4,1,171,11,70,2,3,5,1))
...
swL3RouteRedistriSrcProtocol=_SwL3RouteRedistriSrcProtocol_Object((1,3,6,1,4,1,171,11,70,2,3,5,1,1),_SwL3RouteRedistriSrcProtocol_Type())
...
swL3RouteRedistriDstProtocol=_SwL3RouteRedistriDstProtocol_Object((1,3,6,1,4,1,171,11,70,2,3,5,1,2),_SwL3RouteRedistriDstProtocol_Type())
...
swL3RouteRedistriMetric=_SwL3RouteRedistriMetric_Object((1,3,6,1,4,1,171,11,70,2,3,5,1,4),_SwL3RouteRedistriMetric_Type())
...
swL3RouteRedistriRowStatus=_SwL3RouteRedistriRowStatus_Object((1,3,6,1,4,1,171,11,70,2,3,5,1,5),_SwL3RouteRedistriRowStatus_Type())
...
swL3RoutePreference=_SwL3RoutePreference_ObjectIdentity((1,3,6,1,4,1,171,11,70,2,3,9))
...
swL3RoutePreferenceRIP=_SwL3RoutePreferenceRIP_Object((1,3,6,1,4,1,171,11,70,2,3,9,1),_SwL3RoutePreferenceRIP_Type())
...
swL3RoutePreferenceStatic=_SwL3RoutePreferenceStatic_Object((1,3,6,1,4,1,171,11,70,2,3,9,3),_SwL3RoutePreferenceStatic_Type())
...
swL3RoutePreferenceLocal=_SwL3RoutePreferenceLocal_Object((1,3,6,1,4,1,171,11,70,2,3,9,4),_SwL3RoutePreferenceLocal_Type())
...
swL3RoutePreferenceDefault=_SwL3RoutePreferenceDefault_Object((1,3,6,1,4,1,171,11,70,2,3,9,8),_SwL3RoutePreferenceDefault_Type())
