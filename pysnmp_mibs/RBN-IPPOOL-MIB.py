...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-IPPOOL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:01 2025
...
rbnIpPoolCompliance.setObjects(
      *(("RBN-IPPOOL-MIB", "rbnIpPoolGroup"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolNotifyGroup"))
)
if mibBuilder.loadTexts:
...
rbnIpPoolNameCompliance.setObjects(
      *(("RBN-IPPOOL-MIB", "rbnIpPoolGroup"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolNotifyGroup"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolNameGroup"))
)
if mibBuilder.loadTexts:
...
rbnIpPoolComplianceV2.setObjects(
      *(("RBN-IPPOOL-MIB", "rbnIpPoolGroupV2"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolNotifyGroup"))
)
if mibBuilder.loadTexts:
...
rbnIpPoolNameComplianceV2.setObjects(
      *(("RBN-IPPOOL-MIB", "rbnIpPoolGroupV2"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolNotifyGroup"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolNameGroup"))
)
...
rbnIpPoolRangeCompliance.setObjects(
      *(("RBN-IPPOOL-MIB", "rbnIpPoolGroupV2"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolNotifyGroup"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolRangeGroup"))
)
if mibBuilder.loadTexts:
...
rbnIpPoolThresholdPercentCompliance.setObjects(
      *(("RBN-IPPOOL-MIB", "rbnIpPoolInterfaceGroup"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolContextGroup"),
        ("RBN-IPPOOL-MIB", "rbnIpPoolNotifyGroupV2"))
)
if mibBuilder.loadTexts:
...
rbnInetIpPoolCompliance.setObjects(
      *(("RBN-IPPOOL-MIB", "rbnInetIpPoolGroup"),
        ("RBN-IPPOOL-MIB", "rbnInetIpPoolNotifyGroup"))
)
if mibBuilder.loadTexts:
