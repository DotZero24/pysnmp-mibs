...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-PERSISTENT-XGCP-EVENTS-MIB
...
persistentXgcpEventsMIBCompliance.setObjects(
    ("CISCO-WAN-PERSISTENT-XGCP-EVENTS-MIB", "persistentXgcpEventsMIBGroup")
)
if mibBuilder.loadTexts:
