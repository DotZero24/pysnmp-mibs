# SNMP MIB module (CISCOSB-SFLOW-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-SFLOW-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:39:38 2025
...
rlsFlowStatisticsEntry = _RlsFlowStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 147, 1, 1)
)
rlsFlowStatisticsEntry.setIndexNames(
    (0, "CISCOSB-SFLOW-MIB", "rlsFlowDataSource"),
)
if mibBuilder.loadTexts:
...
rlsFlowDataSource = _RlsFlowDataSource_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 147, 1, 1, 1),
...
rlsFlowStatisticsSampledPackets = _RlsFlowStatisticsSampledPackets_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 147, 1, 1, 2),
...
rlsFlowStatisticsDatagramSent = _RlsFlowStatisticsDatagramSent_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 147, 1, 1, 3),
...
rlsFlowStatisticsAction = _RlsFlowStatisticsAction_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 147, 1, 1, 4),
