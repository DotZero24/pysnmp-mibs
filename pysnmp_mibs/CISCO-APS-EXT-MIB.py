...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-APS-EXT-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:15:08 2025
...
cApsConfigEntry, CApsK1K2, cApsChanStatusEntry, cApsStatusEntry, cApsChanConfigEntry = mibBuilder.importSymbols("CISCO-APS-MIB", "cApsConfigEntry", "CApsK1K2", "cApsChanStatusEntry", "cApsStatusEntry", "cApsChanConfigEntry")
...
mibBuilder.exportSymbols("CISCO-APS-EXT-MIB", cApsChanAssociationGroup=cApsChanAssociationGroup, CApsMessageTransport=CApsMessageTransport, cApsConfigMinSearchUpInterval=cApsConfigMinSearchUpInterval, cApsConfigMaxSearchUpInterval=cApsConfigMaxSearchUpInterval, cApsChanConfigReflectorMode=cApsChanConfigReflectorMode, cApsChanConfigExt=cApsChanConfigExt, cApsStatusMessageTransport=cApsStatusMessageTransport, cApsExtMIBObjects=cApsExtMIBObjects, cApsChanAssociationTable=cApsChanAssociationTable, cApsExtMIB=cApsExtMIB, cApsExtCompliance2=cApsExtCompliance2, cApsConfigExtEntry=cApsConfigExtEntry, cApsExtComplianceRev1=cApsExtComplianceRev1, cApsConfigMessageHolddownCount=cApsConfigMessageHolddownCount, cApsConfigYcableExt=cApsConfigYcableExt, cApsConfigSwitchoverTimerExt=cApsConfigSwitchoverTimerExt, cApsStatusMessageExt=cApsStatusMessageExt, cApsStatusExtEntry=cApsStatusExtEntry, cApsConfigMessageExt=cApsConfigMessageExt, cApsChanAssociationIpAddressType=cApsChanAssociationIpAddressType, cApsChanStatusRequestExt=cApsChanStatusRequestExt, cApsStatusCdlApsBytesTrans=cApsStatusCdlApsBytesTrans, cApsChanAssociationGroupName=cApsChanAssociationGroupName, cApsStatusCdlApsBytesRcv=cApsStatusCdlApsBytesRcv, PYSNMP_MODULE_ID=cApsExtMIB, cApsConfigMessageMaxInterval=cApsConfigMessageMaxInterval, cApsConfigExtTable=cApsConfigExtTable, cApsChanAssociationMapNumber=cApsChanAssociationMapNumber, cApsConfigFarEndGroupName=cApsConfigFarEndGroupName, cApsConfigSpan=cApsConfigSpan, cApsChanStatusExtTable=cApsChanStatusExtTable, cApsChanAssociationEntry=cApsChanAssociationEntry, cApsExtMIBConformance=cApsExtMIBConformance, cApsConfigMessageHolddown=cApsConfigMessageHolddown, cApsChanAssociationNumber=cApsChanAssociationNumber, cApsExtCompliance=cApsExtCompliance, cApsChanConfigExtEntry=cApsChanConfigExtEntry, cApsChanStatusExtRequest=cApsChanStatusExtRequest, cApsConfigMessageTransport=cApsConfigMessageTransport, cApsExtCompliances=cApsExtCompliances, cApsChanConfigExtTable=cApsChanConfigExtTable, cApsNotifiesEnable=cApsNotifiesEnable, cApsStatusExtTable=cApsStatusExtTable, cApsChanStatusExtEntry=cApsChanStatusExtEntry, cApsExtGroups=cApsExtGroups, cApsNotifiesEnableGroup=cApsNotifiesEnableGroup, cApsConfigPathExt=cApsConfigPathExt, cApsConfigFarEndIpAddress=cApsConfigFarEndIpAddress, cApsConfigSearchExt=cApsConfigSearchExt, CApsChannelConfigNumber=CApsChannelConfigNumber, cApsStatusCdlExt=cApsStatusCdlExt, cApsConfigIPExt=cApsConfigIPExt, cApsConfigYcable=cApsConfigYcable, cApsConfigSwitchoverEnableInterval=cApsConfigSwitchoverEnableInterval, CdlApsBytes=CdlApsBytes, cApsChanAssociationIpAddress=cApsChanAssociationIpAddress, cApsConfigFarEndIpAddressType=cApsConfigFarEndIpAddressType)
