...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-APS-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:06 2025
...
_CApsConfigMessageTransport_Type.__name__ = "CApsMessageTransport"
...
_CApsConfigFarEndIpAddressType_Type.__name__ = "InetAddressType"
...
cApsExtCompliance.setObjects(
      *(("CISCO-APS-EXT-MIB", "cApsNotifiesEnableGroup"),
...
cApsExtComplianceRev1.setObjects(
      *(("CISCO-APS-EXT-MIB", "cApsChanConfigExt"),
        ("CISCO-APS-EXT-MIB", "cApsChanAssociationGroup"))
)
if mibBuilder.loadTexts:
