...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:30:03 2025
...
cApsChanConfigEntry, cApsStatusEntry, CApsK1K2, cApsChanStatusEntry, cApsConfigEntry = mibBuilder.importSymbols("CISCO-APS-MIB", "cApsChanConfigEntry", "cApsStatusEntry", "CApsK1K2", "cApsChanStatusEntry", "cApsConfigEntry")
...
mibBuilder.exportSymbols("CISCO-APS-EXT-MIB", cApsConfigFarEndGroupName=cApsConfigFarEndGroupName, CApsChannelConfigNumber=CApsChannelConfigNumber, cApsExtGroups=cApsExtGroups, cApsExtCompliance=cApsExtCompliance, cApsConfigYcableExt=cApsConfigYcableExt, cApsExtComplianceRev1=cApsExtComplianceRev1, cApsStatusMessageExt=cApsStatusMessageExt, cApsConfigExtEntry=cApsConfigExtEntry, cApsExtMIBObjects=cApsExtMIBObjects, cApsConfigMessageHolddown=cApsConfigMessageHolddown, cApsExtCompliance2=cApsExtCompliance2, cApsChanAssociationTable=cApsChanAssociationTable, cApsNotifiesEnable=cApsNotifiesEnable, cApsChanAssociationEntry=cApsChanAssociationEntry, cApsConfigSpan=cApsConfigSpan, cApsChanAssociationIpAddressType=cApsChanAssociationIpAddressType, CdlApsBytes=CdlApsBytes, cApsChanConfigReflectorMode=cApsChanConfigReflectorMode, cApsChanAssociationMapNumber=cApsChanAssociationMapNumber, cApsChanConfigExtTable=cApsChanConfigExtTable, cApsChanStatusExtRequest=cApsChanStatusExtRequest, cApsChanStatusRequestExt=cApsChanStatusRequestExt, cApsConfigMessageExt=cApsConfigMessageExt, cApsChanAssociationIpAddress=cApsChanAssociationIpAddress, cApsConfigSearchExt=cApsConfigSearchExt, cApsStatusCdlApsBytesRcv=cApsStatusCdlApsBytesRcv, cApsExtMIB=cApsExtMIB, cApsConfigMaxSearchUpInterval=cApsConfigMaxSearchUpInterval, cApsChanConfigExtEntry=cApsChanConfigExtEntry, cApsChanStatusExtTable=cApsChanStatusExtTable, cApsConfigMessageTransport=cApsConfigMessageTransport, cApsConfigFarEndIpAddressType=cApsConfigFarEndIpAddressType, PYSNMP_MODULE_ID=cApsExtMIB, cApsConfigMessageHolddownCount=cApsConfigMessageHolddownCount, cApsStatusMessageTransport=cApsStatusMessageTransport, cApsConfigSwitchoverEnableInterval=cApsConfigSwitchoverEnableInterval, cApsConfigYcable=cApsConfigYcable, cApsStatusExtTable=cApsStatusExtTable, cApsChanStatusExtEntry=cApsChanStatusExtEntry, cApsConfigMessageMaxInterval=cApsConfigMessageMaxInterval, cApsExtCompliances=cApsExtCompliances, cApsChanAssociationGroupName=cApsChanAssociationGroupName, cApsNotifiesEnableGroup=cApsNotifiesEnableGroup, cApsChanAssociationGroup=cApsChanAssociationGroup, cApsExtMIBConformance=cApsExtMIBConformance, cApsConfigFarEndIpAddress=cApsConfigFarEndIpAddress, cApsStatusCdlExt=cApsStatusCdlExt, cApsConfigIPExt=cApsConfigIPExt, cApsConfigExtTable=cApsConfigExtTable, CApsMessageTransport=CApsMessageTransport, cApsConfigMinSearchUpInterval=cApsConfigMinSearchUpInterval, cApsStatusCdlApsBytesTrans=cApsStatusCdlApsBytesTrans, cApsConfigPathExt=cApsConfigPathExt, cApsChanAssociationNumber=cApsChanAssociationNumber, cApsConfigSwitchoverTimerExt=cApsConfigSwitchoverTimerExt, cApsChanConfigExt=cApsChanConfigExt, cApsStatusExtEntry=cApsStatusExtEntry)
