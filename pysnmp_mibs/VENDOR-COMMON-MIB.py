...
class DeviceType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(16842752,16843009,16843265,16843521,16909057,16974081,16974082,16974083,16974084,16974085,16974086,16974087,16974088,16974089,16974090,16974091,16974092,16974094,16974095,16974337,16974338,16974593,16974594,16974849,16974850,17039617,17040129,17105153,17105409,17105665)));namedValues=NamedValues(*(('epon',16842752),('chassis',16843009),('olt',16843265),('pon',16843521),('pon1',16909057),('onu4db',16974081),('onu4db1',16974082),('onu4db2',16974083),('onu8db',16974084),('onu4d',16974085),('onu1d',16974086),('onu1dg',16974087),('onu2dg',16974088),('onu4dp',16974089),('onu3dm',16974090),('onu4d1',16974091),('onu2dm',16974092),('onu4dgm',16974094),('onu2dgm',16974095),('onu4d2p',16974337),('onu4d2pp',16974338),('onu4d1r',16974593),('onu4d1rp',16974594),('onu4d2p1r',16974849),('onu4d2p1rp',16974850),('onu24d',17039617),('onu4d2p1r1',17040129),('epon1u',17105153),('olt1',17105409),('pon2',17105665)))
...
pon=_Pon_ObjectIdentity((1,3,6,1,4,1,34592,1,3))
if mibBuilder.loadTexts:pon.setStatus(_A)
_Eoc_ObjectIdentity=ObjectIdentity
eoc=_Eoc_ObjectIdentity((1,3,6,1,4,1,34592,1,4))
if mibBuilder.loadTexts:eoc.setStatus(_A)
mibBuilder.exportSymbols('VENDOR-COMMON-MIB',**{'OperSwitch':OperSwitch,'DeviceStatus':DeviceStatus,'DataDirection':DataDirection,'DeviceOperation':DeviceOperation,'LedStatus':LedStatus,'DeviceType':DeviceType,'vendor':vendor,'ipProduct':ipProduct,'mediaConverter':mediaConverter,'switch':switch,'pon':pon,'eoc':eoc})