...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FCSP-MIB
...
ciscoFcspMIBCompliance.setObjects(
      *(("CISCO-FCSP-MIB", "cfcspConfigGroup"),
        ("CISCO-FCSP-MIB", "cfcspLocalPasswdGroup"),
        ("CISCO-FCSP-MIB", "cfcspIfStatsGroup"),
        ("CISCO-FCSP-MIB", "cfcspNotificationGroup"))
)
if mibBuilder.loadTexts:
