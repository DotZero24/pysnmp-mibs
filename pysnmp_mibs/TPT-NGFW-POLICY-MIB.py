...
tpt_ngfw_groups, tpt_ngfw_objs, tpt_ngfw_params, tpt_ngfw_eventsV2, tpt_ngfw_compls = mibBuilder.importSymbols("TPT-NGFW-REG-MIB", "tpt-ngfw-groups", "tpt-ngfw-objs", "tpt-ngfw-params", "tpt-ngfw-eventsV2", "tpt-ngfw-compls")
...
mibBuilder.exportSymbols("TPT-NGFW-POLICY-MIB", tptNgfwPolicyNotifyActionType=tptNgfwPolicyNotifyActionType, tptNgfwPolicyNotifyProtocol=tptNgfwPolicyNotifyProtocol, tptNgfwPolicyNotifyBytesOut=tptNgfwPolicyNotifyBytesOut, tptNgfwPolicyNotifyDestIpAddrType=tptNgfwPolicyNotifyDestIpAddrType, tptNgfwPolicyNotifyRateLimit=tptNgfwPolicyNotifyRateLimit, tptNgfwPolicyCompl=tptNgfwPolicyCompl, tptNgfwPolicyNotifyFilterName=tptNgfwPolicyNotifyFilterName, tptNgfwPolicyNotifySrcTransPort=tptNgfwPolicyNotifySrcTransPort, tptNgfwPolicyGroup=tptNgfwPolicyGroup, tptNgfwPolicyNotifyAction=tptNgfwPolicyNotifyAction, tptNgfwPolicyNotifyUserName=tptNgfwPolicyNotifyUserName, tptNgfwPolicyNotifySrcIpAddr=tptNgfwPolicyNotifySrcIpAddr, tptNgfwPolicyNotifyEventSource=tptNgfwPolicyNotifyEventSource, tptNgfwPolicyNotifyActionSetName=tptNgfwPolicyNotifyActionSetName, tptNgfwPolicyNotifyPeriod=tptNgfwPolicyNotifyPeriod, tptNgfwPolicyNotifyApplicationName=tptNgfwPolicyNotifyApplicationName, FirewallEventType=FirewallEventType, tptNgfwPolicyNotifyDestPort=tptNgfwPolicyNotifyDestPort, tptNgfwPolicyNotifyPktTraceEnd=tptNgfwPolicyNotifyPktTraceEnd, tptNgfwPolicy=tptNgfwPolicy, tptNgfwPolicyNotifyInInterface=tptNgfwPolicyNotifyInInterface, tptNgfwPolicyNotifySrcIpAddrType=tptNgfwPolicyNotifySrcIpAddrType, tptNgfwPolicyNotifyDestTransPort=tptNgfwPolicyNotifyDestTransPort, tptNgfwPolicyNotifyHitCount=tptNgfwPolicyNotifyHitCount, PacketTraceVersion=PacketTraceVersion, ActionType=ActionType, tptNgfwPolicyNotify=tptNgfwPolicyNotify, tptNgfwPolicyNotifyPktTraceId=tptNgfwPolicyNotifyPktTraceId, tptNgfwPolicyNotifyOutInterface=tptNgfwPolicyNotifyOutInterface, tptNgfwPolicyNotifyPktTraceBegin=tptNgfwPolicyNotifyPktTraceBegin, tptNgfwPolicyNotifyEventType=tptNgfwPolicyNotifyEventType, tptNgfwPolicyNotifySrcPort=tptNgfwPolicyNotifySrcPort, tptNgfwPolicyNotifyStartTimeSec=tptNgfwPolicyNotifyStartTimeSec, tptNgfwPolicyNotifyPolicyName=tptNgfwPolicyNotifyPolicyName, EventSource=EventSource, tptNgfwPolicyNotifyMsgParams=tptNgfwPolicyNotifyMsgParams, tptNgfwPolicyNotifyDestIpAddr=tptNgfwPolicyNotifyDestIpAddr, tptNgfwPolicyNotifySrcTransIpAddr=tptNgfwPolicyNotifySrcTransIpAddr, tptNgfwPolicyNotifyVlanId=tptNgfwPolicyNotifyVlanId, tptNgfwPolicyNotifyPktTraceVer=tptNgfwPolicyNotifyPktTraceVer, tptNgfwPolicyNotifyTime=tptNgfwPolicyNotifyTime, tptNgfwPolicyNotifyEventSeverity=tptNgfwPolicyNotifyEventSeverity, tptNgfwPolicyNotifyBytesIn=tptNgfwPolicyNotifyBytesIn, tptNgfwPolicyNotifyProfileName=tptNgfwPolicyNotifyProfileName, tptNgfwPolicyNotifyCorrelationId=tptNgfwPolicyNotifyCorrelationId, tptNgfwPolicyNotifyRuleName=tptNgfwPolicyNotifyRuleName, PYSNMP_MODULE_ID=tptNgfwPolicy, tptNgfwPolicyNotifyStartTimeNano=tptNgfwPolicyNotifyStartTimeNano, tptNgfwPolicyNotifyDestTransIpAddr=tptNgfwPolicyNotifyDestTransIpAddr, tptNgfwPolicyNotificationGroup=tptNgfwPolicyNotificationGroup, EventSeverity=EventSeverity)
