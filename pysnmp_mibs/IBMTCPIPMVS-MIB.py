...
MibIdentifier, enterprises, NotificationType, Integer32, Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, TimeTicks, Counter64, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "NotificationType", "Integer32", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "TimeTicks", "Counter64", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("IBMTCPIPMVS-MIB", ibmMvsTcpConnBytesIn=ibmMvsTcpConnBytesIn, ibmMvsUdpRestrictLowPorts=ibmMvsUdpRestrictLowPorts, ibmMvsTcpConnInitRcvSeq=ibmMvsTcpConnInitRcvSeq, ibmMvsAtmSnaLeTable=ibmMvsAtmSnaLeTable, ibmMvsAtmOsasfChannelVtamId=ibmMvsAtmOsasfChannelVtamId, ibmMvsAtmLecControlFramesIn=ibmMvsAtmLecControlFramesIn, ibmMvsAtmOsasfPvcBestEffort=ibmMvsAtmOsasfPvcBestEffort, ibmMvsDVIPAEntry=ibmMvsDVIPAEntry, ibmMvsLinkMcastGroupAddr=ibmMvsLinkMcastGroupAddr, ibmMvsAtmOsasfChannelDate=ibmMvsAtmOsasfChannelDate, ibmMvsPortSharePort=ibmMvsPortSharePort, ibmMvsTcpOutWinUpdates=ibmMvsTcpOutWinUpdates, ibmMvsPrimaryInterfaceIfIndex=ibmMvsPrimaryInterfaceIfIndex, ibmMvsTcpListenerResourceId=ibmMvsTcpListenerResourceId, ibmMvsUdpResourceName=ibmMvsUdpResourceName, ibmMvsDVIPARangeConfIpAddr=ibmMvsDVIPARangeConfIpAddr, ibmMvsOsaExpEthPortMacAddrBurntIn=ibmMvsOsaExpEthPortMacAddrBurntIn, ibmMvsTcpConnLastActivity=ibmMvsTcpConnLastActivity, ibmMvsGatewayVarianceMultiplier=ibmMvsGatewayVarianceMultiplier, ibmMvsUdpMcastRecvLinkAddr=ibmMvsUdpMcastRecvLinkAddr, ibmMvsAtmLecLastFailureState=ibmMvsAtmLecLastFailureState, osaexpEthPortEntry=osaexpEthPortEntry, ibmMvsAtmOsasfChannelHwModel=ibmMvsAtmOsasfChannelHwModel, ibmMvsAtmOsasfPortUniVersion=ibmMvsAtmOsasfPortUniVersion, ibmMvsGatewayMaximumRetransmitTime=ibmMvsGatewayMaximumRetransmitTime, ibmMvsFirewallEnabled=ibmMvsFirewallEnabled, ibmMvsOsaExpChannelManLparNum=ibmMvsOsaExpChannelManLparNum, ibmMvsTcpListenerLocalAddrType=ibmMvsTcpListenerLocalAddrType, ibmMvsTcpConnMaxBacklog=ibmMvsTcpConnMaxBacklog, ibmMvsTcpConnMaxSndWnd=ibmMvsTcpConnMaxSndWnd, ibmMvsDVIPARangeConfMaskType=ibmMvsDVIPARangeConfMaskType, ibmMvsTcpConnCongestionWnd=ibmMvsTcpConnCongestionWnd, ibmMvsAtmOsasfChannelControlUnitNumber=ibmMvsAtmOsasfChannelControlUnitNumber, ibmMvsTcpConnUsrRcvNxt=ibmMvsTcpConnUsrRcvNxt, ibmMvsAtmLecActualLanType=ibmMvsAtmLecActualLanType, ibmMvsTcpInBadSum=ibmMvsTcpInBadSum, ibmMvsPortProtocol=ibmMvsPortProtocol, ibmMvsOsaExpEthPortHardwareState=ibmMvsOsaExpEthPortHardwareState, ibmMvsTcpConnSubtask=ibmMvsTcpConnSubtask, DeviceLinkTypes=DeviceLinkTypes, ibmMvsAtmLecAtmAddress=ibmMvsAtmLecAtmAddress, ibmMvsTcpPMTUErrors=ibmMvsTcpPMTUErrors, ibmMvsAtmLecArpRepliesIn=ibmMvsAtmLecArpRepliesIn, ibmMvsTcpInSomeBeforeWin=ibmMvsTcpInSomeBeforeWin, ibmMvsUdpMcastLoopback=ibmMvsUdpMcastLoopback, ibmMvsTcpConnSendWindowAck=ibmMvsTcpConnSendWindowAck, ibmMvsDeviceLuName=ibmMvsDeviceLuName, ibmMvsDeviceWorkstationClawName=ibmMvsDeviceWorkstationClawName, ibmTCPIPmvsTcpGroup2=ibmTCPIPmvsTcpGroup2, ibmMvsOsaExpChannelPCIBusUtilHour=ibmMvsOsaExpChannelPCIBusUtilHour, ibmMvsAtmLecConfigDirectVPI=ibmMvsAtmLecConfigDirectVPI, ibmMvsLinkType=ibmMvsLinkType, ibmMvsSubagentCacheTime=ibmMvsSubagentCacheTime, ibmMvsTcpConnSndWl1=ibmMvsTcpConnSndWl1, osasfChannelTable=osasfChannelTable, ibmMvsDVIPADistConfTargetDynXcfIpAddr=ibmMvsDVIPADistConfTargetDynXcfIpAddr, ibmMvsOsaExpChannelCurLparName=ibmMvsOsaExpChannelCurLparName, ibmMvsAtmSnaLeLlcT2=ibmMvsAtmSnaLeLlcT2, ibmTcpipMvsLinkTable=ibmTcpipMvsLinkTable, ibmMvsOsaExpPerfInKbytesRateHour=ibmMvsOsaExpPerfInKbytesRateHour, ibmMvsLinkMcast=ibmMvsLinkMcast, ibmMvsDVIPADistPortWlmWeight=ibmMvsDVIPADistPortWlmWeight, ibmMvsTcpOutDelayAcks=ibmMvsTcpOutDelayAcks, ibmMvsOsaExpChannelMode=ibmMvsOsaExpChannelMode, ibmMvsTcpRestrictLowPorts=ibmMvsTcpRestrictLowPorts, ibmMvsTcpConnLuName=ibmMvsTcpConnLuName, ibmMvsTcpConnTcpSig=ibmMvsTcpConnTcpSig, ibmMvsTcpKeepAliveDrops=ibmMvsTcpKeepAliveDrops, ibmTcpipMvsPortEntry=ibmTcpipMvsPortEntry, ibmMvsAtmLecMacAddressTable=ibmMvsAtmLecMacAddressTable, ibmMvsAtmLecPortName=ibmMvsAtmLecPortName, ibmMvsDVIPAConnPolicyRuleName=ibmMvsDVIPAConnPolicyRuleName, ibmMvsTcpKeepAliveProbes=ibmMvsTcpKeepAliveProbes, ibmMvsIpInDevLayerCalls=ibmMvsIpInDevLayerCalls, ibmMvsTcpKeepAliveTimer=ibmMvsTcpKeepAliveTimer, ibmMvsDVIPAStatusChange=ibmMvsDVIPAStatusChange, ibmMvsGatewayMinimumRetransmitTime=ibmMvsGatewayMinimumRetransmitTime, ibmMvsOsaExpEthPortActiveSpeed=ibmMvsOsaExpEthPortActiveSpeed, ibmMvsTcpInAfterClose=ibmMvsTcpInAfterClose, ibmMvsDVIPAConnRemPort=ibmMvsDVIPAConnRemPort, ibmMvsTcpRxmtDrops=ibmMvsTcpRxmtDrops, ibmMvsAtmSnaLeUserData=ibmMvsAtmSnaLeUserData, ibmMvsTcpipAsid=ibmMvsTcpipAsid, ibmMvsDVIPAMaskAddr=ibmMvsDVIPAMaskAddr, ibmMvsOsaExpEthSnaInactTimer=ibmMvsOsaExpEthSnaInactTimer, ibmMvsAtmSnaLeLlcTi=ibmMvsAtmSnaLeLlcTi, ibmMvsSourceVipaEnabled=ibmMvsSourceVipaEnabled, ibmTcpipMvsAtmGroup=ibmTcpipMvsAtmGroup, ibmMvsMaximumRetransmitTime=ibmMvsMaximumRetransmitTime, ibmMvsTcpipProcname=ibmMvsTcpipProcname, ibmAgentCaps=ibmAgentCaps, ibmMvsTcpConnClientUserId=ibmMvsTcpConnClientUserId, ibmMvsUdpDgramOut=ibmMvsUdpDgramOut, ibmMvsMultipathEnabled=ibmMvsMultipathEnabled, ibmMvsAtmOsasfChannelCurLparNum=ibmMvsAtmOsasfChannelCurLparNum, ibmTCPIPmvsPortGroup=ibmTCPIPmvsPortGroup, ibmMvsAtmLecConfigDirectVCI=ibmMvsAtmLecConfigDirectVCI, ibmMvsDeviceReadBuffers=ibmMvsDeviceReadBuffers, ibmMvsDVIPARank=ibmMvsDVIPARank, ibmTcpipMvsInterfaceGroup=ibmTcpipMvsInterfaceGroup, ibmMvsDVIPAConnRoutingTable=ibmMvsDVIPAConnRoutingTable, ibmTCPIPmvsAtmSupportGroup2=ibmTCPIPmvsAtmSupportGroup2, ibmTCPIPmvsDVIPANotificationGroup=ibmTCPIPmvsDVIPANotificationGroup, ibmMvsPortNumberHigh=ibmMvsPortNumberHigh, ibmTCPIPmvsPingGroup=ibmTCPIPmvsPingGroup, ibmMvsAtmLecConfigLanName=ibmMvsAtmLecConfigLanName, ibmMvsDVIPATargetRemoved=ibmMvsDVIPATargetRemoved, ibmTCPIPmvsTcpGroup=ibmTCPIPmvsTcpGroup, ibmTCPIPmvsCompliance=ibmTCPIPmvsCompliance, ibmMvsTcpConnResourceName=ibmMvsTcpConnResourceName, ibmMvsAtmLecMacAddress=ibmMvsAtmLecMacAddress, ibmMvsPortReuse=ibmMvsPortReuse, ibmMvsDVIPADistPortEntry=ibmMvsDVIPADistPortEntry, ibmMvsUdpBytesIn=ibmMvsUdpBytesIn, ibmMvsTcpConnCurrBacklog=ibmMvsTcpConnCurrBacklog, ibmMvsRPingTimeOut=ibmMvsRPingTimeOut, ibmTCPIPmvsAtmNotificationGroup=ibmTCPIPmvsAtmNotificationGroup, ibmMvsTcpConnReXmtCount=ibmMvsTcpConnReXmtCount, ibmMvsTcpListenerAcceptCount=ibmMvsTcpListenerAcceptCount, ibmMvsPortProcName=ibmMvsPortProcName, ibmProd=ibmProd, ibmMvsLinkIbmtrCanonical=ibmMvsLinkIbmtrCanonical, ibmTCPIPmvsRoutingGroup=ibmTCPIPmvsRoutingGroup, ibmMvsTcpConnTcpPol=ibmMvsTcpConnTcpPol, ibmMvsAtmOsasfPortCodeLoadStatus=ibmMvsAtmOsasfPortCodeLoadStatus, ibmMvsDVIPADistPortPort=ibmMvsDVIPADistPortPort, ibmMvsAtmOsasfPortMacAddrActive=ibmMvsAtmOsasfPortMacAddrActive, ibmMvsTcpConnServerResourceId=ibmMvsTcpConnServerResourceId, ibmMvsAtmOsasfPortMaxPcmConnections=ibmMvsAtmOsasfPortMaxPcmConnections, ibmMvsTcpConnOutgoingWinSeq=ibmMvsTcpConnOutgoingWinSeq, ibmTCPIPmvsInterfacesGroup2=ibmTCPIPmvsInterfacesGroup2, ibmMvsDVIPAOrigin=ibmMvsDVIPAOrigin, ibmMvsTcpConnOutBuffered=ibmMvsTcpConnOutBuffered, ibmMvsTcpConnRoundTripTime=ibmMvsTcpConnRoundTripTime, ibmTcpipMvsUdpGroup=ibmTcpipMvsUdpGroup, ibmMvsAtmLecMulticastFwdVCI=ibmMvsAtmLecMulticastFwdVCI, ibmMvsDVIPADistPortReadyCount=ibmMvsDVIPADistPortReadyCount, ibmMvsAtmLecStatisticsEntry=ibmMvsAtmLecStatisticsEntry, ibmMvsAtmLecProxyClient=ibmMvsAtmLecProxyClient, ibmTCPIPmvsOsaExpGroup=ibmTCPIPmvsOsaExpGroup, osasfPvcEntry=osasfPvcEntry, ibmTcpipMvsLinkEntry=ibmTcpipMvsLinkEntry, ibmMvsDVIPAConnDynXcfIpAddr=ibmMvsDVIPAConnDynXcfIpAddr, ibmMvsIpMaxReassemblySize=ibmMvsIpMaxReassemblySize, ibmTCPIPmvsAtmSupportGroup=ibmTCPIPmvsAtmSupportGroup, ibmMvsOsaExpEthSnaMaxIFramesBeforeAck=ibmMvsOsaExpEthSnaMaxIFramesBeforeAck, ibmMvsSoMaxConn=ibmMvsSoMaxConn, ibmMvsTcpConnLogMode=ibmMvsTcpConnLogMode, ibmMvsTcpConnIpTos=ibmMvsTcpConnIpTos, ibmMvsTcpTimeWaitReused=ibmMvsTcpTimeWaitReused, osaexpEthPortTable=osaexpEthPortTable, ibmMvsAtmLecServerEntry=ibmMvsAtmLecServerEntry, ibmMvsOsaExpEthPortName=ibmMvsOsaExpEthPortName, osaexpChannelEntry=osaexpChannelEntry, ibmMvsDVIPATrapControl=ibmMvsDVIPATrapControl, ibmMvsAtmLecArpRequestsOut=ibmMvsAtmLecArpRequestsOut, ibmMvsAtmLecMulticastSendType=ibmMvsAtmLecMulticastSendType, ibmTCPIPmvsCompliances=ibmTCPIPmvsCompliances, ibmMvsAtmLecInterfaceState=ibmMvsAtmLecInterfaceState, ibmMvsTcpConnOptMaxSegmentSize=ibmMvsTcpConnOptMaxSegmentSize, ibmMvsAtmOsasfPortMediaType=ibmMvsAtmOsasfPortMediaType, ibmTcpipMvsUdpEntry=ibmTcpipMvsUdpEntry, ibmTcpipMvsTcpListenerEntry=ibmTcpipMvsTcpListenerEntry, ibmMvsUdpMcastRecvLocalPort=ibmMvsUdpMcastRecvLocalPort, ibmMvsAtmLecConfigLanType=ibmMvsAtmLecConfigLanType, ibm=ibm, ibmMvsDVIPAMaskType=ibmMvsDVIPAMaskType, ibmMvsTcpConnSSThresh=ibmMvsTcpConnSSThresh, ibmMvsTcpInWinProbes=ibmMvsTcpInWinProbes, ibmMvsPathMtuDscEnabled=ibmMvsPathMtuDscEnabled, ibmMvsTcpFinwait2Time=ibmMvsTcpFinwait2Time, ibmTcpipMvsOsaExpGroup=ibmTcpipMvsOsaExpGroup, ibmMvsTcpConnInSegs=ibmMvsTcpConnInSegs, ibmTCPIPmvsSystemGroup7=ibmTCPIPmvsSystemGroup7, ibmMvsOsaExpPerfProcessorUtil5Min=ibmMvsOsaExpPerfProcessorUtil5Min, ibmMvsTcpConnIncomingUrg=ibmMvsTcpConnIncomingUrg, ibmMvsAtmOsasfPortNetPrefix=ibmMvsAtmOsasfPortNetPrefix, osaexpPerfTable=osaexpPerfTable, ibmMvsDVIPADistPortTotalConn=ibmMvsDVIPADistPortTotalConn, ibmTCPIPmvsInterfacesGroup=ibmTCPIPmvsInterfacesGroup, ibmMvsAtmLecControlDirectInterface=ibmMvsAtmLecControlDirectInterface, ibmMvsTcpConnTimeStamp=ibmMvsTcpConnTimeStamp, ibmMvsUdpDSField=ibmMvsUdpDSField, ibmMvsOsaExpPerfOutKbytesRateHour=ibmMvsOsaExpPerfOutKbytesRateHour, ibmMvsTcpListenerRemoteAddrType=ibmMvsTcpListenerRemoteAddrType, ibmMvsOsaExpChannelDeterNodeDesc=ibmMvsOsaExpChannelDeterNodeDesc, ibmMvsOsaExpEthPortGroupMacAddrs=ibmMvsOsaExpEthPortGroupMacAddrs, ibmRemotePingEntry=ibmRemotePingEntry, ibmMvsOsaExpEthSnaAckTimer=ibmMvsOsaExpEthSnaAckTimer, ibmRemotePingTable=ibmRemotePingTable, ibmMvsDVIPADistConfEntry=ibmMvsDVIPADistConfEntry, ibmTcpipMvsGatewayTable=ibmTcpipMvsGatewayTable, osasfPortTable=osasfPortTable, ibmMvsTcpListenerRemoteAddr=ibmMvsTcpListenerRemoteAddr, ibmMvsDVIPAServMgrMulticastIpAddrType=ibmMvsDVIPAServMgrMulticastIpAddrType, ibmMvsTcpInAllAfterWin=ibmMvsTcpInAllAfterWin, ibmTCPIPmvsUdpGroup3=ibmTCPIPmvsUdpGroup3, ibmTcpipMvsDeviceEntry=ibmTcpipMvsDeviceEntry, ibmMvsSendGarbageEnabled=ibmMvsSendGarbageEnabled, ibmMvsDeviceActualRouterStatus=ibmMvsDeviceActualRouterStatus, ibmMvsTcpConnProto=ibmMvsTcpConnProto, ibmMvsNoUdpQueueLimit=ibmMvsNoUdpQueueLimit, ibmMvsTcpConnExceedBacklog=ibmMvsTcpConnExceedBacklog, ibmMvsDVIPADistConfIpAddrType=ibmMvsDVIPADistConfIpAddrType, ibmMvsDVIPADistConfStatus=ibmMvsDVIPADistConfStatus, ibmMvsOsaExpEthSnaMaxTransmitWindow=ibmMvsOsaExpEthSnaMaxTransmitWindow, ibmMvsDVIPARangeConfEntry=ibmMvsDVIPARangeConfEntry, ibmMvsAtmOsasfPortHardwareState=ibmMvsAtmOsasfPortHardwareState, ibmMvsOsaExpChannelProcessorUtil1Min=ibmMvsOsaExpChannelProcessorUtil1Min, ibmMvsDVIPARemoved=ibmMvsDVIPARemoved, ibmMvsAtmLecFlushTimeout=ibmMvsAtmLecFlushTimeout, ibmMvsAtmLecForwardDelayTime=ibmMvsAtmLecForwardDelayTime, ibmMvsDVIPARangeConfMoveable=ibmMvsDVIPARangeConfMoveable, ibmMvsAtmOsasfPvcBwdCellBurstSize=ibmMvsAtmOsasfPvcBwdCellBurstSize, ibmMvsTcpInOutOfOrder=ibmMvsTcpInOutOfOrder, ibmMvsDVIPAServMgrPort=ibmMvsDVIPAServMgrPort, ibmMvsOsaExpEthPortOutPackets=ibmMvsOsaExpEthPortOutPackets, ibmMvsAtmLecMaxUnknownFrameCount=ibmMvsAtmLecMaxUnknownFrameCount, ibmMvsAtmSnaLeBestEffortPeakRate=ibmMvsAtmSnaLeBestEffortPeakRate, ibmTCPIPmvsAdmin=ibmTCPIPmvsAdmin, ibmTcpipMvsTcpConnTable=ibmTcpipMvsTcpConnTable, ibmMvsTcpConnSendMSS=ibmMvsTcpConnSendMSS, ibmMvsTcpConnInBuffered=ibmMvsTcpConnInBuffered, ibmMvsAtmOsasfChannelManParnName=ibmMvsAtmOsasfChannelManParnName, ibmMvsAtmLecVersion=ibmMvsAtmLecVersion, ibmTcpipMvsTcpConnEntry=ibmTcpipMvsTcpConnEntry, ibmMvsGatewayRoundTripGain=ibmMvsGatewayRoundTripGain, ibmMvsAtmOsasfChannelMode=ibmMvsAtmOsasfChannelMode, ibmTCPIPmvsUdpGroup=ibmTCPIPmvsUdpGroup, ibmMvsDeviceRouterStatus=ibmMvsDeviceRouterStatus, ibmMvsDeviceWriteSize=ibmMvsDeviceWriteSize, ibmMvsUdpMcastRecvGroup=ibmMvsUdpMcastRecvGroup, ibmMvsTcpFinwait2Drops=ibmMvsTcpFinwait2Drops, ibmMvsLinkArpSupport=ibmMvsLinkArpSupport, ibmMvsAtmLecConnectionCompleteTimer=ibmMvsAtmLecConnectionCompleteTimer, ibmMvsTcpConnAcceptCount=ibmMvsTcpConnAcceptCount, ibmTCPIPmvsMIBObjects=ibmTCPIPmvsMIBObjects, ibmMvsAtmOsasfChannelNumPorts=ibmMvsAtmOsasfChannelNumPorts, ibmMvsTcpConnActiveOpen=ibmMvsTcpConnActiveOpen, ibmTCPIPmvsInterfacesGroup5=ibmTCPIPmvsInterfacesGroup5, ibmMvsDVIPAConnRoutingEntry=ibmMvsDVIPAConnRoutingEntry, ibmMvsTcpConnUsrSndNxt=ibmMvsTcpConnUsrSndNxt, ibmMvsOsaExpEthPortNumber=ibmMvsOsaExpEthPortNumber, ibmMvsOsaExpPerfOutKbytesRate5Min=ibmMvsOsaExpPerfOutKbytesRate5Min, ibmMvsAtmOsasfPortNumber=ibmMvsAtmOsasfPortNumber, ibmMvsOsaExpEthPortServiceMode=ibmMvsOsaExpEthPortServiceMode, ibmMvsAtmOsasfPortAAL5InPackets=ibmMvsAtmOsasfPortAAL5InPackets, ibmMvsTcpConnSndUna=ibmMvsTcpConnSndUna, ibmMvsAtmLecConfigServerAtmAddress=ibmMvsAtmLecConfigServerAtmAddress, PYSNMP_MODULE_ID=ibmTCPIPmvsMIB, ibmTCPIPmvsSystemGroup6=ibmTCPIPmvsSystemGroup6, ibmMvsOsaExpPerfProcessorUtilHour=ibmMvsOsaExpPerfProcessorUtilHour, ibmMvsTcpInSomeAfterWin=ibmMvsTcpInSomeAfterWin, ibmMvsOsaExpEthPortConfigSpeed=ibmMvsOsaExpEthPortConfigSpeed)
mibBuilder.exportSymbols("IBMTCPIPMVS-MIB", ibmMvsTcpConnRttSeq=ibmMvsTcpConnRttSeq, ibmMvsRPingPacketSize=ibmMvsRPingPacketSize, ibmMvsTcpProbeDrops=ibmMvsTcpProbeDrops, ibmMvsPortDelayAcks=ibmMvsPortDelayAcks, ibmMvsOsaExpPerfInKbytesRate1Min=ibmMvsOsaExpPerfInKbytesRate1Min, ibmMvsDVIPARangeConfTable=ibmMvsDVIPARangeConfTable, ibmMvsAtmOsasfPvcFwdsustainCellRate=ibmMvsAtmOsasfPvcFwdsustainCellRate, ibmMvsTcpConnWindowScale=ibmMvsTcpConnWindowScale, ibmMvsTcpConnTcpTimer=ibmMvsTcpConnTcpTimer, ibmMvsTcpInPawsDrop=ibmMvsTcpInPawsDrop, ibmTcpipMvsUdpMcastRecvEntry=ibmTcpipMvsUdpMcastRecvEntry, ibmMvsAtmOsasfChannelManParnNum=ibmMvsAtmOsasfChannelManParnNum, ibmMvsOsaExpChannelNumPorts=ibmMvsOsaExpChannelNumPorts, ibmTCPIPmvsIpGroup=ibmTCPIPmvsIpGroup, ibmTcpipMvsIpGroup=ibmTcpipMvsIpGroup, ibmMvsUdpEntryState=ibmMvsUdpEntryState, ibmMvsOsaExpChannelShared=ibmMvsOsaExpChannelShared, ibmMvsDeviceReadSize=ibmMvsDeviceReadSize, ibmMvsAtmLecLocalSegmentID=ibmMvsAtmLecLocalSegmentID, ibmTCPIPmvsSystemNotificationGroup=ibmTCPIPmvsSystemNotificationGroup, ibmTCPIPmvsPortGroup2=ibmTCPIPmvsPortGroup2, osaexpEthSnaEntry=osaexpEthSnaEntry, ibmMvsDeviceWriteBuffers=ibmMvsDeviceWriteBuffers, ibmMvsAtmSnaleMaxIn=ibmMvsAtmSnaleMaxIn, osasfPvcTable=osasfPvcTable, ibmSNMPRemPing=ibmSNMPRemPing, ibmMvsOsaExpChannelProcessorUtilHour=ibmMvsOsaExpChannelProcessorUtilHour, ibmMvsAtmLecStatisticsTable=ibmMvsAtmLecStatisticsTable, ibmMvsTcpRxmtTimers=ibmMvsTcpRxmtTimers, mvsSNMPagent=mvsSNMPagent, ibmMvsAtmLecMaxRetryCount=ibmMvsAtmLecMaxRetryCount, ibmMvsOsaExpChannelCodeLevel=ibmMvsOsaExpChannelCodeLevel, ibmMvsAtmLecLastFailureRespCode=ibmMvsAtmLecLastFailureRespCode, ibmMvsUdpResourceId=ibmMvsUdpResourceId, ibmMvsTcpConnIncomingWinSeq=ibmMvsTcpConnIncomingWinSeq, ibmMvsAtmOsasfPvcName=ibmMvsAtmOsasfPvcName, ibmMvsAtmSnaLeMaxOut=ibmMvsAtmSnaLeMaxOut, ibmMvsDeviceBaseNumber=ibmMvsDeviceBaseNumber, ibmMvsUdpBytesOut=ibmMvsUdpBytesOut, ibmMvsOsaExpChannelSubType=ibmMvsOsaExpChannelSubType, ibmMvsOsasfProductVersion=ibmMvsOsasfProductVersion, ibmMvsDVIPARangeConfStatus=ibmMvsDVIPARangeConfStatus, ibmMvsOsaExpEthPortMacAddrActive=ibmMvsOsaExpEthPortMacAddrActive, ibmTcpipMvsTcpListenerTable=ibmTcpipMvsTcpListenerTable, ibmMvsUdpIpOpts=ibmMvsUdpIpOpts, osasfPortEntry=osasfPortEntry, ibmTcpipMvsPortTable=ibmTcpipMvsPortTable, ibmMvsLinkIbmtrBcast=ibmMvsLinkIbmtrBcast, ibmMvsAtmOsasfChannelCurLparName=ibmMvsAtmOsasfChannelCurLparName, ibmMvsArpCacheTimeout=ibmMvsArpCacheTimeout, ibmMvsAtmLecConfigMaxDataFrameSize=ibmMvsAtmLecConfigMaxDataFrameSize, ibmMvsAtmLecMulticastFwdInterface=ibmMvsAtmLecMulticastFwdInterface, ibmMvsTcpConnTcpSel=ibmMvsTcpConnTcpSel, ibmMvsRPingHostAddress=ibmMvsRPingHostAddress, ibmTCPIPmvsAtmLeGroup=ibmTCPIPmvsAtmLeGroup, ibmMvsGatewayVarianceGain=ibmMvsGatewayVarianceGain, ibmMvsTcpPMTURxmts=ibmMvsTcpPMTURxmts, ibmMvsTcpListenerResourceName=ibmMvsTcpListenerResourceName, ibmMvsAtmOsasfPortUniType=ibmMvsAtmOsasfPortUniType, ibmMvsDVIPAIpAddrType=ibmMvsDVIPAIpAddrType, ibmMvsAtmOsasfPvcBwdMaxAal5PduSize=ibmMvsAtmOsasfPvcBwdMaxAal5PduSize, ibmMvsOsaExpPerfInKbytesRate5Min=ibmMvsOsaExpPerfInKbytesRate5Min, ibmMvsDVIPAMoveable=ibmMvsDVIPAMoveable, ibmMvsDVIPADistConfTargetDynXcfIpAddrType=ibmMvsDVIPADistConfTargetDynXcfIpAddrType, ibmMvsAtmLecTopologyChange=ibmMvsAtmLecTopologyChange, ibmMvsAtmSnaLeLlcT1=ibmMvsAtmSnaLeLlcT1, ibmMvsDVIPAConnRemIpAddr=ibmMvsDVIPAConnRemIpAddr, ibmMvsTcpMaxReceiveBufferSize=ibmMvsTcpMaxReceiveBufferSize, ibmMvsTcpConnSndNxt=ibmMvsTcpConnSndNxt, ibmMvsAtmLecSvcFailures=ibmMvsAtmLecSvcFailures, ibmTcpipMvsPortGroup=ibmTcpipMvsPortGroup, ibmMvsDVIPARangeConfMaskAddr=ibmMvsDVIPARangeConfMaskAddr, ibmMvsOsaExpPerfOutKbytesRate1Min=ibmMvsOsaExpPerfOutKbytesRate1Min, ibmTCPIPmvsInterfacesGroup4=ibmTCPIPmvsInterfacesGroup4, ibmMvsTcpipSubagentVersion=ibmMvsTcpipSubagentVersion, ibmMvsDVIPADistConfIpAddr=ibmMvsDVIPADistConfIpAddr, ibmMvsAtmLecPathSwitchingDelay=ibmMvsAtmLecPathSwitchingDelay, ibmMvsAtmLecArpRepliesOut=ibmMvsAtmLecArpRepliesOut, ibmMvsUdpSubtask=ibmMvsUdpSubtask, ibmMvsOsaExpEthPortUserData=ibmMvsOsaExpEthPortUserData, ibmMvsAtmLecConfigTable=ibmMvsAtmLecConfigTable, ibmTCPIPmvsTcpGroup5=ibmTCPIPmvsTcpGroup5, ibmMvsAtmSnaLeClientEnableState=ibmMvsAtmSnaLeClientEnableState, ibmMvsTcpPredictData=ibmMvsTcpPredictData, ibmMvsVarianceMultiplier=ibmMvsVarianceMultiplier, ibmMvsDVIPARangeConfIpAddrType=ibmMvsDVIPARangeConfIpAddrType, ibmMvsDVIPAServMgrMulticastIpAddr=ibmMvsDVIPAServMgrMulticastIpAddr, ibmMvsLinkChecksumEnabled=ibmMvsLinkChecksumEnabled, ibmMvsAtmLecArpRequestsIn=ibmMvsAtmLecArpRequestsIn, osasfChannelEntry=osasfChannelEntry, ibmMvsAtmOsasfChannelSubType=ibmMvsAtmOsasfChannelSubType, ibmMvsUdpMcastTTL=ibmMvsUdpMcastTTL, ibmMvsAtmLecStatusTable=ibmMvsAtmLecStatusTable, ibmMvsAtmLecPrimaryAtmAddress=ibmMvsAtmLecPrimaryAtmAddress, ibmTCPIPmvsObsoleteGroup=ibmTCPIPmvsObsoleteGroup, ibmMvsAtmLecConfigDirectInterface=ibmMvsAtmLecConfigDirectInterface, ibmTCPIPmvsSystemGroup4=ibmTCPIPmvsSystemGroup4, ibmMvsTcpConnOutgoingPush=ibmMvsTcpConnOutgoingPush, ibmTcpipMvsLinkMcastTable=ibmTcpipMvsLinkMcastTable, ibmMvsDeviceConfigPackingMode=ibmMvsDeviceConfigPackingMode, ibmMvsAtmLecMulticastFwdVPI=ibmMvsAtmLecMulticastFwdVPI, ibmMvsTcpConnSndWnd=ibmMvsTcpConnSndWnd, ibmMvsIpInUnpackErrors=ibmMvsIpInUnpackErrors, ibmMvsAtmLecControlDistributeVPI=ibmMvsAtmLecControlDistributeVPI, ibmMvsTcpListenerLocalAddr=ibmMvsTcpListenerLocalAddr, ibmMvsDVIPATargetServerStarted=ibmMvsDVIPATargetServerStarted, ibmMvsVarianceGain=ibmMvsVarianceGain, ibmTCPIPmvsAtmLeGroup2=ibmTCPIPmvsAtmLeGroup2, ibmMvsAtmOsasfPvcFwdPeakCellRate=ibmMvsAtmOsasfPvcFwdPeakCellRate, ibmMvsTcpConnRoundTripVariance=ibmMvsTcpConnRoundTripVariance, ibmMvsUdpRecvLim=ibmMvsUdpRecvLim, ibmMvsTcpConnSendWindowSeq=ibmMvsTcpConnSendWindowSeq, ibmMvsPortOptMaxSegmentSize=ibmMvsPortOptMaxSegmentSize, ibmMvsAtmOsasfPvcBwdPeakCellRate=ibmMvsAtmOsasfPvcBwdPeakCellRate, ibmTCPIPmvsSystemGroup3=ibmTCPIPmvsSystemGroup3, ibmMvsMinimumRetransmitTime=ibmMvsMinimumRetransmitTime, ibmTcpipMvsSystem=ibmTcpipMvsSystem, ibmMvsAtmOsasfPvcFwdMaxAal5PduSize=ibmMvsAtmOsasfPvcFwdMaxAal5PduSize, ibmMvsUdpSendBufferSize=ibmMvsUdpSendBufferSize, ibmMvsLinkAdapterAddr=ibmMvsLinkAdapterAddr, ibmMvsUdpTos=ibmMvsUdpTos, ibmTcpipMvsGatewayEntry=ibmTcpipMvsGatewayEntry, ibmMvsDVIPADistributeStatus=ibmMvsDVIPADistributeStatus, ibmMvsDVIPAConnDynXcfIpAddrType=ibmMvsDVIPAConnDynXcfIpAddrType, ibmMvsOsaExpChannelManLparName=ibmMvsOsaExpChannelManLparName, ibmMvsOsaExpChannelNumber=ibmMvsOsaExpChannelNumber, ibmMvsOsaExpEthPortConfigName=ibmMvsOsaExpEthPortConfigName, ibmMvsAtmLecExpectedArpResponseTime=ibmMvsAtmLecExpectedArpResponseTime, ibmMvsAtmLecVccTimeoutPeriod=ibmMvsAtmLecVccTimeoutPeriod, ibmMvsDVIPAServMgrPasswordSpecified=ibmMvsDVIPAServMgrPasswordSpecified, ibmMvsTcpInAllBeforeWin=ibmMvsTcpInAllBeforeWin, osaexpEthSnaTable=osaexpEthSnaTable, ibmTcpipMvsUdpMcastRecvTable=ibmTcpipMvsUdpMcastRecvTable, ibmTcpipMvsLinkMcastEntry=ibmTcpipMvsLinkMcastEntry, ibmMvsTcpConnOutgoingUrg=ibmMvsTcpConnOutgoingUrg, ibmMvsTcpListenerRemotePort=ibmMvsTcpListenerRemotePort, ibmMvsUdpLastAct=ibmMvsUdpLastAct, ibmMvsAtmOsasfChannelType=ibmMvsAtmOsasfChannelType, ibmMvsTcpConnRcvNxt=ibmMvsTcpConnRcvNxt, ibmMvsAtmLecMulticastSendPeakRate=ibmMvsAtmLecMulticastSendPeakRate, ibmMvsAtmOsasfPortMacAddrBurntIn=ibmMvsAtmOsasfPortMacAddrBurntIn, ibmTCPIPmvsConformance=ibmTCPIPmvsConformance, ibmMvsAtmOsasfPortNetPrefixPrefix=ibmMvsAtmOsasfPortNetPrefixPrefix, ibmMvsTcpConnReXmt=ibmMvsTcpConnReXmt, ibmMvsTcpConnTcpDet=ibmMvsTcpConnTcpDet, ibmMvsTcpSendBufferSize=ibmMvsTcpSendBufferSize, ibmMvsDeviceNetmanEnabled=ibmMvsDeviceNetmanEnabled, ibmMvsTcpConnIncomingPush=ibmMvsTcpConnIncomingPush, ibmTCPIPmvsTcpGroup3=ibmTCPIPmvsTcpGroup3, ibmMvsAtmOsasfAtmPvcCreate=ibmMvsAtmOsasfAtmPvcCreate, ibmMvsMultipathType=ibmMvsMultipathType, TypeOfService=TypeOfService, ibmMvsTcpConnBackoffCount=ibmMvsTcpConnBackoffCount, ibmMvsAtmOsasfChannelCodeLevel=ibmMvsAtmOsasfChannelCodeLevel, ibmMvsTcpConnClusterConnFlag=ibmMvsTcpConnClusterConnFlag, ibmMvsAtmLecMulticastSendVPI=ibmMvsAtmLecMulticastSendVPI, ibmMvsAtmOsasfChannelTime=ibmMvsAtmOsasfChannelTime, ibmMvsIpOutDiscardsMemory=ibmMvsIpOutDiscardsMemory, ibmMvsAtmLecStatusEntry=ibmMvsAtmLecStatusEntry, ibmTCPIPmvsSystemGroup5=ibmTCPIPmvsSystemGroup5, ibmMvsOsaExpChannelPCIBusUtil1Min=ibmMvsOsaExpChannelPCIBusUtil1Min, ibmTCPIPmvsSystemGroup2=ibmTCPIPmvsSystemGroup2, ibmMvsDevRetryDuration=ibmMvsDevRetryDuration, ibmMvsAtmLecControlDirectVPI=ibmMvsAtmLecControlDirectVPI, ibmTCPIPmvsMIBTraps=ibmTCPIPmvsMIBTraps, ibmMvsAtmSnaleMaxStations=ibmMvsAtmSnaleMaxStations, ibmMvsAtmLecControlDirectVCI=ibmMvsAtmLecControlDirectVCI, ibmTCPIPmvsAtmSupportGroup4=ibmTCPIPmvsAtmSupportGroup4, ibmMvsOsaExpEthPortDisabledStatus=ibmMvsOsaExpEthPortDisabledStatus, ibmMvsAtmLecControlFramesOut=ibmMvsAtmLecControlFramesOut, ibmMvsTcpConnSndBufSize=ibmMvsTcpConnSndBufSize, ibmMvsAtmSnaLeEntry=ibmMvsAtmSnaLeEntry, ibmMvsTcpipSubagentColdStart=ibmMvsTcpipSubagentColdStart, ibmTcpipMvsTcpGroup=ibmTcpipMvsTcpGroup, ibmTCPIPmvsTcpGroup4=ibmTCPIPmvsTcpGroup4, ibmTCPIPmvsDVIPAGroup=ibmTCPIPmvsDVIPAGroup, ibmMvsPortSAFResource=ibmMvsPortSAFResource, ibmTCPIPmvsGroups=ibmTCPIPmvsGroups, osaexpChannelTable=osaexpChannelTable, ibmTCPIPmvsTcpGroup6=ibmTCPIPmvsTcpGroup6, ibmMvsOsaExpChannelControlUnitNumber=ibmMvsOsaExpChannelControlUnitNumber, ibmMvsUdpRecvBufferSize=ibmMvsUdpRecvBufferSize, ibmMvsTcpConnSndWl2=ibmMvsTcpConnSndWl2, ibmMvsDVIPADistPortTargetDynXcfIpAddr=ibmMvsDVIPADistPortTargetDynXcfIpAddr, ibmMvsTcpConnInitSndSeq=ibmMvsTcpConnInitSndSeq, ibmMvsAtmOsasfPortAAL5OutPackets=ibmMvsAtmOsasfPortAAL5OutPackets, ibmMvsTcpConnTargetAppl=ibmMvsTcpConnTargetAppl, ibmMvsAtmOsasfChannelState=ibmMvsAtmOsasfChannelState, ibmMvsDVIPADistPortTargetDynXcfIpAddrType=ibmMvsDVIPADistPortTargetDynXcfIpAddrType, ibmMvsAtmLecServerTable=ibmMvsAtmLecServerTable, ibmMvsUdpSendLim=ibmMvsUdpSendLim, ibmMvsTcpListenerExceedBacklog=ibmMvsTcpListenerExceedBacklog, ibmTCPIPmvsUdpGroup2=ibmTCPIPmvsUdpGroup2, ibmMvsDeviceIoBufferSize=ibmMvsDeviceIoBufferSize, ibmMvsAtmOsasfPortIpAddress=ibmMvsAtmOsasfPortIpAddress, ibmMvsDVIPATargetServerEnded=ibmMvsDVIPATargetServerEnded, ibmMvsAtmOsasfPvcVpi=ibmMvsAtmOsasfPvcVpi, ibmMvsTcpConnBytesOut=ibmMvsTcpConnBytesOut, ibmMvsAtmOsasfPvcVci=ibmMvsAtmOsasfPvcVci, ibmMvsDVIPAIpAddr=ibmMvsDVIPAIpAddr, ibmMvsLinkMcastRefCount=ibmMvsLinkMcastRefCount, ibmMvsUdpMcastRecvLocalAddress=ibmMvsUdpMcastRecvLocalAddress, ibmTCPIPmvsAtmSupportGroup3=ibmTCPIPmvsAtmSupportGroup3, ibmMvsTcpConnOutSegs=ibmMvsTcpConnOutSegs, ibmMvsAtmOsasfChannelDeterNodeDesc=ibmMvsAtmOsasfChannelDeterNodeDesc, ibmMvsIpForwarding=ibmMvsIpForwarding, ibmMvsTcpConnDupacks=ibmMvsTcpConnDupacks, ibmMvsAtmLecControlDistributeInterface=ibmMvsAtmLecControlDistributeInterface, ibmTCPIPmvsSystemGroup=ibmTCPIPmvsSystemGroup, ibmMvsPortNumberLow=ibmMvsPortNumberLow, ibmMvsAtmOsasfPortPcmName=ibmMvsAtmOsasfPortPcmName, ibmMvsAtmOsasfChannelNumber=ibmMvsAtmOsasfChannelNumber, ibmMvsOsaExpEthPortInUnknownIPFrames=ibmMvsOsaExpEthPortInUnknownIPFrames, ibmMvsDVIPAStatus=ibmMvsDVIPAStatus, ibmMvsOsaExpChannelProcessorUtil5Min=ibmMvsOsaExpChannelProcessorUtil5Min, ibmMvsIpInDiscardsMemory=ibmMvsIpInDiscardsMemory, ibmMvsOsaExpChannelState=ibmMvsOsaExpChannelState, ibmMvsOsaExpEthSnaRespTimer=ibmMvsOsaExpEthSnaRespTimer, ibmMvsAtmLecAgingTime=ibmMvsAtmLecAgingTime, ibmMvsUdpMcastLinkAddr=ibmMvsUdpMcastLinkAddr, ibmMvsAtmLecConfigSource=ibmMvsAtmLecConfigSource, ibmMvsOsaExpChannelType=ibmMvsOsaExpChannelType, ibmMvsAtmSnaLeTrSessionDelay=ibmMvsAtmSnaLeTrSessionDelay, ibmMvsAtmOsasfChannelShared=ibmMvsAtmOsasfChannelShared, ibmMvsOsaExpEthPortInGroupFrames=ibmMvsOsaExpEthPortInGroupFrames, ibmMvsTcpConnDSField=ibmMvsTcpConnDSField, ibmMvsAtmLecMaxUnknownFrameTime=ibmMvsAtmLecMaxUnknownFrameTime, ibmMvsAtmLecMulticastSendAvgRate=ibmMvsAtmLecMulticastSendAvgRate, ibmMvsDVIPATable=ibmMvsDVIPATable, ibmMvsDVIPATargetAdded=ibmMvsDVIPATargetAdded, ibmMvsIgnoreRedirect=ibmMvsIgnoreRedirect, ibmMvsAtmLecMulticastSendVCI=ibmMvsAtmLecMulticastSendVCI, ibmMvsTcpConnRcvBufSize=ibmMvsTcpConnRcvBufSize, ibmMvsAtmSnaLeMaxSaps=ibmMvsAtmSnaLeMaxSaps, ibmMvsTcpConnResourceId=ibmMvsTcpConnResourceId, ibmMvsOsaExpPerfLparNum=ibmMvsOsaExpPerfLparNum, ibmMvsOsaExpEthPortInBroadcastFrames=ibmMvsOsaExpEthPortInBroadcastFrames, ibmMvsAtmOsasfChannelFlashLevel=ibmMvsAtmOsasfChannelFlashLevel, ibmMvsTcpOutWinProbes=ibmMvsTcpOutWinProbes, ibmTcpipMvsDVIPAGroup=ibmTcpipMvsDVIPAGroup, ibmMvsDeviceAutoRestart=ibmMvsDeviceAutoRestart, ibmMvsLinkMacAddress=ibmMvsLinkMacAddress, ibmMvsAtmSnaLeTrLoadBalancing=ibmMvsAtmSnaLeTrLoadBalancing, ibmMvsOsaExpEthPortInPackets=ibmMvsOsaExpEthPortInPackets, ibmMvsAtmLecMulticastSendInterface=ibmMvsAtmLecMulticastSendInterface, ibmMvsAtmLecProtocol=ibmMvsAtmLecProtocol, ibmTcpipMvsRouteGroup=ibmTcpipMvsRouteGroup, ibmTcpipMvsDeviceTable=ibmTcpipMvsDeviceTable, ibmMvsDeviceHostClawName=ibmMvsDeviceHostClawName, ibmMvsAtmOsasfPortNetPrefixStatus=ibmMvsAtmOsasfPortNetPrefixStatus, ibmMvsAtmLecMacAddressEntry=ibmMvsAtmLecMacAddressEntry, ibmMvsOsasfSysplexName=ibmMvsOsasfSysplexName, ibmMvsTcpConnsClosed=ibmMvsTcpConnsClosed, ibmTcpipMvsUdpTable=ibmTcpipMvsUdpTable)
mibBuilder.exportSymbols("IBMTCPIPMVS-MIB", ibmTCPIPmvsMIB=ibmTCPIPmvsMIB, ibmMvsTcpConnPendTcpRecv=ibmMvsTcpConnPendTcpRecv, ibmMvsIpOutDiscardsDlcAsynch=ibmMvsIpOutDiscardsDlcAsynch, ibmMvsAtmSnaLeCrsGroupAddress=ibmMvsAtmSnaLeCrsGroupAddress, ibmMvsAtmOsasfAtmPvcDelete=ibmMvsAtmOsasfAtmPvcDelete, ibmMvsTcpReceiveBufferSize=ibmMvsTcpReceiveBufferSize, ibmMvsPortAutoLoggable=ibmMvsPortAutoLoggable, ibmMvsDVIPAServMgrEnabled=ibmMvsDVIPAServMgrEnabled, ibmMvsAtmOsasfPortType=ibmMvsAtmOsasfPortType, ibmMvsDeviceActualPackingMode=ibmMvsDeviceActualPackingMode, ibmMvsAtmOsasfChannelEcLevel=ibmMvsAtmOsasfChannelEcLevel, ibmMvsAtmLecControlDistributeVCI=ibmMvsAtmLecControlDistributeVCI, ibmMvsRPingResponseTime=ibmMvsRPingResponseTime, ibmMvsTcpInWinUpdates=ibmMvsTcpInWinUpdates, ibmMvsDeviceIncomingSvcEnabled=ibmMvsDeviceIncomingSvcEnabled, ibmMvsOsaExpChannelCurLparNum=ibmMvsOsaExpChannelCurLparNum, ibmMvsUdpDgramIn=ibmMvsUdpDgramIn, ibmMvsAtmOsasfPvcFwdCellBurstSize=ibmMvsAtmOsasfPvcFwdCellBurstSize, ibmMvsIpOutDiscardsDlcSynch=ibmMvsIpOutDiscardsDlcSynch, ibmMvsTcpConnSockOpt=ibmMvsTcpConnSockOpt, ibmMvsDeviceType=ibmMvsDeviceType, osaexpPerfEntry=osaexpPerfEntry, ibmMvsDVIPADistPortTable=ibmMvsDVIPADistPortTable, ibmMvsOsaExpPerfProcessorUtil1Min=ibmMvsOsaExpPerfProcessorUtil1Min, ibmMvsDVIPADistConfPort=ibmMvsDVIPADistConfPort, ibmMvsAtmOsasfPvcBwdsustainCellRate=ibmMvsAtmOsasfPvcBwdsustainCellRate, ibmMvsIplDateAndTime=ibmMvsIplDateAndTime, ibmMvsLinkNumber=ibmMvsLinkNumber, ibmMvsDeviceProcname=ibmMvsDeviceProcname, ibmMvsRoundTripGain=ibmMvsRoundTripGain, ibmMvsTcpInDupAck=ibmMvsTcpInDupAck, ibmMvsAtmLecConfigEntry=ibmMvsAtmLecConfigEntry, ibmMvsTcpTimeStamp=ibmMvsTcpTimeStamp, ibmMvsDVIPAConnPolicyActionName=ibmMvsDVIPAConnPolicyActionName, ibmMvsOsaExpChannelPCIBusUtil5Min=ibmMvsOsaExpChannelPCIBusUtil5Min, ibmMvsAtmSnaLeMaxLECConnections=ibmMvsAtmSnaLeMaxLECConnections, ibmMvsTcpListenerCurrBacklog=ibmMvsTcpListenerCurrBacklog, ibmMvsAtmLecID=ibmMvsAtmLecID, ibmMvsAtmSnaLeTrEnableLoadBalancing=ibmMvsAtmSnaLeTrEnableLoadBalancing, ibmMvsTcpipStatisticsEnabled=ibmMvsTcpipStatisticsEnabled, ibmMvsOsasfHostName=ibmMvsOsasfHostName, ibmMvsDVIPAConnPort=ibmMvsDVIPAConnPort, ibmMvsTcpConnOptions=ibmMvsTcpConnOptions, ibmMvsUdpChecksum=ibmMvsUdpChecksum, ibmMvsAtmLecControlTimeout=ibmMvsAtmLecControlTimeout, ibmMvsAtmLecActualLanName=ibmMvsAtmLecActualLanName, ibmMvsAtmLecConfigLesAtmAddress=ibmMvsAtmLecConfigLesAtmAddress, ibmMvsLinkDeviceIndex=ibmMvsLinkDeviceIndex, ibmMvsTcpPredictAck=ibmMvsTcpPredictAck, ibmMvsUdpSockOpt=ibmMvsUdpSockOpt, ibmMvsDVIPADistConfTable=ibmMvsDVIPADistConfTable, ibmMvsDVIPAConnRemIpAddrType=ibmMvsDVIPAConnRemIpAddrType, ibmMvsGatewayDelayAcks=ibmMvsGatewayDelayAcks, ibmMvsTcpInBadLen=ibmMvsTcpInBadLen, ibmMvsTcpListenerLocalPort=ibmMvsTcpListenerLocalPort, ibmMvsPortBindIpAddr=ibmMvsPortBindIpAddr, ibmTCPIPmvsInterfacesGroup3=ibmTCPIPmvsInterfacesGroup3, ibmRemotePingGroup=ibmRemotePingGroup, ibmMvsTcpPassiveDrops=ibmMvsTcpPassiveDrops, ibmMvsTcpListenerMaxBacklog=ibmMvsTcpListenerMaxBacklog, ibmMvsOsaExpEthPortType=ibmMvsOsaExpEthPortType, ibmMvsTcpInShort=ibmMvsTcpInShort, ibmMvsAtmLecConfigMode=ibmMvsAtmLecConfigMode, ibmMvsAtmLecActualMaxDataFrameSize=ibmMvsAtmLecActualMaxDataFrameSize)
