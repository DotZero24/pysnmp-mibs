...
if mibBuilder.loadTexts:entitySensorMIB.setRevisions(('2002-12-16 00:00',))
...
entitySensorObjects=_EntitySensorObjects_ObjectIdentity((1,3,6,1,2,1,99,1))
_EntPhySensorTable_Object=MibTable
entPhySensorTable=_EntPhySensorTable_Object((1,3,6,1,2,1,99,1,1))
if mibBuilder.loadTexts:entPhySensorTable.setStatus(_A)
_EntPhySensorEntry_Object=MibTableRow
entPhySensorEntry=_EntPhySensorEntry_Object((1,3,6,1,2,1,99,1,1,1))
...
entPhySensorType=_EntPhySensorType_Object((1,3,6,1,2,1,99,1,1,1,1),_EntPhySensorType_Type())
...
entPhySensorScale=_EntPhySensorScale_Object((1,3,6,1,2,1,99,1,1,1,2),_EntPhySensorScale_Type())
...
entPhySensorPrecision=_EntPhySensorPrecision_Object((1,3,6,1,2,1,99,1,1,1,3),_EntPhySensorPrecision_Type())
...
entPhySensorValue=_EntPhySensorValue_Object((1,3,6,1,2,1,99,1,1,1,4),_EntPhySensorValue_Type())
...
entPhySensorOperStatus=_EntPhySensorOperStatus_Object((1,3,6,1,2,1,99,1,1,1,5),_EntPhySensorOperStatus_Type())
...
entPhySensorUnitsDisplay=_EntPhySensorUnitsDisplay_Object((1,3,6,1,2,1,99,1,1,1,6),_EntPhySensorUnitsDisplay_Type())
...
entPhySensorValueTimeStamp=_EntPhySensorValueTimeStamp_Object((1,3,6,1,2,1,99,1,1,1,7),_EntPhySensorValueTimeStamp_Type())
...
entPhySensorValueUpdateRate=_EntPhySensorValueUpdateRate_Object((1,3,6,1,2,1,99,1,1,1,8),_EntPhySensorValueUpdateRate_Type())
...
entitySensorConformance=_EntitySensorConformance_ObjectIdentity((1,3,6,1,2,1,99,3))
_EntitySensorCompliances_ObjectIdentity=ObjectIdentity
entitySensorCompliances=_EntitySensorCompliances_ObjectIdentity((1,3,6,1,2,1,99,3,1))
_EntitySensorGroups_ObjectIdentity=ObjectIdentity
entitySensorGroups=_EntitySensorGroups_ObjectIdentity((1,3,6,1,2,1,99,3,2))
entitySensorValueGroup=ObjectGroup((1,3,6,1,2,1,99,3,2,1))
...
entitySensorCompliance=ModuleCompliance((1,3,6,1,2,1,99,3,1,1))
