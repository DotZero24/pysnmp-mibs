...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/proxim/ORiNOCO-MIB
...
DisplayString, MacAddress, TimeInterval, TimeStamp, RowStatus, DateAndTime, PhysAddress, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "MacAddress", "TimeInterval", "TimeStamp", "RowStatus", "DateAndTime", "PhysAddress", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("ORiNOCO-MIB", oriWirelessIfSSIDTableVLANID=oriWirelessIfSSIDTableVLANID, oriLinkTestHisMaxNoiseLevel=oriLinkTestHisMaxNoiseLevel, oriRADIUSAcctServerResponseTime=oriRADIUSAcctServerResponseTime, oriLinkIntPollInterval=oriLinkIntPollInterval, oriRADIUSAcctClientStatTableBadAuthenticators=oriRADIUSAcctClientStatTableBadAuthenticators, oriWORPIfConfigTableRetries=oriWORPIfConfigTableRetries, oriWORPIfSatStatTableEntry=oriWORPIfSatStatTableEntry, oriWirelessIfAntennaGain=oriWirelessIfAntennaGain, oriRADScanResultsTableEntry=oriRADScanResultsTableEntry, oriSNMPInterfaceBitmask=oriSNMPInterfaceBitmask, oriNATStaticPortBindTableIndex=oriNATStaticPortBindTableIndex, oriSNTPMinutes=oriSNTPMinutes, oriVLANStatus=oriVLANStatus, oriWORPIfStatTableRegistrationRejects=oriWORPIfStatTableRegistrationRejects, oriHTTPSetupWizardStatus=oriHTTPSetupWizardStatus, oriSNMPAccessTable=oriSNMPAccessTable, oriIntraCellBlockingMACTableGroupID9=oriIntraCellBlockingMACTableGroupID9, oriProtocolFilterTable=oriProtocolFilterTable, oriSystemAccessMaxSessions=oriSystemAccessMaxSessions, oriWORPIfSatConfigTableMaximumBandwidthLimitDownlink=oriWORPIfSatConfigTableMaximumBandwidthLimitDownlink, oriSerialParity=oriSerialParity, oriRogueScanResultsFrequencyChannel=oriRogueScanResultsFrequencyChannel, oriWirelessIfSSIDTableSSIDAuthorizationStatus=oriWirelessIfSSIDTableSSIDAuthorizationStatus, oriRogueScanStationCountWirelessCardB=oriRogueScanStationCountWirelessCardB, oriSyslogHostTableEntry=oriSyslogHostTableEntry, orinocoWDS=orinocoWDS, oriWORPIfSatStatTableMacAddress=oriWORPIfSatStatTableMacAddress, oriSystemFeatureTable=oriSystemFeatureTable, oriLinkTestRadioType=oriLinkTestRadioType, orinocoVLAN=orinocoVLAN, oriEthernetIfConfigTableIndex=oriEthernetIfConfigTableIndex, oriSecurityProfileTableEncryptionKey1=oriSecurityProfileTableEncryptionKey1, oriBroadcastFilteringProtocolName=oriBroadcastFilteringProtocolName, oriSystemEventLogNumberOfMessages=oriSystemEventLogNumberOfMessages, oriWirelessIfSecurityEntry=oriWirelessIfSecurityEntry, oriWORPIfRoamingFastScanThreshold=oriWORPIfRoamingFastScanThreshold, oriStationStatTableOutDiscards=oriStationStatTableOutDiscards, oriPortFilterTableEntryIndex=oriPortFilterTableEntryIndex, oriWirelessIfQoSMaxMediumThreshold=oriWirelessIfQoSMaxMediumThreshold, oriRADIUSMACAddressFormat=oriRADIUSMACAddressFormat, oriRADIUSSvrTableAccountingUpdateInterval=oriRADIUSSvrTableAccountingUpdateInterval, oriTrapVarInterface=oriTrapVarInterface, oriPPPoESessionConfigPADITxInterval=oriPPPoESessionConfigPADITxInterval, oriTrapVarFailedAuthenticationType=oriTrapVarFailedAuthenticationType, oriTrapVarBatchCLIMessage=oriTrapVarBatchCLIMessage, oriTrapAuthenticationFailure=oriTrapAuthenticationFailure, oriImageTraps=oriImageTraps, oriWORPIfSatConfigTableIndex=oriWORPIfSatConfigTableIndex, oriWORPIfConfigTableBaseStationName=oriWORPIfConfigTableBaseStationName, oriSystemInvMgmtTableComponentSerialNumber=oriSystemInvMgmtTableComponentSerialNumber, oriWirelessIfSSIDTableRADIUSDot1xProfile=oriWirelessIfSSIDTableRADIUSDot1xProfile, oriIAPPMaximumHandoverRetransmissions=oriIAPPMaximumHandoverRetransmissions, ObjStatusActive=ObjStatusActive, oriVLANIDTableIdentifier=oriVLANIDTableIdentifier, oriHTTPWebSitenameTableEntry=oriHTTPWebSitenameTableEntry, bg2000=bg2000, oriLinkTestOurMaxNoiseLevel=oriLinkTestOurMaxNoiseLevel, oriWirelessIfDenyNonEncryptedData=oriWirelessIfDenyNonEncryptedData, oriRogueScanResultsTrapReportType=oriRogueScanResultsTrapReportType, oriTrapInvalidLicenseFile=oriTrapInvalidLicenseFile, oriTrapVarTFTPIPAddress=oriTrapVarTFTPIPAddress, orinocoIAPP=orinocoIAPP, orinocoPPPoE=orinocoPPPoE, oriRADIUSbasedManagementAccessProfile=oriRADIUSbasedManagementAccessProfile, oriIAPPPeriodicAnnounceInterval=oriIAPPPeriodicAnnounceInterval, oriTrapVarBatchCLILineNumber=oriTrapVarBatchCLILineNumber, oriIPARPFilteringIPAddress=oriIPARPFilteringIPAddress, oriTrapFlashMemoryCorrupted=oriTrapFlashMemoryCorrupted, orinocoWORPIfBSUStatRemoteTxRate=orinocoWORPIfBSUStatRemoteTxRate, orinocoDMZ=orinocoDMZ, oriRADIUSAuthClientAccessRejects=oriRADIUSAuthClientAccessRejects, oriNetworkIPDefaultTTL=oriNetworkIPDefaultTTL, oriTrapRogueScanCycleComplete=oriTrapRogueScanCycleComplete, oriWORPIfSatStatTableSendRetries=oriWORPIfSatStatTableSendRetries, oriStaticMACAddressFilterWirelessAddress=oriStaticMACAddressFilterWirelessAddress, oriPPPoESessionTableStatus=oriPPPoESessionTableStatus, oriWORPIfConfigTable=oriWORPIfConfigTable, oriSystemInvMgmtTableComponentName=oriSystemInvMgmtTableComponentName, oriNetworkIPConfigSubnetMask=oriNetworkIPConfigSubnetMask, oriStationStatTableInNoise=oriStationStatTableInNoise, oriSystemContactEmail=oriSystemContactEmail, oriTelnetPassword=oriTelnetPassword, oriRADIUSAuthClientAccessRetransmissions=oriRADIUSAuthClientAccessRetransmissions, oriSystemFlashUpdate=oriSystemFlashUpdate, orinocoNAT=orinocoNAT, oriStormThresholdIfBroadcast=oriStormThresholdIfBroadcast, oriQoSDot1DToDot1pMappingTableRowStatus=oriQoSDot1DToDot1pMappingTableRowStatus, oriWORPIfDDRSMinReqSNRdot11an36Mbps=oriWORPIfDDRSMinReqSNRdot11an36Mbps, oriDNSClientStatus=oriDNSClientStatus, oriOEMProductName=oriOEMProductName, orinocoUPSD=orinocoUPSD, oriPacketForwardingInterface=oriPacketForwardingInterface, oriQoSPolicyType=oriQoSPolicyType, oriTrapVarWirelessCard=oriTrapVarWirelessCard, oriWORPIfSatStatTableReplyNoData=oriWORPIfSatStatTableReplyNoData, oriSNMPReadWritePassword=oriSNMPReadWritePassword, oriWORPIfStatTableSendSuccess=oriWORPIfStatTableSendSuccess, oriSystemInvMgmtTableComponentIfTableEntry=oriSystemInvMgmtTableComponentIfTableEntry, ap1000=ap1000, oriSystemInvMgmtInterfaceVariant=oriSystemInvMgmtInterfaceVariant, oriWirelessIfClosedSystem=oriWirelessIfClosedSystem, oriStaticMACAddressFilterTableEntryStatus=oriStaticMACAddressFilterTableEntryStatus, oriLinkTestDataRateTableRemoteCount=oriLinkTestDataRateTableRemoteCount, oriTrapVarUnauthorizedClientMACAddress=oriTrapVarUnauthorizedClientMACAddress, orinocoIf=orinocoIf, oriSNMPReadPassword=oriSNMPReadPassword, oriPPPoESessionBindingsNumberPADTTx=oriPPPoESessionBindingsNumberPADTTx, oriTrapTFTPOperationInitiated=oriTrapTFTPOperationInitiated, oriTrapInvalidImage=oriTrapInvalidImage, orinocoSNMP=orinocoSNMP, oriWORPIfStatTableAverageRemoteNoise=oriWORPIfStatTableAverageRemoteNoise, orinocoDHCP=orinocoDHCP, oriWirelessIfSSIDTableRADIUSAccountingStatus=oriWirelessIfSSIDTableRADIUSAccountingStatus, oriDHCPClientID=oriDHCPClientID, oriNATStaticIPBindTableEntry=oriNATStaticIPBindTableEntry, oriSystemEventLogTable=oriSystemEventLogTable, oriDHCPServerNumIPPoolTableEntries=oriDHCPServerNumIPPoolTableEntries, orinocoNetIP=orinocoNetIP, oriProtocolFilterTableIndex=oriProtocolFilterTableIndex, oriPPPoESessionConnectTime=oriPPPoESessionConnectTime, oriPPPoESessionBindingsNumberServiceNameErrors=oriPPPoESessionBindingsNumberServiceNameErrors, oriWirelessIfSSIDTableSecurityMode=oriWirelessIfSSIDTableSecurityMode, oriIAPPHandoverRequestRetransmissions=oriIAPPHandoverRequestRetransmissions, oriWirelessIfEncryptionKey3=oriWirelessIfEncryptionKey3, oriHTTPWebSiteFilename=oriHTTPWebSiteFilename, oriRADIUSAcctUpdateInterval=oriRADIUSAcctUpdateInterval, oriStationStatTableLastInPktTime=oriStationStatTableLastInPktTime, oriBroadcastAddressThreshold=oriBroadcastAddressThreshold, oriIntraCellBlockingMACTableGroupID7=oriIntraCellBlockingMACTableGroupID7, oriWORPIfStatTableAverageRemoteSignal=oriWORPIfStatTableAverageRemoteSignal, oriQoSDot1DToIPDSCPMappingTableEntry=oriQoSDot1DToIPDSCPMappingTableEntry, oriSecurityProfileTableEncryptionTxKey=oriSecurityProfileTableEncryptionTxKey, oriSystemMode=oriSystemMode, oriSNMPAccessTableEntry=oriSNMPAccessTableEntry, oriRADIUSAcctServerSharedSecret=oriRADIUSAcctServerSharedSecret, oriConfigSaveKnownGood=oriConfigSaveKnownGood, oriTrapWLCVoltageDiscrepancy=oriTrapWLCVoltageDiscrepancy, oriIAPPPDUsDropped=oriIAPPPDUsDropped, oriSecurityProfileTableEncryptionKeyLength=oriSecurityProfileTableEncryptionKeyLength, oriWirelessIfSSIDTableRekeyingInterval=oriWirelessIfSSIDTableRekeyingInterval, oriPortFilterTableEntryPortType=oriPortFilterTableEntryPortType, oriWORPIfDDRSDataRateDecPercentThreshold=oriWORPIfDDRSDataRateDecPercentThreshold, orinocoStaticMACAddressFilter=orinocoStaticMACAddressFilter, oriIAPPAnnounceRequestReceived=oriIAPPAnnounceRequestReceived, oriWORPIfDDRSDataRateIncPercentThreshold=oriWORPIfDDRSDataRateIncPercentThreshold, oriWORPIfStatTableEntry=oriWORPIfStatTableEntry, oriRADIUSClientInvalidSvrAddress=oriRADIUSClientInvalidSvrAddress, orinocoSNTP=orinocoSNTP, oriUnitTemp=oriUnitTemp, oriConfigurationTraps=oriConfigurationTraps, oriWORPIfSatConfigTableEntry=oriWORPIfSatConfigTableEntry, oriDHCPServerIPPoolTableEntryStatus=oriDHCPServerIPPoolTableEntryStatus, oriSNMPAccessTableIPAddress=oriSNMPAccessTableIPAddress, oriIAPPRoamingClients=oriIAPPRoamingClients, PYSNMP_MODULE_ID=orinoco, oriWirelessIfRegulatoryDomainList=oriWirelessIfRegulatoryDomainList, orinocoRADIUSAuth=orinocoRADIUSAuth, oriWORPIfStatTableAuthenticationRequests=oriWORPIfStatTableAuthenticationRequests, orinocoWORPIfBSUStatAverageLocalNoise=orinocoWORPIfBSUStatAverageLocalNoise, DisplayString80=DisplayString80, as2000=as2000, oriTelnetIdleTimeout=oriTelnetIdleTimeout, oriWORPIfSatStatTableAverageRemoteSignal=oriWORPIfSatStatTableAverageRemoteSignal, oriWirelessIfPropertiesEntry=oriWirelessIfPropertiesEntry, oriWORPIfSiteSurveyMaxSatAllowed=oriWORPIfSiteSurveyMaxSatAllowed, oriWORPIfStatTableReplyNoData=oriWORPIfStatTableReplyNoData, oriDNSRedirectStatus=oriDNSRedirectStatus, oriSecurityTrapsStatus=oriSecurityTrapsStatus, oriWORPIfSiteSurveyCurrentSatRegistered=oriWORPIfSiteSurveyCurrentSatRegistered, oriQoSPolicyMarkingStatus=oriQoSPolicyMarkingStatus, ObjStatus=ObjStatus, oriStaticMACAddressFilterComment=oriStaticMACAddressFilterComment, oriHTTPWebSiteLanguage=oriHTTPWebSiteLanguage, orinocoWORPIfDDRS=orinocoWORPIfDDRS, orinocoWORPIfBSUStatMACAddress=orinocoWORPIfBSUStatMACAddress, oriWORPIfSatConfigTableComment=oriWORPIfSatConfigTableComment, oriEthernetIfConfigSettings=oriEthernetIfConfigSettings, oriWirelessIfEncryptionKey1=oriWirelessIfEncryptionKey1, oriWORPIfSatStatTablePollNoData=oriWORPIfSatStatTablePollNoData, oriWORPIfStatTablePollData=oriWORPIfStatTablePollData, oriNATStaticIPBindLocalAddress=oriNATStaticIPBindLocalAddress, oriTrapImageTooLarge=oriTrapImageTooLarge, oriIAPPMACIPTableESSID=oriIAPPMACIPTableESSID, oriPortFilterTable=oriPortFilterTable, oriIntraCellBlockingMACTableGroupID14=oriIntraCellBlockingMACTableGroupID14, oriRADIUSAcctClientAccountingRequests=oriRADIUSAcctClientAccountingRequests, oriWirelessIfSuperModeStatus=oriWirelessIfSuperModeStatus, oriWORPIfConfigTableMode=oriWORPIfConfigTableMode, oriTFTPFileType=oriTFTPFileType, oriSNMPTrapHostTableComment=oriSNMPTrapHostTableComment, oriTrapSSLInitializationFailure=oriTrapSSLInitializationFailure, oriRADIUSAuthClientMalformedAccessResponses=oriRADIUSAuthClientMalformedAccessResponses, oriDHCPServerIPPoolTableDefaultLeaseTime=oriDHCPServerIPPoolTableDefaultLeaseTime, oriWORPIfSatStatTableRemoteTxRate=oriWORPIfSatStatTableRemoteTxRate, orinocoAccessControl=orinocoAccessControl, oriNATStatus=oriNATStatus, orinocoSys=orinocoSys, oriLinkTestStationProfile=oriLinkTestStationProfile, oriPacketForwardingMACAddress=oriPacketForwardingMACAddress, oriStationStatTableRemoteNoise=oriStationStatTableRemoteNoise, oriSNTPPrimaryServerNameOrIPAddress=oriSNTPPrimaryServerNameOrIPAddress, oriSNTPDateAndTime=oriSNTPDateAndTime, oriSystemInvMgmtTableComponentMajorVersion=oriSystemInvMgmtTableComponentMajorVersion, orinocoPacketForwarding=orinocoPacketForwarding, oriEthernetIfConfigBandwidthLimitOut=oriEthernetIfConfigBandwidthLimitOut, orinocoRADIUSAcct=orinocoRADIUSAcct, orinocoIBSSTraffic=orinocoIBSSTraffic, oriProtocolFilterProtocolString=oriProtocolFilterProtocolString, oriIntraCellBlockingMACTableGroupID4=oriIntraCellBlockingMACTableGroupID4, oriTFTPTrapsStatus=oriTFTPTrapsStatus, oriIBSSTrafficOperation=oriIBSSTrafficOperation, oriSecurityRekeyingInterval=oriSecurityRekeyingInterval, oriConfigFileTableEntry=oriConfigFileTableEntry, oriRADIUSAcctClientStatTableIndex=oriRADIUSAcctClientStatTableIndex, oriBroadcastFilteringTableEntryStatus=oriBroadcastFilteringTableEntryStatus, oriLinkTestHisHighFrameCount=oriLinkTestHisHighFrameCount, oriProtocolFilterOperationType=oriProtocolFilterOperationType, oriWORPIfSiteSurveyLocalSNR=oriWORPIfSiteSurveyLocalSNR, oriWirelessIfTurboModeStatus=oriWirelessIfTurboModeStatus, oriWirelessIfChannel=oriWirelessIfChannel, oriRADIUSAuthClientStatTable=oriRADIUSAuthClientStatTable, oriSysFeatureTraps=oriSysFeatureTraps, oriPPPoEMACtoSessionTableISPName=oriPPPoEMACtoSessionTableISPName, oriNATStaticIPBindTable=oriNATStaticIPBindTable, oriTrapSSHInitializationStatus=oriTrapSSHInitializationStatus, oriWirelessIfSSIDTableBroadcastSSID=oriWirelessIfSSIDTableBroadcastSSID, oriHTTPWebSitenameTableStatus=oriHTTPWebSitenameTableStatus, oriTelnetSSHStatus=oriTelnetSSHStatus, orinocoTFTP=orinocoTFTP, oriRADIUSAcctClientAccountingRetransmissions=oriRADIUSAcctClientAccountingRetransmissions, oriQoSPolicyTable=oriQoSPolicyTable, oriIAPPHandoverResponseSent=oriIAPPHandoverResponseSent, oriHTTPInterfaceBitmask=oriHTTPInterfaceBitmask, oriWirelessIfSSIDTableRADIUSMACAccessControl=oriWirelessIfSSIDTableRADIUSMACAccessControl, oriWirelessIfSSIDTableSupportedSecurityModes=oriWirelessIfSSIDTableSupportedSecurityModes, oriRADScanResultsMACAddress=oriRADScanResultsMACAddress, oriTelnetSSHFingerPrint=oriTelnetSSHFingerPrint, oriSNTPYear=oriSNTPYear, oriRADIUSSvrTable=oriRADIUSSvrTable, oriWORPIfDDRSMinReqSNRdot11at48Mbps=oriWORPIfDDRSMinReqSNRdot11at48Mbps, oriHTTPPassword=oriHTTPPassword, oriStaticMACAddressFilterEntry=oriStaticMACAddressFilterEntry, oriMulticastAddressThreshold=oriMulticastAddressThreshold, oriSecurityProfileTableCipherMode=oriSecurityProfileTableCipherMode, oriSystemFeatureTableDescription=oriSystemFeatureTableDescription, oriWORPIfDDRSMinReqSNRdot11an54Mbps=oriWORPIfDDRSMinReqSNRdot11an54Mbps, oriWORPIfDDRSDataRateIncReqSNRThreshold=oriWORPIfDDRSDataRateIncReqSNRThreshold, oriRADIUSAcctClientStatTable=oriRADIUSAcctClientStatTable, oriSystemAccessIdleTimeout=oriSystemAccessIdleTimeout, oriWORPIfStatTableReceiveFailures=oriWORPIfStatTableReceiveFailures, oriWirelessIfSecurityTable=oriWirelessIfSecurityTable, oriWORPIfSiteSurveyLocalSignalLevel=oriWORPIfSiteSurveyLocalSignalLevel, oriRADIUSAuthServerResponseTime=oriRADIUSAuthServerResponseTime, oriWirelessIfOperationalMode=oriWirelessIfOperationalMode)
mibBuilder.exportSymbols("ORiNOCO-MIB", oriRADIUSAuthServerMaximumRetransmission=oriRADIUSAuthServerMaximumRetransmission, oriIntraCellBlockingGroupTableEntry=oriIntraCellBlockingGroupTableEntry, oriDHCPRelayDHCPServerTableIndex=oriDHCPRelayDHCPServerTableIndex, oriWORPIfSatConfigTableMaximumBandwidthLimitUplink=oriWORPIfSatConfigTableMaximumBandwidthLimitUplink, oriRADIUSAcctServerTableEntry=oriRADIUSAcctServerTableEntry, oriSecurityProfileTableEntry=oriSecurityProfileTableEntry, oriIntraCellBlockingMACTableGroupID5=oriIntraCellBlockingMACTableGroupID5, oriNetworkIPConfigIPAddress=oriNetworkIPConfigIPAddress, oriTempLogTableReset=oriTempLogTableReset, oriSpanningTreeStatus=oriSpanningTreeStatus, oriWORPIfSatStatTableReceiveFailures=oriWORPIfSatStatTableReceiveFailures, oriSyslogHostComment=oriSyslogHostComment, oriWORPIfDDRSDefDataRate=oriWORPIfDDRSDefDataRate, oriNATStaticIPBindRemoteAddress=oriNATStaticIPBindRemoteAddress, oriTrapWLCFirmwareFailure=oriTrapWLCFirmwareFailure, oriProtocolFilterTableEntry=oriProtocolFilterTableEntry, oriConfigFileName=oriConfigFileName, oriSecurityConfigTableSupportedSecurityModes=oriSecurityConfigTableSupportedSecurityModes, orinocoDHCPClient=orinocoDHCPClient, oriTelnetRADIUSAccessControl=oriTelnetRADIUSAccessControl, oriTrapDHCPRelayServerTableNotConfigured=oriTrapDHCPRelayServerTableNotConfigured, oriAOLNATALGStatus=oriAOLNATALGStatus, oriTFTPAutoConfigServerIPAddress=oriTFTPAutoConfigServerIPAddress, oriLinkTestHisLowFrameCount=oriLinkTestHisLowFrameCount, oriPortFilterTableEntryStatus=oriPortFilterTableEntryStatus, oriStationStatStatus=oriStationStatStatus, oriRADIUSAcctClientStatTableAccountingRequests=oriRADIUSAcctClientStatTableAccountingRequests, oriRADIUSAuthClientStatTableAccessRetransmissions=oriRADIUSAuthClientStatTableAccessRetransmissions, oriWORPIfDDRSMinReqSNRdot11an48Mbps=oriWORPIfDDRSMinReqSNRdot11an48Mbps, oriSecurityProfileTablePSKPassPhrase=oriSecurityProfileTablePSKPassPhrase, orinocoLinkInt=orinocoLinkInt, oriDHCPServerIPPoolTableMaximumLeaseTime=oriDHCPServerIPPoolTableMaximumLeaseTime, oriRADIUSAcctServerNameOrIPAddress=oriRADIUSAcctServerNameOrIPAddress, oriTrapVarTFTPFilename=oriTrapVarTFTPFilename, oriWirelessIfEncryptionTxKey=oriWirelessIfEncryptionTxKey, orinocoWORPIfSatConfig=orinocoWORPIfSatConfig, oriWirelessIfSSIDTableRADIUSAccountingProfile=oriWirelessIfSSIDTableRADIUSAccountingProfile, oriPPPoEMaximumNumberOfSessions=oriPPPoEMaximumNumberOfSessions, oriIntraCellBlockingMACTableGroupID16=oriIntraCellBlockingMACTableGroupID16, oriWirelessIfInterferenceRobustness=oriWirelessIfInterferenceRobustness, oriWORPIfStatTableReplyMoreData=oriWORPIfStatTableReplyMoreData, oriIntraCellBlockingMACTable=oriIntraCellBlockingMACTable, oriRADInterval=oriRADInterval, oriProtocolFilterInterfaceBitmask=oriProtocolFilterInterfaceBitmask, orinocoConformance=orinocoConformance, oriVLANIDTable=oriVLANIDTable, oriVLANIDTableEntry=oriVLANIDTableEntry, oriRADIUSAcctClientAccountingResponses=oriRADIUSAcctClientAccountingResponses, oriSerialFlowControl=oriSerialFlowControl, oriWORPIfSiteSurveyRemoteSNR=oriWORPIfSiteSurveyRemoteSNR, oriTrapRADIUSAccountingNotConfigured=oriTrapRADIUSAccountingNotConfigured, oriWirelessIfPropertiesIndex=oriWirelessIfPropertiesIndex, oriWirelessIfMulticastRate=oriWirelessIfMulticastRate, oriRADIUSAuthClientStatTableEntry=oriRADIUSAuthClientStatTableEntry, oriQoSIPDSCPUpperLimit=oriQoSIPDSCPUpperLimit, oriProtocolFilterTableEntryStatus=oriProtocolFilterTableEntryStatus, oriWORPIfSatStatTableIndex=oriWORPIfSatStatTableIndex, oriDHCPRelayDHCPServerTableEntry=oriDHCPRelayDHCPServerTableEntry, oriRADIUSAuthServerTableIndex=oriRADIUSAuthServerTableIndex, oriDHCPServerIPPoolTableWidth=oriDHCPServerIPPoolTableWidth, oriSecurityProfileFourWEPKeySupport=oriSecurityProfileFourWEPKeySupport, oriWirelessIfDFSStatus=oriWirelessIfDFSStatus, oriRADIUSAuthClientStatTableBadAuthenticators=oriRADIUSAuthClientStatTableBadAuthenticators, oriTFTPAutoConfigStatus=oriTFTPAutoConfigStatus, oriWORPIfDDRSStatus=oriWORPIfDDRSStatus, oriConfigResetToDefaults=oriConfigResetToDefaults, oriRADIUSAcctInactivityTimer=oriRADIUSAcctInactivityTimer, oriLinkTestHisCurNoiseLevel=oriLinkTestHisCurNoiseLevel, oriRogueScanResultsTableIndex=oriRogueScanResultsTableIndex, oriTrapIncompatibleLicenseFile=oriTrapIncompatibleLicenseFile, oriWORPIfSatStatTableSendFailures=oriWORPIfSatStatTableSendFailures, oriSecurityProfileTableEncryptionKey0=oriSecurityProfileTableEncryptionKey0, oriRogueScanConfigTableScanCycleTime=oriRogueScanConfigTableScanCycleTime, oriTrapUnauthorizedManagerDetected=oriTrapUnauthorizedManagerDetected, oriWORPIfSatStatTableSendSuccess=oriWORPIfSatStatTableSendSuccess, oriQoSDot1DToIPDSCPPriority=oriQoSDot1DToIPDSCPPriority, oriLinkTestHisCurSignalLevel=oriLinkTestHisCurSignalLevel, orinocoSpanningTree=orinocoSpanningTree, oriDHCPServerSecondaryDNSIPAddress=oriDHCPServerSecondaryDNSIPAddress, oriSecurityHwConfigResetStatus=oriSecurityHwConfigResetStatus, oriWirelessIfSSIDTablePSKPassPhrase=oriWirelessIfSSIDTablePSKPassPhrase, orinocoNet=orinocoNet, oriRADIUSAcctServerAddressingFormat=oriRADIUSAcctServerAddressingFormat, oriIAPPHandoverRequestReceived=oriIAPPHandoverRequestReceived, oriWORPIfSiteSurveyTable=oriWORPIfSiteSurveyTable, oriWORPIfDDRSMinReqSNRdot11at96Mbps=oriWORPIfDDRSMinReqSNRdot11at96Mbps, oriWORPIfStatTableAverageLocalSignal=oriWORPIfStatTableAverageLocalSignal, oriWORPIfSatConfigStatus=oriWORPIfSatConfigStatus, oriWORPIfStatTableAverageLocalNoise=oriWORPIfStatTableAverageLocalNoise, oriPPPoEStatus=oriPPPoEStatus, oriSecurityProfileTableEncryptionKey3=oriSecurityProfileTableEncryptionKey3, oriWORPIfSatConfigTableMacAddress=oriWORPIfSatConfigTableMacAddress, oriWORPIfDDRSMinReqSNRdot11an18Mbps=oriWORPIfDDRSMinReqSNRdot11an18Mbps, oriRADIUSSvrTableMACAddressFormat=oriRADIUSSvrTableMACAddressFormat, rg1100=rg1100, oriLinkTestOurCurSNR=oriLinkTestOurCurSNR, oriIPARPFilteringStatus=oriIPARPFilteringStatus, oriWORPIfStatTableRegistrationRequests=oriWORPIfStatTableRegistrationRequests, oriSecurityConfigTable=oriSecurityConfigTable, oriLinkTestInterface=oriLinkTestInterface, oriRADIUSAcctServerTableEntryStatus=oriRADIUSAcctServerTableEntryStatus, oriUPSDRoamingReserved=oriUPSDRoamingReserved, oriTelnetSessions=oriTelnetSessions, oriTrapVarTFTPOperation=oriTrapVarTFTPOperation, oriWirelessIfEncryptionKey2=oriWirelessIfEncryptionKey2, oriNATStaticPortBindLocalAddress=oriNATStaticPortBindLocalAddress, oriPortFilterTableEntryComment=oriPortFilterTableEntryComment, oriLinkTestInProgress=oriLinkTestInProgress, oriTempLogTable=oriTempLogTable, oriWORPIfSiteSurveyRemoteNoiseLevel=oriWORPIfSiteSurveyRemoteNoiseLevel, oriRADIUSAuthServerDestPort=oriRADIUSAuthServerDestPort, rg1000=rg1000, oriWORPIfSiteSurveyLocalNoiseLevel=oriWORPIfSiteSurveyLocalNoiseLevel, oriIAPPMACIPTableEntry=oriIAPPMACIPTableEntry, oriQoSDot1DToIPDSCPMappingTableRowStatus=oriQoSDot1DToIPDSCPMappingTableRowStatus, orinocoAdvancedFiltering=orinocoAdvancedFiltering, oriStaticMACAddressFilterWiredMask=oriStaticMACAddressFilterWiredMask, oriConfigurationTrapsStatus=oriConfigurationTrapsStatus, oriWirelessIfLBAdjAPTimeDiffThreshold=oriWirelessIfLBAdjAPTimeDiffThreshold, oriRogueScanResultsTableEntry=oriRogueScanResultsTableEntry, orinocoProtocolFilter=orinocoProtocolFilter, oriWirelessIfAntenna=oriWirelessIfAntenna, oriSystemInvMgmtTableComponentVariant=oriSystemInvMgmtTableComponentVariant, orinocoSysInvMgmt=orinocoSysInvMgmt, oriRADAccessPointCount=oriRADAccessPointCount, oriSystemInvMgmtTableComponentIfTable=oriSystemInvMgmtTableComponentIfTable, oriAccessControlTableIndex=oriAccessControlTableIndex, oriRADIUSAuthServerType=oriRADIUSAuthServerType, oriWORPStationRegister=oriWORPStationRegister, oriAccessControlTableMACAddress=oriAccessControlTableMACAddress, oriRogueScanResultsTableAgingTime=oriRogueScanResultsTableAgingTime, oriTrapWLCFirmwareDownloadFailure=oriTrapWLCFirmwareDownloadFailure, oriPPPoESessionUserNamePassword=oriPPPoESessionUserNamePassword, orinocoWORPIfBSUStatLocalTxRate=orinocoWORPIfBSUStatLocalTxRate, oriDHCPServerDefaultGatewayIPAddress=oriDHCPServerDefaultGatewayIPAddress, oriRADIUSLocalUserStatus=oriRADIUSLocalUserStatus, oriSecurityConfigTableRekeyingInterval=oriSecurityConfigTableRekeyingInterval, oriWirelessIfSSIDTableMACAccessControl=oriWirelessIfSSIDTableMACAccessControl, orinocoSerial=orinocoSerial, oriRADIUSAuthServerTable=oriRADIUSAuthServerTable, oriDHCPServerStatus=oriDHCPServerStatus, oriStationStatTableOutUcastPkts=oriStationStatTableOutUcastPkts, oriWORPIfSiteSurveyBaseMACAddress=oriWORPIfSiteSurveyBaseMACAddress, oriMiscTraps=oriMiscTraps, oriIntraCellBlockingMACTableIndex=oriIntraCellBlockingMACTableIndex, oriNATStaticPortBindTableEntry=oriNATStaticPortBindTableEntry, oriWORPIfSiteSurveyTableIndex=oriWORPIfSiteSurveyTableIndex, oriOEMNoNavLogoImageFile=oriOEMNoNavLogoImageFile, oriAccessControlTableEntryStatus=oriAccessControlTableEntryStatus, oriTrapWLCNotPresent=oriTrapWLCNotPresent, oriTrapRADScanResults=oriTrapRADScanResults, oriSNMPTrapHostTable=oriSNMPTrapHostTable, oriADSLIfTrapsStatus=oriADSLIfTrapsStatus, oriWORPIfRoamingSlowScanPercentThreshold=oriWORPIfRoamingSlowScanPercentThreshold, oriTrapBatchFileExecEnd=oriTrapBatchFileExecEnd, oriLinkTestHisMinNoiseLevel=oriLinkTestHisMinNoiseLevel, oriWirelessIfMediumReservation=oriWirelessIfMediumReservation, oriHTTPWebSitenameTableIndex=oriHTTPWebSitenameTableIndex, ap500=ap500, oriTrapAutoConfigFailure=oriTrapAutoConfigFailure, oriOEMLogoImageFile=oriOEMLogoImageFile, oriIAPPMACIPTableSystemName=oriIAPPMACIPTableSystemName, oriWORPIfDDRSDataRateIncAvgSNRThreshold=oriWORPIfDDRSDataRateIncAvgSNRThreshold, oriSystemEventLogTableReset=oriSystemEventLogTableReset, oriTrapVarDHCPServerIPAddress=oriTrapVarDHCPServerIPAddress, oriWirelessIfPreambleType=oriWirelessIfPreambleType, oriWDSSecurityTable=oriWDSSecurityTable, oriStationStatTableLastState=oriStationStatTableLastState, oriDHCPServerIPPoolTableEntry=oriDHCPServerIPPoolTableEntry, oriRADIUSAcctClientStatTableAccountingRetransmissions=oriRADIUSAcctClientStatTableAccountingRetransmissions, oriSystemInvMgmtTableComponentMinorVersion=oriSystemInvMgmtTableComponentMinorVersion, oriSecurityConfigTableEntry=oriSecurityConfigTableEntry, oriNATStaticPortBindEndPortNumber=oriNATStaticPortBindEndPortNumber, oriQoSDot1DToDot1pMappingTableIndex=oriQoSDot1DToDot1pMappingTableIndex, oriTrapFeatureNotSupported=oriTrapFeatureNotSupported, oriWirelessIfEncryptionStatus=oriWirelessIfEncryptionStatus, oriVLANIDTableIndex=oriVLANIDTableIndex, oriWORPIfDDRSMaxDataRate=oriWORPIfDDRSMaxDataRate, oriAccessControlEntry=oriAccessControlEntry, oriWirelessIfProtectionMechanismStatus=oriWirelessIfProtectionMechanismStatus, oriPPPoESessionUserName=oriPPPoESessionUserName, oriRADIUSAuthClientStatTableAccessRequests=oriRADIUSAuthClientStatTableAccessRequests, ap700=ap700, ap4000=ap4000, oriLinkTestOurLowFrameCount=oriLinkTestOurLowFrameCount, oriLinkTestTableEntry=oriLinkTestTableEntry, oriWORPIfDDRSMinReqSNRdot11at12Mbps=oriWORPIfDDRSMinReqSNRdot11at12Mbps, oriTrapUnrecoverableSoftwareErrorDetected=oriTrapUnrecoverableSoftwareErrorDetected, oriRADIUSAuthClientStatTableMalformedAccessResponses=oriRADIUSAuthClientStatTableMalformedAccessResponses, oriRADIUSAuthClientStatTableAccessChallenges=oriRADIUSAuthClientStatTableAccessChallenges, oriConfigFileTableIndex=oriConfigFileTableIndex, oriSyslogHostTable=oriSyslogHostTable, oriDHCPClientInterfaceBitmask=oriDHCPClientInterfaceBitmask, oriRADIUSSvrTableRowStatus=oriRADIUSSvrTableRowStatus, oriWORPIfSatStatTableRequestForService=oriWORPIfSatStatTableRequestForService, oriSyslogHeartbeatInterval=oriSyslogHeartbeatInterval, oriWirelessIfWSSStatus=oriWirelessIfWSSStatus, oriSNMPTrapHostTableIPAddress=oriSNMPTrapHostTableIPAddress, oriLinkIntTableTargetIPAddress=oriLinkIntTableTargetIPAddress, oriWirelessIfSSIDTableEncryptionKey0=oriWirelessIfSSIDTableEncryptionKey0, orinocoFiltering=orinocoFiltering, oriRogueScanResultsTableClearEntries=oriRogueScanResultsTableClearEntries, oriTrapBatchExecFailure=oriTrapBatchExecFailure, oriRADIUSAuthClientAccessAccepts=oriRADIUSAuthClientAccessAccepts, oriSNMPAccessTableEntryStatus=oriSNMPAccessTableEntryStatus, oriRADIUSSvrTableEntry=oriRADIUSSvrTableEntry, oriWORPIfSatConfigTableEntryStatus=oriWORPIfSatConfigTableEntryStatus, oriTrapBatchFileExecStart=oriTrapBatchFileExecStart, oriTrapRADScanComplete=oriTrapRADScanComplete, oriSNMPV3AuthPassword=oriSNMPV3AuthPassword, oriRADIUSLocalUserPassword=oriRADIUSLocalUserPassword, oriIAPPHandoverResponseReceived=oriIAPPHandoverResponseReceived, oriWORPIfRoamingFastScanPercentThreshold=oriWORPIfRoamingFastScanPercentThreshold, oriWDSSetupTableEntryStatus=oriWDSSetupTableEntryStatus, orinocoStormThreshold=orinocoStormThreshold, oriWORPIfRoamingSlowScanThreshold=oriWORPIfRoamingSlowScanThreshold, oriStaticMACAddressFilterTableIndex=oriStaticMACAddressFilterTableIndex, oriLinkIntPollRetransmissions=oriLinkIntPollRetransmissions, oriPPPoESessionBindingsNumberACSystemErrors=oriPPPoESessionBindingsNumberACSystemErrors, oriQoSPolicyTableSecIndex=oriQoSPolicyTableSecIndex, oriLinkTestHisMaxSNR=oriLinkTestHisMaxSNR, oriRADIUSSvrTableVLANID=oriRADIUSSvrTableVLANID, orinocoWORPIfBSUStatAverageRemoteSignal=orinocoWORPIfBSUStatAverageRemoteSignal, oriLinkTestHisMaxSignalLevel=oriLinkTestHisMaxSignalLevel, oriEthernetIfConfigTable=oriEthernetIfConfigTable, oriWORPIfStatTableRegistrationTimeouts=oriWORPIfStatTableRegistrationTimeouts, oriDHCPRelayDHCPServerTableEntryStatus=oriDHCPRelayDHCPServerTableEntryStatus, oriPPPoESessionWANConnectMode=oriPPPoESessionWANConnectMode, oriTrapUselessLicense=oriTrapUselessLicense, oriRADIUSSvrTableResponseTime=oriRADIUSSvrTableResponseTime, oriWORPIfSatStatTableAverageLocalSignal=oriWORPIfSatStatTableAverageLocalSignal, oriWORPTraps=oriWORPTraps, oriPortFilterOperationType=oriPortFilterOperationType, oriWirelessIfQoSStatus=oriWirelessIfQoSStatus, oriWORPIfStatTableAuthenticationConfirms=oriWORPIfStatTableAuthenticationConfirms, orinocoDHCPServer=orinocoDHCPServer, oriPortFilterStatus=oriPortFilterStatus, oriWORPIfSiteSurveyBaseName=oriWORPIfSiteSurveyBaseName, oriSystemInvMgmtTableComponentReleaseVersion=oriSystemInvMgmtTableComponentReleaseVersion, oriHTTPPort=oriHTTPPort, oriSecurityHwConfigResetPassword=oriSecurityHwConfigResetPassword, oriSecurityTraps=oriSecurityTraps, oriPortFilterTableEntry=oriPortFilterTableEntry, orinocoIntraCellBlocking=orinocoIntraCellBlocking, oriAccessControlStatus=oriAccessControlStatus, oriWirelessIfTPCMode=oriWirelessIfTPCMode, oriIAPPMACIPTable=oriIAPPMACIPTable, orinocoDNSClient=orinocoDNSClient, oriStationStatTableIPAddress=oriStationStatTableIPAddress, oriIntraCellBlockingGroupTable=oriIntraCellBlockingGroupTable, oriWirelessIfSSIDTableSSID=oriWirelessIfSSIDTableSSID, orinocoWORPIfBSUStat=orinocoWORPIfBSUStat, oriIAPPMACIPTableIPAddress=oriIAPPMACIPTableIPAddress, oriTrapWLCIncompatibleFirmware=oriTrapWLCIncompatibleFirmware)
mibBuilder.exportSymbols("ORiNOCO-MIB", oriIntraCellBlockingMACTableGroupID2=oriIntraCellBlockingMACTableGroupID2, oriTrapTaskSuspended=oriTrapTaskSuspended, oriNATStaticPortBindTable=oriNATStaticPortBindTable, oriRADScanResultsTableIndex=oriRADScanResultsTableIndex, orinocoTempLog=orinocoTempLog, oriRADIUSAuthClientStatTableTimeouts=oriRADIUSAuthClientStatTableTimeouts, oriWirelessIfSSIDTableStatus=oriWirelessIfSSIDTableStatus, oriNetworkIPDefaultRouterIPAddress=oriNetworkIPDefaultRouterIPAddress, oriWORPIfStatTableRegistrationLastReason=oriWORPIfStatTableRegistrationLastReason, oriWORPIfDDRSDataRateDecReqSNRThreshold=oriWORPIfDDRSDataRateDecReqSNRThreshold, orinocoCompliances=orinocoCompliances, oriBroadcastFilteringTableEntry=oriBroadcastFilteringTableEntry, oriTrapWORPIfNetworkSecretNotConfigured=oriTrapWORPIfNetworkSecretNotConfigured, orinocoObjects=orinocoObjects, oriOperationalTraps=oriOperationalTraps, oriDHCPRelayDHCPServerTableComment=oriDHCPRelayDHCPServerTableComment, orinocoWORPIfSiteSurvey=orinocoWORPIfSiteSurvey, oriIntraCellBlockingMACTableGroupID12=oriIntraCellBlockingMACTableGroupID12, oriSpectraLinkStatus=oriSpectraLinkStatus, orinocoTelnet=orinocoTelnet, oriWirelessIfCapabilities=oriWirelessIfCapabilities, oriWORPIfSiteSurveyOperation=oriWORPIfSiteSurveyOperation, oriDHCPServerSubnetMask=oriDHCPServerSubnetMask, oriSpectraLinkLegacyDeviceSupport=oriSpectraLinkLegacyDeviceSupport, oriSystemFeatureTableSupported=oriSystemFeatureTableSupported, oriTrapInvalidImageDigitalSignature=oriTrapInvalidImageDigitalSignature, oriLinkTestHisMinSNR=oriLinkTestHisMinSNR, oriNATStaticIPBindTableIndex=oriNATStaticIPBindTableIndex, oriRADStatus=oriRADStatus, oriSystemInvMgmtInterfaceBottomNumber=oriSystemInvMgmtInterfaceBottomNumber, oriSystemContactPhoneNumber=oriSystemContactPhoneNumber, oriQoSDot1DToDot1pMappingTable=oriQoSDot1DToDot1pMappingTable, oriWirelessIfProfileCode=oriWirelessIfProfileCode, oriSystemInvMgmtInterfaceTopNumber=oriSystemInvMgmtInterfaceTopNumber, oriWirelessIfSSIDTableEncryptionKey2=oriWirelessIfSSIDTableEncryptionKey2, oriTempLogMessage=oriTempLogMessage, oriRADIUSSvrTableSharedSecret=oriRADIUSSvrTableSharedSecret, oriProtocolFilterProtocolComment=oriProtocolFilterProtocolComment, oriPPPoESessionWANConnectionStatus=oriPPPoESessionWANConnectionStatus, oriTrapTFTPOperationCompleted=oriTrapTFTPOperationCompleted, oriIAPPHandoverRequestSent=oriIAPPHandoverRequestSent, orinocoSyslog=orinocoSyslog, oriSystemInvMgmtTableComponentIndex=oriSystemInvMgmtTableComponentIndex, orinocoRAD=orinocoRAD, oriTrapRADIUSServerNotResponding=oriTrapRADIUSServerNotResponding, oriEthernetIfConfigBandwidthLimitIn=oriEthernetIfConfigBandwidthLimitIn, oriQoSIPDSCPLowerLimit=oriQoSIPDSCPLowerLimit, WEPKeyType=WEPKeyType, oriWDSSetupTableEntry=oriWDSSetupTableEntry, oriTrapVariable=oriTrapVariable, oriHTTPSSLStatus=oriHTTPSSLStatus, oriTrapVarTaskSuspended=oriTrapVarTaskSuspended, oriPPPoESessionConfigPADIMaxNumberOfRetries=oriPPPoESessionConfigPADIMaxNumberOfRetries, oriProtocolFilterTableInterfaceBitmask=oriProtocolFilterTableInterfaceBitmask, oriIntraCellBlockingGroupTableIndex=oriIntraCellBlockingGroupTableIndex, oriWDSSetupTablePortIndex=oriWDSSetupTablePortIndex, oriRADIUSAuthClientStatTableAccessRejects=oriRADIUSAuthClientStatTableAccessRejects, orinocoGroups=orinocoGroups, oriWirelessIfSupportedOperationalModes=oriWirelessIfSupportedOperationalModes, oriBroadcastFilteringTable=oriBroadcastFilteringTable, oriRADIUSAuthServerTableEntry=oriRADIUSAuthServerTableEntry, oriTrapVarUnAuthorizedManagerCount=oriTrapVarUnAuthorizedManagerCount, oriHTTPWebSitenameTable=oriHTTPWebSitenameTable, oriStationStatTableOutOctets=oriStationStatTableOutOctets, oriWORPIfSiteSurveyNumSatRegistered=oriWORPIfSiteSurveyNumSatRegistered, oriWORPIfSatStatTableAverageLocalNoise=oriWORPIfSatStatTableAverageLocalNoise, oriWirelessIfDTIMPeriod=oriWirelessIfDTIMPeriod, oriDHCPRelayDHCPServerTable=oriDHCPRelayDHCPServerTable, orinocoNotifications=orinocoNotifications, oriLinkTestOurMinSNR=oriLinkTestOurMinSNR, oriTrapDeviceRebooting=oriTrapDeviceRebooting, oriQoSDot1dPriority=oriQoSDot1dPriority, oriRogueScanResultsBSSID=oriRogueScanResultsBSSID, oriWORPIfStatTableRemotePartners=oriWORPIfStatTableRemotePartners, oriTelnetSSHHostKeyStatus=oriTelnetSSHHostKeyStatus, oriQoSDot1DToIPDSCPMappingTableIndex=oriQoSDot1DToIPDSCPMappingTableIndex, oriDHCPServerIPPoolTableComment=oriDHCPServerIPPoolTableComment, oriWORPIfConfigTableRegistrationTimeout=oriWORPIfConfigTableRegistrationTimeout, oriBroadcastFilteringDirection=oriBroadcastFilteringDirection, oriSyslogHostTableIndex=oriSyslogHostTableIndex, oriRADIUSAuthClientStatTablePrimaryOrSecondaryIndex=oriRADIUSAuthClientStatTablePrimaryOrSecondaryIndex, oriSystemEventLogMask=oriSystemEventLogMask, oriTFTPFileName=oriTFTPFileName, oriPPPoEMACtoSessionTable=oriPPPoEMACtoSessionTable, oriRADIUSMACAccessControl=oriRADIUSMACAccessControl, oriHTTPRefreshDelay=oriHTTPRefreshDelay, oriSerialDataBits=oriSerialDataBits, oriTrapVarBatchCLIFilename=oriTrapVarBatchCLIFilename, oriWirelessIfNetworkName=oriWirelessIfNetworkName, oriSNMPTrapType=oriSNMPTrapType, oriProtocolFilterProtocol=oriProtocolFilterProtocol, oriRogueScanConfigTableEntry=oriRogueScanConfigTableEntry, oriDHCPServerIPPoolTableEndIPAddress=oriDHCPServerIPPoolTableEndIPAddress, oriSecurityEncryptionKeyLengthTableEntry=oriSecurityEncryptionKeyLengthTableEntry, orinocoWORPIfSat=orinocoWORPIfSat, oriWORPIfDDRSMinReqSNRdot11an12Mbps=oriWORPIfDDRSMinReqSNRdot11an12Mbps, oriWirelessIfSSIDTableEncryptionKeyLength=oriWirelessIfSSIDTableEncryptionKeyLength, oriQoSPolicyTableIndex=oriQoSPolicyTableIndex, oriIntraCellBlockingMACTableGroupID13=oriIntraCellBlockingMACTableGroupID13, oriWORPIfSatStatTableLocalTxRate=oriWORPIfSatStatTableLocalTxRate, oriSecurityGwMac=oriSecurityGwMac, oriIntraCellBlockingMACTableGroupID6=oriIntraCellBlockingMACTableGroupID6, oriIAPPHandoverTimeout=oriIAPPHandoverTimeout, orinoco=orinoco, oriSystemCountryCode=oriSystemCountryCode, oriLinkIntTableEntryStatus=oriLinkIntTableEntryStatus, oriPPPoESessionServiceName=oriPPPoESessionServiceName, oriLinkTestOurMinSignalLevel=oriLinkTestOurMinSignalLevel, oriWDSSecurityTableEntry=oriWDSSecurityTableEntry, oriSystemInvMgmtTableComponentId=oriSystemInvMgmtTableComponentId, oriSNTPTimeZone=oriSNTPTimeZone, oriTrapZeroLicenseFiles=oriTrapZeroLicenseFiles, oriHTTPRADIUSAccessControl=oriHTTPRADIUSAccessControl, oriDHCPRelayDHCPServerTableIpAddress=oriDHCPRelayDHCPServerTableIpAddress, DisplayString32=DisplayString32, oriStationStatTableOutNUcastPkts=oriStationStatTableOutNUcastPkts, oriStormThresholdTable=oriStormThresholdTable, oriLinkTestHisMediumFrameCount=oriLinkTestHisMediumFrameCount, oriTrapDuplicateIPAddressEncountered=oriTrapDuplicateIPAddressEncountered, oriNetworkIPConfigTableIndex=oriNetworkIPConfigTableIndex, oriLinkTestDataRateTableIndex=oriLinkTestDataRateTableIndex, oriSyslogPort=oriSyslogPort, oriSNMPTrapHostTableEntryStatus=oriSNMPTrapHostTableEntryStatus, oriLinkIntStatus=oriLinkIntStatus, oriDNSClientSecondaryServerIPAddress=oriDNSClientSecondaryServerIPAddress, oriVLANMgmtIdentifier=oriVLANMgmtIdentifier, oriPPPoESessionTableEntry=oriPPPoESessionTableEntry, oriNetworkIPConfigTableEntry=oriNetworkIPConfigTableEntry, oriTrapTFTPFailedOperation=oriTrapTFTPFailedOperation, oriTrapWLCFailure=oriTrapWLCFailure, oriSNMPErrorMessage=oriSNMPErrorMessage, oriIntraCellBlockingMACTableGroupID10=oriIntraCellBlockingMACTableGroupID10, oriAccessControlOperationType=oriAccessControlOperationType, oriWirelessIfSSIDTableClosedSystem=oriWirelessIfSSIDTableClosedSystem, oriTrapWirelessServiceShutdown=oriTrapWirelessServiceShutdown, oriWirelessIfBandwidthLimitOut=oriWirelessIfBandwidthLimitOut, oriBroadcastFilteringTableIndex=oriBroadcastFilteringTableIndex, oriWDSSecurityTableSecurityMode=oriWDSSecurityTableSecurityMode, oriConfigFileStatus=oriConfigFileStatus, orinocoDNS=orinocoDNS, oriNATStaticPortBindTableEntryStatus=oriNATStaticPortBindTableEntryStatus, oriSNMPAccessTableIndex=oriSNMPAccessTableIndex, ap2000=ap2000, oriWirelessIfSSIDTableQoSPolicy=oriWirelessIfSSIDTableQoSPolicy, oriWORPIfStatTableSendFailures=oriWORPIfStatTableSendFailures, oriWORPIfSatStatTableAverageRemoteNoise=oriWORPIfSatStatTableAverageRemoteNoise, oriSystemEmergencyResetToDefault=oriSystemEmergencyResetToDefault, oriTFTPDowngrade=oriTFTPDowngrade, oriLinkTestOurMaxSNR=oriLinkTestOurMaxSNR, oriTrapVLANIDUserAssignment=oriTrapVLANIDUserAssignment, oriTelnetLoginTimeout=oriTelnetLoginTimeout, oriWDSSecurityTableEncryptionKey0=oriWDSSecurityTableEncryptionKey0, oriAccessControlTableComment=oriAccessControlTableComment, orinocoDHCPRelay=orinocoDHCPRelay, oriQoSPolicyPriorityMapping=oriQoSPolicyPriorityMapping, oriPPPoENumberOfActiveSessions=oriPPPoENumberOfActiveSessions, oriLinkTestOurCurNoiseLevel=oriLinkTestOurCurNoiseLevel, oriNATStaticPortBindPortType=oriNATStaticPortBindPortType, oriStationStatTableMACProtocol=oriStationStatTableMACProtocol, oriIntraCellBlockingMACTableMACAddress=oriIntraCellBlockingMACTableMACAddress, oriIntraCellBlockingMACTableGroupID11=oriIntraCellBlockingMACTableGroupID11, oriDHCPRelayStatus=oriDHCPRelayStatus, oriLinkTestDataRateTable=oriLinkTestDataRateTable, oriQoSPolicyTableRowStatus=oriQoSPolicyTableRowStatus, oriStationStatTableLastChange=oriStationStatTableLastChange, oriStaticMACAddressFilterTable=oriStaticMACAddressFilterTable, oriSNTPSeconds=oriSNTPSeconds, oriWORPIfSiteSurveySignalQualityTableEntry=oriWORPIfSiteSurveySignalQualityTableEntry, oriWirelessIfSupportedAuthenticationModes=oriWirelessIfSupportedAuthenticationModes, oriRADIUSAuthServerIPAddress=oriRADIUSAuthServerIPAddress, orinocoAOL=orinocoAOL, oriWORPIfStatTable=oriWORPIfStatTable, oriWORPIfSatStatTableReceiveRetries=oriWORPIfSatStatTableReceiveRetries, oriSNMPAccessTableStatus=oriSNMPAccessTableStatus, oriLinkTestExplore=oriLinkTestExplore, oriIAPPMACIPTableBSSID=oriIAPPMACIPTableBSSID, oriPPPoESessionTable=oriPPPoESessionTable, oriPPPoEMACtoSessionTableMACAddress=oriPPPoEMACtoSessionTableMACAddress, oriSecurityEncryptionKeyLengthTable=oriSecurityEncryptionKeyLengthTable, oriWirelessIfSupportedMulticastRates=oriWirelessIfSupportedMulticastRates, oriWORPIfConfigTableNetworkSecret=oriWORPIfConfigTableNetworkSecret, oriSNMPAccessTableInterfaceBitmask=oriSNMPAccessTableInterfaceBitmask, oriDHCPServerPrimaryDNSIPAddress=oriDHCPServerPrimaryDNSIPAddress, oriTFTPOperation=oriTFTPOperation, oriTelnetPort=oriTelnetPort, orinocoSecurityGw=orinocoSecurityGw, oriLinkTestDataRateTableEntry=oriLinkTestDataRateTableEntry, oriWirelessIfTxPowerControl=oriWirelessIfTxPowerControl, oriSyslogPriority=oriSyslogPriority, oriSecurityGwStatus=oriSecurityGwStatus, ap600=ap600, oriTFTPAutoConfigFilename=oriTFTPAutoConfigFilename, oriPPPoESessionBindingsNumberMalformedPackets=oriPPPoESessionBindingsNumberMalformedPackets, oriEthernetIfConfigTableEntry=oriEthernetIfConfigTableEntry, oriPPPoESessionISPName=oriPPPoESessionISPName, oriTrapRogueScanStationDetected=oriTrapRogueScanStationDetected, oriSecurityConfigTableEncryptionKeyLength=oriSecurityConfigTableEncryptionKeyLength, oriStaticMACAddressFilterWiredAddress=oriStaticMACAddressFilterWiredAddress, oriTrapModuleNotInitialized=oriTrapModuleNotInitialized, oriIntraCellBlockingMACTableGroupID8=oriIntraCellBlockingMACTableGroupID8, oriWORPIfDDRSMinReqSNRdot11at72Mbps=oriWORPIfDDRSMinReqSNRdot11at72Mbps, oriRADIUSSvrTableAddressingFormat=oriRADIUSSvrTableAddressingFormat, oriWirelessIfLoadBalancing=oriWirelessIfLoadBalancing, oriDMZHostTableIndex=oriDMZHostTableIndex, ap2500=ap2500, oriRADIUSAuthClientTimeouts=oriRADIUSAuthClientTimeouts, oriRADIUSAuthServerTableEntryStatus=oriRADIUSAuthServerTableEntryStatus, oriLinkTestOurStandardFrameCount=oriLinkTestOurStandardFrameCount, oriWORPIfConfigTableNoSleepMode=oriWORPIfConfigTableNoSleepMode, orinocoTrap=orinocoTrap, oriDNSClientDefaultDomainName=oriDNSClientDefaultDomainName, oriNATPublicIPAddress=oriNATPublicIPAddress, oriWORPIfConfigTableMaxSatellites=oriWORPIfConfigTableMaxSatellites, oriIntraCellBlockingMACTableGroupID1=oriIntraCellBlockingMACTableGroupID1, oriRADIUSAcctServerIPAddress=oriRADIUSAcctServerIPAddress, oriRADIUSAcctClientAcctInvalidAuthenticators=oriRADIUSAcctClientAcctInvalidAuthenticators, oriRADScanResultsTable=oriRADScanResultsTable, oriWORPIfRoamingThreshold=oriWORPIfRoamingThreshold, oriRogueScanResultsTable=oriRogueScanResultsTable, oriConfigSaveFile=oriConfigSaveFile, oriLinkTestOurMaxSignalLevel=oriLinkTestOurMaxSignalLevel, oriWirelessIfAutoChannelSelectStatus=oriWirelessIfAutoChannelSelectStatus, oriRADIUSAuthServerSharedSecret=oriRADIUSAuthServerSharedSecret, oriWirelessIfSSIDTable=oriWirelessIfSSIDTable, oriLinkTestHisCurSNR=oriLinkTestHisCurSNR, oriSNTPStatus=oriSNTPStatus, oriIntraCellBlockingGroupTableName=oriIntraCellBlockingGroupTableName, oriTrapVarSubnetMask=oriTrapVarSubnetMask, oriPortFilterTableEntryPort=oriPortFilterTableEntryPort, oriLinkTestTimeOut=oriLinkTestTimeOut, orinocoStationStatistics=orinocoStationStatistics, oriRADIUSSvrTableProfileName=oriRADIUSSvrTableProfileName, oriFlashTraps=oriFlashTraps, oriRADIUSAuthServerNameOrIPAddress=oriRADIUSAuthServerNameOrIPAddress, oriRADIUSAuthClientStatTableAccessAccepts=oriRADIUSAuthClientStatTableAccessAccepts, oriIAPPStatus=oriIAPPStatus, oriPacketForwardingStatus=oriPacketForwardingStatus, orinocoRogueScan=orinocoRogueScan, oriWORPIfDDRSMinReqSNRdot11an6Mbps=oriWORPIfDDRSMinReqSNRdot11an6Mbps, oriLinkTestTable=oriLinkTestTable, oriStationStatTableOperStatus=oriStationStatTableOperStatus, oriDHCPServerIPPoolTableIndex=oriDHCPServerIPPoolTableIndex, oriQoSDot1pPriority=oriQoSDot1pPriority, oriWORPIfDDRSMinReqSNRdot11at18Mbps=oriWORPIfDDRSMinReqSNRdot11at18Mbps, oriWirelessIfTraps=oriWirelessIfTraps, oriTrapDHCPFailed=oriTrapDHCPFailed, oriSystemReboot=oriSystemReboot, oriRADIUSAuthClientAccessRequests=oriRADIUSAuthClientAccessRequests, oriTFTPServerIPAddress=oriTFTPServerIPAddress, oriRogueScanConfigTable=oriRogueScanConfigTable, oriLinkTestOurHighFrameCount=oriLinkTestOurHighFrameCount, oriLinkIntTable=oriLinkIntTable, oriSNMPTrapHostTableEntry=oriSNMPTrapHostTableEntry, oriTrapDNSIPNotConfigured=oriTrapDNSIPNotConfigured)
mibBuilder.exportSymbols("ORiNOCO-MIB", oriStaticMACAddressFilterWirelessMask=oriStaticMACAddressFilterWirelessMask, oriTrapVarMACAddress=oriTrapVarMACAddress, orinocoHTTP=orinocoHTTP, oriOEMProductModel=oriOEMProductModel, orinocoWORPIfSatStat=orinocoWORPIfSatStat, orinocoProducts=orinocoProducts, oriIntraCellBlockingMACTableEntry=oriIntraCellBlockingMACTableEntry, oriSecurityProfileTable=oriSecurityProfileTable, oriSNMPAccessTableComment=oriSNMPAccessTableComment, oriRADIUSAcctClientStatTablePrimaryOrSecondaryIndex=oriRADIUSAcctClientStatTablePrimaryOrSecondaryIndex, oriStormThresholdIfMulticast=oriStormThresholdIfMulticast, oriSecurityEncryptionKeyLength=oriSecurityEncryptionKeyLength, oriDNSRedirectMaxResponseWaitTime=oriDNSRedirectMaxResponseWaitTime, oriPPPoESessionConnectTimeLimitation=oriPPPoESessionConnectTimeLimitation, oriRADIUSAuthClientAccessChallenges=oriRADIUSAuthClientAccessChallenges, oriWirelessIfBandwidthLimitIn=oriWirelessIfBandwidthLimitIn, orinocoWORPIf=orinocoWORPIf, oriRADIUSAcctServerType=oriRADIUSAcctServerType, oriRADLastSuccessfulScanTime=oriRADLastSuccessfulScanTime, oriSNMPAuthorizedManagerCount=oriSNMPAuthorizedManagerCount, oriSystemInvMgmtInterfaceTableIndex=oriSystemInvMgmtInterfaceTableIndex, oriLinkIntTableComment=oriLinkIntTableComment, oriNATStaticPortBindStartPortNumber=oriNATStaticPortBindStartPortNumber, oriStationStatTable=oriStationStatTable, oriSystemInvMgmtInterfaceId=oriSystemInvMgmtInterfaceId, oriSystemFeatureTableCode=oriSystemFeatureTableCode, oriDNSPrimaryDNSIPAddress=oriDNSPrimaryDNSIPAddress, VlanId=VlanId, orinocoLinkTest=orinocoLinkTest, oriSystemInvMgmtComponentTable=oriSystemInvMgmtComponentTable, oriPPPoESessionBindingsNumberGenericErrorsTx=oriPPPoESessionBindingsNumberGenericErrorsTx, oriWORPIfSatStatTablePollNoReplies=oriWORPIfSatStatTablePollNoReplies, oriNATStaticBindStatus=oriNATStaticBindStatus, oriHTTPHelpInformationLink=oriHTTPHelpInformationLink, oriSNTPSecondaryServerNameOrIPAddress=oriSNTPSecondaryServerNameOrIPAddress, oriRADIUSAcctClientStatTableAccountingResponses=oriRADIUSAcctClientStatTableAccountingResponses, oriTempLogTableEntry=oriTempLogTableEntry, oriWirelessIfSSIDTablePSKValue=oriWirelessIfSSIDTablePSKValue, oriRADIUSSvrTableMaximumRetransmission=oriRADIUSSvrTableMaximumRetransmission, oriIntraCellBlockingStatus=oriIntraCellBlockingStatus, oriRADIUSAuthClientAuthInvalidAuthenticators=oriRADIUSAuthClientAuthInvalidAuthenticators, oriLinkTestStationName=oriLinkTestStationName, oriSecurityProfileTableAuthenticationMode=oriSecurityProfileTableAuthenticationMode, oriSecurityProfileTableEncryptionKey2=oriSecurityProfileTableEncryptionKey2, oriTrapVLANIDInvalidConfiguration=oriTrapVLANIDInvalidConfiguration, oriTFTPTraps=oriTFTPTraps, oriRADIUSAcctServerTable=oriRADIUSAcctServerTable, orinocoWirelessIf=orinocoWirelessIf, oriProxyARPStatus=oriProxyARPStatus, oriSNMPTrapHostTableIndex=oriSNMPTrapHostTableIndex, orinocoQoS=orinocoQoS, oriSecurityConfiguration=oriSecurityConfiguration, oriWirelessIfSSIDTableEncryptionKey3=oriWirelessIfSSIDTableEncryptionKey3, oriSerialBaudRate=oriSerialBaudRate, oriOEMHomeUrl=oriOEMHomeUrl, orinocoWORPIfBSUStatAverageLocalSignal=orinocoWORPIfBSUStatAverageLocalSignal, oriStationStatTableMACAddress=oriStationStatTableMACAddress, oriIfWANInterfaceMACAddress=oriIfWANInterfaceMACAddress, orinocoWORPIfBSUStatAverageRemoteNoise=orinocoWORPIfBSUStatAverageRemoteNoise, oriWirelessIfLBTxTimeThreshold=oriWirelessIfLBTxTimeThreshold, oriWORPIfDDRSMinReqSNRdot11at36Mbps=oriWORPIfDDRSMinReqSNRdot11at36Mbps, oriHTTPWebSiteDescription=oriHTTPWebSiteDescription, oriWirelessIfSSIDTableDenyNonEncryptedData=oriWirelessIfSSIDTableDenyNonEncryptedData, oriRADIUSSvrTableNameOrIPAddress=oriRADIUSSvrTableNameOrIPAddress, oriTrapWirelessServiceResumed=oriTrapWirelessServiceResumed, oriWirelessIfMACAddress=oriWirelessIfMACAddress, oriSyslogStatus=oriSyslogStatus, oriWirelessIfMediumDensityDistribution=oriWirelessIfMediumDensityDistribution, oriPortFilterTableEntryInterfaceBitmask=oriPortFilterTableEntryInterfaceBitmask, oriTrapWLCRemoval=oriTrapWLCRemoval, oriPPPoESessionTableIndex=oriPPPoESessionTableIndex, oriRADInterfaceBitmask=oriRADInterfaceBitmask, oriTrapMaximumNumberOfSubscribersReached=oriTrapMaximumNumberOfSubscribersReached, oriWORPIfStatTableBaseStationAnnounces=oriWORPIfStatTableBaseStationAnnounces, oriTrapWLCIncompatibleVendor=oriTrapWLCIncompatibleVendor, oriSystemFeatureTableEntry=oriSystemFeatureTableEntry, oriTrapFlashMemoryEmpty=oriTrapFlashMemoryEmpty, oriDMZHostTableEntryStatus=oriDMZHostTableEntryStatus, oriDHCPServerIPPoolTableStartIPAddress=oriDHCPServerIPPoolTableStartIPAddress, oriWirelessIfPropertiesTable=oriWirelessIfPropertiesTable, tmp11=tmp11, orinocoRADIUSSvrProfiles=orinocoRADIUSSvrProfiles, oriWirelessIfSecurityPerSSIDStatus=oriWirelessIfSecurityPerSSIDStatus, oriIntraCellBlockingMACTableGroupID15=oriIntraCellBlockingMACTableGroupID15, oriNATType=oriNATType, oriRogueScanConfigTableScanMode=oriRogueScanConfigTableScanMode, oriLinkTestHisMinSignalLevel=oriLinkTestHisMinSignalLevel, oriWirelessIfSSIDTableRADIUSMACAuthProfile=oriWirelessIfSSIDTableRADIUSMACAuthProfile, oriRADIUSAcctStatus=oriRADIUSAcctStatus, orinocoSpectraLink=orinocoSpectraLink, oriIntraCellBlockingGroupTableEntryStatus=oriIntraCellBlockingGroupTableEntryStatus, oriLinkTestMACAddress=oriLinkTestMACAddress, oriSNMPV3PrivPassword=oriSNMPV3PrivPassword, oriQoSPolicyName=oriQoSPolicyName, oriStationStatTableRemoteSignal=oriStationStatTableRemoteSignal, oriRADScanResultsFrequencyChannel=oriRADScanResultsFrequencyChannel, oriIAPPAnnounceResponseTime=oriIAPPAnnounceResponseTime, oriNATStaticIPBindTableEntryStatus=oriNATStaticIPBindTableEntryStatus, oriWORPIfSatStatTablePollData=oriWORPIfSatStatTablePollData, oriWirelessIfACSFrequencyBandScan=oriWirelessIfACSFrequencyBandScan, oriRADIUSSvrTableProfileIndex=oriRADIUSSvrTableProfileIndex, oriSNMPAccessTableIPMask=oriSNMPAccessTableIPMask, oriPPPoEMACtoSessionTableIndex=oriPPPoEMACtoSessionTableIndex, oriWORPIfStatTableRequestForService=oriWORPIfStatTableRequestForService, DisplayString55=DisplayString55, oriSystemAccessLoginTimeout=oriSystemAccessLoginTimeout, oriIAPPAnnounceResponseReceived=oriIAPPAnnounceResponseReceived, orinocoPortFilter=orinocoPortFilter, oriTrapBootPFailed=oriTrapBootPFailed, oriIAPPAnnounceResponseSent=oriIAPPAnnounceResponseSent, oriRADIUSAuthServerAddressingFormat=oriRADIUSAuthServerAddressingFormat, oriSerialStopBits=oriSerialStopBits, oriSystemInvMgmtComponentTableEntry=oriSystemInvMgmtComponentTableEntry, oriDMZHostTableComment=oriDMZHostTableComment, oriStationStatTableInDiscards=oriStationStatTableInDiscards, oriWORPIfSatConfigTable=oriWORPIfSatConfigTable, oriWirelessIfDistancebetweenAPs=oriWirelessIfDistancebetweenAPs, oriTrapsImageStatus=oriTrapsImageStatus, oriRADIUSAuthClientStatTableIndex=oriRADIUSAuthClientStatTableIndex, oriSecurityProfileTableIndex=oriSecurityProfileTableIndex, oriWirelessIfSSIDTableEncryptionTxKey=oriWirelessIfSSIDTableEncryptionTxKey, oriRADIUSAcctServerDestPort=oriRADIUSAcctServerDestPort, oriTrapVarUnauthorizedManagerIPaddress=oriTrapVarUnauthorizedManagerIPaddress, oriDNSSecondaryDNSIPAddress=oriDNSSecondaryDNSIPAddress, oriTFTPFileMode=oriTFTPFileMode, oriWORPIfSatStatTableReplyData=oriWORPIfSatStatTableReplyData, oriStationStatTableInNUcastPkts=oriStationStatTableInNUcastPkts, oriOEMName=oriOEMName, oriWirelessIfTxRate=oriWirelessIfTxRate, oriStationStatTableType=oriStationStatTableType, oriSystemEventLogMessage=oriSystemEventLogMessage, orinocoWORPIfRoaming=orinocoWORPIfRoaming, oriWirelessIfAllowedSupportedDataRates=oriWirelessIfAllowedSupportedDataRates, orinocoOEM=orinocoOEM, oriQoSDot1DToDot1pMappingTableEntry=oriQoSDot1DToDot1pMappingTableEntry, orinocoSecurity=orinocoSecurity, oriTrapFlashMemoryRestoringLastKnownGoodConfiguration=oriTrapFlashMemoryRestoringLastKnownGoodConfiguration, oriTrapIncompatibleImage=oriTrapIncompatibleImage, oriFlashMemoryTrapsStatus=oriFlashMemoryTrapsStatus, oriWirelessIfEncryptionOptions=oriWirelessIfEncryptionOptions, oriWORPIfSatConfigTableMinimumBandwidthLimitDownlink=oriWORPIfSatConfigTableMinimumBandwidthLimitDownlink, oriSystemHwType=oriSystemHwType, oriWORPIfStatTableRegistrationAttempts=oriWORPIfStatTableRegistrationAttempts, oriWORPIfStatTableReplyData=oriWORPIfStatTableReplyData, as1000=as1000, oriWirelessIfSSIDTableSecurityProfile=oriWirelessIfSSIDTableSecurityProfile, oriRADIUSSvrTablePrimaryOrSecondaryIndex=oriRADIUSSvrTablePrimaryOrSecondaryIndex, oriWORPIfSatConfigTableMinimumBandwidthLimitUplink=oriWORPIfSatConfigTableMinimumBandwidthLimitUplink, oriIntraCellBlockingMACTableGroupID3=oriIntraCellBlockingMACTableGroupID3, oriTrapDHCPLeaseRenewal=oriTrapDHCPLeaseRenewal, oriUPSDE911Reserved=oriUPSDE911Reserved, oriRADIUSSvrTableDestPort=oriRADIUSSvrTableDestPort, oriConfigFileTable=oriConfigFileTable, oriRogueScanResultsSNR=oriRogueScanResultsSNR, oriSecurityProfileTableSecModeIndex=oriSecurityProfileTableSecModeIndex, oriWirelessIfEncryptionKey4=oriWirelessIfEncryptionKey4, oriWirelessIfSSIDTableEncryptionKey1=oriWirelessIfSSIDTableEncryptionKey1, oriRADIUSAcctServerTableIndex=oriRADIUSAcctServerTableIndex, oriIAPPMACIPTableIndex=oriIAPPMACIPTableIndex, oriRogueScanResultsNotificationMode=oriRogueScanResultsNotificationMode, oriUPSDGPRInterval=oriUPSDGPRInterval, oriWORPIfStatTableReceiveRetries=oriWORPIfStatTableReceiveRetries, oriWORPIfRoamingStatus=oriWORPIfRoamingStatus, oriSystemEventLogTableEntry=oriSystemEventLogTableEntry, orinocoConfig=orinocoConfig, oriWORPIfDDRSMinReqSNRdot11an24Mbps=oriWORPIfDDRSMinReqSNRdot11an24Mbps, oriTrapInvalidEncryptionKey=oriTrapInvalidEncryptionKey, oriPPPoESessionIdleTimeOut=oriPPPoESessionIdleTimeOut, oriAccessControlTable=oriAccessControlTable, oriWORPStationDeRegister=oriWORPStationDeRegister, oriRADIUSAcctClientStatTableEntry=oriRADIUSAcctClientStatTableEntry, oriTrapVarDefaultRouterIPAddress=oriTrapVarDefaultRouterIPAddress, orinocoRADIUS=orinocoRADIUS, oriSyslogHostIPAddress=oriSyslogHostIPAddress, oriSNTPDayLightSavingTime=oriSNTPDayLightSavingTime, oriSecurityConfigTableSecurityMode=oriSecurityConfigTableSecurityMode, oriSystemAccessPassword=oriSystemAccessPassword, oriSyslogHostTableEntryStatus=oriSyslogHostTableEntryStatus, oriWirelessIfAllowedChannels=oriWirelessIfAllowedChannels, oriWORPIfStatTableSendRetries=oriWORPIfStatTableSendRetries, oriTrapDNSClientLookupFailure=oriTrapDNSClientLookupFailure, oriSystemInvMgmtInterfaceRole=oriSystemInvMgmtInterfaceRole, oriLinkTestInterval=oriLinkTestInterval, oriRADIUSClientInvalidServerAddress=oriRADIUSClientInvalidServerAddress, oriHTTPSSLPassphrase=oriHTTPSSLPassphrase, oriIAPPAnnounceRequestSent=oriIAPPAnnounceRequestSent, oriLinkTestOurCurSignalLevel=oriLinkTestOurCurSignalLevel, oriOperationalTrapsStatus=oriOperationalTrapsStatus, oriStationStatTableAdminStatus=oriStationStatTableAdminStatus, oriWORPIfDDRSMinReqSNRdot11at108Mbps=oriWORPIfDDRSMinReqSNRdot11at108Mbps, oriSNMPTrapHostTablePassword=oriSNMPTrapHostTablePassword, oriWDSSetupTable=oriWDSSetupTable, oriStationStatTableInSignal=oriStationStatTableInSignal, oriDMZHostTable=oriDMZHostTable, oriRogueScanConfigTableScanStatus=oriRogueScanConfigTableScanStatus, oriRogueScanResultsStationType=oriRogueScanResultsStationType, oriTrapRADIUSAuthenticationNotConfigured=oriTrapRADIUSAuthenticationNotConfigured, orinocoSysFeature=orinocoSysFeature, oriRADIUSSvrTableAccountingInactivityTimer=oriRADIUSSvrTableAccountingInactivityTimer, oriSNMPSecureManagementStatus=oriSNMPSecureManagementStatus, oriTrapTemperatureAlert=oriTrapTemperatureAlert, orinocoWORPIfBSU=orinocoWORPIfBSU, oriSecurityProfileTablePSKValue=oriSecurityProfileTablePSKValue, oriWORPIfSatStatTableReceiveSuccess=oriWORPIfSatStatTableReceiveSuccess, oriWORPIfStatTablePollNoReplies=oriWORPIfStatTablePollNoReplies, oriLinkTestDataRateTableLocalCount=oriLinkTestDataRateTableLocalCount, oriTFTPOperationStatus=oriTFTPOperationStatus, oriStormThresholdTableEntry=oriStormThresholdTableEntry, oriSNTPHour=oriSNTPHour, oriTrapSNTPFailure=oriTrapSNTPFailure, oriWirelessIfSecurityIndex=oriWirelessIfSecurityIndex, oriWORPIfStatTableReceiveSuccess=oriWORPIfStatTableReceiveSuccess, oriStationStatTableInOctets=oriStationStatTableInOctets, oriPPPoEMACtoSessionTableStatus=oriPPPoEMACtoSessionTableStatus, InterfaceBitmask=InterfaceBitmask, oriDNSClientPrimaryServerIPAddress=oriDNSClientPrimaryServerIPAddress, oriWORPIfSiteSurveyRemoteSignalLevel=oriWORPIfSiteSurveyRemoteSignalLevel, oriDMZHostTableHostIP=oriDMZHostTableHostIP, oriRADIUSAuthorizationLifeTime=oriRADIUSAuthorizationLifeTime, oriStationStatTableEntry=oriStationStatTableEntry, oriStationStatNumberOfClients=oriStationStatNumberOfClients, oriPPPoESessionWANManualConnect=oriPPPoESessionWANManualConnect, oriWirelessIfSSIDTableEntry=oriWirelessIfSSIDTableEntry, oriRADIUSSvrTableAuthorizationLifeTime=oriRADIUSSvrTableAuthorizationLifeTime, oriTelnetInterfaceBitmask=oriTelnetInterfaceBitmask, oriGenericTrapVariable=oriGenericTrapVariable, oriTrapVarIPAddress=oriTrapVarIPAddress, oriWORPTrapsStatus=oriWORPTrapsStatus, oriUPSDMaxActiveSU=oriUPSDMaxActiveSU, oriTrapWLCRadarInterferenceDetected=oriTrapWLCRadarInterferenceDetected, oriPPPoEMACtoSessionTableEntry=oriPPPoEMACtoSessionTableEntry, oriRADIUSAcctServerMaximumRetransmission=oriRADIUSAcctServerMaximumRetransmission, oriIPARPFilteringSubnetMask=oriIPARPFilteringSubnetMask, oriPPPoESessionBindingsNumberGenericErrorsRx=oriPPPoESessionBindingsNumberGenericErrorsRx, oriWORPIfStatTablePollNoData=oriWORPIfStatTablePollNoData, oriLinkTestTableIndex=oriLinkTestTableIndex, oriStationStatTableInterface=oriStationStatTableInterface, oriTempLoggingInterval=oriTempLoggingInterval, oriIAPPSendAnnounceRequestOnStart=oriIAPPSendAnnounceRequestOnStart, oriIntraCellBlockingMACTableEntryStatus=oriIntraCellBlockingMACTableEntryStatus, oriPPPoESessionBindingsNumberPADITx=oriPPPoESessionBindingsNumberPADITx, oriLinkTestOurMediumFrameCount=oriLinkTestOurMediumFrameCount, oriLinkTestOurMinNoiseLevel=oriLinkTestOurMinNoiseLevel, oriQoSDot1DToIPDSCPMappingTable=oriQoSDot1DToIPDSCPMappingTable, oriStationStatTableIndex=oriStationStatTableIndex, oriSystemFeatureTableLicensed=oriSystemFeatureTableLicensed, oriNetworkIPAddressType=oriNetworkIPAddressType, oriLinkIntTableEntry=oriLinkIntTableEntry, oriSyslogHeartbeatStatus=oriSyslogHeartbeatStatus, oriWORPIfDDRSMinReqSNRdot11at24Mbps=oriWORPIfDDRSMinReqSNRdot11at24Mbps, oriLinkIntTableIndex=oriLinkIntTableIndex, oriWirelessIfSupportedCipherModes=oriWirelessIfSupportedCipherModes, oriQoSPolicyTableEntry=oriQoSPolicyTableEntry, orinocoEthernetIf=orinocoEthernetIf)
mibBuilder.exportSymbols("ORiNOCO-MIB", oriLinkTestHisStandardFrameCount=oriLinkTestHisStandardFrameCount, orinocoIPARP=orinocoIPARP, oriWORPIfSatStatTable=oriWORPIfSatStatTable, oriWORPIfDDRSMinReqSNRdot11an9Mbps=oriWORPIfDDRSMinReqSNRdot11an9Mbps, oriPPPoESessionBindingsNumberMultiplePADORx=oriPPPoESessionBindingsNumberMultiplePADORx, oriSystemFlashBackupInterval=oriSystemFlashBackupInterval, agere=agere, oriStationStatTableName=oriStationStatTableName, oriStationStatTableInUcastPkts=oriStationStatTableInUcastPkts, oriTrapZeroSizeImage=oriTrapZeroSizeImage, oriDHCPServerIPPoolTable=oriDHCPServerIPPoolTable, oriRogueScanStationCountWirelessCardA=oriRogueScanStationCountWirelessCardA, oriRogueScanResultsMACAddress=oriRogueScanResultsMACAddress, oriSystemAccessUserName=oriSystemAccessUserName, oriSecurityProfileTableStatus=oriSecurityProfileTableStatus, oriWORPIfConfigTableEntry=oriWORPIfConfigTableEntry, oriNetworkIPConfigTable=oriNetworkIPConfigTable, oriWirelessIfTrapsStatus=oriWirelessIfTrapsStatus, oriWirelessIfSSIDTableIndex=oriWirelessIfSSIDTableIndex, oriWORPIfStatTableRegistrationIncompletes=oriWORPIfStatTableRegistrationIncompletes, oriDMZHostTableEntry=oriDMZHostTableEntry, oriSNTPMonth=oriSNTPMonth, oriWDSSetupTablePartnerMACAddress=oriWDSSetupTablePartnerMACAddress, oriSNTPDay=oriSNTPDay)
