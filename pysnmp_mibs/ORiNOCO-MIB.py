...
RowStatus, DateAndTime, TextualConvention, TimeInterval, MacAddress, PhysAddress, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TextualConvention", "TimeInterval", "MacAddress", "PhysAddress", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("ORiNOCO-MIB", orinocoNet=orinocoNet, orinocoSpanningTree=orinocoSpanningTree, oriIntraCellBlockingMACTableGroupID3=oriIntraCellBlockingMACTableGroupID3, oriLinkTestExplore=oriLinkTestExplore, oriSNMPAccessTableIndex=oriSNMPAccessTableIndex, oriTrapVarTaskSuspended=oriTrapVarTaskSuspended, oriPPPoENumberOfActiveSessions=oriPPPoENumberOfActiveSessions, oriTrapWLCNotPresent=oriTrapWLCNotPresent, oriStationStatTableInNUcastPkts=oriStationStatTableInNUcastPkts, oriRADIUSAuthServerSharedSecret=oriRADIUSAuthServerSharedSecret, oriTrapAuthenticationFailure=oriTrapAuthenticationFailure, oriTrapUnauthorizedManagerDetected=oriTrapUnauthorizedManagerDetected, oriWORPIfConfigTableNoSleepMode=oriWORPIfConfigTableNoSleepMode, oriProtocolFilterProtocolString=oriProtocolFilterProtocolString, oriBroadcastFilteringTableEntry=oriBroadcastFilteringTableEntry, orinocoRADIUS=orinocoRADIUS, oriSystemReboot=oriSystemReboot, oriWirelessIfDTIMPeriod=oriWirelessIfDTIMPeriod, oriNATStatus=oriNATStatus, oriSNTPDateAndTime=oriSNTPDateAndTime, oriSystemInvMgmtTableComponentName=oriSystemInvMgmtTableComponentName, oriSecurityProfileTableSecModeIndex=oriSecurityProfileTableSecModeIndex, oriHTTPWebSitenameTableStatus=oriHTTPWebSitenameTableStatus, ap2500=ap2500, oriWORPIfSatStatTableReceiveFailures=oriWORPIfSatStatTableReceiveFailures, orinocoTelnet=orinocoTelnet, oriSNMPAccessTable=oriSNMPAccessTable, oriWirelessIfTraps=oriWirelessIfTraps, oriSNTPPrimaryServerNameOrIPAddress=oriSNTPPrimaryServerNameOrIPAddress, oriWORPIfSatStatTablePollData=oriWORPIfSatStatTablePollData, oriLinkTestHisStandardFrameCount=oriLinkTestHisStandardFrameCount, oriTempLoggingInterval=oriTempLoggingInterval, oriStationStatTableOperStatus=oriStationStatTableOperStatus, as1000=as1000, oriDHCPServerStatus=oriDHCPServerStatus, oriRADIUSAuthServerTableEntryStatus=oriRADIUSAuthServerTableEntryStatus, oriWORPIfConfigTableRetries=oriWORPIfConfigTableRetries, oriWORPIfStatTableReceiveSuccess=oriWORPIfStatTableReceiveSuccess, oriRADIUSAcctClientStatTableIndex=oriRADIUSAcctClientStatTableIndex, oriQoSDot1DToIPDSCPMappingTableIndex=oriQoSDot1DToIPDSCPMappingTableIndex, oriSNMPReadPassword=oriSNMPReadPassword, oriWORPIfSiteSurveyLocalSNR=oriWORPIfSiteSurveyLocalSNR, oriDHCPServerSubnetMask=oriDHCPServerSubnetMask, oriIPARPFilteringStatus=oriIPARPFilteringStatus, oriTrapBatchExecFailure=oriTrapBatchExecFailure, orinocoProducts=orinocoProducts, oriTrapFeatureNotSupported=oriTrapFeatureNotSupported, oriWORPIfStatTableAuthenticationRequests=oriWORPIfStatTableAuthenticationRequests, orinocoNotifications=orinocoNotifications, oriHTTPSSLStatus=oriHTTPSSLStatus, orinocoDHCPRelay=orinocoDHCPRelay, oriTrapUnrecoverableSoftwareErrorDetected=oriTrapUnrecoverableSoftwareErrorDetected, oriStationStatNumberOfClients=oriStationStatNumberOfClients, ObjStatusActive=ObjStatusActive, oriRogueScanConfigTableScanMode=oriRogueScanConfigTableScanMode, oriSNMPAuthorizedManagerCount=oriSNMPAuthorizedManagerCount, oriTrapIncompatibleLicenseFile=oriTrapIncompatibleLicenseFile, oriDHCPServerNumIPPoolTableEntries=oriDHCPServerNumIPPoolTableEntries, oriSyslogPort=oriSyslogPort, oriDHCPRelayDHCPServerTableComment=oriDHCPRelayDHCPServerTableComment, oriWORPIfDDRSMinReqSNRdot11at18Mbps=oriWORPIfDDRSMinReqSNRdot11at18Mbps, orinocoRADIUSAuth=orinocoRADIUSAuth, oriSystemContactEmail=oriSystemContactEmail, oriTrapFlashMemoryCorrupted=oriTrapFlashMemoryCorrupted, oriWirelessIfSSIDTableMACAccessControl=oriWirelessIfSSIDTableMACAccessControl, oriTrapUselessLicense=oriTrapUselessLicense, oriWirelessIfDFSStatus=oriWirelessIfDFSStatus, oriWORPIfSatConfigTableIndex=oriWORPIfSatConfigTableIndex, orinocoDNSClient=orinocoDNSClient, oriWirelessIfWSSStatus=oriWirelessIfWSSStatus, oriIntraCellBlockingMACTableGroupID14=oriIntraCellBlockingMACTableGroupID14, oriQoSIPDSCPLowerLimit=oriQoSIPDSCPLowerLimit, oriWORPIfDDRSMinReqSNRdot11an54Mbps=oriWORPIfDDRSMinReqSNRdot11an54Mbps, orinocoSNMP=orinocoSNMP, oriIntraCellBlockingMACTableGroupID11=oriIntraCellBlockingMACTableGroupID11, oriLinkTestHisCurSNR=oriLinkTestHisCurSNR, oriSNTPTimeZone=oriSNTPTimeZone, oriWORPIfConfigTableMode=oriWORPIfConfigTableMode, oriDHCPServerIPPoolTable=oriDHCPServerIPPoolTable, orinocoRADIUSAcct=orinocoRADIUSAcct, orinocoWORPIfBSUStatAverageRemoteNoise=orinocoWORPIfBSUStatAverageRemoteNoise, oriTrapSSHInitializationStatus=oriTrapSSHInitializationStatus, VlanId=VlanId, oriDHCPServerIPPoolTableEntryStatus=oriDHCPServerIPPoolTableEntryStatus, oriEthernetIfConfigBandwidthLimitOut=oriEthernetIfConfigBandwidthLimitOut, oriWORPIfDDRSMinReqSNRdot11at48Mbps=oriWORPIfDDRSMinReqSNRdot11at48Mbps, orinocoWORPIfBSUStatMACAddress=orinocoWORPIfBSUStatMACAddress, oriTFTPFileType=oriTFTPFileType, oriTrapWLCIncompatibleFirmware=oriTrapWLCIncompatibleFirmware, oriRogueScanResultsTrapReportType=oriRogueScanResultsTrapReportType, oriWORPIfSiteSurveyCurrentSatRegistered=oriWORPIfSiteSurveyCurrentSatRegistered, oriRADIUSSvrTableRowStatus=oriRADIUSSvrTableRowStatus, oriTrapVarMACAddress=oriTrapVarMACAddress, oriRADIUSAcctServerIPAddress=oriRADIUSAcctServerIPAddress, oriStaticMACAddressFilterWiredAddress=oriStaticMACAddressFilterWiredAddress, oriWORPIfRoamingFastScanThreshold=oriWORPIfRoamingFastScanThreshold, oriWORPIfDDRSMaxDataRate=oriWORPIfDDRSMaxDataRate, oriRogueScanStationCountWirelessCardA=oriRogueScanStationCountWirelessCardA, orinocoIAPP=orinocoIAPP, oriWORPIfDDRSMinReqSNRdot11an6Mbps=oriWORPIfDDRSMinReqSNRdot11an6Mbps, oriSystemInvMgmtInterfaceId=oriSystemInvMgmtInterfaceId, oriProtocolFilterTableEntryStatus=oriProtocolFilterTableEntryStatus, oriRADIUSSvrTablePrimaryOrSecondaryIndex=oriRADIUSSvrTablePrimaryOrSecondaryIndex, oriTFTPServerIPAddress=oriTFTPServerIPAddress, oriWORPIfStatTableRegistrationLastReason=oriWORPIfStatTableRegistrationLastReason, oriIAPPHandoverRequestRetransmissions=oriIAPPHandoverRequestRetransmissions, oriIAPPPDUsDropped=oriIAPPPDUsDropped, oriRADIUSAcctServerMaximumRetransmission=oriRADIUSAcctServerMaximumRetransmission, oriLinkIntTableTargetIPAddress=oriLinkIntTableTargetIPAddress, oriDHCPRelayDHCPServerTableIndex=oriDHCPRelayDHCPServerTableIndex, oriWORPIfStatTableSendSuccess=oriWORPIfStatTableSendSuccess, oriTrapFlashMemoryRestoringLastKnownGoodConfiguration=oriTrapFlashMemoryRestoringLastKnownGoodConfiguration, oriTrapZeroSizeImage=oriTrapZeroSizeImage, oriSystemInvMgmtInterfaceTableIndex=oriSystemInvMgmtInterfaceTableIndex, oriRADIUSMACAccessControl=oriRADIUSMACAccessControl, orinocoPPPoE=orinocoPPPoE, oriLinkTestOurMaxSignalLevel=oriLinkTestOurMaxSignalLevel, orinocoWORPIf=orinocoWORPIf, oriTrapRADScanResults=oriTrapRADScanResults, oriSpanningTreeStatus=oriSpanningTreeStatus, oriPPPoESessionWANConnectMode=oriPPPoESessionWANConnectMode, oriTFTPTrapsStatus=oriTFTPTrapsStatus, oriRADIUSAcctInactivityTimer=oriRADIUSAcctInactivityTimer, oriRADIUSAuthClientStatTableAccessRequests=oriRADIUSAuthClientStatTableAccessRequests, oriTFTPAutoConfigFilename=oriTFTPAutoConfigFilename, oriTrapBatchFileExecEnd=oriTrapBatchFileExecEnd, oriWORPIfSatStatTable=oriWORPIfSatStatTable, orinocoEthernetIf=orinocoEthernetIf, oriRADIUSSvrTableProfileName=oriRADIUSSvrTableProfileName, oriRADIUSSvrTable=oriRADIUSSvrTable, oriWORPIfRoamingSlowScanPercentThreshold=oriWORPIfRoamingSlowScanPercentThreshold, oriTrapRADIUSServerNotResponding=oriTrapRADIUSServerNotResponding, oriWirelessIfEncryptionStatus=oriWirelessIfEncryptionStatus, oriTelnetPort=oriTelnetPort, oriDHCPClientInterfaceBitmask=oriDHCPClientInterfaceBitmask, oriStationStatStatus=oriStationStatStatus, oriWORPIfStatTableRequestForService=oriWORPIfStatTableRequestForService, oriSystemAccessMaxSessions=oriSystemAccessMaxSessions, oriRADIUSAcctClientStatTableAccountingRequests=oriRADIUSAcctClientStatTableAccountingRequests, orinocoSpectraLink=orinocoSpectraLink, orinocoSNTP=orinocoSNTP, oriWirelessIfAutoChannelSelectStatus=oriWirelessIfAutoChannelSelectStatus, oriRADIUSAuthServerTableIndex=oriRADIUSAuthServerTableIndex, oriSyslogHostTableEntry=oriSyslogHostTableEntry, oriWirelessIfProfileCode=oriWirelessIfProfileCode, oriTrapWirelessServiceShutdown=oriTrapWirelessServiceShutdown, oriTrapVarBatchCLIFilename=oriTrapVarBatchCLIFilename, oriTrapWLCRemoval=oriTrapWLCRemoval, oriNetworkIPConfigTableIndex=oriNetworkIPConfigTableIndex, oriWirelessIfOperationalMode=oriWirelessIfOperationalMode, oriSNMPReadWritePassword=oriSNMPReadWritePassword, DisplayString32=DisplayString32, oriIntraCellBlockingStatus=oriIntraCellBlockingStatus, oriRADIUSSvrTableProfileIndex=oriRADIUSSvrTableProfileIndex, oriSecurityConfigTable=oriSecurityConfigTable, oriSystemInvMgmtTableComponentReleaseVersion=oriSystemInvMgmtTableComponentReleaseVersion, oriSerialDataBits=oriSerialDataBits, oriStationStatTableName=oriStationStatTableName, orinocoDHCPClient=orinocoDHCPClient, oriWORPIfSatStatTableAverageLocalSignal=oriWORPIfSatStatTableAverageLocalSignal, oriTrapVarTFTPIPAddress=oriTrapVarTFTPIPAddress, oriWORPIfSatStatTableRequestForService=oriWORPIfSatStatTableRequestForService, oriIAPPAnnounceResponseSent=oriIAPPAnnounceResponseSent, oriConfigFileTableIndex=oriConfigFileTableIndex, oriQoSPolicyTableIndex=oriQoSPolicyTableIndex, oriTrapInvalidEncryptionKey=oriTrapInvalidEncryptionKey, oriRADIUSAcctStatus=oriRADIUSAcctStatus, oriSyslogStatus=oriSyslogStatus, oriQoSPolicyTable=oriQoSPolicyTable, oriWDSSetupTable=oriWDSSetupTable, oriTFTPAutoConfigStatus=oriTFTPAutoConfigStatus, oriWORPStationRegister=oriWORPStationRegister, oriLinkTestDataRateTableRemoteCount=oriLinkTestDataRateTableRemoteCount, oriWirelessIfBandwidthLimitIn=oriWirelessIfBandwidthLimitIn, oriTrapVarUnauthorizedClientMACAddress=oriTrapVarUnauthorizedClientMACAddress, oriTFTPTraps=oriTFTPTraps, oriIfWANInterfaceMACAddress=oriIfWANInterfaceMACAddress, orinocoSysInvMgmt=orinocoSysInvMgmt, oriWORPIfStatTableReceiveFailures=oriWORPIfStatTableReceiveFailures, orinocoIBSSTraffic=orinocoIBSSTraffic, oriOEMLogoImageFile=oriOEMLogoImageFile, orinocoWORPIfRoaming=orinocoWORPIfRoaming, oriWirelessIfSSIDTableDenyNonEncryptedData=oriWirelessIfSSIDTableDenyNonEncryptedData, oriWirelessIfSSIDTableSSIDAuthorizationStatus=oriWirelessIfSSIDTableSSIDAuthorizationStatus, oriIAPPHandoverRequestSent=oriIAPPHandoverRequestSent, oriSecurityTrapsStatus=oriSecurityTrapsStatus, oriPPPoESessionWANManualConnect=oriPPPoESessionWANManualConnect, oriNATStaticPortBindPortType=oriNATStaticPortBindPortType, oriStationStatTableMACProtocol=oriStationStatTableMACProtocol, oriIAPPHandoverResponseSent=oriIAPPHandoverResponseSent, oriTrapVarWirelessCard=oriTrapVarWirelessCard, oriBroadcastFilteringTableIndex=oriBroadcastFilteringTableIndex, oriLinkTestOurCurSNR=oriLinkTestOurCurSNR, oriTrapDHCPFailed=oriTrapDHCPFailed, oriDHCPServerIPPoolTableMaximumLeaseTime=oriDHCPServerIPPoolTableMaximumLeaseTime, oriDHCPServerIPPoolTableWidth=oriDHCPServerIPPoolTableWidth, oriQoSPolicyPriorityMapping=oriQoSPolicyPriorityMapping, oriLinkTestHisMaxSignalLevel=oriLinkTestHisMaxSignalLevel, oriIAPPMACIPTableBSSID=oriIAPPMACIPTableBSSID, oriLinkTestOurHighFrameCount=oriLinkTestOurHighFrameCount, oriNATStaticPortBindTableEntry=oriNATStaticPortBindTableEntry, oriWORPIfSatStatTableMacAddress=oriWORPIfSatStatTableMacAddress, oriConfigFileStatus=oriConfigFileStatus, oriIntraCellBlockingGroupTableEntryStatus=oriIntraCellBlockingGroupTableEntryStatus, oriSyslogHostComment=oriSyslogHostComment, oriWORPIfConfigTableMaxSatellites=oriWORPIfConfigTableMaxSatellites, oriWORPIfStatTableEntry=oriWORPIfStatTableEntry, oriHTTPWebSitenameTableEntry=oriHTTPWebSitenameTableEntry, oriPPPoESessionWANConnectionStatus=oriPPPoESessionWANConnectionStatus, oriSNMPTrapHostTableIndex=oriSNMPTrapHostTableIndex, oriRADStatus=oriRADStatus, oriRogueScanResultsTableClearEntries=oriRogueScanResultsTableClearEntries, oriIntraCellBlockingMACTableEntry=oriIntraCellBlockingMACTableEntry, oriGenericTrapVariable=oriGenericTrapVariable, oriPPPoESessionServiceName=oriPPPoESessionServiceName, orinocoSerial=orinocoSerial, oriWirelessIfProtectionMechanismStatus=oriWirelessIfProtectionMechanismStatus, oriWORPIfDDRSMinReqSNRdot11at12Mbps=oriWORPIfDDRSMinReqSNRdot11at12Mbps, oriSecurityHwConfigResetPassword=oriSecurityHwConfigResetPassword, oriWirelessIfAntennaGain=oriWirelessIfAntennaGain, oriLinkTestOurMinNoiseLevel=oriLinkTestOurMinNoiseLevel, oriTrapVarBatchCLIMessage=oriTrapVarBatchCLIMessage, oriWORPIfConfigTableBaseStationName=oriWORPIfConfigTableBaseStationName, oriRADIUSAuthClientStatTableBadAuthenticators=oriRADIUSAuthClientStatTableBadAuthenticators, oriWirelessIfPropertiesTable=oriWirelessIfPropertiesTable, oriIAPPMACIPTableIndex=oriIAPPMACIPTableIndex, oriStaticMACAddressFilterEntry=oriStaticMACAddressFilterEntry, oriWORPIfDDRSMinReqSNRdot11an48Mbps=oriWORPIfDDRSMinReqSNRdot11an48Mbps, oriLinkTestOurLowFrameCount=oriLinkTestOurLowFrameCount, oriLinkIntTableEntry=oriLinkIntTableEntry, oriVLANIDTableIdentifier=oriVLANIDTableIdentifier, oriWirelessIfClosedSystem=oriWirelessIfClosedSystem, oriRogueScanResultsSNR=oriRogueScanResultsSNR, oriSNTPYear=oriSNTPYear, orinocoIntraCellBlocking=orinocoIntraCellBlocking, oriQoSPolicyTableSecIndex=oriQoSPolicyTableSecIndex, oriSecurityTraps=oriSecurityTraps, oriDMZHostTableEntry=oriDMZHostTableEntry, oriSystemEventLogTableEntry=oriSystemEventLogTableEntry, oriSystemFeatureTableEntry=oriSystemFeatureTableEntry, oriRADIUSAuthClientAuthInvalidAuthenticators=oriRADIUSAuthClientAuthInvalidAuthenticators, oriSecurityConfiguration=oriSecurityConfiguration, oriTrapDNSClientLookupFailure=oriTrapDNSClientLookupFailure, oriHTTPWebSiteFilename=oriHTTPWebSiteFilename, oriTrapVarTFTPFilename=oriTrapVarTFTPFilename, oriSNMPAccessTableIPAddress=oriSNMPAccessTableIPAddress, oriSecurityEncryptionKeyLengthTableEntry=oriSecurityEncryptionKeyLengthTableEntry, oriWirelessIfMediumReservation=oriWirelessIfMediumReservation, oriWORPIfStatTableRegistrationRejects=oriWORPIfStatTableRegistrationRejects, oriSecurityProfileTableStatus=oriSecurityProfileTableStatus, oriWirelessIfSSIDTableSSID=oriWirelessIfSSIDTableSSID, oriTrapRADScanComplete=oriTrapRADScanComplete, oriWirelessIfEncryptionKey4=oriWirelessIfEncryptionKey4, oriQoSPolicyType=oriQoSPolicyType)
mibBuilder.exportSymbols("ORiNOCO-MIB", oriTempLogTableReset=oriTempLogTableReset, oriTelnetInterfaceBitmask=oriTelnetInterfaceBitmask, oriStationStatTableInNoise=oriStationStatTableInNoise, oriStationStatTableLastInPktTime=oriStationStatTableLastInPktTime, oriRogueScanResultsTableEntry=oriRogueScanResultsTableEntry, oriRADIUSAcctServerDestPort=oriRADIUSAcctServerDestPort, oriRADIUSSvrTableDestPort=oriRADIUSSvrTableDestPort, oriIntraCellBlockingMACTableMACAddress=oriIntraCellBlockingMACTableMACAddress, oriRogueScanResultsFrequencyChannel=oriRogueScanResultsFrequencyChannel, oriIntraCellBlockingMACTableGroupID2=oriIntraCellBlockingMACTableGroupID2, oriIntraCellBlockingMACTableGroupID16=oriIntraCellBlockingMACTableGroupID16, oriWirelessIfACSFrequencyBandScan=oriWirelessIfACSFrequencyBandScan, oriWirelessIfSSIDTableQoSPolicy=oriWirelessIfSSIDTableQoSPolicy, oriTrapDuplicateIPAddressEncountered=oriTrapDuplicateIPAddressEncountered, oriWORPIfDDRSDataRateIncPercentThreshold=oriWORPIfDDRSDataRateIncPercentThreshold, oriPortFilterTableEntryStatus=oriPortFilterTableEntryStatus, oriTFTPDowngrade=oriTFTPDowngrade, oriLinkTestInProgress=oriLinkTestInProgress, oriQoSDot1DToIPDSCPPriority=oriQoSDot1DToIPDSCPPriority, orinocoConfig=orinocoConfig, oriWORPIfConfigTable=oriWORPIfConfigTable, oriHTTPWebSiteLanguage=oriHTTPWebSiteLanguage, oriWirelessIfTurboModeStatus=oriWirelessIfTurboModeStatus, oriVLANStatus=oriVLANStatus, oriRADIUSSvrTableEntry=oriRADIUSSvrTableEntry, oriLinkTestTimeOut=oriLinkTestTimeOut, oriRADIUSAuthClientStatTableMalformedAccessResponses=oriRADIUSAuthClientStatTableMalformedAccessResponses, oriRADScanResultsTableEntry=oriRADScanResultsTableEntry, oriStationStatTableType=oriStationStatTableType, oriSecurityProfileTableEncryptionKey0=oriSecurityProfileTableEncryptionKey0, oriWirelessIfAntenna=oriWirelessIfAntenna, oriStormThresholdTable=oriStormThresholdTable, oriDHCPServerIPPoolTableIndex=oriDHCPServerIPPoolTableIndex, oriUnitTemp=oriUnitTemp, oriPPPoESessionIdleTimeOut=oriPPPoESessionIdleTimeOut, orinocoWirelessIf=orinocoWirelessIf, oriWDSSetupTablePortIndex=oriWDSSetupTablePortIndex, tmp11=tmp11, oriDHCPServerIPPoolTableEntry=oriDHCPServerIPPoolTableEntry, oriSecurityProfileTablePSKPassPhrase=oriSecurityProfileTablePSKPassPhrase, oriWirelessIfSupportedAuthenticationModes=oriWirelessIfSupportedAuthenticationModes, oriRogueScanResultsNotificationMode=oriRogueScanResultsNotificationMode, oriRADIUSAuthServerMaximumRetransmission=oriRADIUSAuthServerMaximumRetransmission, oriUPSDMaxActiveSU=oriUPSDMaxActiveSU, oriTrapRogueScanStationDetected=oriTrapRogueScanStationDetected, oriPPPoEMACtoSessionTableIndex=oriPPPoEMACtoSessionTableIndex, oriSecurityProfileTableEncryptionKey2=oriSecurityProfileTableEncryptionKey2, oriTrapRogueScanCycleComplete=oriTrapRogueScanCycleComplete, oriTrapModuleNotInitialized=oriTrapModuleNotInitialized, oriTrapSSLInitializationFailure=oriTrapSSLInitializationFailure, oriSNMPTrapHostTableEntryStatus=oriSNMPTrapHostTableEntryStatus, oriStaticMACAddressFilterComment=oriStaticMACAddressFilterComment, oriProxyARPStatus=oriProxyARPStatus, oriQoSDot1DToDot1pMappingTableRowStatus=oriQoSDot1DToDot1pMappingTableRowStatus, oriRADIUSAuthServerTableEntry=oriRADIUSAuthServerTableEntry, oriNATStaticIPBindTable=oriNATStaticIPBindTable, oriStaticMACAddressFilterWiredMask=oriStaticMACAddressFilterWiredMask, oriWirelessIfNetworkName=oriWirelessIfNetworkName, oriConfigSaveKnownGood=oriConfigSaveKnownGood, oriWirelessIfSSIDTableEncryptionKey2=oriWirelessIfSSIDTableEncryptionKey2, oriStationStatTableLastChange=oriStationStatTableLastChange, oriTrapFlashMemoryEmpty=oriTrapFlashMemoryEmpty, oriLinkIntTable=oriLinkIntTable, oriIAPPMACIPTableSystemName=oriIAPPMACIPTableSystemName, oriWDSSetupTablePartnerMACAddress=oriWDSSetupTablePartnerMACAddress, oriBroadcastFilteringTable=oriBroadcastFilteringTable, oriIAPPHandoverTimeout=oriIAPPHandoverTimeout, oriIntraCellBlockingMACTableGroupID12=oriIntraCellBlockingMACTableGroupID12, orinocoTempLog=orinocoTempLog, oriQoSDot1dPriority=oriQoSDot1dPriority, oriImageTraps=oriImageTraps, oriOEMNoNavLogoImageFile=oriOEMNoNavLogoImageFile, oriTrapVarDHCPServerIPAddress=oriTrapVarDHCPServerIPAddress, oriRogueScanResultsMACAddress=oriRogueScanResultsMACAddress, oriPortFilterTableEntryIndex=oriPortFilterTableEntryIndex, oriWORPIfDDRSMinReqSNRdot11at96Mbps=oriWORPIfDDRSMinReqSNRdot11at96Mbps, oriSystemInvMgmtComponentTable=oriSystemInvMgmtComponentTable, oriStormThresholdTableEntry=oriStormThresholdTableEntry, orinocoWORPIfBSUStatRemoteTxRate=orinocoWORPIfBSUStatRemoteTxRate, oriDHCPRelayDHCPServerTableEntryStatus=oriDHCPRelayDHCPServerTableEntryStatus, oriSecurityProfileTableEncryptionKeyLength=oriSecurityProfileTableEncryptionKeyLength, oriSecurityProfileTableEncryptionTxKey=oriSecurityProfileTableEncryptionTxKey, oriRADIUSAuthClientStatTableIndex=oriRADIUSAuthClientStatTableIndex, oriIntraCellBlockingMACTableGroupID7=oriIntraCellBlockingMACTableGroupID7, oriSNTPMonth=oriSNTPMonth, oriTrapSNTPFailure=oriTrapSNTPFailure, oriHTTPWebSitenameTable=oriHTTPWebSitenameTable, oriRADScanResultsFrequencyChannel=oriRADScanResultsFrequencyChannel, oriWirelessIfQoSMaxMediumThreshold=oriWirelessIfQoSMaxMediumThreshold, oriTrapWLCIncompatibleVendor=oriTrapWLCIncompatibleVendor, oriNetworkIPDefaultTTL=oriNetworkIPDefaultTTL, orinocoWORPIfBSUStat=orinocoWORPIfBSUStat, oriSystemEventLogMask=oriSystemEventLogMask, oriLinkIntTableEntryStatus=oriLinkIntTableEntryStatus, oriRADIUSAuthClientStatTableAccessAccepts=oriRADIUSAuthClientStatTableAccessAccepts, oriNATStaticIPBindRemoteAddress=oriNATStaticIPBindRemoteAddress, oriPortFilterTableEntryPort=oriPortFilterTableEntryPort, oriIntraCellBlockingMACTableGroupID4=oriIntraCellBlockingMACTableGroupID4, oriHTTPRefreshDelay=oriHTTPRefreshDelay, oriTrapImageTooLarge=oriTrapImageTooLarge, oriSNMPAccessTableEntryStatus=oriSNMPAccessTableEntryStatus, InterfaceBitmask=InterfaceBitmask, as2000=as2000, oriPPPoESessionBindingsNumberServiceNameErrors=oriPPPoESessionBindingsNumberServiceNameErrors, oriPPPoESessionBindingsNumberMalformedPackets=oriPPPoESessionBindingsNumberMalformedPackets, oriAccessControlTable=oriAccessControlTable, oriBroadcastFilteringTableEntryStatus=oriBroadcastFilteringTableEntryStatus, oriRADIUSAcctServerNameOrIPAddress=oriRADIUSAcctServerNameOrIPAddress, oriDNSRedirectStatus=oriDNSRedirectStatus, orinocoOEM=orinocoOEM, oriSystemEventLogTableReset=oriSystemEventLogTableReset, oriOEMHomeUrl=oriOEMHomeUrl, oriLinkIntTableIndex=oriLinkIntTableIndex, oriNATStaticPortBindTableEntryStatus=oriNATStaticPortBindTableEntryStatus, oriRADIUSAuthClientTimeouts=oriRADIUSAuthClientTimeouts, oriTrapVarBatchCLILineNumber=oriTrapVarBatchCLILineNumber, ap4000=ap4000, oriWirelessIfPropertiesIndex=oriWirelessIfPropertiesIndex, oriWirelessIfRegulatoryDomainList=oriWirelessIfRegulatoryDomainList, oriSecurityEncryptionKeyLengthTable=oriSecurityEncryptionKeyLengthTable, oriWORPIfSiteSurveyRemoteNoiseLevel=oriWORPIfSiteSurveyRemoteNoiseLevel, oriSNTPDay=oriSNTPDay, oriSystemInvMgmtTableComponentId=oriSystemInvMgmtTableComponentId, DisplayString55=DisplayString55, oriWirelessIfPropertiesEntry=oriWirelessIfPropertiesEntry, oriLinkTestInterval=oriLinkTestInterval, oriWORPIfStatTableReplyData=oriWORPIfStatTableReplyData, oriWirelessIfSupportedMulticastRates=oriWirelessIfSupportedMulticastRates, oriSNMPV3PrivPassword=oriSNMPV3PrivPassword, oriWORPIfStatTable=oriWORPIfStatTable, oriWORPIfSatConfigTableMaximumBandwidthLimitDownlink=oriWORPIfSatConfigTableMaximumBandwidthLimitDownlink, oriTrapVariable=oriTrapVariable, oriVLANIDTableIndex=oriVLANIDTableIndex, orinocoWORPIfBSU=orinocoWORPIfBSU, oriTrapWORPIfNetworkSecretNotConfigured=oriTrapWORPIfNetworkSecretNotConfigured, orinocoWDS=orinocoWDS, oriWirelessIfEncryptionTxKey=oriWirelessIfEncryptionTxKey, oriSystemInvMgmtTableComponentMajorVersion=oriSystemInvMgmtTableComponentMajorVersion, oriRADIUSClientInvalidSvrAddress=oriRADIUSClientInvalidSvrAddress, oriQoSDot1DToIPDSCPMappingTableRowStatus=oriQoSDot1DToIPDSCPMappingTableRowStatus, oriWORPIfStatTablePollNoReplies=oriWORPIfStatTablePollNoReplies, oriTelnetLoginTimeout=oriTelnetLoginTimeout, oriDHCPServerSecondaryDNSIPAddress=oriDHCPServerSecondaryDNSIPAddress, oriRADIUSAcctServerTableEntryStatus=oriRADIUSAcctServerTableEntryStatus, oriSystemHwType=oriSystemHwType, oriEthernetIfConfigTable=oriEthernetIfConfigTable, oriWirelessIfTPCMode=oriWirelessIfTPCMode, oriWORPTraps=oriWORPTraps, oriPortFilterTableEntryComment=oriPortFilterTableEntryComment, orinocoLinkTest=orinocoLinkTest, oriHTTPWebSiteDescription=oriHTTPWebSiteDescription, oriTrapWirelessServiceResumed=oriTrapWirelessServiceResumed, oriWirelessIfBandwidthLimitOut=oriWirelessIfBandwidthLimitOut, oriWirelessIfSSIDTableSupportedSecurityModes=oriWirelessIfSSIDTableSupportedSecurityModes, oriEthernetIfConfigTableEntry=oriEthernetIfConfigTableEntry, oriTrapVLANIDInvalidConfiguration=oriTrapVLANIDInvalidConfiguration, oriStationStatTableRemoteSignal=oriStationStatTableRemoteSignal, oriWORPIfSiteSurveyRemoteSignalLevel=oriWORPIfSiteSurveyRemoteSignalLevel, oriTelnetIdleTimeout=oriTelnetIdleTimeout, oriDNSClientPrimaryServerIPAddress=oriDNSClientPrimaryServerIPAddress, oriSNMPAccessTableEntry=oriSNMPAccessTableEntry, oriStormThresholdIfBroadcast=oriStormThresholdIfBroadcast, oriFlashMemoryTrapsStatus=oriFlashMemoryTrapsStatus, oriSysFeatureTraps=oriSysFeatureTraps, orinocoWORPIfSat=orinocoWORPIfSat, oriIAPPPeriodicAnnounceInterval=oriIAPPPeriodicAnnounceInterval, oriLinkTestOurMinSNR=oriLinkTestOurMinSNR, oriWORPIfSiteSurveyTable=oriWORPIfSiteSurveyTable, oriStationStatTableOutUcastPkts=oriStationStatTableOutUcastPkts, oriAccessControlTableComment=oriAccessControlTableComment, oriWORPIfStatTableSendFailures=oriWORPIfStatTableSendFailures, oriRADIUSAuthServerIPAddress=oriRADIUSAuthServerIPAddress, oriIntraCellBlockingMACTableGroupID9=oriIntraCellBlockingMACTableGroupID9, oriRADIUSAuthClientAccessRequests=oriRADIUSAuthClientAccessRequests, oriTelnetSessions=oriTelnetSessions, oriWirelessIfTrapsStatus=oriWirelessIfTrapsStatus, oriWirelessIfSSIDTableRekeyingInterval=oriWirelessIfSSIDTableRekeyingInterval, oriWORPIfSatStatTableRemoteTxRate=oriWORPIfSatStatTableRemoteTxRate, oriWirelessIfCapabilities=oriWirelessIfCapabilities, oriLinkTestOurStandardFrameCount=oriLinkTestOurStandardFrameCount, orinocoDHCPServer=orinocoDHCPServer, oriRADIUSAuthServerTable=oriRADIUSAuthServerTable, oriPPPoEMaximumNumberOfSessions=oriPPPoEMaximumNumberOfSessions, oriStormThresholdIfMulticast=oriStormThresholdIfMulticast, oriPPPoESessionBindingsNumberGenericErrorsTx=oriPPPoESessionBindingsNumberGenericErrorsTx, oriWORPIfSiteSurveyOperation=oriWORPIfSiteSurveyOperation, oriWORPIfSatConfigTable=oriWORPIfSatConfigTable, oriLinkTestInterface=oriLinkTestInterface, oriSecurityProfileTableAuthenticationMode=oriSecurityProfileTableAuthenticationMode, oriNATStaticPortBindEndPortNumber=oriNATStaticPortBindEndPortNumber, orinocoAOL=orinocoAOL, oriSNMPAccessTableInterfaceBitmask=oriSNMPAccessTableInterfaceBitmask, oriEthernetIfConfigSettings=oriEthernetIfConfigSettings, oriWirelessIfSecurityTable=oriWirelessIfSecurityTable, oriSNTPStatus=oriSNTPStatus, oriTFTPOperationStatus=oriTFTPOperationStatus, oriStaticMACAddressFilterTable=oriStaticMACAddressFilterTable, oriTrapTaskSuspended=oriTrapTaskSuspended, orinocoIf=orinocoIf, oriQoSPolicyName=oriQoSPolicyName, oriSyslogHostTableEntryStatus=oriSyslogHostTableEntryStatus, oriTrapBootPFailed=oriTrapBootPFailed, oriWirelessIfMulticastRate=oriWirelessIfMulticastRate, oriConfigurationTrapsStatus=oriConfigurationTrapsStatus, orinocoStationStatistics=orinocoStationStatistics, oriTrapIncompatibleImage=oriTrapIncompatibleImage, oriWORPIfSatStatTableSendSuccess=oriWORPIfSatStatTableSendSuccess, oriRADIUSLocalUserStatus=oriRADIUSLocalUserStatus, oriRADIUSSvrTableSharedSecret=oriRADIUSSvrTableSharedSecret, oriWORPIfSatConfigTableMinimumBandwidthLimitUplink=oriWORPIfSatConfigTableMinimumBandwidthLimitUplink, oriWORPIfDDRSMinReqSNRdot11an9Mbps=oriWORPIfDDRSMinReqSNRdot11an9Mbps, oriQoSDot1DToIPDSCPMappingTable=oriQoSDot1DToIPDSCPMappingTable, oriWORPIfSatStatTableReceiveRetries=oriWORPIfSatStatTableReceiveRetries, oriPPPoEMACtoSessionTableMACAddress=oriPPPoEMACtoSessionTableMACAddress, oriTrapDNSIPNotConfigured=oriTrapDNSIPNotConfigured, oriWirelessIfMACAddress=oriWirelessIfMACAddress, oriDMZHostTableComment=oriDMZHostTableComment, oriSystemContactPhoneNumber=oriSystemContactPhoneNumber, oriPPPoESessionTableStatus=oriPPPoESessionTableStatus, oriRADIUSbasedManagementAccessProfile=oriRADIUSbasedManagementAccessProfile, oriSecurityEncryptionKeyLength=oriSecurityEncryptionKeyLength, oriQoSPolicyTableEntry=oriQoSPolicyTableEntry, oriFlashTraps=oriFlashTraps, oriWirelessIfAllowedChannels=oriWirelessIfAllowedChannels, oriDMZHostTableEntryStatus=oriDMZHostTableEntryStatus, oriSystemFlashUpdate=oriSystemFlashUpdate, oriWirelessIfSupportedCipherModes=oriWirelessIfSupportedCipherModes, oriWORPIfSatStatTableReplyNoData=oriWORPIfSatStatTableReplyNoData, oriNetworkIPConfigSubnetMask=oriNetworkIPConfigSubnetMask, oriProtocolFilterTable=oriProtocolFilterTable, oriSystemAccessPassword=oriSystemAccessPassword, oriPacketForwardingMACAddress=oriPacketForwardingMACAddress, agere=agere, oriIntraCellBlockingGroupTableIndex=oriIntraCellBlockingGroupTableIndex, oriSerialParity=oriSerialParity, oriSecurityProfileTableEncryptionKey1=oriSecurityProfileTableEncryptionKey1, oriLinkTestOurCurNoiseLevel=oriLinkTestOurCurNoiseLevel, oriLinkTestHisMaxNoiseLevel=oriLinkTestHisMaxNoiseLevel, oriWirelessIfSSIDTableRADIUSAccountingStatus=oriWirelessIfSSIDTableRADIUSAccountingStatus, orinocoRADIUSSvrProfiles=orinocoRADIUSSvrProfiles, oriSNMPTrapHostTablePassword=oriSNMPTrapHostTablePassword, oriSNMPTrapHostTable=oriSNMPTrapHostTable, oriDNSPrimaryDNSIPAddress=oriDNSPrimaryDNSIPAddress, oriAccessControlOperationType=oriAccessControlOperationType, oriPPPoESessionTableEntry=oriPPPoESessionTableEntry, oriRADIUSSvrTableMACAddressFormat=oriRADIUSSvrTableMACAddressFormat, oriRADIUSAuthClientStatTable=oriRADIUSAuthClientStatTable, oriIAPPRoamingClients=oriIAPPRoamingClients, oriTrapInvalidImageDigitalSignature=oriTrapInvalidImageDigitalSignature, oriBroadcastAddressThreshold=oriBroadcastAddressThreshold, orinocoWORPIfSiteSurvey=orinocoWORPIfSiteSurvey, oriTrapDHCPLeaseRenewal=oriTrapDHCPLeaseRenewal, oriSystemInvMgmtInterfaceVariant=oriSystemInvMgmtInterfaceVariant, oriSyslogHostTableIndex=oriSyslogHostTableIndex)
mibBuilder.exportSymbols("ORiNOCO-MIB", oriSystemFeatureTableLicensed=oriSystemFeatureTableLicensed, oriTrapTFTPOperationInitiated=oriTrapTFTPOperationInitiated, oriRADIUSSvrTableAuthorizationLifeTime=oriRADIUSSvrTableAuthorizationLifeTime, orinocoObjects=orinocoObjects, oriPPPoESessionBindingsNumberPADITx=oriPPPoESessionBindingsNumberPADITx, oriRogueScanResultsBSSID=oriRogueScanResultsBSSID, oriDMZHostTableHostIP=oriDMZHostTableHostIP, oriConfigFileTableEntry=oriConfigFileTableEntry, oriRADIUSAuthServerNameOrIPAddress=oriRADIUSAuthServerNameOrIPAddress, oriTrapWLCFirmwareFailure=oriTrapWLCFirmwareFailure, oriOperationalTraps=oriOperationalTraps, oriWirelessIfLBAdjAPTimeDiffThreshold=oriWirelessIfLBAdjAPTimeDiffThreshold, orinocoNAT=orinocoNAT, oriDHCPServerIPPoolTableEndIPAddress=oriDHCPServerIPPoolTableEndIPAddress, oriSystemInvMgmtTableComponentIfTableEntry=oriSystemInvMgmtTableComponentIfTableEntry, oriRADIUSAcctServerSharedSecret=oriRADIUSAcctServerSharedSecret, oriLinkTestOurMinSignalLevel=oriLinkTestOurMinSignalLevel, oriWORPIfSatStatTablePollNoData=oriWORPIfSatStatTablePollNoData, oriHTTPHelpInformationLink=oriHTTPHelpInformationLink, oriRADIUSAuthClientAccessChallenges=oriRADIUSAuthClientAccessChallenges, oriPPPoESessionUserNamePassword=oriPPPoESessionUserNamePassword, oriRogueScanResultsTableIndex=oriRogueScanResultsTableIndex, oriPPPoEMACtoSessionTableStatus=oriPPPoEMACtoSessionTableStatus, oriSystemInvMgmtTableComponentIfTable=oriSystemInvMgmtTableComponentIfTable, orinocoFiltering=orinocoFiltering, oriSyslogHeartbeatStatus=oriSyslogHeartbeatStatus, oriWORPIfStatTableAverageLocalNoise=oriWORPIfStatTableAverageLocalNoise, oriSystemFeatureTable=oriSystemFeatureTable, oriWORPIfStatTableRegistrationIncompletes=oriWORPIfStatTableRegistrationIncompletes, oriUPSDGPRInterval=oriUPSDGPRInterval, oriQoSPolicyMarkingStatus=oriQoSPolicyMarkingStatus, oriRADIUSLocalUserPassword=oriRADIUSLocalUserPassword, oriRADIUSAcctClientAccountingResponses=oriRADIUSAcctClientAccountingResponses, oriIAPPMaximumHandoverRetransmissions=oriIAPPMaximumHandoverRetransmissions, oriTrapVarInterface=oriTrapVarInterface, oriWORPIfSiteSurveyRemoteSNR=oriWORPIfSiteSurveyRemoteSNR, oriRogueScanResultsStationType=oriRogueScanResultsStationType, oriProtocolFilterInterfaceBitmask=oriProtocolFilterInterfaceBitmask, oriStaticMACAddressFilterWirelessMask=oriStaticMACAddressFilterWirelessMask, WEPKeyType=WEPKeyType, oriPortFilterOperationType=oriPortFilterOperationType, orinocoDNS=orinocoDNS, oriRADIUSAuthServerResponseTime=oriRADIUSAuthServerResponseTime, oriRADIUSAcctClientStatTable=oriRADIUSAcctClientStatTable, oriLinkTestOurMediumFrameCount=oriLinkTestOurMediumFrameCount, oriIntraCellBlockingMACTableGroupID5=oriIntraCellBlockingMACTableGroupID5, oriLinkTestDataRateTable=oriLinkTestDataRateTable, oriRADIUSAuthClientAccessRetransmissions=oriRADIUSAuthClientAccessRetransmissions, oriLinkTestDataRateTableLocalCount=oriLinkTestDataRateTableLocalCount, oriTempLogTable=oriTempLogTable, oriLinkIntStatus=oriLinkIntStatus, oriWDSSetupTableEntry=oriWDSSetupTableEntry, oriNATStaticPortBindTableIndex=oriNATStaticPortBindTableIndex, oriOEMProductModel=oriOEMProductModel, oriDNSClientStatus=oriDNSClientStatus, oriWirelessIfPreambleType=oriWirelessIfPreambleType, oriSyslogHeartbeatInterval=oriSyslogHeartbeatInterval, orinocoWORPIfBSUStatAverageLocalNoise=orinocoWORPIfBSUStatAverageLocalNoise, oriSNMPTrapHostTableIPAddress=oriSNMPTrapHostTableIPAddress, orinocoSysFeature=orinocoSysFeature, oriPacketForwardingStatus=oriPacketForwardingStatus, oriLinkTestStationProfile=oriLinkTestStationProfile, oriDNSSecondaryDNSIPAddress=oriDNSSecondaryDNSIPAddress, oriPortFilterTableEntry=oriPortFilterTableEntry, oriDHCPRelayDHCPServerTableEntry=oriDHCPRelayDHCPServerTableEntry, oriSNMPInterfaceBitmask=oriSNMPInterfaceBitmask, oriSystemInvMgmtInterfaceBottomNumber=oriSystemInvMgmtInterfaceBottomNumber, oriWirelessIfTxRate=oriWirelessIfTxRate, oriSNMPV3AuthPassword=oriSNMPV3AuthPassword, oriWORPIfSiteSurveyMaxSatAllowed=oriWORPIfSiteSurveyMaxSatAllowed, oriDHCPServerIPPoolTableStartIPAddress=oriDHCPServerIPPoolTableStartIPAddress, oriLinkTestHisMinSignalLevel=oriLinkTestHisMinSignalLevel, oriWirelessIfSSIDTableEncryptionKey0=oriWirelessIfSSIDTableEncryptionKey0, oriWORPIfSatConfigTableEntry=oriWORPIfSatConfigTableEntry, orinocoHTTP=orinocoHTTP, orinocoSyslog=orinocoSyslog, orinocoWORPIfSatStat=orinocoWORPIfSatStat, oriSystemEventLogNumberOfMessages=oriSystemEventLogNumberOfMessages, orinocoDMZ=orinocoDMZ, oriWDSSetupTableEntryStatus=oriWDSSetupTableEntryStatus, orinocoVLAN=orinocoVLAN, oriQoSDot1DToDot1pMappingTableIndex=oriQoSDot1DToDot1pMappingTableIndex, oriTrapWLCVoltageDiscrepancy=oriTrapWLCVoltageDiscrepancy, oriWORPIfSatStatTablePollNoReplies=oriWORPIfSatStatTablePollNoReplies, oriLinkTestStationName=oriLinkTestStationName, oriWirelessIfSSIDTableVLANID=oriWirelessIfSSIDTableVLANID, oriSNMPAccessTableIPMask=oriSNMPAccessTableIPMask, oriIAPPAnnounceResponseTime=oriIAPPAnnounceResponseTime, oriSystemInvMgmtInterfaceRole=oriSystemInvMgmtInterfaceRole, oriRADIUSAcctClientStatTableAccountingResponses=oriRADIUSAcctClientStatTableAccountingResponses, oriIAPPAnnounceRequestReceived=oriIAPPAnnounceRequestReceived, oriLinkTestDataRateTableIndex=oriLinkTestDataRateTableIndex, orinocoProtocolFilter=orinocoProtocolFilter, oriDHCPRelayStatus=oriDHCPRelayStatus, oriTrapDeviceRebooting=oriTrapDeviceRebooting, oriTrapZeroLicenseFiles=oriTrapZeroLicenseFiles, oriStationStatTableIPAddress=oriStationStatTableIPAddress, oriDHCPServerDefaultGatewayIPAddress=oriDHCPServerDefaultGatewayIPAddress, oriTFTPAutoConfigServerIPAddress=oriTFTPAutoConfigServerIPAddress, oriSpectraLinkLegacyDeviceSupport=oriSpectraLinkLegacyDeviceSupport, orinocoWORPIfBSUStatAverageRemoteSignal=orinocoWORPIfBSUStatAverageRemoteSignal, oriHTTPSSLPassphrase=oriHTTPSSLPassphrase, oriQoSPolicyTableRowStatus=oriQoSPolicyTableRowStatus, oriSNTPMinutes=oriSNTPMinutes, oriSNMPSecureManagementStatus=oriSNMPSecureManagementStatus, oriProtocolFilterProtocol=oriProtocolFilterProtocol, oriWORPIfDDRSDataRateIncReqSNRThreshold=oriWORPIfDDRSDataRateIncReqSNRThreshold, oriStationStatTableInUcastPkts=oriStationStatTableInUcastPkts, oriLinkTestTableIndex=oriLinkTestTableIndex, oriNATStaticIPBindTableEntry=oriNATStaticIPBindTableEntry, oriMulticastAddressThreshold=oriMulticastAddressThreshold, oriWORPIfStatTableAverageRemoteNoise=oriWORPIfStatTableAverageRemoteNoise, oriQoSDot1DToDot1pMappingTable=oriQoSDot1DToDot1pMappingTable, oriAccessControlTableMACAddress=oriAccessControlTableMACAddress, oriSystemInvMgmtComponentTableEntry=oriSystemInvMgmtComponentTableEntry, oriIntraCellBlockingMACTableGroupID6=oriIntraCellBlockingMACTableGroupID6, oriNetworkIPDefaultRouterIPAddress=oriNetworkIPDefaultRouterIPAddress, oriTrapTemperatureAlert=oriTrapTemperatureAlert, oriRADIUSAuthClientAccessRejects=oriRADIUSAuthClientAccessRejects, oriWORPIfDDRSMinReqSNRdot11an18Mbps=oriWORPIfDDRSMinReqSNRdot11an18Mbps, oriIPARPFilteringIPAddress=oriIPARPFilteringIPAddress, oriStationStatTableMACAddress=oriStationStatTableMACAddress, oriIntraCellBlockingMACTable=oriIntraCellBlockingMACTable, oriIntraCellBlockingMACTableGroupID10=oriIntraCellBlockingMACTableGroupID10, oriSystemAccessUserName=oriSystemAccessUserName, oriLinkTestHisMinNoiseLevel=oriLinkTestHisMinNoiseLevel, oriPPPoESessionBindingsNumberMultiplePADORx=oriPPPoESessionBindingsNumberMultiplePADORx, oriSecurityProfileTableCipherMode=oriSecurityProfileTableCipherMode, oriPPPoESessionTableIndex=oriPPPoESessionTableIndex, oriHTTPSetupWizardStatus=oriHTTPSetupWizardStatus, oriStationStatTableOutNUcastPkts=oriStationStatTableOutNUcastPkts, oriRADIUSAcctServerTableEntry=oriRADIUSAcctServerTableEntry, oriSNMPTrapHostTableComment=oriSNMPTrapHostTableComment, oriWORPIfSatStatTableAverageRemoteNoise=oriWORPIfSatStatTableAverageRemoteNoise, oriRADIUSSvrTableAddressingFormat=oriRADIUSSvrTableAddressingFormat, orinocoDHCP=orinocoDHCP, oriWirelessIfSSIDTableRADIUSAccountingProfile=oriWirelessIfSSIDTableRADIUSAccountingProfile, oriSecurityProfileTable=oriSecurityProfileTable, oriStationStatTableRemoteNoise=oriStationStatTableRemoteNoise, oriTrapWLCRadarInterferenceDetected=oriTrapWLCRadarInterferenceDetected, oriLinkTestDataRateTableEntry=oriLinkTestDataRateTableEntry, oriTrapWLCFirmwareDownloadFailure=oriTrapWLCFirmwareDownloadFailure, oriSyslogHostIPAddress=oriSyslogHostIPAddress, oriWirelessIfDistancebetweenAPs=oriWirelessIfDistancebetweenAPs, oriWORPIfSatStatTableAverageLocalNoise=oriWORPIfSatStatTableAverageLocalNoise, oriRADIUSAcctClientStatTablePrimaryOrSecondaryIndex=oriRADIUSAcctClientStatTablePrimaryOrSecondaryIndex, oriSystemFeatureTableCode=oriSystemFeatureTableCode, oriWORPIfSatStatTableReceiveSuccess=oriWORPIfSatStatTableReceiveSuccess, oriWORPIfSatConfigStatus=oriWORPIfSatConfigStatus, oriIAPPMACIPTableESSID=oriIAPPMACIPTableESSID, oriWORPIfSatStatTableIndex=oriWORPIfSatStatTableIndex, oriSystemFlashBackupInterval=oriSystemFlashBackupInterval, oriTrapAutoConfigFailure=oriTrapAutoConfigFailure, oriWirelessIfEncryptionOptions=oriWirelessIfEncryptionOptions, oriStaticMACAddressFilterTableEntryStatus=oriStaticMACAddressFilterTableEntryStatus, orinocoAccessControl=orinocoAccessControl, oriWirelessIfSSIDTableRADIUSMACAccessControl=oriWirelessIfSSIDTableRADIUSMACAccessControl, oriIAPPAnnounceResponseReceived=oriIAPPAnnounceResponseReceived, oriPacketForwardingInterface=oriPacketForwardingInterface, oriWDSSecurityTable=oriWDSSecurityTable, oriNATStaticPortBindStartPortNumber=oriNATStaticPortBindStartPortNumber, oriConfigurationTraps=oriConfigurationTraps, oriPPPoESessionTable=oriPPPoESessionTable, oriStaticMACAddressFilterTableIndex=oriStaticMACAddressFilterTableIndex, oriRADIUSAuthClientStatTableTimeouts=oriRADIUSAuthClientStatTableTimeouts, oriTrapDHCPRelayServerTableNotConfigured=oriTrapDHCPRelayServerTableNotConfigured, oriSpectraLinkStatus=oriSpectraLinkStatus, orinocoStaticMACAddressFilter=orinocoStaticMACAddressFilter, oriIAPPMACIPTableEntry=oriIAPPMACIPTableEntry, orinocoNetIP=orinocoNetIP, orinocoPortFilter=orinocoPortFilter, oriTrapRADIUSAuthenticationNotConfigured=oriTrapRADIUSAuthenticationNotConfigured, oriLinkTestRadioType=oriLinkTestRadioType, oriHTTPInterfaceBitmask=oriHTTPInterfaceBitmask, bg2000=bg2000, oriStationStatTableInDiscards=oriStationStatTableInDiscards, oriDMZHostTable=oriDMZHostTable, orinocoConformance=orinocoConformance, oriNetworkIPConfigTable=oriNetworkIPConfigTable, oriSecurityConfigTableEncryptionKeyLength=oriSecurityConfigTableEncryptionKeyLength, oriOEMName=oriOEMName, oriStationStatTable=oriStationStatTable, oriTrapVLANIDUserAssignment=oriTrapVLANIDUserAssignment, oriTrapTFTPFailedOperation=oriTrapTFTPFailedOperation, oriRADIUSSvrTableAccountingUpdateInterval=oriRADIUSSvrTableAccountingUpdateInterval, oriRADIUSAcctClientStatTableAccountingRetransmissions=oriRADIUSAcctClientStatTableAccountingRetransmissions, oriWORPIfSiteSurveyLocalSignalLevel=oriWORPIfSiteSurveyLocalSignalLevel, oriStaticMACAddressFilterWirelessAddress=oriStaticMACAddressFilterWirelessAddress, oriWORPIfStatTableRegistrationTimeouts=oriWORPIfStatTableRegistrationTimeouts, oriNATStaticIPBindTableIndex=oriNATStaticIPBindTableIndex, oriWORPStationDeRegister=oriWORPStationDeRegister, oriWORPIfSiteSurveyNumSatRegistered=oriWORPIfSiteSurveyNumSatRegistered, oriProtocolFilterOperationType=oriProtocolFilterOperationType, oriRADIUSAuthClientStatTablePrimaryOrSecondaryIndex=oriRADIUSAuthClientStatTablePrimaryOrSecondaryIndex, oriLinkTestOurCurSignalLevel=oriLinkTestOurCurSignalLevel, oriWORPIfStatTableReceiveRetries=oriWORPIfStatTableReceiveRetries, oriSNMPTrapType=oriSNMPTrapType, oriSystemFeatureTableSupported=oriSystemFeatureTableSupported, oriADSLIfTrapsStatus=oriADSLIfTrapsStatus, DisplayString80=DisplayString80, oriWirelessIfMediumDensityDistribution=oriWirelessIfMediumDensityDistribution, oriLinkIntTableComment=oriLinkIntTableComment, oriTrapWLCFailure=oriTrapWLCFailure, oriLinkTestHisCurNoiseLevel=oriLinkTestHisCurNoiseLevel, oriRogueScanStationCountWirelessCardB=oriRogueScanStationCountWirelessCardB, oriNetworkIPConfigIPAddress=oriNetworkIPConfigIPAddress, oriRADScanResultsTable=oriRADScanResultsTable, oriSyslogHostTable=oriSyslogHostTable, oriLinkTestMACAddress=oriLinkTestMACAddress, orinocoAdvancedFiltering=orinocoAdvancedFiltering, oriHTTPPort=oriHTTPPort, oriConfigFileTable=oriConfigFileTable, oriTrapBatchFileExecStart=oriTrapBatchFileExecStart, oriTelnetSSHFingerPrint=oriTelnetSSHFingerPrint, oriSecurityProfileTableEncryptionKey3=oriSecurityProfileTableEncryptionKey3, oriNATStaticIPBindLocalAddress=oriNATStaticIPBindLocalAddress, oriSystemInvMgmtTableComponentMinorVersion=oriSystemInvMgmtTableComponentMinorVersion, oriStationStatTableAdminStatus=oriStationStatTableAdminStatus, oriWORPTrapsStatus=oriWORPTrapsStatus, oriWORPIfStatTablePollNoData=oriWORPIfStatTablePollNoData, oriLinkIntPollRetransmissions=oriLinkIntPollRetransmissions, oriLinkTestHisLowFrameCount=oriLinkTestHisLowFrameCount, oriIntraCellBlockingMACTableEntryStatus=oriIntraCellBlockingMACTableEntryStatus, oriPPPoEStatus=oriPPPoEStatus, orinocoRogueScan=orinocoRogueScan, oriWORPIfSatStatTableEntry=oriWORPIfSatStatTableEntry, oriRogueScanConfigTableScanStatus=oriRogueScanConfigTableScanStatus, oriSNTPSecondaryServerNameOrIPAddress=oriSNTPSecondaryServerNameOrIPAddress, oriWirelessIfQoSStatus=oriWirelessIfQoSStatus, oriWirelessIfSSIDTableClosedSystem=oriWirelessIfSSIDTableClosedSystem, oriWirelessIfEncryptionKey2=oriWirelessIfEncryptionKey2, oriTelnetPassword=oriTelnetPassword, oriWirelessIfEncryptionKey1=oriWirelessIfEncryptionKey1, oriTrapInvalidLicenseFile=oriTrapInvalidLicenseFile, oriSystemInvMgmtInterfaceTopNumber=oriSystemInvMgmtInterfaceTopNumber, oriRADIUSAcctServerResponseTime=oriRADIUSAcctServerResponseTime, oriLinkTestHisHighFrameCount=oriLinkTestHisHighFrameCount, oriDNSRedirectMaxResponseWaitTime=oriDNSRedirectMaxResponseWaitTime, orinocoPacketForwarding=orinocoPacketForwarding, oriRADIUSAcctServerType=oriRADIUSAcctServerType, oriLinkTestOurMaxNoiseLevel=oriLinkTestOurMaxNoiseLevel, orinocoLinkInt=orinocoLinkInt, oriSystemInvMgmtTableComponentIndex=oriSystemInvMgmtTableComponentIndex, oriSNMPErrorMessage=oriSNMPErrorMessage, oriWirelessIfAllowedSupportedDataRates=oriWirelessIfAllowedSupportedDataRates, oriTFTPOperation=oriTFTPOperation, oriRADIUSClientInvalidServerAddress=oriRADIUSClientInvalidServerAddress, oriRogueScanConfigTableScanCycleTime=oriRogueScanConfigTableScanCycleTime, oriNetworkIPAddressType=oriNetworkIPAddressType, orinocoQoS=orinocoQoS, oriWirelessIfSSIDTableRADIUSMACAuthProfile=oriWirelessIfSSIDTableRADIUSMACAuthProfile, oriIAPPStatus=oriIAPPStatus, oriWirelessIfEncryptionKey3=oriWirelessIfEncryptionKey3, oriIAPPHandoverRequestReceived=oriIAPPHandoverRequestReceived)
mibBuilder.exportSymbols("ORiNOCO-MIB", oriRADIUSSvrTableMaximumRetransmission=oriRADIUSSvrTableMaximumRetransmission, oriSecurityConfigTableEntry=oriSecurityConfigTableEntry, oriNATStaticPortBindTable=oriNATStaticPortBindTable, oriIntraCellBlockingMACTableGroupID1=oriIntraCellBlockingMACTableGroupID1, oriWORPIfSatConfigTableMacAddress=oriWORPIfSatConfigTableMacAddress, oriSystemAccessIdleTimeout=oriSystemAccessIdleTimeout, oriRADIUSAcctClientStatTableBadAuthenticators=oriRADIUSAcctClientStatTableBadAuthenticators, oriHTTPRADIUSAccessControl=oriHTTPRADIUSAccessControl, oriWORPIfDDRSMinReqSNRdot11at108Mbps=oriWORPIfDDRSMinReqSNRdot11at108Mbps, oriRADIUSAcctServerTable=oriRADIUSAcctServerTable, oriWORPIfSatConfigTableComment=oriWORPIfSatConfigTableComment, oriWirelessIfSuperModeStatus=oriWirelessIfSuperModeStatus, oriRADIUSAcctServerTableIndex=oriRADIUSAcctServerTableIndex, oriLinkTestHisCurSignalLevel=oriLinkTestHisCurSignalLevel, oriSecurityHwConfigResetStatus=oriSecurityHwConfigResetStatus, oriTrapRADIUSAccountingNotConfigured=oriTrapRADIUSAccountingNotConfigured, oriVLANMgmtIdentifier=oriVLANMgmtIdentifier, orinocoGroups=orinocoGroups, orinocoWORPIfBSUStatLocalTxRate=orinocoWORPIfBSUStatLocalTxRate, oriWirelessIfSSIDTablePSKValue=oriWirelessIfSSIDTablePSKValue, oriSystemInvMgmtTableComponentSerialNumber=oriSystemInvMgmtTableComponentSerialNumber, oriIntraCellBlockingMACTableGroupID15=oriIntraCellBlockingMACTableGroupID15, oriSecurityGwMac=oriSecurityGwMac, oriLinkTestTableEntry=oriLinkTestTableEntry, oriWDSSecurityTableEncryptionKey0=oriWDSSecurityTableEncryptionKey0, oriWORPIfSatStatTableSendRetries=oriWORPIfSatStatTableSendRetries, oriSNMPTrapHostTableEntry=oriSNMPTrapHostTableEntry, oriIPARPFilteringSubnetMask=oriIPARPFilteringSubnetMask, oriWORPIfStatTableRegistrationRequests=oriWORPIfStatTableRegistrationRequests, ObjStatus=ObjStatus, orinocoTrap=orinocoTrap, oriWirelessIfLoadBalancing=oriWirelessIfLoadBalancing, oriRADIUSAcctClientStatTableEntry=oriRADIUSAcctClientStatTableEntry, oriSecurityProfileTablePSKValue=oriSecurityProfileTablePSKValue, oriQoSIPDSCPUpperLimit=oriQoSIPDSCPUpperLimit, oriSNMPAccessTableStatus=oriSNMPAccessTableStatus, oriPPPoESessionISPName=oriPPPoESessionISPName, oriPortFilterTableEntryInterfaceBitmask=oriPortFilterTableEntryInterfaceBitmask, orinocoRAD=orinocoRAD, oriWirelessIfSSIDTable=oriWirelessIfSSIDTable, oriTrapVarUnauthorizedManagerIPaddress=oriTrapVarUnauthorizedManagerIPaddress, oriDHCPRelayDHCPServerTable=oriDHCPRelayDHCPServerTable, oriSerialBaudRate=oriSerialBaudRate, oriTrapsImageStatus=oriTrapsImageStatus, oriPPPoESessionUserName=oriPPPoESessionUserName, oriStationStatTableEntry=oriStationStatTableEntry, oriWORPIfDDRSMinReqSNRdot11an24Mbps=oriWORPIfDDRSMinReqSNRdot11an24Mbps, oriLinkTestTable=oriLinkTestTable, oriRADIUSAuthorizationLifeTime=oriRADIUSAuthorizationLifeTime, oriTFTPFileName=oriTFTPFileName, oriIntraCellBlockingMACTableGroupID13=oriIntraCellBlockingMACTableGroupID13, orinocoIPARP=orinocoIPARP, oriWirelessIfDenyNonEncryptedData=oriWirelessIfDenyNonEncryptedData, oriWORPIfSatConfigTableMaximumBandwidthLimitUplink=oriWORPIfSatConfigTableMaximumBandwidthLimitUplink, oriIAPPSendAnnounceRequestOnStart=oriIAPPSendAnnounceRequestOnStart, oriRADIUSAcctUpdateInterval=oriRADIUSAcctUpdateInterval, oriAccessControlEntry=oriAccessControlEntry, oriWORPIfSatStatTableSendFailures=oriWORPIfSatStatTableSendFailures, oriBroadcastFilteringProtocolName=oriBroadcastFilteringProtocolName, oriWirelessIfSSIDTableIndex=oriWirelessIfSSIDTableIndex, oriPPPoEMACtoSessionTable=oriPPPoEMACtoSessionTable, oriWORPIfStatTableRemotePartners=oriWORPIfStatTableRemotePartners, oriRADIUSAcctClientAccountingRequests=oriRADIUSAcctClientAccountingRequests, oriConfigFileName=oriConfigFileName, oriDNSClientDefaultDomainName=oriDNSClientDefaultDomainName, oriSNMPAccessTableComment=oriSNMPAccessTableComment, oriRogueScanConfigTableEntry=oriRogueScanConfigTableEntry, oriHTTPWebSitenameTableIndex=oriHTTPWebSitenameTableIndex, oriSecurityProfileTableEntry=oriSecurityProfileTableEntry, oriDHCPRelayDHCPServerTableIpAddress=oriDHCPRelayDHCPServerTableIpAddress, oriPortFilterTable=oriPortFilterTable, oriRADIUSSvrTableAccountingInactivityTimer=oriRADIUSSvrTableAccountingInactivityTimer, oriPPPoESessionBindingsNumberGenericErrorsRx=oriPPPoESessionBindingsNumberGenericErrorsRx, oriPortFilterTableEntryPortType=oriPortFilterTableEntryPortType, oriDHCPServerIPPoolTableDefaultLeaseTime=oriDHCPServerIPPoolTableDefaultLeaseTime, oriIAPPMACIPTable=oriIAPPMACIPTable, oriWORPIfDDRSMinReqSNRdot11an12Mbps=oriWORPIfDDRSMinReqSNRdot11an12Mbps, oriRADIUSAuthServerAddressingFormat=oriRADIUSAuthServerAddressingFormat, ap500=ap500, oriLinkTestHisMinSNR=oriLinkTestHisMinSNR, oriNATType=oriNATType, oriWORPIfStatTableAverageRemoteSignal=oriWORPIfStatTableAverageRemoteSignal, oriWORPIfStatTableReplyMoreData=oriWORPIfStatTableReplyMoreData, oriRADIUSAuthClientStatTableAccessRetransmissions=oriRADIUSAuthClientStatTableAccessRetransmissions, oriQoSDot1DToIPDSCPMappingTableEntry=oriQoSDot1DToIPDSCPMappingTableEntry, orinocoSecurityGw=orinocoSecurityGw, oriIntraCellBlockingGroupTable=oriIntraCellBlockingGroupTable, oriWDSSecurityTableEntry=oriWDSSecurityTableEntry, oriSecurityConfigTableSupportedSecurityModes=oriSecurityConfigTableSupportedSecurityModes, oriRADIUSAuthServerType=oriRADIUSAuthServerType, oriWORPIfSatStatTableLocalTxRate=oriWORPIfSatStatTableLocalTxRate, oriRADIUSAuthClientStatTableAccessRejects=oriRADIUSAuthClientStatTableAccessRejects, oriWORPIfConfigTableEntry=oriWORPIfConfigTableEntry, oriPPPoESessionConnectTimeLimitation=oriPPPoESessionConnectTimeLimitation, oriNATStaticBindStatus=oriNATStaticBindStatus, oriSecurityRekeyingInterval=oriSecurityRekeyingInterval, oriStationStatTableInOctets=oriStationStatTableInOctets, oriIntraCellBlockingGroupTableName=oriIntraCellBlockingGroupTableName, oriWORPIfDDRSDataRateDecReqSNRThreshold=oriWORPIfDDRSDataRateDecReqSNRThreshold, oriConfigSaveFile=oriConfigSaveFile, oriTrapVarDefaultRouterIPAddress=oriTrapVarDefaultRouterIPAddress, oriRADIUSAuthClientMalformedAccessResponses=oriRADIUSAuthClientMalformedAccessResponses, oriWORPIfRoamingThreshold=oriWORPIfRoamingThreshold, oriRADIUSAcctServerAddressingFormat=oriRADIUSAcctServerAddressingFormat, oriWORPIfSiteSurveyLocalNoiseLevel=oriWORPIfSiteSurveyLocalNoiseLevel, oriWirelessIfSSIDTablePSKPassPhrase=oriWirelessIfSSIDTablePSKPassPhrase, orinocoWORPIfDDRS=orinocoWORPIfDDRS, oriWDSSecurityTableSecurityMode=oriWDSSecurityTableSecurityMode, oriNATStaticPortBindLocalAddress=oriNATStaticPortBindLocalAddress, ap1000=ap1000, oriRADAccessPointCount=oriRADAccessPointCount, orinoco=orinoco, oriVLANIDTableEntry=oriVLANIDTableEntry, oriPPPoESessionConnectTime=oriPPPoESessionConnectTime, oriRADIUSAuthServerDestPort=oriRADIUSAuthServerDestPort, oriWORPIfStatTableSendRetries=oriWORPIfStatTableSendRetries, oriPPPoESessionBindingsNumberACSystemErrors=oriPPPoESessionBindingsNumberACSystemErrors, oriWirelessIfSSIDTableBroadcastSSID=oriWirelessIfSSIDTableBroadcastSSID, oriTelnetRADIUSAccessControl=oriTelnetRADIUSAccessControl, oriPPPoESessionBindingsNumberPADTTx=oriPPPoESessionBindingsNumberPADTTx, oriQoSDot1pPriority=oriQoSDot1pPriority, oriSecurityConfigTableRekeyingInterval=oriSecurityConfigTableRekeyingInterval, oriLinkTestHisMaxSNR=oriLinkTestHisMaxSNR, oriHTTPPassword=oriHTTPPassword, oriWirelessIfInterferenceRobustness=oriWirelessIfInterferenceRobustness, oriAccessControlTableEntryStatus=oriAccessControlTableEntryStatus, oriIAPPAnnounceRequestSent=oriIAPPAnnounceRequestSent, oriTFTPFileMode=oriTFTPFileMode, oriWORPIfSiteSurveyBaseName=oriWORPIfSiteSurveyBaseName, oriOEMProductName=oriOEMProductName, orinocoCompliances=orinocoCompliances, oriRADInterval=oriRADInterval, oriRADIUSAcctClientAccountingRetransmissions=oriRADIUSAcctClientAccountingRetransmissions, orinocoStormThreshold=orinocoStormThreshold, oriWORPIfSatStatTableReplyData=oriWORPIfSatStatTableReplyData, oriWORPIfDDRSMinReqSNRdot11at24Mbps=oriWORPIfDDRSMinReqSNRdot11at24Mbps, oriRogueScanConfigTable=oriRogueScanConfigTable, orinocoSecurity=orinocoSecurity, oriWirelessIfSecurityPerSSIDStatus=oriWirelessIfSecurityPerSSIDStatus, oriTrapVarTFTPOperation=oriTrapVarTFTPOperation, oriWirelessIfSSIDTableEncryptionKeyLength=oriWirelessIfSSIDTableEncryptionKeyLength, oriWORPIfSatConfigTableEntryStatus=oriWORPIfSatConfigTableEntryStatus, oriNATStaticIPBindTableEntryStatus=oriNATStaticIPBindTableEntryStatus, oriRADScanResultsTableIndex=oriRADScanResultsTableIndex, oriSNTPSeconds=oriSNTPSeconds, oriTempLogMessage=oriTempLogMessage, oriSystemEmergencyResetToDefault=oriSystemEmergencyResetToDefault, oriWORPIfSiteSurveyTableIndex=oriWORPIfSiteSurveyTableIndex, oriWirelessIfTxPowerControl=oriWirelessIfTxPowerControl, oriWirelessIfSupportedOperationalModes=oriWirelessIfSupportedOperationalModes, oriRADLastSuccessfulScanTime=oriRADLastSuccessfulScanTime, oriSystemCountryCode=oriSystemCountryCode, oriPPPoEMACtoSessionTableEntry=oriPPPoEMACtoSessionTableEntry, oriWORPIfStatTableRegistrationAttempts=oriWORPIfStatTableRegistrationAttempts, oriRADIUSSvrTableNameOrIPAddress=oriRADIUSSvrTableNameOrIPAddress, oriWORPIfDDRSMinReqSNRdot11an36Mbps=oriWORPIfDDRSMinReqSNRdot11an36Mbps, oriDMZHostTableIndex=oriDMZHostTableIndex, oriRADIUSAuthClientAccessAccepts=oriRADIUSAuthClientAccessAccepts, oriIAPPMACIPTableIPAddress=oriIAPPMACIPTableIPAddress, oriRADIUSAuthClientStatTableEntry=oriRADIUSAuthClientStatTableEntry, oriSerialFlowControl=oriSerialFlowControl, oriUPSDRoamingReserved=oriUPSDRoamingReserved, oriConfigResetToDefaults=oriConfigResetToDefaults, oriDHCPClientID=oriDHCPClientID, oriWirelessIfSSIDTableEncryptionKey1=oriWirelessIfSSIDTableEncryptionKey1, oriNetworkIPConfigTableEntry=oriNetworkIPConfigTableEntry, oriBroadcastFilteringDirection=oriBroadcastFilteringDirection, oriSystemEventLogTable=oriSystemEventLogTable, oriWORPIfSatStatTableAverageRemoteSignal=oriWORPIfSatStatTableAverageRemoteSignal, oriWORPIfDDRSStatus=oriWORPIfDDRSStatus, oriProtocolFilterTableInterfaceBitmask=oriProtocolFilterTableInterfaceBitmask, oriLinkIntPollInterval=oriLinkIntPollInterval, oriStationStatTableInterface=oriStationStatTableInterface, oriLinkTestHisMediumFrameCount=oriLinkTestHisMediumFrameCount, oriTelnetSSHHostKeyStatus=oriTelnetSSHHostKeyStatus, oriWORPIfDDRSMinReqSNRdot11at36Mbps=oriWORPIfDDRSMinReqSNRdot11at36Mbps, oriIntraCellBlockingMACTableIndex=oriIntraCellBlockingMACTableIndex, oriTrapVarFailedAuthenticationType=oriTrapVarFailedAuthenticationType, oriWORPIfRoamingFastScanPercentThreshold=oriWORPIfRoamingFastScanPercentThreshold, oriAccessControlTableIndex=oriAccessControlTableIndex, oriProtocolFilterTableIndex=oriProtocolFilterTableIndex, ap700=ap700, oriWirelessIfSSIDTableEntry=oriWirelessIfSSIDTableEntry, oriWORPIfConfigTableNetworkSecret=oriWORPIfConfigTableNetworkSecret, oriSystemFeatureTableDescription=oriSystemFeatureTableDescription, oriIntraCellBlockingGroupTableEntry=oriIntraCellBlockingGroupTableEntry, oriEthernetIfConfigBandwidthLimitIn=oriEthernetIfConfigBandwidthLimitIn, oriTrapVarSubnetMask=oriTrapVarSubnetMask, oriWORPIfStatTableAverageLocalSignal=oriWORPIfStatTableAverageLocalSignal, oriStationStatTableOutDiscards=oriStationStatTableOutDiscards, oriWORPIfSiteSurveySignalQualityTableEntry=oriWORPIfSiteSurveySignalQualityTableEntry, oriWORPIfSiteSurveyBaseMACAddress=oriWORPIfSiteSurveyBaseMACAddress, oriSystemEventLogMessage=oriSystemEventLogMessage, oriSerialStopBits=oriSerialStopBits, oriWORPIfDDRSDataRateIncAvgSNRThreshold=oriWORPIfDDRSDataRateIncAvgSNRThreshold, oriIntraCellBlockingMACTableGroupID8=oriIntraCellBlockingMACTableGroupID8, oriStationStatTableIndex=oriStationStatTableIndex, oriWirelessIfSSIDTableStatus=oriWirelessIfSSIDTableStatus, oriSecurityConfigTableSecurityMode=oriSecurityConfigTableSecurityMode, oriTrapTFTPOperationCompleted=oriTrapTFTPOperationCompleted, orinocoUPSD=orinocoUPSD, oriSystemInvMgmtTableComponentVariant=oriSystemInvMgmtTableComponentVariant, oriSecurityProfileTableIndex=oriSecurityProfileTableIndex, oriVLANIDTable=oriVLANIDTable, oriWORPIfRoamingSlowScanThreshold=oriWORPIfRoamingSlowScanThreshold, oriWORPIfRoamingStatus=oriWORPIfRoamingStatus, oriQoSDot1DToDot1pMappingTableEntry=oriQoSDot1DToDot1pMappingTableEntry, oriWORPIfConfigTableRegistrationTimeout=oriWORPIfConfigTableRegistrationTimeout, oriSystemMode=oriSystemMode, oriTrapVarIPAddress=oriTrapVarIPAddress, oriWORPIfStatTableBaseStationAnnounces=oriWORPIfStatTableBaseStationAnnounces, oriMiscTraps=oriMiscTraps, oriRADIUSSvrTableResponseTime=oriRADIUSSvrTableResponseTime, PYSNMP_MODULE_ID=orinoco, ap2000=ap2000, oriIAPPHandoverResponseReceived=oriIAPPHandoverResponseReceived, oriWirelessIfSecurityEntry=oriWirelessIfSecurityEntry, oriRADIUSAcctClientAcctInvalidAuthenticators=oriRADIUSAcctClientAcctInvalidAuthenticators, oriDHCPServerPrimaryDNSIPAddress=oriDHCPServerPrimaryDNSIPAddress, oriSNTPDayLightSavingTime=oriSNTPDayLightSavingTime, oriRADInterfaceBitmask=oriRADInterfaceBitmask, oriTrapInvalidImage=oriTrapInvalidImage, oriDHCPServerIPPoolTableComment=oriDHCPServerIPPoolTableComment, oriWirelessIfLBTxTimeThreshold=oriWirelessIfLBTxTimeThreshold, oriDNSClientSecondaryServerIPAddress=oriDNSClientSecondaryServerIPAddress, oriRogueScanResultsTable=oriRogueScanResultsTable, rg1000=rg1000, orinocoSys=orinocoSys, oriPPPoESessionConfigPADIMaxNumberOfRetries=oriPPPoESessionConfigPADIMaxNumberOfRetries, oriSystemAccessLoginTimeout=oriSystemAccessLoginTimeout, oriWORPIfDDRSDefDataRate=oriWORPIfDDRSDefDataRate, rg1100=rg1100, oriWORPIfStatTableAuthenticationConfirms=oriWORPIfStatTableAuthenticationConfirms, oriWORPIfStatTablePollData=oriWORPIfStatTablePollData, oriWirelessIfSSIDTableSecurityMode=oriWirelessIfSSIDTableSecurityMode, oriWirelessIfSSIDTableEncryptionKey3=oriWirelessIfSSIDTableEncryptionKey3, oriWirelessIfSSIDTableEncryptionTxKey=oriWirelessIfSSIDTableEncryptionTxKey, oriSyslogPriority=oriSyslogPriority, ap600=ap600, oriOperationalTrapsStatus=oriOperationalTrapsStatus, oriEthernetIfConfigTableIndex=oriEthernetIfConfigTableIndex, oriWORPIfStatTableReplyNoData=oriWORPIfStatTableReplyNoData, oriRADIUSMACAddressFormat=oriRADIUSMACAddressFormat, oriRADScanResultsMACAddress=oriRADScanResultsMACAddress, oriWORPIfDDRSDataRateDecPercentThreshold=oriWORPIfDDRSDataRateDecPercentThreshold, oriStationStatTableInSignal=oriStationStatTableInSignal, oriTrapMaximumNumberOfSubscribersReached=oriTrapMaximumNumberOfSubscribersReached, orinocoTFTP=orinocoTFTP, oriRADIUSSvrTableVLANID=oriRADIUSSvrTableVLANID, oriProtocolFilterProtocolComment=oriProtocolFilterProtocolComment, oriRogueScanResultsTableAgingTime=oriRogueScanResultsTableAgingTime, oriStationStatTableLastState=oriStationStatTableLastState, oriWirelessIfSSIDTableSecurityProfile=oriWirelessIfSSIDTableSecurityProfile, oriRADIUSAuthClientStatTableAccessChallenges=oriRADIUSAuthClientStatTableAccessChallenges)
mibBuilder.exportSymbols("ORiNOCO-MIB", oriPPPoEMACtoSessionTableISPName=oriPPPoEMACtoSessionTableISPName, orinocoWORPIfBSUStatAverageLocalSignal=orinocoWORPIfBSUStatAverageLocalSignal, oriSecurityGwStatus=oriSecurityGwStatus, oriWirelessIfChannel=oriWirelessIfChannel, orinocoWORPIfSatConfig=orinocoWORPIfSatConfig, oriPortFilterStatus=oriPortFilterStatus, oriWORPIfSatConfigTableMinimumBandwidthLimitDownlink=oriWORPIfSatConfigTableMinimumBandwidthLimitDownlink, oriProtocolFilterTableEntry=oriProtocolFilterTableEntry, oriTempLogTableEntry=oriTempLogTableEntry, oriAOLNATALGStatus=oriAOLNATALGStatus, oriIBSSTrafficOperation=oriIBSSTrafficOperation, oriStationStatTableOutOctets=oriStationStatTableOutOctets, oriSNTPHour=oriSNTPHour, oriUPSDE911Reserved=oriUPSDE911Reserved, oriTrapVarUnAuthorizedManagerCount=oriTrapVarUnAuthorizedManagerCount, oriWirelessIfSSIDTableRADIUSDot1xProfile=oriWirelessIfSSIDTableRADIUSDot1xProfile, oriAccessControlStatus=oriAccessControlStatus, oriWORPIfDDRSMinReqSNRdot11at72Mbps=oriWORPIfDDRSMinReqSNRdot11at72Mbps, oriNATPublicIPAddress=oriNATPublicIPAddress, oriLinkTestOurMaxSNR=oriLinkTestOurMaxSNR, oriSecurityProfileFourWEPKeySupport=oriSecurityProfileFourWEPKeySupport, oriWirelessIfSecurityIndex=oriWirelessIfSecurityIndex, oriTelnetSSHStatus=oriTelnetSSHStatus, oriPPPoESessionConfigPADITxInterval=oriPPPoESessionConfigPADITxInterval)
