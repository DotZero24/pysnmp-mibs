...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WIRELESS-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:28:18 2025
...
cwrRadioBasicCompliance.setObjects(
      *(("CISCO-WIRELESS-IF-MIB", "cwrComplianceRadioGroup"),
        ...
        ("CISCO-WIRELESS-IF-MIB", "cwrComplianceReqLinkMetrics"),
        ("CISCO-WIRELESS-IF-MIB", "cwrComplianceRadioTestGroup"),
        ("CISCO-WIRELESS-IF-MIB", "cwrComplianceHistoryGroup"),
        ("CISCO-WIRELESS-IF-MIB", "cwrComplianceRadioTlGroup"),
        ("CISCO-WIRELESS-IF-MIB", "cwrComplianceRadioSnapshotGroup"),
        ("CISCO-WIRELESS-IF-MIB", "cwrComplianceRadioAntennaGroup"),
        ("CISCO-WIRELESS-IF-MIB", "cwrComplianceRadioPhyByteErrGroup"),
        ("CISCO-WIRELESS-IF-MIB", "cwrComplianceNotifGroup"))
)
if mibBuilder.loadTexts:
