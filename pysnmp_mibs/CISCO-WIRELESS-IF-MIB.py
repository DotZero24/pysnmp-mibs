...
CwrCwSeverelyErroredSecond, CwrCwErroredSecond, CwrCwDegradedSecond, CwrCollectionStatus, WirelessGauge64, CwrCwErrorFreeSecond, CwrOscState, CwrCwDegradedMinute, CwrThreshLimitType, CwrRadioSignalAttribute, CwrCwConsecutiveSevErrSecond, CwrCollectionAction, CwrRFZeroIndex = mibBuilder.importSymbols("CISCO-WIRELESS-TC-MIB", "CwrCwSeverelyErroredSecond", "CwrCwErroredSecond", "CwrCwDegradedSecond", "CwrCollectionStatus", "WirelessGauge64", "CwrCwErrorFreeSecond", "CwrOscState", "CwrCwDegradedMinute", "CwrThreshLimitType", "CwrRadioSignalAttribute", "CwrCwConsecutiveSevErrSecond", "CwrCollectionAction", "CwrRFZeroIndex")
...
mibBuilder.exportSymbols("CISCO-WIRELESS-IF-MIB", cwrTlNumValues=cwrTlNumValues, cwrArq2ByteErrs=cwrArq2ByteErrs, cwrTrapRfSupplyVoltage=cwrTrapRfSupplyVoltage, cwr1SecTxArqCount=cwr1SecTxArqCount, cwrComplianceNotifGroup=cwrComplianceNotifGroup, cwrTrapLinkSyncLost=cwrTrapLinkSyncLost, cwrPctErrorFreeSeconds=cwrPctErrorFreeSeconds, cwr1SecPostARQGoodCodewords=cwr1SecPostARQGoodCodewords, cwrArq9ByteErrs=cwrArq9ByteErrs, cwr1MinMetricsEntry=cwr1MinMetricsEntry, cwrAvailableSeconds=cwrAvailableSeconds, cwrThroughput=cwrThroughput, cwrRealPart=cwrRealPart, cwrAntennaEntry=cwrAntennaEntry, cwr1HrSevErroredSeconds=cwr1HrSevErroredSeconds, cwrPctSeverelyErroredSeconds=cwrPctSeverelyErroredSeconds, cwrOpStatus=cwrOpStatus, cwrSyncSuccessCount=cwrSyncSuccessCount, cwrBurstSize=cwrBurstSize, cwrThreshAntId=cwrThreshAntId, cwrAcquisitionMode=cwrAcquisitionMode, cwr1MinConsecSvCwErrSeconds=cwr1MinConsecSvCwErrSeconds, cwrSnapAttr1Id=cwrSnapAttr1Id, cwrUpdateRate=cwrUpdateRate, cwr1SecMetricsEntry=cwr1SecMetricsEntry, cwrAntennaIndex=cwrAntennaIndex, cwrPctEffectivePhyDataRate=cwrPctEffectivePhyDataRate, cwrRfTxOscState=cwrRfTxOscState, cwr1MinUpdateTime=cwr1MinUpdateTime, cwrTlStatus=cwrTlStatus, cwrThresholdEntry=cwrThresholdEntry, cwrTxFreqRangeMax=cwrTxFreqRangeMax, cwrHistToneValue=cwrHistToneValue, cwrSnapshotStatus=cwrSnapshotStatus, cwrArqBurstSize=cwrArqBurstSize, cwr1SecCorrectedSyncByteErrs=cwr1SecCorrectedSyncByteErrs, cwrRadioMetricsGroup=cwrRadioMetricsGroup, cwrComplianceRadioPhyByteErrGroup=cwrComplianceRadioPhyByteErrGroup, cwrSnapSummaryTable=cwrSnapSummaryTable, cwrRadioBasicCompliance=cwrRadioBasicCompliance, cwr1SecRxRrEventCount=cwr1SecRxRrEventCount, cwrLink1HrCSESAlarmThresh=cwrLink1HrCSESAlarmThresh, cwrTrapIfRxOsc=cwrTrapIfRxOsc, cwr1HrTotalCodewords=cwr1HrTotalCodewords, cwr1SecTxArqEventCount=cwr1SecTxArqEventCount, cwrThreshIndex=cwrThreshIndex, cwrTlPostTrigBufMgmt=cwrTlPostTrigBufMgmt, cwr24HrSevErroredSeconds=cwr24HrSevErroredSeconds, cwrRadioBaseGroup=cwrRadioBaseGroup, cwrImaginaryPart=cwrImaginaryPart, cwrLinkMetricsThreshEntry=cwrLinkMetricsThreshEntry, cwr24HrMetricsTable=cwr24HrMetricsTable, cwrTlSummaryEntry=cwrTlSummaryEntry, cwr24HrConsecSvErrSeconds=cwr24HrConsecSvErrSeconds, cwrTrapThresh=cwrTrapThresh, cwrLink24HrCSESAlarmThresh=cwrLink24HrCSESAlarmThresh, cwrRfTemperature=cwrRfTemperature, cwrUnAvailableSeconds=cwrUnAvailableSeconds, cwrLastSyncFailTime=cwrLastSyncFailTime, cwrSnapshotRowStatus=cwrSnapshotRowStatus, cwrComplianceHistoryGroup=cwrComplianceHistoryGroup, cwrTlCtrlTable=cwrTlCtrlTable, cwrLink24HrDCMAlarmThresh=cwrLink24HrDCMAlarmThresh, cwrLinkCSESThresh=cwrLinkCSESThresh, cwrRadioPhyQualityGroup=cwrRadioPhyQualityGroup, cwrHistRowStatus=cwrHistRowStatus, cwrHistMean=cwrHistMean, cwrHistBinIndex=cwrHistBinIndex, cwrTlToneSelection=cwrTlToneSelection, cwrHistBitShift=cwrHistBitShift, cwrTxFrequency=cwrTxFrequency, cwr1SecConsecutiveCwErrs=cwr1SecConsecutiveCwErrs, cwrTlCtrlEntry=cwrTlCtrlEntry, cwrTlIndex=cwrTlIndex, cwrDspNumber=cwrDspNumber, cwrComplianceRadioSnapshotGroup=cwrComplianceRadioSnapshotGroup, cwrTlDataEntry=cwrTlDataEntry, cwrCumulativeMetricsEntry=cwrCumulativeMetricsEntry, cwr1MinErrorFreeSeconds=cwr1MinErrorFreeSeconds, cwrAntennaYDim=cwrAntennaYDim, cwrBurstSizeGroup=cwrBurstSizeGroup, cwrComplianceRadioRfGroup=cwrComplianceRadioRfGroup, cwrLinkMetricsThresholdTable=cwrLinkMetricsThresholdTable, cwrArq3ByteErrs=cwrArq3ByteErrs, cwrStartBinValue=cwrStartBinValue, cwrHistCtrlTable=cwrHistCtrlTable, cwrScopePortAttribute=cwrScopePortAttribute, cwrRfStatus=cwrRfStatus, cwrHistStatus=cwrHistStatus, cwrIfInpFreq=cwrIfInpFreq, cwrThreshRowStatus=cwrThreshRowStatus, cwrLocalLoopbackPoint=cwrLocalLoopbackPoint, cwrComplianceRadioGroup=cwrComplianceRadioGroup, cwrLink1HrSESAlarmThresh=cwrLink1HrSESAlarmThresh, cwrRfControlChannelStatus=cwrRfControlChannelStatus, cwrSnapAttr3Size=cwrSnapAttr3Size, cwrIntFreqEntry=cwrIntFreqEntry, cwrSnapDataEntry=cwrSnapDataEntry, cwrRadioCommon=cwrRadioCommon, cwrRadioInternal=cwrRadioInternal, cwrRxFrequency=cwrRxFrequency, cwrComplianceRadioPhyQualityGroup=cwrComplianceRadioPhyQualityGroup, cwrTrapInitFailure=cwrTrapInitFailure, cwrTlNumDataValues=cwrTlNumDataValues, cwrTrapRfTxOsc=cwrTrapRfTxOsc, cwrAntennaXDim=cwrAntennaXDim, cwrComplianceReqLinkMetrics=cwrComplianceReqLinkMetrics, cwrComplianceRadioTestGroup=cwrComplianceRadioTestGroup, cwrTlDecimationFactor=cwrTlDecimationFactor, cwrIfRxOscState=cwrIfRxOscState, cwrMaxTxPower=cwrMaxTxPower, cwrLink24HrSESAlarmThresh=cwrLink24HrSESAlarmThresh, cwrCollDuration=cwrCollDuration, cwr1SecRxCodewords=cwr1SecRxCodewords, cwrLinkCwESThresh=cwrLinkCwESThresh, cwr1MinErroredCodewords=cwr1MinErroredCodewords, cwrHistMax=cwrHistMax, cwrArq1ByteErrs=cwrArq1ByteErrs, cwrPhyQualityEntry=cwrPhyQualityEntry, cwr24HrTotalErroredCodewords=cwr24HrTotalErroredCodewords, cwrNumRxAntenna=cwrNumRxAntenna, cwrRxFreqRangeMax=cwrRxFreqRangeMax, cwrCableLoss=cwrCableLoss, cwrHistSummaryEntry=cwrHistSummaryEntry, cwrSnapValueIndex=cwrSnapValueIndex, cwrHistPeriodicSum=cwrHistPeriodicSum, cwr24HrTotalCodewords=cwr24HrTotalCodewords, cwrPhyQualityTable=cwrPhyQualityTable, cwrTlAction=cwrTlAction, cwrRx1RfIndex=cwrRx1RfIndex, cwrRadioThreshTraps=cwrRadioThreshTraps, cwrAutomaticSyncLoss=cwrAutomaticSyncLoss, cwrOwnerId=cwrOwnerId, cwrTlRfResourceId=cwrTlRfResourceId, cwrTlThreshIndex=cwrTlThreshIndex, cwrRxFreqRangeMin=cwrRxFreqRangeMin, cwrAntennaPolarization=cwrAntennaPolarization, cwr1SecRSCodewordErrors=cwr1SecRSCodewordErrors, cwr1HrMetricsTable=cwr1HrMetricsTable, cwrThreshAttribute=cwrThreshAttribute, cwrHistMin=cwrHistMin, cwrHistIndex=cwrHistIndex, cwrRfTable=cwrRfTable, cwr1HrConsecSvErrSeconds=cwr1HrConsecSvErrSeconds, cwrTlRowStatus=cwrTlRowStatus, cwrRfIndex=cwrRfIndex, cwr1MinMetricsTable=cwr1MinMetricsTable, cwrRadioIfConformance=cwrRadioIfConformance, cwrAntAlignment=cwrAntAlignment, cwrLoopbackTable=cwrLoopbackTable, cwr24HrMetricsIndex=cwr24HrMetricsIndex, cwr1HrErrorFreeSeconds=cwr1HrErrorFreeSeconds, cwr24HrMetricsEntry=cwr24HrMetricsEntry, cwrRadioIfCompliances=cwrRadioIfCompliances, cwrThreshType=cwrThreshType, cwrThreshDspNum=cwrThreshDspNum, cwrRadioBaseTable=cwrRadioBaseTable, cwr24HrUpdateTime=cwr24HrUpdateTime, cwrArqPctBw=cwrArqPctBw, cwrSnapAttr2Id=cwrSnapAttr2Id, cwrArqReset=cwrArqReset, cwrTrapIfRefOsc=cwrTrapIfRefOsc, cwr1HrDegradedMinutes=cwr1HrDegradedMinutes, cwrRadioHistoryGroup=cwrRadioHistoryGroup, cwrClockRefExt=cwrClockRefExt, PYSNMP_MODULE_ID=ciscoWirelessIfMIB, cwrSnapshotDspNum=cwrSnapshotDspNum, cwrRx2RfIndex=cwrRx2RfIndex, cwr1HrErroredCodewords=cwr1HrErroredCodewords, cwrCumulativeMetricsTable=cwrCumulativeMetricsTable, cwrRfSupplyVoltageState=cwrRfSupplyVoltageState, cwrIntFreqTable=cwrIntFreqTable, cwrTlToneValue=cwrTlToneValue, cwrTrapLinkQuality=cwrTrapLinkQuality, cwrRfEntry=cwrRfEntry, cwrSnapshotType=cwrSnapshotType, cwrRadioNotification=cwrRadioNotification, cwrThreshValue=cwrThreshValue, cwrAntennaTable=cwrAntennaTable, cwrTrapRfRxOsc=cwrTrapRfRxOsc, cwrArqVoiceLatency=cwrArqVoiceLatency, cwrPctAvailSeconds=cwrPctAvailSeconds, cwrRfAntIndex=cwrRfAntIndex, cwrSyncLossSeconds=cwrSyncLossSeconds, cwrTlTriggerLoc=cwrTlTriggerLoc, cwrArqDataLatency=cwrArqDataLatency, cwrNumHistBins=cwrNumHistBins, cwrLoopbackEntry=cwrLoopbackEntry, cwrSnapDataTable=cwrSnapDataTable, cwrComplianceRadioTlGroup=cwrComplianceRadioTlGroup, cwrTlValueIndex=cwrTlValueIndex, cwrTlSummaryTable=cwrTlSummaryTable, cwrRadioAntennaGroup=cwrRadioAntennaGroup, cwrHistAction=cwrHistAction, ciscoWirelessIfMIB=ciscoWirelessIfMIB, cwrTxFreqRangeMin=cwrTxFreqRangeMin, cwrRadioBaseEntry=cwrRadioBaseEntry, cwrRadioLatestTrap=cwrRadioLatestTrap, cwrTlPreSumShift=cwrTlPreSumShift, cwr24HrDegradedMinutes=cwr24HrDegradedMinutes, cwr1MinDegradedSeconds=cwr1MinDegradedSeconds, cwrArq5ByteErrs=cwrArq5ByteErrs, cwrAntennaGain=cwrAntennaGain, cwrLink1HrDCMAlarmThresh=cwrLink1HrDCMAlarmThresh, cwrLinkHighCwDSThresh=cwrLinkHighCwDSThresh, cwrThreshHysteresisTime=cwrThreshHysteresisTime, cwr1MinSevErroredSeconds=cwr1MinSevErroredSeconds, cwr1HrMetricsEntry=cwr1HrMetricsEntry, cwrTlDspNum=cwrTlDspNum, cwrRadioNextIndex=cwrRadioNextIndex, cwr24HrErrorFreeSeconds=cwr24HrErrorFreeSeconds, cwrSnapshotCtrlEntry=cwrSnapshotCtrlEntry, cwrRadioPhyEntry=cwrRadioPhyEntry, cwrScopePortOn=cwrScopePortOn, cwrTrapConfigMismatch=cwrTrapConfigMismatch, cwrScopePortEntry=cwrScopePortEntry, cwrSnapAttr3Id=cwrSnapAttr3Id, cwrLink24HrESAlarmThresh=cwrLink24HrESAlarmThresh, cwrHistDataTable=cwrHistDataTable, cwr24HrErroredSeconds=cwr24HrErroredSeconds, cwrSelfTest=cwrSelfTest, cwr1SecArqCodewordErrors=cwr1SecArqCodewordErrors, cwrSnapAttr1Size=cwrSnapAttr1Size, cwr1MinCodewords=cwr1MinCodewords, cwrRadioTrapTable=cwrRadioTrapTable, cwrRadioSnapshotGroup=cwrRadioSnapshotGroup, cwrTrapRfStatusChange=cwrTrapRfStatusChange, cwrRfResourceId=cwrRfResourceId, cwrSnapSummaryEntry=cwrSnapSummaryEntry, cwr1SecIndex=cwr1SecIndex, cwrSnapAttr2Size=cwrSnapAttr2Size, cwrRadioTrapEntry=cwrRadioTrapEntry, cwrComplianceRadioAntennaGroup=cwrComplianceRadioAntennaGroup, cwrPctCwDegradedMinutes=cwrPctCwDegradedMinutes, cwrIfTxOscState=cwrIfTxOscState, cwr1SecRxRrCount=cwr1SecRxRrCount, cwrSnapAttr4Size=cwrSnapAttr4Size, cwrRadioTimelineGroup=cwrRadioTimelineGroup, cwrIfResIndex=cwrIfResIndex, cwrArq7ByteErrs=cwrArq7ByteErrs, cwrBinDelta=cwrBinDelta, cwrPhyCorrectedBytesTable=cwrPhyCorrectedBytesTable, cwrTxPower=cwrTxPower, cwrHistUpdateTime=cwrHistUpdateTime, cwrLastSyncSuccessTime=cwrLastSyncSuccessTime, cwrValue=cwrValue, cwrEffectivePhyDataRate=cwrEffectivePhyDataRate, cwrArqMaxLatencyJitter=cwrArqMaxLatencyJitter, cwrBandwidth=cwrBandwidth, cwrArqMinBitRate=cwrArqMinBitRate, cwrArqTypicalBitRate=cwrArqTypicalBitRate, cwrIfRefOscState=cwrIfRefOscState, cwrSyncFailureCount=cwrSyncFailureCount, cwrLinkLowCwDSThresh=cwrLinkLowCwDSThresh)
mibBuilder.exportSymbols("CISCO-WIRELESS-IF-MIB", cwr1SecUpdateTime=cwr1SecUpdateTime, cwrTlValue=cwrTlValue, cwr1MinMetricsIndex=cwr1MinMetricsIndex, cwrCableLossDiversity=cwrCableLossDiversity, cwrIfOutFreq=cwrIfOutFreq, cwrArq8ByteErrs=cwrArq8ByteErrs, cwrTlDataTable=cwrTlDataTable, cwrPhyCorrectedBytesEntry=cwrPhyCorrectedBytesEntry, cwrThresholdTable=cwrThresholdTable, cwrArqOn=cwrArqOn, cwrArq6ByteErrs=cwrArq6ByteErrs, cwrRadioPhyTable=cwrRadioPhyTable, cwrTrapReason=cwrTrapReason, cwrHistToneSelection=cwrHistToneSelection, cwrAntennaType=cwrAntennaType, cwrTrapLinkSyncAcquired=cwrTrapLinkSyncAcquired, cwrTrapRfTemp=cwrTrapRfTemp, cwr1HrMetricsIndex=cwr1HrMetricsIndex, cwrRadioFreqResGroup=cwrRadioFreqResGroup, cwrHistClass=cwrHistClass, cwrTestGroup=cwrTestGroup, cwrMinTxPower=cwrMinTxPower, cwrHistSummaryTable=cwrHistSummaryTable, cwr1MinErroredSeconds=cwr1MinErroredSeconds, cwrTlUpdateTime=cwrTlUpdateTime, cwrPctErroredSeconds=cwrPctErroredSeconds, cwrTrapIfTxOsc=cwrTrapIfTxOsc, cwrSnapshotCtrlTable=cwrSnapshotCtrlTable, cwrSnapAttr4Id=cwrSnapAttr4Id, cwrAntennaDescr=cwrAntennaDescr, cwrRfRxOscState=cwrRfRxOscState, cwrRadioDevTraps=cwrRadioDevTraps, cwrArq4ByteErrs=cwrArq4ByteErrs, cwrTxRfIndex=cwrTxRfIndex, cwrRadioMibObjects=cwrRadioMibObjects, cwrHistCtrlEntry=cwrHistCtrlEntry, cwr1HrUpdateTime=cwr1HrUpdateTime, cwrRadioIfGroups=cwrRadioIfGroups, cwrTrapLink24HrThresh=cwrTrapLink24HrThresh, cwrManagedSyncLoss=cwrManagedSyncLoss, cwrHistDataEntry=cwrHistDataEntry, cwrRFOpMode=cwrRFOpMode, cwrBasePrivacySupport=cwrBasePrivacySupport, cwrTrapLink1HrThresh=cwrTrapLink1HrThresh, cwr1SecMetricsTable=cwr1SecMetricsTable, cwrScopePortDsp=cwrScopePortDsp, cwrLink1HrESAlarmThresh=cwrLink1HrESAlarmThresh, cwrScopePortTable=cwrScopePortTable, cwrTlClass=cwrTlClass, cwr1HrErroredSeconds=cwr1HrErroredSeconds, cwrOperatingBand=cwrOperatingBand, cwrSnapshotAction=cwrSnapshotAction, cwrRfResIndex=cwrRfResIndex, cwrThreshLimitTime=cwrThreshLimitTime)
