...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-WIRELESS-IF-MIB
...
CwrOscState, CwrCollectionAction, CwrCwDegradedSecond, CwrCollectionStatus, CwrRadioSignalAttribute, CwrCwSeverelyErroredSecond, CwrCwErroredSecond, CwrThreshLimitType, CwrCwDegradedMinute, CwrCwConsecutiveSevErrSecond, WirelessGauge64, CwrCwErrorFreeSecond, CwrRFZeroIndex = mibBuilder.importSymbols("CISCO-WIRELESS-TC-MIB", "CwrOscState", "CwrCollectionAction", "CwrCwDegradedSecond", "CwrCollectionStatus", "CwrRadioSignalAttribute", "CwrCwSeverelyErroredSecond", "CwrCwErroredSecond", "CwrThreshLimitType", "CwrCwDegradedMinute", "CwrCwConsecutiveSevErrSecond", "WirelessGauge64", "CwrCwErrorFreeSecond", "CwrRFZeroIndex")
...
mibBuilder.exportSymbols("CISCO-WIRELESS-IF-MIB", cwr1MinConsecSvCwErrSeconds=cwr1MinConsecSvCwErrSeconds, cwrLastSyncFailTime=cwrLastSyncFailTime, cwrRxFreqRangeMax=cwrRxFreqRangeMax, cwrAntennaPolarization=cwrAntennaPolarization, cwrTrapLink1HrThresh=cwrTrapLink1HrThresh, cwr1MinCodewords=cwr1MinCodewords, cwrTlNumValues=cwrTlNumValues, cwr1SecRxCodewords=cwr1SecRxCodewords, cwrRfControlChannelStatus=cwrRfControlChannelStatus, cwrSnapAttr2Size=cwrSnapAttr2Size, cwrArqTypicalBitRate=cwrArqTypicalBitRate, cwrTlToneValue=cwrTlToneValue, cwrPhyQualityEntry=cwrPhyQualityEntry, cwrThreshIndex=cwrThreshIndex, cwr1HrMetricsEntry=cwr1HrMetricsEntry, cwrTlDataEntry=cwrTlDataEntry, cwrRadioBaseTable=cwrRadioBaseTable, cwrRfTable=cwrRfTable, cwr24HrUpdateTime=cwr24HrUpdateTime, cwrHistDataTable=cwrHistDataTable, cwrTrapThresh=cwrTrapThresh, cwrHistDataEntry=cwrHistDataEntry, cwrLink1HrSESAlarmThresh=cwrLink1HrSESAlarmThresh, cwr1SecTxArqEventCount=cwr1SecTxArqEventCount, cwr24HrDegradedMinutes=cwr24HrDegradedMinutes, cwrSyncSuccessCount=cwrSyncSuccessCount, cwrIntFreqTable=cwrIntFreqTable, cwrCableLoss=cwrCableLoss, cwrThreshValue=cwrThreshValue, cwr1MinErroredSeconds=cwr1MinErroredSeconds, cwrArq4ByteErrs=cwrArq4ByteErrs, cwrSyncLossSeconds=cwrSyncLossSeconds, cwrHistMax=cwrHistMax, cwr1MinErroredCodewords=cwr1MinErroredCodewords, cwrArq9ByteErrs=cwrArq9ByteErrs, cwrSnapshotCtrlTable=cwrSnapshotCtrlTable, cwrBinDelta=cwrBinDelta, cwrScopePortAttribute=cwrScopePortAttribute, cwrRadioTrapEntry=cwrRadioTrapEntry, cwrSyncFailureCount=cwrSyncFailureCount, cwrRfSupplyVoltageState=cwrRfSupplyVoltageState, cwrPctEffectivePhyDataRate=cwrPctEffectivePhyDataRate, cwrHistPeriodicSum=cwrHistPeriodicSum, cwrComplianceReqLinkMetrics=cwrComplianceReqLinkMetrics, cwr1SecIndex=cwr1SecIndex, cwrLocalLoopbackPoint=cwrLocalLoopbackPoint, cwrArqOn=cwrArqOn, cwr1MinMetricsTable=cwr1MinMetricsTable, cwrRadioHistoryGroup=cwrRadioHistoryGroup, cwrSnapSummaryEntry=cwrSnapSummaryEntry, cwr1HrMetricsIndex=cwr1HrMetricsIndex, cwrSnapAttr4Size=cwrSnapAttr4Size, cwrArqDataLatency=cwrArqDataLatency, cwrIntFreqEntry=cwrIntFreqEntry, cwrRadioCommon=cwrRadioCommon, cwrTrapLinkSyncAcquired=cwrTrapLinkSyncAcquired, cwr1SecTxArqCount=cwr1SecTxArqCount, cwrRfIndex=cwrRfIndex, cwrRfTemperature=cwrRfTemperature, cwrTxPower=cwrTxPower, cwrUnAvailableSeconds=cwrUnAvailableSeconds, cwrPctSeverelyErroredSeconds=cwrPctSeverelyErroredSeconds, cwrComplianceNotifGroup=cwrComplianceNotifGroup, cwrLoopbackEntry=cwrLoopbackEntry, cwrLastSyncSuccessTime=cwrLastSyncSuccessTime, cwrAntennaDescr=cwrAntennaDescr, cwrMaxTxPower=cwrMaxTxPower, cwrRadioTimelineGroup=cwrRadioTimelineGroup, cwrRfResIndex=cwrRfResIndex, cwrIfInpFreq=cwrIfInpFreq, cwr24HrSevErroredSeconds=cwr24HrSevErroredSeconds, cwrRadioInternal=cwrRadioInternal, cwrThreshRowStatus=cwrThreshRowStatus, cwr1HrErroredCodewords=cwr1HrErroredCodewords, cwrComplianceRadioTlGroup=cwrComplianceRadioTlGroup, cwrMinTxPower=cwrMinTxPower, cwrTlCtrlTable=cwrTlCtrlTable, cwrTlValue=cwrTlValue, cwr1SecRSCodewordErrors=cwr1SecRSCodewordErrors, cwrSnapshotAction=cwrSnapshotAction, cwrRfRxOscState=cwrRfRxOscState, cwrHistCtrlEntry=cwrHistCtrlEntry, cwrPctAvailSeconds=cwrPctAvailSeconds, cwrHistUpdateTime=cwrHistUpdateTime, cwrRFOpMode=cwrRFOpMode, cwrComplianceRadioSnapshotGroup=cwrComplianceRadioSnapshotGroup, cwrTrapRfStatusChange=cwrTrapRfStatusChange, cwrAntennaTable=cwrAntennaTable, cwrArq2ByteErrs=cwrArq2ByteErrs, cwrTrapRfTxOsc=cwrTrapRfTxOsc, cwrIfOutFreq=cwrIfOutFreq, cwrIfRefOscState=cwrIfRefOscState, cwrBandwidth=cwrBandwidth, cwrTlAction=cwrTlAction, cwrTestGroup=cwrTestGroup, cwrLink24HrCSESAlarmThresh=cwrLink24HrCSESAlarmThresh, cwrRadioDevTraps=cwrRadioDevTraps, cwr1SecArqCodewordErrors=cwr1SecArqCodewordErrors, cwrNumRxAntenna=cwrNumRxAntenna, cwrTlPostTrigBufMgmt=cwrTlPostTrigBufMgmt, cwrOpStatus=cwrOpStatus, cwrHistMin=cwrHistMin, cwrTlSummaryEntry=cwrTlSummaryEntry, cwrIfResIndex=cwrIfResIndex, cwr24HrMetricsEntry=cwr24HrMetricsEntry, cwr1HrConsecSvErrSeconds=cwr1HrConsecSvErrSeconds, PYSNMP_MODULE_ID=ciscoWirelessIfMIB, cwrHistToneValue=cwrHistToneValue, cwrOperatingBand=cwrOperatingBand, cwrRadioBaseGroup=cwrRadioBaseGroup, cwrAntennaEntry=cwrAntennaEntry, cwrTrapReason=cwrTrapReason, cwrAntennaYDim=cwrAntennaYDim, cwrTxFreqRangeMin=cwrTxFreqRangeMin, cwrLoopbackTable=cwrLoopbackTable, cwr1SecMetricsTable=cwr1SecMetricsTable, cwrSnapshotType=cwrSnapshotType, cwrTlPreSumShift=cwrTlPreSumShift, cwr24HrMetricsIndex=cwr24HrMetricsIndex, cwrRxFrequency=cwrRxFrequency, cwrArqBurstSize=cwrArqBurstSize, cwrAutomaticSyncLoss=cwrAutomaticSyncLoss, cwrTlDecimationFactor=cwrTlDecimationFactor, cwrLinkMetricsThresholdTable=cwrLinkMetricsThresholdTable, cwrRfAntIndex=cwrRfAntIndex, cwrLinkMetricsThreshEntry=cwrLinkMetricsThreshEntry, cwrSnapValueIndex=cwrSnapValueIndex, cwrThreshType=cwrThreshType, cwr1SecCorrectedSyncByteErrs=cwr1SecCorrectedSyncByteErrs, cwrLink24HrESAlarmThresh=cwrLink24HrESAlarmThresh, cwrManagedSyncLoss=cwrManagedSyncLoss, cwrArq7ByteErrs=cwrArq7ByteErrs, cwrSnapAttr3Size=cwrSnapAttr3Size, cwrAntAlignment=cwrAntAlignment, cwrClockRefExt=cwrClockRefExt, cwrLink24HrSESAlarmThresh=cwrLink24HrSESAlarmThresh, cwrComplianceRadioAntennaGroup=cwrComplianceRadioAntennaGroup, cwrTlNumDataValues=cwrTlNumDataValues, cwrRadioPhyTable=cwrRadioPhyTable, cwrTrapRfTemp=cwrTrapRfTemp, cwrTlThreshIndex=cwrTlThreshIndex, cwrRfStatus=cwrRfStatus, cwrPctErroredSeconds=cwrPctErroredSeconds, cwrTrapLinkSyncLost=cwrTrapLinkSyncLost, cwrRadioIfCompliances=cwrRadioIfCompliances, cwrTrapRfSupplyVoltage=cwrTrapRfSupplyVoltage, cwrAntennaGain=cwrAntennaGain, cwrRadioPhyEntry=cwrRadioPhyEntry, cwrRx2RfIndex=cwrRx2RfIndex, cwrHistMean=cwrHistMean, cwrArqReset=cwrArqReset, cwrRadioPhyQualityGroup=cwrRadioPhyQualityGroup, cwrTrapConfigMismatch=cwrTrapConfigMismatch, cwrTrapIfTxOsc=cwrTrapIfTxOsc, cwrAntennaType=cwrAntennaType, cwrTlToneSelection=cwrTlToneSelection, cwrSnapSummaryTable=cwrSnapSummaryTable, cwrAvailableSeconds=cwrAvailableSeconds, cwr1SecPostARQGoodCodewords=cwr1SecPostARQGoodCodewords, cwrEffectivePhyDataRate=cwrEffectivePhyDataRate, cwrSnapshotStatus=cwrSnapshotStatus, cwrComplianceHistoryGroup=cwrComplianceHistoryGroup, cwrRfResourceId=cwrRfResourceId, cwrThreshAntId=cwrThreshAntId, cwrTxRfIndex=cwrTxRfIndex, cwrHistSummaryEntry=cwrHistSummaryEntry, cwrSelfTest=cwrSelfTest, cwr1SecRxRrEventCount=cwr1SecRxRrEventCount, cwr1SecRxRrCount=cwr1SecRxRrCount, cwrRadioNotification=cwrRadioNotification, cwr1HrDegradedMinutes=cwr1HrDegradedMinutes, cwrValue=cwrValue, cwrRadioThreshTraps=cwrRadioThreshTraps, cwrSnapAttr1Size=cwrSnapAttr1Size, cwrRadioTrapTable=cwrRadioTrapTable, cwrRadioAntennaGroup=cwrRadioAntennaGroup, cwrStartBinValue=cwrStartBinValue, cwrTrapLinkQuality=cwrTrapLinkQuality, cwrImaginaryPart=cwrImaginaryPart, cwrTlValueIndex=cwrTlValueIndex, cwrSnapDataEntry=cwrSnapDataEntry, cwrIfTxOscState=cwrIfTxOscState, cwrSnapAttr3Id=cwrSnapAttr3Id, cwrRxFreqRangeMin=cwrRxFreqRangeMin, cwrThreshDspNum=cwrThreshDspNum, cwrArq5ByteErrs=cwrArq5ByteErrs, cwrArq6ByteErrs=cwrArq6ByteErrs, cwrLink1HrCSESAlarmThresh=cwrLink1HrCSESAlarmThresh, cwrHistClass=cwrHistClass, cwrThreshAttribute=cwrThreshAttribute, cwrTrapIfRefOsc=cwrTrapIfRefOsc, cwrComplianceRadioTestGroup=cwrComplianceRadioTestGroup, cwrPhyQualityTable=cwrPhyQualityTable, cwrAntennaIndex=cwrAntennaIndex, cwrComplianceRadioPhyQualityGroup=cwrComplianceRadioPhyQualityGroup, cwr24HrConsecSvErrSeconds=cwr24HrConsecSvErrSeconds, cwr24HrErrorFreeSeconds=cwr24HrErrorFreeSeconds, cwrTlTriggerLoc=cwrTlTriggerLoc, cwrScopePortOn=cwrScopePortOn, cwrTlRowStatus=cwrTlRowStatus, cwrDspNumber=cwrDspNumber, cwrTxFrequency=cwrTxFrequency, cwrCumulativeMetricsTable=cwrCumulativeMetricsTable, cwr1MinMetricsIndex=cwr1MinMetricsIndex, cwrHistAction=cwrHistAction, cwrTrapIfRxOsc=cwrTrapIfRxOsc, cwrCableLossDiversity=cwrCableLossDiversity, cwrTrapInitFailure=cwrTrapInitFailure, cwrArq1ByteErrs=cwrArq1ByteErrs, cwr24HrTotalCodewords=cwr24HrTotalCodewords, cwrRadioBasicCompliance=cwrRadioBasicCompliance, cwrLink24HrDCMAlarmThresh=cwrLink24HrDCMAlarmThresh, cwrTlRfResourceId=cwrTlRfResourceId, cwrIfRxOscState=cwrIfRxOscState, cwrHistBinIndex=cwrHistBinIndex, cwrCumulativeMetricsEntry=cwrCumulativeMetricsEntry, cwrOwnerId=cwrOwnerId, cwrLink1HrDCMAlarmThresh=cwrLink1HrDCMAlarmThresh, cwrSnapshotRowStatus=cwrSnapshotRowStatus, cwrRadioMibObjects=cwrRadioMibObjects, cwrArq8ByteErrs=cwrArq8ByteErrs, cwrTlDspNum=cwrTlDspNum, cwrComplianceRadioRfGroup=cwrComplianceRadioRfGroup, cwr1HrTotalCodewords=cwr1HrTotalCodewords, cwrRadioSnapshotGroup=cwrRadioSnapshotGroup, cwrRfEntry=cwrRfEntry, cwrTrapLink24HrThresh=cwrTrapLink24HrThresh, cwrRx1RfIndex=cwrRx1RfIndex, cwrHistBitShift=cwrHistBitShift, cwrSnapAttr4Id=cwrSnapAttr4Id, cwr1SecConsecutiveCwErrs=cwr1SecConsecutiveCwErrs, cwrNumHistBins=cwrNumHistBins, cwrAntennaXDim=cwrAntennaXDim, cwr24HrTotalErroredCodewords=cwr24HrTotalErroredCodewords, cwrLinkLowCwDSThresh=cwrLinkLowCwDSThresh, cwrSnapshotCtrlEntry=cwrSnapshotCtrlEntry, cwrArqPctBw=cwrArqPctBw, cwrRadioFreqResGroup=cwrRadioFreqResGroup, cwrRfTxOscState=cwrRfTxOscState, cwrBurstSizeGroup=cwrBurstSizeGroup, cwrHistStatus=cwrHistStatus, cwrRadioIfConformance=cwrRadioIfConformance, cwr1SecMetricsEntry=cwr1SecMetricsEntry, cwrHistCtrlTable=cwrHistCtrlTable, cwrThreshHysteresisTime=cwrThreshHysteresisTime, cwrScopePortDsp=cwrScopePortDsp, cwrComplianceRadioPhyByteErrGroup=cwrComplianceRadioPhyByteErrGroup, cwr1MinMetricsEntry=cwr1MinMetricsEntry, cwrComplianceRadioGroup=cwrComplianceRadioGroup, cwrLink1HrESAlarmThresh=cwrLink1HrESAlarmThresh, cwrTlStatus=cwrTlStatus, cwrArq3ByteErrs=cwrArq3ByteErrs, cwrSnapAttr2Id=cwrSnapAttr2Id, cwrThroughput=cwrThroughput)
mibBuilder.exportSymbols("CISCO-WIRELESS-IF-MIB", cwr24HrErroredSeconds=cwr24HrErroredSeconds, cwrTlCtrlEntry=cwrTlCtrlEntry, cwrPctErrorFreeSeconds=cwrPctErrorFreeSeconds, cwrThreshLimitTime=cwrThreshLimitTime, cwrHistSummaryTable=cwrHistSummaryTable, cwrTlClass=cwrTlClass, cwrArqMaxLatencyJitter=cwrArqMaxLatencyJitter, cwr1MinDegradedSeconds=cwr1MinDegradedSeconds, cwr1HrUpdateTime=cwr1HrUpdateTime, cwrLinkCwESThresh=cwrLinkCwESThresh, cwrHistRowStatus=cwrHistRowStatus, cwrScopePortEntry=cwrScopePortEntry, cwrCollDuration=cwrCollDuration, cwrLinkHighCwDSThresh=cwrLinkHighCwDSThresh, cwrRadioMetricsGroup=cwrRadioMetricsGroup, cwrRadioBaseEntry=cwrRadioBaseEntry, cwrTxFreqRangeMax=cwrTxFreqRangeMax, cwr1HrErroredSeconds=cwr1HrErroredSeconds, cwrRadioNextIndex=cwrRadioNextIndex, cwrBurstSize=cwrBurstSize, cwr1HrErrorFreeSeconds=cwr1HrErrorFreeSeconds, cwrTrapRfRxOsc=cwrTrapRfRxOsc, cwrTlDataTable=cwrTlDataTable, cwrArqVoiceLatency=cwrArqVoiceLatency, cwrArqMinBitRate=cwrArqMinBitRate, cwrRadioIfGroups=cwrRadioIfGroups, ciscoWirelessIfMIB=ciscoWirelessIfMIB, cwr1MinErrorFreeSeconds=cwr1MinErrorFreeSeconds, cwrHistToneSelection=cwrHistToneSelection, cwr24HrMetricsTable=cwr24HrMetricsTable, cwr1HrMetricsTable=cwr1HrMetricsTable, cwrBasePrivacySupport=cwrBasePrivacySupport, cwrRadioLatestTrap=cwrRadioLatestTrap, cwr1HrSevErroredSeconds=cwr1HrSevErroredSeconds, cwrPhyCorrectedBytesEntry=cwrPhyCorrectedBytesEntry, cwrScopePortTable=cwrScopePortTable, cwrRealPart=cwrRealPart, cwrPhyCorrectedBytesTable=cwrPhyCorrectedBytesTable, cwrPctCwDegradedMinutes=cwrPctCwDegradedMinutes, cwr1SecUpdateTime=cwr1SecUpdateTime, cwrSnapshotDspNum=cwrSnapshotDspNum, cwrThresholdEntry=cwrThresholdEntry, cwrHistIndex=cwrHistIndex, cwrTlUpdateTime=cwrTlUpdateTime, cwrLinkCSESThresh=cwrLinkCSESThresh, cwrSnapAttr1Id=cwrSnapAttr1Id, cwrTlSummaryTable=cwrTlSummaryTable, cwrSnapDataTable=cwrSnapDataTable, cwrAcquisitionMode=cwrAcquisitionMode, cwr1MinUpdateTime=cwr1MinUpdateTime, cwrThresholdTable=cwrThresholdTable, cwr1MinSevErroredSeconds=cwr1MinSevErroredSeconds, cwrTlIndex=cwrTlIndex, cwrUpdateRate=cwrUpdateRate)
