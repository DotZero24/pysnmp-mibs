...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-ADDRESS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:34:55 2025
...
myAddressMIBCompliance.setObjects(
      *(("MY-ADDRESS-MIB", "myMacAddressMIBGroup"),
        ("MY-ADDRESS-MIB", "myAddressNotificationMIBGroup"))
)
if mibBuilder.loadTexts:
