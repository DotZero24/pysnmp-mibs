...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-DEVICE-IF-MIB
...
alvarionDeviceIfMIBCompliance.setObjects(
      *(("ALVARION-DEVICE-IF-MIB", "alvarionDeviceIfStatusMIBGroup"),
        ("ALVARION-DEVICE-IF-MIB", "alvarionDeviceIfStatsMIBGroup"))
)
if mibBuilder.loadTexts:
