...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WIRELESS-DOCS-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:22 2025
...
_CwdIfQosProfMaxTxBurst_Type.__name__ = "Integer32"
...
_CwdIfQosProfBaselinePrivacy_Type.__name__ = "TruthValue"
...
_CwdIfSuRangingRespTimeout_Type.__name__ = "TimeInterval"
...
cwdIfBasicCompliance.setObjects(
      *(("CISCO-WIRELESS-DOCS-IF-MIB", "cwdIfBasicGroup"),
        ("CISCO-WIRELESS-DOCS-IF-MIB", "cwdIfSuGroup"),
        ("CISCO-WIRELESS-DOCS-IF-MIB", "cwdIfHeGroup"),
        ("CISCO-WIRELESS-DOCS-IF-MIB", "cwdIfQosGroup"),
        ("CISCO-WIRELESS-DOCS-IF-MIB", "cwdIfQosHeGroup"),
        ("CISCO-WIRELESS-DOCS-IF-MIB", "cwdIfModGroup"))
)
if mibBuilder.loadTexts:
