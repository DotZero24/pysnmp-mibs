...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-MLD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:52:57 2025
...
class _VRtrMldGenGrpIfQrySrcIpAddrType_Type(InetAddressType):
    """Custom type vRtrMldGenGrpIfQrySrcIpAddrType based on InetAddressType"""
    defaultValue = 0


_VRtrMldGenGrpIfQrySrcIpAddrType_Type.__name__ = "InetAddressType"
...
if mibBuilder.loadTexts:
    vRtrMldIfMcacUnconstrainedBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldIfMcacPreRsvdMandBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldIfMcacinUseMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldIfMcacinUseOpnlBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldIfMcacAvailMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldIfMcacAvailOpnlBw.setUnits("kilobps")
...
class _VRtrMldIfMcacIfPolicyName_Type(TPolicyStatementNameOrEmpty):
    """Custom type vRtrMldIfMcacIfPolicyName based on TPolicyStatementNameOrEmpty"""
    defaultValue = OctetString("")


_VRtrMldIfMcacIfPolicyName_Type.__name__ = "TPolicyStatementNameOrEmpty"
_VRtrMldIfMcacIfPolicyName_Object = MibTableColumn
vRtrMldIfMcacIfPolicyName = _VRtrMldIfMcacIfPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 2, 1, 32),
    _VRtrMldIfMcacIfPolicyName_Type()
)
vRtrMldIfMcacIfPolicyName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrMldIfMcacIfPolicyName.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrMldIfMcacLevelBW.setUnits("kilobps")
...
_VRtrMldIfSGrpRangeSrcTblLstChgd_Type = TimeStamp
_VRtrMldIfSGrpRangeSrcTblLstChgd_Object = MibScalar
vRtrMldIfSGrpRangeSrcTblLstChgd = _VRtrMldIfSGrpRangeSrcTblLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 12),
    _VRtrMldIfSGrpRangeSrcTblLstChgd_Type()
)
vRtrMldIfSGrpRangeSrcTblLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeSrcTblLstChgd.setStatus("current")
_VRtrMldIfSGrpRangeSrcTable_Object = MibTable
vRtrMldIfSGrpRangeSrcTable = _VRtrMldIfSGrpRangeSrcTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13)
)
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeSrcTable.setStatus("current")
_VRtrMldIfSGrpRangeSrcEntry_Object = MibTableRow
vRtrMldIfSGrpRangeSrcEntry = _VRtrMldIfSGrpRangeSrcEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1)
)
vRtrMldIfSGrpRangeSrcEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-VRTR-MIB", "vRtrIfIndex"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeStartAddrType"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeStartAddr"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeEndAddrType"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeEndAddr"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeStepAddrType"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeStepAddr"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeSrcAddrType"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeSrcAddr"),
)
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeSrcEntry.setStatus("current")
_VRtrMldIfSGrpRangeStartAddrType_Type = InetAddressType
_VRtrMldIfSGrpRangeStartAddrType_Object = MibTableColumn
vRtrMldIfSGrpRangeStartAddrType = _VRtrMldIfSGrpRangeStartAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 1),
    _VRtrMldIfSGrpRangeStartAddrType_Type()
)
vRtrMldIfSGrpRangeStartAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeStartAddrType.setStatus("current")


class _VRtrMldIfSGrpRangeStartAddr_Type(InetAddress):
    """Custom type vRtrMldIfSGrpRangeStartAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(16, 16),
    )
...
_VRtrMldIfSGrpRangeStartAddr_Type.__name__ = "InetAddress"
_VRtrMldIfSGrpRangeStartAddr_Object = MibTableColumn
vRtrMldIfSGrpRangeStartAddr = _VRtrMldIfSGrpRangeStartAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 2),
    _VRtrMldIfSGrpRangeStartAddr_Type()
)
vRtrMldIfSGrpRangeStartAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeStartAddr.setStatus("current")
_VRtrMldIfSGrpRangeEndAddrType_Type = InetAddressType
_VRtrMldIfSGrpRangeEndAddrType_Object = MibTableColumn
vRtrMldIfSGrpRangeEndAddrType = _VRtrMldIfSGrpRangeEndAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 3),
    _VRtrMldIfSGrpRangeEndAddrType_Type()
)
vRtrMldIfSGrpRangeEndAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeEndAddrType.setStatus("current")


class _VRtrMldIfSGrpRangeEndAddr_Type(InetAddress):
    """Custom type vRtrMldIfSGrpRangeEndAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(16, 16),
    )
...
_VRtrMldIfSGrpRangeEndAddr_Type.__name__ = "InetAddress"
_VRtrMldIfSGrpRangeEndAddr_Object = MibTableColumn
vRtrMldIfSGrpRangeEndAddr = _VRtrMldIfSGrpRangeEndAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 4),
    _VRtrMldIfSGrpRangeEndAddr_Type()
)
vRtrMldIfSGrpRangeEndAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeEndAddr.setStatus("current")
_VRtrMldIfSGrpRangeStepAddrType_Type = InetAddressType
_VRtrMldIfSGrpRangeStepAddrType_Object = MibTableColumn
vRtrMldIfSGrpRangeStepAddrType = _VRtrMldIfSGrpRangeStepAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 5),
    _VRtrMldIfSGrpRangeStepAddrType_Type()
)
vRtrMldIfSGrpRangeStepAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeStepAddrType.setStatus("current")


class _VRtrMldIfSGrpRangeStepAddr_Type(InetAddress):
    """Custom type vRtrMldIfSGrpRangeStepAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(16, 16),
    )
...
_VRtrMldIfSGrpRangeStepAddr_Type.__name__ = "InetAddress"
_VRtrMldIfSGrpRangeStepAddr_Object = MibTableColumn
vRtrMldIfSGrpRangeStepAddr = _VRtrMldIfSGrpRangeStepAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 6),
    _VRtrMldIfSGrpRangeStepAddr_Type()
)
vRtrMldIfSGrpRangeStepAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeStepAddr.setStatus("current")
_VRtrMldIfSGrpRangeSrcAddrType_Type = InetAddressType
_VRtrMldIfSGrpRangeSrcAddrType_Object = MibTableColumn
vRtrMldIfSGrpRangeSrcAddrType = _VRtrMldIfSGrpRangeSrcAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 7),
    _VRtrMldIfSGrpRangeSrcAddrType_Type()
)
vRtrMldIfSGrpRangeSrcAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeSrcAddrType.setStatus("current")


class _VRtrMldIfSGrpRangeSrcAddr_Type(InetAddress):
    """Custom type vRtrMldIfSGrpRangeSrcAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(16, 16),
    )
...
_VRtrMldIfSGrpRangeSrcAddr_Type.__name__ = "InetAddress"
_VRtrMldIfSGrpRangeSrcAddr_Object = MibTableColumn
vRtrMldIfSGrpRangeSrcAddr = _VRtrMldIfSGrpRangeSrcAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 8),
    _VRtrMldIfSGrpRangeSrcAddr_Type()
)
vRtrMldIfSGrpRangeSrcAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeSrcAddr.setStatus("current")
_VRtrMldIfSGrpRangeSrcRowStatus_Type = RowStatus
_VRtrMldIfSGrpRangeSrcRowStatus_Object = MibTableColumn
vRtrMldIfSGrpRangeSrcRowStatus = _VRtrMldIfSGrpRangeSrcRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 9),
    _VRtrMldIfSGrpRangeSrcRowStatus_Type()
)
vRtrMldIfSGrpRangeSrcRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeSrcRowStatus.setStatus("current")
_VRtrMldIfSGrpRangeLastChanged_Type = TimeStamp
_VRtrMldIfSGrpRangeLastChanged_Object = MibTableColumn
vRtrMldIfSGrpRangeLastChanged = _VRtrMldIfSGrpRangeLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 10),
    _VRtrMldIfSGrpRangeLastChanged_Type()
)
vRtrMldIfSGrpRangeLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeLastChanged.setStatus("current")
_VRtrMldIfSGrpRangeGrpCount_Type = Unsigned32
_VRtrMldIfSGrpRangeGrpCount_Object = MibTableColumn
vRtrMldIfSGrpRangeGrpCount = _VRtrMldIfSGrpRangeGrpCount_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 13, 1, 11),
    _VRtrMldIfSGrpRangeGrpCount_Type()
)
vRtrMldIfSGrpRangeGrpCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIfSGrpRangeGrpCount.setStatus("current")
_VRtrMldIPsecStaticTnlTable_Object = MibTable
vRtrMldIPsecStaticTnlTable = _VRtrMldIPsecStaticTnlTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14)
)
if mibBuilder.loadTexts:
    vRtrMldIPsecStaticTnlTable.setStatus("current")
_VRtrMldIPsecStaticTnlEntry_Object = MibTableRow
vRtrMldIPsecStaticTnlEntry = _VRtrMldIPsecStaticTnlEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1)
)
vRtrMldIPsecStaticTnlEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIPsecStaticTunnelName"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIPsecSTnlSAId"),
)
if mibBuilder.loadTexts:
    vRtrMldIPsecStaticTnlEntry.setStatus("current")
_VRtrMldIPsecStaticTunnelName_Type = TNamedItem
_VRtrMldIPsecStaticTunnelName_Object = MibTableColumn
vRtrMldIPsecStaticTunnelName = _VRtrMldIPsecStaticTunnelName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 1),
    _VRtrMldIPsecStaticTunnelName_Type()
)
vRtrMldIPsecStaticTunnelName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIPsecStaticTunnelName.setStatus("current")
_VRtrMldIPsecSTnlSAId_Type = Unsigned32
_VRtrMldIPsecSTnlSAId_Object = MibTableColumn
vRtrMldIPsecSTnlSAId = _VRtrMldIPsecSTnlSAId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 2),
    _VRtrMldIPsecSTnlSAId_Type()
)
vRtrMldIPsecSTnlSAId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlSAId.setStatus("current")
_VRtrMldIPsecSTnlIndex_Type = InterfaceIndex
_VRtrMldIPsecSTnlIndex_Object = MibTableColumn
vRtrMldIPsecSTnlIndex = _VRtrMldIPsecSTnlIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 3),
    _VRtrMldIPsecSTnlIndex_Type()
)
vRtrMldIPsecSTnlIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlIndex.setStatus("current")
_VRtrMldIPsecSTnlOperState_Type = TmnxOperState
_VRtrMldIPsecSTnlOperState_Object = MibTableColumn
vRtrMldIPsecSTnlOperState = _VRtrMldIPsecSTnlOperState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 4),
    _VRtrMldIPsecSTnlOperState_Type()
)
vRtrMldIPsecSTnlOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlOperState.setStatus("current")
_VRtrMldIPsecSTnlOperVer_Type = Unsigned32
_VRtrMldIPsecSTnlOperVer_Object = MibTableColumn
vRtrMldIPsecSTnlOperVer = _VRtrMldIPsecSTnlOperVer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 5),
    _VRtrMldIPsecSTnlOperVer_Type()
)
vRtrMldIPsecSTnlOperVer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlOperVer.setStatus("current")
_VRtrMldIPsecSTnlQuerierType_Type = InetAddressType
_VRtrMldIPsecSTnlQuerierType_Object = MibTableColumn
vRtrMldIPsecSTnlQuerierType = _VRtrMldIPsecSTnlQuerierType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 6),
    _VRtrMldIPsecSTnlQuerierType_Type()
)
vRtrMldIPsecSTnlQuerierType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlQuerierType.setStatus("current")


class _VRtrMldIPsecSTnlQuerier_Type(InetAddress):
    """Custom type vRtrMldIPsecSTnlQuerier based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(16, 16),
...
_VRtrMldIPsecSTnlQuerier_Type.__name__ = "InetAddress"
_VRtrMldIPsecSTnlQuerier_Object = MibTableColumn
vRtrMldIPsecSTnlQuerier = _VRtrMldIPsecSTnlQuerier_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 7),
    _VRtrMldIPsecSTnlQuerier_Type()
)
vRtrMldIPsecSTnlQuerier.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlQuerier.setStatus("current")
_VRtrMldIPsecSTnlGroupCount_Type = Unsigned32
_VRtrMldIPsecSTnlGroupCount_Object = MibTableColumn
vRtrMldIPsecSTnlGroupCount = _VRtrMldIPsecSTnlGroupCount_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 8),
    _VRtrMldIPsecSTnlGroupCount_Type()
)
vRtrMldIPsecSTnlGroupCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlGroupCount.setStatus("current")
_VRtrMldIPsecSTnlQuerierUpTime_Type = Unsigned32
_VRtrMldIPsecSTnlQuerierUpTime_Object = MibTableColumn
vRtrMldIPsecSTnlQuerierUpTime = _VRtrMldIPsecSTnlQuerierUpTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 9),
    _VRtrMldIPsecSTnlQuerierUpTime_Type()
)
vRtrMldIPsecSTnlQuerierUpTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlQuerierUpTime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlQuerierUpTime.setUnits("seconds")
_VRtrMldIPsecSTnlQuerierExpTime_Type = Unsigned32
_VRtrMldIPsecSTnlQuerierExpTime_Object = MibTableColumn
vRtrMldIPsecSTnlQuerierExpTime = _VRtrMldIPsecSTnlQuerierExpTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 10),
    _VRtrMldIPsecSTnlQuerierExpTime_Type()
)
vRtrMldIPsecSTnlQuerierExpTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlQuerierExpTime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlQuerierExpTime.setUnits("seconds")
_VRtrMldIPsecSTnlNextGenQryTime_Type = Unsigned32
_VRtrMldIPsecSTnlNextGenQryTime_Object = MibTableColumn
vRtrMldIPsecSTnlNextGenQryTime = _VRtrMldIPsecSTnlNextGenQryTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 14, 1, 11),
    _VRtrMldIPsecSTnlNextGenQryTime_Type()
)
vRtrMldIPsecSTnlNextGenQryTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlNextGenQryTime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldIPsecSTnlNextGenQryTime.setUnits("seconds")
_VRtrMldIPsecRUTnlTable_Object = MibTable
vRtrMldIPsecRUTnlTable = _VRtrMldIPsecRUTnlTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15)
)
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlTable.setStatus("current")
_VRtrMldIPsecRUTnlEntry_Object = MibTableRow
vRtrMldIPsecRUTnlEntry = _VRtrMldIPsecRUTnlEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1)
)
vRtrMldIPsecRUTnlEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlGWName"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlInetAddrType"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlInetAddress"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlPort"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlSAId"),
)
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlEntry.setStatus("current")
_VRtrMldIPsecRUTnlGWName_Type = TNamedItem
_VRtrMldIPsecRUTnlGWName_Object = MibTableColumn
vRtrMldIPsecRUTnlGWName = _VRtrMldIPsecRUTnlGWName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 1),
    _VRtrMldIPsecRUTnlGWName_Type()
)
vRtrMldIPsecRUTnlGWName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlGWName.setStatus("current")
_VRtrMldIPsecRUTnlInetAddrType_Type = InetAddressType
_VRtrMldIPsecRUTnlInetAddrType_Object = MibTableColumn
vRtrMldIPsecRUTnlInetAddrType = _VRtrMldIPsecRUTnlInetAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 2),
    _VRtrMldIPsecRUTnlInetAddrType_Type()
)
vRtrMldIPsecRUTnlInetAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlInetAddrType.setStatus("current")


class _VRtrMldIPsecRUTnlInetAddress_Type(InetAddress):
    """Custom type vRtrMldIPsecRUTnlInetAddress based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
...
_VRtrMldIPsecRUTnlInetAddress_Type.__name__ = "InetAddress"
_VRtrMldIPsecRUTnlInetAddress_Object = MibTableColumn
vRtrMldIPsecRUTnlInetAddress = _VRtrMldIPsecRUTnlInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 3),
    _VRtrMldIPsecRUTnlInetAddress_Type()
)
vRtrMldIPsecRUTnlInetAddress.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlInetAddress.setStatus("current")
_VRtrMldIPsecRUTnlPort_Type = TTcpUdpPort
_VRtrMldIPsecRUTnlPort_Object = MibTableColumn
vRtrMldIPsecRUTnlPort = _VRtrMldIPsecRUTnlPort_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 4),
    _VRtrMldIPsecRUTnlPort_Type()
)
vRtrMldIPsecRUTnlPort.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlPort.setStatus("current")
_VRtrMldIPsecRUTnlSAId_Type = Unsigned32
_VRtrMldIPsecRUTnlSAId_Object = MibTableColumn
vRtrMldIPsecRUTnlSAId = _VRtrMldIPsecRUTnlSAId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 5),
    _VRtrMldIPsecRUTnlSAId_Type()
)
vRtrMldIPsecRUTnlSAId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlSAId.setStatus("current")
_VRtrMldIPsecRUTnlIndex_Type = InterfaceIndex
_VRtrMldIPsecRUTnlIndex_Object = MibTableColumn
vRtrMldIPsecRUTnlIndex = _VRtrMldIPsecRUTnlIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 6),
    _VRtrMldIPsecRUTnlIndex_Type()
)
vRtrMldIPsecRUTnlIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlIndex.setStatus("current")
_VRtrMldIPsecRUTnlOperState_Type = TmnxOperState
_VRtrMldIPsecRUTnlOperState_Object = MibTableColumn
vRtrMldIPsecRUTnlOperState = _VRtrMldIPsecRUTnlOperState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 7),
    _VRtrMldIPsecRUTnlOperState_Type()
)
vRtrMldIPsecRUTnlOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlOperState.setStatus("current")
_VRtrMldIPsecRUTnlOperVersion_Type = Unsigned32
_VRtrMldIPsecRUTnlOperVersion_Object = MibTableColumn
vRtrMldIPsecRUTnlOperVersion = _VRtrMldIPsecRUTnlOperVersion_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 8),
    _VRtrMldIPsecRUTnlOperVersion_Type()
)
vRtrMldIPsecRUTnlOperVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlOperVersion.setStatus("current")
_VRtrMldIPsecRUTnlQuerierType_Type = InetAddressType
_VRtrMldIPsecRUTnlQuerierType_Object = MibTableColumn
vRtrMldIPsecRUTnlQuerierType = _VRtrMldIPsecRUTnlQuerierType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 9),
    _VRtrMldIPsecRUTnlQuerierType_Type()
)
vRtrMldIPsecRUTnlQuerierType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlQuerierType.setStatus("current")


class _VRtrMldIPsecRUTnlQuerier_Type(InetAddress):
    """Custom type vRtrMldIPsecRUTnlQuerier based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(16, 16),
...
_VRtrMldIPsecRUTnlQuerier_Type.__name__ = "InetAddress"
_VRtrMldIPsecRUTnlQuerier_Object = MibTableColumn
vRtrMldIPsecRUTnlQuerier = _VRtrMldIPsecRUTnlQuerier_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 10),
    _VRtrMldIPsecRUTnlQuerier_Type()
)
vRtrMldIPsecRUTnlQuerier.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlQuerier.setStatus("current")
_VRtrMldIPsecRUTnlGroupCount_Type = Unsigned32
_VRtrMldIPsecRUTnlGroupCount_Object = MibTableColumn
vRtrMldIPsecRUTnlGroupCount = _VRtrMldIPsecRUTnlGroupCount_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 11),
    _VRtrMldIPsecRUTnlGroupCount_Type()
)
vRtrMldIPsecRUTnlGroupCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlGroupCount.setStatus("current")
_VRtrMldIPsecRUTnlQuerierUpTime_Type = Unsigned32
_VRtrMldIPsecRUTnlQuerierUpTime_Object = MibTableColumn
vRtrMldIPsecRUTnlQuerierUpTime = _VRtrMldIPsecRUTnlQuerierUpTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 12),
    _VRtrMldIPsecRUTnlQuerierUpTime_Type()
)
vRtrMldIPsecRUTnlQuerierUpTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlQuerierUpTime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlQuerierUpTime.setUnits("seconds")
_VRtrMldIPsecRUTnlQuerierExpTime_Type = Unsigned32
_VRtrMldIPsecRUTnlQuerierExpTime_Object = MibTableColumn
vRtrMldIPsecRUTnlQuerierExpTime = _VRtrMldIPsecRUTnlQuerierExpTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 13),
    _VRtrMldIPsecRUTnlQuerierExpTime_Type()
)
vRtrMldIPsecRUTnlQuerierExpTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlQuerierExpTime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlQuerierExpTime.setUnits("seconds")
_VRtrMldIPsecRUTnlNextGenQryTime_Type = Unsigned32
_VRtrMldIPsecRUTnlNextGenQryTime_Object = MibTableColumn
vRtrMldIPsecRUTnlNextGenQryTime = _VRtrMldIPsecRUTnlNextGenQryTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 2, 15, 1, 14),
    _VRtrMldIPsecRUTnlNextGenQryTime_Type()
)
vRtrMldIPsecRUTnlNextGenQryTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlNextGenQryTime.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldIPsecRUTnlNextGenQryTime.setUnits("seconds")
...
class _VRtrMldHostQueryInterval_Type(Unsigned32):
    """Custom type vRtrMldHostQueryInterval based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(2, 1024),
...
_VRtrMldHostQueryInterval_Type.__name__ = "Unsigned32"
_VRtrMldHostQueryInterval_Object = MibTableColumn
vRtrMldHostQueryInterval = _VRtrMldHostQueryInterval_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 1, 1, 19),
    _VRtrMldHostQueryInterval_Type()
)
vRtrMldHostQueryInterval.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostQueryInterval.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldHostQueryInterval.setUnits("seconds")


class _VRtrMldHostLastLstnrQueryIntvl_Type(Unsigned32):
    """Custom type vRtrMldHostLastLstnrQueryIntvl based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 1023),
...
_VRtrMldHostLastLstnrQueryIntvl_Type.__name__ = "Unsigned32"
_VRtrMldHostLastLstnrQueryIntvl_Object = MibTableColumn
vRtrMldHostLastLstnrQueryIntvl = _VRtrMldHostLastLstnrQueryIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 1, 1, 20),
    _VRtrMldHostLastLstnrQueryIntvl_Type()
)
vRtrMldHostLastLstnrQueryIntvl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostLastLstnrQueryIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldHostLastLstnrQueryIntvl.setUnits("seconds")


class _VRtrMldHostQueryResponseIntvl_Type(Unsigned32):
    """Custom type vRtrMldHostQueryResponseIntvl based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 1023),
...
_VRtrMldHostQueryResponseIntvl_Type.__name__ = "Unsigned32"
_VRtrMldHostQueryResponseIntvl_Object = MibTableColumn
vRtrMldHostQueryResponseIntvl = _VRtrMldHostQueryResponseIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 1, 1, 21),
    _VRtrMldHostQueryResponseIntvl_Type()
)
vRtrMldHostQueryResponseIntvl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostQueryResponseIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldHostQueryResponseIntvl.setUnits("seconds")
_VRtrMldHostDisRtrAlertChk_Type = TruthValue
_VRtrMldHostDisRtrAlertChk_Object = MibTableColumn
vRtrMldHostDisRtrAlertChk = _VRtrMldHostDisRtrAlertChk_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 1, 1, 22),
    _VRtrMldHostDisRtrAlertChk_Type()
)
vRtrMldHostDisRtrAlertChk.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostDisRtrAlertChk.setStatus("current")
_VRtrMldHostBondingConnIndex_Type = Unsigned32
_VRtrMldHostBondingConnIndex_Object = MibTableColumn
vRtrMldHostBondingConnIndex = _VRtrMldHostBondingConnIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 1, 1, 23),
    _VRtrMldHostBondingConnIndex_Type()
)
vRtrMldHostBondingConnIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostBondingConnIndex.setStatus("current")
_VRtrMldHostBondingId_Type = TmnxSubIdentStringOrEmpty
_VRtrMldHostBondingId_Object = MibTableColumn
vRtrMldHostBondingId = _VRtrMldHostBondingId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 1, 1, 24),
    _VRtrMldHostBondingId_Type()
)
vRtrMldHostBondingId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostBondingId.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrMldGrpIfMcacUnconstrainedBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldGrpIfMcacPreRsvdMandBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldGrpIfMcacinUseMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldGrpIfMcacinUseOpnlBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldGrpIfMcacAvailMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrMldGrpIfMcacAvailOpnlBw.setUnits("kilobps")
...
class _VRtrMldGrpIfMcacIfPolicyName_Type(TPolicyStatementNameOrEmpty):
    """Custom type vRtrMldGrpIfMcacIfPolicyName based on TPolicyStatementNameOrEmpty"""
    defaultValue = OctetString("")


_VRtrMldGrpIfMcacIfPolicyName_Type.__name__ = "TPolicyStatementNameOrEmpty"
_VRtrMldGrpIfMcacIfPolicyName_Object = MibTableColumn
vRtrMldGrpIfMcacIfPolicyName = _VRtrMldGrpIfMcacIfPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 3, 1, 24),
    _VRtrMldGrpIfMcacIfPolicyName_Type()
)
vRtrMldGrpIfMcacIfPolicyName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrMldGrpIfMcacIfPolicyName.setStatus("current")


class _VRtrMldGrpIfQueryInterval_Type(Unsigned32):
    """Custom type vRtrMldGrpIfQueryInterval based on Unsigned32"""
    defaultValue = 0
...
_VRtrMldGrpIfQueryInterval_Type.__name__ = "Unsigned32"
_VRtrMldGrpIfQueryInterval_Object = MibTableColumn
vRtrMldGrpIfQueryInterval = _VRtrMldGrpIfQueryInterval_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 3, 1, 25),
    _VRtrMldGrpIfQueryInterval_Type()
)
vRtrMldGrpIfQueryInterval.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrMldGrpIfQueryInterval.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldGrpIfQueryInterval.setUnits("seconds")


class _VRtrMldGrpIfLastLstnrQueryIntvl_Type(Unsigned32):
    """Custom type vRtrMldGrpIfLastLstnrQueryIntvl based on Unsigned32"""
    defaultValue = 0
...
_VRtrMldGrpIfLastLstnrQueryIntvl_Type.__name__ = "Unsigned32"
_VRtrMldGrpIfLastLstnrQueryIntvl_Object = MibTableColumn
vRtrMldGrpIfLastLstnrQueryIntvl = _VRtrMldGrpIfLastLstnrQueryIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 3, 1, 26),
    _VRtrMldGrpIfLastLstnrQueryIntvl_Type()
)
vRtrMldGrpIfLastLstnrQueryIntvl.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrMldGrpIfLastLstnrQueryIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldGrpIfLastLstnrQueryIntvl.setUnits("seconds")


class _VRtrMldGrpIfQueryResponseIntvl_Type(Unsigned32):
    """Custom type vRtrMldGrpIfQueryResponseIntvl based on Unsigned32"""
    defaultValue = 0
...
_VRtrMldGrpIfQueryResponseIntvl_Type.__name__ = "Unsigned32"
_VRtrMldGrpIfQueryResponseIntvl_Object = MibTableColumn
vRtrMldGrpIfQueryResponseIntvl = _VRtrMldGrpIfQueryResponseIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 3, 1, 27),
    _VRtrMldGrpIfQueryResponseIntvl_Type()
)
vRtrMldGrpIfQueryResponseIntvl.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrMldGrpIfQueryResponseIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldGrpIfQueryResponseIntvl.setUnits("seconds")
...
_VRtrMldGrpIfHostGrpUpTime_Type = TimeInterval
...
_VRtrMldGrpIfHostGrpExpiryTime_Type = TimeInterval
...
_VRtrMldGrpIfHostGrpVer1HostTmr_Type = TimeInterval
...
_VRtrMldGrpIfHostGrpMRDstVrId_Type = TmnxVRtrIDOrZero
...
_VRtrMldGrpIfHostGrpMRDstIfId_Type = InterfaceIndexOrZero
...
_VRtrMldGrpIfHostGrpBondOwner_Type = TruthValue
_VRtrMldGrpIfHostGrpBondOwner_Object = MibTableColumn
vRtrMldGrpIfHostGrpBondOwner = _VRtrMldGrpIfHostGrpBondOwner_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 4, 1, 11),
    _VRtrMldGrpIfHostGrpBondOwner_Type()
)
vRtrMldGrpIfHostGrpBondOwner.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldGrpIfHostGrpBondOwner.setStatus("current")
_VRtrMldGrpIfHostGrpBondFwd_Type = TruthValue
_VRtrMldGrpIfHostGrpBondFwd_Object = MibTableColumn
vRtrMldGrpIfHostGrpBondFwd = _VRtrMldGrpIfHostGrpBondFwd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 4, 1, 12),
    _VRtrMldGrpIfHostGrpBondFwd_Type()
)
vRtrMldGrpIfHostGrpBondFwd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldGrpIfHostGrpBondFwd.setStatus("current")
...
_VRtrMldGrpIfHostGrpSrcExpTime_Type = TimeInterval
...
_VRtrMldGrpIfHostGrpSrcMRDstVrId_Type = TmnxVRtrIDOrZero
...
_VRtrMldGrpIfHostGrpSrcMRDstIfId_Type = InterfaceIndexOrZero
...
_VRtrMldGrpIfHostGrpSrcBondOwner_Type = TruthValue
_VRtrMldGrpIfHostGrpSrcBondOwner_Object = MibTableColumn
vRtrMldGrpIfHostGrpSrcBondOwner = _VRtrMldGrpIfHostGrpSrcBondOwner_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 5, 1, 7),
    _VRtrMldGrpIfHostGrpSrcBondOwner_Type()
)
vRtrMldGrpIfHostGrpSrcBondOwner.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldGrpIfHostGrpSrcBondOwner.setStatus("current")
_VRtrMldGrpIfHostGrpSrcBondFwd_Type = TruthValue
_VRtrMldGrpIfHostGrpSrcBondFwd_Object = MibTableColumn
vRtrMldGrpIfHostGrpSrcBondFwd = _VRtrMldGrpIfHostGrpSrcBondFwd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 5, 1, 8),
    _VRtrMldGrpIfHostGrpSrcBondFwd_Type()
)
vRtrMldGrpIfHostGrpSrcBondFwd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldGrpIfHostGrpSrcBondFwd.setStatus("current")
...
_VRtrMldHostGrpSrcExpiryTime_Type = TimeInterval
...
_VRtrMldHostGrpSrcMcRdrDstVRtrID_Type = TmnxVRtrIDOrZero
...
_VRtrMldHostGrpSrcMcRdrDstIfIdx_Type = InterfaceIndexOrZero
...
_VRtrMldHostGrpSrcBondOwner_Type = TruthValue
_VRtrMldHostGrpSrcBondOwner_Object = MibTableColumn
vRtrMldHostGrpSrcBondOwner = _VRtrMldHostGrpSrcBondOwner_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 7, 1, 5),
    _VRtrMldHostGrpSrcBondOwner_Type()
)
vRtrMldHostGrpSrcBondOwner.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostGrpSrcBondOwner.setStatus("current")
_VRtrMldHostGrpSrcBondFwd_Type = TruthValue
_VRtrMldHostGrpSrcBondFwd_Object = MibTableColumn
vRtrMldHostGrpSrcBondFwd = _VRtrMldHostGrpSrcBondFwd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 7, 1, 6),
    _VRtrMldHostGrpSrcBondFwd_Type()
)
vRtrMldHostGrpSrcBondFwd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostGrpSrcBondFwd.setStatus("current")
...
_VRtrMldHostGrpUpTime_Type = TimeInterval
...
_VRtrMldHostGrpExpiryTime_Type = TimeInterval
...
_VRtrMldHostGrpVer1HostTmr_Type = TimeInterval
...
_VRtrMldHostGrpMcRdrDstVrId_Type = TmnxVRtrIDOrZero
...
_VRtrMldHostGrpMcRdrDstIfId_Type = InterfaceIndexOrZero
...
_VRtrMldHostGrpBondOwner_Type = TruthValue
_VRtrMldHostGrpBondOwner_Object = MibTableColumn
vRtrMldHostGrpBondOwner = _VRtrMldHostGrpBondOwner_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 8, 1, 9),
    _VRtrMldHostGrpBondOwner_Type()
)
vRtrMldHostGrpBondOwner.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostGrpBondOwner.setStatus("current")
_VRtrMldHostGrpBondFwd_Type = TruthValue
_VRtrMldHostGrpBondFwd_Object = MibTableColumn
vRtrMldHostGrpBondFwd = _VRtrMldHostGrpBondFwd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 8, 1, 10),
    _VRtrMldHostGrpBondFwd_Type()
)
vRtrMldHostGrpBondFwd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostGrpBondFwd.setStatus("current")
...
_VRtrMldHostImportPlcyTable_Object = MibTable
vRtrMldHostImportPlcyTable = _VRtrMldHostImportPlcyTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 10)
)
if mibBuilder.loadTexts:
    vRtrMldHostImportPlcyTable.setStatus("current")
_VRtrMldHostImportPlcyEntry_Object = MibTableRow
vRtrMldHostImportPlcyEntry = _VRtrMldHostImportPlcyEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 10, 1)
)
vRtrMldHostImportPlcyEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldHostAddressType"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldHostAddress"),
    (0, "TIMETRA-MLD-MIB", "vRtrMldHostMacAddress"),
...
if mibBuilder.loadTexts:
    vRtrMldHostImportPlcyEntry.setStatus("current")


class _VRtrMldHostImportPlcySeq_Type(Unsigned32):
    """Custom type vRtrMldHostImportPlcySeq based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_VRtrMldHostImportPlcySeq_Type.__name__ = "Unsigned32"
_VRtrMldHostImportPlcySeq_Object = MibTableColumn
vRtrMldHostImportPlcySeq = _VRtrMldHostImportPlcySeq_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 10, 1, 1),
    _VRtrMldHostImportPlcySeq_Type()
)
vRtrMldHostImportPlcySeq.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrMldHostImportPlcySeq.setStatus("current")


class _VRtrMldHostImportPlcyName_Type(TPolicyStatementNameOrEmpty):
    """Custom type vRtrMldHostImportPlcyName based on TPolicyStatementNameOrEmpty"""
    defaultValue = OctetString("")


_VRtrMldHostImportPlcyName_Type.__name__ = "TPolicyStatementNameOrEmpty"
_VRtrMldHostImportPlcyName_Object = MibTableColumn
vRtrMldHostImportPlcyName = _VRtrMldHostImportPlcyName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 4, 10, 1, 2),
    _VRtrMldHostImportPlcyName_Type()
)
vRtrMldHostImportPlcyName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldHostImportPlcyName.setStatus("current")
...
class _VRtrMldGrpIfSapQryInterval_Type(Unsigned32):
    """Custom type vRtrMldGrpIfSapQryInterval based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(2, 1024),
...
_VRtrMldGrpIfSapQryInterval_Type.__name__ = "Unsigned32"
_VRtrMldGrpIfSapQryInterval_Object = MibTableColumn
vRtrMldGrpIfSapQryInterval = _VRtrMldGrpIfSapQryInterval_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 5, 1, 1, 11),
    _VRtrMldGrpIfSapQryInterval_Type()
)
vRtrMldGrpIfSapQryInterval.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldGrpIfSapQryInterval.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldGrpIfSapQryInterval.setUnits("seconds")


class _VRtrMldGrpIfSapLastLstnrQryIntvl_Type(Unsigned32):
    """Custom type vRtrMldGrpIfSapLastLstnrQryIntvl based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 1023),
...
_VRtrMldGrpIfSapLastLstnrQryIntvl_Type.__name__ = "Unsigned32"
_VRtrMldGrpIfSapLastLstnrQryIntvl_Object = MibTableColumn
vRtrMldGrpIfSapLastLstnrQryIntvl = _VRtrMldGrpIfSapLastLstnrQryIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 5, 1, 1, 12),
    _VRtrMldGrpIfSapLastLstnrQryIntvl_Type()
)
vRtrMldGrpIfSapLastLstnrQryIntvl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldGrpIfSapLastLstnrQryIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldGrpIfSapLastLstnrQryIntvl.setUnits("seconds")


class _VRtrMldGrpIfSapQryResponseIntvl_Type(Unsigned32):
    """Custom type vRtrMldGrpIfSapQryResponseIntvl based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 1023),
...
_VRtrMldGrpIfSapQryResponseIntvl_Type.__name__ = "Unsigned32"
_VRtrMldGrpIfSapQryResponseIntvl_Object = MibTableColumn
vRtrMldGrpIfSapQryResponseIntvl = _VRtrMldGrpIfSapQryResponseIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 46, 5, 1, 1, 13),
    _VRtrMldGrpIfSapQryResponseIntvl_Type()
)
vRtrMldGrpIfSapQryResponseIntvl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMldGrpIfSapQryResponseIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrMldGrpIfSapQryResponseIntvl.setUnits("seconds")
...
_VRtrMldGrpIfSapGrpUpTime_Type = TimeInterval
...
_VRtrMldGrpIfSapGrpExpiryTime_Type = TimeInterval
...
_VRtrMldGrpIfSapGrpVer1HostTmr_Type = TimeInterval
...
_VRtrMldGrpIfSapGrpSrcExpTime_Type = TimeInterval
...
tmnxMldIfV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 46, 2, 11)
)
tmnxMldIfV14v0Group.setObjects(
      *(("TIMETRA-MLD-MIB", "vRtrMldIfMcacIfPolicyName"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfMcacIfPolicyName"),
        ("TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeSrcTblLstChgd"),
        ("TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeSrcRowStatus"),
        ("TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeLastChanged"),
        ("TIMETRA-MLD-MIB", "vRtrMldIfSGrpRangeGrpCount"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfQueryInterval"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfLastLstnrQueryIntvl"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfQueryResponseIntvl"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostQueryInterval"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostLastLstnrQueryIntvl"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostQueryResponseIntvl"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostDisRtrAlertChk"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfSapQryInterval"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfSapLastLstnrQryIntvl"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfSapQryResponseIntvl"))
)
if mibBuilder.loadTexts:
    tmnxMldIfV14v0Group.setStatus("current")

tmnxMldIfV15v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 46, 2, 13)
)
tmnxMldIfV15v0Group.setObjects(
      *(("TIMETRA-MLD-MIB", "vRtrMldHostImportPlcyName"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostBondingConnIndex"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostBondingId"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfHostGrpBondOwner"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfHostGrpBondFwd"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfHostGrpSrcBondOwner"),
        ("TIMETRA-MLD-MIB", "vRtrMldGrpIfHostGrpSrcBondFwd"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostGrpSrcBondOwner"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostGrpSrcBondFwd"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostGrpBondOwner"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostGrpBondFwd"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecSTnlIndex"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecSTnlOperState"),
        ...
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecSTnlGroupCount"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecSTnlQuerierUpTime"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecSTnlQuerierExpTime"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecSTnlNextGenQryTime"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlIndex"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlOperState"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlOperVersion"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlQuerierType"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlQuerier"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlGroupCount"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlQuerierUpTime"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlQuerierExpTime"),
        ("TIMETRA-MLD-MIB", "vRtrMldIPsecRUTnlNextGenQryTime"))
)
if mibBuilder.loadTexts:
    tmnxMldIfV15v0Group.setStatus("current")
...
vRtrMldHostQryIntervalConflict = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 46, 0, 20)
)
vRtrMldHostQryIntervalConflict.setObjects(
      *(("TIMETRA-MLD-MIB", "vRtrMldHostFwdSvcId"),
        ("TIMETRA-MLD-MIB", "vRtrMldHostGrpIfId"),
        ("TIMETRA-MLD-MIB", "vRtrMldNotifyDescription"))
)
if mibBuilder.loadTexts:
    vRtrMldHostQryIntervalConflict.setStatus(
        "current"
    )
...
tmnxMldNotificationV14v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 46, 2, 12)
)
tmnxMldNotificationV14v0Group.setObjects(
    ("TIMETRA-MLD-MIB", "vRtrMldHostQryIntervalConflict")
)
if mibBuilder.loadTexts:
    tmnxMldNotificationV14v0Group.setStatus(
        "current"
    )
...
tmnxMldV14v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 46, 1, 5)
)
tmnxMldV14v0Compliance.setObjects(
      *(("TIMETRA-MLD-MIB", "tmnxMldGlobalGroup"),
        ("TIMETRA-MLD-MIB", "tmnxMldGlobalV12v0Group"),
        ("TIMETRA-MLD-MIB", "tmnxMldIfGroup"),
        ("TIMETRA-MLD-MIB", "tmnxMldNotificationGroup"),
        ...
        ("TIMETRA-MLD-MIB", "tmnxMldIfV8v0Group"),
        ("TIMETRA-MLD-MIB", "tmnxMldIfV12v0Group"),
        ("TIMETRA-MLD-MIB", "tmnxMldIfV14v0Group"),
        ("TIMETRA-MLD-MIB", "tmnxMldNotificationV14v0Group"))
)
if mibBuilder.loadTexts:
    tmnxMldV14v0Compliance.setStatus(
        "obsolete"
    )

tmnxMldV15v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 46, 1, 6)
)
tmnxMldV15v0Compliance.setObjects(
      *(("TIMETRA-MLD-MIB", "tmnxMldGlobalGroup"),
        ("TIMETRA-MLD-MIB", "tmnxMldGlobalV12v0Group"),
        ("TIMETRA-MLD-MIB", "tmnxMldIfGroup"),
        ("TIMETRA-MLD-MIB", "tmnxMldNotificationGroup"),
...
if mibBuilder.loadTexts:
    tmnxMldV15v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"MldGrpItfOperState": MldGrpItfOperState,
       ...
       "tmnxMldV14v0Compliance": tmnxMldV14v0Compliance,
       "tmnxMldV15v0Compliance": tmnxMldV15v0Compliance,
       ...
       "tmnxMldIfV14v0Group": tmnxMldIfV14v0Group,
       "tmnxMldNotificationV14v0Group": tmnxMldNotificationV14v0Group,
       "tmnxMldIfV15v0Group": tmnxMldIfV15v0Group,
       ...
       "vRtrMldIfMcacIfPolicyName": vRtrMldIfMcacIfPolicyName,
       ...
       "vRtrMldIfSGrpRangeSrcTblLstChgd": vRtrMldIfSGrpRangeSrcTblLstChgd,
       "vRtrMldIfSGrpRangeSrcTable": vRtrMldIfSGrpRangeSrcTable,
       "vRtrMldIfSGrpRangeSrcEntry": vRtrMldIfSGrpRangeSrcEntry,
       "vRtrMldIfSGrpRangeStartAddrType": vRtrMldIfSGrpRangeStartAddrType,
       "vRtrMldIfSGrpRangeStartAddr": vRtrMldIfSGrpRangeStartAddr,
       "vRtrMldIfSGrpRangeEndAddrType": vRtrMldIfSGrpRangeEndAddrType,
       "vRtrMldIfSGrpRangeEndAddr": vRtrMldIfSGrpRangeEndAddr,
       "vRtrMldIfSGrpRangeStepAddrType": vRtrMldIfSGrpRangeStepAddrType,
       "vRtrMldIfSGrpRangeStepAddr": vRtrMldIfSGrpRangeStepAddr,
       "vRtrMldIfSGrpRangeSrcAddrType": vRtrMldIfSGrpRangeSrcAddrType,
       "vRtrMldIfSGrpRangeSrcAddr": vRtrMldIfSGrpRangeSrcAddr,
       "vRtrMldIfSGrpRangeSrcRowStatus": vRtrMldIfSGrpRangeSrcRowStatus,
       "vRtrMldIfSGrpRangeLastChanged": vRtrMldIfSGrpRangeLastChanged,
       "vRtrMldIfSGrpRangeGrpCount": vRtrMldIfSGrpRangeGrpCount,
       "vRtrMldIPsecStaticTnlTable": vRtrMldIPsecStaticTnlTable,
       "vRtrMldIPsecStaticTnlEntry": vRtrMldIPsecStaticTnlEntry,
       "vRtrMldIPsecStaticTunnelName": vRtrMldIPsecStaticTunnelName,
       "vRtrMldIPsecSTnlSAId": vRtrMldIPsecSTnlSAId,
       "vRtrMldIPsecSTnlIndex": vRtrMldIPsecSTnlIndex,
       "vRtrMldIPsecSTnlOperState": vRtrMldIPsecSTnlOperState,
       "vRtrMldIPsecSTnlOperVer": vRtrMldIPsecSTnlOperVer,
       "vRtrMldIPsecSTnlQuerierType": vRtrMldIPsecSTnlQuerierType,
       "vRtrMldIPsecSTnlQuerier": vRtrMldIPsecSTnlQuerier,
       "vRtrMldIPsecSTnlGroupCount": vRtrMldIPsecSTnlGroupCount,
       "vRtrMldIPsecSTnlQuerierUpTime": vRtrMldIPsecSTnlQuerierUpTime,
       "vRtrMldIPsecSTnlQuerierExpTime": vRtrMldIPsecSTnlQuerierExpTime,
       "vRtrMldIPsecSTnlNextGenQryTime": vRtrMldIPsecSTnlNextGenQryTime,
       "vRtrMldIPsecRUTnlTable": vRtrMldIPsecRUTnlTable,
       "vRtrMldIPsecRUTnlEntry": vRtrMldIPsecRUTnlEntry,
       "vRtrMldIPsecRUTnlGWName": vRtrMldIPsecRUTnlGWName,
       "vRtrMldIPsecRUTnlInetAddrType": vRtrMldIPsecRUTnlInetAddrType,
       "vRtrMldIPsecRUTnlInetAddress": vRtrMldIPsecRUTnlInetAddress,
       "vRtrMldIPsecRUTnlPort": vRtrMldIPsecRUTnlPort,
       "vRtrMldIPsecRUTnlSAId": vRtrMldIPsecRUTnlSAId,
       "vRtrMldIPsecRUTnlIndex": vRtrMldIPsecRUTnlIndex,
       "vRtrMldIPsecRUTnlOperState": vRtrMldIPsecRUTnlOperState,
       "vRtrMldIPsecRUTnlOperVersion": vRtrMldIPsecRUTnlOperVersion,
       "vRtrMldIPsecRUTnlQuerierType": vRtrMldIPsecRUTnlQuerierType,
       "vRtrMldIPsecRUTnlQuerier": vRtrMldIPsecRUTnlQuerier,
       "vRtrMldIPsecRUTnlGroupCount": vRtrMldIPsecRUTnlGroupCount,
       "vRtrMldIPsecRUTnlQuerierUpTime": vRtrMldIPsecRUTnlQuerierUpTime,
       "vRtrMldIPsecRUTnlQuerierExpTime": vRtrMldIPsecRUTnlQuerierExpTime,
       "vRtrMldIPsecRUTnlNextGenQryTime": vRtrMldIPsecRUTnlNextGenQryTime,
       ...
       "vRtrMldHostQueryInterval": vRtrMldHostQueryInterval,
       "vRtrMldHostLastLstnrQueryIntvl": vRtrMldHostLastLstnrQueryIntvl,
       "vRtrMldHostQueryResponseIntvl": vRtrMldHostQueryResponseIntvl,
       "vRtrMldHostDisRtrAlertChk": vRtrMldHostDisRtrAlertChk,
       "vRtrMldHostBondingConnIndex": vRtrMldHostBondingConnIndex,
       "vRtrMldHostBondingId": vRtrMldHostBondingId,
       ...
       "vRtrMldGrpIfMcacIfPolicyName": vRtrMldGrpIfMcacIfPolicyName,
       "vRtrMldGrpIfQueryInterval": vRtrMldGrpIfQueryInterval,
       "vRtrMldGrpIfLastLstnrQueryIntvl": vRtrMldGrpIfLastLstnrQueryIntvl,
       "vRtrMldGrpIfQueryResponseIntvl": vRtrMldGrpIfQueryResponseIntvl,
       ...
       "vRtrMldGrpIfHostGrpBondOwner": vRtrMldGrpIfHostGrpBondOwner,
       "vRtrMldGrpIfHostGrpBondFwd": vRtrMldGrpIfHostGrpBondFwd,
       ...
       "vRtrMldGrpIfHostGrpSrcBondOwner": vRtrMldGrpIfHostGrpSrcBondOwner,
       "vRtrMldGrpIfHostGrpSrcBondFwd": vRtrMldGrpIfHostGrpSrcBondFwd,
       ...
       "vRtrMldHostGrpSrcBondOwner": vRtrMldHostGrpSrcBondOwner,
       "vRtrMldHostGrpSrcBondFwd": vRtrMldHostGrpSrcBondFwd,
       ...
       "vRtrMldHostGrpBondOwner": vRtrMldHostGrpBondOwner,
       "vRtrMldHostGrpBondFwd": vRtrMldHostGrpBondFwd,
       ...
       "vRtrMldHostImportPlcyTable": vRtrMldHostImportPlcyTable,
       "vRtrMldHostImportPlcyEntry": vRtrMldHostImportPlcyEntry,
       "vRtrMldHostImportPlcySeq": vRtrMldHostImportPlcySeq,
       "vRtrMldHostImportPlcyName": vRtrMldHostImportPlcyName,
       ...
       "vRtrMldGrpIfSapQryInterval": vRtrMldGrpIfSapQryInterval,
       "vRtrMldGrpIfSapLastLstnrQryIntvl": vRtrMldGrpIfSapLastLstnrQryIntvl,
       "vRtrMldGrpIfSapQryResponseIntvl": vRtrMldGrpIfSapQryResponseIntvl,
       ...
       "vRtrMldHostQryIntervalConflict": vRtrMldHostQryIntervalConflict}
)
