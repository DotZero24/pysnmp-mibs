...
snmpSyslogDeviceMIB=ModuleIdentity((1,3,6,1,4,1,171,10,94,89,89,82,1))
...
snmpSyslogDevice=_SnmpSyslogDevice_ObjectIdentity((1,3,6,1,4,1,171,10,94,89,89,82,1,1))
_SnmpSyslogDeviceMessages_Type=Counter32
_SnmpSyslogDeviceMessages_Object=MibScalar
snmpSyslogDeviceMessages=_SnmpSyslogDeviceMessages_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,1,1),_SnmpSyslogDeviceMessages_Type())
...
snmpSyslogDeviceMessagesDropped=_SnmpSyslogDeviceMessagesDropped_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,1,2),_SnmpSyslogDeviceMessagesDropped_Type())
...
snmpSyslogDeviceLastMessageTime=_SnmpSyslogDeviceLastMessageTime_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,1,3),_SnmpSyslogDeviceLastMessageTime_Type())
...
snmpSyslogDeviceControl=_SnmpSyslogDeviceControl_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,1,4),_SnmpSyslogDeviceControl_Type())
...
snmpSyslogCollector=_SnmpSyslogCollector_ObjectIdentity((1,3,6,1,4,1,171,10,94,89,89,82,1,2))
...
snmpSyslogCollectorMaxEntries=_SnmpSyslogCollectorMaxEntries_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,1),_SnmpSyslogCollectorMaxEntries_Type())
...
snmpSyslogCollectorNumEntries=_SnmpSyslogCollectorNumEntries_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,2),_SnmpSyslogCollectorNumEntries_Type())
...
snmpSyslogCollectorTableNextAvailableIndex=_SnmpSyslogCollectorTableNextAvailableIndex_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,3),_SnmpSyslogCollectorTableNextAvailableIndex_Type())
...
snmpSyslogCollectorTable=_SnmpSyslogCollectorTable_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4))
if mibBuilder.loadTexts:snmpSyslogCollectorTable.setStatus(_A)
_SnmpSyslogCollectorEntry_Object=MibTableRow
snmpSyslogCollectorEntry=_SnmpSyslogCollectorEntry_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1))
...
snmpSyslogCollectorIndex=_SnmpSyslogCollectorIndex_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1,1),_SnmpSyslogCollectorIndex_Type())
...
snmpSyslogCollectorDescription=_SnmpSyslogCollectorDescription_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1,2),_SnmpSyslogCollectorDescription_Type())
...
snmpSyslogCollectorAddressType=_SnmpSyslogCollectorAddressType_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1,3),_SnmpSyslogCollectorAddressType_Type())
...
snmpSyslogCollectorAddress=_SnmpSyslogCollectorAddress_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1,4),_SnmpSyslogCollectorAddress_Type())
...
snmpSyslogCollectorUdpPort=_SnmpSyslogCollectorUdpPort_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1,5),_SnmpSyslogCollectorUdpPort_Type())
...
snmpSyslogCollectorFacility=_SnmpSyslogCollectorFacility_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1,6),_SnmpSyslogCollectorFacility_Type())
...
snmpSyslogCollectorSeverity=_SnmpSyslogCollectorSeverity_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1,7),_SnmpSyslogCollectorSeverity_Type())
...
snmpSyslogCollectorMessagesIgnored=_SnmpSyslogCollectorMessagesIgnored_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1,8),_SnmpSyslogCollectorMessagesIgnored_Type())
...
snmpSyslogCollectorRowStatus=_SnmpSyslogCollectorRowStatus_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,4,1,9),_SnmpSyslogCollectorRowStatus_Type())
...
snmpSyslogCollectorDefaultUdpPort=_SnmpSyslogCollectorDefaultUdpPort_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,5),_SnmpSyslogCollectorDefaultUdpPort_Type())
...
snmpSyslogCollectorDefaultFacility=_SnmpSyslogCollectorDefaultFacility_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,6),_SnmpSyslogCollectorDefaultFacility_Type())
...
snmpSyslogCollectorDefaultSeverity=_SnmpSyslogCollectorDefaultSeverity_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,2,7),_SnmpSyslogCollectorDefaultSeverity_Type())
...
snmpSyslogApplication=_SnmpSyslogApplication_ObjectIdentity((1,3,6,1,4,1,171,10,94,89,89,82,1,3))
_SnmpSyslogApplicationTable_Object=MibTable
snmpSyslogApplicationTable=_SnmpSyslogApplicationTable_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,3,1))
if mibBuilder.loadTexts:snmpSyslogApplicationTable.setStatus(_A)
_SnmpSyslogApplicationEntry_Object=MibTableRow
snmpSyslogApplicationEntry=_SnmpSyslogApplicationEntry_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,3,1,1))
...
snmpSyslogApplicationIndex=_SnmpSyslogApplicationIndex_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,3,1,1,1),_SnmpSyslogApplicationIndex_Type())
...
snmpSyslogApplicationDescription=_SnmpSyslogApplicationDescription_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,3,1,1,2),_SnmpSyslogApplicationDescription_Type())
...
snmpSyslogApplicationMnemonic=_SnmpSyslogApplicationMnemonic_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,3,1,1,3),_SnmpSyslogApplicationMnemonic_Type())
...
snmpSyslogApplicationSeverity=_SnmpSyslogApplicationSeverity_Object((1,3,6,1,4,1,171,10,94,89,89,82,1,3,1,1,4),_SnmpSyslogApplicationSeverity_Type())
...
snmpSyslogDeviceConformance=_SnmpSyslogDeviceConformance_ObjectIdentity((1,3,6,1,4,1,171,10,94,89,89,82,1,4))
_SnmpSyslogDeviceGroups_ObjectIdentity=ObjectIdentity
snmpSyslogDeviceGroups=_SnmpSyslogDeviceGroups_ObjectIdentity((1,3,6,1,4,1,171,10,94,89,89,82,1,4,1))
_SnmpSyslogDeviceCompliances_ObjectIdentity=ObjectIdentity
snmpSyslogDeviceCompliances=_SnmpSyslogDeviceCompliances_ObjectIdentity((1,3,6,1,4,1,171,10,94,89,89,82,1,4,2))
snmpSyslogDeviceGroup=ObjectGroup((1,3,6,1,4,1,171,10,94,89,89,82,1,4,1,1))
snmpSyslogDeviceGroup.setObjects(*((_B,_N),(_B,_O),(_B,_P),(_B,_Q)))
if mibBuilder.loadTexts:snmpSyslogDeviceGroup.setStatus(_A)
snmpSyslogCollectorGroup=ObjectGroup((1,3,6,1,4,1,171,10,94,89,89,82,1,4,1,2))
...
snmpSyslogApplicationGroup=ObjectGroup((1,3,6,1,4,1,171,10,94,89,89,82,1,4,1,3))
snmpSyslogApplicationGroup.setObjects(*((_B,_c),(_B,_d),(_B,_e)))
if mibBuilder.loadTexts:snmpSyslogApplicationGroup.setStatus(_A)
snmpSyslogCollectorDefaultsGroup=ObjectGroup((1,3,6,1,4,1,171,10,94,89,89,82,1,4,1,4))
...
snmpSyslogDeviceCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,94,89,89,82,1,4,2,1))
