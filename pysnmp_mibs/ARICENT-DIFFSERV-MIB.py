_R='read-only'
_Q='fsDiffServPortCoSqId'
_P='fsDiffServBaseCoSqPortId'
_O='fsDiffServPortId'
...
fsDiffServMIBObjects=_FsDiffServMIBObjects_ObjectIdentity((1,3,6,1,4,1,2076,83,1))
_FsDiffServSystem_ObjectIdentity=ObjectIdentity
fsDiffServSystem=_FsDiffServSystem_ObjectIdentity((1,3,6,1,4,1,2076,83,1,1))
...
fsDsSystemControl=_FsDsSystemControl_Object((1,3,6,1,4,1,2076,83,1,1,1),_FsDsSystemControl_Type())
...
fsDsStatus=_FsDsStatus_Object((1,3,6,1,4,1,2076,83,1,1,2),_FsDsStatus_Type())
...
fsDiffServMFClassifier=_FsDiffServMFClassifier_ObjectIdentity((1,3,6,1,4,1,2076,83,1,2))
_FsDiffServMultiFieldClfrTable_Object=MibTable
fsDiffServMultiFieldClfrTable=_FsDiffServMultiFieldClfrTable_Object((1,3,6,1,4,1,2076,83,1,2,1))
if mibBuilder.loadTexts:fsDiffServMultiFieldClfrTable.setStatus(_A)
_FsDiffServMultiFieldClfrEntry_Object=MibTableRow
fsDiffServMultiFieldClfrEntry=_FsDiffServMultiFieldClfrEntry_Object((1,3,6,1,4,1,2076,83,1,2,1,1))
...
fsDiffServMultiFieldClfrId=_FsDiffServMultiFieldClfrId_Object((1,3,6,1,4,1,2076,83,1,2,1,1,1),_FsDiffServMultiFieldClfrId_Type())
...
fsDiffServMultiFieldClfrFilterId=_FsDiffServMultiFieldClfrFilterId_Object((1,3,6,1,4,1,2076,83,1,2,1,1,2),_FsDiffServMultiFieldClfrFilterId_Type())
...
fsDiffServMultiFieldClfrFilterType=_FsDiffServMultiFieldClfrFilterType_Object((1,3,6,1,4,1,2076,83,1,2,1,1,3),_FsDiffServMultiFieldClfrFilterType_Type())
...
fsDiffServMultiFieldClfrStatus=_FsDiffServMultiFieldClfrStatus_Object((1,3,6,1,4,1,2076,83,1,2,1,1,4),_FsDiffServMultiFieldClfrStatus_Type())
...
fsDiffServClassifier=_FsDiffServClassifier_ObjectIdentity((1,3,6,1,4,1,2076,83,1,3))
_FsDiffServClfrTable_Object=MibTable
fsDiffServClfrTable=_FsDiffServClfrTable_Object((1,3,6,1,4,1,2076,83,1,3,1))
if mibBuilder.loadTexts:fsDiffServClfrTable.setStatus(_A)
_FsDiffServClfrEntry_Object=MibTableRow
fsDiffServClfrEntry=_FsDiffServClfrEntry_Object((1,3,6,1,4,1,2076,83,1,3,1,1))
...
fsDiffServClfrId=_FsDiffServClfrId_Object((1,3,6,1,4,1,2076,83,1,3,1,1,1),_FsDiffServClfrId_Type())
...
fsDiffServClfrMFClfrId=_FsDiffServClfrMFClfrId_Object((1,3,6,1,4,1,2076,83,1,3,1,1,2),_FsDiffServClfrMFClfrId_Type())
...
fsDiffServClfrInProActionId=_FsDiffServClfrInProActionId_Object((1,3,6,1,4,1,2076,83,1,3,1,1,3),_FsDiffServClfrInProActionId_Type())
...
fsDiffServClfrOutProActionId=_FsDiffServClfrOutProActionId_Object((1,3,6,1,4,1,2076,83,1,3,1,1,4),_FsDiffServClfrOutProActionId_Type())
...
fsDiffServClfrStatus=_FsDiffServClfrStatus_Object((1,3,6,1,4,1,2076,83,1,3,1,1,5),_FsDiffServClfrStatus_Type())
...
fsDiffServInProfileAction=_FsDiffServInProfileAction_ObjectIdentity((1,3,6,1,4,1,2076,83,1,4))
_FsDiffServInProfileActionTable_Object=MibTable
fsDiffServInProfileActionTable=_FsDiffServInProfileActionTable_Object((1,3,6,1,4,1,2076,83,1,4,1))
if mibBuilder.loadTexts:fsDiffServInProfileActionTable.setStatus(_A)
_FsDiffServInProfileActionEntry_Object=MibTableRow
fsDiffServInProfileActionEntry=_FsDiffServInProfileActionEntry_Object((1,3,6,1,4,1,2076,83,1,4,1,1))
...
fsDiffServInProfileActionId=_FsDiffServInProfileActionId_Object((1,3,6,1,4,1,2076,83,1,4,1,1,1),_FsDiffServInProfileActionId_Type())
...
fsDiffServInProfileActionFlag=_FsDiffServInProfileActionFlag_Object((1,3,6,1,4,1,2076,83,1,4,1,1,2),_FsDiffServInProfileActionFlag_Type())
...
fsDiffServInProfileActionNewPrio=_FsDiffServInProfileActionNewPrio_Object((1,3,6,1,4,1,2076,83,1,4,1,1,3),_FsDiffServInProfileActionNewPrio_Type())
...
fsDiffServInProfileActionIpTOS=_FsDiffServInProfileActionIpTOS_Object((1,3,6,1,4,1,2076,83,1,4,1,1,4),_FsDiffServInProfileActionIpTOS_Type())
...
fsDiffServInProfileActionPort=_FsDiffServInProfileActionPort_Object((1,3,6,1,4,1,2076,83,1,4,1,1,5),_FsDiffServInProfileActionPort_Type())
...
fsDiffServInProfileActionDscp=_FsDiffServInProfileActionDscp_Object((1,3,6,1,4,1,2076,83,1,4,1,1,6),_FsDiffServInProfileActionDscp_Type())
...
fsDiffServInProfileActionStatus=_FsDiffServInProfileActionStatus_Object((1,3,6,1,4,1,2076,83,1,4,1,1,7),_FsDiffServInProfileActionStatus_Type())
...
fsDiffServOutProfileAction=_FsDiffServOutProfileAction_ObjectIdentity((1,3,6,1,4,1,2076,83,1,5))
_FsDiffServOutProfileActionTable_Object=MibTable
fsDiffServOutProfileActionTable=_FsDiffServOutProfileActionTable_Object((1,3,6,1,4,1,2076,83,1,5,1))
if mibBuilder.loadTexts:fsDiffServOutProfileActionTable.setStatus(_A)
_FsDiffServOutProfileActionEntry_Object=MibTableRow
fsDiffServOutProfileActionEntry=_FsDiffServOutProfileActionEntry_Object((1,3,6,1,4,1,2076,83,1,5,1,1))
...
fsDiffServOutProfileActionId=_FsDiffServOutProfileActionId_Object((1,3,6,1,4,1,2076,83,1,5,1,1,1),_FsDiffServOutProfileActionId_Type())
...
fsDiffServOutProfileActionFlag=_FsDiffServOutProfileActionFlag_Object((1,3,6,1,4,1,2076,83,1,5,1,1,2),_FsDiffServOutProfileActionFlag_Type())
...
fsDiffServOutProfileActionDscp=_FsDiffServOutProfileActionDscp_Object((1,3,6,1,4,1,2076,83,1,5,1,1,3),_FsDiffServOutProfileActionDscp_Type())
...
fsDiffServOutProfileActionMID=_FsDiffServOutProfileActionMID_Object((1,3,6,1,4,1,2076,83,1,5,1,1,4),_FsDiffServOutProfileActionMID_Type())
...
fsDiffServOutProfileActionStatus=_FsDiffServOutProfileActionStatus_Object((1,3,6,1,4,1,2076,83,1,5,1,1,5),_FsDiffServOutProfileActionStatus_Type())
...
fsDiffServMeter=_FsDiffServMeter_ObjectIdentity((1,3,6,1,4,1,2076,83,1,6))
_FsDiffServMeterTable_Object=MibTable
fsDiffServMeterTable=_FsDiffServMeterTable_Object((1,3,6,1,4,1,2076,83,1,6,1))
if mibBuilder.loadTexts:fsDiffServMeterTable.setStatus(_A)
_FsDiffServMeterEntry_Object=MibTableRow
fsDiffServMeterEntry=_FsDiffServMeterEntry_Object((1,3,6,1,4,1,2076,83,1,6,1,1))
...
fsDiffServMeterId=_FsDiffServMeterId_Object((1,3,6,1,4,1,2076,83,1,6,1,1,1),_FsDiffServMeterId_Type())
...
fsDiffServMetertokenSize=_FsDiffServMetertokenSize_Object((1,3,6,1,4,1,2076,83,1,6,1,1,2),_FsDiffServMetertokenSize_Type())
...
fsDiffServMeterRefreshCount=_FsDiffServMeterRefreshCount_Object((1,3,6,1,4,1,2076,83,1,6,1,1,3),_FsDiffServMeterRefreshCount_Type())
...
fsDiffServMeterStatus=_FsDiffServMeterStatus_Object((1,3,6,1,4,1,2076,83,1,6,1,1,4),_FsDiffServMeterStatus_Type())
...
fsDiffServScheduler=_FsDiffServScheduler_ObjectIdentity((1,3,6,1,4,1,2076,83,1,7))
_FsDiffServSchedulerTable_Object=MibTable
fsDiffServSchedulerTable=_FsDiffServSchedulerTable_Object((1,3,6,1,4,1,2076,83,1,7,1))
if mibBuilder.loadTexts:fsDiffServSchedulerTable.setStatus(_A)
_FsDiffServSchedulerEntry_Object=MibTableRow
fsDiffServSchedulerEntry=_FsDiffServSchedulerEntry_Object((1,3,6,1,4,1,2076,83,1,7,1,1))
...
fsDiffServSchedulerId=_FsDiffServSchedulerId_Object((1,3,6,1,4,1,2076,83,1,7,1,1,1),_FsDiffServSchedulerId_Type())
...
fsDiffServSchedulerDPId=_FsDiffServSchedulerDPId_Object((1,3,6,1,4,1,2076,83,1,7,1,1,2),_FsDiffServSchedulerDPId_Type())
...
_FsDiffServSchedulerQueueCount_Type.__name__=_G
_FsDiffServSchedulerQueueCount_Object=MibTableColumn
fsDiffServSchedulerQueueCount=_FsDiffServSchedulerQueueCount_Object((1,3,6,1,4,1,2076,83,1,7,1,1,3),_FsDiffServSchedulerQueueCount_Type())
...
_FsDiffServSchedulerWeight_Type.__name__=_H
_FsDiffServSchedulerWeight_Object=MibTableColumn
fsDiffServSchedulerWeight=_FsDiffServSchedulerWeight_Object((1,3,6,1,4,1,2076,83,1,7,1,1,4),_FsDiffServSchedulerWeight_Type())
...
fsDiffServSchedulerStatus=_FsDiffServSchedulerStatus_Object((1,3,6,1,4,1,2076,83,1,7,1,1,5),_FsDiffServSchedulerStatus_Type())
fsDiffServSchedulerStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:fsDiffServSchedulerStatus.setStatus(_A)
_FsDiffServFutureCoSqAlgorithm_ObjectIdentity=ObjectIdentity
fsDiffServFutureCoSqAlgorithm=_FsDiffServFutureCoSqAlgorithm_ObjectIdentity((1,3,6,1,4,1,2076,83,1,8))
_FsDiffServCoSqAlgorithmTable_Object=MibTable
fsDiffServCoSqAlgorithmTable=_FsDiffServCoSqAlgorithmTable_Object((1,3,6,1,4,1,2076,83,1,8,1))
if mibBuilder.loadTexts:fsDiffServCoSqAlgorithmTable.setStatus(_A)
_FsDiffServCoSqAlgorithmEntry_Object=MibTableRow
fsDiffServCoSqAlgorithmEntry=_FsDiffServCoSqAlgorithmEntry_Object((1,3,6,1,4,1,2076,83,1,8,1,1))
fsDiffServCoSqAlgorithmEntry.setIndexNames((0,_D,_O))
if mibBuilder.loadTexts:fsDiffServCoSqAlgorithmEntry.setStatus(_A)
class _FsDiffServPortId_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,24))
_FsDiffServPortId_Type.__name__=_C
_FsDiffServPortId_Object=MibTableColumn
fsDiffServPortId=_FsDiffServPortId_Object((1,3,6,1,4,1,2076,83,1,8,1,1,1),_FsDiffServPortId_Type())
fsDiffServPortId.setMaxAccess(_E)
if mibBuilder.loadTexts:fsDiffServPortId.setStatus(_A)
class _FsDiffServCoSqAlgorithm_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*(('strictPriority',1),('roundRobin',2),('weightedRoundRobin',3),('weightedFairQueing',4),('strictRoundRobin',5),('strictWeightedRoundRobin',6),('strictWeightedFairQueing',7),('deficitRoundRobin',8)))
_FsDiffServCoSqAlgorithm_Type.__name__=_C
_FsDiffServCoSqAlgorithm_Object=MibTableColumn
fsDiffServCoSqAlgorithm=_FsDiffServCoSqAlgorithm_Object((1,3,6,1,4,1,2076,83,1,8,1,1,2),_FsDiffServCoSqAlgorithm_Type())
fsDiffServCoSqAlgorithm.setMaxAccess(_B)
if mibBuilder.loadTexts:fsDiffServCoSqAlgorithm.setStatus(_A)
_FsDiffServFutureCoSqWeightBw_ObjectIdentity=ObjectIdentity
fsDiffServFutureCoSqWeightBw=_FsDiffServFutureCoSqWeightBw_ObjectIdentity((1,3,6,1,4,1,2076,83,1,9))
_FsDiffServCoSqWeightBwTable_Object=MibTable
fsDiffServCoSqWeightBwTable=_FsDiffServCoSqWeightBwTable_Object((1,3,6,1,4,1,2076,83,1,9,1))
if mibBuilder.loadTexts:fsDiffServCoSqWeightBwTable.setStatus(_A)
_FsDiffServCoSqWeightBwEntry_Object=MibTableRow
fsDiffServCoSqWeightBwEntry=_FsDiffServCoSqWeightBwEntry_Object((1,3,6,1,4,1,2076,83,1,9,1,1))
fsDiffServCoSqWeightBwEntry.setIndexNames((0,_D,_P),(0,_D,_Q))
if mibBuilder.loadTexts:fsDiffServCoSqWeightBwEntry.setStatus(_A)
class _FsDiffServBaseCoSqPortId_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,24))
_FsDiffServBaseCoSqPortId_Type.__name__=_C
_FsDiffServBaseCoSqPortId_Object=MibTableColumn
fsDiffServBaseCoSqPortId=_FsDiffServBaseCoSqPortId_Object((1,3,6,1,4,1,2076,83,1,9,1,1,1),_FsDiffServBaseCoSqPortId_Type())
fsDiffServBaseCoSqPortId.setMaxAccess(_E)
if mibBuilder.loadTexts:fsDiffServBaseCoSqPortId.setStatus(_A)
class _FsDiffServPortCoSqId_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,7))
_FsDiffServPortCoSqId_Type.__name__=_C
_FsDiffServPortCoSqId_Object=MibTableColumn
fsDiffServPortCoSqId=_FsDiffServPortCoSqId_Object((1,3,6,1,4,1,2076,83,1,9,1,1,2),_FsDiffServPortCoSqId_Type())
fsDiffServPortCoSqId.setMaxAccess(_E)
if mibBuilder.loadTexts:fsDiffServPortCoSqId.setStatus(_A)
class _FsDiffServCoSqWeight_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,15))
_FsDiffServCoSqWeight_Type.__name__=_C
_FsDiffServCoSqWeight_Object=MibTableColumn
fsDiffServCoSqWeight=_FsDiffServCoSqWeight_Object((1,3,6,1,4,1,2076,83,1,9,1,1,3),_FsDiffServCoSqWeight_Type())
fsDiffServCoSqWeight.setMaxAccess(_B)
if mibBuilder.loadTexts:fsDiffServCoSqWeight.setStatus(_A)
class _FsDiffServCoSqBwMin_Type(Unsigned32):subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,262143))
_FsDiffServCoSqBwMin_Type.__name__=_G
_FsDiffServCoSqBwMin_Object=MibTableColumn
fsDiffServCoSqBwMin=_FsDiffServCoSqBwMin_Object((1,3,6,1,4,1,2076,83,1,9,1,1,4),_FsDiffServCoSqBwMin_Type())
fsDiffServCoSqBwMin.setMaxAccess(_B)
if mibBuilder.loadTexts:fsDiffServCoSqBwMin.setStatus(_A)
class _FsDiffServCoSqBwMax_Type(Unsigned32):subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,262143))
_FsDiffServCoSqBwMax_Type.__name__=_G
_FsDiffServCoSqBwMax_Object=MibTableColumn
fsDiffServCoSqBwMax=_FsDiffServCoSqBwMax_Object((1,3,6,1,4,1,2076,83,1,9,1,1,5),_FsDiffServCoSqBwMax_Type())
fsDiffServCoSqBwMax.setMaxAccess(_R)
if mibBuilder.loadTexts:fsDiffServCoSqBwMax.setStatus(_A)
class _FsDiffServCoSqBwFlags_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('excess',1),('minimum',2)))
_FsDiffServCoSqBwFlags_Type.__name__=_C
_FsDiffServCoSqBwFlags_Object=MibTableColumn
fsDiffServCoSqBwFlags=_FsDiffServCoSqBwFlags_Object((1,3,6,1,4,1,2076,83,1,9,1,1,6),_FsDiffServCoSqBwFlags_Type())
fsDiffServCoSqBwFlags.setMaxAccess(_R)
if mibBuilder.loadTexts:fsDiffServCoSqBwFlags.setStatus(_A)
mibBuilder.exportSymbols(_D,**{'IfDirection':IfDirection,'PortList':PortList,'DscpOrAny':DscpOrAny,'fsDiffServMib':fsDiffServMib,'fsDiffServMIBObjects':fsDiffServMIBObjects,'fsDiffServSystem':fsDiffServSystem,'fsDsSystemControl':fsDsSystemControl,'fsDsStatus':fsDsStatus,'fsDiffServMFClassifier':fsDiffServMFClassifier,'fsDiffServMultiFieldClfrTable':fsDiffServMultiFieldClfrTable,'fsDiffServMultiFieldClfrEntry':fsDiffServMultiFieldClfrEntry,_I:fsDiffServMultiFieldClfrId,'fsDiffServMultiFieldClfrFilterId':fsDiffServMultiFieldClfrFilterId,'fsDiffServMultiFieldClfrFilterType':fsDiffServMultiFieldClfrFilterType,'fsDiffServMultiFieldClfrStatus':fsDiffServMultiFieldClfrStatus,'fsDiffServClassifier':fsDiffServClassifier,'fsDiffServClfrTable':fsDiffServClfrTable,'fsDiffServClfrEntry':fsDiffServClfrEntry,_J:fsDiffServClfrId,'fsDiffServClfrMFClfrId':fsDiffServClfrMFClfrId,'fsDiffServClfrInProActionId':fsDiffServClfrInProActionId,'fsDiffServClfrOutProActionId':fsDiffServClfrOutProActionId,'fsDiffServClfrStatus':fsDiffServClfrStatus,'fsDiffServInProfileAction':fsDiffServInProfileAction,'fsDiffServInProfileActionTable':fsDiffServInProfileActionTable,'fsDiffServInProfileActionEntry':fsDiffServInProfileActionEntry,_K:fsDiffServInProfileActionId,'fsDiffServInProfileActionFlag':fsDiffServInProfileActionFlag,'fsDiffServInProfileActionNewPrio':fsDiffServInProfileActionNewPrio,'fsDiffServInProfileActionIpTOS':fsDiffServInProfileActionIpTOS,'fsDiffServInProfileActionPort':fsDiffServInProfileActionPort,'fsDiffServInProfileActionDscp':fsDiffServInProfileActionDscp,'fsDiffServInProfileActionStatus':fsDiffServInProfileActionStatus,'fsDiffServOutProfileAction':fsDiffServOutProfileAction,'fsDiffServOutProfileActionTable':fsDiffServOutProfileActionTable,'fsDiffServOutProfileActionEntry':fsDiffServOutProfileActionEntry,_L:fsDiffServOutProfileActionId,'fsDiffServOutProfileActionFlag':fsDiffServOutProfileActionFlag,'fsDiffServOutProfileActionDscp':fsDiffServOutProfileActionDscp,'fsDiffServOutProfileActionMID':fsDiffServOutProfileActionMID,'fsDiffServOutProfileActionStatus':fsDiffServOutProfileActionStatus,'fsDiffServMeter':fsDiffServMeter,'fsDiffServMeterTable':fsDiffServMeterTable,'fsDiffServMeterEntry':fsDiffServMeterEntry,_M:fsDiffServMeterId,'fsDiffServMetertokenSize':fsDiffServMetertokenSize,'fsDiffServMeterRefreshCount':fsDiffServMeterRefreshCount,'fsDiffServMeterStatus':fsDiffServMeterStatus,'fsDiffServScheduler':fsDiffServScheduler,'fsDiffServSchedulerTable':fsDiffServSchedulerTable,'fsDiffServSchedulerEntry':fsDiffServSchedulerEntry,_N:fsDiffServSchedulerId,'fsDiffServSchedulerDPId':fsDiffServSchedulerDPId,'fsDiffServSchedulerQueueCount':fsDiffServSchedulerQueueCount,'fsDiffServSchedulerWeight':fsDiffServSchedulerWeight,'fsDiffServSchedulerStatus':fsDiffServSchedulerStatus,'fsDiffServFutureCoSqAlgorithm':fsDiffServFutureCoSqAlgorithm,'fsDiffServCoSqAlgorithmTable':fsDiffServCoSqAlgorithmTable,'fsDiffServCoSqAlgorithmEntry':fsDiffServCoSqAlgorithmEntry,_O:fsDiffServPortId,'fsDiffServCoSqAlgorithm':fsDiffServCoSqAlgorithm,'fsDiffServFutureCoSqWeightBw':fsDiffServFutureCoSqWeightBw,'fsDiffServCoSqWeightBwTable':fsDiffServCoSqWeightBwTable,'fsDiffServCoSqWeightBwEntry':fsDiffServCoSqWeightBwEntry,_P:fsDiffServBaseCoSqPortId,_Q:fsDiffServPortCoSqId,'fsDiffServCoSqWeight':fsDiffServCoSqWeight,'fsDiffServCoSqBwMin':fsDiffServCoSqBwMin,'fsDiffServCoSqBwMax':fsDiffServCoSqBwMax,'fsDiffServCoSqBwFlags':fsDiffServCoSqBwFlags})