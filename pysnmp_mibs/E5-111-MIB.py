...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/calix/E5-111-MIB
...
mibBuilder.exportSymbols("E5-111-MIB", macStatus=macStatus, dhcpAckBySnoopFull=dhcpAckBySnoopFull, sipProfileUriType=sipProfileUriType, tlspvcVpi=tlspvcVpi, paepvcSessionacname=paepvcSessionacname, sipProfile=sipProfile, dspProfileTable=dspProfileTable, sipCallSvcProfileDtmf=sipCallSvcProfileDtmf, adslMaxL2RateForBatchSet=adslMaxL2RateForBatchSet, dtpvcStateCvid=dtpvcStateCvid, voipNumberPlanRowStatus=voipNumberPlanRowStatus, paepvcCPriority=paepvcCPriority, subrPortEntry=subrPortEntry, mltVdcRing=mltVdcRing, mltDetectedDtmfCount=mltDetectedDtmfCount, ppvcTable=ppvcTable, dhcpRouteIP=dhcpRouteIP, ipbpvcDomainVlanTable=ipbpvcDomainVlanTable, ouiFilterVlanFilterMode=ouiFilterVlanFilterMode, voipLineInfoRtpTxPt=voipLineInfoRtpTxPt, aclSetVci=aclSetVci, h248ProfilePhysicalSuffixLength=h248ProfilePhysicalSuffixLength, vlanIsolationTable=vlanIsolationTable, adslLineConfL2ATPR=adslLineConfL2ATPR, h248ProfileEphemeralStartNumber=h248ProfileEphemeralStartNumber, mltOps=mltOps, macfilter=macfilter, voipLineInfoRtpRxCodecType=voipLineInfoRtpRxCodecType, igmpPortCtrlPduEntry=igmpPortCtrlPduEntry, enetSfpInfoTemperature=enetSfpInfoTemperature, macFfStatsTable=macFfStatsTable, ipbpvcPvid=ipbpvcPvid, pppoeAgentEnable=pppoeAgentEnable, pvcEntry=pvcEntry, macFfStaticIPVid=macFfStaticIPVid, powerMgmtParamTable=powerMgmtParamTable, gbond=gbond, paepvcVpi=paepvcVpi, dtpvcStateEntry=dtpvcStateEntry, voipH248StatusMgName=voipH248StatusMgName, severityThresh=severityThresh, alarmCurrParam7=alarmCurrParam7, mltRrg=mltRrg, h248ProfilePbit=h248ProfilePbit, igmpPortCtrlPduTable=igmpPortCtrlPduTable, tlspvcTable=tlspvcTable, dsBcastDisableTable=dsBcastDisableTable, ipbpvcInterfaceIfIndex=ipbpvcInterfaceIfIndex, dhcpSnoopIpTable=dhcpSnoopIpTable, adslMaxRxPowerForBatchSet=adslMaxRxPowerForBatchSet, paepvcSessionEntry=paepvcSessionEntry, adslPortOps2=adslPortOps2, macFfIndex=macFfIndex, paepvcCountPadtRx=paepvcCountPadtRx, rpvcGatewayIpAddress=rpvcGatewayIpAddress, igmpQryRespInterval=igmpQryRespInterval, igmpCountPortEnable=igmpCountPortEnable, qryVidStatusEntry=qryVidStatusEntry, igmpGroupnumberOfMembers=igmpGroupnumberOfMembers, ipbpvcInterfaceEntry=ipbpvcInterfaceEntry, macFfVid=macFfVid, macFfStaticIPPort=macFfStaticIPPort, alarmCurrParam5=alarmCurrParam5, adslLineConfAnnexL=adslLineConfAnnexL, igmpProfileName=igmpProfileName, initialTimeout=initialTimeout, dspProfilePlayBufferMaxDelay=dspProfilePlayBufferMaxDelay, enetMtu=enetMtu, dhcpRelay82ThirdServer=dhcpRelay82ThirdServer, voipLineInfoSipLocalUri2=voipLineInfoSipLocalUri2, voipIp=voipIp, dtpvcDSProfile=dtpvcDSProfile, dhcpRelayTest=dhcpRelayTest, portOperations=portOperations, mvlanUntaggedPorts=mvlanUntaggedPorts, ipbpvcEdgeRouterVid=ipbpvcEdgeRouterVid, powerMgmtL2MaxRate=powerMgmtL2MaxRate, ouiFilterTable=ouiFilterTable, mltVacTip=mltVacTip, ipbpvc=ipbpvc, pvcHelloTime=pvcHelloTime, dhcp=dhcp, voipSipLineConfDspProfile=voipSipLineConfDspProfile, dhcpRelay82EntryOptionMode=dhcpRelay82EntryOptionMode, fwUpgrade=fwUpgrade, iesSeriesCommon=iesSeriesCommon, dsBcastDisableEntry=dsBcastDisableEntry, enetSfpInfoTxpower=enetSfpInfoTxpower, qryVidStatusTable=qryVidStatusTable, rpvcRouteDomainVci=rpvcRouteDomainVci, pvcUsRateLimitEnable=pvcUsRateLimitEnable, adslPortUtilTx=adslPortUtilTx, powerMgmtPSDEntry=powerMgmtPSDEntry, dhcpSnoop=dhcpSnoop, igmpGroupPortIp=igmpGroupPortIp, pvcTable=pvcTable, ipbpvcEdgeRouterRowStatus=ipbpvcEdgeRouterRowStatus, userPriviledge=userPriviledge, arpproxyDhcpIp=arpproxyDhcpIp, rpvcGatewayRowStatus=rpvcGatewayRowStatus, pvcAcName=pvcAcName, ipbpvcDomainName=ipbpvcDomainName, ouiFilterPortTable=ouiFilterPortTable, macFfSrcMask=macFfSrcMask, ouiFilterPortFilterMode=ouiFilterPortFilterMode, dhcpRelayArpShowTable=dhcpRelayArpShowTable, trap=trap, voipPortRXGain=voipPortRXGain, sipProfileProxySvr=sipProfileProxySvr, adslLineStatusEntry=adslLineStatusEntry, sipProfileKeepAlive=sipProfileKeepAlive, paepvcCountVpi=paepvcCountVpi, mvlanName=mvlanName, voipLineInfoRtpRemoteIp2=voipLineInfoRtpRemoteIp2, dhcpSnoopMac=dhcpSnoopMac, userName=userName, adslAlarmProfileForBatchSet=adslAlarmProfileForBatchSet, adslL2ATPRForBatchSet=adslL2ATPRForBatchSet, ipbpvcDomainEntry=ipbpvcDomainEntry, dtpvcSpriority=dtpvcSpriority, macFilterMacCountForBatchSet=macFilterMacCountForBatchSet, aclProfileActionNumber=aclProfileActionNumber, paepvcCountPadrTx=paepvcCountPadrTx, dhcpSnoopEnable=dhcpSnoopEnable, paepvcPvid=paepvcPvid, pvcStatePriority=pvcStatePriority, macFilterPortMacCount=macFilterPortMacCount, maxNumOfOuiFiltersInSystem=maxNumOfOuiFiltersInSystem, snrMgnUcDownshift=snrMgnUcDownshift, maxNumOfMacFiltersPerPort=maxNumOfMacFiltersPerPort, adslLineConfL0toL2Rate=adslLineConfL0toL2Rate, paepvcCountAcSystemErrRx=paepvcCountAcSystemErrRx, macFfArpVid=macFfArpVid, maxNumOfH248Profiles=maxNumOfH248Profiles, sipProfileRegExpire=sipProfileRegExpire, delayedReboot=delayedReboot, mcastBwPortEnable=mcastBwPortEnable, powerMgmtAtucMaxPSD=powerMgmtAtucMaxPSD, fwUpgradeVersion=fwUpgradeVersion, voipSipLineConfSipCallSvcProfile=voipSipLineConfSipCallSvcProfile, h248ProfileEncode=h248ProfileEncode, e5x100=e5x100, pvcProfileUS=pvcProfileUS, aclSetTable=aclSetTable, pppoeAgent=pppoeAgent, dscpMappingEntry=dscpMappingEntry, adslPortTarget=adslPortTarget, igmpProfilePortTable=igmpProfilePortTable, aclProfileTable=aclProfileTable, rpvcEntry=rpvcEntry, aclProfileRuleDestIPMask=aclProfileRuleDestIPMask, dspProfileEntry=dspProfileEntry, aclProfileRuleDestEndPort=aclProfileRuleDestEndPort, maxNumOfMacFiltersInSystem=maxNumOfMacFiltersInSystem, rpvcTable=rpvcTable, macfilterOps=macfilterOps, igmpProfileRowStatus=igmpProfileRowStatus, sipProfileSipPort=sipProfileSipPort, dscpStatusEnable=dscpStatusEnable, vlanIsolationEntry=vlanIsolationEntry, dhcpOffer=dhcpOffer, paepvcCountPppLcpEchoReplyRx=paepvcCountPppLcpEchoReplyRx, maxNumOfSipCallSvcProfiles=maxNumOfSipCallSvcProfiles, ipbpvcInterfaceTable=ipbpvcInterfaceTable, dhcpRelayTestOps=dhcpRelayTestOps, paepvcCountGenericErrRx=paepvcCountGenericErrRx, voipNumberPlanDftTable=voipNumberPlanDftTable, adslLineConfTable=adslLineConfTable, sipCallSvcProfileRowStatus=sipCallSvcProfileRowStatus, macFfstaticIP=macFfstaticIP, dhcpSnoopOps=dhcpSnoopOps, igmpGroupV2Table=igmpGroupV2Table, dtpvcSvid=dtpvcSvid, dspProfileG726Vpi=dspProfileG726Vpi, paepvcSessionsrvcname=paepvcSessionsrvcname, dhcpSnoopMask=dhcpSnoopMask, ipbpvcEntry=ipbpvcEntry, adslAturInpForBatchSet=adslAturInpForBatchSet, rpvcArpAgingTime=rpvcArpAgingTime, adslLineStatusTable=adslLineStatusTable, arpproxyFlushTarget=arpproxyFlushTarget, alarmConfClearable=alarmConfClearable, mltCtr=mltCtr, adslLineConfAtucMaxTxPower=adslLineConfAtucMaxTxPower, snrMgnUcMin=snrMgnUcMin, dspProfileG711Vpi=dspProfileG711Vpi, macFfRowStatus=macFfRowStatus, timeoutSetup=timeoutSetup, rpvcRowStatus=rpvcRowStatus, calixRegistrations=calixRegistrations, mltRtr=mltRtr, paepvcSessionId=paepvcSessionId, igmpPortCtrlPduReportCnt=igmpPortCtrlPduReportCnt, arpproxyFlushInterfaceVid=arpproxyFlushInterfaceVid, userTable=userTable, ipbpvcProfileUS=ipbpvcProfileUS, dhcpRelay82ActiveServer=dhcpRelay82ActiveServer, igmpGroupPortV2Table=igmpGroupPortV2Table, macFfArpIP=macFfArpIP, voipRouteTable=voipRouteTable, pvcUsRateLimitTable=pvcUsRateLimitTable, sipProfilePbit=sipProfilePbit, dhcpRelayArpShowEntry=dhcpRelayArpShowEntry, voipLineInfoRtpRxPt2=voipLineInfoRtpRxPt2, voipH248Status=voipH248Status, h248ProfileMgc2On=h248ProfileMgc2On, counterClearTarget=counterClearTarget, adslPort=adslPort, ouiFilterTableOld=ouiFilterTableOld, adslLineConfAtucCarrierMask0=adslLineConfAtucCarrierMask0, dtpvcStateChannelType=dtpvcStateChannelType, dtpvcStateVpi=dtpvcStateVpi, igmpPortCtrlPduQueryCnt=igmpPortCtrlPduQueryCnt, rpvcNetmask=rpvcNetmask, dhcpStaticTable=dhcpStaticTable, igmpRobust=igmpRobust, gbondGroupPorts=gbondGroupPorts, voipPortOps=voipPortOps, aclProfileRuleDestIP=aclProfileRuleDestIP, voipRingTable=voipRingTable, h248ProfileEphemeralSuffixLength=h248ProfileEphemeralSuffixLength, pppoeAgentInfo=pppoeAgentInfo, paepvcCountGenericErrTx=paepvcCountGenericErrTx, igmpGroupPortV2SourceIp=igmpGroupPortV2SourceIp, dhcpSnoopVid=dhcpSnoopVid, paepvcHelloTime=paepvcHelloTime, paepvcSessionVci=paepvcSessionVci, voipMode=voipMode, e5x111=e5x111, paepvcCountPadtTx=paepvcCountPadtTx, adslOptionMaskForBatchSet=adslOptionMaskForBatchSet, mltDialToneDetected=mltDialToneDetected, aclProfileRuleEndTos=aclProfileRuleEndTos, alarmCurrParam1=alarmCurrParam1, seltLoopEstimateLengthFt=seltLoopEstimateLengthFt, adslPortUtilTable=adslPortUtilTable, voipLineInfoRtpRxCodecType2=voipLineInfoRtpRxCodecType2, alarmCurrEntry=alarmCurrEntry, ipbpvcEncap=ipbpvcEncap, dscpPortEntry=dscpPortEntry, ouiFilterVlanTable=ouiFilterVlanTable, voipDnsIp=voipDnsIp, isConfigChanged=isConfigChanged, enetMtuEntry=enetMtuEntry, dhcpRelay82FourthServer=dhcpRelay82FourthServer, arpproxyMac=arpproxyMac, securedClientTable=securedClientTable, macFfStaticIPEntry=macFfStaticIPEntry, h248ProfileMgcSvr=h248ProfileMgcSvr, igmpNumOfActiveGroups=igmpNumOfActiveGroups, aclProfileEntry=aclProfileEntry, ouiFilterPortEntry=ouiFilterPortEntry, dhcpStats=dhcpStats, arpproxyInterfaceVid=arpproxyInterfaceVid)
mibBuilder.exportSymbols("E5-111-MIB", voipNumberPlanTable=voipNumberPlanTable, h248ProfileEntry=h248ProfileEntry, macFfArIP=macFfArIP, voipPortTel=voipPortTel, securedClientStartIp=securedClientStartIp, ppvcVci=ppvcVci, ipbpvcRouteIp=ipbpvcRouteIp, sipCallSvcProfileEntry=sipCallSvcProfileEntry, igmpFilterTable=igmpFilterTable, ipbpvcRouteDynamicNextHop=ipbpvcRouteDynamicNextHop, ipbpvcStats=ipbpvcStats, dslRateXtucMinTxRate=dslRateXtucMinTxRate, delayedRebootRemainingTime=delayedRebootRemainingTime, powerMgmtPSDTable=powerMgmtPSDTable, sipProfileProxySvrPort=sipProfileProxySvrPort, mltVdcDiff=mltVdcDiff, ipbpvcRouteEntry=ipbpvcRouteEntry, dslRateXturMaxTxRate=dslRateXturMaxTxRate, userAuthServerSecret=userAuthServerSecret, igmpGroupV2Entry=igmpGroupV2Entry, dhcpSnoopIp=dhcpSnoopIp, macAddress=macAddress, dhcpRouteMask=dhcpRouteMask, ipbpvcRouteDynamicMask=ipbpvcRouteDynamicMask, voipNumberPlanName=voipNumberPlanName, voipRingName=voipRingName, macFfArpCounterReplyRXDrop=macFfArpCounterReplyRXDrop, sipProfileTable=sipProfileTable, ipbpvcRouteMask=ipbpvcRouteMask, igmpEnable=igmpEnable, paepvcTable=paepvcTable, adslLineConfAnnexM=adslLineConfAnnexM, igmpProfileMaxGroup=igmpProfileMaxGroup, voipSip=voipSip, alarmConfId=alarmConfId, matchingTimeout=matchingTimeout, dhcpRelay82RelayMode=dhcpRelay82RelayMode, mltRtg=mltRtg, rpvcRouteDomainNetmask=rpvcRouteDomainNetmask, ipbpvcRouteDynamicPriority=ipbpvcRouteDynamicPriority, dhcpRelay82VlanMask=dhcpRelay82VlanMask, dhcpRelayTestIp=dhcpRelayTestIp, ipbpvcIfDynamicTable=ipbpvcIfDynamicTable, voipSipLineConfSipProfile=voipSipLineConfSipProfile, macFfArpCounterRequestTX=macFfArpCounterRequestTX, dscpMappingTable=dscpMappingTable, dhcpStaticIpAddr=dhcpStaticIpAddr, securedClientService=securedClientService, subrPortTel=subrPortTel, dtpvcStateTable=dtpvcStateTable, digitSetup=digitSetup, ppvcMemberEntry=ppvcMemberEntry, alarmCurrIndex=alarmCurrIndex, sipProfileSipSvr=sipProfileSipSvr, paepvcProfileDS=paepvcProfileDS, tlspvcRowStatus=tlspvcRowStatus, counterClearVci=counterClearVci, ipbpvcRouteDynamicTable=ipbpvcRouteDynamicTable, paepvcCountTable=paepvcCountTable, mvlanTranslateIndex=mvlanTranslateIndex, dhcpSnoopPortTable=dhcpSnoopPortTable, snrMgnUrTarget=snrMgnUrTarget, macFfStaticIPRowStatus=macFfStaticIPRowStatus, macFfStatsIndex=macFfStatsIndex, voipH248=voipH248, maxNumOfMvlan=maxNumOfMvlan, adslLineStatusMode=adslLineStatusMode, voipRouteMask=voipRouteMask, paepvcEntry=paepvcEntry, userPassword=userPassword, mltRelayEntry=mltRelayEntry, paepvcCountPadsRx=paepvcCountPadsRx, ipbpvcEdgeRouterEntry=ipbpvcEdgeRouterEntry, pppoeAgentRowStatus=pppoeAgentRowStatus, igmpLeaveCntTotal=igmpLeaveCntTotal, dsBcastDisableVlanId=dsBcastDisableVlanId, igmpProfileTable=igmpProfileTable, sipCallSvcProfileTable=sipCallSvcProfileTable, fwUpgradeStatus=fwUpgradeStatus, aclProfileRuleStartTos=aclProfileRuleStartTos, aclProfileActionrvlan=aclProfileActionrvlan, maxNumOfMcastBw=maxNumOfMcastBw, alarmCurrParam6=alarmCurrParam6, h248ProfileForceVer=h248ProfileForceVer, macFilterPortEnable=macFilterPortEnable, igmpGroupV2Vid=igmpGroupV2Vid, sipCallSvcProfileFax=sipCallSvcProfileFax, dtpvcVci=dtpvcVci, dhcpSnoopTarget=dhcpSnoopTarget, mvlanTranslateStartIp=mvlanTranslateStartIp, pvcStateChannelType=pvcStateChannelType, macFfArpCounterRequestRXDrop=macFfArpCounterRequestRXDrop, mltRLoop=mltRLoop, qryVidConfTable=qryVidConfTable, gbondGroupDownRate=gbondGroupDownRate, igmpGroupPortTable=igmpGroupPortTable, seltLoopEstimateLengthMeter=seltLoopEstimateLengthMeter, mltRelaySet=mltRelaySet, gbondGroupEntry=gbondGroupEntry, igmpPortCtrlAuditLeaveCnt=igmpPortCtrlAuditLeaveCnt, dtpvcRowStatus=dtpvcRowStatus, adslLineProfileForBatchSet=adslLineProfileForBatchSet, ipbpvcRouteNextHop=ipbpvcRouteNextHop, adslAturCarrierMaskForBatchSet=adslAturCarrierMaskForBatchSet, qryVidConfEntry=qryVidConfEntry, mcastBwStartIp=mcastBwStartIp, dhcpSnoopGateway=dhcpSnoopGateway, macFfStatsVid=macFfStatsVid, gbondGroupName=gbondGroupName, extAlarmTable=extAlarmTable, ppvcMemberTable=ppvcMemberTable, voipActiveCallStat=voipActiveCallStat, ppvcMemberVci=ppvcMemberVci, delayedRebootCancel=delayedRebootCancel, ppvcEncap=ppvcEncap, mvlanIndex=mvlanIndex, rpvcIp=rpvcIp, ipbpvcRouteRowStatus=ipbpvcRouteRowStatus, enetSfpInfoEntry=enetSfpInfoEntry, powerMgmtL2Time=powerMgmtL2Time, ipbpvcRouteDynamicMetric=ipbpvcRouteDynamicMetric, maxNumOfDhcpStaticIp=maxNumOfDhcpStaticIp, paepvcServiceName=paepvcServiceName, dhcpRelay82SecondaryServer=dhcpRelay82SecondaryServer, selt=selt, paepvc=paepvc, adslLineConfMinL2Rate=adslLineConfMinL2Rate, sipCallSvcProfilePasswdOn=sipCallSvcProfilePasswdOn, voipLineInfoRtpLocalIp=voipLineInfoRtpLocalIp, adslLineConfNitro=adslLineConfNitro, rpvc=rpvc, rpvcRouteDomainVpi=rpvcRouteDomainVpi, ipbpvcDomainVlanId=ipbpvcDomainVlanId, dtpvcAcName=dtpvcAcName, adslLineConfAturCarrierMask=adslLineConfAturCarrierMask, calixProducts=calixProducts, adslL2TimeForBatchSet=adslL2TimeForBatchSet, aclProfileRuleName=aclProfileRuleName, dhcpSnoopPortEntry=dhcpSnoopPortEntry, mvlan=mvlan, voipRingOff1=voipRingOff1, igmpTimer=igmpTimer, mcastBwPortBandwidth=mcastBwPortBandwidth, enetStats=enetStats, ouiFilterEntry=ouiFilterEntry, dhcpSnoopSmacverifyEnable=dhcpSnoopSmacverifyEnable, h248ProfilePhysicalStartNumber=h248ProfilePhysicalStartNumber, arpproxyIfIndex=arpproxyIfIndex, adslPortBatchSet=adslPortBatchSet, maxNumOfOuiFiltersPerPort=maxNumOfOuiFiltersPerPort, user=user, voipLineInfoSipRemoteUri2=voipLineInfoSipRemoteUri2, voipRouteRowStatus=voipRouteRowStatus, maxNumOfVoipH248MgConf=maxNumOfVoipH248MgConf, voipLineInfoRtpRemotePort2=voipLineInfoRtpRemotePort2, arpproxyFlushOps=arpproxyFlushOps, pvcStateEntry=pvcStateEntry, igmpGroupPortV2Ip=igmpGroupPortV2Ip, igmpCount=igmpCount, macFfArpEntry=macFfArpEntry, acl=acl, arpproxyInterfaceIp=arpproxyInterfaceIp, seltTarget=seltTarget, ipbpvcRowStatus=ipbpvcRowStatus, adslModeForBatchSet=adslModeForBatchSet, mlt=mlt, extAlarmstatus=extAlarmstatus, voipPortTelEntry=voipPortTelEntry, accessCtrl=accessCtrl, aclProfileRowStatus=aclProfileRowStatus, ppvcMemberProfileDS=ppvcMemberProfileDS, dhcpRelay82VlanGateway=dhcpRelay82VlanGateway, macFfArpFlush=macFfArpFlush, dhcpRouteTable=dhcpRouteTable, powerMgmtL2MinRate=powerMgmtL2MinRate, snrMgnUrMin=snrMgnUrMin, voipStats=voipStats, igmpProfilePortProfile=igmpProfilePortProfile, h248ProfileTable=h248ProfileTable, extAlarmTriggeredMode=extAlarmTriggeredMode, paepvcRowStatus=paepvcRowStatus, dspProfileG729Vpi=dspProfileG729Vpi, sipProfileRegSvrPort=sipProfileRegSvrPort, dtpvcCpriority=dtpvcCpriority, aclProfileRuleDmac=aclProfileRuleDmac, ppvc=ppvc, userEntry=userEntry, dtpvcUSProfile=dtpvcUSProfile, voipPortH248TermName=voipPortH248TermName, auditQryInterval=auditQryInterval, extAlarmname=extAlarmname, rpvcRouteDomainRowStatus=rpvcRouteDomainRowStatus, dtpvcSuperChannel=dtpvcSuperChannel, sipCallSvcProfileStateMask=sipCallSvcProfileStateMask, paepvcCountPadiTx=paepvcCountPadiTx, arpproxyTable=arpproxyTable, enetSfpInfoVoltage=enetSfpInfoVoltage, mvlanTranslateTable=mvlanTranslateTable, igmpGroupV2NumOfMembers=igmpGroupV2NumOfMembers, digitPauseTimeout=digitPauseTimeout, snrMgnUcUpshift=snrMgnUcUpshift, alarmOps=alarmOps, mcastBwEntry=mcastBwEntry, ipbpvcInterfaceVid=ipbpvcInterfaceVid, pvc=pvc, aclProfileRulePriority=aclProfileRulePriority, mcastBwBandwidth=mcastBwBandwidth, ipbpvcIfDynamicEntry=ipbpvcIfDynamicEntry, gbondGroupUpRate=gbondGroupUpRate, h248ProfilePhysicalPrefix=h248ProfilePhysicalPrefix, macFfArpCounterEntry=macFfArpCounterEntry, aclSetProfileName=aclSetProfileName, mltVdcTip=mltVdcTip, voipLineInfoRtpLocalPort=voipLineInfoRtpLocalPort, paepvcCountPppLcpCfgReqRx=paepvcCountPppLcpCfgReqRx, aclProfileRuleProtocol=aclProfileRuleProtocol, dspProfilePlayBufferMinDelay=dspProfilePlayBufferMinDelay, ipbpvcEdgeRouterMask=ipbpvcEdgeRouterMask, delayedRebootTimer=delayedRebootTimer, mvlanEntry=mvlanEntry, mcastBwTable=mcastBwTable, dtpvcEntry=dtpvcEntry, adslL0toL2RateForBatchSet=adslL0toL2RateForBatchSet, voipArpShowMac=voipArpShowMac, voipRingSetDefault=voipRingSetDefault, pvcUsRateLimit=pvcUsRateLimit, mvlanRowStatus=mvlanRowStatus, dhcpRelayArpShowMac=dhcpRelayArpShowMac, arpproxyFlushEdgeRouterIp=arpproxyFlushEdgeRouterIp, mltOption=mltOption, adslAtucMaxTxPowerForBatchSet=adslAtucMaxTxPowerForBatchSet, h248ProfileDscp=h248ProfileDscp, macFfArpTable=macFfArpTable, voipRouteGateway=voipRouteGateway, dtpvcStateSvid=dtpvcStateSvid, voipPortEnableStatus=voipPortEnableStatus, igmpCountPortEntry=igmpCountPortEntry, snrMgnEntry=snrMgnEntry, h248ProfileName=h248ProfileName, rpvcVpi=rpvcVpi, h248ProfileTransport=h248ProfileTransport, aclProfileRuleSrcIPMask=aclProfileRuleSrcIPMask, usBcastCtrlRate=usBcastCtrlRate, dhcpRelay82Suboption2Enable=dhcpRelay82Suboption2Enable, h248ProfileMgcPort=h248ProfileMgcPort, adslLineConfUSPhyr=adslLineConfUSPhyr, securedClientIndex=securedClientIndex, igmpCountPortTable=igmpCountPortTable, mcastBwPortEntry=mcastBwPortEntry, maxNumOfQryVid=maxNumOfQryVid, adslLineConfPowerMgmt=adslLineConfPowerMgmt, voipRingOff2=voipRingOff2, voipArpShowEntry=voipArpShowEntry, macFfVlanEntry=macFfVlanEntry)
mibBuilder.exportSymbols("E5-111-MIB", voipPortGainEntry=voipPortGainEntry, profile=profile, voipH248MgPort=voipH248MgPort, voipLineInfoRtpLocalIp2=voipLineInfoRtpLocalIp2, macFfArpCounterReplyTX=macFfArpCounterReplyTX, sipProfileSe=sipProfileSe, macFilterRowStatus=macFilterRowStatus, pvcVpi=pvcVpi, ipbpvcDomainTable=ipbpvcDomainTable, adslAtucCarrierMask1ForBatchSet=adslAtucCarrierMask1ForBatchSet, h248ProfileMgc2Port=h248ProfileMgc2Port, igmpGroupPortV2Vid=igmpGroupPortV2Vid, dhcpRouteIndex=dhcpRouteIndex, igmpGroupIp=igmpGroupIp, paepvcSessionUptime=paepvcSessionUptime, counterClearOps=counterClearOps, rpvcArpFlush=rpvcArpFlush, multicast=multicast, ipbpvcDomainRowStatus=ipbpvcDomainRowStatus, voipPortTXGain=voipPortTXGain, ipbpvcDomainVlanEntry=ipbpvcDomainVlanEntry, rpvcUSProfile=rpvcUSProfile, rpvcGatewayTable=rpvcGatewayTable, rpvcRouteDomainTable=rpvcRouteDomainTable, voipRouteMetric=voipRouteMetric, macFfVlanUnknownUnicast=macFfVlanUnknownUnicast, dhcpRelay82Info=dhcpRelay82Info, mltTarget=mltTarget, voipBootRegDelay=voipBootRegDelay, voipRingOn1=voipRingOn1, dslRateXtucMaxInterleaveDelay=dslRateXtucMaxInterleaveDelay, voipH248LineConfEntry=voipH248LineConfEntry, macFilterTable=macFilterTable, dhcpRelay82Suboption2Info=dhcpRelay82Suboption2Info, arpproxyVpi=arpproxyVpi, rpvcGatewayIp=rpvcGatewayIp, rpvcRouteDomainEntry=rpvcRouteDomainEntry, pvcStateVpi=pvcStateVpi, igmpFilterEntry=igmpFilterEntry, dtpvcVpi=dtpvcVpi, aclProfileRuleNumber=aclProfileRuleNumber, adslLineConfAtucInp=adslLineConfAtucInp, igmpFilterStartIp=igmpFilterStartIp, ipbpvcEdgeRouterTable=ipbpvcEdgeRouterTable, h248ProfileEphemeralPrefix=h248ProfileEphemeralPrefix, vlanIsolation=vlanIsolation, voipLineInfoRtpRxPt=voipLineInfoRtpRxPt, arpproxyInterfaceMask=arpproxyInterfaceMask, macFfArpCounterTable=macFfArpCounterTable, auditQuery=auditQuery, igmpVersion=igmpVersion, securedClientEndIp=securedClientEndIp, voipIpSetVid=voipIpSetVid, mltDialToneDelay=mltDialToneDelay, voipNumberPlanEntry=voipNumberPlanEntry, h248ProfileStartRTPPort=h248ProfileStartRTPPort, voipLineStatusServiceStatus=voipLineStatusServiceStatus, vlanIsolationRowStatus=vlanIsolationRowStatus, h248ProfileSoftswitch=h248ProfileSoftswitch, arpproxyFlush=arpproxyFlush, arpproxyEntry=arpproxyEntry, alarmCurrTrapOid=alarmCurrTrapOid, aclSetVpi=aclSetVpi, sipCallSvcProfileFlashInfo=sipCallSvcProfileFlashInfo, ipbpvcIfDynamicIp=ipbpvcIfDynamicIp, voipLineInfoRtpTxPt2=voipLineInfoRtpTxPt2, pppoeAgentTable=pppoeAgentTable, pvcPriority=pvcPriority, tlspvcSpriority=tlspvcSpriority, igmpLastMemQryInterval=igmpLastMemQryInterval, ipbpvcEdgeRouterIp=ipbpvcEdgeRouterIp, usBcastCtrlEnable=usBcastCtrlEnable, dhcpRelayArpFlushOps=dhcpRelayArpFlushOps, aclProfileRuleVid=aclProfileRuleVid, voipH248LineConfVBDProfile=voipH248LineConfVBDProfile, mvlanEgressPorts=mvlanEgressPorts, h248ProfileEndRTPPort=h248ProfileEndRTPPort, igmpPortNumOfActiveGroups=igmpPortNumOfActiveGroups, arpproxyIp=arpproxyIp, alarmCurrParam4=alarmCurrParam4, voipH248LineConfMgName=voipH248LineConfMgName, alarmCurrParam2=alarmCurrParam2, ouiFilterAddrOld=ouiFilterAddrOld, userRowStatus=userRowStatus, alarmConfTarget=alarmConfTarget, rpvcGatewayEntry=rpvcGatewayEntry, dhcpRelay82ServerVid=dhcpRelay82ServerVid, snrMgnUcMax=snrMgnUcMax, ipbpvcInterfaceRowStatus=ipbpvcInterfaceRowStatus, rpvcDSProfile=rpvcDSProfile, auditQryEnable=auditQryEnable, aclProfileRuleSrcIP=aclProfileRuleSrcIP, userAuthServerPort=userAuthServerPort, voipActiveCallStatFailAttempts=voipActiveCallStatFailAttempts, adslLineConfL2Time=adslLineConfL2Time, aclSetEntry=aclSetEntry, adslLineConfMaxRxPower=adslLineConfMaxRxPower, ipbpvcRouteMetric=ipbpvcRouteMetric, accessSwitchCommonATM=accessSwitchCommonATM, mcastBwPortTable=mcastBwPortTable, dhcpRelay82PrimaryServer=dhcpRelay82PrimaryServer, igmpProfileEntry=igmpProfileEntry, dhcpRelayArpShowVid=dhcpRelayArpShowVid, sipCallSvcProfileSoftSwitchType=sipCallSvcProfileSoftSwitchType, ppvcPriority=ppvcPriority, stdioTimeout=stdioTimeout, voipArpShowIp=voipArpShowIp, maxNumOfSipProfiles=maxNumOfSipProfiles, ppvcPvid=ppvcPvid, mcastBandwidth=mcastBandwidth, voipIpSetMask=voipIpSetMask, voipLineInfoSipLocalUri=voipLineInfoSipLocalUri, enetSfpInfoRxpower=enetSfpInfoRxpower, maxNumOfDspProfiles=maxNumOfDspProfiles, igmpQueryCntTotal=igmpQueryCntTotal, igmpGroupvid=igmpGroupvid, sipProfileEntry=sipProfileEntry, sys=sys, dhcpRelay82EntryEnable=dhcpRelay82EntryEnable, dsBcastDisableRowStatus=dsBcastDisableRowStatus, arpproxyType=arpproxyType, adslAturMaxTxPowerForBatchSet=adslAturMaxTxPowerForBatchSet, macPort=macPort, dscp=dscp, rpvcGatewayVlanId=rpvcGatewayVlanId, alarmSeverityPortTable=alarmSeverityPortTable, macFfStaticIPMask=macFfStaticIPMask, voipNumberPlanPattern=voipNumberPlanPattern, dslRateXturMinTxRate=dslRateXturMinTxRate, dtpvcStateCPriority=dtpvcStateCPriority, snrMgnUrUpshift=snrMgnUrUpshift, ipbpvcVpi=ipbpvcVpi, ipbpvcVci=ipbpvcVci, aclProfileRuleSrcStartPort=aclProfileRuleSrcStartPort, adslLineConfAtucCarrierMask1=adslLineConfAtucCarrierMask1, tlspvcProfileDS=tlspvcProfileDS, dsBcastCtrlEnable=dsBcastCtrlEnable, voipPortGainTable=voipPortGainTable, ipbpvcRoutePriority=ipbpvcRoutePriority, mltVacDiff=mltVacDiff, paepvcPriority=paepvcPriority, adslLineConfAturMaxTxPower=adslLineConfAturMaxTxPower, pvcProfileDS=pvcProfileDS, paepvcCvid=paepvcCvid, clear=clear, igmpProfileEnable=igmpProfileEnable, pvcVci=pvcVci, qryVidRowStatus=qryVidRowStatus, tlspvcEntry=tlspvcEntry, adslLineConfOptionMask=adslLineConfOptionMask, powerMgmtL2ThreshRate=powerMgmtL2ThreshRate, sipProfileDscp=sipProfileDscp, dtpvcStateSPriority=dtpvcStateSPriority, ipbpvcIfDynamicVci=ipbpvcIfDynamicVci, paepvcCountSrvcnameErrRx=paepvcCountSrvcnameErrRx, igmpCountPortLimit=igmpCountPortLimit, sipCallSvcProfileNumberPlanNdc=sipCallSvcProfileNumberPlanNdc, voipLineInfoRtpLocalPort2=voipLineInfoRtpLocalPort2, mcastDefaultBandwidth=mcastDefaultBandwidth, ipbpvcInterfaceVpi=ipbpvcInterfaceVpi, powerMgmtParamEntry=powerMgmtParamEntry, ouiFilterVlanEnable=ouiFilterVlanEnable, adslLineConfPowerMode=adslLineConfPowerMode, ppvcRowStatus=ppvcRowStatus, ipbpvcRouteDynamicEntry=ipbpvcRouteDynamicEntry, macFfTable=macFfTable, arpproxy=arpproxy, macDisplayTarget=macDisplayTarget, adslStats=adslStats, arpproxyFlushEdgeRouterVid=arpproxyFlushEdgeRouterVid, maxNumOfMacFfVlanInSystem=maxNumOfMacFfVlanInSystem, mltRelayTable=mltRelayTable, aclSetRowStatus=aclSetRowStatus, paepvcStats=paepvcStats, userAuthDefaultPriviledge=userAuthDefaultPriviledge, port=port, adslLineConfAnnexI=adslLineConfAnnexI, usbCastCtrl=usbCastCtrl, aclProfileRuleSmac=aclProfileRuleSmac, macFfStatsArIP=macFfStatsArIP, ipbpvcIfDynamicIfIndex=ipbpvcIfDynamicIfIndex, paepvcSessionVpi=paepvcSessionVpi, ipbpvcDomainVlanRowStatus=ipbpvcDomainVlanRowStatus, dhcpRelayArpShowIp=dhcpRelayArpShowIp, igmpFilterIndex=igmpFilterIndex, pvcServiceName=pvcServiceName, voipActiveCallMaxActiveCalls=voipActiveCallMaxActiveCalls, voipActiveCallThreshold=voipActiveCallThreshold, dtpvc=dtpvc, dhcpSnoopRouteMap=dhcpSnoopRouteMap, sipCallSvcProfileFlashType=sipCallSvcProfileFlashType, macFilterPortEntry=macFilterPortEntry, qryVidType=qryVidType, macffStats=macffStats, voipDns=voipDns, arpproxyVci=arpproxyVci, dhcpSnoopMaxcnt=dhcpSnoopMaxcnt, macFfStatsSrcMask=macFfStatsSrcMask, aclProfileRuleSrcEndPort=aclProfileRuleSrcEndPort, queryVid=queryVid, sipProfileName=sipProfileName, sipProfileRowStatus=sipProfileRowStatus, mcastBwEndIp=mcastBwEndIp, paepvcAcName=paepvcAcName, dhcpSnoopCounterTable=dhcpSnoopCounterTable, dhcpRequest=dhcpRequest, adslLineConfL2ATPRT=adslLineConfL2ATPRT, voipRingIndex=voipRingIndex, voipArpFlushOps=voipArpFlushOps, ppvcMemberProfileUS=ppvcMemberProfileUS, adslLineConfAturInp=adslLineConfAturInp, powerMgmtAturMaxPSD=powerMgmtAturMaxPSD, adslL0TimeForBatchSet=adslL0TimeForBatchSet, enetSfpInfoTable=enetSfpInfoTable, interDigitTimeout=interDigitTimeout, dtpvcHelloTime=dtpvcHelloTime, voipH248LineConfTable=voipH248LineConfTable, dspProfileCodec=dspProfileCodec, igmpQryInterval=igmpQryInterval, voipLineStatusTable=voipLineStatusTable, paepvcCountPppLcpEchoReqRx=paepvcCountPppLcpEchoReqRx, ipbpvcIfDynamicMask=ipbpvcIfDynamicMask, aclProfileRuleDestStartPort=aclProfileRuleDestStartPort, voipArpShowTable=voipArpShowTable, ppvcEntry=ppvcEntry, igmpGroupEntry=igmpGroupEntry, dspProfileName=dspProfileName, voipH248LineConfDspProfile=voipH248LineConfDspProfile, voip=voip, voipRingOn2=voipRingOn2, mcastBwRowStatus=mcastBwRowStatus, dscpSrcCodePoint=dscpSrcCodePoint, igmpLeaveMode=igmpLeaveMode, voipH248MgEnable=voipH248MgEnable, rpvcRouteDomainIp=rpvcRouteDomainIp, dscpMapPriority=dscpMapPriority, dhcpRouteVid=dhcpRouteVid, voipH248StatusMgStatus=voipH248StatusMgStatus, ppvcMemberVpi=ppvcMemberVpi, snrMgnUrMax=snrMgnUrMax, dhcpRelay82Table=dhcpRelay82Table, sipCallSvcProfileNumberPlanTable=sipCallSvcProfileNumberPlanTable, macFfStaticIPTable=macFfStaticIPTable, counterClearVpi=counterClearVpi, voipH248MgConf=voipH248MgConf, igmpGroupV2MemberPorts=igmpGroupV2MemberPorts, ipbpvcInterfaceIp=ipbpvcInterfaceIp, mltVRing=mltVRing, maxNumOfOuiFiltersPerVlan=maxNumOfOuiFiltersPerVlan, dhcpDiscovery=dhcpDiscovery, igmpReportCntTotal=igmpReportCntTotal, adslMinL2RateForBatchSet=adslMinL2RateForBatchSet, voipLineInfoRtpTxCodecType=voipLineInfoRtpTxCodecType, alarmconf=alarmconf)
mibBuilder.exportSymbols("E5-111-MIB", dhcpRelayArp=dhcpRelayArp, dhcpRelay82Entry=dhcpRelay82Entry, dhcpStaticRowStatus=dhcpStaticRowStatus, userAuthMode=userAuthMode, dhcpRelayTestStatus=dhcpRelayTestStatus, aclProfileActionrpri=aclProfileActionrpri, mltCtg=mltCtg, adslLineConfMaxL2Rate=adslLineConfMaxL2Rate, igmpProfile=igmpProfile, voipNumberPlanDftRule=voipNumberPlanDftRule, mltForce=mltForce, dhcpRelay82Enable=dhcpRelay82Enable, paepvcSessionTable=paepvcSessionTable, maxNumOfVoipRoute=maxNumOfVoipRoute, voipRingOn3=voipRingOn3, diagnostic=diagnostic, voipH248MgName=voipH248MgName, dhcpRouteGwIP=dhcpRouteGwIP, voipLineInfoRtpTxCodecType2=voipLineInfoRtpTxCodecType2, dslRateLatencyMode=dslRateLatencyMode, alarmConfEntry=alarmConfEntry, macFilterAddr=macFilterAddr, dslRate=dslRate, subrPortName=subrPortName, switch=switch, macFilterPortFilterMode=macFilterPortFilterMode, dsbCastCtrl=dsbCastCtrl, macFfArpPort=macFfArpPort, voipIpSetIp=voipIpSetIp, mvlanTable=mvlanTable, maxNumberOfIgmpProfiles=maxNumberOfIgmpProfiles, ouiFilterVlanEntry=ouiFilterVlanEntry, alarmSeverityPortEntry=alarmSeverityPortEntry, fwUpgradeCheck=fwUpgradeCheck, pvcPvid=pvcPvid, h248Profile=h248Profile, igmpGroupPortvid=igmpGroupPortvid, adslPortOps=adslPortOps, h248ProfileMgc2Svr=h248ProfileMgc2Svr, voipCountryCode=voipCountryCode, tlspvc=tlspvc, auditQryRobust=auditQryRobust, ipbpvcRouteDynamicType=ipbpvcRouteDynamicType, voipPort=voipPort, mltCrg=mltCrg, dtpvcServiceName=dtpvcServiceName, paepvcCountPadoRx=paepvcCountPadoRx, aclProfileActionRate=aclProfileActionRate, snrMgnMode=snrMgnMode, h248ProfileRowStatus=h248ProfileRowStatus, paepvcProfileUS=paepvcProfileUS, ipbpvcInterfaceVci=ipbpvcInterfaceVci, maxNumOfPppoeDhcpRelay82Conf=maxNumOfPppoeDhcpRelay82Conf, sipProfileRegSvr=sipProfileRegSvr, maxNumOfVoipNumberPlan=maxNumOfVoipNumberPlan, sipCallSvcProfileNumberPlanOn=sipCallSvcProfileNumberPlanOn, pvcStateVci=pvcStateVci, arpproxyFlushInterfaceIp=arpproxyFlushInterfaceIp, voipLineStatusEntry=voipLineStatusEntry, macFfStatsEntry=macFfStatsEntry, voipActiveCall=voipActiveCall, gbondGroupRowStatus=gbondGroupRowStatus, dslRateXtucMaxTxRate=dslRateXtucMaxTxRate, macFfVlanTable=macFfVlanTable, dspProfileG723Vpi=dspProfileG723Vpi, macfilterTarget=macfilterTarget, paepvcCountEntry=paepvcCountEntry, ipbpvcTable=ipbpvcTable, voipH248MgH248Profile=voipH248MgH248Profile, tlspvcVci=tlspvcVci, pppoeAgentOptionMode=pppoeAgentOptionMode, macFfArpCounterRequestRX=macFfArpCounterRequestRX, securedClientEntry=securedClientEntry, voipLineInfoEntry=voipLineInfoEntry, arpproxyFlushInterfaceMask=arpproxyFlushInterfaceMask, macTable=macTable, dtpvcStateVci=dtpvcStateVci, igmpLastMemQryRobust=igmpLastMemQryRobust, pvcStatePvid=pvcStatePvid, ppvcMemberRowStatus=ppvcMemberRowStatus, tlspvcProfileUS=tlspvcProfileUS, dtpvcStateEncap=dtpvcStateEncap, alarmConfSeverity=alarmConfSeverity, adslPortUtilRx=adslPortUtilRx, voipNumberPlanIndex=voipNumberPlanIndex, voipRouteIp=voipRouteIp, mvlanTranslateEndIp=mvlanTranslateEndIp, rpvcGatewayPriority=rpvcGatewayPriority, alarmCurrTable=alarmCurrTable, seltOps=seltOps, alarmCurrParam3=alarmCurrParam3, mcastBwIndex=mcastBwIndex, powerMgmtL2Atprt=powerMgmtL2Atprt, alarmConfFacility=alarmConfFacility, ppvcVpi=ppvcVpi, ouiFilterRowStatus=ouiFilterRowStatus, voipLineInfoTable=voipLineInfoTable, paepvcVci=paepvcVci, dhcpAck=dhcpAck, snrMgnUrDownshift=snrMgnUrDownshift, dscpPortTable=dscpPortTable, pvcStateEncap=pvcStateEncap, voipRingEntry=voipRingEntry, mltVacRing=mltVacRing, dhcpRelayTestVid=dhcpRelayTestVid, arpproxyAge=arpproxyAge, igmpGroupV2Ip=igmpGroupV2Ip, subrPortTable=subrPortTable, aesSeriesCommon=aesSeriesCommon, paepvcSessionState=paepvcSessionState, enetSfpInfoTxBias=enetSfpInfoTxBias, ouiFilterPortEnable=ouiFilterPortEnable, voipSipLineConfTable=voipSipLineConfTable, mvlanTranslateEntry=mvlanTranslateEntry, userAuthServerIp=userAuthServerIp, ipbpvcInterfaceMask=ipbpvcInterfaceMask, macEntry=macEntry, ouiFilterAddr=ouiFilterAddr, voipLineInfoSipRemoteUri=voipLineInfoSipRemoteUri, igmpGroupTable=igmpGroupTable, mltRen=mltRen, pvcStateTable=pvcStateTable, dslRateMode=dslRateMode, dsBcastCtrlRate=dsBcastCtrlRate, dhcpRelay82FifthServer=dhcpRelay82FifthServer, ouiFilterEntryOld=ouiFilterEntryOld, macFfArpMac=macFfArpMac, dhcpSnoopIpEntry=dhcpSnoopIpEntry, voipRing=voipRing, dhcpSnoopMaxcntMode=dhcpSnoopMaxcntMode, dhcpRelay82VlanIp=dhcpRelay82VlanIp, voipRouteEntry=voipRouteEntry, seltCableType=seltCableType, sipCallSvcProfilePasswd=sipCallSvcProfilePasswd, macff=macff, aclProfileRuleEtype=aclProfileRuleEtype, voipLineStatusPhoneStatus=voipLineStatusPhoneStatus, voipArp=voipArp, voipNumberPlanRule=voipNumberPlanRule, pvcRowStatus=pvcRowStatus, adslAtucCarrierMask0ForBatchSet=adslAtucCarrierMask0ForBatchSet, adslAtucInpForBatchSet=adslAtucInpForBatchSet, voipPortH248TerminationTable=voipPortH248TerminationTable, dspProfileRowStatus=dspProfileRowStatus, adslLineConfDSPhyr=adslLineConfDSPhyr, macFfArpCounterReplyRX=macFfArpCounterReplyRX, maxNumOfPriorityPvcs=maxNumOfPriorityPvcs, alarmCurrSeverity=alarmCurrSeverity, voipProfile=voipProfile, voipLineInfoRtpRemoteIp=voipLineInfoRtpRemoteIp, dtpvcCvid=dtpvcCvid, macFfStatsSrcIP=macFfStatsSrcIP, extAlarmIndex=extAlarmIndex, igmpGroupPortEntry=igmpGroupPortEntry, tlspvcSvid=tlspvcSvid, pppoeAgentEntry=pppoeAgentEntry, dhcpRouteEntry=dhcpRouteEntry, macFfSrcIP=macFfSrcIP, ipbpvcIfDynamicVpi=ipbpvcIfDynamicVpi, voipActiveCallStatCurrentActiveCalls=voipActiveCallStatCurrentActiveCalls, sipCallSvcProfileNumberPlanCc=sipCallSvcProfileNumberPlanCc, snrMgn=snrMgn, dtpvcTable=dtpvcTable, mltVMetering=mltVMetering, macfilterBatchSet=macfilterBatchSet, dspProfileEchoTail=dspProfileEchoTail, powerMgmtL0Time=powerMgmtL0Time, powerMgmtL2Atpr=powerMgmtL2Atpr, ipbpvcDomainDhcpVlanEnable=ipbpvcDomainDhcpVlanEnable, dhcpSnoopCounterEntry=dhcpSnoopCounterEntry, alarmCurrParam8=alarmCurrParam8, dslRateTable=dslRateTable, maxNumOfPvcs=maxNumOfPvcs, ouiFilterRowStatusOld=ouiFilterRowStatusOld, extAlarmEntry=extAlarmEntry, macStats=macStats, mltResult=mltResult, pvcUsRateLimitEntry=pvcUsRateLimitEntry, aclProfileRuleParamMask=aclProfileRuleParamMask, gbondGroupTable=gbondGroupTable, adslLineConfL0Time=adslLineConfL0Time, igmpFilterEndIp=igmpFilterEndIp, dhcpStaticEntry=dhcpStaticEntry, adslLineConfAdslMode=adslLineConfAdslMode, sipProfilePrack=sipProfilePrack, voipSipLineConfEntry=voipSipLineConfEntry, ipbpvcRouteTable=ipbpvcRouteTable, snrMgnUcTarget=snrMgnUcTarget, igmpProfilePortEntry=igmpProfilePortEntry, voipPortTelTable=voipPortTelTable, dslRateEntry=dslRateEntry, securedClientEnable=securedClientEnable, voipRingOff3=voipRingOff3, rpvcVci=rpvcVci, macFfVlanRowstatus=macFfVlanRowstatus, calixNetworks=calixNetworks, adslLineConfEntry=adslLineConfEntry, macFfEntry=macFfEntry, ppvcMemberPriority=ppvcMemberPriority, igmpGroupPortV2Entry=igmpGroupPortV2Entry, paepvcCountVci=paepvcCountVci, adslPortUtilEntry=adslPortUtilEntry, adslL2ATPRTForBatchSet=adslL2ATPRTForBatchSet, snrMgnTable=snrMgnTable, currNumOfMacFiltersInSystem=currNumOfMacFiltersInSystem, alarmConfTable=alarmConfTable, igmpPortCtrlPduLeaveCnt=igmpPortCtrlPduLeaveCnt, voipPortH248TerminationEntry=voipPortH248TerminationEntry, igmpGroupMemberPorts=igmpGroupMemberPorts, alarmCurrTimeDescr=alarmCurrTimeDescr, ipbpvcPriority=ipbpvcPriority, dslRateXturMaxInterleaveDelay=dslRateXturMaxInterleaveDelay, voipLineInfoRtpRemotePort=voipLineInfoRtpRemotePort, qryVid=qryVid, adslLineUpTime=adslLineUpTime, macFilterPortTable=macFilterPortTable, statistics=statistics, extAlarm=extAlarm, ipbpvcProfile=ipbpvcProfile, h248ProfileVbd=h248ProfileVbd, seltStatus=seltStatus, alarmCurrOccurTime=alarmCurrOccurTime, voipPortTarget=voipPortTarget, sipCallSvcProfileName=sipCallSvcProfileName, alarmCurrDescr=alarmCurrDescr, ipbpvcRouteDynamicIp=ipbpvcRouteDynamicIp, voipNumberPlanDftEntry=voipNumberPlanDftEntry, macFilterEntry=macFilterEntry)
