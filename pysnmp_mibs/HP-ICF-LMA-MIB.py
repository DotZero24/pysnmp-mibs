...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hp/HP-ICF-LMA-MIB
...
hpicfLmaMIB.setRevisions(('2018-10-30 00:00', '2017-06-28 07:10', '2016-02-12 07:10', '2013-04-10 09:00',))
if mibBuilder.loadTexts: hpicfLmaMIB.setLastUpdated('201810300000Z')
...
hpicfLmaUnauthVidLLDPNwkPolicy = MibTableColumn((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 97, 1, 1, 6, 1, 12), TruthValue().clone('false')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hpicfLmaUnauthVidLLDPNwkPolicy.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfLmaCompliance3 = hpicfLmaCompliance3.setStatus('deprecated')
hpicfLmaCompliance4 = ModuleCompliance((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 97, 2, 1, 4)).setObjects(("HP-ICF-LMA-MIB", "hpicfLmaMacGroup1"), ("HP-ICF-LMA-MIB", "hpicfLmaConfigGroup3"), ("HP-ICF-LMA-MIB", "hpicfLmaSessionStatsGroup1"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfLmaCompliance4 = hpicfLmaCompliance4.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfLmaConfigGroup2 = hpicfLmaConfigGroup2.setStatus('deprecated')
hpicfLmaConfigGroup3 = ObjectGroup((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 97, 2, 2, 8)).setObjects(("HP-ICF-LMA-MIB", "hpicfLmaClientLimit"), ("HP-ICF-LMA-MIB", "hpicfLmaQuietPeriod"), ("HP-ICF-LMA-MIB", "hpicfLmaLogoffPeriod"), ("HP-ICF-LMA-MIB", "hpicfLmaAuthVid"), ("HP-ICF-LMA-MIB", "hpicfLmaUnauthVid"), ("HP-ICF-LMA-MIB", "hpicfLmaUnAuthPeriod"), ("HP-ICF-LMA-MIB", "hpicfLmaReauthenticate"), ("HP-ICF-LMA-MIB", "hpicfLmaMacPin"), ("HP-ICF-LMA-MIB", "hpicfLmaUnauthVidLLDPNwkPolicy"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfLmaConfigGroup3 = hpicfLmaConfigGroup3.setStatus('current')
mibBuilder.exportSymbols("HP-ICF-LMA-MIB", hpicfLmaObjects=hpicfLmaObjects, hpicfLmaCompliance4=hpicfLmaCompliance4, hpicfLmaMacEntry=hpicfLmaMacEntry, hpicfLmaConfigObjects=hpicfLmaConfigObjects, hpicfLmaSessionUnauthVid=hpicfLmaSessionUnauthVid, hpicfLmaAssociationMacType=hpicfLmaAssociationMacType, hpicfLmaMacGroup1=hpicfLmaMacGroup1, hpicfLmaConfigTable=hpicfLmaConfigTable, hpicfLmaMacPin=hpicfLmaMacPin, hpicfLmaSessionMacAddr=hpicfLmaSessionMacAddr, hpicfLmaUserRoleAssociationEntry=hpicfLmaUserRoleAssociationEntry, hpicfLmaSessionStateTime=hpicfLmaSessionStateTime, hpicfLmaAssociationEntry=hpicfLmaAssociationEntry, hpicfLmaMacGroup=hpicfLmaMacGroup, hpicfLmaConfigGroup3=hpicfLmaConfigGroup3, hpicfLmaUnauthVid=hpicfLmaUnauthVid, hpicfLmaSessionStatsGroup=hpicfLmaSessionStatsGroup, hpicfLmaAssociationMacValue=hpicfLmaAssociationMacValue, hpicfLmaProfileEntry=hpicfLmaProfileEntry, hpicfLmaUserRoleAssociationMacType=hpicfLmaUserRoleAssociationMacType, hpicfLmaSessionAuthVid=hpicfLmaSessionAuthVid, hpicfLmaMacTable=hpicfLmaMacTable, hpicfLmaConformance=hpicfLmaConformance, hpicfLmaPortNumber=hpicfLmaPortNumber, hpicfLmaReauthenticate=hpicfLmaReauthenticate, hpicfLmaSessionStatsEntry=hpicfLmaSessionStatsEntry, hpicfLmaCompliance2=hpicfLmaCompliance2, hpicfLmaUserRoleAssociationRowStatus=hpicfLmaUserRoleAssociationRowStatus, hpicfLmaSessionUsrNumberCnt=hpicfLmaSessionUsrNumberCnt, hpicfLmaCompliance1=hpicfLmaCompliance1, hpicfLmaMacGrpRowStatus=hpicfLmaMacGrpRowStatus, hpicfLmaProfileCoS=hpicfLmaProfileCoS, hpicfLmaClientLimit=hpicfLmaClientLimit, hpicfLmaNotifications=hpicfLmaNotifications, hpicfLmaAssociationRowStatus=hpicfLmaAssociationRowStatus, hpicfLmaProfileUntaggedVid=hpicfLmaProfileUntaggedVid, hpicfLmaAuthVid=hpicfLmaAuthVid, hpicfLmaConfigGroup1=hpicfLmaConfigGroup1, hpicfLmaScalarObjects=hpicfLmaScalarObjects, hpicfLmaConfigGroup2=hpicfLmaConfigGroup2, hpicfLmaMIB=hpicfLmaMIB, hpicfLmaMacGrpName=hpicfLmaMacGrpName, hpicfLmaMacRowStatus=hpicfLmaMacRowStatus, hpicfLmaMacGrpEntry=hpicfLmaMacGrpEntry, hpicfLmaProfileTable=hpicfLmaProfileTable, hpicfLmaProfileIsAssociated=hpicfLmaProfileIsAssociated, hpicfLmaAssocActiveTable=hpicfLmaAssocActiveTable, hpicfLmaMacType=hpicfLmaMacType, hpicfLmaAssocActiveMacAddress=hpicfLmaAssocActiveMacAddress, PYSNMP_MODULE_ID=hpicfLmaMIB, hpicfLmaConfigEntry=hpicfLmaConfigEntry, hpicfLmaQuietPeriod=hpicfLmaQuietPeriod, hpicfLmaAssocActiveProfileName=hpicfLmaAssocActiveProfileName, hpicfLmaAssocActiveEntry=hpicfLmaAssocActiveEntry, hpicfLmaUserRoleAssociationTable=hpicfLmaUserRoleAssociationTable, hpicfLmaProfileTaggedVids=hpicfLmaProfileTaggedVids, hpicfLmaUnAuthPeriod=hpicfLmaUnAuthPeriod, hpicfLmaSessionStatsTable=hpicfLmaSessionStatsTable, hpicfLmaProfileName=hpicfLmaProfileName, hpicfLmaMacGrpTable=hpicfLmaMacGrpTable, hpicfLmaUserRoleAssociationName=hpicfLmaUserRoleAssociationName, hpicfLmaStatsObjects=hpicfLmaStatsObjects, hpicfLmaSessionStatsGroup1=hpicfLmaSessionStatsGroup1, hpicfLmaGroups=hpicfLmaGroups, hpicfLmaCompliances=hpicfLmaCompliances, hpicfLmaMacValue=hpicfLmaMacValue, hpicfLmaProfileRowStatus=hpicfLmaProfileRowStatus, hpicfLmaUnauthVidLLDPNwkPolicy=hpicfLmaUnauthVidLLDPNwkPolicy, hpicfLmaUserRoleAssociationMacValue=hpicfLmaUserRoleAssociationMacValue, hpicfLmaCompliance3=hpicfLmaCompliance3, hpicfLmaSessionUserRole=hpicfLmaSessionUserRole, hpicfLmaLogoffPeriod=hpicfLmaLogoffPeriod, hpicfLmaAssociationTable=hpicfLmaAssociationTable, hpicfLmaSessionState=hpicfLmaSessionState, hpicfLmaConfigGroup=hpicfLmaConfigGroup)
