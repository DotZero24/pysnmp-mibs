...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-LMA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:35:29 2025
...
_HpicfLmaMacPin_Type.__name__ = "TruthValue"
...
class _HpicfLmaUnauthVidLLDPNwkPolicy_Type(TruthValue):
    """Custom type hpicfLmaUnauthVidLLDPNwkPolicy based on TruthValue"""
    defaultValue = 2


_HpicfLmaUnauthVidLLDPNwkPolicy_Type.__name__ = "TruthValue"
_HpicfLmaUnauthVidLLDPNwkPolicy_Object = MibTableColumn
hpicfLmaUnauthVidLLDPNwkPolicy = _HpicfLmaUnauthVidLLDPNwkPolicy_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 97, 1, 1, 6, 1, 12),
    _HpicfLmaUnauthVidLLDPNwkPolicy_Type()
)
hpicfLmaUnauthVidLLDPNwkPolicy.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfLmaUnauthVidLLDPNwkPolicy.setStatus("current")
...
_HpicfLmaSessionUsrNumberCnt_Type.__name__ = "Counter32"
...
if mibBuilder.loadTexts:
    hpicfLmaConfigGroup2.setStatus("deprecated")

hpicfLmaConfigGroup3 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 97, 2, 2, 8)
)
hpicfLmaConfigGroup3.setObjects(
      *(("HP-ICF-LMA-MIB", "hpicfLmaClientLimit"),
        ("HP-ICF-LMA-MIB", "hpicfLmaQuietPeriod"),
        ("HP-ICF-LMA-MIB", "hpicfLmaLogoffPeriod"),
        ("HP-ICF-LMA-MIB", "hpicfLmaAuthVid"),
        ...
        ("HP-ICF-LMA-MIB", "hpicfLmaReauthenticate"),
        ("HP-ICF-LMA-MIB", "hpicfLmaMacPin"),
        ("HP-ICF-LMA-MIB", "hpicfLmaUnauthVidLLDPNwkPolicy"))
)
if mibBuilder.loadTexts:
    hpicfLmaConfigGroup3.setStatus("current")
...
hpicfLmaCompliance1.setObjects(
      *(("HP-ICF-LMA-MIB", "hpicfLmaMacGroup"),
        ("HP-ICF-LMA-MIB", "hpicfLmaConfigGroup"),
        ("HP-ICF-LMA-MIB", "hpicfLmaSessionStatsGroup"))
)
if mibBuilder.loadTexts:
...
hpicfLmaCompliance2.setObjects(
      *(("HP-ICF-LMA-MIB", "hpicfLmaMacGroup1"),
        ("HP-ICF-LMA-MIB", "hpicfLmaConfigGroup1"),
        ("HP-ICF-LMA-MIB", "hpicfLmaSessionStatsGroup1"))
)
if mibBuilder.loadTexts:
...
hpicfLmaCompliance3.setObjects(
      *(("HP-ICF-LMA-MIB", "hpicfLmaMacGroup1"),
        ("HP-ICF-LMA-MIB", "hpicfLmaConfigGroup2"),
        ("HP-ICF-LMA-MIB", "hpicfLmaSessionStatsGroup1"))
)
if mibBuilder.loadTexts:
...
hpicfLmaCompliance4 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 97, 2, 1, 4)
)
hpicfLmaCompliance4.setObjects(
      *(("HP-ICF-LMA-MIB", "hpicfLmaMacGroup1"),
        ("HP-ICF-LMA-MIB", "hpicfLmaConfigGroup3"),
        ("HP-ICF-LMA-MIB", "hpicfLmaSessionStatsGroup1"))
)
if mibBuilder.loadTexts:
    hpicfLmaCompliance4.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpicfLmaMIB": hpicfLmaMIB,
       ...
       "hpicfLmaUnauthVidLLDPNwkPolicy": hpicfLmaUnauthVidLLDPNwkPolicy,
       ...
       "hpicfLmaCompliance4": hpicfLmaCompliance4,
       ...
       "hpicfLmaConfigGroup3": hpicfLmaConfigGroup3}
)
