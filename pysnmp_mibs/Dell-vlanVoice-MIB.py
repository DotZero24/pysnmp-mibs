# SNMP MIB module (Dell-vlanVoice-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-vlanVoice-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:07:44 2025
...
vlanVoiceUcDeviceEntry.setIndexNames(
    (0, "Dell-vlanVoice-MIB", "vlanVoiceUcDeviceType"),
    (0, "Dell-vlanVoice-MIB", "vlanVoiceUcDeviceMacAddress"),
    (0, "Dell-vlanVoice-MIB", "vlanVoiceUcDeviceInterface"),
)
if mibBuilder.loadTexts:
...
vlanVoiceOUIBasedEntry.setIndexNames(
    (0, "Dell-vlanVoice-MIB", "vlanVoiceOUIBasedPrefix"),
)
if mibBuilder.loadTexts:
