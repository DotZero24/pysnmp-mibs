#
# PySNMP MIB module Dell-vlanVoice-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/dell/Dell-vlanVoice-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:43:30 2025
...
VlanPriority, = mibBuilder.importSymbols("Dell-MIB", "VlanPriority")
...
if mibBuilder.loadTexts: vlanVoice.setOrganization('Dell')
...
vlanVoiceUcDeviceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 48, 54, 10, 1), ).setIndexNames((0, "Dell-vlanVoice-MIB", "vlanVoiceUcDeviceType"), (0, "Dell-vlanVoice-MIB", "vlanVoiceUcDeviceMacAddress"), (0, "Dell-vlanVoice-MIB", "vlanVoiceUcDeviceInterface"))
...
vlanVoiceOUIBasedEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 48, 54, 12, 4, 1), ).setIndexNames((0, "Dell-vlanVoice-MIB", "vlanVoiceOUIBasedPrefix"))
