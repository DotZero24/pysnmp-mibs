...
mibBuilder.exportSymbols("CISCO-VPN-LIC-USAGE-MONITOR-MIB", cvpnLicClntInfoGetReqRx=cvpnLicClntInfoGetReqRx, cvpnLicClntInfoRegReqTx=cvpnLicClntInfoRegReqTx, cvpnLicClntInfoTransferReqTx=cvpnLicClntInfoTransferReqTx, LicServerStatus=LicServerStatus, VPNLicDeviceRole=VPNLicDeviceRole, ciscoVPNSharedLicUsageMandatoryGroup=ciscoVPNSharedLicUsageMandatoryGroup, cvpnLicClient=cvpnLicClient, cvpnLicServerSyncError=cvpnLicServerSyncError, cvpnLicClntInfoTable=cvpnLicClntInfoTable, cvpnLicClntInfoDeviceID=cvpnLicClntInfoDeviceID, cvpnLicServerUtilized=cvpnLicServerUtilized, cvpnLicBkpServerDevID=cvpnLicBkpServerDevID, cvpnLicServerSyncTx=cvpnLicServerSyncTx, cvpnLicClntInfoHigh=cvpnLicClntInfoHigh, cvpnLicServerVPNLicType=cvpnLicServerVPNLicType, cvpnLicServerHelloRx=cvpnLicServerHelloRx, cvpnLicBkpSerAddr=cvpnLicBkpSerAddr, cvpnLicServerStatus=cvpnLicServerStatus, cvpnLicClntInfoPlatLmt=cvpnLicClntInfoPlatLmt, cvpnLicDeviceRole=cvpnLicDeviceRole, cvpnLicClntInfoCurUsage=cvpnLicClntInfoCurUsage, cvpnLicServerAddrType=cvpnLicServerAddrType, cvpnLicBkpServerAddrType=cvpnLicBkpServerAddrType, cvpnLicClntInfoTransferReqError=cvpnLicClntInfoTransferReqError, cvpnLicBkpServerVer=cvpnLicBkpServerVer, cvpnLicClntInfoRelReqError=cvpnLicClntInfoRelReqError, cvpnLicClntInfoTransferReqRx=cvpnLicClntInfoTransferReqRx, cvpnLicBkpServerHAPeerDevID=cvpnLicBkpServerHAPeerDevID, cvpnLicServerEntry=cvpnLicServerEntry, cvpnLicClntInfoRegReqError=cvpnLicClntInfoRegReqError, LicServerRegistered=LicServerRegistered, cvpnLicBkpServerAddr=cvpnLicBkpServerAddr, cvpnLicServerTable=cvpnLicServerTable, cvpnLicBkpServerRegd=cvpnLicBkpServerRegd, cvpnLicClntVPNLicType=cvpnLicClntVPNLicType, cvpnLicServerHelloError=cvpnLicServerHelloError, ciscoVpnLicUsageMonitorMIBGroups=ciscoVpnLicUsageMonitorMIBGroups, cvpnLicClntInfoRelReqRx=cvpnLicClntInfoRelReqRx, cvpnLicServerNumLicAvail=cvpnLicServerNumLicAvail, cvpnLicClntInfoRegReqRx=cvpnLicClntInfoRegReqRx, ciscoVpnLicUsageMonitorMIB=ciscoVpnLicUsageMonitorMIB, cvpnLicServerUpdateTx=cvpnLicServerUpdateTx, cvpnLicClntInfoHostName=cvpnLicClntInfoHostName, cvpnLicClntInfoGetReqError=cvpnLicClntInfoGetReqError, cvpnLicClntInfoGetReqTx=cvpnLicClntInfoGetReqTx, ciscoVpnLicUsageMonitorMIBObjects=ciscoVpnLicUsageMonitorMIBObjects, cvpnLicServerUpdateError=cvpnLicServerUpdateError, cvpnLicServer=cvpnLicServer, cvpnLicClntInfoRelReqTx=cvpnLicClntInfoRelReqTx, ciscoVpnLicUsageMonitorMIBCompliance=ciscoVpnLicUsageMonitorMIBCompliance, cvpnLicServerAddr=cvpnLicServerAddr, cvpnLicBkpServer=cvpnLicBkpServer, ciscoVPNSharedLicOptUsageGroup=ciscoVPNSharedLicOptUsageGroup, VPNLicType=VPNLicType, ciscoVpnLicUsageMonitorMIBConform=ciscoVpnLicUsageMonitorMIBConform, cvpnLicServerVer=cvpnLicServerVer, ciscoVpnLicUsageMonitorMIBCompliances=ciscoVpnLicUsageMonitorMIBCompliances, cvpnLicServerUpdateRx=cvpnLicServerUpdateRx, cvpnLicServerSyncRx=cvpnLicServerSyncRx, cvpnLicClntInfoEntry=cvpnLicClntInfoEntry, cvpnLicBkpServerStatus=cvpnLicBkpServerStatus, cvpnLicBkpServerHAPeerRegd=cvpnLicBkpServerHAPeerRegd, cvpnLicServerHelloTx=cvpnLicServerHelloTx, PYSNMP_MODULE_ID=ciscoVpnLicUsageMonitorMIB, cvpnLicBkpSerAddrType=cvpnLicBkpSerAddrType, cvpnLicServerNumLicCapacity=cvpnLicServerNumLicCapacity)
