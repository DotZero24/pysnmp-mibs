...
CIPsecCryptomapType, CIPsecEncapMode, CIPsecNumCryptoMaps, CIPsecLifetime, CIPsecTransform, CIPsecDiffHellmanGrp, CIPsecSecuritySuite, CIPsecLifesize, CIPsecTunnelIdleTime = mibBuilder.importSymbols("CISCO-IPSEC-TC", "CIPsecCryptomapType", "CIPsecEncapMode", "CIPsecNumCryptoMaps", "CIPsecLifetime", "CIPsecTransform", "CIPsecDiffHellmanGrp", "CIPsecSecuritySuite", "CIPsecLifesize", "CIPsecTunnelIdleTime")
...
mibBuilder.exportSymbols("CISCO-IPSEC-PROVISIONING-MIB", cipsStaticCryptomapAutoPeer=cipsStaticCryptomapAutoPeer, ciscoIPsecProvMIBCompliance=ciscoIPsecProvMIBCompliance, cipsCryptoMaps=cipsCryptoMaps, cipsStaticCryptomapSetEntry=cipsStaticCryptomapSetEntry, cipsIfCryptomapSetInfoEntry=cipsIfCryptomapSetInfoEntry, ciscoIPsecProvInfoGroup=ciscoIPsecProvInfoGroup, ciscoIPsecProvisioningMIBNotifs=ciscoIPsecProvisioningMIBNotifs, ciscoIPsecProvisioningMIBObjects=ciscoIPsecProvisioningMIBObjects, cipsStaticCryptomapTable=cipsStaticCryptomapTable, cipsStaticCryptomapNumPeers=cipsStaticCryptomapNumPeers, cipsIPsecCryMapPeerTable=cipsIPsecCryMapPeerTable, cipsNumTEDCryptomapSets=cipsNumTEDCryptomapSets, cipsStaticCryptomapSetNumIsakmp=cipsStaticCryptomapSetNumIsakmp, cipsTunnelLifetime=cipsTunnelLifetime, cipsStaticCryptomapSetTable=cipsStaticCryptomapSetTable, cipsCryMapPeerAddr=cipsCryMapPeerAddr, ciscoIPsecProvGlobalsGroup=ciscoIPsecProvGlobalsGroup, cipsXformSetCompressionXform=cipsXformSetCompressionXform, cipsStaticCryptomapIdleTimeout=cipsStaticCryptomapIdleTimeout, cipsStaticCryptomapCurPAddr=cipsStaticCryptomapCurPAddr, cipsIPsecGlobals=cipsIPsecGlobals, cipsIfStaticCryptomapSetName=cipsIfStaticCryptomapSetName, ciscoIPsecProvXformsGroup=ciscoIPsecProvXformsGroup, PYSNMP_MODULE_ID=ciscoIPsecProvisioningMIB, cipsIfCryptomapSetInfoTable=cipsIfCryptomapSetInfoTable, ciscoIPsecProvMIBGroups=ciscoIPsecProvMIBGroups, cipsIPsecXformSetTable=cipsIPsecXformSetTable, cipsCryMapPeerStatus=cipsCryMapPeerStatus, cipsStaticCryptomapCurPAddrType=cipsStaticCryptomapCurPAddrType, ciscoIPsecProvisioningMIB=ciscoIPsecProvisioningMIB, cipsXformSetIntegrityXformAh=cipsXformSetIntegrityXformAh, cipsStaticCryptomapPfs=cipsStaticCryptomapPfs, ciscoIPsecProvCryptomapDeleted=ciscoIPsecProvCryptomapDeleted, cipsStaticCryptomapPriority=cipsStaticCryptomapPriority, cipsStaticCryptomapStatus=cipsStaticCryptomapStatus, cipsXformSetMode=cipsXformSetMode, cipsXformSetEncryptionXform=cipsXformSetEncryptionXform, ciscoIPsecProvCryptomapAttached=ciscoIPsecProvCryptomapAttached, cipsIPsecCryMapPeerEntry=cipsIPsecCryMapPeerEntry, cipsIPsecTransforms=cipsIPsecTransforms, cipsCntlCryptomapSetAttached=cipsCntlCryptomapSetAttached, cipsNumDynamicCryptomapSets=cipsNumDynamicCryptomapSets, cipsXformSetName=cipsXformSetName, cipsCntlCryptomapSetDetached=cipsCntlCryptomapSetDetached, cipsCryMapPeerAddrType=cipsCryMapPeerAddrType, ciscoIPsecProvNotifCntlGroup=ciscoIPsecProvNotifCntlGroup, ciscoIPsecProvTedCryptomapGroup=ciscoIPsecProvTedCryptomapGroup, cipsStaticCryptomapSetNumManual=cipsStaticCryptomapSetNumManual, cipsStaticCryptomapSetNumTED=cipsStaticCryptomapSetNumTED, cipsCntlCryptomapAdded=cipsCntlCryptomapAdded, cipsXformSetSuite=cipsXformSetSuite, cipsCryptomapSetIfStatus=cipsCryptomapSetIfStatus, cipsStaticCryptomapIpFilter=cipsStaticCryptomapIpFilter, cipsStaticCryptomapSetSize=cipsStaticCryptomapSetSize, ciscoIPsecProvCryptomapAdded=ciscoIPsecProvCryptomapAdded, ciscoIPsecCryptomapPeerGroup=ciscoIPsecCryptomapPeerGroup, cipsStaticCryptomapLifesize=cipsStaticCryptomapLifesize, ciscoIPsecProvNotifGroup=ciscoIPsecProvNotifGroup, ciscoIPsecProvDynCryptomapGroup=ciscoIPsecProvDynCryptomapGroup, ciscoIPsecProvMIBComplianceRev1=ciscoIPsecProvMIBComplianceRev1, cipsStaticCryptomapEntry=cipsStaticCryptomapEntry, ciscoIPsecProvMIBCompliances=ciscoIPsecProvMIBCompliances, cipsIPsecXformSetEntry=cipsIPsecXformSetEntry, cipsTunnelIdleTimeout=cipsTunnelIdleTimeout, cipsStaticCryptomapSetNumDynamic=cipsStaticCryptomapSetNumDynamic, ciscoIPsecProvCryptomapDetached=ciscoIPsecProvCryptomapDetached, cipsCryptoMapGeneral=cipsCryptoMapGeneral, cipsNumStaticCryptomapSets=cipsNumStaticCryptomapSets, cipsCryMapPeerIndex=cipsCryMapPeerIndex, cipsStaticCryptomapSetNumSAs=cipsStaticCryptomapSetNumSAs, cipsXformSetIntegrityXformEsp=cipsXformSetIntegrityXformEsp, cipsStaticCryptomapLifetime=cipsStaticCryptomapLifetime, cipsCryMapPeerOrder=cipsCryMapPeerOrder, cipsStaticCryptomapXformSetList=cipsStaticCryptomapXformSetList, cipsXformSetStatus=cipsXformSetStatus, cipsCntlCryptomapDeleted=cipsCntlCryptomapDeleted, cipsCryptomapSetIfEntry=cipsCryptomapSetIfEntry, cipsStaticCryptomapDescr=cipsStaticCryptomapDescr, cipsTunnelLifesize=cipsTunnelLifesize, cipsStaticCryptomapSetName=cipsStaticCryptomapSetName, cipsStaticCryotomapNextPIndex=cipsStaticCryotomapNextPIndex, cipsStaticCryptomapLevelHost=cipsStaticCryptomapLevelHost, cipsCntlAllNotifs=cipsCntlAllNotifs, ciscoIPsecProvStCryptomapGroup=ciscoIPsecProvStCryptomapGroup, cipsXformSetId=cipsXformSetId, cipsCryptomapSetIfTable=cipsCryptomapSetIfTable, ciscoIPsecProvisioningMIBConform=ciscoIPsecProvisioningMIBConform, cipsStaticCryptomapType=cipsStaticCryptomapType, cipsNotificationCntl=cipsNotificationCntl)
