...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IPSEC-PROVISIONING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:40:17 2025
...
_CipsTunnelLifetime_Type.__name__ = "CIPsecLifetime"
...
_CipsTunnelLifesize_Type.__name__ = "CIPsecLifesize"
...
_CipsTunnelIdleTimeout_Type.__name__ = "CIPsecTunnelIdleTime"
...
_CipsXformSetEncryptionXform_Type.__name__ = "CIPsecTransform"
...
_CipsXformSetIntegrityXformEsp_Type.__name__ = "CIPsecTransform"
...
_CipsXformSetIntegrityXformAh_Type.__name__ = "CIPsecTransform"
...
_CipsXformSetCompressionXform_Type.__name__ = "CIPsecTransform"
...
_CipsXformSetMode_Type.__name__ = "CIPsecEncapMode"
...
_CipsStaticCryptomapLevelHost_Type.__name__ = "TruthValue"
...
_CipsStaticCryptomapAutoPeer_Type.__name__ = "TruthValue"
...
_CipsCntlAllNotifs_Type.__name__ = "TruthValue"
...
_CipsCntlCryptomapAdded_Type.__name__ = "TruthValue"
...
_CipsCntlCryptomapDeleted_Type.__name__ = "TruthValue"
...
_CipsCntlCryptomapSetAttached_Type.__name__ = "TruthValue"
...
_CipsCntlCryptomapSetDetached_Type.__name__ = "TruthValue"
...
ciscoIPsecProvMIBCompliance.setObjects(
      *(("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvGlobalsGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvXformsGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvStCryptomapGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecCryptomapPeerGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvNotifCntlGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvDynCryptomapGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvTedCryptomapGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvNotifGroup"))
)
if mibBuilder.loadTexts:
...
ciscoIPsecProvMIBComplianceRev1.setObjects(
      *(("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvGlobalsGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvXformsGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvStCryptomapGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecCryptomapPeerGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvNotifCntlGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvInfoGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvDynCryptomapGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvTedCryptomapGroup"),
        ("CISCO-IPSEC-PROVISIONING-MIB", "ciscoIPsecProvNotifGroup"))
)
