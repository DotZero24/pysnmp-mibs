...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/stormshield/STORMSHIELD-IF-MIB
...
snsifComment = MibTableColumn((1, 3, 6, 1, 4, 1, 11256, 1, 4, 1, 1, 39), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: snsifComment.setStatus('current')
mibBuilder.exportSymbols("STORMSHIELD-IF-MIB", snsifIndex=snsifIndex, snsifName=snsifName, snsifInCurThroughput=snsifInCurThroughput, snsifInUdpBytes=snsifInUdpBytes, snsifTcpBytes=snsifTcpBytes, snsifOutMaxThroughput=snsifOutMaxThroughput, snsifOutUdpBytes=snsifOutUdpBytes, snsifMask=snsifMask, snsifAddr=snsifAddr, snsifPktAccepted=snsifPktAccepted, snsifInMaxThroughput=snsifInMaxThroughput, snsifPktFragmented=snsifPktFragmented, snsifType=snsifType, snsifTcpConn=snsifTcpConn, snsifPktUdp=snsifPktUdp, snsifPktTcp=snsifPktTcp, PYSNMP_MODULE_ID=snsif, snsifTable=snsifTable, snsifInTcpBytes=snsifInTcpBytes, snsif=snsif, snsifProtected=snsifProtected, snsifOutCurThroughput=snsifOutCurThroughput, snsifUdpConn=snsifUdpConn, snsifMacThroughput=snsifMacThroughput, snsifInIcmpBytes=snsifInIcmpBytes, snsifUdpConnCount=snsifUdpConnCount, snsifPktIcmp=snsifPktIcmp, snsifCurThroughput=snsifCurThroughput, snsifComment=snsifComment, snsifColor=snsifColor, snsifTotalBytes=snsifTotalBytes, snsifUserName=snsifUserName, snsifTcpConnCount=snsifTcpConnCount, snsifUdpBytes=snsifUdpBytes, snsifPktBlocked=snsifPktBlocked, snsifInTotalBytes=snsifInTotalBytes, snsifOutTcpBytes=snsifOutTcpBytes, snsifMaxThroughput=snsifMaxThroughput, snsifOutIcmpBytes=snsifOutIcmpBytes, snsifOutTotalBytes=snsifOutTotalBytes, snsifDrvName=snsifDrvName, snsifIcmpBytes=snsifIcmpBytes, snsifEntry=snsifEntry)
