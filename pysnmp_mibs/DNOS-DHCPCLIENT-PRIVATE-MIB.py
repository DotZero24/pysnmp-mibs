...
_D='DNOS-DHCPCLIENT-PRIVATE-MIB'
_C='Integer32'
_B='read-only'
_A='current'
...
agentdhcp4ClientLeaseParameters=_Agentdhcp4ClientLeaseParameters_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1))
_Agentdhcp4ClientLeaseParametersTable_Object=MibTable
agentdhcp4ClientLeaseParametersTable=_Agentdhcp4ClientLeaseParametersTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1))
...
agentdhcp4ClientLeaseParametersEntry=_Agentdhcp4ClientLeaseParametersEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1))
...
agentdhcp4ClientInterfaceIndex=_Agentdhcp4ClientInterfaceIndex_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,1),_Agentdhcp4ClientInterfaceIndex_Type())
...
agentdhcp4ClientIpAddress=_Agentdhcp4ClientIpAddress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,2),_Agentdhcp4ClientIpAddress_Type())
...
agentdhcp4ClientSubnetMask=_Agentdhcp4ClientSubnetMask_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,3),_Agentdhcp4ClientSubnetMask_Type())
...
agentdhcp4ClientDhcpServerAddress=_Agentdhcp4ClientDhcpServerAddress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,4),_Agentdhcp4ClientDhcpServerAddress_Type())
...
agentdhcp4ClientState=_Agentdhcp4ClientState_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,5),_Agentdhcp4ClientState_Type())
...
agentdhcp4ClientTransactionID=_Agentdhcp4ClientTransactionID_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,6),_Agentdhcp4ClientTransactionID_Type())
...
agentdhcp4ClientLeaseTime=_Agentdhcp4ClientLeaseTime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,7),_Agentdhcp4ClientLeaseTime_Type())
...
agentdhcp4ClientRenewTime=_Agentdhcp4ClientRenewTime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,8),_Agentdhcp4ClientRenewTime_Type())
...
agentdhcp4ClientRebindTime=_Agentdhcp4ClientRebindTime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,9),_Agentdhcp4ClientRebindTime_Type())
...
agentdhcp4ClientRetryCount=_Agentdhcp4ClientRetryCount_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,100,1,1,1,10),_Agentdhcp4ClientRetryCount_Type())
