# SNMP MIB module (Dell-CLI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-CLI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:09:44 2025
...
rlCLIremoteCLIcommandsEntry.setIndexNames(
    (0, "Dell-CLI-MIB", "rlCLIremoteCLIcommandIndex"),
    (0, "Dell-CLI-MIB", "rlCLIremoteCLIcommandPartNumber"),
)
if mibBuilder.loadTexts:
...
rlCLIremoteCLIoutputsEntry.setIndexNames(
    (0, "Dell-CLI-MIB", "rlCLIremoteCLIoutputRowIndex"),
    (0, "Dell-CLI-MIB", "rlCLIremoteCLIoutputRowPartNumber"),
)
if mibBuilder.loadTexts:
