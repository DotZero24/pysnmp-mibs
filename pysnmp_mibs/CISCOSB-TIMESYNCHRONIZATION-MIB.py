_t='rlSntpAllServerInetAddress'
_s='rlSntpAllServerInetAddressType'
_r='rlSntpAllServerPreference'
_q='rlSntpAllServerIfIndex'
_p='rlSntpAllServerSource'
_o='rlSntpServerInetAddress'
_n='rlSntpServerInetAddressType'
_m='rlSntpAnycastInetIfIndex'
_l='rlSntpBroadcastInetIfIndex'
_k='rlSntpAuthenticationKeyID'
_j='rlSntpServerAddress'
_i='rlSntpAnycastIfIndex'
_h='receiveSend'
_g='receive'
_f='rlSntpBroadcastIfIndex'
_e='ipv6OnlyEnabled'
_d='ipv4OnlyEnabled'
_c='rlSntpNtpConfigSrvEntryType'
_b='RlSntpNtpSyncType'
_a='rlTimeSyncManagedDateTimeIndex'
_Z='dhcpv6'
_Y='dhcpv4'
_X='static'
_W='rlTimeZoneIndex'
...
_G='DisplayString'
_F='not-accessible'
_E='CISCOSB-TIMESYNCHRONIZATION-MIB'
_D='Integer32'
_C='read-write'
_B='read-only'
_A='current'
...
class RlClockStatus(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*(('invalid',1),('manuallySet',2),('synchronizedBySntp',3),('setByRtc',4),('setByPnP',5)))
...
rlTimeSyncMethodMode=_RlTimeSyncMethodMode_ObjectIdentity((1,3,6,1,4,1,9,6,1,101,92,1))
_RlTimeSyncMibVersion_Type=Integer32
_RlTimeSyncMibVersion_Object=MibScalar
rlTimeSyncMibVersion=_RlTimeSyncMibVersion_Object((1,3,6,1,4,1,9,6,1,101,92,1,1),_RlTimeSyncMibVersion_Type())
...
_RndTimeSyncManagedTime_Type.__name__=_G
_RndTimeSyncManagedTime_Object=MibScalar
rndTimeSyncManagedTime=_RndTimeSyncManagedTime_Object((1,3,6,1,4,1,9,6,1,101,92,1,2),_RndTimeSyncManagedTime_Type())
...
_RndTimeSyncManagedDate_Type.__name__=_G
_RndTimeSyncManagedDate_Object=MibScalar
rndTimeSyncManagedDate=_RndTimeSyncManagedDate_Object((1,3,6,1,4,1,9,6,1,101,92,1,3),_RndTimeSyncManagedDate_Type())
...
_RndTimeSyncManagedDateTime_Type.__name__=_G
_RndTimeSyncManagedDateTime_Object=MibScalar
rndTimeSyncManagedDateTime=_RndTimeSyncManagedDateTime_Object((1,3,6,1,4,1,9,6,1,101,92,1,4),_RndTimeSyncManagedDateTime_Type())
...
rlTimeSyncMethod=_RlTimeSyncMethod_Object((1,3,6,1,4,1,9,6,1,101,92,1,5),_RlTimeSyncMethod_Type())
...
_RlTimeZone_Type.__name__=_G
_RlTimeZone_Object=MibScalar
rlTimeZone=_RlTimeZone_Object((1,3,6,1,4,1,9,6,1,101,92,1,6),_RlTimeZone_Type())
...
_RlTimeZoneCode_Type.__name__=_G
_RlTimeZoneCode_Object=MibScalar
rlTimeZoneCode=_RlTimeZoneCode_Object((1,3,6,1,4,1,9,6,1,101,92,1,7),_RlTimeZoneCode_Type())
...
rlDaylightSavingTimeMode=_RlDaylightSavingTimeMode_Object((1,3,6,1,4,1,9,6,1,101,92,1,8),_RlDaylightSavingTimeMode_Type())
...
rlDaylightSavingTimeStart=_RlDaylightSavingTimeStart_Object((1,3,6,1,4,1,9,6,1,101,92,1,9),_RlDaylightSavingTimeStart_Type())
...
rlDaylightSavingTimeEnd=_RlDaylightSavingTimeEnd_Object((1,3,6,1,4,1,9,6,1,101,92,1,10),_RlDaylightSavingTimeEnd_Type())
...
rlDaylightSavingTimeOffset=_RlDaylightSavingTimeOffset_Object((1,3,6,1,4,1,9,6,1,101,92,1,11),_RlDaylightSavingTimeOffset_Type())
...
_RlDaylightSavingTimeCode_Type.__name__=_G
_RlDaylightSavingTimeCode_Object=MibScalar
rlDaylightSavingTimeCode=_RlDaylightSavingTimeCode_Object((1,3,6,1,4,1,9,6,1,101,92,1,12),_RlDaylightSavingTimeCode_Type())
...
rlTZDSTOffset=_RlTZDSTOffset_Object((1,3,6,1,4,1,9,6,1,101,92,1,13),_RlTZDSTOffset_Type())
...
_RlTimeZoneName_Type.__name__=_G
_RlTimeZoneName_Object=MibScalar
rlTimeZoneName=_RlTimeZoneName_Object((1,3,6,1,4,1,9,6,1,101,92,1,14),_RlTimeZoneName_Type())
rlTimeZoneName.setMaxAccess(_C)
if mibBuilder.loadTexts:rlTimeZoneName.setStatus(_A)
_RlTimeZoneTable_Object=MibTable
rlTimeZoneTable=_RlTimeZoneTable_Object((1,3,6,1,4,1,9,6,1,101,92,1,15))
if mibBuilder.loadTexts:rlTimeZoneTable.setStatus(_A)
_RlTimeZoneEntry_Object=MibTableRow
rlTimeZoneEntry=_RlTimeZoneEntry_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1))
rlTimeZoneEntry.setIndexNames((0,_E,_W))
...
rlTimeZoneIndex=_RlTimeZoneIndex_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,1),_RlTimeZoneIndex_Type())
rlTimeZoneIndex.setMaxAccess(_F)
...
rlTimeZoneTimeSyncMethod=_RlTimeZoneTimeSyncMethod_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,2),_RlTimeZoneTimeSyncMethod_Type())
...
_RlTimeZoneTimeZoneOffset_Type.__name__=_G
_RlTimeZoneTimeZoneOffset_Object=MibTableColumn
rlTimeZoneTimeZoneOffset=_RlTimeZoneTimeZoneOffset_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,3),_RlTimeZoneTimeZoneOffset_Type())
...
_RlTimeZoneTimeZoneCode_Type.__name__=_G
_RlTimeZoneTimeZoneCode_Object=MibTableColumn
rlTimeZoneTimeZoneCode=_RlTimeZoneTimeZoneCode_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,4),_RlTimeZoneTimeZoneCode_Type())
...
rlTimeZoneDaylightSavingTimeMode=_RlTimeZoneDaylightSavingTimeMode_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,5),_RlTimeZoneDaylightSavingTimeMode_Type())
...
rlTimeZoneDaylightSavingTimeStart=_RlTimeZoneDaylightSavingTimeStart_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,6),_RlTimeZoneDaylightSavingTimeStart_Type())
...
rlTimeZoneDaylightSavingTimeEnd=_RlTimeZoneDaylightSavingTimeEnd_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,7),_RlTimeZoneDaylightSavingTimeEnd_Type())
...
rlTimeZoneDaylightSavingTimeOffset=_RlTimeZoneDaylightSavingTimeOffset_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,8),_RlTimeZoneDaylightSavingTimeOffset_Type())
...
_RlTimeZoneDaylightSavingTimeCode_Type.__name__=_G
_RlTimeZoneDaylightSavingTimeCode_Object=MibTableColumn
rlTimeZoneDaylightSavingTimeCode=_RlTimeZoneDaylightSavingTimeCode_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,9),_RlTimeZoneDaylightSavingTimeCode_Type())
...
rlTimeZoneTZDSTOffset=_RlTimeZoneTZDSTOffset_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,10),_RlTimeZoneTZDSTOffset_Type())
...
_RlTimeZoneTimeZoneName_Type.__name__=_G
_RlTimeZoneTimeZoneName_Object=MibTableColumn
rlTimeZoneTimeZoneName=_RlTimeZoneTimeZoneName_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,11),_RlTimeZoneTimeZoneName_Type())
rlTimeZoneTimeZoneName.setMaxAccess(_C)
if mibBuilder.loadTexts:rlTimeZoneTimeZoneName.setStatus(_A)
class _RlTimeZoneDataType_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_X,1),('dynamic',2)))
_RlTimeZoneDataType_Type.__name__=_D
_RlTimeZoneDataType_Object=MibTableColumn
rlTimeZoneDataType=_RlTimeZoneDataType_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,12),_RlTimeZoneDataType_Type())
...
rlTimeZoneDataSourceIfIndex=_RlTimeZoneDataSourceIfIndex_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,13),_RlTimeZoneDataSourceIfIndex_Type())
rlTimeZoneDataSourceIfIndex.setMaxAccess(_C)
if mibBuilder.loadTexts:rlTimeZoneDataSourceIfIndex.setStatus(_A)
class _RlTimeZoneDataDynamicConfSource_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_J,1),(_Y,2),(_Z,3)))
_RlTimeZoneDataDynamicConfSource_Type.__name__=_D
_RlTimeZoneDataDynamicConfSource_Object=MibTableColumn
rlTimeZoneDataDynamicConfSource=_RlTimeZoneDataDynamicConfSource_Object((1,3,6,1,4,1,9,6,1,101,92,1,15,1,14),_RlTimeZoneDataDynamicConfSource_Type())
rlTimeZoneDataDynamicConfSource.setMaxAccess(_C)
if mibBuilder.loadTexts:rlTimeZoneDataDynamicConfSource.setStatus(_A)
_RlClockStatus_Type=RlClockStatus
_RlClockStatus_Object=MibScalar
rlClockStatus=_RlClockStatus_Object((1,3,6,1,4,1,9,6,1,101,92,1,16),_RlClockStatus_Type())
...
rlDhcpTimezoneOptionEnabled=_RlDhcpTimezoneOptionEnabled_Object((1,3,6,1,4,1,9,6,1,101,92,1,17),_RlDhcpTimezoneOptionEnabled_Type())
...
_RlAutomaticClockSetFromPCEnabled_Type.__name__=_I
_RlAutomaticClockSetFromPCEnabled_Object=MibScalar
rlAutomaticClockSetFromPCEnabled=_RlAutomaticClockSetFromPCEnabled_Object((1,3,6,1,4,1,9,6,1,101,92,1,18),_RlAutomaticClockSetFromPCEnabled_Type())
...
rlTimeAndDateHaveBeenSet=_RlTimeAndDateHaveBeenSet_Object((1,3,6,1,4,1,9,6,1,101,92,1,19),_RlTimeAndDateHaveBeenSet_Type())
rlTimeAndDateHaveBeenSet.setMaxAccess(_B)
if mibBuilder.loadTexts:rlTimeAndDateHaveBeenSet.setStatus(_A)
_RlTimeSyncManagedDateTimeTable_Object=MibTable
rlTimeSyncManagedDateTimeTable=_RlTimeSyncManagedDateTimeTable_Object((1,3,6,1,4,1,9,6,1,101,92,1,20))
if mibBuilder.loadTexts:rlTimeSyncManagedDateTimeTable.setStatus(_A)
_RlTimeSyncManagedDateTimeEntry_Object=MibTableRow
rlTimeSyncManagedDateTimeEntry=_RlTimeSyncManagedDateTimeEntry_Object((1,3,6,1,4,1,9,6,1,101,92,1,20,1))
rlTimeSyncManagedDateTimeEntry.setIndexNames((0,_E,_a))
if mibBuilder.loadTexts:rlTimeSyncManagedDateTimeEntry.setStatus(_A)
class _RlTimeSyncManagedDateTimeIndex_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,1))
_RlTimeSyncManagedDateTimeIndex_Type.__name__=_D
_RlTimeSyncManagedDateTimeIndex_Object=MibTableColumn
rlTimeSyncManagedDateTimeIndex=_RlTimeSyncManagedDateTimeIndex_Object((1,3,6,1,4,1,9,6,1,101,92,1,20,1,1),_RlTimeSyncManagedDateTimeIndex_Type())
rlTimeSyncManagedDateTimeIndex.setMaxAccess(_F)
if mibBuilder.loadTexts:rlTimeSyncManagedDateTimeIndex.setStatus(_A)
class _RlTimeSyncManagedDateTime_Type(DisplayString):subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(12,12));fixedLength=12
_RlTimeSyncManagedDateTime_Type.__name__=_G
_RlTimeSyncManagedDateTime_Object=MibTableColumn
rlTimeSyncManagedDateTime=_RlTimeSyncManagedDateTime_Object((1,3,6,1,4,1,9,6,1,101,92,1,20,1,2),_RlTimeSyncManagedDateTime_Type())
rlTimeSyncManagedDateTime.setMaxAccess(_C)
if mibBuilder.loadTexts:rlTimeSyncManagedDateTime.setStatus(_A)
_RlTimeSyncManagedDateTimeSource_Type=RlClockStatus
_RlTimeSyncManagedDateTimeSource_Object=MibTableColumn
rlTimeSyncManagedDateTimeSource=_RlTimeSyncManagedDateTimeSource_Object((1,3,6,1,4,1,9,6,1,101,92,1,20,1,3),_RlTimeSyncManagedDateTimeSource_Type())
rlTimeSyncManagedDateTimeSource.setMaxAccess(_B)
if mibBuilder.loadTexts:rlTimeSyncManagedDateTimeSource.setStatus(_A)
_RlSntpNtpClient_ObjectIdentity=ObjectIdentity
rlSntpNtpClient=_RlSntpNtpClient_ObjectIdentity((1,3,6,1,4,1,9,6,1,101,92,2))
_RlSntpNtpConfig_ObjectIdentity=ObjectIdentity
rlSntpNtpConfig=_RlSntpNtpConfig_ObjectIdentity((1,3,6,1,4,1,9,6,1,101,92,2,1))
_RlSntpNtpMibVersion_Type=Integer32
_RlSntpNtpMibVersion_Object=MibScalar
rlSntpNtpMibVersion=_RlSntpNtpMibVersion_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,1),_RlSntpNtpMibVersion_Type())
...
rlSntpNtpConfigMode=_RlSntpNtpConfigMode_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,2),_RlSntpNtpConfigMode_Type())
...
rlSntpNtpConfigSysStratum=_RlSntpNtpConfigSysStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,3),_RlSntpNtpConfigSysStratum_Type())
...
rlSntpNtpConfigPollInterval=_RlSntpNtpConfigPollInterval_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,4),_RlSntpNtpConfigPollInterval_Type())
...
rlSntpNtpConfigPrimaryPollSrvAddr=_RlSntpNtpConfigPrimaryPollSrvAddr_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,5),_RlSntpNtpConfigPrimaryPollSrvAddr_Type())
...
rlSntpNtpConfigPrimaryPollSrvMrid=_RlSntpNtpConfigPrimaryPollSrvMrid_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,6),_RlSntpNtpConfigPrimaryPollSrvMrid_Type())
...
rlSntpNtpConfigPrimaryPollSrvIfIndex=_RlSntpNtpConfigPrimaryPollSrvIfIndex_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,7),_RlSntpNtpConfigPrimaryPollSrvIfIndex_Type())
...
rlSntpNtpConfigPrimaryPollSrvStratum=_RlSntpNtpConfigPrimaryPollSrvStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,8),_RlSntpNtpConfigPrimaryPollSrvStratum_Type())
...
rlSntpNtpConfigSyncSrvAddr=_RlSntpNtpConfigSyncSrvAddr_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,9),_RlSntpNtpConfigSyncSrvAddr_Type())
...
rlSntpNtpConfigSyncSrvMrid=_RlSntpNtpConfigSyncSrvMrid_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,10),_RlSntpNtpConfigSyncSrvMrid_Type())
...
rlSntpNtpConfigSyncSrvIfIndex=_RlSntpNtpConfigSyncSrvIfIndex_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,11),_RlSntpNtpConfigSyncSrvIfIndex_Type())
...
_RlSntpNtpConfigSyncSrvType_Type.__name__=_b
_RlSntpNtpConfigSyncSrvType_Object=MibScalar
rlSntpNtpConfigSyncSrvType=_RlSntpNtpConfigSyncSrvType_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,12),_RlSntpNtpConfigSyncSrvType_Type())
...
rlSntpNtpConfigSyncSrvStratum=_RlSntpNtpConfigSyncSrvStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,13),_RlSntpNtpConfigSyncSrvStratum_Type())
...
rlSntpNtpConfigRetryTimeout=_RlSntpNtpConfigRetryTimeout_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,14),_RlSntpNtpConfigRetryTimeout_Type())
...
rlSntpNtpConfigRetryCnt=_RlSntpNtpConfigRetryCnt_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,15),_RlSntpNtpConfigRetryCnt_Type())
...
rlSntpNtpConfigSrvTable=_RlSntpNtpConfigSrvTable_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,16))
if mibBuilder.loadTexts:rlSntpNtpConfigSrvTable.setStatus(_A)
_RlSntpNtpConfigSrvEntry_Object=MibTableRow
rlSntpNtpConfigSrvEntry=_RlSntpNtpConfigSrvEntry_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,16,1))
rlSntpNtpConfigSrvEntry.setIndexNames((0,_E,_c))
...
rlSntpNtpConfigSrvEntryType=_RlSntpNtpConfigSrvEntryType_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,16,1,1),_RlSntpNtpConfigSrvEntryType_Type())
rlSntpNtpConfigSrvEntryType.setMaxAccess(_F)
...
rlSntpNtpConfigSrvInetAddressType=_RlSntpNtpConfigSrvInetAddressType_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,16,1,2),_RlSntpNtpConfigSrvInetAddressType_Type())
...
rlSntpNtpConfigSrvInetAddress=_RlSntpNtpConfigSrvInetAddress_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,16,1,3),_RlSntpNtpConfigSrvInetAddress_Type())
...
rlSntpNtpConfigSrvMrid=_RlSntpNtpConfigSrvMrid_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,16,1,4),_RlSntpNtpConfigSrvMrid_Type())
...
rlSntpNtpConfigSrvIfIndex=_RlSntpNtpConfigSrvIfIndex_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,16,1,5),_RlSntpNtpConfigSrvIfIndex_Type())
...
rlSntpNtpConfigSrvSyncType=_RlSntpNtpConfigSrvSyncType_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,16,1,6),_RlSntpNtpConfigSrvSyncType_Type())
...
rlSntpNtpConfigSrvStratum=_RlSntpNtpConfigSrvStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,1,16,1,7),_RlSntpNtpConfigSrvStratum_Type())
...
rlSntpConfig=_RlSntpConfig_ObjectIdentity((1,3,6,1,4,1,9,6,1,101,92,2,2))
...
rlSntpClientMode=_RlSntpClientMode_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,1),_RlSntpClientMode_Type())
...
rlSntpUnicastAdminState=_RlSntpUnicastAdminState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,2),_RlSntpUnicastAdminState_Type())
rlSntpUnicastAdminState.setMaxAccess(_C)
if mibBuilder.loadTexts:rlSntpUnicastAdminState.setStatus(_A)
class _RlSntpBroadcastAdminState_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_K,1),(_L,2),(_d,3),(_e,4)))
_RlSntpBroadcastAdminState_Type.__name__=_D
_RlSntpBroadcastAdminState_Object=MibScalar
rlSntpBroadcastAdminState=_RlSntpBroadcastAdminState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,3),_RlSntpBroadcastAdminState_Type())
rlSntpBroadcastAdminState.setMaxAccess(_C)
if mibBuilder.loadTexts:rlSntpBroadcastAdminState.setStatus(_A)
class _RlSntpAnycastAdminState_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_K,1),(_L,2),(_d,3),(_e,4)))
_RlSntpAnycastAdminState_Type.__name__=_D
_RlSntpAnycastAdminState_Object=MibScalar
rlSntpAnycastAdminState=_RlSntpAnycastAdminState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,4),_RlSntpAnycastAdminState_Type())
...
_RlSntpUnicastPollState_Type.__name__=_I
_RlSntpUnicastPollState_Object=MibScalar
rlSntpUnicastPollState=_RlSntpUnicastPollState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,5),_RlSntpUnicastPollState_Type())
...
_RlSntpBroadcastPollState_Type.__name__=_I
_RlSntpBroadcastPollState_Object=MibScalar
rlSntpBroadcastPollState=_RlSntpBroadcastPollState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,6),_RlSntpBroadcastPollState_Type())
...
_RlSntpAnycastPollState_Type.__name__=_I
_RlSntpAnycastPollState_Object=MibScalar
rlSntpAnycastPollState=_RlSntpAnycastPollState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,7),_RlSntpAnycastPollState_Type())
...
rlSntpAuthenticationState=_RlSntpAuthenticationState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,8),_RlSntpAuthenticationState_Type())
...
_RlTimeValidFlag_Type.__name__=_I
_RlTimeValidFlag_Object=MibScalar
rlTimeValidFlag=_RlTimeValidFlag_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,9),_RlTimeValidFlag_Type())
...
rlSntpConfigBroadcastTable=_RlSntpConfigBroadcastTable_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10))
if mibBuilder.loadTexts:rlSntpConfigBroadcastTable.setStatus(_A)
_RlSntpBroadcastEntry_Object=MibTableRow
rlSntpBroadcastEntry=_RlSntpBroadcastEntry_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1))
rlSntpBroadcastEntry.setIndexNames((0,_E,_f))
...
rlSntpBroadcastIfIndex=_RlSntpBroadcastIfIndex_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,1),_RlSntpBroadcastIfIndex_Type())
rlSntpBroadcastIfIndex.setMaxAccess(_F)
...
rlSntpBroadcastIfAdminState=_RlSntpBroadcastIfAdminState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,2),_RlSntpBroadcastIfAdminState_Type())
rlSntpBroadcastIfAdminState.setMaxAccess(_C)
if mibBuilder.loadTexts:rlSntpBroadcastIfAdminState.setStatus(_A)
class _RlSntpBroadcastMode_Type(Integer32):defaultValue=4;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_J,1),(_g,2),('send',3),(_h,4)))
_RlSntpBroadcastMode_Type.__name__=_D
_RlSntpBroadcastMode_Object=MibTableColumn
rlSntpBroadcastMode=_RlSntpBroadcastMode_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,3),_RlSntpBroadcastMode_Type())
...
_RlSntpBroadcastPolled_Type.__name__=_I
_RlSntpBroadcastPolled_Object=MibTableColumn
rlSntpBroadcastPolled=_RlSntpBroadcastPolled_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,4),_RlSntpBroadcastPolled_Type())
...
rlSntpBroadcastAddress=_RlSntpBroadcastAddress_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,5),_RlSntpBroadcastAddress_Type())
...
rlSntpBroadcastStratum=_RlSntpBroadcastStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,6),_RlSntpBroadcastStratum_Type())
...
rlSntpBroadcastLastResp=_RlSntpBroadcastLastResp_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,7),_RlSntpBroadcastLastResp_Type())
...
rlSntpBroadcastStatus=_RlSntpBroadcastStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,8),_RlSntpBroadcastStatus_Type())
...
rlSntpBroadcastOffset=_RlSntpBroadcastOffset_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,9),_RlSntpBroadcastOffset_Type())
rlSntpBroadcastOffset.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpBroadcastOffset.setStatus(_A)
if mibBuilder.loadTexts:rlSntpBroadcastOffset.setUnits(_H)
_RlSntpBroadcastDelay_Type=NTPSignedTimeValue
_RlSntpBroadcastDelay_Object=MibTableColumn
rlSntpBroadcastDelay=_RlSntpBroadcastDelay_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,10),_RlSntpBroadcastDelay_Type())
rlSntpBroadcastDelay.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpBroadcastDelay.setStatus(_A)
if mibBuilder.loadTexts:rlSntpBroadcastDelay.setUnits(_H)
_RlSntpBroadcastRowStatus_Type=RowStatus
_RlSntpBroadcastRowStatus_Object=MibTableColumn
rlSntpBroadcastRowStatus=_RlSntpBroadcastRowStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,10,1,11),_RlSntpBroadcastRowStatus_Type())
...
rlSntpConfigAnycastTable=_RlSntpConfigAnycastTable_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11))
if mibBuilder.loadTexts:rlSntpConfigAnycastTable.setStatus(_A)
_RlSntpAnycastEntry_Object=MibTableRow
rlSntpAnycastEntry=_RlSntpAnycastEntry_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11,1))
rlSntpAnycastEntry.setIndexNames((0,_E,_i))
...
rlSntpAnycastIfIndex=_RlSntpAnycastIfIndex_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11,1,1),_RlSntpAnycastIfIndex_Type())
rlSntpAnycastIfIndex.setMaxAccess(_F)
...
rlSntpAnycastAddress=_RlSntpAnycastAddress_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11,1,2),_RlSntpAnycastAddress_Type())
...
rlSntpAnycastStratum=_RlSntpAnycastStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11,1,3),_RlSntpAnycastStratum_Type())
...
rlSntpAnycastLastResp=_RlSntpAnycastLastResp_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11,1,4),_RlSntpAnycastLastResp_Type())
...
rlSntpAnycastStatus=_RlSntpAnycastStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11,1,5),_RlSntpAnycastStatus_Type())
...
rlSntpAnycastOffset=_RlSntpAnycastOffset_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11,1,6),_RlSntpAnycastOffset_Type())
rlSntpAnycastOffset.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAnycastOffset.setStatus(_A)
if mibBuilder.loadTexts:rlSntpAnycastOffset.setUnits(_H)
_RlSntpAnycastDelay_Type=NTPSignedTimeValue
_RlSntpAnycastDelay_Object=MibTableColumn
rlSntpAnycastDelay=_RlSntpAnycastDelay_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11,1,7),_RlSntpAnycastDelay_Type())
rlSntpAnycastDelay.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAnycastDelay.setStatus(_A)
if mibBuilder.loadTexts:rlSntpAnycastDelay.setUnits(_H)
_RlSntpAnycastRowStatus_Type=RowStatus
_RlSntpAnycastRowStatus_Object=MibTableColumn
rlSntpAnycastRowStatus=_RlSntpAnycastRowStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,11,1,8),_RlSntpAnycastRowStatus_Type())
...
rlSntpConfigServerTable=_RlSntpConfigServerTable_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12))
if mibBuilder.loadTexts:rlSntpConfigServerTable.setStatus(_A)
_RlSntpServerEntry_Object=MibTableRow
rlSntpServerEntry=_RlSntpServerEntry_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1))
rlSntpServerEntry.setIndexNames((0,_E,_j))
...
rlSntpServerAddress=_RlSntpServerAddress_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1,1),_RlSntpServerAddress_Type())
rlSntpServerAddress.setMaxAccess(_F)
if mibBuilder.loadTexts:rlSntpServerAddress.setStatus(_A)
class _RlSntpServerPolled_Type(TruthValue):defaultValue=2
_RlSntpServerPolled_Type.__name__=_I
_RlSntpServerPolled_Object=MibTableColumn
rlSntpServerPolled=_RlSntpServerPolled_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1,2),_RlSntpServerPolled_Type())
...
rlSntpServerStratum=_RlSntpServerStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1,3),_RlSntpServerStratum_Type())
...
rlSntpServerLastResp=_RlSntpServerLastResp_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1,4),_RlSntpServerLastResp_Type())
...
rlSntpServerStatus=_RlSntpServerStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1,5),_RlSntpServerStatus_Type())
...
rlSntpServersOffset=_RlSntpServersOffset_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1,6),_RlSntpServersOffset_Type())
rlSntpServersOffset.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpServersOffset.setStatus(_A)
if mibBuilder.loadTexts:rlSntpServersOffset.setUnits(_H)
_RlSntpServersDelay_Type=NTPSignedTimeValue
_RlSntpServersDelay_Object=MibTableColumn
rlSntpServersDelay=_RlSntpServersDelay_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1,7),_RlSntpServersDelay_Type())
rlSntpServersDelay.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpServersDelay.setStatus(_A)
if mibBuilder.loadTexts:rlSntpServersDelay.setUnits(_H)
_RlSntpServersKeyIdentifier_Type=Unsigned32
_RlSntpServersKeyIdentifier_Object=MibTableColumn
rlSntpServersKeyIdentifier=_RlSntpServersKeyIdentifier_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1,8),_RlSntpServersKeyIdentifier_Type())
...
rlSntpServerRowStatus=_RlSntpServerRowStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,12,1,9),_RlSntpServerRowStatus_Type())
...
rlSntpConfigAuthenticationTable=_RlSntpConfigAuthenticationTable_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,13))
if mibBuilder.loadTexts:rlSntpConfigAuthenticationTable.setStatus(_A)
_RlSntpAuthenticationEntry_Object=MibTableRow
rlSntpAuthenticationEntry=_RlSntpAuthenticationEntry_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,13,1))
rlSntpAuthenticationEntry.setIndexNames((0,_E,_k))
...
rlSntpAuthenticationKeyID=_RlSntpAuthenticationKeyID_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,13,1,1),_RlSntpAuthenticationKeyID_Type())
...
_RlSntpAuthenticationKeyValue_Type.__name__=_G
_RlSntpAuthenticationKeyValue_Object=MibTableColumn
rlSntpAuthenticationKeyValue=_RlSntpAuthenticationKeyValue_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,13,1,2),_RlSntpAuthenticationKeyValue_Type())
...
rlSntpAuthenticationKeyState=_RlSntpAuthenticationKeyState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,13,1,3),_RlSntpAuthenticationKeyState_Type())
...
rlSntpAuthenticationRowStatus=_RlSntpAuthenticationRowStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,13,1,4),_RlSntpAuthenticationRowStatus_Type())
...
rlSntpPort=_RlSntpPort_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,14),_RlSntpPort_Type())
rlSntpPort.setMaxAccess(_C)
if mibBuilder.loadTexts:rlSntpPort.setStatus(_A)
_RlSntpConfigBroadcastInetTable_Object=MibTable
rlSntpConfigBroadcastInetTable=_RlSntpConfigBroadcastInetTable_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15))
if mibBuilder.loadTexts:rlSntpConfigBroadcastInetTable.setStatus(_A)
_RlSntpBroadcastInetEntry_Object=MibTableRow
rlSntpBroadcastInetEntry=_RlSntpBroadcastInetEntry_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1))
rlSntpBroadcastInetEntry.setIndexNames((0,_E,_l))
...
rlSntpBroadcastInetIfIndex=_RlSntpBroadcastInetIfIndex_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,1),_RlSntpBroadcastInetIfIndex_Type())
rlSntpBroadcastInetIfIndex.setMaxAccess(_F)
...
rlSntpBroadcastInetIfAdminState=_RlSntpBroadcastInetIfAdminState_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,2),_RlSntpBroadcastInetIfAdminState_Type())
rlSntpBroadcastInetIfAdminState.setMaxAccess(_C)
if mibBuilder.loadTexts:rlSntpBroadcastInetIfAdminState.setStatus(_A)
class _RlSntpBroadcastInetMode_Type(Integer32):defaultValue=4;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_J,1),(_g,2),('send',3),(_h,4)))
_RlSntpBroadcastInetMode_Type.__name__=_D
_RlSntpBroadcastInetMode_Object=MibTableColumn
rlSntpBroadcastInetMode=_RlSntpBroadcastInetMode_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,3),_RlSntpBroadcastInetMode_Type())
...
_RlSntpBroadcastInetPolled_Type.__name__=_I
_RlSntpBroadcastInetPolled_Object=MibTableColumn
rlSntpBroadcastInetPolled=_RlSntpBroadcastInetPolled_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,4),_RlSntpBroadcastInetPolled_Type())
...
rlSntpBroadcastInetAddressType=_RlSntpBroadcastInetAddressType_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,5),_RlSntpBroadcastInetAddressType_Type())
...
rlSntpBroadcastInetAddress=_RlSntpBroadcastInetAddress_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,6),_RlSntpBroadcastInetAddress_Type())
...
rlSntpBroadcastInetStratum=_RlSntpBroadcastInetStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,7),_RlSntpBroadcastInetStratum_Type())
...
rlSntpBroadcastInetLastResp=_RlSntpBroadcastInetLastResp_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,8),_RlSntpBroadcastInetLastResp_Type())
...
rlSntpBroadcastInetStatus=_RlSntpBroadcastInetStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,9),_RlSntpBroadcastInetStatus_Type())
...
rlSntpBroadcastInetOffset=_RlSntpBroadcastInetOffset_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,10),_RlSntpBroadcastInetOffset_Type())
rlSntpBroadcastInetOffset.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpBroadcastInetOffset.setStatus(_A)
if mibBuilder.loadTexts:rlSntpBroadcastInetOffset.setUnits(_H)
_RlSntpBroadcastInetDelay_Type=NTPSignedTimeValue
_RlSntpBroadcastInetDelay_Object=MibTableColumn
rlSntpBroadcastInetDelay=_RlSntpBroadcastInetDelay_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,11),_RlSntpBroadcastInetDelay_Type())
rlSntpBroadcastInetDelay.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpBroadcastInetDelay.setStatus(_A)
if mibBuilder.loadTexts:rlSntpBroadcastInetDelay.setUnits(_H)
_RlSntpBroadcastInetRowStatus_Type=RowStatus
_RlSntpBroadcastInetRowStatus_Object=MibTableColumn
rlSntpBroadcastInetRowStatus=_RlSntpBroadcastInetRowStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,12),_RlSntpBroadcastInetRowStatus_Type())
...
rlSntpBroadcastInetLastReq=_RlSntpBroadcastInetLastReq_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,15,1,13),_RlSntpBroadcastInetLastReq_Type())
rlSntpBroadcastInetLastReq.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpBroadcastInetLastReq.setStatus(_A)
_RlSntpConfigAnycastInetTable_Object=MibTable
rlSntpConfigAnycastInetTable=_RlSntpConfigAnycastInetTable_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16))
if mibBuilder.loadTexts:rlSntpConfigAnycastInetTable.setStatus(_A)
_RlSntpAnycastInetEntry_Object=MibTableRow
rlSntpAnycastInetEntry=_RlSntpAnycastInetEntry_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1))
rlSntpAnycastInetEntry.setIndexNames((0,_E,_m))
...
rlSntpAnycastInetIfIndex=_RlSntpAnycastInetIfIndex_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,1),_RlSntpAnycastInetIfIndex_Type())
rlSntpAnycastInetIfIndex.setMaxAccess(_F)
...
rlSntpAnycastInetAddressType=_RlSntpAnycastInetAddressType_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,2),_RlSntpAnycastInetAddressType_Type())
...
rlSntpAnycastInetAddress=_RlSntpAnycastInetAddress_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,3),_RlSntpAnycastInetAddress_Type())
...
rlSntpAnycastInetStratum=_RlSntpAnycastInetStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,4),_RlSntpAnycastInetStratum_Type())
...
rlSntpAnycastInetLastResp=_RlSntpAnycastInetLastResp_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,5),_RlSntpAnycastInetLastResp_Type())
...
rlSntpAnycastInetStatus=_RlSntpAnycastInetStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,6),_RlSntpAnycastInetStatus_Type())
...
rlSntpAnycastInetOffset=_RlSntpAnycastInetOffset_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,7),_RlSntpAnycastInetOffset_Type())
rlSntpAnycastInetOffset.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAnycastInetOffset.setStatus(_A)
if mibBuilder.loadTexts:rlSntpAnycastInetOffset.setUnits(_H)
_RlSntpAnycastInetDelay_Type=NTPSignedTimeValue
_RlSntpAnycastInetDelay_Object=MibTableColumn
rlSntpAnycastInetDelay=_RlSntpAnycastInetDelay_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,8),_RlSntpAnycastInetDelay_Type())
rlSntpAnycastInetDelay.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAnycastInetDelay.setStatus(_A)
if mibBuilder.loadTexts:rlSntpAnycastInetDelay.setUnits(_H)
_RlSntpAnycastInetRowStatus_Type=RowStatus
_RlSntpAnycastInetRowStatus_Object=MibTableColumn
rlSntpAnycastInetRowStatus=_RlSntpAnycastInetRowStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,9),_RlSntpAnycastInetRowStatus_Type())
...
rlSntpAnycastInetLastReq=_RlSntpAnycastInetLastReq_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,16,1,10),_RlSntpAnycastInetLastReq_Type())
rlSntpAnycastInetLastReq.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAnycastInetLastReq.setStatus(_A)
_RlSntpConfigServerInetTable_Object=MibTable
rlSntpConfigServerInetTable=_RlSntpConfigServerInetTable_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17))
if mibBuilder.loadTexts:rlSntpConfigServerInetTable.setStatus(_A)
_RlSntpServerInetEntry_Object=MibTableRow
rlSntpServerInetEntry=_RlSntpServerInetEntry_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1))
rlSntpServerInetEntry.setIndexNames((0,_E,_n),(0,_E,_o))
...
rlSntpServerInetAddressType=_RlSntpServerInetAddressType_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,1),_RlSntpServerInetAddressType_Type())
rlSntpServerInetAddressType.setMaxAccess(_F)
...
rlSntpServerInetAddress=_RlSntpServerInetAddress_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,2),_RlSntpServerInetAddress_Type())
rlSntpServerInetAddress.setMaxAccess(_F)
if mibBuilder.loadTexts:rlSntpServerInetAddress.setStatus(_A)
class _RlSntpServerInetPolled_Type(TruthValue):defaultValue=2
_RlSntpServerInetPolled_Type.__name__=_I
_RlSntpServerInetPolled_Object=MibTableColumn
rlSntpServerInetPolled=_RlSntpServerInetPolled_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,3),_RlSntpServerInetPolled_Type())
...
rlSntpServerInetStratum=_RlSntpServerInetStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,4),_RlSntpServerInetStratum_Type())
...
rlSntpServerInetLastResp=_RlSntpServerInetLastResp_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,5),_RlSntpServerInetLastResp_Type())
...
rlSntpServerInetStatus=_RlSntpServerInetStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,6),_RlSntpServerInetStatus_Type())
...
rlSntpServerInetOffset=_RlSntpServerInetOffset_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,7),_RlSntpServerInetOffset_Type())
rlSntpServerInetOffset.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpServerInetOffset.setStatus(_A)
if mibBuilder.loadTexts:rlSntpServerInetOffset.setUnits(_H)
_RlSntpServerInetDelay_Type=NTPSignedTimeValue
_RlSntpServerInetDelay_Object=MibTableColumn
rlSntpServerInetDelay=_RlSntpServerInetDelay_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,8),_RlSntpServerInetDelay_Type())
rlSntpServerInetDelay.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpServerInetDelay.setStatus(_A)
if mibBuilder.loadTexts:rlSntpServerInetDelay.setUnits(_H)
_RlSntpServerInetKeyIdentifier_Type=Unsigned32
_RlSntpServerInetKeyIdentifier_Object=MibTableColumn
rlSntpServerInetKeyIdentifier=_RlSntpServerInetKeyIdentifier_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,9),_RlSntpServerInetKeyIdentifier_Type())
...
rlSntpServerInetRowStatus=_RlSntpServerInetRowStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,10),_RlSntpServerInetRowStatus_Type())
...
rlSntpServerInetLastReq=_RlSntpServerInetLastReq_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,17,1,11),_RlSntpServerInetLastReq_Type())
rlSntpServerInetLastReq.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpServerInetLastReq.setStatus(_A)
_RlSntpAllServerInetTable_Object=MibTable
rlSntpAllServerInetTable=_RlSntpAllServerInetTable_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18))
if mibBuilder.loadTexts:rlSntpAllServerInetTable.setStatus(_A)
_RlSntpAllServerInetEntry_Object=MibTableRow
rlSntpAllServerInetEntry=_RlSntpAllServerInetEntry_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1))
rlSntpAllServerInetEntry.setIndexNames((0,_E,_p),(0,_E,_q),(0,_E,_r),(0,_E,_s),(0,_E,_t))
if mibBuilder.loadTexts:rlSntpAllServerInetEntry.setStatus(_A)
class _RlSntpAllServerSource_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_X,1),(_Z,2),(_Y,3)))
_RlSntpAllServerSource_Type.__name__=_D
_RlSntpAllServerSource_Object=MibTableColumn
rlSntpAllServerSource=_RlSntpAllServerSource_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,1),_RlSntpAllServerSource_Type())
rlSntpAllServerSource.setMaxAccess(_F)
if mibBuilder.loadTexts:rlSntpAllServerSource.setStatus(_A)
_RlSntpAllServerIfIndex_Type=InterfaceIndex
_RlSntpAllServerIfIndex_Object=MibTableColumn
rlSntpAllServerIfIndex=_RlSntpAllServerIfIndex_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,2),_RlSntpAllServerIfIndex_Type())
rlSntpAllServerIfIndex.setMaxAccess(_F)
if mibBuilder.loadTexts:rlSntpAllServerIfIndex.setStatus(_A)
_RlSntpAllServerPreference_Type=Integer32
_RlSntpAllServerPreference_Object=MibTableColumn
rlSntpAllServerPreference=_RlSntpAllServerPreference_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,3),_RlSntpAllServerPreference_Type())
rlSntpAllServerPreference.setMaxAccess(_F)
if mibBuilder.loadTexts:rlSntpAllServerPreference.setStatus(_A)
_RlSntpAllServerInetAddressType_Type=InetAddressType
_RlSntpAllServerInetAddressType_Object=MibTableColumn
rlSntpAllServerInetAddressType=_RlSntpAllServerInetAddressType_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,4),_RlSntpAllServerInetAddressType_Type())
rlSntpAllServerInetAddressType.setMaxAccess(_F)
if mibBuilder.loadTexts:rlSntpAllServerInetAddressType.setStatus(_A)
_RlSntpAllServerInetAddress_Type=InetAddress
_RlSntpAllServerInetAddress_Object=MibTableColumn
rlSntpAllServerInetAddress=_RlSntpAllServerInetAddress_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,5),_RlSntpAllServerInetAddress_Type())
rlSntpAllServerInetAddress.setMaxAccess(_F)
if mibBuilder.loadTexts:rlSntpAllServerInetAddress.setStatus(_A)
class _RlSntpAllServerInetPolled_Type(TruthValue):defaultValue=2
_RlSntpAllServerInetPolled_Type.__name__=_I
_RlSntpAllServerInetPolled_Object=MibTableColumn
rlSntpAllServerInetPolled=_RlSntpAllServerInetPolled_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,6),_RlSntpAllServerInetPolled_Type())
rlSntpAllServerInetPolled.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAllServerInetPolled.setStatus(_A)
_RlSntpAllServerInetStratum_Type=NTPStratum
_RlSntpAllServerInetStratum_Object=MibTableColumn
rlSntpAllServerInetStratum=_RlSntpAllServerInetStratum_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,7),_RlSntpAllServerInetStratum_Type())
rlSntpAllServerInetStratum.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAllServerInetStratum.setStatus(_A)
_RlSntpAllServerInetLastResp_Type=NTPTimeStamp
_RlSntpAllServerInetLastResp_Object=MibTableColumn
rlSntpAllServerInetLastResp=_RlSntpAllServerInetLastResp_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,8),_RlSntpAllServerInetLastResp_Type())
rlSntpAllServerInetLastResp.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAllServerInetLastResp.setStatus(_A)
class _RlSntpAllServerInetStatus_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_M,1),(_N,2),(_O,3),(_P,4)))
_RlSntpAllServerInetStatus_Type.__name__=_D
_RlSntpAllServerInetStatus_Object=MibTableColumn
rlSntpAllServerInetStatus=_RlSntpAllServerInetStatus_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,9),_RlSntpAllServerInetStatus_Type())
rlSntpAllServerInetStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAllServerInetStatus.setStatus(_A)
_RlSntpAllServerInetOffset_Type=NTPTimeStamp
_RlSntpAllServerInetOffset_Object=MibTableColumn
rlSntpAllServerInetOffset=_RlSntpAllServerInetOffset_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,10),_RlSntpAllServerInetOffset_Type())
rlSntpAllServerInetOffset.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAllServerInetOffset.setStatus(_A)
if mibBuilder.loadTexts:rlSntpAllServerInetOffset.setUnits(_H)
_RlSntpAllServerInetDelay_Type=NTPSignedTimeValue
_RlSntpAllServerInetDelay_Object=MibTableColumn
rlSntpAllServerInetDelay=_RlSntpAllServerInetDelay_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,11),_RlSntpAllServerInetDelay_Type())
rlSntpAllServerInetDelay.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAllServerInetDelay.setStatus(_A)
if mibBuilder.loadTexts:rlSntpAllServerInetDelay.setUnits(_H)
_RlSntpAllServerInetKeyIdentifier_Type=Unsigned32
_RlSntpAllServerInetKeyIdentifier_Object=MibTableColumn
rlSntpAllServerInetKeyIdentifier=_RlSntpAllServerInetKeyIdentifier_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,12),_RlSntpAllServerInetKeyIdentifier_Type())
rlSntpAllServerInetKeyIdentifier.setMaxAccess(_C)
if mibBuilder.loadTexts:rlSntpAllServerInetKeyIdentifier.setStatus(_A)
_RlSntpAllServerInetLastReq_Type=NTPTimeStamp
_RlSntpAllServerInetLastReq_Object=MibTableColumn
rlSntpAllServerInetLastReq=_RlSntpAllServerInetLastReq_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,18,1,13),_RlSntpAllServerInetLastReq_Type())
rlSntpAllServerInetLastReq.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpAllServerInetLastReq.setStatus(_A)
_RlSntpRestoreDefaultServers_Type=TruthValue
_RlSntpRestoreDefaultServers_Object=MibScalar
rlSntpRestoreDefaultServers=_RlSntpRestoreDefaultServers_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,19),_RlSntpRestoreDefaultServers_Type())
rlSntpRestoreDefaultServers.setMaxAccess(_C)
if mibBuilder.loadTexts:rlSntpRestoreDefaultServers.setStatus(_A)
_RlSntpTimeSinceLastSync_Type=Unsigned32
_RlSntpTimeSinceLastSync_Object=MibScalar
rlSntpTimeSinceLastSync=_RlSntpTimeSinceLastSync_Object((1,3,6,1,4,1,9,6,1,101,92,2,2,20),_RlSntpTimeSinceLastSync_Type())
rlSntpTimeSinceLastSync.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSntpTimeSinceLastSync.setStatus(_A)
_RlNtpConfig_ObjectIdentity=ObjectIdentity
rlNtpConfig=_RlNtpConfig_ObjectIdentity((1,3,6,1,4,1,9,6,1,101,92,2,3))
mibBuilder.exportSymbols(_E,**{'NTPTimeStamp':NTPTimeStamp,'NTPSignedTimeValue':NTPSignedTimeValue,'NTPStratum':NTPStratum,_R:RlTimeSyncMethod,'RlClockStatus':RlClockStatus,_S:RlDaylightSavingTimeMode,_b:RlSntpNtpSyncType,'RlSntpNtpSyncEntryType':RlSntpNtpSyncEntryType,'rlTimeSynchronization':rlTimeSynchronization,'rlTimeSyncMethodMode':rlTimeSyncMethodMode,'rlTimeSyncMibVersion':rlTimeSyncMibVersion,'rndTimeSyncManagedTime':rndTimeSyncManagedTime,'rndTimeSyncManagedDate':rndTimeSyncManagedDate,'rndTimeSyncManagedDateTime':rndTimeSyncManagedDateTime,'rlTimeSyncMethod':rlTimeSyncMethod,'rlTimeZone':rlTimeZone,'rlTimeZoneCode':rlTimeZoneCode,'rlDaylightSavingTimeMode':rlDaylightSavingTimeMode,'rlDaylightSavingTimeStart':rlDaylightSavingTimeStart,'rlDaylightSavingTimeEnd':rlDaylightSavingTimeEnd,'rlDaylightSavingTimeOffset':rlDaylightSavingTimeOffset,'rlDaylightSavingTimeCode':rlDaylightSavingTimeCode,'rlTZDSTOffset':rlTZDSTOffset,'rlTimeZoneName':rlTimeZoneName,'rlTimeZoneTable':rlTimeZoneTable,'rlTimeZoneEntry':rlTimeZoneEntry,_W:rlTimeZoneIndex,'rlTimeZoneTimeSyncMethod':rlTimeZoneTimeSyncMethod,'rlTimeZoneTimeZoneOffset':rlTimeZoneTimeZoneOffset,'rlTimeZoneTimeZoneCode':rlTimeZoneTimeZoneCode,'rlTimeZoneDaylightSavingTimeMode':rlTimeZoneDaylightSavingTimeMode,'rlTimeZoneDaylightSavingTimeStart':rlTimeZoneDaylightSavingTimeStart,'rlTimeZoneDaylightSavingTimeEnd':rlTimeZoneDaylightSavingTimeEnd,'rlTimeZoneDaylightSavingTimeOffset':rlTimeZoneDaylightSavingTimeOffset,'rlTimeZoneDaylightSavingTimeCode':rlTimeZoneDaylightSavingTimeCode,'rlTimeZoneTZDSTOffset':rlTimeZoneTZDSTOffset,'rlTimeZoneTimeZoneName':rlTimeZoneTimeZoneName,'rlTimeZoneDataType':rlTimeZoneDataType,'rlTimeZoneDataSourceIfIndex':rlTimeZoneDataSourceIfIndex,'rlTimeZoneDataDynamicConfSource':rlTimeZoneDataDynamicConfSource,'rlClockStatus':rlClockStatus,'rlDhcpTimezoneOptionEnabled':rlDhcpTimezoneOptionEnabled,'rlAutomaticClockSetFromPCEnabled':rlAutomaticClockSetFromPCEnabled,'rlTimeAndDateHaveBeenSet':rlTimeAndDateHaveBeenSet,'rlTimeSyncManagedDateTimeTable':rlTimeSyncManagedDateTimeTable,'rlTimeSyncManagedDateTimeEntry':rlTimeSyncManagedDateTimeEntry,_a:rlTimeSyncManagedDateTimeIndex,'rlTimeSyncManagedDateTime':rlTimeSyncManagedDateTime,'rlTimeSyncManagedDateTimeSource':rlTimeSyncManagedDateTimeSource,'rlSntpNtpClient':rlSntpNtpClient,'rlSntpNtpConfig':rlSntpNtpConfig,'rlSntpNtpMibVersion':rlSntpNtpMibVersion,'rlSntpNtpConfigMode':rlSntpNtpConfigMode,'rlSntpNtpConfigSysStratum':rlSntpNtpConfigSysStratum,'rlSntpNtpConfigPollInterval':rlSntpNtpConfigPollInterval,'rlSntpNtpConfigPrimaryPollSrvAddr':rlSntpNtpConfigPrimaryPollSrvAddr,'rlSntpNtpConfigPrimaryPollSrvMrid':rlSntpNtpConfigPrimaryPollSrvMrid,'rlSntpNtpConfigPrimaryPollSrvIfIndex':rlSntpNtpConfigPrimaryPollSrvIfIndex,'rlSntpNtpConfigPrimaryPollSrvStratum':rlSntpNtpConfigPrimaryPollSrvStratum,'rlSntpNtpConfigSyncSrvAddr':rlSntpNtpConfigSyncSrvAddr,'rlSntpNtpConfigSyncSrvMrid':rlSntpNtpConfigSyncSrvMrid,'rlSntpNtpConfigSyncSrvIfIndex':rlSntpNtpConfigSyncSrvIfIndex,'rlSntpNtpConfigSyncSrvType':rlSntpNtpConfigSyncSrvType,'rlSntpNtpConfigSyncSrvStratum':rlSntpNtpConfigSyncSrvStratum,'rlSntpNtpConfigRetryTimeout':rlSntpNtpConfigRetryTimeout,'rlSntpNtpConfigRetryCnt':rlSntpNtpConfigRetryCnt,'rlSntpNtpConfigSrvTable':rlSntpNtpConfigSrvTable,'rlSntpNtpConfigSrvEntry':rlSntpNtpConfigSrvEntry,_c:rlSntpNtpConfigSrvEntryType,'rlSntpNtpConfigSrvInetAddressType':rlSntpNtpConfigSrvInetAddressType,'rlSntpNtpConfigSrvInetAddress':rlSntpNtpConfigSrvInetAddress,'rlSntpNtpConfigSrvMrid':rlSntpNtpConfigSrvMrid,'rlSntpNtpConfigSrvIfIndex':rlSntpNtpConfigSrvIfIndex,'rlSntpNtpConfigSrvSyncType':rlSntpNtpConfigSrvSyncType,'rlSntpNtpConfigSrvStratum':rlSntpNtpConfigSrvStratum,'rlSntpConfig':rlSntpConfig,'rlSntpClientMode':rlSntpClientMode,'rlSntpUnicastAdminState':rlSntpUnicastAdminState,'rlSntpBroadcastAdminState':rlSntpBroadcastAdminState,'rlSntpAnycastAdminState':rlSntpAnycastAdminState,'rlSntpUnicastPollState':rlSntpUnicastPollState,'rlSntpBroadcastPollState':rlSntpBroadcastPollState,'rlSntpAnycastPollState':rlSntpAnycastPollState,'rlSntpAuthenticationState':rlSntpAuthenticationState,'rlTimeValidFlag':rlTimeValidFlag,'rlSntpConfigBroadcastTable':rlSntpConfigBroadcastTable,'rlSntpBroadcastEntry':rlSntpBroadcastEntry,_f:rlSntpBroadcastIfIndex,'rlSntpBroadcastIfAdminState':rlSntpBroadcastIfAdminState,'rlSntpBroadcastMode':rlSntpBroadcastMode,'rlSntpBroadcastPolled':rlSntpBroadcastPolled,'rlSntpBroadcastAddress':rlSntpBroadcastAddress,'rlSntpBroadcastStratum':rlSntpBroadcastStratum,'rlSntpBroadcastLastResp':rlSntpBroadcastLastResp,'rlSntpBroadcastStatus':rlSntpBroadcastStatus,'rlSntpBroadcastOffset':rlSntpBroadcastOffset,'rlSntpBroadcastDelay':rlSntpBroadcastDelay,'rlSntpBroadcastRowStatus':rlSntpBroadcastRowStatus,'rlSntpConfigAnycastTable':rlSntpConfigAnycastTable,'rlSntpAnycastEntry':rlSntpAnycastEntry,_i:rlSntpAnycastIfIndex,'rlSntpAnycastAddress':rlSntpAnycastAddress,'rlSntpAnycastStratum':rlSntpAnycastStratum,'rlSntpAnycastLastResp':rlSntpAnycastLastResp,'rlSntpAnycastStatus':rlSntpAnycastStatus,'rlSntpAnycastOffset':rlSntpAnycastOffset,'rlSntpAnycastDelay':rlSntpAnycastDelay,'rlSntpAnycastRowStatus':rlSntpAnycastRowStatus,'rlSntpConfigServerTable':rlSntpConfigServerTable,'rlSntpServerEntry':rlSntpServerEntry,_j:rlSntpServerAddress,'rlSntpServerPolled':rlSntpServerPolled,'rlSntpServerStratum':rlSntpServerStratum,'rlSntpServerLastResp':rlSntpServerLastResp,'rlSntpServerStatus':rlSntpServerStatus,'rlSntpServersOffset':rlSntpServersOffset,'rlSntpServersDelay':rlSntpServersDelay,'rlSntpServersKeyIdentifier':rlSntpServersKeyIdentifier,'rlSntpServerRowStatus':rlSntpServerRowStatus,'rlSntpConfigAuthenticationTable':rlSntpConfigAuthenticationTable,'rlSntpAuthenticationEntry':rlSntpAuthenticationEntry,_k:rlSntpAuthenticationKeyID,'rlSntpAuthenticationKeyValue':rlSntpAuthenticationKeyValue,'rlSntpAuthenticationKeyState':rlSntpAuthenticationKeyState,'rlSntpAuthenticationRowStatus':rlSntpAuthenticationRowStatus,'rlSntpPort':rlSntpPort,'rlSntpConfigBroadcastInetTable':rlSntpConfigBroadcastInetTable,'rlSntpBroadcastInetEntry':rlSntpBroadcastInetEntry,_l:rlSntpBroadcastInetIfIndex,'rlSntpBroadcastInetIfAdminState':rlSntpBroadcastInetIfAdminState,'rlSntpBroadcastInetMode':rlSntpBroadcastInetMode,'rlSntpBroadcastInetPolled':rlSntpBroadcastInetPolled,'rlSntpBroadcastInetAddressType':rlSntpBroadcastInetAddressType,'rlSntpBroadcastInetAddress':rlSntpBroadcastInetAddress,'rlSntpBroadcastInetStratum':rlSntpBroadcastInetStratum,'rlSntpBroadcastInetLastResp':rlSntpBroadcastInetLastResp,'rlSntpBroadcastInetStatus':rlSntpBroadcastInetStatus,'rlSntpBroadcastInetOffset':rlSntpBroadcastInetOffset,'rlSntpBroadcastInetDelay':rlSntpBroadcastInetDelay,'rlSntpBroadcastInetRowStatus':rlSntpBroadcastInetRowStatus,'rlSntpBroadcastInetLastReq':rlSntpBroadcastInetLastReq,'rlSntpConfigAnycastInetTable':rlSntpConfigAnycastInetTable,'rlSntpAnycastInetEntry':rlSntpAnycastInetEntry,_m:rlSntpAnycastInetIfIndex,'rlSntpAnycastInetAddressType':rlSntpAnycastInetAddressType,'rlSntpAnycastInetAddress':rlSntpAnycastInetAddress,'rlSntpAnycastInetStratum':rlSntpAnycastInetStratum,'rlSntpAnycastInetLastResp':rlSntpAnycastInetLastResp,'rlSntpAnycastInetStatus':rlSntpAnycastInetStatus,'rlSntpAnycastInetOffset':rlSntpAnycastInetOffset,'rlSntpAnycastInetDelay':rlSntpAnycastInetDelay,'rlSntpAnycastInetRowStatus':rlSntpAnycastInetRowStatus,'rlSntpAnycastInetLastReq':rlSntpAnycastInetLastReq,'rlSntpConfigServerInetTable':rlSntpConfigServerInetTable,'rlSntpServerInetEntry':rlSntpServerInetEntry,_n:rlSntpServerInetAddressType,_o:rlSntpServerInetAddress,'rlSntpServerInetPolled':rlSntpServerInetPolled,'rlSntpServerInetStratum':rlSntpServerInetStratum,'rlSntpServerInetLastResp':rlSntpServerInetLastResp,'rlSntpServerInetStatus':rlSntpServerInetStatus,'rlSntpServerInetOffset':rlSntpServerInetOffset,'rlSntpServerInetDelay':rlSntpServerInetDelay,'rlSntpServerInetKeyIdentifier':rlSntpServerInetKeyIdentifier,'rlSntpServerInetRowStatus':rlSntpServerInetRowStatus,'rlSntpServerInetLastReq':rlSntpServerInetLastReq,'rlSntpAllServerInetTable':rlSntpAllServerInetTable,'rlSntpAllServerInetEntry':rlSntpAllServerInetEntry,_p:rlSntpAllServerSource,_q:rlSntpAllServerIfIndex,_r:rlSntpAllServerPreference,_s:rlSntpAllServerInetAddressType,_t:rlSntpAllServerInetAddress,'rlSntpAllServerInetPolled':rlSntpAllServerInetPolled,'rlSntpAllServerInetStratum':rlSntpAllServerInetStratum,'rlSntpAllServerInetLastResp':rlSntpAllServerInetLastResp,'rlSntpAllServerInetStatus':rlSntpAllServerInetStatus,'rlSntpAllServerInetOffset':rlSntpAllServerInetOffset,'rlSntpAllServerInetDelay':rlSntpAllServerInetDelay,'rlSntpAllServerInetKeyIdentifier':rlSntpAllServerInetKeyIdentifier,'rlSntpAllServerInetLastReq':rlSntpAllServerInetLastReq,'rlSntpRestoreDefaultServers':rlSntpRestoreDefaultServers,'rlSntpTimeSinceLastSync':rlSntpTimeSinceLastSync,'rlNtpConfig':rlNtpConfig})