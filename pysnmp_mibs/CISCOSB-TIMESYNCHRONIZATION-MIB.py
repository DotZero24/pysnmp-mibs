...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-TIMESYNCHRONIZATION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:41:42 2025
...
rlTimeSyncManagedDateTimeTable = _RlTimeSyncManagedDateTimeTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 92, 1, 20)
)
if mibBuilder.loadTexts:
    rlTimeSyncManagedDateTimeTable.setStatus("current")
_RlTimeSyncManagedDateTimeEntry_Object = MibTableRow
rlTimeSyncManagedDateTimeEntry = _RlTimeSyncManagedDateTimeEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 92, 1, 20, 1)
)
rlTimeSyncManagedDateTimeEntry.setIndexNames(
    (0, "CISCOSB-TIMESYNCHRONIZATION-MIB", "rlTimeSyncManagedDateTimeIndex"),
)
if mibBuilder.loadTexts:
    rlTimeSyncManagedDateTimeEntry.setStatus("current")


class _RlTimeSyncManagedDateTimeIndex_Type(Integer32):
    """Custom type rlTimeSyncManagedDateTimeIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_RlTimeSyncManagedDateTimeIndex_Type.__name__ = "Integer32"
_RlTimeSyncManagedDateTimeIndex_Object = MibTableColumn
rlTimeSyncManagedDateTimeIndex = _RlTimeSyncManagedDateTimeIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 92, 1, 20, 1, 1),
    _RlTimeSyncManagedDateTimeIndex_Type()
)
rlTimeSyncManagedDateTimeIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    rlTimeSyncManagedDateTimeIndex.setStatus("current")


class _RlTimeSyncManagedDateTime_Type(DisplayString):
    """Custom type rlTimeSyncManagedDateTime based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(12, 12),
    )
...
_RlTimeSyncManagedDateTime_Type.__name__ = "DisplayString"
_RlTimeSyncManagedDateTime_Object = MibTableColumn
rlTimeSyncManagedDateTime = _RlTimeSyncManagedDateTime_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 92, 1, 20, 1, 2),
    _RlTimeSyncManagedDateTime_Type()
)
rlTimeSyncManagedDateTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlTimeSyncManagedDateTime.setStatus("current")
_RlTimeSyncManagedDateTimeSource_Type = RlClockStatus
_RlTimeSyncManagedDateTimeSource_Object = MibTableColumn
rlTimeSyncManagedDateTimeSource = _RlTimeSyncManagedDateTimeSource_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 92, 1, 20, 1, 3),
    _RlTimeSyncManagedDateTimeSource_Type()
)
rlTimeSyncManagedDateTimeSource.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlTimeSyncManagedDateTimeSource.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"NTPTimeStamp": NTPTimeStamp,
       ...
       "rlTimeSyncManagedDateTimeTable": rlTimeSyncManagedDateTimeTable,
       "rlTimeSyncManagedDateTimeEntry": rlTimeSyncManagedDateTimeEntry,
       "rlTimeSyncManagedDateTimeIndex": rlTimeSyncManagedDateTimeIndex,
       "rlTimeSyncManagedDateTime": rlTimeSyncManagedDateTime,
       "rlTimeSyncManagedDateTimeSource": rlTimeSyncManagedDateTimeSource,
