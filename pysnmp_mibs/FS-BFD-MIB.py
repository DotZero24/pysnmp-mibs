...
mibBuilder.exportSymbols("FS-BFD-MIB", fsBfdSessPerfCtrlPktDropHC=fsBfdSessPerfCtrlPktDropHC, fsBfdSessOperMode=fsBfdSessOperMode, fsBfdCompliances=fsBfdCompliances, fsBfdSessGTSMTTL=fsBfdSessGTSMTTL, fsBfdSessIfDes=fsBfdSessIfDes, fsBfdSessPerfCtrlPktInHC=fsBfdSessPerfCtrlPktInHC, fsBfdSessUp=fsBfdSessUp, fsBfdSessionPerfGroup=fsBfdSessionPerfGroup, fsBfdSessDstAddr=fsBfdSessDstAddr, fsBfdSessType=fsBfdSessType, fsBfdSessPerfCtrlPktOut=fsBfdSessPerfCtrlPktOut, fsBfdSessState=fsBfdSessState, FSBfdIntervalTC=FSBfdIntervalTC, fsBfdSessPerfLastCommLostDiag=fsBfdSessPerfLastCommLostDiag, fsBfdSessNotificationsEnable=fsBfdSessNotificationsEnable, fsBfdSessIpMapTable=fsBfdSessIpMapTable, fsBfdSessDiscMapRowStatus=fsBfdSessDiscMapRowStatus, fsBfdSessionPerfHCGroup=fsBfdSessionPerfHCGroup, fsBfdSessDiscMapStorageType=fsBfdSessDiscMapStorageType, fsBfdSessReqMinEchoRxInterval=fsBfdSessReqMinEchoRxInterval, fsBfdSessDstAddrType=fsBfdSessDstAddrType, fsBfdSessIpMapIndex=fsBfdSessIpMapIndex, fsBfdSessIpMapStorageType=fsBfdSessIpMapStorageType, FSBfdCtrlDestPortNumberTC=FSBfdCtrlDestPortNumberTC, fsBfdSessIndex=fsBfdSessIndex, fsBfdSessPerfEntry=fsBfdSessPerfEntry, fsBfdSessRowStatus=fsBfdSessRowStatus, fsBfdSessReqMinRxInterval=fsBfdSessReqMinRxInterval, FSBfdSessAuthenticationTypeTC=FSBfdSessAuthenticationTypeTC, fsBfdSessUpTime=fsBfdSessUpTime, fsBfdSessRemoteDiscr=fsBfdSessRemoteDiscr, fsBfdSessRemoteHeardFlag=fsBfdSessRemoteHeardFlag, fsBfdSessPerfCtrlPktDrop=fsBfdSessPerfCtrlPktDrop, fsBfdSessSrcAddr=fsBfdSessSrcAddr, fsBfdSessNegotiatedDetectMult=fsBfdSessNegotiatedDetectMult, fsBfdSessPerfCtrlPktDropLastTime=fsBfdSessPerfCtrlPktDropLastTime, fsBfdSessInterface=fsBfdSessInterface, fsBfdSessTable=fsBfdSessTable, fsBfdScalarObjects=fsBfdScalarObjects, FSBfdSessionAuthenticationKeyTC=FSBfdSessionAuthenticationKeyTC, fsBfdSessPerfCtrlPktOutHC=fsBfdSessPerfCtrlPktOutHC, fsBfdSessControlPlaneIndepFlag=fsBfdSessControlPlaneIndepFlag, fsBfdSessGTSM=fsBfdSessGTSM, fsBfdSessDesiredMinTxInterval=fsBfdSessDesiredMinTxInterval, fsBfdSessPerfEchoPktDropHC=fsBfdSessPerfEchoPktDropHC, fsBfdNotificationGroup=fsBfdNotificationGroup, fsBfdSessAdminStatus=fsBfdSessAdminStatus, fsBfdSessSourceUdpPort=fsBfdSessSourceUdpPort, FSBfdSessOperModeTC=FSBfdSessOperModeTC, fsBfdSessionReadOnlyGroup=fsBfdSessionReadOnlyGroup, fsBfdAdminStatus=fsBfdAdminStatus, fsBfdSessIpMapRowStatus=fsBfdSessIpMapRowStatus, fsBfdSessDown=fsBfdSessDown, fsBfdSessNegotiatedInterval=fsBfdSessNegotiatedInterval, FSBfdSessTypeTC=FSBfdSessTypeTC, fsBfdSessAuthenticationType=fsBfdSessAuthenticationType, fsBfdSessPerfEchoPktDropLastTime=fsBfdSessPerfEchoPktDropLastTime, fsBfdConformance=fsBfdConformance, fsBfdSessPerfEchoPktOutHC=fsBfdSessPerfEchoPktOutHC, FSBfdSessStateTC=FSBfdSessStateTC, FSBfdCtrlSourcePortNumberTC=FSBfdCtrlSourcePortNumberTC, fsBfdSessMultipointFlag=fsBfdSessMultipointFlag, fsBfdModuleFullCompliance=fsBfdModuleFullCompliance, fsBfdSessDiscMapEntry=fsBfdSessDiscMapEntry, fsBfdNotifications=fsBfdNotifications, fsBfdSessPerfEchoPktOut=fsBfdSessPerfEchoPktOut, fsBfdModuleReadOnlyCompliance=fsBfdModuleReadOnlyCompliance, PYSNMP_MODULE_ID=fsBfdMIB, fsBfdSessPerfSessUpCount=fsBfdSessPerfSessUpCount, FSBfdDiagTC=FSBfdDiagTC, fsBfdSessPerfEchoPktIn=fsBfdSessPerfEchoPktIn, fsBfdSessDiscriminator=fsBfdSessDiscriminator, fsBfdSessPerfCtrlPktIn=fsBfdSessPerfCtrlPktIn, fsBfdSessPerfDiscTime=fsBfdSessPerfDiscTime, fsBfdSessDiscMapIndex=fsBfdSessDiscMapIndex, fsBfdSessVersionNumber=fsBfdSessVersionNumber, fsBfdSessPerfEchoPktDrop=fsBfdSessPerfEchoPktDrop, fsBfdGroups=fsBfdGroups, FSBfdSessIndexTC=FSBfdSessIndexTC, fsBfdSessIfName=fsBfdSessIfName, fsBfdSessEchoSourceUdpPort=fsBfdSessEchoSourceUdpPort, fsBfdSessDetectMult=fsBfdSessDetectMult, fsBfdSessPerfLastSessDownTime=fsBfdSessPerfLastSessDownTime, fsBfdSessDiag=fsBfdSessDiag, fsBfdSessDemandModeDesiredFlag=fsBfdSessDemandModeDesiredFlag, fsBfdSessSrcAddrType=fsBfdSessSrcAddrType, fsBfdSessionGroup=fsBfdSessionGroup, fsBfdSessIpMapEntry=fsBfdSessIpMapEntry, fsBfdObjects=fsBfdObjects, fsBfdSessAuthenticationKeyID=fsBfdSessAuthenticationKeyID, fsBfdSessPerfTable=fsBfdSessPerfTable, fsBfdSessStorageType=fsBfdSessStorageType, fsBfdSessAuthenticationKey=fsBfdSessAuthenticationKey, fsBfdSessNegotiatedEchoInterval=fsBfdSessNegotiatedEchoInterval, fsBfdSessAuthPresFlag=fsBfdSessAuthPresFlag, fsBfdSessDestinationUdpPort=fsBfdSessDestinationUdpPort, fsBfdSessEntry=fsBfdSessEntry, fsBfdSessDiscMapTable=fsBfdSessDiscMapTable, FSBfdMultiplierTC=FSBfdMultiplierTC, fsBfdMIB=fsBfdMIB, fsBfdSessPerfEchoPktInHC=fsBfdSessPerfEchoPktInHC)
