...
sonetSectionCurrentStatus, sonetMediumEntry, sonetLineCurrentStatus, sonetPathCurrentStatus = mibBuilder.importSymbols("SONET-MIB", "sonetSectionCurrentStatus", "sonetMediumEntry", "sonetLineCurrentStatus", "sonetPathCurrentStatus")
...
mibBuilder.exportSymbols("ZHONE-PHY-SONET-MIB", zhoneSonetErrorStatsPathFebeCount=zhoneSonetErrorStatsPathFebeCount, sonetClockEntry=sonetClockEntry, zhoneSonetErrorStatsTxCellCount=zhoneSonetErrorStatsTxCellCount, zhoneSonetErrorStatsLocdCount=zhoneSonetErrorStatsLocdCount, PYSNMP_MODULE_ID=phySonet, zhoneSonetErrorStatsRxCellCount=zhoneSonetErrorStatsRxCellCount, sonetPathStatusChange=sonetPathStatusChange, sonetMediumExtEntry=sonetMediumExtEntry, zhoneSonetErrorStatsCellFifoOverflowCount=zhoneSonetErrorStatsCellFifoOverflowCount, sonetMediumExtScrambleEnabled=sonetMediumExtScrambleEnabled, sonetV2Traps=sonetV2Traps, zhoneSonetErrorStatsPathBipCount=zhoneSonetErrorStatsPathBipCount, sonetClockExternalRecovery=sonetClockExternalRecovery, sonetClockTransmitSourceChange=sonetClockTransmitSourceChange, sonetSectionStatusChange=sonetSectionStatusChange, zhoneSonetErrorStatsLineFebeCount=zhoneSonetErrorStatsLineFebeCount, zhoneSonetErrorStatsHecUncorrectedCount=zhoneSonetErrorStatsHecUncorrectedCount, zhoneSonetErrorStatsIndex=zhoneSonetErrorStatsIndex, zhoneSonetErrorStatsLineBipCount=zhoneSonetErrorStatsLineBipCount, sonetClockTransmitSource=sonetClockTransmitSource, sonetMediumExtTable=sonetMediumExtTable, phySonet=phySonet, zhoneSonetErrorStatsOofCount=zhoneSonetErrorStatsOofCount, sonetTraps=sonetTraps, sonetMediumExtLineScrmEnabled=sonetMediumExtLineScrmEnabled, zhoneSonetErrorStatsTable=zhoneSonetErrorStatsTable, sonetLineStatusChange=sonetLineStatusChange, zhoneSonetErrorStatsSectionBipCount=zhoneSonetErrorStatsSectionBipCount, zhoneSonetErrorStatsEntry=zhoneSonetErrorStatsEntry, zhoneSonetErrorStatsHecCorrectedCount=zhoneSonetErrorStatsHecCorrectedCount, sonetClockTable=sonetClockTable)
