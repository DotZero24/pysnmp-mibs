...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-PTP-MIB
...
if mibBuilder.loadTexts: ciscoPtpMIB.setLastUpdated('202003170000Z')
...
cPtpClockSystemTimePropertiesTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12), )
if mibBuilder.loadTexts: cPtpClockSystemTimePropertiesTable.setStatus('current')
cPtpClockSystemTimePropertiesEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1), ).setIndexNames((0, "CISCO-PTP-MIB", "cPtpClockSystemTimePropertiesDomainIndex"), (0, "CISCO-PTP-MIB", "cPtpClockSystemTimePropertiesInstanceIndex"), (0, "CISCO-PTP-MIB", "cPtpClockSystemTimePropertiesClockTypeIndex"))
if mibBuilder.loadTexts: cPtpClockSystemTimePropertiesEntry.setStatus('current')
cPtpClockSystemTimePropertiesDomainIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1, 1), ClockDomainType())
if mibBuilder.loadTexts: cPtpClockSystemTimePropertiesDomainIndex.setStatus('current')
cPtpClockSystemTimePropertiesClockTypeIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1, 2), ClockType())
if mibBuilder.loadTexts: cPtpClockSystemTimePropertiesClockTypeIndex.setStatus('current')
cPtpClockSystemTimePropertiesInstanceIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1, 3), ClockInstanceType().subtype(subtypeSpec=ValueRangeConstraint(0, 255)))
...
mibBuilder.exportSymbols("CISCO-PTP-MIB", cPtpClockPortRunningInterfaceIndex=cPtpClockPortRunningInterfaceIndex, cPtpClockPortRunningTxMode=cPtpClockPortRunningTxMode, cPtpClockRunningPacketsReceived=cPtpClockRunningPacketsReceived, cPtpClockPortRunningClockTypeIndex=cPtpClockPortRunningClockTypeIndex, cPtpSystemDomainTable=cPtpSystemDomainTable, ClockType=ClockType, cPtpClockPortRunningPacketsSent=cPtpClockPortRunningPacketsSent, cPtpClockTransDefaultDSDomainIndex=cPtpClockTransDefaultDSDomainIndex, cPtpClockPortDSSyncInterval=cPtpClockPortDSSyncInterval, cPtpClockPortDSAnnounceRctTimeout=cPtpClockPortDSAnnounceRctTimeout, cPtpDomainIndex=cPtpDomainIndex, PYSNMP_MODULE_ID=ciscoPtpMIB, cPtpSystemProfile=cPtpSystemProfile, cPtpClockParentDSTable=cPtpClockParentDSTable, ciscoPtpMIBConformance=ciscoPtpMIBConformance, ciscoPtpMIBClockInfo=ciscoPtpMIBClockInfo, cPtpClockPortTransDSDomainIndex=cPtpClockPortTransDSDomainIndex, cPtpClockTransDefaultDSClockIdentity=cPtpClockTransDefaultDSClockIdentity, cPtpClockInput1ppsEnabled=cPtpClockInput1ppsEnabled, cPtpClockTimePropertiesDSInstanceIndex=cPtpClockTimePropertiesDSInstanceIndex, ciscoPtpMIBClockPortRunningGroup=ciscoPtpMIBClockPortRunningGroup, cPtpClockTimePropertiesDSPTPTimescale=cPtpClockTimePropertiesDSPTPTimescale, cPtpClockPortCurrentClockInstanceIndex=cPtpClockPortCurrentClockInstanceIndex, cPtpClockPortDSGrantDuration=cPtpClockPortDSGrantDuration, ClockProfileType=ClockProfileType, cPtpClockTimePropertiesDSClockTypeIndex=cPtpClockTimePropertiesDSClockTypeIndex, cPtpSystemDomainTotals=cPtpSystemDomainTotals, cPtpClockPortBlockGMC=cPtpClockPortBlockGMC, cPtpClockParentDSOffset=cPtpClockParentDSOffset, cPtpClockPortRunningPortNumberIndex=cPtpClockPortRunningPortNumberIndex, ciscoPtpMIBGroups=ciscoPtpMIBGroups, ciscoPtpMIBClockCurrentDSGroup=ciscoPtpMIBClockCurrentDSGroup, cPtpClockCurrentDSOffsetFromMaster=cPtpClockCurrentDSOffsetFromMaster, cPtpSystemDomainClockTypeIndex=cPtpSystemDomainClockTypeIndex, cPtpInstanceIndex=cPtpInstanceIndex, cPtpClockTransDefaultDSNumOfPorts=cPtpClockTransDefaultDSNumOfPorts, cPtpClockPortRunningRole=cPtpClockPortRunningRole, cPtpClockDefaultDSPriority1=cPtpClockDefaultDSPriority1, cPtpClockDefaultDSPriority2=cPtpClockDefaultDSPriority2, cPtpSystemTable=cPtpSystemTable, cPtpClockPortRunningPacketsReceived=cPtpClockPortRunningPacketsReceived, cPtpClockPortDomainIndex=cPtpClockPortDomainIndex, cPtpClockSystemTimePropertiesInstanceIndex=cPtpClockSystemTimePropertiesInstanceIndex, cPtpClockParentDSGMClockQualityAccuracy=cPtpClockParentDSGMClockQualityAccuracy, cPtpClockRunningPacketsSent=cPtpClockRunningPacketsSent, cPtpSystemDomainEntry=cPtpSystemDomainEntry, ciscoPtpRogueMaster=ciscoPtpRogueMaster, cPtpClockRogueMasterDetect=cPtpClockRogueMasterDetect, cPtpClockPortDSPeerDelayReqInterval=cPtpClockPortDSPeerDelayReqInterval, cPtpClockPortDSPeerMeanPathDelay=cPtpClockPortDSPeerMeanPathDelay, cPtpClockPortRunningName=cPtpClockPortRunningName, cPtpClockPortTransDSInstanceIndex=cPtpClockPortTransDSInstanceIndex, cPtpClockSystemTimePropertiesFrequencyOffset=cPtpClockSystemTimePropertiesFrequencyOffset, ciscoPtpMIBClockPortTransDSGroup=ciscoPtpMIBClockPortTransDSGroup, cPtpClockCurrentDSTable=cPtpClockCurrentDSTable, cPtpClockDefaultDSTwoStepFlag=cPtpClockDefaultDSTwoStepFlag, cPtpClockPortAssociatePortIndex=cPtpClockPortAssociatePortIndex, cPtpClockDefaultDSClockTypeIndex=cPtpClockDefaultDSClockTypeIndex, cPtpClockNodeTable=cPtpClockNodeTable, cPtpClockPortDSPortIdentity=cPtpClockPortDSPortIdentity, cPtpClockRunningDomainIndex=cPtpClockRunningDomainIndex, cPtpClockPortDSDelayMech=cPtpClockPortDSDelayMech, cPtpClockTimePropertiesDSLeap61=cPtpClockTimePropertiesDSLeap61, ClockDomainType=ClockDomainType, cPtpClockPortTransDSTable=cPtpClockPortTransDSTable, ClockIdentity=ClockIdentity, ciscoPtpParentClockChange=ciscoPtpParentClockChange, cPtpClockCurrentDSInstanceIndex=cPtpClockCurrentDSInstanceIndex, cPtpClockParentDSClockPhChRate=cPtpClockParentDSClockPhChRate, cPtpClockTimePropertiesDSDomainIndex=cPtpClockTimePropertiesDSDomainIndex, cPtpClockInstanceIndex=cPtpClockInstanceIndex, cPtpClockParentDSDomainIndex=cPtpClockParentDSDomainIndex, ClockStateType=ClockStateType, cPtpClockTimePropertiesDSTable=cPtpClockTimePropertiesDSTable, cPtpClockParentDSGMClockPriority1=cPtpClockParentDSGMClockPriority1, ClockPortState=ClockPortState, cPtpClockRunningInstanceIndex=cPtpClockRunningInstanceIndex, cPtpClockTransDefaultDSPrimaryDomain=cPtpClockTransDefaultDSPrimaryDomain, cPtpClockCurrentDSClockTypeIndex=cPtpClockCurrentDSClockTypeIndex, cPtpClockPortDSDomainIndex=cPtpClockPortDSDomainIndex, cPtpClockPortTransDSPortNumberIndex=cPtpClockPortTransDSPortNumberIndex, ClockTxModeType=ClockTxModeType, cPtpClockPortTransDSPortIdentity=cPtpClockPortTransDSPortIdentity, cPtpClockPortDSPTPVersion=cPtpClockPortDSPTPVersion, cPtpClockPortDSEntry=cPtpClockPortDSEntry, cPtpClockDefaultDSDomainIndex=cPtpClockDefaultDSDomainIndex, ciscoPtpMIB=ciscoPtpMIB, cPtpDomainClockPortPhysicalInterfacesTotal=cPtpDomainClockPortPhysicalInterfacesTotal, cPtpClockPortDSName=cPtpClockPortDSName, cPtpClockDefaultDSQualityClass=cPtpClockDefaultDSQualityClass, cPtpClockSystemTimePropertiesTable=cPtpClockSystemTimePropertiesTable, cPtpClockPortCurrentDomainIndex=cPtpClockPortCurrentDomainIndex, ClockQualityClassType=ClockQualityClassType, ClockPortNumber=ClockPortNumber, ciscoPtpMIBClockTranparentDSGroup=ciscoPtpMIBClockTranparentDSGroup, cPtpClockPortName=cPtpClockPortName, cPtpClockTransDefaultDSTable=cPtpClockTransDefaultDSTable, ciscoPtpMIBCompliances2=ciscoPtpMIBCompliances2, cPtpClockPortAssociateEntry=cPtpClockPortAssociateEntry, cPtpClockPortRunningIPversion=cPtpClockPortRunningIPversion, ClockIntervalBase2=ClockIntervalBase2, ClockMechanismType=ClockMechanismType, ClockQualityAccuracyType=ClockQualityAccuracyType, ciscoPtpMIBCompliances1=ciscoPtpMIBCompliances1, cPtpClockDefaultDSClockIdentity=cPtpClockDefaultDSClockIdentity, cPtpClockDefaultDSInstanceIndex=cPtpClockDefaultDSInstanceIndex, cPtpClockTimePropertiesDSTimeTraceable=cPtpClockTimePropertiesDSTimeTraceable, cPtpClockSystemTimePropertiesClockTypeIndex=cPtpClockSystemTimePropertiesClockTypeIndex, cPtpClockPortTable=cPtpClockPortTable, cPtpClockPortAssociatePacketsReceived=cPtpClockPortAssociatePacketsReceived, cPtpClockPortClockTypeIndex=cPtpClockPortClockTypeIndex, cPtpClockTransDefaultDSDelay=cPtpClockTransDefaultDSDelay, cPtpClockPortRunningEntry=cPtpClockPortRunningEntry, cPtpClockPortTablePortNumberIndex=cPtpClockPortTablePortNumberIndex, ciscoPtpMIBCompliances5=ciscoPtpMIBCompliances5, cPtpClockPortAssociateAddressType=cPtpClockPortAssociateAddressType, ciscoPtpMIBSystemInfoGroup=ciscoPtpMIBSystemInfoGroup, ciscoPtpGMClockChange=ciscoPtpGMClockChange, ClockInstanceType=ClockInstanceType, cPtpClockDefaultDSTable=cPtpClockDefaultDSTable, cPtpClockSystemTimePropertiesEntry=cPtpClockSystemTimePropertiesEntry, cPtpClockPortSyncOneStep=cPtpClockPortSyncOneStep, cPtpClockPortRunningEncapsulationType=cPtpClockPortRunningEncapsulationType, ciscoPtpMIBCompliances3=ciscoPtpMIBCompliances3, cPtpClockDefaultDSQualityOffset=cPtpClockDefaultDSQualityOffset, ClockTimeInterval=ClockTimeInterval, cPtpClockPortTransDSFaultyFlag=cPtpClockPortTransDSFaultyFlag, cPtpClockRunningEntry=cPtpClockRunningEntry, cPtpClockPortAssociatePacketsSent=cPtpClockPortAssociatePacketsSent, cPtpClockPortTransDSEntry=cPtpClockPortTransDSEntry, cPtpClockInput1ppsInterface=cPtpClockInput1ppsInterface, cPtpClockTimePropertiesDSCurrentUTCOffsetValid=cPtpClockTimePropertiesDSCurrentUTCOffsetValid, cPtpClockPortClockInstanceIndex=cPtpClockPortClockInstanceIndex, cPtpClockOutput1ppsOffsetNegative=cPtpClockOutput1ppsOffsetNegative, cPtpClockCurrentDSStepsRemoved=cPtpClockCurrentDSStepsRemoved, ciscoPtpMIBCompliances=ciscoPtpMIBCompliances, ciscoPtpMIBClockPortGroup=ciscoPtpMIBClockPortGroup, cPtpClockNodeEntry=cPtpClockNodeEntry, cPtpClockInputFrequencyEnabled=cPtpClockInputFrequencyEnabled, cPtpClockCurrentDSMeanPathDelay=cPtpClockCurrentDSMeanPathDelay, cPtpClockPortDSMinDelayReqInterval=cPtpClockPortDSMinDelayReqInterval, ciscoPtpMIBNotificationGroup=ciscoPtpMIBNotificationGroup, cPtpClockTimePropertiesDSCurrentUTCOffset=cPtpClockTimePropertiesDSCurrentUTCOffset, cPtpClockOutput1ppsInterface=cPtpClockOutput1ppsInterface, cPtpClockDefaultDSSlaveOnly=cPtpClockDefaultDSSlaveOnly, cPtpClockTimePropertiesDSSource=cPtpClockTimePropertiesDSSource, cPtpDomainClockPortsTotal=cPtpDomainClockPortsTotal, cPtpClockPortTransDSlogMinPdelayReqInt=cPtpClockPortTransDSlogMinPdelayReqInt, cPtpClockPortDSClockInstanceIndex=cPtpClockPortDSClockInstanceIndex, cPtpClockCurrentDSDomainIndex=cPtpClockCurrentDSDomainIndex, ciscoPtpMIBClockPortDSGroup=ciscoPtpMIBClockPortDSGroup, cPtpClockTODEnabled=cPtpClockTODEnabled, ciscoPtpMIBClockTimepropertiesGroup=ciscoPtpMIBClockTimepropertiesGroup, ciscoPtpMIBClockDefaultDSGroup=ciscoPtpMIBClockDefaultDSGroup, cPtpClockSystemTimePropertiesDomainSyntonized=cPtpClockSystemTimePropertiesDomainSyntonized, ClockRoleType=ClockRoleType, ciscoPtpMIBClockParentDSGroup=ciscoPtpMIBClockParentDSGroup, cPtpClockPortAssociateTable=cPtpClockPortAssociateTable, cPtpClockParentDSEntry=cPtpClockParentDSEntry, cPtpClockDefaultDSQualityAccuracy=cPtpClockDefaultDSQualityAccuracy, cPtpClockDefaultDSEntry=cPtpClockDefaultDSEntry, cPtpClockParentDSParentStats=cPtpClockParentDSParentStats, ciscoPtpMIBNotifs=ciscoPtpMIBNotifs, cPtpClockPortRunningState=cPtpClockPortRunningState, cPtpClockPortCurrentPortNumberIndex=cPtpClockPortCurrentPortNumberIndex, cPtpClockParentDSGMClockQualityOffset=cPtpClockParentDSGMClockQualityOffset, ciscoPtpMIBCompliances4=ciscoPtpMIBCompliances4, cPtpClockParentDSGMClockPriority2=cPtpClockParentDSGMClockPriority2, cPtpClockTimePropertiesDSFreqTraceable=cPtpClockTimePropertiesDSFreqTraceable, cPtpClockTODInterface=cPtpClockTODInterface, cPtpClockParentDSParentPortIdentity=cPtpClockParentDSParentPortIdentity, cPtpClockTimePropertiesDSEntry=cPtpClockTimePropertiesDSEntry, cPtpClockPortCurrentPeerAddressType=cPtpClockPortCurrentPeerAddressType, cPtpSystemEntry=cPtpSystemEntry, cPtpClockPortTransDSPeerMeanPathDelay=cPtpClockPortTransDSPeerMeanPathDelay, ciscoPtpMIBClockPortAssociateGroup=ciscoPtpMIBClockPortAssociateGroup, cPtpClockPortDSPortNumberIndex=cPtpClockPortDSPortNumberIndex, cPtpClockTimePropertiesDSLeap59=cPtpClockTimePropertiesDSLeap59, cPtpClockSystemTimePropertiesDomainIndex=cPtpClockSystemTimePropertiesDomainIndex, cPtpClockPortRunningClockInstanceIndex=cPtpClockPortRunningClockInstanceIndex, cPtpClockPortDSAnnouncementInterval=cPtpClockPortDSAnnouncementInterval, ciscoPtpMIBClockRunningGroup=ciscoPtpMIBClockRunningGroup, cPtpClockOutput1ppsOffsetEnabled=cPtpClockOutput1ppsOffsetEnabled, cPtpClockPortNumOfAssociatedPorts=cPtpClockPortNumOfAssociatedPorts, cPtpClockPortDSClockTypeIndex=cPtpClockPortDSClockTypeIndex, cPtpClockPortAssociateInErrors=cPtpClockPortAssociateInErrors, cPtpClockOutput1ppsEnabled=cPtpClockOutput1ppsEnabled, cPtpClockParentDSClockTypeIndex=cPtpClockParentDSClockTypeIndex, cPtpClockParentDSGMClockQualityClass=cPtpClockParentDSGMClockQualityClass, cPtpClockDomainIndex=cPtpClockDomainIndex, cPtpClockPortRole=cPtpClockPortRole, cPtpClockParentDSInstanceIndex=cPtpClockParentDSInstanceIndex, cPtpClockRunningClockTypeIndex=cPtpClockRunningClockTypeIndex, ciscoPtpMIBSystemInfo=ciscoPtpMIBSystemInfo, cPtpClockTypeIndex=cPtpClockTypeIndex, cPtpClockRunningState=cPtpClockRunningState, cPtpClockPortAssociateOutErrors=cPtpClockPortAssociateOutErrors, cPtpClockSystemTimePropertiesClockSyntonized=cPtpClockSystemTimePropertiesClockSyntonized, cPtpClockCurrentDSEntry=cPtpClockCurrentDSEntry, cPtpClockPortCurrentClockTypeIndex=cPtpClockPortCurrentClockTypeIndex, cPtpClockRunningTable=cPtpClockRunningTable, cPtpClockPortDSTable=cPtpClockPortDSTable, cPtpClockPortRunningDomainIndex=cPtpClockPortRunningDomainIndex, cPtpClockOutput1ppsOffsetValue=cPtpClockOutput1ppsOffsetValue, cPtpClockPortEntry=cPtpClockPortEntry, ciscoPtpMIBClockSystemTimePropertiesGroup=ciscoPtpMIBClockSystemTimePropertiesGroup, cPtpClockPortRunningTable=cPtpClockPortRunningTable, ciscoPtpMIBObjects=ciscoPtpMIBObjects, cPtpClockTransDefaultDSInstanceIndex=cPtpClockTransDefaultDSInstanceIndex, cPtpClockTransDefaultDSEntry=cPtpClockTransDefaultDSEntry, cPtpClockPortRunningRxMode=cPtpClockPortRunningRxMode, ClockTimeSourceType=ClockTimeSourceType, cPtpClockPortCurrentPeerAddress=cPtpClockPortCurrentPeerAddress, cPtpClockParentDSGMClockIdentity=cPtpClockParentDSGMClockIdentity, cPtpClockPortAssociateAddress=cPtpClockPortAssociateAddress)
