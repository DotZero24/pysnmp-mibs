...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-PTP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:22:17 2025
...
_CPtpClockPortBlockGMC_Type = TruthValue
_CPtpClockPortBlockGMC_Object = MibTableColumn
cPtpClockPortBlockGMC = _CPtpClockPortBlockGMC_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 7, 1, 11),
    _CPtpClockPortBlockGMC_Type()
)
cPtpClockPortBlockGMC.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cPtpClockPortBlockGMC.setStatus("current")
_CPtpClockRogueMasterDetect_Type = TruthValue
_CPtpClockRogueMasterDetect_Object = MibTableColumn
cPtpClockRogueMasterDetect = _CPtpClockRogueMasterDetect_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 7, 1, 12),
    _CPtpClockRogueMasterDetect_Type()
)
cPtpClockRogueMasterDetect.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cPtpClockRogueMasterDetect.setStatus("current")
...
_CPtpClockSystemTimePropertiesTable_Object = MibTable
cPtpClockSystemTimePropertiesTable = _CPtpClockSystemTimePropertiesTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12)
)
if mibBuilder.loadTexts:
    cPtpClockSystemTimePropertiesTable.setStatus("current")
_CPtpClockSystemTimePropertiesEntry_Object = MibTableRow
cPtpClockSystemTimePropertiesEntry = _CPtpClockSystemTimePropertiesEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1)
)
cPtpClockSystemTimePropertiesEntry.setIndexNames(
    (0, "CISCO-PTP-MIB", "cPtpClockSystemTimePropertiesDomainIndex"),
    (0, "CISCO-PTP-MIB", "cPtpClockSystemTimePropertiesInstanceIndex"),
    (0, "CISCO-PTP-MIB", "cPtpClockSystemTimePropertiesClockTypeIndex"),
)
if mibBuilder.loadTexts:
    cPtpClockSystemTimePropertiesEntry.setStatus("current")
_CPtpClockSystemTimePropertiesDomainIndex_Type = ClockDomainType
_CPtpClockSystemTimePropertiesDomainIndex_Object = MibTableColumn
cPtpClockSystemTimePropertiesDomainIndex = _CPtpClockSystemTimePropertiesDomainIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1, 1),
    _CPtpClockSystemTimePropertiesDomainIndex_Type()
)
cPtpClockSystemTimePropertiesDomainIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cPtpClockSystemTimePropertiesDomainIndex.setStatus("current")
_CPtpClockSystemTimePropertiesClockTypeIndex_Type = ClockType
_CPtpClockSystemTimePropertiesClockTypeIndex_Object = MibTableColumn
cPtpClockSystemTimePropertiesClockTypeIndex = _CPtpClockSystemTimePropertiesClockTypeIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1, 2),
    _CPtpClockSystemTimePropertiesClockTypeIndex_Type()
)
cPtpClockSystemTimePropertiesClockTypeIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cPtpClockSystemTimePropertiesClockTypeIndex.setStatus("current")


class _CPtpClockSystemTimePropertiesInstanceIndex_Type(ClockInstanceType):
    """Custom type cPtpClockSystemTimePropertiesInstanceIndex based on ClockInstanceType"""
    subtypeSpec = ClockInstanceType.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_CPtpClockSystemTimePropertiesInstanceIndex_Type.__name__ = "ClockInstanceType"
_CPtpClockSystemTimePropertiesInstanceIndex_Object = MibTableColumn
cPtpClockSystemTimePropertiesInstanceIndex = _CPtpClockSystemTimePropertiesInstanceIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1, 3),
    _CPtpClockSystemTimePropertiesInstanceIndex_Type()
)
cPtpClockSystemTimePropertiesInstanceIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cPtpClockSystemTimePropertiesInstanceIndex.setStatus("current")
_CPtpClockSystemTimePropertiesClockSyntonized_Type = TruthValue
_CPtpClockSystemTimePropertiesClockSyntonized_Object = MibTableColumn
cPtpClockSystemTimePropertiesClockSyntonized = _CPtpClockSystemTimePropertiesClockSyntonized_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1, 4),
    _CPtpClockSystemTimePropertiesClockSyntonized_Type()
)
cPtpClockSystemTimePropertiesClockSyntonized.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cPtpClockSystemTimePropertiesClockSyntonized.setStatus("current")
_CPtpClockSystemTimePropertiesDomainSyntonized_Type = TruthValue
_CPtpClockSystemTimePropertiesDomainSyntonized_Object = MibTableColumn
cPtpClockSystemTimePropertiesDomainSyntonized = _CPtpClockSystemTimePropertiesDomainSyntonized_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1, 5),
    _CPtpClockSystemTimePropertiesDomainSyntonized_Type()
)
cPtpClockSystemTimePropertiesDomainSyntonized.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cPtpClockSystemTimePropertiesDomainSyntonized.setStatus("current")
_CPtpClockSystemTimePropertiesFrequencyOffset_Type = Integer32
_CPtpClockSystemTimePropertiesFrequencyOffset_Object = MibTableColumn
cPtpClockSystemTimePropertiesFrequencyOffset = _CPtpClockSystemTimePropertiesFrequencyOffset_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 1, 2, 12, 1, 6),
    _CPtpClockSystemTimePropertiesFrequencyOffset_Type()
)
cPtpClockSystemTimePropertiesFrequencyOffset.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cPtpClockSystemTimePropertiesFrequencyOffset.setStatus("current")
...
ciscoPtpMIBClockPortGroup.setObjects(
      *(("CISCO-PTP-MIB", "cPtpClockPortName"),
        ...
        ("CISCO-PTP-MIB", "cPtpClockPortBlockGMC"),
...
ciscoPtpMIBClockSystemTimePropertiesGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 2, 2, 14)
)
ciscoPtpMIBClockSystemTimePropertiesGroup.setObjects(
      *(("CISCO-PTP-MIB", "cPtpClockSystemTimePropertiesClockSyntonized"),
        ("CISCO-PTP-MIB", "cPtpClockSystemTimePropertiesDomainSyntonized"),
        ("CISCO-PTP-MIB", "cPtpClockSystemTimePropertiesFrequencyOffset"))
)
if mibBuilder.loadTexts:
    ciscoPtpMIBClockSystemTimePropertiesGroup.setStatus("current")


# Notification objects

ciscoPtpGMClockChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 0, 1)
)
ciscoPtpGMClockChange.setObjects(
    ("CISCO-PTP-MIB", "cPtpClockParentDSGMClockIdentity")
)
if mibBuilder.loadTexts:
    ciscoPtpGMClockChange.setStatus(
        "current"
    )

ciscoPtpParentClockChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 0, 2)
)
ciscoPtpParentClockChange.setObjects(
    ("CISCO-PTP-MIB", "cPtpClockParentDSParentPortIdentity")
)
if mibBuilder.loadTexts:
    ciscoPtpParentClockChange.setStatus(
        "current"
    )

ciscoPtpRogueMaster = NotificationType(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 0, 3)
)
ciscoPtpRogueMaster.setObjects(
      *(("CISCO-PTP-MIB", "cPtpClockRogueMasterDetect"),
        ("CISCO-PTP-MIB", "cPtpClockPortName"))
)
if mibBuilder.loadTexts:
    ciscoPtpRogueMaster.setStatus(
        "current"
    )
...
ciscoPtpMIBNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 2, 2, 13)
)
ciscoPtpMIBNotificationGroup.setObjects(
      *(("CISCO-PTP-MIB", "ciscoPtpParentClockChange"),
        ("CISCO-PTP-MIB", "ciscoPtpGMClockChange"))
)
if mibBuilder.loadTexts:
    ciscoPtpMIBNotificationGroup.setStatus(
        "current"
    )
...
ciscoPtpMIBCompliances1.setObjects(
    ("CISCO-PTP-MIB", "ciscoPtpMIBSystemInfoGroup")
)
if mibBuilder.loadTexts:
...
ciscoPtpMIBCompliances2.setObjects(
      *(("CISCO-PTP-MIB", "ciscoPtpMIBClockCurrentDSGroup"),
        ("CISCO-PTP-MIB", "ciscoPtpMIBClockParentDSGroup"),
        ("CISCO-PTP-MIB", "ciscoPtpMIBClockDefaultDSGroup"),
        ("CISCO-PTP-MIB", "ciscoPtpMIBClockRunningGroup"),
        ("CISCO-PTP-MIB", "ciscoPtpMIBClockTimepropertiesGroup"),
        ("CISCO-PTP-MIB", "ciscoPtpMIBClockSystemTimePropertiesGroup"))
)
if mibBuilder.loadTexts:
...
ciscoPtpMIBCompliances3.setObjects(
      *(("CISCO-PTP-MIB", "ciscoPtpMIBClockPortGroup"),
        ("CISCO-PTP-MIB", "ciscoPtpMIBClockPortDSGroup"),
        ("CISCO-PTP-MIB", "ciscoPtpMIBClockPortRunningGroup"),
        ("CISCO-PTP-MIB", "ciscoPtpMIBClockPortAssociateGroup"))
)
if mibBuilder.loadTexts:
...
ciscoPtpMIBCompliances4.setObjects(
      *(("CISCO-PTP-MIB", "ciscoPtpMIBClockTranparentDSGroup"),
        ("CISCO-PTP-MIB", "ciscoPtpMIBClockPortTransDSGroup"))
)
if mibBuilder.loadTexts:
...
ciscoPtpMIBCompliances5 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 760, 2, 1, 5)
)
ciscoPtpMIBCompliances5.setObjects(
    ("CISCO-PTP-MIB", "ciscoPtpMIBNotificationGroup")
)
if mibBuilder.loadTexts:
    ciscoPtpMIBCompliances5.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"ClockDomainType": ClockDomainType,
       ...
       "ciscoPtpGMClockChange": ciscoPtpGMClockChange,
       "ciscoPtpParentClockChange": ciscoPtpParentClockChange,
       ...
       "cPtpClockPortBlockGMC": cPtpClockPortBlockGMC,
       "cPtpClockRogueMasterDetect": cPtpClockRogueMasterDetect,
       ...
       "cPtpClockSystemTimePropertiesTable": cPtpClockSystemTimePropertiesTable,
       "cPtpClockSystemTimePropertiesEntry": cPtpClockSystemTimePropertiesEntry,
       "cPtpClockSystemTimePropertiesDomainIndex": cPtpClockSystemTimePropertiesDomainIndex,
       "cPtpClockSystemTimePropertiesClockTypeIndex": cPtpClockSystemTimePropertiesClockTypeIndex,
       "cPtpClockSystemTimePropertiesInstanceIndex": cPtpClockSystemTimePropertiesInstanceIndex,
       "cPtpClockSystemTimePropertiesClockSyntonized": cPtpClockSystemTimePropertiesClockSyntonized,
       "cPtpClockSystemTimePropertiesDomainSyntonized": cPtpClockSystemTimePropertiesDomainSyntonized,
       ...
       "ciscoPtpMIBCompliances5": ciscoPtpMIBCompliances5,
       ...
       "ciscoPtpMIBNotificationGroup": ciscoPtpMIBNotificationGroup,
       "ciscoPtpMIBClockSystemTimePropertiesGroup": ciscoPtpMIBClockSystemTimePropertiesGroup}
)
