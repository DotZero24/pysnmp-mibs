...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-OID-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:43:33 2025
...
_HpnicfMulticastSnoop_ObjectIdentity = ObjectIdentity
hpnicfMulticastSnoop = _HpnicfMulticastSnoop_ObjectIdentity(
...
_HpnicfPvst_ObjectIdentity = ObjectIdentity
hpnicfPvst = _HpnicfPvst_ObjectIdentity(
...
_HpnicfSmlk_ObjectIdentity = ObjectIdentity
hpnicfSmlk = _HpnicfSmlk_ObjectIdentity(
...
_Hpnicf8021XExt2_ObjectIdentity = ObjectIdentity
hpnicf8021XExt2 = _Hpnicf8021XExt2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 153)
)
_HpnicfContext_ObjectIdentity = ObjectIdentity
hpnicfContext = _HpnicfContext_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 154)
)
_HpnicfObjp_ObjectIdentity = ObjectIdentity
hpnicfObjp = _HpnicfObjp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 155)
)
_HpnicfNvgre_ObjectIdentity = ObjectIdentity
hpnicfNvgre = _HpnicfNvgre_ObjectIdentity(
...
mibBuilder.exportSymbols(
    ...
    **{"hp": hp,
       ...
       "hpnicf8021XExt2": hpnicf8021XExt2,
