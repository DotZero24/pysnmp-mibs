...
# Notes
# -----
# ASN.1 source file://mibs/trendmicro/TPT-NGFW-SYSTEM-INFO-MIB
...
tptNgfwSystemInfoCompl.setObjects(
      *(("TPT-NGFW-SYSTEM-INFO-MIB", "tptNgfwSystemInfoGroup"),
        ("TPT-NGFW-SYSTEM-INFO-MIB", "tptNgfwSystemNotificationGroup"))
)
if mibBuilder.loadTexts:
