...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SWITCH-STATS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:30 2025
...
csstSwitchStatsMIBCompliance.setObjects(
      *(("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsConfOptionGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsConfMapGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsConfIfGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsVlanGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsL2Group"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsL3Group"))
)
if mibBuilder.loadTexts:
...
csstSwitchStatsMIBCompliance2.setObjects(
      *(("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsConfOptionGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsConfMapGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsConfIfGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsVlanGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsL2Group"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsLayer3Group"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsLayer3ExtGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsTotalGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsInternalStatsGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsInternalErrorGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsInternalInstanceGroup"),
        ("CISCO-SWITCH-STATS-MIB", "ciscoSwitchStatsRewriteEngineStatsGroup"))
)
if mibBuilder.loadTexts:
