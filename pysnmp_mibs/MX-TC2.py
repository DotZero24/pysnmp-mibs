# SNMP MIB module (MX-TC2) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/media5/MX-TC2
...
(mediatrixModules,) = mibBuilder.importSymbols(
    "MX-SMI",
    "mediatrixModules")

(mxTextualConventions,) = mibBuilder.importSymbols(
    "MX-TC",
...
mibBuilder.exportSymbols(
    "MX-TC2",
    **{"MxIpHostNamePort": MxIpHostNamePort,
       "MxIpAddr": MxIpAddr,
       "MxIpAddrPort": MxIpAddrPort,
       "MxIpAddrMask": MxIpAddrMask,
       "MxExtIpPort": MxExtIpPort,
       "MxUri": MxUri,
       "MxUrl": MxUrl,
       "MxUInt64": MxUInt64,
       "MxFloat32": MxFloat32}
