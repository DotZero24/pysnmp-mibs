...
# Notes
# -----
# ASN.1 source file://mibs/rfc/NEMO-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:24:13 2025
...
nemoCoreCompliance.setObjects(
    ("NEMO-MIB", "nemoSystemGroup")
)
if mibBuilder.loadTexts:
...
nemoCompliance2.setObjects(
      *(("NEMO-MIB", "nemoSystemGroup"),
        ("NEMO-MIB", "nemoBindingCacheGroup"))
)
if mibBuilder.loadTexts:
...
nemoCoreReadOnlyCompliance.setObjects(
    ("NEMO-MIB", "nemoSystemGroup")
)
if mibBuilder.loadTexts:
...
nemoReadOnlyCompliance2.setObjects(
      *(("NEMO-MIB", "nemoSystemGroup"),
        ("NEMO-MIB", "nemoBindingCacheGroup"))
)
if mibBuilder.loadTexts:
...
nemoMrCompliance.setObjects(
      *(("NEMO-MIB", "nemoStatsGroup"),
        ("NEMO-MIB", "nemoMrConfGroup"),
        ("NEMO-MIB", "nemoMrRegistrationGroup"))
)
if mibBuilder.loadTexts:
...
nemoMrReadOnlyCompliance2.setObjects(
      *(("NEMO-MIB", "nemoStatsGroup"),
        ("NEMO-MIB", "nemoMrConfGroup"),
        ("NEMO-MIB", "nemoMrRegistrationGroup"))
)
...
nemoHaCoreCompliance.setObjects(
    ("NEMO-MIB", "nemoHaSystemGroup")
)
if mibBuilder.loadTexts:
...
nemoHaCompliance2.setObjects(
      *(("NEMO-MIB", "nemoHaSystemGroup"),
        ("NEMO-MIB", "nemoHaStatsGroup"),
        ("NEMO-MIB", "nemoHaGlobalStatsGroup"))
)
if mibBuilder.loadTexts:
...
nemoNotificationCompliance.setObjects(
    ("NEMO-MIB", "nemoNotificationGroup")
)
if mibBuilder.loadTexts:
