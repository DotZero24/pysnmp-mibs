...
mip6MnBLEntry, mip6BindingHomeAddress, mip6MnBLCOA, mip6MnBLCOAType, mip6BindingCacheEntry, mip6BindingHomeAddressType = mibBuilder.importSymbols("MOBILEIPV6-MIB", "mip6MnBLEntry", "mip6BindingHomeAddress", "mip6MnBLCOA", "mip6MnBLCOAType", "mip6BindingCacheEntry", "mip6BindingHomeAddressType")
...
mibBuilder.exportSymbols("NEMO-MIB", nemoHomeTunnelEstablished=nemoHomeTunnelEstablished, nemoMrMovedOutofHome=nemoMrMovedOutofHome, nemoHaGlobalStatsGroup=nemoHaGlobalStatsGroup, nemoMrMobilityMessagesSent=nemoMrMobilityMessagesSent, nemoMrEgressIfRoamHoldDownTime=nemoMrEgressIfRoamHoldDownTime, nemoHaMobileNetworkPrefixTable=nemoHaMobileNetworkPrefixTable, nemoHaRegistration=nemoHaRegistration, nemoMIB=nemoMIB, nemoMrEgressIfPriority=nemoMrEgressIfPriority, nemoMrEgressIfDescription=nemoMrEgressIfDescription, nemoMrConf=nemoMrConf, nemoMrBLActiveEgressIfIndex=nemoMrBLActiveEgressIfIndex, nemoCn=nemoCn, nemoBindingCacheGroup=nemoBindingCacheGroup, nemoStats=nemoStats, nemoMrBindingAcksRegTypeChangeDisallowed=nemoMrBindingAcksRegTypeChangeDisallowed, nemoMrMobilityMessagesRecd=nemoMrMobilityMessagesRecd, nemoHaMobileNetworkPrefix=nemoHaMobileNetworkPrefix, nemoCompliances=nemoCompliances, nemoMr=nemoMr, nemoConformance=nemoConformance, nemoCoreCompliance=nemoCoreCompliance, nemoMrCompliance=nemoMrCompliance, nemoCounterDiscontinuityTime=nemoCounterDiscontinuityTime, nemoHaBUAcksOperationNotPermitted=nemoHaBUAcksOperationNotPermitted, nemoHa=nemoHa, nemoMrDiscoveryRepliesRouterFlagZero=nemoMrDiscoveryRepliesRouterFlagZero, nemoMrSystem=nemoMrSystem, nemoGroups=nemoGroups, nemoHaRecentBURejectionCode=nemoHaRecentBURejectionCode, nemoMrRegnCounters=nemoMrRegnCounters, nemoMrRegistrationGroup=nemoMrRegistrationGroup, nemoMrBindingAcksOperationNotPermitted=nemoMrBindingAcksOperationNotPermitted, nemoHaMobileNetworkPrefixEntry=nemoHaMobileNetworkPrefixEntry, nemoCapabilities=nemoCapabilities, nemoHaCounterEntry=nemoHaCounterEntry, nemoBindingMrMode=nemoBindingMrMode, nemoHaStats=nemoHaStats, nemoHaSystemGroup=nemoHaSystemGroup, nemoMrMovedHome=nemoMrMovedHome, nemoHaMobileNetworkPrefixSource=nemoHaMobileNetworkPrefixSource, nemoHaMobileNetworkPrefixSeqNo=nemoHaMobileNetworkPrefixSeqNo, nemoHaBURequestsAccepted=nemoHaBURequestsAccepted, nemoMrBindingAcksWONemoSupport=nemoMrBindingAcksWONemoSupport, nemoMrGlobalStats=nemoMrGlobalStats, nemoCompliance2=nemoCompliance2, nemoBindings=nemoBindings, nemoHaCtrDiscontinuityTime=nemoHaCtrDiscontinuityTime, nemoBindingCacheTable=nemoBindingCacheTable, nemoHaBUAcksWONemoSupport=nemoHaBUAcksWONemoSupport, nemoNotificationGroup=nemoNotificationGroup, nemoMrRegistration=nemoMrRegistration, nemoHaMobileNetworkPrefixType=nemoHaMobileNetworkPrefixType, nemoStatus=nemoStatus, nemoMrBLEstablishedHomeTunnelIfIndex=nemoMrBLEstablishedHomeTunnelIfIndex, nemoStatsGroup=nemoStatsGroup, nemoSystemGroup=nemoSystemGroup, nemoSystem=nemoSystem, nemoMrPrefixRegMode=nemoMrPrefixRegMode, nemoMrEgressIfTable=nemoMrEgressIfTable, nemoMrMovedFNtoFN=nemoMrMovedFNtoFN, nemoHaBCEntryCreationTime=nemoHaBCEntryCreationTime, nemoReadOnlyCompliance2=nemoReadOnlyCompliance2, nemoHaBUAcksRegTypeChangeDisallowed=nemoHaBUAcksRegTypeChangeDisallowed, nemoHaStatsGroup=nemoHaStatsGroup, nemoHaBUAcksNotAuthorizedForPrefix=nemoHaBUAcksNotAuthorizedForPrefix, nemoMrBindingAcksOtherError=nemoMrBindingAcksOtherError, PYSNMP_MODULE_ID=nemoMIB, nemoBindingMrFlag=nemoBindingMrFlag, nemoHaBURejectionTime=nemoHaBURejectionTime, nemoCoreReadOnlyCompliance=nemoCoreReadOnlyCompliance, nemoMrEgressIfEntry=nemoMrEgressIfEntry, nemoHaBUAcksForwardingSetupFailed=nemoHaBUAcksForwardingSetupFailed, nemoHaBURequestsDenied=nemoHaBURequestsDenied, nemoMrBLMode=nemoMrBLMode, nemoHomeTunnelReleased=nemoHomeTunnelReleased, nemoHaGlobalStats=nemoHaGlobalStats, nemoMrBetterIfDetected=nemoMrBetterIfDetected, nemoNotificationCompliance=nemoNotificationCompliance, nemoMrDiscoveryRequests=nemoMrDiscoveryRequests, nemoHaBUAcksOtherError=nemoHaBUAcksOtherError, NemoBURequestRejectionCode=NemoBURequestRejectionCode, nemoMrBindingAcksForwardingSetupFailed=nemoMrBindingAcksForwardingSetupFailed, nemoHaBUAcksInvalidPrefix=nemoHaBUAcksInvalidPrefix, nemoHaAdvertisement=nemoHaAdvertisement, nemoMrBLTable=nemoMrBLTable, nemoMrConfGroup=nemoMrConfGroup, nemoCore=nemoCore, nemoObjects=nemoObjects, nemoNotifications=nemoNotifications, nemoBindingCacheEntry=nemoBindingCacheEntry, nemoHaMobileNetworkPrefixLength=nemoHaMobileNetworkPrefixLength, nemoHaCoreCompliance=nemoHaCoreCompliance, nemoHaCompliance2=nemoHaCompliance2, nemoMrBindingAcksNotAuthorizedForPrefix=nemoMrBindingAcksNotAuthorizedForPrefix, nemoMrBLHomeAddressPrefixLength=nemoMrBLHomeAddressPrefixLength, nemoConfiguration=nemoConfiguration, nemoMrBLMrFlag=nemoMrBLMrFlag, nemoHaCounterTable=nemoHaCounterTable, nemoMrBLEntry=nemoMrBLEntry, nemoMrBindingAcksInvalidPrefix=nemoMrBindingAcksInvalidPrefix, nemoMrReadOnlyCompliance2=nemoMrReadOnlyCompliance2, nemoHaBUAcceptedTime=nemoHaBUAcceptedTime, nemoMrDiscoveryReplies=nemoMrDiscoveryReplies, nemoMrBLCareofAddressPrefixLength=nemoMrBLCareofAddressPrefixLength, nemoMrEgressIfIndex=nemoMrEgressIfIndex)
