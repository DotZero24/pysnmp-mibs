...
# Produced by pysmi-1.6.2 at Fri Oct 10 19:46:51 2025
...
class _CienaCesOamEventLogPort_Type(Integer32):
    """Custom type cienaCesOamEventLogPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 1000),
    )
...
_CienaCesOamEventLogPort_Type.__name__ = "Integer32"
