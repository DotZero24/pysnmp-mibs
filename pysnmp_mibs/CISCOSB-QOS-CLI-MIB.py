...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-QOS-CLI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:41:07 2025
...
rlQosAclLastAceIndex = _RlQosAclLastAceIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 88, 7, 1, 7),
    _RlQosAclLastAceIndex_Type()
)
rlQosAclLastAceIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlQosAclLastAceIndex.setStatus("current")
...
rlQosClassifierUtilizationEntry.setIndexNames(
    ...
    (0, "CISCOSB-QOS-CLI-MIB", "rlQosClassifierUtilizationPoolId"),
)
if mibBuilder.loadTexts:
...
class _RlQosClassifierUtilizationPoolId_Type(Unsigned32):
    """Custom type rlQosClassifierUtilizationPoolId based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_RlQosClassifierUtilizationPoolId_Type.__name__ = "Unsigned32"
_RlQosClassifierUtilizationPoolId_Object = MibTableColumn
rlQosClassifierUtilizationPoolId = _RlQosClassifierUtilizationPoolId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 88, 36, 1, 1, 2),
    _RlQosClassifierUtilizationPoolId_Type()
)
rlQosClassifierUtilizationPoolId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    rlQosClassifierUtilizationPoolId.setStatus("current")
...
rlQosClassifierUtilizationFreeRulesNumber = _RlQosClassifierUtilizationFreeRulesNumber_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 88, 36, 1, 1, 5),
...
mibBuilder.exportSymbols(
    ...
    **{"ClassOffsetType": ClassOffsetType,
       ...
       "rlQosAclLastAceIndex": rlQosAclLastAceIndex,
       ...
       "rlQosClassifierUtilizationPoolId": rlQosClassifierUtilizationPoolId,
