...
MplsLSPID, MplsBurstSize, MplsInitialCreationSource, MplsBitRate, mplsMIB, MplsLabel = mibBuilder.importSymbols("HP-SN-MPLS-TC-MIB", "MplsLSPID", "MplsBurstSize", "MplsInitialCreationSource", "MplsBitRate", "mplsMIB", "MplsLabel")
