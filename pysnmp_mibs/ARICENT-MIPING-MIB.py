# SNMP MIB module (ARICENT-MIPING-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MIPING-MIB
...
fsMIPingIndex = _FsMIPingIndex_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 1),
    _FsMIPingIndex_Type()
)
...
fsMIPingDest = _FsMIPingDest_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 2),
    _FsMIPingDest_Type()
)
...
fsMIPingContextId = _FsMIPingContextId_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 3),
...
fsMIPingTimeout = _FsMIPingTimeout_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 4),
...
fsMIPingTries = _FsMIPingTries_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 5),
    _FsMIPingTries_Type()
)
...
fsMIPingDataSize = _FsMIPingDataSize_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 6),
...
fsMIPingStatus = _FsMIPingStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 7),
...
fsMIPingSendCount = _FsMIPingSendCount_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 8),
...
fsMIPingAverageTime = _FsMIPingAverageTime_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 9),
...
fsMIPingMaxTime = _FsMIPingMaxTime_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 10),
...
fsMIPingMinTime = _FsMIPingMinTime_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 11),
...
fsMIPingSuccesses = _FsMIPingSuccesses_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 12),
...
fsMIPingEntryStatus = _FsMIPingEntryStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 13),
...
class _FsMIPingHostName_Type(OctetString):
    """Custom type fsMIPingHostName based on OctetString"""
...
_FsMIPingHostName_Type.__name__ = "OctetString"
_FsMIPingHostName_Object = MibTableColumn
fsMIPingHostName = _FsMIPingHostName_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 36, 1, 1, 1, 14),
    _FsMIPingHostName_Type()
)
fsMIPingHostName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIPingHostName.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"fsMIPingMIB": fsMIPingMIB,
       ...
       "fsMIPingHostName": fsMIPingHostName}
)
