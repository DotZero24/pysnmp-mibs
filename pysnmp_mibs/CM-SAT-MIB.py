...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/adva/CM-SAT-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:36:54 2025
...
AdminState, VlanId, SecondaryState, MepDestinationType, VlanPriority, OperationalState, CmPmBinAction = mibBuilder.importSymbols("CM-COMMON-MIB", "AdminState", "VlanId", "SecondaryState", "MepDestinationType", "VlanPriority", "OperationalState", "CmPmBinAction")
neIndex, networkElementEntry, shelfIndex, slotIndex = mibBuilder.importSymbols("CM-ENTITY-MIB", "neIndex", "networkElementEntry", "shelfIndex", "slotIndex")
...
dot1agCfmMepEntry, Dot1agCfmMepIdOrZero = mibBuilder.importSymbols("IEEE8021-CFM-MIB", "dot1agCfmMepEntry", "Dot1agCfmMepIdOrZero")
...
cmServiceActivationMIB.setRevisions(('2013-09-12 00:00',))
if mibBuilder.loadTexts: cmServiceActivationMIB.setLastUpdated('201309120000Z')
if mibBuilder.loadTexts: cmServiceActivationMIB.setOrganization('ADVA Optical Networking')
...
class SatStatus(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("completed", 1), ("notStarted", 2), ("inProgress", 3), ("failed", 4))
...
cmSatGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 2544, 1, 12, 28, 3, 2, 1)).setObjects(("CM-SAT-MIB", "satControlIndex"), ("CM-SAT-MIB", "satControlName"), ("CM-SAT-MIB", "satControlTestMode"), ("CM-SAT-MIB", "satControlTestProcedures"), ("CM-SAT-MIB", "satControlConfigTestDuration"), ("CM-SAT-MIB", "satControlConfigCIRTestStepNum"), ("CM-SAT-MIB", "satControlConfigCIRTestStepDuration"), ("CM-SAT-MIB", "satControlPerfTestDuration"), ("CM-SAT-MIB", "satControlStatus"), ("CM-SAT-MIB", "satControlAction"), ("CM-SAT-MIB", "satControlFailCause"), ("CM-SAT-MIB", "satControlTestStartTime"), ("CM-SAT-MIB", "satControlFlpduTagOverride"), ("CM-SAT-MIB", "satStreamIndex"), ("CM-SAT-MIB", "satStreamName"), ("CM-SAT-MIB", "satStreamTestPort"), ("CM-SAT-MIB", "satStreamTestDirection"), ("CM-SAT-MIB", "satStreamDestMacAddress"), ("CM-SAT-MIB", "satStreamFramePayloadType"), ("CM-SAT-MIB", "satStreamCustomFramePayload"), ("CM-SAT-MIB", "satStreamFrameSizeList"), ("CM-SAT-MIB", "satStreamSacProfileId"), ("CM-SAT-MIB", "satStreamSrcMepId"), ("CM-SAT-MIB", "satStreamDestMepType"), ("CM-SAT-MIB", "satStreamDestMepId"), ("CM-SAT-MIB", "satStreamDestMepMacAddr"), ("CM-SAT-MIB", "satStreamDmmPacketSize"), ("CM-SAT-MIB", "satStreamDmmPacketInterval"), ("CM-SAT-MIB", "satStreamOverallResult"), ("CM-SAT-MIB", "satStreamAction"), ("CM-SAT-MIB", "satStreamStatus"), ("CM-SAT-MIB", "satStreamCurrentTestProcedure"), ("CM-SAT-MIB", "satStreamCurrentConfigCirTestStep"), ("CM-SAT-MIB", "satStreamInner1VlanId"), ("CM-SAT-MIB", "satStreamInner1VlanPri"), ("CM-SAT-MIB", "satStreamInner1VlanEnabled"), ("CM-SAT-MIB", "satStreamInner1ValnEtherType"), ("CM-SAT-MIB", "satStreamInner2VlanId"), ("CM-SAT-MIB", "satStreamInner2VlanPri"), ("CM-SAT-MIB", "satStreamInner2VlanEnabled"), ("CM-SAT-MIB", "satStreamInner2VlanEtherType"), ("CM-SAT-MIB", "satStreamOuterVlanId"), ("CM-SAT-MIB", "satStreamOuterVlanPri"), ("CM-SAT-MIB", "satStreamOuterVlanEnabled"), ("CM-SAT-MIB", "satStreamOuterVlanEtherType"), ("CM-SAT-MIB", "satStreamDeiEnabled"), ("CM-SAT-MIB", "satStreamGreenPcp"), ("CM-SAT-MIB", "satStreamYellowPcp"), ("CM-SAT-MIB", "satStreamColorMode"), ("CM-SAT-MIB", "satStreamCirLo"), ("CM-SAT-MIB", "satStreamCirHi"), ("CM-SAT-MIB", "satStreamEirLo"), ("CM-SAT-MIB", "satStreamEirHi"), ("CM-SAT-MIB", "satStreamCbs"), ("CM-SAT-MIB", "satStreamEbs"), ("CM-SAT-MIB", "satStreamStorageType"), ("CM-SAT-MIB", "satStreamRowStatus"), ("CM-SAT-MIB", "satControlStorageType"), ("CM-SAT-MIB", "satControlRowStatus"), ("CM-SAT-MIB", "satStreamDmmPktPriority"), ("CM-SAT-MIB", "satStreamMFactor"), ("CM-SAT-MIB", "satResultStatsSessionId"), ("CM-SAT-MIB", "satResultStatsTestType"), ("CM-SAT-MIB", "satResultStatsStepNumber"), ("CM-SAT-MIB", "satResultStatsStartTime"), ("CM-SAT-MIB", "satResultStatsEndTime"), ("CM-SAT-MIB", "satResultStatsStatus"), ("CM-SAT-MIB", "satResultStatsResult"), ("CM-SAT-MIB", "satResultStatsMinIRGMeasured"), ("CM-SAT-MIB", "satResultStatsAvgIRGMeasured"), ("CM-SAT-MIB", "satResultStatsMaxIRGMeasured"), ("CM-SAT-MIB", "satResultStatsMinIRYMeasured"), ("CM-SAT-MIB", "satResultStatsAvgIRYMeasured"), ("CM-SAT-MIB", "satResultStatsMaxIRYMeasured"), ("CM-SAT-MIB", "satResultStatsFlrGMeasured"), ("CM-SAT-MIB", "satResultStatsFlrYMeasured"), ("CM-SAT-MIB", "satResultStatsFlrGCounts"), ("CM-SAT-MIB", "satResultStatsFlrYCounts"), ("CM-SAT-MIB", "satResultStatsMinFTDGMeasured"), ("CM-SAT-MIB", "satResultStatsAvgFTDGMeasured"), ("CM-SAT-MIB", "satResultStatsMaxFTDGMeasured"), ("CM-SAT-MIB", "satResultStatsIMinFDVGMeasured"), ("CM-SAT-MIB", "satResultStatsIAvgFDVGMeasured"), ("CM-SAT-MIB", "satResultStatsIMaxFDVGMeasured"), ("CM-SAT-MIB", "satResultStatsISyncErrorsNum"), ("CM-SAT-MIB", "satResultStatsIfNegFLG"), ("CM-SAT-MIB", "satResultStatsIfNegFLY"), ("CM-SAT-MIB", "satResultStatsAvgIRT"), ("CM-SAT-MIB", "satResultStatsFlrTMeasured"), ("CM-SAT-MIB", "satResultStatsFlTCounts"), ("CM-SAT-MIB", "satResultStatsIfNegFLT"), ("CM-SAT-MIB", "satSacProfileIndex"), ("CM-SAT-MIB", "satSacProfileAlias"), ("CM-SAT-MIB", "satSacProfileFLR"), ("CM-SAT-MIB", "satSacProfileFTD"), ("CM-SAT-MIB", "satSacProfileFDV"), ("CM-SAT-MIB", "satSacProfileStorageType"), ("CM-SAT-MIB", "satSacProfileRowStatus"), ("CM-SAT-MIB", "satResponderSessionIndex"), ("CM-SAT-MIB", "satResponderSessionId"), ("CM-SAT-MIB", "satResponderSessionControlMepMacAddr"), ("CM-SAT-MIB", "satResponderSessionMepId"), ("CM-SAT-MIB", "satResponderSessionStorageType"), ("CM-SAT-MIB", "satResponderSessionRowStatus"), ("CM-SAT-MIB", "satCfmMepSatResponderEnabled"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    cmSatGroup = cmSatGroup.setStatus('current')
mibBuilder.exportSymbols("CM-SAT-MIB", satStreamOuterVlanEtherType=satStreamOuterVlanEtherType, satResultStatsSessionId=satResultStatsSessionId, satStreamInner1VlanId=satStreamInner1VlanId, satControlTable=satControlTable, satResultStatsIMaxFDVGMeasured=satResultStatsIMaxFDVGMeasured, satStreamInner2VlanId=satStreamInner2VlanId, satStreamRowStatus=satStreamRowStatus, satResultStatsFlrTMeasured=satResultStatsFlrTMeasured, satControlAction=satControlAction, satStreamDestMepType=satStreamDestMepType, SatProceduresList=SatProceduresList, satResultStatsEndTime=satResultStatsEndTime, satStreamOuterVlanPri=satStreamOuterVlanPri, satResultStatsMaxIRYMeasured=satResultStatsMaxIRYMeasured, satStreamFrameSizeList=satStreamFrameSizeList, satControlStatus=satControlStatus, satResponderSessionMepId=satResponderSessionMepId, cmServActivationCompliances=cmServActivationCompliances, SatFramePayloadType=SatFramePayloadType, satResultStatsIMinFDVGMeasured=satResultStatsIMinFDVGMeasured, satResultStatsFlrGMeasured=satResultStatsFlrGMeasured, satResultStatsFlrYCounts=satResultStatsFlrYCounts, SatTestAction=SatTestAction, satStreamTestPort=satStreamTestPort, satCfmMepExtTable=satCfmMepExtTable, cmServActivationCompliance=cmServActivationCompliance, satResponderSessionRowStatus=satResponderSessionRowStatus, satSacProfileFTD=satSacProfileFTD, satSacProfileRowStatus=satSacProfileRowStatus, satControlPerfTestDuration=satControlPerfTestDuration, cmServActivationObjects=cmServActivationObjects, satStreamDestMacAddress=satStreamDestMacAddress, satStreamOverallResult=satStreamOverallResult, satStreamInner1VlanPri=satStreamInner1VlanPri, satResultStatsMinIRYMeasured=satResultStatsMinIRYMeasured, satResultStatsStepNumber=satResultStatsStepNumber, satResultStatsFlrGCounts=satResultStatsFlrGCounts, satStreamEirHi=satStreamEirHi, satStreamCurrentTestProcedure=satStreamCurrentTestProcedure, satResultStatsStatus=satResultStatsStatus, satStreamMFactor=satStreamMFactor, cmServActivationConformance=cmServActivationConformance, satStreamOuterVlanEnabled=satStreamOuterVlanEnabled, satResultStatsIfNegFLT=satResultStatsIfNegFLT, satControlRowStatus=satControlRowStatus, satControlEntry=satControlEntry, satStreamDmmPacketSize=satStreamDmmPacketSize, neSatParamsEtherType=neSatParamsEtherType, satResponderSessionEntry=satResponderSessionEntry, satResultStatsAvgIRYMeasured=satResultStatsAvgIRYMeasured, satControlStorageType=satControlStorageType, satSacProfileAlias=satSacProfileAlias, satResultStatsMaxIRGMeasured=satResultStatsMaxIRGMeasured, satStreamOuterVlanId=satStreamOuterVlanId, satStreamDmmPktPriority=satStreamDmmPktPriority, satStreamEbs=satStreamEbs, satResultStatsResult=satResultStatsResult, satStreamDeiEnabled=satStreamDeiEnabled, satStreamAction=satStreamAction, satResultStatsIfNegFLY=satResultStatsIfNegFLY, PYSNMP_MODULE_ID=cmServiceActivationMIB, cmServActivationNotifications=cmServActivationNotifications, networkElementSatParamsEntry=networkElementSatParamsEntry, cmServiceActivationMIB=cmServiceActivationMIB, satControlTestStartTime=satControlTestStartTime, cmSatGroup=cmSatGroup, SatDirection=SatDirection, satStreamEntry=satStreamEntry, satResultStatsIAvgFDVGMeasured=satResultStatsIAvgFDVGMeasured, satControlFailCause=satControlFailCause, satResultStatsTestType=satResultStatsTestType, satStreamInner1VlanEnabled=satStreamInner1VlanEnabled, satResultStatsMaxFTDGMeasured=satResultStatsMaxFTDGMeasured, satStreamFramePayloadType=satStreamFramePayloadType, satControlTestMode=satControlTestMode, satCfmMepExtEntry=satCfmMepExtEntry, SatProceduresType=SatProceduresType, satResponderSessionControlMepMacAddr=satResponderSessionControlMepMacAddr, satControlTestProcedures=satControlTestProcedures, satSacProfileFLR=satSacProfileFLR, satStreamCirLo=satStreamCirLo, satCfmMepSatResponderEnabled=satCfmMepSatResponderEnabled, satStreamInner2VlanEnabled=satStreamInner2VlanEnabled, satControlFlpduTagOverride=satControlFlpduTagOverride, SatStatus=SatStatus, satResultStatsMinFTDGMeasured=satResultStatsMinFTDGMeasured, satResultStatsTable=satResultStatsTable, satControlConfigCIRTestStepDuration=satControlConfigCIRTestStepDuration, satStreamYellowPcp=satStreamYellowPcp, satStreamCbs=satStreamCbs, satResultStatsIfNegFLG=satResultStatsIfNegFLG, satStreamInner2VlanEtherType=satStreamInner2VlanEtherType, ServiceActivationTestMode=ServiceActivationTestMode, satSacProfileStorageType=satSacProfileStorageType, satStreamDmmPacketInterval=satStreamDmmPacketInterval, satStreamGreenPcp=satStreamGreenPcp, satStreamTable=satStreamTable, satStreamInner1ValnEtherType=satStreamInner1ValnEtherType, satResultStatsISyncErrorsNum=satResultStatsISyncErrorsNum, satSacProfileTable=satSacProfileTable, satStreamColorMode=satStreamColorMode, satSacProfileEntry=satSacProfileEntry, satStreamCustomFramePayload=satStreamCustomFramePayload, satStreamEirLo=satStreamEirLo, satResponderSessionStorageType=satResponderSessionStorageType, satStreamCurrentConfigCirTestStep=satStreamCurrentConfigCirTestStep, satControlConfigCIRTestStepNum=satControlConfigCIRTestStepNum, satStreamTestDirection=satStreamTestDirection, satControlName=satControlName, satResultStatsMinIRGMeasured=satResultStatsMinIRGMeasured, satResponderSessionIndex=satResponderSessionIndex, satSacProfileFDV=satSacProfileFDV, satStreamCirHi=satStreamCirHi, satResultStatsAvgFTDGMeasured=satResultStatsAvgFTDGMeasured, satStreamName=satStreamName, networkElementSatParamsTable=networkElementSatParamsTable, cmServActivationGroups=cmServActivationGroups, satControlConfigTestDuration=satControlConfigTestDuration, satStreamInner2VlanPri=satStreamInner2VlanPri, satResultStatsAvgIRGMeasured=satResultStatsAvgIRGMeasured, satStreamDestMepMacAddr=satStreamDestMepMacAddr, SatResult=SatResult, satStreamSrcMepId=satStreamSrcMepId, satResultStatsFlTCounts=satResultStatsFlTCounts, satResultStatsStartTime=satResultStatsStartTime, satResultStatsFlrYMeasured=satResultStatsFlrYMeasured, satResponderSessionTable=satResponderSessionTable, satControlIndex=satControlIndex, satStreamDestMepId=satStreamDestMepId, satStreamIndex=satStreamIndex, satStreamSacProfileId=satStreamSacProfileId, satResultStatsAvgIRT=satResultStatsAvgIRT, satSacProfileIndex=satSacProfileIndex, satStreamStatus=satStreamStatus, satStreamStorageType=satStreamStorageType, satResponderSessionId=satResponderSessionId, satResultStatsEntry=satResultStatsEntry)
