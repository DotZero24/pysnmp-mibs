...
mibBuilder.exportSymbols("DPS-MIB-V38", dpsRTUIdent=dpsRTUIdent, dpsRTUAState=dpsRTUAState, tmonAPoint=tmonAPoint, dpsRTUPort=dpsRTUPort, tmonIdent=tmonIdent, dpsRTUDispDesc=dpsRTUDispDesc, tmonASite=tmonASite, tmonCRalarmSet=tmonCRalarmSet, tmonAAddress=tmonAAddress, tmonMNalarmClr=tmonMNalarmClr, tmonADispDesc=tmonADispDesc, tmonCommandGrid=tmonCommandGrid, tmonCAddress=tmonCAddress, tmonAChgDate=tmonAChgDate, tmonAPort=tmonAPort, dpsAlarmControl=dpsAlarmControl, tmonCPoint=tmonCPoint, tmonCResult=tmonCResult, dpsRTUAddress=dpsRTUAddress, dpsRTUADisplay=dpsRTUADisplay, dpsRTUDisplayGrid=dpsRTUDisplayGrid, tmonSTalarmSet=tmonSTalarmSet, dpsRTUPointSet=dpsRTUPointSet, tmonIdentSoftwareVersion=tmonIdentSoftwareVersion, tmonCRalarmClr=tmonCRalarmClr, dpsRTUCAction=dpsRTUCAction, tmonXM=tmonXM, dpsRTUManufacturer=dpsRTUManufacturer, tmonAChgTime=tmonAChgTime, dpsRTUDisplay=dpsRTUDisplay, tmonAState=tmonAState, tmonADesc=tmonADesc, dpsRTUDisplayEntry=dpsRTUDisplayEntry, tmonCAuxText=tmonCAuxText, dpsRTUsumPSet=dpsRTUsumPSet, dpsInc=dpsInc, dpsRTUDateTime=dpsRTUDateTime, tmonAIndex=tmonAIndex, tmonCPType=tmonCPType, dpsRTUcomRestored=dpsRTUcomRestored, tmonIdentManufacturer=tmonIdentManufacturer, dpsRTUAPoint=dpsRTUAPoint, dpsRTUSyncReq=dpsRTUSyncReq, tmonAPntType=tmonAPntType, dpsRTUCAddress=dpsRTUCAddress, tmonMJalarmSet=tmonMJalarmSet, tmonIdentModel=tmonIdentModel, tmonADisplay=tmonADisplay, dpsRTUsumPClr=dpsRTUsumPClr, dpsRTUFirmwareVersion=dpsRTUFirmwareVersion, tmonAlarmTable=tmonAlarmTable, tmonCPort=tmonCPort, tmonCDisplay=tmonCDisplay, dpsRTUModel=dpsRTUModel, dpsRTUPntMap=dpsRTUPntMap, dpsRTUCDisplay=dpsRTUCDisplay, dpsRTUAPort=dpsRTUAPort, dpsRTUPointClr=dpsRTUPointClr, dpsRTUcomFailed=dpsRTUcomFailed, tmonAAuxDesc=tmonAAuxDesc, tmonMNalarmSet=tmonMNalarmSet, tmonASeverity=tmonASeverity, dpsRTUCPoint=dpsRTUCPoint, dpsRTUControlGrid=dpsRTUControlGrid, dpsRTUCPort=dpsRTUCPort, dpsRTUAlarmEntry=dpsRTUAlarmEntry, tmonAlarmEntry=tmonAlarmEntry, tmonCEvent=tmonCEvent, dpsRTUAlarmGrid=dpsRTUAlarmGrid, tmonMJalarmClr=tmonMJalarmClr, dpsRTUAPntDesc=dpsRTUAPntDesc, tmonCAction=tmonCAction, tmonSTalarmClr=tmonSTalarmClr, dpsRTUAAddress=dpsRTUAAddress, dpsRTU=dpsRTU)
