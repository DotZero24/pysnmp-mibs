# SNMP MIB module (SOCOMECUPS7-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/socomec/SOCOMECUPS7-MIB
...
upsInputEntry.setIndexNames(
    (0, "SOCOMECUPS7-MIB", "upsInputLineIndex"),
)
if mibBuilder.loadTexts:
...
upsOutputEntry.setIndexNames(
    (0, "SOCOMECUPS7-MIB", "upsOutputLineIndex"),
)
if mibBuilder.loadTexts:
...
upsBypassEntry.setIndexNames(
    (0, "SOCOMECUPS7-MIB", "upsBypassLineIndex"),
)
if mibBuilder.loadTexts:
...
shutdownParamEntry.setIndexNames(
    (0, "SOCOMECUPS7-MIB", "upsControlEventIndex"),
)
if mibBuilder.loadTexts:
...
upsControlWeeklyScheduleEntry.setIndexNames(
    (0, "SOCOMECUPS7-MIB", "upsControlWeeklyIndex"),
)
if mibBuilder.loadTexts:
...
upsControlSpecialScheduleEntry.setIndexNames(
    (0, "SOCOMECUPS7-MIB", "upsControlSpecialIndex"),
)
if mibBuilder.loadTexts:
...
upsControlEcoModeScheduleEntry.setIndexNames(
    (0, "SOCOMECUPS7-MIB", "upsControlEcoModeIndex"),
)
if mibBuilder.loadTexts:
...
upsDevicesEntry.setIndexNames(
    (0, "SOCOMECUPS7-MIB", "indexOfDevice"),
)
if mibBuilder.loadTexts:
...
upsTrapOnBattery.setObjects(
      *(("SOCOMECUPS7-MIB", "upsEstimatedMinutesRemaining"),
        ("SOCOMECUPS7-MIB", "upsSecondsOnBattery"))
)
if mibBuilder.loadTexts:
...
upsTrapAlarmEntryAdded.setObjects(
      *(("SOCOMECUPS7-MIB", "upsAlarmId"),
        ("SOCOMECUPS7-MIB", "upsAlarmDescr"))
)
if mibBuilder.loadTexts:
