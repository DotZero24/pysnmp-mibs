...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/mrv/RT-CFG-MIB
...
ModuleIdentity, Counter64, NotificationType, enterprises, Integer32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, Unsigned32, MibIdentifier, TimeTicks, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "NotificationType", "enterprises", "Integer32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "Unsigned32", "MibIdentifier", "TimeTicks", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("RT-CFG-MIB", nbVifDevName=nbVifDevName, nbVifProxyArpMode=nbVifProxyArpMode, nbRtFibTable=nbRtFibTable, nbRtActionListEntry=nbRtActionListEntry, nbRtFibEntryIpMask=nbRtFibEntryIpMask, nbRtPoliceRateLimitCoSlevel=nbRtPoliceRateLimitCoSlevel, nbRtAccPortAdminStatus=nbRtAccPortAdminStatus, nbRtAccVifEntry=nbRtAccVifEntry, nbRtDiffServDscpMapName=nbRtDiffServDscpMapName, nbRtVifIsTagged=nbRtVifIsTagged, nbVifMac=nbVifMac, nbRtAccVifAdminStatus=nbRtAccVifAdminStatus, nbRtPortTagVmanDefTag=nbRtPortTagVmanDefTag, nbRtPoliceRateLimitLowExceedFrames32=nbRtPoliceRateLimitLowExceedFrames32, nbVifAliasDLimitTable=nbVifAliasDLimitTable, nbRtFibEntryIpAddress=nbRtFibEntryIpAddress, nbRtDiffServMgmtDscpMapNameIndex=nbRtDiffServMgmtDscpMapNameIndex, nbRtAccPortHighConformingMcastPackets=nbRtAccPortHighConformingMcastPackets, nbVifPeer=nbVifPeer, nbRtAccPortHighExceedingPackets=nbRtAccPortHighExceedingPackets, nbRtDiffServDscpMapPrflTable=nbRtDiffServDscpMapPrflTable, nbRtAccPortConformingBytes=nbRtAccPortConformingBytes, nbRtPoliceRateLimitOperMode=nbRtPoliceRateLimitOperMode, nbRtPoliceRateLimitBuckRate=nbRtPoliceRateLimitBuckRate, nbRtAccPort64ConformingMcastPackets=nbRtAccPort64ConformingMcastPackets, nbRtPoliceActionOperMode=nbRtPoliceActionOperMode, nbRtVifMac=nbRtVifMac, nbVifTableSize=nbVifTableSize, nbRtVifDiffServAdminStatus=nbRtVifDiffServAdminStatus, nbRtDiffServDscpMapEntry=nbRtDiffServDscpMapEntry, nbAclVifId=nbAclVifId, nbRtDiffServVptMapPrflInValue=nbRtDiffServVptMapPrflInValue, nbRtActionListName=nbRtActionListName, nbRtPoliceActionTable=nbRtPoliceActionTable, nbRtPoliceActionEntry=nbRtPoliceActionEntry, nbRtPoliceActionSharingMode=nbRtPoliceActionSharingMode, MacAddress=MacAddress, nbVifIpOnlyMode=nbVifIpOnlyMode, nbRtAccVif64ConformingBytes=nbRtAccVif64ConformingBytes, nbRtAccVifExceedingBytes=nbRtAccVifExceedingBytes, nbRtAccPortHighConformingBcastPackets=nbRtAccPortHighConformingBcastPackets, nbRtDiffServVptMapEntry=nbRtDiffServVptMapEntry, nbRtDiffServDscpMapPrflInValueId=nbRtDiffServDscpMapPrflInValueId, nbRtPortTagId=nbRtPortTagId, nbRtAccPortExceedingBytes=nbRtAccPortExceedingBytes, nbRtAccPortLowConformingBcastPackets=nbRtAccPortLowConformingBcastPackets, nbRtPoliceRateLimitName=nbRtPoliceRateLimitName, nbRtAccVifLowExceedingBytes=nbRtAccVifLowExceedingBytes, nbVifSecurity=nbVifSecurity, nbRtFibEntryNextPhysAddress=nbRtFibEntryNextPhysAddress, nbRtVifDiffServRateLimitTable=nbRtVifDiffServRateLimitTable, nbVifLimitType=nbVifLimitType, nbRtDiffServVptMapNameIndex=nbRtDiffServVptMapNameIndex, nbRtPoliceActionVifBindingStatus=nbRtPoliceActionVifBindingStatus, nbRtPoliceRateLimitEntry=nbRtPoliceRateLimitEntry, nbRtPoliceRateLimitHighExceedBytes32=nbRtPoliceRateLimitHighExceedBytes32, nbRtActionListAdminStatus=nbRtActionListAdminStatus, nbRtAccVif64ConformingMcastPackets=nbRtAccVif64ConformingMcastPackets, nbRtAccPort64ConformingBcastPackets=nbRtAccPort64ConformingBcastPackets, nbRtAccPortOperStatus=nbRtAccPortOperStatus, nbRtAccVifPortEntry=nbRtAccVifPortEntry, nbRtAccVifLowConformingBcastPackets=nbRtAccVifLowConformingBcastPackets, nbRtAccPortHighConformingPackets=nbRtAccPortHighConformingPackets, nbRtPoliceRateLimitHighExceedFrames32=nbRtPoliceRateLimitHighExceedFrames32, nbase=nbase, nbRtAccVif64ExceedingBytes=nbRtAccVif64ExceedingBytes, nbVifDevNo=nbVifDevNo, nbRtFibEntryAge=nbRtFibEntryAge, nbRtAccVifHighConformingUcastPackets=nbRtAccVifHighConformingUcastPackets, nbRtAccPortVif64ConformingBytes=nbRtAccPortVif64ConformingBytes, nbRtPoliceRateLimitTable=nbRtPoliceRateLimitTable, nbRtAccVifLowConformingBytes=nbRtAccVifLowConformingBytes, nbRtVifPortList=nbRtVifPortList, nbRtVifTable=nbRtVifTable, nbRtDiffServVptMapPrflInValueId=nbRtDiffServVptMapPrflInValueId, nbRtAccVifHighExceedingPackets=nbRtAccVifHighExceedingPackets, nbRtAccPortLowExceedingBytes=nbRtAccPortLowExceedingBytes, nbRtAccVifTable=nbRtAccVifTable, nbRtPoliceRateLimitExceedBytesCnt=nbRtPoliceRateLimitExceedBytesCnt, nbRtPoliceActionAdminStatus=nbRtPoliceActionAdminStatus, nbRtDiffServDscpMapPrflNameId=nbRtDiffServDscpMapPrflNameId, nbRtDiffServDscpMapStatus=nbRtDiffServDscpMapStatus, nbVifProtocol=nbVifProtocol, nbRtPortTagMplsForceMode=nbRtPortTagMplsForceMode, nbRtDiffServVptMapTable=nbRtDiffServVptMapTable, nbRtFibEntryNextHop=nbRtFibEntryNextHop, nbRtPoliceActionVifEntry=nbRtPoliceActionVifEntry, nbRtDiffServVptMapPrflNameId=nbRtDiffServVptMapPrflNameId, nbRtPoliceActionVifTable=nbRtPoliceActionVifTable, nbRtFibEntryNextPort=nbRtFibEntryNextPort, nbRtAccPortLowConformingMcastPackets=nbRtAccPortLowConformingMcastPackets, nbRtAccPortVif64ExceedingBytes=nbRtAccPortVif64ExceedingBytes, nbVifIsAlias=nbVifIsAlias, nbRtFibEntryTag=nbRtFibEntryTag, nbRtAccVifHighConformingPackets=nbRtAccVifHighConformingPackets, nbRtMplsAction=nbRtMplsAction, nbRtAccPortLowConformingPackets=nbRtAccPortLowConformingPackets, nbRtAccPortConformingPackets=nbRtAccPortConformingPackets, nbRtAccVifLowConformingPackets=nbRtAccVifLowConformingPackets, nbRtVifProtocol=nbRtVifProtocol, nbRtDiffServVptMapName=nbRtDiffServVptMapName, nbVifConfigType=nbVifConfigType, nbVifIpForwardingMode=nbVifIpForwardingMode, nbRtAccVifHighConformingBcastPackets=nbRtAccVifHighConformingBcastPackets, nbVifTag=nbVifTag, nbRtAccVifOperStatus=nbRtAccVifOperStatus, nbVifDescr=nbVifDescr, nbSwitchG1=nbSwitchG1, nbRtPoliceRateLimitExceedFramesCnt=nbRtPoliceRateLimitExceedFramesCnt, nbVifMask=nbVifMask, nbRtDiffServTable=nbRtDiffServTable, nbRtFibEntryAdminStatus=nbRtFibEntryAdminStatus, nbRtVifGroup=nbRtVifGroup, nbRtPoliceActionName=nbRtPoliceActionName, nbRtDiffServMode=nbRtDiffServMode, nbRtDiffServDscpMapTable=nbRtDiffServDscpMapTable, nbRtVifEntry=nbRtVifEntry, nbVifDeviceLimitEntry=nbVifDeviceLimitEntry, nbRtAccPortConformingMcastPackets=nbRtAccPortConformingMcastPackets, nbRtActionListTable=nbRtActionListTable, nbRtPoliceRateLimitLowExceedBytes32=nbRtPoliceRateLimitLowExceedBytes32, nbRtFibEntry=nbRtFibEntry, nbRtDevDiffServMode=nbRtDevDiffServMode, nbVifLastChange=nbVifLastChange, nbRtPortTagEntry=nbRtPortTagEntry, nbVifDevNoMax=nbVifDevNoMax, nbRtFibEntryProtocol=nbRtFibEntryProtocol, nbRtAccVifConformingBcastPackets=nbRtAccVifConformingBcastPackets, nbRtDiffServVptMapPrflSl=nbRtDiffServVptMapPrflSl, nbRtPortTagIpDefTag=nbRtPortTagIpDefTag, nbAclVifTable=nbAclVifTable, nbRtVifMask=nbRtVifMask, nbRtPoliceActionTotalHighExceedBytes32=nbRtPoliceActionTotalHighExceedBytes32, nbRtPortTagEtherType=nbRtPortTagEtherType, nbRtAccVifConformingMcastPackets=nbRtAccVifConformingMcastPackets, nbRtAccVifConformingBytes=nbRtAccVifConformingBytes, nbRtVifTag=nbRtVifTag, nbRtDiffServEntry=nbRtDiffServEntry, nbRtDiffServDscpMapPrflOutValue=nbRtDiffServDscpMapPrflOutValue, nbRtAccVifConformingUcastPackets=nbRtAccVifConformingUcastPackets, nbRtActionListPoliceType=nbRtActionListPoliceType, nbRtPoliceActionTotalLowExceedFrames32=nbRtPoliceActionTotalLowExceedFrames32, nbRtDiffServ=nbRtDiffServ, nbRtAccVifLowConformingUcastPackets=nbRtAccVifLowConformingUcastPackets, nbRtFibNumEntries=nbRtFibNumEntries, nbRtFibEntryMetric=nbRtFibEntryMetric, nbRtVifDiffServBuckRate=nbRtVifDiffServBuckRate, nbVifIsTagged=nbVifIsTagged, nbVifAdminStatus=nbVifAdminStatus, nbVifTable=nbVifTable, nbRtAccVifDirection=nbRtAccVifDirection, nbRtAccessLists=nbRtAccessLists, nbRtAccPortConformingBcastPackets=nbRtAccPortConformingBcastPackets, nbRtVifId=nbRtVifId, nbAclVifBindingStatus=nbAclVifBindingStatus, nbRtDiffServVptMapPrflEntry=nbRtDiffServVptMapPrflEntry, nbVifName=nbVifName, nbRtAccVifConformingPackets=nbRtAccVifConformingPackets, nbRtAccVifPortTable=nbRtAccVifPortTable, nbRtFib=nbRtFib, nbAclVifEntry=nbAclVifEntry, nbVifAliasLimitDevAliasFirstEmpty=nbVifAliasLimitDevAliasFirstEmpty, nbVifAliasLimitDevAliasMax=nbVifAliasLimitDevAliasMax, nbRtVifDiffServRateLimitEntry=nbRtVifDiffServRateLimitEntry, nbRtDiffServVptMapAdminStatus=nbRtDiffServVptMapAdminStatus, nbRtPortTagTable=nbRtPortTagTable, nbRtDevDiffServMappingSupport=nbRtDevDiffServMappingSupport, nbRtDiffServVptMapPrflTable=nbRtDiffServVptMapPrflTable, nbVifModify=nbVifModify, nbVifState=nbVifState, nbRtFibEntryLastChTime=nbRtFibEntryLastChTime, nbVifL2SwitchingMode=nbVifL2SwitchingMode, nbRtAccVifLowExceedingPackets=nbRtAccVifLowExceedingPackets, nbVifAliasLimitType=nbVifAliasLimitType, nbRouterConfig=nbRouterConfig, nbRtDiffServDscpMapNameIndex=nbRtDiffServDscpMapNameIndex, nbRtDiffServDscpMapPrflEntry=nbRtDiffServDscpMapPrflEntry, nbVifAliasDLimitEntry=nbVifAliasDLimitEntry, nbRtAccVif64ConformingBcastPackets=nbRtAccVif64ConformingBcastPackets, ActionListName=ActionListName, nbRtVifIpAddress=nbRtVifIpAddress, nbVifPhysType=nbVifPhysType, nbRtPoliceActionVifDirection=nbRtPoliceActionVifDirection, nbRtAccPortHighConformingUcastPackets=nbRtAccPortHighConformingUcastPackets, nbRtDiffServVptMapStatus=nbRtDiffServVptMapStatus, nbRtAccPortHighConformingBytes=nbRtAccPortHighConformingBytes, nbRtPortTagAwareMode=nbRtPortTagAwareMode, AccountCouter=AccountCouter, nbRtPoliceAction=nbRtPoliceAction, nbRtPoliceActionTotalHighExceedFrames32=nbRtPoliceActionTotalHighExceedFrames32, nbRtPoliceActionExceedCntOperStatus=nbRtPoliceActionExceedCntOperStatus, nbRtDiffServDscpMapPrflSl=nbRtDiffServDscpMapPrflSl, nbRtVifName=nbRtVifName, nbRtVifSecurity=nbRtVifSecurity, nbVifAliasLimitDevNo=nbVifAliasLimitDevNo, nbVifPortList=nbVifPortList, nbRtActionListSupport=nbRtActionListSupport, nbAclVifDirection=nbAclVifDirection, nbVifType=nbVifType, nbRtVifDiffServREDmode=nbRtVifDiffServREDmode, nbRtAccVifExceedingPackets=nbRtAccVifExceedingPackets, nbRtPortTagGroup=nbRtPortTagGroup, nbRtAccPortConformingUcastPackets=nbRtAccPortConformingUcastPackets, nbRtActionLists=nbRtActionLists, nbRtPoliceActionTotalLowExceedBytes32=nbRtPoliceActionTotalLowExceedBytes32, nbRtAccPortLowExceedingPackets=nbRtAccPortLowExceedingPackets, nbVifAliasDev=nbVifAliasDev, nbRtAccounting=nbRtAccounting, nbRtAccVifHighExceedingBytes=nbRtAccVifHighExceedingBytes, nbRtAccVifLowConformingMcastPackets=nbRtAccVifLowConformingMcastPackets, nbRtPoliceActionExceedCntAdminStatus=nbRtPoliceActionExceedCntAdminStatus, nbRtVifConfigType=nbRtVifConfigType, nbRtConfigGen=nbRtConfigGen, nbRtPortTagPortDefTag=nbRtPortTagPortDefTag, DirectionType=DirectionType, nbVifDevNoFirstEmpty=nbVifDevNoFirstEmpty, nbRtPortTagNumberOfTags=nbRtPortTagNumberOfTags, nbRtPoliceActionVifPortList=nbRtPoliceActionVifPortList, nbRtAccVifHighConformingMcastPackets=nbRtAccVifHighConformingMcastPackets, nbRtPoliceActionTotalExceedFramesCnt=nbRtPoliceActionTotalExceedFramesCnt, nbRtDiffServVptMapPrflOutValue=nbRtDiffServVptMapPrflOutValue, nbRtAccPortHighExceedingBytes=nbRtAccPortHighExceedingBytes, nbRtDiffServDscpMapAdminStatus=nbRtDiffServDscpMapAdminStatus, nbRtPoliceActionVifName=nbRtPoliceActionVifName, nbRtPoliceRateLimitBuckSize=nbRtPoliceRateLimitBuckSize, nbRtVifPortId=nbRtVifPortId, nbRtAccPort64ConformingUcastPackets=nbRtAccPort64ConformingUcastPackets, nbRtDiffServMgmtVptMapNameIndex=nbRtDiffServMgmtVptMapNameIndex, AccountCounter64=AccountCounter64, nbRtPoliceActionTotalExceedBytesCnt=nbRtPoliceActionTotalExceedBytesCnt, nbRtAccVif64ConformingUcastPackets=nbRtAccVif64ConformingUcastPackets, nbVifDeviceLimitTable=nbVifDeviceLimitTable, nbRtDiffServDscpMapPrflInValue=nbRtDiffServDscpMapPrflInValue, nbRtActionListMplsType=nbRtActionListMplsType, nbRtActionListOperStatus=nbRtActionListOperStatus, nbVifAliasLimitDevAliasMin=nbVifAliasLimitDevAliasMin, nbVifEntry=nbVifEntry, nbVifDevNoMin=nbVifDevNoMin, nbRtAccVifHighConformingBytes=nbRtAccVifHighConformingBytes, nbRtVifDiffServDirect=nbRtVifDiffServDirect, nbRtDiffServDscpMapNameId=nbRtDiffServDscpMapNameId, nbRtAccPortLowConformingBytes=nbRtAccPortLowConformingBytes, nbRtAccPortLowConformingUcastPackets=nbRtAccPortLowConformingUcastPackets, nbRtVifDiffServBuckSize=nbRtVifDiffServBuckSize, nbVifIpAddress=nbVifIpAddress, nbSwitchG1Il=nbSwitchG1Il, nbRtVifAdminStatus=nbRtVifAdminStatus, nbRtAccPortExceedingPackets=nbRtAccPortExceedingPackets, nbAclVifAccessListName=nbAclVifAccessListName, nbRtDiffServVptMapNameId=nbRtDiffServVptMapNameId)
