...
hwLswDhcpMibObject=_HwLswDhcpMibObject_ObjectIdentity((1,3,6,1,4,1,2011,2,23,1,8,1))
_HwDhcpGroupTable_Object=MibTable
hwDhcpGroupTable=_HwDhcpGroupTable_Object((1,3,6,1,4,1,2011,2,23,1,8,1,1))
if mibBuilder.loadTexts:hwDhcpGroupTable.setStatus(_A)
_HwDhcpGroupEntry_Object=MibTableRow
hwDhcpGroupEntry=_HwDhcpGroupEntry_Object((1,3,6,1,4,1,2011,2,23,1,8,1,1,1))
...
hwDhcpGroupID=_HwDhcpGroupID_Object((1,3,6,1,4,1,2011,2,23,1,8,1,1,1,1),_HwDhcpGroupID_Type())
...
hwIpDhcpServerAddress1=_HwIpDhcpServerAddress1_Object((1,3,6,1,4,1,2011,2,23,1,8,1,1,1,2),_HwIpDhcpServerAddress1_Type())
...
hwIpDhcpServerAddress2=_HwIpDhcpServerAddress2_Object((1,3,6,1,4,1,2011,2,23,1,8,1,1,1,3),_HwIpDhcpServerAddress2_Type())
...
hwDhcpRowStatus=_HwDhcpRowStatus_Object((1,3,6,1,4,1,2011,2,23,1,8,1,1,1,4),_HwDhcpRowStatus_Type())
hwDhcpRowStatus.setMaxAccess(_E)
if mibBuilder.loadTexts:hwDhcpRowStatus.setStatus(_A)
_HwDhcpSecurityTable_Object=MibTable
hwDhcpSecurityTable=_HwDhcpSecurityTable_Object((1,3,6,1,4,1,2011,2,23,1,8,1,2))
if mibBuilder.loadTexts:hwDhcpSecurityTable.setStatus(_A)
_HwDhcpSecurityEntry_Object=MibTableRow
hwDhcpSecurityEntry=_HwDhcpSecurityEntry_Object((1,3,6,1,4,1,2011,2,23,1,8,1,2,1))
...
hwDhcpClientIpAddress=_HwDhcpClientIpAddress_Object((1,3,6,1,4,1,2011,2,23,1,8,1,2,1,1),_HwDhcpClientIpAddress_Type())
...
hwDhcpClientMacAddress=_HwDhcpClientMacAddress_Object((1,3,6,1,4,1,2011,2,23,1,8,1,2,1,2),_HwDhcpClientMacAddress_Type())
...
hwDhcpClientProperty=_HwDhcpClientProperty_Object((1,3,6,1,4,1,2011,2,23,1,8,1,2,1,3),_HwDhcpClientProperty_Type())
...
hwDhcpClientRowStatus=_HwDhcpClientRowStatus_Object((1,3,6,1,4,1,2011,2,23,1,8,1,2,1,4),_HwDhcpClientRowStatus_Type())
...
hwDhcpToL3IfTable=_HwDhcpToL3IfTable_Object((1,3,6,1,4,1,2011,2,23,1,8,1,3))
if mibBuilder.loadTexts:hwDhcpToL3IfTable.setStatus(_A)
_HwDhcpToL3IfEntry_Object=MibTableRow
hwDhcpToL3IfEntry=_HwDhcpToL3IfEntry_Object((1,3,6,1,4,1,2011,2,23,1,8,1,3,1))
...
hwDhcpToL3VlanIfIndex=_HwDhcpToL3VlanIfIndex_Object((1,3,6,1,4,1,2011,2,23,1,8,1,3,1,1),_HwDhcpToL3VlanIfIndex_Type())
...
hwDhcpToL3GroupId=_HwDhcpToL3GroupId_Object((1,3,6,1,4,1,2011,2,23,1,8,1,3,1,2),_HwDhcpToL3GroupId_Type())
...
hwDhcpToL3AddressCheck=_HwDhcpToL3AddressCheck_Object((1,3,6,1,4,1,2011,2,23,1,8,1,3,1,3),_HwDhcpToL3AddressCheck_Type())
...
hwDhcpToL3RowStatus=_HwDhcpToL3RowStatus_Object((1,3,6,1,4,1,2011,2,23,1,8,1,3,1,4),_HwDhcpToL3RowStatus_Type())
