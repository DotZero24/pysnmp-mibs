...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-MEGACO-EXT-MIB
...
cmedGatewayLinkId, cmedGatewayConfigEntry, cmedTerminationsEntry, cmedGatewayId, cmedGatewayStatsEntry = mibBuilder.importSymbols("CISCO-IETF-MEGACO-MIB", "cmedGatewayLinkId", "cmedGatewayConfigEntry", "cmedTerminationsEntry", "cmedGatewayId", "cmedGatewayStatsEntry")
CCallControlProfileIndex, CCallControlProfileIndexOrZero = mibBuilder.importSymbols("CISCO-MEDIA-GATEWAY-MIB", "CCallControlProfileIndex", "CCallControlProfileIndexOrZero")
...
mibBuilder.exportSymbols("CISCO-MEGACO-EXT-MIB", cmedxCurrentCRR=cmedxCurrentCRR, cmedxGatewayMaxCommandMsgSize=cmedxGatewayMaxCommandMsgSize, cmedxEphTermInfoMaxNumInUsed=cmedxEphTermInfoMaxNumInUsed, cmedxGatewayStateChangeReason=cmedxGatewayStateChangeReason, cmedxCmdEphTermModRespTimeMin=cmedxCmdEphTermModRespTimeMin, cmedxCmdMaxInProgCmds=cmedxCmdMaxInProgCmds, cmedxConfigGroupRev1=cmedxConfigGroupRev1, cmedxGatewayIpAddressIndex=cmedxGatewayIpAddressIndex, cmedxGatewayCmbDnAndPortInMID=cmedxGatewayCmbDnAndPortInMID, cmedxOverloadNotifyEnabled=cmedxOverloadNotifyEnabled, cmedxGatewayStatsEntry=cmedxGatewayStatsEntry, cmedxEphTermInfoNumTerm=cmedxEphTermInfoNumTerm, cmedxOverloadLastResetTime=cmedxOverloadLastResetTime, cmedxEphTermInfoSinceLastClear=cmedxEphTermInfoSinceLastClear, PYSNMP_MODULE_ID=ciscoMegacoExtMIB, cmedxProfileRowStatus=cmedxProfileRowStatus, cmedxCmdPhyTermSubRespTimeMin=cmedxCmdPhyTermSubRespTimeMin, cmedxCmdPhyTermAddRespTimeAvg=cmedxCmdPhyTermAddRespTimeAvg, cmedxGatewayMsgTokenType=cmedxGatewayMsgTokenType, cmedxTermTypePkgIds=cmedxTermTypePkgIds, cmedxCmdNumMoveFails=cmedxCmdNumMoveFails, cmedxProfileSuppressBearerDigit=cmedxProfileSuppressBearerDigit, cmedxCmdEphTermModRespTimeAvg=cmedxCmdEphTermModRespTimeAvg, cmedxEphTermInfoCounterClear=cmedxEphTermInfoCounterClear, cmedxCntxLongestContextLife=cmedxCntxLongestContextLife, cmedxEphTermInfoAvgDuration=cmedxEphTermInfoAvgDuration, cmedxCmdNumSubtractSucceeds=cmedxCmdNumSubtractSucceeds, cmedxEphemeralTermStatsTable=cmedxEphemeralTermStatsTable, cmedxCmdEphTermAddRespTimeCount=cmedxCmdEphTermAddRespTimeCount, cmedxGatewayMgcOrigPendLimit=cmedxGatewayMgcOrigPendLimit, cmedxCodecNegotiationGroup=cmedxCodecNegotiationGroup, cmedxPhysicalTermStatsEntry=cmedxPhysicalTermStatsEntry, cmedxCodecNegotiationTable=cmedxCodecNegotiationTable, cmedxCmdPhyTermAddRespTimeMin=cmedxCmdPhyTermAddRespTimeMin, cmedxGatewayMaxTermsInContext=cmedxGatewayMaxTermsInContext, cmedxGatewaySrvChgProfileVer=cmedxGatewaySrvChgProfileVer, cmedxEphTermInfoMinDuration=cmedxEphTermInfoMinDuration, cmedxProfilePlayCpToneInterDur=cmedxProfilePlayCpToneInterDur, cmedxCommandStatsEntry=cmedxCommandStatsEntry, cmedxPhyTermStatsOosFromMgcs=cmedxPhyTermStatsOosFromMgcs, cmedxCmdNumMoveSucceeds=cmedxCmdNumMoveSucceeds, cmedxCmdNumAuditValSucceeds=cmedxCmdNumAuditValSucceeds, cmedxGatewayDynamicTpktVersion=cmedxGatewayDynamicTpktVersion, cmedxGatewayMgProvisionRspTime=cmedxGatewayMgProvisionRspTime, cmedxCallReduceControlEntry=cmedxCallReduceControlEntry, cmedxCmdNumSubtractFails=cmedxCmdNumSubtractFails, cmedxOverloadExitCounts=cmedxOverloadExitCounts, cmedxCallReduceLevelEntry=cmedxCallReduceLevelEntry, cmedxProfileDtmfPauseDur=cmedxProfileDtmfPauseDur, cmedxEphTermInfoMaxDuration=cmedxEphTermInfoMaxDuration, cmedxProfileInGainControl=cmedxProfileInGainControl, cmedxCmdNumMovePendings=cmedxCmdNumMovePendings, cmedxCallRenotifInterval=cmedxCallRenotifInterval, cmedxCmdNumAuditCapSucceeds=cmedxCmdNumAuditCapSucceeds, cmedxPhysicalTermStatsTable=cmedxPhysicalTermStatsTable, cmedxOverloadResourceStatsEntry=cmedxOverloadResourceStatsEntry, cmedxPhyTermStatsNumAdds=cmedxPhyTermStatsNumAdds, cmedxCmdPhyTermAddRespTimeMax=cmedxCmdPhyTermAddRespTimeMax, cmedxOverloadControlTable=cmedxOverloadControlTable, cmedxGatewayActiveMgcPortNum=cmedxGatewayActiveMgcPortNum, cmedxCntxAverageContextLife=cmedxCntxAverageContextLife, cmedxOverloadRsResourceIndex=cmedxOverloadRsResourceIndex, cmedxEphTermInfoStatsIndexType=cmedxEphTermInfoStatsIndexType, cmedxCmdNumNotifyPendings=cmedxCmdNumNotifyPendings, cmedxCmdPhyTermAddRespTimeCount=cmedxCmdPhyTermAddRespTimeCount, cmedxComplianceRev3=cmedxComplianceRev3, cmedxProfileRespCotMethod=cmedxProfileRespCotMethod, cmedxCmdNumAddFails=cmedxCmdNumAddFails, cmedxTermTypeProfileId=cmedxTermTypeProfileId, cmedxCmdNumAddSucceeds=cmedxCmdNumAddSucceeds, cmedxOverloadResourceStatsTable=cmedxOverloadResourceStatsTable, cmedxProfileTerminatingCotRx=cmedxProfileTerminatingCotRx, cmedxGatewayRestartDelay=cmedxGatewayRestartDelay, cmedxCmdEphTermAddRespTimeMin=cmedxCmdEphTermAddRespTimeMin, cmedxConfigGroup=cmedxConfigGroup, cmedxStatsGroupRev1=cmedxStatsGroupRev1, cmedxOverloadCurrentState=cmedxOverloadCurrentState, cmedxProfileEchoCancelEnabled=cmedxProfileEchoCancelEnabled, cmedxComplianceRev4=cmedxComplianceRev4, cmedxProfileTable=cmedxProfileTable, cmedxGatewayRespRetentionTime=cmedxGatewayRespRetentionTime, cmedxCmdNumSrvChgFromMgSucceeds=cmedxCmdNumSrvChgFromMgSucceeds, cmedxGatewayHeaderAddrType=cmedxGatewayHeaderAddrType, cmedxCmdNumSrvChgFromMgPendings=cmedxCmdNumSrvChgFromMgPendings, cmedxGatewayDomainName=cmedxGatewayDomainName, cmedxCmdEphTermSubRespTimeMax=cmedxCmdEphTermSubRespTimeMax, cmedxCmdNumAuditValFails=cmedxCmdNumAuditValFails, CH248Packages=CH248Packages, cmedxGatewayMgOrigPendLimit=cmedxGatewayMgOrigPendLimit, cmedxCmdEphTermModRespTimeMax=cmedxCmdEphTermModRespTimeMax, cmedxProfileVoIpVadTimer=cmedxProfileVoIpVadTimer, cmedxCmdEphTermAddRespTimeMax=cmedxCmdEphTermAddRespTimeMax, CMedxCotTones=CMedxCotTones, cmedxCmdEphTermSubRespTimeAvg=cmedxCmdEphTermSubRespTimeAvg, cmedxStatsExtGroup=cmedxStatsExtGroup, cmedxCodecNegotiationCodec=cmedxCodecNegotiationCodec, cmedxGatewayActiveMgcDomain=cmedxGatewayActiveMgcDomain, cmedxProfileTerminatingCotTx=cmedxProfileTerminatingCotTx, cmedxStatsGroup=cmedxStatsGroup, cmedxProfileVoAal2VadTimer=cmedxProfileVoAal2VadTimer, cmedxProfileVoIpVadEnabled=cmedxProfileVoIpVadEnabled, cmedxOverloadRsMedCounts=cmedxOverloadRsMedCounts, cmedxTerminationTypeTable=cmedxTerminationTypeTable, cmedxCmdPhyTermModRespTimeAvg=cmedxCmdPhyTermModRespTimeAvg, cmedxEphemeralTermStatsInfoEntry=cmedxEphemeralTermStatsInfoEntry, cmedxGatewayLastEvent=cmedxGatewayLastEvent, cmedxCmdNumAuditCapPendings=cmedxCmdNumAuditCapPendings, cmedxEphTermStatsNumAdds=cmedxEphTermStatsNumAdds, cmedxGatewayAssociationId=cmedxGatewayAssociationId, cmedxProfileOriginatingCotTx=cmedxProfileOriginatingCotTx, cmedxCallCongEnabled=cmedxCallCongEnabled, cmedxOverloadRsHighCounts=cmedxOverloadRsHighCounts, cmedxOverloadRsCountersClear=cmedxOverloadRsCountersClear, cmedxProfileOriginatingCotRx=cmedxProfileOriginatingCotRx, cmedxProfileEntry=cmedxProfileEntry, cmedxCallReduceControlTable=cmedxCallReduceControlTable, cmedxCntxPeakNumActiveContexts=cmedxCntxPeakNumActiveContexts, cmedxCntxNumContextFreed=cmedxCntxNumContextFreed, cmedxCmdNumSrvChgFromMgcSucceeds=cmedxCmdNumSrvChgFromMgcSucceeds, cmedxGatewayConfigEntry=cmedxGatewayConfigEntry, cmedxGatewayInitialRtt=cmedxGatewayInitialRtt, cmedxPhyTermStatsNumFailures=cmedxPhyTermStatsNumFailures, cmedxEphTermStatsType=cmedxEphTermStatsType, cmedxGatewayDownServiceDelay=cmedxGatewayDownServiceDelay, cmedxGatewayMaxWaitingDelay=cmedxGatewayMaxWaitingDelay, cmedxContextStatsTable=cmedxContextStatsTable, cmedxCmdNumAuditValPendings=cmedxCmdNumAuditValPendings, cmedxProfileDetectLongCpToneDur=cmedxProfileDetectLongCpToneDur, ciscoMegacoExtMIB=ciscoMegacoExtMIB, cmedxGatewayMgExecTime=cmedxGatewayMgExecTime, ciscoMegacoExtConformance=ciscoMegacoExtConformance, cmedxCompliance=cmedxCompliance, cmedxCmdNumModifySucceeds=cmedxCmdNumModifySucceeds, cmedxGatewayNumConnRetries=cmedxGatewayNumConnRetries, cmedxCmdNumAddPendings=cmedxCmdNumAddPendings, cmedxGatewayStateChangeMethod=cmedxGatewayStateChangeMethod, cmedxCntxShortestContextLife=cmedxCntxShortestContextLife, cmedxGatewayInactivityTime=cmedxGatewayInactivityTime, cmedxProfileDtmfDigitOnDur=cmedxProfileDtmfDigitOnDur, cmedxCurrentCallState=cmedxCurrentCallState, cmedxCrrNotifyState=cmedxCrrNotifyState, cmedxConfigDomainInfoGroup=cmedxConfigDomainInfoGroup, cmedxCmdTotalSucceeds=cmedxCmdTotalSucceeds, cmedxCmdNumNotifyFails=cmedxCmdNumNotifyFails, ciscoMegacoExtMIBNotifications=ciscoMegacoExtMIBNotifications, cmedxOverloadNotifyState=cmedxOverloadNotifyState, cmedxOverloadStatsGroup=cmedxOverloadStatsGroup, cmedxCntxNumContextAllocated=cmedxCntxNumContextAllocated, ciscoMegacoExtMIBObjects=ciscoMegacoExtMIBObjects, cmedxEphTermInfoNumFreed=cmedxEphTermInfoNumFreed, cmedxCmdTotal=cmedxCmdTotal, cmedxOverloadStatsTable=cmedxOverloadStatsTable, cmedxOverloadEnterCounts=cmedxOverloadEnterCounts, cmedxProfileAtmAalType=cmedxProfileAtmAalType, cmedxServiceStateGroup=cmedxServiceStateGroup, cmedxCmdPhyTermModRespTimeMax=cmedxCmdPhyTermModRespTimeMax, cmedxCrrNotifyEnabled=cmedxCrrNotifyEnabled, cmedxStats=cmedxStats, cmedxOverloadControlGroup=cmedxOverloadControlGroup, cmedxOverloadContributorCounts=cmedxOverloadContributorCounts, cmedxCallReduceLevelTable=cmedxCallReduceLevelTable, cmedxCmdNumModifyFails=cmedxCmdNumModifyFails, cmedxProfileIndex=cmedxProfileIndex, cmedxCmdPhyTermModRespTimeMin=cmedxCmdPhyTermModRespTimeMin, cmedxEphTermInfoNumInUsed=cmedxEphTermInfoNumInUsed, cmedxCodecNegotiationEntry=cmedxCodecNegotiationEntry, cmedxCmdEphTermSubRespTimeMin=cmedxCmdEphTermSubRespTimeMin, cmedxCRRNumOfLevel=cmedxCRRNumOfLevel, cmedxProfileCot1Frequency=cmedxProfileCot1Frequency, cmedxTermTypeRowStatus=cmedxTermTypeRowStatus, cmedxOverloadControlEnabled=cmedxOverloadControlEnabled, cmedxOverloadControlEntry=cmedxOverloadControlEntry, cmedxGatewayMaxReplyMsgSize=cmedxGatewayMaxReplyMsgSize, cmedxCommandStatsTable=cmedxCommandStatsTable, cmedxCommandProcStatsEntry=cmedxCommandProcStatsEntry, cmedxProfileOutAttnControl=cmedxProfileOutAttnControl, cmedxCntxNumCntxMoreThan2Terms=cmedxCntxNumCntxMoreThan2Terms, cmedxCmdEphTermModRespTimeCount=cmedxCmdEphTermModRespTimeCount, cmedxCntxNumActiveContexts=cmedxCntxNumActiveContexts, cmedxEphTermStatsNumFailures=cmedxEphTermStatsNumFailures, cmedxConfig=cmedxConfig, cmedxCompliances=cmedxCompliances, cmedxCmdEphTermAddRespTimeAvg=cmedxCmdEphTermAddRespTimeAvg, cmedxCmdTotalPendings=cmedxCmdTotalPendings, cmedxGatewaySctpAssocId=cmedxGatewaySctpAssocId, cmedxEphemeralTermStatsGroup=cmedxEphemeralTermStatsGroup, cmedxCmdPhyTermSubRespTimeCount=cmedxCmdPhyTermSubRespTimeCount, cmedxOverloadRsLowCounts=cmedxOverloadRsLowCounts, cmedxConfigGroupRev2=cmedxConfigGroupRev2, cmedxCmdNumInProgCmds=cmedxCmdNumInProgCmds, cmedxGatewayMgcExecTime=cmedxGatewayMgcExecTime, cmedxCmdNumAuditCapFails=cmedxCmdNumAuditCapFails, cmedxPhyTermStatsOosFromOams=cmedxPhyTermStatsOosFromOams, cmedxCmdNumSrvChgFromMgFails=cmedxCmdNumSrvChgFromMgFails, cmedxCmdPhyTermModRespTimeCount=cmedxCmdPhyTermModRespTimeCount, cmedxProfileDetectLongDigitDur=cmedxProfileDetectLongDigitDur, cmedxEphemeralTermStatsInfoTable=cmedxEphemeralTermStatsInfoTable, cmedxProfileComfortNoiseGenerate=cmedxProfileComfortNoiseGenerate, cmedxComplianceRev2=cmedxComplianceRev2, cmedxGatewayConfigTable=cmedxGatewayConfigTable, cmedxProfileEchoCancelTail=cmedxProfileEchoCancelTail, cmedxCmdNumNotifySucceeds=cmedxCmdNumNotifySucceeds, cmedxGatewayStatsTable=cmedxGatewayStatsTable, cmedxEphemeralTermStatsEntry=cmedxEphemeralTermStatsEntry, cmedxGatewayServiceState=cmedxGatewayServiceState, cmedxComplianceRev1=cmedxComplianceRev1, cmedxProfileCot2Frequency=cmedxProfileCot2Frequency, cmedxCmdNumModifyPendings=cmedxCmdNumModifyPendings, cmedxOverloadStatsEntry=cmedxOverloadStatsEntry, cmedxTerminationTypeEntry=cmedxTerminationTypeEntry, cmedxCallReduceRateGroup=cmedxCallReduceRateGroup, cmedxGatewaySrvChgProfile=cmedxGatewaySrvChgProfile, cmedxOverloadCountersClear=cmedxOverloadCountersClear, cmedxEphTermInfoStatsIndex=cmedxEphTermInfoStatsIndex, cmedxCmdPhyTermSubRespTimeMax=cmedxCmdPhyTermSubRespTimeMax, cmedxEphTermIndexInfo=cmedxEphTermIndexInfo, cmedxCallReduceLevelNum=cmedxCallReduceLevelNum, cmedxContextStatsEntry=cmedxContextStatsEntry, cmedxCommandProcStatsTable=cmedxCommandProcStatsTable, cmedxProfileAtmAalPartialFill=cmedxProfileAtmAalPartialFill, cmedxCmdNumSrvChgFromMgcPendings=cmedxCmdNumSrvChgFromMgcPendings, cmedxGroups=cmedxGroups, cmedxCmdTotalFails=cmedxCmdTotalFails, cmedxTermType=cmedxTermType, cmedxProfileInitiateCotDur=cmedxProfileInitiateCotDur, cmedxCmdNumSrvChgFromMgcFails=cmedxCmdNumSrvChgFromMgcFails, cmedxTermTypeId=cmedxTermTypeId, cmedxCmdEphTermSubRespTimeCount=cmedxCmdEphTermSubRespTimeCount, cmedxProfileAtmBearerType=cmedxProfileAtmBearerType, cmedxCallReduceRateNotifyGroup=cmedxCallReduceRateNotifyGroup, cmedxConfigExtGroup=cmedxConfigExtGroup, cmedxCmdNumSubtractPendings=cmedxCmdNumSubtractPendings, cmedxGatewayProvisionRespTime=cmedxGatewayProvisionRespTime, cmedxCallReduceRate=cmedxCallReduceRate, cmedxGatewayMgcGroupIndex=cmedxGatewayMgcGroupIndex, cmedxCodecNegotiationPreference=cmedxCodecNegotiationPreference, cmedxCmdPhyTermSubRespTimeAvg=cmedxCmdPhyTermSubRespTimeAvg, cmedxCmdSinceLastReset=cmedxCmdSinceLastReset, cmedxOverloadRsLastResetTime=cmedxOverloadRsLastResetTime, cmedxGatewayAdminAction=cmedxGatewayAdminAction, cmedxGatewayMgcProvisionRspTime=cmedxGatewayMgcProvisionRspTime, cmedxGatewayMaxContexts=cmedxGatewayMaxContexts, cmedxGatewayActiveMgcAddress=cmedxGatewayActiveMgcAddress, cmedxEphTermInfoSinceLastReset=cmedxEphTermInfoSinceLastReset)
