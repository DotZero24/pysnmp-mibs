...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:27:14 2025
...
cmedGatewayConfigEntry, cmedGatewayLinkId, cmedGatewayStatsEntry, cmedTerminationsEntry, cmedGatewayId = mibBuilder.importSymbols("CISCO-IETF-MEGACO-MIB", "cmedGatewayConfigEntry", "cmedGatewayLinkId", "cmedGatewayStatsEntry", "cmedTerminationsEntry", "cmedGatewayId")
...
mibBuilder.exportSymbols("CISCO-MEGACO-EXT-MIB", cmedxCodecNegotiationTable=cmedxCodecNegotiationTable, cmedxPhyTermStatsOosFromMgcs=cmedxPhyTermStatsOosFromMgcs, cmedxCmdPhyTermModRespTimeCount=cmedxCmdPhyTermModRespTimeCount, cmedxEphTermInfoStatsIndex=cmedxEphTermInfoStatsIndex, cmedxGatewayDomainName=cmedxGatewayDomainName, cmedxProfileOriginatingCotRx=cmedxProfileOriginatingCotRx, cmedxProfileEntry=cmedxProfileEntry, cmedxCallReduceLevelNum=cmedxCallReduceLevelNum, cmedxEphTermInfoNumTerm=cmedxEphTermInfoNumTerm, cmedxGatewayDynamicTpktVersion=cmedxGatewayDynamicTpktVersion, cmedxOverloadStatsGroup=cmedxOverloadStatsGroup, cmedxGatewayMaxContexts=cmedxGatewayMaxContexts, cmedxCodecNegotiationGroup=cmedxCodecNegotiationGroup, cmedxGatewayRestartDelay=cmedxGatewayRestartDelay, cmedxCurrentCallState=cmedxCurrentCallState, cmedxOverloadControlEntry=cmedxOverloadControlEntry, cmedxGatewayDownServiceDelay=cmedxGatewayDownServiceDelay, cmedxProfileVoIpVadEnabled=cmedxProfileVoIpVadEnabled, cmedxCntxNumContextFreed=cmedxCntxNumContextFreed, cmedxGatewayNumConnRetries=cmedxGatewayNumConnRetries, cmedxProfileVoAal2VadTimer=cmedxProfileVoAal2VadTimer, cmedxGatewayStateChangeReason=cmedxGatewayStateChangeReason, cmedxOverloadNotifyState=cmedxOverloadNotifyState, cmedxGatewayProvisionRespTime=cmedxGatewayProvisionRespTime, cmedxGatewayActiveMgcDomain=cmedxGatewayActiveMgcDomain, cmedxProfileCot1Frequency=cmedxProfileCot1Frequency, cmedxCmdNumSrvChgFromMgSucceeds=cmedxCmdNumSrvChgFromMgSucceeds, cmedxOverloadStatsTable=cmedxOverloadStatsTable, cmedxConfigGroup=cmedxConfigGroup, cmedxProfileDtmfPauseDur=cmedxProfileDtmfPauseDur, cmedxCommandProcStatsTable=cmedxCommandProcStatsTable, cmedxCmdNumMovePendings=cmedxCmdNumMovePendings, cmedxCmdPhyTermSubRespTimeAvg=cmedxCmdPhyTermSubRespTimeAvg, cmedxTermType=cmedxTermType, cmedxCrrNotifyEnabled=cmedxCrrNotifyEnabled, cmedxEphemeralTermStatsEntry=cmedxEphemeralTermStatsEntry, cmedxCallRenotifInterval=cmedxCallRenotifInterval, cmedxStatsGroup=cmedxStatsGroup, cmedxGatewayMgcOrigPendLimit=cmedxGatewayMgcOrigPendLimit, cmedxCmdPhyTermModRespTimeAvg=cmedxCmdPhyTermModRespTimeAvg, cmedxCmdTotal=cmedxCmdTotal, cmedxGatewayMaxReplyMsgSize=cmedxGatewayMaxReplyMsgSize, cmedxGatewayCmbDnAndPortInMID=cmedxGatewayCmbDnAndPortInMID, cmedxCmdPhyTermModRespTimeMax=cmedxCmdPhyTermModRespTimeMax, cmedxConfigGroupRev2=cmedxConfigGroupRev2, cmedxTermTypeRowStatus=cmedxTermTypeRowStatus, cmedxPhysicalTermStatsEntry=cmedxPhysicalTermStatsEntry, cmedxCallReduceLevelTable=cmedxCallReduceLevelTable, cmedxCmdEphTermAddRespTimeAvg=cmedxCmdEphTermAddRespTimeAvg, cmedxGatewaySrvChgProfileVer=cmedxGatewaySrvChgProfileVer, cmedxOverloadEnterCounts=cmedxOverloadEnterCounts, cmedxGatewayMaxTermsInContext=cmedxGatewayMaxTermsInContext, cmedxCmdNumAddPendings=cmedxCmdNumAddPendings, cmedxGatewayStatsEntry=cmedxGatewayStatsEntry, cmedxGatewayHeaderAddrType=cmedxGatewayHeaderAddrType, cmedxCntxNumContextAllocated=cmedxCntxNumContextAllocated, cmedxCmdSinceLastReset=cmedxCmdSinceLastReset, CH248Packages=CH248Packages, cmedxCmdEphTermSubRespTimeCount=cmedxCmdEphTermSubRespTimeCount, cmedxProfileSuppressBearerDigit=cmedxProfileSuppressBearerDigit, cmedxComplianceRev2=cmedxComplianceRev2, cmedxConfigGroupRev1=cmedxConfigGroupRev1, cmedxOverloadRsResourceIndex=cmedxOverloadRsResourceIndex, cmedxEphTermInfoCounterClear=cmedxEphTermInfoCounterClear, cmedxGatewayConfigEntry=cmedxGatewayConfigEntry, cmedxStats=cmedxStats, cmedxCallReduceRateNotifyGroup=cmedxCallReduceRateNotifyGroup, cmedxGatewayConfigTable=cmedxGatewayConfigTable, cmedxGatewayRespRetentionTime=cmedxGatewayRespRetentionTime, cmedxProfileRespCotMethod=cmedxProfileRespCotMethod, cmedxOverloadRsMedCounts=cmedxOverloadRsMedCounts, cmedxServiceStateGroup=cmedxServiceStateGroup, cmedxCmdEphTermModRespTimeMin=cmedxCmdEphTermModRespTimeMin, cmedxProfileTerminatingCotRx=cmedxProfileTerminatingCotRx, cmedxEphemeralTermStatsInfoEntry=cmedxEphemeralTermStatsInfoEntry, cmedxOverloadNotifyEnabled=cmedxOverloadNotifyEnabled, cmedxGatewayMgOrigPendLimit=cmedxGatewayMgOrigPendLimit, cmedxCmdPhyTermAddRespTimeMin=cmedxCmdPhyTermAddRespTimeMin, cmedxEphTermInfoSinceLastClear=cmedxEphTermInfoSinceLastClear, cmedxStatsGroupRev1=cmedxStatsGroupRev1, cmedxCmdNumSubtractFails=cmedxCmdNumSubtractFails, cmedxCmdEphTermSubRespTimeMin=cmedxCmdEphTermSubRespTimeMin, cmedxCallReduceControlEntry=cmedxCallReduceControlEntry, cmedxCmdPhyTermAddRespTimeMax=cmedxCmdPhyTermAddRespTimeMax, cmedxCommandProcStatsEntry=cmedxCommandProcStatsEntry, cmedxCmdNumMoveSucceeds=cmedxCmdNumMoveSucceeds, cmedxComplianceRev4=cmedxComplianceRev4, cmedxGatewayServiceState=cmedxGatewayServiceState, cmedxCmdNumSubtractPendings=cmedxCmdNumSubtractPendings, cmedxCmdEphTermSubRespTimeMax=cmedxCmdEphTermSubRespTimeMax, cmedxGatewayMgProvisionRspTime=cmedxGatewayMgProvisionRspTime, cmedxGatewayLastEvent=cmedxGatewayLastEvent, cmedxCmdEphTermModRespTimeMax=cmedxCmdEphTermModRespTimeMax, cmedxCommandStatsTable=cmedxCommandStatsTable, cmedxCntxAverageContextLife=cmedxCntxAverageContextLife, cmedxCallReduceRate=cmedxCallReduceRate, cmedxProfileComfortNoiseGenerate=cmedxProfileComfortNoiseGenerate, cmedxEphTermStatsNumFailures=cmedxEphTermStatsNumFailures, cmedxCallReduceLevelEntry=cmedxCallReduceLevelEntry, ciscoMegacoExtMIBNotifications=ciscoMegacoExtMIBNotifications, cmedxOverloadControlEnabled=cmedxOverloadControlEnabled, cmedxCmdEphTermModRespTimeCount=cmedxCmdEphTermModRespTimeCount, cmedxCodecNegotiationEntry=cmedxCodecNegotiationEntry, cmedxCmdNumAuditValSucceeds=cmedxCmdNumAuditValSucceeds, cmedxCmdMaxInProgCmds=cmedxCmdMaxInProgCmds, cmedxOverloadContributorCounts=cmedxOverloadContributorCounts, cmedxGatewayAssociationId=cmedxGatewayAssociationId, cmedxProfileRowStatus=cmedxProfileRowStatus, cmedxGatewayStateChangeMethod=cmedxGatewayStateChangeMethod, cmedxOverloadRsLastResetTime=cmedxOverloadRsLastResetTime, cmedxProfileInGainControl=cmedxProfileInGainControl, cmedxGatewayInactivityTime=cmedxGatewayInactivityTime, cmedxCallCongEnabled=cmedxCallCongEnabled, cmedxProfileDetectLongDigitDur=cmedxProfileDetectLongDigitDur, cmedxCmdEphTermSubRespTimeAvg=cmedxCmdEphTermSubRespTimeAvg, cmedxCmdPhyTermSubRespTimeMin=cmedxCmdPhyTermSubRespTimeMin, cmedxCompliance=cmedxCompliance, cmedxEphTermInfoMinDuration=cmedxEphTermInfoMinDuration, ciscoMegacoExtMIB=ciscoMegacoExtMIB, cmedxCompliances=cmedxCompliances, cmedxCmdNumSrvChgFromMgFails=cmedxCmdNumSrvChgFromMgFails, cmedxOverloadRsLowCounts=cmedxOverloadRsLowCounts, cmedxTermTypeId=cmedxTermTypeId, cmedxTerminationTypeEntry=cmedxTerminationTypeEntry, cmedxCmdNumNotifyPendings=cmedxCmdNumNotifyPendings, cmedxPhyTermStatsNumAdds=cmedxPhyTermStatsNumAdds, cmedxCmdEphTermModRespTimeAvg=cmedxCmdEphTermModRespTimeAvg, cmedxComplianceRev3=cmedxComplianceRev3, cmedxEphemeralTermStatsGroup=cmedxEphemeralTermStatsGroup, cmedxComplianceRev1=cmedxComplianceRev1, cmedxCmdPhyTermSubRespTimeMax=cmedxCmdPhyTermSubRespTimeMax, cmedxEphTermInfoNumFreed=cmedxEphTermInfoNumFreed, cmedxCmdNumNotifyFails=cmedxCmdNumNotifyFails, cmedxProfileAtmAalPartialFill=cmedxProfileAtmAalPartialFill, cmedxCmdNumMoveFails=cmedxCmdNumMoveFails, cmedxProfileInitiateCotDur=cmedxProfileInitiateCotDur, cmedxCurrentCRR=cmedxCurrentCRR, cmedxTermTypePkgIds=cmedxTermTypePkgIds, cmedxCmdNumSrvChgFromMgcFails=cmedxCmdNumSrvChgFromMgcFails, cmedxGatewayStatsTable=cmedxGatewayStatsTable, cmedxCmdNumAuditCapPendings=cmedxCmdNumAuditCapPendings, cmedxCmdEphTermAddRespTimeMax=cmedxCmdEphTermAddRespTimeMax, cmedxOverloadLastResetTime=cmedxOverloadLastResetTime, cmedxOverloadControlTable=cmedxOverloadControlTable, cmedxCmdNumSrvChgFromMgPendings=cmedxCmdNumSrvChgFromMgPendings, cmedxCmdTotalSucceeds=cmedxCmdTotalSucceeds, cmedxOverloadCountersClear=cmedxOverloadCountersClear, cmedxEphTermInfoStatsIndexType=cmedxEphTermInfoStatsIndexType, cmedxConfigExtGroup=cmedxConfigExtGroup, cmedxCodecNegotiationCodec=cmedxCodecNegotiationCodec, cmedxCmdNumModifyPendings=cmedxCmdNumModifyPendings, cmedxOverloadStatsEntry=cmedxOverloadStatsEntry, cmedxGatewayInitialRtt=cmedxGatewayInitialRtt, cmedxEphTermInfoAvgDuration=cmedxEphTermInfoAvgDuration, cmedxProfileOriginatingCotTx=cmedxProfileOriginatingCotTx, cmedxCallReduceRateGroup=cmedxCallReduceRateGroup, cmedxCmdTotalFails=cmedxCmdTotalFails, cmedxEphTermStatsNumAdds=cmedxEphTermStatsNumAdds, cmedxGatewayMsgTokenType=cmedxGatewayMsgTokenType, cmedxGatewayIpAddressIndex=cmedxGatewayIpAddressIndex, cmedxPhysicalTermStatsTable=cmedxPhysicalTermStatsTable, cmedxCmdNumNotifySucceeds=cmedxCmdNumNotifySucceeds, cmedxEphemeralTermStatsInfoTable=cmedxEphemeralTermStatsInfoTable, cmedxCmdNumSubtractSucceeds=cmedxCmdNumSubtractSucceeds, cmedxCrrNotifyState=cmedxCrrNotifyState, cmedxProfilePlayCpToneInterDur=cmedxProfilePlayCpToneInterDur, cmedxGatewayMaxCommandMsgSize=cmedxGatewayMaxCommandMsgSize, cmedxProfileAtmBearerType=cmedxProfileAtmBearerType, cmedxCmdEphTermAddRespTimeMin=cmedxCmdEphTermAddRespTimeMin, cmedxPhyTermStatsNumFailures=cmedxPhyTermStatsNumFailures, cmedxOverloadRsCountersClear=cmedxOverloadRsCountersClear, cmedxProfileEchoCancelTail=cmedxProfileEchoCancelTail, cmedxCallReduceControlTable=cmedxCallReduceControlTable, cmedxCmdNumModifyFails=cmedxCmdNumModifyFails, cmedxCntxPeakNumActiveContexts=cmedxCntxPeakNumActiveContexts, cmedxCmdPhyTermModRespTimeMin=cmedxCmdPhyTermModRespTimeMin, cmedxOverloadCurrentState=cmedxOverloadCurrentState, cmedxGroups=cmedxGroups, cmedxCmdPhyTermAddRespTimeAvg=cmedxCmdPhyTermAddRespTimeAvg, cmedxTerminationTypeTable=cmedxTerminationTypeTable, cmedxCmdNumInProgCmds=cmedxCmdNumInProgCmds, cmedxOverloadControlGroup=cmedxOverloadControlGroup, cmedxCmdPhyTermSubRespTimeCount=cmedxCmdPhyTermSubRespTimeCount, cmedxCmdNumAuditValFails=cmedxCmdNumAuditValFails, cmedxEphTermInfoNumInUsed=cmedxEphTermInfoNumInUsed, cmedxConfigDomainInfoGroup=cmedxConfigDomainInfoGroup, cmedxPhyTermStatsOosFromOams=cmedxPhyTermStatsOosFromOams, cmedxOverloadResourceStatsTable=cmedxOverloadResourceStatsTable, cmedxCmdNumAddFails=cmedxCmdNumAddFails, cmedxCmdNumSrvChgFromMgcSucceeds=cmedxCmdNumSrvChgFromMgcSucceeds, cmedxCommandStatsEntry=cmedxCommandStatsEntry, cmedxGatewaySrvChgProfile=cmedxGatewaySrvChgProfile, cmedxContextStatsEntry=cmedxContextStatsEntry, cmedxCmdNumAddSucceeds=cmedxCmdNumAddSucceeds, cmedxProfileDetectLongCpToneDur=cmedxProfileDetectLongCpToneDur, cmedxOverloadExitCounts=cmedxOverloadExitCounts, cmedxGatewayAdminAction=cmedxGatewayAdminAction, cmedxEphemeralTermStatsTable=cmedxEphemeralTermStatsTable, cmedxCmdNumAuditCapSucceeds=cmedxCmdNumAuditCapSucceeds, cmedxCmdEphTermAddRespTimeCount=cmedxCmdEphTermAddRespTimeCount, cmedxGatewayMgcExecTime=cmedxGatewayMgcExecTime, cmedxCmdTotalPendings=cmedxCmdTotalPendings, cmedxEphTermInfoSinceLastReset=cmedxEphTermInfoSinceLastReset, ciscoMegacoExtConformance=ciscoMegacoExtConformance, CMedxCotTones=CMedxCotTones, cmedxGatewayMgcProvisionRspTime=cmedxGatewayMgcProvisionRspTime, cmedxProfileTable=cmedxProfileTable, cmedxCmdNumAuditCapFails=cmedxCmdNumAuditCapFails, cmedxProfileEchoCancelEnabled=cmedxProfileEchoCancelEnabled, cmedxContextStatsTable=cmedxContextStatsTable, cmedxCntxNumCntxMoreThan2Terms=cmedxCntxNumCntxMoreThan2Terms, cmedxProfileCot2Frequency=cmedxProfileCot2Frequency, cmedxCntxNumActiveContexts=cmedxCntxNumActiveContexts, cmedxProfileVoIpVadTimer=cmedxProfileVoIpVadTimer, cmedxCmdNumAuditValPendings=cmedxCmdNumAuditValPendings, cmedxCmdNumSrvChgFromMgcPendings=cmedxCmdNumSrvChgFromMgcPendings, cmedxOverloadResourceStatsEntry=cmedxOverloadResourceStatsEntry, cmedxEphTermIndexInfo=cmedxEphTermIndexInfo, cmedxCmdNumModifySucceeds=cmedxCmdNumModifySucceeds, cmedxGatewayMaxWaitingDelay=cmedxGatewayMaxWaitingDelay, cmedxGatewaySctpAssocId=cmedxGatewaySctpAssocId, cmedxProfileTerminatingCotTx=cmedxProfileTerminatingCotTx, cmedxCntxLongestContextLife=cmedxCntxLongestContextLife, cmedxCmdPhyTermAddRespTimeCount=cmedxCmdPhyTermAddRespTimeCount, cmedxProfileIndex=cmedxProfileIndex, cmedxCntxShortestContextLife=cmedxCntxShortestContextLife, cmedxEphTermInfoMaxDuration=cmedxEphTermInfoMaxDuration, cmedxCodecNegotiationPreference=cmedxCodecNegotiationPreference, cmedxProfileDtmfDigitOnDur=cmedxProfileDtmfDigitOnDur, cmedxCRRNumOfLevel=cmedxCRRNumOfLevel, cmedxProfileOutAttnControl=cmedxProfileOutAttnControl, cmedxEphTermStatsType=cmedxEphTermStatsType, cmedxGatewayActiveMgcPortNum=cmedxGatewayActiveMgcPortNum, cmedxConfig=cmedxConfig, cmedxOverloadRsHighCounts=cmedxOverloadRsHighCounts, cmedxGatewayActiveMgcAddress=cmedxGatewayActiveMgcAddress, cmedxStatsExtGroup=cmedxStatsExtGroup, ciscoMegacoExtMIBObjects=ciscoMegacoExtMIBObjects, cmedxGatewayMgcGroupIndex=cmedxGatewayMgcGroupIndex, cmedxTermTypeProfileId=cmedxTermTypeProfileId, PYSNMP_MODULE_ID=ciscoMegacoExtMIB, cmedxGatewayMgExecTime=cmedxGatewayMgExecTime, cmedxProfileAtmAalType=cmedxProfileAtmAalType, cmedxEphTermInfoMaxNumInUsed=cmedxEphTermInfoMaxNumInUsed)
