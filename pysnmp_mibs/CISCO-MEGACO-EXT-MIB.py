...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MEGACO-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:33:12 2025
...
_CmedxGatewayHeaderAddrType_Type.__name__ = "InetAddressType"
...
_CmedxGatewayDynamicTpktVersion_Type.__name__ = "TruthValue"
...
_CmedxGatewayCmbDnAndPortInMID_Type.__name__ = "TruthValue"
...
_CmedxTermTypeProfileId_Type.__name__ = "CCallControlProfileIndexOrZero"
...
_CmedxProfileEchoCancelEnabled_Type.__name__ = "TruthValue"
...
_CmedxProfileVoIpVadEnabled_Type.__name__ = "TruthValue"
...
_CmedxProfileSuppressBearerDigit_Type.__name__ = "TruthValue"
...
_CmedxCallCongEnabled_Type.__name__ = "TruthValue"
...
_CmedxOverloadControlEnabled_Type.__name__ = "TruthValue"
...
cmedxCompliance.setObjects(
      *(("CISCO-MEGACO-EXT-MIB", "cmedxConfigGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxStatsGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCallReduceRateGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCodecNegotiationGroup"))
)
if mibBuilder.loadTexts:
...
cmedxComplianceRev1.setObjects(
      *(("CISCO-MEGACO-EXT-MIB", "cmedxConfigGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxStatsGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCallReduceRateGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCodecNegotiationGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxConfigExtGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxServiceStateGroup"))
)
if mibBuilder.loadTexts:
...
cmedxComplianceRev2.setObjects(
      *(("CISCO-MEGACO-EXT-MIB", "cmedxConfigGroupRev1"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxStatsGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCallReduceRateGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCodecNegotiationGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxConfigExtGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxServiceStateGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCallReduceRateNotifyGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxOverloadControlGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxOverloadStatsGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxStatsExtGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxEphemeralTermStatsGroup"))
)
if mibBuilder.loadTexts:
...
cmedxComplianceRev3.setObjects(
      *(("CISCO-MEGACO-EXT-MIB", "cmedxConfigGroupRev2"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxStatsGroupRev1"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCallReduceRateGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCodecNegotiationGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxConfigExtGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxServiceStateGroup"),
...
cmedxComplianceRev4.setObjects(
      *(("CISCO-MEGACO-EXT-MIB", "cmedxConfigGroupRev2"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxStatsGroupRev1"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCallReduceRateGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxConfigDomainInfoGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCodecNegotiationGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxConfigExtGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxServiceStateGroup"),
        ("CISCO-MEGACO-EXT-MIB", "cmedxCallReduceRateNotifyGroup"),
