...
# Produced by pysmi-1.6.2 at Fri Oct 10 19:43:26 2025
...
hpSwitchModuleBladetype9 = _HpSwitchModuleBladetype9_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 33, 9)
)
_HpSwitchBladeType9_Products_ObjectIdentity = ObjectIdentity
hpSwitchBladeType9_Products = _HpSwitchBladeType9_Products_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 33, 9, 1)
)
_HpSwitchBladeType9_Mgmt_ObjectIdentity = ObjectIdentity
hpSwitchBladeType9_Mgmt = _HpSwitchBladeType9_Mgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 33, 9, 2)
)
...
mibBuilder.exportSymbols(
    ...
    **{"hp": hp,
       ...
       "hpSwitchModuleBladetype9": hpSwitchModuleBladetype9,
       "hpSwitchBladeType9-Products": hpSwitchBladeType9_Products,
       "hpSwitchBladeType9-Mgmt": hpSwitchBladeType9_Mgmt}
)
