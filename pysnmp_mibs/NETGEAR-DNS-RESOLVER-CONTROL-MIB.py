...
_E='not-accessible'
_D='Integer32'
_C='NETGEAR-DNS-RESOLVER-CONTROL-MIB'
_B='read-write'
_A='current'
...
fastPathDnsResCtlMIBObjects=_FastPathDnsResCtlMIBObjects_ObjectIdentity((1,3,6,1,4,1,4526,10,37,1))
_AgentResCtlglobal_ObjectIdentity=ObjectIdentity
agentResCtlglobal=_AgentResCtlglobal_ObjectIdentity((1,3,6,1,4,1,4526,10,37,1,1))
_AgentResCtlAdminMode_Type=TruthValue
_AgentResCtlAdminMode_Object=MibScalar
agentResCtlAdminMode=_AgentResCtlAdminMode_Object((1,3,6,1,4,1,4526,10,37,1,1,1),_AgentResCtlAdminMode_Type())
...
agentResCtlDefDomainName=_AgentResCtlDefDomainName_Object((1,3,6,1,4,1,4526,10,37,1,1,2),_AgentResCtlDefDomainName_Type())
...
agentResCtlCacheFlushStatus=_AgentResCtlCacheFlushStatus_Object((1,3,6,1,4,1,4526,10,37,1,1,3),_AgentResCtlCacheFlushStatus_Type())
...
agentResCtlRequestTimeout=_AgentResCtlRequestTimeout_Object((1,3,6,1,4,1,4526,10,37,1,1,4),_AgentResCtlRequestTimeout_Type())
...
agentResCtlRequestRetransmits=_AgentResCtlRequestRetransmits_Object((1,3,6,1,4,1,4526,10,37,1,1,5),_AgentResCtlRequestRetransmits_Type())
...
agentResCtlDomainListTable=_AgentResCtlDomainListTable_Object((1,3,6,1,4,1,4526,10,37,1,1,6))
if mibBuilder.loadTexts:agentResCtlDomainListTable.setStatus(_A)
_AgentResCtlDomainListEntry_Object=MibTableRow
agentResCtlDomainListEntry=_AgentResCtlDomainListEntry_Object((1,3,6,1,4,1,4526,10,37,1,1,6,1))
...
agentResCtlDomainListName=_AgentResCtlDomainListName_Object((1,3,6,1,4,1,4526,10,37,1,1,6,1,1),_AgentResCtlDomainListName_Type())
...
agentResCtlDomainListNameStatus=_AgentResCtlDomainListNameStatus_Object((1,3,6,1,4,1,4526,10,37,1,1,6,1,2),_AgentResCtlDomainListNameStatus_Type())
...
agentResCtlSourceInterface=_AgentResCtlSourceInterface_Object((1,3,6,1,4,1,4526,10,37,1,1,7),_AgentResCtlSourceInterface_Type())
...
agentResCtlServicePortSrcInterface=_AgentResCtlServicePortSrcInterface_Object((1,3,6,1,4,1,4526,10,37,1,1,8),_AgentResCtlServicePortSrcInterface_Type())
...
agentResCtlServConfig=_AgentResCtlServConfig_ObjectIdentity((1,3,6,1,4,1,4526,10,37,1,2))
_AgentResCtlServConfigTable_Object=MibTable
agentResCtlServConfigTable=_AgentResCtlServConfigTable_Object((1,3,6,1,4,1,4526,10,37,1,2,1))
if mibBuilder.loadTexts:agentResCtlServConfigTable.setStatus(_A)
_AgentResCtlConfigIPEntry_Object=MibTableRow
agentResCtlConfigIPEntry=_AgentResCtlConfigIPEntry_Object((1,3,6,1,4,1,4526,10,37,1,2,1,1))
...
agentResCtlDnsNameServerIPType=_AgentResCtlDnsNameServerIPType_Object((1,3,6,1,4,1,4526,10,37,1,2,1,1,1),_AgentResCtlDnsNameServerIPType_Type())
...
agentResCtlDnsNameServerIP=_AgentResCtlDnsNameServerIP_Object((1,3,6,1,4,1,4526,10,37,1,2,1,1,2),_AgentResCtlDnsNameServerIP_Type())
...
agentResCtlDnsNameServerStatus=_AgentResCtlDnsNameServerStatus_Object((1,3,6,1,4,1,4526,10,37,1,2,1,1,3),_AgentResCtlDnsNameServerStatus_Type())
...
agentResCtlStaticServConfig=_AgentResCtlStaticServConfig_ObjectIdentity((1,3,6,1,4,1,4526,10,37,1,3))
_AgentResCtlStaticServConfigTable_Object=MibTable
agentResCtlStaticServConfigTable=_AgentResCtlStaticServConfigTable_Object((1,3,6,1,4,1,4526,10,37,1,3,1))
if mibBuilder.loadTexts:agentResCtlStaticServConfigTable.setStatus(_A)
_AgentResCtlStaticServEntry_Object=MibTableRow
agentResCtlStaticServEntry=_AgentResCtlStaticServEntry_Object((1,3,6,1,4,1,4526,10,37,1,3,1,1))
...
agentResCtlStaticHostName=_AgentResCtlStaticHostName_Object((1,3,6,1,4,1,4526,10,37,1,3,1,1,1),_AgentResCtlStaticHostName_Type())
...
agentResCtlStaticIPAddress=_AgentResCtlStaticIPAddress_Object((1,3,6,1,4,1,4526,10,37,1,3,1,1,2),_AgentResCtlStaticIPAddress_Type())
...
agentResCtlStaticNameServerStatus=_AgentResCtlStaticNameServerStatus_Object((1,3,6,1,4,1,4526,10,37,1,3,1,1,3),_AgentResCtlStaticNameServerStatus_Type())
