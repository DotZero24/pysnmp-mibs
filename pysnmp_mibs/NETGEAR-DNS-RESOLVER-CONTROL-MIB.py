# SNMP MIB module (NETGEAR-DNS-RESOLVER-CONTROL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-DNS-RESOLVER-CONTROL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:27:40 2025
...
agentResCtlDomainListEntry = _AgentResCtlDomainListEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 1, 6, 1)
)
agentResCtlDomainListEntry.setIndexNames(
    (0, "NETGEAR-DNS-RESOLVER-CONTROL-MIB", "agentResCtlDomainListName"),
)
if mibBuilder.loadTexts:
...
agentResCtlDomainListName = _AgentResCtlDomainListName_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 1, 6, 1, 1),
...
agentResCtlDomainListNameStatus = _AgentResCtlDomainListNameStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 1, 6, 1, 2),
...
agentResCtlConfigIPEntry = _AgentResCtlConfigIPEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 2, 1, 1)
)
agentResCtlConfigIPEntry.setIndexNames(
    (0, "NETGEAR-DNS-RESOLVER-CONTROL-MIB", "agentResCtlDnsNameServerIPType"),
    (0, "NETGEAR-DNS-RESOLVER-CONTROL-MIB", "agentResCtlDnsNameServerIP"),
)
if mibBuilder.loadTexts:
...
agentResCtlDnsNameServerIPType = _AgentResCtlDnsNameServerIPType_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 2, 1, 1, 1),
...
agentResCtlDnsNameServerIP = _AgentResCtlDnsNameServerIP_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 2, 1, 1, 2),
...
agentResCtlDnsNameServerStatus = _AgentResCtlDnsNameServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 2, 1, 1, 3),
...
agentResCtlStaticServEntry = _AgentResCtlStaticServEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 3, 1, 1)
)
agentResCtlStaticServEntry.setIndexNames(
    (0, "NETGEAR-DNS-RESOLVER-CONTROL-MIB", "agentResCtlStaticHostName"),
    (0, "NETGEAR-DNS-RESOLVER-CONTROL-MIB", "agentResCtlStaticIPAddress"),
)
if mibBuilder.loadTexts:
...
agentResCtlStaticHostName = _AgentResCtlStaticHostName_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 3, 1, 1, 1),
...
agentResCtlStaticIPAddress = _AgentResCtlStaticIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 3, 1, 1, 2),
...
agentResCtlStaticNameServerStatus = _AgentResCtlStaticNameServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 37, 1, 3, 1, 1, 3),
