...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-ENCR-8021X-CONFIG-MIB
...
etsysEncrDot1xConfigCompliance.setObjects(
    ("ENTERASYS-ENCR-8021X-CONFIG-MIB", "etsysEncrDot1xAuthConfigGroup")
)
if mibBuilder.loadTexts:
