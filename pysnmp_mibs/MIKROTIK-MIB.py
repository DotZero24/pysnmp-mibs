...
mibBuilder.exportSymbols("MIKROTIK-MIB", mtxrLTEModemRAT=mtxrLTEModemRAT, mtxrScripts=mtxrScripts, mtxrInterfaceStatsTxRx65To127=mtxrInterfaceStatsTxRx65To127, mtxrLTEModemSignalSINR=mtxrLTEModemSignalSINR, mtxrWlCMEntry=mtxrWlCMEntry, mtxrNeighborVersion=mtxrNeighborVersion, mtxrNstremeDual=mtxrNstremeDual, mtxrIkeSADynamicAddressType=mtxrIkeSADynamicAddressType, mtxrUSBPowerReset=mtxrUSBPowerReset, mtxrIkeSARxBytes=mtxrIkeSARxBytes, mtxrWlRtabEntryCount=mtxrWlRtabEntryCount, mtxrDnStatTable=mtxrDnStatTable, mtxrDisplayName=mtxrDisplayName, mtxrOpticalVendorName=mtxrOpticalVendorName, mtxrQueueSimpleDroppedIn=mtxrQueueSimpleDroppedIn, mtxrScriptRunGroup=mtxrScriptRunGroup, mtXRouterOsGroups=mtXRouterOsGroups, mtxrPartitionActive=mtxrPartitionActive, mtxrNeighborGroup=mtxrNeighborGroup, mtxrWlCMRemoteTable=mtxrWlCMRemoteTable, mtXMetaInfo=mtXMetaInfo, mtxrPOE=mtxrPOE, mtxrWlCMRemoteRadios=mtxrWlCMRemoteRadios, mtxrWlStatTxCCQ=mtxrWlStatTxCCQ, mtxrLTEModemIMSI=mtxrLTEModemIMSI, mtxrWirelessModemIMSI=mtxrWirelessModemIMSI, mtxrQueueSimpleBytesIn=mtxrQueueSimpleBytesIn, mtxrScriptRunCmd=mtxrScriptRunCmd, mtxrHlProcessorTemperature=mtxrHlProcessorTemperature, mtxrWlApOverallTxCCQ=mtxrWlApOverallTxCCQ, mtxrIkeSASeen=mtxrIkeSASeen, mtxrHotspotActiveUserPacketsIn=mtxrHotspotActiveUserPacketsIn, mtxrSystemReboot=mtxrSystemReboot, mtxrScriptRunTableEntry=mtxrScriptRunTableEntry, mtxrWlCMRtabTable=mtxrWlCMRtabTable, mtxrSystemGroup=mtxrSystemGroup, GDiv100=GDiv100, mtxrInterfaceStatsRxFragment=mtxrInterfaceStatsRxFragment, mtxrOpticalVendorSerial=mtxrOpticalVendorSerial, mtxrWlApIndex=mtxrWlApIndex, mtxrWlApBand=mtxrWlApBand, mtxrWlRtabTxStrengthCh2=mtxrWlRtabTxStrengthCh2, mtxrQueueSimpleSrcMask=mtxrQueueSimpleSrcMask, mtxrWl60GIndex=mtxrWl60GIndex, mtxrWl60GTable=mtxrWl60GTable, mtxrSerialNumber=mtxrSerialNumber, mtxrQueueGroup=mtxrQueueGroup, mtxrWl60GMode=mtxrWl60GMode, mtxrIkeSATxBytes=mtxrIkeSATxBytes, mtxrDHCPLeaseCount=mtxrDHCPLeaseCount, mikrotik=mikrotik, mtxrQueueSimpleDroppedOut=mtxrQueueSimpleDroppedOut, mtxrPOETable=mtxrPOETable, mtxrWlRtabTable=mtxrWlRtabTable, mtxrHlThreeDotThreeVoltage=mtxrHlThreeDotThreeVoltage, mtxrOpticalTemperature=mtxrOpticalTemperature, mtxrWlRtabAddr=mtxrWlRtabAddr, mtxrScriptRunIndex=mtxrScriptRunIndex, mtxrInterfaceStatsRxBytes=mtxrInterfaceStatsRxBytes, mtxrNeighborTableEntry=mtxrNeighborTableEntry, mtxrInterfaceStatsTxFragment=mtxrInterfaceStatsTxFragment, mtxrHlCurrent=mtxrHlCurrent, mtxrWirelessModemAccessTechnology=mtxrWirelessModemAccessTechnology, mtxrPartitionGroup=mtxrPartitionGroup, mtxrNeighborInterfaceID=mtxrNeighborInterfaceID, mtxrHlTemperature=mtxrHlTemperature, mtxrIkeSAGroup=mtxrIkeSAGroup, mtxrWlCMRegClientCount=mtxrWlCMRegClientCount, mtxrInterfaceStatsTxFCSError=mtxrInterfaceStatsTxFCSError, mtxrIkeSAIdentity=mtxrIkeSAIdentity, mtxrWirelessModemRSRP=mtxrWirelessModemRSRP, mtxrWlCMChannel=mtxrWlCMChannel, mtxrOpticalWavelength=mtxrOpticalWavelength, mtxrLTEModemCellId=mtxrLTEModemCellId, mtxrWirelessModemGroup=mtxrWirelessModemGroup, mtxrNotifications=mtxrNotifications, mtxrWlStatBand=mtxrWlStatBand, mtxrPOEPower=mtxrPOEPower, mtxrIkeSALocalPort=mtxrIkeSALocalPort, mtxrHlPower=mtxrHlPower, mtxrWlApBssid=mtxrWlApBssid, mtxrDate=mtxrDate, mtxrWlCMRtabTxStrength=mtxrWlCMRtabTxStrength, mtxrQueueTreeDropped=mtxrQueueTreeDropped, mtxrWlRtabTxStrengthCh0=mtxrWlRtabTxStrengthCh0, mtxrIkeSAPeerAddressType=mtxrIkeSAPeerAddressType, mtxrWlStatIndex=mtxrWlStatIndex, mtxrInterfaceStatsLinkDowns=mtxrInterfaceStatsLinkDowns, mtxrWlCMIndex=mtxrWlCMIndex, mtxrWlCMRtabSsid=mtxrWlCMRtabSsid, mtxrInterfaceStatsTxSingleCollision=mtxrInterfaceStatsTxSingleCollision, mtxrInterfaceStatsTxCollision=mtxrInterfaceStatsTxCollision, mtxrHlFanSpeed1=mtxrHlFanSpeed1, mtxrInterfaceStatsTxTooLong=mtxrInterfaceStatsTxTooLong, mtxrOpticalIndex=mtxrOpticalIndex, mtxrSystem=mtxrSystem, mtxrHotspotActiveUserValidTillTime=mtxrHotspotActiveUserValidTillTime, mtxrWl60GStaTable=mtxrWl60GStaTable, mtxrWlRtabRxStrengthCh0=mtxrWlRtabRxStrengthCh0, mtxrQueueSimpleIface=mtxrQueueSimpleIface, mtxrWlStatTable=mtxrWlStatTable, mtxrWl60GSignal=mtxrWl60GSignal, mtxrQueueTreeParentIndex=mtxrQueueTreeParentIndex, mtxrHlFanSpeed2=mtxrHlFanSpeed2, mtxrInterfaceStatsTable=mtxrInterfaceStatsTable, mtxrQueueTreeIndex=mtxrQueueTreeIndex, mtxrWl60GPhyRate=mtxrWl60GPhyRate, mtxrInterfaceStatsTx512To1023=mtxrInterfaceStatsTx512To1023, mtxrLicLevel=mtxrLicLevel, mtxrInterfaceStatsDriverTxPackets=mtxrInterfaceStatsDriverTxPackets, mtxrLTEModemTable=mtxrLTEModemTable, mtxrIkeSAIndex=mtxrIkeSAIndex, mtxrHotspotActiveUserRadius=mtxrHotspotActiveUserRadius, mtxrHotspotActiveUserDomain=mtxrHotspotActiveUserDomain, mtxrInterfaceStatsTxTooShort=mtxrInterfaceStatsTxTooShort, mtxrHotspotActiveUserBytesOut=mtxrHotspotActiveUserBytesOut, mtxrGPSGroup=mtxrGPSGroup, mtxrWl60GSsid=mtxrWl60GSsid, mtxrPartitionVersion=mtxrPartitionVersion, mtxrWl60GStaConnected=mtxrWl60GStaConnected, mtxrWl60GConnected=mtxrWl60GConnected, mtxrDHCPGroup=mtxrDHCPGroup, mtxrGaugeTable=mtxrGaugeTable, mtxrGaugeUnit=mtxrGaugeUnit, mtxrWlCMRtabTxRate=mtxrWlCMRtabTxRate, mtxrIkeSATxPackets=mtxrIkeSATxPackets, mtxrWlStatRxCCQ=mtxrWlStatRxCCQ, mtxrWl60GStaRssi=mtxrWl60GStaRssi, mtxrHlPowerSupplyState=mtxrHlPowerSupplyState, mtxrBuildTime=mtxrBuildTime, mtxrIkeSARxPackets=mtxrIkeSARxPackets, mtxrHotspotActiveUserConnectTime=mtxrHotspotActiveUserConnectTime, mtxrPartitionTable=mtxrPartitionTable, mtxrInterfaceStatsTxRx256To511=mtxrInterfaceStatsTxRx256To511, mtxrOpticalGroup=mtxrOpticalGroup, mtxrLTEModemAccessTechnology=mtxrLTEModemAccessTechnology, mtxrWlCMTable=mtxrWlCMTable, mtxrGaugeTableEntry=mtxrGaugeTableEntry, mtxrInterfaceStatsTxRx1024To1518=mtxrInterfaceStatsTxRx1024To1518, mtxrOpticalName=mtxrOpticalName, mtxrWl60GStaIndex=mtxrWl60GStaIndex, mtxrWl60GMcs=mtxrWl60GMcs, HexInt=HexInt, mtxrQueueSimpleBytesOut=mtxrQueueSimpleBytesOut, mtxrWlRtabRxRate=mtxrWlRtabRxRate, mtxrNeighborTable=mtxrNeighborTable, mtxrPOEGroup=mtxrPOEGroup, mtxrQueueTreePackets=mtxrQueueTreePackets, mtxrWlCMRemoteName=mtxrWlCMRemoteName, mtxrDnConnected=mtxrDnConnected, mtXRouterOs=mtXRouterOs, mtxrHlBackupPowerSupplyState=mtxrHlBackupPowerSupplyState, mtxrHotspotActiveUserMAC=mtxrHotspotActiveUserMAC, mtxrQueueTreeFlow=mtxrQueueTreeFlow, mtxrIkeSATable=mtxrIkeSATable, mtxrInterfaceStatsTxDeferred=mtxrInterfaceStatsTxDeferred, mtxrInterfaceStatsTxDrop=mtxrInterfaceStatsTxDrop, mtxrInterfaceStatsRxJabber=mtxrInterfaceStatsRxJabber, mtxrInterfaceStatsRxBroadcast=mtxrInterfaceStatsRxBroadcast, mtxrWlStatEntry=mtxrWlStatEntry, IsakmpCookie=IsakmpCookie, mtxrQueueTreeName=mtxrQueueTreeName, mtxrInterfaceStatsTxUnderrun=mtxrInterfaceStatsTxUnderrun, mtxrWirelessModemSINR=mtxrWirelessModemSINR, mtxrScriptRunTable=mtxrScriptRunTable, mtxrInterfaceStatsRxCarrierError=mtxrInterfaceStatsRxCarrierError, mtxrWirelessModemRSRQ=mtxrWirelessModemRSRQ, mtxrInterfaceStatsEntry=mtxrInterfaceStatsEntry, mtxrHotspotActiveUserBlockedByAdvert=mtxrHotspotActiveUserBlockedByAdvert, mtxrLicUpgrUntil=mtxrLicUpgrUntil, mtxrLicense=mtxrLicense, mtxrFirmwareVersion=mtxrFirmwareVersion, mtxrDnStatTxStrength=mtxrDnStatTxStrength, mtxrHlProcessorFrequency=mtxrHlProcessorFrequency, mtxrWl60GRssi=mtxrWl60GRssi, mtxrWlRtabTxStrengthCh1=mtxrWlRtabTxStrengthCh1, mtxrInterfaceStatsRxAlignError=mtxrInterfaceStatsRxAlignError, mtxrScriptIndex=mtxrScriptIndex, mtxrInterfaceStatsTxBytes=mtxrInterfaceStatsTxBytes, mtxrPOEEntry=mtxrPOEEntry, mtxrInterfaceStats=mtxrInterfaceStats, mtxrWirelessModem=mtxrWirelessModem, mtxrWlStatFreq=mtxrWlStatFreq, mtxrDnStatIndex=mtxrDnStatIndex, mtxrWlRtabIface=mtxrWlRtabIface, mtxrHotspotActiveUserLimitBytesOut=mtxrHotspotActiveUserLimitBytesOut, mtxrWlRtabRxStrengthCh2=mtxrWlRtabRxStrengthCh2, mtxrLicSoftwareId=mtxrLicSoftwareId, mtxrQueueTreeEntry=mtxrQueueTreeEntry, mtxrWl60GTxSector=mtxrWl60GTxSector, ObjectIndex=ObjectIndex, mtxrIkeSAResponder=mtxrIkeSAResponder, mtxrPartitionSize=mtxrPartitionSize, mtxrWlRtabTxPackets=mtxrWlRtabTxPackets, mtxrInterfaceStatsDriverTxBytes=mtxrInterfaceStatsDriverTxBytes, mtxrValid=mtxrValid, mtxrHotspotActiveUsersTableEntry=mtxrHotspotActiveUsersTableEntry, mtxrInterfaceStatsRx512To1023=mtxrInterfaceStatsRx512To1023, mtxrInterfaceStatsRx1519ToMax=mtxrInterfaceStatsRx1519ToMax, mtxrQueueTreeHCBytes=mtxrQueueTreeHCBytes, mtxrOpticalTable=mtxrOpticalTable, mtxrWlStatStrength=mtxrWlStatStrength, mtxrInterfaceStatsRxControl=mtxrInterfaceStatsRxControl, mtxrInterfaceStatsTxPackets=mtxrInterfaceStatsTxPackets, mtxrIkeSAPeerPort=mtxrIkeSAPeerPort, mtxrWlRtabRxPackets=mtxrWlRtabRxPackets, mtxrIkeSALocalAddress=mtxrIkeSALocalAddress, mtxrHotspotActiveUserIP=mtxrHotspotActiveUserIP, mtxrWlCMRtabIface=mtxrWlCMRtabIface, mtxrDnStatTxRate=mtxrDnStatTxRate, PYSNMP_MODULE_ID=mikrotikExperimentalModule, mtxrGaugeName=mtxrGaugeName, mtxrWlCMState=mtxrWlCMState, mtxrScriptRunOutput=mtxrScriptRunOutput, mtxrInterfaceStatsRx128To255=mtxrInterfaceStatsRx128To255, mtxrInterfaceStatsTx1024To1518=mtxrInterfaceStatsTx1024To1518, mtxrPartitionName=mtxrPartitionName, mtxrWl60GStaSignal=mtxrWl60GStaSignal, mtxrQueueTreePCQQueues=mtxrQueueTreePCQQueues, mtxrInterfaceStatsTxRx1519ToMax=mtxrInterfaceStatsTxRx1519ToMax, mtxrWlRtabStrength=mtxrWlRtabStrength, IDiv1000=IDiv1000, mtxrHotspotActiveUserIdleStartTime=mtxrHotspotActiveUserIdleStartTime, mtxrInterfaceStatsTxLateCollision=mtxrInterfaceStatsTxLateCollision, mtxrHotspotActiveUserServerID=mtxrHotspotActiveUserServerID, mtxrHotspotActiveUserIndex=mtxrHotspotActiveUserIndex, mtxrDnStatEntry=mtxrDnStatEntry, mtxrIPSec=mtxrIPSec, mtxrGaugeValue=mtxrGaugeValue, mtxrWlApTable=mtxrWlApTable, mtxrInterfaceStatsRxUnknownOp=mtxrInterfaceStatsRxUnknownOp, mtxrIkeSATableEntry=mtxrIkeSATableEntry, mtxrInterfaceStatsTxMulticast=mtxrInterfaceStatsTxMulticast, mtxrInterfaceStatsRxMulticast=mtxrInterfaceStatsRxMulticast, mtxrLTEModemGroup=mtxrLTEModemGroup, mtxrTemperatureException=mtxrTemperatureException, mtxrDnStatRxStrength=mtxrDnStatRxStrength, mtxrWlCMRtabEapIdent=mtxrWlCMRtabEapIdent, mtxrHotspotActiveUserIdleTimeout=mtxrHotspotActiveUserIdleTimeout, mtxrWirelessModemSignalStrength=mtxrWirelessModemSignalStrength, mtxrWl60GRemote=mtxrWl60GRemote, mtxrQueueTreeTable=mtxrQueueTreeTable, mtxrWlRtabEntry=mtxrWlRtabEntry, mtxrWlCMRemoteAddress=mtxrWlCMRemoteAddress, mtxrQueueSimpleDstMask=mtxrQueueSimpleDstMask, mtxrDHCP=mtxrDHCP, mtxrPartition=mtxrPartition, mtxrHotspotActiveUserGroup=mtxrHotspotActiveUserGroup, mtxrWlCMRtabRxPackets=mtxrWlCMRtabRxPackets, BoolValue=BoolValue, mtxrWl60GEntry=mtxrWl60GEntry, mtxrWlCMRemoteState=mtxrWlCMRemoteState, mtxrQueueSimplePCQQueuesOut=mtxrQueueSimplePCQQueuesOut, mtxrWl60GStaRemote=mtxrWl60GStaRemote)
mibBuilder.exportSymbols("MIKROTIK-MIB", mtxrLicUpgradableTo=mtxrLicUpgradableTo, mtxrInterfaceStatsTxMultipleCollision=mtxrInterfaceStatsTxMultipleCollision, mtxrLTEModemInterfaceIndex=mtxrLTEModemInterfaceIndex, mtxrInterfaceStatsIndex=mtxrInterfaceStatsIndex, mtxrInterfaceStatsGroup=mtxrInterfaceStatsGroup, mtxrNeighborIndex=mtxrNeighborIndex, mtxrInterfaceStatsRxDrop=mtxrInterfaceStatsRxDrop, mtxrInterfaceStatsTxPauseHonored=mtxrInterfaceStatsTxPauseHonored, mtxrWlRtabRouterOSVersion=mtxrWlRtabRouterOSVersion, mtxrQueueSimpleTable=mtxrQueueSimpleTable, mtxrHlSensorTemperature=mtxrHlSensorTemperature, mtxrWlCMRtabTxBytes=mtxrWlCMRtabTxBytes, mtxrLTEModemSignalRSSI=mtxrLTEModemSignalRSSI, mtxrInterfaceStatsRxOverflow=mtxrInterfaceStatsRxOverflow, mtxrInterfaceStatsTxRx64=mtxrInterfaceStatsTxRx64, mtxrQueueSimplePacketsIn=mtxrQueueSimplePacketsIn, mtxrInterfaceStatsRxPause=mtxrInterfaceStatsRxPause, mtxrNeighborSoftwareID=mtxrNeighborSoftwareID, mtxrHotspot=mtxrHotspot, mtxrWlCMRtabEntryCount=mtxrWlCMRtabEntryCount, mtxrNeighborIdentity=mtxrNeighborIdentity, mtxrInterfaceStatsName=mtxrInterfaceStatsName, mtxrPOEStatus=mtxrPOEStatus, mtxrWlApEntry=mtxrWlApEntry, mtxrIkeSACount=mtxrIkeSACount, mtxrNote=mtxrNote, mtxrWlApFreq=mtxrWlApFreq, mtxrQueueSimplePacketsOut=mtxrQueueSimplePacketsOut, mtxrInterfaceStatsTxControl=mtxrInterfaceStatsTxControl, mtxrNeighborPlatform=mtxrNeighborPlatform, mtxrNeighborIpAddress=mtxrNeighborIpAddress, mtxrAltitude=mtxrAltitude, Temperature=Temperature, mtxrHlCpuTemperature=mtxrHlCpuTemperature, mtxrInterfaceStatsRx1024To1518=mtxrInterfaceStatsRx1024To1518, mtxrInterfaceStatsTx64=mtxrInterfaceStatsTx64, mtxrPartitionRunning=mtxrPartitionRunning, mtxrIkeSAResponderCookie=mtxrIkeSAResponderCookie, mtxrSattelites=mtxrSattelites, mtxrWlCMREntryCount=mtxrWlCMREntryCount, mtxrNstremeDualGroup=mtxrNstremeDualGroup, mtxrScriptRun=mtxrScriptRun, mtxrPOEName=mtxrPOEName, mtxrInterfaceStatsRx64=mtxrInterfaceStatsRx64, mtxrLongtitude=mtxrLongtitude, mtxrWl60GStaMcs=mtxrWl60GStaMcs, mtxrWlRtabTxRate=mtxrWlRtabTxRate, mtxrWlRtabRxStrengthCh1=mtxrWlRtabRxStrengthCh1, mtxrWl60GStaPhyRate=mtxrWl60GStaPhyRate, mtxrInterfaceStatsTxRx512To1023=mtxrInterfaceStatsTxRx512To1023, mtxrWlStatSsid=mtxrWlStatSsid, mtxrIkeSAState=mtxrIkeSAState, GDiv1000=GDiv1000, mtxrQueueSimplePCQQueuesIn=mtxrQueueSimplePCQQueuesIn, mtxrInterfaceStatsTx65To127=mtxrInterfaceStatsTx65To127, mtxrHlFiveVoltage=mtxrHlFiveVoltage, mtxrWireless=mtxrWireless, mtxrLTEModemEntry=mtxrLTEModemEntry, mtxrWirelessModemRevision=mtxrWirelessModemRevision, mtxrInterfaceStatsRxCodeError=mtxrInterfaceStatsRxCodeError, mtxrWlCMRtabRxRate=mtxrWlCMRtabRxRate, mtxrWlCMRtabTxPackets=mtxrWlCMRtabTxPackets, mtxrInterfaceStatsTxTotalCollision=mtxrInterfaceStatsTxTotalCollision, mtxrInterfaceStatsRxTooShort=mtxrInterfaceStatsRxTooShort, mtxrInterfaceStatsRxPackets=mtxrInterfaceStatsRxPackets, mtxrOpticalTxPower=mtxrOpticalTxPower, mtxrDnStatRxRate=mtxrDnStatRxRate, mtxrOpticalRxPower=mtxrOpticalRxPower, mtxrHlTwelveVoltage=mtxrHlTwelveVoltage, mtxrWlCMRtabRxBytes=mtxrWlCMRtabRxBytes, mtxrTrap=mtxrTrap, mtxrWlCMRtabEntry=mtxrWlCMRtabEntry, mtxrQueueSimpleEntry=mtxrQueueSimpleEntry, mtxrLTEModemSignalRSRP=mtxrLTEModemSignalRSRP, mtxrHotspotActiveUserName=mtxrHotspotActiveUserName, mtxrHlBoardTemperature=mtxrHlBoardTemperature, Voltage=Voltage, mtxrSpeed=mtxrSpeed, mtxrWirelessGroup=mtxrWirelessGroup, mtxrScriptTableEntry=mtxrScriptTableEntry, mikrotikExperimentalModule=mikrotikExperimentalModule, mtxrHlCoreVoltage=mtxrHlCoreVoltage, mtxrOpticalTxFault=mtxrOpticalTxFault, mtxrInterfaceStatsTxExcessiveCollision=mtxrInterfaceStatsTxExcessiveCollision, mtxrHotspotActiveUserAdvertStatus=mtxrHotspotActiveUserAdvertStatus, mtxrHlActiveFan=mtxrHlActiveFan, mtxrWlApSsid=mtxrWlApSsid, mtxrLTEModemSignalRSRQ=mtxrLTEModemSignalRSRQ, mtxrTraps=mtxrTraps, mtxrWl60GTxSectorInfo=mtxrWl60GTxSectorInfo, mtxrWlCMAuthClientCount=mtxrWlCMAuthClientCount, mtxrWlRtabUptime=mtxrWlRtabUptime, mtxrLatitude=mtxrLatitude, mtxrInterfaceStatsTx128To255=mtxrInterfaceStatsTx128To255, mtxrLTEModemUICC=mtxrLTEModemUICC, mtxrPartitionEntry=mtxrPartitionEntry, mtxrWlApTxRate=mtxrWlApTxRate, mtxrNeighborMacAddress=mtxrNeighborMacAddress, mtxrWlStatTxRate=mtxrWlStatTxRate, mtxrLincenseGroup=mtxrLincenseGroup, mtxrBoardName=mtxrBoardName, mtxrIkeSAPh2Count=mtxrIkeSAPh2Count, mtxrScriptName=mtxrScriptName, mtxrNeighbor=mtxrNeighbor, mtxrHealthGroup=mtxrHealthGroup, mtxrGps=mtxrGps, mtxrIkeSADynamicAddress=mtxrIkeSADynamicAddress, mtxrHotspotActiveUserPingTimeout=mtxrHotspotActiveUserPingTimeout, mtxrWlStatBssid=mtxrWlStatBssid, mtxrHotspotActiveUserLimitBytesIn=mtxrHotspotActiveUserLimitBytesIn, mtxrInterfaceStatsDriverRxBytes=mtxrInterfaceStatsDriverRxBytes, mtxrInterfaceStatsTxRx1024ToMax=mtxrInterfaceStatsTxRx1024ToMax, Power=Power, mtxrInterfaceStatsDriverRxPackets=mtxrInterfaceStatsDriverRxPackets, mtxrOpticalRxLoss=mtxrOpticalRxLoss, mtxrIkeSAUptime=mtxrIkeSAUptime, mtxrScriptTable=mtxrScriptTable, mtxrScriptGroup=mtxrScriptGroup, mtxrWlStatRxRate=mtxrWlStatRxRate, mtxrWlApRxRate=mtxrWlApRxRate, mtxrHotspotActiveUsersTable=mtxrHotspotActiveUsersTable, mtxrQueueSimpleDstAddr=mtxrQueueSimpleDstAddr, mtxrWirelessModemModel=mtxrWirelessModemModel, mtxrPOEInterfaceIndex=mtxrPOEInterfaceIndex, mtxrInterfaceStatsRx256To511=mtxrInterfaceStatsRx256To511, mtxrLTEModemSectorId=mtxrLTEModemSectorId, mtxrWlCMRemoteEntry=mtxrWlCMRemoteEntry, mtxrLTEModemLac=mtxrLTEModemLac, mtxrInterfaceStatsTx256To511=mtxrInterfaceStatsTx256To511, mtxrOpticalTableEntry=mtxrOpticalTableEntry, mtxrWirelessModemIMEI=mtxrWirelessModemIMEI, mtxrWlCMRtabRxStrength=mtxrWlCMRtabRxStrength, mtxrInterfaceStatsRxTooLong=mtxrInterfaceStatsRxTooLong, mtxrPOEVoltage=mtxrPOEVoltage, mtxrWlRtabTxBytes=mtxrWlRtabTxBytes, mtxrOpticalTxBiasCurrent=mtxrOpticalTxBiasCurrent, mtxrInterfaceStatsTxJabber=mtxrInterfaceStatsTxJabber, mtxrInterfaceStatsTxBroadcast=mtxrInterfaceStatsTxBroadcast, mtxrWlApNoiseFloor=mtxrWlApNoiseFloor, mtxrWlRtabRxBytes=mtxrWlRtabRxBytes, mtxrHlVoltage=mtxrHlVoltage, mtxrWirelessModemManufacturer=mtxrWirelessModemManufacturer, mtxrWlRtabSignalToNoise=mtxrWlRtabSignalToNoise, mtxrIkeSAPeerAddress=mtxrIkeSAPeerAddress, mtxrQueueTreeBytes=mtxrQueueTreeBytes, mtxrPOECurrent=mtxrPOECurrent, mtxrHotspotActiveUserPacketsOut=mtxrHotspotActiveUserPacketsOut, mtxrQueueSimpleSrcAddr=mtxrQueueSimpleSrcAddr, mtxrWlCMRemoteIndex=mtxrWlCMRemoteIndex, mtxrWl60GStaDistance=mtxrWl60GStaDistance, mtxrLTEModemEnbId=mtxrLTEModemEnbId, mtxrLTEModem=mtxrLTEModem, mtxrGaugeIndex=mtxrGaugeIndex, mtxrWl60GStaTxSector=mtxrWl60GStaTxSector, mtxrInterfaceStatsRxLengthError=mtxrInterfaceStatsRxLengthError, mtxrHealth=mtxrHealth, mtxrWlApClientCount=mtxrWlApClientCount, mtxrLicVersion=mtxrLicVersion, mtxrInterfaceStatsTxRx128To255=mtxrInterfaceStatsTxRx128To255, mtxrHotspotActiveUserBytesIn=mtxrHotspotActiveUserBytesIn, mtxrTrapGroup=mtxrTrapGroup, mtxrWlApAuthClientCount=mtxrWlApAuthClientCount, mtxrInterfaceStatsRxFCSError=mtxrInterfaceStatsRxFCSError, mtxrInterfaceStatsRx65To127=mtxrInterfaceStatsRx65To127, mtxrWl60GFreq=mtxrWl60GFreq, mtxrQueueSimpleName=mtxrQueueSimpleName, mtxrQueues=mtxrQueues, mtxrInterfaceStatsTxPause=mtxrInterfaceStatsTxPause, mtxrOpticalSupplyVoltage=mtxrOpticalSupplyVoltage, mtxrFirmwareUpgradeVersion=mtxrFirmwareUpgradeVersion, mtxrInterfaceStatsTx1519ToMax=mtxrInterfaceStatsTx1519ToMax, mtxrOptical=mtxrOptical, mtxrQueueSimpleIndex=mtxrQueueSimpleIndex, mtxrWlCMRtabAddr=mtxrWlCMRtabAddr, mtxrWirelessModemFrameErrorRate=mtxrWirelessModemFrameErrorRate, mtxrLTEModemIMEI=mtxrLTEModemIMEI, mtxrInterfaceStatsTxExcessiveDeferred=mtxrInterfaceStatsTxExcessiveDeferred, mtxrIkeSAVersion=mtxrIkeSAVersion, mtxrWlRtabRadioName=mtxrWlRtabRadioName, mtxrWirelessModemSignalECIO=mtxrWirelessModemSignalECIO, mtxrPartitionIndex=mtxrPartitionIndex, mtxrIkeSAInitiatorCookie=mtxrIkeSAInitiatorCookie, mtxrWlRtabTxStrength=mtxrWlRtabTxStrength, mtxrIkeSANatt=mtxrIkeSANatt, mtxrIkeSALocalAddressType=mtxrIkeSALocalAddressType, mtxrWl60GStaEntry=mtxrWl60GStaEntry, mtxrWlCMRtabUptime=mtxrWlCMRtabUptime)
