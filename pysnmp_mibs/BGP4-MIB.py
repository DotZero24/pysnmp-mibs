...
# Notes
# -----
# ASN.1 source file://mibs/junose/BGP4-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:23:01 2025
...
class _BgpPeerNegotiatedVersion_Type(Integer32):
    """Custom type bgpPeerNegotiatedVersion based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_BgpPeerNegotiatedVersion_Type.__name__ = "Integer32"
...
bgpMIBConformance = _BgpMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 2, 1, 15, 8)
)
_BgpMIBCompliances_ObjectIdentity = ObjectIdentity
bgpMIBCompliances = _BgpMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 2, 1, 15, 8, 1)
)
_BgpMIBGroups_ObjectIdentity = ObjectIdentity
bgpMIBGroups = _BgpMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 2, 1, 15, 8, 2)
)
...
bgp4MIBRcvdPathAttrGroup = ObjectGroup(
    (1, 3, 6, 1, 2, 1, 15, 8, 2, 3)
)
bgp4MIBRcvdPathAttrGroup.setObjects(
...
if mibBuilder.loadTexts:
    bgp4MIBRcvdPathAttrGroup.setStatus("obsolete")
...
bgp4MIBNewNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 2, 1, 15, 8, 2, 6)
)
bgp4MIBNewNotificationGroup.setObjects(
      *(("BGP4-MIB", "bgpEstablishedNotification"),
        ("BGP4-MIB", "bgpBackwardTransNotification"))
)
if mibBuilder.loadTexts:
    bgp4MIBNewNotificationGroup.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"bgp": bgp,
       ...
       "bgpMIBConformance": bgpMIBConformance,
       "bgpMIBCompliances": bgpMIBCompliances,
       "bgpMIBCompliance": bgpMIBCompliance,
       "bgpMIBGroups": bgpMIBGroups,
       "bgp4MIBGlobalsGroup": bgp4MIBGlobalsGroup,
       "bgp4MIBPeerGroup": bgp4MIBPeerGroup,
       "bgp4MIBRcvdPathAttrGroup": bgp4MIBRcvdPathAttrGroup,
       "bgp4MIBPathAttrGroup": bgp4MIBPathAttrGroup,
       "bgp4MIBNotificationGroup": bgp4MIBNotificationGroup,
       "bgp4MIBNewNotificationGroup": bgp4MIBNewNotificationGroup}
)
