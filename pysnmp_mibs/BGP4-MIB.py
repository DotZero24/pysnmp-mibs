...
mibBuilder.exportSymbols("BGP4-MIB", bgpPeerRemotePort=bgpPeerRemotePort, bgp4PathAttrNextHop=bgp4PathAttrNextHop, bgpPeerMinASOriginationInterval=bgpPeerMinASOriginationInterval, bgpNotification=bgpNotification, bgpPeerIdentifier=bgpPeerIdentifier, bgp4PathAttrUnknown=bgp4PathAttrUnknown, bgp4PathAttrLocalPref=bgp4PathAttrLocalPref, bgpMIBCompliance=bgpMIBCompliance, bgp4MIBGlobalsGroup=bgp4MIBGlobalsGroup, bgpPeerLocalPort=bgpPeerLocalPort, bgp4PathAttrASPathSegment=bgp4PathAttrASPathSegment, bgpPeerRemoteAddr=bgpPeerRemoteAddr, bgpPeerState=bgpPeerState, bgpVersion=bgpVersion, bgpPathAttrPeer=bgpPathAttrPeer, bgpPeerInTotalMessages=bgpPeerInTotalMessages, bgpBackwardTransNotification=bgpBackwardTransNotification, bgpIdentifier=bgpIdentifier, bgp4PathAttrBest=bgp4PathAttrBest, bgpMIBCompliances=bgpMIBCompliances, bgpBackwardTransition=bgpBackwardTransition, bgpPeerLocalAddr=bgpPeerLocalAddr, bgpPeerInUpdates=bgpPeerInUpdates, bgpPeerFsmEstablishedTransitions=bgpPeerFsmEstablishedTransitions, bgpPeerAdminStatus=bgpPeerAdminStatus, bgpPeerHoldTime=bgpPeerHoldTime, bgpPathAttrOrigin=bgpPathAttrOrigin, bgp=bgp, bgpPeerRemoteAs=bgpPeerRemoteAs, bgp4PathAttrAggregatorAS=bgp4PathAttrAggregatorAS, bgpPathAttrNextHop=bgpPathAttrNextHop, bgpTraps=bgpTraps, bgp4PathAttrCalcLocalPref=bgp4PathAttrCalcLocalPref, bgp4PathAttrTable=bgp4PathAttrTable, bgpLocalAs=bgpLocalAs, bgpPathAttrDestNetwork=bgpPathAttrDestNetwork, bgpPeerOutTotalMessages=bgpPeerOutTotalMessages, bgp4MIBRcvdPathAttrGroup=bgp4MIBRcvdPathAttrGroup, bgpPeerNegotiatedVersion=bgpPeerNegotiatedVersion, bgpPeerKeepAlive=bgpPeerKeepAlive, bgpPeerMinRouteAdvertisementInterval=bgpPeerMinRouteAdvertisementInterval, PYSNMP_MODULE_ID=bgp, bgpMIBGroups=bgpMIBGroups, bgp4MIBNotificationGroup=bgp4MIBNotificationGroup, bgp4PathAttrOrigin=bgp4PathAttrOrigin, bgpPeerHoldTimeConfigured=bgpPeerHoldTimeConfigured, bgpPeerInUpdateElapsedTime=bgpPeerInUpdateElapsedTime, bgpPathAttrEntry=bgpPathAttrEntry, bgp4PathAttrPeer=bgp4PathAttrPeer, bgp4PathAttrAtomicAggregate=bgp4PathAttrAtomicAggregate, bgpEstablishedNotification=bgpEstablishedNotification, bgpPeerConnectRetryInterval=bgpPeerConnectRetryInterval, bgpMIBConformance=bgpMIBConformance, bgp4PathAttrMultiExitDisc=bgp4PathAttrMultiExitDisc, bgpPeerTable=bgpPeerTable, bgp4MIBNewNotificationGroup=bgp4MIBNewNotificationGroup, bgp4MIBPeerGroup=bgp4MIBPeerGroup, bgpPeerKeepAliveConfigured=bgpPeerKeepAliveConfigured, bgpRcvdPathAttrTable=bgpRcvdPathAttrTable, bgpPeerOutUpdates=bgpPeerOutUpdates, bgp4PathAttrIpAddrPrefix=bgp4PathAttrIpAddrPrefix, bgpPathAttrASPath=bgpPathAttrASPath, bgpPeerEntry=bgpPeerEntry, bgpPeerFsmEstablishedTime=bgpPeerFsmEstablishedTime, bgp4PathAttrEntry=bgp4PathAttrEntry, bgpEstablished=bgpEstablished, bgp4PathAttrAggregatorAddr=bgp4PathAttrAggregatorAddr, bgpPeerLastError=bgpPeerLastError, bgp4MIBPathAttrGroup=bgp4MIBPathAttrGroup, bgpPathAttrInterASMetric=bgpPathAttrInterASMetric, bgp4PathAttrIpAddrPrefixLen=bgp4PathAttrIpAddrPrefixLen)
