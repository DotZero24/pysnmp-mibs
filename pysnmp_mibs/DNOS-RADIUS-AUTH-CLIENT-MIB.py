...
_K='obsolete'
_J='DNOS-RADIUS-AUTH-CLIENT-MIB'
_I='disable'
_H='enable'
_G='DisplayString'
_F='read-create'
...
if mibBuilder.loadTexts:fastPathRadius.setRevisions(('2014-04-21 00:00','2011-10-17 00:00','2007-05-23 00:00','2003-11-21 00:00','2003-05-07 00:00'))
_AgentRadiusConfigGroup_ObjectIdentity=ObjectIdentity
agentRadiusConfigGroup=_AgentRadiusConfigGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1))
class _AgentRadiusRetransmit_Type(Unsigned32):defaultValue=4;subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,10))
_AgentRadiusRetransmit_Type.__name__=_E
_AgentRadiusRetransmit_Object=MibScalar
agentRadiusRetransmit=_AgentRadiusRetransmit_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,1),_AgentRadiusRetransmit_Type())
...
agentRadiusTimeout=_AgentRadiusTimeout_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,2),_AgentRadiusTimeout_Type())
...
agentRadiusDeadTime=_AgentRadiusDeadTime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,3),_AgentRadiusDeadTime_Type())
...
agentRadiusServerKey=_AgentRadiusServerKey_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,4),_AgentRadiusServerKey_Type())
...
agentRadiusSourceIPAddr=_AgentRadiusSourceIPAddr_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,5),_AgentRadiusSourceIPAddr_Type())
...
agentRadiusServerIndexNextValid=_AgentRadiusServerIndexNextValid_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,6),_AgentRadiusServerIndexNextValid_Type())
...
agentRadiusServerConfigTable=_AgentRadiusServerConfigTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7))
if mibBuilder.loadTexts:agentRadiusServerConfigTable.setStatus(_A)
_AgentRadiusServerConfigEntry_Object=MibTableRow
agentRadiusServerConfigEntry=_AgentRadiusServerConfigEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1))
...
agentRadiusServerIndex=_AgentRadiusServerIndex_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,1),_AgentRadiusServerIndex_Type())
...
agentRadiusServerAddress=_AgentRadiusServerAddress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,2),_AgentRadiusServerAddress_Type())
...
agentRadiusServerPort=_AgentRadiusServerPort_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,3),_AgentRadiusServerPort_Type())
...
agentRadiusServerTimeout=_AgentRadiusServerTimeout_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,4),_AgentRadiusServerTimeout_Type())
...
agentRadiusServerRetransmit=_AgentRadiusServerRetransmit_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,5),_AgentRadiusServerRetransmit_Type())
...
agentRadiusServerDeadtime=_AgentRadiusServerDeadtime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,6),_AgentRadiusServerDeadtime_Type())
...
agentRadiusServerSourceIPAddr=_AgentRadiusServerSourceIPAddr_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,7),_AgentRadiusServerSourceIPAddr_Type())
...
agentRadiusServerSecret=_AgentRadiusServerSecret_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,8),_AgentRadiusServerSecret_Type())
...
agentRadiusServerPriority=_AgentRadiusServerPriority_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,9),_AgentRadiusServerPriority_Type())
...
agentRadiusServerUsageType=_AgentRadiusServerUsageType_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,10),_AgentRadiusServerUsageType_Type())
...
agentRadiusServerAddressRowStatus=_AgentRadiusServerAddressRowStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,11),_AgentRadiusServerAddressRowStatus_Type())
agentRadiusServerAddressRowStatus.setMaxAccess(_F)
...
agentRadiusServerPrimaryMode=_AgentRadiusServerPrimaryMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,12),_AgentRadiusServerPrimaryMode_Type())
...
agentRadiusServerCurrentMode=_AgentRadiusServerCurrentMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,13),_AgentRadiusServerCurrentMode_Type())
...
agentRadiusServerMsgAuth=_AgentRadiusServerMsgAuth_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,14),_AgentRadiusServerMsgAuth_Type())
...
agentRadiusServerName=_AgentRadiusServerName_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,15),_AgentRadiusServerName_Type())
...
agentRadiusServerInetAddress=_AgentRadiusServerInetAddress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,16),_AgentRadiusServerInetAddress_Type())
...
agentRadiusServerAddressType=_AgentRadiusServerAddressType_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,7,1,17),_AgentRadiusServerAddressType_Type())
...
agentRadiusNasIpAddress=_AgentRadiusNasIpAddress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,8),_AgentRadiusNasIpAddress_Type())
...
agentAuthorizationNetworkRadiusMode=_AgentAuthorizationNetworkRadiusMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,9),_AgentAuthorizationNetworkRadiusMode_Type())
...
agentRadiusAccountingIndexNextValid=_AgentRadiusAccountingIndexNextValid_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,10),_AgentRadiusAccountingIndexNextValid_Type())
...
agentRadiusAccountingConfigTable=_AgentRadiusAccountingConfigTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,11))
...
agentRadiusAccountingConfigEntry=_AgentRadiusAccountingConfigEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,11,1))
...
agentRadiusAccountingServerIndex=_AgentRadiusAccountingServerIndex_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,11,1,1),_AgentRadiusAccountingServerIndex_Type())
...
agentRadiusAccountingServerAddress=_AgentRadiusAccountingServerAddress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,11,1,2),_AgentRadiusAccountingServerAddress_Type())
...
agentRadiusAccountingServerAddressType=_AgentRadiusAccountingServerAddressType_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,11,1,3),_AgentRadiusAccountingServerAddressType_Type())
...
agentRadiusAccountingPort=_AgentRadiusAccountingPort_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,11,1,4),_AgentRadiusAccountingPort_Type())
...
agentRadiusAccountingSecret=_AgentRadiusAccountingSecret_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,11,1,5),_AgentRadiusAccountingSecret_Type())
...
agentRadiusAccountingStatus=_AgentRadiusAccountingStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,11,1,6),_AgentRadiusAccountingStatus_Type())
...
agentRadiusAccountingServerName=_AgentRadiusAccountingServerName_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,11,1,7),_AgentRadiusAccountingServerName_Type())
...
agentRadiusAccountingMode=_AgentRadiusAccountingMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,12),_AgentRadiusAccountingMode_Type())
...
agentRadiusStatsClear=_AgentRadiusStatsClear_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,13),_AgentRadiusStatsClear_Type())
...
agentRadiusAuthenticationServers=_AgentRadiusAuthenticationServers_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,14),_AgentRadiusAuthenticationServers_Type())
...
agentRadiusAccountingServers=_AgentRadiusAccountingServers_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,15),_AgentRadiusAccountingServers_Type())
...
agentRadiusNamedAuthenticationServerGroups=_AgentRadiusNamedAuthenticationServerGroups_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,16),_AgentRadiusNamedAuthenticationServerGroups_Type())
...
agentRadiusNamedAccountingServerGroups=_AgentRadiusNamedAccountingServerGroups_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,17),_AgentRadiusNamedAccountingServerGroups_Type())
...
class _AgentRadiusMaxTransmit_Type(Unsigned32):defaultValue=3;subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,10))
_AgentRadiusMaxTransmit_Type.__name__=_E
_AgentRadiusMaxTransmit_Object=MibScalar
agentRadiusMaxTransmit=_AgentRadiusMaxTransmit_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,18),_AgentRadiusMaxTransmit_Type())
...
agentDasRequestsReceived=_AgentDasRequestsReceived_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,19),_AgentDasRequestsReceived_Type())
...
agentDasACKResponsesSent=_AgentDasACKResponsesSent_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,20),_AgentDasACKResponsesSent_Type())
...
agentDasNAKResponsesSent=_AgentDasNAKResponsesSent_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,21),_AgentDasNAKResponsesSent_Type())
...
agentDasRequestsIgnored=_AgentDasRequestsIgnored_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,22),_AgentDasRequestsIgnored_Type())
...
agentDasRequestsWithMissingOrUnsupportedAttribute=_AgentDasRequestsWithMissingOrUnsupportedAttribute_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,23),_AgentDasRequestsWithMissingOrUnsupportedAttribute_Type())
...
agentDasRequestsWithSessionContextNotFound=_AgentDasRequestsWithSessionContextNotFound_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,24),_AgentDasRequestsWithSessionContextNotFound_Type())
...
agentDasRequestsWithInvalidAttributeValue=_AgentDasRequestsWithInvalidAttributeValue_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,25),_AgentDasRequestsWithInvalidAttributeValue_Type())
...
agentDasRequestsAdministrativelyProhibited=_AgentDasRequestsAdministrativelyProhibited_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,8,1,26),_AgentDasRequestsAdministrativelyProhibited_Type())
