...
# Produced by pysmi-1.1.12 at Wed Oct  8 11:02:55 2025
...
mibBuilder.exportSymbols("F3-PBB-MIB", f3PbbEthernetNetPortHistoryStatsPbbGroupBdaDiscard=f3PbbEthernetNetPortHistoryStatsPbbGroupBdaDiscard, f3PbbFlowITagPriority=f3PbbFlowITagPriority, f3PbbEthernetAccPortITagLoopback3=f3PbbEthernetAccPortITagLoopback3, f3PbbIpManagementTunnelBackboneMacDestinationEnabled=f3PbbIpManagementTunnelBackboneMacDestinationEnabled, f3PbbEthernetNetPortHistoryStatsEntry=f3PbbEthernetNetPortHistoryStatsEntry, f3PbbIpManagementTunnelTable=f3PbbIpManagementTunnelTable, f3PBBGroups=f3PBBGroups, f3PbbFlowA2NPbbCapableFlag=f3PbbFlowA2NPbbCapableFlag, f3PbbEthernetAccPortITagLoopback1=f3PbbEthernetAccPortITagLoopback1, f3PbbIpManagementTunnelBackboneMacDestinationAddress=f3PbbIpManagementTunnelBackboneMacDestinationAddress, f3PbbEthernetNetPortStatsPbbUniBdaDiscard=f3PbbEthernetNetPortStatsPbbUniBdaDiscard, f3PbbIpManagementTunnelISID=f3PbbIpManagementTunnelISID, f3PbbEthernetNetPortITagLoopback1=f3PbbEthernetNetPortITagLoopback1, f3PbbEthernetNetPortITagLoopback2=f3PbbEthernetNetPortITagLoopback2, f3PbbStatsGroup=f3PbbStatsGroup, f3PbbIpManagementTunnelEntry=f3PbbIpManagementTunnelEntry, f3PbbEthernetNetPortStatsTable=f3PbbEthernetNetPortStatsTable, f3PbbEthernetAccPortTable=f3PbbEthernetAccPortTable, f3PbbEthernetAccPortITagLoopback2=f3PbbEthernetAccPortITagLoopback2, f3PbbIpManagementTunnelIPriority=f3PbbIpManagementTunnelIPriority, f3PbbEthernetNetPortStatsPbbGroupBdaDiscard=f3PbbEthernetNetPortStatsPbbGroupBdaDiscard, f3PbbFlowITagISID=f3PbbFlowITagISID, f3PbbEthernetNetPortHistoryStatsTable=f3PbbEthernetNetPortHistoryStatsTable, PYSNMP_MODULE_ID=f3PBBMIB, f3PBBCompliance=f3PBBCompliance, f3PbbEthernetAccPortITagLoopbackMask=f3PbbEthernetAccPortITagLoopbackMask, f3PbbFlowBackboneMacDestinationAddress=f3PbbFlowBackboneMacDestinationAddress, f3PBBPerformanceObjects=f3PBBPerformanceObjects, f3PbbFlowTable=f3PbbFlowTable, f3PbbEthernetNetPortEntry=f3PbbEthernetNetPortEntry, f3PbbEthernetAccPortEntry=f3PbbEthernetAccPortEntry, f3PbbFlowITagControl=f3PbbFlowITagControl, f3PbbFlowBackboneMacDestinationEnabled=f3PbbFlowBackboneMacDestinationEnabled, f3PBBCompliances=f3PBBCompliances, f3PbbFlowEntry=f3PbbFlowEntry, f3PbbIpManagementTunnelItagEnabled=f3PbbIpManagementTunnelItagEnabled, f3PBBConfigObjects=f3PBBConfigObjects, f3PbbEthernetNetPortTable=f3PbbEthernetNetPortTable, f3PBBMIB=f3PBBMIB, f3PBBConformance=f3PBBConformance, f3PbbConfigGroup=f3PbbConfigGroup, f3PbbEthernetNetPortStatsEntry=f3PbbEthernetNetPortStatsEntry, f3PbbEthernetNetPortBackboneMacAddress=f3PbbEthernetNetPortBackboneMacAddress, f3PbbEthernetNetPortHistoryStatsPbbUniBdaDiscard=f3PbbEthernetNetPortHistoryStatsPbbUniBdaDiscard, f3PbbEthernetNetPortITagLoopbackMask=f3PbbEthernetNetPortITagLoopbackMask, f3PbbEthernetNetPortITagLoopback3=f3PbbEthernetNetPortITagLoopback3)
