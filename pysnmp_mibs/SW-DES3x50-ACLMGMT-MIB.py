# SNMP MIB module (SW-DES3x50-ACLMGMT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/SW-DES3x50-ACLMGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:47:21 2025
...
swACLEthernetEntry.setIndexNames(
    (0, "SW-DES3x50-ACLMGMT-MIB", "swACLEthernetProfileID"),
)
if mibBuilder.loadTexts:
...
class _SwACLEthernetPort_Type(PortList):
    """Custom type swACLEthernetPort based on PortList"""
...
_SwACLEthernetPort_Type.__name__ = "PortList"
...
swACLIpEntry.setIndexNames(
    (0, "SW-DES3x50-ACLMGMT-MIB", "swACLIpProfileID"),
)
if mibBuilder.loadTexts:
...
class _SwACLIpPort_Type(PortList):
    """Custom type swACLIpPort based on PortList"""
    subtypeSpec = PortList.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 127),
    )
...
_SwACLIpPort_Type.__name__ = "PortList"
...
swACLPayloadEntry.setIndexNames(
    (0, "SW-DES3x50-ACLMGMT-MIB", "swACLPayloadProfileID"),
)
if mibBuilder.loadTexts:
...
class _SwACLPayloadPort_Type(PortList):
    """Custom type swACLPayloadPort based on PortList"""
    subtypeSpec = PortList.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 127),
    )
...
_SwACLPayloadPort_Type.__name__ = "PortList"
...
swACLEtherRuleEntry.setIndexNames(
    (0, "SW-DES3x50-ACLMGMT-MIB", "swACLEtherRuleProfileID"),
    (0, "SW-DES3x50-ACLMGMT-MIB", "swACLEtherRuleAccessID"),
)
if mibBuilder.loadTexts:
...
swACLIpRuleEntry.setIndexNames(
    (0, "SW-DES3x50-ACLMGMT-MIB", "swACLIpRuleProfileID"),
    (0, "SW-DES3x50-ACLMGMT-MIB", "swACLIpRuleAccessID"),
)
if mibBuilder.loadTexts:
...
swACLPayloadRuleEntry.setIndexNames(
    (0, "SW-DES3x50-ACLMGMT-MIB", "swACLPayloadRuleProfileID"),
    (0, "SW-DES3x50-ACLMGMT-MIB", "swACLPayloadRuleAccessID"),
)
if mibBuilder.loadTexts:
