...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/rfc/ATM2-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:48:41 2025
...
atmVclVci, atmVclVpi, atmVpCrossConnectEntry, atmVclEntry, atmMIBObjects, atmVcCrossConnectEntry, atmInterfaceConfEntry, atmVplEntry, atmVplVpi = mibBuilder.importSymbols("ATM-MIB", "atmVclVci", "atmVclVpi", "atmVpCrossConnectEntry", "atmVclEntry", "atmMIBObjects", "atmVcCrossConnectEntry", "atmInterfaceConfEntry", "atmVplEntry", "atmVplVpi")
AtmSigDescrParamIndex, AtmAddr, AtmIlmiNetworkPrefix, AtmTrafficDescrParamIndex, AtmInterfaceType, AtmVcIdentifier, AtmVpIdentifier = mibBuilder.importSymbols("ATM-TC-MIB", "AtmSigDescrParamIndex", "AtmAddr", "AtmIlmiNetworkPrefix", "AtmTrafficDescrParamIndex", "AtmInterfaceType", "AtmVcIdentifier", "AtmVpIdentifier")
...
mibBuilder.exportSymbols("ATM2-MIB", atmVclStatTotalCellIns=atmVclStatTotalCellIns, atmSigDetectUnavailRoutes=atmSigDetectUnavailRoutes, atmVclStatClp0Discards=atmVclStatClp0Discards, atmSvcVcCrossConnectEntry=atmSvcVcCrossConnectEntry, atmVclStatTotalCellOuts=atmVclStatTotalCellOuts, atmAal5VclStatTable=atmAal5VclStatTable, atmCurrentlyFailingPVplTimeStamp=atmCurrentlyFailingPVplTimeStamp, atmInterfaceCurrentMaxSvccVpi=atmInterfaceCurrentMaxSvccVpi, atmSvcVpCrossConnectHighIfIndex=atmSvcVpCrossConnectHighIfIndex, atmVplStatEntry=atmVplStatEntry, atmIlmiSrvcRegServiceID=atmIlmiSrvcRegServiceID, atmCommonGroup=atmCommonGroup, atmServcGroup=atmServcGroup, atmAal5VclOutPkts=atmAal5VclOutPkts, atmVclAddrRowStatus=atmVclAddrRowStatus, atmVplLogicalPortTable=atmVplLogicalPortTable, atmSvcVcCrossConnectIndex=atmSvcVcCrossConnectIndex, atmSigDetectRestarts=atmSigDetectRestarts, atmSvcVcCrossConnectHighVpi=atmSvcVcCrossConnectHighVpi, atmAddrVclVpi=atmAddrVclVpi, atmCurrentlyFailingPVclTable=atmCurrentlyFailingPVclTable, atmSigDescrParamIndex=atmSigDescrParamIndex, atmVplStatTotalDiscards=atmVplStatTotalDiscards, atmSigSupportTable=atmSigSupportTable, atmSvcVcCrossConnectLowVci=atmSvcVcCrossConnectLowVci, atmSigDescrParamBlliSnapId=atmSigDescrParamBlliSnapId, atmSigStatEntry=atmSigStatEntry, atmVplLogicalPortEntry=atmVplLogicalPortEntry, atmAddrVclVci=atmAddrVclVci, atm2MIBCompliances=atm2MIBCompliances, atmAal5VclOutOctets=atmAal5VclOutOctets, atmSigDetectTimerExpireds=atmSigDetectTimerExpireds, atmSwitchServcNotifGroup=atmSwitchServcNotifGroup, atmVplStatTotalCellIns=atmVplStatTotalCellIns, atmSwitchAddressTable=atmSwitchAddressTable, atmSigDetectMsgErrors=atmSigDetectMsgErrors, atmHostGroup=atmHostGroup, atmVclStatClp0Tagged=atmVclStatClp0Tagged, atmSigDescrParamAalType=atmSigDescrParamAalType, atmSigDescrParamAalSscsType=atmSigDescrParamAalSscsType, atmSvcVpCrossConnectIndex=atmSvcVpCrossConnectIndex, atmVcCrossConnectXTable=atmVcCrossConnectXTable, atmAddrVclAddrType=atmAddrVclAddrType, atmVpCrossConnectProviderName=atmVpCrossConnectProviderName, atm2MIBTraps=atm2MIBTraps, atmSigEmitCldPtyEvents=atmSigEmitCldPtyEvents, atmInterfaceExtTable=atmInterfaceExtTable, atmVplStatTable=atmVplStatTable, atmSvcVpCrossConnectEntry=atmSvcVpCrossConnectEntry, atm2MIB=atm2MIB, atmSigDetectSetupAttempts=atmSigDetectSetupAttempts, atmSwitchAddressRowStatus=atmSwitchAddressRowStatus, atmSwitchGroup=atmSwitchGroup, atmCurrentlyFailingPVclTimeStamp=atmCurrentlyFailingPVclTimeStamp, atmIntfIlmiEstablishConPollIntvl=atmIntfIlmiEstablishConPollIntvl, atmVcCrossConnectXEntry=atmVcCrossConnectXEntry, atmSigEmitClgPtyEvents=atmSigEmitClgPtyEvents, atmIntfCurrentlyFailingPVcls=atmIntfCurrentlyFailingPVcls, atmSvcVpCrossConnectTable=atmSvcVpCrossConnectTable, atmSigDescrParamBlliPktSize=atmSigDescrParamBlliPktSize, atmPvcTraps=atmPvcTraps, atmSigSupportEntry=atmSigSupportEntry, atmSwitchAddressAddress=atmSwitchAddressAddress, atmSvcVcCrossConnectCreationTime=atmSvcVcCrossConnectCreationTime, atmSvcVpCrossConnectCreationTime=atmSvcVpCrossConnectCreationTime, atmSigEmitRestarts=atmSigEmitRestarts, atmSigSupportAALInfo=atmSigSupportAALInfo, atmIfRegAddrAddress=atmIfRegAddrAddress, atmInterfaceConfMaxSvpcVpi=atmInterfaceConfMaxSvpcVpi, atmInterfaceCurrentMaxSvpcVpi=atmInterfaceCurrentMaxSvpcVpi, atmSvcVpCrossConnectLowIfIndex=atmSvcVpCrossConnectLowIfIndex, atmVcCrossConnectProviderName=atmVcCrossConnectProviderName, atmSigDescrParamBhliType=atmSigDescrParamBhliType, atmCurrentlyFailingPVplEntry=atmCurrentlyFailingPVplEntry, atmSigSSCOPConEvents=atmSigSSCOPConEvents, atm2MIBObjects=atm2MIBObjects, atmIntfIlmiAdminStatus=atmIntfIlmiAdminStatus, atmIntfIlmiOperStatus=atmIntfIlmiOperStatus, atmIlmiNetPrefixRowStatus=atmIlmiNetPrefixRowStatus, atmIlmiSrvcRegEntry=atmIlmiSrvcRegEntry, atm2MIBCompliance=atm2MIBCompliance, atmVclGenEntry=atmVclGenEntry, atmSvcVcCrossConnectTable=atmSvcVcCrossConnectTable, atmSwitchAddressIndex=atmSwitchAddressIndex, atmSigEmitUnavailRoutes=atmSigEmitUnavailRoutes, atmVpCrossConnectUserName=atmVpCrossConnectUserName, atmVplLogicalPortDef=atmVplLogicalPortDef, atmVplStatClp0CellOuts=atmVplStatClp0CellOuts, PYSNMP_MODULE_ID=atm2MIB, atmSigSupportHiLyrInfo=atmSigSupportHiLyrInfo, atmIfRegAddrOrgScope=atmIfRegAddrOrgScope, atmVpCrossConnectXEntry=atmVpCrossConnectXEntry, atmSigEmitUnavailResrcs=atmSigEmitUnavailResrcs, atmSigOutEstabls=atmSigOutEstabls, atmVplStatClp0Tagged=atmVplStatClp0Tagged, atmSigEmitMsgErrors=atmSigEmitMsgErrors, atmIfRegAddrRowStatus=atmIfRegAddrRowStatus, atmVplStatTotalCellOuts=atmVplStatTotalCellOuts, atmSvcVcCrossConnectLowVpi=atmSvcVcCrossConnectLowVpi, atmSigSupportCldPtySubAddr=atmSigSupportCldPtySubAddr, atmIntfIlmiCheckConPollIntvl=atmIntfIlmiCheckConPollIntvl, atmVcCrossConnectUserName=atmVcCrossConnectUserName, atmSigDescrParamRowStatus=atmSigDescrParamRowStatus, atmIlmiSrvcRegIndex=atmIlmiSrvcRegIndex, atmSigEmitSetupAttempts=atmSigEmitSetupAttempts, atm2MIBConformance=atm2MIBConformance, atmCommonStatsGroup=atmCommonStatsGroup, atmIlmiSrvcRegParm1=atmIlmiSrvcRegParm1, atmVclStatClp0CellIns=atmVclStatClp0CellIns, atmIntfConfigType=atmIntfConfigType, atmPvcTrapsPrefix=atmPvcTrapsPrefix, atmSvcVcCrossConnectHighVci=atmSvcVcCrossConnectHighVci, atmIfRegisteredAddrTable=atmIfRegisteredAddrTable, atmVclStatClp0CellOuts=atmVclStatClp0CellOuts, atmSigDescrParamBlliLayer2=atmSigDescrParamBlliLayer2, atmSigDescrParamBbcConnConf=atmSigDescrParamBbcConnConf, atmIntfIlmiPublicPrivateIndctr=atmIntfIlmiPublicPrivateIndctr, atmSigSupportLoLyrInfo=atmSigSupportLoLyrInfo, atmIntfActualSide=atmIntfActualSide, atmIntfPvcFailuresTrapEnable=atmIntfPvcFailuresTrapEnable, atmIntfPvcNotificationInterval=atmIntfPvcNotificationInterval, atmHostSigDescrGroup=atmHostSigDescrGroup, atmSigSSCOPErrdPdus=atmSigSSCOPErrdPdus, atmSigDescrParamTable=atmSigDescrParamTable, atmInterfaceConfMinSvccVci=atmInterfaceConfMinSvccVci, atmSigInEstabls=atmSigInEstabls, atmVclAddrAddr=atmVclAddrAddr, atmSvcVcCrossConnectLowIfIndex=atmSvcVcCrossConnectLowIfIndex, atmVclStatEntry=atmVclStatEntry, atmIlmiNetPrefixPrefix=atmIlmiNetPrefixPrefix, atmVclAddrEntry=atmVclAddrEntry, atmIntfCurrentlyFailingPVpls=atmIntfCurrentlyFailingPVpls, atmSigDetectUnavailResrcs=atmSigDetectUnavailResrcs, atmIlmiNetworkPrefixTable=atmIlmiNetworkPrefixTable, atmSigSupportClgPtySubAddr=atmSigSupportClgPtySubAddr, atmIntfIlmiFsmState=atmIntfIlmiFsmState, atmInterfaceCurrentMinSvccVci=atmInterfaceCurrentMinSvccVci, atmIntfActualType=atmIntfActualType, atmIlmiSrvcRegAddressIndex=atmIlmiSrvcRegAddressIndex, atmVpCrossConnectXTable=atmVpCrossConnectXTable, atmIlmiSrvcRegRowStatus=atmIlmiSrvcRegRowStatus, atmAal5VclInOctets=atmAal5VclInOctets, atmAddrVclTable=atmAddrVclTable, atmSigDetectClgPtyEvents=atmSigDetectClgPtyEvents, atmIntfConfigSide=atmIntfConfigSide, atmInterfaceExtEntry=atmInterfaceExtEntry, atmSigDetectCldPtyEvents=atmSigDetectCldPtyEvents, atmIntfLeafSetupRequests=atmIntfLeafSetupRequests, atmSwitchServcSigGroup=atmSwitchServcSigGroup, atmSvcVcCrossConnectHighIfIndex=atmSvcVcCrossConnectHighIfIndex, atmSigSupportBlliRepeatInd=atmSigSupportBlliRepeatInd, atmIntfSigVccTxTrafficDescrIndex=atmIntfSigVccTxTrafficDescrIndex, atmVclGenTable=atmVclGenTable, atmIntfLeafSetupFailures=atmIntfLeafSetupFailures, atmCurrentlyFailingPVclEntry=atmCurrentlyFailingPVclEntry, atmVplStatClp0Discards=atmVplStatClp0Discards, atmSigDescrParamBhliInfo=atmSigDescrParamBhliInfo, atmVplStatClp0CellIns=atmVplStatClp0CellIns, atmIlmiSrvcRegATMAddress=atmIlmiSrvcRegATMAddress, atmCurrentlyFailingPVplTable=atmCurrentlyFailingPVplTable, atmSigStatTable=atmSigStatTable, atmSigEmitTimerExpireds=atmSigEmitTimerExpireds, atmVclAddrTable=atmVclAddrTable, atmAddrVclAtmIfIndex=atmAddrVclAtmIfIndex, atmVclStatTable=atmVclStatTable, atmSigSupportClgPtyNumDel=atmSigSupportClgPtyNumDel, atmVplLogicalPortIndex=atmVplLogicalPortIndex, atmIntfPvcFailures=atmIntfPvcFailures, atmIfRegAddrAddressSource=atmIfRegAddrAddressSource, atmSvcVpCrossConnectLowVpi=atmSvcVpCrossConnectLowVpi, atmIfRegisteredAddrEntry=atmIfRegisteredAddrEntry, atmSwitchServcGroup=atmSwitchServcGroup, atmSvcVpCrossConnectHighVpi=atmSvcVpCrossConnectHighVpi, atmInterfaceConfMaxSvccVpi=atmInterfaceConfMaxSvccVpi, atmIlmiSrvcRegTable=atmIlmiSrvcRegTable, atmIntfPvcFailuresTrap=atmIntfPvcFailuresTrap, atmVclStatTotalDiscards=atmVclStatTotalDiscards, atmIntfSigVccRxTrafficDescrIndex=atmIntfSigVccRxTrafficDescrIndex, atmVclGenSigDescrIndex=atmVclGenSigDescrIndex, atmSvcVpCrossConnectRowStatus=atmSvcVpCrossConnectRowStatus, atmAal5VclStatEntry=atmAal5VclStatEntry, atm2MIBGroups=atm2MIBGroups, atmSvcVcCrossConnectRowStatus=atmSvcVcCrossConnectRowStatus, atmSwitchAddressEntry=atmSwitchAddressEntry, atmSigSupportPrefCarrier=atmSigSupportPrefCarrier, atmSigDescrParamBlliOuiPid=atmSigDescrParamBlliOuiPid, atmSigDescrParamEntry=atmSigDescrParamEntry, atmSigDescrParamBlliLayer3=atmSigDescrParamBlliLayer3, atmIlmiNetworkPrefixEntry=atmIlmiNetworkPrefixEntry, atmIntfIlmiConPollInactFactor=atmIntfIlmiConPollInactFactor, atmAal5VclInPkts=atmAal5VclInPkts, atmAddrVclEntry=atmAddrVclEntry, atmVclAddrType=atmVclAddrType)
