...
atmVcCrossConnectEntry, atmVclVpi, atmVclVci, atmVpCrossConnectEntry, atmVplEntry, atmMIBObjects, atmInterfaceConfEntry, atmVplVpi, atmVclEntry = mibBuilder.importSymbols("ATM-MIB", "atmVcCrossConnectEntry", "atmVclVpi", "atmVclVci", "atmVpCrossConnectEntry", "atmVplEntry", "atmMIBObjects", "atmInterfaceConfEntry", "atmVplVpi", "atmVclEntry")
AtmIlmiNetworkPrefix, AtmTrafficDescrParamIndex, AtmVpIdentifier, AtmInterfaceType, AtmAddr, AtmVcIdentifier, AtmSigDescrParamIndex = mibBuilder.importSymbols("ATM-TC-MIB", "AtmIlmiNetworkPrefix", "AtmTrafficDescrParamIndex", "AtmVpIdentifier", "AtmInterfaceType", "AtmAddr", "AtmVcIdentifier", "AtmSigDescrParamIndex")
...
mibBuilder.exportSymbols("ATM2-MIB", atmSvcVcCrossConnectIndex=atmSvcVcCrossConnectIndex, atmSigDescrParamIndex=atmSigDescrParamIndex, atmSigDescrParamBlliPktSize=atmSigDescrParamBlliPktSize, atmIlmiSrvcRegAddressIndex=atmIlmiSrvcRegAddressIndex, atmVclGenEntry=atmVclGenEntry, atmSvcVcCrossConnectLowVpi=atmSvcVcCrossConnectLowVpi, atm2MIBGroups=atm2MIBGroups, atmSigDescrParamBlliLayer3=atmSigDescrParamBlliLayer3, atm2MIBObjects=atm2MIBObjects, atmSigDescrParamTable=atmSigDescrParamTable, atmIntfCurrentlyFailingPVpls=atmIntfCurrentlyFailingPVpls, atmVclStatTotalCellOuts=atmVclStatTotalCellOuts, atmVclAddrRowStatus=atmVclAddrRowStatus, atmVplStatClp0CellIns=atmVplStatClp0CellIns, atmIfRegAddrOrgScope=atmIfRegAddrOrgScope, atmSvcVcCrossConnectRowStatus=atmSvcVcCrossConnectRowStatus, atmIntfIlmiEstablishConPollIntvl=atmIntfIlmiEstablishConPollIntvl, atmSvcVcCrossConnectHighVpi=atmSvcVcCrossConnectHighVpi, atm2MIB=atm2MIB, atmVplStatTable=atmVplStatTable, atmIntfConfigSide=atmIntfConfigSide, atm2MIBCompliance=atm2MIBCompliance, atmHostGroup=atmHostGroup, atmSigSupportBlliRepeatInd=atmSigSupportBlliRepeatInd, atmSigSupportClgPtyNumDel=atmSigSupportClgPtyNumDel, atmVclAddrTable=atmVclAddrTable, atmIntfActualSide=atmIntfActualSide, atmSvcVpCrossConnectLowIfIndex=atmSvcVpCrossConnectLowIfIndex, atmSvcVcCrossConnectLowIfIndex=atmSvcVcCrossConnectLowIfIndex, atmInterfaceConfMaxSvpcVpi=atmInterfaceConfMaxSvpcVpi, atm2MIBConformance=atm2MIBConformance, atmSigStatEntry=atmSigStatEntry, atmIlmiSrvcRegRowStatus=atmIlmiSrvcRegRowStatus, atmIfRegAddrRowStatus=atmIfRegAddrRowStatus, atmVclGenTable=atmVclGenTable, atmVclStatTotalCellIns=atmVclStatTotalCellIns, atmSigDescrParamAalSscsType=atmSigDescrParamAalSscsType, atmIlmiNetworkPrefixEntry=atmIlmiNetworkPrefixEntry, atmVclStatClp0Tagged=atmVclStatClp0Tagged, atmVplStatClp0CellOuts=atmVplStatClp0CellOuts, atmIlmiSrvcRegServiceID=atmIlmiSrvcRegServiceID, atmSigEmitRestarts=atmSigEmitRestarts, atmCurrentlyFailingPVplTimeStamp=atmCurrentlyFailingPVplTimeStamp, atmServcGroup=atmServcGroup, atmVplStatEntry=atmVplStatEntry, atmSigSupportAALInfo=atmSigSupportAALInfo, atmSigDescrParamBlliSnapId=atmSigDescrParamBlliSnapId, atmSigEmitUnavailResrcs=atmSigEmitUnavailResrcs, atmVclStatTotalDiscards=atmVclStatTotalDiscards, atmVpCrossConnectXTable=atmVpCrossConnectXTable, atmSvcVpCrossConnectRowStatus=atmSvcVpCrossConnectRowStatus, atmVplLogicalPortDef=atmVplLogicalPortDef, atmSwitchServcSigGroup=atmSwitchServcSigGroup, atmSigDetectCldPtyEvents=atmSigDetectCldPtyEvents, atmSvcVcCrossConnectHighVci=atmSvcVcCrossConnectHighVci, atmSvcVcCrossConnectLowVci=atmSvcVcCrossConnectLowVci, atmSvcVpCrossConnectHighVpi=atmSvcVpCrossConnectHighVpi, atmSigDetectRestarts=atmSigDetectRestarts, atmSigDescrParamBlliOuiPid=atmSigDescrParamBlliOuiPid, atmVclStatClp0CellOuts=atmVclStatClp0CellOuts, atmInterfaceCurrentMaxSvpcVpi=atmInterfaceCurrentMaxSvpcVpi, atmSigDetectUnavailRoutes=atmSigDetectUnavailRoutes, atmSigSSCOPConEvents=atmSigSSCOPConEvents, atmIlmiSrvcRegTable=atmIlmiSrvcRegTable, atmSigDetectSetupAttempts=atmSigDetectSetupAttempts, atmSigInEstabls=atmSigInEstabls, atmSwitchAddressTable=atmSwitchAddressTable, atmVclStatClp0Discards=atmVclStatClp0Discards, atmSvcVpCrossConnectCreationTime=atmSvcVpCrossConnectCreationTime, atmVclAddrEntry=atmVclAddrEntry, atmSwitchServcGroup=atmSwitchServcGroup, atmVplStatTotalCellOuts=atmVplStatTotalCellOuts, atmAddrVclTable=atmAddrVclTable, atmCurrentlyFailingPVclTable=atmCurrentlyFailingPVclTable, atmIntfLeafSetupRequests=atmIntfLeafSetupRequests, atmIfRegAddrAddressSource=atmIfRegAddrAddressSource, atmIntfIlmiOperStatus=atmIntfIlmiOperStatus, atmSwitchAddressRowStatus=atmSwitchAddressRowStatus, atmAal5VclStatEntry=atmAal5VclStatEntry, atmIntfIlmiPublicPrivateIndctr=atmIntfIlmiPublicPrivateIndctr, atmVplStatTotalDiscards=atmVplStatTotalDiscards, atmSigSupportEntry=atmSigSupportEntry, atmSigDescrParamBhliInfo=atmSigDescrParamBhliInfo, atmSigDescrParamBbcConnConf=atmSigDescrParamBbcConnConf, atm2MIBCompliances=atm2MIBCompliances, atmVclStatEntry=atmVclStatEntry, atmSigDetectTimerExpireds=atmSigDetectTimerExpireds, atmIntfIlmiAdminStatus=atmIntfIlmiAdminStatus, atmInterfaceExtTable=atmInterfaceExtTable, atmIntfIlmiFsmState=atmIntfIlmiFsmState, atmInterfaceCurrentMinSvccVci=atmInterfaceCurrentMinSvccVci, atmSigDescrParamEntry=atmSigDescrParamEntry, atmPvcTraps=atmPvcTraps, atmAddrVclAddrType=atmAddrVclAddrType, atmSwitchAddressAddress=atmSwitchAddressAddress, atmIlmiSrvcRegIndex=atmIlmiSrvcRegIndex, atmSvcVpCrossConnectLowVpi=atmSvcVpCrossConnectLowVpi, atmVclStatClp0CellIns=atmVclStatClp0CellIns, atmSigSupportPrefCarrier=atmSigSupportPrefCarrier, atmAal5VclInOctets=atmAal5VclInOctets, atmInterfaceConfMaxSvccVpi=atmInterfaceConfMaxSvccVpi, atmIntfSigVccRxTrafficDescrIndex=atmIntfSigVccRxTrafficDescrIndex, atmSigDescrParamAalType=atmSigDescrParamAalType, atmVcCrossConnectProviderName=atmVcCrossConnectProviderName, atmVcCrossConnectUserName=atmVcCrossConnectUserName, atmIntfIlmiCheckConPollIntvl=atmIntfIlmiCheckConPollIntvl, atmSvcVcCrossConnectEntry=atmSvcVcCrossConnectEntry, atmIlmiNetworkPrefixTable=atmIlmiNetworkPrefixTable, atmSigDetectMsgErrors=atmSigDetectMsgErrors, atmSigSupportTable=atmSigSupportTable, atmSigSupportClgPtySubAddr=atmSigSupportClgPtySubAddr, atmVclGenSigDescrIndex=atmVclGenSigDescrIndex, atmAal5VclInPkts=atmAal5VclInPkts, atmHostSigDescrGroup=atmHostSigDescrGroup, atmVcCrossConnectXEntry=atmVcCrossConnectXEntry, atmIntfSigVccTxTrafficDescrIndex=atmIntfSigVccTxTrafficDescrIndex, atmVcCrossConnectXTable=atmVcCrossConnectXTable, atmPvcTrapsPrefix=atmPvcTrapsPrefix, atmIlmiNetPrefixRowStatus=atmIlmiNetPrefixRowStatus, atmSigEmitClgPtyEvents=atmSigEmitClgPtyEvents, atmSigEmitMsgErrors=atmSigEmitMsgErrors, atmIntfIlmiConPollInactFactor=atmIntfIlmiConPollInactFactor, atmVplStatTotalCellIns=atmVplStatTotalCellIns, atmSigSSCOPErrdPdus=atmSigSSCOPErrdPdus, atmIntfActualType=atmIntfActualType, atmSigEmitUnavailRoutes=atmSigEmitUnavailRoutes, atmCurrentlyFailingPVclEntry=atmCurrentlyFailingPVclEntry, atmAddrVclAtmIfIndex=atmAddrVclAtmIfIndex, atmSwitchServcNotifGroup=atmSwitchServcNotifGroup, atmIntfConfigType=atmIntfConfigType, atmSvcVpCrossConnectHighIfIndex=atmSvcVpCrossConnectHighIfIndex, atmIfRegisteredAddrEntry=atmIfRegisteredAddrEntry, atmVclAddrAddr=atmVclAddrAddr, atmVplLogicalPortEntry=atmVplLogicalPortEntry, atmInterfaceCurrentMaxSvccVpi=atmInterfaceCurrentMaxSvccVpi, atmSwitchAddressEntry=atmSwitchAddressEntry, atmSigDescrParamBhliType=atmSigDescrParamBhliType, atmVclAddrType=atmVclAddrType, atmSvcVcCrossConnectCreationTime=atmSvcVcCrossConnectCreationTime, atmSwitchGroup=atmSwitchGroup, atmSigDescrParamBlliLayer2=atmSigDescrParamBlliLayer2, atmSvcVcCrossConnectHighIfIndex=atmSvcVcCrossConnectHighIfIndex, atmIntfLeafSetupFailures=atmIntfLeafSetupFailures, atmAddrVclVpi=atmAddrVclVpi, atmCommonGroup=atmCommonGroup, atmVclStatTable=atmVclStatTable, atmAal5VclOutOctets=atmAal5VclOutOctets, atmSvcVpCrossConnectIndex=atmSvcVpCrossConnectIndex, atmVpCrossConnectProviderName=atmVpCrossConnectProviderName, atmSvcVpCrossConnectTable=atmSvcVpCrossConnectTable, atmAal5VclStatTable=atmAal5VclStatTable, atmIlmiSrvcRegEntry=atmIlmiSrvcRegEntry, atmIntfPvcFailures=atmIntfPvcFailures, atmAddrVclVci=atmAddrVclVci, atmIntfCurrentlyFailingPVcls=atmIntfCurrentlyFailingPVcls, atmIfRegisteredAddrTable=atmIfRegisteredAddrTable, atmSigSupportCldPtySubAddr=atmSigSupportCldPtySubAddr, atmSigDescrParamRowStatus=atmSigDescrParamRowStatus, atmIfRegAddrAddress=atmIfRegAddrAddress, atmVplStatClp0Tagged=atmVplStatClp0Tagged, atmVpCrossConnectUserName=atmVpCrossConnectUserName, atmSigEmitTimerExpireds=atmSigEmitTimerExpireds, atmAddrVclEntry=atmAddrVclEntry, atmSigSupportHiLyrInfo=atmSigSupportHiLyrInfo, atmIntfPvcFailuresTrapEnable=atmIntfPvcFailuresTrapEnable, atmCurrentlyFailingPVplTable=atmCurrentlyFailingPVplTable, atmSigEmitSetupAttempts=atmSigEmitSetupAttempts, atmSigDetectClgPtyEvents=atmSigDetectClgPtyEvents, atmVplLogicalPortIndex=atmVplLogicalPortIndex, atmIlmiSrvcRegATMAddress=atmIlmiSrvcRegATMAddress, atm2MIBTraps=atm2MIBTraps, atmSigOutEstabls=atmSigOutEstabls, atmIlmiSrvcRegParm1=atmIlmiSrvcRegParm1, atmSigEmitCldPtyEvents=atmSigEmitCldPtyEvents, atmInterfaceExtEntry=atmInterfaceExtEntry, atmVplStatClp0Discards=atmVplStatClp0Discards, atmAal5VclOutPkts=atmAal5VclOutPkts, atmInterfaceConfMinSvccVci=atmInterfaceConfMinSvccVci, atmCurrentlyFailingPVplEntry=atmCurrentlyFailingPVplEntry, atmCommonStatsGroup=atmCommonStatsGroup, atmVplLogicalPortTable=atmVplLogicalPortTable, atmSigStatTable=atmSigStatTable, atmIntfPvcNotificationInterval=atmIntfPvcNotificationInterval, atmVpCrossConnectXEntry=atmVpCrossConnectXEntry, PYSNMP_MODULE_ID=atm2MIB, atmSigDetectUnavailResrcs=atmSigDetectUnavailResrcs, atmSvcVcCrossConnectTable=atmSvcVcCrossConnectTable, atmCurrentlyFailingPVclTimeStamp=atmCurrentlyFailingPVclTimeStamp, atmIlmiNetPrefixPrefix=atmIlmiNetPrefixPrefix, atmIntfPvcFailuresTrap=atmIntfPvcFailuresTrap, atmSigSupportLoLyrInfo=atmSigSupportLoLyrInfo, atmSwitchAddressIndex=atmSwitchAddressIndex, atmSvcVpCrossConnectEntry=atmSvcVpCrossConnectEntry)
