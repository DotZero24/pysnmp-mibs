...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HIRSCHMANN-PIM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:55:52 2025
...
_HmPIMInterfaceHelloInterval_Type.__name__ = "Integer32"
...
hmPIMV1MIBCompliance.setObjects(
    ("HIRSCHMANN-PIM-MIB", "hmPIMV1MIBGroup")
)
if mibBuilder.loadTexts:
...
hmPIMSparseV2MIBCompliance.setObjects(
      *(("HIRSCHMANN-PIM-MIB", "hmPIMV2MIBGroup"),
        ("HIRSCHMANN-PIM-MIB", "hmPIMV2CandidateRPMIBGroup"))
)
if mibBuilder.loadTexts:
...
hmPIMDenseV2MIBCompliance.setObjects(
    ("HIRSCHMANN-PIM-MIB", "hmPIMDenseV2MIBGroup")
)
if mibBuilder.loadTexts:
