# SNMP MIB module (FS-MPLS-LDP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/fscom/FS-MPLS-LDP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:13:58 2025
...
fsMplsLdpMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99)
)
if mibBuilder.loadTexts:
    fsMplsLdpMIB.setRevisions(
        ("2011-05-15 00:00",)
    )
...
fsMplsLdpMIBObjects = _FsMplsLdpMIBObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1)
)
_FsMplsLdpObjects_ObjectIdentity = ObjectIdentity
fsMplsLdpObjects = _FsMplsLdpObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1)
)
_FsMplsLdpMplsGernalMibObjects_ObjectIdentity = ObjectIdentity
fsMplsLdpMplsGernalMibObjects = _FsMplsLdpMplsGernalMibObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1)
)
_MplsLdpThreadName_Type = SnmpAdminString
_MplsLdpThreadName_Object = MibScalar
mplsLdpThreadName = _MplsLdpThreadName_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 1),
...
mplsLdpSessionUpCount = _MplsLdpSessionUpCount_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 2),
...
mplsLdpSessionCreatCount = _MplsLdpSessionCreatCount_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 3),
...
mplsLdpSessionDownCount = _MplsLdpSessionDownCount_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 4),
...
mplsLdpSessionDownCauseByInf = _MplsLdpSessionDownCauseByInf_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 5),
...
fsMplsLdpFecTable = _FsMplsLdpFecTable_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6)
)
if mibBuilder.loadTexts:
    fsMplsLdpFecTable.setStatus("current")
_FsMplsLdpFecEntry_Object = MibTableRow
fsMplsLdpFecEntry = _FsMplsLdpFecEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1)
)
fsMplsLdpFecEntry.setIndexNames(
    (0, "FS-MPLS-LDP-MIB", "mplsFecIndex"),
)
if mibBuilder.loadTexts:
    fsMplsLdpFecEntry.setStatus("current")
_MplsFecIndex_Type = Integer32
_MplsFecIndex_Object = MibTableColumn
mplsFecIndex = _MplsFecIndex_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 1),
    _MplsFecIndex_Type()
)
...
mplsFecType = _MplsFecType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 2),
    _MplsFecType_Type()
)
...
mplsFecAddrType = _MplsFecAddrType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 3),
...
mplsFecAddr = _MplsFecAddr_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 4),
    _MplsFecAddr_Type()
)
...
mplsFecAddrPrefixLength = _MplsFecAddrPrefixLength_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 5),
...
mplsFecStatus = _MplsFecStatus_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 6),
    _MplsFecStatus_Type()
)
...
mplsFecLspActivity = _MplsFecLspActivity_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 7),
...
mplsFecLspDisconnect = _MplsFecLspDisconnect_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 8),
...
mplsFecLspDisconnectType = _MplsFecLspDisconnectType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 9),
...
mplsFecSession = _MplsFecSession_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 10),
...
mplsLdpSessionCloseType = _MplsLdpSessionCloseType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 11),
...
mplsFecIngressBytes = _MplsFecIngressBytes_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 12),
...
mplsFecIngressPackets = _MplsFecIngressPackets_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 13),
...
mplsFecTransmitBytes = _MplsFecTransmitBytes_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 14),
...
mplsFecTransmitPackets = _MplsFecTransmitPackets_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 1, 6, 1, 15),
...
fsMplsLdpConfigMibObjects = _FsMplsLdpConfigMibObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 1, 2)
)
_FsMplsLdpConformance_ObjectIdentity = ObjectIdentity
fsMplsLdpConformance = _FsMplsLdpConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 99, 1, 2)
)
...
mibBuilder.exportSymbols(
    "FS-MPLS-LDP-MIB",
    **{"fsMplsLdpMIB": fsMplsLdpMIB,
       "fsMplsLdpMIBObjects": fsMplsLdpMIBObjects,
       "fsMplsLdpObjects": fsMplsLdpObjects,
       "fsMplsLdpMplsGernalMibObjects": fsMplsLdpMplsGernalMibObjects,
       ...
       "fsMplsLdpFecTable": fsMplsLdpFecTable,
       "fsMplsLdpFecEntry": fsMplsLdpFecEntry,
       ...
       "fsMplsLdpConfigMibObjects": fsMplsLdpConfigMibObjects,
       "fsMplsLdpConformance": fsMplsLdpConformance}
)
