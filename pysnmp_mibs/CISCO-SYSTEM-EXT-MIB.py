...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-SYSTEM-EXT-MIB
...
ciscoSystemSwitchingMode = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 305, 1, 6, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("cutThrough", 1), ("storeAndForward", 2)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: ciscoSystemSwitchingMode.setStatus('current')
...
ciscoSystemSwitchingModeObjectsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 305, 2, 2, 18)).setObjects(("CISCO-SYSTEM-EXT-MIB", "ciscoSystemSwitchingModeAdmin"), ("CISCO-SYSTEM-EXT-MIB", "ciscoSystemSwitchingModeOper"), ("CISCO-SYSTEM-EXT-MIB", "ciscoSystemSwitchingMode"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
mibBuilder.exportSymbols("CISCO-SYSTEM-EXT-MIB", ciscoSystemExtNotificationGroupSup1=ciscoSystemExtNotificationGroupSup1, cseSwCoresFileName=cseSwCoresFileName, ciscoSystemExtInfoGroup=ciscoSystemExtInfoGroup, ciscoSystemNormalModeNotifEnable=ciscoSystemNormalModeNotifEnable, cseSwCoresModule=cseSwCoresModule, cseSnmpErrorAddressType=cseSnmpErrorAddressType, ciscoSystemMaintModeNotifControl=ciscoSystemMaintModeNotifControl, cseSnmpErrorTable=cseSnmpErrorTable, ciscoHaGroup=ciscoHaGroup, ciscoSystemMaintModeObjectsGroup=ciscoSystemMaintModeObjectsGroup, cseSwCoresTimeCreated=cseSwCoresTimeCreated, cseMaintModeChangeNotify=cseMaintModeChangeNotify, ciscoSystemExtHaGroupRev1=ciscoSystemExtHaGroupRev1, cseMaintModeNotificationPrefix=cseMaintModeNotificationPrefix, ciscoSystemExtInfoGroupRev2=ciscoSystemExtInfoGroupRev2, cseSysTelnetServiceActivation=cseSysTelnetServiceActivation, cseHaRestartStateless=cseHaRestartStateless, ciscoSystemExtInfoGroupRev1=ciscoSystemExtInfoGroupRev1, ciscoSystemExtInfoGroupRev3=ciscoSystemExtInfoGroupRev3, ciscoSystemSwitchingModeGroup=ciscoSystemSwitchingModeGroup, ciscoSystemExtMIBConformance=ciscoSystemExtMIBConformance, CseHaRestartReason=CseHaRestartReason, cseHaShutDownReason=cseHaShutDownReason, cseFailNotification=cseFailNotification, cseSnmpErrorEntry=cseSnmpErrorEntry, cseSnmpErrorDescription=cseSnmpErrorDescription, ciscoSystemMaintModeNotificationGroup=ciscoSystemMaintModeNotificationGroup, CiscoMaintModeState=CiscoMaintModeState, ciscoSystemReloadGroup=ciscoSystemReloadGroup, cseHaRestartReason=cseHaRestartReason, cseSwCoresProcName=cseSwCoresProcName, ciscoSystemExtMIBComplianceRev10=ciscoSystemExtMIBComplianceRev10, cseSysConsolePortStatus=cseSysConsolePortStatus, ciscoSystemExtMIBComplianceRev5=ciscoSystemExtMIBComplianceRev5, ciscoSystemExtInfoTelnetGroup=ciscoSystemExtInfoTelnetGroup, cseSysUpTime=cseSysUpTime, ciscoSystemExtMIB=ciscoSystemExtMIB, cseSysAutoSync=cseSysAutoSync, ciscoSystemExtMIBComplianceRev7=ciscoSystemExtMIBComplianceRev7, cseSysConfLastChange=cseSysConfLastChange, ciscoSystemSwitchingMode=ciscoSystemSwitchingMode, ciscoSysErrorGroup=ciscoSysErrorGroup, ciscoSwFailureNotifControl=ciscoSwFailureNotifControl, ciscoSystemExtErrorGroup=ciscoSystemExtErrorGroup, ciscoSystemSwitchingModeAdmin=ciscoSystemSwitchingModeAdmin, ciscoSystemExtMIBObjects=ciscoSystemExtMIBObjects, ciscoSystemExtSwFailureGroup3=ciscoSystemExtSwFailureGroup3, cseSysMemoryUtilization=cseSysMemoryUtilization, cseFailSwCoreNotify=cseFailSwCoreNotify, ciscoSystemExtInfoGroupOptional=ciscoSystemExtInfoGroupOptional, ciscoSystemExtSwFailureControlGroup=ciscoSystemExtSwFailureControlGroup, cseFailNotificationPrefix=cseFailNotificationPrefix, ciscoSystemExtMIBComplianceRev4=ciscoSystemExtMIBComplianceRev4, PYSNMP_MODULE_ID=ciscoSystemExtMIB, ciscoSystemExtMIBComplianceRev8=ciscoSystemExtMIBComplianceRev8, cseSwCoresPID=cseSwCoresPID, ciscoSystemExtMIBComplianceRev3=ciscoSystemExtMIBComplianceRev3, ciscoSystemExtMIBGroups=ciscoSystemExtMIBGroups, cseSysCPUUtilization=cseSysCPUUtilization, cseSwCorePath=cseSwCorePath, cseHaNotificationPrefix=cseHaNotificationPrefix, cseSwCoresInstance=cseSwCoresInstance, ciscoSystemExtInfoFIPSGroup=ciscoSystemExtInfoFIPSGroup, cseFailSwCoreNotifyExtended=cseFailSwCoreNotifyExtended, cseSwCoresTable=cseSwCoresTable, ciscoSystemExtHaGroup=ciscoSystemExtHaGroup, cseHaNotification=cseHaNotification, cseSwCoresEntry=cseSwCoresEntry, ciscoSystemExtMIBComplianceRev9=ciscoSystemExtMIBComplianceRev9, ciscoSystemReloadObjectsGroup=ciscoSystemReloadObjectsGroup, ciscoSystemSwitchingModeObjectsGroup=ciscoSystemSwitchingModeObjectsGroup, cseSysAutoSyncState=cseSysAutoSyncState, ciscoSystemExtSwFailureGroup2=ciscoSystemExtSwFailureGroup2, ciscoSystemMaintModeGroup=ciscoSystemMaintModeGroup, cseNormalModeChangeNotify=cseNormalModeChangeNotify, cseSystemReloadPending=cseSystemReloadPending, cseMaintModeNotification=cseMaintModeNotification, cseShutDownNotify=cseShutDownNotify, ciscoSystemExtMIBCompliance=ciscoSystemExtMIBCompliance, ciscoSysInfoGroup=ciscoSysInfoGroup, ciscoSystemExtSwFailureGroup=ciscoSystemExtSwFailureGroup, ciscoSystemSwitchingModeOper=ciscoSystemSwitchingModeOper, cseSnmpErrorCode=cseSnmpErrorCode, cseWriteErase=cseWriteErase, ciscoSwFailureNotifEnable=ciscoSwFailureNotifEnable, ciscoSystemExtNotificationGroupSup2=ciscoSystemExtNotificationGroupSup2, ciscoSystemExtMIBComplianceRev2=ciscoSystemExtMIBComplianceRev2, ciscoSystemExtMIBComplianceRev1=ciscoSystemExtMIBComplianceRev1, cseHaRestartNotify=cseHaRestartNotify, cseSnmpErrorAddress=cseSnmpErrorAddress, ciscoSystemExtMIBCompliances=ciscoSystemExtMIBCompliances, ciscoSwFailureGroup=ciscoSwFailureGroup, cseSnmpErrorRequestId=cseSnmpErrorRequestId, ciscoSystemExtNotificationGroup=ciscoSystemExtNotificationGroup, cseSysFIPSModeActivation=cseSysFIPSModeActivation, ciscoSystemMaintModeNotifEnable=ciscoSystemMaintModeNotifEnable, cseSwCoresSlotNum=cseSwCoresSlotNum, ciscoSystemExtMIBComplianceRev6=ciscoSystemExtMIBComplianceRev6, cseMaintModeState=cseMaintModeState, cseHaRestartService=cseHaRestartService, ciscoSystemExtMIBNotifsPrefix=ciscoSystemExtMIBNotifsPrefix)
