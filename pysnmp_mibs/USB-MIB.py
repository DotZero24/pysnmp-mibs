...
# Notes
# -----
# ASN.1 source file://mibs/rfc/USB-MIB
...
usbMibBasicCompliance.setObjects(
      *(("USB-MIB", "usbMibBasicGroup"),
        ("USB-MIB", "usbMibBasicGroup"),
        ("USB-MIB", "usbMibCDCGroup"),
        ("USB-MIB", "usbMibCDCEtherGroup"),
        ("USB-MIB", "usbCDCEtherXmtAddressGroup"))
)
if mibBuilder.loadTexts:
