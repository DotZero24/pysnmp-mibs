...
# Notes
# -----
# ASN.1 source file://mibs/nortel/BAYSTACK-IPV6-FIRST-HOP-SEC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:18:37 2025
...
_BsIpv6FHSAdmin_Type.__name__ = "TruthValue"
...
_BsIpv6FHSRagAdmin_Type.__name__ = "TruthValue"
...
_BsIpv6FHSDhcpv6gAdmin_Type.__name__ = "TruthValue"
...
_BsIpv6FHSNdInspectAdmin_Type.__name__ = "TruthValue"
...
_BsIpv6FHSIpv6AccessListAccessType_Type.__name__ = "FhsAccessType"
...
_BsIpv6FHSMacAccessListAccessType_Type.__name__ = "FhsAccessType"
...
_BsIpv6FHSPolicyPortMapNDAdmin_Type.__name__ = "TruthValue"
...
_BsIpv6FHSPolicyPortMapSbtDynLearnAdmin_Type.__name__ = "TruthValue"
...
_BsIpv6FHSPolicyPortMapClearDhcpGuardStats_Type.__name__ = "TruthValue"
...
_BsIpv6FHSPolicyPortMapClearRaGuardStats_Type.__name__ = "TruthValue"
...
_BsIpv6FHSPolicyPortMapClearNDInspectStats_Type.__name__ = "TruthValue"
...
class _BsIpv6FHSPolicyPortMapDhcpv6gDeviceRole_Type(FhsDhcpv6GuardDeviceRole):
    """Custom type bsIpv6FHSPolicyPortMapDhcpv6gDeviceRole based on FhsDhcpv6GuardDeviceRole"""
    defaultValue = 1


_BsIpv6FHSPolicyPortMapDhcpv6gDeviceRole_Type.__name__ = "FhsDhcpv6GuardDeviceRole"
_BsIpv6FHSPolicyPortMapDhcpv6gDeviceRole_Object = MibTableColumn
bsIpv6FHSPolicyPortMapDhcpv6gDeviceRole = _BsIpv6FHSPolicyPortMapDhcpv6gDeviceRole_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 4, 1, 16),
    _BsIpv6FHSPolicyPortMapDhcpv6gDeviceRole_Type()
)
bsIpv6FHSPolicyPortMapDhcpv6gDeviceRole.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    bsIpv6FHSPolicyPortMapDhcpv6gDeviceRole.setStatus("current")


class _BsIpv6FHSPolicyPortMapRagDeviceRole_Type(FhsRaGuardDeviceRole):
    """Custom type bsIpv6FHSPolicyPortMapRagDeviceRole based on FhsRaGuardDeviceRole"""
    defaultValue = 1


_BsIpv6FHSPolicyPortMapRagDeviceRole_Type.__name__ = "FhsRaGuardDeviceRole"
_BsIpv6FHSPolicyPortMapRagDeviceRole_Object = MibTableColumn
bsIpv6FHSPolicyPortMapRagDeviceRole = _BsIpv6FHSPolicyPortMapRagDeviceRole_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 4, 1, 17),
    _BsIpv6FHSPolicyPortMapRagDeviceRole_Type()
)
bsIpv6FHSPolicyPortMapRagDeviceRole.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    bsIpv6FHSPolicyPortMapRagDeviceRole.setStatus("current")
...
_BsIpv6FHSRagDeviceRole_Type.__name__ = "FhsRaGuardDeviceRole"
...
_BsIpv6FHSRagRouterPrefMax_Type.__name__ = "FhsRaRouterPrefMax"
...
if mibBuilder.loadTexts:
    bsIpv6NDInspectionNotificationClientMACAddr.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    bsIpv6NDInspectionNotificationMsgType.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    bsIpv6FHSNDInterfaceIndex.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    bsIpv6FHSNDIpv6Address.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    bsIpv6FHSNDVlanID.setStatus("obsolete")
...
_BsIpv6FHSSourceGuardInterfaceState_Type.__name__ = "TruthValue"
...
bsIpv6FHSSourceGuardDropCount = _BsIpv6FHSSourceGuardDropCount_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 9, 1, 6),
    _BsIpv6FHSSourceGuardDropCount_Type()
)
bsIpv6FHSSourceGuardDropCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bsIpv6FHSSourceGuardDropCount.setStatus("current")
_BsIpv6FHSSourceGuardClearDropCount_Type = TruthValue
_BsIpv6FHSSourceGuardClearDropCount_Object = MibTableColumn
bsIpv6FHSSourceGuardClearDropCount = _BsIpv6FHSSourceGuardClearDropCount_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 9, 1, 7),
    _BsIpv6FHSSourceGuardClearDropCount_Type()
)
bsIpv6FHSSourceGuardClearDropCount.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    bsIpv6FHSSourceGuardClearDropCount.setStatus("current")
...
bsIpv6FHSTrapNotificationObjects = _BsIpv6FHSTrapNotificationObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 11)
)
_BsIpv6FHSTrapClientMACAddr_Type = MacAddress
_BsIpv6FHSTrapClientMACAddr_Object = MibScalar
bsIpv6FHSTrapClientMACAddr = _BsIpv6FHSTrapClientMACAddr_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 11, 1),
    _BsIpv6FHSTrapClientMACAddr_Type()
)
bsIpv6FHSTrapClientMACAddr.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    bsIpv6FHSTrapClientMACAddr.setStatus("current")
_BsIpv6FHSTrapInterfaceIndex_Type = InterfaceIndex
_BsIpv6FHSTrapInterfaceIndex_Object = MibScalar
bsIpv6FHSTrapInterfaceIndex = _BsIpv6FHSTrapInterfaceIndex_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 11, 2),
    _BsIpv6FHSTrapInterfaceIndex_Type()
)
bsIpv6FHSTrapInterfaceIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    bsIpv6FHSTrapInterfaceIndex.setStatus("current")
_BsIpv6FHSTrapClientIpv6Address_Type = Ipv6Address
_BsIpv6FHSTrapClientIpv6Address_Object = MibScalar
bsIpv6FHSTrapClientIpv6Address = _BsIpv6FHSTrapClientIpv6Address_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 11, 3),
    _BsIpv6FHSTrapClientIpv6Address_Type()
)
bsIpv6FHSTrapClientIpv6Address.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    bsIpv6FHSTrapClientIpv6Address.setStatus("current")


class _BsIpv6FHSTrapVlanID_Type(Integer32):
    """Custom type bsIpv6FHSTrapVlanID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4094),
    )
...
_BsIpv6FHSTrapVlanID_Type.__name__ = "Integer32"
_BsIpv6FHSTrapVlanID_Object = MibScalar
bsIpv6FHSTrapVlanID = _BsIpv6FHSTrapVlanID_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 11, 4),
    _BsIpv6FHSTrapVlanID_Type()
)
bsIpv6FHSTrapVlanID.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    bsIpv6FHSTrapVlanID.setStatus("current")


class _BsIpv6FHSTrapMsgType_Type(Integer32):
    """Custom type bsIpv6FHSTrapMsgType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_BsIpv6FHSTrapMsgType_Type.__name__ = "Integer32"
_BsIpv6FHSTrapMsgType_Object = MibScalar
bsIpv6FHSTrapMsgType = _BsIpv6FHSTrapMsgType_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 11, 5),
    _BsIpv6FHSTrapMsgType_Type()
)
bsIpv6FHSTrapMsgType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    bsIpv6FHSTrapMsgType.setStatus("current")


class _BsIpv6FhsTrapPktDropReason_Type(Integer32):
    """Custom type bsIpv6FhsTrapPktDropReason based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_BsIpv6FhsTrapPktDropReason_Type.__name__ = "Integer32"
_BsIpv6FhsTrapPktDropReason_Object = MibScalar
bsIpv6FhsTrapPktDropReason = _BsIpv6FhsTrapPktDropReason_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 1, 11, 6),
    _BsIpv6FhsTrapPktDropReason_Type()
)
bsIpv6FhsTrapPktDropReason.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    bsIpv6FhsTrapPktDropReason.setStatus("current")
...
bsIpv6NDNotificationSBTTableFull = NotificationType(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 0, 3)
)
bsIpv6NDNotificationSBTTableFull.setObjects(
      *(("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapClientMACAddr"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapClientIpv6Address"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapMsgType"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapInterfaceIndex"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapVlanID"))
)
if mibBuilder.loadTexts:
    bsIpv6NDNotificationSBTTableFull.setStatus(
        "current"
    )

bsIpv6NDNotificationUntrustedPort = NotificationType(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 0, 4)
)
bsIpv6NDNotificationUntrustedPort.setObjects(
      *(("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapClientMACAddr"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapClientIpv6Address"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapMsgType"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapInterfaceIndex"),
...
if mibBuilder.loadTexts:
    bsIpv6NDNotificationUntrustedPort.setStatus(
        "current"
    )

bsIpv6RAGuardNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 0, 5)
)
bsIpv6RAGuardNotification.setObjects(
      *(("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapClientMACAddr"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapClientIpv6Address"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapMsgType"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapInterfaceIndex"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapVlanID"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FhsTrapPktDropReason"))
)
if mibBuilder.loadTexts:
    bsIpv6RAGuardNotification.setStatus(
        "current"
    )

bsIpv6DHCPGuardNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 45, 5, 45, 0, 6)
)
bsIpv6DHCPGuardNotification.setObjects(
      *(("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapClientMACAddr"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapClientIpv6Address"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapMsgType"),
        ("BAYSTACK-IPV6-FIRST-HOP-SEC-MIB", "bsIpv6FHSTrapInterfaceIndex"),
...
if mibBuilder.loadTexts:
    bsIpv6DHCPGuardNotification.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"FhsRaGuardDeviceRole": FhsRaGuardDeviceRole,
       ...
       "bsIpv6NDNotificationSBTTableFull": bsIpv6NDNotificationSBTTableFull,
       "bsIpv6NDNotificationUntrustedPort": bsIpv6NDNotificationUntrustedPort,
       "bsIpv6RAGuardNotification": bsIpv6RAGuardNotification,
       "bsIpv6DHCPGuardNotification": bsIpv6DHCPGuardNotification,
       ...
       "bsIpv6FHSPolicyPortMapDhcpv6gDeviceRole": bsIpv6FHSPolicyPortMapDhcpv6gDeviceRole,
       "bsIpv6FHSPolicyPortMapRagDeviceRole": bsIpv6FHSPolicyPortMapRagDeviceRole,
       ...
       "bsIpv6FHSSourceGuardDropCount": bsIpv6FHSSourceGuardDropCount,
       "bsIpv6FHSSourceGuardClearDropCount": bsIpv6FHSSourceGuardClearDropCount,
       ...
       "bsIpv6FHSTrapNotificationObjects": bsIpv6FHSTrapNotificationObjects,
       "bsIpv6FHSTrapClientMACAddr": bsIpv6FHSTrapClientMACAddr,
       "bsIpv6FHSTrapInterfaceIndex": bsIpv6FHSTrapInterfaceIndex,
       "bsIpv6FHSTrapClientIpv6Address": bsIpv6FHSTrapClientIpv6Address,
       "bsIpv6FHSTrapVlanID": bsIpv6FHSTrapVlanID,
       "bsIpv6FHSTrapMsgType": bsIpv6FHSTrapMsgType,
       "bsIpv6FhsTrapPktDropReason": bsIpv6FhsTrapPktDropReason}
)
