...
mibBuilder.exportSymbols("HUAWEI-VO-ANALOG-IF-MIB", hwVoAnalogIfEMTimerSendWink=hwVoAnalogIfEMTimerSendWink, hwVoAnalogIfEMTimerWinkRising=hwVoAnalogIfEMTimerWinkRising, hwVoAnalogIfEMConfigPhyType=hwVoAnalogIfEMConfigPhyType, hwVoAnalogIfEMTimerDialoutDelay=hwVoAnalogIfEMTimerDialoutDelay, hwVoAnalogIfEMTimerRising=hwVoAnalogIfEMTimerRising, hwVoAnalogIfEMTimerEntry=hwVoAnalogIfEMTimerEntry, hwVoAnalogIfCommonConfigTable=hwVoAnalogIfCommonConfigTable, hwVoAnalogIfCommonObjects=hwVoAnalogIfCommonObjects, hwVoAnalogIfFXSTimerDtmf=hwVoAnalogIfFXSTimerDtmf, hwVoAnalogIfFXOConfigPortNumber=hwVoAnalogIfFXOConfigPortNumber, hwVoAnalogIfFXOTimerDtmfInterval=hwVoAnalogIfFXOTimerDtmfInterval, hwVoAnalogIfFXOTimerDtmf=hwVoAnalogIfFXOTimerDtmf, hwVoAnalogIfFXSConfigPortNumber=hwVoAnalogIfFXSConfigPortNumber, hwVoAnalogIfEMConfigSignalMode=hwVoAnalogIfEMConfigSignalMode, hwVoAnalogIfEMTimerPortNumber=hwVoAnalogIfEMTimerPortNumber, hwVoAnalogIfEMConfigPhyParm=hwVoAnalogIfEMConfigPhyParm, hwVoAnalogIfFXSConfigEntry=hwVoAnalogIfFXSConfigEntry, hwVoAnalogIfFXOConfigEntry=hwVoAnalogIfFXOConfigEntry, PYSNMP_MODULE_ID=hwVoiceAnalogInterfaceMIB, hwVoAnalogIfFXSConfigTable=hwVoAnalogIfFXSConfigTable, hwVoAnalogIfEMConfigPortNumber=hwVoAnalogIfEMConfigPortNumber, hwVoAnalogIfCommonConfigEntry=hwVoAnalogIfCommonConfigEntry, hwVoAnalogIfFXOPreDialDelay=hwVoAnalogIfFXOPreDialDelay, hwVoAnalogIfEMConfigTable=hwVoAnalogIfEMConfigTable, hwVoAnalogIfEMConfigTimeoutRinging=hwVoAnalogIfEMConfigTimeoutRinging, hwVoAnalogIfEMTimerHold=hwVoAnalogIfEMTimerHold, hwVoAnalogIfFXOConfigTable=hwVoAnalogIfFXOConfigTable, hwVoAnalogIfFXSConfigStartMode=hwVoAnalogIfFXSConfigStartMode, hwVoAnalogIfFXOConfigArea=hwVoAnalogIfFXOConfigArea, hwVoAnalogIfFXOTimerEntry=hwVoAnalogIfFXOTimerEntry, hwVoAnalogIfConfigCallDisconnect=hwVoAnalogIfConfigCallDisconnect, hwVoAnalogIfFXSTimerDtmfInterval=hwVoAnalogIfFXSTimerDtmfInterval, hwVoAnalogIfFXSTimerTable=hwVoAnalogIfFXSTimerTable, hwVoAnalogIfFXOTimerPortNumber=hwVoAnalogIfFXOTimerPortNumber, hwVoAnalogIfEMObjects=hwVoAnalogIfEMObjects, hwVoAnalogIfFXSTimerEntry=hwVoAnalogIfFXSTimerEntry, hwVoAnaloglfFXOConfigPortImpedance=hwVoAnaloglfFXOConfigPortImpedance, hwVoAnalogIfConfigPortType=hwVoAnalogIfConfigPortType, hwVoAnalogIfEMTimerWinkHold=hwVoAnalogIfEMTimerWinkHold, hwVoAnalogIfFXSObjects=hwVoAnalogIfFXSObjects, hwVoAnalogIfFXOConfigStartMode=hwVoAnalogIfFXOConfigStartMode, hwVoAnalogIfEMTimerTable=hwVoAnalogIfEMTimerTable, hwVoAnalogIfEMTimerDtmf=hwVoAnalogIfEMTimerDtmf, hwVoAnalogIfFXOTimerTable=hwVoAnalogIfFXOTimerTable, hwVoAnalogIfEMTimerDtmfInterval=hwVoAnalogIfEMTimerDtmfInterval, hwVoAnalogIfFXOConfigAlertNumber=hwVoAnalogIfFXOConfigAlertNumber, hwVoAnalogIfEMConfigEntry=hwVoAnalogIfEMConfigEntry, hwVoAnalogIfFXSTimerPortNumber=hwVoAnalogIfFXSTimerPortNumber, hwVoAnalogIfEMConfigTimeoutWaitDigit=hwVoAnalogIfEMConfigTimeoutWaitDigit, hwVoAnalogIfEMTimerCallInterval=hwVoAnalogIfEMTimerCallInterval, hwVoAnalogIfConfigInitialDigitTimeOut=hwVoAnalogIfConfigInitialDigitTimeOut, hwVoAnalogIfConfigPortNumber=hwVoAnalogIfConfigPortNumber, hwVoiceAnalogInterfaceMIB=hwVoiceAnalogInterfaceMIB, hwVoAnalogIfFXOObjects=hwVoAnalogIfFXOObjects, hwVoAnaloglfConfigPortImpedance=hwVoAnaloglfConfigPortImpedance, hwVoAnalogIfConfigInterDigitTimeOut=hwVoAnalogIfConfigInterDigitTimeOut)
