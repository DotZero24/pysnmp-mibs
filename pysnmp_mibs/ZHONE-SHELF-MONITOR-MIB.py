...
zhoneSlotIndex, zhoneShelfIndex, zhoneModules, zhoneShelf = mibBuilder.importSymbols("Zhone", "zhoneSlotIndex", "zhoneShelfIndex", "zhoneModules", "zhoneShelf")
...
mibBuilder.exportSymbols("ZHONE-SHELF-MONITOR-MIB", shelfBPowerStatus=shelfBPowerStatus, cardAdminResets=cardAdminResets, shelfFanLocation=shelfFanLocation, shelfCardTable=shelfCardTable, shelfFanTrayStatus=shelfFanTrayStatus, shelfTemperatureIndex=shelfTemperatureIndex, cardCLEICode=cardCLEICode, cardSerialNumber=cardSerialNumber, zhoneCardLinkToBkplaneStatus=zhoneCardLinkToBkplaneStatus, shelfAdminResets=shelfAdminResets, zhoneShelfStatusLastChange=zhoneShelfStatusLastChange, zhoneTrapCardToBkplaneStatusChange=zhoneTrapCardToBkplaneStatusChange, cardFaultResets=cardFaultResets, shelfFeatureBits=shelfFeatureBits, shelfPowerResets=shelfPowerResets, shelfFanTable=shelfFanTable, shelfMonitorRevisionCode=shelfMonitorRevisionCode, shelfTemperatureStatus=shelfTemperatureStatus, zhoneStatusLastChangeGroup=zhoneStatusLastChangeGroup, shelfMfgCLEICode=shelfMfgCLEICode, shelfIOAlarmBoardPresent=shelfIOAlarmBoardPresent, zhoneShelfStatusGroup=zhoneShelfStatusGroup, shelfDPowerStatus=shelfDPowerStatus, cardState=cardState, zhoneTrapCardVersionCheck=zhoneTrapCardVersionCheck, shelfFanTrayRevisionCode=shelfFanTrayRevisionCode, zhoneCardStatusGroup=zhoneCardStatusGroup, shelfChassisReturnVoltage=shelfChassisReturnVoltage, shelfFanIndex=shelfFanIndex, shelfTemperatureLowThreshold=shelfTemperatureLowThreshold, shelfFanEntry=shelfFanEntry, cardType=cardType, cardReboot=cardReboot, zhoneTrapShelfMonitorGroup=zhoneTrapShelfMonitorGroup, cardVersion=cardVersion, shelfLedStatus=shelfLedStatus, shelfFanTrayType=shelfFanTrayType, zhoneFlashCardStatusChange=zhoneFlashCardStatusChange, shelfAlarmContactsStatus=shelfAlarmContactsStatus, PYSNMP_MODULE_ID=zhoneShelfMonitorModule, shelfFanLowSpeedThreshold=shelfFanLowSpeedThreshold, zhoneCardStatus=zhoneCardStatus, cardFeatureBits=cardFeatureBits, shelfAPowerStatus=shelfAPowerStatus, zhoneTrapFlashCardStatusChange=zhoneTrapFlashCardStatusChange, zhoneCardStatusLastChange=zhoneCardStatusLastChange, zhoneTrapShelfStatusChange=zhoneTrapShelfStatusChange, shelfTemperatureHighThreshold=shelfTemperatureHighThreshold, cardSubType=cardSubType, shelfSlotCount=shelfSlotCount, shelfCardStatus=shelfCardStatus, shelfBatteryAVoltage=shelfBatteryAVoltage, shelfBatteryBVoltage=shelfBatteryBVoltage, shelfFaultResets=shelfFaultResets, cardLineType=cardLineType, shelfDataEntry=shelfDataEntry, shelfFanSpeed=shelfFanSpeed, zhoneTrapCardStatusChange=zhoneTrapCardStatusChange, shelfBkplaneRevisionCode=shelfBkplaneRevisionCode, shelfFanTraySerialNumber=shelfFanTraySerialNumber, shelfStatusTable=shelfStatusTable, shelfTemperatureEntry=shelfTemperatureEntry, shelfTemperature=shelfTemperature, zhoneShelfMonitorModule=zhoneShelfMonitorModule, cardEepromVersion=cardEepromVersion, zhoneShelfStatus=zhoneShelfStatus, shelfTemperatureLocation=shelfTemperatureLocation, shelfMonitorSerialNumber=shelfMonitorSerialNumber, shelfDataTable=shelfDataTable, shelfCardEntry=shelfCardEntry, shelfStatusEntry=shelfStatusEntry, zhoneTrapShelfMonitorV2Traps=zhoneTrapShelfMonitorV2Traps, shelfBkplaneSerialNumber=shelfBkplaneSerialNumber, shelfTemperatureTable=shelfTemperatureTable, shelfCPowerStatus=shelfCPowerStatus)
