...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/zhone/ZHONE-SHELF-MONITOR-MIB
...
zhoneModules, zhoneSlotIndex, zhoneShelfIndex, zhoneShelf = mibBuilder.importSymbols("Zhone", "zhoneModules", "zhoneSlotIndex", "zhoneShelfIndex", "zhoneShelf")
ZhoneCardLineType, ZhoneCardType, ZhoneAdminString = mibBuilder.importSymbols("Zhone-TC", "ZhoneCardLineType", "ZhoneCardType", "ZhoneAdminString")
...
mibBuilder.exportSymbols("ZHONE-SHELF-MONITOR-MIB", shelfFanIndex=shelfFanIndex, cardLineType=cardLineType, shelfCardEntry=shelfCardEntry, shelfIOAlarmBoardPresent=shelfIOAlarmBoardPresent, shelfTemperatureHighThreshold=shelfTemperatureHighThreshold, shelfAlarmContactsStatus=shelfAlarmContactsStatus, shelfDPowerStatus=shelfDPowerStatus, zhoneTrapCardToBkplaneStatusChange=zhoneTrapCardToBkplaneStatusChange, zhoneCardStatusLastChange=zhoneCardStatusLastChange, shelfFeatureBits=shelfFeatureBits, zhoneCardStatus=zhoneCardStatus, cardFeatureBits=cardFeatureBits, cardState=cardState, cardFaultResets=cardFaultResets, zhoneCardLinkToBkplaneStatus=zhoneCardLinkToBkplaneStatus, shelfSlotCount=shelfSlotCount, shelfBkplaneRevisionCode=shelfBkplaneRevisionCode, shelfFanTrayType=shelfFanTrayType, shelfFanTrayRevisionCode=shelfFanTrayRevisionCode, shelfMonitorRevisionCode=shelfMonitorRevisionCode, shelfFanEntry=shelfFanEntry, cardType=cardType, cardSubType=cardSubType, shelfBatteryAVoltage=shelfBatteryAVoltage, shelfMfgCLEICode=shelfMfgCLEICode, shelfCardStatus=shelfCardStatus, shelfFaultResets=shelfFaultResets, zhoneShelfStatusLastChange=zhoneShelfStatusLastChange, shelfLedStatus=shelfLedStatus, shelfFanSpeed=shelfFanSpeed, shelfStatusEntry=shelfStatusEntry, zhoneShelfMonitorModule=zhoneShelfMonitorModule, shelfCPowerStatus=shelfCPowerStatus, zhoneShelfStatus=zhoneShelfStatus, shelfTemperatureLowThreshold=shelfTemperatureLowThreshold, shelfFanLowSpeedThreshold=shelfFanLowSpeedThreshold, zhoneTrapShelfStatusChange=zhoneTrapShelfStatusChange, zhoneTrapShelfMonitorGroup=zhoneTrapShelfMonitorGroup, shelfTemperature=shelfTemperature, zhoneTrapCardStatusChange=zhoneTrapCardStatusChange, shelfBkplaneSerialNumber=shelfBkplaneSerialNumber, shelfStatusTable=shelfStatusTable, shelfAPowerStatus=shelfAPowerStatus, zhoneTrapFlashCardStatusChange=zhoneTrapFlashCardStatusChange, shelfDataTable=shelfDataTable, cardSerialNumber=cardSerialNumber, PYSNMP_MODULE_ID=zhoneShelfMonitorModule, shelfFanLocation=shelfFanLocation, shelfTemperatureStatus=shelfTemperatureStatus, shelfFanTraySerialNumber=shelfFanTraySerialNumber, shelfPowerResets=shelfPowerResets, zhoneShelfStatusGroup=zhoneShelfStatusGroup, shelfBatteryBVoltage=shelfBatteryBVoltage, shelfTemperatureIndex=shelfTemperatureIndex, cardCLEICode=cardCLEICode, shelfDataEntry=shelfDataEntry, shelfTemperatureTable=shelfTemperatureTable, cardReboot=cardReboot, shelfMonitorSerialNumber=shelfMonitorSerialNumber, zhoneTrapCardVersionCheck=zhoneTrapCardVersionCheck, cardVersion=cardVersion, shelfBPowerStatus=shelfBPowerStatus, zhoneCardStatusGroup=zhoneCardStatusGroup, shelfFanTable=shelfFanTable, cardEepromVersion=cardEepromVersion, shelfTemperatureLocation=shelfTemperatureLocation, zhoneTrapShelfMonitorV2Traps=zhoneTrapShelfMonitorV2Traps, cardAdminResets=cardAdminResets, zhoneStatusLastChangeGroup=zhoneStatusLastChangeGroup, shelfTemperatureEntry=shelfTemperatureEntry, shelfChassisReturnVoltage=shelfChassisReturnVoltage, shelfAdminResets=shelfAdminResets, shelfFanTrayStatus=shelfFanTrayStatus, shelfCardTable=shelfCardTable, zhoneFlashCardStatusChange=zhoneFlashCardStatusChange)
