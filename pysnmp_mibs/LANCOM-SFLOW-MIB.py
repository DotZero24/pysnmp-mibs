...
SFlowDataSource,SFlowInstance=mibBuilder.importSymbols('SFLOW-MIB','SFlowDataSource','SFlowInstance')
...
if mibBuilder.loadTexts:fastPathSflow.setRevisions(('2017-08-11 00:00',))
...
agentFastPathSflowObjects=_AgentFastPathSflowObjects_ObjectIdentity((1,3,6,1,4,1,2356,16,1,59,1))
_AgentSflowSourceInterface_Type=InterfaceIndexOrZero
_AgentSflowSourceInterface_Object=MibScalar
agentSflowSourceInterface=_AgentSflowSourceInterface_Object((1,3,6,1,4,1,2356,16,1,59,1,1),_AgentSflowSourceInterface_Type())
...
agentSflowServicePortSrcInterface=_AgentSflowServicePortSrcInterface_Object((1,3,6,1,4,1,2356,16,1,59,1,2),_AgentSflowServicePortSrcInterface_Type())
...
agentSflowRemoteAgentTable=_AgentSflowRemoteAgentTable_Object((1,3,6,1,4,1,2356,16,1,59,1,3))
if mibBuilder.loadTexts:agentSflowRemoteAgentTable.setStatus(_A)
_AgentSflowRemoteAgentEntry_Object=MibTableRow
agentSflowRemoteAgentEntry=_AgentSflowRemoteAgentEntry_Object((1,3,6,1,4,1,2356,16,1,59,1,3,1))
...
agentSflowRemoteAgentIndex=_AgentSflowRemoteAgentIndex_Object((1,3,6,1,4,1,2356,16,1,59,1,3,1,1),_AgentSflowRemoteAgentIndex_Type())
...
agentSflowRemoteAgentMonitorSession=_AgentSflowRemoteAgentMonitorSession_Object((1,3,6,1,4,1,2356,16,1,59,1,3,1,2),_AgentSflowRemoteAgentMonitorSession_Type())
...
agentSflowRemoteAgentMonitorSessionDestPort=_AgentSflowRemoteAgentMonitorSessionDestPort_Object((1,3,6,1,4,1,2356,16,1,59,1,3,1,3),_AgentSflowRemoteAgentMonitorSessionDestPort_Type())
...
agentSflowRemoteAgentAddressType=_AgentSflowRemoteAgentAddressType_Object((1,3,6,1,4,1,2356,16,1,59,1,3,1,4),_AgentSflowRemoteAgentAddressType_Type())
...
agentSflowRemoteAgentAddress=_AgentSflowRemoteAgentAddress_Object((1,3,6,1,4,1,2356,16,1,59,1,3,1,5),_AgentSflowRemoteAgentAddress_Type())
...
agentSflowRemoteAgentUdpPort=_AgentSflowRemoteAgentUdpPort_Object((1,3,6,1,4,1,2356,16,1,59,1,3,1,6),_AgentSflowRemoteAgentUdpPort_Type())
...
agentSflowFsRemoteAgentTable=_AgentSflowFsRemoteAgentTable_Object((1,3,6,1,4,1,2356,16,1,59,1,4))
if mibBuilder.loadTexts:agentSflowFsRemoteAgentTable.setStatus(_A)
_AgentSflowFsRemoteAgentEntry_Object=MibTableRow
agentSflowFsRemoteAgentEntry=_AgentSflowFsRemoteAgentEntry_Object((1,3,6,1,4,1,2356,16,1,59,1,4,1))
...
agentSflowFsRemoteAgentDataSource=_AgentSflowFsRemoteAgentDataSource_Object((1,3,6,1,4,1,2356,16,1,59,1,4,1,1),_AgentSflowFsRemoteAgentDataSource_Type())
...
agentSflowFsRemoteAgentInstance=_AgentSflowFsRemoteAgentInstance_Object((1,3,6,1,4,1,2356,16,1,59,1,4,1,2),_AgentSflowFsRemoteAgentInstance_Type())
...
agentSflowFsRemoteAgentReceiver=_AgentSflowFsRemoteAgentReceiver_Object((1,3,6,1,4,1,2356,16,1,59,1,4,1,3),_AgentSflowFsRemoteAgentReceiver_Type())
...
agentSflowFsRemoteAgentPacketIngressSamplingRate=_AgentSflowFsRemoteAgentPacketIngressSamplingRate_Object((1,3,6,1,4,1,2356,16,1,59,1,4,1,4),_AgentSflowFsRemoteAgentPacketIngressSamplingRate_Type())
...
agentSflowFsRemoteAgentPacketEgressSamplingRate=_AgentSflowFsRemoteAgentPacketEgressSamplingRate_Object((1,3,6,1,4,1,2356,16,1,59,1,4,1,5),_AgentSflowFsRemoteAgentPacketEgressSamplingRate_Type())
...
agentSflowFsRemoteAgentPacketFlowBasedSamplingRate=_AgentSflowFsRemoteAgentPacketFlowBasedSamplingRate_Object((1,3,6,1,4,1,2356,16,1,59,1,4,1,6),_AgentSflowFsRemoteAgentPacketFlowBasedSamplingRate_Type())
...
agentSflowRemoteAgentSourceInterface=_AgentSflowRemoteAgentSourceInterface_Object((1,3,6,1,4,1,2356,16,1,59,1,5),_AgentSflowRemoteAgentSourceInterface_Type())
