...
# Produced by pysmi-1.6.2 at Fri Oct 10 19:16:59 2025
...
vpwrSystemIdentEntry.setIndexNames(
    (0, "ELTEK-BC2000-DC-POWER-MIB", "vpwrShelfIndex"),
...
vpwrDcPowerModuleIdentEntry.setIndexNames(
    (0, "ELTEK-BC2000-DC-POWER-MIB", "vpwrShelfIndex1"),
...
vpwrShelfIndex1 = _VpwrShelfIndex1_Object(
    (1, 3, 6, 1, 4, 1, 13858, 6, 1, 1, 1),
    _VpwrShelfIndex1_Type()
)
vpwrShelfIndex1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vpwrShelfIndex1.setStatus("current")
...
vpwrTrapModuleInserted.setObjects(
      *(("ELTEK-BC2000-DC-POWER-MIB", "vpwrTrapsMsgString"),
        ("ELTEK-BC2000-DC-POWER-MIB", "vpwrShelfIndex"),
...
mibBuilder.exportSymbols(
    ...
    **{"PositiveInteger": PositiveInteger,
       ...
       "vpwrShelfIndex1": vpwrShelfIndex1,
