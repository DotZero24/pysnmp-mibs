...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-GGSN-QOS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:36:09 2025
...
_CggsnUmtsQosMapImsSigTrafClass_Type.__name__ = "UmtsQosTrafficClass"
...
_CggsnUmtsQosCacMaxThruPutReject_Type.__name__ = "TruthValue"
...
_CggsnUmtsQosCacMaxDelayClassRej_Type.__name__ = "TruthValue"
...
_CggsnUmtsQosCacTcReject_Type.__name__ = "TruthValue"
...
_CggsnQosBWPoolTrafClassPercent_Type.__name__ = "TruthValue"
...
cggsnQosMIBCompliance.setObjects(
      *(("CISCO-GGSN-QOS-MIB", "cggsnQosGeneralConfigGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosCanonicalQosGroup"))
)
if mibBuilder.loadTexts:
...
cggsnQosMIBComplianceRev1.setObjects(
      *(("CISCO-GGSN-QOS-MIB", "cggsnQosGeneralConfigGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosCanonicalQosGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosUmtsQosGroup"))
)
if mibBuilder.loadTexts:
...
cggsnQosMIBComplianceRev2.setObjects(
      *(("CISCO-GGSN-QOS-MIB", "cggsnQosGeneralConfigGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosCanonicalQosGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosUmtsQosGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosUmtsCacGroup"))
)
if mibBuilder.loadTexts:
...
cggsnQosMIBComplianceRev3.setObjects(
      *(("CISCO-GGSN-QOS-MIB", "cggsnQosGeneralConfigGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosCanonicalQosGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosUmtsQosGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosUmtsCacGroupRev1"))
)
if mibBuilder.loadTexts:
...
cggsnQosMIBComplianceRev4.setObjects(
      *(("CISCO-GGSN-QOS-MIB", "cggsnQosGeneralConfigGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosCanonicalQosGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosUmtsQosGroup"),
        ("CISCO-GGSN-QOS-MIB", "cggsnQosUmtsCacGroupRev2"))
)
if mibBuilder.loadTexts:
