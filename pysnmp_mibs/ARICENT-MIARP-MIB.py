# SNMP MIB module (ARICENT-MIARP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MIARP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:42:17 2025
...
class _FsMIArpContextDebug_Type(Integer32):
    """Custom type fsMIArpContextDebug based on Integer32"""
    defaultValue = 0
...
_FsMIArpContextDebug_Type.__name__ = "Integer32"
_FsMIArpContextDebug_Object = MibTableColumn
fsMIArpContextDebug = _FsMIArpContextDebug_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 33, 1, 1, 6),
    _FsMIArpContextDebug_Type()
)
fsMIArpContextDebug.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIArpContextDebug.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"fsMiArp": fsMiArp,
       ...
       "fsMIArpContextDebug": fsMIArpContextDebug}
)
