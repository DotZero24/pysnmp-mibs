...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-IP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:24:57 2025
...
ciscoIpMIBCompliance.setObjects(
      *(("CISCO-IETF-IP-MIB", "ciscoIpAddressPfxGroup"),
        ("CISCO-IETF-IP-MIB", "ciscoIpAddressGroup"),
        ("CISCO-IETF-IP-MIB", "ciscoInetNetToMediaGroup"),
        ("CISCO-IETF-IP-MIB", "ciscoInetIcmpGroup"),
        ("CISCO-IETF-IP-MIB", "ciscoInetIcmpMsgGroup"),
        ("CISCO-IETF-IP-MIB", "ciscoIpv6GeneralGroup"),
        ("CISCO-IETF-IP-MIB", "ciscoIpv6InterfaceGroup"),
        ("CISCO-IETF-IP-MIB", "ciscoIpv6ScopeGroup"))
)
if mibBuilder.loadTexts:
