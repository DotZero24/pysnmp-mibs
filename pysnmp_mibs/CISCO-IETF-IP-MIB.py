...
TextualConvention, PhysAddress, RowPointer, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "RowPointer", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-IETF-IP-MIB", cIpv6ScopeIdLinkLocal=cIpv6ScopeIdLinkLocal, cInetIcmpMsgCode=cInetIcmpMsgCode, cIpv6ScopeIdB=cIpv6ScopeIdB, cIpv6InterfaceTable=cIpv6InterfaceTable, cIpv6ScopeIdEntry=cIpv6ScopeIdEntry, cIpAddressPfxAdvValidLifetime=cIpAddressPfxAdvValidLifetime, cInetNetToMediaType=cInetNetToMediaType, cInetIcmpMsgOutPkts=cInetIcmpMsgOutPkts, cIpAddressIfIndex=cIpAddressIfIndex, cIpv6Forwarding=cIpv6Forwarding, Ipv6AddrIfIdentifier=Ipv6AddrIfIdentifier, cInetNetToMediaTable=cInetNetToMediaTable, cIpAddressPfxTable=cIpAddressPfxTable, ciscoIpv6GeneralGroup=ciscoIpv6GeneralGroup, cIpv6ScopeIdSubnetLocal=cIpv6ScopeIdSubnetLocal, ScopeId=ScopeId, cIpv6InterfacePhysicalAddress=cIpv6InterfacePhysicalAddress, cIpv6ScopeIdSiteLocal=cIpv6ScopeIdSiteLocal, cInetNetToMediaEntry=cInetNetToMediaEntry, cInetIcmpInErrors=cInetIcmpInErrors, cIpAddressAddr=cIpAddressAddr, cIpAddressStatus=cIpAddressStatus, cIpv6InterfaceEntry=cIpv6InterfaceEntry, ciscoIetfIpMIBObjects=ciscoIetfIpMIBObjects, cIcmp=cIcmp, cIpv6ScopeIdC=cIpv6ScopeIdC, cIpv6InterfaceReasmMaxSize=cIpv6InterfaceReasmMaxSize, cInetIcmpMsgType=cInetIcmpMsgType, cIpv6ScopeIdAdminLocal=cIpv6ScopeIdAdminLocal, cInetIcmpMsgTable=cInetIcmpMsgTable, ciscoIpMIBGroups=ciscoIpMIBGroups, ciscoIpMIBCompliances=ciscoIpMIBCompliances, cInetIcmpTable=cInetIcmpTable, cIpAddressTable=cIpAddressTable, cIpAddressPfxOrigin=cIpAddressPfxOrigin, cInetIcmpAFType=cInetIcmpAFType, cIpAddressPfxType=cIpAddressPfxType, ciscoIpv6InterfaceGroup=ciscoIpv6InterfaceGroup, ciscoIpMIBConformance=ciscoIpMIBConformance, cInetIcmpIfIndex=cInetIcmpIfIndex, cIpAddressAddrType=cIpAddressAddrType, cIpv6DefaultHopLimit=cIpv6DefaultHopLimit, cInetIcmpOutErrors=cInetIcmpOutErrors, ciscoIpMIBCompliance=ciscoIpMIBCompliance, cIpAddressPfxLength=cIpAddressPfxLength, cIpAddressPfxOnLinkFlag=cIpAddressPfxOnLinkFlag, cIpAddressPrefix=cIpAddressPrefix, cIpAddressEntry=cIpAddressEntry, ciscoInetIcmpGroup=ciscoInetIcmpGroup, cIpv6=cIpv6, PYSNMP_MODULE_ID=ciscoIetfIpMIB, ciscoIetfIpMIB=ciscoIetfIpMIB, cIpAddressType=cIpAddressType, cIpAddressPfxIfIndex=cIpAddressPfxIfIndex, cIpv6ScopeId7=cIpv6ScopeId7, cIpv6ScopeIdA=cIpv6ScopeIdA, cIpv6ScopeIdD=cIpv6ScopeIdD, cIpv6ScopeIdOrganizationLocal=cIpv6ScopeIdOrganizationLocal, cIpAddressPfxAutonomousFlag=cIpAddressPfxAutonomousFlag, cIpAddressOrigin=cIpAddressOrigin, cIpAddressPfxAdvPfdLifetime=cIpAddressPfxAdvPfdLifetime, cInetIcmpEntry=cInetIcmpEntry, cIpv6ScopeId6=cIpv6ScopeId6, cInetIcmpMsgInPkts=cInetIcmpMsgInPkts, cInetIcmpMsgEntry=cInetIcmpMsgEntry, cIpv6InterfaceEffectiveMtu=cIpv6InterfaceEffectiveMtu, cInetIcmpOutMsgs=cInetIcmpOutMsgs, cIpv6ScopeIdIfIndex=cIpv6ScopeIdIfIndex, cIpv6InterfaceIfIndex=cIpv6InterfaceIfIndex, cIpv6InterfaceIdentifier=cIpv6InterfaceIdentifier, ciscoInetNetToMediaGroup=ciscoInetNetToMediaGroup, ciscoInetIcmpMsgGroup=ciscoInetIcmpMsgGroup, cInetNetToMediaLastUpdated=cInetNetToMediaLastUpdated, cInetNetToMediaNetAddress=cInetNetToMediaNetAddress, cInetIcmpMsgIfIndex=cInetIcmpMsgIfIndex, ciscoIpv6ScopeGroup=ciscoIpv6ScopeGroup, cIpAddressPfxEntry=cIpAddressPfxEntry, cInetIcmpInMsgs=cInetIcmpInMsgs, cIpv6ScopeIdTable=cIpv6ScopeIdTable, cIpAddressPfxPfx=cIpAddressPfxPfx, cIp=cIp, cInetNetToMediaPhysAddress=cInetNetToMediaPhysAddress, ciscoIpAddressGroup=ciscoIpAddressGroup, cIpv6InterfaceIdentifierLength=cIpv6InterfaceIdentifierLength, cInetIcmpMsgAFType=cInetIcmpMsgAFType, cInetNetToMediaNetAddressType=cInetNetToMediaNetAddressType, cInetNetToMediaState=cInetNetToMediaState, cIpv6ScopeId9=cIpv6ScopeId9, ciscoIpAddressPfxGroup=ciscoIpAddressPfxGroup)
