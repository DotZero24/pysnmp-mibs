...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-TELNET-SERVER-MIB
...
ciscoTelnetServerMIBCompliance.setObjects(
      *(("CISCO-TELNET-SERVER-MIB", "ctsMIBSessionsObjectGroup"),
        ("CISCO-TELNET-SERVER-MIB", "ctsMIBNotificationGroup"),
        ("CISCO-TELNET-SERVER-MIB", "ctsSessionNotifsControlGroup"))
)
if mibBuilder.loadTexts:
