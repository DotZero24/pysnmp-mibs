# SNMP MIB module (RADLAN-ippreflist-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-ippreflist-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:09:48 2025
...
rlIpPrefListTable = _RlIpPrefListTable_Object(
    (1, 3, 6, 1, 4, 1, 89, 212, 1)
)
if mibBuilder.loadTexts:
    rlIpPrefListTable.setStatus("current")
_RlIpPrefListEntry_Object = MibTableRow
rlIpPrefListEntry = _RlIpPrefListEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 212, 1, 1)
)
rlIpPrefListEntry.setIndexNames(
    (0, "RADLAN-ippreflist-MIB", "rlIpPrefListType"),
    (0, "RADLAN-ippreflist-MIB", "rlIpPrefListName"),
    (0, "RADLAN-ippreflist-MIB", "rlIpPrefListEntryIndex"),
)
if mibBuilder.loadTexts:
...
rlIpPrefListInfoEntry = _RlIpPrefListInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 212, 2, 1)
)
rlIpPrefListInfoEntry.setIndexNames(
    (0, "RADLAN-ippreflist-MIB", "rlIpPrefListInfoType"),
    (0, "RADLAN-ippreflist-MIB", "rlIpPrefListInfoName"),
)
if mibBuilder.loadTexts:
