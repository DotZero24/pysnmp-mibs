# SNMP MIB module (SUPERMICRO-POE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-POE-MIB
...
fsPoePdMacAddress = _FsPoePdMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 103, 1, 2, 1, 1),
...
fsPoePdMacPort = _FsPoePdMacPort_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 103, 1, 2, 1, 2),
...
fsPoePdMacRowStatus = _FsPoePdMacRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 103, 1, 2, 1, 3),
