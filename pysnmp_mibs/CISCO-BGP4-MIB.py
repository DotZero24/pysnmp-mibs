...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-BGP4-MIB
...
bgpPeerRemoteAddr, bgpPeerLastError, bgpPeerState, bgpPeerEntry = mibBuilder.importSymbols("BGP4-MIB", "bgpPeerRemoteAddr", "bgpPeerLastError", "bgpPeerState", "bgpPeerEntry")
ciscoMgmt, = mibBuilder.importSymbols("CISCO-SMI", "ciscoMgmt")
InetPortNumber, InetAutonomousSystemNumber, InetAddressType, InetAddress = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetPortNumber", "InetAutonomousSystemNumber", "InetAddressType", "InetAddress")
...
if mibBuilder.loadTexts: ciscoBgp4MIB.setLastUpdated('202005080000Z')
...
class CbgpSafi(TextualConvention, Integer32):
    ...
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 70, 128))
    namedValues = NamedValues(("unicast", 1), ("multicast", 2), ("unicastAndMulticast", 3), ("evpn", 70), ("vpn", 128))
...
cbgpPeer3Table = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 187, 1, 2, 9), )
if mibBuilder.loadTexts: cbgpPeer3Table.setStatus('current')
cbgpPeer3Entry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 187, 1, 2, 9, 1), ).setIndexNames((0, "CISCO-BGP4-MIB", "cbgpPeer3VrfId"), (0, "CISCO-BGP4-MIB", "cbgpPeer3Type"), (0, "CISCO-BGP4-MIB", "cbgpPeer3RemoteAddr"))
...
mibBuilder.exportSymbols("CISCO-BGP4-MIB", cbgpPeerAcceptedPrefixes=cbgpPeerAcceptedPrefixes, ciscoBgp4Peer2Group=ciscoBgp4Peer2Group, cbgpRouteAddrPrefixLen=cbgpRouteAddrPrefixLen, cbgpPeer2Table=cbgpPeer2Table, ciscoBgp4MIBComplianceRev2=ciscoBgp4MIBComplianceRev2, cbgpPeerAddrFamilyTable=cbgpPeerAddrFamilyTable, ciscoBgp4NotificationsGroup1=ciscoBgp4NotificationsGroup1, ciscoBgp4RouteGroup=ciscoBgp4RouteGroup, cbgpPeer2AddrFamilyAfi=cbgpPeer2AddrFamilyAfi, cbgpPeer2FsmStateChange=cbgpPeer2FsmStateChange, cbgpPeer2AddrFamilyEntry=cbgpPeer2AddrFamilyEntry, cbgpPeer2MinRouteAdvertisementInterval=cbgpPeer2MinRouteAdvertisementInterval, cbgpPeer2AddrFamilyPrefixTable=cbgpPeer2AddrFamilyPrefixTable, cbgpPeer3VrfName=cbgpPeer3VrfName, cbgpPeerPrefixSuppressed=cbgpPeerPrefixSuppressed, cbgpPeer2RemoteAddr=cbgpPeer2RemoteAddr, cbgpPeerPrefixWithdrawn=cbgpPeerPrefixWithdrawn, ciscoBgp4MIBObjects=ciscoBgp4MIBObjects, cbgpRouteLocalPref=cbgpRouteLocalPref, cbgpPeer2WithdrawnPrefixes=cbgpPeer2WithdrawnPrefixes, cbgpPeerAddrFamilySafi=cbgpPeerAddrFamilySafi, cbgpPeerAdvertisedPrefixes=cbgpPeerAdvertisedPrefixes, ciscoBgp4MIBCompliances=ciscoBgp4MIBCompliances, cbgpPeerSuppressedPrefixes=cbgpPeerSuppressedPrefixes, cbgpPeer2LocalIdentifier=cbgpPeer2LocalIdentifier, cbgpPeer2MinASOriginationInterval=cbgpPeer2MinASOriginationInterval, cbgpPeerCapValue=cbgpPeerCapValue, cbgpPeer2FsmEstablishedTransitions=cbgpPeer2FsmEstablishedTransitions, ciscoBgp4MIBComplianceRev3=ciscoBgp4MIBComplianceRev3, cbgpPeer2InUpdates=cbgpPeer2InUpdates, cbgpRouteEntry=cbgpRouteEntry, cbgpPeerDeniedPrefixes=cbgpPeerDeniedPrefixes, cbgpPeer2SuppressedPrefixes=cbgpPeer2SuppressedPrefixes, cbgpPeer2EstablishedNotification=cbgpPeer2EstablishedNotification, cbgpPeer3LastErrorTxt=cbgpPeer3LastErrorTxt, cbgpPeer2LastError=cbgpPeer2LastError, cbgpPeer3AdminStatus=cbgpPeer3AdminStatus, cbgpPeer2PrefixClearThreshold=cbgpPeer2PrefixClearThreshold, cbgpPeer3ConnectRetryInterval=cbgpPeer3ConnectRetryInterval, cbgpPeer3Table=cbgpPeer3Table, CbgpSafi=CbgpSafi, cbgpPeer3LocalAs=cbgpPeer3LocalAs, ciscoBgp4NotificationPrefix=ciscoBgp4NotificationPrefix, cbgpPeer3HoldTime=cbgpPeer3HoldTime, cbgpPeer2InUpdateElapsedTime=cbgpPeer2InUpdateElapsedTime, cbgpPeerPrefixLimit=cbgpPeerPrefixLimit, cbgpBackwardTransition=cbgpBackwardTransition, cbgpPeer2CapCode=cbgpPeer2CapCode, cbgpPeer3LocalPort=cbgpPeer3LocalPort, ciscoBgp4GlobalGroup=ciscoBgp4GlobalGroup, cbgpPeerTable=cbgpPeerTable, ciscoBgp4MIBCompliance=ciscoBgp4MIBCompliance, cbgpPeer2LocalAddr=cbgpPeer2LocalAddr, cbgpPeerEntry=cbgpPeerEntry, cbgpGlobal=cbgpGlobal, cbgpPeer2OutUpdates=cbgpPeer2OutUpdates, cbgpPeer2RemoteAs=cbgpPeer2RemoteAs, ciscoBgp4NotificationsGroup=ciscoBgp4NotificationsGroup, cbgpPeer2RemoteIdentifier=cbgpPeer2RemoteIdentifier, cbgpPeerAddrFamilyAfi=cbgpPeerAddrFamilyAfi, cbgpPeer2KeepAliveConfigured=cbgpPeer2KeepAliveConfigured, cbgpPeer3OutUpdates=cbgpPeer3OutUpdates, cbgpPeer2RemotePort=cbgpPeer2RemotePort, cbgpPeer2ConnectRetryInterval=cbgpPeer2ConnectRetryInterval, cbgpRouteAtomicAggregate=cbgpRouteAtomicAggregate, cbgpPeer3FsmEstablishedTransitions=cbgpPeer3FsmEstablishedTransitions, cbgpRouteMultiExitDisc=cbgpRouteMultiExitDisc, cbgpPeer2InTotalMessages=cbgpPeer2InTotalMessages, cbgpPeer3LocalAddr=cbgpPeer3LocalAddr, cbgpPeer2PrefixThresholdClear=cbgpPeer2PrefixThresholdClear, ciscoBgp4Peer2NotificationsGroup=ciscoBgp4Peer2NotificationsGroup, cbgpPeer2BackwardTransition=cbgpPeer2BackwardTransition, cbgpPeerAddrFamilyEntry=cbgpPeerAddrFamilyEntry, ciscoBgp4PeerGroup=ciscoBgp4PeerGroup, cbgpRouteSafi=cbgpRouteSafi, cbgpRouteMedPresent=cbgpRouteMedPresent, cbgpPeer2PrevState=cbgpPeer2PrevState, cbgpPeer3HoldTimeConfigured=cbgpPeer3HoldTimeConfigured, cbgpRouteAddrPrefix=cbgpRouteAddrPrefix, cbgpRouteAggregatorAddrType=cbgpRouteAggregatorAddrType, cbgpPeerPrefixClearThreshold=cbgpPeerPrefixClearThreshold, cbgpPeer2PrefixAdminLimit=cbgpPeer2PrefixAdminLimit, cbgpPeer3Type=cbgpPeer3Type, cbgpPeer3RemoteAddr=cbgpPeer3RemoteAddr, ciscoBgp4MIBGroups=ciscoBgp4MIBGroups, CbgpNetworkAddress=CbgpNetworkAddress, cbgpPeer3PrevState=cbgpPeer3PrevState, cbgpPeer2NegotiatedVersion=cbgpPeer2NegotiatedVersion, cbgpPeer2LastErrorTxt=cbgpPeer2LastErrorTxt, cbgpPeer2State=cbgpPeer2State, cbgpPeer2OutTotalMessages=cbgpPeer2OutTotalMessages, cbgpPeer3NegotiatedVersion=cbgpPeer3NegotiatedVersion, PYSNMP_MODULE_ID=ciscoBgp4MIB, cbgpPeer2PrefixThresholdExceeded=cbgpPeer2PrefixThresholdExceeded, cbgpPeer3OutTotalMessages=cbgpPeer3OutTotalMessages, cbgpPeer2DeniedPrefixes=cbgpPeer2DeniedPrefixes, cbgpPeerAddrFamilyName=cbgpPeerAddrFamilyName, cbgpRouteAggregatorAS=cbgpRouteAggregatorAS, cbgpPeer3State=cbgpPeer3State, cbgpPrefixThresholdExceeded=cbgpPrefixThresholdExceeded, cbgpPeerWithdrawnPrefixes=cbgpPeerWithdrawnPrefixes, cbgpPeerPrefixAdminLimit=cbgpPeerPrefixAdminLimit, cbgpRouteAggregatorAddr=cbgpRouteAggregatorAddr, cbgpPeerPrefixAdvertised=cbgpPeerPrefixAdvertised, cbgpPeerPrevState=cbgpPeerPrevState, cbgpPeer2LocalPort=cbgpPeer2LocalPort, cbgpRouteLocalPrefPresent=cbgpRouteLocalPrefPresent, cbgpLocalAs=cbgpLocalAs, cbgpPeer2AdvertisedPrefixes=cbgpPeer2AdvertisedPrefixes, cbgpPeerCapCode=cbgpPeerCapCode, cbgpPeerPrefixAccepted=cbgpPeerPrefixAccepted, cbgpPeerAddrFamilyPrefixEntry=cbgpPeerAddrFamilyPrefixEntry, cbgpRouteUnknownAttr=cbgpRouteUnknownAttr, ciscoBgp4NotifyPrefix=ciscoBgp4NotifyPrefix, cbgpPeer3KeepAliveConfigured=cbgpPeer3KeepAliveConfigured, cbgpPeer2KeepAlive=cbgpPeer2KeepAlive, cbgpPeer=cbgpPeer, cbgpRoutePeer=cbgpRoutePeer, cbgpPeer2AddrFamilyTable=cbgpPeer2AddrFamilyTable, cbgpPeer3VrfId=cbgpPeer3VrfId, cbgpPeer2BackwardTransNotification=cbgpPeer2BackwardTransNotification, cbgpPeer2AdminStatus=cbgpPeer2AdminStatus, ciscoBgp4MIBConformance=ciscoBgp4MIBConformance, cbgpPeer3RemoteIdentifier=cbgpPeer3RemoteIdentifier, cbgpPeer2CapIndex=cbgpPeer2CapIndex, cbgpPeer2AddrFamilySafi=cbgpPeer2AddrFamilySafi, cbgpPeer3MinRouteAdvertisementInterval=cbgpPeer3MinRouteAdvertisementInterval, cbgpRouteBest=cbgpRouteBest, cbgpRouteOrigin=cbgpRouteOrigin, cbgpPeer2PrefixThreshold=cbgpPeer2PrefixThreshold, cbgpPeer3InUpdates=cbgpPeer3InUpdates, ciscoBgp4MIB=ciscoBgp4MIB, cbgpRouteTable=cbgpRouteTable, cbgpPeerCapIndex=cbgpPeerCapIndex, cbgpPeer2HoldTime=cbgpPeer2HoldTime, cbgpPeer2CapsEntry=cbgpPeer2CapsEntry, cbgpPeer2Entry=cbgpPeer2Entry, cbgpPeer2FsmEstablishedTime=cbgpPeer2FsmEstablishedTime, cbgpPeer2AddrFamilyName=cbgpPeer2AddrFamilyName, cbgpPeer3InTotalMessages=cbgpPeer3InTotalMessages, cbgpPeer2CapValue=cbgpPeer2CapValue, cbgpPeer3KeepAlive=cbgpPeer3KeepAlive, ciscoBgp4MIBComplianceRev1=ciscoBgp4MIBComplianceRev1, cbgpPeer2Type=cbgpPeer2Type, cbgpPeerCapsEntry=cbgpPeerCapsEntry, cbgpRouteNextHop=cbgpRouteNextHop, cbgpPeerAddrFamilyPrefixTable=cbgpPeerAddrFamilyPrefixTable, cbgpPeer2CapsTable=cbgpPeer2CapsTable, cbgpPeer2AddrFamilyPrefixEntry=cbgpPeer2AddrFamilyPrefixEntry, cbgpPeer3RemotePort=cbgpPeer3RemotePort, cbgpRoutePeerType=cbgpRoutePeerType, cbgpPeerPrefixDenied=cbgpPeerPrefixDenied, ciscoBgp4PeerGroup1=ciscoBgp4PeerGroup1, cbgpRouteASPathSegment=cbgpRouteASPathSegment, cbgpPeer3LocalIdentifier=cbgpPeer3LocalIdentifier, cbgpPeerLastErrorTxt=cbgpPeerLastErrorTxt, cbgpRouteAfi=cbgpRouteAfi, cbgpPeer2AcceptedPrefixes=cbgpPeer2AcceptedPrefixes, cbgpPeer3LastError=cbgpPeer3LastError, cbgpPeer3Entry=cbgpPeer3Entry, cbgpNotifsEnable=cbgpNotifsEnable, cbgpPeerPrefixThreshold=cbgpPeerPrefixThreshold, cbgpPeer3InUpdateElapsedTime=cbgpPeer3InUpdateElapsedTime, cbgpPrefixThresholdClear=cbgpPrefixThresholdClear, cbgpPeer3FsmEstablishedTime=cbgpPeer3FsmEstablishedTime, cbgpPeer3MinASOriginationInterval=cbgpPeer3MinASOriginationInterval, cbgpFsmStateChange=cbgpFsmStateChange, cbgpRoute=cbgpRoute, cbgpPeer2LocalAs=cbgpPeer2LocalAs, cbgpPeerCapsTable=cbgpPeerCapsTable, cbgpPeer3RemoteAs=cbgpPeer3RemoteAs, cbgpPeer2HoldTimeConfigured=cbgpPeer2HoldTimeConfigured)
