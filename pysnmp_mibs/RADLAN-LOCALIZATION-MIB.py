...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:11:47 2025
...
rlLocalizationLanguagesEntry = _RlLocalizationLanguagesEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 103, 10, 1)
)
rlLocalizationLanguagesEntry.setIndexNames(
    (1, "RADLAN-LOCALIZATION-MIB", "rlLocalizationLanguagesName"),
)
if mibBuilder.loadTexts:
