...
rlLocalizationActivelanguage=_RlLocalizationActivelanguage_Object((1,3,6,1,4,1,89,103,8),_RlLocalizationActivelanguage_Type())
...
rlLocalizationLoginlanguage=_RlLocalizationLoginlanguage_Object((1,3,6,1,4,1,89,103,9),_RlLocalizationLoginlanguage_Type())
...
rlLocalizationLanguagesTable=_RlLocalizationLanguagesTable_Object((1,3,6,1,4,1,89,103,10))
if mibBuilder.loadTexts:rlLocalizationLanguagesTable.setStatus(_A)
_RlLocalizationLanguagesEntry_Object=MibTableRow
rlLocalizationLanguagesEntry=_RlLocalizationLanguagesEntry_Object((1,3,6,1,4,1,89,103,10,1))
...
rlLocalizationLanguagesName=_RlLocalizationLanguagesName_Object((1,3,6,1,4,1,89,103,10,1,1),_RlLocalizationLanguagesName_Type())
...
rlLocalizationLanguagesUnicodeName=_RlLocalizationLanguagesUnicodeName_Object((1,3,6,1,4,1,89,103,10,1,2),_RlLocalizationLanguagesUnicodeName_Type())
...
rlLocalizationLanguagesUrlDir=_RlLocalizationLanguagesUrlDir_Object((1,3,6,1,4,1,89,103,10,1,3),_RlLocalizationLanguagesUrlDir_Type())
...
rlLocalizationLanguagesUrlHelpDir=_RlLocalizationLanguagesUrlHelpDir_Object((1,3,6,1,4,1,89,103,10,1,4),_RlLocalizationLanguagesUrlHelpDir_Type())
...
rlLocalizationLanguageCode=_RlLocalizationLanguageCode_Object((1,3,6,1,4,1,89,103,10,1,5),_RlLocalizationLanguageCode_Type())
...
rlLocalizationNumOfSections=_RlLocalizationNumOfSections_Object((1,3,6,1,4,1,89,103,10,1,6),_RlLocalizationNumOfSections_Type())
...
rlLocalizationNumOfEmbSections=_RlLocalizationNumOfEmbSections_Object((1,3,6,1,4,1,89,103,10,1,7),_RlLocalizationNumOfEmbSections_Type())
...
rlLocalizationVersion=_RlLocalizationVersion_Object((1,3,6,1,4,1,89,103,10,1,8),_RlLocalizationVersion_Type())
...
rlLocalizationMd5ChksumFile=_RlLocalizationMd5ChksumFile_Object((1,3,6,1,4,1,89,103,10,1,9),_RlLocalizationMd5ChksumFile_Type())
