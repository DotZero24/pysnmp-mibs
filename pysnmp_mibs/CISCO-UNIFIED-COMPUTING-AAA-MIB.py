...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-AAA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:06 2025
...
cucsAaaLocalMgmtCmdLogTable = _CucsAaaLocalMgmtCmdLogTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60)
)
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogTable.setStatus("current")
_CucsAaaLocalMgmtCmdLogEntry_Object = MibTableRow
cucsAaaLocalMgmtCmdLogEntry = _CucsAaaLocalMgmtCmdLogEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1)
)
cucsAaaLocalMgmtCmdLogEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-AAA-MIB", "cucsAaaLocalMgmtCmdLogInstanceId"),
)
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogEntry.setStatus("current")
_CucsAaaLocalMgmtCmdLogInstanceId_Type = CucsManagedObjectId
_CucsAaaLocalMgmtCmdLogInstanceId_Object = MibTableColumn
cucsAaaLocalMgmtCmdLogInstanceId = _CucsAaaLocalMgmtCmdLogInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1, 1),
    _CucsAaaLocalMgmtCmdLogInstanceId_Type()
)
cucsAaaLocalMgmtCmdLogInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogInstanceId.setStatus("current")
_CucsAaaLocalMgmtCmdLogDn_Type = CucsManagedObjectDn
_CucsAaaLocalMgmtCmdLogDn_Object = MibTableColumn
cucsAaaLocalMgmtCmdLogDn = _CucsAaaLocalMgmtCmdLogDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1, 2),
    _CucsAaaLocalMgmtCmdLogDn_Type()
)
cucsAaaLocalMgmtCmdLogDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogDn.setStatus("current")
_CucsAaaLocalMgmtCmdLogRn_Type = SnmpAdminString
_CucsAaaLocalMgmtCmdLogRn_Object = MibTableColumn
cucsAaaLocalMgmtCmdLogRn = _CucsAaaLocalMgmtCmdLogRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1, 3),
    _CucsAaaLocalMgmtCmdLogRn_Type()
)
cucsAaaLocalMgmtCmdLogRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogRn.setStatus("current")
_CucsAaaLocalMgmtCmdLogCmdline_Type = SnmpAdminString
_CucsAaaLocalMgmtCmdLogCmdline_Object = MibTableColumn
cucsAaaLocalMgmtCmdLogCmdline = _CucsAaaLocalMgmtCmdLogCmdline_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1, 4),
    _CucsAaaLocalMgmtCmdLogCmdline_Type()
)
cucsAaaLocalMgmtCmdLogCmdline.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogCmdline.setStatus("current")
_CucsAaaLocalMgmtCmdLogDate_Type = DateAndTime
_CucsAaaLocalMgmtCmdLogDate_Object = MibTableColumn
cucsAaaLocalMgmtCmdLogDate = _CucsAaaLocalMgmtCmdLogDate_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1, 5),
    _CucsAaaLocalMgmtCmdLogDate_Type()
)
cucsAaaLocalMgmtCmdLogDate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogDate.setStatus("current")
_CucsAaaLocalMgmtCmdLogHost_Type = SnmpAdminString
_CucsAaaLocalMgmtCmdLogHost_Object = MibTableColumn
cucsAaaLocalMgmtCmdLogHost = _CucsAaaLocalMgmtCmdLogHost_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1, 6),
    _CucsAaaLocalMgmtCmdLogHost_Type()
)
cucsAaaLocalMgmtCmdLogHost.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogHost.setStatus("current")
_CucsAaaLocalMgmtCmdLogSwitchId_Type = CucsNetworkSwitchId
_CucsAaaLocalMgmtCmdLogSwitchId_Object = MibTableColumn
cucsAaaLocalMgmtCmdLogSwitchId = _CucsAaaLocalMgmtCmdLogSwitchId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1, 7),
    _CucsAaaLocalMgmtCmdLogSwitchId_Type()
)
cucsAaaLocalMgmtCmdLogSwitchId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogSwitchId.setStatus("current")
_CucsAaaLocalMgmtCmdLogTerm_Type = SnmpAdminString
_CucsAaaLocalMgmtCmdLogTerm_Object = MibTableColumn
cucsAaaLocalMgmtCmdLogTerm = _CucsAaaLocalMgmtCmdLogTerm_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1, 8),
    _CucsAaaLocalMgmtCmdLogTerm_Type()
)
cucsAaaLocalMgmtCmdLogTerm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogTerm.setStatus("current")
_CucsAaaLocalMgmtCmdLogUser_Type = SnmpAdminString
_CucsAaaLocalMgmtCmdLogUser_Object = MibTableColumn
cucsAaaLocalMgmtCmdLogUser = _CucsAaaLocalMgmtCmdLogUser_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 2, 60, 1, 9),
    _CucsAaaLocalMgmtCmdLogUser_Type()
)
cucsAaaLocalMgmtCmdLogUser.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsAaaLocalMgmtCmdLogUser.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsAaaObjects": cucsAaaObjects,
       ...
       "cucsAaaLocalMgmtCmdLogTable": cucsAaaLocalMgmtCmdLogTable,
       "cucsAaaLocalMgmtCmdLogEntry": cucsAaaLocalMgmtCmdLogEntry,
       "cucsAaaLocalMgmtCmdLogInstanceId": cucsAaaLocalMgmtCmdLogInstanceId,
       "cucsAaaLocalMgmtCmdLogDn": cucsAaaLocalMgmtCmdLogDn,
       "cucsAaaLocalMgmtCmdLogRn": cucsAaaLocalMgmtCmdLogRn,
       "cucsAaaLocalMgmtCmdLogCmdline": cucsAaaLocalMgmtCmdLogCmdline,
       "cucsAaaLocalMgmtCmdLogDate": cucsAaaLocalMgmtCmdLogDate,
       "cucsAaaLocalMgmtCmdLogHost": cucsAaaLocalMgmtCmdLogHost,
       "cucsAaaLocalMgmtCmdLogSwitchId": cucsAaaLocalMgmtCmdLogSwitchId,
       "cucsAaaLocalMgmtCmdLogTerm": cucsAaaLocalMgmtCmdLogTerm,
       "cucsAaaLocalMgmtCmdLogUser": cucsAaaLocalMgmtCmdLogUser}
)
