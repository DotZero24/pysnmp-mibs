...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-TRAP-VARS-MIB
...
cwTrapVarsCompliance.setObjects(
    ("CISCO-WAN-TRAP-VARS-MIB", "cwTrapVarsTrapGroup")
)
if mibBuilder.loadTexts:
...
cwTrapVarsCompliance2.setObjects(
    ("CISCO-WAN-TRAP-VARS-MIB", "cwTrapVarsTrapGroup2")
)
if mibBuilder.loadTexts:
...
cwTrapVarsCompliance3.setObjects(
    ("CISCO-WAN-TRAP-VARS-MIB", "cwTrapVarsTrapGroup3")
)
if mibBuilder.loadTexts:
...
cwTrapVarsCompliance4.setObjects(
    ("CISCO-WAN-TRAP-VARS-MIB", "cwTrapVarsTrapGroup4")
)
if mibBuilder.loadTexts:
...
cwTrapVarsCompliance5.setObjects(
    ("CISCO-WAN-TRAP-VARS-MIB", "cwTrapVarsTrapGroup5")
)
if mibBuilder.loadTexts:
