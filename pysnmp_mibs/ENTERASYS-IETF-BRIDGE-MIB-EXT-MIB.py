...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:46:57 2025
...
_EtsysIetfBridgeDot1dStpPortStpEnable_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1dStpPortSpanGuardBlocking_Type.__name__ = "TruthValue"
...
_EtsysIetfBridgeDot1dStpNewRootTrapEnable_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1dBasePortNewLearnedAddrTrap_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1dBasePortMovedAddrTrap_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1qNewLearnedAddrTrapEnable_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1qMovedAddrTrapEnable_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1qStaticUcastAsMcast_Type.__name__ = "EnabledStatus"
...
etsysIetfBridgeDot1qGvrpOperStatus = _EtsysIetfBridgeDot1qGvrpOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 31, 1, 3, 4),
    _EtsysIetfBridgeDot1qGvrpOperStatus_Type()
)
etsysIetfBridgeDot1qGvrpOperStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    etsysIetfBridgeDot1qGvrpOperStatus.setStatus("current")
...
_EtsysIetfBridgeDot1dStpSpanGuardEnable_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1dStpSpanGuardTrapEnable_Type.__name__ = "EnabledStatus"
...
class _EtsysIetfBridgeDot1dStpSpanGuardAutoUnlock_Type(EnabledStatus):
    """Custom type etsysIetfBridgeDot1dStpSpanGuardAutoUnlock based on EnabledStatus"""
    defaultValue = 1


_EtsysIetfBridgeDot1dStpSpanGuardAutoUnlock_Type.__name__ = "EnabledStatus"
_EtsysIetfBridgeDot1dStpSpanGuardAutoUnlock_Object = MibScalar
etsysIetfBridgeDot1dStpSpanGuardAutoUnlock = _EtsysIetfBridgeDot1dStpSpanGuardAutoUnlock_Object(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 31, 1, 4, 4),
    _EtsysIetfBridgeDot1dStpSpanGuardAutoUnlock_Type()
)
etsysIetfBridgeDot1dStpSpanGuardAutoUnlock.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    etsysIetfBridgeDot1dStpSpanGuardAutoUnlock.setStatus("current")
...
_EtsysIetfBridgeDot1dStpBackupRootEnable_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1dStpBackupRootTrapEnable_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1dStpLoopProtectPortCistEnable_Type.__name__ = "EnabledStatus"
...
_EtsysIetfBridgeDot1dStpLoopProtectPortCistBlocking_Type.__name__ = "TruthValue"
...
_EtsysIetfBridgeDot1dStpLoopProtectPortPartnerCapable_Type.__name__ = "TruthValue"
...
_EtsysIetfBridgeDot1dStpLoopProtectEventThreshold_Type.__name__ = "Unsigned32"
...
_EtsysIetfBridgeDot1dStpLoopProtectEventWindow_Type.__name__ = "Unsigned32"
...
_EtsysIetfBridgeDot1dStpLoopProtectEventTrapEnable_Type.__name__ = "EnabledStatus"
...
if mibBuilder.loadTexts:
    etsysIetfBridgeSpanGuard.setStatus("deprecated")
...
etsysIetfBridgeGvrpOperStatus = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 31, 2, 1, 17)
)
etsysIetfBridgeGvrpOperStatus.setObjects(
    ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1qGvrpOperStatus")
)
if mibBuilder.loadTexts:
    etsysIetfBridgeGvrpOperStatus.setStatus("current")

etsysIetfBridgeSpanGuard2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 31, 2, 1, 18)
)
etsysIetfBridgeSpanGuard2.setObjects(
      *(("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1dStpSpanGuardEnable"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1dStpSpanGuardBlockTime"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1dStpSpanGuardTrapEnable"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1dStpPortSpanGuardBlocking"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1dStpSpanGuardAutoUnlock"))
)
if mibBuilder.loadTexts:
    etsysIetfBridgeSpanGuard2.setStatus("current")
...
etsysIetfBridgeCompliance.setObjects(
      *(("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeStpPort"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeStpTrap"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeBase"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1qFdbNewAddrNotification"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeSpanGuard"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeSpanGuardNotification"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeBackupRoot"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeBackupRootNotification"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1dStpBridgePriority"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgePortCistRoleValue"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeMovedAddr"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1qFdbMovedAddrNotification"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeLoopProtect"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeLoopProtectNotification"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeStpCistNonForwardingReason"))
)
if mibBuilder.loadTexts:
...
etsysIetfBridgeStaticUcastAsMcastCompliance.setObjects(
    ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeStaticUcastAsMcast")
)
if mibBuilder.loadTexts:
...
etsysIetfBridgeGvrpOperStatusCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 31, 2, 2, 3)
)
etsysIetfBridgeGvrpOperStatusCompliance.setObjects(
    ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeGvrpOperStatus")
)
if mibBuilder.loadTexts:
    etsysIetfBridgeGvrpOperStatusCompliance.setStatus(
        "current"
    )

etsysIetfBridgeCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 31, 2, 2, 4)
)
etsysIetfBridgeCompliance2.setObjects(
      *(("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeStpPort"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeStpTrap"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeBase"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1qFdbNewAddrNotification"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeSpanGuard2"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeSpanGuardNotification"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeBackupRoot"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeBackupRootNotification"),
        ("ENTERASYS-IETF-BRIDGE-MIB-EXT-MIB", "etsysIetfBridgeDot1dStpBridgePriority"),
...
if mibBuilder.loadTexts:
    etsysIetfBridgeCompliance2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"etsysIetfBridgeMibExtMIB": etsysIetfBridgeMibExtMIB,
       ...
       "etsysIetfBridgeDot1qGvrpOperStatus": etsysIetfBridgeDot1qGvrpOperStatus,
       ...
       "etsysIetfBridgeDot1dStpSpanGuardAutoUnlock": etsysIetfBridgeDot1dStpSpanGuardAutoUnlock,
       ...
       "etsysIetfBridgeGvrpOperStatus": etsysIetfBridgeGvrpOperStatus,
       "etsysIetfBridgeSpanGuard2": etsysIetfBridgeSpanGuard2,
       ...
       "etsysIetfBridgeGvrpOperStatusCompliance": etsysIetfBridgeGvrpOperStatusCompliance,
       "etsysIetfBridgeCompliance2": etsysIetfBridgeCompliance2}
)
