...
mibBuilder.exportSymbols("G6-SYSTEM-MIB", systemSendWakeOnLanPacket=systemSendWakeOnLanPacket, scriptScheduleWeekdays=scriptScheduleWeekdays, systemUsedMacAddress=systemUsedMacAddress, systemUsedBootMedia=systemUsedBootMedia, systemAutorunCliScript=systemAutorunCliScript, scriptScheduleHours=scriptScheduleHours, scriptScheduleMinutes=scriptScheduleMinutes, scriptScheduleMonths=scriptScheduleMonths, firmwareEntry=firmwareEntry, systemShowUtilization=systemShowUtilization, systemInventory=systemInventory, systemClimateLevel=systemClimateLevel, firmwareTable=firmwareTable, systemRebootDevice=systemRebootDevice, saveInfoEntry=saveInfoEntry, systemSetTime=systemSetTime, scriptScheduleMode=scriptScheduleMode, systemCharacterSet=systemCharacterSet, systemLastBootTime=systemLastBootTime, saveInfoIndex=saveInfoIndex, scriptScheduleTable=scriptScheduleTable, device=device, systemSetDate=systemSetDate, saveInfoLastSavedParameter=saveInfoLastSavedParameter, scriptScheduleName=scriptScheduleName, systemBootPreference=systemBootPreference, firmwareRunningVersion=firmwareRunningVersion, systemAlternativeMacAddress=systemAlternativeMacAddress, scriptScheduleDays=scriptScheduleDays, PYSNMP_MODULE_ID=device, systemShowTimeDate=systemShowTimeDate, system=system, saveInfoSaveMode=saveInfoSaveMode, scriptScheduleIndex=scriptScheduleIndex, saveInfoTimeStamp=saveInfoTimeStamp, saveInfoWriteStatus=saveInfoWriteStatus, scriptScheduleCliScript=scriptScheduleCliScript, saveInfoTable=saveInfoTable, systemConfigurationSaveMode=systemConfigurationSaveMode, systemCreateSnapshot=systemCreateSnapshot, systemSerialPort=systemSerialPort, firmwareBuildNumber=firmwareBuildNumber, systemUptime=systemUptime, systemPermitDebugAccess=systemPermitDebugAccess, firmwareBuildDate=firmwareBuildDate, systemPermitIncomingAlerts=systemPermitIncomingAlerts, scriptScheduleEntry=scriptScheduleEntry, firmwareIndex=firmwareIndex, systemTemperature=systemTemperature)
