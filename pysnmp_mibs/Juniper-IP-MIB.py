...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/junose/Juniper-IP-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:42:29 2025
...
JuniEnable, JuniIpAddrLessIf, JuniNextIfIndex = mibBuilder.importSymbols("Juniper-TC", "JuniEnable", "JuniIpAddrLessIf", "JuniNextIfIndex")
...
juniIpMIB.setRevisions(('2010-08-02 08:57', '2007-01-17 23:02', '2005-03-30 13:49', '2005-04-29 20:37', '2004-09-20 13:49', '2004-09-10 15:26', '2003-11-03 15:26', '2003-06-25 19:48', '2003-02-11 19:05', '2002-10-23 18:53', '2002-04-03 22:06', '2001-07-05 14:00', '2001-06-18 19:11', '2000-07-31 00:00', '1999-11-09 00:00', '1999-09-16 00:00', '1998-11-19 00:00',))
if mibBuilder.loadTexts: juniIpMIB.setLastUpdated('201008020857Z')
...
juniIpRouteStaticNullIntf = MibTableColumn((1, 3, 6, 1, 4, 1, 4874, 2, 2, 12, 1, 3, 2, 1, 11), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("discard", 1), ("reject", 2))).clone('discard')).setMaxAccess("readcreate")
if mibBuilder.loadTexts: juniIpRouteStaticNullIntf.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    juniIpCompliance14 = juniIpCompliance14.setStatus('obsolete')
juniIpCompliance15 = ModuleCompliance((1, 3, 6, 1, 4, 1, 4874, 2, 2, 12, 4, 1, 15)).setObjects(("Juniper-IP-MIB", "juniIpInterfaceGroup9"), ("Juniper-IP-MIB", "juniIpAddressGroup4"), ("Juniper-IP-MIB", "juniIpRouteGroup4"), ("Juniper-IP-MIB", "juniIpGlobalGroup3"), ("Juniper-IP-MIB", "juniIpIfSummaryGroup"), ("Juniper-IP-MIB", "juniIpNotificationGroup1"), ("Juniper-IP-MIB", "juniIpMIBNotificationObjectsGroup"), ("Juniper-IP-MIB", "juniIpRouteSummaryGroup"), ("Juniper-IP-MIB", "juniIpRouteStaticBFDGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    juniIpCompliance15 = juniIpCompliance15.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    juniIpRouteGroup3 = juniIpRouteGroup3.setStatus('obsolete')
...
juniIpRouteGroup4 = ObjectGroup((1, 3, 6, 1, 4, 1, 4874, 2, 2, 12, 4, 2, 28)).setObjects(("Juniper-IP-MIB", "juniIpRouteTableLimit"), ("Juniper-IP-MIB", "juniIpRouteTableWarnPercent"), ("Juniper-IP-MIB", "juniIpRouteTableWarnOnly"), ("Juniper-IP-MIB", "juniIpRouteTableWarnThreshold"), ("Juniper-IP-MIB", "juniIpRouteStaticDest"), ("Juniper-IP-MIB", "juniIpRouteStaticMask"), ("Juniper-IP-MIB", "juniIpRouteStaticPref"), ("Juniper-IP-MIB", "juniIpRouteStaticNextHop"), ("Juniper-IP-MIB", "juniIpRouteStaticRowStatus"), ("Juniper-IP-MIB", "juniIpRouteStaticIfIndex"), ("Juniper-IP-MIB", "juniIpRouteStaticStatus"), ("Juniper-IP-MIB", "juniIpRouteStaticNextHopAS"), ("Juniper-IP-MIB", "juniIpRouteStaticMetric"), ("Juniper-IP-MIB", "juniIpRouteStaticTag"), ("Juniper-IP-MIB", "juniIpRouteStaticNullIntf"), ("Juniper-IP-MIB", "juniIpCidrRoutePref"), ("Juniper-IP-MIB", "juniIpCidrRouteArea"), ("Juniper-IP-MIB", "juniIpCidrRouteTag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    juniIpRouteGroup4 = juniIpRouteGroup4.setStatus('current')
mibBuilder.exportSymbols("Juniper-IP-MIB", juniIpIfStatsYellowOutSchedDropPackets=juniIpIfStatsYellowOutSchedDropPackets, juniIpRouteStaticMask=juniIpRouteStaticMask, juniIpRouteSummaryUnicastInterAreaOspfRoutes=juniIpRouteSummaryUnicastInterAreaOspfRoutes, juniIpAdEntIcmpUnreachEnable=juniIpAdEntIcmpUnreachEnable, juniIpRouteStaticBfdMultiplier=juniIpRouteStaticBfdMultiplier, juniIpRouteTableTrapRouteLimitExceeded=juniIpRouteTableTrapRouteLimitExceeded, juniIpAdEntIfIndex=juniIpAdEntIfIndex, juniIpIfLoopbackUid=juniIpIfLoopbackUid, juniIpMIBNotificationObjectsGroup=juniIpMIBNotificationObjectsGroup, juniIpRouteTableLimit=juniIpRouteTableLimit, juniIpRouteSummaryUnicastStaticRoutes=juniIpRouteSummaryUnicastStaticRoutes, juniIpInterfaceGroup7=juniIpInterfaceGroup7, juniIpCidrRoutePref=juniIpCidrRoutePref, juniIpNotificationGroup1=juniIpNotificationGroup1, juniIpRouteSummaryUnicastLastRouteAddedOrDeletedMask=juniIpRouteSummaryUnicastLastRouteAddedOrDeletedMask, juniIpIfSharesLowerUid=juniIpIfSharesLowerUid, juniIpAdEntAdminStatus=juniIpAdEntAdminStatus, juniIpRouterId=juniIpRouterId, juniIpIfStatsOutSchedDropPackets=juniIpIfStatsOutSchedDropPackets, juniIpTraps=juniIpTraps, juniIpGlobalGroup3=juniIpGlobalGroup3, juniIpAddressGroup=juniIpAddressGroup, juniIpInterfaceGroup6=juniIpInterfaceGroup6, juniIpCompliance2=juniIpCompliance2, juniIpIfSummaryTotalIntfProtUp=juniIpIfSummaryTotalIntfProtUp, juniIpCidrRouteEntry=juniIpCidrRouteEntry, juniIpRouteMulticastSummary=juniIpRouteMulticastSummary, juniIpRouteSummaryMulticastInterAreaOspfRoutes=juniIpRouteSummaryMulticastInterAreaOspfRoutes, juniIpRouteSummaryUnicastRipRoutes=juniIpRouteSummaryUnicastRipRoutes, juniIpRouteSummaryUnicastBgpRoutes=juniIpRouteSummaryUnicastBgpRoutes, juniIpAddrEntry=juniIpAddrEntry, juniIpRoute=juniIpRoute, juniIpIfRowStatus=juniIpIfRowStatus, juniIpIfTypeId=juniIpIfTypeId, juniIpIfSummaryTotalIntf=juniIpIfSummaryTotalIntf, juniIpSourceRoutingAdminStatus=juniIpSourceRoutingAdminStatus, juniIpIfStatsInForwardedPackets=juniIpIfStatsInForwardedPackets, juniIpCompliance=juniIpCompliance, juniIpIfStatsOutForwardedOctets=juniIpIfStatsOutForwardedOctets, juniIpIfAssocLowerIfIndex=juniIpIfAssocLowerIfIndex, juniIpAdEntIsSecondary=juniIpAdEntIsSecondary, juniIpRouteSummaryMulticastIsisRoutes=juniIpRouteSummaryMulticastIsisRoutes, juniIpAdEntAccessRouteHost=juniIpAdEntAccessRouteHost, juniIpCompliance3=juniIpCompliance3, juniIpRouteTableWarnThreshold=juniIpRouteTableWarnThreshold, juniIpCidrRouteArea=juniIpCidrRouteArea, juniIpRouteStaticBfdEnable=juniIpRouteStaticBfdEnable, juniIpIfTable=juniIpIfTable, juniIpAdEntMtu=juniIpAdEntMtu, juniIpRouteSummaryMulticastExternalOspfRoutes=juniIpRouteSummaryMulticastExternalOspfRoutes, juniIpRouteSummaryUnicastIsisLevel1Routes=juniIpRouteSummaryUnicastIsisLevel1Routes, juniIpGlobals=juniIpGlobals, juniIpIfPrimaryIpAddress=juniIpIfPrimaryIpAddress, juniIpRouteSummaryMulticastRipRoutes=juniIpRouteSummaryMulticastRipRoutes, juniIpIfAdminSpeed=juniIpIfAdminSpeed, juniIpRouteStaticTag=juniIpRouteStaticTag, juniIpIfStatsInOctets=juniIpIfStatsInOctets, juniIpAdEntProxyArpRspEnable=juniIpAdEntProxyArpRspEnable, juniIpRouteStaticNextHopAS=juniIpRouteStaticNextHopAS, juniIpRouteSummaryMulticastLastRouteAddedOrDeletedDate=juniIpRouteSummaryMulticastLastRouteAddedOrDeletedDate, juniIpIfTcpMss=juniIpIfTcpMss, juniIpIfLowerIfIndex=juniIpIfLowerIfIndex, juniIpIfPrimaryIpMask=juniIpIfPrimaryIpMask, juniIpIfLoopback=juniIpIfLoopback, juniIpGroups=juniIpGroups, juniIpRouteGroup2=juniIpRouteGroup2, juniIpRouteTableWarnOnly=juniIpRouteTableWarnOnly, juniIpTrapSaValidationFailure=juniIpTrapSaValidationFailure, juniIpAdEntBcastAddr=juniIpAdEntBcastAddr, juniIpRouteSummaryMulticastLastRouteAddedOrDeletedClient=juniIpRouteSummaryMulticastLastRouteAddedOrDeletedClient, juniIpCompliance15=juniIpCompliance15, juniIpRouteSummaryUnicastIsisRoutes=juniIpRouteSummaryUnicastIsisRoutes, juniIpRouteSummaryUnicastLastRouteAddedOrDeletedClient=juniIpRouteSummaryUnicastLastRouteAddedOrDeletedClient, juniIpIfOperDebounceTime=juniIpIfOperDebounceTime, juniIpIfArpTimeout=juniIpIfArpTimeout, juniIpIfInheritNumUid=juniIpIfInheritNumUid, juniIpCidrRouteTable=juniIpCidrRouteTable, juniIpRouteStaticMetric=juniIpRouteStaticMetric, juniIpIfArpSpoofCheck=juniIpIfArpSpoofCheck, juniIpRouteSummaryUnicastIntraAreaOspfRoutes=juniIpRouteSummaryUnicastIntraAreaOspfRoutes, juniIpAddressGroup4=juniIpAddressGroup4, juniIpIfStatsEntry=juniIpIfStatsEntry, juniIpObjects=juniIpObjects, juniIpCompliance12=juniIpCompliance12, juniIpRouteSummaryMulticastAccessRoutes=juniIpRouteSummaryMulticastAccessRoutes, juniIpRouteGroup3=juniIpRouteGroup3, juniIpIfStatsInForwardedOctets=juniIpIfStatsInForwardedOctets, juniIpAddressGroup3=juniIpAddressGroup3, juniIpInterfaceGroup=juniIpInterfaceGroup, juniIpInterfaceGroup5=juniIpInterfaceGroup5, juniIpAdEntIcmpRedirectEnable=juniIpAdEntIcmpRedirectEnable, juniIpRouteStaticPref=juniIpRouteStaticPref, juniIpIfCreationType=juniIpIfCreationType, juniIpRouteStaticBFDEntry=juniIpRouteStaticBFDEntry, juniIpAdEntReasmMaxSize=juniIpAdEntReasmMaxSize, juniIpCompliance9=juniIpCompliance9, juniIpRouteStaticNullIntf=juniIpRouteStaticNullIntf, juniIpIfAutoConfigure=juniIpIfAutoConfigure, juniIpIfSummaryTotalIntfDown=juniIpIfSummaryTotalIntfDown, juniIpAddressGroup2=juniIpAddressGroup2, juniIpRouteStaticNextHop=juniIpRouteStaticNextHop, juniIpRouteStaticTable=juniIpRouteStaticTable, juniIpAdEntUnnumLoopbackIfIndex=juniIpAdEntUnnumLoopbackIfIndex, juniIpIfStatsOutRequestedOctets=juniIpIfStatsOutRequestedOctets, juniIpRouteStaticStatus=juniIpRouteStaticStatus, juniIpRouteStaticRowStatus=juniIpRouteStaticRowStatus, juniIpCompliance11=juniIpCompliance11, juniIpAdEntIrdpEnable=juniIpAdEntIrdpEnable, juniIpAddrTable=juniIpAddrTable, juniIpAdEntDirectedBcastEnable=juniIpAdEntDirectedBcastEnable, juniIpAddress=juniIpAddress, juniIpRouteStaticBfdMinTxInterval=juniIpRouteStaticBfdMinTxInterval, juniIpIfDebounceTime=juniIpIfDebounceTime, juniIpRouteSummaryUnicastLastRouteAddedOrDeletedDate=juniIpRouteSummaryUnicastLastRouteAddedOrDeletedDate, juniIpIfStatsGreenOutSchedDropOctets=juniIpIfStatsGreenOutSchedDropOctets, juniIpRouteSummaryMulticastLevel1IsisRoutes=juniIpRouteSummaryMulticastLevel1IsisRoutes, juniIpIfStatsOutPoliciedOctets=juniIpIfStatsOutPoliciedOctets, juniIpIfAnalyzerMode=juniIpIfAnalyzerMode, juniIpIfSharedNhAddr=juniIpIfSharedNhAddr, juniIpIfStatsTable=juniIpIfStatsTable, juniIpIfStatsRedOutSchedDropPackets=juniIpIfStatsRedOutSchedDropPackets, juniIpBgpAsConfedSetNewFormat=juniIpBgpAsConfedSetNewFormat, juniIpIfStatsOutSchedDropOctets=juniIpIfStatsOutSchedDropOctets, juniIpAdEntAddr=juniIpAdEntAddr, juniIpTrapPrefix=juniIpTrapPrefix, juniIpRouteUnicastSummary=juniIpRouteUnicastSummary, juniIpRouteSummaryUnicastIntCreatedAccessHostRoutes=juniIpRouteSummaryUnicastIntCreatedAccessHostRoutes, juniIpRouteSummaryUnicastTotalBytes=juniIpRouteSummaryUnicastTotalBytes, juniIpIfSAValidationEnable=juniIpIfSAValidationEnable, juniIpIfStatsInErrorPackets=juniIpIfStatsInErrorPackets, juniIpAdEntIcmpMaskReplyEnable=juniIpAdEntIcmpMaskReplyEnable, juniIpRouteStaticBFDGroup=juniIpRouteStaticBFDGroup, juniIpIfStatsInPoliciedOctets=juniIpIfStatsInPoliciedOctets, juniIpAddressDeprecatedGroup=juniIpAddressDeprecatedGroup, juniIpRouteSummaryUnicastConnectedRoutes=juniIpRouteSummaryUnicastConnectedRoutes, juniIpRouteSummaryUnicastExternalOspfRoutes=juniIpRouteSummaryUnicastExternalOspfRoutes, juniIpRouteSummaryMulticastBgpRoutes=juniIpRouteSummaryMulticastBgpRoutes, juniIpRouteSummaryMulticastTotalBytes=juniIpRouteSummaryMulticastTotalBytes, juniIpIfIndex=juniIpIfIndex, juniIpVpnIdOui=juniIpVpnIdOui, juniIpRouteSummaryMulticastTotalRoutes=juniIpRouteSummaryMulticastTotalRoutes, juniIpIfAlwaysUp=juniIpIfAlwaysUp, juniIpCidrRouteTag=juniIpCidrRouteTag, juniIpTrapEnables=juniIpTrapEnables, juniIpAdEntUnnumInheritNumIfIndex=juniIpAdEntUnnumInheritNumIfIndex, juniIpAdEntIgmpEnable=juniIpAdEntIgmpEnable, juniIpRouteSummaryUnicastOtherInternalRoutes=juniIpRouteSummaryUnicastOtherInternalRoutes, juniIpIfStatsYellowOutSchedDropOctets=juniIpIfStatsYellowOutSchedDropOctets, juniIpIfForceFragmentation=juniIpIfForceFragmentation, juniIpRouteGlobals=juniIpRouteGlobals, juniIpRouteGroup4=juniIpRouteGroup4, juniIpAdEntNetMask=juniIpAdEntNetMask, juniIpRouteSummaryMulticastIntraAreaOspfRoutes=juniIpRouteSummaryMulticastIntraAreaOspfRoutes, juniIpRouteSummaryUnicastTotalRoutes=juniIpRouteSummaryUnicastTotalRoutes, juniIpIfForwarding=juniIpIfForwarding, juniIpIfSummaryTotalIntfUp=juniIpIfSummaryTotalIntfUp, juniIpCompliances=juniIpCompliances, juniIpRouteSummaryMulticastRouteMemoryActive=juniIpRouteSummaryMulticastRouteMemoryActive, juniIpRouteSummaryMultiastIntDialoutRoutes=juniIpRouteSummaryMultiastIntDialoutRoutes, juniIpIfStatsIndex=juniIpIfStatsIndex, juniIpRouteSummaryUnicastRouteMemoryActive=juniIpRouteSummaryUnicastRouteMemoryActive, juniIpRouteSummaryMulticastLastRouteAddedOrDeletedIP=juniIpRouteSummaryMulticastLastRouteAddedOrDeletedIP, juniIpIfAssocTable=juniIpIfAssocTable, juniIpIfStatsGreenOutSchedDropPackets=juniIpIfStatsGreenOutSchedDropPackets, juniIpIfAssocIpIfIndex=juniIpIfAssocIpIfIndex, juniIpIfSummaryTotalIntfProtDown=juniIpIfSummaryTotalIntfProtDown, juniIpRouteSummaryUnicastOspfRoutes=juniIpRouteSummaryUnicastOspfRoutes, juniIpRouteSummaryMulticastLastRouteAddedOrDeletedMask=juniIpRouteSummaryMulticastLastRouteAddedOrDeletedMask, juniIpRouteTableWarnPercent=juniIpRouteTableWarnPercent, juniIpRouteStaticDest=juniIpRouteStaticDest, juniIpIfSaValFailSrcIpAddr=juniIpIfSaValFailSrcIpAddr, juniIpInterfaceGroup8=juniIpInterfaceGroup8, juniIpInterface=juniIpInterface, juniIpIfName=juniIpIfName, juniIpIfMultipathMode=juniIpIfMultipathMode, juniIpIfRouterIndex=juniIpIfRouterIndex, juniIpIfStatsInPackets=juniIpIfStatsInPackets, juniIpRouteSummaryUnicastIntDialoutRoutes=juniIpRouteSummaryUnicastIntDialoutRoutes, juniIpRouteStaticEntry=juniIpRouteStaticEntry, juniIpAdEntAccessRouteEnable=juniIpAdEntAccessRouteEnable, juniIpRouteStaticIfIndex=juniIpRouteStaticIfIndex, juniIpIfStatsInPoliciedPackets=juniIpIfStatsInPoliciedPackets, juniIpRouteTableTrapRouteLimitRemove=juniIpRouteTableTrapRouteLimitRemove, juniIpIfStatsRedOutSchedDropOctets=juniIpIfStatsRedOutSchedDropOctets, juniIpInterfaceGroup4=juniIpInterfaceGroup4, juniIpIfSaValFailDestIpAddr=juniIpIfSaValFailDestIpAddr, juniIpRouteSummaryMulticastLevel2IsisRoutes=juniIpRouteSummaryMulticastLevel2IsisRoutes, juniIpIfFilterOptions=juniIpIfFilterOptions, juniIpCompliance8=juniIpCompliance8, juniIpBgpCommunityNewFormat=juniIpBgpCommunityNewFormat, juniIpRouteSummaryMulticastIntCreatedAccessHostRoutes=juniIpRouteSummaryMulticastIntCreatedAccessHostRoutes, juniIpRouteTableTrapWarnThresholdExceeded=juniIpRouteTableTrapWarnThresholdExceeded, juniIpRouteSummaryMulticastOtherInternalRoutes=juniIpRouteSummaryMulticastOtherInternalRoutes, juniIpIfEntry=juniIpIfEntry, juniIpIfStatsInSpoofedPackets=juniIpIfStatsInSpoofedPackets, juniIpIfAssocEntry=juniIpIfAssocEntry, juniIpArpTimeout=juniIpArpTimeout, juniIpSaValidateTrapEnable=juniIpSaValidateTrapEnable, juniIpCompliance14=juniIpCompliance14, juniIpMIBNotificationObjects=juniIpMIBNotificationObjects, juniIpRouteStaticBfdMinRxInterval=juniIpRouteStaticBfdMinRxInterval, PYSNMP_MODULE_ID=juniIpMIB, juniIpIfStatsOutPoliciedPackets=juniIpIfStatsOutPoliciedPackets, juniIpCompliance13=juniIpCompliance13, juniIpGlobalGroup2=juniIpGlobalGroup2, juniIpRouteSummaryUnicastLastRouteAddedOrDeletedIP=juniIpRouteSummaryUnicastLastRouteAddedOrDeletedIP, juniIpInterfaceGroup9=juniIpInterfaceGroup9, juniIpConformance=juniIpConformance, juniIpNextIfIndex=juniIpNextIfIndex, juniIpGlobalGroup=juniIpGlobalGroup, juniIpAdEntArpRspEnable=juniIpAdEntArpRspEnable, juniIpDebounceTime=juniIpDebounceTime, juniIpIfType=juniIpIfType, juniIpRouteSummaryGroup=juniIpRouteSummaryGroup, juniIpRouteLimit=juniIpRouteLimit, juniIpRouteGroup=juniIpRouteGroup, juniIpCompliance10=juniIpCompliance10, juniIpRouteSummaryMulticastOspfRoutes=juniIpRouteSummaryMulticastOspfRoutes, juniIpCompliance7=juniIpCompliance7, juniIpIfProfileId=juniIpIfProfileId, juniIpInterfaceGroup2=juniIpInterfaceGroup2, juniIpRouteSummaryUnicastAccessRoutes=juniIpRouteSummaryUnicastAccessRoutes, juniIpIfInitSeqPrefAdmin=juniIpIfInitSeqPrefAdmin, juniIpCompliance5=juniIpCompliance5, juniIpIfSummaryGroup=juniIpIfSummaryGroup, juniIpIfSharedNhRouterId=juniIpIfSharedNhRouterId, juniIpAddrGlobals=juniIpAddrGlobals, juniIpIfInheritNum=juniIpIfInheritNum, juniIpIfSummary=juniIpIfSummary, juniIpRouteSummaryUnicastIsisLevel2Routes=juniIpRouteSummaryUnicastIsisLevel2Routes, juniIpInterfaceGroup3=juniIpInterfaceGroup3, juniIpVpnIdIndex=juniIpVpnIdIndex, juniIpRouteSummaryMulticastConnectedRoutes=juniIpRouteSummaryMulticastConnectedRoutes, juniIpInterfaceDeprecatedGroup=juniIpInterfaceDeprecatedGroup, juniIpIfStatsOutForwardedPackets=juniIpIfStatsOutForwardedPackets, juniIpMIB=juniIpMIB, juniIpIfSummaryTotalIntfProtNotPresent=juniIpIfSummaryTotalIntfProtNotPresent, juniIpCompliance6=juniIpCompliance6, juniIpNotificationGroup=juniIpNotificationGroup, juniIpCompliance4=juniIpCompliance4, juniIpRouteStaticBFDTable=juniIpRouteStaticBFDTable, juniIpRouteSummary=juniIpRouteSummary, juniIpAdEntRowStatus=juniIpAdEntRowStatus, juniIpRouteSummaryMulticastStaticRoutes=juniIpRouteSummaryMulticastStaticRoutes, juniIpIfStatsOutRequestedPackets=juniIpIfStatsOutRequestedPackets, juniIpIfInitSeqPrefOper=juniIpIfInitSeqPrefOper)
