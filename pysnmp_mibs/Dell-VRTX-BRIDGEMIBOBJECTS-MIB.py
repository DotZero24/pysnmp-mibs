# SNMP MIB module (Dell-VRTX-BRIDGEMIBOBJECTS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-VRTX-BRIDGEMIBOBJECTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:09:46 2025
...
rldot1dStpVlanEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1dStpVlan"),
)
if mibBuilder.loadTexts:
...
rldot1dStpVlanPortEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1dStpVlanPortVlan"),
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1dStpVlanPortPort"),
)
if mibBuilder.loadTexts:
...
rldot1dStpPortEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1dStpPortPort"),
)
if mibBuilder.loadTexts:
...
rldot1wRStpVlanEdgePortEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1wRStpVlanEdgePortVlan"),
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1wRStpVlanEdgePortPort"),
)
if mibBuilder.loadTexts:
...
rldot1wRStpForceVersionEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1wRStpForceVersionVlan"),
)
if mibBuilder.loadTexts:
...
rldot1pPriorityMapEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1pPriorityMapName"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpInstanceEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpInstanceId"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpInstancePortEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpInstancePortMstiId"),
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpInstancePortPort"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpVlanEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpVlan"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpExtPortEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpExtPortPort"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpInstanceVlanEntry.setIndexNames(
    (0, "Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpInstanceVlanId"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "Dell-VRTX-BRIDGEMIBOBJECTS-MIB",
    **{"VlanList1": VlanList1,
       "VlanList2": VlanList2,
       "VlanList3": VlanList3,
       "VlanList4": VlanList4,
