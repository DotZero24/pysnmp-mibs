...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/meinberg/MBG-SNMP-XPT-MIB
...
mibBuilder.exportSymbols("MBG-SNMP-XPT-MIB", mbgGPSTrapPowerSupplyFailure=mbgGPSTrapPowerSupplyFailure, mbgXPTCompliances=mbgXPTCompliances, mbgGPSRef1GpsSatellitesInView=mbgGPSRef1GpsSatellitesInView, mbgGPSRef2GpsSatellitesInView=mbgGPSRef2GpsSatellitesInView, mbgXPT=mbgXPT, mbgGPSRefclock1ModeVal=mbgGPSRefclock1ModeVal, mbgSCUMasterselect=mbgSCUMasterselect, mbgGPSRefclock2=mbgGPSRefclock2, mbgGPSRef1GpsStateVal=mbgGPSRef1GpsStateVal, PYSNMP_MODULE_ID=mbgXPT, mbgGPSRef1GpsSatellites=mbgGPSRef1GpsSatellites, mbgGPSRef2GpsState=mbgGPSRef2GpsState, mbgSCUType=mbgSCUType, mbgGPSRefclock2Type=mbgGPSRefclock2Type, mbgSCUACOMode=mbgSCUACOMode, mbgSCUPSU1Status=mbgSCUPSU1Status, mbgSCUTypeVal=mbgSCUTypeVal, mbgGPSNavSolved=mbgGPSNavSolved, mbgSCUPSU2Status=mbgSCUPSU2Status, mbgSCUMaster=mbgSCUMaster, mbgSCUTimelimitError=mbgSCUTimelimitError, mbgGPSTrapAntennaFaulty=mbgGPSTrapAntennaFaulty, mbgGPSRefclock1Type=mbgGPSRefclock1Type, mbgGPSTrapLANXPTBoot=mbgGPSTrapLANXPTBoot, mbgSCUDisableOutputs=mbgSCUDisableOutputs, mbgGPSTrapPowerSupplyOK=mbgGPSTrapPowerSupplyOK, mbgGPSRef2GpsStateVal=mbgGPSRef2GpsStateVal, mbgXPTObjectsGroup=mbgXPTObjectsGroup, mbgSCUTimeSync2=mbgSCUTimeSync2, mbgGPSRef1GpsState=mbgGPSRef1GpsState, mbgXPTTrapsGroup=mbgXPTTrapsGroup, mbgGPSTrapMasterclockSwitchover=mbgGPSTrapMasterclockSwitchover, mbgGPSRef1GpsSatellitesGood=mbgGPSRef1GpsSatellitesGood, mbgGPSTrapLeapSecondAnnounced=mbgGPSTrapLeapSecondAnnounced, mbgGPSRefclock2ModeVal=mbgGPSRefclock2ModeVal, mbgSCUTimeSync1=mbgSCUTimeSync1, mbgSCUMasterselectVal=mbgSCUMasterselectVal, mbgGPSRefclock2TypeVal=mbgGPSRefclock2TypeVal, mbgGPSRef2GpsSatellitesGood=mbgGPSRef2GpsSatellitesGood, mbgSCUSelectedInputVal=mbgSCUSelectedInputVal, mbgSCUMasterVal=mbgSCUMasterVal, mbgXPTCompliance=mbgXPTCompliance, mbgGPSTrapReceiverNotResponding=mbgGPSTrapReceiverNotResponding, mbgXPTGroups=mbgXPTGroups, mbgGPSRefclock1TypeVal=mbgGPSRefclock1TypeVal, mbgGPSRef2GpsPosition=mbgGPSRef2GpsPosition, mbgGPSTrapWarmBoot=mbgGPSTrapWarmBoot, mbgGPSRefclock1=mbgGPSRefclock1, mbgSCU=mbgSCU, mbgXPTTraps=mbgXPTTraps, mbgSCUPSUStatus=mbgSCUPSUStatus, mbgGPSRefclock2Mode=mbgGPSRefclock2Mode, mbgGPSRef1GpsPosition=mbgGPSRef1GpsPosition, mbgGPSRefclock1Mode=mbgGPSRefclock1Mode, mbgGPSRef2GpsSatellites=mbgGPSRef2GpsSatellites, mbgGPSTrapColdBoot=mbgGPSTrapColdBoot, mbgGPSTrapReceiverNotSync=mbgGPSTrapReceiverNotSync, mbgGPSTrapTestNotification=mbgGPSTrapTestNotification, mbgXPTConformance=mbgXPTConformance, mbgSCUSelectedInput=mbgSCUSelectedInput, mbgGPSTrapAntennaReconnect=mbgGPSTrapAntennaReconnect)
