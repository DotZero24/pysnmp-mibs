...
mibBuilder.exportSymbols("MBG-SNMP-XPT-MIB", mbgGPSRef1GpsStateVal=mbgGPSRef1GpsStateVal, mbgSCUMasterselectVal=mbgSCUMasterselectVal, mbgSCUPSU2Status=mbgSCUPSU2Status, mbgGPSTrapColdBoot=mbgGPSTrapColdBoot, mbgXPTGroups=mbgXPTGroups, mbgSCUTypeVal=mbgSCUTypeVal, mbgGPSRefclock1TypeVal=mbgGPSRefclock1TypeVal, mbgSCUDisableOutputs=mbgSCUDisableOutputs, mbgSCUPSU1Status=mbgSCUPSU1Status, mbgGPSRef2GpsSatellites=mbgGPSRef2GpsSatellites, mbgSCUMaster=mbgSCUMaster, mbgGPSRef2GpsSatellitesInView=mbgGPSRef2GpsSatellitesInView, mbgGPSRefclock2Type=mbgGPSRefclock2Type, mbgSCUMasterVal=mbgSCUMasterVal, mbgGPSRef1GpsState=mbgGPSRef1GpsState, mbgSCUSelectedInput=mbgSCUSelectedInput, mbgSCU=mbgSCU, mbgGPSRef1GpsSatellitesGood=mbgGPSRef1GpsSatellitesGood, mbgGPSRefclock2Mode=mbgGPSRefclock2Mode, mbgGPSRefclock1=mbgGPSRefclock1, mbgGPSRef2GpsState=mbgGPSRef2GpsState, mbgXPTConformance=mbgXPTConformance, mbgGPSTrapPowerSupplyOK=mbgGPSTrapPowerSupplyOK, mbgXPTTraps=mbgXPTTraps, mbgXPT=mbgXPT, mbgGPSRef2GpsSatellitesGood=mbgGPSRef2GpsSatellitesGood, mbgSCUType=mbgSCUType, mbgSCUTimeSync2=mbgSCUTimeSync2, mbgGPSTrapLANXPTBoot=mbgGPSTrapLANXPTBoot, mbgXPTObjectsGroup=mbgXPTObjectsGroup, PYSNMP_MODULE_ID=mbgXPT, mbgGPSRef2GpsStateVal=mbgGPSRef2GpsStateVal, mbgGPSRefclock2ModeVal=mbgGPSRefclock2ModeVal, mbgGPSNavSolved=mbgGPSNavSolved, mbgGPSTrapReceiverNotSync=mbgGPSTrapReceiverNotSync, mbgGPSRef2GpsPosition=mbgGPSRef2GpsPosition, mbgXPTCompliances=mbgXPTCompliances, mbgGPSRefclock2TypeVal=mbgGPSRefclock2TypeVal, mbgSCUTimeSync1=mbgSCUTimeSync1, mbgGPSRef1GpsSatellites=mbgGPSRef1GpsSatellites, mbgGPSRefclock1Mode=mbgGPSRefclock1Mode, mbgGPSRefclock1Type=mbgGPSRefclock1Type, mbgSCUTimelimitError=mbgSCUTimelimitError, mbgSCUACOMode=mbgSCUACOMode, mbgGPSTrapLeapSecondAnnounced=mbgGPSTrapLeapSecondAnnounced, mbgGPSTrapPowerSupplyFailure=mbgGPSTrapPowerSupplyFailure, mbgXPTCompliance=mbgXPTCompliance, mbgGPSTrapAntennaFaulty=mbgGPSTrapAntennaFaulty, mbgGPSTrapAntennaReconnect=mbgGPSTrapAntennaReconnect, mbgGPSTrapMasterclockSwitchover=mbgGPSTrapMasterclockSwitchover, mbgSCUSelectedInputVal=mbgSCUSelectedInputVal, mbgSCUMasterselect=mbgSCUMasterselect, mbgGPSRef1GpsPosition=mbgGPSRef1GpsPosition, mbgSCUPSUStatus=mbgSCUPSUStatus, mbgXPTTrapsGroup=mbgXPTTrapsGroup, mbgGPSRef1GpsSatellitesInView=mbgGPSRef1GpsSatellitesInView, mbgGPSRefclock2=mbgGPSRefclock2, mbgGPSRefclock1ModeVal=mbgGPSRefclock1ModeVal, mbgGPSTrapTestNotification=mbgGPSTrapTestNotification, mbgGPSTrapReceiverNotResponding=mbgGPSTrapReceiverNotResponding, mbgGPSTrapWarmBoot=mbgGPSTrapWarmBoot)
