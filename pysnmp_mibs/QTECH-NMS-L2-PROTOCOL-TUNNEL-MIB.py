...
l2ptMIBObjects=_L2ptMIBObjects_ObjectIdentity((1,3,6,1,4,1,34751,9,357,1))
_L2ptGlobal_ObjectIdentity=ObjectIdentity
l2ptGlobal=_L2ptGlobal_ObjectIdentity((1,3,6,1,4,1,34751,9,357,1,1))
_L2ptIntfTable_Object=MibTable
l2ptIntfTable=_L2ptIntfTable_Object((1,3,6,1,4,1,34751,9,357,1,2))
if mibBuilder.loadTexts:l2ptIntfTable.setStatus(_A)
_L2ptIntfEntry_Object=MibTableRow
l2ptIntfEntry=_L2ptIntfEntry_Object((1,3,6,1,4,1,34751,9,357,1,2,1))
...
l2ptIntfStpTnl=_L2ptIntfStpTnl_Object((1,3,6,1,4,1,34751,9,357,1,2,1,1),_L2ptIntfStpTnl_Type())
l2ptIntfStpTnl.setMaxAccess('read-write')
if mibBuilder.loadTexts:l2ptIntfStpTnl.setStatus(_A)
mibBuilder.exportSymbols('QTECH-NMS-L2-PROTOCOL-TUNNEL-MIB',**{'nmsL2ProtocolTunnelMIB':nmsL2ProtocolTunnelMIB,'l2ptMIBObjects':l2ptMIBObjects,'l2ptGlobal':l2ptGlobal,'l2ptIntfTable':l2ptIntfTable,'l2ptIntfEntry':l2ptIntfEntry,'l2ptIntfStpTnl':l2ptIntfStpTnl})