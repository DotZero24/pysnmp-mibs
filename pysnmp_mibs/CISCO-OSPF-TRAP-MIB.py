...
cospfShamLinkNeighborId, cospfShamLinksRemoteIpAddrType, cospfAreaNssaTranslatorState, cospfShamLinkLocalIpAddress, cospfShamLinksState, cospfLsdbType, cospfShamLinkAreaId, cospfShamLinkNbrIpAddrType, cospfShamLinkState, cospfShamLinkNbrIpAddr, cospfShamLinksLocalIpAddrType, cospfShamLinkNbrRtrId, cospfShamLinkNbrArea, cospfShamLinkNbrState, cospfShamLinksLocalIpAddr, cospfShamLinksRemoteIpAddr, cospfShamLinksAreaId = mibBuilder.importSymbols("CISCO-OSPF-MIB", "cospfShamLinkNeighborId", "cospfShamLinksRemoteIpAddrType", "cospfAreaNssaTranslatorState", "cospfShamLinkLocalIpAddress", "cospfShamLinksState", "cospfLsdbType", "cospfShamLinkAreaId", "cospfShamLinkNbrIpAddrType", "cospfShamLinkState", "cospfShamLinkNbrIpAddr", "cospfShamLinksLocalIpAddrType", "cospfShamLinkNbrRtrId", "cospfShamLinkNbrArea", "cospfShamLinkNbrState", "cospfShamLinksLocalIpAddr", "cospfShamLinksRemoteIpAddr", "cospfShamLinksAreaId")
ciscoExperiment, = mibBuilder.importSymbols("CISCO-SMI", "ciscoExperiment")
ospfIfIpAddress, ospfAddressLessIf, ospfVirtIfNeighbor, ospfVirtIfAreaId, ospfNbrRtrId, ospfAreaId, ospfLsdbAreaId, ospfRouterId, ospfLsdbRouterId, ospfLsdbLsid = mibBuilder.importSymbols("OSPF-MIB", "ospfIfIpAddress", "ospfAddressLessIf", "ospfVirtIfNeighbor", "ospfVirtIfAreaId", "ospfNbrRtrId", "ospfAreaId", "ospfLsdbAreaId", "ospfRouterId", "ospfLsdbRouterId", "ospfLsdbLsid")
...
mibBuilder.exportSymbols("CISCO-OSPF-TRAP-MIB", cospfPacketType=cospfPacketType, cospfShamLinkAuthFailure=cospfShamLinkAuthFailure, ciscoOspfTrapMIBNotifs=ciscoOspfTrapMIBNotifs, cospfSetTrap=cospfSetTrap, cospfConfigErrorType=cospfConfigErrorType, ciscoOspfTrapEventGroupRev1=ciscoOspfTrapEventGroupRev1, cospfShamLinkNbrStateChange=cospfShamLinkNbrStateChange, cospfVirtIfConfigError=cospfVirtIfConfigError, cospfTxRetransmit=cospfTxRetransmit, cospfShamLinksStateChange=cospfShamLinksStateChange, cospfTrapControl=cospfTrapControl, cospfMaxAgeLsa=cospfMaxAgeLsa, ciscoOspfTrapMIBConform=ciscoOspfTrapMIBConform, cospfShamLinkRxBadPacket=cospfShamLinkRxBadPacket, ciscoOspfTrapMIBCompliances=ciscoOspfTrapMIBCompliances, ciscoOspfTrapMIBCompliance=ciscoOspfTrapMIBCompliance, ciscoOspfTrapMIBObjects=ciscoOspfTrapMIBObjects, cospfShamLinkConfigError=cospfShamLinkConfigError, cospfShamLinkTxRetransmit=cospfShamLinkTxRetransmit, cospfPacketSrc=cospfPacketSrc, cospfOriginateLsa=cospfOriginateLsa, ciscoOspfTrapMIB=ciscoOspfTrapMIB, cospfIfConfigError=cospfIfConfigError, cospfVirtIfTxRetransmit=cospfVirtIfTxRetransmit, ciscoOspfTrapMIBGroups=ciscoOspfTrapMIBGroups, ciscoOspfTrapEventGroup=ciscoOspfTrapEventGroup, cospfShamLinkStateChange=cospfShamLinkStateChange, PYSNMP_MODULE_ID=ciscoOspfTrapMIB, ciscoOspfTrapMIBComplianceRev1=ciscoOspfTrapMIBComplianceRev1, ciscoOspfTrapControlGroup=ciscoOspfTrapControlGroup, cospfNssaTranslatorStatusChange=cospfNssaTranslatorStatusChange)
