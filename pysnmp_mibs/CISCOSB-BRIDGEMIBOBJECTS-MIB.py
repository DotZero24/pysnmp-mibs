...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-BRIDGEMIBOBJECTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:41:45 2025
...
rldot1sMStpInstancePortBpduSent = _Rldot1sMStpInstancePortBpduSent_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 2, 1, 14),
    _Rldot1sMStpInstancePortBpduSent_Type()
)
rldot1sMStpInstancePortBpduSent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rldot1sMStpInstancePortBpduSent.setStatus("current")
_Rldot1sMStpInstancePortBpduReceived_Type = Counter32
_Rldot1sMStpInstancePortBpduReceived_Object = MibTableColumn
rldot1sMStpInstancePortBpduReceived = _Rldot1sMStpInstancePortBpduReceived_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 2, 1, 15),
    _Rldot1sMStpInstancePortBpduReceived_Type()
)
rldot1sMStpInstancePortBpduReceived.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rldot1sMStpInstancePortBpduReceived.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"VlanList1": VlanList1,
       ...
       "rldot1sMStpInstancePortBpduSent": rldot1sMStpInstancePortBpduSent,
       "rldot1sMStpInstancePortBpduReceived": rldot1sMStpInstancePortBpduReceived,
