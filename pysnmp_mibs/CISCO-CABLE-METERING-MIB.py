...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CABLE-METERING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:01 2025
...
_CcmtrCollectionIpAddrType_Type.__name__ = "InetAddressType"
...
_CcmtrCollectionSecure_Type.__name__ = "TruthValue"
...
_CcmtrCollectionCpeList_Type.__name__ = "TruthValue"
...
_CcmtrCollectionAggregate_Type.__name__ = "TruthValue"
...
_CcmtrCollectionSrcIfIndex_Type.__name__ = "InterfaceIndexOrZero"
...
_CcmtrMeteringNotifEnable_Type.__name__ = "TruthValue"
...
ciscoCableMeteringCompliance.setObjects(
      *(("CISCO-CABLE-METERING-MIB", "ccmtrMeteringObjGroup"),
        ("CISCO-CABLE-METERING-MIB", "ccmtrMeteringNotifCtrlGroup"),
        ("CISCO-CABLE-METERING-MIB", "ccmtrMeteringNotifGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCableMeteringComplianceRev1.setObjects(
      *(("CISCO-CABLE-METERING-MIB", "ccmtrMeteringNotifCtrlGroup"),
        ("CISCO-CABLE-METERING-MIB", "ccmtrMeteringNotifGroup"),
        ("CISCO-CABLE-METERING-MIB", "ccmtrMeteringObjGroupRev1"),
        ("CISCO-CABLE-METERING-MIB", "ccmtrMeteringSrcIntfObjGroup"),
        ("CISCO-CABLE-METERING-MIB", "ccmtrMeteringRateCtrlObjGroup"))
)
if mibBuilder.loadTexts:
