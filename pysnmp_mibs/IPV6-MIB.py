...
DisplayString, VariablePointer, TimeStamp, RowPointer, PhysAddress, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "VariablePointer", "TimeStamp", "RowPointer", "PhysAddress", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("IPV6-MIB", ipv6IfStatsReasmReqds=ipv6IfStatsReasmReqds, ipv6RouteNumber=ipv6RouteNumber, ipv6AddrPrefix=ipv6AddrPrefix, ipv6AddrEntry=ipv6AddrEntry, ipv6AddrPrefixAdvPreferredLifetime=ipv6AddrPrefixAdvPreferredLifetime, ipv6IfStatsInTruncatedPkts=ipv6IfStatsInTruncatedPkts, ipv6IfStatsInHdrErrors=ipv6IfStatsInHdrErrors, ipv6NetToMediaValid=ipv6NetToMediaValid, ipv6IfStatsOutMcastPkts=ipv6IfStatsOutMcastPkts, ipv6AddrType=ipv6AddrType, ipv6IfEffectiveMtu=ipv6IfEffectiveMtu, ipv6AddrAddress=ipv6AddrAddress, ipv6IfNetToMediaLastUpdated=ipv6IfNetToMediaLastUpdated, ipv6RouteNextHop=ipv6RouteNextHop, ipv6Forwarding=ipv6Forwarding, ipv6Interfaces=ipv6Interfaces, ipv6NetToMediaType=ipv6NetToMediaType, ipv6IfStatsOutForwDatagrams=ipv6IfStatsOutForwDatagrams, ipv6IfIdentifier=ipv6IfIdentifier, ipv6IfIdentifierLength=ipv6IfIdentifierLength, ipv6IfNetToMediaState=ipv6IfNetToMediaState, PYSNMP_MODULE_ID=ipv6MIB, ipv6IfStatsOutFragCreates=ipv6IfStatsOutFragCreates, ipv6NetToMediaTable=ipv6NetToMediaTable, ipv6AddrStatus=ipv6AddrStatus, ipv6AddrTable=ipv6AddrTable, ipv6IfLastChange=ipv6IfLastChange, ipv6MIB=ipv6MIB, ipv6AddrPrefixLength=ipv6AddrPrefixLength, ipv6RouteMetric=ipv6RouteMetric, ipv6RouteTable=ipv6RouteTable, ipv6RouteIndex=ipv6RouteIndex, ipv6Conformance=ipv6Conformance, ipv6NetToMediaEntry=ipv6NetToMediaEntry, ipv6Notifications=ipv6Notifications, ipv6RouteAge=ipv6RouteAge, ipv6RouteEntry=ipv6RouteEntry, ipv6IfStatsInMcastPkts=ipv6IfStatsInMcastPkts, ipv6AddrPrefixAdvValidLifetime=ipv6AddrPrefixAdvValidLifetime, ipv6Compliances=ipv6Compliances, ipv6RouteType=ipv6RouteType, ipv6Groups=ipv6Groups, ipv6RouteInfo=ipv6RouteInfo, ipv6IfDescr=ipv6IfDescr, ipv6IfReasmMaxSize=ipv6IfReasmMaxSize, ipv6IfStatsInTooBigErrors=ipv6IfStatsInTooBigErrors, ipv6IfStatsInReceives=ipv6IfStatsInReceives, ipv6AddrPrefixAutonomousFlag=ipv6AddrPrefixAutonomousFlag, ipv6IfStateChange=ipv6IfStateChange, ipv6AddrPfxLength=ipv6AddrPfxLength, ipv6IfPhysicalAddress=ipv6IfPhysicalAddress, ipv6IfStatsOutRequests=ipv6IfStatsOutRequests, ipv6IfStatsOutFragFails=ipv6IfStatsOutFragFails, ipv6MIBObjects=ipv6MIBObjects, ipv6AddrPrefixEntry=ipv6AddrPrefixEntry, ipv6IfIndex=ipv6IfIndex, ipv6IfLowerLayer=ipv6IfLowerLayer, ipv6RouteIfIndex=ipv6RouteIfIndex, ipv6RoutePolicy=ipv6RoutePolicy, ipv6RouteValid=ipv6RouteValid, ipv6IfStatsOutDiscards=ipv6IfStatsOutDiscards, ipv6AddrPrefixOnLinkFlag=ipv6AddrPrefixOnLinkFlag, ipv6AddrPrefixTable=ipv6AddrPrefixTable, ipv6IfOperStatus=ipv6IfOperStatus, ipv6NotificationPrefix=ipv6NotificationPrefix, ipv6IfAdminStatus=ipv6IfAdminStatus, ipv6IfTable=ipv6IfTable, ipv6IfTableLastChange=ipv6IfTableLastChange, ipv6Compliance=ipv6Compliance, ipv6RouteDest=ipv6RouteDest, ipv6IfStatsEntry=ipv6IfStatsEntry, ipv6RouteNextHopRDI=ipv6RouteNextHopRDI, ipv6IfStatsInAddrErrors=ipv6IfStatsInAddrErrors, ipv6IfStatsInDelivers=ipv6IfStatsInDelivers, ipv6IfStatsInUnknownProtos=ipv6IfStatsInUnknownProtos, ipv6IfEntry=ipv6IfEntry, ipv6GeneralGroup=ipv6GeneralGroup, ipv6NetToMediaPhysAddress=ipv6NetToMediaPhysAddress, ipv6AddrAnycastFlag=ipv6AddrAnycastFlag, ipv6IfStatsInDiscards=ipv6IfStatsInDiscards, ipv6IfStatsOutFragOKs=ipv6IfStatsOutFragOKs, ipv6NetToMediaNetAddress=ipv6NetToMediaNetAddress, ipv6DiscardedRoutes=ipv6DiscardedRoutes, ipv6NotificationGroup=ipv6NotificationGroup, ipv6IfStatsReasmFails=ipv6IfStatsReasmFails, ipv6RoutePfxLength=ipv6RoutePfxLength, ipv6RouteProtocol=ipv6RouteProtocol, ipv6DefaultHopLimit=ipv6DefaultHopLimit, ipv6RouteWeight=ipv6RouteWeight, ipv6IfStatsInNoRoutes=ipv6IfStatsInNoRoutes, ipv6IfStatsTable=ipv6IfStatsTable, ipv6IfStatsReasmOKs=ipv6IfStatsReasmOKs)
