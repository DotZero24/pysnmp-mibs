...
# Notes
# -----
# ASN.1 source file://mibs/siaemic/SIAE-AGGRL1-MANAGEMENT-MIB
...
aggrL1CarrierTable = _AggrL1CarrierTable_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 83, 9)
)
if mibBuilder.loadTexts:
    aggrL1CarrierTable.setStatus("current")
_AggrL1CarrierEntry_Object = MibTableRow
aggrL1CarrierEntry = _AggrL1CarrierEntry_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 83, 9, 1)
)
aggrL1CarrierEntry.setIndexNames(
    (0, "SIAE-AGGRL1-MANAGEMENT-MIB", "aggrL1ConnAggregableIndex"),
    (0, "SIAE-AGGRL1-MANAGEMENT-MIB", "aggrL1ConnAggregableType"),
)
if mibBuilder.loadTexts:
    aggrL1CarrierEntry.setStatus("current")
_AggrL1CarrierIpAddress_Type = IpAddress
_AggrL1CarrierIpAddress_Object = MibTableColumn
aggrL1CarrierIpAddress = _AggrL1CarrierIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 83, 9, 1, 1),
    _AggrL1CarrierIpAddress_Type()
)
aggrL1CarrierIpAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    aggrL1CarrierIpAddress.setStatus("current")
_AggrL1CarrierMinCapacity_Type = Integer32
_AggrL1CarrierMinCapacity_Object = MibTableColumn
aggrL1CarrierMinCapacity = _AggrL1CarrierMinCapacity_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 83, 9, 1, 2),
    _AggrL1CarrierMinCapacity_Type()
)
aggrL1CarrierMinCapacity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    aggrL1CarrierMinCapacity.setStatus("current")
if mibBuilder.loadTexts:
    aggrL1CarrierMinCapacity.setUnits("Kbps")
_AggrL1CarrierMaxCapacity_Type = Integer32
_AggrL1CarrierMaxCapacity_Object = MibTableColumn
aggrL1CarrierMaxCapacity = _AggrL1CarrierMaxCapacity_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 83, 9, 1, 3),
    _AggrL1CarrierMaxCapacity_Type()
)
aggrL1CarrierMaxCapacity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    aggrL1CarrierMaxCapacity.setStatus("current")
if mibBuilder.loadTexts:
    aggrL1CarrierMaxCapacity.setUnits("Kbps")
...
mibBuilder.exportSymbols(
    ...
    **{"AggregableType": AggregableType,
       ...
       "aggrL1CarrierTable": aggrL1CarrierTable,
       "aggrL1CarrierEntry": aggrL1CarrierEntry,
       "aggrL1CarrierIpAddress": aggrL1CarrierIpAddress,
       "aggrL1CarrierMinCapacity": aggrL1CarrierMinCapacity,
       "aggrL1CarrierMaxCapacity": aggrL1CarrierMaxCapacity}
)
