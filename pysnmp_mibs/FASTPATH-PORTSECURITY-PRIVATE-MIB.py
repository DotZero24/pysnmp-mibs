# SNMP MIB module (FASTPATH-PORTSECURITY-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-PORTSECURITY-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:07:59 2025
...
agentPortSecurityDynamicEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "FASTPATH-PORTSECURITY-PRIVATE-MIB", "agentPortSecurityDynamicVLANId"),
    (0, "FASTPATH-PORTSECURITY-PRIVATE-MIB", "agentPortSecurityDynamicMACAddress"),
)
if mibBuilder.loadTexts:
...
agentPortSecurityViolation.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("FASTPATH-PORTSECURITY-PRIVATE-MIB", "agentPortSecurityLastDiscardedMAC"))
)
if mibBuilder.loadTexts:
