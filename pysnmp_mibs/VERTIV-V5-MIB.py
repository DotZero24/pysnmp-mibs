...
# Notes
# -----
# ASN.1 source file://mibs/geist/VERTIV-V5-MIB
...
pduPhaseResCurrentDetected = _PduPhaseResCurrentDetected_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 2, 1, 20),
    _PduPhaseResCurrentDetected_Type()
)
pduPhaseResCurrentDetected.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pduPhaseResCurrentDetected.setStatus("current")
...
pduBreakerResCurrentDetected = _PduBreakerResCurrentDetected_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 3, 1, 20),
    _PduBreakerResCurrentDetected_Type()
)
pduBreakerResCurrentDetected.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pduBreakerResCurrentDetected.setStatus("current")
_PduBreakerLossOfLoadDetected_Type = TruthValue
_PduBreakerLossOfLoadDetected_Object = MibTableColumn
pduBreakerLossOfLoadDetected = _PduBreakerLossOfLoadDetected_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 3, 1, 21),
    _PduBreakerLossOfLoadDetected_Type()
)
pduBreakerLossOfLoadDetected.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pduBreakerLossOfLoadDetected.setStatus("current")
...
pduResidualCurrentTable = _PduResidualCurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 7)
)
if mibBuilder.loadTexts:
    pduResidualCurrentTable.setStatus("current")
_PduResidualCurrentEntry_Object = MibTableRow
pduResidualCurrentEntry = _PduResidualCurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 7, 1)
)
pduResidualCurrentEntry.setIndexNames(
    (0, "VERTIV-V5-MIB", "pduResidualCurrentIndex"),
)
if mibBuilder.loadTexts:
    pduResidualCurrentEntry.setStatus("current")


class _PduResidualCurrentIndex_Type(Integer32):
    """Custom type pduResidualCurrentIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 100),
    )
...
_PduResidualCurrentIndex_Type.__name__ = "Integer32"
_PduResidualCurrentIndex_Object = MibTableColumn
pduResidualCurrentIndex = _PduResidualCurrentIndex_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 7, 1, 1),
    _PduResidualCurrentIndex_Type()
)
pduResidualCurrentIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    pduResidualCurrentIndex.setStatus("current")


class _PduResidualCurrentName_Type(SnmpAdminString):
    """Custom type pduResidualCurrentName based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 25),
    )
...
_PduResidualCurrentName_Type.__name__ = "SnmpAdminString"
_PduResidualCurrentName_Object = MibTableColumn
pduResidualCurrentName = _PduResidualCurrentName_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 7, 1, 2),
    _PduResidualCurrentName_Type()
)
pduResidualCurrentName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pduResidualCurrentName.setStatus("current")


class _PduResidualCurrentLabel_Type(SnmpAdminString):
    """Custom type pduResidualCurrentLabel based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 25),
    )
...
_PduResidualCurrentLabel_Type.__name__ = "SnmpAdminString"
_PduResidualCurrentLabel_Object = MibTableColumn
pduResidualCurrentLabel = _PduResidualCurrentLabel_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 7, 1, 3),
    _PduResidualCurrentLabel_Type()
)
pduResidualCurrentLabel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pduResidualCurrentLabel.setStatus("current")


class _PduResidualCurrentAggregate_Type(Gauge32):
    """Custom type pduResidualCurrentAggregate based on Gauge32"""
    subtypeSpec = Gauge32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_PduResidualCurrentAggregate_Type.__name__ = "Gauge32"
_PduResidualCurrentAggregate_Object = MibTableColumn
pduResidualCurrentAggregate = _PduResidualCurrentAggregate_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 7, 1, 4),
    _PduResidualCurrentAggregate_Type()
)
pduResidualCurrentAggregate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pduResidualCurrentAggregate.setStatus("current")
if mibBuilder.loadTexts:
    pduResidualCurrentAggregate.setUnits("milliamps")


class _PduResidualCurrentDc_Type(Gauge32):
    """Custom type pduResidualCurrentDc based on Gauge32"""
    subtypeSpec = Gauge32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1000),
    )
...
_PduResidualCurrentDc_Type.__name__ = "Gauge32"
_PduResidualCurrentDc_Object = MibTableColumn
pduResidualCurrentDc = _PduResidualCurrentDc_Object(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 3, 7, 1, 5),
    _PduResidualCurrentDc_Type()
)
pduResidualCurrentDc.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pduResidualCurrentDc.setStatus("current")
if mibBuilder.loadTexts:
    pduResidualCurrentDc.setUnits("milliamps")
...
pduResidualCurrentAggregateNOTIFY = NotificationType(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 32767, 0, 12004)
)
pduResidualCurrentAggregateNOTIFY.setObjects(
      *(("VERTIV-V5-MIB", "pduResidualCurrentAggregate"),
        ("VERTIV-V5-MIB", "trapThreshType"),
        ("VERTIV-V5-MIB", "trapSeverity"),
        ("SNMPv2-MIB", "sysName"),
        ("VERTIV-V5-MIB", "pduMainLabel"),
        ("VERTIV-V5-MIB", "pduResidualCurrentLabel"))
)
if mibBuilder.loadTexts:
    pduResidualCurrentAggregateNOTIFY.setStatus(
        "current"
    )

pduResidualCurrentDcNOTIFY = NotificationType(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 32767, 0, 12005)
)
pduResidualCurrentDcNOTIFY.setObjects(
      *(("VERTIV-V5-MIB", "pduResidualCurrentDc"),
        ("VERTIV-V5-MIB", "trapThreshType"),
        ("VERTIV-V5-MIB", "trapSeverity"),
        ("SNMPv2-MIB", "sysName"),
        ("VERTIV-V5-MIB", "pduMainLabel"),
...
if mibBuilder.loadTexts:
    pduResidualCurrentDcNOTIFY.setStatus(
        "current"
    )
...
pduResidualCurrentAggregateCLEAR = NotificationType(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 32767, 0, 22004)
)
pduResidualCurrentAggregateCLEAR.setObjects(
      *(("VERTIV-V5-MIB", "pduResidualCurrentAggregate"),
        ("VERTIV-V5-MIB", "trapThreshType"),
        ("VERTIV-V5-MIB", "trapSeverity"),
        ("SNMPv2-MIB", "sysName"),
...
if mibBuilder.loadTexts:
    pduResidualCurrentAggregateCLEAR.setStatus(
        "current"
    )

pduResidualCurrentDcCLEAR = NotificationType(
    (1, 3, 6, 1, 4, 1, 21239, 5, 2, 32767, 0, 22005)
)
pduResidualCurrentDcCLEAR.setObjects(
      *(("VERTIV-V5-MIB", "pduResidualCurrentDc"),
        ("VERTIV-V5-MIB", "trapThreshType"),
        ("VERTIV-V5-MIB", "trapSeverity"),
        ("SNMPv2-MIB", "sysName"),
...
if mibBuilder.loadTexts:
    pduResidualCurrentDcCLEAR.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"vertiv": vertiv,
       ...
       "pduPhaseResCurrentDetected": pduPhaseResCurrentDetected,
       ...
       "pduBreakerResCurrentDetected": pduBreakerResCurrentDetected,
       ...
       "pduResidualCurrentTable": pduResidualCurrentTable,
       "pduResidualCurrentEntry": pduResidualCurrentEntry,
       "pduResidualCurrentIndex": pduResidualCurrentIndex,
       "pduResidualCurrentName": pduResidualCurrentName,
       "pduResidualCurrentLabel": pduResidualCurrentLabel,
       "pduResidualCurrentAggregate": pduResidualCurrentAggregate,
       "pduResidualCurrentDc": pduResidualCurrentDc,
       ...
       "pduResidualCurrentAggregateNOTIFY": pduResidualCurrentAggregateNOTIFY,
       "pduResidualCurrentDcNOTIFY": pduResidualCurrentDcNOTIFY,
       ...
       "pduResidualCurrentAggregateCLEAR": pduResidualCurrentAggregateCLEAR,
       "pduResidualCurrentDcCLEAR": pduResidualCurrentDcCLEAR,
