...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/APPN-MIB
...
DisplayString, VariablePointer, TimeStamp, RowPointer, DateAndTime, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "VariablePointer", "TimeStamp", "RowPointer", "DateAndTime", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("APPN-MIB", appnDirLuLocation=appnDirLuLocation, appnIsInSsRecvNxWndwSize=appnIsInSsRecvNxWndwSize, appnIsInRtpNceId=appnIsInRtpNceId, appnLocalTgDestVirtual=appnLocalTgDestVirtual, appnNnTgFREntryTimeLeft=appnNnTgFREntryTimeLeft, appnLsCpCpSessionSupport=appnLsCpCpSessionSupport, appnNnNodeFRFrsn=appnNnNodeFRFrsn, appnNnUniqueInfoAndCaps=appnNnUniqueInfoAndCaps, appnLocalDirPerfConfGroup=appnLocalDirPerfConfGroup, appnCosNodeRowResistMin=appnCosNodeRowResistMin, appnNodeHprEndRteSetups=appnNodeHprEndRteSetups, appnPortDynLsGoodXids=appnPortDynLsGoodXids, appnLinkConfGroup=appnLinkConfGroup, appnLsInXidFrames=appnLsInXidFrames, appnLocalTgConfGroup2=appnLocalTgConfGroup2, appnDirType=appnDirType, appnIsInGlobeCtrOperStatus=appnIsInGlobeCtrOperStatus, appnHprBfConfGroup=appnHprBfConfGroup, appnPortOperState=appnPortOperState, appnNodeEnLuSearch=appnNodeEnLuSearch, appnGeneralConfGroup2=appnGeneralConfGroup2, appnLocalEnTgNum=appnLocalEnTgNum, appnCosTgRowDelayMin=appnCosTgRowDelayMin, appnIsInFqCpName=appnIsInFqCpName, appnLocalEnTgEntryTimeLeft=appnLocalEnTgEntryTimeLeft, alertTrap=alertTrap, appnNnNodeFRCentralDirectory=appnNnNodeFRCentralDirectory, appnLocalEnTgOrigin=appnLocalEnTgOrigin, appnNodeMaxSessPerRtpConn=appnNodeMaxSessPerRtpConn, appnIsInSecLuName=appnIsInSecLuName, appnLocalTopology=appnLocalTopology, appnIsInSsSendMaxBtuSize=appnIsInSsSendMaxBtuSize, appnLsInXidBytes=appnLsInXidBytes, appnLsAdjNodeType=appnLsAdjNodeType, appnLsCommand=appnLsCommand, appnDirCurHomeEntries=appnDirCurHomeEntries, DisplayableDlcAddress=DisplayableDlcAddress, appnNnTgFRSecurity=appnNnTgFRSecurity, appnLsStatusTable=appnLsStatusTable, AppnTgDlcData=AppnTgDlcData, appnPortSIMRIM=appnPortSIMRIM, appnIsInEntry=appnIsInEntry, appnLsTable=appnLsTable, appnNodeHprIntRteSetups=appnNodeHprIntRteSetups, appnDirTable=appnDirTable, appnIsInP2SFmdPius=appnIsInP2SFmdPius, appnLsStatusDlcType=appnLsStatusDlcType, appnCosTgRowDelayMax=appnCosTgRowDelayMax, appnNnTgFRDlcData=appnNnTgFRDlcData, appnNnTopoMaxNodes=appnNnTopoMaxNodes, AppnLinkStationCounter=AppnLinkStationCounter, appnDirNotFoundLocates=appnDirNotFoundLocates, appnLsPartnerNodeId=appnLsPartnerNodeId, appnNodeUpTime=appnNodeUpTime, appnLocalTgMltgLinkType=appnLocalTgMltgLinkType, appnLsAdjCpName=appnLsAdjCpName, appnLsStatusLsName=appnLsStatusLsName, appnDirLuName=appnDirLuName, appnIsInCtrUpTime=appnIsInCtrUpTime, appnLsEntry=appnLsEntry, appnNnNodeFRGarbageCollect=appnNnNodeFRGarbageCollect, appnPortInformation=appnPortInformation, appnGroups=appnGroups, appnNodeHprOrgRteSetups=appnNodeHprOrgRteSetups, appnNnTgFRByteCost=appnNnTgFRByteCost, appnCosNodeRowIndex=appnCosNodeRowIndex, appnDirRegEntries=appnDirRegEntries, appnLsOutMsgFrames=appnLsOutMsgFrames, appnLocalTgUsr3=appnLocalTgUsr3, appnCompliances=appnCompliances, appnLsOutMsgBytes=appnLsOutMsgBytes, appnNodeMibVersion=appnNodeMibVersion, appnLsRevAnrLabel=appnLsRevAnrLabel, appnDirNnServerName=appnDirNnServerName, alertIdNumber=alertIdNumber, appnLocalTgDelay=appnLocalTgDelay, appnLsStatusGeneralSense=appnLsStatusGeneralSense, appnCosTgRowSecurityMax=appnCosTgRowSecurityMax, appnLsMaxSendBtuSize=appnLsMaxSendBtuSize, appnPortDefLsGoodXids=appnPortDefLsGoodXids, appnLsForAnrLabel=appnLsForAnrLabel, appnLocalEnTgByteCost=appnLocalEnTgByteCost, appnIsInTransPriority=appnIsInTransPriority, appnNnTopology=appnNnTopology, appnLsMinDelay=appnLsMinDelay, appnLsActiveTime=appnLsActiveTime, appnNnTgFRCpCpSession=appnNnTgFRCpCpSession, appnVrnEntry=appnVrnEntry, appnLocalTgSecurity=appnLocalTgSecurity, appnLocalEnTgDestVirtual=appnLocalEnTgDestVirtual, appnCosTgRowByteCostMax=appnCosTgRowByteCostMax, AppnTgSecurity=AppnTgSecurity, appnLsBfNceId=appnLsBfNceId, appnIsInGlobeRscvTime=appnIsInGlobeRscvTime, appnNnNodeFRInterchangeSup=appnNnNodeFRInterchangeSup, appnIsInPsRecvPacingType=appnIsInPsRecvPacingType, appnCosTgRowIndex=appnCosTgRowIndex, appnLsStatusPartnerId=appnLsStatusPartnerId, appnCosTransPriority=appnCosTransPriority, AppnTgDelay=AppnTgDelay, appnNnNodeFRType=appnNnNodeFRType, appnConformance=appnConformance, appnDirLocateOutstands=appnDirLocateOutstands, appnLsStatusTime=appnLsStatusTime, appnLsLocalAddr=appnLsLocalAddr, appnLocalEnTgTable=appnLocalEnTgTable, appnNodeNnIsrDepleted=appnNodeNnIsrDepleted, appnTraps=appnTraps, appnVrnTable=appnVrnTable, appnLocalEnTopoConfGroup2=appnLocalEnTopoConfGroup2, appnLocalTgTable=appnLocalTgTable, appnLocalTgIntersubnet=appnLocalTgIntersubnet, appnLocalEnTgUsr3=appnLocalEnTgUsr3, appnCos=appnCos, appnCosNameTable=appnCosNameTable, appnPortDlcType=appnPortDlcType, appnNnTgFRUsr1=appnNnTgFRUsr1, appnNnTgFRDelay=appnNnTgFRDelay, appnIsInGlobeRscv=appnIsInGlobeRscv, appnLsInMsgFrames=appnLsInMsgFrames, appnIsInS2PFmdPius=appnIsInS2PFmdPius, appnLsEchoRsps=appnLsEchoRsps, appnLocalEnTgEffCap=appnLocalEnTgEffCap, appnGeneralInfoAndCaps=appnGeneralInfoAndCaps, appnNnTgFRDestHprTrans=appnNnTgFRDestHprTrans, appnPortDynLsBadXids=appnPortDynLsBadXids, appnLsCurrentDelay=appnLsCurrentDelay, appnLsOutXidFrames=appnLsOutXidFrames, appnTrapNotifGroup=appnTrapNotifGroup, appnIsInSsRecvPacingType=appnIsInSsRecvPacingType, AppnTopologyEntryTimeLeft=AppnTopologyEntryTimeLeft, appnNnTgTopologyFRTable=appnNnTgTopologyFRTable, SnaClassOfServiceName=SnaClassOfServiceName, appnNnTopologyFREntry=appnNnTopologyFREntry, appnCosTgRowSecurityMin=appnCosTgRowSecurityMin, appnNode=appnNode, appnLsErrRecoSup=appnLsErrRecoSup, appnPortCommand=appnPortCommand, appnNnNodeFRPeriBorderSup=appnNnNodeFRPeriBorderSup, appnNnTgFRHprSup=appnNnTgFRHprSup, appnPortName=appnPortName, appnCosTgRowUsr1Max=appnCosTgRowUsr1Max, appnIsInSessType=appnIsInSessType, appnPortCounterDisconTime=appnPortCounterDisconTime, appnCosTgRowConnCostMin=appnCosTgRowConnCostMin, appnNnTgFROwner=appnNnTgFROwner, appnNnTgFRUsr3=appnNnTgFRUsr3, appnCosNodeRowWgt=appnCosNodeRowWgt, appnNnTopoConfGroup=appnNnTopoConfGroup, appnNodeNnQuiescing=appnNodeNnQuiescing, appnIsInGlobeActSess=appnIsInGlobeActSess, appnPortConfGroup=appnPortConfGroup, appnNodeHprEndRteRejects=appnNodeHprEndRteRejects, appnCosNodeRowMaxCongestAllow=appnCosNodeRowMaxCongestAllow, appnCosNodeRowTable=appnCosNodeRowTable, appnNodeNnRsn=appnNodeNnRsn, appnNodeAdaptiveBindPacing=appnNodeAdaptiveBindPacing, appnIsInGlobeCtrStatusTime=appnIsInGlobeCtrStatusTime, appnLsActOnDemand=appnLsActOnDemand, appnPortDefLsBadXids=appnPortDefLsBadXids, appnIsInModeName=appnIsInModeName, appnNnNodeFRExteBorderSup=appnNnNodeFRExteBorderSup, appnLsStatusLocalAddr=appnLsStatusLocalAddr, appnGeneralConfGroup=appnGeneralConfGroup, appnDirOutBcastLocates=appnDirOutBcastLocates, appnNnNodeFRIsr=appnNnNodeFRIsr, SnaNodeIdentification=SnaNodeIdentification, appnDirMaxCaches=appnDirMaxCaches, appnObjects=appnObjects, appnNnTgFRConnCost=appnNnTgFRConnCost, appnLsCounterDisconTime=appnLsCounterDisconTime, appnCosNodeRowEntry=appnCosNodeRowEntry, appnLocalTgOperational=appnLocalTgOperational, appnLsHprSup=appnLsHprSup, appnNodeLsCounterType=appnNodeLsCounterType, appnLocalEnTgSecurity=appnLocalEnTgSecurity, appnLsRemoteAddr=appnLsRemoteAddr, appnEnUniqueCaps=appnEnUniqueCaps, appnNnTgFREffCap=appnNnTgFREffCap, appnCosTgRowUsr2Max=appnCosTgRowUsr2Max, appnIsInRouteInfo=appnIsInRouteInfo, appnLocalEnTgUsr2=appnLocalEnTgUsr2, appnIsInGlobal=appnIsInGlobal, appnNnTgFRGarbageCollect=appnNnTgFRGarbageCollect, appnNnNodeFRRouteAddResist=appnNnNodeFRRouteAddResist, appnNnTopoCurNumNodes=appnNnTopoCurNumNodes, appnIsRtpTable=appnIsRtpTable, appnLsStatusTgNum=appnLsStatusTgNum, appnNodeNnInterchangeSup=appnNodeNnInterchangeSup, appnNnTgFRSubareaNum=appnNnTgFRSubareaNum, appnIsInS2PNonFmdBytes=appnIsInS2PNonFmdBytes, appnDir=appnDir, appnIsInGlobeCtrAdminStatus=appnIsInGlobeCtrAdminStatus, appnMIB=appnMIB, appnLocalTgByteCost=appnLocalTgByteCost, appnCosTgRowUsr1Min=appnCosTgRowUsr1Min, appnLocalTgEffCap=appnLocalTgEffCap, appnLsMltgMember=appnLsMltgMember, appnCosNodeRowMinCongestAllow=appnCosNodeRowMinCongestAllow, appnNodeNnCentralDirectory=appnNodeNnCentralDirectory, appnLsRemoteLsName=appnLsRemoteLsName, appnCosConfGroup=appnCosConfGroup, appnCosTgRowConnCostMax=appnCosTgRowConnCostMax, appnLsCurrentStateTime=appnLsCurrentStateTime, appnNnTopologyFRTable=appnNnTopologyFRTable, appnLocalTgUsr2=appnLocalTgUsr2, appnIsRtpSessions=appnIsRtpSessions, appnLocalEnTgDelay=appnLocalEnTgDelay, appnVrnName=appnVrnName, appnNnTgFRFrsn=appnNnTgFRFrsn, appnNnNodeFRCongested=appnNnNodeFRCongested, appnNodeCpName=appnNodeCpName, appnDirOutLocates=appnDirOutLocates, appnLsStatusXidByteInError=appnLsStatusXidByteInError, appnIsInS2PNonFmdPius=appnIsInS2PNonFmdPius, appnIsRtpEntry=appnIsRtpEntry, appnNnTopoConfGroup2=appnNnTopoConfGroup2, appnLsName=appnLsName, appnNodeNnGateway=appnNodeNnGateway, appnLsTgNum=appnLsTgNum, appnTrapConfGroup=appnTrapConfGroup, appnLsOutXidBytes=appnLsOutXidBytes, appnLsStatusXidRemoteSense=appnLsStatusXidRemoteSense, appnNodeNnCongested=appnNodeNnCongested, appnNnTgFRIntersubnet=appnNnTgFRIntersubnet, appnLocalEnTopoConfGroup=appnLocalEnTopoConfGroup, appnLocalTgQuiescing=appnLocalTgQuiescing, appnNodeNnExteBorderSup=appnNodeNnExteBorderSup, appnNnTgFRNum=appnNnTgFRNum, appnCosModeName=appnCosModeName, appnVrnConfGroup=appnVrnConfGroup, affectedObject=affectedObject, appnCosModeTable=appnCosModeTable, appnIsInSessState=appnIsInSessState, appnVrnPortName=appnVrnPortName, appnIsInSsRecvRpc=appnIsInSsRecvRpc, appnNnTgFRTypeIndicator=appnNnTgFRTypeIndicator, appnIsInPcid=appnIsInPcid, appnLocalEnTgDest=appnLocalEnTgDest, appnNnNodeFREntryTimeLeft=appnNnNodeFREntryTimeLeft, appnLsStatusRetry=appnLsStatusRetry, appnCosTgRowWgt=appnCosTgRowWgt, appnNodeHprSupport=appnNodeHprSupport, SnaControlPointName=SnaControlPointName, appnHprCtrlFlowsRtpConfGroup=appnHprCtrlFlowsRtpConfGroup, appnNnTgFRUsr2=appnNnTgFRUsr2, appnCompliance=appnCompliance, appnCosNodeRowName=appnCosNodeRowName, appnPortMaxIframeWindow=appnPortMaxIframeWindow, appnDirTableConfGroup=appnDirTableConfGroup, AppnPortCounter=AppnPortCounter, appnNnTgFRDest=appnNnTgFRDest, appnLocalEnTgUsr1=appnLocalEnTgUsr1, appnLsStatusCpName=appnLsStatusCpName)
mibBuilder.exportSymbols("APPN-MIB", appnCosName=appnCosName, appnCosTgRowByteCostMin=appnCosTgRowByteCostMin, appnLsBadXids=appnLsBadXids, appnCosTgRowTable=appnCosTgRowTable, appnIsInTable=appnIsInTable, appnIsInPsRecvRpc=appnIsInPsRecvRpc, appnLocalTgBranchLinkType=appnLocalTgBranchLinkType, appnNn=appnNn, appnNnNodeFRRsn=appnNnNodeFRRsn, appnBrNnConfGroup=appnBrNnConfGroup, appnIsInPsRecvNxWndwSize=appnIsInPsRecvNxWndwSize, appnLocalTgHprSup=appnLocalTgHprSup, appnVrnTgNum=appnVrnTgNum, appnNnTgFRQuiescing=appnNnTgFRQuiescing, appnLocalTgConnCost=appnLocalTgConnCost, appnLocalEnTgEntry=appnLocalEnTgEntry, appnLsCpCpNceId=appnLsCpCpNceId, appnCosModeCosName=appnCosModeCosName, appnNodeHprOrgRteRejects=appnNodeHprOrgRteRejects, appnNnTopo=appnNnTopo, appnNodeId=appnNodeId, appnIsInPsSendNxWndwSize=appnIsInPsSendNxWndwSize, appnNodeParallelTg=appnNodeParallelTg, appnNodeNnFrsn=appnNodeNnFrsn, SnaSenseData=SnaSenseData, appnIsRtpNceId=appnIsRtpNceId, appnIsRtpTcid=appnIsRtpTcid, appnNnTopoNodePurges=appnNnTopoNodePurges, appnCosTgRowUsr2Min=appnCosTgRowUsr2Min, appnIsInGlobeHprBfActSess=appnIsInGlobeHprBfActSess, appnIsInSsSendRpc=appnIsInSsSendRpc, appnLocalTgCpCpSession=appnLocalTgCpCpSession, appnNodeEnNnServer=appnNodeEnNnServer, appnLocalEnTgConnCost=appnLocalEnTgConnCost, appnIsInSsSendPacingType=appnIsInSsSendPacingType, appnIsInSsSendNxWndwSize=appnIsInSsSendNxWndwSize, appnNnTopoTgPurges=appnNnTopoTgPurges, appnIsInPriLuName=appnIsInPriLuName, appnNodeNnPeriBorderSup=appnNodeNnPeriBorderSup, appnNodeType=appnNodeType, appnSessIntermediate=appnSessIntermediate, appnLocalTgDlcData=appnLocalTgDlcData, appnNnTopoTotalTduWars=appnNnTopoTotalTduWars, appnDirApparentLuOwnerName=appnDirApparentLuOwnerName, appnLocalEnTgMltgLinkType=appnLocalEnTgMltgLinkType, appnCompliance2=appnCompliance2, appnLsStatusXidBitInError=appnLsStatusXidBitInError, appnLocalEnTgDlcData=appnLocalEnTgDlcData, appnIsInP2SNonFmdPius=appnIsInP2SNonFmdPius, appnNodeNnTreeCache=appnNodeNnTreeCache, appnLocalTgDest=appnLocalTgDest, appnDirCurCaches=appnDirCurCaches, appnLsGoodXids=appnLsGoodXids, appnCosNodeRowResistMax=appnCosNodeRowResistMax, appnLsSpecific=appnLsSpecific, appnLsOperState=appnLsOperState, appnHprBaseConfGroup=appnHprBaseConfGroup, appnNodeNnSafeStoreFreq=appnNodeNnSafeStoreFreq, appnPortMaxRcvBtuSize=appnPortMaxRcvBtuSize, appnNodeEnModeCosMap=appnNodeEnModeCosMap, appnIsInSsAdjTgNum=appnIsInSsAdjTgNum, appnNnNodeFRHprSupport=appnNnNodeFRHprSupport, appnLsRouteNceId=appnLsRouteNceId, appnPortLsRole=appnPortLsRole, appnDirInBcastLocates=appnDirInBcastLocates, appnPortNegotLs=appnPortNegotLs, appnIntSessConfGroup=appnIntSessConfGroup, appnNnTgFRMltgLinkType=appnNnTgFRMltgLinkType, appnNnNodeFRGateway=appnNnNodeFRGateway, appnNnTgFRRsn=appnNnTgFRRsn, appnNnTgFRBranchTg=appnNnTgFRBranchTg, appnIsInSessUpTime=appnIsInSessUpTime, appnLsStatusXidLocalSense=appnLsStatusXidLocalSense, appnLocalTgEntry=appnLocalTgEntry, appnLsStatusRemoteAddr=appnLsStatusRemoteAddr, appnLsDynamic=appnLsDynamic, appnNnNodeFRIsrDepleted=appnNnNodeFRIsrDepleted, appnHprRtpConfGroup=appnHprRtpConfGroup, appnLocalEnTgOperational=appnLocalEnTgOperational, appnLsMigration=appnLsMigration, appnNnNodeFRQuiescing=appnNnNodeFRQuiescing, appnLocalTgUsr1=appnLocalTgUsr1, appnNnTgFROperational=appnNnTgFROperational, appnLsMaxDelayTime=appnLsMaxDelayTime, appnIsInRtpTcid=appnIsInRtpTcid, appnPortEntry=appnPortEntry, appnLinkConfGroup2=appnLinkConfGroup2, appnNnNodeFRName=appnNnNodeFRName, appnNnUniqueConfGroup=appnNnUniqueConfGroup, appnNnTgTopologyFREntry=appnNnTgTopologyFREntry, appnCosTgRowName=appnCosTgRowName, PYSNMP_MODULE_ID=appnMIB, AppnNodeCounter=AppnNodeCounter, appnIsInSsAdjCpName=appnIsInSsAdjCpName, appnLsStatusEndSense=appnLsStatusEndSense, appnPortSpecific=appnPortSpecific, appnIsInPsSendRpc=appnIsInPsSendRpc, appnEnUniqueConfGroup=appnEnUniqueConfGroup, appnLocalTgNum=appnLocalTgNum, appnCosTgRowEffCapMax=appnCosTgRowEffCapMax, appnIsInPsSendPacingType=appnIsInPsSendPacingType, appnPortTable=appnPortTable, appnNodeHprIntRteRejects=appnNodeHprIntRteRejects, SnaModeName=SnaModeName, appnIsInS2PFmdBytes=appnIsInS2PFmdBytes, appnNodeNnRouteAddResist=appnNodeNnRouteAddResist, appnDirPerf=appnDirPerf, appnDirTableConfGroup2=appnDirTableConfGroup2, appnCosTgRowUsr3Min=appnCosTgRowUsr3Min, appnCosTgRowUsr3Max=appnCosTgRowUsr3Max, appnLocalTgPortName=appnLocalTgPortName, appnPortDynamicLinkSupport=appnPortDynamicLinkSupport, appnLsMaxDelay=appnLsMaxDelay, appnLsLimResource=appnLsLimResource, appnIsInP2SFmdBytes=appnIsInP2SFmdBytes, appnIsInPsAdjCpName=appnIsInPsAdjCpName, appnPortDlcLocalAddr=appnPortDlcLocalAddr, appnVrnInfo=appnVrnInfo, appnIsInP2SNonFmdBytes=appnIsInP2SNonFmdBytes, appnDirInLocates=appnDirInLocates, appnLsDlcType=appnLsDlcType, appnLocalTgConfGroup=appnLocalTgConfGroup, appnIsInPsSendMaxBtuSize=appnIsInPsSendMaxBtuSize, appnNodeBrNn=appnNodeBrNn, appnNnTgFRDestVirtual=appnNnTgFRDestVirtual, appnDirEntry=appnDirEntry, appnLsInMsgBytes=appnLsInMsgBytes, appnNnNodeFRBranchAwareness=appnNnNodeFRBranchAwareness, appnLsStatusEntry=appnLsStatusEntry, appnCosTgRowEntry=appnCosTgRowEntry, appnCosTgRowEffCapMin=appnCosTgRowEffCapMin, appnPortPortType=appnPortPortType, appnNodeNnIsr=appnNodeNnIsr, appnLinkStationInformation=appnLinkStationInformation, appnIsInPsAdjTgNum=appnIsInPsAdjTgNum, appnCosNameEntry=appnCosNameEntry, appnDirLuOwnerName=appnDirLuOwnerName, appnDirNotFoundBcastLocates=appnDirNotFoundBcastLocates, appnLsStatusIndex=appnLsStatusIndex, appnIsInCosName=appnIsInCosName, appnCosModeEntry=appnCosModeEntry, appnLocalEnTgCpCpSession=appnLocalEnTgCpCpSession, AppnTgEffectiveCapacity=AppnTgEffectiveCapacity, appnLsPortName=appnLsPortName, appnNodeCounterDisconTime=appnNodeCounterDisconTime)
