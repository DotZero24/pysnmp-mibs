...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:48:51 2025
...
DateAndTime, TextualConvention, VariablePointer, RowPointer, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "VariablePointer", "RowPointer", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("APPN-MIB", appnDirLuLocation=appnDirLuLocation, appnCosNodeRowName=appnCosNodeRowName, appnCosTransPriority=appnCosTransPriority, appnIsInTable=appnIsInTable, appnLsErrRecoSup=appnLsErrRecoSup, appnIsInSsRecvPacingType=appnIsInSsRecvPacingType, appnLsInXidFrames=appnLsInXidFrames, appnHprBaseConfGroup=appnHprBaseConfGroup, appnIsInP2SNonFmdPius=appnIsInP2SNonFmdPius, appnLocalTgDelay=appnLocalTgDelay, appnIsInS2PNonFmdBytes=appnIsInS2PNonFmdBytes, appnNnTgFRRsn=appnNnTgFRRsn, appnNodeBrNn=appnNodeBrNn, appnNnNodeFRIsr=appnNnNodeFRIsr, AppnTgDelay=AppnTgDelay, appnPortSIMRIM=appnPortSIMRIM, appnLinkConfGroup=appnLinkConfGroup, appnIsInS2PFmdPius=appnIsInS2PFmdPius, appnDirApparentLuOwnerName=appnDirApparentLuOwnerName, appnLocalEnTgEffCap=appnLocalEnTgEffCap, SnaNodeIdentification=SnaNodeIdentification, appnIsInS2PFmdBytes=appnIsInS2PFmdBytes, appnIsInS2PNonFmdPius=appnIsInS2PNonFmdPius, appnDirLuName=appnDirLuName, appnNnNodeFRInterchangeSup=appnNnNodeFRInterchangeSup, appnNnNodeFRIsrDepleted=appnNnNodeFRIsrDepleted, appnNnNodeFRType=appnNnNodeFRType, appnNnTgFRTypeIndicator=appnNnTgFRTypeIndicator, appnLocalTgByteCost=appnLocalTgByteCost, appnCosTgRowIndex=appnCosTgRowIndex, appnLsForAnrLabel=appnLsForAnrLabel, appnDirCurHomeEntries=appnDirCurHomeEntries, appnVrnPortName=appnVrnPortName, appnLocalTgUsr3=appnLocalTgUsr3, appnDirLocateOutstands=appnDirLocateOutstands, appnIsInTransPriority=appnIsInTransPriority, appnCosModeCosName=appnCosModeCosName, appnNnNodeFRRsn=appnNnNodeFRRsn, appnIsInGlobeActSess=appnIsInGlobeActSess, appnIsRtpTable=appnIsRtpTable, appnIsInPsRecvRpc=appnIsInPsRecvRpc, appnIsInGlobal=appnIsInGlobal, appnIsInPsRecvPacingType=appnIsInPsRecvPacingType, appnHprRtpConfGroup=appnHprRtpConfGroup, appnNodeEnNnServer=appnNodeEnNnServer, appnNnTgFRFrsn=appnNnTgFRFrsn, appnCosTgRowUsr1Min=appnCosTgRowUsr1Min, appnCosTgRowEffCapMin=appnCosTgRowEffCapMin, appnLocalTgEntry=appnLocalTgEntry, appnDirInLocates=appnDirInLocates, appnCosNodeRowResistMin=appnCosNodeRowResistMin, appnNodeCounterDisconTime=appnNodeCounterDisconTime, appnLocalEnTgUsr3=appnLocalEnTgUsr3, appnLsOutXidBytes=appnLsOutXidBytes, appnIsInGlobeCtrStatusTime=appnIsInGlobeCtrStatusTime, appnNodeNnIsr=appnNodeNnIsr, appnTrapNotifGroup=appnTrapNotifGroup, appnNnNodeFRQuiescing=appnNnNodeFRQuiescing, appnNodeAdaptiveBindPacing=appnNodeAdaptiveBindPacing, appnIsInSsAdjCpName=appnIsInSsAdjCpName, appnLocalEnTgDestVirtual=appnLocalEnTgDestVirtual, appnPortTable=appnPortTable, appnNnTgFRUsr2=appnNnTgFRUsr2, AppnPortCounter=AppnPortCounter, appnVrnTgNum=appnVrnTgNum, PYSNMP_MODULE_ID=appnMIB, appnPortCounterDisconTime=appnPortCounterDisconTime, appnLsStatusEndSense=appnLsStatusEndSense, appnPortDefLsGoodXids=appnPortDefLsGoodXids, appnIsInGlobeCtrOperStatus=appnIsInGlobeCtrOperStatus, appnGroups=appnGroups, appnLocalTgIntersubnet=appnLocalTgIntersubnet, appnLsRemoteAddr=appnLsRemoteAddr, appnNnTgFREntryTimeLeft=appnNnTgFREntryTimeLeft, alertIdNumber=alertIdNumber, appnNnNodeFRRouteAddResist=appnNnNodeFRRouteAddResist, appnNnTopoConfGroup2=appnNnTopoConfGroup2, appnNodeNnRouteAddResist=appnNodeNnRouteAddResist, appnIsInSsRecvNxWndwSize=appnIsInSsRecvNxWndwSize, appnCosTgRowByteCostMin=appnCosTgRowByteCostMin, appnGeneralConfGroup2=appnGeneralConfGroup2, appnIsInGlobeCtrAdminStatus=appnIsInGlobeCtrAdminStatus, appnIsInP2SFmdBytes=appnIsInP2SFmdBytes, appnIsRtpEntry=appnIsRtpEntry, appnIsInPsAdjCpName=appnIsInPsAdjCpName, appnPortName=appnPortName, appnLsMigration=appnLsMigration, appnNnTopoNodePurges=appnNnTopoNodePurges, appnPortSpecific=appnPortSpecific, appnLocalEnTgUsr2=appnLocalEnTgUsr2, appnLsEntry=appnLsEntry, appnLocalTgTable=appnLocalTgTable, appnLocalEnTgUsr1=appnLocalEnTgUsr1, appnIsInPriLuName=appnIsInPriLuName, appnPortEntry=appnPortEntry, appnLocalEnTgTable=appnLocalEnTgTable, appnCosTgRowUsr2Max=appnCosTgRowUsr2Max, appnPortInformation=appnPortInformation, appnConformance=appnConformance, appnPortCommand=appnPortCommand, appnLocalTgMltgLinkType=appnLocalTgMltgLinkType, appnCosNodeRowWgt=appnCosNodeRowWgt, appnDirMaxCaches=appnDirMaxCaches, appnNodeNnRsn=appnNodeNnRsn, appnObjects=appnObjects, appnCosTgRowConnCostMax=appnCosTgRowConnCostMax, appnLsMltgMember=appnLsMltgMember, appnIsInSecLuName=appnIsInSecLuName, appnLocalTgCpCpSession=appnLocalTgCpCpSession, appnDirTableConfGroup2=appnDirTableConfGroup2, appnIsInPsSendPacingType=appnIsInPsSendPacingType, appnNodeId=appnNodeId, AppnLinkStationCounter=AppnLinkStationCounter, appnCosTgRowUsr1Max=appnCosTgRowUsr1Max, appnNnTgFRMltgLinkType=appnNnTgFRMltgLinkType, appnNnTopologyFRTable=appnNnTopologyFRTable, appnIsInFqCpName=appnIsInFqCpName, appnDirOutBcastLocates=appnDirOutBcastLocates, appnLocalEnTgMltgLinkType=appnLocalEnTgMltgLinkType, appnNodeHprSupport=appnNodeHprSupport, appnNodeNnExteBorderSup=appnNodeNnExteBorderSup, appnTrapConfGroup=appnTrapConfGroup, appnIsInPcid=appnIsInPcid, appnLsMinDelay=appnLsMinDelay, appnIsInGlobeRscvTime=appnIsInGlobeRscvTime, appnLsStatusCpName=appnLsStatusCpName, appnNnTgFRDest=appnNnTgFRDest, appnNnTopo=appnNnTopo, appnIsInRtpNceId=appnIsInRtpNceId, appnLsStatusTime=appnLsStatusTime, appnLocalTgConnCost=appnLocalTgConnCost, appnNnTgFRQuiescing=appnNnTgFRQuiescing, appnCosModeEntry=appnCosModeEntry, appnLsCommand=appnLsCommand, appnLocalEnTgOperational=appnLocalEnTgOperational, appnEnUniqueConfGroup=appnEnUniqueConfGroup, appnCosNodeRowIndex=appnCosNodeRowIndex, appnLsStatusXidRemoteSense=appnLsStatusXidRemoteSense, appnDirRegEntries=appnDirRegEntries, appnLsDynamic=appnLsDynamic, appnLsBadXids=appnLsBadXids, appnLsStatusGeneralSense=appnLsStatusGeneralSense, appnLocalEnTgDelay=appnLocalEnTgDelay, appnLocalEnTgEntryTimeLeft=appnLocalEnTgEntryTimeLeft, appnPortConfGroup=appnPortConfGroup, appnIsInGlobeHprBfActSess=appnIsInGlobeHprBfActSess, appnNnUniqueConfGroup=appnNnUniqueConfGroup, appnLocalEnTgDlcData=appnLocalEnTgDlcData, appnPortOperState=appnPortOperState, appnLocalTgConfGroup2=appnLocalTgConfGroup2, appnDirNotFoundBcastLocates=appnDirNotFoundBcastLocates, appnCosTgRowEntry=appnCosTgRowEntry, AppnTgSecurity=AppnTgSecurity, appnCosName=appnCosName, appnIsInSsAdjTgNum=appnIsInSsAdjTgNum, appnPortDlcLocalAddr=appnPortDlcLocalAddr, appnLsTable=appnLsTable, appnLsMaxDelay=appnLsMaxDelay, appnLsHprSup=appnLsHprSup, appnCosTgRowWgt=appnCosTgRowWgt, appnNnTgFROperational=appnNnTgFROperational, appnVrnConfGroup=appnVrnConfGroup, appnIsInPsRecvNxWndwSize=appnIsInPsRecvNxWndwSize, appnLsName=appnLsName, appnLocalTgOperational=appnLocalTgOperational, appnLsStatusTable=appnLsStatusTable, appnLsStatusXidByteInError=appnLsStatusXidByteInError, appnEnUniqueCaps=appnEnUniqueCaps, appnMIB=appnMIB, appnSessIntermediate=appnSessIntermediate, appnNodeHprOrgRteSetups=appnNodeHprOrgRteSetups, appnNodeNnInterchangeSup=appnNodeNnInterchangeSup, alertTrap=alertTrap, appnLocalTgDlcData=appnLocalTgDlcData, appnCosTgRowTable=appnCosTgRowTable, appnLinkStationInformation=appnLinkStationInformation, appnLocalEnTgCpCpSession=appnLocalEnTgCpCpSession, appnVrnName=appnVrnName, appnDirOutLocates=appnDirOutLocates, appnCosTgRowName=appnCosTgRowName, appnLsCpCpNceId=appnLsCpCpNceId, appnIsInSsSendPacingType=appnIsInSsSendPacingType, appnPortNegotLs=appnPortNegotLs, appnGeneralConfGroup=appnGeneralConfGroup, appnTraps=appnTraps, appnLocalEnTopoConfGroup=appnLocalEnTopoConfGroup, appnLsInXidBytes=appnLsInXidBytes, appnPortDefLsBadXids=appnPortDefLsBadXids, SnaClassOfServiceName=SnaClassOfServiceName, SnaControlPointName=SnaControlPointName, appnLocalEnTgOrigin=appnLocalEnTgOrigin, appnLocalDirPerfConfGroup=appnLocalDirPerfConfGroup, appnNnTopology=appnNnTopology, appnIsInModeName=appnIsInModeName, appnLocalTgPortName=appnLocalTgPortName, appnIsRtpSessions=appnIsRtpSessions, appnIsInP2SFmdPius=appnIsInP2SFmdPius, appnPortDynamicLinkSupport=appnPortDynamicLinkSupport, appnLsStatusPartnerId=appnLsStatusPartnerId, appnNnTopoTotalTduWars=appnNnTopoTotalTduWars, appnDirPerf=appnDirPerf, appnNodeEnLuSearch=appnNodeEnLuSearch, appnLocalTgBranchLinkType=appnLocalTgBranchLinkType, appnPortLsRole=appnPortLsRole, appnNnTgFRByteCost=appnNnTgFRByteCost, appnCosTgRowDelayMin=appnCosTgRowDelayMin, appnIsInSsSendMaxBtuSize=appnIsInSsSendMaxBtuSize, appnLsStatusRemoteAddr=appnLsStatusRemoteAddr, appnNnTgFRUsr1=appnNnTgFRUsr1, appnLsGoodXids=appnLsGoodXids, appnNodeNnIsrDepleted=appnNodeNnIsrDepleted, appnNnTgFREffCap=appnNnTgFREffCap, appnCosTgRowSecurityMin=appnCosTgRowSecurityMin, appnLsAdjCpName=appnLsAdjCpName, appnDirNotFoundLocates=appnDirNotFoundLocates, appnPortDynLsBadXids=appnPortDynLsBadXids, appnLsStatusEntry=appnLsStatusEntry, appnLocalTgEffCap=appnLocalTgEffCap, appnLsOutXidFrames=appnLsOutXidFrames, appnIsRtpNceId=appnIsRtpNceId, appnLsSpecific=appnLsSpecific, appnVrnInfo=appnVrnInfo, appnLocalTgUsr2=appnLocalTgUsr2, appnDirType=appnDirType, appnNodeNnCentralDirectory=appnNodeNnCentralDirectory, appnLsRemoteLsName=appnLsRemoteLsName, appnLsStatusXidLocalSense=appnLsStatusXidLocalSense, appnDirInBcastLocates=appnDirInBcastLocates, appnDirTable=appnDirTable, appnLsStatusTgNum=appnLsStatusTgNum, appnNnTgFRBranchTg=appnNnTgFRBranchTg, appnIsInSsSendNxWndwSize=appnIsInSsSendNxWndwSize, appnLsTgNum=appnLsTgNum, appnIsRtpTcid=appnIsRtpTcid, appnIsInPsAdjTgNum=appnIsInPsAdjTgNum, appnNodeHprEndRteSetups=appnNodeHprEndRteSetups, appnNnUniqueInfoAndCaps=appnNnUniqueInfoAndCaps, appnNodeHprEndRteRejects=appnNodeHprEndRteRejects, appnIsInCtrUpTime=appnIsInCtrUpTime, appnNnNodeFRPeriBorderSup=appnNnNodeFRPeriBorderSup, appnCosNodeRowResistMax=appnCosNodeRowResistMax, appnCosNodeRowTable=appnCosNodeRowTable, appnCosModeTable=appnCosModeTable, appnNnTopoConfGroup=appnNnTopoConfGroup, appnLocalTopology=appnLocalTopology, appnNnTgFRUsr3=appnNnTgFRUsr3, appnLsCpCpSessionSupport=appnLsCpCpSessionSupport, appnLsDlcType=appnLsDlcType, appnNodeType=appnNodeType, appnLsBfNceId=appnLsBfNceId, appnBrNnConfGroup=appnBrNnConfGroup, appnCosNameTable=appnCosNameTable, appnPortDynLsGoodXids=appnPortDynLsGoodXids, appnCosTgRowUsr3Min=appnCosTgRowUsr3Min)
mibBuilder.exportSymbols("APPN-MIB", appnCosTgRowDelayMax=appnCosTgRowDelayMax, appnIsInSessUpTime=appnIsInSessUpTime, appnDirNnServerName=appnDirNnServerName, AppnTopologyEntryTimeLeft=AppnTopologyEntryTimeLeft, appnHprBfConfGroup=appnHprBfConfGroup, appnLsMaxSendBtuSize=appnLsMaxSendBtuSize, appnNnNodeFRFrsn=appnNnNodeFRFrsn, appnLsCounterDisconTime=appnLsCounterDisconTime, appnNnNodeFRName=appnNnNodeFRName, appnIsInRouteInfo=appnIsInRouteInfo, appnNodeNnPeriBorderSup=appnNodeNnPeriBorderSup, appnNn=appnNn, DisplayableDlcAddress=DisplayableDlcAddress, appnCosTgRowByteCostMax=appnCosTgRowByteCostMax, appnLocalEnTgEntry=appnLocalEnTgEntry, appnLocalEnTgNum=appnLocalEnTgNum, appnVrnTable=appnVrnTable, appnNnTgTopologyFREntry=appnNnTgTopologyFREntry, appnNnTgTopologyFRTable=appnNnTgTopologyFRTable, appnLsRouteNceId=appnLsRouteNceId, appnDirLuOwnerName=appnDirLuOwnerName, appnLocalEnTgSecurity=appnLocalEnTgSecurity, appnLocalTgDestVirtual=appnLocalTgDestVirtual, appnLsOutMsgFrames=appnLsOutMsgFrames, appnLsOperState=appnLsOperState, appnLsInMsgFrames=appnLsInMsgFrames, appnLocalTgNum=appnLocalTgNum, AppnNodeCounter=AppnNodeCounter, appnNodeNnQuiescing=appnNodeNnQuiescing, appnNnTgFROwner=appnNnTgFROwner, appnIsInSsSendRpc=appnIsInSsSendRpc, appnDirCurCaches=appnDirCurCaches, appnIsInEntry=appnIsInEntry, appnLsLimResource=appnLsLimResource, appnNodeMibVersion=appnNodeMibVersion, appnLsCurrentStateTime=appnLsCurrentStateTime, appnNnNodeFRGateway=appnNnNodeFRGateway, appnLsEchoRsps=appnLsEchoRsps, appnGeneralInfoAndCaps=appnGeneralInfoAndCaps, appnDir=appnDir, appnLsRevAnrLabel=appnLsRevAnrLabel, appnLocalEnTgConnCost=appnLocalEnTgConnCost, appnCosTgRowEffCapMax=appnCosTgRowEffCapMax, appnNnNodeFRExteBorderSup=appnNnNodeFRExteBorderSup, appnLsOutMsgBytes=appnLsOutMsgBytes, appnCosNodeRowEntry=appnCosNodeRowEntry, appnLsAdjNodeType=appnLsAdjNodeType, appnNodeHprIntRteRejects=appnNodeHprIntRteRejects, appnNnNodeFREntryTimeLeft=appnNnNodeFREntryTimeLeft, appnNnTopoMaxNodes=appnNnTopoMaxNodes, appnNodeNnTreeCache=appnNodeNnTreeCache, appnNodeNnSafeStoreFreq=appnNodeNnSafeStoreFreq, appnPortPortType=appnPortPortType, appnCosTgRowUsr3Max=appnCosTgRowUsr3Max, appnNnTgFRGarbageCollect=appnNnTgFRGarbageCollect, appnLsStatusRetry=appnLsStatusRetry, appnCompliance2=appnCompliance2, appnIntSessConfGroup=appnIntSessConfGroup, appnPortDlcType=appnPortDlcType, appnNnNodeFRCentralDirectory=appnNnNodeFRCentralDirectory, appnIsInPsSendRpc=appnIsInPsSendRpc, appnIsInSessType=appnIsInSessType, AppnTgDlcData=AppnTgDlcData, appnLsStatusLsName=appnLsStatusLsName, appnDirEntry=appnDirEntry, appnCosNameEntry=appnCosNameEntry, appnLsPortName=appnLsPortName, SnaSenseData=SnaSenseData, appnLsActiveTime=appnLsActiveTime, appnLocalTgHprSup=appnLocalTgHprSup, appnNnTopoTgPurges=appnNnTopoTgPurges, appnIsInP2SNonFmdBytes=appnIsInP2SNonFmdBytes, appnNode=appnNode, appnNnTgFRDelay=appnNnTgFRDelay, appnNnNodeFRHprSupport=appnNnNodeFRHprSupport, appnNnTgFRSubareaNum=appnNnTgFRSubareaNum, SnaModeName=SnaModeName, appnLsStatusIndex=appnLsStatusIndex, appnLsInMsgBytes=appnLsInMsgBytes, appnCosModeName=appnCosModeName, appnCosConfGroup=appnCosConfGroup, appnNodeNnGateway=appnNodeNnGateway, appnCosNodeRowMinCongestAllow=appnCosNodeRowMinCongestAllow, appnNodeNnCongested=appnNodeNnCongested, appnCosTgRowUsr2Min=appnCosTgRowUsr2Min, appnCosNodeRowMaxCongestAllow=appnCosNodeRowMaxCongestAllow, appnIsInSessState=appnIsInSessState, appnLinkConfGroup2=appnLinkConfGroup2, appnNnTopologyFREntry=appnNnTopologyFREntry, appnCosTgRowSecurityMax=appnCosTgRowSecurityMax, appnLocalTgSecurity=appnLocalTgSecurity, appnIsInSsRecvRpc=appnIsInSsRecvRpc, appnNodeUpTime=appnNodeUpTime, appnNnTgFRDestHprTrans=appnNnTgFRDestHprTrans, appnNnTgFRNum=appnNnTgFRNum, appnNnTgFRDestVirtual=appnNnTgFRDestVirtual, appnLocalTgDest=appnLocalTgDest, appnLsCurrentDelay=appnLsCurrentDelay, appnLsPartnerNodeId=appnLsPartnerNodeId, appnCosTgRowConnCostMin=appnCosTgRowConnCostMin, appnLsStatusXidBitInError=appnLsStatusXidBitInError, appnNodeLsCounterType=appnNodeLsCounterType, appnVrnEntry=appnVrnEntry, appnNodeParallelTg=appnNodeParallelTg, appnNnTopoCurNumNodes=appnNnTopoCurNumNodes, appnDirTableConfGroup=appnDirTableConfGroup, appnIsInCosName=appnIsInCosName, appnLocalEnTgDest=appnLocalEnTgDest, appnNodeNnFrsn=appnNodeNnFrsn, appnLsStatusLocalAddr=appnLsStatusLocalAddr, appnNnTgFRCpCpSession=appnNnTgFRCpCpSession, appnIsInRtpTcid=appnIsInRtpTcid, appnIsInPsSendMaxBtuSize=appnIsInPsSendMaxBtuSize, appnNnNodeFRGarbageCollect=appnNnNodeFRGarbageCollect, appnNodeMaxSessPerRtpConn=appnNodeMaxSessPerRtpConn, appnNnTgFRDlcData=appnNnTgFRDlcData, appnNnTgFRConnCost=appnNnTgFRConnCost, appnLocalEnTopoConfGroup2=appnLocalEnTopoConfGroup2, appnLocalEnTgByteCost=appnLocalEnTgByteCost, appnNodeHprIntRteSetups=appnNodeHprIntRteSetups, appnNnNodeFRCongested=appnNnNodeFRCongested, appnIsInGlobeRscv=appnIsInGlobeRscv, appnNnNodeFRBranchAwareness=appnNnNodeFRBranchAwareness, appnCompliance=appnCompliance, appnNodeEnModeCosMap=appnNodeEnModeCosMap, affectedObject=affectedObject, appnPortMaxIframeWindow=appnPortMaxIframeWindow, appnCompliances=appnCompliances, appnNodeHprOrgRteRejects=appnNodeHprOrgRteRejects, AppnTgEffectiveCapacity=AppnTgEffectiveCapacity, appnNodeCpName=appnNodeCpName, appnNnTgFRHprSup=appnNnTgFRHprSup, appnLsMaxDelayTime=appnLsMaxDelayTime, appnLsLocalAddr=appnLsLocalAddr, appnPortMaxRcvBtuSize=appnPortMaxRcvBtuSize, appnLocalTgQuiescing=appnLocalTgQuiescing, appnLocalTgUsr1=appnLocalTgUsr1, appnIsInPsSendNxWndwSize=appnIsInPsSendNxWndwSize, appnNnTgFRIntersubnet=appnNnTgFRIntersubnet, appnLsStatusDlcType=appnLsStatusDlcType, appnLsActOnDemand=appnLsActOnDemand, appnHprCtrlFlowsRtpConfGroup=appnHprCtrlFlowsRtpConfGroup, appnNnTgFRSecurity=appnNnTgFRSecurity, appnLocalTgConfGroup=appnLocalTgConfGroup, appnCos=appnCos)
