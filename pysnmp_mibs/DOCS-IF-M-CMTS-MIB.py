...
# Notes
# -----
# ASN.1 source file://mibs/rfc/DOCS-IF-M-CMTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:45 2025
...
docsIfMCmtsEQAMCompliance.setObjects(
      *(("DOCS-IF-M-CMTS-MIB", "docsIfMCmtsBaseGroup"),
        ...
        ("DOCS-IF-M-CMTS-MIB", "entityPhysical2Group"),
        ("DOCS-IF-M-CMTS-MIB", "entityPhysical3Group"),
        ("DOCS-IF-M-CMTS-MIB", "entityGeneralGroup"),
        ("DOCS-IF-M-CMTS-MIB", "entityLogical2Group"),
        ("DOCS-IF-M-CMTS-MIB", "entityMappingGroup"))
)
if mibBuilder.loadTexts:
