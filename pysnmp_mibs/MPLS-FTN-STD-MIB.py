...
# Notes
# -----
# ASN.1 source file://mibs/rfc/MPLS-FTN-STD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:25:11 2025
...
_MplsFTNSourcePortMin_Type.__name__ = "InetPortNumber"
...
_MplsFTNSourcePortMax_Type.__name__ = "InetPortNumber"
...
_MplsFTNDestPortMin_Type.__name__ = "InetPortNumber"
...
_MplsFTNDestPortMax_Type.__name__ = "InetPortNumber"
...
_MplsFTNStorageType_Type.__name__ = "StorageType"
...
_MplsFTNMapStorageType_Type.__name__ = "StorageType"
...
mplsFTNModuleFullCompliance.setObjects(
      *(("IF-MIB", "ifGeneralInformationGroup"),
        ("IF-MIB", "ifCounterDiscontinuityGroup"),
        ("MPLS-FTN-STD-MIB", "mplsFTNRuleGroup"),
        ("MPLS-FTN-STD-MIB", "mplsFTNMapGroup"),
        ("MPLS-FTN-STD-MIB", "mplsFTNPerfGroup"))
)
if mibBuilder.loadTexts:
...
mplsFTNModuleReadOnlyCompliance.setObjects(
      *(("IF-MIB", "ifGeneralInformationGroup"),
        ("IF-MIB", "ifCounterDiscontinuityGroup"),
        ("MPLS-FTN-STD-MIB", "mplsFTNRuleGroup"),
        ("MPLS-FTN-STD-MIB", "mplsFTNMapGroup"),
