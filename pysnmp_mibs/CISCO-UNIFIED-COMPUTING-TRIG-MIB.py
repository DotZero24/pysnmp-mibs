...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:30:07 2025
...
CucsTrigTokenOperState, CucsTrigAdminState, CucsTrigTriggeredState, CucsTrigOperState, CucsTrigDay, CucsPolicyPolicyOwner, CucsTrigTrigOperState = mibBuilder.importSymbols("CISCO-UNIFIED-COMPUTING-TC-MIB", "CucsTrigTokenOperState", "CucsTrigAdminState", "CucsTrigTriggeredState", "CucsTrigOperState", "CucsTrigDay", "CucsPolicyPolicyOwner", "CucsTrigTrigOperState")
...
mibBuilder.exportSymbols("CISCO-UNIFIED-COMPUTING-TRIG-MIB", cucsTrigClientTokenOperState=cucsTrigClientTokenOperState, cucsTrigTestIgnoreCap=cucsTrigTestIgnoreCap, cucsTrigLocalSchedDescr=cucsTrigLocalSchedDescr, cucsTrigRecurrWindowMinute=cucsTrigRecurrWindowMinute, cucsTrigAbsWindowInstanceId=cucsTrigAbsWindowInstanceId, cucsTrigTriggeredTrId=cucsTrigTriggeredTrId, cucsTrigLocalSchedFlgInitialActive=cucsTrigLocalSchedFlgInitialActive, cucsTrigMetaDescr=cucsTrigMetaDescr, cucsTrigTestTable=cucsTrigTestTable, cucsTrigAbsWindowRn=cucsTrigAbsWindowRn, cucsTrigLocalAbsWindowRn=cucsTrigLocalAbsWindowRn, cucsTrigLocalSchedPolicyLevel=cucsTrigLocalSchedPolicyLevel, cucsTrigAbsWindowConcurCap=cucsTrigAbsWindowConcurCap, cucsTrigAbsWindowTable=cucsTrigAbsWindowTable, cucsTrigTestAdminState=cucsTrigTestAdminState, cucsTrigSchedOperState=cucsTrigSchedOperState, cucsTrigMetaRn=cucsTrigMetaRn, cucsTrigTriggeredDn=cucsTrigTriggeredDn, cucsTrigLocalAbsWindowName=cucsTrigLocalAbsWindowName, cucsTrigMetaPolicyOwner=cucsTrigMetaPolicyOwner, cucsTrigMetaTable=cucsTrigMetaTable, cucsTrigTriggeredInstanceId=cucsTrigTriggeredInstanceId, cucsTrigTestOperState=cucsTrigTestOperState, cucsTrigClientTokenId=cucsTrigClientTokenId, cucsTrigRecurrWindowProcBreak=cucsTrigRecurrWindowProcBreak, cucsTrigTestName=cucsTrigTestName, cucsTrigClientTokenActivityTs=cucsTrigClientTokenActivityTs, cucsTrigMetaPolicyLevel=cucsTrigMetaPolicyLevel, cucsTrigRecurrWindowInstanceId=cucsTrigRecurrWindowInstanceId, cucsTrigLocalSchedAdminState=cucsTrigLocalSchedAdminState, cucsTrigLocalSchedPolicyOwner=cucsTrigLocalSchedPolicyOwner, cucsTrigMetaAdminState=cucsTrigMetaAdminState, cucsTrigSchedRn=cucsTrigSchedRn, cucsTrigLocalAbsWindowTimeCapped=cucsTrigLocalAbsWindowTimeCapped, cucsTrigTestOperScheduler=cucsTrigTestOperScheduler, cucsTrigLocalSchedTable=cucsTrigLocalSchedTable, cucsTrigRecurrWindowProcCap=cucsTrigRecurrWindowProcCap, cucsTrigTriggeredOperState=cucsTrigTriggeredOperState, cucsTrigSchedDn=cucsTrigSchedDn, cucsTrigTriggeredTrDn=cucsTrigTriggeredTrDn, cucsTrigRecurrWindowHour=cucsTrigRecurrWindowHour, cucsTrigLocalSchedInstanceId=cucsTrigLocalSchedInstanceId, cucsTrigSchedPolicyLevel=cucsTrigSchedPolicyLevel, cucsTrigSchedName=cucsTrigSchedName, cucsTrigRecurrWindowRn=cucsTrigRecurrWindowRn, cucsTrigLocalSchedDn=cucsTrigLocalSchedDn, cucsTrigLocalAbsWindowInstanceId=cucsTrigLocalAbsWindowInstanceId, cucsTrigClientTokenEntry=cucsTrigClientTokenEntry, cucsTrigTestCreationDate=cucsTrigTestCreationDate, cucsTrigTriggeredEntry=cucsTrigTriggeredEntry, cucsTrigSchedIntId=cucsTrigSchedIntId, cucsTrigTestEntry=cucsTrigTestEntry, cucsTrigRecurrWindowName=cucsTrigRecurrWindowName, cucsTrigSchedTable=cucsTrigSchedTable, cucsTrigMetaJobCount=cucsTrigMetaJobCount, cucsTrigTestDescr=cucsTrigTestDescr, cucsTrigLocalAbsWindowTimeCap=cucsTrigLocalAbsWindowTimeCap, PYSNMP_MODULE_ID=cucsTrigObjects, cucsTrigSchedAdminState=cucsTrigSchedAdminState, cucsTrigRecurrWindowTimeCapped=cucsTrigRecurrWindowTimeCapped, cucsTrigAbsWindowTimeCap=cucsTrigAbsWindowTimeCap, cucsTrigAbsWindowDate=cucsTrigAbsWindowDate, cucsTrigTestDn=cucsTrigTestDn, cucsTrigRecurrWindowTable=cucsTrigRecurrWindowTable, cucsTrigSchedEntry=cucsTrigSchedEntry, cucsTrigMetaEntry=cucsTrigMetaEntry, cucsTrigTestInstanceId=cucsTrigTestInstanceId, cucsTrigRecurrWindowTimeCap=cucsTrigRecurrWindowTimeCap, cucsTrigTestRn=cucsTrigTestRn, cucsTrigSchedInstanceId=cucsTrigSchedInstanceId, cucsTrigObjects=cucsTrigObjects, cucsTrigMetaName=cucsTrigMetaName, cucsTrigMetaInstanceId=cucsTrigMetaInstanceId, cucsTrigRecurrWindowConcurCap=cucsTrigRecurrWindowConcurCap, cucsTrigClientTokenDn=cucsTrigClientTokenDn, cucsTrigLocalAbsWindowProcCap=cucsTrigLocalAbsWindowProcCap, cucsTrigMetaIntId=cucsTrigMetaIntId, cucsTrigTestIntId=cucsTrigTestIntId, cucsTrigMetaDn=cucsTrigMetaDn, cucsTrigTestPolicyOwner=cucsTrigTestPolicyOwner, cucsTrigLocalAbsWindowJobCount=cucsTrigLocalAbsWindowJobCount, cucsTrigMetaTrigTime=cucsTrigMetaTrigTime, cucsTrigLocalSchedOperState=cucsTrigLocalSchedOperState, cucsTrigRecurrWindowEntry=cucsTrigRecurrWindowEntry, cucsTrigAbsWindowDn=cucsTrigAbsWindowDn, cucsTrigAbsWindowTimeCapped=cucsTrigAbsWindowTimeCapped, cucsTrigLocalAbsWindowTable=cucsTrigLocalAbsWindowTable, cucsTrigAbsWindowName=cucsTrigAbsWindowName, cucsTrigTriggeredRn=cucsTrigTriggeredRn, cucsTrigTriggeredOrder=cucsTrigTriggeredOrder, cucsTrigAbsWindowJobCount=cucsTrigAbsWindowJobCount, cucsTrigSchedFlgInitialActive=cucsTrigSchedFlgInitialActive, cucsTrigMetaWindowDn=cucsTrigMetaWindowDn, cucsTrigLocalSchedEntry=cucsTrigLocalSchedEntry, cucsTrigTestPolicyLevel=cucsTrigTestPolicyLevel, cucsTrigLocalAbsWindowEntry=cucsTrigLocalAbsWindowEntry, cucsTrigLocalAbsWindowDate=cucsTrigLocalAbsWindowDate, cucsTrigAbsWindowEntry=cucsTrigAbsWindowEntry, cucsTrigClientTokenInstanceId=cucsTrigClientTokenInstanceId, cucsTrigTestAutoDelete=cucsTrigTestAutoDelete, cucsTrigTestScheduler=cucsTrigTestScheduler, cucsTrigLocalSchedIntId=cucsTrigLocalSchedIntId, cucsTrigTriggeredJobCount=cucsTrigTriggeredJobCount, cucsTrigClientTokenTable=cucsTrigClientTokenTable, cucsTrigLocalSchedName=cucsTrigLocalSchedName, cucsTrigLocalAbsWindowDn=cucsTrigLocalAbsWindowDn, cucsTrigMetaOperState=cucsTrigMetaOperState, cucsTrigTriggeredTable=cucsTrigTriggeredTable, cucsTrigSchedDescr=cucsTrigSchedDescr, cucsTrigRecurrWindowDn=cucsTrigRecurrWindowDn, cucsTrigLocalSchedRn=cucsTrigLocalSchedRn, cucsTrigLocalAbsWindowConcurCap=cucsTrigLocalAbsWindowConcurCap, cucsTrigSchedPolicyOwner=cucsTrigSchedPolicyOwner, cucsTrigAbsWindowProcCap=cucsTrigAbsWindowProcCap, cucsTrigMetaSchedName=cucsTrigMetaSchedName, cucsTrigRecurrWindowJobCount=cucsTrigRecurrWindowJobCount, cucsTrigLocalAbsWindowProcBreak=cucsTrigLocalAbsWindowProcBreak, cucsTrigAbsWindowProcBreak=cucsTrigAbsWindowProcBreak, cucsTrigRecurrWindowDay=cucsTrigRecurrWindowDay, cucsTrigClientTokenRn=cucsTrigClientTokenRn)
