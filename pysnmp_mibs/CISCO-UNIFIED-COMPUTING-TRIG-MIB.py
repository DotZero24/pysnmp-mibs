...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-UNIFIED-COMPUTING-TRIG-MIB
...
CucsPolicyPolicyOwner, CucsTrigTriggeredState, CucsTrigAdminState, CucsTrigTokenOperState, CucsTrigTrigOperState, CucsTrigDay, CucsTrigOperState = mibBuilder.importSymbols("CISCO-UNIFIED-COMPUTING-TC-MIB", "CucsPolicyPolicyOwner", "CucsTrigTriggeredState", "CucsTrigAdminState", "CucsTrigTokenOperState", "CucsTrigTrigOperState", "CucsTrigDay", "CucsTrigOperState")
...
if mibBuilder.loadTexts: cucsTrigObjects.setLastUpdated('201807260000Z')
...
mibBuilder.exportSymbols("CISCO-UNIFIED-COMPUTING-TRIG-MIB", cucsTrigSchedName=cucsTrigSchedName, cucsTrigRecurrWindowDay=cucsTrigRecurrWindowDay, cucsTrigRecurrWindowHour=cucsTrigRecurrWindowHour, cucsTrigTestOperScheduler=cucsTrigTestOperScheduler, cucsTrigTriggeredEntry=cucsTrigTriggeredEntry, cucsTrigMetaAdminState=cucsTrigMetaAdminState, cucsTrigRecurrWindowProcCap=cucsTrigRecurrWindowProcCap, cucsTrigRecurrWindowRn=cucsTrigRecurrWindowRn, cucsTrigSchedIntId=cucsTrigSchedIntId, cucsTrigClientTokenTable=cucsTrigClientTokenTable, cucsTrigLocalAbsWindowProcCap=cucsTrigLocalAbsWindowProcCap, cucsTrigSchedFlgInitialActive=cucsTrigSchedFlgInitialActive, cucsTrigTriggeredDn=cucsTrigTriggeredDn, cucsTrigLocalAbsWindowTimeCapped=cucsTrigLocalAbsWindowTimeCapped, cucsTrigLocalAbsWindowDn=cucsTrigLocalAbsWindowDn, cucsTrigLocalAbsWindowRn=cucsTrigLocalAbsWindowRn, cucsTrigRecurrWindowEntry=cucsTrigRecurrWindowEntry, cucsTrigAbsWindowDn=cucsTrigAbsWindowDn, cucsTrigRecurrWindowProcBreak=cucsTrigRecurrWindowProcBreak, cucsTrigTriggeredOperState=cucsTrigTriggeredOperState, cucsTrigLocalSchedIntId=cucsTrigLocalSchedIntId, cucsTrigRecurrWindowTimeCap=cucsTrigRecurrWindowTimeCap, cucsTrigSchedAdminState=cucsTrigSchedAdminState, cucsTrigSchedTable=cucsTrigSchedTable, cucsTrigLocalAbsWindowInstanceId=cucsTrigLocalAbsWindowInstanceId, cucsTrigLocalSchedPolicyOwner=cucsTrigLocalSchedPolicyOwner, cucsTrigClientTokenEntry=cucsTrigClientTokenEntry, cucsTrigClientTokenActivityTs=cucsTrigClientTokenActivityTs, cucsTrigRecurrWindowInstanceId=cucsTrigRecurrWindowInstanceId, cucsTrigTestTable=cucsTrigTestTable, cucsTrigMetaPolicyLevel=cucsTrigMetaPolicyLevel, cucsTrigMetaInstanceId=cucsTrigMetaInstanceId, cucsTrigMetaTable=cucsTrigMetaTable, cucsTrigLocalAbsWindowConcurCap=cucsTrigLocalAbsWindowConcurCap, cucsTrigAbsWindowRn=cucsTrigAbsWindowRn, cucsTrigMetaDescr=cucsTrigMetaDescr, cucsTrigLocalSchedInstanceId=cucsTrigLocalSchedInstanceId, cucsTrigMetaEntry=cucsTrigMetaEntry, cucsTrigTestInstanceId=cucsTrigTestInstanceId, cucsTrigRecurrWindowMinute=cucsTrigRecurrWindowMinute, cucsTrigRecurrWindowDn=cucsTrigRecurrWindowDn, cucsTrigMetaSchedName=cucsTrigMetaSchedName, cucsTrigTriggeredInstanceId=cucsTrigTriggeredInstanceId, cucsTrigClientTokenDn=cucsTrigClientTokenDn, cucsTrigRecurrWindowConcurCap=cucsTrigRecurrWindowConcurCap, cucsTrigAbsWindowName=cucsTrigAbsWindowName, cucsTrigTestAdminState=cucsTrigTestAdminState, cucsTrigTestCreationDate=cucsTrigTestCreationDate, cucsTrigAbsWindowTable=cucsTrigAbsWindowTable, cucsTrigAbsWindowProcCap=cucsTrigAbsWindowProcCap, cucsTrigSchedRn=cucsTrigSchedRn, cucsTrigLocalAbsWindowDate=cucsTrigLocalAbsWindowDate, cucsTrigRecurrWindowName=cucsTrigRecurrWindowName, cucsTrigLocalSchedEntry=cucsTrigLocalSchedEntry, cucsTrigTestPolicyLevel=cucsTrigTestPolicyLevel, cucsTrigLocalSchedDn=cucsTrigLocalSchedDn, cucsTrigLocalSchedFlgInitialActive=cucsTrigLocalSchedFlgInitialActive, PYSNMP_MODULE_ID=cucsTrigObjects, cucsTrigTestEntry=cucsTrigTestEntry, cucsTrigClientTokenInstanceId=cucsTrigClientTokenInstanceId, cucsTrigClientTokenRn=cucsTrigClientTokenRn, cucsTrigTriggeredTrDn=cucsTrigTriggeredTrDn, cucsTrigAbsWindowTimeCap=cucsTrigAbsWindowTimeCap, cucsTrigClientTokenId=cucsTrigClientTokenId, cucsTrigMetaPolicyOwner=cucsTrigMetaPolicyOwner, cucsTrigClientTokenOperState=cucsTrigClientTokenOperState, cucsTrigSchedOperState=cucsTrigSchedOperState, cucsTrigLocalAbsWindowTimeCap=cucsTrigLocalAbsWindowTimeCap, cucsTrigSchedDescr=cucsTrigSchedDescr, cucsTrigMetaDn=cucsTrigMetaDn, cucsTrigLocalSchedAdminState=cucsTrigLocalSchedAdminState, cucsTrigAbsWindowProcBreak=cucsTrigAbsWindowProcBreak, cucsTrigTriggeredJobCount=cucsTrigTriggeredJobCount, cucsTrigLocalSchedTable=cucsTrigLocalSchedTable, cucsTrigMetaWindowDn=cucsTrigMetaWindowDn, cucsTrigMetaTrigTime=cucsTrigMetaTrigTime, cucsTrigLocalAbsWindowTable=cucsTrigLocalAbsWindowTable, cucsTrigLocalAbsWindowProcBreak=cucsTrigLocalAbsWindowProcBreak, cucsTrigObjects=cucsTrigObjects, cucsTrigAbsWindowEntry=cucsTrigAbsWindowEntry, cucsTrigTestName=cucsTrigTestName, cucsTrigTriggeredTable=cucsTrigTriggeredTable, cucsTrigRecurrWindowTable=cucsTrigRecurrWindowTable, cucsTrigSchedEntry=cucsTrigSchedEntry, cucsTrigAbsWindowInstanceId=cucsTrigAbsWindowInstanceId, cucsTrigTestAutoDelete=cucsTrigTestAutoDelete, cucsTrigTestDescr=cucsTrigTestDescr, cucsTrigLocalAbsWindowEntry=cucsTrigLocalAbsWindowEntry, cucsTrigMetaIntId=cucsTrigMetaIntId, cucsTrigTriggeredOrder=cucsTrigTriggeredOrder, cucsTrigLocalSchedRn=cucsTrigLocalSchedRn, cucsTrigMetaName=cucsTrigMetaName, cucsTrigTestIntId=cucsTrigTestIntId, cucsTrigMetaRn=cucsTrigMetaRn, cucsTrigTestIgnoreCap=cucsTrigTestIgnoreCap, cucsTrigMetaOperState=cucsTrigMetaOperState, cucsTrigLocalAbsWindowJobCount=cucsTrigLocalAbsWindowJobCount, cucsTrigSchedInstanceId=cucsTrigSchedInstanceId, cucsTrigSchedDn=cucsTrigSchedDn, cucsTrigRecurrWindowTimeCapped=cucsTrigRecurrWindowTimeCapped, cucsTrigTestScheduler=cucsTrigTestScheduler, cucsTrigLocalSchedDescr=cucsTrigLocalSchedDescr, cucsTrigLocalSchedName=cucsTrigLocalSchedName, cucsTrigTriggeredRn=cucsTrigTriggeredRn, cucsTrigAbsWindowJobCount=cucsTrigAbsWindowJobCount, cucsTrigTriggeredTrId=cucsTrigTriggeredTrId, cucsTrigLocalAbsWindowName=cucsTrigLocalAbsWindowName, cucsTrigTestDn=cucsTrigTestDn, cucsTrigAbsWindowDate=cucsTrigAbsWindowDate, cucsTrigMetaJobCount=cucsTrigMetaJobCount, cucsTrigTestPolicyOwner=cucsTrigTestPolicyOwner, cucsTrigSchedPolicyLevel=cucsTrigSchedPolicyLevel, cucsTrigSchedPolicyOwner=cucsTrigSchedPolicyOwner, cucsTrigTestOperState=cucsTrigTestOperState, cucsTrigTestRn=cucsTrigTestRn, cucsTrigRecurrWindowJobCount=cucsTrigRecurrWindowJobCount, cucsTrigAbsWindowConcurCap=cucsTrigAbsWindowConcurCap, cucsTrigLocalSchedOperState=cucsTrigLocalSchedOperState, cucsTrigLocalSchedPolicyLevel=cucsTrigLocalSchedPolicyLevel, cucsTrigAbsWindowTimeCapped=cucsTrigAbsWindowTimeCapped)
