...
mibBuilder.exportSymbols("HPNSASINFO-MIB", hpnsaSiPowerOnPassword=hpnsaSiPowerOnPassword, hpnsaSiNumEISASlots=hpnsaSiNumEISASlots, hpnsaSiVideoBlankMode=hpnsaSiVideoBlankMode, hpnsaSiNetServerMode=hpnsaSiNetServerMode, hpnsaSiAgentTable=hpnsaSiAgentTable, hpnsaSiMibRevMajor=hpnsaSiMibRevMajor, hpnsaSiFloppyDriveIndex=hpnsaSiFloppyDriveIndex, hpnsaSiAgentEntry=hpnsaSiAgentEntry, hpnsaSiBIOSVersion=hpnsaSiBIOSVersion, hpnsaSiCPUEntry=hpnsaSiCPUEntry, hpnsaSiPortIndex=hpnsaSiPortIndex, hpnsaSiPortEndAddress=hpnsaSiPortEndAddress, hpnsaSiVideoType=hpnsaSiVideoType, hpnsaSiRemoteLocatorLED=hpnsaSiRemoteLocatorLED, hpnsaSiModel=hpnsaSiModel, hpnsaSiPortTable=hpnsaSiPortTable, hpnsaSiSecurity=hpnsaSiSecurity, hpnsaSiPortType=hpnsaSiPortType, hpnsaSiPortEntry=hpnsaSiPortEntry, hpnsaSiRemoteLocatorLEDSupported=hpnsaSiRemoteLocatorLEDSupported, hpnsaSiBasicInfo=hpnsaSiBasicInfo, hpnsaSiAgentVersion=hpnsaSiAgentVersion, hpnsaSiWriteToFloppy=hpnsaSiWriteToFloppy, hpnsaSiMemory=hpnsaSiMemory, hpnsaSiAgentName=hpnsaSiAgentName, hpnsaSiCPUTable=hpnsaSiCPUTable, hpnsaSiSystemName=hpnsaSiSystemName, hpnsaSiOpSysVer=hpnsaSiOpSysVer, hpnsaSiSystemID=hpnsaSiSystemID, hpnsaSiExtMemSize=hpnsaSiExtMemSize, hpnsaSiBaseMemSize=hpnsaSiBaseMemSize, hpnsaSiMouseType=hpnsaSiMouseType, hpnsaSiModelName=hpnsaSiModelName, hpnsaSiMibRev=hpnsaSiMibRev, hpnsaSiFloppyDrive=hpnsaSiFloppyDrive, hpnsaSiOpSysType=hpnsaSiOpSysType, hpnsaSiFloppyDriveEntry=hpnsaSiFloppyDriveEntry, hpnsaSiNumISASlots=hpnsaSiNumISASlots, hpnsaSiMemType=hpnsaSiMemType, hpnsaSiMemSpeed=hpnsaSiMemSpeed, hp=hp, hpnsaSiNumPCISlots=hpnsaSiNumPCISlots, hpnsaSiNumFloppyDrives=hpnsaSiNumFloppyDrives, hpnsaSiPortStartAddress=hpnsaSiPortStartAddress, hpnsaSiPortInterruptNum=hpnsaSiPortInterruptNum, hpnsaSiAgent=hpnsaSiAgent, hpnsaSiOpSysDescription=hpnsaSiOpSysDescription, hpnsaSiCPUIndex=hpnsaSiCPUIndex, hpnsaSiFloppyDriveType=hpnsaSiFloppyDriveType, hpnsaSiAgentIndex=hpnsaSiAgentIndex, hpnsaSiKeyboardLockPassword=hpnsaSiKeyboardLockPassword, hpnsaSiKbdMouseInactivityTO=hpnsaSiKbdMouseInactivityTO, hpnsaSiRemoteLocatorLEDSet=hpnsaSiRemoteLocatorLEDSet, hpnsaSiPort=hpnsaSiPort, hpnsaSiAgentDate=hpnsaSiAgentDate, hpnsaSiCPUSpeed=hpnsaSiCPUSpeed, hpnsaSiBootDiskPriority=hpnsaSiBootDiskPriority, hpnsaSiMibRevMinor=hpnsaSiMibRevMinor, hpnsaSystemInfo=hpnsaSystemInfo, hpnsaSiVideoBIOSVersion=hpnsaSiVideoBIOSVersion, hpnsaSiCPUModel=hpnsaSiCPUModel, hpnsaSiRemoteLocatorLEDStatus=hpnsaSiRemoteLocatorLEDStatus, hpnsaSiSCSIBIOSVersion=hpnsaSiSCSIBIOSVersion, nm=nm, hpnsaSiKbdType=hpnsaSiKbdType, hpnsa=hpnsa, hpnsaSiFloppyDriveTable=hpnsaSiFloppyDriveTable, hpnsaSiNumCPU=hpnsaSiNumCPU)
