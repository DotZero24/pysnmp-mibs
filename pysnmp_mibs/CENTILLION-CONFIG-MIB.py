...
StatusIndicator, MacAddress, sysConfig, BitField, EnableIndicator = mibBuilder.importSymbols("CENTILLION-ROOT-MIB", "StatusIndicator", "MacAddress", "sysConfig", "BitField", "EnableIndicator")
...
mibBuilder.exportSymbols("CENTILLION-CONFIG-MIB", sysSNMPGroup=sysSNMPGroup, rifPrevious=rifPrevious, cnnetbiosNameAge=cnnetbiosNameAge, lnmBridgeGroupDisplayMode=lnmBridgeGroupDisplayMode, cnnetbiosNameTableEntry=cnnetbiosNameTableEntry, defaultGatewayAddr=defaultGatewayAddr, cnnetbiosNamePortType=cnnetbiosNamePortType, sysMcpRedundTable=sysMcpRedundTable, trapIPRcvrCommunity=trapIPRcvrCommunity, cnnetbiosNamePortNumber=cnnetbiosNamePortNumber, sysSNMPEnableTraps=sysSNMPEnableTraps, netbiosGroup=netbiosGroup, cnnetbiosNameVlanId=cnnetbiosNameVlanId, configLogin=configLogin, sysBcastAddr=sysBcastAddr, netbiosNameTableFlush=netbiosNameTableFlush, netbiosNameQueryInterval=netbiosNameQueryInterval, ipHostTable=ipHostTable, sysImgIndx=sysImgIndx, ipHostEnable=ipHostEnable, lnmOperStatus=lnmOperStatus, cnnetbiosNameProxies=cnnetbiosNameProxies, sonmpTrConfig=sonmpTrConfig, ipHostNetMask=ipHostNetMask, rifTable=rifTable, cnnetbiosNameEntry=cnnetbiosNameEntry, VlanId=VlanId, sysMgmtRingNumber=sysMgmtRingNumber, netbiosNameEntry=netbiosNameEntry, sysMcpRedundOperState=sysMcpRedundOperState, ipHostType=ipHostType, maxRids=maxRids, sysMcpRedundEntry=sysMcpRedundEntry, sysNetProtocol=sysNetProtocol, sysImgGblLoadDst=sysImgGblLoadDst, sysImgEntry=sysImgEntry, maxPerfMode=maxPerfMode, systemConfigMode=systemConfigMode, sysTFTPIpAddress=sysTFTPIpAddress, netbiosNameStatus=netbiosNameStatus, systemConfigIpOption=systemConfigIpOption, netbiosNameSuppressedQueries=netbiosNameSuppressedQueries, cpuClkRate=cpuClkRate, ipHostAddress=ipHostAddress, configSource=configSource, sysSNMPTrapIPReceiverEntry=sysSNMPTrapIPReceiverEntry, configSave=configSave, sysImgGbl=sysImgGbl, sysTFTPResult=sysTFTPResult, sysMcpRedundCfgStatus=sysMcpRedundCfgStatus, sysMcpRedundIndx=sysMcpRedundIndx, ipConfigProtocol=ipConfigProtocol, ipHostDefaultGatewayAddr=ipHostDefaultGatewayAddr, cnnetbiosNameStatus=cnnetbiosNameStatus, sysTFTPGroup=sysTFTPGroup, configServerAddr=configServerAddr, lnmLinkPassword=lnmLinkPassword, trapIPRcvrStatus=trapIPRcvrStatus, cnnetbiosNameSuppressedQueries=cnnetbiosNameSuppressedQueries, sysTFTPStart=sysTFTPStart, ipHostConfigProtocol=ipHostConfigProtocol, sysMcpRedundType=sysMcpRedundType, sysImgTable=sysImgTable, rifEntry=rifEntry, sysNetMask=sysNetMask, ipHostNumber=ipHostNumber, netbiosNameAge=netbiosNameAge, ipHostBcastAddr=ipHostBcastAddr, sysMcpRedundGbl=sysMcpRedundGbl, rifCount=rifCount, systemMaxPacketInfoSize=systemMaxPacketInfoSize, sysMcpRedundNxtGblState=sysMcpRedundNxtGblState, sysMcpRedundInfo=sysMcpRedundInfo, netbiosNameTableEntry=netbiosNameTableEntry, cnnetbiosNameName=cnnetbiosNameName, netbiosNamePortNumber=netbiosNamePortNumber, netbiosNameVirtualRingNumber=netbiosNameVirtualRingNumber, configProtocol=configProtocol, cnnetbiosNameStationAddress=cnnetbiosNameStationAddress, netbiosNameName=netbiosNameName, sysSNMPSetCommunity=sysSNMPSetCommunity, sysSNMPTrapIPReceiverTable=sysSNMPTrapIPReceiverTable, sysImgVer=sysImgVer, cnnetbiosNameVirtualRingNumber=cnnetbiosNameVirtualRingNumber, localAdminMacAddress=localAdminMacAddress, srbIeeeBpduEnable=srbIeeeBpduEnable, ipHostIndex=ipHostIndex, lnmGroup=lnmGroup, rifNext=rifNext, sysTFTPFileName=sysTFTPFileName, configFilename=configFilename, sysTableConfig=sysTableConfig, lnmAdminStatus=lnmAdminStatus, sysTFTPFileType=sysTFTPFileType, sysImgInfo=sysImgInfo, sysIpProtocol=sysIpProtocol, netbiosNamePortType=netbiosNamePortType, rifPath=rifPath, sysImgGblInvokeSrc=sysImgGblInvokeSrc, tbRifProxyEnable=tbRifProxyEnable, netbiosNameTableAgingTimer=netbiosNameTableAgingTimer, sysAddr=sysAddr, ipHostEntry=ipHostEntry, netbiosNameStationAddress=netbiosNameStationAddress, netbiosNameCardNumber=netbiosNameCardNumber, sysMcpRedundPriority=sysMcpRedundPriority, netbiosNameProxies=netbiosNameProxies, cnnetbiosNameCardNumber=cnnetbiosNameCardNumber, srUnknownFrameFlood=srUnknownFrameFlood, rifIndex=rifIndex, sysImgStatus=sysImgStatus, rifInUse=rifInUse, rifLength=rifLength, sysSNMPGetCommunity=sysSNMPGetCommunity, trapIPRcvrAddress=trapIPRcvrAddress, sonmpTrSpeed=sonmpTrSpeed)
