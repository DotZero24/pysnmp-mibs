...
# Notes
# -----
# ASN.1 source file://mibs/eltex/ELTEX-MES-FLEX-LINKS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:48:12 2025
...
eltFlexLinksMIBCompliance.setObjects(
      *(("ELTEX-MES-FLEX-LINKS-MIB", "eltFlexLinksIfConfigGroup"),
        ("ELTEX-MES-FLEX-LINKS-MIB", "eltFlexLinksIfStatusGroup"),
        ("ELTEX-MES-FLEX-LINKS-MIB", "eltFlexLinksEnableNotifGroup"),
        ("ELTEX-MES-FLEX-LINKS-MIB", "eltFlexLinksNotifGroup"),
        ("ELTEX-MES-FLEX-LINKS-MIB", "eltFlexLinksPreemptionGroup"))
)
if mibBuilder.loadTexts:
