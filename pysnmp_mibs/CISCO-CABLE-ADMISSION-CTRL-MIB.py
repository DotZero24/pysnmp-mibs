...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CABLE-ADMISSION-CTRL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:33:00 2025
...
_CcacNotifyEnable_Type.__name__ = "TruthValue"
...
_CcacEventMonitoring_Type.__name__ = "CcacMonitoredEvent"
...
class _CcacUsConfigRevAppBucketName_Type(SnmpAdminString):
    """Custom type ccacUsConfigRevAppBucketName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CcacUsConfigRevAppBucketName_Type.__name__ = "SnmpAdminString"
...
_CcacUsConfigRevStorageType_Type.__name__ = "StorageType"
...
class _CcacDsConfigRevAppBucketName_Type(SnmpAdminString):
    """Custom type ccacDsConfigRevAppBucketName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CcacDsConfigRevAppBucketName_Type.__name__ = "SnmpAdminString"
...
_CcacDsConfigRevStorageType_Type.__name__ = "StorageType"
...
_CcacEventHistTableSize_Type.__name__ = "Unsigned32"
...
ciscoCableAdmCtrlCompliance.setObjects(
      *(("CISCO-CABLE-ADMISSION-CTRL-MIB", "ciscoCableAdmCtrlConfigGroup"),
        ("CISCO-CABLE-ADMISSION-CTRL-MIB", "ciscoCableAdmCtrlStatGroup"),
        ("CISCO-CABLE-ADMISSION-CTRL-MIB", "ciscoCableAdmCtrlEventHistGroup"),
        ("CISCO-CABLE-ADMISSION-CTRL-MIB", "ciscoCableAdmCtrlNotifGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCableAdmCtrlComplianceRev.setObjects(
      *(("CISCO-CABLE-ADMISSION-CTRL-MIB", "ciscoCableAdmCtrlConfigGroupRev1"),
        ("CISCO-CABLE-ADMISSION-CTRL-MIB", "ciscoCableAdmCtrlStatGroupRev1"),
        ("CISCO-CABLE-ADMISSION-CTRL-MIB", "ciscoCableAdmCtrlEventHistGroup"),
        ("CISCO-CABLE-ADMISSION-CTRL-MIB", "ciscoCableAdmCtrlNotifGroup"))
)
if mibBuilder.loadTexts:
