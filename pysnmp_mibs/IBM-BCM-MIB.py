...
mibBuilder.exportSymbols("IBM-BCM-MIB", bcmNbBroadcastFramesDirectedNoRif=bcmNbBroadcastFramesDirectedNoRif, bcmIpxBroadcastFramesDirectedAre=bcmIpxBroadcastFramesDirectedAre, bcmNbTransmitErrorFrames=bcmNbTransmitErrorFrames, bcmCIpxStatGroup=bcmCIpxStatGroup, bcmBroadcastFramesDirectedSte=bcmBroadcastFramesDirectedSte, bcmCStaticTargetsConfigGroup=bcmCStaticTargetsConfigGroup, bcmIpxConfCacheAge=bcmIpxConfCacheAge, bcmStaticTargetsNextId=bcmStaticTargetsNextId, bcmStatEntry=bcmStatEntry, bcmNbOctetsReceived=bcmNbOctetsReceived, bcmStatTable=bcmStatTable, bcmIpConfOperStatus=bcmIpConfOperStatus, bcmStaticTargetsIndex=bcmStaticTargetsIndex, bcmConfTable=bcmConfTable, bcmOctetsDiscarded=bcmOctetsDiscarded, bcmNbConfCacheAge=bcmNbConfCacheAge, bcmCIpxConfigGroup=bcmCIpxConfigGroup, bcmCNbConfigGroup=bcmCNbConfigGroup, bcmOctetsReturned=bcmOctetsReturned, bcmIpxFramesReceived=bcmIpxFramesReceived, bcmIpFramesReceived=bcmIpFramesReceived, bcmOctetsReceived=bcmOctetsReceived, bcmIpBroadcastFramesDirectedSte=bcmIpBroadcastFramesDirectedSte, bcmNbConfAdminStatus=bcmNbConfAdminStatus, bcmNbStatTable=bcmNbStatTable, bcmIpxOctetsReturned=bcmIpxOctetsReturned, bcmStaticTargetsAtmAddress=bcmStaticTargetsAtmAddress, bcmBroadcastFramesDirectedNoRif=bcmBroadcastFramesDirectedNoRif, bcmConfEntry=bcmConfEntry, bcmStaticTargetsRowStatus=bcmStaticTargetsRowStatus, bcmCConfGroup=bcmCConfGroup, bcmIpxFramesTransmitted=bcmIpxFramesTransmitted, bcmIpFramesDiscarded=bcmIpFramesDiscarded, bcmTransmitErrorFrames=bcmTransmitErrorFrames, bcmIpxConfOperStatus=bcmIpxConfOperStatus, bcmIpxFramesDiscarded=bcmIpxFramesDiscarded, bcmStatGroup=bcmStatGroup, bcmIpConfAdminStatus=bcmIpConfAdminStatus, bcmCIpStatGroup=bcmCIpStatGroup, bcmIpxStatTable=bcmIpxStatTable, bcmStaticTargetsEntry=bcmStaticTargetsEntry, bcmIpxTransmitErrorFrames=bcmIpxTransmitErrorFrames, bcmIpFramesTransmitted=bcmIpFramesTransmitted, bcmNbBroadcastFramesDirectedSrf=bcmNbBroadcastFramesDirectedSrf, bcmIpStatTable=bcmIpStatTable, bcmNbOctetsReturned=bcmNbOctetsReturned, bcmIpOctetsDiscarded=bcmIpOctetsDiscarded, bcmIpConfTable=bcmIpConfTable, bcmIpConfEntry=bcmIpConfEntry, bcmIpOctetsTransmitted=bcmIpOctetsTransmitted, bcmIpxStatEntry=bcmIpxStatEntry, bcmFramesReturned=bcmFramesReturned, bcmIpxBroadcastFramesDirectedNoRif=bcmIpxBroadcastFramesDirectedNoRif, bcmNbConfTable=bcmNbConfTable, bcmCNbStatGroup=bcmCNbStatGroup, bcmNbFramesTransmitted=bcmNbFramesTransmitted, bcmNbBroadcastFramesDirectedAre=bcmNbBroadcastFramesDirectedAre, bcmIpBroadcastFramesDirectedAre=bcmIpBroadcastFramesDirectedAre, bcmIpxOctetsDiscarded=bcmIpxOctetsDiscarded, bcmIpOctetsReturned=bcmIpOctetsReturned, bcmNbOctetsDiscarded=bcmNbOctetsDiscarded, bcmNbConfEntry=bcmNbConfEntry, bcmFramesReceived=bcmFramesReceived, bcmIpBroadcastFramesDirectedSrf=bcmIpBroadcastFramesDirectedSrf, bcmMIBConformance=bcmMIBConformance, bcmIpTransmitErrorFrames=bcmIpTransmitErrorFrames, bcmBroadcastFramesDirectedAre=bcmBroadcastFramesDirectedAre, bcmIpOctetsReceived=bcmIpOctetsReceived, bcmStaticTargetsMacAddress=bcmStaticTargetsMacAddress, bcmIpxOctetsReceived=bcmIpxOctetsReceived, bcmIpxConfEntry=bcmIpxConfEntry, bcmNbFramesReturned=bcmNbFramesReturned, bcmNbFramesDiscarded=bcmNbFramesDiscarded, bcmIpxFramesReturned=bcmIpxFramesReturned, bcmMIBCompliance=bcmMIBCompliance, bcmIpxConfTable=bcmIpxConfTable, bcmIpxConfAdminStatus=bcmIpxConfAdminStatus, bcmIpxBroadcastFramesDirectedSrf=bcmIpxBroadcastFramesDirectedSrf, bcmNbStatEntry=bcmNbStatEntry, bcmNbBroadcastFramesDirectedSte=bcmNbBroadcastFramesDirectedSte, bcmStaticTargetsTable=bcmStaticTargetsTable, bcmTransmitErrorOctets=bcmTransmitErrorOctets, bcmIpStatEntry=bcmIpStatEntry, bcmIpTransmitErrorOctets=bcmIpTransmitErrorOctets, bcmIpBroadcastFramesDirectedNoRif=bcmIpBroadcastFramesDirectedNoRif, bcmStaticTargetsProtocol=bcmStaticTargetsProtocol, bcmIpConfCacheAge=bcmIpConfCacheAge, bcmIpxOctetsTransmitted=bcmIpxOctetsTransmitted, bcmIpxBroadcastFramesDirectedSte=bcmIpxBroadcastFramesDirectedSte, bcmConfGroup=bcmConfGroup, bcmCIpConfigGroup=bcmCIpConfigGroup, bcmNbTransmitErrorOctets=bcmNbTransmitErrorOctets, BcmCacheAge=BcmCacheAge, bcmMIBGroups=bcmMIBGroups, bcmOctetsTransmitted=bcmOctetsTransmitted, bcmCStatGroup=bcmCStatGroup, bcmFramesDiscarded=bcmFramesDiscarded, bcmMIBCompliances=bcmMIBCompliances, bcmNbOctetsTransmitted=bcmNbOctetsTransmitted, ibmBcmMIB=ibmBcmMIB, bcmNbConfOperStatus=bcmNbConfOperStatus, bcmBroadcastFramesDirectedSrf=bcmBroadcastFramesDirectedSrf, bcmIpFramesReturned=bcmIpFramesReturned, bcmNbFramesReceived=bcmNbFramesReceived, bcmFramesTransmitted=bcmFramesTransmitted, bcmIpxTransmitErrorOctets=bcmIpxTransmitErrorOctets, bcmRouteCacheEnabled=bcmRouteCacheEnabled)
