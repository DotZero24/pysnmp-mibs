...
_G='read-only'
_F='not-accessible'
_E='A3COM-HUAWEI-VODIGITALIF-MIB'
_D='OctetString'
_C='Integer32'
_B='read-write'
_A='current'
...
h3cVoDigitalIfCommonObjects=_H3cVoDigitalIfCommonObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,4,1))
_H3cVoDigitalIfCommonCfgTable_Object=MibTable
h3cVoDigitalIfCommonCfgTable=_H3cVoDigitalIfCommonCfgTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,1,1))
if mibBuilder.loadTexts:h3cVoDigitalIfCommonCfgTable.setStatus(_A)
_H3cVoDigitalIfCommonCfgEntry_Object=MibTableRow
h3cVoDigitalIfCommonCfgEntry=_H3cVoDigitalIfCommonCfgEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,1,1,1))
...
h3cVoDIfCfgPort=_H3cVoDIfCfgPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,1,1,1,1),_H3cVoDIfCfgPort_Type())
...
h3cVoDIfCfgGroup=_H3cVoDIfCfgGroup_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,1,1,1,2),_H3cVoDIfCfgGroup_Type())
...
h3cVoDIfCfgBoardType=_H3cVoDIfCfgBoardType_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,1,1,1,3),_H3cVoDIfCfgBoardType_Type())
...
h3cVoDIfCfgSignalType=_H3cVoDIfCfgSignalType_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,1,1,1,4),_H3cVoDIfCfgSignalType_Type())
...
h3cVoDIfCfgTsInformation=_H3cVoDIfCfgTsInformation_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,1,1,1,5),_H3cVoDIfCfgTsInformation_Type())
...
h3cVoDIfCfgPortSubLine=_H3cVoDIfCfgPortSubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,1,1,1,6),_H3cVoDIfCfgPortSubLine_Type())
...
h3cVoDigitalIfEMObjects=_H3cVoDigitalIfEMObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,4,2))
_H3cVoDigitalIfEMCfgTable_Object=MibTable
h3cVoDigitalIfEMCfgTable=_H3cVoDigitalIfEMCfgTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,1))
if mibBuilder.loadTexts:h3cVoDigitalIfEMCfgTable.setStatus(_A)
_H3cVoDigitalIfEMCfgEntry_Object=MibTableRow
h3cVoDigitalIfEMCfgEntry=_H3cVoDigitalIfEMCfgEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,1,1))
...
h3cVoDIfEMCfgPort=_H3cVoDIfEMCfgPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,1,1,1),_H3cVoDIfEMCfgPort_Type())
...
h3cVoDIfEMCfgGroup=_H3cVoDIfEMCfgGroup_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,1,1,2),_H3cVoDIfEMCfgGroup_Type())
...
h3cVoDIfEMCfgTimeoutInterDigit=_H3cVoDIfEMCfgTimeoutInterDigit_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,1,1,3),_H3cVoDIfEMCfgTimeoutInterDigit_Type())
...
h3cVoDIfEMCfgTimeoutRinging=_H3cVoDIfEMCfgTimeoutRinging_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,1,1,4),_H3cVoDIfEMCfgTimeoutRinging_Type())
...
h3cVoDIfEMCfgTimeoutWaitDigit=_H3cVoDIfEMCfgTimeoutWaitDigit_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,1,1,5),_H3cVoDIfEMCfgTimeoutWaitDigit_Type())
...
h3cVoDIfEMCfgPortSubLine=_H3cVoDIfEMCfgPortSubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,1,1,6),_H3cVoDIfEMCfgPortSubLine_Type())
...
h3cVoDigitalIfEMABCDCfgTable=_H3cVoDigitalIfEMABCDCfgTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,2))
if mibBuilder.loadTexts:h3cVoDigitalIfEMABCDCfgTable.setStatus(_A)
_H3cVoDigitalIfEMABCDCfgEntry_Object=MibTableRow
h3cVoDigitalIfEMABCDCfgEntry=_H3cVoDigitalIfEMABCDCfgEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,2,1))
...
h3cVoDIfEMABCDCfgPort=_H3cVoDIfEMABCDCfgPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,2,1,1),_H3cVoDIfEMABCDCfgPort_Type())
...
h3cVoDIfEMABCDCfgGroup=_H3cVoDIfEMABCDCfgGroup_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,2,1,2),_H3cVoDIfEMABCDCfgGroup_Type())
...
h3cVoDIfEMABCDRxIdle=_H3cVoDIfEMABCDRxIdle_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,2,1,3),_H3cVoDIfEMABCDRxIdle_Type())
...
h3cVoDIfEMABCDRxSeizure=_H3cVoDIfEMABCDRxSeizure_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,2,1,4),_H3cVoDIfEMABCDRxSeizure_Type())
...
h3cVoDIfEMABCDTxIdle=_H3cVoDIfEMABCDTxIdle_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,2,1,5),_H3cVoDIfEMABCDTxIdle_Type())
...
h3cVoDIfEMABCDTxSeizure=_H3cVoDIfEMABCDTxSeizure_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,2,1,6),_H3cVoDIfEMABCDTxSeizure_Type())
...
h3cVoDIFEMABCDSubLine=_H3cVoDIFEMABCDSubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,2,1,7),_H3cVoDIFEMABCDSubLine_Type())
...
h3cVoDigitalIfEMTimerTable=_H3cVoDigitalIfEMTimerTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4))
if mibBuilder.loadTexts:h3cVoDigitalIfEMTimerTable.setStatus(_A)
_H3cVoDigitalIfEMTimerEntry_Object=MibTableRow
h3cVoDigitalIfEMTimerEntry=_H3cVoDigitalIfEMTimerEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1))
...
h3cVoDIfEMTimerPort=_H3cVoDIfEMTimerPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,1),_H3cVoDIfEMTimerPort_Type())
...
h3cVoDIfEMTimerGroup=_H3cVoDIfEMTimerGroup_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,2),_H3cVoDIfEMTimerGroup_Type())
...
h3cVoDIfEMTimerSendWink=_H3cVoDIfEMTimerSendWink_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,4),_H3cVoDIfEMTimerSendWink_Type())
...
h3cVoDIfEMTimerWinkRising=_H3cVoDIfEMTimerWinkRising_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,5),_H3cVoDIfEMTimerWinkRising_Type())
...
h3cVoDIfEMTimerWinkHold=_H3cVoDIfEMTimerWinkHold_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,6),_H3cVoDIfEMTimerWinkHold_Type())
...
h3cVoDIfEMTimerDialoutDelay=_H3cVoDIfEMTimerDialoutDelay_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,7),_H3cVoDIfEMTimerDialoutDelay_Type())
...
h3cVoDIfEMTimerDelayRising=_H3cVoDIfEMTimerDelayRising_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,8),_H3cVoDIfEMTimerDelayRising_Type())
...
h3cVoDIfEMTimerDelayHold=_H3cVoDIfEMTimerDelayHold_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,9),_H3cVoDIfEMTimerDelayHold_Type())
...
h3cVoDIfEMTimerDtmf=_H3cVoDIfEMTimerDtmf_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,10),_H3cVoDIfEMTimerDtmf_Type())
...
h3cVoDIfEMTimerDtmfInterval=_H3cVoDIfEMTimerDtmfInterval_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,11),_H3cVoDIfEMTimerDtmfInterval_Type())
...
h3cVoDIfEMTimerPortSubLine=_H3cVoDIfEMTimerPortSubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,2,4,1,12),_H3cVoDIfEMTimerPortSubLine_Type())
...
h3cVoDigitalIfR2Objects=_H3cVoDigitalIfR2Objects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,4,3))
_H3cVoDigitalIfR2CfgTable_Object=MibTable
h3cVoDigitalIfR2CfgTable=_H3cVoDigitalIfR2CfgTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,1))
if mibBuilder.loadTexts:h3cVoDigitalIfR2CfgTable.setStatus(_A)
_H3cVoDigitalIfR2CfgEntry_Object=MibTableRow
h3cVoDigitalIfR2CfgEntry=_H3cVoDigitalIfR2CfgEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,1,1))
...
h3cVoDIfR2CfgPort=_H3cVoDIfR2CfgPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,1,1,1),_H3cVoDIfR2CfgPort_Type())
...
h3cVoDIfR2CfgGroup=_H3cVoDIfR2CfgGroup_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,1,1,2),_H3cVoDIfR2CfgGroup_Type())
...
h3cVoDIfR2CfgCountryMode=_H3cVoDIfR2CfgCountryMode_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,1,1,3),_H3cVoDIfR2CfgCountryMode_Type())
...
h3cVoDIfR2CfgSpecialChar=_H3cVoDIfR2CfgSpecialChar_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,1,1,4),_H3cVoDIfR2CfgSpecialChar_Type())
...
h3cVoDIfR2CfgSpecialSignal=_H3cVoDIfR2CfgSpecialSignal_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,1,1,5),_H3cVoDIfR2CfgSpecialSignal_Type())
...
h3cVoDIfR2CfgSelectMode=_H3cVoDIfR2CfgSelectMode_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,1,1,6),_H3cVoDIfR2CfgSelectMode_Type())
...
h3cVoDIFR2CfgSubLine=_H3cVoDIFR2CfgSubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,1,1,7),_H3cVoDIFR2CfgSubLine_Type())
...
h3cVoDigitalIfR2ABCDCfgTable=_H3cVoDigitalIfR2ABCDCfgTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2))
if mibBuilder.loadTexts:h3cVoDigitalIfR2ABCDCfgTable.setStatus(_A)
_H3cVoDigitalIfR2ABCDCfgEntry_Object=MibTableRow
h3cVoDigitalIfR2ABCDCfgEntry=_H3cVoDigitalIfR2ABCDCfgEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1))
...
h3cVoDIfR2ABCDCfgPort=_H3cVoDIfR2ABCDCfgPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,1),_H3cVoDIfR2ABCDCfgPort_Type())
...
h3cVoDIfR2ABCDCfgGroup=_H3cVoDIfR2ABCDCfgGroup_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,2),_H3cVoDIfR2ABCDCfgGroup_Type())
...
h3cVoDIfR2ABCDReverseABCD=_H3cVoDIfR2ABCDReverseABCD_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,3),_H3cVoDIfR2ABCDReverseABCD_Type())
...
h3cVoDIfR2ABCDRenewABCD=_H3cVoDIfR2ABCDRenewABCD_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,4),_H3cVoDIfR2ABCDRenewABCD_Type())
...
h3cVoDIfR2ABCDRxIdle=_H3cVoDIfR2ABCDRxIdle_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,5),_H3cVoDIfR2ABCDRxIdle_Type())
...
h3cVoDIfR2ABCDTxIdle=_H3cVoDIfR2ABCDTxIdle_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,6),_H3cVoDIfR2ABCDTxIdle_Type())
...
h3cVoDIfR2ABCDRxSeizure=_H3cVoDIfR2ABCDRxSeizure_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,7),_H3cVoDIfR2ABCDRxSeizure_Type())
...
h3cVoDIfR2ABCDTxSeizure=_H3cVoDIfR2ABCDTxSeizure_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,8),_H3cVoDIfR2ABCDTxSeizure_Type())
...
h3cVoDIfR2ABCDRxSeizureAck=_H3cVoDIfR2ABCDRxSeizureAck_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,9),_H3cVoDIfR2ABCDRxSeizureAck_Type())
...
h3cVoDIfR2ABCDTxSeizureAck=_H3cVoDIfR2ABCDTxSeizureAck_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,10),_H3cVoDIfR2ABCDTxSeizureAck_Type())
...
h3cVoDIfR2ABCDRxAnswer=_H3cVoDIfR2ABCDRxAnswer_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,11),_H3cVoDIfR2ABCDRxAnswer_Type())
...
h3cVoDIfR2ABCDTxAnswer=_H3cVoDIfR2ABCDTxAnswer_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,12),_H3cVoDIfR2ABCDTxAnswer_Type())
...
h3cVoDIfR2ABCDRxClearForward=_H3cVoDIfR2ABCDRxClearForward_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,13),_H3cVoDIfR2ABCDRxClearForward_Type())
...
h3cVoDIfR2ABCDTxClearForward=_H3cVoDIfR2ABCDTxClearForward_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,14),_H3cVoDIfR2ABCDTxClearForward_Type())
...
h3cVoDIfR2ABCDRxClearBack=_H3cVoDIfR2ABCDRxClearBack_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,15),_H3cVoDIfR2ABCDRxClearBack_Type())
...
h3cVoDIfR2ABCDTxClearBack=_H3cVoDIfR2ABCDTxClearBack_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,16),_H3cVoDIfR2ABCDTxClearBack_Type())
...
h3cVoDIfR2ABCDRxReleaseGuard=_H3cVoDIfR2ABCDRxReleaseGuard_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,17),_H3cVoDIfR2ABCDRxReleaseGuard_Type())
...
h3cVoDIfR2ABCDTxReleaseGuard=_H3cVoDIfR2ABCDTxReleaseGuard_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,18),_H3cVoDIfR2ABCDTxReleaseGuard_Type())
...
h3cVoDIfR2ABCDRxBlocking=_H3cVoDIfR2ABCDRxBlocking_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,19),_H3cVoDIfR2ABCDRxBlocking_Type())
...
h3cVoDIfR2ABCDTxBlocking=_H3cVoDIfR2ABCDTxBlocking_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,20),_H3cVoDIfR2ABCDTxBlocking_Type())
...
h3cVoDIfR2ABCDSubLine=_H3cVoDIfR2ABCDSubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,2,1,21),_H3cVoDIfR2ABCDSubLine_Type())
...
h3cVoDigitalIfR2MfcCfgTable=_H3cVoDigitalIfR2MfcCfgTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3))
if mibBuilder.loadTexts:h3cVoDigitalIfR2MfcCfgTable.setStatus(_A)
_H3cVoDigitalIfR2MfcCfgEntry_Object=MibTableRow
h3cVoDigitalIfR2MfcCfgEntry=_H3cVoDigitalIfR2MfcCfgEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1))
...
h3cVoDIfR2MfcCfgPort=_H3cVoDIfR2MfcCfgPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,1),_H3cVoDIfR2MfcCfgPort_Type())
...
h3cVoDIfR2MfcCfgGroup=_H3cVoDIfR2MfcCfgGroup_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,2),_H3cVoDIfR2MfcCfgGroup_Type())
...
h3cVoDIfR2BillingCategory=_H3cVoDIfR2BillingCategory_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,3),_H3cVoDIfR2BillingCategory_Type())
...
h3cVoDIfR2CallingCategory=_H3cVoDIfR2CallingCategory_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,4),_H3cVoDIfR2CallingCategory_Type())
...
h3cVoDIfR2Congestion=_H3cVoDIfR2Congestion_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,5),_H3cVoDIfR2Congestion_Type())
...
h3cVoDIfR2DemandRefused=_H3cVoDIfR2DemandRefused_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,6),_H3cVoDIfR2DemandRefused_Type())
...
h3cVoDIfR2DigitEnd=_H3cVoDIfR2DigitEnd_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,7),_H3cVoDIfR2DigitEnd_Type())
...
h3cVoDIfR2Nullnum=_H3cVoDIfR2Nullnum_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,8),_H3cVoDIfR2Nullnum_Type())
...
h3cVoDIfR2ReqBillingCategory=_H3cVoDIfR2ReqBillingCategory_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,9),_H3cVoDIfR2ReqBillingCategory_Type())
...
h3cVoDIfR2ReqCallingCategory=_H3cVoDIfR2ReqCallingCategory_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,10),_H3cVoDIfR2ReqCallingCategory_Type())
...
h3cVoDIfR2ReqCurrentdigit=_H3cVoDIfR2ReqCurrentdigit_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,11),_H3cVoDIfR2ReqCurrentdigit_Type())
...
h3cVoDIfR2ReqFirstCallingnum=_H3cVoDIfR2ReqFirstCallingnum_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,12),_H3cVoDIfR2ReqFirstCallingnum_Type())
...
h3cVoDIfR2ReqFirstDigit=_H3cVoDIfR2ReqFirstDigit_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,13),_H3cVoDIfR2ReqFirstDigit_Type())
...
h3cVoDIfR2ReqNextCallednum=_H3cVoDIfR2ReqNextCallednum_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,14),_H3cVoDIfR2ReqNextCallednum_Type())
...
h3cVoDIfR2ReqNextCallingnum=_H3cVoDIfR2ReqNextCallingnum_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,15),_H3cVoDIfR2ReqNextCallingnum_Type())
...
h3cVoDIfR2ReqLastFirstDigit=_H3cVoDIfR2ReqLastFirstDigit_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,16),_H3cVoDIfR2ReqLastFirstDigit_Type())
...
h3cVoDIfR2ReqLastSecondDigit=_H3cVoDIfR2ReqLastSecondDigit_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,17),_H3cVoDIfR2ReqLastSecondDigit_Type())
...
h3cVoDIfR2ReqLastThirdDigit=_H3cVoDIfR2ReqLastThirdDigit_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,18),_H3cVoDIfR2ReqLastThirdDigit_Type())
...
h3cVoDIfR2ReqSwitchGroupB=_H3cVoDIfR2ReqSwitchGroupB_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,19),_H3cVoDIfR2ReqSwitchGroupB_Type())
...
h3cVoDIfR2SubscriberIdle=_H3cVoDIfR2SubscriberIdle_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,20),_H3cVoDIfR2SubscriberIdle_Type())
...
h3cVoDIfR2SubscriberBusy=_H3cVoDIfR2SubscriberBusy_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,21),_H3cVoDIfR2SubscriberBusy_Type())
...
h3cVoDIfR2ReqCallingnumOffset=_H3cVoDIfR2ReqCallingnumOffset_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,22),_H3cVoDIfR2ReqCallingnumOffset_Type())
...
h3cVoDIfR2CallCreateInA=_H3cVoDIfR2CallCreateInA_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,23),_H3cVoDIfR2CallCreateInA_Type())
...
h3cVoDIfR2ReqFirstCalledNumInC=_H3cVoDIfR2ReqFirstCalledNumInC_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,24),_H3cVoDIfR2ReqFirstCalledNumInC_Type())
...
h3cVoDIfR2ReqCurCalledNumInC=_H3cVoDIfR2ReqCurCalledNumInC_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,25),_H3cVoDIfR2ReqCurCalledNumInC_Type())
...
h3cVoDIfR2ReqCalledNumSwitchA=_H3cVoDIfR2ReqCalledNumSwitchA_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,26),_H3cVoDIfR2ReqCalledNumSwitchA_Type())
...
h3cVoDIfR2ReqSpecialSignal=_H3cVoDIfR2ReqSpecialSignal_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,27),_H3cVoDIfR2ReqSpecialSignal_Type())
...
h3cVoDIfR2SubscriberCharge=_H3cVoDIfR2SubscriberCharge_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,28),_H3cVoDIfR2SubscriberCharge_Type())
...
h3cVoDIfR2SubscriberAbnormal=_H3cVoDIfR2SubscriberAbnormal_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,29),_H3cVoDIfR2SubscriberAbnormal_Type())
...
h3cVoDIfR2Ani=_H3cVoDIfR2Ani_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,30),_H3cVoDIfR2Ani_Type())
...
h3cVoDIfR2SubLine=_H3cVoDIfR2SubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,3,1,31),_H3cVoDIfR2SubLine_Type())
...
h3cVoDigitalIfR2TimerCfgTable=_H3cVoDigitalIfR2TimerCfgTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4))
if mibBuilder.loadTexts:h3cVoDigitalIfR2TimerCfgTable.setStatus(_A)
_H3cVoDigitalIfR2TimerCfgEntry_Object=MibTableRow
h3cVoDigitalIfR2TimerCfgEntry=_H3cVoDigitalIfR2TimerCfgEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1))
...
h3cVoDIfR2TimeCfgPort=_H3cVoDIfR2TimeCfgPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,1),_H3cVoDIfR2TimeCfgPort_Type())
...
h3cVoDIfR2TimeCfgGroup=_H3cVoDIfR2TimeCfgGroup_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,2),_H3cVoDIfR2TimeCfgGroup_Type())
...
h3cVoDIfR2CfgDebounceTime=_H3cVoDIfR2CfgDebounceTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,3),_H3cVoDIfR2CfgDebounceTime_Type())
...
h3cVoDIfR2CfgSendringBackTime=_H3cVoDIfR2CfgSendringBackTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,4),_H3cVoDIfR2CfgSendringBackTime_Type())
...
h3cVoDIfR2CfgSendringBusyTime=_H3cVoDIfR2CfgSendringBusyTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,5),_H3cVoDIfR2CfgSendringBusyTime_Type())
...
h3cVoDIfR2PulseSignalPersistT=_H3cVoDIfR2PulseSignalPersistT_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,6),_H3cVoDIfR2PulseSignalPersistT_Type())
...
h3cVoDIfR2CfgDlAnswerTime=_H3cVoDIfR2CfgDlAnswerTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,7),_H3cVoDIfR2CfgDlAnswerTime_Type())
...
h3cVoDIfR2CfgDlClearBackTime=_H3cVoDIfR2CfgDlClearBackTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,8),_H3cVoDIfR2CfgDlClearBackTime_Type())
...
h3cVoDIfR2CfgDlClearForwardT=_H3cVoDIfR2CfgDlClearForwardT_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,9),_H3cVoDIfR2CfgDlClearForwardT_Type())
...
h3cVoDIfR2CfgDlSeizureTime=_H3cVoDIfR2CfgDlSeizureTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,10),_H3cVoDIfR2CfgDlSeizureTime_Type())
...
h3cVoDIfR2CfgDlReanswerTime=_H3cVoDIfR2CfgDlReanswerTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,11),_H3cVoDIfR2CfgDlReanswerTime_Type())
...
h3cVoDIfR2CfgDlRelGuardTime=_H3cVoDIfR2CfgDlRelGuardTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,12),_H3cVoDIfR2CfgDlRelGuardTime_Type())
...
h3cVoDIfR2CfgMfcGroupBTime=_H3cVoDIfR2CfgMfcGroupBTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,13),_H3cVoDIfR2CfgMfcGroupBTime_Type())
...
h3cVoDIfR2CfgDTMFTime=_H3cVoDIfR2CfgDTMFTime_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,14),_H3cVoDIfR2CfgDTMFTime_Type())
...
h3cVoDIfR2TimeCfgSubLine=_H3cVoDIfR2TimeCfgSubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,4,1,15),_H3cVoDIfR2TimeCfgSubLine_Type())
...
h3cVoDIfR2CapabilityCfgTable=_H3cVoDIfR2CapabilityCfgTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5))
if mibBuilder.loadTexts:h3cVoDIfR2CapabilityCfgTable.setStatus(_A)
_H3cVoDIfR2CapabilityCfgEntry_Object=MibTableRow
h3cVoDIfR2CapabilityCfgEntry=_H3cVoDIfR2CapabilityCfgEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1))
...
h3cVoDIfR2CapCfgPort=_H3cVoDIfR2CapCfgPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,1),_H3cVoDIfR2CapCfgPort_Type())
...
h3cVoDIfR2CapCfgGroup=_H3cVoDIfR2CapCfgGroup_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,2),_H3cVoDIfR2CapCfgGroup_Type())
...
h3cVoDIfR2CfgGroupB=_H3cVoDIfR2CfgGroupB_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,3),_H3cVoDIfR2CfgGroupB_Type())
...
h3cVoDIfR2CfgClearForwardAck=_H3cVoDIfR2CfgClearForwardAck_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,4),_H3cVoDIfR2CfgClearForwardAck_Type())
...
h3cVoDIfR2CfgDlSeizureAck=_H3cVoDIfR2CfgDlSeizureAck_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,5),_H3cVoDIfR2CfgDlSeizureAck_Type())
...
h3cVoDIfR2CfgDTMF=_H3cVoDIfR2CfgDTMF_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,6),_H3cVoDIfR2CfgDTMF_Type())
...
h3cVoDIfR2CfgAnswer=_H3cVoDIfR2CfgAnswer_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,7),_H3cVoDIfR2CfgAnswer_Type())
...
h3cVoDIfR2CfgReanswer=_H3cVoDIfR2CfgReanswer_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,8),_H3cVoDIfR2CfgReanswer_Type())
...
h3cVoDIfR2CfgFinalCallnum=_H3cVoDIfR2CfgFinalCallnum_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,9),_H3cVoDIfR2CfgFinalCallnum_Type())
...
h3cVoDIfR2CfgForceMetering=_H3cVoDIfR2CfgForceMetering_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,10),_H3cVoDIfR2CfgForceMetering_Type())
...
h3cVoDIfR2CfgSendRingBack=_H3cVoDIfR2CfgSendRingBack_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,11),_H3cVoDIfR2CfgSendRingBack_Type())
...
h3cVoDIfR2CfgSendRingBusy=_H3cVoDIfR2CfgSendRingBusy_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,12),_H3cVoDIfR2CfgSendRingBusy_Type())
...
h3cVoDIfR2CapCfgSubLine=_H3cVoDIfR2CapCfgSubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,4,3,5,1,15),_H3cVoDIfR2CapCfgSubLine_Type())
