...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-RIPv2-EXT-MIB
...
_EtsysRip2ExtTriggeredDelayMin_Type.__name__ = "Unsigned32"
...
_EtsysRip2ExtTriggeredDelayMax_Type.__name__ = "Unsigned32"
...
etsysRip2ExtCompliance.setObjects(
    ("ENTERASYS-RIPv2-EXT-MIB", "etsysRip2ExtGlobalGroup")
)
if mibBuilder.loadTexts:
