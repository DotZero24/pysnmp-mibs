...
mibBuilder.exportSymbols("ARICENT-IPV6-MLD-MIB", PYSNMP_MODULE_ID=futuremld, fsmldDebugLevel=fsmldDebugLevel, fsmldTraceDebug=fsmldTraceDebug, fsmldProtocolUpDown=fsmldProtocolUpDown, fsmldScalars=fsmldScalars, fsmldNoOfCacheEntries=fsmldNoOfCacheEntries, futuremld=futuremld, fsmldMode=fsmldMode, fsmldNoOfRoutingProtocols=fsmldNoOfRoutingProtocols)
