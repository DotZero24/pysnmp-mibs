# SNMP MIB module (FASTPATH-SNTP-CLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-SNTP-CLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:08:00 2025
...
if mibBuilder.loadTexts:
    agentSntpClientPollInterval.setStatus("current")
if mibBuilder.loadTexts:
...
agentSntpClientUcastServerEntry.setIndexNames(
    (0, "FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerIndex"),
)
if mibBuilder.loadTexts:
...
agentSntpClientDeviceGroup.setObjects(
      *(("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientVersion"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientSupportedMode"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientMode"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientLastUpdateTime"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientLastAttemptTime"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientLastAttemptStatus"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientServerAddressType"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientServerAddress"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientServerMode"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientServerStratum"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientServerRefClkId"))
)
if mibBuilder.loadTexts:
...
agentSntpClientUnicastGroup.setObjects(
      *(("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUnicastPollInterval"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUnicastPollTimeout"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUnicastPollRetry"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerMaxEntries"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerCurrEntries"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerAddress"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerAddressType"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerPrecedence"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerLastUpdateTime"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerLastAttemptTime"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerLastAttemptStatus"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUcastServerNumRequests"),
...
agentSntpClientBroadcastGroup.setObjects(
      *(("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientBroadcastCount"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientBroadcastInterval"))
)
if mibBuilder.loadTexts:
...
agentSntpClientCompliance.setObjects(
      *(("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientDeviceGroup"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientUnicastGroup"),
        ("FASTPATH-SNTP-CLIENT-MIB", "agentSntpClientBroadcastGroup"))
)
if mibBuilder.loadTexts:
