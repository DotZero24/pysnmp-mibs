...
if mibBuilder.loadTexts:agentSntpClientMIB.setRevisions(('2007-05-23 00:00','2003-12-18 16:29'))
...
class _AgentSntpClientPort_Type(InetPortNumber):defaultValue=123;subtypeSpec=InetPortNumber.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,65535))
...
if mibBuilder.loadTexts:agentSntpClientPollInterval.setStatus(_A)
...
class _AgentSntpClientUcastServerPrecedence_Type(Unsigned32):defaultValue=1;subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,8))
