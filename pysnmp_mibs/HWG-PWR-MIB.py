...
# Notes
# -----
# ASN.1 source file://mibs/hwgroup/HWG-PWR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:21:19 2025
...
mtSecAddrTxt = _MtSecAddrTxt_Object(
    (1, 3, 6, 1, 4, 1, 21796, 4, 6, 1, 2, 1, 6),
    _MtSecAddrTxt_Type()
)
mtSecAddrTxt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mtSecAddrTxt.setStatus("mandatory")
