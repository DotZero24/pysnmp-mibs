...
# Notes
# -----
# ASN.1 source file://mibs/cisco/ALTIGA-ADDRESS-STATS-MIB
...
altigaAddressStatsMibCompliance.setObjects(
    ("ALTIGA-ADDRESS-STATS-MIB", "altigaAddressStatsGroup")
)
if mibBuilder.loadTexts:
...
altigaAddressStatsMibComplianceRev1.setObjects(
      *(("ALTIGA-ADDRESS-STATS-MIB", "altigaAddressStatsGroup"),
        ("ALTIGA-ADDRESS-STATS-MIB", "altigaAddressStatsGroupSup1"))
)
if mibBuilder.loadTexts:
