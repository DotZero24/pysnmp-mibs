...
mibBuilder.exportSymbols("ALTIGA-ADDRESS-STATS-MIB", alAddressStatsGrpHeldAddresses=alAddressStatsGrpHeldAddresses, alAddressStatsPoolGroupTable=alAddressStatsPoolGroupTable, alAddressStatsHeldReason=alAddressStatsHeldReason, alAddressStatsGrpPoolId=alAddressStatsGrpPoolId, altigaAddressStatsMibCompliance=altigaAddressStatsMibCompliance, alAddressStatsGrpMaxAddressesAssigned=alAddressStatsGrpMaxAddressesAssigned, alAddressStatsHeldTimeLeft=alAddressStatsHeldTimeLeft, altigaAddressStatsMibCompliances=altigaAddressStatsMibCompliances, alAddressStatsGrpCurrAvailAddresses=alAddressStatsGrpCurrAvailAddresses, alAddressStatsTotalPoolAddresses=alAddressStatsTotalPoolAddresses, altigaAddressStatsMibComplianceRev1=altigaAddressStatsMibComplianceRev1, alAddressStatsCurrAllocAddresses=alAddressStatsCurrAllocAddresses, alAddressStatsHeldAddrIndex=alAddressStatsHeldAddrIndex, alAddressStatsGrpHeldReason=alAddressStatsGrpHeldReason, alAddressStatsPoolGroupEntry=alAddressStatsPoolGroupEntry, alAddressStatsGrpHeldEntry=alAddressStatsGrpHeldEntry, alAddressStatsGlobal=alAddressStatsGlobal, alAddressStatsHeldAddress=alAddressStatsHeldAddress, alAddressStatsPoolTable=alAddressStatsPoolTable, altigaAddressStatsMibModule=altigaAddressStatsMibModule, alAddressStatsMaxAddressesAssigned=alAddressStatsMaxAddressesAssigned, alAddressStatsHeldTable=alAddressStatsHeldTable, alAddressStatsPoolEntry=alAddressStatsPoolEntry, alAddressStatsHeldEntry=alAddressStatsHeldEntry, alAddressStatsGrpHeldAddress=alAddressStatsGrpHeldAddress, alAddressStatsGrpHeldPoolId=alAddressStatsGrpHeldPoolId, IPAddressHeldReason=IPAddressHeldReason, alAddressStatsGrpId=alAddressStatsGrpId, alAddressStatsPoolId=alAddressStatsPoolId, alAddressStatsCurrAvailAddresses=alAddressStatsCurrAvailAddresses, alAddressStatsHeldAddresses=alAddressStatsHeldAddresses, altigaAddressStatsGroupSup1=altigaAddressStatsGroupSup1, alAddressStatsGrpHeldTable=alAddressStatsGrpHeldTable, alAddressStatsGrpHeldId=alAddressStatsGrpHeldId, alAddressStatsGrpTotalPoolAddresses=alAddressStatsGrpTotalPoolAddresses, alAddressStatsGrpCurrAllocAddresses=alAddressStatsGrpCurrAllocAddresses, alAddressStatsGrpHeldAddrIndex=alAddressStatsGrpHeldAddrIndex, altigaAddressStatsGroup=altigaAddressStatsGroup, PYSNMP_MODULE_ID=altigaAddressStatsMibModule, altigaAddressStatsMibConformance=altigaAddressStatsMibConformance, alAddressStatsHeldPoolId=alAddressStatsHeldPoolId, alAddressStatsGrpHeldTimeLeft=alAddressStatsGrpHeldTimeLeft)
