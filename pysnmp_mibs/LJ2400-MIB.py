...
_A3='eUnknownMediaSize'
_A2='eISOandJISA4R'
_A1='eUSLetterR'
_A0='eJapansePostcardDouble'
_z='eISOandJISA3'
_y='eROC8K'
_x='eLedger'
_w='eInitiateAction'
...
class _Sleep_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_Y,1),(_S,2)))
...
class _Show_address_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_O,1),(_i,3)))
...
class _Mio1_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_j,8),(_k,12)))
...
class _Mio2_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_j,8),(_k,12)))
...
class _Mio3_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_j,8),(_k,12)))
...
class _Job_info_accounting_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_x,11),(_a,17),(_V,18),(_y,19),(_W,25),(_R,26),(_z,27),(_X,45),('eJISB4',46),('eISOB5',65),(_A0,72),(_b,80),(_c,81),(_d,90),(_e,91),(_f,100),(_g,101),(_A1,258),(_A2,282),(_A3,32767)))
...
class _Ram_disk_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_O,1),(_i,3)))
...
class _Firmware_download_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_Y,1),(_S,2)))
...
class _Upgradable_devices_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_Y,1),(_S,2)))
...
class _Default_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,15,17,18,25,26,45,72,80,81,90,91,100,101)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_h,10),(_A8,15),(_a,17),(_V,18),(_W,25),(_R,26),(_X,45),(_A9,72),(_b,80),(_c,81),(_d,90),(_e,91),(_f,100),(_g,101)))
...
class _Reprint_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_O,1),(_P,2),(_i,3)))
...
class _Form_feed_needed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_Y,1),(_S,2)))
...
class _Override_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_x,11),(_a,17),(_V,18),(_y,19),(_W,25),(_R,26),(_z,27),(_X,45),('eJISB4',46),('eISOB5',65),(_A9,72),(_b,80),(_c,81),(_d,90),(_e,91),(_f,100),(_g,101),(_A1,258),(_A2,282),(_A3,32767)))
...
class _Manually_feed_prompt_test_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_Y,1),(_S,2)))
...
class _Tray1_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,15,17,18,25,26,45,72,80,81,90,91,100,101,32764,32765)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_h,10),(_A8,15),(_a,17),(_V,18),(_W,25),(_R,26),(_X,45),(_A0,72),(_b,80),(_c,81),(_d,90),(_e,91),(_f,100),(_g,101),('eAnyCustomSize',32764),(_m,32765)))
...
class _Tray2_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,18,25,26,45,32765)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_h,10),(_V,18),(_W,25),(_R,26),(_X,45),(_m,32765)))
...
class _Tray3_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,18,25,26,45,32765)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_h,10),(_V,18),(_W,25),(_R,26),(_X,45),(_m,32765)))
...
class _Consumable_status_usage_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_n,1),(_o,2),(_p,3),(_q,4),(_r,5),(_s,6),(_t,7),(_u,8)))
...
class _Consumable_status_engine_usage_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_n,1),(_o,2),(_p,3),(_q,4),(_r,5),(_s,6),(_t,7),(_u,8)))
...
class _Consumable_status_drum_life_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_n,1),(_o,2),(_p,3),(_q,4),(_r,5),(_s,6),(_t,7),(_u,8)))
...
channelEntry.setIndexNames((0,_v,'channelindex'))
...
deviceChannelEntry.setIndexNames((0,_v,'channel-index'))
