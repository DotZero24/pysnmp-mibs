# SNMP MIB module (LANCOM-UDLD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-UDLD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:19:52 2025
...
agentUdldMessageInterval = _AgentUdldMessageInterval_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 54, 1, 1, 2),
...
agentUdldTimeoutInterval = _AgentUdldTimeoutInterval_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 54, 1, 1, 3),
...
agentUdldReset = _AgentUdldReset_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 54, 1, 1, 4),
...
agentUdldInterfaceEntry = _AgentUdldInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 54, 1, 2, 1, 1)
)
...
agentUdldInterfaceAdminMode = _AgentUdldInterfaceAdminMode_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 54, 1, 2, 1, 1, 2),
...
agentUdldInterfaceAggresiveMode = _AgentUdldInterfaceAggresiveMode_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 54, 1, 2, 1, 1, 3),
