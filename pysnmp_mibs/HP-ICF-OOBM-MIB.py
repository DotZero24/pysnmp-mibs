...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-OOBM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:40:29 2025
...
_HpicfSnmpTargetAddrIsOobm_Type.__name__ = "TruthValue"
...
hpicfOobmMibCompliance.setObjects(
      *(("HP-ICF-OOBM-MIB", "hpicfOobmScalarsGroup"),
        ("HP-ICF-OOBM-MIB", "hpicfOobmServersGroup"),
        ("HP-ICF-OOBM-MIB", "hpicfSnmpTargetAddrIsOobmGroup"),
        ("HP-ICF-OOBM-MIB", "hpicfOobmDefGatewayGroup"),
        ("HP-ICF-OOBM-MIB", "hpicfOobmMemberGroup"),
        ("HP-ICF-OOBM-MIB", "hpicfOobmGroups"))
)
if mibBuilder.loadTexts:
