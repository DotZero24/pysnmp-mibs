...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-IPv6-DYNAMIC-LOCKDOWN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:43:20 2025
...
_HpicfDIPLDv6SourceBindingOutOfResourcesTrapCtrl_Type.__name__ = "TruthValue"
...
_HpicfDIPLDv6SourceBindingViolationsTrapCtrl_Type.__name__ = "TruthValue"
...
hpicfDIPLDv6Compliance.setObjects(
    ("HP-ICF-IPv6-DYNAMIC-LOCKDOWN-MIB", "hpicfIpv6LockBaseGroup")
)
if mibBuilder.loadTexts:
...
hpicfIpv6SourceBindingTrapCompliance.setObjects(
      *(("HP-ICF-IPv6-DYNAMIC-LOCKDOWN-MIB", "hpicfSourceBindingTrapObjectsGroup"),
        ("HP-ICF-IPv6-DYNAMIC-LOCKDOWN-MIB", "hpicfSourceBindingTrapsGroup"))
)
if mibBuilder.loadTexts:
