...
SubscriberCircuitId, SubscriberDnis, SubscriberVRF, SubscriberDhcpClass, SubscriberMediaType, SubSessionIdentity, SubSessionIdentities, SubscriberRemoteId, SubscriberNasPort, SubscriberLabel, SubscriberPbhk, SubscriberAcctSessionId, SubscriberDomain, SubscriberProtocolType, SubscriberTunnelName, SubscriberServiceName, SubscriberLocationName, SubscriberUsername = mibBuilder.importSymbols("CISCO-SUBSCRIBER-IDENTITY-TC-MIB", "SubscriberCircuitId", "SubscriberDnis", "SubscriberVRF", "SubscriberDhcpClass", "SubscriberMediaType", "SubSessionIdentity", "SubSessionIdentities", "SubscriberRemoteId", "SubscriberNasPort", "SubscriberLabel", "SubscriberPbhk", "SubscriberAcctSessionId", "SubscriberDomain", "SubscriberProtocolType", "SubscriberTunnelName", "SubscriberServiceName", "SubscriberLocationName", "SubscriberUsername")
...
mibBuilder.exportSymbols("CISCO-SUBSCRIBER-SESSION-MIB", csubSessionNativeIpMask2=csubSessionNativeIpMask2, csubJobQuerySortKey2=csubJobQuerySortKey2, csubSessionDhcpClass=csubSessionDhcpClass, csubAggStatsDayFailedSessions=csubAggStatsDayFailedSessions, csubAggStatsIntGroup=csubAggStatsIntGroup, csubAggStatsPointType=csubAggStatsPointType, csubSessionFallingNotif=csubSessionFallingNotif, csubAggStatsThreshGroup=csubAggStatsThreshGroup, csubJobMatchDnis=csubJobMatchDnis, csubJobMatchMlpNegotiated=csubJobMatchMlpNegotiated, csubJobQuerySortKey3=csubJobQuerySortKey3, csubSessionRisingNotif=csubSessionRisingNotif, csubJobMatchRemoteId=csubJobMatchRemoteId, csubAggStatsAvgSessionRPM=csubAggStatsAvgSessionRPM, ciscoSubscriberSessionMIBNotifs=ciscoSubscriberSessionMIBNotifs, csubSessionAvailableIdentities=csubSessionAvailableIdentities, ciscoSubscriberSessionMIBCompliances=ciscoSubscriberSessionMIBCompliances, csubSessionDeltaPercentFallingThreshNotif=csubSessionDeltaPercentFallingThreshNotif, csubJobMatchNativeVrf=csubJobMatchNativeVrf, csubSessionRemoteId=csubSessionRemoteId, csubJobState=csubJobState, csubAggStatsIntUpSessions=csubAggStatsIntUpSessions, ciscoSubscriberSessionMIBConform=ciscoSubscriberSessionMIBConform, csubJobMatchServiceName=csubJobMatchServiceName, csubAggStatsRedSessions=csubAggStatsRedSessions, csubJobStatus=csubJobStatus, PYSNMP_MODULE_ID=ciscoSubscriberSessionMIB, csubSessionGroup=csubSessionGroup, csubJobQueueJobId=csubJobQueueJobId, csubJobQueryParamsGroup=csubJobQueryParamsGroup, csubSessionUsername=csubSessionUsername, csubSessionCreationTime=csubSessionCreationTime, csubJobQueryParamsEntry=csubJobQueryParamsEntry, csubSessionDomainVrf=csubSessionDomainVrf, csubAggStatsPoint=csubAggStatsPoint, csubJobMatchCircuitId=csubJobMatchCircuitId, csubJobMatchParamsEntry=csubJobMatchParamsEntry, csubJobMatchDomainIpAddr=csubJobMatchDomainIpAddr, csubJobMatchOtherParams=csubJobMatchOtherParams, csubSessionNativeIpAddrType2=csubSessionNativeIpAddrType2, csubJobCount=csubJobCount, csubSessionSubscriberLabel=csubSessionSubscriberLabel, csubSessionType=csubSessionType, csubJobNotifGroup=csubJobNotifGroup, csubSessionRedundancyMode=csubSessionRedundancyMode, csubSessionDnis=csubSessionDnis, csubSessionState=csubSessionState, csubSessionLastChanged=csubSessionLastChanged, csubAggStatsSessionType=csubAggStatsSessionType, csubAggStatsIntCreatedSessions=csubAggStatsIntCreatedSessions, csubAggStatsIntDiscSessions=csubAggStatsIntDiscSessions, csubAggStatsCurrCreatedSessions=csubAggStatsCurrCreatedSessions, csubAggStatsIntValid=csubAggStatsIntValid, csubAggStatsCurrUpSessions=csubAggStatsCurrUpSessions, csubJobReportSession=csubJobReportSession, csubSessionIpAddrAssignment=csubSessionIpAddrAssignment, csubAggStatsAvgSessionUptime=csubAggStatsAvgSessionUptime, csubAggStatsDayUpSessions=csubAggStatsDayUpSessions, csubSessionMacAddress=csubSessionMacAddress, csubJobMatchDomainVrf=csubJobMatchDomainVrf, csubAggStatsCurrGroup=csubAggStatsCurrGroup, csubSessionProtocol=csubSessionProtocol, csubAggStatsDayDiscSessions=csubAggStatsDayDiscSessions, csubJobGroup=csubJobGroup, csubSessionTunnelName=csubSessionTunnelName, csubJobFinishedTime=csubJobFinishedTime, csubJobMatchUsername=csubJobMatchUsername, csubJobFinishedNotify=csubJobFinishedNotify, csubSessionFallingThresh=csubSessionFallingThresh, csubJobId=csubJobId, csubAggStatsThreshNotifEnable=csubAggStatsThreshNotifEnable, csubAggStats=csubAggStats, csubSessionDerivedCfg=csubSessionDerivedCfg, csubSessionByTypeEntry=csubSessionByTypeEntry, csubJobControl=csubJobControl, csubJobStorage=csubJobStorage, csubJobMatchNativeIpAddr=csubJobMatchNativeIpAddr, csubJobQueueTable=csubJobQueueTable, csubAggStatsHighUpSessions=csubAggStatsHighUpSessions, csubJobMatchNativeIpMask=csubJobMatchNativeIpMask, ciscoSubscriberSessionR2Compliance=ciscoSubscriberSessionR2Compliance, csubJobMatchNativeIpAddrType=csubJobMatchNativeIpAddrType, csubJobMatchRedundancyMode=csubJobMatchRedundancyMode, csubJobFinishedReason=csubJobFinishedReason, csubSessionMedia=csubSessionMedia, csubJobMatchNasPort=csubJobMatchNasPort, csubSessionRisingThresh=csubSessionRisingThresh, csubAggStatsIntAuthSessions=csubAggStatsIntAuthSessions, csubSessionAuthenticated=csubSessionAuthenticated, csubJobMatchTunnelName=csubJobMatchTunnelName, ciscoSubscriberSessionMIBObjects=ciscoSubscriberSessionMIBObjects, csubAggStatsUnAuthSessions=csubAggStatsUnAuthSessions, csubAggStatsCurrValidIntervals=csubAggStatsCurrValidIntervals, csubAggStatsCurrFailedSessions=csubAggStatsCurrFailedSessions, csubAggStatsTable=csubAggStatsTable, csubAggStatsDayAuthSessions=csubAggStatsDayAuthSessions, ciscoSubscriberSessionMIBGroups=ciscoSubscriberSessionMIBGroups, csubJobReportEntry=csubJobReportEntry, csubAggStatsDayGroup=csubAggStatsDayGroup, csubSessionEntry=csubSessionEntry, csubJobEntry=csubJobEntry, csubAggStatsDiscontinuityTime=csubAggStatsDiscontinuityTime, csubSessionAcctSessionId=csubSessionAcctSessionId, csubSessionServiceIdentifier=csubSessionServiceIdentifier, csubJobMatchParamsTable=csubJobMatchParamsTable, csubSessionNativeIpMask=csubSessionNativeIpMask, csubJob=csubJob, csubJobMatchPbhk=csubJobMatchPbhk, csubJobQueueNumber=csubJobQueueNumber, csubJobMatchProtocol=csubJobMatchProtocol, csubAggStatsLightWeightSessions=csubAggStatsLightWeightSessions, csubJobMatchAuthenticated=csubJobMatchAuthenticated, csubSessionNativeIpAddrType=csubSessionNativeIpAddrType, csubSessionDomainIpMask=csubSessionDomainIpMask, csubJobStartedTime=csubJobStartedTime, csubJobMaxNumber=csubJobMaxNumber, csubJobMatchParamsGroup=csubJobMatchParamsGroup, csubSessionCircuitId=csubSessionCircuitId, SubscriberJobIdentifier=SubscriberJobIdentifier, csubSessionThreshEvalInterval=csubSessionThreshEvalInterval, csubSession=csubSession, csubAggStatsCurrDiscSessions=csubAggStatsCurrDiscSessions, csubJobMatchAcctSessionId=csubJobMatchAcctSessionId, csubSessionByType=csubSessionByType, csubJobIndexedAttributes=csubJobIndexedAttributes, csubSessionNativeIpAddr=csubSessionNativeIpAddr, csubJobReportId=csubJobReportId, csubAggStatsGroup=csubAggStatsGroup, csubSessionMlpNegotiated=csubSessionMlpNegotiated, csubAggStatsAvgSessionRPH=csubAggStatsAvgSessionRPH, csubJobMatchDanglingDuration=csubJobMatchDanglingDuration, csubAggStatsUpSessions=csubAggStatsUpSessions, csubSessionLocationIdentifier=csubSessionLocationIdentifier, csubSessionPbhk=csubSessionPbhk, csubAggStatsIntNumber=csubAggStatsIntNumber, csubJobReportTable=csubJobReportTable, csubJobMaxLife=csubJobMaxLife, csubSessionNativeIpAddr2=csubSessionNativeIpAddr2, csubAggStatsNotifGroup=csubAggStatsNotifGroup, csubJobQueueEntry=csubJobQueueEntry, csubSessionTable=csubSessionTable, csubJobMatchDomainIpAddrType=csubJobMatchDomainIpAddrType, csubJobMatchMacAddress=csubJobMatchMacAddress, csubAggStatsEntry=csubAggStatsEntry, csubAggStatsTotalUpSessions=csubAggStatsTotalUpSessions, csubAggStatsDayCreatedSessions=csubAggStatsDayCreatedSessions, csubAggStatsTotalFlowsUp=csubAggStatsTotalFlowsUp, csubJobMatchDomain=csubJobMatchDomain, csubJobType=csubJobType, csubJobMatchIdentities=csubJobMatchIdentities, csubAggStatsThreshEntry=csubAggStatsThreshEntry, ciscoSubscriberSessionR1Compliance=ciscoSubscriberSessionR1Compliance, csubAggStatsTotalFailedSessions=csubAggStatsTotalFailedSessions, csubJobTable=csubJobTable, csubAggStatsIntFailedSessions=csubAggStatsIntFailedSessions, csubAggStatsTotalLightWeightSessions=csubAggStatsTotalLightWeightSessions, csubJobMatchMedia=csubJobMatchMedia, csubJobQueryResultingReportSize=csubJobQueryResultingReportSize, csubAggStatsIntEntry=csubAggStatsIntEntry, csubAggStatsTotalCreatedSessions=csubAggStatsTotalCreatedSessions, csubJobIdNext=csubJobIdNext, csubAggStatsThrottleEngagements=csubAggStatsThrottleEngagements, csubAggStatsAuthSessions=csubAggStatsAuthSessions, csubAggStatsIntTable=csubAggStatsIntTable, csubSessionDeltaPercentFallingThresh=csubSessionDeltaPercentFallingThresh, csubJobQuerySortKey1=csubJobQuerySortKey1, csubAggStatsCurrAuthSessions=csubAggStatsCurrAuthSessions, csubSessionIfIndex=csubSessionIfIndex, csubAggStatsTotalAuthSessions=csubAggStatsTotalAuthSessions, csubAggThresh=csubAggThresh, csubJobMatchSubscriberLabel=csubJobMatchSubscriberLabel, csubSessionDomainIpAddr=csubSessionDomainIpAddr, csubJobFinishedNotifyEnable=csubJobFinishedNotifyEnable, csubSessionDomain=csubSessionDomain, csubAggStatsCurrInvalidIntervals=csubAggStatsCurrInvalidIntervals, csubSessionNasPort=csubSessionNasPort, csubAggStatsCurrFlowsUp=csubAggStatsCurrFlowsUp, csubAggStatsThreshTable=csubAggStatsThreshTable, csubAggStatsPendingSessions=csubAggStatsPendingSessions, csubJobQueueGroup=csubJobQueueGroup, csubAggStatsTotalDiscSessions=csubAggStatsTotalDiscSessions, csubJobMatchDhcpClass=csubJobMatchDhcpClass, csubJobMatchDomainIpMask=csubJobMatchDomainIpMask, SubscriberJobIdentifierOrZero=SubscriberJobIdentifierOrZero, csubAggStatsCurrTimeElapsed=csubAggStatsCurrTimeElapsed, csubJobQueryParamsTable=csubJobQueryParamsTable, csubJobMatchState=csubJobMatchState, csubSessionNativeVrf=csubSessionNativeVrf, csubSessionByTypeTable=csubSessionByTypeTable, ciscoSubscriberSessionMIB=ciscoSubscriberSessionMIB, csubSessionDomainIpAddrType=csubSessionDomainIpAddrType)
