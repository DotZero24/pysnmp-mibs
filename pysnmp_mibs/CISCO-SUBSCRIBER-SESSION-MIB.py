...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SUBSCRIBER-SESSION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:33:41 2025
...
_CsubJobFinishedNotifyEnable_Type.__name__ = "TruthValue"
...
_CsubJobStorage_Type.__name__ = "StorageType"
...
_CsubJobMatchIdentities_Type.__name__ = "SubSessionIdentities"
...
_CsubJobMatchSubscriberLabel_Type.__name__ = "SubscriberLabel"
...
_CsubJobMatchMacAddress_Type.__name__ = "MacAddress"
...
class _CsubJobMatchNativeVrf_Type(SubscriberVRF):
    """Custom type csubJobMatchNativeVrf based on SubscriberVRF"""
    defaultValue = OctetString("")


_CsubJobMatchNativeVrf_Type.__name__ = "SubscriberVRF"
...
_CsubJobMatchNativeIpAddrType_Type.__name__ = "InetAddressType"
...
_CsubJobMatchNativeIpAddr_Type.__name__ = "InetAddress"
...
_CsubJobMatchNativeIpMask_Type.__name__ = "InetAddress"
...
class _CsubJobMatchDomainVrf_Type(SubscriberVRF):
    """Custom type csubJobMatchDomainVrf based on SubscriberVRF"""
    defaultValue = OctetString("")


_CsubJobMatchDomainVrf_Type.__name__ = "SubscriberVRF"
...
_CsubJobMatchDomainIpAddrType_Type.__name__ = "InetAddressType"
...
_CsubJobMatchDomainIpAddr_Type.__name__ = "InetAddress"
...
_CsubJobMatchDomainIpMask_Type.__name__ = "InetAddress"
...
_CsubJobMatchPbhk_Type.__name__ = "SubscriberPbhk"
...
class _CsubJobMatchRemoteId_Type(SubscriberRemoteId):
    """Custom type csubJobMatchRemoteId based on SubscriberRemoteId"""
    defaultValue = OctetString("")


_CsubJobMatchRemoteId_Type.__name__ = "SubscriberRemoteId"
...
class _CsubJobMatchCircuitId_Type(SubscriberCircuitId):
    """Custom type csubJobMatchCircuitId based on SubscriberCircuitId"""
    defaultValue = OctetString("")


_CsubJobMatchCircuitId_Type.__name__ = "SubscriberCircuitId"
...
_CsubJobMatchNasPort_Type.__name__ = "SubscriberNasPort"
...
class _CsubJobMatchDomain_Type(SubscriberDomain):
    """Custom type csubJobMatchDomain based on SubscriberDomain"""
    defaultValue = OctetString("")


_CsubJobMatchDomain_Type.__name__ = "SubscriberDomain"
...
class _CsubJobMatchUsername_Type(SubscriberUsername):
    """Custom type csubJobMatchUsername based on SubscriberUsername"""
    defaultValue = OctetString("")


_CsubJobMatchUsername_Type.__name__ = "SubscriberUsername"
...
_CsubJobMatchAcctSessionId_Type.__name__ = "SubscriberAcctSessionId"
...
class _CsubJobMatchDnis_Type(SubscriberDnis):
    """Custom type csubJobMatchDnis based on SubscriberDnis"""
    defaultValue = OctetString("")


_CsubJobMatchDnis_Type.__name__ = "SubscriberDnis"
...
_CsubJobMatchMedia_Type.__name__ = "SubscriberMediaType"
...
_CsubJobMatchMlpNegotiated_Type.__name__ = "TruthValue"
...
_CsubJobMatchProtocol_Type.__name__ = "SubscriberProtocolType"
...
class _CsubJobMatchServiceName_Type(CbpElementName):
    """Custom type csubJobMatchServiceName based on CbpElementName"""
    defaultValue = OctetString("")


_CsubJobMatchServiceName_Type.__name__ = "CbpElementName"
...
class _CsubJobMatchDhcpClass_Type(SubscriberDhcpClass):
    """Custom type csubJobMatchDhcpClass based on SubscriberDhcpClass"""
    defaultValue = OctetString("")


_CsubJobMatchDhcpClass_Type.__name__ = "SubscriberDhcpClass"
...
class _CsubJobMatchTunnelName_Type(SubscriberTunnelName):
    """Custom type csubJobMatchTunnelName based on SubscriberTunnelName"""
    defaultValue = OctetString("")


_CsubJobMatchTunnelName_Type.__name__ = "SubscriberTunnelName"
...
_CsubJobMatchState_Type.__name__ = "SubSessionState"
...
_CsubJobMatchAuthenticated_Type.__name__ = "TruthValue"
...
_CsubJobMatchRedundancyMode_Type.__name__ = "SubSessionRedundancyMode"
...
_CsubJobQuerySortKey1_Type.__name__ = "SubSessionIdentity"
...
_CsubJobQuerySortKey2_Type.__name__ = "SubSessionIdentity"
...
_CsubJobQuerySortKey3_Type.__name__ = "SubSessionIdentity"
...
ciscoSubscriberSessionR1Compliance.setObjects(
      *(("CISCO-SUBSCRIBER-SESSION-MIB", "csubSessionGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubAggStatsGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubJobGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubJobMatchParamsGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubJobQueryParamsGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubJobNotifGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubAggStatsCurrGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubAggStatsIntGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubAggStatsDayGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubJobQueueGroup"))
)
if mibBuilder.loadTexts:
...
ciscoSubscriberSessionR2Compliance.setObjects(
      *(("CISCO-SUBSCRIBER-SESSION-MIB", "csubAggStatsThreshGroup"),
        ("CISCO-SUBSCRIBER-SESSION-MIB", "csubAggStatsNotifGroup"))
)
if mibBuilder.loadTexts:
