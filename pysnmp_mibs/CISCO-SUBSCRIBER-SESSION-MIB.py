...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-SUBSCRIBER-SESSION-MIB
...
SubSessionIdentities, SubscriberDnis, SubscriberLabel, SubscriberTunnelName, SubscriberRemoteId, SubscriberPbhk, SubscriberDomain, SubscriberProtocolType, SubscriberCircuitId, SubscriberVRF, SubscriberDhcpClass, SubscriberLocationName, SubscriberMediaType, SubscriberServiceName, SubscriberNasPort, SubscriberAcctSessionId, SubSessionIdentity, SubscriberUsername = mibBuilder.importSymbols("CISCO-SUBSCRIBER-IDENTITY-TC-MIB", "SubSessionIdentities", "SubscriberDnis", "SubscriberLabel", "SubscriberTunnelName", "SubscriberRemoteId", "SubscriberPbhk", "SubscriberDomain", "SubscriberProtocolType", "SubscriberCircuitId", "SubscriberVRF", "SubscriberDhcpClass", "SubscriberLocationName", "SubscriberMediaType", "SubscriberServiceName", "SubscriberNasPort", "SubscriberAcctSessionId", "SubSessionIdentity", "SubscriberUsername")
SubSessionRedundancyMode, SubSessionType, SubSessionState = mibBuilder.importSymbols("CISCO-SUBSCRIBER-SESSION-TC-MIB", "SubSessionRedundancyMode", "SubSessionType", "SubSessionState")
...
mibBuilder.exportSymbols("CISCO-SUBSCRIBER-SESSION-MIB", csubSessionDomainIpAddrType=csubSessionDomainIpAddrType, ciscoSubscriberSessionMIBGroups=ciscoSubscriberSessionMIBGroups, csubAggStatsCurrAuthSessions=csubAggStatsCurrAuthSessions, csubJobMatchDomainIpMask=csubJobMatchDomainIpMask, csubJobMatchProtocol=csubJobMatchProtocol, csubSessionNativeIpAddrType2=csubSessionNativeIpAddrType2, csubSessionPbhk=csubSessionPbhk, csubJobType=csubJobType, csubSession=csubSession, ciscoSubscriberSessionR1Compliance=ciscoSubscriberSessionR1Compliance, csubJobFinishedNotify=csubJobFinishedNotify, csubAggStatsAuthSessions=csubAggStatsAuthSessions, csubJobMatchParamsEntry=csubJobMatchParamsEntry, csubAggStatsTotalFlowsUp=csubAggStatsTotalFlowsUp, csubJobMatchServiceName=csubJobMatchServiceName, csubJobReportTable=csubJobReportTable, csubSessionProtocol=csubSessionProtocol, csubJobMatchMacAddress=csubJobMatchMacAddress, csubJobQuerySortKey3=csubJobQuerySortKey3, csubSessionMlpNegotiated=csubSessionMlpNegotiated, csubAggStats=csubAggStats, csubAggStatsCurrFlowsUp=csubAggStatsCurrFlowsUp, ciscoSubscriberSessionR2Compliance=ciscoSubscriberSessionR2Compliance, csubJobQueueEntry=csubJobQueueEntry, csubJobMatchNativeIpAddr=csubJobMatchNativeIpAddr, csubAggStatsNotifGroup=csubAggStatsNotifGroup, csubAggStatsUpSessions=csubAggStatsUpSessions, csubAggStatsTotalCreatedSessions=csubAggStatsTotalCreatedSessions, csubAggStatsDayUpSessions=csubAggStatsDayUpSessions, csubSessionMacAddress=csubSessionMacAddress, csubAggStatsIntCreatedSessions=csubAggStatsIntCreatedSessions, csubJobMatchNativeIpAddrType=csubJobMatchNativeIpAddrType, csubSessionRemoteId=csubSessionRemoteId, csubAggStatsCurrCreatedSessions=csubAggStatsCurrCreatedSessions, csubSessionDomainVrf=csubSessionDomainVrf, csubJob=csubJob, csubSessionDeltaPercentFallingThreshNotif=csubSessionDeltaPercentFallingThreshNotif, csubAggStatsDayGroup=csubAggStatsDayGroup, csubJobReportSession=csubJobReportSession, csubAggStatsPendingSessions=csubAggStatsPendingSessions, csubJobMatchParamsGroup=csubJobMatchParamsGroup, csubSessionAcctSessionId=csubSessionAcctSessionId, csubSessionByTypeTable=csubSessionByTypeTable, csubJobQueueGroup=csubJobQueueGroup, csubJobTable=csubJobTable, ciscoSubscriberSessionMIBObjects=ciscoSubscriberSessionMIBObjects, csubAggStatsThreshTable=csubAggStatsThreshTable, csubJobMaxNumber=csubJobMaxNumber, csubSessionIpAddrAssignment=csubSessionIpAddrAssignment, SubscriberJobIdentifier=SubscriberJobIdentifier, csubAggStatsEntry=csubAggStatsEntry, csubSessionByTypeEntry=csubSessionByTypeEntry, csubJobState=csubJobState, csubJobMatchAcctSessionId=csubJobMatchAcctSessionId, csubJobMatchCircuitId=csubJobMatchCircuitId, csubAggStatsCurrInvalidIntervals=csubAggStatsCurrInvalidIntervals, csubJobQueryParamsTable=csubJobQueryParamsTable, csubJobMatchDomainIpAddrType=csubJobMatchDomainIpAddrType, csubAggStatsUnAuthSessions=csubAggStatsUnAuthSessions, csubAggThresh=csubAggThresh, csubSessionDnis=csubSessionDnis, csubJobMatchRedundancyMode=csubJobMatchRedundancyMode, csubAggStatsIntAuthSessions=csubAggStatsIntAuthSessions, csubAggStatsIntValid=csubAggStatsIntValid, csubJobId=csubJobId, csubJobFinishedReason=csubJobFinishedReason, csubAggStatsCurrTimeElapsed=csubAggStatsCurrTimeElapsed, ciscoSubscriberSessionMIB=ciscoSubscriberSessionMIB, csubJobMatchMlpNegotiated=csubJobMatchMlpNegotiated, csubAggStatsCurrDiscSessions=csubAggStatsCurrDiscSessions, csubJobQuerySortKey1=csubJobQuerySortKey1, csubSessionNativeIpMask2=csubSessionNativeIpMask2, csubSessionNativeIpAddr2=csubSessionNativeIpAddr2, csubAggStatsDayAuthSessions=csubAggStatsDayAuthSessions, csubAggStatsCurrFailedSessions=csubAggStatsCurrFailedSessions, csubSessionType=csubSessionType, csubSessionNativeIpMask=csubSessionNativeIpMask, csubJobCount=csubJobCount, csubJobMatchDomainVrf=csubJobMatchDomainVrf, SubscriberJobIdentifierOrZero=SubscriberJobIdentifierOrZero, csubJobMatchSubscriberLabel=csubJobMatchSubscriberLabel, csubJobEntry=csubJobEntry, csubAggStatsDiscontinuityTime=csubAggStatsDiscontinuityTime, csubSessionAvailableIdentities=csubSessionAvailableIdentities, csubSessionMedia=csubSessionMedia, csubAggStatsIntEntry=csubAggStatsIntEntry, csubSessionRedundancyMode=csubSessionRedundancyMode, csubJobMatchOtherParams=csubJobMatchOtherParams, csubSessionDhcpClass=csubSessionDhcpClass, csubAggStatsAvgSessionUptime=csubAggStatsAvgSessionUptime, csubAggStatsThreshEntry=csubAggStatsThreshEntry, ciscoSubscriberSessionMIBConform=ciscoSubscriberSessionMIBConform, ciscoSubscriberSessionMIBNotifs=ciscoSubscriberSessionMIBNotifs, csubJobFinishedNotifyEnable=csubJobFinishedNotifyEnable, csubJobStartedTime=csubJobStartedTime, csubSessionEntry=csubSessionEntry, csubSessionRisingNotif=csubSessionRisingNotif, csubSessionRisingThresh=csubSessionRisingThresh, csubAggStatsCurrValidIntervals=csubAggStatsCurrValidIntervals, csubSessionNativeIpAddr=csubSessionNativeIpAddr, csubJobNotifGroup=csubJobNotifGroup, csubJobMatchDnis=csubJobMatchDnis, csubSessionCreationTime=csubSessionCreationTime, csubJobQueueTable=csubJobQueueTable, csubJobMatchNativeIpMask=csubJobMatchNativeIpMask, csubAggStatsPointType=csubAggStatsPointType, csubSessionState=csubSessionState, csubAggStatsThreshNotifEnable=csubAggStatsThreshNotifEnable, csubSessionTable=csubSessionTable, csubJobMatchTunnelName=csubJobMatchTunnelName, csubJobMatchNasPort=csubJobMatchNasPort, csubJobIdNext=csubJobIdNext, csubSessionServiceIdentifier=csubSessionServiceIdentifier, csubSessionLastChanged=csubSessionLastChanged, csubAggStatsLightWeightSessions=csubAggStatsLightWeightSessions, csubAggStatsIntDiscSessions=csubAggStatsIntDiscSessions, csubAggStatsRedSessions=csubAggStatsRedSessions, csubAggStatsDayCreatedSessions=csubAggStatsDayCreatedSessions, csubSessionDerivedCfg=csubSessionDerivedCfg, PYSNMP_MODULE_ID=ciscoSubscriberSessionMIB, csubJobMatchMedia=csubJobMatchMedia, csubJobMatchUsername=csubJobMatchUsername, csubJobReportId=csubJobReportId, csubJobControl=csubJobControl, csubSessionDomainIpMask=csubSessionDomainIpMask, csubSessionDomainIpAddr=csubSessionDomainIpAddr, csubJobMatchDanglingDuration=csubJobMatchDanglingDuration, csubJobQueryParamsGroup=csubJobQueryParamsGroup, csubJobMatchParamsTable=csubJobMatchParamsTable, csubAggStatsIntTable=csubAggStatsIntTable, csubSessionIfIndex=csubSessionIfIndex, csubAggStatsIntUpSessions=csubAggStatsIntUpSessions, csubJobQueueNumber=csubJobQueueNumber, csubAggStatsAvgSessionRPM=csubAggStatsAvgSessionRPM, csubSessionTunnelName=csubSessionTunnelName, csubAggStatsPoint=csubAggStatsPoint, csubSessionFallingThresh=csubSessionFallingThresh, csubJobIndexedAttributes=csubJobIndexedAttributes, csubSessionCircuitId=csubSessionCircuitId, csubSessionUsername=csubSessionUsername, csubAggStatsThreshGroup=csubAggStatsThreshGroup, csubSessionGroup=csubSessionGroup, csubSessionByType=csubSessionByType, csubSessionNasPort=csubSessionNasPort, csubJobMatchDhcpClass=csubJobMatchDhcpClass, csubJobMatchRemoteId=csubJobMatchRemoteId, csubJobReportEntry=csubJobReportEntry, csubAggStatsHighUpSessions=csubAggStatsHighUpSessions, ciscoSubscriberSessionMIBCompliances=ciscoSubscriberSessionMIBCompliances, csubJobMatchDomain=csubJobMatchDomain, csubSessionFallingNotif=csubSessionFallingNotif, csubJobQueryParamsEntry=csubJobQueryParamsEntry, csubSessionNativeVrf=csubSessionNativeVrf, csubJobQueueJobId=csubJobQueueJobId, csubAggStatsIntFailedSessions=csubAggStatsIntFailedSessions, csubSessionDomain=csubSessionDomain, csubJobMatchState=csubJobMatchState, csubAggStatsGroup=csubAggStatsGroup, csubJobStatus=csubJobStatus, csubAggStatsThrottleEngagements=csubAggStatsThrottleEngagements, csubAggStatsTotalLightWeightSessions=csubAggStatsTotalLightWeightSessions, csubAggStatsDayFailedSessions=csubAggStatsDayFailedSessions, csubAggStatsCurrUpSessions=csubAggStatsCurrUpSessions, csubJobMatchPbhk=csubJobMatchPbhk, csubAggStatsIntGroup=csubAggStatsIntGroup, csubAggStatsTable=csubAggStatsTable, csubAggStatsIntNumber=csubAggStatsIntNumber, csubAggStatsAvgSessionRPH=csubAggStatsAvgSessionRPH, csubJobMatchNativeVrf=csubJobMatchNativeVrf, csubAggStatsCurrGroup=csubAggStatsCurrGroup, csubSessionNativeIpAddrType=csubSessionNativeIpAddrType, csubJobMatchDomainIpAddr=csubJobMatchDomainIpAddr, csubSessionDeltaPercentFallingThresh=csubSessionDeltaPercentFallingThresh, csubAggStatsSessionType=csubAggStatsSessionType, csubJobGroup=csubJobGroup, csubSessionThreshEvalInterval=csubSessionThreshEvalInterval, csubJobStorage=csubJobStorage, csubJobMatchIdentities=csubJobMatchIdentities, csubAggStatsTotalDiscSessions=csubAggStatsTotalDiscSessions, csubJobQuerySortKey2=csubJobQuerySortKey2, csubAggStatsTotalAuthSessions=csubAggStatsTotalAuthSessions, csubJobQueryResultingReportSize=csubJobQueryResultingReportSize, csubAggStatsTotalFailedSessions=csubAggStatsTotalFailedSessions, csubJobFinishedTime=csubJobFinishedTime, csubSessionSubscriberLabel=csubSessionSubscriberLabel, csubJobMatchAuthenticated=csubJobMatchAuthenticated, csubAggStatsTotalUpSessions=csubAggStatsTotalUpSessions, csubJobMaxLife=csubJobMaxLife, csubSessionAuthenticated=csubSessionAuthenticated, csubAggStatsDayDiscSessions=csubAggStatsDayDiscSessions, csubSessionLocationIdentifier=csubSessionLocationIdentifier)
