...
mibBuilder.exportSymbols("ADTRAN-AOS-MUX-MIB", adGenAOSXConnectTable=adGenAOSXConnectTable, adGenAOSXConnectSecondIfSlot=adGenAOSXConnectSecondIfSlot, adGenAOSTdmGroupIfPort=adGenAOSTdmGroupIfPort, adGenAOSXConnectSecondIfPort=adGenAOSXConnectSecondIfPort, adGenAOSTdmGroup=adGenAOSTdmGroup, adGenAOSMux=adGenAOSMux, adGenAOSTdmGroupTable=adGenAOSTdmGroupTable, adGenAOSXConnectSecondSubIfNumber=adGenAOSXConnectSecondSubIfNumber, adGenAOSXConnectFirstIfType=adGenAOSXConnectFirstIfType, adGenAOSXConnectFirstTdmGroupDS0=adGenAOSXConnectFirstTdmGroupDS0, adGenAOSXConnectFirstIfPort=adGenAOSXConnectFirstIfPort, adGenAOSMuxConformancemModule=adGenAOSMuxConformancemModule, adGenAOSMuxID=adGenAOSMuxID, adGenAOSTdmGroupUsage=adGenAOSTdmGroupUsage, adGenAOSXConnectGrp=adGenAOSXConnectGrp, adGenAOSTdmGroupIfSlot=adGenAOSTdmGroupIfSlot, adGenAOSXConnectSecondTdmGroupDS0=adGenAOSXConnectSecondTdmGroupDS0, PYSNMP_MODULE_ID=adGenAOSMuxID, adGenAOSXConnectIndex=adGenAOSXConnectIndex, adGenAOSXConnectSecondIfNumber=adGenAOSXConnectSecondIfNumber, adGenAOSXConnectPreserveRbs=adGenAOSXConnectPreserveRbs, adGenAOSMuxConformance=adGenAOSMuxConformance, adGenAOSMuxCompliance=adGenAOSMuxCompliance, adGenAOSXConnectRowStatus=adGenAOSXConnectRowStatus, adGenAOSTdmGroupGrp=adGenAOSTdmGroupGrp, adGenAOSXConnectFirstSubIfNumber=adGenAOSXConnectFirstSubIfNumber, adGenAOSTdmGroupMask=adGenAOSTdmGroupMask, adGenAOSXConnectFirstIfNumber=adGenAOSXConnectFirstIfNumber, adGenAOSXConnectSecondIfType=adGenAOSXConnectSecondIfType, adGenAOSXConnectSecondTdmGroup=adGenAOSXConnectSecondTdmGroup, adGenAOSTdmGroupID=adGenAOSTdmGroupID, adGenAOSXConnectFirstTdmGroup=adGenAOSXConnectFirstTdmGroup, adGenAOSXConnectEntry=adGenAOSXConnectEntry, adGenAOSMuxMibGroups=adGenAOSMuxMibGroups, adGenAOSTdmGroupEntry=adGenAOSTdmGroupEntry, adGenAOSXConnectFirstIfSlot=adGenAOSXConnectFirstIfSlot, adGenAOSXConnect=adGenAOSXConnect)
