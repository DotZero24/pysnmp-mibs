...
_AlvarionQOSMIBObjects_ObjectIdentity=ObjectIdentity
alvarionQOSMIBObjects=_AlvarionQOSMIBObjects_ObjectIdentity((1,3,6,1,4,1,12394,1,10,5,13,1))
_CoQOSStatistics_ObjectIdentity=ObjectIdentity
coQOSStatistics=_CoQOSStatistics_ObjectIdentity((1,3,6,1,4,1,12394,1,10,5,13,1,1))
_CoQOSCountersTable_Object=MibTable
coQOSCountersTable=_CoQOSCountersTable_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1))
if mibBuilder.loadTexts:coQOSCountersTable.setStatus(_A)
_CoQOSCountersEntry_Object=MibTableRow
coQOSCountersEntry=_CoQOSCountersEntry_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1))
coQOSCountersEntry.setIndexNames((0,_D,_E),(0,_B,_F))
if mibBuilder.loadTexts:coQOSCountersEntry.setStatus(_A)
_CoQOSQueueId_Type=AlvarionPriorityQueue
_CoQOSQueueId_Object=MibTableColumn
coQOSQueueId=_CoQOSQueueId_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1,1),_CoQOSQueueId_Type())
...
coQOSTransmittedFrameCount=_CoQOSTransmittedFrameCount_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1,2),_CoQOSTransmittedFrameCount_Type())
...
coQOSMulticastTransmittedFrameCount=_CoQOSMulticastTransmittedFrameCount_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1,3),_CoQOSMulticastTransmittedFrameCount_Type())
...
coQOSFailedCount=_CoQOSFailedCount_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1,4),_CoQOSFailedCount_Type())
...
coQOSRetryCount=_CoQOSRetryCount_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1,5),_CoQOSRetryCount_Type())
...
coQOSMultipleRetryCount=_CoQOSMultipleRetryCount_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1,6),_CoQOSMultipleRetryCount_Type())
...
coQOSFrameDuplicateCount=_CoQOSFrameDuplicateCount_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1,7),_CoQOSFrameDuplicateCount_Type())
...
coQOSReceivedFrameCount=_CoQOSReceivedFrameCount_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1,8),_CoQOSReceivedFrameCount_Type())
...
coQOSMulticastReceivedFrameCount=_CoQOSMulticastReceivedFrameCount_Object((1,3,6,1,4,1,12394,1,10,5,13,1,1,1,1,9),_CoQOSMulticastReceivedFrameCount_Type())
...
coQOSConformance=_CoQOSConformance_ObjectIdentity((1,3,6,1,4,1,12394,1,10,5,13,1,2))
_CoQOSGroups_ObjectIdentity=ObjectIdentity
coQOSGroups=_CoQOSGroups_ObjectIdentity((1,3,6,1,4,1,12394,1,10,5,13,1,2,1))
_CoQOSCompliances_ObjectIdentity=ObjectIdentity
coQOSCompliances=_CoQOSCompliances_ObjectIdentity((1,3,6,1,4,1,12394,1,10,5,13,1,2,2))
coQOSCountersGroup=ObjectGroup((1,3,6,1,4,1,12394,1,10,5,13,1,2,1,1))
