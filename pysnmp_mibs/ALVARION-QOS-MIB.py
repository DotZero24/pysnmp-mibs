# SNMP MIB module (ALVARION-QOS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-QOS-MIB
...
alvarionQOS = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13)
)
...
coQOSCountersEntry = _CoQOSCountersEntry_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 1, 1, 1)
)
coQOSCountersEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "ALVARION-QOS-MIB", "coQOSQueueId"),
)
if mibBuilder.loadTexts:
...
coQOSQueueId = _CoQOSQueueId_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 1, 1, 1, 1),
    _CoQOSQueueId_Type()
)
...
coQOSTransmittedFrameCount = _CoQOSTransmittedFrameCount_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 1, 1, 1, 2),
...
coQOSMulticastTransmittedFrameCount = _CoQOSMulticastTransmittedFrameCount_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 1, 1, 1, 3),
...
coQOSRetryCount = _CoQOSRetryCount_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 1, 1, 1, 5),
...
coQOSMultipleRetryCount = _CoQOSMultipleRetryCount_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 1, 1, 1, 6),
...
coQOSFrameDuplicateCount = _CoQOSFrameDuplicateCount_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 1, 1, 1, 7),
...
coQOSReceivedFrameCount = _CoQOSReceivedFrameCount_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 1, 1, 1, 8),
...
coQOSMulticastReceivedFrameCount = _CoQOSMulticastReceivedFrameCount_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 1, 1, 1, 9),
...
coQOSConformance = _CoQOSConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 2)
)
_CoQOSGroups_ObjectIdentity = ObjectIdentity
coQOSGroups = _CoQOSGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 2, 1)
)
_CoQOSCompliances_ObjectIdentity = ObjectIdentity
coQOSCompliances = _CoQOSCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 2, 2)
)

# Managed Objects groups

coQOSCountersGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 2, 1, 1)
)
coQOSCountersGroup.setObjects(
      *(("ALVARION-QOS-MIB", "coQOSTransmittedFrameCount"),
        ("ALVARION-QOS-MIB", "coQOSMulticastTransmittedFrameCount"),
        ("ALVARION-QOS-MIB", "coQOSFailedCount"),
        ("ALVARION-QOS-MIB", "coQOSRetryCount"),
        ("ALVARION-QOS-MIB", "coQOSMultipleRetryCount"),
        ("ALVARION-QOS-MIB", "coQOSFrameDuplicateCount"),
        ("ALVARION-QOS-MIB", "coQOSReceivedFrameCount"),
        ("ALVARION-QOS-MIB", "coQOSMulticastReceivedFrameCount"))
)
if mibBuilder.loadTexts:
...
coQOSCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 13, 1, 2, 2, 1)
)
coQOSCompliance.setObjects(
    ("ALVARION-QOS-MIB", "coQOSCountersGroup")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "ALVARION-QOS-MIB",
    **{"alvarionQOS": alvarionQOS,
       "alvarionQOSMIBObjects": alvarionQOSMIBObjects,
