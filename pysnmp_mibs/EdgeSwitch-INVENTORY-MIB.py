...
if mibBuilder.loadTexts:fastPathInventory.setRevisions(('2013-10-15 00:00','2011-01-26 00:00','2007-05-23 00:00','2004-10-28 20:37','2003-05-26 19:30'))
...
agentInventoryStackTemplateId=_AgentInventoryStackTemplateId_Object((1,3,6,1,4,1,4413,1,1,13,1,8),_AgentInventoryStackTemplateId_Type())
...
agentInventoryUnitSFSTransferStatus=_AgentInventoryUnitSFSTransferStatus_Object((1,3,6,1,4,1,4413,1,1,13,2,2,1,27),_AgentInventoryUnitSFSTransferStatus_Type())
...
agentInventoryUnitSFSLastAttemptStatus=_AgentInventoryUnitSFSLastAttemptStatus_Object((1,3,6,1,4,1,4413,1,1,13,2,2,1,28),_AgentInventoryUnitSFSLastAttemptStatus_Type())
...
agentInventorySFSGroup=_AgentInventorySFSGroup_ObjectIdentity((1,3,6,1,4,1,4413,1,1,13,8))
_AgentInventoryStackUnitNumber_Type=Unsigned32
_AgentInventoryStackUnitNumber_Object=MibScalar
agentInventoryStackUnitNumber=_AgentInventoryStackUnitNumber_Object((1,3,6,1,4,1,4413,1,1,13,8,1),_AgentInventoryStackUnitNumber_Type())
...
agentInventorySFS=_AgentInventorySFS_Object((1,3,6,1,4,1,4413,1,1,13,8,2),_AgentInventorySFS_Type())
...
agentInventorySFSAllowDowngrade=_AgentInventorySFSAllowDowngrade_Object((1,3,6,1,4,1,4413,1,1,13,8,3),_AgentInventorySFSAllowDowngrade_Type())
...
agentInventorySFSTrap=_AgentInventorySFSTrap_Object((1,3,6,1,4,1,4413,1,1,13,8,4),_AgentInventorySFSTrap_Type())
...
fastPathInventorySlotGroup.setObjects(*((_B,_M),(_B,_A1),(_B,_A2),(_B,_A3),(_B,_P),(_B,_V)))
...
fastPathInventoryCardGroup.setObjects(*((_B,_T),(_B,_A4),(_B,_A5),(_B,_A6)))
...
agentInventorySFSStart=NotificationType((1,3,6,1,4,1,4413,1,1,13,0,5))
agentInventorySFSStart.setObjects((_B,_Q))
if mibBuilder.loadTexts:agentInventorySFSStart.setStatus(_A)
agentInventorySFSComplete=NotificationType((1,3,6,1,4,1,4413,1,1,13,0,6))
agentInventorySFSComplete.setObjects((_B,_Q))
if mibBuilder.loadTexts:agentInventorySFSComplete.setStatus(_A)
agentInventorySFSFail=NotificationType((1,3,6,1,4,1,4413,1,1,13,0,7))
...
fastPathInventoryNotificationsGroup.setObjects(*((_B,_A7),(_B,_A8)))
