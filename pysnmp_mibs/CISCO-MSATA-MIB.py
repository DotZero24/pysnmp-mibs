...
mibBuilder.exportSymbols("CISCO-MSATA-MIB", ciscoMsataMIBObjects=ciscoMsataMIBObjects, ciscoMsataMIB=ciscoMsataMIB, ciscoMsata=ciscoMsata, PYSNMP_MODULE_ID=ciscoMsataMIB)
