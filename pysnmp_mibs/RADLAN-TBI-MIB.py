# SNMP MIB module (RADLAN-TBI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-TBI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:11:24 2025
...
rlTBITimeRangeEntry = _RlTBITimeRangeEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 145, 1, 1)
)
rlTBITimeRangeEntry.setIndexNames(
    (1, "RADLAN-TBI-MIB", "rlTBITimeRangeName"),
)
if mibBuilder.loadTexts:
...
rlTBIPeriodicTable = _RlTBIPeriodicTable_Object(
    (1, 3, 6, 1, 4, 1, 89, 145, 2)
)
if mibBuilder.loadTexts:
    rlTBIPeriodicTable.setStatus("current")
_RlTBIPeriodicEntry_Object = MibTableRow
rlTBIPeriodicEntry = _RlTBIPeriodicEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 145, 2, 1)
)
rlTBIPeriodicEntry.setIndexNames(
    (0, "RADLAN-TBI-MIB", "rlTBIPeriodicTimeRangeName"),
    (0, "RADLAN-TBI-MIB", "rlTBIPeriodicWeekDayList"),
    (0, "RADLAN-TBI-MIB", "rlTBIPeriodicStart"),
    (0, "RADLAN-TBI-MIB", "rlTBIPeriodicEnd"),
)
if mibBuilder.loadTexts:
