# SNMP MIB module (EdgeSwitch-KEYING-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ubiquiti/EdgeSwitch-KEYING-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:59:25 2025
...
agentFeatureKeyingEntry = _AgentFeatureKeyingEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 24, 1, 3, 1)
)
agentFeatureKeyingEntry.setIndexNames(
    (0, "EdgeSwitch-KEYING-PRIVATE-MIB", "agentFeatureKeyingIndex"),
)
if mibBuilder.loadTexts:
...
agentFeatureKeyingIndex = _AgentFeatureKeyingIndex_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 24, 1, 3, 1, 1),
...
agentFeatureKeyingName = _AgentFeatureKeyingName_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 24, 1, 3, 1, 2),
...
agentFeatureKeyingStatus = _AgentFeatureKeyingStatus_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 24, 1, 3, 1, 3),
