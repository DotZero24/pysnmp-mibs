# SNMP MIB module (FASTPATH-MULTICAST-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-MULTICAST-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:07:40 2025
...
agentMulticastIGMPInterfaceEntry.setIndexNames(
    (0, "FASTPATH-MULTICAST-MIB", "agentMulticastIGMPInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
agentMulticastPIMSMStaticRPEntry.setIndexNames(
    (0, "FASTPATH-MULTICAST-MIB", "agentMulticastPIMSMStaticRPIpAddr"),
    (0, "FASTPATH-MULTICAST-MIB", "agentMulticastPIMSMStaticRPGroupIpAddr"),
    (0, "FASTPATH-MULTICAST-MIB", "agentMulticastPIMSMStaticRPGroupIpMask"),
)
if mibBuilder.loadTexts:
...
agentMulticastPIMSMStaticRPGroupIpAddr = _AgentMulticastPIMSMStaticRPGroupIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 4, 3, 4, 1, 2),
...
agentMulticastPIMSMStaticRPGroupIpMask = _AgentMulticastPIMSMStaticRPGroupIpMask_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 4, 3, 4, 1, 3),
...
agentMulticastPIMSMStaticRPStatus = _AgentMulticastPIMSMStaticRPStatus_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 4, 3, 4, 1, 4),
...
agentMulticastPIMSMInterfaceEntry = _AgentMulticastPIMSMInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 4, 3, 5, 1)
)
agentMulticastPIMSMInterfaceEntry.setIndexNames(
    (0, "FASTPATH-MULTICAST-MIB", "agentMulticastPIMSMInterfaceIndex"),
)
if mibBuilder.loadTexts:
...
agentMulticastPIMSMInterfaceIndex = _AgentMulticastPIMSMInterfaceIndex_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 4, 3, 5, 1, 1),
...
agentMulticastPIMSMInterfaceCBSRHashMaskLength = _AgentMulticastPIMSMInterfaceCBSRHashMaskLength_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 4, 3, 5, 1, 2),
...
agentMulticastPIMSMInterfaceCRPPreference = _AgentMulticastPIMSMInterfaceCRPPreference_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 4, 3, 5, 1, 3),
...
agentIpStaticMRouteEntry.setIndexNames(
    (0, "FASTPATH-MULTICAST-MIB", "agentIpStaticMRouteSrcAddressType"),
    (0, "FASTPATH-MULTICAST-MIB", "agentIpStaticMRouteSrcIpAddr"),
    (0, "FASTPATH-MULTICAST-MIB", "agentIpStaticMRouteSrcNetMask"),
)
if mibBuilder.loadTexts:
