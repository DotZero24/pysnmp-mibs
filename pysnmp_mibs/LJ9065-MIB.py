# SNMP MIB module (LJ9065-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hp/LJ9065-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:38:17 2025
...
page_frame_memory_available = _Page_frame_memory_available_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 2, 72),
    _Page_frame_memory_available_Type()
)
page_frame_memory_available.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    page_frame_memory_available.setStatus("optional")


class _Copy_controller_memory_installed_Type(Integer32):
    """Custom type copy_controller_memory_installed based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Copy_controller_memory_installed_Type.__name__ = "Integer32"
_Copy_controller_memory_installed_Object = MibScalar
copy_controller_memory_installed = _Copy_controller_memory_installed_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 2, 74),
    _Copy_controller_memory_installed_Type()
)
copy_controller_memory_installed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    copy_controller_memory_installed.setStatus("optional")


class _Copy_controller_disk_storage_Type(Integer32):
    """Custom type copy_controller_disk_storage based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-1, 3600),
    )
...
_Copy_controller_disk_storage_Type.__name__ = "Integer32"
_Copy_controller_disk_storage_Object = MibScalar
copy_controller_disk_storage = _Copy_controller_disk_storage_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 2, 75),
    _Copy_controller_disk_storage_Type()
)
copy_controller_disk_storage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    copy_controller_disk_storage.setStatus("optional")


class _Time_regionalization_Type(DisplayString):
    """Custom type time_regionalization based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Time_regionalization_Type.__name__ = "DisplayString"
_Time_regionalization_Object = MibScalar
time_regionalization = _Time_regionalization_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 2, 76),
    _Time_regionalization_Type()
)
time_regionalization.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    time_regionalization.setStatus("optional")
...
class _Model_number_Type(DisplayString):
    """Custom type model_number based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Model_number_Type.__name__ = "DisplayString"
...
class _Phd2_model_Type(DisplayString):
    """Custom type phd2_model based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Phd2_model_Type.__name__ = "DisplayString"
...
class _Phd2_manufacturing_info_Type(DisplayString):
    """Custom type phd2_manufacturing_info based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_Phd2_manufacturing_info_Type.__name__ = "DisplayString"
...
phd2_number_of_options = _Phd2_number_of_options_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 5, 2, 5),
    _Phd2_number_of_options_Type()
)
phd2_number_of_options.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    phd2_number_of_options.setStatus("optional")


class _Phd2_options_model_Type(DisplayString):
    """Custom type phd2_options_model based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_Phd2_options_model_Type.__name__ = "DisplayString"
_Phd2_options_model_Object = MibScalar
phd2_options_model = _Phd2_options_model_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 5, 2, 6),
    _Phd2_options_model_Type()
)
phd2_options_model.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    phd2_options_model.setStatus("optional")


class _Phd2_options_description_Type(DisplayString):
    """Custom type phd2_options_description based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 64),
    )
...
_Phd2_options_description_Type.__name__ = "DisplayString"
_Phd2_options_description_Object = MibScalar
phd2_options_description = _Phd2_options_description_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 5, 2, 7),
    _Phd2_options_description_Type()
)
phd2_options_description.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    phd2_options_description.setStatus("optional")


class _Phd2_options_firmware_version_Type(DisplayString):
    """Custom type phd2_options_firmware_version based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_Phd2_options_firmware_version_Type.__name__ = "DisplayString"
_Phd2_options_firmware_version_Object = MibScalar
phd2_options_firmware_version = _Phd2_options_firmware_version_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 5, 2, 8),
    _Phd2_options_firmware_version_Type()
)
phd2_options_firmware_version.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    phd2_options_firmware_version.setStatus("optional")
...
class _Phd3_model_Type(DisplayString):
    """Custom type phd3_model based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 64),
    )
...
_Phd3_model_Type.__name__ = "DisplayString"
...
class _Phd3_manufacturing_info_Type(DisplayString):
    """Custom type phd3_manufacturing_info based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_Phd3_manufacturing_info_Type.__name__ = "DisplayString"
...
phd3_number_of_options = _Phd3_number_of_options_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 5, 3, 5),
    _Phd3_number_of_options_Type()
)
phd3_number_of_options.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    phd3_number_of_options.setStatus("optional")
...
class _Printed_media_count_Type(Integer32):
    """Custom type printed_media_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Printed_media_count_Type.__name__ = "Integer32"
_Printed_media_count_Object = MibScalar
printed_media_count = _Printed_media_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 16, 1, 1, 8),
    _Printed_media_count_Type()
)
printed_media_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    printed_media_count.setStatus("optional")
_Printed_media_charge_Type = OctetString
_Printed_media_charge_Object = MibScalar
printed_media_charge = _Printed_media_charge_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 16, 1, 1, 9),
    _Printed_media_charge_Type()
)
printed_media_charge.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    printed_media_charge.setStatus("optional")
...
copier_accounting = _Copier_accounting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 16, 7)
)
_Copied_media_usage_ObjectIdentity = ObjectIdentity
copied_media_usage = _Copied_media_usage_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 16, 7, 1)
)
_Copied_media_count_Type = Integer32
_Copied_media_count_Object = MibScalar
copied_media_count = _Copied_media_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 16, 7, 1, 8),
    _Copied_media_count_Type()
)
copied_media_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    copied_media_count.setStatus("optional")
...
class _Default_media_name_Type(DisplayString):
    """Custom type default_media_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_Default_media_name_Type.__name__ = "DisplayString"
...
simplex_one_to_one_mono_page_count = _Simplex_one_to_one_mono_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 2, 42),
    _Simplex_one_to_one_mono_page_count_Type()
)
simplex_one_to_one_mono_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    simplex_one_to_one_mono_page_count.setStatus("optional")
_Simplex_two_to_one_mono_page_count_Type = Integer32
_Simplex_two_to_one_mono_page_count_Object = MibScalar
simplex_two_to_one_mono_page_count = _Simplex_two_to_one_mono_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 2, 43),
    _Simplex_two_to_one_mono_page_count_Type()
)
simplex_two_to_one_mono_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    simplex_two_to_one_mono_page_count.setStatus("optional")
_Duplex_one_to_two_mono_page_count_Type = Integer32
_Duplex_one_to_two_mono_page_count_Object = MibScalar
duplex_one_to_two_mono_page_count = _Duplex_one_to_two_mono_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 2, 44),
    _Duplex_one_to_two_mono_page_count_Type()
)
duplex_one_to_two_mono_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    duplex_one_to_two_mono_page_count.setStatus("optional")
_Duplex_two_to_two_mono_page_count_Type = Integer32
_Duplex_two_to_two_mono_page_count_Object = MibScalar
duplex_two_to_two_mono_page_count = _Duplex_two_to_two_mono_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 2, 45),
    _Duplex_two_to_two_mono_page_count_Type()
)
duplex_two_to_two_mono_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    duplex_two_to_two_mono_page_count.setStatus("optional")
...
tray1_media_size_loaded.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
low_marking_agent_processing.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
out_marking_agent_processing.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media1_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media2_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media3_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media4_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media5_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media6_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media7_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media8_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media10_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media11_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media12_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media13_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media14_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media15_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
media16_engine_media_mode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
class _Consumable_string_information_Type(DisplayString):
    """Custom type consumable_string_information based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Consumable_string_information_Type.__name__ = "DisplayString"
...
status_copier = _Status_copier_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2)
)
_Device_detail_ObjectIdentity = ObjectIdentity
device_detail = _Device_detail_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4)
)
_Imaging_mode_ObjectIdentity = ObjectIdentity
imaging_mode = _Imaging_mode_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 1)
)


class _Imaging_mode_page_count_Type(Integer32):
    """Custom type imaging_mode_page_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Imaging_mode_page_count_Type.__name__ = "Integer32"
_Imaging_mode_page_count_Object = MibScalar
imaging_mode_page_count = _Imaging_mode_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 1, 1),
    _Imaging_mode_page_count_Type()
)
imaging_mode_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    imaging_mode_page_count.setStatus("optional")


class _Imaging_mode_page_count_description_Type(DisplayString):
    """Custom type imaging_mode_page_count_description based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 40),
    )
...
_Imaging_mode_page_count_description_Type.__name__ = "DisplayString"
_Imaging_mode_page_count_description_Object = MibScalar
imaging_mode_page_count_description = _Imaging_mode_page_count_description_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 1, 2),
    _Imaging_mode_page_count_description_Type()
)
imaging_mode_page_count_description.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    imaging_mode_page_count_description.setStatus("optional")
_Jam_count_by_location_ObjectIdentity = ObjectIdentity
jam_count_by_location = _Jam_count_by_location_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 2)
)


class _Jam_count_by_location_count_Type(Integer32):
    """Custom type jam_count_by_location_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Jam_count_by_location_count_Type.__name__ = "Integer32"
_Jam_count_by_location_count_Object = MibScalar
jam_count_by_location_count = _Jam_count_by_location_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 2, 1),
    _Jam_count_by_location_count_Type()
)
jam_count_by_location_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jam_count_by_location_count.setStatus("optional")


class _Jam_count_by_location_description_Type(DisplayString):
    """Custom type jam_count_by_location_description based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Jam_count_by_location_description_Type.__name__ = "DisplayString"
_Jam_count_by_location_description_Object = MibScalar
jam_count_by_location_description = _Jam_count_by_location_description_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 2, 2),
    _Jam_count_by_location_description_Type()
)
jam_count_by_location_description.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jam_count_by_location_description.setStatus("optional")
_Jam_history_ObjectIdentity = ObjectIdentity
jam_history = _Jam_history_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 3)
)


class _Jam_history_jam_code_Type(DisplayString):
    """Custom type jam_history_jam_code based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 5),
    )
...
_Jam_history_jam_code_Type.__name__ = "DisplayString"
_Jam_history_jam_code_Object = MibScalar
jam_history_jam_code = _Jam_history_jam_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 3, 1),
    _Jam_history_jam_code_Type()
)
jam_history_jam_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jam_history_jam_code.setStatus("optional")


class _Jam_history_jam_count_Type(Integer32):
    """Custom type jam_history_jam_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Jam_history_jam_count_Type.__name__ = "Integer32"
_Jam_history_jam_count_Object = MibScalar
jam_history_jam_count = _Jam_history_jam_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 3, 2),
    _Jam_history_jam_count_Type()
)
jam_history_jam_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jam_history_jam_count.setStatus("optional")


class _Jam_history_time_stamp_Type(DisplayString):
    """Custom type jam_history_time_stamp based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Jam_history_time_stamp_Type.__name__ = "DisplayString"
_Jam_history_time_stamp_Object = MibScalar
jam_history_time_stamp = _Jam_history_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 3, 3),
    _Jam_history_time_stamp_Type()
)
jam_history_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jam_history_time_stamp.setStatus("optional")


class _Jam_history_source_tray_Type(Integer32):
    """Custom type jam_history_source_tray based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 5),
    )
...
_Jam_history_source_tray_Type.__name__ = "Integer32"
_Jam_history_source_tray_Object = MibScalar
jam_history_source_tray = _Jam_history_source_tray_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 3, 4),
    _Jam_history_source_tray_Type()
)
jam_history_source_tray.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jam_history_source_tray.setStatus("optional")


class _Jam_history_media_size_Type(Integer32):
    """Custom type jam_history_media_size based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Jam_history_media_size_Type.__name__ = "Integer32"
_Jam_history_media_size_Object = MibScalar
jam_history_media_size = _Jam_history_media_size_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 3, 5),
    _Jam_history_media_size_Type()
)
jam_history_media_size.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jam_history_media_size.setStatus("optional")
_Jam_history_magnification_Type = OctetString
_Jam_history_magnification_Object = MibScalar
jam_history_magnification = _Jam_history_magnification_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 3, 6),
    _Jam_history_magnification_Type()
)
jam_history_magnification.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    jam_history_magnification.setStatus("optional")
_Replaceable_part_custom_life_information_ObjectIdentity = ObjectIdentity
replaceable_part_custom_life_information = _Replaceable_part_custom_life_information_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 4)
)


class _Replaceable_part_custom_information_count_Type(Integer32):
    """Custom type replaceable_part_custom_information_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 99999999),
    )
...
_Replaceable_part_custom_information_count_Type.__name__ = "Integer32"
_Replaceable_part_custom_information_count_Object = MibScalar
replaceable_part_custom_information_count = _Replaceable_part_custom_information_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 4, 1),
    _Replaceable_part_custom_information_count_Type()
)
replaceable_part_custom_information_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    replaceable_part_custom_information_count.setStatus("optional")


class _Replaceable_part_custom_information_limit_Type(Integer32):
    """Custom type replaceable_part_custom_information_limit based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 99999999),
    )
...
_Replaceable_part_custom_information_limit_Type.__name__ = "Integer32"
_Replaceable_part_custom_information_limit_Object = MibScalar
replaceable_part_custom_information_limit = _Replaceable_part_custom_information_limit_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 4, 2),
    _Replaceable_part_custom_information_limit_Type()
)
replaceable_part_custom_information_limit.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    replaceable_part_custom_information_limit.setStatus("optional")


class _Replaceable_part_custom_information_part_number_Type(DisplayString):
    """Custom type replaceable_part_custom_information_part_number based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Replaceable_part_custom_information_part_number_Type.__name__ = "DisplayString"
_Replaceable_part_custom_information_part_number_Object = MibScalar
replaceable_part_custom_information_part_number = _Replaceable_part_custom_information_part_number_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 4, 3),
    _Replaceable_part_custom_information_part_number_Type()
)
replaceable_part_custom_information_part_number.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    replaceable_part_custom_information_part_number.setStatus("optional")


class _Replaceable_part_custom_information_part_name_Type(DisplayString):
    """Custom type replaceable_part_custom_information_part_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 9),
    )
...
_Replaceable_part_custom_information_part_name_Type.__name__ = "DisplayString"
_Replaceable_part_custom_information_part_name_Object = MibScalar
replaceable_part_custom_information_part_name = _Replaceable_part_custom_information_part_name_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 4, 4),
    _Replaceable_part_custom_information_part_name_Type()
)
replaceable_part_custom_information_part_name.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    replaceable_part_custom_information_part_name.setStatus("optional")
_Replaceable_part_life_information_ObjectIdentity = ObjectIdentity
replaceable_part_life_information = _Replaceable_part_life_information_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 5)
)


class _Replaceable_part_life_information_count_Type(Integer32):
    """Custom type replaceable_part_life_information_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 99999999),
    )
...
_Replaceable_part_life_information_count_Type.__name__ = "Integer32"
_Replaceable_part_life_information_count_Object = MibScalar
replaceable_part_life_information_count = _Replaceable_part_life_information_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 5, 1),
    _Replaceable_part_life_information_count_Type()
)
replaceable_part_life_information_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    replaceable_part_life_information_count.setStatus("optional")


class _Replaceable_part_life_information_part_number_Type(DisplayString):
    """Custom type replaceable_part_life_information_part_number based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Replaceable_part_life_information_part_number_Type.__name__ = "DisplayString"
_Replaceable_part_life_information_part_number_Object = MibScalar
replaceable_part_life_information_part_number = _Replaceable_part_life_information_part_number_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 5, 2),
    _Replaceable_part_life_information_part_number_Type()
)
replaceable_part_life_information_part_number.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    replaceable_part_life_information_part_number.setStatus("optional")


class _Replaceable_part_life_information_part_name_Type(DisplayString):
    """Custom type replaceable_part_life_information_part_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Replaceable_part_life_information_part_name_Type.__name__ = "DisplayString"
_Replaceable_part_life_information_part_name_Object = MibScalar
replaceable_part_life_information_part_name = _Replaceable_part_life_information_part_name_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 5, 3),
    _Replaceable_part_life_information_part_name_Type()
)
replaceable_part_life_information_part_name.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    replaceable_part_life_information_part_name.setStatus("optional")
_Service_call_information_ObjectIdentity = ObjectIdentity
service_call_information = _Service_call_information_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 6)
)


class _Service_call_information_count_Type(Integer32):
    """Custom type service_call_information_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 9999),
    )
...
_Service_call_information_count_Type.__name__ = "Integer32"
_Service_call_information_count_Object = MibScalar
service_call_information_count = _Service_call_information_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 6, 1),
    _Service_call_information_count_Type()
)
service_call_information_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    service_call_information_count.setStatus("optional")


class _Service_call_information_description_Type(DisplayString):
    """Custom type service_call_information_description based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 5),
    )
...
_Service_call_information_description_Type.__name__ = "DisplayString"
_Service_call_information_description_Object = MibScalar
service_call_information_description = _Service_call_information_description_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 6, 2),
    _Service_call_information_description_Type()
)
service_call_information_description.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    service_call_information_description.setStatus("optional")
_Configuration_dip_switches_ObjectIdentity = ObjectIdentity
configuration_dip_switches = _Configuration_dip_switches_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 7)
)


class _Configuration_dip_switches_switch_Type(Integer32):
    """Custom type configuration_dip_switches_switch based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_Configuration_dip_switches_switch_Type.__name__ = "Integer32"
_Configuration_dip_switches_switch_Object = MibScalar
configuration_dip_switches_switch = _Configuration_dip_switches_switch_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 7, 1),
    _Configuration_dip_switches_switch_Type()
)
configuration_dip_switches_switch.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    configuration_dip_switches_switch.setStatus("optional")
_Engine_data_access_ObjectIdentity = ObjectIdentity
engine_data_access = _Engine_data_access_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 9)
)


class _Engine_data_access_location_Type(Integer32):
    """Custom type engine_data_access_location based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_Engine_data_access_location_Type.__name__ = "Integer32"
_Engine_data_access_location_Object = MibScalar
engine_data_access_location = _Engine_data_access_location_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 2, 4, 9, 1),
    _Engine_data_access_location_Type()
)
engine_data_access_location.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    engine_data_access_location.setStatus("optional")
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "page-frame-memory-available": page_frame_memory_available,
       "copy-controller-memory-installed": copy_controller_memory_installed,
       "copy-controller-disk-storage": copy_controller_disk_storage,
       "time-regionalization": time_regionalization,
       "id": id,
       ...
       "phd2-number-of-options": phd2_number_of_options,
       "phd2-options-model": phd2_options_model,
       "phd2-options-description": phd2_options_description,
       "phd2-options-firmware-version": phd2_options_firmware_version,
       "phd3": phd3,
       "phd3-model": phd3_model,
       "phd3-manufacturing-info": phd3_manufacturing_info,
       "phd3-type": phd3_type,
       "phd3-capacity": phd3_capacity,
       "phd3-number-of-options": phd3_number_of_options,
       ...
       "printed-media-count": printed_media_count,
       "printed-media-charge": printed_media_charge,
       ...
       "copier-accounting": copier_accounting,
       "copied-media-usage": copied_media_usage,
       "copied-media-count": copied_media_count,
       ...
       "simplex-two-to-one-mono-page-count": simplex_two_to_one_mono_page_count,
       "duplex-one-to-two-mono-page-count": duplex_one_to_two_mono_page_count,
       "duplex-two-to-two-mono-page-count": duplex_two_to_two_mono_page_count,
       "intray": intray,
       ...
       "copier": copier,
       "status-copier": status_copier,
       "device-detail": device_detail,
       "imaging-mode": imaging_mode,
       "imaging-mode-page-count": imaging_mode_page_count,
       "imaging-mode-page-count-description": imaging_mode_page_count_description,
       "jam-count-by-location": jam_count_by_location,
       "jam-count-by-location-count": jam_count_by_location_count,
       "jam-count-by-location-description": jam_count_by_location_description,
       "jam-history": jam_history,
       "jam-history-jam-code": jam_history_jam_code,
       "jam-history-jam-count": jam_history_jam_count,
       "jam-history-time-stamp": jam_history_time_stamp,
       "jam-history-source-tray": jam_history_source_tray,
       "jam-history-media-size": jam_history_media_size,
       "jam-history-magnification": jam_history_magnification,
       "replaceable-part-custom-life-information": replaceable_part_custom_life_information,
       "replaceable-part-custom-information-count": replaceable_part_custom_information_count,
       "replaceable-part-custom-information-limit": replaceable_part_custom_information_limit,
       "replaceable-part-custom-information-part-number": replaceable_part_custom_information_part_number,
       "replaceable-part-custom-information-part-name": replaceable_part_custom_information_part_name,
       "replaceable-part-life-information": replaceable_part_life_information,
       "replaceable-part-life-information-count": replaceable_part_life_information_count,
       "replaceable-part-life-information-part-number": replaceable_part_life_information_part_number,
       "replaceable-part-life-information-part-name": replaceable_part_life_information_part_name,
       "service-call-information": service_call_information,
       "service-call-information-count": service_call_information_count,
       "service-call-information-description": service_call_information_description,
       "configuration-dip-switches": configuration_dip_switches,
       "configuration-dip-switches-switch": configuration_dip_switches_switch,
       "engine-data-access": engine_data_access,
       "engine-data-access-location": engine_data_access_location,
       "channel": channel,
