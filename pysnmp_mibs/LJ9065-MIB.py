#
# PySNMP MIB module LJ9065-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/LJ9065-MIB
...
channelEntry = MibTableRow((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 6, 3, 1), ).setIndexNames((0, "LJ9065-MIB", "channelindex"))
...
deviceChannelEntry = MibTableRow((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 7, 2, 1), ).setIndexNames((0, "LJ9065-MIB", "channel-index"))
...
mibBuilder.exportSymbols("LJ9065-MIB", mio1_type=mio1_type, DisplayString=DisplayString, media4_page_count=media4_page_count, copied_media_count=copied_media_count, error38_time_stamp=error38_time_stamp, simm3_bank1_type=simm3_bank1_type, phd2_model=phd2_model, media10_short_name=media10_short_name, error31_code=error31_code, error22=error22, postscript_total_page_count=postscript_total_page_count, media1=media1, simm4_bank=simm4_bank, jam_history_source_tray=jam_history_source_tray, tray5_phd=tray5_phd, media1_page_count=media1_page_count, error35_time_stamp=error35_time_stamp, media6_short_name=media6_short_name, media9=media9, error25_code=error25_code, error2_code=error2_code, destination_subsystem=destination_subsystem, tray6_media_size_loaded=tray6_media_size_loaded, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, error23_code=error23_code, clearable_warning=clearable_warning, job_info_attr_12=job_info_attr_12, firmware_download_write_status_supported=firmware_download_write_status_supported, service_id=service_id, channelprinteralert=channelprinteralert, error11=error11, interface=interface, phd2_capacity=phd2_capacity, error44_time_stamp=error44_time_stamp, held_job_security=held_job_security, error47_time_stamp=error47_time_stamp, error33_code=error33_code, error43=error43, simm4_bank1_type=simm4_bank1_type, tray3_media_size_loaded=tray3_media_size_loaded, media16_short_name=media16_short_name, print_meter=print_meter, firmware_download_name=firmware_download_name, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, media8=media8, held_job_delete=held_job_delete, job_info_pages_printed=job_info_pages_printed, error5_time_stamp=error5_time_stamp, tray2_phd=tray2_phd, media16_engine_media_mode=media16_engine_media_mode, job_info_physical_outbins_used=job_info_physical_outbins_used, on_off_line=on_off_line, error40_code=error40_code, media2_engine_media_mode=media2_engine_media_mode, error14_time_stamp=error14_time_stamp, media6_name=media6_name, simm2_bank1_capacity=simm2_bank1_capacity, pdl_pcl=pdl_pcl, print_internal_page=print_internal_page, job_info_accounting_black_dots=job_info_accounting_black_dots, spooler=spooler, intray=intray, rpc_bound_protocol_address=rpc_bound_protocol_address, simm3_bank1=simm3_bank1, default_vmi=default_vmi, consumable_string_information_reset=consumable_string_information_reset, simm3_capacity=simm3_capacity, device_name=device_name, replaceable_part_custom_information_limit=replaceable_part_custom_information_limit, error35=error35, mopy_mode=mopy_mode, channel_io_errors=channel_io_errors, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, error37_time_stamp=error37_time_stamp, error48=error48, simm1_bank1=simm1_bank1, settings_print_media=settings_print_media, mio1_manufacturing_info=mio1_manufacturing_info, media_info=media_info, media_names_available=media_names_available, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, simplex_two_to_one_mono_page_count=simplex_two_to_one_mono_page_count, channel_bytes_sent=channel_bytes_sent, settings_system=settings_system, error50=error50, replaceable_part_custom_information_part_name=replaceable_part_custom_information_part_name, simplex_one_to_one_mono_page_count=simplex_one_to_one_mono_page_count, channelEntry=channelEntry, copied_media_usage=copied_media_usage, error12_time_stamp=error12_time_stamp, form_feed_needed=form_feed_needed, upgradable_devices_version=upgradable_devices_version, simm3_bank2_type=simm3_bank2_type, channel_mio=channel_mio, ram_disk_mode=ram_disk_mode, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, held_job_pin=held_job_pin, phd2_type=phd2_type, error5_code=error5_code, settings_file_system=settings_file_system, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, media7_engine_media_mode=media7_engine_media_mode, media7_short_name=media7_short_name, copy_controller_memory_installed=copy_controller_memory_installed, error15=error15, error44=error44, resource_manager=resource_manager, error25_time_stamp=error25_time_stamp, tray1_media_size_loaded=tray1_media_size_loaded, control_panel_button_press=control_panel_button_press, jam_history_media_size=jam_history_media_size, engine_media_modes_supported1=engine_media_modes_supported1, error13_time_stamp=error13_time_stamp, error1=error1, consumables_life=consumables_life, error7=error7, print_engine_revision=print_engine_revision, simm=simm, media14=media14, settings_marking_agent=settings_marking_agent, device=device, error42=error42, engine_data_access_location=engine_data_access_location, mio1_model_name=mio1_model_name, error8_time_stamp=error8_time_stamp, error49_time_stamp=error49_time_stamp, held_job_user_name=held_job_user_name, media9_engine_media_mode=media9_engine_media_mode, background_message1=background_message1, error20=error20, operating_system=operating_system, job_info_accounting_finishing_options=job_info_accounting_finishing_options, port1_parallel_bidirectionality=port1_parallel_bidirectionality, media15_name=media15_name, error2=error2, active_print_jobs=active_print_jobs, pjl=pjl, duplex_two_to_two_mono_page_count=duplex_two_to_two_mono_page_count, usage_instructions_line4=usage_instructions_line4, status_mass_storage_bd=status_mass_storage_bd, error10_time_stamp=error10_time_stamp, error39_time_stamp=error39_time_stamp, error11_code=error11_code, imaging_mode=imaging_mode, simm1_bank2=simm1_bank2, media12_engine_media_mode=media12_engine_media_mode, web_server_security=web_server_security, error49_code=error49_code, cancel_job=cancel_job, held_job_print=held_job_print, media1_name=media1_name, consumables_status=consumables_status, timestamp=timestamp, replaceable_part_custom_information_part_number=replaceable_part_custom_information_part_number, usage_instructions_line3=usage_instructions_line3, media10=media10, error22_time_stamp=error22_time_stamp, mio2_type=mio2_type, media11_short_name=media11_short_name, simm3_bank2_capacity=simm3_bank2_capacity, service_call_information_count=service_call_information_count, error30=error30, engine_data_access=engine_data_access, configuration_dip_switches_switch=configuration_dip_switches_switch, error50_code=error50_code, simm3_bank1_capacity=simm3_bank1_capacity, io_switch=io_switch, error4_time_stamp=error4_time_stamp, error19_code=error19_code, error39_code=error39_code, tray1_phd=tray1_phd, error21=error21, media4=media4, remote_upgrade_enable=remote_upgrade_enable, copier=copier, file_systems=file_systems, error2_time_stamp=error2_time_stamp, error15_code=error15_code, consumable_reorder_url=consumable_reorder_url, simm4_bank2=simm4_bank2, duplex_page_count=duplex_page_count, phd2_manufacturing_info=phd2_manufacturing_info, media4_name=media4_name, jam_history_jam_count=jam_history_jam_count, device_system=device_system, media4_engine_media_mode=media4_engine_media_mode, mio3_manufacturing_info=mio3_manufacturing_info, upgradable_devices_current_state=upgradable_devices_current_state, media3_name=media3_name, simm4_bank2_type=simm4_bank2_type, media5_short_name=media5_short_name, media13_engine_media_mode=media13_engine_media_mode, error9=error9, mio=mio, media9_short_name=media9_short_name, settings_spooler=settings_spooler, default_media_size=default_media_size, file_system4_initialize_volume=file_system4_initialize_volume, file_system4=file_system4, error8=error8, error19_time_stamp=error19_time_stamp, hold_job_timeout=hold_job_timeout, jam_count_by_location_description=jam_count_by_location_description, tray6_phd=tray6_phd, firmware_download_version=firmware_download_version, phd=phd, held_job_enable=held_job_enable, source_subsystem=source_subsystem, media_modes=media_modes, background_message2=background_message2, settings_mass_storage_bd=settings_mass_storage_bd, background_status_msg_line2_part1=background_status_msg_line2_part1, deviceChannelTable=deviceChannelTable, simm2_bank1=simm2_bank1, default_lines_per_page=default_lines_per_page, socket_ping=socket_ping, job_info_requested_originals=job_info_requested_originals, time_regionalization=time_regionalization, display=display, mass_storage_resources=mass_storage_resources, mio2_model_name=mio2_model_name, error34=error34, job_info_accounting_media_type=job_info_accounting_media_type, media7=media7, held_job_quantity=held_job_quantity, error17_code=error17_code, default_copies=default_copies, service_call_information_description=service_call_information_description, error19=error19, job_info_attr_6=job_info_attr_6, error46_code=error46_code, job_info_attr_15=job_info_attr_15, media14_page_count=media14_page_count, simm3_bank=simm3_bank, error43_time_stamp=error43_time_stamp, localization_languages_supported=localization_languages_supported, install_date=install_date, error3=error3, pcl_total_page_count=pcl_total_page_count, error3_time_stamp=error3_time_stamp, status_prt_eng=status_prt_eng, id=id, consumable_string_information=consumable_string_information, error37=error37, show_address=show_address, job_info_change_id=job_info_change_id, os_execute_file=os_execute_file, error36=error36, auto_continue=auto_continue, media3_engine_media_mode=media3_engine_media_mode, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, intray5=intray5, media2=media2, error26_time_stamp=error26_time_stamp)
mibBuilder.exportSymbols("LJ9065-MIB", tray5_media_size_loaded=tray5_media_size_loaded, error16=error16, settings_webserver=settings_webserver, media12_name=media12_name, error45_time_stamp=error45_time_stamp, firmware_download_maximum_write_count=firmware_download_maximum_write_count, error6_code=error6_code, pcl_default_font_height=pcl_default_font_height, tables=tables, marking_agent_density=marking_agent_density, media10_engine_media_mode=media10_engine_media_mode, channel_bytes_received=channel_bytes_received, intray3=intray3, copier_accounting=copier_accounting, printed_media_charge=printed_media_charge, error27_code=error27_code, mio2=mio2, media9_name=media9_name, simm3_type=simm3_type, error7_time_stamp=error7_time_stamp, control_panel_key_press=control_panel_key_press, media_number_of_type_supported=media_number_of_type_supported, fw_rom_datecode=fw_rom_datecode, io=io, model_number=model_number, pcl_default_font_width=pcl_default_font_width, simm2_bank2_capacity=simm2_bank2_capacity, error29_code=error29_code, printed_media_count=printed_media_count, simm4=simm4, error6_time_stamp=error6_time_stamp, cold_reset_media_size=cold_reset_media_size, media1_short_name=media1_short_name, current_job_parsing_id=current_job_parsing_id, error4_code=error4_code, media5_name=media5_name, media13=media13, upgradable_devices=upgradable_devices, errorlog=errorlog, mio3=mio3, hp=hp, job_info_attr_9=job_info_attr_9, error37_code=error37_code, job_info_stage=job_info_stage, error26=error26, intray2=intray2, media14_name=media14_name, simm2_capacity=simm2_capacity, media5=media5, job=job, default_bits_per_pixel=default_bits_per_pixel, error33=error33, status_pdl=status_pdl, held_job_control=held_job_control, job_info_attr_7=job_info_attr_7, media6_engine_media_mode=media6_engine_media_mode, settings_io=settings_io, background_status_msg_line1_part1=background_status_msg_line1_part1, mass_storage_resource_change_counter=mass_storage_resource_change_counter, page_frame_memory_available=page_frame_memory_available, media15_page_count=media15_page_count, sleep_mode=sleep_mode, job_info_attr_5=job_info_attr_5, host_application_available_memory=host_application_available_memory, job_info=job_info, remote_procedure_call=remote_procedure_call, error28_code=error28_code, error21_time_stamp=error21_time_stamp, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, ram_disk_size=ram_disk_size, job_info_accounting_media_size=job_info_accounting_media_size, media13_page_count=media13_page_count, error42_code=error42_code, media13_short_name=media13_short_name, simm1_bank1_type=simm1_bank1_type, error45_code=error45_code, jam_history=jam_history, pysmi_continue=pysmi_continue, consumable_current_state=consumable_current_state, display_status=display_status, error29_time_stamp=error29_time_stamp, status_copier=status_copier, error20_code=error20_code, device_detail=device_detail, error_log_clear=error_log_clear, media3=media3, printed_media_total_charge=printed_media_total_charge, channeltype=channeltype, usage_instructions_line1=usage_instructions_line1, media11_engine_media_mode=media11_engine_media_mode, media2_short_name=media2_short_name, media6=media6, replaceable_part_life_information_part_name=replaceable_part_life_information_part_name, media6_page_count=media6_page_count, job_info_attr_3=job_info_attr_3, error31=error31, error35_code=error35_code, media14_engine_media_mode=media14_engine_media_mode, job_info_pages_processed=job_info_pages_processed, replaceable_part_life_information_count=replaceable_part_life_information_count, job_info_outcome=job_info_outcome, accounting=accounting, phd3_capacity=phd3_capacity, error6=error6, error47=error47, media16=media16, error38=error38, channelprotocolversion=channelprotocolversion, media14_short_name=media14_short_name, media_counts=media_counts, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, printer_accounting=printer_accounting, energy_star=energy_star, job_info_accounting_job_type=job_info_accounting_job_type, replaceable_part_custom_life_information=replaceable_part_custom_life_information, error18=error18, phd3_type=phd3_type, file_system=file_system, job_info_attr_8=job_info_attr_8, simm4_bank1=simm4_bank1, error41=error41, media16_name=media16_name, webserver_proc_sub=webserver_proc_sub, simm3=simm3, simm4_capacity=simm4_capacity, error41_code=error41_code, deviceChannelEntry=deviceChannelEntry, imaging_mode_page_count=imaging_mode_page_count, printed_media_usage=printed_media_usage, replaceable_part_custom_information_count=replaceable_part_custom_information_count, default_media_name=default_media_name, port1=port1, error9_code=error9_code, phd2_options_firmware_version=phd2_options_firmware_version, media2_page_count=media2_page_count, status_rpc=status_rpc, intray1=intray1, default_custom_paper_dim_unit=default_custom_paper_dim_unit, media1_engine_media_mode=media1_engine_media_mode, settings_pdl=settings_pdl, error22_code=error22_code, error12=error12, error1_time_stamp=error1_time_stamp, ports=ports, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, duplex_one_to_two_mono_page_count=duplex_one_to_two_mono_page_count, phd3=phd3, firmware_download_write_time=firmware_download_write_time, replaceable_part_life_information_part_number=replaceable_part_life_information_part_number, file_system2=file_system2, replaceable_part_life_information=replaceable_part_life_information, mio1=mio1, error24_time_stamp=error24_time_stamp, job_info_io_source=job_info_io_source, phd2_options_model=phd2_options_model, job_info_outbins_used=job_info_outbins_used, media12_short_name=media12_short_name, held_job_info=held_job_info, error13_code=error13_code, jam_history_time_stamp=jam_history_time_stamp, configuration_dip_switches=configuration_dip_switches, reprint=reprint, test=test, simm4_bank1_capacity=simm4_bank1_capacity, firmware_download=firmware_download, settings_prt_eng=settings_prt_eng, pdl=pdl, file_system_max_open_files=file_system_max_open_files, error38_code=error38_code, media_size=media_size, PYSNMP_MODULE_ID=hp, job_info_attribute=job_info_attribute, job_info_attr_13=job_info_attr_13, upgradable_devices_write_time=upgradable_devices_write_time, tray3_phd=tray3_phd, socket_ping_job_events_version=socket_ping_job_events_version, error27_time_stamp=error27_time_stamp, simm1_bank1_capacity=simm1_bank1_capacity, error48_code=error48_code, media9_page_count=media9_page_count, error50_time_stamp=error50_time_stamp, asset_number=asset_number, default_custom_paper_feed_dim=default_custom_paper_feed_dim, simm1_bank=simm1_bank, simm1_bank2_capacity=simm1_bank2_capacity, media3_page_count=media3_page_count, job_info_attr_16=job_info_attr_16, background_message=background_message, media10_name=media10_name, netPMLmgmt=netPMLmgmt, phd2_number_of_options=phd2_number_of_options, io_timeout=io_timeout, low_marking_agent_processing=low_marking_agent_processing, media_types=media_types, media11_page_count=media11_page_count, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, media7_name=media7_name, error30_code=error30_code, jam_count_by_location_count=jam_count_by_location_count, error31_time_stamp=error31_time_stamp, error36_time_stamp=error36_time_stamp, held_job_job_name=held_job_job_name, error14_code=error14_code, maximum_ram_disk_memory=maximum_ram_disk_memory, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, error17=error17, error1_code=error1_code, jam_history_magnification=jam_history_magnification, settings_intray=settings_intray, media8_name=media8_name, media13_name=media13_name, job_info_accounting=job_info_accounting, job_info_name1=job_info_name1, default_horizontal_black_resolution=default_horizontal_black_resolution, error27=error27, phd2_options_description=phd2_options_description, error5=error5, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, channelstate=channelstate, simm3_bank2=simm3_bank2, phd3_manufacturing_info=phd3_manufacturing_info, media_size_count=media_size_count, error49=error49, error45=error45, printer_average=printer_average, held_job_retention=held_job_retention, mass_storage_resource_changed=mass_storage_resource_changed, settings_job=settings_job, default_page_protect=default_page_protect, error24=error24, phd3_number_of_options=phd3_number_of_options, simm2_bank2=simm2_bank2, simm2=simm2, error46=error46, simm1_type=simm1_type, error48_time_stamp=error48_time_stamp, error41_time_stamp=error41_time_stamp, error25=error25, form_feed=form_feed, consumable_life_low_threshold=consumable_life_low_threshold, intrays=intrays, firmware_download_write_count=firmware_download_write_count, out_marking_agent_processing=out_marking_agent_processing, media4_short_name=media4_short_name, consumables=consumables, error16_time_stamp=error16_time_stamp, perm_store_init_occurred=perm_store_init_occurred, job_info_state=job_info_state, error47_code=error47_code, processing_subsystem=processing_subsystem, jam_count_by_location=jam_count_by_location, pcl_default_font_source=pcl_default_font_source, job_info_attr_14=job_info_attr_14)
mibBuilder.exportSymbols("LJ9065-MIB", mio3_model_name=mio3_model_name, error33_time_stamp=error33_time_stamp, error36_code=error36_code, pdl_postscript=pdl_postscript, print_media=print_media, error3_code=error3_code, upgradable_devices_write_count=upgradable_devices_write_count, simm4_bank2_capacity=simm4_bank2_capacity, media12_page_count=media12_page_count, error20_time_stamp=error20_time_stamp, simm1_bank2_type=simm1_bank2_type, self_test=self_test, held_job_set_queue_size=held_job_set_queue_size, postscript_print_errors=postscript_print_errors, media15_short_name=media15_short_name, error30_time_stamp=error30_time_stamp, usage_instructions_line2=usage_instructions_line2, firmware_download_current_state=firmware_download_current_state, error7_code=error7_code, marking_agent=marking_agent, simm2_bank=simm2_bank, error10_code=error10_code, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, simm2_bank1_type=simm2_bank1_type, rpc_bind_protocol_address=rpc_bind_protocol_address, intray6=intray6, error15_time_stamp=error15_time_stamp, error9_time_stamp=error9_time_stamp, error32_time_stamp=error32_time_stamp, error24_code=error24_code, service_call_information=service_call_information, error43_code=error43_code, marking_agent_density_setting=marking_agent_density_setting, error23_time_stamp=error23_time_stamp, port1_parallel_speed=port1_parallel_speed, file_system_delete_files=file_system_delete_files, error28=error28, held_job=held_job, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, phd3_model=phd3_model, media15=media15, job_info_name2=job_info_name2, error32_code=error32_code, upgradable_devices_name=upgradable_devices_name, imaging_mode_page_count_description=imaging_mode_page_count_description, upgradable_devices_max_write_count=upgradable_devices_max_write_count, channelnumberofchannels=channelnumberofchannels, file_system3=file_system3, localization_countries_supported=localization_countries_supported, job_info_attr_1=job_info_attr_1, file_system3_initialize_volume=file_system3_initialize_volume, job_info_size=job_info_size, channelstatus=channelstatus, model_name=model_name, job_info_pages_in_original=job_info_pages_in_original, channelifindex=channelifindex, error39=error39, error13=error13, error16_code=error16_code, media11_name=media11_name, error40=error40, mio3_type=mio3_type, fw_rom_revision=fw_rom_revision, media8_engine_media_mode=media8_engine_media_mode, default_vertical_black_resolution=default_vertical_black_resolution, job_info_attr_10=job_info_attr_10, simm4_type=simm4_type, error8_code=error8_code, error26_code=error26_code, error34_time_stamp=error34_time_stamp, channelinformation=channelinformation, channel_jobs_received=channel_jobs_received, print_engine=print_engine, media8_short_name=media8_short_name, error32=error32, job_info_printed_originals=job_info_printed_originals, job_being_parsed=job_being_parsed, collated_originals_support=collated_originals_support, media15_engine_media_mode=media15_engine_media_mode, pcl_default_font_number=pcl_default_font_number, media10_page_count=media10_page_count, channelTable=channelTable, consumable_string=consumable_string, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, mass_storage_block_driver=mass_storage_block_driver, error18_time_stamp=error18_time_stamp, media7_page_count=media7_page_count, error28_time_stamp=error28_time_stamp, tray2_media_size_loaded=tray2_media_size_loaded, media16_page_count=media16_page_count, jam_history_jam_code=jam_history_jam_code, copy_controller_disk_storage=copy_controller_disk_storage, error29=error29, phd2=phd2, error4=error4, file_system2_initialize_volume=file_system2_initialize_volume, job_info_attr_4=job_info_attr_4, error21_code=error21_code, error17_time_stamp=error17_time_stamp, non_assured_oht_page_count=non_assured_oht_page_count, simm1=simm1, media5_page_count=media5_page_count, simm2_type=simm2_type, mio2_manufacturing_info=mio2_manufacturing_info, error10=error10, error23=error23, error11_time_stamp=error11_time_stamp, error40_time_stamp=error40_time_stamp, error12_code=error12_code, error46_time_stamp=error46_time_stamp, serial_number=serial_number, media2_name=media2_name, print_density=print_density, media5_engine_media_mode=media5_engine_media_mode, channel=channel, consumable_life_usage_units=consumable_life_usage_units, error18_code=error18_code, job_info_attr_11=job_info_attr_11, device_location=device_location, error42_time_stamp=error42_time_stamp, error44_code=error44_code, job_info_page_count_current_original=job_info_page_count_current_original, simm1_capacity=simm1_capacity, simm2_bank2_type=simm2_bank2_type, status_system=status_system, settings_rpc=settings_rpc, error14=error14, media3_short_name=media3_short_name, media12=media12, media11=media11, job_info_attr_2=job_info_attr_2, error34_code=error34_code, media8_page_count=media8_page_count)
