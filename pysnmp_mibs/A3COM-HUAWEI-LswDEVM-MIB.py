...
mibBuilder.exportSymbols("A3COM-HUAWEI-LswDEVM-MIB", hwLswdevMMib=hwLswdevMMib, hwCpuCostRatePer5Min=hwCpuCostRatePer5Min, hwLswdevMMibObject=hwLswdevMMibObject, hwCpuCostRate=hwCpuCostRate, hwMemSize=hwMemSize, hwMemTable=hwMemTable, hwDevMSlotEnvironmentStatus=hwDevMSlotEnvironmentStatus, hwBufModuleIndex=hwBufModuleIndex, hwBufCurrentTotal=hwBufCurrentTotal, hwCfmEraseFlash=hwCfmEraseFlash, hwMemModuleIndex=hwMemModuleIndex, hwBufCurrentUsed=hwBufCurrentUsed, hwMem=hwMem, hwdot1qTpFdbLearnStatus=hwdot1qTpFdbLearnStatus, hwCpuTable=hwCpuTable, hwMemFail=hwMemFail, hwMemLgFree=hwMemLgFree, PYSNMP_MODULE_ID=hwLswdevMMib, hwCpuEntry=hwCpuEntry, hwFlhTotalFree=hwFlhTotalFree, hwDevMPowerNum=hwDevMPowerNum, hwBufEntry=hwBufEntry, hwBufTable=hwBufTable, hwFlhState=hwFlhState, hwDevMFanNum=hwDevMFanNum, hwDevMFirstTrapTime=hwDevMFirstTrapTime, hwDevMSlotEnvironmentValue=hwDevMSlotEnvironmentValue, hwdevMSlotEnvironmentTable=hwdevMSlotEnvironmentTable, hwFlhTotalSize=hwFlhTotalSize, hwDevice=hwDevice, hwMemRawSliceUsed=hwMemRawSliceUsed, hwFlh=hwFlh, hwDevMSlotEnvironmentUpperLimit=hwDevMSlotEnvironmentUpperLimit, hwDevMSlotEnvironmentLowerLimit=hwDevMSlotEnvironmentLowerLimit, hwLinkUpDownTrapEnable=hwLinkUpDownTrapEnable, hwCpuCostRatePer1Min=hwCpuCostRatePer1Min, hwdevMSlotEnvironmentType=hwdevMSlotEnvironmentType, hwFlhLastDelTime=hwFlhLastDelTime, hwDevMFanStatus=hwDevMFanStatus, hwFlhDelState=hwFlhDelState, hwdevMFanStatusTable=hwdevMFanStatusTable, hwdevMPowerStatusEntry=hwdevMPowerStatusEntry, hwdevMFanStatusEntry=hwdevMFanStatusEntry, hwdevMSlotEnvironmentEntry=hwdevMSlotEnvironmentEntry, hwDevMPowerStatus=hwDevMPowerStatus, hwCfmWriteFlash=hwCfmWriteFlash, hwBufSize=hwBufSize, hwCpuIndex=hwCpuIndex, hwMemEntry=hwMemEntry, hwMemFailNoMem=hwMemFailNoMem, hwMemFree=hwMemFree, hwdevMPowerStatusTable=hwdevMPowerStatusTable)
