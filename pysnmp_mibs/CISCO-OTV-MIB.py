...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-OTV-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:22:54 2025
...
class _CotvOverlayVlansExtendedFirst2k_Type(Cisco2KVlanList):
    """Custom type cotvOverlayVlansExtendedFirst2k based on Cisco2KVlanList"""
    defaultValue = OctetString("")


_CotvOverlayVlansExtendedFirst2k_Type.__name__ = "Cisco2KVlanList"
...
class _CotvOverlayVlansExtendedSecond2k_Type(Cisco2KVlanList):
    """Custom type cotvOverlayVlansExtendedSecond2k based on Cisco2KVlanList"""
    defaultValue = OctetString("")


_CotvOverlayVlansExtendedSecond2k_Type.__name__ = "Cisco2KVlanList"
...
_CotvOverlayControlGroupAddrType_Type.__name__ = "InetAddressType"
...
class _CotvOverlayControlGroupAddr_Type(InetAddress):
    """Custom type cotvOverlayControlGroupAddr based on InetAddress"""
    defaultValue = OctetString("")


_CotvOverlayControlGroupAddr_Type.__name__ = "InetAddress"
...
_CotvOverlayBroadcastGroupAddrType_Type.__name__ = "InetAddressType"
...
class _CotvOverlayBroadcastGroupAddr_Type(InetAddress):
    """Custom type cotvOverlayBroadcastGroupAddr based on InetAddress"""
    defaultValue = OctetString("")


_CotvOverlayBroadcastGroupAddr_Type.__name__ = "InetAddress"
...
_CotvOverlayJoinInterface_Type.__name__ = "InterfaceIndexOrZero"
...
_CotvOverlaySourceInterface_Type.__name__ = "InterfaceIndexOrZero"
...
_CotvOverlayAdjServerEnable_Type.__name__ = "TruthValue"
...
_CotvOverlayPrimaryAdjServerAddrType_Type.__name__ = "InetAddressType"
...
class _CotvOverlayPrimaryAdjServerAddr_Type(InetAddress):
    """Custom type cotvOverlayPrimaryAdjServerAddr based on InetAddress"""
    defaultValue = OctetString("")


_CotvOverlayPrimaryAdjServerAddr_Type.__name__ = "InetAddress"
...
_CotvOverlaySecondaryAdjServerAddrType_Type.__name__ = "InetAddressType"
...
class _CotvOverlaySecondaryAdjServerAddr_Type(InetAddress):
    """Custom type cotvOverlaySecondaryAdjServerAddr based on InetAddress"""
    defaultValue = OctetString("")


_CotvOverlaySecondaryAdjServerAddr_Type.__name__ = "InetAddress"
...
_CotvOverlaySuppressArpND_Type.__name__ = "TruthValue"
...
_CotvOverlayStorageType_Type.__name__ = "StorageType"
...
_CotvDataGroupStorageType_Type.__name__ = "StorageType"
...
ciscoOtvMIBCompliance.setObjects(
      *(("CISCO-OTV-MIB", "ciscoOtvSiteGroup"),
        ("CISCO-OTV-MIB", "ciscoOtvOverlayGroup"),
        ("CISCO-OTV-MIB", "ciscoOtvVlanGroup"),
        ("CISCO-OTV-MIB", "ciscoOtvDataGroupConfigGroup"),
        ("CISCO-OTV-MIB", "ciscoOtvDataGroupInfoGroup"),
        ("CISCO-OTV-MIB", "ciscoOtvAdjacencyGroup"),
        ("CISCO-OTV-MIB", "ciscoOtvArpNdCacheGroup"),
        ("CISCO-OTV-MIB", "ciscoOtvRouteGroup"),
        ("CISCO-OTV-MIB", "ciscoOtvMcastRouteGroup"),
        ("CISCO-OTV-MIB", "ciscoOtvMcastRouteInfoGroup"))
)
if mibBuilder.loadTexts:
