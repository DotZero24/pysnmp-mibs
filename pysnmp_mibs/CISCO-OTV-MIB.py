...
mibBuilder.exportSymbols("CISCO-OTV-MIB", cotvAdjacentDevSystemID=cotvAdjacentDevSystemID, cotvVlanId=cotvVlanId, cotvOverlaySourceInterface=cotvOverlaySourceInterface, ciscoOtvMIBObjects=ciscoOtvMIBObjects, cotvMcastRouteInfoUpTime=cotvMcastRouteInfoUpTime, cotvSiteVlanState=cotvSiteVlanState, cotvOverlaySecondaryAdjServerAddrType=cotvOverlaySecondaryAdjServerAddrType, cotvVlanState=cotvVlanState, cotvArpNdCacheMacAddr=cotvArpNdCacheMacAddr, ciscoOtvMIBCompliance=ciscoOtvMIBCompliance, ciscoOtvRouteGroup=ciscoOtvRouteGroup, cotvOverlayTable=cotvOverlayTable, cotvDataGroupInfoTable=cotvDataGroupInfoTable, cotvRouteMacAddr=cotvRouteMacAddr, cotvOverlayVpnDownReason=cotvOverlayVpnDownReason, cotvDataGroupStorageType=cotvDataGroupStorageType, cotvOverlayNumber=cotvOverlayNumber, PYSNMP_MODULE_ID=ciscoOtvMIB, cotvOverlayControlGroupAddr=cotvOverlayControlGroupAddr, cotvMcastRouteInfoEntry=cotvMcastRouteInfoEntry, cotvDataGroupRowStatus=cotvDataGroupRowStatus, cotvMcastRouteVlanId=cotvMcastRouteVlanId, cotvVlansEntry=cotvVlansEntry, cotvMcastRouteOwners=cotvMcastRouteOwners, cotvOverlayAedCapable=cotvOverlayAedCapable, cotvMcastRouteInfoMetric=cotvMcastRouteInfoMetric, ciscoOtvDataGroupConfigGroup=ciscoOtvDataGroupConfigGroup, cotvDataGroupActiveGroupAddr=cotvDataGroupActiveGroupAddr, cotvDataGroupLocalActiveSrcState=cotvDataGroupLocalActiveSrcState, cotvRouteEntry=cotvRouteEntry, cotvSiteObjects=cotvSiteObjects, cotvArpNdCacheL3AddrType=cotvArpNdCacheL3AddrType, cotvDataGroupActiveSrcAddrType=cotvDataGroupActiveSrcAddrType, cotvAdjacencyDatabaseTable=cotvAdjacencyDatabaseTable, cotvMcastRouteInfoHostAddrType=cotvMcastRouteInfoHostAddrType, ciscoOtvMIBNotifs=ciscoOtvMIBNotifs, cotvRouteObjects=cotvRouteObjects, cotvRouteTable=cotvRouteTable, ciscoOtvMIBConform=ciscoOtvMIBConform, cotvOverlayPrimaryAdjServerAddrType=cotvOverlayPrimaryAdjServerAddrType, cotvOverlayVlansExtendedSecond2k=cotvOverlayVlansExtendedSecond2k, cotvArpNdCacheAge=cotvArpNdCacheAge, cotvVlanAedAddr=cotvVlanAedAddr, cotvRouteNextHopAddrType=cotvRouteNextHopAddrType, cotvOverlayVpnState=cotvOverlayVpnState, cotvRouteOwner=cotvRouteOwner, cotvDataGroupVlanId=cotvDataGroupVlanId, cotvRouteNextHopIf=cotvRouteNextHopIf, cotvMcastRouteActiveSrcAddr=cotvMcastRouteActiveSrcAddr, cotvOverlayStorageType=cotvOverlayStorageType, cotvMcastRouteEntry=cotvMcastRouteEntry, cotvMcastRouteActiveGroupAddr=cotvMcastRouteActiveGroupAddr, ciscoOtvOverlayGroup=ciscoOtvOverlayGroup, ciscoOtvVlanGroup=ciscoOtvVlanGroup, cotvSiteVlan=cotvSiteVlan, cotvMcastRouteActiveGroupAddrType=cotvMcastRouteActiveGroupAddrType, cotvSiteIdOper=cotvSiteIdOper, cotvOverlayVpnName=cotvOverlayVpnName, cotvSiteIdAdmin=cotvSiteIdAdmin, cotvOverlaySuppressArpND=cotvOverlaySuppressArpND, ciscoOtvMIBGroups=ciscoOtvMIBGroups, cotvDataGroupDeliverySrcAddr=cotvDataGroupDeliverySrcAddr, cotvMcastRouteInfoTable=cotvMcastRouteInfoTable, cotvGlobalObjects=cotvGlobalObjects, cotvArpNdCacheL3Addr=cotvArpNdCacheL3Addr, cotvMcastRouteInfoActiveGroupAddr=cotvMcastRouteInfoActiveGroupAddr, cotvVlanAedAddrType=cotvVlanAedAddrType, cotvRouteMetric=cotvRouteMetric, cotvOverlayRowStatus=cotvOverlayRowStatus, cotvDataGroupMcastRangeAddrType=cotvDataGroupMcastRangeAddrType, cotvAdjacencyDatabaseEntry=cotvAdjacencyDatabaseEntry, cotvOverlayAedIncapableReason=cotvOverlayAedIncapableReason, cotvOverlayPrimaryAdjServerAddr=cotvOverlayPrimaryAdjServerAddr, cotvMcastRouteMetric=cotvMcastRouteMetric, cotvDataGroupInfoEntry=cotvDataGroupInfoEntry, cotvRouteVlanId=cotvRouteVlanId, cotvMcastRouteTable=cotvMcastRouteTable, cotvMcastRouteInfoActiveSrcAddr=cotvMcastRouteInfoActiveSrcAddr, cotvDataGroupConfigEntry=cotvDataGroupConfigEntry, cotvDataGroupConfigTable=cotvDataGroupConfigTable, ciscoOtvDataGroupInfoGroup=ciscoOtvDataGroupInfoGroup, cotvOverlayControlGroupAddrType=cotvOverlayControlGroupAddrType, cotvDataGroupMcastRangeAddr=cotvDataGroupMcastRangeAddr, cotvDataGroupMcastRangePrefixLength=cotvDataGroupMcastRangePrefixLength, cotvArpNdCacheEntry=cotvArpNdCacheEntry, cotvArpNdObjects=cotvArpNdObjects, cotvDataGroupDeliveryGroupAddr=cotvDataGroupDeliveryGroupAddr, cotvMcastRouteInfoActiveGroupAddrType=cotvMcastRouteInfoActiveGroupAddrType, cotvMcastRouteInfoProtocolOwners=cotvMcastRouteInfoProtocolOwners, cotvVlansTable=cotvVlansTable, cotvMcastRouteUpTime=cotvMcastRouteUpTime, cotvOverlayVlansExtendedFirst2k=cotvOverlayVlansExtendedFirst2k, ciscoOtvMIB=ciscoOtvMIB, cotvMcastRouteInfoIf=cotvMcastRouteInfoIf, ciscoOtvAdjacencyGroup=ciscoOtvAdjacencyGroup, ciscoOtvSiteGroup=ciscoOtvSiteGroup, cotvArpNdCacheTimeToExpire=cotvArpNdCacheTimeToExpire, cotvAdjacencyObjects=cotvAdjacencyObjects, ciscoOtvMcastRouteInfoGroup=ciscoOtvMcastRouteInfoGroup, ciscoOtvMIBCompliances=ciscoOtvMIBCompliances, cotvOverlayEntry=cotvOverlayEntry, cotvDataGroupActiveSrcAddr=cotvDataGroupActiveSrcAddr, cotvAdjacentDevUpTime=cotvAdjacentDevUpTime, cotvOverlayObjects=cotvOverlayObjects, cotvDataGroupJoinInterface=cotvDataGroupJoinInterface, cotvMcastRouteInfoActiveSrcAddrType=cotvMcastRouteInfoActiveSrcAddrType, cotvRouteUpTime=cotvRouteUpTime, cotvArpNdCacheTable=cotvArpNdCacheTable, cotvRouteNextHopAddr=cotvRouteNextHopAddr, cotvOverlaySecondaryAdjServerAddr=cotvOverlaySecondaryAdjServerAddr, cotvDataGroupDeliveryGroupAddrType=cotvDataGroupDeliveryGroupAddrType, cotvMcastRouteActiveSrcAddrType=cotvMcastRouteActiveSrcAddrType, cotvOverlayBroadcastGroupAddrType=cotvOverlayBroadcastGroupAddrType, cotvDataGroupDeliverySrcAddrType=cotvDataGroupDeliverySrcAddrType, cotvAdjacentDevAddr=cotvAdjacentDevAddr, cotvMcastRouteInfoVlanId=cotvMcastRouteInfoVlanId, cotvAdjacentDevState=cotvAdjacentDevState, cotvOverlayBroadcastGroupAddr=cotvOverlayBroadcastGroupAddr, cotvGlobalStatsObjects=cotvGlobalStatsObjects, cotvOverlayAdjServerEnable=cotvOverlayAdjServerEnable, cotvAdjacentDevName=cotvAdjacentDevName, ciscoOtvArpNdCacheGroup=ciscoOtvArpNdCacheGroup, cotvDataGroupActiveGroupAddrType=cotvDataGroupActiveGroupAddrType, cotvDataGroupActiveSrcLocation=cotvDataGroupActiveSrcLocation, cotvVlanEdgeDevIsAed=cotvVlanEdgeDevIsAed, cotvMcastRouteInfoHostAddr=cotvMcastRouteInfoHostAddr, cotvVlanInactiveReason=cotvVlanInactiveReason, cotvOverlayJoinInterface=cotvOverlayJoinInterface, cotvOverlayAdjServerTransportType=cotvOverlayAdjServerTransportType, ciscoOtvMcastRouteGroup=ciscoOtvMcastRouteGroup, cotvAdjacentDevAddrType=cotvAdjacentDevAddrType)
