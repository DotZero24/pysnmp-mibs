...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-OTV-MIB
...
mibBuilder.exportSymbols("CISCO-OTV-MIB", ciscoOtvMIB=ciscoOtvMIB, cotvAdjacencyObjects=cotvAdjacencyObjects, cotvOverlayControlGroupAddrType=cotvOverlayControlGroupAddrType, cotvDataGroupInfoEntry=cotvDataGroupInfoEntry, cotvDataGroupMcastRangeAddrType=cotvDataGroupMcastRangeAddrType, cotvArpNdCacheL3AddrType=cotvArpNdCacheL3AddrType, cotvVlanId=cotvVlanId, cotvVlanAedAddr=cotvVlanAedAddr, cotvMcastRouteActiveSrcAddrType=cotvMcastRouteActiveSrcAddrType, cotvMcastRouteInfoHostAddr=cotvMcastRouteInfoHostAddr, cotvVlanInactiveReason=cotvVlanInactiveReason, PYSNMP_MODULE_ID=ciscoOtvMIB, cotvAdjacentDevName=cotvAdjacentDevName, cotvAdjacentDevSystemID=cotvAdjacentDevSystemID, cotvDataGroupConfigTable=cotvDataGroupConfigTable, ciscoOtvMIBGroups=ciscoOtvMIBGroups, cotvOverlayNumber=cotvOverlayNumber, cotvMcastRouteInfoActiveGroupAddrType=cotvMcastRouteInfoActiveGroupAddrType, cotvMcastRouteActiveGroupAddr=cotvMcastRouteActiveGroupAddr, cotvOverlaySecondaryAdjServerAddrType=cotvOverlaySecondaryAdjServerAddrType, cotvVlanAedAddrType=cotvVlanAedAddrType, cotvDataGroupInfoTable=cotvDataGroupInfoTable, cotvDataGroupActiveSrcAddrType=cotvDataGroupActiveSrcAddrType, ciscoOtvDataGroupConfigGroup=ciscoOtvDataGroupConfigGroup, cotvRouteNextHopIf=cotvRouteNextHopIf, cotvOverlayEntry=cotvOverlayEntry, cotvAdjacentDevAddrType=cotvAdjacentDevAddrType, cotvVlanState=cotvVlanState, ciscoOtvMIBNotifs=ciscoOtvMIBNotifs, cotvArpNdCacheTable=cotvArpNdCacheTable, cotvMcastRouteInfoActiveSrcAddrType=cotvMcastRouteInfoActiveSrcAddrType, cotvMcastRouteInfoVlanId=cotvMcastRouteInfoVlanId, cotvGlobalStatsObjects=cotvGlobalStatsObjects, cotvDataGroupJoinInterface=cotvDataGroupJoinInterface, cotvMcastRouteActiveSrcAddr=cotvMcastRouteActiveSrcAddr, cotvDataGroupDeliveryGroupAddrType=cotvDataGroupDeliveryGroupAddrType, cotvMcastRouteInfoTable=cotvMcastRouteInfoTable, cotvAdjacentDevAddr=cotvAdjacentDevAddr, cotvDataGroupMcastRangePrefixLength=cotvDataGroupMcastRangePrefixLength, cotvOverlayBroadcastGroupAddrType=cotvOverlayBroadcastGroupAddrType, ciscoOtvVlanGroup=ciscoOtvVlanGroup, cotvVlansEntry=cotvVlansEntry, cotvArpNdObjects=cotvArpNdObjects, cotvRouteEntry=cotvRouteEntry, cotvMcastRouteMetric=cotvMcastRouteMetric, cotvMcastRouteInfoEntry=cotvMcastRouteInfoEntry, cotvRouteNextHopAddr=cotvRouteNextHopAddr, cotvDataGroupActiveGroupAddr=cotvDataGroupActiveGroupAddr, cotvMcastRouteEntry=cotvMcastRouteEntry, cotvAdjacencyDatabaseTable=cotvAdjacencyDatabaseTable, cotvDataGroupDeliverySrcAddr=cotvDataGroupDeliverySrcAddr, cotvMcastRouteActiveGroupAddrType=cotvMcastRouteActiveGroupAddrType, cotvRouteMetric=cotvRouteMetric, cotvRouteVlanId=cotvRouteVlanId, cotvMcastRouteInfoMetric=cotvMcastRouteInfoMetric, ciscoOtvAdjacencyGroup=ciscoOtvAdjacencyGroup, cotvOverlayVlansExtendedFirst2k=cotvOverlayVlansExtendedFirst2k, cotvOverlayAedIncapableReason=cotvOverlayAedIncapableReason, cotvAdjacentDevUpTime=cotvAdjacentDevUpTime, cotvOverlayStorageType=cotvOverlayStorageType, cotvOverlayPrimaryAdjServerAddr=cotvOverlayPrimaryAdjServerAddr, ciscoOtvArpNdCacheGroup=ciscoOtvArpNdCacheGroup, cotvMcastRouteInfoProtocolOwners=cotvMcastRouteInfoProtocolOwners, cotvArpNdCacheTimeToExpire=cotvArpNdCacheTimeToExpire, cotvSiteObjects=cotvSiteObjects, cotvOverlayPrimaryAdjServerAddrType=cotvOverlayPrimaryAdjServerAddrType, cotvRouteObjects=cotvRouteObjects, cotvDataGroupLocalActiveSrcState=cotvDataGroupLocalActiveSrcState, cotvDataGroupVlanId=cotvDataGroupVlanId, cotvArpNdCacheEntry=cotvArpNdCacheEntry, ciscoOtvDataGroupInfoGroup=ciscoOtvDataGroupInfoGroup, cotvRouteUpTime=cotvRouteUpTime, cotvOverlayAedCapable=cotvOverlayAedCapable, ciscoOtvMcastRouteInfoGroup=ciscoOtvMcastRouteInfoGroup, cotvDataGroupActiveGroupAddrType=cotvDataGroupActiveGroupAddrType, cotvAdjacencyDatabaseEntry=cotvAdjacencyDatabaseEntry, cotvMcastRouteVlanId=cotvMcastRouteVlanId, ciscoOtvMIBConform=ciscoOtvMIBConform, cotvVlansTable=cotvVlansTable, cotvOverlayVpnState=cotvOverlayVpnState, cotvOverlayAdjServerTransportType=cotvOverlayAdjServerTransportType, cotvGlobalObjects=cotvGlobalObjects, cotvRouteNextHopAddrType=cotvRouteNextHopAddrType, cotvSiteIdOper=cotvSiteIdOper, cotvVlanEdgeDevIsAed=cotvVlanEdgeDevIsAed, cotvOverlayVlansExtendedSecond2k=cotvOverlayVlansExtendedSecond2k, cotvArpNdCacheMacAddr=cotvArpNdCacheMacAddr, ciscoOtvMcastRouteGroup=ciscoOtvMcastRouteGroup, cotvRouteTable=cotvRouteTable, cotvOverlaySuppressArpND=cotvOverlaySuppressArpND, cotvOverlayVpnName=cotvOverlayVpnName, cotvArpNdCacheAge=cotvArpNdCacheAge, cotvOverlayObjects=cotvOverlayObjects, cotvSiteIdAdmin=cotvSiteIdAdmin, cotvDataGroupStorageType=cotvDataGroupStorageType, cotvMcastRouteInfoActiveSrcAddr=cotvMcastRouteInfoActiveSrcAddr, cotvDataGroupRowStatus=cotvDataGroupRowStatus, cotvDataGroupDeliveryGroupAddr=cotvDataGroupDeliveryGroupAddr, ciscoOtvOverlayGroup=ciscoOtvOverlayGroup, cotvArpNdCacheL3Addr=cotvArpNdCacheL3Addr, cotvDataGroupDeliverySrcAddrType=cotvDataGroupDeliverySrcAddrType, cotvRouteOwner=cotvRouteOwner, cotvOverlaySecondaryAdjServerAddr=cotvOverlaySecondaryAdjServerAddr, cotvMcastRouteInfoActiveGroupAddr=cotvMcastRouteInfoActiveGroupAddr, ciscoOtvMIBCompliance=ciscoOtvMIBCompliance, cotvSiteVlan=cotvSiteVlan, cotvDataGroupConfigEntry=cotvDataGroupConfigEntry, cotvOverlayBroadcastGroupAddr=cotvOverlayBroadcastGroupAddr, ciscoOtvMIBCompliances=ciscoOtvMIBCompliances, cotvOverlayTable=cotvOverlayTable, cotvAdjacentDevState=cotvAdjacentDevState, cotvSiteVlanState=cotvSiteVlanState, cotvMcastRouteUpTime=cotvMcastRouteUpTime, cotvMcastRouteTable=cotvMcastRouteTable, cotvDataGroupActiveSrcAddr=cotvDataGroupActiveSrcAddr, cotvOverlaySourceInterface=cotvOverlaySourceInterface, cotvOverlayRowStatus=cotvOverlayRowStatus, ciscoOtvRouteGroup=ciscoOtvRouteGroup, cotvOverlayControlGroupAddr=cotvOverlayControlGroupAddr, cotvMcastRouteInfoIf=cotvMcastRouteInfoIf, cotvDataGroupActiveSrcLocation=cotvDataGroupActiveSrcLocation, cotvMcastRouteOwners=cotvMcastRouteOwners, cotvRouteMacAddr=cotvRouteMacAddr, cotvMcastRouteInfoHostAddrType=cotvMcastRouteInfoHostAddrType, ciscoOtvSiteGroup=ciscoOtvSiteGroup, cotvOverlayAdjServerEnable=cotvOverlayAdjServerEnable, cotvDataGroupMcastRangeAddr=cotvDataGroupMcastRangeAddr, cotvOverlayVpnDownReason=cotvOverlayVpnDownReason, ciscoOtvMIBObjects=ciscoOtvMIBObjects, cotvMcastRouteInfoUpTime=cotvMcastRouteInfoUpTime, cotvOverlayJoinInterface=cotvOverlayJoinInterface)
