...
_D='read-create'
_C='Integer32'
_B='A3COM-HUAWEI-IP-ADDRESS-MIB'
_A='current'
...
h3cIpAddressObjects=_H3cIpAddressObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,67,1))
_H3cIpAddressConfig_ObjectIdentity=ObjectIdentity
h3cIpAddressConfig=_H3cIpAddressConfig_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,67,1,1))
_H3cIpAddrSetTable_Object=MibTable
h3cIpAddrSetTable=_H3cIpAddrSetTable_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,1))
if mibBuilder.loadTexts:h3cIpAddrSetTable.setStatus(_A)
_H3cIpAddrSetEntry_Object=MibTableRow
h3cIpAddrSetEntry=_H3cIpAddrSetEntry_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,1,1))
...
h3cIpAddrSetIfIndex=_H3cIpAddrSetIfIndex_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,1,1,1),_H3cIpAddrSetIfIndex_Type())
...
h3cIpAddrSetAddrType=_H3cIpAddrSetAddrType_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,1,1,2),_H3cIpAddrSetAddrType_Type())
...
h3cIpAddrSetAddr=_H3cIpAddrSetAddr_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,1,1,3),_H3cIpAddrSetAddr_Type())
...
h3cIpAddrSetMask=_H3cIpAddrSetMask_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,1,1,4),_H3cIpAddrSetMask_Type())
...
h3cIpAddrSetSourceType=_H3cIpAddrSetSourceType_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,1,1,5),_H3cIpAddrSetSourceType_Type())
...
h3cIpAddrSetCatalog=_H3cIpAddrSetCatalog_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,1,1,6),_H3cIpAddrSetCatalog_Type())
...
h3cIpAddrSetRowStatus=_H3cIpAddrSetRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,1,1,7),_H3cIpAddrSetRowStatus_Type())
...
h3cIpAddrReadTable=_H3cIpAddrReadTable_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,2))
if mibBuilder.loadTexts:h3cIpAddrReadTable.setStatus(_A)
_H3cIpAddrReadEntry_Object=MibTableRow
h3cIpAddrReadEntry=_H3cIpAddrReadEntry_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,2,1))
...
h3cIpAddrReadIfIndex=_H3cIpAddrReadIfIndex_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,2,1,1),_H3cIpAddrReadIfIndex_Type())
...
h3cIpAddrReadAddrType=_H3cIpAddrReadAddrType_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,2,1,2),_H3cIpAddrReadAddrType_Type())
...
h3cIpAddrReadAddr=_H3cIpAddrReadAddr_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,2,1,3),_H3cIpAddrReadAddr_Type())
...
h3cIpAddrReadMask=_H3cIpAddrReadMask_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,2,1,4),_H3cIpAddrReadMask_Type())
...
h3cIpAddrReadSourceType=_H3cIpAddrReadSourceType_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,2,1,5),_H3cIpAddrReadSourceType_Type())
...
h3cIpAddrReadCatalog=_H3cIpAddrReadCatalog_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,2,1,6),_H3cIpAddrReadCatalog_Type())
...
h3cIpv4AddrTable=_H3cIpv4AddrTable_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,3))
if mibBuilder.loadTexts:h3cIpv4AddrTable.setStatus(_A)
_H3cIpv4AddrEntry_Object=MibTableRow
h3cIpv4AddrEntry=_H3cIpv4AddrEntry_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,3,1))
...
h3cIpv4AddrAddr=_H3cIpv4AddrAddr_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,3,1,1),_H3cIpv4AddrAddr_Type())
...
h3cIpv4AddrMask=_H3cIpv4AddrMask_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,3,1,2),_H3cIpv4AddrMask_Type())
...
h3cIpv4AddrRowStatus=_H3cIpv4AddrRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,67,1,1,3,1,3),_H3cIpv4AddrRowStatus_Type())
...
h3cIpAddrNotify=_H3cIpAddrNotify_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,67,2))
_H3cIpAddrNotifyScalarObjects_ObjectIdentity=ObjectIdentity
h3cIpAddrNotifyScalarObjects=_H3cIpAddrNotifyScalarObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,67,2,1))
...
h3cIpAddrNotifyIfIndex=_H3cIpAddrNotifyIfIndex_Object((1,3,6,1,4,1,43,45,1,10,2,67,2,1,1),_H3cIpAddrNotifyIfIndex_Type())
...
h3cIpAddrOldIpAddress=_H3cIpAddrOldIpAddress_Object((1,3,6,1,4,1,43,45,1,10,2,67,2,1,2),_H3cIpAddrOldIpAddress_Type())
...
h3cIpAddrNewIpAddress=_H3cIpAddrNewIpAddress_Object((1,3,6,1,4,1,43,45,1,10,2,67,2,1,3),_H3cIpAddrNewIpAddress_Type())
...
h3cIpAddrFirstTrapTime=_H3cIpAddrFirstTrapTime_Object((1,3,6,1,4,1,43,45,1,10,2,67,2,1,4),_H3cIpAddrFirstTrapTime_Type())
...
h3cIpAddrNotifyObjects=_H3cIpAddrNotifyObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,67,2,2))
_H3cIpAddrNotifyObjectsPrefix_ObjectIdentity=ObjectIdentity
h3cIpAddrNotifyObjectsPrefix=_H3cIpAddrNotifyObjectsPrefix_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,67,2,2,0))
h3cIpAddressChangeNotify=NotificationType((1,3,6,1,4,1,43,45,1,10,2,67,2,2,0,1))
