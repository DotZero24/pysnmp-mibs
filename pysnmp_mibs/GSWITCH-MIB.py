...
mibBuilder.exportSymbols("GSWITCH-MIB", nbsPortLateColl=nbsPortLateColl, nbsPortsStatTable=nbsPortsStatTable, nbsPortsContTable=nbsPortsContTable, nbsPortFrameLong=nbsPortFrameLong, nbsMACAddrTable=nbsMACAddrTable, nbsUpLinkType=nbsUpLinkType, nbsPortsCountEntry=nbsPortsCountEntry, nbsPortMulByteRec=nbsPortMulByteRec, gswitch=gswitch, nbsPartition=nbsPartition, nbsRMONmode=nbsRMONmode, nbsForwardMulticast=nbsForwardMulticast, nbsPortBroadcast=nbsPortBroadcast, nbsMacFirstGap=nbsMacFirstGap, nbsPortByteRec=nbsPortByteRec, nbsMACAddrEntry=nbsMACAddrEntry, nbsPALPortsTable=nbsPALPortsTable, nbsSoftVers=nbsSoftVers, nbsPortBadByteRec=nbsPortBadByteRec, nbsUpLinkHardVers=nbsUpLinkHardVers, nbsPortsCounters=nbsPortsCounters, nbsPortPolDetection=nbsPortPolDetection, nbsCardHardVers=nbsCardHardVers, nbsCardsEntry=nbsCardsEntry, nbsPortByteSent=nbsPortByteSent, nbsPALPortOpticPower=nbsPALPortOpticPower, nbsSpanningTree=nbsSpanningTree, nbsPortFramesSent=nbsPortFramesSent, nbsPortsCountTable=nbsPortsCountTable, nbsPortForwardUnk=nbsPortForwardUnk, nbsBaseHardVers=nbsBaseHardVers, nbsPortBroadByteRec=nbsPortBroadByteRec, nbsSlotsTable=nbsSlotsTable, nbsNPorts=nbsNPorts, nbsCardsTable=nbsCardsTable, nbsCardIndex=nbsCardIndex, nbsForwardUnkPkts=nbsForwardUnkPkts, nbsDeviceControl=nbsDeviceControl, nbsAddressTable=nbsAddressTable, nbase=nbase, nbsPortDuplex=nbsPortDuplex, nbsPortFramesShort=nbsPortFramesShort, nbsSnifferPort=nbsSnifferPort, nbsPortSpaning=nbsPortSpaning, nbsPALPortIndex=nbsPALPortIndex, nbsPortBroadFramesRec=nbsPortBroadFramesRec, nbsPortsControl=nbsPortsControl, nbsLearningProcess=nbsLearningProcess, nbsPortIndex2=nbsPortIndex2, nbsPortCRCAligErr=nbsPortCRCAligErr, nbsPortsContEntry=nbsPortsContEntry, nbsBackOffMode=nbsBackOffMode, nbsLinkTest=nbsLinkTest, nbsAddrPort=nbsAddrPort, nbsMACAddress=nbsMACAddress, nbsPortsStatEntry=nbsPortsStatEntry, nbsDevIdentify=nbsDevIdentify, nbsPortCollisions=nbsPortCollisions, nbsPortMulFramesRec=nbsPortMulFramesRec, nbsNMacRecords=nbsNMacRecords, nbsPortIndex1=nbsPortIndex1, nbsPortType=nbsPortType, nbsPortsStatus=nbsPortsStatus, nbsPortFramesRec=nbsPortFramesRec, nbsPortJabber=nbsPortJabber, nbsParitionEnable=nbsParitionEnable, nbsAddrForwardTo=nbsAddrForwardTo, nbsPortSpeed=nbsPortSpeed, nbsPortMonitor=nbsPortMonitor, nbsBufferThreshold=nbsBufferThreshold, nbsCreatinDate=nbsCreatinDate, nbsPALPorts=nbsPALPorts, nbsPALPortsEntry=nbsPALPortsEntry, nbsPortIndex=nbsPortIndex, nbsAddrIndex=nbsAddrIndex, nbsAddrStatic=nbsAddrStatic, nbsCardType=nbsCardType, nbsPortEnable=nbsPortEnable)
