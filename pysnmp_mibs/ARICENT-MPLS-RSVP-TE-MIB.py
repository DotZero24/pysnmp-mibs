# SNMP MIB module (ARICENT-MPLS-RSVP-TE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MPLS-RSVP-TE-MIB
...
fsMplsRsvpTeIfEntry = _FsMplsRsvpTeIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1)
)
fsMplsRsvpTeIfEntry.setIndexNames(
    (0, "ARICENT-MPLS-RSVP-TE-MIB", "fsMplsRsvpTeIfIndex"),
)
if mibBuilder.loadTexts:
...
fsMplsRsvpTeIfMtu = _FsMplsRsvpTeIfMtu_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 10),
...
fsMplsRsvpTeIfUdpNbrs = _FsMplsRsvpTeIfUdpNbrs_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 11),
...
fsMplsRsvpTeIfIpNbrs = _FsMplsRsvpTeIfIpNbrs_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 12),
...
fsMplsRsvpTeIfNbrs = _FsMplsRsvpTeIfNbrs_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 13),
...
fsMplsRsvpTeIfRefreshMultiple = _FsMplsRsvpTeIfRefreshMultiple_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 14),
...
fsMplsRsvpTeIfTTL = _FsMplsRsvpTeIfTTL_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 15),
...
fsMplsRsvpTeIfRefreshInterval = _FsMplsRsvpTeIfRefreshInterval_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 16),
...
fsMplsRsvpTeIfRouteDelay = _FsMplsRsvpTeIfRouteDelay_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 17),
...
fsMplsRsvpTeIfUdpRequired = _FsMplsRsvpTeIfUdpRequired_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 18),
...
fsMplsRsvpTeIfHelloSupported = _FsMplsRsvpTeIfHelloSupported_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 19),
...
class _FsMplsRsvpTeIfLinkAttr_Type(Unsigned32):
    """Custom type fsMplsRsvpTeIfLinkAttr based on Unsigned32"""
    defaultValue = 1
...
fsMplsRsvpTeIfStatus = _FsMplsRsvpTeIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 21),
...
fsMplsRsvpTeIfPlrId = _FsMplsRsvpTeIfPlrId_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 22),
...
fsMplsRsvpTeIfAvoidNodeId = _FsMplsRsvpTeIfAvoidNodeId_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 23),
...
fsMplsRsvpTeIfStorageType = _FsMplsRsvpTeIfStorageType_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 1, 1, 24),
...
fsMplsRsvpTeIfNumResvErrSent = _FsMplsRsvpTeIfNumResvErrSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 10),
...
fsMplsRsvpTeIfNumResvErrRcvd = _FsMplsRsvpTeIfNumResvErrRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 11),
...
fsMplsRsvpTeIfNumResvTearSent = _FsMplsRsvpTeIfNumResvTearSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 12),
...
fsMplsRsvpTeIfNumResvTearRcvd = _FsMplsRsvpTeIfNumResvTearRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 13),
...
fsMplsRsvpTeIfNumResvConfSent = _FsMplsRsvpTeIfNumResvConfSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 14),
...
fsMplsRsvpTeIfNumResvConfRcvd = _FsMplsRsvpTeIfNumResvConfRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 15),
...
fsMplsRsvpTeIfNumBundleMsgSent = _FsMplsRsvpTeIfNumBundleMsgSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 16),
...
fsMplsRsvpTeIfNumBundleMsgRcvd = _FsMplsRsvpTeIfNumBundleMsgRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 17),
...
fsMplsRsvpTeIfNumSRefreshMsgSent = _FsMplsRsvpTeIfNumSRefreshMsgSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 18),
...
fsMplsRsvpTeIfNumSRefreshMsgRcvd = _FsMplsRsvpTeIfNumSRefreshMsgRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 19),
...
fsMplsRsvpTeIfNumPathSent = _FsMplsRsvpTeIfNumPathSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 20),
...
fsMplsRsvpTeIfNumPathRcvd = _FsMplsRsvpTeIfNumPathRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 21),
...
fsMplsRsvpTeIfNumResvSent = _FsMplsRsvpTeIfNumResvSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 22),
...
fsMplsRsvpTeIfNumResvRcvd = _FsMplsRsvpTeIfNumResvRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 23),
...
fsMplsRsvpTeIfNumNotifyMsgSent = _FsMplsRsvpTeIfNumNotifyMsgSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 24),
...
fsMplsRsvpTeIfNumNotifyMsgRcvd = _FsMplsRsvpTeIfNumNotifyMsgRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 25),
...
fsMplsRsvpTeIfNumRecoveryPathSent = _FsMplsRsvpTeIfNumRecoveryPathSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 26),
...
fsMplsRsvpTeIfNumRecoveryPathRcvd = _FsMplsRsvpTeIfNumRecoveryPathRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 27),
...
fsMplsRsvpTeIfNumPathSentWithRecoveryLbl = _FsMplsRsvpTeIfNumPathSentWithRecoveryLbl_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 28),
...
fsMplsRsvpTeIfNumPathRcvdWithRecoveryLbl = _FsMplsRsvpTeIfNumPathRcvdWithRecoveryLbl_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 29),
...
fsMplsRsvpTeIfNumPathSentWithSuggestedLbl = _FsMplsRsvpTeIfNumPathSentWithSuggestedLbl_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 30),
...
fsMplsRsvpTeIfNumPathRcvdWithSuggestedLbl = _FsMplsRsvpTeIfNumPathRcvdWithSuggestedLbl_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 31),
...
fsMplsRsvpTeIfNumHelloSentWithRestartCap = _FsMplsRsvpTeIfNumHelloSentWithRestartCap_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 32),
...
fsMplsRsvpTeIfNumHelloRcvdWithRestartCap = _FsMplsRsvpTeIfNumHelloRcvdWithRestartCap_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 33),
...
fsMplsRsvpTeIfNumHelloSentWithCapability = _FsMplsRsvpTeIfNumHelloSentWithCapability_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 34),
...
fsMplsRsvpTeIfNumHelloRcvdWithCapability = _FsMplsRsvpTeIfNumHelloRcvdWithCapability_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 35),
...
fsMplsRsvpTeIfNumPktDiscrded = _FsMplsRsvpTeIfNumPktDiscrded_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 2, 1, 36),
    _FsMplsRsvpTeIfNumPktDiscrded_Type()
)
fsMplsRsvpTeIfNumPktDiscrded.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsMplsRsvpTeIfNumPktDiscrded.setStatus("current")
_FsMplsRsvpTeNbrTable_Object = MibTable
fsMplsRsvpTeNbrTable = _FsMplsRsvpTeNbrTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3)
)
if mibBuilder.loadTexts:
...
fsMplsRsvpTeNbrEntry = _FsMplsRsvpTeNbrEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1)
)
fsMplsRsvpTeNbrEntry.setIndexNames(
    (0, "ARICENT-MPLS-RSVP-TE-MIB", "fsMplsRsvpTeIfIndex"),
    (0, "ARICENT-MPLS-RSVP-TE-MIB", "fsMplsRsvpTeNbrIfAddr"),
)
if mibBuilder.loadTexts:
...
fsMplsRsvpTeNbrDestInstInfo = _FsMplsRsvpTeNbrDestInstInfo_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 10),
...
fsMplsRsvpTeNbrCreationTime = _FsMplsRsvpTeNbrCreationTime_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 11),
...
fsMplsRsvpTeNbrLclRprDetectionTime = _FsMplsRsvpTeNbrLclRprDetectionTime_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 12),
...
fsMplsRsvpTeNbrNumTunnels = _FsMplsRsvpTeNbrNumTunnels_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 13),
...
fsMplsRsvpTeNbrStatus = _FsMplsRsvpTeNbrStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 14),
...
fsMplsRsvpTeNbrGrRecoveryPathCapability = _FsMplsRsvpTeNbrGrRecoveryPathCapability_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 15),
...
fsMplsRsvpTeNbrGrRestartTime = _FsMplsRsvpTeNbrGrRestartTime_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 16),
...
fsMplsRsvpTeNbrGrRecoveryTime = _FsMplsRsvpTeNbrGrRecoveryTime_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 17),
...
fsMplsRsvpTeNbrGrProgressStatus = _FsMplsRsvpTeNbrGrProgressStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 18),
...
fsMplsRsvpTeNbrStorageType = _FsMplsRsvpTeNbrStorageType_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 1, 3, 1, 19),
...
class _FsMplsRsvpTeReoptimizeTime_Type(Integer32):
    """Custom type fsMplsRsvpTeReoptimizeTime based on Integer32"""
    defaultValue = 60


_FsMplsRsvpTeReoptimizeTime_Type.__name__ = "Integer32"
_FsMplsRsvpTeReoptimizeTime_Object = MibScalar
fsMplsRsvpTeReoptimizeTime = _FsMplsRsvpTeReoptimizeTime_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 2, 35),
    _FsMplsRsvpTeReoptimizeTime_Type()
)
fsMplsRsvpTeReoptimizeTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMplsRsvpTeReoptimizeTime.setStatus("current")


class _FsMplsRsvpTeEroCacheTime_Type(Integer32):
    """Custom type fsMplsRsvpTeEroCacheTime based on Integer32"""
    defaultValue = 5


_FsMplsRsvpTeEroCacheTime_Type.__name__ = "Integer32"
_FsMplsRsvpTeEroCacheTime_Object = MibScalar
fsMplsRsvpTeEroCacheTime = _FsMplsRsvpTeEroCacheTime_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 2, 36),
    _FsMplsRsvpTeEroCacheTime_Type()
)
fsMplsRsvpTeEroCacheTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMplsRsvpTeEroCacheTime.setStatus("current")
_FsMplsRsvpTeReoptLinkMaintenance_Type = Integer32
_FsMplsRsvpTeReoptLinkMaintenance_Object = MibScalar
fsMplsRsvpTeReoptLinkMaintenance = _FsMplsRsvpTeReoptLinkMaintenance_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 2, 37),
    _FsMplsRsvpTeReoptLinkMaintenance_Type()
)
fsMplsRsvpTeReoptLinkMaintenance.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMplsRsvpTeReoptLinkMaintenance.setStatus("current")
_FsMplsRsvpTeReoptNodeMaintenance_Type = Integer32
_FsMplsRsvpTeReoptNodeMaintenance_Object = MibScalar
fsMplsRsvpTeReoptNodeMaintenance = _FsMplsRsvpTeReoptNodeMaintenance_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 2, 2, 38),
    _FsMplsRsvpTeReoptNodeMaintenance_Type()
)
fsMplsRsvpTeReoptNodeMaintenance.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMplsRsvpTeReoptNodeMaintenance.setStatus("current")
fsMplsRsvpTeIfEntry.registerAugmentions(
    ("ARICENT-MPLS-RSVP-TE-MIB",
...
mibBuilder.exportSymbols(
    ...
    **{"MplsLsrIdentifier": MplsLsrIdentifier,
       ...
       "fsMplsRsvpTeIfNumPktDiscrded": fsMplsRsvpTeIfNumPktDiscrded,
       ...
       "fsMplsRsvpTeReoptimizeTime": fsMplsRsvpTeReoptimizeTime,
       "fsMplsRsvpTeEroCacheTime": fsMplsRsvpTeEroCacheTime,
       "fsMplsRsvpTeReoptLinkMaintenance": fsMplsRsvpTeReoptLinkMaintenance,
       "fsMplsRsvpTeReoptNodeMaintenance": fsMplsRsvpTeReoptNodeMaintenance}
)
