...
# Notes
# -----
# ASN.1 source file://mibs/rfc/TCP-ESTATS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:55 2025
...
_TcpEStatsControlPath_Type.__name__ = "TruthValue"
...
_TcpEStatsControlStack_Type.__name__ = "TruthValue"
...
_TcpEStatsControlApp_Type.__name__ = "TruthValue"
...
_TcpEStatsControlTune_Type.__name__ = "TruthValue"
...
_TcpEStatsControlNotify_Type.__name__ = "TruthValue"
...
_TcpEStatsConnTableLatency_Type.__name__ = "Unsigned32"
...
tcpEStatsCompliance.setObjects(
      *(("TCP-ESTATS-MIB", "tcpEStatsListenerGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsConnectIdGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsPerfGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsPathGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsStackGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsAppGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsListenerHCGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsPerfOptionalGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsPerfHCGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsPathOptionalGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsPathHCGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsStackOptionalGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsAppHCGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsAppOptionalGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsTuneOptionalGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsNotificationsGroup"),
        ("TCP-ESTATS-MIB", "tcpEStatsNotificationsCtlGroup"))
)
if mibBuilder.loadTexts:
