...
h3cNMConfigObjects=_H3cNMConfigObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,90,1))
_H3cNMMonitorObjects_ObjectIdentity=ObjectIdentity
h3cNMMonitorObjects=_H3cNMMonitorObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,90,2))
_H3cNMNotify_ObjectIdentity=ObjectIdentity
h3cNMNotify=_H3cNMNotify_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,90,3))
_H3cNMNotifyScalarObjects_ObjectIdentity=ObjectIdentity
h3cNMNotifyScalarObjects=_H3cNMNotifyScalarObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,90,3,1))
_H3cNMIpAddressType_Type=InetAddressType
_H3cNMIpAddressType_Object=MibScalar
h3cNMIpAddressType=_H3cNMIpAddressType_Object((1,3,6,1,4,1,43,45,1,10,2,90,3,1,1),_H3cNMIpAddressType_Type())
...
h3cNMIpAddress=_H3cNMIpAddress_Object((1,3,6,1,4,1,43,45,1,10,2,90,3,1,2),_H3cNMIpAddress_Type())
...
h3cNMCustomBuildInfo=_H3cNMCustomBuildInfo_Object((1,3,6,1,4,1,43,45,1,10,2,90,3,1,3),_H3cNMCustomBuildInfo_Type())
...
h3cNMSerialNum=_H3cNMSerialNum_Object((1,3,6,1,4,1,43,45,1,10,2,90,3,1,4),_H3cNMSerialNum_Type())
...
h3cNMNotifyObjects=_H3cNMNotifyObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,90,3,2))
_H3cNMNotifyObjectsPrefix_ObjectIdentity=ObjectIdentity
h3cNMNotifyObjectsPrefix=_H3cNMNotifyObjectsPrefix_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,90,3,2,0))
_H3cNetManConformance_ObjectIdentity=ObjectIdentity
h3cNetManConformance=_H3cNetManConformance_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,90,4))
_H3cNetManCompliances_ObjectIdentity=ObjectIdentity
h3cNetManCompliances=_H3cNetManCompliances_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,90,4,1))
_H3cNetManGroups_ObjectIdentity=ObjectIdentity
h3cNetManGroups=_H3cNetManGroups_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,90,4,2))
h3cNMMonitorGroup=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,90,4,2,1))
h3cNMMonitorGroup.setObjects(*((_A,_E),(_A,_F),(_A,_G),(_A,_H)))
if mibBuilder.loadTexts:h3cNMMonitorGroup.setStatus(_B)
h3cIpAddrChangeNotify=NotificationType((1,3,6,1,4,1,43,45,1,10,2,90,3,2,0,1))
h3cIpAddrChangeNotify.setObjects(*((_A,_E),(_A,_F),(_A,_G),(_A,_H)))
if mibBuilder.loadTexts:h3cIpAddrChangeNotify.setStatus(_B)
h3cNMNotificationGroup=NotificationGroup((1,3,6,1,4,1,43,45,1,10,2,90,4,2,2))
h3cNMNotificationGroup.setObjects((_A,_I))
if mibBuilder.loadTexts:h3cNMNotificationGroup.setStatus(_B)
h3cNetManCompliance=ModuleCompliance((1,3,6,1,4,1,43,45,1,10,2,90,4,1,1))
