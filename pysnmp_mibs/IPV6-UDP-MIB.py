...
# Produced by pysmi-1.6.2 at Fri Oct 10 21:22:55 2025
...
if mibBuilder.loadTexts:
    ipv6UdpTable.setStatus("current")
...
if mibBuilder.loadTexts:
    ipv6UdpEntry.setStatus("current")
...
if mibBuilder.loadTexts:
    ipv6UdpLocalAddress.setStatus("current")
...
if mibBuilder.loadTexts:
    ipv6UdpLocalPort.setStatus("current")
...
if mibBuilder.loadTexts:
    ipv6UdpIfIndex.setStatus("current")
...
if mibBuilder.loadTexts:
    ipv6UdpGroup.setStatus("current")
...
ipv6UdpCompliance.setObjects(
    ("IPV6-UDP-MIB", "ipv6UdpGroup")
)
if mibBuilder.loadTexts:
