...
if mibBuilder.loadTexts:f10FamilyMIB.setRevisions(('2013-10-22 12:00','2011-12-15 12:00','2007-06-15 12:00','2002-01-31 00:00'))
_F10ESeriesProducts_ObjectIdentity=ObjectIdentity
f10ESeriesProducts=_F10ESeriesProducts_ObjectIdentity((1,3,6,1,4,1,6027,1,1))
if mibBuilder.loadTexts:f10ESeriesProducts.setStatus(_A)
...
f10CSeriesProducts=_F10CSeriesProducts_ObjectIdentity((1,3,6,1,4,1,6027,1,2))
if mibBuilder.loadTexts:f10CSeriesProducts.setStatus(_A)
...
f10SSeriesProducts=_F10SSeriesProducts_ObjectIdentity((1,3,6,1,4,1,6027,1,3))
if mibBuilder.loadTexts:f10SSeriesProducts.setStatus(_A)
...
f10MSeriesProducts=_F10MSeriesProducts_ObjectIdentity((1,3,6,1,4,1,6027,1,4))
if mibBuilder.loadTexts:f10MSeriesProducts.setStatus(_A)
...
f10ZSeriesProducts=_F10ZSeriesProducts_ObjectIdentity((1,3,6,1,4,1,6027,1,5))
if mibBuilder.loadTexts:f10ZSeriesProducts.setStatus(_A)
...
mibBuilder.exportSymbols('F10-PRODUCTS-MIB',**{'f10ESeriesProducts':f10ESeriesProducts,'e1200':e1200,'e600':e600,'e300':e300,'e610':e610,'e1200i':e1200i,'f10CSeriesProducts':f10CSeriesProducts,'c300':c300,'c150':c150,'f10SSeriesProducts':f10SSeriesProducts,'s50':s50,'s50e':s50e,'s50v':s50v,'s25pac':s25pac,'s2410cp':s2410cp,'s2410p':s2410p,'s50nac':s50nac,'s50ndc':s50ndc,'s25pdc':s25pdc,'s25v':s25v,'s25n':s25n,'s60':s60,'s55':s55,'s4810':s4810,'z9000':z9000,'s4820':s4820,'s6000':s6000,'s5000':s5000,'s4810on':s4810on,'s6000on':s6000on,'s4048on':s4048on,'s3048on':s3048on,'f10MSeriesProducts':f10MSeriesProducts,'m-MXL':m_MXL,'m-IOA':m_IOA,'s-IOA':s_IOA,'f10ZSeriesProducts':f10ZSeriesProducts,'z9500':z9500,'f10FamilyMIB':f10FamilyMIB})