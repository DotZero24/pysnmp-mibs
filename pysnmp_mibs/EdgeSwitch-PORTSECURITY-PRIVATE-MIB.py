...
_J='Unsigned32'
_I='EdgeSwitch-PORTSECURITY-PRIVATE-MIB'
_H='read-only'
_G='ifIndex'
_F='IF-MIB'
_E='disable'
...
agentPortSecurityStickyMode=_AgentPortSecurityStickyMode_Object((1,3,6,1,4,1,4413,1,1,20,1,2,1,11),_AgentPortSecurityStickyMode_Type())
...
agentGlobalPortSecurityStickyMode=_AgentGlobalPortSecurityStickyMode_Object((1,3,6,1,4,1,4413,1,1,20,1,4),_AgentGlobalPortSecurityStickyMode_Type())
...
agentGlobalPortSecurityViolationTrapMode=_AgentGlobalPortSecurityViolationTrapMode_Object((1,3,6,1,4,1,4413,1,1,20,1,5),_AgentGlobalPortSecurityViolationTrapMode_Type())
