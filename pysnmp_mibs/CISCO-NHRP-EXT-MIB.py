...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-NHRP-EXT-MIB
...
nhrpClientInternetworkAddr, nhrpClientNhsInternetworkAddr, nhrpServerNhcNbmaAddrType, nhrpCacheNbmaAddr, nhrpClientNbmaAddrType, nhrpClientIndex, nhrpServerNhcPrefixLength, nhrpClientHoldTime, nhrpServerInternetworkAddr, nhrpServerNhcInternetworkAddrType, nhrpClientNhsNbmaAddrType, nhrpServerNbmaAddrType, nhrpClientStatEntry, nhrpServerStatEntry, nhrpServerNhcInUse, nhrpClientNbmaSubaddr, nhrpClientNbmaAddr, nhrpClientRegUniqueness, nhrpServerNhcNbmaSubaddr, nhrpServerNhcNbmaAddr, nhrpCacheType, nhrpClientInternetworkAddrType, nhrpServerIndex, nhrpServerInternetworkAddrType, nhrpServerNbmaAddr, nhrpCacheNbmaAddrType, nhrpClientNhsNbmaAddr, nhrpServerCacheUniqueness, nhrpServerNhcInternetworkAddr, nhrpClientNhsInternetworkAddrType, nhrpClientNhsInUse, nhrpCacheNextHopInternetworkAddr, nhrpClientNhsNbmaSubaddr, nhrpServerNbmaSubaddr, nhrpCacheNbmaSubaddr = mibBuilder.importSymbols("NHRP-MIB", "nhrpClientInternetworkAddr", "nhrpClientNhsInternetworkAddr", "nhrpServerNhcNbmaAddrType", "nhrpCacheNbmaAddr", "nhrpClientNbmaAddrType", "nhrpClientIndex", "nhrpServerNhcPrefixLength", "nhrpClientHoldTime", "nhrpServerInternetworkAddr", "nhrpServerNhcInternetworkAddrType", "nhrpClientNhsNbmaAddrType", "nhrpServerNbmaAddrType", "nhrpClientStatEntry", "nhrpServerStatEntry", "nhrpServerNhcInUse", "nhrpClientNbmaSubaddr", "nhrpClientNbmaAddr", "nhrpClientRegUniqueness", "nhrpServerNhcNbmaSubaddr", "nhrpServerNhcNbmaAddr", "nhrpCacheType", "nhrpClientInternetworkAddrType", "nhrpServerIndex", "nhrpServerInternetworkAddrType", "nhrpServerNbmaAddr", "nhrpCacheNbmaAddrType", "nhrpClientNhsNbmaAddr", "nhrpServerCacheUniqueness", "nhrpServerNhcInternetworkAddr", "nhrpClientNhsInternetworkAddrType", "nhrpClientNhsInUse", "nhrpCacheNextHopInternetworkAddr", "nhrpClientNhsNbmaSubaddr", "nhrpServerNbmaSubaddr", "nhrpCacheNbmaSubaddr")
...
mibBuilder.exportSymbols("CISCO-NHRP-EXT-MIB", cneNotifNextHopRegServerDown=cneNotifNextHopRegServerDown, PYSNMP_MODULE_ID=ciscoNhrpExtMIB, cneConform=cneConform, CiscoNextHopDownReasonCode=CiscoNextHopDownReasonCode, CiscoNhrpErrorCode=CiscoNhrpErrorCode, cneObjects=cneObjects, cneNextHopDownReason=cneNextHopDownReason, cneCompliance=cneCompliance, cneClientStatExtTable=cneClientStatExtTable, cneClientStatExtEntry=cneClientStatExtEntry, cneNotifNextHopPeerDown=cneNotifNextHopPeerDown, cneNotifNextHopPeerUp=cneNotifNextHopPeerUp, cneNotifNextHopRegServerUp=cneNotifNextHopRegServerUp, cneNotifRateLimitExceeded=cneNotifRateLimitExceeded, cneClientStatRedirectRx=cneClientStatRedirectRx, cneGeneralGroup=cneGeneralGroup, cneServerObjects=cneServerObjects, cneNotifEnable=cneNotifEnable, cneGeneralNotificationGroup=cneGeneralNotificationGroup, cneNotifNextHopRegClientUp=cneNotifNextHopRegClientUp, cneNotificationControlGroup=cneNotificationControlGroup, cneCompliances=cneCompliances, cneServerNotificationGroup=cneServerNotificationGroup, cneGroups=cneGroups, ciscoNhrpExtMIB=ciscoNhrpExtMIB, cneNHRPException=cneNHRPException, cneClientGroup=cneClientGroup, cneServerGroup=cneServerGroup, cneServerStatRedirectTx=cneServerStatRedirectTx, cneServerStatExtTable=cneServerStatExtTable, cneNotifs=cneNotifs, cneServerStatExtEntry=cneServerStatExtEntry, cneNotifNextHopRegClientDown=cneNotifNextHopRegClientDown, cneClientObjects=cneClientObjects, cneClientNotificationGroup=cneClientNotificationGroup, cneGeneralObjects=cneGeneralObjects, cneNotificationControlObjects=cneNotificationControlObjects)
