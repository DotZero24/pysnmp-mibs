...
# Notes
# -----
# ASN.1 source file://mibs/brocade/BROCADE-SPX-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:02:58 2025
...
class _BrcdSPXGlobalConfigZeroTouchEnable_Type(Integer32):
    """Custom type brcdSPXGlobalConfigZeroTouchEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_BrcdSPXGlobalConfigZeroTouchEnable_Type.__name__ = "Integer32"
_BrcdSPXGlobalConfigZeroTouchEnable_Object = MibScalar
brcdSPXGlobalConfigZeroTouchEnable = _BrcdSPXGlobalConfigZeroTouchEnable_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 1, 3, 40, 1, 3),
    _BrcdSPXGlobalConfigZeroTouchEnable_Type()
)
brcdSPXGlobalConfigZeroTouchEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    brcdSPXGlobalConfigZeroTouchEnable.setStatus("current")


class _BrcdSPXGlobalConfigZeroTouchDeny_Type(Integer32):
    """Custom type brcdSPXGlobalConfigZeroTouchDeny based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_BrcdSPXGlobalConfigZeroTouchDeny_Type.__name__ = "Integer32"
_BrcdSPXGlobalConfigZeroTouchDeny_Object = MibScalar
brcdSPXGlobalConfigZeroTouchDeny = _BrcdSPXGlobalConfigZeroTouchDeny_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 1, 3, 40, 1, 4),
    _BrcdSPXGlobalConfigZeroTouchDeny_Type()
)
brcdSPXGlobalConfigZeroTouchDeny.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    brcdSPXGlobalConfigZeroTouchDeny.setStatus("current")


class _BrcdSPXGlobalConfigAllowPEMovement_Type(Integer32):
    """Custom type brcdSPXGlobalConfigAllowPEMovement based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_BrcdSPXGlobalConfigAllowPEMovement_Type.__name__ = "Integer32"
_BrcdSPXGlobalConfigAllowPEMovement_Object = MibScalar
brcdSPXGlobalConfigAllowPEMovement = _BrcdSPXGlobalConfigAllowPEMovement_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 1, 3, 40, 1, 5),
    _BrcdSPXGlobalConfigAllowPEMovement_Type()
)
brcdSPXGlobalConfigAllowPEMovement.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    brcdSPXGlobalConfigAllowPEMovement.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"brcdSPXMIB": brcdSPXMIB,
       ...
       "brcdSPXGlobalConfigZeroTouchEnable": brcdSPXGlobalConfigZeroTouchEnable,
       "brcdSPXGlobalConfigZeroTouchDeny": brcdSPXGlobalConfigZeroTouchDeny,
       "brcdSPXGlobalConfigAllowPEMovement": brcdSPXGlobalConfigAllowPEMovement,
