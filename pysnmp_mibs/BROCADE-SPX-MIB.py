...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/brocade/BROCADE-SPX-MIB
...
brcdSPXMIB.setRevisions(('2015-05-12 00:00', '2017-08-07 00:00',))
if mibBuilder.loadTexts: brcdSPXMIB.setLastUpdated('201708070000Z')
if mibBuilder.loadTexts: brcdSPXMIB.setOrganization('Ruckus Wireless, Inc')
...
brcdSPXGlobalConfigZeroTouchEnable = MibScalar((1, 3, 6, 1, 4, 1, 1991, 1, 1, 3, 40, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1))).clone(namedValues=NamedValues(("none", 0), ("enabled", 1)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: brcdSPXGlobalConfigZeroTouchEnable.setStatus('current')
brcdSPXGlobalConfigZeroTouchDeny = MibScalar((1, 3, 6, 1, 4, 1, 1991, 1, 1, 3, 40, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1))).clone(namedValues=NamedValues(("none", 0), ("deny", 1)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: brcdSPXGlobalConfigZeroTouchDeny.setStatus('current')
brcdSPXGlobalConfigAllowPEMovement = MibScalar((1, 3, 6, 1, 4, 1, 1991, 1, 1, 3, 40, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1))).clone(namedValues=NamedValues(("none", 0), ("enabled", 1)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: brcdSPXGlobalConfigAllowPEMovement.setStatus('current')
...
brcdSPXOperUnitRole = MibTableColumn((1, 3, 6, 1, 4, 1, 1991, 1, 1, 3, 40, 2, 2, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(("other", 1), ("active", 2), ("standby", 3), ("member", 4), ("standalone", 5), ("spxPe", 6)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("BROCADE-SPX-MIB", brcdSPXCBSPXPortEntry=brcdSPXCBSPXPortEntry, brcdSPXOperUnitType=brcdSPXOperUnitType, brcdSPXGlobalConfigZeroTouchDeny=brcdSPXGlobalConfigZeroTouchDeny, brcdSPXOperUnitMac=brcdSPXOperUnitMac, brcdSPXCBSPXLagLagIflist=brcdSPXCBSPXLagLagIflist, brcdSPXPEGroupCBSPXPort=brcdSPXPEGroupCBSPXPort, brcdSPXConfigUnitState=brcdSPXConfigUnitState, brcdSPXOperUnitEntry=brcdSPXOperUnitEntry, brcdSPXPEGroupPEGroup=brcdSPXPEGroupPEGroup, brcdSPXGlobalConfigCBState=brcdSPXGlobalConfigCBState, brcdSPXMIB=brcdSPXMIB, brcdSPXConfigUnitPESPXLag1=brcdSPXConfigUnitPESPXLag1, brcdSPXGlobalConfigAllowPEMovement=brcdSPXGlobalConfigAllowPEMovement, brcdSPXCBSPXLagPEGroup=brcdSPXCBSPXLagPEGroup, brcdSPXConfigUnitType=brcdSPXConfigUnitType, brcdSPXConfigUnitPEName=brcdSPXConfigUnitPEName, brcdSPXOperUnitBuildlVer=brcdSPXOperUnitBuildlVer, brcdSPXCBSPXLagRowStatus=brcdSPXCBSPXLagRowStatus, brcdSPXCBSPXPortRowStatus=brcdSPXCBSPXPortRowStatus, brcdSPXCBSPXPortPort=brcdSPXCBSPXPortPort, brcdSPXOperUnitIndex=brcdSPXOperUnitIndex, brcdSPXOperUnitPriority=brcdSPXOperUnitPriority, brcdSPXOperUnitDescription=brcdSPXOperUnitDescription, brcdSPXCBSPXLagPrimaryPort=brcdSPXCBSPXLagPrimaryPort, brcdSPXOperUnitState=brcdSPXOperUnitState, brcdSPXConfigUnitRowStatus=brcdSPXConfigUnitRowStatus, brcdSPXCBSPXLagEntry=brcdSPXCBSPXLagEntry, brcdSPXCBSPXLagTable=brcdSPXCBSPXLagTable, brcdSPXOperUnitImgVer=brcdSPXOperUnitImgVer, brcdSPXPEGroupPEIdList=brcdSPXPEGroupPEIdList, brcdSPXTableObjects=brcdSPXTableObjects, brcdSPXPEGroupCBSPXEndPort=brcdSPXPEGroupCBSPXEndPort, brcdSPXGlobalConfigZeroTouchEnable=brcdSPXGlobalConfigZeroTouchEnable, brcdSPXConfigUnitIndex=brcdSPXConfigUnitIndex, brcdSPXConfigUnitPESPXLag2=brcdSPXConfigUnitPESPXLag2, brcdSPXConfigUnitTable=brcdSPXConfigUnitTable, brcdSPXCBSPXPortTable=brcdSPXCBSPXPortTable, brcdSPXGlobalObjects=brcdSPXGlobalObjects, brcdSPXConfigUnitEntry=brcdSPXConfigUnitEntry, brcdSPXConfigUnitPESPXPort1=brcdSPXConfigUnitPESPXPort1, brcdSPXGlobalConfigPEState=brcdSPXGlobalConfigPEState, PYSNMP_MODULE_ID=brcdSPXMIB, brcdSPXOperUnitTable=brcdSPXOperUnitTable, brcdSPXPEGroupTable=brcdSPXPEGroupTable, brcdSPXConfigUnitPESPXPort2=brcdSPXConfigUnitPESPXPort2, brcdSPXPEGroupEntry=brcdSPXPEGroupEntry, brcdSPXCBSPXPortPEGroup=brcdSPXCBSPXPortPEGroup, brcdSPXOperUnitRole=brcdSPXOperUnitRole)
