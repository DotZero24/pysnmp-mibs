...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgTable=agPortNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mirrOper=mirrOper, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mirroring=mirroring, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkgroup=trunkgroup, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrPortMirr=mirrPortMirr, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgState=stgNewCfgState, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgState=agPortCurCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoPhyIfType=portInfoPhyIfType, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlans=vlans, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoMode=portInfoMode, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrOperType=mirrOperType, pmNewCfgState=pmNewCfgState, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgBackLink=agPortNewCfgBackLink, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgTimeout=pmCurCfgTimeout, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortConfig=agPortConfig, stgCurCfgTable=stgCurCfgTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, port_stats=port_stats, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsIndx=portStatsIndx, portInfoIndx=portInfoIndx, portInfoLink=portInfoLink, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portmirroring=portmirroring, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgState=pmCurCfgState, stgCurCfgState=stgCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanCurCfgState=vlanCurCfgState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoTableEntry=portInfoTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoFlowCtrl=portInfoFlowCtrl, stgCurCfgIndex=stgCurCfgIndex, portInfoTable=portInfoTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsTable=portStatsTable, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgIndx=agPortNewCfgIndx, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanMaxEnt=vlanMaxEnt, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgStp=agPortNewCfgStp, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgPortName=agPortNewCfgPortName, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgTable=agPortCurCfgTable, mirrOperState=mirrOperState, agPortCurCfgPortName=agPortCurCfgPortName, port_info=port_info, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgState=vlanNewCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuStats=portCpuStats, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgTable=vlanCurCfgTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoSpeed=portInfoSpeed, portStatsTableEntry=portStatsTableEntry, mirrVlanMirr=mirrVlanMirr, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgStg=vlanNewCfgStg)
