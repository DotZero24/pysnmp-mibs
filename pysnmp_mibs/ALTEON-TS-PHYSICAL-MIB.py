...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/nortel/ALTEON-TS-PHYSICAL-MIB
...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", mirrPortMirr=mirrPortMirr, port_info=port_info, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoFlowCtrl=portInfoFlowCtrl, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, portmirroring=portmirroring, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgState=pmCurCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortCurCfgState=agPortCurCfgState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgState=stgCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, port_stats=port_stats, agPortCurCfgPortName=agPortCurCfgPortName, trunkgroup=trunkgroup, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanCurCfgStg=vlanCurCfgStg, portInfoTable=portInfoTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsTableEntry=portStatsTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgRmon=agPortCurCfgRmon, portInfoSpeed=portInfoSpeed, mirrOper=mirrOper, vlanMaxEnt=vlanMaxEnt, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portInfoLink=portInfoLink, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portStatsIndx=portStatsIndx, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgTable=stgCurCfgTable, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, portInfoTableEntry=portInfoTableEntry, portInfoMode=portInfoMode, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgTable=stgNewCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgState=vlanNewCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsTable=portStatsTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortConfig=agPortConfig, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgState=vlanCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgBwmContract=agPortNewCfgBwmContract, mirrOperState=mirrOperState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgState=pmNewCfgState, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOperMonitoringPort=mirrOperMonitoringPort, mirrOperType=mirrOperType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoIndx=portInfoIndx, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgState=stgNewCfgState, mirroring=mirroring, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, mirrOperTimeout=mirrOperTimeout, agPortCurCfgTable=agPortCurCfgTable, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgState=agPortNewCfgState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgIndx=agPortCurCfgIndx, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgIndex=stgNewCfgIndex, agPortNewCfgIndx=agPortNewCfgIndx, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, mirrVlanMirr=mirrVlanMirr, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portCpuStats=portCpuStats, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlans=vlans, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgTable=agPortNewCfgTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoPhyIfType=portInfoPhyIfType, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete)
