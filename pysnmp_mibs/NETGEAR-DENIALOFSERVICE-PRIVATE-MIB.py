# SNMP MIB module (NETGEAR-DENIALOFSERVICE-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-DENIALOFSERVICE-PRIVATE-MIB
...
mibBuilder.exportSymbols(
    "NETGEAR-DENIALOFSERVICE-PRIVATE-MIB",
