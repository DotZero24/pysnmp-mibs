...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-DHCP-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:43:06 2025
...
class _HpnicfDHCPSrvGlobalPoolAllocObject_Type(Integer32):
    """Custom type hpnicfDHCPSrvGlobalPoolAllocObject based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_HpnicfDHCPSrvGlobalPoolAllocObject_Type.__name__ = "Integer32"
_HpnicfDHCPSrvGlobalPoolAllocObject_Object = MibTableColumn
hpnicfDHCPSrvGlobalPoolAllocObject = _HpnicfDHCPSrvGlobalPoolAllocObject_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 101, 2, 3, 1, 10),
    _HpnicfDHCPSrvGlobalPoolAllocObject_Type()
)
hpnicfDHCPSrvGlobalPoolAllocObject.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnicfDHCPSrvGlobalPoolAllocObject.setStatus("current")
...
class _HpnicfDHCPSrvGlbPoolLeaseTimeSec_Type(Integer32):
    """Custom type hpnicfDHCPSrvGlbPoolLeaseTimeSec based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_HpnicfDHCPSrvGlbPoolLeaseTimeSec_Type.__name__ = "Integer32"
_HpnicfDHCPSrvGlbPoolLeaseTimeSec_Object = MibTableColumn
hpnicfDHCPSrvGlbPoolLeaseTimeSec = _HpnicfDHCPSrvGlbPoolLeaseTimeSec_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 101, 2, 4, 1, 19),
    _HpnicfDHCPSrvGlbPoolLeaseTimeSec_Type()
)
hpnicfDHCPSrvGlbPoolLeaseTimeSec.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnicfDHCPSrvGlbPoolLeaseTimeSec.setStatus("current")
if mibBuilder.loadTexts:
    hpnicfDHCPSrvGlbPoolLeaseTimeSec.setUnits("seconds")
_HpnicfDHCPSrvGlbPoolCliGWIPAddr_Type = IpAddress
_HpnicfDHCPSrvGlbPoolCliGWIPAddr_Object = MibTableColumn
hpnicfDHCPSrvGlbPoolCliGWIPAddr = _HpnicfDHCPSrvGlbPoolCliGWIPAddr_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 101, 2, 4, 1, 20),
    _HpnicfDHCPSrvGlbPoolCliGWIPAddr_Type()
)
hpnicfDHCPSrvGlbPoolCliGWIPAddr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnicfDHCPSrvGlbPoolCliGWIPAddr.setStatus("current")
...
_HpnicfDHCPSvrPoolMacOptIndex_Type.__name__ = "Integer32"
...
mibBuilder.exportSymbols(
    ...
    **{"hpnicfDHCPServer": hpnicfDHCPServer,
       ...
       "hpnicfDHCPSrvGlbPoolCliGWIPAddr": hpnicfDHCPSrvGlbPoolCliGWIPAddr,
