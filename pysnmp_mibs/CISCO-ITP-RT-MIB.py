...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ITP-RT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:28:36 2025
...
_CItpRtStateChangeNotifEnabled_Type.__name__ = "TruthValue"
...
cItpRtMIBCompliance.setObjects(
      *(("CISCO-ITP-RT-MIB", "cItpRtScalarGroup"),
        ("CISCO-ITP-RT-MIB", "cItpRouteGroup"))
)
if mibBuilder.loadTexts:
...
cItpRtMIBComplianceRev1.setObjects(
      *(("CISCO-ITP-RT-MIB", "cItpRtScalarGroup"),
        ("CISCO-ITP-RT-MIB", "cItpRouteGroup"),
        ("CISCO-ITP-RT-MIB", "cItpRtNotificationsGroup"),
        ("CISCO-ITP-RT-MIB", "cItpRtScalarGroupRev1"))
)
if mibBuilder.loadTexts:
