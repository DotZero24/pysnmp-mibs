# SNMP MIB module (LJ5500-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hp/LJ5500-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:38:50 2025
...
outbin12 = _Outbin12_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 4, 3, 12)
)
_Outbin12_override_mode_Type = OctetString
_Outbin12_override_mode_Object = MibScalar
outbin12_override_mode = _Outbin12_override_mode_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 4, 3, 12, 9),
    _Outbin12_override_mode_Type()
)
outbin12_override_mode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    outbin12_override_mode.setStatus("optional")
_Outbin12_maximum_binding_Type = Integer32
_Outbin12_maximum_binding_Object = MibScalar
outbin12_maximum_binding = _Outbin12_maximum_binding_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 4, 3, 12, 10),
    _Outbin12_maximum_binding_Type()
)
outbin12_maximum_binding.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    outbin12_maximum_binding.setStatus("optional")
_Outbin12_phd_Type = Integer32
_Outbin12_phd_Object = MibScalar
outbin12_phd = _Outbin12_phd_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 4, 3, 12, 11),
    _Outbin12_phd_Type()
)
outbin12_phd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    outbin12_phd.setStatus("optional")


class _Outbin12_error_info_Type(OctetString):
    """Custom type outbin12_error_info based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Outbin12_error_info_Type.__name__ = "OctetString"
_Outbin12_error_info_Object = MibScalar
outbin12_error_info = _Outbin12_error_info_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 4, 3, 12, 12),
    _Outbin12_error_info_Type()
)
outbin12_error_info.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    outbin12_error_info.setStatus("optional")
...
class _Consumable_status_page_count_quarter_speed_Type(Integer32):
    """Custom type consumable_status_page_count_quarter_speed based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_page_count_quarter_speed_Type.__name__ = "Integer32"
_Consumable_status_page_count_quarter_speed_Object = MibScalar
consumable_status_page_count_quarter_speed = _Consumable_status_page_count_quarter_speed_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 33),
    _Consumable_status_page_count_quarter_speed_Type()
)
consumable_status_page_count_quarter_speed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_page_count_quarter_speed.setStatus("optional")


class _Consumable_status_page_count_third_speed_Type(Integer32):
    """Custom type consumable_status_page_count_third_speed based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_page_count_third_speed_Type.__name__ = "Integer32"
_Consumable_status_page_count_third_speed_Object = MibScalar
consumable_status_page_count_third_speed = _Consumable_status_page_count_third_speed_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 34),
    _Consumable_status_page_count_third_speed_Type()
)
consumable_status_page_count_third_speed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_page_count_third_speed.setStatus("optional")
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "outbin12": outbin12,
       "outbin12-override-mode": outbin12_override_mode,
       "outbin12-maximum-binding": outbin12_maximum_binding,
       "outbin12-phd": outbin12_phd,
       "outbin12-error-info": outbin12_error_info,
       ...
       "consumable-status-page-count-quarter-speed": consumable_status_page_count_quarter_speed,
       "consumable-status-page-count-third-speed": consumable_status_page_count_third_speed,
