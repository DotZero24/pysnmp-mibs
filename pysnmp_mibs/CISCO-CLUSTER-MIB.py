...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CLUSTER-MIB
...
_CcStatusTimeOfLastChange_Type.__name__ = "TimeStamp"
...
class _CcStatusMemberOrder_Type(SnmpAdminString):
    """Custom type ccStatusMemberOrder based on SnmpAdminString"""
    defaultValue = OctetString("")


_CcStatusMemberOrder_Type.__name__ = "SnmpAdminString"
...
ciscoClusterCompliance.setObjects(
      *(("CISCO-CLUSTER-MIB", "ciscoClusterStatusGroup"),
        ("CISCO-CLUSTER-MIB", "ciscoClusterMemberStatusGroup"),
        ("CISCO-CLUSTER-MIB", "ciscoClusterMemberGroup"),
        ("CISCO-CLUSTER-MIB", "ciscoClusterCandidateGroup"))
)
if mibBuilder.loadTexts:
...
ciscoClusterComplianceRev1.setObjects(
      *(("CISCO-CLUSTER-MIB", "ciscoClusterStatusGroup"),
        ("CISCO-CLUSTER-MIB", "ciscoClusterMemberStatusGroup"),
        ("CISCO-CLUSTER-MIB", "ciscoClusterMemberGroup"),
        ("CISCO-CLUSTER-MIB", "ciscoClusterCandidateGroup"),
        ("CISCO-CLUSTER-MIB", "ciscoClusterNotificationGroup"))
)
if mibBuilder.loadTexts:
