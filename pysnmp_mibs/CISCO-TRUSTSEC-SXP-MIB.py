...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-TRUSTSEC-SXP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:25:05 2025
...
(CtsPassword,
 ...
 CtsSecurityGroupTag,
 CtsSxpConnectionStatus) = mibBuilder.importSymbols(
...
_CtsxSxpConnSourceAddrType_Type.__name__ = "InetAddressType"
...
class _CtsxSxpConnSourceAddr_Type(InetAddress):
    """Custom type ctsxSxpConnSourceAddr based on InetAddress"""
    defaultValue = OctetString("")


_CtsxSxpConnSourceAddr_Type.__name__ = "InetAddress"
...
_CtsxSxpConnConfigPasswordType_Type.__name__ = "CtsPasswordEncryptionType"
...
class _CtsxSxpConnConfigPassword_Type(CtsPassword):
    """Custom type ctsxSxpConnConfigPassword based on CtsPassword"""
    defaultValue = OctetString("")


_CtsxSxpConnConfigPassword_Type.__name__ = "CtsPassword"
...
_CtsxSxpConnStatus_Type = CtsSxpConnectionStatus
...
_CtsxSxpConnStorageType_Type.__name__ = "StorageType"
...
_CtsxSxpConnBiDirListenerStatus_Type = CtsSxpConnectionStatus
_CtsxSxpConnBiDirListenerStatus_Object = MibTableColumn
ctsxSxpConnBiDirListenerStatus = _CtsxSxpConnBiDirListenerStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 720, 1, 2, 1, 1, 27),
    _CtsxSxpConnBiDirListenerStatus_Type()
)
ctsxSxpConnBiDirListenerStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ctsxSxpConnBiDirListenerStatus.setStatus("current")
_CtsxSxpConnBiDirListenerHoldTime_Type = Unsigned32
_CtsxSxpConnBiDirListenerHoldTime_Object = MibTableColumn
ctsxSxpConnBiDirListenerHoldTime = _CtsxSxpConnBiDirListenerHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 720, 1, 2, 1, 1, 28),
    _CtsxSxpConnBiDirListenerHoldTime_Type()
)
ctsxSxpConnBiDirListenerHoldTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ctsxSxpConnBiDirListenerHoldTime.setStatus("current")
if mibBuilder.loadTexts:
    ctsxSxpConnBiDirListenerHoldTime.setUnits("seconds")
...
ctsxBiDirectionalSxpGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 720, 2, 2, 17)
)
ctsxBiDirectionalSxpGroup.setObjects(
      *(("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpConnBiDirListenerStatus"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpConnBiDirListenerHoldTime"))
)
if mibBuilder.loadTexts:
    ctsxBiDirectionalSxpGroup.setStatus("current")
...
ciscoTrustSecSxpMIBCompliance.setObjects(
      *(("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpGlobalGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpConnectionGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxIpSgtMappingGroup"))
)
if mibBuilder.loadTexts:
...
ciscoTrustSecSxpMIBCompliance2.setObjects(
      *(("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpGlobalGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpConnectionGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxIpSgtMappingGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpVersionGroup"))
)
if mibBuilder.loadTexts:
...
ciscoTrustSecSxpMIBCompliance3.setObjects(
      *(("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpGlobalGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpConnectionGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpVersionGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpBindingLogGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpBindingNotifInfoGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpNodeIdInfoGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxIpSgtMappingGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpSgtMapGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxNotifsControlGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxNotifsGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpNotifErrMsgGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpGlobalHoldTimeGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpConnHoldTimeGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpConnCapbilityGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpVersionSupportGroup"),
...
ciscoTrustSecSxpMIBCompliance4 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 720, 2, 1, 4)
)
ciscoTrustSecSxpMIBCompliance4.setObjects(
      *(("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpGlobalGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpConnectionGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpVersionGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpBindingLogGroup"),
        ...
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSxpVersionSupportGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxSgtMapPeerSeqGroup"),
        ("CISCO-TRUSTSEC-SXP-MIB", "ctsxBiDirectionalSxpGroup"))
)
if mibBuilder.loadTexts:
    ciscoTrustSecSxpMIBCompliance4.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoTrustSecSxpMIB": ciscoTrustSecSxpMIB,
       ...
       "ctsxSxpConnBiDirListenerHoldTime": ctsxSxpConnBiDirListenerHoldTime,
       ...
       "ciscoTrustSecSxpMIBCompliance4": ciscoTrustSecSxpMIBCompliance4,
       ...
       "ctsxBiDirectionalSxpGroup": ctsxBiDirectionalSxpGroup}
)
