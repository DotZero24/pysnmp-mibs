...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DLSW-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:53 2025
...
_CiscoDlswVirtualSegmentLFSize_Type.__name__ = "LFSize"
...
_CiscoDlswTConnConfigAdvertiseMacNB_Type.__name__ = "TruthValue"
...
_CiscoDlswDirMacMask_Type.__name__ = "MacAddress"
...
_CiscoDlswDirMacLFSize_Type.__name__ = "LFSize"
...
_CiscoDlswDirNBLFSize_Type.__name__ = "LFSize"
...
_CiscoDlswSdlcLsRemoteMac_Type.__name__ = "MacAddress"
...
ciscoDlswCoreCompliance.setObjects(
      *(("CISCO-DLSW-MIB", "ciscoDlswNodeGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswTConnStatGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswTConnConfigGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswTConnOperGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswTConnTcpConfigGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswTConnTcpOperGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswInterfaceGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswCircuitStatGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswCircuitGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDlswDirCompliance.setObjects(
      *(("CISCO-DLSW-MIB", "ciscoDlswDirGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswDirNBGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDlswDirLocateCompliance.setObjects(
      *(("CISCO-DLSW-MIB", "ciscoDlswDirLocateGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswDirLocateNBGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDlswSdlcCompliance.setObjects(
    ("CISCO-DLSW-MIB", "ciscoDlswSdlcGroup")
)
if mibBuilder.loadTexts:
...
ciscoDlswCoreComplianceV11R01.setObjects(
      *(("CISCO-DLSW-MIB", "ciscoDlswNodeGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswTConnStatGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswTConnConfigGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswTConnOperGroup"),
        ...
        ("CISCO-DLSW-MIB", "ciscoDlswCircuitStatGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswCircuitGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswNodeNBGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswTConnNBGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDlswDirComplianceV11R01.setObjects(
      *(("CISCO-DLSW-MIB", "ciscoDlswDirGroup"),
        ("CISCO-DLSW-MIB", "ciscoDlswDirNBGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDlswSdlcComplianceV11R01.setObjects(
    ("CISCO-DLSW-MIB", "ciscoDlswSdlcGroup")
)
if mibBuilder.loadTexts:
