...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-DLSW-MIB
...
RowStatus, TextualConvention, InstancePointer, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "InstancePointer", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-DLSW-MIB", ciscoDlswVersion=ciscoDlswVersion, ciscoDlswDirNBNameType=ciscoDlswDirNBNameType, ciscoDlswTrapCircuitUp=ciscoDlswTrapCircuitUp, ciscoDlswCircuitFCRecvGrantedUnits=ciscoDlswCircuitFCRecvGrantedUnits, ciscoDlswCircuitFCHalveWndwRcvds=ciscoDlswCircuitFCHalveWndwRcvds, ciscoDlswTrapTConnProtViolation=ciscoDlswTrapTConnProtViolation, ciscoDlswTConnConfigIndex=ciscoDlswTConnConfigIndex, ciscoDlswTConnConfigEntry=ciscoDlswTConnConfigEntry, ciscoDlswCircuitTable=ciscoDlswCircuitTable, TAddress=TAddress, ciscoDlswDirLocate=ciscoDlswDirLocate, ciscoDlswTConnConfigLastModifyTime=ciscoDlswTConnConfigLastModifyTime, ciscoDlswTConnOperPartnerNBInfo=ciscoDlswTConnOperPartnerNBInfo, ciscoDlswDirNBEntries=ciscoDlswDirNBEntries, ciscoDlswDirLocateNBName=ciscoDlswDirLocateNBName, EndStationLocation=EndStationLocation, ciscoDlswTConnStatCloseBusys=ciscoDlswTConnStatCloseBusys, ciscoDlswTConnOperPartnerVersion=ciscoDlswTConnOperPartnerVersion, ciscoDlswTConnTcpConfigKeepAliveInt=ciscoDlswTConnTcpConfigKeepAliveInt, ciscoDlswResourceNBExclusivity=ciscoDlswResourceNBExclusivity, ciscoDlswTConnOperPartnerSapList=ciscoDlswTConnOperPartnerSapList, ciscoDlswCircuitPriority=ciscoDlswCircuitPriority, ciscoDlswTConnOperCURexSents=ciscoDlswTConnOperCURexSents, ciscoDlswTrapCntlTConnPartnerReject=ciscoDlswTrapCntlTConnPartnerReject, ciscoDlswGroups=ciscoDlswGroups, ciscoDlswCircuitOrigin=ciscoDlswCircuitOrigin, ciscoDlswDirMacCacheHits=ciscoDlswDirMacCacheHits, ciscoDlswDirLocateMacMac=ciscoDlswDirLocateMacMac, ciscoDlswTrapTConnUp=ciscoDlswTrapTConnUp, ciscoDlswCircuitFCRecvCurrentWndw=ciscoDlswCircuitFCRecvCurrentWndw, ciscoDlswTConnTcpConfigTcpConnections=ciscoDlswTConnTcpConfigTcpConnections, ciscoDlswCircuitS2TAddress=ciscoDlswCircuitS2TAddress, ciscoDlswTrapCntlTConnProtViolation=ciscoDlswTrapCntlTConnProtViolation, ciscoDlswTConnOperDiscActiveCir=ciscoDlswTConnOperDiscActiveCir, ciscoDlswIfRowStatus=ciscoDlswIfRowStatus, ciscoDlswCoreComplianceV11R01=ciscoDlswCoreComplianceV11R01, ciscoDlswTConnStatGroup=ciscoDlswTConnStatGroup, ciscoDlswTConnTcp=ciscoDlswTConnTcp, ciscoDlswSdlcGroup=ciscoDlswSdlcGroup, ciscoDlswCircuitS1Dlc=ciscoDlswCircuitS1Dlc, ciscoDlswCircuitStatGroup=ciscoDlswCircuitStatGroup, ciscoDlswTConnTcpOperEntry=ciscoDlswTConnTcpOperEntry, ciscoDlswSdlcLsRemoteSap=ciscoDlswSdlcLsRemoteSap, ciscoDlswCircuitDiscReasonRemoteData=ciscoDlswCircuitDiscReasonRemoteData, ciscoDlswDirMacStatus=ciscoDlswDirMacStatus, ciscoDlswTrapTConnDown=ciscoDlswTrapTConnDown, ciscoDlswDirMacLocation=ciscoDlswDirMacLocation, ciscoDlswSdlcLsEntry=ciscoDlswSdlcLsEntry, ciscoDlswTConnTcpOperTcpConnections=ciscoDlswTConnTcpOperTcpConnections, ciscoDlswTConnOperNRexSents=ciscoDlswTConnOperNRexSents, ciscoDlswCircuitS2Mac=ciscoDlswCircuitS2Mac, ciscoDlswCircuitS1Sap=ciscoDlswCircuitS1Sap, ciscoDlswResourceMacExclusivity=ciscoDlswResourceMacExclusivity, ciscoDlswDirNBEntry=ciscoDlswDirNBEntry, ciscoDlswTConnOperPartnerMacInfo=ciscoDlswTConnOperPartnerMacInfo, ciscoDlswTConnTcpConfigTable=ciscoDlswTConnTcpConfigTable, ciscoDlswTConnConfigTable=ciscoDlswTConnConfigTable, ciscoDlswCircuitS2CircuitId=ciscoDlswCircuitS2CircuitId, ciscoDlswDirMacLocationType=ciscoDlswDirMacLocationType, LFSize=LFSize, ciscoDlswStdPacingSupport=ciscoDlswStdPacingSupport, ciscoDlswTConnConfigInitCirRecvWndw=ciscoDlswTConnConfigInitCirRecvWndw, ciscoDlswDirNBStatus=ciscoDlswDirNBStatus, ciscoDlswTConnOperDiscReason=ciscoDlswTConnOperDiscReason, ciscoDlswTConnTcpConfigEntry=ciscoDlswTConnTcpConfigEntry, ciscoDlswSdlcLsLocalSap=ciscoDlswSdlcLsLocalSap, ciscoDlswDirLocateNBLocation=ciscoDlswDirLocateNBLocation, ciscoDlswMIBObjects=ciscoDlswMIBObjects, ciscoDlswTConnOperCirCreates=ciscoDlswTConnOperCirCreates, ciscoDlswVersionString=ciscoDlswVersionString, ciscoDlswDirectory=ciscoDlswDirectory, ciscoDlswTConnStat=ciscoDlswTConnStat, ciscoDlswTConnConfigGroupDefinition=ciscoDlswTConnConfigGroupDefinition, ciscoDlswTConnConfigAdvertiseMacNB=ciscoDlswTConnConfigAdvertiseMacNB, ciscoDlswTConnOperPartnerInitPacingWndw=ciscoDlswTConnOperPartnerInitPacingWndw, ciscoDlswTConnOperNQexSents=ciscoDlswTConnOperNQexSents, ciscoDlswDirMacEntryType=ciscoDlswDirMacEntryType, ciscoDlswDirLocateNBMatch=ciscoDlswDirLocateNBMatch, ciscoDlswTConnOperGroup=ciscoDlswTConnOperGroup, ciscoDlswTrapControl=ciscoDlswTrapControl, ciscoDlswTConnOperPartnerMacExcl=ciscoDlswTConnOperPartnerMacExcl, ciscoDlswActiveCircuits=ciscoDlswActiveCircuits, ciscoDlswTConnConfigOpens=ciscoDlswTConnConfigOpens, ciscoDlswTConnOperEntry=ciscoDlswTConnOperEntry, ciscoDlswTConnNBGroup=ciscoDlswTConnNBGroup, ciscoDlswCircuitCreates=ciscoDlswCircuitCreates, ciscoDlswTConnOperState=ciscoDlswTConnOperState, ciscoDlswCircuitGroup=ciscoDlswCircuitGroup, ciscoDlswStatus=ciscoDlswStatus, ciscoDlswTConnConfigSapList=ciscoDlswTConnConfigSapList, ciscoDlswTConnOperLocalTAddr=ciscoDlswTConnOperLocalTAddr, ciscoDlswTConnOperInCntlPkts=ciscoDlswTConnOperInCntlPkts, ciscoDlswTConnOperDiscTime=ciscoDlswTConnOperDiscTime, ciscoDlswDirStat=ciscoDlswDirStat, ciscoDlswCircuitState=ciscoDlswCircuitState, ciscoDlswDirNBIndex=ciscoDlswDirNBIndex, ciscoDlswDirLocateMacEntry=ciscoDlswDirLocateMacEntry, ciscoDlswCircuitFCHalveWndwSents=ciscoDlswCircuitFCHalveWndwSents, ciscoDlswSdlcLsLocalMac=ciscoDlswSdlcLsLocalMac, MacAddress=MacAddress, ciscoDlswDirLocateMacLocation=ciscoDlswDirLocateMacLocation, ciscoDlswTConnConfigGroup=ciscoDlswTConnConfigGroup, ciscoDlswInterface=ciscoDlswInterface, ciscoDlswDirLocateNBGroup=ciscoDlswDirLocateNBGroup, ciscoDlswTConnOperInDataPkts=ciscoDlswTConnOperInDataPkts, ciscoDlswDomains=ciscoDlswDomains, ciscoDlswCircuitFCResetOpRcvds=ciscoDlswCircuitFCResetOpRcvds, ciscoDlswDirMacEntry=ciscoDlswDirMacEntry, ciscoDlswDirCompliance=ciscoDlswDirCompliance, ciscoDlswTConnTcpConfigGroup=ciscoDlswTConnTcpConfigGroup, ciscoDlswInterfaceGroup=ciscoDlswInterfaceGroup, ciscoDlswDirLocateCompliance=ciscoDlswDirLocateCompliance, ciscoDlswDirMacMac=ciscoDlswDirMacMac, DlcType=DlcType, ciscoDlswCircuitS1Mac=ciscoDlswCircuitS1Mac, ciscoDlswTConnOperTable=ciscoDlswTConnOperTable, ciscoDlswTConnOperOutDataPkts=ciscoDlswTConnOperOutDataPkts, ciscoDlswCircuitFCLargestRecvGranted=ciscoDlswCircuitFCLargestRecvGranted, ciscoDlswTConnOperICRexRcvds=ciscoDlswTConnOperICRexRcvds, ciscoDlswCircuitFCLargestSendGranted=ciscoDlswCircuitFCLargestSendGranted, ciscoDlswDirGroup=ciscoDlswDirGroup, ciscoDlswDirNBRowStatus=ciscoDlswDirNBRowStatus, ciscoDlswDirLocateNBEntry=ciscoDlswDirLocateNBEntry, ciscoDlswConformance=ciscoDlswConformance, ciscoDlswTConnOperCURexRcvds=ciscoDlswTConnOperCURexRcvds, ciscoDlswTConnOperNQexRcvds=ciscoDlswTConnOperNQexRcvds, ciscoDlswTrapCntlTConn=ciscoDlswTrapCntlTConn, ciscoDlswNodeGroup=ciscoDlswNodeGroup, ciscoDlswVirtualSegmentLFSize=ciscoDlswVirtualSegmentLFSize, ciscoDlswTraps=ciscoDlswTraps, ciscoDlswCircuitFCSendCurrentWndw=ciscoDlswCircuitFCSendCurrentWndw, ciscoDlswDirNBCacheHits=ciscoDlswDirNBCacheHits, ciscoDlswTConnOperTDomain=ciscoDlswTConnOperTDomain, ciscoDlswDirNBCacheMisses=ciscoDlswDirNBCacheMisses, ciscoDlswTConnStatCloseIdles=ciscoDlswTConnStatCloseIdles, ciscoDlswDirNBEntryType=ciscoDlswDirNBEntryType, ciscoDlswTConnTcpConfigMaxSegmentSize=ciscoDlswTConnTcpConfigMaxSegmentSize, ciscoDlswDirMacLFSize=ciscoDlswDirMacLFSize, ciscoDlswMIB=ciscoDlswMIB, ciscoDlswTConnConfigSetupType=ciscoDlswTConnConfigSetupType, ciscoDlswIfEntry=ciscoDlswIfEntry, ciscoDlswTConnOperPartnerNBExcl=ciscoDlswTConnOperPartnerNBExcl, ciscoDlswSdlc=ciscoDlswSdlc, ciscoDlswSdlcLsTable=ciscoDlswSdlcLsTable, ciscoDlswTConnConfigLocalTAddr=ciscoDlswTConnConfigLocalTAddr, ciscoDlswTCPDomain=ciscoDlswTCPDomain, ciscoDlswDirNBTable=ciscoDlswDirNBTable, ciscoDlswCircuitDiscReasonLocal=ciscoDlswCircuitDiscReasonLocal, ciscoDlswTrapTConnPartnerReject=ciscoDlswTrapTConnPartnerReject, ciscoDlswDirMacCacheMisses=ciscoDlswDirMacCacheMisses, ciscoDlswTConnConfigEntryType=ciscoDlswTConnConfigEntryType, ciscoDlswTConnOperCircuits=ciscoDlswTConnOperCircuits, ciscoDlswDirNBGroup=ciscoDlswDirNBGroup, ciscoDlswDirLocateMacMatch=ciscoDlswDirLocateMacMatch, ciscoDlswTConnOperICRexSents=ciscoDlswTConnOperICRexSents, ciscoDlswCircuitS2Sap=ciscoDlswCircuitS2Sap, ciscoDlswTConnOperEntryTime=ciscoDlswTConnOperEntryTime, ciscoDlswCompliances=ciscoDlswCompliances, ciscoDlswNodeNBGroup=ciscoDlswNodeNBGroup, ciscoDlswSdlcLsLocalBlockNum=ciscoDlswSdlcLsLocalBlockNum, ciscoDlswCircuitS1RouteInfo=ciscoDlswCircuitS1RouteInfo, ciscoDlswCircuitStateTime=ciscoDlswCircuitStateTime, ciscoDlswSdlcLsLocalIdNum=ciscoDlswSdlcLsLocalIdNum, ciscoDlswDirLocateGroup=ciscoDlswDirLocateGroup, ciscoDlswTConnOperConnectTime=ciscoDlswTConnOperConnectTime, ciscoDlswTConnOperConfigIndex=ciscoDlswTConnOperConfigIndex, ciscoDlswTrapCntlCircuit=ciscoDlswTrapCntlCircuit, ciscoDlswCircuitFCSendGrantedUnits=ciscoDlswCircuitFCSendGrantedUnits, ciscoDlswIfTable=ciscoDlswIfTable, ciscoDlswTConnTcpOperGroup=ciscoDlswTConnTcpOperGroup, ciscoDlswSdlcLsRowStatus=ciscoDlswSdlcLsRowStatus, ciscoDlswTConnOperPartnerVersionStr=ciscoDlswTConnOperPartnerVersionStr, ciscoDlswCircuitFCResetOpSents=ciscoDlswCircuitFCResetOpSents, ciscoDlswDirComplianceV11R01=ciscoDlswDirComplianceV11R01, ciscoDlswTConnOperRemoteTAddr=ciscoDlswTConnOperRemoteTAddr, ciscoDlswDirNBName=ciscoDlswDirNBName, ciscoDlswDirMacRowStatus=ciscoDlswDirMacRowStatus, ciscoDlswTConnOperOutDataOctets=ciscoDlswTConnOperOutDataOctets, ciscoDlswDirLocateNBTable=ciscoDlswDirLocateNBTable, ciscoDlswCircuitStat=ciscoDlswCircuitStat, ciscoDlswDirMacMask=ciscoDlswDirMacMask, ciscoDlswCircuitS1IfIndex=ciscoDlswCircuitS1IfIndex, ciscoDlswCoreCompliance=ciscoDlswCoreCompliance, ciscoDlswTConnOperOutCntlPkts=ciscoDlswTConnOperOutCntlPkts, ciscoDlswIfVirtualSegment=ciscoDlswIfVirtualSegment, ciscoDlswCircuitS2TDomain=ciscoDlswCircuitS2TDomain, NBName=NBName, ciscoDlswCircuit=ciscoDlswCircuit, ciscoDlswCircuitDiscReasonRemote=ciscoDlswCircuitDiscReasonRemote, ciscoDlswTConnTcpOperPrefTcpConnections=ciscoDlswTConnTcpOperPrefTcpConnections, ciscoDlswDirCache=ciscoDlswDirCache, ciscoDlswVendorID=ciscoDlswVendorID, ciscoDlswDirNBLocation=ciscoDlswDirNBLocation, ciscoDlswCircuitEntry=ciscoDlswCircuitEntry, ciscoDlswSdlcLsEntries=ciscoDlswSdlcLsEntries, ciscoDlswCircuitS2Location=ciscoDlswCircuitS2Location, ciscoDlswSdlcLsRemoteMac=ciscoDlswSdlcLsRemoteMac, DlswTimeStamp=DlswTimeStamp, ciscoDlswTConnConfigRowStatus=ciscoDlswTConnConfigRowStatus, ciscoDlswTConnConfigRemoteTAddr=ciscoDlswTConnConfigRemoteTAddr, ciscoDlswCircuitS1CircuitId=ciscoDlswCircuitS1CircuitId, PYSNMP_MODULE_ID=ciscoDlswMIB, ciscoDlswSdlcCompliance=ciscoDlswSdlcCompliance, ciscoDlswTConnOperFlowCntlMode=ciscoDlswTConnOperFlowCntlMode, ciscoDlswTConnOperNRexRcvds=ciscoDlswTConnOperNRexRcvds, ciscoDlswTConnStatActiveConnections=ciscoDlswTConnStatActiveConnections, ciscoDlswTConnTcpOperKeepAliveInt=ciscoDlswTConnTcpOperKeepAliveInt, ciscoDlswTConnOperPartnerVendorID=ciscoDlswTConnOperPartnerVendorID, ciscoDlswCircuitEntryTime=ciscoDlswCircuitEntryTime, ciscoDlswDirMacEntries=ciscoDlswDirMacEntries, ciscoDlswSdlcComplianceV11R01=ciscoDlswSdlcComplianceV11R01, ciscoDlswDirNBLocationType=ciscoDlswDirNBLocationType, ciscoDlswTConnTcpOperTable=ciscoDlswTConnTcpOperTable, ciscoDlswDirLocateMacTable=ciscoDlswDirLocateMacTable, ciscoDlswCircuitS1DlcType=ciscoDlswCircuitS1DlcType, ciscoDlswNode=ciscoDlswNode, ciscoDlswTConnSpecific=ciscoDlswTConnSpecific, ciscoDlswTrapCircuitDown=ciscoDlswTrapCircuitDown, ciscoDlswUpTime=ciscoDlswUpTime, ciscoDlswTConnConfigTDomain=ciscoDlswTConnConfigTDomain, ciscoDlswIfSapList=ciscoDlswIfSapList, ciscoDlswDirMacTable=ciscoDlswDirMacTable, ciscoDlswDirNBLFSize=ciscoDlswDirNBLFSize, ciscoDlswTConn=ciscoDlswTConn, ciscoDlswDirMacIndex=ciscoDlswDirMacIndex, ciscoDlswTConnOperInDataOctets=ciscoDlswTConnOperInDataOctets)
