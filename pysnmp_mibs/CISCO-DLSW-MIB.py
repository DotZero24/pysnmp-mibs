...
DisplayString, RowStatus, InstancePointer, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "InstancePointer", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-DLSW-MIB", EndStationLocation=EndStationLocation, ciscoDlswTConnConfigTDomain=ciscoDlswTConnConfigTDomain, ciscoDlswCircuitS1Dlc=ciscoDlswCircuitS1Dlc, ciscoDlswDirLocateNBMatch=ciscoDlswDirLocateNBMatch, ciscoDlswTConnConfigTable=ciscoDlswTConnConfigTable, ciscoDlswDirNBStatus=ciscoDlswDirNBStatus, ciscoDlswDirMacCacheMisses=ciscoDlswDirMacCacheMisses, ciscoDlswTConnTcpOperGroup=ciscoDlswTConnTcpOperGroup, ciscoDlswDirNBNameType=ciscoDlswDirNBNameType, ciscoDlswDirLocateMacTable=ciscoDlswDirLocateMacTable, ciscoDlswTConnOperDiscReason=ciscoDlswTConnOperDiscReason, ciscoDlswDirMacCacheHits=ciscoDlswDirMacCacheHits, ciscoDlswCircuitS2CircuitId=ciscoDlswCircuitS2CircuitId, ciscoDlswTConnConfigEntry=ciscoDlswTConnConfigEntry, ciscoDlswTConnOperState=ciscoDlswTConnOperState, ciscoDlswTConnOperDiscActiveCir=ciscoDlswTConnOperDiscActiveCir, ciscoDlswCircuitFCResetOpRcvds=ciscoDlswCircuitFCResetOpRcvds, ciscoDlswTConnOperNQexSents=ciscoDlswTConnOperNQexSents, ciscoDlswSdlcLsRemoteSap=ciscoDlswSdlcLsRemoteSap, ciscoDlswSdlcGroup=ciscoDlswSdlcGroup, ciscoDlswDirNBGroup=ciscoDlswDirNBGroup, ciscoDlswTConnTcpConfigGroup=ciscoDlswTConnTcpConfigGroup, ciscoDlswTConnOperLocalTAddr=ciscoDlswTConnOperLocalTAddr, ciscoDlswTConnOperCircuits=ciscoDlswTConnOperCircuits, ciscoDlswSdlcLsTable=ciscoDlswSdlcLsTable, LFSize=LFSize, ciscoDlswSdlcLsLocalSap=ciscoDlswSdlcLsLocalSap, ciscoDlswVirtualSegmentLFSize=ciscoDlswVirtualSegmentLFSize, MacAddress=MacAddress, ciscoDlswSdlcLsRowStatus=ciscoDlswSdlcLsRowStatus, ciscoDlswTConnOperEntry=ciscoDlswTConnOperEntry, ciscoDlswTConnOperPartnerMacExcl=ciscoDlswTConnOperPartnerMacExcl, ciscoDlswTConnOperTable=ciscoDlswTConnOperTable, ciscoDlswDirNBRowStatus=ciscoDlswDirNBRowStatus, ciscoDlswIfSapList=ciscoDlswIfSapList, ciscoDlswActiveCircuits=ciscoDlswActiveCircuits, ciscoDlswDirLocate=ciscoDlswDirLocate, ciscoDlswCircuitFCSendGrantedUnits=ciscoDlswCircuitFCSendGrantedUnits, ciscoDlswTConnOperConfigIndex=ciscoDlswTConnOperConfigIndex, ciscoDlswTConnOperGroup=ciscoDlswTConnOperGroup, ciscoDlswCircuitCreates=ciscoDlswCircuitCreates, ciscoDlswTConnConfigEntryType=ciscoDlswTConnConfigEntryType, ciscoDlswDirLocateMacMac=ciscoDlswDirLocateMacMac, ciscoDlswTConnOperNRexRcvds=ciscoDlswTConnOperNRexRcvds, ciscoDlswTConnOperOutCntlPkts=ciscoDlswTConnOperOutCntlPkts, ciscoDlswSdlcLsLocalBlockNum=ciscoDlswSdlcLsLocalBlockNum, ciscoDlswTConnOperInDataPkts=ciscoDlswTConnOperInDataPkts, ciscoDlswTConnOperCURexSents=ciscoDlswTConnOperCURexSents, ciscoDlswCircuitFCLargestSendGranted=ciscoDlswCircuitFCLargestSendGranted, ciscoDlswNodeNBGroup=ciscoDlswNodeNBGroup, ciscoDlswTConnConfigOpens=ciscoDlswTConnConfigOpens, ciscoDlswCircuitStat=ciscoDlswCircuitStat, ciscoDlswDirLocateCompliance=ciscoDlswDirLocateCompliance, ciscoDlswNodeGroup=ciscoDlswNodeGroup, ciscoDlswCircuitGroup=ciscoDlswCircuitGroup, ciscoDlswTrapControl=ciscoDlswTrapControl, ciscoDlswTConnOperRemoteTAddr=ciscoDlswTConnOperRemoteTAddr, ciscoDlswCircuitDiscReasonLocal=ciscoDlswCircuitDiscReasonLocal, ciscoDlswDirMacStatus=ciscoDlswDirMacStatus, ciscoDlswTrapTConnProtViolation=ciscoDlswTrapTConnProtViolation, ciscoDlswTConnOperICRexRcvds=ciscoDlswTConnOperICRexRcvds, ciscoDlswCircuitS1IfIndex=ciscoDlswCircuitS1IfIndex, ciscoDlswCoreComplianceV11R01=ciscoDlswCoreComplianceV11R01, ciscoDlswDirLocateNBLocation=ciscoDlswDirLocateNBLocation, ciscoDlswCoreCompliance=ciscoDlswCoreCompliance, ciscoDlswTConn=ciscoDlswTConn, ciscoDlswMIB=ciscoDlswMIB, ciscoDlswCircuitState=ciscoDlswCircuitState, ciscoDlswDirCompliance=ciscoDlswDirCompliance, ciscoDlswTrapCircuitUp=ciscoDlswTrapCircuitUp, ciscoDlswCircuitS1CircuitId=ciscoDlswCircuitS1CircuitId, ciscoDlswCircuitTable=ciscoDlswCircuitTable, ciscoDlswDirectory=ciscoDlswDirectory, ciscoDlswCircuitFCHalveWndwRcvds=ciscoDlswCircuitFCHalveWndwRcvds, ciscoDlswTConnTcpOperTable=ciscoDlswTConnTcpOperTable, ciscoDlswResourceMacExclusivity=ciscoDlswResourceMacExclusivity, NBName=NBName, ciscoDlswDirNBEntryType=ciscoDlswDirNBEntryType, ciscoDlswDirNBEntry=ciscoDlswDirNBEntry, ciscoDlswDirLocateMacMatch=ciscoDlswDirLocateMacMatch, ciscoDlswTConnStatGroup=ciscoDlswTConnStatGroup, ciscoDlswCircuitStateTime=ciscoDlswCircuitStateTime, ciscoDlswCircuitFCHalveWndwSents=ciscoDlswCircuitFCHalveWndwSents, ciscoDlswGroups=ciscoDlswGroups, ciscoDlswDirCache=ciscoDlswDirCache, ciscoDlswSdlcLsEntry=ciscoDlswSdlcLsEntry, ciscoDlswTrapCntlCircuit=ciscoDlswTrapCntlCircuit, ciscoDlswTConnOperICRexSents=ciscoDlswTConnOperICRexSents, ciscoDlswDirLocateMacLocation=ciscoDlswDirLocateMacLocation, ciscoDlswCircuitFCRecvGrantedUnits=ciscoDlswCircuitFCRecvGrantedUnits, ciscoDlswDirNBLocationType=ciscoDlswDirNBLocationType, PYSNMP_MODULE_ID=ciscoDlswMIB, ciscoDlswTrapCntlTConn=ciscoDlswTrapCntlTConn, ciscoDlswTConnTcpConfigKeepAliveInt=ciscoDlswTConnTcpConfigKeepAliveInt, ciscoDlswTConnNBGroup=ciscoDlswTConnNBGroup, ciscoDlswTConnTcpConfigEntry=ciscoDlswTConnTcpConfigEntry, ciscoDlswTConnConfigLastModifyTime=ciscoDlswTConnConfigLastModifyTime, ciscoDlswUpTime=ciscoDlswUpTime, ciscoDlswTConnTcpConfigTcpConnections=ciscoDlswTConnTcpConfigTcpConnections, ciscoDlswDirMacLocation=ciscoDlswDirMacLocation, ciscoDlswDirNBTable=ciscoDlswDirNBTable, ciscoDlswIfEntry=ciscoDlswIfEntry, ciscoDlswTConnOperPartnerVersion=ciscoDlswTConnOperPartnerVersion, ciscoDlswResourceNBExclusivity=ciscoDlswResourceNBExclusivity, ciscoDlswTCPDomain=ciscoDlswTCPDomain, ciscoDlswSdlcLsLocalIdNum=ciscoDlswSdlcLsLocalIdNum, ciscoDlswTrapCircuitDown=ciscoDlswTrapCircuitDown, ciscoDlswConformance=ciscoDlswConformance, ciscoDlswTConnOperEntryTime=ciscoDlswTConnOperEntryTime, ciscoDlswTrapTConnPartnerReject=ciscoDlswTrapTConnPartnerReject, ciscoDlswDirMacTable=ciscoDlswDirMacTable, ciscoDlswDirNBLocation=ciscoDlswDirNBLocation, ciscoDlswDirLocateMacEntry=ciscoDlswDirLocateMacEntry, ciscoDlswDirGroup=ciscoDlswDirGroup, ciscoDlswTConnOperTDomain=ciscoDlswTConnOperTDomain, ciscoDlswCircuitEntry=ciscoDlswCircuitEntry, ciscoDlswCircuitStatGroup=ciscoDlswCircuitStatGroup, ciscoDlswCircuitS1DlcType=ciscoDlswCircuitS1DlcType, ciscoDlswCircuitS1Mac=ciscoDlswCircuitS1Mac, ciscoDlswVersion=ciscoDlswVersion, ciscoDlswTConnConfigSetupType=ciscoDlswTConnConfigSetupType, ciscoDlswDirNBCacheMisses=ciscoDlswDirNBCacheMisses, ciscoDlswCircuitS2Mac=ciscoDlswCircuitS2Mac, ciscoDlswDirMacEntryType=ciscoDlswDirMacEntryType, ciscoDlswIfVirtualSegment=ciscoDlswIfVirtualSegment, ciscoDlswTrapCntlTConnPartnerReject=ciscoDlswTrapCntlTConnPartnerReject, ciscoDlswCircuitS2TDomain=ciscoDlswCircuitS2TDomain, ciscoDlswStdPacingSupport=ciscoDlswStdPacingSupport, ciscoDlswDirLocateNBName=ciscoDlswDirLocateNBName, ciscoDlswTConnTcpOperTcpConnections=ciscoDlswTConnTcpOperTcpConnections, ciscoDlswTrapTConnDown=ciscoDlswTrapTConnDown, ciscoDlswCircuitS2Location=ciscoDlswCircuitS2Location, ciscoDlswTConnConfigInitCirRecvWndw=ciscoDlswTConnConfigInitCirRecvWndw, ciscoDlswCircuit=ciscoDlswCircuit, ciscoDlswTConnStatActiveConnections=ciscoDlswTConnStatActiveConnections, ciscoDlswTConnTcpOperPrefTcpConnections=ciscoDlswTConnTcpOperPrefTcpConnections, DlswTimeStamp=DlswTimeStamp, ciscoDlswTConnOperPartnerMacInfo=ciscoDlswTConnOperPartnerMacInfo, ciscoDlswVendorID=ciscoDlswVendorID, ciscoDlswTConnConfigIndex=ciscoDlswTConnConfigIndex, ciscoDlswCircuitS1Sap=ciscoDlswCircuitS1Sap, ciscoDlswTConnConfigGroup=ciscoDlswTConnConfigGroup, ciscoDlswCircuitFCLargestRecvGranted=ciscoDlswCircuitFCLargestRecvGranted, ciscoDlswTConnOperConnectTime=ciscoDlswTConnOperConnectTime, ciscoDlswTConnOperDiscTime=ciscoDlswTConnOperDiscTime, ciscoDlswDirLocateNBEntry=ciscoDlswDirLocateNBEntry, ciscoDlswTConnStatCloseBusys=ciscoDlswTConnStatCloseBusys, ciscoDlswTConnOperInDataOctets=ciscoDlswTConnOperInDataOctets, ciscoDlswTConnOperCirCreates=ciscoDlswTConnOperCirCreates, ciscoDlswTrapTConnUp=ciscoDlswTrapTConnUp, ciscoDlswTConnOperPartnerNBExcl=ciscoDlswTConnOperPartnerNBExcl, ciscoDlswDirNBName=ciscoDlswDirNBName, ciscoDlswTConnOperPartnerVersionStr=ciscoDlswTConnOperPartnerVersionStr, ciscoDlswTConnTcpConfigTable=ciscoDlswTConnTcpConfigTable, ciscoDlswInterface=ciscoDlswInterface, TAddress=TAddress, ciscoDlswDirNBCacheHits=ciscoDlswDirNBCacheHits, ciscoDlswDirComplianceV11R01=ciscoDlswDirComplianceV11R01, ciscoDlswCircuitS2TAddress=ciscoDlswCircuitS2TAddress, ciscoDlswCircuitFCSendCurrentWndw=ciscoDlswCircuitFCSendCurrentWndw, ciscoDlswTConnOperPartnerNBInfo=ciscoDlswTConnOperPartnerNBInfo, ciscoDlswDirLocateNBTable=ciscoDlswDirLocateNBTable, ciscoDlswVersionString=ciscoDlswVersionString, ciscoDlswCircuitFCResetOpSents=ciscoDlswCircuitFCResetOpSents, ciscoDlswDirMacEntry=ciscoDlswDirMacEntry, ciscoDlswDirMacLocationType=ciscoDlswDirMacLocationType, ciscoDlswMIBObjects=ciscoDlswMIBObjects, ciscoDlswSdlc=ciscoDlswSdlc, ciscoDlswTConnOperInCntlPkts=ciscoDlswTConnOperInCntlPkts, DlcType=DlcType, ciscoDlswTConnTcpOperKeepAliveInt=ciscoDlswTConnTcpOperKeepAliveInt, ciscoDlswDirMacIndex=ciscoDlswDirMacIndex, ciscoDlswDirMacLFSize=ciscoDlswDirMacLFSize, ciscoDlswCircuitDiscReasonRemoteData=ciscoDlswCircuitDiscReasonRemoteData, ciscoDlswSdlcCompliance=ciscoDlswSdlcCompliance, ciscoDlswTConnOperOutDataOctets=ciscoDlswTConnOperOutDataOctets, ciscoDlswCompliances=ciscoDlswCompliances, ciscoDlswNode=ciscoDlswNode, ciscoDlswTConnOperCURexRcvds=ciscoDlswTConnOperCURexRcvds, ciscoDlswTConnConfigRowStatus=ciscoDlswTConnConfigRowStatus, ciscoDlswDirNBLFSize=ciscoDlswDirNBLFSize, ciscoDlswDirStat=ciscoDlswDirStat, ciscoDlswTConnStatCloseIdles=ciscoDlswTConnStatCloseIdles, ciscoDlswTConnConfigGroupDefinition=ciscoDlswTConnConfigGroupDefinition, ciscoDlswDomains=ciscoDlswDomains, ciscoDlswCircuitPriority=ciscoDlswCircuitPriority, ciscoDlswCircuitDiscReasonRemote=ciscoDlswCircuitDiscReasonRemote, ciscoDlswTConnOperNQexRcvds=ciscoDlswTConnOperNQexRcvds, ciscoDlswTConnOperPartnerSapList=ciscoDlswTConnOperPartnerSapList, ciscoDlswTConnTcpConfigMaxSegmentSize=ciscoDlswTConnTcpConfigMaxSegmentSize, ciscoDlswTConnConfigAdvertiseMacNB=ciscoDlswTConnConfigAdvertiseMacNB, ciscoDlswSdlcComplianceV11R01=ciscoDlswSdlcComplianceV11R01, ciscoDlswStatus=ciscoDlswStatus, ciscoDlswCircuitS2Sap=ciscoDlswCircuitS2Sap, ciscoDlswDirMacEntries=ciscoDlswDirMacEntries, ciscoDlswDirMacMask=ciscoDlswDirMacMask, ciscoDlswCircuitS1RouteInfo=ciscoDlswCircuitS1RouteInfo, ciscoDlswSdlcLsRemoteMac=ciscoDlswSdlcLsRemoteMac, ciscoDlswTrapCntlTConnProtViolation=ciscoDlswTrapCntlTConnProtViolation, ciscoDlswCircuitEntryTime=ciscoDlswCircuitEntryTime, ciscoDlswTConnOperPartnerVendorID=ciscoDlswTConnOperPartnerVendorID, ciscoDlswTConnOperFlowCntlMode=ciscoDlswTConnOperFlowCntlMode, ciscoDlswTConnSpecific=ciscoDlswTConnSpecific, ciscoDlswIfTable=ciscoDlswIfTable, ciscoDlswIfRowStatus=ciscoDlswIfRowStatus, ciscoDlswDirLocateNBGroup=ciscoDlswDirLocateNBGroup, ciscoDlswTConnOperPartnerInitPacingWndw=ciscoDlswTConnOperPartnerInitPacingWndw, ciscoDlswDirNBIndex=ciscoDlswDirNBIndex, ciscoDlswTConnConfigSapList=ciscoDlswTConnConfigSapList, ciscoDlswTConnConfigRemoteTAddr=ciscoDlswTConnConfigRemoteTAddr, ciscoDlswTConnOperOutDataPkts=ciscoDlswTConnOperOutDataPkts, ciscoDlswTConnOperNRexSents=ciscoDlswTConnOperNRexSents, ciscoDlswTraps=ciscoDlswTraps, ciscoDlswSdlcLsEntries=ciscoDlswSdlcLsEntries, ciscoDlswCircuitFCRecvCurrentWndw=ciscoDlswCircuitFCRecvCurrentWndw, ciscoDlswDirMacRowStatus=ciscoDlswDirMacRowStatus, ciscoDlswInterfaceGroup=ciscoDlswInterfaceGroup, ciscoDlswDirLocateGroup=ciscoDlswDirLocateGroup, ciscoDlswCircuitOrigin=ciscoDlswCircuitOrigin, ciscoDlswTConnConfigLocalTAddr=ciscoDlswTConnConfigLocalTAddr, ciscoDlswSdlcLsLocalMac=ciscoDlswSdlcLsLocalMac, ciscoDlswTConnStat=ciscoDlswTConnStat, ciscoDlswDirMacMac=ciscoDlswDirMacMac, ciscoDlswTConnTcpOperEntry=ciscoDlswTConnTcpOperEntry, ciscoDlswTConnTcp=ciscoDlswTConnTcp, ciscoDlswDirNBEntries=ciscoDlswDirNBEntries)
