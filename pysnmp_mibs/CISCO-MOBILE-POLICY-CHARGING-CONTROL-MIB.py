...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:22:19 2025
...
_CmpccPreloadErrorNotifEnabled_Type.__name__ = "TruthValue"
...
cMobilePolicyChargingControlMIBCompliance.setObjects(
      *(("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cMobilePolicyChargingControlGlobalStatsGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cMobilePolicyChargingControlNotifGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cMobilePolicyChargingControlConfigGroup"),
...
cMobilePolicyChargingControlMIBCompliancesRev1.setObjects(
      *(("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cMobilePolicyChargingControlConfigGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cMobilePolicyChargingControlGlobalStatsGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cMobilePolicyChargingControlPCRFMethodListStatsGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cMobilePolicyChargingControlPolicyPreloadStatsGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cMobilePolicyChargingControlNotifGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cMobilePolicyChargingControlNotifEnableGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cmpccStatisticsExtGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cmpccPolicyPreloadNotifGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cmpccPreloadNotifControlGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cmpccPolicyMismatchGroup"),
        ("CISCO-MOBILE-POLICY-CHARGING-CONTROL-MIB", "cmpccRollbackFailedGroup"))
)
if mibBuilder.loadTexts:
