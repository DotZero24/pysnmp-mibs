...
mibBuilder.exportSymbols("CTRON-TRANSLATION-MIB", ctTransFddiEthernetAuto=ctTransFddiEthernetAuto, ctTransIbmLlcNbMode=ctTransIbmLlcNbMode, ctTransRifDbTable=ctTransRifDbTable, ctTransBcastXMedia=ctTransBcastXMedia, ctTransA2ArpCfgMode=ctTransA2ArpCfgMode, ctTransSrOther=ctTransSrOther, ctTransOtherSapDsap2Mode=ctTransOtherSapDsap2Mode, ctTransSrNetBIOS=ctTransSrNetBIOS, ctTransIbmLlcLnmMode=ctTransIbmLlcLnmMode, ctTransLfpsOperationalStatus=ctTransLfpsOperationalStatus, ctTransEthernetFddi=ctTransEthernetFddi, ctTransRifDbCtrlTable=ctTransRifDbCtrlTable, ctTransSrExpMode=ctTransSrExpMode, ctTransOtherCfg=ctTransOtherCfg, ctTransNovellCfgTable=ctTransNovellCfgTable, ctTransIbmLlcDscMode=ctTransIbmLlcDscMode, ctTransA2CfgEntry=ctTransA2CfgEntry, ctTransRifDbLength=ctTransRifDbLength, ctTransRifDbSrcPort=ctTransRifDbSrcPort, ctTransOtherUnknownSnap=ctTransOtherUnknownSnap, ctTransFddiEthernetSnapIPX=ctTransFddiEthernetSnapIPX, ctTransLfpsEntry=ctTransLfpsEntry, ctTransOtherSnap1Mode=ctTransOtherSnap1Mode, ctTransFddiEthernetIPFrag=ctTransFddiEthernetIPFrag, ctTransSRAutoRingNumberDetect=ctTransSRAutoRingNumberDetect, ctTransSrIP=ctTransSrIP, ctTransIPCfg=ctTransIPCfg, ctTransSrSRLF=ctTransSrSRLF, ctTransIbmLlcTable=ctTransIbmLlcTable, ctTransIbmLlc=ctTransIbmLlc, ctTransIbmLlcSnaMode=ctTransIbmLlcSnaMode, ctTransRifDb=ctTransRifDb, ctTransFddiEthernetMACIPX=ctTransFddiEthernetMACIPX, ctTransNovellCfgMode=ctTransNovellCfgMode, ctTransIPArpCfgMode=ctTransIPArpCfgMode, ctTransIPCfgTable=ctTransIPCfgTable, ctTransSr=ctTransSr, ctTransOtherEntry=ctTransOtherEntry, ctTransSRLocalSegment=ctTransSRLocalSegment, ctTransSrIfMode=ctTransSrIfMode, ctTransRifDbCtrlType=ctTransRifDbCtrlType, ctTransSrEntry=ctTransSrEntry, ctTransIPRarpCfgMode=ctTransIPRarpCfgMode, ctTransIPDataCfgMode=ctTransIPDataCfgMode, ctTransFddiAtm=ctTransFddiAtm, ctTransRifDbRIF=ctTransRifDbRIF, ctTransOtherSapDsap1Mode=ctTransOtherSapDsap1Mode, ctTransRifDbWeightState=ctTransRifDbWeightState, ctTransOtherPort=ctTransOtherPort, ctTransBcastX=ctTransBcastX, ctTransSrPort=ctTransSrPort, ctTransOtherSapDsap2Val=ctTransOtherSapDsap2Val, ctTransSrIPX=ctTransSrIPX, ctTransOtherSapDsap3Val=ctTransOtherSapDsap3Val, ctTransIbmLlcEntry=ctTransIbmLlcEntry, ctTransA2CfgTable=ctTransA2CfgTable, ctTransBcastXCanonical=ctTransBcastXCanonical, ctTransRifDbEntry=ctTransRifDbEntry, ctTransNovellCfgPort=ctTransNovellCfgPort, ctTransNovellCfgEntry=ctTransNovellCfgEntry, ctTransNovellCfg=ctTransNovellCfg, ctTransFddiEthernet802dot2IPX=ctTransFddiEthernet802dot2IPX, ctTransLfpsPort=ctTransLfpsPort, ctTransFddiSnapEthernetType=ctTransFddiSnapEthernetType, ctTransSrSNA=ctTransSrSNA, ctTransIbmLlcOtherMode=ctTransIbmLlcOtherMode, ctTransSrTable=ctTransSrTable, ctTransIbmLlcOtherValue=ctTransIbmLlcOtherValue, ctTransA2McastCfgMode=ctTransA2McastCfgMode, ctTransA2DataCfgMode=ctTransA2DataCfgMode, ctTransA2CfgPort=ctTransA2CfgPort, ctTransFddiAtmMtu=ctTransFddiAtmMtu, ctTransIbmLlcPort=ctTransIbmLlcPort, ctTransOtherSapDsap3Mode=ctTransOtherSapDsap3Mode, ctTransA2Cfg=ctTransA2Cfg, ctTransIbmLlcSnaPathMode=ctTransIbmLlcSnaPathMode, ctTransEthernetFddiPadVerify=ctTransEthernetFddiPadVerify, ctTransRifDbCtrlPort=ctTransRifDbCtrlPort, ctTransIPCfgPort=ctTransIPCfgPort, ctTransOtherTable=ctTransOtherTable, ctTransNovellGroupMode=ctTransNovellGroupMode, ctTransRifDbCtrlEntry=ctTransRifDbCtrlEntry, ctTransEthernetFddiRAW=ctTransEthernetFddiRAW, ctTransBcastXMode=ctTransBcastXMode, ctTransFddiEthernet=ctTransFddiEthernet, ctTransOtherUnknownSap=ctTransOtherUnknownSap, ctTransOtherSnap1Val=ctTransOtherSnap1Val, ctTransLfpsTable=ctTransLfpsTable, ctTransOtherSnap2Val=ctTransOtherSnap2Val, ctTransBcastXEntry=ctTransBcastXEntry, ctTransFddiAtmIPFrag=ctTransFddiAtmIPFrag, ctTransIbmLlcNullMode=ctTransIbmLlcNullMode, ctTransIPCfgEntry=ctTransIPCfgEntry, ctTransOtherSapDsap1Val=ctTransOtherSapDsap1Val, ctTransBcastXPort=ctTransBcastXPort, ctTransLfpsAdminStatus=ctTransLfpsAdminStatus, ctTransOtherSnap2Mode=ctTransOtherSnap2Mode, ctTransBcastXTable=ctTransBcastXTable, ctTransRifDbAgingTimer=ctTransRifDbAgingTimer, ctTransRifDbMacAddr=ctTransRifDbMacAddr, ctTranslfpsCfg=ctTranslfpsCfg)
