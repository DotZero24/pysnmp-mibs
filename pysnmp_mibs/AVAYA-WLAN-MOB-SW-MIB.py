...
mibBuilder.exportSymbols("AVAYA-WLAN-MOB-SW-MIB", avWlanMobAgentVlanLVID=avWlanMobAgentVlanLVID, avWlanMobSwTunnelIpAddress=avWlanMobSwTunnelIpAddress, PYSNMP_MODULE_ID=avayaWlanMobSwMib, avWlanMobVlanServerVlanName=avWlanMobVlanServerVlanName, avWlanMobSwDeviceStatus=avWlanMobSwDeviceStatus, avWlanMobTunnelStatsDeviceId=avWlanMobTunnelStatsDeviceId, avWlanMobSwTunnelIpAddressType=avWlanMobSwTunnelIpAddressType, avWlanMobVlanPeerAdvertiserEntry=avWlanMobVlanPeerAdvertiserEntry, avWlanMobAgentVlanWeight=avWlanMobAgentVlanWeight, avWlanMobSwTunnelIngressDataRate=avWlanMobSwTunnelIngressDataRate, avWlanMobPeerVlansAdvertisedEntry=avWlanMobPeerVlansAdvertisedEntry, avWlanMobSwKeepAliveNumRetries=avWlanMobSwKeepAliveNumRetries, avWlanMobTunnelStatsIngressKeepAliveRsp=avWlanMobTunnelStatsIngressKeepAliveRsp, avWlanMobAgentVlanActive=avWlanMobAgentVlanActive, avWlanMobTunnelStatsEgressPkts128to255=avWlanMobTunnelStatsEgressPkts128to255, avWlanMobTunnelStatsEgressFragments=avWlanMobTunnelStatsEgressFragments, avWlanMobSwTunnelResetStats=avWlanMobSwTunnelResetStats, avWlanMobAgentVlanWcValidated=avWlanMobAgentVlanWcValidated, avWlanMobSwTunnelEgressPkts128to255=avWlanMobSwTunnelEgressPkts128to255, avWlanMobTunnelStatsIngressKeepAliveReq=avWlanMobTunnelStatsIngressKeepAliveReq, avWlanMobAgentVlanEntry=avWlanMobAgentVlanEntry, avWlanMobSwPurgeInactiveMaps=avWlanMobSwPurgeInactiveMaps, avWlanMobSwTunnelEgressPkts512to1023=avWlanMobSwTunnelEgressPkts512to1023, avWlanMobSwNumAccessTunnels=avWlanMobSwNumAccessTunnels, avWlanMobSwTunnelStatisticsTable=avWlanMobSwTunnelStatisticsTable, avWlanMobSwTunnelIngressError=avWlanMobSwTunnelIngressError, avWlanMobSwTunnelIngressBcast=avWlanMobSwTunnelIngressBcast, avWlanMobSwTunnelEgressMcast=avWlanMobSwTunnelEgressMcast, avWlanMobTunnelStatsTable=avWlanMobTunnelStatsTable, avWlanMobTunnelStatsIngressPkts256to511=avWlanMobTunnelStatsIngressPkts256to511, avWlanMobTunnelStatsEgressKeepAliveReq=avWlanMobTunnelStatsEgressKeepAliveReq, avWlanMobSwFdbRemoteEndpointUdpPort=avWlanMobSwFdbRemoteEndpointUdpPort, avWlanMobTunnelStatsEgressError=avWlanMobTunnelStatsEgressError, avWlanMobSwDeviceAddr=avWlanMobSwDeviceAddr, avWlanMobSwTunnelIngressMcast=avWlanMobSwTunnelIngressMcast, avWlanMobSwDeviceId=avWlanMobSwDeviceId, avWlanMobSwTunnelIngressPkts64=avWlanMobSwTunnelIngressPkts64, avWlanMobVlanServerId=avWlanMobVlanServerId, avWlanMobSwFdbRemoteEndpointAddrType=avWlanMobSwFdbRemoteEndpointAddrType, avWlanMobTunnelStatsIngressPkts128to255=avWlanMobTunnelStatsIngressPkts128to255, avWlanMobSwAllStatisticsResetStatus=avWlanMobSwAllStatisticsResetStatus, avWlanMobAgentVlanScope=avWlanMobAgentVlanScope, avWlanMobPeerVlansAdvertisedTable=avWlanMobPeerVlansAdvertisedTable, avWlanMobSwTunnelEgressPkts=avWlanMobSwTunnelEgressPkts, avWlanMobSwLocalDeviceId=avWlanMobSwLocalDeviceId, avWlanMobSwTunnelEgressBcast=avWlanMobSwTunnelEgressBcast, avWlanMobSwTunnelEgressDataRate=avWlanMobSwTunnelEgressDataRate, avWlanMobSwFdbFlushAction=avWlanMobSwFdbFlushAction, avWlanMobSwTunnelEgressPkts65to127=avWlanMobSwTunnelEgressPkts65to127, avayaWlanMobSwMib=avayaWlanMobSwMib, avWlanMobTunnelStatsIngressBcast=avWlanMobTunnelStatsIngressBcast, avWlanMobSwTunnelIngressPkts256to511=avWlanMobSwTunnelIngressPkts256to511, avWlanMobVlanPeerAdvertiserId=avWlanMobVlanPeerAdvertiserId, avWlanMobSwTunnelInterfaceId=avWlanMobSwTunnelInterfaceId, avWlanMobSwFdbGlobalFlushActionStatus=avWlanMobSwFdbGlobalFlushActionStatus, avWlanMobTunnelStatsEgressPkts1522to9216=avWlanMobTunnelStatsEgressPkts1522to9216, avWlanMobSwTunnelEgressKeepAliveRsp=avWlanMobSwTunnelEgressKeepAliveRsp, avWlanMobSwDeviceTable=avWlanMobSwDeviceTable, avWlanMobSwVMMMaxRetransmits=avWlanMobSwVMMMaxRetransmits, avWlanMobSwDeviceLocalUdpPort=avWlanMobSwDeviceLocalUdpPort, avWlanMobTunnelStatsIngressPkts1522to9216=avWlanMobTunnelStatsIngressPkts1522to9216, avWlanMobSwControllerAddrType=avWlanMobSwControllerAddrType, avWlanMobSwFdbLocalEndpointUdpPort=avWlanMobSwFdbLocalEndpointUdpPort, avWlanMobSwFdbTable=avWlanMobSwFdbTable, avWlanMobSwTunnelIngressPkts128to255=avWlanMobSwTunnelIngressPkts128to255, avWlanMobPeerVlansAdvertisedVlanName=avWlanMobPeerVlansAdvertisedVlanName, avWlanMobTunnelStatsEgressOctets=avWlanMobTunnelStatsEgressOctets, avWlanMobVlanServerTable=avWlanMobVlanServerTable, avWlanMobSwNumMobilityTunnels=avWlanMobSwNumMobilityTunnels, avWlanMobAgentVlanRowStatus=avWlanMobAgentVlanRowStatus, avWlanMobTunnelStatsIngressFragments=avWlanMobTunnelStatsIngressFragments, avWlanMobPeerVlansAdvertisedPriority=avWlanMobPeerVlansAdvertisedPriority, avWlanMobSwControllerTable=avWlanMobSwControllerTable, avWlanMobTunnelStatsIngressPkts=avWlanMobTunnelStatsIngressPkts, avWlanMobTunnelStatsIngressMcast=avWlanMobTunnelStatsIngressMcast, avWlanMobAgentVlanTrack=avWlanMobAgentVlanTrack, avWlanMobSwVLANPeriodicAdvInterval=avWlanMobSwVLANPeriodicAdvInterval, avWlanMobSwScalars=avWlanMobSwScalars, avWlanMobAgentVlanTable=avWlanMobAgentVlanTable, avWlanMobSwControllerId=avWlanMobSwControllerId, avWlanMobSwDeviceInterfaceId=avWlanMobSwDeviceInterfaceId, avWlanMobTunnelStatsIngressPkts1024to1518=avWlanMobTunnelStatsIngressPkts1024to1518, avWlanMobTunnelStatsEgressMcast=avWlanMobTunnelStatsEgressMcast, avWlanMobSwTunnelIngressPkts=avWlanMobSwTunnelIngressPkts, avWlanMobSwTunnelIngressKeepAliveReq=avWlanMobSwTunnelIngressKeepAliveReq, avWlanMobSwTunnelEgressPkts1024to1518=avWlanMobSwTunnelEgressPkts1024to1518, avWlanMobSwObjects=avWlanMobSwObjects, avWlanMobVlanServerEntry=avWlanMobVlanServerEntry, avWlanMobTunnelStatsIngressPkts65to127=avWlanMobTunnelStatsIngressPkts65to127, avWlanMobSwDeviceEntry=avWlanMobSwDeviceEntry, avWlanMobTunnelStatsEgressDataRate=avWlanMobTunnelStatsEgressDataRate, avWlanMobPeerVlansAdvertisedId=avWlanMobPeerVlansAdvertisedId, avWlanMobSwFdbTunnelType=avWlanMobSwFdbTunnelType, avWlanMobSwTunnelEgressPkts64=avWlanMobSwTunnelEgressPkts64, avWlanMobSwDeviceUdpPort=avWlanMobSwDeviceUdpPort, avWlanMobSwFdbMacAddress=avWlanMobSwFdbMacAddress, avWlanMobTunnelStatsIngressOctets=avWlanMobTunnelStatsIngressOctets, avWlanMobSwAllStatisticsReset=avWlanMobSwAllStatisticsReset, avWlanMobTunnelStatsIngressPkts512to1023=avWlanMobTunnelStatsIngressPkts512to1023, avWlanMobSwTunnelIngressPkts65to127=avWlanMobSwTunnelIngressPkts65to127, avWlanMobSwTunnelEgressPkts256to511=avWlanMobSwTunnelEgressPkts256to511, avWlanMobSwTunnelEgressFragments=avWlanMobSwTunnelEgressFragments, avWlanMobTunnelStatsIngressDropped=avWlanMobTunnelStatsIngressDropped, avWlanMobTunnelStatsIngressPkts64=avWlanMobTunnelStatsIngressPkts64, avWlanMobSwTunnelIngressPkts512to1023=avWlanMobSwTunnelIngressPkts512to1023, avWlanMobSwTunnelEgressError=avWlanMobSwTunnelEgressError, avWlanMobAgentVlanL3Mobility=avWlanMobAgentVlanL3Mobility, avWlanMobSwTunnelEgressOctets=avWlanMobSwTunnelEgressOctets, avWlanMobSwControllerEntry=avWlanMobSwControllerEntry, avWlanMobTunnelStatsEntry=avWlanMobTunnelStatsEntry, avWlanMobVlanPeerAdvertiserPriority=avWlanMobVlanPeerAdvertiserPriority, avWlanMobSwFdbType=avWlanMobSwFdbType, avWlanMobSwTunnelEgressPkts1522to9216=avWlanMobSwTunnelEgressPkts1522to9216, avWlanMobSwTunnelIngressFragmentsDrop=avWlanMobSwTunnelIngressFragmentsDrop, avWlanMobSwDeviceType=avWlanMobSwDeviceType, avWlanMobTunnelStatsIngressError=avWlanMobTunnelStatsIngressError, avWlanMobSwTunnelIngressDropped=avWlanMobSwTunnelIngressDropped, avWlanMobSwCtrlAddr=avWlanMobSwCtrlAddr, avWlanMobSwKeepAliveInterval=avWlanMobSwKeepAliveInterval, avWlanMobSwFdbRemoteEndpointId=avWlanMobSwFdbRemoteEndpointId, avWlanMobVlanPeerAdvertiserVlanName=avWlanMobVlanPeerAdvertiserVlanName, avWlanMobTunnelStatsIngressFragmentsDrop=avWlanMobTunnelStatsIngressFragmentsDrop, avWlanMobSwTunnelEgressDropped=avWlanMobSwTunnelEgressDropped, avWlanMobSwFdbGlobalFlushAction=avWlanMobSwFdbGlobalFlushAction, avWlanMobSwFdbRemoteEndpointAddr=avWlanMobSwFdbRemoteEndpointAddr, avWlanMobSwTunnelIngressPkts1522to9216=avWlanMobSwTunnelIngressPkts1522to9216, avWlanMobTunnelStatsReset=avWlanMobTunnelStatsReset, avWlanMobSwTunnelStatisticsEntry=avWlanMobSwTunnelStatisticsEntry, avWlanMobSwFdbEntry=avWlanMobSwFdbEntry, avWlanMobVlanServerPriority=avWlanMobVlanServerPriority, avWlanMobSwTunnelIngressPkts1024to1518=avWlanMobSwTunnelIngressPkts1024to1518, avWlanMobVlanPeerAdvertiserTable=avWlanMobVlanPeerAdvertiserTable, avWlanMobSwDeviceAddrType=avWlanMobSwDeviceAddrType, avWlanMobTunnelStatsEgressPkts256to511=avWlanMobTunnelStatsEgressPkts256to511, avWlanMobSwTransMaxRetransmits=avWlanMobSwTransMaxRetransmits, avWlanMobTunnelStatsIngressDataRate=avWlanMobTunnelStatsIngressDataRate, avWlanMobSwFdbVlanId=avWlanMobSwFdbVlanId, avWlanMobSwFdbInterfaceId=avWlanMobSwFdbInterfaceId, avWlanMobTunnelStatsEgressPkts64=avWlanMobTunnelStatsEgressPkts64, avWlanMobTunnelStatsEgressPkts512to1023=avWlanMobTunnelStatsEgressPkts512to1023, avWlanMobSwTunnelIngressFragments=avWlanMobSwTunnelIngressFragments, avWlanMobSwControllerAddr=avWlanMobSwControllerAddr, avWlanMobTunnelStatsEgressDropped=avWlanMobTunnelStatsEgressDropped, avWlanMobTunnelStatsEgressPkts65to127=avWlanMobTunnelStatsEgressPkts65to127, avWlanMobTunnelStatsEgressBcast=avWlanMobTunnelStatsEgressBcast, avWlanMobAgentVlanAdminMapped=avWlanMobAgentVlanAdminMapped, avWlanMobSwTunnelEgressKeepAliveReq=avWlanMobSwTunnelEgressKeepAliveReq, avWlanMobSwCtrlAddrType=avWlanMobSwCtrlAddrType, avWlanMobSwNumResPeerAccessTunnels=avWlanMobSwNumResPeerAccessTunnels, avWlanMobAgentObjects=avWlanMobAgentObjects, avWlanMobTunnelStatsEgressKeepAliveRsp=avWlanMobTunnelStatsEgressKeepAliveRsp, avWlanMobAgentVlanName=avWlanMobAgentVlanName, avWlanMobSwTunnelIngressOctets=avWlanMobSwTunnelIngressOctets, avWlanMobTunnelStatsEgressPkts=avWlanMobTunnelStatsEgressPkts, avWlanMobTunnelStatsEgressPkts1024to1518=avWlanMobTunnelStatsEgressPkts1024to1518, avWlanMobSwControllerRowStatus=avWlanMobSwControllerRowStatus, avWlanMobSwTunnelIngressKeepAliveRsp=avWlanMobSwTunnelIngressKeepAliveRsp)
