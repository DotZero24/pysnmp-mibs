# SNMP MIB module (AricentMIMst-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/AricentMIMst-MIB
...
fsMIDot1sFutureMstEntry = _FsMIDot1sFutureMstEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 3, 1)
)
fsMIDot1sFutureMstEntry.setIndexNames(
    (0, "AricentMIMst-MIB", "fsMIDot1sFutureMstContextId"),
)
if mibBuilder.loadTexts:
...
class _FsMIMstStpPerfStatus_Type(Integer32):
    """Custom type fsMIMstStpPerfStatus based on Integer32"""
    defaultValue = 2
...
_FsMIMstStpPerfStatus_Type.__name__ = "Integer32"
_FsMIMstStpPerfStatus_Object = MibTableColumn
fsMIMstStpPerfStatus = _FsMIMstStpPerfStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 3, 1, 51),
    _FsMIMstStpPerfStatus_Type()
)
fsMIMstStpPerfStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIMstStpPerfStatus.setStatus("current")
_FsMIMstMstiBridgeTable_Object = MibTable
fsMIMstMstiBridgeTable = _FsMIMstMstiBridgeTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 4)
)
if mibBuilder.loadTexts:
...
fsMIMstMstiBridgeEntry = _FsMIMstMstiBridgeEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 4, 1)
)
fsMIMstMstiBridgeEntry.setIndexNames(
    (0, "AricentMIMst-MIB", "fsMIDot1sFutureMstContextId"),
    (0, "AricentMIMst-MIB", "fsMIMstMstiInstanceIndex"),
)
if mibBuilder.loadTexts:
...
class _FsMIMstiRootPriority_Type(Integer32):
    """Custom type fsMIMstiRootPriority based on Integer32"""
    defaultValue = 3
...
_FsMIMstiRootPriority_Type.__name__ = "Integer32"
_FsMIMstiRootPriority_Object = MibTableColumn
fsMIMstiRootPriority = _FsMIMstiRootPriority_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 4, 1, 16),
    _FsMIMstiRootPriority_Type()
)
fsMIMstiRootPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIMstiRootPriority.setStatus("current")
_FsMIMstVlanInstanceMappingTable_Object = MibTable
fsMIMstVlanInstanceMappingTable = _FsMIMstVlanInstanceMappingTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 5)
)
if mibBuilder.loadTexts:
...
fsMIMstVlanInstanceMappingEntry = _FsMIMstVlanInstanceMappingEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 5, 1)
)
fsMIMstVlanInstanceMappingEntry.setIndexNames(
    (0, "AricentMIMst-MIB", "fsMIDot1sFutureMstContextId"),
    (0, "AricentMIMst-MIB", "fsMIMstInstanceIndex"),
)
if mibBuilder.loadTexts:
...
fsMIMstCistPortEntry = _FsMIMstCistPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 6, 1)
)
fsMIMstCistPortEntry.setIndexNames(
    (0, "AricentMIMst-MIB", "fsMIMstCistPort"),
)
if mibBuilder.loadTexts:
...
class _FsMIMstCistPortRootGuard_Type(TruthValue):
    """Custom type fsMIMstCistPortRootGuard based on TruthValue"""
    defaultValue = 2


_FsMIMstCistPortRootGuard_Type.__name__ = "TruthValue"
_FsMIMstCistPortRootGuard_Object = MibTableColumn
fsMIMstCistPortRootGuard = _FsMIMstCistPortRootGuard_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 6, 1, 58),
    _FsMIMstCistPortRootGuard_Type()
)
fsMIMstCistPortRootGuard.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIMstCistPortRootGuard.setStatus("current")


class _FsMIMstCistPortRootInconsistentState_Type(TruthValue):
    """Custom type fsMIMstCistPortRootInconsistentState based on TruthValue"""
    defaultValue = 2


_FsMIMstCistPortRootInconsistentState_Type.__name__ = "TruthValue"
_FsMIMstCistPortRootInconsistentState_Object = MibTableColumn
fsMIMstCistPortRootInconsistentState = _FsMIMstCistPortRootInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 6, 1, 59),
    _FsMIMstCistPortRootInconsistentState_Type()
)
fsMIMstCistPortRootInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsMIMstCistPortRootInconsistentState.setStatus("current")


class _FsMIMstCistPortErrorRecovery_Type(Timeout):
    """Custom type fsMIMstCistPortErrorRecovery based on Timeout"""
    defaultValue = 30000
...
_FsMIMstCistPortErrorRecovery_Type.__name__ = "Timeout"
_FsMIMstCistPortErrorRecovery_Object = MibTableColumn
fsMIMstCistPortErrorRecovery = _FsMIMstCistPortErrorRecovery_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 6, 1, 60),
    _FsMIMstCistPortErrorRecovery_Type()
)
fsMIMstCistPortErrorRecovery.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIMstCistPortErrorRecovery.setStatus("current")
if mibBuilder.loadTexts:
    fsMIMstCistPortErrorRecovery.setUnits("centi-seconds")


class _FsMIMstPortBpduInconsistentState_Type(TruthValue):
    """Custom type fsMIMstPortBpduInconsistentState based on TruthValue"""
    defaultValue = 2


_FsMIMstPortBpduInconsistentState_Type.__name__ = "TruthValue"
_FsMIMstPortBpduInconsistentState_Object = MibTableColumn
fsMIMstPortBpduInconsistentState = _FsMIMstPortBpduInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 6, 1, 61),
    _FsMIMstPortBpduInconsistentState_Type()
)
fsMIMstPortBpduInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsMIMstPortBpduInconsistentState.setStatus("current")


class _FsMIMstPortBpduGuardAction_Type(Integer32):
    """Custom type fsMIMstPortBpduGuardAction based on Integer32"""
    defaultValue = 1
...
_FsMIMstPortBpduGuardAction_Type.__name__ = "Integer32"
_FsMIMstPortBpduGuardAction_Object = MibTableColumn
fsMIMstPortBpduGuardAction = _FsMIMstPortBpduGuardAction_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 6, 1, 62),
    _FsMIMstPortBpduGuardAction_Type()
)
fsMIMstPortBpduGuardAction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIMstPortBpduGuardAction.setStatus("current")
_FsMIMstMstiPortTable_Object = MibTable
fsMIMstMstiPortTable = _FsMIMstMstiPortTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 7)
)
if mibBuilder.loadTexts:
...
fsMIMstMstiPortEntry = _FsMIMstMstiPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 7, 1)
)
fsMIMstMstiPortEntry.setIndexNames(
    (0, "AricentMIMst-MIB", "fsMIMstMstiPort"),
    (0, "AricentMIMst-MIB", "fsMIMstInstanceIndex"),
)
if mibBuilder.loadTexts:
...
class _FsMIMstMstiPortRootInconsistentState_Type(TruthValue):
    """Custom type fsMIMstMstiPortRootInconsistentState based on TruthValue"""
    defaultValue = 2


_FsMIMstMstiPortRootInconsistentState_Type.__name__ = "TruthValue"
_FsMIMstMstiPortRootInconsistentState_Object = MibTableColumn
fsMIMstMstiPortRootInconsistentState = _FsMIMstMstiPortRootInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 7, 1, 25),
    _FsMIMstMstiPortRootInconsistentState_Type()
)
fsMIMstMstiPortRootInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsMIMstMstiPortRootInconsistentState.setStatus("current")
_FsMIMstPortExtTable_Object = MibTable
fsMIMstPortExtTable = _FsMIMstPortExtTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 8)
)
if mibBuilder.loadTexts:
...
fsMIMstPortExtEntry = _FsMIMstPortExtEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 1, 8, 1)
)
fsMIMstPortExtEntry.setIndexNames(
    (0, "AricentMIMst-MIB", "fsMIMstPort"),
)
if mibBuilder.loadTexts:
...
fsMIMstPortTrapNotificationEntry = _FsMIMstPortTrapNotificationEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 118, 2, 4, 1)
)
fsMIMstPortTrapNotificationEntry.setIndexNames(
    (0, "AricentMIMst-MIB", "fsMIMstPortTrapIndex"),
)
if mibBuilder.loadTexts:
...
fsMIMstGlobalErrTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 1)
)
fsMIMstGlobalErrTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstGlobalErrTrapType"))
)
if mibBuilder.loadTexts:
...
fsMIMstGenTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 2)
)
fsMIMstGenTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstContextName"),
        ("AricentMIMst-MIB", "fsMIMstGenTrapType"))
)
if mibBuilder.loadTexts:
...
fsMIMstNewRootTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 3)
)
fsMIMstNewRootTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstContextName"),
        ("AricentMIMst-MIB", "fsMIMstOldDesignatedRoot"),
        ("AricentMIMst-MIB", "fsMIMstMstiBridgeRegionalRoot"))
)
if mibBuilder.loadTexts:
...
fsMIMstTopologyChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 4)
)
fsMIMstTopologyChgTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstContextName"),
        ("AricentMIMst-MIB", "fsMIMstMstiTopChanges"))
)
if mibBuilder.loadTexts:
...
fsMIMstProtocolMigrationTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 5)
)
fsMIMstProtocolMigrationTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstContextName"),
        ("AricentMIMst-MIB", "fsMIMstForceProtocolVersion"),
        ("AricentMIMst-MIB", "fsMIMstPortMigrationType"))
)
if mibBuilder.loadTexts:
...
fsMIMstInvalidBpduRxdTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 6)
)
fsMIMstInvalidBpduRxdTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstContextName"),
        ("AricentMIMst-MIB", "fsMIMstPktErrType"),
        ("AricentMIMst-MIB", "fsMIMstPktErrVal"))
)
if mibBuilder.loadTexts:
...
fsMIMstRegionConfigChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 7)
)
fsMIMstRegionConfigChangeTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstContextName"),
        ("AricentMIMst-MIB", "fsMIMstMstiConfigIdSel"),
        ("AricentMIMst-MIB", "fsMIMstMstiRegionName"),
        ("AricentMIMst-MIB", "fsMIMstMstiRegionVersion"),
        ("AricentMIMst-MIB", "fsMIMstMstiConfigDigest"))
)
if mibBuilder.loadTexts:
...
fsMIMstNewPortRoleTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 8)
)
fsMIMstNewPortRoleTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstPortRoleType"),
        ("AricentMIMst-MIB", "fsMIMstOldRoleType"))
)
if mibBuilder.loadTexts:
...
fsMIMstCistHwFailureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 9)
)
fsMIMstCistHwFailureTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstContextName"),
        ("AricentMIMst-MIB", "fsMIMstCistPortState"))
)
if mibBuilder.loadTexts:
...
fsMIMstMstiHwFailureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 118, 3, 0, 10)
)
fsMIMstMstiHwFailureTrap.setObjects(
      *(("AricentMIMst-MIB", "fsMIMstBrgAddress"),
        ("AricentMIMst-MIB", "fsMIMstContextName"),
        ("AricentMIMst-MIB", "fsMIMstMstiPortState"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"VlanId": VlanId,
       ...
       "fsMIMstStpPerfStatus": fsMIMstStpPerfStatus,
       ...
       "fsMIMstiRootPriority": fsMIMstiRootPriority,
       ...
       "fsMIMstCistPortRootGuard": fsMIMstCistPortRootGuard,
       "fsMIMstCistPortRootInconsistentState": fsMIMstCistPortRootInconsistentState,
       "fsMIMstCistPortErrorRecovery": fsMIMstCistPortErrorRecovery,
       "fsMIMstPortBpduInconsistentState": fsMIMstPortBpduInconsistentState,
       "fsMIMstPortBpduGuardAction": fsMIMstPortBpduGuardAction,
       ...
       "fsMIMstMstiPortRootInconsistentState": fsMIMstMstiPortRootInconsistentState,
