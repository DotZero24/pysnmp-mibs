...
_H='DisplayString'
_G='VlanPriority'
_F='NETGEAR-RADLAN-vlanVoice-MIB'
_E='TruthValue'
_D='read-write'
_C='read-only'
_B='Integer32'
...
VlanPriority,=mibBuilder.importSymbols('NETGEAR-RADLAN-MIB',_G)
vlan,=mibBuilder.importSymbols('NETGEAR-RADLAN-vlan-MIB','vlan')
...
vlanVoice=ModuleIdentity((1,3,6,1,4,1,4526,17,48,54))
...
vlanVoiceAdminState=_VlanVoiceAdminState_Object((1,3,6,1,4,1,4526,17,48,54,6),_VlanVoiceAdminState_Type())
...
vlanVoiceOperState=_VlanVoiceOperState_Object((1,3,6,1,4,1,4526,17,48,54,7),_VlanVoiceOperState_Type())
...
vlanVoiceAdminVid=_VlanVoiceAdminVid_Object((1,3,6,1,4,1,4526,17,48,54,8),_VlanVoiceAdminVid_Type())
...
vlanVoiceOperVid=_VlanVoiceOperVid_Object((1,3,6,1,4,1,4526,17,48,54,9),_VlanVoiceOperVid_Type())
...
vlanVoiceUcDeviceTable=_VlanVoiceUcDeviceTable_Object((1,3,6,1,4,1,4526,17,48,54,10))
if mibBuilder.loadTexts:vlanVoiceUcDeviceTable.setStatus(_A)
_VlanVoiceUcDeviceEntry_Object=MibTableRow
vlanVoiceUcDeviceEntry=_VlanVoiceUcDeviceEntry_Object((1,3,6,1,4,1,4526,17,48,54,10,1))
...
vlanVoiceUcDeviceType=_VlanVoiceUcDeviceType_Object((1,3,6,1,4,1,4526,17,48,54,10,1,1),_VlanVoiceUcDeviceType_Type())
...
vlanVoiceUcDeviceMacAddress=_VlanVoiceUcDeviceMacAddress_Object((1,3,6,1,4,1,4526,17,48,54,10,1,2),_VlanVoiceUcDeviceMacAddress_Type())
...
vlanVoiceUcDeviceInterface=_VlanVoiceUcDeviceInterface_Object((1,3,6,1,4,1,4526,17,48,54,10,1,3),_VlanVoiceUcDeviceInterface_Type())
...
vlanVoiceUcDeviceVid=_VlanVoiceUcDeviceVid_Object((1,3,6,1,4,1,4526,17,48,54,10,1,4),_VlanVoiceUcDeviceVid_Type())
...
vlanVoiceUcDeviceVpt=_VlanVoiceUcDeviceVpt_Object((1,3,6,1,4,1,4526,17,48,54,10,1,5),_VlanVoiceUcDeviceVpt_Type())
...
vlanVoiceUcDeviceDscp=_VlanVoiceUcDeviceDscp_Object((1,3,6,1,4,1,4526,17,48,54,10,1,6),_VlanVoiceUcDeviceDscp_Type())
...
vlanVoiceUcDeviceIsBest=_VlanVoiceUcDeviceIsBest_Object((1,3,6,1,4,1,4526,17,48,54,10,1,7),_VlanVoiceUcDeviceIsBest_Type())
...
vlanVoiceAuto=_VlanVoiceAuto_ObjectIdentity((1,3,6,1,4,1,4526,17,48,54,11))
_VlanVoiceAutoAdmin_ObjectIdentity=ObjectIdentity
vlanVoiceAutoAdmin=_VlanVoiceAutoAdmin_ObjectIdentity((1,3,6,1,4,1,4526,17,48,54,11,1))
...
vlanVoiceAutoAdminVpt=_VlanVoiceAutoAdminVpt_Object((1,3,6,1,4,1,4526,17,48,54,11,1,1),_VlanVoiceAutoAdminVpt_Type())
...
vlanVoiceAutoAdminDscp=_VlanVoiceAutoAdminDscp_Object((1,3,6,1,4,1,4526,17,48,54,11,1,2),_VlanVoiceAutoAdminDscp_Type())
...
vlanVoiceAutoOper=_VlanVoiceAutoOper_ObjectIdentity((1,3,6,1,4,1,4526,17,48,54,11,2))
_VlanVoiceAutoOperVpt_Type=VlanPriority
_VlanVoiceAutoOperVpt_Object=MibScalar
vlanVoiceAutoOperVpt=_VlanVoiceAutoOperVpt_Object((1,3,6,1,4,1,4526,17,48,54,11,2,1),_VlanVoiceAutoOperVpt_Type())
...
vlanVoiceAutoOperDscp=_VlanVoiceAutoOperDscp_Object((1,3,6,1,4,1,4526,17,48,54,11,2,2),_VlanVoiceAutoOperDscp_Type())
...
vlanVoiceAutoOperSource=_VlanVoiceAutoOperSource_Object((1,3,6,1,4,1,4526,17,48,54,11,2,3),_VlanVoiceAutoOperSource_Type())
...
vlanVoiceAutoOperPriority=_VlanVoiceAutoOperPriority_Object((1,3,6,1,4,1,4526,17,48,54,11,2,4),_VlanVoiceAutoOperPriority_Type())
...
vlanVoiceAutoRefresh=_VlanVoiceAutoRefresh_Object((1,3,6,1,4,1,4526,17,48,54,11,3),_VlanVoiceAutoRefresh_Type())
...
vlanVoiceAutoAgreedVlanLastChange=_VlanVoiceAutoAgreedVlanLastChange_Object((1,3,6,1,4,1,4526,17,48,54,11,4),_VlanVoiceAutoAgreedVlanLastChange_Type())
...
vlanVoiceOUIBased=_VlanVoiceOUIBased_ObjectIdentity((1,3,6,1,4,1,4526,17,48,54,12))
...
vlanVoiceOUIBasedAdminPriority=_VlanVoiceOUIBasedAdminPriority_Object((1,3,6,1,4,1,4526,17,48,54,12,1),_VlanVoiceOUIBasedAdminPriority_Type())
...
vlanVoiceOUIBasedAdminRemark=_VlanVoiceOUIBasedAdminRemark_Object((1,3,6,1,4,1,4526,17,48,54,12,2),_VlanVoiceOUIBasedAdminRemark_Type())
...
vlanVoiceOUIBasedSetToDefault=_VlanVoiceOUIBasedSetToDefault_Object((1,3,6,1,4,1,4526,17,48,54,12,3),_VlanVoiceOUIBasedSetToDefault_Type())
...
vlanVoiceOUIBasedTable=_VlanVoiceOUIBasedTable_Object((1,3,6,1,4,1,4526,17,48,54,12,4))
if mibBuilder.loadTexts:vlanVoiceOUIBasedTable.setStatus(_A)
_VlanVoiceOUIBasedEntry_Object=MibTableRow
vlanVoiceOUIBasedEntry=_VlanVoiceOUIBasedEntry_Object((1,3,6,1,4,1,4526,17,48,54,12,4,1))
...
vlanVoiceOUIBasedPrefix=_VlanVoiceOUIBasedPrefix_Object((1,3,6,1,4,1,4526,17,48,54,12,4,1,1),_VlanVoiceOUIBasedPrefix_Type())
...
vlanVoiceOUIBasedDescription=_VlanVoiceOUIBasedDescription_Object((1,3,6,1,4,1,4526,17,48,54,12,4,1,2),_VlanVoiceOUIBasedDescription_Type())
...
vlanVoiceOUIBasedEntryRowStatus=_VlanVoiceOUIBasedEntryRowStatus_Object((1,3,6,1,4,1,4526,17,48,54,12,4,1,3),_VlanVoiceOUIBasedEntryRowStatus_Type())
...
vlanVoiceOUIBasedPortTable=_VlanVoiceOUIBasedPortTable_Object((1,3,6,1,4,1,4526,17,48,54,12,5))
if mibBuilder.loadTexts:vlanVoiceOUIBasedPortTable.setStatus(_A)
_VlanVoiceOUIBasedPortEntry_Object=MibTableRow
vlanVoiceOUIBasedPortEntry=_VlanVoiceOUIBasedPortEntry_Object((1,3,6,1,4,1,4526,17,48,54,12,5,1))
...
vlanVoiceOUIBasedPortEnable=_VlanVoiceOUIBasedPortEnable_Object((1,3,6,1,4,1,4526,17,48,54,12,5,1,1),_VlanVoiceOUIBasedPortEnable_Type())
...
vlanVoiceOUIBasedPortVlanIndex=_VlanVoiceOUIBasedPortVlanIndex_Object((1,3,6,1,4,1,4526,17,48,54,12,5,1,2),_VlanVoiceOUIBasedPortVlanIndex_Type())
...
vlanVoiceOUIBasedPortSecure=_VlanVoiceOUIBasedPortSecure_Object((1,3,6,1,4,1,4526,17,48,54,12,5,1,3),_VlanVoiceOUIBasedPortSecure_Type())
...
vlanVoiceOUIBasedPortCurrentMembership=_VlanVoiceOUIBasedPortCurrentMembership_Object((1,3,6,1,4,1,4526,17,48,54,12,5,1,4),_VlanVoiceOUIBasedPortCurrentMembership_Type())
...
vlanVoiceOUIBasedPortQosMode=_VlanVoiceOUIBasedPortQosMode_Object((1,3,6,1,4,1,4526,17,48,54,12,5,1,5),_VlanVoiceOUIBasedPortQosMode_Type())
...
vlanVoiceOUIBasedAgingTimeout=_VlanVoiceOUIBasedAgingTimeout_Object((1,3,6,1,4,1,4526,17,48,54,12,6),_VlanVoiceOUIBasedAgingTimeout_Type())
