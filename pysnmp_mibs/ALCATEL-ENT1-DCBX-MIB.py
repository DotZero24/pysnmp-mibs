# SNMP MIB module (ALCATEL-ENT1-DCBX-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-DCBX-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:09:15 2025
...
alaDcbxDCProfileEntry.setIndexNames(
    (0, "ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPId"),
)
if mibBuilder.loadTexts:
...
_AlaDcbxDCP8023xPauseReady_Type.__name__ = "VfcEnableState"
...
alaDcbxDCPTCEntry.setIndexNames(
    (0, "ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCDCPId"),
    (0, "ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCTrafficClass"),
)
if mibBuilder.loadTexts:
...
_AlaDcbxDCPTCPFCLinkDelayUserModified_Type.__name__ = "TruthValue"
...
alaDcbxPortInstanceEntry.setIndexNames(
    (0, "ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIIfIndex"),
)
if mibBuilder.loadTexts:
...
_AlaDcbxPIDCBXAdmin_Type.__name__ = "VfcEnableState"
...
_AlaDcbxPIDCBXOper_Type.__name__ = "VfcEnableState"
...
_AlaDcbxPILocalModified_Type.__name__ = "TruthValue"
...
_AlaDcbxPIPFCDefense_Type.__name__ = "VfcEnableState"
...
_AlaDcbxPIPFCStatsClear_Type.__name__ = "VfcEnableState"
...
_AlaDcbxPIStatus_Type.__name__ = "DcbxStatus"
...
_AlaDcbxPIActionTaken_Type.__name__ = "DcbxActionTaken"
...
alaDcbxPIDCBXVersion.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
alaDcbxPIPrioEntry.setIndexNames(
    (0, "ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIPrioIfIndex"),
    (0, "ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIPrioPriority"),
)
if mibBuilder.loadTexts:
...
alaDcbxPfcUsageEntry.setIndexNames(
    (0, "ALCATEL-ENT1-DCBX-MIB", "alaDcbxPfcUsageChassisId"),
)
if mibBuilder.loadTexts:
...
alaDcbxDCProfileGroup.setObjects(
      *(("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPName"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPETSTrafficClassesSupported"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPPFCCap"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPPriorityTCMap"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTemplateDCPId"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTemplateDCPName"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCsPresent"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCP8023xPauseReady"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPRowStatus"))
)
if mibBuilder.loadTexts:
...
alaDcbxDCPTrafficClassGroup.setObjects(
      *(("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCDCPName"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCMaximumBandwidth"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCMinimumBandwidth"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCPFCLinkDelay"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCPFCLinkDelayUserModified"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCPFCTrafficFlow"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCPriorityMap"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCTrafficScheduler"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCRecommendedBandwidth"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTCRecommendedTrafficScheduler"))
)
if mibBuilder.loadTexts:
...
alaDcbxPortInstanceGroup.setObjects(
      *(("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIDCBXAdmin"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIDCBXOper"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIAdminDCPId"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIAdminDCPName"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPILocalModified"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIPFCDefense"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIPFCStatsClear"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIStatus"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIActionTaken"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIRowStatus"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIDCBXVersion"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIDCBXOperVersion"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIDCBXRemoteOperVersion"))
)
if mibBuilder.loadTexts:
...
alaDcbxPortInstancePriorityGroup.setObjects(
      *(("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIPrioTC"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIPrioPFCPacketsReceived"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPIPrioPFCPacketsTransmitted"))
)
if mibBuilder.loadTexts:
...
alaDcbxPfcUsageGroup.setObjects(
      *(("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPfcLLPrioritiesUsed"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPfcLLPrioritiesReserved"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPfcLLPrioritiesAvailable"))
)
if mibBuilder.loadTexts:
...
alaDcbxPfcUsageNewGroup.setObjects(
      *(("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPfcUsagePrioritiesUsed"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPfcUsagePrioritiesReserved"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPfcUsagePrioritiesAvailable"))
)
if mibBuilder.loadTexts:
...
alaXdot1dcbxAdminApplicationPriorityGroup.setObjects(
      *(("ALCATEL-ENT1-DCBX-MIB", "alaXdot1dcbxAdminApplicationPriorityAEPriority"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaXdot1dcbxAdminApplicationPriorityAppRowStatus"))
)
if mibBuilder.loadTexts:
...
alcatelIND1DcbxMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCProfileGroup"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxDCPTrafficClassGroup"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPortInstanceGroup"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPortInstancePriorityGroup"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPfcUsageGroup"),
        ("ALCATEL-ENT1-DCBX-MIB", "alaDcbxPfcUsageNewGroup"))
)
if mibBuilder.loadTexts:
