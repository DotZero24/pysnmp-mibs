...
mibBuilder.exportSymbols("HUAWEI-TS-MIB", tsTrap=tsTrap, tsAppName=tsAppName, tsTtyConnPrint=tsTtyConnPrint, tsLoginTty=tsLoginTty, tsAppPort=tsAppPort, tsTtyTestKey1=tsTtyTestKey1, tsTtyManageItemNum=tsTtyManageItemNum, tsClearTtyAll=tsClearTtyAll, tsAsyModeTtyDisconnect=tsAsyModeTtyDisconnect, tsTtyRedrawkey1=tsTtyRedrawkey1, tsTtyBufferSize=tsTtyBufferSize, tsAppStatusTrap=tsAppStatusTrap, EntryStatus=EntryStatus, tsTtyCurrentVtyID=tsTtyCurrentVtyID, tsAppClearStatistic=tsAppClearStatistic, tsAsyModeTtyVtyState=tsAsyModeTtyVtyState, tsTtyCurrentVtyRecv=tsTtyCurrentVtyRecv, tsTtyMenuKey3=tsTtyMenuKey3, tsTtyManageEntry=tsTtyManageEntry, tsAppLastRecvTime=tsAppLastRecvTime, tsAppIPAddress=tsAppIPAddress, tsTtyRedrawkey3=tsTtyRedrawkey3, tsClearSuccessTrap=tsClearSuccessTrap, tsAsyModeTtyEntry=tsAsyModeTtyEntry, tsTtyManageUnixIndex=tsTtyManageUnixIndex, tsDebugTtyAll=tsDebugTtyAll, tsAppSourceIP=tsAppSourceIP, tsDebugTtyBrief=tsDebugTtyBrief, tsTtyTcpRecvBufferSize=tsTtyTcpRecvBufferSize, tsTtyEntry=tsTtyEntry, tsAppLocalPort=tsAppLocalPort, tsAsyModeTtyStatus=tsAsyModeTtyStatus, tsTtyCurrentAppSend=tsTtyCurrentAppSend, tsTtyID=tsTtyID, tsTtyManageUnixSockid=tsTtyManageUnixSockid, tsTtySendBytes=tsTtySendBytes, tsTtyManageTable=tsTtyManageTable, tsAsyModeTtyIFIndex=tsAsyModeTtyIFIndex, tsTtyBufferRate=tsTtyBufferRate, tsTtyClearStatistic=tsTtyClearStatistic, tsAppSockSendByte=tsAppSockSendByte, tsEnableTrap=tsEnableTrap, tsAsyModeTtyVtyID=tsAsyModeTtyVtyID, tsTtyTestKey2=tsTtyTestKey2, tsAsyModeTtyID=tsAsyModeTtyID, tsTtyStatusTrap=tsTtyStatusTrap, tsExceptionTrap=tsExceptionTrap, tsAppSocketRecvBufSize=tsAppSocketRecvBufSize, tsTtyAutoLink=tsTtyAutoLink, tsDisconnectSuccessTrap=tsDisconnectSuccessTrap, tsAsyModeTtyTable=tsAsyModeTtyTable, tsAppSockRecvByte=tsAppSockRecvByte, tsTtyCurrentAppRecv=tsTtyCurrentAppRecv, tsTtyLogoPrint=tsTtyLogoPrint, tsTtyTestKey3=tsTtyTestKey3, tsAppLastSendTime=tsAppLastSendTime, tsTtyLastRecvTime=tsTtyLastRecvTime, tsTtyManageLocalIP=tsTtyManageLocalIP, tsTtyRedrawkey2=tsTtyRedrawkey2, tsDebugTtyGroup=tsDebugTtyGroup, tsTtyLastSendTime=tsTtyLastSendTime, tsAppTable=tsAppTable, tsAsyModeTtyAppID=tsAsyModeTtyAppID, tsTtyRecvBytes=tsTtyRecvBytes, tsTtyCurrentVtySend=tsTtyCurrentVtySend, tsTtyTcpSendBufferSize=tsTtyTcpSendBufferSize, tsTtyMenuKey2=tsTtyMenuKey2, tsTtyMenuKey1=tsTtyMenuKey1, tsEnable=tsEnable, tsAppSocketSendBufSize=tsAppSocketSendBufSize, tsTtyCurrentAppID=tsTtyCurrentAppID, tsTtyResetKey3=tsTtyResetKey3, tsAppTtyServerState=tsAppTtyServerState, tsTtyResetKey2=tsTtyResetKey2, tsAppType=tsAppType, tsTtyReadBlock=tsTtyReadBlock, tsDebugTtyTty=tsDebugTtyTty, tsTtyDelay=tsTtyDelay, tsAppID=tsAppID, tsTtyResetKey1=tsTtyResetKey1, tsTtyTable=tsTtyTable, tsDebugTtyError=tsDebugTtyError, tsAppUnixIndex=tsAppUnixIndex, tsAppStatus=tsAppStatus, terminalServer=terminalServer, tsTtyTcpNoDelay=tsTtyTcpNoDelay, tsDebugTtyManage=tsDebugTtyManage, tsDebugTtySock=tsDebugTtySock, tsTtyCloseLink=tsTtyCloseLink, tsAppEntry=tsAppEntry, tsAsyModeTtyFlowCtrlState=tsAsyModeTtyFlowCtrlState, tsDebugTtyTimeStamp=tsDebugTtyTimeStamp)
