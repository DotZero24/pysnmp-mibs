# SNMP MIB module (ARICENT-PVRST-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-PVRST-MIB
...
fsFuturePvrstPortEntry = _FsFuturePvrstPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1)
)
fsFuturePvrstPortEntry.setIndexNames(
    (0, "ARICENT-PVRST-MIB", "fsPvrstPort"),
)
if mibBuilder.loadTexts:
...
fsPvrstPortOperPointToPoint = _FsPvrstPortOperPointToPoint_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 10),
...
fsPvrstPortInvalidBpdusRcvd = _FsPvrstPortInvalidBpdusRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 11),
...
fsPvrstPortInvalidConfigBpduRxCount = _FsPvrstPortInvalidConfigBpduRxCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 12),
...
fsPvrstPortInvalidTcnBpduRxCount = _FsPvrstPortInvalidTcnBpduRxCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 13),
...
fsPvrstPortRowStatus = _FsPvrstPortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 14),
...
class _FsPvrstPortLoopGuard_Type(TruthValue):
    """Custom type fsPvrstPortLoopGuard based on TruthValue"""
    defaultValue = 2


_FsPvrstPortLoopGuard_Type.__name__ = "TruthValue"
_FsPvrstPortLoopGuard_Object = MibTableColumn
fsPvrstPortLoopGuard = _FsPvrstPortLoopGuard_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 15),
    _FsPvrstPortLoopGuard_Type()
)
fsPvrstPortLoopGuard.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPvrstPortLoopGuard.setStatus("current")


class _FsPvrstPortLoopInconsistentState_Type(TruthValue):
    """Custom type fsPvrstPortLoopInconsistentState based on TruthValue"""
    defaultValue = 2


_FsPvrstPortLoopInconsistentState_Type.__name__ = "TruthValue"
_FsPvrstPortLoopInconsistentState_Object = MibTableColumn
fsPvrstPortLoopInconsistentState = _FsPvrstPortLoopInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 16),
    _FsPvrstPortLoopInconsistentState_Type()
)
fsPvrstPortLoopInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPvrstPortLoopInconsistentState.setStatus("current")


class _FsPvrstPortEnableBPDURx_Type(TruthValue):
    """Custom type fsPvrstPortEnableBPDURx based on TruthValue"""
    defaultValue = 1


_FsPvrstPortEnableBPDURx_Type.__name__ = "TruthValue"
_FsPvrstPortEnableBPDURx_Object = MibTableColumn
fsPvrstPortEnableBPDURx = _FsPvrstPortEnableBPDURx_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 17),
    _FsPvrstPortEnableBPDURx_Type()
)
fsPvrstPortEnableBPDURx.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPvrstPortEnableBPDURx.setStatus("current")


class _FsPvrstPortEnableBPDUTx_Type(TruthValue):
    """Custom type fsPvrstPortEnableBPDUTx based on TruthValue"""
    defaultValue = 1


_FsPvrstPortEnableBPDUTx_Type.__name__ = "TruthValue"
_FsPvrstPortEnableBPDUTx_Object = MibTableColumn
fsPvrstPortEnableBPDUTx = _FsPvrstPortEnableBPDUTx_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 18),
    _FsPvrstPortEnableBPDUTx_Type()
)
fsPvrstPortEnableBPDUTx.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPvrstPortEnableBPDUTx.setStatus("current")


class _FsPvrstBpduFilter_Type(Integer32):
    """Custom type fsPvrstBpduFilter based on Integer32"""
    defaultValue = 1
...
_FsPvrstBpduFilter_Type.__name__ = "Integer32"
_FsPvrstBpduFilter_Object = MibTableColumn
fsPvrstBpduFilter = _FsPvrstBpduFilter_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 19),
    _FsPvrstBpduFilter_Type()
)
fsPvrstBpduFilter.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPvrstBpduFilter.setStatus("current")


class _FsPvrstPortAutoEdge_Type(TruthValue):
    """Custom type fsPvrstPortAutoEdge based on TruthValue"""
    defaultValue = 1


_FsPvrstPortAutoEdge_Type.__name__ = "TruthValue"
_FsPvrstPortAutoEdge_Object = MibTableColumn
fsPvrstPortAutoEdge = _FsPvrstPortAutoEdge_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 20),
    _FsPvrstPortAutoEdge_Type()
)
fsPvrstPortAutoEdge.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPvrstPortAutoEdge.setStatus("current")


class _FsPvrstPortBpduInconsistentState_Type(TruthValue):
    """Custom type fsPvrstPortBpduInconsistentState based on TruthValue"""
    defaultValue = 2


_FsPvrstPortBpduInconsistentState_Type.__name__ = "TruthValue"
_FsPvrstPortBpduInconsistentState_Object = MibTableColumn
fsPvrstPortBpduInconsistentState = _FsPvrstPortBpduInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 21),
    _FsPvrstPortBpduInconsistentState_Type()
)
fsPvrstPortBpduInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPvrstPortBpduInconsistentState.setStatus("current")


class _FsPvrstPortTypeInconsistentState_Type(TruthValue):
    """Custom type fsPvrstPortTypeInconsistentState based on TruthValue"""
    defaultValue = 2


_FsPvrstPortTypeInconsistentState_Type.__name__ = "TruthValue"
_FsPvrstPortTypeInconsistentState_Object = MibTableColumn
fsPvrstPortTypeInconsistentState = _FsPvrstPortTypeInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 22),
    _FsPvrstPortTypeInconsistentState_Type()
)
fsPvrstPortTypeInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPvrstPortTypeInconsistentState.setStatus("current")


class _FsPvrstPortPVIDInconsistentState_Type(TruthValue):
    """Custom type fsPvrstPortPVIDInconsistentState based on TruthValue"""
    defaultValue = 2


_FsPvrstPortPVIDInconsistentState_Type.__name__ = "TruthValue"
_FsPvrstPortPVIDInconsistentState_Object = MibTableColumn
fsPvrstPortPVIDInconsistentState = _FsPvrstPortPVIDInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 23),
    _FsPvrstPortPVIDInconsistentState_Type()
)
fsPvrstPortPVIDInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsPvrstPortPVIDInconsistentState.setStatus("current")


class _FsPvrstPortBpduGuardAction_Type(Integer32):
    """Custom type fsPvrstPortBpduGuardAction based on Integer32"""
    defaultValue = 1
...
_FsPvrstPortBpduGuardAction_Type.__name__ = "Integer32"
_FsPvrstPortBpduGuardAction_Object = MibTableColumn
fsPvrstPortBpduGuardAction = _FsPvrstPortBpduGuardAction_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 13, 1, 24),
    _FsPvrstPortBpduGuardAction_Type()
)
fsPvrstPortBpduGuardAction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPvrstPortBpduGuardAction.setStatus("current")
_FsPvrstInstBridgeTable_Object = MibTable
fsPvrstInstBridgeTable = _FsPvrstInstBridgeTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14)
)
if mibBuilder.loadTexts:
...
fsPvrstInstBridgeEntry = _FsPvrstInstBridgeEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1)
)
fsPvrstInstBridgeEntry.setIndexNames(
    (0, "ARICENT-PVRST-MIB", "fsPvrstInstVlanId"),
)
if mibBuilder.loadTexts:
...
fsPvrstInstTimeSinceTopologyChange = _FsPvrstInstTimeSinceTopologyChange_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 10),
...
fsPvrstInstTopChanges = _FsPvrstInstTopChanges_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 11),
...
fsPvrstInstNewRootCount = _FsPvrstInstNewRootCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 12),
...
fsPvrstInstInstanceUpCount = _FsPvrstInstInstanceUpCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 13),
...
fsPvrstInstInstanceDownCount = _FsPvrstInstInstanceDownCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 14),
...
fsPvrstInstPortRoleSelSemState = _FsPvrstInstPortRoleSelSemState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 15),
...
fsPvrstInstDesignatedRoot = _FsPvrstInstDesignatedRoot_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 16),
...
fsPvrstInstRootMaxAge = _FsPvrstInstRootMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 17),
...
fsPvrstInstRootHelloTime = _FsPvrstInstRootHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 18),
...
fsPvrstInstRootForwardDelay = _FsPvrstInstRootForwardDelay_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 14, 1, 19),
...
fsPvrstInstPortEntry = _FsPvrstInstPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1)
)
fsPvrstInstPortEntry.setIndexNames(
    (0, "ARICENT-PVRST-MIB", "fsPvrstInstVlanId"),
    (0, "ARICENT-PVRST-MIB", "fsPvrstInstPortIndex"),
)
if mibBuilder.loadTexts:
...
fsPvrstInstPortProtocolMigration = _FsPvrstInstPortProtocolMigration_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 9),
    _FsPvrstInstPortProtocolMigration_Type()
)
fsPvrstInstPortProtocolMigration.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
fsPvrstInstPortState = _FsPvrstInstPortState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 10),
...
fsPvrstInstPortForwardTransitions = _FsPvrstInstPortForwardTransitions_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 11),
...
fsPvrstInstPortReceivedBpdus = _FsPvrstInstPortReceivedBpdus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 12),
...
fsPvrstInstPortRxConfigBpduCount = _FsPvrstInstPortRxConfigBpduCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 13),
...
fsPvrstInstPortRxTcnBpduCount = _FsPvrstInstPortRxTcnBpduCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 14),
...
fsPvrstInstPortTransmittedBpdus = _FsPvrstInstPortTransmittedBpdus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 15),
...
fsPvrstInstPortTxConfigBpduCount = _FsPvrstInstPortTxConfigBpduCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 16),
...
fsPvrstInstPortTxTcnBpduCount = _FsPvrstInstPortTxTcnBpduCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 17),
...
fsPvrstInstPortTxSemState = _FsPvrstInstPortTxSemState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 18),
...
fsPvrstInstPortProtMigrationSemState = _FsPvrstInstPortProtMigrationSemState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 19),
...
fsPvrstInstProtocolMigrationCount = _FsPvrstInstProtocolMigrationCount_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 20),
...
fsPvrstInstPortRole = _FsPvrstInstPortRole_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 21),
...
fsPvrstInstCurrentPortRole = _FsPvrstInstCurrentPortRole_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 22),
...
fsPvrstInstPortInfoSemState = _FsPvrstInstPortInfoSemState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 23),
...
fsPvrstInstPortRoleTransitionSemState = _FsPvrstInstPortRoleTransitionSemState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 24),
...
fsPvrstInstPortStateTransitionSemState = _FsPvrstInstPortStateTransitionSemState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 25),
...
fsPvrstInstPortTopologyChangeSemState = _FsPvrstInstPortTopologyChangeSemState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 26),
...
fsPvrstInstPortEffectivePortState = _FsPvrstInstPortEffectivePortState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 27),
...
fsPvrstInstPortHelloTime = _FsPvrstInstPortHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 28),
...
fsPvrstInstPortMaxAge = _FsPvrstInstPortMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 29),
...
fsPvrstInstPortForwardDelay = _FsPvrstInstPortForwardDelay_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 30),
...
fsPvrstInstPortHoldTime = _FsPvrstInstPortHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 31),
...
fsPvrstInstPortAdminPathCost = _FsPvrstInstPortAdminPathCost_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 15, 1, 32),
...
class _FsPvrstForceProtocolVersion_Type(Integer32):
    """Custom type fsPvrstForceProtocolVersion based on Integer32"""
    defaultValue = 2
...
_FsPvrstForceProtocolVersion_Type.__name__ = "Integer32"
_FsPvrstForceProtocolVersion_Object = MibScalar
fsPvrstForceProtocolVersion = _FsPvrstForceProtocolVersion_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 1, 18),
    _FsPvrstForceProtocolVersion_Type()
)
fsPvrstForceProtocolVersion.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPvrstForceProtocolVersion.setStatus("current")
_FsPvrstTrapsControl_ObjectIdentity = ObjectIdentity
fsPvrstTrapsControl = _FsPvrstTrapsControl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 161, 2)
)
...
fsPvrstPortTrapNotificationEntry = _FsPvrstPortTrapNotificationEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 161, 2, 4, 1)
)
fsPvrstPortTrapNotificationEntry.setIndexNames(
    (0, "ARICENT-PVRST-MIB", "fsPvrstPortTrapIndex"),
)
if mibBuilder.loadTexts:
...
fsPvrstGenTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 161, 3, 0, 1)
)
fsPvrstGenTrap.setObjects(
      *(("ARICENT-PVRST-MIB", "fsPvrstBrgAddress"),
        ("ARICENT-PVRST-MIB", "fsPvrstGenTrapType"),
        ("ARICENT-PVRST-MIB", "fsPvrstInstInstanceUpCount"),
        ("ARICENT-PVRST-MIB", "fsPvrstInstInstanceDownCount"))
)
if mibBuilder.loadTexts:
...
fsPvrstErrTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 161, 3, 0, 2)
)
fsPvrstErrTrap.setObjects(
      *(("ARICENT-PVRST-MIB", "fsPvrstBrgAddress"),
        ("ARICENT-PVRST-MIB", "fsPvrstErrTrapType"))
)
if mibBuilder.loadTexts:
...
fsPvrstNewRootTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 161, 3, 0, 3)
)
fsPvrstNewRootTrap.setObjects(
      *(("ARICENT-PVRST-MIB", "fsPvrstBrgAddress"),
        ("ARICENT-PVRST-MIB", "fsPvrstInstDesignatedRoot"))
)
if mibBuilder.loadTexts:
...
fsPvrstTopologyChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 161, 3, 0, 4)
)
fsPvrstTopologyChgTrap.setObjects(
      *(("ARICENT-PVRST-MIB", "fsPvrstBrgAddress"),
        ("ARICENT-PVRST-MIB", "fsPvrstInstTopChanges"))
)
if mibBuilder.loadTexts:
...
fsPvrstProtocolMigrationTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 161, 3, 0, 5)
)
fsPvrstProtocolMigrationTrap.setObjects(
      *(("ARICENT-PVRST-MIB", "fsPvrstBrgAddress"),
        ("ARICENT-PVRST-MIB", "fsPvrstPortMigrationType"))
)
if mibBuilder.loadTexts:
...
fsPvrstInvalidBpduRxdTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 161, 3, 0, 6)
)
fsPvrstInvalidBpduRxdTrap.setObjects(
      *(("ARICENT-PVRST-MIB", "fsPvrstBrgAddress"),
        ("ARICENT-PVRST-MIB", "fsPvrstPktErrType"),
        ("ARICENT-PVRST-MIB", "fsPvrstPktErrVal"))
)
if mibBuilder.loadTexts:
...
fsPvrstNewPortRoleTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 161, 3, 0, 7)
)
fsPvrstNewPortRoleTrap.setObjects(
      *(("ARICENT-PVRST-MIB", "fsPvrstBrgAddress"),
        ("ARICENT-PVRST-MIB", "fsPvrstPortRoleType"),
        ("ARICENT-PVRST-MIB", "fsPvrstOldRoleType"))
)
if mibBuilder.loadTexts:
...
fsPvrstHwFailureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 161, 3, 0, 8)
)
fsPvrstHwFailureTrap.setObjects(
      *(("ARICENT-PVRST-MIB", "fsPvrstBrgAddress"),
        ("ARICENT-PVRST-MIB", "fsPvrstInstPortState"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"BridgeId": BridgeId,
       ...
       "fsPvrstPortLoopGuard": fsPvrstPortLoopGuard,
       "fsPvrstPortLoopInconsistentState": fsPvrstPortLoopInconsistentState,
       "fsPvrstPortEnableBPDURx": fsPvrstPortEnableBPDURx,
       "fsPvrstPortEnableBPDUTx": fsPvrstPortEnableBPDUTx,
       "fsPvrstBpduFilter": fsPvrstBpduFilter,
       "fsPvrstPortAutoEdge": fsPvrstPortAutoEdge,
       "fsPvrstPortBpduInconsistentState": fsPvrstPortBpduInconsistentState,
       "fsPvrstPortTypeInconsistentState": fsPvrstPortTypeInconsistentState,
       "fsPvrstPortPVIDInconsistentState": fsPvrstPortPVIDInconsistentState,
       "fsPvrstPortBpduGuardAction": fsPvrstPortBpduGuardAction,
       ...
       "fsPvrstForceProtocolVersion": fsPvrstForceProtocolVersion,
