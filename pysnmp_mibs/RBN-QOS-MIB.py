...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-QOS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:02 2025
...
rbnQosCompliance.setObjects(
    ("RBN-QOS-MIB", "rbnQosIfGroup")
)
if mibBuilder.loadTexts:
...
rbnQosCompliance2.setObjects(
      *(("RBN-QOS-MIB", "rbnQosIfGroup"),
        ("RBN-QOS-MIB", "rbnQosIfQueueGroup"))
)
if mibBuilder.loadTexts:
...
rbnQosCompliance3.setObjects(
      *(("RBN-QOS-MIB", "rbnQosIfGroup"),
        ("RBN-QOS-MIB", "rbnQosIfQueueGroup"),
        ("RBN-QOS-MIB", "rbnQosSubscriberQueueGroup"))
)
if mibBuilder.loadTexts:
...
rbnQosCompliance4.setObjects(
      *(("RBN-QOS-MIB", "rbnQosIfGroup"),
        ("RBN-QOS-MIB", "rbnQosIfQueueGroup"),
        ("RBN-QOS-MIB", "rbnQosSubscriberQueueGroup"),
        ("RBN-QOS-MIB", "rbnQosIfRLClassStatsGroup"),
        ("RBN-QOS-MIB", "rbnQosSubscriberRLClassStatsGroup"))
)
if mibBuilder.loadTexts:
...
rbnQosCompliance5.setObjects(
      *(("RBN-QOS-MIB", "rbnQosIfGroup"),
        ("RBN-QOS-MIB", "rbnQosIfQueueGroup"),
        ("RBN-QOS-MIB", "rbnQosSubscriberQueueGroup"),
        ("RBN-QOS-MIB", "rbnQosIfRLClassStatsGroup"),
        ("RBN-QOS-MIB", "rbnQosSubscriberRLClassStatsGroup"),
        ("RBN-QOS-MIB", "rbnQosHierarchicalPolicyStatsGroup"))
)
if mibBuilder.loadTexts:
