...
RowStatus, TextualConvention, StorageType, TestAndIncr, RowPointer, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "StorageType", "TestAndIncr", "RowPointer", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SNMP-USER-BASED-SM-MIB", usmMIBConformance=usmMIBConformance, usmStats=usmStats, usmUserEngineID=usmUserEngineID, usmMIBCompliances=usmMIBCompliances, usmUserPrivProtocol=usmUserPrivProtocol, usmUserPublic=usmUserPublic, usmHMACMD5AuthProtocol=usmHMACMD5AuthProtocol, usmUserPrivKeyChange=usmUserPrivKeyChange, usmUserSecurityName=usmUserSecurityName, usmUserName=usmUserName, usmStatsUnsupportedSecLevels=usmStatsUnsupportedSecLevels, snmpUsmMIB=snmpUsmMIB, usmUserTable=usmUserTable, usmUserSpinLock=usmUserSpinLock, usmMIBBasicGroup=usmMIBBasicGroup, usmMIBGroups=usmMIBGroups, usmStatsUnknownUserNames=usmStatsUnknownUserNames, usmStatsDecryptionErrors=usmStatsDecryptionErrors, usmStatsNotInTimeWindows=usmStatsNotInTimeWindows, usmHMACSHAAuthProtocol=usmHMACSHAAuthProtocol, PYSNMP_MODULE_ID=snmpUsmMIB, usmStatsWrongDigests=usmStatsWrongDigests, usmUserCloneFrom=usmUserCloneFrom, usmUser=usmUser, KeyChange=KeyChange, usmUserStorageType=usmUserStorageType, usmDESPrivProtocol=usmDESPrivProtocol, usmUserStatus=usmUserStatus, usmStatsUnknownEngineIDs=usmStatsUnknownEngineIDs, usmUserAuthKeyChange=usmUserAuthKeyChange, usmUserAuthProtocol=usmUserAuthProtocol, usmNoPrivProtocol=usmNoPrivProtocol, usmMIBCompliance=usmMIBCompliance, usmUserEntry=usmUserEntry, usmUserOwnPrivKeyChange=usmUserOwnPrivKeyChange, usmNoAuthProtocol=usmNoAuthProtocol, usmUserOwnAuthKeyChange=usmUserOwnAuthKeyChange, usmMIBObjects=usmMIBObjects)
