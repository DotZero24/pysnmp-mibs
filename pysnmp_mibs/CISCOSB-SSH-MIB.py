...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/ciscosb/CISCOSB-SSH-MIB
...
rlSshServerLoggingEnable = MibScalar((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 78, 2, 109), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: rlSshServerLoggingEnable.setStatus('current')
