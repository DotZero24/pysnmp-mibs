...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-SSH-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:41:09 2025
...
class _RlSshServerLoggingEnable_Type(Integer32):
    """Custom type rlSshServerLoggingEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_RlSshServerLoggingEnable_Type.__name__ = "Integer32"
_RlSshServerLoggingEnable_Object = MibScalar
rlSshServerLoggingEnable = _RlSshServerLoggingEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 78, 2, 109),
    _RlSshServerLoggingEnable_Type()
)
rlSshServerLoggingEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlSshServerLoggingEnable.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlSshPublicKeyAlgorithm": RlSshPublicKeyAlgorithm,
       ...
       "rlSshServerLoggingEnable": rlSshServerLoggingEnable,
