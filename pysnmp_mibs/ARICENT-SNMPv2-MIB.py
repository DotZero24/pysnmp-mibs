...
snmpListenPort=_SnmpListenPort_Object((1,3,6,1,4,1,2076,50,1),_SnmpListenPort_Type())
...
snmpListenTrapPort=_SnmpListenTrapPort_Object((1,3,6,1,4,1,2076,50,2),_SnmpListenTrapPort_Type())
...
snmpCommunityTable=_SnmpCommunityTable_Object((1,3,6,1,4,1,2076,50,3))
if mibBuilder.loadTexts:snmpCommunityTable.setStatus(_A)
_SnmpCommunityEntry_Object=MibTableRow
snmpCommunityEntry=_SnmpCommunityEntry_Object((1,3,6,1,4,1,2076,50,3,1))
...
snmpCommunityIndex=_SnmpCommunityIndex_Object((1,3,6,1,4,1,2076,50,3,1,1),_SnmpCommunityIndex_Type())
...
snmpCommunityName=_SnmpCommunityName_Object((1,3,6,1,4,1,2076,50,3,1,2),_SnmpCommunityName_Type())
...
snmpCommunityPrivilege=_SnmpCommunityPrivilege_Object((1,3,6,1,4,1,2076,50,3,1,3),_SnmpCommunityPrivilege_Type())
...
snmpCommunityIpAddr=_SnmpCommunityIpAddr_Object((1,3,6,1,4,1,2076,50,3,1,4),_SnmpCommunityIpAddr_Type())
...
snmpStatus=_SnmpStatus_Object((1,3,6,1,4,1,2076,50,3,1,5),_SnmpStatus_Type())
snmpStatus.setMaxAccess(_I)
if mibBuilder.loadTexts:snmpStatus.setStatus(_A)
_SnmpTrapTable_Object=MibTable
snmpTrapTable=_SnmpTrapTable_Object((1,3,6,1,4,1,2076,50,4))
if mibBuilder.loadTexts:snmpTrapTable.setStatus(_A)
_SnmpTrapEntry_Object=MibTableRow
snmpTrapEntry=_SnmpTrapEntry_Object((1,3,6,1,4,1,2076,50,4,1))
...
snmpTrapIndex=_SnmpTrapIndex_Object((1,3,6,1,4,1,2076,50,4,1,1),_SnmpTrapIndex_Type())
...
snmpTrapCommunityName=_SnmpTrapCommunityName_Object((1,3,6,1,4,1,2076,50,4,1,2),_SnmpTrapCommunityName_Type())
...
snmpTrapIpAddr=_SnmpTrapIpAddr_Object((1,3,6,1,4,1,2076,50,4,1,3),_SnmpTrapIpAddr_Type())
...
snmpTrapMgrType=_SnmpTrapMgrType_Object((1,3,6,1,4,1,2076,50,4,1,4),_SnmpTrapMgrType_Type())
...
snmpTrapStatus=_SnmpTrapStatus_Object((1,3,6,1,4,1,2076,50,4,1,5),_SnmpTrapStatus_Type())
