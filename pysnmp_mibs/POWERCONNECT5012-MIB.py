...
_Powerconnect5012_ObjectIdentity=ObjectIdentity
powerconnect5012=_Powerconnect5012_ObjectIdentity((1,3,6,1,4,1,674,10895,2))
_DellCommGroup_ObjectIdentity=ObjectIdentity
dellCommGroup=_DellCommGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,2,1))
_CommTable_Object=MibTable
commTable=_CommTable_Object((1,3,6,1,4,1,674,10895,2,1,1))
if mibBuilder.loadTexts:commTable.setStatus(_A)
_CommEntry_Object=MibTableRow
commEntry=_CommEntry_Object((1,3,6,1,4,1,674,10895,2,1,1,1))
...
commIndex=_CommIndex_Object((1,3,6,1,4,1,674,10895,2,1,1,1,1),_CommIndex_Type())
...
commName=_CommName_Object((1,3,6,1,4,1,674,10895,2,1,1,1,2),_CommName_Type())
...
commGet=_CommGet_Object((1,3,6,1,4,1,674,10895,2,1,1,1,3),_CommGet_Type())
...
commSet=_CommSet_Object((1,3,6,1,4,1,674,10895,2,1,1,1,4),_CommSet_Type())
...
commTrap=_CommTrap_Object((1,3,6,1,4,1,674,10895,2,1,1,1,5),_CommTrap_Type())
...
commStatus=_CommStatus_Object((1,3,6,1,4,1,674,10895,2,1,1,1,6),_CommStatus_Type())
commStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:commStatus.setStatus(_A)
_DellHostGroup_ObjectIdentity=ObjectIdentity
dellHostGroup=_DellHostGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,2,2))
_HostTable_Object=MibTable
hostTable=_HostTable_Object((1,3,6,1,4,1,674,10895,2,2,1))
if mibBuilder.loadTexts:hostTable.setStatus(_A)
_HostEntry_Object=MibTableRow
hostEntry=_HostEntry_Object((1,3,6,1,4,1,674,10895,2,2,1,1))
...
hostIndex=_HostIndex_Object((1,3,6,1,4,1,674,10895,2,2,1,1,1),_HostIndex_Type())
...
hostName=_HostName_Object((1,3,6,1,4,1,674,10895,2,2,1,1,2),_HostName_Type())
hostName.setMaxAccess(_B)
if mibBuilder.loadTexts:hostName.setStatus(_A)
_HostIP_Type=IpAddress
_HostIP_Object=MibTableColumn
hostIP=_HostIP_Object((1,3,6,1,4,1,674,10895,2,2,1,1,3),_HostIP_Type())
...
hostComm=_HostComm_Object((1,3,6,1,4,1,674,10895,2,2,1,1,4),_HostComm_Type())
...
hostStatus=_HostStatus_Object((1,3,6,1,4,1,674,10895,2,2,1,1,5),_HostStatus_Type())
...
hostAuthorization=_HostAuthorization_Object((1,3,6,1,4,1,674,10895,2,2,2),_HostAuthorization_Type())
...
dellMiscGroup=_DellMiscGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,2,3))
_MiscBaud_Type=Integer32
_MiscBaud_Object=MibScalar
miscBaud=_MiscBaud_Object((1,3,6,1,4,1,674,10895,2,3,1),_MiscBaud_Type())
...
miscReset=_MiscReset_Object((1,3,6,1,4,1,674,10895,2,3,2),_MiscReset_Type())
...
miscStatisticsReset=_MiscStatisticsReset_Object((1,3,6,1,4,1,674,10895,2,3,3),_MiscStatisticsReset_Type())
...
miscSwitchOperState=_MiscSwitchOperState_Object((1,3,6,1,4,1,674,10895,2,3,4),_MiscSwitchOperState_Type())
...
dellSpanGroup=_DellSpanGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,2,4))
...
spanOnOff=_SpanOnOff_Object((1,3,6,1,4,1,674,10895,2,4,1),_SpanOnOff_Type())
spanOnOff.setMaxAccess(_B)
if mibBuilder.loadTexts:spanOnOff.setStatus(_A)
_DellConfigGroup_ObjectIdentity=ObjectIdentity
dellConfigGroup=_DellConfigGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,2,11))
...
configVerSwPrimary=_ConfigVerSwPrimary_Object((1,3,6,1,4,1,674,10895,2,11,1),_ConfigVerSwPrimary_Type())
...
configVerHwChipSet=_ConfigVerHwChipSet_Object((1,3,6,1,4,1,674,10895,2,11,2),_ConfigVerHwChipSet_Type())
...
configBootMode=_ConfigBootMode_Object((1,3,6,1,4,1,674,10895,2,11,3),_ConfigBootMode_Type())
...
configBootFtpServerIp=_ConfigBootFtpServerIp_Object((1,3,6,1,4,1,674,10895,2,11,4),_ConfigBootFtpServerIp_Type())
...
configBootImageFileName=_ConfigBootImageFileName_Object((1,3,6,1,4,1,674,10895,2,11,5),_ConfigBootImageFileName_Type())
...
configPortTable=_ConfigPortTable_Object((1,3,6,1,4,1,674,10895,2,11,6))
if mibBuilder.loadTexts:configPortTable.setStatus(_A)
_ConfigPortEntry_Object=MibTableRow
configPortEntry=_ConfigPortEntry_Object((1,3,6,1,4,1,674,10895,2,11,6,1))
...
configPort=_ConfigPort_Object((1,3,6,1,4,1,674,10895,2,11,6,1,1),_ConfigPort_Type())
...
configPortDuplex=_ConfigPortDuplex_Object((1,3,6,1,4,1,674,10895,2,11,6,1,3),_ConfigPortDuplex_Type())
...
configPortRuntFilt=_ConfigPortRuntFilt_Object((1,3,6,1,4,1,674,10895,2,11,6,1,4),_ConfigPortRuntFilt_Type())
...
configPortSrcSecurity=_ConfigPortSrcSecurity_Object((1,3,6,1,4,1,674,10895,2,11,6,1,5),_ConfigPortSrcSecurity_Type())
...
configPortDataRate=_ConfigPortDataRate_Object((1,3,6,1,4,1,674,10895,2,11,6,1,6),_ConfigPortDataRate_Type())
...
configForwardingMode=_ConfigForwardingMode_Object((1,3,6,1,4,1,674,10895,2,11,6,1,7),_ConfigForwardingMode_Type())
...
configPortDuplexOper=_ConfigPortDuplexOper_Object((1,3,6,1,4,1,674,10895,2,11,6,1,8),_ConfigPortDuplexOper_Type())
...
configPortDataRateOper=_ConfigPortDataRateOper_Object((1,3,6,1,4,1,674,10895,2,11,6,1,9),_ConfigPortDataRateOper_Type())
...
configPortStateOper=_ConfigPortStateOper_Object((1,3,6,1,4,1,674,10895,2,11,6,1,10),_ConfigPortStateOper_Type())
...
configPortFlowControl=_ConfigPortFlowControl_Object((1,3,6,1,4,1,674,10895,2,11,6,1,11),_ConfigPortFlowControl_Type())
...
configPortDefaultVlanId=_ConfigPortDefaultVlanId_Object((1,3,6,1,4,1,674,10895,2,11,6,1,12),_ConfigPortDefaultVlanId_Type())
...
configPortComments=_ConfigPortComments_Object((1,3,6,1,4,1,674,10895,2,11,6,1,13),_ConfigPortComments_Type())
...
configPortAutoNegotiation=_ConfigPortAutoNegotiation_Object((1,3,6,1,4,1,674,10895,2,11,6,1,14),_ConfigPortAutoNegotiation_Type())
...
configPortHOLBlocking=_ConfigPortHOLBlocking_Object((1,3,6,1,4,1,674,10895,2,11,6,1,15),_ConfigPortHOLBlocking_Type())
...
configPortFlowControlOper=_ConfigPortFlowControlOper_Object((1,3,6,1,4,1,674,10895,2,11,6,1,16),_ConfigPortFlowControlOper_Type())
...
configPortGBIC=_ConfigPortGBIC_Object((1,3,6,1,4,1,674,10895,2,11,6,1,17),_ConfigPortGBIC_Type())
...
configPortFastLink=_ConfigPortFastLink_Object((1,3,6,1,4,1,674,10895,2,11,6,1,18),_ConfigPortFastLink_Type())
...
configPortPriority=_ConfigPortPriority_Object((1,3,6,1,4,1,674,10895,2,11,6,1,19),_ConfigPortPriority_Type())
...
configRmonOnOff=_ConfigRmonOnOff_Object((1,3,6,1,4,1,674,10895,2,11,7),_ConfigRmonOnOff_Type())
...
configMirroringOnOff=_ConfigMirroringOnOff_Object((1,3,6,1,4,1,674,10895,2,11,8),_ConfigMirroringOnOff_Type())
...
configMirrorSrc=_ConfigMirrorSrc_Object((1,3,6,1,4,1,674,10895,2,11,9),_ConfigMirrorSrc_Type())
...
configMirrorMon=_ConfigMirrorMon_Object((1,3,6,1,4,1,674,10895,2,11,10),_ConfigMirrorMon_Type())
...
configIpAssignmentMode=_ConfigIpAssignmentMode_Object((1,3,6,1,4,1,674,10895,2,11,12),_ConfigIpAssignmentMode_Type())
...
configPhysAddress=_ConfigPhysAddress_Object((1,3,6,1,4,1,674,10895,2,11,13),_ConfigPhysAddress_Type())
...
configPasswordUser=_ConfigPasswordUser_Object((1,3,6,1,4,1,674,10895,2,11,14),_ConfigPasswordUser_Type())
...
configPasswordAdmin=_ConfigPasswordAdmin_Object((1,3,6,1,4,1,674,10895,2,11,15),_ConfigPasswordAdmin_Type())
...
configIpAddress=_ConfigIpAddress_Object((1,3,6,1,4,1,674,10895,2,11,16),_ConfigIpAddress_Type())
...
configNetMask=_ConfigNetMask_Object((1,3,6,1,4,1,674,10895,2,11,17),_ConfigNetMask_Type())
...
configGateway=_ConfigGateway_Object((1,3,6,1,4,1,674,10895,2,11,18),_ConfigGateway_Type())
...
configSave=_ConfigSave_Object((1,3,6,1,4,1,674,10895,2,11,19),_ConfigSave_Type())
...
configVerifyPassword=_ConfigVerifyPassword_Object((1,3,6,1,4,1,674,10895,2,11,20),_ConfigVerifyPassword_Type())
...
configVerBootRomImage=_ConfigVerBootRomImage_Object((1,3,6,1,4,1,674,10895,2,11,21),_ConfigVerBootRomImage_Type())
...
configRestoreDefaults=_ConfigRestoreDefaults_Object((1,3,6,1,4,1,674,10895,2,11,22),_ConfigRestoreDefaults_Type())
...
configIGMPOnOff=_ConfigIGMPOnOff_Object((1,3,6,1,4,1,674,10895,2,11,23),_ConfigIGMPOnOff_Type())
...
configWebOnOff=_ConfigWebOnOff_Object((1,3,6,1,4,1,674,10895,2,11,24),_ConfigWebOnOff_Type())
...
configHighPriorityOptimization=_ConfigHighPriorityOptimization_Object((1,3,6,1,4,1,674,10895,2,11,25),_ConfigHighPriorityOptimization_Type())
...
configDynamicAddressLearning=_ConfigDynamicAddressLearning_Object((1,3,6,1,4,1,674,10895,2,11,26),_ConfigDynamicAddressLearning_Type())
...
configUserAuthenticationMode=_ConfigUserAuthenticationMode_Object((1,3,6,1,4,1,674,10895,2,11,27),_ConfigUserAuthenticationMode_Type())
...
configRadiusServerIpAddress=_ConfigRadiusServerIpAddress_Object((1,3,6,1,4,1,674,10895,2,11,28),_ConfigRadiusServerIpAddress_Type())
...
configRadiusSharedSecret=_ConfigRadiusSharedSecret_Object((1,3,6,1,4,1,674,10895,2,11,29),_ConfigRadiusSharedSecret_Type())
...
configTelnetConsole=_ConfigTelnetConsole_Object((1,3,6,1,4,1,674,10895,2,11,30),_ConfigTelnetConsole_Type())
...
configDiffServTable=_ConfigDiffServTable_Object((1,3,6,1,4,1,674,10895,2,11,31))
if mibBuilder.loadTexts:configDiffServTable.setStatus(_A)
_ConfigDiffServEntry_Object=MibTableRow
configDiffServEntry=_ConfigDiffServEntry_Object((1,3,6,1,4,1,674,10895,2,11,31,1))
...
configDiffServDSCP=_ConfigDiffServDSCP_Object((1,3,6,1,4,1,674,10895,2,11,31,1,1),_ConfigDiffServDSCP_Type())
...
configDiffServPriority=_ConfigDiffServPriority_Object((1,3,6,1,4,1,674,10895,2,11,31,1,2),_ConfigDiffServPriority_Type())
...
configTftpServerIpAddress=_ConfigTftpServerIpAddress_Object((1,3,6,1,4,1,674,10895,2,11,32),_ConfigTftpServerIpAddress_Type())
...
configTftpServerFileName=_ConfigTftpServerFileName_Object((1,3,6,1,4,1,674,10895,2,11,33),_ConfigTftpServerFileName_Type())
...
configTftpOperation=_ConfigTftpOperation_Object((1,3,6,1,4,1,674,10895,2,11,34),_ConfigTftpOperation_Type())
...
configIpFilter=_ConfigIpFilter_Object((1,3,6,1,4,1,674,10895,2,11,35),_ConfigIpFilter_Type())
configIpFilter.setMaxAccess(_B)
if mibBuilder.loadTexts:configIpFilter.setStatus(_A)
_ConfigIpFilterTable_Object=MibTable
configIpFilterTable=_ConfigIpFilterTable_Object((1,3,6,1,4,1,674,10895,2,11,36))
if mibBuilder.loadTexts:configIpFilterTable.setStatus(_A)
_ConfigIpFilterEntry_Object=MibTableRow
configIpFilterEntry=_ConfigIpFilterEntry_Object((1,3,6,1,4,1,674,10895,2,11,36,1))
...
configIpFilterIpAddress=_ConfigIpFilterIpAddress_Object((1,3,6,1,4,1,674,10895,2,11,36,1,1),_ConfigIpFilterIpAddress_Type())
...
configIpFilterStatus=_ConfigIpFilterStatus_Object((1,3,6,1,4,1,674,10895,2,11,36,1,2),_ConfigIpFilterStatus_Type())
...
dellVlanGroup=_DellVlanGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,2,13))
_VlanTable_Object=MibTable
vlanTable=_VlanTable_Object((1,3,6,1,4,1,674,10895,2,13,1))
if mibBuilder.loadTexts:vlanTable.setStatus(_A)
_VlanEntry_Object=MibTableRow
vlanEntry=_VlanEntry_Object((1,3,6,1,4,1,674,10895,2,13,1,1))
...
vlanId=_VlanId_Object((1,3,6,1,4,1,674,10895,2,13,1,1,1),_VlanId_Type())
...
vlanName=_VlanName_Object((1,3,6,1,4,1,674,10895,2,13,1,1,2),_VlanName_Type())
...
vlanStatus=_VlanStatus_Object((1,3,6,1,4,1,674,10895,2,13,1,1,3),_VlanStatus_Type())
vlanStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:vlanStatus.setStatus(_A)
_VlanPortTable_Object=MibTable
vlanPortTable=_VlanPortTable_Object((1,3,6,1,4,1,674,10895,2,13,2))
if mibBuilder.loadTexts:vlanPortTable.setStatus(_A)
_VlanPortEntry_Object=MibTableRow
vlanPortEntry=_VlanPortEntry_Object((1,3,6,1,4,1,674,10895,2,13,2,1))
...
vlanPortPortId=_VlanPortPortId_Object((1,3,6,1,4,1,674,10895,2,13,2,1,1),_VlanPortPortId_Type())
...
vlanPortVlanId=_VlanPortVlanId_Object((1,3,6,1,4,1,674,10895,2,13,2,1,2),_VlanPortVlanId_Type())
...
vlanPortStatus=_VlanPortStatus_Object((1,3,6,1,4,1,674,10895,2,13,2,1,3),_VlanPortStatus_Type())
...
vlanPortTaggedMode=_VlanPortTaggedMode_Object((1,3,6,1,4,1,674,10895,2,13,2,1,4),_VlanPortTaggedMode_Type())
...
dellPortTrunkGroup=_DellPortTrunkGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,2,14))
_PortTrunkTable_Object=MibTable
portTrunkTable=_PortTrunkTable_Object((1,3,6,1,4,1,674,10895,2,14,1))
if mibBuilder.loadTexts:portTrunkTable.setStatus(_A)
_PortTrunkEntry_Object=MibTableRow
portTrunkEntry=_PortTrunkEntry_Object((1,3,6,1,4,1,674,10895,2,14,1,1))
...
portTrunkId=_PortTrunkId_Object((1,3,6,1,4,1,674,10895,2,14,1,1,1),_PortTrunkId_Type())
...
portTrunkMember=_PortTrunkMember_Object((1,3,6,1,4,1,674,10895,2,14,1,1,2),_PortTrunkMember_Type())
...
portTrunkMemberValue=_PortTrunkMemberValue_Object((1,3,6,1,4,1,674,10895,2,14,1,1,3),_PortTrunkMemberValue_Type())
