...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LWAPP-LINKTEST-MIB
...
_CLLtResponder_Type.__name__ = "TruthValue"
...
ciscoLwappLinkTestMIBCompliance.setObjects(
      *(("CISCO-LWAPP-LINKTEST-MIB", "cLLinkTestConfigGroup"),
        ("CISCO-LWAPP-LINKTEST-MIB", "cLLinkTestRunsGroup"),
        ("CISCO-LWAPP-LINKTEST-MIB", "cLLinkTestStatusGroup"))
)
if mibBuilder.loadTexts:
