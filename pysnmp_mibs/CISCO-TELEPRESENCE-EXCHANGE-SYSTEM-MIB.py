...
mibBuilder.exportSymbols("CISCO-TELEPRESENCE-EXCHANGE-SYSTEM-MIB", ctxClusterNodeEntry=ctxClusterNodeEntry, ctxClusterNodeIPType=ctxClusterNodeIPType, ctxResourceStatsTable=ctxResourceStatsTable, ctxPeakHistIntTime=ctxPeakHistIntTime, CtxResourceOperState=CtxResourceOperState, ciscoCTXSysErrorHistoryEvent=ciscoCTXSysErrorHistoryEvent, ctxSipConfigTable=ctxSipConfigTable, ctxRegionStatsEntry=ctxRegionStatsEntry, ctxPeakHistAllocEntry=ctxPeakHistAllocEntry, ctxPeakHistAllocPoolTable=ctxPeakHistAllocPoolTable, ctxMeetingConfigInterOpMaxId=ctxMeetingConfigInterOpMaxId, ctxErrorTimeStamp=ctxErrorTimeStamp, ciscoCTXSysResourceAllocFailure=ciscoCTXSysResourceAllocFailure, ctxPeakHistAllocTable=ctxPeakHistAllocTable, ctxNotifyObjects=ctxNotifyObjects, ctxServiceProviderEntry=ctxServiceProviderEntry, ctxResourceOperState=ctxResourceOperState, ctxEventHistory=ctxEventHistory, ctxAllocPoolAllocOutOfPorts=ctxAllocPoolAllocOutOfPorts, ctxSystemStatusObjects=ctxSystemStatusObjects, ctxRegionIndex=ctxRegionIndex, CtxSIPProtocolType=CtxSIPProtocolType, ciscoTelepresenceExchangeSystemMIBConfigGroup=ciscoTelepresenceExchangeSystemMIBConfigGroup, CtxIndex=CtxIndex, ciscoTelepresenceExchangeSystemMIBNotifyGroup=ciscoTelepresenceExchangeSystemMIBNotifyGroup, ctxMeetingConfigInterOpMinId=ctxMeetingConfigInterOpMinId, ctxAllocActivePorts=ctxAllocActivePorts, ctxClusterNodeAlarmNotifyEnable=ctxClusterNodeAlarmNotifyEnable, ciscoCTXSysSystemConfigStatusChg=ciscoCTXSysSystemConfigStatusChg, ctxErrorHistoryEntry=ctxErrorHistoryEntry, ctxResourceDescr=ctxResourceDescr, ctxOrganizationDirectDial=ctxOrganizationDirectDial, CtxClusterNodeTypes=CtxClusterNodeTypes, ctxAllocFailures=ctxAllocFailures, CtxKeyId=CtxKeyId, ctxResourceEntry=ctxResourceEntry, ctxAdminServersStatus=ctxAdminServersStatus, ctxDatabaseServersStatus=ctxDatabaseServersStatus, ctxClusterNodeType=ctxClusterNodeType, ctxSipIpAddr=ctxSipIpAddr, ctxServiceProviderIndex=ctxServiceProviderIndex, ctxAllocPoolActivePorts=ctxAllocPoolActivePorts, CtxResourceType=CtxResourceType, ctxOrganizationDescr=ctxOrganizationDescr, ctxPeakHistAllocIntIndex=ctxPeakHistAllocIntIndex, ciscoCTXSysResourceDown=ciscoCTXSysResourceDown, ciscoCTXSysCallSetupFailure=ciscoCTXSysCallSetupFailure, ctxPeakHistAllocPoolIntIndex=ctxPeakHistAllocPoolIntIndex, ctxServiceProviderName=ctxServiceProviderName, ctxRegionTable=ctxRegionTable, ctxRegionStatsTable=ctxRegionStatsTable, ciscoCTXSysClusterNodeUp=ciscoCTXSysClusterNodeUp, ctxResourceTable=ctxResourceTable, ctxOrganizationMaxPorts=ctxOrganizationMaxPorts, ctxRegionName=ctxRegionName, ctxPeakHistAllocTS=ctxPeakHistAllocTS, ctxErrorAttrValStr=ctxErrorAttrValStr, ciscoCTXSysDatabaseServersStatusChg=ciscoCTXSysDatabaseServersStatusChg, ctxErrorHistoryLastIndex=ctxErrorHistoryLastIndex, ctxConfigObjects=ctxConfigObjects, ctxMediaCapacityConfigEntry=ctxMediaCapacityConfigEntry, ctxAllocStatsEntry=ctxAllocStatsEntry, ctxResourceObjects=ctxResourceObjects, ciscoCTXSysClusterNodeDown=ciscoCTXSysClusterNodeDown, ctxPeakHistAllocPoolPorts=ctxPeakHistAllocPoolPorts, ctxServiceProviderDescr=ctxServiceProviderDescr, ctxAuthFailureNotifyEnable=ctxAuthFailureNotifyEnable, ctxErrorIndex=ctxErrorIndex, ctxStatisticsObjects=ctxStatisticsObjects, ciscoTelePresenceExchangeSystemMIBStatsGroup=ciscoTelePresenceExchangeSystemMIBStatsGroup, ctxResourceStatsEntry=ctxResourceStatsEntry, ctxServiceProviderTable=ctxServiceProviderTable, CtxHealthStates=CtxHealthStates, ciscoCTXSysCallEnginesStatusChg=ciscoCTXSysCallEnginesStatusChg, ciscoTelepresenceExchangeSystemMIBStatusGroup=ciscoTelepresenceExchangeSystemMIBStatusGroup, ctxAllocPoolAvailPorts=ctxAllocPoolAvailPorts, ctxRegionCallSetupFailures=ctxRegionCallSetupFailures, ctxAllocAvailPorts=ctxAllocAvailPorts, ctxErrorMessage=ctxErrorMessage, ctxCallFailureNotifyEnable=ctxCallFailureNotifyEnable, ctxClusterNodeTable=ctxClusterNodeTable, ctxAllocPeakHistory=ctxAllocPeakHistory, ctxResourceStatus=ctxResourceStatus, ctxSystemConfigStatus=ctxSystemConfigStatus, ctxOrganizationTable=ctxOrganizationTable, ctxPeakHistAllocPoolTS=ctxPeakHistAllocPoolTS, ciscoCTXSysAdminServersStatusChg=ciscoCTXSysAdminServersStatusChg, ctxClusterNodeOperState=ctxClusterNodeOperState, ctxOrganizationKey=ctxOrganizationKey, ctxPeakHistMaxIntervals=ctxPeakHistMaxIntervals, ctxPeakHistAllocPorts=ctxPeakHistAllocPorts, ctxResourceName=ctxResourceName, ciscoTelepresenceExchangeSystemMIBCompliances=ciscoTelepresenceExchangeSystemMIBCompliances, ciscoTelepresenceExchangeSystemMIBGroups=ciscoTelepresenceExchangeSystemMIBGroups, ctxSipTransportProto=ctxSipTransportProto, ctxStatusChangeNotifyEnable=ctxStatusChangeNotifyEnable, ctxSipConfigEntry=ctxSipConfigEntry, ctxNotifyConfigObjects=ctxNotifyConfigObjects, ctxClusterNodeHostName=ctxClusterNodeHostName, ciscoCTXSysResourceUp=ciscoCTXSysResourceUp, ciscoTelepresenceExchangeSystemMIBObjects=ciscoTelepresenceExchangeSystemMIBObjects, ctxSystemBackupStatus=ctxSystemBackupStatus, ctxOrganizationServiceProviderKeyRef1=ctxOrganizationServiceProviderKeyRef1, ciscoCTXSysSystemBackupStatusChg=ciscoCTXSysSystemBackupStatusChg, ctxErrorHistoryEventNotifyEnable=ctxErrorHistoryEventNotifyEnable, ctxAllocStatsTable=ctxAllocStatsTable, ctxResourceCallSetupFailures=ctxResourceCallSetupFailures, ctxRegionEntry=ctxRegionEntry, ctxResourceUnavailDuration=ctxResourceUnavailDuration, ciscoTelepresenceExchangeSystemMIBNotifs=ciscoTelepresenceExchangeSystemMIBNotifs, ctxMeetingConfigTable=ctxMeetingConfigTable, ctxMediaCapacityLargeMeeting=ctxMediaCapacityLargeMeeting, ctxSipIpType=ctxSipIpType, ctxMediaCapacityConfigTable=ctxMediaCapacityConfigTable, ctxResourceKey=ctxResourceKey, ctxResourceMgmtIPType=ctxResourceMgmtIPType, ctxPeakHistAllocPoolEntry=ctxPeakHistAllocPoolEntry, ctxNotifyMessage=ctxNotifyMessage, ctxErrorHistoryTableSize=ctxErrorHistoryTableSize, ctxServiceProviderHDNumber=ctxServiceProviderHDNumber, ciscoTelepresenceExchangeSystemMIBErrorHistoryGroup=ciscoTelepresenceExchangeSystemMIBErrorHistoryGroup, ctxErrorAppName=ctxErrorAppName, ciscoCTXSysLicenseFailure=ciscoCTXSysLicenseFailure, ctxAllocOutOfPorts=ctxAllocOutOfPorts, ctxClusterNodeKey=ctxClusterNodeKey, ciscoTelepresenceExchangeSystemMIB=ciscoTelepresenceExchangeSystemMIB, ctxErrorSeverity=ctxErrorSeverity, ctxResourceAlarmNotifyEnable=ctxResourceAlarmNotifyEnable, ctxResourceRegionKeyRef1=ctxResourceRegionKeyRef1, ciscoTelepresenceExchangeSystemMIBNotfyObjectsGroup=ciscoTelepresenceExchangeSystemMIBNotfyObjectsGroup, ctxOrganizationName=ctxOrganizationName, ctxCallEnginesStatus=ctxCallEnginesStatus, ctxErrorHistoryMaxSeverity=ctxErrorHistoryMaxSeverity, ctxRegionDescr=ctxRegionDescr, ctxResourceDeviceType=ctxResourceDeviceType, ctxClusterNodeName=ctxClusterNodeName, ctxResourceMgmtIPAddr=ctxResourceMgmtIPAddr, ctxMediaCapacityMaxPorts=ctxMediaCapacityMaxPorts, ctxMeetingConfigStaticMaxId=ctxMeetingConfigStaticMaxId, PYSNMP_MODULE_ID=ciscoTelepresenceExchangeSystemMIB, ctxOrganizationEntry=ctxOrganizationEntry, ctxErrorKey=ctxErrorKey, ctxOrganizationIndex=ctxOrganizationIndex, ctxSipPort=ctxSipPort, ctxMeetingConfigEntry=ctxMeetingConfigEntry, ciscoTelepresenceExchangeSystemMIBModuleCompliance=ciscoTelepresenceExchangeSystemMIBModuleCompliance, ctxErrorHistoryTable=ctxErrorHistoryTable, ctxMeetingConfigStaticMinId=ctxMeetingConfigStaticMinId, ctxResourceIndex=ctxResourceIndex, ciscoCTXSysCallAbnormalDisconnect=ciscoCTXSysCallAbnormalDisconnect, ctxLicenseAlarmNotifyEnable=ctxLicenseAlarmNotifyEnable, ciscoCTXSysUserAuthFailure=ciscoCTXSysUserAuthFailure, ctxClusterNodeClusterName=ctxClusterNodeClusterName, ctxErrorAlarmId=ctxErrorAlarmId, ctxClusterNodeIndex=ctxClusterNodeIndex, ctxResourceUnavailTrans=ctxResourceUnavailTrans, ctxRegionServiceProviderKeyRef1=ctxRegionServiceProviderKeyRef1, ciscoTelepresenceExchangeSystemMIBConform=ciscoTelepresenceExchangeSystemMIBConform, ctxServiceProviderKey=ctxServiceProviderKey, ciscoCTXSysResourceStatusChg=ciscoCTXSysResourceStatusChg, ctxRegionKey=ctxRegionKey, ctxClusterNodeIPAddr=ctxClusterNodeIPAddr, CtxPorts=CtxPorts, ctxAllocPoolAllocFailures=ctxAllocPoolAllocFailures)
