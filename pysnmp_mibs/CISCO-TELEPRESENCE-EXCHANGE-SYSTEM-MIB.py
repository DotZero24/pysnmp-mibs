...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-TELEPRESENCE-EXCHANGE-SYSTEM-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:11:05 2025
...
mibBuilder.exportSymbols("CISCO-TELEPRESENCE-EXCHANGE-SYSTEM-MIB", ctxRegionEntry=ctxRegionEntry, ctxAllocPoolActivePorts=ctxAllocPoolActivePorts, ctxErrorHistoryTable=ctxErrorHistoryTable, ctxOrganizationEntry=ctxOrganizationEntry, ciscoCTXSysSystemConfigStatusChg=ciscoCTXSysSystemConfigStatusChg, CtxPorts=CtxPorts, ctxResourceMgmtIPAddr=ctxResourceMgmtIPAddr, ciscoCTXSysResourceStatusChg=ciscoCTXSysResourceStatusChg, ctxErrorMessage=ctxErrorMessage, ciscoCTXSysCallAbnormalDisconnect=ciscoCTXSysCallAbnormalDisconnect, CtxClusterNodeTypes=CtxClusterNodeTypes, ctxErrorAppName=ctxErrorAppName, ciscoCTXSysUserAuthFailure=ciscoCTXSysUserAuthFailure, ctxServiceProviderEntry=ctxServiceProviderEntry, ciscoCTXSysCallEnginesStatusChg=ciscoCTXSysCallEnginesStatusChg, ctxSystemStatusObjects=ctxSystemStatusObjects, ctxClusterNodeTable=ctxClusterNodeTable, ctxConfigObjects=ctxConfigObjects, ciscoTelepresenceExchangeSystemMIBGroups=ciscoTelepresenceExchangeSystemMIBGroups, ctxClusterNodeIndex=ctxClusterNodeIndex, ctxMediaCapacityConfigEntry=ctxMediaCapacityConfigEntry, ctxRegionStatsEntry=ctxRegionStatsEntry, ctxResourceKey=ctxResourceKey, ctxOrganizationServiceProviderKeyRef1=ctxOrganizationServiceProviderKeyRef1, ctxRegionTable=ctxRegionTable, ctxClusterNodeHostName=ctxClusterNodeHostName, ctxAllocPeakHistory=ctxAllocPeakHistory, ctxPeakHistMaxIntervals=ctxPeakHistMaxIntervals, ctxPeakHistAllocEntry=ctxPeakHistAllocEntry, ctxErrorHistoryMaxSeverity=ctxErrorHistoryMaxSeverity, ctxStatisticsObjects=ctxStatisticsObjects, ciscoCTXSysDatabaseServersStatusChg=ciscoCTXSysDatabaseServersStatusChg, ctxAuthFailureNotifyEnable=ctxAuthFailureNotifyEnable, ctxNotifyObjects=ctxNotifyObjects, ctxAllocPoolAvailPorts=ctxAllocPoolAvailPorts, ctxPeakHistAllocIntIndex=ctxPeakHistAllocIntIndex, ctxResourceStatus=ctxResourceStatus, ctxAllocStatsEntry=ctxAllocStatsEntry, ctxAllocAvailPorts=ctxAllocAvailPorts, ciscoTelepresenceExchangeSystemMIBCompliances=ciscoTelepresenceExchangeSystemMIBCompliances, CtxResourceOperState=CtxResourceOperState, ciscoTelepresenceExchangeSystemMIB=ciscoTelepresenceExchangeSystemMIB, ctxRegionIndex=ctxRegionIndex, ctxClusterNodeEntry=ctxClusterNodeEntry, ctxPeakHistAllocTable=ctxPeakHistAllocTable, ciscoCTXSysSystemBackupStatusChg=ciscoCTXSysSystemBackupStatusChg, ctxOrganizationDescr=ctxOrganizationDescr, CtxResourceType=CtxResourceType, ctxResourceStatsEntry=ctxResourceStatsEntry, ctxServiceProviderIndex=ctxServiceProviderIndex, ciscoTelePresenceExchangeSystemMIBStatsGroup=ciscoTelePresenceExchangeSystemMIBStatsGroup, ctxSipIpType=ctxSipIpType, ctxPeakHistAllocPoolEntry=ctxPeakHistAllocPoolEntry, ctxServiceProviderTable=ctxServiceProviderTable, ctxMeetingConfigStaticMinId=ctxMeetingConfigStaticMinId, ctxErrorKey=ctxErrorKey, ctxResourceCallSetupFailures=ctxResourceCallSetupFailures, ctxErrorHistoryLastIndex=ctxErrorHistoryLastIndex, ctxResourceTable=ctxResourceTable, ctxResourceUnavailDuration=ctxResourceUnavailDuration, ctxErrorIndex=ctxErrorIndex, ctxSipTransportProto=ctxSipTransportProto, ctxPeakHistAllocPorts=ctxPeakHistAllocPorts, ctxOrganizationMaxPorts=ctxOrganizationMaxPorts, ciscoCTXSysAdminServersStatusChg=ciscoCTXSysAdminServersStatusChg, ciscoTelepresenceExchangeSystemMIBStatusGroup=ciscoTelepresenceExchangeSystemMIBStatusGroup, CtxHealthStates=CtxHealthStates, ctxResourceRegionKeyRef1=ctxResourceRegionKeyRef1, ctxAllocActivePorts=ctxAllocActivePorts, ctxErrorSeverity=ctxErrorSeverity, ctxSipIpAddr=ctxSipIpAddr, ciscoCTXSysClusterNodeUp=ciscoCTXSysClusterNodeUp, ctxResourceDescr=ctxResourceDescr, ctxRegionDescr=ctxRegionDescr, ctxAdminServersStatus=ctxAdminServersStatus, ciscoCTXSysResourceAllocFailure=ciscoCTXSysResourceAllocFailure, ctxPeakHistAllocPoolIntIndex=ctxPeakHistAllocPoolIntIndex, ciscoTelepresenceExchangeSystemMIBConfigGroup=ciscoTelepresenceExchangeSystemMIBConfigGroup, ctxAllocPoolAllocFailures=ctxAllocPoolAllocFailures, ctxResourceIndex=ctxResourceIndex, ctxAllocPoolAllocOutOfPorts=ctxAllocPoolAllocOutOfPorts, ctxServiceProviderKey=ctxServiceProviderKey, ciscoTelepresenceExchangeSystemMIBConform=ciscoTelepresenceExchangeSystemMIBConform, ctxNotifyMessage=ctxNotifyMessage, ctxNotifyConfigObjects=ctxNotifyConfigObjects, ctxCallFailureNotifyEnable=ctxCallFailureNotifyEnable, ciscoCTXSysCallSetupFailure=ciscoCTXSysCallSetupFailure, ctxClusterNodeType=ctxClusterNodeType, CtxIndex=CtxIndex, ctxRegionCallSetupFailures=ctxRegionCallSetupFailures, ctxErrorAttrValStr=ctxErrorAttrValStr, ctxResourceStatsTable=ctxResourceStatsTable, ctxMeetingConfigStaticMaxId=ctxMeetingConfigStaticMaxId, ctxClusterNodeOperState=ctxClusterNodeOperState, ctxDatabaseServersStatus=ctxDatabaseServersStatus, ctxAllocFailures=ctxAllocFailures, ctxSystemConfigStatus=ctxSystemConfigStatus, ctxPeakHistAllocPoolTable=ctxPeakHistAllocPoolTable, ctxServiceProviderName=ctxServiceProviderName, ciscoTelepresenceExchangeSystemMIBNotfyObjectsGroup=ciscoTelepresenceExchangeSystemMIBNotfyObjectsGroup, ctxRegionServiceProviderKeyRef1=ctxRegionServiceProviderKeyRef1, ciscoCTXSysLicenseFailure=ciscoCTXSysLicenseFailure, ciscoCTXSysErrorHistoryEvent=ciscoCTXSysErrorHistoryEvent, ctxOrganizationTable=ctxOrganizationTable, ctxPeakHistIntTime=ctxPeakHistIntTime, ctxSipPort=ctxSipPort, ctxPeakHistAllocTS=ctxPeakHistAllocTS, ctxErrorHistoryEventNotifyEnable=ctxErrorHistoryEventNotifyEnable, ctxMediaCapacityConfigTable=ctxMediaCapacityConfigTable, ctxAllocStatsTable=ctxAllocStatsTable, ctxResourceMgmtIPType=ctxResourceMgmtIPType, ctxMeetingConfigEntry=ctxMeetingConfigEntry, ctxErrorAlarmId=ctxErrorAlarmId, ciscoTelepresenceExchangeSystemMIBNotifs=ciscoTelepresenceExchangeSystemMIBNotifs, ciscoCTXSysResourceDown=ciscoCTXSysResourceDown, PYSNMP_MODULE_ID=ciscoTelepresenceExchangeSystemMIB, ctxEventHistory=ctxEventHistory, ctxOrganizationDirectDial=ctxOrganizationDirectDial, ctxClusterNodeAlarmNotifyEnable=ctxClusterNodeAlarmNotifyEnable, ctxResourceObjects=ctxResourceObjects, ctxSipConfigTable=ctxSipConfigTable, ctxMediaCapacityMaxPorts=ctxMediaCapacityMaxPorts, ctxResourceUnavailTrans=ctxResourceUnavailTrans, ctxRegionKey=ctxRegionKey, ctxResourceOperState=ctxResourceOperState, ciscoCTXSysResourceUp=ciscoCTXSysResourceUp, CtxSIPProtocolType=CtxSIPProtocolType, ctxSystemBackupStatus=ctxSystemBackupStatus, ciscoTelepresenceExchangeSystemMIBNotifyGroup=ciscoTelepresenceExchangeSystemMIBNotifyGroup, ctxClusterNodeIPType=ctxClusterNodeIPType, ctxMeetingConfigTable=ctxMeetingConfigTable, ctxStatusChangeNotifyEnable=ctxStatusChangeNotifyEnable, ctxClusterNodeName=ctxClusterNodeName, ctxClusterNodeIPAddr=ctxClusterNodeIPAddr, ctxMediaCapacityLargeMeeting=ctxMediaCapacityLargeMeeting, ciscoTelepresenceExchangeSystemMIBErrorHistoryGroup=ciscoTelepresenceExchangeSystemMIBErrorHistoryGroup, ctxErrorTimeStamp=ctxErrorTimeStamp, CtxKeyId=CtxKeyId, ctxResourceAlarmNotifyEnable=ctxResourceAlarmNotifyEnable, ctxCallEnginesStatus=ctxCallEnginesStatus, ctxAllocOutOfPorts=ctxAllocOutOfPorts, ciscoTelepresenceExchangeSystemMIBModuleCompliance=ciscoTelepresenceExchangeSystemMIBModuleCompliance, ctxClusterNodeClusterName=ctxClusterNodeClusterName, ctxOrganizationKey=ctxOrganizationKey, ctxErrorHistoryEntry=ctxErrorHistoryEntry, ctxRegionName=ctxRegionName, ciscoTelepresenceExchangeSystemMIBObjects=ciscoTelepresenceExchangeSystemMIBObjects, ctxRegionStatsTable=ctxRegionStatsTable, ctxResourceDeviceType=ctxResourceDeviceType, ctxOrganizationIndex=ctxOrganizationIndex, ctxResourceEntry=ctxResourceEntry, ctxResourceName=ctxResourceName, ctxPeakHistAllocPoolTS=ctxPeakHistAllocPoolTS, ctxErrorHistoryTableSize=ctxErrorHistoryTableSize, ciscoCTXSysClusterNodeDown=ciscoCTXSysClusterNodeDown, ctxSipConfigEntry=ctxSipConfigEntry, ctxLicenseAlarmNotifyEnable=ctxLicenseAlarmNotifyEnable, ctxClusterNodeKey=ctxClusterNodeKey, ctxOrganizationName=ctxOrganizationName, ctxMeetingConfigInterOpMaxId=ctxMeetingConfigInterOpMaxId, ctxServiceProviderHDNumber=ctxServiceProviderHDNumber, ctxPeakHistAllocPoolPorts=ctxPeakHistAllocPoolPorts, ctxMeetingConfigInterOpMinId=ctxMeetingConfigInterOpMinId, ctxServiceProviderDescr=ctxServiceProviderDescr)
