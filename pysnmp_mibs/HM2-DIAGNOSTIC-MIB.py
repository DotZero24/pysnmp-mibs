...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-DIAGNOSTIC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:53:38 2025
...
_Hm2DiagSelftestRAM_Type.__name__ = "HmEnabledStatus"
...
_Hm2BootSystemMonitor_Type.__name__ = "HmEnabledStatus"
...
_Hm2BootDefaultConfigOnError_Type.__name__ = "HmEnabledStatus"
...
_Hm2BootConfigPushButton_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConTrapEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConSenseLinkFailure_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConSenseTemperature_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConSenseFan_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConSenseModuleRemoval_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConSenseExtNvmRemoval_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConSenseExtNvmNotInSync_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConSenseRingRedundancy_Type.__name__ = "HmEnabledStatus"
...
class _Hm2SigConSenseEthernetLoops_Type(HmEnabledStatus):
    """Custom type hm2SigConSenseEthernetLoops based on HmEnabledStatus"""
    defaultValue = 2


_Hm2SigConSenseEthernetLoops_Type.__name__ = "HmEnabledStatus"
_Hm2SigConSenseEthernetLoops_Object = MibTableColumn
hm2SigConSenseEthernetLoops = _Hm2SigConSenseEthernetLoops_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 1, 1, 1, 16),
    _Hm2SigConSenseEthernetLoops_Type()
)
hm2SigConSenseEthernetLoops.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SigConSenseEthernetLoops.setStatus("current")


class _Hm2SigConSenseHumidity_Type(HmEnabledStatus):
    """Custom type hm2SigConSenseHumidity based on HmEnabledStatus"""
    defaultValue = 1


_Hm2SigConSenseHumidity_Type.__name__ = "HmEnabledStatus"
_Hm2SigConSenseHumidity_Object = MibTableColumn
hm2SigConSenseHumidity = _Hm2SigConSenseHumidity_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 1, 1, 1, 17),
    _Hm2SigConSenseHumidity_Type()
)
hm2SigConSenseHumidity.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SigConSenseHumidity.setStatus("current")


class _Hm2SigConSenseStpPortBlock_Type(HmEnabledStatus):
    """Custom type hm2SigConSenseStpPortBlock based on HmEnabledStatus"""
    defaultValue = 1


_Hm2SigConSenseStpPortBlock_Type.__name__ = "HmEnabledStatus"
_Hm2SigConSenseStpPortBlock_Object = MibTableColumn
hm2SigConSenseStpPortBlock = _Hm2SigConSenseStpPortBlock_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 1, 1, 1, 18),
    _Hm2SigConSenseStpPortBlock_Type()
)
hm2SigConSenseStpPortBlock.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SigConSenseStpPortBlock.setStatus("current")
...
_Hm2SigConSensePSState_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConSenseIfLinkAlarm_Type.__name__ = "HmEnabledStatus"
...
_Hm2SigConSenseModule_Type.__name__ = "HmEnabledStatus"
...
hm2SigConFanModuleTable = _Hm2SigConFanModuleTable_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 1, 5)
)
if mibBuilder.loadTexts:
    hm2SigConFanModuleTable.setStatus("current")
_Hm2SigConFanModuleEntry_Object = MibTableRow
hm2SigConFanModuleEntry = _Hm2SigConFanModuleEntry_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 1, 5, 1)
)
hm2SigConFanModuleEntry.setIndexNames(
    (0, "HM2-DIAGNOSTIC-MIB", "hm2SigConID"),
    (0, "HM2-DIAGNOSTIC-MIB", "hm2SigConFanModID"),
)
if mibBuilder.loadTexts:
    hm2SigConFanModuleEntry.setStatus("current")


class _Hm2SigConFanModID_Type(Integer32):
    """Custom type hm2SigConFanModID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 7),
    )
...
_Hm2SigConFanModID_Type.__name__ = "Integer32"
_Hm2SigConFanModID_Object = MibTableColumn
hm2SigConFanModID = _Hm2SigConFanModID_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 1, 5, 1, 1),
    _Hm2SigConFanModID_Type()
)
hm2SigConFanModID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2SigConFanModID.setStatus("current")


class _Hm2SigConSenseFanModule_Type(HmEnabledStatus):
    """Custom type hm2SigConSenseFanModule based on HmEnabledStatus"""
    defaultValue = 1


_Hm2SigConSenseFanModule_Type.__name__ = "HmEnabledStatus"
_Hm2SigConSenseFanModule_Object = MibTableColumn
hm2SigConSenseFanModule = _Hm2SigConSenseFanModule_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 1, 5, 1, 2),
    _Hm2SigConSenseFanModule_Type()
)
hm2SigConSenseFanModule.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SigConSenseFanModule.setStatus("current")
...
_Hm2DevMonTrapEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevMonSenseLinkFailure_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevMonSenseTemperature_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevMonSenseFan_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevMonSenseModuleRemoval_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevMonSenseExtNvmRemoval_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevMonSenseExtNvmNotInSync_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevMonSenseRingRedundancy_Type.__name__ = "HmEnabledStatus"
...
class _Hm2DevMonSenseHumidity_Type(HmEnabledStatus):
    """Custom type hm2DevMonSenseHumidity based on HmEnabledStatus"""
    defaultValue = 1


_Hm2DevMonSenseHumidity_Type.__name__ = "HmEnabledStatus"
_Hm2DevMonSenseHumidity_Object = MibTableColumn
hm2DevMonSenseHumidity = _Hm2DevMonSenseHumidity_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 2, 1, 1, 14),
    _Hm2DevMonSenseHumidity_Type()
)
hm2DevMonSenseHumidity.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMonSenseHumidity.setStatus("current")


class _Hm2DevMonSenseStpPortBlock_Type(HmEnabledStatus):
    """Custom type hm2DevMonSenseStpPortBlock based on HmEnabledStatus"""
    defaultValue = 1


_Hm2DevMonSenseStpPortBlock_Type.__name__ = "HmEnabledStatus"
_Hm2DevMonSenseStpPortBlock_Object = MibTableColumn
hm2DevMonSenseStpPortBlock = _Hm2DevMonSenseStpPortBlock_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 2, 1, 1, 15),
    _Hm2DevMonSenseStpPortBlock_Type()
)
hm2DevMonSenseStpPortBlock.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMonSenseStpPortBlock.setStatus("current")
...
_Hm2DevMonSensePSState_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevMonSenseIfLinkAlarm_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevMonSenseModule_Type.__name__ = "HmEnabledStatus"
...
hm2DevMonFanModuleTable = _Hm2DevMonFanModuleTable_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 2, 5)
)
if mibBuilder.loadTexts:
    hm2DevMonFanModuleTable.setStatus("current")
_Hm2DevMonFanModuleEntry_Object = MibTableRow
hm2DevMonFanModuleEntry = _Hm2DevMonFanModuleEntry_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 2, 5, 1)
)
hm2DevMonFanModuleEntry.setIndexNames(
    (0, "HM2-DIAGNOSTIC-MIB", "hm2DevMonID"),
    (0, "HM2-DIAGNOSTIC-MIB", "hm2DevMonFanModID"),
)
if mibBuilder.loadTexts:
    hm2DevMonFanModuleEntry.setStatus("current")


class _Hm2DevMonFanModID_Type(Integer32):
    """Custom type hm2DevMonFanModID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 7),
    )
...
_Hm2DevMonFanModID_Type.__name__ = "Integer32"
_Hm2DevMonFanModID_Object = MibTableColumn
hm2DevMonFanModID = _Hm2DevMonFanModID_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 2, 5, 1, 1),
    _Hm2DevMonFanModID_Type()
)
hm2DevMonFanModID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMonFanModID.setStatus("current")


class _Hm2DevMonSenseFanModule_Type(HmEnabledStatus):
    """Custom type hm2DevMonSenseFanModule based on HmEnabledStatus"""
    defaultValue = 1


_Hm2DevMonSenseFanModule_Type.__name__ = "HmEnabledStatus"
_Hm2DevMonSenseFanModule_Object = MibTableColumn
hm2DevMonSenseFanModule = _Hm2DevMonSenseFanModule_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 2, 5, 1, 2),
    _Hm2DevMonSenseFanModule_Type()
)
hm2DevMonSenseFanModule.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMonSenseFanModule.setStatus("current")
...
_Hm2DevSecTrapEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSensePasswordChange_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSensePasswordMinLength_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSensePasswordStrengthNotConfigured_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseBypassPasswordStrength_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseTelnetEnabled_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseHttpEnabled_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseSnmpUnsecure_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseSysmonEnabled_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseExtNvmUpdateEnabled_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseNoLinkEnabled_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseHiDiscoveryEnabled_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseExtNvmConfigLoadUnsecure_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseIec61850MmsEnabled_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseHttpsCertificateWarning_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseModbusTcpEnabled_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseEtherNetIpEnabled_Type.__name__ = "HmEnabledStatus"
...
_Hm2DevSecSenseProfinetIOEnabled_Type.__name__ = "HmEnabledStatus"
...
class _Hm2DevSecSensePMLDisabled_Type(HmEnabledStatus):
    """Custom type hm2DevSecSensePMLDisabled based on HmEnabledStatus"""
    defaultValue = 1


_Hm2DevSecSensePMLDisabled_Type.__name__ = "HmEnabledStatus"
_Hm2DevSecSensePMLDisabled_Object = MibScalar
hm2DevSecSensePMLDisabled = _Hm2DevSecSensePMLDisabled_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 3, 3, 1, 23),
    _Hm2DevSecSensePMLDisabled_Type()
)
hm2DevSecSensePMLDisabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevSecSensePMLDisabled.setStatus("current")
...
_Hm2DevSecSenseIfNoLink_Type.__name__ = "HmEnabledStatus"
...
_Hm2LedPortSignaling_Type.__name__ = "HmEnabledStatus"
...
hm2DiagEgressIfaceUtilizationTable = _Hm2DiagEgressIfaceUtilizationTable_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 5, 2)
)
if mibBuilder.loadTexts:
    hm2DiagEgressIfaceUtilizationTable.setStatus("current")
_Hm2DiagEgressIfaceUtilizationEntry_Object = MibTableRow
hm2DiagEgressIfaceUtilizationEntry = _Hm2DiagEgressIfaceUtilizationEntry_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 5, 2, 1)
)
hm2DiagEgressIfaceUtilizationEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    hm2DiagEgressIfaceUtilizationEntry.setStatus("current")


class _Hm2DiagEgressIfaceUtilization_Type(Integer32):
    """Custom type hm2DiagEgressIfaceUtilization based on Integer32"""
    defaultValue = 0
...
_Hm2DiagEgressIfaceUtilization_Type.__name__ = "Integer32"
_Hm2DiagEgressIfaceUtilization_Object = MibTableColumn
hm2DiagEgressIfaceUtilization = _Hm2DiagEgressIfaceUtilization_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 5, 2, 1, 1),
    _Hm2DiagEgressIfaceUtilization_Type()
)
hm2DiagEgressIfaceUtilization.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DiagEgressIfaceUtilization.setStatus("current")


class _Hm2DiagEgressIfaceUtilizationControlInterval_Type(Integer32):
    """Custom type hm2DiagEgressIfaceUtilizationControlInterval based on Integer32"""
    defaultValue = 30
...
_Hm2DiagEgressIfaceUtilizationControlInterval_Type.__name__ = "Integer32"
_Hm2DiagEgressIfaceUtilizationControlInterval_Object = MibTableColumn
hm2DiagEgressIfaceUtilizationControlInterval = _Hm2DiagEgressIfaceUtilizationControlInterval_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 5, 2, 1, 2),
    _Hm2DiagEgressIfaceUtilizationControlInterval_Type()
)
hm2DiagEgressIfaceUtilizationControlInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DiagEgressIfaceUtilizationControlInterval.setStatus("current")


class _Hm2DiagEgressIfaceUtilizationAlarmLowerThreshold_Type(Integer32):
    """Custom type hm2DiagEgressIfaceUtilizationAlarmLowerThreshold based on Integer32"""
    defaultValue = 0
...
_Hm2DiagEgressIfaceUtilizationAlarmLowerThreshold_Type.__name__ = "Integer32"
_Hm2DiagEgressIfaceUtilizationAlarmLowerThreshold_Object = MibTableColumn
hm2DiagEgressIfaceUtilizationAlarmLowerThreshold = _Hm2DiagEgressIfaceUtilizationAlarmLowerThreshold_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 5, 2, 1, 3),
    _Hm2DiagEgressIfaceUtilizationAlarmLowerThreshold_Type()
)
hm2DiagEgressIfaceUtilizationAlarmLowerThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DiagEgressIfaceUtilizationAlarmLowerThreshold.setStatus("current")


class _Hm2DiagEgressIfaceUtilizationAlarmUpperThreshold_Type(Integer32):
    """Custom type hm2DiagEgressIfaceUtilizationAlarmUpperThreshold based on Integer32"""
    defaultValue = 0
...
_Hm2DiagEgressIfaceUtilizationAlarmUpperThreshold_Type.__name__ = "Integer32"
_Hm2DiagEgressIfaceUtilizationAlarmUpperThreshold_Object = MibTableColumn
hm2DiagEgressIfaceUtilizationAlarmUpperThreshold = _Hm2DiagEgressIfaceUtilizationAlarmUpperThreshold_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 5, 2, 1, 4),
    _Hm2DiagEgressIfaceUtilizationAlarmUpperThreshold_Type()
)
hm2DiagEgressIfaceUtilizationAlarmUpperThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DiagEgressIfaceUtilizationAlarmUpperThreshold.setStatus("current")
...
hm2DiagEgressIfaceUtilizationAlarmCondition = _Hm2DiagEgressIfaceUtilizationAlarmCondition_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 1, 5, 2, 1, 5),
    _Hm2DiagEgressIfaceUtilizationAlarmCondition_Type()
)
hm2DiagEgressIfaceUtilizationAlarmCondition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DiagEgressIfaceUtilizationAlarmCondition.setStatus("current")
...
_Hm2DiagCableTesterIfIndex_Type.__name__ = "Unsigned32"
...
_Hm2DiagCableTesterCableMinimumLength_Type.__name__ = "Unsigned32"
...
_Hm2DiagCableTesterCableMaximumLength_Type.__name__ = "Unsigned32"
...
_Hm2DiagCableTesterCableFailureLocation_Type.__name__ = "Unsigned32"
...
_Hm2PortMonitorAdminMode_Type.__name__ = "TruthValue"
...
_Hm2PortMonitorIntfReset_Type.__name__ = "TruthValue"
...
_Hm2PortMonitorConditionLinkFlapMode_Type.__name__ = "TruthValue"
...
_Hm2PortMonitorConditionCrcFragmentsMode_Type.__name__ = "TruthValue"
...
_Hm2PortMonitorConditionDuplexMismatchDetectionMode_Type.__name__ = "TruthValue"
...
_Hm2PortMonitorConditionOverloadDetectionMode_Type.__name__ = "TruthValue"
...
_Hm2PortMonitorConditionSpeedDuplexMode_Type.__name__ = "TruthValue"
...
_Hm2PortMonitorConditionOvldDetPkgCntAll_Type.__name__ = "Integer32"
...
_Hm2PortMonitorConditionOvldDetPkgCntBC_Type.__name__ = "Integer32"
...
_Hm2PortMonitorConditionOvldDetPkgCntMC_Type.__name__ = "Integer32"
...
_Hm2PortMonitorConditionOvldDetPkgCntKbit_Type.__name__ = "Integer32"
...
_Hm2DiagEnableMeasurement_Type.__name__ = "HmEnabledStatus"
...
hm2DiagEgressIfaceUtilizationTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 248, 11, 22, 0, 7)
)
hm2DiagEgressIfaceUtilizationTrap.setObjects(
      *(("HM2-DIAGNOSTIC-MIB", "hm2DiagEgressIfaceUtilization"),
        ("HM2-DIAGNOSTIC-MIB", "hm2DiagEgressIfaceUtilizationAlarmCondition"))
)
if mibBuilder.loadTexts:
    hm2DiagEgressIfaceUtilizationTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"Hm2LedType": Hm2LedType,
       ...
       "hm2DiagEgressIfaceUtilizationTrap": hm2DiagEgressIfaceUtilizationTrap,
       ...
       "hm2SigConSenseEthernetLoops": hm2SigConSenseEthernetLoops,
       "hm2SigConSenseHumidity": hm2SigConSenseHumidity,
       "hm2SigConSenseStpPortBlock": hm2SigConSenseStpPortBlock,
       ...
       "hm2SigConFanModuleTable": hm2SigConFanModuleTable,
       "hm2SigConFanModuleEntry": hm2SigConFanModuleEntry,
       "hm2SigConFanModID": hm2SigConFanModID,
       "hm2SigConSenseFanModule": hm2SigConSenseFanModule,
       ...
       "hm2DevMonSenseHumidity": hm2DevMonSenseHumidity,
       "hm2DevMonSenseStpPortBlock": hm2DevMonSenseStpPortBlock,
       ...
       "hm2DevMonFanModuleTable": hm2DevMonFanModuleTable,
       "hm2DevMonFanModuleEntry": hm2DevMonFanModuleEntry,
       "hm2DevMonFanModID": hm2DevMonFanModID,
       "hm2DevMonSenseFanModule": hm2DevMonSenseFanModule,
       ...
       "hm2DevSecSensePMLDisabled": hm2DevSecSensePMLDisabled,
       ...
       "hm2DiagEgressIfaceUtilizationEntry": hm2DiagEgressIfaceUtilizationEntry,
       "hm2DiagEgressIfaceUtilization": hm2DiagEgressIfaceUtilization,
       "hm2DiagEgressIfaceUtilizationControlInterval": hm2DiagEgressIfaceUtilizationControlInterval,
       "hm2DiagEgressIfaceUtilizationAlarmLowerThreshold": hm2DiagEgressIfaceUtilizationAlarmLowerThreshold,
       "hm2DiagEgressIfaceUtilizationAlarmUpperThreshold": hm2DiagEgressIfaceUtilizationAlarmUpperThreshold,
       "hm2DiagEgressIfaceUtilizationAlarmCondition": hm2DiagEgressIfaceUtilizationAlarmCondition,
