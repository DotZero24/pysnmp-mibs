...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:27:07 2025
...
mibBuilder.exportSymbols("CISCO-VISM-PORT-MIB", vismPortCnfGrpTable=vismPortCnfGrpTable, vismPortType=vismPortType, ciscoVismPortMIBConformance=ciscoVismPortMIBConformance, PYSNMP_MODULE_ID=ciscoVismPortMIB, vismPortSpeed=vismPortSpeed, vismPortState=vismPortState, ciscoVismPortCompliance=ciscoVismPortCompliance, vismPortCnfGrp=vismPortCnfGrp, vismPortCnfGrpEntry=vismPortCnfGrpEntry, vismPortDs0ConfigBitMap=vismPortDs0ConfigBitMap, vismPortLineNum=vismPortLineNum, ciscoVismPortMIB=ciscoVismPortMIB, vismPortRowStatus=vismPortRowStatus, ciscoVismPortMIBCompliances=ciscoVismPortMIBCompliances, ciscoVismPortMIBGroups=ciscoVismPortMIBGroups, vismPortNum=vismPortNum, ciscoVismPortGroup=ciscoVismPortGroup)
