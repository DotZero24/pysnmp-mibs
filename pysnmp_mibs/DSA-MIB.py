...
mibBuilder.exportSymbols("DSA-MIB", dsaSlaveHits=dsaSlaveHits, dsaUnauthBinds=dsaUnauthBinds, dsaInOps=dsaInOps, dsaFailures=dsaFailures, dsaGroups=dsaGroups, dsaAddEntryOps=dsaAddEntryOps, dsaIntEntry=dsaIntEntry, dsaIntCompliance=dsaIntCompliance, dsaIntIndex=dsaIntIndex, dsaOneLevelSearchOps=dsaOneLevelSearchOps, dsaSimpleAuthBinds=dsaSimpleAuthBinds, dsaRemoveEntryOps=dsaRemoveEntryOps, dsaAnonymousBinds=dsaAnonymousBinds, dsaTimeOfLastAttempt=dsaTimeOfLastAttempt, dsaEntryCompliance=dsaEntryCompliance, dsaMasterEntries=dsaMasterEntries, dsaConformance=dsaConformance, dsaCompliances=dsaCompliances, dsaEntriesEntry=dsaEntriesEntry, PYSNMP_MODULE_ID=dsaMIB, dsaSuccesses=dsaSuccesses, dsaSecurityErrors=dsaSecurityErrors, dsaBindSecurityErrors=dsaBindSecurityErrors, dsaOpsTable=dsaOpsTable, dsaCompareOps=dsaCompareOps, dsaOpsGroup=dsaOpsGroup, dsaModifyRDNOps=dsaModifyRDNOps, dsaCopyEntries=dsaCopyEntries, dsaEntriesTable=dsaEntriesTable, dsaOpsEntry=dsaOpsEntry, dsaWholeTreeSearchOps=dsaWholeTreeSearchOps, dsaIntTable=dsaIntTable, dsaIntGroup=dsaIntGroup, dsaName=dsaName, dsaEntryGroup=dsaEntryGroup, dsaTimeOfCreation=dsaTimeOfCreation, dsaErrors=dsaErrors, dsaModifyEntryOps=dsaModifyEntryOps, dsaOpsCompliance=dsaOpsCompliance, dsaListOps=dsaListOps, dsaCacheHits=dsaCacheHits, dsaTimeOfLastSuccess=dsaTimeOfLastSuccess, dsaReadOps=dsaReadOps, dsaChainings=dsaChainings, dsaCacheEntries=dsaCacheEntries, dsaReferrals=dsaReferrals, dsaStrongAuthBinds=dsaStrongAuthBinds, dsaSearchOps=dsaSearchOps, dsaMIB=dsaMIB, dsaFailuresSinceLastSuccess=dsaFailuresSinceLastSuccess)
