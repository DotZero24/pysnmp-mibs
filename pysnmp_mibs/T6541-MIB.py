# SNMP MIB module (T6541-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T6541-MIB
...
trapTest.setObjects(
      *(("T6541-MIB", "sensorName"),
        ("T6541-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
