...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-MEGACO-MIB
...
cmedCompliance.setObjects(
      *(("CISCO-IETF-MEGACO-MIB", "cmedConfig"),
        ("CISCO-IETF-MEGACO-MIB", "cmedStatsGroup"),
        ("CISCO-IETF-MEGACO-MIB", "cmedGwyControllerGroup"),
        ("CISCO-IETF-MEGACO-MIB", "cmedNextIdGroup"),
        ("CISCO-IETF-MEGACO-MIB", "cmedTermGroup"))
)
if mibBuilder.loadTexts:
