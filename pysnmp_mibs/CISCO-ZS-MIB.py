...
VsanIndex, FcAddressId, DomainIdOrZero, FcNameId = mibBuilder.importSymbols("CISCO-ST-TC", "VsanIndex", "FcAddressId", "DomainIdOrZero", "FcNameId")
...
mibBuilder.exportSymbols("CISCO-ZS-MIB", zoneEnforcedZoneQos=zoneEnforcedZoneQos, zoneRxGS3Reqs=zoneRxGS3Reqs, zoneMemberNumber=zoneMemberNumber, zoneAliasMemberList=zoneAliasMemberList, zoneEnforcedZoneAliasEntry=zoneEnforcedZoneAliasEntry, zoneNotificationGroup=zoneNotificationGroup, ZoneMemberType=ZoneMemberType, zoneSetActivateRowStatus=zoneSetActivateRowStatus, zoneMemberID=zoneMemberID, zoneCompactVsan=zoneCompactVsan, FcZoneServerRejReasonExpl=FcZoneServerRejReasonExpl, zoneAliasIndex=zoneAliasIndex, zoneAliasNumber=zoneAliasNumber, zoneStatsEntry=zoneStatsEntry, zoneDbEnforcedEqualsLocal=zoneDbEnforcedEqualsLocal, zoneServerMIBCompliance=zoneServerMIBCompliance, zoneEnforcedZoneMemberFormat=zoneEnforcedZoneMemberFormat, zoneSmartZoning=zoneSmartZoning, zoneDefaultZoneTable=zoneDefaultZoneTable, zoneRoZoneSrcFcId=zoneRoZoneSrcFcId, zoneNotificationControlGroup1Sup1=zoneNotificationControlGroup1Sup1, zoneEntry=zoneEntry, zoneRoZoneStatsTable=zoneRoZoneStatsTable, zoneDefaultZoneBehaviour=zoneDefaultZoneBehaviour, zoneCompactZones=zoneCompactZones, zoneSetZoneListBmap4k=zoneSetZoneListBmap4k, zoneLunRxOtherCmds=zoneLunRxOtherCmds, ZoneFileType=ZoneFileType, zoneSetEnforcedZoneListBmap8k=zoneSetEnforcedZoneListBmap8k, zoneSetEnforcedZoneListTable=zoneSetEnforcedZoneListTable, zoneAliasList=zoneAliasList, zoneLunDstFcId=zoneLunDstFcId, zoneLunStatsEntry=zoneLunStatsEntry, zoneCompactFirst2k=zoneCompactFirst2k, zoneCopyDestFileType=zoneCopyDestFileType, zoneMergeFailureNotifyEnable=zoneMergeFailureNotifyEnable, zoneSetEnforcedZoneListBmap16k=zoneSetEnforcedZoneListBmap16k, zoneConfigGroupSup6=zoneConfigGroupSup6, zoneReadOnly=zoneReadOnly, ZoneMemberDeviceTypeAttr=ZoneMemberDeviceTypeAttr, zoneDefaultZoneQos=zoneDefaultZoneQos, zoneEnforcedZoneSetEntry=zoneEnforcedZoneSetEntry, zoneCopyStartCopy=zoneCopyStartCopy, zoneCompactNotify=zoneCompactNotify, zoneConfigurationGroup1=zoneConfigurationGroup1, zoneCopyServerAddrType=zoneCopyServerAddrType, zoneCopyDestFileName=zoneCopyDestFileName, zoneMemberIndex=zoneMemberIndex, zoneSetZoneList=zoneSetZoneList, zoneAliasEntry=zoneAliasEntry, zoneNotifications=zoneNotifications, zoneDefaultZoneQosPriority=zoneDefaultZoneQosPriority, zoneRowStatus=zoneRowStatus, zoneSetLastChange=zoneSetLastChange, zoneDbEntry=zoneDbEntry, zoneCopyActToFullVsan=zoneCopyActToFullVsan, zoneMergeFailRecoverOper=zoneMergeFailRecoverOper, zoneMergeFailureNotify=zoneMergeFailureNotify, zoneConfigurationGroup6=zoneConfigurationGroup6, zoneConfigGroupSup1=zoneConfigGroupSup1, zoneAliasRowStatus=zoneAliasRowStatus, zoneTxGS3Rejects=zoneTxGS3Rejects, zoneLunSrcFcId=zoneLunSrcFcId, zoneZoneSetDistributeVsan=zoneZoneSetDistributeVsan, zoneTxChangeAccepts=zoneTxChangeAccepts, zoneMergeSuccessNotify=zoneMergeSuccessNotify, zoneQosPriority=zoneQosPriority, zoneEnforcedZoneAliasName=zoneEnforcedZoneAliasName, zoneLunStatsTable=zoneLunStatsTable, zoneLunTxInqDataNoLus=zoneLunTxInqDataNoLus, zoneSetEnforcedZoneListBmap6k=zoneSetEnforcedZoneListBmap6k, zoneStats=zoneStats, zoneEnforcedZoneTable=zoneEnforcedZoneTable, zoneNotificationControlGroup=zoneNotificationControlGroup, zoneServerMIBConformance=zoneServerMIBConformance, zoneMergeSuccessNotifyEnable=zoneMergeSuccessNotifyEnable, zoneDefZoneBehaviourChngNotify=zoneDefZoneBehaviourChngNotify, zoneCopyActiveToFullOnVsan=zoneCopyActiveToFullOnVsan, zoneDbTable=zoneDbTable, zoneAliasLastChange=zoneAliasLastChange, zoneServerMIBComplianceRev4=zoneServerMIBComplianceRev4, ciscoZoningMIBObjects=ciscoZoningMIBObjects, zoneEnforcedZoneSetActivateTime=zoneEnforcedZoneSetActivateTime, zoneConfigurationGroup4=zoneConfigurationGroup4, zoneClone=zoneClone, zoneCopyRowStatus=zoneCopyRowStatus, zoneSetClone=zoneSetClone, zoneSetNumber=zoneSetNumber, zoneSetEnforcedZoneListEntry=zoneSetEnforcedZoneListEntry, zoneConfigGroupSup2=zoneConfigGroupSup2, zoneNotificationGroup2=zoneNotificationGroup2, zoneSetPropagationMode=zoneSetPropagationMode, zoneSetZoneListBmap12k=zoneSetZoneListBmap12k, zoneEnforcedZoneMemberAttr=zoneEnforcedZoneMemberAttr, zoneServerMIBComplianceRev9=zoneServerMIBComplianceRev9, zoneRxMergeReqs=zoneRxMergeReqs, zoneAliasName=zoneAliasName, zoneEnforcedZoneMemberLunID=zoneEnforcedZoneMemberLunID, zoneNotificationGroup2Sup1=zoneNotificationGroup2Sup1, zoneMemberTypeIndex=zoneMemberTypeIndex, zoneSetActivateResult=zoneSetActivateResult, zoneEnforcedZoneName=zoneEnforcedZoneName, zoneEnforcedZoneAliasTable=zoneEnforcedZoneAliasTable, zoneLunTxIllegalReqs=zoneLunTxIllegalReqs, zoneSetFailCause=zoneSetFailCause, zoneSetEnforcedZoneListBmap4k=zoneSetEnforcedZoneListBmap4k, zoneServerMIBGroups=zoneServerMIBGroups, zoneSetZoneListBmap10k=zoneSetZoneListBmap10k, zoneEnforcedZoneSetNumber=zoneEnforcedZoneSetNumber, zoneServerMIBComplianceRev5=zoneServerMIBComplianceRev5, zoneConfigGroupSup4=zoneConfigGroupSup4, zoneLunNum=zoneLunNum, zoneEnforcedZoneMemberEntry=zoneEnforcedZoneMemberEntry, zoneDbClearDb=zoneDbClearDb, zoneServerMIBComplianceRev7=zoneServerMIBComplianceRev7, zoneTxMergeAccepts=zoneTxMergeAccepts, zoneMergeSuccessVSANNum=zoneMergeSuccessVSANNum, zoneMemberAttr=zoneMemberAttr, zoneInformation=zoneInformation, zoneSetActivate=zoneSetActivate, zoneEnforcedZoneSetZoneList=zoneEnforcedZoneSetZoneList, zoneLunRxInqReqs=zoneLunRxInqReqs, zoneSetFailDomId=zoneSetFailDomId, zoneCopyProto=zoneCopyProto, zoneSwitchWwn=zoneSwitchWwn, zoneServerMIBCompliance1=zoneServerMIBCompliance1, zoneUnsuppMemInIntOpNotifyEnable=zoneUnsuppMemInIntOpNotifyEnable, zoneMergeFailRecoverVsan=zoneMergeFailRecoverVsan, zoneEnforcedZoneMemberList=zoneEnforcedZoneMemberList, zoneRoZoneLunNum=zoneRoZoneLunNum, zoneLunRxRepLunReqs=zoneLunRxRepLunReqs, zoneEnforcedZoneSetTable=zoneEnforcedZoneSetTable, zoneMergeFailRecoverSpinLock=zoneMergeFailRecoverSpinLock, zoneSetEnforcedZoneListBmap10k=zoneSetEnforcedZoneListBmap10k, zoneEnforcedZoneReadOnly=zoneEnforcedZoneReadOnly, zoneRxChangeReqs=zoneRxChangeReqs, zoneCopyState=zoneCopyState, zoneConfigGroupSup5=zoneConfigGroupSup5, zoneNotificationGroup1=zoneNotificationGroup1, zoneRoZoneStatsEntry=zoneRoZoneStatsEntry, zoneDefaultZoneBroadcast=zoneDefaultZoneBroadcast, zoneNumber=zoneNumber, zoneCopyTable=zoneCopyTable, zoneTxMergeReqs=zoneTxMergeReqs, zoneLastChange=zoneLastChange, zoneEnforcedZoneMemberTable=zoneEnforcedZoneMemberTable, zoneConfigurationGroup2=zoneConfigurationGroup2, zoneBroadcast=zoneBroadcast, zoneEnforcedZoneAliasNumber=zoneEnforcedZoneAliasNumber, zoneSetEnforcedZoneListBmap14k=zoneSetEnforcedZoneListBmap14k, zoneSetPropagationEntry=zoneSetPropagationEntry, zoneIndex=zoneIndex, zoneEnforcedZoneSetName=zoneEnforcedZoneSetName, zoneDefaultZoneEntry=zoneDefaultZoneEntry, zoneEnforcedZoneSmartZoning=zoneEnforcedZoneSmartZoning, zoneMergeFailureVSANNum=zoneMergeFailureVSANNum, zoneZoneSetDistributeResult=zoneZoneSetDistributeResult, zoneZoneSetDistributeFailReason=zoneZoneSetDistributeFailReason, zoneDefaultZoneReadOnly=zoneDefaultZoneReadOnly, ZoneMergeFailCause=ZoneMergeFailCause, zoneCompactEntry=zoneCompactEntry, zoneSetIndex=zoneSetIndex, zoneCopyActToFullMode=zoneCopyActToFullMode, zoneStatisticsGroup=zoneStatisticsGroup, zoneEnforcedZoneActivateTime=zoneEnforcedZoneActivateTime, zoneEnforcedZoneMemberID=zoneEnforcedZoneMemberID, zoneAliasClone=zoneAliasClone, zoneMergeFailureObject=zoneMergeFailureObject, zoneDbHardZoningEnabled=zoneDbHardZoningEnabled, zoneCompactTable=zoneCompactTable, zoneConfigurationGroup7=zoneConfigurationGroup7, zoneMemberRowStatus=zoneMemberRowStatus, zoneServiceReqRejNotifyEnable=zoneServiceReqRejNotifyEnable, zoneSetEntry=zoneSetEntry, zoneEnforcedZoneNumber=zoneEnforcedZoneNumber, zoneMergeFailRecoverInterface=zoneMergeFailRecoverInterface, zoneCopyUserPassword=zoneCopyUserPassword, zoneSetTable=zoneSetTable, zoneMergeFailRecoverResult=zoneMergeFailRecoverResult, zoneServerMIBComplianceRev3=zoneServerMIBComplianceRev3, PYSNMP_MODULE_ID=ciscoZsMIB, zoneMemberList=zoneMemberList, zoneStatsTable=zoneStatsTable, zoneSetZoneListEntry=zoneSetZoneListEntry, zoneServerMIBComplianceRev8=zoneServerMIBComplianceRev8, zoneName=zoneName, zoneServerMIBCompliances=zoneServerMIBCompliances, zoneMemberParentIndex=zoneMemberParentIndex, zoneCopyEntry=zoneCopyEntry, zoneActivateNotify=zoneActivateNotify, zoneSetName=zoneSetName, zoneVsanId=zoneVsanId, zoneServiceReqRejNotify=zoneServiceReqRejNotify, zoneLunStatsGroup=zoneLunStatsGroup, zoneMemberFormat=zoneMemberFormat, zoneMergeFailureReason=zoneMergeFailureReason, zoneSetZoneListTable=zoneSetZoneListTable, zoneSetZoneListBmap8k=zoneSetZoneListBmap8k, zoneSetZoneListBmap16k=zoneSetZoneListBmap16k, zoneTxChangeReqs=zoneTxChangeReqs, zoneEnforcedZoneAliasList=zoneEnforcedZoneAliasList, zoneEnforcedZoneBroadcast=zoneEnforcedZoneBroadcast, zoneSetActivateTable=zoneSetActivateTable, zoneMemberEntry=zoneMemberEntry, zoneRoZoneTxDataProts=zoneRoZoneTxDataProts, zoneSetActivateEntry=zoneSetActivateEntry, zoneServiceRejReasonCode=zoneServiceRejReasonCode, zoneServiceRejReasonCodeExp=zoneServiceRejReasonCodeExp, ciscoZsMIB=ciscoZsMIB, ZoneCopyProtocol=ZoneCopyProtocol, zoneSetZoneListBmap6k=zoneSetZoneListBmap6k, FcChangeProtoFailCause=FcChangeProtoFailCause, zoneTotalGS3Rejects=zoneTotalGS3Rejects, zoneConfigurationGroup5=zoneConfigurationGroup5, zoneTable=zoneTable, zoneCopyActToFullSpinLock=zoneCopyActToFullSpinLock, zoneConfigurationGroup3=zoneConfigurationGroup3, zoneNotificationControlGroup1Sup2=zoneNotificationControlGroup1Sup2, zoneRoZoneDstFcId=zoneRoZoneDstFcId, zoneQos=zoneQos, zoneRxMergeAccepts=zoneRxMergeAccepts, zoneCopyServerAddr=zoneCopyServerAddr, zoneDefZoneBehvrChngNotifyEnable=zoneDefZoneBehvrChngNotifyEnable, zoneEnforcedZoneQosPriority=zoneEnforcedZoneQosPriority, zoneSetEnforcedZoneListBmap12k=zoneSetEnforcedZoneListBmap12k, zoneServerMIBComplianceRev2=zoneServerMIBComplianceRev2, FcList=FcList, zoneEnforcedZoneMemberNumber=zoneEnforcedZoneMemberNumber, zoneConfiguration=zoneConfiguration, zoneSetRowStatus=zoneSetRowStatus, zoneAliasTable=zoneAliasTable, zoneNotification=zoneNotification, zoneRxChangeAccepts=zoneRxChangeAccepts, zoneServerMIBComplianceRev6=zoneServerMIBComplianceRev6, zoneMemberTable=zoneMemberTable, zoneMemberLunID=zoneMemberLunID, zoneEnforcedZoneEntry=zoneEnforcedZoneEntry, zoneUnsuppMemInIntOpModeNotify=zoneUnsuppMemInIntOpModeNotify, zoneNotificationControlGroup1=zoneNotificationControlGroup1, zoneSetDeActivate=zoneSetDeActivate, ZoneQosPriorityLevel=ZoneQosPriorityLevel, zoneLunRxSenseReqs=zoneLunRxSenseReqs, zoneCopyUserName=zoneCopyUserName, zoneConfigurationGroup=zoneConfigurationGroup, zoneEnforcedZoneAliasMemberList=zoneEnforcedZoneAliasMemberList, zoneSetPropagationTable=zoneSetPropagationTable, zoneSetZoneListBmap14k=zoneSetZoneListBmap14k)
