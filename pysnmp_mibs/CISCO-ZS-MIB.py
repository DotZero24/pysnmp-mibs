...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-ZS-MIB
...
DomainIdOrZero, FcAddressId, FcNameId, VsanIndex = mibBuilder.importSymbols("CISCO-ST-TC", "DomainIdOrZero", "FcAddressId", "FcNameId", "VsanIndex")
...
ciscoZsMIB.setRevisions(('2014-11-25 00:00', '2012-04-12 00:00', '2011-10-31 00:00', '2008-03-06 00:00', '2006-07-05 00:00', '2005-11-10 00:00', '2005-04-07 00:00', '2004-09-01 00:00', '2004-01-27 00:00', '2003-12-12 00:00', '2003-08-25 00:00', '2003-08-01 00:00', '2003-03-26 00:00', '2003-01-17 00:00', '2002-11-08 00:00', '2002-10-28 00:00', '2002-10-03 00:00',))
if mibBuilder.loadTexts: ciscoZsMIB.setLastUpdated('201411250000Z')
...
zoneSmartZoning = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 7, 1, 12), TruthValue().clone('true')).setMaxAccess("readcreate")
if mibBuilder.loadTexts: zoneSmartZoning.setStatus('current')
...
zoneMemberAttr = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 11, 1, 8), ZoneMemberDeviceTypeAttr().clone('both')).setMaxAccess("readcreate")
if mibBuilder.loadTexts: zoneMemberAttr.setStatus('current')
...
zoneEnforcedZoneSmartZoning = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 15, 1, 9), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: zoneEnforcedZoneSmartZoning.setStatus('current')
...
zoneEnforcedZoneMemberAttr = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 19, 1, 4), ZoneMemberDeviceTypeAttr()).setMaxAccess("readonly")
if mibBuilder.loadTexts: zoneEnforcedZoneMemberAttr.setStatus('current')
...
zoneDbClearDb = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 30, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("clear", 1), ("noop", 2), ("clearAutoZones", 3)))).setMaxAccess("readwrite")
...
zoneSetZoneListBmap10k = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 38, 1, 4), FcList().clone(hexValue="")).setMaxAccess("readcreate")
if mibBuilder.loadTexts: zoneSetZoneListBmap10k.setStatus('current')
zoneSetZoneListBmap12k = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 38, 1, 5), FcList().clone(hexValue="")).setMaxAccess("readcreate")
if mibBuilder.loadTexts: zoneSetZoneListBmap12k.setStatus('current')
zoneSetZoneListBmap14k = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 38, 1, 6), FcList().clone(hexValue="")).setMaxAccess("readcreate")
if mibBuilder.loadTexts: zoneSetZoneListBmap14k.setStatus('current')
zoneSetZoneListBmap16k = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 38, 1, 7), FcList().clone(hexValue="")).setMaxAccess("readcreate")
if mibBuilder.loadTexts: zoneSetZoneListBmap16k.setStatus('current')
...
zoneSetEnforcedZoneListBmap10k = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 39, 1, 4), FcList()).setMaxAccess("readonly")
if mibBuilder.loadTexts: zoneSetEnforcedZoneListBmap10k.setStatus('current')
zoneSetEnforcedZoneListBmap12k = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 39, 1, 5), FcList()).setMaxAccess("readonly")
if mibBuilder.loadTexts: zoneSetEnforcedZoneListBmap12k.setStatus('current')
zoneSetEnforcedZoneListBmap14k = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 39, 1, 6), FcList()).setMaxAccess("readonly")
if mibBuilder.loadTexts: zoneSetEnforcedZoneListBmap14k.setStatus('current')
zoneSetEnforcedZoneListBmap16k = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 39, 1, 7), FcList()).setMaxAccess("readonly")
if mibBuilder.loadTexts: zoneSetEnforcedZoneListBmap16k.setStatus('current')
...
if mibBuilder.loadTexts: zoneCompactFirst2k.setStatus('deprecated')
zoneCompactZones = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 40, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("compact", 1), ("noop", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: zoneCompactZones.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    zoneServerMIBComplianceRev8 = zoneServerMIBComplianceRev8.setStatus('deprecated')
zoneServerMIBComplianceRev9 = ModuleCompliance((1, 3, 6, 1, 4, 1, 9, 9, 294, 2, 1, 10)).setObjects(("CISCO-ZS-MIB", "zoneConfigurationGroup7"), ("CISCO-ZS-MIB", "zoneStatisticsGroup"), ("CISCO-ZS-MIB", "zoneNotificationControlGroup1"), ("CISCO-ZS-MIB", "zoneNotificationGroup2"), ("CISCO-ZS-MIB", "zoneNotificationControlGroup1Sup1"), ("CISCO-ZS-MIB", "zoneConfigGroupSup2"), ("CISCO-ZS-MIB", "zoneLunStatsGroup"), ("CISCO-ZS-MIB", "zoneNotificationControlGroup1Sup2"), ("CISCO-ZS-MIB", "zoneNotificationGroup2Sup1"), ("CISCO-ZS-MIB", "zoneConfigGroupSup4"), ("CISCO-ZS-MIB", "zoneConfigGroupSup5"), ("CISCO-ZS-MIB", "zoneConfigGroupSup6"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    zoneServerMIBComplianceRev9 = zoneServerMIBComplianceRev9.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    zoneConfigGroupSup1 = zoneConfigGroupSup1.setStatus('deprecated')
...
zoneConfigurationGroup7 = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 294, 2, 2, 20)).setObjects(("CISCO-ZS-MIB", "zoneSetPropagationMode"), ("CISCO-ZS-MIB", "zoneDefaultZoneBehaviour"), ("CISCO-ZS-MIB", "zoneDefaultZoneReadOnly"), ("CISCO-ZS-MIB", "zoneDefaultZoneQos"), ("CISCO-ZS-MIB", "zoneDefaultZoneQosPriority"), ("CISCO-ZS-MIB", "zoneDefaultZoneBroadcast"), ("CISCO-ZS-MIB", "zoneSetNumber"), ("CISCO-ZS-MIB", "zoneSetName"), ("CISCO-ZS-MIB", "zoneSetZoneList"), ("CISCO-ZS-MIB", "zoneSetLastChange"), ("CISCO-ZS-MIB", "zoneSetRowStatus"), ("CISCO-ZS-MIB", "zoneSetClone"), ("CISCO-ZS-MIB", "zoneSetActivate"), ("CISCO-ZS-MIB", "zoneSetActivateResult"), ("CISCO-ZS-MIB", "zoneSetDeActivate"), ("CISCO-ZS-MIB", "zoneSetActivateRowStatus"), ("CISCO-ZS-MIB", "zoneSetFailCause"), ("CISCO-ZS-MIB", "zoneSetFailDomId"), ("CISCO-ZS-MIB", "zoneNumber"), ("CISCO-ZS-MIB", "zoneName"), ("CISCO-ZS-MIB", "zoneMemberList"), ("CISCO-ZS-MIB", "zoneAliasList"), ("CISCO-ZS-MIB", "zoneLastChange"), ("CISCO-ZS-MIB", "zoneRowStatus"), ("CISCO-ZS-MIB", "zoneReadOnly"), ("CISCO-ZS-MIB", "zoneQos"), ("CISCO-ZS-MIB", "zoneQosPriority"), ("CISCO-ZS-MIB", "zoneBroadcast"), ("CISCO-ZS-MIB", "zoneClone"), ("CISCO-ZS-MIB", "zoneSmartZoning"), ("CISCO-ZS-MIB", "zoneAliasNumber"), ("CISCO-ZS-MIB", "zoneAliasName"), ("CISCO-ZS-MIB", "zoneAliasMemberList"), ("CISCO-ZS-MIB", "zoneAliasRowStatus"), ("CISCO-ZS-MIB", "zoneAliasLastChange"), ("CISCO-ZS-MIB", "zoneAliasClone"), ("CISCO-ZS-MIB", "zoneMemberNumber"), ("CISCO-ZS-MIB", "zoneMemberFormat"), ("CISCO-ZS-MIB", "zoneMemberID"), ("CISCO-ZS-MIB", "zoneMemberLunID"), ("CISCO-ZS-MIB", "zoneMemberRowStatus"), ("CISCO-ZS-MIB", "zoneMemberAttr"), ("CISCO-ZS-MIB", "zoneEnforcedZoneSetNumber"), ("CISCO-ZS-MIB", "zoneEnforcedZoneSetName"), ("CISCO-ZS-MIB", "zoneEnforcedZoneSetZoneList"), ("CISCO-ZS-MIB", "zoneEnforcedZoneSetActivateTime"), ("CISCO-ZS-MIB", "zoneEnforcedZoneNumber"), ("CISCO-ZS-MIB", "zoneEnforcedZoneName"), ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberList"), ("CISCO-ZS-MIB", "zoneEnforcedZoneAliasList"), ("CISCO-ZS-MIB", "zoneEnforcedZoneActivateTime"), ("CISCO-ZS-MIB", "zoneEnforcedZoneReadOnly"), ("CISCO-ZS-MIB", "zoneEnforcedZoneQos"), ("CISCO-ZS-MIB", "zoneEnforcedZoneQosPriority"), ("CISCO-ZS-MIB", "zoneEnforcedZoneBroadcast"), ("CISCO-ZS-MIB", "zoneEnforcedZoneSmartZoning"), ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberNumber"), ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberFormat"), ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberID"), ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberLunID"), ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberAttr"), ("CISCO-ZS-MIB", "zoneMergeFailRecoverSpinLock"), ("CISCO-ZS-MIB", "zoneMergeFailRecoverInterface"), ("CISCO-ZS-MIB", "zoneMergeFailRecoverVsan"), ("CISCO-ZS-MIB", "zoneMergeFailRecoverOper"), ("CISCO-ZS-MIB", "zoneMergeFailRecoverResult"), ("CISCO-ZS-MIB", "zoneDbClearDb"), ("CISCO-ZS-MIB", "zoneDbEnforcedEqualsLocal"), ("CISCO-ZS-MIB", "zoneDbHardZoningEnabled"), ("CISCO-ZS-MIB", "zoneCopyProto"), ("CISCO-ZS-MIB", "zoneCopyDestFileType"), ("CISCO-ZS-MIB", "zoneCopyServerAddrType"), ("CISCO-ZS-MIB", "zoneCopyServerAddr"), ("CISCO-ZS-MIB", "zoneCopyDestFileName"), ("CISCO-ZS-MIB", "zoneCopyUserName"), ("CISCO-ZS-MIB", "zoneCopyUserPassword"), ("CISCO-ZS-MIB", "zoneCopyStartCopy"), ("CISCO-ZS-MIB", "zoneCopyState"), ("CISCO-ZS-MIB", "zoneCopyRowStatus"), ("CISCO-ZS-MIB", "zoneZoneSetDistributeVsan"), ("CISCO-ZS-MIB", "zoneZoneSetDistributeResult"), ("CISCO-ZS-MIB", "zoneZoneSetDistributeFailReason"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    zoneConfigurationGroup7 = zoneConfigurationGroup7.setStatus('current')
zoneConfigGroupSup4 = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 294, 2, 2, 21)).setObjects(("CISCO-ZS-MIB", "zoneSetZoneListBmap4k"), ("CISCO-ZS-MIB", "zoneSetZoneListBmap6k"), ("CISCO-ZS-MIB", "zoneSetZoneListBmap8k"), ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap4k"), ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap6k"), ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap8k"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    zoneConfigGroupSup4 = zoneConfigGroupSup4.setStatus('current')
zoneConfigGroupSup5 = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 294, 2, 2, 22)).setObjects(("CISCO-ZS-MIB", "zoneSetZoneListBmap10k"), ("CISCO-ZS-MIB", "zoneSetZoneListBmap12k"), ("CISCO-ZS-MIB", "zoneSetZoneListBmap14k"), ("CISCO-ZS-MIB", "zoneSetZoneListBmap16k"), ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap10k"), ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap12k"), ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap14k"), ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap16k"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    zoneConfigGroupSup5 = zoneConfigGroupSup5.setStatus('current')
zoneConfigGroupSup6 = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 294, 2, 2, 23)).setObjects(("CISCO-ZS-MIB", "zoneCompactZones"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    zoneConfigGroupSup6 = zoneConfigGroupSup6.setStatus('current')
mibBuilder.exportSymbols("CISCO-ZS-MIB", zoneConfigurationGroup7=zoneConfigurationGroup7, zoneMemberRowStatus=zoneMemberRowStatus, zoneTxGS3Rejects=zoneTxGS3Rejects, zoneSwitchWwn=zoneSwitchWwn, ciscoZsMIB=ciscoZsMIB, zoneNotificationGroup1=zoneNotificationGroup1, zoneAliasRowStatus=zoneAliasRowStatus, zoneMemberTypeIndex=zoneMemberTypeIndex, ZoneMergeFailCause=ZoneMergeFailCause, zoneAliasList=zoneAliasList, zoneVsanId=zoneVsanId, zoneSetZoneListBmap12k=zoneSetZoneListBmap12k, zoneServerMIBComplianceRev3=zoneServerMIBComplianceRev3, zoneName=zoneName, zoneEnforcedZoneSetZoneList=zoneEnforcedZoneSetZoneList, zoneCopyUserName=zoneCopyUserName, zoneSetLastChange=zoneSetLastChange, zoneReadOnly=zoneReadOnly, zoneNotification=zoneNotification, zoneSetZoneListBmap14k=zoneSetZoneListBmap14k, zoneServerMIBCompliances=zoneServerMIBCompliances, zoneSetEnforcedZoneListBmap16k=zoneSetEnforcedZoneListBmap16k, zoneSetDeActivate=zoneSetDeActivate, zoneEnforcedZoneMemberList=zoneEnforcedZoneMemberList, zoneSetEnforcedZoneListBmap10k=zoneSetEnforcedZoneListBmap10k, zoneDefaultZoneBehaviour=zoneDefaultZoneBehaviour, zoneConfigurationGroup5=zoneConfigurationGroup5, zoneMemberList=zoneMemberList, zoneEnforcedZoneQosPriority=zoneEnforcedZoneQosPriority, zoneLunRxRepLunReqs=zoneLunRxRepLunReqs, zoneTxChangeReqs=zoneTxChangeReqs, zoneSetActivateEntry=zoneSetActivateEntry, zoneLastChange=zoneLastChange, zoneDbClearDb=zoneDbClearDb, zoneSetZoneListTable=zoneSetZoneListTable, zoneQos=zoneQos, zoneCopyUserPassword=zoneCopyUserPassword, zoneSetEnforcedZoneListBmap4k=zoneSetEnforcedZoneListBmap4k, zoneSetTable=zoneSetTable, zoneRoZoneSrcFcId=zoneRoZoneSrcFcId, FcList=FcList, zoneDefZoneBehaviourChngNotify=zoneDefZoneBehaviourChngNotify, zoneNotificationControlGroup1Sup2=zoneNotificationControlGroup1Sup2, zoneZoneSetDistributeResult=zoneZoneSetDistributeResult, zoneSetIndex=zoneSetIndex, zoneMergeSuccessNotifyEnable=zoneMergeSuccessNotifyEnable, zoneDbTable=zoneDbTable, zoneCompactZones=zoneCompactZones, zoneRxChangeAccepts=zoneRxChangeAccepts, zoneEnforcedZoneSetNumber=zoneEnforcedZoneSetNumber, zoneTotalGS3Rejects=zoneTotalGS3Rejects, zoneLunDstFcId=zoneLunDstFcId, zoneSetEnforcedZoneListBmap8k=zoneSetEnforcedZoneListBmap8k, zoneEntry=zoneEntry, zoneServerMIBComplianceRev4=zoneServerMIBComplianceRev4, zoneLunStatsTable=zoneLunStatsTable, zoneSetActivateRowStatus=zoneSetActivateRowStatus, zoneConfigurationGroup4=zoneConfigurationGroup4, zoneCompactTable=zoneCompactTable, zoneMemberLunID=zoneMemberLunID, zoneAliasLastChange=zoneAliasLastChange, zoneSetEnforcedZoneListTable=zoneSetEnforcedZoneListTable, zoneEnforcedZoneSetEntry=zoneEnforcedZoneSetEntry, zoneSetZoneListBmap10k=zoneSetZoneListBmap10k, zoneTxMergeReqs=zoneTxMergeReqs, zoneConfigurationGroup6=zoneConfigurationGroup6, zoneDefaultZoneQos=zoneDefaultZoneQos, zoneServerMIBConformance=zoneServerMIBConformance, zoneSetClone=zoneSetClone, zoneCopyActToFullMode=zoneCopyActToFullMode, zoneCompactNotify=zoneCompactNotify, zoneConfigurationGroup2=zoneConfigurationGroup2, zoneNotificationGroup2Sup1=zoneNotificationGroup2Sup1, zoneEnforcedZoneMemberTable=zoneEnforcedZoneMemberTable, zoneMergeFailRecoverSpinLock=zoneMergeFailRecoverSpinLock, zoneServiceReqRejNotify=zoneServiceReqRejNotify, zoneClone=zoneClone, zoneTable=zoneTable, zoneNotificationControlGroup1=zoneNotificationControlGroup1, ZoneQosPriorityLevel=ZoneQosPriorityLevel, zoneSetNumber=zoneSetNumber, zoneMergeFailRecoverInterface=zoneMergeFailRecoverInterface, ZoneCopyProtocol=ZoneCopyProtocol, zoneServerMIBComplianceRev8=zoneServerMIBComplianceRev8, zoneSetZoneList=zoneSetZoneList, zoneServerMIBComplianceRev6=zoneServerMIBComplianceRev6, zoneMemberNumber=zoneMemberNumber, zoneCopyActToFullVsan=zoneCopyActToFullVsan, zoneSetFailCause=zoneSetFailCause, zoneServerMIBComplianceRev5=zoneServerMIBComplianceRev5, zoneEnforcedZoneMemberNumber=zoneEnforcedZoneMemberNumber, zoneTxChangeAccepts=zoneTxChangeAccepts, zoneMergeFailureReason=zoneMergeFailureReason, zoneSetZoneListBmap6k=zoneSetZoneListBmap6k, zoneRxGS3Reqs=zoneRxGS3Reqs, zoneRxMergeReqs=zoneRxMergeReqs, zoneRoZoneLunNum=zoneRoZoneLunNum, zoneMemberIndex=zoneMemberIndex, zoneSetActivate=zoneSetActivate, zoneDbEntry=zoneDbEntry, zoneUnsuppMemInIntOpModeNotify=zoneUnsuppMemInIntOpModeNotify, PYSNMP_MODULE_ID=ciscoZsMIB, zoneEnforcedZoneAliasTable=zoneEnforcedZoneAliasTable, zoneSetEnforcedZoneListBmap14k=zoneSetEnforcedZoneListBmap14k, zoneLunSrcFcId=zoneLunSrcFcId, zoneSetZoneListBmap16k=zoneSetZoneListBmap16k, zoneRowStatus=zoneRowStatus, zoneStatsTable=zoneStatsTable, zoneLunTxInqDataNoLus=zoneLunTxInqDataNoLus, zoneSetEnforcedZoneListBmap12k=zoneSetEnforcedZoneListBmap12k, zoneRoZoneTxDataProts=zoneRoZoneTxDataProts, zoneServiceReqRejNotifyEnable=zoneServiceReqRejNotifyEnable, zoneAliasName=zoneAliasName, zoneEnforcedZoneAliasList=zoneEnforcedZoneAliasList, zoneLunRxSenseReqs=zoneLunRxSenseReqs, zoneAliasMemberList=zoneAliasMemberList, zoneConfigGroupSup6=zoneConfigGroupSup6, zoneLunTxIllegalReqs=zoneLunTxIllegalReqs, zoneEnforcedZoneEntry=zoneEnforcedZoneEntry, zoneEnforcedZoneSmartZoning=zoneEnforcedZoneSmartZoning, zoneMergeFailRecoverResult=zoneMergeFailRecoverResult, zoneEnforcedZoneTable=zoneEnforcedZoneTable, zoneMemberTable=zoneMemberTable, zoneRoZoneStatsTable=zoneRoZoneStatsTable, zoneStatsEntry=zoneStatsEntry, zoneServerMIBComplianceRev7=zoneServerMIBComplianceRev7, zoneConfigurationGroup3=zoneConfigurationGroup3, ZoneMemberType=ZoneMemberType, zoneSetActivateResult=zoneSetActivateResult, zoneConfigGroupSup4=zoneConfigGroupSup4, zoneAliasClone=zoneAliasClone, zoneMemberAttr=zoneMemberAttr, zoneCopyActiveToFullOnVsan=zoneCopyActiveToFullOnVsan, zoneMemberFormat=zoneMemberFormat, zoneNotificationGroup=zoneNotificationGroup, zoneActivateNotify=zoneActivateNotify, zoneEnforcedZoneSetActivateTime=zoneEnforcedZoneSetActivateTime, zoneBroadcast=zoneBroadcast, zoneDefaultZoneTable=zoneDefaultZoneTable, zoneEnforcedZoneQos=zoneEnforcedZoneQos, zoneCopyState=zoneCopyState, zoneMemberEntry=zoneMemberEntry, zoneRoZoneDstFcId=zoneRoZoneDstFcId, zoneMergeFailureVSANNum=zoneMergeFailureVSANNum, zoneEnforcedZoneSetTable=zoneEnforcedZoneSetTable, zoneSetPropagationMode=zoneSetPropagationMode, zoneEnforcedZoneAliasEntry=zoneEnforcedZoneAliasEntry, zoneNumber=zoneNumber, zoneServiceRejReasonCode=zoneServiceRejReasonCode, zoneServerMIBComplianceRev9=zoneServerMIBComplianceRev9, zoneAliasTable=zoneAliasTable, zoneEnforcedZoneNumber=zoneEnforcedZoneNumber, zoneEnforcedZoneMemberFormat=zoneEnforcedZoneMemberFormat, zoneEnforcedZoneBroadcast=zoneEnforcedZoneBroadcast, zoneMergeFailRecoverVsan=zoneMergeFailRecoverVsan, zoneServerMIBGroups=zoneServerMIBGroups, zoneSetZoneListEntry=zoneSetZoneListEntry, ZoneMemberDeviceTypeAttr=ZoneMemberDeviceTypeAttr, zoneDbEnforcedEqualsLocal=zoneDbEnforcedEqualsLocal, zoneAliasEntry=zoneAliasEntry, FcChangeProtoFailCause=FcChangeProtoFailCause, zoneInformation=zoneInformation, zoneSetName=zoneSetName, zoneEnforcedZoneMemberAttr=zoneEnforcedZoneMemberAttr, zoneCopyDestFileType=zoneCopyDestFileType, zoneEnforcedZoneAliasMemberList=zoneEnforcedZoneAliasMemberList, zoneCompactVsan=zoneCompactVsan, FcZoneServerRejReasonExpl=FcZoneServerRejReasonExpl, zoneEnforcedZoneName=zoneEnforcedZoneName, zoneMergeFailureNotify=zoneMergeFailureNotify, zoneStats=zoneStats, zoneConfiguration=zoneConfiguration, zoneSetPropagationTable=zoneSetPropagationTable, zoneDbHardZoningEnabled=zoneDbHardZoningEnabled, zoneUnsuppMemInIntOpNotifyEnable=zoneUnsuppMemInIntOpNotifyEnable, zoneNotificationControlGroup=zoneNotificationControlGroup, zoneSetEnforcedZoneListBmap6k=zoneSetEnforcedZoneListBmap6k, zoneTxMergeAccepts=zoneTxMergeAccepts, zoneSetEnforcedZoneListEntry=zoneSetEnforcedZoneListEntry, zoneLunStatsGroup=zoneLunStatsGroup, ZoneFileType=ZoneFileType, zoneEnforcedZoneAliasNumber=zoneEnforcedZoneAliasNumber, zoneLunRxOtherCmds=zoneLunRxOtherCmds, zoneCopyServerAddr=zoneCopyServerAddr, zoneNotificationGroup2=zoneNotificationGroup2, zoneSetFailDomId=zoneSetFailDomId, zoneZoneSetDistributeFailReason=zoneZoneSetDistributeFailReason, zoneEnforcedZoneActivateTime=zoneEnforcedZoneActivateTime, zoneSetActivateTable=zoneSetActivateTable, zoneMergeSuccessNotify=zoneMergeSuccessNotify, zoneEnforcedZoneAliasName=zoneEnforcedZoneAliasName, zoneConfigGroupSup1=zoneConfigGroupSup1, zoneConfigGroupSup2=zoneConfigGroupSup2, zoneSmartZoning=zoneSmartZoning, zoneCopyEntry=zoneCopyEntry, zoneSetZoneListBmap8k=zoneSetZoneListBmap8k, zoneDefaultZoneEntry=zoneDefaultZoneEntry, zoneConfigurationGroup=zoneConfigurationGroup, zoneEnforcedZoneSetName=zoneEnforcedZoneSetName, zoneCompactEntry=zoneCompactEntry, zoneCompactFirst2k=zoneCompactFirst2k, zoneServerMIBCompliance=zoneServerMIBCompliance, zoneQosPriority=zoneQosPriority, zoneEnforcedZoneMemberEntry=zoneEnforcedZoneMemberEntry, zoneCopyTable=zoneCopyTable, ciscoZoningMIBObjects=ciscoZoningMIBObjects, zoneCopyServerAddrType=zoneCopyServerAddrType, zoneAliasIndex=zoneAliasIndex, zoneServerMIBCompliance1=zoneServerMIBCompliance1, zoneRxMergeAccepts=zoneRxMergeAccepts, zoneMergeFailRecoverOper=zoneMergeFailRecoverOper, zoneDefaultZoneBroadcast=zoneDefaultZoneBroadcast, zoneEnforcedZoneReadOnly=zoneEnforcedZoneReadOnly, zoneLunStatsEntry=zoneLunStatsEntry, zoneMemberParentIndex=zoneMemberParentIndex, zoneStatisticsGroup=zoneStatisticsGroup, zoneEnforcedZoneMemberLunID=zoneEnforcedZoneMemberLunID, zoneConfigGroupSup5=zoneConfigGroupSup5, zoneSetZoneListBmap4k=zoneSetZoneListBmap4k, zoneCopyRowStatus=zoneCopyRowStatus, zoneLunRxInqReqs=zoneLunRxInqReqs, zoneEnforcedZoneMemberID=zoneEnforcedZoneMemberID, zoneSetEntry=zoneSetEntry, zoneMergeSuccessVSANNum=zoneMergeSuccessVSANNum, zoneAliasNumber=zoneAliasNumber, zoneMemberID=zoneMemberID, zoneMergeFailureNotifyEnable=zoneMergeFailureNotifyEnable, zoneCopyDestFileName=zoneCopyDestFileName, zoneCopyStartCopy=zoneCopyStartCopy, zoneLunNum=zoneLunNum, zoneNotifications=zoneNotifications, zoneCopyProto=zoneCopyProto, zoneServiceRejReasonCodeExp=zoneServiceRejReasonCodeExp, zoneServerMIBComplianceRev2=zoneServerMIBComplianceRev2, zoneZoneSetDistributeVsan=zoneZoneSetDistributeVsan, zoneConfigurationGroup1=zoneConfigurationGroup1, zoneNotificationControlGroup1Sup1=zoneNotificationControlGroup1Sup1, zoneDefZoneBehvrChngNotifyEnable=zoneDefZoneBehvrChngNotifyEnable, zoneSetPropagationEntry=zoneSetPropagationEntry, zoneRoZoneStatsEntry=zoneRoZoneStatsEntry, zoneDefaultZoneReadOnly=zoneDefaultZoneReadOnly, zoneDefaultZoneQosPriority=zoneDefaultZoneQosPriority, zoneIndex=zoneIndex, zoneMergeFailureObject=zoneMergeFailureObject, zoneSetRowStatus=zoneSetRowStatus, zoneCopyActToFullSpinLock=zoneCopyActToFullSpinLock, zoneRxChangeReqs=zoneRxChangeReqs)
