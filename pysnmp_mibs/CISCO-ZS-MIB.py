...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ZS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:42:01 2025
...
class ZoneMemberDeviceTypeAttr(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
_ZoneDefaultZoneReadOnly_Type.__name__ = "TruthValue"
...
_ZoneDefaultZoneQosPriority_Type.__name__ = "ZoneQosPriorityLevel"
...
_ZoneSetZoneList_Type.__name__ = "FcList"
...
_ZoneMemberList_Type.__name__ = "FcList"
...
_ZoneAliasList_Type.__name__ = "FcList"
...
_ZoneReadOnly_Type.__name__ = "TruthValue"
...
_ZoneQos_Type.__name__ = "TruthValue"
...
_ZoneQosPriority_Type.__name__ = "ZoneQosPriorityLevel"
...
_ZoneBroadcast_Type.__name__ = "TruthValue"
...
class _ZoneSmartZoning_Type(TruthValue):
    """Custom type zoneSmartZoning based on TruthValue"""
    defaultValue = 1


_ZoneSmartZoning_Type.__name__ = "TruthValue"
_ZoneSmartZoning_Object = MibTableColumn
zoneSmartZoning = _ZoneSmartZoning_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 7, 1, 12),
    _ZoneSmartZoning_Type()
)
zoneSmartZoning.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    zoneSmartZoning.setStatus("current")
...
_ZoneAliasMemberList_Type.__name__ = "FcList"
...
class _ZoneMemberAttr_Type(ZoneMemberDeviceTypeAttr):
    """Custom type zoneMemberAttr based on ZoneMemberDeviceTypeAttr"""
    defaultValue = 3


_ZoneMemberAttr_Type.__name__ = "ZoneMemberDeviceTypeAttr"
_ZoneMemberAttr_Object = MibTableColumn
zoneMemberAttr = _ZoneMemberAttr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 11, 1, 8),
    _ZoneMemberAttr_Type()
)
zoneMemberAttr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    zoneMemberAttr.setStatus("current")
...
_ZoneEnforcedZoneSmartZoning_Type = TruthValue
_ZoneEnforcedZoneSmartZoning_Object = MibTableColumn
zoneEnforcedZoneSmartZoning = _ZoneEnforcedZoneSmartZoning_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 15, 1, 9),
    _ZoneEnforcedZoneSmartZoning_Type()
)
zoneEnforcedZoneSmartZoning.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    zoneEnforcedZoneSmartZoning.setStatus("current")
...
_ZoneEnforcedZoneMemberAttr_Type = ZoneMemberDeviceTypeAttr
_ZoneEnforcedZoneMemberAttr_Object = MibTableColumn
zoneEnforcedZoneMemberAttr = _ZoneEnforcedZoneMemberAttr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 19, 1, 4),
    _ZoneEnforcedZoneMemberAttr_Type()
)
zoneEnforcedZoneMemberAttr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    zoneEnforcedZoneMemberAttr.setStatus("current")
...
_ZoneMergeFailRecoverVsan_Type.__name__ = "VsanIndex"
...
_ZoneCopyProto_Type.__name__ = "ZoneCopyProtocol"
...
_ZoneCopyDestFileType_Type.__name__ = "ZoneFileType"
...
_ZoneCopyServerAddrType_Type.__name__ = "InetAddressType"
...
_ZoneUnsuppMemInIntOpNotifyEnable_Type.__name__ = "TruthValue"
...
_ZoneSetZoneListBmap4k_Type.__name__ = "FcList"
...
_ZoneSetZoneListBmap6k_Type.__name__ = "FcList"
...
_ZoneSetZoneListBmap8k_Type.__name__ = "FcList"
...
class _ZoneSetZoneListBmap10k_Type(FcList):
    """Custom type zoneSetZoneListBmap10k based on FcList"""
    defaultHexValue = ""


_ZoneSetZoneListBmap10k_Type.__name__ = "FcList"
_ZoneSetZoneListBmap10k_Object = MibTableColumn
zoneSetZoneListBmap10k = _ZoneSetZoneListBmap10k_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 38, 1, 4),
    _ZoneSetZoneListBmap10k_Type()
)
zoneSetZoneListBmap10k.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    zoneSetZoneListBmap10k.setStatus("current")


class _ZoneSetZoneListBmap12k_Type(FcList):
    """Custom type zoneSetZoneListBmap12k based on FcList"""
    defaultHexValue = ""


_ZoneSetZoneListBmap12k_Type.__name__ = "FcList"
_ZoneSetZoneListBmap12k_Object = MibTableColumn
zoneSetZoneListBmap12k = _ZoneSetZoneListBmap12k_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 38, 1, 5),
    _ZoneSetZoneListBmap12k_Type()
)
zoneSetZoneListBmap12k.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    zoneSetZoneListBmap12k.setStatus("current")


class _ZoneSetZoneListBmap14k_Type(FcList):
    """Custom type zoneSetZoneListBmap14k based on FcList"""
    defaultHexValue = ""


_ZoneSetZoneListBmap14k_Type.__name__ = "FcList"
_ZoneSetZoneListBmap14k_Object = MibTableColumn
zoneSetZoneListBmap14k = _ZoneSetZoneListBmap14k_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 38, 1, 6),
    _ZoneSetZoneListBmap14k_Type()
)
zoneSetZoneListBmap14k.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    zoneSetZoneListBmap14k.setStatus("current")


class _ZoneSetZoneListBmap16k_Type(FcList):
    """Custom type zoneSetZoneListBmap16k based on FcList"""
    defaultHexValue = ""


_ZoneSetZoneListBmap16k_Type.__name__ = "FcList"
_ZoneSetZoneListBmap16k_Object = MibTableColumn
zoneSetZoneListBmap16k = _ZoneSetZoneListBmap16k_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 38, 1, 7),
    _ZoneSetZoneListBmap16k_Type()
)
zoneSetZoneListBmap16k.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    zoneSetZoneListBmap16k.setStatus("current")
...
_ZoneSetEnforcedZoneListBmap10k_Type = FcList
_ZoneSetEnforcedZoneListBmap10k_Object = MibTableColumn
zoneSetEnforcedZoneListBmap10k = _ZoneSetEnforcedZoneListBmap10k_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 39, 1, 4),
    _ZoneSetEnforcedZoneListBmap10k_Type()
)
zoneSetEnforcedZoneListBmap10k.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    zoneSetEnforcedZoneListBmap10k.setStatus("current")
_ZoneSetEnforcedZoneListBmap12k_Type = FcList
_ZoneSetEnforcedZoneListBmap12k_Object = MibTableColumn
zoneSetEnforcedZoneListBmap12k = _ZoneSetEnforcedZoneListBmap12k_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 39, 1, 5),
    _ZoneSetEnforcedZoneListBmap12k_Type()
)
zoneSetEnforcedZoneListBmap12k.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    zoneSetEnforcedZoneListBmap12k.setStatus("current")
_ZoneSetEnforcedZoneListBmap14k_Type = FcList
_ZoneSetEnforcedZoneListBmap14k_Object = MibTableColumn
zoneSetEnforcedZoneListBmap14k = _ZoneSetEnforcedZoneListBmap14k_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 39, 1, 6),
    _ZoneSetEnforcedZoneListBmap14k_Type()
)
zoneSetEnforcedZoneListBmap14k.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    zoneSetEnforcedZoneListBmap14k.setStatus("current")
_ZoneSetEnforcedZoneListBmap16k_Type = FcList
_ZoneSetEnforcedZoneListBmap16k_Object = MibTableColumn
zoneSetEnforcedZoneListBmap16k = _ZoneSetEnforcedZoneListBmap16k_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 39, 1, 7),
    _ZoneSetEnforcedZoneListBmap16k_Type()
)
zoneSetEnforcedZoneListBmap16k.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    zoneSetEnforcedZoneListBmap16k.setStatus("current")
...
if mibBuilder.loadTexts:
    zoneCompactFirst2k.setStatus("deprecated")


class _ZoneCompactZones_Type(Integer32):
    """Custom type zoneCompactZones based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ZoneCompactZones_Type.__name__ = "Integer32"
_ZoneCompactZones_Object = MibTableColumn
zoneCompactZones = _ZoneCompactZones_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 1, 1, 40, 1, 2),
    _ZoneCompactZones_Type()
)
zoneCompactZones.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zoneCompactZones.setStatus("current")
...
if mibBuilder.loadTexts:
    zoneConfigGroupSup1.setStatus("deprecated")
...
zoneConfigurationGroup7.setObjects(
      *(("CISCO-ZS-MIB", "zoneSetPropagationMode"),
        ...
        ("CISCO-ZS-MIB", "zoneEnforcedZoneQosPriority"),
        ("CISCO-ZS-MIB", "zoneEnforcedZoneBroadcast"),
        ("CISCO-ZS-MIB", "zoneEnforcedZoneSmartZoning"),
        ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberNumber"),
        ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberFormat"),
        ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberID"),
        ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberLunID"),
        ("CISCO-ZS-MIB", "zoneEnforcedZoneMemberAttr"),
        ("CISCO-ZS-MIB", "zoneMergeFailRecoverSpinLock"),
        ("CISCO-ZS-MIB", "zoneMergeFailRecoverInterface"),
        ("CISCO-ZS-MIB", "zoneMergeFailRecoverVsan"),
        ("CISCO-ZS-MIB", "zoneMergeFailRecoverOper"),
...
zoneConfigGroupSup4 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 2, 2, 21)
)
zoneConfigGroupSup4.setObjects(
      *(("CISCO-ZS-MIB", "zoneSetZoneListBmap4k"),
        ("CISCO-ZS-MIB", "zoneSetZoneListBmap6k"),
        ("CISCO-ZS-MIB", "zoneSetZoneListBmap8k"),
        ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap4k"),
...
if mibBuilder.loadTexts:
    zoneConfigGroupSup4.setStatus("current")

zoneConfigGroupSup5 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 2, 2, 22)
)
zoneConfigGroupSup5.setObjects(
      *(("CISCO-ZS-MIB", "zoneSetZoneListBmap10k"),
        ("CISCO-ZS-MIB", "zoneSetZoneListBmap12k"),
        ("CISCO-ZS-MIB", "zoneSetZoneListBmap14k"),
        ("CISCO-ZS-MIB", "zoneSetZoneListBmap16k"),
        ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap10k"),
        ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap12k"),
        ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap14k"),
        ("CISCO-ZS-MIB", "zoneSetEnforcedZoneListBmap16k"))
)
if mibBuilder.loadTexts:
    zoneConfigGroupSup5.setStatus("current")

zoneConfigGroupSup6 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 2, 2, 23)
)
zoneConfigGroupSup6.setObjects(
    ("CISCO-ZS-MIB", "zoneCompactZones")
)
if mibBuilder.loadTexts:
    zoneConfigGroupSup6.setStatus("current")
...
zoneServerMIBCompliance.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup"))
)
if mibBuilder.loadTexts:
...
zoneServerMIBCompliance1.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup1"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup"))
)
...
zoneServerMIBComplianceRev2.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup2"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup"),
        ("CISCO-ZS-MIB", "zoneLunStatsGroup"))
)
if mibBuilder.loadTexts:
...
zoneServerMIBComplianceRev3.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup3"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup"),
        ("CISCO-ZS-MIB", "zoneLunStatsGroup"))
...
zoneServerMIBComplianceRev4.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup3"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup1"),
        ("CISCO-ZS-MIB", "zoneLunStatsGroup"))
)
if mibBuilder.loadTexts:
...
zoneServerMIBComplianceRev5.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup4"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup1"),
        ("CISCO-ZS-MIB", "zoneLunStatsGroup"))
...
zoneServerMIBComplianceRev6.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup5"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup1"),
        ("CISCO-ZS-MIB", "zoneLunStatsGroup"))
...
zoneServerMIBComplianceRev7.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup6"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup2"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1Sup1"),
        ("CISCO-ZS-MIB", "zoneLunStatsGroup"))
)
if mibBuilder.loadTexts:
...
zoneServerMIBComplianceRev8.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup7"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup2"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1Sup1"),
        ("CISCO-ZS-MIB", "zoneConfigGroupSup2"),
        ("CISCO-ZS-MIB", "zoneLunStatsGroup"),
        ("CISCO-ZS-MIB", "zoneConfigGroupSup1"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1Sup2"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup2Sup1"))
)
if mibBuilder.loadTexts:
...
zoneServerMIBComplianceRev9 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 294, 2, 1, 10)
)
zoneServerMIBComplianceRev9.setObjects(
      *(("CISCO-ZS-MIB", "zoneConfigurationGroup7"),
        ("CISCO-ZS-MIB", "zoneStatisticsGroup"),
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup2"),
        ...
        ("CISCO-ZS-MIB", "zoneNotificationControlGroup1Sup2"),
        ("CISCO-ZS-MIB", "zoneNotificationGroup2Sup1"),
        ("CISCO-ZS-MIB", "zoneConfigGroupSup4"),
        ("CISCO-ZS-MIB", "zoneConfigGroupSup5"),
        ("CISCO-ZS-MIB", "zoneConfigGroupSup6"))
)
if mibBuilder.loadTexts:
    zoneServerMIBComplianceRev9.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"ZoneMemberType": ZoneMemberType,
       ...
       "ZoneMemberDeviceTypeAttr": ZoneMemberDeviceTypeAttr,
       ...
       "zoneClone": zoneClone,
       "zoneSmartZoning": zoneSmartZoning,
       ...
       "zoneEnforcedZoneSmartZoning": zoneEnforcedZoneSmartZoning,
       ...
       "zoneEnforcedZoneMemberAttr": zoneEnforcedZoneMemberAttr,
       ...
       "zoneSetZoneListBmap10k": zoneSetZoneListBmap10k,
       "zoneSetZoneListBmap12k": zoneSetZoneListBmap12k,
       "zoneSetZoneListBmap14k": zoneSetZoneListBmap14k,
       "zoneSetZoneListBmap16k": zoneSetZoneListBmap16k,
       ...
       "zoneSetEnforcedZoneListBmap10k": zoneSetEnforcedZoneListBmap10k,
       "zoneSetEnforcedZoneListBmap12k": zoneSetEnforcedZoneListBmap12k,
       "zoneSetEnforcedZoneListBmap14k": zoneSetEnforcedZoneListBmap14k,
       "zoneSetEnforcedZoneListBmap16k": zoneSetEnforcedZoneListBmap16k,
       "zoneCompactTable": zoneCompactTable,
       "zoneCompactEntry": zoneCompactEntry,
       "zoneCompactFirst2k": zoneCompactFirst2k,
       "zoneCompactZones": zoneCompactZones,
       ...
       "zoneServerMIBComplianceRev9": zoneServerMIBComplianceRev9,
       ...
       "zoneConfigGroupSup4": zoneConfigGroupSup4,
       "zoneConfigGroupSup5": zoneConfigGroupSup5,
       "zoneConfigGroupSup6": zoneConfigGroupSup6}
)
