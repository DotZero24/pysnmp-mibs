...
ZhoneFileName, ZhoneSlotValue, ZhoneRowStatus, ZhoneAdminString, ZhoneShelfValue = mibBuilder.importSymbols("Zhone-TC", "ZhoneFileName", "ZhoneSlotValue", "ZhoneRowStatus", "ZhoneAdminString", "ZhoneShelfValue")
...
mibBuilder.exportSymbols("ZHONE-COM-IP-DHCP-SERVER-MIB", bootpCountInvalids=bootpCountInvalids, dhcpSubnetRange3End=dhcpSubnetRange3End, dhcpServerSubnetTable=dhcpServerSubnetTable, dhcpServerLeaseEntry=dhcpServerLeaseEntry, dhcpGroupRowStatus=dhcpGroupRowStatus, dhcpSubnetOptionSecondaryNameServer=dhcpSubnetOptionSecondaryNameServer, dhcpSubnetOptionMinLeaseTime=dhcpSubnetOptionMinLeaseTime, dhcpGroupName=dhcpGroupName, dhcpGroupOptionDefaultLeaseTime=dhcpGroupOptionDefaultLeaseTime, dhcpCountDroppedNotServingSubnet=dhcpCountDroppedNotServingSubnet, dhcpHostOptionSecondaryNameServer=dhcpHostOptionSecondaryNameServer, dhcpGroupOptionMaxLeaseTime=dhcpGroupOptionMaxLeaseTime, dhcpSubnetOptionDomainName=dhcpSubnetOptionDomainName, dhcpGroupVendorMatchOffset=dhcpGroupVendorMatchOffset, dhcpGroupIndex=dhcpGroupIndex, dhcpSubnetRowStatus=dhcpSubnetRowStatus, dhcpSubnetRange2Start=dhcpSubnetRange2Start, bootpCountersTable=bootpCountersTable, dhcpSubnetNetwork=dhcpSubnetNetwork, serverUptime=serverUptime, dhcpServerSubnetOptionEntry=dhcpServerSubnetOptionEntry, dhcpLeaseEnds=dhcpLeaseEnds, bootpCountRequests=bootpCountRequests, dhcpTrapZhoneCpeDetected=dhcpTrapZhoneCpeDetected, dhcpSubnetRange4End=dhcpSubnetRange4End, dhcpGroupOptionDefaultRouter=dhcpGroupOptionDefaultRouter, dhcpLeaseClientId=dhcpLeaseClientId, bootpCountDroppedUnknownClients=bootpCountDroppedUnknownClients, dhcpHostOptionMinLeaseTime=dhcpHostOptionMinLeaseTime, dhcpHostOptionDefaultRouter=dhcpHostOptionDefaultRouter, dhcpLeaseDomain=dhcpLeaseDomain, dhcpLeaseHardwareAddress=dhcpLeaseHardwareAddress, dhcpServerGroupOptionTable=dhcpServerGroupOptionTable, dhcpServerNextSubnetIndex=dhcpServerNextSubnetIndex, dhcpHostIndex=dhcpHostIndex, dhcpHostDomain=dhcpHostDomain, dhcpGroupOptionMinLeaseTime=dhcpGroupOptionMinLeaseTime, dhcpServerGroupOptionEntry=dhcpServerGroupOptionEntry, dhcpSubnetOptionDefaultRouter=dhcpSubnetOptionDefaultRouter, dhcpServerNextHostIndex=dhcpServerNextHostIndex, dhcpServerGroupTable=dhcpServerGroupTable, dhcpTrapZhoneIpAddressUpdate=dhcpTrapZhoneIpAddressUpdate, dhcpServerSubnetOptionTable=dhcpServerSubnetOptionTable, dhcpHostOptionDefaultLeaseTime=dhcpHostOptionDefaultLeaseTime, dhcpServerStatistics=dhcpServerStatistics, dhcpCountRequests=dhcpCountRequests, dhcpLeaseRowStatus=dhcpLeaseRowStatus, dhcpServerTraps=dhcpServerTraps, dhcpCountersTable=dhcpCountersTable, dhcpHostHardwareAddress=dhcpHostHardwareAddress, dhcpSubnetIndex=dhcpSubnetIndex, dhcpHostOptionDomainName=dhcpHostOptionDomainName, dhcpCountOffers=dhcpCountOffers, dhcpCountDroppedUnknownClient=dhcpCountDroppedUnknownClient, dhcpCountNacks=dhcpCountNacks, dhcpGroupOptionBootServer=dhcpGroupOptionBootServer, dhcpLeaseDDNSFwdName=dhcpLeaseDDNSFwdName, dhcpSubnetRange1Start=dhcpSubnetRange1Start, dhcpHostClientId=dhcpHostClientId, dhcpServerHostOptionTable=dhcpServerHostOptionTable, dhcpServerHostOptionEntry=dhcpServerHostOptionEntry, dhcpHostOptionBootServer=dhcpHostOptionBootServer, dhcpStickyAddr=dhcpStickyAddr, dhcpCountDeclines=dhcpCountDeclines, dhcpTrapZhoneCpeSysObjectID=dhcpTrapZhoneCpeSysObjectID, dhcpLeaseHostname=dhcpLeaseHostname, dhcpSubnetRange3Start=dhcpSubnetRange3Start, dhcpCountAcks=dhcpCountAcks, dhcpLeaseDDNSRevName=dhcpLeaseDDNSRevName, dhcpGroupClientMatchLength=dhcpGroupClientMatchLength, dhcpCountInforms=dhcpCountInforms, dhcpHostIpAddress3=dhcpHostIpAddress3, dhcpSubnetDomain=dhcpSubnetDomain, dhcpServerRestart=dhcpServerRestart, dhcpServer=dhcpServer, dhcpSubnetRange1End=dhcpSubnetRange1End, dhcpHostIpAddress1=dhcpHostIpAddress1, dhcpCountInvalids=dhcpCountInvalids, dhcpTrapZhoneIpInterfaceIndex=dhcpTrapZhoneIpInterfaceIndex, dhcpSubnetExternalServer=dhcpSubnetExternalServer, dhcpServerDefaultReserveStart=dhcpServerDefaultReserveStart, dhcpSubnetRange2End=dhcpSubnetRange2End, dhcpSubnetExternalServerAlt=dhcpSubnetExternalServerAlt, dhcpSubnetOptionMaxLeaseTime=dhcpSubnetOptionMaxLeaseTime, dhcpServerLeaseTable=dhcpServerLeaseTable, dhcpLeaseFlags=dhcpLeaseFlags, dhcpHostOptionBootFile=dhcpHostOptionBootFile, dhcpServerDefaultReserveEnd=dhcpServerDefaultReserveEnd, dhcpServerSubnetEntry=dhcpServerSubnetEntry, dhcpLeaseClientHostname=dhcpLeaseClientHostname, dhcpServerHostEntry=dhcpServerHostEntry, dhcpSubnetOptionPrimaryNameServer=dhcpSubnetOptionPrimaryNameServer, dhcpGroupDomain=dhcpGroupDomain, dhcpGroupOptionSecondaryNameServer=dhcpGroupOptionSecondaryNameServer, dhcpGroupVendorMatchString=dhcpGroupVendorMatchString, serverStandbySlot=serverStandbySlot, dhcpHostOptionPrimaryNameServer=dhcpHostOptionPrimaryNameServer, dhcpCountReleases=dhcpCountReleases, dhcpGroupVendorMatchLength=dhcpGroupVendorMatchLength, comIpDhcpServer=comIpDhcpServer, serverSystemObjectID=serverSystemObjectID, dhcpServerConfigurationVersion=dhcpServerConfigurationVersion, serverSystem=serverSystem, bootpCountDroppedNotServingSubnet=bootpCountDroppedNotServingSubnet, dhcpCountersEntry=dhcpCountersEntry, dhcpServerDefaultMaxLeaseTime=dhcpServerDefaultMaxLeaseTime, dhcpSubnetOptionBootServer=dhcpSubnetOptionBootServer, dhcpServerNextGroupIndex=dhcpServerNextGroupIndex, dhcpGroupOptionDomainName=dhcpGroupOptionDomainName, bootpCountersEntry=bootpCountersEntry, dhcpHostIpAddress2=dhcpHostIpAddress2, dhcpSubnetNetmask=dhcpSubnetNetmask, dhcpLeaseStarts=dhcpLeaseStarts, dhcpHostOptionMaxLeaseTime=dhcpHostOptionMaxLeaseTime, dhcpGroupOptionPrimaryNameServer=dhcpGroupOptionPrimaryNameServer, PYSNMP_MODULE_ID=comIpDhcpServer, serverSystemDescr=serverSystemDescr, dhcpSubnetRange4Start=dhcpSubnetRange4Start, dhcpServerHostTable=dhcpServerHostTable, dhcpHostIpAddress4=dhcpHostIpAddress4, dhcpCountDiscovers=dhcpCountDiscovers, serverActiveShelf=serverActiveShelf, dhcpGroupClientMatchOffset=dhcpGroupClientMatchOffset, dhcpHostRowStatus=dhcpHostRowStatus, dhcpSubnetOptionDefaultLeaseTime=dhcpSubnetOptionDefaultLeaseTime, dhcpGroupClientMatchString=dhcpGroupClientMatchString, dhcpServerGroupEntry=dhcpServerGroupEntry, dhcpSubnetOptionBootFile=dhcpSubnetOptionBootFile, dhcpServerDefaultMinLeaseTime=dhcpServerDefaultMinLeaseTime, dhcpServerDefaultLeaseTime=dhcpServerDefaultLeaseTime, dhcpLeaseIpAddress=dhcpLeaseIpAddress, dhcpSubnetGroup2=dhcpSubnetGroup2, dhcpHostHostname=dhcpHostHostname, bootpCountReplies=bootpCountReplies, dhcpGroupOptionBootFile=dhcpGroupOptionBootFile, serverStandbyShelf=serverStandbyShelf, serverActiveSlot=serverActiveSlot)
