...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-POSA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:20:18 2025
...
_H3cPosaSrvStateChangeTrapEnable_Type.__name__ = "TruthValue"
...
_H3cPosaAppStateChangeTrapEnable_Type.__name__ = "TruthValue"
...
_H3cPosaTerminalHangUpTrapEnable_Type.__name__ = "TruthValue"
...
_H3cPosaFcmLnkNegoFailTrapEnable_Type.__name__ = "TruthValue"
...
_H3cPosaFcmPhyNegoFailTrapEnable_Type.__name__ = "TruthValue"
...
h3cPosaTcpConnectionNumber = _H3cPosaTcpConnectionNumber_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 10),
    _H3cPosaTcpConnectionNumber_Type()
)
h3cPosaTcpConnectionNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaTcpConnectionNumber.setStatus("current")
_H3cPosaFcmConnectionNumber_Type = Integer32
_H3cPosaFcmConnectionNumber_Object = MibScalar
h3cPosaFcmConnectionNumber = _H3cPosaFcmConnectionNumber_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 11),
    _H3cPosaFcmConnectionNumber_Type()
)
h3cPosaFcmConnectionNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaFcmConnectionNumber.setStatus("current")


class _H3cPosaTcpConnectionThreshold_Type(Integer32):
    """Custom type h3cPosaTcpConnectionThreshold based on Integer32"""
    defaultValue = 4096


_H3cPosaTcpConnectionThreshold_Type.__name__ = "Integer32"
_H3cPosaTcpConnectionThreshold_Object = MibScalar
h3cPosaTcpConnectionThreshold = _H3cPosaTcpConnectionThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 12),
    _H3cPosaTcpConnectionThreshold_Type()
)
h3cPosaTcpConnectionThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaTcpConnectionThreshold.setStatus("current")


class _H3cPosaFcmConnectionThreshold_Type(Integer32):
    """Custom type h3cPosaFcmConnectionThreshold based on Integer32"""
    defaultValue = 1024


_H3cPosaFcmConnectionThreshold_Type.__name__ = "Integer32"
_H3cPosaFcmConnectionThreshold_Object = MibScalar
h3cPosaFcmConnectionThreshold = _H3cPosaFcmConnectionThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 13),
    _H3cPosaFcmConnectionThreshold_Type()
)
h3cPosaFcmConnectionThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaFcmConnectionThreshold.setStatus("current")


class _H3cPosaTcpConnectionTrapEnable_Type(TruthValue):
    """Custom type h3cPosaTcpConnectionTrapEnable based on TruthValue"""
    defaultValue = 1


_H3cPosaTcpConnectionTrapEnable_Type.__name__ = "TruthValue"
_H3cPosaTcpConnectionTrapEnable_Object = MibScalar
h3cPosaTcpConnectionTrapEnable = _H3cPosaTcpConnectionTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 14),
    _H3cPosaTcpConnectionTrapEnable_Type()
)
h3cPosaTcpConnectionTrapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaTcpConnectionTrapEnable.setStatus("current")


class _H3cPosaFcmConnectionTrapEnable_Type(TruthValue):
    """Custom type h3cPosaFcmConnectionTrapEnable based on TruthValue"""
    defaultValue = 1


_H3cPosaFcmConnectionTrapEnable_Type.__name__ = "TruthValue"
_H3cPosaFcmConnectionTrapEnable_Object = MibScalar
h3cPosaFcmConnectionTrapEnable = _H3cPosaFcmConnectionTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 15),
    _H3cPosaFcmConnectionTrapEnable_Type()
)
h3cPosaFcmConnectionTrapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaFcmConnectionTrapEnable.setStatus("current")


class _H3cPosaTcpTradeLimit_Type(Integer32):
    """Custom type h3cPosaTcpTradeLimit based on Integer32"""
    defaultValue = 0


_H3cPosaTcpTradeLimit_Type.__name__ = "Integer32"
_H3cPosaTcpTradeLimit_Object = MibScalar
h3cPosaTcpTradeLimit = _H3cPosaTcpTradeLimit_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 16),
    _H3cPosaTcpTradeLimit_Type()
)
h3cPosaTcpTradeLimit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaTcpTradeLimit.setStatus("current")


class _H3cPosaTcpTradeTrapEnable_Type(TruthValue):
    """Custom type h3cPosaTcpTradeTrapEnable based on TruthValue"""
    defaultValue = 1


_H3cPosaTcpTradeTrapEnable_Type.__name__ = "TruthValue"
_H3cPosaTcpTradeTrapEnable_Object = MibScalar
h3cPosaTcpTradeTrapEnable = _H3cPosaTcpTradeTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 17),
    _H3cPosaTcpTradeTrapEnable_Type()
)
h3cPosaTcpTradeTrapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaTcpTradeTrapEnable.setStatus("current")


class _H3cPosaTcpTradeTimeout_Type(Integer32):
    """Custom type h3cPosaTcpTradeTimeout based on Integer32"""
    defaultValue = 240


_H3cPosaTcpTradeTimeout_Type.__name__ = "Integer32"
_H3cPosaTcpTradeTimeout_Object = MibScalar
h3cPosaTcpTradeTimeout = _H3cPosaTcpTradeTimeout_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 18),
    _H3cPosaTcpTradeTimeout_Type()
)
h3cPosaTcpTradeTimeout.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaTcpTradeTimeout.setStatus("current")


class _H3cPosaTradeSuccessFallingTrapEnable_Type(TruthValue):
    """Custom type h3cPosaTradeSuccessFallingTrapEnable based on TruthValue"""
    defaultValue = 1


_H3cPosaTradeSuccessFallingTrapEnable_Type.__name__ = "TruthValue"
_H3cPosaTradeSuccessFallingTrapEnable_Object = MibScalar
h3cPosaTradeSuccessFallingTrapEnable = _H3cPosaTradeSuccessFallingTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 19),
    _H3cPosaTradeSuccessFallingTrapEnable_Type()
)
h3cPosaTradeSuccessFallingTrapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaTradeSuccessFallingTrapEnable.setStatus("current")


class _H3cPosaTradeSuccessFallingThreshold_Type(Integer32):
    """Custom type h3cPosaTradeSuccessFallingThreshold based on Integer32"""
    defaultValue = 90


_H3cPosaTradeSuccessFallingThreshold_Type.__name__ = "Integer32"
_H3cPosaTradeSuccessFallingThreshold_Object = MibScalar
h3cPosaTradeSuccessFallingThreshold = _H3cPosaTradeSuccessFallingThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 20),
    _H3cPosaTradeSuccessFallingThreshold_Type()
)
h3cPosaTradeSuccessFallingThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaTradeSuccessFallingThreshold.setStatus("current")


class _H3cPosaE1DialFallingTrapEnable_Type(TruthValue):
    """Custom type h3cPosaE1DialFallingTrapEnable based on TruthValue"""
    defaultValue = 1


_H3cPosaE1DialFallingTrapEnable_Type.__name__ = "TruthValue"
_H3cPosaE1DialFallingTrapEnable_Object = MibScalar
h3cPosaE1DialFallingTrapEnable = _H3cPosaE1DialFallingTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 21),
    _H3cPosaE1DialFallingTrapEnable_Type()
)
h3cPosaE1DialFallingTrapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaE1DialFallingTrapEnable.setStatus("current")


class _H3cPosaE1DialFallingThreshold_Type(Integer32):
    """Custom type h3cPosaE1DialFallingThreshold based on Integer32"""
    defaultValue = 90


_H3cPosaE1DialFallingThreshold_Type.__name__ = "Integer32"
_H3cPosaE1DialFallingThreshold_Object = MibScalar
h3cPosaE1DialFallingThreshold = _H3cPosaE1DialFallingThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 22),
    _H3cPosaE1DialFallingThreshold_Type()
)
h3cPosaE1DialFallingThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaE1DialFallingThreshold.setStatus("current")


class _H3cPosaFcmTradeAbnormalTrapEnable_Type(TruthValue):
    """Custom type h3cPosaFcmTradeAbnormalTrapEnable based on TruthValue"""
    defaultValue = 1


_H3cPosaFcmTradeAbnormalTrapEnable_Type.__name__ = "TruthValue"
_H3cPosaFcmTradeAbnormalTrapEnable_Object = MibScalar
h3cPosaFcmTradeAbnormalTrapEnable = _H3cPosaFcmTradeAbnormalTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 1, 23),
    _H3cPosaFcmTradeAbnormalTrapEnable_Type()
)
h3cPosaFcmTradeAbnormalTrapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaFcmTradeAbnormalTrapEnable.setStatus("current")
...
_H3cPosaAppServiceType_Type.__name__ = "H3cAppServiceType"
...
_H3cPosaAppMode_Type.__name__ = "H3cAppMode"
...
_H3cPosaCallerIDTransEnable_Type.__name__ = "TruthValue"
...
_H3cPosaTpduChangeStrategy_Type.__name__ = "H3cTpduChangeStrategy"
...
class _H3cPosaBackupAppID_Type(Integer32):
    """Custom type h3cPosaBackupAppID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cPosaBackupAppID_Type.__name__ = "Integer32"
_H3cPosaBackupAppID_Object = MibTableColumn
h3cPosaBackupAppID = _H3cPosaBackupAppID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 1, 1, 18),
    _H3cPosaBackupAppID_Type()
)
h3cPosaBackupAppID.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cPosaBackupAppID.setStatus("current")


class _H3cPosaQuietTimeOut_Type(Integer32):
    """Custom type h3cPosaQuietTimeOut based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cPosaQuietTimeOut_Type.__name__ = "Integer32"
_H3cPosaQuietTimeOut_Object = MibTableColumn
h3cPosaQuietTimeOut = _H3cPosaQuietTimeOut_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 1, 1, 19),
    _H3cPosaQuietTimeOut_Type()
)
h3cPosaQuietTimeOut.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cPosaQuietTimeOut.setStatus("current")


class _H3cPosaAppHello_Type(TruthValue):
    """Custom type h3cPosaAppHello based on TruthValue"""
    defaultValue = 2


_H3cPosaAppHello_Type.__name__ = "TruthValue"
_H3cPosaAppHello_Object = MibTableColumn
h3cPosaAppHello = _H3cPosaAppHello_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 1, 1, 20),
    _H3cPosaAppHello_Type()
)
h3cPosaAppHello.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cPosaAppHello.setStatus("current")


class _H3cPosaAppHelloInterval_Type(Integer32):
    """Custom type h3cPosaAppHelloInterval based on Integer32"""
    defaultValue = 1
...
_H3cPosaAppHelloInterval_Type.__name__ = "Integer32"
_H3cPosaAppHelloInterval_Object = MibTableColumn
h3cPosaAppHelloInterval = _H3cPosaAppHelloInterval_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 1, 1, 21),
    _H3cPosaAppHelloInterval_Type()
)
h3cPosaAppHelloInterval.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cPosaAppHelloInterval.setStatus("current")


class _H3cPosaAppRouterPort_Type(Integer32):
    """Custom type h3cPosaAppRouterPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cPosaAppRouterPort_Type.__name__ = "Integer32"
_H3cPosaAppRouterPort_Object = MibTableColumn
h3cPosaAppRouterPort = _H3cPosaAppRouterPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 1, 1, 22),
    _H3cPosaAppRouterPort_Type()
)
h3cPosaAppRouterPort.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cPosaAppRouterPort.setStatus("current")
...
h3cPosaTerminalID.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
_H3cPosaTerminalAccessType_Type.__name__ = "H3cTerminalAccessType"
...
h3cPosaFcmStatTransCnts = _H3cPosaFcmStatTransCnts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 4, 1, 4),
    _H3cPosaFcmStatTransCnts_Type()
)
h3cPosaFcmStatTransCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaFcmStatTransCnts.setStatus("current")
_H3cPosaFcmStatTransSuccessCnts_Type = Gauge32
_H3cPosaFcmStatTransSuccessCnts_Object = MibTableColumn
h3cPosaFcmStatTransSuccessCnts = _H3cPosaFcmStatTransSuccessCnts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 4, 1, 5),
    _H3cPosaFcmStatTransSuccessCnts_Type()
)
h3cPosaFcmStatTransSuccessCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaFcmStatTransSuccessCnts.setStatus("current")


class _H3cPosaFcmStatTransCntsClear_Type(TruthValue):
    """Custom type h3cPosaFcmStatTransCntsClear based on TruthValue"""
    defaultValue = 2


_H3cPosaFcmStatTransCntsClear_Type.__name__ = "TruthValue"
_H3cPosaFcmStatTransCntsClear_Object = MibTableColumn
h3cPosaFcmStatTransCntsClear = _H3cPosaFcmStatTransCntsClear_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 4, 1, 6),
    _H3cPosaFcmStatTransCntsClear_Type()
)
h3cPosaFcmStatTransCntsClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPosaFcmStatTransCntsClear.setStatus("current")
...
h3cPosaTermianlTcpConnectionNumber = _H3cPosaTermianlTcpConnectionNumber_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 6, 1, 7),
    _H3cPosaTermianlTcpConnectionNumber_Type()
)
h3cPosaTermianlTcpConnectionNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaTermianlTcpConnectionNumber.setStatus("current")
...
h3cPosaCallerStatCallerID.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
h3cPosaNiiStatTable = _H3cPosaNiiStatTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 11)
)
if mibBuilder.loadTexts:
    h3cPosaNiiStatTable.setStatus("current")
_H3cPosaNiiStatEntry_Object = MibTableRow
h3cPosaNiiStatEntry = _H3cPosaNiiStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 11, 1)
)
h3cPosaNiiStatEntry.setIndexNames(
    (0, "H3C-POSA-MIB", "h3cPosaNiiStatIndex"),
)
if mibBuilder.loadTexts:
    h3cPosaNiiStatEntry.setStatus("current")


class _H3cPosaNiiStatIndex_Type(OctetString):
    """Custom type h3cPosaNiiStatIndex based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cPosaNiiStatIndex_Type.__name__ = "OctetString"
_H3cPosaNiiStatIndex_Object = MibTableColumn
h3cPosaNiiStatIndex = _H3cPosaNiiStatIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 11, 1, 1),
    _H3cPosaNiiStatIndex_Type()
)
h3cPosaNiiStatIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cPosaNiiStatIndex.setStatus("current")
_H3cPosaNiiRecvPkts_Type = Counter32
_H3cPosaNiiRecvPkts_Object = MibTableColumn
h3cPosaNiiRecvPkts = _H3cPosaNiiRecvPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 11, 1, 2),
    _H3cPosaNiiRecvPkts_Type()
)
h3cPosaNiiRecvPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaNiiRecvPkts.setStatus("current")
_H3cPosaNiiSendPkts_Type = Counter32
_H3cPosaNiiSendPkts_Object = MibTableColumn
h3cPosaNiiSendPkts = _H3cPosaNiiSendPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 11, 1, 3),
    _H3cPosaNiiSendPkts_Type()
)
h3cPosaNiiSendPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaNiiSendPkts.setStatus("current")
_H3cPosaNiiSuccessTradeCnt_Type = Counter32
_H3cPosaNiiSuccessTradeCnt_Object = MibTableColumn
h3cPosaNiiSuccessTradeCnt = _H3cPosaNiiSuccessTradeCnt_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 11, 1, 4),
    _H3cPosaNiiSuccessTradeCnt_Type()
)
h3cPosaNiiSuccessTradeCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaNiiSuccessTradeCnt.setStatus("current")
_H3cPosaNiiTradeCnt_Type = Counter32
_H3cPosaNiiTradeCnt_Object = MibTableColumn
h3cPosaNiiTradeCnt = _H3cPosaNiiTradeCnt_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 11, 1, 5),
    _H3cPosaNiiTradeCnt_Type()
)
h3cPosaNiiTradeCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaNiiTradeCnt.setStatus("current")
_H3cPosaE1StatTable_Object = MibTable
h3cPosaE1StatTable = _H3cPosaE1StatTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12)
)
if mibBuilder.loadTexts:
    h3cPosaE1StatTable.setStatus("current")
_H3cPosaE1StatEntry_Object = MibTableRow
h3cPosaE1StatEntry = _H3cPosaE1StatEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1)
)
h3cPosaE1StatEntry.setIndexNames(
    (0, "H3C-POSA-MIB", "h3cPosaE1StatIndex"),
)
if mibBuilder.loadTexts:
    h3cPosaE1StatEntry.setStatus("current")


class _H3cPosaE1StatIndex_Type(Integer32):
    """Custom type h3cPosaE1StatIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cPosaE1StatIndex_Type.__name__ = "Integer32"
_H3cPosaE1StatIndex_Object = MibTableColumn
h3cPosaE1StatIndex = _H3cPosaE1StatIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1, 1),
    _H3cPosaE1StatIndex_Type()
)
h3cPosaE1StatIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPosaE1StatIndex.setStatus("current")
_H3cPosaE1DialCnt_Type = Counter32
_H3cPosaE1DialCnt_Object = MibTableColumn
h3cPosaE1DialCnt = _H3cPosaE1DialCnt_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1, 2),
    _H3cPosaE1DialCnt_Type()
)
h3cPosaE1DialCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaE1DialCnt.setStatus("current")
_H3cPosaE1DialSuccess_Type = Counter32
_H3cPosaE1DialSuccess_Object = MibTableColumn
h3cPosaE1DialSuccess = _H3cPosaE1DialSuccess_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1, 3),
    _H3cPosaE1DialSuccess_Type()
)
h3cPosaE1DialSuccess.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaE1DialSuccess.setStatus("current")
_H3cPosaE1RecvPkts_Type = Counter32
_H3cPosaE1RecvPkts_Object = MibTableColumn
h3cPosaE1RecvPkts = _H3cPosaE1RecvPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1, 4),
    _H3cPosaE1RecvPkts_Type()
)
h3cPosaE1RecvPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaE1RecvPkts.setStatus("current")
_H3cPosaE1SendPkts_Type = Counter32
_H3cPosaE1SendPkts_Object = MibTableColumn
h3cPosaE1SendPkts = _H3cPosaE1SendPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1, 5),
    _H3cPosaE1SendPkts_Type()
)
h3cPosaE1SendPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaE1SendPkts.setStatus("current")
_H3cPosaE1ErrPkts_Type = Counter32
_H3cPosaE1ErrPkts_Object = MibTableColumn
h3cPosaE1ErrPkts = _H3cPosaE1ErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1, 6),
    _H3cPosaE1ErrPkts_Type()
)
h3cPosaE1ErrPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaE1ErrPkts.setStatus("current")
_H3cPosaE1MapErrCnts_Type = Counter32
_H3cPosaE1MapErrCnts_Object = MibTableColumn
h3cPosaE1MapErrCnts = _H3cPosaE1MapErrCnts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1, 7),
    _H3cPosaE1MapErrCnts_Type()
)
h3cPosaE1MapErrCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaE1MapErrCnts.setStatus("current")
_H3cPosaE1InDiscardedPkts_Type = Counter32
_H3cPosaE1InDiscardedPkts_Object = MibTableColumn
h3cPosaE1InDiscardedPkts = _H3cPosaE1InDiscardedPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1, 8),
    _H3cPosaE1InDiscardedPkts_Type()
)
h3cPosaE1InDiscardedPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaE1InDiscardedPkts.setStatus("current")
_H3cPosaE1OutDiscardedPkts_Type = Counter32
_H3cPosaE1OutDiscardedPkts_Object = MibTableColumn
h3cPosaE1OutDiscardedPkts = _H3cPosaE1OutDiscardedPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 2, 12, 1, 9),
    _H3cPosaE1OutDiscardedPkts_Type()
)
h3cPosaE1OutDiscardedPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPosaE1OutDiscardedPkts.setStatus("current")
...
h3cPosaTerminalHangUp.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-POSA-MIB", "h3cPosaCallerStatCallerID"))
)
if mibBuilder.loadTexts:
...
h3cPosaTcpConnectionExceed = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 3, 0, 6)
)
h3cPosaTcpConnectionExceed.setObjects(
    ("H3C-POSA-MIB", "h3cPosaTcpConnectionThreshold")
)
if mibBuilder.loadTexts:
    h3cPosaTcpConnectionExceed.setStatus(
        "current"
    )

h3cPosaFcmConnectionExceed = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 3, 0, 7)
)
h3cPosaFcmConnectionExceed.setObjects(
    ("H3C-POSA-MIB", "h3cPosaFcmConnectionThreshold")
)
if mibBuilder.loadTexts:
    h3cPosaFcmConnectionExceed.setStatus(
        "current"
    )

h3cPosaTcpTradeExceed = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 3, 0, 8)
)
h3cPosaTcpTradeExceed.setObjects(
      *(("H3C-POSA-MIB", "h3cPosaTcpTradeLimit"),
        ("H3C-POSA-MIB", "h3cPosaTerminalID"))
)
if mibBuilder.loadTexts:
    h3cPosaTcpTradeExceed.setStatus(
        "current"
    )

h3cPosaTradeSuccessFalling = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 3, 0, 9)
)
h3cPosaTradeSuccessFalling.setObjects(
      *(("H3C-POSA-MIB", "h3cPosaNiiStatIndex"),
        ("H3C-POSA-MIB", "h3cPosaTradeSuccessFallingThreshold"))
)
if mibBuilder.loadTexts:
    h3cPosaTradeSuccessFalling.setStatus(
        "current"
    )

h3cPosaE1DialFalling = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 3, 0, 10)
)
h3cPosaE1DialFalling.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-POSA-MIB", "h3cPosaE1DialFallingThreshold"))
)
if mibBuilder.loadTexts:
    h3cPosaE1DialFalling.setStatus(
        "current"
    )

h3cPosaFcmTradeAbnormal = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 92, 3, 0, 11)
)
h3cPosaFcmTradeAbnormal.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-POSA-MIB", "h3cPosaCallerStatCallerID"))
)
if mibBuilder.loadTexts:
    h3cPosaFcmTradeAbnormal.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"H3cAppServiceType": H3cAppServiceType,
       ...
       "h3cPosaTcpConnectionNumber": h3cPosaTcpConnectionNumber,
       "h3cPosaFcmConnectionNumber": h3cPosaFcmConnectionNumber,
       "h3cPosaTcpConnectionThreshold": h3cPosaTcpConnectionThreshold,
       "h3cPosaFcmConnectionThreshold": h3cPosaFcmConnectionThreshold,
       "h3cPosaTcpConnectionTrapEnable": h3cPosaTcpConnectionTrapEnable,
       "h3cPosaFcmConnectionTrapEnable": h3cPosaFcmConnectionTrapEnable,
       "h3cPosaTcpTradeLimit": h3cPosaTcpTradeLimit,
       "h3cPosaTcpTradeTrapEnable": h3cPosaTcpTradeTrapEnable,
       "h3cPosaTcpTradeTimeout": h3cPosaTcpTradeTimeout,
       "h3cPosaTradeSuccessFallingTrapEnable": h3cPosaTradeSuccessFallingTrapEnable,
       "h3cPosaTradeSuccessFallingThreshold": h3cPosaTradeSuccessFallingThreshold,
       "h3cPosaE1DialFallingTrapEnable": h3cPosaE1DialFallingTrapEnable,
       "h3cPosaE1DialFallingThreshold": h3cPosaE1DialFallingThreshold,
       "h3cPosaFcmTradeAbnormalTrapEnable": h3cPosaFcmTradeAbnormalTrapEnable,
       ...
       "h3cPosaBackupAppID": h3cPosaBackupAppID,
       "h3cPosaQuietTimeOut": h3cPosaQuietTimeOut,
       "h3cPosaAppHello": h3cPosaAppHello,
       "h3cPosaAppHelloInterval": h3cPosaAppHelloInterval,
       "h3cPosaAppRouterPort": h3cPosaAppRouterPort,
       ...
       "h3cPosaFcmStatTransCnts": h3cPosaFcmStatTransCnts,
       "h3cPosaFcmStatTransSuccessCnts": h3cPosaFcmStatTransSuccessCnts,
       "h3cPosaFcmStatTransCntsClear": h3cPosaFcmStatTransCntsClear,
       ...
       "h3cPosaTermianlTcpConnectionNumber": h3cPosaTermianlTcpConnectionNumber,
       ...
       "h3cPosaNiiStatTable": h3cPosaNiiStatTable,
       "h3cPosaNiiStatEntry": h3cPosaNiiStatEntry,
       "h3cPosaNiiStatIndex": h3cPosaNiiStatIndex,
       "h3cPosaNiiRecvPkts": h3cPosaNiiRecvPkts,
       "h3cPosaNiiSendPkts": h3cPosaNiiSendPkts,
       "h3cPosaNiiSuccessTradeCnt": h3cPosaNiiSuccessTradeCnt,
       "h3cPosaNiiTradeCnt": h3cPosaNiiTradeCnt,
       "h3cPosaE1StatTable": h3cPosaE1StatTable,
       "h3cPosaE1StatEntry": h3cPosaE1StatEntry,
       "h3cPosaE1StatIndex": h3cPosaE1StatIndex,
       "h3cPosaE1DialCnt": h3cPosaE1DialCnt,
       "h3cPosaE1DialSuccess": h3cPosaE1DialSuccess,
       "h3cPosaE1RecvPkts": h3cPosaE1RecvPkts,
       "h3cPosaE1SendPkts": h3cPosaE1SendPkts,
       "h3cPosaE1ErrPkts": h3cPosaE1ErrPkts,
       "h3cPosaE1MapErrCnts": h3cPosaE1MapErrCnts,
       "h3cPosaE1InDiscardedPkts": h3cPosaE1InDiscardedPkts,
       "h3cPosaE1OutDiscardedPkts": h3cPosaE1OutDiscardedPkts,
       ...
       "h3cPosaTcpConnectionExceed": h3cPosaTcpConnectionExceed,
       "h3cPosaFcmConnectionExceed": h3cPosaFcmConnectionExceed,
       "h3cPosaTcpTradeExceed": h3cPosaTcpTradeExceed,
       "h3cPosaTradeSuccessFalling": h3cPosaTradeSuccessFalling,
       "h3cPosaE1DialFalling": h3cPosaE1DialFalling,
       "h3cPosaFcmTradeAbnormal": h3cPosaFcmTradeAbnormal,
