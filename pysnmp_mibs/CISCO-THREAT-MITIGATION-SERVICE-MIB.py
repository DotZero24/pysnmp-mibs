...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-THREAT-MITIGATION-SERVICE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:21:53 2025
...
class _CiTmsConsumerDeviceId_Type(SnmpAdminString):
    """Custom type ciTmsConsumerDeviceId based on SnmpAdminString"""
    defaultValue = OctetString("")


_CiTmsConsumerDeviceId_Type.__name__ = "SnmpAdminString"
...
_CiTmsGroupNotifEnable_Type.__name__ = "TruthValue"
...
_CiTmsGroupStorageType_Type.__name__ = "StorageType"
...
_CiTmsConsStateChangeNotifEnable_Type.__name__ = "TruthValue"
...
ciscoTmsMIBCompliance.setObjects(
      *(("CISCO-THREAT-MITIGATION-SERVICE-MIB", "ciscoTmsConsumerGroup"),
        ("CISCO-THREAT-MITIGATION-SERVICE-MIB", "ciscoTmsThreatGroup"),
        ("CISCO-THREAT-MITIGATION-SERVICE-MIB", "ciscoTmsThreatActionGroup"),
        ("CISCO-THREAT-MITIGATION-SERVICE-MIB", "ciscoTmsThreatInterfaceGroup"),
        ("CISCO-THREAT-MITIGATION-SERVICE-MIB", "ciscoTmsNotificationGroup"))
)
if mibBuilder.loadTexts:
