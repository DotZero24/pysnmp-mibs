...
mibBuilder.exportSymbols("CISCO-LICENSE-MIB", ciscoLicenseMIB=ciscoLicenseMIB, celPoolLicenseMaxUsage=celPoolLicenseMaxUsage, celLicenseConfigIndex=celLicenseConfigIndex, celMIBCompliance=celMIBCompliance, celMIBGroup=celMIBGroup, celInUseLicenseType=celInUseLicenseType, celPhysicallyProgSlotNumber=celPhysicallyProgSlotNumber, celPhysicallyProgEntIndex=celPhysicallyProgEntIndex, celInUseLicenseEntry=celInUseLicenseEntry, celLicenseInstallEntitySerNum=celLicenseInstallEntitySerNum, celPoolLicenseIndex=celPoolLicenseIndex, celPoolLicensesInstalled=celPoolLicensesInstalled, celPoolLicensesInUse=celPoolLicensesInUse, celPoolLicenseEntry=celPoolLicenseEntry, celMIBObjects=celMIBObjects, celInUseLicenseTable=celInUseLicenseTable, celPhysicallyProgLicUseTmStamp=celPhysicallyProgLicUseTmStamp, celLicenseConfigType=celLicenseConfigType, celOperationExpiryTmStamp=celOperationExpiryTmStamp, celPhysicallyProgLicTypeDescr=celPhysicallyProgLicTypeDescr, celMIBGroups=celMIBGroups, celPoolLicenseType=celPoolLicenseType, celGeneral=celGeneral, celLicenseConfigHistoryEntry=celLicenseConfigHistoryEntry, celLicenseEntityVendorType=celLicenseEntityVendorType, celLicenseConfigDetailTable=celLicenseConfigDetailTable, celPhysicallyProgLicenses=celPhysicallyProgLicenses, celLicenseConfigDetailEntry=celLicenseConfigDetailEntry, celLicenseTypeDescr=celLicenseTypeDescr, celInUseLicenseDescr=celInUseLicenseDescr, celInUseLicenses=celInUseLicenses, celMIBNotifications=celMIBNotifications, PYSNMP_MODULE_ID=ciscoLicenseMIB, celPhysicallyProgLicenseEntry=celPhysicallyProgLicenseEntry, celNeededLicenses=celNeededLicenses, celEntPhysicalIndex=celEntPhysicalIndex, celLicenseSerialNumber=celLicenseSerialNumber, celPhysicallyProgLicInstSerNum=celPhysicallyProgLicInstSerNum, celPoolLicenseTable=celPoolLicenseTable, celPoolLicenseEntityVendorType=celPoolLicenseEntityVendorType, celLicenseConfigHistoryIndex=celLicenseConfigHistoryIndex, celPhysicallyProgLicenseType=celPhysicallyProgLicenseType, celLicenseUpdateSequenceNum=celLicenseUpdateSequenceNum, celInUseSlotIndex=celInUseSlotIndex, celPhysicallyProgLicSerialNum=celPhysicallyProgLicSerialNum, celLicenseUpdateTimeStamp=celLicenseUpdateTimeStamp, celPhysicallyProgLicInstSysName=celPhysicallyProgLicInstSysName, celMIBConformance=celMIBConformance, celLicenseUpdateMethod=celLicenseUpdateMethod, celPhysicallyProgLicenseTable=celPhysicallyProgLicenseTable, celMIBCompliances=celMIBCompliances, celLicenseConfigCount=celLicenseConfigCount, celLicenseConfigHistoryTable=celLicenseConfigHistoryTable, celPhysicallyProgLicenseStatus=celPhysicallyProgLicenseStatus, LicenseType=LicenseType)
