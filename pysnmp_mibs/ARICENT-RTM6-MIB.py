...
fsrrd6Scalar=_Fsrrd6Scalar_ObjectIdentity((1,3,6,1,4,1,2076,92,1))
_FsRrd6RouterId_Type=IpAddress
_FsRrd6RouterId_Object=MibScalar
fsRrd6RouterId=_FsRrd6RouterId_Object((1,3,6,1,4,1,2076,92,1,1),_FsRrd6RouterId_Type())
...
fsRrd6FilterByOspfTag=_FsRrd6FilterByOspfTag_Object((1,3,6,1,4,1,2076,92,1,2),_FsRrd6FilterByOspfTag_Type())
...
fsRrd6FilterOspfTag=_FsRrd6FilterOspfTag_Object((1,3,6,1,4,1,2076,92,1,3),_FsRrd6FilterOspfTag_Type())
...
fsRrd6FilterOspfTagMask=_FsRrd6FilterOspfTagMask_Object((1,3,6,1,4,1,2076,92,1,4),_FsRrd6FilterOspfTagMask_Type())
...
fsRrd6RouterASNumber=_FsRrd6RouterASNumber_Object((1,3,6,1,4,1,2076,92,1,5),_FsRrd6RouterASNumber_Type())
...
fsRrd6AdminStatus=_FsRrd6AdminStatus_Object((1,3,6,1,4,1,2076,92,1,6),_FsRrd6AdminStatus_Type())
...
fsRrd6Trace=_FsRrd6Trace_Object((1,3,6,1,4,1,2076,92,1,7),_FsRrd6Trace_Type())
...
fsRrd6ThrotLimit=_FsRrd6ThrotLimit_Object((1,3,6,1,4,1,2076,92,1,8),_FsRrd6ThrotLimit_Type())
...
fsRrd6MaximumBgpRoutes=_FsRrd6MaximumBgpRoutes_Object((1,3,6,1,4,1,2076,92,1,9),_FsRrd6MaximumBgpRoutes_Type())
fsRrd6MaximumBgpRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRrd6MaximumBgpRoutes.setStatus(_A)
_FsRrd6MaximumOspfRoutes_Type=Unsigned32
_FsRrd6MaximumOspfRoutes_Object=MibScalar
fsRrd6MaximumOspfRoutes=_FsRrd6MaximumOspfRoutes_Object((1,3,6,1,4,1,2076,92,1,10),_FsRrd6MaximumOspfRoutes_Type())
fsRrd6MaximumOspfRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRrd6MaximumOspfRoutes.setStatus(_A)
_FsRrd6MaximumRipRoutes_Type=Unsigned32
_FsRrd6MaximumRipRoutes_Object=MibScalar
fsRrd6MaximumRipRoutes=_FsRrd6MaximumRipRoutes_Object((1,3,6,1,4,1,2076,92,1,11),_FsRrd6MaximumRipRoutes_Type())
fsRrd6MaximumRipRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRrd6MaximumRipRoutes.setStatus(_A)
_FsRrd6MaximumStaticRoutes_Type=Unsigned32
_FsRrd6MaximumStaticRoutes_Object=MibScalar
fsRrd6MaximumStaticRoutes=_FsRrd6MaximumStaticRoutes_Object((1,3,6,1,4,1,2076,92,1,12),_FsRrd6MaximumStaticRoutes_Type())
fsRrd6MaximumStaticRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRrd6MaximumStaticRoutes.setStatus(_A)
_FsRrd6MaximumISISRoutes_Type=Unsigned32
_FsRrd6MaximumISISRoutes_Object=MibScalar
fsRrd6MaximumISISRoutes=_FsRrd6MaximumISISRoutes_Object((1,3,6,1,4,1,2076,92,1,13),_FsRrd6MaximumISISRoutes_Type())
fsRrd6MaximumISISRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRrd6MaximumISISRoutes.setStatus(_A)
class _FsRtm6StaticRouteDistance_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,255))
_FsRtm6StaticRouteDistance_Type.__name__=_C
_FsRtm6StaticRouteDistance_Object=MibScalar
fsRtm6StaticRouteDistance=_FsRtm6StaticRouteDistance_Object((1,3,6,1,4,1,2076,92,1,14),_FsRtm6StaticRouteDistance_Type())
fsRtm6StaticRouteDistance.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRtm6StaticRouteDistance.setStatus(_A)
_FsRrd6ControlTable_Object=MibTable
fsRrd6ControlTable=_FsRrd6ControlTable_Object((1,3,6,1,4,1,2076,92,2))
if mibBuilder.loadTexts:fsRrd6ControlTable.setStatus(_A)
_FsRrd6ControlEntry_Object=MibTableRow
fsRrd6ControlEntry=_FsRrd6ControlEntry_Object((1,3,6,1,4,1,2076,92,2,1))
...
fsRrd6ControlDestIpAddress=_FsRrd6ControlDestIpAddress_Object((1,3,6,1,4,1,2076,92,2,1,1),_FsRrd6ControlDestIpAddress_Type())
...
fsRrd6ControlNetMaskLen=_FsRrd6ControlNetMaskLen_Object((1,3,6,1,4,1,2076,92,2,1,2),_FsRrd6ControlNetMaskLen_Type())
...
fsRrd6ControlSourceProto=_FsRrd6ControlSourceProto_Object((1,3,6,1,4,1,2076,92,2,1,3),_FsRrd6ControlSourceProto_Type())
...
fsRrd6ControlDestProto=_FsRrd6ControlDestProto_Object((1,3,6,1,4,1,2076,92,2,1,4),_FsRrd6ControlDestProto_Type())
...
fsRrd6ControlRouteExportFlag=_FsRrd6ControlRouteExportFlag_Object((1,3,6,1,4,1,2076,92,2,1,5),_FsRrd6ControlRouteExportFlag_Type())
...
fsRrd6ControlRowStatus=_FsRrd6ControlRowStatus_Object((1,3,6,1,4,1,2076,92,2,1,6),_FsRrd6ControlRowStatus_Type())
...
fsRrd6RoutingProtoTable=_FsRrd6RoutingProtoTable_Object((1,3,6,1,4,1,2076,92,3))
if mibBuilder.loadTexts:fsRrd6RoutingProtoTable.setStatus(_A)
_FsRrd6RoutingProtoEntry_Object=MibTableRow
fsRrd6RoutingProtoEntry=_FsRrd6RoutingProtoEntry_Object((1,3,6,1,4,1,2076,92,3,1))
...
fsRrd6RoutingProtoId=_FsRrd6RoutingProtoId_Object((1,3,6,1,4,1,2076,92,3,1,1),_FsRrd6RoutingProtoId_Type())
...
fsRrd6RoutingRegnId=_FsRrd6RoutingRegnId_Object((1,3,6,1,4,1,2076,92,3,1,2),_FsRrd6RoutingRegnId_Type())
...
fsRrd6RoutingProtoTaskIdent=_FsRrd6RoutingProtoTaskIdent_Object((1,3,6,1,4,1,2076,92,3,1,3),_FsRrd6RoutingProtoTaskIdent_Type())
...
fsRrd6RoutingProtoQueueIdent=_FsRrd6RoutingProtoQueueIdent_Object((1,3,6,1,4,1,2076,92,3,1,4),_FsRrd6RoutingProtoQueueIdent_Type())
...
fsRrd6AllowOspfAreaRoutes=_FsRrd6AllowOspfAreaRoutes_Object((1,3,6,1,4,1,2076,92,3,1,5),_FsRrd6AllowOspfAreaRoutes_Type())
...
fsRrd6AllowOspfExtRoutes=_FsRrd6AllowOspfExtRoutes_Object((1,3,6,1,4,1,2076,92,3,1,6),_FsRrd6AllowOspfExtRoutes_Type())
...
fsRtm6RedTest=_FsRtm6RedTest_ObjectIdentity((1,3,6,1,4,1,2076,92,4))
_FsRtm6RedEntryTime_Type=Integer32
_FsRtm6RedEntryTime_Object=MibScalar
fsRtm6RedEntryTime=_FsRtm6RedEntryTime_Object((1,3,6,1,4,1,2076,92,4,1),_FsRtm6RedEntryTime_Type())
