...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-EMBEDDED-EVENT-MGR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:34:09 2025
...
cEventMgrCompliance.setObjects(
      *(("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrDescrGroup"),
        ("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrNotificationsGroup"),
        ("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrRegisteredPolicyGroup"),
        ("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrHistoryGroup"))
)
if mibBuilder.loadTexts:
...
cEventMgrComplianceRev1.setObjects(
      *(("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrDescrGroup"),
        ("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrNotificationsGroup"),
        ("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrRegisteredPolicyGroup"),
        ("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrRegisteredPolicyGroupSup1"),
        ("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrHistoryGroup"),
        ("CISCO-EMBEDDED-EVENT-MGR-MIB", "cEventMgrHistoryGroupSup1"))
)
if mibBuilder.loadTexts:
