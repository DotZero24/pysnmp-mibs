...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/radlan/MARVELL-ERRDISABLE-RECOVERY-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:40:55 2025
...
class RlErrdisableRecoveryCauseType(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("loopback-detection", 1), ("port-security", 2), ("dot1x-src-address", 3), ("acl-deny", 4), ("stp-bpdu-guard", 5), ("stp-loopback-guard", 6), ("pcb-overheat", 7), ("udld", 8), ("storm-control", 9), ("link-flapping", 10), ("l2pt-guard", 11), ("pvst", 12), ("vpc", 13), ("arp-inspection", 14))
