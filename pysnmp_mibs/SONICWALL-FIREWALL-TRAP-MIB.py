...
# Notes
# -----
# ASN.1 source file://mibs/sonicwall/SONICWALL-FIREWALL-TRAP-MIB
...
class FwTrapType(TextualConvention, Integer32):
    status = "current"
    ...
    namedValues = NamedValues(
        *(("trapTypeSysEnvVoltageFail", 101),
          ...
          ("trapTypeEnhSysEnvPsuFailed", 5433),
          ("trapTypeEnhSysEnvPsuNotPresent", 5434),
          ("trapTypeEnhSysEnvPsuOn", 5435),
          ...
          ("trapTypeEnhSonicPointNStatus", 13601),
          ("trapTypeEnhSonicPointNProvision", 13602),
          ("trapTypeEnhSonicPointNHWFailure", 13603),
          ...
          ("trapTypeEnhSwMonLinkUtilHigh", 17001),
          ("trapTypeEnhSwMonCpuUtilHigh", 17002),
          ("trapTypeEnhSwMonSessionUtilHigh", 17003),
          ("trapTypeEnhSwMonThroughputUtilHigh", 17004),
          ("trapTypeEnhSwMonNATTranslationUtilHigh", 17005),
          ("trapTypeEnhSdwanPspPathAvailable", 18001),
          ("trapTypeEnhSdwanPspPathAllRemoved", 18002),
          ("trapTypeEnhSdwanPspPathAdd", 18003),
          ("trapTypeEnhSdwanPspPathRemove", 18004),
          ("trapTypeEnhSdwanProbeAdded", 18005),
          ("trapTypeEnhSdwanProbeDeleted", 18006),
          ("trapTypeEnhSdwanProbeModified", 18007),
          ("trapTypeEnhSdwanPcoAdded", 18008),
          ("trapTypeEnhSdwanPcoDeleted", 18009),
          ("trapTypeEnhSdwanPcoModified", 18010),
          ("trapTypeEnhSdwanPspAdd", 18011),
          ("trapTypeEnhSdwanPspMod", 18012),
          ("trapTypeEnhSdwanPspDel", 18013),
          ("trapTypeEnhSdwanRouteAdd", 18014),
          ("trapTypeEnhSdwanRouteMod", 18015),
          ("trapTypeEnhSdwanRouteDel", 18016),
          ("trapTypeEnhSdwanGrpAdd", 18017),
          ("trapTypeEnhSdwanGrpMod", 18018),
          ("trapTypeEnhSdwanGrpDel", 18019),
          ("trapTypeEnhSdwanGrpMemAdd", 18020),
          ("trapTypeEnhSdwanGrpMemDel", 18021),
          ("trapTypeEnhSdwanGrpMemMod", 18022))
    )
