...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-NS-MIB
...
_FcNameServerProxyPortName_Type.__name__ = "FcNameIdOrZero"
...
_FcNameServerPortName_Type.__name__ = "FcNameId"
...
_FcNameServerNodeName_Type.__name__ = "FcNameId"
...
_FcNameServerFabricPortName_Type.__name__ = "FcNameId"
...
_FcNameServerRejReqNotifyEnable_Type.__name__ = "TruthValue"
...
fcNameServerMIBCompliance.setObjects(
      *(("CISCO-NS-MIB", "fcNameServerDBGroup"),
        ("CISCO-NS-MIB", "fcNameServerStatsGroup"),
        ("CISCO-NS-MIB", "fcNameServerNotifyControlGroup"),
        ("CISCO-NS-MIB", "fcNameServerNotifyGroup"))
)
if mibBuilder.loadTexts:
...
fcNameServerMIBCompliance1.setObjects(
      *(("CISCO-NS-MIB", "fcNameServerDBGroup1"),
        ("CISCO-NS-MIB", "fcNameServerStatsGroup"),
        ("CISCO-NS-MIB", "fcNameServerNotifyControlGroup"),
        ("CISCO-NS-MIB", "fcNameServerNotifyGroup"))
)
...
fcNameServerMIBCompliance2.setObjects(
      *(("CISCO-NS-MIB", "fcNameServerDBGroup2"),
        ("CISCO-NS-MIB", "fcNameServerStatsGroup"),
        ("CISCO-NS-MIB", "fcNameServerNotifyControlGroup"),
        ("CISCO-NS-MIB", "fcNameServerNotifyGroupRev1"))
)
if mibBuilder.loadTexts:
...
fcNameServerMIBCompliance3.setObjects(
      *(("CISCO-NS-MIB", "fcNameServerDBGroup3"),
        ("CISCO-NS-MIB", "fcNameServerStatsGroup"),
        ("CISCO-NS-MIB", "fcNameServerNotifyControlGroup"),
        ("CISCO-NS-MIB", "fcNameServerNotifyGroupRev1"))
)
