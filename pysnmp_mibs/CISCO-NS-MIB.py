...
FcNameIdOrZero, FcClassOfServices, FcNameId, FcAddressId = mibBuilder.importSymbols("CISCO-ST-TC", "FcNameIdOrZero", "FcClassOfServices", "FcNameId", "FcAddressId")
...
mibBuilder.exportSymbols("CISCO-NS-MIB", fcNameServerTable=fcNameServerTable, fcNameServerDBGroup1=fcNameServerDBGroup1, fcNameServerNodeName=fcNameServerNodeName, fcNameServerInGetReqs=fcNameServerInGetReqs, fcNameServerNotification=fcNameServerNotification, fcNameServerEntryDelete=fcNameServerEntryDelete, fcNameServerMIBCompliance=fcNameServerMIBCompliance, fcNameServerStatsGroup=fcNameServerStatsGroup, fcNameServerStatsEntry=fcNameServerStatsEntry, fcNameServerDBGroup2=fcNameServerDBGroup2, fcNameServerPortName=fcNameServerPortName, FcNameServerRejReasonExpl=FcNameServerRejReasonExpl, fcNameServerInDeRegReqs=fcNameServerInDeRegReqs, fcNameServerFC4Features=fcNameServerFC4Features, fcNameServerSymbolicPortName=fcNameServerSymbolicPortName, fcNameServerDBGroup=fcNameServerDBGroup, ciscoNsMIB=ciscoNsMIB, fcNameServerPortFunction=fcNameServerPortFunction, fcNameServerInRscns=fcNameServerInRscns, fcNameServerInformation=fcNameServerInformation, fcNameServerNumRows=fcNameServerNumRows, fcNameServerPortIpAddress=fcNameServerPortIpAddress, fcNameServerOutGetReqs=fcNameServerOutGetReqs, fcNameServerStatsTable=fcNameServerStatsTable, fcNameServerTableLastChange=fcNameServerTableLastChange, fcNameServerHardAddress=fcNameServerHardAddress, fcNameServerMIBCompliance2=fcNameServerMIBCompliance2, fcNameServerInRegReqs=fcNameServerInRegReqs, fcNameServerFabricPortName=fcNameServerFabricPortName, fcNameServerRejReasonCodeExp=fcNameServerRejReasonCodeExp, fcNameServerMIBCompliance3=fcNameServerMIBCompliance3, fcNameServerNotifyGroup=fcNameServerNotifyGroup, fcNameServerPermanentPortName=fcNameServerPermanentPortName, fcNameServerDatabaseFull=fcNameServerDatabaseFull, fcNameServerRejects=fcNameServerRejects, fcNameServerMIBGroups=fcNameServerMIBGroups, fcNameServerNodeIpAddress=fcNameServerNodeIpAddress, fcNameServerConfiguration=fcNameServerConfiguration, fcNameServerPortType=fcNameServerPortType, ciscoNameServerMIBObjects=ciscoNameServerMIBObjects, fcNameServerSymbolicNodeName=fcNameServerSymbolicNodeName, fcNameServerRejectReasonCode=fcNameServerRejectReasonCode, fcNameServerMIBConformance=fcNameServerMIBConformance, fcNameServerProxyPortEntry=fcNameServerProxyPortEntry, fcNameServerOutRscns=fcNameServerOutRscns, fcNameServerProcAssoc=fcNameServerProcAssoc, fcNameServerStats=fcNameServerStats, fcNameServerFC4Type=fcNameServerFC4Type, fcNameServerNotifyControlGroup=fcNameServerNotifyControlGroup, fcNameServerNotifications=fcNameServerNotifications, fcNameServerEntry=fcNameServerEntry, PYSNMP_MODULE_ID=ciscoNsMIB, fcNameServerClassOfSvc=fcNameServerClassOfSvc, fcNameServerRejReqNotifyEnable=fcNameServerRejReqNotifyEnable, fcNameServerEntryAdd=fcNameServerEntryAdd, FcGs3RejectReasonCode=FcGs3RejectReasonCode, fcNameServerTotalRejects=fcNameServerTotalRejects, fcNameServerProxyPortTable=fcNameServerProxyPortTable, fcNameServerDBGroup3=fcNameServerDBGroup3, fcNameServerProxyPortName=fcNameServerProxyPortName, fcNameServerMIBCompliances=fcNameServerMIBCompliances, fcNameServerNotifyGroupRev1=fcNameServerNotifyGroupRev1, fcNameServerMIBCompliance1=fcNameServerMIBCompliance1, fcNameServerRejectRegNotify=fcNameServerRejectRegNotify, fcNameServerPortIdentifier=fcNameServerPortIdentifier)
