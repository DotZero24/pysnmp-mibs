...
hrPartitionSize, hrPartitionLabel, hrPartitionIndex, hrFSMountPoint = mibBuilder.importSymbols("HOST-RESOURCES-MIB", "hrPartitionSize", "hrPartitionLabel", "hrPartitionIndex", "hrFSMountPoint")
...
mibBuilder.exportSymbols("NOKIA-IPSO-SYSTEM-MIB", ipsoCPUModel=ipsoCPUModel, ipsoImageGroup=ipsoImageGroup, ipsoPkgIndex=ipsoPkgIndex, ipsoDiskDriveModel=ipsoDiskDriveModel, ipsoPkgName=ipsoPkgName, ipsoFanIndex=ipsoFanIndex, systemTrapConfigurationFileChange=systemTrapConfigurationFileChange, ipsoConfigFilePath=ipsoConfigFilePath, ipsoPkgLicense=ipsoPkgLicense, ipsoConfigLogEntry=ipsoConfigLogEntry, ipsoPowerSupplyOverTemperature=ipsoPowerSupplyOverTemperature, systemTrapDiskMirrorSetCreate=systemTrapDiskMirrorSetCreate, ipsoDaysToExpire=ipsoDaysToExpire, ipsoDiskSysDriveIndex=ipsoDiskSysDriveIndex, systemTrapDiskMirrorSyncFailure=systemTrapDiskMirrorSyncFailure, systemTrapNoDiskSpace=systemTrapNoDiskSpace, ipsoDiskMirrorSetDestinationDriveIndex=ipsoDiskMirrorSetDestinationDriveIndex, ipsoKernMaxMem=ipsoKernMaxMem, ipsoSIMMTotal=ipsoSIMMTotal, ipsoImageEntry=ipsoImageEntry, ipsoCardEntry=ipsoCardEntry, ipsoDiskMirrorSetIndex=ipsoDiskMirrorSetIndex, ipsoConfigTable=ipsoConfigTable, ipsoAssetTable=ipsoAssetTable, ipsoConfigFileDateAndTime=ipsoConfigFileDateAndTime, ipsoImageVersionNumber=ipsoImageVersionNumber, ipsoTotalDiskMirrorSets=ipsoTotalDiskMirrorSets, ipsoDiskMirrorSetSourceDriveIndex=ipsoDiskMirrorSetSourceDriveIndex, ipsoConfigLogIndex=ipsoConfigLogIndex, ipsoProcessGroup=ipsoProcessGroup, ipsoImageTimeOfLoad=ipsoImageTimeOfLoad, ipsoCPUFreq=ipsoCPUFreq, systemTrapDiskMirrorSyncSuccess=systemTrapDiskMirrorSyncSuccess, ipsoProcessOwner=ipsoProcessOwner, ipsoConfigLogSize=ipsoConfigLogSize, ipsoPkgMajorVersion=ipsoPkgMajorVersion, ipsoPowerSupplyTable=ipsoPowerSupplyTable, ipsoDiskDriveEntry=ipsoDiskDriveEntry, ipsoNotificationGroup=ipsoNotificationGroup, ipsoProcessPercentCPU=ipsoProcessPercentCPU, ipsoFanGroup=ipsoFanGroup, ipsoCPUMfr=ipsoCPUMfr, ipsoStorageGroup=ipsoStorageGroup, ipsoOSRelease=ipsoOSRelease, ipsoPowerSupplyOperStatus=ipsoPowerSupplyOperStatus, ipsoDiskMirrorSetTable=ipsoDiskMirrorSetTable, systemTrapLicense=systemTrapLicense, ipsoChassisMBRevNumber=ipsoChassisMBRevNumber, ipsoProcessEntry=ipsoProcessEntry, ipsoProducts=ipsoProducts, ipsoConfigIndex=ipsoConfigIndex, ipsoFanOperStatus=ipsoFanOperStatus, ipsoImageIndex=ipsoImageIndex, ipsoConfigEntry=ipsoConfigEntry, ipsoConfigGroup=ipsoConfigGroup, ipsoFanEntry=ipsoFanEntry, ipsoLicenseGroup=ipsoLicenseGroup, ipsoDiskMirrorGroup=ipsoDiskMirrorGroup, ipsoProcessMemory=ipsoProcessMemory, ipsoProcessID=ipsoProcessID, ipsoOSVersion=ipsoOSVersion, ipsoAssetChassisSerialNumber=ipsoAssetChassisSerialNumber, ipsoAssetEntry=ipsoAssetEntry, ipsoDiskMirrorSetEntry=ipsoDiskMirrorSetEntry, ipsoAssetGroup=ipsoAssetGroup, ipsoChassisSerialNumber=ipsoChassisSerialNumber, ipsoProcessTable=ipsoProcessTable, systemTrapDiskMirrorSetDelete=systemTrapDiskMirrorSetDelete, PYSNMP_MODULE_ID=ipsoSystem, ipsoDiskDriveCapacity=ipsoDiskDriveCapacity, ipsoChassisMBType=ipsoChassisMBType, systemTrapConfigurationChange=systemTrapConfigurationChange, systemTraps=systemTraps, ipsoMotherBoardRev=ipsoMotherBoardRev, ipsoDiskDriveIndex=ipsoDiskDriveIndex, ipsoChassisGroup=ipsoChassisGroup, systemTrapSnmpProcessShutdown=systemTrapSnmpProcessShutdown, ipsoProcessParentID=ipsoProcessParentID, ipsoFanTable=ipsoFanTable, ipsoFeatureName=ipsoFeatureName, ipsoCardTable=ipsoCardTable, ipsoPowerSupplyEntry=ipsoPowerSupplyEntry, ipsoPkgMinorVersion=ipsoPkgMinorVersion, ipsoConfigLogDescr=ipsoConfigLogDescr, ipsoDiskDriveLocation=ipsoDiskDriveLocation, ipsoCardOperStatus=ipsoCardOperStatus, ipsoProcessorUtilization=ipsoProcessorUtilization, ipsoDiskMirrorSetSyncPercent=ipsoDiskMirrorSetSyncPercent, nokiaProducts=nokiaProducts, ipsoProductModel=ipsoProductModel, ipsoImageTable=ipsoImageTable, systemTrapLowDiskSpace=systemTrapLowDiskSpace, ipsoChassisMBSerialNumber=ipsoChassisMBSerialNumber, ipsoConfigLogTable=ipsoConfigLogTable, nokia=nokia, ipsoCardIndex=ipsoCardIndex, ipsoPowerSupplyGroup=ipsoPowerSupplyGroup, ipsoChassisTemperature=ipsoChassisTemperature, systemTrapDiskFailure=systemTrapDiskFailure, ipsoImageSerialNumber=ipsoImageSerialNumber, ipsoDiskDriveTable=ipsoDiskDriveTable, ipsoMotherBoardSerNum=ipsoMotherBoardSerNum, systemTrapConfigurationSaveChange=systemTrapConfigurationSaveChange, ipsoMotherBoardModel=ipsoMotherBoardModel, ipsoPowerSupplyIndex=ipsoPowerSupplyIndex, ipsoSystem=ipsoSystem)
