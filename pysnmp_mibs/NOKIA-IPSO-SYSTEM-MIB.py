...
# Notes
# -----
# ASN.1 source file://mibs/checkpoint/NOKIA-IPSO-SYSTEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:21:45 2025
...
class _IpsoDiskSysDriveIndex_Type(Integer32):
    """Custom type ipsoDiskSysDriveIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_IpsoDiskSysDriveIndex_Type.__name__ = "Integer32"
_IpsoDiskSysDriveIndex_Object = MibTableColumn
ipsoDiskSysDriveIndex = _IpsoDiskSysDriveIndex_Object(
    (1, 3, 6, 1, 4, 1, 94, 1, 21, 1, 10, 13, 1, 2),
    _IpsoDiskSysDriveIndex_Type()
)
ipsoDiskSysDriveIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ipsoDiskSysDriveIndex.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"nokia": nokia,
       ...
       "ipsoDiskSysDriveIndex": ipsoDiskSysDriveIndex,
