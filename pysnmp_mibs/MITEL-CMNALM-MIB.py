...
mibBuilder.exportSymbols("MITEL-CMNALM-MIB", mitelAlmActiveTblSeverity=mitelAlmActiveTblSeverity, mitelCmnAlarms=mitelCmnAlarms, ItuPerceivedSeverity=ItuPerceivedSeverity, mitelAlmSysSeverityDescr=mitelAlmSysSeverityDescr, mitelAlmActiveTblThresholdValue=mitelAlmActiveTblThresholdValue, mitelAlmActiveTblDescr=mitelAlmActiveTblDescr, mitelAlmActiveTblSeverityDetectTime=mitelAlmActiveTblSeverityDetectTime, mitelAlmSystem=mitelAlmSystem, mitelCmnAlmConformance=mitelCmnAlmConformance, PYSNMP_MODULE_ID=mitelCmnAlarms, mitelAlmActiveTblThresholdType=mitelAlmActiveTblThresholdType, mitelAlmActiveTblIndex=mitelAlmActiveTblIndex, mitelAlmActiveTableEntry=mitelAlmActiveTableEntry, mitelAlmSysSeverityDetectTime=mitelAlmSysSeverityDetectTime, mitelAlmActiveTblType=mitelAlmActiveTblType, mitelAlmSysSeverity=mitelAlmSysSeverity, mitelAlmActiveTblClass=mitelAlmActiveTblClass, MitelCmnAlarmThresholdType=MitelCmnAlarmThresholdType, mitelCmnAlmNotifications=mitelCmnAlmNotifications, mitelCmnAlmObjects=mitelCmnAlmObjects, mitelAlmActiveTable=mitelAlmActiveTable, mitelNotifActiveAlarm=mitelNotifActiveAlarm, mitelAlmActiveTblTypeName=mitelAlmActiveTblTypeName)
