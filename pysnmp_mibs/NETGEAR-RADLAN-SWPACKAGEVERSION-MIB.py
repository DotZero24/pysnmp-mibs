...
_C='NETGEAR-RADLAN-SWPACKAGEVERSION-MIB'
_B='DisplayString'
_A='current'
...
rlSwPackageVersionTable=_RlSwPackageVersionTable_Object((1,3,6,1,4,1,4526,17,67,1))
if mibBuilder.loadTexts:rlSwPackageVersionTable.setStatus(_A)
_RlSwPackageVersionEntry_Object=MibTableRow
rlSwPackageVersionEntry=_RlSwPackageVersionEntry_Object((1,3,6,1,4,1,4526,17,67,1,1))
...
rlSwPackageVersionName=_RlSwPackageVersionName_Object((1,3,6,1,4,1,4526,17,67,1,1,1),_RlSwPackageVersionName_Type())
...
rlSwPackageVersionVesrion=_RlSwPackageVersionVesrion_Object((1,3,6,1,4,1,4526,17,67,1,1,2),_RlSwPackageVersionVesrion_Type())
