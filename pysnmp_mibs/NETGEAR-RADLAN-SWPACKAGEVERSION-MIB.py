# SNMP MIB module (NETGEAR-RADLAN-SWPACKAGEVERSION-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-SWPACKAGEVERSION-MIB
...
rlSwPackageVersionEntry = _RlSwPackageVersionEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 67, 1, 1)
)
rlSwPackageVersionEntry.setIndexNames(
    (1, "NETGEAR-RADLAN-SWPACKAGEVERSION-MIB", "rlSwPackageVersionName"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "NETGEAR-RADLAN-SWPACKAGEVERSION-MIB",
