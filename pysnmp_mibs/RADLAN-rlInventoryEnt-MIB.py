...
rlInventoryEntTable=_RlInventoryEntTable_Object((1,3,6,1,4,1,89,217))
if mibBuilder.loadTexts:rlInventoryEntTable.setStatus(_A)
_RlInventoryEntEntry_Object=MibTableRow
rlInventoryEntEntry=_RlInventoryEntEntry_Object((1,3,6,1,4,1,89,217,1))
...
rlInventoryEntUnitOrIfindex=_RlInventoryEntUnitOrIfindex_Object((1,3,6,1,4,1,89,217,1,1),_RlInventoryEntUnitOrIfindex_Type())
...
rlInventoryEntUnitIfindexID=_RlInventoryEntUnitIfindexID_Object((1,3,6,1,4,1,89,217,1,2),_RlInventoryEntUnitIfindexID_Type())
...
rlInventoryEntVendorID=_RlInventoryEntVendorID_Object((1,3,6,1,4,1,89,217,1,3),_RlInventoryEntVendorID_Type())
...
rlInventoryEntPID=_RlInventoryEntPID_Object((1,3,6,1,4,1,89,217,1,4),_RlInventoryEntPID_Type())
...
rlInventoryEntName=_RlInventoryEntName_Object((1,3,6,1,4,1,89,217,1,5),_RlInventoryEntName_Type())
...
rlInventoryEntDescription=_RlInventoryEntDescription_Object((1,3,6,1,4,1,89,217,1,6),_RlInventoryEntDescription_Type())
...
rlInventoryEntSerialNumber=_RlInventoryEntSerialNumber_Object((1,3,6,1,4,1,89,217,1,7),_RlInventoryEntSerialNumber_Type())
...
rlInventoryEntUnitNum=_RlInventoryEntUnitNum_Object((1,3,6,1,4,1,89,217,1,8),_RlInventoryEntUnitNum_Type())
