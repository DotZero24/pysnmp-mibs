...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cambium/CAMBIUM-PTP650-MIB
...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", cableDiagnosticsGroup=cableDiagnosticsGroup, wirelessLinkAvailability=wirelessLinkAvailability, capacityVariantMismatch=capacityVariantMismatch, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, rawReceivePower=rawReceivePower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortAllocation=mainPSUPortAllocation, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, longitude=longitude, antennaGain=antennaGain, tDMInterfaceStatus=tDMInterfaceStatus, transparentClockPort=transparentClockPort, licenseCapacity=licenseCapacity, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, userTableEntry=userTableEntry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, daylightSaving=daylightSaving, smtpGroup=smtpGroup, auxPortQLTx=auxPortQLTx, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, bootVersion=bootVersion, userTableIndex=userTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, supplementaryGroup=supplementaryGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsPeaks=dfsPeaks, nIDULanPortStatus=nIDULanPortStatus, userName=userName, tFTPServerInternetAddress=tFTPServerInternetAddress, frequencyVariant=frequencyVariant, aAAControlGroup=aAAControlGroup, channelBandwidth=channelBandwidth, mABTransmissionInterval=mABTransmissionInterval, licenseMaxLinkRange=licenseMaxLinkRange, systemClock=systemClock, softwareVersion=softwareVersion, iPVersion=iPVersion, tDM=tDM, sNTPServerTable=sNTPServerTable, ptp=ptp, targetRange=targetRange, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, portAllocationMismatch=portAllocationMismatch, tDMChannelLoopback=tDMChannelLoopback, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortStatusTrap=sFPPortStatusTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsControl=cableDiagnosticsControl, cableDiagPair2Distance=cableDiagPair2Distance, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transmitChannel=transmitChannel, mABHoldoffPeriod=mABHoldoffPeriod, cableDiagPair3Distance=cableDiagPair3Distance, versionsGroup=versionsGroup, phyStatusGroup=phyStatusGroup, txMABFrames=txMABFrames, mainPSUPortStatus=mainPSUPortStatus, l2CPPriorityTable=l2CPPriorityTable, mainPSUPortAutoMdix=mainPSUPortAutoMdix, syslogControlGroup=syslogControlGroup, transparentClock=transparentClock, sFPPortAutoMdix=sFPPortAutoMdix, mABState=mABState, sNMPEnabledTraps=sNMPEnabledTraps, maxLinkRangeExceeded=maxLinkRangeExceeded, receiveFreqKHz=receiveFreqKHz, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTable=userTable, ptmp=ptmp, localPacketFiltering=localPacketFiltering, routerProtocols=routerProtocols, mainPSUPortQLRx=mainPSUPortQLRx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsTable=dfsTable, wirelessLinkStatus=wirelessLinkStatus, iPv6Address=iPv6Address, receivePower=receivePower, masterSlaveMode=masterSlaveMode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, productName=productName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, lowestTDMModulationMode=lowestTDMModulationMode, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNTPState=sNTPState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mABNominalTransmitCapacity=mABNominalTransmitCapacity, pubStats=pubStats, byteErrorRatio=byteErrorRatio, auxPortSyncERxStatus=auxPortSyncERxStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetPortNumber=telnetPortNumber, sFPPortSSMTx=sFPPortSSMTx, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkName=linkName, syncETracking=syncETracking, tFTPServerPortNumber=tFTPServerPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseIPv6Support=licenseIPv6Support, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sMTPEnabledMessages=sMTPEnabledMessages, dSCPManagementPriority=dSCPManagementPriority, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSync=sNTPSync, enableTransmission=enableTransmission, cableDiagPair2Results=cableDiagPair2Results, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPError=sFPError, userPassword=userPassword, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationMode=tDDSynchronizationMode, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, receiveDataRate=receiveDataRate, licenseEncryption=licenseEncryption, notificationsGroup=notificationsGroup, sNTPPollInterval=sNTPPollInterval, tDMChannelStatus=tDMChannelStatus, licenseSFPPortSupport=licenseSFPPortSupport, installStatusTrap=installStatusTrap, cableDiagPair1Distance=cableDiagPair1Distance, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, timeZone=timeZone, auxPortSSMTx=auxPortSSMTx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseIssueNumber=licenseIssueNumber, installArmState=installArmState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, subbandHighestFrequency=subbandHighestFrequency, portAllocationMismatchTrap=portAllocationMismatchTrap, userRole=userRole, vLANManagementPriority=vLANManagementPriority, licenseGroup=licenseGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseVersion=licenseVersion, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, subnetMask=subnetMask, cableDiagPair3Results=cableDiagPair3Results, extendedSpectrumScanning=extendedSpectrumScanning, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTable=ethernetPriorityTable, dfsMeans=dfsMeans, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseSyncESupport=licenseSyncESupport, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpCompliance=ptpCompliance, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataBridgingStatus=dataBridgingStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, syslogState=syslogState, rangingMode=rangingMode, alarms=alarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, lowestDataModulationMode=lowestDataModulationMode, sNTPServerRetries=sNTPServerRetries, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressType=remoteInternetAddressType, cableLoss=cableLoss, sFPPortAllocation=sFPPortAllocation, licenseTrialPeriod=licenseTrialPeriod, userEnabled=userEnabled, reset=reset, sNTPServerStatus=sNTPServerStatus, cableDiagPair4Distance=cableDiagPair4Distance, sNTPServerTableEntry=sNTPServerTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortPauseFrames=dataPortPauseFrames, mPLSTCPriorityTable=mPLSTCPriorityTable, license=license, subbandLowestFrequency=subbandLowestFrequency, sNTPLastSync=sNTPLastSync, transmitFreqMHz=transmitFreqMHz, bridge=bridge, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, lowestSecondDataModulationMode=lowestSecondDataModulationMode, searchState=searchState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseSecurityLevel=licenseSecurityLevel, licenseRARSupport=licenseRARSupport, linkSymmetry=linkSymmetry, auxPortStatus=auxPortStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, secureModeAlarmTrap=secureModeAlarmTrap, sntp=sntp, tdmTable=tdmTable, regulatoryBand=regulatoryBand, transmitModulationMode=transmitModulationMode, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, productVariant=productVariant, l2CPPriorityTableIndex=l2CPPriorityTableIndex, auxPortStatusTrap=auxPortStatusTrap, PYSNMP_MODULE_ID=cambium, sNMPTrapTable=sNMPTrapTable, unitOutOfCalibration=unitOutOfCalibration, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkModeOptimization=linkModeOptimization, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, secureModeAlarm=secureModeAlarm, ptpTraps=ptpTraps, syncEEquipmentClock=syncEEquipmentClock, txColorCode=txColorCode, targetMACAddress=targetMACAddress, ethernet=ethernet, syslogControl=syslogControl, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, supplementary=supplementary, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, siteName=siteName, ptp650=ptp650, sNMPTrapInternetAddress=sNMPTrapInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tDMEnabledChannels=tDMEnabledChannels, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControl=phyControl, sMTPServerPortNumber=sMTPServerPortNumber, regulatoryBandTrap=regulatoryBandTrap, hardwareVersion=hardwareVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortSSMTx=mainPSUPortSSMTx, secondDataBridgingStatus=secondDataBridgingStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDMChannelCableLength=tDMChannelCableLength, tDDControl=tDDControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqMHz=receiveFreqMHz, auxPortConfigurationMismatch=auxPortConfigurationMismatch, versions=versions, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDMChannelStatusTrap=tDMChannelStatusTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortAllocation=auxPortAllocation, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, gatewayIPAddress=gatewayIPAddress, latitude=latitude, encryptionGroup=encryptionGroup, mainPSUPortQLTx=mainPSUPortQLTx, syslogClientTrap=syslogClientTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cableDiagPair1Results=cableDiagPair1Results, cableDiagnostics=cableDiagnostics, nIDULanPortAutoMdix=nIDULanPortAutoMdix, channelChangeTrap=channelChangeTrap, bridgeGroup=bridgeGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkLoss=linkLoss, sFPErrorTrap=sFPErrorTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortQLTx=sFPPortQLTx, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, systemReset=systemReset, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, range=range, licenseTDDSyncSupport=licenseTDDSyncSupport, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, eIRP=eIRP, smtp=smtp, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, configuration=configuration, configurationGroup=configurationGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tDMInterfaceControl=tDMInterfaceControl, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDDControlGroup=tDDControlGroup, tdmTableNumber=tdmTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseRegulatoryBandsList=licenseRegulatoryBandsList, aAAControl=aAAControl, transparentClockVLAN=transparentClockVLAN, transparentClockVID=transparentClockVID, phyControlGroup=phyControlGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagnosticsWarning=cableDiagnosticsWarning, iPv4Address=iPv4Address, cambium=cambium, dfsGroup=dfsGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, accessMethod=accessMethod, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortDisabledWarning=auxPortDisabledWarning, installArmStateTrap=installArmStateTrap, cableDiagPair4Results=cableDiagPair4Results, receiveChannel=receiveChannel, dfsTableNumber=dfsTableNumber, secondDataPortPauseFrames=secondDataPortPauseFrames, sNTPServerTableIndex=sNTPServerTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, installStatus=installStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortStatus=sFPPortStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, rxColorCode=rxColorCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, syslogClient=syslogClient, syslogStateTrap=syslogStateTrap, aggregateDataRate=aggregateDataRate, tDMGroup=tDMGroup, mABNominalModulationMode=mABNominalModulationMode, tdmTableEntry=tdmTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, remoteInternetAddress=remoteInternetAddress, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, sntpGroup=sntpGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dfsTableEntry=dfsTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, alarmsGroup=alarmsGroup, phyStatus=phyStatus, licenseCountry=licenseCountry, auxPortQLRx=auxPortQLRx, sMTPEmailAlert=sMTPEmailAlert, iPv6PrefixLength=iPv6PrefixLength, encryptionAlgorithm=encryptionAlgorithm, routerProtocolsGroup=routerProtocolsGroup, syncETrackingState=syncETrackingState, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, transmitFreqKHz=transmitFreqKHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, snmpControl=snmpControl, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseBandwidthCap=licenseBandwidthCap, tdmTableIndex=tdmTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mABProtocolVID=mABProtocolVID, tDMChannelLineCode=tDMChannelLineCode, licenseGroupAccess=licenseGroupAccess, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dfsTableIndex=dfsTableIndex, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dfs=dfs, auxPortAcceptedQLRx=auxPortAcceptedQLRx, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sFPPortQLRx=sFPPortQLRx, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataBridgingAvailability=dataBridgingAvailability, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ptpGroups=ptpGroups, vectorError=vectorError, pubStatsGroup=pubStatsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, altitude=altitude, groupID=groupID, sNTPServerTableNumber=sNTPServerTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, encryption=encryption, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementGroup=managementGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch)
