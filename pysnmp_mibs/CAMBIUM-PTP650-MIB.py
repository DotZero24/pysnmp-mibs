...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", l2CPPriorityTableIndex=l2CPPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, cableDiagPair2Results=cableDiagPair2Results, sntpGroup=sntpGroup, accessMethod=accessMethod, dfsTableNumber=dfsTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfs=dfs, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitDataRate=transmitDataRate, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, channelBandwidth=channelBandwidth, aAAControl=aAAControl, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, transparentClock=transparentClock, installArmStateTrap=installArmStateTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, license=license, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortAllocation=auxPortAllocation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPLastSync=sNTPLastSync, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPServerTableNumber=sNTPServerTableNumber, encryption=encryption, transparentClockVLAN=transparentClockVLAN, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortStatus=sFPPortStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syncETracking=syncETracking, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sFPPortAutoMdix=sFPPortAutoMdix, channelChangeTrap=channelChangeTrap, linkModeOptimization=linkModeOptimization, phyControlGroup=phyControlGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, localPacketFiltering=localPacketFiltering, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataBridgingAvailability=dataBridgingAvailability, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, userRole=userRole, licenseMaxLinkRange=licenseMaxLinkRange, aggregateDataRate=aggregateDataRate, qOSPriorityScheme=qOSPriorityScheme, tFTPServerInternetAddress=tFTPServerInternetAddress, configuration=configuration, cableLoss=cableLoss, tDMEnabledChannels=tDMEnabledChannels, licenseGroupAccess=licenseGroupAccess, latitude=latitude, licenseSFPPortSupport=licenseSFPPortSupport, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, rangingMode=rangingMode, syslogState=syslogState, sNTPServerTimeout=sNTPServerTimeout, productName=productName, ethernetGroup=ethernetGroup, mABMaintenanceLevel=mABMaintenanceLevel, sNTPServerInternetAddress=sNTPServerInternetAddress, bootVersion=bootVersion, phyStatus=phyStatus, mABProtocolVID=mABProtocolVID, bridge=bridge, tDDControlGroup=tDDControlGroup, systemClock=systemClock, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, userTable=userTable, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTable=mPLSTCPriorityTable, iPVersion=iPVersion, dfsGroup=dfsGroup, installStatusTrap=installStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, byteErrorRatio=byteErrorRatio, secureModeAlarm=secureModeAlarm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPv6PrefixLength=iPv6PrefixLength, tDMChannelLoopback=tDMChannelLoopback, enableTransmission=enableTransmission, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receivePower=receivePower, sNTPServerTable=sNTPServerTable, installStatus=installStatus, vLANManagementPriority=vLANManagementPriority, searchState=searchState, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, cableDiagPair3Distance=cableDiagPair3Distance, pubStatsGroup=pubStatsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClientTrap=syslogClientTrap, ptpCompliance=ptpCompliance, licenseGroup=licenseGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, lowestDataModulationMode=lowestDataModulationMode, tDMChannelLineCode=tDMChannelLineCode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, installArmState=installArmState, altitude=altitude, telnetPortNumber=telnetPortNumber, rawReceivePower=rawReceivePower, syslogControl=syslogControl, tdmTable=tdmTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, versions=versions, cambium=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, ethernet=ethernet, transparentClockVID=transparentClockVID, sntp=sntp, dfsTable=dfsTable, lowestSecondDataModulationMode=lowestSecondDataModulationMode, cableDiagPair4Distance=cableDiagPair4Distance, licenseCapacity=licenseCapacity, supplementaryGroup=supplementaryGroup, sFPPortSSMTx=sFPPortSSMTx, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, reset=reset, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rxColorCode=rxColorCode, sNTPServerRetries=sNTPServerRetries, sNTPSyncTrap=sNTPSyncTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDM=tDM, range=range, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, supplementary=supplementary, tDDControl=tDDControl, dfsTableIndex=dfsTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, auxPortDisabledWarning=auxPortDisabledWarning, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transparentClockPort=transparentClockPort, sNTPSync=sNTPSync, sNTPServerStatus=sNTPServerStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPError=sFPError, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, cableDiagPair1Distance=cableDiagPair1Distance, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDMChannelCableLength=tDMChannelCableLength, transmitFreqKHz=transmitFreqKHz, receiveFreqMHz=receiveFreqMHz, smtp=smtp, licenseVersion=licenseVersion, smtpGroup=smtpGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, alarms=alarms, mABState=mABState, tDDSynchronizationMode=tDDSynchronizationMode, siteName=siteName, masterSlaveMode=masterSlaveMode, lowestTDMModulationMode=lowestTDMModulationMode, userTableEntry=userTableEntry, licenseSecurityLevel=licenseSecurityLevel, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, nIDULanPortStatus=nIDULanPortStatus, receiveDataRate=receiveDataRate, l2CPPriorityTable=l2CPPriorityTable, transmitPower=transmitPower, frequencyVariant=frequencyVariant, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerPortNumber=sMTPServerPortNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseCountry=licenseCountry, ptmp=ptmp, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagPair4Results=cableDiagPair4Results, receiveChannel=receiveChannel, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, remoteInternetAddress=remoteInternetAddress, mainPSUPortQLTx=mainPSUPortQLTx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagnostics=cableDiagnostics, groupID=groupID, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, targetMACAddress=targetMACAddress, management=management, softwareVersion=softwareVersion, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMGroup=tDMGroup, timeZone=timeZone, cableDiagPair3Results=cableDiagPair3Results, auxPortQLTx=auxPortQLTx, sNMPEnabledTraps=sNMPEnabledTraps, secondDataPortPauseFrames=secondDataPortPauseFrames, maximumTransmitPower=maximumTransmitPower, tdmTableNumber=tdmTableNumber, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, secondarySoftwareVersion=secondarySoftwareVersion, userPassword=userPassword, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMInterfaceStatus=tDMInterfaceStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sFPPortQLRx=sFPPortQLRx, tDDSynchronizationAlarm=tDDSynchronizationAlarm, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, unitOutOfCalibration=unitOutOfCalibration, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortStatusTrap=sFPPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortStatusTrap=mainPSUPortStatusTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tdmTableIndex=tdmTableIndex, licenseIPv6Support=licenseIPv6Support, iPv6Address=iPv6Address, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsResultTable=cableDiagnosticsResultTable)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sMTPEmailAlert=sMTPEmailAlert, gatewayIPAddress=gatewayIPAddress, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mABHoldoffPeriod=mABHoldoffPeriod, encryptionGroup=encryptionGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hardwareVersion=hardwareVersion, bridgeGroup=bridgeGroup, eIRP=eIRP, dfsPeaks=dfsPeaks, ptpTraps=ptpTraps, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseRARSupport=licenseRARSupport, sNMPCommunityString=sNMPCommunityString, sFPPortAllocation=sFPPortAllocation, ptpGroups=ptpGroups, tDMChannelStatusTrap=tDMChannelStatusTrap, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, sNTPPollInterval=sNTPPollInterval, mABTransmissionInterval=mABTransmissionInterval, sNTPState=sNTPState, licenseEncryption=licenseEncryption, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, subbandLowestFrequency=subbandLowestFrequency, notificationsGroup=notificationsGroup, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, userName=userName, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNTPServerTableIndex=sNTPServerTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, ethernetPriorityTable=ethernetPriorityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagnosticsControl=cableDiagnosticsControl, sNMPv3Enable=sNMPv3Enable, auxPortQLRx=auxPortQLRx, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDMChannelStatus=tDMChannelStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sMTPEnabledMessages=sMTPEnabledMessages, routerProtocolsGroup=routerProtocolsGroup, systemReset=systemReset, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, alarmsGroup=alarmsGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortQLTx=sFPPortQLTx, userTableNumber=userTableNumber, managementGroup=managementGroup, cableDiagPair1Results=cableDiagPair1Results, daylightSaving=daylightSaving, syncETrackingState=syncETrackingState, mainPSUPortQLRx=mainPSUPortQLRx, userEnabled=userEnabled, transmitFreqMHz=transmitFreqMHz, txColorCode=txColorCode, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, syncEEquipmentClock=syncEEquipmentClock, capacityVariantMismatch=capacityVariantMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regulatoryBand=regulatoryBand, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPErrorTrap=sFPErrorTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, pubStats=pubStats, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dfsMeans=dfsMeans, portAllocationMismatch=portAllocationMismatch, mABNominalModulationMode=mABNominalModulationMode, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, dataBridgingStatus=dataBridgingStatus, sNMPPortNumber=sNMPPortNumber, ptp=ptp, capacityVariantMismatchTrap=capacityVariantMismatchTrap, linkLoss=linkLoss, remoteInternetAddressType=remoteInternetAddressType, auxPortSSMTx=auxPortSSMTx, hTTPPortNumber=hTTPPortNumber, extendedSpectrumScanning=extendedSpectrumScanning, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, PYSNMP_MODULE_ID=cambium, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, auxPortStatus=auxPortStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, productVariant=productVariant, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, longitude=longitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseIssueNumber=licenseIssueNumber, useVLANForMABProtocol=useVLANForMABProtocol, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, dataPortPauseFrames=dataPortPauseFrames, licenseSyncESupport=licenseSyncESupport, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, txMABFrames=txMABFrames, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortStatus=mainPSUPortStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ptp650=ptp650, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tDMInterfaceControl=tDMInterfaceControl, targetRange=targetRange, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, secondDataBridgingStatus=secondDataBridgingStatus, receiveModulationMode=receiveModulationMode, syslogStateTrap=syslogStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, resetGroup=resetGroup, tdmTableEntry=tdmTableEntry, cableDiagPair2Distance=cableDiagPair2Distance, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, linkSymmetry=linkSymmetry, regulatoryBandTrap=regulatoryBandTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, phyControl=phyControl, syslogControlGroup=syslogControlGroup, versionsGroup=versionsGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, mABProtocolVLANPriority=mABProtocolVLANPriority, routerProtocols=routerProtocols, mainPSUPortAllocation=mainPSUPortAllocation, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, subbandHighestFrequency=subbandHighestFrequency, licenseBandwidthCap=licenseBandwidthCap, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv4Address=iPv4Address, licenseTrialPeriod=licenseTrialPeriod, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNTPPrimaryServer=sNTPPrimaryServer, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitChannel=transmitChannel, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, linkName=linkName, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, syslogClient=syslogClient, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortStatusTrap=auxPortStatusTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dataBridgingStatusAlarm=dataBridgingStatusAlarm)
