...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cabletron/CTRON-AP3000-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:13:41 2025
...
MibIdentifier, enterprises, NotificationType, Integer32, Bits, Unsigned32, mgmt, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, TimeTicks, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "NotificationType", "Integer32", "Bits", "Unsigned32", "mgmt", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "TimeTicks", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("CTRON-AP3000-MIB", apWStationSessionTable=apWStationSessionTable, apAuthenticationAcctPort=apAuthenticationAcctPort, DisplayString=DisplayString, ap8021xSuppUser=ap8021xSuppUser, dot11StationAuthentication=dot11StationAuthentication, apSecuritySshServerPort=apSecuritySshServerPort, apAuthenticationMgnt=apAuthenticationMgnt, apVLANMgntNativeId=apVLANMgntNativeId, ap8021xSessionKeyRefreshRate=ap8021xSessionKeyRefreshRate, dot11InterfaceGFail=dot11InterfaceGFail, apSyslogConfigMgnt=apSyslogConfigMgnt, dot11StationReAssociation=dot11StationReAssociation, apSecuritySshServerEnabled=apSecuritySshServerEnabled, apNotificationDot11ReasonCode=apNotificationDot11ReasonCode, apSyslogServerPort=apSyslogServerPort, apWMMBssParamEntry=apWMMBssParamEntry, wdsApRole=wdsApRole, apSyslogServerTable=apSyslogServerTable, apRadioApSecurityWPAPreAuthentication=apRadioApSecurityWPAPreAuthentication, apSyslogServerState=apSyslogServerState, apWStationSessionRxByteCount=apWStationSessionRxByteCount, apRadioSecuritySharedKeyLen=apRadioSecuritySharedKeyLen, macFilterAddress=macFilterAddress, sysSystemDown=sysSystemDown, enterpriseApFilterProtocolEntry=enterpriseApFilterProtocolEntry, apWMMBssParamAIFSN=apWMMBssParamAIFSN, apWMMControlEntry=apWMMControlEntry, netConfigDefaultGateway=netConfigDefaultGateway, macFilterIndex=macFilterIndex, apSNTPDSTStartDay=apSNTPDSTStartDay, trapPppLogonFail=trapPppLogonFail, appAdminPassword=appAdminPassword, apEtherNetConfig=apEtherNetConfig, apAuthenticationServerIndex=apAuthenticationServerIndex, apRadioSecurityIndex=apRadioSecurityIndex, netConfigHttpPort=netConfigHttpPort, apNotificationTrapObjects=apNotificationTrapObjects, dot1xAuthFail=dot1xAuthFail, apvFilterControlEntry=apvFilterControlEntry, apWStationSessionLastDisassociatedTime=apWStationSessionLastDisassociatedTime, localMacAddrAuthSuccess=localMacAddrAuthSuccess, apDNSMgnt=apDNSMgnt, rogueApDetectionTable=rogueApDetectionTable, swOpCodeVer=swOpCodeVer, PYSNMP_MODULE_ID=ctronAP3000, apAdminMgnt=apAdminMgnt, cabletron=cabletron, apWStationSessionAuthenticated=apWStationSessionAuthenticated, MacAddress=MacAddress, macFilterAllowedToGo=macFilterAllowedToGo, trapIappStationRoamedTo=trapIappStationRoamedTo, enterpriseApRadioWEPKeysTable=enterpriseApRadioWEPKeysTable, enterpriseApRadioDataRate=enterpriseApRadioDataRate, apWMMBssParamCWmax=apWMMBssParamCWmax, apLogConfigState=apLogConfigState, apvMacFilterPermission=apvMacFilterPermission, apWStationSessionKeyType=apWStationSessionKeyType, apSnmpTrapDestinationEntry=apSnmpTrapDestinationEntry, swCountrySetting=swCountrySetting, netConfigDHCPState=netConfigDHCPState, apWSLSupportRxThreshold=apWSLSupportRxThreshold, apWStationSessionIsForwarding=apWStationSessionIsForwarding, wdsPeerBssid=wdsPeerBssid, apSNTPDSTStartMonth=apSNTPDSTStartMonth, rogueApRADIUSAuthenticate=rogueApRADIUSAuthenticate, trapSysSystemUp=trapSysSystemUp, trapDot1xAuthSuccess=trapDot1xAuthSuccess, enterpriseApRadioWEPKeyLength=enterpriseApRadioWEPKeyLength, apAdminUsername=apAdminUsername, apSyslogLevel=apSyslogLevel, apDNSSecondaryServer=apDNSSecondaryServer, ap8021xReauthenticationTimeout=ap8021xReauthenticationTimeout, enterpriseApRadioAutoDataRate=enterpriseApRadioAutoDataRate, apNativeVlanSsidNumber=apNativeVlanSsidNumber, apSnmpTrapDestinationIP=apSnmpTrapDestinationIP, iappStationRoamedTo=iappStationRoamedTo, apAuthenticationAcctInterimUpdate=apAuthenticationAcctInterimUpdate, apWMMBssParamIndex=apWMMBssParamIndex, trapDot11StationReAssociation=trapDot11StationReAssociation, apRadioInterfaceMgnt=apRadioInterfaceMgnt, rogueApIndex=rogueApIndex, apVLANMgntEtherUntaggedVlanId=apVLANMgntEtherUntaggedVlanId, apSyslogConsoleState=apSyslogConsoleState, apEventLogIndex=apEventLogIndex, linkQualityEntry=linkQualityEntry, apAuthenticationSetupEntry=apAuthenticationSetupEntry, apWSLSupportMgnt=apWSLSupportMgnt, apMacFilterControl=apMacFilterControl, apEventLogEntry=apEventLogEntry, apSnmpTrapDestinationState=apSnmpTrapDestinationState, apvAuthenticationSetupTable=apvAuthenticationSetupTable, ap8021xBroadcastKeyRefreshRate=ap8021xBroadcastKeyRefreshRate, trapSntpServerFail=trapSntpServerFail, apAuthenticationMode=apAuthenticationMode, apNativeVlanTable=apNativeVlanTable, mibs=mibs, apSNTPSecondaryServer=apSNTPSecondaryServer, apSecurityMgnt=apSecurityMgnt, apWStationSessionTxPacketCount=apWStationSessionTxPacketCount, apWMMApParamAIFSN=apWMMApParamAIFSN, dot11WirelessSTPDetection=dot11WirelessSTPDetection, enterpriseApRadioAntennaMode=enterpriseApRadioAntennaMode, apv8021xState=apv8021xState, apSNTPTimezone=apSNTPTimezone, enterpriseApVapRadioEntry=enterpriseApVapRadioEntry, apWMMApParamTable=apWMMApParamTable, iappStationRoamedFrom=iappStationRoamedFrom, dot1xMacAddrAuthSuccess=dot1xMacAddrAuthSuccess, apSNTPDSTEndDay=apSNTPDSTEndDay, dot11StationRequestFail=dot11StationRequestFail, apSNTPPrimaryServer=apSNTPPrimaryServer, enterpriseApRadioAvChannelListTable=enterpriseApRadioAvChannelListTable, apWStationSessionEntry=apWStationSessionEntry, apRadioSecurityWEPEnabled=apRadioSecurityWEPEnabled, enterpriseApVapRadioSecureAccess=enterpriseApVapRadioSecureAccess, trapDot11StationAssociation=trapDot11StationAssociation, apvGlobalIBSSRelayMode=apvGlobalIBSSRelayMode, apWStationSessionStationAddres=apWStationSessionStationAddres, apvFilterControlTable=apvFilterControlTable, localMacAddrAuthFail=localMacAddrAuthFail, enterpriseApRadioIndex=enterpriseApRadioIndex, apvMacFilterEntry=apvMacFilterEntry, qosEtherTypeTable=qosEtherTypeTable, apRadioSecurityWPAPSKType=apRadioSecurityWPAPSKType, apSnmpTrapDestinationCommunity=apSnmpTrapDestinationCommunity, apWMMApParamIndex=apWMMApParamIndex, rogueApInterval=rogueApInterval, ap8021xSuppState=ap8021xSuppState, wdsPeerIndex=wdsPeerIndex, apNotificationObjects=apNotificationObjects, apvAuthenticationSetupEntry=apvAuthenticationSetupEntry, linkQualityStaRssi=linkQualityStaRssi, apvFilterControlIndex=apvFilterControlIndex, linkQualityTable=linkQualityTable, apAuthenticationPort=apAuthenticationPort, apSnmpVersionFilter=apSnmpVersionFilter, apvMACAuthenticationTimeout=apvMACAuthenticationTimeout, macFilterEntry=macFilterEntry, apWStationSessionAssociatedTime=apWStationSessionAssociatedTime, apWSLSupportHeartbeatInterval=apWSLSupportHeartbeatInterval, apWSLRFAreaPollControl=apWSLRFAreaPollControl, apWMMState=apWMMState, wdsApAckTimeout=wdsApAckTimeout, enterpriseApVapRadioDefefaultPriority=enterpriseApVapRadioDefefaultPriority, apRadioSecurityWPAMode=apRadioSecurityWPAMode, apDNSPrimaryServer=apDNSPrimaryServer, apEventLogMgnt=apEventLogMgnt, qosMACTypeTable=qosMACTypeTable, enterpriseApRadioAvAntennaIndex=enterpriseApRadioAvAntennaIndex, rogueApDetectionEntry=rogueApDetectionEntry, apResetMgt=apResetMgt, enterpriseApRadioFixedAntennaType=enterpriseApRadioFixedAntennaType, dot1xMacAddrAuthFail=dot1xMacAddrAuthFail, apAuthenticationAcctState=apAuthenticationAcctState, apRadioSecurityEntry=apRadioSecurityEntry, linkQualityStaIndex=linkQualityStaIndex, qosMACTypeOpeStatus=qosMACTypeOpeStatus, apAuthenticationSupplicantTable=apAuthenticationSupplicantTable, apSnmpMgnt=apSnmpMgnt, apWMMApParamCWmax=apWMMApParamCWmax, apWSLSupportControlStatus=apWSLSupportControlStatus, enterpriseApVapRadioMaxAssoc=enterpriseApVapRadioMaxAssoc, rogueApClear=rogueApClear, apRadioSecurityWPACipher=apRadioSecurityWPACipher, enterpriseApRadioSWRetryMode=enterpriseApRadioSWRetryMode, ap8021xState=ap8021xState, apWMMApParamTXOPLimit=apWMMApParamTXOPLimit, apRadioSecurityWEPKeyType=apRadioSecurityWEPKeyType, apAuthenticationKey=apAuthenticationKey, trapIappStationRoamedFrom=trapIappStationRoamedFrom, swProductName=swProductName, enterpriseApVapRadioIndex=enterpriseApVapRadioIndex, trapDot1xMacAddrAuthSuccess=trapDot1xMacAddrAuthSuccess, netConfigHttpState=netConfigHttpState, netConfigHttpsState=netConfigHttpsState, enterpriseApRadioAvAntennaListTable=enterpriseApRadioAvAntennaListTable, apRadioSecurityTable=apRadioSecurityTable, enterpriseApRadioWdsTable=enterpriseApRadioWdsTable, apRestartOpCodeFile=apRestartOpCodeFile, trapConfiguration=trapConfiguration, enterpriseApRadioTable=enterpriseApRadioTable, apNativeVlanIfIndex=apNativeVlanIfIndex, apWMMBssParamAdmissionControl=apWMMBssParamAdmissionControl, enterpriseApRadioAutoChannel=enterpriseApRadioAutoChannel, apRadioSecurityWPACipherSuite=apRadioSecurityWPACipherSuite, macFilterTable=macFilterTable, apNotificationDot11AuthenticatorMacAddr=apNotificationDot11AuthenticatorMacAddr, apWMMApParamAdmissionControl=apWMMApParamAdmissionControl, apNotificationDot11IpAddress=apNotificationDot11IpAddress, apAuthenticationServerEntry=apAuthenticationServerEntry, apWStationSessionTxByteCount=apWStationSessionTxByteCount, dot1xAuthSuccess=dot1xAuthSuccess, trapIappContextDataSent=trapIappContextDataSent, apWMMBssParamCWmin=apWMMBssParamCWmin, apWStationSessionAssociationId=apWStationSessionAssociationId, apWMMApParamEntry=apWMMApParamEntry, netConfigIPAddress=netConfigIPAddress, pppLogonFail=pppLogonFail, linkQualityStaMacAddress=linkQualityStaMacAddress, apSNTPState=apSNTPState, qosMACTypePriority=qosMACTypePriority, apWMMBssParamTable=apWMMBssParamTable, sysRadiusServerChanged=sysRadiusServerChanged, apNotificationDot11RequestType=apNotificationDot11RequestType, enterpriseApFilterProtocolState=enterpriseApFilterProtocolState, swSerialNumber=swSerialNumber, macFilterMgnt=macFilterMgnt, enterpriseApVapRadioState=enterpriseApVapRadioState, swHardwareVer=swHardwareVer, apSyslogServerIndex=apSyslogServerIndex, apIappMgnt=apIappMgnt, apAuthenticationTimeout=apAuthenticationTimeout, apvMacFilterOperateTable=apvMacFilterOperateTable, apWSLSupportHeartbeatLastChange=apWSLSupportHeartbeatLastChange, dot11InterfaceAFail=dot11InterfaceAFail, apvMacFilterOperateEntry=apvMacFilterOperateEntry, enterpriseApRadioAvChannelListEntry=enterpriseApRadioAvChannelListEntry, apWSLSupportOperationMode=apWSLSupportOperationMode, apWStationSessionIfIndex=apWStationSessionIfIndex, apSnmpCommunityReadOnly=apSnmpCommunityReadOnly, apWStationSessionLastAuthenticatedTime=apWStationSessionLastAuthenticatedTime, apvMACAuthenticationMode=apvMACAuthenticationMode, apWMMBssParamTXOPLimit=apWMMBssParamTXOPLimit, apSnmpTrapDestinationIndex=apSnmpTrapDestinationIndex, enterpriseApRadioAntennaModeControl=enterpriseApRadioAntennaModeControl, enterpriseApRadioAvAntennaListEntry=enterpriseApRadioAvAntennaListEntry, apNativeVlanVlanId=apNativeVlanVlanId, sysSystemUp=sysSystemUp, qosModeControl=qosModeControl, apEventLogMessage=apEventLogMessage, enterpriseApRadioWEPKeyType=enterpriseApRadioWEPKeyType, trapDot11StationAuthentication=trapDot11StationAuthentication, apAuthenticationSupplicantEntry=apAuthenticationSupplicantEntry, apNotificationDot11MacAddr=apNotificationDot11MacAddr, apWStationSessionMgnt=apWStationSessionMgnt, enterpriseApFilterControlEthernet=enterpriseApFilterControlEthernet, netConfigHttpsPort=netConfigHttpsPort, enterpriseApFilterProtocolTable=enterpriseApFilterProtocolTable, apvMACAuthenticationPasswd=apvMACAuthenticationPasswd, apRestartControl=apRestartControl, rogueApRSSIValue=rogueApRSSIValue, trapDot11WirelessSTPDetection=trapDot11WirelessSTPDetection, apFilterControlMgnt=apFilterControlMgnt, ap8021xSuppIndex=ap8021xSuppIndex, rogueApChannelNumber=rogueApChannelNumber, sysEntity=sysEntity, enterpriseApRadioAvChannelIndex=enterpriseApRadioAvChannelIndex, apRadioSecurityWPAPSK=apRadioSecurityWPAPSK, apWStationSessionLastAssociatedTime=apWStationSessionLastAssociatedTime, enterpriseApRadioTurboMode=enterpriseApRadioTurboMode, apSecuritySsh=apSecuritySsh, apvMacFilterTable=apvMacFilterTable, apSNTPMgnt=apSNTPMgnt, apv8021xIndex=apv8021xIndex)
mibBuilder.exportSymbols("CTRON-AP3000-MIB", apEventLogClear=apEventLogClear, qosEtherTypePriority=qosEtherTypePriority, apWSLSupportMasterAddress=apWSLSupportMasterAddress, apRadioSecurityWPAKeyType=apRadioSecurityWPAKeyType, apSNTPDST=apSNTPDST, apSyslogServerEntry=apSyslogServerEntry, comPortControl=comPortControl, apWSLSupportPort=apWSLSupportPort, linkQualityMgnt=linkQualityMgnt, apWSLSupportControl=apWSLSupportControl, apNativeVlanEntry=apNativeVlanEntry, apWMMApParamCWmin=apWMMApParamCWmin, netConfigSubnetMask=netConfigSubnetMask, trapLocalMacAddrAuthSuccess=trapLocalMacAddrAuthSuccess, apRogueApMgnt=apRogueApMgnt, qosEtherTypeEntry=qosEtherTypeEntry, enterpriseApFilterProtocolISODesignator=enterpriseApFilterProtocolISODesignator, rogueApSsid=rogueApSsid, apSyslogServerIPAddress=apSyslogServerIPAddress, qosMACTypeIndex=qosMACTypeIndex, apAuthenticationRetransmit=apAuthenticationRetransmit, apv8021xReauthenticationTimeout=apv8021xReauthenticationTimeout, apvMacFilterAddressToAdd=apvMacFilterAddressToAdd, ap8021xSuppPasswd=ap8021xSuppPasswd, swBootRomVer=swBootRomVer, TruthValue=TruthValue, enterpriseApRadioAvAntennaId=enterpriseApRadioAvAntennaId, enterpriseApRadioAntennaID=enterpriseApRadioAntennaID, apSNTPDSTEndMonth=apSNTPDSTEndMonth, apFilterControlBridge=apFilterControlBridge, qosSVPStatus=qosSVPStatus, enterpriseApRadioMulticastDataRate=enterpriseApRadioMulticastDataRate, rogueApPortNumber=rogueApPortNumber, apvIBSSFilterControl=apvIBSSFilterControl, dot1xAuthNotInitiated=dot1xAuthNotInitiated, wdsPeerRSSI=wdsPeerRSSI, trapLocalMacAddrAuthFail=trapLocalMacAddrAuthFail, apRougeApControl=apRougeApControl, apNotificationTrapTree=apNotificationTrapTree, enterpriseApRadioAvChannelNo=enterpriseApRadioAvChannelNo, apWSLSupportSecondaryAddress=apWSLSupportSecondaryAddress, iappContextDataSent=iappContextDataSent, enterpriseApRadioAvAntennaDesc=enterpriseApRadioAvAntennaDesc, enterpriseApVapRadioTable=enterpriseApVapRadioTable, trapSysSystemDown=trapSysSystemDown, trapControl=trapControl, apEtherInterfaceMgnt=apEtherInterfaceMgnt, apvMacFilterActivity=apvMacFilterActivity, rogueApBssid=rogueApBssid, ctronAP3000=ctronAP3000, dot11StationAssociation=dot11StationAssociation, rogueApScanNow=rogueApScanNow, enterpriseApRadioPreamble=enterpriseApRadioPreamble, enterpriseApRadioTransmitPower=enterpriseApRadioTransmitPower, enterpriseApRadioGMode=enterpriseApRadioGMode, qosMgnt=qosMgnt, rogueApState=rogueApState, enterpriseApRadioWEPKeysEntry=enterpriseApRadioWEPKeysEntry, trapSysRadiusServerChanged=trapSysRadiusServerChanged, apVLANMgntStateNextBoot=apVLANMgntStateNextBoot, apAuthenticationServerTable=apAuthenticationServerTable, enterpriseApFilterProtocolName=enterpriseApFilterProtocolName, apVLANMgnt=apVLANMgnt, apWStationSessionAssociated=apWStationSessionAssociated, enterpriseApVapRadioTransmitKey=enterpriseApVapRadioTransmitKey, rogueApDuration=rogueApDuration, trapDot1xMacAddrAuthFail=trapDot1xMacAddrAuthFail, enterpriseApFilterControlAPManage=enterpriseApFilterControlAPManage, qosEtherTypeOpeStatus=qosEtherTypeOpeStatus, apvMacFilterAddress=apvMacFilterAddress, apNotificationDot11Station=apNotificationDot11Station, trapDot11InterfaceGFail=trapDot11InterfaceGFail, trapDot1xAuthNotInitiated=trapDot1xAuthNotInitiated, apNativeVlanState=apNativeVlanState, enterpriseApRadioWdsEntry=enterpriseApRadioWdsEntry, apWStationSessionRxPacketCount=apWStationSessionRxPacketCount, comPortMgnt=comPortMgnt, trapDot11StationRequestFail=trapDot11StationRequestFail, apSnmpTrapDestinationTable=apSnmpTrapDestinationTable, apv8021xBroadcastKeyRefreshRate=apv8021xBroadcastKeyRefreshRate, sntpServerFail=sntpServerFail, linkQualityRadioIndex=linkQualityRadioIndex, macFilterOpeStatus=macFilterOpeStatus, apRadioApSecurityWPAPmksaLifetime=apRadioApSecurityWPAPmksaLifetime, enterpriseApVapRadioDescription=enterpriseApVapRadioDescription, qosMACTypeAddress=qosMACTypeAddress, apvAPManageFilterControl=apvAPManageFilterControl, enterpriseApRadioWEPKeysIndex=enterpriseApRadioWEPKeysIndex, apAuthenticationServer=apAuthenticationServer, qosMACTypeEntry=qosMACTypeEntry, qosQueueingMode=qosQueueingMode, apWSLRFAreaPollControlStatus=apWSLRFAreaPollControlStatus, qosEtherTypeIndex=qosEtherTypeIndex, apSnmpCommunityReadWrite=apSnmpCommunityReadWrite, qosEtherTypeHexValue=qosEtherTypeHexValue, apVLANMgntState=apVLANMgntState, apWStationSessionVlanID=apWStationSessionVlanID, apWMMMgnt=apWMMMgnt, apv8021xSessionKeyRefreshRate=apv8021xSessionKeyRefreshRate, apRadioSecurityWEPAuthType=apRadioSecurityWEPAuthType, apEventLogTable=apEventLogTable, enterpriseApFilterProtocolIndex=enterpriseApFilterProtocolIndex, apWMMControlTable=apWMMControlTable, apIappEnabled=apIappEnabled, apSecuritySshTelnetServerEnabled=apSecuritySshTelnetServerEnabled, enterpriseApRadioEntry=enterpriseApRadioEntry, apvMacFilterIndex=apvMacFilterIndex, enterpriseApRadioWdsPeerTable=enterpriseApRadioWdsPeerTable, enterpriseApRadioWdsPeerEntry=enterpriseApRadioWdsPeerEntry, trapDot11InterfaceAFail=trapDot11InterfaceAFail, trapDot1xAuthFail=trapDot1xAuthFail)
