...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/a3com/A3Com-DLSW-r1-MIB
...
mibBuilder.exportSymbols("A3Com-DLSW-r1-MIB", dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswResourceMacExclusivity=dlswResourceMacExclusivity, dlswDirectory=dlswDirectory, dlswVersion=dlswVersion, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, TAddress=TAddress, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirNBTable=dlswDirNBTable, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, EndStationLocation=EndStationLocation, dlswDirMacMask=dlswDirMacMask, dlswCircuit=dlswCircuit, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacTable=dlswDirMacTable, dlswDirMacMac=dlswDirMacMac, dlswTrapControl=dlswTrapControl, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, RowStatus=RowStatus, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, Truthvalue=Truthvalue, dlswDirNBEntry=dlswDirNBEntry, dlswDirMacIndex=dlswDirMacIndex, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperState=dlswTConnOperState, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirStat=dlswDirStat, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitS2TDomain=dlswCircuitS2TDomain, LFSize=LFSize, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswMIB_3Com=dlswMIB_3Com, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswVirtualSegmentLFSize=dlswVirtualSegmentLFSize, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConn=dlswTConn, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBLFSize=dlswDirNBLFSize, dlswInterface=dlswInterface, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitEntry=dlswCircuitEntry, MacAddress=MacAddress, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswResourceNBExclusivity=dlswResourceNBExclusivity, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, DlcType=DlcType, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswStatus=dlswStatus, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitCreates=dlswCircuitCreates, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswVersionString=dlswVersionString, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirMacLFSize=dlswDirMacLFSize, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswSdlc=dlswSdlc, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitPriority=dlswCircuitPriority, dlswVendorID=dlswVendorID, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacEntry=dlswDirMacEntry, dlswStdPacingSupport=dlswStdPacingSupport, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirMacEntryType=dlswDirMacEntryType, dlswTraps=dlswTraps, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitState=dlswCircuitState, dlswTConnConfigSapList=dlswTConnConfigSapList, brouterMIB=brouterMIB, dlswDirNBEntries=dlswDirNBEntries, dlswTrapTConnUp=dlswTrapTConnUp, dlswUpTime=dlswUpTime, Instancepointer=Instancepointer, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBName=dlswDirNBName, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitStat=dlswCircuitStat, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperConnectTime=dlswTConnOperConnectTime, NBName=NBName, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswActiveCircuits=dlswActiveCircuits, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswNode=dlswNode, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacLocationType=dlswDirMacLocationType, DlswTimeStamp=DlswTimeStamp, dlswTConnStat=dlswTConnStat, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirCache=dlswDirCache, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitTable=dlswCircuitTable, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, a3Com=a3Com)
