...
mibBuilder.exportSymbols("A3Com-DLSW-r1-MIB", EndStationLocation=EndStationLocation, dlswTConn=dlswTConn, dlswResourceNBExclusivity=dlswResourceNBExclusivity, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuit=dlswCircuit, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswInterface=dlswInterface, LFSize=LFSize, dlswVirtualSegmentLFSize=dlswVirtualSegmentLFSize, dlswDirCache=dlswDirCache, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, MacAddress=MacAddress, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitStat=dlswCircuitStat, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirNBName=dlswDirNBName, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirMacEntry=dlswDirMacEntry, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitState=dlswCircuitState, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirNBIndex=dlswDirNBIndex, dlswResourceMacExclusivity=dlswResourceMacExclusivity, dlswNode=dlswNode, dlswDirMacEntryType=dlswDirMacEntryType, NBName=NBName, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, a3Com=a3Com, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapControl=dlswTrapControl, dlswDirMacMac=dlswDirMacMac, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswStatus=dlswStatus, dlswActiveCircuits=dlswActiveCircuits, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirectory=dlswDirectory, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirMacMask=dlswDirMacMask, DlswTimeStamp=DlswTimeStamp, dlswMIB_3Com=dlswMIB_3Com, dlswSdlc=dlswSdlc, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacTable=dlswDirMacTable, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBLocationType=dlswDirNBLocationType, dlswStdPacingSupport=dlswStdPacingSupport, Instancepointer=Instancepointer, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirNBRowStatus=dlswDirNBRowStatus, TAddress=TAddress, RowStatus=RowStatus, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnStat=dlswTConnStat, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitEntry=dlswCircuitEntry, DlcType=DlcType, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTraps=dlswTraps, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswVersion=dlswVersion, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitTable=dlswCircuitTable, dlswUpTime=dlswUpTime, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswVendorID=dlswVendorID, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitCreates=dlswCircuitCreates, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirMacEntries=dlswDirMacEntries, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirNBTable=dlswDirNBTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, brouterMIB=brouterMIB, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirMacLocation=dlswDirMacLocation, Truthvalue=Truthvalue, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswVersionString=dlswVersionString, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperState=dlswTConnOperState, dlswDirStat=dlswDirStat, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted)
