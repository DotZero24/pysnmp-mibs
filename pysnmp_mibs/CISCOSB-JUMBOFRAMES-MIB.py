...
rlJumboFramesCurrentStatus=_RlJumboFramesCurrentStatus_Object((1,3,6,1,4,1,9,6,1,101,91,1),_RlJumboFramesCurrentStatus_Type())
...
rlJumboFramesStatusAfterReset=_RlJumboFramesStatusAfterReset_Object((1,3,6,1,4,1,9,6,1,101,91,2),_RlJumboFramesStatusAfterReset_Type())
rlJumboFramesStatusAfterReset.setMaxAccess('read-write')
if mibBuilder.loadTexts:rlJumboFramesStatusAfterReset.setStatus(_D)
mibBuilder.exportSymbols('CISCOSB-JUMBOFRAMES-MIB',**{'rlJumboFrames':rlJumboFrames,'rlJumboFramesCurrentStatus':rlJumboFramesCurrentStatus,'rlJumboFramesStatusAfterReset':rlJumboFramesStatusAfterReset})