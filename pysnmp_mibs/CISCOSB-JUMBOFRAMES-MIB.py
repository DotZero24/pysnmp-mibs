...
mibBuilder.exportSymbols("CISCOSB-JUMBOFRAMES-MIB", rlJumboFramesCurrentStatus=rlJumboFramesCurrentStatus, PYSNMP_MODULE_ID=rlJumboFrames, rlJumboFrames=rlJumboFrames, rlJumboFramesStatusAfterReset=rlJumboFramesStatusAfterReset)
