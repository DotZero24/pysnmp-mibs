...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/ENTITY-MIB
...
DisplayString, TDomain, TimeStamp, TruthValue, AutonomousType, TAddress, DateAndTime, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TDomain", "TimeStamp", "TruthValue", "AutonomousType", "TAddress", "DateAndTime", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("ENTITY-MIB", entPhysicalFirmwareRev=entPhysicalFirmwareRev, entAliasMappingIdentifier=entAliasMappingIdentifier, entityLogical2Group=entityLogical2Group, entPhysicalIsFRU=entPhysicalIsFRU, entityPhysical=entityPhysical, entPhysicalHardwareRev=entPhysicalHardwareRev, entLogicalDescr=entLogicalDescr, entLogicalContextEngineID=entLogicalContextEngineID, entityMIBTrapPrefix=entityMIBTrapPrefix, entityGroups=entityGroups, entityPhysicalCRGroup=entityPhysicalCRGroup, entPhysicalSoftwareRev=entPhysicalSoftwareRev, entPhysicalParentRelPos=entPhysicalParentRelPos, entLogicalContextName=entLogicalContextName, entity4Compliance=entity4Compliance, entityMIB=entityMIB, entityMappingGroup=entityMappingGroup, entLogicalTable=entLogicalTable, entityPhysical2Group=entityPhysical2Group, entityCompliance=entityCompliance, entAliasLogicalIndexOrZero=entAliasLogicalIndexOrZero, entityPhysical3Group=entityPhysical3Group, entPhysicalUUID=entPhysicalUUID, entLPMappingEntry=entLPMappingEntry, SnmpEngineIdOrNone=SnmpEngineIdOrNone, entPhysicalContainsEntry=entPhysicalContainsEntry, entityGeneral=entityGeneral, entityConformance=entityConformance, entAliasMappingTable=entAliasMappingTable, entPhysicalTable=entPhysicalTable, entLogicalCommunity=entLogicalCommunity, entLogicalTAddress=entLogicalTAddress, entPhysicalContainsTable=entPhysicalContainsTable, entLPMappingTable=entLPMappingTable, entConfigChange=entConfigChange, PhysicalIndexOrZero=PhysicalIndexOrZero, entPhysicalChildIndex=entPhysicalChildIndex, entityLogicalGroup=entityLogicalGroup, PhysicalIndex=PhysicalIndex, entPhysicalClass=entPhysicalClass, entPhysicalAssetID=entPhysicalAssetID, entPhysicalMfgDate=entPhysicalMfgDate, entPhysicalDescr=entPhysicalDescr, entPhysicalIndex=entPhysicalIndex, entityPhysicalGroup=entityPhysicalGroup, entPhysicalAlias=entPhysicalAlias, entPhysicalEntry=entPhysicalEntry, entPhysicalMfgName=entPhysicalMfgName, entity3Compliance=entity3Compliance, entityCompliances=entityCompliances, entityMIBTraps=entityMIBTraps, entPhysicalSerialNum=entPhysicalSerialNum, entPhysicalVendorType=entPhysicalVendorType, entLogicalTDomain=entLogicalTDomain, entityMIBObjects=entityMIBObjects, entLastChangeTime=entLastChangeTime, entPhysicalUris=entPhysicalUris, PhysicalClass=PhysicalClass, entityPhysical4Group=entityPhysical4Group, entPhysicalModelName=entPhysicalModelName, entLogicalIndex=entLogicalIndex, entity4CRCompliance=entity4CRCompliance, entityMapping=entityMapping, entity2Compliance=entity2Compliance, entityLogical=entityLogical, entPhysicalContainedIn=entPhysicalContainedIn, entLogicalEntry=entLogicalEntry, entLogicalType=entLogicalType, PYSNMP_MODULE_ID=entityMIB, entPhysicalName=entPhysicalName, entLPPhysicalIndex=entLPPhysicalIndex, entityNotificationsGroup=entityNotificationsGroup, entAliasMappingEntry=entAliasMappingEntry, entityGeneralGroup=entityGeneralGroup)
