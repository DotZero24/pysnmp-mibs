...
TDomain, TAddress, DateAndTime, TextualConvention, RowPointer, TruthValue, AutonomousType, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TDomain", "TAddress", "DateAndTime", "TextualConvention", "RowPointer", "TruthValue", "AutonomousType", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("ENTITY-MIB", entAliasMappingTable=entAliasMappingTable, entLogicalContextEngineID=entLogicalContextEngineID, entityMIBTrapPrefix=entityMIBTrapPrefix, entPhysicalVendorType=entPhysicalVendorType, entPhysicalSerialNum=entPhysicalSerialNum, entity2Compliance=entity2Compliance, entPhysicalIndex=entPhysicalIndex, entAliasMappingIdentifier=entAliasMappingIdentifier, entityMIB=entityMIB, entityMIBTraps=entityMIBTraps, entityPhysical4Group=entityPhysical4Group, entPhysicalUUID=entPhysicalUUID, entPhysicalName=entPhysicalName, entPhysicalAssetID=entPhysicalAssetID, entityNotificationsGroup=entityNotificationsGroup, entLPMappingTable=entLPMappingTable, entLPMappingEntry=entLPMappingEntry, entAliasLogicalIndexOrZero=entAliasLogicalIndexOrZero, entityGroups=entityGroups, entPhysicalParentRelPos=entPhysicalParentRelPos, entPhysicalContainsEntry=entPhysicalContainsEntry, entPhysicalIsFRU=entPhysicalIsFRU, entPhysicalDescr=entPhysicalDescr, entPhysicalTable=entPhysicalTable, entLogicalTable=entLogicalTable, entityPhysical=entityPhysical, entPhysicalModelName=entPhysicalModelName, entLogicalIndex=entLogicalIndex, entConfigChange=entConfigChange, entityMappingGroup=entityMappingGroup, entLogicalContextName=entLogicalContextName, entLogicalEntry=entLogicalEntry, entityLogical2Group=entityLogical2Group, entPhysicalClass=entPhysicalClass, entPhysicalContainedIn=entPhysicalContainedIn, PhysicalClass=PhysicalClass, entLogicalCommunity=entLogicalCommunity, PhysicalIndexOrZero=PhysicalIndexOrZero, entPhysicalMfgName=entPhysicalMfgName, entLogicalDescr=entLogicalDescr, entLogicalType=entLogicalType, entityLogical=entityLogical, entityPhysical3Group=entityPhysical3Group, entityPhysicalCRGroup=entityPhysicalCRGroup, entPhysicalHardwareRev=entPhysicalHardwareRev, entPhysicalMfgDate=entPhysicalMfgDate, entLogicalTDomain=entLogicalTDomain, entityPhysical2Group=entityPhysical2Group, PhysicalIndex=PhysicalIndex, entLPPhysicalIndex=entLPPhysicalIndex, entPhysicalContainsTable=entPhysicalContainsTable, entityGeneralGroup=entityGeneralGroup, entPhysicalEntry=entPhysicalEntry, entPhysicalAlias=entPhysicalAlias, entity4Compliance=entity4Compliance, entityLogicalGroup=entityLogicalGroup, entityMapping=entityMapping, entPhysicalChildIndex=entPhysicalChildIndex, entityPhysicalGroup=entityPhysicalGroup, entLastChangeTime=entLastChangeTime, entityConformance=entityConformance, entityMIBObjects=entityMIBObjects, entPhysicalUris=entPhysicalUris, entityCompliances=entityCompliances, entity3Compliance=entity3Compliance, PYSNMP_MODULE_ID=entityMIB, entLogicalTAddress=entLogicalTAddress, entityCompliance=entityCompliance, entPhysicalFirmwareRev=entPhysicalFirmwareRev, entPhysicalSoftwareRev=entPhysicalSoftwareRev, entAliasMappingEntry=entAliasMappingEntry, entityGeneral=entityGeneral, SnmpEngineIdOrNone=SnmpEngineIdOrNone, entity4CRCompliance=entity4CRCompliance)
