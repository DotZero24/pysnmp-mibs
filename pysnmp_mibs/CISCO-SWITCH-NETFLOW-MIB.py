...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SWITCH-NETFLOW-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:36:15 2025
...
csnMIBCompliance.setObjects(
      *(("CISCO-SWITCH-NETFLOW-MIB", "csnGlobalGroup"),
        ("CISCO-SWITCH-NETFLOW-MIB", "csnUsageThreshNotifControlGroup"),
        ("CISCO-SWITCH-NETFLOW-MIB", "csnUsageThreshGroup"),
        ("CISCO-SWITCH-NETFLOW-MIB", "csnUtilizationGroup"),
        ("CISCO-SWITCH-NETFLOW-MIB", "csnUsageThreshNotifGroup"),
        ("CISCO-SWITCH-NETFLOW-MIB", "csnNetflowTableSizeGroup"),
        ("CISCO-SWITCH-NETFLOW-MIB", "csnSamplerGroup"))
)
if mibBuilder.loadTexts:
