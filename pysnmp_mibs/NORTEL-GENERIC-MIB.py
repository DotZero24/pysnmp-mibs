...
mibBuilder.exportSymbols("NORTEL-GENERIC-MIB", PYSNMP_MODULE_ID=nortelGenericMIBs, nortelNetworkManagementInterfaceMIBs=nortelNetworkManagementInterfaceMIBs, nortelGenericMIBs=nortelGenericMIBs)
