...
# Notes
# -----
# ASN.1 source file://mibs/rfc/ISNS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:22:14 2025
...
_IsnsServerEnableControlNodeMgtScn_Type.__name__ = "TruthValue"
...
isnsIscsiServerCompliance.setObjects(
      *(("ISNS-MIB", "isnsServerAttributesGroup"),
        ("ISNS-MIB", "isnsServerIscsiControlNodeGroup"),
        ("ISNS-MIB", "isnsServerIscsiDdsDdObjGroup"),
        ("ISNS-MIB", "isnsServerRegIscsiObjGroup"),
        ("ISNS-MIB", "isnsServerNumObjectsGroup"),
        ("ISNS-MIB", "isnsNotificationsObjGroup"),
        ("ISNS-MIB", "isnsServerNotificationGroup"))
)
if mibBuilder.loadTexts:
...
isnsIfcpServerCompliance.setObjects(
      *(("ISNS-MIB", "isnsServerAttributesGroup"),
        ("ISNS-MIB", "isnsServerIfcpPortControlNodeGroup"),
        ("ISNS-MIB", "isnsServerIfcpDdsDdObjGroup"),
