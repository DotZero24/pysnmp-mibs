...
sslGeneralGroup=_SslGeneralGroup_ObjectIdentity((1,3,6,1,4,1,10876,101,1,96,1))
class _SslSecureHttpStatus_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_E,1),(_F,2)))
_SslSecureHttpStatus_Type.__name__=_C
_SslSecureHttpStatus_Object=MibScalar
sslSecureHttpStatus=_SslSecureHttpStatus_Object((1,3,6,1,4,1,10876,101,1,96,1,2),_SslSecureHttpStatus_Type())
...
sslPort=_SslPort_Object((1,3,6,1,4,1,10876,101,1,96,1,3),_SslPort_Type())
sslPort.setMaxAccess(_A)
if mibBuilder.loadTexts:sslPort.setStatus(_B)
_SslTrace_Type=Integer32
_SslTrace_Object=MibScalar
sslTrace=_SslTrace_Object((1,3,6,1,4,1,10876,101,1,96,1,4),_SslTrace_Type())
...
sslVersion=_SslVersion_Object((1,3,6,1,4,1,10876,101,1,96,1,5),_SslVersion_Type())
sslVersion.setMaxAccess(_A)
if mibBuilder.loadTexts:sslVersion.setStatus(_B)
class _SslRestconfStatus_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_E,1),(_F,2)))
_SslRestconfStatus_Type.__name__=_C
_SslRestconfStatus_Object=MibScalar
sslRestconfStatus=_SslRestconfStatus_Object((1,3,6,1,4,1,10876,101,1,96,1,6),_SslRestconfStatus_Type())
sslRestconfStatus.setMaxAccess(_A)
if mibBuilder.loadTexts:sslRestconfStatus.setStatus(_B)
_SslCiphers_ObjectIdentity=ObjectIdentity
sslCiphers=_SslCiphers_ObjectIdentity((1,3,6,1,4,1,10876,101,1,96,2))
class _SslCipherList_Type(Integer32):defaultValue=76
_SslCipherList_Type.__name__=_C
_SslCipherList_Object=MibScalar
sslCipherList=_SslCipherList_Object((1,3,6,1,4,1,10876,101,1,96,2,1),_SslCipherList_Type())
...
sslDefaultCipherList=_SslDefaultCipherList_Object((1,3,6,1,4,1,10876,101,1,96,2,2),_SslDefaultCipherList_Type())
sslDefaultCipherList.setMaxAccess(_A)
if mibBuilder.loadTexts:sslDefaultCipherList.setStatus(_B)
mibBuilder.exportSymbols('SUPERMICRO-SSL-MIB',**{'ssl':ssl,'sslGeneralGroup':sslGeneralGroup,'sslSecureHttpStatus':sslSecureHttpStatus,'sslPort':sslPort,'sslTrace':sslTrace,'sslVersion':sslVersion,'sslRestconfStatus':sslRestconfStatus,'sslCiphers':sslCiphers,'sslCipherList':sslCipherList,'sslDefaultCipherList':sslDefaultCipherList})