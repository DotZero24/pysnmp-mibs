...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CABLE-DSG-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:25:25 2025
...
ccdsgIfBasicCompliance.setObjects(
      *(("CISCO-CABLE-DSG-IF-MIB", "ccdsgIfCaVendorGroup"),
        ("CISCO-CABLE-DSG-IF-MIB", "ccdsgIfTunnelGroup"),
        ("CISCO-CABLE-DSG-IF-MIB", "ccdsgIfDownstreamGroup"))
)
if mibBuilder.loadTexts:
