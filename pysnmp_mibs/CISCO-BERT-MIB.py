...
mibBuilder.exportSymbols("CISCO-BERT-MIB", BertPatterns=BertPatterns, cbOperStatus=cbOperStatus, cbBertTxPatternInv=cbBertTxPatternInv, cbUserPattern=cbUserPattern, cbSingleBitErrorInsert=cbSingleBitErrorInsert, cbDuration=cbDuration, cbDS0DPCodeIteration=cbDS0DPCodeIteration, cbHCRxBitErrCounts=cbHCRxBitErrCounts, cbESsCounts=cbESsCounts, ciscoBertLoopbackGroup=ciscoBertLoopbackGroup, ciscoBertConfigGroup=ciscoBertConfigGroup, cbRowStatus=cbRowStatus, cbLoopbackCode=cbLoopbackCode, cbStartDateAndTime=cbStartDateAndTime, ciscoBertMIBConformance=ciscoBertMIBConformance, cbStatsTable=cbStatsTable, PYSNMP_MODULE_ID=ciscoBertMIB, cbPatternLossCounts=cbPatternLossCounts, cbFailedReason=cbFailedReason, cbTxBitCountLower=cbTxBitCountLower, cbEFSsCounts=cbEFSsCounts, cbHCRxBitCounts=cbHCRxBitCounts, ciscoBertStatsGroup=ciscoBertStatsGroup, ciscoBertMIB=ciscoBertMIB, ciscoBertConfigGroupDs1=ciscoBertConfigGroupDs1, cbConfTable=cbConfTable, ciscoBertConfig=ciscoBertConfig, cbTxBitCountUpper=cbTxBitCountUpper, cbRxBitCountLower=cbRxBitCountLower, cbDs0BitMap=cbDs0BitMap, cbRxBitCountUpper=cbRxBitCountUpper, cbRxBitErrCountUpper=cbRxBitErrCountUpper, cbErrorInjectCounts=cbErrorInjectCounts, cbConfEntry=cbConfEntry, cbStatsEntry=cbStatsEntry, cbSESsCounts=cbSESsCounts, ciscoBertMIBGroups=ciscoBertMIBGroups, cbTestPattern=cbTestPattern, cbBertRxPatternInv=cbBertRxPatternInv, ciscoBertMIBCompliance=ciscoBertMIBCompliance, cbErrorInsertionRate=cbErrorInsertionRate, ciscoBertHCStatsGroup=ciscoBertHCStatsGroup, ciscoBertMIBObjects=ciscoBertMIBObjects, cbRxBitErrCountLower=cbRxBitErrCountLower, cbHCTxBitCounts=cbHCTxBitCounts, cbSyncLossCounts=cbSyncLossCounts, ciscoBertMIBCompliances=ciscoBertMIBCompliances, cbFrameLossCounts=cbFrameLossCounts, cbLoopback=cbLoopback)
