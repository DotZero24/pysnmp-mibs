...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-BERT-MIB
...
ciscoBertMIBCompliance.setObjects(
      *(("CISCO-BERT-MIB", "ciscoBertConfigGroup"),
        ("CISCO-BERT-MIB", "ciscoBertStatsGroup"),
        ("CISCO-BERT-MIB", "ciscoBertHCStatsGroup"),
        ("CISCO-BERT-MIB", "ciscoBertLoopbackGroup"),
        ("CISCO-BERT-MIB", "ciscoBertConfigGroupDs1"))
)
if mibBuilder.loadTexts:
