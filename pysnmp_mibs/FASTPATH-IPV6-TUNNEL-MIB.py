# SNMP MIB module (FASTPATH-IPV6-TUNNEL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-IPV6-TUNNEL-MIB
...
agentTunnelIPV6Entry.setIndexNames(
    (0, "FASTPATH-IPV6-TUNNEL-MIB", "agentTunnelID"),
)
if mibBuilder.loadTexts:
...
agentTunnelIPV6PrefixEntry.setIndexNames(
    (0, "FASTPATH-IPV6-TUNNEL-MIB", "agentTunnelID"),
    (0, "FASTPATH-IPV6-TUNNEL-MIB", "agentTunnelIPV6PrefixPrefix"),
    (0, "FASTPATH-IPV6-TUNNEL-MIB", "agentTunnelIPV6PrefixPrefixLen"),
)
if mibBuilder.loadTexts:
