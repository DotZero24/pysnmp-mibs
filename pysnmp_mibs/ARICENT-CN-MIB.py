...
fsCnMaster=_FsCnMaster_ObjectIdentity((1,3,6,1,4,1,29601,2,47,1))
...
fsCnSystemControl=_FsCnSystemControl_Object((1,3,6,1,4,1,29601,2,47,1,1),_FsCnSystemControl_Type())
...
fsCnGlobalEnableTrap=_FsCnGlobalEnableTrap_Object((1,3,6,1,4,1,29601,2,47,1,2),_FsCnGlobalEnableTrap_Type())
...
fsCnComponent=_FsCnComponent_ObjectIdentity((1,3,6,1,4,1,29601,2,47,2))
_FsCnXGlobalTable_Object=MibTable
fsCnXGlobalTable=_FsCnXGlobalTable_Object((1,3,6,1,4,1,29601,2,47,2,1))
if mibBuilder.loadTexts:fsCnXGlobalTable.setStatus(_A)
_FsCnXGlobalEntry_Object=MibTableRow
fsCnXGlobalEntry=_FsCnXGlobalEntry_Object((1,3,6,1,4,1,29601,2,47,2,1,1))
...
fsCnXGlobalTraceLevel=_FsCnXGlobalTraceLevel_Object((1,3,6,1,4,1,29601,2,47,2,1,1,1),_FsCnXGlobalTraceLevel_Type())
...
fsCnXGlobalClearCounters=_FsCnXGlobalClearCounters_Object((1,3,6,1,4,1,29601,2,47,2,1,1,2),_FsCnXGlobalClearCounters_Type())
...
fsCnXGlobalTLVErrors=_FsCnXGlobalTLVErrors_Object((1,3,6,1,4,1,29601,2,47,2,1,1,3),_FsCnXGlobalTLVErrors_Type())
...
fsCnPortPriority=_FsCnPortPriority_ObjectIdentity((1,3,6,1,4,1,29601,2,47,3))
_FsCnXPortPriTable_Object=MibTable
fsCnXPortPriTable=_FsCnXPortPriTable_Object((1,3,6,1,4,1,29601,2,47,3,1))
if mibBuilder.loadTexts:fsCnXPortPriTable.setStatus(_A)
_FsCnXPortPriEntry_Object=MibTableRow
fsCnXPortPriEntry=_FsCnXPortPriEntry_Object((1,3,6,1,4,1,29601,2,47,3,1,1))
...
fsCnXPortPriClearCpCounters=_FsCnXPortPriClearCpCounters_Object((1,3,6,1,4,1,29601,2,47,3,1,1,1),_FsCnXPortPriClearCpCounters_Type())
...
fsCnXPortPriErrorEntry=_FsCnXPortPriErrorEntry_Object((1,3,6,1,4,1,29601,2,47,3,1,1,2),_FsCnXPortPriErrorEntry_Type())
...
fsCnXPortPriOperDefMode=_FsCnXPortPriOperDefMode_Object((1,3,6,1,4,1,29601,2,47,3,1,1,3),_FsCnXPortPriOperDefMode_Type())
...
fsCnXPortPriOperAltPri=_FsCnXPortPriOperAltPri_Object((1,3,6,1,4,1,29601,2,47,3,1,1,4),_FsCnXPortPriOperAltPri_Type())
...
fsCnXPortPriLastRcvdEvent=_FsCnXPortPriLastRcvdEvent_Object((1,3,6,1,4,1,29601,2,47,3,1,1,5),_FsCnXPortPriLastRcvdEvent_Type())
...
fsCnXPortPriLastRcvdEventTime=_FsCnXPortPriLastRcvdEventTime_Object((1,3,6,1,4,1,29601,2,47,3,1,1,6),_FsCnXPortPriLastRcvdEventTime_Type())
...
fsCnXPortPriLastSentEvent=_FsCnXPortPriLastSentEvent_Object((1,3,6,1,4,1,29601,2,47,3,1,1,7),_FsCnXPortPriLastSentEvent_Type())
...
fsCnXPortPriLastSentEventTime=_FsCnXPortPriLastSentEventTime_Object((1,3,6,1,4,1,29601,2,47,3,1,1,8),_FsCnXPortPriLastSentEventTime_Type())
...
fsCnNotifications=_FsCnNotifications_ObjectIdentity((1,3,6,1,4,1,29601,2,47,4))
_FsCnTraps_ObjectIdentity=ObjectIdentity
fsCnTraps=_FsCnTraps_ObjectIdentity((1,3,6,1,4,1,29601,2,47,4,0))
_FsCnCnmQOffset_Type=Integer32
_FsCnCnmQOffset_Object=MibScalar
fsCnCnmQOffset=_FsCnCnmQOffset_Object((1,3,6,1,4,1,29601,2,47,4,1),_FsCnCnmQOffset_Type())
...
fsCnCnmQDelta=_FsCnCnmQDelta_Object((1,3,6,1,4,1,29601,2,47,4,2),_FsCnCnmQDelta_Type())
...
fsCnEpEntryTrap=NotificationType((1,3,6,1,4,1,29601,2,47,4,0,1))
fsCnEpEntryTrap.setObjects((_C,_L))
if mibBuilder.loadTexts:fsCnEpEntryTrap.setStatus(_A)
fsCnCNMTrap=NotificationType((1,3,6,1,4,1,29601,2,47,4,0,2))
