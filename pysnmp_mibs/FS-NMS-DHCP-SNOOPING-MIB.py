# SNMP MIB module (FS-NMS-DHCP-SNOOPING-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/fscom/FS-NMS-DHCP-SNOOPING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:15:40 2025
...
nmsipsourceBindingsEntry = _NmsipsourceBindingsEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 2, 233, 3, 1)
)
nmsipsourceBindingsEntry.setIndexNames(
    (0, "FS-NMS-DHCP-SNOOPING-MIB", "nmsipsourceBindingsIpAddress"),
)
if mibBuilder.loadTexts:
