...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-SYSTEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:56:54 2025
...
if mibBuilder.loadTexts:
    tmnxSysFpResAllocG8032Sap.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSysFpResAllocOperG8032Sap.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSysMgmtIfMDCliCmdAccntLoad.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSysFpoMacFltOutVlanPrioAdmSt.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSysFpoMacFltOutVlanPrioOprSt.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSysRmtMgmtHelloInterval.setStatus("current")
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    tmnxSysMgmtIfMdCliCmdAccntGroup.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSysFpResAllocV20v0Group.setStatus("current")
...
tmnxSysV20v0Compliance.setObjects(
      *(("TIMETRA-SYSTEM-MIB", "tmnxSysNotificationV20v0Group"),
        ...
        ("TIMETRA-SYSTEM-MIB", "tmnxSysFpResAllocV20v0Group"),
