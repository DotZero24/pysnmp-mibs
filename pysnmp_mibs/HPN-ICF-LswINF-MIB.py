...
mibBuilder.exportSymbols("HPN-ICF-LswINF-MIB", hpnicfifPortProtocolStatEntry=hpnicfifPortProtocolStatEntry, hpnicfifAggregatePortListPorts=hpnicfifAggregatePortListPorts, hpnicfifVLANType=hpnicfifVLANType, hpnicfifMulSuppression=hpnicfifMulSuppression, hpnicfifVlanVPNUplinkStatus=hpnicfifVlanVPNUplinkStatus, hpnicfifAggregatePortName=hpnicfifAggregatePortName, hpnicfifInPayloadOctets=hpnicfifInPayloadOctets, hpnicfMaxMacLearnRange=hpnicfMaxMacLearnRange, hpnicfifVLANTrunkAllowListHigh=hpnicfifVLANTrunkAllowListHigh, hpnicfifUniSuppression=hpnicfifUniSuppression, hpnicfifIPv4OutMultiPkts=hpnicfifIPv4OutMultiPkts, hpnicfifPpsBcastDisValControl=hpnicfifPpsBcastDisValControl, DropDirection=DropDirection, hpnicfifIPv4OutDiscards=hpnicfifIPv4OutDiscards, hpnicfVlanVPNTPID=hpnicfVlanVPNTPID, hpnicfifEthernetMdi=hpnicfifEthernetMdi, hpnicfifIPv4OutBroadcastPkts=hpnicfifIPv4OutBroadcastPkts, hpnicfifPktBufInit=hpnicfifPktBufInit, hpnicfifIPv6InUcastPkts=hpnicfifIPv6InUcastPkts, VlanIndex=VlanIndex, hpnicfifIPv4InDiscards=hpnicfifIPv4InDiscards, hpnicfifUnknownPacketDropUni=hpnicfifUnknownPacketDropUni, hpnicfifEthernetMTU=hpnicfifEthernetMTU, hpnicfifPktBufMin=hpnicfifPktBufMin, hpnicfifMcastControl=hpnicfifMcastControl, hpnicfifBKbpsMulSuppression=hpnicfifBKbpsMulSuppression, hpnicfifMulSuppressionStep=hpnicfifMulSuppressionStep, hpnicfPortIsolateGroupTable=hpnicfPortIsolateGroupTable, PortList=PortList, hpnicfifEthernetAutoSpeed=hpnicfifEthernetAutoSpeed, hpnicfVlanVPNTPIDMode=hpnicfVlanVPNTPIDMode, hpnicfifBKbpsMulSuppressionMax=hpnicfifBKbpsMulSuppressionMax, hpnicfifEthernetDuplex=hpnicfifEthernetDuplex, hpnicfLswL2InfMibObject=hpnicfLswL2InfMibObject, hpnicfifBMbpsUniSuppressionMax=hpnicfifBMbpsUniSuppressionMax, hpnicfLswExtInterface=hpnicfLswExtInterface, hpnicfethernetEntry=hpnicfethernetEntry, hpnicfifIPv6InAnycastPkts=hpnicfifIPv6InAnycastPkts, hpnicfLswL2InfMib=hpnicfLswL2InfMib, hpnicfSwitchPortMax=hpnicfSwitchPortMax, hpnicfifVLANTrunkPassListHigh=hpnicfifVLANTrunkPassListHigh, hpnicfifIPv4OutErrors=hpnicfifIPv4OutErrors, hpnicfifBKbpsUniSuppressionMax=hpnicfifBKbpsUniSuppressionMax, hpnicfifHybridUnTaggedVlanListLow=hpnicfifHybridUnTaggedVlanListLow, hpnicfifAggregateEntry=hpnicfifAggregateEntry, hpnicfifHybridTaggedVlanListHigh=hpnicfifHybridTaggedVlanListHigh, hpnicfifIPv6InErrors=hpnicfifIPv6InErrors, hpnicfifComboPortTable=hpnicfifComboPortTable, hpnicfGlobalBroadcastMaxPps=hpnicfGlobalBroadcastMaxPps, hpnicfifIPv6OutMultiPkts=hpnicfifIPv6OutMultiPkts, hpnicfifBKbpsUniSuppression=hpnicfifBKbpsUniSuppression, hpnicfifHybridTaggedVlanListLow=hpnicfifHybridTaggedVlanListLow, hpnicfifAggregateOperStatus=hpnicfifAggregateOperStatus, hpnicfIsolateGroupMax=hpnicfIsolateGroupMax, hpnicfifAggregateModel=hpnicfifAggregateModel, hpnicfifIPv4InErrors=hpnicfifIPv4InErrors, hpnicfifComboPortIndex=hpnicfifComboPortIndex, hpnicfifIPv6InDiscards=hpnicfifIPv6InDiscards, hpnicfifVLANTrunkIndex=hpnicfifVLANTrunkIndex, hpnicfifBMbpsMulSuppression=hpnicfifBMbpsMulSuppression, hpnicfPortIsolateGroupDescription=hpnicfPortIsolateGroupDescription, hpnicfifFlowControl=hpnicfifFlowControl, hpnicfifUnBoundPort=hpnicfifUnBoundPort, hpnicfifSrcMacControl=hpnicfifSrcMacControl, hpnicfifPktBufFree=hpnicfifPktBufFree, hpnicfifISPhyPort=hpnicfifISPhyPort, hpnicfifIPv6OutDiscards=hpnicfifIPv6OutDiscards, hpnicfifClearStat=hpnicfifClearStat, hpnicfGlobalBroadcastMaxRatio=hpnicfGlobalBroadcastMaxRatio, hpnicfifHybridUnTaggedVlanListHigh=hpnicfifHybridUnTaggedVlanListHigh, hpnicfifPpsMulSuppression=hpnicfifPpsMulSuppression, hpnicfifComboPortEntry=hpnicfifComboPortEntry, hpnicfethernetTable=hpnicfethernetTable, hpnicfifHybridPortIndex=hpnicfifHybridPortIndex, hpnicfifIPv6OutAnycastPkts=hpnicfifIPv6OutAnycastPkts, hpnicfifEthernetSpeed=hpnicfifEthernetSpeed, hpnicfifVlanVPNTPID=hpnicfifVlanVPNTPID, hpnicfPortIsolateGroupRowStatus=hpnicfPortIsolateGroupRowStatus, SpeedModeFlag=SpeedModeFlag, hpnicfifComboPortCurActive=hpnicfifComboPortCurActive, hpnicfifIPv4InOctets=hpnicfifIPv4InOctets, hpnicfifInNormalPkts=hpnicfifInNormalPkts, hpnicfifUnknownPacketDropMul=hpnicfifUnknownPacketDropMul, hpnicfifVlanVPNStatus=hpnicfifVlanVPNStatus, hpnicfSlotPortMax=hpnicfSlotPortMax, hpnicfifOutPayloadOctets=hpnicfifOutPayloadOctets, hpnicfifBKbpsMulSuppressionStep=hpnicfifBKbpsMulSuppressionStep, hpnicfifAggregatePortIndex=hpnicfifAggregatePortIndex, hpnicfifBMbpsUniSuppression=hpnicfifBMbpsUniSuppression, hpnicfifEthernetAutoSpeedMask=hpnicfifEthernetAutoSpeedMask, hpnicfifIPv4OutUcastPkts=hpnicfifIPv4OutUcastPkts, hpnicfifXXTable=hpnicfifXXTable, hpnicfifAggregatePort=hpnicfifAggregatePort, hpnicfifHybridPortTable=hpnicfifHybridPortTable, hpnicfifIPv6InMultiPkts=hpnicfifIPv6InMultiPkts, hpnicfPortIsolateGroupEntry=hpnicfPortIsolateGroupEntry, hpnicfifVLANTrunkStatusTable=hpnicfifVLANTrunkStatusTable, hpnicfifPktBufTable=hpnicfifPktBufTable, hpnicfPortIsolateUplinkIfIndex=hpnicfPortIsolateUplinkIfIndex, hpnicfifIPv6InOctets=hpnicfifIPv6InOctets, hpnicfifisUplinkPort=hpnicfifisUplinkPort, hpnicfifXXBasePortIndex=hpnicfifXXBasePortIndex, hpnicfifXXEntry=hpnicfifXXEntry, hpnicfMaxMacLearn=hpnicfMaxMacLearn, hpnicfifEthernetTest=hpnicfifEthernetTest, hpnicfifComboActivePort=hpnicfifComboActivePort, hpnicfifEthernetFlowInterval=hpnicfifEthernetFlowInterval, hpnicfifVLANTrunkAllowListLow=hpnicfifVLANTrunkAllowListLow, hpnicfifAggregateTable=hpnicfifAggregateTable, hpnicfifPpsUniSuppressionMax=hpnicfifPpsUniSuppressionMax, hpnicfifIPv6OutOctets=hpnicfifIPv6OutOctets, hpnicfifPktBufMiss=hpnicfifPktBufMiss, hpnicfifOutPkts=hpnicfifOutPkts, hpnicfifPktBufEntry=hpnicfifPktBufEntry, hpnicfPortIsolateGroupIndex=hpnicfPortIsolateGroupIndex, hpnicfifVLANTrunkPassListLow=hpnicfifVLANTrunkPassListLow, hpnicfBpduTunnelStatus=hpnicfBpduTunnelStatus, hpnicfifIPv6OutErrors=hpnicfifIPv6OutErrors, hpnicfifInErrorPktsRate=hpnicfifInErrorPktsRate, hpnicfifIPv4InMultiPkts=hpnicfifIPv4InMultiPkts, hpnicfifIPv4InBroadcastPkts=hpnicfifIPv4InBroadcastPkts, hpnicfifBKbpsUniSuppressionStep=hpnicfifBKbpsUniSuppressionStep, hpnicfifIPv4OutOctets=hpnicfifIPv4OutOctets, hpnicfifIsolateGroupID=hpnicfifIsolateGroupID, hpnicfifPpsMcastControl=hpnicfifPpsMcastControl, hpnicfifBMbpsMulSuppressionMax=hpnicfifBMbpsMulSuppressionMax, hpnicfifPpsMulSuppressionMax=hpnicfifPpsMulSuppressionMax, hpnicfifXXDevPortIndex=hpnicfifXXDevPortIndex, hpnicfifMacAddressLearn=hpnicfifMacAddressLearn, hpnicfifUniSuppressionStep=hpnicfifUniSuppressionStep, hpnicfifHybridPortEntry=hpnicfifHybridPortEntry, hpnicfifMirrorPort=hpnicfifMirrorPort, hpnicfifPpsUniSuppression=hpnicfifPpsUniSuppression, hpnicfifIPv4InUcastPkts=hpnicfifIPv4InUcastPkts, hpnicfifEthernetIsolate=hpnicfifEthernetIsolate, hpnicfifMacAddrLearnMode=hpnicfifMacAddrLearnMode, hpnicfifVLANTrunkGvrpRegistration=hpnicfifVLANTrunkGvrpRegistration, PYSNMP_MODULE_ID=hpnicfLswL2InfMib, hpnicfifInPkts=hpnicfifInPkts, hpnicfifVLANTrunkStatusEntry=hpnicfifVLANTrunkStatusEntry, hpnicfifPortProtocolStatTable=hpnicfifPortProtocolStatTable, hpnicfifIPv6OutUcastPkts=hpnicfifIPv6OutUcastPkts)
