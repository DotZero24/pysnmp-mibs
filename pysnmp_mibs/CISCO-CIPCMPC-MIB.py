...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CIPCMPC-MIB
...
ciscoCipCmpcMibCompliance.setObjects(
      *(("CISCO-CIPCMPC-MIB", "ciscoCipCmpcSubChannelGroup"),
        ("CISCO-CIPCMPC-MIB", "ciscoCipCmpcTgGroup"))
)
if mibBuilder.loadTexts:
