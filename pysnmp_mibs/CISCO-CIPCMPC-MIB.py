...
DisplayString, TDomain, TimeStamp, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TDomain", "TimeStamp", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-CIPCMPC-MIB", cipCmpcTgOperExpectedReceiveSeqNum=cipCmpcTgOperExpectedReceiveSeqNum, ciscoCipCmpcMibCompliances=ciscoCipCmpcMibCompliances, ciscoCipCmpcTgGroup=ciscoCipCmpcTgGroup, cipCmpcSubChannelOperEntry=cipCmpcSubChannelOperEntry, cipCmpcTgStatsEntry=cipCmpcTgStatsEntry, cipCmpcNotifications=cipCmpcNotifications, cipCmpcTgOperTable=cipCmpcTgOperTable, cipCmpcTgStatsConnectRsps=cipCmpcTgStatsConnectRsps, cipCmpcTgStatsConnectCnfms=cipCmpcTgStatsConnectCnfms, cipCmpcTgStatsDiscInds=cipCmpcTgStatsDiscInds, cipCmpcSeqNumError=cipCmpcSeqNumError, ciscoCipCmpcMibCompliance=ciscoCipCmpcMibCompliance, cipCmpcTgStatsConnectInds=cipCmpcTgStatsConnectInds, cipCmpcTgOperLastSeqNumSent=cipCmpcTgOperLastSeqNumSent, cipCmpcSubChannelOperState=cipCmpcSubChannelOperState, cipCmpcObjects=cipCmpcObjects, cipCmpcDirectionMismatch=cipCmpcDirectionMismatch, ciscoCipCmpcMibGroups=ciscoCipCmpcMibGroups, cipCmpcTg=cipCmpcTg, cipCmpcSubChannelAdminDirection=cipCmpcSubChannelAdminDirection, cipCmpcSubChannelOperMaxbfru=cipCmpcSubChannelOperMaxbfru, cipCmpcTgStatsConnectReqs=cipCmpcTgStatsConnectReqs, cipCmpcTgStatsSweepRspsIn=cipCmpcTgStatsSweepRspsIn, cipCmpcTgStatsWraps=cipCmpcTgStatsWraps, cipCmpcSubChannelAdminTgName=cipCmpcSubChannelAdminTgName, cipCmpcTgStatsTable=cipCmpcTgStatsTable, cipCmpcSubChannelAdminRowStatus=cipCmpcSubChannelAdminRowStatus, ciscoCipCmpcMibConformance=ciscoCipCmpcMibConformance, cipCmpcTgStatsSweepRspsOut=cipCmpcTgStatsSweepRspsOut, cipCmpcTgOperName=cipCmpcTgOperName, cipCmpcTgOperLastSeqNumFailureTime=cipCmpcTgOperLastSeqNumFailureTime, cipCmpcTgStatsSweepReqsOut=cipCmpcTgStatsSweepReqsOut, ciscoCipCmpcSubChannelGroup=ciscoCipCmpcSubChannelGroup, ciscoCipCmpcMIB=ciscoCipCmpcMIB, cipCmpcSubChannelAdminTgTransport=cipCmpcSubChannelAdminTgTransport, cipCmpcTgOperLastSeqNumReceived=cipCmpcTgOperLastSeqNumReceived, cipCmpcSubChannelAdminDevice=cipCmpcSubChannelAdminDevice, cipCmpcTgStatsDiscReqs=cipCmpcTgStatsDiscReqs, PYSNMP_MODULE_ID=ciscoCipCmpcMIB, cipCmpcSubChannelAdminTable=cipCmpcSubChannelAdminTable, cipCmpcSubChannelAdminEntry=cipCmpcSubChannelAdminEntry, cipCmpcTgStatsSweepReqsIn=cipCmpcTgStatsSweepReqsIn, cipCmpcTgOperEntry=cipCmpcTgOperEntry, cipCmpcTgOperLastSeqNumFailureCause=cipCmpcTgOperLastSeqNumFailureCause, cipCmpcSubChannelAdminPath=cipCmpcSubChannelAdminPath, cipCmpcNotificationPrefix=cipCmpcNotificationPrefix, cipCmpcSubChannel=cipCmpcSubChannel, cipCmpcSubChannelOperTable=cipCmpcSubChannelOperTable)
