...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACLateCts=fddimibMACLateCts, fddimibPATHTable=fddimibPATHTable, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMAC=fddimibMAC, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPORTEntry=fddimibPORTEntry, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTEntry=fddimibSMTEntry, fddimibMACTReq=fddimibMACTReq, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTTable=fddimibPORTTable, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTTable=fddimibSMTTable, fddimibMACCounters=fddimibMACCounters, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPATHEntry=fddimibPATHEntry, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTStationId=fddimibSMTStationId, fddimibSMT=fddimibSMT, fddimibPORTNumber=fddimibPORTNumber, fddimibMACIndex=fddimibMACIndex, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddi=fddi, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACTable=fddimibMACTable, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTLemCts=fddimibPORTLemCts, fddimib=fddimib, fddimibPATH=fddimibPATH, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTAction=fddimibPORTAction, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTIndex=fddimibSMTIndex, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibSMTCFState=fddimibSMTCFState, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACCountersTable=fddimibMACCountersTable, FddiTimeNano=FddiTimeNano, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACTNeg=fddimibMACTNeg, fddimibPATHNumber=fddimibPATHNumber, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibSMTUserData=fddimibSMTUserData, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACLostCts=fddimibMACLostCts, fddimibMACTMaxCapability=fddimibMACTMaxCapability, FddiResourceId=FddiResourceId, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPATHIndex=fddimibPATHIndex, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORT=fddimibPORT, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACEntry=fddimibMACEntry, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACNumber=fddimibMACNumber, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACTMax=fddimibMACTMax, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, FddiTimeMilli=FddiTimeMilli, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTMasterCts=fddimibSMTMasterCts)
