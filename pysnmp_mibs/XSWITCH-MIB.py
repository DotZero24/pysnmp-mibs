...
mibBuilder.exportSymbols("XSWITCH-MIB", scGenGroupRspDeviceNotRespondingTimeout=scGenGroupRspDeviceNotRespondingTimeout, scGenPortDot1xPortNumSupplicants=scGenPortDot1xPortNumSupplicants, scEthPortGoodMulticastPktsRec=scEthPortGoodMulticastPktsRec, scGenSwitchCopyDestination=scGenSwitchCopyDestination, scGenChAgVLAN=scGenChAgVLAN, scEthPortPkts256to511Octets=scEthPortPkts256to511Octets, scHostTimePortCorrEntry=scHostTimePortCorrEntry, scGenLinkAggregationFaultMask=scGenLinkAggregationFaultMask, scGenPortGenericTrap=scGenPortGenericTrap, scGenGroupStatus=scGenGroupStatus, scGenGroupVlanCurrentEgressPorts=scGenGroupVlanCurrentEgressPorts, scGenGroupBUPSAllocatedPower=scGenGroupBUPSAllocatedPower, scHostTimeIndex=scHostTimeIndex, scGenGroupFansStatus=scGenGroupFansStatus, scGenGroupSmonDropEvents=scGenGroupSmonDropEvents, scGenMonMIBCtrMode=scGenMonMIBCtrMode, scGenSwitchSWRdChange=scGenSwitchSWRdChange, scEthPortPktsRec=scEthPortPktsRec, scGenMonVLANList=scGenMonVLANList, scGenMonVLANStatsBcastPkts=scGenMonVLANStatsBcastPkts, scEthPortPkts64Octets=scEthPortPkts64Octets, scGenMonVLANTable=scGenMonVLANTable, scHostTimeAddress=scHostTimeAddress, scGenPortGroupId=scGenPortGroupId, scGenMonVLANEntry=scGenMonVLANEntry, scGenPortDot1xMACTable=scGenPortDot1xMACTable, scGenSwitchMacAging=scGenSwitchMacAging, scGenMonPrioritySwitchId=scGenMonPrioritySwitchId, scGenGroupRspBroadcastArpLongInterval=scGenGroupRspBroadcastArpLongInterval, scGenLinkAggregationNumberOfPorts=scGenLinkAggregationNumberOfPorts, scPriorityQueuingWRRWeights=scPriorityQueuingWRRWeights, scGenPortSecureMACTable=scGenPortSecureMACTable, scGenGroupCopyPortSupport=scGenGroupCopyPortSupport, scEthPortGroupId=scEthPortGroupId, scGenPortEntry=scGenPortEntry, scEthPortLower32OctetsRec=scEthPortLower32OctetsRec, scGenPortCopyMode=scGenPortCopyMode, scEthPortGoodPktsRec=scEthPortGoodPktsRec, scEth=scEth, scGenGroupMcFilterStackingSupport=scGenGroupMcFilterStackingSupport, scGenGroupSecurityMacCount=scGenGroupSecurityMacCount, scGenGroupCascadingCS=scGenGroupCascadingCS, scGenGroupSmonTable=scGenGroupSmonTable, scGenMonGoodBroadcastPkts=scGenMonGoodBroadcastPkts, scEthPortLower32OctetsSent=scEthPortLower32OctetsSent, scGenGroupRspPeriodicPingsDestinationIpAddress=scGenGroupRspPeriodicPingsDestinationIpAddress, scEthGroupId=scEthGroupId, scEthPortMode=scEthPortMode, scGenPortIPAddressRspIpAddressIndex=scGenPortIPAddressRspIpAddressIndex, scEthPortPkts65to127Octets=scEthPortPkts65to127Octets, scGenChassis=scGenChassis, scGenSwitchCopyMode=scGenSwitchCopyMode, scGenGroupVlanGroupId=scGenGroupVlanGroupId, scGenGroupSmonGoodBroadcastPkts=scGenGroupSmonGoodBroadcastPkts, scGenSwitchVLANBridging=scGenSwitchVLANBridging, scGenPortDot1xPortNumAuthenticatingSupplicants=scGenPortDot1xPortNumAuthenticatingSupplicants, scEthPortOversizePkts=scEthPortOversizePkts, scGenSwitchMcFilterHostAgingTime=scGenSwitchMcFilterHostAgingTime, scGenGroupRspDevicePollingInterval=scGenGroupRspDevicePollingInterval, scGenPortSecurityMode=scGenPortSecurityMode, scGenMonPriorityGoodPkts=scGenMonPriorityGoodPkts, scGenGroupVlanId=scGenGroupVlanId, scGenPortRspTable=scGenPortRspTable, scGenGroupPlugInType=scGenGroupPlugInType, scGenPortDot1xMACGroupID=scGenPortDot1xMACGroupID, scGenPortTable=scGenPortTable, scEthGroup=scEthGroup, scGenGroupBUPSCS=scGenGroupBUPSCS, scPriorityQueuingNumberOfQueues=scPriorityQueuingNumberOfQueues, scGenSwitchVLANList=scGenSwitchVLANList, scGenSwitchLACPMode=scGenSwitchLACPMode, scEthPortDiscardPktsSent=scEthPortDiscardPktsSent, scEthPortCRCAlignErrors=scEthPortCRCAlignErrors, scGenMonMIBCtrList=scGenMonMIBCtrList, scGenPort=scGenPort, scGenMonTable=scGenMonTable, scGenGroupSmonEntry=scGenGroupSmonEntry, scGenMonVLANStatsMcastPkts=scGenMonVLANStatsMcastPkts, scGenSwitchReset=scGenSwitchReset, scEthPortEntry=scEthPortEntry, scGenGroupVlanBcastOctets=scGenGroupVlanBcastOctets, scGenGroupSupportSegCountersList=scGenGroupSupportSegCountersList, scGenSwitchFastAgingOnRemoteTopChg=scGenSwitchFastAgingOnRemoteTopChg, scGenGroupSupportCopyPortList=scGenGroupSupportCopyPortList, scGenGroupVlanCurrentUntaggedPorts=scGenGroupVlanCurrentUntaggedPorts, scGenSwitchSecurityMode=scGenSwitchSecurityMode, scGenMonTimeStamp=scGenMonTimeStamp, scGenGroupUpLinkType=scGenGroupUpLinkType, scGenGroupRspBroadcastArpShortInterval=scGenGroupRspBroadcastArpShortInterval, scEthPortBadOctets=scEthPortBadOctets, scEthPortGoodPktsSent=scEthPortGoodPktsSent, scPowerEthGroupPseDetectionProcess=scPowerEthGroupPseDetectionProcess, scGenGroupMcFilterPersonalitySupport=scGenGroupMcFilterPersonalitySupport, scGenGroupVlanEntry=scGenGroupVlanEntry, scGenPortVLAN=scGenPortVLAN, scGenMonSmonCapability=scGenMonSmonCapability, scGenGroupSmonPkts=scGenGroupSmonPkts, scEthPortGoodBroadcastPktsRec=scEthPortGoodBroadcastPktsRec, scEthPortMulticastPktsSent=scEthPortMulticastPktsSent, scEthPortGigaPauseStatus=scEthPortGigaPauseStatus, scGenGroupSmonBadOctets=scGenGroupSmonBadOctets, scEthPortPkts512to1023Octets=scEthPortPkts512to1023Octets, scGenMon=scGenMon, scEthPortGoodOctetsRec=scEthPortGoodOctetsRec, scEthPortUnicastPktsSent=scEthPortUnicastPktsSent, scGenGroupVlanStaticEgressPorts=scGenGroupVlanStaticEgressPorts, scGenGroupBroadcastThreshold=scGenGroupBroadcastThreshold, scGenMonVLANGoodPkts=scGenMonVLANGoodPkts, scGenGroupVlanMcastPkts=scGenGroupVlanMcastPkts, scGenSwitchSTA=scGenSwitchSTA, scGenLinkAggregationStatus=scGenLinkAggregationStatus, scGenPortVLANEgressStaticConfiguration=scGenPortVLANEgressStaticConfiguration, scEthPortGoodOctetsSent=scEthPortGoodOctetsSent, scGenGroupVlanGoodOctets=scGenGroupVlanGoodOctets, scGenGroupVlanUcastPkts=scGenGroupVlanUcastPkts, scPriorityQueuingModuleID=scPriorityQueuingModuleID, scHostTimePortCorrTable=scHostTimePortCorrTable, scGenGroupDot1xCurrentNumAuthenticatingSupplicant=scGenGroupDot1xCurrentNumAuthenticatingSupplicant, scGenPortStaticVLANBinding=scGenPortStaticVLANBinding, scGenPortLinkAggregationNumber=scGenPortLinkAggregationNumber, scGenMonSwitches=scGenMonSwitches, RowStatus=RowStatus, scEthPortPauseCapabilities=scEthPortPauseCapabilities, scGenSwitch=scGenSwitch, scPowerEthGroupInlineSWversion=scPowerEthGroupInlineSWversion, scGenGroupSupportDstCopyPortList=scGenGroupSupportDstCopyPortList, scGenGroupVlanStaticUntaggedPorts=scGenGroupVlanStaticUntaggedPorts, scHostTimeCreationOrder=scHostTimeCreationOrder, scGenGroupRspPeriodicPingsBoxIpAddress=scGenGroupRspPeriodicPingsBoxIpAddress, scEthPort=scEthPort, scGenPortDot1xPortMode=scGenPortDot1xPortMode, scGenGroupSmonGoodOctets=scGenGroupSmonGoodOctets, scPowerEthPortPortId=scPowerEthPortPortId, scGenPortPriority=scGenPortPriority, scEthPortTable=scEthPortTable, scGenGroupPriorityQueuesScheduling=scGenGroupPriorityQueuesScheduling, scGenGroupBroadcastStormControl=scGenGroupBroadcastStormControl, scGenPortLagCapability=scGenPortLagCapability, scGenGroupSmonCapability=scGenGroupSmonCapability, scGenPortIPAddressRspEntry=scGenPortIPAddressRspEntry, scPowerEthPortGroupId=scPowerEthPortGroupId, scPowerEthPortTable=scPowerEthPortTable, scGenPortCopyDestination=scGenPortCopyDestination, scGenMonBadPkts=scGenMonBadPkts, scPowerEthGroupEntry=scPowerEthGroupEntry, scGenMonGoodOctets=scGenMonGoodOctets, scGenGroupSmonVlanList=scGenGroupSmonVlanList, scGenMonSwitchVLANList=scGenMonSwitchVLANList, scGenGroupDynamicVlans=scGenGroupDynamicVlans, scGenChRedunAgPosition=scGenChRedunAgPosition, scEthPortGoodUnicastPktsRec=scEthPortGoodUnicastPktsRec, scGenPortCopyClassModuleLevel=scGenPortCopyClassModuleLevel, scGenGroupVlanMcastOctets=scGenGroupVlanMcastOctets, scGenPortSetDefaults=scGenPortSetDefaults, scGenGroupDot1xCurrentNumSupplicant=scGenGroupDot1xCurrentNumSupplicant, scPowerEthPortEntry=scPowerEthPortEntry, scGenPortDot1xPortPortId=scGenPortDot1xPortPortId, scGenMonSwitchId=scGenMonSwitchId, scGenMonVlanTimeStamp=scGenMonVlanTimeStamp, scGenGroupCascadingDescr=scGenGroupCascadingDescr, scGenPortSecureGroupID=scGenPortSecureGroupID, scGenGroupUseSwitches=scGenGroupUseSwitches, scGenGroupRspHelloInterval=scGenGroupRspHelloInterval, scGenPortSLDStatus=scGenPortSLDStatus, scEthPortUndersizePktsRec=scEthPortUndersizePktsRec, scPriorityQueuingModeControl=scPriorityQueuingModeControl, scGenSwitchSetDefaults=scGenSwitchSetDefaults, scGenGroupDot1xEntry=scGenGroupDot1xEntry, scGenLinkAggregationTable=scGenLinkAggregationTable, scGenLinkAggregationLogicalPortGroupId=scGenLinkAggregationLogicalPortGroupId, scGenPortRspGroupId=scGenPortRspGroupId, scGenGroupRspMode=scGenGroupRspMode, scGenChRedunAgActivityStatus=scGenChRedunAgActivityStatus, scGenPortSecId=scGenPortSecId, scGenPortCopyClassStackLevel=scGenPortCopyClassStackLevel, scGenSwitchEntry=scGenSwitchEntry, scPriorityQueuingTable=scPriorityQueuingTable, scEthPortBadPkts=scEthPortBadPkts, scPriorityQueuing=scPriorityQueuing, scGenSwitchOldVersionModules=scGenSwitchOldVersionModules, scGenGroupRspSwitchNotRespondingTimeout=scGenGroupRspSwitchNotRespondingTimeout, scGenSwitchTable=scGenSwitchTable, scGenSwitchId=scGenSwitchId, scGenSwitchWelcomeMessage=scGenSwitchWelcomeMessage, scGenChMainAgPosition=scGenChMainAgPosition, scGenGroupSecurityMode=scGenGroupSecurityMode, scGenGroupBoundedDelay=scGenGroupBoundedDelay, scGenLinkAggregationLogicalPortId=scGenLinkAggregationLogicalPortId, scGenSwitchPromptMessage=scGenSwitchPromptMessage, scEthPortCollisions=scEthPortCollisions, scGenGroupDot1xTable=scGenGroupDot1xTable, scGenLinkAggregationFunctionalStatus=scGenLinkAggregationFunctionalStatus, scGenLinkAggregationBasePortId=scGenLinkAggregationBasePortId, scEthGroupEntry=scEthGroupEntry, scGenSwitchSecurityModePermit=scGenSwitchSecurityModePermit, scGenSwitchFindQuery=scGenSwitchFindQuery, scGenGroupRspEntry=scGenGroupRspEntry, scEthPortId=scEthPortId, scEthPortGoodMulticastOctetsRec=scEthPortGoodMulticastOctetsRec, scGenSwitchDot1xLldpTxVlanName=scGenSwitchDot1xLldpTxVlanName, scEthGroupTable=scEthGroupTable, scGenMonPriorityId=scGenMonPriorityId, scGenGroupTable=scGenGroupTable, scEthPortPkts1024to1518Octets=scEthPortPkts1024to1518Octets, scGenSwitchMcFilter=scGenSwitchMcFilter, scGenGroupVlanTable=scGenGroupVlanTable, scGenPortIPAddressRspIpAddress=scGenPortIPAddressRspIpAddress, scEthPortSpeed=scEthPortSpeed, scGenPortSTA=scGenPortSTA, scGenPortBackbone=scGenPortBackbone, scGenPortRspId=scGenPortRspId, scGenSwitchCopySource=scGenSwitchCopySource, scGenGroupPlugInCS=scGenGroupPlugInCS, scGenSwitchVIDP=scGenSwitchVIDP, scEthPortFragments=scEthPortFragments, scGenSwitchAgVLAN=scGenSwitchAgVLAN, scGenGroupPlugInDescr=scGenGroupPlugInDescr, scEthPortJabber=scEthPortJabber, scGenSwitchType=scGenSwitchType, scEthPortAutoNegotiation=scEthPortAutoNegotiation, scGenGroupXswitchConnection=scGenGroupXswitchConnection, scGenGroupRspBroadcastArpShortIntervalNumber=scGenGroupRspBroadcastArpShortIntervalNumber, scEthPortDiscardPktsRec=scEthPortDiscardPktsRec, scEthPortUpper32OctetsSent=scEthPortUpper32OctetsSent, scGenGroupInternalBuffering=scGenGroupInternalBuffering, scGenMonDropEvents=scGenMonDropEvents, scEthPortFlowControl=scEthPortFlowControl, scGenGroupSupportPortCountersList=scGenGroupSupportPortCountersList, scGenGroupBUPSFansStatus=scGenGroupBUPSFansStatus, scGenGroupRspGroupId=scGenGroupRspGroupId, scEthPortAutoNegotiationStatus=scEthPortAutoNegotiationStatus, scGenMonBadOctets=scGenMonBadOctets, scGenPortIPAddressRspTable=scGenPortIPAddressRspTable, scEthPortFunctionalStatus=scEthPortFunctionalStatus, scGenPortSLDAdminStatus=scGenPortSLDAdminStatus, scEthPortGoodBroadcastOctetsRec=scEthPortGoodBroadcastOctetsRec, scGenPortIPAddressRspGroupId=scGenPortIPAddressRspGroupId, scGen=scGen, scPriorityQueuingDefaultControl=scPriorityQueuingDefaultControl, scPriorityQueuingEntry=scPriorityQueuingEntry, scEthPortDropEvents=scEthPortDropEvents, scGenSwitchMasterId=scGenSwitchMasterId, scGenPortCapability=scGenPortCapability, scGenMonPkts=scGenMonPkts, scEthPortTotalOctets=scEthPortTotalOctets, scGenGroupSmonBadPkts=scGenGroupSmonBadPkts, scGenGroupDot1xCurrentNumAuthenticatedSupplicant=scGenGroupDot1xCurrentNumAuthenticatedSupplicant, scGenPortDot1xMACPortId=scGenPortDot1xMACPortId, scGenLinkAggregation=scGenLinkAggregation, scGenSwitchSTANonSupportedModules=scGenSwitchSTANonSupportedModules, scPowerEthPortConsumptionPower=scPowerEthPortConsumptionPower, scGenGroupSmonOctets=scGenGroupSmonOctets, scEthPortLateCollisions=scEthPortLateCollisions, scGenGroupVlanGoodPkts=scGenGroupVlanGoodPkts)
mibBuilder.exportSymbols("XSWITCH-MIB", scGenGroupSwitchType=scGenGroupSwitchType, scGenMonVLANSwitchId=scGenMonVLANSwitchId, scGenPortDot1xMACAuthBackendAuthState=scGenPortDot1xMACAuthBackendAuthState, scGenGroupSmonMIBCtrMode=scGenGroupSmonMIBCtrMode, scGenPortDot1xMACAuthPaeState=scGenPortDot1xMACAuthPaeState, scGenSwitchDefaultVLAN=scGenSwitchDefaultVLAN, scGenSwitchGigaMode=scGenSwitchGigaMode, scGenPortRspEntry=scGenPortRspEntry, scPowerEth=scPowerEth, scGenGroupSetDefaults=scGenGroupSetDefaults, scGenLinkAggregationBasePortGroupId=scGenLinkAggregationBasePortGroupId, scGenGroupEntry=scGenGroupEntry, scGenPortDot1xMAC=scGenPortDot1xMAC, scGenGroupLACPMode=scGenGroupLACPMode, scGenLinkAggregationAutoNegResults=scGenLinkAggregationAutoNegResults, scGenPortDot1xMACEntry=scGenPortDot1xMACEntry, scGenMonPriorityEntry=scGenMonPriorityEntry, scGenGroupSmonGoodMulticastPkts=scGenGroupSmonGoodMulticastPkts, scEthPortTotalPkts=scEthPortTotalPkts, scGenMonVLANStatsUcastPkts=scGenMonVLANStatsUcastPkts, scPowerEthGroupId=scPowerEthGroupId, scGenPortDot1xPortNumAuthenticatedSupplicants=scGenPortDot1xPortNumAuthenticatedSupplicants, scGenSwitchMcFilterDelayTime=scGenSwitchMcFilterDelayTime, scGenGroupRspTable=scGenGroupRspTable, scGenSwitchCAMClear=scGenSwitchCAMClear, scGenPortIPAddressRspPortId=scGenPortIPAddressRspPortId, scGenPortLACPMode=scGenPortLACPMode, switchChip=switchChip, scEthPortUpper32OctetsRec=scEthPortUpper32OctetsRec, scGenLinkAggregationId=scGenLinkAggregationId, scGenMonOctets=scGenMonOctets, scGenGroupVlanBcastPkts=scGenGroupVlanBcastPkts, scGenSwitchMcFilterRouterAgingTime=scGenSwitchMcFilterRouterAgingTime, scGenGroupRspMoveToForwardingInterval=scGenGroupRspMoveToForwardingInterval, scGenGroupCascadingType=scGenGroupCascadingType, scGenSwitchDot1xPortMaxSuppNum=scGenSwitchDot1xPortMaxSuppNum, scGenPortIPAddressRsp=scGenPortIPAddressRsp, scGenGroup=scGenGroup, scGenGroupDefaultVLAN=scGenGroupDefaultVLAN, scGenGroupDot1xSystemMaxNumSupplicant=scGenGroupDot1xSystemMaxNumSupplicant, scGenPortSecurePortId=scGenPortSecurePortId, scGenPortSecureMACStatus=scGenPortSecureMACStatus, scGenMonGoodPkts=scGenMonGoodPkts, scPowerEthGroupPsePSPowerFaultErrMsg=scPowerEthGroupPsePSPowerFaultErrMsg, scGenMonVLANGoodOctets=scGenMonVLANGoodOctets, scEthGroupFefiEnable=scEthGroupFefiEnable, scGenPortSecureMAC=scGenPortSecureMAC, scPriorityQueuingExpediteWRRFlg=scPriorityQueuingExpediteWRRFlg, scEthPortOctetsRec=scEthPortOctetsRec, scGenLinkAggregationEntry=scGenLinkAggregationEntry, scGenPortDot1xAuthAuthControlledPortStatus=scGenPortDot1xAuthAuthControlledPortStatus, scGenMonEntry=scGenMonEntry, scGenPortId=scGenPortId, scGenMonVLANId=scGenMonVLANId, scGenGroupSLDAdminStatus=scGenGroupSLDAdminStatus, scGenSwitchVIDPNonSupportedModules=scGenSwitchVIDPNonSupportedModules, scPowerEthGroupTable=scPowerEthGroupTable, scHostTimePortConnection=scHostTimePortConnection, scGenGroupBUPSType=scGenGroupBUPSType, scGenGroupDot1xGroupId=scGenGroupDot1xGroupId, scEthPortPkts128to255Octets=scEthPortPkts128to255Octets, scGenPortSecureMACEntry=scGenPortSecureMACEntry, scGenPortLastIntruderSourceAddr=scGenPortLastIntruderSourceAddr, scGenGroupSmonGroupId=scGenGroupSmonGroupId, scGenSwitchIDSNonSupportedModules=scGenSwitchIDSNonSupportedModules, scGenMonPriorityTable=scGenMonPriorityTable, scGenSwitchNumberOfLoads=scGenSwitchNumberOfLoads, scGenMonPriorityGoodOctets=scGenMonPriorityGoodOctets, scGenGroupVlanUcastOctets=scGenGroupVlanUcastOctets, scGenPortMaxLagsOnSec=scGenPortMaxLagsOnSec, scEthGroupAutoPartitionEnable=scEthGroupAutoPartitionEnable, scGenMonGoodMulticastPkts=scGenMonGoodMulticastPkts, scGenPortRspMode=scGenPortRspMode, scGenPortDot1xPortTable=scGenPortDot1xPortTable, scGenPortDot1xPortEntry=scGenPortDot1xPortEntry, scGenGroupSmonGoodPkts=scGenGroupSmonGoodPkts, scGenPortDot1xPortGroupID=scGenPortDot1xPortGroupID, scGenSwitchSecurityAction=scGenSwitchSecurityAction, scGenGroupNumberOfLoads=scGenGroupNumberOfLoads, scGenPortSendBridgedPackets=scGenPortSendBridgedPackets, scGenGroupId=scGenGroupId, scGenLinkAggregationName=scGenLinkAggregationName, scGenSwitchFindResult=scGenSwitchFindResult, scGenGroupMcFilterBoxSupport=scGenGroupMcFilterBoxSupport)
