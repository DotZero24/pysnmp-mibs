...
# Notes
# -----
# ASN.1 source file://mibs/avaya/XSWITCH-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:04:43 2025
...
scGenGroupDynamicVlans = _ScGenGroupDynamicVlans_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 1, 1, 36),
    _ScGenGroupDynamicVlans_Type()
)
scGenGroupDynamicVlans.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenGroupDynamicVlans.setStatus("mandatory")


class _ScGenGroupSecurityMacCount_Type(Integer32):
    """Custom type scGenGroupSecurityMacCount based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ScGenGroupSecurityMacCount_Type.__name__ = "Integer32"
_ScGenGroupSecurityMacCount_Object = MibTableColumn
scGenGroupSecurityMacCount = _ScGenGroupSecurityMacCount_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 1, 1, 37),
    _ScGenGroupSecurityMacCount_Type()
)
scGenGroupSecurityMacCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenGroupSecurityMacCount.setStatus("mandatory")


class _ScGenGroupBUPSAllocatedPower_Type(Integer32):
    """Custom type scGenGroupBUPSAllocatedPower based on Integer32"""
    defaultValue = 800
...
_ScGenGroupBUPSAllocatedPower_Type.__name__ = "Integer32"
_ScGenGroupBUPSAllocatedPower_Object = MibTableColumn
scGenGroupBUPSAllocatedPower = _ScGenGroupBUPSAllocatedPower_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 1, 1, 38),
    _ScGenGroupBUPSAllocatedPower_Type()
)
scGenGroupBUPSAllocatedPower.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenGroupBUPSAllocatedPower.setStatus("mandatory")
...
_ScGenGroupRspHelloInterval_Type.__name__ = "Integer32"
...
_ScGenGroupRspDevicePollingInterval_Type.__name__ = "Integer32"
...
_ScGenGroupRspDeviceNotRespondingTimeout_Type.__name__ = "Integer32"
...
_ScGenGroupRspSwitchNotRespondingTimeout_Type.__name__ = "Integer32"
...
_ScGenGroupRspMoveToForwardingInterval_Type.__name__ = "Integer32"
...
_ScGenGroupRspBroadcastArpShortInterval_Type.__name__ = "Integer32"
...
_ScGenGroupRspBroadcastArpShortIntervalNumber_Type.__name__ = "Integer32"
...
_ScGenGroupRspBroadcastArpLongInterval_Type.__name__ = "Integer32"
...
scGenGroupDot1xTable = _ScGenGroupDot1xTable_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 5)
)
if mibBuilder.loadTexts:
    scGenGroupDot1xTable.setStatus("mandatory")
_ScGenGroupDot1xEntry_Object = MibTableRow
scGenGroupDot1xEntry = _ScGenGroupDot1xEntry_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 5, 1)
)
scGenGroupDot1xEntry.setIndexNames(
    (0, "XSWITCH-MIB", "scGenGroupDot1xGroupId"),
)
if mibBuilder.loadTexts:
    scGenGroupDot1xEntry.setStatus("mandatory")
_ScGenGroupDot1xGroupId_Type = Integer32
_ScGenGroupDot1xGroupId_Object = MibTableColumn
scGenGroupDot1xGroupId = _ScGenGroupDot1xGroupId_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 5, 1, 1),
    _ScGenGroupDot1xGroupId_Type()
)
scGenGroupDot1xGroupId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenGroupDot1xGroupId.setStatus("mandatory")
_ScGenGroupDot1xSystemMaxNumSupplicant_Type = Integer32
_ScGenGroupDot1xSystemMaxNumSupplicant_Object = MibTableColumn
scGenGroupDot1xSystemMaxNumSupplicant = _ScGenGroupDot1xSystemMaxNumSupplicant_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 5, 1, 2),
    _ScGenGroupDot1xSystemMaxNumSupplicant_Type()
)
scGenGroupDot1xSystemMaxNumSupplicant.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenGroupDot1xSystemMaxNumSupplicant.setStatus("mandatory")
_ScGenGroupDot1xCurrentNumSupplicant_Type = Integer32
_ScGenGroupDot1xCurrentNumSupplicant_Object = MibTableColumn
scGenGroupDot1xCurrentNumSupplicant = _ScGenGroupDot1xCurrentNumSupplicant_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 5, 1, 3),
    _ScGenGroupDot1xCurrentNumSupplicant_Type()
)
scGenGroupDot1xCurrentNumSupplicant.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenGroupDot1xCurrentNumSupplicant.setStatus("mandatory")
...
scGenGroupDot1xCurrentNumAuthenticatedSupplicant = _ScGenGroupDot1xCurrentNumAuthenticatedSupplicant_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 5, 1, 4),
    _ScGenGroupDot1xCurrentNumAuthenticatedSupplicant_Type()
)
scGenGroupDot1xCurrentNumAuthenticatedSupplicant.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenGroupDot1xCurrentNumAuthenticatedSupplicant.setStatus("mandatory")
...
scGenGroupDot1xCurrentNumAuthenticatingSupplicant = _ScGenGroupDot1xCurrentNumAuthenticatingSupplicant_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 3, 5, 1, 5),
    _ScGenGroupDot1xCurrentNumAuthenticatingSupplicant_Type()
)
scGenGroupDot1xCurrentNumAuthenticatingSupplicant.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenGroupDot1xCurrentNumAuthenticatingSupplicant.setStatus("mandatory")
...
class _ScGenPortLastIntruderSourceAddr_Type(OctetString):
    """Custom type scGenPortLastIntruderSourceAddr based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ScGenPortLastIntruderSourceAddr_Type.__name__ = "OctetString"
...
scGenPortCopyClassModuleLevel = _ScGenPortCopyClassModuleLevel_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 1, 1, 24),
    _ScGenPortCopyClassModuleLevel_Type()
)
scGenPortCopyClassModuleLevel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortCopyClassModuleLevel.setStatus("mandatory")
_ScGenPortCopyClassStackLevel_Type = OctetString
_ScGenPortCopyClassStackLevel_Object = MibTableColumn
scGenPortCopyClassStackLevel = _ScGenPortCopyClassStackLevel_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 1, 1, 25),
    _ScGenPortCopyClassStackLevel_Type()
)
scGenPortCopyClassStackLevel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortCopyClassStackLevel.setStatus("mandatory")
...
scGenPortSecureMACTable = _ScGenPortSecureMACTable_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 3)
)
if mibBuilder.loadTexts:
    scGenPortSecureMACTable.setStatus("mandatory")
_ScGenPortSecureMACEntry_Object = MibTableRow
scGenPortSecureMACEntry = _ScGenPortSecureMACEntry_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 3, 1)
)
scGenPortSecureMACEntry.setIndexNames(
    (0, "XSWITCH-MIB", "scGenPortSecureGroupID"),
    (0, "XSWITCH-MIB", "scGenPortSecurePortId"),
    (0, "XSWITCH-MIB", "scGenPortSecureMAC"),
)
if mibBuilder.loadTexts:
    scGenPortSecureMACEntry.setStatus("mandatory")


class _ScGenPortSecureGroupID_Type(Integer32):
    """Custom type scGenPortSecureGroupID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ScGenPortSecureGroupID_Type.__name__ = "Integer32"
_ScGenPortSecureGroupID_Object = MibTableColumn
scGenPortSecureGroupID = _ScGenPortSecureGroupID_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 3, 1, 1),
    _ScGenPortSecureGroupID_Type()
)
scGenPortSecureGroupID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortSecureGroupID.setStatus("mandatory")


class _ScGenPortSecurePortId_Type(Integer32):
    """Custom type scGenPortSecurePortId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 1024),
    )
...
_ScGenPortSecurePortId_Type.__name__ = "Integer32"
_ScGenPortSecurePortId_Object = MibTableColumn
scGenPortSecurePortId = _ScGenPortSecurePortId_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 3, 1, 2),
    _ScGenPortSecurePortId_Type()
)
scGenPortSecurePortId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortSecurePortId.setStatus("mandatory")
_ScGenPortSecureMAC_Type = MacAddress
_ScGenPortSecureMAC_Object = MibTableColumn
scGenPortSecureMAC = _ScGenPortSecureMAC_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 3, 1, 3),
    _ScGenPortSecureMAC_Type()
)
scGenPortSecureMAC.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortSecureMAC.setStatus("mandatory")
_ScGenPortSecureMACStatus_Type = RowStatus
_ScGenPortSecureMACStatus_Object = MibTableColumn
scGenPortSecureMACStatus = _ScGenPortSecureMACStatus_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 3, 1, 4),
    _ScGenPortSecureMACStatus_Type()
)
scGenPortSecureMACStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenPortSecureMACStatus.setStatus("mandatory")
_ScGenPortDot1xMACTable_Object = MibTable
scGenPortDot1xMACTable = _ScGenPortDot1xMACTable_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 4)
)
if mibBuilder.loadTexts:
    scGenPortDot1xMACTable.setStatus("mandatory")
_ScGenPortDot1xMACEntry_Object = MibTableRow
scGenPortDot1xMACEntry = _ScGenPortDot1xMACEntry_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 4, 1)
)
scGenPortDot1xMACEntry.setIndexNames(
    (0, "XSWITCH-MIB", "scGenPortDot1xMACGroupID"),
    (0, "XSWITCH-MIB", "scGenPortDot1xMACPortId"),
    (0, "XSWITCH-MIB", "scGenPortDot1xMAC"),
)
if mibBuilder.loadTexts:
    scGenPortDot1xMACEntry.setStatus("mandatory")


class _ScGenPortDot1xMACGroupID_Type(Integer32):
    """Custom type scGenPortDot1xMACGroupID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 10),
    )
...
_ScGenPortDot1xMACGroupID_Type.__name__ = "Integer32"
_ScGenPortDot1xMACGroupID_Object = MibTableColumn
scGenPortDot1xMACGroupID = _ScGenPortDot1xMACGroupID_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 4, 1, 1),
    _ScGenPortDot1xMACGroupID_Type()
)
scGenPortDot1xMACGroupID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortDot1xMACGroupID.setStatus("mandatory")


class _ScGenPortDot1xMACPortId_Type(Integer32):
    """Custom type scGenPortDot1xMACPortId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 1024),
    )
...
_ScGenPortDot1xMACPortId_Type.__name__ = "Integer32"
_ScGenPortDot1xMACPortId_Object = MibTableColumn
scGenPortDot1xMACPortId = _ScGenPortDot1xMACPortId_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 4, 1, 2),
    _ScGenPortDot1xMACPortId_Type()
)
scGenPortDot1xMACPortId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortDot1xMACPortId.setStatus("mandatory")
_ScGenPortDot1xMAC_Type = MacAddress
_ScGenPortDot1xMAC_Object = MibTableColumn
scGenPortDot1xMAC = _ScGenPortDot1xMAC_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 4, 1, 3),
    _ScGenPortDot1xMAC_Type()
)
scGenPortDot1xMAC.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortDot1xMAC.setStatus("mandatory")


class _ScGenPortDot1xMACAuthPaeState_Type(Integer32):
    """Custom type scGenPortDot1xMACAuthPaeState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ScGenPortDot1xMACAuthPaeState_Type.__name__ = "Integer32"
_ScGenPortDot1xMACAuthPaeState_Object = MibTableColumn
scGenPortDot1xMACAuthPaeState = _ScGenPortDot1xMACAuthPaeState_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 4, 1, 4),
    _ScGenPortDot1xMACAuthPaeState_Type()
)
scGenPortDot1xMACAuthPaeState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortDot1xMACAuthPaeState.setStatus("mandatory")


class _ScGenPortDot1xMACAuthBackendAuthState_Type(Integer32):
    """Custom type scGenPortDot1xMACAuthBackendAuthState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ScGenPortDot1xMACAuthBackendAuthState_Type.__name__ = "Integer32"
_ScGenPortDot1xMACAuthBackendAuthState_Object = MibTableColumn
scGenPortDot1xMACAuthBackendAuthState = _ScGenPortDot1xMACAuthBackendAuthState_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 4, 1, 5),
    _ScGenPortDot1xMACAuthBackendAuthState_Type()
)
scGenPortDot1xMACAuthBackendAuthState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortDot1xMACAuthBackendAuthState.setStatus("mandatory")
...
scGenPortDot1xAuthAuthControlledPortStatus = _ScGenPortDot1xAuthAuthControlledPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 4, 1, 6),
    _ScGenPortDot1xAuthAuthControlledPortStatus_Type()
)
scGenPortDot1xAuthAuthControlledPortStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortDot1xAuthAuthControlledPortStatus.setStatus("mandatory")
_ScGenPortDot1xPortTable_Object = MibTable
scGenPortDot1xPortTable = _ScGenPortDot1xPortTable_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 5)
)
if mibBuilder.loadTexts:
    scGenPortDot1xPortTable.setStatus("mandatory")
_ScGenPortDot1xPortEntry_Object = MibTableRow
scGenPortDot1xPortEntry = _ScGenPortDot1xPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 5, 1)
)
scGenPortDot1xPortEntry.setIndexNames(
    (0, "XSWITCH-MIB", "scGenPortDot1xPortGroupID"),
    (0, "XSWITCH-MIB", "scGenPortDot1xPortPortId"),
)
if mibBuilder.loadTexts:
    scGenPortDot1xPortEntry.setStatus("mandatory")


class _ScGenPortDot1xPortGroupID_Type(Integer32):
    """Custom type scGenPortDot1xPortGroupID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 10),
    )
...
_ScGenPortDot1xPortGroupID_Type.__name__ = "Integer32"
_ScGenPortDot1xPortGroupID_Object = MibTableColumn
scGenPortDot1xPortGroupID = _ScGenPortDot1xPortGroupID_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 5, 1, 1),
    _ScGenPortDot1xPortGroupID_Type()
)
scGenPortDot1xPortGroupID.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    scGenPortDot1xPortGroupID.setStatus("mandatory")


class _ScGenPortDot1xPortPortId_Type(Integer32):
    """Custom type scGenPortDot1xPortPortId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 1024),
    )
...
_ScGenPortDot1xPortPortId_Type.__name__ = "Integer32"
_ScGenPortDot1xPortPortId_Object = MibTableColumn
scGenPortDot1xPortPortId = _ScGenPortDot1xPortPortId_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 5, 1, 2),
    _ScGenPortDot1xPortPortId_Type()
)
scGenPortDot1xPortPortId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    scGenPortDot1xPortPortId.setStatus("mandatory")


class _ScGenPortDot1xPortMode_Type(Integer32):
    """Custom type scGenPortDot1xPortMode based on Integer32"""
    defaultValue = 1
...
_ScGenPortDot1xPortMode_Type.__name__ = "Integer32"
_ScGenPortDot1xPortMode_Object = MibTableColumn
scGenPortDot1xPortMode = _ScGenPortDot1xPortMode_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 5, 1, 3),
    _ScGenPortDot1xPortMode_Type()
)
scGenPortDot1xPortMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenPortDot1xPortMode.setStatus("mandatory")
_ScGenPortDot1xPortNumSupplicants_Type = Integer32
_ScGenPortDot1xPortNumSupplicants_Object = MibTableColumn
scGenPortDot1xPortNumSupplicants = _ScGenPortDot1xPortNumSupplicants_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 5, 1, 4),
    _ScGenPortDot1xPortNumSupplicants_Type()
)
scGenPortDot1xPortNumSupplicants.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortDot1xPortNumSupplicants.setStatus("mandatory")
...
scGenPortDot1xPortNumAuthenticatedSupplicants = _ScGenPortDot1xPortNumAuthenticatedSupplicants_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 5, 1, 5),
    _ScGenPortDot1xPortNumAuthenticatedSupplicants_Type()
)
scGenPortDot1xPortNumAuthenticatedSupplicants.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortDot1xPortNumAuthenticatedSupplicants.setStatus("mandatory")
...
scGenPortDot1xPortNumAuthenticatingSupplicants = _ScGenPortDot1xPortNumAuthenticatingSupplicants_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 4, 5, 1, 6),
    _ScGenPortDot1xPortNumAuthenticatingSupplicants_Type()
)
scGenPortDot1xPortNumAuthenticatingSupplicants.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scGenPortDot1xPortNumAuthenticatingSupplicants.setStatus("mandatory")
...
_ScGenSwitchMcFilterHostAgingTime_Type.__name__ = "Integer32"
...
_ScGenSwitchMcFilterRouterAgingTime_Type.__name__ = "Integer32"
...
_ScGenSwitchMcFilterDelayTime_Type.__name__ = "Integer32"
...
class _ScGenSwitchWelcomeMessage_Type(DisplayString):
    """Custom type scGenSwitchWelcomeMessage based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ScGenSwitchWelcomeMessage_Type.__name__ = "DisplayString"
_ScGenSwitchWelcomeMessage_Object = MibTableColumn
scGenSwitchWelcomeMessage = _ScGenSwitchWelcomeMessage_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 5, 1, 1, 33),
    _ScGenSwitchWelcomeMessage_Type()
)
scGenSwitchWelcomeMessage.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenSwitchWelcomeMessage.setStatus("mandatory")


class _ScGenSwitchPromptMessage_Type(DisplayString):
    """Custom type scGenSwitchPromptMessage based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_ScGenSwitchPromptMessage_Type.__name__ = "DisplayString"
_ScGenSwitchPromptMessage_Object = MibTableColumn
scGenSwitchPromptMessage = _ScGenSwitchPromptMessage_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 5, 1, 1, 34),
    _ScGenSwitchPromptMessage_Type()
)
scGenSwitchPromptMessage.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenSwitchPromptMessage.setStatus("mandatory")


class _ScGenSwitchMacAging_Type(Integer32):
    """Custom type scGenSwitchMacAging based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ScGenSwitchMacAging_Type.__name__ = "Integer32"
_ScGenSwitchMacAging_Object = MibTableColumn
scGenSwitchMacAging = _ScGenSwitchMacAging_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 5, 1, 1, 35),
    _ScGenSwitchMacAging_Type()
)
scGenSwitchMacAging.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenSwitchMacAging.setStatus("mandatory")


class _ScGenSwitchSecurityAction_Type(Integer32):
    """Custom type scGenSwitchSecurityAction based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ScGenSwitchSecurityAction_Type.__name__ = "Integer32"
_ScGenSwitchSecurityAction_Object = MibTableColumn
scGenSwitchSecurityAction = _ScGenSwitchSecurityAction_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 5, 1, 1, 36),
    _ScGenSwitchSecurityAction_Type()
)
scGenSwitchSecurityAction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenSwitchSecurityAction.setStatus("mandatory")


class _ScGenSwitchDot1xPortMaxSuppNum_Type(Integer32):
    """Custom type scGenSwitchDot1xPortMaxSuppNum based on Integer32"""
    defaultValue = 2


_ScGenSwitchDot1xPortMaxSuppNum_Type.__name__ = "Integer32"
_ScGenSwitchDot1xPortMaxSuppNum_Object = MibTableColumn
scGenSwitchDot1xPortMaxSuppNum = _ScGenSwitchDot1xPortMaxSuppNum_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 5, 1, 1, 37),
    _ScGenSwitchDot1xPortMaxSuppNum_Type()
)
scGenSwitchDot1xPortMaxSuppNum.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenSwitchDot1xPortMaxSuppNum.setStatus("mandatory")


class _ScGenSwitchDot1xLldpTxVlanName_Type(Integer32):
    """Custom type scGenSwitchDot1xLldpTxVlanName based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ScGenSwitchDot1xLldpTxVlanName_Type.__name__ = "Integer32"
_ScGenSwitchDot1xLldpTxVlanName_Object = MibTableColumn
scGenSwitchDot1xLldpTxVlanName = _ScGenSwitchDot1xLldpTxVlanName_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 1, 5, 1, 1, 38),
    _ScGenSwitchDot1xLldpTxVlanName_Type()
)
scGenSwitchDot1xLldpTxVlanName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scGenSwitchDot1xLldpTxVlanName.setStatus("mandatory")
...
class _ScPowerEthGroupInlineSWversion_Type(OctetString):
    """Custom type scPowerEthGroupInlineSWversion based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ScPowerEthGroupInlineSWversion_Type.__name__ = "OctetString"
_ScPowerEthGroupInlineSWversion_Object = MibTableColumn
scPowerEthGroupInlineSWversion = _ScPowerEthGroupInlineSWversion_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 2, 2, 1, 1, 4),
    _ScPowerEthGroupInlineSWversion_Type()
)
scPowerEthGroupInlineSWversion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scPowerEthGroupInlineSWversion.setStatus("mandatory")
_ScPowerEth_ObjectIdentity = ObjectIdentity
scPowerEth = _ScPowerEth_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 81, 28, 3)
)
_ScPowerEthGroupTable_Object = MibTable
scPowerEthGroupTable = _ScPowerEthGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 1)
)
if mibBuilder.loadTexts:
    scPowerEthGroupTable.setStatus("mandatory")
_ScPowerEthGroupEntry_Object = MibTableRow
scPowerEthGroupEntry = _ScPowerEthGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 1, 1)
)
scPowerEthGroupEntry.setIndexNames(
    (0, "XSWITCH-MIB", "scPowerEthGroupId"),
)
if mibBuilder.loadTexts:
    scPowerEthGroupEntry.setStatus("mandatory")
_ScPowerEthGroupId_Type = Integer32
_ScPowerEthGroupId_Object = MibTableColumn
scPowerEthGroupId = _ScPowerEthGroupId_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 1, 1, 1),
    _ScPowerEthGroupId_Type()
)
scPowerEthGroupId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scPowerEthGroupId.setStatus("mandatory")
_ScPowerEthGroupPsePSPowerFaultErrMsg_Type = DisplayString
_ScPowerEthGroupPsePSPowerFaultErrMsg_Object = MibTableColumn
scPowerEthGroupPsePSPowerFaultErrMsg = _ScPowerEthGroupPsePSPowerFaultErrMsg_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 1, 1, 2),
    _ScPowerEthGroupPsePSPowerFaultErrMsg_Type()
)
scPowerEthGroupPsePSPowerFaultErrMsg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scPowerEthGroupPsePSPowerFaultErrMsg.setStatus("mandatory")


class _ScPowerEthGroupPseDetectionProcess_Type(Integer32):
    """Custom type scPowerEthGroupPseDetectionProcess based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ScPowerEthGroupPseDetectionProcess_Type.__name__ = "Integer32"
_ScPowerEthGroupPseDetectionProcess_Object = MibTableColumn
scPowerEthGroupPseDetectionProcess = _ScPowerEthGroupPseDetectionProcess_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 1, 1, 3),
    _ScPowerEthGroupPseDetectionProcess_Type()
)
scPowerEthGroupPseDetectionProcess.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scPowerEthGroupPseDetectionProcess.setStatus("mandatory")
_ScPowerEthPortTable_Object = MibTable
scPowerEthPortTable = _ScPowerEthPortTable_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 2)
)
if mibBuilder.loadTexts:
    scPowerEthPortTable.setStatus("mandatory")
_ScPowerEthPortEntry_Object = MibTableRow
scPowerEthPortEntry = _ScPowerEthPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 2, 1)
)
scPowerEthPortEntry.setIndexNames(
    (0, "XSWITCH-MIB", "scPowerEthPortGroupId"),
    (0, "XSWITCH-MIB", "scPowerEthPortPortId"),
)
if mibBuilder.loadTexts:
    scPowerEthPortEntry.setStatus("mandatory")
_ScPowerEthPortGroupId_Type = Integer32
_ScPowerEthPortGroupId_Object = MibTableColumn
scPowerEthPortGroupId = _ScPowerEthPortGroupId_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 2, 1, 1),
    _ScPowerEthPortGroupId_Type()
)
scPowerEthPortGroupId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    scPowerEthPortGroupId.setStatus("mandatory")
_ScPowerEthPortPortId_Type = Integer32
_ScPowerEthPortPortId_Object = MibTableColumn
scPowerEthPortPortId = _ScPowerEthPortPortId_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 2, 1, 2),
    _ScPowerEthPortPortId_Type()
)
scPowerEthPortPortId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    scPowerEthPortPortId.setStatus("mandatory")
_ScPowerEthPortConsumptionPower_Type = Integer32
_ScPowerEthPortConsumptionPower_Object = MibTableColumn
scPowerEthPortConsumptionPower = _ScPowerEthPortConsumptionPower_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 3, 2, 1, 3),
    _ScPowerEthPortConsumptionPower_Type()
)
scPowerEthPortConsumptionPower.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scPowerEthPortConsumptionPower.setStatus("mandatory")
_ScPriorityQueuing_ObjectIdentity = ObjectIdentity
scPriorityQueuing = _ScPriorityQueuing_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 81, 28, 4)
)
_ScPriorityQueuingTable_Object = MibTable
scPriorityQueuingTable = _ScPriorityQueuingTable_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 4, 1)
)
if mibBuilder.loadTexts:
    scPriorityQueuingTable.setStatus("mandatory")
_ScPriorityQueuingEntry_Object = MibTableRow
scPriorityQueuingEntry = _ScPriorityQueuingEntry_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 4, 1, 1)
)
scPriorityQueuingEntry.setIndexNames(
    (0, "XSWITCH-MIB", "scPriorityQueuingModuleID"),
)
if mibBuilder.loadTexts:
    scPriorityQueuingEntry.setStatus("mandatory")


class _ScPriorityQueuingModuleID_Type(Integer32):
    """Custom type scPriorityQueuingModuleID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ScPriorityQueuingModuleID_Type.__name__ = "Integer32"
_ScPriorityQueuingModuleID_Object = MibTableColumn
scPriorityQueuingModuleID = _ScPriorityQueuingModuleID_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 4, 1, 1, 1),
    _ScPriorityQueuingModuleID_Type()
)
scPriorityQueuingModuleID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scPriorityQueuingModuleID.setStatus("mandatory")


class _ScPriorityQueuingNumberOfQueues_Type(Integer32):
    """Custom type scPriorityQueuingNumberOfQueues based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ScPriorityQueuingNumberOfQueues_Type.__name__ = "Integer32"
_ScPriorityQueuingNumberOfQueues_Object = MibTableColumn
scPriorityQueuingNumberOfQueues = _ScPriorityQueuingNumberOfQueues_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 4, 1, 1, 2),
    _ScPriorityQueuingNumberOfQueues_Type()
)
scPriorityQueuingNumberOfQueues.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scPriorityQueuingNumberOfQueues.setStatus("mandatory")


class _ScPriorityQueuingExpediteWRRFlg_Type(Integer32):
    """Custom type scPriorityQueuingExpediteWRRFlg based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ScPriorityQueuingExpediteWRRFlg_Type.__name__ = "Integer32"
_ScPriorityQueuingExpediteWRRFlg_Object = MibTableColumn
scPriorityQueuingExpediteWRRFlg = _ScPriorityQueuingExpediteWRRFlg_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 4, 1, 1, 3),
    _ScPriorityQueuingExpediteWRRFlg_Type()
)
scPriorityQueuingExpediteWRRFlg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    scPriorityQueuingExpediteWRRFlg.setStatus("mandatory")


class _ScPriorityQueuingModeControl_Type(Integer32):
    """Custom type scPriorityQueuingModeControl based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ScPriorityQueuingModeControl_Type.__name__ = "Integer32"
_ScPriorityQueuingModeControl_Object = MibTableColumn
scPriorityQueuingModeControl = _ScPriorityQueuingModeControl_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 4, 1, 1, 4),
    _ScPriorityQueuingModeControl_Type()
)
scPriorityQueuingModeControl.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scPriorityQueuingModeControl.setStatus("mandatory")


class _ScPriorityQueuingDefaultControl_Type(Integer32):
    """Custom type scPriorityQueuingDefaultControl based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ScPriorityQueuingDefaultControl_Type.__name__ = "Integer32"
_ScPriorityQueuingDefaultControl_Object = MibTableColumn
scPriorityQueuingDefaultControl = _ScPriorityQueuingDefaultControl_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 4, 1, 1, 5),
    _ScPriorityQueuingDefaultControl_Type()
)
scPriorityQueuingDefaultControl.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scPriorityQueuingDefaultControl.setStatus("mandatory")


class _ScPriorityQueuingWRRWeights_Type(OctetString):
    """Custom type scPriorityQueuingWRRWeights based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ScPriorityQueuingWRRWeights_Type.__name__ = "OctetString"
_ScPriorityQueuingWRRWeights_Object = MibTableColumn
scPriorityQueuingWRRWeights = _ScPriorityQueuingWRRWeights_Object(
    (1, 3, 6, 1, 4, 1, 81, 28, 4, 1, 1, 6),
    _ScPriorityQueuingWRRWeights_Type()
)
scPriorityQueuingWRRWeights.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    scPriorityQueuingWRRWeights.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"RowStatus": RowStatus,
       ...
       "scGenGroupDynamicVlans": scGenGroupDynamicVlans,
       "scGenGroupSecurityMacCount": scGenGroupSecurityMacCount,
       "scGenGroupBUPSAllocatedPower": scGenGroupBUPSAllocatedPower,
       ...
       "scGenGroupDot1xTable": scGenGroupDot1xTable,
       "scGenGroupDot1xEntry": scGenGroupDot1xEntry,
       "scGenGroupDot1xGroupId": scGenGroupDot1xGroupId,
       "scGenGroupDot1xSystemMaxNumSupplicant": scGenGroupDot1xSystemMaxNumSupplicant,
       "scGenGroupDot1xCurrentNumSupplicant": scGenGroupDot1xCurrentNumSupplicant,
       "scGenGroupDot1xCurrentNumAuthenticatedSupplicant": scGenGroupDot1xCurrentNumAuthenticatedSupplicant,
       "scGenGroupDot1xCurrentNumAuthenticatingSupplicant": scGenGroupDot1xCurrentNumAuthenticatingSupplicant,
       "scGenPort": scGenPort,
       ...
       "scGenPortCopyClassModuleLevel": scGenPortCopyClassModuleLevel,
       "scGenPortCopyClassStackLevel": scGenPortCopyClassStackLevel,
       ...
       "scGenPortSecureMACTable": scGenPortSecureMACTable,
       "scGenPortSecureMACEntry": scGenPortSecureMACEntry,
       "scGenPortSecureGroupID": scGenPortSecureGroupID,
       "scGenPortSecurePortId": scGenPortSecurePortId,
       "scGenPortSecureMAC": scGenPortSecureMAC,
       "scGenPortSecureMACStatus": scGenPortSecureMACStatus,
       "scGenPortDot1xMACTable": scGenPortDot1xMACTable,
       "scGenPortDot1xMACEntry": scGenPortDot1xMACEntry,
       "scGenPortDot1xMACGroupID": scGenPortDot1xMACGroupID,
       "scGenPortDot1xMACPortId": scGenPortDot1xMACPortId,
       "scGenPortDot1xMAC": scGenPortDot1xMAC,
       "scGenPortDot1xMACAuthPaeState": scGenPortDot1xMACAuthPaeState,
       "scGenPortDot1xMACAuthBackendAuthState": scGenPortDot1xMACAuthBackendAuthState,
       "scGenPortDot1xAuthAuthControlledPortStatus": scGenPortDot1xAuthAuthControlledPortStatus,
       "scGenPortDot1xPortTable": scGenPortDot1xPortTable,
       "scGenPortDot1xPortEntry": scGenPortDot1xPortEntry,
       "scGenPortDot1xPortGroupID": scGenPortDot1xPortGroupID,
       "scGenPortDot1xPortPortId": scGenPortDot1xPortPortId,
       "scGenPortDot1xPortMode": scGenPortDot1xPortMode,
       "scGenPortDot1xPortNumSupplicants": scGenPortDot1xPortNumSupplicants,
       "scGenPortDot1xPortNumAuthenticatedSupplicants": scGenPortDot1xPortNumAuthenticatedSupplicants,
       "scGenPortDot1xPortNumAuthenticatingSupplicants": scGenPortDot1xPortNumAuthenticatingSupplicants,
       ...
       "scGenSwitchWelcomeMessage": scGenSwitchWelcomeMessage,
       "scGenSwitchPromptMessage": scGenSwitchPromptMessage,
       "scGenSwitchMacAging": scGenSwitchMacAging,
       "scGenSwitchSecurityAction": scGenSwitchSecurityAction,
       "scGenSwitchDot1xPortMaxSuppNum": scGenSwitchDot1xPortMaxSuppNum,
       "scGenSwitchDot1xLldpTxVlanName": scGenSwitchDot1xLldpTxVlanName,
       ...
       "scPowerEthGroupInlineSWversion": scPowerEthGroupInlineSWversion,
       "scPowerEth": scPowerEth,
       "scPowerEthGroupTable": scPowerEthGroupTable,
       "scPowerEthGroupEntry": scPowerEthGroupEntry,
       "scPowerEthGroupId": scPowerEthGroupId,
       "scPowerEthGroupPsePSPowerFaultErrMsg": scPowerEthGroupPsePSPowerFaultErrMsg,
       "scPowerEthGroupPseDetectionProcess": scPowerEthGroupPseDetectionProcess,
       "scPowerEthPortTable": scPowerEthPortTable,
       "scPowerEthPortEntry": scPowerEthPortEntry,
       "scPowerEthPortGroupId": scPowerEthPortGroupId,
       "scPowerEthPortPortId": scPowerEthPortPortId,
       "scPowerEthPortConsumptionPower": scPowerEthPortConsumptionPower,
       "scPriorityQueuing": scPriorityQueuing,
       "scPriorityQueuingTable": scPriorityQueuingTable,
       "scPriorityQueuingEntry": scPriorityQueuingEntry,
       "scPriorityQueuingModuleID": scPriorityQueuingModuleID,
       "scPriorityQueuingNumberOfQueues": scPriorityQueuingNumberOfQueues,
       "scPriorityQueuingExpediteWRRFlg": scPriorityQueuingExpediteWRRFlg,
       "scPriorityQueuingModeControl": scPriorityQueuingModeControl,
       "scPriorityQueuingDefaultControl": scPriorityQueuingDefaultControl,
       "scPriorityQueuingWRRWeights": scPriorityQueuingWRRWeights}
)
