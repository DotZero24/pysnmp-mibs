...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DEVICE-LOCATION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:33:02 2025
...
_CdlCustomLocationStorageType_Type.__name__ = "StorageType"
...
class _CdlGeoLatitudeResolution_Type(SnmpAdminString):
    """Custom type cdlGeoLatitudeResolution based on SnmpAdminString"""
    defaultValue = OctetString("")


_CdlGeoLatitudeResolution_Type.__name__ = "SnmpAdminString"
...
class _CdlGeoLongitudeResolution_Type(SnmpAdminString):
    """Custom type cdlGeoLongitudeResolution based on SnmpAdminString"""
    defaultValue = OctetString("")


_CdlGeoLongitudeResolution_Type.__name__ = "SnmpAdminString"
...
_CdlGeoAltitudeResolution_Type.__name__ = "SnmpAdminString"
...
_CdlGeoResolution_Type.__name__ = "SnmpAdminString"
...
_CdlGeoStorageType_Type.__name__ = "StorageType"
...
cdlMIBCompliance.setObjects(
      *(("CISCO-DEVICE-LOCATION-MIB", "cdlLocationGroup"),
        ("CISCO-DEVICE-LOCATION-MIB", "cdlCivicAddrLocationGroup"))
)
if mibBuilder.loadTexts:
...
cdlMIBComplianceRev1.setObjects(
      *(("CISCO-DEVICE-LOCATION-MIB", "cdlLocationGroup"),
        ("CISCO-DEVICE-LOCATION-MIB", "cdlCivicAddrLocationGroup"),
        ("CISCO-DEVICE-LOCATION-MIB", "cdlCustomLocationGroup"),
        ("CISCO-DEVICE-LOCATION-MIB", "cdlGeoLocationGroup"),
