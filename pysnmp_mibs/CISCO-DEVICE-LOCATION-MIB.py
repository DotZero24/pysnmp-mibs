...
mibBuilder.exportSymbols("CISCO-DEVICE-LOCATION-MIB", cdlGeoLocationTable=cdlGeoLocationTable, cdlGeoStatus=cdlGeoStatus, cdlCustomLocationStatus=cdlCustomLocationStatus, cdlLocationEntry=cdlLocationEntry, cdlCivicAddrLocationStatus=cdlCivicAddrLocationStatus, cdlGeoStorageType=cdlGeoStorageType, cdlLocationPreferWeightType=cdlLocationPreferWeightType, cdlMIBNotifications=cdlMIBNotifications, cdlMIBCompliances=cdlMIBCompliances, cdlCustomLocationName=cdlCustomLocationName, cdlCivicAddrLocationEntry=cdlCivicAddrLocationEntry, cdlGeoLongitude=cdlGeoLongitude, cdlCustomLocationTable=cdlCustomLocationTable, cdlGeoLongitudeResolution=cdlGeoLongitudeResolution, cdlCivicAddrLocationTable=cdlCivicAddrLocationTable, cdlKey=cdlKey, cdlMIBObjects=cdlMIBObjects, cdlLocationTable=cdlLocationTable, cdlCustomLocationStorageType=cdlCustomLocationStorageType, cdlMIBComplianceRev1=cdlMIBComplianceRev1, cdlCivicAddrLocationStorageType=cdlCivicAddrLocationStorageType, cdlMIBScalars=cdlMIBScalars, cdlGeoLocationEntry=cdlGeoLocationEntry, cdlLocationTargetType=cdlLocationTargetType, cdlCustomLocationEntry=cdlCustomLocationEntry, ciscoDeviceLocationMIB=ciscoDeviceLocationMIB, cdlGeoResolution=cdlGeoResolution, cdlLocationPreferWeightGroup=cdlLocationPreferWeightGroup, cdlGeoAltitudeResolution=cdlGeoAltitudeResolution, cdlLocationIndex=cdlLocationIndex, cdlCustomLocationGroup=cdlCustomLocationGroup, cdlGeoLocationGroup=cdlGeoLocationGroup, cdlLocationGroup=cdlLocationGroup, cdlMIBConform=cdlMIBConform, cdlGeoLatitudeResolution=cdlGeoLatitudeResolution, cdlCivicAddrLocationValue=cdlCivicAddrLocationValue, cdlMIBCompliance=cdlMIBCompliance, cdlLocationPreferWeightEntry=cdlLocationPreferWeightEntry, cdlGeoAltitudeType=cdlGeoAltitudeType, cdlLocationSubTypeCapability=cdlLocationSubTypeCapability, cdlGeoLatitude=cdlGeoLatitude, cdlLocationTargetIdentifier=cdlLocationTargetIdentifier, cdlCivicAddrLocationType=cdlCivicAddrLocationType, cdlCustomLocationValue=cdlCustomLocationValue, cdlLocationCountryCode=cdlLocationCountryCode, cdlLocationPreferWeightTable=cdlLocationPreferWeightTable, cdlLocationPreferWeightValue=cdlLocationPreferWeightValue, cdlMIBGroups=cdlMIBGroups, cdlCivicAddrLocationGroup=cdlCivicAddrLocationGroup, PYSNMP_MODULE_ID=ciscoDeviceLocationMIB, cdlGeoAltitude=cdlGeoAltitude)
