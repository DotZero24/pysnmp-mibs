...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-ARP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:01:28 2025
...
pdnNetToMediaCompliance.setObjects(
      *(("PDN-ARP-MIB", "pdnNetToMediaParamsGroup"),
        ("PDN-ARP-MIB", "pdnNetToMediaConfigGroup"),
        ("PDN-ARP-MIB", "pdnNetToMedia8023ConfigGroup"),
        ("PDN-ARP-MIB", "pdnNetToMediaClearGroup"),
        ("PDN-ARP-MIB", "pdnNetToMediaProxyArpGroup"),
        ("PDN-ARP-MIB", "pdnNetToMediaConfigProxyArpGroup"),
        ("PDN-ARP-MIB", "pdnNetToMediaExtGroup"),
        ("PDN-ARP-MIB", "pdnNetToMediaLimitGroup"),
        ("PDN-ARP-MIB", "pdnNetToMediaUnauthorizedUserEventGroup"),
        ("PDN-ARP-MIB", "pdnNetToMediaParamsAprConfigGroup"),
        ("PDN-ARP-MIB", "pdnNetToMediaParamsAprTimeToNextGroup"))
)
if mibBuilder.loadTexts:
