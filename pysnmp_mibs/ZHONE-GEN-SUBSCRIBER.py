...
mibBuilder.exportSymbols("ZHONE-GEN-SUBSCRIBER", subInfoEntry=subInfoEntry, subVoiceVoipPassword=subVoiceVoipPassword, subVoiceVoipFramesPerPacket=subVoiceVoipFramesPerPacket, subRowStatus=subRowStatus, subVoiceHotlineInitialTimer=subVoiceHotlineInitialTimer, subDataCurrentIpAddr=subDataCurrentIpAddr, subVoicePotsEndPointIndex=subVoicePotsEndPointIndex, PYSNMP_MODULE_ID=zhoneSubscriberRecords, subVoiceDs1HuntGrpEndPointIndex2=subVoiceDs1HuntGrpEndPointIndex2, subVoiceHuntGroup=subVoiceHuntGroup, subId=subId, subVoiceEndPoint1AddressIndex=subVoiceEndPoint1AddressIndex, subVoiceIsdnEndPointIndex=subVoiceIsdnEndPointIndex, subMaxAllowedLineRate=subMaxAllowedLineRate, subVoiceV52Table=subVoiceV52Table, subVoiceTr008Entry=subVoiceTr008Entry, subVoiceVoipIpInterface=subVoiceVoipIpInterface, subVoiceElcpAal2Table=subVoiceElcpAal2Table, subVoiceVoipRegistrationServer=subVoiceVoipRegistrationServer, subVoiceV52Entry=subVoiceV52Entry, ZhoneCodecType=ZhoneCodecType, subVoiceVoipDirectoryNumber=subVoiceVoipDirectoryNumber, subVoiceIsdnSigEndPointIndex=subVoiceIsdnSigEndPointIndex, subVoiceGr303IgName=subVoiceGr303IgName, subVoiceVoipPlarUdpPort=subVoiceVoipPlarUdpPort, nextSubId=nextSubId, subVoiceTr008ChanNum=subVoiceTr008ChanNum, subVoiceVoipG726ByteOrder=subVoiceVoipG726ByteOrder, subLgId=subLgId, subVoiceIsdnSigEntry=subVoiceIsdnSigEntry, subDataIpIfOperStatus=subDataIpIfOperStatus, subVoiceEbsEntry=subVoiceEbsEntry, subInfoTable=subInfoTable, subVoicePotsHuntGrpEndPointIndex1=subVoicePotsHuntGrpEndPointIndex1, subVoiceVoipHotlineDN=subVoiceVoipHotlineDN, subIadType=subIadType, subVoiceV52IsdnChannelId=subVoiceV52IsdnChannelId, subVoiceElcpAal2EndPointIndex=subVoiceElcpAal2EndPointIndex, subVoiceElcpAal2LineGroupId=subVoiceElcpAal2LineGroupId, subNextVoiceConnectionIndex=subNextVoiceConnectionIndex, subVoiceConnectionDescription=subVoiceConnectionDescription, subVoiceVoipPreferredCodec=subVoiceVoipPreferredCodec, subVoiceDs1Ds0ChannelID=subVoiceDs1Ds0ChannelID, subDataConnectionTable=subDataConnectionTable, subVoiceAal2Vci=subVoiceAal2Vci, subVoiceDs1EndPointIndex=subVoiceDs1EndPointIndex, subVoiceVoipAuthUsername=subVoiceVoipAuthUsername, subVoiceAal2Table=subVoiceAal2Table, subVoiceElcpAal2Entry=subVoiceElcpAal2Entry, subVoiceV52EndPointIndex=subVoiceV52EndPointIndex, subVoiceAal2LineGroupId=subVoiceAal2LineGroupId, subVoiceVoipEntry=subVoiceVoipEntry, subVoiceDs1HuntGrpEndPointIndex1=subVoiceDs1HuntGrpEndPointIndex1, subVoiceEndPoint2AddressIndex=subVoiceEndPoint2AddressIndex, subVoiceConnectionEntry=subVoiceConnectionEntry, subVoiceElcpAal2PortType=subVoiceElcpAal2PortType, subDataConnectionEntry=subDataConnectionEntry, subVoicePotsEntry=subVoicePotsEntry, subVoiceElcpAal2Vci=subVoiceElcpAal2Vci, subProviderId=subProviderId, subVoiceAal2Cid=subVoiceAal2Cid, subVoiceV52UserPortId=subVoiceV52UserPortId, subVoiceTr008GroupId=subVoiceTr008GroupId, nextEndPointIndex=nextEndPointIndex, subDataUserPassword=subDataUserPassword, subVoiceFeatureSetOne=subVoiceFeatureSetOne, subVoiceAal2Entry=subVoiceAal2Entry, subVoiceVoipUserName=subVoiceVoipUserName, subMaxCapableLineRate=subMaxCapableLineRate, subVoiceDs1LineGroupId=subVoiceDs1LineGroupId, subVoiceVoipPLAR=subVoiceVoipPLAR, subDataRowStatus=subDataRowStatus, subVoiceIsdnTable=subVoiceIsdnTable, subVoiceAal2EndPointIndex=subVoiceAal2EndPointIndex, subVoiceAdminStatus=subVoiceAdminStatus, subDataStatsStatus=subDataStatsStatus, subVoiceEbsEndPointIndex=subVoiceEbsEndPointIndex, T38FaxType=T38FaxType, subVoiceIsdnSigHuntGrpEndPointIndex2=subVoiceIsdnSigHuntGrpEndPointIndex2, subVoicePotsHuntGrpEndPointIndex3=subVoicePotsHuntGrpEndPointIndex3, zhoneSubscriberRecords=zhoneSubscriberRecords, subVoiceIsdnChannelId=subVoiceIsdnChannelId, subVoiceIsdnSigEntryIndex=subVoiceIsdnSigEntryIndex, subVoiceIsdnEntry=subVoiceIsdnEntry, subVoiceGr303Entry=subVoiceGr303Entry, subVoiceEbsTable=subVoiceEbsTable, subVoiceV52UserType=subVoiceV52UserType, subDataUserLogOnId=subDataUserLogOnId, subVoiceTr008EndPointIndex=subVoiceTr008EndPointIndex, subVoiceConnectionTable=subVoiceConnectionTable, subVoiceConnectionIndex=subVoiceConnectionIndex, subVoiceIsdnSigDirectoryNumber=subVoiceIsdnSigDirectoryNumber, subVoiceV52InterfaceName=subVoiceV52InterfaceName, subVoiceAal2Vpi=subVoiceAal2Vpi, subVoiceVoipT38Fax=subVoiceVoipT38Fax, subVoiceElcpAal2IsdnChannelId=subVoiceElcpAal2IsdnChannelId, subVoiceElcpAal2Vpi=subVoiceElcpAal2Vpi, subVoiceGr303IgCrv=subVoiceGr303IgCrv, subVoiceVoipEndPointIndex=subVoiceVoipEndPointIndex, subVoiceVoipPlarDestIpAddrType=subVoiceVoipPlarDestIpAddrType, subVoiceIsdnSigHuntGrpEndPointIndex1=subVoiceIsdnSigHuntGrpEndPointIndex1, subVoiceIsdnLineGroupId=subVoiceIsdnLineGroupId, subVoiceDs1HuntGrpEndPointIndex3=subVoiceDs1HuntGrpEndPointIndex3, subVoicePotsTable=subVoicePotsTable, subName=subName, subVoiceTr008Table=subVoiceTr008Table, subDataIfIndex=subDataIfIndex, subVoiceConnectionType=subVoiceConnectionType, subDataIpAddrInUse=subDataIpAddrInUse, subVoiceDs1Table=subVoiceDs1Table, subVoiceVoipTable=subVoiceVoipTable, subVoiceIsdnType=subVoiceIsdnType, subVoiceElcpAal2PortId=subVoiceElcpAal2PortId, subVoiceIsdnSigHuntGrpEndPointIndex3=subVoiceIsdnSigHuntGrpEndPointIndex3, subVoiceGr303Table=subVoiceGr303Table, subVoiceVoipPlarDestIpAddr=subVoiceVoipPlarDestIpAddr, subVoicePotsHuntGrpEndPointIndex2=subVoicePotsHuntGrpEndPointIndex2, subVoiceDs1Entry=subVoiceDs1Entry, subVoiceVoipG711Fallback=subVoiceVoipG711Fallback, subVoiceGr303EndPointIndex=subVoiceGr303EndPointIndex, subVoicePotsLineGroupId=subVoicePotsLineGroupId, subVoiceEbsLineGroupId=subVoiceEbsLineGroupId, subDataMaxAddrAllowed=subDataMaxAddrAllowed, subVoiceIsdnSigTable=subVoiceIsdnSigTable, zhoneSubscriberObjectsGroup=zhoneSubscriberObjectsGroup, subVoiceRowStatus=subVoiceRowStatus)
