...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/L2TP-MIB
...
ModuleIdentity, transmission, Integer32, Gauge32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, MibIdentifier, Counter64, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "transmission", "Integer32", "Gauge32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "MibIdentifier", "Counter64", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("L2TP-MIB", l2tpMIBReadOnlyCompliance=l2tpMIBReadOnlyCompliance, l2tpTunnelStatsDrainingTunnel=l2tpTunnelStatsDrainingTunnel, l2tpDomainConfigAdminState=l2tpDomainConfigAdminState, l2tpDomainStatsControlRxOctets=l2tpDomainStatsControlRxOctets, l2tpDomainConfigTunnelSecurity=l2tpDomainConfigTunnelSecurity, l2tpSessionStatsCallType=l2tpSessionStatsCallType, l2tpTunnelStatsControlAckTO=l2tpTunnelStatsControlAckTO, l2tpSessionMapIfIndex=l2tpSessionMapIfIndex, l2tpDomainGroup=l2tpDomainGroup, l2tpMIBFullCompliance=l2tpMIBFullCompliance, l2tpSessionStatsRxSeq=l2tpSessionStatsRxSeq, l2tpMappingGroup=l2tpMappingGroup, l2tpConfigGroup=l2tpConfigGroup, l2tp=l2tp, l2tpSessionStatsTxSeq=l2tpSessionStatsTxSeq, l2tpNotifications=l2tpNotifications, l2tpTunnelStatsFailedSessions=l2tpTunnelStatsFailedSessions, l2tpTunnelStatsTable=l2tpTunnelStatsTable, l2tpTunnelMapTable=l2tpTunnelMapTable, l2tpTunnelStatsLastErrorMessage=l2tpTunnelStatsLastErrorMessage, l2tpTunnelStatsRxSeqAck=l2tpTunnelStatsRxSeqAck, l2tpIpUdpGroup=l2tpIpUdpGroup, l2tpDomainConfigAuth=l2tpDomainConfigAuth, l2tpSessionStatsTable=l2tpSessionStatsTable, l2tpSessionStatsCLID=l2tpSessionStatsCLID, l2tpDrainingTunnels=l2tpDrainingTunnels, l2tpSessionStatsTxConnectSpeed=l2tpSessionStatsTxConnectSpeed, l2tpTunnelMapIfIndex=l2tpTunnelMapIfIndex, l2tpDomainStatsEntry=l2tpDomainStatsEntry, l2tpStatsGroup=l2tpStatsGroup, l2tpDomainStatsPayloadHCTxPkts=l2tpDomainStatsPayloadHCTxPkts, l2tpTunnelConfigSecurity=l2tpTunnelConfigSecurity, l2tpSessionMapEntry=l2tpSessionMapEntry, l2tpSessionStatsOutSequence=l2tpSessionStatsOutSequence, l2tpDomainConfigTunnelIdleTO=l2tpDomainConfigTunnelIdleTO, l2tpDomainStatsPayloadHCRxDiscs=l2tpDomainStatsPayloadHCRxDiscs, l2tpIpUdpTraps=l2tpIpUdpTraps, l2tpSecurityGroup=l2tpSecurityGroup, l2tpSessionMapTunnelIfIndex=l2tpSessionMapTunnelIfIndex, l2tpTunnelStatsBearerCaps=l2tpTunnelStatsBearerCaps, l2tpTunnelConfigDrainTunnel=l2tpTunnelConfigDrainTunnel, l2tpTunnelConfigEntry=l2tpTunnelConfigEntry, l2tpTunnelConfigReassemblyTO=l2tpTunnelConfigReassemblyTO, l2tpTunnelStatsTxSeq=l2tpTunnelStatsTxSeq, l2tpConfig=l2tpConfig, l2tpDomainConfigStatus=l2tpDomainConfigStatus, l2tpDomainStatsFailedSessions=l2tpDomainStatsFailedSessions, l2tpTunnelStatsLastErrorCode=l2tpTunnelStatsLastErrorCode, l2tpTunnelConfigTable=l2tpTunnelConfigTable, l2tpDomainStatsPayloadHCTxOctets=l2tpDomainStatsPayloadHCTxOctets, l2tpSessionStatsEntry=l2tpSessionStatsEntry, l2tpDomainStatsDrainingTunnels=l2tpDomainStatsDrainingTunnels, l2tpDomainStatsControlTxOctets=l2tpDomainStatsControlTxOctets, l2tpTunnelConfigAuth=l2tpTunnelConfigAuth, l2tpTunnelStatsControlRxPkts=l2tpTunnelStatsControlRxPkts, l2tpDomainConfigPayloadSeq=l2tpDomainConfigPayloadSeq, l2tpDomainConfigEntry=l2tpDomainConfigEntry, l2tpDomainConfigSecret=l2tpDomainConfigSecret, l2tpTunnelStatsControlTxPkts=l2tpTunnelStatsControlTxPkts, l2tpTunnelStatsRemoteFirmwareRev=l2tpTunnelStatsRemoteFirmwareRev, l2tpDomainConfigTable=l2tpDomainConfigTable, l2tpTrapGroup=l2tpTrapGroup, l2tpDomainConfigControlMaxRetx=l2tpDomainConfigControlMaxRetx, l2tpTunnelStatsEntry=l2tpTunnelStatsEntry, l2tpTunnelStatsControlTxZLB=l2tpTunnelStatsControlTxZLB, l2tpIpUdpObjects=l2tpIpUdpObjects, l2tpDomainStatsControlHCRxPkts=l2tpDomainStatsControlHCRxPkts, l2tpSessionStatsAuthMethod=l2tpSessionStatsAuthMethod, l2tpSessionStatsState=l2tpSessionStatsState, l2tpSessionStatsProxyLcp=l2tpSessionStatsProxyLcp, l2tpDomainConfigTunnelHelloInt=l2tpDomainConfigTunnelHelloInt, l2tpSessionStatsRxConnectSpeed=l2tpSessionStatsRxConnectSpeed, l2tpStats=l2tpStats, l2tpTunnelStatsInitiated=l2tpTunnelStatsInitiated, l2tpSessionStatsDNIS=l2tpSessionStatsDNIS, PYSNMP_MODULE_ID=l2tp, l2tpSessionStatsTunnelIfIndex=l2tpSessionStatsTunnelIfIndex, l2tpSessionStatsCallSerialNumber=l2tpSessionStatsCallSerialNumber, l2tpTunnelStatsState=l2tpTunnelStatsState, l2tpTunnelStatsRemoteProtocolVer=l2tpTunnelStatsRemoteProtocolVer, l2tpUdpStatsEntry=l2tpUdpStatsEntry, l2tpDomainStatsActiveTunnels=l2tpDomainStatsActiveTunnels, l2tpDomainStatsPayloadHCRxOctets=l2tpDomainStatsPayloadHCRxOctets, l2tpTransports=l2tpTransports, l2tpSessionStatsSubAddress=l2tpSessionStatsSubAddress, l2tpDomainStatsPayloadRxDiscs=l2tpDomainStatsPayloadRxDiscs, l2tpHCPacketGroup=l2tpHCPacketGroup, l2tpUdpStatsIfIndex=l2tpUdpStatsIfIndex, l2tpDomainStatsControlTxPkts=l2tpDomainStatsControlTxPkts, l2tpDomainStatsPayloadTxPkts=l2tpDomainStatsPayloadTxPkts, l2tpTunnelStatsControlOutOfWin=l2tpTunnelStatsControlOutOfWin, l2tpGroups=l2tpGroups, l2tpDrainTunnels=l2tpDrainTunnels, l2tpTunnelConfigPayloadSeq=l2tpTunnelConfigPayloadSeq, l2tpTunnelStatsInitialRemoteRWS=l2tpTunnelStatsInitialRemoteRWS, l2tpDomainStatsPayloadTxOctets=l2tpDomainStatsPayloadTxOctets, l2tpTunnelStatsRxSeq=l2tpTunnelStatsRxSeq, l2tpUdpStatsPeerPort=l2tpUdpStatsPeerPort, l2tpTunnelStatsTotalSessions=l2tpTunnelStatsTotalSessions, l2tpFirmwareRev=l2tpFirmwareRev, l2tpSessionStatsCallBearerType=l2tpSessionStatsCallBearerType, l2tpDomainStatsControlHCTxOctets=l2tpDomainStatsControlHCTxOctets, l2tpDomainConfigStorageType=l2tpDomainConfigStorageType, l2tpTunnelConfigSecret=l2tpTunnelConfigSecret, L2tpMilliSeconds=L2tpMilliSeconds, l2tpTunnelConfigControlMaxRetx=l2tpTunnelConfigControlMaxRetx, l2tpDomainStatsTotalTunnels=l2tpDomainStatsTotalTunnels, l2tpDomainConfigReassemblyTO=l2tpDomainConfigReassemblyTO, l2tpTunnelStatsControlRxZLB=l2tpTunnelStatsControlRxZLB, l2tpTunnelConfigControlRWS=l2tpTunnelConfigControlRWS, l2tpDomainStatsActiveSessions=l2tpDomainStatsActiveSessions, l2tpDomainStatsFailedAuths=l2tpDomainStatsFailedAuths, l2tpDomainStatsPayloadRxOctets=l2tpDomainStatsPayloadRxOctets, l2tpTunnelAuthFailure=l2tpTunnelAuthFailure, l2tpSessionStatsReassemblyTO=l2tpSessionStatsReassemblyTO, l2tpSessionStatsLocalSID=l2tpSessionStatsLocalSID, l2tpTunnelStatsFramingCaps=l2tpTunnelStatsFramingCaps, l2tpTunnelStatsControlOutOfSeq=l2tpTunnelStatsControlOutOfSeq, l2tpSessionStatsFramingType=l2tpSessionStatsFramingType, l2tpDomainStatsPayloadRxPkts=l2tpDomainStatsPayloadRxPkts, l2tpVendorName=l2tpVendorName, l2tpSessionMapStatus=l2tpSessionMapStatus, l2tpDomainStatsTable=l2tpDomainStatsTable, l2tpTunnelConfigHelloInterval=l2tpTunnelConfigHelloInterval, l2tpProtocolVersions=l2tpProtocolVersions, l2tpSessionMapLocalSID=l2tpSessionMapLocalSID, l2tpDomainStatsControlHCTxPkts=l2tpDomainStatsControlHCTxPkts, l2tpTunnelStatsLastResultCode=l2tpTunnelStatsLastResultCode, l2tpTunnelMapEntry=l2tpTunnelMapEntry, l2tpTunnelStatsRemoteHostName=l2tpTunnelStatsRemoteHostName, l2tpDomainConfigControlMaxRetxTO=l2tpDomainConfigControlMaxRetxTO, l2tpDomainConfigDrainTunnels=l2tpDomainConfigDrainTunnels, l2tpDomainStatsControlHCRxOctets=l2tpDomainStatsControlHCRxOctets, l2tpDomainStatsPayloadHCRxPkts=l2tpDomainStatsPayloadHCRxPkts, l2tpTunnelStatsActiveSessions=l2tpTunnelStatsActiveSessions, l2tpDomainStatsControlRxPkts=l2tpDomainStatsControlRxPkts, l2tpTunnelConfigProxyPPPAuth=l2tpTunnelConfigProxyPPPAuth, l2tpTunnelStatsCurrentRemoteRWS=l2tpTunnelStatsCurrentRemoteRWS, l2tpSessionStatsPhysChanId=l2tpSessionStatsPhysChanId, l2tpTunnelConfigTransport=l2tpTunnelConfigTransport, l2tpSessionStatsRemoteSID=l2tpSessionStatsRemoteSID, l2tpTunnelConfigIdleTimeout=l2tpTunnelConfigIdleTimeout, l2tpSessionStatsIfIndex=l2tpSessionStatsIfIndex, l2tpSessionStatsSequencingState=l2tpSessionStatsSequencingState, l2tpConformance=l2tpConformance, l2tpSessionStatsUserName=l2tpSessionStatsUserName, l2tpDomainStatsTotalSessions=l2tpDomainStatsTotalSessions, l2tpTunnelConfigDomainId=l2tpTunnelConfigDomainId, l2tpDomainConfigControlRWS=l2tpDomainConfigControlRWS, l2tpTransportIpUdp=l2tpTransportIpUdp, l2tpTunnelConfigIfIndex=l2tpTunnelConfigIfIndex, l2tpDomainStatsFailedTunnels=l2tpDomainStatsFailedTunnels, l2tpUdpStatsLocalPort=l2tpUdpStatsLocalPort, l2tpTunnelMapLocalTID=l2tpTunnelMapLocalTID, l2tpTunnelStatsRemoteTID=l2tpTunnelStatsRemoteTID, l2tpAdminState=l2tpAdminState, l2tpTunnelStatsLocalTID=l2tpTunnelStatsLocalTID, l2tpObjects=l2tpObjects, l2tpSessionMapTable=l2tpSessionMapTable, l2tpDomainConfigProxyPPPAuth=l2tpDomainConfigProxyPPPAuth, l2tpCompliances=l2tpCompliances, l2tpDomainConfigId=l2tpDomainConfigId, l2tpTunnelConfigControlMaxRetxTO=l2tpTunnelConfigControlMaxRetxTO, l2tpScalar=l2tpScalar, l2tpTunnelStatsTxSeqAck=l2tpTunnelStatsTxSeqAck, l2tpSessionStatsPrivateGroupID=l2tpSessionStatsPrivateGroupID, l2tpTunnelStatsRemoteVendorName=l2tpTunnelStatsRemoteVendorName, l2tpUdpStatsTable=l2tpUdpStatsTable)
