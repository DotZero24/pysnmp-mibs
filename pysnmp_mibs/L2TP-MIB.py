...
transmission, MibIdentifier, NotificationType, Integer32, Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, Counter64, ModuleIdentity, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "transmission", "MibIdentifier", "NotificationType", "Integer32", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "Counter64", "ModuleIdentity", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("L2TP-MIB", l2tpTransports=l2tpTransports, l2tpDomainConfigEntry=l2tpDomainConfigEntry, l2tpTunnelConfigDrainTunnel=l2tpTunnelConfigDrainTunnel, l2tpSessionStatsPhysChanId=l2tpSessionStatsPhysChanId, l2tpSessionStatsRxSeq=l2tpSessionStatsRxSeq, l2tpDomainStatsControlHCTxOctets=l2tpDomainStatsControlHCTxOctets, l2tpDomainStatsEntry=l2tpDomainStatsEntry, l2tpDomainConfigPayloadSeq=l2tpDomainConfigPayloadSeq, l2tpAdminState=l2tpAdminState, l2tpDomainStatsControlHCRxOctets=l2tpDomainStatsControlHCRxOctets, l2tpTunnelStatsControlTxPkts=l2tpTunnelStatsControlTxPkts, l2tpDomainStatsFailedTunnels=l2tpDomainStatsFailedTunnels, l2tpDomainStatsControlRxPkts=l2tpDomainStatsControlRxPkts, l2tpSessionStatsIfIndex=l2tpSessionStatsIfIndex, l2tpTunnelConfigControlMaxRetxTO=l2tpTunnelConfigControlMaxRetxTO, l2tpTunnelStatsTxSeqAck=l2tpTunnelStatsTxSeqAck, l2tpSessionStatsEntry=l2tpSessionStatsEntry, l2tpDomainStatsControlRxOctets=l2tpDomainStatsControlRxOctets, l2tpDomainStatsActiveTunnels=l2tpDomainStatsActiveTunnels, l2tpSessionStatsTunnelIfIndex=l2tpSessionStatsTunnelIfIndex, l2tpTunnelStatsFramingCaps=l2tpTunnelStatsFramingCaps, l2tpTunnelStatsControlAckTO=l2tpTunnelStatsControlAckTO, l2tpTunnelConfigProxyPPPAuth=l2tpTunnelConfigProxyPPPAuth, l2tpDomainStatsPayloadRxPkts=l2tpDomainStatsPayloadRxPkts, l2tpTunnelStatsLastErrorMessage=l2tpTunnelStatsLastErrorMessage, l2tpTunnelStatsControlRxZLB=l2tpTunnelStatsControlRxZLB, l2tpSessionStatsSubAddress=l2tpSessionStatsSubAddress, l2tpDomainConfigProxyPPPAuth=l2tpDomainConfigProxyPPPAuth, l2tpDomainConfigStorageType=l2tpDomainConfigStorageType, l2tpDomainStatsPayloadHCRxPkts=l2tpDomainStatsPayloadHCRxPkts, l2tpTunnelConfigHelloInterval=l2tpTunnelConfigHelloInterval, l2tpMappingGroup=l2tpMappingGroup, l2tpSessionMapEntry=l2tpSessionMapEntry, l2tpTunnelStatsInitiated=l2tpTunnelStatsInitiated, l2tpTunnelConfigIdleTimeout=l2tpTunnelConfigIdleTimeout, l2tpSessionStatsUserName=l2tpSessionStatsUserName, l2tpNotifications=l2tpNotifications, l2tpTunnelStatsRemoteHostName=l2tpTunnelStatsRemoteHostName, l2tpTunnelConfigDomainId=l2tpTunnelConfigDomainId, l2tpTunnelStatsBearerCaps=l2tpTunnelStatsBearerCaps, l2tpDomainStatsFailedAuths=l2tpDomainStatsFailedAuths, l2tpDomainConfigTable=l2tpDomainConfigTable, l2tpSessionStatsTable=l2tpSessionStatsTable, l2tpDomainStatsControlHCTxPkts=l2tpDomainStatsControlHCTxPkts, l2tpSessionStatsSequencingState=l2tpSessionStatsSequencingState, l2tpHCPacketGroup=l2tpHCPacketGroup, l2tpTunnelStatsLastResultCode=l2tpTunnelStatsLastResultCode, l2tpTunnelAuthFailure=l2tpTunnelAuthFailure, l2tpSessionStatsReassemblyTO=l2tpSessionStatsReassemblyTO, l2tpUdpStatsEntry=l2tpUdpStatsEntry, l2tpDomainStatsPayloadHCRxOctets=l2tpDomainStatsPayloadHCRxOctets, l2tpTunnelStatsEntry=l2tpTunnelStatsEntry, l2tpSessionMapTunnelIfIndex=l2tpSessionMapTunnelIfIndex, l2tpTransportIpUdp=l2tpTransportIpUdp, l2tpSessionStatsFramingType=l2tpSessionStatsFramingType, l2tpStatsGroup=l2tpStatsGroup, l2tpTunnelStatsLastErrorCode=l2tpTunnelStatsLastErrorCode, l2tpUdpStatsLocalPort=l2tpUdpStatsLocalPort, l2tpTunnelStatsInitialRemoteRWS=l2tpTunnelStatsInitialRemoteRWS, l2tpConfig=l2tpConfig, l2tpTunnelStatsCurrentRemoteRWS=l2tpTunnelStatsCurrentRemoteRWS, l2tpTunnelConfigControlMaxRetx=l2tpTunnelConfigControlMaxRetx, l2tpTunnelConfigReassemblyTO=l2tpTunnelConfigReassemblyTO, l2tpSessionStatsLocalSID=l2tpSessionStatsLocalSID, l2tpSessionMapLocalSID=l2tpSessionMapLocalSID, l2tpDomainStatsControlTxOctets=l2tpDomainStatsControlTxOctets, l2tpDomainConfigControlRWS=l2tpDomainConfigControlRWS, l2tpDomainStatsTotalSessions=l2tpDomainStatsTotalSessions, l2tpTunnelConfigSecret=l2tpTunnelConfigSecret, l2tpDomainConfigControlMaxRetx=l2tpDomainConfigControlMaxRetx, l2tpDomainStatsPayloadTxOctets=l2tpDomainStatsPayloadTxOctets, l2tpSessionStatsOutSequence=l2tpSessionStatsOutSequence, l2tpSessionStatsTxSeq=l2tpSessionStatsTxSeq, l2tpSessionStatsCallType=l2tpSessionStatsCallType, l2tpDomainGroup=l2tpDomainGroup, l2tpSessionStatsCLID=l2tpSessionStatsCLID, l2tpTunnelStatsControlRxPkts=l2tpTunnelStatsControlRxPkts, l2tpDomainStatsPayloadRxOctets=l2tpDomainStatsPayloadRxOctets, l2tpUdpStatsPeerPort=l2tpUdpStatsPeerPort, l2tpDomainStatsPayloadHCRxDiscs=l2tpDomainStatsPayloadHCRxDiscs, l2tpTunnelStatsRxSeqAck=l2tpTunnelStatsRxSeqAck, l2tpDomainConfigSecret=l2tpDomainConfigSecret, l2tpConformance=l2tpConformance, l2tp=l2tp, l2tpDomainStatsControlHCRxPkts=l2tpDomainStatsControlHCRxPkts, l2tpSessionStatsProxyLcp=l2tpSessionStatsProxyLcp, l2tpDomainConfigTunnelHelloInt=l2tpDomainConfigTunnelHelloInt, l2tpSessionMapTable=l2tpSessionMapTable, l2tpDomainStatsPayloadRxDiscs=l2tpDomainStatsPayloadRxDiscs, l2tpTunnelStatsDrainingTunnel=l2tpTunnelStatsDrainingTunnel, L2tpMilliSeconds=L2tpMilliSeconds, l2tpDomainStatsFailedSessions=l2tpDomainStatsFailedSessions, PYSNMP_MODULE_ID=l2tp, l2tpDomainConfigAdminState=l2tpDomainConfigAdminState, l2tpIpUdpGroup=l2tpIpUdpGroup, l2tpDomainConfigControlMaxRetxTO=l2tpDomainConfigControlMaxRetxTO, l2tpDrainTunnels=l2tpDrainTunnels, l2tpTunnelStatsActiveSessions=l2tpTunnelStatsActiveSessions, l2tpVendorName=l2tpVendorName, l2tpSessionStatsState=l2tpSessionStatsState, l2tpDomainStatsDrainingTunnels=l2tpDomainStatsDrainingTunnels, l2tpIpUdpTraps=l2tpIpUdpTraps, l2tpTunnelConfigTable=l2tpTunnelConfigTable, l2tpTunnelStatsTable=l2tpTunnelStatsTable, l2tpTunnelMapTable=l2tpTunnelMapTable, l2tpScalar=l2tpScalar, l2tpDomainConfigId=l2tpDomainConfigId, l2tpDomainConfigReassemblyTO=l2tpDomainConfigReassemblyTO, l2tpSecurityGroup=l2tpSecurityGroup, l2tpDomainConfigTunnelSecurity=l2tpDomainConfigTunnelSecurity, l2tpSessionStatsRxConnectSpeed=l2tpSessionStatsRxConnectSpeed, l2tpSessionStatsCallBearerType=l2tpSessionStatsCallBearerType, l2tpTunnelStatsRemoteProtocolVer=l2tpTunnelStatsRemoteProtocolVer, l2tpDomainConfigDrainTunnels=l2tpDomainConfigDrainTunnels, l2tpTunnelStatsTotalSessions=l2tpTunnelStatsTotalSessions, l2tpCompliances=l2tpCompliances, l2tpStats=l2tpStats, l2tpTunnelConfigIfIndex=l2tpTunnelConfigIfIndex, l2tpSessionStatsCallSerialNumber=l2tpSessionStatsCallSerialNumber, l2tpSessionStatsAuthMethod=l2tpSessionStatsAuthMethod, l2tpTunnelConfigEntry=l2tpTunnelConfigEntry, l2tpTunnelStatsFailedSessions=l2tpTunnelStatsFailedSessions, l2tpTunnelConfigTransport=l2tpTunnelConfigTransport, l2tpSessionStatsRemoteSID=l2tpSessionStatsRemoteSID, l2tpTunnelStatsTxSeq=l2tpTunnelStatsTxSeq, l2tpTunnelStatsRxSeq=l2tpTunnelStatsRxSeq, l2tpUdpStatsIfIndex=l2tpUdpStatsIfIndex, l2tpDomainConfigAuth=l2tpDomainConfigAuth, l2tpTunnelMapLocalTID=l2tpTunnelMapLocalTID, l2tpTunnelStatsRemoteTID=l2tpTunnelStatsRemoteTID, l2tpFirmwareRev=l2tpFirmwareRev, l2tpDomainStatsTotalTunnels=l2tpDomainStatsTotalTunnels, l2tpMIBFullCompliance=l2tpMIBFullCompliance, l2tpGroups=l2tpGroups, l2tpTunnelStatsLocalTID=l2tpTunnelStatsLocalTID, l2tpConfigGroup=l2tpConfigGroup, l2tpProtocolVersions=l2tpProtocolVersions, l2tpTunnelStatsRemoteFirmwareRev=l2tpTunnelStatsRemoteFirmwareRev, l2tpMIBReadOnlyCompliance=l2tpMIBReadOnlyCompliance, l2tpDrainingTunnels=l2tpDrainingTunnels, l2tpDomainConfigTunnelIdleTO=l2tpDomainConfigTunnelIdleTO, l2tpObjects=l2tpObjects, l2tpDomainConfigStatus=l2tpDomainConfigStatus, l2tpDomainStatsTable=l2tpDomainStatsTable, l2tpTrapGroup=l2tpTrapGroup, l2tpDomainStatsPayloadHCTxOctets=l2tpDomainStatsPayloadHCTxOctets, l2tpTunnelConfigPayloadSeq=l2tpTunnelConfigPayloadSeq, l2tpIpUdpObjects=l2tpIpUdpObjects, l2tpSessionMapStatus=l2tpSessionMapStatus, l2tpUdpStatsTable=l2tpUdpStatsTable, l2tpTunnelMapEntry=l2tpTunnelMapEntry, l2tpSessionStatsDNIS=l2tpSessionStatsDNIS, l2tpTunnelConfigAuth=l2tpTunnelConfigAuth, l2tpTunnelStatsControlOutOfWin=l2tpTunnelStatsControlOutOfWin, l2tpTunnelStatsRemoteVendorName=l2tpTunnelStatsRemoteVendorName, l2tpTunnelConfigSecurity=l2tpTunnelConfigSecurity, l2tpSessionStatsTxConnectSpeed=l2tpSessionStatsTxConnectSpeed, l2tpTunnelMapIfIndex=l2tpTunnelMapIfIndex, l2tpSessionStatsPrivateGroupID=l2tpSessionStatsPrivateGroupID, l2tpTunnelStatsControlOutOfSeq=l2tpTunnelStatsControlOutOfSeq, l2tpDomainStatsPayloadTxPkts=l2tpDomainStatsPayloadTxPkts, l2tpDomainStatsPayloadHCTxPkts=l2tpDomainStatsPayloadHCTxPkts, l2tpSessionMapIfIndex=l2tpSessionMapIfIndex, l2tpTunnelStatsState=l2tpTunnelStatsState, l2tpTunnelConfigControlRWS=l2tpTunnelConfigControlRWS, l2tpTunnelStatsControlTxZLB=l2tpTunnelStatsControlTxZLB, l2tpDomainStatsActiveSessions=l2tpDomainStatsActiveSessions, l2tpDomainStatsControlTxPkts=l2tpDomainStatsControlTxPkts)
