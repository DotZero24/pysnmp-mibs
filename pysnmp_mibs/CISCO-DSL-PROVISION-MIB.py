...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DSL-PROVISION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:05 2025
...
if mibBuilder.loadTexts:
    ciscoDslProvisionMIB.setRevisions(
        ("2005-12-14 00:00",
         "1999-06-18 00:00")
    )
...
_CdslVTIpAddressMask_Type.__name__ = "IpAddress"
...
_CdslVTIpIfIndex_Type.__name__ = "InterfaceIndexOrZero"
...
_CdslVTPppChapEncrypType_Type.__name__ = "TruthValue"
...
_CdslVTPppChapWaitPeer_Type.__name__ = "TruthValue"
...
_CdslVTPppPapEncrypType_Type.__name__ = "TruthValue"
...
_CdslVTRowStatus_Type.__name__ = "RowStatus"
...
_CdslAtmPvcRowStatus_Type.__name__ = "RowStatus"
...
cdslVcClassEntry.setIndexNames(
    (0, "CISCO-DSL-PROVISION-MIB", "cdslNrpSlotIndex"),
    (0, "CISCO-DSL-PROVISION-MIB", "cdslVcClassName"),
)
if mibBuilder.loadTexts:
...
_CdslVcClassRowStatus_Type.__name__ = "RowStatus"
...
ciscoDslProvMIBBasicCompliance.setObjects(
      *(("CISCO-DSL-PROVISION-MIB", "ciscoNrpSlotGroup"),
        ("CISCO-DSL-PROVISION-MIB", "ciscoVirtualTemplateGroup"),
        ("CISCO-DSL-PROVISION-MIB", "ciscoIpPoolGroup"),
        ("CISCO-DSL-PROVISION-MIB", "ciscoDslPVCGroup"),
        ("CISCO-DSL-PROVISION-MIB", "ciscoVcClassGroup"))
)
if mibBuilder.loadTexts:
