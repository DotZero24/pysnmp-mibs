...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-DSL-PROVISION-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:30:02 2025
...
if mibBuilder.loadTexts: ciscoDslProvisionMIB.setLastUpdated('200512140000Z')
...
cdslLocalIpAddrPoolEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 10, 30, 1, 3, 2, 1), ).setIndexNames((0, "CISCO-DSL-PROVISION-MIB", "cdslNrpSlotIndex"), (0, "CISCO-DSL-PROVISION-MIB", "cdslLocalIpAddrPoolName"))
...
cdslLocalIpAddrRangeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 10, 30, 1, 3, 3, 1), ).setIndexNames((0, "CISCO-DSL-PROVISION-MIB", "cdslNrpSlotIndex"), (0, "CISCO-DSL-PROVISION-MIB", "cdslLocalIpAddrRangeLowAddr"), (0, "CISCO-DSL-PROVISION-MIB", "cdslLocalIpAddrRangeHighAddr"), (0, "CISCO-DSL-PROVISION-MIB", "cdslLocalIpAddrPoolName"))
...
cdslVcClassEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 10, 30, 1, 5, 2, 1), ).setIndexNames((0, "CISCO-DSL-PROVISION-MIB", "cdslNrpSlotIndex"), (0, "CISCO-DSL-PROVISION-MIB", "cdslVcClassName"))
...
mibBuilder.exportSymbols("CISCO-DSL-PROVISION-MIB", cdslVTPppChapRefuse=cdslVTPppChapRefuse, cdslAtmPvcProtocolIpBC=cdslAtmPvcProtocolIpBC, cdslVcClassUbrPCR=cdslVcClassUbrPCR, cdslVTPppPapUserName=cdslVTPppPapUserName, cdslVcClassEntry=cdslVcClassEntry, cdslNrpSlot=cdslNrpSlot, cdslVTPppChapEncrypType=cdslVTPppChapEncrypType, cdslAtmPvcOamRetryDownCount=cdslAtmPvcOamRetryDownCount, cdslVcClassType=cdslVcClassType, cdslVTPppChapWaitPeer=cdslVTPppChapWaitPeer, cdslVcClassVbrNrtSCR=cdslVcClassVbrNrtSCR, cdslLocalIpAddrPoolFreeAddresses=cdslLocalIpAddrPoolFreeAddresses, cdslAtmPvcName=cdslAtmPvcName, cdslAtmPvcOamPvcLF=cdslAtmPvcOamPvcLF, cdslAtmPvcVbrNrtSCR=cdslAtmPvcVbrNrtSCR, cdslAtmPvcMuxLinkType=cdslAtmPvcMuxLinkType, cdslVcClassName=cdslVcClassName, cdslVTPppAuthChap=cdslVTPppAuthChap, cdslAtmPvcVbrNrtPCR=cdslAtmPvcVbrNrtPCR, ciscoDslProvMIBGroups=ciscoDslProvMIBGroups, cdslAtmPvcProtocolIpxBC=cdslAtmPvcProtocolIpxBC, ciscoDslProvMIBBasicCompliance=ciscoDslProvMIBBasicCompliance, ciscoDslProvisionMIB=ciscoDslProvisionMIB, cdslMaxVcClasses=cdslMaxVcClasses, cdslVcClassAbrMcr=cdslVcClassAbrMcr, cdslLocalIpAddrPoolEntry=cdslLocalIpAddrPoolEntry, cdslLocalIpAddrRangeTable=cdslLocalIpAddrRangeTable, cdslVcClassVbrNrtInputBP=cdslVcClassVbrNrtInputBP, cdslVcClassOamSvcManaged=cdslVcClassOamSvcManaged, cdslVirtualTemplateTable=cdslVirtualTemplateTable, cdslPppOverAtmPvcNumberEntry=cdslPppOverAtmPvcNumberEntry, cdslVcClassOamSvcLF=cdslVcClassOamSvcLF, cdslLocalIpAddrRangeEntry=cdslLocalIpAddrRangeEntry, cdslAtmPvcVirtualTemplate=cdslAtmPvcVirtualTemplate, cdslVcClassVbrNrtInputSCR=cdslVcClassVbrNrtInputSCR, cdslLocalIpAddrPoolName=cdslLocalIpAddrPoolName, cdslAtmPvcAbrMCR=cdslAtmPvcAbrMCR, cdslVirtualTemplates=cdslVirtualTemplates, ciscoIpPoolGroup=ciscoIpPoolGroup, cdslNrpIpAddressEntry=cdslNrpIpAddressEntry, cdslVcClassTransmitPriority=cdslVcClassTransmitPriority, cdslVcClassOamPvcManaged=cdslVcClassOamPvcManaged, cdslAtmPvcAbrPCR=cdslAtmPvcAbrPCR, cdslAtmPvcUbrPCR=cdslAtmPvcUbrPCR, cdslVcClassUbrPlusInputMCR=cdslVcClassUbrPlusInputMCR, cdslVcClassProtocolIpBC=cdslVcClassProtocolIpBC, cdslVcClassUbrInputPCR=cdslVcClassUbrInputPCR, ciscoDslProvMIBNotificationPrefix=ciscoDslProvMIBNotificationPrefix, cdslMaxVirtualTemplates=cdslMaxVirtualTemplates, cdslAtmPvc=cdslAtmPvc, cdslVTPppChapHost=cdslVTPppChapHost, cdslVcClassIdleMTR=cdslVcClassIdleMTR, cdslVcClassEncapsulation=cdslVcClassEncapsulation, cdslAtmPvcEntry=cdslAtmPvcEntry, cdslVcClassProtocolIpxBC=cdslVcClassProtocolIpxBC, ciscoNrpSlotGroup=ciscoNrpSlotGroup, cdslVcClassVbrNrtInputPCR=cdslVcClassVbrNrtInputPCR, cdslAtmPvcTable=cdslAtmPvcTable, cdslVcClassMuxLinkType=cdslVcClassMuxLinkType, cdslVcClasses=cdslVcClasses, cdslLocalIpAddrPoolNumberTable=cdslLocalIpAddrPoolNumberTable, cdslLocalIpAddrRangeLowAddr=cdslLocalIpAddrRangeLowAddr, cdslVcClassOamRetryUpCount=cdslVcClassOamRetryUpCount, cdslVcClassAbrIORDF=cdslVcClassAbrIORDF, cdslMaxNrps=cdslMaxNrps, cdslVcClassInarp=cdslVcClassInarp, ciscoDslPVCGroup=ciscoDslPVCGroup, cdslVTPppPapPassword=cdslVTPppPapPassword, cdslAtmPvcAbrIORDF=cdslAtmPvcAbrIORDF, cdslVcClass=cdslVcClass, cdslLocalIpAddrRangeHighAddr=cdslLocalIpAddrRangeHighAddr, cdslAtmPvcSubIfNumber=cdslAtmPvcSubIfNumber, cdslLocalIpAddrRangeRowStatus=cdslLocalIpAddrRangeRowStatus, cdslVcClassUbrPlusMCR=cdslVcClassUbrPlusMCR, cdslVTPppPapEncrypType=cdslVTPppPapEncrypType, cdslVcClassAbrPCR=cdslVcClassAbrPCR, cdslVcClassIdleTimeout=cdslVcClassIdleTimeout, cdslVcClassVirtualTemplate=cdslVcClassVirtualTemplate, cdslAtmPvcOamRetryUpCount=cdslAtmPvcOamRetryUpCount, cdslVTIpAddress=cdslVTIpAddress, cdslVcClassQosType=cdslVcClassQosType, cdslVcClassILMIManage=cdslVcClassILMIManage, ciscoDslProvMIBConformance=ciscoDslProvMIBConformance, cdslVcClassRowStatus=cdslVcClassRowStatus, cdslVTPppAuthMSChap=cdslVTPppAuthMSChap, cdslVTPeerIpAddressMethod=cdslVTPeerIpAddressMethod, cdslAtmPvcVci=cdslAtmPvcVci, cdslAtmPvcEncapsulation=cdslAtmPvcEncapsulation, cdslVTIndex=cdslVTIndex, cdslVTPppChapPassword=cdslVTPppChapPassword, cdslVTPppUseTacacs=cdslVTPppUseTacacs, cdslVTIpAddressMask=cdslVTIpAddressMask, cdslVTPppAuthPap=cdslVTPppAuthPap, cdslAtmPvcClass=cdslAtmPvcClass, ciscoVirtualTemplateGroup=ciscoVirtualTemplateGroup, cdslLocalIpAddrPool=cdslLocalIpAddrPool, cdslAtmPvcUbrPlusMCR=cdslAtmPvcUbrPlusMCR, cdslLocalIpAddrPools=cdslLocalIpAddrPools, cdslAtmPvcInarp=cdslAtmPvcInarp, cdslVcClassVbrNrtPCR=cdslVcClassVbrNrtPCR, cdslVTIpAddressMethod=cdslVTIpAddressMethod, cdslLocalIpAddrPoolNumberEntry=cdslLocalIpAddrPoolNumberEntry, PYSNMP_MODULE_ID=ciscoDslProvisionMIB, cdslVcClassVbrNrtInputMBS=cdslVcClassVbrNrtInputMBS, cdslNrpIpAddressTable=cdslNrpIpAddressTable, cdslAtmPvcBroadcast=cdslAtmPvcBroadcast, cdslVcClassOamRetryDownCount=cdslVcClassOamRetryDownCount, cdslAtmPvcILMIManage=cdslAtmPvcILMIManage, cdslVirtualTemplate=cdslVirtualTemplate, cdslVirtualTemplateEntry=cdslVirtualTemplateEntry, cdslAtmPvcRowStatus=cdslAtmPvcRowStatus, cdslVcClassTable=cdslVcClassTable, cdslVcClassAbrIORIF=cdslVcClassAbrIORIF, ciscoDslProvMIBCompliances=ciscoDslProvMIBCompliances, ciscoDslProvMIBObjects=ciscoDslProvMIBObjects, cdslAtmPvcUbrPlusPCR=cdslAtmPvcUbrPlusPCR, cdslMaxLocalIpAddrPools=cdslMaxLocalIpAddrPools, cdslVcClassUbrPlusInputPCR=cdslVcClassUbrPlusInputPCR, cdslVcClassBroadcast=cdslVcClassBroadcast, cdslVcClassNumberTable=cdslVcClassNumberTable, cdslVTPeerIpAddrPool=cdslVTPeerIpAddrPool, cdslVTRowStatus=cdslVTRowStatus, cdslPppOverAtmPvcNumberTable=cdslPppOverAtmPvcNumberTable, cdslVirtualTemplateNumberEntry=cdslVirtualTemplateNumberEntry, cdslNrpNumber=cdslNrpNumber, cdslVcClassOamPvcLF=cdslVcClassOamPvcLF, cdslNrpIpAddress=cdslNrpIpAddress, cdslVcClassNumberEntry=cdslVcClassNumberEntry, cdslVcClassUbrPlusPCR=cdslVcClassUbrPlusPCR, cdslPppOverAtmPvcs=cdslPppOverAtmPvcs, cdslAtmPvcQosType=cdslAtmPvcQosType, cdslVirtualTemplateNumberTable=cdslVirtualTemplateNumberTable, cdslLocalIpAddrPoolInUseAddresses=cdslLocalIpAddrPoolInUseAddresses, cdslAtmPvcAbrIORIF=cdslAtmPvcAbrIORIF, cdslAtmPvcOamPvcManaged=cdslAtmPvcOamPvcManaged, cdslAtmPvcVpi=cdslAtmPvcVpi, ciscoVcClassGroup=ciscoVcClassGroup, cdslVTIpIfIndex=cdslVTIpIfIndex, cdslNrpSlotIndex=cdslNrpSlotIndex, cdslLocalIpAddrPoolTable=cdslLocalIpAddrPoolTable)
