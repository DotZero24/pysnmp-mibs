...
rlIscsiSnoop=_RlIscsiSnoop_ObjectIdentity((1,3,6,1,4,1,89,126))
_RlIscsiSnoopEnable_Type=TruthValue
_RlIscsiSnoopEnable_Object=MibScalar
rlIscsiSnoopEnable=_RlIscsiSnoopEnable_Object((1,3,6,1,4,1,89,126,1),_RlIscsiSnoopEnable_Type())
...
rlIscsiSnoopAgingTimeOut=_RlIscsiSnoopAgingTimeOut_Object((1,3,6,1,4,1,89,126,2),_RlIscsiSnoopAgingTimeOut_Type())
...
rlIscsiSnoopQosTable=_RlIscsiSnoopQosTable_Object((1,3,6,1,4,1,89,126,3))
if mibBuilder.loadTexts:rlIscsiSnoopQosTable.setStatus(_A)
_RlIscsiSnoopQosEntry_Object=MibTableRow
rlIscsiSnoopQosEntry=_RlIscsiSnoopQosEntry_Object((1,3,6,1,4,1,89,126,3,1))
...
rlIscsiSnoopQosKey=_RlIscsiSnoopQosKey_Object((1,3,6,1,4,1,89,126,3,1,1),_RlIscsiSnoopQosKey_Type())
...
rlIscsiSnoopQosType=_RlIscsiSnoopQosType_Object((1,3,6,1,4,1,89,126,3,1,2),_RlIscsiSnoopQosType_Type())
...
rlIscsiSnoopQosValue=_RlIscsiSnoopQosValue_Object((1,3,6,1,4,1,89,126,3,1,4),_RlIscsiSnoopQosValue_Type())
...
rlIscsiSnoopQosRemark=_RlIscsiSnoopQosRemark_Object((1,3,6,1,4,1,89,126,3,1,5),_RlIscsiSnoopQosRemark_Type())
...
rlIscsiSnoopTargetConfigTable=_RlIscsiSnoopTargetConfigTable_Object((1,3,6,1,4,1,89,126,4))
if mibBuilder.loadTexts:rlIscsiSnoopTargetConfigTable.setStatus(_A)
_RlIscsiSnoopTargetConfigEntry_Object=MibTableRow
rlIscsiSnoopTargetConfigEntry=_RlIscsiSnoopTargetConfigEntry_Object((1,3,6,1,4,1,89,126,4,1))
...
rlIscsiSnoopTargetConfigTcpPort=_RlIscsiSnoopTargetConfigTcpPort_Object((1,3,6,1,4,1,89,126,4,1,1),_RlIscsiSnoopTargetConfigTcpPort_Type())
...
rlIscsiSnoopTargetConfigAddr=_RlIscsiSnoopTargetConfigAddr_Object((1,3,6,1,4,1,89,126,4,1,3),_RlIscsiSnoopTargetConfigAddr_Type())
...
rlIscsiSnoopTargetConfigName1=_RlIscsiSnoopTargetConfigName1_Object((1,3,6,1,4,1,89,126,4,1,4),_RlIscsiSnoopTargetConfigName1_Type())
...
rlIscsiSnoopTargetConfigName2=_RlIscsiSnoopTargetConfigName2_Object((1,3,6,1,4,1,89,126,4,1,5),_RlIscsiSnoopTargetConfigName2_Type())
...
rlIscsiSnoopTargetConfigStatus=_RlIscsiSnoopTargetConfigStatus_Object((1,3,6,1,4,1,89,126,4,1,6),_RlIscsiSnoopTargetConfigStatus_Type())
...
rlIscsiSnoopTargetNameTable=_RlIscsiSnoopTargetNameTable_Object((1,3,6,1,4,1,89,126,5))
if mibBuilder.loadTexts:rlIscsiSnoopTargetNameTable.setStatus(_A)
_RlIscsiSnoopTargetNameEntry_Object=MibTableRow
rlIscsiSnoopTargetNameEntry=_RlIscsiSnoopTargetNameEntry_Object((1,3,6,1,4,1,89,126,5,1))
...
rlIscsiSnoopTargetNameId=_RlIscsiSnoopTargetNameId_Object((1,3,6,1,4,1,89,126,5,1,1),_RlIscsiSnoopTargetNameId_Type())
...
rlIscsiSnoopTargetName1=_RlIscsiSnoopTargetName1_Object((1,3,6,1,4,1,89,126,5,1,2),_RlIscsiSnoopTargetName1_Type())
...
rlIscsiSnoopTargetName2=_RlIscsiSnoopTargetName2_Object((1,3,6,1,4,1,89,126,5,1,3),_RlIscsiSnoopTargetName2_Type())
...
rlIscsiSnoopInitiatorNameTable=_RlIscsiSnoopInitiatorNameTable_Object((1,3,6,1,4,1,89,126,6))
if mibBuilder.loadTexts:rlIscsiSnoopInitiatorNameTable.setStatus(_A)
_RlIscsiSnoopInitiatorNameEntry_Object=MibTableRow
rlIscsiSnoopInitiatorNameEntry=_RlIscsiSnoopInitiatorNameEntry_Object((1,3,6,1,4,1,89,126,6,1))
...
rlIscsiSnoopInitiatorNameId=_RlIscsiSnoopInitiatorNameId_Object((1,3,6,1,4,1,89,126,6,1,1),_RlIscsiSnoopInitiatorNameId_Type())
...
rlIscsiSnoopInitiatorName1=_RlIscsiSnoopInitiatorName1_Object((1,3,6,1,4,1,89,126,6,1,2),_RlIscsiSnoopInitiatorName1_Type())
...
rlIscsiSnoopInitiatorName2=_RlIscsiSnoopInitiatorName2_Object((1,3,6,1,4,1,89,126,6,1,3),_RlIscsiSnoopInitiatorName2_Type())
...
rlIscsiSnoopSessionTable=_RlIscsiSnoopSessionTable_Object((1,3,6,1,4,1,89,126,7))
if mibBuilder.loadTexts:rlIscsiSnoopSessionTable.setStatus(_A)
_RlIscsiSnoopSessionEntry_Object=MibTableRow
rlIscsiSnoopSessionEntry=_RlIscsiSnoopSessionEntry_Object((1,3,6,1,4,1,89,126,7,1))
...
rlIscsiSnoopSessionISID=_RlIscsiSnoopSessionISID_Object((1,3,6,1,4,1,89,126,7,1,1),_RlIscsiSnoopSessionISID_Type())
...
rlIscsiSnoopSessAgingTime=_RlIscsiSnoopSessAgingTime_Object((1,3,6,1,4,1,89,126,7,1,2),_RlIscsiSnoopSessAgingTime_Type())
...
rlIscsiSnoopSessionUpTime=_RlIscsiSnoopSessionUpTime_Object((1,3,6,1,4,1,89,126,7,1,3),_RlIscsiSnoopSessionUpTime_Type())
...
rlIscsiSnoopConnectionTable=_RlIscsiSnoopConnectionTable_Object((1,3,6,1,4,1,89,126,8))
if mibBuilder.loadTexts:rlIscsiSnoopConnectionTable.setStatus(_A)
_RlIscsiSnoopConnectionEntry_Object=MibTableRow
rlIscsiSnoopConnectionEntry=_RlIscsiSnoopConnectionEntry_Object((1,3,6,1,4,1,89,126,8,1))
...
rlIscsiSnoopConnectionTargetAddr=_RlIscsiSnoopConnectionTargetAddr_Object((1,3,6,1,4,1,89,126,8,1,2),_RlIscsiSnoopConnectionTargetAddr_Type())
...
rlIscsiSnoopConnectionTargetPort=_RlIscsiSnoopConnectionTargetPort_Object((1,3,6,1,4,1,89,126,8,1,3),_RlIscsiSnoopConnectionTargetPort_Type())
...
rlIscsiSnoopConnectionInitiatorAddr=_RlIscsiSnoopConnectionInitiatorAddr_Object((1,3,6,1,4,1,89,126,8,1,5),_RlIscsiSnoopConnectionInitiatorAddr_Type())
...
rlIscsiSnoopConnectionInitiatorPort=_RlIscsiSnoopConnectionInitiatorPort_Object((1,3,6,1,4,1,89,126,8,1,6),_RlIscsiSnoopConnectionInitiatorPort_Type())
...
rlIscsiSnoopConnectionCreationTime=_RlIscsiSnoopConnectionCreationTime_Object((1,3,6,1,4,1,89,126,8,1,7),_RlIscsiSnoopConnectionCreationTime_Type())
...
rlIscsiSnoopConnectionLastActTime=_RlIscsiSnoopConnectionLastActTime_Object((1,3,6,1,4,1,89,126,8,1,8),_RlIscsiSnoopConnectionLastActTime_Type())
...
rlIscsiSnoopConnectionLastPollTime=_RlIscsiSnoopConnectionLastPollTime_Object((1,3,6,1,4,1,89,126,8,1,9),_RlIscsiSnoopConnectionLastPollTime_Type())
...
rlIscsiSnoopConnectionExpiryTime=_RlIscsiSnoopConnectionExpiryTime_Object((1,3,6,1,4,1,89,126,8,1,10),_RlIscsiSnoopConnectionExpiryTime_Type())
...
rlIscsiSnoopConnectionCounterIndex=_RlIscsiSnoopConnectionCounterIndex_Object((1,3,6,1,4,1,89,126,8,1,11),_RlIscsiSnoopConnectionCounterIndex_Type())
...
rlIscsiSnoopCosEnable=_RlIscsiSnoopCosEnable_Object((1,3,6,1,4,1,89,126,9),_RlIscsiSnoopCosEnable_Type())
