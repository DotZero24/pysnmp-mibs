...
# Notes
# -----
# ASN.1 source file://mibs/eaton/EATON-EPDU-PU-SW-MIB
...
compliances.setObjects(
      *(("EATON-EPDU-PU-SW-MIB", "allObjects"),
        ("EATON-EPDU-PU-SW-MIB", "allNotifications"))
)
if mibBuilder.loadTexts:
...
oldCompliances.setObjects(
    ("EATON-EPDU-PU-SW-MIB", "oldObjects")
)
if mibBuilder.loadTexts:
...
obsoleteCompliances.setObjects(
    ("EATON-EPDU-PU-SW-MIB", "obsoleteObjects")
)
if mibBuilder.loadTexts:
