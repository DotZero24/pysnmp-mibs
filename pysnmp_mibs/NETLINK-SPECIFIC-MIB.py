...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cabletron/NETLINK-SPECIFIC-MIB
...
ModuleIdentity, Counter64, Integer32, enterprises, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, MibIdentifier, TimeTicks, mgmt, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "enterprises", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "mgmt", "Bits", "mib-2", "IpAddress")
DisplayString, MacAddress, TimeInterval, RowStatus, PhysAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "MacAddress", "TimeInterval", "RowStatus", "PhysAddress", "TextualConvention")
...
mibBuilder.exportSymbols("NETLINK-SPECIFIC-MIB", portVoiceAdminDialTimer=portVoiceAdminDialTimer, lSSdlcAdminRowStatus=lSSdlcAdminRowStatus, nlIfRlp=nlIfRlp, portPhyX25AdminRcvClockFromDTE=portPhyX25AdminRcvClockFromDTE, frStatsTxDEFrames=frStatsTxDEFrames, tpAddress=tpAddress, nlIfIpNetworkMask=nlIfIpNetworkMask, x25RxStatsEntry=x25RxStatsEntry, nlIfTableOid=nlIfTableOid, portBsciOperTransTextSupported=portBsciOperTransTextSupported, portBsciAdminTable=portBsciAdminTable, nlIfIpSVCIdleTimer=nlIfIpSVCIdleTimer, nlLlc2OrigConnectionMAXDATA=nlLlc2OrigConnectionMAXDATA, portSdlcOperEntry=portSdlcOperEntry, statT1=statT1, voiceSpeedDialExtDialStr=voiceSpeedDialExtDialStr, ipxNodeDefaultConfigRouterName=ipxNodeDefaultConfigRouterName, ipxInterfaceNetBIOSHops=ipxInterfaceNetBIOSHops, lSSdlcLlc2OperIdnum=lSSdlcLlc2OperIdnum, lSSdlcLlc2OperLanT1=lSSdlcLlc2OperLanT1, ipxInterfaceType=ipxInterfaceType, voiceStatsEntry=voiceStatsEntry, bsciSubscrOperRemoteID=bsciSubscrOperRemoteID, lSSdlcOperRemoteSub=lSSdlcOperRemoteSub, bsciDevAdminPrinterAttached=bsciDevAdminPrinterAttached, ipxStaticRouteConfigRouter=ipxStaticRouteConfigRouter, portThreshIndex=portThreshIndex, t1StatsRcvAbortFrames=t1StatsRcvAbortFrames, portBsciOperRetransmitInterval=portBsciOperRetransmitInterval, portDLCIPortIndex=portDLCIPortIndex, nlIfIpICMPAddRoutes=nlIfIpICMPAddRoutes, nlIfIpBAG=nlIfIpBAG, portVoiceAdminLevelIn=portVoiceAdminLevelIn, nsNodTable=nsNodTable, nsEntry=nsEntry, lSSdlcOperL2DatMode=lSSdlcOperL2DatMode, bsciDevAdminDisableStatusRequest=bsciDevAdminDisableStatusRequest, portVoiceOperDTMF=portVoiceOperDTMF, portLogicalX25AdminBAG=portLogicalX25AdminBAG, llc2=llc2, portVoiceOperSLTTimeout=portVoiceOperSLTTimeout, portVoiceOperLinkDownBusy=portVoiceOperLinkDownBusy, nlIfIpSecondaryAddrRowStatus=nlIfIpSecondaryAddrRowStatus, nlLocalSubscriberRouteTable=nlLocalSubscriberRouteTable, statVoice=statVoice, portBsciOperStartSynchChars=portBsciOperStartSynchChars, nlLlc2TermConnectionLocalSubscriberId=nlLlc2TermConnectionLocalSubscriberId, ipxServConfigTable=ipxServConfigTable, portT1AdminFrameModelSelect=portT1AdminFrameModelSelect, portX25OperBlockedFlag=portX25OperBlockedFlag, portSdlcAdminPadType=portSdlcAdminPadType, portFrBackupUseOnly=portFrBackupUseOnly, portX25OperFlowCtrlNeg=portX25OperFlowCtrlNeg, portDLCIBackupGroup=portDLCIBackupGroup, lSSdlcLlc2OperSuppressXID=lSSdlcLlc2OperSuppressXID, nlIfVoicePeerNodeNumber=nlIfVoicePeerNodeNumber, subscriber=subscriber, bsciDevOperTransTextSupported=bsciDevOperTransTextSupported, portBsciAdminPollInterval=portBsciAdminPollInterval, portVoiceOperSpeed=portVoiceOperSpeed, portSdlcAdminSpeed=portSdlcAdminSpeed, portVoiceOperTable=portVoiceOperTable, nlLlc2OrigConnectionIDBLK=nlLlc2OrigConnectionIDBLK, voiceStatsRxCallsAccepts=voiceStatsRxCallsAccepts, nlIfLlc2FrFormat=nlIfLlc2FrFormat, nlIfIpPVCConnection=nlIfIpPVCConnection, portBsciOperSpeed=portBsciOperSpeed, nlIfIpRIPFullUpdates=nlIfIpRIPFullUpdates, voiceSystemDialDigits=voiceSystemDialDigits, portLogicalX25OperBAG=portLogicalX25OperBAG, bsciSubscrOperAutocallRtyTimer=bsciSubscrOperAutocallRtyTimer, portT1OperBlockedPortFlag=portT1OperBlockedPortFlag, voiceSystemCountryCode=voiceSystemCountryCode, portSdlcOperMAXRetries=portSdlcOperMAXRetries, voiceStatsTxCongestions=voiceStatsTxCongestions, portBsciAdminBlockedFlag=portBsciAdminBlockedFlag, voiceStatsPortIndex=voiceStatsPortIndex, lSSdlcLlc2OperLocalMac=lSSdlcLlc2OperLocalMac, nlLlc2OrigConnectionMAXIN=nlLlc2OrigConnectionMAXIN, x25RxSABMFrames=x25RxSABMFrames, nlLocalSubscriberRedirectOO=nlLocalSubscriberRedirectOO, portBsciAdminSlowPollRetryCount=portBsciAdminSlowPollRetryCount, pinStatusTable=pinStatusTable, lSSdlcAdminLPDAResourceID=lSSdlcAdminLPDAResourceID, nlIfVoiceFrameRelayRlp=nlIfVoiceFrameRelayRlp, portSdlcOperTable=portSdlcOperTable, portPhyX25AdminDisconnectTimer=portPhyX25AdminDisconnectTimer, portPinStatus=portPinStatus, lSSdlcLlc2OperLanTw=lSSdlcLlc2OperLanTw, portVoiceOperLevelIn=portVoiceOperLevelIn, nlIfIpSourceAddress=nlIfIpSourceAddress, portVoiceOperToneType=portVoiceOperToneType, ipxInterfaceTransportTime=ipxInterfaceTransportTime, rlpThreshEntry=rlpThreshEntry, frStatsRxANXDFrames=frStatsRxANXDFrames, x25RxUAFrames=x25RxUAFrames, portBsciAdminCallInfoInRequestPacket=portBsciAdminCallInfoInRequestPacket, nlLlc2HostGroup=nlLlc2HostGroup, portBsciAdminStartSynchChars=portBsciAdminStartSynchChars, portT1AdminNRZI=portT1AdminNRZI, ipxInterfaceSVCIdleTimer=ipxInterfaceSVCIdleTimer, nlIfIpSecondaryAddrRouteMetric=nlIfIpSecondaryAddrRouteMetric, voiceStatsTable=voiceStatsTable, bsciDevOperDeviceUnitID=bsciDevOperDeviceUnitID, portSdlcOperRcvClockFromDTE=portSdlcOperRcvClockFromDTE, portBsciAdminRowStatus=portBsciAdminRowStatus, nlLocalSubscriberRouteRowStatus=nlLocalSubscriberRouteRowStatus, nlLlc2TermConnectionHSAP=nlLlc2TermConnectionHSAP, portFrOutgoingRateControl=portFrOutgoingRateControl, ipxServConfigServNodeAddress=ipxServConfigServNodeAddress, portDLCIRowStatus=portDLCIRowStatus, sdlcLSAdminTable=sdlcLSAdminTable, portFrMaxBytesPerFrame=portFrMaxBytesPerFrame, portX25OperLocChgPrev=portX25OperLocChgPrev, portVoiceOperAutoDialNumber=portVoiceOperAutoDialNumber, nlLocalSubscriberId=nlLocalSubscriberId, portVoiceAdminRlpIndex=portVoiceAdminRlpIndex, nlLocalSubscriberRoutePort=nlLocalSubscriberRoutePort, portVoiceOperEntry=portVoiceOperEntry, portX25OperThruptClassNeg=portX25OperThruptClassNeg, portFrRowStatus=portFrRowStatus, rlpStatsInFrames=rlpStatsInFrames, portPhyX25AdminSetupTimer=portPhyX25AdminSetupTimer, ipxStaticRouteConfigNetNum=ipxStaticRouteConfigNetNum, nlIfLlc2FrHostMACAddress=nlIfLlc2FrHostMACAddress, lSSdlcLlc2AdminSuppressXID=lSSdlcLlc2AdminSuppressXID, nlIfLlc2LANRowStatus=nlIfLlc2LANRowStatus, portVoiceOperAutoPoll=portVoiceOperAutoPoll, nlIfIpSecondaryAddrTable=nlIfIpSecondaryAddrTable, portX25AdminInCallBar=portX25AdminInCallBar, rlpGroupNumber=rlpGroupNumber, portBsciOperMultidrop=portBsciOperMultidrop, bsciDevAdminTable=bsciDevAdminTable, portBsciOperNAKRetryCount=portBsciOperNAKRetryCount, bsciSubscrOperLocalID=bsciSubscrOperLocalID, t1StatsLCVCnt=t1StatsLCVCnt, portX25AdminMaxWinSize=portX25AdminMaxWinSize, sdlc=sdlc, portBsciAdminMAXRetransmits=portBsciAdminMAXRetransmits, nlIfLlc2FrPriority=nlIfLlc2FrPriority, portLogicalX25AdminRfc1490=portLogicalX25AdminRfc1490, bsciSubscrAdminAutocallMaxRtry=bsciSubscrAdminAutocallMaxRtry, tpAdrSLev=tpAdrSLev, portStatsRlpIndex=portStatsRlpIndex, nlIfIpSecondaryAddrNetworkMask=nlIfIpSecondaryAddrNetworkMask, portStatsTable=portStatsTable, portX25OperOutCallBar=portX25OperOutCallBar, nlIfIpTable=nlIfIpTable, portLogicalX25AdminRowStatus=portLogicalX25AdminRowStatus, portFrBackupPort=portFrBackupPort, ipxInterfaceNetworkAddress=ipxInterfaceNetworkAddress, nlIfVoicePeerNodePort=nlIfVoicePeerNodePort, frStatsTxANXDFrames=frStatsTxANXDFrames, portFrPortIndex=portFrPortIndex, x25RxStatsTable=x25RxStatsTable, nlLlc2OrigConnectionLocalSubscriberId=nlLlc2OrigConnectionLocalSubscriberId, portBsciAdminDataMode=portBsciAdminDataMode, t1StatsRcvOverruns=t1StatsRcvOverruns, portX25AdminDefWinSize=portX25AdminDefWinSize, lSSdlcAdminLocalSub=lSSdlcAdminLocalSub, portSdlcOperIdleFillChar=portSdlcOperIdleFillChar, nodeModel=nodeModel, nlLlc2HostRowStatus=nlLlc2HostRowStatus, lSSdlcOperEntry=lSSdlcOperEntry, nlLocalSubscriberRouteConf=nlLocalSubscriberRouteConf, portFrRcvClkFrmDTE=portFrRcvClkFrmDTE, portVoiceAdminCallTimer=portVoiceAdminCallTimer, nlIfLlc2LANTable=nlIfLlc2LANTable, nsNTNode=nsNTNode, portVoiceAdminMakeRatio=portVoiceAdminMakeRatio, hwcard=hwcard, portDLCIRlpIndex=portDLCIRlpIndex, nodeBagTable=nodeBagTable, voiceSystemVoiceRatesMin=voiceSystemVoiceRatesMin, portBsciAdminSpeed=portBsciAdminSpeed, portThreshTxPercentUtl=portThreshTxPercentUtl, nodeSNMPGroup=nodeSNMPGroup, t1StatsRcvChannelErrors=t1StatsRcvChannelErrors, ipxInterfaceRIPAgeTimer=ipxInterfaceRIPAgeTimer, portBsciAdminRcvClockFromDTE=portBsciAdminRcvClockFromDTE, portBsciOperGenerateClock=portBsciOperGenerateClock, portVoiceOperRlpIndex=portVoiceOperRlpIndex, nlLlc2OrigConnectionHSAP=nlLlc2OrigConnectionHSAP, lSSdlcLlc2AdminLocalMac=lSSdlcLlc2AdminLocalMac, t1StatsEntry=t1StatsEntry, portFrBandwidthAllocation=portFrBandwidthAllocation, portPhyX25AdminTrunkGroup=portPhyX25AdminTrunkGroup, x25RxDMFrames=x25RxDMFrames, bsciDevOperSingleUserVC=bsciDevOperSingleUserVC, portVoiceAdminForwardedDigits=portVoiceAdminForwardedDigits, portPhyX25OperTable=portPhyX25OperTable, portPhyX25OperInactivityTimer=portPhyX25OperInactivityTimer, nlIfLlc2FrDLCI=nlIfLlc2FrDLCI, nlLocalSubscriberRedirectBusy=nlLocalSubscriberRedirectBusy, frStatsEntry=frStatsEntry, t1StatsRedAlarms=t1StatsRedAlarms, nlLocalSubscriberSystematicRedirect=nlLocalSubscriberSystematicRedirect, portT1Group=portT1Group, t1StatsTable=t1StatsTable, ipxInterfacePeriodicRIPTimer=ipxInterfacePeriodicRIPTimer, portBsciOperEntry=portBsciOperEntry, portVoiceOperFaxSupported=portVoiceOperFaxSupported, bsciDevAdminSingleUserVC=bsciDevAdminSingleUserVC, voiceStatsTxClears=voiceStatsTxClears, nlLocalSubscriberRedirAddr=nlLocalSubscriberRedirAddr, ipxInterfaceRowStatus=ipxInterfaceRowStatus, lSSdlcAdminEntry=lSSdlcAdminEntry, nlIfLlc2LANPriority=nlIfLlc2LANPriority, bsciSubscrOperConnectionID=bsciSubscrOperConnectionID, t1StatsXmitUsage=t1StatsXmitUsage, portLogicalX25AdminEntry=portLogicalX25AdminEntry, portBsciGroup=portBsciGroup, voice=voice, portFrConfigTable=portFrConfigTable, nlIfPortStatus=nlIfPortStatus, portX25OperCUGPref=portX25OperCUGPref, x25TxINFOFrames=x25TxINFOFrames, nlLlc2HostTable=nlLlc2HostTable, nlIfIpInterfaces=nlIfIpInterfaces, portSdlcOperGenerateClock=portSdlcOperGenerateClock, bsciDevOperControlUnitID=bsciDevOperControlUnitID, bridgeDefaultEthernetFrameType=bridgeDefaultEthernetFrameType, portBsciAdminEndToEndAck=portBsciAdminEndToEndAck, portDLCIIncomingCIR=portDLCIIncomingCIR, portBsciOperBlockCheck=portBsciOperBlockCheck, portBsciOperPadType=portBsciOperPadType, bsciDevOperTable=bsciDevOperTable, bsciSubscrAdminConnectionID=bsciSubscrAdminConnectionID, portDLCIIncomingBc=portDLCIIncomingBc, portT1AdminFramingMode=portT1AdminFramingMode, bsciDevAdminConnectionID=bsciDevAdminConnectionID, lSSdlcLlc2AdminPriority=lSSdlcLlc2AdminPriority, nlIfLlc2FrPort=nlIfLlc2FrPort, nlIfIpLANCard=nlIfIpLANCard, rlpStatsOutFrames=rlpStatsOutFrames, nlIfIpProxyARP=nlIfIpProxyARP, portVoiceGroup=portVoiceGroup, nlLocalSubscriberAlgorithm=nlLocalSubscriberAlgorithm, bridgeIPEnabled=bridgeIPEnabled, x25TxRlpIndex=x25TxRlpIndex, portFrBackupWaitTimer=portFrBackupWaitTimer, bsciDevOperPrinterAttached=bsciDevOperPrinterAttached, portFrBackupGroup=portFrBackupGroup, bsciSubscrAdminAutocallRtyTimer=bsciSubscrAdminAutocallRtyTimer, portSdlcAdminRcvClockFromDTE=portSdlcAdminRcvClockFromDTE, rlpThreshRlpIndex=rlpThreshRlpIndex, t1StatsRcvUsage=t1StatsRcvUsage, portX25OperRevChgAccpt=portX25OperRevChgAccpt, bsciSubscrAdminRemoteID=bsciSubscrAdminRemoteID, voiceStatsRxClears=voiceStatsRxClears, lSSdlcAdminTable=lSSdlcAdminTable, nodeTrapAdrTable=nodeTrapAdrTable, portThreshRtxFramesPerSec=portThreshRtxFramesPerSec, portVoiceAdminLinkDownBusy=portVoiceAdminLinkDownBusy)
mibBuilder.exportSymbols("NETLINK-SPECIFIC-MIB", sdlcLSGroup=sdlcLSGroup, x25TxStatsTable=x25TxStatsTable, portVoiceOperTelephonyType=portVoiceOperTelephonyType, statThresh=statThresh, portThreshTxErrorRatio=portThreshTxErrorRatio, portPhyX25AdminSpeed=portPhyX25AdminSpeed, portDLCIOutgoingCIR=portDLCIOutgoingCIR, bsciSubscrOperSequence=bsciSubscrOperSequence, portSdlcAdminIdleFillChar=portSdlcAdminIdleFillChar, voiceSpeedDialRowStatus=voiceSpeedDialRowStatus, portFrBackupRowStatus=portFrBackupRowStatus, nlIfLlc2FrTable=nlIfLlc2FrTable, ipxInterfaceEntry=ipxInterfaceEntry, nlIfIpSourceSub=nlIfIpSourceSub, ipxInterfaceRIPEnabled=ipxInterfaceRIPEnabled, nsStatus=nsStatus, rlpEntry=rlpEntry, lSSdlcAdminLlc2Conversion=lSSdlcAdminLlc2Conversion, portVoiceOperDialTimer=portVoiceOperDialTimer, ipxInterfaceSAPEnabled=ipxInterfaceSAPEnabled, nlIfLlc2LANRlp=nlIfLlc2LANRlp, nlLocalSubscriberPriority=nlLocalSubscriberPriority, portVoiceAdminDTMFOnDuration=portVoiceAdminDTMFOnDuration, portPhyX25AdminRowStatus=portPhyX25AdminRowStatus, nlIfEntry=nlIfEntry, portSdlcOperSpeed=portSdlcOperSpeed, portBsciOperDataMode=portBsciOperDataMode, voiceStatsRxCalls=voiceStatsRxCalls, portX25AdminThruptClassNeg=portX25AdminThruptClassNeg, t1StatsXmitAbortFrames=t1StatsXmitAbortFrames, portSdlcOperConnector=portSdlcOperConnector, portSdlcAdminLPDASupport=portSdlcAdminLPDASupport, voiceSpeedDialDigits=voiceSpeedDialDigits, nlLlc2TermConnectionEntry=nlLlc2TermConnectionEntry, portLogicalX25AdminCxnPriority=portLogicalX25AdminCxnPriority, nlIfLlc2FrBlockedPortFlag=nlIfLlc2FrBlockedPortFlag, lSSdlcLlc2OperTable=lSSdlcLlc2OperTable, rlpThreshRejFramesPerSec=rlpThreshRejFramesPerSec, portPhyX25OperGenerateClock=portPhyX25OperGenerateClock, nlIfPort=nlIfPort, lSSdlcLlc2AdminRowStatus=lSSdlcLlc2AdminRowStatus, nlIpDefaultRIPVersion=nlIpDefaultRIPVersion, ipxInterfaceSerializationEnabled=ipxInterfaceSerializationEnabled, portLogicalX25OperRfc1490=portLogicalX25OperRfc1490, ipxInterfaceFrameType=ipxInterfaceFrameType, rlpThreshRxFramesPerSec=rlpThreshRxFramesPerSec, portX25OperDefPktSize=portX25OperDefPktSize, nlLlc2HostSessionType=nlLlc2HostSessionType, portThreshTxFramesPerSec=portThreshTxFramesPerSec, portX25OperTable=portX25OperTable, portVoiceOperNumDigitsDelete=portVoiceOperNumDigitsDelete, portBsciOperNoResponseTimer=portBsciOperNoResponseTimer, ipxNodeDefaultConfigNetworkAddress=ipxNodeDefaultConfigNetworkAddress, nlLlc2HostPriority=nlLlc2HostPriority, bsciDevAdminDeviceUnitID=bsciDevAdminDeviceUnitID, nlLocalSubscriberRedirIndex=nlLocalSubscriberRedirIndex, nlLlc2NextHostNumber=nlLlc2NextHostNumber, nsThisNode=nsThisNode, portBsciAdminMaxBytesPerFrame=portBsciAdminMaxBytesPerFrame, portT1AdminGenerateClock=portT1AdminGenerateClock, frStatsTxLMIFrames=frStatsTxLMIFrames, nsNumNeigh=nsNumNeigh, bridgeEnabled=bridgeEnabled, portX25AdminTable=portX25AdminTable, nlIfLlc2FrBAG=nlIfLlc2FrBAG, portBsciOperMaxBytesPerFrame=portBsciOperMaxBytesPerFrame, lSSdlcLlc2AdminBAG=lSSdlcLlc2AdminBAG, bridgeAdminVirtualLANID=bridgeAdminVirtualLANID, ds0aStatsRcvFrames=ds0aStatsRcvFrames, portVoiceOperAutoDial=portVoiceOperAutoDial, ipxStaticRouteConfigRowStatus=ipxStaticRouteConfigRowStatus, ds0aStatsTable=ds0aStatsTable, portPhyX25AdminTrunkFlag=portPhyX25AdminTrunkFlag, portPhyX25OperDisconnectTimer=portPhyX25OperDisconnectTimer, portBsciOperConnector=portBsciOperConnector, portVoiceOperMakeRatio=portVoiceOperMakeRatio, nlIfVoiceFrameRelayPort=nlIfVoiceFrameRelayPort, portVoiceAdminAutoPoll=portVoiceAdminAutoPoll, voiceStatsCallTimeouts=voiceStatsCallTimeouts, ipxInterfacePortDiagEnabled=ipxInterfacePortDiagEnabled, nlIfPhyPort=nlIfPhyPort, portStatsFrameRetrans=portStatsFrameRetrans, portFrT392Timer=portFrT392Timer, statIp=statIp, portSdlcAdminInactivityTimer=portSdlcAdminInactivityTimer, bsciSubscrAdminTable=bsciSubscrAdminTable, portX25AdminMaxPktSize=portX25AdminMaxPktSize, ipxInterfaceRIPMaxSize=ipxInterfaceRIPMaxSize, nlLlc2HostT2RecvAckTimer=nlLlc2HostT2RecvAckTimer, rlpStatsFrameRetransmits=rlpStatsFrameRetransmits, nlLlc2OrigConnectionIDNUM=nlLlc2OrigConnectionIDNUM, nlIfIpSourceRlp=nlIfIpSourceRlp, portBsciAdminNoResponseRetryCount=portBsciAdminNoResponseRetryCount, portFrLLM=portFrLLM, nlIfIpSecondaryAddrBroadcastAddress=nlIfIpSecondaryAddrBroadcastAddress, portT1AdminBlockedPortFlag=portT1AdminBlockedPortFlag, nlIfLlc2FrRowStatus=nlIfLlc2FrRowStatus, ipxConfigInterface=ipxConfigInterface, lSSdlcOperRetryTime=lSSdlcOperRetryTime, portX25OperEntry=portX25OperEntry, portT1OperGenerateClock=portT1OperGenerateClock, netlink=netlink, portBsciAdminEndPadChars=portBsciAdminEndPadChars, portT1AdminTable=portT1AdminTable, portBsciAdminClearVCOnLastDeviceDown=portBsciAdminClearVCOnLastDeviceDown, portPhyX25OperConnector=portPhyX25OperConnector, lSSdlcLlc2AdminIdblk=lSSdlcLlc2AdminIdblk, nodeTrapText=nodeTrapText, portVoiceAdminBreakRatio=portVoiceAdminBreakRatio, portX25AdminLocChgPrev=portX25AdminLocChgPrev, portDLCIIncomingBe=portDLCIIncomingBe, bridgeIPXEnabled=bridgeIPXEnabled, portThreshEntry=portThreshEntry, bsciSubscrAdminAutocall=bsciSubscrAdminAutocall, rlpMaxProtos=rlpMaxProtos, nlIfLlc2LANBlockedPortFlag=nlIfLlc2LANBlockedPortFlag, nlIfLlc2FrSessionType=nlIfLlc2FrSessionType, frStatsRxLMIFrames=frStatsRxLMIFrames, portVoiceOperExtDigitsSource=portVoiceOperExtDigitsSource, portFrBackupRLP=portFrBackupRLP, portVoiceAdminTable=portVoiceAdminTable, nlIfIpRouteMetric=nlIfIpRouteMetric, portDLCIPriority=portDLCIPriority, ipxInterfaceSAPAgeTimer=ipxInterfaceSAPAgeTimer, bridge=bridge, portSdlcAdminDisableRequestDisconnect=portSdlcAdminDisableRequestDisconnect, bsciSubscrOperAutocallMaxRtry=bsciSubscrOperAutocallMaxRtry, portStatsEntry=portStatsEntry, portBsciOperClearVCOnLastDeviceDown=portBsciOperClearVCOnLastDeviceDown, nlIfVoiceEntry=nlIfVoiceEntry, nlLlc2OrigConnectionRowStatus=nlLlc2OrigConnectionRowStatus, ds0aStatsRcvErrors=ds0aStatsRcvErrors, portBsciAdminFullDuplex=portBsciAdminFullDuplex, portBsciAdminActivateConnectionWithoutPoll=portBsciAdminActivateConnectionWithoutPoll, nlIfVoiceInterfaces=nlIfVoiceInterfaces, network=network, lSSdlcLlc2OperLanN2=lSSdlcLlc2OperLanN2, x25RxRNRFrames=x25RxRNRFrames, portX25Group=portX25Group, lSSdlcLlc2OperIdblk=lSSdlcLlc2OperIdblk, frStatsRxBECNFrames=frStatsRxBECNFrames, lSSdlcAdminL2DatMode=lSSdlcAdminL2DatMode, portVoiceAdminNumDigitsDelete=portVoiceAdminNumDigitsDelete, rlpThreshTable=rlpThreshTable, portSdlcAdminCommit=portSdlcAdminCommit, portBsciOperPollInterval=portBsciOperPollInterval, ipxInterfaceDestinationSubscriber=ipxInterfaceDestinationSubscriber, nlIfIpRIPDeltaUpdates=nlIfIpRIPDeltaUpdates, nlIfLlc2Interfaces=nlIfLlc2Interfaces, x25RxINFOFrames=x25RxINFOFrames, lSSdlcLlc2AdminIdnum=lSSdlcLlc2AdminIdnum, ipxInterfaceMaxTransUnit=ipxInterfaceMaxTransUnit, portBsciOperActivateConnectionWithoutPoll=portBsciOperActivateConnectionWithoutPoll, nlLlc2HostMACAddress=nlLlc2HostMACAddress, x25RxDISCFrames=x25RxDISCFrames, portThreshRxPercentUtl=portThreshRxPercentUtl, portX25OperCUGIncAccess=portX25OperCUGIncAccess, nsNodNum=nsNodNum, portLogicalX25AdminTable=portLogicalX25AdminTable, lSSdlcOperLPDAResourceID=lSSdlcOperLPDAResourceID, portVoiceAdminTETimer=portVoiceAdminTETimer, lSSdlcLlc2AdminEntry=lSSdlcLlc2AdminEntry, portSdlcOperMAXOut=portSdlcOperMAXOut, lSSdlcLlc2OperLanTi=lSSdlcLlc2OperLanTi, nlIfIpSecondaryAddrSequence=nlIfIpSecondaryAddrSequence, lSSdlcLlc2AdminLanTw=lSSdlcLlc2AdminLanTw, portVoiceAdminAutoPollTimer=portVoiceAdminAutoPollTimer, nlIfLlc2LANEntry=nlIfLlc2LANEntry, nlIfIpSourcePort=nlIfIpSourcePort, t1StatsOOSCnt=t1StatsOOSCnt, lSSdlcLlc2AdminLanN3=lSSdlcLlc2AdminLanN3, nlIfLlc2LANID=nlIfLlc2LANID, ds0aStatsEntry=ds0aStatsEntry, portSdlcAdminConnector=portSdlcAdminConnector, nlIfIpDestSub=nlIfIpDestSub, nlLocalSubscriberRouteLP=nlLocalSubscriberRouteLP, portX25AdminBlockedFlag=portX25AdminBlockedFlag, portX25OperMaxPktSize=portX25OperMaxPktSize, portFrBackupGroupTable=portFrBackupGroupTable, portPinPort=portPinPort, lSSdlcLlc2AdminLanTi=lSSdlcLlc2AdminLanTi, portBsciAdminMultidrop=portBsciAdminMultidrop, portVoiceOperAutoPollTimer=portVoiceOperAutoPollTimer, portVoiceAdminForwardedType=portVoiceAdminForwardedType, nlLocalSubscriberTable=nlLocalSubscriberTable, portVoiceAdminSpeed=portVoiceAdminSpeed, ds0aStatsRcvOverruns=ds0aStatsRcvOverruns, portVoiceOperBlockedFlag=portVoiceOperBlockedFlag, portThreshTable=portThreshTable, ipxNodeDefaultConfigRIPSAPGap=ipxNodeDefaultConfigRIPSAPGap, portSdlcAdminPacketSize=portSdlcAdminPacketSize, portPhyX25OperDialOut=portPhyX25OperDialOut, snaDLC=snaDLC, lSSdlcLlc2OperLocalSap=lSSdlcLlc2OperLocalSap, portDLCIEntry=portDLCIEntry, bridgeOperVirtualLANID=bridgeOperVirtualLANID, bsciDevAdminRowStatus=bsciDevAdminRowStatus, bsciSubscrAdminSequence=bsciSubscrAdminSequence, nlLlc2HostT1ReplyTimer=nlLlc2HostT1ReplyTimer, portVoiceAdminBlockedFlag=portVoiceAdminBlockedFlag, lSSdlcOperLocalSub=lSSdlcOperLocalSub, nlIfIpSecondaryAddrRIPSupport=nlIfIpSecondaryAddrRIPSupport, portT1OperProtocolFraming=portT1OperProtocolFraming, portThreshRxFramesPerSec=portThreshRxFramesPerSec, nsNeighEntry=nsNeighEntry, portBsciAdminRetransmitInterval=portBsciAdminRetransmitInterval, portFrConnector=portFrConnector, portVoiceOperTETimer=portVoiceOperTETimer, rlpStatus=rlpStatus, nlInterfaces=nlInterfaces, nlIfIndex=nlIfIndex, nlIfVoicePeerNodeType=nlIfVoicePeerNodeType, lSSdlcLlc2AdminLanT2=lSSdlcLlc2AdminLanT2, portBsciOperSlowPollRetryCount=portBsciOperSlowPollRetryCount, nlIfVoiceRowStatus=nlIfVoiceRowStatus, portVoiceOperForwardedType=portVoiceOperForwardedType, portDLCIOutgoingBc=portDLCIOutgoingBc, nsNTNeighStat=nsNTNeighStat, nlIfIpUnnumberedIf=nlIfIpUnnumberedIf, nlLocalSubscriberRedirEntry=nlLocalSubscriberRedirEntry, rlpThreshTxFramesPerSec=rlpThreshTxFramesPerSec, x25TxSABMFrames=x25TxSABMFrames, nlLlc2OrigConnectionSequence=nlLlc2OrigConnectionSequence, ipxInterfaceNetBIOSEnabled=ipxInterfaceNetBIOSEnabled, portPinEntry=portPinEntry, portBsciOperSlowPollRetryFreq=portBsciOperSlowPollRetryFreq, portVoiceAdminExtDigitsSource=portVoiceAdminExtDigitsSource, nsNTNeigh=nsNTNeigh, ipxInterfaceWatchdogSpoofingEnabled=ipxInterfaceWatchdogSpoofingEnabled, rlpStatsFrameRejects=rlpStatsFrameRejects, portLogicalX25OperTable=portLogicalX25OperTable, portX25AdminFlowCtrlNeg=portX25AdminFlowCtrlNeg, nlIfVoiceEnableFragment=nlIfVoiceEnableFragment, nlLlc2HostIndex=nlLlc2HostIndex, x25TxStatsEntry=x25TxStatsEntry, t1StatsRcvErrors=t1StatsRcvErrors, ipxInterfaceSourceSubscriber=ipxInterfaceSourceSubscriber, nlIfIpMaxSVC=nlIfIpMaxSVC, portPhyX25OperTrunkFlag=portPhyX25OperTrunkFlag, lSSdlcAdminRetryTime=lSSdlcAdminRetryTime, portPhyX25OperSpeed=portPhyX25OperSpeed, nlLlc2OrigConnectionTable=nlLlc2OrigConnectionTable, nlLlc2OrigConnectionType=nlLlc2OrigConnectionType, ds0aStatsRlpIndex=ds0aStatsRlpIndex, portLogicalX25OperCxnPriority=portLogicalX25OperCxnPriority, portX25AdminOutCallBar=portX25AdminOutCallBar, portFrBackupDLCI=portFrBackupDLCI, nlLocalSubscriberRedirRowStatus=nlLocalSubscriberRedirRowStatus, lSSdlcLlc2OperPriority=lSSdlcLlc2OperPriority, ipxServConfigInterveningNetworks=ipxServConfigInterveningNetworks, portThreshRlpIndex=portThreshRlpIndex, portBsciAdminSlowPollRetryFreq=portBsciAdminSlowPollRetryFreq, portVoiceAdminDTMF=portVoiceAdminDTMF, nlIfLlc2LANPort=nlIfLlc2LANPort)
mibBuilder.exportSymbols("NETLINK-SPECIFIC-MIB", portPhyX25OperRcvClockFromDTE=portPhyX25OperRcvClockFromDTE, voiceStatsTxCalls=voiceStatsTxCalls, lSSdlcAdminAutoCall=lSSdlcAdminAutoCall, portBsciAdminErrorRetransmitCount=portBsciAdminErrorRetransmitCount, lSSdlcLlc2AdminTable=lSSdlcLlc2AdminTable, portBsciOperUseEBCDIC=portBsciOperUseEBCDIC, portBsciOperCallInfoInRequestPacket=portBsciOperCallInfoInRequestPacket, nlLlc2TermConnectionRemoteSubscriberId=nlLlc2TermConnectionRemoteSubscriberId, portX25OperInCallBar=portX25OperInCallBar, nodeCfgTable=nodeCfgTable, nlLlc2OrigConnectionEntry=nlLlc2OrigConnectionEntry, portBsciAdminTransTextSupported=portBsciAdminTransTextSupported, bridgeAdminSRBID=bridgeAdminSRBID, portBsciOperMAXRetransmits=portBsciOperMAXRetransmits, nlLlc2HostTiInactivityTimer=nlLlc2HostTiInactivityTimer, nlLlc2HostRoutingSubscriberId=nlLlc2HostRoutingSubscriberId, t1StatsYellowAlarms=t1StatsYellowAlarms, portLogicalX25OperFrDlci=portLogicalX25OperFrDlci, nsNeighTable=nsNeighTable, portSdlcAdminGenerateClock=portSdlcAdminGenerateClock, bsciDevOperConnectionID=bsciDevOperConnectionID, bsciSubscrOperAutocall=bsciSubscrOperAutocall, ipxServConfigRowStatus=ipxServConfigRowStatus, portBsciOperNoResponseRetryCount=portBsciOperNoResponseRetryCount, sdlcLSAddress=sdlcLSAddress, portFrGenClock=portFrGenClock, portSdlcAdminTable=portSdlcAdminTable, nlIfVoiceInterface=nlIfVoiceInterface, ds0aStatsChannelIndex=ds0aStatsChannelIndex, rlpMemorySize=rlpMemorySize, bridgeOperSRBID=bridgeOperSRBID, portPhyX25OperTrunkGroup=portPhyX25OperTrunkGroup, nlIfVoiceLocalNodeNumber=nlIfVoiceLocalNodeNumber, portX25AdminCUGOutAccess=portX25AdminCUGOutAccess, portPhyX25OperEntry=portPhyX25OperEntry, portPhyX25AdminTable=portPhyX25AdminTable, nlIfType=nlIfType, ipxInterfaceSourcePort=ipxInterfaceSourcePort, voiceStatsTxCallsAccepts=voiceStatsTxCallsAccepts, portVoiceOperForwardedDigits=portVoiceOperForwardedDigits, portSdlcAdminEntry=portSdlcAdminEntry, nlIfIpInterface=nlIfIpInterface, portStatsOutFrames=portStatsOutFrames, nlLocalSubscriberEntry=nlLocalSubscriberEntry, portX25AdminFastSelAccpt=portX25AdminFastSelAccpt, rlpStatsQMessages=rlpStatsQMessages, frStatsRxDEFrames=frStatsRxDEFrames, voiceStatsBusyCalls=voiceStatsBusyCalls, ipxInterfaceTable=ipxInterfaceTable, voiceSystemExtDialDigits=voiceSystemExtDialDigits, voiceSystemRingVolFreq=voiceSystemRingVolFreq, rlpConfigTable=rlpConfigTable, nlLlc2OrigConnectionRemoteSubscriberId=nlLlc2OrigConnectionRemoteSubscriberId, voiceSystemVoiceRatesMax=voiceSystemVoiceRatesMax, voiceSpeedDialEntry=voiceSpeedDialEntry, nlLlc2HostEntry=nlLlc2HostEntry, portStatsOutPercentUtils=portStatsOutPercentUtils, ipxStaticRouteConfigTable=ipxStaticRouteConfigTable, statFrame=statFrame, port=port, bsciDevOperEntry=bsciDevOperEntry, portDLCIConfigTable=portDLCIConfigTable, portSdlcOperCommit=portSdlcOperCommit, ipxInterfaceSourceDLCI=ipxInterfaceSourceDLCI, frStatsPortIndex=frStatsPortIndex, status=status, portStatsLogicalRejects=portStatsLogicalRejects, nlLocalSubscriberRouteIndex=nlLocalSubscriberRouteIndex, lSSdlcLlc2AdminLanN2=lSSdlcLlc2AdminLanN2, frStatsRlpIndex=frStatsRlpIndex, portT1OperTable=portT1OperTable, nlLlc2TermConnectionTable=nlLlc2TermConnectionTable, ipxConfigRouting=ipxConfigRouting, bsciDevAdminEntry=bsciDevAdminEntry, portX25AdminDefPktSize=portX25AdminDefPktSize, portVoiceAdminEntry=portVoiceAdminEntry, portVoiceAdminAutoDial=portVoiceAdminAutoDial, ipxInterfaceWanEnabled=ipxInterfaceWanEnabled, voiceStatsRlpIndex=voiceStatsRlpIndex, nlIfIpSVCRetryTimer=nlIfIpSVCRetryTimer, portVoiceOperCallTimer=portVoiceOperCallTimer, ipxInterfacePVCConnection=ipxInterfacePVCConnection, portBsciAdminBlockCheck=portBsciAdminBlockCheck, ipxInterfaceBlockedPortFlag=ipxInterfaceBlockedPortFlag, ipxConfigNodeDefault=ipxConfigNodeDefault, t1StatsPCVRErrs=t1StatsPCVRErrs, portStatsInFrames=portStatsInFrames, voiceSystemVoiceNodeNum=voiceSystemVoiceNodeNum, portX25OperMaxThruptClass=portX25OperMaxThruptClass, nlLocalSubscriberName=nlLocalSubscriberName, rlpStatsUsedBuffers=rlpStatsUsedBuffers, lSSdlcLlc2OperBAG=lSSdlcLlc2OperBAG, nlLlc2HostInterface=nlLlc2HostInterface, nlLlc2HostBAG=nlLlc2HostBAG, nlIfLlc2FrEntry=nlIfLlc2FrEntry, portVoiceOperPortIndex=portVoiceOperPortIndex, rlpLIC2Type=rlpLIC2Type, bsciSubscrAdminEntry=bsciSubscrAdminEntry, nlIfLlc2FrLANID=nlIfLlc2FrLANID, nlIfIpRIPSupport=nlIfIpRIPSupport, portPhyX25AdminGenerateClock=portPhyX25AdminGenerateClock, NlSubscriberAddress=NlSubscriberAddress, portSdlcAdminMAXOut=portSdlcAdminMAXOut, local=local, nodeAlmTable=nodeAlmTable, portDLCIOutgoingBe=portDLCIOutgoingBe, portBsciAdminEntry=portBsciAdminEntry, lSSdlcOperLlc2Conversion=lSSdlcOperLlc2Conversion, frStatsTotDiscFrames=frStatsTotDiscFrames, t1StatsXmitFrames=t1StatsXmitFrames, portBsciAdminConnector=portBsciAdminConnector, portSdlcGroup=portSdlcGroup, lSSdlcOperTable=lSSdlcOperTable, ipxInterfaceSVCRetryTimer=ipxInterfaceSVCRetryTimer, portX25OperCUGIndex=portX25OperCUGIndex, statBag=statBag, portVoiceAdminDTMFOffDuration=portVoiceAdminDTMFOffDuration, portFrBlockedFlag=portFrBlockedFlag, portDLCIBackupProtEnb=portDLCIBackupProtEnb, portVoiceOperSampleDelay=portVoiceOperSampleDelay, ipxStaticRouteConfigCircIndex=ipxStaticRouteConfigCircIndex, frStatsTxFECNFrames=frStatsTxFECNFrames, bsciDevOperDisableStatusRequest=bsciDevOperDisableStatusRequest, portBsciOperFullDuplex=portBsciOperFullDuplex, lSSdlcLlc2AdminLanT1=lSSdlcLlc2AdminLanT1, nlIfIpRowStatus=nlIfIpRowStatus, portBsciOperBlockedFlag=portBsciOperBlockedFlag, portT1OperFramingMode=portT1OperFramingMode, portVoiceOperLongDialPrefix=portVoiceOperLongDialPrefix, t1StatsBlueAlarms=t1StatsBlueAlarms, portThreshRxErrorRatio=portThreshRxErrorRatio, nlIfVoiceFrameRelayDLCI=nlIfVoiceFrameRelayDLCI, portSdlcOperPadType=portSdlcOperPadType, portSdlcAdminNrz=portSdlcAdminNrz, portT1AdminLineEncoding=portT1AdminLineEncoding, portFrBackupProtEnab=portFrBackupProtEnab, rlpThreshPercntBufInUse=rlpThreshPercntBufInUse, portBsciOperEndToEndAck=portBsciOperEndToEndAck, bsciSubscrAdminRowStatus=bsciSubscrAdminRowStatus, rlpThreshRtxFramesPerSec=rlpThreshRtxFramesPerSec, ipxServConfigServName=ipxServConfigServName, ds0aStatsXmitFrames=ds0aStatsXmitFrames, nlIfLlc2LANCard=nlIfLlc2LANCard, portX25AdminRevChgAccpt=portX25AdminRevChgAccpt, ipxStaticRouteConfigEntry=ipxStaticRouteConfigEntry, portT1OperEntry=portT1OperEntry, x25RxRlpIndex=x25RxRlpIndex, portFrBackupEntry=portFrBackupEntry, nlLlc2HostSrcMACAddressMask=nlLlc2HostSrcMACAddressMask, ipxInterfaceMaxVC=ipxInterfaceMaxVC, rlpStatsTable=rlpStatsTable, nlIfLlc2LANType=nlIfLlc2LANType, portVoiceAdminSuppression=portVoiceAdminSuppression, nlIfIpSecondaryAddrSourceAddress=nlIfIpSecondaryAddrSourceAddress, portSdlcAdminRowStatus=portSdlcAdminRowStatus, lSSdlcLlc2OperLanN3=lSSdlcLlc2OperLanN3, ipxConfig=ipxConfig, ds0aStatsPortIndex=ds0aStatsPortIndex, portVoiceAdminSLTTimeout=portVoiceAdminSLTTimeout, t1StatsRcvFrames=t1StatsRcvFrames, portVoiceAdminHuntGroup=portVoiceAdminHuntGroup, voiceSpeedDialLongDialMap=voiceSpeedDialLongDialMap, nlLocalSubscriberRedirTable=nlLocalSubscriberRedirTable, nlLocalSubscriberRowStatus=nlLocalSubscriberRowStatus, x25TxDISCFrames=x25TxDISCFrames, portT1OperFrameModelSelect=portT1OperFrameModelSelect, lSSdlcAdminRemoteSub=lSSdlcAdminRemoteSub, nlLlc2TermConnectionRowStatus=nlLlc2TermConnectionRowStatus, x25TxUAFrames=x25TxUAFrames, ipxInterfaceNumber=ipxInterfaceNumber, voiceSpeedDialTable=voiceSpeedDialTable, tpAdrFlag=tpAdrFlag, bsciDevAdminControlUnitID=bsciDevAdminControlUnitID, ipxServConfigServNetworkAddress=ipxServConfigServNetworkAddress, nlLlc2TermConnectionSequence=nlLlc2TermConnectionSequence, portT1OperLineEncoding=portT1OperLineEncoding, nlIfIpType=nlIfIpType, lSSdlcLlc2AdminLocalSap=lSSdlcLlc2AdminLocalSap, x25RxPortIndex=x25RxPortIndex, portSdlcOperL1Duplex=portSdlcOperL1Duplex, portX25AdminEntry=portX25AdminEntry, portT1AdminEntry=portT1AdminEntry, portBsciAdminUseEBCDIC=portBsciAdminUseEBCDIC, x25TxPortIndex=x25TxPortIndex, portBsciOperTable=portBsciOperTable, portT1AdminProtocolFraming=portT1AdminProtocolFraming, portLogicalX25OperEntry=portLogicalX25OperEntry, portVoiceOperHuntGroup=portVoiceOperHuntGroup, nlIfIpMtu=nlIfIpMtu, nlLlc2HostTwNumberOutstanding=nlLlc2HostTwNumberOutstanding, x25TxREJFrames=x25TxREJFrames, frStatsTxBECNFrames=frStatsTxBECNFrames, tpAdrIdx=tpAdrIdx, portBsciAdminNAKRetryCount=portBsciAdminNAKRetryCount, portStatsIndex=portStatsIndex, portVoiceAdminInterface=portVoiceAdminInterface, rlpLIC1Type=rlpLIC1Type, portBsciAdminGenerateClock=portBsciAdminGenerateClock, portBsciAdminAnswerNonConfigured=portBsciAdminAnswerNonConfigured, voiceStatsRxCongestions=voiceStatsRxCongestions, statGroup=statGroup, nlIfLlc2FrRlp=nlIfLlc2FrRlp, x25RxRRFrames=x25RxRRFrames, netstat=netstat, portFrSpeed=portFrSpeed, rlpProtocol=rlpProtocol, lSSdlcLlc2OperLanT2=lSSdlcLlc2OperLanT2, lSSdlcLlc2OperEntry=lSSdlcLlc2OperEntry, portT1OperLineBuildOut=portT1OperLineBuildOut, portPhyX25AdminDialOut=portPhyX25AdminDialOut, portFrGroup=portFrGroup, portSdlcAdminL1Duplex=portSdlcAdminL1Duplex, portSdlcOperInactivityTimer=portSdlcOperInactivityTimer, portX25AdminMaxThruptClass=portX25AdminMaxThruptClass, portVoiceOperSuppression=portVoiceOperSuppression, portVoiceAdminAutoDialNumber=portVoiceAdminAutoDialNumber, ipxServConfigServiceType=ipxServConfigServiceType, ipxInterfacePeriodicRIPEnabled=ipxInterfacePeriodicRIPEnabled, ipxInterfacePeriodicSAPTimer=ipxInterfacePeriodicSAPTimer, nlIfIpSecondaryAddrEntry=nlIfIpSecondaryAddrEntry, nlIfVoiceLocalNodePort=nlIfVoiceLocalNodePort, portVoiceAdminForwardDelay=portVoiceAdminForwardDelay, nlLocalSubscriberRouteEntry=nlLocalSubscriberRouteEntry, portBsciAdminNoResponseTimer=portBsciAdminNoResponseTimer, portVoiceOperDTMFOffDuration=portVoiceOperDTMFOffDuration, nlLlc2HostAccess=nlLlc2HostAccess, rlpStatsEntry=rlpStatsEntry, x25TxFRMRFrames=x25TxFRMRFrames, portX25OperCUGOutAccess=portX25OperCUGOutAccess, portThreshFCSErrPerSec=portThreshFCSErrPerSec, x25RxFRMRFrames=x25RxFRMRFrames, portVoiceAdminLevelOut=portVoiceAdminLevelOut, frStatsTable=frStatsTable, portVoiceOperInterface=portVoiceOperInterface, statDS0A=statDS0A, portVoiceAdminTelephonyType=portVoiceAdminTelephonyType, ipxInterfaceBandwidthAllocGroup=ipxInterfaceBandwidthAllocGroup, frStatsRxFECNFrames=frStatsRxFECNFrames, portVoiceAdminFaxSupported=portVoiceAdminFaxSupported, portStatsFCSErrors=portStatsFCSErrors, portVoiceOperDTMFOnDuration=portVoiceOperDTMFOnDuration, portFrRlpIndex=portFrRlpIndex, portVoiceAdminLongDialPrefix=portVoiceAdminLongDialPrefix, portThreshLogRejPerSec=portThreshLogRejPerSec, lSSdlcOperAutoCall=lSSdlcOperAutoCall, ipNl=ipNl, nlIfConnectorType=nlIfConnectorType, nlIfLlc2FrInterface=nlIfLlc2FrInterface, portPhyX25AdminEntry=portPhyX25AdminEntry, ipxServConfigServSocketNumber=ipxServConfigServSocketNumber, t1StatsPortIndex=t1StatsPortIndex, portBsciOperRcvClockFromDTE=portBsciOperRcvClockFromDTE, portPhyX25AdminConnector=portPhyX25AdminConnector, portX25OperDefWinSize=portX25OperDefWinSize)
mibBuilder.exportSymbols("NETLINK-SPECIFIC-MIB", portSdlcOperLPDASupport=portSdlcOperLPDASupport, portStatsInPercentUtils=portStatsInPercentUtils, portPhyX25AdminInactivityTimer=portPhyX25AdminInactivityTimer, nlIfLlc2LANInterface=nlIfLlc2LANInterface, portSdlcOperPacketSize=portSdlcOperPacketSize, sdlcLSAdminEntry=sdlcLSAdminEntry, bsciSubscrOperTable=bsciSubscrOperTable, lSSdlcOperRetryCount=lSSdlcOperRetryCount, portSdlcAdminMAXRetries=portSdlcAdminMAXRetries, nlLlc2HostN2ExpiredT1LPDUCount=nlLlc2HostN2ExpiredT1LPDUCount, portVoiceAdminSampleDelay=portVoiceAdminSampleDelay, portX25OperFastSelAccpt=portX25OperFastSelAccpt, nlIfIpEntry=nlIfIpEntry, portLogicalX25AdminFrDlci=portLogicalX25AdminFrDlci, portT1AdminRowStatus=portT1AdminRowStatus, portVoiceAdminPortIndex=portVoiceAdminPortIndex, node=node, ipxInterfaceLanCardNumber=ipxInterfaceLanCardNumber, x25TxRRFrames=x25TxRRFrames, portFrLogicalDCE=portFrLogicalDCE, portPhyX25OperSetupTimer=portPhyX25OperSetupTimer, portVoiceOperForwardDelay=portVoiceOperForwardDelay, portT1OperNRZI=portT1OperNRZI, portVoiceOperLevelOut=portVoiceOperLevelOut, nlIfIpPriority=nlIfIpPriority, bsciSubscrAdminLocalID=bsciSubscrAdminLocalID, tpAdrEntry=tpAdrEntry, portVoiceAdminToneType=portVoiceAdminToneType, portX25AdminCUGIndex=portX25AdminCUGIndex, rlpStatsIndex=rlpStatsIndex, portFrEntry=portFrEntry, nlIfTableIndex=nlIfTableIndex, nlIfIpSourceDLCI=nlIfIpSourceDLCI, ipxInterfacePeriodicSAPEnabled=ipxInterfacePeriodicSAPEnabled, rlpGroupResponsibility=rlpGroupResponsibility, portX25AdminCUGPref=portX25AdminCUGPref, portDLCIBecnRecoveryCnt=portDLCIBecnRecoveryCnt, portSdlcOperDisableRequestDisconnect=portSdlcOperDisableRequestDisconnect, rlpThreshMsgQueueLen=rlpThreshMsgQueueLen, portBsciOperErrorRetransmitCount=portBsciOperErrorRetransmitCount, nsMaxNeigh=nsMaxNeigh, portVoiceOperBreakRatio=portVoiceOperBreakRatio, ipxServConfigGatewayAddress=ipxServConfigGatewayAddress, ipxServConfigEntry=ipxServConfigEntry, rlpIndex=rlpIndex, bsciDevAdminTransTextSupported=bsciDevAdminTransTextSupported, portT1AdminLineBuildOut=portT1AdminLineBuildOut, ipxInterfaceSourceCard=ipxInterfaceSourceCard, portBsciAdminPadType=portBsciAdminPadType, nlLlc2HostN3NumberLPDUs=nlLlc2HostN3NumberLPDUs, portDLCIIndex=portDLCIIndex, portBsciOperAnswerNonConfigured=portBsciOperAnswerNonConfigured, lSSdlcAdminRetryCount=lSSdlcAdminRetryCount, nlIfIpInverseARP=nlIfIpInverseARP, portSdlcOperNrz=portSdlcOperNrz, portVoiceAdminRowStatus=portVoiceAdminRowStatus, portVoiceAdminJitter=portVoiceAdminJitter, portVoiceOperJitter=portVoiceOperJitter, ipxServConfigInterface=ipxServConfigInterface, nlIfIpBroadcastAddress=nlIfIpBroadcastAddress, nlIfTable=nlIfTable, portPinRlp=portPinRlp, bridgeMaxSizeForwardingTable=bridgeMaxSizeForwardingTable, portX25OperMaxWinSize=portX25OperMaxWinSize, t1StatsRlpIndex=t1StatsRlpIndex, portBsciOperEndPadChars=portBsciOperEndPadChars, x25RxREJFrames=x25RxREJFrames, statistics=statistics, x25TxRNRFrames=x25TxRNRFrames, ds0aStatsRcvAbortFrames=ds0aStatsRcvAbortFrames, nlIfIpDestAddress=nlIfIpDestAddress, x25TxDMFrames=x25TxDMFrames, portX25AdminCUGIncAccess=portX25AdminCUGIncAccess, bsciSubscrOperEntry=bsciSubscrOperEntry, nlIfVoiceTable=nlIfVoiceTable)
