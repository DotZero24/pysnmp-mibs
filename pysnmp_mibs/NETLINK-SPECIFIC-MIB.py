...
Gauge32, enterprises, MibIdentifier, NotificationType, Bits, Integer32, Unsigned32, mgmt, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, Counter64, TimeTicks, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibIdentifier", "NotificationType", "Bits", "Integer32", "Unsigned32", "mgmt", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "Counter64", "TimeTicks", "ModuleIdentity", "mib-2")
RowStatus, TextualConvention, TimeInterval, MacAddress, PhysAddress, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeInterval", "MacAddress", "PhysAddress", "DisplayString")
...
mibBuilder.exportSymbols("NETLINK-SPECIFIC-MIB", portVoiceAdminAutoPollTimer=portVoiceAdminAutoPollTimer, portVoiceAdminDTMFOffDuration=portVoiceAdminDTMFOffDuration, nlIfLlc2LANRowStatus=nlIfLlc2LANRowStatus, frStatsRxANXDFrames=frStatsRxANXDFrames, t1StatsRcvErrors=t1StatsRcvErrors, portVoiceAdminMakeRatio=portVoiceAdminMakeRatio, bridgeOperSRBID=bridgeOperSRBID, rlpStatus=rlpStatus, bsciDevAdminConnectionID=bsciDevAdminConnectionID, nlIfIpDestSub=nlIfIpDestSub, ipxInterfaceBlockedPortFlag=ipxInterfaceBlockedPortFlag, portPhyX25AdminGenerateClock=portPhyX25AdminGenerateClock, portThreshFCSErrPerSec=portThreshFCSErrPerSec, nlIfIpSecondaryAddrTable=nlIfIpSecondaryAddrTable, portT1AdminLineEncoding=portT1AdminLineEncoding, nsNeighEntry=nsNeighEntry, portBsciOperClearVCOnLastDeviceDown=portBsciOperClearVCOnLastDeviceDown, portX25OperEntry=portX25OperEntry, portStatsInFrames=portStatsInFrames, ipxInterfaceTransportTime=ipxInterfaceTransportTime, portBsciAdminMAXRetransmits=portBsciAdminMAXRetransmits, ipxNodeDefaultConfigNetworkAddress=ipxNodeDefaultConfigNetworkAddress, nlIfIpInterfaces=nlIfIpInterfaces, voiceSystemExtDialDigits=voiceSystemExtDialDigits, nlIfIpBroadcastAddress=nlIfIpBroadcastAddress, voiceStatsTxCalls=voiceStatsTxCalls, nlIfLlc2FrPort=nlIfLlc2FrPort, lSSdlcOperAutoCall=lSSdlcOperAutoCall, bsciSubscrAdminEntry=bsciSubscrAdminEntry, portX25OperMaxThruptClass=portX25OperMaxThruptClass, portDLCIOutgoingCIR=portDLCIOutgoingCIR, bsciDevOperDisableStatusRequest=bsciDevOperDisableStatusRequest, portX25AdminLocChgPrev=portX25AdminLocChgPrev, voiceSystemDialDigits=voiceSystemDialDigits, nlIfIpRowStatus=nlIfIpRowStatus, ipxStaticRouteConfigEntry=ipxStaticRouteConfigEntry, portVoiceAdminLevelIn=portVoiceAdminLevelIn, portX25OperBlockedFlag=portX25OperBlockedFlag, nlLlc2HostT1ReplyTimer=nlLlc2HostT1ReplyTimer, portX25AdminCUGOutAccess=portX25AdminCUGOutAccess, portSdlcOperCommit=portSdlcOperCommit, nlIfIpMtu=nlIfIpMtu, lSSdlcLlc2AdminLanN3=lSSdlcLlc2AdminLanN3, t1StatsRcvUsage=t1StatsRcvUsage, portBsciOperNoResponseTimer=portBsciOperNoResponseTimer, portVoiceOperHuntGroup=portVoiceOperHuntGroup, nlLocalSubscriberRouteRowStatus=nlLocalSubscriberRouteRowStatus, nlIfVoiceTable=nlIfVoiceTable, bsciSubscrOperConnectionID=bsciSubscrOperConnectionID, ipxInterfaceFrameType=ipxInterfaceFrameType, portX25OperMaxWinSize=portX25OperMaxWinSize, lSSdlcLlc2AdminLanT1=lSSdlcLlc2AdminLanT1, portFrRowStatus=portFrRowStatus, portVoiceAdminBlockedFlag=portVoiceAdminBlockedFlag, portVoiceAdminEntry=portVoiceAdminEntry, portPhyX25OperInactivityTimer=portPhyX25OperInactivityTimer, nlIfIndex=nlIfIndex, bsciDevAdminPrinterAttached=bsciDevAdminPrinterAttached, nlIfTableOid=nlIfTableOid, nlIfLlc2LANRlp=nlIfLlc2LANRlp, portSdlcAdminPadType=portSdlcAdminPadType, portVoiceAdminFaxSupported=portVoiceAdminFaxSupported, nlIpDefaultRIPVersion=nlIpDefaultRIPVersion, portVoiceOperPortIndex=portVoiceOperPortIndex, nsMaxNeigh=nsMaxNeigh, lSSdlcLlc2OperBAG=lSSdlcLlc2OperBAG, ipxInterfaceSourcePort=ipxInterfaceSourcePort, portBsciAdminPollInterval=portBsciAdminPollInterval, nlIfLlc2LANPort=nlIfLlc2LANPort, x25RxINFOFrames=x25RxINFOFrames, x25RxREJFrames=x25RxREJFrames, ipxInterfacePeriodicSAPTimer=ipxInterfacePeriodicSAPTimer, portPhyX25OperRcvClockFromDTE=portPhyX25OperRcvClockFromDTE, portPhyX25OperTrunkGroup=portPhyX25OperTrunkGroup, portVoiceOperLongDialPrefix=portVoiceOperLongDialPrefix, portPhyX25OperSpeed=portPhyX25OperSpeed, portBsciAdminRcvClockFromDTE=portBsciAdminRcvClockFromDTE, portVoiceOperDialTimer=portVoiceOperDialTimer, nlLocalSubscriberRouteTable=nlLocalSubscriberRouteTable, portVoiceAdminExtDigitsSource=portVoiceAdminExtDigitsSource, nlIfEntry=nlIfEntry, portFrGenClock=portFrGenClock, portBsciOperBlockedFlag=portBsciOperBlockedFlag, voiceStatsTxCallsAccepts=voiceStatsTxCallsAccepts, portPhyX25OperConnector=portPhyX25OperConnector, portBsciAdminNAKRetryCount=portBsciAdminNAKRetryCount, lSSdlcLlc2OperSuppressXID=lSSdlcLlc2OperSuppressXID, portSdlcAdminLPDASupport=portSdlcAdminLPDASupport, x25TxINFOFrames=x25TxINFOFrames, portPhyX25AdminTable=portPhyX25AdminTable, lSSdlcLlc2OperEntry=lSSdlcLlc2OperEntry, portSdlcAdminTable=portSdlcAdminTable, ipxNodeDefaultConfigRIPSAPGap=ipxNodeDefaultConfigRIPSAPGap, nlIfIpSVCIdleTimer=nlIfIpSVCIdleTimer, nlLlc2TermConnectionRowStatus=nlLlc2TermConnectionRowStatus, portBsciAdminBlockCheck=portBsciAdminBlockCheck, t1StatsLCVCnt=t1StatsLCVCnt, portT1OperTable=portT1OperTable, nlLlc2HostSrcMACAddressMask=nlLlc2HostSrcMACAddressMask, lSSdlcLlc2OperIdblk=lSSdlcLlc2OperIdblk, bsciDevOperEntry=bsciDevOperEntry, rlpStatsTable=rlpStatsTable, statFrame=statFrame, portSdlcOperPadType=portSdlcOperPadType, portFrBackupRowStatus=portFrBackupRowStatus, nlIfIpSecondaryAddrRIPSupport=nlIfIpSecondaryAddrRIPSupport, nlLlc2OrigConnectionSequence=nlLlc2OrigConnectionSequence, portVoiceAdminCallTimer=portVoiceAdminCallTimer, portVoiceAdminAutoDialNumber=portVoiceAdminAutoDialNumber, nlLocalSubscriberRedirRowStatus=nlLocalSubscriberRedirRowStatus, ds0aStatsRcvFrames=ds0aStatsRcvFrames, lSSdlcLlc2OperPriority=lSSdlcLlc2OperPriority, ipxConfigRouting=ipxConfigRouting, portBsciGroup=portBsciGroup, portStatsOutPercentUtils=portStatsOutPercentUtils, portFrBackupPort=portFrBackupPort, bsciSubscrOperSequence=bsciSubscrOperSequence, portSdlcOperSpeed=portSdlcOperSpeed, nlLlc2HostPriority=nlLlc2HostPriority, portBsciAdminErrorRetransmitCount=portBsciAdminErrorRetransmitCount, portVoiceOperForwardedType=portVoiceOperForwardedType, portT1AdminNRZI=portT1AdminNRZI, portVoiceAdminAutoPoll=portVoiceAdminAutoPoll, nlIfLlc2FrRlp=nlIfLlc2FrRlp, portT1AdminLineBuildOut=portT1AdminLineBuildOut, portStatsInPercentUtils=portStatsInPercentUtils, bsciDevAdminDisableStatusRequest=bsciDevAdminDisableStatusRequest, tpAdrSLev=tpAdrSLev, portLogicalX25OperRfc1490=portLogicalX25OperRfc1490, ds0aStatsRcvErrors=ds0aStatsRcvErrors, nlIfType=nlIfType, nlLlc2HostAccess=nlLlc2HostAccess, portX25OperRevChgAccpt=portX25OperRevChgAccpt, portVoiceOperTelephonyType=portVoiceOperTelephonyType, frStatsTxDEFrames=frStatsTxDEFrames, x25RxSABMFrames=x25RxSABMFrames, lSSdlcLlc2OperLocalMac=lSSdlcLlc2OperLocalMac, portX25Group=portX25Group, nlIfLlc2LANBlockedPortFlag=nlIfLlc2LANBlockedPortFlag, lSSdlcOperLlc2Conversion=lSSdlcOperLlc2Conversion, portX25OperLocChgPrev=portX25OperLocChgPrev, ipxInterfaceSourceSubscriber=ipxInterfaceSourceSubscriber, x25TxDISCFrames=x25TxDISCFrames, rlpEntry=rlpEntry, nlLocalSubscriberRedirAddr=nlLocalSubscriberRedirAddr, ipxInterfaceNumber=ipxInterfaceNumber, portVoiceOperAutoDialNumber=portVoiceOperAutoDialNumber, t1StatsTable=t1StatsTable, portBsciOperCallInfoInRequestPacket=portBsciOperCallInfoInRequestPacket, portVoiceAdminDTMF=portVoiceAdminDTMF, ds0aStatsRcvAbortFrames=ds0aStatsRcvAbortFrames, ipxInterfacePVCConnection=ipxInterfacePVCConnection, rlpProtocol=rlpProtocol, portVoiceOperSuppression=portVoiceOperSuppression, nlIfIpMaxSVC=nlIfIpMaxSVC, portStatsIndex=portStatsIndex, nlLlc2HostTable=nlLlc2HostTable, portPhyX25AdminSpeed=portPhyX25AdminSpeed, portVoiceAdminLongDialPrefix=portVoiceAdminLongDialPrefix, nlIfRlp=nlIfRlp, x25TxUAFrames=x25TxUAFrames, portVoiceOperLinkDownBusy=portVoiceOperLinkDownBusy, portThreshEntry=portThreshEntry, nlIfIpPVCConnection=nlIfIpPVCConnection, ipxInterfaceRIPMaxSize=ipxInterfaceRIPMaxSize, nsStatus=nsStatus, rlpLIC1Type=rlpLIC1Type, lSSdlcLlc2OperLanT2=lSSdlcLlc2OperLanT2, portVoiceOperForwardedDigits=portVoiceOperForwardedDigits, bridge=bridge, portFrSpeed=portFrSpeed, portBsciOperSlowPollRetryFreq=portBsciOperSlowPollRetryFreq, nlLocalSubscriberRedirectBusy=nlLocalSubscriberRedirectBusy, portLogicalX25AdminRfc1490=portLogicalX25AdminRfc1490, bsciDevOperConnectionID=bsciDevOperConnectionID, portSdlcAdminEntry=portSdlcAdminEntry, rlpStatsIndex=rlpStatsIndex, portSdlcOperPacketSize=portSdlcOperPacketSize, nlIfLlc2FrTable=nlIfLlc2FrTable, portX25AdminRevChgAccpt=portX25AdminRevChgAccpt, nlIfIpPriority=nlIfIpPriority, portThreshIndex=portThreshIndex, lSSdlcAdminRemoteSub=lSSdlcAdminRemoteSub, portBsciOperEndPadChars=portBsciOperEndPadChars, portVoiceOperInterface=portVoiceOperInterface, portFrOutgoingRateControl=portFrOutgoingRateControl, portDLCIIncomingBe=portDLCIIncomingBe, voiceSpeedDialDigits=voiceSpeedDialDigits, ipxConfigNodeDefault=ipxConfigNodeDefault, portVoiceOperFaxSupported=portVoiceOperFaxSupported, rlpStatsFrameRejects=rlpStatsFrameRejects, ipNl=ipNl, portBsciOperMAXRetransmits=portBsciOperMAXRetransmits, portBsciOperNAKRetryCount=portBsciOperNAKRetryCount, portThreshTable=portThreshTable, nlIfIpSourceDLCI=nlIfIpSourceDLCI, portBsciAdminSlowPollRetryFreq=portBsciAdminSlowPollRetryFreq, portThreshRxPercentUtl=portThreshRxPercentUtl, portBsciOperActivateConnectionWithoutPoll=portBsciOperActivateConnectionWithoutPoll, portDLCIBecnRecoveryCnt=portDLCIBecnRecoveryCnt, nsNumNeigh=nsNumNeigh, portT1OperEntry=portT1OperEntry, nlIfLlc2LANInterface=nlIfLlc2LANInterface, nlIfIpSourceAddress=nlIfIpSourceAddress, ipxInterfaceSAPEnabled=ipxInterfaceSAPEnabled, portVoiceOperSampleDelay=portVoiceOperSampleDelay, x25RxPortIndex=x25RxPortIndex, t1StatsRedAlarms=t1StatsRedAlarms, portPhyX25AdminRcvClockFromDTE=portPhyX25AdminRcvClockFromDTE, portFrBackupUseOnly=portFrBackupUseOnly, portBsciAdminSlowPollRetryCount=portBsciAdminSlowPollRetryCount, portDLCIConfigTable=portDLCIConfigTable, t1StatsOOSCnt=t1StatsOOSCnt, portX25OperDefWinSize=portX25OperDefWinSize, portX25AdminInCallBar=portX25AdminInCallBar, bsciSubscrOperRemoteID=bsciSubscrOperRemoteID, portPhyX25AdminTrunkFlag=portPhyX25AdminTrunkFlag, t1StatsRcvFrames=t1StatsRcvFrames, voiceStatsRxCallsAccepts=voiceStatsRxCallsAccepts, portPhyX25OperTable=portPhyX25OperTable, nodeTrapText=nodeTrapText, x25TxStatsEntry=x25TxStatsEntry, ds0aStatsTable=ds0aStatsTable, nlIfIpRIPSupport=nlIfIpRIPSupport, voiceStatsCallTimeouts=voiceStatsCallTimeouts, bsciDevOperDeviceUnitID=bsciDevOperDeviceUnitID, portBsciOperTransTextSupported=portBsciOperTransTextSupported, portBsciOperStartSynchChars=portBsciOperStartSynchChars, nlIfLlc2FrHostMACAddress=nlIfLlc2FrHostMACAddress, portStatsTable=portStatsTable, portSdlcAdminNrz=portSdlcAdminNrz, netlink=netlink, ipxInterfacePortDiagEnabled=ipxInterfacePortDiagEnabled, portPhyX25AdminInactivityTimer=portPhyX25AdminInactivityTimer, lSSdlcAdminRetryTime=lSSdlcAdminRetryTime, portVoiceOperSpeed=portVoiceOperSpeed, portBsciOperNoResponseRetryCount=portBsciOperNoResponseRetryCount, ipxNodeDefaultConfigRouterName=ipxNodeDefaultConfigRouterName, nlIfVoicePeerNodeNumber=nlIfVoicePeerNodeNumber, nlLlc2NextHostNumber=nlLlc2NextHostNumber, voiceSpeedDialEntry=voiceSpeedDialEntry, ipxInterfacePeriodicRIPEnabled=ipxInterfacePeriodicRIPEnabled, ipxInterfaceTable=ipxInterfaceTable, nlIfIpLANCard=nlIfIpLANCard, portX25OperCUGIncAccess=portX25OperCUGIncAccess, statGroup=statGroup, portPhyX25OperGenerateClock=portPhyX25OperGenerateClock, ipxInterfaceRowStatus=ipxInterfaceRowStatus, rlpThreshTable=rlpThreshTable, portFrEntry=portFrEntry, rlpLIC2Type=rlpLIC2Type, voiceStatsRxCalls=voiceStatsRxCalls, x25TxREJFrames=x25TxREJFrames, ipxInterfaceRIPEnabled=ipxInterfaceRIPEnabled)
mibBuilder.exportSymbols("NETLINK-SPECIFIC-MIB", sdlc=sdlc, nlIfIpSecondaryAddrSequence=nlIfIpSecondaryAddrSequence, bsciSubscrAdminLocalID=bsciSubscrAdminLocalID, ds0aStatsXmitFrames=ds0aStatsXmitFrames, ipxInterfaceSerializationEnabled=ipxInterfaceSerializationEnabled, portX25OperOutCallBar=portX25OperOutCallBar, nlIfLlc2FrInterface=nlIfLlc2FrInterface, portBsciOperMultidrop=portBsciOperMultidrop, x25RxRNRFrames=x25RxRNRFrames, rlpStatsQMessages=rlpStatsQMessages, portThreshRtxFramesPerSec=portThreshRtxFramesPerSec, portFrLogicalDCE=portFrLogicalDCE, lSSdlcOperEntry=lSSdlcOperEntry, lSSdlcLlc2OperLocalSap=lSSdlcLlc2OperLocalSap, ipxInterfaceWanEnabled=ipxInterfaceWanEnabled, lSSdlcOperRetryCount=lSSdlcOperRetryCount, lSSdlcLlc2AdminSuppressXID=lSSdlcLlc2AdminSuppressXID, ipxServConfigServNodeAddress=ipxServConfigServNodeAddress, nlLlc2OrigConnectionMAXIN=nlLlc2OrigConnectionMAXIN, nlIfLlc2FrLANID=nlIfLlc2FrLANID, portVoiceOperTETimer=portVoiceOperTETimer, portFrT392Timer=portFrT392Timer, portVoiceAdminPortIndex=portVoiceAdminPortIndex, portVoiceOperMakeRatio=portVoiceOperMakeRatio, nlIfPort=nlIfPort, portBsciOperRcvClockFromDTE=portBsciOperRcvClockFromDTE, voice=voice, portStatsRlpIndex=portStatsRlpIndex, portBsciAdminAnswerNonConfigured=portBsciAdminAnswerNonConfigured, nlIfIpSecondaryAddrNetworkMask=nlIfIpSecondaryAddrNetworkMask, portThreshRxErrorRatio=portThreshRxErrorRatio, ipxInterfaceDestinationSubscriber=ipxInterfaceDestinationSubscriber, portPinRlp=portPinRlp, nlIfVoiceFrameRelayRlp=nlIfVoiceFrameRelayRlp, nlLlc2HostTiInactivityTimer=nlLlc2HostTiInactivityTimer, ds0aStatsEntry=ds0aStatsEntry, ipxInterfaceLanCardNumber=ipxInterfaceLanCardNumber, ipxInterfaceBandwidthAllocGroup=ipxInterfaceBandwidthAllocGroup, portStatsLogicalRejects=portStatsLogicalRejects, lSSdlcLlc2AdminLanT2=lSSdlcLlc2AdminLanT2, portSdlcAdminRowStatus=portSdlcAdminRowStatus, lSSdlcLlc2OperLanN3=lSSdlcLlc2OperLanN3, portX25AdminCUGIncAccess=portX25AdminCUGIncAccess, lSSdlcAdminEntry=lSSdlcAdminEntry, portVoiceAdminBreakRatio=portVoiceAdminBreakRatio, nlLlc2HostT2RecvAckTimer=nlLlc2HostT2RecvAckTimer, portT1AdminFramingMode=portT1AdminFramingMode, nlIfIpType=nlIfIpType, frStatsPortIndex=frStatsPortIndex, portT1AdminBlockedPortFlag=portT1AdminBlockedPortFlag, nlLlc2TermConnectionSequence=nlLlc2TermConnectionSequence, portVoiceAdminTable=portVoiceAdminTable, portVoiceOperRlpIndex=portVoiceOperRlpIndex, nlIfTableIndex=nlIfTableIndex, nlIfIpSecondaryAddrEntry=nlIfIpSecondaryAddrEntry, portStatsFCSErrors=portStatsFCSErrors, portX25AdminFlowCtrlNeg=portX25AdminFlowCtrlNeg, portT1AdminTable=portT1AdminTable, ipxStaticRouteConfigTable=ipxStaticRouteConfigTable, frStatsRxDEFrames=frStatsRxDEFrames, portBsciAdminRetransmitInterval=portBsciAdminRetransmitInterval, lSSdlcLlc2AdminPriority=lSSdlcLlc2AdminPriority, bridgeEnabled=bridgeEnabled, rlpConfigTable=rlpConfigTable, nlLocalSubscriberRedirEntry=nlLocalSubscriberRedirEntry, portVoiceAdminJitter=portVoiceAdminJitter, portSdlcOperMAXOut=portSdlcOperMAXOut, nlLlc2HostBAG=nlLlc2HostBAG, nlLlc2OrigConnectionType=nlLlc2OrigConnectionType, portVoiceAdminRlpIndex=portVoiceAdminRlpIndex, portFrBackupGroup=portFrBackupGroup, portBsciAdminTransTextSupported=portBsciAdminTransTextSupported, portX25OperCUGPref=portX25OperCUGPref, netstat=netstat, nodeCfgTable=nodeCfgTable, bsciDevAdminTransTextSupported=bsciDevAdminTransTextSupported, lSSdlcAdminTable=lSSdlcAdminTable, nlIfIpSourceRlp=nlIfIpSourceRlp, x25TxDMFrames=x25TxDMFrames, ipxInterfaceSourceCard=ipxInterfaceSourceCard, portLogicalX25AdminTable=portLogicalX25AdminTable, nlIfIpSourcePort=nlIfIpSourcePort, llc2=llc2, portX25OperDefPktSize=portX25OperDefPktSize, portX25OperCUGOutAccess=portX25OperCUGOutAccess, bridgeAdminSRBID=bridgeAdminSRBID, portBsciAdminUseEBCDIC=portBsciAdminUseEBCDIC, portSdlcOperL1Duplex=portSdlcOperL1Duplex, lSSdlcLlc2AdminLanTi=lSSdlcLlc2AdminLanTi, portT1AdminProtocolFraming=portT1AdminProtocolFraming, portVoiceAdminDTMFOnDuration=portVoiceAdminDTMFOnDuration, portX25AdminMaxWinSize=portX25AdminMaxWinSize, portDLCIIncomingBc=portDLCIIncomingBc, t1StatsPCVRErrs=t1StatsPCVRErrs, frStatsTxFECNFrames=frStatsTxFECNFrames, portThreshTxPercentUtl=portThreshTxPercentUtl, portX25AdminDefWinSize=portX25AdminDefWinSize, voiceSystemCountryCode=voiceSystemCountryCode, ipxStaticRouteConfigRowStatus=ipxStaticRouteConfigRowStatus, nlIfIpSecondaryAddrRouteMetric=nlIfIpSecondaryAddrRouteMetric, portVoiceOperDTMF=portVoiceOperDTMF, rlpIndex=rlpIndex, lSSdlcAdminLPDAResourceID=lSSdlcAdminLPDAResourceID, nlIfLlc2FrBlockedPortFlag=nlIfLlc2FrBlockedPortFlag, rlpStatsUsedBuffers=rlpStatsUsedBuffers, node=node, portLogicalX25AdminRowStatus=portLogicalX25AdminRowStatus, portSdlcOperTable=portSdlcOperTable, portBsciAdminGenerateClock=portBsciAdminGenerateClock, nlLocalSubscriberRouteEntry=nlLocalSubscriberRouteEntry, statVoice=statVoice, portPhyX25AdminSetupTimer=portPhyX25AdminSetupTimer, network=network, nlLocalSubscriberRowStatus=nlLocalSubscriberRowStatus, nlLlc2HostRowStatus=nlLlc2HostRowStatus, t1StatsXmitFrames=t1StatsXmitFrames, portT1OperGenerateClock=portT1OperGenerateClock, portLogicalX25AdminBAG=portLogicalX25AdminBAG, lSSdlcLlc2AdminLocalMac=lSSdlcLlc2AdminLocalMac, lSSdlcLlc2OperLanTi=lSSdlcLlc2OperLanTi, portPinStatus=portPinStatus, portVoiceOperNumDigitsDelete=portVoiceOperNumDigitsDelete, portBsciOperGenerateClock=portBsciOperGenerateClock, portSdlcOperGenerateClock=portSdlcOperGenerateClock, bsciSubscrOperAutocallMaxRtry=bsciSubscrOperAutocallMaxRtry, ipxInterfaceMaxVC=ipxInterfaceMaxVC, nsEntry=nsEntry, bridgeOperVirtualLANID=bridgeOperVirtualLANID, voiceSystemVoiceNodeNum=voiceSystemVoiceNodeNum, portVoiceAdminSuppression=portVoiceAdminSuppression, portBsciAdminSpeed=portBsciAdminSpeed, voiceStatsBusyCalls=voiceStatsBusyCalls, portDLCIPortIndex=portDLCIPortIndex, portT1AdminGenerateClock=portT1AdminGenerateClock, x25RxDISCFrames=x25RxDISCFrames, NlSubscriberAddress=NlSubscriberAddress, ipxServConfigEntry=ipxServConfigEntry, portX25AdminMaxThruptClass=portX25AdminMaxThruptClass, ipxConfigInterface=ipxConfigInterface, rlpGroupNumber=rlpGroupNumber, nlIfIpDestAddress=nlIfIpDestAddress, bsciDevAdminRowStatus=bsciDevAdminRowStatus, nlIfConnectorType=nlIfConnectorType, portX25OperFastSelAccpt=portX25OperFastSelAccpt, lSSdlcLlc2AdminEntry=lSSdlcLlc2AdminEntry, bsciDevAdminEntry=bsciDevAdminEntry, bridgeIPXEnabled=bridgeIPXEnabled, portT1AdminEntry=portT1AdminEntry, portX25AdminThruptClassNeg=portX25AdminThruptClassNeg, portVoiceAdminRowStatus=portVoiceAdminRowStatus, nlIfPortStatus=nlIfPortStatus, nlIfVoiceFrameRelayPort=nlIfVoiceFrameRelayPort, ipxInterfaceNetBIOSEnabled=ipxInterfaceNetBIOSEnabled, portBsciOperEndToEndAck=portBsciOperEndToEndAck, portSdlcAdminPacketSize=portSdlcAdminPacketSize, rlpMaxProtos=rlpMaxProtos, portFrConnector=portFrConnector, portBsciOperMaxBytesPerFrame=portBsciOperMaxBytesPerFrame, x25TxFRMRFrames=x25TxFRMRFrames, nlIfVoiceEnableFragment=nlIfVoiceEnableFragment, portStatsOutFrames=portStatsOutFrames, nlIfLlc2LANTable=nlIfLlc2LANTable, x25RxStatsEntry=x25RxStatsEntry, bsciSubscrOperLocalID=bsciSubscrOperLocalID, portX25OperCUGIndex=portX25OperCUGIndex, portX25OperTable=portX25OperTable, nlLlc2OrigConnectionMAXDATA=nlLlc2OrigConnectionMAXDATA, ipxServConfigInterface=ipxServConfigInterface, bsciSubscrOperEntry=bsciSubscrOperEntry, nlLocalSubscriberRedirTable=nlLocalSubscriberRedirTable, portX25AdminBlockedFlag=portX25AdminBlockedFlag, portFrMaxBytesPerFrame=portFrMaxBytesPerFrame, lSSdlcLlc2OperTable=lSSdlcLlc2OperTable, statT1=statT1, rlpThreshPercntBufInUse=rlpThreshPercntBufInUse, portVoiceAdminTelephonyType=portVoiceAdminTelephonyType, portDLCIRlpIndex=portDLCIRlpIndex, portX25AdminFastSelAccpt=portX25AdminFastSelAccpt, rlpThreshRlpIndex=rlpThreshRlpIndex, nodeTrapAdrTable=nodeTrapAdrTable, lSSdlcLlc2AdminLanTw=lSSdlcLlc2AdminLanTw, portFrBackupDLCI=portFrBackupDLCI, nlLocalSubscriberRouteIndex=nlLocalSubscriberRouteIndex, portBsciAdminDataMode=portBsciAdminDataMode, portDLCIEntry=portDLCIEntry, frStatsRlpIndex=frStatsRlpIndex, nlIfIpRIPDeltaUpdates=nlIfIpRIPDeltaUpdates, nlLocalSubscriberPriority=nlLocalSubscriberPriority, portLogicalX25AdminFrDlci=portLogicalX25AdminFrDlci, bridgeDefaultEthernetFrameType=bridgeDefaultEthernetFrameType, rlpThreshMsgQueueLen=rlpThreshMsgQueueLen, voiceStatsRlpIndex=voiceStatsRlpIndex, portT1OperNRZI=portT1OperNRZI, statThresh=statThresh, portVoiceOperDTMFOnDuration=portVoiceOperDTMFOnDuration, bsciSubscrAdminSequence=bsciSubscrAdminSequence, portBsciAdminActivateConnectionWithoutPoll=portBsciAdminActivateConnectionWithoutPoll, portSdlcOperIdleFillChar=portSdlcOperIdleFillChar, portThreshRlpIndex=portThreshRlpIndex, nodeAlmTable=nodeAlmTable, rlpGroupResponsibility=rlpGroupResponsibility, bsciSubscrAdminRemoteID=bsciSubscrAdminRemoteID, sdlcLSAddress=sdlcLSAddress, bsciSubscrAdminRowStatus=bsciSubscrAdminRowStatus, nlIfLlc2FrDLCI=nlIfLlc2FrDLCI, ipxStaticRouteConfigRouter=ipxStaticRouteConfigRouter, frStatsRxLMIFrames=frStatsRxLMIFrames, portBsciAdminNoResponseTimer=portBsciAdminNoResponseTimer, portVoiceOperSLTTimeout=portVoiceOperSLTTimeout, portSdlcAdminInactivityTimer=portSdlcAdminInactivityTimer, portVoiceOperCallTimer=portVoiceOperCallTimer, statIp=statIp, portPhyX25AdminDisconnectTimer=portPhyX25AdminDisconnectTimer, nlLlc2HostTwNumberOutstanding=nlLlc2HostTwNumberOutstanding, ipxInterfacePeriodicRIPTimer=ipxInterfacePeriodicRIPTimer, nlLocalSubscriberRoutePort=nlLocalSubscriberRoutePort, portBsciAdminNoResponseRetryCount=portBsciAdminNoResponseRetryCount, portT1AdminFrameModelSelect=portT1AdminFrameModelSelect, nlIfIpSourceSub=nlIfIpSourceSub, portBsciOperAnswerNonConfigured=portBsciOperAnswerNonConfigured, lSSdlcLlc2OperLanT1=lSSdlcLlc2OperLanT1, x25TxRlpIndex=x25TxRlpIndex, x25RxFRMRFrames=x25RxFRMRFrames, nlIfPhyPort=nlIfPhyPort, portVoiceOperLevelOut=portVoiceOperLevelOut, ipxInterfaceNetworkAddress=ipxInterfaceNetworkAddress, portBsciOperConnector=portBsciOperConnector, portPinPort=portPinPort, ipxInterfaceSAPAgeTimer=ipxInterfaceSAPAgeTimer, t1StatsXmitAbortFrames=t1StatsXmitAbortFrames, t1StatsPortIndex=t1StatsPortIndex, voiceSpeedDialLongDialMap=voiceSpeedDialLongDialMap, lSSdlcOperL2DatMode=lSSdlcOperL2DatMode, x25TxSABMFrames=x25TxSABMFrames, bridgeAdminVirtualLANID=bridgeAdminVirtualLANID, lSSdlcLlc2AdminRowStatus=lSSdlcLlc2AdminRowStatus, portSdlcOperConnector=portSdlcOperConnector, bsciSubscrAdminConnectionID=bsciSubscrAdminConnectionID, portVoiceOperToneType=portVoiceOperToneType, portSdlcOperInactivityTimer=portSdlcOperInactivityTimer, portBsciOperFullDuplex=portBsciOperFullDuplex, lSSdlcOperLocalSub=lSSdlcOperLocalSub, nlLlc2OrigConnectionRemoteSubscriberId=nlLlc2OrigConnectionRemoteSubscriberId, portThreshTxErrorRatio=portThreshTxErrorRatio, nlIfTable=nlIfTable, portVoiceAdminSpeed=portVoiceAdminSpeed, nlLlc2HostN3NumberLPDUs=nlLlc2HostN3NumberLPDUs, portVoiceAdminDialTimer=portVoiceAdminDialTimer, portT1Group=portT1Group, hwcard=hwcard, ipxInterfaceNetBIOSHops=ipxInterfaceNetBIOSHops, local=local, nlIfIpBAG=nlIfIpBAG, portSdlcAdminSpeed=portSdlcAdminSpeed)
mibBuilder.exportSymbols("NETLINK-SPECIFIC-MIB", portVoiceOperBreakRatio=portVoiceOperBreakRatio, nlIfLlc2LANID=nlIfLlc2LANID, portPhyX25AdminRowStatus=portPhyX25AdminRowStatus, t1StatsRlpIndex=t1StatsRlpIndex, sdlcLSAdminEntry=sdlcLSAdminEntry, ipxServConfigGatewayAddress=ipxServConfigGatewayAddress, portThreshLogRejPerSec=portThreshLogRejPerSec, portPhyX25AdminConnector=portPhyX25AdminConnector, x25RxUAFrames=x25RxUAFrames, portPhyX25OperDialOut=portPhyX25OperDialOut, rlpThreshEntry=rlpThreshEntry, nlLlc2HostMACAddress=nlLlc2HostMACAddress, portSdlcAdminMAXRetries=portSdlcAdminMAXRetries, nlIfVoiceLocalNodeNumber=nlIfVoiceLocalNodeNumber, nlLlc2TermConnectionEntry=nlLlc2TermConnectionEntry, x25RxRRFrames=x25RxRRFrames, nsNTNode=nsNTNode, portDLCIOutgoingBe=portDLCIOutgoingBe, portPinEntry=portPinEntry, portThreshTxFramesPerSec=portThreshTxFramesPerSec, nlLocalSubscriberRouteConf=nlLocalSubscriberRouteConf, nsNTNeighStat=nsNTNeighStat, ipxInterfaceEntry=ipxInterfaceEntry, portLogicalX25OperCxnPriority=portLogicalX25OperCxnPriority, lSSdlcOperRetryTime=lSSdlcOperRetryTime, voiceSpeedDialRowStatus=voiceSpeedDialRowStatus, lSSdlcLlc2OperLanTw=lSSdlcLlc2OperLanTw, nlIfLlc2FrFormat=nlIfLlc2FrFormat, portFrBackupRLP=portFrBackupRLP, lSSdlcLlc2AdminBAG=lSSdlcLlc2AdminBAG, portFrConfigTable=portFrConfigTable, portVoiceAdminLinkDownBusy=portVoiceAdminLinkDownBusy, voiceStatsRxCongestions=voiceStatsRxCongestions, nlIfLlc2FrPriority=nlIfLlc2FrPriority, nlIfLlc2LANPriority=nlIfLlc2LANPriority, nlInterfaces=nlInterfaces, nlLocalSubscriberRedirectOO=nlLocalSubscriberRedirectOO, voiceStatsPortIndex=voiceStatsPortIndex, lSSdlcOperRemoteSub=lSSdlcOperRemoteSub, ipxConfig=ipxConfig, portStatsEntry=portStatsEntry, portDLCIBackupProtEnb=portDLCIBackupProtEnb, portVoiceAdminSLTTimeout=portVoiceAdminSLTTimeout, portPhyX25OperSetupTimer=portPhyX25OperSetupTimer, nlIfLlc2LANCard=nlIfLlc2LANCard, nlIfVoiceInterfaces=nlIfVoiceInterfaces, portDLCIIncomingCIR=portDLCIIncomingCIR, bsciSubscrOperTable=bsciSubscrOperTable, portVoiceOperEntry=portVoiceOperEntry, ipxInterfaceType=ipxInterfaceType, nodeBagTable=nodeBagTable, portBsciAdminConnector=portBsciAdminConnector, bsciDevOperSingleUserVC=bsciDevOperSingleUserVC, rlpThreshRtxFramesPerSec=rlpThreshRtxFramesPerSec, nlIfIpSecondaryAddrRowStatus=nlIfIpSecondaryAddrRowStatus, portBsciOperEntry=portBsciOperEntry, portSdlcAdminL1Duplex=portSdlcAdminL1Duplex, ipxStaticRouteConfigNetNum=ipxStaticRouteConfigNetNum, portBsciAdminStartSynchChars=portBsciAdminStartSynchChars, portBsciAdminClearVCOnLastDeviceDown=portBsciAdminClearVCOnLastDeviceDown, bsciDevAdminTable=bsciDevAdminTable, nsNTNeigh=nsNTNeigh, ds0aStatsPortIndex=ds0aStatsPortIndex, frStatsTable=frStatsTable, lSSdlcLlc2AdminIdblk=lSSdlcLlc2AdminIdblk, nlLocalSubscriberId=nlLocalSubscriberId, voiceSystemRingVolFreq=voiceSystemRingVolFreq, portBsciOperPadType=portBsciOperPadType, nlIfIpRIPFullUpdates=nlIfIpRIPFullUpdates, bsciSubscrOperAutocallRtyTimer=bsciSubscrOperAutocallRtyTimer, bsciDevOperControlUnitID=bsciDevOperControlUnitID, portT1OperLineEncoding=portT1OperLineEncoding, portLogicalX25OperFrDlci=portLogicalX25OperFrDlci, portX25OperThruptClassNeg=portX25OperThruptClassNeg, sdlcLSAdminTable=sdlcLSAdminTable, lSSdlcAdminLlc2Conversion=lSSdlcAdminLlc2Conversion, rlpStatsFrameRetransmits=rlpStatsFrameRetransmits, t1StatsBlueAlarms=t1StatsBlueAlarms, ds0aStatsRcvOverruns=ds0aStatsRcvOverruns, x25RxStatsTable=x25RxStatsTable, nlIfIpTable=nlIfIpTable, portLogicalX25OperBAG=portLogicalX25OperBAG, bsciSubscrAdminAutocall=bsciSubscrAdminAutocall, nlLlc2HostRoutingSubscriberId=nlLlc2HostRoutingSubscriberId, portBsciAdminMaxBytesPerFrame=portBsciAdminMaxBytesPerFrame, portVoiceAdminHuntGroup=portVoiceAdminHuntGroup, frStatsRxFECNFrames=frStatsRxFECNFrames, frStatsTxLMIFrames=frStatsTxLMIFrames, portBsciAdminRowStatus=portBsciAdminRowStatus, portSdlcOperNrz=portSdlcOperNrz, nlLlc2OrigConnectionIDBLK=nlLlc2OrigConnectionIDBLK, portVoiceAdminToneType=portVoiceAdminToneType, sdlcLSGroup=sdlcLSGroup, portPhyX25AdminTrunkGroup=portPhyX25AdminTrunkGroup, ipxStaticRouteConfigCircIndex=ipxStaticRouteConfigCircIndex, nlIfVoicePeerNodePort=nlIfVoicePeerNodePort, voiceStatsTxClears=voiceStatsTxClears, statBag=statBag, portSdlcGroup=portSdlcGroup, nlLlc2OrigConnectionRowStatus=nlLlc2OrigConnectionRowStatus, portDLCIBackupGroup=portDLCIBackupGroup, nlIfVoicePeerNodeType=nlIfVoicePeerNodeType, x25RxDMFrames=x25RxDMFrames, lSSdlcLlc2OperIdnum=lSSdlcLlc2OperIdnum, statDS0A=statDS0A, snaDLC=snaDLC, portVoiceOperJitter=portVoiceOperJitter, bsciDevAdminSingleUserVC=bsciDevAdminSingleUserVC, portBsciOperUseEBCDIC=portBsciOperUseEBCDIC, bridgeMaxSizeForwardingTable=bridgeMaxSizeForwardingTable, portT1OperProtocolFraming=portT1OperProtocolFraming, portLogicalX25OperTable=portLogicalX25OperTable, frStatsEntry=frStatsEntry, x25TxRRFrames=x25TxRRFrames, tpAdrIdx=tpAdrIdx, lSSdlcOperLPDAResourceID=lSSdlcOperLPDAResourceID, portBsciOperTable=portBsciOperTable, nlLocalSubscriberSystematicRedirect=nlLocalSubscriberSystematicRedirect, lSSdlcAdminAutoCall=lSSdlcAdminAutoCall, portT1OperLineBuildOut=portT1OperLineBuildOut, nlIfVoiceLocalNodePort=nlIfVoiceLocalNodePort, portFrBackupEntry=portFrBackupEntry, portBsciOperErrorRetransmitCount=portBsciOperErrorRetransmitCount, x25TxStatsTable=x25TxStatsTable, portVoiceAdminSampleDelay=portVoiceAdminSampleDelay, nlLlc2TermConnectionHSAP=nlLlc2TermConnectionHSAP, nlIfIpSecondaryAddrBroadcastAddress=nlIfIpSecondaryAddrBroadcastAddress, portFrBackupProtEnab=portFrBackupProtEnab, nlLlc2OrigConnectionTable=nlLlc2OrigConnectionTable, nlLocalSubscriberAlgorithm=nlLocalSubscriberAlgorithm, portT1OperFramingMode=portT1OperFramingMode, portX25AdminEntry=portX25AdminEntry, portBsciOperSlowPollRetryCount=portBsciOperSlowPollRetryCount, portBsciOperDataMode=portBsciOperDataMode, bsciSubscrAdminAutocallRtyTimer=bsciSubscrAdminAutocallRtyTimer, bsciDevOperPrinterAttached=bsciDevOperPrinterAttached, ipxServConfigServNetworkAddress=ipxServConfigServNetworkAddress, nlLocalSubscriberEntry=nlLocalSubscriberEntry, nlLlc2OrigConnectionEntry=nlLlc2OrigConnectionEntry, nlIfIpEntry=nlIfIpEntry, ipxInterfacePeriodicSAPEnabled=ipxInterfacePeriodicSAPEnabled, portFrBlockedFlag=portFrBlockedFlag, nlIfIpNetworkMask=nlIfIpNetworkMask, portBsciAdminTable=portBsciAdminTable, nlIfIpUnnumberedIf=nlIfIpUnnumberedIf, voiceSpeedDialExtDialStr=voiceSpeedDialExtDialStr, portT1OperFrameModelSelect=portT1OperFrameModelSelect, portVoiceOperLevelIn=portVoiceOperLevelIn, voiceStatsTable=voiceStatsTable, portVoiceOperForwardDelay=portVoiceOperForwardDelay, portVoiceGroup=portVoiceGroup, portThreshRxFramesPerSec=portThreshRxFramesPerSec, portX25AdminCUGIndex=portX25AdminCUGIndex, nlIfIpInterface=nlIfIpInterface, nlLocalSubscriberName=nlLocalSubscriberName, nodeSNMPGroup=nodeSNMPGroup, frStatsTxBECNFrames=frStatsTxBECNFrames, portBsciOperPollInterval=portBsciOperPollInterval, nlIfIpSecondaryAddrSourceAddress=nlIfIpSecondaryAddrSourceAddress, portX25AdminMaxPktSize=portX25AdminMaxPktSize, bsciDevOperTable=bsciDevOperTable, lSSdlcAdminL2DatMode=lSSdlcAdminL2DatMode, ipxInterfaceSVCRetryTimer=ipxInterfaceSVCRetryTimer, portStatsFrameRetrans=portStatsFrameRetrans, portSdlcAdminIdleFillChar=portSdlcAdminIdleFillChar, lSSdlcAdminRetryCount=lSSdlcAdminRetryCount, voiceStatsEntry=voiceStatsEntry, lSSdlcLlc2AdminTable=lSSdlcLlc2AdminTable, portSdlcOperMAXRetries=portSdlcOperMAXRetries, bsciSubscrOperAutocall=bsciSubscrOperAutocall, tpAdrEntry=tpAdrEntry, nlLlc2HostN2ExpiredT1LPDUCount=nlLlc2HostN2ExpiredT1LPDUCount, portSdlcAdminRcvClockFromDTE=portSdlcAdminRcvClockFromDTE, portVoiceAdminForwardedDigits=portVoiceAdminForwardedDigits, t1StatsXmitUsage=t1StatsXmitUsage, lSSdlcLlc2AdminIdnum=lSSdlcLlc2AdminIdnum, nsThisNode=nsThisNode, portPhyX25OperEntry=portPhyX25OperEntry, portVoiceAdminForwardDelay=portVoiceAdminForwardDelay, t1StatsRcvChannelErrors=t1StatsRcvChannelErrors, status=status, ipxServConfigRowStatus=ipxServConfigRowStatus, portFrBackupWaitTimer=portFrBackupWaitTimer, nlIfIpProxyARP=nlIfIpProxyARP, portBsciAdminEndPadChars=portBsciAdminEndPadChars, portBsciAdminBlockedFlag=portBsciAdminBlockedFlag, ipxServConfigServName=ipxServConfigServName, frStatsTxANXDFrames=frStatsTxANXDFrames, nlLocalSubscriberRouteLP=nlLocalSubscriberRouteLP, portBsciAdminCallInfoInRequestPacket=portBsciAdminCallInfoInRequestPacket, portVoiceAdminLevelOut=portVoiceAdminLevelOut, nlIfLlc2FrRowStatus=nlIfLlc2FrRowStatus, nsNodNum=nsNodNum, nlLlc2HostIndex=nlLlc2HostIndex, t1StatsYellowAlarms=t1StatsYellowAlarms, bsciDevOperTransTextSupported=bsciDevOperTransTextSupported, tpAddress=tpAddress, nlLlc2HostGroup=nlLlc2HostGroup, portVoiceAdminTETimer=portVoiceAdminTETimer, portSdlcOperRcvClockFromDTE=portSdlcOperRcvClockFromDTE, nlIfVoiceEntry=nlIfVoiceEntry, portSdlcOperLPDASupport=portSdlcOperLPDASupport, lSSdlcAdminLocalSub=lSSdlcAdminLocalSub, nlIfIpInverseARP=nlIfIpInverseARP, portSdlcAdminGenerateClock=portSdlcAdminGenerateClock, bsciSubscrAdminTable=bsciSubscrAdminTable, portX25OperInCallBar=portX25OperInCallBar, bridgeIPEnabled=bridgeIPEnabled, portX25AdminOutCallBar=portX25AdminOutCallBar, rlpMemorySize=rlpMemorySize, portLogicalX25OperEntry=portLogicalX25OperEntry, bsciSubscrAdminAutocallMaxRtry=bsciSubscrAdminAutocallMaxRtry, portX25AdminTable=portX25AdminTable, portVoiceOperBlockedFlag=portVoiceOperBlockedFlag, statistics=statistics, ipxInterfaceSourceDLCI=ipxInterfaceSourceDLCI, nlIfIpRouteMetric=nlIfIpRouteMetric, rlpStatsOutFrames=rlpStatsOutFrames, portLogicalX25AdminCxnPriority=portLogicalX25AdminCxnPriority, portBsciAdminEndToEndAck=portBsciAdminEndToEndAck, portVoiceOperExtDigitsSource=portVoiceOperExtDigitsSource, nlLlc2TermConnectionRemoteSubscriberId=nlLlc2TermConnectionRemoteSubscriberId, voiceSystemVoiceRatesMax=voiceSystemVoiceRatesMax, nlIfVoiceInterface=nlIfVoiceInterface, nlIfLlc2FrBAG=nlIfLlc2FrBAG, rlpThreshTxFramesPerSec=rlpThreshTxFramesPerSec, nlIfIpICMPAddRoutes=nlIfIpICMPAddRoutes, portFrRcvClkFrmDTE=portFrRcvClkFrmDTE, nlLocalSubscriberTable=nlLocalSubscriberTable, portPhyX25AdminEntry=portPhyX25AdminEntry, portBsciAdminEntry=portBsciAdminEntry, lSSdlcAdminRowStatus=lSSdlcAdminRowStatus, lSSdlcLlc2AdminLocalSap=lSSdlcLlc2AdminLocalSap, nlIfLlc2LANType=nlIfLlc2LANType, nlLlc2OrigConnectionLocalSubscriberId=nlLlc2OrigConnectionLocalSubscriberId, portBsciOperRetransmitInterval=portBsciOperRetransmitInterval, portDLCIPriority=portDLCIPriority, pinStatusTable=pinStatusTable, rlpStatsEntry=rlpStatsEntry, x25RxRlpIndex=x25RxRlpIndex, t1StatsEntry=t1StatsEntry, voiceSystemVoiceRatesMin=voiceSystemVoiceRatesMin, portT1OperBlockedPortFlag=portT1OperBlockedPortFlag, portVoiceOperAutoDial=portVoiceOperAutoDial, nlLlc2OrigConnectionIDNUM=nlLlc2OrigConnectionIDNUM, voiceStatsTxCongestions=voiceStatsTxCongestions, rlpThreshRejFramesPerSec=rlpThreshRejFramesPerSec, lSSdlcOperTable=lSSdlcOperTable, portVoiceOperAutoPoll=portVoiceOperAutoPoll, portVoiceOperTable=portVoiceOperTable, voiceSpeedDialTable=voiceSpeedDialTable, bsciDevAdminControlUnitID=bsciDevAdminControlUnitID, t1StatsRcvOverruns=t1StatsRcvOverruns, nodeModel=nodeModel)
mibBuilder.exportSymbols("NETLINK-SPECIFIC-MIB", nlLlc2OrigConnectionHSAP=nlLlc2OrigConnectionHSAP, portLogicalX25AdminEntry=portLogicalX25AdminEntry, portSdlcOperDisableRequestDisconnect=portSdlcOperDisableRequestDisconnect, portDLCIRowStatus=portDLCIRowStatus, portPhyX25OperDisconnectTimer=portPhyX25OperDisconnectTimer, x25TxPortIndex=x25TxPortIndex, ds0aStatsRlpIndex=ds0aStatsRlpIndex, portPhyX25OperTrunkFlag=portPhyX25OperTrunkFlag, portBsciAdminMultidrop=portBsciAdminMultidrop, portVoiceAdminNumDigitsDelete=portVoiceAdminNumDigitsDelete, nsNodTable=nsNodTable, frStatsRxBECNFrames=frStatsRxBECNFrames, portDLCIIndex=portDLCIIndex, nlIfVoiceRowStatus=nlIfVoiceRowStatus, nlIfLlc2FrEntry=nlIfLlc2FrEntry, t1StatsRcvAbortFrames=t1StatsRcvAbortFrames, portX25AdminDefPktSize=portX25AdminDefPktSize, portFrLLM=portFrLLM, portBsciAdminPadType=portBsciAdminPadType, portSdlcAdminMAXOut=portSdlcAdminMAXOut, portFrBackupGroupTable=portFrBackupGroupTable, lSSdlcLlc2AdminLanN2=lSSdlcLlc2AdminLanN2, nlLlc2TermConnectionLocalSubscriberId=nlLlc2TermConnectionLocalSubscriberId, portSdlcAdminConnector=portSdlcAdminConnector, lSSdlcLlc2OperLanN2=lSSdlcLlc2OperLanN2, portT1AdminRowStatus=portT1AdminRowStatus, nlIfLlc2Interfaces=nlIfLlc2Interfaces, nlLlc2HostInterface=nlLlc2HostInterface, nlLlc2HostSessionType=nlLlc2HostSessionType, portFrGroup=portFrGroup, nlIfIpSVCRetryTimer=nlIfIpSVCRetryTimer, voiceStatsRxClears=voiceStatsRxClears, portBsciOperBlockCheck=portBsciOperBlockCheck, nlLlc2TermConnectionTable=nlLlc2TermConnectionTable, port=port, portDLCIOutgoingBc=portDLCIOutgoingBc, portSdlcAdminCommit=portSdlcAdminCommit, frStatsTotDiscFrames=frStatsTotDiscFrames, subscriber=subscriber, ipxInterfaceSVCIdleTimer=ipxInterfaceSVCIdleTimer, portVoiceAdminAutoDial=portVoiceAdminAutoDial, nlIfLlc2FrSessionType=nlIfLlc2FrSessionType, ipxServConfigTable=ipxServConfigTable, rlpThreshRxFramesPerSec=rlpThreshRxFramesPerSec, portPhyX25AdminDialOut=portPhyX25AdminDialOut, portVoiceAdminForwardedType=portVoiceAdminForwardedType, ipxInterfaceWatchdogSpoofingEnabled=ipxInterfaceWatchdogSpoofingEnabled, rlpStatsInFrames=rlpStatsInFrames, portFrBandwidthAllocation=portFrBandwidthAllocation, portBsciOperSpeed=portBsciOperSpeed, portBsciAdminFullDuplex=portBsciAdminFullDuplex, nsNeighTable=nsNeighTable, ipxServConfigInterveningNetworks=ipxServConfigInterveningNetworks, nlIfVoiceFrameRelayDLCI=nlIfVoiceFrameRelayDLCI, nlLocalSubscriberRedirIndex=nlLocalSubscriberRedirIndex, portVoiceOperAutoPollTimer=portVoiceOperAutoPollTimer, portVoiceAdminInterface=portVoiceAdminInterface, tpAdrFlag=tpAdrFlag, portVoiceOperDTMFOffDuration=portVoiceOperDTMFOffDuration, ipxServConfigServiceType=ipxServConfigServiceType, ipxServConfigServSocketNumber=ipxServConfigServSocketNumber, ipxInterfaceMaxTransUnit=ipxInterfaceMaxTransUnit, nlIfLlc2LANEntry=nlIfLlc2LANEntry, nlLlc2HostEntry=nlLlc2HostEntry, bsciDevAdminDeviceUnitID=bsciDevAdminDeviceUnitID, x25TxRNRFrames=x25TxRNRFrames, portSdlcOperEntry=portSdlcOperEntry, portX25OperFlowCtrlNeg=portX25OperFlowCtrlNeg, portX25AdminCUGPref=portX25AdminCUGPref, ipxInterfaceRIPAgeTimer=ipxInterfaceRIPAgeTimer, portSdlcAdminDisableRequestDisconnect=portSdlcAdminDisableRequestDisconnect, ds0aStatsChannelIndex=ds0aStatsChannelIndex, portFrPortIndex=portFrPortIndex, portX25OperMaxPktSize=portX25OperMaxPktSize, portFrRlpIndex=portFrRlpIndex)
