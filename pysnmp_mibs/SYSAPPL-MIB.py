...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/SYSAPPL-MIB
...
ModuleIdentity, Counter64, Integer32, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, MibIdentifier, TimeTicks, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "Bits", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("SYSAPPL-MIB", sysApplElmtPastRunNumFiles=sysApplElmtPastRunNumFiles, sysApplElmtPastRunTable=sysApplElmtPastRunTable, sysApplInstallPkgProductName=sysApplInstallPkgProductName, sysApplPastRunTimeEnded=sysApplPastRunTimeEnded, sysApplElmtPastRunName=sysApplElmtPastRunName, sysApplElemPastRunMaxRows=sysApplElemPastRunMaxRows, sysApplInstallElmtSizeHigh=sysApplInstallElmtSizeHigh, sysApplElmtRunInvocID=sysApplElmtRunInvocID, sysApplInstallElmtName=sysApplInstallElmtName, sysApplInstallElmtEntry=sysApplInstallElmtEntry, sysApplInstallElmtCurSizeHigh=sysApplInstallElmtCurSizeHigh, sysApplElmtRunUser=sysApplElmtRunUser, sysApplInstalled=sysApplInstalled, sysApplMap=sysApplMap, sysApplElmtRunEntry=sysApplElmtRunEntry, Utf8String=Utf8String, sysApplElmtPastRunMemory=sysApplElmtPastRunMemory, sysApplInstallPkgIndex=sysApplInstallPkgIndex, sysApplMapGroup=sysApplMapGroup, PYSNMP_MODULE_ID=sysApplMIB, sysApplInstallPkgEntry=sysApplInstallPkgEntry, sysApplElmtPastRunTimeStarted=sysApplElmtPastRunTimeStarted, sysApplElemPastRunTableRemItems=sysApplElemPastRunTableRemItems, sysApplRunGroup=sysApplRunGroup, sysApplAgentPollInterval=sysApplAgentPollInterval, sysApplMapTable=sysApplMapTable, sysApplMIBGroups=sysApplMIBGroups, sysApplElmtPastRunCPU=sysApplElmtPastRunCPU, sysApplInstallPkgLocation=sysApplInstallPkgLocation, sysApplInstallElmtTable=sysApplInstallElmtTable, sysApplPastRunExitState=sysApplPastRunExitState, sysApplMapEntry=sysApplMapEntry, sysApplElmtPastRunEntry=sysApplElmtPastRunEntry, sysApplElmtRunName=sysApplElmtRunName, sysApplInstallElmtPath=sysApplInstallElmtPath, sysApplElmtRunState=sysApplElmtRunState, sysApplPastRunIndex=sysApplPastRunIndex, sysApplElmtRunParameters=sysApplElmtRunParameters, sysApplInstallPkgTable=sysApplInstallPkgTable, sysApplRunEntry=sysApplRunEntry, sysApplMIBCompliance=sysApplMIBCompliance, sysApplMIB=sysApplMIB, sysApplPastRunEntry=sysApplPastRunEntry, sysApplInstallElmtIndex=sysApplInstallElmtIndex, sysApplElmtPastRunTimeEnded=sysApplElmtPastRunTimeEnded, sysApplPastRunTable=sysApplPastRunTable, sysApplInstallPkgDate=sysApplInstallPkgDate, sysApplInstallPkgManufacturer=sysApplInstallPkgManufacturer, sysApplInstallElmtSizeLow=sysApplInstallElmtSizeLow, sysApplRun=sysApplRun, sysApplRunCurrentState=sysApplRunCurrentState, sysApplElmtPastRunInvocID=sysApplElmtPastRunInvocID, sysApplOBJ=sysApplOBJ, sysApplPastRunMaxRows=sysApplPastRunMaxRows, RunState=RunState, sysApplElemPastRunTblTimeLimit=sysApplElemPastRunTblTimeLimit, sysApplRunStarted=sysApplRunStarted, sysApplElmtRunInstallPkg=sysApplElmtRunInstallPkg, sysApplElmtPastRunUser=sysApplElmtPastRunUser, sysApplElmtRunCPU=sysApplElmtRunCPU, sysApplInstallElmtCurSizeLow=sysApplInstallElmtCurSizeLow, sysApplElmtRunIndex=sysApplElmtRunIndex, sysApplElmtPastRunParameters=sysApplElmtPastRunParameters, sysApplElmtRunTimeStarted=sysApplElmtRunTimeStarted, sysApplMapInstallPkgIndex=sysApplMapInstallPkgIndex, sysApplInstallElmtType=sysApplInstallElmtType, sysApplInstallElmtModifyDate=sysApplInstallElmtModifyDate, sysApplInstallElmtRole=sysApplInstallElmtRole, sysApplMIBCompliances=sysApplMIBCompliances, sysApplElmtRunInstallID=sysApplElmtRunInstallID, sysApplNotifications=sysApplNotifications, sysApplMapInstallElmtIndex=sysApplMapInstallElmtIndex, sysApplElmtPastRunInstallID=sysApplElmtPastRunInstallID, sysApplRunIndex=sysApplRunIndex, sysApplInstallPkgSerialNumber=sysApplInstallPkgSerialNumber, LongUtf8String=LongUtf8String, sysApplPastRunTableRemItems=sysApplPastRunTableRemItems, sysApplInstalledGroup=sysApplInstalledGroup, sysApplInstallPkgVersion=sysApplInstallPkgVersion, sysApplPastRunStarted=sysApplPastRunStarted, sysApplInstallElmtDate=sysApplInstallElmtDate, sysApplPastRunTblTimeLimit=sysApplPastRunTblTimeLimit, sysApplElmtRunNumFiles=sysApplElmtRunNumFiles, sysApplElmtRunTable=sysApplElmtRunTable, sysApplRunTable=sysApplRunTable, sysApplConformance=sysApplConformance, sysApplElmtPastRunIndex=sysApplElmtPastRunIndex, sysApplElmtRunMemory=sysApplElmtRunMemory)
