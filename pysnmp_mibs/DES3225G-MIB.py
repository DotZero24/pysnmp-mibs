...
mibBuilder.exportSymbols("DES3225G-MIB", swDevCtrlUploadImageFileName=swDevCtrlUploadImageFileName, swFdbFilterAddressIndex=swFdbFilterAddressIndex, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swFdbFilterState=swFdbFilterState, swPortStOversizeFrames=swPortStOversizeFrames, swModuleInfoTable=swModuleInfoTable, swDevInfoMaxNumOfModule=swDevInfoMaxNumOfModule, swPortStCRCError=swPortStCRCError, swModuleInfoEntry=swModuleInfoEntry, swDevInfoSaveCfg=swDevInfoSaveCfg, swFdbStaticAddressIndex=swFdbStaticAddressIndex, swPortStUndersizeFrames=swPortStUndersizeFrames, swDevCtrl=swDevCtrl, swPortStFrames_128_255_bytes=swPortStFrames_128_255_bytes, MacAddress=MacAddress, swDevCtrlHOLState=swDevCtrlHOLState, swDevInfoConsoleInUse=swDevInfoConsoleInUse, swDevInfoTotalNumOfModule=swDevInfoTotalNumOfModule, swPortCtrlPriority=swPortCtrlPriority, swFdbStaticStatus=swFdbStaticStatus, dlink_Des3225gProd=dlink_Des3225gProd, swPortCtrlLockState=swPortCtrlLockState, swPortStModuleIndex=swPortStModuleIndex, swPortCtrlNwayState=swPortCtrlNwayState, swPortCtrlModuleIndex=swPortCtrlModuleIndex, swPortInfoTable=swPortInfoTable, swFdbStaticTable=swFdbStaticTable, dlink_products=dlink_products, swPortStMulticastFramesRx=swPortStMulticastFramesRx, swPortCtrlTable=swPortCtrlTable, swFdbFilterTable=swFdbFilterTable, swPortCtrlBroadcastFallingThr=swPortCtrlBroadcastFallingThr, swPortCtrlLinkStatusAlarmState=swPortCtrlLinkStatusAlarmState, swPortStPortIndex=swPortStPortIndex, swDevCtrlPartitionModeState=swDevCtrlPartitionModeState, swModuleInfoIndex=swModuleInfoIndex, swDevAlarm=swDevAlarm, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swPortStFrames_512_1023_bytes=swPortStFrames_512_1023_bytes, swPortStFragments=swPortStFragments, des3225gSeries=des3225gSeries, swDevInfoSystemUpTime=swDevInfoSystemUpTime, swPortStFrames_64_bytes=swPortStFrames_64_bytes, swDevInfo=swDevInfo, swPortCtrlBroadcastRisingAct=swPortCtrlBroadcastRisingAct, swFdbFilterVid=swFdbFilterVid, swFdbStaticEntry=swFdbStaticEntry, swPortPackage=swPortPackage, swFdbFilterEntry=swFdbFilterEntry, swPortStBroadcastFramesTx=swPortStBroadcastFramesTx, swPortCtrlFlowCtrlState=swPortCtrlFlowCtrlState, swDevCtrlAddrLookupModesAndHitRate=swDevCtrlAddrLookupModesAndHitRate, swPortStFramesDroppedFrames=swPortStFramesDroppedFrames, swFdbStaticState=swFdbStaticState, swPortInfoEntry=swPortInfoEntry, swPortInfoNwayStatus=swPortInfoNwayStatus, swPortStTable=swPortStTable, broadcastFallingStorm=broadcastFallingStorm, swPortCtrlAdminState=swPortCtrlAdminState, swDevIGMPCaptureState=swDevIGMPCaptureState, swPortInfoType=swPortInfoType, swFdbPackage=swFdbPackage, swModuleInfoType=swModuleInfoType, swPortStTotalFramesRx=swPortStTotalFramesRx, swDevCtrlUploadImage=swDevCtrlUploadImage, linkChangeEvent=linkChangeEvent, swDevAlarmPartition=swDevAlarmPartition, swModuleInfoDesc=swModuleInfoDesc, swPortCtrlEntry=swPortCtrlEntry, swPortInfoPortIndex=swPortInfoPortIndex, swPortStTotalBytesRx=swPortStTotalBytesRx, swPortStFrames_65_127_bytes=swPortStFrames_65_127_bytes, swFdbStaticPortMap=swFdbStaticPortMap, dlink_mgmt=dlink_mgmt, swPortStFrames_1024_1536_bytes=swPortStFrames_1024_1536_bytes, swFdbStaticVid=swFdbStaticVid, swDevCtrlSaveCfg=swDevCtrlSaveCfg, broadcastRisingStorm=broadcastRisingStorm, swPortStLateCollision=swPortStLateCollision, swDevAlarmLinkChange=swDevAlarmLinkChange, swPortCtrlHOLState=swPortCtrlHOLState, swPortStCollision=swPortStCollision, swModuleInfoTotalNumOfPort=swModuleInfoTotalNumOfPort, swPortCtrlBroadcastFallingAct=swPortCtrlBroadcastFallingAct, swPortStFrameTx=swPortStFrameTx, swDevInfoSystemLedStatus=swDevInfoSystemLedStatus, portPartition=portPartition, swPortStEntry=swPortStEntry, swPortStJabber=swPortStJabber, swModuleInfoNumOfPortInUse=swModuleInfoNumOfPortInUse, swPortStByteTx=swPortStByteTx, swPortStFrameRx=swPortStFrameRx, swPortStBroadcastFramesRx=swPortStBroadcastFramesRx, swPortCtrlCleanAllStatisticCounter=swPortCtrlCleanAllStatisticCounter, swDevCtrlTableLockState=swDevCtrlTableLockState, swModuleInfoPortLedStatus=swModuleInfoPortLedStatus, swDevCtrlStpState=swDevCtrlStpState, swPortCtrlBroadcastRisingThr=swPortCtrlBroadcastRisingThr, swDevAlarmTopologyChange=swDevAlarmTopologyChange, swPortInfoModuleIndex=swPortInfoModuleIndex, swPortCtrlPortIndex=swPortCtrlPortIndex, swPortStFrames_256_511_bytes=swPortStFrames_256_511_bytes, swPortStMulticastFramesTx=swPortStMulticastFramesTx, swPortCtrlStpState=swPortCtrlStpState, swDevAlarmNewRoot=swDevAlarmNewRoot, swProperty=swProperty, swPortInfoFlowCtrlStatus=swPortInfoFlowCtrlStatus, swModule=swModule, dlink=dlink, swPortInfoLinkStatus=swPortInfoLinkStatus, swDevPackage=swDevPackage, swModulePackage=swModulePackage, swPortStByteRx=swPortStByteRx, swPortCtrlBackPressState=swPortCtrlBackPressState)
