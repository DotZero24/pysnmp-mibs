...
des3026,=mibBuilder.importSymbols('DLINK-SWPRIMGMT-MIB','des3026')
...
swL2MgmtMIB=ModuleIdentity((1,3,6,1,4,1,171,11,63,3,2))
...
swL2DevMgmt=_SwL2DevMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,1))
_SwL2DevInfo_ObjectIdentity=ObjectIdentity
swL2DevInfo=_SwL2DevInfo_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,1,1))
...
swL2DevInfoFrontPanelLedStatus=_SwL2DevInfoFrontPanelLedStatus_Object((1,3,6,1,4,1,171,11,63,3,2,1,1,5),_SwL2DevInfoFrontPanelLedStatus_Type())
...
swL2Module_1_Type=_SwL2Module_1_Type_Object((1,3,6,1,4,1,171,11,63,3,2,1,1,6),_SwL2Module_1_Type_Type())
...
swL2Module_2_Type=_SwL2Module_2_Type_Object((1,3,6,1,4,1,171,11,63,3,2,1,1,7),_SwL2Module_2_Type_Type())
...
swL2DevCtrl=_SwL2DevCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,1,2))
...
swL2DevCtrlSystemReboot=_SwL2DevCtrlSystemReboot_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,1),_SwL2DevCtrlSystemReboot_Type())
...
swL2DevCtrlSystemIP=_SwL2DevCtrlSystemIP_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,2),_SwL2DevCtrlSystemIP_Type())
...
swL2DevCtrlSubnetMask=_SwL2DevCtrlSubnetMask_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,3),_SwL2DevCtrlSubnetMask_Type())
...
swL2DevCtrlDefaultGateway=_SwL2DevCtrlDefaultGateway_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,4),_SwL2DevCtrlDefaultGateway_Type())
...
swL2DevCtrlManagementVlanId=_SwL2DevCtrlManagementVlanId_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,5),_SwL2DevCtrlManagementVlanId_Type())
...
swL2DevCtrlStpState=_SwL2DevCtrlStpState_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,6),_SwL2DevCtrlStpState_Type())
...
swL2DevCtrlIGMPSnooping=_SwL2DevCtrlIGMPSnooping_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,7),_SwL2DevCtrlIGMPSnooping_Type())
...
swL2DevCtrlCleanAllStatisticCounter=_SwL2DevCtrlCleanAllStatisticCounter_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,12),_SwL2DevCtrlCleanAllStatisticCounter_Type())
...
swL2DevCtrlSnmpEnableAuthenTraps=_SwL2DevCtrlSnmpEnableAuthenTraps_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,13),_SwL2DevCtrlSnmpEnableAuthenTraps_Type())
...
swL2DevCtrlRmonState=_SwL2DevCtrlRmonState_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,16),_SwL2DevCtrlRmonState_Type())
...
swL2DevCtrlIpAutoConfig=_SwL2DevCtrlIpAutoConfig_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,17),_SwL2DevCtrlIpAutoConfig_Type())
...
swL2PortCtrlMulticastfilter=_SwL2PortCtrlMulticastfilter_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,18),_SwL2PortCtrlMulticastfilter_Type())
...
swL2MACNotifyState=_SwL2MACNotifyState_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,19),_SwL2MACNotifyState_Type())
...
swL2MACNotifyHistorySize=_SwL2MACNotifyHistorySize_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,20),_SwL2MACNotifyHistorySize_Type())
...
swL2MACNotifyInterval=_SwL2MACNotifyInterval_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,21),_SwL2MACNotifyInterval_Type())
...
swL2DevCtrlVLANTrunkState=_SwL2DevCtrlVLANTrunkState_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,22),_SwL2DevCtrlVLANTrunkState_Type())
...
swL2DevCtrlLLDPState=_SwL2DevCtrlLLDPState_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,23),_SwL2DevCtrlLLDPState_Type())
...
swL2DevCtrlLLDPForwardMessageState=_SwL2DevCtrlLLDPForwardMessageState_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,24),_SwL2DevCtrlLLDPForwardMessageState_Type())
...
swL2DevCtrlVlanIdOfFDBTbl=_SwL2DevCtrlVlanIdOfFDBTbl_Object((1,3,6,1,4,1,171,11,63,3,2,1,2,25),_SwL2DevCtrlVlanIdOfFDBTbl_Type())
...
swL2CPUutilization=_SwL2CPUutilization_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,1,3))
_SwL2CPUutilizationIn5sec_Type=Integer32
_SwL2CPUutilizationIn5sec_Object=MibScalar
swL2CPUutilizationIn5sec=_SwL2CPUutilizationIn5sec_Object((1,3,6,1,4,1,171,11,63,3,2,1,3,1),_SwL2CPUutilizationIn5sec_Type())
...
swL2CPUutilizationIn1min=_SwL2CPUutilizationIn1min_Object((1,3,6,1,4,1,171,11,63,3,2,1,3,2),_SwL2CPUutilizationIn1min_Type())
...
swL2CPUutilizationIn5min=_SwL2CPUutilizationIn5min_Object((1,3,6,1,4,1,171,11,63,3,2,1,3,3),_SwL2CPUutilizationIn5min_Type())
...
swL2DevAlarm=_SwL2DevAlarm_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,1,4))
...
swL2DevAlarmLinkChange=_SwL2DevAlarmLinkChange_Object((1,3,6,1,4,1,171,11,63,3,2,1,4,3),_SwL2DevAlarmLinkChange_Type())
...
swL2PortMgmt=_SwL2PortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,2))
_SwL2PortInfoTable_Object=MibTable
swL2PortInfoTable=_SwL2PortInfoTable_Object((1,3,6,1,4,1,171,11,63,3,2,2,1))
if mibBuilder.loadTexts:swL2PortInfoTable.setStatus(_A)
_SwL2PortInfoEntry_Object=MibTableRow
swL2PortInfoEntry=_SwL2PortInfoEntry_Object((1,3,6,1,4,1,171,11,63,3,2,2,1,1))
...
swL2PortInfoPortIndex=_SwL2PortInfoPortIndex_Object((1,3,6,1,4,1,171,11,63,3,2,2,1,1,1),_SwL2PortInfoPortIndex_Type())
...
swL2PortInfoLinkStatus=_SwL2PortInfoLinkStatus_Object((1,3,6,1,4,1,171,11,63,3,2,2,1,1,4),_SwL2PortInfoLinkStatus_Type())
...
swL2PortInfoNwayStatus=_SwL2PortInfoNwayStatus_Object((1,3,6,1,4,1,171,11,63,3,2,2,1,1,5),_SwL2PortInfoNwayStatus_Type())
...
swL2PortCtrlTable=_SwL2PortCtrlTable_Object((1,3,6,1,4,1,171,11,63,3,2,2,2))
if mibBuilder.loadTexts:swL2PortCtrlTable.setStatus(_A)
_SwL2PortCtrlEntry_Object=MibTableRow
swL2PortCtrlEntry=_SwL2PortCtrlEntry_Object((1,3,6,1,4,1,171,11,63,3,2,2,2,1))
...
swL2PortCtrlPortIndex=_SwL2PortCtrlPortIndex_Object((1,3,6,1,4,1,171,11,63,3,2,2,2,1,1),_SwL2PortCtrlPortIndex_Type())
...
swL2PortCtrlAdminState=_SwL2PortCtrlAdminState_Object((1,3,6,1,4,1,171,11,63,3,2,2,2,1,2),_SwL2PortCtrlAdminState_Type())
...
swL2PortCtrlNwayState=_SwL2PortCtrlNwayState_Object((1,3,6,1,4,1,171,11,63,3,2,2,2,1,3),_SwL2PortCtrlNwayState_Type())
...
swL2PortCtrlFlowCtrlState=_SwL2PortCtrlFlowCtrlState_Object((1,3,6,1,4,1,171,11,63,3,2,2,2,1,4),_SwL2PortCtrlFlowCtrlState_Type())
...
swL2PortCtrlDescription=_SwL2PortCtrlDescription_Object((1,3,6,1,4,1,171,11,63,3,2,2,2,1,5),_SwL2PortCtrlDescription_Type())
...
swL2PortCtrlMACNotifyState=_SwL2PortCtrlMACNotifyState_Object((1,3,6,1,4,1,171,11,63,3,2,2,2,1,7),_SwL2PortCtrlMACNotifyState_Type())
...
swL2PortCtrlMDIXState=_SwL2PortCtrlMDIXState_Object((1,3,6,1,4,1,171,11,63,3,2,2,2,1,10),_SwL2PortCtrlMDIXState_Type())
...
swL2PortErrTable=_SwL2PortErrTable_Object((1,3,6,1,4,1,171,11,63,3,2,2,3))
if mibBuilder.loadTexts:swL2PortErrTable.setStatus(_A)
_SwL2PortErrEntry_Object=MibTableRow
swL2PortErrEntry=_SwL2PortErrEntry_Object((1,3,6,1,4,1,171,11,63,3,2,2,3,1))
...
swL2PortErrPortIndex=_SwL2PortErrPortIndex_Object((1,3,6,1,4,1,171,11,63,3,2,2,3,1,1),_SwL2PortErrPortIndex_Type())
...
swL2PortErrPortState=_SwL2PortErrPortState_Object((1,3,6,1,4,1,171,11,63,3,2,2,3,1,2),_SwL2PortErrPortState_Type())
...
swL2PortErrPortStatus=_SwL2PortErrPortStatus_Object((1,3,6,1,4,1,171,11,63,3,2,2,3,1,3),_SwL2PortErrPortStatus_Type())
...
swL2PortErrPortReason=_SwL2PortErrPortReason_Object((1,3,6,1,4,1,171,11,63,3,2,2,3,1,4),_SwL2PortErrPortReason_Type())
...
swL2PortErrDescription=_SwL2PortErrDescription_Object((1,3,6,1,4,1,171,11,63,3,2,2,3,1,5),_SwL2PortErrDescription_Type())
...
swL2QOSMgmt=_SwL2QOSMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,3))
_SwL2QOSBandwidthControlTable_Object=MibTable
swL2QOSBandwidthControlTable=_SwL2QOSBandwidthControlTable_Object((1,3,6,1,4,1,171,11,63,3,2,3,1))
if mibBuilder.loadTexts:swL2QOSBandwidthControlTable.setStatus(_A)
_SwL2QOSBandwidthControlEntry_Object=MibTableRow
swL2QOSBandwidthControlEntry=_SwL2QOSBandwidthControlEntry_Object((1,3,6,1,4,1,171,11,63,3,2,3,1,1))
...
swL2QOSBandwidthPortIndex=_SwL2QOSBandwidthPortIndex_Object((1,3,6,1,4,1,171,11,63,3,2,3,1,1,1),_SwL2QOSBandwidthPortIndex_Type())
...
swL2QOSBandwidthRxRate=_SwL2QOSBandwidthRxRate_Object((1,3,6,1,4,1,171,11,63,3,2,3,1,1,2),_SwL2QOSBandwidthRxRate_Type())
...
swL2QOSBandwidthTxRate=_SwL2QOSBandwidthTxRate_Object((1,3,6,1,4,1,171,11,63,3,2,3,1,1,3),_SwL2QOSBandwidthTxRate_Type())
...
swL2QOSBandwidthRadiusRxRate=_SwL2QOSBandwidthRadiusRxRate_Object((1,3,6,1,4,1,171,11,63,3,2,3,1,1,4),_SwL2QOSBandwidthRadiusRxRate_Type())
...
swL2QOSBandwidthRadiusTxRate=_SwL2QOSBandwidthRadiusTxRate_Object((1,3,6,1,4,1,171,11,63,3,2,3,1,1,5),_SwL2QOSBandwidthRadiusTxRate_Type())
...
swL2QOSSchedulingTable=_SwL2QOSSchedulingTable_Object((1,3,6,1,4,1,171,11,63,3,2,3,2))
if mibBuilder.loadTexts:swL2QOSSchedulingTable.setStatus(_A)
_SwL2QOSSchedulingEntry_Object=MibTableRow
swL2QOSSchedulingEntry=_SwL2QOSSchedulingEntry_Object((1,3,6,1,4,1,171,11,63,3,2,3,2,1))
...
swL2QOSSchedulingClassIndex=_SwL2QOSSchedulingClassIndex_Object((1,3,6,1,4,1,171,11,63,3,2,3,2,1,1),_SwL2QOSSchedulingClassIndex_Type())
...
swL2QOSSchedulingMaxWeight=_SwL2QOSSchedulingMaxWeight_Object((1,3,6,1,4,1,171,11,63,3,2,3,2,1,4),_SwL2QOSSchedulingMaxWeight_Type())
...
swL2QOS8021pUserPriorityTable=_SwL2QOS8021pUserPriorityTable_Object((1,3,6,1,4,1,171,11,63,3,2,3,3))
if mibBuilder.loadTexts:swL2QOS8021pUserPriorityTable.setStatus(_A)
_SwL2QOS8021pUserPriorityEntry_Object=MibTableRow
swL2QOS8021pUserPriorityEntry=_SwL2QOS8021pUserPriorityEntry_Object((1,3,6,1,4,1,171,11,63,3,2,3,3,1))
...
swL2QOS8021pUserPriorityIndex=_SwL2QOS8021pUserPriorityIndex_Object((1,3,6,1,4,1,171,11,63,3,2,3,3,1,1),_SwL2QOS8021pUserPriorityIndex_Type())
...
swL2QOS8021pUserPriorityClass=_SwL2QOS8021pUserPriorityClass_Object((1,3,6,1,4,1,171,11,63,3,2,3,3,1,2),_SwL2QOS8021pUserPriorityClass_Type())
...
swL2QOS8021pDefaultPriorityTable=_SwL2QOS8021pDefaultPriorityTable_Object((1,3,6,1,4,1,171,11,63,3,2,3,4))
...
swL2QOS8021pDefaultPriorityEntry=_SwL2QOS8021pDefaultPriorityEntry_Object((1,3,6,1,4,1,171,11,63,3,2,3,4,1))
...
swL2QOS8021pDefaultPriorityIndex=_SwL2QOS8021pDefaultPriorityIndex_Object((1,3,6,1,4,1,171,11,63,3,2,3,4,1,1),_SwL2QOS8021pDefaultPriorityIndex_Type())
...
swL2QOS8021pDefaultPriority=_SwL2QOS8021pDefaultPriority_Object((1,3,6,1,4,1,171,11,63,3,2,3,4,1,2),_SwL2QOS8021pDefaultPriority_Type())
...
swL2QOS8021pRadiusPriority=_SwL2QOS8021pRadiusPriority_Object((1,3,6,1,4,1,171,11,63,3,2,3,4,1,3),_SwL2QOS8021pRadiusPriority_Type())
...
swL2QOSSchedulingMechanismCtrl=_SwL2QOSSchedulingMechanismCtrl_Object((1,3,6,1,4,1,171,11,63,3,2,3,5),_SwL2QOSSchedulingMechanismCtrl_Type())
...
swL2TrunkMgmt=_SwL2TrunkMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,4))
_SwPortTrunkMaxEntries_Type=Integer32
_SwPortTrunkMaxEntries_Object=MibScalar
swPortTrunkMaxEntries=_SwPortTrunkMaxEntries_Object((1,3,6,1,4,1,171,11,63,3,2,4,1),_SwPortTrunkMaxEntries_Type())
...
swPortTrunkMaxPortMembers=_SwPortTrunkMaxPortMembers_Object((1,3,6,1,4,1,171,11,63,3,2,4,2),_SwPortTrunkMaxPortMembers_Type())
...
swPortTrunkTable=_SwPortTrunkTable_Object((1,3,6,1,4,1,171,11,63,3,2,4,3))
if mibBuilder.loadTexts:swPortTrunkTable.setStatus(_A)
_SwPortTrunkEntry_Object=MibTableRow
swPortTrunkEntry=_SwPortTrunkEntry_Object((1,3,6,1,4,1,171,11,63,3,2,4,3,1))
...
swPortTrunkIndex=_SwPortTrunkIndex_Object((1,3,6,1,4,1,171,11,63,3,2,4,3,1,1),_SwPortTrunkIndex_Type())
...
swPortTrunkMasterPort=_SwPortTrunkMasterPort_Object((1,3,6,1,4,1,171,11,63,3,2,4,3,1,2),_SwPortTrunkMasterPort_Type())
...
swPortTrunkPortList=_SwPortTrunkPortList_Object((1,3,6,1,4,1,171,11,63,3,2,4,3,1,3),_SwPortTrunkPortList_Type())
...
swPortTrunkType=_SwPortTrunkType_Object((1,3,6,1,4,1,171,11,63,3,2,4,3,1,4),_SwPortTrunkType_Type())
...
swPortTrunkActivePort=_SwPortTrunkActivePort_Object((1,3,6,1,4,1,171,11,63,3,2,4,3,1,5),_SwPortTrunkActivePort_Type())
...
swPortTrunkState=_SwPortTrunkState_Object((1,3,6,1,4,1,171,11,63,3,2,4,3,1,6),_SwPortTrunkState_Type())
...
swPortTrunkFloodingPort=_SwPortTrunkFloodingPort_Object((1,3,6,1,4,1,171,11,63,3,2,4,3,1,7),_SwPortTrunkFloodingPort_Type())
...
swL2TrunkAlgorithm=_SwL2TrunkAlgorithm_Object((1,3,6,1,4,1,171,11,63,3,2,4,4),_SwL2TrunkAlgorithm_Type())
...
swL2TrunkLACPPortTable=_SwL2TrunkLACPPortTable_Object((1,3,6,1,4,1,171,11,63,3,2,4,5))
if mibBuilder.loadTexts:swL2TrunkLACPPortTable.setStatus(_A)
_SwL2TrunkLACPPortEntry_Object=MibTableRow
swL2TrunkLACPPortEntry=_SwL2TrunkLACPPortEntry_Object((1,3,6,1,4,1,171,11,63,3,2,4,5,1))
...
swL2TrunkLACPPortIndex=_SwL2TrunkLACPPortIndex_Object((1,3,6,1,4,1,171,11,63,3,2,4,5,1,1),_SwL2TrunkLACPPortIndex_Type())
...
swL2TrunkLACPPortState=_SwL2TrunkLACPPortState_Object((1,3,6,1,4,1,171,11,63,3,2,4,5,1,2),_SwL2TrunkLACPPortState_Type())
...
swL2TrunkVLANTable=_SwL2TrunkVLANTable_Object((1,3,6,1,4,1,171,11,63,3,2,4,6))
if mibBuilder.loadTexts:swL2TrunkVLANTable.setStatus(_A)
_SwL2TrunkVLANEntry_Object=MibTableRow
swL2TrunkVLANEntry=_SwL2TrunkVLANEntry_Object((1,3,6,1,4,1,171,11,63,3,2,4,6,1))
...
swL2TrunkVLANPort=_SwL2TrunkVLANPort_Object((1,3,6,1,4,1,171,11,63,3,2,4,6,1,1),_SwL2TrunkVLANPort_Type())
...
swL2TrunkVLANState=_SwL2TrunkVLANState_Object((1,3,6,1,4,1,171,11,63,3,2,4,6,1,2),_SwL2TrunkVLANState_Type())
...
swPortMirrorPackage=_SwPortMirrorPackage_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,6))
_SwPortMirrorRxPortList_Type=PortList
_SwPortMirrorRxPortList_Object=MibScalar
swPortMirrorRxPortList=_SwPortMirrorRxPortList_Object((1,3,6,1,4,1,171,11,63,3,2,6,2),_SwPortMirrorRxPortList_Type())
...
swPortMirrorTxPortList=_SwPortMirrorTxPortList_Object((1,3,6,1,4,1,171,11,63,3,2,6,3),_SwPortMirrorTxPortList_Type())
...
swPortMirrorTargetPort=_SwPortMirrorTargetPort_Object((1,3,6,1,4,1,171,11,63,3,2,6,4),_SwPortMirrorTargetPort_Type())
...
swPortMirrorState=_SwPortMirrorState_Object((1,3,6,1,4,1,171,11,63,3,2,6,5),_SwPortMirrorState_Type())
...
swIGMPPackage=_SwIGMPPackage_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,7))
...
swL2IGMPMaxSupportedVlans=_SwL2IGMPMaxSupportedVlans_Object((1,3,6,1,4,1,171,11,63,3,2,7,1),_SwL2IGMPMaxSupportedVlans_Type())
...
swL2IGMPMaxIpGroupNumPerVlan=_SwL2IGMPMaxIpGroupNumPerVlan_Object((1,3,6,1,4,1,171,11,63,3,2,7,2),_SwL2IGMPMaxIpGroupNumPerVlan_Type())
...
swL2IGMPCtrlTable=_SwL2IGMPCtrlTable_Object((1,3,6,1,4,1,171,11,63,3,2,7,3))
if mibBuilder.loadTexts:swL2IGMPCtrlTable.setStatus(_A)
_SwL2IGMPCtrlEntry_Object=MibTableRow
swL2IGMPCtrlEntry=_SwL2IGMPCtrlEntry_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1))
...
swL2IGMPCtrlVid=_SwL2IGMPCtrlVid_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,1),_SwL2IGMPCtrlVid_Type())
...
swL2IGMPQueryInterval=_SwL2IGMPQueryInterval_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,2),_SwL2IGMPQueryInterval_Type())
...
swL2IGMPMaxResponseTime=_SwL2IGMPMaxResponseTime_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,3),_SwL2IGMPMaxResponseTime_Type())
...
swL2IGMPRobustness=_SwL2IGMPRobustness_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,4),_SwL2IGMPRobustness_Type())
...
swL2IGMPLastMemberQueryInterval=_SwL2IGMPLastMemberQueryInterval_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,5),_SwL2IGMPLastMemberQueryInterval_Type())
...
swL2IGMPHostTimeout=_SwL2IGMPHostTimeout_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,6),_SwL2IGMPHostTimeout_Type())
...
swL2IGMPRouteTimeout=_SwL2IGMPRouteTimeout_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,7),_SwL2IGMPRouteTimeout_Type())
...
swL2IGMPLeaveTimer=_SwL2IGMPLeaveTimer_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,8),_SwL2IGMPLeaveTimer_Type())
...
swL2IGMPQueryState=_SwL2IGMPQueryState_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,9),_SwL2IGMPQueryState_Type())
...
swL2IGMPCurrentState=_SwL2IGMPCurrentState_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,10),_SwL2IGMPCurrentState_Type())
...
swL2IGMPCtrlState=_SwL2IGMPCtrlState_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,11),_SwL2IGMPCtrlState_Type())
...
swL2IGMPFastLeave=_SwL2IGMPFastLeave_Object((1,3,6,1,4,1,171,11,63,3,2,7,3,1,12),_SwL2IGMPFastLeave_Type())
...
swL2IGMPQueryInfoTable=_SwL2IGMPQueryInfoTable_Object((1,3,6,1,4,1,171,11,63,3,2,7,4))
if mibBuilder.loadTexts:swL2IGMPQueryInfoTable.setStatus(_A)
_SwL2IGMPQueryInfoEntry_Object=MibTableRow
swL2IGMPQueryInfoEntry=_SwL2IGMPQueryInfoEntry_Object((1,3,6,1,4,1,171,11,63,3,2,7,4,1))
...
swL2IGMPInfoVid=_SwL2IGMPInfoVid_Object((1,3,6,1,4,1,171,11,63,3,2,7,4,1,1),_SwL2IGMPInfoVid_Type())
...
swL2IGMPInfoQueryCount=_SwL2IGMPInfoQueryCount_Object((1,3,6,1,4,1,171,11,63,3,2,7,4,1,2),_SwL2IGMPInfoQueryCount_Type())
...
swL2IGMPInfoTxQueryCount=_SwL2IGMPInfoTxQueryCount_Object((1,3,6,1,4,1,171,11,63,3,2,7,4,1,3),_SwL2IGMPInfoTxQueryCount_Type())
...
swL2IGMPInfoTable=_SwL2IGMPInfoTable_Object((1,3,6,1,4,1,171,11,63,3,2,7,5))
if mibBuilder.loadTexts:swL2IGMPInfoTable.setStatus(_A)
_SwL2IGMPInfoEntry_Object=MibTableRow
swL2IGMPInfoEntry=_SwL2IGMPInfoEntry_Object((1,3,6,1,4,1,171,11,63,3,2,7,5,1))
...
swL2IGMPVid=_SwL2IGMPVid_Object((1,3,6,1,4,1,171,11,63,3,2,7,5,1,1),_SwL2IGMPVid_Type())
...
swL2IGMPGroupIpAddr=_SwL2IGMPGroupIpAddr_Object((1,3,6,1,4,1,171,11,63,3,2,7,5,1,2),_SwL2IGMPGroupIpAddr_Type())
...
swL2IGMPMacAddr=_SwL2IGMPMacAddr_Object((1,3,6,1,4,1,171,11,63,3,2,7,5,1,3),_SwL2IGMPMacAddr_Type())
...
swL2IGMPPortMap=_SwL2IGMPPortMap_Object((1,3,6,1,4,1,171,11,63,3,2,7,5,1,4),_SwL2IGMPPortMap_Type())
...
swL2IGMPIpGroupReportCount=_SwL2IGMPIpGroupReportCount_Object((1,3,6,1,4,1,171,11,63,3,2,7,5,1,5),_SwL2IGMPIpGroupReportCount_Type())
...
swL2IGMPRouterPortTable=_SwL2IGMPRouterPortTable_Object((1,3,6,1,4,1,171,11,63,3,2,7,6))
if mibBuilder.loadTexts:swL2IGMPRouterPortTable.setStatus(_A)
_SwL2IGMPRouterPortEntry_Object=MibTableRow
swL2IGMPRouterPortEntry=_SwL2IGMPRouterPortEntry_Object((1,3,6,1,4,1,171,11,63,3,2,7,6,1))
...
swL2IGMPRouterPortVlanid=_SwL2IGMPRouterPortVlanid_Object((1,3,6,1,4,1,171,11,63,3,2,7,6,1,1),_SwL2IGMPRouterPortVlanid_Type())
...
swL2IGMPRouterPortVlanName=_SwL2IGMPRouterPortVlanName_Object((1,3,6,1,4,1,171,11,63,3,2,7,6,1,2),_SwL2IGMPRouterPortVlanName_Type())
...
swL2IGMPRouterPortStaticPortList=_SwL2IGMPRouterPortStaticPortList_Object((1,3,6,1,4,1,171,11,63,3,2,7,6,1,3),_SwL2IGMPRouterPortStaticPortList_Type())
...
swL2IGMPRouterPortDynamicPortList=_SwL2IGMPRouterPortDynamicPortList_Object((1,3,6,1,4,1,171,11,63,3,2,7,6,1,4),_SwL2IGMPRouterPortDynamicPortList_Type())
...
swL2IGMPRouterPortForbiddenPortList=_SwL2IGMPRouterPortForbiddenPortList_Object((1,3,6,1,4,1,171,11,63,3,2,7,6,1,5),_SwL2IGMPRouterPortForbiddenPortList_Type())
...
swL2IGMPAccessAuthTable=_SwL2IGMPAccessAuthTable_Object((1,3,6,1,4,1,171,11,63,3,2,7,7))
if mibBuilder.loadTexts:swL2IGMPAccessAuthTable.setStatus(_A)
_SwL2IGMPAccessAuthEntry_Object=MibTableRow
swL2IGMPAccessAuthEntry=_SwL2IGMPAccessAuthEntry_Object((1,3,6,1,4,1,171,11,63,3,2,7,7,1))
...
swL2IGMPAccessAuthPort=_SwL2IGMPAccessAuthPort_Object((1,3,6,1,4,1,171,11,63,3,2,7,7,1,1),_SwL2IGMPAccessAuthPort_Type())
...
swL2IGMPAccessAuthState=_SwL2IGMPAccessAuthState_Object((1,3,6,1,4,1,171,11,63,3,2,7,7,1,2),_SwL2IGMPAccessAuthState_Type())
...
swL2TrafficMgmt=_SwL2TrafficMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,11))
_SwL2TrafficCtrlTable_Object=MibTable
swL2TrafficCtrlTable=_SwL2TrafficCtrlTable_Object((1,3,6,1,4,1,171,11,63,3,2,11,1))
if mibBuilder.loadTexts:swL2TrafficCtrlTable.setStatus(_A)
_SwL2TrafficCtrlEntry_Object=MibTableRow
swL2TrafficCtrlEntry=_SwL2TrafficCtrlEntry_Object((1,3,6,1,4,1,171,11,63,3,2,11,1,1))
...
swL2TrafficCtrlGroupIndex=_SwL2TrafficCtrlGroupIndex_Object((1,3,6,1,4,1,171,11,63,3,2,11,1,1,1),_SwL2TrafficCtrlGroupIndex_Type())
...
swL2TrafficCtrlUnitIndex=_SwL2TrafficCtrlUnitIndex_Object((1,3,6,1,4,1,171,11,63,3,2,11,1,1,2),_SwL2TrafficCtrlUnitIndex_Type())
...
swL2TrafficCtrlBMStromthreshold=_SwL2TrafficCtrlBMStromthreshold_Object((1,3,6,1,4,1,171,11,63,3,2,11,1,1,3),_SwL2TrafficCtrlBMStromthreshold_Type())
...
swL2TrafficCtrlBcastStromCtrl=_SwL2TrafficCtrlBcastStromCtrl_Object((1,3,6,1,4,1,171,11,63,3,2,11,1,1,4),_SwL2TrafficCtrlBcastStromCtrl_Type())
...
swL2TrafficCtrlMcastStromCtrl=_SwL2TrafficCtrlMcastStromCtrl_Object((1,3,6,1,4,1,171,11,63,3,2,11,1,1,5),_SwL2TrafficCtrlMcastStromCtrl_Type())
...
swL2TrafficCtrlUcastStromCtrl=_SwL2TrafficCtrlUcastStromCtrl_Object((1,3,6,1,4,1,171,11,63,3,2,11,1,1,6),_SwL2TrafficCtrlUcastStromCtrl_Type())
...
swL2TrafficSegMgmt=_SwL2TrafficSegMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,12))
_SwL2TrafficSegTable_Object=MibTable
swL2TrafficSegTable=_SwL2TrafficSegTable_Object((1,3,6,1,4,1,171,11,63,3,2,12,1))
if mibBuilder.loadTexts:swL2TrafficSegTable.setStatus(_A)
_SwL2TrafficSegEntry_Object=MibTableRow
swL2TrafficSegEntry=_SwL2TrafficSegEntry_Object((1,3,6,1,4,1,171,11,63,3,2,12,1,1))
...
swL2TrafficSegPort=_SwL2TrafficSegPort_Object((1,3,6,1,4,1,171,11,63,3,2,12,1,1,1),_SwL2TrafficSegPort_Type())
...
swL2TrafficSegForwardPorts=_SwL2TrafficSegForwardPorts_Object((1,3,6,1,4,1,171,11,63,3,2,12,1,1,2),_SwL2TrafficSegForwardPorts_Type())
...
swL2PortSecurityMgmt=_SwL2PortSecurityMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,15))
_SwL2PortSecurityControlTable_Object=MibTable
swL2PortSecurityControlTable=_SwL2PortSecurityControlTable_Object((1,3,6,1,4,1,171,11,63,3,2,15,1))
if mibBuilder.loadTexts:swL2PortSecurityControlTable.setStatus(_A)
_SwL2PortSecurityControlEntry_Object=MibTableRow
swL2PortSecurityControlEntry=_SwL2PortSecurityControlEntry_Object((1,3,6,1,4,1,171,11,63,3,2,15,1,1))
...
swL2PortSecurityPortIndex=_SwL2PortSecurityPortIndex_Object((1,3,6,1,4,1,171,11,63,3,2,15,1,1,1),_SwL2PortSecurityPortIndex_Type())
...
swL2PortSecurityMaxLernAddr=_SwL2PortSecurityMaxLernAddr_Object((1,3,6,1,4,1,171,11,63,3,2,15,1,1,2),_SwL2PortSecurityMaxLernAddr_Type())
...
swL2PortSecurityMode=_SwL2PortSecurityMode_Object((1,3,6,1,4,1,171,11,63,3,2,15,1,1,3),_SwL2PortSecurityMode_Type())
...
swL2PortSecurityAdmState=_SwL2PortSecurityAdmState_Object((1,3,6,1,4,1,171,11,63,3,2,15,1,1,4),_SwL2PortSecurityAdmState_Type())
...
swL2PortSecurityTrapLogState=_SwL2PortSecurityTrapLogState_Object((1,3,6,1,4,1,171,11,63,3,2,15,2),_SwL2PortSecurityTrapLogState_Type())
...
swL2StpMgmt=_SwL2StpMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,16))
...
swL2StpForwardBPDU=_SwL2StpForwardBPDU_Object((1,3,6,1,4,1,171,11,63,3,2,16,1),_SwL2StpForwardBPDU_Type())
...
swL2StpLbd=_SwL2StpLbd_Object((1,3,6,1,4,1,171,11,63,3,2,16,2),_SwL2StpLbd_Type())
...
swL2StpLbdRecoverTime=_SwL2StpLbdRecoverTime_Object((1,3,6,1,4,1,171,11,63,3,2,16,3),_SwL2StpLbdRecoverTime_Type())
...
swL2StpPortTable=_SwL2StpPortTable_Object((1,3,6,1,4,1,171,11,63,3,2,16,4))
if mibBuilder.loadTexts:swL2StpPortTable.setStatus(_A)
_SwL2StpPortEntry_Object=MibTableRow
swL2StpPortEntry=_SwL2StpPortEntry_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1))
...
swL2StpPort=_SwL2StpPort_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,1),_SwL2StpPort_Type())
...
swL2StpPortLbd=_SwL2StpPortLbd_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,2),_SwL2StpPortLbd_Type())
...
swL2StpPortStatus=_SwL2StpPortStatus_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,3),_SwL2StpPortStatus_Type())
...
swL2StpPortRole=_SwL2StpPortRole_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,4),_SwL2StpPortRole_Type())
...
swL2StpPortFBPDU=_SwL2StpPortFBPDU_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,5),_SwL2StpPortFBPDU_Type())
...
swL2StpPortLinkState=_SwL2StpPortLinkState_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,6),_SwL2StpPortLinkState_Type())
...
swL2StpPortProtocolMigration=_SwL2StpPortProtocolMigration_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,7),_SwL2StpPortProtocolMigration_Type())
...
swL2StpPortAdminEdgePort=_SwL2StpPortAdminEdgePort_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,8),_SwL2StpPortAdminEdgePort_Type())
...
swL2StpPortOperEdgePort=_SwL2StpPortOperEdgePort_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,9),_SwL2StpPortOperEdgePort_Type())
...
swL2StpPortAdminPointToPoint=_SwL2StpPortAdminPointToPoint_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,10),_SwL2StpPortAdminPointToPoint_Type())
...
swL2StpPortOperPointToPoint=_SwL2StpPortOperPointToPoint_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,11),_SwL2StpPortOperPointToPoint_Type())
...
swL2StpPortAdminPathCost=_SwL2StpPortAdminPathCost_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,12),_SwL2StpPortAdminPathCost_Type())
...
swL2StpPortPriority=_SwL2StpPortPriority_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,13),_SwL2StpPortPriority_Type())
...
swL2STPPortState=_SwL2STPPortState_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,14),_SwL2STPPortState_Type())
...
swL2StpPortRestrictedRole=_SwL2StpPortRestrictedRole_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,15),_SwL2StpPortRestrictedRole_Type())
...
swL2StpPortRestrictedTCN=_SwL2StpPortRestrictedTCN_Object((1,3,6,1,4,1,171,11,63,3,2,16,4,1,16),_SwL2StpPortRestrictedTCN_Type())
...
swL2CosMgmt=_SwL2CosMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,17))
_SwL2CosPriorityCtrl_ObjectIdentity=ObjectIdentity
swL2CosPriorityCtrl=_SwL2CosPriorityCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,17,3))
_SwL2CosPriorityTable_Object=MibTable
swL2CosPriorityTable=_SwL2CosPriorityTable_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,1))
if mibBuilder.loadTexts:swL2CosPriorityTable.setStatus(_A)
_SwL2CosPriorityEntry_Object=MibTableRow
swL2CosPriorityEntry=_SwL2CosPriorityEntry_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,1,1))
...
swL2CosPriorityPort=_SwL2CosPriorityPort_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,1,1,1),_SwL2CosPriorityPort_Type())
...
swL2CosPriorityPortPRI=_SwL2CosPriorityPortPRI_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,1,1,2),_SwL2CosPriorityPortPRI_Type())
...
swL2CosPriorityEtherPRI=_SwL2CosPriorityEtherPRI_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,1,1,3),_SwL2CosPriorityEtherPRI_Type())
...
swL2CosPriorityIpPRI=_SwL2CosPriorityIpPRI_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,1,1,4),_SwL2CosPriorityIpPRI_Type())
...
swL2CosPriorityNone=_SwL2CosPriorityNone_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,1,1,5),_SwL2CosPriorityNone_Type())
...
swL2CosPortPRITable=_SwL2CosPortPRITable_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,2))
if mibBuilder.loadTexts:swL2CosPortPRITable.setStatus(_A)
_SwL2CosPortPRIEntry_Object=MibTableRow
swL2CosPortPRIEntry=_SwL2CosPortPRIEntry_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,2,1))
...
swL2CosPortPRIIndex=_SwL2CosPortPRIIndex_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,2,1,1),_SwL2CosPortPRIIndex_Type())
...
swL2CosPortPRIClass=_SwL2CosPortPRIClass_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,2,1,2),_SwL2CosPortPRIClass_Type())
...
swL2CosMacBasePRITable=_SwL2CosMacBasePRITable_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,3))
if mibBuilder.loadTexts:swL2CosMacBasePRITable.setStatus(_A)
_SwL2CosMacBasePRIEntry_Object=MibTableRow
swL2CosMacBasePRIEntry=_SwL2CosMacBasePRIEntry_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,3,1))
...
swL2CosMacBasePRIIndex=_SwL2CosMacBasePRIIndex_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,3,1,1),_SwL2CosMacBasePRIIndex_Type())
...
swL2CosMacBasePRIClass=_SwL2CosMacBasePRIClass_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,3,1,2),_SwL2CosMacBasePRIClass_Type())
...
swL2CosTosPRITable=_SwL2CosTosPRITable_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,4))
if mibBuilder.loadTexts:swL2CosTosPRITable.setStatus(_A)
_SwL2CosTosPRIEntry_Object=MibTableRow
swL2CosTosPRIEntry=_SwL2CosTosPRIEntry_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,4,1))
...
swL2CosTosPRIIndex=_SwL2CosTosPRIIndex_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,4,1,1),_SwL2CosTosPRIIndex_Type())
...
swL2CosTosPRIClass=_SwL2CosTosPRIClass_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,4,1,2),_SwL2CosTosPRIClass_Type())
...
swL2CosDscpPRITable=_SwL2CosDscpPRITable_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,5))
if mibBuilder.loadTexts:swL2CosDscpPRITable.setStatus(_A)
_SwL2CosDscpPRIEntry_Object=MibTableRow
swL2CosDscpPRIEntry=_SwL2CosDscpPRIEntry_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,5,1))
...
swL2CosDscpPRIIndex=_SwL2CosDscpPRIIndex_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,5,1,1),_SwL2CosDscpPRIIndex_Type())
...
swL2CosDscpPRIClass=_SwL2CosDscpPRIClass_Object((1,3,6,1,4,1,171,11,63,3,2,17,3,5,1,2),_SwL2CosDscpPRIClass_Type())
...
swL2LoopDetectMgmt=_SwL2LoopDetectMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,18))
_SwL2LoopDetectCtrl_ObjectIdentity=ObjectIdentity
swL2LoopDetectCtrl=_SwL2LoopDetectCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,18,1))
...
swL2LoopDetectAdminState=_SwL2LoopDetectAdminState_Object((1,3,6,1,4,1,171,11,63,3,2,18,1,1),_SwL2LoopDetectAdminState_Type())
...
swL2LoopDetectInterval=_SwL2LoopDetectInterval_Object((1,3,6,1,4,1,171,11,63,3,2,18,1,2),_SwL2LoopDetectInterval_Type())
...
swL2LoopDetectRecoverTime=_SwL2LoopDetectRecoverTime_Object((1,3,6,1,4,1,171,11,63,3,2,18,1,3),_SwL2LoopDetectRecoverTime_Type())
...
swL2LoopDetectPortMgmt=_SwL2LoopDetectPortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,18,2))
_SwL2LoopDetectPortTable_Object=MibTable
swL2LoopDetectPortTable=_SwL2LoopDetectPortTable_Object((1,3,6,1,4,1,171,11,63,3,2,18,2,1))
if mibBuilder.loadTexts:swL2LoopDetectPortTable.setStatus(_A)
_SwL2LoopDetectPortEntry_Object=MibTableRow
swL2LoopDetectPortEntry=_SwL2LoopDetectPortEntry_Object((1,3,6,1,4,1,171,11,63,3,2,18,2,1,1))
...
swL2LoopDetectPortIndex=_SwL2LoopDetectPortIndex_Object((1,3,6,1,4,1,171,11,63,3,2,18,2,1,1,1),_SwL2LoopDetectPortIndex_Type())
...
swL2LoopDetectPortState=_SwL2LoopDetectPortState_Object((1,3,6,1,4,1,171,11,63,3,2,18,2,1,1,2),_SwL2LoopDetectPortState_Type())
...
swL2LoopDetectPortLoopStatus=_SwL2LoopDetectPortLoopStatus_Object((1,3,6,1,4,1,171,11,63,3,2,18,2,1,1,4),_SwL2LoopDetectPortLoopStatus_Type())
...
swL2VLANMgmt=_SwL2VLANMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,19))
_SwL2VlanTable_Object=MibTable
swL2VlanTable=_SwL2VlanTable_Object((1,3,6,1,4,1,171,11,63,3,2,19,1))
if mibBuilder.loadTexts:swL2VlanTable.setStatus(_A)
_SwL2VlanEntry_Object=MibTableRow
swL2VlanEntry=_SwL2VlanEntry_Object((1,3,6,1,4,1,171,11,63,3,2,19,1,1))
...
swL2VlanIndex=_SwL2VlanIndex_Object((1,3,6,1,4,1,171,11,63,3,2,19,1,1,1),_SwL2VlanIndex_Type())
...
swL2VlanName=_SwL2VlanName_Object((1,3,6,1,4,1,171,11,63,3,2,19,1,1,2),_SwL2VlanName_Type())
...
swL2VlanType=_SwL2VlanType_Object((1,3,6,1,4,1,171,11,63,3,2,19,1,1,3),_SwL2VlanType_Type())
...
swL2VlanMemberPorts=_SwL2VlanMemberPorts_Object((1,3,6,1,4,1,171,11,63,3,2,19,1,1,4),_SwL2VlanMemberPorts_Type())
...
swL2VlanStaticPorts=_SwL2VlanStaticPorts_Object((1,3,6,1,4,1,171,11,63,3,2,19,1,1,5),_SwL2VlanStaticPorts_Type())
...
swL2VlanUntaggedPorts=_SwL2VlanUntaggedPorts_Object((1,3,6,1,4,1,171,11,63,3,2,19,1,1,6),_SwL2VlanUntaggedPorts_Type())
...
swL2VlanTaggedPorts=_SwL2VlanTaggedPorts_Object((1,3,6,1,4,1,171,11,63,3,2,19,1,1,7),_SwL2VlanTaggedPorts_Type())
...
swL2MgmtMIBTraps=_SwL2MgmtMIBTraps_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,100))
_SwL2Notify_ObjectIdentity=ObjectIdentity
swL2Notify=_SwL2Notify_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,100,1))
_SwL2NotifyPrefix_ObjectIdentity=ObjectIdentity
swL2NotifyPrefix=_SwL2NotifyPrefix_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,100,1,2))
_SwL2NotifFirmware_ObjectIdentity=ObjectIdentity
swL2NotifFirmware=_SwL2NotifFirmware_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,100,1,2,0))
_Swl2NotificationBidings_ObjectIdentity=ObjectIdentity
swl2NotificationBidings=_Swl2NotificationBidings_ObjectIdentity((1,3,6,1,4,1,171,11,63,3,2,100,1,2,1))
...
swL2macNotifyInfo=_SwL2macNotifyInfo_Object((1,3,6,1,4,1,171,11,63,3,2,100,1,2,1,1),_SwL2macNotifyInfo_Type())
...
swL2PortSecurityViolationMac=_SwL2PortSecurityViolationMac_Object((1,3,6,1,4,1,171,11,63,3,2,100,1,2,1,2),_SwL2PortSecurityViolationMac_Type())
...
swL2macNotification=NotificationType((1,3,6,1,4,1,171,11,63,3,2,100,1,2,0,1))
swL2macNotification.setObjects((_F,_AC))
if mibBuilder.loadTexts:swL2macNotification.setStatus(_A)
swL2PortSecurityViolationTrap=NotificationType((1,3,6,1,4,1,171,11,63,3,2,100,1,2,0,2))
