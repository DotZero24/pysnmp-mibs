...
mibBuilder.exportSymbols("PDN-DS1CONFIG-MIB", devDS1TestEntry=devDS1TestEntry, devDS1TestIfIndex=devDS1TestIfIndex, devDS1TestTable=devDS1TestTable, devDS1TestArgument=devDS1TestArgument, devDS1SendControlTable=devDS1SendControlTable, devDS1TestType=devDS1TestType, devDS1MonResultTestType=devDS1MonResultTestType, devDS1TestControl=devDS1TestControl, devDS1MonResultTable=devDS1MonResultTable, devDS1MonResultEntry=devDS1MonResultEntry, devDS1SendControlInjectErr=devDS1SendControlInjectErr, devDS1SendControlErrorCount=devDS1SendControlErrorCount, devDS1Test=devDS1Test, devDS1MonResultErrorCount=devDS1MonResultErrorCount, devDS1MonResultIfIndex=devDS1MonResultIfIndex, devDS1SendControlIfIndex=devDS1SendControlIfIndex, devDS1MonResultCode=devDS1MonResultCode, ent_ds1=ent_ds1, devDS1SendControlEntry=devDS1SendControlEntry)
