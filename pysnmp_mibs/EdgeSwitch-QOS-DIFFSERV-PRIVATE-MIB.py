...
_I='not-accessible'
_H='StorageType'
_G='EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB'
_F='Integer32'
_E='obsolete'
_D='Unsigned32'
_C='read-only'
...
agentDiffServPolicyAttrStmtMarkCosAsSecCos=_AgentDiffServPolicyAttrStmtMarkCosAsSecCos_Object((1,3,6,1,4,1,4413,1,1,7,3,4,1,47),_AgentDiffServPolicyAttrStmtMarkCosAsSecCos_Type())
...
agentDiffServPolicyPerfOutOfferedPackets=_AgentDiffServPolicyPerfOutOfferedPackets_Object((1,3,6,1,4,1,4413,1,1,7,3,6,1,18),_AgentDiffServPolicyPerfOutOfferedPackets_Type())
...
agentDiffServPolicyPerfOutDiscardedPackets=_AgentDiffServPolicyPerfOutDiscardedPackets_Object((1,3,6,1,4,1,4413,1,1,7,3,6,1,20),_AgentDiffServPolicyPerfOutDiscardedPackets_Type())
...
agentDiffServPolicyPerfOutHCOfferedPackets=_AgentDiffServPolicyPerfOutHCOfferedPackets_Object((1,3,6,1,4,1,4413,1,1,7,3,6,1,22),_AgentDiffServPolicyPerfOutHCOfferedPackets_Type())
...
agentDiffServPolicyPerfOutHCDiscardedPackets=_AgentDiffServPolicyPerfOutHCDiscardedPackets_Object((1,3,6,1,4,1,4413,1,1,7,3,6,1,24),_AgentDiffServPolicyPerfOutHCDiscardedPackets_Type())
...
agentDiffServPolicyPerfOutStorageType=_AgentDiffServPolicyPerfOutStorageType_Object((1,3,6,1,4,1,4413,1,1,7,3,6,1,25),_AgentDiffServPolicyPerfOutStorageType_Type())
...
agentDiffServPolicyPerfOutRowStatus=_AgentDiffServPolicyPerfOutRowStatus_Object((1,3,6,1,4,1,4413,1,1,7,3,6,1,26),_AgentDiffServPolicyPerfOutRowStatus_Type())
