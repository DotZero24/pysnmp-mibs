# SNMP MIB module (EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ubiquiti/EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:59:33 2025
...
agentDiffServClassEntry.setIndexNames(
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServClassIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServClassRuleEntry.setIndexNames(
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServClassIndex"),
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServClassRuleIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyEntry.setIndexNames(
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyInstEntry.setIndexNames(
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyIndex"),
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyInstIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyAttrEntry.setIndexNames(
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyIndex"),
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyInstIndex"),
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyAttrIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyAttrStmtMarkCosAsSecCos = _AgentDiffServPolicyAttrStmtMarkCosAsSecCos_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 7, 3, 4, 1, 47),
...
agentDiffServServiceEntry.setIndexNames(
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServServiceIfIndex"),
    (0, "EdgeSwitch-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServServiceIfDirection"),
)
if mibBuilder.loadTexts:
