...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ATM-SIG-DIAG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:46 2025
...
_CsfFilterInInterface_Type.__name__ = "InterfaceIndexOrZero"
...
_CsfFilterOutInterface_Type.__name__ = "InterfaceIndexOrZero"
...
class _CsfFilterCallingParty_Type(AtmAddr):
    """Custom type csfFilterCallingParty based on AtmAddr"""
    defaultValue = OctetString("")


_CsfFilterCallingParty_Type.__name__ = "AtmAddr"
...
class _CsfFilterCalledParty_Type(AtmAddr):
    """Custom type csfFilterCalledParty based on AtmAddr"""
    defaultValue = OctetString("")


_CsfFilterCalledParty_Type.__name__ = "AtmAddr"
...
ciscoSigFailMIBCompliance.setObjects(
      *(("CISCO-ATM-SIG-DIAG-MIB", "ciscoSigFailGeneralGroup"),
        ("CISCO-ATM-SIG-DIAG-MIB", "ciscoSigFailMIBGroup"))
)
if mibBuilder.loadTexts:
