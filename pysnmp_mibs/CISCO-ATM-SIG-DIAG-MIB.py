...
ServiceCategory, PnniNodeId, PnniPortId = mibBuilder.importSymbols("PNNI-MIB", "ServiceCategory", "PnniNodeId", "PnniPortId")
...
mibBuilder.exportSymbols("CISCO-ATM-SIG-DIAG-MIB", csfFilterCallingPartyMask=csfFilterCallingPartyMask, csfFilterIndex=csfFilterIndex, csfFilterNumMatches=csfFilterNumMatches, csfRecordConnKind=csfRecordConnKind, PYSNMP_MODULE_ID=ciscoAtmSigDiagMIB, csfFilterScope=csfFilterScope, csfFilterOutInterface=csfFilterOutInterface, csfFilterMaxRecords=csfFilterMaxRecords, csfRecordCallingPartySubAddress=csfRecordCallingPartySubAddress, csfRecordScope=csfRecordScope, csfFilterInInterface=csfFilterInInterface, csfRecordCrankBackPortId=csfRecordCrankBackPortId, csfFilterConnCastType=csfFilterConnCastType, csfFilterCause=csfFilterCause, ciscoSigFailMIBGroup=ciscoSigFailMIBGroup, csfDtlEntry=csfDtlEntry, csfRecordCrankBackTransitType=csfRecordCrankBackTransitType, csfFilterRowStatus=csfFilterRowStatus, csfFilterEntry=csfFilterEntry, csfRecordCrankBackSucceedingNodeId=csfRecordCrankBackSucceedingNodeId, csfDtlTable=csfDtlTable, csfFilterConnKind=csfFilterConnKind, csfRecordConnCastType=csfRecordConnCastType, csfRecordCause=csfRecordCause, csfRecordInInterface=csfRecordInInterface, AtmAddr=AtmAddr, ciscoSigFailMIBObjects=ciscoSigFailMIBObjects, csfBaseGroup=csfBaseGroup, csfFilterAgeTimeout=csfFilterAgeTimeout, ciscoSigFailGeneralGroup=ciscoSigFailGeneralGroup, csfRecordTimeStamp=csfRecordTimeStamp, ciscoSigFailMIBConformance=ciscoSigFailMIBConformance, csfRecordCrankBackNodeId=csfRecordCrankBackNodeId, csfFilterCalledPartyMask=csfFilterCalledPartyMask, ciscoSigFailMIBGroups=ciscoSigFailMIBGroups, csfRecordDiags=csfRecordDiags, csfDtlLinkType=csfDtlLinkType, csfDtlPortId=csfDtlPortId, csfRecordCalledParty=csfRecordCalledParty, csfDtlNodeId=csfDtlNodeId, csfFilterTable=csfFilterTable, csfFilterGroup=csfFilterGroup, csfFilterCallingParty=csfFilterCallingParty, csfFilterPurge=csfFilterPurge, csfRecordGroup=csfRecordGroup, csfRecordIndex=csfRecordIndex, csfRecordServiceCategory=csfRecordServiceCategory, csfFilterCalledParty=csfFilterCalledParty, csfRecordTable=csfRecordTable, ciscoSigFailMIBCompliances=ciscoSigFailMIBCompliances, csfRecordCallingParty=csfRecordCallingParty, ciscoSigFailMIBCompliance=ciscoSigFailMIBCompliance, csfRecordCalledPartySubAddress=csfRecordCalledPartySubAddress, ciscoAtmSigDiagMIB=ciscoAtmSigDiagMIB, csfRecordConnIndicator=csfRecordConnIndicator, csfFilterControl=csfFilterControl, csfRecordOutInterface=csfRecordOutInterface, csfDtlEntryIndex=csfDtlEntryIndex, csfFilterServiceCategory=csfFilterServiceCategory, csfRecordEntry=csfRecordEntry)
