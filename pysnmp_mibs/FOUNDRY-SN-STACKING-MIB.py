...
mibBuilder.exportSymbols("FOUNDRY-SN-STACKING-MIB", snStackingConfigPeriTrunkTable=snStackingConfigPeriTrunkTable, snStacking=snStacking, snStackingOperUnitStackPort1State=snStackingOperUnitStackPort1State, snStackingOperUnitNeighbor1=snStackingOperUnitNeighbor1, snStackingConfigStackTrunkTable=snStackingConfigStackTrunkTable, snStackingConfigPeriPortTable=snStackingConfigPeriPortTable, snStackingOperUnitStackPort2State=snStackingOperUnitStackPort2State, snStackingOperUnitImgVer=snStackingOperUnitImgVer, snStackingConfigUnitTable=snStackingConfigUnitTable, snStackingConfigStackTrunkRowStatus=snStackingConfigStackTrunkRowStatus, snStackingConfigUnitPriority=snStackingConfigUnitPriority, snStackingTableObjects=snStackingTableObjects, snStackingGlobalTopology=snStackingGlobalTopology, snStackingGlobalZeroTouchEnable=snStackingGlobalZeroTouchEnable, snStackingConfigUnitRowStatus=snStackingConfigUnitRowStatus, snStackingOperUnitEntry=snStackingOperUnitEntry, snStackingGlobalPersistentMacTimer=snStackingGlobalPersistentMacTimer, snStackingOperUnitPriority=snStackingOperUnitPriority, snStackingGlobalConfigState=snStackingGlobalConfigState, snStackingConfigStackTrunkEntry=snStackingConfigStackTrunkEntry, snStackingConfigUnitStackTrunk1=snStackingConfigUnitStackTrunk1, snStackingConfigStackTrunkUnit=snStackingConfigStackTrunkUnit, snStackingConfigPeriTrunkPort2=snStackingConfigPeriTrunkPort2, snStackingConfigUnitEntry=snStackingConfigUnitEntry, snStackingConfigPeriTrunkUnit=snStackingConfigPeriTrunkUnit, snStackingGlobalHighestPriority=snStackingGlobalHighestPriority, PYSNMP_MODULE_ID=snStacking, snStackingConfigUnitName=snStackingConfigUnitName, snStackingConfigStackTrunkNumPort2=snStackingConfigStackTrunkNumPort2, snStackingConfigPeriTrunkEntry=snStackingConfigPeriTrunkEntry, snStackingConfigStackTrunkPort2=snStackingConfigStackTrunkPort2, snStackingGlobalMacAddress=snStackingGlobalMacAddress, snStackingConfigUnitType=snStackingConfigUnitType, snStackingConfigUnitConnectPort2=snStackingConfigUnitConnectPort2, snStackingOperUnitState=snStackingOperUnitState, snStackingConfigUnitStackPort1=snStackingConfigUnitStackPort1, snStackingNeighborPortStackPort=snStackingNeighborPortStackPort, snStackingOperUnitStackPort1=snStackingOperUnitStackPort1, snStackingOperUnitRole=snStackingOperUnitRole, snStackingOperUnitStackPort2=snStackingOperUnitStackPort2, snStackingConfigPeriPortEntry=snStackingConfigPeriPortEntry, snStackingNeighborPortTable=snStackingNeighborPortTable, snStackingConfigPeriPortRowStatus=snStackingConfigPeriPortRowStatus, snStackingConfigPeriTrunkPort1=snStackingConfigPeriTrunkPort1, snStackingConfigUnitState=snStackingConfigUnitState, snStackingConfigPeriTrunkRowStatus=snStackingConfigPeriTrunkRowStatus, snStackingGlobalMaxUnitNumber=snStackingGlobalMaxUnitNumber, snStackingOperUnitBuildlVer=snStackingOperUnitBuildlVer, snStackingOperUnitMac=snStackingOperUnitMac, snStackingGlobalMode=snStackingGlobalMode, snStackingNeighborPortNeighborPort=snStackingNeighborPortNeighborPort, snStackingConfigUnitConfigStackPort=snStackingConfigUnitConfigStackPort, snStackingOperUnitIndex=snStackingOperUnitIndex, snStackingConfigStackTrunkNumPort1=snStackingConfigStackTrunkNumPort1, snStackingNeighborPortEntry=snStackingNeighborPortEntry, snStackingNeighborPortUnit=snStackingNeighborPortUnit, snStackingConfigStackTrunkPort1=snStackingConfigStackTrunkPort1, snStackingGlobalPersistentMacTimerState=snStackingGlobalPersistentMacTimerState, snStackingConfigPeriPortUnit=snStackingConfigPeriPortUnit, snStackingGlobalObjects=snStackingGlobalObjects, snStackingConfigPeriPortPort=snStackingConfigPeriPortPort, snStackingConfigUnitIndex=snStackingConfigUnitIndex, snStackingGlobalMixedMode=snStackingGlobalMixedMode, snStackingOperUnitTable=snStackingOperUnitTable, snStackingConfigUnitConnectPort1=snStackingConfigUnitConnectPort1, snStackingOperUnitNeighbor2=snStackingOperUnitNeighbor2, snStackingOperUnitDescription=snStackingOperUnitDescription, snStackingConfigUnitStackPort2=snStackingConfigUnitStackPort2, snStackingConfigUnitStackTrunk2=snStackingConfigUnitStackTrunk2)
