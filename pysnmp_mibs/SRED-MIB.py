...
mibBuilder.exportSymbols("SRED-MIB", swSredCtrlDropRateLow=swSredCtrlDropRateLow, swSredCtrlDropGreenState=swSredCtrlDropGreenState, swSredCtrlThresholdHigh=swSredCtrlThresholdHigh, swDscpMapCtrl8021pPriority=swDscpMapCtrl8021pPriority, PYSNMP_MODULE_ID=swSredMIB, swSredMIB=swSredMIB, swDscpTrustPortCtrlPortIndex=swDscpTrustPortCtrlPortIndex, swSredCtrlDropRateHigh=swSredCtrlDropRateHigh, swSredCtrl=swSredCtrl, swDscpMapCtrlDscpIndex=swDscpMapCtrlDscpIndex, swSredInfo=swSredInfo, sw8021pColorMapCtrlColor=sw8021pColorMapCtrlColor, swDscpMapCtrlEntry=swDscpMapCtrlEntry, swSredGlobalState=swSredGlobalState, swSredCtrlClassIndex=swSredCtrlClassIndex, swSredDropCounterEntry=swSredDropCounterEntry, swSredCtrlTable=swSredCtrlTable, swSredMgmt=swSredMgmt, sw8021pColorMapCtrlTable=sw8021pColorMapCtrlTable, swDscpMapCtrlPortIndex=swDscpMapCtrlPortIndex, swSredLowDropCounter=swSredLowDropCounter, swDscpMapCtrlTable=swDscpMapCtrlTable, swDscpTrustPortCtrlState=swDscpTrustPortCtrlState, swSredPortIndex=swSredPortIndex, swSredCtrlThresholdLow=swSredCtrlThresholdLow, swDscpMapCtrlColor=swDscpMapCtrlColor, sw8021pColorMapCtrlPriorityIndex=sw8021pColorMapCtrlPriorityIndex, sw8021pColorMapCtrlEntry=sw8021pColorMapCtrlEntry, swDscpTrustPortCtrlTable=swDscpTrustPortCtrlTable, swDscpMapCtrlNewDscp=swDscpMapCtrlNewDscp, swSredDropCounterTable=swSredDropCounterTable, swSredCtrlPortIndex=swSredCtrlPortIndex, sw8021pColorMapCtrlPortIndex=sw8021pColorMapCtrlPortIndex, swSredHighDropCounter=swSredHighDropCounter, swSredCtrlEntry=swSredCtrlEntry, swDscpTrustPortCtrlEntry=swDscpTrustPortCtrlEntry)
