...
mibBuilder.exportSymbols("ALTIGA-FILTER-STATS-MIB", altigaFilterStatsMibConformance=altigaFilterStatsMibConformance, alFilterStatsInPktsFiltered=alFilterStatsInPktsFiltered, alFilterStatsStartTime=alFilterStatsStartTime, alFilterStatsInShortUdpHdr=alFilterStatsInShortUdpHdr, altigaFilterStatsMibModule=altigaFilterStatsMibModule, alFilterStatsInterfaceId=alFilterStatsInterfaceId, alFilterStatsOutIcmpFragDiscard=alFilterStatsOutIcmpFragDiscard, alFilterStatsEntry=alFilterStatsEntry, altigaFilterStatsMibCompliances=altigaFilterStatsMibCompliances, PYSNMP_MODULE_ID=altigaFilterStatsMibModule, alFilterStatsOutShortUdpHdr=alFilterStatsOutShortUdpHdr, alFilterStatsInIcmpFragDiscard=alFilterStatsInIcmpFragDiscard, altigaFilterStatsGroup=altigaFilterStatsGroup, alFilterStatsInShortTcpHdr=alFilterStatsInShortTcpHdr, alFilterStatsInTcpFragDiscard=alFilterStatsInTcpFragDiscard, alFilterStatsOutPktsRx=alFilterStatsOutPktsRx, alFilterStatsInPktsRx=alFilterStatsInPktsRx, alFilterStatsTable=alFilterStatsTable, alFilterStatsOutPktsTx=alFilterStatsOutPktsTx, alFilterStatsInPktsTx=alFilterStatsInPktsTx, alFilterStatsOutShortTcpHdr=alFilterStatsOutShortTcpHdr, alStatsFilterGlobal=alStatsFilterGlobal, alFilterStatsOutPktsFiltered=alFilterStatsOutPktsFiltered, altigaFilterStatsMibCompliance=altigaFilterStatsMibCompliance, alFilterStatsOutTcpFragDiscard=alFilterStatsOutTcpFragDiscard)
