...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-SWITCH-TRAP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:41:02 2025
...
arubaSwitchR0M67Atrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 28, 0, 2)
)
if mibBuilder.loadTexts:
    arubaSwitchR0M67Atrap.setStatus(
        ""
    )

arubaSwitchR0M68Atrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 29, 0, 2)
)
if mibBuilder.loadTexts:
    arubaSwitchR0M68Atrap.setStatus(
        ""
    )

arubaSwitchJL693Atrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 35, 0, 2)
)
if mibBuilder.loadTexts:
    arubaSwitchJL693Atrap.setStatus(
        ""
    )

arubaSwitchJL692Atrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 272, 0, 2)
)
if mibBuilder.loadTexts:
    arubaSwitchJL692Atrap.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"bridge1010trap": bridge1010trap,
       ...
       "arubaSwitchR0M67Atrap": arubaSwitchR0M67Atrap,
       "arubaSwitchR0M68Atrap": arubaSwitchR0M68Atrap,
       "arubaSwitchJL693Atrap": arubaSwitchJL693Atrap,
       "arubaSwitchJL692Atrap": arubaSwitchJL692Atrap,
