...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/ciena/CIENA-CES-OSPF-MIB
...
cienaCesOspfMIB.setRevisions(('2017-06-07 00:00', '2013-04-18 00:00', '2011-02-02 00:00',))
if mibBuilder.loadTexts: cienaCesOspfMIB.setLastUpdated('201706070000Z')
if mibBuilder.loadTexts: cienaCesOspfMIB.setOrganization('Ciena Corp.')
...
mibBuilder.exportSymbols("CIENA-CES-OSPF-MIB", cienaCesOspfRFC1583Comp=cienaCesOspfRFC1583Comp, cienaCesOspfNumUpdPending=cienaCesOspfNumUpdPending, cienaCesOspfAreaNetLsaCksumSum=cienaCesOspfAreaNetLsaCksumSum, cienaCesOspfIfOperStatus=cienaCesOspfIfOperStatus, cienaCesOspfIfNetMask=cienaCesOspfIfNetMask, cienaCesOspfAreaRtrLsaCount=cienaCesOspfAreaRtrLsaCount, cienaCesOspfAreaNssaLsaCksumSum=cienaCesOspfAreaNssaLsaCksumSum, cienaCesOspf=cienaCesOspf, cienaCesOspfMIB=cienaCesOspfMIB, cienaCesOspfAreaTransitCapability=cienaCesOspfAreaTransitCapability, cienaCesOspfAreaOpLsaCksumSum=cienaCesOspfAreaOpLsaCksumSum, cienaCesOspfAreaEntry=cienaCesOspfAreaEntry, cienaCesOspfExtOpLsaCount=cienaCesOspfExtOpLsaCount, cienaCesOspfAreaNetLsaCount=cienaCesOspfAreaNetLsaCount, cienaCesOspfAreaId=cienaCesOspfAreaId, cienaCesOspfRouterId=cienaCesOspfRouterId, PYSNMP_MODULE_ID=cienaCesOspfMIB, cienaCesOspfMIBObjects=cienaCesOspfMIBObjects, cienaCesOspfAreaSummAsLsaCksumSum=cienaCesOspfAreaSummAsLsaCksumSum, cienaCesOspfAreaTable=cienaCesOspfAreaTable, cienaCesOspfAreaOpLsaCount=cienaCesOspfAreaOpLsaCount, cienaCesOspfOpaqueLsaSupport=cienaCesOspfOpaqueLsaSupport, cienaCesOspfTrafficEngSupport=cienaCesOspfTrafficEngSupport, cienaCesOspfExtOpLsaCksumSum=cienaCesOspfExtOpLsaCksumSum, cienaCesOspfIfEntry=cienaCesOspfIfEntry, cienaCesOspfGeneralGroup=cienaCesOspfGeneralGroup, cienaCesOspfIfIpAddress=cienaCesOspfIfIpAddress, cienaCesOspfIfLsaCksumSum=cienaCesOspfIfLsaCksumSum, cienaCesOspfAreaSummAsLsaCount=cienaCesOspfAreaSummAsLsaCount, cienaCesOspfAreaNssaLsaCount=cienaCesOspfAreaNssaLsaCount, cienaCesOspfIfLsaCount=cienaCesOspfIfLsaCount, cienaCesOspfAddressLessIf=cienaCesOspfAddressLessIf, cienaCesOspfAreaSummLsaCount=cienaCesOspfAreaSummLsaCount, cienaCesOspfIfTransmitTimerDelay=cienaCesOspfIfTransmitTimerDelay, cienaCesOspfNumUpdMerged=cienaCesOspfNumUpdMerged, cienaCesOspfOperStatus=cienaCesOspfOperStatus, cienaCesOspfAreaRtrLsaCksumSum=cienaCesOspfAreaRtrLsaCksumSum, cienaCesOspfIfTable=cienaCesOspfIfTable, cienaCesOspfCalcMaxDelay=cienaCesOspfCalcMaxDelay, cienaCesOspfNumCksumsPending=cienaCesOspfNumCksumsPending, cienaCesOspfAreaSummLsaCksumSum=cienaCesOspfAreaSummLsaCksumSum, OspfOperStatus=OspfOperStatus)
