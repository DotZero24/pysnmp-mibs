...
if mibBuilder.loadTexts:snVsrp.setRevisions(('2009-09-30 00:00','2017-08-07 00:00'))
...
snVsrpGlobal=_SnVsrpGlobal_ObjectIdentity((1,3,6,1,4,1,1991,1,1,3,21,1))
...
snVsrpGroupOperModeVsrp=_SnVsrpGroupOperModeVsrp_Object((1,3,6,1,4,1,1991,1,1,3,21,1,1),_SnVsrpGroupOperModeVsrp_Type())
...
snVsrpIfStateChangeTrap=_SnVsrpIfStateChangeTrap_Object((1,3,6,1,4,1,1991,1,1,3,21,1,2),_SnVsrpIfStateChangeTrap_Type())
...
snVsrpIfMaxNumVridPerIntf=_SnVsrpIfMaxNumVridPerIntf_Object((1,3,6,1,4,1,1991,1,1,3,21,1,3),_SnVsrpIfMaxNumVridPerIntf_Type())
...
snVsrpIfMaxNumVridPerSystem=_SnVsrpIfMaxNumVridPerSystem_Object((1,3,6,1,4,1,1991,1,1,3,21,1,4),_SnVsrpIfMaxNumVridPerSystem_Type())
...
snVsrpClearVrrpStat=_SnVsrpClearVrrpStat_Object((1,3,6,1,4,1,1991,1,1,3,21,1,5),_SnVsrpClearVrrpStat_Type())
...
snVsrpIfIntf=_SnVsrpIfIntf_ObjectIdentity((1,3,6,1,4,1,1991,1,1,3,21,2))
_SnVsrpIfTable_Object=MibTable
snVsrpIfTable=_SnVsrpIfTable_Object((1,3,6,1,4,1,1991,1,1,3,21,2,1))
if mibBuilder.loadTexts:snVsrpIfTable.setStatus(_A)
_SnVsrpIfEntry_Object=MibTableRow
snVsrpIfEntry=_SnVsrpIfEntry_Object((1,3,6,1,4,1,1991,1,1,3,21,2,1,1))
...
snVsrpIfVlanId=_SnVsrpIfVlanId_Object((1,3,6,1,4,1,1991,1,1,3,21,2,1,1,1),_SnVsrpIfVlanId_Type())
...
snVsrpIfAuthType=_SnVsrpIfAuthType_Object((1,3,6,1,4,1,1991,1,1,3,21,2,1,1,2),_SnVsrpIfAuthType_Type())
snVsrpIfAuthType.setMaxAccess(_D)
if mibBuilder.loadTexts:snVsrpIfAuthType.setStatus(_A)
class _SnVsrpIfAuthPassword_Type(OctetString):subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,8))
_SnVsrpIfAuthPassword_Type.__name__=_H
_SnVsrpIfAuthPassword_Object=MibTableColumn
snVsrpIfAuthPassword=_SnVsrpIfAuthPassword_Object((1,3,6,1,4,1,1991,1,1,3,21,2,1,1,3),_SnVsrpIfAuthPassword_Type())
...
snVsrpVirRtr=_SnVsrpVirRtr_ObjectIdentity((1,3,6,1,4,1,1991,1,1,3,21,3))
_SnVsrpVirRtrTable_Object=MibTable
snVsrpVirRtrTable=_SnVsrpVirRtrTable_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1))
if mibBuilder.loadTexts:snVsrpVirRtrTable.setStatus(_A)
_SnVsrpVirRtrEntry_Object=MibTableRow
snVsrpVirRtrEntry=_SnVsrpVirRtrEntry_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1))
...
snVsrpVirRtrVlanId=_SnVsrpVirRtrVlanId_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,1),_SnVsrpVirRtrVlanId_Type())
...
snVsrpVirRtrId=_SnVsrpVirRtrId_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,2),_SnVsrpVirRtrId_Type())
...
snVsrpVirRtrOwnership=_SnVsrpVirRtrOwnership_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,3),_SnVsrpVirRtrOwnership_Type())
snVsrpVirRtrOwnership.setMaxAccess(_D)
if mibBuilder.loadTexts:snVsrpVirRtrOwnership.setStatus(_A)
class _SnVsrpVirRtrCfgPriority_Type(Integer32):defaultValue=100;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,255))
_SnVsrpVirRtrCfgPriority_Type.__name__=_B
_SnVsrpVirRtrCfgPriority_Object=MibTableColumn
snVsrpVirRtrCfgPriority=_SnVsrpVirRtrCfgPriority_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,4),_SnVsrpVirRtrCfgPriority_Type())
...
snVsrpVirRtrTrackPriority=_SnVsrpVirRtrTrackPriority_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,5),_SnVsrpVirRtrTrackPriority_Type())
...
snVsrpVirRtrCurrPriority=_SnVsrpVirRtrCurrPriority_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,6),_SnVsrpVirRtrCurrPriority_Type())
...
snVsrpVirRtrHelloInt=_SnVsrpVirRtrHelloInt_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,7),_SnVsrpVirRtrHelloInt_Type())
snVsrpVirRtrHelloInt.setMaxAccess(_D)
if mibBuilder.loadTexts:snVsrpVirRtrHelloInt.setStatus(_A)
class _SnVsrpVirRtrDeadInt_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,84))
_SnVsrpVirRtrDeadInt_Type.__name__=_B
_SnVsrpVirRtrDeadInt_Object=MibTableColumn
snVsrpVirRtrDeadInt=_SnVsrpVirRtrDeadInt_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,8),_SnVsrpVirRtrDeadInt_Type())
...
snVsrpVirRtrPreemptMode=_SnVsrpVirRtrPreemptMode_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,9),_SnVsrpVirRtrPreemptMode_Type())
...
snVsrpVirRtrState=_SnVsrpVirRtrState_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,10),_SnVsrpVirRtrState_Type())
...
snVsrpVirRtrIpAddrMask=_SnVsrpVirRtrIpAddrMask_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,11),_SnVsrpVirRtrIpAddrMask_Type())
...
snVsrpVirRtrActivate=_SnVsrpVirRtrActivate_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,12),_SnVsrpVirRtrActivate_Type())
...
snVsrpVirRtrTrackPortList=_SnVsrpVirRtrTrackPortList_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,13),_SnVsrpVirRtrTrackPortList_Type())
...
snVsrpVirRtrAdvertiseBackup=_SnVsrpVirRtrAdvertiseBackup_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,14),_SnVsrpVirRtrAdvertiseBackup_Type())
...
snVsrpVirRtrHoldDownInt=_SnVsrpVirRtrHoldDownInt_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,15),_SnVsrpVirRtrHoldDownInt_Type())
...
snVsrpVirRtrInitTtl=_SnVsrpVirRtrInitTtl_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,16),_SnVsrpVirRtrInitTtl_Type())
...
snVsrpVirRtrIncPortList=_SnVsrpVirRtrIncPortList_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,17),_SnVsrpVirRtrIncPortList_Type())
...
snVsrpVirRtrSave=_SnVsrpVirRtrSave_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,18),_SnVsrpVirRtrSave_Type())
...
snVsrpVirRtrBackupInt=_SnVsrpVirRtrBackupInt_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,19),_SnVsrpVirRtrBackupInt_Type())
...
snVsrpVirRtrRowStatus=_SnVsrpVirRtrRowStatus_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,20),_SnVsrpVirRtrRowStatus_Type())
...
snVsrpVirRtrRxArpPktDropCnts=_SnVsrpVirRtrRxArpPktDropCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,21),_SnVsrpVirRtrRxArpPktDropCnts_Type())
...
snVsrpVirRtrRxIpPktDropCnts=_SnVsrpVirRtrRxIpPktDropCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,22),_SnVsrpVirRtrRxIpPktDropCnts_Type())
...
snVsrpVirRtrRxPortMismatchCnts=_SnVsrpVirRtrRxPortMismatchCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,23),_SnVsrpVirRtrRxPortMismatchCnts_Type())
...
snVsrpVirRtrRxNumOfIpMismatchCnts=_SnVsrpVirRtrRxNumOfIpMismatchCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,24),_SnVsrpVirRtrRxNumOfIpMismatchCnts_Type())
...
snVsrpVirRtrRxIpMismatchCnts=_SnVsrpVirRtrRxIpMismatchCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,25),_SnVsrpVirRtrRxIpMismatchCnts_Type())
...
snVsrpVirRtrRxHelloIntMismatchCnts=_SnVsrpVirRtrRxHelloIntMismatchCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,26),_SnVsrpVirRtrRxHelloIntMismatchCnts_Type())
...
snVsrpVirRtrRxPriorityZeroFromMasterCnts=_SnVsrpVirRtrRxPriorityZeroFromMasterCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,27),_SnVsrpVirRtrRxPriorityZeroFromMasterCnts_Type())
...
snVsrpVirRtrRxHigherPriorityCnts=_SnVsrpVirRtrRxHigherPriorityCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,28),_SnVsrpVirRtrRxHigherPriorityCnts_Type())
...
snVsrpVirRtrTransToMasterStateCnts=_SnVsrpVirRtrTransToMasterStateCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,29),_SnVsrpVirRtrTransToMasterStateCnts_Type())
...
snVsrpVirRtrTransToBackupStateCnts=_SnVsrpVirRtrTransToBackupStateCnts_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,30),_SnVsrpVirRtrTransToBackupStateCnts_Type())
...
snVsrpVirRtrCurrDeadInt=_SnVsrpVirRtrCurrDeadInt_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,31),_SnVsrpVirRtrCurrDeadInt_Type())
...
snVsrpVirRtrCurHelloInt=_SnVsrpVirRtrCurHelloInt_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,32),_SnVsrpVirRtrCurHelloInt_Type())
...
snVsrpVirRtrCurHoldDownInt=_SnVsrpVirRtrCurHoldDownInt_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,33),_SnVsrpVirRtrCurHoldDownInt_Type())
...
snVsrpVirRtrCurInitTtl=_SnVsrpVirRtrCurInitTtl_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,34),_SnVsrpVirRtrCurInitTtl_Type())
...
snVsrpVirRtrHelloMacAddress=_SnVsrpVirRtrHelloMacAddress_Object((1,3,6,1,4,1,1991,1,1,3,21,3,1,1,35),_SnVsrpVirRtrHelloMacAddress_Type())
