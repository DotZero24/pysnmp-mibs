# SNMP MIB module (Dell-VRTX-CLI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-VRTX-CLI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:29 2025
...
rlCLIremoteCLIcommandsEntry = _RlCLIremoteCLIcommandsEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 52, 6, 5, 1)
)
rlCLIremoteCLIcommandsEntry.setIndexNames(
    (0, "Dell-VRTX-CLI-MIB", "rlCLIremoteCLIcommandIndex"),
    (0, "Dell-VRTX-CLI-MIB", "rlCLIremoteCLIcommandPartNumber"),
)
if mibBuilder.loadTexts:
...
rlCLIremoteCLIoutputsEntry = _RlCLIremoteCLIoutputsEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 52, 6, 6, 1)
)
rlCLIremoteCLIoutputsEntry.setIndexNames(
    (0, "Dell-VRTX-CLI-MIB", "rlCLIremoteCLIoutputRowIndex"),
    (0, "Dell-VRTX-CLI-MIB", "rlCLIremoteCLIoutputRowPartNumber"),
)
if mibBuilder.loadTexts:
