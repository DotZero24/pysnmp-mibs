# SNMP MIB module (HUAWEI-LswARP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/HUAWEI-LswARP-MIB
...
hwLswProxyArpEnableEntry = _HwLswProxyArpEnableEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 4, 1, 1, 1)
)
hwLswProxyArpEnableEntry.setIndexNames(
    (0, "HUAWEI-LswARP-MIB", "hwLswIfIndex"),
)
if mibBuilder.loadTexts:
...
hwLswIfIndex = _HwLswIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 4, 1, 1, 1, 1),
    _HwLswIfIndex_Type()
)
...
hwLswProxyArpStatus = _HwLswProxyArpStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 4, 1, 1, 1, 2),
