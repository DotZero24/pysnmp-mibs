...
mibBuilder.exportSymbols("Juniper-ADDRESS-POOL-MIB", juniAddressPoolTable=juniAddressPoolTable, juniAddressPoolTrapGroup=juniAddressPoolTrapGroup, juniAddressPoolNextPoolProfileIndex=juniAddressPoolNextPoolProfileIndex, juniAddressPool=juniAddressPool, juniAddressPoolEnd=juniAddressPoolEnd, juniAddressPoolCompliance4=juniAddressPoolCompliance4, juniAddressAliasEntry=juniAddressAliasEntry, juniAddressPoolTrapPrefix=juniAddressPoolTrapPrefix, juniAddressPoolName=juniAddressPoolName, PYSNMP_MODULE_ID=juniAddressPoolMIB, juniAddressAliasRowStatus=juniAddressAliasRowStatus, juniAddressPoolHighUtilThreshold=juniAddressPoolHighUtilThreshold, juniAddressPoolMIB=juniAddressPoolMIB, juniAddressPoolCompliance3=juniAddressPoolCompliance3, juniAddressPoolGroup2=juniAddressPoolGroup2, juniAddressPoolProfileEnd=juniAddressPoolProfileEnd, juniAddressPoolUtilPct=juniAddressPoolUtilPct, juniAddressPoolProfileTable=juniAddressPoolProfileTable, juniAddressPoolSize=juniAddressPoolSize, juniAddressPoolCompliance2=juniAddressPoolCompliance2, juniAddressPoolMIBConformance=juniAddressPoolMIBConformance, juniAddressPoolTrapEnable=juniAddressPoolTrapEnable, juniAddressPoolCompliance5=juniAddressPoolCompliance5, juniAddressPoolGroup5=juniAddressPoolGroup5, juniAddressPoolNextPoolIndex=juniAddressPoolNextPoolIndex, juniAddressAliasTable=juniAddressAliasTable, juniAddressPoolStart=juniAddressPoolStart, juniAddressPoolProfileRowStatus=juniAddressPoolProfileRowStatus, juniAddressPoolCompliance6=juniAddressPoolCompliance6, juniAddressPoolProfileSize=juniAddressPoolProfileSize, juniAddressPoolHighAddrUtil=juniAddressPoolHighAddrUtil, juniAddressSharedPoolTable=juniAddressSharedPoolTable, juniAddressPoolGroup4=juniAddressPoolGroup4, juniAddressPoolInUse=juniAddressPoolInUse, juniAddressAliasPoolName=juniAddressAliasPoolName, juniAddressPoolMIBGroups=juniAddressPoolMIBGroups, juniAddressPoolCompliance=juniAddressPoolCompliance, juniAddressPoolProfileStart=juniAddressPoolProfileStart, juniAddressPoolGroup3=juniAddressPoolGroup3, juniAddressPoolNoAddresses=juniAddressPoolNoAddresses, juniAddressPoolProfileIndex=juniAddressPoolProfileIndex, juniAddressPoolDeprecatedGroup=juniAddressPoolDeprecatedGroup, juniAddressPoolMIBCompliances=juniAddressPoolMIBCompliances, juniAddressPoolEntry=juniAddressPoolEntry, juniAddressPoolProfileInUse=juniAddressPoolProfileInUse, juniAddressSharedPoolName=juniAddressSharedPoolName, juniAddressPoolAbatedUtilThreshold=juniAddressPoolAbatedUtilThreshold, juniAddressAliasName=juniAddressAliasName, juniAddressSharedPoolRowStatus=juniAddressSharedPoolRowStatus, juniAddressSharedPoolEntry=juniAddressSharedPoolEntry, juniAddressSharedPoolInUse=juniAddressSharedPoolInUse, juniAddressPoolRowStatus=juniAddressPoolRowStatus, juniAddressPoolTraps=juniAddressPoolTraps, juniAddressPoolAbatedAddrUtil=juniAddressPoolAbatedAddrUtil, juniAddressPoolGroup=juniAddressPoolGroup, juniAddressAliasGroup=juniAddressAliasGroup, juniAddressSharedPoolDhcpPoolName=juniAddressSharedPoolDhcpPoolName, juniAddressSharedPoolIndex=juniAddressSharedPoolIndex, juniAddressPoolIndex=juniAddressPoolIndex, juniAddressPoolProfileEntry=juniAddressPoolProfileEntry, juniAddressPoolObjects=juniAddressPoolObjects)
