# SNMP MIB module (H3C-VOICE-VLAN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-VOICE-VLAN-MIB
...
h3cvoiceVlanOuiEntry = _H3cvoiceVlanOuiEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 9, 1, 1)
)
h3cvoiceVlanOuiEntry.setIndexNames(
    (0, "H3C-VOICE-VLAN-MIB", "h3cVoiceVlanOuiAddress"),
)
if mibBuilder.loadTexts:
...
h3cvoiceVlanPortEntry = _H3cvoiceVlanPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 9, 7, 1)
)
h3cvoiceVlanPortEntry.setIndexNames(
    (0, "H3C-VOICE-VLAN-MIB", "h3cVoiceVlanPortifIndex"),
)
if mibBuilder.loadTexts:
