...
if mibBuilder.loadTexts:h3cVoiceVlan.setRevisions(('2016-12-01 00:00','2009-05-15 00:00','2002-07-01 00:00'))
class PortList(TextualConvention,OctetString):status=_A
_H3cvoiceVlanOuiTable_Object=MibTable
h3cvoiceVlanOuiTable=_H3cvoiceVlanOuiTable_Object((1,3,6,1,4,1,2011,10,2,9,1))
if mibBuilder.loadTexts:h3cvoiceVlanOuiTable.setStatus(_A)
_H3cvoiceVlanOuiEntry_Object=MibTableRow
h3cvoiceVlanOuiEntry=_H3cvoiceVlanOuiEntry_Object((1,3,6,1,4,1,2011,10,2,9,1,1))
...
h3cVoiceVlanOuiAddress=_H3cVoiceVlanOuiAddress_Object((1,3,6,1,4,1,2011,10,2,9,1,1,1),_H3cVoiceVlanOuiAddress_Type())
...
h3cVoiceVlanOuiMask=_H3cVoiceVlanOuiMask_Object((1,3,6,1,4,1,2011,10,2,9,1,1,2),_H3cVoiceVlanOuiMask_Type())
...
h3cVoiceVlanOuiDescription=_H3cVoiceVlanOuiDescription_Object((1,3,6,1,4,1,2011,10,2,9,1,1,3),_H3cVoiceVlanOuiDescription_Type())
...
h3cVoiceVlanOuiRowStatus=_H3cVoiceVlanOuiRowStatus_Object((1,3,6,1,4,1,2011,10,2,9,1,1,4),_H3cVoiceVlanOuiRowStatus_Type())
...
h3cVoiceVlanEnabledId=_H3cVoiceVlanEnabledId_Object((1,3,6,1,4,1,2011,10,2,9,2),_H3cVoiceVlanEnabledId_Type())
...
h3cVoiceVlanPortEnableList=_H3cVoiceVlanPortEnableList_Object((1,3,6,1,4,1,2011,10,2,9,3),_H3cVoiceVlanPortEnableList_Type())
h3cVoiceVlanPortEnableList.setMaxAccess(_B)
if mibBuilder.loadTexts:h3cVoiceVlanPortEnableList.setStatus(_A)
class _H3cVoiceVlanAgingTime_Type(Integer32):defaultValue=1440;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,0),ValueRangeConstraint(5,43200))
_H3cVoiceVlanAgingTime_Type.__name__=_C
_H3cVoiceVlanAgingTime_Object=MibScalar
h3cVoiceVlanAgingTime=_H3cVoiceVlanAgingTime_Object((1,3,6,1,4,1,2011,10,2,9,4),_H3cVoiceVlanAgingTime_Type())
...
h3cVoiceVlanConfigState=_H3cVoiceVlanConfigState_Object((1,3,6,1,4,1,2011,10,2,9,5),_H3cVoiceVlanConfigState_Type())
...
h3cVoiceVlanSecurityState=_H3cVoiceVlanSecurityState_Object((1,3,6,1,4,1,2011,10,2,9,6),_H3cVoiceVlanSecurityState_Type())
...
h3cvoiceVlanPortTable=_H3cvoiceVlanPortTable_Object((1,3,6,1,4,1,2011,10,2,9,7))
if mibBuilder.loadTexts:h3cvoiceVlanPortTable.setStatus(_A)
_H3cvoiceVlanPortEntry_Object=MibTableRow
h3cvoiceVlanPortEntry=_H3cvoiceVlanPortEntry_Object((1,3,6,1,4,1,2011,10,2,9,7,1))
...
h3cVoiceVlanPortifIndex=_H3cVoiceVlanPortifIndex_Object((1,3,6,1,4,1,2011,10,2,9,7,1,1),_H3cVoiceVlanPortifIndex_Type())
...
h3cVoiceVlanPortMode=_H3cVoiceVlanPortMode_Object((1,3,6,1,4,1,2011,10,2,9,7,1,2),_H3cVoiceVlanPortMode_Type())
...
h3cVoiceVlanPortLegacy=_H3cVoiceVlanPortLegacy_Object((1,3,6,1,4,1,2011,10,2,9,7,1,3),_H3cVoiceVlanPortLegacy_Type())
...
h3cVoiceVlanPortQosTrust=_H3cVoiceVlanPortQosTrust_Object((1,3,6,1,4,1,2011,10,2,9,7,1,4),_H3cVoiceVlanPortQosTrust_Type())
