...
DateAndTime, TextualConvention, RowPointer, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "RowPointer", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("NETI-EVENT-MIB", AlarmCause=AlarmCause, eventAlarmIndeterminate=eventAlarmIndeterminate, eventAlarmCreatedTime=eventAlarmCreatedTime, eventEntry=eventEntry, eventAlarmClear=eventAlarmClear, eventActiveAlarmAcknowledged=eventActiveAlarmAcknowledged, eventWarningCounter=eventWarningCounter, eventAlarmSeverity=eventAlarmSeverity, eventActiveAlarmLastChangedTime=eventActiveAlarmLastChangedTime, eventAlarmUnknown=eventAlarmUnknown, eventAlarmWarning=eventAlarmWarning, eventActiveAlarmSeverity=eventActiveAlarmSeverity, eventTrapPurpose=eventTrapPurpose, eventConformanceGroups=eventConformanceGroups, eventObjectName=eventObjectName, eventTable=eventTable, eventActiveAlarmCause=eventActiveAlarmCause, eventActiveAlarmAlarmType=eventActiveAlarmAlarmType, eventAlarmMinor=eventAlarmMinor, eventAlarmAlarmType=eventAlarmAlarmType, netiEventMIB=netiEventMIB, eventAlarmAcknowledged=eventAlarmAcknowledged, eventAlarmTable=eventAlarmTable, eventAlarmText=eventAlarmText, eventLogLastChangedTime=eventLogLastChangedTime, eventType=eventType, eventActiveAlarmEntry=eventActiveAlarmEntry, eventAlarmIndex=eventAlarmIndex, eventAlarmObjectName=eventAlarmObjectName, eventIndeterminateCounter=eventIndeterminateCounter, eventActiveAlarmCreatedTime=eventActiveAlarmCreatedTime, eventMinorCounter=eventMinorCounter, eventAlarmType=eventAlarmType, eventCreatedTime=eventCreatedTime, eventCriticalCounter=eventCriticalCounter, eventActiveAlarmObject=eventActiveAlarmObject, eventAlarmEntry=eventAlarmEntry, AlarmType=AlarmType, eventAlarmCritical=eventAlarmCritical, eventSequenceCounter=eventSequenceCounter, eventMajorCounter=eventMajorCounter, EventType=EventType, eventConformanceGroup=eventConformanceGroup, eventNotificationObjectsGroup=eventNotificationObjectsGroup, eventNotificationsGroup=eventNotificationsGroup, eventAlarmObject=eventAlarmObject, eventActiveAlarmIndex=eventActiveAlarmIndex, eventAlarmMajor=eventAlarmMajor, AlarmSeverity=AlarmSeverity, eventText=eventText, eventAlarmCause=eventAlarmCause, eventActiveAlarmTable=eventActiveAlarmTable, eventActiveAlarmText=eventActiveAlarmText, PYSNMP_MODULE_ID=netiEventMIB, eventIndex=eventIndex, netiGenericEvent=netiGenericEvent, eventAlarmLastChangedTime=eventAlarmLastChangedTime, eventNotifications=eventNotifications, eventObject=eventObject, eventCause=eventCause, eventSeverity=eventSeverity, eventActiveAlarmObjectName=eventActiveAlarmObjectName, eventObjects=eventObjects, eventAlarmCountersGroup=eventAlarmCountersGroup)
