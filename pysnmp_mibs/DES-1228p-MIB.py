...
mibBuilder.exportSymbols("DES-1228p-MIB", portTrunkMember=portTrunkMember, lldpSysConfigChecksum=lldpSysConfigChecksum, commTrapTrapAbnormalTPTXError=commTrapTrapAbnormalTPTXError, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, configPasswordAdmin=configPasswordAdmin, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, tvlanPortVlanId=tvlanPortVlanId, configRestoreDefaults=configRestoreDefaults, commSetStatus=commSetStatus, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, configPhysAddress=configPhysAddress, configPortTable=configPortTable, staticMac=staticMac, tvlanManagementid=tvlanManagementid, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, configVerSwPrimary=configVerSwPrimary, tvlanName=tvlanName, commSetTable=commSetTable, igsVlanFilterStatus=igsVlanFilterStatus, igsSharedSegmentAggregationInterval=igsSharedSegmentAggregationInterval, d_link=d_link, igsMcastEntryAgeingInterval=igsMcastEntryAgeingInterval, radiusServerAddress=radiusServerAddress, companyTVlanGroup=companyTVlanGroup, igsQueryInterval=igsQueryInterval, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, igsVlanFilterTable=igsVlanFilterTable, MacAddress=MacAddress, commTrapTrapAbnormalFiberTXError=commTrapTrapAbnormalFiberTXError, commTrapTrapPOEPortShort=commTrapTrapPOEPortShort, poeportgroup=poeportgroup, igsSystem=igsSystem, swTPAbnormalRXError=swTPAbnormalRXError, configMirrorEntry=configMirrorEntry, swTPAbnormalTXError=swTPAbnormalTXError, staticOnOff=staticOnOff, configPortOperStatus=configPortOperStatus, igsVlan=igsVlan, igsRobustnessValue=igsRobustnessValue, staticPort=staticPort, tvlanTable=tvlanTable, igsv3Processing=igsv3Processing, commTrapName=commTrapName, igsVlanMcastFwdPortListMac=igsVlanMcastFwdPortListMac, configNetMask=configNetMask, tvlanStatus=tvlanStatus, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, PortList=PortList, dlink_products=dlink_products, companyMiscGroup=companyMiscGroup, configBootTftpServerIp=configBootTftpServerIp, configPort=configPort, configIpAssignmentMode=configIpAssignmentMode, swFiberAbnormalTXError=swFiberAbnormalTXError, lldpAntiRoguePortStatus=lldpAntiRoguePortStatus, configMirrorMon=configMirrorMon, configVLANMode=configVLANMode, configMirrorRXSrc=configMirrorRXSrc, poeportpowerlimit=poeportpowerlimit, companyDot1xGroup=companyDot1xGroup, poeportid=poeportid, staticStatus=staticStatus, dlink_DES12XXSeriesProd=dlink_DES12XXSeriesProd, staticId=staticId, igsVlanMcastFwdVlanIdMac=igsVlanMcastFwdVlanIdMac, configTftpServerIpAddress=configTftpServerIpAddress, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, configMirrorStatus=configMirrorStatus, poePortEntry=poePortEntry, swFiberRemove=swFiberRemove, configIpAddress=configIpAddress, companyConfigGroup=companyConfigGroup, staticTable=staticTable, commTrapIndex=commTrapIndex, lldpAntiRoguePortControl=lldpAntiRoguePortControl, spanOnOff=spanOnOff, commTrapTrapAbnormalFiberRXError=commTrapTrapAbnormalFiberRXError, configMirrorId=configMirrorId, configTftpOperation=configTftpOperation, companyCommGroup=companyCommGroup, OwnerString=OwnerString, dot1xAuth=dot1xAuth, commGetTable=commGetTable, tvlanUntaggedPorts=tvlanUntaggedPorts, configPortSpeed=configPortSpeed, configPortEntry=configPortEntry, commGetEntry=commGetEntry, commTrapSNMPBootup=commTrapSNMPBootup, commTrapSNMPTPLinkUpDown=commTrapSNMPTPLinkUpDown, igsNextMcastFwdMode=igsNextMcastFwdMode, swFiberInsert=swFiberInsert, commGetIndex=commGetIndex, portTrunkEntry=portTrunkEntry, igsVlanRouterPortList=igsVlanRouterPortList, dot1xAuthMaxReq=dot1xAuthMaxReq, commSetName=commSetName, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, swFiberAbnormalRXError=swFiberAbnormalRXError, igsVlanMcastFwdGroupAddress=igsVlanMcastFwdGroupAddress, companyStaticGroup=companyStaticGroup, dot1xAuthServerTimeout=dot1xAuthServerTimeout, igsLeaveProcessInterval=igsLeaveProcessInterval, tvlanManagementOnOff=tvlanManagementOnOff, commGetStatus=commGetStatus, configGateway=configGateway, configPortPriority=configPortPriority, tvlanMember=tvlanMember, igsVlanMcastFwdEntry=igsVlanMcastFwdEntry, staticEntry=staticEntry, tvlanAsyOnOff=tvlanAsyOnOff, commTrapStatus=commTrapStatus, igsGblReportFwdOnAllPorts=igsGblReportFwdOnAllPorts, igsVlanMcastFwdTable=igsVlanMcastFwdTable, commTrapIpAddress=commTrapIpAddress, igsVlanRouterPortListTable=igsVlanRouterPortListTable, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, commTrapTrapPOEPortOvercurrent=commTrapTrapPOEPortOvercurrent, igsHostPortPurgeInterval=igsHostPortPurgeInterval, igsVlanRouterPortListVlanId=igsVlanRouterPortListVlanId, igsReportForwardInterval=igsReportForwardInterval, RowStatus=RowStatus, configTftpServerFileName=configTftpServerFileName, tvlanPortPortId=tvlanPortPortId, configBootTftpOperation=configBootTftpOperation, tvlanPortEntry=tvlanPortEntry, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, companyIgsGroup=companyIgsGroup, lldpSysMACDigest=lldpSysMACDigest, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, radiusServerPort=radiusServerPort, configMirrorTable=configMirrorTable, configVerHwChipSet=configVerHwChipSet, igsVlanRouterPortListEntry=igsVlanRouterPortListEntry, portTrunkTable=portTrunkTable, dot1xAuthTxPeriod=dot1xAuthTxPeriod, companyPoEGroup=companyPoEGroup, dot1xAuthSystemControl=dot1xAuthSystemControl, staticVlanID=staticVlanID, commTrapSNMPFiberLinkUpDown=commTrapSNMPFiberLinkUpDown, igsVlanFilterEntry=igsVlanFilterEntry, companySpanGroup=companySpanGroup, igsStatus=igsStatus, commSetEntry=commSetEntry, tvlanPortTable=tvlanPortTable, companyLLDPExtnGroup=companyLLDPExtnGroup, configBootImageFileName=configBootImageFileName, des_1228pa1=des_1228pa1, commTrapTable=commTrapTable, configMirrorTXSrc=configMirrorTXSrc, configSNMPEnable=configSNMPEnable, igsVlanId=igsVlanId, portTrunkName=portTrunkName, commSetIndex=commSetIndex, commTrapTrapAbnormalTPRXError=commTrapTrapAbnormalTPRXError, commTrapEntry=commTrapEntry, portTrunkId=portTrunkId, igsQueryMaxResponseTime=igsQueryMaxResponseTime, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, lldpGalobalEnable=lldpGalobalEnable, companyPortTrunkGroup=companyPortTrunkGroup, miscStatisticsReset=miscStatisticsReset, poePortTable=poePortTable, configSave=configSave, radiusServerSharedSecret=radiusServerSharedSecret, commGetName=commGetName, tvlanEntry=tvlanEntry, tvlanId=tvlanId, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, commTrapTrapPOEPowerFail=commTrapTrapPOEPowerFail, lldpAntiRogueKey=lldpAntiRogueKey, staticAutoLearning=staticAutoLearning, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, radius=radius, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, miscReset=miscReset, lldpAntiRoguePortIndex=lldpAntiRoguePortIndex, igsLastMembQueryInterval=igsLastMembQueryInterval)
