...
# Notes
# -----
# ASN.1 source file://mibs/h3c/HUAWEI-3COM-OID-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:58 2025
...
_H3cInfoCenter_ObjectIdentity = ObjectIdentity
h3cInfoCenter = _H3cInfoCenter_ObjectIdentity(
...
_H3cTRNG2_ObjectIdentity = ObjectIdentity
h3cTRNG2 = _H3cTRNG2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 121)
)
_H3cDhcp4_ObjectIdentity = ObjectIdentity
h3cDhcp4 = _H3cDhcp4_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 122)
)
_H3cMulticastSnoop_ObjectIdentity = ObjectIdentity
h3cMulticastSnoop = _H3cMulticastSnoop_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 123)
)
_H3cDhcpSnoop2_ObjectIdentity = ObjectIdentity
h3cDhcpSnoop2 = _H3cDhcpSnoop2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 124)
)
_H3cRmonExt_ObjectIdentity = ObjectIdentity
h3cRmonExt = _H3cRmonExt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 125)
)
_H3cIPsecMonitorV2_ObjectIdentity = ObjectIdentity
h3cIPsecMonitorV2 = _H3cIPsecMonitorV2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 126)
)
_H3cSan_ObjectIdentity = ObjectIdentity
h3cSan = _H3cSan_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 127)
)
_H3cSpb_ObjectIdentity = ObjectIdentity
h3cSpb = _H3cSpb_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 128)
)
_H3cPex_ObjectIdentity = ObjectIdentity
h3cPex = _H3cPex_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 129)
)
_H3cSlbg_ObjectIdentity = ObjectIdentity
h3cSlbg = _H3cSlbg_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 130)
)
_H3cPvst_ObjectIdentity = ObjectIdentity
h3cPvst = _H3cPvst_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 131)
)
_H3cEvi_ObjectIdentity = ObjectIdentity
h3cEvi = _H3cEvi_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 132)
)
_H3cIssuUpgrade_ObjectIdentity = ObjectIdentity
h3cIssuUpgrade = _H3cIssuUpgrade_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 133)
)
_H3cEvb_ObjectIdentity = ObjectIdentity
h3cEvb = _H3cEvb_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 134)
)
_H3cFcoeMode_ObjectIdentity = ObjectIdentity
h3cFcoeMode = _H3cFcoeMode_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 135)
)
_H3cMDC_ObjectIdentity = ObjectIdentity
h3cMDC = _H3cMDC_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 136)
)
_H3cQinQv2_ObjectIdentity = ObjectIdentity
h3cQinQv2 = _H3cQinQv2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 137)
)
_H3cVmap_ObjectIdentity = ObjectIdentity
h3cVmap = _H3cVmap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 138)
)
_H3cL2tp_ObjectIdentity = ObjectIdentity
h3cL2tp = _H3cL2tp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 139)
)
_H3cMultilinkPPPV2_ObjectIdentity = ObjectIdentity
h3cMultilinkPPPV2 = _H3cMultilinkPPPV2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 140)
)
_H3cLocAAASrv_ObjectIdentity = ObjectIdentity
h3cLocAAASrv = _H3cLocAAASrv_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 141)
)
_H3cMplsExt_ObjectIdentity = ObjectIdentity
h3cMplsExt = _H3cMplsExt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 142)
)
_H3cMplsTe_ObjectIdentity = ObjectIdentity
h3cMplsTe = _H3cMplsTe_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 143)
)
_H3cBpa_ObjectIdentity = ObjectIdentity
h3cBpa = _H3cBpa_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 144)
)
_H3cLicense_ObjectIdentity = ObjectIdentity
h3cLicense = _H3cLicense_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 145)
)
_H3cARPSourceSuppression_ObjectIdentity = ObjectIdentity
h3cARPSourceSuppression = _H3cARPSourceSuppression_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 146)
)
_H3cSmlk_ObjectIdentity = ObjectIdentity
h3cSmlk = _H3cSmlk_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 147)
)
_H3cLBv2_ObjectIdentity = ObjectIdentity
h3cLBv2 = _H3cLBv2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 148)
)
_H3cSession_ObjectIdentity = ObjectIdentity
h3cSession = _H3cSession_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 149)
)
_H3cVxlan_ObjectIdentity = ObjectIdentity
h3cVxlan = _H3cVxlan_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 150)
)
_H3cRddc_ObjectIdentity = ObjectIdentity
h3cRddc = _H3cRddc_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 151)
)
_H3cIpRanDcn_ObjectIdentity = ObjectIdentity
h3cIpRanDcn = _H3cIpRanDcn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 152)
)
_H3c8021XExt2_ObjectIdentity = ObjectIdentity
h3c8021XExt2 = _H3c8021XExt2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 153)
)
_H3cContext_ObjectIdentity = ObjectIdentity
h3cContext = _H3cContext_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 154)
)
_H3cObjp_ObjectIdentity = ObjectIdentity
h3cObjp = _H3cObjp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 155)
)
_H3cNvgre_ObjectIdentity = ObjectIdentity
h3cNvgre = _H3cNvgre_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 156)
)
_H3cWlanMt_ObjectIdentity = ObjectIdentity
h3cWlanMt = _H3cWlanMt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 157)
)
_H3cRbac_ObjectIdentity = ObjectIdentity
h3cRbac = _H3cRbac_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 158)
)
_H3cDHCP6Server_ObjectIdentity = ObjectIdentity
h3cDHCP6Server = _H3cDHCP6Server_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 159)
)
_H3cMplsVpnBgp_ObjectIdentity = ObjectIdentity
h3cMplsVpnBgp = _H3cMplsVpnBgp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 160)
)
_H3cOspf_ObjectIdentity = ObjectIdentity
h3cOspf = _H3cOspf_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 161)
)
_H3cL2vpn_ObjectIdentity = ObjectIdentity
h3cL2vpn = _H3cL2vpn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 162)
)
_H3cMACsec_ObjectIdentity = ObjectIdentity
h3cMACsec = _H3cMACsec_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 163)
)
_H3cFailover_ObjectIdentity = ObjectIdentity
h3cFailover = _H3cFailover_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 164)
)
_H3cVpnPeer_ObjectIdentity = ObjectIdentity
h3cVpnPeer = _H3cVpnPeer_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 165)
)
_H3cSecp_ObjectIdentity = ObjectIdentity
h3cSecp = _H3cSecp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 166)
)
_H3cOfp_ObjectIdentity = ObjectIdentity
h3cOfp = _H3cOfp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 167)
)
_H3cARPEntry_ObjectIdentity = ObjectIdentity
h3cARPEntry = _H3cARPEntry_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 168)
)
_H3cResMon_ObjectIdentity = ObjectIdentity
h3cResMon = _H3cResMon_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 169)
)
_H3cSslvpn_ObjectIdentity = ObjectIdentity
h3cSslvpn = _H3cSslvpn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 170)
)
_H3cSecHigh_ObjectIdentity = ObjectIdentity
h3cSecHigh = _H3cSecHigh_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 171)
)
_H3cBgpEvpn_ObjectIdentity = ObjectIdentity
h3cBgpEvpn = _H3cBgpEvpn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 172)
)
_H3cEvpn_ObjectIdentity = ObjectIdentity
h3cEvpn = _H3cEvpn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 173)
)
_H3cLTE_ObjectIdentity = ObjectIdentity
h3cLTE = _H3cLTE_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 174)
)
_H3cPPP_ObjectIdentity = ObjectIdentity
h3cPPP = _H3cPPP_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 175)
)
