...
rlUPnPUniqueDeviceName=_RlUPnPUniqueDeviceName_Object((1,3,6,1,4,1,89,109,1),_RlUPnPUniqueDeviceName_Type())
...
rlUPnPEnabling=_RlUPnPEnabling_Object((1,3,6,1,4,1,89,109,2),_RlUPnPEnabling_Type())
rlUPnPEnabling.setMaxAccess('read-write')
if mibBuilder.loadTexts:rlUPnPEnabling.setStatus(_B)
mibBuilder.exportSymbols('RADLAN-UPNP-MIB',**{'rlUPnP':rlUPnP,'rlUPnPUniqueDeviceName':rlUPnPUniqueDeviceName,'rlUPnPEnabling':rlUPnPEnabling})