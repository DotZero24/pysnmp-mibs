...
mibBuilder.exportSymbols("RADLAN-UPNP-MIB", rlUPnPEnabling=rlUPnPEnabling, PYSNMP_MODULE_ID=rlUPnP, rlUPnP=rlUPnP, rlUPnPUniqueDeviceName=rlUPnPUniqueDeviceName)
