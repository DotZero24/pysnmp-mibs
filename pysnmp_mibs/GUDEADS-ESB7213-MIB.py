...
epc7213NTPClient = _Epc7213NTPClient_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 28507, 66, 1, 5, 15)
)


class _Epc7213NTPTimeValid_Type(Integer32):
    """Custom type epc7213NTPTimeValid based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_Epc7213NTPTimeValid_Type.__name__ = "Integer32"
_Epc7213NTPTimeValid_Object = MibScalar
epc7213NTPTimeValid = _Epc7213NTPTimeValid_Object(
    (1, 3, 6, 1, 4, 1, 28507, 66, 1, 5, 15, 1),
    _Epc7213NTPTimeValid_Type()
)
epc7213NTPTimeValid.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    epc7213NTPTimeValid.setStatus("current")
_Epc7213NTPUnixTime_Type = Unsigned32
_Epc7213NTPUnixTime_Object = MibScalar
epc7213NTPUnixTime = _Epc7213NTPUnixTime_Object(
    (1, 3, 6, 1, 4, 1, 28507, 66, 1, 5, 15, 2),
    _Epc7213NTPUnixTime_Type()
)
epc7213NTPUnixTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    epc7213NTPUnixTime.setStatus("current")
if mibBuilder.loadTexts:
    epc7213NTPUnixTime.setUnits("s")
_Epc7213NTPLastValidTimestamp_Type = Unsigned32
_Epc7213NTPLastValidTimestamp_Object = MibScalar
epc7213NTPLastValidTimestamp = _Epc7213NTPLastValidTimestamp_Object(
    (1, 3, 6, 1, 4, 1, 28507, 66, 1, 5, 15, 3),
    _Epc7213NTPLastValidTimestamp_Type()
)
epc7213NTPLastValidTimestamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    epc7213NTPLastValidTimestamp.setStatus("current")
if mibBuilder.loadTexts:
    epc7213NTPLastValidTimestamp.setUnits("s")
...
esb7213BasicGroup.setObjects(
      *(("GUDEADS-ESB7213-MIB", "esb7213TrapCtrl"),
        ...
        ("GUDEADS-ESB7213-MIB", "epc7213NTPTimeValid"),
        ("GUDEADS-ESB7213-MIB", "epc7213NTPUnixTime"),
        ("GUDEADS-ESB7213-MIB", "epc7213NTPLastValidTimestamp"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"gudeads": gudeads,
       ...
       "epc7213NTPClient": epc7213NTPClient,
       "epc7213NTPTimeValid": epc7213NTPTimeValid,
       "epc7213NTPUnixTime": epc7213NTPUnixTime,
       "epc7213NTPLastValidTimestamp": epc7213NTPLastValidTimestamp,
