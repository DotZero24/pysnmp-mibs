...
oacMIBModules, oacExpIMIsdn, oacExpIMIsdnNotifications = mibBuilder.importSymbols("ONEACCESS-GLOBAL-REG", "oacMIBModules", "oacExpIMIsdn", "oacExpIMIsdnNotifications")
