...
swLedMIBObject=_SwLedMIBObject_ObjectIdentity((1,3,6,1,4,1,171,11,117,4,1,4,1))
_SwLedInfoTable_Object=MibTable
swLedInfoTable=_SwLedInfoTable_Object((1,3,6,1,4,1,171,11,117,4,1,4,1,1))
if mibBuilder.loadTexts:swLedInfoTable.setStatus(_A)
_SwLedInfoEntry_Object=MibTableRow
swLedInfoEntry=_SwLedInfoEntry_Object((1,3,6,1,4,1,171,11,117,4,1,4,1,1,1))
...
swLedInfoUnitId=_SwLedInfoUnitId_Object((1,3,6,1,4,1,171,11,117,4,1,4,1,1,1,1),_SwLedInfoUnitId_Type())
...
swLedInfoFrontPanelLedStatus=_SwLedInfoFrontPanelLedStatus_Object((1,3,6,1,4,1,171,11,117,4,1,4,1,1,1,2),_SwLedInfoFrontPanelLedStatus_Type())
