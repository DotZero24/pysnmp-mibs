...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINKSW-IP-FILTER-MIB
...
dIPFilterMIBFullCompliance.setObjects(
      *(("DLINKSW-IP-FILTER-MIB", "dRouteMapGroup"),
        ("DLINKSW-IP-FILTER-MIB", "dRouteMapSeqGroup"),
        ("DLINKSW-IP-FILTER-MIB", "dRouteMapClauseGroup"),
        ("DLINKSW-IP-FILTER-MIB", "dAccessListGroup"),
        ("DLINKSW-IP-FILTER-MIB", "dAccessListRuleGroup"),
        ("DLINKSW-IP-FILTER-MIB", "dPrefixListGroup"),
        ("DLINKSW-IP-FILTER-MIB", "dPrefixListRuleGroup"),
        ("DLINKSW-IP-FILTER-MIB", "dPrefixListDescGroup"))
)
if mibBuilder.loadTexts:
