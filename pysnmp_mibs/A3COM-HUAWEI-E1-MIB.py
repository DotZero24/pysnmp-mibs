...
if mibBuilder.loadTexts:h3cE1.setRevisions(('2010-04-08 18:55','2009-06-08 17:41','2004-12-01 14:36'))
...
e1InterfaceStatusTable=_E1InterfaceStatusTable_Object((1,3,6,1,4,1,43,45,1,10,2,28,1))
if mibBuilder.loadTexts:e1InterfaceStatusTable.setStatus(_A)
_E1InterfaceStatusEntry_Object=MibTableRow
e1InterfaceStatusEntry=_E1InterfaceStatusEntry_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1))
...
e1InterfaceInErrs=_E1InterfaceInErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,1),_E1InterfaceInErrs_Type())
...
e1InterfaceInRuntsErrs=_E1InterfaceInRuntsErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,2),_E1InterfaceInRuntsErrs_Type())
...
e1InterfaceInGiantsErrs=_E1InterfaceInGiantsErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,3),_E1InterfaceInGiantsErrs_Type())
...
e1InterfaceInCrcErrs=_E1InterfaceInCrcErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,4),_E1InterfaceInCrcErrs_Type())
...
e1InterfaceInAlignErrs=_E1InterfaceInAlignErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,5),_E1InterfaceInAlignErrs_Type())
...
e1InterfaceInOverRunsErrs=_E1InterfaceInOverRunsErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,6),_E1InterfaceInOverRunsErrs_Type())
...
e1InterfaceInDribblesErrs=_E1InterfaceInDribblesErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,7),_E1InterfaceInDribblesErrs_Type())
...
e1InterfaceInAbortedSeqErrs=_E1InterfaceInAbortedSeqErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,8),_E1InterfaceInAbortedSeqErrs_Type())
...
e1InterfaceInNoBufferErrs=_E1InterfaceInNoBufferErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,9),_E1InterfaceInNoBufferErrs_Type())
...
e1InterfaceInFramingErrs=_E1InterfaceInFramingErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,10),_E1InterfaceInFramingErrs_Type())
...
e1InterfaceOutputErrs=_E1InterfaceOutputErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,11),_E1InterfaceOutputErrs_Type())
...
e1InterfaceOutUnderRunErrs=_E1InterfaceOutUnderRunErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,12),_E1InterfaceOutUnderRunErrs_Type())
...
e1InterfaceOutCollisonsErrs=_E1InterfaceOutCollisonsErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,13),_E1InterfaceOutCollisonsErrs_Type())
...
e1InterfaceOutDeferedErrs=_E1InterfaceOutDeferedErrs_Object((1,3,6,1,4,1,43,45,1,10,2,28,1,1,14),_E1InterfaceOutDeferedErrs_Type())
...
h3ce1Table=_H3ce1Table_Object((1,3,6,1,4,1,43,45,1,10,2,28,2))
if mibBuilder.loadTexts:h3ce1Table.setStatus(_A)
_H3ce1Entry_Object=MibTableRow
h3ce1Entry=_H3ce1Entry_Object((1,3,6,1,4,1,43,45,1,10,2,28,2,1))
...
h3ce1Type=_H3ce1Type_Object((1,3,6,1,4,1,43,45,1,10,2,28,2,1,1),_H3ce1Type_Type())
h3ce1Type.setMaxAccess(_B)
if mibBuilder.loadTexts:h3ce1Type.setStatus(_A)
class _H3ce1Clock_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('slave',1),('master',2)))
_H3ce1Clock_Type.__name__=_C
_H3ce1Clock_Object=MibTableColumn
h3ce1Clock=_H3ce1Clock_Object((1,3,6,1,4,1,43,45,1,10,2,28,2,1,2),_H3ce1Clock_Type())
...
h3ce1FrameFormat=_H3ce1FrameFormat_Object((1,3,6,1,4,1,43,45,1,10,2,28,2,1,3),_H3ce1FrameFormat_Type())
...
h3ce1LineCode=_H3ce1LineCode_Object((1,3,6,1,4,1,43,45,1,10,2,28,2,1,4),_H3ce1LineCode_Type())
...
h3ce1PriSetTimeSlot=_H3ce1PriSetTimeSlot_Object((1,3,6,1,4,1,43,45,1,10,2,28,2,1,5),_H3ce1PriSetTimeSlot_Type())
...
h3ce1DChannelIndex=_H3ce1DChannelIndex_Object((1,3,6,1,4,1,43,45,1,10,2,28,2,1,6),_H3ce1DChannelIndex_Type())
...
h3ce1SubScribLineChannelIndex=_H3ce1SubScribLineChannelIndex_Object((1,3,6,1,4,1,43,45,1,10,2,28,2,1,7),_H3ce1SubScribLineChannelIndex_Type())
...
h3ce1FcmChannelIndex=_H3ce1FcmChannelIndex_Object((1,3,6,1,4,1,43,45,1,10,2,28,2,1,8),_H3ce1FcmChannelIndex_Type())
...
h3ce1InterfaceTable=_H3ce1InterfaceTable_Object((1,3,6,1,4,1,43,45,1,10,2,28,3))
if mibBuilder.loadTexts:h3ce1InterfaceTable.setStatus(_A)
_H3ce1InterfaceEntry_Object=MibTableRow
h3ce1InterfaceEntry=_H3ce1InterfaceEntry_Object((1,3,6,1,4,1,43,45,1,10,2,28,3,1))
...
h3ce1ControllerIndex=_H3ce1ControllerIndex_Object((1,3,6,1,4,1,43,45,1,10,2,28,3,1,1),_H3ce1ControllerIndex_Type())
...
h3ce1TimeSlotSetTable=_H3ce1TimeSlotSetTable_Object((1,3,6,1,4,1,43,45,1,10,2,28,4))
if mibBuilder.loadTexts:h3ce1TimeSlotSetTable.setStatus(_A)
_H3ce1TimeSlotSetEntry_Object=MibTableRow
h3ce1TimeSlotSetEntry=_H3ce1TimeSlotSetEntry_Object((1,3,6,1,4,1,43,45,1,10,2,28,4,1))
...
h3ce1TimeSlotSetGroupId=_H3ce1TimeSlotSetGroupId_Object((1,3,6,1,4,1,43,45,1,10,2,28,4,1,1),_H3ce1TimeSlotSetGroupId_Type())
...
h3ce1TimeSlotSetSignalType=_H3ce1TimeSlotSetSignalType_Object((1,3,6,1,4,1,43,45,1,10,2,28,4,1,2),_H3ce1TimeSlotSetSignalType_Type())
...
h3ce1TimeSlotSetList=_H3ce1TimeSlotSetList_Object((1,3,6,1,4,1,43,45,1,10,2,28,4,1,3),_H3ce1TimeSlotSetList_Type())
