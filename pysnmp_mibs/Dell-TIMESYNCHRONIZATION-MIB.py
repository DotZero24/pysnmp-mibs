# SNMP MIB module (Dell-TIMESYNCHRONIZATION-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-TIMESYNCHRONIZATION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:09:06 2025
...
rlTimeZoneEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlTimeZoneIndex"),
)
if mibBuilder.loadTexts:
...
rlSntpNtpConfigSrvEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpNtpConfigSrvEntryType"),
)
if mibBuilder.loadTexts:
...
rlSntpBroadcastEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpBroadcastIfIndex"),
)
if mibBuilder.loadTexts:
...
rlSntpAnycastEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAnycastIfIndex"),
)
if mibBuilder.loadTexts:
...
rlSntpServerEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpServerAddress"),
)
if mibBuilder.loadTexts:
...
rlSntpAuthenticationEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAuthenticationKeyID"),
)
if mibBuilder.loadTexts:
...
rlSntpBroadcastInetEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpBroadcastInetIfIndex"),
)
if mibBuilder.loadTexts:
...
rlSntpAnycastInetEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAnycastInetIfIndex"),
)
if mibBuilder.loadTexts:
...
rlSntpServerInetEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpServerInetAddressType"),
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpServerInetAddress"),
)
if mibBuilder.loadTexts:
...
rlSntpAllServerInetEntry.setIndexNames(
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAllServerSource"),
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAllServerIfIndex"),
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAllServerPreference"),
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAllServerInetAddressType"),
    (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAllServerInetAddress"),
)
if mibBuilder.loadTexts:
