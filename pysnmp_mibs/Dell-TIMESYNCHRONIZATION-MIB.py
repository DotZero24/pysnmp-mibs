#
# PySNMP MIB module Dell-TIMESYNCHRONIZATION-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/dell/Dell-TIMESYNCHRONIZATION-MIB
...
if mibBuilder.loadTexts: rlTimeSynchronization.setOrganization('Dell')
...
rlTimeZoneEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 92, 1, 15, 1), ).setIndexNames((0, "Dell-TIMESYNCHRONIZATION-MIB", "rlTimeZoneIndex"))
...
rlSntpNtpConfigSrvEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 92, 2, 1, 16, 1), ).setIndexNames((0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpNtpConfigSrvEntryType"))
...
rlSntpBroadcastEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 92, 2, 2, 10, 1), ).setIndexNames((0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpBroadcastIfIndex"))
...
rlSntpAnycastEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 92, 2, 2, 11, 1), ).setIndexNames((0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAnycastIfIndex"))
...
rlSntpServerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 92, 2, 2, 12, 1), ).setIndexNames((0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpServerAddress"))
...
rlSntpAuthenticationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 92, 2, 2, 13, 1), ).setIndexNames((0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAuthenticationKeyID"))
...
rlSntpBroadcastInetEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 92, 2, 2, 15, 1), ).setIndexNames((0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpBroadcastInetIfIndex"))
...
rlSntpAnycastInetEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 92, 2, 2, 16, 1), ).setIndexNames((0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpAnycastInetIfIndex"))
...
rlSntpServerInetEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 92, 2, 2, 17, 1), ).setIndexNames((0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpServerInetAddressType"), (0, "Dell-TIMESYNCHRONIZATION-MIB", "rlSntpServerInetAddress"))
