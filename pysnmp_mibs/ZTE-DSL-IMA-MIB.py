...
mibBuilder.exportSymbols("ZTE-DSL-IMA-MIB", zxDslImaGroupDsx1LineCoding=zxDslImaGroupDsx1LineCoding, zte=zte, zxDslImaGroupDsx1LineType=zxDslImaGroupDsx1LineType, zxDslImaLinkId=zxDslImaLinkId, zxDslImaGroupRxFrameLength=zxDslImaGroupRxFrameLength, zxDslImaGroupSymmetry=zxDslImaGroupSymmetry, zxDslImaGroupNeTxClkMode=zxDslImaGroupNeTxClkMode, zxDslImaLinkNeTxState=zxDslImaLinkNeTxState, zxDslImaGroupFeState=zxDslImaGroupFeState, zxDslImaGroupM2SClkMode=zxDslImaGroupM2SClkMode, zxDslImaLinkFeTxState=zxDslImaLinkFeTxState, PYSNMP_MODULE_ID=zxDslImaMib, zxDslImaGroupTxFrameLength=zxDslImaGroupTxFrameLength, zxDslImaGroupActualImaVersion=zxDslImaGroupActualImaVersion, zxDslImaLinkTable=zxDslImaLinkTable, zxDslImaSlot=zxDslImaSlot, zxDslImaGroupAdminStatus=zxDslImaGroupAdminStatus, zxDslImaLinkEntry=zxDslImaLinkEntry, zxDslImaGroupTable=zxDslImaGroupTable, zxDsl=zxDsl, zxDslImaGroupDsx1TxScrambling=zxDslImaGroupDsx1TxScrambling, zxDslImaLinkNeTxAdminStatus=zxDslImaLinkNeTxAdminStatus, zxDslImaGroupEntry=zxDslImaGroupEntry, zxDslImaGroupConfImaVersion=zxDslImaGroupConfImaVersion, zxDslImaGroupDsx1TxClockSource=zxDslImaGroupDsx1TxClockSource, ImaGroupTxClkMode=ImaGroupTxClkMode, zxDslImaGroupDsx1IdleCells=zxDslImaGroupDsx1IdleCells, zxDslImaGroupIfIndex=zxDslImaGroupIfIndex, zxDslImaGroupNeState=zxDslImaGroupNeState, ImaGroupState=ImaGroupState, zxDslImaGroupDsx1RxScrambling=zxDslImaGroupDsx1RxScrambling, zxDslImaGroupRowStatus=zxDslImaGroupRowStatus, zxDslImaLinkNeRxAdminStatus=zxDslImaLinkNeRxAdminStatus, zxDslImaLinkNeRxState=zxDslImaLinkNeRxState, ImaGroupSymmetry=ImaGroupSymmetry, ImaFrameLength=ImaFrameLength, zxDslImaGroupFeTxClkMode=zxDslImaGroupFeTxClkMode, zxDslImaMib=zxDslImaMib, zxDslImaLinkFeRxState=zxDslImaLinkFeRxState, ImaLinkState=ImaLinkState, zxDslImaGroupOperstatus=zxDslImaGroupOperstatus, zxDslImaLinkGroupIfIndex=zxDslImaLinkGroupIfIndex)
