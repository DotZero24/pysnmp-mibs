# SNMP MIB module (SUPERMICRO-MPLS-HLSP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-MPLS-HLSP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:03:40 2025
...
fsMplsLSPMapTunnelEntry = _FsMplsLSPMapTunnelEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1)
)
fsMplsLSPMapTunnelEntry.setIndexNames(
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsLSPMapTunnelIndex"),
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsLSPMapTunnelInstance"),
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsLSPMapTunnelIngressLSRId"),
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsLSPMapTunnelEgressLSRId"),
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsLSPMapSubTunnelIndex"),
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsLSPMapSubTunnelInstance"),
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsLSPMapSubTunnelIngressLSRId"),
...
fsMplsLSPMapTunnelIndex = _FsMplsLSPMapTunnelIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 1),
...
fsMplsLSPMapTunnelInstance = _FsMplsLSPMapTunnelInstance_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 2),
...
fsMplsLSPMapTunnelIngressLSRId = _FsMplsLSPMapTunnelIngressLSRId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 3),
...
fsMplsLSPMapTunnelEgressLSRId = _FsMplsLSPMapTunnelEgressLSRId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 4),
...
fsMplsLSPMapSubTunnelIndex = _FsMplsLSPMapSubTunnelIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 5),
...
fsMplsLSPMapSubTunnelInstance = _FsMplsLSPMapSubTunnelInstance_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 6),
...
fsMplsLSPMapSubTunnelIngressLSRId = _FsMplsLSPMapSubTunnelIngressLSRId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 7),
...
fsMplsLSPMapSubTunnelEgressLSRId = _FsMplsLSPMapSubTunnelEgressLSRId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 8),
...
fsMplsLSPMaptunnelOperation = _FsMplsLSPMaptunnelOperation_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 9),
...
fsMplsLSPMaptunnelRowStatus = _FsMplsLSPMaptunnelRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 1, 1, 10),
...
fsMplsHLSPTable = _FsMplsHLSPTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 2)
)
if mibBuilder.loadTexts:
    fsMplsHLSPTable.setStatus("current")
_FsMplsHLSPEntry_Object = MibTableRow
fsMplsHLSPEntry = _FsMplsHLSPEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 2, 1)
)
fsMplsHLSPEntry.setIndexNames(
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsHLSPIndex"),
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsHLSPInstance"),
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsHLSPIngressLSRId"),
    (0, "SUPERMICRO-MPLS-HLSP-MIB", "fsMplsHLSPEgressLSRId"),
)
if mibBuilder.loadTexts:
...
fsMplsHLSPIndex = _FsMplsHLSPIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 2, 1, 1),
...
fsMplsHLSPInstance = _FsMplsHLSPInstance_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 2, 1, 2),
...
fsMplsHLSPIngressLSRId = _FsMplsHLSPIngressLSRId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 2, 1, 3),
...
fsMplsHLSPEgressLSRId = _FsMplsHLSPEgressLSRId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 2, 1, 4),
...
fsMplsHLSPAvailableBW = _FsMplsHLSPAvailableBW_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 2, 1, 5),
...
fsMplsHLSPNoOfStackedTunnels = _FsMplsHLSPNoOfStackedTunnels_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 58, 1, 2, 1, 6),
