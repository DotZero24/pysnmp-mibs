...
EntryValidator, TagList, PortIndex, oaOptiSwitch = mibBuilder.importSymbols("OS-COMMON-TC-MIB", "EntryValidator", "TagList", "PortIndex", "oaOptiSwitch")
...
mibBuilder.exportSymbols("OS-PROV-TAGS-MIB", osProvTagsRxTag=osProvTagsRxTag, osProvTagsConformance=osProvTagsConformance, osProvTagsTable=osProvTagsTable, osProvTags=osProvTags, osEvcNniExceptionPortAdminStatus=osEvcNniExceptionPortAdminStatus, osEvcNniExceptionPortTagsAction=osEvcNniExceptionPortTagsAction, PYSNMP_MODULE_ID=osProvTags, TagAction=TagAction, osEvcUniExceptionPortEntry=osEvcUniExceptionPortEntry, osEvcUniExceptionPortId=osEvcUniExceptionPortId, osEvcUniExceptionPortTable=osEvcUniExceptionPortTable, osEvcNniExceptionPortId=osEvcNniExceptionPortId, osProvTagsMIBCompliance=osProvTagsMIBCompliance, osEvcUniExceptionPortRxSVlans=osEvcUniExceptionPortRxSVlans, osProvTagsMIBGroups=osProvTagsMIBGroups, osEvcNniExceptionPortTable=osEvcNniExceptionPortTable, osProvTagsAction=osProvTagsAction, osProvTagsEntry=osProvTagsEntry, osProvTagsMandatoryGroup=osProvTagsMandatoryGroup, osEvcUniExceptionPortTxSVlan=osEvcUniExceptionPortTxSVlan, osEvcUniExceptionPortAdminStatus=osEvcUniExceptionPortAdminStatus, osProvTagsDir=osProvTagsDir, osProvTagsAdminStatus=osProvTagsAdminStatus, osProvTagsMIBCompliances=osProvTagsMIBCompliances, osEvcNniExceptionPortEntry=osEvcNniExceptionPortEntry, osProvTagsObjects=osProvTagsObjects)
