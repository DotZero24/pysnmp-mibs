...
swL2DevMgmt=_SwL2DevMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,1))
_SwL2DevInfo_ObjectIdentity=ObjectIdentity
swL2DevInfo=_SwL2DevInfo_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,1,1))
...
swL2DevInfoFrontPanelLedStatus=_SwL2DevInfoFrontPanelLedStatus_Object((1,3,6,1,4,1,171,11,63,9,2,1,1,5),_SwL2DevInfoFrontPanelLedStatus_Type())
...
swL2DevCtrl=_SwL2DevCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,1,2))
...
swL2DevCtrlSystemReboot=_SwL2DevCtrlSystemReboot_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,1),_SwL2DevCtrlSystemReboot_Type())
...
swL2DevCtrlSystemIP=_SwL2DevCtrlSystemIP_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,2),_SwL2DevCtrlSystemIP_Type())
...
swL2DevCtrlSubnetMask=_SwL2DevCtrlSubnetMask_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,3),_SwL2DevCtrlSubnetMask_Type())
...
swL2DevCtrlDefaultGateway=_SwL2DevCtrlDefaultGateway_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,4),_SwL2DevCtrlDefaultGateway_Type())
...
swL2DevCtrlManagementVlanId=_SwL2DevCtrlManagementVlanId_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,5),_SwL2DevCtrlManagementVlanId_Type())
...
swL2DevCtrlIGMPSnooping=_SwL2DevCtrlIGMPSnooping_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,7),_SwL2DevCtrlIGMPSnooping_Type())
...
swL2DevCtrlCleanAllStatisticCounter=_SwL2DevCtrlCleanAllStatisticCounter_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,12),_SwL2DevCtrlCleanAllStatisticCounter_Type())
...
swL2DevCtrlSnmpEnableAuthenTraps=_SwL2DevCtrlSnmpEnableAuthenTraps_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,13),_SwL2DevCtrlSnmpEnableAuthenTraps_Type())
...
swL2DevCtrlRmonState=_SwL2DevCtrlRmonState_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,16),_SwL2DevCtrlRmonState_Type())
...
swL2DevCtrlIpAutoConfig=_SwL2DevCtrlIpAutoConfig_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,17),_SwL2DevCtrlIpAutoConfig_Type())
...
swL2MACNotifyState=_SwL2MACNotifyState_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,19),_SwL2MACNotifyState_Type())
...
swL2MACNotifyHistorySize=_SwL2MACNotifyHistorySize_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,20),_SwL2MACNotifyHistorySize_Type())
...
swL2MACNotifyInterval=_SwL2MACNotifyInterval_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,21),_SwL2MACNotifyInterval_Type())
...
swL2DevCtrlLLDPState=_SwL2DevCtrlLLDPState_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,22),_SwL2DevCtrlLLDPState_Type())
...
swL2DevCtrlLLDPForwardMessageState=_SwL2DevCtrlLLDPForwardMessageState_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,23),_SwL2DevCtrlLLDPForwardMessageState_Type())
...
swL2DevCtrlAsymVlanState=_SwL2DevCtrlAsymVlanState_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,24),_SwL2DevCtrlAsymVlanState_Type())
...
swL2IGMPSnoopingMulticastVlanState=_SwL2IGMPSnoopingMulticastVlanState_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,25),_SwL2IGMPSnoopingMulticastVlanState_Type())
...
swL2DevCtrlVLANTrunkState=_SwL2DevCtrlVLANTrunkState_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,26),_SwL2DevCtrlVLANTrunkState_Type())
...
swL2DevCtrlWeb=_SwL2DevCtrlWeb_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,1,2,27))
...
swL2DevCtrlWebState=_SwL2DevCtrlWebState_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,27,1),_SwL2DevCtrlWebState_Type())
...
swL2DevCtrlTelnet=_SwL2DevCtrlTelnet_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,1,2,28))
...
swL2DevCtrlTelnetState=_SwL2DevCtrlTelnetState_Object((1,3,6,1,4,1,171,11,63,9,2,1,2,28,1),_SwL2DevCtrlTelnetState_Type())
...
swL2DevAlarm=_SwL2DevAlarm_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,1,3))
...
swL2DevAlarmNewRoot=_SwL2DevAlarmNewRoot_Object((1,3,6,1,4,1,171,11,63,9,2,1,3,1),_SwL2DevAlarmNewRoot_Type())
...
swL2DevAlarmTopologyChange=_SwL2DevAlarmTopologyChange_Object((1,3,6,1,4,1,171,11,63,9,2,1,3,2),_SwL2DevAlarmTopologyChange_Type())
...
swL2DevAlarmLinkChange=_SwL2DevAlarmLinkChange_Object((1,3,6,1,4,1,171,11,63,9,2,1,3,3),_SwL2DevAlarmLinkChange_Type())
...
swL2PortMgmt=_SwL2PortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,2))
_SwL2PortInfoTable_Object=MibTable
swL2PortInfoTable=_SwL2PortInfoTable_Object((1,3,6,1,4,1,171,11,63,9,2,2,1))
if mibBuilder.loadTexts:swL2PortInfoTable.setStatus(_A)
_SwL2PortInfoEntry_Object=MibTableRow
swL2PortInfoEntry=_SwL2PortInfoEntry_Object((1,3,6,1,4,1,171,11,63,9,2,2,1,1))
...
swL2PortInfoPortIndex=_SwL2PortInfoPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,2,1,1,1),_SwL2PortInfoPortIndex_Type())
...
swL2PortInfoMediumType=_SwL2PortInfoMediumType_Object((1,3,6,1,4,1,171,11,63,9,2,2,1,1,2),_SwL2PortInfoMediumType_Type())
...
swL2PortInfoLinkStatus=_SwL2PortInfoLinkStatus_Object((1,3,6,1,4,1,171,11,63,9,2,2,1,1,4),_SwL2PortInfoLinkStatus_Type())
...
swL2PortInfoNwayStatus=_SwL2PortInfoNwayStatus_Object((1,3,6,1,4,1,171,11,63,9,2,2,1,1,5),_SwL2PortInfoNwayStatus_Type())
...
swL2PortCtrlTable=_SwL2PortCtrlTable_Object((1,3,6,1,4,1,171,11,63,9,2,2,2))
if mibBuilder.loadTexts:swL2PortCtrlTable.setStatus(_A)
_SwL2PortCtrlEntry_Object=MibTableRow
swL2PortCtrlEntry=_SwL2PortCtrlEntry_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1))
...
swL2PortCtrlPortIndex=_SwL2PortCtrlPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,1),_SwL2PortCtrlPortIndex_Type())
...
swL2PortCtrlPortMediumType=_SwL2PortCtrlPortMediumType_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,2),_SwL2PortCtrlPortMediumType_Type())
...
swL2PortCtrlAdminState=_SwL2PortCtrlAdminState_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,3),_SwL2PortCtrlAdminState_Type())
...
swL2PortCtrlNwayState=_SwL2PortCtrlNwayState_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,4),_SwL2PortCtrlNwayState_Type())
...
swL2PortCtrlFlowCtrlState=_SwL2PortCtrlFlowCtrlState_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,5),_SwL2PortCtrlFlowCtrlState_Type())
...
swL2PortCtrlDescription=_SwL2PortCtrlDescription_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,6),_SwL2PortCtrlDescription_Type())
...
swL2PortCtrlAddressLearning=_SwL2PortCtrlAddressLearning_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,7),_SwL2PortCtrlAddressLearning_Type())
...
swL2PortCtrlMACNotifyState=_SwL2PortCtrlMACNotifyState_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,8),_SwL2PortCtrlMACNotifyState_Type())
...
swL2PortCtrlMulticastfilter=_SwL2PortCtrlMulticastfilter_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,9),_SwL2PortCtrlMulticastfilter_Type())
...
swL2PortCtrlMDIXState=_SwL2PortCtrlMDIXState_Object((1,3,6,1,4,1,171,11,63,9,2,2,2,1,10),_SwL2PortCtrlMDIXState_Type())
...
swL2PortErrTable=_SwL2PortErrTable_Object((1,3,6,1,4,1,171,11,63,9,2,2,3))
if mibBuilder.loadTexts:swL2PortErrTable.setStatus(_A)
_SwL2PortErrEntry_Object=MibTableRow
swL2PortErrEntry=_SwL2PortErrEntry_Object((1,3,6,1,4,1,171,11,63,9,2,2,3,1))
...
swL2PortErrPortIndex=_SwL2PortErrPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,2,3,1,1),_SwL2PortErrPortIndex_Type())
...
swL2PortErrPortState=_SwL2PortErrPortState_Object((1,3,6,1,4,1,171,11,63,9,2,2,3,1,2),_SwL2PortErrPortState_Type())
...
swL2PortErrPortStatus=_SwL2PortErrPortStatus_Object((1,3,6,1,4,1,171,11,63,9,2,2,3,1,3),_SwL2PortErrPortStatus_Type())
...
swL2PortErrPortReason=_SwL2PortErrPortReason_Object((1,3,6,1,4,1,171,11,63,9,2,2,3,1,4),_SwL2PortErrPortReason_Type())
...
swL2PortErrDescription=_SwL2PortErrDescription_Object((1,3,6,1,4,1,171,11,63,9,2,2,3,1,5),_SwL2PortErrDescription_Type())
...
swL2QOSMgmt=_SwL2QOSMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,3))
_SwL2QOSBandwidthControlTable_Object=MibTable
swL2QOSBandwidthControlTable=_SwL2QOSBandwidthControlTable_Object((1,3,6,1,4,1,171,11,63,9,2,3,1))
if mibBuilder.loadTexts:swL2QOSBandwidthControlTable.setStatus(_A)
_SwL2QOSBandwidthControlEntry_Object=MibTableRow
swL2QOSBandwidthControlEntry=_SwL2QOSBandwidthControlEntry_Object((1,3,6,1,4,1,171,11,63,9,2,3,1,1))
...
swL2QOSBandwidthPortIndex=_SwL2QOSBandwidthPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,3,1,1,1),_SwL2QOSBandwidthPortIndex_Type())
...
swL2QOSBandwidthRxRate=_SwL2QOSBandwidthRxRate_Object((1,3,6,1,4,1,171,11,63,9,2,3,1,1,2),_SwL2QOSBandwidthRxRate_Type())
...
swL2QOSBandwidthTxRate=_SwL2QOSBandwidthTxRate_Object((1,3,6,1,4,1,171,11,63,9,2,3,1,1,3),_SwL2QOSBandwidthTxRate_Type())
...
swL2QOSBandwidthRadiusRxRate=_SwL2QOSBandwidthRadiusRxRate_Object((1,3,6,1,4,1,171,11,63,9,2,3,1,1,4),_SwL2QOSBandwidthRadiusRxRate_Type())
...
swL2QOSBandwidthRadiusTxRate=_SwL2QOSBandwidthRadiusTxRate_Object((1,3,6,1,4,1,171,11,63,9,2,3,1,1,5),_SwL2QOSBandwidthRadiusTxRate_Type())
...
swL2QOSSchedulingTable=_SwL2QOSSchedulingTable_Object((1,3,6,1,4,1,171,11,63,9,2,3,2))
if mibBuilder.loadTexts:swL2QOSSchedulingTable.setStatus(_A)
_SwL2QOSSchedulingEntry_Object=MibTableRow
swL2QOSSchedulingEntry=_SwL2QOSSchedulingEntry_Object((1,3,6,1,4,1,171,11,63,9,2,3,2,1))
...
swL2QOSSchedulingClassIndex=_SwL2QOSSchedulingClassIndex_Object((1,3,6,1,4,1,171,11,63,9,2,3,2,1,1),_SwL2QOSSchedulingClassIndex_Type())
...
swL2QOSSchedulingMaxWeight=_SwL2QOSSchedulingMaxWeight_Object((1,3,6,1,4,1,171,11,63,9,2,3,2,1,4),_SwL2QOSSchedulingMaxWeight_Type())
...
swL2QOSSchedulingMechanism=_SwL2QOSSchedulingMechanism_Object((1,3,6,1,4,1,171,11,63,9,2,3,2,1,5),_SwL2QOSSchedulingMechanism_Type())
...
swL2QOS8021pUserPriorityTable=_SwL2QOS8021pUserPriorityTable_Object((1,3,6,1,4,1,171,11,63,9,2,3,3))
if mibBuilder.loadTexts:swL2QOS8021pUserPriorityTable.setStatus(_A)
_SwL2QOS8021pUserPriorityEntry_Object=MibTableRow
swL2QOS8021pUserPriorityEntry=_SwL2QOS8021pUserPriorityEntry_Object((1,3,6,1,4,1,171,11,63,9,2,3,3,1))
...
swL2QOS8021pUserPriorityIndex=_SwL2QOS8021pUserPriorityIndex_Object((1,3,6,1,4,1,171,11,63,9,2,3,3,1,1),_SwL2QOS8021pUserPriorityIndex_Type())
...
swL2QOS8021pUserPriorityClass=_SwL2QOS8021pUserPriorityClass_Object((1,3,6,1,4,1,171,11,63,9,2,3,3,1,2),_SwL2QOS8021pUserPriorityClass_Type())
...
swL2QOS8021pDefaultPriorityTable=_SwL2QOS8021pDefaultPriorityTable_Object((1,3,6,1,4,1,171,11,63,9,2,3,4))
...
swL2QOS8021pDefaultPriorityEntry=_SwL2QOS8021pDefaultPriorityEntry_Object((1,3,6,1,4,1,171,11,63,9,2,3,4,1))
...
swL2QOS8021pDefaultPriorityIndex=_SwL2QOS8021pDefaultPriorityIndex_Object((1,3,6,1,4,1,171,11,63,9,2,3,4,1,1),_SwL2QOS8021pDefaultPriorityIndex_Type())
...
swL2QOS8021pDefaultPriority=_SwL2QOS8021pDefaultPriority_Object((1,3,6,1,4,1,171,11,63,9,2,3,4,1,2),_SwL2QOS8021pDefaultPriority_Type())
...
swL2QOS8021pRadiusPriority=_SwL2QOS8021pRadiusPriority_Object((1,3,6,1,4,1,171,11,63,9,2,3,4,1,3),_SwL2QOS8021pRadiusPriority_Type())
...
swL2QOSSchedulingMechanismCtrl=_SwL2QOSSchedulingMechanismCtrl_Object((1,3,6,1,4,1,171,11,63,9,2,3,5),_SwL2QOSSchedulingMechanismCtrl_Type())
...
swL2TrunkMgmt=_SwL2TrunkMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,4))
_SwPortTrunkMaxEntries_Type=Integer32
_SwPortTrunkMaxEntries_Object=MibScalar
swPortTrunkMaxEntries=_SwPortTrunkMaxEntries_Object((1,3,6,1,4,1,171,11,63,9,2,4,1),_SwPortTrunkMaxEntries_Type())
...
swPortTrunkMaxPortMembers=_SwPortTrunkMaxPortMembers_Object((1,3,6,1,4,1,171,11,63,9,2,4,2),_SwPortTrunkMaxPortMembers_Type())
...
swPortTrunkTable=_SwPortTrunkTable_Object((1,3,6,1,4,1,171,11,63,9,2,4,3))
if mibBuilder.loadTexts:swPortTrunkTable.setStatus(_A)
_SwPortTrunkEntry_Object=MibTableRow
swPortTrunkEntry=_SwPortTrunkEntry_Object((1,3,6,1,4,1,171,11,63,9,2,4,3,1))
...
swPortTrunkIndex=_SwPortTrunkIndex_Object((1,3,6,1,4,1,171,11,63,9,2,4,3,1,1),_SwPortTrunkIndex_Type())
...
swPortTrunkMasterPort=_SwPortTrunkMasterPort_Object((1,3,6,1,4,1,171,11,63,9,2,4,3,1,2),_SwPortTrunkMasterPort_Type())
...
swPortTrunkPortList=_SwPortTrunkPortList_Object((1,3,6,1,4,1,171,11,63,9,2,4,3,1,3),_SwPortTrunkPortList_Type())
...
swPortTrunkType=_SwPortTrunkType_Object((1,3,6,1,4,1,171,11,63,9,2,4,3,1,4),_SwPortTrunkType_Type())
...
swPortTrunkActivePort=_SwPortTrunkActivePort_Object((1,3,6,1,4,1,171,11,63,9,2,4,3,1,5),_SwPortTrunkActivePort_Type())
...
swPortTrunkState=_SwPortTrunkState_Object((1,3,6,1,4,1,171,11,63,9,2,4,3,1,6),_SwPortTrunkState_Type())
...
swPortTrunkFloodingPort=_SwPortTrunkFloodingPort_Object((1,3,6,1,4,1,171,11,63,9,2,4,3,1,7),_SwPortTrunkFloodingPort_Type())
...
swL2TrunkAlgorithm=_SwL2TrunkAlgorithm_Object((1,3,6,1,4,1,171,11,63,9,2,4,4),_SwL2TrunkAlgorithm_Type())
...
swL2TrunkLACPPortTable=_SwL2TrunkLACPPortTable_Object((1,3,6,1,4,1,171,11,63,9,2,4,5))
if mibBuilder.loadTexts:swL2TrunkLACPPortTable.setStatus(_A)
_SwL2TrunkLACPPortEntry_Object=MibTableRow
swL2TrunkLACPPortEntry=_SwL2TrunkLACPPortEntry_Object((1,3,6,1,4,1,171,11,63,9,2,4,5,1))
...
swL2TrunkLACPPortIndex=_SwL2TrunkLACPPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,4,5,1,1),_SwL2TrunkLACPPortIndex_Type())
...
swL2TrunkLACPPortState=_SwL2TrunkLACPPortState_Object((1,3,6,1,4,1,171,11,63,9,2,4,5,1,2),_SwL2TrunkLACPPortState_Type())
...
swL2TrunkVLANTable=_SwL2TrunkVLANTable_Object((1,3,6,1,4,1,171,11,63,9,2,4,6))
if mibBuilder.loadTexts:swL2TrunkVLANTable.setStatus(_A)
_SwL2TrunkVLANEntry_Object=MibTableRow
swL2TrunkVLANEntry=_SwL2TrunkVLANEntry_Object((1,3,6,1,4,1,171,11,63,9,2,4,6,1))
...
swL2TrunkVLANPort=_SwL2TrunkVLANPort_Object((1,3,6,1,4,1,171,11,63,9,2,4,6,1,1),_SwL2TrunkVLANPort_Type())
...
swL2TrunkVLANState=_SwL2TrunkVLANState_Object((1,3,6,1,4,1,171,11,63,9,2,4,6,1,2),_SwL2TrunkVLANState_Type())
...
swPortMirrorPackage=_SwPortMirrorPackage_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,6))
_SwPortMirrorRxPortList_Type=PortList
_SwPortMirrorRxPortList_Object=MibScalar
swPortMirrorRxPortList=_SwPortMirrorRxPortList_Object((1,3,6,1,4,1,171,11,63,9,2,6,2),_SwPortMirrorRxPortList_Type())
...
swPortMirrorTxPortList=_SwPortMirrorTxPortList_Object((1,3,6,1,4,1,171,11,63,9,2,6,3),_SwPortMirrorTxPortList_Type())
...
swPortMirrorTargetPort=_SwPortMirrorTargetPort_Object((1,3,6,1,4,1,171,11,63,9,2,6,4),_SwPortMirrorTargetPort_Type())
...
swPortMirrorState=_SwPortMirrorState_Object((1,3,6,1,4,1,171,11,63,9,2,6,5),_SwPortMirrorState_Type())
...
swIGMPPackage=_SwIGMPPackage_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,7))
...
swL2IGMPMaxSupportedVlans=_SwL2IGMPMaxSupportedVlans_Object((1,3,6,1,4,1,171,11,63,9,2,7,1),_SwL2IGMPMaxSupportedVlans_Type())
...
swL2IGMPMaxIpGroupNumPerVlan=_SwL2IGMPMaxIpGroupNumPerVlan_Object((1,3,6,1,4,1,171,11,63,9,2,7,2),_SwL2IGMPMaxIpGroupNumPerVlan_Type())
...
swL2IGMPCtrlTable=_SwL2IGMPCtrlTable_Object((1,3,6,1,4,1,171,11,63,9,2,7,3))
if mibBuilder.loadTexts:swL2IGMPCtrlTable.setStatus(_A)
_SwL2IGMPCtrlEntry_Object=MibTableRow
swL2IGMPCtrlEntry=_SwL2IGMPCtrlEntry_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1))
...
swL2IGMPCtrlVid=_SwL2IGMPCtrlVid_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,1),_SwL2IGMPCtrlVid_Type())
...
swL2IGMPQueryInterval=_SwL2IGMPQueryInterval_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,2),_SwL2IGMPQueryInterval_Type())
...
swL2IGMPMaxResponseTime=_SwL2IGMPMaxResponseTime_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,3),_SwL2IGMPMaxResponseTime_Type())
...
swL2IGMPRobustness=_SwL2IGMPRobustness_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,4),_SwL2IGMPRobustness_Type())
...
swL2IGMPLastMemberQueryInterval=_SwL2IGMPLastMemberQueryInterval_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,5),_SwL2IGMPLastMemberQueryInterval_Type())
...
swL2IGMPHostTimeout=_SwL2IGMPHostTimeout_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,6),_SwL2IGMPHostTimeout_Type())
...
swL2IGMPRouteTimeout=_SwL2IGMPRouteTimeout_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,7),_SwL2IGMPRouteTimeout_Type())
...
swL2IGMPLeaveTimer=_SwL2IGMPLeaveTimer_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,8),_SwL2IGMPLeaveTimer_Type())
...
swL2IGMPQueryState=_SwL2IGMPQueryState_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,9),_SwL2IGMPQueryState_Type())
...
swL2IGMPCurrentState=_SwL2IGMPCurrentState_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,10),_SwL2IGMPCurrentState_Type())
...
swL2IGMPCtrlState=_SwL2IGMPCtrlState_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,11),_SwL2IGMPCtrlState_Type())
...
swL2IGMPFastLeave=_SwL2IGMPFastLeave_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,12),_SwL2IGMPFastLeave_Type())
...
swL2IGMPDynIPMultVlanState=_SwL2IGMPDynIPMultVlanState_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,13),_SwL2IGMPDynIPMultVlanState_Type())
...
swL2IGMPDynIPMultVlanAge=_SwL2IGMPDynIPMultVlanAge_Object((1,3,6,1,4,1,171,11,63,9,2,7,3,1,14),_SwL2IGMPDynIPMultVlanAge_Type())
...
swL2IGMPQueryInfoTable=_SwL2IGMPQueryInfoTable_Object((1,3,6,1,4,1,171,11,63,9,2,7,4))
if mibBuilder.loadTexts:swL2IGMPQueryInfoTable.setStatus(_A)
_SwL2IGMPQueryInfoEntry_Object=MibTableRow
swL2IGMPQueryInfoEntry=_SwL2IGMPQueryInfoEntry_Object((1,3,6,1,4,1,171,11,63,9,2,7,4,1))
...
swL2IGMPInfoVid=_SwL2IGMPInfoVid_Object((1,3,6,1,4,1,171,11,63,9,2,7,4,1,1),_SwL2IGMPInfoVid_Type())
...
swL2IGMPInfoQueryCount=_SwL2IGMPInfoQueryCount_Object((1,3,6,1,4,1,171,11,63,9,2,7,4,1,2),_SwL2IGMPInfoQueryCount_Type())
...
swL2IGMPInfoTxQueryCount=_SwL2IGMPInfoTxQueryCount_Object((1,3,6,1,4,1,171,11,63,9,2,7,4,1,3),_SwL2IGMPInfoTxQueryCount_Type())
...
swL2IGMPInfoTable=_SwL2IGMPInfoTable_Object((1,3,6,1,4,1,171,11,63,9,2,7,5))
if mibBuilder.loadTexts:swL2IGMPInfoTable.setStatus(_A)
_SwL2IGMPInfoEntry_Object=MibTableRow
swL2IGMPInfoEntry=_SwL2IGMPInfoEntry_Object((1,3,6,1,4,1,171,11,63,9,2,7,5,1))
...
swL2IGMPVid=_SwL2IGMPVid_Object((1,3,6,1,4,1,171,11,63,9,2,7,5,1,1),_SwL2IGMPVid_Type())
...
swL2IGMPGroupIpAddr=_SwL2IGMPGroupIpAddr_Object((1,3,6,1,4,1,171,11,63,9,2,7,5,1,2),_SwL2IGMPGroupIpAddr_Type())
...
swL2IGMPMacAddr=_SwL2IGMPMacAddr_Object((1,3,6,1,4,1,171,11,63,9,2,7,5,1,3),_SwL2IGMPMacAddr_Type())
...
swL2IGMPPortMap=_SwL2IGMPPortMap_Object((1,3,6,1,4,1,171,11,63,9,2,7,5,1,4),_SwL2IGMPPortMap_Type())
...
swL2IGMPIpGroupReportCount=_SwL2IGMPIpGroupReportCount_Object((1,3,6,1,4,1,171,11,63,9,2,7,5,1,5),_SwL2IGMPIpGroupReportCount_Type())
...
swL2IGMPRouterPortTable=_SwL2IGMPRouterPortTable_Object((1,3,6,1,4,1,171,11,63,9,2,7,6))
if mibBuilder.loadTexts:swL2IGMPRouterPortTable.setStatus(_A)
_SwL2IGMPRouterPortEntry_Object=MibTableRow
swL2IGMPRouterPortEntry=_SwL2IGMPRouterPortEntry_Object((1,3,6,1,4,1,171,11,63,9,2,7,6,1))
...
swL2IGMPRouterPortVlanid=_SwL2IGMPRouterPortVlanid_Object((1,3,6,1,4,1,171,11,63,9,2,7,6,1,1),_SwL2IGMPRouterPortVlanid_Type())
...
swL2IGMPRouterPortVlanName=_SwL2IGMPRouterPortVlanName_Object((1,3,6,1,4,1,171,11,63,9,2,7,6,1,2),_SwL2IGMPRouterPortVlanName_Type())
...
swL2IGMPRouterPortStaticPortList=_SwL2IGMPRouterPortStaticPortList_Object((1,3,6,1,4,1,171,11,63,9,2,7,6,1,3),_SwL2IGMPRouterPortStaticPortList_Type())
...
swL2IGMPRouterPortDynamicPortList=_SwL2IGMPRouterPortDynamicPortList_Object((1,3,6,1,4,1,171,11,63,9,2,7,6,1,4),_SwL2IGMPRouterPortDynamicPortList_Type())
...
swL2IGMPRouterPortForbiddenPortList=_SwL2IGMPRouterPortForbiddenPortList_Object((1,3,6,1,4,1,171,11,63,9,2,7,6,1,5),_SwL2IGMPRouterPortForbiddenPortList_Type())
...
swL2IGMPAccessAuthTable=_SwL2IGMPAccessAuthTable_Object((1,3,6,1,4,1,171,11,63,9,2,7,7))
if mibBuilder.loadTexts:swL2IGMPAccessAuthTable.setStatus(_A)
_SwL2IGMPAccessAuthEntry_Object=MibTableRow
swL2IGMPAccessAuthEntry=_SwL2IGMPAccessAuthEntry_Object((1,3,6,1,4,1,171,11,63,9,2,7,7,1))
...
swL2IGMPAccessAuthPort=_SwL2IGMPAccessAuthPort_Object((1,3,6,1,4,1,171,11,63,9,2,7,7,1,1),_SwL2IGMPAccessAuthPort_Type())
...
swL2IGMPAccessAuthState=_SwL2IGMPAccessAuthState_Object((1,3,6,1,4,1,171,11,63,9,2,7,7,1,2),_SwL2IGMPAccessAuthState_Type())
...
swL2IGMPMulticastVlanTable=_SwL2IGMPMulticastVlanTable_Object((1,3,6,1,4,1,171,11,63,9,2,7,8))
if mibBuilder.loadTexts:swL2IGMPMulticastVlanTable.setStatus(_A)
_SwL2IGMPMulticastVlanEntry_Object=MibTableRow
swL2IGMPMulticastVlanEntry=_SwL2IGMPMulticastVlanEntry_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1))
...
swL2IGMPMulticastVlanid=_SwL2IGMPMulticastVlanid_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,1),_SwL2IGMPMulticastVlanid_Type())
...
swL2IGMPMulticastVlanName=_SwL2IGMPMulticastVlanName_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,2),_SwL2IGMPMulticastVlanName_Type())
...
swL2IGMPMulticastVlanSourcePort=_SwL2IGMPMulticastVlanSourcePort_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,3),_SwL2IGMPMulticastVlanSourcePort_Type())
...
swL2IGMPMulticastVlanMemberPort=_SwL2IGMPMulticastVlanMemberPort_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,4),_SwL2IGMPMulticastVlanMemberPort_Type())
...
swL2IGMPMulticastVlanTagMemberPort=_SwL2IGMPMulticastVlanTagMemberPort_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,5),_SwL2IGMPMulticastVlanTagMemberPort_Type())
...
swL2IGMPMulticastVlanState=_SwL2IGMPMulticastVlanState_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,6),_SwL2IGMPMulticastVlanState_Type())
...
swL2IGMPMulticastVlanReplaceSourceIp=_SwL2IGMPMulticastVlanReplaceSourceIp_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,7),_SwL2IGMPMulticastVlanReplaceSourceIp_Type())
...
swL2IGMPMulticastVlanRowStatus=_SwL2IGMPMulticastVlanRowStatus_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,8),_SwL2IGMPMulticastVlanRowStatus_Type())
...
swL2IGMPMulticastVlanRemoveAllMcastAddrListAction=_SwL2IGMPMulticastVlanRemoveAllMcastAddrListAction_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,9),_SwL2IGMPMulticastVlanRemoveAllMcastAddrListAction_Type())
...
swL2IGMPMulticastVlanUntagSourcePort=_SwL2IGMPMulticastVlanUntagSourcePort_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,10),_SwL2IGMPMulticastVlanUntagSourcePort_Type())
...
swL2IGMPMulticastVlanRemapPriority=_SwL2IGMPMulticastVlanRemapPriority_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,11),_SwL2IGMPMulticastVlanRemapPriority_Type())
...
swL2IGMPMulticastVlanReplacePriority=_SwL2IGMPMulticastVlanReplacePriority_Object((1,3,6,1,4,1,171,11,63,9,2,7,8,1,12),_SwL2IGMPMulticastVlanReplacePriority_Type())
...
swL2IGMPMulticastVlanGroupTable=_SwL2IGMPMulticastVlanGroupTable_Object((1,3,6,1,4,1,171,11,63,9,2,7,9))
if mibBuilder.loadTexts:swL2IGMPMulticastVlanGroupTable.setStatus(_A)
_SwL2IGMPMulticastVlanGroupEntry_Object=MibTableRow
swL2IGMPMulticastVlanGroupEntry=_SwL2IGMPMulticastVlanGroupEntry_Object((1,3,6,1,4,1,171,11,63,9,2,7,9,1))
...
swL2IGMPMulticastVlanGroupVid=_SwL2IGMPMulticastVlanGroupVid_Object((1,3,6,1,4,1,171,11,63,9,2,7,9,1,1),_SwL2IGMPMulticastVlanGroupVid_Type())
...
swL2IGMPMulticastVlanGroupFromIp=_SwL2IGMPMulticastVlanGroupFromIp_Object((1,3,6,1,4,1,171,11,63,9,2,7,9,1,2),_SwL2IGMPMulticastVlanGroupFromIp_Type())
...
swL2IGMPMulticastVlanGroupToIp=_SwL2IGMPMulticastVlanGroupToIp_Object((1,3,6,1,4,1,171,11,63,9,2,7,9,1,3),_SwL2IGMPMulticastVlanGroupToIp_Type())
...
swL2IGMPMulticastVlanGroupStatus=_SwL2IGMPMulticastVlanGroupStatus_Object((1,3,6,1,4,1,171,11,63,9,2,7,9,1,4),_SwL2IGMPMulticastVlanGroupStatus_Type())
...
swL2IGMPv3Table=_SwL2IGMPv3Table_Object((1,3,6,1,4,1,171,11,63,9,2,7,10))
if mibBuilder.loadTexts:swL2IGMPv3Table.setStatus(_A)
_SwL2IGMPv3Entry_Object=MibTableRow
swL2IGMPv3Entry=_SwL2IGMPv3Entry_Object((1,3,6,1,4,1,171,11,63,9,2,7,10,1))
...
swL2IGMPv3SourceIPAddr=_SwL2IGMPv3SourceIPAddr_Object((1,3,6,1,4,1,171,11,63,9,2,7,10,1,1),_SwL2IGMPv3SourceIPAddr_Type())
...
swL2IGMPv3Forwarding=_SwL2IGMPv3Forwarding_Object((1,3,6,1,4,1,171,11,63,9,2,7,10,1,2),_SwL2IGMPv3Forwarding_Type())
...
swL2IGMPv3ExpireTimer=_SwL2IGMPv3ExpireTimer_Object((1,3,6,1,4,1,171,11,63,9,2,7,10,1,3),_SwL2IGMPv3ExpireTimer_Type())
...
swIGMPSnoopingGroupTable=_SwIGMPSnoopingGroupTable_Object((1,3,6,1,4,1,171,11,63,9,2,7,11))
if mibBuilder.loadTexts:swIGMPSnoopingGroupTable.setStatus(_A)
_SwIGMPSnoopingGroupEntry_Object=MibTableRow
swIGMPSnoopingGroupEntry=_SwIGMPSnoopingGroupEntry_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1))
...
swIGMPSnoopingGroupVid=_SwIGMPSnoopingGroupVid_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1,1),_SwIGMPSnoopingGroupVid_Type())
...
swIGMPSnoopingGroupGroupAddr=_SwIGMPSnoopingGroupGroupAddr_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1,2),_SwIGMPSnoopingGroupGroupAddr_Type())
...
swIGMPSnoopingGroupSourceAddr=_SwIGMPSnoopingGroupSourceAddr_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1,3),_SwIGMPSnoopingGroupSourceAddr_Type())
...
swIGMPSnoopingGroupIncludePortMap=_SwIGMPSnoopingGroupIncludePortMap_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1,4),_SwIGMPSnoopingGroupIncludePortMap_Type())
...
swIGMPSnoopingGroupExcludePortMap=_SwIGMPSnoopingGroupExcludePortMap_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1,5),_SwIGMPSnoopingGroupExcludePortMap_Type())
...
swIGMPSnoopingGroupReportCount=_SwIGMPSnoopingGroupReportCount_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1,6),_SwIGMPSnoopingGroupReportCount_Type())
...
swIGMPSnoopingGroupUpTime=_SwIGMPSnoopingGroupUpTime_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1,7),_SwIGMPSnoopingGroupUpTime_Type())
...
swIGMPSnoopingGroupExpiryTime=_SwIGMPSnoopingGroupExpiryTime_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1,8),_SwIGMPSnoopingGroupExpiryTime_Type())
...
swIGMPSnoopingGroupRouterPorts=_SwIGMPSnoopingGroupRouterPorts_Object((1,3,6,1,4,1,171,11,63,9,2,7,11,1,9),_SwIGMPSnoopingGroupRouterPorts_Type())
...
swL2IGMPDynIpMultMgmt=_SwL2IGMPDynIpMultMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,7,12))
_SwL2IGMPDynIPMultMaxEntry_Type=Integer32
_SwL2IGMPDynIPMultMaxEntry_Object=MibScalar
swL2IGMPDynIPMultMaxEntry=_SwL2IGMPDynIPMultMaxEntry_Object((1,3,6,1,4,1,171,11,63,9,2,7,12,1),_SwL2IGMPDynIPMultMaxEntry_Type())
...
swL2IGMPSnoopingClearDynIpMult=_SwL2IGMPSnoopingClearDynIpMult_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,7,12,2))
_SwL2IGMPSnoopingClearDynIpMultVID_Type=VlanId
_SwL2IGMPSnoopingClearDynIpMultVID_Object=MibScalar
swL2IGMPSnoopingClearDynIpMultVID=_SwL2IGMPSnoopingClearDynIpMultVID_Object((1,3,6,1,4,1,171,11,63,9,2,7,12,2,1),_SwL2IGMPSnoopingClearDynIpMultVID_Type())
...
swL2IGMPSnoopingClearDynIpMultIP=_SwL2IGMPSnoopingClearDynIpMultIP_Object((1,3,6,1,4,1,171,11,63,9,2,7,12,2,2),_SwL2IGMPSnoopingClearDynIpMultIP_Type())
...
swL2IGMPSnoopingClearDynIpMultAction=_SwL2IGMPSnoopingClearDynIpMultAction_Object((1,3,6,1,4,1,171,11,63,9,2,7,12,2,3),_SwL2IGMPSnoopingClearDynIpMultAction_Type())
...
swL2TrafficSegMgmt=_SwL2TrafficSegMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,12))
_SwL2TrafficSegTable_Object=MibTable
swL2TrafficSegTable=_SwL2TrafficSegTable_Object((1,3,6,1,4,1,171,11,63,9,2,12,1))
if mibBuilder.loadTexts:swL2TrafficSegTable.setStatus(_A)
_SwL2TrafficSegEntry_Object=MibTableRow
swL2TrafficSegEntry=_SwL2TrafficSegEntry_Object((1,3,6,1,4,1,171,11,63,9,2,12,1,1))
...
swL2TrafficSegPort=_SwL2TrafficSegPort_Object((1,3,6,1,4,1,171,11,63,9,2,12,1,1,1),_SwL2TrafficSegPort_Type())
...
swL2TrafficSegForwardPorts=_SwL2TrafficSegForwardPorts_Object((1,3,6,1,4,1,171,11,63,9,2,12,1,1,2),_SwL2TrafficSegForwardPorts_Type())
...
swL2PortSecurityMgmt=_SwL2PortSecurityMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,15))
_SwL2PortSecurityControlTable_Object=MibTable
swL2PortSecurityControlTable=_SwL2PortSecurityControlTable_Object((1,3,6,1,4,1,171,11,63,9,2,15,1))
if mibBuilder.loadTexts:swL2PortSecurityControlTable.setStatus(_A)
_SwL2PortSecurityControlEntry_Object=MibTableRow
swL2PortSecurityControlEntry=_SwL2PortSecurityControlEntry_Object((1,3,6,1,4,1,171,11,63,9,2,15,1,1))
...
swL2PortSecurityPortIndex=_SwL2PortSecurityPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,15,1,1,1),_SwL2PortSecurityPortIndex_Type())
...
swL2PortSecurityMaxLernAddr=_SwL2PortSecurityMaxLernAddr_Object((1,3,6,1,4,1,171,11,63,9,2,15,1,1,2),_SwL2PortSecurityMaxLernAddr_Type())
...
swL2PortSecurityMode=_SwL2PortSecurityMode_Object((1,3,6,1,4,1,171,11,63,9,2,15,1,1,3),_SwL2PortSecurityMode_Type())
...
swL2PortSecurityAdmState=_SwL2PortSecurityAdmState_Object((1,3,6,1,4,1,171,11,63,9,2,15,1,1,4),_SwL2PortSecurityAdmState_Type())
...
swL2PortSecurityTrapLogState=_SwL2PortSecurityTrapLogState_Object((1,3,6,1,4,1,171,11,63,9,2,15,2),_SwL2PortSecurityTrapLogState_Type())
...
swL2PortSecurityDelCtrl=_SwL2PortSecurityDelCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,15,3))
...
swL2PortSecurityDelVlanName=_SwL2PortSecurityDelVlanName_Object((1,3,6,1,4,1,171,11,63,9,2,15,3,1),_SwL2PortSecurityDelVlanName_Type())
...
swL2PortSecurityDelPort=_SwL2PortSecurityDelPort_Object((1,3,6,1,4,1,171,11,63,9,2,15,3,2),_SwL2PortSecurityDelPort_Type())
...
swL2PortSecurityDelMacAddress=_SwL2PortSecurityDelMacAddress_Object((1,3,6,1,4,1,171,11,63,9,2,15,3,3),_SwL2PortSecurityDelMacAddress_Type())
...
swL2PortSecurityDelActivity=_SwL2PortSecurityDelActivity_Object((1,3,6,1,4,1,171,11,63,9,2,15,3,4),_SwL2PortSecurityDelActivity_Type())
...
swL2CosMgmt=_SwL2CosMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,17))
_SwL2CosPriorityCtrl_ObjectIdentity=ObjectIdentity
swL2CosPriorityCtrl=_SwL2CosPriorityCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,17,3))
_SwL2CosPriorityTable_Object=MibTable
swL2CosPriorityTable=_SwL2CosPriorityTable_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,1))
if mibBuilder.loadTexts:swL2CosPriorityTable.setStatus(_A)
_SwL2CosPriorityEntry_Object=MibTableRow
swL2CosPriorityEntry=_SwL2CosPriorityEntry_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,1,1))
...
swL2CosPriorityPort=_SwL2CosPriorityPort_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,1,1,1),_SwL2CosPriorityPort_Type())
...
swL2CosPriorityPortPRI=_SwL2CosPriorityPortPRI_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,1,1,2),_SwL2CosPriorityPortPRI_Type())
...
swL2CosPriorityEtherPRI=_SwL2CosPriorityEtherPRI_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,1,1,3),_SwL2CosPriorityEtherPRI_Type())
...
swL2CosPriorityIpPRI=_SwL2CosPriorityIpPRI_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,1,1,4),_SwL2CosPriorityIpPRI_Type())
...
swL2CosPriorityNone=_SwL2CosPriorityNone_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,1,1,5),_SwL2CosPriorityNone_Type())
...
swL2CosPortPRITable=_SwL2CosPortPRITable_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,2))
if mibBuilder.loadTexts:swL2CosPortPRITable.setStatus(_A)
_SwL2CosPortPRIEntry_Object=MibTableRow
swL2CosPortPRIEntry=_SwL2CosPortPRIEntry_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,2,1))
...
swL2CosPortPRIIndex=_SwL2CosPortPRIIndex_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,2,1,1),_SwL2CosPortPRIIndex_Type())
...
swL2CosPortPRIClass=_SwL2CosPortPRIClass_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,2,1,2),_SwL2CosPortPRIClass_Type())
...
swL2CosMacBasePRITable=_SwL2CosMacBasePRITable_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,3))
if mibBuilder.loadTexts:swL2CosMacBasePRITable.setStatus(_A)
_SwL2CosMacBasePRIEntry_Object=MibTableRow
swL2CosMacBasePRIEntry=_SwL2CosMacBasePRIEntry_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,3,1))
...
swL2CosMacBasePRIIndex=_SwL2CosMacBasePRIIndex_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,3,1,1),_SwL2CosMacBasePRIIndex_Type())
...
swL2CosMacBasePRIClass=_SwL2CosMacBasePRIClass_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,3,1,2),_SwL2CosMacBasePRIClass_Type())
...
swL2CosTosPRITable=_SwL2CosTosPRITable_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,4))
if mibBuilder.loadTexts:swL2CosTosPRITable.setStatus(_A)
_SwL2CosTosPRIEntry_Object=MibTableRow
swL2CosTosPRIEntry=_SwL2CosTosPRIEntry_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,4,1))
...
swL2CosTosPRIIndex=_SwL2CosTosPRIIndex_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,4,1,1),_SwL2CosTosPRIIndex_Type())
...
swL2CosTosPRIClass=_SwL2CosTosPRIClass_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,4,1,2),_SwL2CosTosPRIClass_Type())
...
swL2CosDscpPRITable=_SwL2CosDscpPRITable_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,5))
if mibBuilder.loadTexts:swL2CosDscpPRITable.setStatus(_A)
_SwL2CosDscpPRIEntry_Object=MibTableRow
swL2CosDscpPRIEntry=_SwL2CosDscpPRIEntry_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,5,1))
...
swL2CosDscpPRIIndex=_SwL2CosDscpPRIIndex_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,5,1,1),_SwL2CosDscpPRIIndex_Type())
...
swL2CosDscpPRIClass=_SwL2CosDscpPRIClass_Object((1,3,6,1,4,1,171,11,63,9,2,17,3,5,1,2),_SwL2CosDscpPRIClass_Type())
...
swL2DhcpRelayMgmt=_SwL2DhcpRelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,18))
...
swL2DhcpRelayState=_SwL2DhcpRelayState_Object((1,3,6,1,4,1,171,11,63,9,2,18,1),_SwL2DhcpRelayState_Type())
...
swL2DhcpRelayHopCount=_SwL2DhcpRelayHopCount_Object((1,3,6,1,4,1,171,11,63,9,2,18,2),_SwL2DhcpRelayHopCount_Type())
...
swL2DhcpRelayTimeThreshold=_SwL2DhcpRelayTimeThreshold_Object((1,3,6,1,4,1,171,11,63,9,2,18,3),_SwL2DhcpRelayTimeThreshold_Type())
...
swL2DhcpRelayOption82State=_SwL2DhcpRelayOption82State_Object((1,3,6,1,4,1,171,11,63,9,2,18,4),_SwL2DhcpRelayOption82State_Type())
...
swL2DhcpRelayOption82Check=_SwL2DhcpRelayOption82Check_Object((1,3,6,1,4,1,171,11,63,9,2,18,5),_SwL2DhcpRelayOption82Check_Type())
...
swL2DhcpRelayOption82Policy=_SwL2DhcpRelayOption82Policy_Object((1,3,6,1,4,1,171,11,63,9,2,18,6),_SwL2DhcpRelayOption82Policy_Type())
...
swL2DhcpRelayCtrlTable=_SwL2DhcpRelayCtrlTable_Object((1,3,6,1,4,1,171,11,63,9,2,18,7))
if mibBuilder.loadTexts:swL2DhcpRelayCtrlTable.setStatus(_J)
_SwL2DhcpRelayCtrlEntry_Object=MibTableRow
swL2DhcpRelayCtrlEntry=_SwL2DhcpRelayCtrlEntry_Object((1,3,6,1,4,1,171,11,63,9,2,18,7,1))
...
swL2DhcpRelayCtrlInterfaceName=_SwL2DhcpRelayCtrlInterfaceName_Object((1,3,6,1,4,1,171,11,63,9,2,18,7,1,1),_SwL2DhcpRelayCtrlInterfaceName_Type())
...
swL2DhcpRelayCtrlServer=_SwL2DhcpRelayCtrlServer_Object((1,3,6,1,4,1,171,11,63,9,2,18,7,1,2),_SwL2DhcpRelayCtrlServer_Type())
...
swL2DhcpRelayCtrlState=_SwL2DhcpRelayCtrlState_Object((1,3,6,1,4,1,171,11,63,9,2,18,7,1,3),_SwL2DhcpRelayCtrlState_Type())
...
swL2MgmtMIBTraps=_SwL2MgmtMIBTraps_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,20))
_SwL2MgmtMIBTrapPrefix_ObjectIdentity=ObjectIdentity
swL2MgmtMIBTrapPrefix=_SwL2MgmtMIBTrapPrefix_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,20,0))
_Swl2PortSecurityBindings_ObjectIdentity=ObjectIdentity
swl2PortSecurityBindings=_Swl2PortSecurityBindings_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,20,1))
_SwL2PortSecurityViolationMac_Type=MacAddress
_SwL2PortSecurityViolationMac_Object=MibScalar
swL2PortSecurityViolationMac=_SwL2PortSecurityViolationMac_Object((1,3,6,1,4,1,171,11,63,9,2,20,1,1),_SwL2PortSecurityViolationMac_Type())
...
swl2NotificationBindings=_Swl2NotificationBindings_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,20,2))
...
swL2macNotifyInfo=_SwL2macNotifyInfo_Object((1,3,6,1,4,1,171,11,63,9,2,20,2,1),_SwL2macNotifyInfo_Type())
...
swL2FloodMacDetectedMacVid=_SwL2FloodMacDetectedMacVid_Object((1,3,6,1,4,1,171,11,63,9,2,20,2,2),_SwL2FloodMacDetectedMacVid_Type())
...
swL2FloodMacDetectedMacAddress=_SwL2FloodMacDetectedMacAddress_Object((1,3,6,1,4,1,171,11,63,9,2,20,2,3),_SwL2FloodMacDetectedMacAddress_Type())
...
swL2LoopDetectMgmt=_SwL2LoopDetectMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,21))
_SwL2LoopDetectCtrl_ObjectIdentity=ObjectIdentity
swL2LoopDetectCtrl=_SwL2LoopDetectCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,21,1))
...
swL2LoopDetectAdminState=_SwL2LoopDetectAdminState_Object((1,3,6,1,4,1,171,11,63,9,2,21,1,1),_SwL2LoopDetectAdminState_Type())
...
swL2LoopDetectInterval=_SwL2LoopDetectInterval_Object((1,3,6,1,4,1,171,11,63,9,2,21,1,2),_SwL2LoopDetectInterval_Type())
...
swL2LoopDetectRecoverTime=_SwL2LoopDetectRecoverTime_Object((1,3,6,1,4,1,171,11,63,9,2,21,1,3),_SwL2LoopDetectRecoverTime_Type())
...
swL2LoopDetectTrapMode=_SwL2LoopDetectTrapMode_Object((1,3,6,1,4,1,171,11,63,9,2,21,1,5),_SwL2LoopDetectTrapMode_Type())
...
swL2LoopDetectPortMgmt=_SwL2LoopDetectPortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,21,2))
_SwL2LoopDetectPortTable_Object=MibTable
swL2LoopDetectPortTable=_SwL2LoopDetectPortTable_Object((1,3,6,1,4,1,171,11,63,9,2,21,2,1))
if mibBuilder.loadTexts:swL2LoopDetectPortTable.setStatus(_A)
_SwL2LoopDetectPortEntry_Object=MibTableRow
swL2LoopDetectPortEntry=_SwL2LoopDetectPortEntry_Object((1,3,6,1,4,1,171,11,63,9,2,21,2,1,1))
...
swL2LoopDetectPortIndex=_SwL2LoopDetectPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,21,2,1,1,1),_SwL2LoopDetectPortIndex_Type())
...
swL2LoopDetectPortState=_SwL2LoopDetectPortState_Object((1,3,6,1,4,1,171,11,63,9,2,21,2,1,1,2),_SwL2LoopDetectPortState_Type())
...
swL2LoopDetectPortLoopStatus=_SwL2LoopDetectPortLoopStatus_Object((1,3,6,1,4,1,171,11,63,9,2,21,2,1,1,4),_SwL2LoopDetectPortLoopStatus_Type())
...
swL2MultiFilter=_SwL2MultiFilter_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,22))
_SwL2McastFilterTable_Object=MibTable
swL2McastFilterTable=_SwL2McastFilterTable_Object((1,3,6,1,4,1,171,11,63,9,2,22,2))
if mibBuilder.loadTexts:swL2McastFilterTable.setStatus(_A)
_SwL2McastFilterEntry_Object=MibTableRow
swL2McastFilterEntry=_SwL2McastFilterEntry_Object((1,3,6,1,4,1,171,11,63,9,2,22,2,1))
...
swL2McastFilterProfileIndex=_SwL2McastFilterProfileIndex_Object((1,3,6,1,4,1,171,11,63,9,2,22,2,1,1),_SwL2McastFilterProfileIndex_Type())
...
swL2McastFilterProfileName=_SwL2McastFilterProfileName_Object((1,3,6,1,4,1,171,11,63,9,2,22,2,1,2),_SwL2McastFilterProfileName_Type())
...
swL2McastFilterAddOrDelState=_SwL2McastFilterAddOrDelState_Object((1,3,6,1,4,1,171,11,63,9,2,22,2,1,3),_SwL2McastFilterAddOrDelState_Type())
...
swL2McastFilterGroupList=_SwL2McastFilterGroupList_Object((1,3,6,1,4,1,171,11,63,9,2,22,2,1,4),_SwL2McastFilterGroupList_Type())
...
swL2McastFilterStatus=_SwL2McastFilterStatus_Object((1,3,6,1,4,1,171,11,63,9,2,22,2,1,5),_SwL2McastFilterStatus_Type())
...
swL2McastFilterPortTable=_SwL2McastFilterPortTable_Object((1,3,6,1,4,1,171,11,63,9,2,22,3))
if mibBuilder.loadTexts:swL2McastFilterPortTable.setStatus(_A)
_SwL2McastFilterPortEntry_Object=MibTableRow
swL2McastFilterPortEntry=_SwL2McastFilterPortEntry_Object((1,3,6,1,4,1,171,11,63,9,2,22,3,1))
...
swL2McastFilterPortGroupPortIndex=_SwL2McastFilterPortGroupPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,22,3,1,1),_SwL2McastFilterPortGroupPortIndex_Type())
...
swL2McastFilterPortProfileAddOrDelState=_SwL2McastFilterPortProfileAddOrDelState_Object((1,3,6,1,4,1,171,11,63,9,2,22,3,1,2),_SwL2McastFilterPortProfileAddOrDelState_Type())
...
swL2McastFilterPortProfileID=_SwL2McastFilterPortProfileID_Object((1,3,6,1,4,1,171,11,63,9,2,22,3,1,3),_SwL2McastFilterPortProfileID_Type())
...
swL2McastFilterPortMaxGroupTable=_SwL2McastFilterPortMaxGroupTable_Object((1,3,6,1,4,1,171,11,63,9,2,22,4))
...
swL2McastFilterPortMaxGroupEntry=_SwL2McastFilterPortMaxGroupEntry_Object((1,3,6,1,4,1,171,11,63,9,2,22,4,1))
...
swL2McastFilterPortMaxGroupPortIndex=_SwL2McastFilterPortMaxGroupPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,22,4,1,1),_SwL2McastFilterPortMaxGroupPortIndex_Type())
...
swL2McastFilterPortMaxGroup=_SwL2McastFilterPortMaxGroup_Object((1,3,6,1,4,1,171,11,63,9,2,22,4,1,2),_SwL2McastFilterPortMaxGroup_Type())
...
swL2McastFilterPortInfoTable=_SwL2McastFilterPortInfoTable_Object((1,3,6,1,4,1,171,11,63,9,2,22,5))
if mibBuilder.loadTexts:swL2McastFilterPortInfoTable.setStatus(_A)
_SwL2McastFilterPortInfoEntry_Object=MibTableRow
swL2McastFilterPortInfoEntry=_SwL2McastFilterPortInfoEntry_Object((1,3,6,1,4,1,171,11,63,9,2,22,5,1))
...
swL2McastFilterPortInfoPortIndex=_SwL2McastFilterPortInfoPortIndex_Object((1,3,6,1,4,1,171,11,63,9,2,22,5,1,1),_SwL2McastFilterPortInfoPortIndex_Type())
...
swL2McastFilterPortInfoProfileName=_SwL2McastFilterPortInfoProfileName_Object((1,3,6,1,4,1,171,11,63,9,2,22,5,1,2),_SwL2McastFilterPortInfoProfileName_Type())
...
swL2VlanMgmt=_SwL2VlanMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,23))
_SwL2VlanAdvertisementTable_Object=MibTable
swL2VlanAdvertisementTable=_SwL2VlanAdvertisementTable_Object((1,3,6,1,4,1,171,11,63,9,2,23,1))
if mibBuilder.loadTexts:swL2VlanAdvertisementTable.setStatus(_A)
_SwL2VlanAdvertisementEntry_Object=MibTableRow
swL2VlanAdvertisementEntry=_SwL2VlanAdvertisementEntry_Object((1,3,6,1,4,1,171,11,63,9,2,23,1,1))
...
swL2VlanIndex=_SwL2VlanIndex_Object((1,3,6,1,4,1,171,11,63,9,2,23,1,1,1),_SwL2VlanIndex_Type())
...
swL2VlanName=_SwL2VlanName_Object((1,3,6,1,4,1,171,11,63,9,2,23,1,1,2),_SwL2VlanName_Type())
...
swL2VlanAdvertiseState=_SwL2VlanAdvertiseState_Object((1,3,6,1,4,1,171,11,63,9,2,23,1,1,3),_SwL2VlanAdvertiseState_Type())
...
swL2VlanMultiplyMgmt=_SwL2VlanMultiplyMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,23,2))
...
swL2VlanMultiplyVlanList=_SwL2VlanMultiplyVlanList_Object((1,3,6,1,4,1,171,11,63,9,2,23,2,1),_SwL2VlanMultiplyVlanList_Type())
...
swL2VlanMultiplyAdvertisement=_SwL2VlanMultiplyAdvertisement_Object((1,3,6,1,4,1,171,11,63,9,2,23,2,2),_SwL2VlanMultiplyAdvertisement_Type())
...
swL2VlanMultiplyPortList=_SwL2VlanMultiplyPortList_Object((1,3,6,1,4,1,171,11,63,9,2,23,2,3),_SwL2VlanMultiplyPortList_Type())
...
swL2VlanMultiplyPortListAction=_SwL2VlanMultiplyPortListAction_Object((1,3,6,1,4,1,171,11,63,9,2,23,2,4),_SwL2VlanMultiplyPortListAction_Type())
...
swL2VlanMultiplyAction=_SwL2VlanMultiplyAction_Object((1,3,6,1,4,1,171,11,63,9,2,23,2,5),_SwL2VlanMultiplyAction_Type())
...
swL2DhcpLocalRelayMgmt=_SwL2DhcpLocalRelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,24))
...
swL2DhcpLocalRelayState=_SwL2DhcpLocalRelayState_Object((1,3,6,1,4,1,171,11,63,9,2,24,1),_SwL2DhcpLocalRelayState_Type())
...
swL2DhcpLocalRelayVLANTable=_SwL2DhcpLocalRelayVLANTable_Object((1,3,6,1,4,1,171,11,63,9,2,24,2))
if mibBuilder.loadTexts:swL2DhcpLocalRelayVLANTable.setStatus(_A)
_SwL2DhcpLocalRelayVLANEntry_Object=MibTableRow
swL2DhcpLocalRelayVLANEntry=_SwL2DhcpLocalRelayVLANEntry_Object((1,3,6,1,4,1,171,11,63,9,2,24,2,1))
...
swL2DhcpLocalRelayVLANID=_SwL2DhcpLocalRelayVLANID_Object((1,3,6,1,4,1,171,11,63,9,2,24,2,1,1),_SwL2DhcpLocalRelayVLANID_Type())
...
swL2DhcpLocalRelayVLANState=_SwL2DhcpLocalRelayVLANState_Object((1,3,6,1,4,1,171,11,63,9,2,24,2,1,2),_SwL2DhcpLocalRelayVLANState_Type())
...
swL2FloodMAC=_SwL2FloodMAC_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,25))
_SwL2FloodMACMgmt_ObjectIdentity=ObjectIdentity
swL2FloodMACMgmt=_SwL2FloodMACMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,25,1))
_SwL2FloodMACGlobalSettings_ObjectIdentity=ObjectIdentity
swL2FloodMACGlobalSettings=_SwL2FloodMACGlobalSettings_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,25,1,1))
...
swL2FloodMACState=_SwL2FloodMACState_Object((1,3,6,1,4,1,171,11,63,9,2,25,1,1,1),_SwL2FloodMACState_Type())
...
swL2FloodMACLogState=_SwL2FloodMACLogState_Object((1,3,6,1,4,1,171,11,63,9,2,25,1,1,2),_SwL2FloodMACLogState_Type())
...
swL2FloodMACTrapState=_SwL2FloodMACTrapState_Object((1,3,6,1,4,1,171,11,63,9,2,25,1,1,3),_SwL2FloodMACTrapState_Type())
...
swL2FloodMACClearFDB=_SwL2FloodMACClearFDB_Object((1,3,6,1,4,1,171,11,63,9,2,25,1,1,4),_SwL2FloodMACClearFDB_Type())
...
swL2FloodMACAutoFDBCtrlTable=_SwL2FloodMACAutoFDBCtrlTable_Object((1,3,6,1,4,1,171,11,63,9,2,25,1,2))
if mibBuilder.loadTexts:swL2FloodMACAutoFDBCtrlTable.setStatus(_A)
_SwL2FloodMACAutoFDBCtrlEntry_Object=MibTableRow
swL2FloodMACAutoFDBCtrlEntry=_SwL2FloodMACAutoFDBCtrlEntry_Object((1,3,6,1,4,1,171,11,63,9,2,25,1,2,1))
...
swL2FloodMACAutoFDBIPAddress=_SwL2FloodMACAutoFDBIPAddress_Object((1,3,6,1,4,1,171,11,63,9,2,25,1,2,1,1),_SwL2FloodMACAutoFDBIPAddress_Type())
...
swL2FloodMACAutoFDBRowStatus=_SwL2FloodMACAutoFDBRowStatus_Object((1,3,6,1,4,1,171,11,63,9,2,25,1,2,1,2),_SwL2FloodMACAutoFDBRowStatus_Type())
...
swL2FloodMACInfo=_SwL2FloodMACInfo_ObjectIdentity((1,3,6,1,4,1,171,11,63,9,2,25,2))
_SwL2FloodMACFDBTable_Object=MibTable
swL2FloodMACFDBTable=_SwL2FloodMACFDBTable_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,1))
if mibBuilder.loadTexts:swL2FloodMACFDBTable.setStatus(_A)
_SwL2FloodMACFDBEntry_Object=MibTableRow
swL2FloodMACFDBEntry=_SwL2FloodMACFDBEntry_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,1,1))
...
swL2FloodMACFDBIndex=_SwL2FloodMACFDBIndex_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,1,1,1),_SwL2FloodMACFDBIndex_Type())
...
swL2FloodMACFDBVID=_SwL2FloodMACFDBVID_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,1,1,2),_SwL2FloodMACFDBVID_Type())
...
swL2FloodMACFDBMacAddress=_SwL2FloodMACFDBMacAddress_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,1,1,3),_SwL2FloodMACFDBMacAddress_Type())
...
swL2FloodMACFDBStatus=_SwL2FloodMACFDBStatus_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,1,1,4),_SwL2FloodMACFDBStatus_Type())
...
swL2FloodMACFDBTimestamp=_SwL2FloodMACFDBTimestamp_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,1,1,5),_SwL2FloodMACFDBTimestamp_Type())
...
swL2FloodMACAutoFDBTable=_SwL2FloodMACAutoFDBTable_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,2))
if mibBuilder.loadTexts:swL2FloodMACAutoFDBTable.setStatus(_A)
_SwL2FloodMACAutoFDBEntry_Object=MibTableRow
swL2FloodMACAutoFDBEntry=_SwL2FloodMACAutoFDBEntry_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,2,1))
...
swL2FloodMACAutoFDBVID=_SwL2FloodMACAutoFDBVID_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,2,1,1),_SwL2FloodMACAutoFDBVID_Type())
...
swL2FloodMACAutoFDBMacAddress=_SwL2FloodMACAutoFDBMacAddress_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,2,1,2),_SwL2FloodMACAutoFDBMacAddress_Type())
...
swL2FloodMACAutoFDBPort=_SwL2FloodMACAutoFDBPort_Object((1,3,6,1,4,1,171,11,63,9,2,25,2,2,1,3),_SwL2FloodMACAutoFDBPort_Type())
