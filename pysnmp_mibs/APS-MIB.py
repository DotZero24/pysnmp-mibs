...
# Notes
# -----
# ASN.1 source file://mibs/zhone/APS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:24:12 2025
...
apsConfigName = _ApsConfigName_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 1),
    _ApsConfigName_Type()
)
...
apsConfigRowStatus = _ApsConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 2),
...
apsConfigMode = _ApsConfigMode_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 3),
    _ApsConfigMode_Type()
)
...
apsConfigRevert = _ApsConfigRevert_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 4),
    _ApsConfigRevert_Type()
)
apsConfigRevert.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
apsConfigDirection = _ApsConfigDirection_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 5),
    _ApsConfigDirection_Type()
)
apsConfigDirection.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
apsConfigExtraTraffic = _ApsConfigExtraTraffic_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 6),
    _ApsConfigExtraTraffic_Type()
)
apsConfigExtraTraffic.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
apsConfigSdBerThreshold = _ApsConfigSdBerThreshold_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 7),
...
apsConfigSfBerThreshold = _ApsConfigSfBerThreshold_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 8),
...
apsConfigWaitToRestore = _ApsConfigWaitToRestore_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 9),
...
apsConfigCreationTime = _ApsConfigCreationTime_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 10),
...
class _ApsConfigAdminStatus_Type(Integer32):
    """Custom type apsConfigAdminStatus based on Integer32"""
    defaultValue = 2
...
_ApsConfigAdminStatus_Type.__name__ = "Integer32"
_ApsConfigAdminStatus_Object = MibTableColumn
apsConfigAdminStatus = _ApsConfigAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 1, 2, 1, 11),
    _ApsConfigAdminStatus_Type()
)
apsConfigAdminStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    apsConfigAdminStatus.setStatus("current")
_ApsStatusTable_Object = MibTable
apsStatusTable = _ApsStatusTable_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2)
)
if mibBuilder.loadTexts:
    apsStatusTable.setStatus("current")
_ApsStatusEntry_Object = MibTableRow
apsStatusEntry = _ApsStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2, 1)
)
...
apsStatusK1K2Rcv = _ApsStatusK1K2Rcv_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2, 1, 1),
...
apsStatusK1K2Trans = _ApsStatusK1K2Trans_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2, 1, 2),
...
apsStatusCurrent = _ApsStatusCurrent_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2, 1, 3),
...
apsStatusModeMismatches = _ApsStatusModeMismatches_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2, 1, 4),
...
apsStatusChannelMismatches = _ApsStatusChannelMismatches_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2, 1, 5),
...
apsStatusPSBFs = _ApsStatusPSBFs_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2, 1, 6),
...
apsStatusFEPLFs = _ApsStatusFEPLFs_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2, 1, 7),
...
apsStatusSwitchedChannel = _ApsStatusSwitchedChannel_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 2, 1, 8),
...
apsMapTable = _ApsMapTable_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 3, 2)
)
if mibBuilder.loadTexts:
    apsMapTable.setStatus("current")
_ApsMapEntry_Object = MibTableRow
apsMapEntry = _ApsMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 3, 2, 1)
)
apsMapEntry.setIndexNames(
    (0, "APS-MIB", "apsMapIfIndex"),
)
if mibBuilder.loadTexts:
    apsMapEntry.setStatus("current")
_ApsMapIfIndex_Type = InterfaceIndex
_ApsMapIfIndex_Object = MibTableColumn
apsMapIfIndex = _ApsMapIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 3, 2, 1, 1),
    _ApsMapIfIndex_Type()
)
apsMapIfIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    apsMapIfIndex.setStatus("current")
...
apsMapGroupName = _ApsMapGroupName_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 3, 2, 1, 2),
...
apsMapChanNumber = _ApsMapChanNumber_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 3, 2, 1, 3),
...
apsChanConfigGroupName = _ApsChanConfigGroupName_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 4, 1, 1),
...
apsChanConfigNumber = _ApsChanConfigNumber_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 4, 1, 2),
...
apsChanConfigRowStatus = _ApsChanConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 4, 1, 3),
    _ApsChanConfigRowStatus_Type()
)
apsChanConfigRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
apsChanConfigIfIndex = _ApsChanConfigIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 4, 1, 4),
    _ApsChanConfigIfIndex_Type()
)
apsChanConfigIfIndex.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
apsChanConfigPriority = _ApsChanConfigPriority_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 4, 1, 5),
    _ApsChanConfigPriority_Type()
)
apsChanConfigPriority.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    apsChanConfigPriority.setStatus("current")


class _ApsChanConfigAdminStatus_Type(Integer32):
    """Custom type apsChanConfigAdminStatus based on Integer32"""
    defaultValue = 2
...
_ApsChanConfigAdminStatus_Type.__name__ = "Integer32"
_ApsChanConfigAdminStatus_Object = MibTableColumn
apsChanConfigAdminStatus = _ApsChanConfigAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 4, 1, 6),
    _ApsChanConfigAdminStatus_Type()
)
apsChanConfigAdminStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    apsChanConfigAdminStatus.setStatus("current")
_ApsCommandTable_Object = MibTable
apsCommandTable = _ApsCommandTable_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 5)
)
if mibBuilder.loadTexts:
    apsCommandTable.setStatus("current")
_ApsCommandEntry_Object = MibTableRow
apsCommandEntry = _ApsCommandEntry_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 5, 1)
)
...
apsCommandSwitch = _ApsCommandSwitch_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 5, 1, 1),
...
apsCommandControl = _ApsCommandControl_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 5, 1, 2),
...
apsChanStatusCurrent = _ApsChanStatusCurrent_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 6, 1, 1),
...
apsChanStatusSignalDegrades = _ApsChanStatusSignalDegrades_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 6, 1, 2),
...
apsChanStatusSignalFailures = _ApsChanStatusSignalFailures_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 6, 1, 3),
...
apsChanStatusSwitchovers = _ApsChanStatusSwitchovers_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 6, 1, 4),
...
apsChanStatusLastSwitchover = _ApsChanStatusLastSwitchover_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 6, 1, 5),
...
apsChanStatusSwitchoverSeconds = _ApsChanStatusSwitchoverSeconds_Object(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 1, 6, 1, 6),
...
apsEventOptional = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 3, 1, 10)
)
apsEventOptional.setObjects(
...
apsCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5504, 10, 1, 1, 3, 2, 1)
)
apsCompliance.setObjects(
...
mibBuilder.exportSymbols(
    ...
    **{"ApsK1K2": ApsK1K2,
       ...
       "apsConfigAdminStatus": apsConfigAdminStatus,
       ...
       "apsChanConfigAdminStatus": apsChanConfigAdminStatus,
       ...
       "apsEventOptional": apsEventOptional,
