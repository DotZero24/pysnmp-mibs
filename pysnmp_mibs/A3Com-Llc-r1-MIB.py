# SNMP MIB module (A3Com-Llc-r1-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3Com-Llc-r1-MIB
...
llcSapAdminEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "A3Com-Llc-r1-MIB", "llcSapNumber"),
)
if mibBuilder.loadTexts:
...
llcCcAdminEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "A3Com-Llc-r1-MIB", "llcCcLSap"),
    (0, "A3Com-Llc-r1-MIB", "llcCcRSap"),
    (0, "A3Com-Llc-r1-MIB", "llcCcRMac"),
    (0, "A3Com-Llc-r1-MIB", "llcCcLMac"),
)
if mibBuilder.loadTexts:
...
ccsLlcTunnelRouterEntry.setIndexNames(
    (0, "A3Com-Llc-r1-MIB", "ccsLlcTunnelId"),
)
if mibBuilder.loadTexts:
...
ccsLlcTunnelDefaultDestEntry.setIndexNames(
    (0, "A3Com-Llc-r1-MIB", "pysmiFakeCol28"),
)
if mibBuilder.loadTexts:
...
_PysmiFakeCol28_Type = Integer32
_PysmiFakeCol28_Object = MibTableColumn
pysmiFakeCol28 = _PysmiFakeCol28_Object(
    (1, 3, 6, 1, 4, 1, 43, 2, 26, 4, 3, 1, 4294967295),
    _PysmiFakeCol28_Type()
)
pysmiFakeCol28.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    pysmiFakeCol28.setStatus("mandatory")
