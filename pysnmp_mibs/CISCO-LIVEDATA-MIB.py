...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LIVEDATA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:54 2025
...
_CldEventNotifEnable_Type.__name__ = "TruthValue"
...
ciscoLivedataMIBCompliance.setObjects(
      *(("CISCO-LIVEDATA-MIB", "cldGeneralGroup"),
        ("CISCO-LIVEDATA-MIB", "cldClusterGroup"),
        ("CISCO-LIVEDATA-MIB", "cldServicesGroup"),
        ("CISCO-LIVEDATA-MIB", "cldRptConnectionsGroup"),
        ("CISCO-LIVEDATA-MIB", "cldEventsGroup"),
        ("CISCO-LIVEDATA-MIB", "cldMIBEventGroup"))
)
if mibBuilder.loadTexts:
