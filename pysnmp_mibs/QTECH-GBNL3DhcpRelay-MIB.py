...
dhcpRelayEnableStatus=_DhcpRelayEnableStatus_Object((1,3,6,1,4,1,27514,1,2,5,5,1),_DhcpRelayEnableStatus_Type())
...
dhcpRelayDebugStatus=_DhcpRelayDebugStatus_Object((1,3,6,1,4,1,27514,1,2,5,5,2),_DhcpRelayDebugStatus_Type())
...
dhcpRelayGroupTable=_DhcpRelayGroupTable_Object((1,3,6,1,4,1,27514,1,2,5,5,3))
if mibBuilder.loadTexts:dhcpRelayGroupTable.setStatus(_A)
_DhcpRelayGroupEntry_Object=MibTableRow
dhcpRelayGroupEntry=_DhcpRelayGroupEntry_Object((1,3,6,1,4,1,27514,1,2,5,5,3,1))
...
dhcpRelaySvrGroupNo=_DhcpRelaySvrGroupNo_Object((1,3,6,1,4,1,27514,1,2,5,5,3,1,1),_DhcpRelaySvrGroupNo_Type())
...
dhcpRelayServerIp=_DhcpRelayServerIp_Object((1,3,6,1,4,1,27514,1,2,5,5,3,1,2),_DhcpRelayServerIp_Type())
...
dhcpRelayIfaceTable=_DhcpRelayIfaceTable_Object((1,3,6,1,4,1,27514,1,2,5,5,4))
if mibBuilder.loadTexts:dhcpRelayIfaceTable.setStatus(_A)
_DhcpRelayIfaceEntry_Object=MibTableRow
dhcpRelayIfaceEntry=_DhcpRelayIfaceEntry_Object((1,3,6,1,4,1,27514,1,2,5,5,4,1))
...
dhcpRelaySvrVlanIfaceNo=_DhcpRelaySvrVlanIfaceNo_Object((1,3,6,1,4,1,27514,1,2,5,5,4,1,1),_DhcpRelaySvrVlanIfaceNo_Type())
...
dhcpRelayVlanIfaceGroupNo=_DhcpRelayVlanIfaceGroupNo_Object((1,3,6,1,4,1,27514,1,2,5,5,4,1,2),_DhcpRelayVlanIfaceGroupNo_Type())
...
dhcpRelayHideServerIp=_DhcpRelayHideServerIp_Object((1,3,6,1,4,1,27514,1,2,5,5,5),_DhcpRelayHideServerIp_Type())
