# SNMP MIB module (QTECH-GBNL3DhcpRelay-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-GBNL3DhcpRelay-MIB
...
dhcpRelayGroupEntry = _DhcpRelayGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 5, 5, 3, 1)
)
dhcpRelayGroupEntry.setIndexNames(
    (0, "QTECH-GBNL3DhcpRelay-MIB", "dhcpRelaySvrGroupNo"),
)
if mibBuilder.loadTexts:
...
dhcpRelaySvrGroupNo = _DhcpRelaySvrGroupNo_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 5, 5, 3, 1, 1),
...
dhcpRelayServerIp = _DhcpRelayServerIp_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 5, 5, 3, 1, 2),
...
dhcpRelayIfaceEntry = _DhcpRelayIfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 5, 5, 4, 1)
)
dhcpRelayIfaceEntry.setIndexNames(
    (0, "QTECH-GBNL3DhcpRelay-MIB", "dhcpRelaySvrVlanIfaceNo"),
)
if mibBuilder.loadTexts:
...
dhcpRelaySvrVlanIfaceNo = _DhcpRelaySvrVlanIfaceNo_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 5, 5, 4, 1, 1),
...
dhcpRelayVlanIfaceGroupNo = _DhcpRelayVlanIfaceGroupNo_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 5, 5, 4, 1, 2),
