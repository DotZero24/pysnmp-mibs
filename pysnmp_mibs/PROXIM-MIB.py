...
mibBuilder.exportSymbols("PROXIM-MIB", radiusClientAuthStatsAccessAccepts=radiusClientAuthStatsAccessAccepts, worpSiteSurveyOperationTableIndex=worpSiteSurveyOperationTableIndex, wirelessIfWORPLinkTestProgressStatus=wirelessIfWORPLinkTestProgressStatus, worpQoS=worpQoS, dhcpServerIpPoolEndIpAddress=dhcpServerIpPoolEndIpAddress, wirelessIfDDRSMinReqSNRTableSecIndex=wirelessIfDDRSMinReqSNRTableSecIndex, wirelessIfPropertiesTableIndex=wirelessIfPropertiesTableIndex, dhcpMaxLeaseTime=dhcpMaxLeaseTime, worpQoSPIRStartPort=worpQoSPIRStartPort, sntpStatus=sntpStatus, worpSiteSurveyLocalMimoCtrlSNR1=worpSiteSurveyLocalMimoCtrlSNR1, worpSiteSurveyRemoteMimoCtrlSNR1=worpSiteSurveyRemoteMimoCtrlSNR1, wirelessQoSEDCATableAIFSN=wirelessQoSEDCATableAIFSN, sysFeatureNumOfSatellitesAllowed=sysFeatureNumOfSatellitesAllowed, dhcpRelay=dhcpRelay, wirelessIfTPC=wirelessIfTPC, worpSiteSurveyChannel=worpSiteSurveyChannel, wirelessIfWORPStatsReceiveRetries=wirelessIfWORPStatsReceiveRetries, telnetPassword=telnetPassword, ripInterfaceAuthType=ripInterfaceAuthType, wirelessIfBlacklistInfoTableIndex=wirelessIfBlacklistInfoTableIndex, natStaticPortBindLocalAddr=natStaticPortBindLocalAddr, wirelessIfBlacklistInfoTableEntry=wirelessIfBlacklistInfoTableEntry, worpQoSSFClassSchedularType=worpQoSSFClassSchedularType, dhcpServerIfTable=dhcpServerIfTable, deviceMgmt=deviceMgmt, wirelessIfWORPStatsCurrentDownlinkBandwidth=wirelessIfWORPStatsCurrentDownlinkBandwidth, wirelessIfStaStatsRxUnauthPort=wirelessIfStaStatsRxUnauthPort, qosProfileTable=qosProfileTable, qosProfileName=qosProfileName, worpSiteSurveyRemoteMimoCtrlSig2=worpSiteSurveyRemoteMimoCtrlSig2, stormMulticastThreshold=stormMulticastThreshold, syslogHostTableIndex=syslogHostTableIndex, wirelessQoSEDCATableACM=wirelessQoSEDCATableACM, radiusClientAccStatsTableIndex=radiusClientAccStatsTableIndex, vlanEthCfgTableEntry=vlanEthCfgTableEntry, httpsAccessControl=httpsAccessControl, interface=interface, ripConfigTableEntry=ripConfigTableEntry, natStaticPortBindTable=natStaticPortBindTable, tempLogReset=tempLogReset, worpIntraCellBlockingGroupID6=worpIntraCellBlockingGroupID6, mgmtSnmpV3PrivProtocol=mgmtSnmpV3PrivProtocol, wirelessSecurityCfgRekeyingInterval=wirelessSecurityCfgRekeyingInterval, wirelessIfVAPRadiusAccStatus=wirelessIfVAPRadiusAccStatus, ObjStatusActive=ObjStatusActive, worpQoSPIRPortTableEntry=worpQoSPIRPortTableEntry, worpIntraCellBlockingGroupID10=worpIntraCellBlockingGroupID10, wirelessIfWORPStatsRemotePartners=wirelessIfWORPStatsRemotePartners, igmpEth1MCastTableIndex=igmpEth1MCastTableIndex, netIpWirelessCfgTableEntry=netIpWirelessCfgTableEntry, productDescr=productDescr, wirelessIfWORPTableEntry=wirelessIfWORPTableEntry, worpQoSPIRMapDstPortIndexList=worpQoSPIRMapDstPortIndexList, qosProfileTableEntry=qosProfileTableEntry, wirelessIfChannelWaitTime=wirelessIfChannelWaitTime, dhcpServerInterfaceType=dhcpServerInterfaceType, etherProtocolFilterTableStatus=etherProtocolFilterTableStatus, dhcpRelayServerTableIndex=dhcpRelayServerTableIndex, sysFeatureFreqBand=sysFeatureFreqBand, sysLicFeatureType=sysLicFeatureType, sysFeatureBitmap=sysFeatureBitmap, wirelessIfStaStatsTxUnicastFrames=wirelessIfStaStatsTxUnicastFrames, wirelessSecurityCfgNetworkSecret=wirelessSecurityCfgNetworkSecret, wirelessQoSEDCATableCWmax=wirelessQoSEDCATableCWmax, worpQoSPIRIPSubMask=worpQoSPIRIPSubMask, wirelessIfStaStatsRSSI=wirelessIfStaStatsRSSI, wirelessIfBlacklistTimeElapsed=wirelessIfBlacklistTimeElapsed, worpQoSPIRPortTableIndex=worpQoSPIRPortTableIndex, nat=nat, wirelessIfWORPStatsActiveDownlinkMIR=wirelessIfWORPStatsActiveDownlinkMIR, ethernetIfTxModeAndSpeed=ethernetIfTxModeAndSpeed, securityGateway=securityGateway, worpQoSPIRTableIndex=worpQoSPIRTableIndex, dhcpRelayServerTable=dhcpRelayServerTable, igmpEth2MCastTableIndex=igmpEth2MCastTableIndex, worpQoSPIRVlanId=worpQoSPIRVlanId, radiusSupProfileTableIndex=radiusSupProfileTableIndex, wirelessIfVAPBroadcastSSID=wirelessIfVAPBroadcastSSID, mgmtSnmpTrapHostTableEntry=mgmtSnmpTrapHostTableEntry, tftpFileName=tftpFileName, debugLogBitMask=debugLogBitMask, VlanId=VlanId, wirelessIfWORPStatsAverageLocalSignal=wirelessIfWORPStatsAverageLocalSignal, wirelessIfWORPRadiusProfileIndex=wirelessIfWORPRadiusProfileIndex, mgmtSnmpTrapHostTableComment=mgmtSnmpTrapHostTableComment, qoSPolicyTableSecIndex=qoSPolicyTableSecIndex, mgmtSnmpV3AuthPassword=mgmtSnmpV3AuthPassword, worpQoSClassTableEntry=worpQoSClassTableEntry, staticMACAddrFilterTableIndex=staticMACAddrFilterTableIndex, radiusSupProfileMaxReTransmissions=radiusSupProfileMaxReTransmissions, wirelessIfStaStatsHTCapability=wirelessIfStaStatsHTCapability, wirelessIfStaStatsVlanTag=wirelessIfStaStatsVlanTag, stormThresholdTableEntry=stormThresholdTableEntry, filteringCtrl=filteringCtrl, wirelessIfWORPLinkTestRemoteCurSignal=wirelessIfWORPLinkTestRemoteCurSignal, debugLogSize=debugLogSize, worpQoSPIRMacTable=worpQoSPIRMacTable, wirelessIfAutoChannelSelection=wirelessIfAutoChannelSelection, worpQoSPIRMapTableEntry=worpQoSPIRMapTableEntry, stormBroadcastThreshold=stormBroadcastThreshold, deviceConfig=deviceConfig, wirelessIfAntennaGain=wirelessIfAntennaGain, wirelessIfWORPLinkTestLocalMaxSNR=wirelessIfWORPLinkTestLocalMaxSNR, sysLicFeatureTable=sysLicFeatureTable, igmpRouterPortListTable=igmpRouterPortListTable, httpAccessControl=httpAccessControl, worpQoSSFClassTableEntry=worpQoSSFClassTableEntry, wirelessIfDDRSDecrReqSNRThrld=wirelessIfDDRSDecrReqSNRThrld, igmpStats=igmpStats, radiusSupProfileTableEntryStatus=radiusSupProfileTableEntryStatus, sysTypeActiveMode=sysTypeActiveMode, radiusClientAuthStatsUnknownTypes=radiusClientAuthStatsUnknownTypes, netCfg=netCfg, worpSiteSurveyOperationTableEntry=worpSiteSurveyOperationTableEntry, wirelessIfWORPLinkTest=wirelessIfWORPLinkTest, worpIntraCellBlockingStatus=worpIntraCellBlockingStatus, wirelessIfWORPStatsReplyNoData=wirelessIfWORPStatsReplyNoData, wirelessIfBlacklistInfoTableSecIndex=wirelessIfBlacklistInfoTableSecIndex, mgmtSnmpTrapHostTable=mgmtSnmpTrapHostTable, wirelessIfWORPStatsProvisionedDownlinkMIR=wirelessIfWORPStatsProvisionedDownlinkMIR, wirelessIfVAPTableIndex=wirelessIfVAPTableIndex, staticNATModuleInitFailure=staticNATModuleInitFailure, netIpStaticRouteMetric=netIpStaticRouteMetric, sysMonitorCPUUsage=sysMonitorCPUUsage, radiusClientAuthStatsMalformedResponses=radiusClientAuthStatsMalformedResponses, Password=Password, wirelessIfWORPTableIndex=wirelessIfWORPTableIndex, etherProtocolFilteringType=etherProtocolFilteringType, igmpRouterPortAgingTimer=igmpRouterPortAgingTimer, sysFeatureOpMode=sysFeatureOpMode, ethernetIfSupportedTxMode=ethernetIfSupportedTxMode, radiusSrvProfileTableSecIndex=radiusSrvProfileTableSecIndex, syslogModuleInitFailure=syslogModuleInitFailure, igmpEth1MCastTableEntry=igmpEth1MCastTableEntry, tftpOpType=tftpOpType, mgmtAccessTableIpAddress=mgmtAccessTableIpAddress, syslogHostTableEntry=syslogHostTableEntry, wirelessIfBlacklistReason=wirelessIfBlacklistReason, DisplayString32=DisplayString32, qos=qos, wirelessIf11nPropertiesTxAntennas=wirelessIf11nPropertiesTxAntennas, worpIntraCellBlockingGroupID2=worpIntraCellBlockingGroupID2, wirelessIfSupportedChannels=wirelessIfSupportedChannels, qoSPolicyTableEntry=qoSPolicyTableEntry, wirelessIfVAPMACACLStatus=wirelessIfVAPMACACLStatus, wirelessIfStaStatsVAPNumber=wirelessIfStaStatsVAPNumber, wirelessIfWORPStaStatsLocalMimoCtrlSig1=wirelessIfWORPStaStatsLocalMimoCtrlSig1, advancedFilterProtocolName=advancedFilterProtocolName, mgmtAccessModuleInitFailure=mgmtAccessModuleInitFailure, dhcpServerStatus=dhcpServerStatus, worpQoSPIRIPComment=worpQoSPIRIPComment, worpQoSSFClassTolerableJitter=worpQoSSFClassTolerableJitter, wirelessSecurityCfgEntryStatus=wirelessSecurityCfgEntryStatus, dhcpServerIpPoolTable=dhcpServerIpPoolTable, worpQoSPIRPortTableEntryStatus=worpQoSPIRPortTableEntryStatus, sysTypeMode=sysTypeMode, mgmtSnmpTrapHostTableIndex=mgmtSnmpTrapHostTableIndex, wirelessIfStaStatsRxMulticastFrames=wirelessIfStaStatsRxMulticastFrames, worpQoSSUMACAddress=worpQoSSUMACAddress, wirelessIfWORPStaStatsLocalTxRate=wirelessIfWORPStaStatsLocalTxRate, igmpWirelessSnoopingStats=igmpWirelessSnoopingStats, macaclOperationType=macaclOperationType, accessVLANPriority=accessVLANPriority, vlanEthTrunkTableEntry=vlanEthTrunkTableEntry, highTempThreshold=highTempThreshold, tcpudpPortFilterPortNumber=tcpudpPortFilterPortNumber, wirelessIfWORPMTU=wirelessIfWORPMTU, sysTypeActiveFreqDomain=sysTypeActiveFreqDomain, mgmtAccessTableEntryStatus=mgmtAccessTableEntryStatus, dhcpServerSecondaryDNS=dhcpServerSecondaryDNS, sysInvMgmtDaughterCardAvailability=sysInvMgmtDaughterCardAvailability, dhcpRelayModuleInitFailure=dhcpRelayModuleInitFailure, sshSessions=sshSessions, worpQoSPIREndPort=worpQoSPIREndPort, wirelessIfDDRSMinReqSNRTableIndex=wirelessIfDDRSMinReqSNRTableIndex, igmpEth2MCastGrpMACAddr=igmpEth2MCastGrpMACAddr, worpQoSSFClassTableIndex=worpQoSSFClassTableIndex, systemName=systemName, radiusClientAccStatsResponses=radiusClientAccStatsResponses, wirelessIfBlacklistInfoTable=wirelessIfBlacklistInfoTable, worpSiteSurveyLocalMimoCtrlSNR3=worpSiteSurveyLocalMimoCtrlSNR3, staticMACAddrFilterWiredMACMask=staticMACAddrFilterWiredMACMask, worpQoSClassPriority=worpQoSClassPriority, wirelessIfWORPStatsPollNoData=wirelessIfWORPStatsPollNoData, traps=traps, worpIntraCellBlockingMACTableEntryStatus=worpIntraCellBlockingMACTableEntryStatus, wirelessIfWORPStatsSendRetries=wirelessIfWORPStatsSendRetries, advancedFiltering=advancedFiltering, ethernetIfPropertiesTableEntry=ethernetIfPropertiesTableEntry, wirelessIfDDRSRateBackOffInt=wirelessIfDDRSRateBackOffInt, wirelessIfPropertiesTableEntry=wirelessIfPropertiesTableEntry, ethernetIfAutoShutDown=ethernetIfAutoShutDown, wirelessIfStatsTable=wirelessIfStatsTable, sysInvMgmtComponentTable=sysInvMgmtComponentTable, wirelessIfWORPLinkTestLocalMinSignal=wirelessIfWORPLinkTestLocalMinSignal, wirelessIfWORPStatsActiveDownlinkCIR=wirelessIfWORPStatsActiveDownlinkCIR, sysInvMgmtCompName=sysInvMgmtCompName, eventLogPriority=eventLogPriority, macaclAddrTable=macaclAddrTable, wirelessIfStaStatsRxDeMicFail=wirelessIfStaStatsRxDeMicFail, wirelessIfDDRSTableIndex=wirelessIfDDRSTableIndex, stormThresholdTable=stormThresholdTable, wirelessIfWORPStaStatsPollData=wirelessIfWORPStaStatsPollData, wirelessIfStatsRxDecryptErrors=wirelessIfStatsRxDecryptErrors, netIp=netIp, worpSiteSurveyLocalChainBalStatus=worpSiteSurveyLocalChainBalStatus, netIpCfgTable=netIpCfgTable, macaclAddrTableSecIndex=macaclAddrTableSecIndex, worpIntraCellBlockingGroupID1=worpIntraCellBlockingGroupID1, siteSurvey=siteSurvey, wirelessIfWORPLinkTestRemoteMinSNR=wirelessIfWORPLinkTestRemoteMinSNR, igmpSnoopingGlobalStatus=igmpSnoopingGlobalStatus, radiusClientAccStatsTableEntry=radiusClientAccStatsTableEntry, wirelessIfStaStatsTableIndex=wirelessIfStaStatsTableIndex, mgmtSnmpV3SecurityLevel=mgmtSnmpV3SecurityLevel, igmpEth2MCastGrpAgingTimeElapsed=igmpEth2MCastGrpAgingTimeElapsed, wirelessIfStatsChain1ExtRSSI=wirelessIfStatsChain1ExtRSSI, worpSiteSurveyTableSecIndex=worpSiteSurveyTableSecIndex, wirelessIfWORPStatsProvisionedUplinkMIR=wirelessIfWORPStatsProvisionedUplinkMIR, sysLicRadioInfoTableIndex=sysLicRadioInfoTableIndex, mgmtSnmpV3AuthProtocol=mgmtSnmpV3AuthProtocol, wirelessIfDDRSMinReqSNRTable=wirelessIfDDRSMinReqSNRTable, wirelessIfStaStatsTableSecIndex=wirelessIfStaStatsTableSecIndex, wirelessInterfaceCardRadarInterferenceDetected=wirelessInterfaceCardRadarInterferenceDetected, netCfgStaticRouteStatus=netCfgStaticRouteStatus, wirelessIfWORPRegistrationTimeout=wirelessIfWORPRegistrationTimeout, telnet=telnet, worpQoSSUTableEntryStatus=worpQoSSUTableEntryStatus, syslogHostTableEntryStatus=syslogHostTableEntryStatus, wirelessIfStaStatsRxMgmtFrames=wirelessIfStaStatsRxMgmtFrames, wirelessIfWORPStaStatsAverageRemoteSNR=wirelessIfWORPStaStatsAverageRemoteSNR, worpSiteSurveyLocalMimoCtrlSNR2=worpSiteSurveyLocalMimoCtrlSNR2, wirelessIfWORPStatsProvisionedUplinkCIR=wirelessIfWORPStatsProvisionedUplinkCIR, wirelessIfWORPTable=wirelessIfWORPTable, radiusClientAccStatsMalformedResponses=radiusClientAccStatsMalformedResponses, worpQoSPIRRuleBitMask=worpQoSPIRRuleBitMask, radiusSupProfileName=radiusSupProfileName, igmpEth2MCastTableEntry=igmpEth2MCastTableEntry, worpQoSClassSFCValue=worpQoSClassSFCValue, wirelessIfStaStatsRxBeacons=wirelessIfStaStatsRxBeacons, wirelessIfDDRSMinReqSNRTableEntry=wirelessIfDDRSMinReqSNRTableEntry, imageTraps=imageTraps, igmpEth2MCastTable=igmpEth2MCastTable, wirelessIfStaStatsMACAddress=wirelessIfStaStatsMACAddress, sysMgmtFactoryReset=sysMgmtFactoryReset, worpIntraCellBlockingMACTableIndex=worpIntraCellBlockingMACTableIndex, tcpudpPortFilterTableIndex=tcpudpPortFilterTableIndex, worpQoSPIRPPPoEProtocolId=worpQoSPIRPPPoEProtocolId, radiusSrvProfileServerSharedSecret=radiusSrvProfileServerSharedSecret, wirelessIfDDRSPhyModulation=wirelessIfDDRSPhyModulation, radiusClientAccStatsPacketsDropped=radiusClientAccStatsPacketsDropped, igmpEth1MCastGrpAgingTimeElapsed=igmpEth1MCastGrpAgingTimeElapsed, qosProfileTableIndex=qosProfileTableIndex)
mibBuilder.exportSymbols("PROXIM-MIB", worpSiteSurveyMaxSatellitesAllowed=worpSiteSurveyMaxSatellitesAllowed, wirelessIfWORPStaStatsAverageLocalSNR=wirelessIfWORPStaStatsAverageLocalSNR, worpQoSPIRMapRuleName=worpQoSPIRMapRuleName, l2l3QoSDot1pPriority=l2l3QoSDot1pPriority, wirelessIfWORPStaStatsAverageLocalSignal=wirelessIfWORPStaStatsAverageLocalSignal, l2l3QoSDot1DToDot1pMappingTable=l2l3QoSDot1DToDot1pMappingTable, advancedFilterTable=advancedFilterTable, dhcpServerDefaultLeaseTime=dhcpServerDefaultLeaseTime, wirelessIf11nPropertiesTable=wirelessIf11nPropertiesTable, wirelessIfStaStatsTxAssociationFrames=wirelessIfStaStatsTxAssociationFrames, wirelessIfWORPMACACLStatus=wirelessIfWORPMACACLStatus, wirelessIfSupportedOperationalMode=wirelessIfSupportedOperationalMode, sysMgmtModulesInitFailure=sysMgmtModulesInitFailure, dhcpRelayServerTableEntryStatus=dhcpRelayServerTableEntryStatus, qosProfileEDCAProfileName=qosProfileEDCAProfileName, ripConfigStatus=ripConfigStatus, mgmtSnmp=mgmtSnmp, worpQoSPIRMapTableIndex=worpQoSPIRMapTableIndex, wirelessIfStatsRadioReTunes=wirelessIfStatsRadioReTunes, worpQoSPIRMacTableEntryStatus=worpQoSPIRMacTableEntryStatus, wirelessIfWORPStaStatsAverageLocalNoise=wirelessIfWORPStaStatsAverageLocalNoise, radiusSrvProfileType=radiusSrvProfileType, httpPassword=httpPassword, radiusClientAuthStatsTableEntry=radiusClientAuthStatsTableEntry, wirelessQoSEDCATableAPCWmin=wirelessQoSEDCATableAPCWmin, tempLoggingInterval=tempLoggingInterval, wirelessIfWORPLinkTestStatus=wirelessIfWORPLinkTestStatus, wirelessIfWORPInputBandwidthLimit=wirelessIfWORPInputBandwidthLimit, sysMgmtReboot=sysMgmtReboot, ripInterfaceAuthKey=ripInterfaceAuthKey, tftpModuleInitFailure=tftpModuleInitFailure, worpSiteSurveyLocalSignalLevel=worpSiteSurveyLocalSignalLevel, sysLicFeatureTableIndex=sysLicFeatureTableIndex, ethernetInActivityTimer=ethernetInActivityTimer, wirelessInActivityTimerInSecs=wirelessInActivityTimerInSecs, wlanModuleInitFailure=wlanModuleInitFailure, macaclProfileTable=macaclProfileTable, wirelessIfStaStatsTxAssociationFailedFrames=wirelessIfStaStatsTxAssociationFailedFrames, sntp=sntp, worpSiteSurveyLocalMimoCtrlSig2=worpSiteSurveyLocalMimoCtrlSig2, wirelessIfWORPRetries=wirelessIfWORPRetries, invalidLicenseFile=invalidLicenseFile, wirelessIfStaStatsTxEospLost=wirelessIfStaStatsTxEospLost, worpSiteSurveyRemoteChainBalStatus=worpSiteSurveyRemoteChainBalStatus, sysGPSLatitude=sysGPSLatitude, radiusClientAuthStatsTable=radiusClientAuthStatsTable, worpQoSPIRPPPoEEncapsulation=worpQoSPIRPPPoEEncapsulation, worpIntraCellBlockingGroupID9=worpIntraCellBlockingGroupID9, worpQoSSUTableEntry=worpQoSSUTableEntry, qoSPolicyType=qoSPolicyType, mgmtSnmpReadPassword=mgmtSnmpReadPassword, mgmtSnmpTrapHostTableIPAddress=mgmtSnmpTrapHostTableIPAddress, wirelessIfWORPStaStatsRemoteTxRate=wirelessIfWORPStaStatsRemoteTxRate, wirelessIf11nPropertiesAMSDUStatus=wirelessIf11nPropertiesAMSDUStatus, cpuUsageThresholdExceeded=cpuUsageThresholdExceeded, worpSiteSurveyChannelBandwidth=worpSiteSurveyChannelBandwidth, advancedFilterDirection=advancedFilterDirection, InterfaceBitmask=InterfaceBitmask, wirelessIfStaStatsTxDisassociation=wirelessIfStaStatsTxDisassociation, wirelessIfWORPBaseStationName=wirelessIfWORPBaseStationName, radiusClientAuthStatsRetransmissions=radiusClientAuthStatsRetransmissions, staticMACAddrFilterWirelessMACMask=staticMACAddrFilterWirelessMACMask, wirelessIf11nPropertiesAMSDUMaxFrameSize=wirelessIf11nPropertiesAMSDUMaxFrameSize, sysInvMgmtCompMinorVersion=sysInvMgmtCompMinorVersion, wirelessIfWORPStaStatsSendFailures=wirelessIfWORPStaStatsSendFailures, sys=sys, wirelessIfWORPRadiusMACACLStatus=wirelessIfWORPRadiusMACACLStatus, vlanEthTrunkTableIndex=vlanEthTrunkTableIndex, sntpModuleInitFailure=sntpModuleInitFailure, wirelessIfDDRSAggressiveIndex=wirelessIfDDRSAggressiveIndex, wirelessIfWORPMaxSatellites=wirelessIfWORPMaxSatellites, sysGPSLongitude=sysGPSLongitude, sysNetworkMode=sysNetworkMode, netIpCfgSubnetMask=netIpCfgSubnetMask, worpQoSSFClassMIR=worpQoSSFClassMIR, syslogHostPort=syslogHostPort, debugLog=debugLog, wirelessIfStaStatsRxProbeResp=wirelessIfStaStatsRxProbeResp, worpSiteSurveyLocalMimoCtrlSig1=worpSiteSurveyLocalMimoCtrlSig1, DisplayString55=DisplayString55, radiusClientAuthStatsResponses=radiusClientAuthStatsResponses, wirelessIfWORPStaStatsReceiveRetries=wirelessIfWORPStaStatsReceiveRetries, wirelessSecurityCfgKeyIndex=wirelessSecurityCfgKeyIndex, wirelessIfWORPStaStatsLocalMimoCtrlSNR3=wirelessIfWORPStaStatsLocalMimoCtrlSNR3, configurationAppliedSuccessfully=configurationAppliedSuccessfully, wirelessIfWORPLinkTestStatsTableEntry=wirelessIfWORPLinkTestStatsTableEntry, igmpWireless1MCastGrpAgingTimeElapsed=igmpWireless1MCastGrpAgingTimeElapsed, wirelessIfWORPStatsAuthenticationConfirms=wirelessIfWORPStatsAuthenticationConfirms, sysMonitor=sysMonitor, wirelessIfStatsRxPkts=wirelessIfStatsRxPkts, wirelessIfPropertiesRadioStatus=wirelessIfPropertiesRadioStatus, wirelessIfWORPStatsCurrentUplinkBandwidth=wirelessIfWORPStatsCurrentUplinkBandwidth, wirelessIfWORPLinkTestStatsTable=wirelessIfWORPLinkTestStatsTable, sntpPrimaryServerName=sntpPrimaryServerName, dhcpServerModuleInitFailure=dhcpServerModuleInitFailure, products=products, wirelessSecurityCfgPSK=wirelessSecurityCfgPSK, stpFrameForwardStatus=stpFrameForwardStatus, wirelessIfStaStatsAssociationID=wirelessIfStaStatsAssociationID, worpQoSClassTableIndex=worpQoSClassTableIndex, snmpModuleInitFailure=snmpModuleInitFailure, tftpOpStatus=tftpOpStatus, wirelessIfWORPStatsRegistrationRequests=wirelessIfWORPStatsRegistrationRequests, wirelessIfWORPStatsPollNoReplies=wirelessIfWORPStatsPollNoReplies, igmpRouterPortListTableIndex=igmpRouterPortListTableIndex, syslog=syslog, worpQoSPIRIPAddr=worpQoSPIRIPAddr, worpSiteSurveyRemoteSNR=worpSiteSurveyRemoteSNR, l2l3QoSDSCPPriorityUpperLimit=l2l3QoSDSCPPriorityUpperLimit, wirelessIfStaStatsAuthenAlgorithm=wirelessIfStaStatsAuthenAlgorithm, wirelessInterfaceInvalidRegDomain=wirelessInterfaceInvalidRegDomain, worpSiteSurveyOperationIfName=worpSiteSurveyOperationIfName, worpQoSPIRMapTable=worpQoSPIRMapTable, sysInvMgmt=sysInvMgmt, tftpSrvIpAddress=tftpSrvIpAddress, netCfgPrimaryDNSIpAddress=netCfgPrimaryDNSIpAddress, sysTypeSupportedFreqDomains=sysTypeSupportedFreqDomains, worpIntraCellBlockingGroupID11=worpIntraCellBlockingGroupID11, vlanStatus=vlanStatus, wirelessIfWORPStaStatsTable=wirelessIfWORPStaStatsTable, worpQoSPIREtherPriorityLow=worpQoSPIREtherPriorityLow, wirelessIfStaStatsRxDefragFailed=wirelessIfStaStatsRxDefragFailed, wirelessQoSEDCATableAPACM=wirelessQoSEDCATableAPACM, DisplayString20=DisplayString20, dhcpServerIpPoolInterface=dhcpServerIpPoolInterface, ramMemoryThresholdExceeded=ramMemoryThresholdExceeded, worpQoSSFClassTableEntryStatus=worpQoSSFClassTableEntryStatus, dhcpRelayServerTableEntry=dhcpRelayServerTableEntry, sysLicFeatureTableEntry=sysLicFeatureTableEntry, advancedFilterTableIndex=advancedFilterTableIndex, worpSiteSurveyRemoteMimoCtrlSig3=worpSiteSurveyRemoteMimoCtrlSig3, wirelessIfStaStatsRxDeauthenticationFrames=wirelessIfStaStatsRxDeauthenticationFrames, sshAccessControl=sshAccessControl, wirelessIfStaStatsTxDeAuthFrames=wirelessIfStaStatsTxDeAuthFrames, operationalTraps=operationalTraps, wirelessIfWORPStatsAverageRemoteNoise=wirelessIfWORPStatsAverageRemoteNoise, network=network, radiusSupProfileReAuthenticationPeriod=radiusSupProfileReAuthenticationPeriod, syslogPriority=syslogPriority, wirelessIfWORPStaStatsReplyNoData=wirelessIfWORPStaStatsReplyNoData, qb_8100=qb_8100, igmpRouterPortNumber=igmpRouterPortNumber, sysContactPhoneNumber=sysContactPhoneNumber, ap_8000=ap_8000, wirelessIfWORPStatsReplyMoreData=wirelessIfWORPStatsReplyMoreData, macaclTableEntryStatus=macaclTableEntryStatus, wirelessIfStaStatsTxMulticastFrames=wirelessIfStaStatsTxMulticastFrames, wirelessIfWORPStatsProvisionedDownlinkCIR=wirelessIfWORPStatsProvisionedDownlinkCIR, dhcpServerIpPoolTableIndex=dhcpServerIpPoolTableIndex, sntpFailure=sntpFailure, wirelessIfStaStatsRxDecryptFailedOnCRC=wirelessIfStaStatsRxDecryptFailedOnCRC, sntpTraps=sntpTraps, licenseModuleInitFailure=licenseModuleInitFailure, sysLocationName=sysLocationName, invalidImage=invalidImage, netCfgClearIntfStats=netCfgClearIntfStats, worpQoSDefaultClass=worpQoSDefaultClass, systemTraps=systemTraps, mgmtSnmpTrapHostTablePassword=mgmtSnmpTrapHostTablePassword, PYSNMP_MODULE_ID=proxim, syslogHostTable=syslogHostTable, worpQoSPIRTable=worpQoSPIRTable, wirelessIfStatsChain0CtlRSSI=wirelessIfStatsChain0CtlRSSI, wirelessIfDDRSRateBlackListInt=wirelessIfDDRSRateBlackListInt, worpQoSSFClassCIR=worpQoSSFClassCIR, dhcpServer=dhcpServer, dhcpServerDefaultGateway=dhcpServerDefaultGateway, sysFeatureCumulativeBandwidth=sysFeatureCumulativeBandwidth, wirelessIfVAPRadiusProfileName=wirelessIfVAPRadiusProfileName, ethernetIfAdminStatus=ethernetIfAdminStatus, wirelessIfWORPStatsSendSuccess=wirelessIfWORPStatsSendSuccess, worpSiteSurveyLocalMimoCtrlSig3=worpSiteSurveyLocalMimoCtrlSig3, sysGPSAltitude=sysGPSAltitude, worpQoSPIRIPTableEntry=worpQoSPIRIPTableEntry, wirelessIfWORPStaStatsRemoteMimoCtrlSig2=wirelessIfWORPStaStatsRemoteMimoCtrlSig2, mp_8100=mp_8100, igmpEth1MCastTable=igmpEth1MCastTable, wirelessIfAutoRateSelection=wirelessIfAutoRateSelection, stormThreshold=stormThreshold, wirelessInActivityTimer=wirelessInActivityTimer, wirelessIfStaStatsTxDisassociationCode=wirelessIfStaStatsTxDisassociationCode, wirelessIfWORPIntfMacAddress=wirelessIfWORPIntfMacAddress, l2l3QoSDot1dPriorityIPDSCP=l2l3QoSDot1dPriorityIPDSCP, etherProtocolFilterTableEntry=etherProtocolFilterTableEntry, dhcpServerIfTableComment=dhcpServerIfTableComment, worpQoSSUComment=worpQoSSUComment, syslogHostComment=syslogHostComment, igmpEth1MCastGrpIp=igmpEth1MCastGrpIp, wirelessQoSEDCATableEntry=wirelessQoSEDCATableEntry, sshPort=sshPort, wirelessIfWORPStatsReceiveFailures=wirelessIfWORPStatsReceiveFailures, wirelessIfWORPLinkTestRemoteCurNoise=wirelessIfWORPLinkTestRemoteCurNoise, worpQoSPIRIPToSLow=worpQoSPIRIPToSLow, macaclProfileTableEntry=macaclProfileTableEntry, telnetAccessControl=telnetAccessControl, igmpRouterAgingTimeElapsed=igmpRouterAgingTimeElapsed, httpPort=httpPort, wirelessQoSEDCATableTXOP=wirelessQoSEDCATableTXOP, ripConfigTable=ripConfigTable, wirelessIfSatelliteDensity=wirelessIfSatelliteDensity, macaclAddrComment=macaclAddrComment, wirelessIfStaStatsTxPower=wirelessIfStaStatsTxPower, wirelessIfWORPStaStatsLocalMimoNoise=wirelessIfWORPStaStatsLocalMimoNoise, wirelessIfWORPLinkTestLocalMaxSignal=wirelessIfWORPLinkTestLocalMaxSignal, igmpRouterPortListTableEntry=igmpRouterPortListTableEntry, sysFeatureOutBandwidth=sysFeatureOutBandwidth, radiusSrvIPADDR=radiusSrvIPADDR, wirelessIfStaStatsAssocationTime=wirelessIfStaStatsAssocationTime, genericTrap=genericTrap, igmpWireless1MCastGrpIp=igmpWireless1MCastGrpIp, worpSiteSurveyTableIndex=worpSiteSurveyTableIndex, wirelessIfWORPStatsActiveUplinkCIR=wirelessIfWORPStatsActiveUplinkCIR, worpSiteSurveyTableEntry=worpSiteSurveyTableEntry, allIntAccessControl=allIntAccessControl, wirelessInterfaceChannelChanged=wirelessInterfaceChannelChanged, radiusSrvProfileTableEntry=radiusSrvProfileTableEntry, sysMgmtCfgChangeCnt=sysMgmtCfgChangeCnt, wirelessIfStatsPhyErrors=wirelessIfStatsPhyErrors, staticMACAddrFilter=staticMACAddrFilter, wirelessIfWORPStaStatsRemoteMimoCtrlSNR2=wirelessIfWORPStaStatsRemoteMimoCtrlSNR2, sysInvMgmtCompVariant=sysInvMgmtCompVariant, worpIntraCellBlockingGroupID13=worpIntraCellBlockingGroupID13, sysutilsModuleInitFailure=sysutilsModuleInitFailure, wirelessIfDDRSDataRate=wirelessIfDDRSDataRate, ripInterfaceStatus=ripInterfaceStatus, etherProtocolFilterProtocolName=etherProtocolFilterProtocolName, etherprotocolFilterStatus=etherprotocolFilterStatus, currentUnitTemp=currentUnitTemp, filtering=filtering, apSecurity=apSecurity, invalidConfigFile=invalidConfigFile, wirelessIfWORPAutoMultiFrameBursting=wirelessIfWORPAutoMultiFrameBursting, wirelessIfStaStatsTxAuthenticationFrames=wirelessIfStaStatsTxAuthenticationFrames, WEPKeyType=WEPKeyType, wirelessIfWORPStaStatsReplyData=wirelessIfWORPStaStatsReplyData, wirelessIfWORPLinkTestStationName=wirelessIfWORPLinkTestStationName, wirelessSecurityCfgTable=wirelessSecurityCfgTable, mgmtSnmpAccessTableEntry=mgmtSnmpAccessTableEntry, wirelessSecurityCfgKey3=wirelessSecurityCfgKey3, mp_8100_cpe=mp_8100_cpe, wirelessIfVAPStatus=wirelessIfVAPStatus, ethernetIfPropertiesTableIndex=ethernetIfPropertiesTableIndex, wirelessIfStaStatsTxDeAuthCode=wirelessIfStaStatsTxDeAuthCode, wirelessIfWORPOutputBandwidthLimit=wirelessIfWORPOutputBandwidthLimit, wirelessIfWORPStaStatsRemoteMimoCtrlSNR3=wirelessIfWORPStaStatsRemoteMimoCtrlSNR3, wirelessIfStatsChain0ExtRSSI=wirelessIfStatsChain0ExtRSSI, worpIntraCellBlockingGroupID7=worpIntraCellBlockingGroupID7, worpIntraCellBlockingGroupName=worpIntraCellBlockingGroupName, wirelessSecurityCfgTableIndex=wirelessSecurityCfgTableIndex, securityGatewayMacAddress=securityGatewayMacAddress, sysTypeRadioIfIndex=sysTypeRadioIfIndex, qoSPolicyTableEntryStatus=qoSPolicyTableEntryStatus, mgmtVLANIdentifier=mgmtVLANIdentifier, wirelessIfStaStatsTxRate=wirelessIfStaStatsTxRate)
mibBuilder.exportSymbols("PROXIM-MIB", wirelessIfWORPLinkTestRemoteMaxSignal=wirelessIfWORPLinkTestRemoteMaxSignal, radiusSrvNotResponding=radiusSrvNotResponding, routingModuleInitFailure=routingModuleInitFailure, sysLicRadioInfoTableEntry=sysLicRadioInfoTableEntry, staticMACAddrFilterTableEntry=staticMACAddrFilterTableEntry, wirelessIfWORPStaStatsReceiveSuccess=wirelessIfWORPStaStatsReceiveSuccess, wirelessIfWORPStatsRegistrationAttempts=wirelessIfWORPStatsRegistrationAttempts, wirelessQoSEDCATableAPAIFSN=wirelessQoSEDCATableAPAIFSN, mgmtAccessControl=mgmtAccessControl, wirelessIfDDRSDefDataRate=wirelessIfDDRSDefDataRate, etherProtocolFilterTable=etherProtocolFilterTable, worpSiteSurveyLocalSNR=worpSiteSurveyLocalSNR, natStaticPortBindTableEntryStatus=natStaticPortBindTableEntryStatus, wirelessIfStatsChain2CtlRSSI=wirelessIfStatsChain2CtlRSSI, vlanMode=vlanMode, wirelessIfWORPNetworkName=wirelessIfWORPNetworkName, wirelessSecurityCfgdot1xWepKeyLength=wirelessSecurityCfgdot1xWepKeyLength, wirelessIfDTIM=wirelessIfDTIM, tftpFileType=tftpFileType, radiusSrvProfileTableEntryStatus=radiusSrvProfileTableEntryStatus, worpIntraCellBlockingGroupTableIndex=worpIntraCellBlockingGroupTableIndex, netIpCfgTableIndex=netIpCfgTableIndex, ripInterfaceVersionNum=ripInterfaceVersionNum, wirelessIfWORPStaStatsTableIndex=wirelessIfWORPStaStatsTableIndex, radiusClientAuthStatsPacketsDropped=radiusClientAuthStatsPacketsDropped, wirelessIfDDRSIncrReqSNRThrld=wirelessIfDDRSIncrReqSNRThrld, wirelessSecurityCfgTableEntry=wirelessSecurityCfgTableEntry, radiusClientAccStatsTimeouts=radiusClientAccStatsTimeouts, sysFeatureCtrlID=sysFeatureCtrlID, worpSiteSurveyRemoteMimoCtrlSig1=worpSiteSurveyRemoteMimoCtrlSig1, sysFeatureNumRadios=sysFeatureNumRadios, netIpStaticRouteTableEntry=netIpStaticRouteTableEntry, wirelessIfStaStatsState=wirelessIfStaStatsState, wirelessIfWORPStatsBaseStationAnnounces=wirelessIfWORPStatsBaseStationAnnounces, wirelessIfStatsChain2ExtRSSI=wirelessIfStatsChain2ExtRSSI, staticMACAddrFilterTableEntryStatus=staticMACAddrFilterTableEntryStatus, wirelessIfDDRSIncrReTxPercentThrld=wirelessIfDDRSIncrReTxPercentThrld, worpQoSL2BroadcastClass=worpQoSL2BroadcastClass, wirelessIfWORPStaStatsSatelliteName=wirelessIfWORPStaStatsSatelliteName, dhcpServerPrimaryDNS=dhcpServerPrimaryDNS, wirelessIfStaStats=wirelessIfStaStats, worpQoSPIRPortTable=worpQoSPIRPortTable, wirelessQoSEDCATableSecIndex=wirelessQoSEDCATableSecIndex, radiusSupProfileMsgResponseTime=radiusSupProfileMsgResponseTime, wirelessIfWORPStaStatsRequestForService=wirelessIfWORPStaStatsRequestForService, wirelessIfWORPStaStatsSendRetries=wirelessIfWORPStaStatsSendRetries, wirelessIfDDRSDecrReTxPercentThrld=wirelessIfDDRSDecrReTxPercentThrld, ethVLANTrunkId=ethVLANTrunkId, intraBSSFiltering=intraBSSFiltering, igmpEthernetSnoopingStats=igmpEthernetSnoopingStats, sysTypeTable=sysTypeTable, wirelessIfWORPLinkTestLocalMinSNR=wirelessIfWORPLinkTestLocalMinSNR, wirelessIfDDRSTableEntry=wirelessIfDDRSTableEntry, macaclAddrTableEntry=macaclAddrTableEntry, netIpCfgIPAddress=netIpCfgIPAddress, netIpStaticRouteTableEntryStatus=netIpStaticRouteTableEntryStatus, vlanModuleInitFailure=vlanModuleInitFailure, worpSiteSurveyBaseBridgePort=worpSiteSurveyBaseBridgePort, telnetPort=telnetPort, ssh=ssh, netIpWirelessCfgTableIndex=netIpWirelessCfgTableIndex, vlanEthCfgTable=vlanEthCfgTable, worpQoSSFClassDirection=worpQoSSFClassDirection, dhcpServerIfTableEntryStatus=dhcpServerIfTableEntryStatus, wirelessIfWORPStaStatsSendSuccess=wirelessIfWORPStaStatsSendSuccess, wirelessIfVAPBSSID=wirelessIfVAPBSSID, wirelessIfStaStatsRxWepFail=wirelessIfStaStatsRxWepFail, accessVLANId=accessVLANId, worpQoSSFClassName=worpQoSSFClassName, wirelessIfStaStatsRxNoPrivacy=wirelessIfStaStatsRxNoPrivacy, wirelessIfWORPSecurityProfileIndex=wirelessIfWORPSecurityProfileIndex, worpSiteSurvey=worpSiteSurvey, wirelessIfWORPSupportedTxRate=wirelessIfWORPSupportedTxRate, wirelessSecurityCfgKey4=wirelessSecurityCfgKey4, natStaticPortBindTableIndex=natStaticPortBindTableIndex, vlanEthCfgTableIndex=vlanEthCfgTableIndex, wirelessIfBlacklistedChannelNum=wirelessIfBlacklistedChannelNum, dhcpServerIpPoolTableEntry=dhcpServerIpPoolTableEntry, wirelessQoSEDCATable=wirelessQoSEDCATable, tcpudpPortFilterTable=tcpudpPortFilterTable, wirelessIfWORPLinkTestMACAddress=wirelessIfWORPLinkTestMACAddress, wirelessIfWORPLinkTestIdleTimeout=wirelessIfWORPLinkTestIdleTimeout, wirelessIfWORPStatsPollData=wirelessIfWORPStatsPollData, qoSPolicyTable=qoSPolicyTable, wirelessIfWORPSleepMode=wirelessIfWORPSleepMode, wirelessIfPropertiesTable=wirelessIfPropertiesTable, worpIntraCellBlockingGroupID12=worpIntraCellBlockingGroupID12, radiusClientAccStatsTableSecIndex=radiusClientAccStatsTableSecIndex, wirelessIfSupportedChannelBandwidth=wirelessIfSupportedChannelBandwidth, tcpudpPortFilterTableEntryStatus=tcpudpPortFilterTableEntryStatus, wirelessIfStaStatsTable=wirelessIfStaStatsTable, radiusClientAccStatsRequests=radiusClientAccStatsRequests, wirelessIf11nPropertiesRxAntennas=wirelessIf11nPropertiesRxAntennas, radiusClientAccStatsRetransmissions=radiusClientAccStatsRetransmissions, masterAgentExited=masterAgentExited, ripConfigTableIndex=ripConfigTableIndex, wirelessQoSEDCATableProfileName=wirelessQoSEDCATableProfileName, ethernetIfSupportedModes=ethernetIfSupportedModes, wirelessIfStaStatsTxBytes=wirelessIfStaStatsTxBytes, wirelessIfVAPRTSThreshold=wirelessIfVAPRTSThreshold, syslogStatus=syslogStatus, objects=objects, worpQoSPIRMacAddr=worpQoSPIRMacAddr, tftp=tftp, tcpudpPortFilterProtocolName=tcpudpPortFilterProtocolName, wirelessIf11nPropertiesAMPDUMaxNumFrames=wirelessIf11nPropertiesAMPDUMaxNumFrames, l2l3QoSDot1dPriority=l2l3QoSDot1dPriority, wirelessIfWORPStaStatsLocalMimoCtrlSig2=wirelessIfWORPStaStatsLocalMimoCtrlSig2, worpSiteSurveyOperationTable=worpSiteSurveyOperationTable, worpQoSSFClassTrafficPriority=worpQoSSFClassTrafficPriority, worpIntraCellBlockingMACAddress=worpIntraCellBlockingMACAddress, wirelessIfVAPVLANPriority=wirelessIfVAPVLANPriority, dhcpServerIpPoolTableEntryStatus=dhcpServerIpPoolTableEntryStatus, tcpudpPortFilterPortType=tcpudpPortFilterPortType, wirelessIfWORPLinkTestRemoteMinSignal=wirelessIfWORPLinkTestRemoteMinSignal, wirelessIfWORPLinkTestLocalCurSNR=wirelessIfWORPLinkTestLocalCurSNR, dhcpServerNetMask=dhcpServerNetMask, worpQoSPIRMapTableIndexVal=worpQoSPIRMapTableIndexVal, vlanEthTrunkTableEntryStatus=vlanEthTrunkTableEntryStatus, worpQoSSFClassTable=worpQoSSFClassTable, wirelessIfStaStatsFrequency=wirelessIfStaStatsFrequency, worpSiteSurveyLocalMimoNoise=worpSiteSurveyLocalMimoNoise, sysFeatureNumEtherIf=sysFeatureNumEtherIf, imageDownloadFailed=imageDownloadFailed, wirelessIfVAPType=wirelessIfVAPType, proxim=proxim, sysInvMgmtCompMajorVersion=sysInvMgmtCompMajorVersion, qoSPolicyTableIndex=qoSPolicyTableIndex, wirelessIfWORPStaStatsMacAddress=wirelessIfWORPStaStatsMacAddress, wirelessIfWORPStatsTableIndex=wirelessIfWORPStatsTableIndex, wirelessIfWORPLinkTestRemoteMinNoise=wirelessIfWORPLinkTestRemoteMinNoise, ethernetIfPropertiesTable=ethernetIfPropertiesTable, worpQoSClassSFCTableIndex=worpQoSClassSFCTableIndex, worpQoSPIRIPToSHigh=worpQoSPIRIPToSHigh, worpQoSPIREtherPriorityHigh=worpQoSPIREtherPriorityHigh, wirelessIfStaStatsRxDupFrames=wirelessIfStaStatsRxDupFrames, wirelessIfCellSize=wirelessIfCellSize, eventlog=eventlog, wirelessIfOperationalMode=wirelessIfOperationalMode, wirelessIfStatsTableEntry=wirelessIfStatsTableEntry, igmpWireless1MCastGrpMACAddr=igmpWireless1MCastGrpMACAddr, DisplayString80=DisplayString80, wirelessQoS=wirelessQoS, radius=radius, macaclProfileTableIndex=macaclProfileTableIndex, securityGatewayStatus=securityGatewayStatus, eventLogReset=eventLogReset, sysMgmtCfgErrorMsg=sysMgmtCfgErrorMsg, netIpWirelessCfgIPAddress=netIpWirelessCfgIPAddress, worpSiteSurveyChannelRxRate=worpSiteSurveyChannelRxRate, sysCountryCode=sysCountryCode, radiusClientAuthStatsRequests=radiusClientAuthStatsRequests, ethernetIfMACAddress=ethernetIfMACAddress, worpSiteSurveyRemoteSignalLevel=worpSiteSurveyRemoteSignalLevel, wirelessIf=wirelessIf, wirelessIf11nPropertiesSupportedRxAntennas=wirelessIf11nPropertiesSupportedRxAntennas, worpQoSPIRPortComment=worpQoSPIRPortComment, radiusClientAuthStatsBadAuthenticators=radiusClientAuthStatsBadAuthenticators, flashModuleInitFailure=flashModuleInitFailure, flashMemoryThresholdExceeded=flashMemoryThresholdExceeded, wirelessIfVAPFragmentationThreshold=wirelessIfVAPFragmentationThreshold, wirelessIfStaStatsRxDisassociationFrames=wirelessIfStaStatsRxDisassociationFrames, macaclAddrTableIndex=macaclAddrTableIndex, radiusClientAuthStatsRoundTripTime=radiusClientAuthStatsRoundTripTime, radiusClientAuthStatsTableSecIndex=radiusClientAuthStatsTableSecIndex, wirelessQoSEDCATableAPTXOP=wirelessQoSEDCATableAPTXOP, lowTempThreshold=lowTempThreshold, igmpMembershipAgingTimer=igmpMembershipAgingTimer, worpQoSPIRIPTableEntryStatus=worpQoSPIRIPTableEntryStatus, dhcpServerIfTableEntry=dhcpServerIfTableEntry, wirelessIfWORPStaStatsReceiveFailures=wirelessIfWORPStaStatsReceiveFailures, untaggedFrames=untaggedFrames, telnetSessions=telnetSessions, l2l3QoSDot1DToIPDSCPMappingTable=l2l3QoSDot1DToIPDSCPMappingTable, l2l3QoSDot1DToDot1pMappingTableIndex=l2l3QoSDot1DToDot1pMappingTableIndex, wirelessIfWORPLinkTestLocalMinNoise=wirelessIfWORPLinkTestLocalMinNoise, worpIntraCellBlockingGroupID8=worpIntraCellBlockingGroupID8, wirelessIfWORPSuperPacketing=wirelessIfWORPSuperPacketing, radiusClientAccStatsRoundTripTime=radiusClientAccStatsRoundTripTime, worpQoSSUTableIndex=worpQoSSUTableIndex, snmpAccessControl=snmpAccessControl, staticMACAddrFilterWiredMACAddress=staticMACAddrFilterWiredMACAddress, worpIntraCellBlocking=worpIntraCellBlocking, sntpTimeZone=sntpTimeZone, natPortBindingStatus=natPortBindingStatus, wirelessSecurityCfgprofileName=wirelessSecurityCfgprofileName, mgmtSnmpV3PrivPassword=mgmtSnmpV3PrivPassword, sysLicRadioAntennaType=sysLicRadioAntennaType, wirelessIfStatsTxBytes=wirelessIfStatsTxBytes, worpSiteSurveyLocalTxRate=worpSiteSurveyLocalTxRate, worpQoSClassTable=worpQoSClassTable, worpQoSSUQoSClassIndex=worpQoSSUQoSClassIndex, mgmtSnmpAccessTable=mgmtSnmpAccessTable, ethernetIf=ethernetIf, natStaticPortBindPortType=natStaticPortBindPortType, wirelessIf11nPropertiesNumOfSpatialStreams=wirelessIf11nPropertiesNumOfSpatialStreams, sysMonitorRAMUsage=sysMonitorRAMUsage, systemTempReachedLimits=systemTempReachedLimits, wirelessIfWORPStaStatsLocalMimoCtrlSig3=wirelessIfWORPStaStatsLocalMimoCtrlSig3, V3Password=V3Password, mgmtSnmpVersion=mgmtSnmpVersion, wirelessIfVAPQoSProfileName=wirelessIfVAPQoSProfileName, worpSiteSurveyRemoteTxRate=worpSiteSurveyRemoteTxRate, ObjStatus=ObjStatus, wirelessIf11nPropertiesTableIndex=wirelessIf11nPropertiesTableIndex, wirelessIfVAPVLANID=wirelessIfVAPVLANID, protocolFilter=protocolFilter, qoSPolicyTablePolicyName=qoSPolicyTablePolicyName, netIpWirelessCfgTable=netIpWirelessCfgTable, wirelessIfWORPStatsAverageRemoteSignal=wirelessIfWORPStatsAverageRemoteSignal, wirelessIfStatsCombinedRSSI=wirelessIfStatsCombinedRSSI, wirelessIfDDRSStatus=wirelessIfDDRSStatus, radiusMon=radiusMon, worpIntraCellBlockingGroupTableEntry=worpIntraCellBlockingGroupTableEntry, syslogReset=syslogReset, wirelessIfWORPStatsTableEntry=wirelessIfWORPStatsTableEntry, worpQoSPIRRuleName=worpQoSPIRRuleName, sysTypeFreqDomain=sysTypeFreqDomain, wirelessIfWORPStatsRequestForService=wirelessIfWORPStatsRequestForService, wirelessIfDDRSMinReqSNR=wirelessIfDDRSMinReqSNR, wirelessIfVAPTableEntry=wirelessIfVAPTableEntry, netIpStaticRouteTableIndex=netIpStaticRouteTableIndex, wirelessIf11nPropertiesGuardInterval=wirelessIf11nPropertiesGuardInterval, wirelessIfStaStatsRxUnencrypted=wirelessIfStaStatsRxUnencrypted, wirelessIfBlacklistInfo=wirelessIfBlacklistInfo, radiusClientAuthStatsTimeouts=radiusClientAuthStatsTimeouts, ethernetIfSupportedSpeed=ethernetIfSupportedSpeed, worpSiteSurveyRemoteMimoCtrlSNR3=worpSiteSurveyRemoteMimoCtrlSNR3, wirelessIf11nPropertiesAMPDUStatus=wirelessIf11nPropertiesAMPDUStatus, wireless=wireless, worpQoSClassTableEntryStatus=worpQoSClassTableEntryStatus, wirelessIfDfsNumSatWithRadarForFreqSwitch=wirelessIfDfsNumSatWithRadarForFreqSwitch, wirelessIf11nPropertiesFrequencyExtension=wirelessIf11nPropertiesFrequencyExtension, wirelessQoSEDCATableAPCWmax=wirelessQoSEDCATableAPCWmax, filteringModuleInitFailure=filteringModuleInitFailure, systemFeatureModuleInitFailure=systemFeatureModuleInitFailure, ripInterfaceName=ripInterfaceName, wirelessIfWORPLinkTestWORPLinkStatus=wirelessIfWORPLinkTestWORPLinkStatus, worpQoSPIRMapSrcMacIndexList=worpQoSPIRMapSrcMacIndexList, wirelessIfStatsRxBytes=wirelessIfStatsRxBytes, wirelessIfWORPStaStatsRemoteMimoCtrlSig3=wirelessIfWORPStaStatsRemoteMimoCtrlSig3, dhcpRelayServerIpAddress=dhcpRelayServerIpAddress, sysInfo=sysInfo, wirelessIfWORPBandwidthLimitType=wirelessIfWORPBandwidthLimitType, worpIntraCellBlockingMACTable=worpIntraCellBlockingMACTable, sysMgmtLoadTextConfig=sysMgmtLoadTextConfig, wirelessIfWORPStaStatsRemoteMimoNoise=wirelessIfWORPStaStatsRemoteMimoNoise, wirelessIfStats=wirelessIfStats, wirelessIf11nPropertiesAMPDUMaxFrameSize=wirelessIf11nPropertiesAMPDUMaxFrameSize, wirelessIfWORPStatsAuthenticationRequests=wirelessIfWORPStatsAuthenticationRequests, igmpEth2MCastGrpIp=igmpEth2MCastGrpIp, wirelessIfStaStatsTxProbeReq=wirelessIfStaStatsTxProbeReq, sysInvMgmtCompReleaseVersion=sysInvMgmtCompReleaseVersion, wirelessIfVAPSecurityProfileName=wirelessIfVAPSecurityProfileName)
mibBuilder.exportSymbols("PROXIM-MIB", radiusSupProfileTableEntry=radiusSupProfileTableEntry, sysLicRadioAntennaMimoType=sysLicRadioAntennaMimoType, tcpudpPortFilterTableEntry=tcpudpPortFilterTableEntry, wirelessIfWORPStaBridgePort=wirelessIfWORPStaBridgePort, worpQoSSFClassStatus=worpQoSSFClassStatus, wirelessIfStatsTxPkts=wirelessIfStatsTxPkts, radiusClientAuthStatsAccessChallenges=radiusClientAuthStatsAccessChallenges, signatureCheckFailed=signatureCheckFailed, sysLicRadioCompID=sysLicRadioCompID, netCfgAllIntfDefaultRouterAddr=netCfgAllIntfDefaultRouterAddr, worpSiteSurveyOperationStatus=worpSiteSurveyOperationStatus, netIpStaticRouteDestAddr=netIpStaticRouteDestAddr, wirelessIfWORPStaStatsRemoteChainBalStatus=wirelessIfWORPStaStatsRemoteChainBalStatus, sysTypeSupportedMode=sysTypeSupportedMode, radiusClientAuthStatsTableIndex=radiusClientAuthStatsTableIndex, wirelessIfStaStatsTableEntry=wirelessIfStaStatsTableEntry, worpQoSPIREtherType=worpQoSPIREtherType, wirelessIfStaStatsRxBytes=wirelessIfStaStatsRxBytes, sysInvMgmtCompTableIndex=sysInvMgmtCompTableIndex, wirelessQoSEDCATableIndex=wirelessQoSEDCATableIndex, worpQoSPIRIPTableIndex=worpQoSPIRIPTableIndex, sysFeatureInBandwidth=sysFeatureInBandwidth, wirelessIfWORPStaStatsAverageRemoteSignal=wirelessIfWORPStaStatsAverageRemoteSignal, sysFeatureProductFamily=sysFeatureProductFamily, mgmtSnmpReadWritePassword=mgmtSnmpReadWritePassword, sysLicRadioInfoTable=sysLicRadioInfoTable, interfaceTraps=interfaceTraps, worpQoSPIRMacMask=worpQoSPIRMacMask, wirelessIfWORPMultiFrameBursting=wirelessIfWORPMultiFrameBursting, sysMgmt=sysMgmt, etherProtocolFilteringCtrl=etherProtocolFilteringCtrl, wirelessQoSEDCATableCWmin=wirelessQoSEDCATableCWmin, radiusSrvProfileTableIndex=radiusSrvProfileTableIndex, macacl=macacl, wirelessIfDDRSIncrAvgSNRThrld=wirelessIfDDRSIncrAvgSNRThrld, globalTrapStatus=globalTrapStatus, sntpShowCurrentTime=sntpShowCurrentTime, wirelessIfWORPStaStatsLocalMimoCtrlSNR2=wirelessIfWORPStaStatsLocalMimoCtrlSNR2, igmpWireless1MCastTable=igmpWireless1MCastTable, wirelessIfWORPLinkTestRemoteCurSNR=wirelessIfWORPLinkTestRemoteCurSNR, wirelessIfWORPLinkTestLocalCurNoise=wirelessIfWORPLinkTestLocalCurNoise, wirelessIfMonNumOfStaConnected=wirelessIfMonNumOfStaConnected, l2l3QoSDot1DToDot1pMappingTableEntry=l2l3QoSDot1DToDot1pMappingTableEntry, syslogHostIpAddress=syslogHostIpAddress, securityTraps=securityTraps, macaclAddrTableMACAddress=macaclAddrTableMACAddress, wirelessIfVAPTable=wirelessIfVAPTable, wirelessIfStaStatsInactivityTimer=wirelessIfStaStatsInactivityTimer, worpIntraCellBlockingGroupID5=worpIntraCellBlockingGroupID5, worpIntraCellBlockingGroupID14=worpIntraCellBlockingGroupID14, wirelessIfWORPMode=wirelessIfWORPMode, wirelessSecurityCfgAuthenticationMode=wirelessSecurityCfgAuthenticationMode, radiusClientStats=radiusClientStats, netIpStaticRouteNextHop=netIpStaticRouteNextHop, wirelessIfStatsTableIndex=wirelessIfStatsTableIndex, wirelessIfWORPStaStatsPollNoReplies=wirelessIfWORPStaStatsPollNoReplies, l2l3QoS=l2l3QoS, wirelessIfVAPBeaconInterval=wirelessIfVAPBeaconInterval, ap_800=ap_800, worpQoSSFClassNumOfMesgInBurst=worpQoSSFClassNumOfMesgInBurst, wirelessIfStaStatsRxDecapFailed=wirelessIfStaStatsRxDecapFailed, stormThresholdTableIndex=stormThresholdTableIndex, worpQoSPIRMacComment=worpQoSPIRMacComment, sysFeature=sysFeature, wirelessIfDfsStatus=wirelessIfDfsStatus, natStatus=natStatus, sysFeatureProductClass=sysFeatureProductClass, staticMACAddrFilterComment=staticMACAddrFilterComment, debugLogReset=debugLogReset, wirelessInterfaceWorldModeCCNotSet=wirelessInterfaceWorldModeCCNotSet, worpSiteSurveyRemoteMimoNoise=worpSiteSurveyRemoteMimoNoise, sysLicFeatureValue=sysLicFeatureValue, sysLicRadiovariantID=sysLicRadiovariantID, trapControl=trapControl, qoSPolicyPriorityMapping=qoSPolicyPriorityMapping, worpSiteSurveySatelliteRegisteredStatus=worpSiteSurveySatelliteRegisteredStatus, staticMACAddrFilterTable=staticMACAddrFilterTable, mgmtAccessTable=mgmtAccessTable, vlan=vlan, wirelessInterfaceCardInitFailure=wirelessInterfaceCardInitFailure, radiusSupProfileTable=radiusSupProfileTable, wirelessIfWORPStatsRegistrationTimeouts=wirelessIfWORPStatsRegistrationTimeouts, wirelessIfDDRSTable=wirelessIfDDRSTable, stormFilterInterface=stormFilterInterface, wirelessSecurity=wirelessSecurity, vlanEthTrunkTableSecIndex=vlanEthTrunkTableSecIndex, mgmtSnmpAccessTableIndex=mgmtSnmpAccessTableIndex, worpQoSPIREtherValue=worpQoSPIREtherValue, wirelessIfWORPStatsRegistrationIncompletes=wirelessIfWORPStatsRegistrationIncompletes, wirelessIfStaStatsStationOperatingMode=wirelessIfStaStatsStationOperatingMode, sysMgmtCfgCommit=sysMgmtCfgCommit, temperature=temperature, macaclProfileName=macaclProfileName, worpSiteSurveyBaseName=worpSiteSurveyBaseName, worpQoSPIRMapSrcIpAddrIndexList=worpQoSPIRMapSrcIpAddrIndexList, worpIntraCellBlockingGroupTableEntryStatus=worpIntraCellBlockingGroupTableEntryStatus, worpQoSClassName=worpQoSClassName, wirelessIfSupportedRate=wirelessIfSupportedRate, natStaticPortBindEndPortNum=natStaticPortBindEndPortNum, worpIntraCellBlockingGroupID16=worpIntraCellBlockingGroupID16, worpSiteSurveyTable=worpSiteSurveyTable, worpSiteSurveyLocalNoiseLevel=worpSiteSurveyLocalNoiseLevel, worpIntraCellBlockingGroupTable=worpIntraCellBlockingGroupTable, wirelessIfStaStatsRxControlFrames=wirelessIfStaStatsRxControlFrames, advancedFilterTableEntry=advancedFilterTableEntry, worpQoSClassPIRValue=worpQoSClassPIRValue, netIpCfgDefaultRouterIPAddress=netIpCfgDefaultRouterIPAddress, worpIntraCellBlockingMACTableEntry=worpIntraCellBlockingMACTableEntry, sysInvMgmtCompSerialNumber=sysInvMgmtCompSerialNumber, wirelessIfWORPLinkTestLocalCurSignal=wirelessIfWORPLinkTestLocalCurSignal, wirelessIfVAPRadiusMACACLStatus=wirelessIfVAPRadiusMACACLStatus, worpSiteSurveyRemoteMimoCtrlSNR2=worpSiteSurveyRemoteMimoCtrlSNR2, wirelessIfCurrentActiveChannel=wirelessIfCurrentActiveChannel, worpQoSPIRIPProtocolIds=worpQoSPIRIPProtocolIds, wirelessIfWORPStaStatsLocalChainBalStatus=wirelessIfWORPStaStatsLocalChainBalStatus, radiusSrvProfileTable=radiusSrvProfileTable, sntpSecondaryServerName=sntpSecondaryServerName, wirelessIfWORPStats=wirelessIfWORPStats, l2l3QoSDSCPPriorityLowerLimit=l2l3QoSDSCPPriorityLowerLimit, radiusSrvServerPort=radiusSrvServerPort, wirelessIfWORPStaStatsRemoteMimoCtrlSNR1=wirelessIfWORPStaStatsRemoteMimoCtrlSNR1, sysContactEmail=sysContactEmail, wirelessIfWORPStatsRegistrationRejects=wirelessIfWORPStatsRegistrationRejects, worpQoSPIRMapDstIpAddrIndexList=worpQoSPIRMapDstIpAddrIndexList, etherProtocolFilterTableIndex=etherProtocolFilterTableIndex, natStaticPortBindTableEntry=natStaticPortBindTableEntry, wirelessIfCurrentChannelBandwidth=wirelessIfCurrentChannelBandwidth, mgmtAccessTableEntry=mgmtAccessTableEntry, wirelessIfCurrentOperatingChannel=wirelessIfCurrentOperatingChannel, wirelessSecurityCfgKey2=wirelessSecurityCfgKey2, netIpCfgAddressType=netIpCfgAddressType, wirelessIfVAPTableSecIndex=wirelessIfVAPTableSecIndex, wirelessIfWORPLinkTestStatsTableSecIndex=wirelessIfWORPLinkTestStatsTableSecIndex, wirelessIf11nPropertiesSupportedTxAntennas=wirelessIf11nPropertiesSupportedTxAntennas, wirelessIfWORPLinkTestLocalMaxNoise=wirelessIfWORPLinkTestLocalMaxNoise, igmp=igmp, wirelessIfStaStatsIfNumber=wirelessIfStaStatsIfNumber, worpSiteSurveyBaseMACAddress=worpSiteSurveyBaseMACAddress, igmpWireless1MCastTableIndex=igmpWireless1MCastTableIndex, http=http, wirelessIfWORPStatsRegistrationLastReason=wirelessIfWORPStatsRegistrationLastReason, wirelessIfStaStatsTxMgmtFrames=wirelessIfStaStatsTxMgmtFrames, staticMACAddrFilterWirelessMACAddress=staticMACAddrFilterWirelessMACAddress, worpQoSSFClassMaxLatency=worpQoSSFClassMaxLatency, netIpStaticRouteMask=netIpStaticRouteMask, wirelessIfActiveTPC=wirelessIfActiveTPC, wirelessIfWORPLinkTestExploreStatus=wirelessIfWORPLinkTestExploreStatus, wirelessIfStaStatsTxAuthenticationFailed=wirelessIfStaStatsTxAuthenticationFailed, igmpWireless1MCastTableEntry=igmpWireless1MCastTableEntry, mgmtSnmpTrapHostTableEntryStatus=mgmtSnmpTrapHostTableEntryStatus, wirelessIfWORPStatsReplyData=wirelessIfWORPStatsReplyData, etherProtocolFilterProtocolNumber=etherProtocolFilterProtocolNumber, tcpudpPortFilter=tcpudpPortFilter, wirelessSecurityCfgEncryptionType=wirelessSecurityCfgEncryptionType, macaclAddrTableEntryStatus=macaclAddrTableEntryStatus, qosProfileTablePolicyName=qosProfileTablePolicyName, wirelessIfWORPLinkTestConfTableEntry=wirelessIfWORPLinkTestConfTableEntry, wirelessIfWORPTxRate=wirelessIfWORPTxRate, wirelessIfWORPStatsActiveUplinkMIR=wirelessIfWORPStatsActiveUplinkMIR, worpQoSPIRTableEntryStatus=worpQoSPIRTableEntryStatus, wirelessIfWORPStaStatsPollNoData=wirelessIfWORPStaStatsPollNoData, wirelessIfDDRSChainBalThrld=wirelessIfDDRSChainBalThrld, tcpudpPortFilterCtrl=tcpudpPortFilterCtrl, worpQoSSUTable=worpQoSSUTable, wirelessIfMon=wirelessIfMon, sysInvMgmtSecurityID=sysInvMgmtSecurityID, l2l3QoSDot1DToIPDSCPMappingTableEntry=l2l3QoSDot1DToIPDSCPMappingTableEntry, deviceMon=deviceMon, sysInvMgmtComponentTableEntry=sysInvMgmtComponentTableEntry, wirelessIfStaStatsTxDataFrames=wirelessIfStaStatsTxDataFrames, wirelessIfWORPStatsReceiveSuccess=wirelessIfWORPStatsReceiveSuccess, wirelessIfWORPLinkTestConfTableIndex=wirelessIfWORPLinkTestConfTableIndex, worpIntraCellBlockingGroupID3=worpIntraCellBlockingGroupID3, worpQoSPIRIPTable=worpQoSPIRIPTable, wirelessIfWORPStaStatsTableEntry=wirelessIfWORPStaStatsTableEntry, mgmtAccessTableIndex=mgmtAccessTableIndex, qoSPolicyMarkingStatus=qoSPolicyMarkingStatus, worpQoSPIRMapSrcPortIndexList=worpQoSPIRMapSrcPortIndexList, mgmtVLANPriority=mgmtVLANPriority, wirelessIfWORPLinkTestRemoteMaxSNR=wirelessIfWORPLinkTestRemoteMaxSNR, worpQoSPIRMacTableIndex=worpQoSPIRMacTableIndex, worpQoSPIRMacTableEntry=worpQoSPIRMacTableEntry, wirelessIfStaStatsTxPSDiscard=wirelessIfStaStatsTxPSDiscard, wirelessSecurityCfgKey1=wirelessSecurityCfgKey1, netIpStaticRouteTable=netIpStaticRouteTable, worpQoSPIRIPToSMask=worpQoSPIRIPToSMask, wirelessIf11nPropertiesTableEntry=wirelessIf11nPropertiesTableEntry, wirelessIfWORPLinkTestStatsTableIndex=wirelessIfWORPLinkTestStatsTableIndex, wirelessIfTransmittedRate=wirelessIfTransmittedRate, netIpWirelessCfgSubnetMask=netIpWirelessCfgSubnetMask, wirelessIfStaStatsRxUnicastFrames=wirelessIfStaStatsRxUnicastFrames, igmpEth1MCastGrpMACAddr=igmpEth1MCastGrpMACAddr, wirelessIfWORPStaStatsLocalMimoCtrlSNR1=wirelessIfWORPStaStatsLocalMimoCtrlSNR1, wirelessIfWORPLinkTestRemoteMaxNoise=wirelessIfWORPLinkTestRemoteMaxNoise, worpQoSClassPIRTableIndex=worpQoSClassPIRTableIndex, wirelessIfWORPStaStatsRemoteMimoCtrlSig1=wirelessIfWORPStaStatsRemoteMimoCtrlSig1, radiusClientAuthStatsAccessRejects=radiusClientAuthStatsAccessRejects, advancedFilterTableEntryStatus=advancedFilterTableEntryStatus, worpSiteSurveyNumSatellitesRegistered=worpSiteSurveyNumSatellitesRegistered, netCfgSecondaryDNSIpAddress=netCfgSecondaryDNSIpAddress, wirelessIfDDRSMaxDataRate=wirelessIfDDRSMaxDataRate, wirelessIfWORPRadiusAccStatus=wirelessIfWORPRadiusAccStatus, dhcpServerIfTableIndex=dhcpServerIfTableIndex, wirelessIfVAPSSID=wirelessIfVAPSSID, wirelessIfWORPStatsTable=wirelessIfWORPStatsTable, mgmtAccessTableStatus=mgmtAccessTableStatus, worpIntraCellBlockingGroupID15=worpIntraCellBlockingGroupID15, worpIntraCellBlockingGroupID4=worpIntraCellBlockingGroupID4, wirelessIfWORPLinkTestConfTable=wirelessIfWORPLinkTestConfTable, igmpForcedFlood=igmpForcedFlood, ripReceiveOnly=ripReceiveOnly, sntpDayLightSavingTime=sntpDayLightSavingTime, dhcp=dhcp, pxmModulesInitSuccess=pxmModulesInitSuccess, sysInvMgmtCompId=sysInvMgmtCompId, sysConf=sysConf, radiusClientAccStatsUnknownTypes=radiusClientAccStatsUnknownTypes, wirelessIfMPOperationalMode=wirelessIfMPOperationalMode, rip=rip, sysConfCountryCode=sysConfCountryCode, qosProfileTableQoSNACKStatus=qosProfileTableQoSNACKStatus, netIpCfgTableEntry=netIpCfgTableEntry, vlanEthTrunkTable=vlanEthTrunkTable, tcpudpPortFilterInterface=tcpudpPortFilterInterface, worpSiteSurveyRemoteNoiseLevel=worpSiteSurveyRemoteNoiseLevel, wirelessIfStatsRxCRCErrors=wirelessIfStatsRxCRCErrors, wirelessIfWORPStaStatsAverageRemoteNoise=wirelessIfWORPStaStatsAverageRemoteNoise, wirelessIfWORPStatsSendFailures=wirelessIfWORPStatsSendFailures, worpQoSPIRMapDstMacIndexList=worpQoSPIRMapDstMacIndexList, sysActiveNetworkMode=sysActiveNetworkMode, sysMgmtCfgRestore=sysMgmtCfgRestore, sysTypeTableEntry=sysTypeTableEntry, dhcpServerIpPoolStartIpAddress=dhcpServerIpPoolStartIpAddress, wirelessIfWORPStatsAverageLocalNoise=wirelessIfWORPStatsAverageLocalNoise, wirelessIfStatsChain1CtlRSSI=wirelessIfStatsChain1CtlRSSI, worpQoSPIRTableEntry=worpQoSPIRTableEntry, natStaticPortBindStartPortNum=natStaticPortBindStartPortNum, l2l3QoSDot1DToIPDSCPMappingTableIndex=l2l3QoSDot1DToIPDSCPMappingTableIndex, radiusClientAccStatsTable=radiusClientAccStatsTable, netCfgSupportedInterfaces=netCfgSupportedInterfaces)
