...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/proxim/PROXIM-MIB
...
mibBuilder.exportSymbols("PROXIM-MIB", worpQoSPIRIPAddr=worpQoSPIRIPAddr, wirelessIfAutoRateSelection=wirelessIfAutoRateSelection, mgmtSnmpV3PrivPassword=mgmtSnmpV3PrivPassword, wirelessIfWORPStatsAverageLocalSignal=wirelessIfWORPStatsAverageLocalSignal, ripReceiveOnly=ripReceiveOnly, sysFeatureNumEtherIf=sysFeatureNumEtherIf, mgmtAccessTableIndex=mgmtAccessTableIndex, mp_8100_cpe=mp_8100_cpe, sntpFailure=sntpFailure, ethernetIfSupportedTxMode=ethernetIfSupportedTxMode, netIpWirelessCfgTableEntry=netIpWirelessCfgTableEntry, wirelessSecurityCfgKeyIndex=wirelessSecurityCfgKeyIndex, sntpTimeZone=sntpTimeZone, l2l3QoSDot1DToDot1pMappingTableEntry=l2l3QoSDot1DToDot1pMappingTableEntry, etherProtocolFilterTableIndex=etherProtocolFilterTableIndex, worpQoSSFClassTolerableJitter=worpQoSSFClassTolerableJitter, wirelessSecurityCfgprofileName=wirelessSecurityCfgprofileName, wirelessQoSEDCATableSecIndex=wirelessQoSEDCATableSecIndex, netIpStaticRouteTable=netIpStaticRouteTable, wirelessIfWORPLinkTestRemoteCurNoise=wirelessIfWORPLinkTestRemoteCurNoise, wirelessInActivityTimer=wirelessInActivityTimer, wirelessIfWORPStatsRegistrationAttempts=wirelessIfWORPStatsRegistrationAttempts, radiusSupProfileTableEntryStatus=radiusSupProfileTableEntryStatus, netIpCfgAddressType=netIpCfgAddressType, wirelessQoSEDCATableAPACM=wirelessQoSEDCATableAPACM, wirelessIfWORPLinkTestLocalMinNoise=wirelessIfWORPLinkTestLocalMinNoise, worpQoS=worpQoS, wirelessQoSEDCATableAPCWmin=wirelessQoSEDCATableAPCWmin, sysContactEmail=sysContactEmail, wirelessIfDDRSDecrReqSNRThrld=wirelessIfDDRSDecrReqSNRThrld, worpQoSPIRMapSrcMacIndexList=worpQoSPIRMapSrcMacIndexList, wirelessIfWORPStaStatsLocalMimoCtrlSig2=wirelessIfWORPStaStatsLocalMimoCtrlSig2, macaclAddrTableEntryStatus=macaclAddrTableEntryStatus, radiusSrvProfileServerSharedSecret=radiusSrvProfileServerSharedSecret, wirelessIfStaStatsVAPNumber=wirelessIfStaStatsVAPNumber, wirelessInterfaceWorldModeCCNotSet=wirelessInterfaceWorldModeCCNotSet, worpSiteSurveyTableIndex=worpSiteSurveyTableIndex, tempLoggingInterval=tempLoggingInterval, wirelessIfWORPStatsActiveUplinkMIR=wirelessIfWORPStatsActiveUplinkMIR, macaclAddrTableIndex=macaclAddrTableIndex, wirelessQoSEDCATableProfileName=wirelessQoSEDCATableProfileName, httpsAccessControl=httpsAccessControl, worpSiteSurveyLocalNoiseLevel=worpSiteSurveyLocalNoiseLevel, worpIntraCellBlockingGroupID14=worpIntraCellBlockingGroupID14, sysMgmtModulesInitFailure=sysMgmtModulesInitFailure, worpSiteSurveyBaseBridgePort=worpSiteSurveyBaseBridgePort, sysFeatureCumulativeBandwidth=sysFeatureCumulativeBandwidth, qoSPolicyType=qoSPolicyType, worpQoSPIRVlanId=worpQoSPIRVlanId, sysMgmtLoadTextConfig=sysMgmtLoadTextConfig, wirelessIfStaStatsVlanTag=wirelessIfStaStatsVlanTag, ap_800=ap_800, wirelessIfMPOperationalMode=wirelessIfMPOperationalMode, wirelessIfDDRSChainBalThrld=wirelessIfDDRSChainBalThrld, sntpTraps=sntpTraps, wirelessIfBlacklistInfoTableEntry=wirelessIfBlacklistInfoTableEntry, radiusMon=radiusMon, ethVLANTrunkId=ethVLANTrunkId, wirelessIfStatsRxDecryptErrors=wirelessIfStatsRxDecryptErrors, mgmtSnmpTrapHostTableEntry=mgmtSnmpTrapHostTableEntry, worpIntraCellBlockingMACTableIndex=worpIntraCellBlockingMACTableIndex, wirelessIfWORPInputBandwidthLimit=wirelessIfWORPInputBandwidthLimit, dhcpRelayServerTableIndex=dhcpRelayServerTableIndex, httpPort=httpPort, ripInterfaceAuthKey=ripInterfaceAuthKey, wirelessIfStaStatsRxDeauthenticationFrames=wirelessIfStaStatsRxDeauthenticationFrames, wirelessIfStaStatsRxNoPrivacy=wirelessIfStaStatsRxNoPrivacy, ObjStatusActive=ObjStatusActive, wirelessQoSEDCATableTXOP=wirelessQoSEDCATableTXOP, radiusSupProfileMaxReTransmissions=radiusSupProfileMaxReTransmissions, wirelessIfWORPLinkTest=wirelessIfWORPLinkTest, wirelessIfVAPMACACLStatus=wirelessIfVAPMACACLStatus, advancedFilterProtocolName=advancedFilterProtocolName, wirelessIfWORPStatsProvisionedDownlinkMIR=wirelessIfWORPStatsProvisionedDownlinkMIR, wirelessIfWORPStaStatsTableIndex=wirelessIfWORPStaStatsTableIndex, wirelessIfVAPBroadcastSSID=wirelessIfVAPBroadcastSSID, wirelessIfWORPTableEntry=wirelessIfWORPTableEntry, wirelessIfBlacklistInfoTableSecIndex=wirelessIfBlacklistInfoTableSecIndex, wirelessIfWORPStaStatsSatelliteName=wirelessIfWORPStaStatsSatelliteName, wirelessIfWORPSecurityProfileIndex=wirelessIfWORPSecurityProfileIndex, wirelessIfVAPTableEntry=wirelessIfVAPTableEntry, wirelessIfVAPSSID=wirelessIfVAPSSID, wirelessIf11nPropertiesAMPDUStatus=wirelessIf11nPropertiesAMPDUStatus, sysTypeFreqDomain=sysTypeFreqDomain, wirelessQoSEDCATableACM=wirelessQoSEDCATableACM, wirelessIfWORPStatsActiveDownlinkMIR=wirelessIfWORPStatsActiveDownlinkMIR, netCfgPrimaryDNSIpAddress=netCfgPrimaryDNSIpAddress, worpSiteSurveyRemoteMimoCtrlSNR2=worpSiteSurveyRemoteMimoCtrlSNR2, wirelessIfVAPQoSProfileName=wirelessIfVAPQoSProfileName, invalidConfigFile=invalidConfigFile, wirelessQoSEDCATableEntry=wirelessQoSEDCATableEntry, wirelessIfVAPRTSThreshold=wirelessIfVAPRTSThreshold, netIpCfgIPAddress=netIpCfgIPAddress, worpSiteSurveyRemoteTxRate=worpSiteSurveyRemoteTxRate, wirelessSecurityCfgKey1=wirelessSecurityCfgKey1, worpQoSPIRRuleBitMask=worpQoSPIRRuleBitMask, wirelessIfWORPLinkTestStatsTableEntry=wirelessIfWORPLinkTestStatsTableEntry, netIpStaticRouteNextHop=netIpStaticRouteNextHop, igmpForcedFlood=igmpForcedFlood, wirelessIfWORPLinkTestWORPLinkStatus=wirelessIfWORPLinkTestWORPLinkStatus, radiusClientAccStatsPacketsDropped=radiusClientAccStatsPacketsDropped, wirelessIfWORPStatsRegistrationIncompletes=wirelessIfWORPStatsRegistrationIncompletes, wirelessIfStaStatsAssociationID=wirelessIfStaStatsAssociationID, dhcp=dhcp, wirelessIf11nPropertiesFrequencyExtension=wirelessIf11nPropertiesFrequencyExtension, sysInvMgmtCompMinorVersion=sysInvMgmtCompMinorVersion, worpQoSSUTableEntryStatus=worpQoSSUTableEntryStatus, ripConfigTableEntry=ripConfigTableEntry, vlanEthCfgTableIndex=vlanEthCfgTableIndex, syslogPriority=syslogPriority, wirelessIfStaStatsRxDecapFailed=wirelessIfStaStatsRxDecapFailed, wirelessQoSEDCATableCWmax=wirelessQoSEDCATableCWmax, sysLicRadioInfoTable=sysLicRadioInfoTable, wirelessIfStaStatsTxDisassociation=wirelessIfStaStatsTxDisassociation, sysInvMgmtCompSerialNumber=sysInvMgmtCompSerialNumber, worpQoSSFClassTrafficPriority=worpQoSSFClassTrafficPriority, ethernetIfSupportedSpeed=ethernetIfSupportedSpeed, worpQoSClassTableEntryStatus=worpQoSClassTableEntryStatus, wirelessIfBlacklistInfoTableIndex=wirelessIfBlacklistInfoTableIndex, macaclAddrTableMACAddress=macaclAddrTableMACAddress, wirelessIfWORPStatsSendSuccess=wirelessIfWORPStatsSendSuccess, wirelessIfWORPStatsReceiveFailures=wirelessIfWORPStatsReceiveFailures, dhcpServerDefaultGateway=dhcpServerDefaultGateway, tftpSrvIpAddress=tftpSrvIpAddress, wirelessIfWORPSupportedTxRate=wirelessIfWORPSupportedTxRate, tcpudpPortFilterTableEntry=tcpudpPortFilterTableEntry, worpSiteSurveySatelliteRegisteredStatus=worpSiteSurveySatelliteRegisteredStatus, worpSiteSurveyRemoteMimoCtrlSig2=worpSiteSurveyRemoteMimoCtrlSig2, wirelessQoSEDCATableCWmin=wirelessQoSEDCATableCWmin, wirelessIfStaStatsRxUnicastFrames=wirelessIfStaStatsRxUnicastFrames, worpQoSPIRTableEntry=worpQoSPIRTableEntry, sshAccessControl=sshAccessControl, wirelessIfDDRSMinReqSNR=wirelessIfDDRSMinReqSNR, worpIntraCellBlockingGroupID16=worpIntraCellBlockingGroupID16, advancedFilterTable=advancedFilterTable, worpQoSPIRTable=worpQoSPIRTable, sysFeatureNumRadios=sysFeatureNumRadios, sysInvMgmt=sysInvMgmt, dhcpServerIpPoolInterface=dhcpServerIpPoolInterface, worpQoSL2BroadcastClass=worpQoSL2BroadcastClass, sysFeatureInBandwidth=sysFeatureInBandwidth, wirelessIfStaStatsMACAddress=wirelessIfStaStatsMACAddress, wirelessIfStaStatsTxUnicastFrames=wirelessIfStaStatsTxUnicastFrames, wirelessIfStaStatsRSSI=wirelessIfStaStatsRSSI, worpQoSPIRTableEntryStatus=worpQoSPIRTableEntryStatus, worpIntraCellBlockingGroupID9=worpIntraCellBlockingGroupID9, mgmtAccessTableEntry=mgmtAccessTableEntry, sntpStatus=sntpStatus, wirelessIfWORPStaStatsLocalMimoCtrlSig1=wirelessIfWORPStaStatsLocalMimoCtrlSig1, l2l3QoSDot1pPriority=l2l3QoSDot1pPriority, sysLicRadioAntennaType=sysLicRadioAntennaType, staticMACAddrFilterWiredMACAddress=staticMACAddrFilterWiredMACAddress, sysFeatureFreqBand=sysFeatureFreqBand, configurationAppliedSuccessfully=configurationAppliedSuccessfully, staticNATModuleInitFailure=staticNATModuleInitFailure, sshSessions=sshSessions, worpQoSSFClassTable=worpQoSSFClassTable, worpIntraCellBlockingGroupID5=worpIntraCellBlockingGroupID5, systemFeatureModuleInitFailure=systemFeatureModuleInitFailure, wirelessIfWORPStatsRegistrationRejects=wirelessIfWORPStatsRegistrationRejects, macaclProfileTableEntry=macaclProfileTableEntry, wirelessIfWORPLinkTestRemoteMaxSNR=wirelessIfWORPLinkTestRemoteMaxSNR, wirelessQoSEDCATableIndex=wirelessQoSEDCATableIndex, DisplayString80=DisplayString80, wirelessIfAntennaGain=wirelessIfAntennaGain, netCfgSupportedInterfaces=netCfgSupportedInterfaces, advancedFilterTableEntry=advancedFilterTableEntry, tftpModuleInitFailure=tftpModuleInitFailure, sysMonitor=sysMonitor, ap_8000=ap_8000, ethernetIfPropertiesTableIndex=ethernetIfPropertiesTableIndex, wirelessIf11nPropertiesTable=wirelessIf11nPropertiesTable, mgmtSnmpTrapHostTableIPAddress=mgmtSnmpTrapHostTableIPAddress, wirelessIfSatelliteDensity=wirelessIfSatelliteDensity, mgmtAccessTable=mgmtAccessTable, debugLog=debugLog, wirelessIfStaStatsRxWepFail=wirelessIfStaStatsRxWepFail, ssh=ssh, staticMACAddrFilterTableIndex=staticMACAddrFilterTableIndex, ObjStatus=ObjStatus, wirelessIfDDRSMinReqSNRTableIndex=wirelessIfDDRSMinReqSNRTableIndex, sysTypeSupportedFreqDomains=sysTypeSupportedFreqDomains, radiusClientAuthStatsResponses=radiusClientAuthStatsResponses, worpSiteSurveyOperationTableIndex=worpSiteSurveyOperationTableIndex, worpSiteSurveyRemoteSNR=worpSiteSurveyRemoteSNR, mgmtSnmpAccessTable=mgmtSnmpAccessTable, wirelessIfWORPStatsAverageLocalNoise=wirelessIfWORPStatsAverageLocalNoise, worpSiteSurveyRemoteMimoCtrlSig1=worpSiteSurveyRemoteMimoCtrlSig1, wireless=wireless, worpQoSPIRPortTableEntryStatus=worpQoSPIRPortTableEntryStatus, wirelessIfWORPStatsCurrentUplinkBandwidth=wirelessIfWORPStatsCurrentUplinkBandwidth, ethernetIfAutoShutDown=ethernetIfAutoShutDown, igmpMembershipAgingTimer=igmpMembershipAgingTimer, wirelessIfWORPStaStatsSendFailures=wirelessIfWORPStaStatsSendFailures, deviceMgmt=deviceMgmt, worpQoSPIREtherValue=worpQoSPIREtherValue, worpQoSPIRIPTableEntryStatus=worpQoSPIRIPTableEntryStatus, wirelessIfWORPStaStatsSendSuccess=wirelessIfWORPStaStatsSendSuccess, worpSiteSurveyRemoteChainBalStatus=worpSiteSurveyRemoteChainBalStatus, stormThreshold=stormThreshold, etherProtocolFilterTable=etherProtocolFilterTable, mgmtSnmpTrapHostTable=mgmtSnmpTrapHostTable, wirelessIfWORPStatsTableIndex=wirelessIfWORPStatsTableIndex, l2l3QoSDot1DToIPDSCPMappingTableEntry=l2l3QoSDot1DToIPDSCPMappingTableEntry, netIpWirelessCfgIPAddress=netIpWirelessCfgIPAddress, tcpudpPortFilterPortType=tcpudpPortFilterPortType, netIpCfgTableIndex=netIpCfgTableIndex, radiusClientAuthStatsRetransmissions=radiusClientAuthStatsRetransmissions, wirelessIfWORPStaStatsRemoteTxRate=wirelessIfWORPStaStatsRemoteTxRate, syslogHostTableEntryStatus=syslogHostTableEntryStatus, wirelessIfDDRSMaxDataRate=wirelessIfDDRSMaxDataRate, netIpStaticRouteTableIndex=netIpStaticRouteTableIndex, natStaticPortBindTableIndex=natStaticPortBindTableIndex, telnet=telnet, wirelessIfPropertiesTableEntry=wirelessIfPropertiesTableEntry, wirelessIfWORPLinkTestIdleTimeout=wirelessIfWORPLinkTestIdleTimeout, radiusSrvProfileTableEntryStatus=radiusSrvProfileTableEntryStatus, telnetPort=telnetPort, wirelessIfWORPLinkTestRemoteCurSignal=wirelessIfWORPLinkTestRemoteCurSignal, mgmtSnmpTrapHostTableEntryStatus=mgmtSnmpTrapHostTableEntryStatus, worpQoSPIRTableIndex=worpQoSPIRTableIndex, netIpCfgTable=netIpCfgTable, sysTypeTable=sysTypeTable, igmpEth2MCastGrpIp=igmpEth2MCastGrpIp, wirelessIfWORPSuperPacketing=wirelessIfWORPSuperPacketing, wirelessSecurityCfgdot1xWepKeyLength=wirelessSecurityCfgdot1xWepKeyLength, radiusClientAccStatsTableIndex=radiusClientAccStatsTableIndex, wirelessIfTransmittedRate=wirelessIfTransmittedRate, wirelessIf11nPropertiesRxAntennas=wirelessIf11nPropertiesRxAntennas, ethernetIfPropertiesTableEntry=ethernetIfPropertiesTableEntry, deviceConfig=deviceConfig, wirelessIfDfsStatus=wirelessIfDfsStatus, worpQoSPIRIPProtocolIds=worpQoSPIRIPProtocolIds, wirelessIfWORPStaStatsRemoteMimoNoise=wirelessIfWORPStaStatsRemoteMimoNoise, igmpRouterPortAgingTimer=igmpRouterPortAgingTimer, wirelessIfStaStatsAuthenAlgorithm=wirelessIfStaStatsAuthenAlgorithm, radiusClientAuthStatsRequests=radiusClientAuthStatsRequests, wirelessIf11nPropertiesAMPDUMaxFrameSize=wirelessIf11nPropertiesAMPDUMaxFrameSize, wirelessIfVAPVLANID=wirelessIfVAPVLANID, wirelessIfWORPRegistrationTimeout=wirelessIfWORPRegistrationTimeout, sysTypeActiveMode=sysTypeActiveMode, igmpEth1MCastGrpIp=igmpEth1MCastGrpIp, wirelessIfStaStatsRxProbeResp=wirelessIfStaStatsRxProbeResp, sysTypeTableEntry=sysTypeTableEntry, wirelessIfWORPLinkTestStatsTableSecIndex=wirelessIfWORPLinkTestStatsTableSecIndex, wirelessIfTPC=wirelessIfTPC, etherProtocolFilteringCtrl=etherProtocolFilteringCtrl, worpIntraCellBlockingGroupID11=worpIntraCellBlockingGroupID11, wirelessIfWORPStatsAverageRemoteSignal=wirelessIfWORPStatsAverageRemoteSignal, igmpRouterPortListTableEntry=igmpRouterPortListTableEntry, wirelessIfWORPStatsReplyNoData=wirelessIfWORPStatsReplyNoData, wirelessIf11nPropertiesAMPDUMaxNumFrames=wirelessIf11nPropertiesAMPDUMaxNumFrames, stormBroadcastThreshold=stormBroadcastThreshold, sysInvMgmtSecurityID=sysInvMgmtSecurityID)
mibBuilder.exportSymbols("PROXIM-MIB", wirelessIfCurrentActiveChannel=wirelessIfCurrentActiveChannel, wirelessSecurityCfgTableEntry=wirelessSecurityCfgTableEntry, tcpudpPortFilterPortNumber=tcpudpPortFilterPortNumber, worpQoSPIRMapDstPortIndexList=worpQoSPIRMapDstPortIndexList, wirelessIfStaStatsRxDisassociationFrames=wirelessIfStaStatsRxDisassociationFrames, wirelessIfWORPStatsBaseStationAnnounces=wirelessIfWORPStatsBaseStationAnnounces, vlanEthTrunkTableSecIndex=vlanEthTrunkTableSecIndex, lowTempThreshold=lowTempThreshold, systemTraps=systemTraps, productDescr=productDescr, worpQoSPIRMapSrcPortIndexList=worpQoSPIRMapSrcPortIndexList, objects=objects, sysInvMgmtComponentTableEntry=sysInvMgmtComponentTableEntry, wirelessIfStaStatsTxDeAuthCode=wirelessIfStaStatsTxDeAuthCode, worpQoSClassTableIndex=worpQoSClassTableIndex, sysConfCountryCode=sysConfCountryCode, netIpCfgDefaultRouterIPAddress=netIpCfgDefaultRouterIPAddress, dhcpServerDefaultLeaseTime=dhcpServerDefaultLeaseTime, wirelessIfStatsRxCRCErrors=wirelessIfStatsRxCRCErrors, worpSiteSurveyBaseName=worpSiteSurveyBaseName, wirelessInterfaceInvalidRegDomain=wirelessInterfaceInvalidRegDomain, radius=radius, wirelessIfStaStatsTableIndex=wirelessIfStaStatsTableIndex, wirelessIfWORPStaStatsAverageLocalNoise=wirelessIfWORPStaStatsAverageLocalNoise, wirelessIfDDRSPhyModulation=wirelessIfDDRSPhyModulation, vlanEthCfgTableEntry=vlanEthCfgTableEntry, worpQoSPIRMapTableIndex=worpQoSPIRMapTableIndex, igmpRouterPortListTable=igmpRouterPortListTable, qosProfileTablePolicyName=qosProfileTablePolicyName, wirelessIfVAPType=wirelessIfVAPType, wirelessSecurityCfgPSK=wirelessSecurityCfgPSK, wirelessIfWORPAutoMultiFrameBursting=wirelessIfWORPAutoMultiFrameBursting, wlanModuleInitFailure=wlanModuleInitFailure, radiusClientAccStatsTableEntry=radiusClientAccStatsTableEntry, wirelessIfWORPStatsReplyData=wirelessIfWORPStatsReplyData, wirelessIf11nPropertiesTableIndex=wirelessIf11nPropertiesTableIndex, vlanEthTrunkTableEntry=vlanEthTrunkTableEntry, worpQoSPIREtherPriorityHigh=worpQoSPIREtherPriorityHigh, signatureCheckFailed=signatureCheckFailed, dhcpServerIpPoolTable=dhcpServerIpPoolTable, wirelessIfWORPStatsActiveDownlinkCIR=wirelessIfWORPStatsActiveDownlinkCIR, tcpudpPortFilterTableEntryStatus=tcpudpPortFilterTableEntryStatus, radiusClientAuthStatsTable=radiusClientAuthStatsTable, natStatus=natStatus, ethernetIfSupportedModes=ethernetIfSupportedModes, macaclProfileTable=macaclProfileTable, worpQoSPIRIPToSHigh=worpQoSPIRIPToSHigh, sysFeatureOutBandwidth=sysFeatureOutBandwidth, igmpEth1MCastTableEntry=igmpEth1MCastTableEntry, trapControl=trapControl, netIpWirelessCfgTable=netIpWirelessCfgTable, wirelessIfStatsCombinedRSSI=wirelessIfStatsCombinedRSSI, l2l3QoSDot1DToIPDSCPMappingTableIndex=l2l3QoSDot1DToIPDSCPMappingTableIndex, ripInterfaceStatus=ripInterfaceStatus, sysTypeRadioIfIndex=sysTypeRadioIfIndex, wirelessIfStaStatsRxUnencrypted=wirelessIfStaStatsRxUnencrypted, wirelessIfWORPStaStatsAverageRemoteNoise=wirelessIfWORPStaStatsAverageRemoteNoise, wirelessQoSEDCATableAPAIFSN=wirelessQoSEDCATableAPAIFSN, netIpCfgTableEntry=netIpCfgTableEntry, wirelessIfWORPStaStatsLocalMimoCtrlSNR2=wirelessIfWORPStaStatsLocalMimoCtrlSNR2, wirelessIfWORPMultiFrameBursting=wirelessIfWORPMultiFrameBursting, worpQoSPIRIPTable=worpQoSPIRIPTable, wirelessIfWORPStatsSendFailures=wirelessIfWORPStatsSendFailures, worpIntraCellBlocking=worpIntraCellBlocking, qosProfileTableEntry=qosProfileTableEntry, worpQoSSFClassMaxLatency=worpQoSSFClassMaxLatency, imageTraps=imageTraps, etherprotocolFilterStatus=etherprotocolFilterStatus, operationalTraps=operationalTraps, wirelessIfStaStatsTxAssociationFrames=wirelessIfStaStatsTxAssociationFrames, netIpStaticRouteTableEntry=netIpStaticRouteTableEntry, wirelessIfWORPStaStatsRequestForService=wirelessIfWORPStaStatsRequestForService, wirelessSecurityCfgAuthenticationMode=wirelessSecurityCfgAuthenticationMode, wirelessIfWORPStaStatsReceiveSuccess=wirelessIfWORPStaStatsReceiveSuccess, wirelessIfWORPStaStatsRemoteMimoCtrlSNR3=wirelessIfWORPStaStatsRemoteMimoCtrlSNR3, wirelessIfWORPStatsPollNoReplies=wirelessIfWORPStatsPollNoReplies, wirelessIfStatsRxPkts=wirelessIfStatsRxPkts, worpIntraCellBlockingGroupTable=worpIntraCellBlockingGroupTable, radiusSupProfileTable=radiusSupProfileTable, worpQoSClassPriority=worpQoSClassPriority, wirelessIfWORPStaStatsRemoteMimoCtrlSig1=wirelessIfWORPStaStatsRemoteMimoCtrlSig1, wirelessIfStatsChain0CtlRSSI=wirelessIfStatsChain0CtlRSSI, ripConfigStatus=ripConfigStatus, mgmtSnmpReadWritePassword=mgmtSnmpReadWritePassword, worpQoSPIRStartPort=worpQoSPIRStartPort, vlanEthTrunkTableEntryStatus=vlanEthTrunkTableEntryStatus, wirelessIfWORPNetworkName=wirelessIfWORPNetworkName, wirelessIfDDRSMinReqSNRTable=wirelessIfDDRSMinReqSNRTable, snmpModuleInitFailure=snmpModuleInitFailure, wirelessIfWORPStaStatsReceiveRetries=wirelessIfWORPStaStatsReceiveRetries, wirelessIfWORPLinkTestExploreStatus=wirelessIfWORPLinkTestExploreStatus, syslogHostTableIndex=syslogHostTableIndex, worpQoSPIRMapTableIndexVal=worpQoSPIRMapTableIndexVal, worpQoSClassPIRValue=worpQoSClassPIRValue, worpQoSPIREndPort=worpQoSPIREndPort, radiusSrvNotResponding=radiusSrvNotResponding, worpQoSDefaultClass=worpQoSDefaultClass, dhcpServerPrimaryDNS=dhcpServerPrimaryDNS, telnetSessions=telnetSessions, wirelessIfDDRSIncrReqSNRThrld=wirelessIfDDRSIncrReqSNRThrld, worpQoSPIRMacTableIndex=worpQoSPIRMacTableIndex, qosProfileTableIndex=qosProfileTableIndex, vlanMode=vlanMode, sysLicRadioInfoTableEntry=sysLicRadioInfoTableEntry, worpQoSSFClassTableIndex=worpQoSSFClassTableIndex, pxmModulesInitSuccess=pxmModulesInitSuccess, wirelessQoSEDCATableAIFSN=wirelessQoSEDCATableAIFSN, wirelessIf11nPropertiesAMSDUStatus=wirelessIf11nPropertiesAMSDUStatus, worpQoSPIRIPTableEntry=worpQoSPIRIPTableEntry, wirelessIfStaStatsTxRate=wirelessIfStaStatsTxRate, siteSurvey=siteSurvey, l2l3QoSDSCPPriorityUpperLimit=l2l3QoSDSCPPriorityUpperLimit, sntpPrimaryServerName=sntpPrimaryServerName, etherProtocolFilterProtocolName=etherProtocolFilterProtocolName, traps=traps, qos=qos, wirelessIfCurrentChannelBandwidth=wirelessIfCurrentChannelBandwidth, temperature=temperature, wirelessIfStaStatsTxMulticastFrames=wirelessIfStaStatsTxMulticastFrames, netIpCfgSubnetMask=netIpCfgSubnetMask, debugLogReset=debugLogReset, licenseModuleInitFailure=licenseModuleInitFailure, worpSiteSurveyOperationTableEntry=worpSiteSurveyOperationTableEntry, wirelessIfWORPRadiusAccStatus=wirelessIfWORPRadiusAccStatus, worpSiteSurvey=worpSiteSurvey, wirelessIfStaStatsState=wirelessIfStaStatsState, wirelessIfWORPOutputBandwidthLimit=wirelessIfWORPOutputBandwidthLimit, staticMACAddrFilterTableEntry=staticMACAddrFilterTableEntry, worpSiteSurveyLocalMimoCtrlSNR1=worpSiteSurveyLocalMimoCtrlSNR1, worpSiteSurveyLocalMimoCtrlSig1=worpSiteSurveyLocalMimoCtrlSig1, wirelessIfWORPStaStatsAverageLocalSNR=wirelessIfWORPStaStatsAverageLocalSNR, sysMgmtCfgErrorMsg=sysMgmtCfgErrorMsg, wirelessIfWORPStatsRequestForService=wirelessIfWORPStatsRequestForService, wirelessIfStaStatsTableSecIndex=wirelessIfStaStatsTableSecIndex, wirelessIf11nPropertiesGuardInterval=wirelessIf11nPropertiesGuardInterval, sysFeatureOpMode=sysFeatureOpMode, sysLicFeatureValue=sysLicFeatureValue, wirelessIfWORPLinkTestRemoteMinSignal=wirelessIfWORPLinkTestRemoteMinSignal, ethernetIfMACAddress=ethernetIfMACAddress, sysTypeActiveFreqDomain=sysTypeActiveFreqDomain, worpSiteSurveyMaxSatellitesAllowed=worpSiteSurveyMaxSatellitesAllowed, wirelessIfStaStatsTxDeAuthFrames=wirelessIfStaStatsTxDeAuthFrames, wirelessIfStaStatsTxAuthenticationFrames=wirelessIfStaStatsTxAuthenticationFrames, netIpWirelessCfgTableIndex=netIpWirelessCfgTableIndex, dhcpServerIfTableEntryStatus=dhcpServerIfTableEntryStatus, flashMemoryThresholdExceeded=flashMemoryThresholdExceeded, wirelessIfVAPBSSID=wirelessIfVAPBSSID, wirelessSecurityCfgKey2=wirelessSecurityCfgKey2, l2l3QoS=l2l3QoS, igmpStats=igmpStats, wirelessIfWORPRetries=wirelessIfWORPRetries, wirelessIfWORPLinkTestLocalCurNoise=wirelessIfWORPLinkTestLocalCurNoise, tempLogReset=tempLogReset, wirelessIfStaStats=wirelessIfStaStats, mgmtSnmpV3SecurityLevel=mgmtSnmpV3SecurityLevel, netCfgAllIntfDefaultRouterAddr=netCfgAllIntfDefaultRouterAddr, mgmtSnmpAccessTableEntry=mgmtSnmpAccessTableEntry, wirelessIfDDRSDataRate=wirelessIfDDRSDataRate, wirelessIfStaStatsTxEospLost=wirelessIfStaStatsTxEospLost, wirelessIfWORPStaStatsPollNoReplies=wirelessIfWORPStaStatsPollNoReplies, radiusClientAuthStatsAccessAccepts=radiusClientAuthStatsAccessAccepts, wirelessIfWORPSleepMode=wirelessIfWORPSleepMode, sysLicRadioInfoTableIndex=sysLicRadioInfoTableIndex, macaclOperationType=macaclOperationType, wirelessIfWORPStaStatsRemoteMimoCtrlSig2=wirelessIfWORPStaStatsRemoteMimoCtrlSig2, sysLicFeatureTableIndex=sysLicFeatureTableIndex, igmpEth1MCastTableIndex=igmpEth1MCastTableIndex, wirelessIfWORPStaStatsAverageRemoteSNR=wirelessIfWORPStaStatsAverageRemoteSNR, wirelessQoS=wirelessQoS, wirelessQoSEDCATableAPTXOP=wirelessQoSEDCATableAPTXOP, wirelessIfStaStatsRxDupFrames=wirelessIfStaStatsRxDupFrames, wirelessIfWORPLinkTestStatus=wirelessIfWORPLinkTestStatus, radiusClientAuthStatsTableIndex=radiusClientAuthStatsTableIndex, dhcpServerInterfaceType=dhcpServerInterfaceType, mgmtAccessTableIpAddress=mgmtAccessTableIpAddress, masterAgentExited=masterAgentExited, wirelessIfWORPLinkTestConfTableIndex=wirelessIfWORPLinkTestConfTableIndex, worpIntraCellBlockingGroupTableEntry=worpIntraCellBlockingGroupTableEntry, genericTrap=genericTrap, sysFeatureProductClass=sysFeatureProductClass, wirelessIfWORPStatsProvisionedDownlinkCIR=wirelessIfWORPStatsProvisionedDownlinkCIR, wirelessIfWORPLinkTestRemoteMaxNoise=wirelessIfWORPLinkTestRemoteMaxNoise, radiusSupProfileReAuthenticationPeriod=radiusSupProfileReAuthenticationPeriod, worpQoSSFClassDirection=worpQoSSFClassDirection, wirelessIfStaStatsRxMulticastFrames=wirelessIfStaStatsRxMulticastFrames, wirelessIfWORPStatsProvisionedUplinkMIR=wirelessIfWORPStatsProvisionedUplinkMIR, igmpWireless1MCastGrpIp=igmpWireless1MCastGrpIp, worpQoSPIRPPPoEProtocolId=worpQoSPIRPPPoEProtocolId, eventLogPriority=eventLogPriority, wirelessIfStatsTxPkts=wirelessIfStatsTxPkts, igmpWirelessSnoopingStats=igmpWirelessSnoopingStats, worpQoSPIRMapSrcIpAddrIndexList=worpQoSPIRMapSrcIpAddrIndexList, wirelessIfStaStatsTxDisassociationCode=wirelessIfStaStatsTxDisassociationCode, wirelessIfWORPStatsRegistrationTimeouts=wirelessIfWORPStatsRegistrationTimeouts, dhcpServerStatus=dhcpServerStatus, wirelessIf11nPropertiesTxAntennas=wirelessIf11nPropertiesTxAntennas, natStaticPortBindTableEntryStatus=natStaticPortBindTableEntryStatus, wirelessIfWORPStatsAuthenticationConfirms=wirelessIfWORPStatsAuthenticationConfirms, worpQoSPIRMacTableEntryStatus=worpQoSPIRMacTableEntryStatus, sysInvMgmtComponentTable=sysInvMgmtComponentTable, wirelessIfVAPBeaconInterval=wirelessIfVAPBeaconInterval, wirelessIfVAPStatus=wirelessIfVAPStatus, worpQoSPIRMapTableEntry=worpQoSPIRMapTableEntry, mgmtAccessTableEntryStatus=mgmtAccessTableEntryStatus, sysMonitorCPUUsage=sysMonitorCPUUsage, tcpudpPortFilterTable=tcpudpPortFilterTable, igmp=igmp, wirelessIfWORPLinkTestMACAddress=wirelessIfWORPLinkTestMACAddress, wirelessIfWORPLinkTestLocalMaxNoise=wirelessIfWORPLinkTestLocalMaxNoise, worpSiteSurveyChannelBandwidth=worpSiteSurveyChannelBandwidth, wirelessIfChannelWaitTime=wirelessIfChannelWaitTime, tftpFileName=tftpFileName, radiusClientAuthStatsAccessRejects=radiusClientAuthStatsAccessRejects, netIpStaticRouteTableEntryStatus=netIpStaticRouteTableEntryStatus, worpIntraCellBlockingGroupName=worpIntraCellBlockingGroupName, wirelessIfDDRSMinReqSNRTableSecIndex=wirelessIfDDRSMinReqSNRTableSecIndex, syslogReset=syslogReset, wirelessIfWORPLinkTestStatsTable=wirelessIfWORPLinkTestStatsTable, DisplayString20=DisplayString20, dhcpServerIpPoolStartIpAddress=dhcpServerIpPoolStartIpAddress, sysFeatureProductFamily=sysFeatureProductFamily, dhcpServerIfTableIndex=dhcpServerIfTableIndex, http=http, wirelessIfDDRSMinReqSNRTableEntry=wirelessIfDDRSMinReqSNRTableEntry, worpQoSPIRMacComment=worpQoSPIRMacComment, wirelessIfWORPLinkTestLocalMinSNR=wirelessIfWORPLinkTestLocalMinSNR, invalidImage=invalidImage, wirelessIfDDRSStatus=wirelessIfDDRSStatus, wirelessIfStaStatsRxDecryptFailedOnCRC=wirelessIfStaStatsRxDecryptFailedOnCRC, intraBSSFiltering=intraBSSFiltering, macaclAddrTableEntry=macaclAddrTableEntry, wirelessIfWORPLinkTestStatsTableIndex=wirelessIfWORPLinkTestStatsTableIndex, worpQoSClassTable=worpQoSClassTable, sysLicRadioCompID=sysLicRadioCompID, dhcpRelayModuleInitFailure=dhcpRelayModuleInitFailure, worpIntraCellBlockingGroupID6=worpIntraCellBlockingGroupID6, worpQoSSUMACAddress=worpQoSSUMACAddress, netIpStaticRouteMetric=netIpStaticRouteMetric, globalTrapStatus=globalTrapStatus, worpSiteSurveyChannel=worpSiteSurveyChannel, wirelessIfWORPStaStatsLocalMimoCtrlSNR3=wirelessIfWORPStaStatsLocalMimoCtrlSNR3, staticMACAddrFilterWirelessMACAddress=staticMACAddrFilterWirelessMACAddress, mgmtSnmpTrapHostTableIndex=mgmtSnmpTrapHostTableIndex, wirelessIf11nPropertiesSupportedRxAntennas=wirelessIf11nPropertiesSupportedRxAntennas, radiusSupProfileTableIndex=radiusSupProfileTableIndex, worpQoSSFClassMIR=worpQoSSFClassMIR, mgmtSnmpTrapHostTableComment=mgmtSnmpTrapHostTableComment, worpIntraCellBlockingGroupTableEntryStatus=worpIntraCellBlockingGroupTableEntryStatus, syslog=syslog, worpQoSPIRIPTableIndex=worpQoSPIRIPTableIndex, igmpWireless1MCastTableIndex=igmpWireless1MCastTableIndex, wirelessSecurityCfgTable=wirelessSecurityCfgTable, igmpWireless1MCastGrpMACAddr=igmpWireless1MCastGrpMACAddr, filteringCtrl=filteringCtrl)
mibBuilder.exportSymbols("PROXIM-MIB", tftpFileType=tftpFileType, wirelessIfStaStatsRxMgmtFrames=wirelessIfStaStatsRxMgmtFrames, wirelessIfWORPStatsRegistrationLastReason=wirelessIfWORPStatsRegistrationLastReason, PYSNMP_MODULE_ID=proxim, sysMgmtCfgChangeCnt=sysMgmtCfgChangeCnt, radiusClientAccStatsTableSecIndex=radiusClientAccStatsTableSecIndex, vlanModuleInitFailure=vlanModuleInitFailure, radiusClientAccStatsMalformedResponses=radiusClientAccStatsMalformedResponses, wirelessIfWORPBandwidthLimitType=wirelessIfWORPBandwidthLimitType, wirelessIfBlacklistReason=wirelessIfBlacklistReason, worpIntraCellBlockingGroupID8=worpIntraCellBlockingGroupID8, wirelessIfVAPTableSecIndex=wirelessIfVAPTableSecIndex, V3Password=V3Password, network=network, natStaticPortBindTableEntry=natStaticPortBindTableEntry, wirelessIfStaStatsRxControlFrames=wirelessIfStaStatsRxControlFrames, sysInfo=sysInfo, sysCountryCode=sysCountryCode, worpQoSPIRMapDstIpAddrIndexList=worpQoSPIRMapDstIpAddrIndexList, igmpEth1MCastGrpAgingTimeElapsed=igmpEth1MCastGrpAgingTimeElapsed, stormThresholdTableIndex=stormThresholdTableIndex, advancedFilterDirection=advancedFilterDirection, stpFrameForwardStatus=stpFrameForwardStatus, WEPKeyType=WEPKeyType, wirelessIfWORPTxRate=wirelessIfWORPTxRate, natStaticPortBindStartPortNum=natStaticPortBindStartPortNum, wirelessIfWORPMACACLStatus=wirelessIfWORPMACACLStatus, radiusSrvProfileTableIndex=radiusSrvProfileTableIndex, mgmtSnmpVersion=mgmtSnmpVersion, sntp=sntp, worpSiteSurveyTableSecIndex=worpSiteSurveyTableSecIndex, cpuUsageThresholdExceeded=cpuUsageThresholdExceeded, wirelessIfWORPStaStatsLocalMimoCtrlSNR1=wirelessIfWORPStaStatsLocalMimoCtrlSNR1, wirelessIfBlacklistInfo=wirelessIfBlacklistInfo, worpQoSPIRIPComment=worpQoSPIRIPComment, mgmtAccessTableStatus=mgmtAccessTableStatus, wirelessInterfaceCardRadarInterferenceDetected=wirelessInterfaceCardRadarInterferenceDetected, worpQoSSUQoSClassIndex=worpQoSSUQoSClassIndex, dhcpServerIfTable=dhcpServerIfTable, worpIntraCellBlockingGroupID7=worpIntraCellBlockingGroupID7, mgmtAccessControl=mgmtAccessControl, wirelessIfWORPStatsAuthenticationRequests=wirelessIfWORPStatsAuthenticationRequests, natPortBindingStatus=natPortBindingStatus, radiusClientAccStatsRetransmissions=radiusClientAccStatsRetransmissions, vlanEthTrunkTable=vlanEthTrunkTable, dhcpServerIfTableEntry=dhcpServerIfTableEntry, wirelessIfWORPStaStatsPollNoData=wirelessIfWORPStaStatsPollNoData, macaclTableEntryStatus=macaclTableEntryStatus, filteringModuleInitFailure=filteringModuleInitFailure, worpIntraCellBlockingGroupID3=worpIntraCellBlockingGroupID3, qosProfileTableQoSNACKStatus=qosProfileTableQoSNACKStatus, macaclProfileName=macaclProfileName, worpQoSSFClassSchedularType=worpQoSSFClassSchedularType, stormMulticastThreshold=stormMulticastThreshold, mgmtSnmp=mgmtSnmp, radiusClientAccStatsTimeouts=radiusClientAccStatsTimeouts, wirelessIfWORPStaStatsRemoteMimoCtrlSNR2=wirelessIfWORPStaStatsRemoteMimoCtrlSNR2, wirelessIfOperationalMode=wirelessIfOperationalMode, wirelessIfStatsTableEntry=wirelessIfStatsTableEntry, worpQoSPIRMapRuleName=worpQoSPIRMapRuleName, worpSiteSurveyNumSatellitesRegistered=worpSiteSurveyNumSatellitesRegistered, dhcpRelayServerTableEntry=dhcpRelayServerTableEntry, worpQoSClassSFCTableIndex=worpQoSClassSFCTableIndex, netCfgSecondaryDNSIpAddress=netCfgSecondaryDNSIpAddress, proxim=proxim, staticMACAddrFilterTableEntryStatus=staticMACAddrFilterTableEntryStatus, wirelessIfActiveTPC=wirelessIfActiveTPC, sysGPSLatitude=sysGPSLatitude, wirelessIfWORPStatsReplyMoreData=wirelessIfWORPStatsReplyMoreData, worpQoSPIRPPPoEEncapsulation=worpQoSPIRPPPoEEncapsulation, stormFilterInterface=stormFilterInterface, sysTypeMode=sysTypeMode, sysMgmtReboot=sysMgmtReboot, wirelessIfStaStatsTxPower=wirelessIfStaStatsTxPower, snmpAccessControl=snmpAccessControl, sysMgmtCfgCommit=sysMgmtCfgCommit, wirelessIfWORPStatsPollNoData=wirelessIfWORPStatsPollNoData, wirelessIfWORPTableIndex=wirelessIfWORPTableIndex, filtering=filtering, worpQoSClassSFCValue=worpQoSClassSFCValue, wirelessIfWORPStaStatsLocalTxRate=wirelessIfWORPStaStatsLocalTxRate, wirelessIfStatsRadioReTunes=wirelessIfStatsRadioReTunes, worpSiteSurveyLocalMimoNoise=worpSiteSurveyLocalMimoNoise, tftpOpStatus=tftpOpStatus, wirelessIfStaStatsTxPSDiscard=wirelessIfStaStatsTxPSDiscard, worpIntraCellBlockingGroupID13=worpIntraCellBlockingGroupID13, apSecurity=apSecurity, sysConf=sysConf, wirelessIfVAPRadiusProfileName=wirelessIfVAPRadiusProfileName, worpQoSSFClassNumOfMesgInBurst=worpQoSSFClassNumOfMesgInBurst, DisplayString32=DisplayString32, syslogHostPort=syslogHostPort, wirelessSecurityCfgRekeyingInterval=wirelessSecurityCfgRekeyingInterval, wirelessQoSEDCATable=wirelessQoSEDCATable, wirelessIfWORPStaStatsRemoteMimoCtrlSig3=wirelessIfWORPStaStatsRemoteMimoCtrlSig3, tcpudpPortFilterProtocolName=tcpudpPortFilterProtocolName, systemName=systemName, radiusSupProfileTableEntry=radiusSupProfileTableEntry, wirelessInterfaceChannelChanged=wirelessInterfaceChannelChanged, wirelessIfCurrentOperatingChannel=wirelessIfCurrentOperatingChannel, nat=nat, ripInterfaceAuthType=ripInterfaceAuthType, wirelessIfStaStatsFrequency=wirelessIfStaStatsFrequency, wirelessIfWORPMaxSatellites=wirelessIfWORPMaxSatellites, worpQoSPIRPortTableIndex=worpQoSPIRPortTableIndex, sysLocationName=sysLocationName, wirelessIfWORPLinkTestRemoteMinNoise=wirelessIfWORPLinkTestRemoteMinNoise, netCfgClearIntfStats=netCfgClearIntfStats, wirelessIfWORPStaStatsLocalMimoCtrlSig3=wirelessIfWORPStaStatsLocalMimoCtrlSig3, wirelessIfStats=wirelessIfStats, wirelessIfWORPLinkTestLocalMaxSignal=wirelessIfWORPLinkTestLocalMaxSignal, wirelessIfWORPStatsCurrentDownlinkBandwidth=wirelessIfWORPStatsCurrentDownlinkBandwidth, wirelessIfWORPMTU=wirelessIfWORPMTU, sysFeature=sysFeature, wirelessIfDTIM=wirelessIfDTIM, untaggedFrames=untaggedFrames, wirelessIfWORPStatsRemotePartners=wirelessIfWORPStatsRemotePartners, radiusSupProfileMsgResponseTime=radiusSupProfileMsgResponseTime, etherProtocolFilterProtocolNumber=etherProtocolFilterProtocolNumber, wirelessIfWORPStaStatsMacAddress=wirelessIfWORPStaStatsMacAddress, securityGatewayMacAddress=securityGatewayMacAddress, wirelessIfStatsChain2ExtRSSI=wirelessIfStatsChain2ExtRSSI, wirelessIfWORPLinkTestLocalMaxSNR=wirelessIfWORPLinkTestLocalMaxSNR, wirelessIfWORPStaStatsReplyNoData=wirelessIfWORPStaStatsReplyNoData, worpSiteSurveyChannelRxRate=worpSiteSurveyChannelRxRate, worpQoSPIRMapDstMacIndexList=worpQoSPIRMapDstMacIndexList, sysFeatureBitmap=sysFeatureBitmap, sys=sys, worpQoSSFClassTableEntryStatus=worpQoSSFClassTableEntryStatus, wirelessIfStaStatsTable=wirelessIfStaStatsTable, wirelessIfStaStatsTxDataFrames=wirelessIfStaStatsTxDataFrames, macaclAddrTable=macaclAddrTable, radiusClientAccStatsUnknownTypes=radiusClientAccStatsUnknownTypes, igmpRouterPortListTableIndex=igmpRouterPortListTableIndex, igmpEth1MCastTable=igmpEth1MCastTable, worpSiteSurveyLocalMimoCtrlSig2=worpSiteSurveyLocalMimoCtrlSig2, wirelessIfWORPLinkTestProgressStatus=wirelessIfWORPLinkTestProgressStatus, l2l3QoSDot1DToDot1pMappingTable=l2l3QoSDot1DToDot1pMappingTable, worpSiteSurveyLocalSignalLevel=worpSiteSurveyLocalSignalLevel, igmpEth2MCastGrpMACAddr=igmpEth2MCastGrpMACAddr, interfaceTraps=interfaceTraps, worpQoSPIRPortComment=worpQoSPIRPortComment, netCfgStaticRouteStatus=netCfgStaticRouteStatus, worpQoSPIREtherPriorityLow=worpQoSPIREtherPriorityLow, qoSPolicyTableEntry=qoSPolicyTableEntry, ethernetIfAdminStatus=ethernetIfAdminStatus, mgmtSnmpV3PrivProtocol=mgmtSnmpV3PrivProtocol, radiusClientAuthStatsMalformedResponses=radiusClientAuthStatsMalformedResponses, wirelessIfWORPLinkTestConfTable=wirelessIfWORPLinkTestConfTable, qoSPolicyMarkingStatus=qoSPolicyMarkingStatus, radiusClientAccStatsResponses=radiusClientAccStatsResponses, sysGPSAltitude=sysGPSAltitude, radiusClientAuthStatsBadAuthenticators=radiusClientAuthStatsBadAuthenticators, worpSiteSurveyBaseMACAddress=worpSiteSurveyBaseMACAddress, sysFeatureNumOfSatellitesAllowed=sysFeatureNumOfSatellitesAllowed, wirelessIfWORPStaStatsReceiveFailures=wirelessIfWORPStaStatsReceiveFailures, wirelessIfDDRSTableIndex=wirelessIfDDRSTableIndex, wirelessIf11nPropertiesSupportedTxAntennas=wirelessIf11nPropertiesSupportedTxAntennas, netIpStaticRouteMask=netIpStaticRouteMask, wirelessIfStaStatsRxUnauthPort=wirelessIfStaStatsRxUnauthPort, sysLicFeatureTable=sysLicFeatureTable, mgmtSnmpReadPassword=mgmtSnmpReadPassword, wirelessIfSupportedChannels=wirelessIfSupportedChannels, qosProfileEDCAProfileName=qosProfileEDCAProfileName, igmpEth2MCastTableIndex=igmpEth2MCastTableIndex, ripInterfaceName=ripInterfaceName, worpQoSPIRIPSubMask=worpQoSPIRIPSubMask, dhcpMaxLeaseTime=dhcpMaxLeaseTime, systemTempReachedLimits=systemTempReachedLimits, worpSiteSurveyRemoteMimoCtrlSig3=worpSiteSurveyRemoteMimoCtrlSig3, invalidLicenseFile=invalidLicenseFile, radiusSrvProfileType=radiusSrvProfileType, syslogHostTable=syslogHostTable, ripConfigTableIndex=ripConfigTableIndex, wirelessIfWORPStaStatsRemoteMimoCtrlSNR1=wirelessIfWORPStaStatsRemoteMimoCtrlSNR1, worpIntraCellBlockingMACTable=worpIntraCellBlockingMACTable, mgmtAccessModuleInitFailure=mgmtAccessModuleInitFailure, wirelessIfMon=wirelessIfMon, wirelessIfDDRSTableEntry=wirelessIfDDRSTableEntry, worpIntraCellBlockingMACAddress=worpIntraCellBlockingMACAddress, worpSiteSurveyLocalMimoCtrlSNR3=worpSiteSurveyLocalMimoCtrlSNR3, qosProfileName=qosProfileName, wirelessIf11nPropertiesAMSDUMaxFrameSize=wirelessIf11nPropertiesAMSDUMaxFrameSize, worpQoSClassName=worpQoSClassName, ethernetInActivityTimer=ethernetInActivityTimer, accessVLANPriority=accessVLANPriority, wirelessIfDDRSDefDataRate=wirelessIfDDRSDefDataRate, mgmtSnmpTrapHostTablePassword=mgmtSnmpTrapHostTablePassword, wirelessIfSupportedOperationalMode=wirelessIfSupportedOperationalMode, wirelessIfWORPRadiusProfileIndex=wirelessIfWORPRadiusProfileIndex, mgmtSnmpV3AuthPassword=mgmtSnmpV3AuthPassword, worpQoSSUComment=worpQoSSUComment, l2l3QoSDSCPPriorityLowerLimit=l2l3QoSDSCPPriorityLowerLimit, worpQoSPIRPortTable=worpQoSPIRPortTable, worpSiteSurveyRemoteSignalLevel=worpSiteSurveyRemoteSignalLevel, worpSiteSurveyRemoteMimoNoise=worpSiteSurveyRemoteMimoNoise, worpQoSSFClassName=worpQoSSFClassName, dhcpServerIpPoolEndIpAddress=dhcpServerIpPoolEndIpAddress, wirelessIfAutoChannelSelection=wirelessIfAutoChannelSelection, telnetAccessControl=telnetAccessControl, debugLogBitMask=debugLogBitMask, radiusClientStats=radiusClientStats, radiusClientAuthStatsTimeouts=radiusClientAuthStatsTimeouts, wirelessSecurity=wirelessSecurity, sysGPSLongitude=sysGPSLongitude, igmpEth2MCastTableEntry=igmpEth2MCastTableEntry, wirelessIfVAPTableIndex=wirelessIfVAPTableIndex, radiusClientAuthStatsAccessChallenges=radiusClientAuthStatsAccessChallenges, wirelessSecurityCfgEntryStatus=wirelessSecurityCfgEntryStatus, wirelessIfDDRSRateBlackListInt=wirelessIfDDRSRateBlackListInt, igmpWireless1MCastTable=igmpWireless1MCastTable, deviceMon=deviceMon, worpIntraCellBlockingGroupID10=worpIntraCellBlockingGroupID10, wirelessIfWORPLinkTestRemoteMinSNR=wirelessIfWORPLinkTestRemoteMinSNR, radiusClientAuthStatsPacketsDropped=radiusClientAuthStatsPacketsDropped, netIpWirelessCfgSubnetMask=netIpWirelessCfgSubnetMask, natStaticPortBindLocalAddr=natStaticPortBindLocalAddr, igmpEthernetSnoopingStats=igmpEthernetSnoopingStats, wirelessIfDDRSIncrReTxPercentThrld=wirelessIfDDRSIncrReTxPercentThrld, igmpEth1MCastGrpMACAddr=igmpEth1MCastGrpMACAddr, wirelessSecurityCfgNetworkSecret=wirelessSecurityCfgNetworkSecret, macaclProfileTableIndex=macaclProfileTableIndex, sysutilsModuleInitFailure=sysutilsModuleInitFailure, worpQoSPIRMacTableEntry=worpQoSPIRMacTableEntry, dhcpServerSecondaryDNS=dhcpServerSecondaryDNS, wirelessIfVAPSecurityProfileName=wirelessIfVAPSecurityProfileName, vlanEthTrunkTableIndex=vlanEthTrunkTableIndex, flashModuleInitFailure=flashModuleInitFailure, products=products, Password=Password, worpIntraCellBlockingMACTableEntryStatus=worpIntraCellBlockingMACTableEntryStatus, l2l3QoSDot1DToIPDSCPMappingTable=l2l3QoSDot1DToIPDSCPMappingTable, VlanId=VlanId, tcpudpPortFilterTableIndex=tcpudpPortFilterTableIndex, wirelessIfWORPStaStatsAverageLocalSignal=wirelessIfWORPStaStatsAverageLocalSignal, wirelessIfWORPStaStatsPollData=wirelessIfWORPStaStatsPollData, wirelessIf11nPropertiesTableEntry=wirelessIf11nPropertiesTableEntry, wirelessIfWORPLinkTestLocalCurSNR=wirelessIfWORPLinkTestLocalCurSNR, worpSiteSurveyRemoteNoiseLevel=worpSiteSurveyRemoteNoiseLevel, wirelessIfStaStatsRxDeMicFail=wirelessIfStaStatsRxDeMicFail, interface=interface, natStaticPortBindPortType=natStaticPortBindPortType, stormThresholdTable=stormThresholdTable, sysInvMgmtDaughterCardAvailability=sysInvMgmtDaughterCardAvailability, wirelessInActivityTimerInSecs=wirelessInActivityTimerInSecs, wirelessIfDDRSTable=wirelessIfDDRSTable, wirelessIfStatsPhyErrors=wirelessIfStatsPhyErrors, radiusSupProfileName=radiusSupProfileName, radiusClientAuthStatsUnknownTypes=radiusClientAuthStatsUnknownTypes, currentUnitTemp=currentUnitTemp, worpQoSSFClassTableEntry=worpQoSSFClassTableEntry, natStaticPortBindEndPortNum=natStaticPortBindEndPortNum, worpQoSSFClassStatus=worpQoSSFClassStatus, wirelessIfStatsChain1CtlRSSI=wirelessIfStatsChain1CtlRSSI)
mibBuilder.exportSymbols("PROXIM-MIB", syslogHostComment=syslogHostComment, wirelessIfWORPStatsTable=wirelessIfWORPStatsTable, wirelessIfWORPStaStatsLocalMimoNoise=wirelessIfWORPStaStatsLocalMimoNoise, netCfg=netCfg, staticMACAddrFilterTable=staticMACAddrFilterTable, wirelessIfWORPIntfMacAddress=wirelessIfWORPIntfMacAddress, debugLogSize=debugLogSize, wirelessIfWORPStaStatsAverageRemoteSignal=wirelessIfWORPStaStatsAverageRemoteSignal, wirelessIfStaStatsTxBytes=wirelessIfStaStatsTxBytes, securityGateway=securityGateway, sntpShowCurrentTime=sntpShowCurrentTime, wirelessQoSEDCATableAPCWmax=wirelessQoSEDCATableAPCWmax, wirelessIfWORPLinkTestLocalCurSignal=wirelessIfWORPLinkTestLocalCurSignal, worpSiteSurveyOperationIfName=worpSiteSurveyOperationIfName, wirelessIfWORPStatsPollData=wirelessIfWORPStatsPollData, l2l3QoSDot1dPriority=l2l3QoSDot1dPriority, wirelessInterfaceCardInitFailure=wirelessInterfaceCardInitFailure, vlanEthCfgTable=vlanEthCfgTable, worpSiteSurveyOperationStatus=worpSiteSurveyOperationStatus, netIp=netIp, wirelessIfWORPRadiusMACACLStatus=wirelessIfWORPRadiusMACACLStatus, wirelessSecurityCfgTableIndex=wirelessSecurityCfgTableIndex, advancedFiltering=advancedFiltering, dhcpServerIfTableComment=dhcpServerIfTableComment, qoSPolicyTableIndex=qoSPolicyTableIndex, tcpudpPortFilter=tcpudpPortFilter, igmpWireless1MCastGrpAgingTimeElapsed=igmpWireless1MCastGrpAgingTimeElapsed, sysInvMgmtCompReleaseVersion=sysInvMgmtCompReleaseVersion, igmpEth2MCastGrpAgingTimeElapsed=igmpEth2MCastGrpAgingTimeElapsed, wirelessIf11nPropertiesNumOfSpatialStreams=wirelessIf11nPropertiesNumOfSpatialStreams, qoSPolicyTable=qoSPolicyTable, qoSPolicyPriorityMapping=qoSPolicyPriorityMapping, wirelessIfStaStatsTxMgmtFrames=wirelessIfStaStatsTxMgmtFrames, qoSPolicyTableSecIndex=qoSPolicyTableSecIndex, worpSiteSurveyLocalMimoCtrlSNR2=worpSiteSurveyLocalMimoCtrlSNR2, qb_8100=qb_8100, igmpSnoopingGlobalStatus=igmpSnoopingGlobalStatus, wirelessIfDDRSRateBackOffInt=wirelessIfDDRSRateBackOffInt, syslogHostIpAddress=syslogHostIpAddress, sysMgmt=sysMgmt, wirelessIfVAPRadiusMACACLStatus=wirelessIfVAPRadiusMACACLStatus, protocolFilter=protocolFilter, staticMACAddrFilterWirelessMACMask=staticMACAddrFilterWirelessMACMask, wirelessIfWORPStaStatsTable=wirelessIfWORPStaStatsTable, wirelessIfWORPStatsTableEntry=wirelessIfWORPStatsTableEntry, wirelessIfWORPStatsActiveUplinkCIR=wirelessIfWORPStatsActiveUplinkCIR, rip=rip, worpSiteSurveyRemoteMimoCtrlSNR1=worpSiteSurveyRemoteMimoCtrlSNR1, wirelessIfDDRSIncrAvgSNRThrld=wirelessIfDDRSIncrAvgSNRThrld, netIpStaticRouteDestAddr=netIpStaticRouteDestAddr, wirelessIfStatsChain2CtlRSSI=wirelessIfStatsChain2CtlRSSI, tftp=tftp, sysInvMgmtCompTableIndex=sysInvMgmtCompTableIndex, qoSPolicyTableEntryStatus=qoSPolicyTableEntryStatus, wirelessIfWORPStaStatsSendRetries=wirelessIfWORPStaStatsSendRetries, wirelessIfStatsChain0ExtRSSI=wirelessIfStatsChain0ExtRSSI, worpIntraCellBlockingGroupID4=worpIntraCellBlockingGroupID4, wirelessIfWORPStatsReceiveRetries=wirelessIfWORPStatsReceiveRetries, dhcpRelayServerIpAddress=dhcpRelayServerIpAddress, worpQoSPIRMacAddr=worpQoSPIRMacAddr, imageDownloadFailed=imageDownloadFailed, stormThresholdTableEntry=stormThresholdTableEntry, worpQoSSUTableEntry=worpQoSSUTableEntry, staticMACAddrFilterComment=staticMACAddrFilterComment, sysTypeSupportedMode=sysTypeSupportedMode, worpSiteSurveyLocalTxRate=worpSiteSurveyLocalTxRate, eventlog=eventlog, wirelessIfPropertiesTableIndex=wirelessIfPropertiesTableIndex, mgmtSnmpAccessTableIndex=mgmtSnmpAccessTableIndex, worpIntraCellBlockingGroupID15=worpIntraCellBlockingGroupID15, etherProtocolFilteringType=etherProtocolFilteringType, dhcpServerNetMask=dhcpServerNetMask, tcpudpPortFilterCtrl=tcpudpPortFilterCtrl, wirelessIfWORPStats=wirelessIfWORPStats, macaclAddrTableSecIndex=macaclAddrTableSecIndex, wirelessSecurityCfgKey4=wirelessSecurityCfgKey4, dhcpRelayServerTable=dhcpRelayServerTable, wirelessIfStatsTxBytes=wirelessIfStatsTxBytes, worpSiteSurveyLocalMimoCtrlSig3=worpSiteSurveyLocalMimoCtrlSig3, staticMACAddrFilter=staticMACAddrFilter, sysNetworkMode=sysNetworkMode, httpPassword=httpPassword, radiusClientAuthStatsTableEntry=radiusClientAuthStatsTableEntry, sntpSecondaryServerName=sntpSecondaryServerName, wirelessIfDDRSDecrReTxPercentThrld=wirelessIfDDRSDecrReTxPercentThrld, DisplayString55=DisplayString55, wirelessIfStaStatsTableEntry=wirelessIfStaStatsTableEntry, igmpWireless1MCastTableEntry=igmpWireless1MCastTableEntry, macacl=macacl, radiusClientAccStatsRequests=radiusClientAccStatsRequests, sysLicFeatureType=sysLicFeatureType, wirelessIfPropertiesRadioStatus=wirelessIfPropertiesRadioStatus, worpQoSPIRMapTable=worpQoSPIRMapTable, wirelessIfStaStatsTxProbeReq=wirelessIfStaStatsTxProbeReq, radiusClientAccStatsRoundTripTime=radiusClientAccStatsRoundTripTime, radiusSrvServerPort=radiusSrvServerPort, dhcpServerIpPoolTableEntryStatus=dhcpServerIpPoolTableEntryStatus, worpIntraCellBlockingStatus=worpIntraCellBlockingStatus, wirelessIfDDRSAggressiveIndex=wirelessIfDDRSAggressiveIndex, wirelessIfBlacklistInfoTable=wirelessIfBlacklistInfoTable, wirelessIfPropertiesTable=wirelessIfPropertiesTable, wirelessIfWORPStatsRegistrationRequests=wirelessIfWORPStatsRegistrationRequests, etherProtocolFilterTableEntry=etherProtocolFilterTableEntry, radiusSrvProfileTableEntry=radiusSrvProfileTableEntry, wirelessIfStaStatsRxDefragFailed=wirelessIfStaStatsRxDefragFailed, telnetPassword=telnetPassword, wirelessIfStaStatsRxBeacons=wirelessIfStaStatsRxBeacons, sysInvMgmtCompName=sysInvMgmtCompName, worpIntraCellBlockingGroupID2=worpIntraCellBlockingGroupID2, qoSPolicyTablePolicyName=qoSPolicyTablePolicyName, sntpDayLightSavingTime=sntpDayLightSavingTime, worpSiteSurveyTable=worpSiteSurveyTable, ethernetIf=ethernetIf, httpAccessControl=httpAccessControl, syslogStatus=syslogStatus, sysFeatureCtrlID=sysFeatureCtrlID, sntpModuleInitFailure=sntpModuleInitFailure, dhcpServerModuleInitFailure=dhcpServerModuleInitFailure, ripInterfaceVersionNum=ripInterfaceVersionNum, sysMgmtCfgRestore=sysMgmtCfgRestore, wirelessIfWORPStaBridgePort=wirelessIfWORPStaBridgePort, worpIntraCellBlockingGroupTableIndex=worpIntraCellBlockingGroupTableIndex, mp_8100=mp_8100, wirelessIfVAPRadiusAccStatus=wirelessIfVAPRadiusAccStatus, wirelessIfWORPStaStatsReplyData=wirelessIfWORPStaStatsReplyData, igmpEth2MCastTable=igmpEth2MCastTable, vlan=vlan, worpQoSPIRMacTable=worpQoSPIRMacTable, radiusSrvProfileTable=radiusSrvProfileTable, wirelessIfWORPLinkTestConfTableEntry=wirelessIfWORPLinkTestConfTableEntry, radiusClientAuthStatsRoundTripTime=radiusClientAuthStatsRoundTripTime, wirelessIfStatsTableIndex=wirelessIfStatsTableIndex, sshPort=sshPort, wirelessIfWORPStatsReceiveSuccess=wirelessIfWORPStatsReceiveSuccess, radiusClientAuthStatsTableSecIndex=radiusClientAuthStatsTableSecIndex, wirelessIfStaStatsHTCapability=wirelessIfStaStatsHTCapability, ramMemoryThresholdExceeded=ramMemoryThresholdExceeded, sysInvMgmtCompVariant=sysInvMgmtCompVariant, dhcpServer=dhcpServer, sysContactPhoneNumber=sysContactPhoneNumber, sysLicRadioAntennaMimoType=sysLicRadioAntennaMimoType, worpQoSPIRIPToSLow=worpQoSPIRIPToSLow, worpSiteSurveyTableEntry=worpSiteSurveyTableEntry, advancedFilterTableEntryStatus=advancedFilterTableEntryStatus, worpQoSSFClassCIR=worpQoSSFClassCIR, sysActiveNetworkMode=sysActiveNetworkMode, wirelessIfWORPStatsAverageRemoteNoise=wirelessIfWORPStatsAverageRemoteNoise, wirelessIfStatsTable=wirelessIfStatsTable, allIntAccessControl=allIntAccessControl, staticMACAddrFilterWiredMACMask=staticMACAddrFilterWiredMACMask, mgmtSnmpV3AuthProtocol=mgmtSnmpV3AuthProtocol, macaclAddrComment=macaclAddrComment, wirelessIfWORPStatsProvisionedUplinkCIR=wirelessIfWORPStatsProvisionedUplinkCIR, wirelessIfWORPTable=wirelessIfWORPTable, qosProfileTable=qosProfileTable, worpIntraCellBlockingGroupID12=worpIntraCellBlockingGroupID12, ethernetIfPropertiesTable=ethernetIfPropertiesTable, securityGatewayStatus=securityGatewayStatus, wirelessSecurityCfgEncryptionType=wirelessSecurityCfgEncryptionType, dhcpRelayServerTableEntryStatus=dhcpRelayServerTableEntryStatus, eventLogReset=eventLogReset, routingModuleInitFailure=routingModuleInitFailure, wirelessIfStatsChain1ExtRSSI=wirelessIfStatsChain1ExtRSSI, dhcpRelay=dhcpRelay, vlanStatus=vlanStatus, wirelessIfStaStatsTxAssociationFailedFrames=wirelessIfStaStatsTxAssociationFailedFrames, highTempThreshold=highTempThreshold, igmpRouterAgingTimeElapsed=igmpRouterAgingTimeElapsed, ethernetIfTxModeAndSpeed=ethernetIfTxModeAndSpeed, mgmtVLANIdentifier=mgmtVLANIdentifier, wirelessIfStaStatsInactivityTimer=wirelessIfStaStatsInactivityTimer, wirelessIfBlacklistedChannelNum=wirelessIfBlacklistedChannelNum, wirelessIfWORPMode=wirelessIfWORPMode, wirelessIfWORPLinkTestRemoteMaxSignal=wirelessIfWORPLinkTestRemoteMaxSignal, worpSiteSurveyOperationTable=worpSiteSurveyOperationTable, natStaticPortBindTable=natStaticPortBindTable, wirelessIfStaStatsIfNumber=wirelessIfStaStatsIfNumber, wirelessIfWORPStaStatsLocalChainBalStatus=wirelessIfWORPStaStatsLocalChainBalStatus, wirelessIfWORPStaStatsRemoteChainBalStatus=wirelessIfWORPStaStatsRemoteChainBalStatus, InterfaceBitmask=InterfaceBitmask, worpQoSSUTable=worpQoSSUTable, sysLicFeatureTableEntry=sysLicFeatureTableEntry, igmpRouterPortNumber=igmpRouterPortNumber, wirelessIfStaStatsStationOperatingMode=wirelessIfStaStatsStationOperatingMode, securityTraps=securityTraps, worpIntraCellBlockingGroupID1=worpIntraCellBlockingGroupID1, sysInvMgmtCompId=sysInvMgmtCompId, dhcpServerIpPoolTableEntry=dhcpServerIpPoolTableEntry, syslogModuleInitFailure=syslogModuleInitFailure, advancedFilterTableIndex=advancedFilterTableIndex, worpQoSSUTableIndex=worpQoSSUTableIndex, wirelessIfWORPBaseStationName=wirelessIfWORPBaseStationName, tcpudpPortFilterInterface=tcpudpPortFilterInterface, wirelessIfWORPLinkTestRemoteCurSNR=wirelessIfWORPLinkTestRemoteCurSNR, wirelessIfStatsRxBytes=wirelessIfStatsRxBytes, wirelessIfDfsNumSatWithRadarForFreqSwitch=wirelessIfDfsNumSatWithRadarForFreqSwitch, wirelessIfCellSize=wirelessIfCellSize, worpQoSPIRIPToSMask=worpQoSPIRIPToSMask, wirelessIfVAPVLANPriority=wirelessIfVAPVLANPriority, sysInvMgmtCompMajorVersion=sysInvMgmtCompMajorVersion, worpQoSPIRMacMask=worpQoSPIRMacMask, ripConfigTable=ripConfigTable, radiusSrvProfileTableSecIndex=radiusSrvProfileTableSecIndex, wirelessIfVAPFragmentationThreshold=wirelessIfVAPFragmentationThreshold, mgmtVLANPriority=mgmtVLANPriority, wirelessIfVAPTable=wirelessIfVAPTable, wirelessIf=wirelessIf, l2l3QoSDot1dPriorityIPDSCP=l2l3QoSDot1dPriorityIPDSCP, worpQoSPIRRuleName=worpQoSPIRRuleName, dhcpServerIpPoolTableIndex=dhcpServerIpPoolTableIndex, wirelessIfStaStatsTxAuthenticationFailed=wirelessIfStaStatsTxAuthenticationFailed, sysMonitorRAMUsage=sysMonitorRAMUsage, syslogHostTableEntry=syslogHostTableEntry, l2l3QoSDot1DToDot1pMappingTableIndex=l2l3QoSDot1DToDot1pMappingTableIndex, worpSiteSurveyRemoteMimoCtrlSNR3=worpSiteSurveyRemoteMimoCtrlSNR3, worpSiteSurveyLocalSNR=worpSiteSurveyLocalSNR, wirelessIfWORPStaStatsTableEntry=wirelessIfWORPStaStatsTableEntry, tftpOpType=tftpOpType, wirelessIfWORPLinkTestStationName=wirelessIfWORPLinkTestStationName, wirelessIfMonNumOfStaConnected=wirelessIfMonNumOfStaConnected, worpQoSPIREtherType=worpQoSPIREtherType, wirelessIfStaStatsRxBytes=wirelessIfStaStatsRxBytes, wirelessSecurityCfgKey3=wirelessSecurityCfgKey3, accessVLANId=accessVLANId, worpSiteSurveyLocalChainBalStatus=worpSiteSurveyLocalChainBalStatus, sysMgmtFactoryReset=sysMgmtFactoryReset, worpIntraCellBlockingMACTableEntry=worpIntraCellBlockingMACTableEntry, etherProtocolFilterTableStatus=etherProtocolFilterTableStatus, radiusSrvIPADDR=radiusSrvIPADDR, wirelessIfStaStatsAssocationTime=wirelessIfStaStatsAssocationTime, wirelessIfWORPStatsSendRetries=wirelessIfWORPStatsSendRetries, wirelessIfWORPLinkTestLocalMinSignal=wirelessIfWORPLinkTestLocalMinSignal, wirelessIfSupportedChannelBandwidth=wirelessIfSupportedChannelBandwidth, wirelessIfBlacklistTimeElapsed=wirelessIfBlacklistTimeElapsed, wirelessIfSupportedRate=wirelessIfSupportedRate, worpQoSClassPIRTableIndex=worpQoSClassPIRTableIndex, radiusClientAccStatsTable=radiusClientAccStatsTable, sysLicRadiovariantID=sysLicRadiovariantID, worpQoSClassTableEntry=worpQoSClassTableEntry, worpQoSPIRPortTableEntry=worpQoSPIRPortTableEntry)
