# SNMP MIB module (PW-TC-STD-R-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/rad/PW-TC-STD-R-MIB
...
pwTcStdMIBR = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 11)
)
if mibBuilder.loadTexts:
    pwTcStdMIBR.setRevisions(
        ("2007-02-04 12:00",)
    )
