...
mibBuilder.exportSymbols("CISCO-PPPOE-MIB", cPppoeSystemLimitsThresholdsNotifGroup=cPppoeSystemLimitsThresholdsNotifGroup, cPppoeSystemPerMacThrottleRatelimit=cPppoeSystemPerMacThrottleRatelimit, cPppoeSystemCurrSessions=cPppoeSystemCurrSessions, cPppoeVcCfgInfo=cPppoeVcCfgInfo, cPppoeVcSessionThresholdTrap=cPppoeVcSessionThresholdTrap, ciscoPppoeMIBCompliances=ciscoPppoeMIBCompliances, cPppoeSessionsPerInterfaceTable=cPppoeSessionsPerInterfaceTable, cPppoeVcExceededSessionErrors=cPppoeVcExceededSessionErrors, cPppoeSystemSessionPerVCLimitNotif=cPppoeSystemSessionPerVCLimitNotif, cPppoeSessionsPerInterfaceEntry=cPppoeSessionsPerInterfaceEntry, ciscoPppoeMIBNotificationPrefix=ciscoPppoeMIBNotificationPrefix, cPppoeSystemSessionPerMACLimitNotif=cPppoeSystemSessionPerMACLimitNotif, cPppoeSystemSessionPerVLANThrottleNotif=cPppoeSystemSessionPerVLANThrottleNotif, cPppoeSystemSessionLossThresholdNotif=cPppoeSystemSessionLossThresholdNotif, cPppoeSystemSessionInnerVlanID=cPppoeSystemSessionInnerVlanID, cPppoeSystemLimitsThresholdsGroup=cPppoeSystemLimitsThresholdsGroup, cPppoeSystemMaxAllowedSessions=cPppoeSystemMaxAllowedSessions, PYSNMP_MODULE_ID=ciscoPppoeMIB, cPppoeSystemSessionVlanID=cPppoeSystemSessionVlanID, cPppoeTransSessions=cPppoeTransSessions, cPppoeNotificationsGroup=cPppoeNotificationsGroup, cPppoeSystemHighWaterSessions=cPppoeSystemHighWaterSessions, cPppoeSystemSessionPerVLANLimitNotif=cPppoeSystemSessionPerVLANLimitNotif, cPppoeSystemPerVCThrottleRatelimit=cPppoeSystemPerVCThrottleRatelimit, cPppoeSystemPerVClimit=cPppoeSystemPerVClimit, cPppoeSystemPerMacIWFSessionlimit=cPppoeSystemPerMacIWFSessionlimit, cPppoeVcSessionsGroup=cPppoeVcSessionsGroup, cPppoeVcEnable=cPppoeVcEnable, ciscoPppoeMIBGroups=ciscoPppoeMIBGroups, cPppoeSystemSessionNotifyObjects=cPppoeSystemSessionNotifyObjects, cPppoeVcCfgEntry=cPppoeVcCfgEntry, cPppoeVcCfgTable=cPppoeVcCfgTable, cPppoePerInterfaceGroup=cPppoePerInterfaceGroup, cPppoeVcSessionsEntry=cPppoeVcSessionsEntry, cPppoeSessionsPerInterfaceInfo=cPppoeSessionsPerInterfaceInfo, cPppoeVcMaxAllowedSessions=cPppoeVcMaxAllowedSessions, cPppoeSystemLimitsThresholdsNotifObjectsGroup=cPppoeSystemLimitsThresholdsNotifObjectsGroup, cPppoeVcSessionsTable=cPppoeVcSessionsTable, cPppoeSystemSessionVci=cPppoeSystemSessionVci, cPppoeVcCurrSessions=cPppoeVcCurrSessions, cPppoePtaSessions=cPppoePtaSessions, cPppoeVcSessionsInfo=cPppoeVcSessionsInfo, cPppoeSystemSessionLossPercent=cPppoeSystemSessionLossPercent, cPppoeSystemSessionVpi=cPppoeSystemSessionVpi, ciscoPppoeMIBNotification=ciscoPppoeMIBNotification, cPppoeFwdedSessions=cPppoeFwdedSessions, cPppoeSystemSessionLossPercentNotif=cPppoeSystemSessionLossPercentNotif, cPppoeVcCfgGroup=cPppoeVcCfgGroup, ciscoPppoeMIBObjects=ciscoPppoeMIBObjects, cPppoeSystemPerVLANthrottleRatelimit=cPppoeSystemPerVLANthrottleRatelimit, cPppoeVcHighWaterSessions=cPppoeVcHighWaterSessions, cPppoePerInterfaceSessionLossPercent=cPppoePerInterfaceSessionLossPercent, cPppoePerInterfaceSessionLossThreshold=cPppoePerInterfaceSessionLossThreshold, cPppoeSystemSessionPerMACThrottleNotif=cPppoeSystemSessionPerMACThrottleNotif, cPppoePerInterfaceSessionLossPercentNotif=cPppoePerInterfaceSessionLossPercentNotif, ciscoPppoeMIBBasicCompliance=ciscoPppoeMIBBasicCompliance, cPppoeSystemSessionInfo=cPppoeSystemSessionInfo, ciscoPppoeMIBConformance=ciscoPppoeMIBConformance, cPppoeSystemThresholdSessions=cPppoeSystemThresholdSessions, cPppoeSystemPerMacSessionlimit=cPppoeSystemPerMacSessionlimit, ciscoPppoeMIBBasicComplianceRev1=ciscoPppoeMIBBasicComplianceRev1, cPppoeSystemSessionThresholdTrap=cPppoeSystemSessionThresholdTrap, cPppoeSystemGroup=cPppoeSystemGroup, ciscoPppoeMIB=ciscoPppoeMIB, cPppoeSystemExceededSessionErrors=cPppoeSystemExceededSessionErrors, cPppoeVcThresholdSessions=cPppoeVcThresholdSessions, cPppoeSystemSessionPerVCThrottleNotif=cPppoeSystemSessionPerVCThrottleNotif, cPppoeSystemPerVLANlimit=cPppoeSystemPerVLANlimit, cPppoeSystemSessionClientMacAddress=cPppoeSystemSessionClientMacAddress, cPppoeTotalSessions=cPppoeTotalSessions, cPppoeSystemSessionLossThreshold=cPppoeSystemSessionLossThreshold, cPppoePerInterfaceSessionLossThresholdNotif=cPppoePerInterfaceSessionLossThresholdNotif)
