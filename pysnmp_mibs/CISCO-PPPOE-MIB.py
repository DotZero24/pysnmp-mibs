...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-PPPOE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:34:03 2025
...
_CPppoeVcEnable_Type.__name__ = "TruthValue"
...
ciscoPppoeMIBBasicCompliance.setObjects(
      *(("CISCO-PPPOE-MIB", "cPppoeSystemGroup"),
        ("CISCO-PPPOE-MIB", "cPppoeVcCfgGroup"),
        ("CISCO-PPPOE-MIB", "cPppoeVcSessionsGroup"),
        ("CISCO-PPPOE-MIB", "cPppoePerInterfaceGroup"),
        ("CISCO-PPPOE-MIB", "cPppoeNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoPppoeMIBBasicComplianceRev1.setObjects(
      *(("CISCO-PPPOE-MIB", "cPppoeSystemGroup"),
        ("CISCO-PPPOE-MIB", "cPppoeVcCfgGroup"),
        ("CISCO-PPPOE-MIB", "cPppoeVcSessionsGroup"),
        ("CISCO-PPPOE-MIB", "cPppoePerInterfaceGroup"),
        ("CISCO-PPPOE-MIB", "cPppoeNotificationsGroup"),
        ("CISCO-PPPOE-MIB", "cPppoeSystemLimitsThresholdsGroup"),
        ("CISCO-PPPOE-MIB", "cPppoeSystemLimitsThresholdsNotifObjectsGroup"),
        ("CISCO-PPPOE-MIB", "cPppoeSystemLimitsThresholdsNotifGroup"))
)
if mibBuilder.loadTexts:
