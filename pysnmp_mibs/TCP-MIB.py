...
mibBuilder.exportSymbols("TCP-MIB", tcpMIB=tcpMIB, tcpHCGroup=tcpHCGroup, tcpMaxConn=tcpMaxConn, tcpMIBCompliance2=tcpMIBCompliance2, PYSNMP_MODULE_ID=tcpMIB, tcpListenerLocalAddress=tcpListenerLocalAddress, tcp=tcp, tcpConnectionRemPort=tcpConnectionRemPort, tcpOutSegs=tcpOutSegs, tcpConnState=tcpConnState, tcpInErrs=tcpInErrs, tcpRtoMin=tcpRtoMin, tcpConnectionLocalAddress=tcpConnectionLocalAddress, tcpConnLocalPort=tcpConnLocalPort, tcpConnectionRemAddress=tcpConnectionRemAddress, tcpConnRemAddress=tcpConnRemAddress, tcpListenerLocalAddressType=tcpListenerLocalAddressType, tcpConnRemPort=tcpConnRemPort, tcpMIBGroups=tcpMIBGroups, tcpListenerProcess=tcpListenerProcess, tcpConnectionLocalPort=tcpConnectionLocalPort, tcpMIBCompliance=tcpMIBCompliance, tcpHCInSegs=tcpHCInSegs, tcpConnectionTable=tcpConnectionTable, tcpCurrEstab=tcpCurrEstab, tcpConnectionEntry=tcpConnectionEntry, tcpListenerTable=tcpListenerTable, tcpListenerEntry=tcpListenerEntry, tcpRtoAlgorithm=tcpRtoAlgorithm, tcpConnTable=tcpConnTable, tcpMIBCompliances=tcpMIBCompliances, tcpConnectionProcess=tcpConnectionProcess, tcpGroup=tcpGroup, tcpPassiveOpens=tcpPassiveOpens, tcpAttemptFails=tcpAttemptFails, tcpConnEntry=tcpConnEntry, tcpConnectionState=tcpConnectionState, tcpConnectionLocalAddressType=tcpConnectionLocalAddressType, tcpHCOutSegs=tcpHCOutSegs, tcpRetransSegs=tcpRetransSegs, tcpEstabResets=tcpEstabResets, tcpConnLocalAddress=tcpConnLocalAddress, tcpInSegs=tcpInSegs, tcpConnectionGroup=tcpConnectionGroup, tcpBaseGroup=tcpBaseGroup, tcpActiveOpens=tcpActiveOpens, tcpOutRsts=tcpOutRsts, tcpConnectionRemAddressType=tcpConnectionRemAddressType, tcpListenerLocalPort=tcpListenerLocalPort, tcpMIBConformance=tcpMIBConformance, tcpRtoMax=tcpRtoMax, tcpListenerGroup=tcpListenerGroup)
