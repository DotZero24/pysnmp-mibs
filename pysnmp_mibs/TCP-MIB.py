...
mibBuilder.exportSymbols("TCP-MIB", tcpOutSegs=tcpOutSegs, tcpListenerEntry=tcpListenerEntry, tcpRtoAlgorithm=tcpRtoAlgorithm, tcp=tcp, tcpConnState=tcpConnState, tcpMIBGroups=tcpMIBGroups, tcpConnectionLocalPort=tcpConnectionLocalPort, PYSNMP_MODULE_ID=tcpMIB, tcpConnectionRemAddressType=tcpConnectionRemAddressType, tcpConnLocalAddress=tcpConnLocalAddress, tcpInErrs=tcpInErrs, tcpCurrEstab=tcpCurrEstab, tcpOutRsts=tcpOutRsts, tcpMaxConn=tcpMaxConn, tcpMIB=tcpMIB, tcpListenerLocalPort=tcpListenerLocalPort, tcpListenerLocalAddress=tcpListenerLocalAddress, tcpConnTable=tcpConnTable, tcpListenerProcess=tcpListenerProcess, tcpListenerTable=tcpListenerTable, tcpConnRemAddress=tcpConnRemAddress, tcpListenerGroup=tcpListenerGroup, tcpMIBCompliance=tcpMIBCompliance, tcpBaseGroup=tcpBaseGroup, tcpRtoMax=tcpRtoMax, tcpConnectionTable=tcpConnectionTable, tcpConnectionState=tcpConnectionState, tcpAttemptFails=tcpAttemptFails, tcpConnEntry=tcpConnEntry, tcpHCOutSegs=tcpHCOutSegs, tcpMIBCompliances=tcpMIBCompliances, tcpConnectionLocalAddressType=tcpConnectionLocalAddressType, tcpMIBCompliance2=tcpMIBCompliance2, tcpGroup=tcpGroup, tcpConnectionRemPort=tcpConnectionRemPort, tcpHCInSegs=tcpHCInSegs, tcpMIBConformance=tcpMIBConformance, tcpHCGroup=tcpHCGroup, tcpConnectionProcess=tcpConnectionProcess, tcpConnRemPort=tcpConnRemPort, tcpPassiveOpens=tcpPassiveOpens, tcpEstabResets=tcpEstabResets, tcpRetransSegs=tcpRetransSegs, tcpConnectionLocalAddress=tcpConnectionLocalAddress, tcpInSegs=tcpInSegs, tcpConnectionGroup=tcpConnectionGroup, tcpConnectionEntry=tcpConnectionEntry, tcpListenerLocalAddressType=tcpListenerLocalAddressType, tcpConnectionRemAddress=tcpConnectionRemAddress, tcpRtoMin=tcpRtoMin, tcpConnLocalPort=tcpConnLocalPort, tcpActiveOpens=tcpActiveOpens)
