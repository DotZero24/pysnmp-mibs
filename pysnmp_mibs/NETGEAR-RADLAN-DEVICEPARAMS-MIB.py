# SNMP MIB module (NETGEAR-RADLAN-DEVICEPARAMS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-DEVICEPARAMS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:28:27 2025
...
rndActiveSoftwareFileEntry = _RndActiveSoftwareFileEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 13, 1, 1)
)
rndActiveSoftwareFileEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DEVICEPARAMS-MIB", "rndUnitNumber"),
)
if mibBuilder.loadTexts:
...
rndUnitNumber = _RndUnitNumber_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 13, 1, 1, 1),
    _RndUnitNumber_Type()
)
...
rndActiveSoftwareFile = _RndActiveSoftwareFile_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 13, 1, 1, 2),
...
rndActiveSoftwareFileAfterReset = _RndActiveSoftwareFileAfterReset_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 13, 1, 1, 3),
...
rndStackUnitNumber = _RndStackUnitNumber_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 1),
...
rndImage1Name = _RndImage1Name_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 2),
    _RndImage1Name_Type()
)
...
rndImage2Name = _RndImage2Name_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 3),
    _RndImage2Name_Type()
)
...
rndImage1Version = _RndImage1Version_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 4),
...
rndImage2Version = _RndImage2Version_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 5),
...
rndImage1Date = _RndImage1Date_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 6),
    _RndImage1Date_Type()
)
...
rndImage2Date = _RndImage2Date_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 7),
    _RndImage2Date_Type()
)
...
rndImage1Time = _RndImage1Time_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 8),
    _RndImage1Time_Type()
)
...
rndImage2Time = _RndImage2Time_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 9),
    _RndImage2Time_Type()
)
...
rndImage1Description = _RndImage1Description_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 10),
...
rndImage2Description = _RndImage2Description_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 1, 1, 11),
...
rlComponentsInfoEntry = _RlComponentsInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 2, 1)
)
rlComponentsInfoEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DEVICEPARAMS-MIB", "rlComponentsInfoStackUnitNumber"),
    (0, "NETGEAR-RADLAN-DEVICEPARAMS-MIB", "rlComponentsInfoImageId"),
    (1, "NETGEAR-RADLAN-DEVICEPARAMS-MIB", "rlComponentsInfoComponent"),
)
if mibBuilder.loadTexts:
...
rlComponentsInfoStackUnitNumber = _RlComponentsInfoStackUnitNumber_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 2, 1, 1),
...
rlComponentsInfoImageId = _RlComponentsInfoImageId_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 2, 1, 2),
...
rlComponentsInfoComponent = _RlComponentsInfoComponent_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 2, 1, 3),
...
rlComponentsInfoBaseline = _RlComponentsInfoBaseline_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 2, 16, 2, 1, 5),
