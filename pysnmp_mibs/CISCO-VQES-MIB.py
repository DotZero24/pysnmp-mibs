...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VQES-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:39:46 2025
...
_CvqsNotificationsEnable_Type.__name__ = "TruthValue"
...
cvqsMIBCompliance.setObjects(
      *(("CISCO-VQES-MIB", "ciscoVqeSControlGroup"),
        ("CISCO-VQES-MIB", "ciscoVqeSChannelGroup"),
        ("CISCO-VQES-MIB", "ciscoVqeSERGroup"),
        ("CISCO-VQES-MIB", "ciscoVqeSRCCGroup"),
        ("CISCO-VQES-MIB", "ciscoVqeSCapacityGroup"),
        ("CISCO-VQES-MIB", "ciscoVqeSNotifGroup"))
)
if mibBuilder.loadTexts:
