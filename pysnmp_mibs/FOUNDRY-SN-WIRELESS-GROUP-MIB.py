...
mibBuilder.exportSymbols("FOUNDRY-SN-WIRELESS-GROUP-MIB", wgRoamingPeerConnectionStatus=wgRoamingPeerConnectionStatus, wgVpnPTServerIpAddress=wgVpnPTServerIpAddress, wgIfPnPLearnNewAP=wgIfPnPLearnNewAP, wgPnPStatus=wgPnPStatus, wgVpnPTServerEntry=wgVpnPTServerEntry, wgRoamingPeerIpAddress=wgRoamingPeerIpAddress, wgVpnPTPolicyTable=wgVpnPTPolicyTable, wgVpnPTFilterTable=wgVpnPTFilterTable, wgRoamingPeerEntry=wgRoamingPeerEntry, wgVpnPTServerPolicyId=wgVpnPTServerPolicyId, wgPnPIpMask=wgPnPIpMask, wgRoamingPeerRowStatus=wgRoamingPeerRowStatus, wgVpnPTFilterPort=wgVpnPTFilterPort, wgVpnPTPolicyEntry=wgVpnPTPolicyEntry, wgRoamingPeerTable=wgRoamingPeerTable, wgPnPIpAddress=wgPnPIpAddress, wgVpnPTFilterPolicyId=wgVpnPTFilterPolicyId, IfIndexList=IfIndexList, wgVpnPTPolicyId=wgVpnPTPolicyId, wgVpnPTFilterRowStatus=wgVpnPTFilterRowStatus, wgIfVpnPTPolicyId=wgIfVpnPTPolicyId, wgIfIndex=wgIfIndex, wgVpnPTFilterEntry=wgVpnPTFilterEntry, wgIfEntry=wgIfEntry, wgVpnPTServerRowStatus=wgVpnPTServerRowStatus, wgPnPMacAddress=wgPnPMacAddress, wgVpnPTPolicyPortList=wgVpnPTPolicyPortList, wgVpnPTServerTable=wgVpnPTServerTable, wgVpnPTDeletePolicy=wgVpnPTDeletePolicy, wgIfTable=wgIfTable, PYSNMP_MODULE_ID=snWireless, wgMobilityId=wgMobilityId, wgPnPEntry=wgPnPEntry, wgPnPRowStatus=wgPnPRowStatus, snWireless=snWireless, wgVpnPTFilterProtocol=wgVpnPTFilterProtocol, wgGroup=wgGroup, wgPnPTable=wgPnPTable, wgIfWirelessEnable=wgIfWirelessEnable, wgIfAutoPortDisable=wgIfAutoPortDisable, wgPnPIpDefaultGw=wgPnPIpDefaultGw, wgIfFullCompRoamingEnable=wgIfFullCompRoamingEnable, wgPnPIfIndex=wgPnPIfIndex)
