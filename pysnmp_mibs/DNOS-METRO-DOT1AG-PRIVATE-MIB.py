...
# Notes
# -----
# ASN.1 source file://mibs/dell/DNOS-METRO-DOT1AG-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:59 2025
...
class _AgentDot1agCfmClearStatistics_Type(Integer32):
    """Custom type agentDot1agCfmClearStatistics based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 1),
    )
...
_AgentDot1agCfmClearStatistics_Type.__name__ = "Integer32"
_AgentDot1agCfmClearStatistics_Object = MibScalar
agentDot1agCfmClearStatistics = _AgentDot1agCfmClearStatistics_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 45, 1, 1, 5),
    _AgentDot1agCfmClearStatistics_Type()
)
agentDot1agCfmClearStatistics.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentDot1agCfmClearStatistics.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"fastPathDot1agPrivateMIB": fastPathDot1agPrivateMIB,
       ...
       "agentDot1agCfmClearStatistics": agentDot1agCfmClearStatistics,
