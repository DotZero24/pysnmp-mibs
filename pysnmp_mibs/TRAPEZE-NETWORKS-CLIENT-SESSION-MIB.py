...
TrpzApSerialNum, TrpzRadioNum, TrpzRadioRate, TrpzApNum, TrpzAccessType, TrpzRssi = mibBuilder.importSymbols("TRAPEZE-NETWORKS-AP-TC", "TrpzApSerialNum", "TrpzRadioNum", "TrpzRadioRate", "TrpzApNum", "TrpzAccessType", "TrpzRssi")
...
mibBuilder.exportSymbols("TRAPEZE-NETWORKS-CLIENT-SESSION-MIB", trpzClientSessRoamingHistoryTableGroupRev2=trpzClientSessRoamingHistoryTableGroupRev2, TrpzSessState=TrpzSessState, trpzClSessClientSessStatsUniPktOut=trpzClSessClientSessStatsUniPktOut, trpzClSessClientSessStatsEncErrOctet=trpzClSessClientSessStatsEncErrOctet, trpzClientSessionConformance=trpzClientSessionConformance, trpzClSessRoamingHistoryTable=trpzClSessRoamingHistoryTable, trpzClSessClientSessionTable=trpzClSessClientSessionTable, trpzClSessClientSessStatsUniOctetIn=trpzClSessClientSessStatsUniOctetIn, trpzClSessRoamHistMacAddress=trpzClSessRoamHistMacAddress, trpzClSessClientSessVlanTag=trpzClSessClientSessVlanTag, trpzClSessClientSessAccessMode=trpzClSessClientSessAccessMode, trpzClSessRoamHistRadioNum=trpzClSessRoamHistRadioNum, trpzClSessClientAddressTable=trpzClSessClientAddressTable, trpzClSessClientSessSessionState=trpzClSessClientSessSessionState, trpzClSessClientSessStatsMacAddress=trpzClSessClientSessStatsMacAddress, trpzClientSessionComplianceRev3=trpzClientSessionComplianceRev3, trpzClSessRoamHistAccessMode=trpzClSessRoamHistAccessMode, trpzClSessClientSessEncryptionType=trpzClSessClientSessEncryptionType, trpzClSessClientSessionStatisticsEntry=trpzClSessClientSessionStatisticsEntry, trpzClSessClientAddressValue=trpzClSessClientAddressValue, trpzClSessClientSessAuthServer=trpzClSessClientSessAuthServer, trpzClSessClientSessStatsMultiPktIn=trpzClSessClientSessStatsMultiPktIn, trpzClientSessClientSessionTableGroup=trpzClientSessClientSessionTableGroup, trpzClientSessionComplianceRev4=trpzClientSessionComplianceRev4, trpzClSessRoamHistAccessType=trpzClSessRoamHistAccessType, trpzClientSessScalarsGroup=trpzClientSessScalarsGroup, PYSNMP_MODULE_ID=trpzClientSessionMib, trpzClientSessionComplianceRev2=trpzClientSessionComplianceRev2, trpzClSessClientSessRadioNum=trpzClSessClientSessRadioNum, trpzClientSessionDataObjects=trpzClientSessionDataObjects, trpzClSessClientSessApSerialNum=trpzClSessClientSessApSerialNum, trpzClSessRoamHistApNumOrPort=trpzClSessRoamHistApNumOrPort, trpzClSessClientSessApNum=trpzClSessClientSessApNum, trpzClientSessionObjects=trpzClientSessionObjects, trpzClSessClientSessVlan=trpzClSessClientSessVlan, trpzClSessClientSessState=trpzClSessClientSessState, trpzClSessClientSessDeviceType=trpzClSessClientSessDeviceType, trpzClSessClientSessSsid=trpzClSessClientSessSsid, trpzClSessClientSessIpAddress=trpzClSessClientSessIpAddress, trpzClSessClientSessStatsMultiOctetIn=trpzClSessClientSessStatsMultiOctetIn, trpzClientSessClientSessionTableGroupRev2=trpzClientSessClientSessionTableGroupRev2, trpzClSessClientSessPhysPortNum=trpzClSessClientSessPhysPortNum, trpzClSessRoamHistPhysPortNum=trpzClSessRoamHistPhysPortNum, trpzClientSessionGroups=trpzClientSessionGroups, trpzClSessClientSessAccessType=trpzClSessClientSessAccessType, trpzClSessClientSessionEntry=trpzClSessClientSessionEntry, trpzClientSessionCommonGroup=trpzClientSessionCommonGroup, TrpzEncryptionType=TrpzEncryptionType, trpzClSessRoamHistApSerialNum=trpzClSessRoamHistApSerialNum, trpzClientSessClientSessionStatisticsTableGroup=trpzClientSessClientSessionStatisticsTableGroup, trpzClSessClientSessTimeStamp=trpzClSessClientSessTimeStamp, trpzClSessClientAddressTableGroup=trpzClSessClientAddressTableGroup, trpzClSessClientSessStatsEncErrPkt=trpzClSessClientSessStatsEncErrPkt, trpzClientSessClientSessionTableGroupRev3=trpzClientSessClientSessionTableGroupRev3, trpzClSessRoamHistIpAddress=trpzClSessRoamHistIpAddress, trpzClSessClientSessMacAddress=trpzClSessClientSessMacAddress, trpzClientSessionCompliances=trpzClientSessionCompliances, trpzClientSessionCompliance=trpzClientSessionCompliance, trpzClSessClientSessAuthMethod=trpzClSessClientSessAuthMethod, trpzClSessClientSessStatsLastRssi=trpzClSessClientSessStatsLastRssi, trpzClSessClientSessionStatisticsTable=trpzClSessClientSessionStatisticsTable, trpzClSessClientSessSessionId=trpzClSessClientSessSessionId, trpzClSessTotalSessions=trpzClSessTotalSessions, trpzClientSessRoamingHistoryTableGroup=trpzClientSessRoamingHistoryTableGroup, trpzClSessClientSessStatsLastSNR=trpzClSessClientSessStatsLastSNR, trpzClSessClientSessStatsUniOctetOut=trpzClSessClientSessStatsUniOctetOut, trpzClSessClientSessLoginType=trpzClSessClientSessLoginType, trpzClSessClientSessPortOrNum=trpzClSessClientSessPortOrNum, TrpzAuthMethod=TrpzAuthMethod, trpzClSessClientSessStatsLastRate=trpzClSessClientSessStatsLastRate, trpzClSessClientSessDeviceGroup=trpzClSessClientSessDeviceGroup, trpzClSessClientSessUsername=trpzClSessClientSessUsername, trpzClientSessionMib=trpzClientSessionMib, trpzClSessClientAddressEntry=trpzClSessClientAddressEntry, trpzClSessClientSessDot1xAuthMethod=trpzClSessClientSessDot1xAuthMethod, trpzClSessRoamHistIndex=trpzClSessRoamHistIndex, trpzClSessRoamHistApNum=trpzClSessRoamHistApNum, trpzClSessRoamHistTimeStamp=trpzClSessRoamHistTimeStamp, trpzClSessClientSessStatsUniPktIn=trpzClSessClientSessStatsUniPktIn, trpzClSessRoamingHistoryEntry=trpzClSessRoamingHistoryEntry, trpzClSessClientAddressType=trpzClSessClientAddressType, trpzClSessClientSessDeviceProfileName=trpzClSessClientSessDeviceProfileName, trpzClSessClientAddressIndex=trpzClSessClientAddressIndex)
