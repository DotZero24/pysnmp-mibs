...
mibBuilder.exportSymbols("CISCO-SWITCH-CEF-MIB", PYSNMP_MODULE_ID=ciscoSwitchCefMIB, cscEomL2Routes=cscEomL2Routes, cscIpv6GlobalRoutes=cscIpv6GlobalRoutes, cscIpv6UnicastRoutes=cscIpv6UnicastRoutes, cscSwitchCefIpv6LinkLocalGroup=cscSwitchCefIpv6LinkLocalGroup, cscIpv6LinkLocalRoutes=cscIpv6LinkLocalRoutes, cscMplsStatsGroupExt=cscMplsStatsGroupExt, cscSwitchCefIpv6GlobalStatsGroup=cscSwitchCefIpv6GlobalStatsGroup, cscEomIpv4MulticastRoutes=cscEomIpv4MulticastRoutes, cscEomIpv6MulticastRoutes=cscEomIpv6MulticastRoutes, ciscoSwitchCefMIB=ciscoSwitchCefMIB, cscIpv4NonVrfRoutes=cscIpv4NonVrfRoutes, cscIpv6NonVrfRoutes=cscIpv6NonVrfRoutes, cscSwitchCefStatsEntry=cscSwitchCefStatsEntry, cscIpv6MulticastRoutes=cscIpv6MulticastRoutes, cscMplsStatsGroup=cscMplsStatsGroup, cscSwitchCefMIBCompliances=cscSwitchCefMIBCompliances, cscSwitchCefMIBCompliance=cscSwitchCefMIBCompliance, ciscoSwitchCefMIBNotifs=ciscoSwitchCefMIBNotifs, cscMplsVpnRoutes=cscMplsVpnRoutes, cscSwitchCefEomL2Group=cscSwitchCefEomL2Group, ciscoSwitchCefMIBObjects=ciscoSwitchCefMIBObjects, ciscoSwitchCefMIBConform=ciscoSwitchCefMIBConform, cscIpv4UnicastRoutes=cscIpv4UnicastRoutes, cscIpv6VrfRoutes=cscIpv6VrfRoutes, cscSwitchCefIpv4StatsGroup=cscSwitchCefIpv4StatsGroup, cscTotalRoutes=cscTotalRoutes, cscTotalStatsGroup=cscTotalStatsGroup, cscIpv4VrfRoutes=cscIpv4VrfRoutes, cscSwitchCefIpv6StatsGroup=cscSwitchCefIpv6StatsGroup, cscStats=cscStats, cscIpv4MulticastRoutes=cscIpv4MulticastRoutes, cscSwitchCefMIBGroups=cscSwitchCefMIBGroups, cscMplsRoutes=cscMplsRoutes, cscSwitchCefStatsTable=cscSwitchCefStatsTable)
