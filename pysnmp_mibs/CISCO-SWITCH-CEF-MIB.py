...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SWITCH-CEF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:18 2025
...
cscSwitchCefMIBCompliance.setObjects(
      *(("CISCO-SWITCH-CEF-MIB", "cscSwitchCefIpv4StatsGroup"),
        ("CISCO-SWITCH-CEF-MIB", "cscSwitchCefIpv6StatsGroup"),
        ("CISCO-SWITCH-CEF-MIB", "cscTotalStatsGroup"),
        ("CISCO-SWITCH-CEF-MIB", "cscSwitchCefIpv6GlobalStatsGroup"),
        ("CISCO-SWITCH-CEF-MIB", "cscSwitchCefIpv6LinkLocalGroup"),
        ("CISCO-SWITCH-CEF-MIB", "cscSwitchCefEomL2Group"),
        ("CISCO-SWITCH-CEF-MIB", "cscMplsStatsGroup"),
        ("CISCO-SWITCH-CEF-MIB", "cscMplsStatsGroupExt"))
)
if mibBuilder.loadTexts:
