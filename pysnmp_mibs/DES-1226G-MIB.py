# SNMP MIB module (DES-1226G-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES-1226G-MIB
...
commSetIndex = _CommSetIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 1, 1, 1),
    _CommSetIndex_Type()
)
...
commSetName = _CommSetName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 1, 1, 2),
    _CommSetName_Type()
)
...
commSetStatus = _CommSetStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 1, 1, 3),
    _CommSetStatus_Type()
)
...
commGetIndex = _CommGetIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 2, 1, 1),
    _CommGetIndex_Type()
)
...
commGetName = _CommGetName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 2, 1, 2),
    _CommGetName_Type()
)
...
commGetStatus = _CommGetStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 2, 1, 3),
    _CommGetStatus_Type()
)
...
commTrapIndex = _CommTrapIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 3, 1, 1),
    _CommTrapIndex_Type()
)
...
commTrapName = _CommTrapName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 3, 1, 2),
    _CommTrapName_Type()
)
...
commTrapIpAddress = _CommTrapIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 3, 1, 3),
...
commTrapSNMPBootup = _CommTrapSNMPBootup_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 3, 1, 5),
...
commTrapSNMPTPLinkUpDown = _CommTrapSNMPTPLinkUpDown_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 3, 1, 6),
...
commTrapSNMPFiberLinkUpDown = _CommTrapSNMPFiberLinkUpDown_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 3, 1, 7),
...
commTrapStatus = _CommTrapStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 1, 3, 1, 13),
...
configPort = _ConfigPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 11, 6, 1, 1),
    _ConfigPort_Type()
)
...
configPortOperStatus = _ConfigPortOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 11, 6, 1, 3),
...
configPortFlowControl = _ConfigPortFlowControl_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 11, 6, 1, 4),
...
configPortFlowControlOper = _ConfigPortFlowControlOper_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 11, 6, 1, 5),
...
configMirrorId = _ConfigMirrorId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 11, 8, 1, 1),
...
configMirrorMode = _ConfigMirrorMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 11, 8, 1, 2),
...
configMirrorMon = _ConfigMirrorMon_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 11, 8, 1, 3),
...
configMirrorSrc = _ConfigMirrorSrc_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 11, 8, 1, 4),
...
configMirrorStatus = _ConfigMirrorStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 11, 8, 1, 5),
...
tvlanId = _TvlanId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 13, 1, 1, 1),
    _TvlanId_Type()
)
...
tvlanMember = _TvlanMember_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 13, 1, 1, 3),
    _TvlanMember_Type()
)
...
tvlanUntaggedPorts = _TvlanUntaggedPorts_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 13, 1, 1, 4),
...
tvlanStatus = _TvlanStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 13, 1, 1, 5),
    _TvlanStatus_Type()
)
...
tvlanPortPortId = _TvlanPortPortId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 13, 2, 1, 1),
...
tvlanPortVlanId = _TvlanPortVlanId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 13, 2, 1, 2),
...
portTrunkId = _PortTrunkId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 14, 1, 1, 1),
    _PortTrunkId_Type()
)
...
portTrunkMember = _PortTrunkMember_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 14, 1, 1, 2),
...
portTrunkMemberValue = _PortTrunkMemberValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 14, 1, 1, 3),
...
portTrunkEnable = _PortTrunkEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 14, 1, 1, 4),
...
companyQoSGroup = _CompanyQoSGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 15)
)
_Qos8021pTable_Object = MibTable
qos8021pTable = _Qos8021pTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 15, 2)
)
if mibBuilder.loadTexts:
    qos8021pTable.setStatus("mandatory")
_Qos8021pEntry_Object = MibTableRow
qos8021pEntry = _Qos8021pEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 15, 2, 1)
)
qos8021pEntry.setIndexNames(
    (0, "DES-1226G-MIB", "qos8021pPriority"),
)
if mibBuilder.loadTexts:
    qos8021pEntry.setStatus("mandatory")
_Qos8021pPriority_Type = Integer32
_Qos8021pPriority_Object = MibTableColumn
qos8021pPriority = _Qos8021pPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 15, 2, 1, 1),
    _Qos8021pPriority_Type()
)
qos8021pPriority.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    qos8021pPriority.setStatus("mandatory")


class _Qos8021pQueueLevel_Type(Integer32):
    """Custom type qos8021pQueueLevel based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Qos8021pQueueLevel_Type.__name__ = "Integer32"
_Qos8021pQueueLevel_Object = MibTableColumn
qos8021pQueueLevel = _Qos8021pQueueLevel_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 15, 2, 1, 2),
    _Qos8021pQueueLevel_Type()
)
qos8021pQueueLevel.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    qos8021pQueueLevel.setStatus("mandatory")
_CompanyStaticGroup_ObjectIdentity = ObjectIdentity
companyStaticGroup = _CompanyStaticGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 21)
)
...
staticId = _StaticId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 21, 3, 1, 1),
    _StaticId_Type()
)
...
staticMac = _StaticMac_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 21, 3, 1, 2),
    _StaticMac_Type()
)
...
staticPort = _StaticPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 21, 3, 1, 3),
    _StaticPort_Type()
)
...
staticVID = _StaticVID_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 21, 3, 1, 4),
    _StaticVID_Type()
)
staticVID.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    staticVID.setStatus("mandatory")
...
staticStatus = _StaticStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 1, 21, 3, 1, 5),
    _StaticStatus_Type()
)
...
mibBuilder.exportSymbols(
    ...
    **{"OwnerString": OwnerString,
       ...
       "dlink-FESmartSwitch": dlink_FESmartSwitch,
       "des-1226G": des_1226G,
       ...
       "qos8021pTable": qos8021pTable,
       "qos8021pEntry": qos8021pEntry,
       "qos8021pPriority": qos8021pPriority,
       "qos8021pQueueLevel": qos8021pQueueLevel,
