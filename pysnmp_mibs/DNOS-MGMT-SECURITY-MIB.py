...
# Notes
# -----
# ASN.1 source file://mibs/dell/DNOS-MGMT-SECURITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:07:51 2025
...
class _AgentSSLIpHttpSecureCiphersuite_Type(Bits):
    """Custom type agentSSLIpHttpSecureCiphersuite based on Bits"""
    namedValues = NamedValues(
        *(("undefined", 0),
          ("aes128-cbc-sha", 1),
          ("aes256-cbc-sha", 2),
...
agentSSLIpHttpSecureCiphersuite = _AgentSSLIpHttpSecureCiphersuite_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 1, 10),
    _AgentSSLIpHttpSecureCiphersuite_Type()
)
agentSSLIpHttpSecureCiphersuite.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSLIpHttpSecureCiphersuite.setStatus("current")


class _AgentSSLCryptoDhParam_Type(Integer32):
    """Custom type agentSSLCryptoDhParam based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentSSLCryptoDhParam_Type.__name__ = "Integer32"
_AgentSSLCryptoDhParam_Object = MibScalar
agentSSLCryptoDhParam = _AgentSSLCryptoDhParam_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 1, 11),
    _AgentSSLCryptoDhParam_Type()
)
agentSSLCryptoDhParam.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSLCryptoDhParam.setStatus("current")
...
class _AgentSSHEcdsaKeyControl_Type(Integer32):
    """Custom type agentSSHEcdsaKeyControl based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentSSHEcdsaKeyControl_Type.__name__ = "Integer32"
_AgentSSHEcdsaKeyControl_Object = MibScalar
agentSSHEcdsaKeyControl = _AgentSSHEcdsaKeyControl_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 13),
    _AgentSSHEcdsaKeyControl_Type()
)
agentSSHEcdsaKeyControl.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSHEcdsaKeyControl.setStatus("current")
_AgentSSHEcdsaKeyLen_Type = Integer32
_AgentSSHEcdsaKeyLen_Object = MibScalar
agentSSHEcdsaKeyLen = _AgentSSHEcdsaKeyLen_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 14),
    _AgentSSHEcdsaKeyLen_Type()
)
agentSSHEcdsaKeyLen.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSHEcdsaKeyLen.setStatus("current")


class _AgentSSHDsaKeyLen_Type(Integer32):
    """Custom type agentSSHDsaKeyLen based on Integer32"""
    defaultValue = 1024


_AgentSSHDsaKeyLen_Type.__name__ = "Integer32"
_AgentSSHDsaKeyLen_Object = MibScalar
agentSSHDsaKeyLen = _AgentSSHDsaKeyLen_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 15),
    _AgentSSHDsaKeyLen_Type()
)
agentSSHDsaKeyLen.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSHDsaKeyLen.setStatus("current")


class _AgentSSHRsaKeyLen_Type(Integer32):
    """Custom type agentSSHRsaKeyLen based on Integer32"""
    defaultValue = 1024


_AgentSSHRsaKeyLen_Type.__name__ = "Integer32"
_AgentSSHRsaKeyLen_Object = MibScalar
agentSSHRsaKeyLen = _AgentSSHRsaKeyLen_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 16),
    _AgentSSHRsaKeyLen_Type()
)
agentSSHRsaKeyLen.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSHRsaKeyLen.setStatus("current")


class _AgentSSHAuthenticationRetries_Type(Unsigned32):
    """Custom type agentSSHAuthenticationRetries based on Unsigned32"""
    defaultValue = 3
...
_AgentSSHAuthenticationRetries_Type.__name__ = "Unsigned32"
_AgentSSHAuthenticationRetries_Object = MibScalar
agentSSHAuthenticationRetries = _AgentSSHAuthenticationRetries_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 17),
    _AgentSSHAuthenticationRetries_Type()
)
agentSSHAuthenticationRetries.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSHAuthenticationRetries.setStatus("current")
_AgentSSHEncryptionAlgorithmsConfigGroup_ObjectIdentity = ObjectIdentity
agentSSHEncryptionAlgorithmsConfigGroup = _AgentSSHEncryptionAlgorithmsConfigGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 18)
)
_AgentSSHServerEncryptionAlgorithmsTable_Object = MibTable
agentSSHServerEncryptionAlgorithmsTable = _AgentSSHServerEncryptionAlgorithmsTable_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 18, 1)
)
if mibBuilder.loadTexts:
    agentSSHServerEncryptionAlgorithmsTable.setStatus("current")
_AgentSSHServerEncryptionAlgorithmsEntry_Object = MibTableRow
agentSSHServerEncryptionAlgorithmsEntry = _AgentSSHServerEncryptionAlgorithmsEntry_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 18, 1, 1)
)
agentSSHServerEncryptionAlgorithmsEntry.setIndexNames(
    (0, "DNOS-MGMT-SECURITY-MIB", "agentSSHServerEncryptionIndex"),
)
if mibBuilder.loadTexts:
    agentSSHServerEncryptionAlgorithmsEntry.setStatus("current")


class _AgentSSHServerEncryptionIndex_Type(Unsigned32):
    """Custom type agentSSHServerEncryptionIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentSSHServerEncryptionIndex_Type.__name__ = "Unsigned32"
_AgentSSHServerEncryptionIndex_Object = MibTableColumn
agentSSHServerEncryptionIndex = _AgentSSHServerEncryptionIndex_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 18, 1, 1, 1),
    _AgentSSHServerEncryptionIndex_Type()
)
agentSSHServerEncryptionIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agentSSHServerEncryptionIndex.setStatus("current")


class _AgentSSHServerEncryptionAlgorithms_Type(Integer32):
    """Custom type agentSSHServerEncryptionAlgorithms based on Integer32"""
    defaultValue = 0
...
_AgentSSHServerEncryptionAlgorithms_Type.__name__ = "Integer32"
_AgentSSHServerEncryptionAlgorithms_Object = MibTableColumn
agentSSHServerEncryptionAlgorithms = _AgentSSHServerEncryptionAlgorithms_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 18, 1, 1, 2),
    _AgentSSHServerEncryptionAlgorithms_Type()
)
agentSSHServerEncryptionAlgorithms.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentSSHServerEncryptionAlgorithms.setStatus("current")


class _AgentSSHServerEncryptionRefresh_Type(Integer32):
    """Custom type agentSSHServerEncryptionRefresh based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentSSHServerEncryptionRefresh_Type.__name__ = "Integer32"
_AgentSSHServerEncryptionRefresh_Object = MibScalar
agentSSHServerEncryptionRefresh = _AgentSSHServerEncryptionRefresh_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 18, 2),
    _AgentSSHServerEncryptionRefresh_Type()
)
agentSSHServerEncryptionRefresh.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSHServerEncryptionRefresh.setStatus("current")
_AgentSSHMacAlgorithmsConfigGroup_ObjectIdentity = ObjectIdentity
agentSSHMacAlgorithmsConfigGroup = _AgentSSHMacAlgorithmsConfigGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 19)
)
_AgentSSHServerMacAlgorithmsTable_Object = MibTable
agentSSHServerMacAlgorithmsTable = _AgentSSHServerMacAlgorithmsTable_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 19, 1)
)
if mibBuilder.loadTexts:
    agentSSHServerMacAlgorithmsTable.setStatus("current")
_AgentSSHServerMacAlgorithmsEntry_Object = MibTableRow
agentSSHServerMacAlgorithmsEntry = _AgentSSHServerMacAlgorithmsEntry_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 19, 1, 1)
)
agentSSHServerMacAlgorithmsEntry.setIndexNames(
    (0, "DNOS-MGMT-SECURITY-MIB", "agentSSHServerMacIndex"),
)
if mibBuilder.loadTexts:
    agentSSHServerMacAlgorithmsEntry.setStatus("current")


class _AgentSSHServerMacIndex_Type(Unsigned32):
    """Custom type agentSSHServerMacIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentSSHServerMacIndex_Type.__name__ = "Unsigned32"
_AgentSSHServerMacIndex_Object = MibTableColumn
agentSSHServerMacIndex = _AgentSSHServerMacIndex_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 19, 1, 1, 1),
    _AgentSSHServerMacIndex_Type()
)
agentSSHServerMacIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agentSSHServerMacIndex.setStatus("current")


class _AgentSSHServerMacAlgorithms_Type(Integer32):
    """Custom type agentSSHServerMacAlgorithms based on Integer32"""
    defaultValue = 0
...
_AgentSSHServerMacAlgorithms_Type.__name__ = "Integer32"
_AgentSSHServerMacAlgorithms_Object = MibTableColumn
agentSSHServerMacAlgorithms = _AgentSSHServerMacAlgorithms_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 19, 1, 1, 2),
    _AgentSSHServerMacAlgorithms_Type()
)
agentSSHServerMacAlgorithms.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentSSHServerMacAlgorithms.setStatus("current")


class _AgentSSHServerMacRefresh_Type(Integer32):
    """Custom type agentSSHServerMacRefresh based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentSSHServerMacRefresh_Type.__name__ = "Integer32"
_AgentSSHServerMacRefresh_Object = MibScalar
agentSSHServerMacRefresh = _AgentSSHServerMacRefresh_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 19, 2),
    _AgentSSHServerMacRefresh_Type()
)
agentSSHServerMacRefresh.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSHServerMacRefresh.setStatus("current")
_AgentSSHKexAlgorithmsConfigGroup_ObjectIdentity = ObjectIdentity
agentSSHKexAlgorithmsConfigGroup = _AgentSSHKexAlgorithmsConfigGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 20)
)
_AgentSSHServerKexAlgorithmsTable_Object = MibTable
agentSSHServerKexAlgorithmsTable = _AgentSSHServerKexAlgorithmsTable_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 20, 1)
)
if mibBuilder.loadTexts:
    agentSSHServerKexAlgorithmsTable.setStatus("current")
_AgentSSHServerKexAlgorithmsEntry_Object = MibTableRow
agentSSHServerKexAlgorithmsEntry = _AgentSSHServerKexAlgorithmsEntry_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 20, 1, 1)
)
agentSSHServerKexAlgorithmsEntry.setIndexNames(
    (0, "DNOS-MGMT-SECURITY-MIB", "agentSSHServerKexIndex"),
)
if mibBuilder.loadTexts:
    agentSSHServerKexAlgorithmsEntry.setStatus("current")


class _AgentSSHServerKexIndex_Type(Unsigned32):
    """Custom type agentSSHServerKexIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 10),
    )
...
_AgentSSHServerKexIndex_Type.__name__ = "Unsigned32"
_AgentSSHServerKexIndex_Object = MibTableColumn
agentSSHServerKexIndex = _AgentSSHServerKexIndex_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 20, 1, 1, 1),
    _AgentSSHServerKexIndex_Type()
)
agentSSHServerKexIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agentSSHServerKexIndex.setStatus("current")


class _AgentSSHServerKexAlgorithms_Type(Integer32):
    """Custom type agentSSHServerKexAlgorithms based on Integer32"""
    defaultValue = 0
...
_AgentSSHServerKexAlgorithms_Type.__name__ = "Integer32"
_AgentSSHServerKexAlgorithms_Object = MibTableColumn
agentSSHServerKexAlgorithms = _AgentSSHServerKexAlgorithms_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 20, 1, 1, 2),
    _AgentSSHServerKexAlgorithms_Type()
)
agentSSHServerKexAlgorithms.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentSSHServerKexAlgorithms.setStatus("current")


class _AgentSSHServerKexRefresh_Type(Integer32):
    """Custom type agentSSHServerKexRefresh based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentSSHServerKexRefresh_Type.__name__ = "Integer32"
_AgentSSHServerKexRefresh_Object = MibScalar
agentSSHServerKexRefresh = _AgentSSHServerKexRefresh_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 2, 20, 2),
    _AgentSSHServerKexRefresh_Type()
)
agentSSHServerKexRefresh.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSSHServerKexRefresh.setStatus("current")
_AgentOutboundSSHGroup_ObjectIdentity = ObjectIdentity
agentOutboundSSHGroup = _AgentOutboundSSHGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 3)
)
...
agentOutboundSSHAdminMode = _AgentOutboundSSHAdminMode_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 3, 1),
...
class _AgentOutboundSSHMaxSessions_Type(Integer32):
    """Custom type agentOutboundSSHMaxSessions based on Integer32"""
    defaultValue = 5
...
_AgentOutboundSSHMaxSessions_Type.__name__ = "Integer32"
_AgentOutboundSSHMaxSessions_Object = MibScalar
agentOutboundSSHMaxSessions = _AgentOutboundSSHMaxSessions_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 3, 2),
    _AgentOutboundSSHMaxSessions_Type()
)
agentOutboundSSHMaxSessions.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentOutboundSSHMaxSessions.setStatus("current")
_AgentOutboundSSHActiveSessions_Type = Integer32
_AgentOutboundSSHActiveSessions_Object = MibScalar
agentOutboundSSHActiveSessions = _AgentOutboundSSHActiveSessions_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 3, 3),
    _AgentOutboundSSHActiveSessions_Type()
)
agentOutboundSSHActiveSessions.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agentOutboundSSHActiveSessions.setStatus("current")
...
agentOutboundSSHTimeout = _AgentOutboundSSHTimeout_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 11, 3, 4),
...
mibBuilder.exportSymbols(
    ...
    **{"fastPathMgmtSecurity": fastPathMgmtSecurity,
       ...
       "agentSSLIpHttpSecureCiphersuite": agentSSLIpHttpSecureCiphersuite,
       "agentSSLCryptoDhParam": agentSSLCryptoDhParam,
       ...
       "agentSSHEcdsaKeyControl": agentSSHEcdsaKeyControl,
       "agentSSHEcdsaKeyLen": agentSSHEcdsaKeyLen,
       "agentSSHDsaKeyLen": agentSSHDsaKeyLen,
       "agentSSHRsaKeyLen": agentSSHRsaKeyLen,
       "agentSSHAuthenticationRetries": agentSSHAuthenticationRetries,
       "agentSSHEncryptionAlgorithmsConfigGroup": agentSSHEncryptionAlgorithmsConfigGroup,
       "agentSSHServerEncryptionAlgorithmsTable": agentSSHServerEncryptionAlgorithmsTable,
       "agentSSHServerEncryptionAlgorithmsEntry": agentSSHServerEncryptionAlgorithmsEntry,
       "agentSSHServerEncryptionIndex": agentSSHServerEncryptionIndex,
       "agentSSHServerEncryptionAlgorithms": agentSSHServerEncryptionAlgorithms,
       "agentSSHServerEncryptionRefresh": agentSSHServerEncryptionRefresh,
       "agentSSHMacAlgorithmsConfigGroup": agentSSHMacAlgorithmsConfigGroup,
       "agentSSHServerMacAlgorithmsTable": agentSSHServerMacAlgorithmsTable,
       "agentSSHServerMacAlgorithmsEntry": agentSSHServerMacAlgorithmsEntry,
       "agentSSHServerMacIndex": agentSSHServerMacIndex,
       "agentSSHServerMacAlgorithms": agentSSHServerMacAlgorithms,
       "agentSSHServerMacRefresh": agentSSHServerMacRefresh,
       "agentSSHKexAlgorithmsConfigGroup": agentSSHKexAlgorithmsConfigGroup,
       "agentSSHServerKexAlgorithmsTable": agentSSHServerKexAlgorithmsTable,
       "agentSSHServerKexAlgorithmsEntry": agentSSHServerKexAlgorithmsEntry,
       "agentSSHServerKexIndex": agentSSHServerKexIndex,
       "agentSSHServerKexAlgorithms": agentSSHServerKexAlgorithms,
       ...
       "agentOutboundSSHMaxSessions": agentOutboundSSHMaxSessions,
       "agentOutboundSSHActiveSessions": agentOutboundSSHActiveSessions,
