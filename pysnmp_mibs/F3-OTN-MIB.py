...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/adva/F3-OTN-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:37:15 2025
...
DisplayString, TruthValue, VariablePointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "VariablePointer", "TextualConvention")
...
mibBuilder.exportSymbols("F3-OTN-MIB", f3OtnMIB=f3OtnMIB, f3OtnNetPortHistoryExtTable=f3OtnNetPortHistoryExtTable, f3OtnNetPortHistoryExtOtuErrSec=f3OtnNetPortHistoryExtOtuErrSec, TimDetectMode=TimDetectMode, f3OtnNetPortTimAisInsertOduEnabled=f3OtnNetPortTimAisInsertOduEnabled, f3OtnNetPortHistoryExtOduBBE=f3OtnNetPortHistoryExtOduBBE, f3OtnNetPortHistoryExtOduUAS=f3OtnNetPortHistoryExtOduUAS, f3OtnConfigObjects=f3OtnConfigObjects, f3OtnNetPortHistoryExtEntry=f3OtnNetPortHistoryExtEntry, f3OtnNetPortTtiActualRxHexOtu=f3OtnNetPortTtiActualRxHexOtu, f3OtnNetPortHistoryExtOtuUAS=f3OtnNetPortHistoryExtOtuUAS, f3OtnGroups=f3OtnGroups, f3OtnCompliance=f3OtnCompliance, f3OtnNetPortHistoryExtFecSES=f3OtnNetPortHistoryExtFecSES, f3OtnNetPortFacilityType=f3OtnNetPortFacilityType, f3OtnNetPortHistoryExtOtuSES=f3OtnNetPortHistoryExtOtuSES, f3OtnNetPortHistoryExtOduSES=f3OtnNetPortHistoryExtOduSES, f3OtnNetPortPayloadType=f3OtnNetPortPayloadType, f3OtnNetPortTtiSapiTxOdu=f3OtnNetPortTtiSapiTxOdu, f3OtnNetPortStatsExtOduErrSec=f3OtnNetPortStatsExtOduErrSec, f3OtnConfigGroup=f3OtnConfigGroup, f3OtnNetPortTtiOpSpActualRxOtu=f3OtnNetPortTtiOpSpActualRxOtu, f3OtnNetPortTtiDapiTxOdu=f3OtnNetPortTtiDapiTxOdu, f3OtnPerfGroup=f3OtnPerfGroup, f3OtnNetPortStatsExtOtuSES=f3OtnNetPortStatsExtOtuSES, f3OtnNetPortStatsExtFecCorrErr=f3OtnNetPortStatsExtFecCorrErr, OtnFecType=OtnFecType, f3OtnNetPortStatsExtBerBeforeCorr=f3OtnNetPortStatsExtBerBeforeCorr, f3OtnConformance=f3OtnConformance, f3OtnNetPortFec=f3OtnNetPortFec, f3OtnNetPortHistoryExtFecErrSec=f3OtnNetPortHistoryExtFecErrSec, f3OtnNetPortHistoryExtOtuBBE=f3OtnNetPortHistoryExtOtuBBE, f3OtnNetPortHistoryExtFecUncorrBlockErr=f3OtnNetPortHistoryExtFecUncorrBlockErr, f3OtnPerfObjects=f3OtnPerfObjects, f3OtnNetPortTtiDapiActualRxOtu=f3OtnNetPortTtiDapiActualRxOtu, f3OtnNetPortTtiOpSpTxOdu=f3OtnNetPortTtiOpSpTxOdu, f3OtnNetPortHistoryExtBerBeforeCorr=f3OtnNetPortHistoryExtBerBeforeCorr, f3OtnNetPortTtiSapiTxOtu=f3OtnNetPortTtiSapiTxOtu, f3OtnNetPortTimDetectModeOdu=f3OtnNetPortTimDetectModeOdu, f3OtnNetPortExtTable=f3OtnNetPortExtTable, f3OtnNetPortTtiSapiExpectedRxOtu=f3OtnNetPortTtiSapiExpectedRxOtu, f3OtnNetPortEntry=f3OtnNetPortEntry, f3OtnNetPortStatsExtFecErrSec=f3OtnNetPortStatsExtFecErrSec, f3OtnNetPortTimAisInsertOtuEnabled=f3OtnNetPortTimAisInsertOtuEnabled, f3OtnCompliances=f3OtnCompliances, f3OtnNetPortTtiActualRxHexOdu=f3OtnNetPortTtiActualRxHexOdu, f3OtnNetPortTtiSapiExpectedRxOdu=f3OtnNetPortTtiSapiExpectedRxOdu, f3OtnNetPortTimDetectModeOtu=f3OtnNetPortTimDetectModeOtu, f3OtnNetPortStatsExtTable=f3OtnNetPortStatsExtTable, f3OtnNetPortTtiOpSpActualRxOdu=f3OtnNetPortTtiOpSpActualRxOdu, f3OtnNetPortStatsExtOtuBBE=f3OtnNetPortStatsExtOtuBBE, f3OtnNetPortStatsExtEntry=f3OtnNetPortStatsExtEntry, f3OtnNetPortTtiDapiTxOtu=f3OtnNetPortTtiDapiTxOtu, f3OtnNetPortTtiDapiActualRxOdu=f3OtnNetPortTtiDapiActualRxOdu, f3OtnNetPortTtiSapiActualRxOdu=f3OtnNetPortTtiSapiActualRxOdu, f3OtnNetPortStatsExtOduUAS=f3OtnNetPortStatsExtOduUAS, f3OtnNetPortTtiOpSpTxOtu=f3OtnNetPortTtiOpSpTxOtu, f3OtnNetPortStatsExtFecUncorrBlockErr=f3OtnNetPortStatsExtFecUncorrBlockErr, f3OtnNetPortHistoryExtFecCorrErr=f3OtnNetPortHistoryExtFecCorrErr, f3OtnNetPortStatsExtOduBBE=f3OtnNetPortStatsExtOduBBE, f3OtnNetPortHistoryExtOduErrSec=f3OtnNetPortHistoryExtOduErrSec, f3OtnNetPortStatsExtOtuErrSec=f3OtnNetPortStatsExtOtuErrSec, f3OtnNetPortStatsExtOtuUAS=f3OtnNetPortStatsExtOtuUAS, PYSNMP_MODULE_ID=f3OtnMIB, f3OtnNetPortStatsExtOduSES=f3OtnNetPortStatsExtOduSES, f3OtnNetPortStatsExtFecSES=f3OtnNetPortStatsExtFecSES, OtnFacilityType=OtnFacilityType, f3OtnNetPortTtiSapiActualRxOtu=f3OtnNetPortTtiSapiActualRxOtu)
