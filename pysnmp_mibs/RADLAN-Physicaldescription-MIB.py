...
_H='rndErrorSeverity'
_G='rndErrorDesc'
_F='RADLAN-Physicaldescription-MIB'
_E='Integer32'
_D='RADLAN-DEVICEPARAMS-MIB'
_C='read-write'
_B='read-only'
_A='current'
...
rlPhdUnitEnvParamFan6Status=_RlPhdUnitEnvParamFan6Status_Object((1,3,6,1,4,1,89,53,15,1,9),_RlPhdUnitEnvParamFan6Status_Type())
...
rlPhdUnitEnvParamTempSensorValue=_RlPhdUnitEnvParamTempSensorValue_Object((1,3,6,1,4,1,89,53,15,1,10),_RlPhdUnitEnvParamTempSensorValue_Type())
...
rlPhdUnitEnvParamTempSensorStatus=_RlPhdUnitEnvParamTempSensorStatus_Object((1,3,6,1,4,1,89,53,15,1,11),_RlPhdUnitEnvParamTempSensorStatus_Type())
...
rlPhdUnitEnvParamTempSensorWarningThresholdValue=_RlPhdUnitEnvParamTempSensorWarningThresholdValue_Object((1,3,6,1,4,1,89,53,15,1,12),_RlPhdUnitEnvParamTempSensorWarningThresholdValue_Type())
...
rlPhdUnitEnvParamTempSensorCriticalThresholdValue=_RlPhdUnitEnvParamTempSensorCriticalThresholdValue_Object((1,3,6,1,4,1,89,53,15,1,13),_RlPhdUnitEnvParamTempSensorCriticalThresholdValue_Type())
...
rlPhdUnitEnvParamUpTime=_RlPhdUnitEnvParamUpTime_Object((1,3,6,1,4,1,89,53,15,1,14),_RlPhdUnitEnvParamUpTime_Type())
...
rlPhdUnitEnvParamMonitorAutoRecoveryEnable=_RlPhdUnitEnvParamMonitorAutoRecoveryEnable_Object((1,3,6,1,4,1,89,53,15,1,15),_RlPhdUnitEnvParamMonitorAutoRecoveryEnable_Type())
...
rlPhdUnitEnvParamMonitorTemperatureStatus=_RlPhdUnitEnvParamMonitorTemperatureStatus_Object((1,3,6,1,4,1,89,53,15,1,16),_RlPhdUnitEnvParamMonitorTemperatureStatus_Type())
...
rlPhdUnitEnvParamMonitorOperStatus=_RlPhdUnitEnvParamMonitorOperStatus_Object((1,3,6,1,4,1,89,53,15,1,17),_RlPhdUnitEnvParamMonitorOperStatus_Type())
...
rlCascadeAdminTable=_RlCascadeAdminTable_Object((1,3,6,1,4,1,89,53,24))
if mibBuilder.loadTexts:rlCascadeAdminTable.setStatus(_A)
_RlCascadeAdminEntry_Object=MibTableRow
rlCascadeAdminEntry=_RlCascadeAdminEntry_Object((1,3,6,1,4,1,89,53,24,1))
...
rlCascadeAdminUnitId=_RlCascadeAdminUnitId_Object((1,3,6,1,4,1,89,53,24,1,1),_RlCascadeAdminUnitId_Type())
...
rlCascadeAdminIndexList=_RlCascadeAdminIndexList_Object((1,3,6,1,4,1,89,53,24,1,2),_RlCascadeAdminIndexList_Type())
...
rlCascadeAdminSpeed=_RlCascadeAdminSpeed_Object((1,3,6,1,4,1,89,53,24,1,3),_RlCascadeAdminSpeed_Type())
