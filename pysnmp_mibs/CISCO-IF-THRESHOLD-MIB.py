...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-IF-THRESHOLD-MIB
...
mibBuilder.exportSymbols("CISCO-IF-THRESHOLD-MIB", cifthTemplateIfAssignOperStatus=cifthTemplateIfAssignOperStatus, cifthTemplateName=cifthTemplateName, cifthThresholdObject=cifthThresholdObject, cifthIfThresholdFiredLstSeverity=cifthIfThresholdFiredLstSeverity, cifthTemplateEntry=cifthTemplateEntry, cifthIfThresholdFiredEntry=cifthIfThresholdFiredEntry, cifthTemplateIfAssignRowStatus=cifthTemplateIfAssignRowStatus, cifthThresholdFiredNotifyEnable=cifthThresholdFiredNotifyEnable, cIfThresholdMIBConformance=cIfThresholdMIBConformance, cifthTemplateIfAssignEntry=cifthTemplateIfAssignEntry, cifthThresholdIndex=cifthThresholdIndex, cifthTemplateIfAssignTable=cifthTemplateIfAssignTable, cIfThresholdMIBCompliances=cIfThresholdMIBCompliances, CifthTemplateIndex=CifthTemplateIndex, cifthTemplateIndexNext=cifthTemplateIndexNext, CifthThresholdIndex=CifthThresholdIndex, cifthThresholdLastChange=cifthThresholdLastChange, cifthTemplateNotifyHoldDownTime=cifthTemplateNotifyHoldDownTime, cifthIfThresholdFiredMaxSeverity=cifthIfThresholdFiredMaxSeverity, cifthHoldDownTimerGroup=cifthHoldDownTimerGroup, cifthTemplateIfLastChange=cifthTemplateIfLastChange, cifthThresholdFiredValue=cifthThresholdFiredValue, cifthThresholdEntry=cifthThresholdEntry, cifthThresholdDescr=cifthThresholdDescr, cifthTemplateNotifyHoldDownType=cifthTemplateNotifyHoldDownType, cIfThresholdTemplateGroup=cIfThresholdTemplateGroup, cIfThresholdMIBCompliance=cIfThresholdMIBCompliance, cifthIfThresholdFiredLstChange=cifthIfThresholdFiredLstChange, cifthThresholdType=cifthThresholdType, cifthThresholdDirection=cifthThresholdDirection, cifthThresholdFiredLastChange=cifthThresholdFiredLastChange, PYSNMP_MODULE_ID=ciscoIfThresholdMIB, cifthIfThresholdFiredGroup=cifthIfThresholdFiredGroup, cifthTemplateTable=cifthTemplateTable, cifthIfThresholdFiredTable=cifthIfThresholdFiredTable, cIfThresholdMIBGroups=cIfThresholdMIBGroups, cifthIfThresholdCleared=cifthIfThresholdCleared, cifthThresholdApsSwitchover=cifthThresholdApsSwitchover, CifthTemplateIndexOrZero=CifthTemplateIndexOrZero, cifthTemplateIndex=cifthTemplateIndex, cifthTemplateIfNotifsGroup=cifthTemplateIfNotifsGroup, cifthMIBNotificationsPrefix=cifthMIBNotificationsPrefix, cIfThresholdMIBNotifications=cIfThresholdMIBNotifications, cifthIfThresholdFired=cifthIfThresholdFired, cifthTemplateLastChange=cifthTemplateLastChange, cifthIfThresholdsFired=cifthIfThresholdsFired, cIfThresholdMIBObjects=cIfThresholdMIBObjects, cifthTemplateGroup=cifthTemplateGroup, cIfThresholdFiredGroup=cIfThresholdFiredGroup, CifthThresholdList=CifthThresholdList, cifthTemplateIfAssignInterface=cifthTemplateIfAssignInterface, cifthApsGroup=cifthApsGroup, cifthThresholdTable=cifthThresholdTable, cIfThresholdNotifsGroup=cIfThresholdNotifsGroup, ciscoIfThresholdMIB=ciscoIfThresholdMIB, cifthTemplateRowStatus=cifthTemplateRowStatus, CifthThresholdSeverity=CifthThresholdSeverity, cifthThresholdClearedValue=cifthThresholdClearedValue, cifthThresholdSeverity=cifthThresholdSeverity, cifthThresholdRowStatus=cifthThresholdRowStatus, cifthIfLastThresholdFired=cifthIfLastThresholdFired, cifthTemplateIfAssignGroup=cifthTemplateIfAssignGroup, cifthTemplateIfStatusChange=cifthTemplateIfStatusChange, cifthIfThresholdFiredTemplate=cifthIfThresholdFiredTemplate, cifthThresholdSampleInterval=cifthThresholdSampleInterval, cifthHoldDownHysteresisGroup=cifthHoldDownHysteresisGroup, CifthThresholdSeverityOrZero=CifthThresholdSeverityOrZero)
