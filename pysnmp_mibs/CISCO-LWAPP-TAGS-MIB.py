# SNMP MIB module (CISCO-LWAPP-TAGS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LWAPP-TAGS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:05 2025
...
cLPolicyTagConfigEntry = _CLPolicyTagConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 1, 1, 1, 1)
)
cLPolicyTagConfigEntry.setIndexNames(
    (0, "CISCO-LWAPP-TAGS-MIB", "cLPolicyTagName"),
)
if mibBuilder.loadTexts:
...
cLPolicyProfileConfigEntry = _CLPolicyProfileConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 1, 1, 2, 1)
)
cLPolicyProfileConfigEntry.setIndexNames(
    (0, "CISCO-LWAPP-TAGS-MIB", "cLPolicyTagName"),
    (0, "CISCO-LWAPP-TAGS-MIB", "cLProfileName"),
)
if mibBuilder.loadTexts:
...
cLRlanPolicyProfileConfigEntry = _CLRlanPolicyProfileConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 1, 1, 3, 1)
)
cLRlanPolicyProfileConfigEntry.setIndexNames(
    (0, "CISCO-LWAPP-TAGS-MIB", "cLPolicyTagName"),
    (0, "CISCO-LWAPP-TAGS-MIB", "cLRlanPortID"),
)
if mibBuilder.loadTexts:
...
cLRlanProfile = _CLRlanProfile_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 1, 1, 3, 1, 2),
    _CLRlanProfile_Type()
)
cLRlanProfile.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
cLRlanPolicyProfileRowStatus = _CLRlanPolicyProfileRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 1, 1, 3, 1, 4),
    _CLRlanPolicyProfileRowStatus_Type()
)
cLRlanPolicyProfileRowStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
cLSiteTagConfigEntry = _CLSiteTagConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 1, 2, 1, 1)
)
cLSiteTagConfigEntry.setIndexNames(
    (0, "CISCO-LWAPP-TAGS-MIB", "cLSiteTagName"),
)
if mibBuilder.loadTexts:
...
cLApFilterPriorityEntry = _CLApFilterPriorityEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 1, 5, 2, 1)
)
cLApFilterPriorityEntry.setIndexNames(
    (0, "CISCO-LWAPP-TAGS-MIB", "cLApFilterPriority"),
)
if mibBuilder.loadTexts:
...
ciscoLwappTagsMIBCompliances = _CiscoLwappTagsMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 2, 1)
)
_CiscoLwappTagsMIBGroups_ObjectIdentity = ObjectIdentity
ciscoLwappTagsMIBGroups = _CiscoLwappTagsMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 2, 2)
)

# Managed Objects groups

ciscoLwappTagsConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 2, 2, 1)
)
ciscoLwappTagsConfigGroup.setObjects(
      *(("CISCO-LWAPP-TAGS-MIB", "cLPolicyTagDescription"),
        ("CISCO-LWAPP-TAGS-MIB", "cLPolicyTagRowStatus"),
        ("CISCO-LWAPP-TAGS-MIB", "cLPolicyProfileName"),
        ("CISCO-LWAPP-TAGS-MIB", "cLPolicyProfileRowStatus"),
        ("CISCO-LWAPP-TAGS-MIB", "cLRfTagRowStatus"),
        ("CISCO-LWAPP-TAGS-MIB", "cLRfTagDescription"),
        ("CISCO-LWAPP-TAGS-MIB", "cL11aRfProfName"),
        ("CISCO-LWAPP-TAGS-MIB", "cL11bRfProfName"),
        ("CISCO-LWAPP-TAGS-MIB", "cLSiteTagRowStatus"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApJoinProfName"),
        ("CISCO-LWAPP-TAGS-MIB", "cLFlexProfName"),
        ("CISCO-LWAPP-TAGS-MIB", "cLSiteTagDescription"),
        ("CISCO-LWAPP-TAGS-MIB", "cLReapSiteUpgradeStart"),
        ("CISCO-LWAPP-TAGS-MIB", "cLReapSiteTagStartCertificateDownload"),
        ("CISCO-LWAPP-TAGS-MIB", "cLIsLocalSite"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApConfigPolicyTagName"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApConfigRfTagName"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApConfigSiteTagName"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApConfigTagRowStatus"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApTagSrcRowStatus"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApTagSrcList"))
)
if mibBuilder.loadTexts:
    ciscoLwappTagsConfigGroup.setStatus("current")

ciscoLwappFilterConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 2, 2, 2)
)
ciscoLwappFilterConfigGroup.setObjects(
      *(("CISCO-LWAPP-TAGS-MIB", "cLApFilterRowStatus"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApFilterNameApNameRule"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApFilterPolicyTag"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApFilterRfTag"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApFilterSiteTag"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApFilterPriorityRowStatus"),
        ("CISCO-LWAPP-TAGS-MIB", "cLApFilterPriorityFilterName"))
)
if mibBuilder.loadTexts:
    ciscoLwappFilterConfigGroup.setStatus("current")

ciscoLwappRlanConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 2, 2, 3)
)
ciscoLwappRlanConfigGroup.setObjects(
      *(("CISCO-LWAPP-TAGS-MIB", "cLRlanPolicyProfile"),
        ("CISCO-LWAPP-TAGS-MIB", "cLRlanPolicyProfileRowStatus"))
)
if mibBuilder.loadTexts:
...
ciscoLwappTagsMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 858, 2, 1, 1)
)
ciscoLwappTagsMIBCompliance.setObjects(
      *(("CISCO-LWAPP-TAGS-MIB", "ciscoLwappTagsConfigGroup"),
        ("CISCO-LWAPP-TAGS-MIB", "ciscoLwappFilterConfigGroup"),
        ("CISCO-LWAPP-TAGS-MIB", "ciscoLwappRlanConfigGroup"))
)
if mibBuilder.loadTexts:
