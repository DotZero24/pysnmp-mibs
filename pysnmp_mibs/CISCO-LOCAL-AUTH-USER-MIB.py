...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LOCAL-AUTH-USER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:25:24 2025
...
_ClauNotifEnable_Type.__name__ = "TruthValue"
...
clauMIBCompliance.setObjects(
      *(("CISCO-LOCAL-AUTH-USER-MIB", "clauMIBMainObjectGroup"),
        ("CISCO-LOCAL-AUTH-USER-MIB", "clauMIBNotificationGroup"))
)
if mibBuilder.loadTexts:
...
clauMIBCompliance1.setObjects(
      *(("CISCO-LOCAL-AUTH-USER-MIB", "clauMIBMainObjectGroup"),
        ("CISCO-LOCAL-AUTH-USER-MIB", "clauMIBNotificationGroup"),
        ("CISCO-LOCAL-AUTH-USER-MIB", "clauMIBNotificationGroup1"))
)
if mibBuilder.loadTexts:
...
clauMIBCompliance2.setObjects(
      *(("CISCO-LOCAL-AUTH-USER-MIB", "clauNotifControlGroup"),
        ("CISCO-LOCAL-AUTH-USER-MIB", "clauUserInfoGroup"),
        ("CISCO-LOCAL-AUTH-USER-MIB", "clauMIBNotificationGroup2"))
)
if mibBuilder.loadTexts:
