...
_E='not-accessible'
_D='read-write'
_C='A3COM-HUAWEI-DOT11-WIDS-MIB'
_B='read-only'
_A='current'
...
H3cDot11ChannelScopeType,H3cDot11ObjectIDType,H3cDot11RadioScopeType,H3cDot11RadioType,H3cDot11SSIDStringType,h3cDot11=mibBuilder.importSymbols('A3COM-HUAWEI-DOT11-REF-MIB','H3cDot11ChannelScopeType','H3cDot11ObjectIDType','H3cDot11RadioScopeType','H3cDot11RadioType',_b,'h3cDot11')
...
h3cDot11WIDSConfigGroup=_H3cDot11WIDSConfigGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,5,1))
_H3cDot11WIDSGlobalConfigGroup_ObjectIdentity=ObjectIdentity
h3cDot11WIDSGlobalConfigGroup=_H3cDot11WIDSGlobalConfigGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1))
...
h3cDot11WIDSScanMode=_H3cDot11WIDSScanMode_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,1),_H3cDot11WIDSScanMode_Type())
...
h3cDot11WIDSScanChannelList=_H3cDot11WIDSScanChannelList_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,2),_H3cDot11WIDSScanChannelList_Type())
...
h3cDot11CntMsrMode=_H3cDot11CntMsrMode_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,3),_H3cDot11CntMsrMode_Type())
...
h3cDot11DevAgingTime=_H3cDot11DevAgingTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,4),_H3cDot11DevAgingTime_Type())
...
h3cDot11DynBlkListEnable=_H3cDot11DynBlkListEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,5),_H3cDot11DynBlkListEnable_Type())
...
h3cDot11DynBlkListLifeTime=_H3cDot11DynBlkListLifeTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,6),_H3cDot11DynBlkListLifeTime_Type())
...
h3cDot11FloodAtkDctEnable=_H3cDot11FloodAtkDctEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,7),_H3cDot11FloodAtkDctEnable_Type())
...
h3cDot11SpoofAtkDctEnable=_H3cDot11SpoofAtkDctEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,8),_H3cDot11SpoofAtkDctEnable_Type())
...
h3cDot11WeakIVAtkDctEnable=_H3cDot11WeakIVAtkDctEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,9),_H3cDot11WeakIVAtkDctEnable_Type())
...
h3cDot11ResetWIDSRogueHistory=_H3cDot11ResetWIDSRogueHistory_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,10),_H3cDot11ResetWIDSRogueHistory_Type())
...
h3cDot11ResetWIDSHistroy=_H3cDot11ResetWIDSHistroy_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,11),_H3cDot11ResetWIDSHistroy_Type())
...
h3cDot11ResetWIDSStatistics=_H3cDot11ResetWIDSStatistics_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,12),_H3cDot11ResetWIDSStatistics_Type())
...
h3cDot11ResetAllDynBlkList=_H3cDot11ResetAllDynBlkList_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,13),_H3cDot11ResetAllDynBlkList_Type())
...
h3cDot11ResetAllStcBlkList=_H3cDot11ResetAllStcBlkList_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,14),_H3cDot11ResetAllStcBlkList_Type())
...
h3cDot11ResetAllWhtBlkList=_H3cDot11ResetAllWhtBlkList_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,15),_H3cDot11ResetAllWhtBlkList_Type())
...
h3cDot11ResetAllDctRogueAP=_H3cDot11ResetAllDctRogueAP_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,16),_H3cDot11ResetAllDctRogueAP_Type())
...
h3cDot11ResetAllDctRogueSta=_H3cDot11ResetAllDctRogueSta_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,17),_H3cDot11ResetAllDctRogueSta_Type())
...
h3cDot11ResetAllDctAdhoc=_H3cDot11ResetAllDctAdhoc_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,18),_H3cDot11ResetAllDctAdhoc_Type())
...
h3cDot11ResetAllDctDevice=_H3cDot11ResetAllDctDevice_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,19),_H3cDot11ResetAllDctDevice_Type())
...
h3cDot11ResetAllDctSSID=_H3cDot11ResetAllDctSSID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,20),_H3cDot11ResetAllDctSSID_Type())
...
h3cDot11WidsFloodInterval=_H3cDot11WidsFloodInterval_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,21),_H3cDot11WidsFloodInterval_Type())
...
h3cDot11WidsBlackListThreshold=_H3cDot11WidsBlackListThreshold_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,22),_H3cDot11WidsBlackListThreshold_Type())
...
h3cDot11SSIDFilterOnOff=_H3cDot11SSIDFilterOnOff_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,23),_H3cDot11SSIDFilterOnOff_Type())
...
h3cDot11BSSIDFilterOnOff=_H3cDot11BSSIDFilterOnOff_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,1,24),_H3cDot11BSSIDFilterOnOff_Type())
...
h3cDot11WIDSPermitVendorTable=_H3cDot11WIDSPermitVendorTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,2))
if mibBuilder.loadTexts:h3cDot11WIDSPermitVendorTable.setStatus(_A)
_H3cDot11WIDSPermitVendorEntry_Object=MibTableRow
h3cDot11WIDSPermitVendorEntry=_H3cDot11WIDSPermitVendorEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,2,1))
...
h3cDot11VendorOUI=_H3cDot11VendorOUI_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,2,1,1),_H3cDot11VendorOUI_Type())
...
h3cDot11PermitVendorRowStatus=_H3cDot11PermitVendorRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,2,1,2),_H3cDot11PermitVendorRowStatus_Type())
...
h3cDot11VendorName=_H3cDot11VendorName_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,2,1,3),_H3cDot11VendorName_Type())
...
h3cDot11WIDSPermitSSIDTable=_H3cDot11WIDSPermitSSIDTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,3))
if mibBuilder.loadTexts:h3cDot11WIDSPermitSSIDTable.setStatus(_A)
_H3cDot11WIDSPermitSSIDEntry_Object=MibTableRow
h3cDot11WIDSPermitSSIDEntry=_H3cDot11WIDSPermitSSIDEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,3,1))
...
h3cDot11PermitSSID=_H3cDot11PermitSSID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,3,1,1),_H3cDot11PermitSSID_Type())
...
h3cDot11PermitSSIDRowStatus=_H3cDot11PermitSSIDRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,3,1,2),_H3cDot11PermitSSIDRowStatus_Type())
...
h3cDot11PermitSSIDDetected=_H3cDot11PermitSSIDDetected_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,3,1,3),_H3cDot11PermitSSIDDetected_Type())
...
h3cDot11WIDSIgnoreListTable=_H3cDot11WIDSIgnoreListTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,4))
if mibBuilder.loadTexts:h3cDot11WIDSIgnoreListTable.setStatus(_A)
_H3cDot11WIDSIgnoreListEntry_Object=MibTableRow
h3cDot11WIDSIgnoreListEntry=_H3cDot11WIDSIgnoreListEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,4,1))
...
h3cDot11IgnoreMAC=_H3cDot11IgnoreMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,4,1,1),_H3cDot11IgnoreMAC_Type())
...
h3cDot11IgnoreListRowStatus=_H3cDot11IgnoreListRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,4,1,2),_H3cDot11IgnoreListRowStatus_Type())
...
h3cDot11IgnoreMACDetected=_H3cDot11IgnoreMACDetected_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,4,1,3),_H3cDot11IgnoreMACDetected_Type())
...
h3cDot11IgnoreDevType=_H3cDot11IgnoreDevType_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,4,1,4),_H3cDot11IgnoreDevType_Type())
...
h3cDot11WIDSAttackListTable=_H3cDot11WIDSAttackListTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,5))
if mibBuilder.loadTexts:h3cDot11WIDSAttackListTable.setStatus(_A)
_H3cDot11WIDSAttackListEntry_Object=MibTableRow
h3cDot11WIDSAttackListEntry=_H3cDot11WIDSAttackListEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,5,1))
...
h3cDot11AttackDeviceMac=_H3cDot11AttackDeviceMac_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,5,1,1),_H3cDot11AttackDeviceMac_Type())
...
h3cDot11AttackListRowStatus=_H3cDot11AttackListRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,5,1,2),_H3cDot11AttackListRowStatus_Type())
...
h3cDot11AttackDevDetected=_H3cDot11AttackDevDetected_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,5,1,3),_H3cDot11AttackDevDetected_Type())
...
h3cDot11AttackDevType=_H3cDot11AttackDevType_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,5,1,4),_H3cDot11AttackDevType_Type())
...
h3cDot11StaticWhiteListTable=_H3cDot11StaticWhiteListTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,6))
if mibBuilder.loadTexts:h3cDot11StaticWhiteListTable.setStatus(_A)
_H3cDot11StaticWhiteListEntry_Object=MibTableRow
h3cDot11StaticWhiteListEntry=_H3cDot11StaticWhiteListEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,6,1))
...
h3cDot11StaticWhiteListMAC=_H3cDot11StaticWhiteListMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,6,1,1),_H3cDot11StaticWhiteListMAC_Type())
...
h3cDot11StaticWhiteListRowStatus=_H3cDot11StaticWhiteListRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,6,1,2),_H3cDot11StaticWhiteListRowStatus_Type())
...
h3cDot11StaticBlackListTable=_H3cDot11StaticBlackListTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,7))
if mibBuilder.loadTexts:h3cDot11StaticBlackListTable.setStatus(_A)
_H3cDot11StaticBlackListEntry_Object=MibTableRow
h3cDot11StaticBlackListEntry=_H3cDot11StaticBlackListEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,7,1))
...
h3cDot11StaticBlackListMAC=_H3cDot11StaticBlackListMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,7,1,1),_H3cDot11StaticBlackListMAC_Type())
...
h3cDot11StaticBlackListRowStatus=_H3cDot11StaticBlackListRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,7,1,2),_H3cDot11StaticBlackListRowStatus_Type())
...
h3cDot11WIDSPermitBSSIDTable=_H3cDot11WIDSPermitBSSIDTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,8))
if mibBuilder.loadTexts:h3cDot11WIDSPermitBSSIDTable.setStatus(_A)
_H3cDot11WIDSPermitBSSIDEntry_Object=MibTableRow
h3cDot11WIDSPermitBSSIDEntry=_H3cDot11WIDSPermitBSSIDEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,8,1))
...
h3cDot11PermitBSSID=_H3cDot11PermitBSSID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,8,1,1),_H3cDot11PermitBSSID_Type())
...
h3cDot11PermitBSSIDDetected=_H3cDot11PermitBSSIDDetected_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,8,1,2),_H3cDot11PermitBSSIDDetected_Type())
...
h3cDot11PermitBSSIDRowStatus=_H3cDot11PermitBSSIDRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,1,8,1,3),_H3cDot11PermitBSSIDRowStatus_Type())
...
h3cDot11WIDSDetectGroup=_H3cDot11WIDSDetectGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,5,2))
_H3cDot11WIDSRogueAPTable_Object=MibTable
h3cDot11WIDSRogueAPTable=_H3cDot11WIDSRogueAPTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1))
if mibBuilder.loadTexts:h3cDot11WIDSRogueAPTable.setStatus(_A)
_H3cDot11WIDSRogueAPEntry_Object=MibTableRow
h3cDot11WIDSRogueAPEntry=_H3cDot11WIDSRogueAPEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1))
...
h3cDot11RogueAPBSSMAC=_H3cDot11RogueAPBSSMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,1),_H3cDot11RogueAPBSSMAC_Type())
...
h3cDot11RogueAPVendorName=_H3cDot11RogueAPVendorName_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,2),_H3cDot11RogueAPVendorName_Type())
...
h3cDot11RogueAPMonitorNum=_H3cDot11RogueAPMonitorNum_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,3),_H3cDot11RogueAPMonitorNum_Type())
...
h3cDot11RogueAPFirstDetectTm=_H3cDot11RogueAPFirstDetectTm_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,4),_H3cDot11RogueAPFirstDetectTm_Type())
...
h3cDot11RogueAPLastDetectTm=_H3cDot11RogueAPLastDetectTm_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,5),_H3cDot11RogueAPLastDetectTm_Type())
...
h3cDot11RogueAPSSID=_H3cDot11RogueAPSSID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,6),_H3cDot11RogueAPSSID_Type())
...
h3cDot11RogueAPMaxSigStrength=_H3cDot11RogueAPMaxSigStrength_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,7),_H3cDot11RogueAPMaxSigStrength_Type())
...
h3cDot11RogueAPChannel=_H3cDot11RogueAPChannel_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,8),_H3cDot11RogueAPChannel_Type())
...
h3cDot11RogueAPBeaconInterval=_H3cDot11RogueAPBeaconInterval_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,9),_H3cDot11RogueAPBeaconInterval_Type())
...
h3cDot11RogueAPAttackedStatus=_H3cDot11RogueAPAttackedStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,10),_H3cDot11RogueAPAttackedStatus_Type())
...
h3cDot11RogueAPToIgnore=_H3cDot11RogueAPToIgnore_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,11),_H3cDot11RogueAPToIgnore_Type())
...
h3cDot11RogueAPEncryptStatus=_H3cDot11RogueAPEncryptStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,12),_H3cDot11RogueAPEncryptStatus_Type())
...
h3cDot11RogueAPReset=_H3cDot11RogueAPReset_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,13),_H3cDot11RogueAPReset_Type())
...
h3cDot11RogueAPFirstDetectTmStr=_H3cDot11RogueAPFirstDetectTmStr_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,14),_H3cDot11RogueAPFirstDetectTmStr_Type())
...
h3cDot11RogueAPLastDetectTmStr=_H3cDot11RogueAPLastDetectTmStr_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,1,1,15),_H3cDot11RogueAPLastDetectTmStr_Type())
...
h3cDot11WIDSRogueAPExtTable=_H3cDot11WIDSRogueAPExtTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,2))
if mibBuilder.loadTexts:h3cDot11WIDSRogueAPExtTable.setStatus(_A)
_H3cDot11WIDSRogueAPExtEntry_Object=MibTableRow
h3cDot11WIDSRogueAPExtEntry=_H3cDot11WIDSRogueAPExtEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,2,1))
...
h3cDot11WIDSAPID=_H3cDot11WIDSAPID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,2,1,1),_H3cDot11WIDSAPID_Type())
...
h3cDot11DetectCurAPSigStrength=_H3cDot11DetectCurAPSigStrength_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,2,1,2),_H3cDot11DetectCurAPSigStrength_Type())
...
h3cDot11DetectAPByChannel=_H3cDot11DetectAPByChannel_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,2,1,3),_H3cDot11DetectAPByChannel_Type())
...
h3cDot11DetectAPByRadioID=_H3cDot11DetectAPByRadioID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,2,1,4),_H3cDot11DetectAPByRadioID_Type())
...
h3cDot11AttackAPStatus=_H3cDot11AttackAPStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,2,1,5),_H3cDot11AttackAPStatus_Type())
...
h3cDot11DetectAPFirstTm=_H3cDot11DetectAPFirstTm_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,2,1,6),_H3cDot11DetectAPFirstTm_Type())
...
h3cDot11DetectAPLastTm=_H3cDot11DetectAPLastTm_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,2,1,7),_H3cDot11DetectAPLastTm_Type())
...
h3cDot11WIDSRogueStaTable=_H3cDot11WIDSRogueStaTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3))
if mibBuilder.loadTexts:h3cDot11WIDSRogueStaTable.setStatus(_A)
_H3cDot11WIDSRogueStaEntry_Object=MibTableRow
h3cDot11WIDSRogueStaEntry=_H3cDot11WIDSRogueStaEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1))
...
h3cDot11RogueStaMAC=_H3cDot11RogueStaMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,1),_H3cDot11RogueStaMAC_Type())
...
h3cDot11RogueStaVendorName=_H3cDot11RogueStaVendorName_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,2),_H3cDot11RogueStaVendorName_Type())
...
h3cDot11RogueStaMonitorNum=_H3cDot11RogueStaMonitorNum_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,3),_H3cDot11RogueStaMonitorNum_Type())
...
h3cDot11RogueStaFirstDetectTm=_H3cDot11RogueStaFirstDetectTm_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,4),_H3cDot11RogueStaFirstDetectTm_Type())
...
h3cDot11RogueStaLastDetectTm=_H3cDot11RogueStaLastDetectTm_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,5),_H3cDot11RogueStaLastDetectTm_Type())
...
h3cDot11RogueStaAccessBSSID=_H3cDot11RogueStaAccessBSSID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,6),_H3cDot11RogueStaAccessBSSID_Type())
...
h3cDot11RogueStaMaxSigStrength=_H3cDot11RogueStaMaxSigStrength_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,7),_H3cDot11RogueStaMaxSigStrength_Type())
...
h3cDot11RogueStaChannel=_H3cDot11RogueStaChannel_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,8),_H3cDot11RogueStaChannel_Type())
...
h3cDot11RogueStaAttackedStatus=_H3cDot11RogueStaAttackedStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,9),_H3cDot11RogueStaAttackedStatus_Type())
...
h3cDot11RogueStaToIgnore=_H3cDot11RogueStaToIgnore_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,10),_H3cDot11RogueStaToIgnore_Type())
...
h3cDot11RogueStaAdHocStatus=_H3cDot11RogueStaAdHocStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,11),_H3cDot11RogueStaAdHocStatus_Type())
...
h3cDot11RogueStaReset=_H3cDot11RogueStaReset_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,12),_H3cDot11RogueStaReset_Type())
...
h3cDot11RogueStaFirstDetectTmStr=_H3cDot11RogueStaFirstDetectTmStr_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,13),_H3cDot11RogueStaFirstDetectTmStr_Type())
...
h3cDot11RogueStaLastDetectTmStr=_H3cDot11RogueStaLastDetectTmStr_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,3,1,14),_H3cDot11RogueStaLastDetectTmStr_Type())
...
h3cDot11WIDSRogueStaExtTable=_H3cDot11WIDSRogueStaExtTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,4))
if mibBuilder.loadTexts:h3cDot11WIDSRogueStaExtTable.setStatus(_A)
_H3cDot11WIDSRogueStaExtEntry_Object=MibTableRow
h3cDot11WIDSRogueStaExtEntry=_H3cDot11WIDSRogueStaExtEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,4,1))
...
h3cDot11DetectCurStaSigStrength=_H3cDot11DetectCurStaSigStrength_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,4,1,1),_H3cDot11DetectCurStaSigStrength_Type())
...
h3cDot11DetectStaByChannel=_H3cDot11DetectStaByChannel_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,4,1,2),_H3cDot11DetectStaByChannel_Type())
...
h3cDot11DetectStaByRadioID=_H3cDot11DetectStaByRadioID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,4,1,3),_H3cDot11DetectStaByRadioID_Type())
...
h3cDot11AttackStaStatus=_H3cDot11AttackStaStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,4,1,4),_H3cDot11AttackStaStatus_Type())
...
h3cDot11DetectStaFirstTm=_H3cDot11DetectStaFirstTm_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,4,1,5),_H3cDot11DetectStaFirstTm_Type())
...
h3cDot11DetectStaLastTm=_H3cDot11DetectStaLastTm_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,4,1,6),_H3cDot11DetectStaLastTm_Type())
...
h3cDot11WIDSDetectedDevTable=_H3cDot11WIDSDetectedDevTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5))
if mibBuilder.loadTexts:h3cDot11WIDSDetectedDevTable.setStatus(_A)
_H3cDot11WIDSDetectedDevEntry_Object=MibTableRow
h3cDot11WIDSDetectedDevEntry=_H3cDot11WIDSDetectedDevEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1))
...
h3cDot11WIDSDevMAC=_H3cDot11WIDSDevMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,1),_H3cDot11WIDSDevMAC_Type())
...
h3cDot11WIDSDevType=_H3cDot11WIDSDevType_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,2),_H3cDot11WIDSDevType_Type())
...
h3cDot11WIDSDevPermitType=_H3cDot11WIDSDevPermitType_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,3),_H3cDot11WIDSDevPermitType_Type())
...
h3cDot11WIDSDevVendor=_H3cDot11WIDSDevVendor_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,4),_H3cDot11WIDSDevVendor_Type())
...
h3cDot11WIDSDevMonitorNum=_H3cDot11WIDSDevMonitorNum_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,5),_H3cDot11WIDSDevMonitorNum_Type())
...
h3cDot11WIDSDevSSID=_H3cDot11WIDSDevSSID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,6),_H3cDot11WIDSDevSSID_Type())
...
h3cDot11WIDSDevBSSID=_H3cDot11WIDSDevBSSID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,7),_H3cDot11WIDSDevBSSID_Type())
...
h3cDot11WIDSDevChannel=_H3cDot11WIDSDevChannel_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,8),_H3cDot11WIDSDevChannel_Type())
...
h3cDot11WIDSDevMaxRSSI=_H3cDot11WIDSDevMaxRSSI_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,9),_H3cDot11WIDSDevMaxRSSI_Type())
...
h3cDot11WIDSDevBeaconIntvl=_H3cDot11WIDSDevBeaconIntvl_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,10),_H3cDot11WIDSDevBeaconIntvl_Type())
...
h3cDot11WIDSDevFstDctTime=_H3cDot11WIDSDevFstDctTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,11),_H3cDot11WIDSDevFstDctTime_Type())
...
h3cDot11WIDSDevLstDctTime=_H3cDot11WIDSDevLstDctTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,12),_H3cDot11WIDSDevLstDctTime_Type())
...
h3cDot11WIDSDevReset=_H3cDot11WIDSDevReset_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,13),_H3cDot11WIDSDevReset_Type())
...
h3cDot11WIDSDevSnr=_H3cDot11WIDSDevSnr_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,5,1,14),_H3cDot11WIDSDevSnr_Type())
...
h3cDot11WIDSRptAPTable=_H3cDot11WIDSRptAPTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,6))
if mibBuilder.loadTexts:h3cDot11WIDSRptAPTable.setStatus(_A)
_H3cDot11WIDSRptAPEntry_Object=MibTableRow
h3cDot11WIDSRptAPEntry=_H3cDot11WIDSRptAPEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,6,1))
...
h3cDot11WIDSRptAPMAC=_H3cDot11WIDSRptAPMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,6,1,1),_H3cDot11WIDSRptAPMAC_Type())
...
h3cDot11WIDSRptAPName=_H3cDot11WIDSRptAPName_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,6,1,2),_H3cDot11WIDSRptAPName_Type())
...
h3cDot11WIDSRptAPRadioID=_H3cDot11WIDSRptAPRadioID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,6,1,3),_H3cDot11WIDSRptAPRadioID_Type())
...
h3cDot11WIDSRptAPMaxRSSI=_H3cDot11WIDSRptAPMaxRSSI_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,6,1,4),_H3cDot11WIDSRptAPMaxRSSI_Type())
...
h3cDot11WIDSRptAPFstDctTime=_H3cDot11WIDSRptAPFstDctTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,6,1,5),_H3cDot11WIDSRptAPFstDctTime_Type())
...
h3cDot11WIDSRptAPLstDctTime=_H3cDot11WIDSRptAPLstDctTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,6,1,6),_H3cDot11WIDSRptAPLstDctTime_Type())
...
h3cDot11DynBlackListTable=_H3cDot11DynBlackListTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,7))
if mibBuilder.loadTexts:h3cDot11DynBlackListTable.setStatus(_A)
_H3cDot11DynBlackListEntry_Object=MibTableRow
h3cDot11DynBlackListEntry=_H3cDot11DynBlackListEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,7,1))
...
h3cDot11DynBlackListMAC=_H3cDot11DynBlackListMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,7,1,1),_H3cDot11DynBlackListMAC_Type())
...
h3cDot11DynBlackListTime=_H3cDot11DynBlackListTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,7,1,2),_H3cDot11DynBlackListTime_Type())
...
h3cDot11DynBlackListReason=_H3cDot11DynBlackListReason_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,7,1,3),_H3cDot11DynBlackListReason_Type())
...
h3cDot11DynBlackListReset=_H3cDot11DynBlackListReset_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,7,1,4),_H3cDot11DynBlackListReset_Type())
...
h3cDot11DynBlackListTimeTicks=_H3cDot11DynBlackListTimeTicks_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,7,1,5),_H3cDot11DynBlackListTimeTicks_Type())
...
h3cDot11WIDSRogueHistoryTable=_H3cDot11WIDSRogueHistoryTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,8))
if mibBuilder.loadTexts:h3cDot11WIDSRogueHistoryTable.setStatus(_A)
_H3cDot11WIDSRogueHistoryEntry_Object=MibTableRow
h3cDot11WIDSRogueHistoryEntry=_H3cDot11WIDSRogueHistoryEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,8,1))
...
h3cDot11WIDSRogueHisIndex=_H3cDot11WIDSRogueHisIndex_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,8,1,1),_H3cDot11WIDSRogueHisIndex_Type())
...
h3cDot11WIDSRogueHisMAC=_H3cDot11WIDSRogueHisMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,8,1,2),_H3cDot11WIDSRogueHisMAC_Type())
...
h3cDot11WIDSRogueHisVendor=_H3cDot11WIDSRogueHisVendor_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,8,1,3),_H3cDot11WIDSRogueHisVendor_Type())
...
h3cDot11WIDSRogueHisType=_H3cDot11WIDSRogueHisType_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,8,1,4),_H3cDot11WIDSRogueHisType_Type())
...
h3cDot11WIDSRogueHisChl=_H3cDot11WIDSRogueHisChl_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,8,1,5),_H3cDot11WIDSRogueHisChl_Type())
...
h3cDot11WIDSRogueHisSSID=_H3cDot11WIDSRogueHisSSID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,8,1,6),_H3cDot11WIDSRogueHisSSID_Type())
...
h3cDot11WIDSRogueHisLastDctTime=_H3cDot11WIDSRogueHisLastDctTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,8,1,7),_H3cDot11WIDSRogueHisLastDctTime_Type())
...
h3cDot11WIDSAtkHistroyTable=_H3cDot11WIDSAtkHistroyTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,9))
if mibBuilder.loadTexts:h3cDot11WIDSAtkHistroyTable.setStatus(_A)
_H3cDot11WIDSAtkHistroyEntry_Object=MibTableRow
h3cDot11WIDSAtkHistroyEntry=_H3cDot11WIDSAtkHistroyEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,9,1))
...
h3cDot11WIDSAtkHisIndex=_H3cDot11WIDSAtkHisIndex_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,9,1,1),_H3cDot11WIDSAtkHisIndex_Type())
...
h3cDot11WIDSAtkHisMAC=_H3cDot11WIDSAtkHisMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,9,1,2),_H3cDot11WIDSAtkHisMAC_Type())
...
h3cDot11WIDSAtkHisType=_H3cDot11WIDSAtkHisType_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,9,1,3),_H3cDot11WIDSAtkHisType_Type())
...
h3cDot11WIDSAtkHisChl=_H3cDot11WIDSAtkHisChl_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,9,1,4),_H3cDot11WIDSAtkHisChl_Type())
...
h3cDot11WIDSAtkHisRSSI=_H3cDot11WIDSAtkHisRSSI_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,9,1,5),_H3cDot11WIDSAtkHisRSSI_Type())
...
h3cDot11WIDSAtkHisDctTime=_H3cDot11WIDSAtkHisDctTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,9,1,6),_H3cDot11WIDSAtkHisDctTime_Type())
...
h3cDot11WIDSAtkHisAPName=_H3cDot11WIDSAtkHisAPName_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,9,1,7),_H3cDot11WIDSAtkHisAPName_Type())
...
h3cDot11WIDSAtkStatis=_H3cDot11WIDSAtkStatis_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,5,2,10))
_H3cDot11WIDSAtkStasStartTime_Type=DateAndTime
_H3cDot11WIDSAtkStasStartTime_Object=MibScalar
h3cDot11WIDSAtkStasStartTime=_H3cDot11WIDSAtkStasStartTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,10,1),_H3cDot11WIDSAtkStasStartTime_Type())
...
h3cDot11WIDSAtkStasTable=_H3cDot11WIDSAtkStasTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,10,2))
if mibBuilder.loadTexts:h3cDot11WIDSAtkStasTable.setStatus(_A)
_H3cDot11WIDSAtkStasEntry_Object=MibTableRow
h3cDot11WIDSAtkStasEntry=_H3cDot11WIDSAtkStasEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,10,2,1))
...
h3cDot11WIDSAtkStasType=_H3cDot11WIDSAtkStasType_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,10,2,1,1),_H3cDot11WIDSAtkStasType_Type())
...
h3cDot11WIDSAtkStasCurCnt=_H3cDot11WIDSAtkStasCurCnt_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,10,2,1,2),_H3cDot11WIDSAtkStasCurCnt_Type())
...
h3cDot11WIDSAtkStasTotalCnt=_H3cDot11WIDSAtkStasTotalCnt_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,10,2,1,3),_H3cDot11WIDSAtkStasTotalCnt_Type())
...
h3cDot11BlackListTable=_H3cDot11BlackListTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,11))
if mibBuilder.loadTexts:h3cDot11BlackListTable.setStatus(_A)
_H3cDot11BlackListEntry_Object=MibTableRow
h3cDot11BlackListEntry=_H3cDot11BlackListEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,11,1))
...
h3cDot11BlackListMAC=_H3cDot11BlackListMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,11,1,1),_H3cDot11BlackListMAC_Type())
...
h3cDot11BlackListTime=_H3cDot11BlackListTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,11,1,2),_H3cDot11BlackListTime_Type())
...
h3cDot11BlackListReason=_H3cDot11BlackListReason_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,11,1,3),_H3cDot11BlackListReason_Type())
...
h3cDot11BlackListRowStatus=_H3cDot11BlackListRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,11,1,4),_H3cDot11BlackListRowStatus_Type())
...
h3cDot11BlackListTimeTicks=_H3cDot11BlackListTimeTicks_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,2,11,1,5),_H3cDot11BlackListTimeTicks_Type())
...
h3cDot11WIDSNotifyGroup=_H3cDot11WIDSNotifyGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,5,3))
_H3cDot11WIDSTraps_ObjectIdentity=ObjectIdentity
h3cDot11WIDSTraps=_H3cDot11WIDSTraps_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,5,3,1))
_H3cDot11WIDSTrapVarObjects_ObjectIdentity=ObjectIdentity
h3cDot11WIDSTrapVarObjects=_H3cDot11WIDSTrapVarObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2))
_H3cDot11WIDSRogueMAC_Type=MacAddress
_H3cDot11WIDSRogueMAC_Object=MibScalar
h3cDot11WIDSRogueMAC=_H3cDot11WIDSRogueMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,1),_H3cDot11WIDSRogueMAC_Type())
...
h3cDot11WIDSRogueType=_H3cDot11WIDSRogueType_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,2),_H3cDot11WIDSRogueType_Type())
...
h3cDot11WIDSMonitorMAC=_H3cDot11WIDSMonitorMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,3),_H3cDot11WIDSMonitorMAC_Type())
...
h3cDot11WIDSAdHocMAC=_H3cDot11WIDSAdHocMAC_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,4),_H3cDot11WIDSAdHocMAC_Type())
...
h3cDot11UnauthorSSIDName=_H3cDot11UnauthorSSIDName_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,5),_H3cDot11UnauthorSSIDName_Type())
...
h3cDot11MonitorAPID=_H3cDot11MonitorAPID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,6),_H3cDot11MonitorAPID_Type())
...
h3cDot11MonitorApRadioID=_H3cDot11MonitorApRadioID_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,7),_H3cDot11MonitorApRadioID_Type())
...
h3cDot11WIDSAtkMac=_H3cDot11WIDSAtkMac_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,8),_H3cDot11WIDSAtkMac_Type())
...
h3cDot11WIDSAtkFrameType=_H3cDot11WIDSAtkFrameType_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,9),_H3cDot11WIDSAtkFrameType_Type())
...
h3cDot11WIDSAtkChannel=_H3cDot11WIDSAtkChannel_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,10),_H3cDot11WIDSAtkChannel_Type())
...
h3cDot11WIDSAtkTime=_H3cDot11WIDSAtkTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,11),_H3cDot11WIDSAtkTime_Type())
...
h3cDot11WIDSAtkDestMac=_H3cDot11WIDSAtkDestMac_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,12),_H3cDot11WIDSAtkDestMac_Type())
...
h3cDot11WIDSFirstTrapTime=_H3cDot11WIDSFirstTrapTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,5,3,2,13),_H3cDot11WIDSFirstTrapTime_Type())
h3cDot11WIDSFirstTrapTime.setMaxAccess(_F)
if mibBuilder.loadTexts:h3cDot11WIDSFirstTrapTime.setStatus(_A)
h3cDot11WIDSDetectRogueTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,75,5,3,1,1))
...
h3cDot11WIDSAdHocTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,75,5,3,1,2))
h3cDot11WIDSAdHocTrap.setObjects(*((_C,_r),(_C,_L)))
if mibBuilder.loadTexts:h3cDot11WIDSAdHocTrap.setStatus(_A)
h3cDot11WIDSUnauthorSSIDTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,75,5,3,1,3))
...
h3cDot11WIDSWeakIVTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,75,5,3,1,9))
