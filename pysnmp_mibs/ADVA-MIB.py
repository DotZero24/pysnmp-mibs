...
# Produced by pysmi-1.1.12 at Wed Oct  8 11:03:14 2025
...
MibIdentifier, enterprises, NotificationType, Integer32, Bits, Unsigned32, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, Counter64, TimeTicks, snmpModules, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "NotificationType", "Integer32", "Bits", "Unsigned32", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "TimeTicks", "snmpModules", "Gauge32")
...
mibBuilder.exportSymbols("ADVA-MIB", controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, F7AutoBackupRunState=F7AutoBackupRunState, NoYesNA=NoYesNA, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, neEventLogIdentityTranslation=neEventLogIdentityTranslation, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, swDbDataActivationTime=swDbDataActivationTime, sonetSectionConfigEntry=sonetSectionConfigEntry, dbAdmin=dbAdmin, fwDataFirmwareApproved=fwDataFirmwareApproved, oduTcmADataTable=oduTcmADataTable, neAutoBackupServerDirectory=neAutoBackupServerDirectory, SonetTraceForm=SonetTraceForm, entityType=entityType, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, LoopConfigCaps=LoopConfigCaps, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, LogicalIfTransportCaps=LogicalIfTransportCaps, fwDataStandbyVersion=fwDataStandbyVersion, oduConfig=oduConfig, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, inventorySerialNum=inventorySerialNum, fspxg480_100gcfp2=fspxg480_100gcfp2, neEventLogVarOidVal=neEventLogVarOidVal, neInfo=neInfo, DestinationNodeOrAgentState=DestinationNodeOrAgentState, neStorageDescr=neStorageDescr, fsp3000c=fsp3000c, SonetTimingSourceCaps=SonetTimingSourceCaps, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, fsp3000alm=fsp3000alm, config=config, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, otuSectionConfigPayload=otuSectionConfigPayload, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, OtnTcmLevelCaps=OtnTcmLevelCaps, EquipmentState=EquipmentState, swDbDataRestoreConfig=swDbDataRestoreConfig, oduSectionConfigTimMode=oduSectionConfigTimMode, ncuScheduledActivation=ncuScheduledActivation, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, fsp150cm=fsp150cm, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, swDbFileArea=swDbFileArea, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, software=software, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, inventoryUnitName=inventoryUnitName, fspxg118pro_cshac=fspxg118pro_cshac, PartitionStatus=PartitionStatus, vtpEntityClass=vtpEntityClass, snmpAgent=snmpAgent, neMemorySizeFree=neMemorySizeFree, events=events, entityTable=entityTable, snmpProxyServerAdminState=snmpProxyServerAdminState, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, sonetSectionConfigTimMode=sonetSectionConfigTimMode, swDbFileTable=swDbFileTable, neEventLogVarInteger32Val=neEventLogVarInteger32Val, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, sonetSectionDataEntry=sonetSectionDataEntry, containsIndex=containsIndex, swVersionEntry=swVersionEntry, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, neSwDownloadProgress=neSwDownloadProgress, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, controlPlaneEthEntityClass=controlPlaneEthEntityClass, inventoryTable=inventoryTable, inventoryVendorId=inventoryVendorId, provAssignmentState=provAssignmentState, neBackupRestoreRequest=neBackupRestoreRequest, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, oduTcmADataEntry=oduTcmADataEntry, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, SonetVcBundleAllocation=SonetVcBundleAllocation, entityAssignmentState=entityAssignmentState, vtpEntityAssignmentState=vtpEntityAssignmentState, ptpEntityIndexAid=ptpEntityIndexAid, FspR7Date=FspR7Date, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, neAutoBackupServerLogin=neAutoBackupServerLogin, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, neAlarmStatus=neAlarmStatus, RestoreActivation=RestoreActivation, FspTime=FspTime, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, swDbFileVersion=swDbFileVersion, neTrapsinkRowStatus=neTrapsinkRowStatus, neTrapsinkEntry=neTrapsinkEntry, SonetSectSigDegThres=SonetSectSigDegThres, swDbDataDatabaseVersion=swDbDataDatabaseVersion, neAutoBackupInterval=neAutoBackupInterval, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, swDbDataArea=swDbDataArea, neEventLogNotificationOID=neEventLogNotificationOID, neF7AutomaticBackupTable=neF7AutomaticBackupTable, neEventLogTable=neEventLogTable, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, FspR7FalseTrue=FspR7FalseTrue, inventoryFpgaRev=inventoryFpgaRev, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, FileTransferProtocol=FileTransferProtocol, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, otn=otn, ApsDirection=ApsDirection, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, neEventsLogged=neEventsLogged, oduTcmCConfigEntry=oduTcmCConfigEntry, neEventLogTimeStamp=neEventLogTimeStamp, sourceIpAddress=sourceIpAddress, SourceIpAddress=SourceIpAddress, containsTable=containsTable, inventorySoftwareRev=inventorySoftwareRev, TrapAlarmSeverity=TrapAlarmSeverity, ptpEntityType=ptpEntityType, fspxg404=fspxg404, swDbDataNumEqpt=swDbDataNumEqpt, inventoryCleiCode=inventoryCleiCode, vtpEntityReferencedTo=vtpEntityReferencedTo, EthDuplexModeCaps=EthDuplexModeCaps, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, EntityClass=EntityClass, oduTcmCConfigTimMode=oduTcmCConfigTimMode, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, FileType=FileType, eqpFwEqpType=eqpFwEqpType, advaMIB=advaMIB, updateBackupRestoreMib=updateBackupRestoreMib, ServiceAffectingCaps=ServiceAffectingCaps, SnmpProxySynchronizationState=SnmpProxySynchronizationState, snmpWriteAccessNmsName=snmpWriteAccessNmsName, neAutoBackupNextActionAt=neAutoBackupNextActionAt, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, snmpWriteAccessTable=snmpWriteAccessTable, OtnPayloadTypeCaps=OtnPayloadTypeCaps, ptpEntityClass=ptpEntityClass, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, neEventLogIndex=neEventLogIndex, installedEqpt=installedEqpt, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, snmpProxyServerSynchroState=snmpProxyServerSynchroState, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, NeSwUpgradeStatusType=NeSwUpgradeStatusType, coldRestartCapEntry=coldRestartCapEntry, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, swDbFileType=swDbFileType, sonetSectionConfigTable=sonetSectionConfigTable, oduTcmAConfigTable=oduTcmAConfigTable, neRestoreFileBackupDate=neRestoreFileBackupDate, swDbFileFileName=swDbFileFileName, swDbDataDefaultsEntry=swDbDataDefaultsEntry, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, swDbFileGrade=swDbFileGrade, swDbFileSize=swDbFileSize, fsp1000=fsp1000, vtpEntityContainedIn=vtpEntityContainedIn, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, sonetSectionDataTable=sonetSectionDataTable, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, fwDataNewVersion=fwDataNewVersion, otuSectionConfigTable=otuSectionConfigTable, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, VirtualContainerType=VirtualContainerType, neEventLogEntry=neEventLogEntry, fsp3000=fsp3000, NeSwInstallStatusType=NeSwInstallStatusType, neTrapsinkType=neTrapsinkType, otuSectionConfigTimMode=otuSectionConfigTimMode, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, swVersionInactiveApplSw=swVersionInactiveApplSw, ptpEntityEntry=ptpEntityEntry, products=products, neStorageCapacity=neStorageCapacity, otuSectionDataTable=otuSectionDataTable, swVersionNextBoot=swVersionNextBoot, eqpFwNcuServerBusy=eqpFwNcuServerBusy, clearRdiskRequest=clearRdiskRequest, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, controlPlaneEthContainsTable=controlPlaneEthContainsTable, neSwUpgradeState=neSwUpgradeState, fspxg480=fspxg480, FspR7UsersDb=FspR7UsersDb, Counter64String=Counter64String, inventoryMib=inventoryMib, fwDataServiceImpairment=fwDataServiceImpairment, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, ServiceAffecting=ServiceAffecting, StandbyServiceAffecting=StandbyServiceAffecting, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, fspR7=fspR7, swDbDataCapEntry=swDbDataCapEntry, EthDuplexMode=EthDuplexMode, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, LoopConfig=LoopConfig, neBackupRestore=neBackupRestore, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, neStorageTable=neStorageTable, neEventLogVarTable=neEventLogVarTable, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, oduTcmCDataTable=oduTcmCDataTable, fsp1500=fsp1500, EnableStateCaps=EnableStateCaps, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, fwDataFirmwareAvailable=fwDataFirmwareAvailable, common=common, entityContainedIn=entityContainedIn, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, snmpProxyServerPort=snmpProxyServerPort, fspxg404_100g=fspxg404_100g, ptpEntityContainedIn=ptpEntityContainedIn, swDbFileIndex=swDbFileIndex, ModuleForm=ModuleForm, TrapCounter=TrapCounter, otuConfig=otuConfig, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, CommandEqpt=CommandEqpt, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, eqpFwEqpServerBusy=eqpFwEqpServerBusy, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, OtnPayloadType=OtnPayloadType, swDbDataNumSaNotReady=swDbDataNumSaNotReady, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, oduTcmCDataEntry=oduTcmCDataEntry, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, fsp150=fsp150, KBytes=KBytes, oduSectionConfigEntry=oduSectionConfigEntry, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, ServiceImpairment=ServiceImpairment, oduTcmAConfigEntry=oduTcmAConfigEntry, Grade=Grade, neStorageEntry=neStorageEntry, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, OtnTcmLevel=OtnTcmLevel, swVersionActiveOperatingSw=swVersionActiveOperatingSw, FspR7YesNo=FspR7YesNo, inventoryEntry=inventoryEntry, neRestoreConfig=neRestoreConfig)
mibBuilder.exportSymbols("ADVA-MIB", oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, neAutoBackup=neAutoBackup, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, provContainerTable=provContainerTable, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, entityIndexAid=entityIndexAid, snmpServerPort=snmpServerPort, neSoftwareUpgrade=neSoftwareUpgrade, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, neEventLogVarEntry=neEventLogVarEntry, neEventLogVarType=neEventLogVarType, swDbDataCapTable=swDbDataCapTable, coldRestartCapTable=coldRestartCapTable, admin=admin, FspDate=FspDate, vtpEntityType=vtpEntityType, OhTerminationLevel=OhTerminationLevel, entityEntry=entityEntry, SonetTraceFormCaps=SonetTraceFormCaps, vtpEntityIndex=vtpEntityIndex, neEventLogVarId=neEventLogVarId, F7FileTimeStamp=F7FileTimeStamp, fwDataForm=fwDataForm, inventoryPartnumber=inventoryPartnumber, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, neSwUpgradeRequest=neSwUpgradeRequest, ptpEntityIndex=ptpEntityIndex, neSwUpgradeServerLogin=neSwUpgradeServerLogin, oduSectionDataEntry=oduSectionDataEntry, neTrapsinkCommunity=neTrapsinkCommunity, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, vtpEntityIndexAid=vtpEntityIndexAid, swDbDataTable=swDbDataTable, TimMode=TimMode, containsEntry=containsEntry, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, oduSectionConfigTable=oduSectionConfigTable, IdentityTranslation=IdentityTranslation, neSwUpgradeType=neSwUpgradeType, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, PgmType=PgmType, LogicalIfTransport=LogicalIfTransport, neEventLogVarCounter64Val=neEventLogVarCounter64Val, aos=aos, ArcState=ArcState, vtpEntityTable=vtpEntityTable, neBackupEncryption=neBackupEncryption, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, fsp1000adm=fsp1000adm, updateEqpt=updateEqpt, eqpFwServiceImpairment=eqpFwServiceImpairment, snmpWriteAccessEntry=snmpWriteAccessEntry, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, ApsHoldoffTime=ApsHoldoffTime, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, ptpEntityReferencedTo=ptpEntityReferencedTo, fspxg118pro_cshdc_g=fspxg118pro_cshdc_g, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, FileArea=FileArea, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, ncuActivationDate=ncuActivationDate, neStorageAvailable=neStorageAvailable, provContainerEntry=provContainerEntry, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, neAutoBackupConfig=neAutoBackupConfig, neTrapsinkPort=neTrapsinkPort, fspxg404_100gcfp2=fspxg404_100gcfp2, ptpEntityAssignmentState=ptpEntityAssignmentState, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, snmpWriteAccessRestriction=snmpWriteAccessRestriction, neTrapsinkAddress=neTrapsinkAddress, oduTcmBConfigTimMode=oduTcmBConfigTimMode, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, RestoreActivationCaps=RestoreActivationCaps, fspxg480_100g=fspxg480_100g, inventoryGradeInventory=inventoryGradeInventory, neStorageIndex=neStorageIndex, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, OhTerminationLevelCaps=OhTerminationLevelCaps, neSwInstallState=neSwInstallState, fwDataTable=fwDataTable, vtpEntityEntry=vtpEntityEntry, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, swDbFileEntry=swDbFileEntry, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, sonetConfig=sonetConfig, fspxg418_100gcfp2=fspxg418_100gcfp2, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, TimModeCaps=TimModeCaps, transportStandards=transportStandards, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, oduTcmBDataTable=oduTcmBDataTable, SonetTimingSource=SonetTimingSource, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, AvailState=AvailState, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, swVersionTable=swVersionTable, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, PYSNMP_MODULE_ID=advaMIB, swDbDataIndex=swDbDataIndex, fspxg418=fspxg418, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, BootState=BootState, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, oduTcmBConfigEntry=oduTcmBConfigEntry, ProtectionMech=ProtectionMech, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, neDateAndTime=neDateAndTime, OnOff=OnOff, EntityType=EntityType, inventoryHardwareRev=inventoryHardwareRev, neManufacturer=neManufacturer, eqpFwUpgradeRequest=eqpFwUpgradeRequest, aosProducts=aosProducts, swDbFileComment=swDbFileComment, oduTcmBConfigTable=oduTcmBConfigTable, neTrapsinkUserName=neTrapsinkUserName, swVersionActiveApplSw=swVersionActiveApplSw, NcuAutoActivation=NcuAutoActivation, YesNoNA=YesNoNA, neTrapsinkVersion=neTrapsinkVersion, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, EntityIndex=EntityIndex, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, fwDataEntry=fwDataEntry, EnableState=EnableState, fspxg480_25g_100g=fspxg480_25g_100g, neMibVariant=neMibVariant, otuSectionDataEntry=otuSectionDataEntry, entityClass=entityClass, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, neBackupPassword=neBackupPassword, CpWdmEntityClass=CpWdmEntityClass, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, fspxg418_100g=fspxg418_100g, FspR7Time=FspR7Time, swDbDataProgramVersion=swDbDataProgramVersion, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, inventoryMacAddress=inventoryMacAddress, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, oduTcmBDataEntry=oduTcmBDataEntry, oduTcmCConfigTable=oduTcmCConfigTable, neTrapsinkTable=neTrapsinkTable, ncuActivationTimeUtc=ncuActivationTimeUtc, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, vtpEntityEquipmentState=vtpEntityEquipmentState, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, neBackupUsers=neBackupUsers, swDbFileRowStatus=swDbFileRowStatus, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, neMemorySizeTotal=neMemorySizeTotal, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, swDbDataDefaultsTable=swDbDataDefaultsTable, ptpEntityEquipmentState=ptpEntityEquipmentState, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, AssignmentState=AssignmentState, fsp2000=fsp2000, swDbDataEntry=swDbDataEntry, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, swDbFilePgmType=swDbFilePgmType, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, ncuActivationTime=ncuActivationTime, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, controlPlaneEthEntityTable=controlPlaneEthEntityTable, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, neBackupRestoreFile=neBackupRestoreFile, aosCommon=aosCommon, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, neSwUpgradeServerAddress=neSwUpgradeServerAddress, otuSectionConfigEntry=otuSectionConfigEntry, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, selectedFile=selectedFile, sonet=sonet, neSwUpgradeFileName=neSwUpgradeFileName, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, otuSectionConfigStuffing=otuSectionConfigStuffing, neAutoBackupServerAddress=neAutoBackupServerAddress, inventoryType=inventoryType, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, entityClassInstanceNumber=entityClassInstanceNumber, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, entityIndex=entityIndex, oduSectionDataTable=oduSectionDataTable, provEquipmentState=provEquipmentState, ProtectionMechCaps=ProtectionMechCaps, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, VirtualContainerTypeCaps=VirtualContainerTypeCaps, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, fspxg118pro_cshdc=fspxg118pro_cshdc, fspxg118pro_cshac_g=fspxg118pro_cshac_g, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, oduTcmAConfigTimMode=oduTcmAConfigTimMode, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, encryptionFwpFile=encryptionFwpFile, F7AutoBackupInterval=F7AutoBackupInterval, neBackupRestoreState=neBackupRestoreState, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, fwDataBootStatus=fwDataBootStatus, neEventLogVarIndex=neEventLogVarIndex, ApsDirectionCaps=ApsDirectionCaps, ncuScheduledDbRestore=ncuScheduledDbRestore, entityEquipmentState=entityEquipmentState, swDbFileCreationTime=swDbFileCreationTime, neAutoBackupServerPasswd=neAutoBackupServerPasswd, fwDataReadyForActivation=fwDataReadyForActivation, swAdmin=swAdmin, ncuActivationDateUtc=ncuActivationDateUtc, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, fspNm=fspNm, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, fwDataProtectionPart=fwDataProtectionPart, FspR7EquipmentType=FspR7EquipmentType, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, ptpEntityTable=ptpEntityTable)
