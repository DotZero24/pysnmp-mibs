...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/adva/ADVA-MIB
...
ModuleIdentity, Counter64, enterprises, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, snmpModules, iso, MibIdentifier, mib_2, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "snmpModules", "iso", "MibIdentifier", "mib-2", "Integer32", "Bits", "TimeTicks", "IpAddress")
DisplayString, MacAddress, TimeStamp, RowStatus, TestAndIncr, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "MacAddress", "TimeStamp", "RowStatus", "TestAndIncr", "DateAndTime", "TextualConvention")
...
fsp3000c = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 1))
fspxg480 = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 2))
fspxg404 = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 3))
fspxg418 = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 4))
fspxg480_25g_100g = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 5)).setLabel("fspxg480-25g-100g")
fspxg480_100g = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 6)).setLabel("fspxg480-100g")
fspxg480_100gcfp2 = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 7)).setLabel("fspxg480-100gcfp2")
fspxg404_100g = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 8)).setLabel("fspxg404-100g")
fspxg404_100gcfp2 = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 9)).setLabel("fspxg404-100gcfp2")
fspxg418_100g = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 10)).setLabel("fspxg418-100g")
fspxg418_100gcfp2 = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 11)).setLabel("fspxg418-100gcfp2")
fspxg118pro_cshac = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 12)).setLabel("fspxg118pro-cshac")
fspxg118pro_cshdc = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 13)).setLabel("fspxg118pro-cshdc")
fspxg118pro_cshac_g = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 14)).setLabel("fspxg118pro-cshac-g")
fspxg118pro_cshdc_g = MibIdentifier((1, 3, 6, 1, 4, 1, 2544, 1, 20, 2, 15)).setLabel("fspxg118pro-cshdc-g")
...
mibBuilder.exportSymbols("ADVA-MIB", neSwUpgradeServerLogin=neSwUpgradeServerLogin, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, fsp1000=fsp1000, vtpEntityReferencedTo=vtpEntityReferencedTo, fsp1500=fsp1500, swDbFileEntry=swDbFileEntry, sonetSectionDataTable=sonetSectionDataTable, AvailState=AvailState, oduTcmCDataEntry=oduTcmCDataEntry, fspxg118pro_cshac=fspxg118pro_cshac, swDbDataIndex=swDbDataIndex, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, neStorageTable=neStorageTable, ApsDirectionCaps=ApsDirectionCaps, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, fsp150=fsp150, snmpWriteAccessEntry=snmpWriteAccessEntry, OhTerminationLevel=OhTerminationLevel, inventoryFpgaRev=inventoryFpgaRev, fspxg480=fspxg480, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, SnmpProxySynchronizationState=SnmpProxySynchronizationState, TrapCounter=TrapCounter, inventoryCleiCode=inventoryCleiCode, swDbDataEntry=swDbDataEntry, installedEqpt=installedEqpt, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, inventoryGradeInventory=inventoryGradeInventory, neEventLogVarOidVal=neEventLogVarOidVal, fsp2000=fsp2000, otuSectionConfigEntry=otuSectionConfigEntry, DestinationNodeOrAgentState=DestinationNodeOrAgentState, NcuAutoActivation=NcuAutoActivation, SonetTimingSourceCaps=SonetTimingSourceCaps, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, ptpEntityReferencedTo=ptpEntityReferencedTo, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, ServiceImpairment=ServiceImpairment, NeSwUpgradeStatusType=NeSwUpgradeStatusType, otuSectionConfigPayload=otuSectionConfigPayload, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, neTrapsinkEntry=neTrapsinkEntry, OtnPayloadTypeCaps=OtnPayloadTypeCaps, NoYesNA=NoYesNA, ptpEntityTable=ptpEntityTable, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, otuSectionConfigTable=otuSectionConfigTable, clearRdiskRequest=clearRdiskRequest, swDbFileTable=swDbFileTable, swDbFileComment=swDbFileComment, fsp150cm=fsp150cm, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, swAdmin=swAdmin, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, inventoryMib=inventoryMib, software=software, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, sonetSectionConfigTable=sonetSectionConfigTable, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, entityType=entityType, SonetTimingSource=SonetTimingSource, OtnTcmLevel=OtnTcmLevel, entityIndex=entityIndex, neAutoBackupConfig=neAutoBackupConfig, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, swVersionInactiveApplSw=swVersionInactiveApplSw, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, otuSectionDataTable=otuSectionDataTable, inventoryMacAddress=inventoryMacAddress, inventoryHardwareRev=inventoryHardwareRev, entityEntry=entityEntry, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, StandbyServiceAffecting=StandbyServiceAffecting, controlPlaneEthContainsTable=controlPlaneEthContainsTable, neEventLogVarId=neEventLogVarId, fspR7=fspR7, oduTcmCConfigEntry=oduTcmCConfigEntry, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, ApsDirection=ApsDirection, swVersionNextBoot=swVersionNextBoot, swDbDataTable=swDbDataTable, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, swVersionActiveOperatingSw=swVersionActiveOperatingSw, neBackupEncryption=neBackupEncryption, swVersionActiveApplSw=swVersionActiveApplSw, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, snmpWriteAccessNmsName=snmpWriteAccessNmsName, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, SonetVcBundleAllocation=SonetVcBundleAllocation, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, updateEqpt=updateEqpt, entityEquipmentState=entityEquipmentState, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, neTrapsinkTable=neTrapsinkTable, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, EnableState=EnableState, neEventLogIdentityTranslation=neEventLogIdentityTranslation, neF7AutomaticBackupTable=neF7AutomaticBackupTable, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, swDbDataRestoreConfig=swDbDataRestoreConfig, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, otuConfig=otuConfig, swDbDataDefaultsTable=swDbDataDefaultsTable, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, vtpEntityEntry=vtpEntityEntry, vtpEntityAssignmentState=vtpEntityAssignmentState, neAutoBackupServerAddress=neAutoBackupServerAddress, inventorySerialNum=inventorySerialNum, ncuActivationTimeUtc=ncuActivationTimeUtc, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, VirtualContainerTypeCaps=VirtualContainerTypeCaps, common=common, ncuActivationDate=ncuActivationDate, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, oduSectionConfigEntry=oduSectionConfigEntry, fspxg480_25g_100g=fspxg480_25g_100g, entityClassInstanceNumber=entityClassInstanceNumber, neEventLogEntry=neEventLogEntry, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, oduTcmCDataTable=oduTcmCDataTable, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, ncuActivationTime=ncuActivationTime, neAutoBackupNextActionAt=neAutoBackupNextActionAt, inventoryPartnumber=inventoryPartnumber, coldRestartCapEntry=coldRestartCapEntry, neEventLogVarEntry=neEventLogVarEntry, fwDataFirmwareApproved=fwDataFirmwareApproved, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, swDbFileType=swDbFileType, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, neAutoBackup=neAutoBackup, inventoryVendorId=inventoryVendorId, fwDataProtectionPart=fwDataProtectionPart, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, OtnPayloadType=OtnPayloadType, neBackupRestoreState=neBackupRestoreState, aosProducts=aosProducts, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, ptpEntityContainedIn=ptpEntityContainedIn, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, fspxg418_100gcfp2=fspxg418_100gcfp2, NeSwInstallStatusType=NeSwInstallStatusType, entityAssignmentState=entityAssignmentState, neBackupPassword=neBackupPassword, ptpEntityClass=ptpEntityClass, FspR7YesNo=FspR7YesNo, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, snmpProxyServerSynchroState=snmpProxyServerSynchroState, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, neEventLogNotificationOID=neEventLogNotificationOID, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, oduSectionDataEntry=oduSectionDataEntry, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, AssignmentState=AssignmentState, neSwUpgradeType=neSwUpgradeType, eqpFwEqpType=eqpFwEqpType, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, ncuScheduledActivation=ncuScheduledActivation, EthDuplexModeCaps=EthDuplexModeCaps, fwDataServiceImpairment=fwDataServiceImpairment, otn=otn, F7AutoBackupRunState=F7AutoBackupRunState, sourceIpAddress=sourceIpAddress, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, swDbFileCreationTime=swDbFileCreationTime, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, LogicalIfTransportCaps=LogicalIfTransportCaps, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, vtpEntityType=vtpEntityType, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, encryptionFwpFile=encryptionFwpFile, containsIndex=containsIndex, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, oduTcmBConfigTable=oduTcmBConfigTable, updateBackupRestoreMib=updateBackupRestoreMib, fspxg118pro_cshdc=fspxg118pro_cshdc, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, swVersionEntry=swVersionEntry, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, config=config, neEventLogTimeStamp=neEventLogTimeStamp, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, OtnTcmLevelCaps=OtnTcmLevelCaps, neBackupRestoreFile=neBackupRestoreFile, neAutoBackupServerPasswd=neAutoBackupServerPasswd, fsp3000c=fsp3000c, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, oduTcmAConfigEntry=oduTcmAConfigEntry, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, EntityClass=EntityClass, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, YesNoNA=YesNoNA, ArcState=ArcState, FileArea=FileArea, transportStandards=transportStandards, vtpEntityIndexAid=vtpEntityIndexAid, inventoryTable=inventoryTable, entityTable=entityTable, aosCommon=aosCommon, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, neTrapsinkType=neTrapsinkType, PartitionStatus=PartitionStatus, inventoryUnitName=inventoryUnitName, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, swDbDataDatabaseVersion=swDbDataDatabaseVersion, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, sonetSectionDataEntry=sonetSectionDataEntry, neAlarmStatus=neAlarmStatus, swDbDataProgramVersion=swDbDataProgramVersion, neTrapsinkRowStatus=neTrapsinkRowStatus, sonetConfig=sonetConfig, oduSectionConfigTimMode=oduSectionConfigTimMode, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, neSwUpgradeFileName=neSwUpgradeFileName, eqpFwUpgradeRequest=eqpFwUpgradeRequest, oduTcmBDataTable=oduTcmBDataTable, RestoreActivationCaps=RestoreActivationCaps, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, EquipmentState=EquipmentState, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, neAutoBackupServerDirectory=neAutoBackupServerDirectory, neTrapsinkVersion=neTrapsinkVersion, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, neStorageDescr=neStorageDescr, neManufacturer=neManufacturer)
mibBuilder.exportSymbols("ADVA-MIB", FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, eqpFwServiceImpairment=eqpFwServiceImpairment, swDbDataActivationTime=swDbDataActivationTime, inventoryType=inventoryType, neBackupRestore=neBackupRestore, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, ApsHoldoffTime=ApsHoldoffTime, FspTime=FspTime, neSwInstallState=neSwInstallState, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, aos=aos, neStorageEntry=neStorageEntry, fwDataForm=fwDataForm, fwDataNewVersion=fwDataNewVersion, fsp1000adm=fsp1000adm, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, KBytes=KBytes, EnableStateCaps=EnableStateCaps, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, FspR7EquipmentType=FspR7EquipmentType, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, otuSectionDataEntry=otuSectionDataEntry, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, neDateAndTime=neDateAndTime, FspR7Date=FspR7Date, snmpAgent=snmpAgent, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, TimMode=TimMode, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, provContainerTable=provContainerTable, neTrapsinkUserName=neTrapsinkUserName, neMibVariant=neMibVariant, FspR7FalseTrue=FspR7FalseTrue, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, neMemorySizeFree=neMemorySizeFree, neEventLogVarInteger32Val=neEventLogVarInteger32Val, oduTcmBConfigEntry=oduTcmBConfigEntry, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, fspxg404_100gcfp2=fspxg404_100gcfp2, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, SonetTraceForm=SonetTraceForm, swVersionTable=swVersionTable, ptpEntityIndexAid=ptpEntityIndexAid, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, ncuScheduledDbRestore=ncuScheduledDbRestore, FileType=FileType, neEventLogTable=neEventLogTable, neEventLogIndex=neEventLogIndex, neEventLogVarIndex=neEventLogVarIndex, FspR7UsersDb=FspR7UsersDb, oduTcmCConfigTable=oduTcmCConfigTable, neBackupRestoreRequest=neBackupRestoreRequest, neRestoreFileBackupDate=neRestoreFileBackupDate, fwDataReadyForActivation=fwDataReadyForActivation, neAutoBackupInterval=neAutoBackupInterval, snmpProxyServerPort=snmpProxyServerPort, dbAdmin=dbAdmin, LoopConfig=LoopConfig, RestoreActivation=RestoreActivation, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, fspxg118pro_cshac_g=fspxg118pro_cshac_g, PgmType=PgmType, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, snmpWriteAccessRestriction=snmpWriteAccessRestriction, eqpFwNcuServerBusy=eqpFwNcuServerBusy, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, containsEntry=containsEntry, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, PYSNMP_MODULE_ID=advaMIB, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, vtpEntityClass=vtpEntityClass, ProtectionMech=ProtectionMech, ptpEntityType=ptpEntityType, swDbDataArea=swDbDataArea, fwDataFirmwareAvailable=fwDataFirmwareAvailable, oduTcmADataEntry=oduTcmADataEntry, coldRestartCapTable=coldRestartCapTable, neBackupUsers=neBackupUsers, events=events, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, CommandEqpt=CommandEqpt, neEventLogVarType=neEventLogVarType, fspxg418_100g=fspxg418_100g, containsTable=containsTable, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, otuSectionConfigStuffing=otuSectionConfigStuffing, EntityIndex=EntityIndex, controlPlaneEthEntityTable=controlPlaneEthEntityTable, neEventsLogged=neEventsLogged, ServiceAffectingCaps=ServiceAffectingCaps, SonetSectSigDegThres=SonetSectSigDegThres, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, fsp3000=fsp3000, neMemorySizeTotal=neMemorySizeTotal, snmpProxyServerAdminState=snmpProxyServerAdminState, ServiceAffecting=ServiceAffecting, swDbDataCapTable=swDbDataCapTable, oduConfig=oduConfig, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, oduTcmAConfigTimMode=oduTcmAConfigTimMode, swDbFileVersion=swDbFileVersion, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, oduTcmBConfigTimMode=oduTcmBConfigTimMode, vtpEntityTable=vtpEntityTable, TrapAlarmSeverity=TrapAlarmSeverity, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, VirtualContainerType=VirtualContainerType, ProtectionMechCaps=ProtectionMechCaps, EntityType=EntityType, provContainerEntry=provContainerEntry, vtpEntityIndex=vtpEntityIndex, fwDataBootStatus=fwDataBootStatus, neStorageAvailable=neStorageAvailable, ptpEntityAssignmentState=ptpEntityAssignmentState, neRestoreConfig=neRestoreConfig, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, FileTransferProtocol=FileTransferProtocol, entityIndexAid=entityIndexAid, neTrapsinkAddress=neTrapsinkAddress, provEquipmentState=provEquipmentState, BootState=BootState, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, neSwDownloadProgress=neSwDownloadProgress, oduSectionDataTable=oduSectionDataTable, selectedFile=selectedFile, neInfo=neInfo, ptpEntityEntry=ptpEntityEntry, advaMIB=advaMIB, swDbDataCapEntry=swDbDataCapEntry, neSwUpgradeRequest=neSwUpgradeRequest, vtpEntityEquipmentState=vtpEntityEquipmentState, snmpServerPort=snmpServerPort, products=products, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, oduTcmCConfigTimMode=oduTcmCConfigTimMode, neEventLogVarTable=neEventLogVarTable, IdentityTranslation=IdentityTranslation, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, ModuleForm=ModuleForm, swDbFileArea=swDbFileArea, CpWdmEntityClass=CpWdmEntityClass, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, fwDataTable=fwDataTable, provAssignmentState=provAssignmentState, swDbDataDefaultsEntry=swDbDataDefaultsEntry, neStorageCapacity=neStorageCapacity, otuSectionConfigTimMode=otuSectionConfigTimMode, inventorySoftwareRev=inventorySoftwareRev, controlPlaneEthEntityClass=controlPlaneEthEntityClass, snmpWriteAccessTable=snmpWriteAccessTable, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, fsp3000alm=fsp3000alm, oduTcmAConfigTable=oduTcmAConfigTable, neAutoBackupServerLogin=neAutoBackupServerLogin, eqpFwEqpServerBusy=eqpFwEqpServerBusy, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, neStorageIndex=neStorageIndex, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, oduSectionConfigTable=oduSectionConfigTable, TimModeCaps=TimModeCaps, fspxg480_100g=fspxg480_100g, swDbFileRowStatus=swDbFileRowStatus, swDbDataNumEqpt=swDbDataNumEqpt, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, neTrapsinkCommunity=neTrapsinkCommunity, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, sonetSectionConfigEntry=sonetSectionConfigEntry, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, Grade=Grade, OhTerminationLevelCaps=OhTerminationLevelCaps, LogicalIfTransport=LogicalIfTransport, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, fspxg118pro_cshdc_g=fspxg118pro_cshdc_g, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, swDbFilePgmType=swDbFilePgmType, LoopConfigCaps=LoopConfigCaps, F7AutoBackupInterval=F7AutoBackupInterval, neSwUpgradeState=neSwUpgradeState, oduTcmADataTable=oduTcmADataTable, vtpEntityContainedIn=vtpEntityContainedIn, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, neSoftwareUpgrade=neSoftwareUpgrade, OnOff=OnOff, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, entityClass=entityClass, swDbFileGrade=swDbFileGrade, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, ncuActivationDateUtc=ncuActivationDateUtc, fspxg480_100gcfp2=fspxg480_100gcfp2, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, FspDate=FspDate, sonet=sonet, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, swDbFileFileName=swDbFileFileName, swDbDataNumSaNotReady=swDbDataNumSaNotReady, swDbFileIndex=swDbFileIndex, neTrapsinkPort=neTrapsinkPort, fspxg404_100g=fspxg404_100g, fwDataEntry=fwDataEntry, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, ptpEntityEquipmentState=ptpEntityEquipmentState, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, Counter64String=Counter64String, ptpEntityIndex=ptpEntityIndex, fwDataStandbyVersion=fwDataStandbyVersion, fspNm=fspNm, oduTcmBDataEntry=oduTcmBDataEntry, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, EthDuplexMode=EthDuplexMode, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, FspR7Time=FspR7Time, fspxg418=fspxg418, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, entityContainedIn=entityContainedIn, swDbFileSize=swDbFileSize, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, F7FileTimeStamp=F7FileTimeStamp, inventoryEntry=inventoryEntry, fspxg404=fspxg404, neEventLogVarCounter64Val=neEventLogVarCounter64Val, admin=admin, SonetTraceFormCaps=SonetTraceFormCaps, neSwUpgradeServerAddress=neSwUpgradeServerAddress, SourceIpAddress=SourceIpAddress, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, sonetSectionConfigTimMode=sonetSectionConfigTimMode)
