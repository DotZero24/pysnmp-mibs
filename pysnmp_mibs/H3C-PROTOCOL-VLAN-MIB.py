# SNMP MIB module (H3C-PROTOCOL-VLAN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-PROTOCOL-VLAN-MIB
...
h3cProtocolVlanEntry = _H3cProtocolVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 5, 1)
)
h3cProtocolVlanEntry.setIndexNames(
    (0, "H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanVlanId"),
    (0, "H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanProtocolIndex"),
)
if mibBuilder.loadTexts:
...
h3cProtocolVlanVlanId = _H3cProtocolVlanVlanId_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 5, 1, 1),
...
h3cProtocolVlanProtocolIndex = _H3cProtocolVlanProtocolIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 5, 1, 2),
...
h3cProtocolVlanProtocolType = _H3cProtocolVlanProtocolType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 5, 1, 3),
...
h3cProtocolVlanProtocolSubType = _H3cProtocolVlanProtocolSubType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 5, 1, 4),
...
h3cProtocolVlanProtocolTypeValue = _H3cProtocolVlanProtocolTypeValue_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 5, 1, 5),
...
h3cProtocolVlanRowStatus = _H3cProtocolVlanRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 5, 1, 6),
...
h3cProtocolVlanPortEntry = _H3cProtocolVlanPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 6, 1)
)
h3cProtocolVlanPortEntry.setIndexNames(
    (0, "H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanPortIndex"),
    (0, "H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanPortVlanId"),
    (0, "H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanPortProtocolId"),
)
if mibBuilder.loadTexts:
...
h3cProtocolVlanPortIndex = _H3cProtocolVlanPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 6, 1, 1),
...
h3cProtocolVlanPortVlanId = _H3cProtocolVlanPortVlanId_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 6, 1, 2),
...
h3cProtocolVlanPortProtocolId = _H3cProtocolVlanPortProtocolId_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 6, 1, 3),
...
h3cProtocolVlanPortProtocolType = _H3cProtocolVlanPortProtocolType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 6, 1, 4),
...
h3cProtocolVlanPortProtocolSubType = _H3cProtocolVlanPortProtocolSubType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 6, 1, 5),
...
h3cProtocolVlanPortTypeValue = _H3cProtocolVlanPortTypeValue_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 6, 1, 6),
...
h3cProtocolVlanPortRowStatus = _H3cProtocolVlanPortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 6, 1, 7),
...
class _H3cProtocolVlanPortStatus_Type(Integer32):
    """Custom type h3cProtocolVlanPortStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cProtocolVlanPortStatus_Type.__name__ = "Integer32"
_H3cProtocolVlanPortStatus_Object = MibTableColumn
h3cProtocolVlanPortStatus = _H3cProtocolVlanPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 1, 6, 1, 8),
    _H3cProtocolVlanPortStatus_Type()
)
h3cProtocolVlanPortStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cProtocolVlanPortStatus.setStatus("current")
...
h3cProtocolVlanCompliances = _H3cProtocolVlanCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 2, 1)
)
_H3cProtocolVlanGroups_ObjectIdentity = ObjectIdentity
h3cProtocolVlanGroups = _H3cProtocolVlanGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 2, 2)
)

# Managed Objects groups

h3cProtocolVlanOperateGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 2, 2, 1)
)
h3cProtocolVlanOperateGroup.setObjects(
      *(("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolNumAllVlan"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolNumPerVlan"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolNumAllPort"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolNumPerPort"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cDifferentProtocolNumAllPort"))
)
if mibBuilder.loadTexts:
    h3cProtocolVlanOperateGroup.setStatus("current")

h3cProtocolVlanProtocolGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 2, 2, 2)
)
h3cProtocolVlanProtocolGroup.setObjects(
      *(("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanProtocolType"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanProtocolSubType"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanProtocolTypeValue"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanRowStatus"))
)
if mibBuilder.loadTexts:
    h3cProtocolVlanProtocolGroup.setStatus("current")

h3cProtocolVlanPortGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 2, 2, 3)
)
h3cProtocolVlanPortGroup.setObjects(
      *(("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanPortProtocolType"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanPortProtocolSubType"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanPortTypeValue"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanPortRowStatus"))
)
if mibBuilder.loadTexts:
...
h3cProtocolVlanCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 16, 2, 1, 1)
)
h3cProtocolVlanCompliance.setObjects(
      *(("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanOperateGroup"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanProtocolGroup"),
        ("H3C-PROTOCOL-VLAN-MIB", "h3cProtocolVlanPortGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"H3cvProtocolVlanProtocolType": H3cvProtocolVlanProtocolType,
       ...
       "h3cProtocolVlanPortStatus": h3cProtocolVlanPortStatus,
