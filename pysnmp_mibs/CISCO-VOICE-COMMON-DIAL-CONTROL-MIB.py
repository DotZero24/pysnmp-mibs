...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-VOICE-COMMON-DIAL-CONTROL-MIB
...
mibBuilder.exportSymbols("CISCO-VOICE-COMMON-DIAL-CONTROL-MIB", ciscoVoiceCommonDialControlMIB=ciscoVoiceCommonDialControlMIB, cvCommonDcCallHistoryCallingName=cvCommonDcCallHistoryCallingName, CvcVideoCoderRate=CvcVideoCoderRate, cvCommonDcCallActiveCallingName=cvCommonDcCallActiveCallingName, cvCommonDcMIBCompliances=cvCommonDcMIBCompliances, cvCommonDcCallActiveConnectionId=cvCommonDcCallActiveConnectionId, cvCommonDcCallActiveCallerIDBlock=cvCommonDcCallActiveCallerIDBlock, cvCommonDcMIBGroups=cvCommonDcMIBGroups, cvCommonDcMIBComplianceRev1=cvCommonDcMIBComplianceRev1, CvcGUid=CvcGUid, cvCommonDcCallActiveCoderTypeRate=cvCommonDcCallActiveCoderTypeRate, cvCommonDcMIBCompliance=cvCommonDcMIBCompliance, CvcFaxTransmitRate=CvcFaxTransmitRate, cvCommonDcCallActive=cvCommonDcCallActive, cvCommonDcMIBObjects=cvCommonDcMIBObjects, cvCommonDcCallHistoryEntry=cvCommonDcCallHistoryEntry, cvCommonDcCallGroup=cvCommonDcCallGroup, cvCommonDcCallActiveEntry=cvCommonDcCallActiveEntry, cvCommonDcCallActiveTable=cvCommonDcCallActiveTable, cvCommonDcCallHistoryTable=cvCommonDcCallHistoryTable, cvCommonDcCallHistory=cvCommonDcCallHistory, cvCommonDcCallActiveVADEnable=cvCommonDcCallActiveVADEnable, cvCommonDcMIBNotifications=cvCommonDcMIBNotifications, CvcCoderTypeRate=CvcCoderTypeRate, cvCommonDcMIBConformance=cvCommonDcMIBConformance, CvcCallReferenceIdOrZero=CvcCallReferenceIdOrZero, cvCommonDcCallHistoryCodecBytes=cvCommonDcCallHistoryCodecBytes, cvCommonDcMIBNotificationPrefix=cvCommonDcMIBNotificationPrefix, cvCommonDcCallGroup1=cvCommonDcCallGroup1, cvCommonDcCallHistoryConnectionId=cvCommonDcCallHistoryConnectionId, cvCommonDcCallActiveInBandSignaling=cvCommonDcCallActiveInBandSignaling, PYSNMP_MODULE_ID=ciscoVoiceCommonDialControlMIB, cvCommonDcCallHistoryInBandSignaling=cvCommonDcCallHistoryInBandSignaling, cvCommonDcCallHistoryCallerIDBlock=cvCommonDcCallHistoryCallerIDBlock, CvcSpeechCoderRate=CvcSpeechCoderRate, cvCommonDcCallActiveCodecBytes=cvCommonDcCallActiveCodecBytes, cvCommonDcCallHistoryVADEnable=cvCommonDcCallHistoryVADEnable, CvcH320CallType=CvcH320CallType, cvCommonDcCallHistoryCoderTypeRate=cvCommonDcCallHistoryCoderTypeRate, CvcInBandSignaling=CvcInBandSignaling)
