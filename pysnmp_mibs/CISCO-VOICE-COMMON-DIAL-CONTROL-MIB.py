...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:32:01 2025
...
mibBuilder.exportSymbols("CISCO-VOICE-COMMON-DIAL-CONTROL-MIB", CvcH320CallType=CvcH320CallType, CvcCallReferenceIdOrZero=CvcCallReferenceIdOrZero, cvCommonDcMIBNotifications=cvCommonDcMIBNotifications, ciscoVoiceCommonDialControlMIB=ciscoVoiceCommonDialControlMIB, cvCommonDcMIBComplianceRev1=cvCommonDcMIBComplianceRev1, CvcGUid=CvcGUid, cvCommonDcMIBObjects=cvCommonDcMIBObjects, cvCommonDcCallHistoryVADEnable=cvCommonDcCallHistoryVADEnable, cvCommonDcMIBCompliances=cvCommonDcMIBCompliances, CvcCoderTypeRate=CvcCoderTypeRate, cvCommonDcCallHistoryCallerIDBlock=cvCommonDcCallHistoryCallerIDBlock, CvcFaxTransmitRate=CvcFaxTransmitRate, cvCommonDcMIBCompliance=cvCommonDcMIBCompliance, CvcVideoCoderRate=CvcVideoCoderRate, cvCommonDcCallActiveCodecBytes=cvCommonDcCallActiveCodecBytes, cvCommonDcCallHistoryCodecBytes=cvCommonDcCallHistoryCodecBytes, cvCommonDcMIBNotificationPrefix=cvCommonDcMIBNotificationPrefix, cvCommonDcCallHistoryTable=cvCommonDcCallHistoryTable, cvCommonDcCallActiveVADEnable=cvCommonDcCallActiveVADEnable, CvcSpeechCoderRate=CvcSpeechCoderRate, cvCommonDcCallActiveCallingName=cvCommonDcCallActiveCallingName, cvCommonDcCallGroup1=cvCommonDcCallGroup1, cvCommonDcCallActiveEntry=cvCommonDcCallActiveEntry, cvCommonDcCallActiveCallerIDBlock=cvCommonDcCallActiveCallerIDBlock, cvCommonDcCallActiveInBandSignaling=cvCommonDcCallActiveInBandSignaling, cvCommonDcCallHistoryConnectionId=cvCommonDcCallHistoryConnectionId, CvcInBandSignaling=CvcInBandSignaling, cvCommonDcCallHistoryEntry=cvCommonDcCallHistoryEntry, cvCommonDcCallHistoryInBandSignaling=cvCommonDcCallHistoryInBandSignaling, cvCommonDcCallActiveCoderTypeRate=cvCommonDcCallActiveCoderTypeRate, cvCommonDcCallHistoryCoderTypeRate=cvCommonDcCallHistoryCoderTypeRate, cvCommonDcCallHistoryCallingName=cvCommonDcCallHistoryCallingName, PYSNMP_MODULE_ID=ciscoVoiceCommonDialControlMIB, cvCommonDcMIBGroups=cvCommonDcMIBGroups, cvCommonDcCallActive=cvCommonDcCallActive, cvCommonDcMIBConformance=cvCommonDcMIBConformance, cvCommonDcCallHistory=cvCommonDcCallHistory, cvCommonDcCallActiveConnectionId=cvCommonDcCallActiveConnectionId, cvCommonDcCallActiveTable=cvCommonDcCallActiveTable, cvCommonDcCallGroup=cvCommonDcCallGroup)
