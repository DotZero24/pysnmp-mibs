# SNMP MIB module (DNS110004-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DNS110004-MIB
...
sysNum = _SysNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 1),
    _SysNum_Type()
)
...
sysName = _SysName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 2),
    _SysName_Type()
)
...
sysFWVer = _SysFWVer_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 3),
    _SysFWVer_Type()
)
...
sysNetType = _SysNetType_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 4),
    _SysNetType_Type()
)
...
sysFanSpeed = _SysFanSpeed_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 5),
    _SysFanSpeed_Type()
)
...
sysTemperature = _SysTemperature_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 6),
...
sysPrinterName = _SysPrinterName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 7),
...
sysCIFS = _SysCIFS_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 8),
    _SysCIFS_Type()
)
...
sysFtpServer = _SysFtpServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 9),
    _SysFtpServer_Type()
)
...
sysNFSServer = _SysNFSServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 10),
    _SysNFSServer_Type()
)
...
sysDFSServer = _SysDFSServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 11),
    _SysDFSServer_Type()
)
...
sysQuota = _SysQuota_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 12),
    _SysQuota_Type()
)
...
sysAFP = _SysAFP_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 13),
    _SysAFP_Type()
)
...
sysWebDAV = _SysWebDAV_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 14),
    _SysWebDAV_Type()
)
...
sysWebFileServer = _SysWebFileServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 15),
...
sysiSCSITarget = _SysiSCSITarget_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 16),
...
sysiSNS = _SysiSNS_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 2, 1, 17),
    _SysiSNS_Type()
)
...
diskNum = _DiskNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 3, 1, 1),
    _DiskNum_Type()
)
...
diskName = _DiskName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 3, 1, 2),
    _DiskName_Type()
)
...
diskModel = _DiskModel_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 3, 1, 3),
    _DiskModel_Type()
)
...
diskTemperature = _DiskTemperature_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 3, 1, 4),
...
diskCapacity = _DiskCapacity_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 3, 1, 5),
    _DiskCapacity_Type()
)
...
diskStatus = _DiskStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 3, 1, 6),
    _DiskStatus_Type()
)
...
volumeNum = _VolumeNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 4, 1, 1),
    _VolumeNum_Type()
)
...
volumeName = _VolumeName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 4, 1, 2),
    _VolumeName_Type()
)
...
volumeEncryption = _VolumeEncryption_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 4, 1, 3),
...
volumeFsType = _VolumeFsType_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 4, 1, 4),
    _VolumeFsType_Type()
)
...
volumeRaidLevel = _VolumeRaidLevel_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 4, 1, 5),
...
volumeSize = _VolumeSize_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 4, 1, 6),
    _VolumeSize_Type()
)
...
volumeFreeSpace = _VolumeFreeSpace_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 4, 1, 7),
...
volumeState = _VolumeState_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 4, 1, 8),
    _VolumeState_Type()
)
...
snapShotNum = _SnapShotNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 5, 1, 1),
    _SnapShotNum_Type()
)
...
snapShotVolume = _SnapShotVolume_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 5, 1, 2),
...
snapShotName = _SnapShotName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 5, 1, 3),
    _SnapShotName_Type()
)
...
snapShotSchedule = _SnapShotSchedule_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 5, 1, 4),
...
snapShotCount = _SnapShotCount_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 5, 1, 5),
    _SnapShotCount_Type()
)
...
snapShotState = _SnapShotState_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 5, 1, 6),
    _SnapShotState_Type()
)
...
snapShotPath = _SnapShotPath_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 5, 1, 7),
    _SnapShotPath_Type()
)
...
dFSNum = _DFSNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 6, 1, 1),
    _DFSNum_Type()
)
...
dFSLShareName = _DFSLShareName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 6, 1, 2),
    _DFSLShareName_Type()
)
...
dFSHost = _DFSHost_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 6, 1, 3),
    _DFSHost_Type()
)
...
dFSRSharefolder = _DFSRSharefolder_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 6, 1, 4),
...
nFSNum = _NFSNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 7, 1, 1),
    _NFSNum_Type()
)
...
nFSMountPath = _NFSMountPath_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 7, 1, 2),
    _NFSMountPath_Type()
)
...
nFSHost = _NFSHost_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 7, 1, 3),
    _NFSHost_Type()
)
...
nFSPermission = _NFSPermission_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 7, 1, 4),
    _NFSPermission_Type()
)
...
nFSRootSquash = _NFSRootSquash_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 7, 1, 5),
    _NFSRootSquash_Type()
)
...
nFSStatus = _NFSStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 7, 1, 6),
    _NFSStatus_Type()
)
...
iSONum = _ISONum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 8, 1, 1),
    _ISONum_Type()
)
...
iSOShareName = _ISOShareName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 8, 1, 2),
    _ISOShareName_Type()
)
...
iSOPath = _ISOPath_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 8, 1, 3),
    _ISOPath_Type()
)
...
iSOStatus = _ISOStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 8, 1, 4),
    _ISOStatus_Type()
)
...
logServerNum = _LogServerNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 9, 1, 1),
    _LogServerNum_Type()
)
...
logServerRuleName = _LogServerRuleName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 9, 1, 2),
...
logServerLogfiles = _LogServerLogfiles_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 9, 1, 3),
...
logServerStatus = _LogServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 9, 1, 4),
...
uPSNum = _UPSNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 10, 1, 1),
    _UPSNum_Type()
)
...
uPSDeviceInfo = _UPSDeviceInfo_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 10, 1, 2),
    _UPSDeviceInfo_Type()
)
...
uPSProduct = _UPSProduct_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 10, 1, 3),
    _UPSProduct_Type()
)
...
uPSManufacturer = _UPSManufacturer_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 10, 1, 4),
...
uPSBattery = _UPSBattery_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 10, 1, 5),
    _UPSBattery_Type()
)
...
uPSState = _UPSState_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 10, 1, 6),
    _UPSState_Type()
)
...
uPSServerIP = _UPSServerIP_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 10, 1, 7),
    _UPSServerIP_Type()
)
...
uPSAllowedIP = _UPSAllowedIP_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 10, 1, 8),
    _UPSAllowedIP_Type()
)
...
vVNum = _VVNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 11, 1, 1),
    _VVNum_Type()
)
...
vVTargetName = _VVTargetName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 11, 1, 2),
    _VVTargetName_Type()
)
...
vVSharefolder = _VVSharefolder_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 11, 1, 3),
    _VVSharefolder_Type()
)
...
vVStatus = _VVStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 11, 1, 4),
    _VVStatus_Type()
)
...
vVSize = _VVSize_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 11, 1, 5),
    _VVSize_Type()
)
...
iSCSITargetNum = _ISCSITargetNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 12, 1, 1),
...
iSCSITargetIQN = _ISCSITargetIQN_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 12, 1, 2),
...
iSCSITargetStatus = _ISCSITargetStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 12, 1, 3),
...
iSCSILUNNum = _ISCSILUNNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 13, 1, 1),
    _ISCSILUNNum_Type()
)
...
iSCSILUNName = _ISCSILUNName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 13, 1, 2),
    _ISCSILUNName_Type()
)
...
iSCSILUNVolume = _ISCSILUNVolume_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 13, 1, 3),
...
iSCSILUNSize = _ISCSILUNSize_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 13, 1, 4),
    _ISCSILUNSize_Type()
)
...
iSCSILUNStatus = _ISCSILUNStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 13, 1, 5),
...
iSCSILUNMapping = _ISCSILUNMapping_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 13, 1, 6),
...
iSCSIACLNum = _ISCSIACLNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 14, 1, 1),
    _ISCSIACLNum_Type()
)
...
iSCSIACLName = _ISCSIACLName_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 14, 1, 2),
    _ISCSIACLName_Type()
)
...
iSCSIACLInitiator = _ISCSIACLInitiator_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 14, 1, 3),
...
aMAZONS3Num = _AMAZONS3Num_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 15, 1, 1),
    _AMAZONS3Num_Type()
)
...
aMAZONS3Task = _AMAZONS3Task_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 15, 1, 2),
    _AMAZONS3Task_Type()
)
...
aMAZONS3Schedule = _AMAZONS3Schedule_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 15, 1, 3),
...
aMAZONS3Status = _AMAZONS3Status_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 15, 1, 4),
...
aMAZONS3Enable = _AMAZONS3Enable_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 15, 1, 5),
...
aMAZONS3BackupNow = _AMAZONS3BackupNow_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 15, 1, 6),
...
aMAZONS3Restore = _AMAZONS3Restore_Object(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 15, 1, 7),
...
notifyEvts = _NotifyEvts_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200)
)
...
notifyPasswdChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 1)
)
if mibBuilder.loadTexts:
...
notifyNetworketh0Changed = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 2)
)
if mibBuilder.loadTexts:
...
notifyNetworketh1Changed = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 3)
)
if mibBuilder.loadTexts:
...
notifyTemperatureExceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 4)
)
if mibBuilder.loadTexts:
...
notifyPowerFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 5)
)
if mibBuilder.loadTexts:
...
notifyFirmwareUpgraded = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 6)
)
if mibBuilder.loadTexts:
...
notifyDiskLost = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 7)
)
if mibBuilder.loadTexts:
...
notifyDiskInsertion = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 8)
)
if mibBuilder.loadTexts:
...
notifyRaidFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 9)
)
if mibBuilder.loadTexts:
...
notifyVolumeCreateSuccess = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 10)
)
if mibBuilder.loadTexts:
...
notifyVolumeCreateFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 11)
)
if mibBuilder.loadTexts:
...
notifyVolumeRemoveSuccess = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 12)
)
if mibBuilder.loadTexts:
...
notifyVolumeRemoveFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 13)
)
if mibBuilder.loadTexts:
...
notifyVolumeStatusCrashed = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 14)
)
if mibBuilder.loadTexts:
...
notifyVolumeStatusDegraded = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 15)
)
if mibBuilder.loadTexts:
...
notifyVolumeStatusREBUILD = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 16)
)
if mibBuilder.loadTexts:
...
notifyVolumeStatusREBUILT = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 17)
)
if mibBuilder.loadTexts:
...
notifyHDFull = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 18)
)
if mibBuilder.loadTexts:
...
notifyVolumeSpace = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 19)
)
if mibBuilder.loadTexts:
...
notifySeleftest = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 50, 1, 3, 1, 1, 200, 20)
)
if mibBuilder.loadTexts:
