# SNMP MIB module (NETGEAR-RADLAN-3SW2SWTABLES-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-3SW2SWTABLES-MIB
...
mibBuilder.exportSymbols(
    "NETGEAR-RADLAN-3SW2SWTABLES-MIB",
