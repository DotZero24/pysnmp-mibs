...
mibBuilder.exportSymbols("CISCO-ATM-NETWORK-CLOCK-MIB", cncRootClockSource=cncRootClockSource, cncNcdpPRSReference=cncNcdpPRSReference, cncNcdpHoldTime=cncNcdpHoldTime, cncManualSourceTable=cncManualSourceTable, cncNcdpSourceTable=cncNcdpSourceTable, cncNcdpBestClockSource=cncNcdpBestClockSource, cncManualSourceId=cncManualSourceId, cncGlobal=cncGlobal, cncNcdpAtmEntry=cncNcdpAtmEntry, cncNotifySourceChange=cncNotifySourceChange, cncGroup=cncGroup, ciscoAtmNetworkClockNotificationPrefix=ciscoAtmNetworkClockNotificationPrefix, cncNcdpAdminWeight=cncNcdpAdminWeight, PYSNMP_MODULE_ID=ciscoAtmNetworkClockMIB, cncManualSourceEntry=cncManualSourceEntry, cncNcdpVpi=cncNcdpVpi, cncMIBCompliance=cncMIBCompliance, cncNcdpPriority=cncNcdpPriority, cncNcdpHealth=cncNcdpHealth, cncNcdpMaxDiameter=cncNcdpMaxDiameter, cncNcdpSourceEntry=cncNcdpSourceEntry, cncNodeStratum=cncNodeStratum, ciscoAtmNetworkClockMIBNotifications=ciscoAtmNetworkClockMIBNotifications, ciscoAtmNetworkClockMIB=ciscoAtmNetworkClockMIB, cncManualSourceHealth=cncManualSourceHealth, cncNcdpAtmTable=cncNcdpAtmTable, cncNotificationGroup=cncNotificationGroup, cncSourceChangeReason=cncSourceChangeReason, cncManualRowStatus=cncManualRowStatus, cncNcdpVci=cncNcdpVci, cncNcdpStratum=cncNcdpStratum, cncNcdpEnable=cncNcdpEnable, CncStratum=CncStratum, cncNcdpSource=cncNcdpSource, ciscoAtmNetworkClockConformance=ciscoAtmNetworkClockConformance, CncHealth=CncHealth, cncNotificationOnChange=cncNotificationOnChange, ciscoAtmNetworkClockMIBGroups=ciscoAtmNetworkClockMIBGroups, cncManualSourcePriority=cncManualSourcePriority, ciscoAtmNetworkClockMIBObjects=ciscoAtmNetworkClockMIBObjects, cncSourceChangeTimeStamp=cncSourceChangeTimeStamp, cncManualSource=cncManualSource, cncNcdpMessageInterval=cncNcdpMessageInterval, ciscoAtmNetworkClockMIBCompliances=ciscoAtmNetworkClockMIBCompliances, cncDistributionMethod=cncDistributionMethod, cncNcdp=cncNcdp, cncNcdpRowStatus=cncNcdpRowStatus, cncNcdpSourceHealth=cncNcdpSourceHealth)
