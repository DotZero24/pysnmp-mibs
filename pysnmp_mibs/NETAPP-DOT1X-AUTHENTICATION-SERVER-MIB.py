# SNMP MIB module (NETAPP-DOT1X-AUTHENTICATION-SERVER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netapp/NETAPP-DOT1X-AUTHENTICATION-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:07:40 2025
...
agentDot1xAuthServUserConfigCreate = _AgentDot1xAuthServUserConfigCreate_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 49, 1, 1),
...
agentDot1xAuthServUserConfigTable = _AgentDot1xAuthServUserConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 49, 1, 2)
)
if mibBuilder.loadTexts:
...
agentDot1xAuthServUserConfigEntry = _AgentDot1xAuthServUserConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 49, 1, 2, 1)
)
agentDot1xAuthServUserConfigEntry.setIndexNames(
    (0, "NETAPP-DOT1X-AUTHENTICATION-SERVER-MIB", "agentDot1xAuthServUserIndex"),
)
if mibBuilder.loadTexts:
...
agentDot1xAuthServUserIndex = _AgentDot1xAuthServUserIndex_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 49, 1, 2, 1, 1),
...
agentDot1xAuthServUserName = _AgentDot1xAuthServUserName_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 49, 1, 2, 1, 2),
...
agentDot1xAuthServUserPassword = _AgentDot1xAuthServUserPassword_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 49, 1, 2, 1, 3),
...
agentDot1xAuthServUserStatus = _AgentDot1xAuthServUserStatus_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 49, 1, 2, 1, 4),
...
mibBuilder.exportSymbols(
    "NETAPP-DOT1X-AUTHENTICATION-SERVER-MIB",
