# SNMP MIB module (Baytech-MIB-401-4) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/baytech/Baytech-MIB-401-4
...
sBTAModulesRPCEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "sBTAModulesRPCIndex"),
)
if mibBuilder.loadTexts:
...
sBTAModulesRPCOutletEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "sBTAModulesRPCOutletModuleIndex"),
    (0, "Baytech-MIB-401-4", "sBTAModulesRPCOutletIndex"),
)
if mibBuilder.loadTexts:
...
sBTAModulesRPCModPortEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "sRPCModuleIndex"),
    (0, "Baytech-MIB-401-4", "sRPCPortIndex"),
)
if mibBuilder.loadTexts:
...
sBTAModulesRPCModPortOutletEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "sRPCOutletModuleIndex"),
    (0, "Baytech-MIB-401-4", "sRPCOutletPortIndex"),
    (0, "Baytech-MIB-401-4", "sRPCOutletIndex"),
)
if mibBuilder.loadTexts:
...
sBTAModulesRPCCurrentGroupsCurrentEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "groupCurrentIndex"),
)
if mibBuilder.loadTexts:
...
sBTAModulesRPCBreakersEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "sBTAModulesRPCBreakersModulesIndex"),
    (0, "Baytech-MIB-401-4", "sBTAModulesRPCBreakersBreakersIndex"),
)
if mibBuilder.loadTexts:
...
sRPCModPortBreakersEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "sRPCBreakersModIndex"),
    (0, "Baytech-MIB-401-4", "sRPCBreakersPortIndex"),
    (0, "Baytech-MIB-401-4", "sRPCBreakersBreakersIndex"),
)
if mibBuilder.loadTexts:
...
sBTAControlUserEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "sBTAControlUserIndex"),
)
if mibBuilder.loadTexts:
...
sBTAModulesEnvironmentalObjectsEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "sBTAModulesEnvironmentalModulesIndex"),
    (0, "Baytech-MIB-401-4", "sBTAModulesEnvironmentalSensorsIndex"),
)
if mibBuilder.loadTexts:
...
sRPCEnvironmentalObjectsEntry.setIndexNames(
    (0, "Baytech-MIB-401-4", "sBTAEnvironmentalModuleIndex"),
    (0, "Baytech-MIB-401-4", "sBTAEnvironmentalPortIndex"),
    (0, "Baytech-MIB-401-4", "sBTAEnvironmentalSensorsIndex"),
)
if mibBuilder.loadTexts:
...
communicationLost.setObjects(
    ("Baytech-MIB-401-4", "mtrapargsTimeTicks")
)
if mibBuilder.loadTexts:
...
communicationEstablished.setObjects(
    ("Baytech-MIB-401-4", "mtrapargsString")
)
if mibBuilder.loadTexts:
...
outletOn.setObjects(
      *(("Baytech-MIB-401-4", "sBTAModuleIndex"),
        ("Baytech-MIB-401-4", "sBTAOutletIndex"))
)
if mibBuilder.loadTexts:
    outletOn.setStatus(
        ""
...
temperatureThresholdViolation.setObjects(
    ("Baytech-MIB-401-4", "mtrapargsInteger")
)
if mibBuilder.loadTexts:
...
voltageSourceChangeAlarm.setObjects(
      *(("Baytech-MIB-401-4", "sBTAModuleIndex"),
        ("Baytech-MIB-401-4", "sBTAVoltageSource"),
        ("Baytech-MIB-401-4", "sBTASourceSwitchCount"))
)
if mibBuilder.loadTexts:
...
sensorTempThreshHiAlarmTrap.setObjects(
      *(("Baytech-MIB-401-4", "sBTAModuleIndex"),
        ("Baytech-MIB-401-4", "sBTASensorIndex"))
)
if mibBuilder.loadTexts:
