...
# Notes
# -----
# ASN.1 source file://mibs/trapeze/TRAPEZE-NETWORKS-EXTERNAL-SERVER-MIB
...
trpzExternalServerCompliance.setObjects(
    ("TRAPEZE-NETWORKS-EXTERNAL-SERVER-MIB", "trpzExternalServerConfigGroup")
)
if mibBuilder.loadTexts:
...
trpzExternalServerComplianceRev2.setObjects(
      *(("TRAPEZE-NETWORKS-EXTERNAL-SERVER-MIB", "trpzExternalServerConfigGroup"),
        ("TRAPEZE-NETWORKS-EXTERNAL-SERVER-MIB", "trpzExternalServerDnsServerGroup"))
)
if mibBuilder.loadTexts:
