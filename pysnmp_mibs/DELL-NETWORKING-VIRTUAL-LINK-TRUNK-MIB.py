...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:43:25 2025
...
TimeInterval, MacAddress, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "MacAddress", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("DELL-NETWORKING-VIRTUAL-LINK-TRUNK-MIB", dellNetVLTMacAddr=dellNetVLTMacAddr, dellNetVLTDetailLocalLagID=dellNetVLTDetailLocalLagID, dellNetVirtualLinkTrunkGroup=dellNetVirtualLinkTrunkGroup, dellNetVirtualLinkTrunkMib=dellNetVirtualLinkTrunkMib, dellNetVirtualLinkTrunkGroups=dellNetVirtualLinkTrunkGroups, dellNetVLTRemoteUnitId=dellNetVLTRemoteUnitId, dellNetVLTRemotePeerRouting=dellNetVLTRemotePeerRouting, dellNetVLTRemoteVersionMajor=dellNetVLTRemoteVersionMajor, dellNetVLTIclStatus=dellNetVLTIclStatus, dellNetVirtualLinkTrunkConformance=dellNetVirtualLinkTrunkConformance, DellNetVLTMemberLinkStatus=DellNetVLTMemberLinkStatus, dellNetVLTDomainId=dellNetVLTDomainId, dellNetVLTPeerStatusChange=dellNetVLTPeerStatusChange, dellNetVirtualLinkDetailsTableEntry=dellNetVirtualLinkDetailsTableEntry, dellNetVirtualLinkTrunkNotifications=dellNetVirtualLinkTrunkNotifications, dellNetVirtualLinkTrunkCompliances=dellNetVirtualLinkTrunkCompliances, dellNetVirtualLinkTrunkTableEntry=dellNetVirtualLinkTrunkTableEntry, dellNetVLTBkUpInterval=dellNetVLTBkUpInterval, dellNetVirtualLinkStatsTableEntry=dellNetVirtualLinkStatsTableEntry, dellNetVirtualLinkStatisticsGroup=dellNetVirtualLinkStatisticsGroup, dellNetVLTBkUpIpAddrType=dellNetVLTBkUpIpAddrType, dellNetVLTVersionMajor=dellNetVLTVersionMajor, dellNetVLTDetailPeerLagID=dellNetVLTDetailPeerLagID, dellNetVLTDomainConfigError=dellNetVLTDomainConfigError, dellNetVirtualLinkDetailsTable=dellNetVirtualLinkDetailsTable, dellNetVLTPriority=dellNetVLTPriority, dellNetVLTStatNumHelloSent=dellNetVLTStatNumHelloSent, dellNetVLTDetailLocalStatus=dellNetVLTDetailLocalStatus, dellNetVLTIclStatusChange=dellNetVLTIclStatusChange, dellNetVirtualLinkTrunkCompliance=dellNetVirtualLinkTrunkCompliance, dellNetVLTBkUpIpAddr=dellNetVLTBkUpIpAddr, PYSNMP_MODULE_ID=dellNetVirtualLinkTrunkMib, dellNetVirtualLinkNotificationGroup=dellNetVirtualLinkNotificationGroup, dellNetVLTRoleChange=dellNetVLTRoleChange, dellNetVLTIclBwUsageExceed=dellNetVLTIclBwUsageExceed, dellNetVLTStatNumDomainErrors=dellNetVLTStatNumDomainErrors, dellNetVLTHBeatStatusChange=dellNetVLTHBeatStatusChange, dellNetVLTIclBwStatus=dellNetVLTIclBwStatus, dellNetVLTIclIfIndex=dellNetVLTIclIfIndex, dellNetVLTRemoteRolePriority=dellNetVLTRemoteRolePriority, dellNetVLTRemoteMacAddr=dellNetVLTRemoteMacAddr, dellNetVLTUnitId=dellNetVLTUnitId, dellNetVirtualLinkDetailsTableGroup=dellNetVirtualLinkDetailsTableGroup, dellNetVLTRole=dellNetVLTRole, dellNetVLTPeerStatus=dellNetVLTPeerStatus, dellNetVLTCfgSysMacAddr=dellNetVLTCfgSysMacAddr, dellNetVLTRemoteVersionMinor=dellNetVLTRemoteVersionMinor, dellNetVLTPeerRoutingTimeout=dellNetVLTPeerRoutingTimeout, dellNetVLTHBeatStatus=dellNetVLTHBeatStatus, dellNetVLTStatNumHbeatSent=dellNetVLTStatNumHbeatSent, dellNetVLTErrorReason=dellNetVLTErrorReason, dellNetVLTStatNumHbeatRcvd=dellNetVLTStatNumHbeatRcvd, dellNetVirtualLinkStatsTable=dellNetVirtualLinkStatsTable, dellNetVirtualLinkTrunkNotifObjects=dellNetVirtualLinkTrunkNotifObjects, dellNetVirtualLinkTrunkObjects=dellNetVirtualLinkTrunkObjects, dellNetVLTVersionMinor=dellNetVLTVersionMinor, dellNetVLTPeerRouting=dellNetVLTPeerRouting, dellNetVirtualLinkTrunkTable=dellNetVirtualLinkTrunkTable, dellNetVLTDetailPeerStatus=dellNetVLTDetailPeerStatus, dellNetVLTStatNumVersionErrors=dellNetVLTStatNumVersionErrors, dellNetVLTStatNumHelloRcvd=dellNetVLTStatNumHelloRcvd)
