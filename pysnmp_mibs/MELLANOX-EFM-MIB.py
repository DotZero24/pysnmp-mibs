# SNMP MIB module (MELLANOX-EFM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/mellanox/MELLANOX-EFM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:37 2025
...
(mellanox,) = mibBuilder.importSymbols(
    "MELLANOX-SMI-MIB",
    "mellanox")
...
mellanoxMgmt = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 33049, 2)
)
if mibBuilder.loadTexts:
    mellanoxMgmt.setRevisions(
        ("2014-04-01 00:00",)
    )
...
sendTestTrapSet = _SendTestTrapSet_Object(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 1, 1, 6),
    _SendTestTrapSet_Type()
)
sendTestTrapSet.setMaxAccess("write-only")
if mibBuilder.loadTexts:
    sendTestTrapSet.setStatus("current")
...
fanIndex = _FanIndex_Object(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 1, 5, 1, 1, 1),
    _FanIndex_Type()
)
...
fanName = _FanName_Object(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 1, 5, 1, 1, 2),
    _FanName_Type()
)
...
fanStatus = _FanStatus_Object(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 1, 5, 1, 1, 3),
    _FanStatus_Type()
)
...
fanSpeed = _FanSpeed_Object(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 1, 5, 1, 1, 4),
    _FanSpeed_Type()
)
...
tempIndex = _TempIndex_Object(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 1, 6, 1, 1, 1),
    _TempIndex_Type()
)
...
tempSensorName = _TempSensorName_Object(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 1, 6, 1, 1, 2),
...
tempSensorStatus = _TempSensorStatus_Object(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 1, 6, 1, 1, 3),
...
tempSensor = _TempSensor_Object(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 1, 6, 1, 1, 4),
    _TempSensor_Type()
)
tempSensor.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tempSensor.setStatus("current")
...
bxIbCntEntry.setIndexNames(
    (0, "MELLANOX-EFM-MIB", "bxIbCntIndex"),
)
if mibBuilder.loadTexts:
...
bxEthCntEntry.setIndexNames(
    (0, "MELLANOX-EFM-MIB", "bxEthCntIndex"),
)
if mibBuilder.loadTexts:
...
bxFcCntEntry.setIndexNames(
    (0, "MELLANOX-EFM-MIB", "bxFcCntIndex"),
)
if mibBuilder.loadTexts:
...
mlxIBCAInfoEntry.setIndexNames(
    (0, "MELLANOX-EFM-MIB", "mlxIBCAIndex"),
)
if mibBuilder.loadTexts:
...
mlxIBSwitchInfoEntry.setIndexNames(
    (0, "MELLANOX-EFM-MIB", "mlxIBSwitchIndex"),
)
if mibBuilder.loadTexts:
...
mlxIBRouterInfoEntry.setIndexNames(
    (0, "MELLANOX-EFM-MIB", "mlxIBRouterIndex"),
)
if mibBuilder.loadTexts:
...
mlxIBPortInfoEntry.setIndexNames(
    (0, "MELLANOX-EFM-MIB", "mlxIBPortIndex"),
)
if mibBuilder.loadTexts:
...
systemHealthStatus.setObjects(
    ("MELLANOX-EFM-MIB", "invHealthStatus")
)
if mibBuilder.loadTexts:
...
insufficientPower = NotificationType(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 2, 11)
)
if mibBuilder.loadTexts:
    insufficientPower.setStatus(
        "current"
    )

powerRedundancyMismatch = NotificationType(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 2, 12)
)
if mibBuilder.loadTexts:
    powerRedundancyMismatch.setStatus(
        "current"
    )
...
testTrap.setObjects(
    ("MELLANOX-EFM-MIB", "ifPhysAddress")
)
if mibBuilder.loadTexts:
    testTrap.setStatus(
        "current"
...
internalSpeedMismatch = NotificationType(
    (1, 3, 6, 1, 4, 1, 33049, 2, 1, 2, 14)
)
internalSpeedMismatch.setObjects(
    ("MELLANOX-EFM-MIB", "mellanoxIfVPIIndex")
)
if mibBuilder.loadTexts:
    internalSpeedMismatch.setStatus(
        "current"
    )
...
mlxIBCAHealthStatusChange.setObjects(
      *(("MELLANOX-EFM-MIB", "mlxIBCAIndex"),
        ("MELLANOX-EFM-MIB", "mlxIBCAHealthStatus"),
        ("MELLANOX-EFM-MIB", "mlxIBCADeviceName"))
)
if mibBuilder.loadTexts:
...
mlxIBSwitchInsertion.setObjects(
    ("MELLANOX-EFM-MIB", "mlxIBSwitchIndex")
)
if mibBuilder.loadTexts:
...
mlxIBRouterInsertion.setObjects(
    ("MELLANOX-EFM-MIB", "mlxIBRouterIndex")
)
if mibBuilder.loadTexts:
...
mlxIBPortStateChange.setObjects(
      *(("MELLANOX-EFM-MIB", "mlxIBPortIndex"),
        ("MELLANOX-EFM-MIB", "mlxIBPortState"),
        ("MELLANOX-EFM-MIB", "mlxIBPortGUID"),
        ("MELLANOX-EFM-MIB", "mlxIBPortNodeType"),
        ("MELLANOX-EFM-MIB", "mlxIBPortNodeIndex"))
)
if mibBuilder.loadTexts:
...
mlxIBPortPhysicalStateChange.setObjects(
      *(("MELLANOX-EFM-MIB", "mlxIBPortIndex"),
        ("MELLANOX-EFM-MIB", "mlxIBPortPhysicalState"),
        ("MELLANOX-EFM-MIB", "mlxIBPortGUID"),
        ("MELLANOX-EFM-MIB", "mlxIBPortNodeType"),
        ("MELLANOX-EFM-MIB", "mlxIBPortNodeIndex"))
)
...
mibBuilder.exportSymbols(
    ...
    **{"IbGuid": IbGuid,
       ...
       "buildInfo": buildInfo,
       "nodeName": nodeName,
       "sendTestTrapSet": sendTestTrapSet,
       "procmgr": procmgr,
       "procTable": procTable,
       "procEntry": procEntry,
       "procIndex": procIndex,
       ...
       "powerRedundancyMismatch": powerRedundancyMismatch,
       "testTrap": testTrap,
       "internalSpeedMismatch": internalSpeedMismatch,
       "ibSwitch": ibSwitch,
