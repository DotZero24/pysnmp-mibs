_f='mlxIBPortPhysicalState'
_e='mlxIBPortState'
_d='mlxIBCADeviceName'
_c='mlxIBCAHealthStatus'
_b='invHealthStatus'
_a='bxFcCntIndex'
_Z='bxEthCntIndex'
_Y='bxIbCntIndex'
...
_R='fsIndex'
_Q='procIndex'
_P='mlxIBPortNodeIndex'
_O='mlxIBPortNodeType'
_N='mlxIBPortGUID'
_M='procName'
_L='other'
_K='Unsigned32'
...
if mibBuilder.loadTexts:mellanoxMgmt.setRevisions(('2014-04-01 00:00',))
...
_SendTestTrapSet_Type=Unsigned32
_SendTestTrapSet_Object=MibScalar
sendTestTrapSet=_SendTestTrapSet_Object((1,3,6,1,4,1,33049,2,1,1,1,6),_SendTestTrapSet_Type())
sendTestTrapSet.setMaxAccess('write-only')
if mibBuilder.loadTexts:sendTestTrapSet.setStatus(_A)
...
procEntry.setIndexNames((0,_C,_Q))
...
cpuEntry.setIndexNames((0,_C,_S))
...
_FanInventory_ObjectIdentity=ObjectIdentity
fanInventory=_FanInventory_ObjectIdentity((1,3,6,1,4,1,33049,2,1,1,5))
_FanTable_Object=MibTable
fanTable=_FanTable_Object((1,3,6,1,4,1,33049,2,1,1,5,1))
if mibBuilder.loadTexts:fanTable.setStatus(_A)
_FanEntry_Object=MibTableRow
fanEntry=_FanEntry_Object((1,3,6,1,4,1,33049,2,1,1,5,1,1))
fanEntry.setIndexNames((0,_C,_T))
if mibBuilder.loadTexts:fanEntry.setStatus(_A)
_FanIndex_Type=Unsigned32
_FanIndex_Object=MibTableColumn
fanIndex=_FanIndex_Object((1,3,6,1,4,1,33049,2,1,1,5,1,1,1),_FanIndex_Type())
fanIndex.setMaxAccess(_B)
if mibBuilder.loadTexts:fanIndex.setStatus(_A)
_FanName_Type=OctetString
_FanName_Object=MibTableColumn
fanName=_FanName_Object((1,3,6,1,4,1,33049,2,1,1,5,1,1,2),_FanName_Type())
fanName.setMaxAccess(_B)
if mibBuilder.loadTexts:fanName.setStatus(_A)
_FanStatus_Type=OctetString
_FanStatus_Object=MibTableColumn
fanStatus=_FanStatus_Object((1,3,6,1,4,1,33049,2,1,1,5,1,1,3),_FanStatus_Type())
...
fanSpeed=_FanSpeed_Object((1,3,6,1,4,1,33049,2,1,1,5,1,1,4),_FanSpeed_Type())
fanSpeed.setMaxAccess(_B)
if mibBuilder.loadTexts:fanSpeed.setStatus(_A)
_TempInventory_ObjectIdentity=ObjectIdentity
tempInventory=_TempInventory_ObjectIdentity((1,3,6,1,4,1,33049,2,1,1,6))
_TempTable_Object=MibTable
tempTable=_TempTable_Object((1,3,6,1,4,1,33049,2,1,1,6,1))
if mibBuilder.loadTexts:tempTable.setStatus(_A)
_TempEntry_Object=MibTableRow
tempEntry=_TempEntry_Object((1,3,6,1,4,1,33049,2,1,1,6,1,1))
tempEntry.setIndexNames((0,_C,_U))
if mibBuilder.loadTexts:tempEntry.setStatus(_A)
_TempIndex_Type=Unsigned32
_TempIndex_Object=MibTableColumn
tempIndex=_TempIndex_Object((1,3,6,1,4,1,33049,2,1,1,6,1,1,1),_TempIndex_Type())
tempIndex.setMaxAccess(_D)
if mibBuilder.loadTexts:tempIndex.setStatus(_A)
_TempSensorName_Type=OctetString
_TempSensorName_Object=MibTableColumn
tempSensorName=_TempSensorName_Object((1,3,6,1,4,1,33049,2,1,1,6,1,1,2),_TempSensorName_Type())
tempSensorName.setMaxAccess(_B)
if mibBuilder.loadTexts:tempSensorName.setStatus(_A)
_TempSensorStatus_Type=OctetString
_TempSensorStatus_Object=MibTableColumn
tempSensorStatus=_TempSensorStatus_Object((1,3,6,1,4,1,33049,2,1,1,6,1,1,3),_TempSensorStatus_Type())
tempSensorStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:tempSensorStatus.setStatus(_A)
_TempSensor_Type=Unsigned32
_TempSensor_Object=MibTableColumn
tempSensor=_TempSensor_Object((1,3,6,1,4,1,33049,2,1,1,6,1,1,4),_TempSensor_Type())
tempSensor.setMaxAccess(_B)
if mibBuilder.loadTexts:tempSensor.setStatus(_A)
...
invEntry.setIndexNames((0,_C,_V))
...
cntEntry.setIndexNames((0,_C,_W))
...
bxInvEntry.setIndexNames((0,_C,_X))
...
bxIbCntEntry.setIndexNames((0,_C,_Y))
...
bxEthCntEntry.setIndexNames((0,_C,_Z))
...
bxFcCntEntry.setIndexNames((0,_C,_a))
...
procUnexpectedExit.setObjects((_C,_M))
...
systemHealthStatus.setObjects((_C,_b))
...
if mibBuilder.loadTexts:insufficientPower.setStatus(_A)
powerRedundancyMismatch=NotificationType((1,3,6,1,4,1,33049,2,1,2,12))
if mibBuilder.loadTexts:powerRedundancyMismatch.setStatus(_A)
testTrap=NotificationType((1,3,6,1,4,1,33049,2,1,2,13))
testTrap.setObjects((_C,'ifPhysAddress'))
if mibBuilder.loadTexts:testTrap.setStatus(_A)
internalSpeedMismatch=NotificationType((1,3,6,1,4,1,33049,2,1,2,14))
internalSpeedMismatch.setObjects((_C,'mellanoxIfVPIIndex'))
if mibBuilder.loadTexts:internalSpeedMismatch.setStatus(_A)
...
mlxIBCAHealthStatusChange.setObjects(*((_C,_H),(_C,_c),(_C,_d)))
...
mlxIBPortStateChange.setObjects(*((_C,_G),(_C,_e),(_C,_N),(_C,_O),(_C,_P)))
...
mlxIBPortPhysicalStateChange.setObjects(*((_C,_G),(_C,_f),(_C,_N),(_C,_O),(_C,_P)))
...
mibBuilder.exportSymbols(_C,**{'IbGuid':IbGuid,'mellanoxMgmt':mellanoxMgmt,'generalMgmt':generalMgmt,'gmVariables':gmVariables,'gmSystem':gmSystem,'type':type,'serialNumber':serialNumber,'swVersion':swVersion,'buildInfo':buildInfo,'nodeName':nodeName,'sendTestTrapSet':sendTestTrapSet,'procmgr':procmgr,'procTable':procTable,'procEntry':procEntry,_Q:procIndex,_M:procName,'procStatus':procStatus,'procNumFailures':procNumFailures,'storage':storage,'fsTable':fsTable,'fsEntry':fsEntry,_R:fsIndex,'fsMountPoint':fsMountPoint,'fsSpaceTotal':fsSpaceTotal,'fsSpaceUsed':fsSpaceUsed,'fsSpaceFree':fsSpaceFree,'fsSpaceAvail':fsSpaceAvail,'cpus':cpus,'cpuTable':cpuTable,'cpuEntry':cpuEntry,_S:cpuIndex,'idleTime':idleTime,'systemTime':systemTime,'userTime':userTime,'fanInventory':fanInventory,'fanTable':fanTable,'fanEntry':fanEntry,_T:fanIndex,'fanName':fanName,'fanStatus':fanStatus,'fanSpeed':fanSpeed,'tempInventory':tempInventory,'tempTable':tempTable,'tempEntry':tempEntry,_U:tempIndex,'tempSensorName':tempSensorName,'tempSensorStatus':tempSensorStatus,'tempSensor':tempSensor,'gmNotifications':gmNotifications,'internalBusError':internalBusError,'procCrash':procCrash,'cpuUtilHigh':cpuUtilHigh,'procUnexpectedExit':procUnexpectedExit,'unexpectedShutdown':unexpectedShutdown,'diskSpaceLow':diskSpaceLow,'systemHealthStatus':systemHealthStatus,'lowPowerRecover':lowPowerRecover,'insufficientFans':insufficientFans,'insufficientFansRecover':insufficientFansRecover,'insufficientPower':insufficientPower,'powerRedundancyMismatch':powerRedundancyMismatch,'testTrap':testTrap,'internalSpeedMismatch':internalSpeedMismatch,'ibSwitch':ibSwitch,'ibVariables':ibVariables,'ibInventory':ibInventory,'invTable':invTable,'invEntry':invEntry,_V:invIndex,'invName':invName,'invType':invType,'invPartNum':invPartNum,'invSerialNum':invSerialNum,'invFirmware':invFirmware,_b:invHealthStatus,'ibPorts':ibPorts,'cntTable':cntTable,'cntEntry':cntEntry,_W:cntIndex,'cntName':cntName,'cntPort':cntPort,'cntPhyState':cntPhyState,'cntLogState':cntLogState,'cntRate':cntRate,'cntMTU':cntMTU,'cntRcvData':cntRcvData,'cntRcvPkts':cntRcvPkts,'cntXmitData':cntXmitData,'cntXmitPkts':cntXmitPkts,'cntRcvErr':cntRcvErr,'cntXmitDiscard':cntXmitDiscard,'cntXmitWait':cntXmitWait,'cntSymErr':cntSymErr,'cntVL15Drop':cntVL15Drop,'cntSpeed':cntSpeed,'cntWidth':cntWidth,'cntOperationalVLs':cntOperationalVLs,'cntSupportedSpeeds':cntSupportedSpeeds,'cntSupportedWidths':cntSupportedWidths,'cntMaxSupportedMTUs':cntMaxSupportedMTUs,'cntVLCapabilities':cntVLCapabilities,'cntGUID':cntGUID,'cntLID':cntLID,'ibNotifications':ibNotifications,'asicChipDown':asicChipDown,'asicOverTempReset':asicOverTempReset,'asicOverTemp':asicOverTemp,'lowPower':lowPower,'subnetMngr':subnetMngr,'smVariables':smVariables,'smNotifications':smNotifications,'ibSMup':ibSMup,'ibSMdown':ibSMdown,'ibSMrestart':ibSMrestart,'bxBridge':bxBridge,'bxVariables':bxVariables,'bxInventory':bxInventory,'bxInvTable':bxInvTable,'bxInvEntry':bxInvEntry,_X:bxInvIndex,'bxInvName':bxInvName,'bxInvType':bxInvType,'bxInvPartNum':bxInvPartNum,'bxInvSerialNum':bxInvSerialNum,'bxInvFirmware':bxInvFirmware,'bxIbPorts':bxIbPorts,'bxIbCntTable':bxIbCntTable,'bxIbCntEntry':bxIbCntEntry,_Y:bxIbCntIndex,'bxIbCntName':bxIbCntName,'bxIbCntPort':bxIbCntPort,'bxIbCntLogState':bxIbCntLogState,'bxIbCntPhyState':bxIbCntPhyState,'bxIbCntRate':bxIbCntRate,'bxIbCntSupportedSpeeds':bxIbCntSupportedSpeeds,'bxIbCntSpeed':bxIbCntSpeed,'bxIbCntSupportedWidths':bxIbCntSupportedWidths,'bxIbCntWidth':bxIbCntWidth,'bxIbCntMaxSupportedMTUs':bxIbCntMaxSupportedMTUs,'bxIbCntMTU':bxIbCntMTU,'bxIbCntVLCapabilities':bxIbCntVLCapabilities,'bxIbCntOperationalVLs':bxIbCntOperationalVLs,'bxIbCntGUID':bxIbCntGUID,'bxIbCntLID':bxIbCntLID,'bxIbCntRcvPkts':bxIbCntRcvPkts,'bxIbCntRcvData':bxIbCntRcvData,'bxIbCntRcvErr':bxIbCntRcvErr,'bxIbCntSymErr':bxIbCntSymErr,'bxIbCntVL15Drop':bxIbCntVL15Drop,'bxIbCntXmitPkts':bxIbCntXmitPkts,'bxIbCntXmitData':bxIbCntXmitData,'bxIbCntXmitWaits':bxIbCntXmitWaits,'bxIbCntXmitDiscards':bxIbCntXmitDiscards,'bxEthPorts':bxEthPorts,'bxEthCntTable':bxEthCntTable,'bxEthCntEntry':bxEthCntEntry,_Z:bxEthCntIndex,'bxEthCntName':bxEthCntName,'bxEthCntAdminMode':bxEthCntAdminMode,'bxEthCntStatus':bxEthCntStatus,'bxEthCntSupportedSpeeds':bxEthCntSupportedSpeeds,'bxEthCntSpeed':bxEthCntSpeed,'bxEthCntDuplex':bxEthCntDuplex,'bxEthCntMTU':bxEthCntMTU,'bxEthCntFlowcontrolStatus':bxEthCntFlowcontrolStatus,'bxEthCntFlowcontrolMode':bxEthCntFlowcontrolMode,'bxEthCntFlowcontrolPriorities':bxEthCntFlowcontrolPriorities,'bxEthCntRcvPkts':bxEthCntRcvPkts,'bxEthCntRcvUcastPkts':bxEthCntRcvUcastPkts,'bxEthCntRcvMcatsPkts':bxEthCntRcvMcatsPkts,'bxEthCntRcvBcastPkts':bxEthCntRcvBcastPkts,'bxEthCntRcvJumboPkts':bxEthCntRcvJumboPkts,'bxEthCntRcvData':bxEthCntRcvData,'bxEthCntRcvErr':bxEthCntRcvErr,'bxEthCntRcvNoBuffer':bxEthCntRcvNoBuffer,'bxEthCntRcvRunt':bxEthCntRcvRunt,'bxEthCntRcvCRC':bxEthCntRcvCRC,'bxEthCntXmitPkts':bxEthCntXmitPkts,'bxEthCntXmitUcastPkts':bxEthCntXmitUcastPkts,'bxEthCntXmitMcastPkts':bxEthCntXmitMcastPkts,'bxEthCntXmitBcastPkts':bxEthCntXmitBcastPkts,'bxEthCntXmitJumboPkts':bxEthCntXmitJumboPkts,'bxEthCntXmitData':bxEthCntXmitData,'bxEthCntXmitErr':bxEthCntXmitErr,'bxFcPorts':bxFcPorts,'bxFcCntTable':bxFcCntTable,'bxFcCntEntry':bxFcCntEntry,_a:bxFcCntIndex,'bxFcCntName':bxFcCntName,'bxFcCntAdminMode':bxFcCntAdminMode,'bxFcCntStatus':bxFcCntStatus,'bxFcCntSupportedSpeeds':bxFcCntSupportedSpeeds,'bxFcCntSpeed':bxFcCntSpeed,'bxFcCntWWPN':bxFcCntWWPN,'bxFcCntFCID':bxFcCntFCID,'bxFcCntRcvCreditsAlloc':bxFcCntRcvCreditsAlloc,'bxFcCntXmitCreditsAlloc':bxFcCntXmitCreditsAlloc,'bxFcCntRcvPkts':bxFcCntRcvPkts,'bxFcCntRcvData':bxFcCntRcvData,'bxFcCntRcvDiscards':bxFcCntRcvDiscards,'bxFcCntRcvErr':bxFcCntRcvErr,'bxFcCntRcvCRC':bxFcCntRcvCRC,'bxFcCntRcvUnknown':bxFcCntRcvUnknown,'bxFcCntRcvLong':bxFcCntRcvLong,'bxFcCntRcvShort':bxFcCntRcvShort,'bxFcCntRcvOffline':bxFcCntRcvOffline,'bxFcCntRcvLinkReset':bxFcCntRcvLinkReset,'bxFcCntRcvNonOperational':bxFcCntRcvNonOperational,'bxFcCntRcvRemainCredits':bxFcCntRcvRemainCredits,'bxFcCntXmitPkts':bxFcCntXmitPkts,'bxFcCntXmitData':bxFcCntXmitData,'bxFcCntXmitDiscards':bxFcCntXmitDiscards,'bxFcCntXmitErr':bxFcCntXmitErr,'bxFcCntXmitOffline':bxFcCntXmitOffline,'bxFcCntXmitLinkReset':bxFcCntXmitLinkReset,'bxFcCntXmitNonOperational':bxFcCntXmitNonOperational,'bxFcCntXmitRemainCredits':bxFcCntXmitRemainCredits,'bxNotifications':bxNotifications,'mlxIBObjects':mlxIBObjects,'mlxIBCAInfoGroup':mlxIBCAInfoGroup,'mlxIBCAInfoTableNumCAs':mlxIBCAInfoTableNumCAs,'mlxIBCAInfoTable':mlxIBCAInfoTable,'mlxIBCAInfoEntry':mlxIBCAInfoEntry,_H:mlxIBCAIndex,_d:mlxIBCADeviceName,'mlxIBCAPCIDomain':mlxIBCAPCIDomain,'mlxIBCAPCIBus':mlxIBCAPCIBus,'mlxIBCAPCISlot':mlxIBCAPCISlot,'mlxIBCAPCIFunction':mlxIBCAPCIFunction,'mlxIBCAPCIPhysicalSlot':mlxIBCAPCIPhysicalSlot,'mlxIBCAIrq':mlxIBCAIrq,'mlxIBCAModelString':mlxIBCAModelString,'mlxIBCASerialNumber':mlxIBCASerialNumber,'mlxIBCAPartNumber':mlxIBCAPartNumber,'mlxIBCANodeGUID':mlxIBCANodeGUID,'mlxIBCASystemImageGUID':mlxIBCASystemImageGUID,'mlxIBCAFirmwareVersion':mlxIBCAFirmwareVersion,'mlxIBCAHardwareVersion':mlxIBCAHardwareVersion,_c:mlxIBCAHealthStatus,'mlxIBCANumPorts':mlxIBCANumPorts,'mlxIBCAType':mlxIBCAType,'mlxIBSwitchInfoGroup':mlxIBSwitchInfoGroup,'mlxIBSwitchInfoTableNumSwitches':mlxIBSwitchInfoTableNumSwitches,'mlxIBSwitchInfoTable':mlxIBSwitchInfoTable,'mlxIBSwitchInfoEntry':mlxIBSwitchInfoEntry,_I:mlxIBSwitchIndex,'mlxIBRouterInfoGroup':mlxIBRouterInfoGroup,'mlxIBRouterInfoTableNumRouters':mlxIBRouterInfoTableNumRouters,'mlxIBRouterInfoTable':mlxIBRouterInfoTable,'mlxIBRouterInfoEntry':mlxIBRouterInfoEntry,_J:mlxIBRouterIndex,'mlxIBPortInfoGroup':mlxIBPortInfoGroup,'mlxIBPortInfoTableNumPorts':mlxIBPortInfoTableNumPorts,'mlxIBPortInfoTable':mlxIBPortInfoTable,'mlxIBPortInfoEntry':mlxIBPortInfoEntry,_G:mlxIBPortIndex,'mlxIBPortLocalPortNumber':mlxIBPortLocalPortNumber,_e:mlxIBPortState,_f:mlxIBPortPhysicalState,_N:mlxIBPortGUID,_O:mlxIBPortNodeType,_P:mlxIBPortNodeIndex,'mlxIBNotifications':mlxIBNotifications,'mlxIBCAHealthStatusChange':mlxIBCAHealthStatusChange,'mlxIBCAInsertion':mlxIBCAInsertion,'mlxIBCARemoval':mlxIBCARemoval,'mlxIBSwitchInsertion':mlxIBSwitchInsertion,'mlxIBSwitchRemoval':mlxIBSwitchRemoval,'mlxIBRouterInsertion':mlxIBRouterInsertion,'mlxIBRouterRemoval':mlxIBRouterRemoval,'mlxIBPortStateChange':mlxIBPortStateChange,'mlxIBPortPhysicalStateChange':mlxIBPortPhysicalStateChange,'mlxIBPortInsertion':mlxIBPortInsertion,'mlxIBPortRemoval':mlxIBPortRemoval})