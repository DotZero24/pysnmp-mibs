# SNMP MIB module (DLINK-AUTH-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-AUTH-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:47:49 2025
...
swDlinkAuthCtrl = ModuleIdentity(
...
swAuthCtrl = _SwAuthCtrl_ObjectIdentity(
...
class _SwFakeAuthentication_Type(Integer32):
    """Custom type swFakeAuthentication based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwFakeAuthentication_Type.__name__ = "Integer32"
_SwFakeAuthentication_Object = MibScalar
swFakeAuthentication = _SwFakeAuthentication_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 3, 1, 3),
    _SwFakeAuthentication_Type()
)
swFakeAuthentication.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swFakeAuthentication.setStatus("current")
...
swRadiusServerEntry.setIndexNames(
    (0, "DLINK-AUTH-MIB", "swRadiusServerIndex"),
)
if mibBuilder.loadTexts:
...
swRadiusAuthServerEntry.setIndexNames(
    (0, "DLINK-AUTH-MIB", "swRadiusAuthServerIndex"),
)
if mibBuilder.loadTexts:
...
swRadiusAcctServiceEntry.setIndexNames(
    (0, "DLINK-AUTH-MIB", "swRadiusAcctServiceIndex"),
)
if mibBuilder.loadTexts:
...
swRadiusAcctServerEntry.setIndexNames(
    (0, "DLINK-AUTH-MIB", "swRadiusAcctServerIndex"),
)
if mibBuilder.loadTexts:
...
_SwRadiusAcctClientServerPortNumber_Type.__name__ = "Unsigned32"
...
swMacAuthStateEntry.setIndexNames(
    (0, "DLINK-AUTH-MIB", "swPaeMacAddr"),
    (0, "DLINK-AUTH-MIB", "swPaePortNumber"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "DLINK-AUTH-MIB",
    **{"swDlinkAuthCtrl": swDlinkAuthCtrl,
       "swAuthCtrl": swAuthCtrl,
       "authProtocol": authProtocol,
       "swAuthMode": swAuthMode,
       "swFakeAuthentication": swFakeAuthentication,
