...
entPhysicalModelName, entPhysicalIndex, entPhysicalClass, entPhysicalContainedIn, entPhysicalVendorType, entPhysicalName = mibBuilder.importSymbols("ENTITY-MIB", "entPhysicalModelName", "entPhysicalIndex", "entPhysicalClass", "entPhysicalContainedIn", "entPhysicalVendorType", "entPhysicalName")
...
mibBuilder.exportSymbols("CISCO-ENTITY-FRU-CONTROL-MIB", cefcCoolingGroup=cefcCoolingGroup, cefcTotalDrawnInlineCurrent=cefcTotalDrawnInlineCurrent, cefcFRUPowerStatusEntry=cefcFRUPowerStatusEntry, cefcMaxDefaultHighInLinePower=cefcMaxDefaultHighInLinePower, cefcModuleAdminStatus=cefcModuleAdminStatus, cefcFanSpeed=cefcFanSpeed, cefcMIBPowerCompliance7=cefcMIBPowerCompliance7, cefcMIBInLinePowerControlGroup=cefcMIBInLinePowerControlGroup, cefcModulePowerConsumptionEntry=cefcModulePowerConsumptionEntry, cefcFRUFanCoolingUnitGroup=cefcFRUFanCoolingUnitGroup, cefcMIBNotificationEnables=cefcMIBNotificationEnables, cefcPowerSupplyInputTable=cefcPowerSupplyInputTable, cefcMIBEnableStatusNotification=cefcMIBEnableStatusNotification, cefcFanCoolingCapacity=cefcFanCoolingCapacity, cefcFanTrayStatusEntry=cefcFanTrayStatusEntry, cefcFRUPowerOperStatus=cefcFRUPowerOperStatus, cefcFanCoolingCapacityUnit=cefcFanCoolingCapacityUnit, cefcFanSpeedPercent=cefcFanSpeedPercent, cefcFanCoolingCapCapacityUnit=cefcFanCoolingCapCapacityUnit, cefcModuleExtGroup=cefcModuleExtGroup, cefcVmModuleNotifsGroup=cefcVmModuleNotifsGroup, cefcMIBInLinePowerCurrentGroup=cefcMIBInLinePowerCurrentGroup, FRUTimeSeconds=FRUTimeSeconds, cefcTotalDrawnCurrent=cefcTotalDrawnCurrent, cefcPSOutputModeIndex=cefcPSOutputModeIndex, cefcEnablePSOutputChangeNotif=cefcEnablePSOutputChangeNotif, cefcModuleStatusChange=cefcModuleStatusChange, cefcMgmtNotificationsGroup3=cefcMgmtNotificationsGroup3, cefcModuleGroupRev1=cefcModuleGroupRev1, cefcPowerSupplyOutputChange=cefcPowerSupplyOutputChange, cefcFRURealTimeCurrent=cefcFRURealTimeCurrent, cefcModuleStateChangeReasonDescr=cefcModuleStateChangeReasonDescr, cefcMIBGroups=cefcMIBGroups, cefcMIBConformance=cefcMIBConformance, cefcModuleLocalSwitchingMode=cefcModuleLocalSwitchingMode, PowerRedundancyType=PowerRedundancyType, cefcModuleCooling=cefcModuleCooling, cefcModule=cefcModule, cefcConnector=cefcConnector, cefcPowerUnits=cefcPowerUnits, cefcCooling=cefcCooling, cefcPSOutputModeCurrent=cefcPSOutputModeCurrent, cefcMIBPowerCompliance5=cefcMIBPowerCompliance5, cefcMIBModuleGroup=cefcMIBModuleGroup, cefcIntelliModuleIPAddrType=cefcIntelliModuleIPAddrType, cefcChassisCoolingEntry=cefcChassisCoolingEntry, cefcFRURemoved=cefcFRURemoved, cefcFanCoolingCapEntry=cefcFanCoolingCapEntry, PowerAdminType=PowerAdminType, cefcVmModuleOperStatus=cefcVmModuleOperStatus, cefcVmModuleStatusLastChangeTime=cefcVmModuleStatusLastChangeTime, cefcIntelliModuleGroup=cefcIntelliModuleGroup, cefcMgmtNotificationsGroup2=cefcMgmtNotificationsGroup2, cefcFRUDrawnSystemCurrent=cefcFRUDrawnSystemCurrent, cefcFanTrayOperStatus=cefcFanTrayOperStatus, cefcMIBPowerCompliance3=cefcMIBPowerCompliance3, ModuleOperType=ModuleOperType, cefcMIBPowerFRUControlGroup=cefcMIBPowerFRUControlGroup, cefcFRUPowerSupplyValueTable=cefcFRUPowerSupplyValueTable, FRUCoolingUnit=FRUCoolingUnit, cefcConnectorRating=cefcConnectorRating, cefcModuleOperStatus=cefcModuleOperStatus, cefcVmModuleGroup=cefcVmModuleGroup, cefcMIBNotifications=cefcMIBNotifications, cefcModuleEntry=cefcModuleEntry, cefcMaxDefaultInLinePower=cefcMaxDefaultInLinePower, cefcFRUCoolingUnitGroup=cefcFRUCoolingUnitGroup, cefcModuleLocalSwitchingTable=cefcModuleLocalSwitchingTable, CefcPercentOrMinusOne=CefcPercentOrMinusOne, cefcMgmtNotificationsGroup=cefcMgmtNotificationsGroup, cefcFRUPowerCapabilityGroup=cefcFRUPowerCapabilityGroup, cefcFanTrayStatusChange=cefcFanTrayStatusChange, cefcPowerRedundancyOperMode=cefcPowerRedundancyOperMode, cefcModuleCoolingTable=cefcModuleCoolingTable, cefcIntelliModuleEntry=cefcIntelliModuleEntry, cefcPSOutputModeInOperation=cefcPSOutputModeInOperation, cefcModulePowerConsumption=cefcModulePowerConsumption, cefcPowerStatusChange=cefcPowerStatusChange, cefcFanSpeedGroup=cefcFanSpeedGroup, cefcVmModuleStatusChangeNotif=cefcVmModuleStatusChangeNotif, cefcPowerSupplyInputIndex=cefcPowerSupplyInputIndex, cefcMIBPowerOperModeGroup=cefcMIBPowerOperModeGroup, PowerOperType=PowerOperType, cefcCoolingGroup2=cefcCoolingGroup2, cefcMIBModuleLocalSwitchingGroup=cefcMIBModuleLocalSwitchingGroup, ciscoEntityFRUControlMIB=ciscoEntityFRUControlMIB, cefcMIBCompliances=cefcMIBCompliances, ModuleAdminType=ModuleAdminType, cefcMIBPowerCompliance8=cefcMIBPowerCompliance8, cefcFRUPowerAdminStatus=cefcFRUPowerAdminStatus, cefcUnrecognizedFRU=cefcUnrecognizedFRU, cefcMIBInLinePowerControlGroupRev1=cefcMIBInLinePowerControlGroupRev1, cefcFRUPowerSupplyGroupTable=cefcFRUPowerSupplyGroupTable, cefcModuleCoolingUnit=cefcModuleCoolingUnit, cefcFanCoolingCapCapacity=cefcFanCoolingCapCapacity, ModuleResetReasonType=ModuleResetReasonType, cefcModuleLocalSwitchingEntry=cefcModuleLocalSwitchingEntry, cefcFRUPowerRealTimeStatusGroup=cefcFRUPowerRealTimeStatusGroup, cefcFanCoolingCapCurrent=cefcFanCoolingCapCurrent, cefcFRUCurrent=cefcFRUCurrent, cefcFRUFan=cefcFRUFan, cefcTotalAvailableCurrent=cefcTotalAvailableCurrent, cefcFanTrayStatusTable=cefcFanTrayStatusTable, cefcMIBNotificationEnablesGroup=cefcMIBNotificationEnablesGroup, FRUCurrentType=FRUCurrentType, cefcFanTable=cefcFanTable, cefcMIBFanTrayStatusGroup=cefcMIBFanTrayStatusGroup, CefcVmModuleOperType=CefcVmModuleOperType, cefcFRUTotalSystemCurrent=cefcFRUTotalSystemCurrent, cefcModuleResetReasonDescription=cefcModuleResetReasonDescription, cefcMIBPowerCompliance9=cefcMIBPowerCompliance9, cefcMIBPhysicalGroup=cefcMIBPhysicalGroup, cefcPhysical=cefcPhysical, cefcFRUTotalInlineCurrent=cefcFRUTotalInlineCurrent, cefcPowerSupplyActualGroup=cefcPowerSupplyActualGroup, cefcModuleStatusLastChangeTime=cefcModuleStatusLastChangeTime, cefcPowerCapacity=cefcPowerCapacity, cefcFRUPower=cefcFRUPower, cefcConnectorRatingGroup=cefcConnectorRatingGroup, cefcMIBPowerFRUValueGroup=cefcMIBPowerFRUValueGroup, cefcModuleResetReason=cefcModuleResetReason, cefcMIBObjects=cefcMIBObjects, cefcFanEntry=cefcFanEntry, cefcMIBNotificationEnablesGroup2=cefcMIBNotificationEnablesGroup2, cefcFRUPowerStatusTable=cefcFRUPowerStatusTable, cefcMIBPowerCompliance=cefcMIBPowerCompliance, cefcFRUMIBNotificationPrefix=cefcFRUMIBNotificationPrefix, cefcMIBPowerCompliance6=cefcMIBPowerCompliance6, cefcModuleTable=cefcModuleTable, cefcPowerSupplyOutputTable=cefcPowerSupplyOutputTable, cefcFRUPowerCapability=cefcFRUPowerCapability, cefcModuleUpTime=cefcModuleUpTime, cefcFanCoolingCapIndex=cefcFanCoolingCapIndex, cefcIntelliModuleIPAddr=cefcIntelliModuleIPAddr, cefcModuleCoolingEntry=cefcModuleCoolingEntry, cefcFRUPowerSupplyGroupEntry=cefcFRUPowerSupplyGroupEntry, cefcFRUActualOutputCurrent=cefcFRUActualOutputCurrent, cefcMIBPowerCompliance2=cefcMIBPowerCompliance2, cefcMIBPowerRedundancyInfoGroup=cefcMIBPowerRedundancyInfoGroup, cefcConnectorRatingTable=cefcConnectorRatingTable, cefcMIBPowerModeGroup=cefcMIBPowerModeGroup, cefcChassisPerSlotCoolingCap=cefcChassisPerSlotCoolingCap, cefcFRUPowerSupplyValueEntry=cefcFRUPowerSupplyValueEntry, cefcPowerSupplyOutputEntry=cefcPowerSupplyOutputEntry, cefcFanCoolingCapTable=cefcFanCoolingCapTable, cefcFanCoolingTable=cefcFanCoolingTable, cefcMIBPowerCompliance10=cefcMIBPowerCompliance10, PYSNMP_MODULE_ID=ciscoEntityFRUControlMIB, cefcPowerNonRedundantReason=cefcPowerNonRedundantReason, cefcFRUActualInputCurrent=cefcFRUActualInputCurrent, cefcPhysicalStatus=cefcPhysicalStatus, cefcChassisPerSlotCoolingUnit=cefcChassisPerSlotCoolingUnit, cefcFRUDrawnInlineCurrent=cefcFRUDrawnInlineCurrent, cefcFanCoolingEntry=cefcFanCoolingEntry, cefcFanCoolingGroup=cefcFanCoolingGroup, cefcPowerSupplyInputType=cefcPowerSupplyInputType, cefcFanCoolingCapModeDescr=cefcFanCoolingCapModeDescr, cefcChassisCoolingTable=cefcChassisCoolingTable, cefcPhysicalTable=cefcPhysicalTable, cefcFanTrayDirection=cefcFanTrayDirection, cefcPowerRedundancyMode=cefcPowerRedundancyMode, cefcModuleLastClearConfigTime=cefcModuleLastClearConfigTime, cefcConnectorRatingEntry=cefcConnectorRatingEntry, cefcFRUInserted=cefcFRUInserted, cefcIntelliModuleTable=cefcIntelliModuleTable, cefcPhysicalEntry=cefcPhysicalEntry, cefcModulePowerConsumptionTable=cefcModulePowerConsumptionTable, cefcMIBPowerCompliance4=cefcMIBPowerCompliance4, cefcPowerCapacityGroup=cefcPowerCapacityGroup, cefcPowerSupplyInputEntry=cefcPowerSupplyInputEntry, cefcFanDirectionGroup=cefcFanDirectionGroup, cefcFanCoolingCapGroup=cefcFanCoolingCapGroup)
