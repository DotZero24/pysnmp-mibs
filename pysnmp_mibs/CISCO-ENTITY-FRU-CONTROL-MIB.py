...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-ENTITY-FRU-CONTROL-MIB
...
entPhysicalClass, entPhysicalContainedIn, entPhysicalModelName, entPhysicalIndex, entPhysicalVendorType, entPhysicalName = mibBuilder.importSymbols("ENTITY-MIB", "entPhysicalClass", "entPhysicalContainedIn", "entPhysicalModelName", "entPhysicalIndex", "entPhysicalVendorType", "entPhysicalName")
...
if mibBuilder.loadTexts: ciscoEntityFRUControlMIB.setLastUpdated('201811050000Z')
...
cefcFanTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 117, 1, 4, 2), )
if mibBuilder.loadTexts: cefcFanTable.setStatus('current')
cefcFanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 117, 1, 4, 2, 1), ).setIndexNames((0, "ENTITY-MIB", "entPhysicalIndex"))
...
mibBuilder.exportSymbols("CISCO-ENTITY-FRU-CONTROL-MIB", PowerRedundancyType=PowerRedundancyType, cefcFRUActualInputCurrent=cefcFRUActualInputCurrent, cefcFanCoolingTable=cefcFanCoolingTable, cefcFRUFan=cefcFRUFan, cefcCooling=cefcCooling, cefcFRUPowerSupplyGroupEntry=cefcFRUPowerSupplyGroupEntry, cefcModuleCoolingEntry=cefcModuleCoolingEntry, cefcPowerSupplyInputEntry=cefcPowerSupplyInputEntry, cefcMIBPowerCompliance2=cefcMIBPowerCompliance2, cefcMIBInLinePowerControlGroup=cefcMIBInLinePowerControlGroup, cefcModuleStateChangeReasonDescr=cefcModuleStateChangeReasonDescr, cefcConnector=cefcConnector, cefcMIBPowerRedundancyInfoGroup=cefcMIBPowerRedundancyInfoGroup, cefcFanCoolingCapacityUnit=cefcFanCoolingCapacityUnit, cefcModulePowerConsumption=cefcModulePowerConsumption, cefcFRUActualOutputCurrent=cefcFRUActualOutputCurrent, cefcFanTrayStatusChange=cefcFanTrayStatusChange, cefcFanSpeedPercent=cefcFanSpeedPercent, cefcModule=cefcModule, cefcPhysical=cefcPhysical, cefcModulePowerConsumptionTable=cefcModulePowerConsumptionTable, cefcFRUDrawnSystemCurrent=cefcFRUDrawnSystemCurrent, cefcModuleAdminStatus=cefcModuleAdminStatus, cefcFRUDrawnInlineCurrent=cefcFRUDrawnInlineCurrent, cefcFanTrayOperStatus=cefcFanTrayOperStatus, cefcMIBInLinePowerControlGroupRev1=cefcMIBInLinePowerControlGroupRev1, cefcMgmtNotificationsGroup3=cefcMgmtNotificationsGroup3, cefcVmModuleGroup=cefcVmModuleGroup, cefcPowerRedundancyMode=cefcPowerRedundancyMode, cefcUnrecognizedFRU=cefcUnrecognizedFRU, cefcPowerSupplyOutputTable=cefcPowerSupplyOutputTable, cefcPowerRedundancyOperMode=cefcPowerRedundancyOperMode, cefcMIBNotificationEnablesGroup2=cefcMIBNotificationEnablesGroup2, cefcMIBNotifications=cefcMIBNotifications, cefcFanTrayStatusEntry=cefcFanTrayStatusEntry, cefcFRUTotalInlineCurrent=cefcFRUTotalInlineCurrent, cefcFanCoolingCapEntry=cefcFanCoolingCapEntry, PowerAdminType=PowerAdminType, PowerOperType=PowerOperType, cefcFanCoolingCapacity=cefcFanCoolingCapacity, FRUCoolingUnit=FRUCoolingUnit, cefcPowerSupplyInputType=cefcPowerSupplyInputType, ModuleResetReasonType=ModuleResetReasonType, cefcFRUCurrent=cefcFRUCurrent, cefcModuleCoolingTable=cefcModuleCoolingTable, cefcModuleExtGroup=cefcModuleExtGroup, ModuleOperType=ModuleOperType, cefcModuleGroupRev1=cefcModuleGroupRev1, cefcChassisCoolingEntry=cefcChassisCoolingEntry, cefcMIBPowerFRUValueGroup=cefcMIBPowerFRUValueGroup, cefcPhysicalTable=cefcPhysicalTable, cefcPowerSupplyOutputChange=cefcPowerSupplyOutputChange, cefcMIBPowerCompliance4=cefcMIBPowerCompliance4, cefcPowerSupplyInputIndex=cefcPowerSupplyInputIndex, cefcTotalAvailableCurrent=cefcTotalAvailableCurrent, cefcChassisCoolingTable=cefcChassisCoolingTable, cefcModuleOperStatus=cefcModuleOperStatus, cefcModuleLocalSwitchingTable=cefcModuleLocalSwitchingTable, cefcVmModuleNotifsGroup=cefcVmModuleNotifsGroup, cefcMIBPowerCompliance3=cefcMIBPowerCompliance3, cefcFanDirectionGroup=cefcFanDirectionGroup, cefcModuleEntry=cefcModuleEntry, cefcFanCoolingCapCurrent=cefcFanCoolingCapCurrent, cefcFanTrayStatusTable=cefcFanTrayStatusTable, cefcIntelliModuleGroup=cefcIntelliModuleGroup, cefcVmModuleStatusChangeNotif=cefcVmModuleStatusChangeNotif, cefcPSOutputModeInOperation=cefcPSOutputModeInOperation, cefcMIBPowerCompliance=cefcMIBPowerCompliance, cefcConnectorRatingGroup=cefcConnectorRatingGroup, cefcFRUFanCoolingUnitGroup=cefcFRUFanCoolingUnitGroup, cefcPowerNonRedundantReason=cefcPowerNonRedundantReason, cefcCoolingGroup2=cefcCoolingGroup2, cefcModuleUpTime=cefcModuleUpTime, cefcIntelliModuleTable=cefcIntelliModuleTable, cefcModuleCooling=cefcModuleCooling, cefcMIBModuleGroup=cefcMIBModuleGroup, cefcFanTrayDirection=cefcFanTrayDirection, cefcMgmtNotificationsGroup=cefcMgmtNotificationsGroup, cefcModuleLocalSwitchingEntry=cefcModuleLocalSwitchingEntry, ciscoEntityFRUControlMIB=ciscoEntityFRUControlMIB, cefcMIBCompliances=cefcMIBCompliances, cefcFanCoolingCapCapacity=cefcFanCoolingCapCapacity, cefcMIBPowerModeGroup=cefcMIBPowerModeGroup, cefcFRUCoolingUnitGroup=cefcFRUCoolingUnitGroup, cefcConnectorRating=cefcConnectorRating, cefcModuleTable=cefcModuleTable, cefcMIBPowerCompliance9=cefcMIBPowerCompliance9, cefcFanSpeed=cefcFanSpeed, cefcFRUInserted=cefcFRUInserted, cefcMIBPowerOperModeGroup=cefcMIBPowerOperModeGroup, cefcPowerSupplyInputTable=cefcPowerSupplyInputTable, cefcFRUPowerAdminStatus=cefcFRUPowerAdminStatus, cefcFanCoolingCapIndex=cefcFanCoolingCapIndex, cefcModulePowerConsumptionEntry=cefcModulePowerConsumptionEntry, cefcFanEntry=cefcFanEntry, cefcFRUPowerOperStatus=cefcFRUPowerOperStatus, cefcConnectorRatingEntry=cefcConnectorRatingEntry, cefcTotalDrawnCurrent=cefcTotalDrawnCurrent, cefcMIBPowerFRUControlGroup=cefcMIBPowerFRUControlGroup, cefcMIBFanTrayStatusGroup=cefcMIBFanTrayStatusGroup, cefcMIBPowerCompliance5=cefcMIBPowerCompliance5, cefcFRUPower=cefcFRUPower, FRUCurrentType=FRUCurrentType, cefcFanTable=cefcFanTable, cefcMIBPhysicalGroup=cefcMIBPhysicalGroup, cefcCoolingGroup=cefcCoolingGroup, cefcVmModuleOperStatus=cefcVmModuleOperStatus, cefcModuleLocalSwitchingMode=cefcModuleLocalSwitchingMode, cefcFRUPowerSupplyGroupTable=cefcFRUPowerSupplyGroupTable, cefcFanCoolingEntry=cefcFanCoolingEntry, cefcMIBConformance=cefcMIBConformance, cefcMIBPowerCompliance8=cefcMIBPowerCompliance8, cefcMIBPowerCompliance10=cefcMIBPowerCompliance10, cefcMIBNotificationEnables=cefcMIBNotificationEnables, cefcModuleStatusChange=cefcModuleStatusChange, cefcMIBPowerCompliance7=cefcMIBPowerCompliance7, cefcTotalDrawnInlineCurrent=cefcTotalDrawnInlineCurrent, cefcFRUPowerStatusEntry=cefcFRUPowerStatusEntry, cefcFRUPowerSupplyValueTable=cefcFRUPowerSupplyValueTable, cefcPSOutputModeIndex=cefcPSOutputModeIndex, cefcFRUPowerCapabilityGroup=cefcFRUPowerCapabilityGroup, cefcPowerUnits=cefcPowerUnits, cefcMIBGroups=cefcMIBGroups, cefcPowerCapacity=cefcPowerCapacity, cefcPSOutputModeCurrent=cefcPSOutputModeCurrent, cefcPhysicalStatus=cefcPhysicalStatus, cefcMIBInLinePowerCurrentGroup=cefcMIBInLinePowerCurrentGroup, cefcChassisPerSlotCoolingUnit=cefcChassisPerSlotCoolingUnit, PYSNMP_MODULE_ID=ciscoEntityFRUControlMIB, cefcMgmtNotificationsGroup2=cefcMgmtNotificationsGroup2, cefcFanCoolingGroup=cefcFanCoolingGroup, CefcPercentOrMinusOne=CefcPercentOrMinusOne, cefcConnectorRatingTable=cefcConnectorRatingTable, cefcFanCoolingCapCapacityUnit=cefcFanCoolingCapCapacityUnit, cefcIntelliModuleIPAddrType=cefcIntelliModuleIPAddrType, cefcPowerStatusChange=cefcPowerStatusChange, cefcPowerCapacityGroup=cefcPowerCapacityGroup, ModuleAdminType=ModuleAdminType, cefcMaxDefaultInLinePower=cefcMaxDefaultInLinePower, cefcFRUPowerSupplyValueEntry=cefcFRUPowerSupplyValueEntry, CefcVmModuleOperType=CefcVmModuleOperType, FRUTimeSeconds=FRUTimeSeconds, cefcFanCoolingCapModeDescr=cefcFanCoolingCapModeDescr, cefcFRUPowerRealTimeStatusGroup=cefcFRUPowerRealTimeStatusGroup, cefcMIBObjects=cefcMIBObjects, cefcFRURemoved=cefcFRURemoved, cefcModuleCoolingUnit=cefcModuleCoolingUnit, cefcMaxDefaultHighInLinePower=cefcMaxDefaultHighInLinePower, cefcFRUTotalSystemCurrent=cefcFRUTotalSystemCurrent, cefcIntelliModuleIPAddr=cefcIntelliModuleIPAddr, cefcMIBEnableStatusNotification=cefcMIBEnableStatusNotification, cefcMIBNotificationEnablesGroup=cefcMIBNotificationEnablesGroup, cefcFanCoolingCapGroup=cefcFanCoolingCapGroup, cefcModuleLastClearConfigTime=cefcModuleLastClearConfigTime, cefcMIBPowerCompliance6=cefcMIBPowerCompliance6, cefcFRURealTimeCurrent=cefcFRURealTimeCurrent, cefcModuleResetReasonDescription=cefcModuleResetReasonDescription, cefcMIBModuleLocalSwitchingGroup=cefcMIBModuleLocalSwitchingGroup, cefcVmModuleStatusLastChangeTime=cefcVmModuleStatusLastChangeTime, cefcPowerSupplyActualGroup=cefcPowerSupplyActualGroup, cefcFRUPowerStatusTable=cefcFRUPowerStatusTable, cefcPhysicalEntry=cefcPhysicalEntry, cefcModuleStatusLastChangeTime=cefcModuleStatusLastChangeTime, cefcIntelliModuleEntry=cefcIntelliModuleEntry, cefcChassisPerSlotCoolingCap=cefcChassisPerSlotCoolingCap, cefcFanSpeedGroup=cefcFanSpeedGroup, cefcFanCoolingCapTable=cefcFanCoolingCapTable, cefcEnablePSOutputChangeNotif=cefcEnablePSOutputChangeNotif, cefcModuleResetReason=cefcModuleResetReason, cefcFRUPowerCapability=cefcFRUPowerCapability, cefcPowerSupplyOutputEntry=cefcPowerSupplyOutputEntry, cefcFRUMIBNotificationPrefix=cefcFRUMIBNotificationPrefix)
