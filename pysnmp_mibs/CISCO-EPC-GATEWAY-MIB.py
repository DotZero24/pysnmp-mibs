...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:32:26 2025
...
mibBuilder.exportSymbols("CISCO-EPC-GATEWAY-MIB", ciscoEpcGatewayMIBObjects=ciscoEpcGatewayMIBObjects, cegCongestionDfpWeight=cegCongestionDfpWeight, cegTotalBufferedPackets=cegTotalBufferedPackets, cegCongestionLowThreshold=cegCongestionLowThreshold, cegCongestionHighLastOccurTime=cegCongestionHighLastOccurTime, cegCongestionHighThresholdNotif=cegCongestionHighThresholdNotif, cegBufferingAgentEnabled=cegBufferingAgentEnabled, ciscoEpcGatewayMIBConformance=ciscoEpcGatewayMIBConformance, cegOverloadProtectionNotifGrp=cegOverloadProtectionNotifGrp, cegSystemStatusGrp=cegSystemStatusGrp, cegOverloadProtectionStatsGrp=cegOverloadProtectionStatsGrp, cegSystemStatusGrpSup1=cegSystemStatusGrpSup1, ciscoEpcGatewayNotifMgmt=ciscoEpcGatewayNotifMgmt, cegCongestionLowNotifEnable=cegCongestionLowNotifEnable, ciscoEpcGatewayConfig=ciscoEpcGatewayConfig, cegOverloadProtectionStats=cegOverloadProtectionStats, cegActivatedBearers=cegActivatedBearers, cegCongestionHighThresholdReached=cegCongestionHighThresholdReached, cegTotalIdleSessions=cegTotalIdleSessions, cegTotalInUseBuffers=cegTotalInUseBuffers, cegTotalSuspendedUsers=cegTotalSuspendedUsers, cegCongestionIncomingReqDrops=cegCongestionIncomingReqDrops, cegCongestionHighThreshold=cegCongestionHighThreshold, cegBufferingAgentStatsGrpSup1=cegBufferingAgentStatsGrpSup1, cegBufferStats=cegBufferStats, cegOverloadProtectionConfig=cegOverloadProtectionConfig, cegActivatedIpv4DedicatedBearers=cegActivatedIpv4DedicatedBearers, ciscoEPCGatewayMIBComplianceRev2=ciscoEPCGatewayMIBComplianceRev2, cegCongestionLowThresholdReached=cegCongestionLowThresholdReached, cegCongestionClearedNotif=cegCongestionClearedNotif, ciscoEpcGatewayStatus=ciscoEpcGatewayStatus, cegCongestionStatus=cegCongestionStatus, ciscoEpcGatewayMIBGroups=ciscoEpcGatewayMIBGroups, cegTotalBufferedBytes=cegTotalBufferedBytes, cegBufferingAgentStatsGrp=cegBufferingAgentStatsGrp, cegSystemStatusGrpSup3=cegSystemStatusGrpSup3, cegBufferBytesDequeued=cegBufferBytesDequeued, cegCongestionHighLastDuration=cegCongestionHighLastDuration, cegTotalIdleUsers=cegTotalIdleUsers, cegCongestionLowLastDuration=cegCongestionLowLastDuration, ciscoEpcGatewayStatistics=ciscoEpcGatewayStatistics, cegBufferMaxPacketsPerBuffer=cegBufferMaxPacketsPerBuffer, cegActivatedIpv4v6Sessions=cegActivatedIpv4v6Sessions, cegCongestionLowThresholdNotif=cegCongestionLowThresholdNotif, cegVersion=cegVersion, cegPacketDropDueToMaxBufferLimit=cegPacketDropDueToMaxBufferLimit, cegBufferPacketsEnqueued=cegBufferPacketsEnqueued, cegOverloadProtectionConfigGrp=cegOverloadProtectionConfigGrp, cegBufferDiscardDataTime=cegBufferDiscardDataTime, cegActivatedIpv6DedicatedBearers=cegActivatedIpv6DedicatedBearers, cegOverloadProtectionStatus=cegOverloadProtectionStatus, cegBufferingAgentStatusGrp=cegBufferingAgentStatusGrp, ciscoEpcGatewayMIBCompliances=ciscoEpcGatewayMIBCompliances, cegPacketDropDueToMaxPacketLimit=cegPacketDropDueToMaxPacketLimit, ciscoEpcGatewayMIB=ciscoEpcGatewayMIB, cegBuffersCreated=cegBuffersCreated, cegActivatedIpv4Bearers=cegActivatedIpv4Bearers, cegActivatedIpv4v6Bearers=cegActivatedIpv4v6Bearers, cegOverloadProtectionStatusGrp=cegOverloadProtectionStatusGrp, cegBuffersTimedOut=cegBuffersTimedOut, ciscoEpcGatewayMIBCompliance=ciscoEpcGatewayMIBCompliance, cegTotalUsers=cegTotalUsers, cegBufferRejMemUnavailable=cegBufferRejMemUnavailable, ciscoEpcGatewayMIBComplianceRev3=ciscoEpcGatewayMIBComplianceRev3, cegCongestionClearNotifEnable=cegCongestionClearNotifEnable, cegBufferMaxSize=cegBufferMaxSize, cegBufferRejLowMem=cegBufferRejLowMem, cegSystemStatusGrpSup2=cegSystemStatusGrpSup2, cegActivatedGtpv2PgwSessions=cegActivatedGtpv2PgwSessions, cegOverloadProtectionNotifMgmtGrp=cegOverloadProtectionNotifMgmtGrp, cegBufferPacketsDequeued=cegBufferPacketsDequeued, cegActivatedGtpv2SPgwSessions=cegActivatedGtpv2SPgwSessions, cegCongestionHighNotifEnable=cegCongestionHighNotifEnable, PYSNMP_MODULE_ID=ciscoEpcGatewayMIB, cegActivatedIpv6Bearers=cegActivatedIpv6Bearers, cegActivatedGtpv2SgwSessions=cegActivatedGtpv2SgwSessions, cegBufferStatus=cegBufferStatus, ciscoEpcGatewayMIBComplianceRev1=ciscoEpcGatewayMIBComplianceRev1, cegBuffersDeleted=cegBuffersDeleted, cegCongestionLowLastOccurTime=cegCongestionLowLastOccurTime, cegBufferingAgentConfigGrp=cegBufferingAgentConfigGrp, ciscoEpcGatewayMIBNotifications=ciscoEpcGatewayMIBNotifications, cegBufferBytesEnqueued=cegBufferBytesEnqueued, cegActivatedDedicatedBearers=cegActivatedDedicatedBearers, cegTotalBufferAvailable=cegTotalBufferAvailable, cegBufferingAgentConfig=cegBufferingAgentConfig)
