# SNMP MIB module (DES7200-AAA-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-AAA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:47:16 2025
...
myDot1xAuthObjectsConfigEntry.setIndexNames(
    (0, "DES7200-AAA-MIB", "myDot1xAuthObjectsConfigFdbId"),
    (0, "DES7200-AAA-MIB", "myDot1xAuthObjectsConfigAddr"),
)
if mibBuilder.loadTexts:
...
myDot1xAuthStatsEntry.setIndexNames(
    (0, "DES7200-AAA-MIB", "myDot1xAuthObjectsStatsFdbId"),
    (0, "DES7200-AAA-MIB", "myDot1xAuthObjectsStatsAddr"),
)
if mibBuilder.loadTexts:
...
myDot1xIfUserMaxEntry.setIndexNames(
    (0, "DES7200-AAA-MIB", "myDot1xIfUserMaxIndex"),
)
if mibBuilder.loadTexts:
...
myAAAServerConfigEntry.setIndexNames(
    (0, "DES7200-AAA-MIB", "myAAAServerConfigProtocol"),
    (0, "DES7200-AAA-MIB", "myAAAServerConfigIndex"),
)
if mibBuilder.loadTexts:
...
myAuthAddrEntry.setIndexNames(
    (0, "DES7200-AAA-MIB", "myAuthPort"),
    (0, "DES7200-AAA-MIB", "myAuthMacAddress"),
)
if mibBuilder.loadTexts:
...
myAuthUserEntry.setIndexNames(
    (0, "DES7200-AAA-MIB", "myAuthUserFdbId"),
    (0, "DES7200-AAA-MIB", "myAuthUserMacAddress"),
)
if mibBuilder.loadTexts:
...
myDot1xAuthMIBGroup.setObjects(
      *(("DES7200-AAA-MIB", "myDot1xAuthStatus"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsQuietPeriod"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsTxPeriod"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsSuppTimeout"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsServerTimeout"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsMaxReq"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsReAuthPeriod"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsReAuthEnable"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsConfigFdbId"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsConfigAddr"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsPaeState"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsBackendAuthState"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsAuthControlledPortStatus"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsKeyTxEnabled"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsIfIndex"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsStatsFdbId"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsStatsAddr"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsEapolFramesRx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsEapolFramesTx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsEapolMyFramesRx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsEapolLogoffFramesRx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsEapolRespIdFramesRx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsEapolRespFramesRx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsEapolReqIdFramesTx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsEapolReqFramesTx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsInvalidEapolFramesRx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsEapLengthErrorFramesRx"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsLastEapolFrameVersion"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsLastEapolFrameSource"),
        ("DES7200-AAA-MIB", "myDot1xCurrentUserNumber"),
        ("DES7200-AAA-MIB", "myDot1xCurrentAuthenticatedUserNumber"),
        ("DES7200-AAA-MIB", "myDot1xAuthObjectsMaxReauth"),
        ("DES7200-AAA-MIB", "myAuthIf"),
        ("DES7200-AAA-MIB", "myAuthIfStatus"),
        ("DES7200-AAA-MIB", "myAuthenticationMode"))
)
if mibBuilder.loadTexts:
...
myAAAServerMIBGroup.setObjects(
      *(("DES7200-AAA-MIB", "myAAAServerAuthPort"),
        ("DES7200-AAA-MIB", "myAAAServerAcctPort"),
        ("DES7200-AAA-MIB", "myAAAServerRadiusKeyStr"),
        ("DES7200-AAA-MIB", "myAAAServerTacplusKeyStr"),
        ("DES7200-AAA-MIB", "myAAAServerConfigAddressType"),
        ("DES7200-AAA-MIB", "myAAAServerConfigAddress"),
        ("DES7200-AAA-MIB", "myAAAServerConfigAuthPort"),
        ("DES7200-AAA-MIB", "myAAAServerConfigAcctPort"),
        ("DES7200-AAA-MIB", "myAAAServerConfigKeyStr"),
        ("DES7200-AAA-MIB", "myAAAServerConfigRowStatus"))
)
if mibBuilder.loadTexts:
...
myAuthAddrMIBGroup.setObjects(
      *(("DES7200-AAA-MIB", "myAuthMacAddress"),
        ("DES7200-AAA-MIB", "myAuthPort"),
        ("DES7200-AAA-MIB", "myAuthAddrStatus"),
        ("DES7200-AAA-MIB", "myAuthUserFdbId"),
        ("DES7200-AAA-MIB", "myAuthUserMacAddress"),
        ("DES7200-AAA-MIB", "myAuthUserName"),
        ("DES7200-AAA-MIB", "myAuthUserSessionId"),
        ("DES7200-AAA-MIB", "myAuthUserIpAddr"),
        ("DES7200-AAA-MIB", "myAuthUserPort"),
        ("DES7200-AAA-MIB", "myAuthUserStatus"))
)
if mibBuilder.loadTexts:
...
myAuthModeMIBGroup.setObjects(
    ("DES7200-AAA-MIB", "myIpAuthorizationMode")
)
if mibBuilder.loadTexts:
...
myClientProbeGroup.setObjects(
      *(("DES7200-AAA-MIB", "myClientProbeEnabledStatus"),
        ("DES7200-AAA-MIB", "myClientProbeHelloInterval"),
        ("DES7200-AAA-MIB", "myClientProbeAliveInteval"))
)
if mibBuilder.loadTexts:
...
myAAAMIBCompliance.setObjects(
      *(("DES7200-AAA-MIB", "myDot1xAuthMIBGroup"),
        ("DES7200-AAA-MIB", "myAAAServerMIBGroup"),
        ("DES7200-AAA-MIB", "myAuthAddrMIBGroup"),
        ("DES7200-AAA-MIB", "myAuthModeMIBGroup"),
        ("DES7200-AAA-MIB", "myClientProbeGroup"))
)
if mibBuilder.loadTexts:
