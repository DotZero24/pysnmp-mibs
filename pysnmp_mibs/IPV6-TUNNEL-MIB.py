# SNMP MIB module (IPV6-TUNNEL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/quanta/IPV6-TUNNEL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:12:50 2025
...
ipv6Tunnel = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 27)
)
...
agentTunnelIPV6Entry = _AgentTunnelIPV6Entry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 27, 1, 1, 1)
)
agentTunnelIPV6Entry.setIndexNames(
    (0, "IPV6-TUNNEL-MIB", "agentTunnelID"),
)
if mibBuilder.loadTexts:
...
agentTunnelIPV6PrefixEntry = _AgentTunnelIPV6PrefixEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 27, 1, 2, 1)
)
agentTunnelIPV6PrefixEntry.setIndexNames(
    (0, "IPV6-TUNNEL-MIB", "agentTunnelID"),
    (0, "IPV6-TUNNEL-MIB", "agentTunnelIPV6PrefixPrefix"),
    (0, "IPV6-TUNNEL-MIB", "agentTunnelIPV6PrefixPrefixLen"),
)
if mibBuilder.loadTexts:
