# SNMP MIB module (ALCATEL-ENT1-VRRP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-VRRP-MIB
...
alaVrrpTrackEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackId"),
)
if mibBuilder.loadTexts:
...
class _AlaVrrpTrackBfdStatus_Type(Integer32):
    """Custom type alaVrrpTrackBfdStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AlaVrrpTrackBfdStatus_Type.__name__ = "Integer32"
...
alaVrrpAssoTrackEntry.setIndexNames(
    ...
    (0, "ALCATEL-ENT1-VRRP-MIB", "alaVrrpAssoTrackId"),
)
if mibBuilder.loadTexts:
...
alaVrrp3AssoTrackEntry.setIndexNames(
    ...
    (0, "IF-MIB", "ifIndex"),
    (0, "ALCATEL-ENT1-VRRP-MIB", "alaVrrp3AssoTrackId"),
)
if mibBuilder.loadTexts:
...
alaVrrp3AssoTrackRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
alaVrrpGroupEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupId"),
)
if mibBuilder.loadTexts:
...
alaVRRPConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 2, 1)
)
alaVRRPConfigGroup.setObjects(
      *(("ALCATEL-ENT1-VRRP-MIB", "alaVRRPStartDelay"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpBfdStatus"))
)
if mibBuilder.loadTexts:
    alaVRRPConfigGroup.setStatus("current")

alaVRRPv2ConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 2, 2)
)
alaVRRPv2ConfigGroup.setObjects(
      *(("ALCATEL-ENT1-VRRP-MIB", "alaVRRPAdminState"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVRRPDefaultInterval"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVRRPDefaultPreemptMode"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVRRPDefaultPriority"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVRRPOverride"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVRRPSetParam"))
)
if mibBuilder.loadTexts:
    alaVRRPv2ConfigGroup.setStatus("current")

alaVrrp3AssoTrackTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 2, 3)
)
alaVrrp3AssoTrackTableGroup.setObjects(
    ("ALCATEL-ENT1-VRRP-MIB", "alaVrrp3AssoTrackRowStatus")
)
if mibBuilder.loadTexts:
    alaVrrp3AssoTrackTableGroup.setStatus("current")

alaVrrp3OperExEntryGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 2, 4)
)
alaVrrp3OperExEntryGroup.setObjects(
      *(("ALCATEL-ENT1-VRRP-MIB", "alaVrrp3CurrentPriority"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrp3GroupIdent"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrp3TrackCount"))
)
if mibBuilder.loadTexts:
    alaVrrp3OperExEntryGroup.setStatus("current")

alaVrrpAssoGroupEntryGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 2, 5)
)
alaVrrpAssoGroupEntryGroup.setObjects(
    ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpAssoGroupRowStatus")
)
if mibBuilder.loadTexts:
    alaVrrpAssoGroupEntryGroup.setStatus("current")

alaVrrpAssoTrackEntryGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 2, 6)
)
alaVrrpAssoTrackEntryGroup.setObjects(
    ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpAssoTrackRowStatus")
)
if mibBuilder.loadTexts:
    alaVrrpAssoTrackEntryGroup.setStatus("current")

alaVrrpOperEntryGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 2, 7)
)
alaVrrpOperEntryGroup.setObjects(
      *(("ALCATEL-ENT1-VRRP-MIB", "alaVrrpCurrentPriority"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackCount"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupIdent"))
)
if mibBuilder.loadTexts:
    alaVrrpOperEntryGroup.setStatus("current")

alaVrrpGroupTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 2, 8)
)
alaVrrpGroupTableGroup.setObjects(
      *(("ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupInterval"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupPriority"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupPreemptMode"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupAdminState"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupSetParam"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupOverride"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupRowStatus"))
)
if mibBuilder.loadTexts:
    alaVrrpGroupTableGroup.setStatus("current")

alaVrrpTrackGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 2, 9)
)
alaVrrpTrackGroup.setObjects(
      *(("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackState"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackAdminState"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackEntityType"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackEntityPort"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackPriority"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackRowStatus"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackEntityInterface"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackEntityIpv6Interface"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackEntityIpAddrType"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackEntityIpAddr"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpTrackBfdStatus"))
)
if mibBuilder.loadTexts:
...
alaVRRPCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 28, 1, 2, 1, 1)
)
alaVRRPCompliance.setObjects(
      *(("ALCATEL-ENT1-VRRP-MIB", "alaVRRPConfigGroup"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVRRPv2ConfigGroup"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrp3AssoTrackTableGroup"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrp3OperExEntryGroup"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpAssoGroupEntryGroup"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpOperEntryGroup"),
        ("ALCATEL-ENT1-VRRP-MIB", "alaVrrpGroupTableGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"AlaVrTrackId": AlaVrTrackId,
       ...
       "alaVRRPv2ConfigGroup": alaVRRPv2ConfigGroup,
       "alaVrrp3AssoTrackTableGroup": alaVrrp3AssoTrackTableGroup,
       "alaVrrp3OperExEntryGroup": alaVrrp3OperExEntryGroup,
       "alaVrrpAssoGroupEntryGroup": alaVrrpAssoGroupEntryGroup,
       "alaVrrpAssoTrackEntryGroup": alaVrrpAssoTrackEntryGroup,
       "alaVrrpOperEntryGroup": alaVrrpOperEntryGroup,
       "alaVrrpGroupTableGroup": alaVrrpGroupTableGroup,
