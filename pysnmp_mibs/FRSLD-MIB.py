...
# Notes
# -----
# ASN.1 source file://mibs/rfc/FRSLD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:21:44 2025
...
frsldCompliance.setObjects(
      *(("FRSLD-MIB", "frsldPvcReqCtrlGroup"),
        ("FRSLD-MIB", "frsldPvcReqDataGroup"),
        ("FRSLD-MIB", "frsldCapabilitiesGroup"),
        ("FRSLD-MIB", "frsldPvcHCFrameDataGroup"),
        ("FRSLD-MIB", "frsldPvcHCOctetDataGroup"),
        ("FRSLD-MIB", "frsldPvcPacketGroup"),
        ("FRSLD-MIB", "frsldPvcDelayCtrlGroup"),
        ("FRSLD-MIB", "frsldPvcSampleCtrlGroup"),
        ("FRSLD-MIB", "frsldPvcDelayDataGroup"),
        ("FRSLD-MIB", "frsldPvcSampleDelayGroup"),
        ("FRSLD-MIB", "frsldPvcSampleDataGroup"),
        ("FRSLD-MIB", "frsldPvcSampleHCFrameGroup"),
        ("FRSLD-MIB", "frsldPvcSampleHCDataGroup"),
        ("FRSLD-MIB", "frsldPvcSampleAvailGroup"),
        ("FRSLD-MIB", "frsldPvcSampleGeneralGroup"))
)
if mibBuilder.loadTexts:
