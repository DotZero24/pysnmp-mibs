_AV='els10-27hwDiagCode'
_AU='els10-27adminFatalErr'
_AT='els10-27trunkLinkCount'
_AS='els10-27trunkLinkOrdinal'
_AR='els10-27trunkLastError'
_AQ='els10-27trunkRemoteIp'
_AP='els10-27trunkRemoteBridgeAddr'
_AO='els10-27trunkState'
_AN='els10-27lpbkErrorBadReceives'
_AM='els10-27lpbkErrorNoReceives'
_AL='els10-27lpbkOperation'
_AK='els10-27debugString'
_AJ='els10-27debugStringID'
_AI='els10-27adminNAMReceiveCongests'
_AH='els10-27ifRxQueues'
_AG='els10-27ifFunction'
_AF='els10-27swdisDesc'
_AE='els10-27swdisWriteStatus'
_AD='els10-27FlowControlInterface'
_AC='els10-27igmpCacheIfIndex'
_AB='els10-27igmpCacheAddress'
_AA='els10-27VlanStaticVID'
_A9='els10-27VlanFilterGVRPVID'
_A8='els10-27VlanEgressVID'
_A7='els10-27VlanConfigVID'
_A6='els10-27volmirrorIndex'
_A5='els10-27traceProbe'
_A4='els10-27traceHop'
_A3='els10-27traceDestAddr'
_A2='els10-27traceNMSAddr'
_A1='completed'
_A0='not-started'
_z='els10-27pingDestAddr'
_y='els10-27pingNMSAddr'
_x='els10-27trapEntryIndex'
_w='els10-27trapIndex'
_v='els10-27WorkGroupNumber'
_u='els10-27trunkIfIndex'
_t='els10-27protoIfIndex'
_s='els10-27lpbkIndex'
_r='els10-27debugIndex'
_q='els10-27uartIndex'
_p='els10-27dot3Index'
_o='els10-27ifIndex'
_n='els10-27swIndex'
_m='els10-27hwPortIndex'
_l='DisplayString'
_k='NotificationType'
_j='ifOutErrors'
_i='ifOutDiscards'
...
_g='dot1dStpRootPort'
_f='dot1dStpRootCost'
_e='dot1dStpPortDesignatedRoot'
_d='dot1dStpPortDesignatedCost'
_c='dot1dStpPortDesignatedBridge'
_b='dot1dStpMaxAge'
_a='dot1dStpHelloTime'
_Z='dot1dStpForwardDelay'
_Y='dot1dStpDesignatedRoot'
_X='create'
_W='disable'
_V='enable'
_U='critical'
...
dot1dStpDesignatedRoot,dot1dStpForwardDelay,dot1dStpHelloTime,dot1dStpMaxAge,dot1dStpPortDesignatedBridge,dot1dStpPortDesignatedCost,dot1dStpPortDesignatedPort,dot1dStpPortDesignatedRoot,dot1dStpPortState,dot1dStpRootCost,dot1dStpRootPort=mibBuilder.importSymbols(_G,_Y,_Z,_a,_b,_c,_d,_O,_e,_P,_f,_g)
ifInErrors,ifOutDiscards,ifOutErrors=mibBuilder.importSymbols(_L,_h,_i,_j)
...
els10_27hwPortEntry.setIndexNames((0,_D,_m))
...
class _Els10_27hwUpLink_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_J,1),(_K,2)))
...
els10_27swFilesetEntry.setIndexNames((0,_D,_n))
...
class _Els10_27adminStorageFailure_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_J,1),(_K,2)))
...
class _Els10_27adminDisableButton_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_J,1),(_K,2)))
...
class _Els10_27addrOperation_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,4,5,6)));namedValues=NamedValues(*(('read-random',1),('read-next',2),('update',4),(_M,5),('read-block',6)))
...
els10_27ifEntry.setIndexNames((0,_D,_o))
...
els10_27dot3Entry.setIndexNames((0,_D,_p))
...
class _Els10_27dot3TPLinkOK_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_J,1),(_K,2)))
...
els10_27uartEntry.setIndexNames((0,_D,_q))
...
els10_27debugEntry.setIndexNames((0,_D,_r))
...
els10_27lpbkEntry.setIndexNames((0,_D,_s))
...
els10_27protoEntry.setIndexNames((0,_D,_t))
...
class _Els10_27protoRipListen_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_H,1),(_I,2)))
...
class _Els10_27protoTrunking_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_H,1),(_I,2)))
...
class _Els10_27sprotoTransmitPacing_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_H,1),(_I,2)))
...
els10_27trunkEntry.setIndexNames((0,_D,_u))
...
class _Els10_27trunkState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7)));namedValues=NamedValues(*((_N,1),('closed',2),('oneway',3),('joined',4),('perturbed',5),('helddown',6),('broken',7)))
...
els10_27WorkGroupEntry.setIndexNames((0,_D,_v))
...
els10_27trapControlEntry.setIndexNames((0,_D,_w))
...
class _Els10_27trapEnabled_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_J,1),(_K,2)))
...
class _Els10_27trapSeverity_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*((_Q,1),(_R,2),(_S,3),(_T,4),(_U,5)))
...
class _Els10_27trapSeverityControlSeverity_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*((_Q,1),(_R,2),(_S,3),(_T,4),(_U,5)))
...
class _Els10_27trapSeverityEnable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_H,1),(_I,2)))
...
class _Els10_27trapIncludeText_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_J,1),(_K,2)))
...
els10_27trapEntry.setIndexNames((0,_D,_x))
...
class _Els10_27trapEntrySeverity_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*((_Q,1),(_R,2),(_S,3),(_T,4),(_U,5)))
...
els10_27pingEntry.setIndexNames((0,_D,_y),(0,_D,_z))
...
class _Els10_27pingState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3)));namedValues=NamedValues(*((_A0,0),('active',1),('timed-out',2),(_A1,3)))
...
class _Els10_27pingOperation_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('on',1),(_N,2)))
...
els10_27traceEntry.setIndexNames((0,_D,_A2),(0,_D,_A3),(0,_D,_A4),(0,_D,_A5))
...
class _Els10_27traceOperation_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('on',1),(_N,2)))
...
class _Els10_27traceState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3,4,5)));namedValues=NamedValues(*((_A0,0),('active',1),('time-exceeded',2),('host-unreachable',3),('net-unreachable',4),(_A1,5)))
...
class _Els10_27volmirrorMode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1)));namedValues=NamedValues(*((_N,0),('on',1)))
...
els10_27volmirrorMacEntry.setIndexNames((0,_D,_A6))
...
class _Els10_27VlanGVRPEnable_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_H,1),(_I,2)))
_Els10_27VlanGVRPEnable_Type.__name__=_E
...
els10_27VlanConfigEntry.setIndexNames((0,_D,_A7))
...
class _Els10_27VlanConfigVID_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,4094))
_Els10_27VlanConfigVID_Type.__name__=_E
...
_Els10_27VlanConfigName_Type.__name__=_l
...
class _Els10_27VlanConfigStatus_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_V,1),(_W,2)))
_Els10_27VlanConfigStatus_Type.__name__=_E
...
class _Els10_27VlanConfigEstablish_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_X,1),(_M,2)))
...
els10_27VlanConfigEgressEntry.setIndexNames((0,_D,_A8))
...
class _Els10_27VlanEgressVID_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,4094))
_Els10_27VlanEgressVID_Type.__name__=_E
...
class _Els10_27VlanEgressStatus_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_V,1),(_W,2)))
_Els10_27VlanEgressStatus_Type.__name__=_E
...
els10_27VlanFilterGVRPEntry.setIndexNames((0,_D,_A9))
...
class _Els10_27VlanFilterGVRPVID_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,4094))
_Els10_27VlanFilterGVRPVID_Type.__name__=_E
...
class _Els10_27VlanFilterGVRPStatus_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_V,1),(_W,2)))
_Els10_27VlanFilterGVRPStatus_Type.__name__=_E
...
class _Els10_27VlanFilterGVRPEstablishVID_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_X,1),(_M,2)))
...
els10_27VlanStaticEntry.setIndexNames((0,_D,_AA))
if mibBuilder.loadTexts:els10_27VlanStaticEntry.setStatus(_A)
class _Els10_27VlanStaticVID_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,4094))
_Els10_27VlanStaticVID_Type.__name__=_E
...
class _Els10_27VlanStaticPort_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,27))
_Els10_27VlanStaticPort_Type.__name__=_E
...
class _Els10_27VlanStaticEstablish_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_X,1),(_M,2)))
...
class _Els10_27IPMulticastStatus_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1)));namedValues=NamedValues(*((_I,0),(_H,1)))
...
class _Els10_27igmpStatus_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1)));namedValues=NamedValues(*((_H,0),(_I,1)))
...
class _Els10_27igmpQueryStatus_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1)));namedValues=NamedValues(*((_I,0),(_H,1)))
...
els10_27igmpCacheEntry.setIndexNames((0,_D,_AB),(0,_D,_AC))
...
els10_27FlowControlEntry.setIndexNames((0,_D,_AD))
...
els10_27WriteStatusTrap=NotificationType((1,3,6,1,4,1,97,0,2))
els10_27WriteStatusTrap.setObjects(*((_D,_F),(_D,_AE),(_D,_AF)))
if mibBuilder.loadTexts:els10_27WriteStatusTrap.setStatus('')
els10_27PortFunctionsTrap=NotificationType((1,3,6,1,4,1,97,0,3))
els10_27PortFunctionsTrap.setObjects(*((_D,_F),(_D,_AG)))
if mibBuilder.loadTexts:els10_27PortFunctionsTrap.setStatus('')
els10_27RxQueuesTrap=NotificationType((1,3,6,1,4,1,97,0,4))
els10_27RxQueuesTrap.setObjects(*((_D,_F),(_D,_AH)))
if mibBuilder.loadTexts:els10_27RxQueuesTrap.setStatus('')
els10_27RxStormFlagTrap=NotificationType((1,3,6,1,4,1,97,0,5))
els10_27RxStormFlagTrap.setObjects((_D,_F))
if mibBuilder.loadTexts:els10_27RxStormFlagTrap.setStatus('')
els10_27TxCongestsTrap=NotificationType((1,3,6,1,4,1,97,0,6))
els10_27TxCongestsTrap.setObjects(*((_D,_F),(_D,_AI)))
if mibBuilder.loadTexts:els10_27TxCongestsTrap.setStatus('')
els10_27DebugStringIdTrap=NotificationType((1,3,6,1,4,1,97,0,8))
els10_27DebugStringIdTrap.setObjects(*((_D,_F),(_D,_AJ),(_D,_AK)))
if mibBuilder.loadTexts:els10_27DebugStringIdTrap.setStatus('')
els10_27LpbkOperationTrap=NotificationType((1,3,6,1,4,1,97,0,9))
els10_27LpbkOperationTrap.setObjects(*((_D,_F),(_D,_AL),(_D,_AM),(_D,_AN)))
if mibBuilder.loadTexts:els10_27LpbkOperationTrap.setStatus('')
els10_27TrunkStateTrap=NotificationType((1,3,6,1,4,1,97,0,10))
els10_27TrunkStateTrap.setObjects(*((_D,_F),(_D,_AO)))
if mibBuilder.loadTexts:els10_27TrunkStateTrap.setStatus('')
els10_27TrunkBridgeAddrTrap=NotificationType((1,3,6,1,4,1,97,0,11))
els10_27TrunkBridgeAddrTrap.setObjects(*((_D,_F),(_D,_AP)))
if mibBuilder.loadTexts:els10_27TrunkBridgeAddrTrap.setStatus('')
els10_27TrunkIPAddrTrap=NotificationType((1,3,6,1,4,1,97,0,12))
els10_27TrunkIPAddrTrap.setObjects(*((_D,_F),(_D,_AQ)))
if mibBuilder.loadTexts:els10_27TrunkIPAddrTrap.setStatus('')
els10_27TrunkErrorTrap=NotificationType((1,3,6,1,4,1,97,0,13))
els10_27TrunkErrorTrap.setObjects(*((_D,_F),(_D,_AR)))
if mibBuilder.loadTexts:els10_27TrunkErrorTrap.setStatus('')
els10_27TrunkLinkOrdinalTrap=NotificationType((1,3,6,1,4,1,97,0,14))
els10_27TrunkLinkOrdinalTrap.setObjects(*((_D,_F),(_D,_AS)))
if mibBuilder.loadTexts:els10_27TrunkLinkOrdinalTrap.setStatus('')
els10_27TrunkLinkCountTrap=NotificationType((1,3,6,1,4,1,97,0,15))
els10_27TrunkLinkCountTrap.setObjects(*((_D,_F),(_D,_AT)))
if mibBuilder.loadTexts:els10_27TrunkLinkCountTrap.setStatus('')
els10_27DiagUnitBootedTrap=NotificationType((1,3,6,1,4,1,97,0,16))
els10_27DiagUnitBootedTrap.setObjects(*((_D,_F),(_D,_AU)))
if mibBuilder.loadTexts:els10_27DiagUnitBootedTrap.setStatus('')
els10_27StorageFailureTrap=NotificationType((1,3,6,1,4,1,97,0,17))
els10_27StorageFailureTrap.setObjects((_D,_F))
if mibBuilder.loadTexts:els10_27StorageFailureTrap.setStatus('')
els10_27PortCongestedTrap=NotificationType((1,3,6,1,4,1,97,0,18))
els10_27PortCongestedTrap.setObjects(*((_D,_F),(_L,_i)))
if mibBuilder.loadTexts:els10_27PortCongestedTrap.setStatus('')
els10_27TopChangeBegunTrap=NotificationType((1,3,6,1,4,1,97,0,19))
els10_27TopChangeBegunTrap.setObjects((_D,_F))
if mibBuilder.loadTexts:els10_27TopChangeBegunTrap.setStatus('')
els10_27TopChangeEndTrap=NotificationType((1,3,6,1,4,1,97,0,20))
els10_27TopChangeEndTrap.setObjects((_D,_F))
if mibBuilder.loadTexts:els10_27TopChangeEndTrap.setStatus('')
els10_27IfErrorsTrap=NotificationType((1,3,6,1,4,1,97,0,21))
els10_27IfErrorsTrap.setObjects(*((_D,_F),(_L,_h),(_L,_j)))
if mibBuilder.loadTexts:els10_27IfErrorsTrap.setStatus('')
els10_27StRootIDTrap=NotificationType((1,3,6,1,4,1,97,0,22))
els10_27StRootIDTrap.setObjects(*((_D,_F),(_G,_Y)))
if mibBuilder.loadTexts:els10_27StRootIDTrap.setStatus('')
els10_27StRootCostTrap=NotificationType((1,3,6,1,4,1,97,0,23))
els10_27StRootCostTrap.setObjects(*((_D,_F),(_G,_f)))
if mibBuilder.loadTexts:els10_27StRootCostTrap.setStatus('')
els10_27StRootPortTrap=NotificationType((1,3,6,1,4,1,97,0,24))
els10_27StRootPortTrap.setObjects(*((_D,_F),(_G,_g)))
if mibBuilder.loadTexts:els10_27StRootPortTrap.setStatus('')
els10_27StMaxAgeTrap=NotificationType((1,3,6,1,4,1,97,0,25))
els10_27StMaxAgeTrap.setObjects(*((_D,_F),(_G,_b)))
if mibBuilder.loadTexts:els10_27StMaxAgeTrap.setStatus('')
els10_27StHelloTimeTrap=NotificationType((1,3,6,1,4,1,97,0,26))
els10_27StHelloTimeTrap.setObjects(*((_D,_F),(_G,_a)))
if mibBuilder.loadTexts:els10_27StHelloTimeTrap.setStatus('')
els10_27StForwardDelayTrap=NotificationType((1,3,6,1,4,1,97,0,27))
els10_27StForwardDelayTrap.setObjects(*((_D,_F),(_G,_Z)))
if mibBuilder.loadTexts:els10_27StForwardDelayTrap.setStatus('')
els10_27StDesigRootTrap=NotificationType((1,3,6,1,4,1,97,0,28))
els10_27StDesigRootTrap.setObjects(*((_D,_F),(_G,_e)))
if mibBuilder.loadTexts:els10_27StDesigRootTrap.setStatus('')
els10_27StPortDesigBridgeTrap=NotificationType((1,3,6,1,4,1,97,0,29))
els10_27StPortDesigBridgeTrap.setObjects(*((_D,_F),(_G,_c)))
if mibBuilder.loadTexts:els10_27StPortDesigBridgeTrap.setStatus('')
els10_27StPortDesigCostTrap=NotificationType((1,3,6,1,4,1,97,0,30))
els10_27StPortDesigCostTrap.setObjects(*((_D,_F),(_G,_d)))
if mibBuilder.loadTexts:els10_27StPortDesigCostTrap.setStatus('')
els10_27StPortDesigPortTrap=NotificationType((1,3,6,1,4,1,97,0,31))
els10_27StPortDesigPortTrap.setObjects(*((_D,_F),(_G,_O)))
if mibBuilder.loadTexts:els10_27StPortDesigPortTrap.setStatus('')
els10_27StPortStateTrap=NotificationType((1,3,6,1,4,1,97,0,32))
els10_27StPortStateTrap.setObjects(*((_D,_F),(_G,_P)))
if mibBuilder.loadTexts:els10_27StPortStateTrap.setStatus('')
els10_27InvalidConfigurationFileTrap=NotificationType((1,3,6,1,4,1,97,0,34))
els10_27InvalidConfigurationFileTrap.setObjects(*((_D,_F),(_G,_O)))
if mibBuilder.loadTexts:els10_27InvalidConfigurationFileTrap.setStatus('')
els10_27StInvalidFlashCodeImageTrap=NotificationType((1,3,6,1,4,1,97,0,35))
els10_27StInvalidFlashCodeImageTrap.setObjects(*((_D,_F),(_G,_P)))
if mibBuilder.loadTexts:els10_27StInvalidFlashCodeImageTrap.setStatus('')
els10_27hwDiagTrap=NotificationType((1,3,6,1,4,1,97,0,100))
els10_27hwDiagTrap.setObjects(*((_D,_F),(_D,_AV)))
if mibBuilder.loadTexts:els10_27hwDiagTrap.setStatus('')
mibBuilder.exportSymbols(_D,**{'sigma':sigma,'els10-27WriteStatusTrap':els10_27WriteStatusTrap,'els10-27PortFunctionsTrap':els10_27PortFunctionsTrap,'els10-27RxQueuesTrap':els10_27RxQueuesTrap,'els10-27RxStormFlagTrap':els10_27RxStormFlagTrap,'els10-27TxCongestsTrap':els10_27TxCongestsTrap,'els10-27DebugStringIdTrap':els10_27DebugStringIdTrap,'els10-27LpbkOperationTrap':els10_27LpbkOperationTrap,'els10-27TrunkStateTrap':els10_27TrunkStateTrap,'els10-27TrunkBridgeAddrTrap':els10_27TrunkBridgeAddrTrap,'els10-27TrunkIPAddrTrap':els10_27TrunkIPAddrTrap,'els10-27TrunkErrorTrap':els10_27TrunkErrorTrap,'els10-27TrunkLinkOrdinalTrap':els10_27TrunkLinkOrdinalTrap,'els10-27TrunkLinkCountTrap':els10_27TrunkLinkCountTrap,'els10-27DiagUnitBootedTrap':els10_27DiagUnitBootedTrap,'els10-27StorageFailureTrap':els10_27StorageFailureTrap,'els10-27PortCongestedTrap':els10_27PortCongestedTrap,'els10-27TopChangeBegunTrap':els10_27TopChangeBegunTrap,'els10-27TopChangeEndTrap':els10_27TopChangeEndTrap,'els10-27IfErrorsTrap':els10_27IfErrorsTrap,'els10-27StRootIDTrap':els10_27StRootIDTrap,'els10-27StRootCostTrap':els10_27StRootCostTrap,'els10-27StRootPortTrap':els10_27StRootPortTrap,'els10-27StMaxAgeTrap':els10_27StMaxAgeTrap,'els10-27StHelloTimeTrap':els10_27StHelloTimeTrap,'els10-27StForwardDelayTrap':els10_27StForwardDelayTrap,'els10-27StDesigRootTrap':els10_27StDesigRootTrap,'els10-27StPortDesigBridgeTrap':els10_27StPortDesigBridgeTrap,'els10-27StPortDesigCostTrap':els10_27StPortDesigCostTrap,'els10-27StPortDesigPortTrap':els10_27StPortDesigPortTrap,'els10-27StPortStateTrap':els10_27StPortStateTrap,'els10-27InvalidConfigurationFileTrap':els10_27InvalidConfigurationFileTrap,'els10-27StInvalidFlashCodeImageTrap':els10_27StInvalidFlashCodeImageTrap,'els10-27hwDiagTrap':els10_27hwDiagTrap,'sys':sys,'sysID':sysID,'sysReset':sysReset,'sysTrapPort':sysTrapPort,'els10-27':els10_27,'els10-27hw':els10_27hw,_AV:els10_27hwDiagCode,'els10-27hwManufData':els10_27hwManufData,'els10-27hwPortCount':els10_27hwPortCount,'els10-27hwPortTable':els10_27hwPortTable,'els10-27hwPortEntry':els10_27hwPortEntry,_m:els10_27hwPortIndex,'els10-27hwPortType':els10_27hwPortType,'els10-27hwPortSubType':els10_27hwPortSubType,'els10-27hwPortDiagPassed':els10_27hwPortDiagPassed,'els10-27hwAddr':els10_27hwAddr,'els10-27hwUpLink':els10_27hwUpLink,'els10-27hwUpLinkManufData':els10_27hwUpLinkManufData,'els10-27sw':els10_27sw,'els10-27swNumber':els10_27swNumber,'els10-27swFilesetTable':els10_27swFilesetTable,'els10-27swFilesetEntry':els10_27swFilesetEntry,_n:els10_27swIndex,'els10-27swDesc':els10_27swDesc,'els10-27swCount':els10_27swCount,'els10-27swType':els10_27swType,'els10-27swSizes':els10_27swSizes,'els10-27swStarts':els10_27swStarts,'els10-27swBases':els10_27swBases,'els10-27swFlashBank':els10_27swFlashBank,'els10-27admin':els10_27admin,_AU:els10_27adminFatalErr,'els10-27adminAnyPass':els10_27adminAnyPass,'els10-27adminGetPass':els10_27adminGetPass,'els10-27adminNMSIPAddr':els10_27adminNMSIPAddr,'els10-27adminStorageFailure':els10_27adminStorageFailure,'els10-27adminAuthenticationFailure':els10_27adminAuthenticationFailure,_AI:els10_27adminNAMReceiveCongests,'els10-27adminArpEntries':els10_27adminArpEntries,'els10-27adminArpStatics':els10_27adminArpStatics,'els10-27adminArpOverflows':els10_27adminArpOverflows,'els10-27adminIpEntries':els10_27adminIpEntries,'els10-27adminIpStatics':els10_27adminIpStatics,'els10-27adminStaticPreference':els10_27adminStaticPreference,'els10-27adminRipPreference':els10_27adminRipPreference,'els10-27adminRipRouteDiscards':els10_27adminRipRouteDiscards,'els10-27adminRebootConfig':els10_27adminRebootConfig,'els10-27adminDisableButton':els10_27adminDisableButton,'els10-27adminButtonSelection':els10_27adminButtonSelection,'els10-27adminLEDProgramOption':els10_27adminLEDProgramOption,'els10-27swdis':els10_27swdis,_AF:els10_27swdisDesc,'els10-27swdisAccess':els10_27swdisAccess,_AE:els10_27swdisWriteStatus,'els10-27swdisConfigIp':els10_27swdisConfigIp,'els10-27swdisConfigRetryTime':els10_27swdisConfigRetryTime,'els10-27swdisConfigTotalTimeout':els10_27swdisConfigTotalTimeout,'els10-27addr':els10_27addr,'els10-27addrStatics':els10_27addrStatics,'els10-27addrDynamics':els10_27addrDynamics,'els10-27addrDynamicMax':els10_27addrDynamicMax,'els10-27addrDynamicOverflows':els10_27addrDynamicOverflows,'els10-27addrFlags':els10_27addrFlags,'els10-27addrMAC':els10_27addrMAC,'els10-27addrPort':els10_27addrPort,'els10-27addrOperation':els10_27addrOperation,'els10-27addrIndex':els10_27addrIndex,'els10-27addrNext':els10_27addrNext,'els10-27addrBlockSize':els10_27addrBlockSize,'els10-27addrBlock':els10_27addrBlock,'els10-27if':els10_27if,'els10-27ifTable':els10_27ifTable,'els10-27ifEntry':els10_27ifEntry,_o:els10_27ifIndex,'els10-27ifThreshold':els10_27ifThreshold,'els10-27ifThresholdTime':els10_27ifThresholdTime,'els10-27ifRxQueueThresh':els10_27ifRxQueueThresh,'els10-27ifRxQueueThreshTime':els10_27ifRxQueueThreshTime,'els10-27ifTxStormCnt':els10_27ifTxStormCnt,'els10-27ifTxStormTime':els10_27ifTxStormTime,_AG:els10_27ifFunction,'els10-27ifRxHwFCSs':els10_27ifRxHwFCSs,_AH:els10_27ifRxQueues,'els10-27ifStatisticsTime':els10_27ifStatisticsTime,'els10-27ifForwardedChars':els10_27ifForwardedChars,'els10-27ifDescr':els10_27ifDescr,'els10-27ifGoodRxFrames':els10_27ifGoodRxFrames,'els10-27ifGoodTxFrames':els10_27ifGoodTxFrames,'els10-27dot3':els10_27dot3,'els10-27dot3Table':els10_27dot3Table,'els10-27dot3Entry':els10_27dot3Entry,_p:els10_27dot3Index,'els10-27dot3TPLinkOK':els10_27dot3TPLinkOK,'els10-27dot3LedOn':els10_27dot3LedOn,'els10-27dot3RxCollisions':els10_27dot3RxCollisions,'els10-27dot3RxRunts':els10_27dot3RxRunts,'els10-27dot3RxLateColls':els10_27dot3RxLateColls,'els10-27dot3TxJabbers':els10_27dot3TxJabbers,'els10-27dot3TxBabbles':els10_27dot3TxBabbles,'els10-27dot3TxCollisions':els10_27dot3TxCollisions,'els10-27dot3SpeedSelection':els10_27dot3SpeedSelection,'els10-27dot3DuplexSelection':els10_27dot3DuplexSelection,'els10-27uart':els10_27uart,'els10-27uartTable':els10_27uartTable,'els10-27uartEntry':els10_27uartEntry,_q:els10_27uartIndex,'els10-27uartBaud':els10_27uartBaud,'els10-27uartAlignmentErrors':els10_27uartAlignmentErrors,'els10-27uartOverrunErrors':els10_27uartOverrunErrors,'els10-27debug':els10_27debug,_AJ:els10_27debugStringID,_AK:els10_27debugString,'els10-27debugTable':els10_27debugTable,'els10-27debugEntry':els10_27debugEntry,_r:els10_27debugIndex,'els10-27debugOperation':els10_27debugOperation,'els10-27debugBase':els10_27debugBase,'els10-27debugLength':els10_27debugLength,'els10-27debugData':els10_27debugData,'els10-27lpbk':els10_27lpbk,'els10-27lpbkTable':els10_27lpbkTable,'els10-27lpbkEntry':els10_27lpbkEntry,_s:els10_27lpbkIndex,_AL:els10_27lpbkOperation,'els10-27lpbkDestAddr':els10_27lpbkDestAddr,'els10-27lpbkPktNum':els10_27lpbkPktNum,'els10-27lpbkInterval':els10_27lpbkInterval,'els10-27lpbkPktLength':els10_27lpbkPktLength,'els10-27lpbkIncrements':els10_27lpbkIncrements,'els10-27lpbkGoods':els10_27lpbkGoods,_AM:els10_27lpbkErrorNoReceives,_AN:els10_27lpbkErrorBadReceives,'els10-27lpbkErrorSize':els10_27lpbkErrorSize,'els10-27lpbkErrorSent':els10_27lpbkErrorSent,'els10-27lpbkErrorReceived':els10_27lpbkErrorReceived,'els10-27lpbkErrorOffset':els10_27lpbkErrorOffset,'els10-27proto':els10_27proto,'els10-27protoTable':els10_27protoTable,'els10-27protoEntry':els10_27protoEntry,_t:els10_27protoIfIndex,'els10-27protoBridge':els10_27protoBridge,'els10-27protoSuppressBpdu':els10_27protoSuppressBpdu,'els10-27protoRipListen':els10_27protoRipListen,'els10-27protoTrunking':els10_27protoTrunking,'els10-27sprotoTransmitPacing':els10_27sprotoTransmitPacing,'els10-27trunk':els10_27trunk,'els10-27trunkTable':els10_27trunkTable,'els10-27trunkEntry':els10_27trunkEntry,_u:els10_27trunkIfIndex,_AO:els10_27trunkState,_AP:els10_27trunkRemoteBridgeAddr,_AQ:els10_27trunkRemoteIp,_AR:els10_27trunkLastError,_AS:els10_27trunkLinkOrdinal,_AT:els10_27trunkLinkCount,'els10-27trunkLastChange':els10_27trunkLastChange,'els10-27workgroup':els10_27workgroup,'els10-27WorkGroupNextNumber':els10_27WorkGroupNextNumber,'els10-27WorkGroupCurrentCount':els10_27WorkGroupCurrentCount,'els10-27WorkGroupMaxCount':els10_27WorkGroupMaxCount,'els10-27WorkGroupTable':els10_27WorkGroupTable,'els10-27WorkGroupEntry':els10_27WorkGroupEntry,_v:els10_27WorkGroupNumber,'els10-27WorkGroupName':els10_27WorkGroupName,'els10-27WorkGroupPorts':els10_27WorkGroupPorts,'els10-27WorkGroupType':els10_27WorkGroupType,'els10-27trapMgt':els10_27trapMgt,'els10-27trapControlTable':els10_27trapControlTable,'els10-27trapControlEntry':els10_27trapControlEntry,_w:els10_27trapIndex,'els10-27trapEnabled':els10_27trapEnabled,_F:els10_27trapSeverity,'els10-27trapText':els10_27trapText,'els10-27trapSeverityControlTable':els10_27trapSeverityControlTable,'els10-27trapSeverityControlEntry':els10_27trapSeverityControlEntry,'els10-27trapSeverityControlSeverity':els10_27trapSeverityControlSeverity,'els10-27trapSeverityEnable':els10_27trapSeverityEnable,'els10-27trapIncludeText':els10_27trapIncludeText,'els10-27trapTime':els10_27trapTime,'els10-27trapRetry':els10_27trapRetry,'els10-27trapNumber':els10_27trapNumber,'els10-27trapTable':els10_27trapTable,'els10-27trapEntry':els10_27trapEntry,_x:els10_27trapEntryIndex,'els10-27trapEntryTimeStamp':els10_27trapEntryTimeStamp,'els10-27trapEntryText':els10_27trapEntryText,'els10-27trapEntryNumber':els10_27trapEntryNumber,'els10-27trapEntrySeverity':els10_27trapEntrySeverity,'els10-27pingMgt':els10_27pingMgt,'els10-27pingDataTimeout':els10_27pingDataTimeout,'els10-27pingTable':els10_27pingTable,'els10-27pingEntry':els10_27pingEntry,_y:els10_27pingNMSAddr,_z:els10_27pingDestAddr,'els10-27pingState':els10_27pingState,'els10-27pingCount':els10_27pingCount,'els10-27pingDataSize':els10_27pingDataSize,'els10-27pingWait':els10_27pingWait,'els10-27pingTimeOut':els10_27pingTimeOut,'els10-27pingOperation':els10_27pingOperation,'els10-27pingMin':els10_27pingMin,'els10-27pingMax':els10_27pingMax,'els10-27pingAvg':els10_27pingAvg,'els10-27pingNumTransmitted':els10_27pingNumTransmitted,'els10-27pingNumReceived':els10_27pingNumReceived,'els10-27traceMgt':els10_27traceMgt,'els10-27traceDataTimeout':els10_27traceDataTimeout,'els10-27traceTable':els10_27traceTable,'els10-27traceEntry':els10_27traceEntry,_A2:els10_27traceNMSAddr,_A3:els10_27traceDestAddr,'els10-27traceMaxTTL':els10_27traceMaxTTL,'els10-27traceDataSize':els10_27traceDataSize,'els10-27traceNumProbes':els10_27traceNumProbes,'els10-27traceWait':els10_27traceWait,'els10-27traceOperation':els10_27traceOperation,_A4:els10_27traceHop,'els10-27traceHopAddr':els10_27traceHopAddr,_A5:els10_27traceProbe,'els10-27traceState':els10_27traceState,'els10-27traceTime':els10_27traceTime,'els10-27volmirrorgroup':els10_27volmirrorgroup,'els10-27volmirrorMode':els10_27volmirrorMode,'els10-27volmirrorPort':els10_27volmirrorPort,'els10-27volmonitorPort':els10_27volmonitorPort,'els10-27volMirrorMacTable':els10_27volMirrorMacTable,'els10-27volmirrorMacEntry':els10_27volmirrorMacEntry,_A6:els10_27volmirrorIndex,'els10-27volmirrorMac1':els10_27volmirrorMac1,'els10-27VlanBridgeConfig':els10_27VlanBridgeConfig,'els10-27VlanVersionNumber':els10_27VlanVersionNumber,'els10-27VlanOperatingMode':els10_27VlanOperatingMode,'els10-27VlanResetDefaults':els10_27VlanResetDefaults,'els10-27VlanGVRPEnable':els10_27VlanGVRPEnable,'els10-27VlanAccessList':els10_27VlanAccessList,'els10-27VlanConfigVlan':els10_27VlanConfigVlan,'els10-27VlanNumActiveEntries':els10_27VlanNumActiveEntries,'els10-27VlanNumConfiguredEntries':els10_27VlanNumConfiguredEntries,'els10-27VlanMaxNumEntries':els10_27VlanMaxNumEntries,'els10-27VlanConfigTable':els10_27VlanConfigTable,'els10-27VlanConfigEntry':els10_27VlanConfigEntry,'els10-27VlanConfigIndex':els10_27VlanConfigIndex,_A7:els10_27VlanConfigVID,'els10-27VlanConfigPorts':els10_27VlanConfigPorts,'els10-27VlanConfigIP':els10_27VlanConfigIP,'els10-27VlanConfigIPMask':els10_27VlanConfigIPMask,'els10-27VlanConfigName':els10_27VlanConfigName,'els10-27VlanConfigStatus':els10_27VlanConfigStatus,'els10-27VlanConfigEstablish':els10_27VlanConfigEstablish,'els10-27VlanConfigEgressTable':els10_27VlanConfigEgressTable,'els10-27VlanConfigEgressEntry':els10_27VlanConfigEgressEntry,'els10-27VlanEgressIndex':els10_27VlanEgressIndex,_A8:els10_27VlanEgressVID,'els10-27VlanEgressList':els10_27VlanEgressList,'els10-27VlanEgressStatus':els10_27VlanEgressStatus,'els10-27VlanFilterGVRPTable':els10_27VlanFilterGVRPTable,'els10-27VlanFilterGVRPEntry':els10_27VlanFilterGVRPEntry,'els10-27VlanFilterGVRPIndex':els10_27VlanFilterGVRPIndex,_A9:els10_27VlanFilterGVRPVID,'els10-27VlanFilterGVRPList':els10_27VlanFilterGVRPList,'els10-27VlanFilterGVRPStatus':els10_27VlanFilterGVRPStatus,'els10-27VlanFilterGVRPEstablishVID':els10_27VlanFilterGVRPEstablishVID,'els10-27VlanStaticTable':els10_27VlanStaticTable,'els10-27VlanStaticEntry':els10_27VlanStaticEntry,_AA:els10_27VlanStaticVID,'els10-27VlanStaticMAC':els10_27VlanStaticMAC,'els10-27VlanStaticPort':els10_27VlanStaticPort,'els10-27VlanStaticEstablish':els10_27VlanStaticEstablish,'els10-27volipmgroup':els10_27volipmgroup,'els10-27IPMulticastStatus':els10_27IPMulticastStatus,'els10-27ipmInterfaceRtr':els10_27ipmInterfaceRtr,'els10-27voligmpgroup':els10_27voligmpgroup,'els10-27igmpStatus':els10_27igmpStatus,'els10-27igmpQueryStatus':els10_27igmpQueryStatus,'els10-27igmpQueryCount':els10_27igmpQueryCount,'els10-27igmpPortDelay':els10_27igmpPortDelay,'els10-27igmpCacheTable':els10_27igmpCacheTable,'els10-27igmpCacheEntry':els10_27igmpCacheEntry,_AB:els10_27igmpCacheAddress,_AC:els10_27igmpCacheIfIndex,'els10-27igmpCacheExpiryTime':els10_27igmpCacheExpiryTime,'els10-27FlowControlCtl':els10_27FlowControlCtl,'els10-27FlowControlBackPressure':els10_27FlowControlBackPressure,'els10-27FlowControlThresholdValue':els10_27FlowControlThresholdValue,'els10-27FlowControlPauseInteval':els10_27FlowControlPauseInteval,'els10-27FlowControlTable':els10_27FlowControlTable,'els10-27FlowControlEntry':els10_27FlowControlEntry,_AD:els10_27FlowControlInterface,'els10-27FlowControlEnable':els10_27FlowControlEnable,'els10-27FlowControlRxPauseFrames':els10_27FlowControlRxPauseFrames,'els10-27FlowControlTxPauseFrames':els10_27FlowControlTxPauseFrames})