...
TimeIntervalSec, AttId, SrcIndx = mibBuilder.importSymbols("S5-TCS-MIB", "TimeIntervalSec", "AttId", "SrcIndx")
...
mibBuilder.exportSymbols("S5-ETHERNET-COMMON-MIB", s5EnPortExt100MbSegConnCapability=s5EnPortExt100MbSegConnCapability, s5EnBStatFcsErrors=s5EnBStatFcsErrors, s5EnBStatLateColls=s5EnBStatLateColls, s5EnBStatTooLongFrms=s5EnBStatTooLongFrms, s5EnPortExtCurDuplexMode=s5EnPortExtCurDuplexMode, s5EnBStatNullFrames=s5EnBStatNullFrames, s5EnBStatBcastFrms=s5EnBStatBcastFrms, s5EnPortLinkStatus=s5EnPortLinkStatus, s5EnPortExt10MbSegConnCapability=s5EnPortExt10MbSegConnCapability, s5EnPortJabberStatus=s5EnPortJabberStatus, s5EnPortExtEntry=s5EnPortExtEntry, s5EnSStatSegRate=s5EnSStatSegRate, s5EnBStatRateMismatches=s5EnBStatRateMismatches, s5EnBStatShortIPGs=s5EnBStatShortIPGs, s5EnPStatTable=s5EnPStatTable, s5EnBStatMcastFrms=s5EnBStatMcastFrms, s5EnPortEntry=s5EnPortEntry, s5EnPortExtBrdIndx=s5EnPortExtBrdIndx, s5EnBStatRunts=s5EnBStatRunts, s5EnPortPartStatus=s5EnPortPartStatus, s5EnBStatFragments=s5EnBStatFragments, s5EnSStatTable=s5EnSStatTable, s5EnBStatAutoPartitions=s5EnBStatAutoPartitions, s5EnPortTable=s5EnPortTable, s5EnPortPartTime=s5EnPortPartTime, s5EnBStatGoodOctets=s5EnBStatGoodOctets, s5EnPStatSourceAddrChngs=s5EnPStatSourceAddrChngs, s5EthernetCommonMib=s5EthernetCommonMib, s5EnPortExtAutoNegRcvd=s5EnPortExtAutoNegRcvd, s5EnBStatAlignErrors=s5EnBStatAlignErrors, s5EnSStatSrcIndx=s5EnSStatSrcIndx, s5EnPortExt100MbSegAttCfg=s5EnPortExt100MbSegAttCfg, s5EnPStatEntry=s5EnPStatEntry, s5EnPortBrdIndx=s5EnPortBrdIndx, s5EnBStatGoodFrms=s5EnBStatGoodFrms, s5EnBStatShortEvents=s5EnBStatShortEvents, s5EnPStatSrcIndx=s5EnPStatSrcIndx, s5EnSStatSegColls=s5EnSStatSegColls, s5EnPortExtTable=s5EnPortExtTable, s5EnBStatVeryLongEvents=s5EnBStatVeryLongEvents, s5EnBStatBackOffFailures=s5EnBStatBackOffFailures, s5EnPortExtAutoNegAdv=s5EnPortExtAutoNegAdv, PYSNMP_MODULE_ID=s5EthernetCommonMib, s5EnBStatTable=s5EnBStatTable, s5EnPortExtActiveSpeed=s5EnPortExtActiveSpeed, s5EnPStatLinkStatusChngs=s5EnPStatLinkStatusChngs, s5EnSStatEntry=s5EnSStatEntry, s5EnPortExtIndx=s5EnPortExtIndx, s5EnPortExtHwCapability=s5EnPortExtHwCapability, s5EnPortIndx=s5EnPortIndx, s5EnBStatColls=s5EnBStatColls, s5EnBStatSrcIndx=s5EnBStatSrcIndx, s5EnPortExt10MbSegAttCfg=s5EnPortExt10MbSegAttCfg, s5EnPStatLastSourceAddr=s5EnPStatLastSourceAddr, s5EnBStatEntry=s5EnBStatEntry)
