# SNMP MIB module (A3COM-HUAWEI-MIRRORGROUP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-MIRRORGROUP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:45:55 2025
...
h3cMGID = _H3cMGID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 1, 1, 1, 1),
    _H3cMGID_Type()
)
...
h3cMGType = _H3cMGType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 1, 1, 1, 2),
    _H3cMGType_Type()
)
...
h3cMGRowStatus = _H3cMGRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 1, 1, 1, 4),
...
h3cMGMirrorIfIndex = _H3cMGMirrorIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 2, 1, 1, 1),
...
h3cMGMirrorDirection = _H3cMGMirrorDirection_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 2, 1, 1, 2),
...
h3cMGMirrorRowStatus = _H3cMGMirrorRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 2, 1, 1, 3),
...
h3cMGMonitorIfEntry = _H3cMGMonitorIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 3, 1, 1)
)
h3cMGMonitorIfEntry.setIndexNames(
    (0, "A3COM-HUAWEI-MIRRORGROUP-MIB", "h3cMGID"),
    (0, "A3COM-HUAWEI-MIRRORGROUP-MIB", "h3cMGMonitorIfIndex"),
)
if mibBuilder.loadTexts:
...
h3cMGMonitorIfIndex = _H3cMGMonitorIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 3, 1, 1, 1),
...
h3cMGMonitorRowStatus = _H3cMGMonitorRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 3, 1, 1, 2),
...
h3cMGReflectorIfEntry = _H3cMGReflectorIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 4, 1, 1)
)
h3cMGReflectorIfEntry.setIndexNames(
    (0, "A3COM-HUAWEI-MIRRORGROUP-MIB", "h3cMGID"),
    (0, "A3COM-HUAWEI-MIRRORGROUP-MIB", "h3cMGReflectorIfIndex"),
)
if mibBuilder.loadTexts:
...
h3cMGReflectorIfIndex = _H3cMGReflectorIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 4, 1, 1, 1),
...
h3cMGReflectorRowStatus = _H3cMGReflectorRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 4, 1, 1, 2),
...
h3cMGRprobeVlanEntry = _H3cMGRprobeVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 5, 1, 1)
)
h3cMGRprobeVlanEntry.setIndexNames(
    (0, "A3COM-HUAWEI-MIRRORGROUP-MIB", "h3cMGID"),
    (0, "A3COM-HUAWEI-MIRRORGROUP-MIB", "h3cMGRprobeVlanID"),
)
if mibBuilder.loadTexts:
...
h3cMGRprobeVlanID = _H3cMGRprobeVlanID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 5, 1, 1, 1),
...
h3cMGRprobeVlanRowStatus = _H3cMGRprobeVlanRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 68, 1, 5, 1, 1, 2),
