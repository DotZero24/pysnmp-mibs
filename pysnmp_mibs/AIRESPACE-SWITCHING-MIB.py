...
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:05 2025
...
_ProductGroup5_ObjectIdentity = ObjectIdentity
productGroup5 = _ProductGroup5_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14179, 1, 1, 4, 5)
)
...
class _AgentSnmpCommunityInetAddressType_Type(InetAddressType):
    """Custom type agentSnmpCommunityInetAddressType based on InetAddressType"""
    defaultValue = 2


_AgentSnmpCommunityInetAddressType_Type.__name__ = "InetAddressType"
_AgentSnmpCommunityInetAddressType_Object = MibTableColumn
agentSnmpCommunityInetAddressType = _AgentSnmpCommunityInetAddressType_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 5, 5, 1, 6),
    _AgentSnmpCommunityInetAddressType_Type()
)
agentSnmpCommunityInetAddressType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentSnmpCommunityInetAddressType.setStatus("current")
_AgentSnmpCommunityInetAddress_Type = InetAddress
_AgentSnmpCommunityInetAddress_Object = MibTableColumn
agentSnmpCommunityInetAddress = _AgentSnmpCommunityInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 5, 5, 1, 7),
    _AgentSnmpCommunityInetAddress_Type()
)
agentSnmpCommunityInetAddress.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentSnmpCommunityInetAddress.setStatus("current")


class _AgentSnmpCommunityPrefixLength_Type(Unsigned32):
    """Custom type agentSnmpCommunityPrefixLength based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentSnmpCommunityPrefixLength_Type.__name__ = "Unsigned32"
_AgentSnmpCommunityPrefixLength_Object = MibTableColumn
agentSnmpCommunityPrefixLength = _AgentSnmpCommunityPrefixLength_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 5, 5, 1, 8),
    _AgentSnmpCommunityPrefixLength_Type()
)
agentSnmpCommunityPrefixLength.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentSnmpCommunityPrefixLength.setStatus("current")
...
class _AgentSnmpTrapReceiverInetAddressType_Type(InetAddressType):
    """Custom type agentSnmpTrapReceiverInetAddressType based on InetAddressType"""
    defaultValue = 2


_AgentSnmpTrapReceiverInetAddressType_Type.__name__ = "InetAddressType"
_AgentSnmpTrapReceiverInetAddressType_Object = MibTableColumn
agentSnmpTrapReceiverInetAddressType = _AgentSnmpTrapReceiverInetAddressType_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 5, 6, 1, 4),
    _AgentSnmpTrapReceiverInetAddressType_Type()
)
agentSnmpTrapReceiverInetAddressType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentSnmpTrapReceiverInetAddressType.setStatus("current")
_AgentSnmpTrapReceiverInetAddress_Type = InetAddress
_AgentSnmpTrapReceiverInetAddress_Object = MibTableColumn
agentSnmpTrapReceiverInetAddress = _AgentSnmpTrapReceiverInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 14179, 1, 2, 5, 6, 1, 5),
    _AgentSnmpTrapReceiverInetAddress_Type()
)
agentSnmpTrapReceiverInetAddress.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentSnmpTrapReceiverInetAddress.setStatus("current")
...
if mibBuilder.loadTexts:
    agentTransferUploadMode.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferUploadPath.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferUploadFilename.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferUploadDataType.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferUploadStart.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferUploadStatus.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferDownloadMode.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferDownloadPath.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferDownloadFilename.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferDownloadDataType.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferDownloadStart.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferDownloadStatus.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferDownloadTftpMaxRetries.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferDownloadTftpTimeout.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferConfigurationFileEncryption.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentTransferConfigurationFileEncryptionKey.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentPortPhysicalMode.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    agentPortPhysicalStatus.setStatus("deprecated")
...
mibBuilder.exportSymbols(
    ...
    **{"bsnSwitching": bsnSwitching,
       ...
       "agentSnmpCommunityInetAddressType": agentSnmpCommunityInetAddressType,
       "agentSnmpCommunityInetAddress": agentSnmpCommunityInetAddress,
       "agentSnmpCommunityPrefixLength": agentSnmpCommunityPrefixLength,
       ...
       "agentSnmpTrapReceiverInetAddressType": agentSnmpTrapReceiverInetAddressType,
