...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:26:20 2025
...
mibBuilder.exportSymbols("AIRESPACE-SWITCHING-MIB", agentCLIConfigGroup=agentCLIConfigGroup, agentSnmpCommunityIPMask=agentSnmpCommunityIPMask, agentTransferDownloadTftpMaxRetries=agentTransferDownloadTftpMaxRetries, agentSnmpBroadcastStormTrapFlag=agentSnmpBroadcastStormTrapFlag, agentSerialParityType=agentSerialParityType, agentLagSummaryAdminMode=agentLagSummaryAdminMode, agentDhcpScopeDnsServerAddress2=agentDhcpScopeDnsServerAddress2, agentInterfaceDhcpProtocol=agentInterfaceDhcpProtocol, agentTelnetLoginTimeout=agentTelnetLoginTimeout, agentDhcpScopeNetwork=agentDhcpScopeNetwork, agentNetworkRouteIPAddress=agentNetworkRouteIPAddress, agentDhcpScopeDnsServerAddress1=agentDhcpScopeDnsServerAddress1, agentLagSummaryConfigTable=agentLagSummaryConfigTable, agentNetworkConfigGroup=agentNetworkConfigGroup, agentInterfaceActivePortNo=agentInterfaceActivePortNo, agentSnmpV3UserConfigEntry=agentSnmpV3UserConfigEntry, agentDot3adAggPortLACPMode=agentDot3adAggPortLACPMode, agentTransferDownloadMode=agentTransferDownloadMode, agentNetworkArpTimeout=agentNetworkArpTimeout, agentLoginSessionIdleTime=agentLoginSessionIdleTime, agentNtpConfigGroup=agentNtpConfigGroup, agentInterfacePortNo=agentInterfacePortNo, agentServicePortBurnedInMacAddress=agentServicePortBurnedInMacAddress, agentTelnetAllowNewMode=agentTelnetAllowNewMode, agentNetworkWebMode=agentNetworkWebMode, agentDhcpScopeDefaultRouterAddress3=agentDhcpScopeDefaultRouterAddress3, agentSwitchInfoGroup=agentSwitchInfoGroup, productGroup1=productGroup1, agentDhcpScopeNetbiosNameServerAddress3=agentDhcpScopeNetbiosNameServerAddress3, agentLoginSessionSessionTime=agentLoginSessionSessionTime, agentTransferDownloadPath=agentTransferDownloadPath, agentInventoryIsGigECardPresent=agentInventoryIsGigECardPresent, agentDhcpScopePoolStartAddress=agentDhcpScopePoolStartAddress, agentInterfaceIPNetmask=agentInterfaceIPNetmask, agentDhcpScopeName=agentDhcpScopeName, agentSnmpCommunityConfigTable=agentSnmpCommunityConfigTable, agentTransferConfigGroup=agentTransferConfigGroup, portStatsPktsTx1519to1530Octets=portStatsPktsTx1519to1530Octets, agentInterfaceConfigEntry=agentInterfaceConfigEntry, agentLagDetailedPortSpeed=agentLagDetailedPortSpeed, agentClearLoginSessions=agentClearLoginSessions, portStatsPktsTxOversizeOctets=portStatsPktsTxOversizeOctets, agentTrapLogEntry=agentTrapLogEntry, agentPortClearStats=agentPortClearStats, agentInventoryIsCryptoCard2Present=agentInventoryIsCryptoCard2Present, agentSnmpCommunityName=agentSnmpCommunityName, agentTransferDownloadGroup=agentTransferDownloadGroup, agentSnmpAuthenticationTrapFlag=agentSnmpAuthenticationTrapFlag, agentTransferUploadGroup=agentTransferUploadGroup, agentSystemGroup=agentSystemGroup, agentWcpSlotNumber=agentWcpSlotNumber, agentSwitchInfoPowerSupply1Present=agentSwitchInfoPowerSupply1Present, agentSwitchConfigGroup=agentSwitchConfigGroup, agentSnmpVersion3Status=agentSnmpVersion3Status, agentNetworkSecureWebPassword=agentNetworkSecureWebPassword, agentInterfaceAclName=agentInterfaceAclName, portStatsIndex=portStatsIndex, agentPortType=agentPortType, agentConfigGroup=agentConfigGroup, agentInventorySerialNumber=agentInventorySerialNumber, agentResetSystem=agentResetSystem, agentNetworkWebAuthCertType=agentNetworkWebAuthCertType, agentNetworkUserIdleTimeout=agentNetworkUserIdleTimeout, agentTransferDownloadFilename=agentTransferDownloadFilename, agentInfoGroup=agentInfoGroup, agentLagSummaryFlushTimer=agentLagSummaryFlushTimer, agentSwitchAddressAgingTimeoutTable=agentSwitchAddressAgingTimeoutTable, agentSerialHWFlowControlMode=agentSerialHWFlowControlMode, agentNetworkRouteIPNetmask=agentNetworkRouteIPNetmask, agentInventoryProductVersion=agentInventoryProductVersion, agentPortDot3FlowControlMode=agentPortDot3FlowControlMode, agentSwitchDot3FlowControlMode=agentSwitchDot3FlowControlMode, agentPortConfigEntry=agentPortConfigEntry, agentApInterferenceProfileFailTrapCount=agentApInterferenceProfileFailTrapCount, agentSnmpTrapFlagsConfigGroup=agentSnmpTrapFlagsConfigGroup, agentPortGarpJoinTime=agentPortGarpJoinTime, agentApAssociateDisassociateTrapCount=agentApAssociateDisassociateTrapCount, agentTransferDownloadTftpTimeout=agentTransferDownloadTftpTimeout, agentInventoryOperatingSystem=agentInventoryOperatingSystem, bsnSwitchingGroups=bsnSwitchingGroups, productGroup2=productGroup2, agentInterfaceConfigTable=agentInterfaceConfigTable, agentInterfaceVlanId=agentInterfaceVlanId, portStatsPktsRx1519to1530Octets=portStatsPktsRx1519to1530Octets, portStatsPktsTx1024to1518Octets=portStatsPktsTx1024to1518Octets, agentLagSummaryDeletePort=agentLagSummaryDeletePort, bsnSwitchingAgentConfigGroup=bsnSwitchingAgentConfigGroup, portStatsTable=portStatsTable, agentTrapLogSystemTime=agentTrapLogSystemTime, agentNetworkSubnetMask=agentNetworkSubnetMask, agentNetworkRouteConfigTable=agentNetworkRouteConfigTable, agentInventoryBurnedInMacAddress=agentInventoryBurnedInMacAddress, agentSnmpCommunityPrefixLength=agentSnmpCommunityPrefixLength, agentInventoryMaxNumberOfAPsSupported=agentInventoryMaxNumberOfAPsSupported, agentNtpServerTable=agentNtpServerTable, portStatsPktsTx512to1023Octets=portStatsPktsTx512to1023Octets, agentNtpPollingInterval=agentNtpPollingInterval, agentInventoryManufacturerName=agentInventoryManufacturerName, agentTransferUploadDataType=agentTransferUploadDataType, agentTransferDownloadDataType=agentTransferDownloadDataType, portStatsPktsTx65to127Octets=portStatsPktsTx65to127Octets, agentNetworkWebAuthCertRegenerateCmdInvoke=agentNetworkWebAuthCertRegenerateCmdInvoke, agentSwitchLwappTransportMode=agentSwitchLwappTransportMode, agentWcpPeerIpAddress=agentWcpPeerIpAddress, agentTransferUploadStatus=agentTransferUploadStatus, agentLagSummaryAddPort=agentLagSummaryAddPort, agentNetworkManagementVlan=agentNetworkManagementVlan, agentInventoryMaintenanceLevel=agentInventoryMaintenanceLevel, agentInventoryGroup=agentInventoryGroup, agentNetworkBurnedInMacAddress=agentNetworkBurnedInMacAddress, vlanDefaultCfgFailureTrap=vlanDefaultCfgFailureTrap, agentLagSummaryLinkTrap=agentLagSummaryLinkTrap, agentFreeMemory=agentFreeMemory, agentWcpInfoGroup=agentWcpInfoGroup, agentTotalMemory=agentTotalMemory, agentTransferConfigurationFileEncryption=agentTransferConfigurationFileEncryption, agentLoginSessionIPAddress=agentLoginSessionIPAddress, fanFailureTrap=fanFailureTrap, agentInventorySysDescription=agentInventorySysDescription, agentLagSummaryName=agentLagSummaryName, agentPortMirrorMode=agentPortMirrorMode, agentSnmpV3UserConfigTable=agentSnmpV3UserConfigTable, agentDhcpScopeNetbiosNameServerAddress1=agentDhcpScopeNetbiosNameServerAddress1, agentDhcpScopeLeaseTime=agentDhcpScopeLeaseTime, agentSnmpVersion2cStatus=agentSnmpVersion2cStatus, agentSwitchInfoPowerSupply2Operational=agentSwitchInfoPowerSupply2Operational, agentSnmpTrapReceiverConfigTable=agentSnmpTrapReceiverConfigTable, agentDhcpScopeIndex=agentDhcpScopeIndex, agentLagDetailedConfigTable=agentLagDetailedConfigTable, agentInterfaceDnsHostName=agentInterfaceDnsHostName, agentPortIfIndex=agentPortIfIndex, agentTrapLogGroup=agentTrapLogGroup, agentNetworkConfigProtocol=agentNetworkConfigProtocol, agentProductGroup=agentProductGroup, bsnSwitching=bsnSwitching, agentPortOperationalStatus=agentPortOperationalStatus, agentSerialGroup=agentSerialGroup, agentInterfaceSecondaryDhcpAddress=agentInterfaceSecondaryDhcpAddress, agentInventoryIsCryptoCardPresent=agentInventoryIsCryptoCardPresent, agentSwitchBroadcastControlMode=agentSwitchBroadcastControlMode, agentTransferDownloadStart=agentTransferDownloadStart, agentNetworkMulticastMode=agentNetworkMulticastMode, vlanDeleteLastTrap=vlanDeleteLastTrap, bsnSwitchingTrap=bsnSwitchingTrap, agentDhcpScopeDnsDomainName=agentDhcpScopeDnsDomainName, agentDhcpScopeNetbiosNameServerAddress2=agentDhcpScopeNetbiosNameServerAddress2, agentSnmpSpanningTreeTrapFlag=agentSnmpSpanningTreeTrapFlag, agentDhcpScopeDefaultRouterAddress2=agentDhcpScopeDefaultRouterAddress2, agentSnmpV3UserAuthenticationPassword=agentSnmpV3UserAuthenticationPassword, agentNetworkRouteGateway=agentNetworkRouteGateway, bsnSwitchingCompliances=bsnSwitchingCompliances, agentPortAutoNegAdminStatus=agentPortAutoNegAdminStatus, agentSnmpMultipleUsersTrapFlag=agentSnmpMultipleUsersTrapFlag, agentNetworkDsPortNumber=agentNetworkDsPortNumber, agentSnmpV3UserAuthenticationType=agentSnmpV3UserAuthenticationType, agentWcpControllerInfoEntry=agentWcpControllerInfoEntry, agentInventoryMachineModel=agentInventoryMachineModel, productGroup4=productGroup4, agentClearSwitchStats=agentClearSwitchStats, agentPortLinkTrapMode=agentPortLinkTrapMode, agentNetworkBroadcastSsidMode=agentNetworkBroadcastSsidMode, agentSnmpV3UserEncryptionPassword=agentSnmpV3UserEncryptionPassword, agentServicePortConfigProtocol=agentServicePortConfigProtocol, agentLagConfigMode=agentLagConfigMode, agentLagSummaryStpMode=agentLagSummaryStpMode, agentInventoryMachineType=agentInventoryMachineType, agentInterfaceName=agentInterfaceName, agentTransferUploadStart=agentTransferUploadStart, agentNetworkDefaultGateway=agentNetworkDefaultGateway, agentTrapLogTotal=agentTrapLogTotal, agentNetworkIPAddress=agentNetworkIPAddress, bsnSwitchingObsGroup=bsnSwitchingObsGroup, agentSwitchInfoPowerSupply2Present=agentSwitchInfoPowerSupply2Present, agentSerialCharacterSize=agentSerialCharacterSize, bsnSwitchingAgentStatsGroup=bsnSwitchingAgentStatsGroup, stats=stats, agentInterfaceIPGateway=agentInterfaceIPGateway, agentTransferUploadServerIP=agentTransferUploadServerIP, agentPortDefaultType=agentPortDefaultType, agentDhcpScopePoolEndAddress=agentDhcpScopePoolEndAddress, vlanRestoreFailureTrap=vlanRestoreFailureTrap, bsnSwitchingAgentInfoGroup=bsnSwitchingAgentInfoGroup, PYSNMP_MODULE_ID=bsnSwitching, stpInstanceNewRootTrap=stpInstanceNewRootTrap, agentInterfaceRowStatus=agentInterfaceRowStatus, agentSnmpV3UserStatus=agentSnmpV3UserStatus, agentTrapLogTable=agentTrapLogTable, agentDhcpScopeEntry=agentDhcpScopeEntry, agentNetworkAllowMgmtViaWireless=agentNetworkAllowMgmtViaWireless, agentInventoryFipsModeEnabled=agentInventoryFipsModeEnabled, agentSerialBaudrate=agentSerialBaudrate, agentTransferUploadPath=agentTransferUploadPath, agentSSHAllowNewMode=agentSSHAllowNewMode, agentSnmpV3UserName=agentSnmpV3UserName, bsnSwitchingAgentSystemGroup=bsnSwitchingAgentSystemGroup, agentSnmpTrapReceiverIPAddress=agentSnmpTrapReceiverIPAddress, agentDhcpScopeRowStatus=agentDhcpScopeRowStatus, agentTransferDownloadStatus=agentTransferDownloadStatus, bsnSwitchingCompliance=bsnSwitchingCompliance, agentSnmpCommunityAccessMode=agentSnmpCommunityAccessMode, agentSaveConfig=agentSaveConfig, agentSnmpV3UserEncryptionType=agentSnmpV3UserEncryptionType, agentWcpPortNumber=agentWcpPortNumber, agentNetworkWebAdminCertType=agentNetworkWebAdminCertType, agentInventoryProductName=agentInventoryProductName, portStatsEntry=portStatsEntry, agentSnmpLinkUpDownTrapFlag=agentSnmpLinkUpDownTrapFlag, linkFailureTrap=linkFailureTrap, agentLoginSessionIndex=agentLoginSessionIndex, stpInstanceTopologyChangeTrap=stpInstanceTopologyChangeTrap, agentTelnetMaxSessions=agentTelnetMaxSessions, agentSwitchInfoPowerSupply1Operational=agentSwitchInfoPowerSupply1Operational, agentWcpControllerInfoIpAddress=agentWcpControllerInfoIpAddress, agentInterfaceMacAddress=agentInterfaceMacAddress, switchingTraps=switchingTraps, agentDot3adAggPortEntry=agentDot3adAggPortEntry, agentNtpServerEntry=agentNtpServerEntry, portStatsPktsTx128to255Octets=portStatsPktsTx128to255Octets, agentTrapLogIndex=agentTrapLogIndex, agentNtpServerRowStatus=agentNtpServerRowStatus, agentInterfaceBackupPortNo=agentInterfaceBackupPortNo, agentSnmpTrapReceiverInetAddress=agentSnmpTrapReceiverInetAddress, agentServicePortConfigGroup=agentServicePortConfigGroup, agentPortPhysicalMode=agentPortPhysicalMode, agentSpanningTreeMode=agentSpanningTreeMode, agentLoginSessionUserName=agentLoginSessionUserName, agentSwitchAddressAgingTimeoutEntry=agentSwitchAddressAgingTimeoutEntry, agentSerialStopBits=agentSerialStopBits, agentTrapLogTrap=agentTrapLogTrap, agentNetworkWebAdminCertRegenerateCmdInvoke=agentNetworkWebAdminCertRegenerateCmdInvoke, agentSnmpCommunityEnabled=agentSnmpCommunityEnabled, broadcastStormStartTrap=broadcastStormStartTrap, agentLoginSessionStatus=agentLoginSessionStatus, agentSnmpTrapReceiverEnabled=agentSnmpTrapReceiverEnabled, agentWcpControllerInfoPortNumber=agentWcpControllerInfoPortNumber, agentDot3adAggPort=agentDot3adAggPort, agentPortPhysicalStatus=agentPortPhysicalStatus, agentLagSummaryLagIndex=agentLagSummaryLagIndex, agentTransferDownloadServerIP=agentTransferDownloadServerIP, broadcastStormEndTrap=broadcastStormEndTrap, agentSnmpCommunityStatus=agentSnmpCommunityStatus, agentNetworkGvrpStatus=agentNetworkGvrpStatus, agentPortGarpLeaveAllTime=agentPortGarpLeaveAllTime, agentLagConfigGroup=agentLagConfigGroup, agentSnmpTrapReceiverInetAddressType=agentSnmpTrapReceiverInetAddressType, agentLagSummaryStatus=agentLagSummaryStatus, agentNetworkPeerToPeerBlockingMode=agentNetworkPeerToPeerBlockingMode, agentLagDetailedLagIndex=agentLagDetailedLagIndex, agentDhcpScopeDefaultRouterAddress1=agentDhcpScopeDefaultRouterAddress1, agentTransferUploadFilename=agentTransferUploadFilename, multipleUsersTrap=multipleUsersTrap, agentPortSTPState=agentPortSTPState, agentClearConfig=agentClearConfig, agentServicePortSubnetMask=agentServicePortSubnetMask)
mibBuilder.exportSymbols("AIRESPACE-SWITCHING-MIB", agentInterfaceVlanQuarantine=agentInterfaceVlanQuarantine, agentDhcpScopeTable=agentDhcpScopeTable, agentPortPowerMode=agentPortPowerMode, agentSwitchInfoLwappTransportMode=agentSwitchInfoLwappTransportMode, agentInterfaceType=agentInterfaceType, agentWcpDeviceName=agentWcpDeviceName, agentSpanningTreeConfigGroup=agentSpanningTreeConfigGroup, agentDhcpScopeNetmask=agentDhcpScopeNetmask, agentInterfaceAPManagementFeature=agentInterfaceAPManagementFeature, agentNetworkRouteStatus=agentNetworkRouteStatus, agentPortSTPMode=agentPortSTPMode, agentSnmpCommunityInetAddress=agentSnmpCommunityInetAddress, agentClearLags=agentClearLags, agentSnmpTrapPortNumber=agentSnmpTrapPortNumber, agentLagDetailedConfigEntry=agentLagDetailedConfigEntry, agentPortMulticastApplianceMode=agentPortMulticastApplianceMode, agentResourceInfoGroup=agentResourceInfoGroup, agentPortDot1dBasePort=agentPortDot1dBasePort, agentLagSummaryPortsBitMask=agentLagSummaryPortsBitMask, powerSupplyStatusChangeTrap=powerSupplyStatusChangeTrap, agentServicePortIPAddress=agentServicePortIPAddress, agentApLoadProfileFailTrapCount=agentApLoadProfileFailTrapCount, agentDot3adAggPortTable=agentDot3adAggPortTable, agentNtpServerIndex=agentNtpServerIndex, agentSnmpV3UserAccessMode=agentSnmpV3UserAccessMode, agentNetworkSecureWebMode=agentNetworkSecureWebMode, vlanRequestFailureTrap=vlanRequestFailureTrap, agentInterfacePrimaryDhcpAddress=agentInterfacePrimaryDhcpAddress, agentPortGvrpStatus=agentPortGvrpStatus, agentLagConfigCreate=agentLagConfigCreate, agentSnmpCommunityInetAddressType=agentSnmpCommunityInetAddressType, agentLoginSessionConnectionType=agentLoginSessionConnectionType, agentDhcpScopeState=agentDhcpScopeState, agentRadioUpDownTrapCount=agentRadioUpDownTrapCount, agentWcpControllerInfoSlotNumber=agentWcpControllerInfoSlotNumber, agentNetworkRouteConfigEntry=agentNetworkRouteConfigEntry, agentServicePortDefaultGateway=agentServicePortDefaultGateway, agentLoginSessionTable=agentLoginSessionTable, agentSwitchAddressAgingTimeout=agentSwitchAddressAgingTimeout, agentWcpControllerInfoTable=agentWcpControllerInfoTable, agentClearPortStats=agentClearPortStats, agentApCoverageProfileFailTrapCount=agentApCoverageProfileFailTrapCount, agentLoginSessionEntry=agentLoginSessionEntry, agentPortGarpLeaveTime=agentPortGarpLeaveTime, agentSnmpTrapReceiverStatus=agentSnmpTrapReceiverStatus, agentSnmpV3ConfigGroup=agentSnmpV3ConfigGroup, agentCurrentCPUUtilization=agentCurrentCPUUtilization, productGroup5=productGroup5, agentSerialTimeout=agentSerialTimeout, agentWcpControllerTableChecksum=agentWcpControllerTableChecksum, agentTelnetConfigGroup=agentTelnetConfigGroup, agentPortConfigTable=agentPortConfigTable, portStatsPktsTx256to511Octets=portStatsPktsTx256to511Octets, agentSnmpCommunityConfigEntry=agentSnmpCommunityConfigEntry, agentDhcpScopeDnsServerAddress3=agentDhcpScopeDnsServerAddress3, agentLagSummaryConfigEntry=agentLagSummaryConfigEntry, portStatsPktsTx64Octets=portStatsPktsTx64Octets, agentApNoiseProfileFailTrapCount=agentApNoiseProfileFailTrapCount, agentWcpPeerPortNumber=agentWcpPeerPortNumber, agentInventoryIsForeignAPSupported=agentInventoryIsForeignAPSupported, agentSnmpVersion1Status=agentSnmpVersion1Status, agentSnmpTrapReceiverConfigEntry=agentSnmpTrapReceiverConfigEntry, agentDhcpConfigGroup=agentDhcpConfigGroup, agentTrapLogTotalSinceLastViewed=agentTrapLogTotalSinceLastViewed, agentNetworkMulticastGroupAddress=agentNetworkMulticastGroupAddress, agentInterfaceIPAddress=agentInterfaceIPAddress, productGroup3=productGroup3, agentClearTrapLog=agentClearTrapLog, agentPortIanaType=agentPortIanaType, agentSnmpConfigGroup=agentSnmpConfigGroup, agentNtpServerAddress=agentNtpServerAddress, agentLagDetailedIfIndex=agentLagDetailedIfIndex, agentSnmpTrapReceiverName=agentSnmpTrapReceiverName, agentSnmpCommunityIPAddress=agentSnmpCommunityIPAddress, agentTransferUploadMode=agentTransferUploadMode, agentTransferConfigurationFileEncryptionKey=agentTransferConfigurationFileEncryptionKey, agentPortAdminMode=agentPortAdminMode)
