...
rlDvmrpMibVersion=_RlDvmrpMibVersion_Object((1,3,6,1,4,1,4526,17,46,4,2),_RlDvmrpMibVersion_Type())
...
rlDvmrpEnable=_RlDvmrpEnable_Object((1,3,6,1,4,1,4526,17,46,4,3),_RlDvmrpEnable_Type())
...
rlDvmrpProbeInterval=_RlDvmrpProbeInterval_Object((1,3,6,1,4,1,4526,17,46,4,4),_RlDvmrpProbeInterval_Type())
...
rlDvmrpNeighborTimeOutInterval=_RlDvmrpNeighborTimeOutInterval_Object((1,3,6,1,4,1,4526,17,46,4,5),_RlDvmrpNeighborTimeOutInterval_Type())
...
rlDvmrpMinFlashUpdateInterval=_RlDvmrpMinFlashUpdateInterval_Object((1,3,6,1,4,1,4526,17,46,4,6),_RlDvmrpMinFlashUpdateInterval_Type())
...
rlDvmrpRouteReportInterval=_RlDvmrpRouteReportInterval_Object((1,3,6,1,4,1,4526,17,46,4,7),_RlDvmrpRouteReportInterval_Type())
...
rlDvmrpRouteExpirationTime=_RlDvmrpRouteExpirationTime_Object((1,3,6,1,4,1,4526,17,46,4,8),_RlDvmrpRouteExpirationTime_Type())
...
rlDvmrpPruneLifetime=_RlDvmrpPruneLifetime_Object((1,3,6,1,4,1,4526,17,46,4,9),_RlDvmrpPruneLifetime_Type())
...
rlDvmrpRouteDesignatedForwarderExtTable=_RlDvmrpRouteDesignatedForwarderExtTable_Object((1,3,6,1,4,1,4526,17,46,4,10))
...
rlDvmrpRouteDesignatedForwarderExtEntry=_RlDvmrpRouteDesignatedForwarderExtEntry_Object((1,3,6,1,4,1,4526,17,46,4,10,1))
...
rlDvmrpRouteDesignatedForwarder=_RlDvmrpRouteDesignatedForwarder_Object((1,3,6,1,4,1,4526,17,46,4,10,1,1),_RlDvmrpRouteDesignatedForwarder_Type())
...
rlDvmrpTableOverflow=NotificationType((1,3,6,1,4,1,4526,17,0,155))
