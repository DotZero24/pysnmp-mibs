...
# Notes
# -----
# ASN.1 source file://mibs/trendmicro/TPT-NGFW-USER-MIB
...
tptNgfwUserCompl.setObjects(
      *(("TPT-NGFW-USER-MIB", "tptNgfwUserGroup"),
        ("TPT-NGFW-USER-MIB", "tptNgfwUserNotificationGroup"))
)
if mibBuilder.loadTexts:
