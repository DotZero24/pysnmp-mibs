...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MAU-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:36 2025
...
cmExtMIBCompliance.setObjects(
    ("CISCO-MAU-EXT-MIB", "cmExtJackConfigGroup")
)
if mibBuilder.loadTexts:
...
cmExtMIBCompliance2.setObjects(
      *(("CISCO-MAU-EXT-MIB", "cmExtJackConfigGroup"),
        ("CISCO-MAU-EXT-MIB", "cmExtIfAutoMdixConfigGroup"))
)
if mibBuilder.loadTexts:
...
cmExtMIBCompliance3.setObjects(
      *(("CISCO-MAU-EXT-MIB", "cmExtJackConfigGroup"),
        ("CISCO-MAU-EXT-MIB", "cmExtIfAutoMdixConfigGroup"),
        ("CISCO-MAU-EXT-MIB", "cmExtIfMauTrafficGroup"))
)
if mibBuilder.loadTexts:
