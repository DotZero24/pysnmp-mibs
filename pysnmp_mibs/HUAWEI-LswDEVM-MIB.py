...
# Notes
# -----
# ASN.1 source file://mibs/h3c/HUAWEI-LswDEVM-MIB
...
hwDevMFanPosFrame = _HwDevMFanPosFrame_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 9, 1, 1, 1, 3),
    _HwDevMFanPosFrame_Type()
)
hwDevMFanPosFrame.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwDevMFanPosFrame.setStatus("current")
_HwDevMFanPosSlot_Type = Integer32
_HwDevMFanPosSlot_Object = MibTableColumn
hwDevMFanPosSlot = _HwDevMFanPosSlot_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 9, 1, 1, 1, 4),
    _HwDevMFanPosSlot_Type()
)
hwDevMFanPosSlot.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwDevMFanPosSlot.setStatus("current")
_HwDevMFanPosIndex_Type = Integer32
_HwDevMFanPosIndex_Object = MibTableColumn
hwDevMFanPosIndex = _HwDevMFanPosIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 9, 1, 1, 1, 5),
    _HwDevMFanPosIndex_Type()
)
hwDevMFanPosIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwDevMFanPosIndex.setStatus("current")
_HwDevMFanMaxSpeed_Type = Integer32
_HwDevMFanMaxSpeed_Object = MibTableColumn
hwDevMFanMaxSpeed = _HwDevMFanMaxSpeed_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 9, 1, 1, 1, 6),
    _HwDevMFanMaxSpeed_Type()
)
hwDevMFanMaxSpeed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwDevMFanMaxSpeed.setStatus("current")
_HwDevMFanCurrentSpeed_Type = Integer32
_HwDevMFanCurrentSpeed_Object = MibTableColumn
hwDevMFanCurrentSpeed = _HwDevMFanCurrentSpeed_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 9, 1, 1, 1, 7),
    _HwDevMFanCurrentSpeed_Type()
)
hwDevMFanCurrentSpeed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwDevMFanCurrentSpeed.setStatus("current")
...
hwDevMFirstTrapTime = _HwDevMFirstTrapTime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 9, 1, 13),
...
hwdevMExternalAlarmStatus = _HwdevMExternalAlarmStatus_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 9, 1, 14)
)
...
mibBuilder.exportSymbols(
    ...
    **{"hwLswdevMMib": hwLswdevMMib,
       ...
       "hwDevMFanPosFrame": hwDevMFanPosFrame,
       "hwDevMFanPosSlot": hwDevMFanPosSlot,
       "hwDevMFanPosIndex": hwDevMFanPosIndex,
       "hwDevMFanMaxSpeed": hwDevMFanMaxSpeed,
       "hwDevMFanCurrentSpeed": hwDevMFanCurrentSpeed,
       ...
       "hwdevMExternalAlarmStatus": hwdevMExternalAlarmStatus,
       "hwDevice": hwDevice,
