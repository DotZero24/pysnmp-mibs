# SNMP MIB module (ARICENT-DVMRP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-DVMRP-MIB
...
dvmrpInterfaceEntry = _DvmrpInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 60, 2, 9, 1)
)
dvmrpInterfaceEntry.setIndexNames(
    (0, "ARICENT-DVMRP-MIB", "dvmrpInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
dvmrpRouteNextHopEntry = _DvmrpRouteNextHopEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 60, 2, 12, 1)
)
dvmrpRouteNextHopEntry.setIndexNames(
    (0, "ARICENT-DVMRP-MIB", "dvmrpRouteNextHopSource"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpRouteNextHopSourceMask"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpRouteNextHopIfIndex"),
)
if mibBuilder.loadTexts:
...
dvmrpForwardPruneNbrEntry = _DvmrpForwardPruneNbrEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 60, 2, 14, 1)
)
dvmrpForwardPruneNbrEntry.setIndexNames(
    (0, "ARICENT-DVMRP-MIB", "dvmrpForwardSourceNetwork"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpForwardGroupAddress"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpForwardIfIndex"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpForwardPruneNeighbor"),
)
if mibBuilder.loadTexts:
...
dvmrpIpMRTable = _DvmrpIpMRTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 60, 2, 15)
)
if mibBuilder.loadTexts:
    dvmrpIpMRTable.setStatus("current")
_DvmrpIpMREntry_Object = MibTableRow
dvmrpIpMREntry = _DvmrpIpMREntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 60, 2, 15, 1)
)
dvmrpIpMREntry.setIndexNames(
    (0, "ARICENT-DVMRP-MIB", "dvmrpIpMRGroup"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpIpMRSource"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpIpMRSourceMask"),
)
if mibBuilder.loadTexts:
...
dvmrpIpMNextHopEntry = _DvmrpIpMNextHopEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 60, 2, 16, 1)
)
dvmrpIpMNextHopEntry.setIndexNames(
    (0, "ARICENT-DVMRP-MIB", "dvmrpIpMNextHopGroup"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpIpMNextHopSource"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpIpMNextHopSourceMask"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpIpMNextHopIfIndex"),
    (0, "ARICENT-DVMRP-MIB", "dvmrpIpMNextHopAddress"),
)
if mibBuilder.loadTexts:
...
dvmrpMIBConformance = _DvmrpMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 60, 3)
)
_DvmrpMIBCompliances_ObjectIdentity = ObjectIdentity
dvmrpMIBCompliances = _DvmrpMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 60, 3, 1)
)
_DvmrpMIBGroups_ObjectIdentity = ObjectIdentity
dvmrpMIBGroups = _DvmrpMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 60, 3, 2)
)

# Managed Objects groups

dvmrpGeneralGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2076, 60, 3, 2, 2)
)
dvmrpGeneralGroup.setObjects(
      *(("ARICENT-DVMRP-MIB", "dvmrpVersionString"),
        ("ARICENT-DVMRP-MIB", "dvmrpGenerationId"),
        ("ARICENT-DVMRP-MIB", "dvmrpNumRoutes"),
        ("ARICENT-DVMRP-MIB", "dvmrpReachableRoutes"))
)
if mibBuilder.loadTexts:
    dvmrpGeneralGroup.setStatus("current")

dvmrpInterfaceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2076, 60, 3, 2, 3)
)
dvmrpInterfaceGroup.setObjects(
      *(("ARICENT-DVMRP-MIB", "dvmrpInterfaceLocalAddress"),
        ("ARICENT-DVMRP-MIB", "dvmrpInterfaceMetric"),
        ("ARICENT-DVMRP-MIB", "dvmrpInterfaceRcvBadPkts"),
        ("ARICENT-DVMRP-MIB", "dvmrpInterfaceRcvBadRoutes"))
)
if mibBuilder.loadTexts:
    dvmrpInterfaceGroup.setStatus("current")

dvmrpNeighborGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2076, 60, 3, 2, 4)
)
dvmrpNeighborGroup.setObjects(
      *(("ARICENT-DVMRP-MIB", "dvmrpNeighborUpTime"),
        ("ARICENT-DVMRP-MIB", "dvmrpNeighborExpiryTime"),
        ("ARICENT-DVMRP-MIB", "dvmrpNeighborGenerationId"),
        ("ARICENT-DVMRP-MIB", "dvmrpNeighborMajorVersion"),
        ("ARICENT-DVMRP-MIB", "dvmrpNeighborMinorVersion"),
        ("ARICENT-DVMRP-MIB", "dvmrpNeighborCapabilities"),
        ("ARICENT-DVMRP-MIB", "dvmrpNeighborRcvRoutes"),
        ("ARICENT-DVMRP-MIB", "dvmrpNeighborRcvBadPkts"),
        ("ARICENT-DVMRP-MIB", "dvmrpNeighborRcvBadRoutes"))
)
if mibBuilder.loadTexts:
    dvmrpNeighborGroup.setStatus("current")

dvmrpRoutingGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2076, 60, 3, 2, 5)
)
dvmrpRoutingGroup.setObjects(
      *(("ARICENT-DVMRP-MIB", "dvmrpRouteUpstreamNeighbor"),
        ("ARICENT-DVMRP-MIB", "dvmrpRouteIfIndex"),
        ("ARICENT-DVMRP-MIB", "dvmrpRouteMetric"),
        ("ARICENT-DVMRP-MIB", "dvmrpRouteExpiryTime"),
        ("ARICENT-DVMRP-MIB", "dvmrpRouteUpTime"),
        ("ARICENT-DVMRP-MIB", "dvmrpRouteNextHopType"))
)
if mibBuilder.loadTexts:
...
dvmrpMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2076, 60, 3, 1, 1)
)
dvmrpMIBCompliance.setObjects(
      *(("ARICENT-DVMRP-MIB", "dvmrpGeneralGroup"),
        ("ARICENT-DVMRP-MIB", "dvmrpInterfaceGroup"),
        ("ARICENT-DVMRP-MIB", "dvmrpNeighborGroup"),
        ("ARICENT-DVMRP-MIB", "dvmrpRoutingGroup"))
)
if mibBuilder.loadTexts:
