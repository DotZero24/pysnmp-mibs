...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/dell/DNOS-ROUTING6-MIB
...
if mibBuilder.loadTexts: fastPathRoutingIpv6.setOrganization('Dell EMC')
...
agentIpv6InterfaceMtuValue = MibTableColumn((1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 30, 1, 2, 1, 2), Unsigned32().subtype(subtypeSpec=ConstraintsUnion(ValueRangeConstraint(0, 0), ValueRangeConstraint(1280, 9198), ))).setMaxAccess("readwrite")
