...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-DOMAIN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:26:22 2025
...
cucsDomainChassisFeatureTable = _CucsDomainChassisFeatureTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 18)
)
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureTable.setStatus("current")
_CucsDomainChassisFeatureEntry_Object = MibTableRow
cucsDomainChassisFeatureEntry = _CucsDomainChassisFeatureEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 18, 1)
)
cucsDomainChassisFeatureEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-DOMAIN-MIB", "cucsDomainChassisFeatureInstanceId"),
)
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureEntry.setStatus("current")
_CucsDomainChassisFeatureInstanceId_Type = CucsManagedObjectId
_CucsDomainChassisFeatureInstanceId_Object = MibTableColumn
cucsDomainChassisFeatureInstanceId = _CucsDomainChassisFeatureInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 18, 1, 1),
    _CucsDomainChassisFeatureInstanceId_Type()
)
cucsDomainChassisFeatureInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureInstanceId.setStatus("current")
_CucsDomainChassisFeatureDn_Type = CucsManagedObjectDn
_CucsDomainChassisFeatureDn_Object = MibTableColumn
cucsDomainChassisFeatureDn = _CucsDomainChassisFeatureDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 18, 1, 2),
    _CucsDomainChassisFeatureDn_Type()
)
cucsDomainChassisFeatureDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureDn.setStatus("current")
_CucsDomainChassisFeatureRn_Type = SnmpAdminString
_CucsDomainChassisFeatureRn_Object = MibTableColumn
cucsDomainChassisFeatureRn = _CucsDomainChassisFeatureRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 18, 1, 3),
    _CucsDomainChassisFeatureRn_Type()
)
cucsDomainChassisFeatureRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureRn.setStatus("current")
_CucsDomainChassisFeatureFltAggr_Type = Unsigned64
_CucsDomainChassisFeatureFltAggr_Object = MibTableColumn
cucsDomainChassisFeatureFltAggr = _CucsDomainChassisFeatureFltAggr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 18, 1, 4),
    _CucsDomainChassisFeatureFltAggr_Type()
)
cucsDomainChassisFeatureFltAggr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureFltAggr.setStatus("current")
...
cucsDomainChassisFeatureFunctionalState = _CucsDomainChassisFeatureFunctionalState_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 18, 1, 5),
    _CucsDomainChassisFeatureFunctionalState_Type()
)
cucsDomainChassisFeatureFunctionalState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureFunctionalState.setStatus("current")
_CucsDomainChassisFeatureName_Type = SnmpAdminString
_CucsDomainChassisFeatureName_Object = MibTableColumn
cucsDomainChassisFeatureName = _CucsDomainChassisFeatureName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 18, 1, 6),
    _CucsDomainChassisFeatureName_Type()
)
cucsDomainChassisFeatureName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureName.setStatus("current")
_CucsDomainChassisFeatureType_Type = CucsDomainFeatureType
_CucsDomainChassisFeatureType_Object = MibTableColumn
cucsDomainChassisFeatureType = _CucsDomainChassisFeatureType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 18, 1, 7),
    _CucsDomainChassisFeatureType_Type()
)
cucsDomainChassisFeatureType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureType.setStatus("current")
_CucsDomainChassisFeatureContTable_Object = MibTable
cucsDomainChassisFeatureContTable = _CucsDomainChassisFeatureContTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 19)
)
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureContTable.setStatus("current")
_CucsDomainChassisFeatureContEntry_Object = MibTableRow
cucsDomainChassisFeatureContEntry = _CucsDomainChassisFeatureContEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 19, 1)
)
cucsDomainChassisFeatureContEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-DOMAIN-MIB", "cucsDomainChassisFeatureContInstanceId"),
)
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureContEntry.setStatus("current")
...
cucsDomainChassisFeatureContInstanceId = _CucsDomainChassisFeatureContInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 19, 1, 1),
    _CucsDomainChassisFeatureContInstanceId_Type()
)
cucsDomainChassisFeatureContInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureContInstanceId.setStatus("current")
_CucsDomainChassisFeatureContDn_Type = CucsManagedObjectDn
_CucsDomainChassisFeatureContDn_Object = MibTableColumn
cucsDomainChassisFeatureContDn = _CucsDomainChassisFeatureContDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 19, 1, 2),
    _CucsDomainChassisFeatureContDn_Type()
)
cucsDomainChassisFeatureContDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureContDn.setStatus("current")
_CucsDomainChassisFeatureContRn_Type = SnmpAdminString
_CucsDomainChassisFeatureContRn_Object = MibTableColumn
cucsDomainChassisFeatureContRn = _CucsDomainChassisFeatureContRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 19, 1, 3),
    _CucsDomainChassisFeatureContRn_Type()
)
cucsDomainChassisFeatureContRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureContRn.setStatus("current")
_CucsDomainChassisFeatureContFltAggr_Type = Unsigned64
_CucsDomainChassisFeatureContFltAggr_Object = MibTableColumn
cucsDomainChassisFeatureContFltAggr = _CucsDomainChassisFeatureContFltAggr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 19, 1, 4),
    _CucsDomainChassisFeatureContFltAggr_Type()
)
cucsDomainChassisFeatureContFltAggr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisFeatureContFltAggr.setStatus("current")
_CucsDomainChassisParamTable_Object = MibTable
cucsDomainChassisParamTable = _CucsDomainChassisParamTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 20)
)
if mibBuilder.loadTexts:
    cucsDomainChassisParamTable.setStatus("current")
_CucsDomainChassisParamEntry_Object = MibTableRow
cucsDomainChassisParamEntry = _CucsDomainChassisParamEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 20, 1)
)
cucsDomainChassisParamEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-DOMAIN-MIB", "cucsDomainChassisParamInstanceId"),
)
if mibBuilder.loadTexts:
    cucsDomainChassisParamEntry.setStatus("current")
_CucsDomainChassisParamInstanceId_Type = CucsManagedObjectId
_CucsDomainChassisParamInstanceId_Object = MibTableColumn
cucsDomainChassisParamInstanceId = _CucsDomainChassisParamInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 20, 1, 1),
    _CucsDomainChassisParamInstanceId_Type()
)
cucsDomainChassisParamInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsDomainChassisParamInstanceId.setStatus("current")
_CucsDomainChassisParamDn_Type = CucsManagedObjectDn
_CucsDomainChassisParamDn_Object = MibTableColumn
cucsDomainChassisParamDn = _CucsDomainChassisParamDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 20, 1, 2),
    _CucsDomainChassisParamDn_Type()
)
cucsDomainChassisParamDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisParamDn.setStatus("current")
_CucsDomainChassisParamRn_Type = SnmpAdminString
_CucsDomainChassisParamRn_Object = MibTableColumn
cucsDomainChassisParamRn = _CucsDomainChassisParamRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 20, 1, 3),
    _CucsDomainChassisParamRn_Type()
)
cucsDomainChassisParamRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisParamRn.setStatus("current")
_CucsDomainChassisParamFltAggr_Type = Unsigned64
_CucsDomainChassisParamFltAggr_Object = MibTableColumn
cucsDomainChassisParamFltAggr = _CucsDomainChassisParamFltAggr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 20, 1, 4),
    _CucsDomainChassisParamFltAggr_Type()
)
cucsDomainChassisParamFltAggr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisParamFltAggr.setStatus("current")
_CucsDomainChassisParamName_Type = SnmpAdminString
_CucsDomainChassisParamName_Object = MibTableColumn
cucsDomainChassisParamName = _CucsDomainChassisParamName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 20, 1, 5),
    _CucsDomainChassisParamName_Type()
)
cucsDomainChassisParamName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisParamName.setStatus("current")
_CucsDomainChassisParamValue_Type = SnmpAdminString
_CucsDomainChassisParamValue_Object = MibTableColumn
cucsDomainChassisParamValue = _CucsDomainChassisParamValue_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 74, 20, 1, 6),
    _CucsDomainChassisParamValue_Type()
)
cucsDomainChassisParamValue.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsDomainChassisParamValue.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsDomainObjects": cucsDomainObjects,
       ...
       "cucsDomainChassisFeatureInstanceId": cucsDomainChassisFeatureInstanceId,
       "cucsDomainChassisFeatureDn": cucsDomainChassisFeatureDn,
       "cucsDomainChassisFeatureRn": cucsDomainChassisFeatureRn,
       "cucsDomainChassisFeatureFltAggr": cucsDomainChassisFeatureFltAggr,
       "cucsDomainChassisFeatureFunctionalState": cucsDomainChassisFeatureFunctionalState,
       "cucsDomainChassisFeatureName": cucsDomainChassisFeatureName,
       "cucsDomainChassisFeatureType": cucsDomainChassisFeatureType,
       "cucsDomainChassisFeatureContTable": cucsDomainChassisFeatureContTable,
       "cucsDomainChassisFeatureContEntry": cucsDomainChassisFeatureContEntry,
       "cucsDomainChassisFeatureContInstanceId": cucsDomainChassisFeatureContInstanceId,
       ...
       "cucsDomainChassisParamTable": cucsDomainChassisParamTable,
       "cucsDomainChassisParamEntry": cucsDomainChassisParamEntry,
       "cucsDomainChassisParamInstanceId": cucsDomainChassisParamInstanceId,
       "cucsDomainChassisParamDn": cucsDomainChassisParamDn,
       "cucsDomainChassisParamRn": cucsDomainChassisParamRn,
       "cucsDomainChassisParamFltAggr": cucsDomainChassisParamFltAggr,
       "cucsDomainChassisParamName": cucsDomainChassisParamName,
       "cucsDomainChassisParamValue": cucsDomainChassisParamValue}
)
