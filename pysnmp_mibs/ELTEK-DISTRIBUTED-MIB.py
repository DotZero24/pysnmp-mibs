...
_EltekDistributedPlantV8_ObjectIdentity = ObjectIdentity
eltekDistributedPlantV8 = _EltekDistributedPlantV8_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12148, 9)
)
...
mibBuilder.exportSymbols(
    ...
    **{"eltekDistributedPlantV8": eltekDistributedPlantV8,
