...
mibBuilder.exportSymbols("CISCO-SVC-INTERFACE-MIB", csiSessionInFCPUnderRuns=csiSessionInFCPUnderRuns, csiSwitchName=csiSwitchName, csiInterfaceStatsGroup=csiInterfaceStatsGroup, csiSessionInBLSFrames=csiSessionInBLSFrames, csiSessionOutFCPDataBytes=csiSessionOutFCPDataBytes, csiNodeName=csiNodeName, csiErrorText=csiErrorText, csiNportRowStatus=csiNportRowStatus, csiInterfaceNwwnEntry=csiInterfaceNwwnEntry, csiInterfaceStatsEntry=csiInterfaceStatsEntry, csiSessionInBadFc2Drops=csiSessionInBadFc2Drops, csiNportType=csiNportType, csiNportPwwn=csiNportPwwn, csiMIBTraps=csiMIBTraps, ciscoSvcInterfaceMIBObjects=ciscoSvcInterfaceMIBObjects, csiClusterName=csiClusterName, csiSessionOutFCPCmds=csiSessionOutFCPCmds, csiNportOutBytes=csiNportOutBytes, csiSessionPeerNwwn=csiSessionPeerNwwn, ciscoSvcMIBConformance=ciscoSvcMIBConformance, csiNportTable=csiNportTable, csiSessionIfIndex=csiSessionIfIndex, csiInterfaceOutBytesRate=csiInterfaceOutBytesRate, csiInterfaceInBytesRate=csiInterfaceInBytesRate, csiWarningTrap=csiWarningTrap, cSvcInterfaceConfiguration=cSvcInterfaceConfiguration, csiSessionInFCPXferRdys=csiSessionInFCPXferRdys, csiSessionOutFCPStatus=csiSessionOutFCPStatus, csiNportVsanId=csiNportVsanId, csiInterfaceOutFrames=csiInterfaceOutFrames, csiSessionInFCPCmds=csiSessionInFCPCmds, csiSessionPeerPwwn=csiSessionPeerPwwn, csiSessionInAborts=csiSessionInAborts, cSvcInterfaceTrapObjects=cSvcInterfaceTrapObjects, csiSessionType=csiSessionType, csiSessionOpenXchanges=csiSessionOpenXchanges, csiSessionInBadFcPDrops=csiSessionInBadFcPDrops, ciscoSvcMIBCompliance=ciscoSvcMIBCompliance, csiInterfaceNwwnTable=csiInterfaceNwwnTable, csiErrorTrap=csiErrorTrap, csiNportFcid=csiNportFcid, csiNportEntry=csiNportEntry, csiNportStatsEntry=csiNportStatsEntry, csiSessionId=csiSessionId, csiSessionStatsTable=csiSessionStatsTable, csiCardSerialNo=csiCardSerialNo, csiSessionInFCPOverRuns=csiSessionInFCPOverRuns, csiNportOutFrameRate=csiNportOutFrameRate, csiObjName=csiObjName, csiNportIfIndex=csiNportIfIndex, csiInterfaceOutFrameRate=csiInterfaceOutFrameRate, csiErrorId=csiErrorId, csiSessionNportPwwn=csiSessionNportPwwn, csiPortNumber=csiPortNumber, csiNportStatsTable=csiNportStatsTable, csiSessionOutFCPDataFrames=csiSessionOutFCPDataFrames, csiNportState=csiNportState, csiNportStatsGroup=csiNportStatsGroup, csiNportOutFrames=csiNportOutFrames, cefcMgmtNotificationsGroup=cefcMgmtNotificationsGroup, csiInformationTrap=csiInformationTrap, csiSessionInFCPDataFrames=csiSessionInFCPDataFrames, csiNportInBytes=csiNportInBytes, csiSessionTable=csiSessionTable, csiNportInFrameRate=csiNportInFrameRate, ciscoSvcMIBGroups=ciscoSvcMIBGroups, csiSessionOutFCPOverRuns=csiSessionOutFCPOverRuns, csiSessionInFCPDataBytes=csiSessionInFCPDataBytes, csiNportOutBytesRate=csiNportOutBytesRate, csiSwVersion=csiSwVersion, csiNportInBytesRate=csiNportInBytesRate, csiSessionOutAborts=csiSessionOutAborts, csiSessionGroup=csiSessionGroup, csiSessionStatsEntry=csiSessionStatsEntry, csiSessionOutFCPXferRdys=csiSessionOutFCPXferRdys, NportType=NportType, csiSessionStatsGroup=csiSessionStatsGroup, ciscoSvcInterfaceMIB=ciscoSvcInterfaceMIB, csiNportDownReason=csiNportDownReason, csiErrorSeqNumber=csiErrorSeqNumber, csiNotifObjectsGroup=csiNotifObjectsGroup, csiSessionOutFCPUnderRuns=csiSessionOutFCPUnderRuns, PYSNMP_MODULE_ID=ciscoSvcInterfaceMIB, csiSlotNumber=csiSlotNumber, csiNportInFrames=csiNportInFrames, csiInterfaceInFrames=csiInterfaceInFrames, csiNportSessions=csiNportSessions, csiNportGroup=csiNportGroup, csiInterfaceInBytes=csiInterfaceInBytes, ciscoSvcInterfaceMIBTrapPrefix=ciscoSvcInterfaceMIBTrapPrefix, csiSessionOutBLSFrames=csiSessionOutBLSFrames, csiMachineType=csiMachineType, csiInterfaceNwwnGroup=csiInterfaceNwwnGroup, csiInterfaceNwwn=csiInterfaceNwwn, csiSessionInFCPStatus=csiSessionInFCPStatus, ciscoSvcMIBCompliances=ciscoSvcMIBCompliances, csiSessionVsanId=csiSessionVsanId, csiSessionEntry=csiSessionEntry, csiSessionPeerFcid=csiSessionPeerFcid, csiSessionInELSFrames=csiSessionInELSFrames, csiSessionOutELSFrames=csiSessionOutELSFrames, csiInterfaceOutBytes=csiInterfaceOutBytes, csiInterfaceOperStateCause=csiInterfaceOperStateCause, csiInterfaceInFrameRate=csiInterfaceInFrameRate, csiInterfaceStatsTable=csiInterfaceStatsTable, csiSessionInFCPDataExcess=csiSessionInFCPDataExcess)
