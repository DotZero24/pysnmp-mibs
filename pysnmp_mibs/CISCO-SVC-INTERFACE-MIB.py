...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-SVC-INTERFACE-MIB
...
mibBuilder.exportSymbols("CISCO-SVC-INTERFACE-MIB", csiNportVsanId=csiNportVsanId, csiNportInFrames=csiNportInFrames, csiInterfaceNwwnGroup=csiInterfaceNwwnGroup, csiSessionStatsTable=csiSessionStatsTable, csiNodeName=csiNodeName, csiSessionOutFCPDataFrames=csiSessionOutFCPDataFrames, ciscoSvcMIBConformance=ciscoSvcMIBConformance, csiClusterName=csiClusterName, csiErrorId=csiErrorId, csiSessionPeerFcid=csiSessionPeerFcid, csiNportOutFrames=csiNportOutFrames, csiNportState=csiNportState, csiSessionOutFCPXferRdys=csiSessionOutFCPXferRdys, csiSessionId=csiSessionId, csiSessionInFCPDataExcess=csiSessionInFCPDataExcess, csiSessionInELSFrames=csiSessionInELSFrames, csiSessionInFCPStatus=csiSessionInFCPStatus, csiNportSessions=csiNportSessions, csiSessionType=csiSessionType, csiInterfaceInFrameRate=csiInterfaceInFrameRate, csiInterfaceOutBytes=csiInterfaceOutBytes, csiSessionIfIndex=csiSessionIfIndex, csiInterfaceInBytesRate=csiInterfaceInBytesRate, csiSessionOutBLSFrames=csiSessionOutBLSFrames, csiNportIfIndex=csiNportIfIndex, csiSessionVsanId=csiSessionVsanId, csiInterfaceStatsGroup=csiInterfaceStatsGroup, csiSessionInBLSFrames=csiSessionInBLSFrames, csiNportOutBytes=csiNportOutBytes, csiSessionInFCPXferRdys=csiSessionInFCPXferRdys, csiSessionInFCPOverRuns=csiSessionInFCPOverRuns, csiNportOutFrameRate=csiNportOutFrameRate, csiCardSerialNo=csiCardSerialNo, csiSessionEntry=csiSessionEntry, csiSessionOpenXchanges=csiSessionOpenXchanges, csiNportEntry=csiNportEntry, csiNportType=csiNportType, ciscoSvcMIBCompliances=ciscoSvcMIBCompliances, csiSessionInFCPUnderRuns=csiSessionInFCPUnderRuns, csiSessionOutFCPDataBytes=csiSessionOutFCPDataBytes, cSvcInterfaceConfiguration=cSvcInterfaceConfiguration, csiNportDownReason=csiNportDownReason, csiNportRowStatus=csiNportRowStatus, csiInterfaceOperStateCause=csiInterfaceOperStateCause, csiNportInFrameRate=csiNportInFrameRate, csiInterfaceNwwn=csiInterfaceNwwn, csiInterfaceStatsEntry=csiInterfaceStatsEntry, csiSessionInAborts=csiSessionInAborts, cefcMgmtNotificationsGroup=cefcMgmtNotificationsGroup, csiNportPwwn=csiNportPwwn, csiErrorText=csiErrorText, csiSwVersion=csiSwVersion, csiInterfaceNwwnTable=csiInterfaceNwwnTable, csiErrorTrap=csiErrorTrap, cSvcInterfaceTrapObjects=cSvcInterfaceTrapObjects, csiSessionInBadFc2Drops=csiSessionInBadFc2Drops, csiSessionInFCPDataFrames=csiSessionInFCPDataFrames, csiWarningTrap=csiWarningTrap, csiSessionStatsEntry=csiSessionStatsEntry, csiSessionPeerNwwn=csiSessionPeerNwwn, csiInterfaceOutFrameRate=csiInterfaceOutFrameRate, csiNportInBytesRate=csiNportInBytesRate, csiNportGroup=csiNportGroup, ciscoSvcInterfaceMIBObjects=ciscoSvcInterfaceMIBObjects, csiSessionOutFCPStatus=csiSessionOutFCPStatus, csiMIBTraps=csiMIBTraps, csiSessionOutFCPUnderRuns=csiSessionOutFCPUnderRuns, csiInterfaceOutFrames=csiInterfaceOutFrames, csiSessionPeerPwwn=csiSessionPeerPwwn, csiSlotNumber=csiSlotNumber, csiPortNumber=csiPortNumber, csiSessionOutAborts=csiSessionOutAborts, csiSessionOutFCPCmds=csiSessionOutFCPCmds, csiNportFcid=csiNportFcid, csiInterfaceNwwnEntry=csiInterfaceNwwnEntry, csiSessionInFCPCmds=csiSessionInFCPCmds, ciscoSvcMIBGroups=ciscoSvcMIBGroups, csiNportStatsTable=csiNportStatsTable, csiObjName=csiObjName, csiNportStatsGroup=csiNportStatsGroup, csiInterfaceInFrames=csiInterfaceInFrames, csiSessionNportPwwn=csiSessionNportPwwn, csiNportOutBytesRate=csiNportOutBytesRate, csiSessionStatsGroup=csiSessionStatsGroup, csiNportTable=csiNportTable, csiErrorSeqNumber=csiErrorSeqNumber, csiSessionInFCPDataBytes=csiSessionInFCPDataBytes, csiInterfaceStatsTable=csiInterfaceStatsTable, PYSNMP_MODULE_ID=ciscoSvcInterfaceMIB, NportType=NportType, csiNportInBytes=csiNportInBytes, csiMachineType=csiMachineType, csiNotifObjectsGroup=csiNotifObjectsGroup, csiInterfaceInBytes=csiInterfaceInBytes, ciscoSvcMIBCompliance=ciscoSvcMIBCompliance, csiSessionOutFCPOverRuns=csiSessionOutFCPOverRuns, ciscoSvcInterfaceMIB=ciscoSvcInterfaceMIB, ciscoSvcInterfaceMIBTrapPrefix=ciscoSvcInterfaceMIBTrapPrefix, csiSessionGroup=csiSessionGroup, csiSessionTable=csiSessionTable, csiSessionOutELSFrames=csiSessionOutELSFrames, csiSwitchName=csiSwitchName, csiInformationTrap=csiInformationTrap, csiSessionInBadFcPDrops=csiSessionInBadFcPDrops, csiNportStatsEntry=csiNportStatsEntry, csiInterfaceOutBytesRate=csiInterfaceOutBytesRate)
