...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SVC-INTERFACE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:22:33 2025
...
ciscoSvcMIBCompliance.setObjects(
      *(("CISCO-SVC-INTERFACE-MIB", "csiNportGroup"),
        ("CISCO-SVC-INTERFACE-MIB", "csiSessionGroup"),
        ("CISCO-SVC-INTERFACE-MIB", "csiInterfaceStatsGroup"),
        ("CISCO-SVC-INTERFACE-MIB", "csiNportStatsGroup"),
        ("CISCO-SVC-INTERFACE-MIB", "csiSessionStatsGroup"),
        ("CISCO-SVC-INTERFACE-MIB", "csiInterfaceNwwnGroup"),
        ("CISCO-SVC-INTERFACE-MIB", "csiNotifObjectsGroup"),
        ("CISCO-SVC-INTERFACE-MIB", "cefcMgmtNotificationsGroup"))
)
if mibBuilder.loadTexts:
