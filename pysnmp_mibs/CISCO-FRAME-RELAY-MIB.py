...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-FRAME-RELAY-MIB
...
frCircuitEntry, frDlcmiEntry, frCircuitDlci, frCircuitIfIndex = mibBuilder.importSymbols("RFC1315-MIB", "frCircuitEntry", "frDlcmiEntry", "frCircuitDlci", "frCircuitIfIndex")
...
mibBuilder.exportSymbols("CISCO-FRAME-RELAY-MIB", cfrConnSegment1Name=cfrConnSegment1Name, cfrExtCircuitMinThruputOut=cfrExtCircuitMinThruputOut, cfrFragEntry=cfrFragEntry, cfrFragNotOutPkts=cfrFragNotOutPkts, cfrFragOutOfSeqFragPkts=cfrFragOutOfSeqFragPkts, ciscoFrMIBConformance=ciscoFrMIBConformance, cfrLmiObjs=cfrLmiObjs, cfrSvcAddrRemote=cfrSvcAddrRemote, ciscoFrElmiMIBGroup1=ciscoFrElmiMIBGroup1, cfrExtCircuitIfName=cfrExtCircuitIfName, cfrElmiNeighborEntry=cfrElmiNeighborEntry, cfrExtCircuitBECNOuts=cfrExtCircuitBECNOuts, cfrExtCircuitTable=cfrExtCircuitTable, cfrMapTable=cfrMapTable, ciscoFrMIBGroup=ciscoFrMIBGroup, cfrLmiEnquiryOuts=cfrLmiEnquiryOuts, cfrSvcEntry=cfrSvcEntry, ciscoFrMIBCompliancesRev1=ciscoFrMIBCompliancesRev1, cfrLmiStatusIns=cfrLmiStatusIns, cfrSvcMinThruputOut=cfrSvcMinThruputOut, cfrConnName=cfrConnName, ciscoFrMIBCompliancesRev3=ciscoFrMIBCompliancesRev3, cfrElmiNeighborVendorName=cfrElmiNeighborVendorName, cfrExtCircuitShapePkts=cfrExtCircuitShapePkts, ciscoFrCircuitMIBGroup=ciscoFrCircuitMIBGroup, cfrFragPreOutOctets=cfrFragPreOutOctets, ciscoFrSvcMIBGroup=ciscoFrSvcMIBGroup, cfrExtCircuitShapeByteIncrement=cfrExtCircuitShapeByteIncrement, cfrLmiTable=cfrLmiTable, ciscoFrMIBGroups=ciscoFrMIBGroups, ciscoExtCircuitMIBGroup=ciscoExtCircuitMIBGroup, cfrLmiStatusEnqTimeouts=cfrLmiStatusEnqTimeouts, cfrLmiEntry=cfrLmiEntry, cfrConnSegment2Vci=cfrConnSegment2Vci, cfrFragObjs=cfrFragObjs, cfrLmiN392Dce=cfrLmiN392Dce, cfrLmiEnquiryIns=cfrLmiEnquiryIns, cfrConnDeBit=cfrConnDeBit, cfrExtCircuitShapeByteLimit=cfrExtCircuitShapeByteLimit, cfrLmiStatusOuts=cfrLmiStatusOuts, cfrCircuitDEins=cfrCircuitDEins, cfrExtCircuitMinThruputIn=cfrExtCircuitMinThruputIn, ciscoFrFragMIBGroup=ciscoFrFragMIBGroup, cfrMapObjs=cfrMapObjs, cfrExtCircuitUncompressOuts=cfrExtCircuitUncompressOuts, cfrSvcObjs=cfrSvcObjs, cfrSvcTable=cfrSvcTable, cfrExtCircuitCreateType=cfrExtCircuitCreateType, cfrConnSegment1Dlci=cfrConnSegment1Dlci, ciscoFrMIBCompliance=ciscoFrMIBCompliance, cfrExtCircuitShapeBytes=cfrExtCircuitShapeBytes, cfrMapEntry=cfrMapEntry, cfrMapProtocol=cfrMapProtocol, cfrConnServiceTranslation=cfrConnServiceTranslation, cfrFragNotInPkts=cfrFragNotInPkts, cfrElmiNeighborIpAddress=cfrElmiNeighborIpAddress, cfrFragSeqMissedPkts=cfrFragSeqMissedPkts, cfrExtCircuitMulticast=cfrExtCircuitMulticast, cfrLmiUpdateStatusIns=cfrLmiUpdateStatusIns, cfrSvcIdleTime=cfrSvcIdleTime, cfrFragDroppedReAssembledInPkts=cfrFragDroppedReAssembledInPkts, cfrElmiNeighborArStatus=cfrElmiNeighborArStatus, cfrExtCircuitBcastByteOuts=cfrExtCircuitBcastByteOuts, cfrExtCircuitRcvDataRate=cfrExtCircuitRcvDataRate, cfrConnFrSscsDlci=cfrConnFrSscsDlci, cfrConnectionEntry=cfrConnectionEntry, ciscoFrMIBCompliancesRev4=ciscoFrMIBCompliancesRev4, CfrMapProtocols=CfrMapProtocols, cfrLmiT392Dce=cfrLmiT392Dce, ciscoFrConnMIBGroup=ciscoFrConnMIBGroup, cfrExtCircuitShapePktsDelay=cfrExtCircuitShapePktsDelay, cfrCircuitTable=cfrCircuitTable, cfrExtCircuitMapStatus=cfrExtCircuitMapStatus, ciscoFrMIBGroupRev1=ciscoFrMIBGroupRev1, PYSNMP_MODULE_ID=ciscoFrameRelayMIB, DlciNumber=DlciNumber, cfrFragUnexpectedBBitSetPkts=cfrFragUnexpectedBBitSetPkts, cfrLmiLinkstatus=cfrLmiLinkstatus, cfrConnSegment2Vpi=cfrConnSegment2Vpi, cfrSvcCommitBurstIn=cfrSvcCommitBurstIn, cfrCircuitDropPktsOuts=cfrCircuitDropPktsOuts, cfrElmiNeighborIfIndex=cfrElmiNeighborIfIndex, ciscoFrMapMIBGroup=ciscoFrMapMIBGroup, cfrExtCircuitShapeBytesDelay=cfrExtCircuitShapeBytesDelay, cfrMapEncaps=cfrMapEncaps, cfrLmiUpdateStatusOuts=cfrLmiUpdateStatusOuts, ciscoFrMIBCompliancesRev2=ciscoFrMIBCompliancesRev2, cfrExtCircuitTxPktRate=cfrExtCircuitTxPktRate, cfrElmiTable=cfrElmiTable, cfrExtCircuitShapeAdapting=cfrExtCircuitShapeAdapting, cfrFragPreOutPkts=cfrFragPreOutPkts, cfrElmiObjs=cfrElmiObjs, cfrMapTcpHdrCompress=cfrMapTcpHdrCompress, cfrExtCircuitRcvPktRate=cfrExtCircuitRcvPktRate, cfrConnectionObjs=cfrConnectionObjs, ciscoFrTsMIBGroup=ciscoFrTsMIBGroup, cfrCircuitObjs=cfrCircuitObjs, cfrMapIndex=cfrMapIndex, cfrMapBroadcast=cfrMapBroadcast, cfrElmiRemoteStatus=cfrElmiRemoteStatus, cfrFragAssembledInPkts=cfrFragAssembledInPkts, cfrFragAssembledInOctets=cfrFragAssembledInOctets, cfrExtCircuitEntry=cfrExtCircuitEntry, ciscoExtCircuitMIBGroup1=ciscoExtCircuitMIBGroup1, cfrFragOutOctets=cfrFragOutOctets, cfrExtCircuitUncompressIns=cfrExtCircuitUncompressIns, cfrExtCircuitTxDataRate=cfrExtCircuitTxDataRate, cfrConnState=cfrConnState, cfrConnClpBit=cfrConnClpBit, cfrLmiN393Dce=cfrLmiN393Dce, cfrExtCircuitFECNOuts=cfrExtCircuitFECNOuts, cfrFragDroppedFragmentedOutPkts=cfrFragDroppedFragmentedOutPkts, ciscoFrMIBObjects=ciscoFrMIBObjects, cfrMapPayloadCompress=cfrMapPayloadCompress, cfrFragTimeoutsIn=cfrFragTimeoutsIn, cfrSvcAddrLocal=cfrSvcAddrLocal, cfrConnSegment2Name=cfrConnSegment2Name, cfrElmiIpAddr=cfrElmiIpAddr, cfrMapRtpHdrCompress=cfrMapRtpHdrCompress, cfrExtCircuitRoutedDlci=cfrExtCircuitRoutedDlci, cfrConnEfciBit=cfrConnEfciBit, ciscoFrMIBCompliances=ciscoFrMIBCompliances, ciscoFrameRelayMIB=ciscoFrameRelayMIB, cfrElmiLinkStatus=cfrElmiLinkStatus, cfrSvcExcessBurstIn=cfrSvcExcessBurstIn, cfrExtCircuitRoutedIf=cfrExtCircuitRoutedIf, cfrExtCircuitBandwidth=cfrExtCircuitBandwidth, cfrFragInOctets=cfrFragInOctets, cfrExtCircuitShapeInterval=cfrExtCircuitShapeInterval, cfrMapAddress=cfrMapAddress, cfrCircuitEntry=cfrCircuitEntry, cfrElmiArStatus=cfrElmiArStatus, cfrElmiNeighborDeviceName=cfrElmiNeighborDeviceName, cfrExtCircuitSubifIndex=cfrExtCircuitSubifIndex, cfrSvcThroughputIn=cfrSvcThroughputIn, cfrMapType=cfrMapType, cfrMapPayloadCompressType=cfrMapPayloadCompressType, cfrFragTable=cfrFragTable, cfrFragInPkts=cfrFragInPkts, cfrLmiLinkType=cfrLmiLinkType, cfrElmiNeighborTable=cfrElmiNeighborTable, cfrElmiNeighborPlatformName=cfrElmiNeighborPlatformName, cfrConnID=cfrConnID, cfrLmiStatusTimeouts=cfrLmiStatusTimeouts, cfrCircuitType=cfrCircuitType, cfrFragOutPkts=cfrFragOutPkts, cfrConnectionTable=cfrConnectionTable, cfrExtCircuitIfType=cfrExtCircuitIfType, cfrFragNotInOctets=cfrFragNotInOctets, ciscoFrLmiMIBGroup=ciscoFrLmiMIBGroup, cfrExtCircuitBcastPktOuts=cfrExtCircuitBcastPktOuts, cfrFragInterleavedOutPkts=cfrFragInterleavedOutPkts, cfrFragSize=cfrFragSize, cfrElmiEntry=cfrElmiEntry, cfrExtCircuitShapeActive=cfrExtCircuitShapeActive, ciscoFrElmiMIBGroup=ciscoFrElmiMIBGroup, cfrFragType=cfrFragType, cfrConnSegment1VCGroup=cfrConnSegment1VCGroup, cfrFragNotOutOctets=cfrFragNotOutOctets, cfrCircuitDEouts=cfrCircuitDEouts, cfrSvcMinThruputIn=cfrSvcMinThruputIn)
