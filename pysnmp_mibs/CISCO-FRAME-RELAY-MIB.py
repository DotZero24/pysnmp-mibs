...
mibBuilder.exportSymbols("CISCO-FRAME-RELAY-MIB", cfrExtCircuitRoutedIf=cfrExtCircuitRoutedIf, cfrConnServiceTranslation=cfrConnServiceTranslation, cfrConnSegment2Vci=cfrConnSegment2Vci, cfrLmiEnquiryIns=cfrLmiEnquiryIns, cfrMapAddress=cfrMapAddress, cfrLmiUpdateStatusOuts=cfrLmiUpdateStatusOuts, cfrSvcObjs=cfrSvcObjs, cfrElmiObjs=cfrElmiObjs, cfrExtCircuitBcastByteOuts=cfrExtCircuitBcastByteOuts, ciscoFrCircuitMIBGroup=ciscoFrCircuitMIBGroup, cfrFragPreOutPkts=cfrFragPreOutPkts, cfrExtCircuitUncompressIns=cfrExtCircuitUncompressIns, cfrCircuitEntry=cfrCircuitEntry, cfrElmiTable=cfrElmiTable, cfrFragAssembledInPkts=cfrFragAssembledInPkts, cfrMapTable=cfrMapTable, cfrFragOutOfSeqFragPkts=cfrFragOutOfSeqFragPkts, cfrMapRtpHdrCompress=cfrMapRtpHdrCompress, ciscoFrFragMIBGroup=ciscoFrFragMIBGroup, cfrLmiLinkstatus=cfrLmiLinkstatus, cfrCircuitType=cfrCircuitType, cfrExtCircuitTable=cfrExtCircuitTable, cfrLmiStatusOuts=cfrLmiStatusOuts, cfrExtCircuitShapeByteLimit=cfrExtCircuitShapeByteLimit, ciscoFrElmiMIBGroup=ciscoFrElmiMIBGroup, cfrExtCircuitMulticast=cfrExtCircuitMulticast, cfrFragOutPkts=cfrFragOutPkts, cfrElmiNeighborPlatformName=cfrElmiNeighborPlatformName, cfrElmiNeighborEntry=cfrElmiNeighborEntry, cfrCircuitDEins=cfrCircuitDEins, cfrFragAssembledInOctets=cfrFragAssembledInOctets, cfrExtCircuitTxPktRate=cfrExtCircuitTxPktRate, cfrCircuitTable=cfrCircuitTable, ciscoFrMIBGroupRev1=ciscoFrMIBGroupRev1, ciscoFrMIBCompliancesRev1=ciscoFrMIBCompliancesRev1, ciscoFrTsMIBGroup=ciscoFrTsMIBGroup, cfrFragType=cfrFragType, cfrLmiN393Dce=cfrLmiN393Dce, PYSNMP_MODULE_ID=ciscoFrameRelayMIB, cfrMapTcpHdrCompress=cfrMapTcpHdrCompress, CfrMapProtocols=CfrMapProtocols, cfrConnectionTable=cfrConnectionTable, cfrExtCircuitBandwidth=cfrExtCircuitBandwidth, cfrExtCircuitBcastPktOuts=cfrExtCircuitBcastPktOuts, cfrSvcMinThruputIn=cfrSvcMinThruputIn, cfrExtCircuitShapeBytes=cfrExtCircuitShapeBytes, cfrExtCircuitShapePktsDelay=cfrExtCircuitShapePktsDelay, ciscoFrMIBCompliances=ciscoFrMIBCompliances, cfrElmiIpAddr=cfrElmiIpAddr, ciscoFrSvcMIBGroup=ciscoFrSvcMIBGroup, ciscoExtCircuitMIBGroup=ciscoExtCircuitMIBGroup, cfrMapProtocol=cfrMapProtocol, cfrFragEntry=cfrFragEntry, cfrLmiStatusTimeouts=cfrLmiStatusTimeouts, ciscoFrLmiMIBGroup=ciscoFrLmiMIBGroup, cfrFragObjs=cfrFragObjs, cfrLmiEntry=cfrLmiEntry, cfrFragInOctets=cfrFragInOctets, cfrElmiNeighborIpAddress=cfrElmiNeighborIpAddress, cfrExtCircuitFECNOuts=cfrExtCircuitFECNOuts, ciscoFrMIBGroup=ciscoFrMIBGroup, cfrExtCircuitIfType=cfrExtCircuitIfType, cfrMapPayloadCompress=cfrMapPayloadCompress, cfrCircuitObjs=cfrCircuitObjs, cfrLmiEnquiryOuts=cfrLmiEnquiryOuts, cfrExtCircuitUncompressOuts=cfrExtCircuitUncompressOuts, cfrMapEncaps=cfrMapEncaps, cfrLmiLinkType=cfrLmiLinkType, cfrLmiObjs=cfrLmiObjs, cfrFragTable=cfrFragTable, cfrLmiStatusIns=cfrLmiStatusIns, cfrElmiNeighborTable=cfrElmiNeighborTable, cfrCircuitDEouts=cfrCircuitDEouts, cfrExtCircuitSubifIndex=cfrExtCircuitSubifIndex, cfrLmiTable=cfrLmiTable, cfrFragTimeoutsIn=cfrFragTimeoutsIn, cfrElmiLinkStatus=cfrElmiLinkStatus, cfrFragDroppedReAssembledInPkts=cfrFragDroppedReAssembledInPkts, cfrConnectionObjs=cfrConnectionObjs, cfrExtCircuitShapeByteIncrement=cfrExtCircuitShapeByteIncrement, cfrExtCircuitBECNOuts=cfrExtCircuitBECNOuts, cfrElmiArStatus=cfrElmiArStatus, cfrMapEntry=cfrMapEntry, cfrSvcIdleTime=cfrSvcIdleTime, cfrConnSegment2Name=cfrConnSegment2Name, cfrExtCircuitTxDataRate=cfrExtCircuitTxDataRate, cfrSvcThroughputIn=cfrSvcThroughputIn, cfrElmiRemoteStatus=cfrElmiRemoteStatus, cfrExtCircuitEntry=cfrExtCircuitEntry, cfrMapType=cfrMapType, cfrElmiNeighborArStatus=cfrElmiNeighborArStatus, cfrExtCircuitShapeInterval=cfrExtCircuitShapeInterval, cfrExtCircuitCreateType=cfrExtCircuitCreateType, cfrFragInterleavedOutPkts=cfrFragInterleavedOutPkts, cfrFragInPkts=cfrFragInPkts, ciscoExtCircuitMIBGroup1=ciscoExtCircuitMIBGroup1, cfrExtCircuitMinThruputIn=cfrExtCircuitMinThruputIn, cfrLmiT392Dce=cfrLmiT392Dce, cfrConnClpBit=cfrConnClpBit, cfrFragPreOutOctets=cfrFragPreOutOctets, cfrExtCircuitShapeAdapting=cfrExtCircuitShapeAdapting, cfrExtCircuitIfName=cfrExtCircuitIfName, cfrElmiEntry=cfrElmiEntry, cfrFragSize=cfrFragSize, cfrConnEfciBit=cfrConnEfciBit, cfrConnectionEntry=cfrConnectionEntry, cfrFragUnexpectedBBitSetPkts=cfrFragUnexpectedBBitSetPkts, cfrConnDeBit=cfrConnDeBit, cfrSvcAddrLocal=cfrSvcAddrLocal, cfrExtCircuitRcvPktRate=cfrExtCircuitRcvPktRate, cfrFragNotOutPkts=cfrFragNotOutPkts, cfrSvcExcessBurstIn=cfrSvcExcessBurstIn, cfrConnSegment2Vpi=cfrConnSegment2Vpi, cfrSvcCommitBurstIn=cfrSvcCommitBurstIn, cfrConnName=cfrConnName, cfrExtCircuitShapeBytesDelay=cfrExtCircuitShapeBytesDelay, cfrExtCircuitShapePkts=cfrExtCircuitShapePkts, cfrElmiNeighborDeviceName=cfrElmiNeighborDeviceName, ciscoFrMIBObjects=ciscoFrMIBObjects, DlciNumber=DlciNumber, cfrCircuitDropPktsOuts=cfrCircuitDropPktsOuts, cfrMapIndex=cfrMapIndex, cfrFragOutOctets=cfrFragOutOctets, cfrMapPayloadCompressType=cfrMapPayloadCompressType, cfrElmiNeighborIfIndex=cfrElmiNeighborIfIndex, cfrExtCircuitMinThruputOut=cfrExtCircuitMinThruputOut, cfrConnState=cfrConnState, ciscoFrElmiMIBGroup1=ciscoFrElmiMIBGroup1, ciscoFrConnMIBGroup=ciscoFrConnMIBGroup, cfrExtCircuitShapeActive=cfrExtCircuitShapeActive, ciscoFrMIBCompliance=ciscoFrMIBCompliance, ciscoFrMIBCompliancesRev2=ciscoFrMIBCompliancesRev2, cfrMapObjs=cfrMapObjs, cfrExtCircuitMapStatus=cfrExtCircuitMapStatus, cfrSvcTable=cfrSvcTable, ciscoFrMapMIBGroup=ciscoFrMapMIBGroup, cfrExtCircuitRcvDataRate=cfrExtCircuitRcvDataRate, ciscoFrameRelayMIB=ciscoFrameRelayMIB, cfrFragNotInPkts=cfrFragNotInPkts, cfrMapBroadcast=cfrMapBroadcast, cfrSvcMinThruputOut=cfrSvcMinThruputOut, ciscoFrMIBConformance=ciscoFrMIBConformance, ciscoFrMIBCompliancesRev3=ciscoFrMIBCompliancesRev3, ciscoFrMIBCompliancesRev4=ciscoFrMIBCompliancesRev4, cfrLmiUpdateStatusIns=cfrLmiUpdateStatusIns, cfrFragSeqMissedPkts=cfrFragSeqMissedPkts, cfrFragDroppedFragmentedOutPkts=cfrFragDroppedFragmentedOutPkts, cfrConnSegment1Name=cfrConnSegment1Name, cfrLmiN392Dce=cfrLmiN392Dce, ciscoFrMIBGroups=ciscoFrMIBGroups, cfrConnFrSscsDlci=cfrConnFrSscsDlci, cfrSvcEntry=cfrSvcEntry, cfrConnSegment1VCGroup=cfrConnSegment1VCGroup, cfrElmiNeighborVendorName=cfrElmiNeighborVendorName, cfrSvcAddrRemote=cfrSvcAddrRemote, cfrFragNotOutOctets=cfrFragNotOutOctets, cfrExtCircuitRoutedDlci=cfrExtCircuitRoutedDlci, cfrConnSegment1Dlci=cfrConnSegment1Dlci, cfrFragNotInOctets=cfrFragNotInOctets, cfrLmiStatusEnqTimeouts=cfrLmiStatusEnqTimeouts, cfrConnID=cfrConnID)
