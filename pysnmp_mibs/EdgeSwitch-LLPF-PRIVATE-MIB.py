# SNMP MIB module (EdgeSwitch-LLPF-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ubiquiti/EdgeSwitch-LLPF-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:59:17 2025
...
agentSwitchLlpfPortConfigEntry = _AgentSwitchLlpfPortConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 48, 1, 1, 1)
)
agentSwitchLlpfPortConfigEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "EdgeSwitch-LLPF-PRIVATE-MIB", "agentSwitchLlpfProtocolType"),
)
if mibBuilder.loadTexts:
...
agentSwitchLlpfProtocolType = _AgentSwitchLlpfProtocolType_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 48, 1, 1, 1, 1),
