...
mibBuilder.exportSymbols("CPQIODRV-MIB", cpqIoDrvInfoReducedWriteReason=cpqIoDrvInfoReducedWriteReason, cpqIoDrvInfoNonWritableIndicator=cpqIoDrvInfoNonWritableIndicator, cpqIoDrvExtnConfidenceInterval=cpqIoDrvExtnConfidenceInterval, cpqIoDrvExtnLongTermEndDate=cpqIoDrvExtnLongTermEndDate, cpqIoDrvInfoFlashbackIndicator=cpqIoDrvInfoFlashbackIndicator, cpqIoDrvMibRevMajor=cpqIoDrvMibRevMajor, cpqIoDrvNonWritableTrap=cpqIoDrvNonWritableTrap, cpqIoDrvExtnUsablePhysicalCapacityU=cpqIoDrvExtnUsablePhysicalCapacityU, cpqIoDrvExtnBytesReadU=cpqIoDrvExtnBytesReadU, cpqIoDrvCapacityEntry=cpqIoDrvCapacityEntry, cpqIoDrvInfoUID=cpqIoDrvInfoUID, cpqIoDrvWearoutTrap=cpqIoDrvWearoutTrap, cpqIoDrvInfoPCISubdeviceID=cpqIoDrvInfoPCISubdeviceID, cpqIoDrvMibRev=cpqIoDrvMibRev, cpqIoDrvProcTable=cpqIoDrvProcTable, cpqIoDrvInfoSparesPartNumber=cpqIoDrvInfoSparesPartNumber, cpqIoDrvInfoPowerlossProtectDisabled=cpqIoDrvInfoPowerlossProtectDisabled, cpqIoDrvInfoFirmwareVersion=cpqIoDrvInfoFirmwareVersion, cpqIoDrvInfoPCISlot=cpqIoDrvInfoPCISlot, cpqIoDrvWriteInfoIndex=cpqIoDrvWriteInfoIndex, cpqIoDrvInfoPCIAddress=cpqIoDrvInfoPCIAddress, cpqIoDrvInfoMilliVolts=cpqIoDrvInfoMilliVolts, cpqIoDrvExtnIndex=cpqIoDrvExtnIndex, cpqIoDrvExtnPhysicalBytesWrittenL=cpqIoDrvExtnPhysicalBytesWrittenL, cpqIoDrvExtnLongTermStartDate=cpqIoDrvExtnLongTermStartDate, cpqIoDrvComponent=cpqIoDrvComponent, cpqIoDrvInfoSubVendorPartNumber=cpqIoDrvInfoSubVendorPartNumber, cpqIoDrvErrorTrap=cpqIoDrvErrorTrap, cpqIoDrvTempOkTrap=cpqIoDrvTempOkTrap, cpqIoDrvInfoLifespanGoverningTgtDate=cpqIoDrvInfoLifespanGoverningTgtDate, cpqIoDrvExtnShortTermEndDate=cpqIoDrvExtnShortTermEndDate, cpqIoDrvExtnTotalLogicalCapacityU=cpqIoDrvExtnTotalLogicalCapacityU, cpqIoDrvExtnLongTermAvgU=cpqIoDrvExtnLongTermAvgU, cpqIoDrvInfoInternalTempHigh=cpqIoDrvInfoInternalTempHigh, cpqIoDrvInfoActualGoverningLevel=cpqIoDrvInfoActualGoverningLevel, cpqIoDrvTemp=cpqIoDrvTemp, cpqIoDrvExtnLongTermWindow=cpqIoDrvExtnLongTermWindow, cpqIoDrvProcEntry=cpqIoDrvProcEntry, cpqIoDrvInfoTable=cpqIoDrvInfoTable, cpqIoDrvTempTable=cpqIoDrvTempTable, cpqIoDrvWriteValueU=cpqIoDrvWriteValueU, cpqIoDrvInfoSerialNumber=cpqIoDrvInfoSerialNumber, cpqIoDrvInfoPCIBandwidthCompatibility=cpqIoDrvInfoPCIBandwidthCompatibility, cpqIoDrvInfoLongTermNonWritableDate=cpqIoDrvInfoLongTermNonWritableDate, cpqIoDrvInfoClientDeviceName=cpqIoDrvInfoClientDeviceName, cpqIoDrvCapacityValueL=cpqIoDrvCapacityValueL, cpqIoDrvInfoMilliVoltsMin=cpqIoDrvInfoMilliVoltsMin, cpqIoDrvCapacityValueU=cpqIoDrvCapacityValueU, cpqIoDrvInfoPowerGoverningLevel=cpqIoDrvInfoPowerGoverningLevel, cpqIoDrvInfoPCISubvendorID=cpqIoDrvInfoPCISubvendorID, cpqIoDrvWriteIndex=cpqIoDrvWriteIndex, cpqIoDrvCapacityIndex=cpqIoDrvCapacityIndex, cpqIoDrvCapacityInfoIndex=cpqIoDrvCapacityInfoIndex, cpqIoDrvExtnTotalLogicalCapacityL=cpqIoDrvExtnTotalLogicalCapacityL, cpqIoDrvProc=cpqIoDrvProc, cpqIoDrvExtnCurrentRAMUsageL=cpqIoDrvExtnCurrentRAMUsageL, cpqIoDrvInfoName=cpqIoDrvInfoName, cpqIoDrvExtnPhysicalBytesWrittenU=cpqIoDrvExtnPhysicalBytesWrittenU, cpqIoDrvExtnBytesReadL=cpqIoDrvExtnBytesReadL, cpqIoDrvInfoLongTermWearoutDate=cpqIoDrvInfoLongTermWearoutDate, cpqIoDrvInfoEntry=cpqIoDrvInfoEntry, cpqIoDrvCapacityTimestamp=cpqIoDrvCapacityTimestamp, cpqIoDrvTempValue=cpqIoDrvTempValue, cpqIoDrvTempHighTrap=cpqIoDrvTempHighTrap, cpqIoDrvWriteValueL=cpqIoDrvWriteValueL, cpqIoDrvInfoMilliAmps=cpqIoDrvInfoMilliAmps, cpqIoDrvInfoShortTermWearoutDate=cpqIoDrvInfoShortTermWearoutDate, cpqIoDrvExtnShortTermAvgL=cpqIoDrvExtnShortTermAvgL, cpqIoDrvProcIndex=cpqIoDrvProcIndex, cpqIoDrvExtnPeakRAMUsageL=cpqIoDrvExtnPeakRAMUsageL, cpqIoDrvInfoState=cpqIoDrvInfoState, cpqIoDrvInfoAdapterPort=cpqIoDrvInfoAdapterPort, cpqIoDrvInfoLifespanGoverningEnabled=cpqIoDrvInfoLifespanGoverningEnabled, cpqIoDrvExtnWriteRateAutoCalc=cpqIoDrvExtnWriteRateAutoCalc, cpqIoDrvInfo=cpqIoDrvInfo, cpqIoDrvInfoAssemblyNumber=cpqIoDrvInfoAssemblyNumber, cpqIoDrvInfoWearoutIndicator=cpqIoDrvInfoWearoutIndicator, cpqIoDrvExtnLogicalBytesWrittenU=cpqIoDrvExtnLogicalBytesWrittenU, cpqIoDrvMibCondition=cpqIoDrvMibCondition, cpqIoDrvExtnTotalPhysicalCapacityL=cpqIoDrvExtnTotalPhysicalCapacityL, cpqIoDrvInfoIndex=cpqIoDrvInfoIndex, cpqIoDrvExtnTable=cpqIoDrvExtnTable, cpqIoDrvProcState=cpqIoDrvProcState, cpqIoDrvInfoMinimalModeReason=cpqIoDrvInfoMinimalModeReason, cpqIoDrvInfoAdapterExtPowerPresent=cpqIoDrvInfoAdapterExtPowerPresent, cpqIoDrvTempEntry=cpqIoDrvTempEntry, cpqIoDrvInfoMilliWattsPeak=cpqIoDrvInfoMilliWattsPeak, cpqIoDrvExtnLogicalBytesWrittenL=cpqIoDrvExtnLogicalBytesWrittenL, cpqIoDrvExtnTotalPhysicalCapacityU=cpqIoDrvExtnTotalPhysicalCapacityU, cpqIoDrvExtnShortTermEndDateFloat=cpqIoDrvExtnShortTermEndDateFloat, cpqIoDrvExtnLongTermEndDateFloat=cpqIoDrvExtnLongTermEndDateFloat, cpqIoDrvInfoMilliAmpsPeak=cpqIoDrvInfoMilliAmpsPeak, cpqIoDrvInfoAdapterType=cpqIoDrvInfoAdapterType, cpqIoDrvWriteTable=cpqIoDrvWriteTable, cpqIoDrvExtnShortTermStartDate=cpqIoDrvExtnShortTermStartDate, cpqIoDrvExtnUsedPhysicalCapacityL=cpqIoDrvExtnUsedPhysicalCapacityL, cpqIoDrvWriteEntry=cpqIoDrvWriteEntry, cpqIoDrvInfoDriverVersion=cpqIoDrvInfoDriverVersion, cpqIoDrvInfoBeacon=cpqIoDrvInfoBeacon, cpqIoDrvInfoPercentLifeRemaining=cpqIoDrvInfoPercentLifeRemaining, cpqIoDrvInfoPCIDeviceID=cpqIoDrvInfoPCIDeviceID, cpqIoDrvInfoPCIPowerCompatibility=cpqIoDrvInfoPCIPowerCompatibility, cpqIoDrvCapacityTable=cpqIoDrvCapacityTable, cpqIoDrvFlashbackTrap=cpqIoDrvFlashbackTrap, cpqIoDrvInfoPartNumber=cpqIoDrvInfoPartNumber, cpqIoDrvInfoThermalGoverningLevel=cpqIoDrvInfoThermalGoverningLevel, cpqIoDrvProcName=cpqIoDrvProcName, cpqIoDrvInfoShortTermNonWritableDate=cpqIoDrvInfoShortTermNonWritableDate, cpqIoDrvExtnLongTermAvgL=cpqIoDrvExtnLongTermAvgL, cpqIoDrvTempIndex=cpqIoDrvTempIndex, cpqIoDrvExtnUsedPhysicalCapacityU=cpqIoDrvExtnUsedPhysicalCapacityU, cpqIoDrvCapacity=cpqIoDrvCapacity, cpqIoDrvExtnShortTermAvgU=cpqIoDrvExtnShortTermAvgU, cpqIoDrvProcCPU=cpqIoDrvProcCPU, cpqIoDrvExtnCurrentRAMUsageU=cpqIoDrvExtnCurrentRAMUsageU, cpqIoDrvInfoPCIVendorID=cpqIoDrvInfoPCIVendorID, cpqIoDrvExtnAvailableLogicalCapacityL=cpqIoDrvExtnAvailableLogicalCapacityL, cpqIoDrv=cpqIoDrv, cpqIoDrvWrite=cpqIoDrvWrite, cpqIoDrvExtnShortTermWindow=cpqIoDrvExtnShortTermWindow, cpqIoDrvExtnUsablePhysicalCapacityL=cpqIoDrvExtnUsablePhysicalCapacityL, cpqIoDrvTempInfoIndex=cpqIoDrvTempInfoIndex, cpqIoDrvWriteTimestamp=cpqIoDrvWriteTimestamp, cpqIoDrvTempTimestamp=cpqIoDrvTempTimestamp, cpqIoDrvExtnFormattedBlockSize=cpqIoDrvExtnFormattedBlockSize, cpqIoDrvExtnPeakRAMUsageU=cpqIoDrvExtnPeakRAMUsageU, cpqIoDrvInfoStatus=cpqIoDrvInfoStatus, cpqIoDrvInfoMilliWatts=cpqIoDrvInfoMilliWatts, cpqIoDrvMibRevMinor=cpqIoDrvMibRevMinor, cpqIoDrvInfoLifespanGoverningLevel=cpqIoDrvInfoLifespanGoverningLevel, cpqIoDrvExtnAvailableLogicalCapacityU=cpqIoDrvExtnAvailableLogicalCapacityU, cpqIoDrvInfoAmbientTemp=cpqIoDrvInfoAmbientTemp, cpqIoDrvExtnEntry=cpqIoDrvExtnEntry, cpqIoDrvExtn=cpqIoDrvExtn, cpqIoDrvPowerlossProtectTrap=cpqIoDrvPowerlossProtectTrap, cpqIoDrvInfoAdapterSerialNumber=cpqIoDrvInfoAdapterSerialNumber, cpqIoDrvProcRAM=cpqIoDrvProcRAM, cpqIoDrvInfoCurrentTemp=cpqIoDrvInfoCurrentTemp, cpqIoDrvInfoMilliVoltsPeak=cpqIoDrvInfoMilliVoltsPeak)
