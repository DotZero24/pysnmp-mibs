...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/broadcom/FASTPATH-QOS-ACL-MIB
...
fastPathQOSACL.setRevisions(('2005-07-08 00:00', '2004-09-20 00:00', '2003-11-21 00:00', '2003-02-06 23:34',))
if mibBuilder.loadTexts: fastPathQOSACL.setLastUpdated('200507080000Z')
...
aclEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 1, 1), ).setIndexNames((0, "FASTPATH-QOS-ACL-MIB", "aclIndex"))
...
aclName = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 1, 1, 2), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 31))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclName.setStatus('current')
aclStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 1, 1, 3), RowStatus()).setMaxAccess("readcreate")
...
aclIfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 8, 1), ).setIndexNames((0, "FASTPATH-QOS-ACL-MIB", "aclIfIndex"), (0, "FASTPATH-QOS-ACL-MIB", "aclIfDirection"), (0, "FASTPATH-QOS-ACL-MIB", "aclIfSequence"), (0, "FASTPATH-QOS-ACL-MIB", "aclIfAclType"), (0, "FASTPATH-QOS-ACL-MIB", "aclIfAclId"))
...
aclRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 4, 1), ).setIndexNames((0, "FASTPATH-QOS-ACL-MIB", "aclIndex"), (0, "FASTPATH-QOS-ACL-MIB", "aclRuleIndex"))
...
aclMacEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 6, 1), ).setIndexNames((0, "FASTPATH-QOS-ACL-MIB", "aclMacIndex"))
...
aclMacRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 7, 1), ).setIndexNames((0, "FASTPATH-QOS-ACL-MIB", "aclMacIndex"), (0, "FASTPATH-QOS-ACL-MIB", "aclMacRuleIndex"))
...
aclMacRuleVlanId = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 7, 1, 11), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4095))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclMacRuleVlanId.setStatus('current')
aclMacRuleVlanIdRangeStart = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 7, 1, 12), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4095))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclMacRuleVlanIdRangeStart.setStatus('current')
aclMacRuleVlanIdRangeEnd = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 7, 1, 13), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4095))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclMacRuleVlanIdRangeEnd.setStatus('current')
aclMacRuleVlanId2 = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 7, 1, 14), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4095))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclMacRuleVlanId2.setStatus('current')
aclMacRuleVlanId2RangeStart = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 7, 1, 15), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4095))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclMacRuleVlanId2RangeStart.setStatus('current')
aclMacRuleVlanId2RangeEnd = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 7, 1, 16), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4095))).setMaxAccess("readcreate")
...
aclVlanTable = MibTable((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 10), )
if mibBuilder.loadTexts: aclVlanTable.setStatus('current')
aclVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 10, 1), ).setIndexNames((0, "FASTPATH-QOS-ACL-MIB", "aclVlanIndex"), (0, "FASTPATH-QOS-ACL-MIB", "aclVlanDirection"), (0, "FASTPATH-QOS-ACL-MIB", "aclVlanSequence"), (0, "FASTPATH-QOS-ACL-MIB", "aclVlanAclType"), (0, "FASTPATH-QOS-ACL-MIB", "aclVlanAclId"))
if mibBuilder.loadTexts: aclVlanEntry.setStatus('current')
aclVlanIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 10, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 2147483647)))
if mibBuilder.loadTexts: aclVlanIndex.setStatus('current')
aclVlanAclType = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 10, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("ip", 1), ("mac", 2), ("ipv6", 3))))
if mibBuilder.loadTexts: aclVlanAclType.setStatus('current')
aclVlanAclId = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 10, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 2147483647)))
if mibBuilder.loadTexts: aclVlanAclId.setStatus('current')
aclVlanDirection = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 10, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("inbound", 1), ("outbound", 2)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: aclVlanDirection.setStatus('current')
aclVlanSequence = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 10, 1, 5), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4294967295)))
if mibBuilder.loadTexts: aclVlanSequence.setStatus('current')
aclVlanStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 10, 1, 6), RowStatus()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclVlanStatus.setStatus('current')
aclIpv6IndexNextFree = MibScalar((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 11), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: aclIpv6IndexNextFree.setStatus('current')
aclIpv6Table = MibTable((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 12), )
if mibBuilder.loadTexts: aclIpv6Table.setStatus('current')
aclIpv6Entry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 12, 1), ).setIndexNames((0, "FASTPATH-QOS-ACL-MIB", "aclIpv6Index"))
if mibBuilder.loadTexts: aclIpv6Entry.setStatus('current')
aclIpv6Index = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 12, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 2147483647)))
if mibBuilder.loadTexts: aclIpv6Index.setStatus('current')
aclIpv6Name = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 12, 1, 2), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 31))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6Name.setStatus('current')
aclIpv6Status = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 12, 1, 3), RowStatus()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6Status.setStatus('current')
aclIpv6RuleTable = MibTable((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13), )
if mibBuilder.loadTexts: aclIpv6RuleTable.setStatus('current')
aclIpv6RuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1), ).setIndexNames((0, "FASTPATH-QOS-ACL-MIB", "aclIpv6Index"), (0, "FASTPATH-QOS-ACL-MIB", "aclIpv6RuleIndex"))
if mibBuilder.loadTexts: aclIpv6RuleEntry.setStatus('current')
aclIpv6RuleIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 2147483647)))
if mibBuilder.loadTexts: aclIpv6RuleIndex.setStatus('current')
aclIpv6RuleAction = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("permit", 1), ("deny", 2))).clone('deny')).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleAction.setStatus('current')
aclIpv6RuleLogging = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 3), TruthValue()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleLogging.setStatus('current')
aclIpv6RuleAssignQueueId = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 4), Unsigned32()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleAssignQueueId.setStatus('current')
aclIpv6RuleRedirectIntf = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 5), InterfaceIndexOrZero()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleRedirectIntf.setStatus('current')
aclIpv6RuleMirrorIntf = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 6), InterfaceIndexOrZero()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleMirrorIntf.setStatus('current')
aclIpv6RuleMatchEvery = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 7), TruthValue()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleMatchEvery.setStatus('current')
aclIpv6RuleProtocol = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 8), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 255))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleProtocol.setStatus('current')
aclIpv6RuleSrcL4Port = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 9), Integer32()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleSrcL4Port.setStatus('current')
aclIpv6RuleSrcL4PortRangeStart = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 10), Integer32()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleSrcL4PortRangeStart.setStatus('current')
aclIpv6RuleSrcL4PortRangeEnd = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 11), Integer32()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleSrcL4PortRangeEnd.setStatus('current')
aclIpv6RuleDestL4Port = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 12), Integer32()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleDestL4Port.setStatus('current')
aclIpv6RuleDestL4PortRangeStart = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 13), Integer32()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleDestL4PortRangeStart.setStatus('current')
aclIpv6RuleDestL4PortRangeEnd = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 14), Integer32()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleDestL4PortRangeEnd.setStatus('current')
aclIpv6RuleStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 15), RowStatus()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleStatus.setStatus('current')
aclIpv6RuleFlowLabel = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 16), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 1048575))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleFlowLabel.setStatus('current')
aclIpv6RuleIPDSCP = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 17), Integer32()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclIpv6RuleIPDSCP.setStatus('current')
aclRuleSrcIpv6Prefix = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 18), Ipv6AddressPrefix()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: aclRuleSrcIpv6Prefix.setStatus('current')
aclRuleSrcIpv6PrefixLength = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 19), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 128))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: aclRuleSrcIpv6PrefixLength.setStatus('current')
aclRuleDstIpv6Prefix = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 20), Ipv6AddressPrefix()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: aclRuleDstIpv6Prefix.setStatus('current')
aclRuleDstIpv6PrefixLength = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 13, 1, 21), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 128))).setMaxAccess("readcreate")
...
aclTrapRuleLogEvent = NotificationType((1, 3, 6, 1, 4, 1, 4413, 1, 1, 3, 2, 0, 1)).setObjects(("FASTPATH-QOS-ACL-MIB", "aclIfAclType"), ("FASTPATH-QOS-ACL-MIB", "aclIfAclId"), ("FASTPATH-QOS-ACL-MIB", "aclTrapRuleIndex"), ("FASTPATH-QOS-ACL-MIB", "aclTrapRuleAction"), ("FASTPATH-QOS-ACL-MIB", "aclTrapRuleHitCount"))
if mibBuilder.loadTexts: aclTrapRuleLogEvent.setStatus('current')
mibBuilder.exportSymbols("FASTPATH-QOS-ACL-MIB", aclRuleDestIpAddress=aclRuleDestIpAddress, aclIfSequence=aclIfSequence, aclRuleSrcL4PortRangeEnd=aclRuleSrcL4PortRangeEnd, aclMacRuleAction=aclMacRuleAction, aclMacRuleVlanIdRangeEnd=aclMacRuleVlanIdRangeEnd, aclVlanAclId=aclVlanAclId, aclTrapRuleAction=aclTrapRuleAction, aclMacRuleVlanIdRangeStart=aclMacRuleVlanIdRangeStart, aclRuleSrcIpAddress=aclRuleSrcIpAddress, aclMacIndexNextFree=aclMacIndexNextFree, aclIpv6IndexNextFree=aclIpv6IndexNextFree, aclMacRuleCos=aclMacRuleCos, aclTrapRuleLogEvent=aclTrapRuleLogEvent, aclIpv6RuleDestL4PortRangeStart=aclIpv6RuleDestL4PortRangeStart, aclIpv6RuleSrcL4PortRangeEnd=aclIpv6RuleSrcL4PortRangeEnd, aclVlanAclType=aclVlanAclType, aclMacRuleTable=aclMacRuleTable, aclRuleIPDSCP=aclRuleIPDSCP, aclIpv6Entry=aclIpv6Entry, aclRuleSrcIpMask=aclRuleSrcIpMask, aclVlanStatus=aclVlanStatus, aclIpv6RuleProtocol=aclIpv6RuleProtocol, PYSNMP_MODULE_ID=fastPathQOSACL, aclMacRuleDestMacAddr=aclMacRuleDestMacAddr, aclStatus=aclStatus, aclMacRuleVlanId=aclMacRuleVlanId, aclRuleSrcL4PortRangeStart=aclRuleSrcL4PortRangeStart, aclRuleAction=aclRuleAction, aclIfAclId=aclIfAclId, aclVlanEntry=aclVlanEntry, aclIfDirection=aclIfDirection, aclNamedIpv4IndexNextFree=aclNamedIpv4IndexNextFree, fastPathQOSACL=fastPathQOSACL, aclIpv6RuleMatchEvery=aclIpv6RuleMatchEvery, aclTrapFlag=aclTrapFlag, aclRuleDstIpv6PrefixLength=aclRuleDstIpv6PrefixLength, aclIpv6RuleDestL4Port=aclIpv6RuleDestL4Port, aclIpv6Table=aclIpv6Table, aclMacRuleSrcMacAddr=aclMacRuleSrcMacAddr, aclMacRuleAssignQueueId=aclMacRuleAssignQueueId, aclIpv6RuleIPDSCP=aclIpv6RuleIPDSCP, Ipv6AddressPrefix=Ipv6AddressPrefix, aclRuleDestL4PortRangeEnd=aclRuleDestL4PortRangeEnd, aclIpv6RuleAssignQueueId=aclIpv6RuleAssignQueueId, aclMacTable=aclMacTable, aclRuleDestL4Port=aclRuleDestL4Port, aclMacRuleStatus=aclMacRuleStatus, aclIpv6RuleRedirectIntf=aclIpv6RuleRedirectIntf, aclRuleIndex=aclRuleIndex, aclTable=aclTable, aclMacRuleDestMacMask=aclMacRuleDestMacMask, aclTrapRuleIndex=aclTrapRuleIndex, aclIpv6RuleFlowLabel=aclIpv6RuleFlowLabel, aclNotifications=aclNotifications, aclVlanTable=aclVlanTable, aclRuleProtocol=aclRuleProtocol, aclLoggingGroup=aclLoggingGroup, aclRuleAssignQueueId=aclRuleAssignQueueId, aclIndex=aclIndex, aclRuleMatchEvery=aclRuleMatchEvery, aclMacStatus=aclMacStatus, aclIpv6RuleAction=aclIpv6RuleAction, aclRuleSrcIpv6PrefixLength=aclRuleSrcIpv6PrefixLength, aclName=aclName, aclIfEntry=aclIfEntry, EtypeValue=EtypeValue, aclVlanIndex=aclVlanIndex, aclIpv6RuleLogging=aclIpv6RuleLogging, aclRuleIpPrecedence=aclRuleIpPrecedence, aclIpv6RuleIndex=aclIpv6RuleIndex, aclIpv6RuleDestL4PortRangeEnd=aclIpv6RuleDestL4PortRangeEnd, aclMacEntry=aclMacEntry, aclMacRuleVlanId2=aclMacRuleVlanId2, aclIpv6RuleSrcL4Port=aclIpv6RuleSrcL4Port, aclMacRuleEtypeKey=aclMacRuleEtypeKey, aclRuleDestIpMask=aclRuleDestIpMask, aclMacRuleEtypeValue=aclMacRuleEtypeValue, aclRuleEntry=aclRuleEntry, aclMacRuleIndex=aclMacRuleIndex, aclRuleSrcL4Port=aclRuleSrcL4Port, aclMacRuleLogging=aclMacRuleLogging, aclIpv6Name=aclIpv6Name, aclMacIndex=aclMacIndex, aclMacRuleVlanId2RangeEnd=aclMacRuleVlanId2RangeEnd, aclMacRuleMatchEvery=aclMacRuleMatchEvery, aclRuleSrcIpv6Prefix=aclRuleSrcIpv6Prefix, aclVlanDirection=aclVlanDirection, aclMacName=aclMacName, aclMacRuleVlanId2RangeStart=aclMacRuleVlanId2RangeStart, aclMacRuleEntry=aclMacRuleEntry, aclIpv6Status=aclIpv6Status, aclRuleTable=aclRuleTable, aclIpv6RuleTable=aclIpv6RuleTable, aclMacRuleMirrorIntf=aclMacRuleMirrorIntf, aclRuleDstIpv6Prefix=aclRuleDstIpv6Prefix, aclMacRuleRedirectIntf=aclMacRuleRedirectIntf, aclIfAclType=aclIfAclType, aclMacRuleCos2=aclMacRuleCos2, aclIfStatus=aclIfStatus, aclRuleIpTosBits=aclRuleIpTosBits, aclIfTable=aclIfTable, aclIpv6RuleStatus=aclIpv6RuleStatus, aclRuleStatus=aclRuleStatus, aclIpv6RuleSrcL4PortRangeStart=aclIpv6RuleSrcL4PortRangeStart, aclIpv6RuleMirrorIntf=aclIpv6RuleMirrorIntf, aclRuleRedirectIntf=aclRuleRedirectIntf, aclVlanSequence=aclVlanSequence, aclMacRuleSrcMacMask=aclMacRuleSrcMacMask, aclIfIndex=aclIfIndex, aclRuleLogging=aclRuleLogging, aclEntry=aclEntry, aclRuleIpTosMask=aclRuleIpTosMask, aclIpv6RuleEntry=aclIpv6RuleEntry, aclRuleMirrorIntf=aclRuleMirrorIntf, aclRuleDestL4PortRangeStart=aclRuleDestL4PortRangeStart, aclIpv6Index=aclIpv6Index, aclTrapRuleHitCount=aclTrapRuleHitCount)
