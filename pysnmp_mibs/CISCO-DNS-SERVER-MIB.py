...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-DNS-SERVER-MIB
...
TimeInterval, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "DisplayString", "TimeStamp", "TextualConvention")
ciscoDnsServerMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 9, 9, 405))
ciscoDnsServerMIB.setRevisions(('2008-05-31 00:00', '2005-03-01 00:00', '2004-02-01 00:00',))
if mibBuilder.loadTexts: ciscoDnsServerMIB.setLastUpdated('200805310000Z')
...
cDnsHaMsgSyncPendingRcvdCnts = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 12, 31), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cDnsHaMsgSyncPendingRcvdCnts.setStatus('current')
cDnsHaMsgSyncPendingSentCnts = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 12, 32), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cDnsHaMsgSyncPendingSentCnts.setStatus('current')
cDnsHaMsgShutdownRcvdCnts = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 12, 33), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cDnsHaMsgShutdownRcvdCnts.setStatus('current')
cDnsHaMsgShutdownSentCnts = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 12, 34), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cDnsHaMsgShutdownSentCnts.setStatus('current')
...
cDnsHaIntMsgSyncPendingRcvdCnts = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 13, 33), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cDnsHaIntMsgSyncPendingRcvdCnts.setStatus('current')
cDnsHaIntMsgSyncPendingSentCnts = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 13, 34), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cDnsHaIntMsgSyncPendingSentCnts.setStatus('current')
cDnsHaIntMsgShutdownRcvdCnts = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 13, 35), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cDnsHaIntMsgShutdownRcvdCnts.setStatus('current')
cDnsHaIntMsgShutdownSentCnts = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 13, 36), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cDnsHaIntMsgShutdownSentCnts.setStatus('current')
...
cDnsHaStatsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 405, 2, 2, 12)).setObjects(("CISCO-DNS-SERVER-MIB", "cDnsHaCommInterruptedStates"), ("CISCO-DNS-SERVER-MIB", "cDnsHaPartnerDownStates"), ("CISCO-DNS-SERVER-MIB", "cDnsHaSyncs"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgConnectSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgReconcileSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgHeartBeatSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgZoneSyncSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgRRSyncSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgRRUpdateSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgResponseSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgConnectRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgReconcileRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgHeartbeatRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgZoneSyncRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgRRSyncRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgRRUpdateRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgResponseRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaHeartbeatTimeoutCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaUpdateRejectCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaResponseMismatchCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaResponseServFailCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaRespInconsistentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaRespUnknownCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaFullZoneResyncCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaUpdatePrivateReqCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaUpdatePrivateRespCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaSyncConflictCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaSyncDiscardNameCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaSyncMergeNameCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaUpdateLatencyAverage"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgSyncPendingRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgSyncPendingSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgShutdownRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgShutdownSentCnts"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    cDnsHaStatsGroup = cDnsHaStatsGroup.setStatus('current')
cDnsHaStatsIntervalGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 405, 2, 2, 13)).setObjects(("CISCO-DNS-SERVER-MIB", "cDnsHaIntCommInterruptedStates"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntPartnerDownStates"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntSyncs"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgConnectSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgReconcileSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgHeartBeatSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgZoneSyncSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgRRSyncSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgRRUpdateSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgResponseSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgConnectRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgReconcileRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgHeartbeatRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgZoneSyncRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgRRSyncRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgRRUpdateRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgResponseRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntHeartbeatTimeoutCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntUpdateRejectCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntResponseMismatchCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntResponseServFailCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntRespInconsistentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntRespUnknownCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntFullZoneResyncCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntUpdatePrivateReqCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntUpdatePrivateRespCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntSyncConflictCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntSyncDiscardNameCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntSyncMergeNameCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntUpdateLatencyAverage"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntSampleTime"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntSampleInterval"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgSyncPendingRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgSyncPendingSentCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgShutdownRcvdCnts"), ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgShutdownSentCnts"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    cDnsHaStatsIntervalGroup = cDnsHaStatsIntervalGroup.setStatus('current')
mibBuilder.exportSymbols("CISCO-DNS-SERVER-MIB", cDnsHaIntMsgConnectRcvdCnts=cDnsHaIntMsgConnectRcvdCnts, cDnsHaIntMsgZoneSyncRcvdCnts=cDnsHaIntMsgZoneSyncRcvdCnts, cDnsPerfIntQueries=cDnsPerfIntQueries, cDnsMaxCntrIntHaPersEditListCnts=cDnsMaxCntrIntHaPersEditListCnts, cDnsQueryIntNonAuthNoDataResps=cDnsQueryIntNonAuthNoDataResps, cDnsSecurityDetectTsigBadSigs=cDnsSecurityDetectTsigBadSigs, cDnsHaUpdateRejectCnts=cDnsHaUpdateRejectCnts, cDnsHaIntMsgResponseRcvdCnts=cDnsHaIntMsgResponseRcvdCnts, cDnsQueryStats=cDnsQueryStats, cDnsHaIntMsgReconcileSentCnts=cDnsHaIntMsgReconcileSentCnts, cDnsPerfStatsGroup=cDnsPerfStatsGroup, cDnsQueryIntAuthNoNames=cDnsQueryIntAuthNoNames, cDnsSecurityUnauthXferReqs=cDnsSecurityUnauthXferReqs, cDnsMaxCntrIntHaRRPendListCnts=cDnsMaxCntrIntHaRRPendListCnts, cDnsPerfStats=cDnsPerfStats, cDnsMaxCntrIntConcurXfrsOutCnts=cDnsMaxCntrIntConcurXfrsOutCnts, cDnsHaIntResponseMismatchCnts=cDnsHaIntResponseMismatchCnts, cDnsErrorStats=cDnsErrorStats, cDnsPerfIntInboundNotifies=cDnsPerfIntInboundNotifies, cDnsPerfFullRespIxfrs=cDnsPerfFullRespIxfrs, cDnsHaSyncMergeNameCnts=cDnsHaSyncMergeNameCnts, cDnsQueryIntAuthNoDataResps=cDnsQueryIntAuthNoDataResps, cDnsHaMsgShutdownSentCnts=cDnsHaMsgShutdownSentCnts, cDnsQueryMemCacheWrites=cDnsQueryMemCacheWrites, cDnsMaxCntrHaPersEditListCnts=cDnsMaxCntrHaPersEditListCnts, cDnsPerfInboundAxfrs=cDnsPerfInboundAxfrs, cDnsMaxCntrIntHaRRActiveListCnts=cDnsMaxCntrIntHaRRActiveListCnts, cDnsMaxCntrIntHaUpdLatencyMax=cDnsMaxCntrIntHaUpdLatencyMax, cDnsQueryStatsIntervalGroup=cDnsQueryStatsIntervalGroup, cDnsErrorIntSentFormatErrors=cDnsErrorIntSentFormatErrors, cDnsErrorIntSentTotalErrors=cDnsErrorIntSentTotalErrors, cDnsHaMsgSyncPendingRcvdCnts=cDnsHaMsgSyncPendingRcvdCnts, CDnsTime=CDnsTime, cDnsHaIntMsgShutdownRcvdCnts=cDnsHaIntMsgShutdownRcvdCnts, cDnsQueryIntMemCacheMisses=cDnsQueryIntMemCacheMisses, cDnsPerfIntOutboundAxfrs=cDnsPerfIntOutboundAxfrs, cDnsQueryAuthAnswers=cDnsQueryAuthAnswers, cDnsQueryIntAuthAnswers=cDnsQueryIntAuthAnswers, cDnsQueryIntNonAuthAnswers=cDnsQueryIntNonAuthAnswers, cDnsPerfOutboundAxfrs=cDnsPerfOutboundAxfrs, cDnsHaRespUnknownCnts=cDnsHaRespUnknownCnts, cDnsServMIBCompliance=cDnsServMIBCompliance, cDnsServMIBObjects=cDnsServMIBObjects, cDnsPerfInboundNotifies=cDnsPerfInboundNotifies, cDnsHaStatsGroup=cDnsHaStatsGroup, cDnsHaIntRespInconsistentCnts=cDnsHaIntRespInconsistentCnts, cDnsSecurityRestrictQueryAcls=cDnsSecurityRestrictQueryAcls, cDnsErrorIxfrInErrors=cDnsErrorIxfrInErrors, cDnsHaMsgReconcileSentCnts=cDnsHaMsgReconcileSentCnts, cDnsErrorStatsIntervalGroup=cDnsErrorStatsIntervalGroup, cDnsHaMsgRRSyncSentCnts=cDnsHaMsgRRSyncSentCnts, cDnsPerfIntInboundIxfrs=cDnsPerfIntInboundIxfrs, cDnsPerfOutboundNotifies=cDnsPerfOutboundNotifies, cDnsQueryLameDelegations=cDnsQueryLameDelegations, cDnsErrorIxfrOutErrors=cDnsErrorIxfrOutErrors, cDnsHaUpdatePrivateRespCnts=cDnsHaUpdatePrivateRespCnts, cDnsQueryRelNameRequests=cDnsQueryRelNameRequests, cDnsMaxCounterStatsGroup=cDnsMaxCounterStatsGroup, cDnsMaxCntrHaRRActiveListCnts=cDnsMaxCntrHaRRActiveListCnts, cDnsQueryIntMemCacheHits=cDnsQueryIntMemCacheHits, cDnsSecurityRcvdTsigBadSigs=cDnsSecurityRcvdTsigBadSigs, cDnsMaxCntrHaUpdLatencyMax=cDnsMaxCntrHaUpdLatencyMax, cDnsServConfigUpTime=cDnsServConfigUpTime, cDnsMaxCntrIntHaSvrMaxNoRespTime=cDnsMaxCntrIntHaSvrMaxNoRespTime, cDnsErrorIntSampleInterval=cDnsErrorIntSampleInterval, cDnsHaUpdatePrivateReqCnts=cDnsHaUpdatePrivateReqCnts, cDnsMaxCntrHaSvrNoRespTime=cDnsMaxCntrHaSvrNoRespTime, cDnsServConfigGroup=cDnsServConfigGroup, cDnsPerfUpdatePkts=cDnsPerfUpdatePkts, cDnsPerfIntSampleTime=cDnsPerfIntSampleTime, cDnsPerfIntOutboundIxfrs=cDnsPerfIntOutboundIxfrs, cDnsSecurityIntRcvdTsigBadTimes=cDnsSecurityIntRcvdTsigBadTimes, cDnsSecurityIntUnauthUpdateReqs=cDnsSecurityIntUnauthUpdateReqs, cDnsPerfUpdateRRs=cDnsPerfUpdateRRs, cDnsSecurityIntRestrictQueryAcls=cDnsSecurityIntRestrictQueryAcls, cDnsErrorAxfrOutErrors=cDnsErrorAxfrOutErrors, cDnsErrorIntIxfrInErrors=cDnsErrorIntIxfrInErrors, cDnsHaResponseMismatchCnts=cDnsHaResponseMismatchCnts, cDnsHaIntMsgResponseSentCnts=cDnsHaIntMsgResponseSentCnts, cDnsHaFullZoneResyncCnts=cDnsHaFullZoneResyncCnts, cDnsHaRespInconsistentCnts=cDnsHaRespInconsistentCnts, cDnsHaIntMsgRRUpdateSentCnts=cDnsHaIntMsgRRUpdateSentCnts, cDnsServConfigReset=cDnsServConfigReset, cDnsHaMsgZoneSyncRcvdCnts=cDnsHaMsgZoneSyncRcvdCnts, cDnsHaIntSampleInterval=cDnsHaIntSampleInterval, cDnsSecurityDetecTsigBadTimes=cDnsSecurityDetecTsigBadTimes, cDnsHaMsgHeartBeatSentCnts=cDnsHaMsgHeartBeatSentCnts, cDnsQueryIntervalStats=cDnsQueryIntervalStats, cDnsQueryIntSampleTime=cDnsQueryIntSampleTime, cDnsErrorIntUpdateErrors=cDnsErrorIntUpdateErrors, cDnsServConfigImplementIdent=cDnsServConfigImplementIdent, cDnsQueryReferrals=cDnsQueryReferrals, cDnsServConfigRecurs=cDnsServConfigRecurs, cDnsSecurityIntRcvdTsigBadKeys=cDnsSecurityIntRcvdTsigBadKeys, cDnsQueryMemCacheHits=cDnsQueryMemCacheHits, cDnsErrorIntervalStats=cDnsErrorIntervalStats, cDnsHaIntUpdateRejectCnts=cDnsHaIntUpdateRejectCnts, cDnsMaxCntrHaSvrMaxNoRespTime=cDnsMaxCntrHaSvrMaxNoRespTime, cDnsMaxCounterIntervalStats=cDnsMaxCounterIntervalStats, cDnsErrorSentTotalErrors=cDnsErrorSentTotalErrors, cDnsSecurityStatsIntervalGroup=cDnsSecurityStatsIntervalGroup, cDnsHaStats=cDnsHaStats, cDnsPerfIntervalStats=cDnsPerfIntervalStats, cDnsHaIntSyncMergeNameCnts=cDnsHaIntSyncMergeNameCnts, cDnsHaIntResponseServFailCnts=cDnsHaIntResponseServFailCnts, cDnsQueryIntRefusals=cDnsQueryIntRefusals, cDnsPerfInboundAtLimitXfrs=cDnsPerfInboundAtLimitXfrs, cDnsPerfIntOutboundNotifies=cDnsPerfIntOutboundNotifies, cDnsMaxCntrHaRRPendListCnts=cDnsMaxCntrHaRRPendListCnts, cDnsHaIntHeartbeatTimeoutCnts=cDnsHaIntHeartbeatTimeoutCnts, cDnsHaMsgRRUpdateSentCnts=cDnsHaMsgRRUpdateSentCnts, cDnsSecurityRcvdTsigPackets=cDnsSecurityRcvdTsigPackets, cDnsHaPartnerDownStates=cDnsHaPartnerDownStates, cDnsHaIntMsgHeartbeatRcvdCnts=cDnsHaIntMsgHeartbeatRcvdCnts, cDnsSecurityStatsGroup=cDnsSecurityStatsGroup, cDnsHaIntMsgReconcileRcvdCnts=cDnsHaIntMsgReconcileRcvdCnts, cDnsServConfig=cDnsServConfig, cDnsSecurityIntDetecTsigBadTimes=cDnsSecurityIntDetecTsigBadTimes, cDnsMaxCntrHaBatchLimitCnts=cDnsMaxCntrHaBatchLimitCnts, cDnsHaIntMsgHeartBeatSentCnts=cDnsHaIntMsgHeartBeatSentCnts, cDnsPerfOutboundAtLimitXfrs=cDnsPerfOutboundAtLimitXfrs, cDnsErrorIntSampleTime=cDnsErrorIntSampleTime, cDnsPerfStatsIntervalGroup=cDnsPerfStatsIntervalGroup, cDnsMaxCntrConcurXfrsInCnts=cDnsMaxCntrConcurXfrsInCnts, cDnsPerfIntFullRespIxfrs=cDnsPerfIntFullRespIxfrs, cDnsHaSyncs=cDnsHaSyncs, cDnsHaIntUpdatePrivateRespCnts=cDnsHaIntUpdatePrivateRespCnts, cDnsHaMsgResponseSentCnts=cDnsHaMsgResponseSentCnts, cDnsHaIntMsgShutdownSentCnts=cDnsHaIntMsgShutdownSentCnts, cDnsPerfInboundIxfrs=cDnsPerfInboundIxfrs, cDnsErrorUpdateErrors=cDnsErrorUpdateErrors, cDnsHaResponseServFailCnts=cDnsHaResponseServFailCnts, cDnsQueryNonAuthAnswers=cDnsQueryNonAuthAnswers, cDnsErrorIntAxfrInErrors=cDnsErrorIntAxfrInErrors, cDnsHaMsgSyncPendingSentCnts=cDnsHaMsgSyncPendingSentCnts, cDnsHaMsgZoneSyncSentCnts=cDnsHaMsgZoneSyncSentCnts, cDnsHaHeartbeatTimeoutCnts=cDnsHaHeartbeatTimeoutCnts, cDnsQueryRefusals=cDnsQueryRefusals, cDnsHaMsgReconcileRcvdCnts=cDnsHaMsgReconcileRcvdCnts, cDnsMaxCntrIntHaBatchLimitCnts=cDnsMaxCntrIntHaBatchLimitCnts, cDnsErrorIntSentOtherErrors=cDnsErrorIntSentOtherErrors, cDnsHaIntSyncs=cDnsHaIntSyncs, cDnsHaMsgConnectSentCnts=cDnsHaMsgConnectSentCnts, cDnsErrorRcvdFormatErrors=cDnsErrorRcvdFormatErrors, cDnsMaxCounterStats=cDnsMaxCounterStats, cDnsServConfigResetTime=cDnsServConfigResetTime, cDnsHaIntMsgSyncPendingSentCnts=cDnsHaIntMsgSyncPendingSentCnts, cDnsSecurityRcvdTsigBadTimes=cDnsSecurityRcvdTsigBadTimes, cDnsHaSyncConflictCnts=cDnsHaSyncConflictCnts, cDnsMaxCntrIntHaSvrNoRespTime=cDnsMaxCntrIntHaSvrNoRespTime, cDnsServMIBNotifs=cDnsServMIBNotifs, cDnsHaMsgHeartbeatRcvdCnts=cDnsHaMsgHeartbeatRcvdCnts, cDnsHaIntMsgConnectSentCnts=cDnsHaIntMsgConnectSentCnts, cDnsSecurityIntUnauthXferReqs=cDnsSecurityIntUnauthXferReqs, cDnsHaUpdateLatencyAverage=cDnsHaUpdateLatencyAverage, cDnsPerfIntUpdateRRs=cDnsPerfIntUpdateRRs, cDnsHaIntCommInterruptedStates=cDnsHaIntCommInterruptedStates, cDnsSecurityIntDetectTsigBadKeys=cDnsSecurityIntDetectTsigBadKeys, PYSNMP_MODULE_ID=ciscoDnsServerMIB, cDnsHaMsgRRSyncRcvdCnts=cDnsHaMsgRRSyncRcvdCnts, cDnsQueryAuthNoNames=cDnsQueryAuthNoNames, cDnsHaIntMsgRRSyncSentCnts=cDnsHaIntMsgRRSyncSentCnts, cDnsSecurityIntSampleInterval=cDnsSecurityIntSampleInterval, cDnsHaIntMsgRRSyncRcvdCnts=cDnsHaIntMsgRRSyncRcvdCnts, cDnsErrorIntRcvdFormatErrors=cDnsErrorIntRcvdFormatErrors, cDnsPerfIntSampleInterval=cDnsPerfIntSampleInterval, cDnsQueryNonAuthNoDataResps=cDnsQueryNonAuthNoDataResps, cDnsHaIntMsgRRUpdateRcvdCnts=cDnsHaIntMsgRRUpdateRcvdCnts, cDnsHaIntSyncConflictCnts=cDnsHaIntSyncConflictCnts, cDnsHaIntFullZoneResyncCnts=cDnsHaIntFullZoneResyncCnts, cDnsSecurityRcvdTsigBadKeys=cDnsSecurityRcvdTsigBadKeys, cDnsServMIBCompliances=cDnsServMIBCompliances, cDnsMaxCntrConcurXfrsOutCnts=cDnsMaxCntrConcurXfrsOutCnts, cDnsHaIntPartnerDownStates=cDnsHaIntPartnerDownStates, cDnsQueryIntSampleInterval=cDnsQueryIntSampleInterval, cDnsHaMsgResponseRcvdCnts=cDnsHaMsgResponseRcvdCnts, cDnsSecurityIntervalStats=cDnsSecurityIntervalStats, cDnsErrorSentOtherErrors=cDnsErrorSentOtherErrors, cDnsServMIBConform=cDnsServMIBConform, cDnsHaIntUpdatePrivateReqCnts=cDnsHaIntUpdatePrivateReqCnts, cDnsHaIntMsgZoneSyncSentCnts=cDnsHaIntMsgZoneSyncSentCnts, cDnsQueryAuthNoDataResps=cDnsQueryAuthNoDataResps, cDnsSecurityStats=cDnsSecurityStats, cDnsHaMsgRRUpdateRcvdCnts=cDnsHaMsgRRUpdateRcvdCnts, cDnsPerfOutboundIxfrs=cDnsPerfOutboundIxfrs, cDnsHaIntUpdateLatencyAverage=cDnsHaIntUpdateLatencyAverage, cDnsSecurityIntDetectTsigBadSigs=cDnsSecurityIntDetectTsigBadSigs, cDnsHaIntervalStats=cDnsHaIntervalStats, cDnsSecurityDetectTsigBadKeys=cDnsSecurityDetectTsigBadKeys, cDnsHaCommInterruptedStates=cDnsHaCommInterruptedStates, cDnsHaIntMsgSyncPendingRcvdCnts=cDnsHaIntMsgSyncPendingRcvdCnts, cDnsQueryIntLameDelegations=cDnsQueryIntLameDelegations, cDnsQueryIntMemCacheWrites=cDnsQueryIntMemCacheWrites, cDnsQueryMemCacheMisses=cDnsQueryMemCacheMisses, cDnsServMIBGroups=cDnsServMIBGroups, cDnsHaStatsIntervalGroup=cDnsHaStatsIntervalGroup, cDnsHaMsgConnectRcvdCnts=cDnsHaMsgConnectRcvdCnts, cDnsHaIntSampleTime=cDnsHaIntSampleTime, cDnsPerfIntOutboundAtLimitXfrs=cDnsPerfIntOutboundAtLimitXfrs, cDnsErrorIntAxfrOutErrors=cDnsErrorIntAxfrOutErrors, cDnsHaIntSyncDiscardNameCnts=cDnsHaIntSyncDiscardNameCnts, cDnsQueryIntReferrals=cDnsQueryIntReferrals, cDnsPerfIntInboundAtLimitXfrs=cDnsPerfIntInboundAtLimitXfrs, cDnsErrorSentFormatErrors=cDnsErrorSentFormatErrors, cDnsMaxCntrIntSampleTime=cDnsMaxCntrIntSampleTime, cDnsErrorSentRefusalErrors=cDnsErrorSentRefusalErrors, cDnsPerfIntInboundAxfrs=cDnsPerfIntInboundAxfrs, cDnsSecurityIntRcvdTsigPackets=cDnsSecurityIntRcvdTsigPackets, cDnsQueryStatsGroup=cDnsQueryStatsGroup, cDnsErrorAxfrInErrors=cDnsErrorAxfrInErrors, cDnsHaSyncDiscardNameCnts=cDnsHaSyncDiscardNameCnts, cDnsHaMsgShutdownRcvdCnts=cDnsHaMsgShutdownRcvdCnts, cDnsHaIntRespUnknownCnts=cDnsHaIntRespUnknownCnts, cDnsServConfigIntervalSample=cDnsServConfigIntervalSample, cDnsPerfIntUpdatePkts=cDnsPerfIntUpdatePkts, cDnsQueryIntRelNameRequests=cDnsQueryIntRelNameRequests, cDnsPerfQueries=cDnsPerfQueries, cDnsSecurityUnauthUpdateReqs=cDnsSecurityUnauthUpdateReqs, cDnsErrorIntIxfrOutErrors=cDnsErrorIntIxfrOutErrors, cDnsSecurityIntSampleTime=cDnsSecurityIntSampleTime, cDnsMaxCntrIntConcurXfrsInCnts=cDnsMaxCntrIntConcurXfrsInCnts, cDnsErrorStatsGroup=cDnsErrorStatsGroup, cDnsMaxCounterStatsIntervalGroup=cDnsMaxCounterStatsIntervalGroup, cDnsMaxCntrIntSampleInterval=cDnsMaxCntrIntSampleInterval, ciscoDnsServerMIB=ciscoDnsServerMIB, cDnsSecurityIntRcvdTsigBadSigs=cDnsSecurityIntRcvdTsigBadSigs, cDnsErrorIntSentRefusalErrors=cDnsErrorIntSentRefusalErrors)
