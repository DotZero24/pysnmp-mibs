...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DNS-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:33:40 2025
...
_CDnsHaMsgSyncPendingRcvdCnts_Type = Counter32
_CDnsHaMsgSyncPendingRcvdCnts_Object = MibScalar
cDnsHaMsgSyncPendingRcvdCnts = _CDnsHaMsgSyncPendingRcvdCnts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 12, 31),
    _CDnsHaMsgSyncPendingRcvdCnts_Type()
)
cDnsHaMsgSyncPendingRcvdCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cDnsHaMsgSyncPendingRcvdCnts.setStatus("current")
_CDnsHaMsgSyncPendingSentCnts_Type = Counter32
_CDnsHaMsgSyncPendingSentCnts_Object = MibScalar
cDnsHaMsgSyncPendingSentCnts = _CDnsHaMsgSyncPendingSentCnts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 12, 32),
    _CDnsHaMsgSyncPendingSentCnts_Type()
)
cDnsHaMsgSyncPendingSentCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cDnsHaMsgSyncPendingSentCnts.setStatus("current")
_CDnsHaMsgShutdownRcvdCnts_Type = Counter32
_CDnsHaMsgShutdownRcvdCnts_Object = MibScalar
cDnsHaMsgShutdownRcvdCnts = _CDnsHaMsgShutdownRcvdCnts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 12, 33),
    _CDnsHaMsgShutdownRcvdCnts_Type()
)
cDnsHaMsgShutdownRcvdCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cDnsHaMsgShutdownRcvdCnts.setStatus("current")
_CDnsHaMsgShutdownSentCnts_Type = Counter32
_CDnsHaMsgShutdownSentCnts_Object = MibScalar
cDnsHaMsgShutdownSentCnts = _CDnsHaMsgShutdownSentCnts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 12, 34),
    _CDnsHaMsgShutdownSentCnts_Type()
)
cDnsHaMsgShutdownSentCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cDnsHaMsgShutdownSentCnts.setStatus("current")
...
_CDnsHaIntMsgSyncPendingRcvdCnts_Type = Unsigned32
_CDnsHaIntMsgSyncPendingRcvdCnts_Object = MibScalar
cDnsHaIntMsgSyncPendingRcvdCnts = _CDnsHaIntMsgSyncPendingRcvdCnts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 13, 33),
    _CDnsHaIntMsgSyncPendingRcvdCnts_Type()
)
cDnsHaIntMsgSyncPendingRcvdCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cDnsHaIntMsgSyncPendingRcvdCnts.setStatus("current")
_CDnsHaIntMsgSyncPendingSentCnts_Type = Unsigned32
_CDnsHaIntMsgSyncPendingSentCnts_Object = MibScalar
cDnsHaIntMsgSyncPendingSentCnts = _CDnsHaIntMsgSyncPendingSentCnts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 13, 34),
    _CDnsHaIntMsgSyncPendingSentCnts_Type()
)
cDnsHaIntMsgSyncPendingSentCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cDnsHaIntMsgSyncPendingSentCnts.setStatus("current")
_CDnsHaIntMsgShutdownRcvdCnts_Type = Unsigned32
_CDnsHaIntMsgShutdownRcvdCnts_Object = MibScalar
cDnsHaIntMsgShutdownRcvdCnts = _CDnsHaIntMsgShutdownRcvdCnts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 13, 35),
    _CDnsHaIntMsgShutdownRcvdCnts_Type()
)
cDnsHaIntMsgShutdownRcvdCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cDnsHaIntMsgShutdownRcvdCnts.setStatus("current")
_CDnsHaIntMsgShutdownSentCnts_Type = Unsigned32
_CDnsHaIntMsgShutdownSentCnts_Object = MibScalar
cDnsHaIntMsgShutdownSentCnts = _CDnsHaIntMsgShutdownSentCnts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 405, 1, 13, 36),
    _CDnsHaIntMsgShutdownSentCnts_Type()
)
cDnsHaIntMsgShutdownSentCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cDnsHaIntMsgShutdownSentCnts.setStatus("current")
...
cDnsHaStatsGroup.setObjects(
      *(("CISCO-DNS-SERVER-MIB", "cDnsHaCommInterruptedStates"),
        ...
        ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgSyncPendingRcvdCnts"),
        ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgSyncPendingSentCnts"),
        ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgShutdownRcvdCnts"),
        ("CISCO-DNS-SERVER-MIB", "cDnsHaMsgShutdownSentCnts"))
)
if mibBuilder.loadTexts:
...
cDnsHaStatsIntervalGroup.setObjects(
      *(("CISCO-DNS-SERVER-MIB", "cDnsHaIntCommInterruptedStates"),
        ...
        ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgSyncPendingRcvdCnts"),
        ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgSyncPendingSentCnts"),
        ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgShutdownRcvdCnts"),
        ("CISCO-DNS-SERVER-MIB", "cDnsHaIntMsgShutdownSentCnts"))
)
if mibBuilder.loadTexts:
...
cDnsServMIBCompliance.setObjects(
      *(("CISCO-DNS-SERVER-MIB", "cDnsQueryStatsGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsQueryStatsIntervalGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsPerfStatsGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsPerfStatsIntervalGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsSecurityStatsGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsSecurityStatsIntervalGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsErrorStatsGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsErrorStatsIntervalGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsMaxCounterStatsGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsMaxCounterStatsIntervalGroup"),
        ("CISCO-DNS-SERVER-MIB", "cDnsHaStatsGroup"),
...
mibBuilder.exportSymbols(
    ...
    **{"CDnsTime": CDnsTime,
       ...
       "cDnsHaMsgSyncPendingRcvdCnts": cDnsHaMsgSyncPendingRcvdCnts,
       "cDnsHaMsgSyncPendingSentCnts": cDnsHaMsgSyncPendingSentCnts,
       "cDnsHaMsgShutdownRcvdCnts": cDnsHaMsgShutdownRcvdCnts,
       "cDnsHaMsgShutdownSentCnts": cDnsHaMsgShutdownSentCnts,
       ...
       "cDnsHaIntMsgSyncPendingRcvdCnts": cDnsHaIntMsgSyncPendingRcvdCnts,
       "cDnsHaIntMsgSyncPendingSentCnts": cDnsHaIntMsgSyncPendingSentCnts,
       "cDnsHaIntMsgShutdownRcvdCnts": cDnsHaIntMsgShutdownRcvdCnts,
       "cDnsHaIntMsgShutdownSentCnts": cDnsHaIntMsgShutdownSentCnts,
