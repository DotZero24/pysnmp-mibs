...
mibBuilder.exportSymbols("CISCO-DNS-SERVER-MIB", cDnsMaxCntrHaUpdLatencyMax=cDnsMaxCntrHaUpdLatencyMax, cDnsHaStats=cDnsHaStats, cDnsMaxCntrConcurXfrsInCnts=cDnsMaxCntrConcurXfrsInCnts, cDnsQueryNonAuthNoDataResps=cDnsQueryNonAuthNoDataResps, cDnsErrorSentTotalErrors=cDnsErrorSentTotalErrors, cDnsErrorIntAxfrOutErrors=cDnsErrorIntAxfrOutErrors, cDnsHaIntSyncDiscardNameCnts=cDnsHaIntSyncDiscardNameCnts, cDnsErrorStatsGroup=cDnsErrorStatsGroup, cDnsServMIBObjects=cDnsServMIBObjects, cDnsSecurityRcvdTsigBadKeys=cDnsSecurityRcvdTsigBadKeys, cDnsHaResponseMismatchCnts=cDnsHaResponseMismatchCnts, cDnsHaFullZoneResyncCnts=cDnsHaFullZoneResyncCnts, cDnsServMIBCompliances=cDnsServMIBCompliances, cDnsMaxCntrIntConcurXfrsOutCnts=cDnsMaxCntrIntConcurXfrsOutCnts, cDnsQueryIntMemCacheHits=cDnsQueryIntMemCacheHits, cDnsMaxCntrIntConcurXfrsInCnts=cDnsMaxCntrIntConcurXfrsInCnts, cDnsQueryReferrals=cDnsQueryReferrals, cDnsHaRespUnknownCnts=cDnsHaRespUnknownCnts, cDnsQueryIntReferrals=cDnsQueryIntReferrals, cDnsQueryMemCacheWrites=cDnsQueryMemCacheWrites, cDnsPerfUpdateRRs=cDnsPerfUpdateRRs, cDnsMaxCntrHaSvrNoRespTime=cDnsMaxCntrHaSvrNoRespTime, cDnsPerfIntOutboundAxfrs=cDnsPerfIntOutboundAxfrs, cDnsPerfInboundAxfrs=cDnsPerfInboundAxfrs, cDnsPerfIntSampleTime=cDnsPerfIntSampleTime, cDnsQueryIntAuthNoNames=cDnsQueryIntAuthNoNames, cDnsServMIBNotifs=cDnsServMIBNotifs, cDnsHaIntMsgShutdownRcvdCnts=cDnsHaIntMsgShutdownRcvdCnts, cDnsHaIntPartnerDownStates=cDnsHaIntPartnerDownStates, cDnsHaPartnerDownStates=cDnsHaPartnerDownStates, cDnsSecurityUnauthXferReqs=cDnsSecurityUnauthXferReqs, cDnsQueryIntRefusals=cDnsQueryIntRefusals, cDnsPerfIntUpdateRRs=cDnsPerfIntUpdateRRs, cDnsPerfIntInboundAxfrs=cDnsPerfIntInboundAxfrs, cDnsHaMsgZoneSyncRcvdCnts=cDnsHaMsgZoneSyncRcvdCnts, cDnsPerfIntInboundAtLimitXfrs=cDnsPerfIntInboundAtLimitXfrs, cDnsHaMsgRRUpdateSentCnts=cDnsHaMsgRRUpdateSentCnts, cDnsErrorIntUpdateErrors=cDnsErrorIntUpdateErrors, cDnsErrorIntAxfrInErrors=cDnsErrorIntAxfrInErrors, cDnsHaIntSyncMergeNameCnts=cDnsHaIntSyncMergeNameCnts, cDnsQueryNonAuthAnswers=cDnsQueryNonAuthAnswers, cDnsPerfQueries=cDnsPerfQueries, cDnsSecurityIntDetecTsigBadTimes=cDnsSecurityIntDetecTsigBadTimes, cDnsServConfigIntervalSample=cDnsServConfigIntervalSample, cDnsHaStatsIntervalGroup=cDnsHaStatsIntervalGroup, cDnsPerfInboundAtLimitXfrs=cDnsPerfInboundAtLimitXfrs, cDnsHaIntMsgReconcileSentCnts=cDnsHaIntMsgReconcileSentCnts, cDnsHaStatsGroup=cDnsHaStatsGroup, cDnsMaxCntrIntHaRRPendListCnts=cDnsMaxCntrIntHaRRPendListCnts, cDnsPerfStatsIntervalGroup=cDnsPerfStatsIntervalGroup, cDnsSecurityDetectTsigBadSigs=cDnsSecurityDetectTsigBadSigs, cDnsErrorIntSentRefusalErrors=cDnsErrorIntSentRefusalErrors, cDnsHaMsgHeartBeatSentCnts=cDnsHaMsgHeartBeatSentCnts, cDnsQueryRefusals=cDnsQueryRefusals, cDnsHaIntMsgZoneSyncSentCnts=cDnsHaIntMsgZoneSyncSentCnts, cDnsSecurityIntRcvdTsigPackets=cDnsSecurityIntRcvdTsigPackets, cDnsSecurityRestrictQueryAcls=cDnsSecurityRestrictQueryAcls, cDnsMaxCounterStatsIntervalGroup=cDnsMaxCounterStatsIntervalGroup, cDnsPerfIntInboundIxfrs=cDnsPerfIntInboundIxfrs, cDnsHaUpdateRejectCnts=cDnsHaUpdateRejectCnts, cDnsPerfInboundNotifies=cDnsPerfInboundNotifies, cDnsMaxCntrIntSampleInterval=cDnsMaxCntrIntSampleInterval, cDnsHaIntMsgSyncPendingRcvdCnts=cDnsHaIntMsgSyncPendingRcvdCnts, cDnsErrorSentOtherErrors=cDnsErrorSentOtherErrors, cDnsQueryAuthAnswers=cDnsQueryAuthAnswers, cDnsHaSyncs=cDnsHaSyncs, cDnsQueryIntAuthAnswers=cDnsQueryIntAuthAnswers, cDnsMaxCntrIntHaSvrNoRespTime=cDnsMaxCntrIntHaSvrNoRespTime, cDnsSecurityIntRcvdTsigBadTimes=cDnsSecurityIntRcvdTsigBadTimes, cDnsErrorSentRefusalErrors=cDnsErrorSentRefusalErrors, cDnsSecurityUnauthUpdateReqs=cDnsSecurityUnauthUpdateReqs, cDnsMaxCntrIntHaPersEditListCnts=cDnsMaxCntrIntHaPersEditListCnts, cDnsHaUpdatePrivateReqCnts=cDnsHaUpdatePrivateReqCnts, cDnsHaIntMsgRRUpdateSentCnts=cDnsHaIntMsgRRUpdateSentCnts, cDnsHaIntSampleInterval=cDnsHaIntSampleInterval, cDnsPerfIntFullRespIxfrs=cDnsPerfIntFullRespIxfrs, cDnsPerfIntQueries=cDnsPerfIntQueries, cDnsErrorIntSentTotalErrors=cDnsErrorIntSentTotalErrors, cDnsSecurityIntervalStats=cDnsSecurityIntervalStats, cDnsSecurityIntDetectTsigBadSigs=cDnsSecurityIntDetectTsigBadSigs, cDnsHaIntUpdatePrivateRespCnts=cDnsHaIntUpdatePrivateRespCnts, cDnsHaIntUpdateLatencyAverage=cDnsHaIntUpdateLatencyAverage, cDnsPerfOutboundNotifies=cDnsPerfOutboundNotifies, cDnsQueryStats=cDnsQueryStats, cDnsServConfig=cDnsServConfig, cDnsQueryAuthNoDataResps=cDnsQueryAuthNoDataResps, cDnsPerfOutboundAtLimitXfrs=cDnsPerfOutboundAtLimitXfrs, PYSNMP_MODULE_ID=ciscoDnsServerMIB, cDnsHaUpdateLatencyAverage=cDnsHaUpdateLatencyAverage, cDnsServConfigUpTime=cDnsServConfigUpTime, cDnsHaIntRespInconsistentCnts=cDnsHaIntRespInconsistentCnts, ciscoDnsServerMIB=ciscoDnsServerMIB, cDnsHaSyncMergeNameCnts=cDnsHaSyncMergeNameCnts, cDnsMaxCntrHaBatchLimitCnts=cDnsMaxCntrHaBatchLimitCnts, cDnsMaxCntrConcurXfrsOutCnts=cDnsMaxCntrConcurXfrsOutCnts, cDnsHaIntMsgConnectRcvdCnts=cDnsHaIntMsgConnectRcvdCnts, cDnsHaMsgZoneSyncSentCnts=cDnsHaMsgZoneSyncSentCnts, cDnsQueryRelNameRequests=cDnsQueryRelNameRequests, cDnsSecurityRcvdTsigBadTimes=cDnsSecurityRcvdTsigBadTimes, cDnsHaMsgReconcileSentCnts=cDnsHaMsgReconcileSentCnts, cDnsHaMsgRRUpdateRcvdCnts=cDnsHaMsgRRUpdateRcvdCnts, cDnsHaIntResponseServFailCnts=cDnsHaIntResponseServFailCnts, cDnsHaRespInconsistentCnts=cDnsHaRespInconsistentCnts, cDnsServConfigResetTime=cDnsServConfigResetTime, cDnsErrorIntervalStats=cDnsErrorIntervalStats, cDnsPerfOutboundIxfrs=cDnsPerfOutboundIxfrs, cDnsSecurityIntRcvdTsigBadKeys=cDnsSecurityIntRcvdTsigBadKeys, cDnsHaMsgShutdownRcvdCnts=cDnsHaMsgShutdownRcvdCnts, cDnsPerfIntervalStats=cDnsPerfIntervalStats, cDnsPerfStats=cDnsPerfStats, cDnsServMIBGroups=cDnsServMIBGroups, cDnsPerfIntOutboundNotifies=cDnsPerfIntOutboundNotifies, cDnsHaIntCommInterruptedStates=cDnsHaIntCommInterruptedStates, cDnsHaIntMsgConnectSentCnts=cDnsHaIntMsgConnectSentCnts, cDnsErrorIntRcvdFormatErrors=cDnsErrorIntRcvdFormatErrors, cDnsHaIntMsgReconcileRcvdCnts=cDnsHaIntMsgReconcileRcvdCnts, cDnsSecurityStatsIntervalGroup=cDnsSecurityStatsIntervalGroup, cDnsErrorUpdateErrors=cDnsErrorUpdateErrors, cDnsPerfStatsGroup=cDnsPerfStatsGroup, cDnsHaResponseServFailCnts=cDnsHaResponseServFailCnts, cDnsHaIntUpdateRejectCnts=cDnsHaIntUpdateRejectCnts, cDnsQueryMemCacheMisses=cDnsQueryMemCacheMisses, cDnsSecurityIntRcvdTsigBadSigs=cDnsSecurityIntRcvdTsigBadSigs, cDnsSecurityIntSampleTime=cDnsSecurityIntSampleTime, cDnsHaIntMsgSyncPendingSentCnts=cDnsHaIntMsgSyncPendingSentCnts, cDnsHaIntMsgZoneSyncRcvdCnts=cDnsHaIntMsgZoneSyncRcvdCnts, cDnsServConfigRecurs=cDnsServConfigRecurs, cDnsErrorIntIxfrOutErrors=cDnsErrorIntIxfrOutErrors, cDnsHaIntMsgHeartbeatRcvdCnts=cDnsHaIntMsgHeartbeatRcvdCnts, cDnsErrorIxfrInErrors=cDnsErrorIxfrInErrors, cDnsQueryIntMemCacheMisses=cDnsQueryIntMemCacheMisses, cDnsHaIntUpdatePrivateReqCnts=cDnsHaIntUpdatePrivateReqCnts, cDnsErrorIntSampleTime=cDnsErrorIntSampleTime, cDnsHaIntResponseMismatchCnts=cDnsHaIntResponseMismatchCnts, cDnsServConfigImplementIdent=cDnsServConfigImplementIdent, cDnsPerfIntOutboundIxfrs=cDnsPerfIntOutboundIxfrs, cDnsPerfIntInboundNotifies=cDnsPerfIntInboundNotifies, cDnsSecurityIntUnauthUpdateReqs=cDnsSecurityIntUnauthUpdateReqs, cDnsMaxCntrIntHaSvrMaxNoRespTime=cDnsMaxCntrIntHaSvrMaxNoRespTime, cDnsMaxCntrIntHaBatchLimitCnts=cDnsMaxCntrIntHaBatchLimitCnts, cDnsErrorIntIxfrInErrors=cDnsErrorIntIxfrInErrors, cDnsErrorIntSampleInterval=cDnsErrorIntSampleInterval, cDnsPerfUpdatePkts=cDnsPerfUpdatePkts, cDnsMaxCounterIntervalStats=cDnsMaxCounterIntervalStats, cDnsQueryMemCacheHits=cDnsQueryMemCacheHits, cDnsMaxCntrHaRRPendListCnts=cDnsMaxCntrHaRRPendListCnts, cDnsSecurityRcvdTsigPackets=cDnsSecurityRcvdTsigPackets, cDnsHaMsgConnectRcvdCnts=cDnsHaMsgConnectRcvdCnts, cDnsHaIntMsgHeartBeatSentCnts=cDnsHaIntMsgHeartBeatSentCnts, cDnsHaIntMsgRRSyncSentCnts=cDnsHaIntMsgRRSyncSentCnts, cDnsMaxCntrHaSvrMaxNoRespTime=cDnsMaxCntrHaSvrMaxNoRespTime, cDnsQueryIntMemCacheWrites=cDnsQueryIntMemCacheWrites, cDnsHaIntMsgResponseSentCnts=cDnsHaIntMsgResponseSentCnts, cDnsErrorSentFormatErrors=cDnsErrorSentFormatErrors, cDnsMaxCntrHaPersEditListCnts=cDnsMaxCntrHaPersEditListCnts, CDnsTime=CDnsTime, cDnsPerfOutboundAxfrs=cDnsPerfOutboundAxfrs, cDnsQueryIntSampleTime=cDnsQueryIntSampleTime, cDnsHaSyncConflictCnts=cDnsHaSyncConflictCnts, cDnsQueryIntAuthNoDataResps=cDnsQueryIntAuthNoDataResps, cDnsQueryIntLameDelegations=cDnsQueryIntLameDelegations, cDnsHaUpdatePrivateRespCnts=cDnsHaUpdatePrivateRespCnts, cDnsQueryStatsIntervalGroup=cDnsQueryStatsIntervalGroup, cDnsErrorStats=cDnsErrorStats, cDnsErrorAxfrOutErrors=cDnsErrorAxfrOutErrors, cDnsHaIntervalStats=cDnsHaIntervalStats, cDnsSecurityIntRestrictQueryAcls=cDnsSecurityIntRestrictQueryAcls, cDnsSecurityIntDetectTsigBadKeys=cDnsSecurityIntDetectTsigBadKeys, cDnsSecurityIntUnauthXferReqs=cDnsSecurityIntUnauthXferReqs, cDnsHaCommInterruptedStates=cDnsHaCommInterruptedStates, cDnsHaIntSampleTime=cDnsHaIntSampleTime, cDnsHaMsgRRSyncRcvdCnts=cDnsHaMsgRRSyncRcvdCnts, cDnsHaMsgResponseRcvdCnts=cDnsHaMsgResponseRcvdCnts, cDnsHaIntMsgResponseRcvdCnts=cDnsHaIntMsgResponseRcvdCnts, cDnsMaxCounterStatsGroup=cDnsMaxCounterStatsGroup, cDnsMaxCntrIntSampleTime=cDnsMaxCntrIntSampleTime, cDnsQueryAuthNoNames=cDnsQueryAuthNoNames, cDnsHaIntMsgRRSyncRcvdCnts=cDnsHaIntMsgRRSyncRcvdCnts, cDnsHaMsgResponseSentCnts=cDnsHaMsgResponseSentCnts, cDnsErrorRcvdFormatErrors=cDnsErrorRcvdFormatErrors, cDnsMaxCntrIntHaUpdLatencyMax=cDnsMaxCntrIntHaUpdLatencyMax, cDnsHaMsgSyncPendingRcvdCnts=cDnsHaMsgSyncPendingRcvdCnts, cDnsHaIntMsgShutdownSentCnts=cDnsHaIntMsgShutdownSentCnts, cDnsQueryIntervalStats=cDnsQueryIntervalStats, cDnsPerfInboundIxfrs=cDnsPerfInboundIxfrs, cDnsPerfIntSampleInterval=cDnsPerfIntSampleInterval, cDnsHaIntHeartbeatTimeoutCnts=cDnsHaIntHeartbeatTimeoutCnts, cDnsMaxCounterStats=cDnsMaxCounterStats, cDnsQueryIntNonAuthAnswers=cDnsQueryIntNonAuthAnswers, cDnsErrorIntSentFormatErrors=cDnsErrorIntSentFormatErrors, cDnsHaMsgRRSyncSentCnts=cDnsHaMsgRRSyncSentCnts, cDnsServMIBCompliance=cDnsServMIBCompliance, cDnsQueryIntRelNameRequests=cDnsQueryIntRelNameRequests, cDnsHaIntSyncs=cDnsHaIntSyncs, cDnsQueryStatsGroup=cDnsQueryStatsGroup, cDnsMaxCntrIntHaRRActiveListCnts=cDnsMaxCntrIntHaRRActiveListCnts, cDnsHaHeartbeatTimeoutCnts=cDnsHaHeartbeatTimeoutCnts, cDnsHaMsgConnectSentCnts=cDnsHaMsgConnectSentCnts, cDnsQueryIntSampleInterval=cDnsQueryIntSampleInterval, cDnsHaMsgHeartbeatRcvdCnts=cDnsHaMsgHeartbeatRcvdCnts, cDnsQueryIntNonAuthNoDataResps=cDnsQueryIntNonAuthNoDataResps, cDnsSecurityRcvdTsigBadSigs=cDnsSecurityRcvdTsigBadSigs, cDnsPerfIntOutboundAtLimitXfrs=cDnsPerfIntOutboundAtLimitXfrs, cDnsHaIntFullZoneResyncCnts=cDnsHaIntFullZoneResyncCnts, cDnsSecurityIntSampleInterval=cDnsSecurityIntSampleInterval, cDnsErrorAxfrInErrors=cDnsErrorAxfrInErrors, cDnsQueryLameDelegations=cDnsQueryLameDelegations, cDnsPerfIntUpdatePkts=cDnsPerfIntUpdatePkts, cDnsMaxCntrHaRRActiveListCnts=cDnsMaxCntrHaRRActiveListCnts, cDnsHaMsgSyncPendingSentCnts=cDnsHaMsgSyncPendingSentCnts, cDnsHaMsgShutdownSentCnts=cDnsHaMsgShutdownSentCnts, cDnsSecurityStats=cDnsSecurityStats, cDnsErrorIntSentOtherErrors=cDnsErrorIntSentOtherErrors, cDnsSecurityStatsGroup=cDnsSecurityStatsGroup, cDnsServConfigReset=cDnsServConfigReset, cDnsErrorIxfrOutErrors=cDnsErrorIxfrOutErrors, cDnsServMIBConform=cDnsServMIBConform, cDnsErrorStatsIntervalGroup=cDnsErrorStatsIntervalGroup, cDnsSecurityDetectTsigBadKeys=cDnsSecurityDetectTsigBadKeys, cDnsPerfFullRespIxfrs=cDnsPerfFullRespIxfrs, cDnsHaIntSyncConflictCnts=cDnsHaIntSyncConflictCnts, cDnsHaSyncDiscardNameCnts=cDnsHaSyncDiscardNameCnts, cDnsHaMsgReconcileRcvdCnts=cDnsHaMsgReconcileRcvdCnts, cDnsServConfigGroup=cDnsServConfigGroup, cDnsHaIntRespUnknownCnts=cDnsHaIntRespUnknownCnts, cDnsHaIntMsgRRUpdateRcvdCnts=cDnsHaIntMsgRRUpdateRcvdCnts, cDnsSecurityDetecTsigBadTimes=cDnsSecurityDetecTsigBadTimes)
