...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-RPVST-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:38:43 2025
...
_HpicfRpvstResetCounters_Type.__name__ = "TruthValue"
...
_HpicfRpvstExtendedSystemID_Type.__name__ = "TruthValue"
...
_HpicfRpvstIgnorePVIDInconsistency_Type.__name__ = "TruthValue"
...
_HpicfRpvstVlanResetCounters_Type.__name__ = "TruthValue"
...
_HpicfRpvstSendTopoChangeCtrl_Type.__name__ = "TruthValue"
...
_HpicfRpvstLogPortStateTransitions_Type.__name__ = "TruthValue"
...
_HpicfRpvstPortRootGuard_Type.__name__ = "TruthValue"
...
_HpicfRpvstPortLoopGuard_Type.__name__ = "TruthValue"
...
_HpicfRpvstPortBpduProtection_Type.__name__ = "TruthValue"
...
_HpicfRpvstPortIeeeRstBpdu_Type.__name__ = "TruthValue"
...
_HpicfRpvstPortVlanResetCounters_Type.__name__ = "TruthValue"
...
hpicfRpvstCompliance1.setObjects(
      *(("HP-ICF-RPVST-MIB", "hpicfRpvstGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstVlanGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstPortVlanGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstPortGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstPortVlanCounterGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstRootHistoryGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstNotificationObjectGrp"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstNotificationGroup"))
)
if mibBuilder.loadTexts:
...
hpicfRpvstCompliance2.setObjects(
      *(("HP-ICF-RPVST-MIB", "hpicfRpvstPvst1"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstNotificationGroupPvst1"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstNotificationObjectGrpPvst1"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstTopologyRxGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstTopologyTxGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstPortRoleChangeGroup"))
)
if mibBuilder.loadTexts:
...
hpicfRpvstCompliance3.setObjects(
      *(("HP-ICF-RPVST-MIB", "hpicfRpvstGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstVlanGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstPortVlanGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstPortGroup1"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstPortVlanCounterGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstRootHistoryGroup"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstNotificationObjectGrp"),
        ("HP-ICF-RPVST-MIB", "hpicfRpvstNotificationGroup"))
