...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-TRUSTSEC-INTERFACE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:40:01 2025
...
_CtsiIfDot1xSgtPropagateEnabled_Type.__name__ = "TruthValue"
...
_CtsiIfDot1xReauthInterval_Type.__name__ = "Integer32"
...
_CtsiIfDot1xSapModeList_Type.__name__ = "CtsSapNegModeList"
...
_CtsiIfDot1xStorageType_Type.__name__ = "StorageType"
...
class _CtsiIfManualDynamicPeerId_Type(SnmpAdminString):
    """Custom type ctsiIfManualDynamicPeerId based on SnmpAdminString"""
    defaultValue = OctetString("")


_CtsiIfManualDynamicPeerId_Type.__name__ = "SnmpAdminString"
...
_CtsiIfManualStaticSgt_Type.__name__ = "CtsSecurityGroupTag"
...
_CtsiIfManualStaticSgtTrusted_Type.__name__ = "TruthValue"
...
_CtsiIfManualSgtPropagateEnabled_Type.__name__ = "TruthValue"
...
class _CtsiIfManualSapModeList_Type(CtsSapNegModeList):
    """Custom type ctsiIfManualSapModeList based on CtsSapNegModeList"""
    defaultValue = OctetString("")


_CtsiIfManualSapModeList_Type.__name__ = "CtsSapNegModeList"
...
_CtsiIfManualStorageType_Type.__name__ = "StorageType"
...
_CtsiIfL3ForwardStorageType_Type.__name__ = "StorageType"
...
ciscoTrustSecIfMIBCompliance.setObjects(
      *(("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBIfConfigGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBDot1xGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBManualGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBL3ForwardGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBStatusGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBStatisticGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBAuthorizationGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBIfcStatisticGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBEventStatisticGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBIfModeStatisticGroup"))
)
if mibBuilder.loadTexts:
...
ciscoTrustSecIfMIBCompliance2.setObjects(
      *(("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBIfConfigGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBDot1xGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBManualGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBL3ForwardGroup"),
        ...
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBEventStatisticGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBIfModeStatisticGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBNotifsCtrlGrp"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBNotifsOnlyInfoGrp"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBNotifsGrp"))
)
if mibBuilder.loadTexts:
...
ciscoTrustSecIfMIBCompliance3.setObjects(
      *(("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBIfConfigGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBDot1xGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBManualGroup"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBL3ForwardGroup"),
        ...
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBNotifsOnlyInfoGrp"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBNotifsGrp"),
        ("CISCO-TRUSTSEC-INTERFACE-MIB", "ciscoTrustSecIfMIBCriticalAuthStatusGrp"))
)
if mibBuilder.loadTexts:
