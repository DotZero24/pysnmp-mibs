...
mibBuilder.exportSymbols("ALGPOWER_v2-MIB", overload=overload, watchdogPing9=watchdogPing9, watchdogPing5=watchdogPing5, chargerStatus=chargerStatus, batteryVoltage=batteryVoltage, btst_elapsed=btst_elapsed, output=output, innerTemperature=innerTemperature, algcom=algcom, facilityAddr=facilityAddr, batBrand=batBrand, bat_tst=bat_tst, installation=installation, batteryCharging=batteryCharging, watchdogPing3=watchdogPing3, batteryDischarging=batteryDischarging, oidNotUsed3=oidNotUsed3, upTime=upTime, btst_amp_f=btst_amp_f, watchdogPing7=watchdogPing7, fanBfail=fanBfail, alarmOnBattery=alarmOnBattery, input=input, facilityCity=facilityCity, watchdogPing2=watchdogPing2, watchdogPing8=watchdogPing8, watchdogPing1=watchdogPing1, btst_status=btst_status, temperature=temperature, watchdog=watchdog, fanAfail=fanAfail, btst_duration=btst_duration, overheat=overheat, outputCurrent=outputCurrent, btst_date=btst_date, acFail=acFail, watchdogPing10=watchdogPing10, watchdogPing4=watchdogPing4, popName=popName, batCapacity=batCapacity, oidNotUsed1=oidNotUsed1, oidNotUsed2=oidNotUsed2, heatSinkTemperature=heatSinkTemperature, instDate=instDate, upsObjects=upsObjects, btst_volt_i=btst_volt_i, outerTemperature=outerTemperature, supplyVoltage=supplyVoltage, batInstDate=batInstDate, watchdogPing6=watchdogPing6, battery=battery, btst_volt_f=btst_volt_f, outputVoltage=outputVoltage, oidNotUsed0=oidNotUsed0, respPers=respPers, supply=supply, batteryCurrent=batteryCurrent, btst_amp_i=btst_amp_i)
