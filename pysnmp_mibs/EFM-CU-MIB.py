...
ifIndex, ifSpeed, InterfaceIndex = mibBuilder.importSymbols("IF-MIB", "ifIndex", "ifSpeed", "InterfaceIndex")
...
mibBuilder.exportSymbols("EFM-CU-MIB", efmCuPAFInLostEnds=efmCuPAFInLostEnds, efmCuPortConfTable=efmCuPortConfTable, efmCuPmeSnrMonitoringInterval=efmCuPmeSnrMonitoringInterval, efmCuMIB=efmCuMIB, efmCuPme10PUPBOReferenceProfile=efmCuPme10PUPBOReferenceProfile, efmCuPme10PProfileIndex=efmCuPme10PProfileIndex, efmCuPmeOperStatus=efmCuPmeOperStatus, efmCuPme2BConstellation=efmCuPme2BConstellation, efmCuPortSide=efmCuPortSide, efmCuPmeLinkTrfcDisablTrapEnable=efmCuPmeLinkTrfcDisablTrapEnable, efmCuPmeMaintenanceMode=efmCuPmeMaintenanceMode, efmCuPme10PPayloadDRateProfile=efmCuPme10PPayloadDRateProfile, efmCuRegenLOSWS=efmCuRegenLOSWS, efmCuPme10PBandNotchProfiles=efmCuPme10PBandNotchProfiles, efmCuPme2BPower=efmCuPme2BPower, efmCuPmeGroup=efmCuPmeGroup, efmCuRegenSNR=efmCuRegenSNR, ifAvailableStackTable=ifAvailableStackTable, PYSNMP_MODULE_ID=efmCuMIB, efmCuPmeSnrMgnCrossingTrapEnable=efmCuPmeSnrMgnCrossingTrapEnable, efmCuPmeErrorThreshMonInterval=efmCuPmeErrorThreshMonInterval, efmCuPmeErrorRestartCnt=efmCuPmeErrorRestartCnt, ifAvailableStackStatus=ifAvailableStackStatus, efmCuThreshLowBandwidth=efmCuThreshLowBandwidth, efmCuPortStatusTable=efmCuPortStatusTable, ProfileIndexList=ProfileIndexList, efmCuPmeTCCodingErrors=efmCuPmeTCCodingErrors, efmCuPAFInSmallFragments=efmCuPAFInSmallFragments, efmCuRegenCRC=efmCuRegenCRC, efmCuPmeThreshLineAtn=efmCuPmeThreshLineAtn, efmCuRegenES=efmCuRegenES, efmCuPmeLineAtn=efmCuPmeLineAtn, efmCuPmeAdminSubType=efmCuPmeAdminSubType, efmCuPAFErrorsGroup=efmCuPAFErrorsGroup, efmCuPmeErrorTCDownCnt=efmCuPmeErrorTCDownCnt, efmCuPAFAdminState=efmCuPAFAdminState, efmCuTargetWorstCaseSnrMgn=efmCuTargetWorstCaseSnrMgn, efmCuPmeSnrCrossingCnt=efmCuPmeSnrCrossingCnt, TruthValueOrUnknown=TruthValueOrUnknown, efmCuPmeErrorMaxConsecutiveSec=efmCuPmeErrorMaxConsecutiveSec, efmCuPmeConfigInitFailure=efmCuPmeConfigInitFailure, efmCuPmeErrorConsecutiveSec=efmCuPmeErrorConsecutiveSec, efmCuPAFInLargeFragments=efmCuPAFInLargeFragments, efmCuTargetDataRate=efmCuTargetDataRate, efmCuPAFInBadFragments=efmCuPAFInBadFragments, efmCuRegeneratorStatusEntry=efmCuRegeneratorStatusEntry, efmCuPme2BProfileEntry=efmCuPme2BProfileEntry, efmCuPme10PStatusTable=efmCuPme10PStatusTable, efmCuPme10PProfileTable=efmCuPme10PProfileTable, efmCuPAFCapacity=efmCuPAFCapacity, efmCuPAFInLostFragments=efmCuPAFInLostFragments, efmCuTargetWorstCaseMode=efmCuTargetWorstCaseMode, efmCuLowBandwidth=efmCuLowBandwidth, efmCuConformance=efmCuConformance, efmCuPmeTCDownCnt=efmCuPmeTCDownCnt, efmCuPAFInLostStarts=efmCuPAFInLostStarts, efmCuPort=efmCuPort, ifAvailableStackEntry=ifAvailableStackEntry, efmCuRegenDCAlarm=efmCuRegenDCAlarm, efmCuPmeMaintenanceEndTime=efmCuPmeMaintenanceEndTime, efmCuPmeThreshMinSnrMgn=efmCuPmeThreshMinSnrMgn, efmCuPme10PProfileRowStatus=efmCuPme10PProfileRowStatus, efmCuPortNotifications=efmCuPortNotifications, efmCuPme=efmCuPme, efmCuPmePeerSnrMgn=efmCuPmePeerSnrMgn, efmCuFltStatus=efmCuFltStatus, efmCuPAFInOverflows=efmCuPAFInOverflows, efmCuPmeErrorThreshEfmTrafficEnable=efmCuPmeErrorThreshEfmTrafficEnable, efmCuPAFDiscoveryCode=efmCuPAFDiscoveryCode, efmCuPme10PFECCorrectedBlocks=efmCuPme10PFECCorrectedBlocks, efmCuBasicGroup=efmCuBasicGroup, efmCuPmeSnrMgn=efmCuPmeSnrMgn, efmCuPme10PStatusEntry=efmCuPme10PStatusEntry, ifStackCapabilityGroup=ifStackCapabilityGroup, efmCuPAFAutoDiscovery=efmCuPAFAutoDiscovery, efmCuRegenUAS=efmCuRegenUAS, ifAvailableStackHigherLayer=ifAvailableStackHigherLayer, efmCuPmeProtocolInitFailure=efmCuPmeProtocolInitFailure, efmCuRegenIndex=efmCuRegenIndex, efmCuTargetCurrentConditionSnrMgn=efmCuTargetCurrentConditionSnrMgn, efmCuAdminProfile=efmCuAdminProfile, efmCuPmeOperProfile=efmCuPmeOperProfile, efmCuPeerPAFSupported=efmCuPeerPAFSupported, efmCuPmeConfTable=efmCuPmeConfTable, efmCuPmeSnrMgnCrossingClear=efmCuPmeSnrMgnCrossingClear, efmCuPme10PProfileEntry=efmCuPme10PProfileEntry, efmCuPeerPAFCapacity=efmCuPeerPAFCapacity, efmCuPmeConfigInitFailEnable=efmCuPmeConfigInitFailEnable, efmCuPme2BProfileIndex=efmCuPme2BProfileIndex, efmCuPme10PBandplanPSDMskProfile=efmCuPme10PBandplanPSDMskProfile, efmCuPme2BProfileGroup=efmCuPme2BProfileGroup, efmCuPmePeerLineAtn=efmCuPmePeerLineAtn, efmCuPAFRemoteDiscoveryCode=efmCuPAFRemoteDiscoveryCode, efmCuPme10PProfileGroup=efmCuPme10PProfileGroup, efmCuPmeCapabilityEntry=efmCuPmeCapabilityEntry, efmCuPmeErrorClearStats=efmCuPmeErrorClearStats, efmCuLowBandwidthEnable=efmCuLowBandwidthEnable, efmCuPmeNtr=efmCuPmeNtr, efmCuPme10P=efmCuPme10P, efmCuPmeNotifications=efmCuPmeNotifications, efmCuObjects=efmCuObjects, efmCuPmeLinkTrafficEnabled=efmCuPmeLinkTrafficEnabled, efmCuPmeDeviceFaultEnable=efmCuPmeDeviceFaultEnable, efmCuPme2B=efmCuPme2B, efmCuPme2BRegion=efmCuPme2BRegion, efmCuPmeLinkTrafficDisabled=efmCuPmeLinkTrafficDisabled, efmCuPme2BDataRate=efmCuPme2BDataRate, efmCuPmeMaintenanceStartTime=efmCuPmeMaintenanceStartTime, ProfileIndex=ProfileIndex, efmCuPAFGroup=efmCuPAFGroup, efmCuRegenClearCounts=efmCuRegenClearCounts, efmCuPmeFltStatus=efmCuPmeFltStatus, efmCuPmeBondGroupTrafficEnabled=efmCuPmeBondGroupTrafficEnabled, ProfileIndexOrZero=ProfileIndexOrZero, efmCuPme10PPayloadURateProfile=efmCuPme10PPayloadURateProfile, efmCuPme10PFECUncorrectedBlocks=efmCuPme10PFECUncorrectedBlocks, efmCuRegeneratorStatusTable=efmCuRegeneratorStatusTable, efmCuPmeOperSubType=efmCuPmeOperSubType, efmCuRegenSES=efmCuRegenSES, efmCuPmeSnrRestartCnt=efmCuPmeSnrRestartCnt, efmCuRegenLineAttn=efmCuRegenLineAttn, efmCuPmeDeviceFault=efmCuPmeDeviceFault, efmCuPmeStatusTable=efmCuPmeStatusTable, efmCuPme10PProfileDescr=efmCuPme10PProfileDescr, efmCuPmeErrorThreshEfmTrafficDisable=efmCuPmeErrorThreshEfmTrafficDisable, efmCuPmeThreshMaxSnrMgnDelta=efmCuPmeThreshMaxSnrMgnDelta, efmCuCompliance=efmCuCompliance, efmCuPme2BProfileDescr=efmCuPme2BProfileDescr, efmCuPmeSnrMgnCrossing=efmCuPmeSnrMgnCrossing, efmCuRegenSide=efmCuRegenSide, efmCuPme2BProfileTable=efmCuPme2BProfileTable, efmCuPortConfEntry=efmCuPortConfEntry, efmCuPmeCapabilityTable=efmCuPmeCapabilityTable, efmCuNotificationGroup=efmCuNotificationGroup, efmCuAlarmConfGroup=efmCuAlarmConfGroup, efmCuPme10PElectricalLength=efmCuPme10PElectricalLength, efmCuPmeConfEntry=efmCuPmeConfEntry, efmCuPmeSnrClearStats=efmCuPmeSnrClearStats, efmCuPme10PStatusGroup=efmCuPme10PStatusGroup, efmCuCompliances=efmCuCompliances, efmCuPmeStatusEntry=efmCuPmeStatusEntry, efmCuPortStatusEntry=efmCuPortStatusEntry, efmCuPAFSupported=efmCuPAFSupported, efmCuNumPMEs=efmCuNumPMEs, efmCuPAFInErrors=efmCuPAFInErrors, efmCuGroups=efmCuGroups, efmCuPmeAdminProfile=efmCuPmeAdminProfile, efmCuRegeneratorStats=efmCuRegeneratorStats, efmCuPmeLineAtnCrossingEnable=efmCuPmeLineAtnCrossingEnable, efmCuPme2BProfileRowStatus=efmCuPme2BProfileRowStatus, efmCuPortCapabilityEntry=efmCuPortCapabilityEntry, ifAvailableStackLowerLayer=ifAvailableStackLowerLayer, efmCuPmeErrorThreshMonClrInterval=efmCuPmeErrorThreshMonClrInterval, efmCuPmeTCCrcErrors=efmCuPmeTCCrcErrors, efmCuPmeLineAtnCrossing=efmCuPmeLineAtnCrossing, efmCuTargetCurrentConditionMode=efmCuTargetCurrentConditionMode, efmCuPmeErrorThreshMonEnable=efmCuPmeErrorThreshMonEnable, efmCuPmeSubTypesSupported=efmCuPmeSubTypesSupported, efmCuPmeErrorThreshMonNotifyEnable=efmCuPmeErrorThreshMonNotifyEnable, efmCuPmeBondGroupTrafficDisabled=efmCuPmeBondGroupTrafficDisabled, efmCuPortCapabilityTable=efmCuPortCapabilityTable, efmCuPmeProtocolInitFailEnable=efmCuPmeProtocolInitFailEnable)
