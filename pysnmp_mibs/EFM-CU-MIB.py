...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/zhone/EFM-CU-MIB
...
ifIndex, InterfaceIndex, ifSpeed = mibBuilder.importSymbols("IF-MIB", "ifIndex", "InterfaceIndex", "ifSpeed")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
ModuleIdentity, Counter64, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, iso, MibIdentifier, mib_2, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "iso", "MibIdentifier", "mib-2", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("EFM-CU-MIB", efmCuPmeSnrRestartCnt=efmCuPmeSnrRestartCnt, efmCuPmeMaintenanceStartTime=efmCuPmeMaintenanceStartTime, efmCuPmeLineAtnCrossing=efmCuPmeLineAtnCrossing, efmCuPmeMaintenanceEndTime=efmCuPmeMaintenanceEndTime, efmCuPmeSnrClearStats=efmCuPmeSnrClearStats, efmCuRegenSide=efmCuRegenSide, efmCuPAFInOverflows=efmCuPAFInOverflows, efmCuPmeOperSubType=efmCuPmeOperSubType, ProfileIndexList=ProfileIndexList, efmCuPme10PBandNotchProfiles=efmCuPme10PBandNotchProfiles, efmCuPmeNotifications=efmCuPmeNotifications, efmCuPmeLinkTrfcDisablTrapEnable=efmCuPmeLinkTrfcDisablTrapEnable, efmCuPmeFltStatus=efmCuPmeFltStatus, efmCuTargetWorstCaseMode=efmCuTargetWorstCaseMode, efmCuThreshLowBandwidth=efmCuThreshLowBandwidth, efmCuPme2B=efmCuPme2B, efmCuTargetCurrentConditionMode=efmCuTargetCurrentConditionMode, efmCuPmeSnrMonitoringInterval=efmCuPmeSnrMonitoringInterval, efmCuPmeDeviceFaultEnable=efmCuPmeDeviceFaultEnable, ifStackCapabilityGroup=ifStackCapabilityGroup, efmCuLowBandwidth=efmCuLowBandwidth, efmCuPmeNtr=efmCuPmeNtr, efmCuRegenUAS=efmCuRegenUAS, efmCuPmeThreshLineAtn=efmCuPmeThreshLineAtn, efmCuPmeLineAtn=efmCuPmeLineAtn, efmCuRegeneratorStatusEntry=efmCuRegeneratorStatusEntry, efmCuConformance=efmCuConformance, efmCuPAFAdminState=efmCuPAFAdminState, efmCuPmeDeviceFault=efmCuPmeDeviceFault, efmCuPmeTCCodingErrors=efmCuPmeTCCodingErrors, efmCuPme2BDataRate=efmCuPme2BDataRate, efmCuPmeLineAtnCrossingEnable=efmCuPmeLineAtnCrossingEnable, efmCuPme10PStatusGroup=efmCuPme10PStatusGroup, efmCuRegenClearCounts=efmCuRegenClearCounts, ProfileIndexOrZero=ProfileIndexOrZero, efmCuAdminProfile=efmCuAdminProfile, efmCuPortStatusEntry=efmCuPortStatusEntry, efmCuPAFInSmallFragments=efmCuPAFInSmallFragments, efmCuPme10PPayloadDRateProfile=efmCuPme10PPayloadDRateProfile, efmCuObjects=efmCuObjects, efmCuPme2BProfileGroup=efmCuPme2BProfileGroup, efmCuPme2BProfileEntry=efmCuPme2BProfileEntry, efmCuPort=efmCuPort, efmCuPeerPAFSupported=efmCuPeerPAFSupported, efmCuAlarmConfGroup=efmCuAlarmConfGroup, efmCuPme10PProfileGroup=efmCuPme10PProfileGroup, efmCuPortStatusTable=efmCuPortStatusTable, efmCuPortConfTable=efmCuPortConfTable, efmCuPortConfEntry=efmCuPortConfEntry, efmCuPmeSnrCrossingCnt=efmCuPmeSnrCrossingCnt, efmCuPmeErrorTCDownCnt=efmCuPmeErrorTCDownCnt, efmCuNotificationGroup=efmCuNotificationGroup, efmCuRegenLOSWS=efmCuRegenLOSWS, efmCuPAFInLostEnds=efmCuPAFInLostEnds, efmCuPmeErrorThreshMonClrInterval=efmCuPmeErrorThreshMonClrInterval, efmCuPAFInErrors=efmCuPAFInErrors, efmCuPme2BPower=efmCuPme2BPower, efmCuPAFInBadFragments=efmCuPAFInBadFragments, efmCuPmeSnrMgnCrossingClear=efmCuPmeSnrMgnCrossingClear, ifAvailableStackTable=ifAvailableStackTable, efmCuPmeLinkTrafficDisabled=efmCuPmeLinkTrafficDisabled, efmCuPortCapabilityEntry=efmCuPortCapabilityEntry, efmCuPmeTCCrcErrors=efmCuPmeTCCrcErrors, efmCuPmeOperProfile=efmCuPmeOperProfile, efmCuCompliances=efmCuCompliances, efmCuPmeSnrMgn=efmCuPmeSnrMgn, efmCuGroups=efmCuGroups, efmCuPmeStatusTable=efmCuPmeStatusTable, efmCuRegenLineAttn=efmCuRegenLineAttn, efmCuFltStatus=efmCuFltStatus, efmCuPme10PProfileRowStatus=efmCuPme10PProfileRowStatus, TruthValueOrUnknown=TruthValueOrUnknown, efmCuPme10P=efmCuPme10P, efmCuPAFAutoDiscovery=efmCuPAFAutoDiscovery, efmCuPmePeerSnrMgn=efmCuPmePeerSnrMgn, efmCuPme2BProfileDescr=efmCuPme2BProfileDescr, efmCuLowBandwidthEnable=efmCuLowBandwidthEnable, efmCuPme2BProfileTable=efmCuPme2BProfileTable, efmCuPme2BProfileIndex=efmCuPme2BProfileIndex, ifAvailableStackLowerLayer=ifAvailableStackLowerLayer, efmCuPmeConfigInitFailure=efmCuPmeConfigInitFailure, efmCuPmePeerLineAtn=efmCuPmePeerLineAtn, efmCuRegenES=efmCuRegenES, efmCuPme10PProfileIndex=efmCuPme10PProfileIndex, efmCuPAFCapacity=efmCuPAFCapacity, efmCuPme10PFECUncorrectedBlocks=efmCuPme10PFECUncorrectedBlocks, efmCuPortNotifications=efmCuPortNotifications, efmCuPmeErrorMaxConsecutiveSec=efmCuPmeErrorMaxConsecutiveSec, efmCuPme10PUPBOReferenceProfile=efmCuPme10PUPBOReferenceProfile, efmCuPme10PProfileTable=efmCuPme10PProfileTable, efmCuRegenSES=efmCuRegenSES, efmCuCompliance=efmCuCompliance, efmCuPmeErrorThreshMonInterval=efmCuPmeErrorThreshMonInterval, efmCuPme=efmCuPme, efmCuPortSide=efmCuPortSide, ifAvailableStackHigherLayer=ifAvailableStackHigherLayer, efmCuPmeThreshMinSnrMgn=efmCuPmeThreshMinSnrMgn, efmCuPmeErrorConsecutiveSec=efmCuPmeErrorConsecutiveSec, efmCuPmeAdminSubType=efmCuPmeAdminSubType, efmCuRegeneratorStatusTable=efmCuRegeneratorStatusTable, efmCuPme10PElectricalLength=efmCuPme10PElectricalLength, efmCuPmeErrorThreshEfmTrafficDisable=efmCuPmeErrorThreshEfmTrafficDisable, efmCuPme10PBandplanPSDMskProfile=efmCuPme10PBandplanPSDMskProfile, efmCuPme10PFECCorrectedBlocks=efmCuPme10PFECCorrectedBlocks, efmCuPmeErrorClearStats=efmCuPmeErrorClearStats, ProfileIndex=ProfileIndex, efmCuPmeErrorRestartCnt=efmCuPmeErrorRestartCnt, efmCuTargetDataRate=efmCuTargetDataRate, efmCuPme10PProfileEntry=efmCuPme10PProfileEntry, efmCuRegenSNR=efmCuRegenSNR, efmCuPmeBondGroupTrafficEnabled=efmCuPmeBondGroupTrafficEnabled, efmCuPmeProtocolInitFailEnable=efmCuPmeProtocolInitFailEnable, efmCuPmeConfEntry=efmCuPmeConfEntry, efmCuPme10PProfileDescr=efmCuPme10PProfileDescr, efmCuPmeCapabilityEntry=efmCuPmeCapabilityEntry, efmCuPAFSupported=efmCuPAFSupported, efmCuPme10PPayloadURateProfile=efmCuPme10PPayloadURateProfile, efmCuPme2BProfileRowStatus=efmCuPme2BProfileRowStatus, efmCuPmeLinkTrafficEnabled=efmCuPmeLinkTrafficEnabled, efmCuRegenCRC=efmCuRegenCRC, efmCuPortCapabilityTable=efmCuPortCapabilityTable, efmCuPmeConfTable=efmCuPmeConfTable, efmCuPmeSnrMgnCrossing=efmCuPmeSnrMgnCrossing, efmCuTargetCurrentConditionSnrMgn=efmCuTargetCurrentConditionSnrMgn, efmCuPeerPAFCapacity=efmCuPeerPAFCapacity, PYSNMP_MODULE_ID=efmCuMIB, efmCuPmeProtocolInitFailure=efmCuPmeProtocolInitFailure, efmCuRegeneratorStats=efmCuRegeneratorStats, efmCuRegenIndex=efmCuRegenIndex, efmCuPme2BRegion=efmCuPme2BRegion, ifAvailableStackStatus=ifAvailableStackStatus, efmCuPAFGroup=efmCuPAFGroup, efmCuPme2BConstellation=efmCuPme2BConstellation, efmCuPmeConfigInitFailEnable=efmCuPmeConfigInitFailEnable, efmCuNumPMEs=efmCuNumPMEs, efmCuPmeTCDownCnt=efmCuPmeTCDownCnt, efmCuPme10PStatusEntry=efmCuPme10PStatusEntry, efmCuPAFErrorsGroup=efmCuPAFErrorsGroup, efmCuPmeThreshMaxSnrMgnDelta=efmCuPmeThreshMaxSnrMgnDelta, efmCuPmeErrorThreshMonNotifyEnable=efmCuPmeErrorThreshMonNotifyEnable, efmCuPmeMaintenanceMode=efmCuPmeMaintenanceMode, efmCuPmeSnrMgnCrossingTrapEnable=efmCuPmeSnrMgnCrossingTrapEnable, efmCuPmeBondGroupTrafficDisabled=efmCuPmeBondGroupTrafficDisabled, efmCuPmeSubTypesSupported=efmCuPmeSubTypesSupported, efmCuBasicGroup=efmCuBasicGroup, efmCuPmeStatusEntry=efmCuPmeStatusEntry, efmCuPAFRemoteDiscoveryCode=efmCuPAFRemoteDiscoveryCode, efmCuRegenDCAlarm=efmCuRegenDCAlarm, efmCuPAFDiscoveryCode=efmCuPAFDiscoveryCode, efmCuPAFInLostFragments=efmCuPAFInLostFragments, efmCuPmeOperStatus=efmCuPmeOperStatus, efmCuTargetWorstCaseSnrMgn=efmCuTargetWorstCaseSnrMgn, efmCuPAFInLostStarts=efmCuPAFInLostStarts, efmCuPmeErrorThreshEfmTrafficEnable=efmCuPmeErrorThreshEfmTrafficEnable, efmCuPAFInLargeFragments=efmCuPAFInLargeFragments, efmCuPme10PStatusTable=efmCuPme10PStatusTable, efmCuPmeErrorThreshMonEnable=efmCuPmeErrorThreshMonEnable, efmCuMIB=efmCuMIB, efmCuPmeGroup=efmCuPmeGroup, efmCuPmeCapabilityTable=efmCuPmeCapabilityTable, ifAvailableStackEntry=ifAvailableStackEntry, efmCuPmeAdminProfile=efmCuPmeAdminProfile)
