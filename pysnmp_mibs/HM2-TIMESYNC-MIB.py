...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-TIMESYNC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:53:39 2025
...
_Hm2SntpServerAdminState_Type.__name__ = "HmEnabledStatus"
...
_Hm2SntpServerOnlyIfSync_Type.__name__ = "HmEnabledStatus"
...
class _Hm2SntpServerInterface_Type(InterfaceIndexOrZero):
    """Custom type hm2SntpServerInterface based on InterfaceIndexOrZero"""
    defaultValue = 0


_Hm2SntpServerInterface_Type.__name__ = "InterfaceIndexOrZero"
_Hm2SntpServerInterface_Object = MibScalar
hm2SntpServerInterface = _Hm2SntpServerInterface_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 1, 2, 1, 5),
    _Hm2SntpServerInterface_Type()
)
hm2SntpServerInterface.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SntpServerInterface.setStatus("current")
...
_Hm2SntpServerBroadcastAdminState_Type.__name__ = "HmEnabledStatus"
...
_Hm2SntpServerBroadcastAddrType_Type.__name__ = "InetAddressType"
...
_Hm2SntpServerBroadcastAddr_Type.__name__ = "InetAddress"
...
_Hm2SntpClientAdminState_Type.__name__ = "HmEnabledStatus"
...
_Hm2SntpClientDisableAfterSync_Type.__name__ = "HmEnabledStatus"
...
class _Hm2SntpClientInterface_Type(InterfaceIndexOrZero):
    """Custom type hm2SntpClientInterface based on InterfaceIndexOrZero"""
    defaultValue = 0


_Hm2SntpClientInterface_Type.__name__ = "InterfaceIndexOrZero"
_Hm2SntpClientInterface_Object = MibScalar
hm2SntpClientInterface = _Hm2SntpClientInterface_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 1, 2, 3, 7),
    _Hm2SntpClientInterface_Type()
)
hm2SntpClientInterface.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SntpClientInterface.setStatus("current")
...
_Hm2SntpClientServerAddrType_Type.__name__ = "InetAddressType"
...
_Hm2SntpClientServerAddr_Type.__name__ = "InetAddress"
...
_Hm2NtpServerAdminState_Type.__name__ = "HmEnabledStatus"
...
_Hm2NtpClientAdminState_Type.__name__ = "HmEnabledStatus"
...
_Hm2NtpClientServerAddressType_Type.__name__ = "InetAddressType"
...
_Hm2NtpClientServerAddress_Type.__name__ = "InetAddress"
...
_Hm2NtpClientServerPort_Type.__name__ = "InetPortNumber"
...
_Hm2NtpClientServerInitialBurst_Type.__name__ = "HmEnabledStatus"
...
_Hm2NtpClientServerBurst_Type.__name__ = "HmEnabledStatus"
...
_Hm2NtpClientServerPrefer_Type.__name__ = "TruthValue"
...
_Hm2NtpClientListenAddrAddressType_Type.__name__ = "InetAddressType"
...
_Hm2NtpClientListenAddrAddress_Type.__name__ = "InetAddress"
...
_Hm2NtpClientListenAddrPort_Type.__name__ = "InetPortNumber"
...
_Hm2PtpEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2PtpManagement_Type.__name__ = "TruthValue"
...
_Hm2Ptp2CurrentUtcOffsetValid_Type.__name__ = "TruthValue"
...
_Hm2Ptp2PortEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2Ptp2LogSyncInterval_Type.__name__ = "Hm2Ptp2LogSyncIntervalTc"
...
_Hm2Ptp2LogPdelayReqInterval_Type.__name__ = "Hm2Ptp2LogPdelayReqIntervalTc"
...
_Hm2Ptp2TCSyntonized_Type.__name__ = "TruthValue"
...
_Hm2Ptp2TCMultiDomainMode_Type.__name__ = "TruthValue"
...
_Hm2Ptp2TCSyncLocalClock_Type.__name__ = "TruthValue"
...
_Hm2Ptp2TCPortEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2Ptp2TCLogPdelayReqInterval_Type.__name__ = "Hm2Ptp2LogPdelayReqIntervalTc"
...
_Hm2IrigAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2IrigPpsAdminStatus_Type.__name__ = "HmEnabledStatus"
...
hm2Dot1asGroup = _Hm2Dot1asGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 1, 6)
)
_Hm2Dot1asGlobal_ObjectIdentity = ObjectIdentity
hm2Dot1asGlobal = _Hm2Dot1asGlobal_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 1, 6, 1)
)


class _Hm2Dot1asEnable_Type(HmEnabledStatus):
    """Custom type hm2Dot1asEnable based on HmEnabledStatus"""
    defaultValue = 2


_Hm2Dot1asEnable_Type.__name__ = "HmEnabledStatus"
_Hm2Dot1asEnable_Object = MibScalar
hm2Dot1asEnable = _Hm2Dot1asEnable_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 1, 6, 1, 1),
    _Hm2Dot1asEnable_Type()
)
hm2Dot1asEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2Dot1asEnable.setStatus("current")


class _Hm2Dot1asIsSynchronized_Type(Integer32):
    """Custom type hm2Dot1asIsSynchronized based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hm2Dot1asIsSynchronized_Type.__name__ = "Integer32"
_Hm2Dot1asIsSynchronized_Object = MibScalar
hm2Dot1asIsSynchronized = _Hm2Dot1asIsSynchronized_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 1, 6, 1, 2),
    _Hm2Dot1asIsSynchronized_Type()
)
hm2Dot1asIsSynchronized.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2Dot1asIsSynchronized.setStatus("current")


class _Hm2Dot1asSyncLowerBound_Type(Integer32):
    """Custom type hm2Dot1asSyncLowerBound based on Integer32"""
    defaultValue = 30
...
_Hm2Dot1asSyncLowerBound_Type.__name__ = "Integer32"
_Hm2Dot1asSyncLowerBound_Object = MibScalar
hm2Dot1asSyncLowerBound = _Hm2Dot1asSyncLowerBound_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 1, 6, 1, 3),
    _Hm2Dot1asSyncLowerBound_Type()
)
hm2Dot1asSyncLowerBound.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2Dot1asSyncLowerBound.setStatus("current")


class _Hm2Dot1asSyncUpperBound_Type(Integer32):
    """Custom type hm2Dot1asSyncUpperBound based on Integer32"""
    defaultValue = 5000
...
_Hm2Dot1asSyncUpperBound_Type.__name__ = "Integer32"
_Hm2Dot1asSyncUpperBound_Object = MibScalar
hm2Dot1asSyncUpperBound = _Hm2Dot1asSyncUpperBound_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 1, 6, 1, 4),
    _Hm2Dot1asSyncUpperBound_Type()
)
hm2Dot1asSyncUpperBound.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2Dot1asSyncUpperBound.setStatus("current")
_Hm2Dot1asAbsMaxOffset_Type = Integer32
_Hm2Dot1asAbsMaxOffset_Object = MibScalar
hm2Dot1asAbsMaxOffset = _Hm2Dot1asAbsMaxOffset_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 1, 6, 1, 5),
    _Hm2Dot1asAbsMaxOffset_Type()
)
hm2Dot1asAbsMaxOffset.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2Dot1asAbsMaxOffset.setStatus("current")
...
hm2TimeSyncSntpSESIpv6PortNumberPairInUse = _Hm2TimeSyncSntpSESIpv6PortNumberPairInUse_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 3, 2, 3)
)
if mibBuilder.loadTexts:
    hm2TimeSyncSntpSESIpv6PortNumberPairInUse.setStatus("current")
...
hm2TimeSyncPtpSESPortIsNotCapable = _Hm2TimeSyncPtpSESPortIsNotCapable_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 3, 4, 1)
)
if mibBuilder.loadTexts:
    hm2TimeSyncPtpSESPortIsNotCapable.setStatus("current")
...
hm2TimeSyncDot1asSESGroup = _Hm2TimeSyncDot1asSESGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 3, 6)
)
...
hm2Dot1asSynchronizationChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 248, 11, 50, 0, 20)
)
hm2Dot1asSynchronizationChange.setObjects(
    ("HM2-TIMESYNC-MIB", "hm2Dot1asIsSynchronized")
)
if mibBuilder.loadTexts:
    hm2Dot1asSynchronizationChange.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"HmSntpClientServerStatus": HmSntpClientServerStatus,
       ...
       "hm2Dot1asSynchronizationChange": hm2Dot1asSynchronizationChange,
       ...
       "hm2SntpServerInterface": hm2SntpServerInterface,
       ...
       "hm2SntpClientInterface": hm2SntpClientInterface,
       ...
       "hm2Dot1asGroup": hm2Dot1asGroup,
       "hm2Dot1asGlobal": hm2Dot1asGlobal,
       "hm2Dot1asEnable": hm2Dot1asEnable,
       "hm2Dot1asIsSynchronized": hm2Dot1asIsSynchronized,
       "hm2Dot1asSyncLowerBound": hm2Dot1asSyncLowerBound,
       "hm2Dot1asSyncUpperBound": hm2Dot1asSyncUpperBound,
       "hm2Dot1asAbsMaxOffset": hm2Dot1asAbsMaxOffset,
       ...
       "hm2TimeSyncSntpSESIpv6PortNumberPairInUse": hm2TimeSyncSntpSESIpv6PortNumberPairInUse,
       "hm2TimeSyncNtpSESGroup": hm2TimeSyncNtpSESGroup,
       "hm2TimeSyncPtpSESGroup": hm2TimeSyncPtpSESGroup,
       "hm2TimeSyncPtpSESPortIsNotCapable": hm2TimeSyncPtpSESPortIsNotCapable,
       "hm2TimeSyncIrigSESGroup": hm2TimeSyncIrigSESGroup,
       "hm2TimeSyncDot1asSESGroup": hm2TimeSyncDot1asSESGroup}
)
