...
mibBuilder.exportSymbols("ZYXEL-LOAD-SHARING-MIB", PYSNMP_MODULE_ID=zyxelLoadSharing, zyLoadSharingDiscoverTime=zyLoadSharingDiscoverTime, zyxelLoadSharingSetup=zyxelLoadSharingSetup, zyLoadSharingMaxPaths=zyLoadSharingMaxPaths, zyLoadSharingAgingTime=zyLoadSharingAgingTime, zyxelLoadSharing=zyxelLoadSharing, zyLoadSharingState=zyLoadSharingState, zyLoadSharingCriteria=zyLoadSharingCriteria)
