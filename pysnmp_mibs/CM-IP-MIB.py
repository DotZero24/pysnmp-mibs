...
# Produced by pysmi-1.6.2 at Fri Oct 10 21:59:55 2025
...
cmIpInterfaceMTU.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
ipManagementTunnelMTU.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
cmIpv6InterfaceMTU.setMaxAccess("read-only")
if mibBuilder.loadTexts:
