...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/adva/CM-IP-MIB
...
DisplayString, VariablePointer, MacAddress, RowStatus, TextualConvention, TruthValue, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "VariablePointer", "MacAddress", "RowStatus", "TextualConvention", "TruthValue", "StorageType")
cmIPMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 2544, 1, 12, 11))
cmIPMIB.setRevisions(('2010-12-08 00:00',))
if mibBuilder.loadTexts: cmIPMIB.setLastUpdated('201012080000Z')
if mibBuilder.loadTexts: cmIPMIB.setOrganization('ADVA Optical Networking')
...
cmIpInterfaceMTU = MibTableColumn((1, 3, 6, 1, 4, 1, 2544, 1, 12, 11, 1, 1, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 1500)).clone(1)).setMaxAccess("readonly")
...
ipManagementTunnelMTU = MibTableColumn((1, 3, 6, 1, 4, 1, 2544, 1, 12, 11, 1, 5, 1, 5), Integer32()).setMaxAccess("readonly")
...
cmIpv6InterfaceMTU = MibTableColumn((1, 3, 6, 1, 4, 1, 2544, 1, 12, 11, 1, 6, 1, 1), Integer32()).setMaxAccess("readonly")
...
ipGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 2544, 1, 12, 11, 2, 2, 1)).setObjects(("CM-IP-MIB", "cmIpFlushARPCacheAction"), ("CM-IP-MIB", "cmIpProxyARPEnabled"), ("CM-IP-MIB", "cmIpPingDestination"), ("CM-IP-MIB", "cmIpInitiatePingAction"), ("CM-IP-MIB", "cmIpPingResult"), ("CM-IP-MIB", "cmIpTraceRouteDestination"), ("CM-IP-MIB", "cmIpInitiateTraceRouteAction"), ("CM-IP-MIB", "cmIpTraceRouteResult"), ("CM-IP-MIB", "cmIpSNMPv1InterfaceName"), ("CM-IP-MIB", "cmIpSourceAddressType"), ("CM-IP-MIB", "cmIpSourceAddressInterfaceName"), ("CM-IP-MIB", "cmIpManagementTrafficBridgingEnabled"), ("CM-IP-MIB", "cmIpManagementTrafficBridgingSecurityEnabled"), ("CM-IP-MIB", "cmIpInterfaceName"), ("CM-IP-MIB", "cmIpInterface"), ("CM-IP-MIB", "cmIpInterfaceMask"), ("CM-IP-MIB", "cmIpInterfaceDhcpEnabled"), ("CM-IP-MIB", "cmIpInterfaceMTU"), ("CM-IP-MIB", "cmIpInterfaceDhcpRole"), ("CM-IP-MIB", "cmIpInterfacePhysicalAddress"), ("CM-IP-MIB", "cmIpInterfaceRIPv2Enabled"), ("CM-IP-MIB", "cmIpInterfaceDHCPClientIdEnabled"), ("CM-IP-MIB", "cmIpInterfaceDHCPClientId"), ("CM-IP-MIB", "cmIpInterfaceIpMode"), ("CM-IP-MIB", "cmIpInterfaceDhcpClassIdEnabled"), ("CM-IP-MIB", "cmIpInterfaceDhcpHostNameEnabled"), ("CM-IP-MIB", "cmIpInterfaceDhcpHostName"), ("CM-IP-MIB", "cmIpInterfaceDhcpLogServerEnabled"), ("CM-IP-MIB", "cmIpInterfaceDhcpNTPServerEnabled"), ("CM-IP-MIB", "cmIpInterfaceDhcpClientIdType"), ("CM-IP-MIB", "cmIpInterfaceDhcpHostNameType"), ("CM-IP-MIB", "cmIpInterfaceDhcpVendorInfoEnabled"), ("CM-IP-MIB", "cmIpInterfaceDhcpVendorInfoType"), ("CM-IP-MIB", "cmIpInterfaceDhcpVendorInfo"), ("CM-IP-MIB", "cmStaticRouteDest"), ("CM-IP-MIB", "cmStaticRouteMask"), ("CM-IP-MIB", "cmStaticRouteNextHop"), ("CM-IP-MIB", "cmStaticRouteMetric"), ("CM-IP-MIB", "cmStaticRouteRowStatus"), ("CM-IP-MIB", "cmStaticRouteInterface"), ("CM-IP-MIB", "cmStaticRouteAdvertise"), ("CM-IP-MIB", "cmARPIndex"), ("CM-IP-MIB", "cmARPIPAddress"), ("CM-IP-MIB", "cmARPMacAddress"), ("CM-IP-MIB", "cmARPInterface"), ("CM-IP-MIB", "cmARPStorageType"), ("CM-IP-MIB", "cmARPRowStatus"), ("CM-IP-MIB", "cmARPEntryType"), ("CM-IP-MIB", "cmProxyARPIndex"), ("CM-IP-MIB", "cmProxyARPIPAddress"), ("CM-IP-MIB", "cmProxyARPSubnetMask"), ("CM-IP-MIB", "cmProxyARPInterface"), ("CM-IP-MIB", "cmProxyARPStorageType"), ("CM-IP-MIB", "cmProxyARPRowStatus"), ("CM-IP-MIB", "ipManagementTunnelIndex"), ("CM-IP-MIB", "ipManagementTunnelAssociatedPort"), ("CM-IP-MIB", "ipManagementTunnelName"), ("CM-IP-MIB", "ipManagementTunnelType"), ("CM-IP-MIB", "ipManagementTunnelMTU"), ("CM-IP-MIB", "ipManagementTunnelEncapsulationType"), ("CM-IP-MIB", "ipManagementTunnelIpAddress"), ("CM-IP-MIB", "ipManagementTunnelSubnetMask"), ("CM-IP-MIB", "ipManagementTunnelVlanId"), ("CM-IP-MIB", "ipManagementTunnelSVlanEnabled"), ("CM-IP-MIB", "ipManagementTunnelSVlanId"), ("CM-IP-MIB", "ipManagementTunnelDhcpEnabled"), ("CM-IP-MIB", "ipManagementTunnelRip2PktsEnabled"), ("CM-IP-MIB", "ipManagementTunnelPhysicalAddress"), ("CM-IP-MIB", "ipManagementTunnelCOS"), ("CM-IP-MIB", "ipManagementTunnelCIR"), ("CM-IP-MIB", "ipManagementTunnelEIR"), ("CM-IP-MIB", "ipManagementTunnelBufferSize"), ("CM-IP-MIB", "ipManagementTunnelStorageType"), ("CM-IP-MIB", "ipManagementTunnelRowStatus"), ("CM-IP-MIB", "ipManagementTunnelQosQueueProfile"), ("CM-IP-MIB", "ipManagementTunnelDHCPClientIdEnabled"), ("CM-IP-MIB", "ipManagementTunnelDHCPClientId"), ("CM-IP-MIB", "ipManagementTunnelCVlanEnabled"), ("CM-IP-MIB", "ipManagementTunnelIpMode"), ("CM-IP-MIB", "ipManagementTunnelDhcpClassIdEnabled"), ("CM-IP-MIB", "ipManagementTunnelDhcpHostNameEnabled"), ("CM-IP-MIB", "ipManagementTunnelDhcpHostName"), ("CM-IP-MIB", "ipManagementTunnelDhcpLogServerEnabled"), ("CM-IP-MIB", "ipManagementTunnelDhcpNTPServerEnabled"), ("CM-IP-MIB", "ipManagementTunnelDhcpClientIdType"), ("CM-IP-MIB", "ipManagementTunnelDhcpHostNameType"), ("CM-IP-MIB", "cmIpManagementTrafficDscpEnabled"), ("CM-IP-MIB", "cmIpManagementTrafficDscp"), ("CM-IP-MIB", "ipManagementTunnelDhcpVendorInfoEnabled"), ("CM-IP-MIB", "ipManagementTunnelDhcpVendorInfoType"), ("CM-IP-MIB", "ipManagementTunnelDhcpVendorInfo"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipGroup = ipGroup.setStatus('current')
ipv6Group = ObjectGroup((1, 3, 6, 1, 4, 1, 2544, 1, 12, 11, 2, 2, 2)).setObjects(("CM-IP-MIB", "ipManagementTunnelDHCPv6Enabled"), ("CM-IP-MIB", "ipManagementTunnelIpv6Address"), ("CM-IP-MIB", "ipManagementTunnelIpv6AddrPrefixLen"), ("CM-IP-MIB", "ipManagementTunnelIpv6StateAddrAutoConfigEnabled"), ("CM-IP-MIB", "ipManagementTunnellinkLocIpv6Addr"), ("CM-IP-MIB", "ipManagementTunnellinkLocIpv6AddrPrefixLen"), ("CM-IP-MIB", "ipManagementTunnelIpv6PrefixAdvertiseEnabled"), ("CM-IP-MIB", "ipManagementTunnelIpv6Prefix"), ("CM-IP-MIB", "ipManagementTunnelIpv6PrefixLen"), ("CM-IP-MIB", "ipManagementTunnelIpv6RipngEnabled"), ("CM-IP-MIB", "cmIpv6InterfaceMTU"), ("CM-IP-MIB", "cmIpv6UnicastAddr"), ("CM-IP-MIB", "cmIpv6UnicastAddrPrefixLen"), ("CM-IP-MIB", "cmIpv6PrefixAdvertiseEnabled"), ("CM-IP-MIB", "cmIpv6RAPrefix"), ("CM-IP-MIB", "cmIpv6RAPrefixLength"), ("CM-IP-MIB", "cmIpv6StateAddrAutoConfigEnabled"), ("CM-IP-MIB", "cmIpv6DhcpEnabled"), ("CM-IP-MIB", "cmIpv6DhcpRole"), ("CM-IP-MIB", "cmIpv6RIPngEnabled"), ("CM-IP-MIB", "cmIpv6LinkLocAddr"), ("CM-IP-MIB", "cmIpv6LinkLocAddrPrefixLen"), ("CM-IP-MIB", "cmIpv6StaticRouteDest"), ("CM-IP-MIB", "cmIpv6StaticRoutePrefixLen"), ("CM-IP-MIB", "cmIpv6StaticRouteNextHop"), ("CM-IP-MIB", "cmIpv6StaticRouteMetric"), ("CM-IP-MIB", "cmIpv6StaticRouteRowStatus"), ("CM-IP-MIB", "cmIpv6StaticRouteInterface"), ("CM-IP-MIB", "cmIpv6StaticRouteAdvertise"), ("CM-IP-MIB", "cmNDPIpv6Address"), ("CM-IP-MIB", "cmNDPMacAddress"), ("CM-IP-MIB", "cmNDPInterface"), ("CM-IP-MIB", "cmNDPStorageType"), ("CM-IP-MIB", "cmNDPRowStatus"), ("CM-IP-MIB", "cmNDPEntryType"), ("CM-IP-MIB", "cmProxyNDPIpv6Address"), ("CM-IP-MIB", "cmProxyNDPIpv6PrefixLen"), ("CM-IP-MIB", "cmProxyNDPInterface"), ("CM-IP-MIB", "cmProxyNDPStorageType"), ("CM-IP-MIB", "cmProxyNDPRowStatus"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelIndex"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelName"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelType"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelDestIpv4Addr"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelIpv6UnicastAddress"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelAssociatedIpv4Interface"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelStorageType"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelRowStatus"), ("CM-IP-MIB", "cmIpv6InitiatePingAction"), ("CM-IP-MIB", "cmIpv6InitiatePingAction"), ("CM-IP-MIB", "cmIpv6TraceRouteDestination"), ("CM-IP-MIB", "cmIpv6InitiateTraceRouteAction"), ("CM-IP-MIB", "cmIpv6PingInterface"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelIpv6UnicastAddrPrefixLen"), ("CM-IP-MIB", "cmIpv6OverIpv4TunnelLinkLocalAddress"), ("CM-IP-MIB", "cmIpv60verIpv4TunnelLinkLocalAddrPrefixLen"), ("CM-IP-MIB", "cmIpv6OverIpv4PotentialRouterList"), ("CM-IP-MIB", "cmIpv6FwdEnabled"), ("CM-IP-MIB", "cmIpv6ProxyNDPEnabled"), ("CM-IP-MIB", "cmIpFlushNDPCacheAction"), ("CM-IP-MIB", "cmIpPtpArpRtrvAction"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipv6Group = ipv6Group.setStatus('current')
mibBuilder.exportSymbols("CM-IP-MIB", IpMode=IpMode, cmARPRowStatus=cmARPRowStatus, IpManagementTunnelEncapsulationType=IpManagementTunnelEncapsulationType, cmProxyNDPIpv6PrefixLen=cmProxyNDPIpv6PrefixLen, cmStaticRouteNextHop=cmStaticRouteNextHop, cmIpInterfaceTable=cmIpInterfaceTable, cmIpInterfaceMask=cmIpInterfaceMask, ipManagementTunnelQosQueueProfile=ipManagementTunnelQosQueueProfile, cmIpInitiatePingAction=cmIpInitiatePingAction, cmProxyNDPInterface=cmProxyNDPInterface, cmIpv6DhcpRole=cmIpv6DhcpRole, ipManagementTunnelPhysicalAddress=ipManagementTunnelPhysicalAddress, ipManagementTunnelCIR=ipManagementTunnelCIR, cmIpInterfaceDhcpNTPServerEnabled=cmIpInterfaceDhcpNTPServerEnabled, ipManagementTunnelStorageType=ipManagementTunnelStorageType, cmIpv6DhcpEnabled=cmIpv6DhcpEnabled, cmProxyNDPStorageType=cmProxyNDPStorageType, cmARPMacAddress=cmARPMacAddress, cmIpTraceRouteResult=cmIpTraceRouteResult, Ipv6OverIpv4TunnelType=Ipv6OverIpv4TunnelType, cmIpManagementTrafficDscp=cmIpManagementTrafficDscp, cmIpInterfaceRIPv2Enabled=cmIpInterfaceRIPv2Enabled, cmNDPInterface=cmNDPInterface, cmIpv6PrefixAdvertiseEnabled=cmIpv6PrefixAdvertiseEnabled, cmIpInterfaceEntry=cmIpInterfaceEntry, cmIpPingDestination=cmIpPingDestination, cmIpInterfaceDhcpVendorInfo=cmIpInterfaceDhcpVendorInfo, cmIpv6StaticRouteAdvertise=cmIpv6StaticRouteAdvertise, cmNDPMacAddress=cmNDPMacAddress, cmIpv6UnicastAddr=cmIpv6UnicastAddr, cmIpv6LinkLocAddrPrefixLen=cmIpv6LinkLocAddrPrefixLen, cmNDPTable=cmNDPTable, cmARPEntryType=cmARPEntryType, cmNDPEntryType=cmNDPEntryType, cmProxyNDPEntry=cmProxyNDPEntry, ipManagementTunnelIpv6Address=ipManagementTunnelIpv6Address, cmIpSystemScalars=cmIpSystemScalars, cmIpv6OverIpv4TunnelTable=cmIpv6OverIpv4TunnelTable, cmStaticRouteMask=cmStaticRouteMask, IpEntryType=IpEntryType, cmARPIndex=cmARPIndex, cmIpv6StaticRouteInterface=cmIpv6StaticRouteInterface, cmIpInterfaceIpMode=cmIpInterfaceIpMode, cmIpv6PingDestination=cmIpv6PingDestination, ipManagementTunnelDhcpVendorInfoEnabled=ipManagementTunnelDhcpVendorInfoEnabled, ipManagementTunnelDHCPClientIdEnabled=ipManagementTunnelDHCPClientIdEnabled, cmIpInterfaceDhcpHostNameType=cmIpInterfaceDhcpHostNameType, IpActionType=IpActionType, cmIpv6RIPngEnabled=cmIpv6RIPngEnabled, cmIpv6OverIpv4TunnelStorageType=cmIpv6OverIpv4TunnelStorageType, ipGroup=ipGroup, ipManagementTunnelDhcpClassIdEnabled=ipManagementTunnelDhcpClassIdEnabled, cmIpProxyARPEnabled=cmIpProxyARPEnabled, cmIpFlushNDPCacheAction=cmIpFlushNDPCacheAction, cmIpv6OverIpv4TunnelLinkLocalAddress=cmIpv6OverIpv4TunnelLinkLocalAddress, ipManagementTunnelIpMode=ipManagementTunnelIpMode, ipManagementTunnelDhcpHostName=ipManagementTunnelDhcpHostName, DHCPVendorInfoType=DHCPVendorInfoType, ipManagementTunnelDhcpHostNameType=ipManagementTunnelDhcpHostNameType, cmIpv6ProxyNDPEnabled=cmIpv6ProxyNDPEnabled, cmIpv6OverIpv4TunnelType=cmIpv6OverIpv4TunnelType, cmStaticRouteRowStatus=cmStaticRouteRowStatus, cmIpFlushARPCacheAction=cmIpFlushARPCacheAction, PYSNMP_MODULE_ID=cmIPMIB, cmIpv6InitiatePingAction=cmIpv6InitiatePingAction, cmProxyARPIPAddress=cmProxyARPIPAddress, cmProxyARPRowStatus=cmProxyARPRowStatus, ipManagementTunnelType=ipManagementTunnelType, cmStaticRouteInterface=cmStaticRouteInterface, ipManagementTunnelDhcpVendorInfo=ipManagementTunnelDhcpVendorInfo, cmIpv6RAPrefix=cmIpv6RAPrefix, cmNDPEntry=cmNDPEntry, ipCompliances=ipCompliances, ipManagementTunnelDhcpEnabled=ipManagementTunnelDhcpEnabled, cmIpObjects=cmIpObjects, DHCPCIDType=DHCPCIDType, ipManagementTunnelIpv6StateAddrAutoConfigEnabled=ipManagementTunnelIpv6StateAddrAutoConfigEnabled, cmIpv6StaticRouteEntry=cmIpv6StaticRouteEntry, cmARPIPAddress=cmARPIPAddress, cmIpv6StateAddrAutoConfigEnabled=cmIpv6StateAddrAutoConfigEnabled, cmIpv6RAPrefixLength=cmIpv6RAPrefixLength, ipManagementTunnelDhcpVendorInfoType=ipManagementTunnelDhcpVendorInfoType, PtpArpActionType=PtpArpActionType, cmIpInterfaceDhcpVendorInfoEnabled=cmIpInterfaceDhcpVendorInfoEnabled, IpManagementTunnelType=IpManagementTunnelType, cmProxyARPIndex=cmProxyARPIndex, cmIpInterfaceDHCPClientIdEnabled=cmIpInterfaceDHCPClientIdEnabled, cmStaticRouteAdvertise=cmStaticRouteAdvertise, ipManagementTunnelName=ipManagementTunnelName, cmIpv6InterfaceEntry=cmIpv6InterfaceEntry, cmIpManagementTrafficBridgingEnabled=cmIpManagementTrafficBridgingEnabled, ipManagementTunnelIpv6PrefixAdvertiseEnabled=ipManagementTunnelIpv6PrefixAdvertiseEnabled, cmIpv6StaticRouteDest=cmIpv6StaticRouteDest, cmIpInitiateTraceRouteAction=cmIpInitiateTraceRouteAction, cmStaticRouteMetric=cmStaticRouteMetric, cmProxyARPInterface=cmProxyARPInterface, cmIpInterfaceDhcpClientIdType=cmIpInterfaceDhcpClientIdType, ipCompliance=ipCompliance, cmIpv6OverIpv4TunnelIpv6UnicastAddrPrefixLen=cmIpv6OverIpv4TunnelIpv6UnicastAddrPrefixLen, cmIpv6OverIpv4TunnelIpv6UnicastAddress=cmIpv6OverIpv4TunnelIpv6UnicastAddress, cmIpv6OverIpv4TunnelEntry=cmIpv6OverIpv4TunnelEntry, CmDhcpRole=CmDhcpRole, cmIpInterfaceDhcpRole=cmIpInterfaceDhcpRole, cmARPStorageType=cmARPStorageType, ipManagementTunnelIpv6Prefix=ipManagementTunnelIpv6Prefix, cmIpPingResult=cmIpPingResult, cmIpPtpArpRtrvAction=cmIpPtpArpRtrvAction, cmIpInterfaceMTU=cmIpInterfaceMTU, cmStaticRouteEntry=cmStaticRouteEntry, cmIpScalars=cmIpScalars, cmIpInterfaceName=cmIpInterfaceName, cmIpInterfaceDhcpHostNameEnabled=cmIpInterfaceDhcpHostNameEnabled, cmIpv6InterfaceMTU=cmIpv6InterfaceMTU, cmARPEntry=cmARPEntry, cmIpInterfacePhysicalAddress=cmIpInterfacePhysicalAddress, cmIpInterfaceDhcpHostName=cmIpInterfaceDhcpHostName, cmProxyARPStorageType=cmProxyARPStorageType, cmStaticRouteTable=cmStaticRouteTable, ipManagementTunnelIpAddress=ipManagementTunnelIpAddress, cmIpInterface=cmIpInterface, ipManagementTunnelDHCPClientId=ipManagementTunnelDHCPClientId, ipManagementTunnelIpv6AddrPrefixLen=ipManagementTunnelIpv6AddrPrefixLen, ipManagementTunnelDhcpNTPServerEnabled=ipManagementTunnelDhcpNTPServerEnabled, cmIpv6UnicastAddrPrefixLen=cmIpv6UnicastAddrPrefixLen, ipManagementTunnelDhcpHostNameEnabled=ipManagementTunnelDhcpHostNameEnabled, cmIpv6StaticRouteNextHop=cmIpv6StaticRouteNextHop, cmIPMIB=cmIPMIB, cmIpInterfaceDHCPClientId=cmIpInterfaceDHCPClientId, cmIpv6FwdEnabled=cmIpv6FwdEnabled, cmARPTable=cmARPTable, cmIpv6LinkLocAddr=cmIpv6LinkLocAddr, cmIpManagementTrafficDscpEnabled=cmIpManagementTrafficDscpEnabled, ipManagementTunnelEntry=ipManagementTunnelEntry, ipGroups=ipGroups, cmIpTraceRouteDestination=cmIpTraceRouteDestination, cmIpv60verIpv4TunnelLinkLocalAddrPrefixLen=cmIpv60verIpv4TunnelLinkLocalAddrPrefixLen, cmNDPStorageType=cmNDPStorageType, IpSourceAddrType=IpSourceAddrType, ipManagementTunnelSubnetMask=ipManagementTunnelSubnetMask, ipManagementTunnelRowStatus=ipManagementTunnelRowStatus, cmStaticRouteDest=cmStaticRouteDest, cmIpv6StaticRouteRowStatus=cmIpv6StaticRouteRowStatus, ipManagementTunnelSVlanId=ipManagementTunnelSVlanId, cmIpConformance=cmIpConformance, ipv6Group=ipv6Group, DHCPHostNameType=DHCPHostNameType, cmIpSNMPv1InterfaceName=cmIpSNMPv1InterfaceName, cmProxyNDPIpv6Address=cmProxyNDPIpv6Address, cmIpSourceAddressInterfaceName=cmIpSourceAddressInterfaceName, cmIpSourceAddressType=cmIpSourceAddressType, ipManagementTunnelDHCPv6Enabled=ipManagementTunnelDHCPv6Enabled, ipManagementTunnellinkLocIpv6AddrPrefixLen=ipManagementTunnellinkLocIpv6AddrPrefixLen, ipManagementTunnelDhcpClientIdType=ipManagementTunnelDhcpClientIdType, ipManagementTunnelVlanId=ipManagementTunnelVlanId, cmIpv6OverIpv4TunnelName=cmIpv6OverIpv4TunnelName, ipManagementTunnellinkLocIpv6Addr=ipManagementTunnellinkLocIpv6Addr, cmNDPIpv6Address=cmNDPIpv6Address, ipManagementTunnelDhcpLogServerEnabled=ipManagementTunnelDhcpLogServerEnabled, ipManagementTunnelMTU=ipManagementTunnelMTU, ipManagementTunnelRip2PktsEnabled=ipManagementTunnelRip2PktsEnabled, cmIpv6InitiateTraceRouteAction=cmIpv6InitiateTraceRouteAction, ipManagementTunnelTable=ipManagementTunnelTable, ipManagementTunnelSVlanEnabled=ipManagementTunnelSVlanEnabled, ipManagementTunnelEIR=ipManagementTunnelEIR, cmProxyARPTable=cmProxyARPTable, ipManagementTunnelBufferSize=ipManagementTunnelBufferSize, cmIpSourceAddrScalars=cmIpSourceAddrScalars, ipManagementTunnelCOS=ipManagementTunnelCOS, ipManagementTunnelCVlanEnabled=ipManagementTunnelCVlanEnabled, ipManagementTunnelAssociatedPort=ipManagementTunnelAssociatedPort, cmProxyNDPTable=cmProxyNDPTable, cmIpInterfaceDhcpLogServerEnabled=cmIpInterfaceDhcpLogServerEnabled, ipManagementTunnelIndex=ipManagementTunnelIndex, cmIpv6OverIpv4TunnelRowStatus=cmIpv6OverIpv4TunnelRowStatus, cmIpv6InterfaceTable=cmIpv6InterfaceTable, cmNDPRowStatus=cmNDPRowStatus, cmIpv6OverIpv4TunnelDestIpv4Addr=cmIpv6OverIpv4TunnelDestIpv4Addr, cmProxyNDPRowStatus=cmProxyNDPRowStatus, cmIpManagementTrafficBridgingSecurityEnabled=cmIpManagementTrafficBridgingSecurityEnabled, cmIpv6OverIpv4PotentialRouterList=cmIpv6OverIpv4PotentialRouterList, cmARPInterface=cmARPInterface, cmIpv6PingInterface=cmIpv6PingInterface, ipManagementTunnelIpv6PrefixLen=ipManagementTunnelIpv6PrefixLen, ipManagementTunnelEncapsulationType=ipManagementTunnelEncapsulationType, cmIpv6TraceRouteDestination=cmIpv6TraceRouteDestination, cmIpv6StaticRouteTable=cmIpv6StaticRouteTable, cmIpv6OverIpv4TunnelAssociatedIpv4Interface=cmIpv6OverIpv4TunnelAssociatedIpv4Interface, cmIpv6OverIpv4TunnelIndex=cmIpv6OverIpv4TunnelIndex, cmIpv6StaticRouteMetric=cmIpv6StaticRouteMetric, cmIpv6StaticRoutePrefixLen=cmIpv6StaticRoutePrefixLen, cmIpInterfaceDhcpVendorInfoType=cmIpInterfaceDhcpVendorInfoType, cmProxyARPSubnetMask=cmProxyARPSubnetMask, cmIpInterfaceDhcpEnabled=cmIpInterfaceDhcpEnabled, ipManagementTunnelIpv6RipngEnabled=ipManagementTunnelIpv6RipngEnabled, cmIpInterfaceDhcpClassIdEnabled=cmIpInterfaceDhcpClassIdEnabled, cmProxyARPEntry=cmProxyARPEntry)
