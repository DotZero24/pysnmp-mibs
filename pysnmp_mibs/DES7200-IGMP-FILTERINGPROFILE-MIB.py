# SNMP MIB module (DES7200-IGMP-FILTERINGPROFILE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-IGMP-FILTERINGPROFILE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:51:58 2025
...
myIgmpFilteringMaxProfiles = _MyIgmpFilteringMaxProfiles_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 1),
...
myIgmpFilteringProfileActionTable = _MyIgmpFilteringProfileActionTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 2)
)
if mibBuilder.loadTexts:
...
myIgmpFilteringProfileActionEntry = _MyIgmpFilteringProfileActionEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 2, 1)
)
myIgmpFilteringProfileActionEntry.setIndexNames(
    (0, "DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfileIndex"),
)
if mibBuilder.loadTexts:
...
myIgmpFilteringProfileIndex = _MyIgmpFilteringProfileIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 2, 1, 1),
...
myIgmpFilteringProfileAction = _MyIgmpFilteringProfileAction_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 2, 1, 2),
...
myIgmpFilteringProfileStatus = _MyIgmpFilteringProfileStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 2, 1, 3),
...
myIgmpFilteringProfileRangeTable = _MyIgmpFilteringProfileRangeTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 3)
)
if mibBuilder.loadTexts:
...
myIgmpFilteringProfileRangeEntry = _MyIgmpFilteringProfileRangeEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 3, 1)
)
myIgmpFilteringProfileRangeEntry.setIndexNames(
    (0, "DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfileRangeIndex"),
    (0, "DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfieRangeMyAddress"),
)
if mibBuilder.loadTexts:
...
myIgmpFilteringProfileRangeIndex = _MyIgmpFilteringProfileRangeIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 3, 1, 1),
...
myIgmpFilteringProfieRangeMyAddress = _MyIgmpFilteringProfieRangeMyAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 3, 1, 2),
...
myIgmpFilteringProfieRangeEndAddress = _MyIgmpFilteringProfieRangeEndAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 3, 1, 3),
...
myIgmpFilteringProfileRangeStatus = _MyIgmpFilteringProfileRangeStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 1, 3, 1, 4),
...
myIgmpFilteringProfileMIBCompliances = _MyIgmpFilteringProfileMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 2, 1)
)
...
myIgmpFilteringProfileMIBGroups = _MyIgmpFilteringProfileMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 2, 2)
)

# Managed Objects groups

myIgmpFilteringProfileMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 2, 2, 1)
)
myIgmpFilteringProfileMIBGroup.setObjects(
      *(("DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringMaxProfiles"),
        ("DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfileIndex"),
        ("DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfileAction"),
        ("DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfileStatus"),
        ("DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfileRangeIndex"),
        ("DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfieRangeMyAddress"),
        ("DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfieRangeEndAddress"),
        ("DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfileRangeStatus"))
)
if mibBuilder.loadTexts:
...
myIgmpFilteringProfileMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 37, 2, 1, 1)
)
myIgmpFilteringProfileMIBCompliance.setObjects(
    ("DES7200-IGMP-FILTERINGPROFILE-MIB", "myIgmpFilteringProfileMIBGroup")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "DES7200-IGMP-FILTERINGPROFILE-MIB",
