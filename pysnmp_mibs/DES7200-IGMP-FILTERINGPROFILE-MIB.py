...
_D='Integer32'
_C='read-write'
_B='DES7200-IGMP-FILTERINGPROFILE-MIB'
_A='current'
...
myIgmpFilteringProfileMIBObjects=_MyIgmpFilteringProfileMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,37,1))
_MyIgmpFilteringMaxProfiles_Type=Unsigned32
_MyIgmpFilteringMaxProfiles_Object=MibScalar
myIgmpFilteringMaxProfiles=_MyIgmpFilteringMaxProfiles_Object((1,3,6,1,4,1,171,10,97,2,37,1,1),_MyIgmpFilteringMaxProfiles_Type())
...
myIgmpFilteringProfileActionTable=_MyIgmpFilteringProfileActionTable_Object((1,3,6,1,4,1,171,10,97,2,37,1,2))
...
myIgmpFilteringProfileActionEntry=_MyIgmpFilteringProfileActionEntry_Object((1,3,6,1,4,1,171,10,97,2,37,1,2,1))
...
myIgmpFilteringProfileIndex=_MyIgmpFilteringProfileIndex_Object((1,3,6,1,4,1,171,10,97,2,37,1,2,1,1),_MyIgmpFilteringProfileIndex_Type())
...
myIgmpFilteringProfileAction=_MyIgmpFilteringProfileAction_Object((1,3,6,1,4,1,171,10,97,2,37,1,2,1,2),_MyIgmpFilteringProfileAction_Type())
...
myIgmpFilteringProfileStatus=_MyIgmpFilteringProfileStatus_Object((1,3,6,1,4,1,171,10,97,2,37,1,2,1,3),_MyIgmpFilteringProfileStatus_Type())
...
myIgmpFilteringProfileRangeTable=_MyIgmpFilteringProfileRangeTable_Object((1,3,6,1,4,1,171,10,97,2,37,1,3))
...
myIgmpFilteringProfileRangeEntry=_MyIgmpFilteringProfileRangeEntry_Object((1,3,6,1,4,1,171,10,97,2,37,1,3,1))
...
myIgmpFilteringProfileRangeIndex=_MyIgmpFilteringProfileRangeIndex_Object((1,3,6,1,4,1,171,10,97,2,37,1,3,1,1),_MyIgmpFilteringProfileRangeIndex_Type())
...
myIgmpFilteringProfieRangeMyAddress=_MyIgmpFilteringProfieRangeMyAddress_Object((1,3,6,1,4,1,171,10,97,2,37,1,3,1,2),_MyIgmpFilteringProfieRangeMyAddress_Type())
...
myIgmpFilteringProfieRangeEndAddress=_MyIgmpFilteringProfieRangeEndAddress_Object((1,3,6,1,4,1,171,10,97,2,37,1,3,1,3),_MyIgmpFilteringProfieRangeEndAddress_Type())
...
myIgmpFilteringProfileRangeStatus=_MyIgmpFilteringProfileRangeStatus_Object((1,3,6,1,4,1,171,10,97,2,37,1,3,1,4),_MyIgmpFilteringProfileRangeStatus_Type())
...
myIgmpFilteringProfileMIBConformance=_MyIgmpFilteringProfileMIBConformance_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,37,2))
_MyIgmpFilteringProfileMIBCompliances_ObjectIdentity=ObjectIdentity
myIgmpFilteringProfileMIBCompliances=_MyIgmpFilteringProfileMIBCompliances_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,37,2,1))
_MyIgmpFilteringProfileMIBGroups_ObjectIdentity=ObjectIdentity
myIgmpFilteringProfileMIBGroups=_MyIgmpFilteringProfileMIBGroups_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,37,2,2))
myIgmpFilteringProfileMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,37,2,2,1))
...
myIgmpFilteringProfileMIBCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,97,2,37,2,1,1))
