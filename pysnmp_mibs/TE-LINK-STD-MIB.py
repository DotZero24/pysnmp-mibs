...
# Notes
# -----
# ASN.1 source file://mibs/rfc/TE-LINK-STD-MIB
...
teLinkModuleFullCompliance.setObjects(
      *(("TE-LINK-STD-MIB", "teLinkGroup"),
        ("TE-LINK-STD-MIB", "teLinkBandwidthGroup"),
        ("TE-LINK-STD-MIB", "componentLinkBandwidthGroup"),
        ("TE-LINK-STD-MIB", "teLinkSrlgGroup"),
        ("TE-LINK-STD-MIB", "teLinkPscGroup"),
        ("TE-LINK-STD-MIB", "teLinkTdmGroup"))
)
if mibBuilder.loadTexts:
...
teLinkModuleReadOnlyCompliance.setObjects(
      *(("TE-LINK-STD-MIB", "teLinkGroup"),
        ("TE-LINK-STD-MIB", "teLinkBandwidthGroup"),
        ("TE-LINK-STD-MIB", "componentLinkBandwidthGroup"),
        ("TE-LINK-STD-MIB", "teLinkSrlgGroup"),
