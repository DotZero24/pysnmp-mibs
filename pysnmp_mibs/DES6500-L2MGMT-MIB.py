# SNMP MIB module (DES6500-L2MGMT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES6500-L2MGMT-MIB
...
swL2PortInfoEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2PortInfoPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortCtrlEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2PortCtrlPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2QOSBandwidthControlEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2QOSBandwidthPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2QOSSchedulingEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2QOSSchedulingClassIndex"),
)
if mibBuilder.loadTexts:
...
swL2QOS8021pUserPriorityEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2QOS8021pUserPriorityIndex"),
)
if mibBuilder.loadTexts:
...
swL2QOS8021pDefaultPriorityEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2QOS8021pDefaultPriorityIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortSecurityControlEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2PortSecurityPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2TrunkCtrlEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2TrunkIndex"),
)
if mibBuilder.loadTexts:
...
swL2TrunkLACPPortEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2TrunkLACPPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2IGMPSnoopingCtrlEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2IGMPSnoopingCtrlVid"),
)
if mibBuilder.loadTexts:
...
swL2IGMPSnoopingQueryInfoEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2IGMPSnoopingInfoVid"),
)
if mibBuilder.loadTexts:
...
swL2IGMPSnoopingInfoEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2IGMPSnoopingVid"),
    (0, "DES6500-L2MGMT-MIB", "swL2IGMPSnoopingGroupIpAddr"),
)
if mibBuilder.loadTexts:
...
swL2TrafficSegEntry.setIndexNames(
    (0, "DES6500-L2MGMT-MIB", "swL2TrafficSegPort"),
)
if mibBuilder.loadTexts:
