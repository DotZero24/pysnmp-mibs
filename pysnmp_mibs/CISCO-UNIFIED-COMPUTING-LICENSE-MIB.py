...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-UNIFIED-COMPUTING-LICENSE-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:25:50 2025
...
CucsLicensePeerStatus, CucsLicenseTransport, CucsLicenseTransferState, CucsLicenseDownloaderFsmStageName, CucsLicenseFileState, CucsLicenseScope, CucsLicenseInstanceFsmStageName, CucsLicenseDownloaderFsmTaskItem, CucsLicenseInstanceFsmTaskItem, CucsLicenseFileFsmTaskItem, CucsLicenseDownloadActivity, CucsConditionRemoteInvRslt, CucsLicenseState, CucsLicenseType, CucsLicenseFileFsmCurrentFsm, CucsFsmFsmStageStatus, CucsLicenseDownloaderFsmCurrentFsm, CucsFsmCompletion, CucsFsmFlags, CucsLicenseInstanceFsmCurrentFsm, CucsLicenseFileFsmStageName, CucsPolicyPolicyOwner, CucsLicenseFeatureType = mibBuilder.importSymbols("CISCO-UNIFIED-COMPUTING-TC-MIB", "CucsLicensePeerStatus", "CucsLicenseTransport", "CucsLicenseTransferState", "CucsLicenseDownloaderFsmStageName", "CucsLicenseFileState", "CucsLicenseScope", "CucsLicenseInstanceFsmStageName", "CucsLicenseDownloaderFsmTaskItem", "CucsLicenseInstanceFsmTaskItem", "CucsLicenseFileFsmTaskItem", "CucsLicenseDownloadActivity", "CucsConditionRemoteInvRslt", "CucsLicenseState", "CucsLicenseType", "CucsLicenseFileFsmCurrentFsm", "CucsFsmFsmStageStatus", "CucsLicenseDownloaderFsmCurrentFsm", "CucsFsmCompletion", "CucsFsmFlags", "CucsLicenseInstanceFsmCurrentFsm", "CucsLicenseFileFsmStageName", "CucsPolicyPolicyOwner", "CucsLicenseFeatureType")
...
if mibBuilder.loadTexts: cucsLicenseObjects.setLastUpdated('201807260000Z')
...
mibBuilder.exportSymbols("CISCO-UNIFIED-COMPUTING-LICENSE-MIB", cucsLicenseFeatureCapProviderDeprecated=cucsLicenseFeatureCapProviderDeprecated, cucsLicenseDownloaderFsmStageLastUpdateTime=cucsLicenseDownloaderFsmStageLastUpdateTime, cucsLicenseInstanceFsmInstanceId=cucsLicenseInstanceFsmInstanceId, cucsLicenseInstanceFsmTaskCompletion=cucsLicenseInstanceFsmTaskCompletion, cucsLicenseFileFsmRmtInvErrDescr=cucsLicenseFileFsmRmtInvErrDescr, cucsLicenseDownloaderFsmProgr=cucsLicenseDownloaderFsmProgr, cucsLicenseFileFsmRmtInvErrCode=cucsLicenseFileFsmRmtInvErrCode, cucsLicenseDownloaderFsmTaskTable=cucsLicenseDownloaderFsmTaskTable, cucsLicenseInstanceRn=cucsLicenseInstanceRn, cucsLicenseFileFsmTaskRn=cucsLicenseFileFsmTaskRn, cucsLicenseInstanceFsmStageName=cucsLicenseInstanceFsmStageName, cucsLicenseDownloaderFsmEntry=cucsLicenseDownloaderFsmEntry, cucsLicenseFeatureEntry=cucsLicenseFeatureEntry, cucsLicenseInstanceFsmEntry=cucsLicenseInstanceFsmEntry, cucsLicenseFeatureVersion=cucsLicenseFeatureVersion, cucsLicenseDownloaderRemotePath=cucsLicenseDownloaderRemotePath, cucsLicenseObjects=cucsLicenseObjects, cucsLicenseDownloaderFsmStageTable=cucsLicenseDownloaderFsmStageTable, cucsLicenseDownloaderFsmTaskDn=cucsLicenseDownloaderFsmTaskDn, cucsLicenseFeatureCapProviderSku=cucsLicenseFeatureCapProviderSku, cucsLicensePropRn=cucsLicensePropRn, cucsLicenseFeatureDescr=cucsLicenseFeatureDescr, cucsLicenseServerHostIdInstanceId=cucsLicenseServerHostIdInstanceId, cucsLicenseFileFsmStageRetry=cucsLicenseFileFsmStageRetry, cucsLicenseFileName=cucsLicenseFileName, cucsLicenseContentsFeatureName=cucsLicenseContentsFeatureName, cucsLicenseContentsEntry=cucsLicenseContentsEntry, cucsLicenseFeatureRn=cucsLicenseFeatureRn, cucsLicenseFeatureCapProviderType=cucsLicenseFeatureCapProviderType, cucsLicenseFileFsmDn=cucsLicenseFileFsmDn, cucsLicenseInstanceFeature=cucsLicenseInstanceFeature, cucsLicenseFeatureCapProviderFeatureName=cucsLicenseFeatureCapProviderFeatureName, cucsLicenseInstanceFsmStageInstanceId=cucsLicenseInstanceFsmStageInstanceId, cucsLicenseEpRn=cucsLicenseEpRn, cucsLicenseSourceSku=cucsLicenseSourceSku, cucsLicenseInstanceFsmCompletionTime=cucsLicenseInstanceFsmCompletionTime, cucsLicenseInstanceScope=cucsLicenseInstanceScope, cucsLicenseFeaturePolicyLevel=cucsLicenseFeaturePolicyLevel, cucsLicenseDownloaderServer=cucsLicenseDownloaderServer, cucsLicenseInstanceFsmStageTable=cucsLicenseInstanceFsmStageTable, cucsLicenseFeatureCapProviderGencount=cucsLicenseFeatureCapProviderGencount, cucsLicenseFeatureLineId=cucsLicenseFeatureLineId, cucsLicenseInstanceFsmTaskInstanceId=cucsLicenseInstanceFsmTaskInstanceId, cucsLicenseDownloaderFsmDescr=cucsLicenseDownloaderFsmDescr, cucsLicenseEpInstanceId=cucsLicenseEpInstanceId, cucsLicenseFileOperStateDescr=cucsLicenseFileOperStateDescr, cucsLicenseInstanceIsPresent=cucsLicenseInstanceIsPresent, cucsLicenseSourceFileEntry=cucsLicenseSourceFileEntry, cucsLicenseFileFsmProgr=cucsLicenseFileFsmProgr, cucsLicenseServerHostIdRn=cucsLicenseServerHostIdRn, cucsLicenseDownloaderFsmFsmStatus=cucsLicenseDownloaderFsmFsmStatus, cucsLicenseFileEntry=cucsLicenseFileEntry, cucsLicenseFeatureCapProviderRevision=cucsLicenseFeatureCapProviderRevision, cucsLicenseDownloaderInstanceId=cucsLicenseDownloaderInstanceId, cucsLicenseFeatureIntId=cucsLicenseFeatureIntId, cucsLicenseFileVersion=cucsLicenseFileVersion, cucsLicenseContentsVendor=cucsLicenseContentsVendor, cucsLicenseInstanceTable=cucsLicenseInstanceTable, cucsLicenseInstanceAbsQuant=cucsLicenseInstanceAbsQuant, cucsLicenseFeatureType=cucsLicenseFeatureType, cucsLicenseSourceFileTable=cucsLicenseSourceFileTable, cucsLicenseDownloaderFsmStageDescrData=cucsLicenseDownloaderFsmStageDescrData, cucsLicenseFileFsmPrev=cucsLicenseFileFsmPrev, cucsLicenseDownloaderFileName=cucsLicenseDownloaderFileName, cucsLicenseDownloaderFsmStageRetry=cucsLicenseDownloaderFsmStageRetry, cucsLicenseFeatureLineSku=cucsLicenseFeatureLineSku, cucsLicenseDownloaderTransferState=cucsLicenseDownloaderTransferState, cucsLicenseFeatureLineRn=cucsLicenseFeatureLineRn, cucsLicenseFileFsmStageDescr=cucsLicenseFileFsmStageDescr, cucsLicenseFileFsmTaskCompletion=cucsLicenseFileFsmTaskCompletion, cucsLicenseInstanceFsmDn=cucsLicenseInstanceFsmDn, cucsLicensePropInstanceId=cucsLicensePropInstanceId, cucsLicenseInstanceFsmFsmStatus=cucsLicenseInstanceFsmFsmStatus, cucsLicenseFeatureCapProviderLicVendor=cucsLicenseFeatureCapProviderLicVendor, cucsLicenseServerHostIdTable=cucsLicenseServerHostIdTable, cucsLicenseInstanceSubordinateUsedQuant=cucsLicenseInstanceSubordinateUsedQuant, cucsLicenseEpEntry=cucsLicenseEpEntry, cucsLicenseSourceInstanceId=cucsLicenseSourceInstanceId, cucsLicenseDownloaderFsmDn=cucsLicenseDownloaderFsmDn, cucsLicenseContentsDn=cucsLicenseContentsDn, cucsLicenseFileFsmStamp=cucsLicenseFileFsmStamp, cucsLicenseInstanceFsmStageRn=cucsLicenseInstanceFsmStageRn, cucsLicenseContentsRn=cucsLicenseContentsRn, cucsLicenseFileFsmStageDn=cucsLicenseFileFsmStageDn, cucsLicenseFeatureCapProviderMgmtPlaneVer=cucsLicenseFeatureCapProviderMgmtPlaneVer, cucsLicenseInstanceFsmTaskRn=cucsLicenseInstanceFsmTaskRn, cucsLicenseFeatureLineDn=cucsLicenseFeatureLineDn, cucsLicenseFileFsmStageLastUpdateTime=cucsLicenseFileFsmStageLastUpdateTime, cucsLicenseDownloaderDn=cucsLicenseDownloaderDn, cucsLicenseFileRn=cucsLicenseFileRn, cucsLicenseInstanceDn=cucsLicenseInstanceDn, cucsLicenseInstanceFsmTable=cucsLicenseInstanceFsmTable, cucsLicenseSourceRn=cucsLicenseSourceRn, cucsLicenseFileFsmStageName=cucsLicenseFileFsmStageName, cucsLicenseFeatureLineType=cucsLicenseFeatureLineType, cucsLicenseDownloaderTable=cucsLicenseDownloaderTable, cucsLicenseDownloaderFsmPrev=cucsLicenseDownloaderFsmPrev, cucsLicenseFileFsmStageTable=cucsLicenseFileFsmStageTable, cucsLicenseFeatureCapProviderRn=cucsLicenseFeatureCapProviderRn, cucsLicenseDownloaderFsmRmtInvErrCode=cucsLicenseDownloaderFsmRmtInvErrCode, cucsLicenseInstanceGracePeriodUsed=cucsLicenseInstanceGracePeriodUsed, cucsLicenseFileFsmTaskSeqId=cucsLicenseFileFsmTaskSeqId, cucsLicenseInstanceFsmRmtErrCode=cucsLicenseInstanceFsmRmtErrCode, cucsLicenseDownloaderUser=cucsLicenseDownloaderUser, cucsLicenseInstanceDefQuant=cucsLicenseInstanceDefQuant, cucsLicenseInstanceFsmDescr=cucsLicenseInstanceFsmDescr, cucsLicenseDownloaderFsmTry=cucsLicenseDownloaderFsmTry, cucsLicenseInstanceFsmTaskSeqId=cucsLicenseInstanceFsmTaskSeqId, cucsLicenseDownloaderFsmStamp=cucsLicenseDownloaderFsmStamp, cucsLicenseFeatureLineSig=cucsLicenseFeatureLineSig, cucsLicenseDownloaderFsmStatus=cucsLicenseDownloaderFsmStatus, cucsLicenseFileFsmInstanceId=cucsLicenseFileFsmInstanceId, cucsLicenseFileFsmStageEntry=cucsLicenseFileFsmStageEntry, cucsLicenseInstanceFsmStageDescr=cucsLicenseInstanceFsmStageDescr, cucsLicenseSourceFileLine=cucsLicenseSourceFileLine, cucsLicenseSourceFileQuant=cucsLicenseSourceFileQuant, cucsLicenseInstanceFsmDescrData=cucsLicenseInstanceFsmDescrData, cucsLicenseInstanceFsmCurrentFsm=cucsLicenseInstanceFsmCurrentFsm, cucsLicenseFeatureLineTable=cucsLicenseFeatureLineTable, cucsLicenseDownloaderFsmRmtErrCode=cucsLicenseDownloaderFsmRmtErrCode, cucsLicenseFeatureCapProviderVendor=cucsLicenseFeatureCapProviderVendor, PYSNMP_MODULE_ID=cucsLicenseObjects, cucsLicenseDownloaderFsmTaskInstanceId=cucsLicenseDownloaderFsmTaskInstanceId, cucsLicenseEpDn=cucsLicenseEpDn, cucsLicenseInstanceFsmStageLastUpdateTime=cucsLicenseInstanceFsmStageLastUpdateTime, cucsLicenseFeatureLineExp=cucsLicenseFeatureLineExp, cucsLicenseInstanceInstanceId=cucsLicenseInstanceInstanceId, cucsLicenseFileFsmEntry=cucsLicenseFileFsmEntry, cucsLicensePropDn=cucsLicensePropDn, cucsLicenseFileInstanceId=cucsLicenseFileInstanceId, cucsLicenseFileFsmStatus=cucsLicenseFileFsmStatus, cucsLicenseDownloaderFsmCurrentFsm=cucsLicenseDownloaderFsmCurrentFsm, cucsLicenseFeatureVendor=cucsLicenseFeatureVendor, cucsLicenseFileFsmStageStageStatus=cucsLicenseFileFsmStageStageStatus, cucsLicensePropName=cucsLicensePropName, cucsLicenseSourceDn=cucsLicenseSourceDn, cucsLicenseFileFsmTaskEntry=cucsLicenseFileFsmTaskEntry, cucsLicenseDownloaderFsmTaskFlags=cucsLicenseDownloaderFsmTaskFlags, cucsLicenseInstanceUsedQuant=cucsLicenseInstanceUsedQuant, cucsLicenseInstanceFsmTaskEntry=cucsLicenseInstanceFsmTaskEntry, cucsLicenseFileFsmStageDescrData=cucsLicenseFileFsmStageDescrData, cucsLicenseFileFsmRmtRslt=cucsLicenseFileFsmRmtRslt, cucsLicenseFileFsmTaskInstanceId=cucsLicenseFileFsmTaskInstanceId, cucsLicenseInstanceFsmStageDn=cucsLicenseInstanceFsmStageDn, cucsLicenseInstanceSku=cucsLicenseInstanceSku, cucsLicenseDownloaderEntry=cucsLicenseDownloaderEntry, cucsLicenseFileFsmRmtErrDescr=cucsLicenseFileFsmRmtErrDescr, cucsLicenseFeatureGracePeriod=cucsLicenseFeatureGracePeriod, cucsLicenseFileFsmCompletionTime=cucsLicenseFileFsmCompletionTime, cucsLicenseInstancePeerStatus=cucsLicenseInstancePeerStatus, cucsLicenseDownloaderFsmRmtInvRslt=cucsLicenseDownloaderFsmRmtInvRslt, cucsLicenseInstanceFsmRn=cucsLicenseInstanceFsmRn, cucsLicenseFileFsmTry=cucsLicenseFileFsmTry, cucsLicenseFileFsmTaskItem=cucsLicenseFileFsmTaskItem, cucsLicenseFeatureLineEntry=cucsLicenseFeatureLineEntry, cucsLicensePropValue=cucsLicensePropValue, cucsLicenseSourceAlwaysUse=cucsLicenseSourceAlwaysUse, cucsLicenseDownloaderFsmStageInstanceId=cucsLicenseDownloaderFsmStageInstanceId, cucsLicenseDownloaderFsmCompletionTime=cucsLicenseDownloaderFsmCompletionTime, cucsLicenseContentsTable=cucsLicenseContentsTable, cucsLicenseInstanceFsmProgress=cucsLicenseInstanceFsmProgress, cucsLicenseInstanceFsmStamp=cucsLicenseInstanceFsmStamp, cucsLicenseDownloaderFsmRmtInvErrDescr=cucsLicenseDownloaderFsmRmtInvErrDescr, cucsLicenseFileFsmCurrentFsm=cucsLicenseFileFsmCurrentFsm, cucsLicenseDownloaderFsmTaskCompletion=cucsLicenseDownloaderFsmTaskCompletion, cucsLicenseDownloaderFsmTaskItem=cucsLicenseDownloaderFsmTaskItem, cucsLicenseFeatureCapProviderModel=cucsLicenseFeatureCapProviderModel, cucsLicenseFeatureCapProviderElementsLoaded=cucsLicenseFeatureCapProviderElementsLoaded, cucsLicenseFileFsmDescrData=cucsLicenseFileFsmDescrData, cucsLicenseFileId=cucsLicenseFileId, cucsLicenseFileFsmStageInstanceId=cucsLicenseFileFsmStageInstanceId, cucsLicenseSourceHostId=cucsLicenseSourceHostId, cucsLicenseFileAdminState=cucsLicenseFileAdminState, cucsLicenseFeatureCapProviderTable=cucsLicenseFeatureCapProviderTable, cucsLicenseSourceVendorDaemonPath=cucsLicenseSourceVendorDaemonPath, cucsLicenseTargetTable=cucsLicenseTargetTable, cucsLicenseTargetIsRackPresent=cucsLicenseTargetIsRackPresent, cucsLicenseInstanceFsmTaskDn=cucsLicenseInstanceFsmTaskDn, cucsLicenseFeatureLineQuant=cucsLicenseFeatureLineQuant, cucsLicenseEpTable=cucsLicenseEpTable, cucsLicenseInstanceFsmStageDescrData=cucsLicenseInstanceFsmStageDescrData, cucsLicenseDownloaderFsmStageOrder=cucsLicenseDownloaderFsmStageOrder, cucsLicenseTargetEntry=cucsLicenseTargetEntry, cucsLicenseDownloaderFsmStageName=cucsLicenseDownloaderFsmStageName, cucsLicenseInstanceFsmRmtInvRslt=cucsLicenseInstanceFsmRmtInvRslt, cucsLicenseFileDn=cucsLicenseFileDn, cucsLicenseContentsTotalQuant=cucsLicenseContentsTotalQuant, cucsLicenseFileFsmDescr=cucsLicenseFileFsmDescr, cucsLicenseInstanceFsmTry=cucsLicenseInstanceFsmTry, cucsLicenseTargetDn=cucsLicenseTargetDn, cucsLicenseSourceFilePak=cucsLicenseSourceFilePak, cucsLicenseFeatureCapProviderGracePeriod=cucsLicenseFeatureCapProviderGracePeriod, cucsLicenseSourceFileSig=cucsLicenseSourceFileSig, cucsLicenseFeatureCapProviderInstanceId=cucsLicenseFeatureCapProviderInstanceId, cucsLicenseInstanceFsmStageOrder=cucsLicenseInstanceFsmStageOrder, cucsLicenseFileFsmTaskDn=cucsLicenseFileFsmTaskDn, cucsLicenseDownloaderFsmDescrData=cucsLicenseDownloaderFsmDescrData, cucsLicenseFileOperState=cucsLicenseFileOperState, cucsLicenseTargetAggrPortId=cucsLicenseTargetAggrPortId, cucsLicenseFeatureCapProviderDn=cucsLicenseFeatureCapProviderDn, cucsLicenseDownloaderFsmRmtRslt=cucsLicenseDownloaderFsmRmtRslt, cucsLicenseInstanceFsmStageStageStatus=cucsLicenseInstanceFsmStageStageStatus, cucsLicenseFileFsmStageOrder=cucsLicenseFileFsmStageOrder, cucsLicenseSourceTable=cucsLicenseSourceTable, cucsLicenseDownloaderFsmTaskSeqId=cucsLicenseDownloaderFsmTaskSeqId, cucsLicenseInstanceFsmRmtInvErrDescr=cucsLicenseInstanceFsmRmtInvErrDescr, cucsLicenseFileScope=cucsLicenseFileScope, cucsLicenseServerHostIdScope=cucsLicenseServerHostIdScope, cucsLicenseFileFsmProgress=cucsLicenseFileFsmProgress, cucsLicenseFileFsmFsmStatus=cucsLicenseFileFsmFsmStatus, cucsLicenseInstanceFsmStageEntry=cucsLicenseInstanceFsmStageEntry, cucsLicenseDownloaderFsmProgress=cucsLicenseDownloaderFsmProgress, cucsLicenseFeatureTable=cucsLicenseFeatureTable, cucsLicenseDownloaderFsmStageRn=cucsLicenseDownloaderFsmStageRn, cucsLicenseInstanceFsmRmtErrDescr=cucsLicenseInstanceFsmRmtErrDescr, cucsLicenseInstanceFsmTaskTable=cucsLicenseInstanceFsmTaskTable, cucsLicensePropTable=cucsLicensePropTable, cucsLicenseInstanceFsmRmtInvErrCode=cucsLicenseInstanceFsmRmtInvErrCode, cucsLicenseTargetPortId=cucsLicenseTargetPortId, cucsLicensePropEntry=cucsLicensePropEntry, cucsLicenseFileFsmTaskFlags=cucsLicenseFileFsmTaskFlags, cucsLicenseDownloaderAdminState=cucsLicenseDownloaderAdminState, cucsLicenseContentsInstanceId=cucsLicenseContentsInstanceId, cucsLicenseDownloaderFsmRmtErrDescr=cucsLicenseDownloaderFsmRmtErrDescr, cucsLicenseSourceFileExp=cucsLicenseSourceFileExp, cucsLicenseFileFsmTaskTable=cucsLicenseFileFsmTaskTable, cucsLicenseFileFsmTable=cucsLicenseFileFsmTable, cucsLicenseSourceHostName=cucsLicenseSourceHostName, cucsLicenseSourceFileInstanceId=cucsLicenseSourceFileInstanceId, cucsLicenseContentsVersion=cucsLicenseContentsVersion, cucsLicenseFileFsmRmtErrCode=cucsLicenseFileFsmRmtErrCode, cucsLicenseDownloaderFsmRn=cucsLicenseDownloaderFsmRn, cucsLicenseFeatureCapProviderLoadErrors=cucsLicenseFeatureCapProviderLoadErrors, cucsLicenseDownloaderFsmTaskEntry=cucsLicenseDownloaderFsmTaskEntry, cucsLicenseFeaturePolicyOwner=cucsLicenseFeaturePolicyOwner, cucsLicenseFeatureInstanceId=cucsLicenseFeatureInstanceId, cucsLicenseDownloaderFsmStageDn=cucsLicenseDownloaderFsmStageDn, cucsLicenseDownloaderFsmStageDescr=cucsLicenseDownloaderFsmStageDescr, cucsLicenseDownloaderPwd=cucsLicenseDownloaderPwd, cucsLicenseSourceEntry=cucsLicenseSourceEntry, cucsLicenseInstanceFsmProgr=cucsLicenseInstanceFsmProgr, cucsLicenseFeatureCapProviderLicVersion=cucsLicenseFeatureCapProviderLicVersion, cucsLicenseServerHostIdDn=cucsLicenseServerHostIdDn, cucsLicenseInstanceFsmTaskFlags=cucsLicenseInstanceFsmTaskFlags, cucsLicenseTargetInstanceId=cucsLicenseTargetInstanceId, cucsLicenseFileFsmRn=cucsLicenseFileFsmRn, cucsLicenseFeatureCapProviderLoadWarnings=cucsLicenseFeatureCapProviderLoadWarnings, cucsLicenseInstanceEntry=cucsLicenseInstanceEntry, cucsLicenseSourceFileDn=cucsLicenseSourceFileDn, cucsLicenseSourceFileHostId=cucsLicenseSourceFileHostId, cucsLicenseFeatureLinePak=cucsLicenseFeatureLinePak, cucsLicenseFeatureDn=cucsLicenseFeatureDn, cucsLicenseInstanceFsmStageRetry=cucsLicenseInstanceFsmStageRetry, cucsLicenseSourceFileId=cucsLicenseSourceFileId)
mibBuilder.exportSymbols("CISCO-UNIFIED-COMPUTING-LICENSE-MIB", cucsLicenseFeatureLineInstanceId=cucsLicenseFeatureLineInstanceId, cucsLicenseDownloaderFsmStageEntry=cucsLicenseDownloaderFsmStageEntry, cucsLicenseDownloaderFsmTable=cucsLicenseDownloaderFsmTable, cucsLicenseServerHostIdEntry=cucsLicenseServerHostIdEntry, cucsLicenseDownloaderProt=cucsLicenseDownloaderProt, cucsLicenseServerHostIdHostId=cucsLicenseServerHostIdHostId, cucsLicenseTargetSlotId=cucsLicenseTargetSlotId, cucsLicenseDownloaderFsmStageStageStatus=cucsLicenseDownloaderFsmStageStageStatus, cucsLicenseFeatureCapProviderEntry=cucsLicenseFeatureCapProviderEntry, cucsLicenseDownloaderRn=cucsLicenseDownloaderRn, cucsLicenseInstanceFsmRmtRslt=cucsLicenseInstanceFsmRmtRslt, cucsLicenseInstanceOperState=cucsLicenseInstanceOperState, cucsLicenseFileFsmStageRn=cucsLicenseFileFsmStageRn, cucsLicenseInstanceFsmTaskItem=cucsLicenseInstanceFsmTaskItem, cucsLicenseFeatureName=cucsLicenseFeatureName, cucsLicenseDownloaderFsmInstanceId=cucsLicenseDownloaderFsmInstanceId, cucsLicenseFeatureCapProviderElementLoadFailures=cucsLicenseFeatureCapProviderElementLoadFailures, cucsLicenseSourceFileRn=cucsLicenseSourceFileRn, cucsLicenseTargetRn=cucsLicenseTargetRn, cucsLicenseInstanceFsmPrev=cucsLicenseInstanceFsmPrev, cucsLicenseFeatureCapProviderDeleted=cucsLicenseFeatureCapProviderDeleted, cucsLicenseFileTable=cucsLicenseFileTable, cucsLicenseInstanceFsmStatus=cucsLicenseInstanceFsmStatus, cucsLicenseFeatureCapProviderDefQuant=cucsLicenseFeatureCapProviderDefQuant, cucsLicenseDownloaderFsmTaskRn=cucsLicenseDownloaderFsmTaskRn, cucsLicenseSourceFileType=cucsLicenseSourceFileType, cucsLicenseFileFsmRmtInvRslt=cucsLicenseFileFsmRmtInvRslt)
