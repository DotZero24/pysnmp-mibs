...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TROPIC-USERMGMT-MIB
...
tnUserPasswordAging = _TnUserPasswordAging_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 1, 7, 2, 1, 1, 1, 13),
    _TnUserPasswordAging_Type()
)
tnUserPasswordAging.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnUserPasswordAging.setStatus("current")
...
class _TnUserMgmtSysMaxSession_Type(Unsigned32):
    """Custom type tnUserMgmtSysMaxSession based on Unsigned32"""
    defaultValue = 0


_TnUserMgmtSysMaxSession_Type.__name__ = "Unsigned32"
_TnUserMgmtSysMaxSession_Object = MibScalar
tnUserMgmtSysMaxSession = _TnUserMgmtSysMaxSession_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 1, 7, 2, 2, 12),
    _TnUserMgmtSysMaxSession_Type()
)
tnUserMgmtSysMaxSession.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tnUserMgmtSysMaxSession.setStatus("current")
...
tnUserGroup.setObjects(
      *(("TROPIC-USERMGMT-MIB", "tnUserRowStatus"),
        ...
        ("TROPIC-USERMGMT-MIB", "tnUserPasswordAging"))
)
if mibBuilder.loadTexts:
...
tnUserMgmtGlobalGroup.setObjects(
      *(("TROPIC-USERMGMT-MIB", "tnUserMgmtSysMinPasswordLength"),
        ...
        ("TROPIC-USERMGMT-MIB", "tnUserMgmtSysMaxSession"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"tnUserMgmtMibModule": tnUserMgmtMibModule,
       ...
       "tnUserPasswordAging": tnUserPasswordAging,
       ...
       "tnUserMgmtSysMaxSession": tnUserMgmtSysMaxSession}
)
