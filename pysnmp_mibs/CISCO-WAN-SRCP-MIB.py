...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-SRCP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:21:52 2025
...
srcpMIBCompliance.setObjects(
      *(("CISCO-WAN-SRCP-MIB", "srcpConfigurationGroup"),
        ("CISCO-WAN-SRCP-MIB", "srcpStatisticsGroup"))
)
if mibBuilder.loadTexts:
...
srcpMIBComplaince2.setObjects(
      *(("CISCO-WAN-SRCP-MIB", "srcpConfigurationGroup2"),
        ("CISCO-WAN-SRCP-MIB", "srcpStatisticsGroup2"))
)
if mibBuilder.loadTexts:
...
srcpMIBComplaince3.setObjects(
      *(("CISCO-WAN-SRCP-MIB", "srcpConfigurationGroup3"),
        ("CISCO-WAN-SRCP-MIB", "srcpStatisticsGroup2"))
)
if mibBuilder.loadTexts:
