# SNMP MIB module (FS-NMS-LLDP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/fscom/FS-NMS-LLDP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:15:47 2025
...
lldpPortConfigEntry.setIndexNames(
    (0, "FS-NMS-LLDP-MIB", "lldpPortConfigPortNum"),
)
if mibBuilder.loadTexts:
...
lldpStatsTxPortEntry.setIndexNames(
    (0, "FS-NMS-LLDP-MIB", "lldpStatsTxPortNum"),
)
if mibBuilder.loadTexts:
...
lldpStatsRxPortEntry.setIndexNames(
    (0, "FS-NMS-LLDP-MIB", "lldpStatsRxPortNum"),
)
if mibBuilder.loadTexts:
...
lldpLocPortEntry.setIndexNames(
    (0, "FS-NMS-LLDP-MIB", "lldpLocPortNum"),
)
if mibBuilder.loadTexts:
...
lldpLocManAddrEntry.setIndexNames(
    (0, "FS-NMS-LLDP-MIB", "lldpLocManAddrSubtype"),
    (0, "FS-NMS-LLDP-MIB", "lldpLocManAddr"),
)
if mibBuilder.loadTexts:
...
lldpRemEntry.setIndexNames(
    (0, "FS-NMS-LLDP-MIB", "lldpRemTimeMark"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemLocalPortNum"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemIndex"),
)
if mibBuilder.loadTexts:
...
lldpRemManAddrEntry.setIndexNames(
    ...
    (0, "FS-NMS-LLDP-MIB", "lldpRemLocalPortNum"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemIndex"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemManAddrSubtype"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemManAddr"),
)
if mibBuilder.loadTexts:
...
lldpRemUnknownTLVEntry.setIndexNames(
    ...
    (0, "FS-NMS-LLDP-MIB", "lldpRemLocalPortNum"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemIndex"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemUnknownTLVType"),
)
if mibBuilder.loadTexts:
...
lldpRemOrgDefInfoEntry.setIndexNames(
    ...
    (0, "FS-NMS-LLDP-MIB", "lldpRemLocalPortNum"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemIndex"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemOrgDefInfoOUI"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemOrgDefInfoSubtype"),
    (0, "FS-NMS-LLDP-MIB", "lldpRemOrgDefInfoIndex"),
)
if mibBuilder.loadTexts:
...
lldpConfigGroup.setObjects(
    ("FS-NMS-LLDP-MIB", "lldpPortConfigAdminStatus")
)
if mibBuilder.loadTexts:
...
lldpConfigRxGroup.setObjects(
      *(("FS-NMS-LLDP-MIB", "lldpNotificationInterval"),
        ("FS-NMS-LLDP-MIB", "lldpPortConfigNotificationEnable"))
)
if mibBuilder.loadTexts:
...
lldpConfigTxGroup.setObjects(
      *(("FS-NMS-LLDP-MIB", "lldpMessageTxInterval"),
        ("FS-NMS-LLDP-MIB", "lldpMessageTxHoldMultiplier"),
        ("FS-NMS-LLDP-MIB", "lldpReinitDelay"),
        ("FS-NMS-LLDP-MIB", "lldpTxDelay"),
        ("FS-NMS-LLDP-MIB", "lldpPortConfigTLVsTxEnable"),
        ("FS-NMS-LLDP-MIB", "lldpConfigManAddrPortsTxEnable"))
)
if mibBuilder.loadTexts:
...
lldpStatsRxGroup.setObjects(
      *(("FS-NMS-LLDP-MIB", "lldpStatsRemTablesLastChangeTime"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRemTablesInserts"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRemTablesDeletes"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRemTablesDrops"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRemTablesAgeouts"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRxPortFramesDiscardedTotal"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRxPortFramesErrors"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRxPortFramesTotal"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRxPortTLVsDiscardedTotal"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRxPortTLVsUnrecognizedTotal"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRxPortAgeoutsTotal"))
)
if mibBuilder.loadTexts:
...
lldpStatsTxGroup.setObjects(
    ("FS-NMS-LLDP-MIB", "lldpStatsTxPortFramesTotal")
)
if mibBuilder.loadTexts:
...
lldpLocSysGroup.setObjects(
      *(("FS-NMS-LLDP-MIB", "lldpLocChassisIdSubtype"),
        ("FS-NMS-LLDP-MIB", "lldpLocChassisId"),
        ("FS-NMS-LLDP-MIB", "lldpLocPortIdSubtype"),
        ("FS-NMS-LLDP-MIB", "lldpLocPortId"),
        ("FS-NMS-LLDP-MIB", "lldpLocPortDesc"),
        ("FS-NMS-LLDP-MIB", "lldpLocSysDesc"),
        ("FS-NMS-LLDP-MIB", "lldpLocSysName"),
        ("FS-NMS-LLDP-MIB", "lldpLocSysCapSupported"),
        ("FS-NMS-LLDP-MIB", "lldpLocSysCapEnabled"),
        ("FS-NMS-LLDP-MIB", "lldpLocManAddrLen"),
        ("FS-NMS-LLDP-MIB", "lldpLocManAddrIfSubtype"),
        ("FS-NMS-LLDP-MIB", "lldpLocManAddrIfId"),
        ("FS-NMS-LLDP-MIB", "lldpLocManAddrOID"))
)
if mibBuilder.loadTexts:
...
lldpRemSysGroup.setObjects(
      *(("FS-NMS-LLDP-MIB", "lldpRemChassisIdSubtype"),
        ("FS-NMS-LLDP-MIB", "lldpRemChassisId"),
        ("FS-NMS-LLDP-MIB", "lldpRemPortIdSubtype"),
        ("FS-NMS-LLDP-MIB", "lldpRemPortId"),
        ("FS-NMS-LLDP-MIB", "lldpRemPortDesc"),
        ("FS-NMS-LLDP-MIB", "lldpRemSysName"),
        ("FS-NMS-LLDP-MIB", "lldpRemSysDesc"),
        ("FS-NMS-LLDP-MIB", "lldpRemSysCapSupported"),
        ("FS-NMS-LLDP-MIB", "lldpRemSysCapEnabled"),
        ("FS-NMS-LLDP-MIB", "lldpRemManAddrIfSubtype"),
        ("FS-NMS-LLDP-MIB", "lldpRemManAddrIfId"),
        ("FS-NMS-LLDP-MIB", "lldpRemManAddrOID"),
        ("FS-NMS-LLDP-MIB", "lldpRemUnknownTLVInfo"),
        ("FS-NMS-LLDP-MIB", "lldpRemOrgDefInfo"))
)
if mibBuilder.loadTexts:
...
lldpNotificationsGroup.setObjects(
    ("FS-NMS-LLDP-MIB", "lldpRemTablesChange")
)
if mibBuilder.loadTexts:
...
lldpCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 52642, 127, 2, 1, 1)
)
lldpCompliance.setObjects(
      *(("FS-NMS-LLDP-MIB", "lldpConfigGroup"),
        ("FS-NMS-LLDP-MIB", "lldpConfigRxGroup"),
        ("FS-NMS-LLDP-MIB", "lldpConfigTxGroup"),
        ("FS-NMS-LLDP-MIB", "lldpStatsRxGroup"),
        ("FS-NMS-LLDP-MIB", "lldpStatsTxGroup"),
        ("FS-NMS-LLDP-MIB", "lldpLocSysGroup"),
        ("FS-NMS-LLDP-MIB", "lldpRemSysGroup"),
        ("FS-NMS-LLDP-MIB", "lldpNotificationsGroup"))
)
if mibBuilder.loadTexts:
