...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WIRELESS-DOCS-EXT-MIB
...
_CwdxHeSuChOverTrapOnCompletion_Type.__name__ = "TruthValue"
...
cwdxDocsExtCompliance.setObjects(
      *(("CISCO-WIRELESS-DOCS-EXT-MIB", "cwdxQosCtrlGroup"),
        ("CISCO-WIRELESS-DOCS-EXT-MIB", "cwdxQosQueueGroup"),
        ("CISCO-WIRELESS-DOCS-EXT-MIB", "cwdxHeSuCpeGroup"))
)
if mibBuilder.loadTexts:
