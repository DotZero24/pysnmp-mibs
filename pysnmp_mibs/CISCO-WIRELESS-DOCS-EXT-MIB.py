...
cwdIfHeServiceEntry, cwdIfHeSuStatusDownChanIfIndex, cwdIfHeSuStatusIndex, cwdIfHeSuStatusEntry, cwdIfHeSuStatusUpChanIfIndex, cwdIfHeMacEntry, cwdIfHeSuStatusMacAddress, cwdIfQosProfIndex, cwdIfQosProfileEntry, cwdIfHeSuStatusServiceId, cwdIfHeSuStatusIpAddress = mibBuilder.importSymbols("CISCO-WIRELESS-DOCS-IF-MIB", "cwdIfHeServiceEntry", "cwdIfHeSuStatusDownChanIfIndex", "cwdIfHeSuStatusIndex", "cwdIfHeSuStatusEntry", "cwdIfHeSuStatusUpChanIfIndex", "cwdIfHeMacEntry", "cwdIfHeSuStatusMacAddress", "cwdIfQosProfIndex", "cwdIfQosProfileEntry", "cwdIfHeSuStatusServiceId", "cwdIfHeSuStatusIpAddress")
...
mibBuilder.exportSymbols("CISCO-WIRELESS-DOCS-EXT-MIB", cwdxCpeIpAddress=cwdxCpeIpAddress, cwdxSuMappingStatusIndex=cwdxSuMappingStatusIndex, cwdxQosCtrlUpTable=cwdxQosCtrlUpTable, cwdxBWQueueOrder=cwdxBWQueueOrder, cwdxIfHeSuStatusMaxOfflineTime=cwdxIfHeSuStatusMaxOfflineTime, cwdxQosCtrlUpReservedBW=cwdxQosCtrlUpReservedBW, cwdxHeSuStatusExtEntry=cwdxHeSuStatusExtEntry, cwdxQosIpTosRatelimitEntry=cwdxQosIpTosRatelimitEntry, cwdxBWQueueType=cwdxBWQueueType, cwdxCpeTable=cwdxCpeTable, cwdxIfHeSuStatusAvgOfflineTime=cwdxIfHeSuStatusAvgOfflineTime, cwdxBWQueueEntry=cwdxBWQueueEntry, cwdxHeServiceExtEntry=cwdxHeServiceExtEntry, cwdxBWQueueTable=cwdxBWQueueTable, cwdxQosIfRateLimitEntry=cwdxQosIfRateLimitEntry, cwdxQosIfRateLimitShpGranularity=cwdxQosIfRateLimitShpGranularity, cwdxQosIpTosRatelimitMaxDownRate=cwdxQosIpTosRatelimitMaxDownRate, cwdxQosCtrlObjects=cwdxQosCtrlObjects, cwdxHeMacExtEntry=cwdxHeMacExtEntry, cwdxHeSuOnOffNotification=cwdxHeSuOnOffNotification, cwdxHeSuCpeGroup=cwdxHeSuCpeGroup, cwdxCpeEntry=cwdxCpeEntry, cwdxIfHeSuStatusOnlineTimes=cwdxIfHeSuStatusOnlineTimes, cwdxQosCtrlUpEntry=cwdxQosCtrlUpEntry, ciscoWirelessDocsExtConformance=ciscoWirelessDocsExtConformance, PYSNMP_MODULE_ID=ciscoWirelessDocsExtMIB, cwdxQosIfRateLimitExpWgt=cwdxQosIfRateLimitExpWgt, cwdxQosProfileExtTable=cwdxQosProfileExtTable, cwdxQosProfGrantInterval=cwdxQosProfGrantInterval, cwdxDocsExtCompliance=cwdxDocsExtCompliance, cwdxQosProfileExtEntry=cwdxQosProfileExtEntry, cwdxQosProfileExtObjects=cwdxQosProfileExtObjects, cwdxDocsExtCompliances=cwdxDocsExtCompliances, cwdxQosProfGrantSize=cwdxQosProfGrantSize, cwdxHeSuTable=cwdxHeSuTable, cwdxSuMappingMacAddress=cwdxSuMappingMacAddress, cwdxSuMappingEntry=cwdxSuMappingEntry, cwdxCpeMacAddress=cwdxCpeMacAddress, cwdxHeSuChOverUpChannelId=cwdxHeSuChOverUpChannelId, ciscoWirelessDocsExtNotifications=ciscoWirelessDocsExtNotifications, cwdxHeSuMaxCpeNumber=cwdxHeSuMaxCpeNumber, cwdxCpeStatusIndex=cwdxCpeStatusIndex, cwdxHeSuEntry=cwdxHeSuEntry, cwdxHeSuChOverNotification=cwdxHeSuChOverNotification, cwdxQosCtrlUpMaxVirtualBW=cwdxQosCtrlUpMaxVirtualBW, cwdxIfHeServiceOutOctets=cwdxIfHeServiceOutOctets, cwdxIfHeSuStatusAvgOnlineTime=cwdxIfHeSuStatusAvgOnlineTime, cwdxHeTotalSusOffline=cwdxHeTotalSusOffline, cwdxQosIfRateLimitAlgo=cwdxQosIfRateLimitAlgo, cwdxHeSuOnOffTrapInterval=cwdxHeSuOnOffTrapInterval, cwdxBWQueueNameCode=cwdxBWQueueNameCode, cwdxHeSuDefaultMaxCpes=cwdxHeSuDefaultMaxCpes, cwdxHeSuChOverState=cwdxHeSuChOverState, cwdxHeSuChOverTimeExpiration=cwdxHeSuChOverTimeExpiration, cwdxBWQueueNumServedBeforeYield=cwdxBWQueueNumServedBeforeYield, cwdxQosCtrlUpAdmissionCtrl=cwdxQosCtrlUpAdmissionCtrl, cwdxHeSuChOverEntry=cwdxHeSuChOverEntry, cwdxIfHeSuStatusMaxOnlineTime=cwdxIfHeSuStatusMaxOnlineTime, cwdxBWQueueDiscards=cwdxBWQueueDiscards, cwdxQosProfTosOverwriteMask=cwdxQosProfTosOverwriteMask, cwdxQosCtrlUpAdmissionRejects=cwdxQosCtrlUpAdmissionRejects, cwdxQosProfName=cwdxQosProfName, cwdxQosCtrlGroup=cwdxQosCtrlGroup, cwdxHeSuStatusValue=cwdxHeSuStatusValue, cwdxHeSuChOverDownFrequency=cwdxHeSuChOverDownFrequency, cwdxBWQueueDepth=cwdxBWQueueDepth, cwdxDocsExtGroups=cwdxDocsExtGroups, cwdxHeSuChOverOpInitiatedTime=cwdxHeSuChOverOpInitiatedTime, cwdxBWQueueMaxDepth=cwdxBWQueueMaxDepth, cwdxHeSuOnOffTrapEnable=cwdxHeSuOnOffTrapEnable, cwdxSuMappingTable=cwdxSuMappingTable, ciscoWirelessDocsExtMIB=ciscoWirelessDocsExtMIB, cwdxHeMacExtTable=cwdxHeMacExtTable, cwdxHeSuChOverTrapOnCompletion=cwdxHeSuChOverTrapOnCompletion, cwdxQosIpTosRatelimitIndex=cwdxQosIpTosRatelimitIndex, cwdxHeSuChOverMacAddress=cwdxHeSuChOverMacAddress, cwdxIfHeServiceOutPackets=cwdxIfHeServiceOutPackets, cwdxQosQueueGroup=cwdxQosQueueGroup, cwdxIfHeSuStatusMinOfflineTime=cwdxIfHeSuStatusMinOfflineTime, cwdxIfHeSuStatusMinOnlineTime=cwdxIfHeSuStatusMinOnlineTime, cwdxHeSuChOverTable=cwdxHeSuChOverTable, cwdxQosIpTosRatelimitTable=cwdxQosIpTosRatelimitTable, cwdxQosMaxDownBWExcessPackets=cwdxQosMaxDownBWExcessPackets, cwdxQosIfRateLimitShpMaxDelay=cwdxQosIfRateLimitShpMaxDelay, cwdxQosIfRateLimitTable=cwdxQosIfRateLimitTable, cwdxQosProfTosOverwriteValue=cwdxQosProfTosOverwriteValue, cwdxCpeAccessGroup=cwdxCpeAccessGroup, cwdxHeSuChOverSerialNumber=cwdxHeSuChOverSerialNumber, ciscoWirelessDocsExtNotificationsPrefix=ciscoWirelessDocsExtNotificationsPrefix, cwdxHeSuStatusExtTable=cwdxHeSuStatusExtTable, cwdxQosCtrlUpMaxRsvdBWPercent=cwdxQosCtrlUpMaxRsvdBWPercent, cwdxQosMaxUpBWExcessRequests=cwdxQosMaxUpBWExcessRequests, cwdxHeServiceExtTable=cwdxHeServiceExtTable, ciscoWirelessDocsExtMIBObjects=ciscoWirelessDocsExtMIBObjects, cwdxHeSuChOverRowStatus=cwdxHeSuChOverRowStatus, cwdxQosQueueObjects=cwdxQosQueueObjects, cwdxHeTotalSusRegistered=cwdxHeTotalSusRegistered, cwdxIfHeSuStatusPercentOnline=cwdxIfHeSuStatusPercentOnline, cwdxIfHeSuStatusDynSidCount=cwdxIfHeSuStatusDynSidCount, cwdxHeSuCpeObjects=cwdxHeSuCpeObjects)
