...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-WIRELESS-DOCS-EXT-MIB
...
cwdIfHeSuStatusEntry, cwdIfHeSuStatusServiceId, cwdIfHeSuStatusDownChanIfIndex, cwdIfHeServiceEntry, cwdIfHeSuStatusIpAddress, cwdIfHeSuStatusUpChanIfIndex, cwdIfHeSuStatusMacAddress, cwdIfHeMacEntry, cwdIfQosProfIndex, cwdIfHeSuStatusIndex, cwdIfQosProfileEntry = mibBuilder.importSymbols("CISCO-WIRELESS-DOCS-IF-MIB", "cwdIfHeSuStatusEntry", "cwdIfHeSuStatusServiceId", "cwdIfHeSuStatusDownChanIfIndex", "cwdIfHeServiceEntry", "cwdIfHeSuStatusIpAddress", "cwdIfHeSuStatusUpChanIfIndex", "cwdIfHeSuStatusMacAddress", "cwdIfHeMacEntry", "cwdIfQosProfIndex", "cwdIfHeSuStatusIndex", "cwdIfQosProfileEntry")
...
mibBuilder.exportSymbols("CISCO-WIRELESS-DOCS-EXT-MIB", cwdxHeTotalSusRegistered=cwdxHeTotalSusRegistered, cwdxQosIpTosRatelimitMaxDownRate=cwdxQosIpTosRatelimitMaxDownRate, cwdxQosProfTosOverwriteValue=cwdxQosProfTosOverwriteValue, cwdxQosIfRateLimitAlgo=cwdxQosIfRateLimitAlgo, cwdxIfHeSuStatusMinOfflineTime=cwdxIfHeSuStatusMinOfflineTime, cwdxQosProfTosOverwriteMask=cwdxQosProfTosOverwriteMask, ciscoWirelessDocsExtNotifications=ciscoWirelessDocsExtNotifications, cwdxQosCtrlUpMaxVirtualBW=cwdxQosCtrlUpMaxVirtualBW, cwdxBWQueueDepth=cwdxBWQueueDepth, cwdxQosIpTosRatelimitIndex=cwdxQosIpTosRatelimitIndex, cwdxDocsExtGroups=cwdxDocsExtGroups, cwdxQosIfRateLimitExpWgt=cwdxQosIfRateLimitExpWgt, cwdxSuMappingTable=cwdxSuMappingTable, cwdxHeMacExtEntry=cwdxHeMacExtEntry, cwdxHeSuChOverDownFrequency=cwdxHeSuChOverDownFrequency, cwdxHeSuChOverSerialNumber=cwdxHeSuChOverSerialNumber, cwdxQosProfileExtEntry=cwdxQosProfileExtEntry, cwdxDocsExtCompliances=cwdxDocsExtCompliances, cwdxQosProfGrantSize=cwdxQosProfGrantSize, cwdxIfHeSuStatusMaxOfflineTime=cwdxIfHeSuStatusMaxOfflineTime, cwdxSuMappingEntry=cwdxSuMappingEntry, cwdxQosIfRateLimitEntry=cwdxQosIfRateLimitEntry, PYSNMP_MODULE_ID=ciscoWirelessDocsExtMIB, cwdxBWQueueNameCode=cwdxBWQueueNameCode, cwdxHeSuStatusValue=cwdxHeSuStatusValue, cwdxHeTotalSusOffline=cwdxHeTotalSusOffline, cwdxHeSuChOverState=cwdxHeSuChOverState, cwdxQosIfRateLimitTable=cwdxQosIfRateLimitTable, cwdxBWQueueDiscards=cwdxBWQueueDiscards, cwdxDocsExtCompliance=cwdxDocsExtCompliance, cwdxHeSuCpeGroup=cwdxHeSuCpeGroup, cwdxHeSuChOverEntry=cwdxHeSuChOverEntry, cwdxBWQueueNumServedBeforeYield=cwdxBWQueueNumServedBeforeYield, cwdxHeSuChOverOpInitiatedTime=cwdxHeSuChOverOpInitiatedTime, cwdxHeSuChOverTrapOnCompletion=cwdxHeSuChOverTrapOnCompletion, cwdxCpeTable=cwdxCpeTable, cwdxIfHeSuStatusAvgOfflineTime=cwdxIfHeSuStatusAvgOfflineTime, cwdxQosIfRateLimitShpMaxDelay=cwdxQosIfRateLimitShpMaxDelay, cwdxCpeEntry=cwdxCpeEntry, cwdxQosProfGrantInterval=cwdxQosProfGrantInterval, cwdxHeSuChOverRowStatus=cwdxHeSuChOverRowStatus, cwdxIfHeSuStatusMaxOnlineTime=cwdxIfHeSuStatusMaxOnlineTime, cwdxQosMaxDownBWExcessPackets=cwdxQosMaxDownBWExcessPackets, cwdxBWQueueType=cwdxBWQueueType, cwdxIfHeSuStatusPercentOnline=cwdxIfHeSuStatusPercentOnline, cwdxHeSuStatusExtTable=cwdxHeSuStatusExtTable, cwdxHeSuChOverTimeExpiration=cwdxHeSuChOverTimeExpiration, cwdxQosCtrlUpReservedBW=cwdxQosCtrlUpReservedBW, cwdxQosCtrlUpMaxRsvdBWPercent=cwdxQosCtrlUpMaxRsvdBWPercent, ciscoWirelessDocsExtMIB=ciscoWirelessDocsExtMIB, cwdxHeSuMaxCpeNumber=cwdxHeSuMaxCpeNumber, ciscoWirelessDocsExtConformance=ciscoWirelessDocsExtConformance, cwdxHeSuOnOffTrapEnable=cwdxHeSuOnOffTrapEnable, cwdxQosProfName=cwdxQosProfName, cwdxIfHeSuStatusMinOnlineTime=cwdxIfHeSuStatusMinOnlineTime, cwdxHeSuDefaultMaxCpes=cwdxHeSuDefaultMaxCpes, cwdxBWQueueEntry=cwdxBWQueueEntry, cwdxHeSuCpeObjects=cwdxHeSuCpeObjects, cwdxQosQueueObjects=cwdxQosQueueObjects, cwdxQosCtrlObjects=cwdxQosCtrlObjects, cwdxHeSuChOverTable=cwdxHeSuChOverTable, cwdxCpeMacAddress=cwdxCpeMacAddress, cwdxQosProfileExtTable=cwdxQosProfileExtTable, cwdxIfHeSuStatusOnlineTimes=cwdxIfHeSuStatusOnlineTimes, cwdxQosIpTosRatelimitEntry=cwdxQosIpTosRatelimitEntry, ciscoWirelessDocsExtNotificationsPrefix=ciscoWirelessDocsExtNotificationsPrefix, cwdxIfHeServiceOutOctets=cwdxIfHeServiceOutOctets, ciscoWirelessDocsExtMIBObjects=ciscoWirelessDocsExtMIBObjects, cwdxQosCtrlGroup=cwdxQosCtrlGroup, cwdxHeSuOnOffTrapInterval=cwdxHeSuOnOffTrapInterval, cwdxQosCtrlUpAdmissionCtrl=cwdxQosCtrlUpAdmissionCtrl, cwdxQosQueueGroup=cwdxQosQueueGroup, cwdxHeSuTable=cwdxHeSuTable, cwdxHeServiceExtTable=cwdxHeServiceExtTable, cwdxCpeStatusIndex=cwdxCpeStatusIndex, cwdxQosCtrlUpAdmissionRejects=cwdxQosCtrlUpAdmissionRejects, cwdxHeServiceExtEntry=cwdxHeServiceExtEntry, cwdxHeSuOnOffNotification=cwdxHeSuOnOffNotification, cwdxQosProfileExtObjects=cwdxQosProfileExtObjects, cwdxBWQueueMaxDepth=cwdxBWQueueMaxDepth, cwdxQosIfRateLimitShpGranularity=cwdxQosIfRateLimitShpGranularity, cwdxIfHeServiceOutPackets=cwdxIfHeServiceOutPackets, cwdxHeSuChOverNotification=cwdxHeSuChOverNotification, cwdxCpeAccessGroup=cwdxCpeAccessGroup, cwdxQosCtrlUpEntry=cwdxQosCtrlUpEntry, cwdxSuMappingStatusIndex=cwdxSuMappingStatusIndex, cwdxHeSuChOverMacAddress=cwdxHeSuChOverMacAddress, cwdxQosCtrlUpTable=cwdxQosCtrlUpTable, cwdxHeSuStatusExtEntry=cwdxHeSuStatusExtEntry, cwdxHeSuEntry=cwdxHeSuEntry, cwdxIfHeSuStatusAvgOnlineTime=cwdxIfHeSuStatusAvgOnlineTime, cwdxQosMaxUpBWExcessRequests=cwdxQosMaxUpBWExcessRequests, cwdxIfHeSuStatusDynSidCount=cwdxIfHeSuStatusDynSidCount, cwdxHeMacExtTable=cwdxHeMacExtTable, cwdxSuMappingMacAddress=cwdxSuMappingMacAddress, cwdxHeSuChOverUpChannelId=cwdxHeSuChOverUpChannelId, cwdxCpeIpAddress=cwdxCpeIpAddress, cwdxBWQueueOrder=cwdxBWQueueOrder, cwdxQosIpTosRatelimitTable=cwdxQosIpTosRatelimitTable, cwdxBWQueueTable=cwdxBWQueueTable)
