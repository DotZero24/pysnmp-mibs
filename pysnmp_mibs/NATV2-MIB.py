...
# Notes
# -----
# ASN.1 source file://mibs/rfc/NATV2-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:25:14 2025
...
_Natv2SubscriberLimitPortMapEntries_Type.__name__ = "Unsigned32"
...
_Natv2SubscriberThresholdPortMapEntriesHigh_Type.__name__ = "Integer32"
...
_Natv2InstanceThresholdAddressMapEntriesHigh_Type.__name__ = "Integer32"
...
_Natv2InstanceThresholdPortMapEntriesHigh_Type.__name__ = "Integer32"
...
_Natv2InstanceLimitAddressMapEntries_Type.__name__ = "Unsigned32"
...
_Natv2InstanceLimitPortMapEntries_Type.__name__ = "Unsigned32"
...
_Natv2InstanceLimitPendingFragments_Type.__name__ = "Unsigned32"
...
_Natv2InstanceLimitSubscriberActives_Type.__name__ = "Unsigned32"
...
natv2MIBBasicCompliance.setObjects(
      *(("NATV2-MIB", "natv2BasicNotificationGroup"),
        ("NATV2-MIB", "natv2BasicInstanceLevelGroup"))
)
if mibBuilder.loadTexts:
...
natv2MIBPooledNATCompliance.setObjects(
      *(("NATV2-MIB", "natv2BasicNotificationGroup"),
        ("NATV2-MIB", "natv2BasicInstanceLevelGroup"),
        ("NATV2-MIB", "natv2PooledNotificationGroup"),
        ("NATV2-MIB", "natv2PooledInstanceLevelGroup"))
)
if mibBuilder.loadTexts:
...
natv2MIBCGNCompliance.setObjects(
      *(("NATV2-MIB", "natv2BasicNotificationGroup"),
        ("NATV2-MIB", "natv2BasicInstanceLevelGroup"),
        ("NATV2-MIB", "natv2PooledNotificationGroup"),
        ("NATV2-MIB", "natv2PooledInstanceLevelGroup"),
        ("NATV2-MIB", "natv2CGNNotificationGroup"),
        ("NATV2-MIB", "natv2CGNDeviceLevelGroup"),
        ("NATV2-MIB", "natv2CGNInstanceLevelGroup"))
)
if mibBuilder.loadTexts:
