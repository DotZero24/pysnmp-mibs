...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/NATV2-MIB
...
mibBuilder.exportSymbols("NATV2-MIB", natv2SubscriberDiscontinuityTime=natv2SubscriberDiscontinuityTime, Natv2SubscriberIndex=Natv2SubscriberIndex, natv2InstanceTranslations=natv2InstanceTranslations, natv2InstancePortMappingBehavior=natv2InstancePortMappingBehavior, natv2PortMapSubscriberIndex=natv2PortMapSubscriberIndex, natv2PortMapInternalMappedAddress=natv2PortMapInternalMappedAddress, natv2InstanceThresholdPortMapEntriesHigh=natv2InstanceThresholdPortMapEntriesHigh, natv2InstanceLimitPendingFragments=natv2InstanceLimitPendingFragments, natv2PortMapInternalRealm=natv2PortMapInternalRealm, natv2ProtocolPortMapFailureDrops=natv2ProtocolPortMapFailureDrops, natv2SubscriberTranslations=natv2SubscriberTranslations, natv2PoolThresholdUsageLow=natv2PoolThresholdUsageLow, natv2InstanceFragmentDrops=natv2InstanceFragmentDrops, natv2InstanceAddressMapEntries=natv2InstanceAddressMapEntries, natv2AddressMapInternalMappedAddress=natv2AddressMapInternalMappedAddress, natv2MIBCompliances=natv2MIBCompliances, natv2MIBCGNCompliance=natv2MIBCGNCompliance, natv2ProtocolInstanceIndex=natv2ProtocolInstanceIndex, natv2InstanceFragmentBehavior=natv2InstanceFragmentBehavior, natv2PoolTable=natv2PoolTable, natv2InstanceSubscriberActiveLimitDrops=natv2InstanceSubscriberActiveLimitDrops, natv2ProtocolPortMapCreations=natv2ProtocolPortMapCreations, natv2InstancePortMapFailureDrops=natv2InstancePortMapFailureDrops, natv2AddressMapInternalMappedAddressType=natv2AddressMapInternalMappedAddressType, natv2CGNDeviceLevelGroup=natv2CGNDeviceLevelGroup, natv2SubscriberIndex=natv2SubscriberIndex, natv2InstanceTable=natv2InstanceTable, natv2InstancePortMapEntryLimitDrops=natv2InstancePortMapEntryLimitDrops, natv2PortMapInstanceIndex=natv2PortMapInstanceIndex, natv2InstanceNotificationInterval=natv2InstanceNotificationInterval, PYSNMP_MODULE_ID=natv2MIB, natv2PoolRangeEntry=natv2PoolRangeEntry, natv2PortMapInternalPort=natv2PortMapInternalPort, natv2InstancePoolingBehavior=natv2InstancePoolingBehavior, natv2PoolDiscontinuityTime=natv2PoolDiscontinuityTime, natv2PoolPortMapEntries=natv2PoolPortMapEntries, natv2SubscriberPortMapEntries=natv2SubscriberPortMapEntries, natv2ProtocolTranslations=natv2ProtocolTranslations, natv2PoolMaximumPort=natv2PoolMaximumPort, natv2InstanceThresholdAddressMapEntriesHigh=natv2InstanceThresholdAddressMapEntriesHigh, natv2PoolPortMapCreations=natv2PoolPortMapCreations, ProtocolNumber=ProtocolNumber, natv2PoolNotifiedPortMapProtocol=natv2PoolNotifiedPortMapProtocol, natv2AddressMapEntry=natv2AddressMapEntry, natv2InstanceEntry=natv2InstanceEntry, natv2ProtocolEntry=natv2ProtocolEntry, natv2InstancePortMapCreations=natv2InstancePortMapCreations, natv2InstanceLimitPortMapEntries=natv2InstanceLimitPortMapEntries, natv2SubscriberAddressMapFailureDrops=natv2SubscriberAddressMapFailureDrops, natv2PortMapExternalPoolIndex=natv2PortMapExternalPoolIndex, natv2PortMapExternalAddressType=natv2PortMapExternalAddressType, natv2PoolRangeEnd=natv2PoolRangeEnd, natv2InstancePortMapEntries=natv2InstancePortMapEntries, natv2PoolEntry=natv2PoolEntry, natv2PortMapInternalAddressType=natv2PortMapInternalAddressType, natv2InstanceAlias=natv2InstanceAlias, natv2AddressMapInstanceIndex=natv2AddressMapInstanceIndex, natv2PortMapExternalAddress=natv2PortMapExternalAddress, Natv2SubscriberIndexOrZero=Natv2SubscriberIndexOrZero, natv2InstanceFilteringBehavior=natv2InstanceFilteringBehavior, natv2PoolAddressMapCreations=natv2PoolAddressMapCreations, natv2PoolRealm=natv2PoolRealm, natv2SubscriberEntry=natv2SubscriberEntry, natv2AddressMapExternalAddressType=natv2AddressMapExternalAddressType, natv2PooledNotificationGroup=natv2PooledNotificationGroup, natv2SubscriberInternalPrefix=natv2SubscriberInternalPrefix, natv2SubscriberThresholdPortMapEntriesHigh=natv2SubscriberThresholdPortMapEntriesHigh, natv2NotificationInstanceAddressMapEntriesHigh=natv2NotificationInstanceAddressMapEntriesHigh, Natv2PoolIndex=Natv2PoolIndex, natv2InstanceIndex=natv2InstanceIndex, natv2SubscriberAddressMapCreations=natv2SubscriberAddressMapCreations, natv2AddressMapSubscriberIndex=natv2AddressMapSubscriberIndex, natv2PooledInstanceLevelGroup=natv2PooledInstanceLevelGroup, natv2PoolNotificationInterval=natv2PoolNotificationInterval, natv2MIBConformance=natv2MIBConformance, natv2PoolMinimumPort=natv2PoolMinimumPort, natv2ProtocolTable=natv2ProtocolTable, natv2PortMapTable=natv2PortMapTable, natv2PoolPortMapFailureDrops=natv2PoolPortMapFailureDrops, natv2InstanceOtherResourceFailureDrops=natv2InstanceOtherResourceFailureDrops, natv2SubscriberLimitPortMapEntries=natv2SubscriberLimitPortMapEntries, natv2MIBInstanceObjects=natv2MIBInstanceObjects, natv2ProtocolNumber=natv2ProtocolNumber, natv2NotificationInstancePortMapEntriesHigh=natv2NotificationInstancePortMapEntriesHigh, natv2BasicInstanceLevelGroup=natv2BasicInstanceLevelGroup, natv2MIBDeviceObjects=natv2MIBDeviceObjects, natv2PoolThresholdUsageHigh=natv2PoolThresholdUsageHigh, natv2AddressMapExternalRealm=natv2AddressMapExternalRealm, natv2PoolRangeTable=natv2PoolRangeTable, natv2AddressMapInternalRealm=natv2AddressMapInternalRealm, natv2InstanceAddressMapEntryLimitDrops=natv2InstanceAddressMapEntryLimitDrops, natv2MIB=natv2MIB, natv2SubscriberAddressMapEntries=natv2SubscriberAddressMapEntries, natv2AddressMapExternalPoolIndex=natv2AddressMapExternalPoolIndex, natv2NotificationPoolUsageLow=natv2NotificationPoolUsageLow, natv2PoolRangeBegin=natv2PoolRangeBegin, natv2BasicNotificationGroup=natv2BasicNotificationGroup, natv2PoolRangeRowIndex=natv2PoolRangeRowIndex, natv2CGNInstanceLevelGroup=natv2CGNInstanceLevelGroup, natv2InstanceLimitSubscriberActives=natv2InstanceLimitSubscriberActives, natv2PortMapInternalAddress=natv2PortMapInternalAddress, natv2CGNNotificationGroup=natv2CGNNotificationGroup, natv2SubscriberTable=natv2SubscriberTable, natv2InstanceDiscontinuityTime=natv2InstanceDiscontinuityTime, natv2InstanceLimitAddressMapEntries=natv2InstanceLimitAddressMapEntries, natv2PortMapProtocol=natv2PortMapProtocol, natv2PoolRangePoolIndex=natv2PoolRangePoolIndex, natv2PoolRangeInstanceIndex=natv2PoolRangeInstanceIndex, natv2AddressMapInternalAddressType=natv2AddressMapInternalAddressType, natv2SubscriberPortMapFailureDrops=natv2SubscriberPortMapFailureDrops, natv2PoolAddressType=natv2PoolAddressType, natv2SubscriberNotificationInterval=natv2SubscriberNotificationInterval, natv2InstanceAddressMapCreations=natv2InstanceAddressMapCreations, natv2InstanceAddressMapFailureDrops=natv2InstanceAddressMapFailureDrops, natv2PoolAddressMapEntries=natv2PoolAddressMapEntries, natv2AddressMapTable=natv2AddressMapTable, natv2NotificationPoolUsageHigh=natv2NotificationPoolUsageHigh, natv2NotificationSubscriberPortMappingEntriesHigh=natv2NotificationSubscriberPortMappingEntriesHigh, natv2PoolIndex=natv2PoolIndex, Natv2InstanceIndex=Natv2InstanceIndex, natv2SubscriberInternalPrefixType=natv2SubscriberInternalPrefixType, natv2PoolAddressMapFailureDrops=natv2PoolAddressMapFailureDrops, natv2MIBGroups=natv2MIBGroups, natv2SubscriberPortMapCreations=natv2SubscriberPortMapCreations, natv2MIBPooledNATCompliance=natv2MIBPooledNATCompliance, natv2ProtocolPortMapEntries=natv2ProtocolPortMapEntries, natv2PortMapExternalPort=natv2PortMapExternalPort, natv2PortMapInternalMappedAddressType=natv2PortMapInternalMappedAddressType, natv2AddressMapRowIndex=natv2AddressMapRowIndex, natv2PoolNotifiedPortMapEntries=natv2PoolNotifiedPortMapEntries, natv2MIBBasicCompliance=natv2MIBBasicCompliance, natv2PortMapExternalRealm=natv2PortMapExternalRealm, Natv2PoolIndexOrZero=Natv2PoolIndexOrZero, natv2SubscriberInternalPrefixLength=natv2SubscriberInternalPrefixLength, natv2SubscriberInternalRealm=natv2SubscriberInternalRealm, natv2AddressMapInternalAddress=natv2AddressMapInternalAddress, natv2AddressMapExternalAddress=natv2AddressMapExternalAddress, natv2MIBNotifications=natv2MIBNotifications, natv2PoolInstanceIndex=natv2PoolInstanceIndex, natv2PortMapEntry=natv2PortMapEntry)
