...
mibBuilder.exportSymbols("NATV2-MIB", natv2SubscriberAddressMapCreations=natv2SubscriberAddressMapCreations, natv2PortMapSubscriberIndex=natv2PortMapSubscriberIndex, natv2InstanceAddressMapEntries=natv2InstanceAddressMapEntries, natv2PoolAddressType=natv2PoolAddressType, Natv2SubscriberIndex=Natv2SubscriberIndex, natv2SubscriberTable=natv2SubscriberTable, natv2SubscriberInternalRealm=natv2SubscriberInternalRealm, natv2PortMapInstanceIndex=natv2PortMapInstanceIndex, natv2PortMapInternalAddressType=natv2PortMapInternalAddressType, natv2SubscriberAddressMapFailureDrops=natv2SubscriberAddressMapFailureDrops, natv2NotificationPoolUsageLow=natv2NotificationPoolUsageLow, natv2InstancePoolingBehavior=natv2InstancePoolingBehavior, ProtocolNumber=ProtocolNumber, PYSNMP_MODULE_ID=natv2MIB, natv2ProtocolInstanceIndex=natv2ProtocolInstanceIndex, natv2PoolRangeRowIndex=natv2PoolRangeRowIndex, natv2MIBPooledNATCompliance=natv2MIBPooledNATCompliance, natv2SubscriberPortMapFailureDrops=natv2SubscriberPortMapFailureDrops, Natv2PoolIndexOrZero=Natv2PoolIndexOrZero, natv2PoolAddressMapCreations=natv2PoolAddressMapCreations, natv2PortMapExternalRealm=natv2PortMapExternalRealm, natv2CGNDeviceLevelGroup=natv2CGNDeviceLevelGroup, natv2InstanceAlias=natv2InstanceAlias, natv2NotificationSubscriberPortMappingEntriesHigh=natv2NotificationSubscriberPortMappingEntriesHigh, natv2SubscriberDiscontinuityTime=natv2SubscriberDiscontinuityTime, natv2InstancePortMapCreations=natv2InstancePortMapCreations, natv2PortMapProtocol=natv2PortMapProtocol, natv2MIBInstanceObjects=natv2MIBInstanceObjects, natv2AddressMapInternalAddressType=natv2AddressMapInternalAddressType, natv2PoolRangeTable=natv2PoolRangeTable, natv2InstanceSubscriberActiveLimitDrops=natv2InstanceSubscriberActiveLimitDrops, natv2PoolRangeEntry=natv2PoolRangeEntry, natv2PortMapExternalAddress=natv2PortMapExternalAddress, natv2AddressMapExternalAddress=natv2AddressMapExternalAddress, natv2ProtocolEntry=natv2ProtocolEntry, natv2PortMapExternalPoolIndex=natv2PortMapExternalPoolIndex, natv2AddressMapInternalRealm=natv2AddressMapInternalRealm, natv2PoolThresholdUsageLow=natv2PoolThresholdUsageLow, natv2MIBDeviceObjects=natv2MIBDeviceObjects, natv2SubscriberLimitPortMapEntries=natv2SubscriberLimitPortMapEntries, natv2ProtocolPortMapFailureDrops=natv2ProtocolPortMapFailureDrops, natv2PoolPortMapEntries=natv2PoolPortMapEntries, natv2PoolNotifiedPortMapProtocol=natv2PoolNotifiedPortMapProtocol, natv2PortMapInternalAddress=natv2PortMapInternalAddress, natv2PoolPortMapFailureDrops=natv2PoolPortMapFailureDrops, natv2ProtocolTable=natv2ProtocolTable, natv2InstanceAddressMapCreations=natv2InstanceAddressMapCreations, natv2PoolRangePoolIndex=natv2PoolRangePoolIndex, natv2PoolRangeEnd=natv2PoolRangeEnd, natv2PortMapInternalPort=natv2PortMapInternalPort, natv2SubscriberThresholdPortMapEntriesHigh=natv2SubscriberThresholdPortMapEntriesHigh, Natv2InstanceIndex=Natv2InstanceIndex, natv2InstanceAddressMapFailureDrops=natv2InstanceAddressMapFailureDrops, natv2PooledNotificationGroup=natv2PooledNotificationGroup, natv2CGNNotificationGroup=natv2CGNNotificationGroup, natv2MIBGroups=natv2MIBGroups, natv2PoolEntry=natv2PoolEntry, natv2PoolThresholdUsageHigh=natv2PoolThresholdUsageHigh, natv2InstanceFragmentBehavior=natv2InstanceFragmentBehavior, natv2AddressMapExternalAddressType=natv2AddressMapExternalAddressType, natv2ProtocolPortMapEntries=natv2ProtocolPortMapEntries, natv2InstanceNotificationInterval=natv2InstanceNotificationInterval, natv2PortMapEntry=natv2PortMapEntry, natv2PoolMinimumPort=natv2PoolMinimumPort, natv2SubscriberInternalPrefixType=natv2SubscriberInternalPrefixType, natv2SubscriberIndex=natv2SubscriberIndex, natv2SubscriberEntry=natv2SubscriberEntry, natv2PortMapInternalRealm=natv2PortMapInternalRealm, Natv2PoolIndex=Natv2PoolIndex, natv2ProtocolPortMapCreations=natv2ProtocolPortMapCreations, natv2PoolRangeInstanceIndex=natv2PoolRangeInstanceIndex, natv2AddressMapInstanceIndex=natv2AddressMapInstanceIndex, natv2AddressMapSubscriberIndex=natv2AddressMapSubscriberIndex, natv2ProtocolTranslations=natv2ProtocolTranslations, natv2InstanceEntry=natv2InstanceEntry, natv2InstanceAddressMapEntryLimitDrops=natv2InstanceAddressMapEntryLimitDrops, natv2NotificationInstanceAddressMapEntriesHigh=natv2NotificationInstanceAddressMapEntriesHigh, natv2NotificationInstancePortMapEntriesHigh=natv2NotificationInstancePortMapEntriesHigh, natv2InstanceIndex=natv2InstanceIndex, natv2AddressMapExternalRealm=natv2AddressMapExternalRealm, natv2AddressMapRowIndex=natv2AddressMapRowIndex, natv2PortMapTable=natv2PortMapTable, natv2MIB=natv2MIB, natv2MIBCompliances=natv2MIBCompliances, natv2SubscriberInternalPrefixLength=natv2SubscriberInternalPrefixLength, natv2PortMapExternalAddressType=natv2PortMapExternalAddressType, natv2PoolMaximumPort=natv2PoolMaximumPort, natv2MIBCGNCompliance=natv2MIBCGNCompliance, natv2PoolNotifiedPortMapEntries=natv2PoolNotifiedPortMapEntries, natv2NotificationPoolUsageHigh=natv2NotificationPoolUsageHigh, natv2SubscriberPortMapEntries=natv2SubscriberPortMapEntries, natv2AddressMapInternalMappedAddressType=natv2AddressMapInternalMappedAddressType, natv2InstanceLimitPendingFragments=natv2InstanceLimitPendingFragments, natv2PortMapInternalMappedAddressType=natv2PortMapInternalMappedAddressType, natv2InstanceLimitPortMapEntries=natv2InstanceLimitPortMapEntries, natv2BasicInstanceLevelGroup=natv2BasicInstanceLevelGroup, natv2InstancePortMapEntries=natv2InstancePortMapEntries, natv2PoolNotificationInterval=natv2PoolNotificationInterval, natv2AddressMapEntry=natv2AddressMapEntry, natv2MIBBasicCompliance=natv2MIBBasicCompliance, natv2PortMapExternalPort=natv2PortMapExternalPort, natv2PooledInstanceLevelGroup=natv2PooledInstanceLevelGroup, natv2SubscriberTranslations=natv2SubscriberTranslations, Natv2SubscriberIndexOrZero=Natv2SubscriberIndexOrZero, natv2CGNInstanceLevelGroup=natv2CGNInstanceLevelGroup, natv2InstanceDiscontinuityTime=natv2InstanceDiscontinuityTime, natv2InstanceFragmentDrops=natv2InstanceFragmentDrops, natv2PoolRealm=natv2PoolRealm, natv2MIBConformance=natv2MIBConformance, natv2SubscriberAddressMapEntries=natv2SubscriberAddressMapEntries, natv2PoolDiscontinuityTime=natv2PoolDiscontinuityTime, natv2PoolAddressMapEntries=natv2PoolAddressMapEntries, natv2SubscriberInternalPrefix=natv2SubscriberInternalPrefix, natv2PoolIndex=natv2PoolIndex, natv2PoolRangeBegin=natv2PoolRangeBegin, natv2InstancePortMapFailureDrops=natv2InstancePortMapFailureDrops, natv2InstanceThresholdPortMapEntriesHigh=natv2InstanceThresholdPortMapEntriesHigh, natv2InstanceFilteringBehavior=natv2InstanceFilteringBehavior, natv2InstanceLimitAddressMapEntries=natv2InstanceLimitAddressMapEntries, natv2AddressMapTable=natv2AddressMapTable, natv2PoolAddressMapFailureDrops=natv2PoolAddressMapFailureDrops, natv2PortMapInternalMappedAddress=natv2PortMapInternalMappedAddress, natv2PoolPortMapCreations=natv2PoolPortMapCreations, natv2SubscriberNotificationInterval=natv2SubscriberNotificationInterval, natv2PoolTable=natv2PoolTable, natv2InstanceTranslations=natv2InstanceTranslations, natv2AddressMapInternalMappedAddress=natv2AddressMapInternalMappedAddress, natv2AddressMapInternalAddress=natv2AddressMapInternalAddress, natv2InstanceThresholdAddressMapEntriesHigh=natv2InstanceThresholdAddressMapEntriesHigh, natv2InstanceLimitSubscriberActives=natv2InstanceLimitSubscriberActives, natv2InstancePortMapEntryLimitDrops=natv2InstancePortMapEntryLimitDrops, natv2SubscriberPortMapCreations=natv2SubscriberPortMapCreations, natv2InstanceOtherResourceFailureDrops=natv2InstanceOtherResourceFailureDrops, natv2AddressMapExternalPoolIndex=natv2AddressMapExternalPoolIndex, natv2InstanceTable=natv2InstanceTable, natv2PoolInstanceIndex=natv2PoolInstanceIndex, natv2BasicNotificationGroup=natv2BasicNotificationGroup, natv2ProtocolNumber=natv2ProtocolNumber, natv2MIBNotifications=natv2MIBNotifications, natv2InstancePortMappingBehavior=natv2InstancePortMappingBehavior)
