...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CABLE-QOS-MONITOR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:29:22 2025
...
_CcqmCmtsEnfRuleAutoEnforce_Type.__name__ = "TruthValue"
...
_CcqmEnfRuleViolateNotifEnable_Type.__name__ = "TruthValue"
...
ccqmCompliance.setObjects(
      *(("CISCO-CABLE-QOS-MONITOR-MIB", "ccqmEnfRuleGroup"),
        ("CISCO-CABLE-QOS-MONITOR-MIB", "ccqmEnfRuleViolateGroup"),
        ("CISCO-CABLE-QOS-MONITOR-MIB", "ccqmEnfRuleViolateNotifGroup"))
)
if mibBuilder.loadTexts:
...
ccqmComplianceRev1.setObjects(
      *(("CISCO-CABLE-QOS-MONITOR-MIB", "ccqmEnfRuleGroupRev1"),
        ("CISCO-CABLE-QOS-MONITOR-MIB", "ccqmEnfRuleViolateGroup"),
        ("CISCO-CABLE-QOS-MONITOR-MIB", "ccqmCmtsRuleIfBwUtilGroup"),
        ("CISCO-CABLE-QOS-MONITOR-MIB", "ccqmEnfRuleViolateNotifGroup"))
)
if mibBuilder.loadTexts:
