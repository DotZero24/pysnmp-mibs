...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IP-ADDRESS-POOL-MIB
...
_CiapGlobalNotifyEnable_Type.__name__ = "TruthValue"
...
_CiapGlobalThresholdUnits_Type.__name__ = "IpAddressPoolThresholdUnits"
...
_CiapPoolStorage_Type.__name__ = "StorageType"
...
class _CiapPoolName_Type(IpAddressPoolNameOrNull):
    """Custom type ciapPoolName based on IpAddressPoolNameOrNull"""
    defaultValue = OctetString("")


_CiapPoolName_Type.__name__ = "IpAddressPoolNameOrNull"
...
class _CiapPoolContainedIn_Type(IpAddressPoolGroupNameOrNull):
    """Custom type ciapPoolContainedIn based on IpAddressPoolGroupNameOrNull"""
    defaultValue = OctetString("")


_CiapPoolContainedIn_Type.__name__ = "IpAddressPoolGroupNameOrNull"
...
_CiapRangeStorage_Type.__name__ = "StorageType"
...
_CiapPrefixStorage_Type.__name__ = "StorageType"
...
ciscoIpAddressPoolCompliance01.setObjects(
      *(("CISCO-IP-ADDRESS-POOL-MIB", "ciapGlobalGroup"),
        ("CISCO-IP-ADDRESS-POOL-MIB", "ciapPoolGroup"),
        ("CISCO-IP-ADDRESS-POOL-MIB", "ciapRangeGroup"),
        ("CISCO-IP-ADDRESS-POOL-MIB", "ciapPoolGroupGroup"),
        ("CISCO-IP-ADDRESS-POOL-MIB", "ciapNotifDataGroup"),
        ("CISCO-IP-ADDRESS-POOL-MIB", "ciapNotifsGroup"),
        ("CISCO-IP-ADDRESS-POOL-MIB", "ciapPrefixGroup"))
)
if mibBuilder.loadTexts:
