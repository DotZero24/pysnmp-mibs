...
IpAddressPoolGroupNameOrNull, IpAddressPoolGroupName, IpAddressPoolNameOrNull, IpAddrPoolInstanceIdentifier, IpAddressPoolThresholdUnits, IpAddrPoolInstanceIdentifierOrZero = mibBuilder.importSymbols("CISCO-IP-ADDRESS-POOL-TC-MIB", "IpAddressPoolGroupNameOrNull", "IpAddressPoolGroupName", "IpAddressPoolNameOrNull", "IpAddrPoolInstanceIdentifier", "IpAddressPoolThresholdUnits", "IpAddrPoolInstanceIdentifierOrZero")
...
mibBuilder.exportSymbols("CISCO-IP-ADDRESS-POOL-MIB", ciapPoolGroupName=ciapPoolGroupName, ciapRangeTableChanged=ciapRangeTableChanged, ciapPoolGroupIdNext=ciapPoolGroupIdNext, ciapAllocatedAddresses=ciapAllocatedAddresses, PYSNMP_MODULE_ID=ciscoIpAddressPoolMIB, ciscoIpAddressPoolMIB=ciscoIpAddressPoolMIB, ciscoIpAddressPoolCompliance01=ciscoIpAddressPoolCompliance01, ciscoIpAddressPoolMIBGroups=ciscoIpAddressPoolMIBGroups, ciapPoolGroup=ciapPoolGroup, ciapPoolThresholdFalling=ciapPoolThresholdFalling, ciapPoolIdNext=ciapPoolIdNext, ciapGlobalThresholdFalling=ciapGlobalThresholdFalling, ciapPoolId=ciapPoolId, ciapNotifsGroup=ciapNotifsGroup, ciapPrefixPriority=ciapPrefixPriority, ciapNotifyResource=ciapNotifyResource, ciapGlobalNotifyEnable=ciapGlobalNotifyEnable, ciapAllocatedAddress=ciapAllocatedAddress, ciapRangeThresholdFalling=ciapRangeThresholdFalling, ciapPrefixAssignedLength=ciapPrefixAssignedLength, ciapPrefixGroup=ciapPrefixGroup, ciapRangeAddressLower=ciapRangeAddressLower, ciapNotifDataGroup=ciapNotifDataGroup, ciapNotifyThresholdFalling=ciapNotifyThresholdFalling, ciapPoolAddressesInUse=ciapPoolAddressesInUse, ciapPoolGroupGroup=ciapPoolGroupGroup, ciapPools=ciapPools, ciapPoolGroupAddressesFree=ciapPoolGroupAddressesFree, ciapPrefixThresholdRising=ciapPrefixThresholdRising, ciapGlobal=ciapGlobal, ciapGlobalThresholdRising=ciapGlobalThresholdRising, ciapPoolTableChanged=ciapPoolTableChanged, ciapPrefixPrefixesInUse=ciapPrefixPrefixesInUse, ciapRangeRecycleDelay=ciapRangeRecycleDelay, ciapPrefixCacheSize=ciapPrefixCacheSize, ciapPoolType=ciapPoolType, ciapPrefixPrefixesFree=ciapPrefixPrefixesFree, ciapPoolGroupId=ciapPoolGroupId, ciapPoolAddressesFree=ciapPoolAddressesFree, ciapRangeAddressesFree=ciapRangeAddressesFree, ciapRangeAddressUpper=ciapRangeAddressUpper, ciapPrefixType=ciapPrefixType, ciapPoolGroups=ciapPoolGroups, ciapRangeCacheSize=ciapRangeCacheSize, ciapPrefixRecycleDelay=ciapPrefixRecycleDelay, ciapPoolGroupThresholdUnits=ciapPoolGroupThresholdUnits, ciapNotifyData=ciapNotifyData, ciapPrefixAddressMask=ciapPrefixAddressMask, ciapPrefixEntry=ciapPrefixEntry, ciscoIpAddressPoolMIBCompliances=ciscoIpAddressPoolMIBCompliances, ciapRangeThresholdUnits=ciapRangeThresholdUnits, ciapNotifyFree=ciapNotifyFree, ciapPoolGroupContainsId=ciapPoolGroupContainsId, ciapPoolGroupContainsTable=ciapPoolGroupContainsTable, ciapPrefixThresholdFalling=ciapPrefixThresholdFalling, ciapRangeEntry=ciapRangeEntry, ciapPoolGroupThresholdFalling=ciapPoolGroupThresholdFalling, ciapPrefixThresholdUnits=ciapPrefixThresholdUnits, ciapEventThresholdFalling=ciapEventThresholdFalling, ciapPrefixStorage=ciapPrefixStorage, ciapRangeAddressType=ciapRangeAddressType, ciapRangeTable=ciapRangeTable, ciapAllocatedAddressMask=ciapAllocatedAddressMask, ciapRangeGroup=ciapRangeGroup, ciapPoolThresholdRising=ciapPoolThresholdRising, ciscoIpAddressPoolMIBConform=ciscoIpAddressPoolMIBConform, ciapPoolEntry=ciapPoolEntry, ciapAllocatedAddressTable=ciapAllocatedAddressTable, ciapPoolContainedIn=ciapPoolContainedIn, ciapRangeStatus=ciapRangeStatus, ciapPrefixStatus=ciapPrefixStatus, ciapAllocatedAddressEntry=ciapAllocatedAddressEntry, ciapGlobalThresholdUnits=ciapGlobalThresholdUnits, ciapGlobalGroup=ciapGlobalGroup, ciapRangeStorage=ciapRangeStorage, ciapPoolGroupEntry=ciapPoolGroupEntry, ciapEventThresholdRising=ciapEventThresholdRising, ciapPoolGroupContainsEntry=ciapPoolGroupContainsEntry, ciapNotifyThresholdUnits=ciapNotifyThresholdUnits, ciapPoolTable=ciapPoolTable, ciapRangeAddressesInUse=ciapRangeAddressesInUse, ciapPoolStatus=ciapPoolStatus, ciapRangeThresholdRising=ciapRangeThresholdRising, ciapPoolName=ciapPoolName, ciapNotifyThresholdRising=ciapNotifyThresholdRising, ciapPoolGroupThresholdRising=ciapPoolGroupThresholdRising, ciapPrefixTable=ciapPrefixTable, ciapPoolGroupTable=ciapPoolGroupTable, ciapNotifyInUse=ciapNotifyInUse, ciapPrefixAddress=ciapPrefixAddress, ciscoIpAddressPoolMIBObjects=ciscoIpAddressPoolMIBObjects, ciapPoolGroupAddressesInUse=ciapPoolGroupAddressesInUse, ciapRangePriority=ciapRangePriority, ciapPoolThresholdUnits=ciapPoolThresholdUnits, ciapAllocatedAddressType=ciapAllocatedAddressType, ciapPrefixTableChanged=ciapPrefixTableChanged, ciapPoolStorage=ciapPoolStorage, ciscoIpAddressPoolMIBNotifs=ciscoIpAddressPoolMIBNotifs)
