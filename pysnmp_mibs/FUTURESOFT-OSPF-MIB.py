...
AreaID,BigMetric,InterfaceIndex,PositiveInteger,RouterID,Status,TOSType,ospfIfEntry,ospfNbrRtrId,ospfRouterId,ospfVirtIfEntry,ospfVirtNbrEntry=mibBuilder.importSymbols(_K,'AreaID',_Z,_L,_a,'RouterID',_U,'TOSType','ospfIfEntry',_b,_N,'ospfVirtIfEntry','ospfVirtNbrEntry')
...
DateAndTime,DisplayString,PhysAddress,RowStatus,TextualConvention,TruthValue=mibBuilder.importSymbols('SNMPv2-TC','DateAndTime',_V,'PhysAddress','RowStatus','TextualConvention',_O)
futospf=ModuleIdentity((1,3,6,1,4,1,2076,10))
if mibBuilder.loadTexts:futospf.setRevisions(('2012-09-05 00:00',))
_FutospfGeneralGroup_ObjectIdentity=ObjectIdentity
futospfGeneralGroup=_FutospfGeneralGroup_ObjectIdentity((1,3,6,1,4,1,2076,10,1))
class _FutOspfOverFlowState_Type(TruthValue):defaultValue=2
_FutOspfOverFlowState_Type.__name__=_O
_FutOspfOverFlowState_Object=MibScalar
futOspfOverFlowState=_FutOspfOverFlowState_Object((1,3,6,1,4,1,2076,10,1,1),_FutOspfOverFlowState_Type())
...
futOspfPktsRcvd=_FutOspfPktsRcvd_Object((1,3,6,1,4,1,2076,10,1,2),_FutOspfPktsRcvd_Type())
...
futOspfPktsTxed=_FutOspfPktsTxed_Object((1,3,6,1,4,1,2076,10,1,3),_FutOspfPktsTxed_Type())
...
futOspfPktsDisd=_FutOspfPktsDisd_Object((1,3,6,1,4,1,2076,10,1,4),_FutOspfPktsDisd_Type())
...
futOspfRFC1583Compatibility=_FutOspfRFC1583Compatibility_Object((1,3,6,1,4,1,2076,10,1,5),_FutOspfRFC1583Compatibility_Type())
...
futOspfMaxAreas=_FutOspfMaxAreas_Object((1,3,6,1,4,1,2076,10,1,6),_FutOspfMaxAreas_Type())
futOspfMaxAreas.setMaxAccess(_C)
if mibBuilder.loadTexts:futOspfMaxAreas.setStatus(_M)
...
futOspfMaxLSAperArea=_FutOspfMaxLSAperArea_Object((1,3,6,1,4,1,2076,10,1,7),_FutOspfMaxLSAperArea_Type())
futOspfMaxLSAperArea.setMaxAccess(_C)
if mibBuilder.loadTexts:futOspfMaxLSAperArea.setStatus(_M)
...
futOspfMaxExtLSAs=_FutOspfMaxExtLSAs_Object((1,3,6,1,4,1,2076,10,1,8),_FutOspfMaxExtLSAs_Type())
futOspfMaxExtLSAs.setMaxAccess(_C)
if mibBuilder.loadTexts:futOspfMaxExtLSAs.setStatus(_M)
...
futOspfMaxSelfOrgLSAs=_FutOspfMaxSelfOrgLSAs_Object((1,3,6,1,4,1,2076,10,1,9),_FutOspfMaxSelfOrgLSAs_Type())
futOspfMaxSelfOrgLSAs.setMaxAccess(_C)
if mibBuilder.loadTexts:futOspfMaxSelfOrgLSAs.setStatus(_M)
...
futOspfMaxRoutes=_FutOspfMaxRoutes_Object((1,3,6,1,4,1,2076,10,1,10),_FutOspfMaxRoutes_Type())
futOspfMaxRoutes.setMaxAccess(_C)
if mibBuilder.loadTexts:futOspfMaxRoutes.setStatus(_M)
...
futOspfMaxLsaSize=_FutOspfMaxLsaSize_Object((1,3,6,1,4,1,2076,10,1,11),_FutOspfMaxLsaSize_Type())
futOspfMaxLsaSize.setMaxAccess(_C)
if mibBuilder.loadTexts:futOspfMaxLsaSize.setStatus(_M)
...
futOspfTraceLevel=_FutOspfTraceLevel_Object((1,3,6,1,4,1,2076,10,1,12),_FutOspfTraceLevel_Type())
...
futOspfMinLsaInterval=_FutOspfMinLsaInterval_Object((1,3,6,1,4,1,2076,10,1,13),_FutOspfMinLsaInterval_Type())
...
futOspfABRType=_FutOspfABRType_Object((1,3,6,1,4,1,2076,10,1,14),_FutOspfABRType_Type())
...
futOspfNssaAsbrDefRtTrans=_FutOspfNssaAsbrDefRtTrans_Object((1,3,6,1,4,1,2076,10,1,15),_FutOspfNssaAsbrDefRtTrans_Type())
...
_FutOspfDefaultPassiveInterface_Type.__name__=_O
_FutOspfDefaultPassiveInterface_Object=MibScalar
futOspfDefaultPassiveInterface=_FutOspfDefaultPassiveInterface_Object((1,3,6,1,4,1,2076,10,1,16),_FutOspfDefaultPassiveInterface_Type())
...
futOspfSpfHoldtime=_FutOspfSpfHoldtime_Object((1,3,6,1,4,1,2076,10,1,17),_FutOspfSpfHoldtime_Type())
...
futOspfSpfDelay=_FutOspfSpfDelay_Object((1,3,6,1,4,1,2076,10,1,18),_FutOspfSpfDelay_Type())
...
futOspfRestartSupport=_FutOspfRestartSupport_Object((1,3,6,1,4,1,2076,10,1,19),_FutOspfRestartSupport_Type())
...
futOspfRestartInterval=_FutOspfRestartInterval_Object((1,3,6,1,4,1,2076,10,1,20),_FutOspfRestartInterval_Type())
...
_FutOspfRestartStrictLsaChecking_Type.__name__=_O
_FutOspfRestartStrictLsaChecking_Object=MibScalar
futOspfRestartStrictLsaChecking=_FutOspfRestartStrictLsaChecking_Object((1,3,6,1,4,1,2076,10,1,21),_FutOspfRestartStrictLsaChecking_Type())
...
futOspfRestartStatus=_FutOspfRestartStatus_Object((1,3,6,1,4,1,2076,10,1,22),_FutOspfRestartStatus_Type())
...
futOspfRestartAge=_FutOspfRestartAge_Object((1,3,6,1,4,1,2076,10,1,23),_FutOspfRestartAge_Type())
...
futOspfRestartExitReason=_FutOspfRestartExitReason_Object((1,3,6,1,4,1,2076,10,1,24),_FutOspfRestartExitReason_Type())
...
futOspfHelperSupport=_FutOspfHelperSupport_Object((1,3,6,1,4,1,2076,10,1,25),_FutOspfHelperSupport_Type())
...
futOspfHelperGraceTimeLimit=_FutOspfHelperGraceTimeLimit_Object((1,3,6,1,4,1,2076,10,1,26),_FutOspfHelperGraceTimeLimit_Type())
...
futOspfRestartAckState=_FutOspfRestartAckState_Object((1,3,6,1,4,1,2076,10,1,27),_FutOspfRestartAckState_Type())
...
futOspfGraceLsaRetransmitCount=_FutOspfGraceLsaRetransmitCount_Object((1,3,6,1,4,1,2076,10,1,28),_FutOspfGraceLsaRetransmitCount_Type())
...
futOspfRestartReason=_FutOspfRestartReason_Object((1,3,6,1,4,1,2076,10,1,29),_FutOspfRestartReason_Type())
...
futOspfRTStaggeringInterval=_FutOspfRTStaggeringInterval_Object((1,3,6,1,4,1,2076,10,1,30),_FutOspfRTStaggeringInterval_Type())
...
futOspfRTStaggeringStatus=_FutOspfRTStaggeringStatus_Object((1,3,6,1,4,1,2076,10,1,31),_FutOspfRTStaggeringStatus_Type())
...
futOspfHotStandbyAdminStatus=_FutOspfHotStandbyAdminStatus_Object((1,3,6,1,4,1,2076,10,1,32),_FutOspfHotStandbyAdminStatus_Type())
...
futOspfHotStandbyState=_FutOspfHotStandbyState_Object((1,3,6,1,4,1,2076,10,1,33),_FutOspfHotStandbyState_Type())
...
futOspfDynamicBulkUpdStatus=_FutOspfDynamicBulkUpdStatus_Object((1,3,6,1,4,1,2076,10,1,34),_FutOspfDynamicBulkUpdStatus_Type())
...
futOspfStanbyHelloSyncCount=_FutOspfStanbyHelloSyncCount_Object((1,3,6,1,4,1,2076,10,1,35),_FutOspfStanbyHelloSyncCount_Type())
...
futOspfStanbyLsaSyncCount=_FutOspfStanbyLsaSyncCount_Object((1,3,6,1,4,1,2076,10,1,36),_FutOspfStanbyLsaSyncCount_Type())
...
futOspfExtTraceLevel=_FutOspfExtTraceLevel_Object((1,3,6,1,4,1,2076,10,1,37),_FutOspfExtTraceLevel_Type())
...
futospfRouterIdPermanence=_FutospfRouterIdPermanence_Object((1,3,6,1,4,1,2076,10,1,38),_FutospfRouterIdPermanence_Type())
...
futOspfBfdStatus=_FutOspfBfdStatus_Object((1,3,6,1,4,1,2076,10,1,39),_FutOspfBfdStatus_Type())
...
futOspfBfdAllIfState=_FutOspfBfdAllIfState_Object((1,3,6,1,4,1,2076,10,1,40),_FutOspfBfdAllIfState_Type())
...
futOspfAreaTable=_FutOspfAreaTable_Object((1,3,6,1,4,1,2076,10,2))
if mibBuilder.loadTexts:futOspfAreaTable.setStatus(_A)
_FutOspfAreaEntry_Object=MibTableRow
futOspfAreaEntry=_FutOspfAreaEntry_Object((1,3,6,1,4,1,2076,10,2,1))
...
futOspfAreaId=_FutOspfAreaId_Object((1,3,6,1,4,1,2076,10,2,1,1),_FutOspfAreaId_Type())
...
futOspfAreaIfCount=_FutOspfAreaIfCount_Object((1,3,6,1,4,1,2076,10,2,1,2),_FutOspfAreaIfCount_Type())
...
futOspfAreaNetCount=_FutOspfAreaNetCount_Object((1,3,6,1,4,1,2076,10,2,1,3),_FutOspfAreaNetCount_Type())
...
futOspfAreaRtrCount=_FutOspfAreaRtrCount_Object((1,3,6,1,4,1,2076,10,2,1,4),_FutOspfAreaRtrCount_Type())
...
futOspfAreaNSSATranslatorRole=_FutOspfAreaNSSATranslatorRole_Object((1,3,6,1,4,1,2076,10,2,1,5),_FutOspfAreaNSSATranslatorRole_Type())
...
futOspfAreaNSSATranslatorState=_FutOspfAreaNSSATranslatorState_Object((1,3,6,1,4,1,2076,10,2,1,6),_FutOspfAreaNSSATranslatorState_Type())
...
futOspfAreaNSSATranslatorStabilityInterval=_FutOspfAreaNSSATranslatorStabilityInterval_Object((1,3,6,1,4,1,2076,10,2,1,7),_FutOspfAreaNSSATranslatorStabilityInterval_Type())
...
futOspfAreaNSSATranslatorEvents=_FutOspfAreaNSSATranslatorEvents_Object((1,3,6,1,4,1,2076,10,2,1,8),_FutOspfAreaNSSATranslatorEvents_Type())
...
futOspfAreaDfInfOriginate=_FutOspfAreaDfInfOriginate_Object((1,3,6,1,4,1,2076,10,2,1,9),_FutOspfAreaDfInfOriginate_Type())
...
futOspfHostTable=_FutOspfHostTable_Object((1,3,6,1,4,1,2076,10,3))
if mibBuilder.loadTexts:futOspfHostTable.setStatus(_A)
_FutOspfHostEntry_Object=MibTableRow
futOspfHostEntry=_FutOspfHostEntry_Object((1,3,6,1,4,1,2076,10,3,1))
...
futOspfHostIpAddress=_FutOspfHostIpAddress_Object((1,3,6,1,4,1,2076,10,3,1,1),_FutOspfHostIpAddress_Type())
...
futOspfHostTOS=_FutOspfHostTOS_Object((1,3,6,1,4,1,2076,10,3,1,2),_FutOspfHostTOS_Type())
...
futOspfHostRouteIfIndex=_FutOspfHostRouteIfIndex_Object((1,3,6,1,4,1,2076,10,3,1,3),_FutOspfHostRouteIfIndex_Type())
...
futOspfIfTable=_FutOspfIfTable_Object((1,3,6,1,4,1,2076,10,4))
if mibBuilder.loadTexts:futOspfIfTable.setStatus(_A)
_FutOspfIfEntry_Object=MibTableRow
futOspfIfEntry=_FutOspfIfEntry_Object((1,3,6,1,4,1,2076,10,4,1))
...
futOspfIfIpAddress=_FutOspfIfIpAddress_Object((1,3,6,1,4,1,2076,10,4,1,1),_FutOspfIfIpAddress_Type())
...
_FutOspfAddressLessIf_Type.__name__=_L
_FutOspfAddressLessIf_Object=MibTableColumn
futOspfAddressLessIf=_FutOspfAddressLessIf_Object((1,3,6,1,4,1,2076,10,4,1,2),_FutOspfAddressLessIf_Type())
...
futOspfIfOperState=_FutOspfIfOperState_Object((1,3,6,1,4,1,2076,10,4,1,3),_FutOspfIfOperState_Type())
...
futOspfIfPassive=_FutOspfIfPassive_Object((1,3,6,1,4,1,2076,10,4,1,4),_FutOspfIfPassive_Type())
...
futOspfIfNbrCount=_FutOspfIfNbrCount_Object((1,3,6,1,4,1,2076,10,4,1,5),_FutOspfIfNbrCount_Type())
...
futOspfIfAdjCount=_FutOspfIfAdjCount_Object((1,3,6,1,4,1,2076,10,4,1,6),_FutOspfIfAdjCount_Type())
...
futOspfIfHelloRcvd=_FutOspfIfHelloRcvd_Object((1,3,6,1,4,1,2076,10,4,1,7),_FutOspfIfHelloRcvd_Type())
...
futOspfIfHelloTxed=_FutOspfIfHelloTxed_Object((1,3,6,1,4,1,2076,10,4,1,8),_FutOspfIfHelloTxed_Type())
...
futOspfIfHelloDisd=_FutOspfIfHelloDisd_Object((1,3,6,1,4,1,2076,10,4,1,9),_FutOspfIfHelloDisd_Type())
...
futOspfIfDdpRcvd=_FutOspfIfDdpRcvd_Object((1,3,6,1,4,1,2076,10,4,1,10),_FutOspfIfDdpRcvd_Type())
...
futOspfIfDdpTxed=_FutOspfIfDdpTxed_Object((1,3,6,1,4,1,2076,10,4,1,11),_FutOspfIfDdpTxed_Type())
...
futOspfIfDdpDisd=_FutOspfIfDdpDisd_Object((1,3,6,1,4,1,2076,10,4,1,12),_FutOspfIfDdpDisd_Type())
...
futOspfIfLrqRcvd=_FutOspfIfLrqRcvd_Object((1,3,6,1,4,1,2076,10,4,1,13),_FutOspfIfLrqRcvd_Type())
...
futOspfIfLrqTxed=_FutOspfIfLrqTxed_Object((1,3,6,1,4,1,2076,10,4,1,14),_FutOspfIfLrqTxed_Type())
...
futOspfIfLrqDisd=_FutOspfIfLrqDisd_Object((1,3,6,1,4,1,2076,10,4,1,15),_FutOspfIfLrqDisd_Type())
...
futOspfIfLsuRcvd=_FutOspfIfLsuRcvd_Object((1,3,6,1,4,1,2076,10,4,1,16),_FutOspfIfLsuRcvd_Type())
...
futOspfIfLsuTxed=_FutOspfIfLsuTxed_Object((1,3,6,1,4,1,2076,10,4,1,17),_FutOspfIfLsuTxed_Type())
...
futOspfIfLsuDisd=_FutOspfIfLsuDisd_Object((1,3,6,1,4,1,2076,10,4,1,18),_FutOspfIfLsuDisd_Type())
...
futOspfIfLakRcvd=_FutOspfIfLakRcvd_Object((1,3,6,1,4,1,2076,10,4,1,19),_FutOspfIfLakRcvd_Type())
...
futOspfIfLakTxed=_FutOspfIfLakTxed_Object((1,3,6,1,4,1,2076,10,4,1,20),_FutOspfIfLakTxed_Type())
...
futOspfIfLakDisd=_FutOspfIfLakDisd_Object((1,3,6,1,4,1,2076,10,4,1,21),_FutOspfIfLakDisd_Type())
...
futOspfIfBfdState=_FutOspfIfBfdState_Object((1,3,6,1,4,1,2076,10,4,1,22),_FutOspfIfBfdState_Type())
...
futOspfIfMD5AuthTable=_FutOspfIfMD5AuthTable_Object((1,3,6,1,4,1,2076,10,5))
if mibBuilder.loadTexts:futOspfIfMD5AuthTable.setStatus(_A)
_FutOspfIfMD5AuthEntry_Object=MibTableRow
futOspfIfMD5AuthEntry=_FutOspfIfMD5AuthEntry_Object((1,3,6,1,4,1,2076,10,5,1))
...
futOspfIfMD5AuthIpAddress=_FutOspfIfMD5AuthIpAddress_Object((1,3,6,1,4,1,2076,10,5,1,1),_FutOspfIfMD5AuthIpAddress_Type())
...
_FutOspfIfMD5AuthAddressLessIf_Type.__name__=_L
_FutOspfIfMD5AuthAddressLessIf_Object=MibTableColumn
futOspfIfMD5AuthAddressLessIf=_FutOspfIfMD5AuthAddressLessIf_Object((1,3,6,1,4,1,2076,10,5,1,2),_FutOspfIfMD5AuthAddressLessIf_Type())
...
futOspfIfMD5AuthKeyId=_FutOspfIfMD5AuthKeyId_Object((1,3,6,1,4,1,2076,10,5,1,3),_FutOspfIfMD5AuthKeyId_Type())
...
futOspfIfMD5AuthKey=_FutOspfIfMD5AuthKey_Object((1,3,6,1,4,1,2076,10,5,1,4),_FutOspfIfMD5AuthKey_Type())
...
futOspfIfMD5AuthKeyStartAccept=_FutOspfIfMD5AuthKeyStartAccept_Object((1,3,6,1,4,1,2076,10,5,1,5),_FutOspfIfMD5AuthKeyStartAccept_Type())
...
futOspfIfMD5AuthKeyStartGenerate=_FutOspfIfMD5AuthKeyStartGenerate_Object((1,3,6,1,4,1,2076,10,5,1,6),_FutOspfIfMD5AuthKeyStartGenerate_Type())
...
futOspfIfMD5AuthKeyStopGenerate=_FutOspfIfMD5AuthKeyStopGenerate_Object((1,3,6,1,4,1,2076,10,5,1,7),_FutOspfIfMD5AuthKeyStopGenerate_Type())
...
futOspfIfMD5AuthKeyStopAccept=_FutOspfIfMD5AuthKeyStopAccept_Object((1,3,6,1,4,1,2076,10,5,1,8),_FutOspfIfMD5AuthKeyStopAccept_Type())
...
futOspfIfMD5AuthKeyStatus=_FutOspfIfMD5AuthKeyStatus_Object((1,3,6,1,4,1,2076,10,5,1,9),_FutOspfIfMD5AuthKeyStatus_Type())
...
futOspfVirtIfMD5AuthTable=_FutOspfVirtIfMD5AuthTable_Object((1,3,6,1,4,1,2076,10,6))
if mibBuilder.loadTexts:futOspfVirtIfMD5AuthTable.setStatus(_A)
_FutOspfVirtIfMD5AuthEntry_Object=MibTableRow
futOspfVirtIfMD5AuthEntry=_FutOspfVirtIfMD5AuthEntry_Object((1,3,6,1,4,1,2076,10,6,1))
...
futOspfVirtIfMD5AuthAreaId=_FutOspfVirtIfMD5AuthAreaId_Object((1,3,6,1,4,1,2076,10,6,1,1),_FutOspfVirtIfMD5AuthAreaId_Type())
...
futOspfVirtIfMD5AuthNeighbor=_FutOspfVirtIfMD5AuthNeighbor_Object((1,3,6,1,4,1,2076,10,6,1,2),_FutOspfVirtIfMD5AuthNeighbor_Type())
...
futOspfVirtIfMD5AuthKeyId=_FutOspfVirtIfMD5AuthKeyId_Object((1,3,6,1,4,1,2076,10,6,1,3),_FutOspfVirtIfMD5AuthKeyId_Type())
...
futOspfVirtIfMD5AuthKey=_FutOspfVirtIfMD5AuthKey_Object((1,3,6,1,4,1,2076,10,6,1,4),_FutOspfVirtIfMD5AuthKey_Type())
...
futOspfVirtIfMD5AuthKeyStartAccept=_FutOspfVirtIfMD5AuthKeyStartAccept_Object((1,3,6,1,4,1,2076,10,6,1,5),_FutOspfVirtIfMD5AuthKeyStartAccept_Type())
...
futOspfVirtIfMD5AuthKeyStartGenerate=_FutOspfVirtIfMD5AuthKeyStartGenerate_Object((1,3,6,1,4,1,2076,10,6,1,6),_FutOspfVirtIfMD5AuthKeyStartGenerate_Type())
...
futOspfVirtIfMD5AuthKeyStopGenerate=_FutOspfVirtIfMD5AuthKeyStopGenerate_Object((1,3,6,1,4,1,2076,10,6,1,7),_FutOspfVirtIfMD5AuthKeyStopGenerate_Type())
...
futOspfVirtIfMD5AuthKeyStopAccept=_FutOspfVirtIfMD5AuthKeyStopAccept_Object((1,3,6,1,4,1,2076,10,6,1,8),_FutOspfVirtIfMD5AuthKeyStopAccept_Type())
...
futOspfVirtIfMD5AuthKeyStatus=_FutOspfVirtIfMD5AuthKeyStatus_Object((1,3,6,1,4,1,2076,10,6,1,9),_FutOspfVirtIfMD5AuthKeyStatus_Type())
...
futOspfNbrTable=_FutOspfNbrTable_Object((1,3,6,1,4,1,2076,10,7))
if mibBuilder.loadTexts:futOspfNbrTable.setStatus(_A)
_FutOspfNbrEntry_Object=MibTableRow
futOspfNbrEntry=_FutOspfNbrEntry_Object((1,3,6,1,4,1,2076,10,7,1))
...
futOspfNbrIpAddr=_FutOspfNbrIpAddr_Object((1,3,6,1,4,1,2076,10,7,1,1),_FutOspfNbrIpAddr_Type())
...
_FutOspfNbrAddressLessIndex_Type.__name__=_L
_FutOspfNbrAddressLessIndex_Object=MibTableColumn
futOspfNbrAddressLessIndex=_FutOspfNbrAddressLessIndex_Object((1,3,6,1,4,1,2076,10,7,1,2),_FutOspfNbrAddressLessIndex_Type())
...
futOspfNbrDBSummaryQLen=_FutOspfNbrDBSummaryQLen_Object((1,3,6,1,4,1,2076,10,7,1,3),_FutOspfNbrDBSummaryQLen_Type())
...
futOspfNbrLSReqQLen=_FutOspfNbrLSReqQLen_Object((1,3,6,1,4,1,2076,10,7,1,4),_FutOspfNbrLSReqQLen_Type())
...
futOspfNbrRestartHelperStatus=_FutOspfNbrRestartHelperStatus_Object((1,3,6,1,4,1,2076,10,7,1,5),_FutOspfNbrRestartHelperStatus_Type())
...
futOspfNbrRestartHelperAge=_FutOspfNbrRestartHelperAge_Object((1,3,6,1,4,1,2076,10,7,1,6),_FutOspfNbrRestartHelperAge_Type())
...
futOspfNbrRestartHelperExitReason=_FutOspfNbrRestartHelperExitReason_Object((1,3,6,1,4,1,2076,10,7,1,7),_FutOspfNbrRestartHelperExitReason_Type())
...
futOspfNbrBfdState=_FutOspfNbrBfdState_Object((1,3,6,1,4,1,2076,10,7,1,8),_FutOspfNbrBfdState_Type())
...
futOspfRoutingTable=_FutOspfRoutingTable_Object((1,3,6,1,4,1,2076,10,8))
if mibBuilder.loadTexts:futOspfRoutingTable.setStatus(_A)
_FutOspfRoutingEntry_Object=MibTableRow
futOspfRoutingEntry=_FutOspfRoutingEntry_Object((1,3,6,1,4,1,2076,10,8,1))
...
futOspfRouteIpAddr=_FutOspfRouteIpAddr_Object((1,3,6,1,4,1,2076,10,8,1,1),_FutOspfRouteIpAddr_Type())
...
futOspfRouteIpAddrMask=_FutOspfRouteIpAddrMask_Object((1,3,6,1,4,1,2076,10,8,1,2),_FutOspfRouteIpAddrMask_Type())
...
futOspfRouteIpTos=_FutOspfRouteIpTos_Object((1,3,6,1,4,1,2076,10,8,1,3),_FutOspfRouteIpTos_Type())
...
futOspfRouteIpNextHop=_FutOspfRouteIpNextHop_Object((1,3,6,1,4,1,2076,10,8,1,4),_FutOspfRouteIpNextHop_Type())
...
futOspfRouteType=_FutOspfRouteType_Object((1,3,6,1,4,1,2076,10,8,1,5),_FutOspfRouteType_Type())
...
futOspfRouteAreaId=_FutOspfRouteAreaId_Object((1,3,6,1,4,1,2076,10,8,1,6),_FutOspfRouteAreaId_Type())
...
futOspfRouteCost=_FutOspfRouteCost_Object((1,3,6,1,4,1,2076,10,8,1,7),_FutOspfRouteCost_Type())
...
futOspfRouteType2Cost=_FutOspfRouteType2Cost_Object((1,3,6,1,4,1,2076,10,8,1,8),_FutOspfRouteType2Cost_Type())
...
futOspfRouteInterfaceIndex=_FutOspfRouteInterfaceIndex_Object((1,3,6,1,4,1,2076,10,8,1,9),_FutOspfRouteInterfaceIndex_Type())
...
futOspfSecIfTable=_FutOspfSecIfTable_Object((1,3,6,1,4,1,2076,10,9))
if mibBuilder.loadTexts:futOspfSecIfTable.setStatus(_A)
_FutOspfSecIfEntry_Object=MibTableRow
futOspfSecIfEntry=_FutOspfSecIfEntry_Object((1,3,6,1,4,1,2076,10,9,1))
...
futOspfPrimIpAddr=_FutOspfPrimIpAddr_Object((1,3,6,1,4,1,2076,10,9,1,1),_FutOspfPrimIpAddr_Type())
...
_FutOspfPrimAddresslessIf_Type.__name__=_L
_FutOspfPrimAddresslessIf_Object=MibTableColumn
futOspfPrimAddresslessIf=_FutOspfPrimAddresslessIf_Object((1,3,6,1,4,1,2076,10,9,1,2),_FutOspfPrimAddresslessIf_Type())
...
futOspfSecIpAddr=_FutOspfSecIpAddr_Object((1,3,6,1,4,1,2076,10,9,1,3),_FutOspfSecIpAddr_Type())
...
futOspfSecIpAddrMask=_FutOspfSecIpAddrMask_Object((1,3,6,1,4,1,2076,10,9,1,4),_FutOspfSecIpAddrMask_Type())
...
futOspfSecIfStatus=_FutOspfSecIfStatus_Object((1,3,6,1,4,1,2076,10,9,1,5),_FutOspfSecIfStatus_Type())
...
futOspfAreaAggregateTable=_FutOspfAreaAggregateTable_Object((1,3,6,1,4,1,2076,10,10))
if mibBuilder.loadTexts:futOspfAreaAggregateTable.setStatus(_A)
_FutOspfAreaAggregateEntry_Object=MibTableRow
futOspfAreaAggregateEntry=_FutOspfAreaAggregateEntry_Object((1,3,6,1,4,1,2076,10,10,1))
...
futOspfAreaAggregateAreaID=_FutOspfAreaAggregateAreaID_Object((1,3,6,1,4,1,2076,10,10,1,1),_FutOspfAreaAggregateAreaID_Type())
...
futOspfAreaAggregateLsdbType=_FutOspfAreaAggregateLsdbType_Object((1,3,6,1,4,1,2076,10,10,1,2),_FutOspfAreaAggregateLsdbType_Type())
...
futOspfAreaAggregateNet=_FutOspfAreaAggregateNet_Object((1,3,6,1,4,1,2076,10,10,1,3),_FutOspfAreaAggregateNet_Type())
...
futOspfAreaAggregateMask=_FutOspfAreaAggregateMask_Object((1,3,6,1,4,1,2076,10,10,1,4),_FutOspfAreaAggregateMask_Type())
...
futOspfAreaAggregateExternalTag=_FutOspfAreaAggregateExternalTag_Object((1,3,6,1,4,1,2076,10,10,1,5),_FutOspfAreaAggregateExternalTag_Type())
...
futOspfAsExternalAggregationTable=_FutOspfAsExternalAggregationTable_Object((1,3,6,1,4,1,2076,10,11))
...
futOspfAsExternalAggregationEntry=_FutOspfAsExternalAggregationEntry_Object((1,3,6,1,4,1,2076,10,11,1))
...
futOspfAsExternalAggregationNet=_FutOspfAsExternalAggregationNet_Object((1,3,6,1,4,1,2076,10,11,1,1),_FutOspfAsExternalAggregationNet_Type())
...
futOspfAsExternalAggregationMask=_FutOspfAsExternalAggregationMask_Object((1,3,6,1,4,1,2076,10,11,1,2),_FutOspfAsExternalAggregationMask_Type())
...
futOspfAsExternalAggregationAreaId=_FutOspfAsExternalAggregationAreaId_Object((1,3,6,1,4,1,2076,10,11,1,3),_FutOspfAsExternalAggregationAreaId_Type())
...
futOspfAsExternalAggregationEffect=_FutOspfAsExternalAggregationEffect_Object((1,3,6,1,4,1,2076,10,11,1,4),_FutOspfAsExternalAggregationEffect_Type())
...
futOspfAsExternalAggregationTranslation=_FutOspfAsExternalAggregationTranslation_Object((1,3,6,1,4,1,2076,10,11,1,5),_FutOspfAsExternalAggregationTranslation_Type())
...
futOspfAsExternalAggregationStatus=_FutOspfAsExternalAggregationStatus_Object((1,3,6,1,4,1,2076,10,11,1,6),_FutOspfAsExternalAggregationStatus_Type())
...
futOspfOpaqueLSAGroup=_FutOspfOpaqueLSAGroup_ObjectIdentity((1,3,6,1,4,1,2076,10,12))
_FutOspfOpaqueLSAGeneralGroup_ObjectIdentity=ObjectIdentity
futOspfOpaqueLSAGeneralGroup=_FutOspfOpaqueLSAGeneralGroup_ObjectIdentity((1,3,6,1,4,1,2076,10,12,1))
...
futOspfOpaqueOption=_FutOspfOpaqueOption_Object((1,3,6,1,4,1,2076,10,12,1,1),_FutOspfOpaqueOption_Type())
...
futOspfType11LsaCount=_FutOspfType11LsaCount_Object((1,3,6,1,4,1,2076,10,12,1,2),_FutOspfType11LsaCount_Type())
...
futOspfType11LsaCksumSum=_FutOspfType11LsaCksumSum_Object((1,3,6,1,4,1,2076,10,12,1,3),_FutOspfType11LsaCksumSum_Type())
...
_FutOspfAreaIDValid_Type.__name__=_O
_FutOspfAreaIDValid_Object=MibScalar
futOspfAreaIDValid=_FutOspfAreaIDValid_Object((1,3,6,1,4,1,2076,10,12,1,4),_FutOspfAreaIDValid_Type())
...
futOspfOpaqueInterfaceTable=_FutOspfOpaqueInterfaceTable_Object((1,3,6,1,4,1,2076,10,12,2))
if mibBuilder.loadTexts:futOspfOpaqueInterfaceTable.setStatus(_A)
_FutOspfOpaqueInterfaceEntry_Object=MibTableRow
futOspfOpaqueInterfaceEntry=_FutOspfOpaqueInterfaceEntry_Object((1,3,6,1,4,1,2076,10,12,2,1))
...
futOspfOpaqueType9LsaCount=_FutOspfOpaqueType9LsaCount_Object((1,3,6,1,4,1,2076,10,12,2,1,1),_FutOspfOpaqueType9LsaCount_Type())
...
futOspfOpaqueType9LsaCksumSum=_FutOspfOpaqueType9LsaCksumSum_Object((1,3,6,1,4,1,2076,10,12,2,1,2),_FutOspfOpaqueType9LsaCksumSum_Type())
...
futOspfType9LsdbTable=_FutOspfType9LsdbTable_Object((1,3,6,1,4,1,2076,10,12,3))
if mibBuilder.loadTexts:futOspfType9LsdbTable.setStatus(_A)
_FutOspfType9LsdbEntry_Object=MibTableRow
futOspfType9LsdbEntry=_FutOspfType9LsdbEntry_Object((1,3,6,1,4,1,2076,10,12,3,1))
...
futOspfType9LsdbIfIpAddress=_FutOspfType9LsdbIfIpAddress_Object((1,3,6,1,4,1,2076,10,12,3,1,1),_FutOspfType9LsdbIfIpAddress_Type())
...
futOspfType9LsdbOpaqueType=_FutOspfType9LsdbOpaqueType_Object((1,3,6,1,4,1,2076,10,12,3,1,2),_FutOspfType9LsdbOpaqueType_Type())
...
futOspfType9LsdbLsid=_FutOspfType9LsdbLsid_Object((1,3,6,1,4,1,2076,10,12,3,1,3),_FutOspfType9LsdbLsid_Type())
...
futOspfType9LsdbRouterId=_FutOspfType9LsdbRouterId_Object((1,3,6,1,4,1,2076,10,12,3,1,4),_FutOspfType9LsdbRouterId_Type())
...
futOspfType9LsdbSequence=_FutOspfType9LsdbSequence_Object((1,3,6,1,4,1,2076,10,12,3,1,5),_FutOspfType9LsdbSequence_Type())
...
futOspfType9LsdbAge=_FutOspfType9LsdbAge_Object((1,3,6,1,4,1,2076,10,12,3,1,6),_FutOspfType9LsdbAge_Type())
...
futOspfType9LsdbChecksum=_FutOspfType9LsdbChecksum_Object((1,3,6,1,4,1,2076,10,12,3,1,7),_FutOspfType9LsdbChecksum_Type())
...
futOspfType9LsdbAdvertisement=_FutOspfType9LsdbAdvertisement_Object((1,3,6,1,4,1,2076,10,12,3,1,8),_FutOspfType9LsdbAdvertisement_Type())
...
futOspfType11LsdbTable=_FutOspfType11LsdbTable_Object((1,3,6,1,4,1,2076,10,12,4))
if mibBuilder.loadTexts:futOspfType11LsdbTable.setStatus(_A)
_FutOspfType11LsdbEntry_Object=MibTableRow
futOspfType11LsdbEntry=_FutOspfType11LsdbEntry_Object((1,3,6,1,4,1,2076,10,12,4,1))
...
futOspfType11LsdbOpaqueType=_FutOspfType11LsdbOpaqueType_Object((1,3,6,1,4,1,2076,10,12,4,1,1),_FutOspfType11LsdbOpaqueType_Type())
...
futOspfType11LsdbLsid=_FutOspfType11LsdbLsid_Object((1,3,6,1,4,1,2076,10,12,4,1,2),_FutOspfType11LsdbLsid_Type())
...
futOspfType11LsdbRouterId=_FutOspfType11LsdbRouterId_Object((1,3,6,1,4,1,2076,10,12,4,1,3),_FutOspfType11LsdbRouterId_Type())
...
futOspfType11LsdbSequence=_FutOspfType11LsdbSequence_Object((1,3,6,1,4,1,2076,10,12,4,1,4),_FutOspfType11LsdbSequence_Type())
...
futOspfType11LsdbAge=_FutOspfType11LsdbAge_Object((1,3,6,1,4,1,2076,10,12,4,1,5),_FutOspfType11LsdbAge_Type())
...
futOspfType11LsdbChecksum=_FutOspfType11LsdbChecksum_Object((1,3,6,1,4,1,2076,10,12,4,1,6),_FutOspfType11LsdbChecksum_Type())
...
futOspfType11LsdbAdvertisement=_FutOspfType11LsdbAdvertisement_Object((1,3,6,1,4,1,2076,10,12,4,1,7),_FutOspfType11LsdbAdvertisement_Type())
...
futOspfAppInfoDbTable=_FutOspfAppInfoDbTable_Object((1,3,6,1,4,1,2076,10,12,5))
if mibBuilder.loadTexts:futOspfAppInfoDbTable.setStatus(_A)
_FutOspfAppInfoDbEntry_Object=MibTableRow
futOspfAppInfoDbEntry=_FutOspfAppInfoDbEntry_Object((1,3,6,1,4,1,2076,10,12,5,1))
...
futOspfAppInfoDbAppid=_FutOspfAppInfoDbAppid_Object((1,3,6,1,4,1,2076,10,12,5,1,1),_FutOspfAppInfoDbAppid_Type())
...
futOspfAppInfoDbOpaqueType=_FutOspfAppInfoDbOpaqueType_Object((1,3,6,1,4,1,2076,10,12,5,1,2),_FutOspfAppInfoDbOpaqueType_Type())
...
futOspfAppInfoDbLsaTypesSupported=_FutOspfAppInfoDbLsaTypesSupported_Object((1,3,6,1,4,1,2076,10,12,5,1,3),_FutOspfAppInfoDbLsaTypesSupported_Type())
...
futOspfAppInfoDbType9Gen=_FutOspfAppInfoDbType9Gen_Object((1,3,6,1,4,1,2076,10,12,5,1,4),_FutOspfAppInfoDbType9Gen_Type())
...
futOspfAppInfoDbType9Rcvd=_FutOspfAppInfoDbType9Rcvd_Object((1,3,6,1,4,1,2076,10,12,5,1,5),_FutOspfAppInfoDbType9Rcvd_Type())
...
futOspfAppInfoDbType10Gen=_FutOspfAppInfoDbType10Gen_Object((1,3,6,1,4,1,2076,10,12,5,1,6),_FutOspfAppInfoDbType10Gen_Type())
...
futOspfAppInfoDbType10Rcvd=_FutOspfAppInfoDbType10Rcvd_Object((1,3,6,1,4,1,2076,10,12,5,1,7),_FutOspfAppInfoDbType10Rcvd_Type())
...
futOspfAppInfoDbType11Gen=_FutOspfAppInfoDbType11Gen_Object((1,3,6,1,4,1,2076,10,12,5,1,8),_FutOspfAppInfoDbType11Gen_Type())
...
futOspfAppInfoDbType11Rcvd=_FutOspfAppInfoDbType11Rcvd_Object((1,3,6,1,4,1,2076,10,12,5,1,9),_FutOspfAppInfoDbType11Rcvd_Type())
...
futospfRRDGroup=_FutospfRRDGroup_ObjectIdentity((1,3,6,1,4,1,2076,10,13))
_FutospfRRDGeneralGroup_ObjectIdentity=ObjectIdentity
futospfRRDGeneralGroup=_FutospfRRDGeneralGroup_ObjectIdentity((1,3,6,1,4,1,2076,10,13,1))
class _FutOspfRRDStatus_Type(Status):defaultValue=2
_FutOspfRRDStatus_Type.__name__=_U
_FutOspfRRDStatus_Object=MibScalar
futOspfRRDStatus=_FutOspfRRDStatus_Object((1,3,6,1,4,1,2076,10,13,1,1),_FutOspfRRDStatus_Type())
...
futOspfRRDSrcProtoMaskEnable=_FutOspfRRDSrcProtoMaskEnable_Object((1,3,6,1,4,1,2076,10,13,1,2),_FutOspfRRDSrcProtoMaskEnable_Type())
futOspfRRDSrcProtoMaskEnable.setMaxAccess(_C)
if mibBuilder.loadTexts:futOspfRRDSrcProtoMaskEnable.setStatus(_A)
class _FutOspfRRDSrcProtoMaskDisable_Type(Integer32):defaultValue=587478
_FutOspfRRDSrcProtoMaskDisable_Type.__name__=_B
_FutOspfRRDSrcProtoMaskDisable_Object=MibScalar
futOspfRRDSrcProtoMaskDisable=_FutOspfRRDSrcProtoMaskDisable_Object((1,3,6,1,4,1,2076,10,13,1,3),_FutOspfRRDSrcProtoMaskDisable_Type())
...
futOspfRRDRouteMapEnable=_FutOspfRRDRouteMapEnable_Object((1,3,6,1,4,1,2076,10,13,1,4),_FutOspfRRDRouteMapEnable_Type())
...
futOspfRRDRouteConfigTable=_FutOspfRRDRouteConfigTable_Object((1,3,6,1,4,1,2076,10,13,2))
if mibBuilder.loadTexts:futOspfRRDRouteConfigTable.setStatus(_A)
_FutOspfRRDRouteConfigEntry_Object=MibTableRow
futOspfRRDRouteConfigEntry=_FutOspfRRDRouteConfigEntry_Object((1,3,6,1,4,1,2076,10,13,2,1))
...
futOspfRRDRouteDest=_FutOspfRRDRouteDest_Object((1,3,6,1,4,1,2076,10,13,2,1,1),_FutOspfRRDRouteDest_Type())
...
futOspfRRDRouteMask=_FutOspfRRDRouteMask_Object((1,3,6,1,4,1,2076,10,13,2,1,2),_FutOspfRRDRouteMask_Type())
...
futOspfRRDRouteMetric=_FutOspfRRDRouteMetric_Object((1,3,6,1,4,1,2076,10,13,2,1,3),_FutOspfRRDRouteMetric_Type())
...
futOspfRRDRouteMetricType=_FutOspfRRDRouteMetricType_Object((1,3,6,1,4,1,2076,10,13,2,1,4),_FutOspfRRDRouteMetricType_Type())
...
futOspfRRDRouteTagType=_FutOspfRRDRouteTagType_Object((1,3,6,1,4,1,2076,10,13,2,1,5),_FutOspfRRDRouteTagType_Type())
...
futOspfRRDRouteTag=_FutOspfRRDRouteTag_Object((1,3,6,1,4,1,2076,10,13,2,1,6),_FutOspfRRDRouteTag_Type())
...
futOspfRRDRouteStatus=_FutOspfRRDRouteStatus_Object((1,3,6,1,4,1,2076,10,13,2,1,7),_FutOspfRRDRouteStatus_Type())
...
futOspfVirtNbrTable=_FutOspfVirtNbrTable_Object((1,3,6,1,4,1,2076,10,14))
if mibBuilder.loadTexts:futOspfVirtNbrTable.setStatus(_A)
_FutOspfVirtNbrEntry_Object=MibTableRow
futOspfVirtNbrEntry=_FutOspfVirtNbrEntry_Object((1,3,6,1,4,1,2076,10,14,1))
...
futOspfVirtNbrRestartHelperStatus=_FutOspfVirtNbrRestartHelperStatus_Object((1,3,6,1,4,1,2076,10,14,1,1),_FutOspfVirtNbrRestartHelperStatus_Type())
...
futOspfVirtNbrRestartHelperAge=_FutOspfVirtNbrRestartHelperAge_Object((1,3,6,1,4,1,2076,10,14,1,2),_FutOspfVirtNbrRestartHelperAge_Type())
...
futOspfVirtNbrRestartHelperExitReason=_FutOspfVirtNbrRestartHelperExitReason_Object((1,3,6,1,4,1,2076,10,14,1,3),_FutOspfVirtNbrRestartHelperExitReason_Type())
...
futospfDistInOutRouteMap=_FutospfDistInOutRouteMap_ObjectIdentity((1,3,6,1,4,1,2076,10,15))
_FutOspfDistInOutRouteMapTable_Object=MibTable
futOspfDistInOutRouteMapTable=_FutOspfDistInOutRouteMapTable_Object((1,3,6,1,4,1,2076,10,15,1))
if mibBuilder.loadTexts:futOspfDistInOutRouteMapTable.setStatus(_A)
_FutOspfDistInOutRouteMapEntry_Object=MibTableRow
futOspfDistInOutRouteMapEntry=_FutOspfDistInOutRouteMapEntry_Object((1,3,6,1,4,1,2076,10,15,1,1))
...
futOspfDistInOutRouteMapName=_FutOspfDistInOutRouteMapName_Object((1,3,6,1,4,1,2076,10,15,1,1,1),_FutOspfDistInOutRouteMapName_Type())
...
futOspfDistInOutRouteMapType=_FutOspfDistInOutRouteMapType_Object((1,3,6,1,4,1,2076,10,15,1,1,3),_FutOspfDistInOutRouteMapType_Type())
...
futOspfDistInOutRouteMapValue=_FutOspfDistInOutRouteMapValue_Object((1,3,6,1,4,1,2076,10,15,1,1,4),_FutOspfDistInOutRouteMapValue_Type())
...
futOspfDistInOutRouteMapRowStatus=_FutOspfDistInOutRouteMapRowStatus_Object((1,3,6,1,4,1,2076,10,15,1,1,5),_FutOspfDistInOutRouteMapRowStatus_Type())
...
futospfPreferenceGroup=_FutospfPreferenceGroup_ObjectIdentity((1,3,6,1,4,1,2076,10,16))
...
futOspfPreferenceValue=_FutOspfPreferenceValue_Object((1,3,6,1,4,1,2076,10,16,1),_FutOspfPreferenceValue_Type())
...
futOspfIfAuthTable=_FutOspfIfAuthTable_Object((1,3,6,1,4,1,2076,10,17))
if mibBuilder.loadTexts:futOspfIfAuthTable.setStatus(_A)
_FutOspfIfAuthEntry_Object=MibTableRow
futOspfIfAuthEntry=_FutOspfIfAuthEntry_Object((1,3,6,1,4,1,2076,10,17,1))
...
futOspfIfAuthIpAddress=_FutOspfIfAuthIpAddress_Object((1,3,6,1,4,1,2076,10,17,1,1),_FutOspfIfAuthIpAddress_Type())
...
_FutOspfIfAuthAddressLessIf_Type.__name__=_L
_FutOspfIfAuthAddressLessIf_Object=MibTableColumn
futOspfIfAuthAddressLessIf=_FutOspfIfAuthAddressLessIf_Object((1,3,6,1,4,1,2076,10,17,1,2),_FutOspfIfAuthAddressLessIf_Type())
...
futOspfIfAuthKeyId=_FutOspfIfAuthKeyId_Object((1,3,6,1,4,1,2076,10,17,1,3),_FutOspfIfAuthKeyId_Type())
...
futOspfIfAuthKey=_FutOspfIfAuthKey_Object((1,3,6,1,4,1,2076,10,17,1,4),_FutOspfIfAuthKey_Type())
...
futOspfIfAuthKeyStartAccept=_FutOspfIfAuthKeyStartAccept_Object((1,3,6,1,4,1,2076,10,17,1,5),_FutOspfIfAuthKeyStartAccept_Type())
...
futOspfIfAuthKeyStartGenerate=_FutOspfIfAuthKeyStartGenerate_Object((1,3,6,1,4,1,2076,10,17,1,6),_FutOspfIfAuthKeyStartGenerate_Type())
...
futOspfIfAuthKeyStopGenerate=_FutOspfIfAuthKeyStopGenerate_Object((1,3,6,1,4,1,2076,10,17,1,7),_FutOspfIfAuthKeyStopGenerate_Type())
...
futOspfIfAuthKeyStopAccept=_FutOspfIfAuthKeyStopAccept_Object((1,3,6,1,4,1,2076,10,17,1,8),_FutOspfIfAuthKeyStopAccept_Type())
...
futOspfIfAuthKeyStatus=_FutOspfIfAuthKeyStatus_Object((1,3,6,1,4,1,2076,10,17,1,9),_FutOspfIfAuthKeyStatus_Type())
...
futOspfVirtIfAuthTable=_FutOspfVirtIfAuthTable_Object((1,3,6,1,4,1,2076,10,18))
if mibBuilder.loadTexts:futOspfVirtIfAuthTable.setStatus(_A)
_FutOspfVirtIfAuthEntry_Object=MibTableRow
futOspfVirtIfAuthEntry=_FutOspfVirtIfAuthEntry_Object((1,3,6,1,4,1,2076,10,18,1))
...
futOspfVirtIfAuthAreaId=_FutOspfVirtIfAuthAreaId_Object((1,3,6,1,4,1,2076,10,18,1,1),_FutOspfVirtIfAuthAreaId_Type())
...
futOspfVirtIfAuthNeighbor=_FutOspfVirtIfAuthNeighbor_Object((1,3,6,1,4,1,2076,10,18,1,2),_FutOspfVirtIfAuthNeighbor_Type())
...
futOspfVirtIfAuthKeyId=_FutOspfVirtIfAuthKeyId_Object((1,3,6,1,4,1,2076,10,18,1,3),_FutOspfVirtIfAuthKeyId_Type())
...
futOspfVirtIfAuthKey=_FutOspfVirtIfAuthKey_Object((1,3,6,1,4,1,2076,10,18,1,4),_FutOspfVirtIfAuthKey_Type())
...
futOspfVirtIfAuthKeyStartAccept=_FutOspfVirtIfAuthKeyStartAccept_Object((1,3,6,1,4,1,2076,10,18,1,5),_FutOspfVirtIfAuthKeyStartAccept_Type())
...
futOspfVirtIfAuthKeyStartGenerate=_FutOspfVirtIfAuthKeyStartGenerate_Object((1,3,6,1,4,1,2076,10,18,1,6),_FutOspfVirtIfAuthKeyStartGenerate_Type())
...
futOspfVirtIfAuthKeyStopGenerate=_FutOspfVirtIfAuthKeyStopGenerate_Object((1,3,6,1,4,1,2076,10,18,1,7),_FutOspfVirtIfAuthKeyStopGenerate_Type())
...
futOspfVirtIfAuthKeyStopAccept=_FutOspfVirtIfAuthKeyStopAccept_Object((1,3,6,1,4,1,2076,10,18,1,8),_FutOspfVirtIfAuthKeyStopAccept_Type())
...
futOspfVirtIfAuthKeyStatus=_FutOspfVirtIfAuthKeyStatus_Object((1,3,6,1,4,1,2076,10,18,1,9),_FutOspfVirtIfAuthKeyStatus_Type())
...
futOspfIfCryptoAuthTable=_FutOspfIfCryptoAuthTable_Object((1,3,6,1,4,1,2076,10,19))
if mibBuilder.loadTexts:futOspfIfCryptoAuthTable.setStatus(_A)
_FutOspfIfCryptoAuthEntry_Object=MibTableRow
futOspfIfCryptoAuthEntry=_FutOspfIfCryptoAuthEntry_Object((1,3,6,1,4,1,2076,10,19,1))
...
futOspfIfCryptoAuthType=_FutOspfIfCryptoAuthType_Object((1,3,6,1,4,1,2076,10,19,1,1),_FutOspfIfCryptoAuthType_Type())
...
futOspfVirtIfCryptoAuthTable=_FutOspfVirtIfCryptoAuthTable_Object((1,3,6,1,4,1,2076,10,20))
if mibBuilder.loadTexts:futOspfVirtIfCryptoAuthTable.setStatus(_A)
_FutOspfVirtIfCryptoAuthEntry_Object=MibTableRow
futOspfVirtIfCryptoAuthEntry=_FutOspfVirtIfCryptoAuthEntry_Object((1,3,6,1,4,1,2076,10,20,1))
...
futOspfVirtIfCryptoAuthType=_FutOspfVirtIfCryptoAuthType_Object((1,3,6,1,4,1,2076,10,20,1,1),_FutOspfVirtIfCryptoAuthType_Type())
...
futOspfTestGroup=_FutOspfTestGroup_ObjectIdentity((1,3,6,1,4,1,2076,10,100))
_FutOspfNotification_ObjectIdentity=ObjectIdentity
futOspfNotification=_FutOspfNotification_ObjectIdentity((1,3,6,1,4,1,2076,10,101))
_FutOspfTraps_ObjectIdentity=ObjectIdentity
futOspfTraps=_FutOspfTraps_ObjectIdentity((1,3,6,1,4,1,2076,10,101,0))
_FutOspfOasGroup_ObjectIdentity=ObjectIdentity
futOspfOasGroup=_FutOspfOasGroup_ObjectIdentity((1,3,6,1,4,1,2076,10,102))
...
futOspfRestartStatusChange=NotificationType((1,3,6,1,4,1,2076,10,101,0,1))
futOspfRestartStatusChange.setObjects(*((_K,_N),(_E,_AY),(_E,_AZ),(_E,_Aa)))
if mibBuilder.loadTexts:futOspfRestartStatusChange.setStatus(_A)
futOspfNbrRestartHelperStatusChange=NotificationType((1,3,6,1,4,1,2076,10,101,0,2))
futOspfNbrRestartHelperStatusChange.setObjects(*((_K,_N),(_K,_b),(_E,_Ab),(_E,_Ac),(_E,_Ad)))
if mibBuilder.loadTexts:futOspfNbrRestartHelperStatusChange.setStatus(_A)
futOspfVirtNbrRestartHelperStatusChange=NotificationType((1,3,6,1,4,1,2076,10,101,0,3))
futOspfVirtNbrRestartHelperStatusChange.setObjects(*((_K,_N),(_E,_Ae),(_E,_Af),(_E,_Ag)))
if mibBuilder.loadTexts:futOspfVirtNbrRestartHelperStatusChange.setStatus(_A)
futOspfHotStandbyEventTrap=NotificationType((1,3,6,1,4,1,2076,10,101,0,4))
futOspfHotStandbyEventTrap.setObjects(*((_K,_N),(_E,_Ah),(_E,_Ai)))
