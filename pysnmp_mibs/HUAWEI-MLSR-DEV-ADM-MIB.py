...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/h3c/HUAWEI-MLSR-DEV-ADM-MIB
...
huawei, router, mlsr, products = mibBuilder.importSymbols("HUAWEI-3COM-OID-MIB", "huawei", "router", "mlsr", "products")
...
mibBuilder.exportSymbols("HUAWEI-MLSR-DEV-ADM-MIB", hwBuffer2048CollectCounts=hwBuffer2048CollectCounts, hwNVRAMSize=hwNVRAMSize, hwBuffer2048FreeError2=hwBuffer2048FreeError2, hwBuffer256DropCounts=hwBuffer256DropCounts, hwBuffer8192CollectCounts=hwBuffer8192CollectCounts, hwBuffer1024Used=hwBuffer1024Used, hwBuffer256Used=hwBuffer256Used, hwBuffer256KTotal=hwBuffer256KTotal, hwBuffer64DropCounts=hwBuffer64DropCounts, hwBuffer256CollectCounts=hwBuffer256CollectCounts, hwBuffer4096FreeError3=hwBuffer4096FreeError3, hwBuffer4096DropCounts=hwBuffer4096DropCounts, hwBuffer45KTotal=hwBuffer45KTotal, hwNVRAMUsed=hwNVRAMUsed, hwBuffer512DropCounts=hwBuffer512DropCounts, hwBuffer1024Free=hwBuffer1024Free, loghostIndex=loghostIndex, hwHostConfigName=hwHostConfigName, hwBuffer32Total=hwBuffer32Total, hwBuffer1024DropCounts=hwBuffer1024DropCounts, loghostseverity=loghostseverity, hwBuffer64FreeError2=hwBuffer64FreeError2, moduleVersion=moduleVersion, hwBuffer8192Used=hwBuffer8192Used, loghoststatus=loghoststatus, hwBuffer128DropCounts=hwBuffer128DropCounts, hwBuffer1024FreeError2=hwBuffer1024FreeError2, huaweiMemoryMan=huaweiMemoryMan, hwMemoryMallocNoMem=hwMemoryMallocNoMem, hwBuffer4096CollectCounts=hwBuffer4096CollectCounts, hwBuffer1024Total=hwBuffer1024Total, loghostfacility=loghostfacility, loghostEntry=loghostEntry, hwBuffer4096FreeError2=hwBuffer4096FreeError2, HwFlashStatus=HwFlashStatus, hwBuffer256KFree=hwBuffer256KFree, hwBuffer1024FreeError3=hwBuffer1024FreeError3, hwTFTPEnabled=hwTFTPEnabled, hwBuffer45KUsed=hwBuffer45KUsed, hwFlashMan=hwFlashMan, hwmHostName=hwmHostName, hwBuffer256Size=hwBuffer256Size, hwBuffer512FreeError2=hwBuffer512FreeError2, hwmWhyReboot=hwmWhyReboot, hwFlhUnusedSize=hwFlhUnusedSize, logfilterstatus=logfilterstatus, hwBuffer8192FreeError2=hwBuffer8192FreeError2, hwBuffer45KFree=hwBuffer45KFree, hwBuffer256FreeError3=hwBuffer256FreeError3, hwFreeMemory=hwFreeMemory, log=log, moduleEntry=moduleEntry, hwBuffer64CollectCounts=hwBuffer64CollectCounts, hwBuffer128FreeError2=hwBuffer128FreeError2, hwNetConfigName=hwNetConfigName, hwBuffer4096Size=hwBuffer4096Size, hwBuffer1024Size=hwBuffer1024Size, hwBuffer45KCollectCounts=hwBuffer45KCollectCounts, hwBuffer512Total=hwBuffer512Total, hwBuffer8192Free=hwBuffer8192Free, hwBuffer256FreeError2=hwBuffer256FreeError2, hwBuffer128Size=hwBuffer128Size, hwBuffer45KDropCounts=hwBuffer45KDropCounts, hwRAMSize=hwRAMSize, HwFlashEreaseStatus=HwFlashEreaseStatus, hwBuffer128Total=hwBuffer128Total, hwBuffer8192Size=hwBuffer8192Size, moduleSwVersion=moduleSwVersion, hwBuffer2048Used=hwBuffer2048Used, logfilterIndex=logfilterIndex, moduleTable=moduleTable, hwRunCfgSavedTime=hwRunCfgSavedTime, logcontroller=logcontroller, hwBuffer256Total=hwBuffer256Total, hwBuffer4096Used=hwBuffer4096Used, hwBuffer45KFreeError2=hwBuffer45KFreeError2, moduleFirstPort=moduleFirstPort, hwMemoryLargestFree=hwMemoryLargestFree, trap=trap, hwBuffer256KCollectCounts=hwBuffer256KCollectCounts, hwBuffer512Free=hwBuffer512Free, hwFansStatus=hwFansStatus, hwROMVersion=hwROMVersion, hwConfigRegNextReboot=hwConfigRegNextReboot, hwSecondPowerStatus=hwSecondPowerStatus, hwMemoryFree=hwMemoryFree, hwBuffer2048Free=hwBuffer2048Free, hwmSystem=hwmSystem, hwConfigReg=hwConfigReg, attr=attr, hwBuffer8192FreeError3=hwBuffer8192FreeError3, hwCpuCostRatePer5Minute=hwCpuCostRatePer5Minute, hwSysAirFlowTempIn=hwSysAirFlowTempIn, hwModuleId=hwModuleId, hwBuffer128CollectCounts=hwBuffer128CollectCounts, hwBuffer45KSize=hwBuffer45KSize, hwBuffer2048DropCounts=hwBuffer2048DropCounts, hwFlhEraseStat=hwFlhEraseStat, hwFlhCurStat=hwFlhCurStat, loghostaddress=loghostaddress, hwBuffer4096Total=hwBuffer4096Total, hwCurrentTime=hwCurrentTime, huaweiMixinfo=huaweiMixinfo, RowStatus=RowStatus, hwRunCfgChangedTime=hwRunCfgChangedTime, hwBuffer64Free=hwBuffer64Free, hwBuffer8192Total=hwBuffer8192Total, hwBuffer256KFreeError3=hwBuffer256KFreeError3, hwBuffer256KUsed=hwBuffer256KUsed, hwBuffer32FreeError2=hwBuffer32FreeError2, hwCpuCostRatePer5Sec=hwCpuCostRatePer5Sec, hwBuffer1024CollectCounts=hwBuffer1024CollectCounts, loghostlanguage=loghostlanguage, hwBuffer256KDropCounts=hwBuffer256KDropCounts, loghostaccess=loghostaccess, hwBuffer32DropCounts=hwBuffer32DropCounts, hwBuffer32Used=hwBuffer32Used, hwBuffer512Used=hwBuffer512Used, hwmRouterSerialNO=hwmRouterSerialNO, hwBuffer64Size=hwBuffer64Size, routerGeneral=routerGeneral, loghostTable=loghostTable, moduleType=moduleType, hwBuffer2048Size=hwBuffer2048Size, hwMemoryMallocFail=hwMemoryMallocFail, vrp=vrp, hwFlhTotalSize=hwFlhTotalSize, hwBuffer4096Free=hwBuffer4096Free, logdevfacility=logdevfacility, hwBuffer128Used=hwBuffer128Used, hwBuffer32Free=hwBuffer32Free, hwBuffer64Total=hwBuffer64Total, loghostport=loghostport, hwmHostHwVersion=hwmHostHwVersion, hwBuffer512CollectCounts=hwBuffer512CollectCounts, hwBuffer512FreeError3=hwBuffer512FreeError3, hwBuffer32FreeError3=hwBuffer32FreeError3, hwBuffer32Size=hwBuffer32Size, hwBuffer45KFreeError3=hwBuffer45KFreeError3, hwStartCfgChangedTime=hwStartCfgChangedTime, hwBuzzerStatus=hwBuzzerStatus, moduleSlotNum=moduleSlotNum, logfilterEntry=logfilterEntry, hwBuffer64FreeError3=hwBuffer64FreeError3, hwBuffer8192DropCounts=hwBuffer8192DropCounts, hwPowerStatus=hwPowerStatus, hwBuffer256KSize=hwBuffer256KSize, hwBuffer128Free=hwBuffer128Free, moduleIndex=moduleIndex, moduleNumberOfPorts=moduleNumberOfPorts, hwBuffer128FreeError3=hwBuffer128FreeError3, hwBuffer256KFreeError2=hwBuffer256KFreeError2, hwBuffer64Used=hwBuffer64Used, hwConfigFile=hwConfigFile, hwROMID=hwROMID, hwBuffer2048FreeError3=hwBuffer2048FreeError3, module=module, basis=basis, moduleHwVersion=moduleHwVersion, hwBuffer32CollectCounts=hwBuffer32CollectCounts, hwROMSysVersion=hwROMSysVersion, hwBuffer512Size=hwBuffer512Size, version=version, hwBuffer256Free=hwBuffer256Free, hwBuffer2048Total=hwBuffer2048Total, hwFlhEraseTime=hwFlhEraseTime, hwUsedMemory=hwUsedMemory, logfilterTable=logfilterTable)
