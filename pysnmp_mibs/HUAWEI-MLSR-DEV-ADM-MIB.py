...
router, products, mlsr, huawei = mibBuilder.importSymbols("HUAWEI-3COM-OID-MIB", "router", "products", "mlsr", "huawei")
...
mibBuilder.exportSymbols("HUAWEI-MLSR-DEV-ADM-MIB", hwBuffer256Free=hwBuffer256Free, loghostIndex=loghostIndex, loghostaccess=loghostaccess, hwNVRAMSize=hwNVRAMSize, hwBuffer32FreeError2=hwBuffer32FreeError2, hwBuffer2048FreeError2=hwBuffer2048FreeError2, hwBuffer256KTotal=hwBuffer256KTotal, hwBuffer45KSize=hwBuffer45KSize, hwBuffer64Free=hwBuffer64Free, hwConfigRegNextReboot=hwConfigRegNextReboot, hwBuffer256KSize=hwBuffer256KSize, hwBuffer512FreeError3=hwBuffer512FreeError3, hwFlashMan=hwFlashMan, hwBuffer2048Used=hwBuffer2048Used, hwBuffer256KCollectCounts=hwBuffer256KCollectCounts, hwBuffer32Free=hwBuffer32Free, hwBuffer128FreeError2=hwBuffer128FreeError2, hwMemoryLargestFree=hwMemoryLargestFree, hwFlhTotalSize=hwFlhTotalSize, huaweiMemoryMan=huaweiMemoryMan, hwBuffer4096Free=hwBuffer4096Free, hwBuffer8192Total=hwBuffer8192Total, hwBuffer8192Used=hwBuffer8192Used, logfilterIndex=logfilterIndex, hwBuffer2048Size=hwBuffer2048Size, hwROMVersion=hwROMVersion, RowStatus=RowStatus, hwRunCfgChangedTime=hwRunCfgChangedTime, hwFlhEraseStat=hwFlhEraseStat, hwBuffer45KFreeError2=hwBuffer45KFreeError2, loghostEntry=loghostEntry, vrp=vrp, hwBuffer32Total=hwBuffer32Total, hwBuffer128Total=hwBuffer128Total, hwFansStatus=hwFansStatus, hwBuffer4096Total=hwBuffer4096Total, hwMemoryFree=hwMemoryFree, logdevfacility=logdevfacility, hwBuffer8192Size=hwBuffer8192Size, hwmWhyReboot=hwmWhyReboot, hwBuffer64DropCounts=hwBuffer64DropCounts, hwBuffer8192DropCounts=hwBuffer8192DropCounts, hwBuffer1024FreeError3=hwBuffer1024FreeError3, hwBuffer64Used=hwBuffer64Used, hwBuffer256KDropCounts=hwBuffer256KDropCounts, hwBuffer2048Free=hwBuffer2048Free, hwBuffer64FreeError3=hwBuffer64FreeError3, hwBuffer128Size=hwBuffer128Size, moduleSlotNum=moduleSlotNum, hwNVRAMUsed=hwNVRAMUsed, hwBuffer128Free=hwBuffer128Free, hwBuffer512Size=hwBuffer512Size, hwBuffer45KFreeError3=hwBuffer45KFreeError3, hwBuffer64CollectCounts=hwBuffer64CollectCounts, hwRAMSize=hwRAMSize, HwFlashEreaseStatus=HwFlashEreaseStatus, moduleTable=moduleTable, log=log, hwFlhEraseTime=hwFlhEraseTime, hwSecondPowerStatus=hwSecondPowerStatus, routerGeneral=routerGeneral, hwBuffer8192Free=hwBuffer8192Free, hwSysAirFlowTempIn=hwSysAirFlowTempIn, moduleVersion=moduleVersion, hwBuffer256DropCounts=hwBuffer256DropCounts, attr=attr, hwBuffer45KTotal=hwBuffer45KTotal, hwBuzzerStatus=hwBuzzerStatus, hwBuffer32CollectCounts=hwBuffer32CollectCounts, basis=basis, hwBuffer32FreeError3=hwBuffer32FreeError3, hwUsedMemory=hwUsedMemory, hwBuffer1024CollectCounts=hwBuffer1024CollectCounts, hwRunCfgSavedTime=hwRunCfgSavedTime, moduleHwVersion=moduleHwVersion, hwBuffer512Used=hwBuffer512Used, loghostaddress=loghostaddress, hwROMID=hwROMID, hwBuffer1024Total=hwBuffer1024Total, hwBuffer1024Used=hwBuffer1024Used, moduleIndex=moduleIndex, moduleNumberOfPorts=moduleNumberOfPorts, loghostTable=loghostTable, hwFlhCurStat=hwFlhCurStat, hwBuffer64Size=hwBuffer64Size, hwBuffer1024Size=hwBuffer1024Size, hwMemoryMallocFail=hwMemoryMallocFail, hwBuffer256FreeError3=hwBuffer256FreeError3, hwBuffer8192CollectCounts=hwBuffer8192CollectCounts, hwBuffer256KFreeError2=hwBuffer256KFreeError2, hwBuffer256Total=hwBuffer256Total, hwBuffer4096FreeError2=hwBuffer4096FreeError2, hwBuffer4096CollectCounts=hwBuffer4096CollectCounts, hwBuffer64FreeError2=hwBuffer64FreeError2, hwBuffer512Total=hwBuffer512Total, hwConfigReg=hwConfigReg, hwBuffer32Used=hwBuffer32Used, hwBuffer4096Size=hwBuffer4096Size, hwBuffer256KFree=hwBuffer256KFree, logcontroller=logcontroller, hwBuffer256Size=hwBuffer256Size, hwBuffer128Used=hwBuffer128Used, hwBuffer4096DropCounts=hwBuffer4096DropCounts, hwBuffer256KFreeError3=hwBuffer256KFreeError3, HwFlashStatus=HwFlashStatus, hwStartCfgChangedTime=hwStartCfgChangedTime, hwBuffer2048Total=hwBuffer2048Total, hwHostConfigName=hwHostConfigName, hwBuffer1024Free=hwBuffer1024Free, hwFlhUnusedSize=hwFlhUnusedSize, module=module, hwBuffer32Size=hwBuffer32Size, hwBuffer32DropCounts=hwBuffer32DropCounts, hwPowerStatus=hwPowerStatus, logfilterstatus=logfilterstatus, hwBuffer128DropCounts=hwBuffer128DropCounts, hwmHostHwVersion=hwmHostHwVersion, hwROMSysVersion=hwROMSysVersion, hwBuffer512Free=hwBuffer512Free, loghostport=loghostport, hwCpuCostRatePer5Sec=hwCpuCostRatePer5Sec, hwBuffer64Total=hwBuffer64Total, hwTFTPEnabled=hwTFTPEnabled, hwBuffer45KDropCounts=hwBuffer45KDropCounts, hwBuffer2048CollectCounts=hwBuffer2048CollectCounts, hwBuffer256KUsed=hwBuffer256KUsed, hwBuffer45KFree=hwBuffer45KFree, moduleType=moduleType, hwConfigFile=hwConfigFile, loghostlanguage=loghostlanguage, hwBuffer512DropCounts=hwBuffer512DropCounts, hwBuffer45KCollectCounts=hwBuffer45KCollectCounts, version=version, moduleEntry=moduleEntry, loghostseverity=loghostseverity, hwmHostName=hwmHostName, hwmRouterSerialNO=hwmRouterSerialNO, hwNetConfigName=hwNetConfigName, hwBuffer2048FreeError3=hwBuffer2048FreeError3, hwBuffer45KUsed=hwBuffer45KUsed, hwBuffer512FreeError2=hwBuffer512FreeError2, hwCurrentTime=hwCurrentTime, hwBuffer8192FreeError3=hwBuffer8192FreeError3, hwBuffer256Used=hwBuffer256Used, hwBuffer512CollectCounts=hwBuffer512CollectCounts, hwMemoryMallocNoMem=hwMemoryMallocNoMem, trap=trap, hwBuffer8192FreeError2=hwBuffer8192FreeError2, hwModuleId=hwModuleId, hwBuffer2048DropCounts=hwBuffer2048DropCounts, hwFreeMemory=hwFreeMemory, hwmSystem=hwmSystem, hwBuffer256CollectCounts=hwBuffer256CollectCounts, logfilterEntry=logfilterEntry, loghoststatus=loghoststatus, moduleFirstPort=moduleFirstPort, hwBuffer128FreeError3=hwBuffer128FreeError3, hwBuffer1024DropCounts=hwBuffer1024DropCounts, loghostfacility=loghostfacility, moduleSwVersion=moduleSwVersion, hwBuffer1024FreeError2=hwBuffer1024FreeError2, hwBuffer128CollectCounts=hwBuffer128CollectCounts, hwBuffer4096Used=hwBuffer4096Used, hwBuffer256FreeError2=hwBuffer256FreeError2, hwBuffer4096FreeError3=hwBuffer4096FreeError3, huaweiMixinfo=huaweiMixinfo, logfilterTable=logfilterTable, hwCpuCostRatePer5Minute=hwCpuCostRatePer5Minute)
