...
mibBuilder.exportSymbols("FR-MIB", nnfrPvcStatsErrPktsRxLastFiveMins=nnfrPvcStatsErrPktsRxLastFiveMins, nnfrAvcNoOfCvcs=nnfrAvcNoOfCvcs, nnfrStatsTable=nnfrStatsTable, nnfrIfEnable=nnfrIfEnable, nnmfrFrameSize=nnmfrFrameSize, nnfrFrameSize=nnfrFrameSize, nnfrAvcStatsUpDownStatesLastBootOrClear=nnfrAvcStatsUpDownStatesLastBootOrClear, nnfrStatsInvDLCIsRx=nnfrStatsInvDLCIsRx, nnfrPvcStatsBytesRxLastFiveMins=nnfrPvcStatsBytesRxLastFiveMins, nnfrIfType=nnfrIfType, nnfrPvcRemoteIpAddr=nnfrPvcRemoteIpAddr, nnfrPvcStatsPktsRxLastFiveMins=nnfrPvcStatsPktsRxLastFiveMins, nnmfrClass=nnmfrClass, nnfrPvcTableEntry=nnfrPvcTableEntry, nnfrAvcDiffDelay=nnfrAvcDiffDelay, nnfrAvcRowStatus=nnfrAvcRowStatus, nnfrPvcStatsBytesTxLastFiveMins=nnfrPvcStatsBytesTxLastFiveMins, nnfrStatsFramesTx=nnfrStatsFramesTx, nnfrPvcStatsUpDownStatesLastFiveMins=nnfrPvcStatsUpDownStatesLastFiveMins, nnfrPvcRowStatus=nnfrPvcRowStatus, nnfrPvcStatsErrPktsRxLastBootOrClear=nnfrPvcStatsErrPktsRxLastBootOrClear, nnfrPvcStatsPktsRxLastBootOrClear=nnfrPvcStatsPktsRxLastBootOrClear, nnfrCvcBundleName=nnfrCvcBundleName, nnfrAvcIpAddr=nnfrAvcIpAddr, nnfrPvcPolicingBe=nnfrPvcPolicingBe, nnmfrAckMsgMaxRetry=nnmfrAckMsgMaxRetry, nnfrStatsFramesRx=nnfrStatsFramesRx, nnfrLmiDteN392=nnfrLmiDteN392, nnfrAvcDlci=nnfrAvcDlci, nnfrAvcClassThreshold=nnfrAvcClassThreshold, nnmfrDiffDelay=nnmfrDiffDelay, nnfrPvcStatsUpDownStatesLastBootOrClear=nnfrPvcStatsUpDownStatesLastBootOrClear, nnfrCvcRowStatus=nnfrCvcRowStatus, nnfrAvcStatsBytesRxLastBootOrClear=nnfrAvcStatsBytesRxLastBootOrClear, nnfrStatsTableEntry=nnfrStatsTableEntry, nnfrStatsShortFramesRx=nnfrStatsShortFramesRx, nnfrPvcShapingBe=nnfrPvcShapingBe, nnfrPvcPolicingCir=nnfrPvcPolicingCir, nnfrAvcTableEntry=nnfrAvcTableEntry, nnfrAvcStatsUpDownStatesLastFiveMins=nnfrAvcStatsUpDownStatesLastFiveMins, nnfrLmiDceN393=nnfrLmiDceN393, nnfrAvcSegThreshold=nnfrAvcSegThreshold, nnfrTableEntry=nnfrTableEntry, nnfrPvcDlci=nnfrPvcDlci, nnfrPvcDlciForSwitching=nnfrPvcDlciForSwitching, nnmfrAckMsgTimer=nnmfrAckMsgTimer, nnfrLmiKeepalive=nnfrLmiKeepalive, nnfrAvcClass=nnfrAvcClass, nnfrEnablePvcAll=nnfrEnablePvcAll, nnfrPvcTable=nnfrPvcTable, PYSNMP_MODULE_ID=nnfrMib, nnfrAvcStatsPktsTxLastFiveMins=nnfrAvcStatsPktsTxLastFiveMins, nnfrPvcShapingBcMax=nnfrPvcShapingBcMax, nnfrPvcBundleNameForSwitching=nnfrPvcBundleNameForSwitching, nnfrStatsBECNsRx=nnfrStatsBECNsRx, nnfrPvcEnable=nnfrPvcEnable, nnfrPvcStatsBytesRxLastBootOrClear=nnfrPvcStatsBytesRxLastBootOrClear, nnfrAvcStatsBytesRxLastFiveMins=nnfrAvcStatsBytesRxLastFiveMins, nnfrAvcStatsPktsRxLastBootOrClear=nnfrAvcStatsPktsRxLastBootOrClear, nnfrAvcStatsPktsTxLastBootOrClear=nnfrAvcStatsPktsTxLastBootOrClear, nnfrMib=nnfrMib, nnfrAvcStatsErrPktsRxLastFiveMins=nnfrAvcStatsErrPktsRxLastFiveMins, nnfrPvcIpSubnetMask=nnfrPvcIpSubnetMask, nnfrLmiDceN392=nnfrLmiDceN392, nnfrPvcStatsTableEntry=nnfrPvcStatsTableEntry, nnfrAvcStatsTable=nnfrAvcStatsTable, nnfrStatsFECNsRx=nnfrStatsFECNsRx, nnfrAvcId=nnfrAvcId, nnfrPvcPolicingBc=nnfrPvcPolicingBc, nnfrPvcStatsPktsTxLastFiveMins=nnfrPvcStatsPktsTxLastFiveMins, nnfrPvcPolicingEnable=nnfrPvcPolicingEnable, nnfrAvcRemoteIpAddr=nnfrAvcRemoteIpAddr, nnfrAvcStatsErrPktsRxLastBootOrClear=nnfrAvcStatsErrPktsRxLastBootOrClear, nnfrStatsLongFramesRx=nnfrStatsLongFramesRx, nnfrCvcTableEntry=nnfrCvcTableEntry, nnfrPvcShapingCir=nnfrPvcShapingCir, nnfrAvcTotalBw=nnfrAvcTotalBw, nnmfrSegThreshold=nnmfrSegThreshold, nnfrCvcTable=nnfrCvcTable, nnfrStatsUnknownDLCIsRx=nnfrStatsUnknownDLCIsRx, nnmfrClassThreshold=nnmfrClassThreshold, nnfrAvcName=nnfrAvcName, nnfrAvcTable=nnfrAvcTable, nnfrCvcEnable=nnfrCvcEnable, nnfrAvcEnable=nnfrAvcEnable, nnfrPvcIpAddr=nnfrPvcIpAddr, nnfrAvcStatsPktsRxLastFiveMins=nnfrAvcStatsPktsRxLastFiveMins, nnfrAvcIpSubnetMask=nnfrAvcIpSubnetMask, nnfrPvcShapingBcMin=nnfrPvcShapingBcMin, nnfrPvcStatsPktsTxLastBootOrClear=nnfrPvcStatsPktsTxLastBootOrClear, nnfrLmiDteN391=nnfrLmiDteN391, nnfrAvcSequence=nnfrAvcSequence, nnfrAvcEnhancedMode=nnfrAvcEnhancedMode, nnfrAvcFragmentSize=nnfrAvcFragmentSize, nnfrTable=nnfrTable, nnfrPvcPolicingDe=nnfrPvcPolicingDe, nnfrPvcStatsTable=nnfrPvcStatsTable, nnfrAvcStatsBytesTxLastBootOrClear=nnfrAvcStatsBytesTxLastBootOrClear, nnfrLmiDteN393=nnfrLmiDteN393, nnfrStatsInvFramesRx=nnfrStatsInvFramesRx, nnmfrHelloTimer=nnmfrHelloTimer, nnfrLmiType=nnfrLmiType, nnfrAvcStatsBytesTxLastFiveMins=nnfrAvcStatsBytesTxLastFiveMins, nnfrPvcStatsBytesTxLastBootOrClear=nnfrPvcStatsBytesTxLastBootOrClear, nnfrPvcDescr=nnfrPvcDescr, nnfrAvcStatsTableEntry=nnfrAvcStatsTableEntry)
