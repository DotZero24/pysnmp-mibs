...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/nortel/FR-MIB
...
mibBuilder.exportSymbols("FR-MIB", nnfrAvcSegThreshold=nnfrAvcSegThreshold, nnfrCvcTableEntry=nnfrCvcTableEntry, nnfrLmiDceN392=nnfrLmiDceN392, nnfrPvcStatsUpDownStatesLastBootOrClear=nnfrPvcStatsUpDownStatesLastBootOrClear, nnfrStatsFramesRx=nnfrStatsFramesRx, nnfrEnablePvcAll=nnfrEnablePvcAll, PYSNMP_MODULE_ID=nnfrMib, nnfrStatsInvFramesRx=nnfrStatsInvFramesRx, nnfrCvcTable=nnfrCvcTable, nnmfrAckMsgTimer=nnmfrAckMsgTimer, nnfrStatsTableEntry=nnfrStatsTableEntry, nnfrStatsFramesTx=nnfrStatsFramesTx, nnfrAvcTableEntry=nnfrAvcTableEntry, nnfrStatsInvDLCIsRx=nnfrStatsInvDLCIsRx, nnfrPvcStatsBytesTxLastFiveMins=nnfrPvcStatsBytesTxLastFiveMins, nnfrStatsBECNsRx=nnfrStatsBECNsRx, nnfrPvcShapingCir=nnfrPvcShapingCir, nnmfrFrameSize=nnmfrFrameSize, nnfrPvcDescr=nnfrPvcDescr, nnfrPvcBundleNameForSwitching=nnfrPvcBundleNameForSwitching, nnfrPvcPolicingDe=nnfrPvcPolicingDe, nnfrPvcIpSubnetMask=nnfrPvcIpSubnetMask, nnfrPvcStatsErrPktsRxLastBootOrClear=nnfrPvcStatsErrPktsRxLastBootOrClear, nnfrPvcTableEntry=nnfrPvcTableEntry, nnfrAvcStatsTableEntry=nnfrAvcStatsTableEntry, nnfrLmiKeepalive=nnfrLmiKeepalive, nnfrStatsUnknownDLCIsRx=nnfrStatsUnknownDLCIsRx, nnfrPvcPolicingEnable=nnfrPvcPolicingEnable, nnfrPvcPolicingCir=nnfrPvcPolicingCir, nnfrCvcEnable=nnfrCvcEnable, nnfrAvcStatsBytesTxLastBootOrClear=nnfrAvcStatsBytesTxLastBootOrClear, nnfrPvcPolicingBc=nnfrPvcPolicingBc, nnfrPvcStatsBytesTxLastBootOrClear=nnfrPvcStatsBytesTxLastBootOrClear, nnfrStatsTable=nnfrStatsTable, nnfrAvcStatsPktsRxLastBootOrClear=nnfrAvcStatsPktsRxLastBootOrClear, nnfrIfEnable=nnfrIfEnable, nnfrFrameSize=nnfrFrameSize, nnfrPvcDlciForSwitching=nnfrPvcDlciForSwitching, nnfrPvcDlci=nnfrPvcDlci, nnfrPvcEnable=nnfrPvcEnable, nnfrPvcStatsPktsTxLastFiveMins=nnfrPvcStatsPktsTxLastFiveMins, nnfrPvcStatsTableEntry=nnfrPvcStatsTableEntry, nnfrPvcStatsUpDownStatesLastFiveMins=nnfrPvcStatsUpDownStatesLastFiveMins, nnfrPvcShapingBcMax=nnfrPvcShapingBcMax, nnfrStatsLongFramesRx=nnfrStatsLongFramesRx, nnfrAvcRowStatus=nnfrAvcRowStatus, nnfrLmiDteN391=nnfrLmiDteN391, nnfrAvcStatsTable=nnfrAvcStatsTable, nnmfrClassThreshold=nnmfrClassThreshold, nnmfrSegThreshold=nnmfrSegThreshold, nnfrAvcNoOfCvcs=nnfrAvcNoOfCvcs, nnfrAvcStatsErrPktsRxLastFiveMins=nnfrAvcStatsErrPktsRxLastFiveMins, nnfrAvcClass=nnfrAvcClass, nnfrPvcStatsPktsRxLastBootOrClear=nnfrPvcStatsPktsRxLastBootOrClear, nnfrPvcStatsBytesRxLastBootOrClear=nnfrPvcStatsBytesRxLastBootOrClear, nnfrTable=nnfrTable, nnfrAvcEnhancedMode=nnfrAvcEnhancedMode, nnfrLmiType=nnfrLmiType, nnfrAvcStatsBytesRxLastBootOrClear=nnfrAvcStatsBytesRxLastBootOrClear, nnfrPvcStatsBytesRxLastFiveMins=nnfrPvcStatsBytesRxLastFiveMins, nnfrPvcRowStatus=nnfrPvcRowStatus, nnfrTableEntry=nnfrTableEntry, nnfrAvcStatsBytesTxLastFiveMins=nnfrAvcStatsBytesTxLastFiveMins, nnfrAvcIpAddr=nnfrAvcIpAddr, nnfrMib=nnfrMib, nnmfrHelloTimer=nnmfrHelloTimer, nnfrAvcStatsPktsTxLastFiveMins=nnfrAvcStatsPktsTxLastFiveMins, nnfrAvcTable=nnfrAvcTable, nnmfrClass=nnmfrClass, nnfrPvcRemoteIpAddr=nnfrPvcRemoteIpAddr, nnfrPvcShapingBcMin=nnfrPvcShapingBcMin, nnfrCvcRowStatus=nnfrCvcRowStatus, nnfrPvcStatsPktsTxLastBootOrClear=nnfrPvcStatsPktsTxLastBootOrClear, nnfrIfType=nnfrIfType, nnfrLmiDteN393=nnfrLmiDteN393, nnfrPvcStatsPktsRxLastFiveMins=nnfrPvcStatsPktsRxLastFiveMins, nnmfrAckMsgMaxRetry=nnmfrAckMsgMaxRetry, nnfrAvcIpSubnetMask=nnfrAvcIpSubnetMask, nnfrAvcStatsPktsRxLastFiveMins=nnfrAvcStatsPktsRxLastFiveMins, nnfrCvcBundleName=nnfrCvcBundleName, nnfrAvcStatsUpDownStatesLastBootOrClear=nnfrAvcStatsUpDownStatesLastBootOrClear, nnfrPvcTable=nnfrPvcTable, nnfrAvcStatsUpDownStatesLastFiveMins=nnfrAvcStatsUpDownStatesLastFiveMins, nnfrLmiDceN393=nnfrLmiDceN393, nnfrStatsFECNsRx=nnfrStatsFECNsRx, nnfrAvcRemoteIpAddr=nnfrAvcRemoteIpAddr, nnfrAvcId=nnfrAvcId, nnmfrDiffDelay=nnmfrDiffDelay, nnfrAvcClassThreshold=nnfrAvcClassThreshold, nnfrPvcStatsErrPktsRxLastFiveMins=nnfrPvcStatsErrPktsRxLastFiveMins, nnfrAvcTotalBw=nnfrAvcTotalBw, nnfrAvcEnable=nnfrAvcEnable, nnfrPvcStatsTable=nnfrPvcStatsTable, nnfrAvcDlci=nnfrAvcDlci, nnfrPvcIpAddr=nnfrPvcIpAddr, nnfrAvcStatsPktsTxLastBootOrClear=nnfrAvcStatsPktsTxLastBootOrClear, nnfrPvcShapingBe=nnfrPvcShapingBe, nnfrAvcFragmentSize=nnfrAvcFragmentSize, nnfrAvcStatsBytesRxLastFiveMins=nnfrAvcStatsBytesRxLastFiveMins, nnfrAvcDiffDelay=nnfrAvcDiffDelay, nnfrAvcName=nnfrAvcName, nnfrAvcSequence=nnfrAvcSequence, nnfrLmiDteN392=nnfrLmiDteN392, nnfrPvcPolicingBe=nnfrPvcPolicingBe, nnfrStatsShortFramesRx=nnfrStatsShortFramesRx, nnfrAvcStatsErrPktsRxLastBootOrClear=nnfrAvcStatsErrPktsRxLastBootOrClear)
