...
mibBuilder.exportSymbols("DT-MIB", hpSwitchDtSystemISCProtocolState=hpSwitchDtSystemISCProtocolState, hpSwitchDtPeerKeepAliveInterval=hpSwitchDtPeerKeepAliveInterval, hpSwitchDtCompliances=hpSwitchDtCompliances, hpSwitchDtPeerKeepAliveDestUdpPort=hpSwitchDtPeerKeepAliveDestUdpPort, hpSwitchDtLacpLocalIfLacpEnable=hpSwitchDtLacpLocalIfLacpEnable, hpSwitchDtStats=hpSwitchDtStats, hpSwitchDtPeerKeepAliveVlanId=hpSwitchDtPeerKeepAliveVlanId, hpSwitchDtIscMACAgedPktsSent=hpSwitchDtIscMACAgedPktsSent, hpSwitchDtSystemAdminRolePriority=hpSwitchDtSystemAdminRolePriority, hpSwitchDtLacpStatusLocalEntry=hpSwitchDtLacpStatusLocalEntry, hpSwitchDtLacpStatus=hpSwitchDtLacpStatus, hpSwitchDtPeerKeepAliveStatsGroup=hpSwitchDtPeerKeepAliveStatsGroup, hpSwitchDtRemoteLacpGroup=hpSwitchDtRemoteLacpGroup, hpSwitchDtLacpPeerIfLacpStatus=hpSwitchDtLacpPeerIfLacpStatus, hpSwitchDtSystemOperRolePriority=hpSwitchDtSystemOperRolePriority, hpSwitchDtLacpLocalIfLacpStatus=hpSwitchDtLacpLocalIfLacpStatus, hpSwitchDtLacpLocalIfTrunkGroup=hpSwitchDtLacpLocalIfTrunkGroup, hpSwitchDtPeerKeepAliveConfig=hpSwitchDtPeerKeepAliveConfig, hpSwitchDtPeerKeepAliveTimeout=hpSwitchDtPeerKeepAliveTimeout, hpSwitchDtIscMACAgedPktsRecv=hpSwitchDtIscMACAgedPktsRecv, hpSwitchDtLacpStatusLocalTable=hpSwitchDtLacpStatusLocalTable, hpSwitchDtGroups=hpSwitchDtGroups, hpSwitchDtPeerKeepAliveGroup=hpSwitchDtPeerKeepAliveGroup, hpSwitchDtIscStatsGroup=hpSwitchDtIscStatsGroup, hpSwitchDtCompliance1=hpSwitchDtCompliance1, hpSwitchDtLacpLocalIfIndex=hpSwitchDtLacpLocalIfIndex, hpSwitchDtConformance=hpSwitchDtConformance, hpSwitchDtCompliance=hpSwitchDtCompliance, hpSwitchDtLacpPeerIfTrunkGroup=hpSwitchDtLacpPeerIfTrunkGroup, hpSwitchDtLacpPeerIfLacpPartner=hpSwitchDtLacpPeerIfLacpPartner, PYSNMP_MODULE_ID=hpSwitchDt, hpSwitchDtLacpPeerIfLacpPortStatus=hpSwitchDtLacpPeerIfLacpPortStatus, hpSwitchDtLacpStatusPeerTable=hpSwitchDtLacpStatusPeerTable, hpSwitchDtPeerKeepAliveStats=hpSwitchDtPeerKeepAliveStats, hpConfig=hpConfig, hpSwitchDtSystemRole=hpSwitchDtSystemRole, hpSwitchDtLacpPeerIfLacpEnable=hpSwitchDtLacpPeerIfLacpEnable, hpSwitchDtLacpLocalIfLacpAdminKey=hpSwitchDtLacpLocalIfLacpAdminKey, hpSwitchDtPeerKeepAliveDestAddressType=hpSwitchDtPeerKeepAliveDestAddressType, hpSwitchDtLacpStatusPeerEntry=hpSwitchDtLacpStatusPeerEntry, hpSwitchDtIscProtocolStats=hpSwitchDtIscProtocolStats, hpSwitchDtSystemInfo=hpSwitchDtSystemInfo, hpSwitchDtLacpLocalIfLacpPortStatus=hpSwitchDtLacpLocalIfLacpPortStatus, hpSwitchDtIscHelloPktsRecv=hpSwitchDtIscHelloPktsRecv, hpSwitchDtSystemDtLacpSystemID=hpSwitchDtSystemDtLacpSystemID, hpSwitchDtSystemPeerOperRolePriority=hpSwitchDtSystemPeerOperRolePriority, hpSwitchDtLocalLacpGroup=hpSwitchDtLocalLacpGroup, hpSwitchDtLacpLocalIfName=hpSwitchDtLacpLocalIfName, hpSwitchDtConfig=hpSwitchDtConfig, hpSwitchDtPeerKeepAlivePktsRecv=hpSwitchDtPeerKeepAlivePktsRecv, hpSwitchDtIscGroup=hpSwitchDtIscGroup, hpSwitchISCPortIndex=hpSwitchISCPortIndex, hpSwitchDtPeerKeepAliveDestAddress=hpSwitchDtPeerKeepAliveDestAddress, hpSwitchDt=hpSwitchDt, hpSwitchDtIscHelloPktsSent=hpSwitchDtIscHelloPktsSent, hpSwitchDtIscMACLearnPktsRecv=hpSwitchDtIscMACLearnPktsRecv, hpSwitchConfig=hpSwitchConfig, hpSwitchDtLacpLocalIfLacpPartner=hpSwitchDtLacpLocalIfLacpPartner, hpSwitchDtLacpPeerIfIndex=hpSwitchDtLacpPeerIfIndex, hpSwitchDtPeerKeepAliveHoldTime=hpSwitchDtPeerKeepAliveHoldTime, hpSwitchRemoteISCPortIndex=hpSwitchRemoteISCPortIndex, hpSwitchDtLacpPeerIfName=hpSwitchDtLacpPeerIfName, hpSwitchDtPeerKeepAlivePktsSent=hpSwitchDtPeerKeepAlivePktsSent, hpSwitchDtSystemInfoGroup=hpSwitchDtSystemInfoGroup, hpSwitchDtIscMACLearnPktsSent=hpSwitchDtIscMACLearnPktsSent, hpSwitchDtLacpLocalIfLacpOperKey=hpSwitchDtLacpLocalIfLacpOperKey)
