...
h3cAFCLeaf=_H3cAFCLeaf_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,85,1))
_H3cDDosAttackTargetIP_Type=IpAddress
_H3cDDosAttackTargetIP_Object=MibScalar
h3cDDosAttackTargetIP=_H3cDDosAttackTargetIP_Object((1,3,6,1,4,1,43,45,1,10,2,85,1,1),_H3cDDosAttackTargetIP_Type())
...
h3cDDosAttackType=_H3cDDosAttackType_Object((1,3,6,1,4,1,43,45,1,10,2,85,1,2),_H3cDDosAttackType_Type())
...
h3cDDosAttackPolicy=_H3cDDosAttackPolicy_Object((1,3,6,1,4,1,43,45,1,10,2,85,1,3),_H3cDDosAttackPolicy_Type())
...
h3cDDosAttackThreshold=_H3cDDosAttackThreshold_Object((1,3,6,1,4,1,43,45,1,10,2,85,1,4),_H3cDDosAttackThreshold_Type())
...
h3cDDosAttackSpeed=_H3cDDosAttackSpeed_Object((1,3,6,1,4,1,43,45,1,10,2,85,1,5),_H3cDDosAttackSpeed_Type())
...
h3cAFCNotify=_H3cAFCNotify_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,85,2))
_H3cAFCNotifyPrefix_ObjectIdentity=ObjectIdentity
h3cAFCNotifyPrefix=_H3cAFCNotifyPrefix_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,85,2,0))
h3cDDosAttackStart=NotificationType((1,3,6,1,4,1,43,45,1,10,2,85,2,0,1))
h3cDDosAttackStart.setObjects(*((_B,_D),(_B,_G),(_B,_H),(_B,_I),(_B,_J)))
if mibBuilder.loadTexts:h3cDDosAttackStart.setStatus(_A)
h3cDDosAttackEnd=NotificationType((1,3,6,1,4,1,43,45,1,10,2,85,2,0,2))
