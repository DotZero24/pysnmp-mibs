...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/TOKENRING-MIB
...
ModuleIdentity, transmission, Counter64, ObjectIdentity, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "transmission", "Counter64", "ObjectIdentity", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("TOKENRING-MIB", dot5StatsLineErrors=dot5StatsLineErrors, dot5StatsRecoverys=dot5StatsRecoverys, dot5LastBeaconSent=dot5LastBeaconSent, dot5RingStatus=dot5RingStatus, dot5TimerStandbyMon=dot5TimerStandbyMon, dot5ChipSets=dot5ChipSets, PYSNMP_MODULE_ID=dot5, dot5StatsIfIndex=dot5StatsIfIndex, dot5Table=dot5Table, dot5StatsTransmitBeacons=dot5StatsTransmitBeacons, dot5Compliance=dot5Compliance, dot5StatsACErrors=dot5StatsACErrors, dot5StatsTable=dot5StatsTable, dot5RingState=dot5RingState, dot5Groups=dot5Groups, dot5TimerNoToken=dot5TimerNoToken, dot5TimerReturnRepeat=dot5TimerReturnRepeat, dot5UpStream=dot5UpStream, dot5RingOpenStatus=dot5RingOpenStatus, dot5StateGroup=dot5StateGroup, dot5ChipSetTItms380=dot5ChipSetTItms380, dot5StatsGroup=dot5StatsGroup, dot5StatsRemoves=dot5StatsRemoves, dot5TimerBeaconReceive=dot5TimerBeaconReceive, dot5StatsFrameCopiedErrors=dot5StatsFrameCopiedErrors, dot5TimerQueuePDU=dot5TimerQueuePDU, dot5ChipSetIBM16=dot5ChipSetIBM16, dot5=dot5, dot5StatsHardErrors=dot5StatsHardErrors, dot5StatsSingles=dot5StatsSingles, dot5Functional=dot5Functional, dot5TimerActiveMon=dot5TimerActiveMon, dot5StatsLobeWires=dot5StatsLobeWires, dot5TimerHolding=dot5TimerHolding, dot5TestInsertFunc=dot5TestInsertFunc, dot5TimerEntry=dot5TimerEntry, dot5Commands=dot5Commands, dot5StatsInternalErrors=dot5StatsInternalErrors, dot5StatsBurstErrors=dot5StatsBurstErrors, dot5IfIndex=dot5IfIndex, dot5TimerIfIndex=dot5TimerIfIndex, dot5StatsLostFrameErrors=dot5StatsLostFrameErrors, dot5StatsReceiveCongestions=dot5StatsReceiveCongestions, dot5StatsSoftErrors=dot5StatsSoftErrors, dot5TimerTable=dot5TimerTable, dot5StatsTokenErrors=dot5StatsTokenErrors, dot5StatsAbortTransErrors=dot5StatsAbortTransErrors, dot5StatsSignalLoss=dot5StatsSignalLoss, dot5Tests=dot5Tests, dot5TestFullDuplexLoopBack=dot5TestFullDuplexLoopBack, dot5ActMonParticipate=dot5ActMonParticipate, dot5Compliances=dot5Compliances, dot5StatsFreqErrors=dot5StatsFreqErrors, dot5RingSpeed=dot5RingSpeed, dot5StatsEntry=dot5StatsEntry, dot5ChipSetTItms380c16=dot5ChipSetTItms380c16, dot5Conformance=dot5Conformance, dot5TimerBeaconTransmit=dot5TimerBeaconTransmit, dot5TimerErrorReport=dot5TimerErrorReport, dot5Entry=dot5Entry, dot5TimerValidTransmit=dot5TimerValidTransmit)
