...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:48:22 2025
...
mibBuilder.exportSymbols("TOKENRING-MIB", dot5StatsLobeWires=dot5StatsLobeWires, dot5LastBeaconSent=dot5LastBeaconSent, dot5ChipSets=dot5ChipSets, dot5TestFullDuplexLoopBack=dot5TestFullDuplexLoopBack, dot5StatsTable=dot5StatsTable, dot5StatsACErrors=dot5StatsACErrors, dot5TimerEntry=dot5TimerEntry, dot5StatsGroup=dot5StatsGroup, dot5TimerNoToken=dot5TimerNoToken, dot5ChipSetIBM16=dot5ChipSetIBM16, dot5TimerIfIndex=dot5TimerIfIndex, dot5Table=dot5Table, dot5RingSpeed=dot5RingSpeed, dot5StatsSingles=dot5StatsSingles, dot5UpStream=dot5UpStream, dot5StatsTokenErrors=dot5StatsTokenErrors, dot5Functional=dot5Functional, dot5TimerErrorReport=dot5TimerErrorReport, dot5StatsLostFrameErrors=dot5StatsLostFrameErrors, dot5TimerQueuePDU=dot5TimerQueuePDU, PYSNMP_MODULE_ID=dot5, dot5TimerTable=dot5TimerTable, dot5StatsEntry=dot5StatsEntry, dot5StatsFrameCopiedErrors=dot5StatsFrameCopiedErrors, dot5Entry=dot5Entry, dot5TimerActiveMon=dot5TimerActiveMon, dot5Tests=dot5Tests, dot5StatsLineErrors=dot5StatsLineErrors, dot5StatsTransmitBeacons=dot5StatsTransmitBeacons, dot5StatsFreqErrors=dot5StatsFreqErrors, dot5TimerHolding=dot5TimerHolding, dot5TestInsertFunc=dot5TestInsertFunc, dot5StatsBurstErrors=dot5StatsBurstErrors, dot5Compliances=dot5Compliances, dot5Compliance=dot5Compliance, dot5StatsSignalLoss=dot5StatsSignalLoss, dot5StatsReceiveCongestions=dot5StatsReceiveCongestions, dot5Commands=dot5Commands, dot5RingState=dot5RingState, dot5TimerStandbyMon=dot5TimerStandbyMon, dot5Groups=dot5Groups, dot5IfIndex=dot5IfIndex, dot5StatsSoftErrors=dot5StatsSoftErrors, dot5StatsAbortTransErrors=dot5StatsAbortTransErrors, dot5ActMonParticipate=dot5ActMonParticipate, dot5StatsIfIndex=dot5StatsIfIndex, dot5StateGroup=dot5StateGroup, dot5StatsRemoves=dot5StatsRemoves, dot5RingStatus=dot5RingStatus, dot5TimerValidTransmit=dot5TimerValidTransmit, dot5TimerReturnRepeat=dot5TimerReturnRepeat, dot5=dot5, dot5TimerBeaconReceive=dot5TimerBeaconReceive, dot5StatsHardErrors=dot5StatsHardErrors, dot5StatsInternalErrors=dot5StatsInternalErrors, dot5Conformance=dot5Conformance, dot5RingOpenStatus=dot5RingOpenStatus, dot5TimerBeaconTransmit=dot5TimerBeaconTransmit, dot5ChipSetTItms380=dot5ChipSetTItms380, dot5ChipSetTItms380c16=dot5ChipSetTItms380c16, dot5StatsRecoverys=dot5StatsRecoverys)
