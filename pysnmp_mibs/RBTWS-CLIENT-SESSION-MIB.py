...
# Notes
# -----
# ASN.1 source file://mibs/cabletron/RBTWS-CLIENT-SESSION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:54:25 2025
...
rbtwsClientSessionCompliance.setObjects(
    ("RBTWS-CLIENT-SESSION-MIB", "rbtwsClientSessionCommonGroup")
)
if mibBuilder.loadTexts:
...
rbtwsClientSessionComplianceRev2.setObjects(
      *(("RBTWS-CLIENT-SESSION-MIB", "rbtwsClientSessScalarsGroup"),
        ("RBTWS-CLIENT-SESSION-MIB", "rbtwsClientSessClientSessionTableGroup"),
        ("RBTWS-CLIENT-SESSION-MIB", "rbtwsClientSessRoamingHistoryTableGroup"),
...
rbtwsClientSessionComplianceRev3.setObjects(
      *(("RBTWS-CLIENT-SESSION-MIB", "rbtwsClientSessScalarsGroup"),
        ("RBTWS-CLIENT-SESSION-MIB", "rbtwsClientSessClientSessionTableGroupRev2"),
        ("RBTWS-CLIENT-SESSION-MIB", "rbtwsClientSessRoamingHistoryTableGroupRev2"),
        ("RBTWS-CLIENT-SESSION-MIB", "rbtwsClientSessClientSessionStatisticsTableGroup"))
)
if mibBuilder.loadTexts:
