# SNMP MIB module (ZTE-AN-TC-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/zte/ZTE-AN-TC-MIB
...
zxAnTcMib = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 3902, 1015, 200)
)
if mibBuilder.loadTexts:
    zxAnTcMib.setRevisions(
        ("2006-05-18 14:00",)
    )
...
mibBuilder.exportSymbols(
    "ZTE-AN-TC-MIB",
    **{"VlanId": VlanId,
       "ZxAnIfindex": ZxAnIfindex,
       "ZxAnPortList": ZxAnPortList,
       "ZxAnIdList": ZxAnIdList,
       "zte": zte,
       "zxAn": zxAn,
       "zxAnTcMib": zxAnTcMib}
)
