...
mibBuilder.exportSymbols("CYCLADES-ACS-CONF-MIB", cySPortDCDCtrl=cySPortDCDCtrl, cyEthIPaddr2=cyEthIPaddr2, cySPortPmUsers=cySPortPmUsers, cySerialDBFacility=cySerialDBFacility, cySPortSniffAdm=cySPortSniffAdm, cySPortSysBufSess=cySPortSysBufSess, cySPortSocketPort=cySPortSocketPort, cySPortAuthSrv2=cySPortAuthSrv2, cySPortAuthAcc=cySPortAuthAcc, cySPortProtocol=cySPortProtocol, cyResolverOrder=cyResolverOrder, cySPortPppOptions=cySPortPppOptions, cySPortAuthSrv1=cySPortAuthSrv1, cyNameService=cyNameService, cySPortPppFoption=cySPortPppFoption, cyACSConf=cyACSConf, cyEthIPmask2=cyEthIPmask2, cySPortAutoOutput=cySPortAutoOutput, cySPortStopBits=cySPortStopBits, cySPortBanner=cySPortBanner, cySPortSockPoll=cySPortSockPoll, cySPortDBtime=cySPortDBtime, cyMotd=cyMotd, cySerialPortTable=cySerialPortTable, cyDNSpriserv=cyDNSpriserv, cySPortAutoInput=cySPortAutoInput, cySPortDBsize=cySPortDBsize, cyEthIPaddr=cyEthIPaddr, cySPortTty=cySPortTty, cySerialLockDir=cySerialLockDir, cySPortLogUtmp=cySPortLogUtmp, cySPortBreakInterval=cySPortBreakInterval, cySPortSttyCmd=cySPortSttyCmd, cySPortPmOutlet=cySPortPmOutlet, cySerialGroupTable=cySerialGroupTable, cyGroupUsers=cyGroupUsers, cySerialRlogin=cySerialRlogin, cySerialSsh=cySerialSsh, cySerialInclude=cySerialInclude, cySPortDBalarm=cySPortDBalarm, cySPortPrompt=cySPortPrompt, cyEthItf=cyEthItf, cySerialNFS=cySerialNFS, cySPortPppMtu=cySPortPppMtu, cysportEntry=cysportEntry, cySPortLogWtmp=cySPortLogWtmp, cySPortDBmenu=cySPortDBmenu, cySPortRemoteIP=cySPortRemoteIP, cySPortDataSize=cySPortDataSize, cySPortDTRdelay=cySPortDTRdelay, cySPortSpeed=cySPortSpeed, cyDNSsecserv=cyDNSsecserv, cySPortRemHost=cySPortRemHost, cyEthIPmask=cyEthIPmask, cySPortNetMask=cySPortNetMask, cySPortAuthRadP=cySPortAuthRadP, cyGroupName=cyGroupName, cySerialPortConf=cySerialPortConf, cySPortDBmode=cySPortDBmode, cyMultipleIP=cyMultipleIP, cySerialPppd=cySerialPppd, cyGroupIndex=cyGroupIndex, cySPortLFSuppress=cySPortLFSuppress, cySPortPmKey=cySPortPmKey, cySPortAuthSecret=cySPortAuthSecret, cySPortAccSrv1=cySPortAccSrv1, cySerialLocalLogins=cySerialLocalLogins, cyConsoleBanner=cyConsoleBanner, cySPortPmNOutlets=cySPortPmNOutlets, cySerialFacility=cySerialFacility, cySPortAuthRetr=cySPortAuthRetr, cySPortAuthtype=cySPortAuthtype, cySPortPmType=cySPortPmType, cyEthMTU=cyEthMTU, cySPortModemChat=cySPortModemChat, cySerialGlobal=cySerialGlobal, cyHostName=cyHostName, cySPortSSHbreak=cySPortSSHbreak, cySPortAccSrv2=cySPortAccSrv2, cygroupEntry=cygroupEntry, cySPortName=cySPortName, cySerialTelnet=cySerialTelnet, cySPortLogform=cySPortLogform, cySPortPppMru=cySPortPppMru, cySPortSockTx=cySPortSockTx, cySPortAuthTmo=cySPortAuthTmo, cyDNSdomain=cyDNSdomain, cySPortAutomUsr=cySPortAutomUsr, PYSNMP_MODULE_ID=cyACSConf, cySPortNumber=cySPortNumber, cySPortSniffMsess=cySPortSniffMsess, cySerialSpec=cySerialSpec, cySPortFlowCtrl=cySPortFlowCtrl, cyDNSserv=cyDNSserv, cySPortSniffSess=cySPortSniffSess, cySPortSniffEsc=cySPortSniffEsc, cyEthDhcpc=cyEthDhcpc, cySPortDBsyslog=cySPortDBsyslog, cySPortParity=cySPortParity, cySPortTelnetMode=cySPortTelnetMode, cySPortSockIdle=cySPortSockIdle, cySPortTermType=cySPortTermType)
