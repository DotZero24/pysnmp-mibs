...
# Notes
# -----
# ASN.1 source file://mibs/rfc/FRNETSERV-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:22:19 2025
...
frnetservCompliance.setObjects(
      *(("FRNETSERV-MIB", "frnetservLportGroup"),
        ("FRNETSERV-MIB", "frnetservMgtVCSigGroup"),
        ("FRNETSERV-MIB", "frnetservPVCEndptGroup"),
        ("FRNETSERV-MIB", "frnetservPVCConnectGroup"),
        ("FRNETSERV-MIB", "frnetservAccountPVCGroup"),
...
frnetservCompliance2.setObjects(
      *(("FRNETSERV-MIB", "frnetservLportGroup2"),
        ("FRNETSERV-MIB", "frnetservMgtVCSigGroup"),
        ("FRNETSERV-MIB", "frnetservPVCEndptGroup"),
        ("FRNETSERV-MIB", "frnetservPVCEndptGroup2"),
        ("FRNETSERV-MIB", "frnetservPVCConnectGroup"),
        ("FRNETSERV-MIB", "frnetservPVCConnectNamesGroup"),
        ("FRNETSERV-MIB", "frnetservPVCNotifGroup2"),
        ("FRNETSERV-MIB", "frnetservAccountPVCGroup"),
        ("FRNETSERV-MIB", "frnetservAccountLportGroup"))
)
if mibBuilder.loadTexts:
...
frnetSwitchCompliance.setObjects(
      *(("FRNETSERV-MIB", "frnetservLportGroup2"),
        ("FRNETSERV-MIB", "frnetservLportAdminGroup"),
        ("FRNETSERV-MIB", "frnetservMgtVCSigGroup"),
        ("FRNETSERV-MIB", "frnetservMgtVCSigAdminGroup"),
        ("FRNETSERV-MIB", "frnetservPVCEndptGroup"),
        ("FRNETSERV-MIB", "frnetservPVCEndptGroup2"),
        ("FRNETSERV-MIB", "frnetservPVCConnectGroup"),
        ("FRNETSERV-MIB", "frnetservPVCConnectNamesGroup"),
