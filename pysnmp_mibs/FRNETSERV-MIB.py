...
mibBuilder.exportSymbols("FRNETSERV-MIB", frLportVCSigProtocol=frLportVCSigProtocol, frPVCEndptOutBc=frPVCEndptOutBc, frPVCEndptInDEFrames=frPVCEndptInDEFrames, frPVCEndptDLCIIndex=frPVCEndptDLCIIndex, frAccountLportTable=frAccountLportTable, frMgtVCSigNetLinkRelErrors=frMgtVCSigNetLinkRelErrors, frnetservLportGroup2=frnetservLportGroup2, frLportFragSize=frLportFragSize, frnetservAccountLportGroup=frnetservAccountLportGroup, frPVCEndptInBe=frPVCEndptInBe, frLportVCSigProtocolAdmin=frLportVCSigProtocolAdmin, frMgtVCSigNetN393=frMgtVCSigNetN393, frMgtVCSigUserChanInactive=frMgtVCSigUserChanInactive, frPVCEndptOutMaxFrameSize=frPVCEndptOutMaxFrameSize, frnetservCompliance2=frnetservCompliance2, frPVCEndptOutCongDiscards=frPVCEndptOutCongDiscards, frPVCEndptAtmIwfConnIndex=frPVCEndptAtmIwfConnIndex, frPVCEndptOutDEFrames=frPVCEndptOutDEFrames, frLportNumPlan=frLportNumPlan, frMgtVCSigNetT392=frMgtVCSigNetT392, frPVCConnectL2hOperStatus=frPVCConnectL2hOperStatus, frnetservLportGroup=frnetservLportGroup, frAccountLportInSegments=frAccountLportInSegments, frMgtVCSigUserT391=frMgtVCSigUserT391, frLportTypeAdmin=frLportTypeAdmin, frnetservTraps=frnetservTraps, frLportAddrDLCILen=frLportAddrDLCILen, frPVCEndptOutFramesBECNSet=frPVCEndptOutFramesBECNSet, frPVCEndptOutFramesFECNSet=frPVCEndptOutFramesFECNSet, frLportDLCIIndexValue=frLportDLCIIndexValue, frPVCEndptInDiscards=frPVCEndptInDiscards, frLportType=frLportType, frMgtVCSigUserT391Admin=frMgtVCSigUserT391Admin, frPVCConnectH2lLastChange=frPVCConnectH2lLastChange, frMgtVCSigNetProtErrors=frMgtVCSigNetProtErrors, frnetservMgtVCSigGroup=frnetservMgtVCSigGroup, frLportVCSigPointer=frLportVCSigPointer, frAccountLportEntry=frAccountLportEntry, frMgtVCSigNetChanInactive=frMgtVCSigNetChanInactive, frAccountLportSegmentSize=frAccountLportSegmentSize, frPVCEndptOutFrames=frPVCEndptOutFrames, frMgtVCSigUserN392=frMgtVCSigUserN392, frPVCConnectHighIfIndex=frPVCConnectHighIfIndex, frPVCEndptInFramesBECNSet=frPVCEndptInFramesBECNSet, frPVCConnectAdminStatus=frPVCConnectAdminStatus, frPVCConnectEntry=frPVCConnectEntry, frPVCEndptInExcessFrames=frPVCEndptInExcessFrames, frMgtVCSigUserN391Admin=frMgtVCSigUserN391Admin, frMgtVCSigNetN393Admin=frMgtVCSigNetN393Admin, frPVCEndptRcvdSigStatus=frPVCEndptRcvdSigStatus, frnetservGroups=frnetservGroups, frPVCEndptInCIR=frPVCEndptInCIR, frPVCConnectL2hLastChange=frPVCConnectL2hLastChange, frnetservConformance=frnetservConformance, frLportEntry=frLportEntry, frPVCEndptOutBe=frPVCEndptOutBe, frAccountPVCSegmentSize=frAccountPVCSegmentSize, frnetservPVCEndptGroup2=frnetservPVCEndptGroup2, frPVCConnectTable=frPVCConnectTable, frPVCEndptInFrames=frPVCEndptInFrames, PYSNMP_MODULE_ID=frnetservMIB, frPVCEndptInDECongDiscards=frPVCEndptInDECongDiscards, frMgtVCSigNetnT3Admin=frMgtVCSigNetnT3Admin, frnetservPVCNotifGroup=frnetservPVCNotifGroup, frMgtVCSigUserLinkRelErrors=frMgtVCSigUserLinkRelErrors, frPVCEndptRowStatus=frPVCEndptRowStatus, frLportTable=frLportTable, frnetservPVCEndptGroup=frnetservPVCEndptGroup, frnetservMgtVCSigAdminGroup=frnetservMgtVCSigAdminGroup, frPVCEndptInFramesFECNSet=frPVCEndptInFramesFECNSet, frPVCEndptOutCIR=frPVCEndptOutCIR, frMgtVCSigEntry=frMgtVCSigEntry, frAccountPVCTable=frAccountPVCTable, frPVCEndptConnectIdentifier=frPVCEndptConnectIdentifier, frnetservLportAdminGroup=frnetservLportAdminGroup, frMgtVCSigNetN392=frMgtVCSigNetN392, frPVCConnectRowStatus=frPVCConnectRowStatus, frPVCConnectHighDLCIIndex=frPVCConnectHighDLCIIndex, frMgtVCSigTable=frMgtVCSigTable, frnetservPVCConnectNamesGroup=frnetservPVCConnectNamesGroup, frPVCConnectIndex=frPVCConnectIndex, frnetservCompliances=frnetservCompliances, frnetservCompliance=frnetservCompliance, frPVCEndptEntry=frPVCEndptEntry, frMgtVCSigUserN393=frMgtVCSigUserN393, frMgtVCSigUserN393Admin=frMgtVCSigUserN393Admin, frPVCConnectUserName=frPVCConnectUserName, frAccountPVCEntry=frAccountPVCEntry, frnetservTrapsPrefix=frnetservTrapsPrefix, frPVCConnectIndexValue=frPVCConnectIndexValue, frPVCEndptOutOctets=frPVCEndptOutOctets, frPVCEndptOutDECongDiscards=frPVCEndptOutDECongDiscards, frPVCEndptTable=frPVCEndptTable, frPVCConnectStatusNotif=frPVCConnectStatusNotif, frPVCEndptInDiscardsDESet=frPVCEndptInDiscardsDESet, frMgtVCSigProced=frMgtVCSigProced, frPVCConnectLowDLCIIndex=frPVCConnectLowDLCIIndex, frMgtVCSigProcedAdmin=frMgtVCSigProcedAdmin, frLportFragControl=frLportFragControl, frMgtVCSigNetnT3=frMgtVCSigNetnT3, frPVCEndptInBc=frPVCEndptInBc, frnetSwitchCompliance=frnetSwitchCompliance, frAccountPVCInSegments=frAccountPVCInSegments, frMgtVCSigNetT392Admin=frMgtVCSigNetT392Admin, frPVCConnectH2lOperStatus=frPVCConnectH2lOperStatus, frnetservObjects=frnetservObjects, frMgtVCSigNetN392Admin=frMgtVCSigNetN392Admin, frPVCConnectLowIfIndex=frPVCConnectLowIfIndex, frPVCEndptInCongDiscards=frPVCEndptInCongDiscards, frMgtVCSigNetnN4=frMgtVCSigNetnN4, frAccountLportOutSegments=frAccountLportOutSegments, frnetservAccountPVCGroup=frnetservAccountPVCGroup, frPVCEndptOutExcessFrames=frPVCEndptOutExcessFrames, frPVCEndptInOctets=frPVCEndptInOctets, frAccountPVCOutSegments=frAccountPVCOutSegments, frPVCConnectStatusChange=frPVCConnectStatusChange, frnetservPVCConnectGroup=frnetservPVCConnectGroup, frnetservPVCNotifGroup2=frnetservPVCNotifGroup2, frLportLocation=frLportLocation, frnetservMIB=frnetservMIB, frLportContact=frLportContact, frPVCEndptInMaxFrameSize=frPVCEndptInMaxFrameSize, frAccountPVCDLCIIndex=frAccountPVCDLCIIndex, frMgtVCSigUserProtErrors=frMgtVCSigUserProtErrors, frPVCConnectProviderName=frPVCConnectProviderName, frMgtVCSigUserN391=frMgtVCSigUserN391, frMgtVCSigUserN392Admin=frMgtVCSigUserN392Admin)
