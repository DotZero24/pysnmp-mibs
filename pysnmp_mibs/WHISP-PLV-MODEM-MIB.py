...
# Notes
# -----
# ASN.1 source file://mibs/cambium/WHISP-PLV-MODEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:07:37 2025
...
whispPlvModemCompliance.setObjects(
      *(("WHISP-PLV-MODEM-MIB", "whispPlvModemInfoGroup"),
        ("WHISP-PLV-MODEM-MIB", "whispPlvModemConfigGroup"),
        ("WHISP-PLV-MODEM-MIB", "whispPlvModemTrapConfigGroup"),
        ("WHISP-PLV-MODEM-MIB", "whispPlvModemAdmConfigGroup"),
        ("WHISP-PLV-MODEM-MIB", "whispPlvModemAdmWConfigGroup"),
        ("WHISP-PLV-MODEM-MIB", "whispPlvModemAdmSnmpAcessConfigGroup"),
        ("WHISP-PLV-MODEM-MIB", "whispPlvModemNotificationsGroup"),
        ("WHISP-PLV-MODEM-MIB", "whispPlvModemAdmRepeaterConfigGroup"),
        ("WHISP-PLV-MODEM-MIB", "whispPlvModemAdmVLANConfigGroup"))
)
if mibBuilder.loadTexts:
