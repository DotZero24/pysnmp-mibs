...
mibBuilder.exportSymbols("LEXMARK-PVT-MIB", lexipxNumPorts=lexipxNumPorts, lexipxTrapNetworkAddress=lexipxTrapNetworkAddress, opsysROMType=opsysROMType, opsysProtocols=opsysProtocols, fax=fax, time=time, lextcpNPAPserversTable=lextcpNPAPserversTable, prtgen=prtgen, lexhdwrPortTableParm9=lexhdwrPortTableParm9, lexhdwrPortTableParm4=lexhdwrPortTableParm4, lexipxConnSrvrConnNum=lexipxConnSrvrConnNum, opsysCodeRev=opsysCodeRev, lexipxPortInfoPollIntvl=lexipxPortInfoPollIntvl, lextrapDestNum=lextrapDestNum, prtgenStatusEntry=prtgenStatusEntry, lextcpActivated=lextcpActivated, prtgenFamilyID=prtgenFamilyID, lexipxTrapNodeAddress=lexipxTrapNodeAddress, printer=printer, lexhdwrPortTableParm7=lexhdwrPortTableParm7, lexipxServerMode=lexipxServerMode, prtgenStatPrinterIndex=prtgenStatPrinterIndex, lexipxConnSrvrPSConnID=lexipxConnSrvrPSConnID, opsysAdapterName=opsysAdapterName, lexhttpLinkTableIndex=lexhttpLinkTableIndex, lextcpAddressServ=lextcpAddressServ, lexhttpLinkTable=lexhttpLinkTable, opsysCurrentJobTable=opsysCurrentJobTable, lextcpNumNPAPservers=lextcpNumNPAPservers, faxTable=faxTable, lextcpBootpEnable=lextcpBootpEnable, prtgenStatusWarming=prtgenStatusWarming, lexipxConnSrvrIndex=lexipxConnSrvrIndex, timeUTCOffset=timeUTCOffset, prtgenStatusBusy=prtgenStatusBusy, lextalkAddress=lextalkAddress, lexipxTrapTable=lexipxTrapTable, lexmacLAA=lexmacLAA, lexipxConnSrvrName=lexipxConnSrvrName, lexipxTrapMask=lexipxTrapMask, prtgenStatusDiskError=prtgenStatusDiskError, opsysAdapterCapabilities=opsysAdapterCapabilities, lexlinkActivated=lexlinkActivated, lextrapDestMask=lextrapDestMask, lexipxSAPMode=lexipxSAPMode, faxSelectedCapabilities=faxSelectedCapabilities, opsysCurrentJobString=opsysCurrentJobString, lexhdwrPortTableType=lexhdwrPortTableType, lexhttpLinkTableLabel=lexhttpLinkTableLabel, lexmacUAA=lexmacUAA, lexhttpNumLinks=lexhttpNumLinks, prtgenResValue=prtgenResValue, lexhttpLinkTableStatus=lexhttpLinkTableStatus, lexhdwrPortTableParm6=lexhdwrPortTableParm6, timeSource=timeSource, lexhdwrPortTableParm8=lexhdwrPortTableParm8, lextrapDestIPAddr=lextrapDestIPAddr, pgTotal=pgTotal, prtgenSerialNo=prtgenSerialNo, irPaperJam=irPaperJam, pgMono=pgMono, irOffline=irOffline, lexhdwrNumPorts=lexhdwrNumPorts, lexipxConnSrvrConnId=lexipxConnSrvrConnId, prtgenStatusOutHopFull=prtgenStatusOutHopFull, prtgenNumber=prtgenNumber, lexhttpLinkTableURL=lexhttpLinkTableURL, prtgenCodeRevision=prtgenCodeRevision, lexipxPortInfoEnable=lexipxPortInfoEnable, lexhttpLinkTableEntry=lexhttpLinkTableEntry, lexipxTrapType=lexipxTrapType, lexdhcpRarpEnable=lexdhcpRarpEnable, lextrapIPTrapType=lextrapIPTrapType, lexhttpEnable=lexhttpEnable, lexmacSpeed=lexmacSpeed, lextalkName=lextalkName, opsysDeviceType=opsysDeviceType, lexipxPortInfoBannerPage=lexipxPortInfoBannerPage, opsysCurrentJobEntry=opsysCurrentJobEntry, lexipxFrameType=lexipxFrameType, faxActiveCapabilities=faxActiveCapabilities, irOutputFull=irOutputFull, faxBinaryEncoding=faxBinaryEncoding, opsysROMSize=opsysROMSize, faxPort=faxPort, lexhttpConfigEnable=lexhttpConfigEnable, lexipxConnSrvrNode=lexipxConnSrvrNode, opsysCardEC=opsysCardEC, lexlinkNickname=lexlinkNickname, lexipxActivated=lexipxActivated, irPageComplexity=irPageComplexity, timeServerName=timeServerName, lexipxPrefSrvrTable=lexipxPrefSrvrTable, lexipxConnSrvrTable=lexipxConnSrvrTable, lexhdwrPortTableIndex=lexhdwrPortTableIndex, prtgenInfoTable=prtgenInfoTable, prtgenStatusCoverOpen=prtgenStatusCoverOpen, adapter=adapter, faxInputTray=faxInputTray, lexipxNetNumber=lexipxNetNumber, faxInitString=faxInitString, irCoverOpen=irCoverOpen, prtgenAssetTag=prtgenAssetTag, prtgenStatusLineStatus=prtgenStatusLineStatus, opsysCurrentJobEntryIndex=opsysCurrentJobEntryIndex, lexdhcpAddressSource=lexdhcpAddressSource, lexmacType=lexmacType, faxEntry=faxEntry, timeDSTOffset=timeDSTOffset, lextalkZone=lextalkZone, lextalk=lextalk, lexhdwrPortTableParm1=lexhdwrPortTableParm1, prtgenStatusTable=prtgenStatusTable, lexipxConnSrvrEntry=lexipxConnSrvrEntry, prtgenStatusPaperJam=prtgenStatusPaperJam, timeReset=timeReset, faxIDString=faxIDString, lexlink=lexlink, faxNumber=faxNumber, lexipxPrefSrvrEntry=lexipxPrefSrvrEntry, lexhdwrPortTable=lexhdwrPortTable, lextalkActivated=lextalkActivated, attachment=attachment, lexipxPortInfoEntry=lexipxPortInfoEntry, lexipxTrapIndex=lexipxTrapIndex, lexdhcp=lexdhcp, pgcount=pgcount, opsysJobTimeout=opsysJobTimeout, lexipxPortInfoIndex=lexipxPortInfoIndex, irTonerLow=irTonerLow, lexdhcpTimetoExpire=lexdhcpTimetoExpire, faxAdapterCapabilities=faxAdapterCapabilities, opsysRAMSize=opsysRAMSize, lextcpNPAPserverAddress=lextcpNPAPserverAddress, lexhdwrPortTableParm2=lexhdwrPortTableParm2, prtgenPrinterIndex=prtgenPrinterIndex, lextcpNPAPserverIndex=lextcpNPAPserverIndex, lexipxPrefSrvrName=lexipxPrefSrvrName, lextcp=lextcp, faxOutputBin=faxOutputBin, lextrapDestTable=lextrapDestTable, opsysCurrentJob=opsysCurrentJob, lexhdwr=lexhdwr, lexmac=lexmac, faxScaling=faxScaling, timeServerAddress=timeServerAddress, opsysTimeToReset=opsysTimeToReset, lexhdwrPortTableEntry=lexhdwrPortTableEntry, opsysCardPartNo=opsysCardPartNo, lexhttpResetLinks=lexhttpResetLinks, prtgenStatusIRC=prtgenStatusIRC, prtgenStatusWaiting=prtgenStatusWaiting, pgColor=pgColor, lexhttp=lexhttp, timeDSTStartDate=timeDSTStartDate, prtgenPrinterName=prtgenPrinterName, lexdhcpDhcpEnable=lexdhcpDhcpEnable, faxModemCapabilities=faxModemCapabilities, prtgenStatusPageComplex=prtgenStatusPageComplex, timeDSTEnable=timeDSTEnable, lexipx=lexipx, faxIndex=faxIndex, lextrapDestEntry=lextrapDestEntry, lexdhcpLeaseLength=lexdhcpLeaseLength, lexipxNumPrefServers=lexipxNumPrefServers, lexipxTrapEntry=lexipxTrapEntry, lextrap=lextrap, lexdhcpWinsServer=lexdhcpWinsServer, irCleared=irCleared, lextalkType=lextalkType, lexipxConnSrvrNet=lexipxConnSrvrNet, opsys=opsys, opsysNVRAMSize=opsysNVRAMSize, lexipxGSQ=lexipxGSQ, lexhdwrPortTableParm3=lexhdwrPortTableParm3, lexmark=lexmark, lexipxLoginName=lexipxLoginName, lextrapDestIndex=lextrapDestIndex, prtgenStatusInputEmpty=prtgenStatusInputEmpty, faxNumberRings=faxNumberRings, lexipxPortInfoTable=lexipxPortInfoTable, irLoadPaper=irLoadPaper, irDiskErr=irDiskErr, lexipxPrefSrvrIndex=lexipxPrefSrvrIndex, prtgenInfoEntry=prtgenInfoEntry, irClearedTypeII=irClearedTypeII, lexdhcpHostname=lexdhcpHostname, lexdhcpDNSServer=lexdhcpDNSServer, prtgenPeripheralID=prtgenPeripheralID, lexhdwrPortTableParm5=lexhdwrPortTableParm5, lexhttpBytesRemaining=lexhttpBytesRemaining, timeDSTEndDate=timeDSTEndDate, lexmacConnType=lexmacConnType, lextcpNPAPserversEntry=lextcpNPAPserversEntry, lexdhcpWinsStatus=lexdhcpWinsStatus, faxPrinterPort=faxPrinterPort, prtgenStatusTonerError=prtgenStatusTonerError, prtgenStatusSrvcReqd=prtgenStatusSrvcReqd, prtgenStatusPrinting=prtgenStatusPrinting, irCondition=irCondition, irServiceReq=irServiceReq)
