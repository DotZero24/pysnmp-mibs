...
# Notes
# -----
# ASN.1 source file://mibs/lexmark/LEXMARK-PVT-MIB
...
class _OpsysCurrentJobEntryIndex_Type(Integer32):
    """Custom type opsysCurrentJobEntryIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_OpsysCurrentJobEntryIndex_Type.__name__ = "Integer32"
...
class _LexipxPortInfoIndex_Type(Integer32):
    """Custom type lexipxPortInfoIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_LexipxPortInfoIndex_Type.__name__ = "Integer32"
...
class _LexipxPrefSrvrIndex_Type(Integer32):
    """Custom type lexipxPrefSrvrIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_LexipxPrefSrvrIndex_Type.__name__ = "Integer32"
...
class _LexipxConnSrvrIndex_Type(Integer32):
    """Custom type lexipxConnSrvrIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_LexipxConnSrvrIndex_Type.__name__ = "Integer32"
...
class _LexipxTrapIndex_Type(Integer32):
    """Custom type lexipxTrapIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_LexipxTrapIndex_Type.__name__ = "Integer32"
...
class _LextcpNPAPserverIndex_Type(Integer32):
    """Custom type lextcpNPAPserverIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_LextcpNPAPserverIndex_Type.__name__ = "Integer32"
...
if mibBuilder.loadTexts:
    lexhttpConfigEnable.setStatus("obsolete")
...
class _LexhdwrPortTableIndex_Type(Integer32):
    """Custom type lexhdwrPortTableIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_LexhdwrPortTableIndex_Type.__name__ = "Integer32"
...
class _LextrapDestIndex_Type(Integer32):
    """Custom type lextrapDestIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_LextrapDestIndex_Type.__name__ = "Integer32"
...
timeUTCOffset.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
timeDSTStartDate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
timeDSTEndDate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
timeDSTOffset.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
class _PrtgenPrinterIndex_Type(Integer32):
    """Custom type prtgenPrinterIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_PrtgenPrinterIndex_Type.__name__ = "Integer32"
...
class _PrtgenAssetTag_Type(DisplayString):
    """Custom type prtgenAssetTag based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_PrtgenAssetTag_Type.__name__ = "DisplayString"
_PrtgenAssetTag_Object = MibTableColumn
prtgenAssetTag = _PrtgenAssetTag_Object(
    (1, 3, 6, 1, 4, 1, 641, 2, 1, 2, 1, 7),
    _PrtgenAssetTag_Type()
)
prtgenAssetTag.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    prtgenAssetTag.setStatus("mandatory")
...
class _PrtgenStatPrinterIndex_Type(Integer32):
    """Custom type prtgenStatPrinterIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_PrtgenStatPrinterIndex_Type.__name__ = "Integer32"
...
prtgenFamilyID = _PrtgenFamilyID_Object(
    (1, 3, 6, 1, 4, 1, 641, 2, 1, 4),
    _PrtgenFamilyID_Type()
)
prtgenFamilyID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    prtgenFamilyID.setStatus("mandatory")
_Pgcount_ObjectIdentity = ObjectIdentity
pgcount = _Pgcount_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 641, 2, 1, 5)
)
_PgTotal_Type = Counter32
_PgTotal_Object = MibScalar
pgTotal = _PgTotal_Object(
    (1, 3, 6, 1, 4, 1, 641, 2, 1, 5, 1),
    _PgTotal_Type()
)
pgTotal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pgTotal.setStatus("mandatory")
_PgMono_Type = Counter32
_PgMono_Object = MibScalar
pgMono = _PgMono_Object(
    (1, 3, 6, 1, 4, 1, 641, 2, 1, 5, 2),
    _PgMono_Type()
)
pgMono.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pgMono.setStatus("mandatory")
_PgColor_Type = Counter32
_PgColor_Object = MibScalar
pgColor = _PgColor_Object(
    (1, 3, 6, 1, 4, 1, 641, 2, 1, 5, 3),
    _PgColor_Type()
)
pgColor.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pgColor.setStatus("mandatory")
...
class _FaxIndex_Type(Integer32):
    """Custom type faxIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_FaxIndex_Type.__name__ = "Integer32"
