# SNMP MIB module (SUPERMICRO-SNMPv2-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-SNMPv2-MIB
...
snmpCommunityIndex = _SnmpCommunityIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 3, 1, 1),
...
snmpCommunityName = _SnmpCommunityName_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 3, 1, 2),
...
snmpCommunityPrivilege = _SnmpCommunityPrivilege_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 3, 1, 3),
...
snmpCommunityIpAddr = _SnmpCommunityIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 3, 1, 4),
...
snmpStatus = _SnmpStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 3, 1, 5),
    _SnmpStatus_Type()
)
...
snmpTrapIndex = _SnmpTrapIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 4, 1, 1),
    _SnmpTrapIndex_Type()
)
...
snmpTrapCommunityName = _SnmpTrapCommunityName_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 4, 1, 2),
...
snmpTrapIpAddr = _SnmpTrapIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 4, 1, 3),
...
snmpTrapMgrType = _SnmpTrapMgrType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 4, 1, 4),
...
snmpTrapStatus = _SnmpTrapStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 50, 4, 1, 5),
