...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-DSPU-MIB
...
mibBuilder.exportSymbols("CISCO-DSPU-MIB", ciscoDspuMIBComplianceV11R01=ciscoDspuMIBComplianceV11R01, dspuPuOperXidFmt=dspuPuOperXidFmt, dspuSapDlcPort=dspuSapDlcPort, dspuPuAdminDlcType=dspuPuAdminDlcType, dspuSapOperState=dspuSapOperState, dspuPoolClassOperDnStreamLuDefs=dspuPoolClassOperDnStreamLuDefs, dspuPooledLuPeerPuIndex=dspuPooledLuPeerPuIndex, dspuPuAdminLinkRetryCount=dspuPuAdminLinkRetryCount, dspuPuOperName=dspuPuOperName, newdspuLuStateChangeTrap=newdspuLuStateChangeTrap, dspuPuStatsSentFrames=dspuPuStatsSentFrames, dspuLuActivationFailureTrap=dspuLuActivationFailureTrap, dspuPuOperType=dspuPuOperType, dspuNodeDefaultPu=dspuNodeDefaultPu, dspuPoolClassTable=dspuPoolClassTable, dspuPuOperRemoteMacAddress=dspuPuOperRemoteMacAddress, dspuLuOperLuLocalAddress=dspuLuOperLuLocalAddress, dspuLuAdminLuLocalAddress=dspuLuAdminLuLocalAddress, dspuLuTraps=dspuLuTraps, dspuNodeRsrbLocalVirtualRing=dspuNodeRsrbLocalVirtualRing, dspuLuOperPoolClassName=dspuLuOperPoolClassName, dspuLuOperEntry=dspuLuOperEntry, dspuPuOperMaxIframe=dspuPuOperMaxIframe, dspuPuTraps=dspuPuTraps, dspuNodeRsrbTargetVirtualRing=dspuNodeRsrbTargetVirtualRing, dspuPoolClassEntry=dspuPoolClassEntry, dspuPuOperLocalSapAddress=dspuPuOperLocalSapAddress, dspuPuOperDlcType=dspuPuOperDlcType, dspuPooledLu=dspuPooledLu, dspuPuAdminRowStatus=dspuPuAdminRowStatus, dspuPuAdminName=dspuPuAdminName, dspuPuAdminFocalPoint=dspuPuAdminFocalPoint, dspuSap=dspuSap, dspuLuGroup=dspuLuGroup, dspuSapStateChangeTrap=dspuSapStateChangeTrap, dspuNodeGroup=dspuNodeGroup, dspuNodeRsrb=dspuNodeRsrb, ciscoDspuMIBCompliance=ciscoDspuMIBCompliance, dspuLuOperFsmState=dspuLuOperFsmState, newdspuPuActivationFailureTrap=newdspuPuActivationFailureTrap, dspuPuAdminType=dspuPuAdminType, dspuPoolClass=dspuPoolClass, dspuPuStatsRcvdNegativeRsps=dspuPuStatsRcvdNegativeRsps, dspuPoolClassOperUpStreamLuDefs=dspuPoolClassOperUpStreamLuDefs, dspuLuAdminPeerLuLocalAddress=dspuLuAdminPeerLuLocalAddress, dspuLuOperState=dspuLuOperState, dspuPuActivationFailureTrap=dspuPuActivationFailureTrap, dspuPuAdminMaxIframe=dspuPuAdminMaxIframe, dspuPooledLuPeerLuLocalAddress=dspuPooledLuPeerLuLocalAddress, dspuLuOperTable=dspuLuOperTable, dspuNodeLastConfigChgTime=dspuNodeLastConfigChgTime, dspuPuTrapsPrefix=dspuPuTrapsPrefix, dspuPuAdminEntry=dspuPuAdminEntry, dspuPuOperRemoteAddress=dspuPuOperRemoteAddress, ciscoDspuMIBGroups=ciscoDspuMIBGroups, dspuPoolClassIndex=dspuPoolClassIndex, dspuPoolClassName=dspuPoolClassName, dspuLuOperSessionState=dspuLuOperSessionState, dspuPuOperWindowSize=dspuPuOperWindowSize, dspuLuOperPeerPuIndex=dspuLuOperPeerPuIndex, dspuNodeRsrbVirtualMacAddress=dspuNodeRsrbVirtualMacAddress, dspuPuOperDlcPort=dspuPuOperDlcPort, dspuPuStateChangeTrap=dspuPuStateChangeTrap, dspuPuStatsActiveLus=dspuPuStatsActiveLus, dspuPuStatsEntry=dspuPuStatsEntry, ciscoDspuMIB=ciscoDspuMIB, dspuLuGroupV11R01=dspuLuGroupV11R01, dspuPuStatsActivationFailures=dspuPuStatsActivationFailures, dspuPuAdminDlcUnit=dspuPuAdminDlcUnit, dspuPuOperEntry=dspuPuOperEntry, dspuLuAdminPoolClassName=dspuLuAdminPoolClassName, dspuLuTrapsPrefix=dspuLuTrapsPrefix, dspuPoolClassGroup=dspuPoolClassGroup, dspuPuAdminXid=dspuPuAdminXid, dspuPuStatsLastActivationFailureReason=dspuPuStatsLastActivationFailureReason, dspuPuGroup=dspuPuGroup, dspuPoolClassInactivityTimeout=dspuPoolClassInactivityTimeout, dspuPuStatsRcvdBytes=dspuPuStatsRcvdBytes, dspuPuStatsSentBytes=dspuPuStatsSentBytes, dspuPuStatsBindLus=dspuPuStatsBindLus, dspuLuOperPeerLuLocalAddress=dspuLuOperPeerLuLocalAddress, dspuPuOperFsmState=dspuPuOperFsmState, dspuNodeActivationWindow=dspuNodeActivationWindow, dspuNode=dspuNode, dspuPooledLuEntry=dspuPooledLuEntry, dspuPuAdminLinkRetryTimeout=dspuPuAdminLinkRetryTimeout, dspuObjects=dspuObjects, dspuSapType=dspuSapType, dspuLuAdminType=dspuLuAdminType, dspuPuAdminRemoteMacAddress=dspuPuAdminRemoteMacAddress, ciscoDspuMIBCompliances=ciscoDspuMIBCompliances, dspuPuOperIndex=dspuPuOperIndex, dspuSapTraps=dspuSapTraps, dspuSapAddress=dspuSapAddress, dspuPuAdminWindowSize=dspuPuAdminWindowSize, dspuPuOperLinkRetryTimeout=dspuPuOperLinkRetryTimeout, dspuPuOperStartTime=dspuPuOperStartTime, dspuPuAdminRemoteAddress=dspuPuAdminRemoteAddress, dspuPuAdminTable=dspuPuAdminTable, dspuSapEntry=dspuSapEntry, dspuPuOperState=dspuPuOperState, ciscoDspuMIBConformance=ciscoDspuMIBConformance, dspuPuAdminLocalSapAddress=dspuPuAdminLocalSapAddress, dspuLuOperLastActivationFailureReason=dspuLuOperLastActivationFailureReason, dspuPooledLuGroup=dspuPooledLuGroup, dspuPuOperDlcUnit=dspuPuOperDlcUnit, dspuLuAdminPeerPuIndex=dspuLuAdminPeerPuIndex, newdspuPuStateChangeTrap=newdspuPuStateChangeTrap, dspuPu=dspuPu, dspuNodeRsrbBridgeNumber=dspuNodeRsrbBridgeNumber, dspuSapTable=dspuSapTable, dspuPuOperStartPu=dspuPuOperStartPu, dspuLuAdminTable=dspuLuAdminTable, dspuPuAdminDlcPort=dspuPuAdminDlcPort, dspuPuGroupV11R01=dspuPuGroupV11R01, PYSNMP_MODULE_ID=ciscoDspuMIB, dspuPuOperRemoteSapAddress=dspuPuOperRemoteSapAddress, dspuPuOperXid=dspuPuOperXid, dspuLuOperType=dspuLuOperType, dspuPuStatsSentNegativeRsps=dspuPuStatsSentNegativeRsps, dspuLu=dspuLu, dspuPuAdminXidFmt=dspuPuAdminXidFmt, dspuPuAdminRemoteSapAddress=dspuPuAdminRemoteSapAddress, dspuSapGroup=dspuSapGroup, dspuLuAdminEntry=dspuLuAdminEntry, dspuPuAdminStartPu=dspuPuAdminStartPu, dspuPooledLuTable=dspuPooledLuTable, dspuSapDlcType=dspuSapDlcType, dspuPuStatsInactiveLus=dspuPuStatsInactiveLus, dspuLuStateChangeTrap=dspuLuStateChangeTrap, dspuPuAdminIndex=dspuPuAdminIndex, dspuPuStatsTable=dspuPuStatsTable, dspuPuOperTable=dspuPuOperTable, dspuNodeDefaultPuMaxIframe=dspuNodeDefaultPuMaxIframe, dspuPuStatsRcvdFrames=dspuPuStatsRcvdFrames, dspuPuOperFocalPoint=dspuPuOperFocalPoint, dspuPuOperLastStateChgTime=dspuPuOperLastStateChgTime, dspuLuAdminRowStatus=dspuLuAdminRowStatus, dspuSapDlcUnit=dspuSapDlcUnit, dspuNodeDefaultPuWindowSize=dspuNodeDefaultPuWindowSize, dspuSapRowStatus=dspuSapRowStatus, dspuPuOperLinkRetryCount=dspuPuOperLinkRetryCount)
