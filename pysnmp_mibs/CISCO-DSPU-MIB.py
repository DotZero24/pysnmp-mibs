...
mibBuilder.exportSymbols("CISCO-DSPU-MIB", dspuPuOperIndex=dspuPuOperIndex, dspuPuStatsEntry=dspuPuStatsEntry, dspuPuOperLinkRetryCount=dspuPuOperLinkRetryCount, dspuPuOperFsmState=dspuPuOperFsmState, dspuSap=dspuSap, dspuPuAdminXidFmt=dspuPuAdminXidFmt, dspuSapDlcType=dspuSapDlcType, dspuPuStatsSentFrames=dspuPuStatsSentFrames, dspuSapRowStatus=dspuSapRowStatus, dspuLuOperLastActivationFailureReason=dspuLuOperLastActivationFailureReason, dspuLuAdminType=dspuLuAdminType, dspuPuOperRemoteAddress=dspuPuOperRemoteAddress, dspuPoolClassOperUpStreamLuDefs=dspuPoolClassOperUpStreamLuDefs, ciscoDspuMIBGroups=ciscoDspuMIBGroups, dspuLuStateChangeTrap=dspuLuStateChangeTrap, dspuLuOperFsmState=dspuLuOperFsmState, dspuNodeRsrbTargetVirtualRing=dspuNodeRsrbTargetVirtualRing, dspuSapType=dspuSapType, dspuSapOperState=dspuSapOperState, dspuLuTraps=dspuLuTraps, dspuPuStatsLastActivationFailureReason=dspuPuStatsLastActivationFailureReason, dspuPuStateChangeTrap=dspuPuStateChangeTrap, dspuLuOperLuLocalAddress=dspuLuOperLuLocalAddress, dspuLuOperState=dspuLuOperState, ciscoDspuMIBCompliance=ciscoDspuMIBCompliance, dspuLuAdminPeerLuLocalAddress=dspuLuAdminPeerLuLocalAddress, dspuPuAdminType=dspuPuAdminType, dspuPuAdminWindowSize=dspuPuAdminWindowSize, dspuNodeRsrbVirtualMacAddress=dspuNodeRsrbVirtualMacAddress, dspuPuOperLocalSapAddress=dspuPuOperLocalSapAddress, dspuPuTraps=dspuPuTraps, dspuNodeActivationWindow=dspuNodeActivationWindow, dspuPoolClassTable=dspuPoolClassTable, dspuPuStatsInactiveLus=dspuPuStatsInactiveLus, dspuLuAdminLuLocalAddress=dspuLuAdminLuLocalAddress, dspuLuOperPeerPuIndex=dspuLuOperPeerPuIndex, dspuObjects=dspuObjects, dspuPuOperXidFmt=dspuPuOperXidFmt, dspuLuActivationFailureTrap=dspuLuActivationFailureTrap, dspuLuAdminRowStatus=dspuLuAdminRowStatus, ciscoDspuMIBCompliances=ciscoDspuMIBCompliances, dspuPuAdminLinkRetryCount=dspuPuAdminLinkRetryCount, dspuPoolClassGroup=dspuPoolClassGroup, dspuPoolClassInactivityTimeout=dspuPoolClassInactivityTimeout, dspuPuAdminFocalPoint=dspuPuAdminFocalPoint, dspuPuAdminEntry=dspuPuAdminEntry, dspuLuAdminPeerPuIndex=dspuLuAdminPeerPuIndex, dspuPoolClassEntry=dspuPoolClassEntry, dspuPuStatsRcvdNegativeRsps=dspuPuStatsRcvdNegativeRsps, dspuPoolClass=dspuPoolClass, dspuPuAdminDlcUnit=dspuPuAdminDlcUnit, dspuPuStatsRcvdFrames=dspuPuStatsRcvdFrames, ciscoDspuMIBConformance=ciscoDspuMIBConformance, dspuPuOperStartTime=dspuPuOperStartTime, dspuNode=dspuNode, dspuNodeGroup=dspuNodeGroup, dspuPuAdminXid=dspuPuAdminXid, dspuPuAdminRemoteAddress=dspuPuAdminRemoteAddress, dspuPoolClassOperDnStreamLuDefs=dspuPoolClassOperDnStreamLuDefs, dspuPuAdminRowStatus=dspuPuAdminRowStatus, dspuPuAdminDlcType=dspuPuAdminDlcType, dspuPuOperName=dspuPuOperName, PYSNMP_MODULE_ID=ciscoDspuMIB, dspuPuStatsBindLus=dspuPuStatsBindLus, dspuSapTable=dspuSapTable, dspuPuOperXid=dspuPuOperXid, dspuNodeRsrbBridgeNumber=dspuNodeRsrbBridgeNumber, dspuPuStatsActiveLus=dspuPuStatsActiveLus, dspuSapAddress=dspuSapAddress, dspuLuAdminTable=dspuLuAdminTable, dspuSapTraps=dspuSapTraps, dspuPooledLuPeerLuLocalAddress=dspuPooledLuPeerLuLocalAddress, dspuLuOperType=dspuLuOperType, dspuPuAdminRemoteSapAddress=dspuPuAdminRemoteSapAddress, dspuPuOperRemoteSapAddress=dspuPuOperRemoteSapAddress, ciscoDspuMIB=ciscoDspuMIB, dspuPuActivationFailureTrap=dspuPuActivationFailureTrap, dspuSapDlcUnit=dspuSapDlcUnit, dspuSapEntry=dspuSapEntry, newdspuPuActivationFailureTrap=newdspuPuActivationFailureTrap, dspuLuAdminPoolClassName=dspuLuAdminPoolClassName, dspuPuOperType=dspuPuOperType, dspuPoolClassIndex=dspuPoolClassIndex, dspuLuTrapsPrefix=dspuLuTrapsPrefix, dspuPuAdminMaxIframe=dspuPuAdminMaxIframe, dspuPuOperStartPu=dspuPuOperStartPu, dspuSapGroup=dspuSapGroup, dspuLuOperTable=dspuLuOperTable, dspuPu=dspuPu, dspuPoolClassName=dspuPoolClassName, dspuPuAdminStartPu=dspuPuAdminStartPu, dspuPuOperState=dspuPuOperState, dspuPuOperFocalPoint=dspuPuOperFocalPoint, dspuLuOperPoolClassName=dspuLuOperPoolClassName, newdspuLuStateChangeTrap=newdspuLuStateChangeTrap, dspuPuOperTable=dspuPuOperTable, ciscoDspuMIBComplianceV11R01=ciscoDspuMIBComplianceV11R01, dspuPuAdminLinkRetryTimeout=dspuPuAdminLinkRetryTimeout, dspuPuOperLastStateChgTime=dspuPuOperLastStateChgTime, newdspuPuStateChangeTrap=newdspuPuStateChangeTrap, dspuLuAdminEntry=dspuLuAdminEntry, dspuLuGroup=dspuLuGroup, dspuPooledLuPeerPuIndex=dspuPooledLuPeerPuIndex, dspuNodeRsrb=dspuNodeRsrb, dspuPuOperDlcType=dspuPuOperDlcType, dspuPuAdminRemoteMacAddress=dspuPuAdminRemoteMacAddress, dspuLuGroupV11R01=dspuLuGroupV11R01, dspuLuOperEntry=dspuLuOperEntry, dspuPooledLuGroup=dspuPooledLuGroup, dspuSapDlcPort=dspuSapDlcPort, dspuNodeRsrbLocalVirtualRing=dspuNodeRsrbLocalVirtualRing, dspuNodeDefaultPuWindowSize=dspuNodeDefaultPuWindowSize, dspuPuAdminIndex=dspuPuAdminIndex, dspuPuGroup=dspuPuGroup, dspuPuOperLinkRetryTimeout=dspuPuOperLinkRetryTimeout, dspuNodeDefaultPuMaxIframe=dspuNodeDefaultPuMaxIframe, dspuNodeLastConfigChgTime=dspuNodeLastConfigChgTime, dspuPuOperDlcPort=dspuPuOperDlcPort, dspuPuTrapsPrefix=dspuPuTrapsPrefix, dspuPuAdminTable=dspuPuAdminTable, dspuLuOperPeerLuLocalAddress=dspuLuOperPeerLuLocalAddress, dspuPuAdminDlcPort=dspuPuAdminDlcPort, dspuPooledLuEntry=dspuPooledLuEntry, dspuSapStateChangeTrap=dspuSapStateChangeTrap, dspuLuOperSessionState=dspuLuOperSessionState, dspuPuAdminName=dspuPuAdminName, dspuPooledLu=dspuPooledLu, dspuPuStatsRcvdBytes=dspuPuStatsRcvdBytes, dspuPuOperEntry=dspuPuOperEntry, dspuPuStatsSentBytes=dspuPuStatsSentBytes, dspuPuStatsSentNegativeRsps=dspuPuStatsSentNegativeRsps, dspuPuGroupV11R01=dspuPuGroupV11R01, dspuPooledLuTable=dspuPooledLuTable, dspuNodeDefaultPu=dspuNodeDefaultPu, dspuPuOperMaxIframe=dspuPuOperMaxIframe, dspuPuOperWindowSize=dspuPuOperWindowSize, dspuPuStatsTable=dspuPuStatsTable, dspuPuAdminLocalSapAddress=dspuPuAdminLocalSapAddress, dspuLu=dspuLu, dspuPuStatsActivationFailures=dspuPuStatsActivationFailures, dspuPuOperRemoteMacAddress=dspuPuOperRemoteMacAddress, dspuPuOperDlcUnit=dspuPuOperDlcUnit)
