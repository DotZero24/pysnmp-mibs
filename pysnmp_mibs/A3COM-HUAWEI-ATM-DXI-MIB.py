...
h3cAtmDxiScalarGroup=_H3cAtmDxiScalarGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,49,1))
...
h3cAtmDxiConfMode=_H3cAtmDxiConfMode_Object((1,3,6,1,4,1,43,45,1,10,2,49,1,1),_H3cAtmDxiConfMode_Type())
...
h3cAtmDxiIfObjects=_H3cAtmDxiIfObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,49,2))
_H3cAtmDxiPvcTable_Object=MibTable
h3cAtmDxiPvcTable=_H3cAtmDxiPvcTable_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,1))
if mibBuilder.loadTexts:h3cAtmDxiPvcTable.setStatus(_A)
_H3cAtmDxiPvcEntry_Object=MibTableRow
h3cAtmDxiPvcEntry=_H3cAtmDxiPvcEntry_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,1,1))
...
h3cAtmDxiPvcVpi=_H3cAtmDxiPvcVpi_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,1,1,1),_H3cAtmDxiPvcVpi_Type())
...
h3cAtmDxiPvcVci=_H3cAtmDxiPvcVci_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,1,1,2),_H3cAtmDxiPvcVci_Type())
...
h3cAtmDxiPvcDFA=_H3cAtmDxiPvcDFA_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,1,1,3),_H3cAtmDxiPvcDFA_Type())
...
h3cAtmDxiPvcEncType=_H3cAtmDxiPvcEncType_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,1,1,4),_H3cAtmDxiPvcEncType_Type())
...
h3cAtmDxiPvcMapCount=_H3cAtmDxiPvcMapCount_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,1,1,5),_H3cAtmDxiPvcMapCount_Type())
...
h3cAtmDxiPvcRowStatus=_H3cAtmDxiPvcRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,1,1,6),_H3cAtmDxiPvcRowStatus_Type())
...
h3cAtmDxiMapTable=_H3cAtmDxiMapTable_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2))
if mibBuilder.loadTexts:h3cAtmDxiMapTable.setStatus(_A)
_H3cAtmDxiMapEntry_Object=MibTableRow
h3cAtmDxiMapEntry=_H3cAtmDxiMapEntry_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2,1))
...
h3cAtmDxiMapPeerIpType=_H3cAtmDxiMapPeerIpType_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2,1,1),_H3cAtmDxiMapPeerIpType_Type())
...
h3cAtmDxiMapPeerIp=_H3cAtmDxiMapPeerIp_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2,1,2),_H3cAtmDxiMapPeerIp_Type())
...
h3cAtmDxiMapPvcVpi=_H3cAtmDxiMapPvcVpi_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2,1,3),_H3cAtmDxiMapPvcVpi_Type())
...
h3cAtmDxiMapPvcVci=_H3cAtmDxiMapPvcVci_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2,1,4),_H3cAtmDxiMapPvcVci_Type())
...
h3cAtmDxiMapType=_H3cAtmDxiMapType_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2,1,5),_H3cAtmDxiMapType_Type())
...
h3cAtmDxiMapInarpTime=_H3cAtmDxiMapInarpTime_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2,1,6),_H3cAtmDxiMapInarpTime_Type())
...
h3cAtmDxiMapBroEnable=_H3cAtmDxiMapBroEnable_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2,1,7),_H3cAtmDxiMapBroEnable_Type())
...
h3cAtmDxiMapRowStatus=_H3cAtmDxiMapRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,49,2,2,1,8),_H3cAtmDxiMapRowStatus_Type())
...
h3cAtmDxiConformance=_H3cAtmDxiConformance_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,49,3))
_H3cAtmDxiCompliances_ObjectIdentity=ObjectIdentity
h3cAtmDxiCompliances=_H3cAtmDxiCompliances_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,49,3,1))
_H3cAtmDxiGroup_ObjectIdentity=ObjectIdentity
h3cAtmDxiGroup=_H3cAtmDxiGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,49,3,2))
h3cPVCMAPGroup=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,49,3,2,1))
h3cPVCMAPGroup.setObjects(*((_B,_O),(_B,_P),(_B,_Q),(_B,_R),(_B,_S),(_B,_T),(_B,_U)))
if mibBuilder.loadTexts:h3cPVCMAPGroup.setStatus(_A)
h3cAtmDxiGeneralGroup=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,49,3,2,2))
h3cAtmDxiGeneralGroup.setObjects((_B,_V))
if mibBuilder.loadTexts:h3cAtmDxiGeneralGroup.setStatus(_A)
h3cAtmDxiCompliance=ModuleCompliance((1,3,6,1,4,1,43,45,1,10,2,49,3,1,1))
