# SNMP MIB module (A3COM-HUAWEI-ATM-DXI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-ATM-DXI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:52 2025
...
h3cAtmDxiConfMode = _H3cAtmDxiConfMode_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 1, 1),
...
h3cAtmDxiPvcVpi = _H3cAtmDxiPvcVpi_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 1, 1, 1),
...
h3cAtmDxiPvcVci = _H3cAtmDxiPvcVci_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 1, 1, 2),
...
h3cAtmDxiPvcDFA = _H3cAtmDxiPvcDFA_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 1, 1, 3),
...
h3cAtmDxiPvcEncType = _H3cAtmDxiPvcEncType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 1, 1, 4),
...
h3cAtmDxiPvcMapCount = _H3cAtmDxiPvcMapCount_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 1, 1, 5),
...
h3cAtmDxiPvcRowStatus = _H3cAtmDxiPvcRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 1, 1, 6),
...
h3cAtmDxiMapTable = _H3cAtmDxiMapTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2)
)
if mibBuilder.loadTexts:
    h3cAtmDxiMapTable.setStatus("current")
_H3cAtmDxiMapEntry_Object = MibTableRow
h3cAtmDxiMapEntry = _H3cAtmDxiMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2, 1)
)
h3cAtmDxiMapEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiMapPeerIpType"),
    (0, "A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiMapPeerIp"),
    (0, "A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiMapPvcVpi"),
    (0, "A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiMapPvcVci"),
    (0, "A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiMapType"),
)
if mibBuilder.loadTexts:
...
h3cAtmDxiMapPeerIpType = _H3cAtmDxiMapPeerIpType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2, 1, 1),
...
h3cAtmDxiMapPeerIp = _H3cAtmDxiMapPeerIp_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2, 1, 2),
...
h3cAtmDxiMapPvcVpi = _H3cAtmDxiMapPvcVpi_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2, 1, 3),
...
h3cAtmDxiMapPvcVci = _H3cAtmDxiMapPvcVci_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2, 1, 4),
...
h3cAtmDxiMapType = _H3cAtmDxiMapType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2, 1, 5),
...
h3cAtmDxiMapInarpTime = _H3cAtmDxiMapInarpTime_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2, 1, 6),
...
h3cAtmDxiMapBroEnable = _H3cAtmDxiMapBroEnable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2, 1, 7),
...
h3cAtmDxiMapRowStatus = _H3cAtmDxiMapRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 2, 2, 1, 8),
...
h3cAtmDxiConformance = _H3cAtmDxiConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 3)
)
_H3cAtmDxiCompliances_ObjectIdentity = ObjectIdentity
h3cAtmDxiCompliances = _H3cAtmDxiCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 3, 1)
)
_H3cAtmDxiGroup_ObjectIdentity = ObjectIdentity
h3cAtmDxiGroup = _H3cAtmDxiGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 3, 2)
)

# Managed Objects groups

h3cPVCMAPGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 3, 2, 1)
)
h3cPVCMAPGroup.setObjects(
      *(("A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiPvcDFA"),
        ("A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiPvcEncType"),
        ("A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiPvcMapCount"),
        ("A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiPvcRowStatus"),
        ("A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiMapBroEnable"),
        ("A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiMapInarpTime"),
        ("A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiMapRowStatus"))
)
if mibBuilder.loadTexts:
    h3cPVCMAPGroup.setStatus("current")

h3cAtmDxiGeneralGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 3, 2, 2)
)
h3cAtmDxiGeneralGroup.setObjects(
    ("A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiConfMode")
)
if mibBuilder.loadTexts:
...
h3cAtmDxiCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 49, 3, 1, 1)
)
h3cAtmDxiCompliance.setObjects(
      *(("A3COM-HUAWEI-ATM-DXI-MIB", "h3cPVCMAPGroup"),
        ("A3COM-HUAWEI-ATM-DXI-MIB", "h3cAtmDxiGeneralGroup"))
)
if mibBuilder.loadTexts:
