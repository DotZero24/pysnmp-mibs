# SNMP MIB module (MY-IGMP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-IGMP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:34:42 2025
...
myIgmpInterfaceEntry.setIndexNames(
    (0, "MY-IGMP-MIB", "myIgmpInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
myIgmpInterfaceStaticEntry.setIndexNames(
    (0, "MY-IGMP-MIB", "myIgmpInterfaceStaticInterface"),
    (0, "MY-IGMP-MIB", "myIgmpInterfaceStaticGroupAddress"),
)
if mibBuilder.loadTexts:
...
myIgmpInterfaceMIBGroup.setObjects(
      *(("MY-IGMP-MIB", "myIgmpInterfaceIfIndex"),
        ("MY-IGMP-MIB", "myIgmpInterfaceQueryInterval"),
        ("MY-IGMP-MIB", "myIgmpInterfaceVersion"),
        ("MY-IGMP-MIB", "myIgmpInterfaceQuerier"),
        ("MY-IGMP-MIB", "myIgmpInterfaceQueryMaxResponseTime"),
        ("MY-IGMP-MIB", "myIgmpInterfaceQuerierUpTime"),
        ("MY-IGMP-MIB", "myIgmpInterfaceQuerierExpiryTime"),
        ("MY-IGMP-MIB", "myIgmpInterfaceVersion1QuerierTimer"),
        ("MY-IGMP-MIB", "myIgmpInterfaceWrongVersionQueries"),
        ("MY-IGMP-MIB", "myIgmpInterfaceJoins"),
        ("MY-IGMP-MIB", "myIgmpInterfaceProxyIfIndex"),
        ("MY-IGMP-MIB", "myIgmpInterfaceGroups"),
        ("MY-IGMP-MIB", "myIgmpInterfaceRobustness"),
        ("MY-IGMP-MIB", "myIgmpInterfaceLastMembQueryIntvl"),
        ("MY-IGMP-MIB", "myIgmpInterfaceQuerierPresentTimeout"),
        ("MY-IGMP-MIB", "myIgmpInterfaceLeaves"),
        ("MY-IGMP-MIB", "myIgmpInterfaceAccessGroupAclName"),
        ("MY-IGMP-MIB", "myIgmpInterfaceEnabled"),
        ("MY-IGMP-MIB", "myIgmpInterfaceHostVersion"))
)
if mibBuilder.loadTexts:
...
myIgmpInterfaceStaticMIBGroup.setObjects(
      *(("MY-IGMP-MIB", "myIgmpInterfaceStaticInterface"),
        ("MY-IGMP-MIB", "myIgmpInterfaceStaticGroupAddress"),
        ("MY-IGMP-MIB", "myIgmpInterfaceStaticStatus"))
)
if mibBuilder.loadTexts:
...
myIgmpMIBCompliance.setObjects(
      *(("MY-IGMP-MIB", "myIgmpInterfaceMIBGroup"),
        ("MY-IGMP-MIB", "myIgmpInterfaceStaticMIBGroup"))
)
if mibBuilder.loadTexts:
