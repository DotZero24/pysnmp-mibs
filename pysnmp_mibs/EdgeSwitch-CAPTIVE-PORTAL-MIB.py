# SNMP MIB module (EdgeSwitch-CAPTIVE-PORTAL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ubiquiti/EdgeSwitch-CAPTIVE-PORTAL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:59:28 2025
...
cpCaptivePortalEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalInstanceId"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalIdleTimeout = _CpCaptivePortalIdleTimeout_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 2, 1, 1, 10),
...
cpCaptivePortalMaxBandwidthUp = _CpCaptivePortalMaxBandwidthUp_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 2, 1, 1, 12),
...
cpCaptivePortalMaxBandwidthDown = _CpCaptivePortalMaxBandwidthDown_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 2, 1, 1, 13),
...
cpCaptivePortalMaxInputOctets = _CpCaptivePortalMaxInputOctets_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 2, 1, 1, 14),
...
cpCaptivePortalMaxOutputOctets = _CpCaptivePortalMaxOutputOctets_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 2, 1, 1, 15),
...
cpCaptivePortalMaxTotalOctets = _CpCaptivePortalMaxTotalOctets_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 2, 1, 1, 16),
...
cpCaptivePortalUserLogoutMode = _CpCaptivePortalUserLogoutMode_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 2, 1, 1, 17),
...
cpLocalUserGroupEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpLocalUserGroupIndex"),
)
if mibBuilder.loadTexts:
...
cpLocalUserEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpLocalUserIndex"),
)
if mibBuilder.loadTexts:
...
cpLocalUserIdleTimeout = _CpLocalUserIdleTimeout_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 3, 2, 1, 5),
...
cpLocalUserMaxBandwidthUp = _CpLocalUserMaxBandwidthUp_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 3, 2, 1, 6),
...
cpLocalUserMaxBandwidthDown = _CpLocalUserMaxBandwidthDown_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 3, 2, 1, 7),
...
cpLocalUserMaxInputOctets = _CpLocalUserMaxInputOctets_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 3, 2, 1, 8),
...
cpLocalUserMaxOutputOctets = _CpLocalUserMaxOutputOctets_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 3, 2, 1, 9),
...
cpLocalUserMaxTotalOctets = _CpLocalUserMaxTotalOctets_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 3, 2, 1, 10),
...
cpLocalUserGroupAssociationEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpLocalUserGroupAssociationUserIndex"),
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpLocalUserGroupAssociationGroupIndex"),
)
if mibBuilder.loadTexts:
...
cpInterfaceAssociationEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpIntfAssociationCPID"),
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpIntfAssociationIfIndex"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalIntfStatusEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalInstanceId"),
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalIntfIfIndex"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalClientStatusEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientMacAddress"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalClientSwitchMacAddress = _CpCaptivePortalClientSwitchMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 1, 1, 9),
...
cpCaptivePortalClientSwitchIpAddress = _CpCaptivePortalClientSwitchIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 1, 1, 10),
...
cpCaptivePortalClientSwitchType = _CpCaptivePortalClientSwitchType_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 1, 1, 11),
...
cpCaptivePortalClientStatisticsEntry = _CpCaptivePortalClientStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 2, 1)
)
if mibBuilder.loadTexts:
...
cpCaptivePortalClientBytesReceived = _CpCaptivePortalClientBytesReceived_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 2, 1, 1),
...
cpCaptivePortalClientBytesTransmitted = _CpCaptivePortalClientBytesTransmitted_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 2, 1, 2),
...
cpCaptivePortalClientPacketsReceived = _CpCaptivePortalClientPacketsReceived_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 2, 1, 3),
...
cpCaptivePortalClientPacketsTransmitted = _CpCaptivePortalClientPacketsTransmitted_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 2, 1, 4),
...
cpCaptivePortalIntfClientAssocEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalIntfClientIfIndex"),
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalIntfClientAssocMacAddress"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalInstanceClientAssocEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalInstanceClientAssocInstanceId"),
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalInstanceClientAssocMacAddress"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalConfigWebEntry = _CpCaptivePortalConfigWebEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 5, 1, 1)
)
cpCaptivePortalConfigWebEntry.setIndexNames(
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalConfigWebInstanceId"),
    (0, "EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalConfigWebWebId"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalConfigWebInstanceId = _CpCaptivePortalConfigWebInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 5, 1, 1, 1),
...
cpCaptivePortalConfigWebWebId = _CpCaptivePortalConfigWebWebId_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 5, 1, 1, 2),
...
cpClientAuthenticationFailure.setObjects(
      *(("EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientMacAddress"),
        ("EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientIpAddress"),
        ("EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientCPID"),
        ("EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientAssocIfIndex"),
        ("EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientSwitchMacAddress"),
        ("EdgeSwitch-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientUserName"))
)
if mibBuilder.loadTexts:
