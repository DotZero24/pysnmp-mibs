...
_F='Unsigned32'
_E='Integer32'
_D='EdgeSwitch-CAPTIVE-PORTAL-MIB'
_C='read-write'
_B='read-only'
_A='current'
...
cpPeerStatsReportingInterval=_CpPeerStatsReportingInterval_Object((1,3,6,1,4,1,4413,1,1,38,1,1,4),_CpPeerStatsReportingInterval_Type())
...
cpCaptivePortalIdleTimeout=_CpCaptivePortalIdleTimeout_Object((1,3,6,1,4,1,4413,1,1,38,1,2,1,1,10),_CpCaptivePortalIdleTimeout_Type())
...
cpCaptivePortalMaxBandwidthUp=_CpCaptivePortalMaxBandwidthUp_Object((1,3,6,1,4,1,4413,1,1,38,1,2,1,1,12),_CpCaptivePortalMaxBandwidthUp_Type())
...
cpCaptivePortalMaxBandwidthDown=_CpCaptivePortalMaxBandwidthDown_Object((1,3,6,1,4,1,4413,1,1,38,1,2,1,1,13),_CpCaptivePortalMaxBandwidthDown_Type())
...
cpCaptivePortalMaxInputOctets=_CpCaptivePortalMaxInputOctets_Object((1,3,6,1,4,1,4413,1,1,38,1,2,1,1,14),_CpCaptivePortalMaxInputOctets_Type())
...
cpCaptivePortalMaxOutputOctets=_CpCaptivePortalMaxOutputOctets_Object((1,3,6,1,4,1,4413,1,1,38,1,2,1,1,15),_CpCaptivePortalMaxOutputOctets_Type())
...
cpCaptivePortalMaxTotalOctets=_CpCaptivePortalMaxTotalOctets_Object((1,3,6,1,4,1,4413,1,1,38,1,2,1,1,16),_CpCaptivePortalMaxTotalOctets_Type())
...
cpCaptivePortalUserLogoutMode=_CpCaptivePortalUserLogoutMode_Object((1,3,6,1,4,1,4413,1,1,38,1,2,1,1,17),_CpCaptivePortalUserLogoutMode_Type())
...
class _CpLocalUserIdleTimeout_Type(Unsigned32):defaultValue=0
_CpLocalUserIdleTimeout_Type.__name__=_F
_CpLocalUserIdleTimeout_Object=MibTableColumn
cpLocalUserIdleTimeout=_CpLocalUserIdleTimeout_Object((1,3,6,1,4,1,4413,1,1,38,1,3,2,1,5),_CpLocalUserIdleTimeout_Type())
...
cpLocalUserMaxBandwidthUp=_CpLocalUserMaxBandwidthUp_Object((1,3,6,1,4,1,4413,1,1,38,1,3,2,1,6),_CpLocalUserMaxBandwidthUp_Type())
...
cpLocalUserMaxBandwidthDown=_CpLocalUserMaxBandwidthDown_Object((1,3,6,1,4,1,4413,1,1,38,1,3,2,1,7),_CpLocalUserMaxBandwidthDown_Type())
cpLocalUserMaxBandwidthDown.setMaxAccess(_C)
if mibBuilder.loadTexts:cpLocalUserMaxBandwidthDown.setStatus(_A)
class _CpLocalUserMaxInputOctets_Type(Unsigned32):defaultValue=0
_CpLocalUserMaxInputOctets_Type.__name__=_F
_CpLocalUserMaxInputOctets_Object=MibTableColumn
cpLocalUserMaxInputOctets=_CpLocalUserMaxInputOctets_Object((1,3,6,1,4,1,4413,1,1,38,1,3,2,1,8),_CpLocalUserMaxInputOctets_Type())
cpLocalUserMaxInputOctets.setMaxAccess(_C)
if mibBuilder.loadTexts:cpLocalUserMaxInputOctets.setStatus(_A)
class _CpLocalUserMaxOutputOctets_Type(Unsigned32):defaultValue=0
_CpLocalUserMaxOutputOctets_Type.__name__=_F
_CpLocalUserMaxOutputOctets_Object=MibTableColumn
cpLocalUserMaxOutputOctets=_CpLocalUserMaxOutputOctets_Object((1,3,6,1,4,1,4413,1,1,38,1,3,2,1,9),_CpLocalUserMaxOutputOctets_Type())
cpLocalUserMaxOutputOctets.setMaxAccess(_C)
if mibBuilder.loadTexts:cpLocalUserMaxOutputOctets.setStatus(_A)
class _CpLocalUserMaxTotalOctets_Type(Unsigned32):defaultValue=0
_CpLocalUserMaxTotalOctets_Type.__name__=_F
_CpLocalUserMaxTotalOctets_Object=MibTableColumn
cpLocalUserMaxTotalOctets=_CpLocalUserMaxTotalOctets_Object((1,3,6,1,4,1,4413,1,1,38,1,3,2,1,10),_CpLocalUserMaxTotalOctets_Type())
...
cpCaptivePortalIntfActivationStatus=_CpCaptivePortalIntfActivationStatus_Object((1,3,6,1,4,1,4413,1,1,38,2,3,1,1,2),_CpCaptivePortalIntfActivationStatus_Type())
...
cpCaptivePortalIntfActivationDisabledReason=_CpCaptivePortalIntfActivationDisabledReason_Object((1,3,6,1,4,1,4413,1,1,38,2,3,1,1,3),_CpCaptivePortalIntfActivationDisabledReason_Type())
...
cpCaptivePortalClientSwitchMacAddress=_CpCaptivePortalClientSwitchMacAddress_Object((1,3,6,1,4,1,4413,1,1,38,2,5,1,1,9),_CpCaptivePortalClientSwitchMacAddress_Type())
...
cpCaptivePortalClientSwitchIpAddress=_CpCaptivePortalClientSwitchIpAddress_Object((1,3,6,1,4,1,4413,1,1,38,2,5,1,1,10),_CpCaptivePortalClientSwitchIpAddress_Type())
...
cpCaptivePortalClientSwitchType=_CpCaptivePortalClientSwitchType_Object((1,3,6,1,4,1,4413,1,1,38,2,5,1,1,11),_CpCaptivePortalClientSwitchType_Type())
...
cpCaptivePortalClientStatisticsTable=_CpCaptivePortalClientStatisticsTable_Object((1,3,6,1,4,1,4413,1,1,38,2,5,2))
...
cpCaptivePortalClientStatisticsEntry=_CpCaptivePortalClientStatisticsEntry_Object((1,3,6,1,4,1,4413,1,1,38,2,5,2,1))
...
cpCaptivePortalClientBytesReceived=_CpCaptivePortalClientBytesReceived_Object((1,3,6,1,4,1,4413,1,1,38,2,5,2,1,1),_CpCaptivePortalClientBytesReceived_Type())
...
cpCaptivePortalClientBytesTransmitted=_CpCaptivePortalClientBytesTransmitted_Object((1,3,6,1,4,1,4413,1,1,38,2,5,2,1,2),_CpCaptivePortalClientBytesTransmitted_Type())
...
cpCaptivePortalClientPacketsReceived=_CpCaptivePortalClientPacketsReceived_Object((1,3,6,1,4,1,4413,1,1,38,2,5,2,1,3),_CpCaptivePortalClientPacketsReceived_Type())
...
cpCaptivePortalClientPacketsTransmitted=_CpCaptivePortalClientPacketsTransmitted_Object((1,3,6,1,4,1,4413,1,1,38,2,5,2,1,4),_CpCaptivePortalClientPacketsTransmitted_Type())
...
cpCaptivePortalConfigWebGroup=_CpCaptivePortalConfigWebGroup_ObjectIdentity((1,3,6,1,4,1,4413,1,1,38,5))
_CpCaptivePortalConfigWebTable_Object=MibTable
cpCaptivePortalConfigWebTable=_CpCaptivePortalConfigWebTable_Object((1,3,6,1,4,1,4413,1,1,38,5,1))
if mibBuilder.loadTexts:cpCaptivePortalConfigWebTable.setStatus(_A)
_CpCaptivePortalConfigWebEntry_Object=MibTableRow
cpCaptivePortalConfigWebEntry=_CpCaptivePortalConfigWebEntry_Object((1,3,6,1,4,1,4413,1,1,38,5,1,1))
...
cpCaptivePortalConfigWebInstanceId=_CpCaptivePortalConfigWebInstanceId_Object((1,3,6,1,4,1,4413,1,1,38,5,1,1,1),_CpCaptivePortalConfigWebInstanceId_Type())
...
cpCaptivePortalConfigWebWebId=_CpCaptivePortalConfigWebWebId_Object((1,3,6,1,4,1,4413,1,1,38,5,1,1,2),_CpCaptivePortalConfigWebWebId_Type())
