...
# Notes
# -----
# ASN.1 source file://mibs/dell/DNOS-INVENTORY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:09:32 2025
...
fastPathInventorySlotGroup.setObjects(
      *(("DNOS-INVENTORY-MIB", "agentInventorySlotNumber"),
        ...
        ("DNOS-INVENTORY-MIB", "agentInventorySlotCapabilities"))
)
if mibBuilder.loadTexts:
...
fastPathInventoryCompliance.setObjects(
      *(("DNOS-INVENTORY-MIB", "fastPathInventorySlotGroup"),
        ("DNOS-INVENTORY-MIB", "fastPathInventoryCardGroup"),
        ("DNOS-INVENTORY-MIB", "fastPathInventoryCardGroup"),
        ("DNOS-INVENTORY-MIB", "fastPathInventoryUnitGroup"))
)
if mibBuilder.loadTexts:
