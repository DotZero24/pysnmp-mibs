...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/dell/DNOS-INVENTORY-MIB
...
if mibBuilder.loadTexts: fastPathInventory.setOrganization('Dell')
...
agentInventoryUnitStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 13, 2, 2, 1, 11), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(("ok", 1), ("unsupported", 2), ("codeMismatch", 3), ("configMismatch", 4), ("sdmMismatch", 5), ("notPresent", 6), ("codeUpdate", 7)))).setMaxAccess("readonly")
