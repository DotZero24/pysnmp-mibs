# SNMP MIB module (CAREL-ir32un_ap-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/carel/CAREL-ir32un_ap-MIB
...
if mibBuilder.loadTexts:
    differenziale1.setUnits("bar x10")
...
if mibBuilder.loadTexts:
    differenziale2.setUnits("bar x10")
...
if mibBuilder.loadTexts:
    sog_bassa_temp.setUnits("bar x10")
...
if mibBuilder.loadTexts:
    sog_alta_temp.setUnits("bar x10")
...
if mibBuilder.loadTexts:
    differenz_all.setUnits("bar x10")
