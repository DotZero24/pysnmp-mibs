...
if mibBuilder.loadTexts:set_point1.setUnits(_C)
...
if mibBuilder.loadTexts:set_point2.setUnits(_C)
...
class _Tempo_allarme_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(120,60))
