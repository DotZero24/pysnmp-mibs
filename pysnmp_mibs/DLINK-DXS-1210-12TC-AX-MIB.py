...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-DXS-1210-12TC-AX-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:50:11 2025
...
voiceVlanMode = _VoiceVlanMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 1),
    _VoiceVlanMode_Type()
)
...
voiceVlanVlanId = _VoiceVlanVlanId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 2),
...
voiceVlanQos = _VoiceVlanQos_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 3),
    _VoiceVlanQos_Type()
)
...
voiceVlanAgingTime = _VoiceVlanAgingTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 4),
...
voiceVlanOuiTable = _VoiceVlanOuiTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 5)
)
if mibBuilder.loadTexts:
    voiceVlanOuiTable.setStatus("current")
_VoiceVlanOuiEntry_Object = MibTableRow
voiceVlanOuiEntry = _VoiceVlanOuiEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 5, 1)
)
voiceVlanOuiEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "voiceVlanOuiAddr"),
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "voiceVlanOuiMask"),
)
if mibBuilder.loadTexts:
...
voiceVlanOuiAddr = _VoiceVlanOuiAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 5, 1, 1),
...
voiceVlanOuiMask = _VoiceVlanOuiMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 5, 1, 2),
...
voiceVlanOuiDes = _VoiceVlanOuiDes_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 5, 1, 3),
...
voiceVlanOuiRowStatus = _VoiceVlanOuiRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 1, 5, 1, 4),
...
voiceVlanInterfaceEntry = _VoiceVlanInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 2, 1, 1)
)
voiceVlanInterfaceEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "voiceVlanIfIndex"),
)
if mibBuilder.loadTexts:
...
voiceVlanIfIndex = _VoiceVlanIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 2, 1, 1, 1),
...
voiceVlanIfEnabled = _VoiceVlanIfEnabled_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 2, 1, 1, 2),
...
voiceVlanIfMode = _VoiceVlanIfMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 2, 1, 1, 3),
...
voiceVlanIfState = _VoiceVlanIfState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 2, 1, 1, 4),
...
voiceVlanDeviceEntry = _VoiceVlanDeviceEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 1, 1)
)
voiceVlanDeviceEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "voiceVlanDevicePortIfindex"),
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "voiceVlanDeviceAddr"),
)
if mibBuilder.loadTexts:
...
voiceVlanDevicePortIfindex = _VoiceVlanDevicePortIfindex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 1, 1, 1),
...
voiceVlanDeviceAddr = _VoiceVlanDeviceAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 1, 1, 2),
...
voiceVlanDeviceStartTime = _VoiceVlanDeviceStartTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 1, 1, 3),
...
voiceVlanDeviceStatus = _VoiceVlanDeviceStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 1, 1, 4),
...
voiceVlanLldpMedDeviceTable = _VoiceVlanLldpMedDeviceTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2)
)
if mibBuilder.loadTexts:
...
voiceVlanLldpMedDeviceEntry = _VoiceVlanLldpMedDeviceEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2, 1)
)
voiceVlanLldpMedDeviceEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "voiceVlanLldpMedDeviceIndex"),
)
if mibBuilder.loadTexts:
...
voiceVlanLldpMedDeviceIndex = _VoiceVlanLldpMedDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2, 1, 1),
...
voiceVlanLldpMedDeviceLocalPort = _VoiceVlanLldpMedDeviceLocalPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2, 1, 2),
...
voiceVlanLldpMedDevChIdSubtype = _VoiceVlanLldpMedDevChIdSubtype_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2, 1, 3),
...
voiceVlanLldpMedDevChassisId = _VoiceVlanLldpMedDevChassisId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2, 1, 4),
...
voiceVlanLldpMedDevPoIdSubtype = _VoiceVlanLldpMedDevPoIdSubtype_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2, 1, 5),
...
voiceVlanLldpMedDevicePortId = _VoiceVlanLldpMedDevicePortId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2, 1, 6),
...
voiceVlanLldpMedDevCreateTime = _VoiceVlanLldpMedDevCreateTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2, 1, 7),
...
voiceVlanLldpMedDevRemainTime = _VoiceVlanLldpMedDevRemainTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 8, 3, 2, 1, 8),
...
l2AutoSurveillanceVlanGroup = _L2AutoSurveillanceVlanGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9)
)
...
autoSurveillanceVlanGlobal = _AutoSurveillanceVlanGlobal_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1)
)
...
autoSurveillanceVlanMode = _AutoSurveillanceVlanMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 1),
...
autoSurveillanceVlanId = _AutoSurveillanceVlanId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 2),
...
autoSurveillanceVlanQos = _AutoSurveillanceVlanQos_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 3),
...
autoSurveillanceVlanAgingTime = _AutoSurveillanceVlanAgingTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 4),
...
autoSurveillanceVlanOuiTable = _AutoSurveillanceVlanOuiTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 5)
)
if mibBuilder.loadTexts:
...
autoSurveillanceVlanOuiEntry = _AutoSurveillanceVlanOuiEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 5, 1)
)
autoSurveillanceVlanOuiEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "autoSurveillanceVlanOuiAddr"),
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "autoSurveillanceVlanOuiMask"),
)
if mibBuilder.loadTexts:
...
autoSurveillanceVlanOuiAddr = _AutoSurveillanceVlanOuiAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 5, 1, 1),
...
autoSurveillanceVlanOuiMask = _AutoSurveillanceVlanOuiMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 5, 1, 2),
...
autoSurveillanceVlanOuiComponentType = _AutoSurveillanceVlanOuiComponentType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 5, 1, 3),
...
autoSurveillanceVlanOuiDescription = _AutoSurveillanceVlanOuiDescription_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 5, 1, 4),
...
autoSurveillanceVlanOuiRowStatus = _AutoSurveillanceVlanOuiRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 1, 5, 1, 5),
...
autoSurveillanceVlanInterface = _AutoSurveillanceVlanInterface_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 2)
)
...
autoSurveillanceVlanInterfaceTable = _AutoSurveillanceVlanInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 2, 1)
)
if mibBuilder.loadTexts:
...
autoSurveillanceVlanInterfaceEntry = _AutoSurveillanceVlanInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 2, 1, 1)
)
autoSurveillanceVlanInterfaceEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "autoSurveillanceVlanIfIndex"),
)
if mibBuilder.loadTexts:
...
autoSurveillanceVlanIfIndex = _AutoSurveillanceVlanIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 2, 1, 1, 1),
...
autoSurveillanceVlanIfEnabled = _AutoSurveillanceVlanIfEnabled_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 2, 1, 1, 2),
...
autoSurveillanceVlanDeviceEntry = _AutoSurveillanceVlanDeviceEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 3, 1, 1)
)
autoSurveillanceVlanDeviceEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "autoSurveillanceVlanDevicePortIfIdx"),
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "autoSurveillanceVlanDeviceAddr"),
)
if mibBuilder.loadTexts:
...
autoSurveillanceVlanDevicePortIfIdx = _AutoSurveillanceVlanDevicePortIfIdx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 3, 1, 1, 1),
...
autoSurveillanceVlanDeviceAddr = _AutoSurveillanceVlanDeviceAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 3, 1, 1, 2),
...
autoSurveillanceVlanDeviceCompType = _AutoSurveillanceVlanDeviceCompType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 3, 1, 1, 3),
...
autoSurveillanceVlanDeviceDescr = _AutoSurveillanceVlanDeviceDescr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 3, 1, 1, 4),
...
autoSurveillanceVlanDeviceStartTime = _AutoSurveillanceVlanDeviceStartTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 3, 1, 1, 5),
...
autoSurveillanceVlanDeviceStatus = _AutoSurveillanceVlanDeviceStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 9, 3, 1, 1, 6),
...
erpsInstanceId = _ErpsInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 1),
...
erpsRingName = _ErpsRingName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 2),
    _ErpsRingName_Type()
)
...
erpsPort0 = _ErpsPort0_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 3),
    _ErpsPort0_Type()
)
...
erpsPort1 = _ErpsPort1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 4),
    _ErpsPort1_Type()
)
...
erpsInstDescription = _ErpsInstDescription_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 5),
...
erpsRapsVlan = _ErpsRapsVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 6),
    _ErpsRapsVlan_Type()
)
...
erpsInclusionVlan = _ErpsInclusionVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 7),
...
erpsInstMel = _ErpsInstMel_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 8),
    _ErpsInstMel_Type()
)
...
erpsInstProfileName = _ErpsInstProfileName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 9),
...
erpsRplPort = _ErpsRplPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 10),
    _ErpsRplPort_Type()
)
...
erpsRplOwner = _ErpsRplOwner_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 11),
    _ErpsRplOwner_Type()
)
...
erpsInstGuardTimer = _ErpsInstGuardTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 12),
...
erpsInstHoldOffTimer = _ErpsInstHoldOffTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 13),
...
erpsInstWTRTimer = _ErpsInstWTRTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 14),
...
erpsInstRevertive = _ErpsInstRevertive_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 15),
...
erpsInstState = _ErpsInstState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 16),
    _ErpsInstState_Type()
)
...
erpsInstAdminRpl = _ErpsInstAdminRpl_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 17),
...
erpsInstOperaRpl = _ErpsInstOperaRpl_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 18),
...
erpsInstPort0State = _ErpsInstPort0State_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 19),
...
erpsInstPort1State = _ErpsInstPort1State_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 20),
...
erpsInstAdminRplPort = _ErpsInstAdminRplPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 21),
...
erpsInstOperaRplPort = _ErpsInstOperaRplPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 22),
...
erpsInstRowStatus = _ErpsInstRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 1, 1, 1, 23),
...
erpsProfileId = _ErpsProfileId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 2, 1, 1, 1),
    _ErpsProfileId_Type()
)
...
erpsProfileName = _ErpsProfileName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 2, 1, 1, 2),
...
erpsProfileRevertive = _ErpsProfileRevertive_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 2, 1, 1, 3),
...
erpsProfileGuardTimer = _ErpsProfileGuardTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 2, 1, 1, 4),
...
erpsProfileHoldOffTimer = _ErpsProfileHoldOffTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 2, 1, 1, 5),
...
erpsProfileWTRTimer = _ErpsProfileWTRTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 2, 1, 1, 6),
...
erpsProfileRowStatus = _ErpsProfileRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 4, 10, 2, 1, 1, 7),
...
multiRouteConfigEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "multiRouteConfigDest"),
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "multiRouteConfigMask"),
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "multiRouteConfigNextHop"),
)
if mibBuilder.loadTexts:
...
multiRouteProto = _MultiRouteProto_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 4, 1, 5),
...
multiRouteMetric = _MultiRouteMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 4, 1, 6),
...
multiRoutePreference = _MultiRoutePreference_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 4, 1, 7),
...
multiIpv6AddrOperStatus = _MultiIpv6AddrOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 6, 1, 7),
...
multiIpv6StaticRouteEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "multiIpv6StaticRouteDest"),
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "multiIpv6StaticRoutePfxLength"),
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "multiIpv6StaticRouteNextHop"),
)
if mibBuilder.loadTexts:
...
multiIpv6RouteNextHop = _MultiIpv6RouteNextHop_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 9, 1, 4),
...
multiIpv6RouteIfIndex = _MultiIpv6RouteIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 9, 1, 5),
...
multiIpv6RouteMetric = _MultiIpv6RouteMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 9, 1, 6),
...
multiIpv6RoutePreference = _MultiIpv6RoutePreference_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 9, 1, 7),
...
dhcpClientIfIndex = _DhcpClientIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 10, 1, 1),
...
dhcpClientClientIdIfIdx = _DhcpClientClientIdIfIdx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 10, 1, 2),
...
dhcpClientClassIdType = _DhcpClientClassIdType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 10, 1, 3),
...
dhcpClientClassId = _DhcpClientClassId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 10, 1, 4),
...
dhcpClientHostName = _DhcpClientHostName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 10, 1, 5),
...
dhcpClientLeaseDay = _DhcpClientLeaseDay_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 10, 1, 6),
...
dhcpClientLeaseHour = _DhcpClientLeaseHour_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 10, 1, 7),
...
dhcpClientLeaseMinute = _DhcpClientLeaseMinute_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 10, 1, 8),
...
dhcp6ClientIndex = _Dhcp6ClientIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 11, 1, 1),
...
dhcp6ClientEnabled = _Dhcp6ClientEnabled_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 11, 1, 2),
...
dhcp6ClientRapidCommit = _Dhcp6ClientRapidCommit_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 11, 1, 3),
...
dhcpRetryCount = _DhcpRetryCount_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 5, 3, 12),
...
pnacState = _PnacState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 1, 1),
    _PnacState_Type()
)
...
pnacTrapState = _PnacTrapState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 1, 2),
    _PnacTrapState_Type()
)
...
pnacPortSettingsEntry = _PnacPortSettingsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1)
)
pnacPortSettingsEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "pnacPortNumber"),
)
if mibBuilder.loadTexts:
...
pnacPortNumber = _PnacPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 1),
...
pnacDirection = _PnacDirection_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 2),
    _PnacDirection_Type()
)
...
pnacPortControl = _PnacPortControl_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 3),
...
pnacForwardPDU = _PnacForwardPDU_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 4),
...
pnacMaxReq = _PnacMaxReq_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 5),
    _PnacMaxReq_Type()
)
...
pnacPAEAuthenticator = _PnacPAEAuthenticator_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 6),
...
pnacServerTimeout = _PnacServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 7),
...
pnacSuppTimeout = _PnacSuppTimeout_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 8),
...
pnacTxPeriod = _PnacTxPeriod_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 9),
    _PnacTxPeriod_Type()
)
...
pnacAuthStatsClear = _PnacAuthStatsClear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 10),
...
pnacAuthSessStatsClear = _PnacAuthSessStatsClear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 11),
...
pnacAuthDiagClear = _PnacAuthDiagClear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 2, 1, 1, 12),
...
pnacPortAuthSessionInfoEntry = _PnacPortAuthSessionInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 1, 1)
)
pnacPortAuthSessionInfoEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "pnacPortAuthPortNumber"),
)
if mibBuilder.loadTexts:
...
pnacPortAuthPortNumber = _PnacPortAuthPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 1, 1, 1),
...
pnacPortAuthMac = _PnacPortAuthMac_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 1, 1, 2),
...
pnacPortAuthPortInit = _PnacPortAuthPortInit_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 1, 1, 3),
...
pnacPortAuthPortReauth = _PnacPortAuthPortReauth_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 1, 1, 4),
...
pnacMacAuthSessionInfoTable = _PnacMacAuthSessionInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 2)
)
if mibBuilder.loadTexts:
...
pnacMacAuthSessionInfoEntry = _PnacMacAuthSessionInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 2, 1)
)
pnacMacAuthSessionInfoEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "pnacMacAuthMacAddr"),
)
if mibBuilder.loadTexts:
...
pnacMacAuthMacAddr = _PnacMacAuthMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 2, 1, 1),
...
pnacMacAuthPortNumber = _PnacMacAuthPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 2, 1, 2),
...
pnacMacAuthInit = _PnacMacAuthInit_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 2, 1, 3),
...
pnacMacAuthReauth = _PnacMacAuthReauth_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 3, 2, 1, 4),
...
pnacPortAuthStatsEntry = _PnacPortAuthStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1)
)
pnacPortAuthStatsEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "pnacPortAuthStatsPortNumber"),
)
if mibBuilder.loadTexts:
...
pnacPortAuthStatsPortNumber = _PnacPortAuthStatsPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 1),
...
pnacPortAuthEapolFramesRx = _PnacPortAuthEapolFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 2),
...
pnacPortAuthEapolFramesTx = _PnacPortAuthEapolFramesTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 3),
...
pnacPortAuthEapolStartFramesRx = _PnacPortAuthEapolStartFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 4),
...
pnacPortAuthEapolLogoffFramesRx = _PnacPortAuthEapolLogoffFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 5),
...
pnacPortAuthEapolRespIdFramesRx = _PnacPortAuthEapolRespIdFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 6),
...
pnacPortAuthEapolRespFramesRx = _PnacPortAuthEapolRespFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 7),
...
pnacPortAuthEapolReqIdFramesTx = _PnacPortAuthEapolReqIdFramesTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 8),
...
pnacPortAuthEapolReqFramesTx = _PnacPortAuthEapolReqFramesTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 9),
...
pnacPortAuthInvalidEapolFramesRx = _PnacPortAuthInvalidEapolFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 10),
...
pnacPortAuthEapLengthErrorFramesRx = _PnacPortAuthEapLengthErrorFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 11),
...
pnacPortAuthLastEapolFrameVersion = _PnacPortAuthLastEapolFrameVersion_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 12),
...
pnacPortAuthLastEapolFrameSource = _PnacPortAuthLastEapolFrameSource_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 1, 1, 13),
...
pnacMacAuthStatsTable = _PnacMacAuthStatsTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2)
)
if mibBuilder.loadTexts:
...
pnacMacAuthStatsEntry = _PnacMacAuthStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1)
)
pnacMacAuthStatsEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "pnacMacAuthStatsMacAddr"),
)
if mibBuilder.loadTexts:
...
pnacMacAuthStatsMacAddr = _PnacMacAuthStatsMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 1),
...
pnacMacAuthEapolFramesRx = _PnacMacAuthEapolFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 2),
...
pnacMacAuthEapolFramesTx = _PnacMacAuthEapolFramesTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 3),
...
pnacMacAuthEapolStartFramesRx = _PnacMacAuthEapolStartFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 4),
...
pnacMacAuthEapolLogoffFramesRx = _PnacMacAuthEapolLogoffFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 5),
...
pnacMacAuthEapolRespIdFramesRx = _PnacMacAuthEapolRespIdFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 6),
...
pnacMacAuthEapolRespFramesRx = _PnacMacAuthEapolRespFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 7),
...
pnacMacAuthEapolReqIdFramesTx = _PnacMacAuthEapolReqIdFramesTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 8),
...
pnacMacAuthEapolReqFramesTx = _PnacMacAuthEapolReqFramesTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 9),
...
pnacMacAuthInvalidEapolFramesRx = _PnacMacAuthInvalidEapolFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 10),
...
pnacMacAuthEapLengthErrorFramesRx = _PnacMacAuthEapLengthErrorFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 11),
...
pnacMacAuthLastEapolFrameVersion = _PnacMacAuthLastEapolFrameVersion_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 12),
...
pnacMacAuthLastEapolFrameSource = _PnacMacAuthLastEapolFrameSource_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 13),
...
pnacMacAuthStatsPortNumber = _PnacMacAuthStatsPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 4, 2, 1, 14),
...
pnacPortAuthSessionStatsEntry = _PnacPortAuthSessionStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1)
)
pnacPortAuthSessionStatsEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "pnacPortAuthSessionPortNumber"),
)
if mibBuilder.loadTexts:
...
pnacPortAuthSessionPortNumber = _PnacPortAuthSessionPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 1),
...
pnacPortAuthSessionOctetsRx = _PnacPortAuthSessionOctetsRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 2),
...
pnacPortAuthSessionOctetsTx = _PnacPortAuthSessionOctetsTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 3),
...
pnacPortAuthSessionFramesRx = _PnacPortAuthSessionFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 4),
...
pnacPortAuthSessionFramesTx = _PnacPortAuthSessionFramesTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 5),
...
pnacPortAuthSessionId = _PnacPortAuthSessionId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 6),
...
pnacPortAuthSessionAuthenticMethod = _PnacPortAuthSessionAuthenticMethod_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 7),
...
pnacPortAuthSessionTime = _PnacPortAuthSessionTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 8),
...
pnacPortAuthSessionTerminateCause = _PnacPortAuthSessionTerminateCause_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 9),
...
pnacPortAuthSessionUserName = _PnacPortAuthSessionUserName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 1, 1, 10),
...
pnacMacAuthSessionStatsTable = _PnacMacAuthSessionStatsTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2)
)
if mibBuilder.loadTexts:
...
pnacMacAuthSessionStatsEntry = _PnacMacAuthSessionStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1)
)
pnacMacAuthSessionStatsEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "pnacMacAuthSessionSuppAddress"),
)
if mibBuilder.loadTexts:
...
pnacMacAuthSessionSuppAddress = _PnacMacAuthSessionSuppAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 1),
...
pnacMacAuthSessionOctetsRx = _PnacMacAuthSessionOctetsRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 2),
...
pnacMacAuthSessionOctetsTx = _PnacMacAuthSessionOctetsTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 3),
...
pnacMacAuthSessionFramesRx = _PnacMacAuthSessionFramesRx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 4),
...
pnacMacAuthSessionFramesTx = _PnacMacAuthSessionFramesTx_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 5),
...
pnacMacAuthSessionId = _PnacMacAuthSessionId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 6),
...
pnacMacAuthSessionAuthenticMethod = _PnacMacAuthSessionAuthenticMethod_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 7),
...
pnacMacAuthSessionTime = _PnacMacAuthSessionTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 8),
...
pnacMacAuthSessionTerminateCause = _PnacMacAuthSessionTerminateCause_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 9),
...
pnacMacAuthSessionUserName = _PnacMacAuthSessionUserName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 10),
...
pnacMacAuthSessionPortNumber = _PnacMacAuthSessionPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 5, 2, 1, 11),
...
pnacPortAuthDiagEntry = _PnacPortAuthDiagEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1)
)
pnacPortAuthDiagEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "pnacPortAuthDiagPortNumber"),
)
if mibBuilder.loadTexts:
...
pnacPortAuthDiagPortNumber = _PnacPortAuthDiagPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 1),
...
pnacPortAuthEntersConnecting = _PnacPortAuthEntersConnecting_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 2),
...
pnacPortAuthEapLogoffsWhileConnecting = _PnacPortAuthEapLogoffsWhileConnecting_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 3),
...
pnacPortAuthEntersAuthenticating = _PnacPortAuthEntersAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 4),
...
pnacPortAuthAuthSuccessWhileAuthenticating = _PnacPortAuthAuthSuccessWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 5),
...
pnacPortAuthAuthTimeoutsWhileAuthenticating = _PnacPortAuthAuthTimeoutsWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 6),
...
pnacPortAuthAuthFailWhileAuthenticating = _PnacPortAuthAuthFailWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 7),
...
pnacPortAuthAuthReauthsWhileAuthenticating = _PnacPortAuthAuthReauthsWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 8),
...
pnacPortAuthAuthEapStartsWhileAuthenticating = _PnacPortAuthAuthEapStartsWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 9),
...
pnacPortAuthAuthEapLogoffWhileAuthenticating = _PnacPortAuthAuthEapLogoffWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 10),
...
pnacPortAuthAuthReauthsWhileAuthenticated = _PnacPortAuthAuthReauthsWhileAuthenticated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 11),
...
pnacPortAuthAuthEapStartsWhileAuthenticated = _PnacPortAuthAuthEapStartsWhileAuthenticated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 12),
...
pnacPortAuthAuthEapLogoffWhileAuthenticated = _PnacPortAuthAuthEapLogoffWhileAuthenticated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 13),
...
pnacPortAuthBackendResponses = _PnacPortAuthBackendResponses_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 14),
...
pnacPortAuthBackendAccessChallenges = _PnacPortAuthBackendAccessChallenges_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 15),
...
pnacPortAuthBackendOtherRequestsToSupplicant = _PnacPortAuthBackendOtherRequestsToSupplicant_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 16),
...
pnacPortAuthBackendNonNakResponsesFromSupplicant = _PnacPortAuthBackendNonNakResponsesFromSupplicant_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 17),
...
pnacPortAuthBackendAuthSuccesses = _PnacPortAuthBackendAuthSuccesses_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 18),
...
pnacPortAuthBackendAuthFails = _PnacPortAuthBackendAuthFails_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 1, 1, 19),
...
pnacMacAuthDiagStatsTable = _PnacMacAuthDiagStatsTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2)
)
if mibBuilder.loadTexts:
...
pnacMacAuthDiagStatsEntry = _PnacMacAuthDiagStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1)
)
pnacMacAuthDiagStatsEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "pnacMacAuthDiagSuppAddress"),
)
if mibBuilder.loadTexts:
...
pnacMacAuthDiagSuppAddress = _PnacMacAuthDiagSuppAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 1),
...
pnacMacAuthEntersConnecting = _PnacMacAuthEntersConnecting_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 2),
...
pnacMacAuthEapLogoffsWhileConnecting = _PnacMacAuthEapLogoffsWhileConnecting_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 3),
...
pnacMacAuthEntersAuthenticating = _PnacMacAuthEntersAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 4),
...
pnacMacAuthAuthSuccessWhileAuthenticating = _PnacMacAuthAuthSuccessWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 5),
...
pnacMacAuthAuthTimeoutsWhileAuthenticating = _PnacMacAuthAuthTimeoutsWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 6),
...
pnacMacAuthAuthFailWhileAuthenticating = _PnacMacAuthAuthFailWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 7),
...
pnacMacAuthAuthReauthsWhileAuthenticating = _PnacMacAuthAuthReauthsWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 8),
...
pnacMacAuthAuthEapStartsWhileAuthenticating = _PnacMacAuthAuthEapStartsWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 9),
...
pnacMacAuthAuthEapLogoffWhileAuthenticating = _PnacMacAuthAuthEapLogoffWhileAuthenticating_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 10),
...
pnacMacAuthAuthReauthsWhileAuthenticated = _PnacMacAuthAuthReauthsWhileAuthenticated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 11),
...
pnacMacAuthAuthEapStartsWhileAuthenticated = _PnacMacAuthAuthEapStartsWhileAuthenticated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 12),
...
pnacMacAuthAuthEapLogoffWhileAuthenticated = _PnacMacAuthAuthEapLogoffWhileAuthenticated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 13),
...
pnacMacAuthBackendResponses = _PnacMacAuthBackendResponses_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 14),
...
pnacMacAuthBackendAccessChallenges = _PnacMacAuthBackendAccessChallenges_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 15),
...
pnacMacAuthBackendOtherRequestsToSupplicant = _PnacMacAuthBackendOtherRequestsToSupplicant_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 16),
...
pnacMacAuthBackendNonNakResponsesFromSupplicant = _PnacMacAuthBackendNonNakResponsesFromSupplicant_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 17),
...
pnacMacAuthBackendAuthSuccesses = _PnacMacAuthBackendAuthSuccesses_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 18),
...
pnacMacAuthBackendAuthFails = _PnacMacAuthBackendAuthFails_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 19),
...
pnacMacAuthDiagPortNumber = _PnacMacAuthDiagPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 6, 2, 1, 20),
...
aaaState = _AaaState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 1, 1),
    _AaaState_Type()
)
...
aaaNETAuthType = _AaaNETAuthType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 1),
...
aaaNETAuthStatus = _AaaNETAuthStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 2),
...
aaaNETAuthFirstMethod = _AaaNETAuthFirstMethod_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 3),
...
aaaNETAuthFirstServerGroupName = _AaaNETAuthFirstServerGroupName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 4),
...
aaaNETAuthSecondMethod = _AaaNETAuthSecondMethod_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 5),
...
aaaNETAuthSecondServerGroupName = _AaaNETAuthSecondServerGroupName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 6),
...
aaaNETAuthThirdMethod = _AaaNETAuthThirdMethod_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 7),
...
aaaNETAuthThirdServerGroupName = _AaaNETAuthThirdServerGroupName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 8),
...
aaaNETAuthForthMethod = _AaaNETAuthForthMethod_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 9),
...
aaaNETAuthForthServerGroupName = _AaaNETAuthForthServerGroupName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 3, 2, 1, 1, 10),
...
radiusServerDeadTime = _RadiusServerDeadTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 1, 1),
...
radiusServerIndex = _RadiusServerIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 2, 1, 1, 1),
...
radiusServerIPType = _RadiusServerIPType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 2, 1, 1, 2),
...
radiusServerAddress = _RadiusServerAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 2, 1, 1, 3),
...
radiusServerAuthPort = _RadiusServerAuthPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 2, 1, 1, 4),
...
radiusServerRetransmit = _RadiusServerRetransmit_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 2, 1, 1, 5),
...
radiusServerTimeout = _RadiusServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 2, 1, 1, 6),
...
radiusServerKeyType = _RadiusServerKeyType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 2, 1, 1, 7),
...
radiusServerKey = _RadiusServerKey_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 2, 1, 1, 8),
...
radiusServerRowStatus = _RadiusServerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 2, 1, 1, 9),
...
radiusServerGroupEntry = _RadiusServerGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 3, 1, 1)
)
radiusServerGroupEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "radiusServerGroupName"),
)
if mibBuilder.loadTexts:
...
radiusServerGroupName = _RadiusServerGroupName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 3, 1, 1, 1),
...
radiusServersInGroup = _RadiusServersInGroup_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 3, 1, 1, 2),
...
radiusServerGroupRowStatus = _RadiusServerGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 3, 1, 1, 3),
...
radiusAuthServerEntry = _RadiusAuthServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1)
)
radiusAuthServerEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "radiusAuthServerIndex"),
)
if mibBuilder.loadTexts:
...
radiusAuthServerIndex = _RadiusAuthServerIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 1),
...
radiusAuthClientRoundTripTime = _RadiusAuthClientRoundTripTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 2),
...
radiusAuthClientAccessRequests = _RadiusAuthClientAccessRequests_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 3),
...
radiusAuthClientAccessRetransmissions = _RadiusAuthClientAccessRetransmissions_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 4),
...
radiusAuthClientAccessAccepts = _RadiusAuthClientAccessAccepts_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 5),
...
radiusAuthClientAccessRejects = _RadiusAuthClientAccessRejects_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 6),
...
radiusAuthClientAccessChallenges = _RadiusAuthClientAccessChallenges_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 7),
...
radiusAuthClientMalformedAccessResponses = _RadiusAuthClientMalformedAccessResponses_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 8),
...
radiusAuthClientBadAuthenticators = _RadiusAuthClientBadAuthenticators_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 9),
...
radiusAuthClientPendingRequests = _RadiusAuthClientPendingRequests_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 10),
...
radiusAuthClientTimeouts = _RadiusAuthClientTimeouts_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 11),
...
radiusAuthClientUnknownTypes = _RadiusAuthClientUnknownTypes_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 12),
...
radiusAuthClientPacketsDropped = _RadiusAuthClientPacketsDropped_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 13),
...
radiusAuthClientStatisticClear = _RadiusAuthClientStatisticClear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 4, 4, 1, 1, 14),
...
securityNetworkAuthGroup = _SecurityNetworkAuthGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12)
)
...
networkAuthGlobalSettings = _NetworkAuthGlobalSettings_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1)
)
...
networkAuthDenyMacMove = _NetworkAuthDenyMacMove_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1, 1),
...
networkAuthorizationState = _NetworkAuthorizationState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1, 2),
...
networkAuthUserTable = _NetworkAuthUserTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1, 3)
)
if mibBuilder.loadTexts:
...
networkAuthUserEntry = _NetworkAuthUserEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1, 3, 1)
)
networkAuthUserEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "networkAuthUserName"),
)
if mibBuilder.loadTexts:
...
networkAuthUserName = _NetworkAuthUserName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1, 3, 1, 1),
...
networkAuthUserAssignVlan = _NetworkAuthUserAssignVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1, 3, 1, 2),
...
networkAuthUserPasswordType = _NetworkAuthUserPasswordType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1, 3, 1, 3),
...
networkAuthUserPassword = _NetworkAuthUserPassword_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1, 3, 1, 4),
...
networkAuthUserStatus = _NetworkAuthUserStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 1, 3, 1, 5),
...
networkAuthPortSettingsEntry = _NetworkAuthPortSettingsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 2, 1, 1)
)
networkAuthPortSettingsEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "networkAuthPortNumber"),
)
if mibBuilder.loadTexts:
...
networkAuthPortNumber = _NetworkAuthPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 2, 1, 1, 1),
...
networkAuthHostMode = _NetworkAuthHostMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 2, 1, 1, 2),
...
networkAuthHostVlanList = _NetworkAuthHostVlanList_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 2, 1, 1, 3),
...
networkAuthPeriodic = _NetworkAuthPeriodic_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 2, 1, 1, 4),
...
networkAuthReAuthTimer = _NetworkAuthReAuthTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 2, 1, 1, 5),
...
networkAuthRestart = _NetworkAuthRestart_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 2, 1, 1, 6),
...
networkAuthGuestVlan = _NetworkAuthGuestVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 2, 1, 1, 7),
...
networkPortAuthSessionInfoEntry = _NetworkPortAuthSessionInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1)
)
networkPortAuthSessionInfoEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "networkPortAuthPortNumber"),
)
if mibBuilder.loadTexts:
...
networkPortAuthPortNumber = _NetworkPortAuthPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 1),
...
networkPortAuthMac = _NetworkPortAuthMac_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 2),
...
networkPortAuthVlan = _NetworkPortAuthVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 3),
...
networkPortAuthUserName = _NetworkPortAuthUserName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 4),
...
networkPortAuthPaeState = _NetworkPortAuthPaeState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 5),
...
networkPortAuthBackendState = _NetworkPortAuthBackendState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 6),
...
networkPortAuthFailReason = _NetworkPortAuthFailReason_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 7),
...
networkPortAuthAssignIngressBandwidth = _NetworkPortAuthAssignIngressBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 8),
...
networkPortAuthAssignEgressBandwidth = _NetworkPortAuthAssignEgressBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 9),
...
networkPortAuthAssignPriority = _NetworkPortAuthAssignPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 1, 1, 10),
...
networkMacAuthSessionInfoTable = _NetworkMacAuthSessionInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 2)
)
if mibBuilder.loadTexts:
...
networkMacAuthSessionInfoEntry = _NetworkMacAuthSessionInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 2, 1)
)
networkMacAuthSessionInfoEntry.setIndexNames(
    (0, "DLINK-DXS-1210-12TC-AX-MIB", "networkMacAuthMacAddr"),
)
if mibBuilder.loadTexts:
...
networkMacAuthMacAddr = _NetworkMacAuthMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 2, 1, 1),
...
networkMacAuthPortNumber = _NetworkMacAuthPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 2, 1, 2),
...
networkMacAuthVlan = _NetworkMacAuthVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 2, 1, 3),
...
networkMacAuthUserName = _NetworkMacAuthUserName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 2, 1, 4),
...
networkMacAuthPaeState = _NetworkMacAuthPaeState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 2, 1, 5),
...
networkMacAuthBackendState = _NetworkMacAuthBackendState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 2, 1, 6),
...
networkMacAuthFailReason = _NetworkMacAuthFailReason_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 12, 3, 2, 1, 7),
...
pnacAuthNotifyAuthSuccess = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 7, 0, 1)
)
if mibBuilder.loadTexts:
...
pnacAuthNotifyAuthFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 139, 1, 1, 8, 2, 7, 0, 2)
)
if mibBuilder.loadTexts:
