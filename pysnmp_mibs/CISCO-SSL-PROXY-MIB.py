...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SSL-PROXY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:41:01 2025
...
_CspGcNotifyProxyServOperStatus_Type.__name__ = "TruthValue"
...
_CspGcNotifyPSCertExpiring_Type.__name__ = "TruthValue"
...
_CspPsVirtualAddressType_Type.__name__ = "InetAddressType"
...
_CspPsServerAddressType_Type.__name__ = "InetAddressType"
...
_CspSpCloseProtocol_Type.__name__ = "TruthValue"
...
cspMIBCompliance.setObjects(
      *(("CISCO-SSL-PROXY-MIB", "cspGlobalConfigGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspProxyServiceConfigGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSslGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSsl3Group"),
        ("CISCO-SSL-PROXY-MIB", "cspTls1Group"),
        ("CISCO-SSL-PROXY-MIB", "cspPolicyConfigGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspTcpGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSslCryptoGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSslErrorGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspProxyServiceStatsGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspProxyServiceSsl3Group"),
        ("CISCO-SSL-PROXY-MIB", "cspProxyServiceTls1Group"),
        ("CISCO-SSL-PROXY-MIB", "cspCpuStatusGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspProxyServiceNotificationGroup"))
)
if mibBuilder.loadTexts:
...
cspMIBComplianceRev1.setObjects(
      *(("CISCO-SSL-PROXY-MIB", "cspGlobalConfigGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspProxyServiceConfigGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSslGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSsl3Group"),
        ("CISCO-SSL-PROXY-MIB", "cspTls1Group"),
        ("CISCO-SSL-PROXY-MIB", "cspHttpHeaderInsertedSslInfoGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspHttpHeaderInsertedSslClientCertGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspHttpRedirectInfoGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspPolicyConfigGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspTcpGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSslCryptoGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSslErrorGroup"),
...
cspMIBComplianceRev2.setObjects(
      *(("CISCO-SSL-PROXY-MIB", "cspGlobalConfigGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspProxyServiceConfigGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSslGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSsl3Group"),
        ...
        ("CISCO-SSL-PROXY-MIB", "cspCpuStatusGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspProxyServiceNotificationGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSslResourceLimitNotifObjectsGroup"),
        ("CISCO-SSL-PROXY-MIB", "cspSslResourceLimitNotifGroup"))
)
if mibBuilder.loadTexts:
