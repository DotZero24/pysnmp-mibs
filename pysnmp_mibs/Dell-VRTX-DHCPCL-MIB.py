# SNMP MIB module (Dell-VRTX-DHCPCL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-VRTX-DHCPCL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:32 2025
...
rlDhcpClActionEntry.setIndexNames(
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpClActionIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpApprovalWaitingEntry.setIndexNames(
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpApprovalWaitingIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpApprovalActionEntry.setIndexNames(
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpApprovalActionIfIndex"),
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpApprovalActionAddress"),
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpApprovalActionMask"),
)
if mibBuilder.loadTexts:
...
rlDhcpClManualAutoConfigDataEntry.setIndexNames(
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpClManualAutoConfigDataIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpClInformationEntry.setIndexNames(
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpClInformationIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpClInformationDnsServerListEntry.setIndexNames(
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpClInformationDnsServerListIfIndex"),
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpClInformationDnsServerListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpClInformationTftpServerListEntry.setIndexNames(
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpClInformationTftpServerListIfIndex"),
    (0, "Dell-VRTX-DHCPCL-MIB", "rlDhcpClInformationTftpServerListPriority"),
)
if mibBuilder.loadTexts:
