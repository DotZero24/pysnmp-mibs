...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/BASIS-SHELF-MIB
...
mibBuilder.exportSymbols("BASIS-SHELF-MIB", axisSvcBilling=axisSvcBilling, statsCollectionInterval=statsCollectionInterval, redCoveringSlot=redCoveringSlot, axisSvcBillingBucketInterval=axisSvcBillingBucketInterval, axisSvcBillingColInterval=axisSvcBillingColInterval, redPrimaryState=redPrimaryState, shelfIntegratedAlarm=shelfIntegratedAlarm, redPrimaryType=redPrimaryType, axisFeederTkNo=axisFeederTkNo, shelfTmZnGMTOff=shelfTmZnGMTOff, shelfBkplnSerialNumDeprecated=shelfBkplnSerialNumDeprecated, shelfTmZn=shelfTmZn, redLineModuleType=redLineModuleType, apsIpAddress=apsIpAddress, shelfNodeName=shelfNodeName, redSecondaryState=redSecondaryState, shelfEntry=shelfEntry, redPrimarySlotNum=redPrimarySlotNum, shelfFunctionModuleHoldReset=shelfFunctionModuleHoldReset, shelfBkPlnType=shelfBkPlnType, shelfDate=shelfDate, clkRate=clkRate, shelfSlotNum=shelfSlotNum, shelfBkplnSerialNum=shelfBkplnSerialNum, shelfNumOfValidEntries=shelfNumOfValidEntries, statsBucketInterval=statsBucketInterval, shelfCBClkRateEntry=shelfCBClkRateEntry, shelfTable=shelfTable, smRedMapEntry=smRedMapEntry, userName=userName, shelfNum=shelfNum, shelfPowerSupplyVoltage=shelfPowerSupplyVoltage, shelfTime=shelfTime, statsMasterIpAddress=statsMasterIpAddress, shelfFunctionModuleState=shelfFunctionModuleState, redFeature=redFeature, shelfCBClkRateTable=shelfCBClkRateTable, smRedMapTable=smRedMapTable, shelfFunctionModuleType=shelfFunctionModuleType, redundantApsIpAddress=redundantApsIpAddress, cBNum=cBNum, redSecondaryType=redSecondaryType, redSecondarySlotNum=redSecondarySlotNum, shelfAlarmCardBitMap=shelfAlarmCardBitMap, redRowStatus=redRowStatus, redType=redType)
