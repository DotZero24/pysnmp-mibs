...
mibBuilder.exportSymbols("BASIS-SHELF-MIB", shelfTmZnGMTOff=shelfTmZnGMTOff, cBNum=cBNum, redSecondaryType=redSecondaryType, statsBucketInterval=statsBucketInterval, statsCollectionInterval=statsCollectionInterval, shelfTmZn=shelfTmZn, shelfBkPlnType=shelfBkPlnType, redRowStatus=redRowStatus, shelfBkplnSerialNum=shelfBkplnSerialNum, redPrimarySlotNum=redPrimarySlotNum, redPrimaryType=redPrimaryType, statsMasterIpAddress=statsMasterIpAddress, shelfCBClkRateEntry=shelfCBClkRateEntry, shelfAlarmCardBitMap=shelfAlarmCardBitMap, redundantApsIpAddress=redundantApsIpAddress, shelfDate=shelfDate, redSecondarySlotNum=redSecondarySlotNum, shelfFunctionModuleType=shelfFunctionModuleType, axisSvcBillingColInterval=axisSvcBillingColInterval, redSecondaryState=redSecondaryState, shelfNum=shelfNum, redType=redType, redLineModuleType=redLineModuleType, clkRate=clkRate, shelfTime=shelfTime, shelfTable=shelfTable, shelfNumOfValidEntries=shelfNumOfValidEntries, shelfEntry=shelfEntry, shelfIntegratedAlarm=shelfIntegratedAlarm, redPrimaryState=redPrimaryState, shelfPowerSupplyVoltage=shelfPowerSupplyVoltage, redFeature=redFeature, axisSvcBillingBucketInterval=axisSvcBillingBucketInterval, shelfSlotNum=shelfSlotNum, shelfCBClkRateTable=shelfCBClkRateTable, shelfBkplnSerialNumDeprecated=shelfBkplnSerialNumDeprecated, smRedMapEntry=smRedMapEntry, redCoveringSlot=redCoveringSlot, shelfNodeName=shelfNodeName, axisSvcBilling=axisSvcBilling, userName=userName, axisFeederTkNo=axisFeederTkNo, shelfFunctionModuleHoldReset=shelfFunctionModuleHoldReset, apsIpAddress=apsIpAddress, smRedMapTable=smRedMapTable, shelfFunctionModuleState=shelfFunctionModuleState)
