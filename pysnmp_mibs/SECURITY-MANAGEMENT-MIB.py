...
cmgTrapLocation, cmgTrapModule, cmgTrapOnIccMissing, cmgTrapSubsystem, cmgTrapOnBoard = mibBuilder.importSymbols("G700-MG-MIB", "cmgTrapLocation", "cmgTrapModule", "cmgTrapOnIccMissing", "cmgTrapSubsystem", "cmgTrapOnBoard")
ifType, ifIndex, ifName, ifPhysAddress = mibBuilder.importSymbols("IF-MIB", "ifType", "ifIndex", "ifName", "ifPhysAddress")
InetAddressType, InetAddress = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddressType", "InetAddress")
genAppFileId, genAppFileVersionNumber, genAppFileName, genOpLastFailureDisplay = mibBuilder.importSymbols("LOAD-MIB", "genAppFileId", "genAppFileVersionNumber", "genAppFileName", "genOpLastFailureDisplay")
...
mibBuilder.exportSymbols("SECURITY-MANAGEMENT-MIB", lsgLicManagement=lsgLicManagement, avMSSNotificationRate=avMSSNotificationRate, secTcpSynCkiOpState=secTcpSynCkiOpState, avMSSVarbindsSrcMACAddr=avMSSVarbindsSrcMACAddr, secTcpSynCookies=secTcpSynCookies, avASGAuthenticationFiles=avASGAuthenticationFiles, avMSSVarbindsDstPort=avMSSVarbindsDstPort, avMSSVarbindsDescription=avMSSVarbindsDescription, avASGAuthFileAFID=avASGAuthFileAFID, avDuplicatedMACAddress=avDuplicatedMACAddress, secTcpSynCkiCfgState=secTcpSynCkiCfgState, secMngConformance=secMngConformance, lsgLicMngLastError=lsgLicMngLastError, avPasswordToExpireAlert=avPasswordToExpireAlert, lsgLicMngOperStatus=lsgLicMngOperStatus, avMngNotificationCompliance=avMngNotificationCompliance, fips140=fips140, avMSSVarbindsDoSType=avMSSVarbindsDoSType, avASGAuthFileRelease=avASGAuthFileRelease, lsgLicMngTable=lsgLicMngTable, lsgLicMngFeatureType=lsgLicMngFeatureType, lsgLicMngEntry=lsgLicMngEntry, lsgLicMngGroups=lsgLicMngGroups, avUnauthInetAddress=avUnauthInetAddress, secMngProtoEntry=secMngProtoEntry, secMngProtoTable=secMngProtoTable, secMngNotificationGroup=secMngNotificationGroup, secMngNotificationsPrefix=secMngNotificationsPrefix, avUnAuthAccessEvent=avUnAuthAccessEvent, avASGAFDownloadSuccess=avASGAFDownloadSuccess, avASGAuthFileGenTime=avASGAuthFileGenTime, secMngGroups=secMngGroups, avMssNotifications=avMssNotifications, avASGAFDownloadFailure=avASGAFDownloadFailure, secMngNotifications=secMngNotifications, avASGAuthFileHeader=avASGAuthFileHeader, avDuplicatedInetAddress=avDuplicatedInetAddress, secMngBasicGroup=secMngBasicGroup, avUnauthUserName=avUnauthUserName, secMngCompliance=secMngCompliance, lsgLicMngAdminStatus=lsgLicMngAdminStatus, lsgLicMngConformance=lsgLicMngConformance, avMSSVarbindsDstAddr=avMSSVarbindsDstAddr, avMssNotificationPrefix=avMssNotificationPrefix, avMSSVarbindsCount=avMSSVarbindsCount, lsgLicMngBasicGroup=lsgLicMngBasicGroup, avASGNotifications=avASGNotifications, PYSNMP_MODULE_ID=secMngModule, secMode=secMode, avAccountLockoutEvent=avAccountLockoutEvent, mssNotificationGroup=mssNotificationGroup, secMngVarbinds=secMngVarbinds, avDuplicatedInetAddressType=avDuplicatedInetAddressType, avMSSVarbindsSrcAddr=avMSSVarbindsSrcAddr, avMSSDenialOfService=avMSSDenialOfService, avMSSVarbindsIpProtocol=avMSSVarbindsIpProtocol, avASGAuthFileNotificationGroup=avASGAuthFileNotificationGroup, ServiceStateType=ServiceStateType, lsgLicMngCountedValue=lsgLicMngCountedValue, lsgLicMngFeatureKeyword=lsgLicMngFeatureKeyword, secMngNumOfDays2Expire=secMngNumOfDays2Expire, avIPv6AddressDuplicationEvent=avIPv6AddressDuplicationEvent, avayaSecurity=avayaSecurity, avASGAuthFileGenDate=avASGAuthFileGenDate, avMSSgroup=avMSSgroup, secMngProtoId=secMngProtoId, avMSSVarbinds=avMSSVarbinds, OnOffType=OnOffType, avUnauthProtocol=avUnauthProtocol, avConfigurationMasterKeyChange=avConfigurationMasterKeyChange, fipsEnhancedSecurityFlg=fipsEnhancedSecurityFlg, avConfigurationEncKeyMismatchFault=avConfigurationEncKeyMismatchFault, avUnauthInetAddressType=avUnauthInetAddressType, secMngModule=secMngModule, avSecLocalDateAndTime=avSecLocalDateAndTime, secMngProtoStatus=secMngProtoStatus, avASGNotificationsPrefix=avASGNotificationsPrefix, avASGAuthFileGroup=avASGAuthFileGroup)
