...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/avaya/SECURITY-MANAGEMENT-MIB
...
cmgTrapLocation, cmgTrapOnBoard, cmgTrapModule, cmgTrapSubsystem, cmgTrapOnIccMissing = mibBuilder.importSymbols("G700-MG-MIB", "cmgTrapLocation", "cmgTrapOnBoard", "cmgTrapModule", "cmgTrapSubsystem", "cmgTrapOnIccMissing")
ifIndex, ifType, ifPhysAddress, ifName = mibBuilder.importSymbols("IF-MIB", "ifIndex", "ifType", "ifPhysAddress", "ifName")
InetAddressType, InetAddress = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddressType", "InetAddress")
genAppFileName, genAppFileVersionNumber, genOpLastFailureDisplay, genAppFileId = mibBuilder.importSymbols("LOAD-MIB", "genAppFileName", "genAppFileVersionNumber", "genOpLastFailureDisplay", "genAppFileId")
...
mibBuilder.exportSymbols("SECURITY-MANAGEMENT-MIB", avMSSVarbinds=avMSSVarbinds, lsgLicMngLastError=lsgLicMngLastError, secMode=secMode, secMngVarbinds=secMngVarbinds, PYSNMP_MODULE_ID=secMngModule, avASGAuthFileRelease=avASGAuthFileRelease, secMngProtoTable=secMngProtoTable, ServiceStateType=ServiceStateType, avMSSgroup=avMSSgroup, avMSSVarbindsCount=avMSSVarbindsCount, avMSSVarbindsDescription=avMSSVarbindsDescription, avASGAuthFileAFID=avASGAuthFileAFID, secTcpSynCookies=secTcpSynCookies, avMSSVarbindsDstAddr=avMSSVarbindsDstAddr, avMSSNotificationRate=avMSSNotificationRate, avMSSVarbindsIpProtocol=avMSSVarbindsIpProtocol, lsgLicMngAdminStatus=lsgLicMngAdminStatus, secMngConformance=secMngConformance, lsgLicMngBasicGroup=lsgLicMngBasicGroup, lsgLicMngFeatureType=lsgLicMngFeatureType, lsgLicMngConformance=lsgLicMngConformance, avIPv6AddressDuplicationEvent=avIPv6AddressDuplicationEvent, avUnauthInetAddress=avUnauthInetAddress, avMngNotificationCompliance=avMngNotificationCompliance, fipsEnhancedSecurityFlg=fipsEnhancedSecurityFlg, avConfigurationMasterKeyChange=avConfigurationMasterKeyChange, avASGAuthFileNotificationGroup=avASGAuthFileNotificationGroup, avUnAuthAccessEvent=avUnAuthAccessEvent, secMngModule=secMngModule, avDuplicatedMACAddress=avDuplicatedMACAddress, secMngNotificationsPrefix=secMngNotificationsPrefix, avAccountLockoutEvent=avAccountLockoutEvent, secMngCompliance=secMngCompliance, secMngNotificationGroup=secMngNotificationGroup, avASGAuthFileGenTime=avASGAuthFileGenTime, avMssNotificationPrefix=avMssNotificationPrefix, secTcpSynCkiCfgState=secTcpSynCkiCfgState, avMSSDenialOfService=avMSSDenialOfService, mssNotificationGroup=mssNotificationGroup, avUnauthProtocol=avUnauthProtocol, avASGAFDownloadFailure=avASGAFDownloadFailure, avASGAuthFileHeader=avASGAuthFileHeader, lsgLicMngTable=lsgLicMngTable, secMngBasicGroup=secMngBasicGroup, lsgLicMngFeatureKeyword=lsgLicMngFeatureKeyword, lsgLicMngGroups=lsgLicMngGroups, secMngNumOfDays2Expire=secMngNumOfDays2Expire, avDuplicatedInetAddressType=avDuplicatedInetAddressType, avMSSVarbindsDstPort=avMSSVarbindsDstPort, avASGNotificationsPrefix=avASGNotificationsPrefix, secTcpSynCkiOpState=secTcpSynCkiOpState, OnOffType=OnOffType, lsgLicMngCountedValue=lsgLicMngCountedValue, fips140=fips140, avUnauthUserName=avUnauthUserName, avASGAuthFileGroup=avASGAuthFileGroup, avConfigurationEncKeyMismatchFault=avConfigurationEncKeyMismatchFault, avayaSecurity=avayaSecurity, avDuplicatedInetAddress=avDuplicatedInetAddress, avASGNotifications=avASGNotifications, avASGAFDownloadSuccess=avASGAFDownloadSuccess, avMSSVarbindsDoSType=avMSSVarbindsDoSType, avSecLocalDateAndTime=avSecLocalDateAndTime, secMngProtoId=secMngProtoId, avPasswordToExpireAlert=avPasswordToExpireAlert, secMngGroups=secMngGroups, lsgLicMngOperStatus=lsgLicMngOperStatus, avASGAuthFileGenDate=avASGAuthFileGenDate, secMngProtoStatus=secMngProtoStatus, avUnauthInetAddressType=avUnauthInetAddressType, secMngNotifications=secMngNotifications, lsgLicMngEntry=lsgLicMngEntry, lsgLicManagement=lsgLicManagement, avASGAuthenticationFiles=avASGAuthenticationFiles, avMSSVarbindsSrcAddr=avMSSVarbindsSrcAddr, avMSSVarbindsSrcMACAddr=avMSSVarbindsSrcMACAddr, secMngProtoEntry=secMngProtoEntry, avMssNotifications=avMssNotifications)
