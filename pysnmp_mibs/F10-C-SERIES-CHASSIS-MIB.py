...
F10ChassisType, F10ProcessorModuleType, F10ChassisMode, F10CardOperStatus, F10HundredthdB, F10CSeriesPortType, F10CSeriesCardType, F10MfgDate, F10SwDate = mibBuilder.importSymbols("FORCE10-TC", "F10ChassisType", "F10ProcessorModuleType", "F10ChassisMode", "F10CardOperStatus", "F10HundredthdB", "F10CSeriesPortType", "F10CSeriesCardType", "F10MfgDate", "F10SwDate")
...
mibBuilder.exportSymbols("F10-C-SERIES-CHASSIS-MIB", chNumSfmSlots=chNumSfmSlots, chSysSwBackupBootImgStatus=chSysSwBackupBootImgStatus, chSysCardCountryCode=chSysCardCountryCode, chLineCardObjects=chLineCardObjects, chSysSfmEntry=chSysSfmEntry, chSysPortEntry=chSysPortEntry, chSysProcessorMemSize=chSysProcessorMemSize, chSysCardPiecePartID=chSysCardPiecePartID, chRpmCpuUtil5Min=chRpmCpuUtil5Min, chSysXfpRecvPower=chSysXfpRecvPower, chSysCardDateCode=chSysCardDateCode, chSwVersion=chSwVersion, chSysSwModuleTable=chSysSwModuleTable, chSysCardType=chSysCardType, chSysCardTable=chSysCardTable, chSysCardBootFlashA=chSysCardBootFlashA, f10CSerChassisMibConformance=f10CSerChassisMibConformance, f10CSerChassisMibCompliances=f10CSerChassisMibCompliances, chSysSwCurrentBootImgDate=chSysSwCurrentBootImgDate, chSysSwCurrentBootImage=chSysSwCurrentBootImage, chSysSwNextRebootImage=chSysSwNextRebootImage, chAlarmObjects=chAlarmObjects, chSysSwModuleEntry=chSysSwModuleEntry, chLineCardCpuUtil5Sec=chLineCardCpuUtil5Sec, chSysPortIndex=chSysPortIndex, chSysCardAdminStatus=chSysCardAdminStatus, chPartNum=chPartNum, chSysSwProcessorIndex=chSysSwProcessorIndex, chSysPowerSupplyTable=chSysPowerSupplyTable, chLineCardMemUsageUtil=chLineCardMemUsageUtil, chPiecePartID=chPiecePartID, f10CSerChassisObject=f10CSerChassisObject, chSysPortSlotIndex=chSysPortSlotIndex, chSysSfmIndex=chSysSfmIndex, chSysSwBackupBootImgVersion=chSysSwBackupBootImgVersion, PYSNMP_MODULE_ID=f10CSerChassisMib, chSysObjects=chSysObjects, chRpmMemUsageUtil=chRpmMemUsageUtil, chPPIDRevision=chPPIDRevision, chSysCardNumPorts=chSysCardNumPorts, chSysCardSlotIndex=chSysCardSlotIndex, chObjects=chObjects, chRpmCpuUtil5Sec=chRpmCpuUtil5Sec, chNumLinecards=chNumLinecards, chDateCode=chDateCode, chNumSlots=chNumSlots, chSerialNumber=chSerialNumber, chChassisMode=chChassisMode, chSysSwRuntimeImgDate=chSysSwRuntimeImgDate, f10CSerChassisMibCompliance=f10CSerChassisMibCompliance, chSysFanTrayTable=chSysFanTrayTable, chSysCardTemp=chSysCardTemp, chSysCardEntry=chSysCardEntry, chSysSfmOperStatus=chSysSfmOperStatus, chRpmSlotNumber=chRpmSlotNumber, chRpmMinorAlarmStatus=chRpmMinorAlarmStatus, chSysCardSerialNumber=chSysCardSerialNumber, chSysPowerSupplyMode=chSysPowerSupplyMode, chSysSwRuntimeImgVersion=chSysSwRuntimeImgVersion, chSysCardExpressServiceCode=chSysCardExpressServiceCode, chSysProcessorSlotIndex=chSysProcessorSlotIndex, chSysPowerSupplyType=chSysPowerSupplyType, chExpressServiceCode=chExpressServiceCode, f10CSerRpmGroup=f10CSerRpmGroup, chSysPowerSupplyOperStatus=chSysPowerSupplyOperStatus, chSysPortType=chSysPortType, chSysCardVendorId=chSysCardVendorId, chRpmNumRpms=chRpmNumRpms, chType=chType, chNumPowerSupplies=chNumPowerSupplies, f10CSerLineCardGroup=f10CSerLineCardGroup, chNumFanTrays=chNumFanTrays, chSysCardOperStatus=chSysCardOperStatus, chSysFanTrayEntry=chSysFanTrayEntry, chSysPowerSupplyVersion=chSysPowerSupplyVersion, chSysCardUpTime=chSysCardUpTime, chSysCardPartNum=chSysCardPartNum, chSysProcessorNvramSize=chSysProcessorNvramSize, f10CSerChassisMib=f10CSerChassisMib, chSysFanTrayOperStatus=chSysFanTrayOperStatus, chLineCardUtilTable=chLineCardUtilTable, chSysCardPPIDRevision=chSysCardPPIDRevision, chSysPortOperStatus=chSysPortOperStatus, chLineCardCpuUtil5Min=chLineCardCpuUtil5Min, chSysPortTable=chSysPortTable, chSysPowerSupplyIndex=chSysPowerSupplyIndex, chLineCardCpuUtil1Min=chLineCardCpuUtil1Min, chServiceTag=chServiceTag, chSysSwSlotIndex=chSysSwSlotIndex, chVendorId=chVendorId, chProductRev=chProductRev, chSysSwBackupBootImgDate=chSysSwBackupBootImgDate, chSysPowerSupplyEntry=chSysPowerSupplyEntry, chSysProcessorEntry=chSysProcessorEntry, chRpmMajorAlarmStatus=chRpmMajorAlarmStatus, chSysCardProductRev=chSysCardProductRev, chRpmCpuIndex=chRpmCpuIndex, chRpmUptime=chRpmUptime, chRpmLastSwitchDate=chRpmLastSwitchDate, f10CSerComponentGroup=f10CSerComponentGroup, chSysProcessorTable=chSysProcessorTable, chRpmUtilEntry=chRpmUtilEntry, chSysProcessorUpTime=chSysProcessorUpTime, chSysSfmTable=chSysSfmTable, f10CSerChassisMibGroups=f10CSerChassisMibGroups, chSysPortAdminStatus=chSysPortAdminStatus, chLineCardUtilEntry=chLineCardUtilEntry, chSysCardNumber=chSysCardNumber, chRpmUtilTable=chRpmUtilTable, chSysProcessorModule=chSysProcessorModule, chSysSwCurrentBootImgStatus=chSysSwCurrentBootImgStatus, chSysProcessorIndex=chSysProcessorIndex, chSysSfmErrorStatus=chSysSfmErrorStatus, chRpmObjects=chRpmObjects, chSysCardBootFlashB=chSysCardBootFlashB, chSysSwCurrentBootImgVersion=chSysSwCurrentBootImgVersion, chSysPortIfIndex=chSysPortIfIndex, chRpmCpuUtil1Min=chRpmCpuUtil1Min, chMacAddr=chMacAddr, chSysSfmAdminStatus=chSysSfmAdminStatus, f10CSerSystemGroup=f10CSerSystemGroup, chSysFanTrayIndex=chSysFanTrayIndex, chCountryCode=chCountryCode, chRpmCpuType=chRpmCpuType, chSysCardServiceTag=chSysCardServiceTag)
