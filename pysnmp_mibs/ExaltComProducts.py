...
EthAuxStatusT, VlanStatusT, ExaltEnableT, Led4ColorT, VlanGroupT, EthMainStatusT, FileTransferStartT, Te1LineCodeT, Te1LoopBackModeT, AcmModulationT, FileTransferTypeT, Te1LboT, EthPortMode, NtpClientEnableT, Te1StatusT, exaltcommunications, TimeZoneT, AlarmLevelT, AuxNmsMode, EnableStatusT = mibBuilder.importSymbols("ExaltComm", "EthAuxStatusT", "VlanStatusT", "ExaltEnableT", "Led4ColorT", "VlanGroupT", "EthMainStatusT", "FileTransferStartT", "Te1LineCodeT", "Te1LoopBackModeT", "AcmModulationT", "FileTransferTypeT", "Te1LboT", "EthPortMode", "NtpClientEnableT", "Te1StatusT", "exaltcommunications", "TimeZoneT", "AlarmLevelT", "AuxNmsMode", "EnableStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", locErrorDurationStr=locErrorDurationStr, hwId=hwId, selectT1orE1=selectT1orE1, locTe1Alarms=locTe1Alarms, trapLocRslThreshold=trapLocRslThreshold, interfaceType=interfaceType, locEthUtilizationIn=locEthUtilizationIn, rnLocal=rnLocal, remSysAlarms=remSysAlarms, radioAdmin=radioAdmin, productsAllObjects=productsAllObjects, te1Status=te1Status, rdkDbVer=rdkDbVer, ipRemote=ipRemote, locMaximumTxModulation=locMaximumTxModulation, locCurrentTempS=locCurrentTempS, trapv1Enable=trapv1Enable, locActiveRxModulation=locActiveRxModulation, remResetStats=remResetStats, trapLocTempStat=trapLocTempStat, remTe1Alarms=remTe1Alarms, snmpConfig=snmpConfig, trapIpaddrEnable4=trapIpaddrEnable4, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, t1LBO=t1LBO, transferStart=transferStart, ntpServer1IpAddr=ntpServer1IpAddr, locCurrentBERstr=locCurrentBERstr, fileManagement=fileManagement, commitTe1Settings=commitTe1Settings, te1Interface=te1Interface, perfRemote=perfRemote, locMinRSL=locMinRSL, transferType=transferType, locLinkStateV=locLinkStateV, productsMIBCompliances=productsMIBCompliances, aggregateUserThroughput=aggregateUserThroughput, fileTransfer=fileTransfer, linkName=linkName, trapv2cEnable=trapv2cEnable, remTe1AlarmsEntry=remTe1AlarmsEntry, locEthUtilizationWatermark=locEthUtilizationWatermark, remCurrentTemp=remCurrentTemp, locActiveTxModulation=locActiveTxModulation, locMinimumTxModulation=locMinimumTxModulation, locSysAlarms=locSysAlarms, PwType=PwType, inboundEthernetThroughput=inboundEthernetThroughput, locCurrentBER=locCurrentBER, firmwareVersion=firmwareVersion, swapFWimage=swapFWimage, ntpServer2IpAddr=ntpServer2IpAddr, te1LoopBackMode=te1LoopBackMode, commitSnmpSettings=commitSnmpSettings, trapIpaddr2=trapIpaddr2, rnRemote=rnRemote, productsMIBObjects=productsMIBObjects, ntpTimeZoneSelect=ntpTimeZoneSelect, trapAuth=trapAuth, remLinkSecMismatch=remLinkSecMismatch, performance=performance, bootVersion=bootVersion, modelNumber=modelNumber, transferStatus=transferStatus, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remLinkStateH=remLinkStateH, userPassword=userPassword, serialNumber=serialNumber, defaultGateway=defaultGateway, locTE1Alarms=locTE1Alarms, ntpServer4IpAddr=ntpServer4IpAddr, outboundEthernetThroughput=outboundEthernetThroughput, locEthSpeed=locEthSpeed, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, productsMIBConformance=productsMIBConformance, trapReboot=trapReboot, sysDate=sysDate, almLocal=almLocal, trapIpaddr1=trapIpaddr1, PYSNMP_MODULE_ID=productsMIB, te1NumChannels=te1NumChannels, perfLocal=perfLocal, te1=te1, remUnavailDurationStr=remUnavailDurationStr, modelName=modelName, adminPassword=adminPassword, locLinkStateH=locLinkStateH, remCurrentBER=remCurrentBER, locTempAlarm=locTempAlarm, remMinRSLstr=remMinRSLstr, te1AIS=te1AIS, remTempAlarm=remTempAlarm, aesKey=aesKey, remCurrentBERstr=remCurrentBERstr, te1NumActiveChannels=te1NumActiveChannels, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, radioInfo=radioInfo, locSampleDurationStr=locSampleDurationStr, locUnavailDuration=locUnavailDuration, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locCurrentRSLstr=locCurrentRSLstr, trapIpaddrEnable1=trapIpaddrEnable1, trapIpaddrEnable3=trapIpaddrEnable3, subnetMask=subnetMask, almRemote=almRemote, sysTime=sysTime, remLinkState=remLinkState, locMinRSLtimestamp=locMinRSLtimestamp, remMaxRSLstr=remMaxRSLstr, trapLocRslStat=trapLocRslStat, factoryFwFilename=factoryFwFilename, partNumber=partNumber, ipAddress=ipAddress, remMaxRSL=remMaxRSL, locEthPerfInterfaces=locEthPerfInterfaces, remCurrentTempS=remCurrentTempS, userThroughput=userThroughput, locErrorDuration=locErrorDuration, trapv3Enable=trapv3Enable, ntpServer3IpAddr=ntpServer3IpAddr, te1Interfaces=te1Interfaces, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, rxFreqRange=rxFreqRange, ipLocal=ipLocal, remErrorDurationStr=remErrorDurationStr, locUnavailDurationStr=locUnavailDurationStr, remMinRSLtimestamp=remMinRSLtimestamp, locEthUtilizationOut=locEthUtilizationOut, locMaximumRxModulation=locMaximumRxModulation, locMaxRSLstr=locMaxRSLstr, remUnavailDuration=remUnavailDuration, trapIpaddr3=trapIpaddr3, trapIpaddrEnable2=trapIpaddrEnable2, locCurrentTemp=locCurrentTemp, locMinimumRxModulation=locMinimumRxModulation, systemConfig=systemConfig, ipAddressNetmask=ipAddressNetmask, aesEnable=aesEnable, ntp=ntp, radioName=radioName, locEthAlarms=locEthAlarms, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locTe1LinkSummary=locTe1LinkSummary, productsMIBNotifications=productsMIBNotifications, alternateFwFilename=alternateFwFilename, alarms=alarms, remTe1LinkSummary=remTe1LinkSummary, ntpClientEnable=ntpClientEnable, t1LineCode=t1LineCode, remCurrentRSLstr=remCurrentRSLstr, linkSecKey=linkSecKey, remLinkStateV=remLinkStateV, remErrorDuration=remErrorDuration, remTE1Alarms=remTE1Alarms, trapIpaddr4=trapIpaddr4, trapRemAlarmStat=trapRemAlarmStat, licKey=licKey, commitSystemSettings=commitSystemSettings, commitAdminSettings=commitAdminSettings, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, productsMIBGroups=productsMIBGroups, commitNtpSettings=commitNtpSettings, locCurrentRSL=locCurrentRSL, remEthAlarms=remEthAlarms, locMaxRSL=locMaxRSL, currentFwFilename=currentFwFilename, rfFreqBand=rfFreqBand, locTe1AlarmsEntry=locTe1AlarmsEntry, remSampleDurationStr=remSampleDurationStr, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, radioMonitor=radioMonitor, locLinkSecMismatch=locLinkSecMismatch, trapLocLinkStat=trapLocLinkStat, remTe1Alarm=remTe1Alarm, radioConfig=radioConfig, locLinkState=locLinkState, locResetStats=locResetStats, remMinRSL=remMinRSL, remCurrentRSL=remCurrentRSL, locSampleDuration=locSampleDuration, tftpServerIp=tftpServerIp, licenseFeatures=licenseFeatures, remSampleDuration=remSampleDuration, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, radioReboot=radioReboot, locMinRSLstr=locMinRSLstr, txFreqRange=txFreqRange, locTe1Alarm=locTe1Alarm, productsMIB=productsMIB, uploadFilename=uploadFilename, trapLocAlarmStat=trapLocAlarmStat, interface=interface)
