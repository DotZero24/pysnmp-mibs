...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/exalt/ExaltComProducts
...
FileTransferStartT, exaltcommunications, Te1StatusT, EthMainStatusT, ExaltEnableT, Led4ColorT, EnableStatusT, AlarmLevelT, AuxNmsMode, Te1LoopBackModeT, TimeZoneT, Te1LineCodeT, Te1LboT, VlanStatusT, FileTransferTypeT, EthPortMode, VlanGroupT, EthAuxStatusT, NtpClientEnableT, AcmModulationT = mibBuilder.importSymbols("ExaltComm", "FileTransferStartT", "exaltcommunications", "Te1StatusT", "EthMainStatusT", "ExaltEnableT", "Led4ColorT", "EnableStatusT", "AlarmLevelT", "AuxNmsMode", "Te1LoopBackModeT", "TimeZoneT", "Te1LineCodeT", "Te1LboT", "VlanStatusT", "FileTransferTypeT", "EthPortMode", "VlanGroupT", "EthAuxStatusT", "NtpClientEnableT", "AcmModulationT")
...
mibBuilder.exportSymbols("ExaltComProducts", trapIpaddrEnable4=trapIpaddrEnable4, locMinRSLstr=locMinRSLstr, rfFreqBand=rfFreqBand, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locEthUtilizationWatermark=locEthUtilizationWatermark, remMinRSLtimestamp=remMinRSLtimestamp, trapReboot=trapReboot, remLinkSecMismatch=remLinkSecMismatch, remUnavailDurationStr=remUnavailDurationStr, remCurrentRSL=remCurrentRSL, locSampleDuration=locSampleDuration, locLinkSecMismatch=locLinkSecMismatch, locCurrentBERstr=locCurrentBERstr, licenseFeatures=licenseFeatures, locMinRSLtimestamp=locMinRSLtimestamp, trapLocLinkStat=trapLocLinkStat, productsMIBCompliances=productsMIBCompliances, locMaximumTxModulation=locMaximumTxModulation, radioName=radioName, locEthUtilizationOut=locEthUtilizationOut, remTempAlarm=remTempAlarm, userPassword=userPassword, transferType=transferType, trapRemAlarmStat=trapRemAlarmStat, remUnavailDuration=remUnavailDuration, t1LBO=t1LBO, radioConfig=radioConfig, remLinkStateH=remLinkStateH, snmpConfig=snmpConfig, rxFreqRange=rxFreqRange, interface=interface, remTe1Alarm=remTe1Alarm, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, modelNumber=modelNumber, locEthAlarms=locEthAlarms, trapAuth=trapAuth, ntpServer2IpAddr=ntpServer2IpAddr, radioInfo=radioInfo, perfRemote=perfRemote, modelName=modelName, trapIpaddr4=trapIpaddr4, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, trapLocTempStat=trapLocTempStat, locUnavailDurationStr=locUnavailDurationStr, systemConfig=systemConfig, subnetMask=subnetMask, ntpTimeZoneSelect=ntpTimeZoneSelect, ipAddressNetmask=ipAddressNetmask, commitAdminSettings=commitAdminSettings, locEthUtilizationIn=locEthUtilizationIn, locMaxRSLstr=locMaxRSLstr, remTe1Alarms=remTe1Alarms, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remTe1AlarmsEntry=remTe1AlarmsEntry, ntpClientEnable=ntpClientEnable, locCurrentTempS=locCurrentTempS, sysDate=sysDate, remErrorDuration=remErrorDuration, locResetStats=locResetStats, PwType=PwType, transferStart=transferStart, remCurrentRSLstr=remCurrentRSLstr, productsMIBGroups=productsMIBGroups, firmwareVersion=firmwareVersion, te1NumChannels=te1NumChannels, locMinimumTxModulation=locMinimumTxModulation, te1=te1, te1NumActiveChannels=te1NumActiveChannels, locEthSpeed=locEthSpeed, commitNtpSettings=commitNtpSettings, rdkDbVer=rdkDbVer, locCurrentRSL=locCurrentRSL, locMinRSL=locMinRSL, rnLocal=rnLocal, te1Status=te1Status, remSampleDurationStr=remSampleDurationStr, aesEnable=aesEnable, uploadFilename=uploadFilename, txFreqRange=txFreqRange, locCurrentBER=locCurrentBER, te1Interfaces=te1Interfaces, remLinkState=remLinkState, remMinRSLstr=remMinRSLstr, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locCurrentRSLstr=locCurrentRSLstr, locTempAlarm=locTempAlarm, almLocal=almLocal, linkSecKey=linkSecKey, perfLocal=perfLocal, locTe1Alarms=locTe1Alarms, remMaxRSLstr=remMaxRSLstr, radioReboot=radioReboot, licKey=licKey, trapv3Enable=trapv3Enable, productsMIBNotifications=productsMIBNotifications, trapIpaddrEnable2=trapIpaddrEnable2, currentFwFilename=currentFwFilename, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locMinimumRxModulation=locMinimumRxModulation, locSampleDurationStr=locSampleDurationStr, adminPassword=adminPassword, ipRemote=ipRemote, commitSystemSettings=commitSystemSettings, locEthPerfInterfaces=locEthPerfInterfaces, remEthAlarms=remEthAlarms, transferStatus=transferStatus, locActiveRxModulation=locActiveRxModulation, outboundEthernetThroughput=outboundEthernetThroughput, remCurrentBER=remCurrentBER, commitSnmpSettings=commitSnmpSettings, commitTe1Settings=commitTe1Settings, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, hwId=hwId, userThroughput=userThroughput, remCurrentBERstr=remCurrentBERstr, serialNumber=serialNumber, trapIpaddrEnable1=trapIpaddrEnable1, t1LineCode=t1LineCode, alarms=alarms, remMinRSL=remMinRSL, locLinkStateH=locLinkStateH, interfaceType=interfaceType, inboundEthernetThroughput=inboundEthernetThroughput, aesKey=aesKey, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, alternateFwFilename=alternateFwFilename, fileManagement=fileManagement, productsMIBObjects=productsMIBObjects, rnRemote=rnRemote, radioMonitor=radioMonitor, bootVersion=bootVersion, swapFWimage=swapFWimage, productsMIB=productsMIB, locErrorDuration=locErrorDuration, locTe1LinkSummary=locTe1LinkSummary, locSysAlarms=locSysAlarms, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locTE1Alarms=locTE1Alarms, te1Interface=te1Interface, locLinkStateV=locLinkStateV, te1LoopBackMode=te1LoopBackMode, remResetStats=remResetStats, remErrorDurationStr=remErrorDurationStr, PYSNMP_MODULE_ID=productsMIB, sysTime=sysTime, almRemote=almRemote, remSampleDuration=remSampleDuration, trapLocRslStat=trapLocRslStat, ntp=ntp, remTE1Alarms=remTE1Alarms, locLinkState=locLinkState, trapIpaddr2=trapIpaddr2, remTe1LinkSummary=remTe1LinkSummary, productsAllObjects=productsAllObjects, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locUnavailDuration=locUnavailDuration, trapIpaddr1=trapIpaddr1, trapIpaddrEnable3=trapIpaddrEnable3, linkName=linkName, ipAddress=ipAddress, trapv2cEnable=trapv2cEnable, trapv1Enable=trapv1Enable, locMaxRSL=locMaxRSL, locCurrentTemp=locCurrentTemp, remSysAlarms=remSysAlarms, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, aggregateUserThroughput=aggregateUserThroughput, ipLocal=ipLocal, locMaximumRxModulation=locMaximumRxModulation, selectT1orE1=selectT1orE1, radioAdmin=radioAdmin, te1AIS=te1AIS, remCurrentTempS=remCurrentTempS, tftpServerIp=tftpServerIp, locTe1AlarmsEntry=locTe1AlarmsEntry, performance=performance, fileTransfer=fileTransfer, productsMIBConformance=productsMIBConformance, locActiveTxModulation=locActiveTxModulation, trapIpaddr3=trapIpaddr3, trapLocAlarmStat=trapLocAlarmStat, partNumber=partNumber, trapLocRslThreshold=trapLocRslThreshold, ntpServer1IpAddr=ntpServer1IpAddr, remMaxRSL=remMaxRSL, locErrorDurationStr=locErrorDurationStr, factoryFwFilename=factoryFwFilename, remLinkStateV=remLinkStateV, ntpServer3IpAddr=ntpServer3IpAddr, locTe1Alarm=locTe1Alarm, ntpServer4IpAddr=ntpServer4IpAddr, remCurrentTemp=remCurrentTemp, defaultGateway=defaultGateway)
