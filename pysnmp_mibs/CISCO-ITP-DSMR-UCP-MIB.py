...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ITP-DSMR-UCP-MIB
...
_CdsmrUcpSessionStateNotifEnabled_Type.__name__ = "TruthValue"
...
ciscoItpDsmrUcpMIBCompliance.setObjects(
      *(("CISCO-ITP-DSMR-UCP-MIB", "ciscoItpDsmrUcpGroup"),
        ("CISCO-ITP-DSMR-UCP-MIB", "ciscoItpDsmrUcpNotificationsGroup"))
)
if mibBuilder.loadTexts:
