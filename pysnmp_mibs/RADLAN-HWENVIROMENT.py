...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-HWENVIROMENT
...
rlEnvRedundantFanEntry = _RlEnvRedundantFanEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 83, 6, 1)
)
rlEnvRedundantFanEntry.setIndexNames(
    (0, "RADLAN-HWENVIROMENT", "rlEnvRedundantFanUnitId"),
    (0, "RADLAN-HWENVIROMENT", "rlEnvRedundantFanIndex"),
)
if mibBuilder.loadTexts:
