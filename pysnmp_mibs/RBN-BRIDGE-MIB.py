...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-BRIDGE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:16:50 2025
...
_RbnBridgeNotifyEnable_Type.__name__ = "TruthValue"
...
rbnBridgeCompliance.setObjects(
      *(("RBN-BRIDGE-MIB", "rbnBridgeNotifyObjectGroup"),
        ("RBN-BRIDGE-MIB", "rbnBridgeNotifyGroup"))
)
if mibBuilder.loadTexts:
...
rbnBridgeCompliance2.setObjects(
      *(("RBN-BRIDGE-MIB", "rbnBridgeNotifyObjectGroup"),
        ("RBN-BRIDGE-MIB", "rbnBridgeStateNotifyObjectGroup"),
        ("RBN-BRIDGE-MIB", "rbnBridgeNotifyGroup"),
        ("RBN-BRIDGE-MIB", "rbnBridgeStateNotifyGroup"),
        ("RBN-BRIDGE-MIB", "rbnBridgeBaseObjectGroup"))
)
if mibBuilder.loadTexts:
