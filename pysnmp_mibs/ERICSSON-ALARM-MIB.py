...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:25:46 2025
...
EriAlarmSequenceNumber, EriAlarmType, EriAlarmSpecificProblem, EriAdditionalText, EriAlarmIndex, EriLargeAdditionalText = mibBuilder.importSymbols("ERICSSON-ALARM-TC-MIB", "EriAlarmSequenceNumber", "EriAlarmType", "EriAlarmSpecificProblem", "EriAdditionalText", "EriAlarmIndex", "EriLargeAdditionalText")
...
mibBuilder.exportSymbols("ERICSSON-ALARM-MIB", eriAlarmActiveOriginalEventTime=eriAlarmActiveOriginalEventTime, eriAlarmAlertsGroup=eriAlarmAlertsGroup, eriAlarmMinorAlert=eriAlarmMinorAlert, eriAlarmAlertEntry=eriAlarmAlertEntry, eriAlarmObjects=eriAlarmObjects, eriAlarmAlertEventType=eriAlarmAlertEventType, eriAlarmAddAddInfoGroup=eriAlarmAddAddInfoGroup, eriAlarmAlertNumber=eriAlarmAlertNumber, eriAlarmNObjMoreAdditionalText=eriAlarmNObjMoreAdditionalText, eriAlarmAppendAlertInfo=eriAlarmAppendAlertInfo, eriAlarmActiveNumber=eriAlarmActiveNumber, eriAlarmMajorAlert=eriAlarmMajorAlert, eriAlarmCleared=eriAlarmCleared, eriAlarmGroups=eriAlarmGroups, eriAlarmNotifObjects=eriAlarmNotifObjects, eriAlarmMajor=eriAlarmMajor, ericssonAlarmMIB=ericssonAlarmMIB, eriAlarmAlertEventTime=eriAlarmAlertEventTime, eriAlarmWarning=eriAlarmWarning, eriAlarmActiveMinorType=eriAlarmActiveMinorType, eriAlarmActiveAlarmEntry=eriAlarmActiveAlarmEntry, eriAlarmActiveAlarmsGroup=eriAlarmActiveAlarmsGroup, eriAlarmActiveEventType=eriAlarmActiveEventType, eriAlarmCompliances=eriAlarmCompliances, eriAlarmAlertSeverity=eriAlarmAlertSeverity, eriAlarmActiveResourceId=eriAlarmActiveResourceId, eriAlarmActiveAlarmTable=eriAlarmActiveAlarmTable, eriAlarmActiveSeverity=eriAlarmActiveSeverity, eriAlarmCritical=eriAlarmCritical, eriAlarmAlertTable=eriAlarmAlertTable, eriAlarmIndeterminate=eriAlarmIndeterminate, eriAlarmActiveAlarms=eriAlarmActiveAlarms, eriAlarmHeartBeatNotif=eriAlarmHeartBeatNotif, eriAlarmAlertTableURL=eriAlarmAlertTableURL, eriAlarmHeartBeatGroup=eriAlarmHeartBeatGroup, eriAlarmSumIndeterminate=eriAlarmSumIndeterminate, eriAlarmActiveOriginalSeverity=eriAlarmActiveOriginalSeverity, eriAlarmSimpleAlarmGroup=eriAlarmSimpleAlarmGroup, eriAlarmHeartBeatNotifGroup=eriAlarmHeartBeatNotifGroup, eriAlarmAlertSpecificProblem=eriAlarmAlertSpecificProblem, PYSNMP_MODULE_ID=ericssonAlarmMIB, eriAlarmActiveSpecificProblem=eriAlarmActiveSpecificProblem, eriAlarmAlertResourceId=eriAlarmAlertResourceId, eriAlarmActiveIndex=eriAlarmActiveIndex, eriAlarmActiveOrigAdditionalText=eriAlarmActiveOrigAdditionalText, eriAlarmMinor=eriAlarmMinor, eriAlarmActiveLastSequenceNo=eriAlarmActiveLastSequenceNo, eriAlarmSumWarning=eriAlarmSumWarning, eriAlarmHbInterval=eriAlarmHbInterval, eriAlarmConformance=eriAlarmConformance, eriAlarmNObjAdditionalText=eriAlarmNObjAdditionalText, eriAlarmAlertMinorType=eriAlarmAlertMinorType, eriAlarmWarnAlert=eriAlarmWarnAlert, eriAlarmAlertManagedObject=eriAlarmAlertManagedObject, eriAlarmIndAlert=eriAlarmIndAlert, eriAlarmActiveEventTime=eriAlarmActiveEventTime, eriAlarmAlertMajorType=eriAlarmAlertMajorType, eriAlarmAlertProbableCause=eriAlarmAlertProbableCause, eriAlarmHeartBeat=eriAlarmHeartBeat, eriAlarmAlertLastChanged=eriAlarmAlertLastChanged, eriAlarmAlarmListRebuilt=eriAlarmAlarmListRebuilt, eriAlarmCriticalAlert=eriAlarmCriticalAlert, eriAlarmAlertNotifGroup=eriAlarmAlertNotifGroup, eriAlarmSumCritical=eriAlarmSumCritical, eriAlarmNObjResourceId=eriAlarmNObjResourceId, eriAlarmAlertAdditionalText=eriAlarmAlertAdditionalText, eriAlarmChangeAlarmGroup=eriAlarmChangeAlarmGroup, eriAlarmSNMPResourceGroup=eriAlarmSNMPResourceGroup, eriAlarmActiveLastChanged=eriAlarmActiveLastChanged, eriAlarmSumMajor=eriAlarmSumMajor, eriAlarmAppendInfo=eriAlarmAppendInfo, eriAlarmAlertIndex=eriAlarmAlertIndex, eriAlarmActiveAdditionalText=eriAlarmActiveAdditionalText, eriAlarmSummaryGroup=eriAlarmSummaryGroup, eriAlarmSummary=eriAlarmSummary, eriAlarmBasicAlarmsCompliance=eriAlarmBasicAlarmsCompliance, eriAlarmNotifications=eriAlarmNotifications, eriAlarmActiveMajorType=eriAlarmActiveMajorType, eriAlarmActiveProbableCause=eriAlarmActiveProbableCause, eriAlarmAlertLastSequenceNo=eriAlarmAlertLastSequenceNo, eriAlarmAlerts=eriAlarmAlerts, eriAlarmActiveManagedObject=eriAlarmActiveManagedObject, eriAlarmSumMinor=eriAlarmSumMinor, eriAlarmActiveTableURL=eriAlarmActiveTableURL, eriAlarmNotifsPrefix=eriAlarmNotifsPrefix)
