...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/ERICSSON-ALARM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:16:54 2025
...
eriAlarmBasicAlarmsCompliance.setObjects(
      *(("ERICSSON-ALARM-MIB", "eriAlarmSummaryGroup"),
        ("ERICSSON-ALARM-MIB", "eriAlarmActiveAlarmsGroup"),
        ("ERICSSON-ALARM-MIB", "eriAlarmHeartBeatGroup"),
        ("ERICSSON-ALARM-MIB", "eriAlarmSimpleAlarmGroup"),
        ("ERICSSON-ALARM-MIB", "eriAlarmHeartBeatNotifGroup"),
        ("ERICSSON-ALARM-MIB", "eriAlarmAlertsGroup"),
        ("ERICSSON-ALARM-MIB", "eriAlarmAlertNotifGroup"),
        ("ERICSSON-ALARM-MIB", "eriAlarmChangeAlarmGroup"),
        ("ERICSSON-ALARM-MIB", "eriAlarmAddAddInfoGroup"),
        ("ERICSSON-ALARM-MIB", "eriAlarmSNMPResourceGroup"),
