...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/ericsson/ERICSSON-ALARM-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:47:12 2025
...
EriAlarmSequenceNumber, EriAlarmSpecificProblem, EriAlarmIndex, EriAdditionalText, EriAlarmType, EriLargeAdditionalText = mibBuilder.importSymbols("ERICSSON-ALARM-TC-MIB", "EriAlarmSequenceNumber", "EriAlarmSpecificProblem", "EriAlarmIndex", "EriAdditionalText", "EriAlarmType", "EriLargeAdditionalText")
...
mibBuilder.exportSymbols("ERICSSON-ALARM-MIB", eriAlarmAlerts=eriAlarmAlerts, eriAlarmActiveOriginalSeverity=eriAlarmActiveOriginalSeverity, eriAlarmSumWarning=eriAlarmSumWarning, eriAlarmActiveProbableCause=eriAlarmActiveProbableCause, eriAlarmHeartBeatNotifGroup=eriAlarmHeartBeatNotifGroup, eriAlarmActiveSpecificProblem=eriAlarmActiveSpecificProblem, eriAlarmCriticalAlert=eriAlarmCriticalAlert, eriAlarmActiveAlarmEntry=eriAlarmActiveAlarmEntry, eriAlarmSumCritical=eriAlarmSumCritical, eriAlarmAlertNumber=eriAlarmAlertNumber, eriAlarmSumMinor=eriAlarmSumMinor, eriAlarmAlertTable=eriAlarmAlertTable, eriAlarmAlarmListRebuilt=eriAlarmAlarmListRebuilt, eriAlarmCompliances=eriAlarmCompliances, eriAlarmAlertManagedObject=eriAlarmAlertManagedObject, eriAlarmAppendInfo=eriAlarmAppendInfo, eriAlarmSNMPResourceGroup=eriAlarmSNMPResourceGroup, eriAlarmAlertMajorType=eriAlarmAlertMajorType, eriAlarmAlertEntry=eriAlarmAlertEntry, eriAlarmNObjMoreAdditionalText=eriAlarmNObjMoreAdditionalText, eriAlarmWarning=eriAlarmWarning, eriAlarmNObjAdditionalText=eriAlarmNObjAdditionalText, eriAlarmNotifications=eriAlarmNotifications, eriAlarmAlertProbableCause=eriAlarmAlertProbableCause, eriAlarmActiveOrigAdditionalText=eriAlarmActiveOrigAdditionalText, eriAlarmMinorAlert=eriAlarmMinorAlert, eriAlarmActiveEventType=eriAlarmActiveEventType, eriAlarmHbInterval=eriAlarmHbInterval, eriAlarmActiveEventTime=eriAlarmActiveEventTime, eriAlarmConformance=eriAlarmConformance, eriAlarmGroups=eriAlarmGroups, eriAlarmActiveNumber=eriAlarmActiveNumber, eriAlarmActiveAlarmsGroup=eriAlarmActiveAlarmsGroup, eriAlarmAppendAlertInfo=eriAlarmAppendAlertInfo, eriAlarmHeartBeatNotif=eriAlarmHeartBeatNotif, eriAlarmAlertEventTime=eriAlarmAlertEventTime, eriAlarmChangeAlarmGroup=eriAlarmChangeAlarmGroup, eriAlarmSimpleAlarmGroup=eriAlarmSimpleAlarmGroup, eriAlarmHeartBeatGroup=eriAlarmHeartBeatGroup, eriAlarmCleared=eriAlarmCleared, eriAlarmSumIndeterminate=eriAlarmSumIndeterminate, eriAlarmActiveAlarmTable=eriAlarmActiveAlarmTable, eriAlarmMajor=eriAlarmMajor, eriAlarmAlertEventType=eriAlarmAlertEventType, eriAlarmActiveOriginalEventTime=eriAlarmActiveOriginalEventTime, eriAlarmActiveAlarms=eriAlarmActiveAlarms, eriAlarmActiveResourceId=eriAlarmActiveResourceId, eriAlarmActiveSeverity=eriAlarmActiveSeverity, eriAlarmActiveTableURL=eriAlarmActiveTableURL, eriAlarmAlertNotifGroup=eriAlarmAlertNotifGroup, eriAlarmAlertLastSequenceNo=eriAlarmAlertLastSequenceNo, eriAlarmMajorAlert=eriAlarmMajorAlert, eriAlarmObjects=eriAlarmObjects, eriAlarmMinor=eriAlarmMinor, eriAlarmSummaryGroup=eriAlarmSummaryGroup, PYSNMP_MODULE_ID=ericssonAlarmMIB, eriAlarmAlertMinorType=eriAlarmAlertMinorType, eriAlarmActiveMajorType=eriAlarmActiveMajorType, eriAlarmAlertLastChanged=eriAlarmAlertLastChanged, eriAlarmCritical=eriAlarmCritical, eriAlarmAlertIndex=eriAlarmAlertIndex, eriAlarmActiveManagedObject=eriAlarmActiveManagedObject, eriAlarmActiveAdditionalText=eriAlarmActiveAdditionalText, eriAlarmAlertSeverity=eriAlarmAlertSeverity, eriAlarmAlertResourceId=eriAlarmAlertResourceId, eriAlarmNotifsPrefix=eriAlarmNotifsPrefix, eriAlarmAlertAdditionalText=eriAlarmAlertAdditionalText, eriAlarmWarnAlert=eriAlarmWarnAlert, eriAlarmActiveIndex=eriAlarmActiveIndex, eriAlarmBasicAlarmsCompliance=eriAlarmBasicAlarmsCompliance, eriAlarmHeartBeat=eriAlarmHeartBeat, eriAlarmSummary=eriAlarmSummary, eriAlarmNObjResourceId=eriAlarmNObjResourceId, eriAlarmActiveLastSequenceNo=eriAlarmActiveLastSequenceNo, eriAlarmAlertSpecificProblem=eriAlarmAlertSpecificProblem, ericssonAlarmMIB=ericssonAlarmMIB, eriAlarmActiveLastChanged=eriAlarmActiveLastChanged, eriAlarmAddAddInfoGroup=eriAlarmAddAddInfoGroup, eriAlarmNotifObjects=eriAlarmNotifObjects, eriAlarmIndeterminate=eriAlarmIndeterminate, eriAlarmAlertsGroup=eriAlarmAlertsGroup, eriAlarmActiveMinorType=eriAlarmActiveMinorType, eriAlarmAlertTableURL=eriAlarmAlertTableURL, eriAlarmIndAlert=eriAlarmIndAlert, eriAlarmSumMajor=eriAlarmSumMajor)
