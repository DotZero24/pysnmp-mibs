...
# Notes
# -----
# ASN.1 source file://mibs/rfc/TPM-MIB
...
_TpmAggrReportCntrlInterval_Type.__name__ = "Unsigned32"
...
tpmMIBCompliance.setObjects(
      *(("TPM-MIB", "tpmCapabilitiesGroup"),
        ("TPM-MIB", "tpmAggregateReportsGroup"),
        ("TPM-MIB", "tpmCurrentReportsGroup"),
        ("TPM-MIB", "tpmExceptionReportsGroup"))
)
if mibBuilder.loadTexts:
...
tpmCurrentReportsCompliance.setObjects(
      *(("TPM-MIB", "tpmCapabilitiesGroup"),
        ("TPM-MIB", "tpmAggregateReportsGroup"),
        ("TPM-MIB", "tpmCurrentReportsGroup"))
)
...
tpmExceptionReportsCompliance.setObjects(
      *(("TPM-MIB", "tpmCapabilitiesGroup"),
        ("TPM-MIB", "tpmAggregateReportsGroup"),
        ("TPM-MIB", "tpmExceptionReportsGroup"),
