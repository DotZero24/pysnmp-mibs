...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/f5/F5OS-APPLIANCE-ALERT-NOTIF-MIB
...
alertSource, alertEffect, alertSeverity, alertDescription, f5Alerts, f5AlertNotificationGroup, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertEffect", "alertSeverity", "alertDescription", "f5Alerts", "f5AlertNotificationGroup", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrHiAlarm=rxPwrHiAlarm, thermal_fault=thermal_fault, ddmVccLoWarn=ddmVccLoWarn, hardware_device_fault=hardware_device_fault, firmware_fault=firmware_fault, lcd_fault=lcd_fault, drive_thermal_throttle=drive_thermal_throttle, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempLoWarn=ddmTempLoWarn, ddmTempHiWarn=ddmTempHiWarn, f5AlertNotification=f5AlertNotification, txBiasLoAlarm=txBiasLoAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmTempHiAlarm=ddmTempHiAlarm, drive_fault=drive_fault, rxPwrLoAlarm=rxPwrLoAlarm, backplane=backplane, txBiasLoWarn=txBiasLoWarn, core_dump=core_dump, drive_utilization=drive_utilization, pcie_fault=pcie_fault, module_present=module_present, module_communication_error=module_communication_error, txPwrLoAlarm=txPwrLoAlarm, txBiasHiWarn=txBiasHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, raidEvent=raidEvent, txPwrHiAlarm=txPwrHiAlarm, rxPwrLoWarn=rxPwrLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, aom_fault=aom_fault, rxPwrHiWarn=rxPwrHiWarn, unknown_alarm=unknown_alarm, drive_capacity_fault=drive_capacity_fault, txPwrHiWarn=txPwrHiWarn, memory_fault=memory_fault, blade_hardware_fault=blade_hardware_fault, service_health=service_health, fipsError=fipsError, psu_fault=psu_fault, ddmTempLoAlarm=ddmTempLoAlarm, blade_thermal_fault=blade_thermal_fault, power_fault=power_fault, cpu_fault=cpu_fault, txPwrLoWarn=txPwrLoWarn, firmware_update_status=firmware_update_status, ddmVccHiWarn=ddmVccHiWarn, txBiasHiAlarm=txBiasHiAlarm)
