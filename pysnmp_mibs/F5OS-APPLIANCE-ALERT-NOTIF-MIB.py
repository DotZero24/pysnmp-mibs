...
f5Alerts, alertSeverity, alertTimeStamp, alertSource, f5AlertNotificationGroup, alertEffect, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertSeverity", "alertTimeStamp", "alertSource", "f5AlertNotificationGroup", "alertEffect", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", service_health=service_health, blade_hardware_fault=blade_hardware_fault, ddmVccHiAlarm=ddmVccHiAlarm, ddmVccHiWarn=ddmVccHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, drive_capacity_fault=drive_capacity_fault, PYSNMP_MODULE_ID=f5AlertNotification, fipsError=fipsError, rxPwrHiWarn=rxPwrHiWarn, txBiasHiWarn=txBiasHiWarn, lcd_fault=lcd_fault, txPwrHiAlarm=txPwrHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, txPwrLoAlarm=txPwrLoAlarm, psu_fault=psu_fault, drive_fault=drive_fault, cpu_fault=cpu_fault, txPwrHiWarn=txPwrHiWarn, drive_thermal_throttle=drive_thermal_throttle, txBiasHiAlarm=txBiasHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccLoWarn=ddmVccLoWarn, unknown_alarm=unknown_alarm, txPwrLoWarn=txPwrLoWarn, module_present=module_present, ddmTempLoAlarm=ddmTempLoAlarm, power_fault=power_fault, core_dump=core_dump, txBiasLoWarn=txBiasLoWarn, firmware_fault=firmware_fault, ddmTempLoWarn=ddmTempLoWarn, drive_utilization=drive_utilization, thermal_fault=thermal_fault, ddmTempHiWarn=ddmTempHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, pcie_fault=pcie_fault, txBiasLoAlarm=txBiasLoAlarm, memory_fault=memory_fault, aom_fault=aom_fault, module_communication_error=module_communication_error, rxPwrLoWarn=rxPwrLoWarn, hardware_device_fault=hardware_device_fault, f5AlertNotification=f5AlertNotification, raidEvent=raidEvent, blade_thermal_fault=blade_thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, firmware_update_status=firmware_update_status, backplane=backplane)
