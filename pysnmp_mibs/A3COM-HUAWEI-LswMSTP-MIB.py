...
class EnabledStatus(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('enabled',1),(_N,2)))
class Hwdot1sFormatStatus(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_O,1),('dot1s',2),('auto',3)))
_HwMstpEventsV2_ObjectIdentity=ObjectIdentity
hwMstpEventsV2=_HwMstpEventsV2_ObjectIdentity((1,3,6,1,4,1,43,45,1,2,23,1,14,0))
...
hwdot1sStpStatus=_Hwdot1sStpStatus_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,1),_Hwdot1sStpStatus_Type())
...
hwdot1sStpForceVersion=_Hwdot1sStpForceVersion_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,2),_Hwdot1sStpForceVersion_Type())
...
hwdot1sStpDiameter=_Hwdot1sStpDiameter_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,3),_Hwdot1sStpDiameter_Type())
...
hwdot1sMstBridgeMaxHops=_Hwdot1sMstBridgeMaxHops_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,4),_Hwdot1sMstBridgeMaxHops_Type())
...
hwdot1sMstMasterBridgeID=_Hwdot1sMstMasterBridgeID_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,5),_Hwdot1sMstMasterBridgeID_Type())
...
hwdot1sMstMasterPathCost=_Hwdot1sMstMasterPathCost_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,6),_Hwdot1sMstMasterPathCost_Type())
...
hwdot1sMstBpduGuard=_Hwdot1sMstBpduGuard_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,7),_Hwdot1sMstBpduGuard_Type())
...
hwdot1sMstAdminFormatSelector=_Hwdot1sMstAdminFormatSelector_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,8),_Hwdot1sMstAdminFormatSelector_Type())
...
hwdot1sMstAdminRegionName=_Hwdot1sMstAdminRegionName_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,9),_Hwdot1sMstAdminRegionName_Type())
...
hwdot1sMstAdminRevisionLevel=_Hwdot1sMstAdminRevisionLevel_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,10),_Hwdot1sMstAdminRevisionLevel_Type())
...
hwdot1sMstOperFormatSelector=_Hwdot1sMstOperFormatSelector_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,11),_Hwdot1sMstOperFormatSelector_Type())
...
hwdot1sMstOperRegionName=_Hwdot1sMstOperRegionName_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,12),_Hwdot1sMstOperRegionName_Type())
...
hwdot1sMstOperRevisionLevel=_Hwdot1sMstOperRevisionLevel_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,13),_Hwdot1sMstOperRevisionLevel_Type())
...
hwdot1sMstOperConfigDigest=_Hwdot1sMstOperConfigDigest_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,14),_Hwdot1sMstOperConfigDigest_Type())
...
hwdot1sMstRegionConfActive=_Hwdot1sMstRegionConfActive_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,15),_Hwdot1sMstRegionConfActive_Type())
...
hwdot1sMstDefaultVlanAllo=_Hwdot1sMstDefaultVlanAllo_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,16),_Hwdot1sMstDefaultVlanAllo_Type())
...
hwdot1sMstDefaultRegionName=_Hwdot1sMstDefaultRegionName_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,17),_Hwdot1sMstDefaultRegionName_Type())
...
hwdot1sVIDAllocationTable=_Hwdot1sVIDAllocationTable_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,18))
if mibBuilder.loadTexts:hwdot1sVIDAllocationTable.setStatus(_A)
_Hwdot1sVIDAllocationEntry_Object=MibTableRow
hwdot1sVIDAllocationEntry=_Hwdot1sVIDAllocationEntry_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,18,1))
hwdot1sVIDAllocationEntry.setIndexNames((0,_E,_P))
...
hwdot1sMstVID=_Hwdot1sMstVID_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,18,1,1),_Hwdot1sMstVID_Type())
...
hwdot1sAdminMstID=_Hwdot1sAdminMstID_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,18,1,2),_Hwdot1sAdminMstID_Type())
...
hwdot1sOperMstID=_Hwdot1sOperMstID_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,18,1,3),_Hwdot1sOperMstID_Type())
...
hwdot1sInstanceTable=_Hwdot1sInstanceTable_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19))
if mibBuilder.loadTexts:hwdot1sInstanceTable.setStatus(_A)
_Hwdot1sInstanceEntry_Object=MibTableRow
hwdot1sInstanceEntry=_Hwdot1sInstanceEntry_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1))
...
hwdot1sInstanceID=_Hwdot1sInstanceID_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,1),_Hwdot1sInstanceID_Type())
...
hwdot1sMstiBridgeID=_Hwdot1sMstiBridgeID_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,2),_Hwdot1sMstiBridgeID_Type())
...
hwdot1sMstiBridgePriority=_Hwdot1sMstiBridgePriority_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,3),_Hwdot1sMstiBridgePriority_Type())
...
hwdot1sMstiDesignedRoot=_Hwdot1sMstiDesignedRoot_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,4),_Hwdot1sMstiDesignedRoot_Type())
...
hwdot1sMstiRootPathCost=_Hwdot1sMstiRootPathCost_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,5),_Hwdot1sMstiRootPathCost_Type())
...
hwdot1sMstiRootPort=_Hwdot1sMstiRootPort_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,6),_Hwdot1sMstiRootPort_Type())
...
hwdot1sMstiRootType=_Hwdot1sMstiRootType_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,7),_Hwdot1sMstiRootType_Type())
...
hwdot1sMstiRemainingHops=_Hwdot1sMstiRemainingHops_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,8),_Hwdot1sMstiRemainingHops_Type())
...
hwdot1sMstiAdminMappedVlanListLow=_Hwdot1sMstiAdminMappedVlanListLow_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,9),_Hwdot1sMstiAdminMappedVlanListLow_Type())
...
hwdot1sMstiAdminMappedVlanListHigh=_Hwdot1sMstiAdminMappedVlanListHigh_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,10),_Hwdot1sMstiAdminMappedVlanListHigh_Type())
...
hwdot1sMstiOperMappedVlanListLow=_Hwdot1sMstiOperMappedVlanListLow_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,11),_Hwdot1sMstiOperMappedVlanListLow_Type())
...
hwdot1sMstiOperMappedVlanListHigh=_Hwdot1sMstiOperMappedVlanListHigh_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,19,1,12),_Hwdot1sMstiOperMappedVlanListHigh_Type())
...
hwdot1sPortTable=_Hwdot1sPortTable_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20))
if mibBuilder.loadTexts:hwdot1sPortTable.setStatus(_A)
_Hwdot1sPortEntry_Object=MibTableRow
hwdot1sPortEntry=_Hwdot1sPortEntry_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1))
...
hwdot1sMstiPortIndex=_Hwdot1sMstiPortIndex_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,1),_Hwdot1sMstiPortIndex_Type())
hwdot1sMstiPortIndex.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1sMstiPortIndex.setStatus(_A)
class _Hwdot1sMstiState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,4,5)));namedValues=NamedValues(*((_N,1),('discarding',2),('learning',4),('forwarding',5)))
_Hwdot1sMstiState_Type.__name__=_C
_Hwdot1sMstiState_Object=MibTableColumn
hwdot1sMstiState=_Hwdot1sMstiState_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,2),_Hwdot1sMstiState_Type())
...
hwdot1sMstiPortPriority=_Hwdot1sMstiPortPriority_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,3),_Hwdot1sMstiPortPriority_Type())
...
hwdot1sMstiPathCost=_Hwdot1sMstiPathCost_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,4),_Hwdot1sMstiPathCost_Type())
...
hwdot1sMstiDesignatedRoot=_Hwdot1sMstiDesignatedRoot_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,5),_Hwdot1sMstiDesignatedRoot_Type())
...
hwdot1sMstiDesignatedCost=_Hwdot1sMstiDesignatedCost_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,6),_Hwdot1sMstiDesignatedCost_Type())
...
hwdot1sMstiDesignatedBridge=_Hwdot1sMstiDesignatedBridge_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,7),_Hwdot1sMstiDesignatedBridge_Type())
...
hwdot1sMstiDesignatedPort=_Hwdot1sMstiDesignatedPort_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,8),_Hwdot1sMstiDesignatedPort_Type())
...
hwdot1sMstiMasterBridgeID=_Hwdot1sMstiMasterBridgeID_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,9),_Hwdot1sMstiMasterBridgeID_Type())
...
hwdot1sMstiMasterPortCost=_Hwdot1sMstiMasterPortCost_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,10),_Hwdot1sMstiMasterPortCost_Type())
...
hwdot1sMstiStpPortEdgeport=_Hwdot1sMstiStpPortEdgeport_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,11),_Hwdot1sMstiStpPortEdgeport_Type())
...
hwdot1sMstiStpPortPointToPoint=_Hwdot1sMstiStpPortPointToPoint_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,12),_Hwdot1sMstiStpPortPointToPoint_Type())
...
hwdot1sMstiStpMcheck=_Hwdot1sMstiStpMcheck_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,13),_Hwdot1sMstiStpMcheck_Type())
...
hwdot1sMstiStpTransLimit=_Hwdot1sMstiStpTransLimit_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,14),_Hwdot1sMstiStpTransLimit_Type())
...
hwdot1sMstiStpRXStpBPDU=_Hwdot1sMstiStpRXStpBPDU_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,15),_Hwdot1sMstiStpRXStpBPDU_Type())
...
hwdot1sMstiStpTXStpBPDU=_Hwdot1sMstiStpTXStpBPDU_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,16),_Hwdot1sMstiStpTXStpBPDU_Type())
...
hwdot1sMstiStpRXTCNBPDU=_Hwdot1sMstiStpRXTCNBPDU_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,17),_Hwdot1sMstiStpRXTCNBPDU_Type())
...
hwdot1sMstiStpTXTCNBPDU=_Hwdot1sMstiStpTXTCNBPDU_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,18),_Hwdot1sMstiStpTXTCNBPDU_Type())
...
hwdot1sMstiStpRXRSTPBPDU=_Hwdot1sMstiStpRXRSTPBPDU_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,19),_Hwdot1sMstiStpRXRSTPBPDU_Type())
...
hwdot1sMstiStpTXRSTPBPDU=_Hwdot1sMstiStpTXRSTPBPDU_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,20),_Hwdot1sMstiStpTXRSTPBPDU_Type())
...
hwdot1sMstiStpRXMSTPBPDU=_Hwdot1sMstiStpRXMSTPBPDU_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,21),_Hwdot1sMstiStpRXMSTPBPDU_Type())
...
hwdot1sMstiStpTXMSTPBPDU=_Hwdot1sMstiStpTXMSTPBPDU_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,22),_Hwdot1sMstiStpTXMSTPBPDU_Type())
...
hwdot1sMstiStpClearStatistics=_Hwdot1sMstiStpClearStatistics_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,23),_Hwdot1sMstiStpClearStatistics_Type())
...
hwdot1sMstiStpDefaultPortCost=_Hwdot1sMstiStpDefaultPortCost_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,24),_Hwdot1sMstiStpDefaultPortCost_Type())
...
hwdot1sMstiStpStatus=_Hwdot1sMstiStpStatus_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,25),_Hwdot1sMstiStpStatus_Type())
...
hwdot1sMstiPortRootGuard=_Hwdot1sMstiPortRootGuard_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,26),_Hwdot1sMstiPortRootGuard_Type())
...
hwdot1sMstiPortLoopGuard=_Hwdot1sMstiPortLoopGuard_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,27),_Hwdot1sMstiPortLoopGuard_Type())
...
hwdot1sMstiStpPortSendingBPDUType=_Hwdot1sMstiStpPortSendingBPDUType_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,28),_Hwdot1sMstiStpPortSendingBPDUType_Type())
...
hwdot1sMstiStpOperPortPointToPoint=_Hwdot1sMstiStpOperPortPointToPoint_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,29),_Hwdot1sMstiStpOperPortPointToPoint_Type())
...
hwdot1sMstiStpPortAdminBPDUFmt=_Hwdot1sMstiStpPortAdminBPDUFmt_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,30),_Hwdot1sMstiStpPortAdminBPDUFmt_Type())
...
hwdot1sMstiStpPortOperBPDUFmt=_Hwdot1sMstiStpPortOperBPDUFmt_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,31),_Hwdot1sMstiStpPortOperBPDUFmt_Type())
...
hwdot1sMstiStpPortRoleRestriction=_Hwdot1sMstiStpPortRoleRestriction_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,32),_Hwdot1sMstiStpPortRoleRestriction_Type())
...
hwdot1sMstiStpPortTcRestriction=_Hwdot1sMstiStpPortTcRestriction_Object((1,3,6,1,4,1,43,45,1,2,23,1,14,20,1,33),_Hwdot1sMstiStpPortTcRestriction_Type())
