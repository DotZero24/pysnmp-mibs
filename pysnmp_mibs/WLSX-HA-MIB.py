...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/aruba/WLSX-HA-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:44:22 2025
# On host macmini.vegmond.io platform Darwin version 24.6.0 by user rob
# Using Python version 3.12.8 (main, Dec  3 2024, 18:42:41) [Clang 16.0.0 (clang-1600.0.26.4)]
#
wlsxEnterpriseMibModules, = mibBuilder.importSymbols("ARUBA-MIB", "wlsxEnterpriseMibModules")
ArubaHaConnectivityStatus, ArubaHaRole, ArubaEnableValue = mibBuilder.importSymbols("ARUBA-TC", "ArubaHaConnectivityStatus", "ArubaHaRole", "ArubaEnableValue")
...
wlsxHaMIB.setRevisions(('2020-08-14 17:45',))
if mibBuilder.loadTexts: wlsxHaMIB.setLastUpdated('202008141745Z')
if mibBuilder.loadTexts: wlsxHaMIB.setOrganization('Aruba, a Hewlett Packard Enterprise company')
...
mibBuilder.exportSymbols("WLSX-HA-MIB", wlsxHighAvalabilityApEntry=wlsxHighAvalabilityApEntry, haOversubscription=haOversubscription, haStandbyAPs=haStandbyAPs, haReferenceCnt=haReferenceCnt, haState=haState, wlsxHaIntercontrollerHbtMiss=wlsxHaIntercontrollerHbtMiss, haHbtThreshold=haHbtThreshold, wlsxHaFailoverRequestFromAp=wlsxHaFailoverRequestFromAp, haActivePmkCacheEntries=haActivePmkCacheEntries, haStandbyVapTunnels=haStandbyVapTunnels, wlsxTrapHaHbtMissTimeStamp=wlsxTrapHaHbtMissTimeStamp, haLastHbtMissedTime=haLastHbtMissedTime, wlsxIntercontrollerHbtTable=wlsxIntercontrollerHbtTable, haTotalAPs=haTotalAPs, haTotalVapTunnels=haTotalVapTunnels, wlsxHaAPName=wlsxHaAPName, wlsxHighAvalabilityTraps=wlsxHighAvalabilityTraps, haTotalPmkCacheEntries=haTotalPmkCacheEntries, haActiveAPs=haActiveAPs, wlsxHaFailoverTrigger=wlsxHaFailoverTrigger, haActiveCtrl=haActiveCtrl, wlsxHighAvalabilityApTable=wlsxHighAvalabilityApTable, haLastMissedHbtCnt=haLastMissedHbtCnt, wlsxHaMIB=wlsxHaMIB, haPresharedKey=haPresharedKey, haTotalKeyCacheEntries=haTotalKeyCacheEntries, wlsxHaStandbyIpSentFailed=wlsxHaStandbyIpSentFailed, haHbtInterval=haHbtInterval, wlsxHaV4Role=wlsxHaV4Role, wlsxHighAvalabilityInfoGroup=wlsxHighAvalabilityInfoGroup, wlsxHaV6Role=wlsxHaV6Role, wlsxHaStandbyControllerIp=wlsxHaStandbyControllerIp, wlsxHaV4Status=wlsxHaV4Status, wlsxHighAvalabilityTunnelEntry=wlsxHighAvalabilityTunnelEntry, haPreemption=haPreemption, haAPHbtTunnels=haAPHbtTunnels, haRole=haRole, haActiveVapTunnels=haActiveVapTunnels, wlsxHaTrapDefinitionGroup=wlsxHaTrapDefinitionGroup, wlsxHighAvalabilityTunnelTable=wlsxHighAvalabilityTunnelTable, wlsxHighAvalabilityConfigTable=wlsxHighAvalabilityConfigTable, haActiveCtrlIp=haActiveCtrlIp, haTotalHbtRequestsSent=haTotalHbtRequestsSent, wlsxHaState=wlsxHaState, wlsxHaStandbyConnectivityState=wlsxHaStandbyConnectivityState, wlsxHaActiveControllerIp=wlsxHaActiveControllerIp, haReplicatedPmkCacheEntries=haReplicatedPmkCacheEntries, wlsxStateSyncTable=wlsxStateSyncTable, haIntercontrollerHbt=haIntercontrollerHbt, wlsxHaTrapObjectsGroup=wlsxHaTrapObjectsGroup, wlsxTrapHaStandbyApCnt=wlsxTrapHaStandbyApCnt, wlsxIntercontrollerHbtEntry=wlsxIntercontrollerHbtEntry, PYSNMP_MODULE_ID=wlsxHaMIB, haTotalHbtResponsesRcvd=haTotalHbtResponsesRcvd, haStateSync=haStateSync, wlsxStateSyncEntry=wlsxStateSyncEntry, wlsxHighAvalabilityConfigEntry=wlsxHighAvalabilityConfigEntry, haMembership=haMembership, haReplicatedKeyCacheEntries=haReplicatedKeyCacheEntries, wlsxTrapHaIntercontrollerHbtMissCnt=wlsxTrapHaIntercontrollerHbtMissCnt, haActiveKeyCacheEntries=haActiveKeyCacheEntries, wlsxTrapHaConnectivityStatus=wlsxTrapHaConnectivityStatus, wlsxHaV6Status=wlsxHaV6Status, haProfileName=haProfileName)
