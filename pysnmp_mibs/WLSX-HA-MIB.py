...
ArubaEnableValue, ArubaHaRole, ArubaHaConnectivityStatus = mibBuilder.importSymbols("ARUBA-TC", "ArubaEnableValue", "ArubaHaRole", "ArubaHaConnectivityStatus")
...
mibBuilder.exportSymbols("WLSX-HA-MIB", wlsxHaActiveControllerIp=wlsxHaActiveControllerIp, wlsxIntercontrollerHbtEntry=wlsxIntercontrollerHbtEntry, wlsxHighAvalabilityInfoGroup=wlsxHighAvalabilityInfoGroup, haReplicatedPmkCacheEntries=haReplicatedPmkCacheEntries, haLastMissedHbtCnt=haLastMissedHbtCnt, wlsxHaV4Role=wlsxHaV4Role, wlsxHighAvalabilityConfigTable=wlsxHighAvalabilityConfigTable, haActiveKeyCacheEntries=haActiveKeyCacheEntries, haTotalVapTunnels=haTotalVapTunnels, wlsxHaV6Status=wlsxHaV6Status, wlsxHaIntercontrollerHbtMiss=wlsxHaIntercontrollerHbtMiss, haAPHbtTunnels=haAPHbtTunnels, haHbtInterval=haHbtInterval, haHbtThreshold=haHbtThreshold, wlsxHaState=wlsxHaState, wlsxHighAvalabilityApTable=wlsxHighAvalabilityApTable, haPresharedKey=haPresharedKey, haTotalHbtResponsesRcvd=haTotalHbtResponsesRcvd, haStandbyAPs=haStandbyAPs, haProfileName=haProfileName, wlsxHighAvalabilityTunnelTable=wlsxHighAvalabilityTunnelTable, haReplicatedKeyCacheEntries=haReplicatedKeyCacheEntries, wlsxHaFailoverTrigger=wlsxHaFailoverTrigger, haStandbyVapTunnels=haStandbyVapTunnels, haTotalKeyCacheEntries=haTotalKeyCacheEntries, wlsxTrapHaStandbyApCnt=wlsxTrapHaStandbyApCnt, wlsxHaAPName=wlsxHaAPName, wlsxHaStandbyIpSentFailed=wlsxHaStandbyIpSentFailed, wlsxStateSyncEntry=wlsxStateSyncEntry, wlsxHaStandbyConnectivityState=wlsxHaStandbyConnectivityState, wlsxHighAvalabilityConfigEntry=wlsxHighAvalabilityConfigEntry, haPreemption=haPreemption, haActiveAPs=haActiveAPs, haMembership=haMembership, wlsxHaFailoverRequestFromAp=wlsxHaFailoverRequestFromAp, wlsxHaTrapObjectsGroup=wlsxHaTrapObjectsGroup, haTotalAPs=haTotalAPs, haActivePmkCacheEntries=haActivePmkCacheEntries, haIntercontrollerHbt=haIntercontrollerHbt, wlsxHighAvalabilityTunnelEntry=wlsxHighAvalabilityTunnelEntry, PYSNMP_MODULE_ID=wlsxHaMIB, haReferenceCnt=haReferenceCnt, haLastHbtMissedTime=haLastHbtMissedTime, haState=haState, wlsxHighAvalabilityTraps=wlsxHighAvalabilityTraps, haStateSync=haStateSync, haTotalHbtRequestsSent=haTotalHbtRequestsSent, haActiveVapTunnels=haActiveVapTunnels, haActiveCtrlIp=haActiveCtrlIp, wlsxHaV6Role=wlsxHaV6Role, haTotalPmkCacheEntries=haTotalPmkCacheEntries, wlsxIntercontrollerHbtTable=wlsxIntercontrollerHbtTable, wlsxTrapHaHbtMissTimeStamp=wlsxTrapHaHbtMissTimeStamp, haOversubscription=haOversubscription, haRole=haRole, wlsxHaTrapDefinitionGroup=wlsxHaTrapDefinitionGroup, wlsxTrapHaConnectivityStatus=wlsxTrapHaConnectivityStatus, wlsxTrapHaIntercontrollerHbtMissCnt=wlsxTrapHaIntercontrollerHbtMissCnt, haActiveCtrl=haActiveCtrl, wlsxHaV4Status=wlsxHaV4Status, wlsxHighAvalabilityApEntry=wlsxHighAvalabilityApEntry, wlsxStateSyncTable=wlsxStateSyncTable, wlsxHaMIB=wlsxHaMIB, wlsxHaStandbyControllerIp=wlsxHaStandbyControllerIp)
