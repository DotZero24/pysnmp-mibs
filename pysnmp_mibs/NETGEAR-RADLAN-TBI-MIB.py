# SNMP MIB module (NETGEAR-RADLAN-TBI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-TBI-MIB
...
rlTBITimeRangeEntry = _RlTBITimeRangeEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 145, 1, 1)
)
rlTBITimeRangeEntry.setIndexNames(
    (1, "NETGEAR-RADLAN-TBI-MIB", "rlTBITimeRangeName"),
)
if mibBuilder.loadTexts:
...
rlTBIPeriodicTable = _RlTBIPeriodicTable_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 145, 2)
)
if mibBuilder.loadTexts:
    rlTBIPeriodicTable.setStatus("current")
_RlTBIPeriodicEntry_Object = MibTableRow
rlTBIPeriodicEntry = _RlTBIPeriodicEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 145, 2, 1)
)
rlTBIPeriodicEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-TBI-MIB", "rlTBIPeriodicTimeRangeName"),
    (0, "NETGEAR-RADLAN-TBI-MIB", "rlTBIPeriodicWeekDayList"),
    (0, "NETGEAR-RADLAN-TBI-MIB", "rlTBIPeriodicStart"),
    (0, "NETGEAR-RADLAN-TBI-MIB", "rlTBIPeriodicEnd"),
)
if mibBuilder.loadTexts:
