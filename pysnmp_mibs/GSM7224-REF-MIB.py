# SNMP MIB module (GSM7224-REF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/GSM7224-REF-MIB
...
gsm7224 = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 1, 8)
)
if mibBuilder.loadTexts:
    gsm7224.setRevisions(
        ("2003-05-06 12:00",)
    )
