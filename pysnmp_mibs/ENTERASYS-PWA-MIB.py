...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-PWA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:47:25 2025
...
_EtsysPwaSystemAuthControl_Type.__name__ = "EnabledStatus"
...
_EtsysPwaSystemAuthBanner_Type.__name__ = "SnmpAdminString"
...
_EtsysPwaSystemPwaNameServicesEnable_Type.__name__ = "EnabledStatus"
...
_EtsysPwaSystemAuthEnhancedMode_Type.__name__ = "EnabledStatus"
...
_EtsysPwaLogoDisplayStatus_Type.__name__ = "EnabledStatus"
...
_EtsysPwaSystemGuestPasswordValid_Type.__name__ = "TruthValue"
...
class _EtsysPwaSystemAccountEnable_Type(EnabledStatus):
    """Custom type etsysPwaSystemAccountEnable based on EnabledStatus"""
    defaultValue = 1


_EtsysPwaSystemAccountEnable_Type.__name__ = "EnabledStatus"
_EtsysPwaSystemAccountEnable_Object = MibScalar
etsysPwaSystemAccountEnable = _EtsysPwaSystemAccountEnable_Object(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 8, 1, 18),
    _EtsysPwaSystemAccountEnable_Type()
)
etsysPwaSystemAccountEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    etsysPwaSystemAccountEnable.setStatus("current")
...
if mibBuilder.loadTexts:
    etsysPwaSystemGroupI.setStatus("deprecated")
...
etsysPwaSystemGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 8, 5, 8)
)
etsysPwaSystemGroup2.setObjects(
      *(("ENTERASYS-PWA-MIB", "etsysPwaSystemAuthControl"),
        ("ENTERASYS-PWA-MIB", "etsysPwaSystemAuthHostName"),
        ("ENTERASYS-PWA-MIB", "etsysPwaSystemAuthBanner"),
        ("ENTERASYS-PWA-MIB", "etsysPwaSystemPwaNameServicesEnable"),
...
if mibBuilder.loadTexts:
    etsysPwaSystemGroup2.setStatus("current")
...
etsysPwaMIBCompliance.setObjects(
      *(("ENTERASYS-PWA-MIB", "etsysPwaSystemGroup"),
        ("ENTERASYS-PWA-MIB", "etsysPwaPortConfigurationGroup"),
        ("ENTERASYS-PWA-MIB", "etsysPwaPortStatusGroup"),
        ("ENTERASYS-PWA-MIB", "etsysPwaSessionGroup"))
)
if mibBuilder.loadTexts:
...
etsysPwaMIBComplianceI.setObjects(
      *(("ENTERASYS-PWA-MIB", "etsysPwaSystemGroupI"),
        ("ENTERASYS-PWA-MIB", "etsysPwaPortConfigurationGroup"),
        ("ENTERASYS-PWA-MIB", "etsysPwaPortStatusGroup"),
        ("ENTERASYS-PWA-MIB", "etsysPwaSessionGroup"))
)
...
etsysPwaMIBCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 8, 6, 3)
)
etsysPwaMIBCompliance2.setObjects(
      *(("ENTERASYS-PWA-MIB", "etsysPwaSystemGroup2"),
        ("ENTERASYS-PWA-MIB", "etsysPwaPortConfigurationGroup"),
        ("ENTERASYS-PWA-MIB", "etsysPwaPortStatusGroup"),
        ("ENTERASYS-PWA-MIB", "etsysPwaSessionGroup"))
)
if mibBuilder.loadTexts:
    etsysPwaMIBCompliance2.setStatus(
        "current"
    )

etsysPwaMIBHighCapacityCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 8, 6, 4)
)
etsysPwaMIBHighCapacityCompliance.setObjects(
    ("ENTERASYS-PWA-MIB", "etsysPwaSessionHCGroup")
)
if mibBuilder.loadTexts:
    etsysPwaMIBHighCapacityCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"etsysPwaMIB": etsysPwaMIB,
       ...
       "etsysPwaSystemAccountEnable": etsysPwaSystemAccountEnable,
       ...
       "etsysPwaSystemGroup2": etsysPwaSystemGroup2,
       ...
       "etsysPwaMIBHighCapacityCompliance": etsysPwaMIBHighCapacityCompliance}
)
