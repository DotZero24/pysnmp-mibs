...
# Notes
# -----
# ASN.1 source file://mibs/hp/CPQSRVMN-MIB
...
class _CpqSmMibRevMajor_Type(Integer32):
    """Custom type cpqSmMibRevMajor based on Integer32"""
...
_CpqSmMibRevMajor_Type.__name__ = "Integer32"
_CpqSmMibRevMajor_Object = MibScalar
cpqSmMibRevMajor = _CpqSmMibRevMajor_Object(
    (1, 3, 6, 1, 4, 1, 232, 4, 1, 1),
    _CpqSmMibRevMajor_Type()
)
cpqSmMibRevMajor.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSmMibRevMajor.setStatus("mandatory")


class _CpqSmMibRevMinor_Type(Integer32):
    """Custom type cpqSmMibRevMinor based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqSmMibRevMinor_Type.__name__ = "Integer32"
_CpqSmMibRevMinor_Object = MibScalar
cpqSmMibRevMinor = _CpqSmMibRevMinor_Object(
    (1, 3, 6, 1, 4, 1, 232, 4, 1, 2),
    _CpqSmMibRevMinor_Type()
)
cpqSmMibRevMinor.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSmMibRevMinor.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"cpqServerManager": cpqServerManager,
       ...
       "cpqSmMibRevMajor": cpqSmMibRevMajor,
       "cpqSmMibRevMinor": cpqSmMibRevMinor,
