...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-CONFIG-MAN-MIB
...
h3cConfigManCompliance.setObjects(
      *(("A3COM-HUAWEI-CONFIG-MAN-MIB", "h3cCfgManLogGroup"),
        ("A3COM-HUAWEI-CONFIG-MAN-MIB", "h3cCfgOperateGroup"),
        ("A3COM-HUAWEI-CONFIG-MAN-MIB", "h3cCfgManNotificationGroup"))
)
if mibBuilder.loadTexts:
