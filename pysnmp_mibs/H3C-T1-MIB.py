...
if mibBuilder.loadTexts:h3cT1.setRevisions(('2012-07-16 17:41','2009-06-08 17:41','2004-12-01 14:36'))
...
t1InterfaceStatusTable=_T1InterfaceStatusTable_Object((1,3,6,1,4,1,2011,10,2,29,1))
if mibBuilder.loadTexts:t1InterfaceStatusTable.setStatus(_A)
_T1InterfaceStatusEntry_Object=MibTableRow
t1InterfaceStatusEntry=_T1InterfaceStatusEntry_Object((1,3,6,1,4,1,2011,10,2,29,1,1))
...
t1InterfaceInErrs=_T1InterfaceInErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,1),_T1InterfaceInErrs_Type())
...
t1InterfaceInRuntsErrs=_T1InterfaceInRuntsErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,2),_T1InterfaceInRuntsErrs_Type())
...
t1InterfaceInGiantsErrs=_T1InterfaceInGiantsErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,3),_T1InterfaceInGiantsErrs_Type())
...
t1InterfaceInCrcErrs=_T1InterfaceInCrcErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,4),_T1InterfaceInCrcErrs_Type())
...
t1InterfaceInAlignErrs=_T1InterfaceInAlignErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,5),_T1InterfaceInAlignErrs_Type())
...
t1InterfaceInOverRunsErrs=_T1InterfaceInOverRunsErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,6),_T1InterfaceInOverRunsErrs_Type())
...
t1InterfaceInDribblesErrs=_T1InterfaceInDribblesErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,7),_T1InterfaceInDribblesErrs_Type())
...
t1InterfaceInAbortedSeqErrs=_T1InterfaceInAbortedSeqErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,8),_T1InterfaceInAbortedSeqErrs_Type())
...
t1InterfaceInNoBufferErrs=_T1InterfaceInNoBufferErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,9),_T1InterfaceInNoBufferErrs_Type())
...
t1InterfaceInFramingErrs=_T1InterfaceInFramingErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,10),_T1InterfaceInFramingErrs_Type())
...
t1InterfaceOutputErrs=_T1InterfaceOutputErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,11),_T1InterfaceOutputErrs_Type())
...
t1InterfaceOutUnderRunErrs=_T1InterfaceOutUnderRunErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,12),_T1InterfaceOutUnderRunErrs_Type())
...
t1InterfaceOutCollisonsErrs=_T1InterfaceOutCollisonsErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,13),_T1InterfaceOutCollisonsErrs_Type())
...
t1InterfaceOutDeferedErrs=_T1InterfaceOutDeferedErrs_Object((1,3,6,1,4,1,2011,10,2,29,1,1,14),_T1InterfaceOutDeferedErrs_Type())
...
h3ct1Table=_H3ct1Table_Object((1,3,6,1,4,1,2011,10,2,29,2))
if mibBuilder.loadTexts:h3ct1Table.setStatus(_A)
_H3ct1Entry_Object=MibTableRow
h3ct1Entry=_H3ct1Entry_Object((1,3,6,1,4,1,2011,10,2,29,2,1))
...
h3ct1Type=_H3ct1Type_Object((1,3,6,1,4,1,2011,10,2,29,2,1,1),_H3ct1Type_Type())
h3ct1Type.setMaxAccess(_B)
if mibBuilder.loadTexts:h3ct1Type.setStatus(_A)
class _H3ct1Clock_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*(('slave',1),('master',2),('internal',3),('line',4),('linePri',5)))
_H3ct1Clock_Type.__name__=_E
_H3ct1Clock_Object=MibTableColumn
h3ct1Clock=_H3ct1Clock_Object((1,3,6,1,4,1,2011,10,2,29,2,1,2),_H3ct1Clock_Type())
...
h3ct1FrameFormat=_H3ct1FrameFormat_Object((1,3,6,1,4,1,2011,10,2,29,2,1,3),_H3ct1FrameFormat_Type())
...
h3ct1LineCode=_H3ct1LineCode_Object((1,3,6,1,4,1,2011,10,2,29,2,1,4),_H3ct1LineCode_Type())
...
h3ct1PriSetTimeSlot=_H3ct1PriSetTimeSlot_Object((1,3,6,1,4,1,2011,10,2,29,2,1,5),_H3ct1PriSetTimeSlot_Type())
...
h3ct1DChannelIndex=_H3ct1DChannelIndex_Object((1,3,6,1,4,1,2011,10,2,29,2,1,6),_H3ct1DChannelIndex_Type())
...
h3ct1SubScribLineChannelIndex=_H3ct1SubScribLineChannelIndex_Object((1,3,6,1,4,1,2011,10,2,29,2,1,7),_H3ct1SubScribLineChannelIndex_Type())
...
h3ct1InterfaceTable=_H3ct1InterfaceTable_Object((1,3,6,1,4,1,2011,10,2,29,3))
if mibBuilder.loadTexts:h3ct1InterfaceTable.setStatus(_A)
_H3ct1InterfaceEntry_Object=MibTableRow
h3ct1InterfaceEntry=_H3ct1InterfaceEntry_Object((1,3,6,1,4,1,2011,10,2,29,3,1))
