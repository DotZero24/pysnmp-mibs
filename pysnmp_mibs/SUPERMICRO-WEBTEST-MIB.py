...
fsWebTstMIB=ModuleIdentity((1,3,6,1,4,1,10876,101,2,66))
if mibBuilder.loadTexts:fsWebTstMIB.setRevisions(('2012-09-05 00:00',))
_FutureHttpTstTable_ObjectIdentity=ObjectIdentity
futureHttpTstTable=_FutureHttpTstTable_ObjectIdentity((1,3,6,1,4,1,10876,101,2,66,1))
_FsHttpAuthTestTable_Object=MibTable
fsHttpAuthTestTable=_FsHttpAuthTestTable_Object((1,3,6,1,4,1,10876,101,2,66,1,1))
if mibBuilder.loadTexts:fsHttpAuthTestTable.setStatus(_A)
_FsHttpAuthTestEntry_Object=MibTableRow
fsHttpAuthTestEntry=_FsHttpAuthTestEntry_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1))
...
fsHttpSessionId=_FsHttpSessionId_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,1),_FsHttpSessionId_Type())
...
fsHttpWWWAuthHeader=_FsHttpWWWAuthHeader_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,2),_FsHttpWWWAuthHeader_Type())
...
fsHttpAuthorizeHeader=_FsHttpAuthorizeHeader_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,3),_FsHttpAuthorizeHeader_Type())
...
fsHttpAuthInfoHeader=_FsHttpAuthInfoHeader_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,4),_FsHttpAuthInfoHeader_Type())
...
fsHttpWWWAuthScheme=_FsHttpWWWAuthScheme_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,5),_FsHttpWWWAuthScheme_Type())
...
fsHttpWWWAuthRealm=_FsHttpWWWAuthRealm_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,6),_FsHttpWWWAuthRealm_Type())
...
fsHttpWWWAuthUsername=_FsHttpWWWAuthUsername_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,7),_FsHttpWWWAuthUsername_Type())
...
fsHttpWWWAuthNonce=_FsHttpWWWAuthNonce_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,8),_FsHttpWWWAuthNonce_Type())
...
fsHttpWWWAuthQop=_FsHttpWWWAuthQop_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,9),_FsHttpWWWAuthQop_Type())
...
fsHttpWWWAuthAlgorithm=_FsHttpWWWAuthAlgorithm_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,10),_FsHttpWWWAuthAlgorithm_Type())
...
fsHttpWWWAuthStale=_FsHttpWWWAuthStale_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,11),_FsHttpWWWAuthStale_Type())
...
fsHttpAuthInfoQop=_FsHttpAuthInfoQop_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,12),_FsHttpAuthInfoQop_Type())
...
fsHttpAuthInfoRespAuth=_FsHttpAuthInfoRespAuth_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,13),_FsHttpAuthInfoRespAuth_Type())
...
fsHttpAuthInfoCnonce=_FsHttpAuthInfoCnonce_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,14),_FsHttpAuthInfoCnonce_Type())
...
fsHttpAuthInfoNonceCount=_FsHttpAuthInfoNonceCount_Object((1,3,6,1,4,1,10876,101,2,66,1,1,1,15),_FsHttpAuthInfoNonceCount_Type())
