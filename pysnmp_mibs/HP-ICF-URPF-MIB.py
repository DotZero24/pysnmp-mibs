...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-URPF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:32:51 2025
...
_HpicfUrpfConfigGlobalEnable_Type.__name__ = "TruthValue"
...
_HpicfUrpfConfigDefRoute_Type.__name__ = "TruthValue"
...
_HpicfUrpfConfigAllowDhcp_Type.__name__ = "TruthValue"
...
_HpicfUrpfConfigLogging_Type.__name__ = "TruthValue"
...
_HpicfUrpfConfigHasWhitelistAcl_Type.__name__ = "TruthValue"
...
class _HpicfUrpfConfigHasAllowlistAcl_Type(TruthValue):
    """Custom type hpicfUrpfConfigHasAllowlistAcl based on TruthValue"""
    defaultValue = 2


_HpicfUrpfConfigHasAllowlistAcl_Type.__name__ = "TruthValue"
_HpicfUrpfConfigHasAllowlistAcl_Object = MibTableColumn
hpicfUrpfConfigHasAllowlistAcl = _HpicfUrpfConfigHasAllowlistAcl_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 131, 1, 3, 1, 9),
    _HpicfUrpfConfigHasAllowlistAcl_Type()
)
hpicfUrpfConfigHasAllowlistAcl.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUrpfConfigHasAllowlistAcl.setStatus("current")
_HpicfUrpfConfigAllowlistAclName_Type = SnmpAdminString
_HpicfUrpfConfigAllowlistAclName_Object = MibTableColumn
hpicfUrpfConfigAllowlistAclName = _HpicfUrpfConfigAllowlistAclName_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 131, 1, 3, 1, 10),
    _HpicfUrpfConfigAllowlistAclName_Type()
)
hpicfUrpfConfigAllowlistAclName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUrpfConfigAllowlistAclName.setStatus("current")
...
if mibBuilder.loadTexts:
    hpicfUrpfConfigTableGroup.setStatus("deprecated")
...
hpicfUrpfConfigTableGroup1 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 131, 3, 1, 4)
)
hpicfUrpfConfigTableGroup1.setObjects(
      *(("HP-ICF-URPF-MIB", "hpicfUrpfConfigMode"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfConfigDefRoute"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfConfigAllowDhcp"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfConfigLogging"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfConfigHasWhitelistAcl"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfConfigWhitelistAclName"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfConfigHasAllowlistAcl"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfConfigAllowlistAclName"))
)
if mibBuilder.loadTexts:
    hpicfUrpfConfigTableGroup1.setStatus("current")
...
hpicfUrpfMIBCompliance.setObjects(
      *(("HP-ICF-URPF-MIB", "hpicfUrpfScalarGroup"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfConfigTableGroup"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfStatsTableGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUrpfMIBCompliance1 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 131, 3, 2, 2)
)
hpicfUrpfMIBCompliance1.setObjects(
      *(("HP-ICF-URPF-MIB", "hpicfUrpfScalarGroup"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfConfigTableGroup1"),
        ("HP-ICF-URPF-MIB", "hpicfUrpfStatsTableGroup"))
)
if mibBuilder.loadTexts:
    hpicfUrpfMIBCompliance1.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpicfUrpfMIB": hpicfUrpfMIB,
       ...
       "hpicfUrpfConfigHasAllowlistAcl": hpicfUrpfConfigHasAllowlistAcl,
       "hpicfUrpfConfigAllowlistAclName": hpicfUrpfConfigAllowlistAclName,
       ...
       "hpicfUrpfConfigTableGroup1": hpicfUrpfConfigTableGroup1,
       "hpicfUrpfMIBCompliances": hpicfUrpfMIBCompliances,
       "hpicfUrpfMIBCompliance": hpicfUrpfMIBCompliance,
       "hpicfUrpfMIBCompliance1": hpicfUrpfMIBCompliance1}
)
