...
DisplayString, TestAndIncr, DateAndTime, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TestAndIncr", "DateAndTime", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-LICENSE-MGR-MIB", clmPortLicensingType=clmPortLicensingType, clmLicenseExpiryNotify=clmLicenseExpiryNotify, clmLicenseRequestCommandStatus=clmLicenseRequestCommandStatus, clmNoOfLicensedFeatures=clmNoOfLicensedFeatures, clmLicenseExpiryDate=clmLicenseExpiryDate, ciscoLicenseMgrCompliances=ciscoLicenseMgrCompliances, clmLicenseInformationGroupSup1=clmLicenseInformationGroupSup1, clmPortLicensingConfig=clmPortLicensingConfig, clmNoOfMissingUsageLicenses=clmNoOfMissingUsageLicenses, clmLicenseRequestAppName=clmLicenseRequestAppName, clmLicenseFeatureUsageEntry=clmLicenseFeatureUsageEntry, clmLicenseFileNoOfRows=clmLicenseFileNoOfRows, clmMaxSslTransactions=clmMaxSslTransactions, clmLicenseRequestFeatureName=clmLicenseRequestFeatureName, clmLicenseGracePeriodLeft=clmLicenseGracePeriodLeft, clmLicenseFileTargetName=clmLicenseFileTargetName, clmCompressionPerformance=clmCompressionPerformance, clmNoOfLicenseMaxUsages=clmNoOfLicenseMaxUsages, clmLicenseInformationGroup2=clmLicenseInformationGroup2, clmPortLicensingTable=clmPortLicensingTable, clmLicenseFileURI=clmLicenseFileURI, clmNoLicenseForFeatureNotify=clmNoLicenseForFeatureNotify, clmLicenseInformationGroup=clmLicenseInformationGroup, ciscoLicenseMgrConfig=ciscoLicenseMgrConfig, clmLicenseInformationPortLicGroup=clmLicenseInformationPortLicGroup, clmPortLicCountMax=clmPortLicCountMax, ciscoLicenseMgrCompliance1=ciscoLicenseMgrCompliance1, clmLicensedAppName=clmLicensedAppName, clmNoOfLicenseCurrentUsages=clmNoOfLicenseCurrentUsages, ciscoLicenseMgrMIBConform=ciscoLicenseMgrMIBConform, clmLicenseInformationGroupSup2=clmLicenseInformationGroupSup2, clmLicenseFileContentsTable=clmLicenseFileContentsTable, ciscoLicenseMgrMIB=ciscoLicenseMgrMIB, clmLicenseFeatureStatus=clmLicenseFeatureStatus, clmLicenseConfiguration=clmLicenseConfiguration, clmLicensedAppIndex=clmLicensedAppIndex, clmWebOptimization=clmWebOptimization, clmLicenseFileMissingNotify=clmLicenseFileMissingNotify, clmLicenseFeatureStatusGroup=clmLicenseFeatureStatusGroup, ciscoLicenseMgrMIBObjects=ciscoLicenseMgrMIBObjects, clmPortLicCountUsed=clmPortLicCountUsed, clmLicenseEnabled=clmLicenseEnabled, clmLicenseRequestSpinLock=clmLicenseRequestSpinLock, ClmLicenseType=ClmLicenseType, clmLicenseInformationGroup1=clmLicenseInformationGroup1, clmPortLicCountTable=clmPortLicCountTable, clmLicenseFeatureName=clmLicenseFeatureName, ciscoLicenseMgrMIBNotifs=ciscoLicenseMgrMIBNotifs, clmLicenseFileRowContents=clmLicenseFileRowContents, clmLicenseConfigCommandStatus=clmLicenseConfigCommandStatus, clmFeatureUsageDetailsEntry=clmFeatureUsageDetailsEntry, clmNoOfLicenseFilesInstalled=clmNoOfLicenseFilesInstalled, clmLicenseFileContentsEntry=clmLicenseFileContentsEntry, ciscoLicenseMgrCompliance3=ciscoLicenseMgrCompliance3, clmHostId=clmHostId, clmLicenseFeatureUsageTable=clmLicenseFeatureUsageTable, clmLicenseRequestCommand=clmLicenseRequestCommand, clmNotificationsEnable=clmNotificationsEnable, clmPortLicCountUsedInternal=clmPortLicCountUsedInternal, clmLicenseFileTimeStamp=clmLicenseFileTimeStamp, ciscoLicenseMgrGroups=ciscoLicenseMgrGroups, clmLicenseInstallGroup=clmLicenseInstallGroup, clmLicenseFileRowNumber=clmLicenseFileRowNumber, clmModuleBandwidth=clmModuleBandwidth, ciscoLicenseMgrCompliance4=ciscoLicenseMgrCompliance4, clmNoOfInstalledLicensesGroup=clmNoOfInstalledLicensesGroup, clmLicenseInformation=clmLicenseInformation, clmLicenseConfigCommand=clmLicenseConfigCommand, clmPortLicensingOper=clmPortLicensingOper, clmPortLicCountMaxInternal=clmPortLicCountMaxInternal, clmLicenseDefaultLicenses=clmLicenseDefaultLicenses, clmNotificationsEnableGroup=clmNotificationsEnableGroup, PYSNMP_MODULE_ID=ciscoLicenseMgrMIB, ciscoLicenseMgrCompliance=ciscoLicenseMgrCompliance, clmLicenseViolationWarnFlag=clmLicenseViolationWarnFlag, clmNotificationGroup=clmNotificationGroup, ciscoLicenseMgrNotifications=ciscoLicenseMgrNotifications, clmPortLicensingEntry=clmPortLicensingEntry, clmLicenseGracePeriod=clmLicenseGracePeriod, clmLicenseConfigSpinLock=clmLicenseConfigSpinLock, clmFeatureUsageDetailsTable=clmFeatureUsageDetailsTable, clmLicenseFileName=clmLicenseFileName, clmPortLicCountEntry=clmPortLicCountEntry, clmLicenseRequestGroup=clmLicenseRequestGroup, clmLicenseFlag=clmLicenseFlag, clmLicenseInformationGroup3=clmLicenseInformationGroup3, clmMaxVirtualizedContext=clmMaxVirtualizedContext, clmLicenseExpiryWarningNotify=clmLicenseExpiryWarningNotify, ciscoLicenseMgrCompliance2=ciscoLicenseMgrCompliance2, ciscoLicenseMgrCompliance5=ciscoLicenseMgrCompliance5)
