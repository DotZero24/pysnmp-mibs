...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-LICENSE-MGR-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:26:08 2025
...
DateAndTime, TextualConvention, TestAndIncr, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "TestAndIncr", "TruthValue", "DisplayString")
...
if mibBuilder.loadTexts: ciscoLicenseMgrMIB.setLastUpdated('201904150000Z')
...
clmPortLicensingTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 369, 1, 3, 7), )
if mibBuilder.loadTexts: clmPortLicensingTable.setStatus('current')
clmPortLicensingEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 369, 1, 3, 7, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"), (0, "CISCO-LICENSE-MGR-MIB", "clmPortLicensingType"))
if mibBuilder.loadTexts: clmPortLicensingEntry.setStatus('current')
clmPortLicensingType = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 369, 1, 3, 7, 1, 1), ClmLicenseType())
...
clmPortLicCountTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 369, 1, 3, 8), )
if mibBuilder.loadTexts: clmPortLicCountTable.setStatus('current')
clmPortLicCountEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 369, 1, 3, 8, 1), ).setIndexNames((0, "CISCO-LICENSE-MGR-MIB", "clmPortLicensingType"))
...
mibBuilder.exportSymbols("CISCO-LICENSE-MGR-MIB", clmLicenseEnabled=clmLicenseEnabled, clmLicenseRequestAppName=clmLicenseRequestAppName, clmNoOfLicensedFeatures=clmNoOfLicensedFeatures, clmNotificationsEnable=clmNotificationsEnable, clmPortLicensingTable=clmPortLicensingTable, clmPortLicCountTable=clmPortLicCountTable, ciscoLicenseMgrMIBConform=ciscoLicenseMgrMIBConform, clmLicenseConfiguration=clmLicenseConfiguration, clmLicenseDefaultLicenses=clmLicenseDefaultLicenses, clmLicenseExpiryWarningNotify=clmLicenseExpiryWarningNotify, ciscoLicenseMgrConfig=ciscoLicenseMgrConfig, clmLicenseFileContentsTable=clmLicenseFileContentsTable, clmLicenseFileRowNumber=clmLicenseFileRowNumber, PYSNMP_MODULE_ID=ciscoLicenseMgrMIB, clmLicenseInformationGroup3=clmLicenseInformationGroup3, clmFeatureUsageDetailsTable=clmFeatureUsageDetailsTable, clmLicenseFileTimeStamp=clmLicenseFileTimeStamp, clmLicenseFileURI=clmLicenseFileURI, ciscoLicenseMgrCompliance2=ciscoLicenseMgrCompliance2, clmPortLicCountUsedInternal=clmPortLicCountUsedInternal, clmPortLicensingType=clmPortLicensingType, clmPortLicCountEntry=clmPortLicCountEntry, clmLicenseViolationWarnFlag=clmLicenseViolationWarnFlag, clmLicenseConfigSpinLock=clmLicenseConfigSpinLock, clmLicenseConfigCommandStatus=clmLicenseConfigCommandStatus, clmLicenseRequestCommand=clmLicenseRequestCommand, clmPortLicensingOper=clmPortLicensingOper, clmLicenseGracePeriod=clmLicenseGracePeriod, clmNotificationsEnableGroup=clmNotificationsEnableGroup, clmLicenseFileRowContents=clmLicenseFileRowContents, ciscoLicenseMgrNotifications=ciscoLicenseMgrNotifications, clmLicenseInformation=clmLicenseInformation, clmLicenseRequestFeatureName=clmLicenseRequestFeatureName, clmMaxVirtualizedContext=clmMaxVirtualizedContext, clmNoOfLicenseCurrentUsages=clmNoOfLicenseCurrentUsages, ciscoLicenseMgrMIBNotifs=ciscoLicenseMgrMIBNotifs, clmHostId=clmHostId, ciscoLicenseMgrMIB=ciscoLicenseMgrMIB, ciscoLicenseMgrCompliance4=ciscoLicenseMgrCompliance4, clmLicenseFeatureUsageTable=clmLicenseFeatureUsageTable, clmModuleBandwidth=clmModuleBandwidth, clmLicenseInstallGroup=clmLicenseInstallGroup, clmNoOfInstalledLicensesGroup=clmNoOfInstalledLicensesGroup, clmLicenseFeatureStatusGroup=clmLicenseFeatureStatusGroup, clmLicenseFlag=clmLicenseFlag, clmLicenseInformationGroupSup2=clmLicenseInformationGroupSup2, clmNoOfMissingUsageLicenses=clmNoOfMissingUsageLicenses, clmLicenseGracePeriodLeft=clmLicenseGracePeriodLeft, ClmLicenseType=ClmLicenseType, clmLicenseExpiryNotify=clmLicenseExpiryNotify, clmPortLicCountUsed=clmPortLicCountUsed, clmLicenseInformationGroupSup1=clmLicenseInformationGroupSup1, clmNoLicenseForFeatureNotify=clmNoLicenseForFeatureNotify, clmNoOfLicenseMaxUsages=clmNoOfLicenseMaxUsages, ciscoLicenseMgrGroups=ciscoLicenseMgrGroups, clmLicenseFeatureName=clmLicenseFeatureName, ciscoLicenseMgrCompliance3=ciscoLicenseMgrCompliance3, clmFeatureUsageDetailsEntry=clmFeatureUsageDetailsEntry, ciscoLicenseMgrCompliance5=ciscoLicenseMgrCompliance5, clmLicenseConfigCommand=clmLicenseConfigCommand, clmPortLicCountMax=clmPortLicCountMax, clmLicenseFileName=clmLicenseFileName, clmCompressionPerformance=clmCompressionPerformance, ciscoLicenseMgrMIBObjects=ciscoLicenseMgrMIBObjects, ciscoLicenseMgrCompliances=ciscoLicenseMgrCompliances, clmLicenseFileNoOfRows=clmLicenseFileNoOfRows, clmLicenseRequestCommandStatus=clmLicenseRequestCommandStatus, clmWebOptimization=clmWebOptimization, clmPortLicCountMaxInternal=clmPortLicCountMaxInternal, clmLicenseFileTargetName=clmLicenseFileTargetName, clmLicenseFeatureUsageEntry=clmLicenseFeatureUsageEntry, clmLicenseRequestSpinLock=clmLicenseRequestSpinLock, clmNoOfLicenseFilesInstalled=clmNoOfLicenseFilesInstalled, clmMaxSslTransactions=clmMaxSslTransactions, clmLicenseInformationGroup1=clmLicenseInformationGroup1, clmLicenseExpiryDate=clmLicenseExpiryDate, clmLicenseRequestGroup=clmLicenseRequestGroup, clmPortLicensingConfig=clmPortLicensingConfig, clmNotificationGroup=clmNotificationGroup, ciscoLicenseMgrCompliance1=ciscoLicenseMgrCompliance1, clmLicenseFileMissingNotify=clmLicenseFileMissingNotify, clmLicensedAppIndex=clmLicensedAppIndex, clmLicenseFeatureStatus=clmLicenseFeatureStatus, clmLicenseInformationPortLicGroup=clmLicenseInformationPortLicGroup, clmPortLicensingEntry=clmPortLicensingEntry, clmLicenseInformationGroup=clmLicenseInformationGroup, clmLicenseFileContentsEntry=clmLicenseFileContentsEntry, clmLicenseInformationGroup2=clmLicenseInformationGroup2, clmLicensedAppName=clmLicensedAppName, ciscoLicenseMgrCompliance=ciscoLicenseMgrCompliance)
