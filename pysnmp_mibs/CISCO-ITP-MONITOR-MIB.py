...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ITP-MONITOR-MIB
...
_CItpmConnFastStart_Type.__name__ = "TruthValue"
...
_CItpmCongestionNotifEnabled_Type.__name__ = "TruthValue"
...
_CItpmMonitorStateNotifEnabled_Type.__name__ = "TruthValue"
...
ciscoItpmMIBCompliance.setObjects(
      *(("CISCO-ITP-MONITOR-MIB", "ciscoItpmConnGroup"),
        ("CISCO-ITP-MONITOR-MIB", "ciscoItpmLinkGroup"),
        ("CISCO-ITP-MONITOR-MIB", "ciscoItpmNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoItpmMIBComplianceRev1.setObjects(
      *(("CISCO-ITP-MONITOR-MIB", "ciscoItpmConnGroupRev1"),
        ("CISCO-ITP-MONITOR-MIB", "ciscoItpmLinkGroup"),
        ("CISCO-ITP-MONITOR-MIB", "ciscoItpmNotificationsGroupRev1"))
)
if mibBuilder.loadTexts:
