...
mibBuilder.exportSymbols("CISCO-ITP-MONITOR-MIB", ciscoItpmMIBCompliance=ciscoItpmMIBCompliance, cItpmLinkRcvdMsus=cItpmLinkRcvdMsus, cItpmCongestionNotifEnabled=cItpmCongestionNotifEnabled, cItpmMonitorStateNotifEnabled=cItpmMonitorStateNotifEnabled, cItpmLinkStatus=cItpmLinkStatus, ciscoItpmMIBCompliances=ciscoItpmMIBCompliances, ciscoItpmNotificationsGroupRev1=ciscoItpmNotificationsGroupRev1, ciscoItpmMIB=ciscoItpmMIB, ciscoItpmConnGroup=ciscoItpmConnGroup, cItpmConnCongestion=cItpmConnCongestion, cItpmConnQueueDepth=cItpmConnQueueDepth, ciscoItpMonitorState=ciscoItpMonitorState, cItpmConnCongOnset=cItpmConnCongOnset, cItpmConnPortNumber=cItpmConnPortNumber, cItpmConnCongCounts=cItpmConnCongCounts, cItpmLinkDescription=cItpmLinkDescription, ciscoItpmMIBNotifs=ciscoItpmMIBNotifs, ciscoItpmLinkGroup=ciscoItpmLinkGroup, cItpmConnTable=cItpmConnTable, cItpmLinkRcvdMsuDrops=cItpmLinkRcvdMsuDrops, cItpmLinkRcvdMsuRate=cItpmLinkRcvdMsuRate, cItpmConnFastStart=cItpmConnFastStart, cItpmLink=cItpmLink, ciscoItpmConnGroupRev1=ciscoItpmConnGroupRev1, cItpmLinkNumber=cItpmLinkNumber, ciscoItpmMIBObjects=ciscoItpmMIBObjects, cItpmConnMonitorState=cItpmConnMonitorState, ciscoItpmMIBConform=ciscoItpmMIBConform, cItpmLinkSlotNumber=cItpmLinkSlotNumber, cItpmConnTableEntry=cItpmConnTableEntry, cItpmConnKeepAlive=cItpmConnKeepAlive, cItpmConnRcvWindowSize=cItpmConnRcvWindowSize, cItpmConn=cItpmConn, cItpmConnMaxQDepth=cItpmConnMaxQDepth, cItpmLinkTableEntry=cItpmLinkTableEntry, cItpmLinkRcvdBitsRate=cItpmLinkRcvdBitsRate, ciscoItpmMIBGroups=ciscoItpmMIBGroups, PYSNMP_MODULE_ID=ciscoItpmMIB, ciscoItpmNotificationsGroup=ciscoItpmNotificationsGroup, cItpmLinkSentBitsRate=cItpmLinkSentBitsRate, cItpmLinkTable=cItpmLinkTable, cItpmLinkSentMsuRate=cItpmLinkSentMsuRate, ciscoItpMonitorCongestion=ciscoItpMonitorCongestion, ciscoItpmMIBComplianceRev1=ciscoItpmMIBComplianceRev1, cItpmLinkSentMsuDrops=cItpmLinkSentMsuDrops, cItpmLinkSentMsus=cItpmLinkSentMsus, cItpmConnCongAbate=cItpmConnCongAbate)
