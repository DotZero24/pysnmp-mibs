...
h3cMplsOamScalarGroup=_H3cMplsOamScalarGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,79,1))
...
h3cMplsOamCapability=_H3cMplsOamCapability_Object((1,3,6,1,4,1,43,45,1,10,2,79,1,1),_H3cMplsOamCapability_Type())
...
h3cMplsOamTrapOpen=_H3cMplsOamTrapOpen_Object((1,3,6,1,4,1,43,45,1,10,2,79,1,2),_H3cMplsOamTrapOpen_Type())
...
h3cMplsOamTable=_H3cMplsOamTable_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,79,2))
_H3cMplsOamIgrTable_Object=MibTable
h3cMplsOamIgrTable=_H3cMplsOamIgrTable_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1))
if mibBuilder.loadTexts:h3cMplsOamIgrTable.setStatus(_A)
_H3cMplsOamIgrEntry_Object=MibTableRow
h3cMplsOamIgrEntry=_H3cMplsOamIgrEntry_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1))
...
h3cMplsOamIgrIndex=_H3cMplsOamIgrIndex_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,1),_H3cMplsOamIgrIndex_Type())
...
h3cMplsOamIgrLspName=_H3cMplsOamIgrLspName_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,2),_H3cMplsOamIgrLspName_Type())
...
h3cMplsOamIgrDetectType=_H3cMplsOamIgrDetectType_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,3),_H3cMplsOamIgrDetectType_Type())
...
h3cMplsOamIgrDetectFreq=_H3cMplsOamIgrDetectFreq_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,4),_H3cMplsOamIgrDetectFreq_Type())
...
h3cMplsOamIgrRevType=_H3cMplsOamIgrRevType_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,5),_H3cMplsOamIgrRevType_Type())
...
h3cMplsOamIgrRevLspName=_H3cMplsOamIgrRevLspName_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,6),_H3cMplsOamIgrRevLspName_Type())
...
h3cMplsOamIgrLspId=_H3cMplsOamIgrLspId_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,7),_H3cMplsOamIgrLspId_Type())
...
h3cMplsOamIgrEnable=_H3cMplsOamIgrEnable_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,8),_H3cMplsOamIgrEnable_Type())
...
h3cMplsOamIgrDefectType=_H3cMplsOamIgrDefectType_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,9),_H3cMplsOamIgrDefectType_Type())
...
h3cMplsOamIgrRowStatus=_H3cMplsOamIgrRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,1,1,10),_H3cMplsOamIgrRowStatus_Type())
...
h3cMplsOamEgrTable=_H3cMplsOamEgrTable_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2))
if mibBuilder.loadTexts:h3cMplsOamEgrTable.setStatus(_A)
_H3cMplsOamEgrEntry_Object=MibTableRow
h3cMplsOamEgrEntry=_H3cMplsOamEgrEntry_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1))
...
h3cMplsOamEgrIndex=_H3cMplsOamEgrIndex_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,1),_H3cMplsOamEgrIndex_Type())
...
h3cMplsOamEgrLspName=_H3cMplsOamEgrLspName_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,2),_H3cMplsOamEgrLspName_Type())
...
h3cMplsOamEgrDetectType=_H3cMplsOamEgrDetectType_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,3),_H3cMplsOamEgrDetectType_Type())
...
h3cMplsOamEgrDetectFreq=_H3cMplsOamEgrDetectFreq_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,4),_H3cMplsOamEgrDetectFreq_Type())
...
h3cMplsOamEgrRevType=_H3cMplsOamEgrRevType_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,5),_H3cMplsOamEgrRevType_Type())
...
h3cMplsOamEgrRevLspName=_H3cMplsOamEgrRevLspName_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,6),_H3cMplsOamEgrRevLspName_Type())
...
h3cMplsOamEgrLsrId=_H3cMplsOamEgrLsrId_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,7),_H3cMplsOamEgrLsrId_Type())
...
h3cMplsOamEgrLspId=_H3cMplsOamEgrLspId_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,8),_H3cMplsOamEgrLspId_Type())
...
h3cMplsOamEgrEnable=_H3cMplsOamEgrEnable_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,9),_H3cMplsOamEgrEnable_Type())
...
h3cMplsOamEgrDefectType=_H3cMplsOamEgrDefectType_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,10),_H3cMplsOamEgrDefectType_Type())
...
h3cMplsOamEgrRowStatus=_H3cMplsOamEgrRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,79,2,2,1,11),_H3cMplsOamEgrRowStatus_Type())
...
h3cMplsOamNotifications=_H3cMplsOamNotifications_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,79,3))
h3cMplsOamIgrLSPOutDefect=NotificationType((1,3,6,1,4,1,43,45,1,10,2,79,3,1))
h3cMplsOamIgrLSPOutDefect.setObjects(*((_C,_F),(_C,_G)))
if mibBuilder.loadTexts:h3cMplsOamIgrLSPOutDefect.setStatus(_A)
h3cMplsOamIgrLSPInDefect=NotificationType((1,3,6,1,4,1,43,45,1,10,2,79,3,2))
h3cMplsOamIgrLSPInDefect.setObjects(*((_C,_F),(_C,_G)))
if mibBuilder.loadTexts:h3cMplsOamIgrLSPInDefect.setStatus(_A)
h3cMplsOamEgrLSPOutDefect=NotificationType((1,3,6,1,4,1,43,45,1,10,2,79,3,3))
h3cMplsOamEgrLSPOutDefect.setObjects(*((_C,_H),(_C,_I)))
if mibBuilder.loadTexts:h3cMplsOamEgrLSPOutDefect.setStatus(_A)
h3cMplsOamEgrLSPInDefect=NotificationType((1,3,6,1,4,1,43,45,1,10,2,79,3,4))
