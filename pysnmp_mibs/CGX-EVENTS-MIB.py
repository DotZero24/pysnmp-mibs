...
# Notes
# -----
# ASN.1 source file://mibs/cloudgenix/CGX-EVENTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:06:31 2025
...
cgxPrivateWanUncreachableClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 50114, 10, 1, 0, 201)
)
cgxPrivateWanUncreachableClear.setObjects(
      *(("CGX-EVENTS-MIB", "cgxElementId"),
        ("CGX-EVENTS-MIB", "cgxElementName"),
        ("CGX-EVENTS-MIB", "cgxSiteId"),
        ("CGX-EVENTS-MIB", "cgxSiteName"),
...
if mibBuilder.loadTexts:
    cgxPrivateWanUncreachableClear.setStatus(
        "current"
    )

cgxPrivateWanUncreachable = NotificationType(
    (1, 3, 6, 1, 4, 1, 50114, 10, 1, 0, 202)
)
cgxPrivateWanUncreachable.setObjects(
      *(("CGX-EVENTS-MIB", "cgxElementId"),
        ("CGX-EVENTS-MIB", "cgxElementName"),
        ("CGX-EVENTS-MIB", "cgxSiteId"),
        ("CGX-EVENTS-MIB", "cgxSiteName"),
...
if mibBuilder.loadTexts:
    cgxPrivateWanUncreachable.setStatus(
        "current"
    )
...
cgxWanNotificationGroup.setObjects(
      *(("CGX-EVENTS-MIB", "cgxPrivateWanDegraded"),
        ...
        ("CGX-EVENTS-MIB", "cgxPrivateWanUncreachable"),
        ("CGX-EVENTS-MIB", "cgxPrivateWanUncreachableClear"),
...
mibBuilder.exportSymbols(
    ...
    **{"cgxEventsMIB": cgxEventsMIB,
       ...
       "cgxPrivateWanUncreachableClear": cgxPrivateWanUncreachableClear,
       "cgxPrivateWanUncreachable": cgxPrivateWanUncreachable,
