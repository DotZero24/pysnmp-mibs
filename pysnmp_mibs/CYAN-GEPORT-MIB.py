...
CyanOpStateTc, CyanTxControlTc, CyanOpStateQualTc, CyanLoopbackControlTc, CyanEnDisabledTc, CyanAdminStateTc, CyanOffOnTc, CyanSecServiceStateTc = mibBuilder.importSymbols("CYAN-TC-MIB", "CyanOpStateTc", "CyanTxControlTc", "CyanOpStateQualTc", "CyanLoopbackControlTc", "CyanEnDisabledTc", "CyanAdminStateTc", "CyanOffOnTc", "CyanSecServiceStateTc")
...
mibBuilder.exportSymbols("CYAN-GEPORT-MIB", cyanGEPortTransmitControl=cyanGEPortTransmitControl, cyanGEPortOperState=cyanGEPortOperState, cyanGEPortOperStateQual=cyanGEPortOperStateQual, cyanGEPortAutoinserviceSoakTimeSec=cyanGEPortAutoinserviceSoakTimeSec, cyanGEPortCompliance=cyanGEPortCompliance, cyanGEPortEntry=cyanGEPortEntry, PYSNMP_MODULE_ID=cyanGEPortModule, cyanGEPortLoopbackControl=cyanGEPortLoopbackControl, cyanGEPortModule=cyanGEPortModule, cyanGEPortAdminState=cyanGEPortAdminState, cyanGEPortDescription=cyanGEPortDescription, cyanGEPortShelfId=cyanGEPortShelfId, cyanGEPortExternalFiberMultishelfLink=cyanGEPortExternalFiberMultishelfLink, cyanGEPortXcvrId=cyanGEPortXcvrId, cyanGEPortExternalFiberRemotePort=cyanGEPortExternalFiberRemotePort, cyanGEPortRxPwr=cyanGEPortRxPwr, cyanGEPortObjectGroup=cyanGEPortObjectGroup, cyanGEPortPortId=cyanGEPortPortId, cyanGEPortSecServState=cyanGEPortSecServState, cyanGEPortModuleId=cyanGEPortModuleId, cyanGEPortTxStatus=cyanGEPortTxStatus, cyanGEPortMibObjects=cyanGEPortMibObjects, cyanGEPortTxPwr=cyanGEPortTxPwr, cyanGEPortTable=cyanGEPortTable)
