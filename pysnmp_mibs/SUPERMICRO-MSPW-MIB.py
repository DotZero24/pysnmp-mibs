# SNMP MIB module (SUPERMICRO-MSPW-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-MSPW-MIB
...
fsMsPwMaxEntries = _FsMsPwMaxEntries_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 57, 1, 1),
...
fsMsPwIndex1 = _FsMsPwIndex1_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 57, 1, 2, 1, 1),
    _FsMsPwIndex1_Type()
)
...
fsMsPwIndex2 = _FsMsPwIndex2_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 57, 1, 2, 1, 2),
    _FsMsPwIndex2_Type()
)
...
fsMsPwRowStatus = _FsMsPwRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 57, 1, 2, 1, 4),
