...
mibBuilder.exportSymbols("Juniper-System-MIB", juniSystemTempProtectionHoldOffTimeRemaining=juniSystemTempProtectionHoldOffTimeRemaining, juniSystemUtilizationThresholdFalling=juniSystemUtilizationThresholdFalling, juniSystemCpuUtilizationEntry=juniSystemCpuUtilizationEntry, juniSystemCpuUtilizationAverageTimePerInvokation=juniSystemCpuUtilizationAverageTimePerInvokation, juniSystemModuleMemUtilPct=juniSystemModuleMemUtilPct, juniSystemNotificationGroup=juniSystemNotificationGroup, juniSystemGroups=juniSystemGroups, juniSystemHighMemUtil=juniSystemHighMemUtil, juniSystemTempTable=juniSystemTempTable, juniSystemMemUtilTrapEnable=juniSystemMemUtilTrapEnable, juniSystemModulePortCount=juniSystemModulePortCount, juniSystemTiming=juniSystemTiming, PYSNMP_MODULE_ID=juniSystemMIB, juniSystemIssuCriteriaIndex=juniSystemIssuCriteriaIndex, juniSystemSwVersion=juniSystemSwVersion, juniSystemBootConfigControl=juniSystemBootConfigControl, juniSystemModuleBootReleaseFile=juniSystemModuleBootReleaseFile, juniSystemAbatedMemUtilThreshold=juniSystemAbatedMemUtilThreshold, juniSystemMIB=juniSystemMIB, juniSystemNvsCount=juniSystemNvsCount, juniSystemSubsystemGroup=juniSystemSubsystemGroup, juniSystemCompliance8=juniSystemCompliance8, juniSystemBootAutoRevertCountTolerance=juniSystemBootAutoRevertCountTolerance, juniSystemPowerTable=juniSystemPowerTable, juniSystemPowerGroup=juniSystemPowerGroup, juniSystemPort=juniSystemPort, juniSystemModuleGroup=juniSystemModuleGroup, juniSystemUtilizationEntry=juniSystemUtilizationEntry, juniSystemPortTable=juniSystemPortTable, juniSystemUtilizationTrapEnable=juniSystemUtilizationTrapEnable, juniSystemUtilizationThresholdRising=juniSystemUtilizationThresholdRising, juniSystemFanCount=juniSystemFanCount, juniSystemCpuUtilizationFiveMinuteUtilization=juniSystemCpuUtilizationFiveMinuteUtilization, juniSystemModuleSlotSpan=juniSystemModuleSlotSpan, juniSystemGeneralGroup=juniSystemGeneralGroup, juniSystemUtilizationLocationType=juniSystemUtilizationLocationType, juniSystemModuleRedundancyGroupId=juniSystemModuleRedundancyGroupId, juniSystemIssuState=juniSystemIssuState, juniSystemIssuRunningReleaseFile=juniSystemIssuRunningReleaseFile, juniSystemAbatedMemUtil=juniSystemAbatedMemUtil, juniSystemModuleTable=juniSystemModuleTable, juniSystemMaxSlotNumber=juniSystemMaxSlotNumber, juniSystemIssuCriteriaEntry=juniSystemIssuCriteriaEntry, juniSystemTrap=juniSystemTrap, juniSystemSwBuildDate=juniSystemSwBuildDate, juniSystemCompliance6=juniSystemCompliance6, juniSystemSlotTable=juniSystemSlotTable, juniSystemModulePhysicalIndex=juniSystemModulePhysicalIndex, juniSystemModuleRedundancyEntry=juniSystemModuleRedundancyEntry, juniSystemModuleAssemblyRev=juniSystemModuleAssemblyRev, JuniSystemTimingSelector=JuniSystemTimingSelector, juniSystemSlotStatus=juniSystemSlotStatus, juniSystemBootBackupConfigControl=juniSystemBootBackupConfigControl, juniSystemCpuUtilizationFiveSecondUtilization=juniSystemCpuUtilizationFiveSecondUtilization, juniSystemTimingGroup=juniSystemTimingGroup, juniSystemTempStatusChange=juniSystemTempStatusChange, juniSystemFabricGroup=juniSystemFabricGroup, juniSystemFabricRev=juniSystemFabricRev, juniSystemSubsystem=juniSystemSubsystem, juniSystemUserName=juniSystemUserName, juniSystemIssuArmedReleaseFile=juniSystemIssuArmedReleaseFile, juniSystemUtilizationThreshold=juniSystemUtilizationThreshold, juniSystemPortIfIndex=juniSystemPortIfIndex, juniSystemSlotLevel=juniSystemSlotLevel, juniSystemBootBackupReleaseFile=juniSystemBootBackupReleaseFile, juniSystemTempStatus=juniSystemTempStatus, juniSystemTimingSourceType=juniSystemTimingSourceType, juniSystemFanTable=juniSystemFanTable, juniSystemPortSfpTxMinPowerThreshold=juniSystemPortSfpTxMinPowerThreshold, juniSystemSubsystemTable=juniSystemSubsystemTable, juniSystemModuleRedundancySupport=juniSystemModuleRedundancySupport, juniSystemFabricSpeed=juniSystemFabricSpeed, juniSystemBootAutoRevertControl=juniSystemBootAutoRevertControl, juniSystemFpgaCorruptionDetected=juniSystemFpgaCorruptionDetected, juniSystemCompliance=juniSystemCompliance, juniSystemTimingAutoUpgrade=juniSystemTimingAutoUpgrade, juniSystemNvsEntry=juniSystemNvsEntry, juniSystemUtilizationLocation=juniSystemUtilizationLocation, juniSystemUtilizationMaxCapacity=juniSystemUtilizationMaxCapacity, juniSystemIssuCriteriaTable=juniSystemIssuCriteriaTable, juniSystemInterfaceName=juniSystemInterfaceName, juniSystemModuleGroup2=juniSystemModuleGroup2, juniSystemSlotType=juniSystemSlotType, juniSystemCpuUtilizationNumberOfInstances=juniSystemCpuUtilizationNumberOfInstances, juniSystemIssuStatus=juniSystemIssuStatus, juniSystemUtilizationResourceSubType=juniSystemUtilizationResourceSubType, juniSystemGeneral=juniSystemGeneral, juniSystemNvsStatus=juniSystemNvsStatus, juniSystemModuleExpectedType=juniSystemModuleExpectedType, juniSystemCompliances=juniSystemCompliances, juniSystemObjects=juniSystemObjects, juniSystemSlotNumber=juniSystemSlotNumber, JuniSystemLocationType=JuniSystemLocationType, juniSystemModuleRedundancyTable=juniSystemModuleRedundancyTable, juniSystemTimingSelectorEntry=juniSystemTimingSelectorEntry, juniSystemBootReleaseFile=juniSystemBootReleaseFile, juniSystemBootForceBackupControl=juniSystemBootForceBackupControl, juniSystemConformance=juniSystemConformance, juniSystemTempEntry=juniSystemTempEntry, juniSystemUtilizationGroup=juniSystemUtilizationGroup, juniSystemMemUtilPct=juniSystemMemUtilPct, juniSystemModuleSoftwareVersion=juniSystemModuleSoftwareVersion, juniSystemModuleRedundancyAssociatedSlot=juniSystemModuleRedundancyAssociatedSlot, juniSystemSubsystemBootReleaseFile=juniSystemSubsystemBootReleaseFile, juniSystemUtilizationTable=juniSystemUtilizationTable, juniSystemModuleOperStatusChange=juniSystemModuleOperStatusChange, juniSystemPortGroup=juniSystemPortGroup, juniSystemModuleRedundancyRevertControl=juniSystemModuleRedundancyRevertControl, juniSystemDefectiveSlotInformation=juniSystemDefectiveSlotInformation, juniSystemTempPhysicalIndex=juniSystemTempPhysicalIndex, juniSystemUtilizationResourceType=juniSystemUtilizationResourceType, juniSystemAdminTimingSource=juniSystemAdminTimingSource, juniSystemPortSfpTxMaxPowerThreshold=juniSystemPortSfpTxMaxPowerThreshold, juniSystemOperTimingSource=juniSystemOperTimingSource, juniSystemTimingSelectorTable=juniSystemTimingSelectorTable, juniSystemUtilizationGroup2=juniSystemUtilizationGroup2, juniSystemPortNumber=juniSystemPortNumber, juniSystemNvsPhysicalIndex=juniSystemNvsPhysicalIndex, JuniSystemLocation=JuniSystemLocation, juniSystemFabric=juniSystemFabric, juniSystemModuleRedundancyRevertTime=juniSystemModuleRedundancyRevertTime, juniSystemNvsCapacity=juniSystemNvsCapacity, juniSystemCpuUtilizationTaskName=juniSystemCpuUtilizationTaskName, juniSystemTempProtectionStatus=juniSystemTempProtectionStatus, juniSystemPowerCount=juniSystemPowerCount, JuniSystemModuleType=JuniSystemModuleType, juniSystemNvsUtilPct=juniSystemNvsUtilPct, juniSystemTempValue=juniSystemTempValue, juniSystemIssu=juniSystemIssu, juniSystemFanEntry=juniSystemFanEntry, juniSystemCpuUtilizationInvokationPerSec=juniSystemCpuUtilizationInvokationPerSec, juniSystemModuleRedundancySpare=juniSystemModuleRedundancySpare, juniSystemNvsGroup=juniSystemNvsGroup, juniSystemPortSfpPowerThresholdIfIndex=juniSystemPortSfpPowerThresholdIfIndex, juniSystemIssuStateChange=juniSystemIssuStateChange, juniSystemModuleControl=juniSystemModuleControl, juniSystemIssuCriteriaDescription=juniSystemIssuCriteriaDescription, juniSystemFanStatus=juniSystemFanStatus, juniSystemModuleCpuFiveSecUtilPct=juniSystemModuleCpuFiveSecUtilPct, juniSystemCpuUtilizationTimeMark=juniSystemCpuUtilizationTimeMark, juniSystemReloadSlotNumber=juniSystemReloadSlotNumber, juniSystemNotificationGroup3=juniSystemNotificationGroup3, juniSystemCompliance3=juniSystemCompliance3, juniSystemPortSfpPowerThresholdValue=juniSystemPortSfpPowerThresholdValue, juniSystemTemperatureGroup=juniSystemTemperatureGroup, juniSystemNotificationGroup4=juniSystemNotificationGroup4, juniSystemCpuUtilizationInvoked=juniSystemCpuUtilizationInvoked, juniSystemPortSfpRxMinPowerThreshold=juniSystemPortSfpRxMinPowerThreshold, juniSystemModuleAssemblyPartNumber=juniSystemModuleAssemblyPartNumber, juniSystemUtilizationThresholdDirection=juniSystemUtilizationThresholdDirection, juniSystemFanIndex=juniSystemFanIndex, juniSystemCompliance7=juniSystemCompliance7, juniSystemMemKBytesCapacity=juniSystemMemKBytesCapacity, juniSystemSubsystemBootBackupReleaseFile=juniSystemSubsystemBootBackupReleaseFile, juniSystemCpuUtilizationTable=juniSystemCpuUtilizationTable, juniSystemCpuUtilizationOneMinuteUtilization=juniSystemCpuUtilizationOneMinuteUtilization, juniSystemFanPhysicalIndex=juniSystemFanPhysicalIndex, juniSystemTempCount=juniSystemTempCount, juniSystemTempProtectionHoldOffTime=juniSystemTempProtectionHoldOffTime, juniSystemModuleCpuOneMinAvgPct=juniSystemModuleCpuOneMinAvgPct, juniSystemHighMemUtilThreshold=juniSystemHighMemUtilThreshold, juniSystemCpuUtilizationTotalRunningTime=juniSystemCpuUtilizationTotalRunningTime, juniSystemNotificationObjectsGroup=juniSystemNotificationObjectsGroup, juniSystemPortPhysicalIndex=juniSystemPortPhysicalIndex, juniSystemIssuGroup=juniSystemIssuGroup, juniSystemUtilizationHoldDownTime=juniSystemUtilizationHoldDownTime, juniSystemModuleDisableReason=juniSystemModuleDisableReason, juniSystemNvsTable=juniSystemNvsTable, juniSystemTimingSourceLine=juniSystemTimingSourceLine, juniSystemTempIndex=juniSystemTempIndex, juniSystemModuleOperStatus=juniSystemModuleOperStatus, juniSystemModuleSoftwareEntry=juniSystemModuleSoftwareEntry, juniSystemSlotEntry=juniSystemSlotEntry, juniSystemPowerStatusChange=juniSystemPowerStatusChange, juniSystemModuleRedundancyLockout=juniSystemModuleRedundancyLockout, juniSystemModuleDescr=juniSystemModuleDescr, JuniSystemTaskName=JuniSystemTaskName, juniSystemRedundancyRevertTimeOfDay=juniSystemRedundancyRevertTimeOfDay, juniSystemTimingSelectorIndex=juniSystemTimingSelectorIndex, juniSystemModuleAdminStatus=juniSystemModuleAdminStatus, juniSystemTimingSourceIfIndex=juniSystemTimingSourceIfIndex, juniSystemIssuCriteriaStatus=juniSystemIssuCriteriaStatus, juniSystemCompliance5=juniSystemCompliance5, juniSystemGeneralGroup2=juniSystemGeneralGroup2, juniSystemModule=juniSystemModule, juniSystemUtilization=juniSystemUtilization, juniSystemTimingWorkingStatus=juniSystemTimingWorkingStatus, juniSystemBootAutoRevertTimeTolerance=juniSystemBootAutoRevertTimeTolerance, juniSystemPowerEntry=juniSystemPowerEntry, juniSystemNvs=juniSystemNvs, juniSystemMaxModulesPerSlot=juniSystemMaxModulesPerSlot, juniSystemSubsystemIndex=juniSystemSubsystemIndex, juniSystemNotificationGroup2=juniSystemNotificationGroup2, juniSystemTemperature=juniSystemTemperature, juniSystemModuleCurrentType=juniSystemModuleCurrentType, juniSystemTimingProtectedStatus=juniSystemTimingProtectedStatus, juniSystemModuleCpuUtilPct=juniSystemModuleCpuUtilPct, juniSystemUtilizationCurrentValue=juniSystemUtilizationCurrentValue, juniSystemBootConfigFile=juniSystemBootConfigFile, juniSystemModuleLevelSpan=juniSystemModuleLevelSpan, JuniSystemSlotLevel=JuniSystemSlotLevel, juniSystemCpuUtilizationPercentageRunningTime=juniSystemCpuUtilizationPercentageRunningTime, juniSystemModuleSerialNumber=juniSystemModuleSerialNumber, juniSystemModuleCpuFiveMinAvgPct=juniSystemModuleCpuFiveMinAvgPct, juniSystemSubsystemName=juniSystemSubsystemName, juniSystemRedundancyRevertControl=juniSystemRedundancyRevertControl, juniSystemPortSfpRxMaxPowerThreshold=juniSystemPortSfpRxMaxPowerThreshold, juniSystemModuleSoftwareSupport=juniSystemModuleSoftwareSupport, juniSystemPowerIndex=juniSystemPowerIndex, juniSystemCompliance2=juniSystemCompliance2, juniSystemCompliance4=juniSystemCompliance4, juniSystemModuleGroup3=juniSystemModuleGroup3, juniSystemModuleEntry=juniSystemModuleEntry, JuniSystemSlotType=JuniSystemSlotType, juniSystemModuleBootBackupReleaseFile=juniSystemModuleBootBackupReleaseFile, juniSystemReloadCommand=juniSystemReloadCommand, juniSystemPowerStatus=juniSystemPowerStatus, juniSystemModuleLastChange=juniSystemModuleLastChange, juniSystemModuleSoftwareTable=juniSystemModuleSoftwareTable, juniSystemTempProtectionStatusChange=juniSystemTempProtectionStatusChange, juniSystemPower=juniSystemPower, juniSystemBootBackupConfigFile=juniSystemBootBackupConfigFile, juniSystemMemCapacity=juniSystemMemCapacity, juniSystemPortEntry=juniSystemPortEntry, juniSystemPowerPhysicalIndex=juniSystemPowerPhysicalIndex, juniSystemFanStatusChange=juniSystemFanStatusChange, juniSystemNvsIndex=juniSystemNvsIndex, juniSystemSubsystemEntry=juniSystemSubsystemEntry)
