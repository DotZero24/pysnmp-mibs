...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/junose/Juniper-System-MIB
...
PhysicalIndex, entPhysicalDescr = mibBuilder.importSymbols("ENTITY-MIB", "PhysicalIndex", "entPhysicalDescr")
...
juniSystemMIB.setRevisions(('2012-03-13 05:12', '2010-10-25 05:12', '2010-03-12 13:45', '2008-06-11 11:01', '2008-05-05 12:41', '2007-05-07 10:12', '2006-12-18 21:25', '2006-11-24 09:13', '2006-05-18 08:31', '2006-01-06 18:17', '2005-12-16 07:21', '2005-11-18 22:30', '2005-09-15 14:14', '2005-08-19 17:48', '2005-07-29 17:48', '2005-05-18 18:10', '2005-05-04 18:10', '2005-01-31 18:13', '2004-12-31 10:13', '2004-12-29 10:10', '2004-05-25 18:13', '2004-01-07 22:46', '2003-11-24 20:59', '2003-11-24 19:39', '2003-07-22 14:10', '2003-01-27 21:22', '2002-10-17 21:01',))
if mibBuilder.loadTexts: juniSystemMIB.setLastUpdated('201203130512Z')
...
juniSystemTempStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 4874, 2, 2, 2, 1, 9, 4, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(("unknown", 0), ("failed", 1), ("tooLow", 2), ("nominal", 3), ("increasedFanSpeed", 4), ("tooHigh", 5), ("tooLowWarning", 6), ("tooHighWarning", 7)))).setMaxAccess("readonly")
...
juniSystemInterfaceName = MibScalar((1, 3, 6, 1, 4, 1, 4874, 2, 2, 2, 1, 1, 26), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: juniSystemInterfaceName.setStatus('current')
juniSystemUserName = MibScalar((1, 3, 6, 1, 4, 1, 4874, 2, 2, 2, 1, 1, 27), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: juniSystemUserName.setStatus('current')
juniSystemDefectiveSlotInformation = MibScalar((1, 3, 6, 1, 4, 1, 4874, 2, 2, 2, 1, 1, 28), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: juniSystemDefectiveSlotInformation.setStatus('current')
...
juniSystemFpgaCorruptionDetected = NotificationType((1, 3, 6, 1, 4, 1, 4874, 2, 2, 2, 0, 15)).setObjects(("Juniper-System-MIB", "juniSystemInterfaceName"), ("Juniper-System-MIB", "juniSystemUserName"), ("Juniper-System-MIB", "juniSystemDefectiveSlotInformation"))
if mibBuilder.loadTexts: juniSystemFpgaCorruptionDetected.setStatus('current')
...
mibBuilder.exportSymbols("Juniper-System-MIB", juniSystemMaxSlotNumber=juniSystemMaxSlotNumber, juniSystemGeneral=juniSystemGeneral, juniSystemOperTimingSource=juniSystemOperTimingSource, juniSystemPowerIndex=juniSystemPowerIndex, juniSystemNotificationObjectsGroup=juniSystemNotificationObjectsGroup, juniSystemModuleOperStatusChange=juniSystemModuleOperStatusChange, juniSystemCpuUtilizationAverageTimePerInvokation=juniSystemCpuUtilizationAverageTimePerInvokation, juniSystemRedundancyRevertControl=juniSystemRedundancyRevertControl, juniSystemUtilizationLocationType=juniSystemUtilizationLocationType, juniSystemFanStatusChange=juniSystemFanStatusChange, juniSystemModuleOperStatus=juniSystemModuleOperStatus, juniSystemModule=juniSystemModule, juniSystemNotificationGroup3=juniSystemNotificationGroup3, juniSystemPort=juniSystemPort, juniSystemModuleRedundancyLockout=juniSystemModuleRedundancyLockout, juniSystemModuleSoftwareSupport=juniSystemModuleSoftwareSupport, juniSystemInterfaceName=juniSystemInterfaceName, juniSystemNvsCapacity=juniSystemNvsCapacity, juniSystemFanPhysicalIndex=juniSystemFanPhysicalIndex, juniSystemDefectiveSlotInformation=juniSystemDefectiveSlotInformation, juniSystemModuleDisableReason=juniSystemModuleDisableReason, juniSystemCpuUtilizationFiveSecondUtilization=juniSystemCpuUtilizationFiveSecondUtilization, juniSystemTempCount=juniSystemTempCount, juniSystemIssuStateChange=juniSystemIssuStateChange, juniSystemPowerGroup=juniSystemPowerGroup, juniSystemBootBackupReleaseFile=juniSystemBootBackupReleaseFile, juniSystemCpuUtilizationNumberOfInstances=juniSystemCpuUtilizationNumberOfInstances, juniSystemModuleDescr=juniSystemModuleDescr, juniSystemFanIndex=juniSystemFanIndex, juniSystemModuleLastChange=juniSystemModuleLastChange, juniSystemTimingGroup=juniSystemTimingGroup, juniSystemUtilizationResourceType=juniSystemUtilizationResourceType, juniSystemPowerEntry=juniSystemPowerEntry, juniSystemMemUtilTrapEnable=juniSystemMemUtilTrapEnable, juniSystemUtilizationCurrentValue=juniSystemUtilizationCurrentValue, juniSystemModuleBootReleaseFile=juniSystemModuleBootReleaseFile, juniSystemFanTable=juniSystemFanTable, juniSystemPortIfIndex=juniSystemPortIfIndex, juniSystemModuleRedundancyRevertControl=juniSystemModuleRedundancyRevertControl, juniSystemBootAutoRevertCountTolerance=juniSystemBootAutoRevertCountTolerance, juniSystemTimingAutoUpgrade=juniSystemTimingAutoUpgrade, juniSystemUtilization=juniSystemUtilization, juniSystemTimingSelectorIndex=juniSystemTimingSelectorIndex, juniSystemNvsStatus=juniSystemNvsStatus, juniSystemCompliances=juniSystemCompliances, juniSystemAbatedMemUtilThreshold=juniSystemAbatedMemUtilThreshold, juniSystemPortSfpRxMinPowerThreshold=juniSystemPortSfpRxMinPowerThreshold, juniSystemModuleCurrentType=juniSystemModuleCurrentType, juniSystemFabricGroup=juniSystemFabricGroup, juniSystemPower=juniSystemPower, juniSystemBootReleaseFile=juniSystemBootReleaseFile, juniSystemCpuUtilizationTimeMark=juniSystemCpuUtilizationTimeMark, juniSystemSubsystem=juniSystemSubsystem, juniSystemCpuUtilizationInvoked=juniSystemCpuUtilizationInvoked, juniSystemGeneralGroup=juniSystemGeneralGroup, juniSystemNvsGroup=juniSystemNvsGroup, juniSystemSwBuildDate=juniSystemSwBuildDate, juniSystemTemperatureGroup=juniSystemTemperatureGroup, juniSystemTimingWorkingStatus=juniSystemTimingWorkingStatus, juniSystemPortSfpPowerThresholdIfIndex=juniSystemPortSfpPowerThresholdIfIndex, juniSystemSlotEntry=juniSystemSlotEntry, juniSystemHighMemUtilThreshold=juniSystemHighMemUtilThreshold, JuniSystemTaskName=JuniSystemTaskName, juniSystemModuleRedundancyRevertTime=juniSystemModuleRedundancyRevertTime, juniSystemTemperature=juniSystemTemperature, juniSystemSlotStatus=juniSystemSlotStatus, juniSystemFabric=juniSystemFabric, juniSystemModuleMemUtilPct=juniSystemModuleMemUtilPct, juniSystemTimingSourceType=juniSystemTimingSourceType, juniSystemUtilizationEntry=juniSystemUtilizationEntry, juniSystemModuleRedundancySupport=juniSystemModuleRedundancySupport, juniSystemBootForceBackupControl=juniSystemBootForceBackupControl, juniSystemModuleSerialNumber=juniSystemModuleSerialNumber, juniSystemSubsystemGroup=juniSystemSubsystemGroup, juniSystemUserName=juniSystemUserName, juniSystemPowerStatusChange=juniSystemPowerStatusChange, JuniSystemSlotLevel=JuniSystemSlotLevel, juniSystemHighMemUtil=juniSystemHighMemUtil, juniSystemSubsystemTable=juniSystemSubsystemTable, juniSystemModuleCpuFiveSecUtilPct=juniSystemModuleCpuFiveSecUtilPct, juniSystemTimingSelectorEntry=juniSystemTimingSelectorEntry, juniSystemCpuUtilizationFiveMinuteUtilization=juniSystemCpuUtilizationFiveMinuteUtilization, juniSystemModuleRedundancyEntry=juniSystemModuleRedundancyEntry, juniSystemModuleSlotSpan=juniSystemModuleSlotSpan, juniSystemPowerPhysicalIndex=juniSystemPowerPhysicalIndex, juniSystemNvsUtilPct=juniSystemNvsUtilPct, juniSystemTimingSelectorTable=juniSystemTimingSelectorTable, juniSystemTempProtectionHoldOffTime=juniSystemTempProtectionHoldOffTime, juniSystemModuleExpectedType=juniSystemModuleExpectedType, juniSystemFpgaCorruptionDetected=juniSystemFpgaCorruptionDetected, juniSystemUtilizationTable=juniSystemUtilizationTable, juniSystemRedundancyRevertTimeOfDay=juniSystemRedundancyRevertTimeOfDay, juniSystemModuleGroup=juniSystemModuleGroup, juniSystemTempPhysicalIndex=juniSystemTempPhysicalIndex, juniSystemCpuUtilizationPercentageRunningTime=juniSystemCpuUtilizationPercentageRunningTime, juniSystemTempStatusChange=juniSystemTempStatusChange, juniSystemBootBackupConfigControl=juniSystemBootBackupConfigControl, juniSystemIssu=juniSystemIssu, juniSystemIssuCriteriaStatus=juniSystemIssuCriteriaStatus, juniSystemAbatedMemUtil=juniSystemAbatedMemUtil, juniSystemMaxModulesPerSlot=juniSystemMaxModulesPerSlot, JuniSystemTimingSelector=JuniSystemTimingSelector, JuniSystemModuleType=JuniSystemModuleType, juniSystemTempTable=juniSystemTempTable, juniSystemUtilizationLocation=juniSystemUtilizationLocation, juniSystemUtilizationThresholdFalling=juniSystemUtilizationThresholdFalling, juniSystemSlotTable=juniSystemSlotTable, juniSystemUtilizationThresholdDirection=juniSystemUtilizationThresholdDirection, juniSystemFabricRev=juniSystemFabricRev, juniSystemTimingSourceIfIndex=juniSystemTimingSourceIfIndex, juniSystemCompliance7=juniSystemCompliance7, juniSystemGroups=juniSystemGroups, juniSystemUtilizationResourceSubType=juniSystemUtilizationResourceSubType, juniSystemCompliance3=juniSystemCompliance3, juniSystemModuleRedundancyTable=juniSystemModuleRedundancyTable, juniSystemReloadCommand=juniSystemReloadCommand, juniSystemBootConfigFile=juniSystemBootConfigFile, juniSystemFanStatus=juniSystemFanStatus, juniSystemModuleSoftwareVersion=juniSystemModuleSoftwareVersion, juniSystemNvsCount=juniSystemNvsCount, juniSystemModuleCpuOneMinAvgPct=juniSystemModuleCpuOneMinAvgPct, juniSystemCpuUtilizationTable=juniSystemCpuUtilizationTable, juniSystemPortSfpPowerThresholdValue=juniSystemPortSfpPowerThresholdValue, juniSystemFabricSpeed=juniSystemFabricSpeed, juniSystemTrap=juniSystemTrap, juniSystemUtilizationTrapEnable=juniSystemUtilizationTrapEnable, juniSystemTempProtectionStatusChange=juniSystemTempProtectionStatusChange, juniSystemSwVersion=juniSystemSwVersion, juniSystemPortPhysicalIndex=juniSystemPortPhysicalIndex, juniSystemTimingSourceLine=juniSystemTimingSourceLine, juniSystemSlotLevel=juniSystemSlotLevel, juniSystemCompliance=juniSystemCompliance, juniSystemCompliance2=juniSystemCompliance2, JuniSystemLocation=JuniSystemLocation, juniSystemModuleAssemblyRev=juniSystemModuleAssemblyRev, juniSystemModuleSoftwareEntry=juniSystemModuleSoftwareEntry, juniSystemModuleControl=juniSystemModuleControl, juniSystemTimingProtectedStatus=juniSystemTimingProtectedStatus, juniSystemUtilizationGroup2=juniSystemUtilizationGroup2, juniSystemTempProtectionHoldOffTimeRemaining=juniSystemTempProtectionHoldOffTimeRemaining, juniSystemNvs=juniSystemNvs, juniSystemNvsTable=juniSystemNvsTable, juniSystemModuleCpuUtilPct=juniSystemModuleCpuUtilPct, juniSystemModulePhysicalIndex=juniSystemModulePhysicalIndex, juniSystemModuleGroup2=juniSystemModuleGroup2, juniSystemMemKBytesCapacity=juniSystemMemKBytesCapacity, juniSystemNotificationGroup=juniSystemNotificationGroup, juniSystemUtilizationMaxCapacity=juniSystemUtilizationMaxCapacity, juniSystemIssuRunningReleaseFile=juniSystemIssuRunningReleaseFile, juniSystemIssuStatus=juniSystemIssuStatus, juniSystemMIB=juniSystemMIB, juniSystemMemCapacity=juniSystemMemCapacity, juniSystemIssuCriteriaIndex=juniSystemIssuCriteriaIndex, juniSystemCpuUtilizationOneMinuteUtilization=juniSystemCpuUtilizationOneMinuteUtilization, juniSystemCpuUtilizationEntry=juniSystemCpuUtilizationEntry, juniSystemModuleRedundancyGroupId=juniSystemModuleRedundancyGroupId, juniSystemPowerStatus=juniSystemPowerStatus, juniSystemSubsystemBootBackupReleaseFile=juniSystemSubsystemBootBackupReleaseFile, juniSystemAdminTimingSource=juniSystemAdminTimingSource, juniSystemBootAutoRevertTimeTolerance=juniSystemBootAutoRevertTimeTolerance, juniSystemIssuCriteriaDescription=juniSystemIssuCriteriaDescription, juniSystemIssuState=juniSystemIssuState, juniSystemModuleLevelSpan=juniSystemModuleLevelSpan, juniSystemUtilizationGroup=juniSystemUtilizationGroup, juniSystemCpuUtilizationTotalRunningTime=juniSystemCpuUtilizationTotalRunningTime, juniSystemNotificationGroup4=juniSystemNotificationGroup4, juniSystemReloadSlotNumber=juniSystemReloadSlotNumber, juniSystemModuleAdminStatus=juniSystemModuleAdminStatus, juniSystemCompliance8=juniSystemCompliance8, juniSystemPortTable=juniSystemPortTable, juniSystemPortEntry=juniSystemPortEntry, juniSystemCpuUtilizationInvokationPerSec=juniSystemCpuUtilizationInvokationPerSec, juniSystemConformance=juniSystemConformance, juniSystemPortGroup=juniSystemPortGroup, juniSystemModuleAssemblyPartNumber=juniSystemModuleAssemblyPartNumber, juniSystemIssuArmedReleaseFile=juniSystemIssuArmedReleaseFile, juniSystemMemUtilPct=juniSystemMemUtilPct, JuniSystemSlotType=JuniSystemSlotType, juniSystemPortNumber=juniSystemPortNumber, juniSystemModulePortCount=juniSystemModulePortCount, juniSystemUtilizationThreshold=juniSystemUtilizationThreshold, juniSystemFanCount=juniSystemFanCount, juniSystemTempValue=juniSystemTempValue, juniSystemTempStatus=juniSystemTempStatus, juniSystemGeneralGroup2=juniSystemGeneralGroup2, juniSystemBootAutoRevertControl=juniSystemBootAutoRevertControl, juniSystemSubsystemIndex=juniSystemSubsystemIndex, juniSystemModuleRedundancyAssociatedSlot=juniSystemModuleRedundancyAssociatedSlot, juniSystemSubsystemBootReleaseFile=juniSystemSubsystemBootReleaseFile, juniSystemTempProtectionStatus=juniSystemTempProtectionStatus, juniSystemNotificationGroup2=juniSystemNotificationGroup2, juniSystemObjects=juniSystemObjects, juniSystemPortSfpRxMaxPowerThreshold=juniSystemPortSfpRxMaxPowerThreshold, juniSystemSlotType=juniSystemSlotType, juniSystemSlotNumber=juniSystemSlotNumber, juniSystemNvsIndex=juniSystemNvsIndex, juniSystemTempIndex=juniSystemTempIndex, juniSystemNvsEntry=juniSystemNvsEntry, juniSystemNvsPhysicalIndex=juniSystemNvsPhysicalIndex, juniSystemModuleBootBackupReleaseFile=juniSystemModuleBootBackupReleaseFile, juniSystemFanEntry=juniSystemFanEntry, juniSystemPowerTable=juniSystemPowerTable, PYSNMP_MODULE_ID=juniSystemMIB, juniSystemCompliance4=juniSystemCompliance4, juniSystemIssuCriteriaTable=juniSystemIssuCriteriaTable, juniSystemModuleSoftwareTable=juniSystemModuleSoftwareTable, juniSystemTiming=juniSystemTiming, juniSystemSubsystemName=juniSystemSubsystemName, juniSystemModuleEntry=juniSystemModuleEntry, juniSystemUtilizationThresholdRising=juniSystemUtilizationThresholdRising, JuniSystemLocationType=JuniSystemLocationType, juniSystemBootConfigControl=juniSystemBootConfigControl, juniSystemPowerCount=juniSystemPowerCount, juniSystemTempEntry=juniSystemTempEntry, juniSystemModuleRedundancySpare=juniSystemModuleRedundancySpare, juniSystemModuleTable=juniSystemModuleTable, juniSystemCompliance6=juniSystemCompliance6, juniSystemPortSfpTxMinPowerThreshold=juniSystemPortSfpTxMinPowerThreshold, juniSystemModuleGroup3=juniSystemModuleGroup3, juniSystemBootBackupConfigFile=juniSystemBootBackupConfigFile, juniSystemModuleCpuFiveMinAvgPct=juniSystemModuleCpuFiveMinAvgPct, juniSystemCompliance5=juniSystemCompliance5, juniSystemPortSfpTxMaxPowerThreshold=juniSystemPortSfpTxMaxPowerThreshold, juniSystemIssuGroup=juniSystemIssuGroup, juniSystemUtilizationHoldDownTime=juniSystemUtilizationHoldDownTime, juniSystemSubsystemEntry=juniSystemSubsystemEntry, juniSystemCpuUtilizationTaskName=juniSystemCpuUtilizationTaskName, juniSystemIssuCriteriaEntry=juniSystemIssuCriteriaEntry)
