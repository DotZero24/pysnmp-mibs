...
mibBuilder.exportSymbols("CISCO-IETF-PW-ATM-MIB", cpwAtmCellsRejected=cpwAtmCellsRejected, cpwVcAtmNotifications=cpwVcAtmNotifications, cpwAtmRowStatus=cpwAtmRowStatus, cpwAtmAvgCellsPacked=cpwAtmAvgCellsPacked, cpwAtmCellPacking=cpwAtmCellPacking, cpwVcAtmPerfEntry=cpwVcAtmPerfEntry, cpwAtmMcptTimeout=cpwAtmMcptTimeout, cpwAtmPerfGroup=cpwAtmPerfGroup, cpwAtmHCCellsRejected=cpwAtmHCCellsRejected, cpwAtmPeerMncp=cpwAtmPeerMncp, cpwAtmVpi=cpwAtmVpi, cpwVcAtmGroup=cpwVcAtmGroup, cpwAtmPktsSent=cpwAtmPktsSent, cpwAtmMncp=cpwAtmMncp, cpwAtmHCCellsReceived=cpwAtmHCCellsReceived, cpwAtmEncap=cpwAtmEncap, cpwVcAtmTable=cpwVcAtmTable, cpwAtmCellsTagged=cpwAtmCellsTagged, cpwAtmCellsSent=cpwAtmCellsSent, cpwVcAtmEntry=cpwVcAtmEntry, cpwAtmOamCellSupported=cpwAtmOamCellSupported, cpwVcAtmObjects=cpwVcAtmObjects, cpwVcAtmConformance=cpwVcAtmConformance, cpwAtmQosScalingFactor=cpwAtmQosScalingFactor, cpwVcAtmMIB=cpwVcAtmMIB, cpwAtmPktsReceived=cpwAtmPktsReceived, cpwVcAtmGroups=cpwVcAtmGroups, cpwVcAtmPerfTable=cpwVcAtmPerfTable, cpwAtmPktsRejected=cpwAtmPktsRejected, cpwAtmHCCellsTagged=cpwAtmHCCellsTagged, cpwVcAtmCompliances=cpwVcAtmCompliances, cpwVcAtmModuleCompliance=cpwVcAtmModuleCompliance, cpwAtmVci=cpwAtmVci, cpwAtmIf=cpwAtmIf, cpwAtmClpQosMapping=cpwAtmClpQosMapping, cpwAtmCellsReceived=cpwAtmCellsReceived, PYSNMP_MODULE_ID=cpwVcAtmMIB)
