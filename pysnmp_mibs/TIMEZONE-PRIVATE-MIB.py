# SNMP MIB module (TIMEZONE-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/quanta/TIMEZONE-PRIVATE-MIB
...
timeZonePrivate = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 42)
)
if mibBuilder.loadTexts:
    timeZonePrivate.setRevisions(
        ("2011-01-26 00:00",
         "2007-02-28 05:00")
    )
