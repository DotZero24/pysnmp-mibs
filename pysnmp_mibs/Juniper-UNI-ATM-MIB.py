...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:42:32 2025
...
atmfM4VpTestCode, atmfM4VpTestObject, atmfM4VpTestId, atmfM4VcTestResult, atmfM4VpTestResult, atmfM4VcTestId, atmfM4VcTestType, atmfM4VpTestType, atmfM4VcTestCode, atmfM4VcTestObject = mibBuilder.importSymbols("ATM-FORUM-SNMP-M4-MIB", "atmfM4VpTestCode", "atmfM4VpTestObject", "atmfM4VpTestId", "atmfM4VcTestResult", "atmfM4VpTestResult", "atmfM4VcTestId", "atmfM4VcTestType", "atmfM4VpTestType", "atmfM4VcTestCode", "atmfM4VcTestObject")
atmVclVci, atmVclVpi, atmVplVpi = mibBuilder.importSymbols("ATM-MIB", "atmVclVci", "atmVclVpi", "atmVplVpi")
AtmVorXAdminStatus, AtmVcIdentifier, AtmVpIdentifier, AtmAddr = mibBuilder.importSymbols("ATM-TC-MIB", "AtmVorXAdminStatus", "AtmVcIdentifier", "AtmVpIdentifier", "AtmAddr")
...
JuniNextIfIndex, JuniInterfaceLocationValue, JuniEnable, JuniInterfaceLocationType = mibBuilder.importSymbols("Juniper-TC", "JuniNextIfIndex", "JuniInterfaceLocationValue", "JuniEnable", "JuniInterfaceLocationType")
...
mibBuilder.exportSymbols("Juniper-UNI-ATM-MIB", juniAtmPvcStatsOutPacketErrors=juniAtmPvcStatsOutPacketErrors, juniAtmF4FlowInOamEndCCActDeActCells=juniAtmF4FlowInOamEndCCActDeActCells, juniAtmPingTestTypes=juniAtmPingTestTypes, juniAtmVpStatsInPacketUnknownProtocol=juniAtmVpStatsInPacketUnknownProtocol, juniAtmVpPingControlGroup=juniAtmVpPingControlGroup, juniAtmSubIfNextIfIndex=juniAtmSubIfNextIfIndex, juniAtmCircuitOamIfIndex=juniAtmCircuitOamIfIndex, juniAtmOamF4FlowSegmentIfIndex=juniAtmOamF4FlowSegmentIfIndex, juniAtmIfSvcSignallingVcd=juniAtmIfSvcSignallingVcd, juniAtmVpStatsTable=juniAtmVpStatsTable, juniAtmLocation=juniAtmLocation, juniAtmBulkCircuitsAdminState=juniAtmBulkCircuitsAdminState, juniAtmVpPingCtlTrapGeneration=juniAtmVpPingCtlTrapGeneration, juniAtmVcPingCtlTrapGeneration=juniAtmVcPingCtlTrapGeneration, juniAtmGroup=juniAtmGroup, juniAtmIfPnniRccVci=juniAtmIfPnniRccVci, juniAtmPvcStatsOutCells=juniAtmPvcStatsOutCells, juniAtmF4FlowEndToEndOutLoopbackRsps=juniAtmF4FlowEndToEndOutLoopbackRsps, juniAtmVcClassGroup=juniAtmVcClassGroup, juniAtmSubIfTable=juniAtmSubIfTable, juniAtmNbmaMapVci=juniAtmNbmaMapVci, juniAtmNbmaMapIfIndex=juniAtmNbmaMapIfIndex, juniAtmCircuitOutOamF5EndToEndLoopbackRsps=juniAtmCircuitOutOamF5EndToEndLoopbackRsps, juniAtmOamF4FlowEndToEndCfgTable=juniAtmOamF4FlowEndToEndCfgTable, juniAtmPvcStatisticsTable=juniAtmPvcStatisticsTable, juniAtmProfileOverrideAssignIfCircuitRangeId=juniAtmProfileOverrideAssignIfCircuitRangeId, juniAtmNbmaMapEntry=juniAtmNbmaMapEntry, juniAtmF4FlowEndToEndOutLoopbackCmds=juniAtmF4FlowEndToEndOutLoopbackCmds, juniAtmSubIfVccTrafficShapingTagging=juniAtmSubIfVccTrafficShapingTagging, JuniAtmNbmaMapNameOrNull=JuniAtmNbmaMapNameOrNull, juniAtmBulkCircuitsIdTable=juniAtmBulkCircuitsIdTable, juniAtmAal5IfRowStatus=juniAtmAal5IfRowStatus, juniAtmCircuitInOamF5EndToEndLoopbackCmds=juniAtmCircuitInOamF5EndToEndLoopbackCmds, juniAtmF4FlowEndInOamCellsDropped=juniAtmF4FlowEndInOamCellsDropped, juniAtmGroup3=juniAtmGroup3, juniAtmVpDescription=juniAtmVpDescription, juniAtmCompliance14=juniAtmCompliance14, juniAtmF4FlowOutSegmentCCCells=juniAtmF4FlowOutSegmentCCCells, juniAtmBulkCircuitsMaxVpi=juniAtmBulkCircuitsMaxVpi, juniAtmCircuitInOamF5RdiCells=juniAtmCircuitInOamF5RdiCells, juniAtmIfCapabilityMaxVpi=juniAtmIfCapabilityMaxVpi, juniAtmVcClassIdTable=juniAtmVcClassIdTable, juniAtmOamF4FlowSegmentCfgEntry=juniAtmOamF4FlowSegmentCfgEntry, juniAtmF4FlowOamSegmentStatsTable=juniAtmF4FlowOamSegmentStatsTable, juniAtmPingTestCodeOamDisabled=juniAtmPingTestCodeOamDisabled, juniAtmVcClassVccType=juniAtmVcClassVccType, juniAtmVpDescrTable=juniAtmVpDescrTable, juniAtmCircuitInOamF5Cells=juniAtmCircuitInOamF5Cells, juniAtmProfileOverrideAssignIfCircuitTable=juniAtmProfileOverrideAssignIfCircuitTable, juniAtmSubIfLocationIndex=juniAtmSubIfLocationIndex, juniAtmIfE164OneToOneAddrTrans=juniAtmIfE164OneToOneAddrTrans, juniAtmVpStatsInCells=juniAtmVpStatsInCells, juniAtmSubIfLocationTable=juniAtmSubIfLocationTable, juniAtmBulkCircuitsIdId=juniAtmBulkCircuitsIdId, juniAtmConformance=juniAtmConformance, juniAtmPvcStatsInCells=juniAtmPvcStatsInCells, juniAtmSubIfVccRowStatus=juniAtmSubIfVccRowStatus, juniAtmVcClassVccOamLoopbackFrequency=juniAtmVcClassVccOamLoopbackFrequency, juniAtmIfCapabilityMaxVci=juniAtmIfCapabilityMaxVci, juniAtmPvcStatsVpi=juniAtmPvcStatsVpi, juniAtmSubIfVccScr=juniAtmSubIfVccScr, juniAtmIfIlmiVcd=juniAtmIfIlmiVcd, juniAtmVpStatsCrcErrors=juniAtmVpStatsCrcErrors, juniAtmNbmaMapBroadcast=juniAtmNbmaMapBroadcast, juniAtmSubIfMartiniMaxCellsPerPacket=juniAtmSubIfMartiniMaxCellsPerPacket, juniAtmMartiniTimeoutTimerEntry=juniAtmMartiniTimeoutTimerEntry, juniAtmCompliance8=juniAtmCompliance8, juniAtmPingTestOamE2E=juniAtmPingTestOamE2E, juniAtmVcClassIdName=juniAtmVcClassIdName, juniAtmSubIfVccPcr=juniAtmSubIfVccPcr, juniAtmF4FlowOutSegmentLoopbackCells=juniAtmF4FlowOutSegmentLoopbackCells, juniAtmBulkCircuitsNameRowStatus=juniAtmBulkCircuitsNameRowStatus, juniAtmVcPingTable=juniAtmVcPingTable, juniAtmCompliance5=juniAtmCompliance5, juniAtmPvcStatsIfIndex=juniAtmPvcStatsIfIndex, juniAtmVcClassNameId=juniAtmVcClassNameId, juniAtmBulkCircuitsRowStatus=juniAtmBulkCircuitsRowStatus, juniAtmIfPnniRccAdminStatus=juniAtmIfPnniRccAdminStatus, juniAtmBulkCircuitsNameTable=juniAtmBulkCircuitsNameTable, juniAtmSubIfSvcConfigPacketDiscard=juniAtmSubIfSvcConfigPacketDiscard, juniAtmCircuitInOamF5EndToEndLoopbackCells=juniAtmCircuitInOamF5EndToEndLoopbackCells, juniAtmIfOutCells=juniAtmIfOutCells, juniAtmAal5Group=juniAtmAal5Group, juniAtmF4FlowOutEndRdiCells=juniAtmF4FlowOutEndRdiCells, juniAtmF4FlowInOamEndAisCells=juniAtmF4FlowInOamEndAisCells, juniAtmSubIfVccTrafficShapingPacketShaping=juniAtmSubIfVccTrafficShapingPacketShaping, juniAtmCircuitInOamCellsDropped=juniAtmCircuitInOamCellsDropped, juniAtmPvcStatsInPacketOctetDiscards=juniAtmPvcStatsInPacketOctetDiscards, juniAtmProfileOverrideAssignIfCircuitVpi=juniAtmProfileOverrideAssignIfCircuitVpi, juniAtmPvcStatisticsEntry=juniAtmPvcStatisticsEntry, juniAtmCompliance12=juniAtmCompliance12, juniAtmIfCapabilityDefaultVcPerVp=juniAtmIfCapabilityDefaultVcPerVp, juniAtmOamF4FlowSegmentRowStatus=juniAtmOamF4FlowSegmentRowStatus, juniAtmIfPnniRccTable=juniAtmIfPnniRccTable, juniAtmOamF4FlowEndToEndVpi=juniAtmOamF4FlowEndToEndVpi, juniAtmSubIfSvcConfigDestE164Address=juniAtmSubIfSvcConfigDestE164Address, juniAtmVpStatsSarTimeouts=juniAtmVpStatsSarTimeouts, juniAtmPingTestCodeStopped=juniAtmPingTestCodeStopped, juniAtmIfLayer=juniAtmIfLayer, juniAtmSubIfSvcConfigEntry=juniAtmSubIfSvcConfigEntry, juniAtmSubIfLocationType=juniAtmSubIfLocationType, juniAtmF4FlowEndToEndInLoopbackCmds=juniAtmF4FlowEndToEndInLoopbackCmds, juniAtmNbmaMapListTable=juniAtmNbmaMapListTable, juniAtmF4FlowOutSegmentRdiCells=juniAtmF4FlowOutSegmentRdiCells, juniAtmF4FlowOamSegmentVpOperationState=juniAtmF4FlowOamSegmentVpOperationState, juniAtmSubIfVccTrafficShapingPoliceObserve=juniAtmSubIfVccTrafficShapingPoliceObserve, juniAtmSubIfSvcConfigScr=juniAtmSubIfSvcConfigScr, juniAtmIfPnniRccEntry=juniAtmIfPnniRccEntry, juniAtmF4FlowOutEndToEndLoopbackCells=juniAtmF4FlowOutEndToEndLoopbackCells, juniAtmIfSvcSignallingAdminStatus=juniAtmIfSvcSignallingAdminStatus, juniAtmF4FlowSegmentOutOamCells=juniAtmF4FlowSegmentOutOamCells, juniAtmVpPingSentProbes=juniAtmVpPingSentProbes, juniAtmF4FlowEndInOamCells=juniAtmF4FlowEndInOamCells, juniAtmIfUniVersion=juniAtmIfUniVersion, juniAtmSubIfInverseArpRefresh=juniAtmSubIfInverseArpRefresh, juniAtmVpTunnelTable=juniAtmVpTunnelTable, juniAtmCompliance4=juniAtmCompliance4, juniAtmSubIfVccMbs=juniAtmSubIfVccMbs, juniAtmVpStatsVpi=juniAtmVpStatsVpi, juniAtmIfMapGroup=juniAtmIfMapGroup, juniAtmF4FlowOamSegmentVpAdminState=juniAtmF4FlowOamSegmentVpAdminState, juniAtmBulkCircuitsId=juniAtmBulkCircuitsId, juniAtmVcClassIdId=juniAtmVcClassIdId, juniAtmSubIfGroup2=juniAtmSubIfGroup2, juniAtmCircuitOutOamF5SegmentLoopbackRsps=juniAtmCircuitOutOamF5SegmentLoopbackRsps, juniAtmVcClassNameTable=juniAtmVcClassNameTable, juniAtmNbmaMapIpAddress=juniAtmNbmaMapIpAddress, juniAtmVcClassId=juniAtmVcClassId, juniAtmCircuitVcOamOperStatus=juniAtmCircuitVcOamOperStatus, juniAtmF4FlowInOamSegmentCCActDeActCells=juniAtmF4FlowInOamSegmentCCActDeActCells, juniAtmVpStatsInPacketDiscards=juniAtmVpStatsInPacketDiscards, juniAtmBulkCircuitsMinVci=juniAtmBulkCircuitsMinVci, juniAtmMartiniTimeoutTimerIndex=juniAtmMartiniTimeoutTimerIndex, juniAtmIfCacUbrWeight=juniAtmIfCacUbrWeight, juniAtmCompliance6=juniAtmCompliance6, juniAtmProfileOverrideAssignIfCircuitRowStatus=juniAtmProfileOverrideAssignIfCircuitRowStatus, juniAtmIfPnniRccVcd=juniAtmIfPnniRccVcd, juniAtmGroups=juniAtmGroups, juniAtmVpTunnelServiceCategory=juniAtmVpTunnelServiceCategory, juniAtmNbmaMapVpi=juniAtmNbmaMapVpi, juniAtmVpPingStartTime=juniAtmVpPingStartTime, juniAtmCompliance3=juniAtmCompliance3, juniAtmF4FlowEndLastTimeChanged=juniAtmF4FlowEndLastTimeChanged, juniAtmSubIfSvcConfigPcr=juniAtmSubIfSvcConfigPcr, juniAtmNbmaMapName=juniAtmNbmaMapName, juniAtmCircuitInOamF5EndToEndLoopbackRsps=juniAtmCircuitInOamF5EndToEndLoopbackRsps, juniAtmVpPingEntry=juniAtmVpPingEntry, juniAtmVpStatsIfIndex=juniAtmVpStatsIfIndex, juniAtmVpPingProbeCount=juniAtmVpPingProbeCount, juniAtmVpStatsInPacketErrors=juniAtmVpStatsInPacketErrors, juniAtmGroup5=juniAtmGroup5, juniAtmVcClassVccMbs=juniAtmVcClassVccMbs, juniAtmIfCapabilityOam=juniAtmIfCapabilityOam, juniAtmIfTable=juniAtmIfTable, juniAtmVcClassVccOamRetryFrequency=juniAtmVcClassVccOamRetryFrequency, juniAtmAal5IfTable=juniAtmAal5IfTable, juniAtmCircuitOamAlarmDownCount=juniAtmCircuitOamAlarmDownCount, juniAtmVcClassNameRowStatus=juniAtmVcClassNameRowStatus, juniAtmCompliance13=juniAtmCompliance13, juniAtmVpStatsOutPacketErrors=juniAtmVpStatsOutPacketErrors, juniAtmAal5IfEntry=juniAtmAal5IfEntry, juniAtmCircuitInOamF5AisCells=juniAtmCircuitInOamF5AisCells, JuniAtmLocationValue=JuniAtmLocationValue, juniAtmVcClassVccScr=juniAtmVcClassVccScr, juniAtmCircuitOamTable=juniAtmCircuitOamTable, juniAtmF4FlowOutEndCCCells=juniAtmF4FlowOutEndCCCells, juniAtmF4OamCircuitGroup=juniAtmF4OamCircuitGroup, juniAtmOamF4FlowEndToEndRowStatus=juniAtmOamF4FlowEndToEndRowStatus, juniAtmVpTunnelRowStatus=juniAtmVpTunnelRowStatus, juniAtmMartiniTimeoutTimerTable=juniAtmMartiniTimeoutTimerTable, juniAtmVcClassVccInverseArpRefresh=juniAtmVcClassVccInverseArpRefresh, juniAtmSubIfVccType=juniAtmSubIfVccType, juniAtmCircuitOutOamF5EndToEndLoopbackCells=juniAtmCircuitOutOamF5EndToEndLoopbackCells, juniAtmAal5IfLayer=juniAtmAal5IfLayer, juniAtmVcPingMaxRtt=juniAtmVcPingMaxRtt, juniAtmVpPingAverageRtt=juniAtmVpPingAverageRtt, juniAtmSubIfSvcConfigCdvt=juniAtmSubIfSvcConfigCdvt, juniAtmPvcStatsinPacketErrors=juniAtmPvcStatsinPacketErrors, juniAtmVcClassVccServiceCategory=juniAtmVcClassVccServiceCategory, juniAtmPingTestCodeCircuitDown=juniAtmPingTestCodeCircuitDown, juniAtmOamF4FlowEndToEndIfIndex=juniAtmOamF4FlowEndToEndIfIndex, juniAtmNextIfIndex=juniAtmNextIfIndex, juniAtmGroup9=juniAtmGroup9, juniAtmCircuitOamVpi=juniAtmCircuitOamVpi, juniAtmIfE164Gateway=juniAtmIfE164Gateway, juniAtmPingTestCodeOamVcOperState=juniAtmPingTestCodeOamVcOperState, juniAtmTrapPrefix=juniAtmTrapPrefix, juniAtmCircuitOutOamF5EndToEndLoopbackCmds=juniAtmCircuitOutOamF5EndToEndLoopbackCmds, juniAtmIfIlmiAdminState=juniAtmIfIlmiAdminState, juniAtmCircuitOamVci=juniAtmCircuitOamVci, juniAtmVpStatsOutCells=juniAtmVpStatsOutCells, juniAtmCircuitOamLoopbackFrequency=juniAtmCircuitOamLoopbackFrequency, juniAtmPvcStatsInCellOctets=juniAtmPvcStatsInCellOctets, juniAtmVcClass=juniAtmVcClass, juniAtmCircuitOamUpCount=juniAtmCircuitOamUpCount, juniAtmIfCacUsedBandwidthUpper=juniAtmIfCacUsedBandwidthUpper, juniAtmNbmaMapTable=juniAtmNbmaMapTable, juniAtmVcPingSentProbes=juniAtmVcPingSentProbes, juniAtmBulkCircuitsEntry=juniAtmBulkCircuitsEntry, juniAtmCompliance11=juniAtmCompliance11, juniAtmVcClassVccOamDownCount=juniAtmVcClassVccOamDownCount, juniAtmF4FlowInOamEndCCCells=juniAtmF4FlowInOamEndCCCells, juniAtmSubIfSvcConfigDestAtmAddress=juniAtmSubIfSvcConfigDestAtmAddress, juniAtmPvcStatsInPacketDiscards=juniAtmPvcStatsInPacketDiscards, juniAtmSubIfSvcConfigServiceCategory=juniAtmSubIfSvcConfigServiceCategory, juniAtmF4FlowInOamSegmentRdiCells=juniAtmF4FlowInOamSegmentRdiCells, juniAtmF4FlowSegmentOutLoopbackCmds=juniAtmF4FlowSegmentOutLoopbackCmds, juniAtmOamF4FlowSegmentCCSource=juniAtmOamF4FlowSegmentCCSource, juniAtmIfSvcSignallingEntry=juniAtmIfSvcSignallingEntry, juniAtmVcClassIdEntry=juniAtmVcClassIdEntry, juniAtmSubIfRowStatus=juniAtmSubIfRowStatus, juniAtmSubIfIndex=juniAtmSubIfIndex, juniAtmIfIndex=juniAtmIfIndex, juniAtmSubIfSvcConfigClp0=juniAtmSubIfSvcConfigClp0, juniAtmCompliance=juniAtmCompliance, juniAtmSubIfGroup=juniAtmSubIfGroup, juniAtmVcPingMinRtt=juniAtmVcPingMinRtt, juniAtmCircuitOamRetryFrequency=juniAtmCircuitOamRetryFrequency, juniAtmCircuitOamAlarmClearTimeout=juniAtmCircuitOamAlarmClearTimeout, juniAtmSubIfVccVci=juniAtmSubIfVccVci, juniAtmVcClassVccOamAlarmDownCount=juniAtmVcClassVccOamAlarmDownCount, juniAtmSubIfDescriptionExport=juniAtmSubIfDescriptionExport, juniAtmBulkCircuitsInstance=juniAtmBulkCircuitsInstance, juniAtmIfCapabilityIndex=juniAtmIfCapabilityIndex, juniAtmPvcStatsVci=juniAtmPvcStatsVci, juniAtmTraps=juniAtmTraps, juniAtmIfCacAvailableBandwidthRx=juniAtmIfCacAvailableBandwidthRx, juniAtmIfAssociatedVcClassId=juniAtmIfAssociatedVcClassId, juniAtmPingTestCodeInvalidParams=juniAtmPingTestCodeInvalidParams, juniAtmObjects=juniAtmObjects, juniAtmIfCapabilityTrafficShaping=juniAtmIfCapabilityTrafficShaping, juniAtmBulkCircuitsNameId=juniAtmBulkCircuitsNameId, juniAtmOamF4FlowEndToEndCfgEntry=juniAtmOamF4FlowEndToEndCfgEntry, juniAtmVpTunnelVpi=juniAtmVpTunnelVpi, juniAtmF4FlowOamEndVpAdminState=juniAtmF4FlowOamEndVpAdminState, juniAtmF4FlowInOamEndLoopbackCells=juniAtmF4FlowInOamEndLoopbackCells, juniAtmCircuitInOamF5SegmentLoopbackCells=juniAtmCircuitInOamF5SegmentLoopbackCells, juniAtmOamF4FlowEndToEndCCSource=juniAtmOamF4FlowEndToEndCCSource, juniAtmBulkCircuitsNameAal5IfIndex=juniAtmBulkCircuitsNameAal5IfIndex, juniAtmSubIfSvcRowStatus=juniAtmSubIfSvcRowStatus, juniAtmIfE164Autoconversion=juniAtmIfE164Autoconversion, juniAtmVpPingMinRtt=juniAtmVpPingMinRtt, juniAtmSubIfLocationIfIndex=juniAtmSubIfLocationIfIndex, juniAtmVcClassEntry=juniAtmVcClassEntry, juniAtmPing=juniAtmPing, juniAtmPvcStatsOutPacketOctets=juniAtmPvcStatsOutPacketOctets, juniAtmMartiniGroup=juniAtmMartiniGroup, juniAtmVcClassVccOamAdminStatus=juniAtmVcClassVccOamAdminStatus, juniAtmSubIfVccServiceCategory=juniAtmSubIfVccServiceCategory, juniAtmCompliance7=juniAtmCompliance7, juniAtmF4FlowInOamSegmentCCCells=juniAtmF4FlowInOamSegmentCCCells, juniAtmCircuitInOamF5SegmentLoopbackRsps=juniAtmCircuitInOamF5SegmentLoopbackRsps, juniAtmSubIfSvcConfigObserve=juniAtmSubIfSvcConfigObserve, juniAtmVpTunnelEntry=juniAtmVpTunnelEntry)
mibBuilder.exportSymbols("Juniper-UNI-ATM-MIB", juniAtmIfOamCellFilter=juniAtmIfOamCellFilter, juniAtmVpDescrEntry=juniAtmVpDescrEntry, juniAtmIfPnniRccVpi=juniAtmIfPnniRccVpi, juniAtmCircuitOamDownCount=juniAtmCircuitOamDownCount, juniAtmVpPingTestCompleted=juniAtmVpPingTestCompleted, juniAtmIfCapabilityNumVpiVciBits=juniAtmIfCapabilityNumVpiVciBits, juniAtmIfCacUsedBandwidthLower=juniAtmIfCacUsedBandwidthLower, juniAtmVpStatsOutPacketOctets=juniAtmVpStatsOutPacketOctets, juniAtmOamF4FlowEndToEndLoopbackTimer=juniAtmOamF4FlowEndToEndLoopbackTimer, juniAtmSubIfGroup4=juniAtmSubIfGroup4, juniAtmSubIfGroup5=juniAtmSubIfGroup5, juniAtmCircuitOamLoopbackOperStatus=juniAtmCircuitOamLoopbackOperStatus, juniAtmGroup6=juniAtmGroup6, juniAtmIfCapabilityEntry=juniAtmIfCapabilityEntry, JuniAtmNbmaMapName=JuniAtmNbmaMapName, juniAtmIfCacAvailableBandwidth=juniAtmIfCacAvailableBandwidth, juniAtmIfSvcSignallingVpi=juniAtmIfSvcSignallingVpi, juniAtmProfileOverrideAssignIfCircuitOperStatus=juniAtmProfileOverrideAssignIfCircuitOperStatus, juniAtmVcClassNameEntry=juniAtmVcClassNameEntry, juniAtmSubIfVccTrafficShapingTable=juniAtmSubIfVccTrafficShapingTable, juniAtmSubIfVccTable=juniAtmSubIfVccTable, juniAtmSubIfVccAssociatedVcClassId=juniAtmSubIfVccAssociatedVcClassId, juniAtmVcPingTestCompleted=juniAtmVcPingTestCompleted, juniAtmMartiniTimeoutTimerValue=juniAtmMartiniTimeoutTimerValue, juniAtmVcClassVccInverseArp=juniAtmVcClassVccInverseArp, juniAtmSubIfSvcConfigTagging=juniAtmSubIfSvcConfigTagging, juniAtmProfileOverrideAssignIfCircuitProfileId=juniAtmProfileOverrideAssignIfCircuitProfileId, juniAtmCompliances=juniAtmCompliances, juniAtmF4FlowOamSegmentStatsEntry=juniAtmF4FlowOamSegmentStatsEntry, juniAtmGroup2=juniAtmGroup2, juniAtmIfCacAdminState=juniAtmIfCacAdminState, juniAtmPingTestCode=juniAtmPingTestCode, juniAtmIfEntry=juniAtmIfEntry, juniAtmVpTunnelIfIndex=juniAtmVpTunnelIfIndex, juniAtmF4FlowSegmentInOamCells=juniAtmF4FlowSegmentInOamCells, juniAtmGroup7=juniAtmGroup7, juniAtmNbmaMapVcd=juniAtmNbmaMapVcd, juniAtmVpStatsEntry=juniAtmVpStatsEntry, juniAtmSubIfGroup6=juniAtmSubIfGroup6, juniAtmAal5IfLowerIfIndex=juniAtmAal5IfLowerIfIndex, juniAtmNbma=juniAtmNbma, juniAtmNbmaMapListRowStatus=juniAtmNbmaMapListRowStatus, juniAtmSubIfGroup3=juniAtmSubIfGroup3, juniAtmF4FlowOamEndToEndStatsTable=juniAtmF4FlowOamEndToEndStatsTable, juniAtmGroup4=juniAtmGroup4, juniAtmSubIfInverseArp=juniAtmSubIfInverseArp, juniAtmF4FlowOamEndVpOperationState=juniAtmF4FlowOamEndVpOperationState, juniAtmPvcStatsInCellErrors=juniAtmPvcStatsInCellErrors, juniAtmSubIfLayer=juniAtmSubIfLayer, juniAtmPingTrapGroup=juniAtmPingTrapGroup, juniAtmVpStatsOutPackets=juniAtmVpStatsOutPackets, juniAtmAal5IfIndex=juniAtmAal5IfIndex, juniAtmBulkCircuitsAal5IfIndex=juniAtmBulkCircuitsAal5IfIndex, juniAtmNbmaMapListName=juniAtmNbmaMapListName, juniAtmIfSvcSignallingTable=juniAtmIfSvcSignallingTable, juniAtmPvcStatsInPackets=juniAtmPvcStatsInPackets, juniAtmPvcStatsInPacketOctets=juniAtmPvcStatsInPacketOctets, juniAtmSubIfAdvisoryRxSpeed=juniAtmSubIfAdvisoryRxSpeed, juniAtmProfileOverrideAssignIfCircuitAal5Index=juniAtmProfileOverrideAssignIfCircuitAal5Index, juniAtmSubIfGroup7=juniAtmSubIfGroup7, juniAtmPnniGroup=juniAtmPnniGroup, juniAtmVpStatsInPacketOctetDiscards=juniAtmVpStatsInPacketOctetDiscards, juniAtmVpPingMaxRtt=juniAtmVpPingMaxRtt, juniAtmVpStatsOverSizedPackets=juniAtmVpStatsOverSizedPackets, juniAtmVpPingTimeOut=juniAtmVpPingTimeOut, juniAtmF4FlowSegmentInOamCellsDropped=juniAtmF4FlowSegmentInOamCellsDropped, juniAtmOamF4FlowSegmentVpi=juniAtmOamF4FlowSegmentVpi, juniAtmIfCapabilityOamCellFilter=juniAtmIfCapabilityOamCellFilter, juniAtmProfileOverrideAssignIfCircuitEntry=juniAtmProfileOverrideAssignIfCircuitEntry, juniAtmSubIfVccVpi=juniAtmSubIfVccVpi, juniAtmVpTunnelGroup=juniAtmVpTunnelGroup, juniAtmNbmaMapListEntry=juniAtmNbmaMapListEntry, juniAtmVcPingControlGroup=juniAtmVcPingControlGroup, juniAtmF4FlowSegmentInLoopbackCmds=juniAtmF4FlowSegmentInLoopbackCmds, juniAtmIfIlmiPollFrequency=juniAtmIfIlmiPollFrequency, juniAtmSubIfMartiniTimeoutTimerId=juniAtmSubIfMartiniTimeoutTimerId, juniAtmBulkCircuitsNameName=juniAtmBulkCircuitsNameName, juniAtmSvcGroup=juniAtmSvcGroup, juniAtmVpPingTable=juniAtmVpPingTable, juniAtmF4FlowEndOutOamCells=juniAtmF4FlowEndOutOamCells, juniAtmPingTestCodeMaxPingCountReached=juniAtmPingTestCodeMaxPingCountReached, juniAtmF4FlowEndToEndInLoopbackRsps=juniAtmF4FlowEndToEndInLoopbackRsps, juniAtmIfInCells=juniAtmIfInCells, juniAtmBulkCircuitsIdName=juniAtmBulkCircuitsIdName, juniAtmVcPingEntry=juniAtmVcPingEntry, juniAtmVcPingProbeCount=juniAtmVcPingProbeCount, juniAtmPvcStatsOutPackets=juniAtmPvcStatsOutPackets, juniAtmCompliance9=juniAtmCompliance9, juniAtmVcPingTimeOut=juniAtmVcPingTimeOut, juniAtmF4FlowSegmentInLoopbackRsps=juniAtmF4FlowSegmentInLoopbackRsps, juniAtmBulkCircuitsIdEntry=juniAtmBulkCircuitsIdEntry, juniAtmAal5NextIfIndex=juniAtmAal5NextIfIndex, juniAtmF4FlowSegmentLastTimeChanged=juniAtmF4FlowSegmentLastTimeChanged, juniAtmSubIfAssociatedVcClassId=juniAtmSubIfAssociatedVcClassId, juniAtmOamF4FlowSegmentCCSink=juniAtmOamF4FlowSegmentCCSink, juniAtmTrafficShapingGroup=juniAtmTrafficShapingGroup, juniAtmSubIfLowerIfIndex=juniAtmSubIfLowerIfIndex, juniAtmVpStatsInPacketOctets=juniAtmVpStatsInPacketOctets, juniAtmVcPingStartTime=juniAtmVcPingStartTime, juniAtmF4OamCircuitGroup2=juniAtmF4OamCircuitGroup2, juniAtmCompliance10=juniAtmCompliance10, juniAtmPvcStatsOutCellErrors=juniAtmPvcStatsOutCellErrors, juniAtmF4FlowEndActualLoopbackFreq=juniAtmF4FlowEndActualLoopbackFreq, juniAtmBulkCircuitsMinVpi=juniAtmBulkCircuitsMinVpi, juniAtmCircuitOutOamF5RdiCells=juniAtmCircuitOutOamF5RdiCells, juniAtmPingTestOamSeg=juniAtmPingTestOamSeg, juniAtmGroup8=juniAtmGroup8, juniAtmCircuitOamAdminStatus=juniAtmCircuitOamAdminStatus, juniAtmSubIfVccTrafficShapingEntry=juniAtmSubIfVccTrafficShapingEntry, juniAtmF4FlowOutEndCCActDeActCells=juniAtmF4FlowOutEndCCActDeActCells, juniAtmSubIfVccTrafficShapingCdvt=juniAtmSubIfVccTrafficShapingCdvt, juniAtmF4FlowInOamSegmentLoopbackCells=juniAtmF4FlowInOamSegmentLoopbackCells, juniAtmBulkCircuitsIdNextInstance=juniAtmBulkCircuitsIdNextInstance, juniAtmSubIfVccTrafficShapingClp0=juniAtmSubIfVccTrafficShapingClp0, juniAtmSubIfEntry=juniAtmSubIfEntry, juniAtmCompliance2=juniAtmCompliance2, juniAtmBulkCircuitsMaxVci=juniAtmBulkCircuitsMaxVci, juniAtmF4FlowSegmentOutLoopbackRsps=juniAtmF4FlowSegmentOutLoopbackRsps, juniAtmSubIfSvcConfigMbs=juniAtmSubIfSvcConfigMbs, juniAtmVcClassTable=juniAtmVcClassTable, juniAtmF4FlowInOamSegmentAisCells=juniAtmF4FlowInOamSegmentAisCells, juniAtmF4FlowOutSegmentCCActDeActCells=juniAtmF4FlowOutSegmentCCActDeActCells, juniAtmCircuitOamEntry=juniAtmCircuitOamEntry, juniAtmVcPingProbeResponses=juniAtmVcPingProbeResponses, juniAtmPvcStatsInPacketUnknownProtocol=juniAtmPvcStatsInPacketUnknownProtocol, juniAtmVpTunnelKbps=juniAtmVpTunnelKbps, juniAtmVcClassName=juniAtmVcClassName, juniAtmSvcGroup2=juniAtmSvcGroup2, juniAtmIfIlmiVpi=juniAtmIfIlmiVpi, juniAtmSubIfSvcConfigTable=juniAtmSubIfSvcConfigTable, juniAtmLocationGroup=juniAtmLocationGroup, juniAtmIfOamCellRxAdminState=juniAtmIfOamCellRxAdminState, juniAtmSubIfLocationEntry=juniAtmSubIfLocationEntry, juniAtmOamF4FlowSegmentCfgTable=juniAtmOamF4FlowSegmentCfgTable, juniAtmNbmaMapRowStatus=juniAtmNbmaMapRowStatus, JuniAtmLocationType=JuniAtmLocationType, juniAtmCircuitOutOamF5SegmentLoopbackCmds=juniAtmCircuitOutOamF5SegmentLoopbackCmds, juniAtmVcClassVccOamAlarmClearTimeout=juniAtmVcClassVccOamAlarmClearTimeout, PYSNMP_MODULE_ID=juniAtmMIB, juniAtmIfCapabilityTable=juniAtmIfCapabilityTable, juniAtmProfileOverrideAssignIfCircuitVci=juniAtmProfileOverrideAssignIfCircuitVci, juniAtmCircuitInOamF5SegmentLoopbackCmds=juniAtmCircuitInOamF5SegmentLoopbackCmds, juniAtmF4FlowOamEndToEndStatsEntry=juniAtmF4FlowOamEndToEndStatsEntry, juniAtmSubIfVccEntry=juniAtmSubIfVccEntry, juniAtmVcClassVccPcr=juniAtmVcClassVccPcr, juniAtmIfSvcSignallingVci=juniAtmIfSvcSignallingVci, juniAtmIfCapabilityMaxVcd=juniAtmIfCapabilityMaxVcd, juniAtmBulkCircuitsTable=juniAtmBulkCircuitsTable, juniAtmSubIfAddress=juniAtmSubIfAddress, juniAtmSubIfNbma=juniAtmSubIfNbma, juniAtmMIB=juniAtmMIB, juniAtmF4FlowInOamEndRdiCells=juniAtmF4FlowInOamEndRdiCells, juniAtmNbmaMapGroup=juniAtmNbmaMapGroup, juniAtmIfIlmiVci=juniAtmIfIlmiVci, juniAtmIfRowStatus=juniAtmIfRowStatus, juniAtmVcPingAverageRtt=juniAtmVcPingAverageRtt, juniAtmSubIfSvcConfigCircuitType=juniAtmSubIfSvcConfigCircuitType, juniAtmOamF4FlowEndToEndCCSink=juniAtmOamF4FlowEndToEndCCSink, juniAtmSubIfMtu=juniAtmSubIfMtu, juniAtmIfVcCount=juniAtmIfVcCount, juniAtmBulkCircuitsIdAal5IfIndex=juniAtmBulkCircuitsIdAal5IfIndex, juniAtmIfCacSubscriptionBandwidth=juniAtmIfCacSubscriptionBandwidth, juniAtmSubIfVccVcd=juniAtmSubIfVccVcd, juniAtmVpPingProbeResponses=juniAtmVpPingProbeResponses, juniAtmPvcStatsOutCellOctets=juniAtmPvcStatsOutCellOctets, juniAtmBulkCircuitsNameEntry=juniAtmBulkCircuitsNameEntry, juniAtmCircuitOutOamF5SegmentLoopbackCells=juniAtmCircuitOutOamF5SegmentLoopbackCells, juniAtmCircuitOutOamF5Cells=juniAtmCircuitOutOamF5Cells, juniAtmSubIfDistinguisher=juniAtmSubIfDistinguisher, juniAtmVpStatsInPackets=juniAtmVpStatsInPackets, juniAtmVpStatsGroup=juniAtmVpStatsGroup, juniAtmIfLowerIfIndex=juniAtmIfLowerIfIndex, juniAtmVcClassVccOamUpCount=juniAtmVcClassVccOamUpCount)
