...
mibBuilder.exportSymbols("CISCO-VISM-MODULE-MIB", vismVoIpGrp=vismVoIpGrp, vismXgcpBearerVCType=vismXgcpBearerVCType, vismPrevMode=vismPrevMode, vismContinuityCheckCellEnable=vismContinuityCheckCellEnable, vismAggregateSvcBandwidth=vismAggregateSvcBandwidth, vismVADDutyCycle=vismVADDutyCycle, vismAal2CidFillTimer=vismAal2CidFillTimer, ciscoVismModuleCompliance1=ciscoVismModuleCompliance1, vismSendDataGramSize=vismSendDataGramSize, vismFaxDeJitterInitialDelay=vismFaxDeJitterInitialDelay, vismSplModemToneBitMap=vismSplModemToneBitMap, vismSubNetMask=vismSubNetMask, vismRtpReceiveTimer=vismRtpReceiveTimer, vismIpGrp=vismIpGrp, vismDaughterCardDescription=vismDaughterCardDescription, vismAggregateTrafficClipping=vismAggregateTrafficClipping, ciscoVismSystemGroup=ciscoVismSystemGroup, ciscoVismAal2Group=ciscoVismAal2Group, ciscoVismTrapVarbindGroup=ciscoVismTrapVarbindGroup, vismXgcpBearerConnectionType=vismXgcpBearerConnectionType, vismTrapObjGrp=vismTrapObjGrp, vismControlTos=vismControlTos, vismTrapIntIndex2=vismTrapIntIndex2, VismFaxDeJitterMode=VismFaxDeJitterMode, vismVoIpLapdTrunkPVC=vismVoIpLapdTrunkPVC, vismEcanCnfIdleDirection=vismEcanCnfIdleDirection, vismPvcAlarmLogEnable=vismPvcAlarmLogEnable, vismBearerContinuityTest=vismBearerContinuityTest, vismMode=vismMode, vismContinuityCo1Timer=vismContinuityCo1Timer, vismUpspeedCodec=vismUpspeedCodec, vismFailedCalls=vismFailedCalls, vismAvailableDs0Count=vismAvailableDs0Count, vismDaughterCardHWRev=vismDaughterCardHWRev, ciscoVismModuleComplianceRev2=ciscoVismModuleComplianceRev2, vismPvcAlarmLogOperTimer=vismPvcAlarmLogOperTimer, vismPacketizationPeriod=vismPacketizationPeriod, ciscoVismModuleMIBConformance=ciscoVismModuleMIBConformance, ciscoVismModuleMIB=ciscoVismModuleMIB, vismDspGrp=vismDspGrp, vismAppliedTemplate=vismAppliedTemplate, VismFaxDeJitterInitDelay=VismFaxDeJitterInitDelay, vismJitterDelayMode=vismJitterDelayMode, vismVoIpNTECapabilityNegotiate=vismVoIpNTECapabilityNegotiate, vismRtcpRepInterval=vismRtcpRepInterval, vismLongDurationTimer=vismLongDurationTimer, vismTrapIntIndex1=vismTrapIntIndex1, vismCacEnable=vismCacEnable, vismConfigChangeTypeBitMap=vismConfigChangeTypeBitMap, vismAal2VADTimer=vismAal2VADTimer, vismPayloadType=vismPayloadType, vismSysPerfClrButton=vismSysPerfClrButton, vismExtDnsServerDn=vismExtDnsServerDn, vismVoIpVADTimer=vismVoIpVADTimer, vismFreeDs0Threshold=vismFreeDs0Threshold, ciscoVismSystemDeprecatedGroup=ciscoVismSystemDeprecatedGroup, vismAal2Grp=vismAal2Grp, vismDSPHeartbeat=vismDSPHeartbeat, vismSSRCEnable=vismSSRCEnable, ciscoVismSystemGroupSup1=ciscoVismSystemGroupSup1, vismVADTolerance=vismVADTolerance, vismConfig=vismConfig, vismMaxConfNum=vismMaxConfNum, ciscoVismIpGroup=ciscoVismIpGroup, ciscoVismModuleComplianceRev3=ciscoVismModuleComplianceRev3, vismRtcpRecvMultiplier=vismRtcpRecvMultiplier, ciscoVismModuleComplianceRev4=ciscoVismModuleComplianceRev4, vismIpAddress=vismIpAddress, vismVoIpTripleRedundancy=vismVoIpTripleRedundancy, vismDynamicPT=vismDynamicPT, vismCallStats=vismCallStats, vismTotalCalls=vismTotalCalls, ciscoVismDspGroupSup1=ciscoVismDspGroupSup1, vismCPUUtilizationThreshold=vismCPUUtilizationThreshold, vismBearerSubNetMask=vismBearerSubNetMask, ciscoVismDspDeprecatedGroup=ciscoVismDspDeprecatedGroup, ciscoVismSystemFeatureGroupRev1=ciscoVismSystemFeatureGroupRev1, vismCPUUtilization=vismCPUUtilization, vismVoIpCasTransport=vismVoIpCasTransport, vismOamLoopbackSetCLP=vismOamLoopbackSetCLP, vismTftpServerDn=vismTftpServerDn, vismVoIpSIDPayloadType=vismVoIpSIDPayloadType, vismERL=vismERL, vismVoIpDPvcOamCellGap=vismVoIpDPvcOamCellGap, vismEcanEncoding=vismEcanEncoding, ciscoVismCallStatsGroup=ciscoVismCallStatsGroup, vismTrapFilteringEnable=vismTrapFilteringEnable, vismReverseCotTone=vismReverseCotTone, vismSystemGrp=vismSystemGrp, vismTrapIntegerValue=vismTrapIntegerValue, vismAal2Type3Redundancy=vismAal2Type3Redundancy, ciscoVismTrapObjGroup=ciscoVismTrapObjGroup, vismDspHealth=vismDspHealth, vismVoIpDPvcRecoverCnt=vismVoIpDPvcRecoverCnt, vismAisSuppression=vismAisSuppression, ciscoVismVoIpGroup=ciscoVismVoIpGroup, vismAdaptiveGainControl=vismAdaptiveGainControl, vismSuccessfulCalls=vismSuccessfulCalls, vismCompCnfPacketSize=vismCompCnfPacketSize, ciscoVismPerfStatsGroup=ciscoVismPerfStatsGroup, vismVoIpDPvcRetryCnt=vismVoIpDPvcRetryCnt, PYSNMP_MODULE_ID=ciscoVismModuleMIB, vismSendDnEnable=vismSendDnEnable, vismAal2DtmfRelay=vismAal2DtmfRelay, vismContinuityCo2Timer=vismContinuityCo2Timer, ciscoVismSystemFeatureGroup=ciscoVismSystemFeatureGroup, ciscoVismVoIpDeprecateGroup=ciscoVismVoIpDeprecateGroup, vismDualToneDetect=vismDualToneDetect, vismCallStatsClrButton=vismCallStatsClrButton, vismXgcpBearerNetworkType=vismXgcpBearerNetworkType, vismAal2CasTransport=vismAal2CasTransport, ciscoVismModuleMIBCompliances=ciscoVismModuleMIBCompliances, vismJitterInitialDelay=vismJitterInitialDelay, vismBearerIpAddress=vismBearerIpAddress, ciscoVismDspGroup=ciscoVismDspGroup, vismMemoryUtilization=vismMemoryUtilization, ciscoVismModuleMIBGroups=ciscoVismModuleMIBGroups, vismEcanCnfIdlePattern=vismEcanCnfIdlePattern, vismMemoryUtilizationThreshold=vismMemoryUtilizationThreshold, vismPvcAlarmLogAdminTimer=vismPvcAlarmLogAdminTimer, vismTrapStrIndex1=vismTrapStrIndex1, vismAal2SubcellMuxing=vismAal2SubcellMuxing, vismVoIpEventNegotiationPolicy=vismVoIpEventNegotiationPolicy, vismInteropGrp=vismInteropGrp, vismDaughterCardSerialNum=vismDaughterCardSerialNum, vismXgcpSdpOst=vismXgcpSdpOst, ciscoVismSystemGroup1=ciscoVismSystemGroup1, vismFeatureBitMap=vismFeatureBitMap, vismBearerTos=vismBearerTos, vismVoIpDtmfRelay=vismVoIpDtmfRelay, vismFaxDeJitterMode=vismFaxDeJitterMode, ciscoVismInteropGroup=ciscoVismInteropGroup, vismCaleaEnable=vismCaleaEnable, vismCarrierLossPolicy=vismCarrierLossPolicy, vismCacRejectionPolicy=vismCacRejectionPolicy, vismBearerContinuityTimer=vismBearerContinuityTimer, ciscoVismModuleCompliance=ciscoVismModuleCompliance, vismOamLoopThreshold=vismOamLoopThreshold, vismProfileNegotiationOption=vismProfileNegotiationOption, vismSystemPerfStats=vismSystemPerfStats, vismCodecNegotiationOption=vismCodecNegotiationOption, vismBearerIpPingEnable=vismBearerIpPingEnable)
