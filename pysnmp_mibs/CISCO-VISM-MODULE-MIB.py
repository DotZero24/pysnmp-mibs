...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-VISM-MODULE-MIB
...
mibBuilder.exportSymbols("CISCO-VISM-MODULE-MIB", vismVoIpEventNegotiationPolicy=vismVoIpEventNegotiationPolicy, vismVADDutyCycle=vismVADDutyCycle, vismFaxDeJitterInitialDelay=vismFaxDeJitterInitialDelay, vismMemoryUtilization=vismMemoryUtilization, vismBearerIpPingEnable=vismBearerIpPingEnable, ciscoVismSystemFeatureGroupRev1=ciscoVismSystemFeatureGroupRev1, ciscoVismTrapObjGroup=ciscoVismTrapObjGroup, vismSysPerfClrButton=vismSysPerfClrButton, vismContinuityCheckCellEnable=vismContinuityCheckCellEnable, vismDspHealth=vismDspHealth, vismDualToneDetect=vismDualToneDetect, ciscoVismModuleCompliance1=ciscoVismModuleCompliance1, vismJitterDelayMode=vismJitterDelayMode, vismOamLoopThreshold=vismOamLoopThreshold, vismAal2CidFillTimer=vismAal2CidFillTimer, vismPacketizationPeriod=vismPacketizationPeriod, ciscoVismDspDeprecatedGroup=ciscoVismDspDeprecatedGroup, vismTrapObjGrp=vismTrapObjGrp, ciscoVismModuleMIBCompliances=ciscoVismModuleMIBCompliances, ciscoVismInteropGroup=ciscoVismInteropGroup, vismXgcpSdpOst=vismXgcpSdpOst, vismBearerTos=vismBearerTos, vismMaxConfNum=vismMaxConfNum, vismEcanEncoding=vismEcanEncoding, vismDynamicPT=vismDynamicPT, vismEcanCnfIdleDirection=vismEcanCnfIdleDirection, vismAppliedTemplate=vismAppliedTemplate, VismFaxDeJitterInitDelay=VismFaxDeJitterInitDelay, vismTotalCalls=vismTotalCalls, vismVoIpLapdTrunkPVC=vismVoIpLapdTrunkPVC, vismIpGrp=vismIpGrp, vismAvailableDs0Count=vismAvailableDs0Count, ciscoVismTrapVarbindGroup=ciscoVismTrapVarbindGroup, ciscoVismVoIpDeprecateGroup=ciscoVismVoIpDeprecateGroup, vismDaughterCardSerialNum=vismDaughterCardSerialNum, ciscoVismIpGroup=ciscoVismIpGroup, ciscoVismSystemFeatureGroup=ciscoVismSystemFeatureGroup, vismConfig=vismConfig, vismVoIpDPvcRetryCnt=vismVoIpDPvcRetryCnt, ciscoVismModuleMIBGroups=ciscoVismModuleMIBGroups, vismUpspeedCodec=vismUpspeedCodec, vismFreeDs0Threshold=vismFreeDs0Threshold, vismPvcAlarmLogAdminTimer=vismPvcAlarmLogAdminTimer, ciscoVismModuleComplianceRev2=ciscoVismModuleComplianceRev2, vismPayloadType=vismPayloadType, vismVoIpGrp=vismVoIpGrp, vismCallStatsClrButton=vismCallStatsClrButton, vismCallStats=vismCallStats, vismMemoryUtilizationThreshold=vismMemoryUtilizationThreshold, vismAdaptiveGainControl=vismAdaptiveGainControl, vismAal2Grp=vismAal2Grp, PYSNMP_MODULE_ID=ciscoVismModuleMIB, vismAal2VADTimer=vismAal2VADTimer, vismTrapIntIndex1=vismTrapIntIndex1, vismVoIpDtmfRelay=vismVoIpDtmfRelay, vismTrapIntegerValue=vismTrapIntegerValue, vismBearerContinuityTest=vismBearerContinuityTest, vismExtDnsServerDn=vismExtDnsServerDn, vismAal2CasTransport=vismAal2CasTransport, vismVADTolerance=vismVADTolerance, vismBearerSubNetMask=vismBearerSubNetMask, ciscoVismSystemGroupSup1=ciscoVismSystemGroupSup1, VismFaxDeJitterMode=VismFaxDeJitterMode, vismVoIpDPvcRecoverCnt=vismVoIpDPvcRecoverCnt, ciscoVismCallStatsGroup=ciscoVismCallStatsGroup, vismRtcpRecvMultiplier=vismRtcpRecvMultiplier, ciscoVismSystemDeprecatedGroup=ciscoVismSystemDeprecatedGroup, vismFailedCalls=vismFailedCalls, vismCacRejectionPolicy=vismCacRejectionPolicy, vismSuccessfulCalls=vismSuccessfulCalls, vismCPUUtilizationThreshold=vismCPUUtilizationThreshold, vismTrapStrIndex1=vismTrapStrIndex1, vismBearerContinuityTimer=vismBearerContinuityTimer, vismBearerIpAddress=vismBearerIpAddress, ciscoVismModuleComplianceRev3=ciscoVismModuleComplianceRev3, vismVoIpSIDPayloadType=vismVoIpSIDPayloadType, vismPvcAlarmLogEnable=vismPvcAlarmLogEnable, ciscoVismModuleComplianceRev4=ciscoVismModuleComplianceRev4, vismCodecNegotiationOption=vismCodecNegotiationOption, vismCPUUtilization=vismCPUUtilization, vismAisSuppression=vismAisSuppression, vismTrapFilteringEnable=vismTrapFilteringEnable, vismSystemGrp=vismSystemGrp, vismAal2SubcellMuxing=vismAal2SubcellMuxing, ciscoVismAal2Group=ciscoVismAal2Group, vismProfileNegotiationOption=vismProfileNegotiationOption, vismInteropGrp=vismInteropGrp, vismIpAddress=vismIpAddress, vismReverseCotTone=vismReverseCotTone, ciscoVismSystemGroup1=ciscoVismSystemGroup1, ciscoVismPerfStatsGroup=ciscoVismPerfStatsGroup, vismControlTos=vismControlTos, vismPvcAlarmLogOperTimer=vismPvcAlarmLogOperTimer, vismCarrierLossPolicy=vismCarrierLossPolicy, vismERL=vismERL, vismTftpServerDn=vismTftpServerDn, vismRtcpRepInterval=vismRtcpRepInterval, vismXgcpBearerNetworkType=vismXgcpBearerNetworkType, vismSSRCEnable=vismSSRCEnable, ciscoVismModuleCompliance=ciscoVismModuleCompliance, vismMode=vismMode, ciscoVismDspGroup=ciscoVismDspGroup, vismCacEnable=vismCacEnable, vismConfigChangeTypeBitMap=vismConfigChangeTypeBitMap, ciscoVismSystemGroup=ciscoVismSystemGroup, vismAal2Type3Redundancy=vismAal2Type3Redundancy, vismVoIpNTECapabilityNegotiate=vismVoIpNTECapabilityNegotiate, vismOamLoopbackSetCLP=vismOamLoopbackSetCLP, vismJitterInitialDelay=vismJitterInitialDelay, vismContinuityCo1Timer=vismContinuityCo1Timer, vismSplModemToneBitMap=vismSplModemToneBitMap, vismCompCnfPacketSize=vismCompCnfPacketSize, vismDaughterCardDescription=vismDaughterCardDescription, ciscoVismDspGroupSup1=ciscoVismDspGroupSup1, vismCaleaEnable=vismCaleaEnable, vismXgcpBearerConnectionType=vismXgcpBearerConnectionType, vismVoIpTripleRedundancy=vismVoIpTripleRedundancy, vismAggregateSvcBandwidth=vismAggregateSvcBandwidth, ciscoVismModuleMIB=ciscoVismModuleMIB, vismVoIpCasTransport=vismVoIpCasTransport, vismEcanCnfIdlePattern=vismEcanCnfIdlePattern, vismFeatureBitMap=vismFeatureBitMap, vismDspGrp=vismDspGrp, vismPrevMode=vismPrevMode, vismTrapIntIndex2=vismTrapIntIndex2, vismDSPHeartbeat=vismDSPHeartbeat, vismAggregateTrafficClipping=vismAggregateTrafficClipping, vismXgcpBearerVCType=vismXgcpBearerVCType, vismSubNetMask=vismSubNetMask, vismLongDurationTimer=vismLongDurationTimer, vismFaxDeJitterMode=vismFaxDeJitterMode, vismVoIpVADTimer=vismVoIpVADTimer, vismContinuityCo2Timer=vismContinuityCo2Timer, vismSendDnEnable=vismSendDnEnable, vismDaughterCardHWRev=vismDaughterCardHWRev, vismSystemPerfStats=vismSystemPerfStats, vismVoIpDPvcOamCellGap=vismVoIpDPvcOamCellGap, ciscoVismVoIpGroup=ciscoVismVoIpGroup, vismAal2DtmfRelay=vismAal2DtmfRelay, vismSendDataGramSize=vismSendDataGramSize, vismRtpReceiveTimer=vismRtpReceiveTimer, ciscoVismModuleMIBConformance=ciscoVismModuleMIBConformance)
