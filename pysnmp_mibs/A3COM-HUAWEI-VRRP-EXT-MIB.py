...
h3cVrrpExtMibObject=_H3cVrrpExtMibObject_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,24,1))
_H3cVrrpExtTable_Object=MibTable
h3cVrrpExtTable=_H3cVrrpExtTable_Object((1,3,6,1,4,1,43,45,1,10,2,24,1,1))
if mibBuilder.loadTexts:h3cVrrpExtTable.setStatus(_A)
_H3cVrrpExtEntry_Object=MibTableRow
h3cVrrpExtEntry=_H3cVrrpExtEntry_Object((1,3,6,1,4,1,43,45,1,10,2,24,1,1,1))
...
h3cVrrpExtTrackInterface=_H3cVrrpExtTrackInterface_Object((1,3,6,1,4,1,43,45,1,10,2,24,1,1,1,1),_H3cVrrpExtTrackInterface_Type())
...
h3cVrrpExtPriorityReduce=_H3cVrrpExtPriorityReduce_Object((1,3,6,1,4,1,43,45,1,10,2,24,1,1,1,2),_H3cVrrpExtPriorityReduce_Type())
...
h3cVrrpExtRowStatus=_H3cVrrpExtRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,24,1,1,1,3),_H3cVrrpExtRowStatus_Type())
