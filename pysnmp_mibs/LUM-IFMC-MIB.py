...
SlotNumber, BoardOrInterfaceAdminStatus, BoardOrInterfaceOperStatus, MgmtNameString, PortNumber, SubrackNumber, FaultStatus = mibBuilder.importSymbols("LUM-TC", "SlotNumber", "BoardOrInterfaceAdminStatus", "BoardOrInterfaceOperStatus", "MgmtNameString", "PortNumber", "SubrackNumber", "FaultStatus")
...
mibBuilder.exportSymbols("LUM-IFMC-MIB", ifMcPortSubrack=ifMcPortSubrack, ifMcPortIndex=ifMcPortIndex, ifMcGeneralIfMcPortTableSize=ifMcGeneralIfMcPortTableSize, ifMcPortSlot=ifMcPortSlot, ifMcGeneralIfMcPortStateLastChangeTime=ifMcGeneralIfMcPortStateLastChangeTime, lumIfMcComplV3=lumIfMcComplV3, ifMcPortGroupV5=ifMcPortGroupV5, ifMcGeneralStateLastChangeTime=ifMcGeneralStateLastChangeTime, ifMcPortMpoCableType=ifMcPortMpoCableType, ifMcGeneralGroupV1=ifMcGeneralGroupV1, ifMcPortGroupV2=ifMcPortGroupV2, ifMcPortIfNo=ifMcPortIfNo, ifMcPortReceivedPowerLow=ifMcPortReceivedPowerLow, ifMcPortGroupV4=ifMcPortGroupV4, lumIfMcConfs=lumIfMcConfs, ifMcPortEntry=ifMcPortEntry, lumIfMcCompl=lumIfMcCompl, ifMcGeneralConfigLastChangeTime=ifMcGeneralConfigLastChangeTime, ifMcPortExpectedType=ifMcPortExpectedType, ifMcPortLossOfSignal=ifMcPortLossOfSignal, ifMcPortOperStatus=ifMcPortOperStatus, ifMcPortGroupV3=ifMcPortGroupV3, ifMcPortTable=ifMcPortTable, PYSNMP_MODULE_ID=lumIfMcMIBModule, ifMcPortName=ifMcPortName, ifMcPortAdminStatus=ifMcPortAdminStatus, lumIfMcComplV1=lumIfMcComplV1, ifMcPortDescr=ifMcPortDescr, lumIfMcGroups=lumIfMcGroups, ifMcGeneral=ifMcGeneral, ifMcGeneralIfMcPortConfigLastChangeTime=ifMcGeneralIfMcPortConfigLastChangeTime, ifMcPortTrxClass=ifMcPortTrxClass, ifMcPortIdx=ifMcPortIdx, ifMcPortGroupV1=ifMcPortGroupV1, lumIfMcComplV4=lumIfMcComplV4, ifMcPortList=ifMcPortList, lumIfMcMIBObjects=lumIfMcMIBObjects, IfMcMpoCableType=IfMcMpoCableType, lumIfMcComplV2=lumIfMcComplV2, IfMcExpectedType=IfMcExpectedType, lumIfMcMIBModule=lumIfMcMIBModule, lumIfMcComplV5=lumIfMcComplV5)
