_n='alaCfmDelayResultGroup'
_m='alaCfmMepGroup'
_l='alaCfmBaseGroup'
_k='alaCfmMepIfStatusTlv'
_j='alaCfmMepPortStatusTlv'
...
_D='Integer32'
_C='read-create'
_B='ALCATEL-ENT1-ETHERNET-OAM-MIB'
_A='current'
...
alcatelIND1CfmMIBObjects=_AlcatelIND1CfmMIBObjects_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,40,1,1))
if mibBuilder.loadTexts:alcatelIND1CfmMIBObjects.setStatus(_A)
_AlaCfmBase_ObjectIdentity=ObjectIdentity
alaCfmBase=_AlaCfmBase_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,1))
...
alaCfmGlobalClearStats=_AlaCfmGlobalClearStats_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,1,1),_AlaCfmGlobalClearStats_Type())
...
alaCfmGlobalOWDClear=_AlaCfmGlobalOWDClear_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,1,2),_AlaCfmGlobalOWDClear_Type())
...
alaCfmGlobalTWDClear=_AlaCfmGlobalTWDClear_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,1,3),_AlaCfmGlobalTWDClear_Type())
...
alaCfmMep=_AlaCfmMep_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2))
_AlaCfmMepTable_Object=MibTable
alaCfmMepTable=_AlaCfmMepTable_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1))
if mibBuilder.loadTexts:alaCfmMepTable.setStatus(_A)
_AlaCfmMepEntry_Object=MibTableRow
alaCfmMepEntry=_AlaCfmMepEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1))
...
alaCfmMepClearStats=_AlaCfmMepClearStats_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,1),_AlaCfmMepClearStats_Type())
...
alaCfmMepOWDTMacAddress=_AlaCfmMepOWDTMacAddress_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,2),_AlaCfmMepOWDTMacAddress_Type())
...
alaCfmMepOWDTRMepIdentifier=_AlaCfmMepOWDTRMepIdentifier_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,3),_AlaCfmMepOWDTRMepIdentifier_Type())
...
alaCfmMepOWDTPriority=_AlaCfmMepOWDTPriority_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,4),_AlaCfmMepOWDTPriority_Type())
...
alaCfmMepTWDTMacAddress=_AlaCfmMepTWDTMacAddress_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,5),_AlaCfmMepTWDTMacAddress_Type())
...
alaCfmMepTWDTRMepIdentifier=_AlaCfmMepTWDTRMepIdentifier_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,6),_AlaCfmMepTWDTRMepIdentifier_Type())
...
alaCfmMepTWDTPriority=_AlaCfmMepTWDTPriority_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,7),_AlaCfmMepTWDTPriority_Type())
...
alaCfmMepRFPEnabled=_AlaCfmMepRFPEnabled_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,8),_AlaCfmMepRFPEnabled_Type())
...
alaCfmMepPortStatusTlv=_AlaCfmMepPortStatusTlv_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,9),_AlaCfmMepPortStatusTlv_Type())
...
alaCfmMepIfStatusTlv=_AlaCfmMepIfStatusTlv_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,2,1,1,10),_AlaCfmMepIfStatusTlv_Type())
...
alaCfmDelayResult=_AlaCfmDelayResult_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,3))
_AlaCfmDelayResultTable_Object=MibTable
alaCfmDelayResultTable=_AlaCfmDelayResultTable_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,3,1))
if mibBuilder.loadTexts:alaCfmDelayResultTable.setStatus(_A)
_AlaCfmDelayResultEntry_Object=MibTableRow
alaCfmDelayResultEntry=_AlaCfmDelayResultEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,3,1,1))
...
alaCfmDelayResultType=_AlaCfmDelayResultType_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,3,1,1,1),_AlaCfmDelayResultType_Type())
...
alaCfmDelayResultRMepMacAddress=_AlaCfmDelayResultRMepMacAddress_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,3,1,1,2),_AlaCfmDelayResultRMepMacAddress_Type())
...
alaCfmDelayResultRMepIdentifier=_AlaCfmDelayResultRMepIdentifier_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,3,1,1,3),_AlaCfmDelayResultRMepIdentifier_Type())
...
alaCfmDelayResultTestDelay=_AlaCfmDelayResultTestDelay_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,3,1,1,4),_AlaCfmDelayResultTestDelay_Type())
...
alaCfmDelayResultVariation=_AlaCfmDelayResultVariation_Object((1,3,6,1,4,1,6486,801,1,2,1,40,1,1,3,1,1,5),_AlaCfmDelayResultVariation_Type())
...
alaCfmConformance=_AlaCfmConformance_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,40,1,2))
_AlaCfmGroups_ObjectIdentity=ObjectIdentity
alaCfmGroups=_AlaCfmGroups_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,40,1,2,1))
_AlaCfmCompliances_ObjectIdentity=ObjectIdentity
alaCfmCompliances=_AlaCfmCompliances_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,40,1,2,2))
dot1agCfmMepEntry.registerAugmentions((_B,_U))
alaCfmMepEntry.setIndexNames(*dot1agCfmMepEntry.getIndexNames())
alaCfmBaseGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,40,1,2,1,1))
alaCfmBaseGroup.setObjects(*((_B,_V),(_B,_W),(_B,_X)))
if mibBuilder.loadTexts:alaCfmBaseGroup.setStatus(_A)
alaCfmMepGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,40,1,2,1,2))
...
alaCfmDelayResultGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,40,1,2,1,3))
alaCfmDelayResultGroup.setObjects(*((_B,_g),(_B,_h),(_B,_i)))
if mibBuilder.loadTexts:alaCfmDelayResultGroup.setStatus(_A)
alaTlvGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,40,1,2,1,4))
alaTlvGroup.setObjects(*((_B,_j),(_B,_k)))
if mibBuilder.loadTexts:alaTlvGroup.setStatus(_A)
alaCfmCompliance=ModuleCompliance((1,3,6,1,4,1,6486,801,1,2,1,40,1,2,2,1))
alaCfmCompliance.setObjects(*((_B,_l),(_B,_m),(_B,_n)))
if mibBuilder.loadTexts:alaCfmCompliance.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'alcatelIND1EoamMIB':alcatelIND1EoamMIB,'alcatelIND1CfmMIBObjects':alcatelIND1CfmMIBObjects,'alaCfmBase':alaCfmBase,_V:alaCfmGlobalClearStats,_W:alaCfmGlobalOWDClear,_X:alaCfmGlobalTWDClear,'alaCfmMep':alaCfmMep,'alaCfmMepTable':alaCfmMepTable,_U:alaCfmMepEntry,_Y:alaCfmMepClearStats,_Z:alaCfmMepOWDTMacAddress,_a:alaCfmMepOWDTRMepIdentifier,_b:alaCfmMepOWDTPriority,_c:alaCfmMepTWDTMacAddress,_d:alaCfmMepTWDTRMepIdentifier,_e:alaCfmMepTWDTPriority,_f:alaCfmMepRFPEnabled,_j:alaCfmMepPortStatusTlv,_k:alaCfmMepIfStatusTlv,'alaCfmDelayResult':alaCfmDelayResult,'alaCfmDelayResultTable':alaCfmDelayResultTable,'alaCfmDelayResultEntry':alaCfmDelayResultEntry,_Q:alaCfmDelayResultType,_R:alaCfmDelayResultRMepMacAddress,_g:alaCfmDelayResultRMepIdentifier,_h:alaCfmDelayResultTestDelay,_i:alaCfmDelayResultVariation,'alaCfmConformance':alaCfmConformance,'alaCfmGroups':alaCfmGroups,_l:alaCfmBaseGroup,_m:alaCfmMepGroup,_n:alaCfmDelayResultGroup,'alaTlvGroup':alaTlvGroup,'alaCfmCompliances':alaCfmCompliances,'alaCfmCompliance':alaCfmCompliance})