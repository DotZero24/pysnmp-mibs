...
# Notes
# -----
# ASN.1 source file://mibs/force10/F10-ISIS-MIB
...
_F10IsisSysOloadSetOverload_Type.__name__ = "TruthValue"
...
_F10IsisSysOloadV6SetOverload_Type.__name__ = "TruthValue"
...
f10IsisCompliance.setObjects(
      *(("F10-ISIS-MIB", "f10IsisSystemGroup"),
        ("F10-ISIS-MIB", "f10IsisNotificationGroup"))
)
if mibBuilder.loadTexts:
