...
nbSwitchG1Il, MepList = mibBuilder.importSymbols("OS-COMMON-TC-MIB", "nbSwitchG1Il", "MepList")
...
mibBuilder.exportSymbols("OA-ETHERNET-OAM-MIB", nbEthOamDmHcLastRttAverage=nbEthOamDmHcLastRttAverage, nbEthOamDmLastType=nbEthOamDmLastType, nbEthOamLbLastRttMax=nbEthOamLbLastRttMax, nbEthOamDmHcLastSDJittSum2=nbEthOamDmHcLastSDJittSum2, nbEthOamTrapCcmHighestPrDefect=nbEthOamTrapCcmHighestPrDefect, TestRunMethod=TestRunMethod, nbEthOamLbHistJittMin=nbEthOamLbHistJittMin, nbEthOamLbHistRttAverage=nbEthOamLbHistRttAverage, nbEthOamFdAlarm=nbEthOamFdAlarm, nbEthOamDSJittAlarm=nbEthOamDSJittAlarm, nbEthOamDmHcHistRttSum2=nbEthOamDmHcHistRttSum2, nbEthOamCapabilities=nbEthOamCapabilities, nbEthOamLbConfMessages=nbEthOamLbConfMessages, nbEthOamDmLastRttMax=nbEthOamDmLastRttMax, nbEthOamLbHistJittNumber=nbEthOamLbHistJittNumber, nbEthOamDSJittRiseThold=nbEthOamDSJittRiseThold, nbEthOamDmHistSDJittAverage=nbEthOamDmHistSDJittAverage, nbEthOamServiceLmResponderSL=nbEthOamServiceLmResponderSL, nbEthOamDmLastDSJittAverage=nbEthOamDmLastDSJittAverage, nbEthOamLbHistPcktLoss=nbEthOamLbHistPcktLoss, nbEthOamDmHcHistSDJittSum2=nbEthOamDmHcHistSDJittSum2, nbEthOamLbConfDestIsMepId=nbEthOamLbConfDestIsMepId, nbEthOamDSJittFallThold=nbEthOamDSJittFallThold, nbEthOamLbLastRttAverage=nbEthOamLbLastRttAverage, nbEthOamDmHcLastRttMin=nbEthOamDmHcLastRttMin, nbEthOamDmHistRttAverage=nbEthOamDmHistRttAverage, nbEthOamDmConfExtTable=nbEthOamDmConfExtTable, nbEthOamDmLastPcktLoss=nbEthOamDmLastPcktLoss, nbEthOamDmConfExtEntry=nbEthOamDmConfExtEntry, nbEthOamDmHcHistDSJittMin=nbEthOamDmHcHistDSJittMin, nbEthOamDmLastStarted=nbEthOamDmLastStarted, nbEthOamDmHcLastEntry=nbEthOamDmHcLastEntry, nbEthOamDmLastTable=nbEthOamDmLastTable, nbEthOamCcmIntervals=nbEthOamCcmIntervals, nbEthOamLbLastMsgTransmitted=nbEthOamLbLastMsgTransmitted, nbEthOamDmHistSDJittIA=nbEthOamDmHistSDJittIA, nbEthOamLbConfTable=nbEthOamLbConfTable, nbEthOamLbHistRttSum2=nbEthOamLbHistRttSum2, nbEthOamLbConfRunMethod=nbEthOamLbConfRunMethod, nbEthOamLbConfIntervalMicro=nbEthOamLbConfIntervalMicro, nbEthOamNotifications=nbEthOamNotifications, nbEthOamMIBCompliance=nbEthOamMIBCompliance, nbEthOamDmHcLastDSJittAverage=nbEthOamDmHcLastDSJittAverage, nbEthOamLbHistJittMax=nbEthOamLbHistJittMax, nbEthOamDmHcLastRunStatus=nbEthOamDmHcLastRunStatus, nbEthOamDmConfRunMethod=nbEthOamDmConfRunMethod, nbEthOamDmConfDestMepId=nbEthOamDmConfDestMepId, nbEthOamLbHistType=nbEthOamLbHistType, nbEthOamDmHistTable=nbEthOamDmHistTable, nbEthOamDmHcHistDSJittMax=nbEthOamDmHcHistDSJittMax, nbEthOamDmConfDestIsMepId=nbEthOamDmConfDestIsMepId, nbEthOamDmHistType=nbEthOamDmHistType, nbEthOamFdRiseThold=nbEthOamFdRiseThold, nbEthOamDmLastSDJittMin=nbEthOamDmLastSDJittMin, nbEthOamDmLastRttSum2=nbEthOamDmLastRttSum2, nbEthOamDmHcHistRttMin=nbEthOamDmHcHistRttMin, nbEthOamLbLastMsgReceived=nbEthOamLbLastMsgReceived, nbEthOamDmHcHistEntry=nbEthOamDmHcHistEntry, nbEthOamDmHistMsgReceived=nbEthOamDmHistMsgReceived, nbEthOamDSJittSum2FallThold=nbEthOamDSJittSum2FallThold, nbEthOamLbLastRttSum2=nbEthOamLbLastRttSum2, nbEthOamDSJittSum2RiseThold=nbEthOamDSJittSum2RiseThold, nbEthOamDmLastRttMin=nbEthOamDmLastRttMin, nbEthOamLbConfDestMepList=nbEthOamLbConfDestMepList, nbEthOamFeaturesSupport=nbEthOamFeaturesSupport, nbEthOamDmLastEntry=nbEthOamDmLastEntry, nbEthOamLbConfExtTable=nbEthOamLbConfExtTable, nbEthOamDmHistRttMax=nbEthOamDmHistRttMax, nbEthOamDmHcLastSDJittMax=nbEthOamDmHcLastSDJittMax, nbEthOamSDJittAlarm=nbEthOamSDJittAlarm, nbEthOamDmHcHistRttMax=nbEthOamDmHcHistRttMax, nbEthOamDmHistRttSum2=nbEthOamDmHistRttSum2, nbEthOamDmHistDSJittNumber=nbEthOamDmHistDSJittNumber, nbEthOamTrapTable=nbEthOamTrapTable, nbEthOamLbConfInterval=nbEthOamLbConfInterval, nbEthOamLbConfTimeout=nbEthOamLbConfTimeout, nbEthOamLbLastEntry=nbEthOamLbLastEntry, nbEthOamLbLastStarted=nbEthOamLbLastStarted, nbEthOamDmLastDestMepMac=nbEthOamDmLastDestMepMac, nbEthOamDmLastDSJittNumber=nbEthOamDmLastDSJittNumber, nbEthOamTrapTrapGeneration=nbEthOamTrapTrapGeneration, nbEthOamLbConfPriority=nbEthOamLbConfPriority, nbEthOamDmConfDataFill=nbEthOamDmConfDataFill, nbEthOamDmConfIntervalMicro=nbEthOamDmConfIntervalMicro, nbEthOamDmConfPriority=nbEthOamDmConfPriority, nbEthOamDmConfDestMepMac=nbEthOamDmConfDestMepMac, nbEthOamLbHistMsgTransmitted=nbEthOamLbHistMsgTransmitted, nbEthOamLbConfExtEntry=nbEthOamLbConfExtEntry, nbEthOamDmLastPriority=nbEthOamDmLastPriority, nbEthOamLbLastJittSum2=nbEthOamLbLastJittSum2, nbEthOamDmHcLastDSJittIA=nbEthOamDmHcLastDSJittIA, nbEthOamDmHcLastSDJittMin=nbEthOamDmHcLastSDJittMin, nbEthOamLbLastDestMepId=nbEthOamLbLastDestMepId, nbEthOamDmLastSDJittAverage=nbEthOamDmLastSDJittAverage, nbEthOamLbHistJittIA=nbEthOamLbHistJittIA, nbEthOamLbHistJittSum2=nbEthOamLbHistJittSum2, nbEthOamDmHistDSJittAverage=nbEthOamDmHistDSJittAverage, nbEthOamDm=nbEthOamDm, nbEthOamDmHistPriority=nbEthOamDmHistPriority, nbEthOamDmHcLastDSJittMax=nbEthOamDmHcLastDSJittMax, nbEthOamLbHistRttMin=nbEthOamLbHistRttMin, nbEthOamDmHistSDJittNumber=nbEthOamDmHistSDJittNumber, nbEthOamLbConfBurstInterval=nbEthOamLbConfBurstInterval, nbEthOamDmLastSDJittIA=nbEthOamDmLastSDJittIA, nbEthOamDmHcHistRttAverage=nbEthOamDmHcHistRttAverage, nbEthOamTrapEntry=nbEthOamTrapEntry, nbEthOamDmLastSDJittSum2=nbEthOamDmLastSDJittSum2, nbEthOamDmHcHistDSJittIA=nbEthOamDmHcHistDSJittIA, nbEthOamLbHistDestMepId=nbEthOamLbHistDestMepId, nbEthOamLb=nbEthOamLb, nbEthOamTrapCcmAlarmType=nbEthOamTrapCcmAlarmType, nbEthOamLbConfDataFill=nbEthOamLbConfDataFill, nbEthOamDmHcLastTable=nbEthOamDmHcLastTable, nbEthOamLbHistStarted=nbEthOamLbHistStarted, nbEthOamDmConfBurstInterval=nbEthOamDmConfBurstInterval, nbEthOamDmLastDSJittMin=nbEthOamDmLastDSJittMin, nbEthOamMandatoryGroup=nbEthOamMandatoryGroup, nbEthOamLbConfDestMepMac=nbEthOamLbConfDestMepMac, nbEthOamServiceDmResponderSL=nbEthOamServiceDmResponderSL, nbEthOamLbHistEntry=nbEthOamLbHistEntry, nbEthOamMIBCompliances=nbEthOamMIBCompliances, nbEthOamDmLastRttAverage=nbEthOamDmLastRttAverage, nbEthOamLbLastRttMin=nbEthOamLbLastRttMin, nbEthOamDmHcLastRttMax=nbEthOamDmHcLastRttMax, nbEthOamLbConfHistorySize=nbEthOamLbConfHistorySize, nbEthOamLbHistDestMepMac=nbEthOamLbHistDestMepMac, nbEthOamDmHcHistSDJittIA=nbEthOamDmHcHistSDJittIA, nbEthOamDmConfTable=nbEthOamDmConfTable, nbEthOamDmConfDestMepList=nbEthOamDmConfDestMepList, nbEthOamDmHistDSJittMin=nbEthOamDmHistDSJittMin, nbEthOamLbHistMsgReceived=nbEthOamLbHistMsgReceived, nbEthOamDmHistDSJittSum2=nbEthOamDmHistDSJittSum2, nbEthOamDmLastMsgTransmitted=nbEthOamDmLastMsgTransmitted, nbEthOamDmHistDSJittMax=nbEthOamDmHistDSJittMax, nbEthOamDmHcHistSDJittMin=nbEthOamDmHcHistSDJittMin, nbEthOamNotificationsGroup=nbEthOamNotificationsGroup, nbEthOamDmHistRttMin=nbEthOamDmHistRttMin, nbEthOamCcmAlarm=nbEthOamCcmAlarm, nbEthOamLbLastTable=nbEthOamLbLastTable, nbEthOamLbLastDestMepMac=nbEthOamLbLastDestMepMac, nbEthOamDmHistDestMepId=nbEthOamDmHistDestMepId, nbEthOamLbLastHistIndx=nbEthOamLbLastHistIndx, nbEthOamSDJittSum2RiseThold=nbEthOamSDJittSum2RiseThold, nbEthOamDmHistSDJittMax=nbEthOamDmHistSDJittMax, DestinationType=DestinationType, nbEthOamSDJittSum2FallThold=nbEthOamSDJittSum2FallThold, nbEthOamLbLastJittIA=nbEthOamLbLastJittIA, nbEthOamTrapDmmReason=nbEthOamTrapDmmReason, nbEthOamFdFallThold=nbEthOamFdFallThold, nbEthOamLbHistRttMax=nbEthOamLbHistRttMax, NbEthOamMepIdOrZero=NbEthOamMepIdOrZero, nbEthOamDmHcLastSDJittIA=nbEthOamDmHcLastSDJittIA, nbEthOamServiceEntry=nbEthOamServiceEntry, nbEthOamMIBGroups=nbEthOamMIBGroups, nbEthOamDmLastMsgReceived=nbEthOamDmLastMsgReceived, nbEthOamDmHistSDJittSum2=nbEthOamDmHistSDJittSum2, nbEthOamDmLastDSJittIA=nbEthOamDmLastDSJittIA, nbEthOamDmHcHistSDJittAverage=nbEthOamDmHcHistSDJittAverage, nbEthOamDmHistSDJittMin=nbEthOamDmHistSDJittMin, nbEthOamLbLastPriority=nbEthOamLbLastPriority, nbEthOamDmConfMessages=nbEthOamDmConfMessages, nbEthOamDmConfHistorySize=nbEthOamDmConfHistorySize, nbEthOamDmHcLastRttSum2=nbEthOamDmHcLastRttSum2, nbEthOamDmLastDSJittMax=nbEthOamDmLastDSJittMax, nbEthOamDmHcHistSDJittMax=nbEthOamDmHcHistSDJittMax, nbEthOamDmHcHistTable=nbEthOamDmHcHistTable, nbEthOamLbLastJittMin=nbEthOamLbLastJittMin, nbEthOamMepIdentifier=nbEthOamMepIdentifier, NbEthOamCcmHighestDefectPri=NbEthOamCcmHighestDefectPri, nbEthOamDmHistDestMepMac=nbEthOamDmHistDestMepMac, nbEthOamServiceLbResponderSL=nbEthOamServiceLbResponderSL, nbEthOam=nbEthOam, nbEthOamLbHistPriority=nbEthOamLbHistPriority, nbEthOamConformance=nbEthOamConformance, nbEthOamDmHcLastDSJittSum2=nbEthOamDmHcLastDSJittSum2, nbEthOamSDJittFallThold=nbEthOamSDJittFallThold, nbEthOamLbHistSampleIndex=nbEthOamLbHistSampleIndex, nbEthOamDmConfInterval=nbEthOamDmConfInterval, nbEthOamDmLastSDJittNumber=nbEthOamDmLastSDJittNumber, nbEthOamPcktLossAlarm=nbEthOamPcktLossAlarm, nbEthOamLbHistJittAverage=nbEthOamLbHistJittAverage, nbEthOamLbLastType=nbEthOamLbLastType, nbEthOamDmConfDataLength=nbEthOamDmConfDataLength, nbEthOamDmLastSDJittMax=nbEthOamDmLastSDJittMax, nbEthOamDmHistStarted=nbEthOamDmHistStarted, nbEthOamDmHistDSJittIA=nbEthOamDmHistDSJittIA, nbEthOamDmHcHistDSJittAverage=nbEthOamDmHcHistDSJittAverage, nbEthOamDmLastDestMepId=nbEthOamDmLastDestMepId, nbEthOamLbConfEntry=nbEthOamLbConfEntry, nbEthOamDmHistPcktLoss=nbEthOamDmHistPcktLoss, nbEthOamDmHcLastSDJittAverage=nbEthOamDmHcLastSDJittAverage, nbEthOamLbConfDestMepId=nbEthOamLbConfDestMepId, nbEthOamDmLastHistIndx=nbEthOamDmLastHistIndx, nbEthOamDmHistSampleIndex=nbEthOamDmHistSampleIndex, nbEthOamServiceTable=nbEthOamServiceTable, nbEthOamSDJittRiseThold=nbEthOamSDJittRiseThold, nbEthOamLbConfNumberOfBursts=nbEthOamLbConfNumberOfBursts, nbEthOamLbLastJittAverage=nbEthOamLbLastJittAverage, nbEthOamLbLastPcktLoss=nbEthOamLbLastPcktLoss, nbEthOamPcktLossRiseThold=nbEthOamPcktLossRiseThold, PYSNMP_MODULE_ID=nbEthOam, nbEthOamDmHistEntry=nbEthOamDmHistEntry, nbEthOamLbConfDataLength=nbEthOamLbConfDataLength, nbEthOamDmConfNumberOfBursts=nbEthOamDmConfNumberOfBursts, nbEthOamLbLastJittNumber=nbEthOamLbLastJittNumber, nbEthOamDmHistMsgTransmitted=nbEthOamDmHistMsgTransmitted, NbEthOamMepId=NbEthOamMepId, nbEthOamDmConfTimeout=nbEthOamDmConfTimeout, nbEthOamMaIndex=nbEthOamMaIndex, nbEthOamDmConfEntry=nbEthOamDmConfEntry, nbEthOamPcktLossFallThold=nbEthOamPcktLossFallThold, nbEthOamLbHistTable=nbEthOamLbHistTable, nbEthOamLbLastJittMax=nbEthOamLbLastJittMax, nbEthOamDmHcLastDSJittMin=nbEthOamDmHcLastDSJittMin, nbEthOamMdIndex=nbEthOamMdIndex, nbEthOamDmLastDSJittSum2=nbEthOamDmLastDSJittSum2, nbEthOamDmHcHistDSJittSum2=nbEthOamDmHcHistDSJittSum2)
