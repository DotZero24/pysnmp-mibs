# SNMP MIB module (GMPLS-TC-STD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/rfc/GMPLS-TC-STD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:23:13 2025
...
gmplsTCStdMIB = ModuleIdentity(
    (1, 3, 6, 1, 2, 1, 10, 166, 12)
)
if mibBuilder.loadTexts:
    gmplsTCStdMIB.setRevisions(
        ("2007-02-28 00:00",)
    )
...
mibBuilder.exportSymbols(
    "GMPLS-TC-STD-MIB",
    **{"GmplsFreeformLabelTC": GmplsFreeformLabelTC,
       "GmplsLabelTypeTC": GmplsLabelTypeTC,
       "GmplsSegmentDirectionTC": GmplsSegmentDirectionTC,
       "gmplsTCStdMIB": gmplsTCStdMIB}
)
