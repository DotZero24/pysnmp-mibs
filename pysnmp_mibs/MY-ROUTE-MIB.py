...
ConfigStatus,IfIndex=mibBuilder.importSymbols('MY-TC',_i,'IfIndex')
...
myRouteMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,20))
...
myRouteMIBObjects=_MyRouteMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,20,1))
_MyRouteServiceStatus_Type=EnabledStatus
_MyRouteServiceStatus_Object=MibScalar
myRouteServiceStatus=_MyRouteServiceStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,1),_MyRouteServiceStatus_Type())
...
myRoutingProtoInfoTable=_MyRoutingProtoInfoTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,2))
if mibBuilder.loadTexts:myRoutingProtoInfoTable.setStatus(_B)
_MyRoutingProtoInfoEntry_Object=MibTableRow
myRoutingProtoInfoEntry=_MyRoutingProtoInfoEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,2,1))
...
myRoutingProtoInfoProtoType=_MyRoutingProtoInfoProtoType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,2,1,1),_MyRoutingProtoInfoProtoType_Type())
...
myRoutingProtoInfoGateWay=_MyRoutingProtoInfoGateWay_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,2,1,2),_MyRoutingProtoInfoGateWay_Type())
...
myRoutingProtoInfoDistance=_MyRoutingProtoInfoDistance_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,2,1,3),_MyRoutingProtoInfoDistance_Type())
...
myRoutingProtoInfoLastUpdate=_MyRoutingProtoInfoLastUpdate_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,2,1,4),_MyRoutingProtoInfoLastUpdate_Type())
...
myDefRoutingCfgTable=_MyDefRoutingCfgTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,3))
if mibBuilder.loadTexts:myDefRoutingCfgTable.setStatus(_B)
_MyDefRoutingCfgEntry_Object=MibTableRow
myDefRoutingCfgEntry=_MyDefRoutingCfgEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,3,1))
...
myDefRoutingCfgRoutingProtoType=_MyDefRoutingCfgRoutingProtoType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,3,1,1),_MyDefRoutingCfgRoutingProtoType_Type())
...
myDefRoutingCfgAlways=_MyDefRoutingCfgAlways_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,3,1,2),_MyDefRoutingCfgAlways_Type())
...
myDefRoutingCfgMetric=_MyDefRoutingCfgMetric_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,3,1,3),_MyDefRoutingCfgMetric_Type())
...
myDefRoutingCfgMetricType=_MyDefRoutingCfgMetricType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,3,1,4),_MyDefRoutingCfgMetricType_Type())
...
myDefRoutingCfgRouteMap=_MyDefRoutingCfgRouteMap_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,3,1,5),_MyDefRoutingCfgRouteMap_Type())
...
myDefRoutingCfgStatus=_MyDefRoutingCfgStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,1,3,1,6),_MyDefRoutingCfgStatus_Type())
...
myRouteMapMIBObjects=_MyRouteMapMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,20,2))
_MyRouteMapTable_Object=MibTable
myRouteMapTable=_MyRouteMapTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1))
if mibBuilder.loadTexts:myRouteMapTable.setStatus(_B)
_MyRouteMapEntry_Object=MibTableRow
myRouteMapEntry=_MyRouteMapEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1))
...
myRouteMapName=_MyRouteMapName_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,1),_MyRouteMapName_Type())
...
myRouteMapSequenceNumber=_MyRouteMapSequenceNumber_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,2),_MyRouteMapSequenceNumber_Type())
...
myRouteMapOperType=_MyRouteMapOperType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,3),_MyRouteMapOperType_Type())
...
myRouteMapMatchMetric=_MyRouteMapMatchMetric_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,4),_MyRouteMapMatchMetric_Type())
...
myRouteMapMatchRouteType=_MyRouteMapMatchRouteType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,5),_MyRouteMapMatchRouteType_Type())
...
myRouteMapMetricValueType=_MyRouteMapMetricValueType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,6),_MyRouteMapMetricValueType_Type())
...
myRouteMapSetMetric=_MyRouteMapSetMetric_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,7),_MyRouteMapSetMetric_Type())
...
myRouteMapSetLevel=_MyRouteMapSetLevel_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,8),_MyRouteMapSetLevel_Type())
...
myRouteMapSetMetricType=_MyRouteMapSetMetricType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,9),_MyRouteMapSetMetricType_Type())
...
myRouteMapSetNexthopSt=_MyRouteMapSetNexthopSt_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,10),_MyRouteMapSetNexthopSt_Type())
...
myRouteMapSetNexthop=_MyRouteMapSetNexthop_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,11),_MyRouteMapSetNexthop_Type())
...
myRouteMapStatus=_MyRouteMapStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,1,1,12),_MyRouteMapStatus_Type())
...
myRouteMapMatchIpAddressTable=_MyRouteMapMatchIpAddressTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,2))
if mibBuilder.loadTexts:myRouteMapMatchIpAddressTable.setStatus(_B)
_MyRouteMapMatchIpAddressEntry_Object=MibTableRow
myRouteMapMatchIpAddressEntry=_MyRouteMapMatchIpAddressEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,2,1))
...
myRouteMapMatchType=_MyRouteMapMatchType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,2,1,1),_MyRouteMapMatchType_Type())
...
myRouteMapMatchIpAddressAclName=_MyRouteMapMatchIpAddressAclName_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,2,1,2),_MyRouteMapMatchIpAddressAclName_Type())
...
myRouteMapMatchIpAddressStatus=_MyRouteMapMatchIpAddressStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,2,1,3),_MyRouteMapMatchIpAddressStatus_Type())
...
myRouteMapMatchTagTable=_MyRouteMapMatchTagTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,3))
if mibBuilder.loadTexts:myRouteMapMatchTagTable.setStatus(_B)
_MyRouteMapMatchTagEntry_Object=MibTableRow
myRouteMapMatchTagEntry=_MyRouteMapMatchTagEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,3,1))
...
myRouteMapMatchTagValue=_MyRouteMapMatchTagValue_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,3,1,1),_MyRouteMapMatchTagValue_Type())
...
myRouteMapMatchTagStatus=_MyRouteMapMatchTagStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,3,1,2),_MyRouteMapMatchTagStatus_Type())
...
myRouteMapMatchInterfaceTable=_MyRouteMapMatchInterfaceTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,4))
if mibBuilder.loadTexts:myRouteMapMatchInterfaceTable.setStatus(_B)
_MyRouteMapMatchInterfaceEntry_Object=MibTableRow
myRouteMapMatchInterfaceEntry=_MyRouteMapMatchInterfaceEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,4,1))
...
myRouteMapMatchInterfaceIfIndex=_MyRouteMapMatchInterfaceIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,4,1,1),_MyRouteMapMatchInterfaceIfIndex_Type())
...
myRouteMapMatchInterfaceStatus=_MyRouteMapMatchInterfaceStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,2,4,1,2),_MyRouteMapMatchInterfaceStatus_Type())
...
myRouteRedistributeMIBObjects=_MyRouteRedistributeMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,20,3))
_MyRouteRedistributeTable_Object=MibTable
myRouteRedistributeTable=_MyRouteRedistributeTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,3,1))
if mibBuilder.loadTexts:myRouteRedistributeTable.setStatus(_B)
_MyRouteRedistributeEntry_Object=MibTableRow
myRouteRedistributeEntry=_MyRouteRedistributeEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,3,1,1))
...
myRouteRedistributeProtocolCfg=_MyRouteRedistributeProtocolCfg_Object((1,3,6,1,4,1,4881,1,1,10,2,20,3,1,1,1),_MyRouteRedistributeProtocolCfg_Type())
...
myRouteRedistributeProtocol=_MyRouteRedistributeProtocol_Object((1,3,6,1,4,1,4881,1,1,10,2,20,3,1,1,2),_MyRouteRedistributeProtocol_Type())
...
myRouteRedistributeMetricValue=_MyRouteRedistributeMetricValue_Object((1,3,6,1,4,1,4881,1,1,10,2,20,3,1,1,3),_MyRouteRedistributeMetricValue_Type())
...
myRouteRedistributeMetricType=_MyRouteRedistributeMetricType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,3,1,1,4),_MyRouteRedistributeMetricType_Type())
...
myRouteRedistributeTagValue=_MyRouteRedistributeTagValue_Object((1,3,6,1,4,1,4881,1,1,10,2,20,3,1,1,5),_MyRouteRedistributeTagValue_Type())
...
myRouteRedistributeRouteMapName=_MyRouteRedistributeRouteMapName_Object((1,3,6,1,4,1,4881,1,1,10,2,20,3,1,1,6),_MyRouteRedistributeRouteMapName_Type())
...
myRouteRedistributeStatus=_MyRouteRedistributeStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,3,1,1,7),_MyRouteRedistributeStatus_Type())
...
myRouteFilteringMIBObjects=_MyRouteFilteringMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,20,4))
_MyIpPrefixListTable_Object=MibTable
myIpPrefixListTable=_MyIpPrefixListTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1))
if mibBuilder.loadTexts:myIpPrefixListTable.setStatus(_B)
_MyIpPrefixListEntry_Object=MibTableRow
myIpPrefixListEntry=_MyIpPrefixListEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1,1))
...
myIpPrefixListName=_MyIpPrefixListName_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1,1,1),_MyIpPrefixListName_Type())
...
myIpPrefixListSequence=_MyIpPrefixListSequence_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1,1,2),_MyIpPrefixListSequence_Type())
...
myIpPrefixListOperMethod=_MyIpPrefixListOperMethod_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1,1,3),_MyIpPrefixListOperMethod_Type())
...
myIpPrefixListIpAddress=_MyIpPrefixListIpAddress_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1,1,4),_MyIpPrefixListIpAddress_Type())
...
myIpPrefixListMaskLength=_MyIpPrefixListMaskLength_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1,1,5),_MyIpPrefixListMaskLength_Type())
...
myIpPrefixListMinimumPrefixLength=_MyIpPrefixListMinimumPrefixLength_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1,1,6),_MyIpPrefixListMinimumPrefixLength_Type())
...
myIpPrefixListMaximumPrefixLength=_MyIpPrefixListMaximumPrefixLength_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1,1,7),_MyIpPrefixListMaximumPrefixLength_Type())
...
myIpPrefixListStatus=_MyIpPrefixListStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,1,1,8),_MyIpPrefixListStatus_Type())
...
myDistributeListTable=_MyDistributeListTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2))
if mibBuilder.loadTexts:myDistributeListTable.setStatus(_B)
_MyDistributeListEntry_Object=MibTableRow
myDistributeListEntry=_MyDistributeListEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1))
...
myDistributeListCfgProtoType=_MyDistributeListCfgProtoType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1,1),_MyDistributeListCfgProtoType_Type())
...
myDistributeListIfIndex=_MyDistributeListIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1,2),_MyDistributeListIfIndex_Type())
...
myDistributeListDirection=_MyDistributeListDirection_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1,3),_MyDistributeListDirection_Type())
...
myDistributeListFilteringProtocol=_MyDistributeListFilteringProtocol_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1,4),_MyDistributeListFilteringProtocol_Type())
...
myDistributeListFilterType=_MyDistributeListFilterType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1,5),_MyDistributeListFilterType_Type())
...
myDistributeListAclName=_MyDistributeListAclName_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1,6),_MyDistributeListAclName_Type())
...
myDistributeListGateWayIpPrefixName=_MyDistributeListGateWayIpPrefixName_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1,7),_MyDistributeListGateWayIpPrefixName_Type())
...
myDistributeListPrefixIpPrefixName=_MyDistributeListPrefixIpPrefixName_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1,8),_MyDistributeListPrefixIpPrefixName_Type())
...
myDistributeListStatus=_MyDistributeListStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,4,2,1,9),_MyDistributeListStatus_Type())
...
myipCidrRouteExtendMIBObjects=_MyipCidrRouteExtendMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,20,5))
_MyipCidrRouteTable_Object=MibTable
myipCidrRouteTable=_MyipCidrRouteTable_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1))
if mibBuilder.loadTexts:myipCidrRouteTable.setStatus(_B)
_MyipCidrRouteEntry_Object=MibTableRow
myipCidrRouteEntry=_MyipCidrRouteEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1))
...
myipCidrRouteDest=_MyipCidrRouteDest_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,1),_MyipCidrRouteDest_Type())
...
myipCidrRouteMask=_MyipCidrRouteMask_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,2),_MyipCidrRouteMask_Type())
...
myipCidrRouteTos=_MyipCidrRouteTos_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,3),_MyipCidrRouteTos_Type())
...
myipCidrRouteNextHop=_MyipCidrRouteNextHop_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,4),_MyipCidrRouteNextHop_Type())
...
myipCidrRouteIfIndex=_MyipCidrRouteIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,5),_MyipCidrRouteIfIndex_Type())
...
myipCidrRouteType=_MyipCidrRouteType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,6),_MyipCidrRouteType_Type())
...
myipCidrRouteProto=_MyipCidrRouteProto_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,7),_MyipCidrRouteProto_Type())
...
myipCidrRouteAge=_MyipCidrRouteAge_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,8),_MyipCidrRouteAge_Type())
...
myipCidrRouteInfo=_MyipCidrRouteInfo_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,9),_MyipCidrRouteInfo_Type())
...
myipCidrRouteNextHopAS=_MyipCidrRouteNextHopAS_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,10),_MyipCidrRouteNextHopAS_Type())
...
myipCidrRouteMetric1=_MyipCidrRouteMetric1_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,11),_MyipCidrRouteMetric1_Type())
...
myipCidrRouteMetric2=_MyipCidrRouteMetric2_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,12),_MyipCidrRouteMetric2_Type())
...
myipCidrRouteMetric3=_MyipCidrRouteMetric3_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,13),_MyipCidrRouteMetric3_Type())
...
myipCidrRouteMetric4=_MyipCidrRouteMetric4_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,14),_MyipCidrRouteMetric4_Type())
...
myipCidrRouteMetric5=_MyipCidrRouteMetric5_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,15),_MyipCidrRouteMetric5_Type())
...
myipCidrRouteStatus=_MyipCidrRouteStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,16),_MyipCidrRouteStatus_Type())
...
myipCidrOspfRouteType=_MyipCidrOspfRouteType_Object((1,3,6,1,4,1,4881,1,1,10,2,20,5,1,1,17),_MyipCidrOspfRouteType_Type())
...
myRouteMIBConformance=_MyRouteMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,20,6))
_MyRouteMIBCompliances_ObjectIdentity=ObjectIdentity
myRouteMIBCompliances=_MyRouteMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,20,6,1))
_MyRouteMIBGroups_ObjectIdentity=ObjectIdentity
myRouteMIBGroups=_MyRouteMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,20,6,2))
myRouteMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,20,6,2,1))
myRouteMIBGroup.setObjects((_A,_p))
if mibBuilder.loadTexts:myRouteMIBGroup.setStatus(_B)
myRouteInfoMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,20,6,2,2))
...
myRouteMapMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,20,6,2,3))
...
myRouteRedistributeMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,20,6,2,4))
...
myRouteFilteringMibGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,20,6,2,5))
...
myipCidrRouteMibGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,20,6,2,6))
...
myRouteMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,20,6,1,1))
