# SNMP MIB module (Dell-MIR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-MIR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:43 2025
...
rlMirInterfaceEntry.setIndexNames(
    (0, "Dell-MIR-MIB", "rlMirInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
rlMirVlanBaseReservedPortsEntry.setIndexNames(
    (0, "Dell-MIR-MIB", "rlMirVlanBaseReservedPortsIfIndex"),
)
if mibBuilder.loadTexts:
...
rlMirVlanBaseLogicalPortsEntry.setIndexNames(
    (0, "Dell-MIR-MIB", "rlMirVlanBaseLogicalPortsIfIndex"),
)
if mibBuilder.loadTexts:
