...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-WAN-BBIF-ILMI-MIB
...
mibBuilder.exportSymbols("CISCO-WAN-BBIF-ILMI-MIB", cwbIlmiStatsGroup=cwbIlmiStatsGroup, bbIfIlmiEnable=bbIfIlmiEnable, bbIfSignallingVci=bbIfSignallingVci, bbIfGetNextRequestReceived=bbIfGetNextRequestReceived, bbIfCnfSigILMIGrp=bbIfCnfSigILMIGrp, bbIfMinTrapInterval=bbIfMinTrapInterval, bbIfSignallingProtocolType=bbIfSignallingProtocolType, bbIfSetRequestReceived=bbIfSetRequestReceived, bbIfCntSigILMIGrp=bbIfCntSigILMIGrp, cwbIlmiMIBConformance=cwbIlmiMIBConformance, bbIfGetResponseTransmitted=bbIfGetResponseTransmitted, bbIfMinEnquiryIntervalT493=bbIfMinEnquiryIntervalT493, bbIfEventThresholdN492=bbIfEventThresholdN492, bbIfTrapTransmitted=bbIfTrapTransmitted, bbIfAddrRegEnable=bbIfAddrRegEnable, bbIfGetResponseReceived=bbIfGetResponseReceived, cwbIlmiMIBGroups=cwbIlmiMIBGroups, bbIfInvalidPDUReceived=bbIfInvalidPDUReceived, bbIfSnmpPduReceived=bbIfSnmpPduReceived, bbIfCntSigILMIGrpTable=bbIfCntSigILMIGrpTable, bbIfErrorThresholdN491=bbIfErrorThresholdN491, cwbIlmiConfGroup=cwbIlmiConfGroup, bbIfPollingIntervalT491=bbIfPollingIntervalT491, cwbIlmiCompliance=cwbIlmiCompliance, cwbIlmiMIBCompliances=cwbIlmiMIBCompliances, bbIfIlmiTrapEnable=bbIfIlmiTrapEnable, bbIfAsn1ParseError=bbIfAsn1ParseError, bbIfTrapReceived=bbIfTrapReceived, bbIfKeepAlivePollingEnable=bbIfKeepAlivePollingEnable, bbIfAddrPrefix=bbIfAddrPrefix, bbIfSigPortNum=bbIfSigPortNum, PYSNMP_MODULE_ID=ciscoWanBbifIlmiMIB, bbIfProtocolRevNo=bbIfProtocolRevNo, bbIfGetRequestTransmitted=bbIfGetRequestTransmitted, sigCntBbIfNum=sigCntBbIfNum, bbIfCustomerId=bbIfCustomerId, bbIfCntSigILMIGrpEntry=bbIfCntSigILMIGrpEntry, bbIfSignallingVpi=bbIfSignallingVpi, bbIfGetRequestReceived=bbIfGetRequestReceived, bbIfCnfSigILMIGrpEntry=bbIfCnfSigILMIGrpEntry, bbIfNoSuchNameError=bbIfNoSuchNameError, ciscoWanBbifIlmiMIB=ciscoWanBbifIlmiMIB, bbIfCnfSigILMIGrpTable=bbIfCnfSigILMIGrpTable, bbIfSigCntClrButton=bbIfSigCntClrButton, bbIfTooBigError=bbIfTooBigError)
