...
mibBuilder.exportSymbols("CISCO-WAN-BBIF-ILMI-MIB", bbIfCntSigILMIGrpTable=bbIfCntSigILMIGrpTable, bbIfGetRequestReceived=bbIfGetRequestReceived, bbIfSignallingVci=bbIfSignallingVci, bbIfGetResponseTransmitted=bbIfGetResponseTransmitted, cwbIlmiConfGroup=cwbIlmiConfGroup, bbIfCnfSigILMIGrp=bbIfCnfSigILMIGrp, PYSNMP_MODULE_ID=ciscoWanBbifIlmiMIB, cwbIlmiCompliance=cwbIlmiCompliance, bbIfAsn1ParseError=bbIfAsn1ParseError, bbIfErrorThresholdN491=bbIfErrorThresholdN491, bbIfAddrRegEnable=bbIfAddrRegEnable, bbIfIlmiTrapEnable=bbIfIlmiTrapEnable, bbIfPollingIntervalT491=bbIfPollingIntervalT491, bbIfTrapTransmitted=bbIfTrapTransmitted, bbIfTooBigError=bbIfTooBigError, ciscoWanBbifIlmiMIB=ciscoWanBbifIlmiMIB, bbIfKeepAlivePollingEnable=bbIfKeepAlivePollingEnable, bbIfTrapReceived=bbIfTrapReceived, bbIfCntSigILMIGrpEntry=bbIfCntSigILMIGrpEntry, cwbIlmiStatsGroup=cwbIlmiStatsGroup, cwbIlmiMIBConformance=cwbIlmiMIBConformance, bbIfSignallingProtocolType=bbIfSignallingProtocolType, bbIfAddrPrefix=bbIfAddrPrefix, bbIfGetRequestTransmitted=bbIfGetRequestTransmitted, bbIfIlmiEnable=bbIfIlmiEnable, bbIfCnfSigILMIGrpTable=bbIfCnfSigILMIGrpTable, bbIfNoSuchNameError=bbIfNoSuchNameError, sigCntBbIfNum=sigCntBbIfNum, bbIfSigCntClrButton=bbIfSigCntClrButton, bbIfSnmpPduReceived=bbIfSnmpPduReceived, bbIfCustomerId=bbIfCustomerId, bbIfCnfSigILMIGrpEntry=bbIfCnfSigILMIGrpEntry, cwbIlmiMIBCompliances=cwbIlmiMIBCompliances, bbIfSigPortNum=bbIfSigPortNum, bbIfMinTrapInterval=bbIfMinTrapInterval, bbIfSignallingVpi=bbIfSignallingVpi, cwbIlmiMIBGroups=cwbIlmiMIBGroups, bbIfGetNextRequestReceived=bbIfGetNextRequestReceived, bbIfCntSigILMIGrp=bbIfCntSigILMIGrp, bbIfGetResponseReceived=bbIfGetResponseReceived, bbIfSetRequestReceived=bbIfSetRequestReceived, bbIfInvalidPDUReceived=bbIfInvalidPDUReceived, bbIfProtocolRevNo=bbIfProtocolRevNo, bbIfMinEnquiryIntervalT493=bbIfMinEnquiryIntervalT493, bbIfEventThresholdN492=bbIfEventThresholdN492)
