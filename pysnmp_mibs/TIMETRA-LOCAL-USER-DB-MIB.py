...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-LOCAL-USER-DB-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:58:21 2025
...
(TItemDescription,
 ...
 TmnxSubSpiGroupId) = mibBuilder.importSymbols(
    "TIMETRA-TC-MIB",
    "TItemDescription",
    "TLNamedItemOrEmpty",
    "TNamedItem",
...
_TmnxLocUsrDbCreationOrigin_Type = TmnxCreateOrigin
_TmnxLocUsrDbCreationOrigin_Object = MibTableColumn
tmnxLocUsrDbCreationOrigin = _TmnxLocUsrDbCreationOrigin_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 2, 1, 22),
    _TmnxLocUsrDbCreationOrigin_Type()
)
tmnxLocUsrDbCreationOrigin.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbCreationOrigin.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoePadoDelay.setUnits("deciseconds")
...
class _TmnxLocUsrDbPppoeDerivedId_Type(DisplayString):
    """Custom type tmnxLocUsrDbPppoeDerivedId based on DisplayString"""
    defaultValue = OctetString("")
...
_TmnxLocUsrDbPppoeDerivedId_Type.__name__ = "DisplayString"
_TmnxLocUsrDbPppoeDerivedId_Object = MibTableColumn
tmnxLocUsrDbPppoeDerivedId = _TmnxLocUsrDbPppoeDerivedId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 4, 1, 66),
    _TmnxLocUsrDbPppoeDerivedId_Type()
)
tmnxLocUsrDbPppoeDerivedId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeDerivedId.setStatus("current")
...
class _TmnxLocUsrDbPppoeUnDerivedId_Type(DisplayString):
    """Custom type tmnxLocUsrDbPppoeUnDerivedId based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_TmnxLocUsrDbPppoeUnDerivedId_Type.__name__ = "DisplayString"
_TmnxLocUsrDbPppoeUnDerivedId_Object = MibTableColumn
tmnxLocUsrDbPppoeUnDerivedId = _TmnxLocUsrDbPppoeUnDerivedId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 5, 1, 10),
    _TmnxLocUsrDbPppoeUnDerivedId_Type()
)
tmnxLocUsrDbPppoeUnDerivedId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeUnDerivedId.setStatus("current")
_TmnxLocUsrDbPppoeUnEncTgRgType_Type = TmnxPortEncapType
_TmnxLocUsrDbPppoeUnEncTgRgType_Object = MibTableColumn
tmnxLocUsrDbPppoeUnEncTgRgType = _TmnxLocUsrDbPppoeUnEncTgRgType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 5, 1, 11),
    _TmnxLocUsrDbPppoeUnEncTgRgType_Type()
)
tmnxLocUsrDbPppoeUnEncTgRgType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeUnEncTgRgType.setStatus("current")
_TmnxLocUsrDbPppoeUnEncTgRgStart_Type = TmnxEncapVal
_TmnxLocUsrDbPppoeUnEncTgRgStart_Object = MibTableColumn
tmnxLocUsrDbPppoeUnEncTgRgStart = _TmnxLocUsrDbPppoeUnEncTgRgStart_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 5, 1, 12),
    _TmnxLocUsrDbPppoeUnEncTgRgStart_Type()
)
tmnxLocUsrDbPppoeUnEncTgRgStart.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeUnEncTgRgStart.setStatus("current")
_TmnxLocUsrDbPppoeUnEncTgRgEnd_Type = TmnxEncapVal
_TmnxLocUsrDbPppoeUnEncTgRgEnd_Object = MibTableColumn
tmnxLocUsrDbPppoeUnEncTgRgEnd = _TmnxLocUsrDbPppoeUnEncTgRgEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 5, 1, 13),
    _TmnxLocUsrDbPppoeUnEncTgRgEnd_Type()
)
tmnxLocUsrDbPppoeUnEncTgRgEnd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeUnEncTgRgEnd.setStatus("current")


class _TmnxLocUsrDbPppoeUnEncTgRgOutSta_Type(Integer32):
    """Custom type tmnxLocUsrDbPppoeUnEncTgRgOutSta based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TmnxLocUsrDbPppoeUnEncTgRgOutSta_Type.__name__ = "Integer32"
_TmnxLocUsrDbPppoeUnEncTgRgOutSta_Object = MibTableColumn
tmnxLocUsrDbPppoeUnEncTgRgOutSta = _TmnxLocUsrDbPppoeUnEncTgRgOutSta_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 5, 1, 14),
    _TmnxLocUsrDbPppoeUnEncTgRgOutSta_Type()
)
tmnxLocUsrDbPppoeUnEncTgRgOutSta.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeUnEncTgRgOutSta.setStatus("current")


class _TmnxLocUsrDbPppoeUnEncTgRgOutEnd_Type(Integer32):
    """Custom type tmnxLocUsrDbPppoeUnEncTgRgOutEnd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-1, -1),
        ValueRangeConstraint(0, 4094),
...
_TmnxLocUsrDbPppoeUnEncTgRgOutEnd_Type.__name__ = "Integer32"
_TmnxLocUsrDbPppoeUnEncTgRgOutEnd_Object = MibTableColumn
tmnxLocUsrDbPppoeUnEncTgRgOutEnd = _TmnxLocUsrDbPppoeUnEncTgRgOutEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 5, 1, 15),
    _TmnxLocUsrDbPppoeUnEncTgRgOutEnd_Type()
)
tmnxLocUsrDbPppoeUnEncTgRgOutEnd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeUnEncTgRgOutEnd.setStatus("current")


class _TmnxLocUsrDbPppoeUnEncTgRgInnSta_Type(Integer32):
    """Custom type tmnxLocUsrDbPppoeUnEncTgRgInnSta based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-1, -1),
        ValueRangeConstraint(0, 4094),
...
_TmnxLocUsrDbPppoeUnEncTgRgInnSta_Type.__name__ = "Integer32"
_TmnxLocUsrDbPppoeUnEncTgRgInnSta_Object = MibTableColumn
tmnxLocUsrDbPppoeUnEncTgRgInnSta = _TmnxLocUsrDbPppoeUnEncTgRgInnSta_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 5, 1, 16),
    _TmnxLocUsrDbPppoeUnEncTgRgInnSta_Type()
)
tmnxLocUsrDbPppoeUnEncTgRgInnSta.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeUnEncTgRgInnSta.setStatus("current")


class _TmnxLocUsrDbPppoeUnEncTgRgInnEnd_Type(Integer32):
    """Custom type tmnxLocUsrDbPppoeUnEncTgRgInnEnd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-1, -1),
        ValueRangeConstraint(0, 4094),
...
_TmnxLocUsrDbPppoeUnEncTgRgInnEnd_Type.__name__ = "Integer32"
_TmnxLocUsrDbPppoeUnEncTgRgInnEnd_Object = MibTableColumn
tmnxLocUsrDbPppoeUnEncTgRgInnEnd = _TmnxLocUsrDbPppoeUnEncTgRgInnEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 5, 1, 17),
    _TmnxLocUsrDbPppoeUnEncTgRgInnEnd_Type()
)
tmnxLocUsrDbPppoeUnEncTgRgInnEnd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeUnEncTgRgInnEnd.setStatus("current")
...
_TmnxLocUsrDbPppoeOptionDisplay_Type = TmnxDhcpOptionDisplay
_TmnxLocUsrDbPppoeOptionDisplay_Object = MibTableColumn
tmnxLocUsrDbPppoeOptionDisplay = _TmnxLocUsrDbPppoeOptionDisplay_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 7, 1, 6),
    _TmnxLocUsrDbPppoeOptionDisplay_Type()
)
tmnxLocUsrDbPppoeOptionDisplay.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeOptionDisplay.setStatus("current")
...
class _TmnxLocUsrDbDhcpIpPrefixAddrType_Type(InetAddressType):
    """Custom type tmnxLocUsrDbDhcpIpPrefixAddrType based on InetAddressType"""
    defaultValue = 0


_TmnxLocUsrDbDhcpIpPrefixAddrType_Type.__name__ = "InetAddressType"
_TmnxLocUsrDbDhcpIpPrefixAddrType_Object = MibTableColumn
tmnxLocUsrDbDhcpIpPrefixAddrType = _TmnxLocUsrDbDhcpIpPrefixAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 9, 1, 62),
    _TmnxLocUsrDbDhcpIpPrefixAddrType_Type()
)
tmnxLocUsrDbDhcpIpPrefixAddrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpIpPrefixAddrType.setStatus("current")


class _TmnxLocUsrDbDhcpIpPrefixAddr_Type(InetAddress):
    """Custom type tmnxLocUsrDbDhcpIpPrefixAddr based on InetAddress"""
    defaultHexValue = ""
...
_TmnxLocUsrDbDhcpIpPrefixAddr_Type.__name__ = "InetAddress"
_TmnxLocUsrDbDhcpIpPrefixAddr_Object = MibTableColumn
tmnxLocUsrDbDhcpIpPrefixAddr = _TmnxLocUsrDbDhcpIpPrefixAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 9, 1, 63),
    _TmnxLocUsrDbDhcpIpPrefixAddr_Type()
)
tmnxLocUsrDbDhcpIpPrefixAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpIpPrefixAddr.setStatus("current")


class _TmnxLocUsrDbDhcpIpPrefixLength_Type(InetAddressPrefixLength):
    """Custom type tmnxLocUsrDbDhcpIpPrefixLength based on InetAddressPrefixLength"""
    defaultValue = 0
...
_TmnxLocUsrDbDhcpIpPrefixLength_Type.__name__ = "InetAddressPrefixLength"
_TmnxLocUsrDbDhcpIpPrefixLength_Object = MibTableColumn
tmnxLocUsrDbDhcpIpPrefixLength = _TmnxLocUsrDbDhcpIpPrefixLength_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 9, 1, 64),
    _TmnxLocUsrDbDhcpIpPrefixLength_Type()
)
tmnxLocUsrDbDhcpIpPrefixLength.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpIpPrefixLength.setStatus("current")


class _TmnxLocUsrDbDhcpSpiGroupId_Type(TmnxSubSpiGroupId):
    """Custom type tmnxLocUsrDbDhcpSpiGroupId based on TmnxSubSpiGroupId"""
    defaultValue = -1


_TmnxLocUsrDbDhcpSpiGroupId_Type.__name__ = "TmnxSubSpiGroupId"
_TmnxLocUsrDbDhcpSpiGroupId_Object = MibTableColumn
tmnxLocUsrDbDhcpSpiGroupId = _TmnxLocUsrDbDhcpSpiGroupId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 9, 1, 65),
    _TmnxLocUsrDbDhcpSpiGroupId_Type()
)
tmnxLocUsrDbDhcpSpiGroupId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpSpiGroupId.setStatus("current")
...
class _TmnxLocUsrDbDhcpUnDerivedId_Type(DisplayString):
    """Custom type tmnxLocUsrDbDhcpUnDerivedId based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_TmnxLocUsrDbDhcpUnDerivedId_Type.__name__ = "DisplayString"
_TmnxLocUsrDbDhcpUnDerivedId_Object = MibTableColumn
tmnxLocUsrDbDhcpUnDerivedId = _TmnxLocUsrDbDhcpUnDerivedId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 11),
    _TmnxLocUsrDbDhcpUnDerivedId_Type()
)
tmnxLocUsrDbDhcpUnDerivedId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnDerivedId.setStatus("current")
_TmnxLocUsrDbDhcpUnEncTagRgType_Type = TmnxPortEncapType
_TmnxLocUsrDbDhcpUnEncTagRgType_Object = MibTableColumn
tmnxLocUsrDbDhcpUnEncTagRgType = _TmnxLocUsrDbDhcpUnEncTagRgType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 12),
    _TmnxLocUsrDbDhcpUnEncTagRgType_Type()
)
tmnxLocUsrDbDhcpUnEncTagRgType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnEncTagRgType.setStatus("current")
_TmnxLocUsrDbDhcpUnEncTagRgStart_Type = TmnxEncapVal
_TmnxLocUsrDbDhcpUnEncTagRgStart_Object = MibTableColumn
tmnxLocUsrDbDhcpUnEncTagRgStart = _TmnxLocUsrDbDhcpUnEncTagRgStart_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 13),
    _TmnxLocUsrDbDhcpUnEncTagRgStart_Type()
)
tmnxLocUsrDbDhcpUnEncTagRgStart.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnEncTagRgStart.setStatus("current")
_TmnxLocUsrDbDhcpUnEncTagRgEnd_Type = TmnxEncapVal
_TmnxLocUsrDbDhcpUnEncTagRgEnd_Object = MibTableColumn
tmnxLocUsrDbDhcpUnEncTagRgEnd = _TmnxLocUsrDbDhcpUnEncTagRgEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 14),
    _TmnxLocUsrDbDhcpUnEncTagRgEnd_Type()
)
tmnxLocUsrDbDhcpUnEncTagRgEnd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnEncTagRgEnd.setStatus("current")
_TmnxLocUsrDbDhcpUnIpPrefAddrType_Type = InetAddressType
_TmnxLocUsrDbDhcpUnIpPrefAddrType_Object = MibTableColumn
tmnxLocUsrDbDhcpUnIpPrefAddrType = _TmnxLocUsrDbDhcpUnIpPrefAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 15),
    _TmnxLocUsrDbDhcpUnIpPrefAddrType_Type()
)
tmnxLocUsrDbDhcpUnIpPrefAddrType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnIpPrefAddrType.setStatus("current")


class _TmnxLocUsrDbDhcpUnIpPrefAddr_Type(InetAddress):
    """Custom type tmnxLocUsrDbDhcpUnIpPrefAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_TmnxLocUsrDbDhcpUnIpPrefAddr_Type.__name__ = "InetAddress"
_TmnxLocUsrDbDhcpUnIpPrefAddr_Object = MibTableColumn
tmnxLocUsrDbDhcpUnIpPrefAddr = _TmnxLocUsrDbDhcpUnIpPrefAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 16),
    _TmnxLocUsrDbDhcpUnIpPrefAddr_Type()
)
tmnxLocUsrDbDhcpUnIpPrefAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnIpPrefAddr.setStatus("current")


class _TmnxLocUsrDbDhcpUnIpPrefLength_Type(InetAddressPrefixLength):
    """Custom type tmnxLocUsrDbDhcpUnIpPrefLength based on InetAddressPrefixLength"""
    subtypeSpec = InetAddressPrefixLength.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 128),
    )
...
_TmnxLocUsrDbDhcpUnIpPrefLength_Type.__name__ = "InetAddressPrefixLength"
_TmnxLocUsrDbDhcpUnIpPrefLength_Object = MibTableColumn
tmnxLocUsrDbDhcpUnIpPrefLength = _TmnxLocUsrDbDhcpUnIpPrefLength_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 17),
    _TmnxLocUsrDbDhcpUnIpPrefLength_Type()
)
tmnxLocUsrDbDhcpUnIpPrefLength.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnIpPrefLength.setStatus("current")


class _TmnxLocUsrDbDhcpUnEncTagRgOutSta_Type(Integer32):
    """Custom type tmnxLocUsrDbDhcpUnEncTagRgOutSta based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-1, -1),
        ValueRangeConstraint(0, 4094),
...
_TmnxLocUsrDbDhcpUnEncTagRgOutSta_Type.__name__ = "Integer32"
_TmnxLocUsrDbDhcpUnEncTagRgOutSta_Object = MibTableColumn
tmnxLocUsrDbDhcpUnEncTagRgOutSta = _TmnxLocUsrDbDhcpUnEncTagRgOutSta_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 18),
    _TmnxLocUsrDbDhcpUnEncTagRgOutSta_Type()
)
tmnxLocUsrDbDhcpUnEncTagRgOutSta.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnEncTagRgOutSta.setStatus("current")


class _TmnxLocUsrDbDhcpUnEncTagRgOutEnd_Type(Integer32):
    """Custom type tmnxLocUsrDbDhcpUnEncTagRgOutEnd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-1, -1),
        ValueRangeConstraint(0, 4094),
...
_TmnxLocUsrDbDhcpUnEncTagRgOutEnd_Type.__name__ = "Integer32"
_TmnxLocUsrDbDhcpUnEncTagRgOutEnd_Object = MibTableColumn
tmnxLocUsrDbDhcpUnEncTagRgOutEnd = _TmnxLocUsrDbDhcpUnEncTagRgOutEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 19),
    _TmnxLocUsrDbDhcpUnEncTagRgOutEnd_Type()
)
tmnxLocUsrDbDhcpUnEncTagRgOutEnd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnEncTagRgOutEnd.setStatus("current")


class _TmnxLocUsrDbDhcpUnEncTagRgInnSta_Type(Integer32):
    """Custom type tmnxLocUsrDbDhcpUnEncTagRgInnSta based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-1, -1),
        ValueRangeConstraint(0, 4094),
...
_TmnxLocUsrDbDhcpUnEncTagRgInnSta_Type.__name__ = "Integer32"
_TmnxLocUsrDbDhcpUnEncTagRgInnSta_Object = MibTableColumn
tmnxLocUsrDbDhcpUnEncTagRgInnSta = _TmnxLocUsrDbDhcpUnEncTagRgInnSta_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 20),
    _TmnxLocUsrDbDhcpUnEncTagRgInnSta_Type()
)
tmnxLocUsrDbDhcpUnEncTagRgInnSta.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnEncTagRgInnSta.setStatus("current")


class _TmnxLocUsrDbDhcpUnEncTagRgInnEnd_Type(Integer32):
    """Custom type tmnxLocUsrDbDhcpUnEncTagRgInnEnd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-1, -1),
        ValueRangeConstraint(0, 4094),
...
_TmnxLocUsrDbDhcpUnEncTagRgInnEnd_Type.__name__ = "Integer32"
_TmnxLocUsrDbDhcpUnEncTagRgInnEnd_Object = MibTableColumn
tmnxLocUsrDbDhcpUnEncTagRgInnEnd = _TmnxLocUsrDbDhcpUnEncTagRgInnEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 10, 1, 21),
    _TmnxLocUsrDbDhcpUnEncTagRgInnEnd_Type()
)
tmnxLocUsrDbDhcpUnEncTagRgInnEnd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpUnEncTagRgInnEnd.setStatus("current")
...
_TmnxLocUsrDbDhcpOptionDisplay_Type = TmnxDhcpOptionDisplay
_TmnxLocUsrDbDhcpOptionDisplay_Object = MibTableColumn
tmnxLocUsrDbDhcpOptionDisplay = _TmnxLocUsrDbDhcpOptionDisplay_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 12, 1, 6),
    _TmnxLocUsrDbDhcpOptionDisplay_Type()
)
tmnxLocUsrDbDhcpOptionDisplay.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpOptionDisplay.setStatus("current")
...
class _TmnxLocUsrDbPppoeAuthDerivedId_Type(DisplayString):
    """Custom type tmnxLocUsrDbPppoeAuthDerivedId based on DisplayString"""
    defaultValue = OctetString("")
...
_TmnxLocUsrDbPppoeAuthDerivedId_Type.__name__ = "DisplayString"
_TmnxLocUsrDbPppoeAuthDerivedId_Object = MibScalar
tmnxLocUsrDbPppoeAuthDerivedId = _TmnxLocUsrDbPppoeAuthDerivedId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 13, 16),
    _TmnxLocUsrDbPppoeAuthDerivedId_Type()
)
tmnxLocUsrDbPppoeAuthDerivedId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppoeAuthDerivedId.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxLudbHostPppoePadoDelay.setUnits("deciseconds")
...
if mibBuilder.loadTexts:
    tmnxLudbPppAleRateDown.setUnits("kilobps")
...
class _TmnxLudbRadproxCacheServiceName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxLudbRadproxCacheServiceName based on TLNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbRadproxCacheServiceName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxLudbRadproxCacheServiceName_Object = MibTableColumn
tmnxLudbRadproxCacheServiceName = _TmnxLudbRadproxCacheServiceName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 25, 1, 10),
    _TmnxLudbRadproxCacheServiceName_Type()
)
tmnxLudbRadproxCacheServiceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbRadproxCacheServiceName.setStatus("current")
...
_TmnxLocUsrDbDhcpOption6Display_Type = TmnxDhcpOptionDisplay
_TmnxLocUsrDbDhcpOption6Display_Object = MibTableColumn
tmnxLocUsrDbDhcpOption6Display = _TmnxLocUsrDbDhcpOption6Display_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 27, 1, 6),
    _TmnxLocUsrDbDhcpOption6Display_Type()
)
tmnxLocUsrDbDhcpOption6Display.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbDhcpOption6Display.setStatus("current")
...
_TmnxLocUsrDbPppOption6Display_Type = TmnxDhcpOptionDisplay
_TmnxLocUsrDbPppOption6Display_Object = MibTableColumn
tmnxLocUsrDbPppOption6Display = _TmnxLocUsrDbPppOption6Display_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 29, 1, 6),
    _TmnxLocUsrDbPppOption6Display_Type()
)
tmnxLocUsrDbPppOption6Display.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLocUsrDbPppOption6Display.setStatus("current")
...
class _TmnxLudbDhcp2RipPolicy_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbDhcp2RipPolicy based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbDhcp2RipPolicy_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbDhcp2RipPolicy_Object = MibTableColumn
tmnxLudbDhcp2RipPolicy = _TmnxLudbDhcp2RipPolicy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 21),
    _TmnxLudbDhcp2RipPolicy_Type()
)
tmnxLudbDhcp2RipPolicy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2RipPolicy.setStatus("current")


class _TmnxLudbDhcp2DiameterAuthPolicy_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbDhcp2DiameterAuthPolicy based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbDhcp2DiameterAuthPolicy_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbDhcp2DiameterAuthPolicy_Object = MibTableColumn
tmnxLudbDhcp2DiameterAuthPolicy = _TmnxLudbDhcp2DiameterAuthPolicy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 22),
    _TmnxLudbDhcp2DiameterAuthPolicy_Type()
)
tmnxLudbDhcp2DiameterAuthPolicy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2DiameterAuthPolicy.setStatus("current")


class _TmnxLudbDhcp2WppPortalGroupName_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbDhcp2WppPortalGroupName based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbDhcp2WppPortalGroupName_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbDhcp2WppPortalGroupName_Object = MibTableColumn
tmnxLudbDhcp2WppPortalGroupName = _TmnxLudbDhcp2WppPortalGroupName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 23),
    _TmnxLudbDhcp2WppPortalGroupName_Type()
)
tmnxLudbDhcp2WppPortalGroupName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2WppPortalGroupName.setStatus("current")


class _TmnxLudbDhcp2RtrAdvPlcy_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbDhcp2RtrAdvPlcy based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbDhcp2RtrAdvPlcy_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbDhcp2RtrAdvPlcy_Object = MibTableColumn
tmnxLudbDhcp2RtrAdvPlcy = _TmnxLudbDhcp2RtrAdvPlcy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 24),
    _TmnxLudbDhcp2RtrAdvPlcy_Type()
)
tmnxLudbDhcp2RtrAdvPlcy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2RtrAdvPlcy.setStatus("current")


class _TmnxLudbDhcp2Service_Type(TmnxServId):
    """Custom type tmnxLudbDhcp2Service based on TmnxServId"""
    defaultValue = 0


_TmnxLudbDhcp2Service_Type.__name__ = "TmnxServId"
_TmnxLudbDhcp2Service_Object = MibTableColumn
tmnxLudbDhcp2Service = _TmnxLudbDhcp2Service_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 25),
    _TmnxLudbDhcp2Service_Type()
)
tmnxLudbDhcp2Service.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2Service.setStatus("current")


class _TmnxLudbDhcp2Interface_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbDhcp2Interface based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxLudbDhcp2Interface_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbDhcp2Interface_Object = MibTableColumn
tmnxLudbDhcp2Interface = _TmnxLudbDhcp2Interface_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 26),
    _TmnxLudbDhcp2Interface_Type()
)
tmnxLudbDhcp2Interface.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2Interface.setStatus("current")


class _TmnxLudbDhcp2GrpIfServiceName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxLudbDhcp2GrpIfServiceName based on TLNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbDhcp2GrpIfServiceName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxLudbDhcp2GrpIfServiceName_Object = MibTableColumn
tmnxLudbDhcp2GrpIfServiceName = _TmnxLudbDhcp2GrpIfServiceName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 27),
    _TmnxLudbDhcp2GrpIfServiceName_Type()
)
tmnxLudbDhcp2GrpIfServiceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2GrpIfServiceName.setStatus("current")


class _TmnxLudbDhcp2RetailerServiceName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxLudbDhcp2RetailerServiceName based on TLNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbDhcp2RetailerServiceName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxLudbDhcp2RetailerServiceName_Object = MibTableColumn
tmnxLudbDhcp2RetailerServiceName = _TmnxLudbDhcp2RetailerServiceName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 28),
    _TmnxLudbDhcp2RetailerServiceName_Type()
)
tmnxLudbDhcp2RetailerServiceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2RetailerServiceName.setStatus("current")


class _TmnxLudbDhcp2IdentServiceName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxLudbDhcp2IdentServiceName based on TLNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbDhcp2IdentServiceName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxLudbDhcp2IdentServiceName_Object = MibTableColumn
tmnxLudbDhcp2IdentServiceName = _TmnxLudbDhcp2IdentServiceName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 29),
    _TmnxLudbDhcp2IdentServiceName_Type()
)
tmnxLudbDhcp2IdentServiceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2IdentServiceName.setStatus("current")


class _TmnxLudbDhcp2EncTagRgOuterStart_Type(Integer32):
    """Custom type tmnxLudbDhcp2EncTagRgOuterStart based on Integer32"""
    defaultValue = -1
...
_TmnxLudbDhcp2EncTagRgOuterStart_Type.__name__ = "Integer32"
_TmnxLudbDhcp2EncTagRgOuterStart_Object = MibTableColumn
tmnxLudbDhcp2EncTagRgOuterStart = _TmnxLudbDhcp2EncTagRgOuterStart_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 30),
    _TmnxLudbDhcp2EncTagRgOuterStart_Type()
)
tmnxLudbDhcp2EncTagRgOuterStart.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2EncTagRgOuterStart.setStatus("current")


class _TmnxLudbDhcp2EncTagRgOuterEnd_Type(Integer32):
    """Custom type tmnxLudbDhcp2EncTagRgOuterEnd based on Integer32"""
    defaultValue = -1
...
_TmnxLudbDhcp2EncTagRgOuterEnd_Type.__name__ = "Integer32"
_TmnxLudbDhcp2EncTagRgOuterEnd_Object = MibTableColumn
tmnxLudbDhcp2EncTagRgOuterEnd = _TmnxLudbDhcp2EncTagRgOuterEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 31),
    _TmnxLudbDhcp2EncTagRgOuterEnd_Type()
)
tmnxLudbDhcp2EncTagRgOuterEnd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2EncTagRgOuterEnd.setStatus("current")


class _TmnxLudbDhcp2EncTagRgInnerStart_Type(Integer32):
    """Custom type tmnxLudbDhcp2EncTagRgInnerStart based on Integer32"""
    defaultValue = -1
...
_TmnxLudbDhcp2EncTagRgInnerStart_Type.__name__ = "Integer32"
_TmnxLudbDhcp2EncTagRgInnerStart_Object = MibTableColumn
tmnxLudbDhcp2EncTagRgInnerStart = _TmnxLudbDhcp2EncTagRgInnerStart_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 32),
    _TmnxLudbDhcp2EncTagRgInnerStart_Type()
)
tmnxLudbDhcp2EncTagRgInnerStart.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2EncTagRgInnerStart.setStatus("current")


class _TmnxLudbDhcp2EncTagRgInnerEnd_Type(Integer32):
    """Custom type tmnxLudbDhcp2EncTagRgInnerEnd based on Integer32"""
    defaultValue = -1
...
_TmnxLudbDhcp2EncTagRgInnerEnd_Type.__name__ = "Integer32"
_TmnxLudbDhcp2EncTagRgInnerEnd_Object = MibTableColumn
tmnxLudbDhcp2EncTagRgInnerEnd = _TmnxLudbDhcp2EncTagRgInnerEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 33, 1, 33),
    _TmnxLudbDhcp2EncTagRgInnerEnd_Type()
)
tmnxLudbDhcp2EncTagRgInnerEnd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbDhcp2EncTagRgInnerEnd.setStatus("current")
...
class _TmnxLudbPpp2RipPolicy_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbPpp2RipPolicy based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbPpp2RipPolicy_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbPpp2RipPolicy_Object = MibTableColumn
tmnxLudbPpp2RipPolicy = _TmnxLudbPpp2RipPolicy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 7),
    _TmnxLudbPpp2RipPolicy_Type()
)
tmnxLudbPpp2RipPolicy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2RipPolicy.setStatus("current")


class _TmnxLudbPpp2DiameterAuthPolicy_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbPpp2DiameterAuthPolicy based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxLudbPpp2DiameterAuthPolicy_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbPpp2DiameterAuthPolicy_Object = MibTableColumn
tmnxLudbPpp2DiameterAuthPolicy = _TmnxLudbPpp2DiameterAuthPolicy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 8),
    _TmnxLudbPpp2DiameterAuthPolicy_Type()
)
tmnxLudbPpp2DiameterAuthPolicy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2DiameterAuthPolicy.setStatus("current")


class _TmnxLudbPpp2IgnoreDfBit_Type(TruthValue):
    """Custom type tmnxLudbPpp2IgnoreDfBit based on TruthValue"""
    defaultValue = 2


_TmnxLudbPpp2IgnoreDfBit_Type.__name__ = "TruthValue"
_TmnxLudbPpp2IgnoreDfBit_Object = MibTableColumn
tmnxLudbPpp2IgnoreDfBit = _TmnxLudbPpp2IgnoreDfBit_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 9),
    _TmnxLudbPpp2IgnoreDfBit_Type()
)
tmnxLudbPpp2IgnoreDfBit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2IgnoreDfBit.setStatus("current")


class _TmnxLudbPpp2UserDb_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbPpp2UserDb based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxLudbPpp2UserDb_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbPpp2UserDb_Object = MibTableColumn
tmnxLudbPpp2UserDb = _TmnxLudbPpp2UserDb_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 10),
    _TmnxLudbPpp2UserDb_Type()
)
tmnxLudbPpp2UserDb.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2UserDb.setStatus("current")


class _TmnxLudbPpp2SteeringProfStr_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbPpp2SteeringProfStr based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxLudbPpp2SteeringProfStr_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbPpp2SteeringProfStr_Object = MibTableColumn
tmnxLudbPpp2SteeringProfStr = _TmnxLudbPpp2SteeringProfStr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 11),
    _TmnxLudbPpp2SteeringProfStr_Type()
)
tmnxLudbPpp2SteeringProfStr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2SteeringProfStr.setStatus("current")


class _TmnxLudbPpp2PadiAuthPolicy_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbPpp2PadiAuthPolicy based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxLudbPpp2PadiAuthPolicy_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbPpp2PadiAuthPolicy_Object = MibTableColumn
tmnxLudbPpp2PadiAuthPolicy = _TmnxLudbPpp2PadiAuthPolicy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 12),
    _TmnxLudbPpp2PadiAuthPolicy_Type()
)
tmnxLudbPpp2PadiAuthPolicy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2PadiAuthPolicy.setStatus("current")


class _TmnxLudbPpp2RtrAdvPlcy_Type(TNamedItemOrEmpty):
    """Custom type tmnxLudbPpp2RtrAdvPlcy based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxLudbPpp2RtrAdvPlcy_Type.__name__ = "TNamedItemOrEmpty"
_TmnxLudbPpp2RtrAdvPlcy_Object = MibTableColumn
tmnxLudbPpp2RtrAdvPlcy = _TmnxLudbPpp2RtrAdvPlcy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 13),
    _TmnxLudbPpp2RtrAdvPlcy_Type()
)
tmnxLudbPpp2RtrAdvPlcy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2RtrAdvPlcy.setStatus("current")


class _TmnxLudbPpp2SpiGroupId_Type(TmnxSubSpiGroupId):
    """Custom type tmnxLudbPpp2SpiGroupId based on TmnxSubSpiGroupId"""
    defaultValue = -1


_TmnxLudbPpp2SpiGroupId_Type.__name__ = "TmnxSubSpiGroupId"
_TmnxLudbPpp2SpiGroupId_Object = MibTableColumn
tmnxLudbPpp2SpiGroupId = _TmnxLudbPpp2SpiGroupId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 14),
    _TmnxLudbPpp2SpiGroupId_Type()
)
tmnxLudbPpp2SpiGroupId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2SpiGroupId.setStatus("current")


class _TmnxLudbPpp2RetailerServiceName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxLudbPpp2RetailerServiceName based on TLNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbPpp2RetailerServiceName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxLudbPpp2RetailerServiceName_Object = MibTableColumn
tmnxLudbPpp2RetailerServiceName = _TmnxLudbPpp2RetailerServiceName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 15),
    _TmnxLudbPpp2RetailerServiceName_Type()
)
tmnxLudbPpp2RetailerServiceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2RetailerServiceName.setStatus("current")


class _TmnxLudbPpp2GrpIfServiceName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxLudbPpp2GrpIfServiceName based on TLNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbPpp2GrpIfServiceName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxLudbPpp2GrpIfServiceName_Object = MibTableColumn
tmnxLudbPpp2GrpIfServiceName = _TmnxLudbPpp2GrpIfServiceName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 16),
    _TmnxLudbPpp2GrpIfServiceName_Type()
)
tmnxLudbPpp2GrpIfServiceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2GrpIfServiceName.setStatus("current")


class _TmnxLudbPpp2L2tpGroupServiceName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxLudbPpp2L2tpGroupServiceName based on TLNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxLudbPpp2L2tpGroupServiceName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxLudbPpp2L2tpGroupServiceName_Object = MibTableColumn
tmnxLudbPpp2L2tpGroupServiceName = _TmnxLudbPpp2L2tpGroupServiceName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 17),
    _TmnxLudbPpp2L2tpGroupServiceName_Type()
)
tmnxLudbPpp2L2tpGroupServiceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2L2tpGroupServiceName.setStatus("current")


class _TmnxLudbPpp2EncTagRgOuterStart_Type(Integer32):
    """Custom type tmnxLudbPpp2EncTagRgOuterStart based on Integer32"""
    defaultValue = -1
...
_TmnxLudbPpp2EncTagRgOuterStart_Type.__name__ = "Integer32"
_TmnxLudbPpp2EncTagRgOuterStart_Object = MibTableColumn
tmnxLudbPpp2EncTagRgOuterStart = _TmnxLudbPpp2EncTagRgOuterStart_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 18),
    _TmnxLudbPpp2EncTagRgOuterStart_Type()
)
tmnxLudbPpp2EncTagRgOuterStart.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2EncTagRgOuterStart.setStatus("current")


class _TmnxLudbPpp2EncTagRgOuterEnd_Type(Integer32):
    """Custom type tmnxLudbPpp2EncTagRgOuterEnd based on Integer32"""
    defaultValue = -1
...
_TmnxLudbPpp2EncTagRgOuterEnd_Type.__name__ = "Integer32"
_TmnxLudbPpp2EncTagRgOuterEnd_Object = MibTableColumn
tmnxLudbPpp2EncTagRgOuterEnd = _TmnxLudbPpp2EncTagRgOuterEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 19),
    _TmnxLudbPpp2EncTagRgOuterEnd_Type()
)
tmnxLudbPpp2EncTagRgOuterEnd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2EncTagRgOuterEnd.setStatus("current")


class _TmnxLudbPpp2EncTagRgInnerStart_Type(Integer32):
    """Custom type tmnxLudbPpp2EncTagRgInnerStart based on Integer32"""
    defaultValue = -1
...
_TmnxLudbPpp2EncTagRgInnerStart_Type.__name__ = "Integer32"
_TmnxLudbPpp2EncTagRgInnerStart_Object = MibTableColumn
tmnxLudbPpp2EncTagRgInnerStart = _TmnxLudbPpp2EncTagRgInnerStart_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 20),
    _TmnxLudbPpp2EncTagRgInnerStart_Type()
)
tmnxLudbPpp2EncTagRgInnerStart.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2EncTagRgInnerStart.setStatus("current")


class _TmnxLudbPpp2EncTagRgInnerEnd_Type(Integer32):
    """Custom type tmnxLudbPpp2EncTagRgInnerEnd based on Integer32"""
    defaultValue = -1
...
_TmnxLudbPpp2EncTagRgInnerEnd_Type.__name__ = "Integer32"
_TmnxLudbPpp2EncTagRgInnerEnd_Object = MibTableColumn
tmnxLudbPpp2EncTagRgInnerEnd = _TmnxLudbPpp2EncTagRgInnerEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 35, 1, 21),
    _TmnxLudbPpp2EncTagRgInnerEnd_Type()
)
tmnxLudbPpp2EncTagRgInnerEnd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbPpp2EncTagRgInnerEnd.setStatus("current")
...
_TmnxLudbToClntOptDisplay_Type = TmnxDhcpOptionDisplay
_TmnxLudbToClntOptDisplay_Object = MibTableColumn
tmnxLudbToClntOptDisplay = _TmnxLudbToClntOptDisplay_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 37, 1, 7),
    _TmnxLudbToClntOptDisplay_Type()
)
tmnxLudbToClntOptDisplay.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLudbToClntOptDisplay.setStatus("current")
_TmnxLudbToServerOptTableLstCh_Type = TimeStamp
_TmnxLudbToServerOptTableLstCh_Object = MibScalar
tmnxLudbToServerOptTableLstCh = _TmnxLudbToServerOptTableLstCh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 38),
    _TmnxLudbToServerOptTableLstCh_Type()
)
tmnxLudbToServerOptTableLstCh.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLudbToServerOptTableLstCh.setStatus("current")
_TmnxLudbToServerOptTable_Object = MibTable
tmnxLudbToServerOptTable = _TmnxLudbToServerOptTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 39)
)
if mibBuilder.loadTexts:
    tmnxLudbToServerOptTable.setStatus("current")
_TmnxLudbToServerOptEntry_Object = MibTableRow
tmnxLudbToServerOptEntry = _TmnxLudbToServerOptEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 39, 1)
)
tmnxLudbToServerOptEntry.setIndexNames(
    (0, "TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbUserDatabaseName"),
    (0, "TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbHostType"),
    (0, "TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbHostName"),
    (0, "TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToServerOptAddrType"),
    (0, "TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToServerOptNumber"),
)
if mibBuilder.loadTexts:
    tmnxLudbToServerOptEntry.setStatus("current")
_TmnxLudbToServerOptAddrType_Type = InetAddressType
_TmnxLudbToServerOptAddrType_Object = MibTableColumn
tmnxLudbToServerOptAddrType = _TmnxLudbToServerOptAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 39, 1, 1),
    _TmnxLudbToServerOptAddrType_Type()
)
tmnxLudbToServerOptAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxLudbToServerOptAddrType.setStatus("current")


class _TmnxLudbToServerOptNumber_Type(Unsigned32):
    """Custom type tmnxLudbToServerOptNumber based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_TmnxLudbToServerOptNumber_Type.__name__ = "Unsigned32"
_TmnxLudbToServerOptNumber_Object = MibTableColumn
tmnxLudbToServerOptNumber = _TmnxLudbToServerOptNumber_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 39, 1, 2),
    _TmnxLudbToServerOptNumber_Type()
)
tmnxLudbToServerOptNumber.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxLudbToServerOptNumber.setStatus("current")
_TmnxLudbToServerOptRowStatus_Type = RowStatus
_TmnxLudbToServerOptRowStatus_Object = MibTableColumn
tmnxLudbToServerOptRowStatus = _TmnxLudbToServerOptRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 39, 1, 3),
    _TmnxLudbToServerOptRowStatus_Type()
)
tmnxLudbToServerOptRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbToServerOptRowStatus.setStatus("current")
_TmnxLudbToServerOptLastCh_Type = TimeStamp
_TmnxLudbToServerOptLastCh_Object = MibTableColumn
tmnxLudbToServerOptLastCh = _TmnxLudbToServerOptLastCh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 39, 1, 4),
    _TmnxLudbToServerOptLastCh_Type()
)
tmnxLudbToServerOptLastCh.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLudbToServerOptLastCh.setStatus("current")
_TmnxLudbToServerOptType_Type = TmnxDhcpOptionType
_TmnxLudbToServerOptType_Object = MibTableColumn
tmnxLudbToServerOptType = _TmnxLudbToServerOptType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 39, 1, 5),
    _TmnxLudbToServerOptType_Type()
)
tmnxLudbToServerOptType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbToServerOptType.setStatus("current")


class _TmnxLudbToServerOptValue_Type(OctetString):
    """Custom type tmnxLudbToServerOptValue based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 127),
    )
...
_TmnxLudbToServerOptValue_Type.__name__ = "OctetString"
_TmnxLudbToServerOptValue_Object = MibTableColumn
tmnxLudbToServerOptValue = _TmnxLudbToServerOptValue_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 39, 1, 6),
    _TmnxLudbToServerOptValue_Type()
)
tmnxLudbToServerOptValue.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbToServerOptValue.setStatus("current")
_TmnxLudbToServerOptDisplay_Type = TmnxDhcpOptionDisplay
_TmnxLudbToServerOptDisplay_Object = MibTableColumn
tmnxLudbToServerOptDisplay = _TmnxLudbToServerOptDisplay_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 39, 1, 7),
    _TmnxLudbToServerOptDisplay_Type()
)
tmnxLudbToServerOptDisplay.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLudbToServerOptDisplay.setStatus("current")
_TmnxLudbMldImpPlcyTableLstCh_Type = TimeStamp
_TmnxLudbMldImpPlcyTableLstCh_Object = MibScalar
tmnxLudbMldImpPlcyTableLstCh = _TmnxLudbMldImpPlcyTableLstCh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 46),
    _TmnxLudbMldImpPlcyTableLstCh_Type()
)
tmnxLudbMldImpPlcyTableLstCh.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLudbMldImpPlcyTableLstCh.setStatus("current")
_TmnxLudbMldImpPlcyTable_Object = MibTable
tmnxLudbMldImpPlcyTable = _TmnxLudbMldImpPlcyTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 47)
)
if mibBuilder.loadTexts:
    tmnxLudbMldImpPlcyTable.setStatus("current")
_TmnxLudbMldImpPlcyEntry_Object = MibTableRow
tmnxLudbMldImpPlcyEntry = _TmnxLudbMldImpPlcyEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 47, 1)
)
tmnxLudbMldImpPlcyEntry.setIndexNames(
    (0, "TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbUserDatabaseName"),
    (0, "TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbHostType"),
    (0, "TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbHostName"),
    (1, "TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbMldImpPlcyName"),
)
if mibBuilder.loadTexts:
    tmnxLudbMldImpPlcyEntry.setStatus("current")
_TmnxLudbMldImpPlcyName_Type = TPolicyStatementName
_TmnxLudbMldImpPlcyName_Object = MibTableColumn
tmnxLudbMldImpPlcyName = _TmnxLudbMldImpPlcyName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 47, 1, 1),
    _TmnxLudbMldImpPlcyName_Type()
)
tmnxLudbMldImpPlcyName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxLudbMldImpPlcyName.setStatus("current")
_TmnxLudbMldImpPlcyRowStatus_Type = RowStatus
_TmnxLudbMldImpPlcyRowStatus_Object = MibTableColumn
tmnxLudbMldImpPlcyRowStatus = _TmnxLudbMldImpPlcyRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 47, 1, 2),
    _TmnxLudbMldImpPlcyRowStatus_Type()
)
tmnxLudbMldImpPlcyRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxLudbMldImpPlcyRowStatus.setStatus("current")
_TmnxLudbMldImpPlcyLastCh_Type = TimeStamp
_TmnxLudbMldImpPlcyLastCh_Object = MibTableColumn
tmnxLudbMldImpPlcyLastCh = _TmnxLudbMldImpPlcyLastCh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 51, 1, 47, 1, 3),
    _TmnxLudbMldImpPlcyLastCh_Type()
)
tmnxLudbMldImpPlcyLastCh.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxLudbMldImpPlcyLastCh.setStatus("current")
...
tmnxLudbRipPlcyV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 33)
)
tmnxLudbRipPlcyV13v0Group.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2RipPolicy"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2RipPolicy"))
)
if mibBuilder.loadTexts:
    tmnxLudbRipPlcyV13v0Group.setStatus("current")

tmnxLudbDiameterAuthPlcyGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 34)
)
tmnxLudbDiameterAuthPlcyGroup.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2DiameterAuthPolicy"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2DiameterAuthPolicy"))
)
if mibBuilder.loadTexts:
    tmnxLudbDiameterAuthPlcyGroup.setStatus("current")

tmnxLocalUserDbPppoeDfGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 35)
)
tmnxLocalUserDbPppoeDfGroup.setObjects(
    ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2IgnoreDfBit")
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbPppoeDfGroup.setStatus("current")

tmnxLocalUserDbPppoeV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 36)
)
tmnxLocalUserDbPppoeV14v0Group.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2UserDb"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeDerivedId"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeAuthDerivedId"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbPppoeV14v0Group.setStatus("current")

tmnxLocalUserDbIpoeV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 37)
)
tmnxLocalUserDbIpoeV14v0Group.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpIpPrefixAddrType"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpIpPrefixAddr"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpIpPrefixLength"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbIpoeV14v0Group.setStatus("current")

tmnxLudbToServerOptGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 38)
)
tmnxLudbToServerOptGroup.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToServerOptTableLstCh"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToServerOptRowStatus"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToServerOptLastCh"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToServerOptType"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToServerOptValue"))
)
if mibBuilder.loadTexts:
    tmnxLudbToServerOptGroup.setStatus("current")

tmnxLocalUserDbV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 39)
)
tmnxLocalUserDbV14v0Group.setObjects(
    ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbCreationOrigin")
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbV14v0Group.setStatus("current")

tmnxLocalUserDbPppoeV15v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 40)
)
tmnxLocalUserDbPppoeV15v0Group.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2SteeringProfStr"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2PadiAuthPolicy"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2RtrAdvPlcy"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbPppoeV15v0Group.setStatus("current")

tmnxLocalUserDbV15v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 41)
)
tmnxLocalUserDbV15v0Group.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2WppPortalGroupName"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbMldImpPlcyTableLstCh"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbMldImpPlcyRowStatus"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbMldImpPlcyLastCh"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2RtrAdvPlcy"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2Service"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2Interface"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbV15v0Group.setStatus("current")

tmnxLocalUserDbV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 42)
)
tmnxLocalUserDbV16v0Group.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpSpiGroupId"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2SpiGroupId"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbRadproxCacheServiceName"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2GrpIfServiceName"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2RetailerServiceName"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2IdentServiceName"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2RetailerServiceName"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2GrpIfServiceName"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2L2tpGroupServiceName"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeOptionDisplay"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpOptionDisplay"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToClntOptDisplay"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToServerOptDisplay"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpOption6Display"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppOption6Display"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbV16v0Group.setStatus("current")

tmnxLocalUserDbV20v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 2, 43)
)
tmnxLocalUserDbV20v0Group.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2EncTagRgOuterStart"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2EncTagRgOuterEnd"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2EncTagRgInnerStart"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDhcp2EncTagRgInnerEnd"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2EncTagRgOuterStart"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2EncTagRgOuterEnd"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2EncTagRgInnerStart"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbPpp2EncTagRgInnerEnd"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnDerivedId"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnEncTagRgType"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnEncTagRgStart"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnEncTagRgEnd"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnEncTagRgOutSta"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnEncTagRgOutEnd"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnEncTagRgInnSta"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnEncTagRgInnEnd"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnIpPrefAddrType"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnIpPrefAddr"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbDhcpUnIpPrefLength"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeUnDerivedId"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeUnEncTgRgType"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeUnEncTgRgStart"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeUnEncTgRgEnd"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeUnEncTgRgOutSta"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeUnEncTgRgOutEnd"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeUnEncTgRgInnSta"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocUsrDbPppoeUnEncTgRgInnEnd"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbV20v0Group.setStatus("current")
...
tmnxLocalUserDbV13v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 1, 9)
)
tmnxLocalUserDbV13v0Compliance.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbV7v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeV8v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeV9v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbDhcpV8v0Group"),
        ...
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeV12v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToClntOptGroup"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbRipPlcyV13v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDiameterAuthPlcyGroup"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeDfGroup"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbV13v0Compliance.setStatus(
        "obsolete"
    )

tmnxLocalUserDbV14v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 1, 10)
)
tmnxLocalUserDbV14v0Compliance.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbV7v0Group"),
        ...
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbRadproxV12v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeV12v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeV14v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToClntOptGroup"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbToServerOptGroup"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbRipPlcyV13v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLudbDiameterAuthPlcyGroup"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeDfGroup"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbIpoeV14v0Group"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbV14v0Compliance.setStatus(
        "obsolete"
    )

tmnxLocalUserDbV15v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 1, 11)
)
tmnxLocalUserDbV15v0Compliance.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeV15v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbV15v0Group"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbV15v0Compliance.setStatus(
        "obsolete"
    )

tmnxLocalUserDbV16v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 1, 12)
)
tmnxLocalUserDbV16v0Compliance.setObjects(
      *(("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbV7v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbV14v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeV8v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeV9v0Group"),
        ...
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbPppoeV15v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbV15v0Group"),
        ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbV16v0Group"))
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbV16v0Compliance.setStatus(
        "current"
    )

tmnxLocalUserDbV20v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 51, 1, 13)
)
tmnxLocalUserDbV20v0Compliance.setObjects(
    ("TIMETRA-LOCAL-USER-DB-MIB", "tmnxLocalUserDbV20v0Group")
)
if mibBuilder.loadTexts:
    tmnxLocalUserDbV20v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TmnxLocUsrDbUserNameFormat": TmnxLocUsrDbUserNameFormat,
       ...
       "tmnxLocalUserDbV13v0Compliance": tmnxLocalUserDbV13v0Compliance,
       "tmnxLocalUserDbV14v0Compliance": tmnxLocalUserDbV14v0Compliance,
       "tmnxLocalUserDbV15v0Compliance": tmnxLocalUserDbV15v0Compliance,
       "tmnxLocalUserDbV16v0Compliance": tmnxLocalUserDbV16v0Compliance,
       "tmnxLocalUserDbV20v0Compliance": tmnxLocalUserDbV20v0Compliance,
       ...
       "tmnxLudbRipPlcyV13v0Group": tmnxLudbRipPlcyV13v0Group,
       "tmnxLudbDiameterAuthPlcyGroup": tmnxLudbDiameterAuthPlcyGroup,
       "tmnxLocalUserDbPppoeDfGroup": tmnxLocalUserDbPppoeDfGroup,
       "tmnxLocalUserDbPppoeV14v0Group": tmnxLocalUserDbPppoeV14v0Group,
       "tmnxLocalUserDbIpoeV14v0Group": tmnxLocalUserDbIpoeV14v0Group,
       "tmnxLudbToServerOptGroup": tmnxLudbToServerOptGroup,
       "tmnxLocalUserDbV14v0Group": tmnxLocalUserDbV14v0Group,
       "tmnxLocalUserDbPppoeV15v0Group": tmnxLocalUserDbPppoeV15v0Group,
       "tmnxLocalUserDbV15v0Group": tmnxLocalUserDbV15v0Group,
       "tmnxLocalUserDbV16v0Group": tmnxLocalUserDbV16v0Group,
       "tmnxLocalUserDbV20v0Group": tmnxLocalUserDbV20v0Group,
       ...
       "tmnxLocUsrDbCreationOrigin": tmnxLocUsrDbCreationOrigin,
       ...
       "tmnxLocUsrDbPppoeDerivedId": tmnxLocUsrDbPppoeDerivedId,
       ...
       "tmnxLocUsrDbPppoeUnDerivedId": tmnxLocUsrDbPppoeUnDerivedId,
       "tmnxLocUsrDbPppoeUnEncTgRgType": tmnxLocUsrDbPppoeUnEncTgRgType,
       "tmnxLocUsrDbPppoeUnEncTgRgStart": tmnxLocUsrDbPppoeUnEncTgRgStart,
       "tmnxLocUsrDbPppoeUnEncTgRgEnd": tmnxLocUsrDbPppoeUnEncTgRgEnd,
       "tmnxLocUsrDbPppoeUnEncTgRgOutSta": tmnxLocUsrDbPppoeUnEncTgRgOutSta,
       "tmnxLocUsrDbPppoeUnEncTgRgOutEnd": tmnxLocUsrDbPppoeUnEncTgRgOutEnd,
       "tmnxLocUsrDbPppoeUnEncTgRgInnSta": tmnxLocUsrDbPppoeUnEncTgRgInnSta,
       "tmnxLocUsrDbPppoeUnEncTgRgInnEnd": tmnxLocUsrDbPppoeUnEncTgRgInnEnd,
       ...
       "tmnxLocUsrDbPppoeOptionDisplay": tmnxLocUsrDbPppoeOptionDisplay,
       ...
       "tmnxLocUsrDbDhcpIpPrefixAddrType": tmnxLocUsrDbDhcpIpPrefixAddrType,
       "tmnxLocUsrDbDhcpIpPrefixAddr": tmnxLocUsrDbDhcpIpPrefixAddr,
       "tmnxLocUsrDbDhcpIpPrefixLength": tmnxLocUsrDbDhcpIpPrefixLength,
       "tmnxLocUsrDbDhcpSpiGroupId": tmnxLocUsrDbDhcpSpiGroupId,
       ...
       "tmnxLocUsrDbDhcpUnDerivedId": tmnxLocUsrDbDhcpUnDerivedId,
       "tmnxLocUsrDbDhcpUnEncTagRgType": tmnxLocUsrDbDhcpUnEncTagRgType,
       "tmnxLocUsrDbDhcpUnEncTagRgStart": tmnxLocUsrDbDhcpUnEncTagRgStart,
       "tmnxLocUsrDbDhcpUnEncTagRgEnd": tmnxLocUsrDbDhcpUnEncTagRgEnd,
       "tmnxLocUsrDbDhcpUnIpPrefAddrType": tmnxLocUsrDbDhcpUnIpPrefAddrType,
       "tmnxLocUsrDbDhcpUnIpPrefAddr": tmnxLocUsrDbDhcpUnIpPrefAddr,
       "tmnxLocUsrDbDhcpUnIpPrefLength": tmnxLocUsrDbDhcpUnIpPrefLength,
       "tmnxLocUsrDbDhcpUnEncTagRgOutSta": tmnxLocUsrDbDhcpUnEncTagRgOutSta,
       "tmnxLocUsrDbDhcpUnEncTagRgOutEnd": tmnxLocUsrDbDhcpUnEncTagRgOutEnd,
       "tmnxLocUsrDbDhcpUnEncTagRgInnSta": tmnxLocUsrDbDhcpUnEncTagRgInnSta,
       "tmnxLocUsrDbDhcpUnEncTagRgInnEnd": tmnxLocUsrDbDhcpUnEncTagRgInnEnd,
       ...
       "tmnxLocUsrDbDhcpOptionDisplay": tmnxLocUsrDbDhcpOptionDisplay,
       ...
       "tmnxLocUsrDbPppoeAuthDerivedId": tmnxLocUsrDbPppoeAuthDerivedId,
       ...
       "tmnxLudbRadproxCacheServiceName": tmnxLudbRadproxCacheServiceName,
       ...
       "tmnxLocUsrDbDhcpOption6Display": tmnxLocUsrDbDhcpOption6Display,
       ...
       "tmnxLocUsrDbPppOption6Display": tmnxLocUsrDbPppOption6Display,
       ...
       "tmnxLudbDhcp2RipPolicy": tmnxLudbDhcp2RipPolicy,
       "tmnxLudbDhcp2DiameterAuthPolicy": tmnxLudbDhcp2DiameterAuthPolicy,
       "tmnxLudbDhcp2WppPortalGroupName": tmnxLudbDhcp2WppPortalGroupName,
       "tmnxLudbDhcp2RtrAdvPlcy": tmnxLudbDhcp2RtrAdvPlcy,
       "tmnxLudbDhcp2Service": tmnxLudbDhcp2Service,
       "tmnxLudbDhcp2Interface": tmnxLudbDhcp2Interface,
       "tmnxLudbDhcp2GrpIfServiceName": tmnxLudbDhcp2GrpIfServiceName,
       "tmnxLudbDhcp2RetailerServiceName": tmnxLudbDhcp2RetailerServiceName,
       "tmnxLudbDhcp2IdentServiceName": tmnxLudbDhcp2IdentServiceName,
       "tmnxLudbDhcp2EncTagRgOuterStart": tmnxLudbDhcp2EncTagRgOuterStart,
       "tmnxLudbDhcp2EncTagRgOuterEnd": tmnxLudbDhcp2EncTagRgOuterEnd,
       "tmnxLudbDhcp2EncTagRgInnerStart": tmnxLudbDhcp2EncTagRgInnerStart,
       "tmnxLudbDhcp2EncTagRgInnerEnd": tmnxLudbDhcp2EncTagRgInnerEnd,
       ...
       "tmnxLudbPpp2RipPolicy": tmnxLudbPpp2RipPolicy,
       "tmnxLudbPpp2DiameterAuthPolicy": tmnxLudbPpp2DiameterAuthPolicy,
       "tmnxLudbPpp2IgnoreDfBit": tmnxLudbPpp2IgnoreDfBit,
       "tmnxLudbPpp2UserDb": tmnxLudbPpp2UserDb,
       "tmnxLudbPpp2SteeringProfStr": tmnxLudbPpp2SteeringProfStr,
       "tmnxLudbPpp2PadiAuthPolicy": tmnxLudbPpp2PadiAuthPolicy,
       "tmnxLudbPpp2RtrAdvPlcy": tmnxLudbPpp2RtrAdvPlcy,
       "tmnxLudbPpp2SpiGroupId": tmnxLudbPpp2SpiGroupId,
       "tmnxLudbPpp2RetailerServiceName": tmnxLudbPpp2RetailerServiceName,
       "tmnxLudbPpp2GrpIfServiceName": tmnxLudbPpp2GrpIfServiceName,
       "tmnxLudbPpp2L2tpGroupServiceName": tmnxLudbPpp2L2tpGroupServiceName,
       "tmnxLudbPpp2EncTagRgOuterStart": tmnxLudbPpp2EncTagRgOuterStart,
       "tmnxLudbPpp2EncTagRgOuterEnd": tmnxLudbPpp2EncTagRgOuterEnd,
       "tmnxLudbPpp2EncTagRgInnerStart": tmnxLudbPpp2EncTagRgInnerStart,
       "tmnxLudbPpp2EncTagRgInnerEnd": tmnxLudbPpp2EncTagRgInnerEnd,
       ...
       "tmnxLudbToClntOptDisplay": tmnxLudbToClntOptDisplay,
       "tmnxLudbToServerOptTableLstCh": tmnxLudbToServerOptTableLstCh,
       "tmnxLudbToServerOptTable": tmnxLudbToServerOptTable,
       "tmnxLudbToServerOptEntry": tmnxLudbToServerOptEntry,
       "tmnxLudbToServerOptAddrType": tmnxLudbToServerOptAddrType,
       "tmnxLudbToServerOptNumber": tmnxLudbToServerOptNumber,
       "tmnxLudbToServerOptRowStatus": tmnxLudbToServerOptRowStatus,
       "tmnxLudbToServerOptLastCh": tmnxLudbToServerOptLastCh,
       "tmnxLudbToServerOptType": tmnxLudbToServerOptType,
       "tmnxLudbToServerOptValue": tmnxLudbToServerOptValue,
       "tmnxLudbToServerOptDisplay": tmnxLudbToServerOptDisplay,
       "tmnxLudbMldImpPlcyTableLstCh": tmnxLudbMldImpPlcyTableLstCh,
       "tmnxLudbMldImpPlcyTable": tmnxLudbMldImpPlcyTable,
       "tmnxLudbMldImpPlcyEntry": tmnxLudbMldImpPlcyEntry,
       "tmnxLudbMldImpPlcyName": tmnxLudbMldImpPlcyName,
       "tmnxLudbMldImpPlcyRowStatus": tmnxLudbMldImpPlcyRowStatus,
       "tmnxLudbMldImpPlcyLastCh": tmnxLudbMldImpPlcyLastCh,
