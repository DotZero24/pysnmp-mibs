...
# Notes
# -----
# ASN.1 source file://mibs/rfc/IPSEC-SA-MON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:20:27 2025
...
_EspAuthFailureTrapEnable_Type.__name__ = "TruthValue"
...
_AhAuthFailureTrapEnable_Type.__name__ = "TruthValue"
...
_EspReplayFailureTrapEnable_Type.__name__ = "TruthValue"
...
_AhReplayFailureTrapEnable_Type.__name__ = "TruthValue"
...
_EspPolicyFailureTrapEnable_Type.__name__ = "TruthValue"
...
_AhPolicyFailureTrapEnable_Type.__name__ = "TruthValue"
...
_InvalidSpiTrapEnable_Type.__name__ = "TruthValue"
...
_OtherPolicyFailureTrapEnable_Type.__name__ = "TruthValue"
...
ipsecSaMonitorCompliance = ModuleCompliance(
    (1, 3, 6, 1, 2, 1, 500, 1, 8, 1)
)
ipsecSaMonitorCompliance.setObjects(
      *(("IPSEC-SA-MON-MIB", "ipsecSaEspGroup"),
        ("IPSEC-SA-MON-MIB", "ipsecSaAhGroup"),
        ("IPSEC-SA-MON-MIB", "ipsecSaErrorsGroup"),
        ("IPSEC-SA-MON-MIB", "ipsecSaFailureTrapEnableGroup"),
        ("IPSEC-SA-MON-MIB", "ipsecSaFailureTrapGroup"))
)
if mibBuilder.loadTexts:
