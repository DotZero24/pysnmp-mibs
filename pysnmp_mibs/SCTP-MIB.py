...
mibBuilder.exportSymbols("SCTP-MIB", sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpAssocRemHostName=sctpAssocRemHostName, sctpRtoMax=sctpRtoMax, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpMibCompliance=sctpMibCompliance, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpAborteds=sctpAborteds, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpStatsGroup=sctpStatsGroup, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpAssocRemPort=sctpAssocRemPort, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpAssocInStreams=sctpAssocInStreams, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpAssocT2expireds=sctpAssocT2expireds, sctpAssocOutStreams=sctpAssocOutStreams, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpParams=sctpParams, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpAssocId=sctpAssocId, sctpAssocLocalPort=sctpAssocLocalPort, sctpInverseGroup=sctpInverseGroup, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpMaxInitRetr=sctpMaxInitRetr, sctpActiveEstabs=sctpActiveEstabs, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpPassiveEstabs=sctpPassiveEstabs, sctpAssocEntry=sctpAssocEntry, sctpOutOfBlues=sctpOutOfBlues, sctpObjects=sctpObjects, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpInOrderChunks=sctpInOrderChunks, sctpMIB=sctpMIB, sctpStats=sctpStats, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpInCtrlChunks=sctpInCtrlChunks, sctpChecksumErrors=sctpChecksumErrors, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpAssocState=sctpAssocState, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpMibConformance=sctpMibConformance, sctpShutdowns=sctpShutdowns, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpMibGroups=sctpMibGroups, sctpAssocT1expireds=sctpAssocT1expireds, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpInSCTPPacks=sctpInSCTPPacks, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpMaxAssocs=sctpMaxAssocs, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpRtoMin=sctpRtoMin, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpMibCompliances=sctpMibCompliances, sctpOutOrderChunks=sctpOutOrderChunks, sctpAssocStartTime=sctpAssocStartTime, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpCurrEstab=sctpCurrEstab, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, PYSNMP_MODULE_ID=sctpMIB, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpValCookieLife=sctpValCookieLife, sctpAssocTable=sctpAssocTable, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpRtoInitial=sctpRtoInitial, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpAssocRemAddr=sctpAssocRemAddr, sctpInUnorderChunks=sctpInUnorderChunks, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime)
