# SNMP MIB module (SNTP-CLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/quanta/SNTP-CLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:12:51 2025
...
agentSntpClientTimeZone = _AgentSntpClientTimeZone_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 2)
)


class _AgentSNTPConfigTimeZoneName_Type(DisplayString):
    """Custom type agentSNTPConfigTimeZoneName based on DisplayString"""
...
_AgentSNTPConfigTimeZoneName_Type.__name__ = "DisplayString"
_AgentSNTPConfigTimeZoneName_Object = MibScalar
agentSNTPConfigTimeZoneName = _AgentSNTPConfigTimeZoneName_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 2, 1),
    _AgentSNTPConfigTimeZoneName_Type()
)
agentSNTPConfigTimeZoneName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSNTPConfigTimeZoneName.setStatus("current")


class _AgentSNTPConfigTimeZoneTimeOffsetHour_Type(Integer32):
    """Custom type agentSNTPConfigTimeZoneTimeOffsetHour based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentSNTPConfigTimeZoneTimeOffsetHour_Type.__name__ = "Integer32"
_AgentSNTPConfigTimeZoneTimeOffsetHour_Object = MibScalar
agentSNTPConfigTimeZoneTimeOffsetHour = _AgentSNTPConfigTimeZoneTimeOffsetHour_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 2, 2),
    _AgentSNTPConfigTimeZoneTimeOffsetHour_Type()
)
agentSNTPConfigTimeZoneTimeOffsetHour.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSNTPConfigTimeZoneTimeOffsetHour.setStatus("current")


class _AgentSNTPConfigTimeZoneTimeOffsetMinute_Type(Unsigned32):
    """Custom type agentSNTPConfigTimeZoneTimeOffsetMinute based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentSNTPConfigTimeZoneTimeOffsetMinute_Type.__name__ = "Unsigned32"
_AgentSNTPConfigTimeZoneTimeOffsetMinute_Object = MibScalar
agentSNTPConfigTimeZoneTimeOffsetMinute = _AgentSNTPConfigTimeZoneTimeOffsetMinute_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 2, 3),
    _AgentSNTPConfigTimeZoneTimeOffsetMinute_Type()
)
agentSNTPConfigTimeZoneTimeOffsetMinute.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSNTPConfigTimeZoneTimeOffsetMinute.setStatus("current")


class _AgentSNTPConfigTimeZoneUTCArea_Type(Integer32):
    """Custom type agentSNTPConfigTimeZoneUTCArea based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentSNTPConfigTimeZoneUTCArea_Type.__name__ = "Integer32"
_AgentSNTPConfigTimeZoneUTCArea_Object = MibScalar
agentSNTPConfigTimeZoneUTCArea = _AgentSNTPConfigTimeZoneUTCArea_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 2, 4),
    _AgentSNTPConfigTimeZoneUTCArea_Type()
)
agentSNTPConfigTimeZoneUTCArea.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSNTPConfigTimeZoneUTCArea.setStatus("current")
_AgentSntpClientUnicast_ObjectIdentity = ObjectIdentity
agentSntpClientUnicast = _AgentSntpClientUnicast_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3)
)
...
class _AgentSntpClientUcastServerMaxEntries_Type(Unsigned32):
    """Custom type agentSntpClientUcastServerMaxEntries based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentSntpClientUcastServerMaxEntries_Type.__name__ = "Unsigned32"
...
agentSntpClientUcastServerEntry = _AgentSntpClientUcastServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1)
)
agentSntpClientUcastServerEntry.setIndexNames(
    (0, "SNTP-CLIENT-MIB", "agentSntpClientUcastServerIndex"),
)
if mibBuilder.loadTexts:
...
agentSntpClientUcastServerIndex = _AgentSntpClientUcastServerIndex_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 1),
...
agentSntpClientUcastServerAddressType = _AgentSntpClientUcastServerAddressType_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 2),
...
agentSntpClientUcastServerPort = _AgentSntpClientUcastServerPort_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 4),
...
agentSntpClientUcastServerVersion = _AgentSntpClientUcastServerVersion_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 5),
...
agentSntpClientUcastServerPrecedence = _AgentSntpClientUcastServerPrecedence_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 6),
...
agentSntpClientUcastServerLastUpdateTime = _AgentSntpClientUcastServerLastUpdateTime_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 7),
...
agentSntpClientUcastServerLastAttemptTime = _AgentSntpClientUcastServerLastAttemptTime_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 8),
...
agentSntpClientUcastServerLastAttemptStatus = _AgentSntpClientUcastServerLastAttemptStatus_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 9),
...
agentSntpClientUcastServerNumRequests = _AgentSntpClientUcastServerNumRequests_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 10),
...
agentSntpClientUcastServerNumFailedRequests = _AgentSntpClientUcastServerNumFailedRequests_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 11),
...
agentSntpClientUcastServerRowStatus = _AgentSntpClientUcastServerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 3, 6, 1, 12),
...
agentSntpClientMulticast = _AgentSntpClientMulticast_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 5)
)
_AgentSntpClientMulticastCount_Type = Counter32
_AgentSntpClientMulticastCount_Object = MibScalar
agentSntpClientMulticastCount = _AgentSntpClientMulticastCount_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 5, 1),
    _AgentSntpClientMulticastCount_Type()
)
agentSntpClientMulticastCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agentSntpClientMulticastCount.setStatus("current")


class _AgentSntpClientMulticastInterval_Type(Unsigned32):
    """Custom type agentSntpClientMulticastInterval based on Unsigned32"""
    defaultValue = 6
...
_AgentSntpClientMulticastInterval_Type.__name__ = "Unsigned32"
_AgentSntpClientMulticastInterval_Object = MibScalar
agentSntpClientMulticastInterval = _AgentSntpClientMulticastInterval_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 1, 5, 2),
    _AgentSntpClientMulticastInterval_Type()
)
agentSntpClientMulticastInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSntpClientMulticastInterval.setStatus("current")
if mibBuilder.loadTexts:
    agentSntpClientMulticastInterval.setUnits("seconds")
...
agentSntpClientCompliances = _AgentSntpClientCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 2, 2)
)

# Managed Objects groups

agentSntpClientDeviceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 2, 1, 1)
)
agentSntpClientDeviceGroup.setObjects(
      *(("SNTP-CLIENT-MIB", "agentSntpClientVersion"),
        ("SNTP-CLIENT-MIB", "agentSntpClientSupportedMode"),
        ("SNTP-CLIENT-MIB", "agentSntpClientMode"),
        ("SNTP-CLIENT-MIB", "agentSntpClientLastUpdateTime"),
        ("SNTP-CLIENT-MIB", "agentSntpClientLastAttemptTime"),
        ("SNTP-CLIENT-MIB", "agentSntpClientLastAttemptStatus"),
        ("SNTP-CLIENT-MIB", "agentSntpClientServerAddressType"),
        ("SNTP-CLIENT-MIB", "agentSntpClientServerAddress"),
        ("SNTP-CLIENT-MIB", "agentSntpClientServerMode"),
        ("SNTP-CLIENT-MIB", "agentSntpClientServerStratum"),
        ("SNTP-CLIENT-MIB", "agentSntpClientServerRefClkId"))
)
if mibBuilder.loadTexts:
    agentSntpClientDeviceGroup.setStatus("current")

agentSntpClientUnicastGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 2, 1, 2)
)
agentSntpClientUnicastGroup.setObjects(
      *(("SNTP-CLIENT-MIB", "agentSntpClientUnicastPollInterval"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUnicastPollTimeout"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUnicastPollRetry"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUcastServerMaxEntries"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUcastServerCurrEntries"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUcastServerAddress"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUcastServerAddressType"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUcastServerPrecedence"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUcastServerLastUpdateTime"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUcastServerLastAttemptTime"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUcastServerLastAttemptStatus"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUcastServerNumRequests"),
...
agentSntpClientBroadcastGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 2, 1, 3)
)
agentSntpClientBroadcastGroup.setObjects(
      *(("SNTP-CLIENT-MIB", "agentSntpClientBroadcastCount"),
        ("SNTP-CLIENT-MIB", "agentSntpClientBroadcastInterval"))
)
if mibBuilder.loadTexts:
...
agentSntpClientCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 7244, 2, 17, 2, 2, 1)
)
agentSntpClientCompliance.setObjects(
      *(("SNTP-CLIENT-MIB", "agentSntpClientDeviceGroup"),
        ("SNTP-CLIENT-MIB", "agentSntpClientUnicastGroup"),
        ("SNTP-CLIENT-MIB", "agentSntpClientBroadcastGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"SntpClientAdminMode": SntpClientAdminMode,
       ...
       "agentSntpClientTimeZone": agentSntpClientTimeZone,
       "agentSNTPConfigTimeZoneName": agentSNTPConfigTimeZoneName,
       "agentSNTPConfigTimeZoneTimeOffsetHour": agentSNTPConfigTimeZoneTimeOffsetHour,
       "agentSNTPConfigTimeZoneTimeOffsetMinute": agentSNTPConfigTimeZoneTimeOffsetMinute,
       "agentSNTPConfigTimeZoneUTCArea": agentSNTPConfigTimeZoneUTCArea,
       ...
       "agentSntpClientMulticast": agentSntpClientMulticast,
       "agentSntpClientMulticastCount": agentSntpClientMulticastCount,
       "agentSntpClientMulticastInterval": agentSntpClientMulticastInterval,
