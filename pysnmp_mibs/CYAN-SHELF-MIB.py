...
CyanSecServiceStateTc, CyanNoYesTc, CyanOpStateTc, CyanOpStateQualTc = mibBuilder.importSymbols("CYAN-TC-MIB", "CyanSecServiceStateTc", "CyanNoYesTc", "CyanOpStateTc", "CyanOpStateQualTc")
...
mibBuilder.exportSymbols("CYAN-SHELF-MIB", cyanShelfRackUnits=cyanShelfRackUnits, cyanShelfMfgPartNumber=cyanShelfMfgPartNumber, PYSNMP_MODULE_ID=cyanShelfModule, cyanShelfModule=cyanShelfModule, cyanShelfEntry=cyanShelfEntry, cyanShelfBaseMacAddress=cyanShelfBaseMacAddress, cyanShelfMfgEciCode=cyanShelfMfgEciCode, cyanShelfFanSpeed=cyanShelfFanSpeed, cyanShelfName=cyanShelfName, cyanShelfOwner=cyanShelfOwner, cyanShelfTable=cyanShelfTable, cyanShelfMacBlockSize=cyanShelfMacBlockSize, cyanShelfCompliance=cyanShelfCompliance, cyanShelfObjectGroup=cyanShelfObjectGroup, cyanShelfMfgCleiCode=cyanShelfMfgCleiCode, cyanShelfFanFilterReplacingIntervalDays=cyanShelfFanFilterReplacingIntervalDays, cyanShelfShelfId=cyanShelfShelfId, cyanShelfRelayRack=cyanShelfRelayRack, cyanShelfBay=cyanShelfBay, cyanShelfDaysSinceLastReplacement=cyanShelfDaysSinceLastReplacement, cyanShelfMfgRevision=cyanShelfMfgRevision, cyanShelfMfgModuleId=cyanShelfMfgModuleId, cyanShelfOperStateQual=cyanShelfOperStateQual, cyanShelfIdentifier=cyanShelfIdentifier, cyanShelfAutoprovisioningFlag=cyanShelfAutoprovisioningFlag, cyanShelfMibObjects=cyanShelfMibObjects, cyanShelfMfgSerialNumber=cyanShelfMfgSerialNumber, cyanShelfSecServState=cyanShelfSecServState, cyanShelfType=cyanShelfType, cyanShelfOperState=cyanShelfOperState, cyanShelfOidClass=cyanShelfOidClass, cyanShelfDescription=cyanShelfDescription, cyanShelfOssLabel=cyanShelfOssLabel, cyanShelfAssetTag=cyanShelfAssetTag)
