...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cyan/CYAN-SHELF-MIB
...
CyanOpStateTc, CyanOpStateQualTc, CyanNoYesTc, CyanSecServiceStateTc = mibBuilder.importSymbols("CYAN-TC-MIB", "CyanOpStateTc", "CyanOpStateQualTc", "CyanNoYesTc", "CyanSecServiceStateTc")
...
mibBuilder.exportSymbols("CYAN-SHELF-MIB", cyanShelfName=cyanShelfName, cyanShelfOperState=cyanShelfOperState, cyanShelfDaysSinceLastReplacement=cyanShelfDaysSinceLastReplacement, cyanShelfMfgSerialNumber=cyanShelfMfgSerialNumber, cyanShelfMfgModuleId=cyanShelfMfgModuleId, cyanShelfEntry=cyanShelfEntry, cyanShelfCompliance=cyanShelfCompliance, cyanShelfOperStateQual=cyanShelfOperStateQual, cyanShelfType=cyanShelfType, cyanShelfTable=cyanShelfTable, cyanShelfIdentifier=cyanShelfIdentifier, cyanShelfOssLabel=cyanShelfOssLabel, cyanShelfDescription=cyanShelfDescription, cyanShelfFanSpeed=cyanShelfFanSpeed, PYSNMP_MODULE_ID=cyanShelfModule, cyanShelfMacBlockSize=cyanShelfMacBlockSize, cyanShelfShelfId=cyanShelfShelfId, cyanShelfMfgCleiCode=cyanShelfMfgCleiCode, cyanShelfRackUnits=cyanShelfRackUnits, cyanShelfAssetTag=cyanShelfAssetTag, cyanShelfMfgPartNumber=cyanShelfMfgPartNumber, cyanShelfRelayRack=cyanShelfRelayRack, cyanShelfOwner=cyanShelfOwner, cyanShelfMibObjects=cyanShelfMibObjects, cyanShelfMfgEciCode=cyanShelfMfgEciCode, cyanShelfBay=cyanShelfBay, cyanShelfBaseMacAddress=cyanShelfBaseMacAddress, cyanShelfMfgRevision=cyanShelfMfgRevision, cyanShelfSecServState=cyanShelfSecServState, cyanShelfOidClass=cyanShelfOidClass, cyanShelfFanFilterReplacingIntervalDays=cyanShelfFanFilterReplacingIntervalDays, cyanShelfObjectGroup=cyanShelfObjectGroup, cyanShelfAutoprovisioningFlag=cyanShelfAutoprovisioningFlag, cyanShelfModule=cyanShelfModule)
