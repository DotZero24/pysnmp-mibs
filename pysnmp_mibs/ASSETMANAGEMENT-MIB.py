...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/raritan/ASSETMANAGEMENT-MIB
...
assetStripCascadePosition = MibTableColumn((1, 3, 6, 1, 4, 1, 13742, 7, 1, 7, 1, 1, 13), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 99))).setMaxAccess("readonly")
if mibBuilder.loadTexts: assetStripCascadePosition.setStatus('current')
rackUnitRelativePosition = MibTableColumn((1, 3, 6, 1, 4, 1, 13742, 7, 1, 7, 1, 1, 14), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 99))).setMaxAccess("readonly")
if mibBuilder.loadTexts: rackUnitRelativePosition.setStatus('current')
assetStripNumberOfRackUnits = MibTableColumn((1, 3, 6, 1, 4, 1, 13742, 7, 1, 7, 1, 1, 15), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 256))).setMaxAccess("readonly")
...
logAssetStripNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 13742, 7, 3, 2, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 256))).setMaxAccess("readonly")
if mibBuilder.loadTexts: logAssetStripNumber.setStatus('current')
logRackUnitNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 13742, 7, 3, 2, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 256))).setMaxAccess("readonly")
...
deviceName = MibScalar((1, 3, 6, 1, 4, 1, 13742, 7, 0, 0, 1), DisplayString()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: deviceName.setStatus('current')
deviceInetAddressType = MibScalar((1, 3, 6, 1, 4, 1, 13742, 7, 0, 0, 2), InetAddressType()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: deviceInetAddressType.setStatus('current')
deviceInetIPAddress = MibScalar((1, 3, 6, 1, 4, 1, 13742, 7, 0, 0, 3), InetAddress()).setMaxAccess("accessiblefornotify")
...
deviceUserName = MibScalar((1, 3, 6, 1, 4, 1, 13742, 7, 0, 0, 7), DisplayString()).setMaxAccess("accessiblefornotify")
...
mibBuilder.exportSymbols("ASSETMANAGEMENT-MIB", assetStripFirmwareUpdateState=assetStripFirmwareUpdateState, assetManagementTable=assetManagementTable, assetManagementGroup=assetManagementGroup, assetStripCount=assetStripCount, numberOfComponentAssetStrips=numberOfComponentAssetStrips, logSlotNumber=logSlotNumber, configGroup=configGroup, tagID=tagID, oldNumberOfComponentAssetStrips=oldNumberOfComponentAssetStrips, assetStripConfigurationEntry=assetStripConfigurationEntry, bladeSlotPosition=bladeSlotPosition, maxBladeTagCount=maxBladeTagCount, assetStripNumberOfRackUnits=assetStripNumberOfRackUnits, assetStripDefaultLEDColorConnected=assetStripDefaultLEDColorConnected, assetStripFirmwareUpdate=assetStripFirmwareUpdate, defaultLEDColorDisconnectedStr=defaultLEDColorDisconnectedStr, rackUnitNumber=rackUnitNumber, assetStripName=assetStripName, assetStripID=assetStripID, bladeExtensionEntry=bladeExtensionEntry, logParentBladeID=logParentBladeID, assetStripStateChange=assetStripStateChange, raritan=raritan, assetTagDisconnected=assetTagDisconnected, assetManagement=assetManagement, assetStripDefaultLEDColorDisconnectedStr=assetStripDefaultLEDColorDisconnectedStr, assetStripCascadePosition=assetStripCascadePosition, newestLogID=newestLogID, defaultLEDColorDisconnected=defaultLEDColorDisconnected, defaultLEDColorConnected=defaultLEDColorConnected, conformance=conformance, RackUnitNumberingModeEnumeration=RackUnitNumberingModeEnumeration, deviceSerialNumber=deviceSerialNumber, logGroup=logGroup, logConfiguration=logConfiguration, trapInformation=trapInformation, rackUnitCount=rackUnitCount, assetStripDefaultLEDColorDisconnected=assetStripDefaultLEDColorDisconnected, bladeSlotID=bladeSlotID, logSize=logSize, logEventCount=logEventCount, logRackUnitNumber=logRackUnitNumber, log=log, rackUnitNumberingMode=rackUnitNumberingMode, logEventType=logEventType, assetStripDefaultLEDColorConnectedStr=assetStripDefaultLEDColorConnectedStr, defaultLEDColorConnectedStr=defaultLEDColorConnectedStr, deviceInetAddressType=deviceInetAddressType, assetStripNumber=assetStripNumber, bladeExtensionOverflowCleared=bladeExtensionOverflowCleared, assetStrip=assetStrip, RackUnitTypeEnumeration=RackUnitTypeEnumeration, deviceChangedParameter=deviceChangedParameter, RGBCOLOR=RGBCOLOR, assetStripState=assetStripState, trapInformationGroup=trapInformationGroup, maxMainTagCount=maxMainTagCount, assetTagConnected=assetTagConnected, bladeExtensionDisconnected=bladeExtensionDisconnected, ledColor=ledColor, ledMode=ledMode, slotNumber=slotNumber, bladeTagID=bladeTagID, trapsGroup=trapsGroup, logAssetStripNumber=logAssetStripNumber, bladeExtensionOverflowOccured=bladeExtensionOverflowOccured, groups=groups, bladeExtensionTable=bladeExtensionTable, configuration=configuration, tagFamily=tagFamily, configGroup2=configGroup2, ledOperationMode=ledOperationMode, DeviceConfigurationParameterEnumeration=DeviceConfigurationParameterEnumeration, assetStripConfigurationTable=assetStripConfigurationTable, assetStripOrientation=assetStripOrientation, agentInetPortNumber=agentInetPortNumber, compositeAssetStripCompositionChanged=compositeAssetStripCompositionChanged, rackUnitRelativePosition=rackUnitRelativePosition, AssetManagementLEDModeEnumeration=AssetManagementLEDModeEnumeration, logTagID=logTagID, bladeExtensionConnected=bladeExtensionConnected, deviceInetIPAddress=deviceInetIPAddress, AssetStripTypeEnumeration=AssetStripTypeEnumeration, AssetStripFirmwareUpdateStateEnumeration=AssetStripFirmwareUpdateStateEnumeration, PYSNMP_MODULE_ID=raritan, assetManagementLogEntry=assetManagementLogEntry, rackUnitName=rackUnitName, logTimeStamp=logTimeStamp, oldestLogID=oldestLogID, complianceRev1=complianceRev1, currentMainTagCount=currentMainTagCount, AssetManagementLEDOperationModeEnumeration=AssetManagementLEDOperationModeEnumeration, rackUnitID=rackUnitID, compliances=compliances, logRackUnitPosition=logRackUnitPosition, assetManagementEntry=assetManagementEntry, assetStripType=assetStripType, bladeExtensionOverflow=bladeExtensionOverflow, traps=traps, ledColorStr=ledColorStr, rackUnitType=rackUnitType, assetManager=assetManager, rackUnitNumberingOffset=rackUnitNumberingOffset, assetManagementLogTable=assetManagementLogTable, changedParameterNewValue=changedParameterNewValue, deviceName=deviceName, rackUnitPosition=rackUnitPosition, logIndex=logIndex, AssetStripOrientationEnumeration=AssetStripOrientationEnumeration, deviceUserName=deviceUserName, rackUnitConfigurationChanged=rackUnitConfigurationChanged, AssetStripStateEnumeration=AssetStripStateEnumeration, LogEventTypeEnumeration=LogEventTypeEnumeration, bladeExtensionSize=bladeExtensionSize, logAssetStripState=logAssetStripState, currentBladeTagCount=currentBladeTagCount, complianceRev2=complianceRev2, deviceConfigurationChanged=deviceConfigurationChanged)
