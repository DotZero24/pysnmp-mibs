...
# Notes
# -----
# ASN.1 source file://mibs/raritan/ASSETMANAGEMENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:21:13 2025
...
deviceUserName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
trapInformationGroup.setObjects(
      *(("ASSETMANAGEMENT-MIB", "deviceName"),
        ...
        ("ASSETMANAGEMENT-MIB", "deviceSerialNumber"))
)
if mibBuilder.loadTexts:
...
complianceRev1.setObjects(
      *(("ASSETMANAGEMENT-MIB", "configGroup"),
        ("ASSETMANAGEMENT-MIB", "assetManagementGroup"),
        ("ASSETMANAGEMENT-MIB", "trapInformationGroup"),
        ("ASSETMANAGEMENT-MIB", "trapsGroup"),
        ("ASSETMANAGEMENT-MIB", "logGroup"))
)
if mibBuilder.loadTexts:
...
complianceRev2.setObjects(
      *(("ASSETMANAGEMENT-MIB", "configGroup2"),
        ("ASSETMANAGEMENT-MIB", "assetManagementGroup"),
        ("ASSETMANAGEMENT-MIB", "trapInformationGroup"),
        ("ASSETMANAGEMENT-MIB", "trapsGroup"))
)
