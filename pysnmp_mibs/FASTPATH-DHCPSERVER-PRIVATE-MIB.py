...
_Q='agentDhcpServerLeaseIPAddress'
...
_H='disable'
_G='enable'
_F='FASTPATH-DHCPSERVER-PRIVATE-MIB'
_E='DisplayString'
_D='Integer32'
_C='read-only'
_B='read-write'
...
if mibBuilder.loadTexts:fastPathDHCPServerPrivate.setRevisions(('2007-05-23 00:00',))
_AgentDhcpServerGroup_ObjectIdentity=ObjectIdentity
agentDhcpServerGroup=_AgentDhcpServerGroup_ObjectIdentity((1,3,6,1,4,1,4413,1,1,12,1))
class _AgentDhcpServerAdminMode_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_G,1),(_H,2)))
_AgentDhcpServerAdminMode_Type.__name__=_D
_AgentDhcpServerAdminMode_Object=MibScalar
agentDhcpServerAdminMode=_AgentDhcpServerAdminMode_Object((1,3,6,1,4,1,4413,1,1,12,1,1),_AgentDhcpServerAdminMode_Type())
...
agentDhcpServerPingPktNos=_AgentDhcpServerPingPktNos_Object((1,3,6,1,4,1,4413,1,1,12,1,2),_AgentDhcpServerPingPktNos_Type())
...
agentDhcpServerAutomaticBindingsNos=_AgentDhcpServerAutomaticBindingsNos_Object((1,3,6,1,4,1,4413,1,1,12,1,3),_AgentDhcpServerAutomaticBindingsNos_Type())
...
agentDhcpServerExpiredBindingsNos=_AgentDhcpServerExpiredBindingsNos_Object((1,3,6,1,4,1,4413,1,1,12,1,4),_AgentDhcpServerExpiredBindingsNos_Type())
...
agentDhcpServerMalformedMessagesReceived=_AgentDhcpServerMalformedMessagesReceived_Object((1,3,6,1,4,1,4413,1,1,12,1,5),_AgentDhcpServerMalformedMessagesReceived_Type())
...
agentDhcpServerDISCOVERMessagesReceived=_AgentDhcpServerDISCOVERMessagesReceived_Object((1,3,6,1,4,1,4413,1,1,12,1,6),_AgentDhcpServerDISCOVERMessagesReceived_Type())
...
agentDhcpServerREQUESTMessagesReceived=_AgentDhcpServerREQUESTMessagesReceived_Object((1,3,6,1,4,1,4413,1,1,12,1,7),_AgentDhcpServerREQUESTMessagesReceived_Type())
...
agentDhcpServerDECLINEMessagesReceived=_AgentDhcpServerDECLINEMessagesReceived_Object((1,3,6,1,4,1,4413,1,1,12,1,8),_AgentDhcpServerDECLINEMessagesReceived_Type())
...
agentDhcpServerRELEASEMessagesReceived=_AgentDhcpServerRELEASEMessagesReceived_Object((1,3,6,1,4,1,4413,1,1,12,1,9),_AgentDhcpServerRELEASEMessagesReceived_Type())
...
agentDhcpServerINFORMMessagesReceived=_AgentDhcpServerINFORMMessagesReceived_Object((1,3,6,1,4,1,4413,1,1,12,1,10),_AgentDhcpServerINFORMMessagesReceived_Type())
...
agentDhcpServerOFFERMessagesSent=_AgentDhcpServerOFFERMessagesSent_Object((1,3,6,1,4,1,4413,1,1,12,1,11),_AgentDhcpServerOFFERMessagesSent_Type())
...
agentDhcpServerACKMessagesSent=_AgentDhcpServerACKMessagesSent_Object((1,3,6,1,4,1,4413,1,1,12,1,12),_AgentDhcpServerACKMessagesSent_Type())
...
agentDhcpServerNAKMessagesSent=_AgentDhcpServerNAKMessagesSent_Object((1,3,6,1,4,1,4413,1,1,12,1,13),_AgentDhcpServerNAKMessagesSent_Type())
agentDhcpServerNAKMessagesSent.setMaxAccess(_C)
if mibBuilder.loadTexts:agentDhcpServerNAKMessagesSent.setStatus(_A)
class _AgentDhcpServerClearStatistics_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_G,1),(_H,2)))
_AgentDhcpServerClearStatistics_Type.__name__=_D
_AgentDhcpServerClearStatistics_Object=MibScalar
agentDhcpServerClearStatistics=_AgentDhcpServerClearStatistics_Object((1,3,6,1,4,1,4413,1,1,12,1,14),_AgentDhcpServerClearStatistics_Type())
agentDhcpServerClearStatistics.setMaxAccess(_B)
if mibBuilder.loadTexts:agentDhcpServerClearStatistics.setStatus(_A)
class _AgentDhcpServerBootpAutomatic_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_G,1),(_H,2)))
_AgentDhcpServerBootpAutomatic_Type.__name__=_D
_AgentDhcpServerBootpAutomatic_Object=MibScalar
agentDhcpServerBootpAutomatic=_AgentDhcpServerBootpAutomatic_Object((1,3,6,1,4,1,4413,1,1,12,1,15),_AgentDhcpServerBootpAutomatic_Type())
...
agentDhcpServerPoolConfigGroup=_AgentDhcpServerPoolConfigGroup_ObjectIdentity((1,3,6,1,4,1,4413,1,1,12,2))
...
agentDhcpServerPoolNameCreate=_AgentDhcpServerPoolNameCreate_Object((1,3,6,1,4,1,4413,1,1,12,2,1),_AgentDhcpServerPoolNameCreate_Type())
...
agentDhcpServerPoolConfigTable=_AgentDhcpServerPoolConfigTable_Object((1,3,6,1,4,1,4413,1,1,12,2,2))
if mibBuilder.loadTexts:agentDhcpServerPoolConfigTable.setStatus(_A)
_AgentDhcpServerPoolConfigEntry_Object=MibTableRow
agentDhcpServerPoolConfigEntry=_AgentDhcpServerPoolConfigEntry_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1))
...
_AgentDhcpServerPoolIndex_Type.__name__=_I
_AgentDhcpServerPoolIndex_Object=MibTableColumn
agentDhcpServerPoolIndex=_AgentDhcpServerPoolIndex_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,1),_AgentDhcpServerPoolIndex_Type())
...
agentDhcpServerPoolName=_AgentDhcpServerPoolName_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,2),_AgentDhcpServerPoolName_Type())
...
agentDhcpServerPoolDefRouter=_AgentDhcpServerPoolDefRouter_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,3),_AgentDhcpServerPoolDefRouter_Type())
...
agentDhcpServerPoolDNSServer=_AgentDhcpServerPoolDNSServer_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,4),_AgentDhcpServerPoolDNSServer_Type())
...
agentDhcpServerPoolLeaseTime=_AgentDhcpServerPoolLeaseTime_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,5),_AgentDhcpServerPoolLeaseTime_Type())
...
agentDhcpServerPoolType=_AgentDhcpServerPoolType_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,6),_AgentDhcpServerPoolType_Type())
...
agentDhcpServerPoolNetbiosNameServer=_AgentDhcpServerPoolNetbiosNameServer_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,7),_AgentDhcpServerPoolNetbiosNameServer_Type())
...
agentDhcpServerPoolNetbiosNodeType=_AgentDhcpServerPoolNetbiosNodeType_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,8),_AgentDhcpServerPoolNetbiosNodeType_Type())
...
agentDhcpServerPoolNextServer=_AgentDhcpServerPoolNextServer_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,9),_AgentDhcpServerPoolNextServer_Type())
...
agentDhcpServerPoolDomainName=_AgentDhcpServerPoolDomainName_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,10),_AgentDhcpServerPoolDomainName_Type())
...
agentDhcpServerPoolBootfile=_AgentDhcpServerPoolBootfile_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,11),_AgentDhcpServerPoolBootfile_Type())
...
agentDhcpServerPoolRowStatus=_AgentDhcpServerPoolRowStatus_Object((1,3,6,1,4,1,4413,1,1,12,2,2,1,12),_AgentDhcpServerPoolRowStatus_Type())
...
agentDhcpServerPoolAllocationTable=_AgentDhcpServerPoolAllocationTable_Object((1,3,6,1,4,1,4413,1,1,12,2,3))
...
agentDhcpServerPoolAllocationEntry=_AgentDhcpServerPoolAllocationEntry_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1))
...
agentDhcpServerPoolAllocationName=_AgentDhcpServerPoolAllocationName_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,1),_AgentDhcpServerPoolAllocationName_Type())
...
agentDhcpServerDynamicPoolIpAddress=_AgentDhcpServerDynamicPoolIpAddress_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,2),_AgentDhcpServerDynamicPoolIpAddress_Type())
...
agentDhcpServerDynamicPoolIpMask=_AgentDhcpServerDynamicPoolIpMask_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,3),_AgentDhcpServerDynamicPoolIpMask_Type())
...
agentDhcpServerDynamicPoolIpPrefixLength=_AgentDhcpServerDynamicPoolIpPrefixLength_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,4),_AgentDhcpServerDynamicPoolIpPrefixLength_Type())
...
agentDhcpServerPoolAllocationType=_AgentDhcpServerPoolAllocationType_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,5),_AgentDhcpServerPoolAllocationType_Type())
...
agentDhcpServerManualPoolClientIdentifier=_AgentDhcpServerManualPoolClientIdentifier_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,6),_AgentDhcpServerManualPoolClientIdentifier_Type())
...
agentDhcpServerManualPoolClientName=_AgentDhcpServerManualPoolClientName_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,7),_AgentDhcpServerManualPoolClientName_Type())
...
agentDhcpServerManualPoolClientHWAddr=_AgentDhcpServerManualPoolClientHWAddr_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,8),_AgentDhcpServerManualPoolClientHWAddr_Type())
...
agentDhcpServerManualPoolClientHWType=_AgentDhcpServerManualPoolClientHWType_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,9),_AgentDhcpServerManualPoolClientHWType_Type())
...
agentDhcpServerManualPoolIpAddress=_AgentDhcpServerManualPoolIpAddress_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,10),_AgentDhcpServerManualPoolIpAddress_Type())
...
agentDhcpServerManualPoolIpMask=_AgentDhcpServerManualPoolIpMask_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,11),_AgentDhcpServerManualPoolIpMask_Type())
...
agentDhcpServerManualPoolIpPrefixLength=_AgentDhcpServerManualPoolIpPrefixLength_Object((1,3,6,1,4,1,4413,1,1,12,2,3,1,12),_AgentDhcpServerManualPoolIpPrefixLength_Type())
...
agentDhcpServerExcludedAddressRangeCreate=_AgentDhcpServerExcludedAddressRangeCreate_Object((1,3,6,1,4,1,4413,1,1,12,2,4),_AgentDhcpServerExcludedAddressRangeCreate_Type())
...
agentDhcpServerExcludedAddressRangeTable=_AgentDhcpServerExcludedAddressRangeTable_Object((1,3,6,1,4,1,4413,1,1,12,2,5))
...
agentDhcpServerExcludedAddressRangeEntry=_AgentDhcpServerExcludedAddressRangeEntry_Object((1,3,6,1,4,1,4413,1,1,12,2,5,1))
...
_AgentDhcpServerExcludedRangeIndex_Type.__name__=_I
_AgentDhcpServerExcludedRangeIndex_Object=MibTableColumn
agentDhcpServerExcludedRangeIndex=_AgentDhcpServerExcludedRangeIndex_Object((1,3,6,1,4,1,4413,1,1,12,2,5,1,1),_AgentDhcpServerExcludedRangeIndex_Type())
...
agentDhcpServerExcludedStartIpAddress=_AgentDhcpServerExcludedStartIpAddress_Object((1,3,6,1,4,1,4413,1,1,12,2,5,1,2),_AgentDhcpServerExcludedStartIpAddress_Type())
...
agentDhcpServerExcludedEndIpAddress=_AgentDhcpServerExcludedEndIpAddress_Object((1,3,6,1,4,1,4413,1,1,12,2,5,1,3),_AgentDhcpServerExcludedEndIpAddress_Type())
...
agentDhcpServerExcludedAddressRangeStatus=_AgentDhcpServerExcludedAddressRangeStatus_Object((1,3,6,1,4,1,4413,1,1,12,2,5,1,4),_AgentDhcpServerExcludedAddressRangeStatus_Type())
...
agentDhcpServerPoolOptionCreate=_AgentDhcpServerPoolOptionCreate_Object((1,3,6,1,4,1,4413,1,1,12,2,6),_AgentDhcpServerPoolOptionCreate_Type())
...
agentDhcpServerPoolOptionTable=_AgentDhcpServerPoolOptionTable_Object((1,3,6,1,4,1,4413,1,1,12,2,7))
if mibBuilder.loadTexts:agentDhcpServerPoolOptionTable.setStatus(_A)
_AgentDhcpServerPoolOptionEntry_Object=MibTableRow
agentDhcpServerPoolOptionEntry=_AgentDhcpServerPoolOptionEntry_Object((1,3,6,1,4,1,4413,1,1,12,2,7,1))
...
_AgentDhcpServerPoolOptionIndex_Type.__name__=_I
_AgentDhcpServerPoolOptionIndex_Object=MibTableColumn
agentDhcpServerPoolOptionIndex=_AgentDhcpServerPoolOptionIndex_Object((1,3,6,1,4,1,4413,1,1,12,2,7,1,1),_AgentDhcpServerPoolOptionIndex_Type())
...
_AgentDhcpServerPoolOptionCode_Type.__name__=_I
_AgentDhcpServerPoolOptionCode_Object=MibTableColumn
agentDhcpServerPoolOptionCode=_AgentDhcpServerPoolOptionCode_Object((1,3,6,1,4,1,4413,1,1,12,2,7,1,2),_AgentDhcpServerPoolOptionCode_Type())
...
agentDhcpServerOptionPoolName=_AgentDhcpServerOptionPoolName_Object((1,3,6,1,4,1,4413,1,1,12,2,7,1,3),_AgentDhcpServerOptionPoolName_Type())
...
agentDhcpServerPoolOptionAsciiData=_AgentDhcpServerPoolOptionAsciiData_Object((1,3,6,1,4,1,4413,1,1,12,2,7,1,4),_AgentDhcpServerPoolOptionAsciiData_Type())
...
agentDhcpServerPoolOptionHexData=_AgentDhcpServerPoolOptionHexData_Object((1,3,6,1,4,1,4413,1,1,12,2,7,1,5),_AgentDhcpServerPoolOptionHexData_Type())
...
agentDhcpServerPoolOptionIpAddressData=_AgentDhcpServerPoolOptionIpAddressData_Object((1,3,6,1,4,1,4413,1,1,12,2,7,1,6),_AgentDhcpServerPoolOptionIpAddressData_Type())
...
agentDhcpServerPoolOptionStatus=_AgentDhcpServerPoolOptionStatus_Object((1,3,6,1,4,1,4413,1,1,12,2,7,1,7),_AgentDhcpServerPoolOptionStatus_Type())
...
agentDhcpServerLeaseGroup=_AgentDhcpServerLeaseGroup_ObjectIdentity((1,3,6,1,4,1,4413,1,1,12,3))
class _AgentDhcpServerLeaseClearAllBindings_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_G,1),(_H,2)))
_AgentDhcpServerLeaseClearAllBindings_Type.__name__=_D
_AgentDhcpServerLeaseClearAllBindings_Object=MibScalar
agentDhcpServerLeaseClearAllBindings=_AgentDhcpServerLeaseClearAllBindings_Object((1,3,6,1,4,1,4413,1,1,12,3,1),_AgentDhcpServerLeaseClearAllBindings_Type())
...
agentDhcpServerLeaseTable=_AgentDhcpServerLeaseTable_Object((1,3,6,1,4,1,4413,1,1,12,3,2))
if mibBuilder.loadTexts:agentDhcpServerLeaseTable.setStatus(_A)
_AgentDhcpServerLeaseEntry_Object=MibTableRow
agentDhcpServerLeaseEntry=_AgentDhcpServerLeaseEntry_Object((1,3,6,1,4,1,4413,1,1,12,3,2,1))
...
agentDhcpServerLeaseIPAddress=_AgentDhcpServerLeaseIPAddress_Object((1,3,6,1,4,1,4413,1,1,12,3,2,1,1),_AgentDhcpServerLeaseIPAddress_Type())
...
agentDhcpServerLeaseIPMask=_AgentDhcpServerLeaseIPMask_Object((1,3,6,1,4,1,4413,1,1,12,3,2,1,2),_AgentDhcpServerLeaseIPMask_Type())
...
agentDhcpServerLeaseHWAddress=_AgentDhcpServerLeaseHWAddress_Object((1,3,6,1,4,1,4413,1,1,12,3,2,1,3),_AgentDhcpServerLeaseHWAddress_Type())
...
agentDhcpServerLeaseRemainingTime=_AgentDhcpServerLeaseRemainingTime_Object((1,3,6,1,4,1,4413,1,1,12,3,2,1,4),_AgentDhcpServerLeaseRemainingTime_Type())
...
agentDhcpServerLeaseType=_AgentDhcpServerLeaseType_Object((1,3,6,1,4,1,4413,1,1,12,3,2,1,5),_AgentDhcpServerLeaseType_Type())
...
agentDhcpServerLeaseStatus=_AgentDhcpServerLeaseStatus_Object((1,3,6,1,4,1,4413,1,1,12,3,2,1,6),_AgentDhcpServerLeaseStatus_Type())
...
agentDhcpServerAddressConflictGroup=_AgentDhcpServerAddressConflictGroup_ObjectIdentity((1,3,6,1,4,1,4413,1,1,12,4))
class _AgentDhcpServerClearAllAddressConflicts_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_G,1),(_H,2)))
_AgentDhcpServerClearAllAddressConflicts_Type.__name__=_D
_AgentDhcpServerClearAllAddressConflicts_Object=MibScalar
agentDhcpServerClearAllAddressConflicts=_AgentDhcpServerClearAllAddressConflicts_Object((1,3,6,1,4,1,4413,1,1,12,4,1),_AgentDhcpServerClearAllAddressConflicts_Type())
...
class _AgentDhcpServerAddressConflictLogging_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_G,1),(_H,2)))
_AgentDhcpServerAddressConflictLogging_Type.__name__=_D
_AgentDhcpServerAddressConflictLogging_Object=MibScalar
agentDhcpServerAddressConflictLogging=_AgentDhcpServerAddressConflictLogging_Object((1,3,6,1,4,1,4413,1,1,12,4,2),_AgentDhcpServerAddressConflictLogging_Type())
...
agentDhcpServerAddressConflictTable=_AgentDhcpServerAddressConflictTable_Object((1,3,6,1,4,1,4413,1,1,12,4,3))
...
agentDhcpServerAddressConflictEntry=_AgentDhcpServerAddressConflictEntry_Object((1,3,6,1,4,1,4413,1,1,12,4,3,1))
...
agentDhcpServerAddressConflictIP=_AgentDhcpServerAddressConflictIP_Object((1,3,6,1,4,1,4413,1,1,12,4,3,1,1),_AgentDhcpServerAddressConflictIP_Type())
...
agentDhcpServerAddressConflictDetectionType=_AgentDhcpServerAddressConflictDetectionType_Object((1,3,6,1,4,1,4413,1,1,12,4,3,1,2),_AgentDhcpServerAddressConflictDetectionType_Type())
...
agentDhcpServerAddressConflictDetectionTime=_AgentDhcpServerAddressConflictDetectionTime_Object((1,3,6,1,4,1,4413,1,1,12,4,3,1,3),_AgentDhcpServerAddressConflictDetectionTime_Type())
...
agentDhcpServerAddressConflictStatus=_AgentDhcpServerAddressConflictStatus_Object((1,3,6,1,4,1,4413,1,1,12,4,3,1,4),_AgentDhcpServerAddressConflictStatus_Type())
