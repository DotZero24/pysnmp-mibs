...
DateAndTime, TextualConvention, RowPointer, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "RowPointer", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("BGP-MPLS-LAYER3-VPN-MULTICAST-MIB", mvpnAdvtStatsTable=mvpnAdvtStatsTable, mvpnMrouteGroup=mvpnMrouteGroup, mvpnPmsiTable=mvpnPmsiTable, mvpnPmsiRD=mvpnPmsiRD, mvpnGenMvrfCreationTime=mvpnGenMvrfCreationTime, mvpnAdvtPeerAddrType=mvpnAdvtPeerAddrType, mvpnSpmsiCmcastSourceAddr=mvpnSpmsiCmcastSourceAddr, mvpnMrouteNextHopAddr=mvpnMrouteNextHopAddr, mvpnMrouteRtPrefixLength=mvpnMrouteRtPrefixLength, mvpnMrouteCmcastGroupAddrType=mvpnMrouteCmcastGroupAddrType, mvpnPmsiTunnelPimGroupAddrType=mvpnPmsiTunnelPimGroupAddrType, mvpnBgpSrcASExtendedCommunity=mvpnBgpSrcASExtendedCommunity, mvpnGroups=mvpnGroups, mvpnMrouteNextHopAddrType=mvpnMrouteNextHopAddrType, mvpnMrouteNumberOfRemoteReplication=mvpnMrouteNumberOfRemoteReplication, mvpnScalars=mvpnScalars, mvpnAdvtReceived=mvpnAdvtReceived, mvpnMrouteNextHopOctets=mvpnMrouteNextHopOctets, mvpnMrouteDroppedInPackets=mvpnMrouteDroppedInPackets, mvpnMrouteExpiryTime=mvpnMrouteExpiryTime, mvpnPimV4Mvrfs=mvpnPimV4Mvrfs, mvpnMrouteNextHopPkts=mvpnMrouteNextHopPkts, mvpnAdvtStatsGroup=mvpnAdvtStatsGroup, mvpnSpmsiCmcastSourcePrefixLen=mvpnSpmsiCmcastSourcePrefixLen, mvpnBgpCmcastRouteWithdrawalTimer=mvpnBgpCmcastRouteWithdrawalTimer, mvpnGenMvrfLastActionTime=mvpnGenMvrfLastActionTime, mvpnModuleAdvtStatsCompliance=mvpnModuleAdvtStatsCompliance, mvpnAdvtLastSentTime=mvpnAdvtLastSentTime, mvpnBgpSrcSharedTreeJoinTimer=mvpnBgpSrcSharedTreeJoinTimer, mvpnMrouteNextHopSourceAddrType=mvpnMrouteNextHopSourceAddrType, mvpnAdvtSent=mvpnAdvtSent, mvpnMrouteNextHopGroupPrefixLength=mvpnMrouteNextHopGroupPrefixLength, mvpnBgpVrfRouteImportExtendedCommunity=mvpnBgpVrfRouteImportExtendedCommunity, mvpnBgpMode=mvpnBgpMode, mvpnSPTunnelLimit=mvpnSPTunnelLimit, mvpnMrouteNextHopGroup=mvpnMrouteNextHopGroup, mvpnMrouteNextHopSourceAddrs=mvpnMrouteNextHopSourceAddrs, mvpnMrouteEntry=mvpnMrouteEntry, mvpnMrouteUpstreamNeighborAddr=mvpnMrouteUpstreamNeighborAddr, mvpnGenCustomerSiteType=mvpnGenCustomerSiteType, mvpnScalarGroup=mvpnScalarGroup, mvpnMrouteRtProtocol=mvpnMrouteRtProtocol, mvpnMrouteNextHopEntry=mvpnMrouteNextHopEntry, mvpnMrouteCounterDiscontinuityTime=mvpnMrouteCounterDiscontinuityTime, PYSNMP_MODULE_ID=mvpnMIB, mvpnGenUmhSelection=mvpnGenUmhSelection, mvpnSpmsiTable=mvpnSpmsiTable, mvpnMrouteTable=mvpnMrouteTable, mvpnMrouteTtlDroppedPackets=mvpnMrouteTtlDroppedPackets, mvpnMrouteCmcastSourceAddrType=mvpnMrouteCmcastSourceAddrType, mvpnBgpV4Mvrfs=mvpnBgpV4Mvrfs, mvpnSpmsiPmsiPointer=mvpnSpmsiPmsiPointer, mvpnPimV6Mvrfs=mvpnPimV6Mvrfs, mvpnAdvtReceivedError=mvpnAdvtReceivedError, mvpnMrouteNumberOfLocalReplication=mvpnMrouteNumberOfLocalReplication, mvpnBgpGroup=mvpnBgpGroup, mvpnMrouteCmcastSourceAddrs=mvpnMrouteCmcastSourceAddrs, mvpnPmsiEntry=mvpnPmsiEntry, mvpnBgpEntry=mvpnBgpEntry, mvpnPmsiTunnelIfIndex=mvpnPmsiTunnelIfIndex, mvpnGenInterAsPmsiInfo=mvpnGenInterAsPmsiInfo, mvpnAdvtPeerAddr=mvpnAdvtPeerAddr, mvpnMrouteTtlDroppedOctets=mvpnMrouteTtlDroppedOctets, mvpnModuleFullCompliance=mvpnModuleFullCompliance, mvpnMrouteNextHopGroupAddrType=mvpnMrouteNextHopGroupAddrType, mvpnAdvtReceivedMalformedTunnelType=mvpnAdvtReceivedMalformedTunnelType, mvpnBgpMsgRateLimit=mvpnBgpMsgRateLimit, mvpnPmsiTunnelPimGroupAddr=mvpnPmsiTunnelPimGroupAddr, mvpnMrouteCmcastSourcePrefixLength=mvpnMrouteCmcastSourcePrefixLength, mvpnCompliances=mvpnCompliances, mvpnGenericTable=mvpnGenericTable, mvpnMrouteDroppedInOctets=mvpnMrouteDroppedInOctets, mvpnPmsiGroup=mvpnPmsiGroup, mvpnV6Mvrfs=mvpnV6Mvrfs, mvpnGenericEntry=mvpnGenericEntry, mvpnMroutePmsiPointer=mvpnMroutePmsiPointer, mvpnModuleReadOnlyCompliance=mvpnModuleReadOnlyCompliance, mvpnMvrfActionTaken=mvpnMvrfActionTaken, mvpnAdvtCounterDiscontinuityTime=mvpnAdvtCounterDiscontinuityTime, mvpnMrouteNextHopCounterDiscontinuityTime=mvpnMrouteNextHopCounterDiscontinuityTime, mvpnAdvtLastReceivedTime=mvpnAdvtLastReceivedTime, mvpnConformance=mvpnConformance, mvpnBgpTable=mvpnBgpTable, mvpnAdvtStatsEntry=mvpnAdvtStatsEntry, mvpnSpmsiCmcastSourceAddrType=mvpnSpmsiCmcastSourceAddrType, mvpnMrouteNextHopExpiryTime=mvpnMrouteNextHopExpiryTime, mvpnSpmsiCmcastGroupAddrType=mvpnSpmsiCmcastGroupAddrType, mvpnMrouteNextHopProtocol=mvpnMrouteNextHopProtocol, mvpnMrouteRtAddr=mvpnMrouteRtAddr, mvpnMvrfs=mvpnMvrfs, mvpnBgpScalarGroup=mvpnBgpScalarGroup, mvpnNotificationGroup=mvpnNotificationGroup, mvpnAdvtType=mvpnAdvtType, mvpnGenericGroup=mvpnGenericGroup, mvpnBgpMaxSrcActiveAdRoutes=mvpnBgpMaxSrcActiveAdRoutes, mvpnMrouteRtAddrType=mvpnMrouteRtAddrType, mvpnObjects=mvpnObjects, mvpnBgpMaxSpmsiAdRoutes=mvpnBgpMaxSpmsiAdRoutes, mvpnSpmsiCmcastGroupPrefixLen=mvpnSpmsiCmcastGroupPrefixLen, mvpnMrouteNextHopGroupAddr=mvpnMrouteNextHopGroupAddr, mvpnMIB=mvpnMIB, mvpnMrouteNextHopTable=mvpnMrouteNextHopTable, mvpnMrouteUpstreamNeighborAddrType=mvpnMrouteUpstreamNeighborAddrType, mvpnMldpMvrfs=mvpnMldpMvrfs, mvpnV4Mvrfs=mvpnV4Mvrfs, mvpnPmsiEncapsulationType=mvpnPmsiEncapsulationType, mvpnMrouteCmcastGroupPrefixLength=mvpnMrouteCmcastGroupPrefixLength, mvpnMrouteOctets=mvpnMrouteOctets, mvpnMrouteNextHopSourcePrefixLength=mvpnMrouteNextHopSourcePrefixLength, mvpnGenMvrfLastAction=mvpnGenMvrfLastAction, mvpnMrouteNextHopIfIndex=mvpnMrouteNextHopIfIndex, mvpnNotifications=mvpnNotifications, mvpnPmsiTunnelType=mvpnPmsiTunnelType, mvpnGenIpmsiInfo=mvpnGenIpmsiInfo, mvpnMrouteRtType=mvpnMrouteRtType, mvpnBgpMaxSrcActiveAdRouteFreq=mvpnBgpMaxSrcActiveAdRouteFreq, mvpnSpmsiCmcastGroupAddr=mvpnSpmsiCmcastGroupAddr, mvpnMrouteInIfIndex=mvpnMrouteInIfIndex, mvpnMrouteNextHopState=mvpnMrouteNextHopState, mvpnMrouteProtocol=mvpnMrouteProtocol, mvpnPmsiTunnelAttribute=mvpnPmsiTunnelAttribute, mvpnAdvtReceivedMalformedTunnelId=mvpnAdvtReceivedMalformedTunnelId, mvpnBgpV6Mvrfs=mvpnBgpV6Mvrfs, mvpnBgpMaxSpmsiAdRouteFreq=mvpnBgpMaxSpmsiAdRouteFreq, mvpnGenCmcastRouteProtocol=mvpnGenCmcastRouteProtocol, mvpnMrouteNextHopClosestMemberHops=mvpnMrouteNextHopClosestMemberHops, mvpnMroutePkts=mvpnMroutePkts, mvpnSpmsiEntry=mvpnSpmsiEntry, mvpnMrouteCmcastGroupAddr=mvpnMrouteCmcastGroupAddr)
