...
_G='fsMIStdOspfv3ContextId'
_F='SUPERMICRO-MISTDOSPFV3-MIB'
_E='Integer32'
_D='InetAddress'
_C='not-accessible'
_B='SUPERMICRO-OSPFV3MI-TEST-MIB'
_A='current'
...
fsMIStdOspfv3ContextId,=mibBuilder.importSymbols(_F,_G)
...
fsMIOspfv3TestIfTable=_FsMIOspfv3TestIfTable_Object((1,3,6,1,4,1,10876,101,2,24,100,1))
if mibBuilder.loadTexts:fsMIOspfv3TestIfTable.setStatus(_A)
_FsMIOspfv3TestIfEntry_Object=MibTableRow
fsMIOspfv3TestIfEntry=_FsMIOspfv3TestIfEntry_Object((1,3,6,1,4,1,10876,101,2,24,100,1,1))
...
fsMIOspfv3TestIfIndex=_FsMIOspfv3TestIfIndex_Object((1,3,6,1,4,1,10876,101,2,24,100,1,1,1),_FsMIOspfv3TestIfIndex_Type())
...
_FsMIOspfv3TestDemandTraffic_Type.__name__=_E
_FsMIOspfv3TestDemandTraffic_Object=MibTableColumn
fsMIOspfv3TestDemandTraffic=_FsMIOspfv3TestDemandTraffic_Object((1,3,6,1,4,1,10876,101,2,24,100,1,1,2),_FsMIOspfv3TestDemandTraffic_Type())
...
fsMIOspfv3TestIfContextId=_FsMIOspfv3TestIfContextId_Object((1,3,6,1,4,1,10876,101,2,24,100,1,1,3),_FsMIOspfv3TestIfContextId_Type())
...
fsMIOspfv3ExtRouteTable=_FsMIOspfv3ExtRouteTable_Object((1,3,6,1,4,1,10876,101,2,24,100,2))
if mibBuilder.loadTexts:fsMIOspfv3ExtRouteTable.setStatus(_A)
_FsMIOspfv3ExtRouteEntry_Object=MibTableRow
fsMIOspfv3ExtRouteEntry=_FsMIOspfv3ExtRouteEntry_Object((1,3,6,1,4,1,10876,101,2,24,100,2,1))
fsMIOspfv3ExtRouteEntry.setIndexNames((0,_F,_G),(0,_B,_I),(0,_B,_J),(0,_B,_K),(0,_B,_L),(0,_B,_M))
...
fsMIOspfv3ExtRouteDestType=_FsMIOspfv3ExtRouteDestType_Object((1,3,6,1,4,1,10876,101,2,24,100,2,1,1),_FsMIOspfv3ExtRouteDestType_Type())
...
fsMIOspfv3ExtRouteDest=_FsMIOspfv3ExtRouteDest_Object((1,3,6,1,4,1,10876,101,2,24,100,2,1,2),_FsMIOspfv3ExtRouteDest_Type())
...
fsMIOspfv3ExtRoutePfxLength=_FsMIOspfv3ExtRoutePfxLength_Object((1,3,6,1,4,1,10876,101,2,24,100,2,1,3),_FsMIOspfv3ExtRoutePfxLength_Type())
...
fsMIOspfv3ExtRouteNextHopType=_FsMIOspfv3ExtRouteNextHopType_Object((1,3,6,1,4,1,10876,101,2,24,100,2,1,4),_FsMIOspfv3ExtRouteNextHopType_Type())
...
fsMIOspfv3ExtRouteNextHop=_FsMIOspfv3ExtRouteNextHop_Object((1,3,6,1,4,1,10876,101,2,24,100,2,1,5),_FsMIOspfv3ExtRouteNextHop_Type())
...
fsMIOspfv3ExtRouteStatus=_FsMIOspfv3ExtRouteStatus_Object((1,3,6,1,4,1,10876,101,2,24,100,2,1,6),_FsMIOspfv3ExtRouteStatus_Type())
