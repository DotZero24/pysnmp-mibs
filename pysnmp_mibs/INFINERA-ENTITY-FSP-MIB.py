...
mibBuilder.exportSymbols("INFINERA-ENTITY-FSP-MIB", fspLabel=fspLabel, fspGroups=fspGroups, fspMIB=fspMIB, fspEntry=fspEntry, PYSNMP_MODULE_ID=fspMIB, fspCompliances=fspCompliances, fspAid=fspAid, fspCompliance=fspCompliance, fspType=fspType, fspTable=fspTable, fspProvSerialNumber=fspProvSerialNumber, fspGroup=fspGroup, fspConformance=fspConformance)
