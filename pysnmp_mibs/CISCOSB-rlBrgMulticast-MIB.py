...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/ciscosb/CISCOSB-rlBrgMulticast-MIB
...
rlUserAssignedVidxConfigTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 116, 9, 1), )
if mibBuilder.loadTexts: rlUserAssignedVidxConfigTable.setStatus('current')
rlUserAssignedVidxConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 116, 9, 1, 1), ).setIndexNames((0, "CISCOSB-rlBrgMulticast-MIB", "rlUserAssignedVidxConfigIndex"))
if mibBuilder.loadTexts: rlUserAssignedVidxConfigEntry.setStatus('current')
rlUserAssignedVidxConfigIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 116, 9, 1, 1, 1), VidxIndex())
