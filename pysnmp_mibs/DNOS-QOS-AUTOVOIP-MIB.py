...
agentAutoVoIPCfgGroup=_AgentAutoVoIPCfgGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1))
_AgentAutoVoIPVLAN_Type=Integer32
_AgentAutoVoIPVLAN_Object=MibScalar
agentAutoVoIPVLAN=_AgentAutoVoIPVLAN_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,1),_AgentAutoVoIPVLAN_Type())
...
agentAutoVoIPOUIPriority=_AgentAutoVoIPOUIPriority_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,2),_AgentAutoVoIPOUIPriority_Type())
...
agentAutoVoIPProtocolPriScheme=_AgentAutoVoIPProtocolPriScheme_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,3),_AgentAutoVoIPProtocolPriScheme_Type())
...
agentAutoVoIPProtocolTcOrRemarkValue=_AgentAutoVoIPProtocolTcOrRemarkValue_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,4),_AgentAutoVoIPProtocolTcOrRemarkValue_Type())
...
agentAutoVoIPTable=_AgentAutoVoIPTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,5))
if mibBuilder.loadTexts:agentAutoVoIPTable.setStatus(_A)
_AgentAutoVoIPEntry_Object=MibTableRow
agentAutoVoIPEntry=_AgentAutoVoIPEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,5,1))
...
agentAutoVoIPIntfIndex=_AgentAutoVoIPIntfIndex_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,5,1,1),_AgentAutoVoIPIntfIndex_Type())
...
agentAutoVoIPProtocolMode=_AgentAutoVoIPProtocolMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,5,1,2),_AgentAutoVoIPProtocolMode_Type())
...
agentAutoVoIPOUIMode=_AgentAutoVoIPOUIMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,5,1,3),_AgentAutoVoIPOUIMode_Type())
...
agentAutoVoIPProtocolPortStatus=_AgentAutoVoIPProtocolPortStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,5,1,4),_AgentAutoVoIPProtocolPortStatus_Type())
...
agentAutoVoIPOUIPortStatus=_AgentAutoVoIPOUIPortStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,5,1,5),_AgentAutoVoIPOUIPortStatus_Type())
...
agentAutoVoIPOUITable=_AgentAutoVoIPOUITable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,6))
if mibBuilder.loadTexts:agentAutoVoIPOUITable.setStatus(_A)
_AgentAutoVoIPOUIEntry_Object=MibTableRow
agentAutoVoIPOUIEntry=_AgentAutoVoIPOUIEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,6,1))
...
agentAutoVoIPOUIIndex=_AgentAutoVoIPOUIIndex_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,6,1,1),_AgentAutoVoIPOUIIndex_Type())
...
agentAutoVoIPOUI=_AgentAutoVoIPOUI_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,6,1,2),_AgentAutoVoIPOUI_Type())
...
agentAutoVoIPOUIDesc=_AgentAutoVoIPOUIDesc_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,6,1,3),_AgentAutoVoIPOUIDesc_Type())
...
agentAutoVoIPOUIRowStatus=_AgentAutoVoIPOUIRowStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,6,1,4),_AgentAutoVoIPOUIRowStatus_Type())
...
agentAutoVoIPSessionTable=_AgentAutoVoIPSessionTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,7))
if mibBuilder.loadTexts:agentAutoVoIPSessionTable.setStatus(_A)
_AgentAutoVoIPSessionEntry_Object=MibTableRow
agentAutoVoIPSessionEntry=_AgentAutoVoIPSessionEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,7,1))
...
agentAutoVoIPSessionIndex=_AgentAutoVoIPSessionIndex_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,7,1,1),_AgentAutoVoIPSessionIndex_Type())
...
agentAutoVoIPSourceIP=_AgentAutoVoIPSourceIP_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,7,1,2),_AgentAutoVoIPSourceIP_Type())
...
agentAutoVoIPDestinationIP=_AgentAutoVoIPDestinationIP_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,7,1,3),_AgentAutoVoIPDestinationIP_Type())
...
agentAutoVoIPSourceL4Port=_AgentAutoVoIPSourceL4Port_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,7,1,4),_AgentAutoVoIPSourceL4Port_Type())
...
agentAutoVoIPDestinationL4Port=_AgentAutoVoIPDestinationL4Port_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,7,1,5),_AgentAutoVoIPDestinationL4Port_Type())
...
agentAutoVoIPProtocol=_AgentAutoVoIPProtocol_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,3,4,1,7,1,6),_AgentAutoVoIPProtocol_Type())
