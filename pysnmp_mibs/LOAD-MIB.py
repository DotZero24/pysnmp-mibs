...
# Notes
# -----
# ASN.1 source file://mibs/avaya/LOAD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:04:45 2025
...
lucentProducts = _LucentProducts_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 1751, 1)
)
_LucentMibs_ObjectIdentity = ObjectIdentity
lucentMibs = _LucentMibs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 1751, 2)
)
...
genOpServerInetAddressType = _GenOpServerInetAddressType_Object(
    (1, 3, 6, 1, 4, 1, 1751, 2, 53, 1, 2, 1, 23),
    _GenOpServerInetAddressType_Type()
)
genOpServerInetAddressType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    genOpServerInetAddressType.setStatus("current")
_GenOpServerInetAddress_Type = InetAddress
_GenOpServerInetAddress_Object = MibTableColumn
genOpServerInetAddress = _GenOpServerInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 1751, 2, 53, 1, 2, 1, 24),
    _GenOpServerInetAddress_Type()
)
genOpServerInetAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    genOpServerInetAddress.setStatus("current")
...
mibBuilder.exportSymbols(
    "LOAD-MIB",
    **{"lucent": lucent,
       "lucentProducts": lucentProducts,
       "lucentMibs": lucentMibs,
       "load": load,
       ...
       "genOpServerInetAddress": genOpServerInetAddress,
