...
# Notes
# -----
# ASN.1 source file://mibs/ibm/IBM-Director-Alert-MIB
...
directorTrapsCompliance.setObjects(
      *(("IBM-Director-Alert-MIB", "directorTrapsGroup"),
        ("IBM-Director-Alert-MIB", "directorNotificationsGroup"))
)
if mibBuilder.loadTexts:
