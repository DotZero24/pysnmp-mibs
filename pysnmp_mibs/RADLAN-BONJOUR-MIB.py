# SNMP MIB module (RADLAN-BONJOUR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-BONJOUR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:11:46 2025
...
rlBonjourStatusEntry.setIndexNames(
    ...
    (0, "RADLAN-BONJOUR-MIB", "rlBonjourStatusIPInterfaceAddr"),
)
if mibBuilder.loadTexts:
...
rlBonjourStateEntry = _RlBonjourStateEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 114, 3, 1)
)
rlBonjourStateEntry.setIndexNames(
    (0, "RADLAN-BONJOUR-MIB", "rlBonjourStateServiceName"),
    (0, "RADLAN-BONJOUR-MIB", "rlBonjourStateL2Interface"),
)
if mibBuilder.loadTexts:
