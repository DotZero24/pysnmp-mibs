# SNMP MIB module (LJ9500mfp-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hp/LJ9500mfp-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:41:39 2025
...
class _Device_configure_printer_parameters_Type(DisplayString):
    """Custom type device_configure_printer_parameters based on DisplayString"""
...
_Device_configure_printer_parameters_Type.__name__ = "DisplayString"
...
phd2_diagnostics_nvram_data = _Phd2_diagnostics_nvram_data_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 5, 2, 9),
    _Phd2_diagnostics_nvram_data_Type()
)
phd2_diagnostics_nvram_data.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    phd2_diagnostics_nvram_data.setStatus("optional")
...
if mibBuilder.loadTexts:
    file_system_security_access_password.setStatus("optional")
...
class _Scanner_accessory_digital_send_config_email_gateway_Type(DisplayString):
    """Custom type scanner_accessory_digital_send_config_email_gateway based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_Scanner_accessory_digital_send_config_email_gateway_Type.__name__ = "DisplayString"
...
class _Scanner_accessory_digital_send_config_ldap_gateway_Type(DisplayString):
    """Custom type scanner_accessory_digital_send_config_ldap_gateway based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_Scanner_accessory_digital_send_config_ldap_gateway_Type.__name__ = "DisplayString"
...
class _Scanner_accessory_digital_send_home_screen_status_Type(DisplayString):
    """Custom type scanner_accessory_digital_send_home_screen_status based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Scanner_accessory_digital_send_home_screen_status_Type.__name__ = "DisplayString"
...
class _Marking_agent_highlights_density_setting_Type(Integer32):
    """Custom type marking_agent_highlights_density_setting based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Marking_agent_highlights_density_setting_Type.__name__ = "Integer32"
...
class _Marking_agent_midtones_density_setting_Type(Integer32):
    """Custom type marking_agent_midtones_density_setting based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-5, 5),
    )
...
_Marking_agent_midtones_density_setting_Type.__name__ = "Integer32"
...
class _Marking_agent_shadows_density_setting_Type(Integer32):
    """Custom type marking_agent_shadows_density_setting based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-5, 5),
    )
...
_Marking_agent_shadows_density_setting_Type.__name__ = "Integer32"
...
class _Media20_name_Type(DisplayString):
    """Custom type media20_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 24),
    )
...
_Media20_name_Type.__name__ = "DisplayString"
...
class _Media20_short_name_Type(DisplayString):
    """Custom type media20_short_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 11),
    )
...
_Media20_short_name_Type.__name__ = "DisplayString"
...
class _Media22_name_Type(DisplayString):
    """Custom type media22_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 24),
    )
...
_Media22_name_Type.__name__ = "DisplayString"
...
class _Media22_short_name_Type(DisplayString):
    """Custom type media22_short_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 11),
    )
...
_Media22_short_name_Type.__name__ = "DisplayString"
...
class _Media23_name_Type(DisplayString):
    """Custom type media23_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 24),
    )
...
_Media23_name_Type.__name__ = "DisplayString"
...
class _Media23_short_name_Type(DisplayString):
    """Custom type media23_short_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 11),
    )
...
_Media23_short_name_Type.__name__ = "DisplayString"
...
class _Media24_name_Type(DisplayString):
    """Custom type media24_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 24),
    )
...
_Media24_name_Type.__name__ = "DisplayString"
...
class _Media24_short_name_Type(DisplayString):
    """Custom type media24_short_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 11),
    )
...
_Media24_short_name_Type.__name__ = "DisplayString"
...
class _Consumable_status_total_page_count_Type(Integer32):
    """Custom type consumable_status_total_page_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_total_page_count_Type.__name__ = "Integer32"
_Consumable_status_total_page_count_Object = MibScalar
consumable_status_total_page_count = _Consumable_status_total_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 24),
    _Consumable_status_total_page_count_Type()
)
consumable_status_total_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_total_page_count.setStatus("optional")


class _Consumable_status_mono_page_count_Type(Integer32):
    """Custom type consumable_status_mono_page_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_mono_page_count_Type.__name__ = "Integer32"
_Consumable_status_mono_page_count_Object = MibScalar
consumable_status_mono_page_count = _Consumable_status_mono_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 25),
    _Consumable_status_mono_page_count_Type()
)
consumable_status_mono_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_mono_page_count.setStatus("optional")


class _Consumable_status_color_page_count_Type(Integer32):
    """Custom type consumable_status_color_page_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_color_page_count_Type.__name__ = "Integer32"
_Consumable_status_color_page_count_Object = MibScalar
consumable_status_color_page_count = _Consumable_status_color_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 26),
    _Consumable_status_color_page_count_Type()
)
consumable_status_color_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_color_page_count.setStatus("optional")


class _Consumable_status_total_equiv_page_count_Type(Integer32):
    """Custom type consumable_status_total_equiv_page_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_total_equiv_page_count_Type.__name__ = "Integer32"
_Consumable_status_total_equiv_page_count_Object = MibScalar
consumable_status_total_equiv_page_count = _Consumable_status_total_equiv_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 27),
    _Consumable_status_total_equiv_page_count_Type()
)
consumable_status_total_equiv_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_total_equiv_page_count.setStatus("optional")


class _Consumable_status_total_equiv_mono_page_count_Type(Integer32):
    """Custom type consumable_status_total_equiv_mono_page_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_total_equiv_mono_page_count_Type.__name__ = "Integer32"
_Consumable_status_total_equiv_mono_page_count_Object = MibScalar
consumable_status_total_equiv_mono_page_count = _Consumable_status_total_equiv_mono_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 28),
    _Consumable_status_total_equiv_mono_page_count_Type()
)
consumable_status_total_equiv_mono_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_total_equiv_mono_page_count.setStatus("optional")


class _Consumable_status_total_equiv_color_page_count_Type(Integer32):
    """Custom type consumable_status_total_equiv_color_page_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_total_equiv_color_page_count_Type.__name__ = "Integer32"
_Consumable_status_total_equiv_color_page_count_Object = MibScalar
consumable_status_total_equiv_color_page_count = _Consumable_status_total_equiv_color_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 29),
    _Consumable_status_total_equiv_color_page_count_Type()
)
consumable_status_total_equiv_color_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_total_equiv_color_page_count.setStatus("optional")


class _Consumable_status_input_option_sheet_count_Type(Integer32):
    """Custom type consumable_status_input_option_sheet_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_input_option_sheet_count_Type.__name__ = "Integer32"
_Consumable_status_input_option_sheet_count_Object = MibScalar
consumable_status_input_option_sheet_count = _Consumable_status_input_option_sheet_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 30),
    _Consumable_status_input_option_sheet_count_Type()
)
consumable_status_input_option_sheet_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_input_option_sheet_count.setStatus("optional")


class _Consumable_status_duplex_sheet_count_Type(Integer32):
    """Custom type consumable_status_duplex_sheet_count based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_duplex_sheet_count_Type.__name__ = "Integer32"
_Consumable_status_duplex_sheet_count_Object = MibScalar
consumable_status_duplex_sheet_count = _Consumable_status_duplex_sheet_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 31),
    _Consumable_status_duplex_sheet_count_Type()
)
consumable_status_duplex_sheet_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_duplex_sheet_count.setStatus("optional")


class _Consumable_status_page_count_half_speed_Type(Integer32):
    """Custom type consumable_status_page_count_half_speed based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_page_count_half_speed_Type.__name__ = "Integer32"
_Consumable_status_page_count_half_speed_Object = MibScalar
consumable_status_page_count_half_speed = _Consumable_status_page_count_half_speed_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 32),
    _Consumable_status_page_count_half_speed_Type()
)
consumable_status_page_count_half_speed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_page_count_half_speed.setStatus("optional")


class _Consumable_status_developer_life_units_Type(Integer32):
    """Custom type consumable_status_developer_life_units based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Consumable_status_developer_life_units_Type.__name__ = "Integer32"
_Consumable_status_developer_life_units_Object = MibScalar
consumable_status_developer_life_units = _Consumable_status_developer_life_units_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 36),
    _Consumable_status_developer_life_units_Type()
)
consumable_status_developer_life_units.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_developer_life_units.setStatus("optional")


class _Consumable_status_developer_life_Type(Integer32):
    """Custom type consumable_status_developer_life based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_developer_life_Type.__name__ = "Integer32"
_Consumable_status_developer_life_Object = MibScalar
consumable_status_developer_life = _Consumable_status_developer_life_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 37),
    _Consumable_status_developer_life_Type()
)
consumable_status_developer_life.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_developer_life.setStatus("optional")
...
class _Consumable_status_authentication_Type(Integer32):
    """Custom type consumable_status_authentication based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Consumable_status_authentication_Type.__name__ = "Integer32"
_Consumable_status_authentication_Object = MibScalar
consumable_status_authentication = _Consumable_status_authentication_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 40),
    _Consumable_status_authentication_Type()
)
consumable_status_authentication.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_authentication.setStatus("optional")
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "phd2-diagnostics-nvram-data": phd2_diagnostics_nvram_data,
       "phd3": phd3,
       ...
       "consumable-status-total-page-count": consumable_status_total_page_count,
       "consumable-status-mono-page-count": consumable_status_mono_page_count,
       "consumable-status-color-page-count": consumable_status_color_page_count,
       "consumable-status-total-equiv-page-count": consumable_status_total_equiv_page_count,
       "consumable-status-total-equiv-mono-page-count": consumable_status_total_equiv_mono_page_count,
       "consumable-status-total-equiv-color-page-count": consumable_status_total_equiv_color_page_count,
       "consumable-status-input-option-sheet-count": consumable_status_input_option_sheet_count,
       "consumable-status-duplex-sheet-count": consumable_status_duplex_sheet_count,
       "consumable-status-page-count-half-speed": consumable_status_page_count_half_speed,
       "consumable-status-developer-life-units": consumable_status_developer_life_units,
       "consumable-status-developer-life": consumable_status_developer_life,
       ...
       "consumable-status-authentication": consumable_status_authentication,
