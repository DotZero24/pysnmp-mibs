...
# Notes
# -----
# ASN.1 source file://mibs/nortel/BAY-STACK-PORT-MIRRORING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:20:41 2025
...
class _BsPortMirroringCtrlMirrorVlan_Type(Integer32):
    """Custom type bsPortMirroringCtrlMirrorVlan based on Integer32"""
    defaultValue = 0
...
_BsPortMirroringCtrlMirrorVlan_Type.__name__ = "Integer32"
_BsPortMirroringCtrlMirrorVlan_Object = MibTableColumn
bsPortMirroringCtrlMirrorVlan = _BsPortMirroringCtrlMirrorVlan_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 28, 1, 1, 1, 11),
    _BsPortMirroringCtrlMirrorVlan_Type()
)
bsPortMirroringCtrlMirrorVlan.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    bsPortMirroringCtrlMirrorVlan.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"bayStackPortMirroringMib": bayStackPortMirroringMib,
       ...
       "bsPortMirroringCtrlMirrorVlan": bsPortMirroringCtrlMirrorVlan,
