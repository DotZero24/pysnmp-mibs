...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-TRUSTSEC-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:42:27 2025
...
_CtsvServerTestStorageType_Type.__name__ = "StorageType"
...
ciscoTrustSecServerMIBCompliance.setObjects(
      *(("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBServerConfigGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBGlobalServerTestGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBServerTestGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBProvisionedServerGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBDownloadServerListGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBDownloadServerGroup"))
)
if mibBuilder.loadTexts:
...
ciscoTrustSecServerMIBCompliance2.setObjects(
      *(("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBServerConfigGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBGlobalServerTestGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBServerTestGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBProvisionedServerGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBDownloadServerListGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecMIBDownloadServerGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecServerMIBKeyWrapGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecServerMIBNotifsCtrlGroup"),
        ("CISCO-TRUSTSEC-SERVER-MIB", "ciscoTrustSecServerMIBNotifsOnlyInfoGroup"),
