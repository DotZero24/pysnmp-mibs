...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/HPN-ICF-DOT11-STATION-MIB
...
HpnicfDot11CipherType, HpnicfDot11RadioType, HpnicfDot11AssocFailType, HpnicfDot11ObjectIDType, HpnicfDot11AKMType, hpnicfDot11, HpnicfDot11SSIDStringType, HpnicfDot11AuthorFailType, HpnicfDot11ChannelScopeType, HpnicfDot11SSIDEncryptModeType, HpnicfDot11RadioType2, HpnicfDot11AuthenType, HpnicfDot11SecIEStatusType, HpnicfDot11RadioScopeType = mibBuilder.importSymbols("HPN-ICF-DOT11-REF-MIB", "HpnicfDot11CipherType", "HpnicfDot11RadioType", "HpnicfDot11AssocFailType", "HpnicfDot11ObjectIDType", "HpnicfDot11AKMType", "hpnicfDot11", "HpnicfDot11SSIDStringType", "HpnicfDot11AuthorFailType", "HpnicfDot11ChannelScopeType", "HpnicfDot11SSIDEncryptModeType", "HpnicfDot11RadioType2", "HpnicfDot11AuthenType", "HpnicfDot11SecIEStatusType", "HpnicfDot11RadioScopeType")
...
hpnicfDot11StaInternetRxFrameBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 75, 3, 1, 3, 1, 24), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hpnicfDot11StaInternetRxFrameBytes.setStatus('current')
hpnicfDot11StaInternetTxFrameBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 75, 3, 1, 3, 1, 25), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hpnicfDot11StaInternetTxFrameBytes.setStatus('current')
hpnicfDot11StaLocalRxFrameBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 75, 3, 1, 3, 1, 26), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hpnicfDot11StaLocalRxFrameBytes.setStatus('current')
hpnicfDot11StaLocalTxFrameBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 75, 3, 1, 3, 1, 27), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hpnicfDot11StaLocalTxFrameBytes.setStatus('current')
...
mibBuilder.exportSymbols("HPN-ICF-DOT11-STATION-MIB", hpnicfDot11StationRfPingRxCnt=hpnicfDot11StationRfPingRxCnt, hpnicfDot11StationTrapStaMAC=hpnicfDot11StationTrapStaMAC, hpnicfDot11StationRadioMode2=hpnicfDot11StationRadioMode2, hpnicfDot11StaRxErrDataFrameCnt=hpnicfDot11StaRxErrDataFrameCnt, hpnicfDot11StationTxRateSet=hpnicfDot11StationTxRateSet, hpnicfDot11StationFailCauseDesc=hpnicfDot11StationFailCauseDesc, hpnicfDot11StationRfPingTest=hpnicfDot11StationRfPingTest, hpnicfDot11StationRfPingEntry=hpnicfDot11StationRfPingEntry, hpnicfDot11StationAssocFailCause=hpnicfDot11StationAssocFailCause, hpnicfDot11StationTxRetryPkts=hpnicfDot11StationTxRetryPkts, hpnicfDot11StationRxFragCnt=hpnicfDot11StationRxFragCnt, hpnicfDot11StaTxDataRatePkts=hpnicfDot11StaTxDataRatePkts, hpnicfDot11StationRxSpeed=hpnicfDot11StationRxSpeed, hpnicfDot11StationSSIDName=hpnicfDot11StationSSIDName, hpnicfDot11StaInternetRxFrameBytes=hpnicfDot11StaInternetRxFrameBytes, hpnicfDot11StationSuccessTxCnt=hpnicfDot11StationSuccessTxCnt, hpnicfDot11StationAuthenModeCM=hpnicfDot11StationAuthenModeCM, hpnicfDot11StationSecIEStatusCM=hpnicfDot11StationSecIEStatusCM, hpnicfDot11StationRxSNR=hpnicfDot11StationRxSNR, hpnicfDot11StationRSSI=hpnicfDot11StationRSSI, hpnicfDot11StationAKMModeCM=hpnicfDot11StationAKMModeCM, hpnicfDot11StationAPRelationEntry=hpnicfDot11StationAPRelationEntry, hpnicfDot11StationSSIDEncryptMode=hpnicfDot11StationSSIDEncryptMode, hpnicfDot11UserName=hpnicfDot11UserName, hpnicfDot11StationTxRate=hpnicfDot11StationTxRate, hpnicfDot11StationStatisTable=hpnicfDot11StationStatisTable, hpnicfDot11StationRadioMode=hpnicfDot11StationRadioMode, hpnicfDot11StationWmmMode=hpnicfDot11StationWmmMode, hpnicfDot11StationRxRate=hpnicfDot11StationRxRate, hpnicfDot11StationTrapAPMacAddress=hpnicfDot11StationTrapAPMacAddress, hpnicfDot11StationUserAuthType=hpnicfDot11StationUserAuthType, hpnicfDot11StationRxDataFrameCnt=hpnicfDot11StationRxDataFrameCnt, hpnicfDot11StationRxDataFrameBytes=hpnicfDot11StationRxDataFrameBytes, hpnicfDot11CurrAPID=hpnicfDot11CurrAPID, hpnicfDot11StationSecurityCiphers=hpnicfDot11StationSecurityCiphers, hpnicfDot11StationVendorName=hpnicfDot11StationVendorName, hpnicfDot11StationDropFrameBytes=hpnicfDot11StationDropFrameBytes, hpnicfDot11StationAPRelationTable=hpnicfDot11StationAPRelationTable, hpnicfDot11StationSessionStartTime=hpnicfDot11StationSessionStartTime, PYSNMP_MODULE_ID=hpnicfDot11STATION, hpnicfDot11StationRxFrameCnt=hpnicfDot11StationRxFrameCnt, hpnicfDot11StationStatisEntry=hpnicfDot11StationStatisEntry, hpnicfDot11StationSuccessTxDataCnt=hpnicfDot11StationSuccessTxDataCnt, hpnicfDot11StationTxFrameBytes=hpnicfDot11StationTxFrameBytes, hpnicfDot11StaInternetTxFrameBytes=hpnicfDot11StaInternetTxFrameBytes, hpnicfDot11STATION=hpnicfDot11STATION, hpnicfDot11StationAuthenMode=hpnicfDot11StationAuthenMode, hpnicfDot11StationDisconnectTrap=hpnicfDot11StationDisconnectTrap, hpnicfDot11StationMtGroup=hpnicfDot11StationMtGroup, hpnicfDot11StationSignalStrength=hpnicfDot11StationSignalStrength, hpnicfDot11StationTrapBSSID=hpnicfDot11StationTrapBSSID, hpnicfDot11StationDropFrameCnt=hpnicfDot11StationDropFrameCnt, hpnicfDot11StationAKMMode=hpnicfDot11StationAKMMode, hpnicfDot11StaLocalTxFrameBytes=hpnicfDot11StaLocalTxFrameBytes, hpnicfDot11StationTxDataFrameCnt=hpnicfDot11StationTxDataFrameCnt, hpnicfDot11StationTrapVarObjects=hpnicfDot11StationTrapVarObjects, hpnicfDot11StationUpTimeTicks=hpnicfDot11StationUpTimeTicks, hpnicfDot11UserDisconnectTrap=hpnicfDot11UserDisconnectTrap, hpnicfDot11StationTxSpeed=hpnicfDot11StationTxSpeed, hpnicfDot11StationRfPingIndex=hpnicfDot11StationRfPingIndex, hpnicfDot11StationUserName=hpnicfDot11StationUserName, hpnicfDot11StationMACAddress=hpnicfDot11StationMACAddress, hpnicfDot11StationIPAddress=hpnicfDot11StationIPAddress, hpnicfDot11StationAid=hpnicfDot11StationAid, hpnicfDot11StationRoamingTrap=hpnicfDot11StationRoamingTrap, hpnicfDot11StationRfPingRate=hpnicfDot11StationRfPingRate, hpnicfDot11StationAuthorSuccTrap=hpnicfDot11StationAuthorSuccTrap, hpnicfDot11StaRxDataRatePkts=hpnicfDot11StaRxDataRatePkts, hpnicfDot11StationRxRetryPkts=hpnicfDot11StationRxRetryPkts, hpnicfDot11StationSessionDuration=hpnicfDot11StationSessionDuration, hpnicfDot11StationMAC=hpnicfDot11StationMAC, hpnicfDot11StationThroughput=hpnicfDot11StationThroughput, hpnicfDot11StationMaxRate=hpnicfDot11StationMaxRate, hpnicfDot11StationTraps=hpnicfDot11StationTraps, hpnicfDot11CurrRadioID=hpnicfDot11CurrRadioID, hpnicfDot11StationRfPingTxCnt=hpnicfDot11StationRfPingTxCnt, hpnicfDot11StationRfPingRtt=hpnicfDot11StationRfPingRtt, hpnicfDot11StationPowerSaveMode=hpnicfDot11StationPowerSaveMode, hpnicfDot11StationSecIEStatus=hpnicfDot11StationSecIEStatus, hpnicfDot11StationMICErrorTrap=hpnicfDot11StationMICErrorTrap, hpnicfDot11StationSecurityCiphersCM=hpnicfDot11StationSecurityCiphersCM, hpnicfDot11StationAPName=hpnicfDot11StationAPName, hpnicfDot11StationAuthenErrorTrap=hpnicfDot11StationAuthenErrorTrap, hpnicfDot11StationChannel=hpnicfDot11StationChannel, hpnicfDot11StationRxNoise=hpnicfDot11StationRxNoise, hpnicfDot11StaDisconnectReason=hpnicfDot11StaDisconnectReason, hpnicfDot11StationTxFrameCnt=hpnicfDot11StationTxFrameCnt, hpnicfDot11StationRxFrameBytes=hpnicfDot11StationRxFrameBytes, hpnicfDot11StationAssocFailTrap=hpnicfDot11StationAssocFailTrap, hpnicfDot11StationACIPAddress=hpnicfDot11StationACIPAddress, hpnicfDot11CurrWlanID=hpnicfDot11CurrWlanID, hpnicfDot11StaTxRetryDataFrameCnt=hpnicfDot11StaTxRetryDataFrameCnt, hpnicfDot11StationAuthorFailTrap=hpnicfDot11StationAuthorFailTrap, hpnicfDot11StationUpTime=hpnicfDot11StationUpTime, hpnicfDot11StationTxRetryBytes=hpnicfDot11StationTxRetryBytes, hpnicfDot11StationNotifyGroup=hpnicfDot11StationNotifyGroup, hpnicfDot11StationRfPingTable=hpnicfDot11StationRfPingTable, hpnicfDot11StaTxSignalStrengthPkts=hpnicfDot11StaTxSignalStrengthPkts, hpnicfDot11StationRfPingRssi=hpnicfDot11StationRfPingRssi, hpnicfDot11StationRoamingTime=hpnicfDot11StationRoamingTime, hpnicfDot11StaLocalRxFrameBytes=hpnicfDot11StaLocalRxFrameBytes, hpnicfDot11StationAssTime=hpnicfDot11StationAssTime, hpnicfDot11StationDeAssocTrap=hpnicfDot11StationDeAssocTrap, hpnicfDot11StationAssociateEntry=hpnicfDot11StationAssociateEntry, hpnicfDot11StationAuthorFailCause=hpnicfDot11StationAuthorFailCause, hpnicfDot11StationBSSID=hpnicfDot11StationBSSID, hpnicfDot11CurrAntennaID=hpnicfDot11CurrAntennaID, hpnicfDot11StationTxDataFrameBytes=hpnicfDot11StationTxDataFrameBytes, hpnicfDot11StationVlanId=hpnicfDot11StationVlanId, hpnicfDot11StationRxRetryBytes=hpnicfDot11StationRxRetryBytes, hpnicfDot11StationRfPingRetries=hpnicfDot11StationRfPingRetries, hpnicfDot11StationAuthMode=hpnicfDot11StationAuthMode, hpnicfDot11StationPowerSaveModeCM=hpnicfDot11StationPowerSaveModeCM, hpnicfDot11StationACIPv6Add=hpnicfDot11StationACIPv6Add, hpnicfDot11StationAssociateTable=hpnicfDot11StationAssociateTable)
