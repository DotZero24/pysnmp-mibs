...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-DOT11-STATION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:32:58 2025
...
_HpnicfDot11StationSSIDEncryptMode_Type.__name__ = "HpnicfDot11SSIDEncryptModeType"
...
hpnicfDot11StaInternetRxFrameBytes = _HpnicfDot11StaInternetRxFrameBytes_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 75, 3, 1, 3, 1, 24),
    _HpnicfDot11StaInternetRxFrameBytes_Type()
)
hpnicfDot11StaInternetRxFrameBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpnicfDot11StaInternetRxFrameBytes.setStatus("current")
_HpnicfDot11StaInternetTxFrameBytes_Type = Counter64
_HpnicfDot11StaInternetTxFrameBytes_Object = MibTableColumn
hpnicfDot11StaInternetTxFrameBytes = _HpnicfDot11StaInternetTxFrameBytes_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 75, 3, 1, 3, 1, 25),
    _HpnicfDot11StaInternetTxFrameBytes_Type()
)
hpnicfDot11StaInternetTxFrameBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpnicfDot11StaInternetTxFrameBytes.setStatus("current")
_HpnicfDot11StaLocalRxFrameBytes_Type = Counter64
_HpnicfDot11StaLocalRxFrameBytes_Object = MibTableColumn
hpnicfDot11StaLocalRxFrameBytes = _HpnicfDot11StaLocalRxFrameBytes_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 75, 3, 1, 3, 1, 26),
    _HpnicfDot11StaLocalRxFrameBytes_Type()
)
hpnicfDot11StaLocalRxFrameBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpnicfDot11StaLocalRxFrameBytes.setStatus("current")
_HpnicfDot11StaLocalTxFrameBytes_Type = Counter64
_HpnicfDot11StaLocalTxFrameBytes_Object = MibTableColumn
hpnicfDot11StaLocalTxFrameBytes = _HpnicfDot11StaLocalTxFrameBytes_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 75, 3, 1, 3, 1, 27),
    _HpnicfDot11StaLocalTxFrameBytes_Type()
)
hpnicfDot11StaLocalTxFrameBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpnicfDot11StaLocalTxFrameBytes.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hpnicfDot11STATION": hpnicfDot11STATION,
       ...
       "hpnicfDot11StaInternetRxFrameBytes": hpnicfDot11StaInternetRxFrameBytes,
       "hpnicfDot11StaInternetTxFrameBytes": hpnicfDot11StaInternetTxFrameBytes,
       "hpnicfDot11StaLocalRxFrameBytes": hpnicfDot11StaLocalRxFrameBytes,
       "hpnicfDot11StaLocalTxFrameBytes": hpnicfDot11StaLocalTxFrameBytes,
