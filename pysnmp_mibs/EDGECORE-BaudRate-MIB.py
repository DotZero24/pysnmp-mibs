# SNMP MIB module (EDGECORE-BaudRate-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/edgecore/EDGECORE-BaudRate-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:53:59 2025
...
rlRs232MibVersion = _RlRs232MibVersion_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 104, 1),
...
rlRs232AutoBaudRateStatus = _RlRs232AutoBaudRateStatus_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 104, 2),
...
rlRs232AutoBaudRateStatusAfterReset = _RlRs232AutoBaudRateStatusAfterReset_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 104, 3),
...
rlRs232BaudRate = _RlRs232BaudRate_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 104, 4),
