...
mibBuilder.exportSymbols("APSWINVENTORY-MIB", apSwCfgTrapPreviousVersion=apSwCfgTrapPreviousVersion, apSwCfgNotificationObjects=apSwCfgNotificationObjects, apSwInventoryGroups=apSwInventoryGroups, apSwInventoryNotificationObjects=apSwInventoryNotificationObjects, apSwInventoryConformance=apSwInventoryConformance, apSwCfgBackupIndex=apSwCfgBackupIndex, apSwInventoryCfgObjects=apSwInventoryCfgObjects, apSwInventoryNotifications=apSwInventoryNotifications, apSwCfgObjectsGroup=apSwCfgObjectsGroup, apSwCfgTrapCurrentVersion=apSwCfgTrapCurrentVersion, apSwInventoryBootObjects=apSwInventoryBootObjects, apSwCfgBackupName=apSwCfgBackupName, apSwBootStatus=apSwBootStatus, apSwInventoryNotificationsGroup=apSwInventoryNotificationsGroup, apSwCfgActivateNotification=apSwCfgActivateNotification, apSwBootTable=apSwBootTable, apSwCfgRunningVersion=apSwCfgRunningVersion, apSwBootEntry=apSwBootEntry, PYSNMP_MODULE_ID=apSwInventoryModule, apSwInventoryMIBObjects=apSwInventoryMIBObjects, apSwCfgBackuptable=apSwCfgBackuptable, apSwInventoryNotificationPrefix=apSwInventoryNotificationPrefix, apSwInventoryCompliances=apSwInventoryCompliances, apSwBootObjectsGroup=apSwBootObjectsGroup, apSwBootType=apSwBootType, apSwCfgBackupEntry=apSwCfgBackupEntry, apSwBootIndex=apSwBootIndex, apSwBootDescr=apSwBootDescr, apSwInventoryModule=apSwInventoryModule, apSwCfgCurrentVersion=apSwCfgCurrentVersion, apSwInventoryNotificationsGroups=apSwInventoryNotificationsGroups)
