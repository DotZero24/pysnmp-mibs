...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-APS-MIB
...
cApsCompliance.setObjects(
      *(("CISCO-APS-MIB", "cApsConfigGeneral"),
        ("CISCO-APS-MIB", "cApsStatusGeneral"),
        ("CISCO-APS-MIB", "cApsChanGeneral"))
)
if mibBuilder.loadTexts:
