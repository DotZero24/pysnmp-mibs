...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:40:14 2025
...
tmnxHwNotification, tmnxHwObjs, tmnxHwConformance, tmnxChassisIndex = mibBuilder.importSymbols("TIMETRA-CHASSIS-MIB", "tmnxHwNotification", "tmnxHwObjs", "tmnxHwConformance", "tmnxChassisIndex")
...
mibBuilder.exportSymbols("TIMETRA-PPP-MIB", tmnxPppRemoteMacAddress=tmnxPppRemoteMacAddress, tmnxPppCpLastClearedTime=tmnxPppCpLastClearedTime, tmnxPppKaOutPktCount=tmnxPppKaOutPktCount, tmnxPppQuality=tmnxPppQuality, tmnxPppLqmOutPktCount=tmnxPppLqmOutPktCount, tmnxPpp77x0V6v0Compliance=tmnxPpp77x0V6v0Compliance, tmnxPppRemoteMagicNumber=tmnxPppRemoteMagicNumber, tmnxPppNcpUp=tmnxPppNcpUp, tmnxPppCompliances=tmnxPppCompliances, tmnxPppCpDown=tmnxPppCpDown, tmnxPppConformance=tmnxPppConformance, tmnxPppLocalAddress=tmnxPppLocalAddress, tmnxPppCpProtocol=tmnxPppCpProtocol, tmnxPppObjs=tmnxPppObjs, tmnxPppNotification=tmnxPppNotification, tmnxPppLoopbackClear=tmnxPppLoopbackClear, tmnxPppLqmOutRate=tmnxPppLqmOutRate, tmnxPppKaLastClearedTime=tmnxPppKaLastClearedTime, tmnxPppLqmInPktCount=tmnxPppLqmInPktCount, tmnxPppLocalMagicNumber=tmnxPppLocalMagicNumber, tmnxPppKaDropCount=tmnxPppKaDropCount, tmnxPppCpRestartCount=tmnxPppCpRestartCount, tmnxPppRemoteIPv4Address=tmnxPppRemoteIPv4Address, tmnxPppRemoteIPv6AddressType=tmnxPppRemoteIPv6AddressType, tmnxPppCompressionGroup=tmnxPppCompressionGroup, tmnxPppLqmFailure=tmnxPppLqmFailure, tmnxPppLocalIPv4Address=tmnxPppLocalIPv4Address, tmnxPppKaTimeDropLink=tmnxPppKaTimeDropLink, tmnxPppLinkPhase=tmnxPppLinkPhase, tmnxPppCompliance=tmnxPppCompliance, PYSNMP_MODULE_ID=tmnxPppMIBModule, tmnxPppLineMonitorMethod=tmnxPppLineMonitorMethod, tmnxPppCpTable=tmnxPppCpTable, tmnxPppLqmInRate=tmnxPppLqmInRate, tmnxPppLqmThresholdExceedsCount=tmnxPppLqmThresholdExceedsCount, tmnxPppTable=tmnxPppTable, tmnxPppLocalIPv4AddressType=tmnxPppLocalIPv4AddressType, tmnxPppKaThresholdExceedsCount=tmnxPppKaThresholdExceedsCount, tmnxPPPObsoleteV4v0Group=tmnxPPPObsoleteV4v0Group, tmnxPppNotifyPrefix=tmnxPppNotifyPrefix, tmnxPppLqmLastClearedTime=tmnxPppLqmLastClearedTime, tmnxPppRemoteIPv6Address=tmnxPppRemoteIPv6Address, tmnxPppMIBModule=tmnxPppMIBModule, tmnxPppGroups=tmnxPppGroups, tmnxPpp7750V4v0Group=tmnxPpp7750V4v0Group, tmnxPpp7750V4v0Compliance=tmnxPpp7750V4v0Compliance, tmnxPpp7450V4v0Compliance=tmnxPpp7450V4v0Compliance, tmnxPppKeepaliveFailure=tmnxPppKeepaliveFailure, tmnxPppRemoteAddress=tmnxPppRemoteAddress, tmnxPpp7450V6v0Compliance=tmnxPpp7450V6v0Compliance, tmnxPppEntry=tmnxPppEntry, tmnxPppLocalIPv6AddressType=tmnxPppLocalIPv6AddressType, tmnxPppKaPeriod=tmnxPppKaPeriod, tmnxPppLocalIPv6Address=tmnxPppLocalIPv6Address, tmnxPppHdrCompression=tmnxPppHdrCompression, tmnxPppCpLastChange=tmnxPppCpLastChange, tmnxPppRemoteIPv4AddressType=tmnxPppRemoteIPv4AddressType, tmnxPppCpUp=tmnxPppCpUp, tmnxPppCpEntry=tmnxPppCpEntry, tmnxPpp7450V4v0Group=tmnxPpp7450V4v0Group, tmnxPppNcpDown=tmnxPppNcpDown, tmnxPppNotificationGroup=tmnxPppNotificationGroup, tmnxPppLqmOperPeriod=tmnxPppLqmOperPeriod, tmnxPppGroup=tmnxPppGroup, tmnxPppLqmTimeDropLink=tmnxPppLqmTimeDropLink, tmnxPppCpState=tmnxPppCpState, tmnxPppLoopback=tmnxPppLoopback, tmnxPppKaInPktCount=tmnxPppKaInPktCount)
