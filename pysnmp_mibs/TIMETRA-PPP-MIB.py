...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-PPP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:00:56 2025
...
if mibBuilder.loadTexts:
    tmnxPppLqmInRate.setUnits("percent")
...
if mibBuilder.loadTexts:
    tmnxPppLqmOutRate.setUnits("percent")
...
tmnxPppCompliance.setObjects(
      *(("TIMETRA-PPP-MIB", "tmnxPppGroup"),
        ("TIMETRA-PPP-MIB", "tmnxPppNotificationGroup"))
)
if mibBuilder.loadTexts:
...
tmnxPpp7450V4v0Compliance.setObjects(
      *(("TIMETRA-PPP-MIB", "tmnxPpp7450V4v0Group"),
        ("TIMETRA-PPP-MIB", "tmnxPppNotificationGroup"))
)
if mibBuilder.loadTexts:
...
tmnxPpp7750V4v0Compliance.setObjects(
      *(("TIMETRA-PPP-MIB", "tmnxPpp7750V4v0Group"),
        ("TIMETRA-PPP-MIB", "tmnxPppNotificationGroup"))
)
if mibBuilder.loadTexts:
...
tmnxPpp7450V6v0Compliance.setObjects(
      *(("TIMETRA-PPP-MIB", "tmnxPpp7450V4v0Group"),
        ("TIMETRA-PPP-MIB", "tmnxPppNotificationGroup"))
)
if mibBuilder.loadTexts:
...
tmnxPpp77x0V6v0Compliance.setObjects(
      *(("TIMETRA-PPP-MIB", "tmnxPpp7750V4v0Group"),
        ("TIMETRA-PPP-MIB", "tmnxPppNotificationGroup"),
        ("TIMETRA-PPP-MIB", "tmnxPppCompressionGroup"))
)
if mibBuilder.loadTexts:
