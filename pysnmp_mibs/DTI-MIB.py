...
mibBuilder.exportSymbols("DTI-MIB", dtiProtocolPerformancePeakToPeakJitter=dtiProtocolPerformancePeakToPeakJitter, dtiServerProperties=dtiServerProperties, dtiProtocolPerformanceTable=dtiProtocolPerformanceTable, dtiPathTraceabilityTable=dtiPathTraceabilityTable, dtiPathTraceabilityServerInetAddrType=dtiPathTraceabilityServerInetAddrType, dtiMib=dtiMib, dtiServerRootClockType=dtiServerRootClockType, dtiServerGlobalToDMethod=dtiServerGlobalToDMethod, dtiPathTraceabilityRootServerInetAddr=dtiPathTraceabilityRootServerInetAddr, dtiPathTraceabilityServerProtVersion=dtiPathTraceabilityServerProtVersion, dtiClientGroup=dtiClientGroup, dtiProtocolServerStatusFlag=dtiProtocolServerStatusFlag, dtiProtocolControlToDValue=dtiProtocolControlToDValue, dtiProtocolClientStatusFlag=dtiProtocolClientStatusFlag, DtiCableAdvance=DtiCableAdvance, dtiProtocolPerformanceWanderTSeconds=dtiProtocolPerformanceWanderTSeconds, dtiProtocolClientClockType=dtiProtocolClientClockType, dtiServerGlobalErrorRateInterval=dtiServerGlobalErrorRateInterval, dtiServerToDSources=dtiServerToDSources, dtiServerHopCount=dtiServerHopCount, dtiClientObjects=dtiClientObjects, dtiProtocolPerformanceDelay=dtiProtocolPerformanceDelay, dtiNotifications=dtiNotifications, dtiProtocolControlTable=dtiProtocolControlTable, dtiProtocolClientFsmStatsT3Count=dtiProtocolClientFsmStatsT3Count, dtiPathTraceabilityServerOutPhyIdx=dtiPathTraceabilityServerOutPhyIdx, dtiPathTraceabilityRootServerOutPhyIdx=dtiPathTraceabilityRootServerOutPhyIdx, dtiServerExternalTimingSource=dtiServerExternalTimingSource, dtiServerGlobalJitterTimeInterval=dtiServerGlobalJitterTimeInterval, dtiProtocolClientVersion=dtiProtocolClientVersion, dtiPathTraceabilityRootServerInetAddrType=dtiPathTraceabilityRootServerInetAddrType, PYSNMP_MODULE_ID=dtiMib, dtiProtocolServerCableAdvanceFlag=dtiProtocolServerCableAdvanceFlag, dtiProtocolPerformanceWander35Second=dtiProtocolPerformanceWander35Second, dtiProtocolClientFsmStatsT7Count=dtiProtocolClientFsmStatsT7Count, dtiMibObjects=dtiMibObjects, dtiMibConformance=dtiMibConformance, dtiProtocolClientFsmStatsTable=dtiProtocolClientFsmStatsTable, dtiProtocolEntityType=dtiProtocolEntityType, dtiMibCompliance=dtiMibCompliance, dtiPathTraceabilityIndex=dtiPathTraceabilityIndex, dtiProtocolPerformanceFrameErrorRate=dtiProtocolPerformanceFrameErrorRate, dtiProtocolClientFsmStatsEntry=dtiProtocolClientFsmStatsEntry, dtiProtocolServerToDState=dtiProtocolServerToDState, dtiProtocolControlTimeInterval=dtiProtocolControlTimeInterval, dtiProtocolClientFsmStatsNormalActiveTime=dtiProtocolClientFsmStatsNormalActiveTime, dtiPathTraceabilityEntry=dtiPathTraceabilityEntry, dtiPathTraceabilityServerInetAddr=dtiPathTraceabilityServerInetAddr, dtiProtocolEntry=dtiProtocolEntry, dtiProtocolServerToDType=dtiProtocolServerToDType, dtiProtocolControlTestMode=dtiProtocolControlTestMode, dtiProtocolClientFsmStatsT4Count=dtiProtocolClientFsmStatsT4Count, dtiProtocolServerCableAdvanceValue=dtiProtocolServerCableAdvanceValue, dtiProtocolServerClientStableFlag=dtiProtocolServerClientStableFlag, dtiProtocolClientFsmStatsHoldoverActiveTime=dtiProtocolClientFsmStatsHoldoverActiveTime, dtiBaseGroup=dtiBaseGroup, dtiProtocolClientPathTraceability=dtiProtocolClientPathTraceability, dtiServerGroup=dtiServerGroup, dtiServerObjects=dtiServerObjects, dtiMibCompliances=dtiMibCompliances, dtiProtocolControlErrorRateInterval=dtiProtocolControlErrorRateInterval, dtiProtocolObjects=dtiProtocolObjects, dtiProtocolControlJitterTimeInterval=dtiProtocolControlJitterTimeInterval, dtiServerGlobalTimeInterval=dtiServerGlobalTimeInterval, dtiProtocolClientFsmStatsT6Count=dtiProtocolClientFsmStatsT6Count, dtiServerGlobalParameters=dtiServerGlobalParameters, dtiProtocolServerToDValue=dtiProtocolServerToDValue, dtiProtocolPerformanceEntry=dtiProtocolPerformanceEntry, dtiPathTraceabilityRootServerProtVersion=dtiPathTraceabilityRootServerProtVersion, dtiServerGlobalToDValue=dtiServerGlobalToDValue, dtiProtocolControlEntry=dtiProtocolControlEntry, dtiMibGroups=dtiMibGroups, dtiProtocolClientPhaseError=dtiProtocolClientPhaseError, dtiProtocolTable=dtiProtocolTable)
