...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:45:51 2025
...
mibBuilder.exportSymbols("SIAE-PMFTP-MIB", pmFTPMibVersion=pmFTPMibVersion, pmFTPActionRequest=pmFTPActionRequest, pmFTPStatus=pmFTPStatus, pmFTPTpClass=pmFTPTpClass, pmFTPBeginInterval=pmFTPBeginInterval, pmFTPTpRmonOwner=pmFTPTpRmonOwner, pmFTP=pmFTP, pmFTPCompressedFile=pmFTPCompressedFile, pmFTPStatusTrap=pmFTPStatusTrap, PYSNMP_MODULE_ID=pmFTP, pmFTPfileName=pmFTPfileName, pmFTPEndInterval=pmFTPEndInterval, pmFTPStatusTrapNotification=pmFTPStatusTrapNotification)
