# SNMP MIB module (MARVELL-SpecialBpdu-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/MARVELL-SpecialBpdu-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:07 2025
...
rlSpecialBpduTable = _RlSpecialBpduTable_Object(
    (1, 3, 6, 1, 4, 1, 89, 144, 1)
)
if mibBuilder.loadTexts:
    rlSpecialBpduTable.setStatus("current")
_RlSpecialBpduEntry_Object = MibTableRow
rlSpecialBpduEntry = _RlSpecialBpduEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 144, 1, 1)
)
rlSpecialBpduEntry.setIndexNames(
    (0, "MARVELL-SpecialBpdu-MIB", "rlSpecialBpduMacAddr"),
    (0, "MARVELL-SpecialBpdu-MIB", "rlSpecialBpduEncap"),
    (0, "MARVELL-SpecialBpdu-MIB", "rlSpecialBpduProtId"),
)
if mibBuilder.loadTexts:
