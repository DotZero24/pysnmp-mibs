# SNMP MIB module (ARICENT-PING-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-PING-MIB
...
class _FsPingHostName_Type(OctetString):
    """Custom type fsPingHostName based on OctetString"""
...
_FsPingHostName_Type.__name__ = "OctetString"
_FsPingHostName_Object = MibTableColumn
fsPingHostName = _FsPingHostName_Object(
    (1, 3, 6, 1, 4, 1, 2076, 106, 1, 1, 1, 13),
    _FsPingHostName_Type()
)
fsPingHostName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPingHostName.setStatus("current")
