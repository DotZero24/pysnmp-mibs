...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-PIM-MIB
...
ciscoPimSparseMIBCompliance.setObjects(
      *(("CISCO-PIM-MIB", "ciscoPimSparseMIBGroup"),
        ("CISCO-PIM-MIB", "ciscoPimNotificationObjectGroup"))
)
if mibBuilder.loadTexts:
