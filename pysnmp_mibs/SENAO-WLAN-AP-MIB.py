...
mibBuilder.exportSymbols("SENAO-WLAN-AP-MIB", connectedToSSID=connectedToSSID, sendPacketsBadCount=sendPacketsBadCount, wepKeyNumber=wepKeyNumber, receivedPacketsGoodCount=receivedPacketsGoodCount, tcp=tcp, icmpInMsgs=icmpInMsgs, tcpOutSegs=tcpOutSegs, wdsKeyUsed=wdsKeyUsed, wdsAPMACAddress2=wdsAPMACAddress2, ipInReceives=ipInReceives, systemSettingsGroup=systemSettingsGroup, wdsAPMACAddress6=wdsAPMACAddress6, currentTransmissionRate=currentTransmissionRate, dhcpIPAddressTo=dhcpIPAddressTo, udpInDatagrams=udpInDatagrams, senaoRFC1213Group=senaoRFC1213Group, ipAddress=ipAddress, dhcpEnabled=dhcpEnabled, dhcpIPAddressFrom=dhcpIPAddressFrom, wdsKeyType=wdsKeyType, countersGroup=countersGroup, dhcpSettingsGroup=dhcpSettingsGroup, icmp=icmp, udpOutDatagrams=udpOutDatagrams, privacySettingsGroup=privacySettingsGroup, wdsAPMACAddress1=wdsAPMACAddress1, wepKey=wepKey, deviceName=deviceName, ipForwDatagrams=ipForwDatagrams, udp=udp, wdsAPMACAddress4=wdsAPMACAddress4, senaoMIB=senaoMIB, wepEnabled=wepEnabled, wdsEnabled=wdsEnabled, saveReboot=saveReboot, wdsAPMACAddress3=wdsAPMACAddress3, currentTXPower=currentTXPower, receivedPacketsBadCount=receivedPacketsBadCount, subnetMask=subnetMask, ipGateway=ipGateway, userName=userName, wepKeyLength=wepKeyLength, icmpOutMsgs=icmpOutMsgs, dhcpLeaseTimes=dhcpLeaseTimes, password=password, tcpInSegs=tcpInSegs, wdsAPMACAddress5=wdsAPMACAddress5, webAdministratorSettingsGroup=webAdministratorSettingsGroup, currentIPAddress=currentIPAddress, sendPacketsGoodCount=sendPacketsGoodCount, wdsSettingsGroup=wdsSettingsGroup, usingChannel=usingChannel, statusInformationGroup=statusInformationGroup, ip=ip, accessPointMACAddress=accessPointMACAddress, operationMode=operationMode)
