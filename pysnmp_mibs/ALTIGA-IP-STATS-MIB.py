...
mibBuilder.exportSymbols("ALTIGA-IP-STATS-MIB", alIpInterfaceStatsIndex=alIpInterfaceStatsIndex, PYSNMP_MODULE_ID=altigaIpStatsMibModule, alIpInterfaceStatsCurrentDuplex=alIpInterfaceStatsCurrentDuplex, altigaIpStatsMibConformance=altigaIpStatsMibConformance, altigaIpStatsGroup=altigaIpStatsGroup, alIpInterfaceStatsEntry=alIpInterfaceStatsEntry, alIpInterfaceStatsTable=alIpInterfaceStatsTable, altigaIpStatsMibModule=altigaIpStatsMibModule, alStatsIpGlobal=alStatsIpGlobal, altigaIpStatsMibCompliances=altigaIpStatsMibCompliances, altigaIpStatsMibCompliance=altigaIpStatsMibCompliance)
