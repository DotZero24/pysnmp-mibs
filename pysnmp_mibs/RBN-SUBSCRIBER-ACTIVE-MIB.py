...
RbnPercentage, RbnPortMediumType, RbnCircuitHandle = mibBuilder.importSymbols("RBN-TC", "RbnPercentage", "RbnPortMediumType", "RbnCircuitHandle")
...
DateAndTime, TextualConvention, RowPointer, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "RowPointer", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("RBN-SUBSCRIBER-ACTIVE-MIB", rbnSubsActiveIpAddr=rbnSubsActiveIpAddr, rbnSubsIPv4PktsReceived=rbnSubsIPv4PktsReceived, rbnSubsXmitPktsDropped=rbnSubsXmitPktsDropped, rbnSubsServiceVolumePktsOut=rbnSubsServiceVolumePktsOut, rbnSubsProfileCountTable=rbnSubsProfileCountTable, rbnSubsServiceIPv4VolumeOctetsOut=rbnSubsServiceIPv4VolumeOctetsOut, rbnSubsIPv6McastPktsReceived=rbnSubsIPv6McastPktsReceived, rbnSubsServiceActiveTime=rbnSubsServiceActiveTime, rbnSubsServiceName=rbnSubsServiceName, rbnSubsActiveIpEntry=rbnSubsActiveIpEntry, rbnSubsReauthRadiusIndex=rbnSubsReauthRadiusIndex, rbnSubsEncapsCountTable=rbnSubsEncapsCountTable, rbnSubsServiceIPv6VolumePktsOut=rbnSubsServiceIPv6VolumePktsOut, rbnSubsIPv4PktsSent=rbnSubsIPv4PktsSent, rbnSubsActiveName=rbnSubsActiveName, rbnSubsActiveSessions=rbnSubsActiveSessions, rbnSubsClearSubscriberName=rbnSubsClearSubscriberName, rbnSubsServiceIPv6VolumeOctetsIn=rbnSubsServiceIPv6VolumeOctetsIn, rbnSubsOctetsSent=rbnSubsOctetsSent, rbnSubsNotifyGroup=rbnSubsNotifyGroup, rbnSubsPktsReceived=rbnSubsPktsReceived, rbnSubsStats=rbnSubsStats, rbnSubsCompliances=rbnSubsCompliances, rbnSubsGroups=rbnSubsGroups, rbnSubsProfileCountEntry=rbnSubsProfileCountEntry, rbnSubscriberActiveMib=rbnSubscriberActiveMib, rbnSubsLicensedSessions=rbnSubsLicensedSessions, PYSNMP_MODULE_ID=rbnSubscriberActiveMib, rbnSubsIPv6McastOctetsSent=rbnSubsIPv6McastOctetsSent, rbnSubsServicesEntry=rbnSubsServicesEntry, rbnSubsActiveSessionSubscriberName=rbnSubsActiveSessionSubscriberName, rbnSubsOctetsReceived=rbnSubsOctetsReceived, rbnSubsServiceIPv4VolumeOctetsIn=rbnSubsServiceIPv4VolumeOctetsIn, rbnSubsActiveGroup2=rbnSubsActiveGroup2, rbnSubsCntxtIp6OnlyCount=rbnSubsCntxtIp6OnlyCount, rbnSubsCntxtCount=rbnSubsCntxtCount, rbnSubsServicesTable=rbnSubsServicesTable, rbnSubsIPv6PktsReceived=rbnSubsIPv6PktsReceived, rbnSubsActiveSessionPointer=rbnSubsActiveSessionPointer, rbnSubsServiceIPv6VolumeOctetsOut=rbnSubsServiceIPv6VolumeOctetsOut, rbnSubsCompliance4=rbnSubsCompliance4, rbnSubsActiveNasPortType=rbnSubsActiveNasPortType, rbnSubsIPv6OctetsReceived=rbnSubsIPv6OctetsReceived, rbnSubsServiceIndex=rbnSubsServiceIndex, rbnSubsLicenseGroup=rbnSubsLicenseGroup, rbnSubsActiveGroup3=rbnSubsActiveGroup3, rbnSubsReauthSessionId=rbnSubsReauthSessionId, rbnSubsServiceIPv4VolumePktsOut=rbnSubsServiceIPv4VolumePktsOut, rbnSubsXmitOctetsDropped=rbnSubsXmitOctetsDropped, rbnSubsNotifyEnable=rbnSubsNotifyEnable, rbnSubsIPv6McastOctetsReceived=rbnSubsIPv6McastOctetsReceived, rbnSubsIPv4McastPktsReceived=rbnSubsIPv4McastPktsReceived, rbnSubsActiveIpAddrTable=rbnSubsActiveIpAddrTable, rbnSubsActiveResendSvcAcct=rbnSubsActiveResendSvcAcct, rbnSubsActiveAddr=rbnSubsActiveAddr, rbnSubsActiveClear=rbnSubsActiveClear, rbnSubsCntxtCountEntry=rbnSubsCntxtCountEntry, rbnSubsServiceVolumeLimitIn=rbnSubsServiceVolumeLimitIn, rbnSubsActive=rbnSubsActive, rbnSubsConfigErrorMsgs=rbnSubsConfigErrorMsgs, rbnSubsCntxtCountTable=rbnSubsCntxtCountTable, rbnSubsActiveIpAddrEntry=rbnSubsActiveIpAddrEntry, rbnSubsReauthRadiusID=rbnSubsReauthRadiusID, rbnSubsIPv6OctetsSent=rbnSubsIPv6OctetsSent, rbnSubsMcastPktsReceived=rbnSubsMcastPktsReceived, rbnSubsIPv6McastPktsSent=rbnSubsIPv6McastPktsSent, rbnSubsActiveSessionTable=rbnSubsActiveSessionTable, rbnSubsStatsGroup=rbnSubsStatsGroup, rbnSubsActiveStartTime=rbnSubsActiveStartTime, rbnSubsActiveAddrType=rbnSubsActiveAddrType, rbnSubsCompliance3=rbnSubsCompliance3, rbnSubsServiceVolumeEntry=rbnSubsServiceVolumeEntry, rbnSubsActiveCircuitHandle=rbnSubsActiveCircuitHandle, rbnSubsCompliance6=rbnSubsCompliance6, rbnSubsActiveNotifications=rbnSubsActiveNotifications, rbnSubsServiceIPv6VolumePktsIn=rbnSubsServiceIPv6VolumePktsIn, rbnSubsServiceTag=rbnSubsServiceTag, rbnSubsNotify=rbnSubsNotify, rbnSubsActiveSessionEntry=rbnSubsActiveSessionEntry, rbnSubsNotifyPrefix=rbnSubsNotifyPrefix, rbnSubsServiceVolumeOctetsOut=rbnSubsServiceVolumeOctetsOut, rbnSubsEncapsulationType=rbnSubsEncapsulationType, rbnSubsActiveGroup4=rbnSubsActiveGroup4, rbnSubsActiveIpAddrType=rbnSubsActiveIpAddrType, rbnSubsCntxtIp4OnlyCount=rbnSubsCntxtIp4OnlyCount, rbnSubsServiceVolumeLimitOut=rbnSubsServiceVolumeLimitOut, rbnSubsStatsTable=rbnSubsStatsTable, rbnSubsCompliance5=rbnSubsCompliance5, rbnSubsCompliance2=rbnSubsCompliance2, rbnSubsIPv4McastOctetsSent=rbnSubsIPv4McastOctetsSent, rbnSubsServicesGroup=rbnSubsServicesGroup, rbnSubsNotifyObjectGroup=rbnSubsNotifyObjectGroup, rbnSubsActiveConformance=rbnSubsActiveConformance, rbnSubsProfileName=rbnSubsProfileName, rbnSubsActiveObjects=rbnSubsActiveObjects, rbnSubsConfigErrorEvent=rbnSubsConfigErrorEvent, rbnSubsCntxtDualCount=rbnSubsCntxtDualCount, rbnSubsBounceName=rbnSubsBounceName, rbnSubsServiceVolumePktsIn=rbnSubsServiceVolumePktsIn, rbnSubsStatsGroup3=rbnSubsStatsGroup3, rbnSubsIPv4McastOctetsReceived=rbnSubsIPv4McastOctetsReceived, rbnSubsClearReason=rbnSubsClearReason, rbnSubsActiveIpAddrDescr=rbnSubsActiveIpAddrDescr, rbnSubsActiveMediumType=rbnSubsActiveMediumType, rbnSubsMcastOctetsSent=rbnSubsMcastOctetsSent, rbnSubsActiveResend=rbnSubsActiveResend, rbnSubsStatsGroup2=rbnSubsStatsGroup2, rbnSubsClearSessionId=rbnSubsClearSessionId, rbnSubsActiveGroup=rbnSubsActiveGroup, rbnSubsCompliance=rbnSubsCompliance, rbnSubsActiveIpPfxLen=rbnSubsActiveIpPfxLen, rbnSubsActiveSessionId=rbnSubsActiveSessionId, rbnSubsEncapsCount=rbnSubsEncapsCount, rbnSubsStatsEntry=rbnSubsStatsEntry, rbnSubsServiceVolumeTable=rbnSubsServiceVolumeTable, rbnSubsIPv6PktsSent=rbnSubsIPv6PktsSent, rbnSubsIPv4McastPktsSent=rbnSubsIPv4McastPktsSent, rbnSubsCapacityPercentageUsed=rbnSubsCapacityPercentageUsed, rbnSubsClear=rbnSubsClear, rbnSubsMcastOctetsReceived=rbnSubsMcastOctetsReceived, rbnSubsServiceVolumeOctetsIn=rbnSubsServiceVolumeOctetsIn, rbnSubsEncapsCountEntry=rbnSubsEncapsCountEntry, rbnSubsServiceIPv4VolumePktsIn=rbnSubsServiceIPv4VolumePktsIn, rbnSubsMcastPktsSent=rbnSubsMcastPktsSent, rbnSubsBounceSessionId=rbnSubsBounceSessionId, rbnSubsLicense=rbnSubsLicense, rbnSubsIPv4OctetsSent=rbnSubsIPv4OctetsSent, rbnSubsCntxtLacCount=rbnSubsCntxtLacCount, rbnSubsActiveCircuitDescr=rbnSubsActiveCircuitDescr, rbnSubsIPv4OctetsReceived=rbnSubsIPv4OctetsReceived, rbnSubsProfileCount=rbnSubsProfileCount, rbnSubsActiveIpTable=rbnSubsActiveIpTable, rbnSubsPktsSent=rbnSubsPktsSent, rbnSubsReauthName=rbnSubsReauthName, rbnSubsActiveEntry=rbnSubsActiveEntry, rbnSubsActiveTable=rbnSubsActiveTable, rbnSubsMaxSupportedSessions=rbnSubsMaxSupportedSessions)
