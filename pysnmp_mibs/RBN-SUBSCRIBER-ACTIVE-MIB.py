...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-SUBSCRIBER-ACTIVE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:27 2025
...
_RbnSubsActiveSessionPointer_Type.__name__ = "RowPointer"
...
_RbnSubsNotifyEnable_Type.__name__ = "TruthValue"
...
rbnSubsCompliance.setObjects(
      *(("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsActiveGroup"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsStatsGroup"))
)
if mibBuilder.loadTexts:
...
rbnSubsCompliance2.setObjects(
      *(("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsActiveGroup2"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsStatsGroup2"))
)
if mibBuilder.loadTexts:
...
rbnSubsCompliance3.setObjects(
      *(("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsActiveGroup3"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsStatsGroup2"))
)
if mibBuilder.loadTexts:
...
rbnSubsCompliance4.setObjects(
      *(("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsActiveGroup3"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsStatsGroup2"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsServicesGroup"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsNotifyObjectGroup"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsNotifyGroup"))
)
if mibBuilder.loadTexts:
...
rbnSubsCompliance5.setObjects(
      *(("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsActiveGroup3"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsStatsGroup2"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsServicesGroup"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsNotifyObjectGroup"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsNotifyGroup"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsLicenseGroup"))
)
if mibBuilder.loadTexts:
...
rbnSubsCompliance6.setObjects(
      *(("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsActiveGroup4"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsStatsGroup3"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsServicesGroup"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsNotifyObjectGroup"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsNotifyGroup"),
        ("RBN-SUBSCRIBER-ACTIVE-MIB", "rbnSubsLicenseGroup"))
