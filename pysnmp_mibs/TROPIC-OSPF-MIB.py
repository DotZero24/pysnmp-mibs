...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TROPIC-OSPF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:52:14 2025
...
tnOspfv3PortTopologyId = _TnOspfv3PortTopologyId_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 21, 1, 2),
    _TnOspfv3PortTopologyId_Type()
)
tnOspfv3PortTopologyId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnOspfv3PortTopologyId.setStatus("current")
...
class _TnOspfMultiAreaConfigVirtualLinkIp_Type(IpAddress):
    """Custom type tnOspfMultiAreaConfigVirtualLinkIp based on IpAddress"""
    defaultHexValue = "00000000"


_TnOspfMultiAreaConfigVirtualLinkIp_Type.__name__ = "IpAddress"
...
tnOspfv3MultiAreaConfigTable = _TnOspfv3MultiAreaConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23)
)
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigTable.setStatus("current")
_TnOspfv3MultiAreaConfigEntry_Object = MibTableRow
tnOspfv3MultiAreaConfigEntry = _TnOspfv3MultiAreaConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1)
)
tnOspfv3MultiAreaConfigEntry.setIndexNames(
    (0, "TROPIC-OSPF-MIB", "tnOspfv3MultiAreaTopologyId"),
)
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigEntry.setStatus("current")
_TnOspfv3MultiAreaTopologyId_Type = TnTopologyId
_TnOspfv3MultiAreaTopologyId_Object = MibTableColumn
tnOspfv3MultiAreaTopologyId = _TnOspfv3MultiAreaTopologyId_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1, 1),
    _TnOspfv3MultiAreaTopologyId_Type()
)
tnOspfv3MultiAreaTopologyId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaTopologyId.setStatus("current")
_TnOspfv3MultiAreaId_Type = AreaID
_TnOspfv3MultiAreaId_Object = MibTableColumn
tnOspfv3MultiAreaId = _TnOspfv3MultiAreaId_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1, 2),
    _TnOspfv3MultiAreaId_Type()
)
tnOspfv3MultiAreaId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaId.setStatus("current")


class _TnOspfv3MultiAreaConfigType_Type(Integer32):
    """Custom type tnOspfv3MultiAreaConfigType based on Integer32"""
    defaultValue = 1
...
_TnOspfv3MultiAreaConfigType_Type.__name__ = "Integer32"
_TnOspfv3MultiAreaConfigType_Object = MibTableColumn
tnOspfv3MultiAreaConfigType = _TnOspfv3MultiAreaConfigType_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1, 3),
    _TnOspfv3MultiAreaConfigType_Type()
)
tnOspfv3MultiAreaConfigType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigType.setStatus("current")


class _TnOspfv3MultiAreaConfigDnsOpaqueLsa_Type(Integer32):
    """Custom type tnOspfv3MultiAreaConfigDnsOpaqueLsa based on Integer32"""
    defaultValue = 1
...
_TnOspfv3MultiAreaConfigDnsOpaqueLsa_Type.__name__ = "Integer32"
_TnOspfv3MultiAreaConfigDnsOpaqueLsa_Object = MibTableColumn
tnOspfv3MultiAreaConfigDnsOpaqueLsa = _TnOspfv3MultiAreaConfigDnsOpaqueLsa_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1, 4),
    _TnOspfv3MultiAreaConfigDnsOpaqueLsa_Type()
)
tnOspfv3MultiAreaConfigDnsOpaqueLsa.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigDnsOpaqueLsa.setStatus("current")


class _TnOspfv3MultiAreaConfigWavekeyOpaqueLsa_Type(Integer32):
    """Custom type tnOspfv3MultiAreaConfigWavekeyOpaqueLsa based on Integer32"""
    defaultValue = 1
...
_TnOspfv3MultiAreaConfigWavekeyOpaqueLsa_Type.__name__ = "Integer32"
_TnOspfv3MultiAreaConfigWavekeyOpaqueLsa_Object = MibTableColumn
tnOspfv3MultiAreaConfigWavekeyOpaqueLsa = _TnOspfv3MultiAreaConfigWavekeyOpaqueLsa_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1, 5),
    _TnOspfv3MultiAreaConfigWavekeyOpaqueLsa_Type()
)
tnOspfv3MultiAreaConfigWavekeyOpaqueLsa.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigWavekeyOpaqueLsa.setStatus("current")


class _TnOspfv3MultiAreaConfigNssaTranslate_Type(Integer32):
    """Custom type tnOspfv3MultiAreaConfigNssaTranslate based on Integer32"""
    defaultValue = 1
...
_TnOspfv3MultiAreaConfigNssaTranslate_Type.__name__ = "Integer32"
_TnOspfv3MultiAreaConfigNssaTranslate_Object = MibTableColumn
tnOspfv3MultiAreaConfigNssaTranslate = _TnOspfv3MultiAreaConfigNssaTranslate_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1, 6),
    _TnOspfv3MultiAreaConfigNssaTranslate_Type()
)
tnOspfv3MultiAreaConfigNssaTranslate.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigNssaTranslate.setStatus("current")


class _TnOspfv3MultiAreaConfigDefaultCost_Type(Integer32):
    """Custom type tnOspfv3MultiAreaConfigDefaultCost based on Integer32"""
    defaultValue = 10


_TnOspfv3MultiAreaConfigDefaultCost_Type.__name__ = "Integer32"
_TnOspfv3MultiAreaConfigDefaultCost_Object = MibTableColumn
tnOspfv3MultiAreaConfigDefaultCost = _TnOspfv3MultiAreaConfigDefaultCost_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1, 7),
    _TnOspfv3MultiAreaConfigDefaultCost_Type()
)
tnOspfv3MultiAreaConfigDefaultCost.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigDefaultCost.setStatus("current")


class _TnOspfv3MultiAreaConfigVirtualLinkIp_Type(IpAddress):
    """Custom type tnOspfv3MultiAreaConfigVirtualLinkIp based on IpAddress"""
    defaultHexValue = "00000000"


_TnOspfv3MultiAreaConfigVirtualLinkIp_Type.__name__ = "IpAddress"
_TnOspfv3MultiAreaConfigVirtualLinkIp_Object = MibTableColumn
tnOspfv3MultiAreaConfigVirtualLinkIp = _TnOspfv3MultiAreaConfigVirtualLinkIp_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1, 8),
    _TnOspfv3MultiAreaConfigVirtualLinkIp_Type()
)
tnOspfv3MultiAreaConfigVirtualLinkIp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigVirtualLinkIp.setStatus("current")


class _TnOspfv3MultiAreaConfigRowStatus_Type(RowStatus):
    """Custom type tnOspfv3MultiAreaConfigRowStatus based on RowStatus"""
    defaultValue = 6


_TnOspfv3MultiAreaConfigRowStatus_Type.__name__ = "RowStatus"
_TnOspfv3MultiAreaConfigRowStatus_Object = MibTableColumn
tnOspfv3MultiAreaConfigRowStatus = _TnOspfv3MultiAreaConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 2, 23, 1, 9),
    _TnOspfv3MultiAreaConfigRowStatus_Type()
)
tnOspfv3MultiAreaConfigRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigRowStatus.setStatus("current")
...
tnOspfPortGroup.setObjects(
      *(("TROPIC-OSPF-MIB", "tnOspfPortTopologyId"),
        ("TROPIC-OSPF-MIB", "tnOspfv3PortTopologyId"))
)
if mibBuilder.loadTexts:
...
tnOspfv3MultiAreaConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 7483, 2, 5, 1, 1, 1, 23)
)
tnOspfv3MultiAreaConfigGroup.setObjects(
      *(("TROPIC-OSPF-MIB", "tnOspfv3MultiAreaId"),
        ("TROPIC-OSPF-MIB", "tnOspfv3MultiAreaConfigType"),
        ("TROPIC-OSPF-MIB", "tnOspfv3MultiAreaConfigDnsOpaqueLsa"),
        ("TROPIC-OSPF-MIB", "tnOspfv3MultiAreaConfigWavekeyOpaqueLsa"),
        ("TROPIC-OSPF-MIB", "tnOspfv3MultiAreaConfigNssaTranslate"),
        ("TROPIC-OSPF-MIB", "tnOspfv3MultiAreaConfigDefaultCost"),
        ("TROPIC-OSPF-MIB", "tnOspfv3MultiAreaConfigVirtualLinkIp"),
        ("TROPIC-OSPF-MIB", "tnOspfv3MultiAreaConfigRowStatus"))
)
if mibBuilder.loadTexts:
    tnOspfv3MultiAreaConfigGroup.setStatus("current")
...
tnOspfCompliance.setObjects(
      *(("TROPIC-OSPF-MIB", "tnOspfAreaGroup"),
        ...
        ("TROPIC-OSPF-MIB", "tnOspfv3MultiAreaConfigGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"TnTopologyId": TnTopologyId,
       ...
       "tnOspfv3MultiAreaConfigGroup": tnOspfv3MultiAreaConfigGroup,
       ...
       "tnOspfv3PortTopologyId": tnOspfv3PortTopologyId,
       ...
       "tnOspfv3MultiAreaConfigTable": tnOspfv3MultiAreaConfigTable,
       "tnOspfv3MultiAreaConfigEntry": tnOspfv3MultiAreaConfigEntry,
       "tnOspfv3MultiAreaTopologyId": tnOspfv3MultiAreaTopologyId,
       "tnOspfv3MultiAreaId": tnOspfv3MultiAreaId,
       "tnOspfv3MultiAreaConfigType": tnOspfv3MultiAreaConfigType,
       "tnOspfv3MultiAreaConfigDnsOpaqueLsa": tnOspfv3MultiAreaConfigDnsOpaqueLsa,
       "tnOspfv3MultiAreaConfigWavekeyOpaqueLsa": tnOspfv3MultiAreaConfigWavekeyOpaqueLsa,
       "tnOspfv3MultiAreaConfigNssaTranslate": tnOspfv3MultiAreaConfigNssaTranslate,
       "tnOspfv3MultiAreaConfigDefaultCost": tnOspfv3MultiAreaConfigDefaultCost,
       "tnOspfv3MultiAreaConfigVirtualLinkIp": tnOspfv3MultiAreaConfigVirtualLinkIp,
       "tnOspfv3MultiAreaConfigRowStatus": tnOspfv3MultiAreaConfigRowStatus}
)
