...
class HpInetCidrRouteState(TextualConvention, Bits):
    status = 'current'
    namedValues = NamedValues(("remote", 0), ("notInstall", 1), ("noAdvise", 2), ("interior", 3), ("exterior", 4), ("delete", 5), ("hidden", 6), ("initial", 7), ("release", 8), ("unused", 9), ("unused2", 10), ("retain", 11), ("unused3", 12), ("gateway", 13), ("reject", 14), ("static", 15), ("null", 16), ("ifSubnetMask", 17), ("unused4", 18), ("suppressed", 19), ("eligibleUnicast", 21), ("eligibleMulticast", 22), ("activeUnicast", 23), ("activeMulticast", 24), ("pendingUnicast", 25), ("pendingMulticast", 26), ("inferiorMed", 27), ("split", 28), ("aggr", 29), ("bgpAggr", 30), ("recurse", 31))
