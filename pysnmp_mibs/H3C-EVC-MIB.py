...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-EVC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:17:58 2025
...
_H3cEvcSrvInstEnableInStat_Type.__name__ = "TruthValue"
...
_H3cEvcSrvInstEnableOutStat_Type.__name__ = "TruthValue"
...
class _H3cEvcSrvInstCvlanIdListLow_Type(OctetString):
    """Custom type h3cEvcSrvInstCvlanIdListLow based on OctetString"""
    defaultHexValue = ""
...
_H3cEvcSrvInstCvlanIdListLow_Type.__name__ = "OctetString"
_H3cEvcSrvInstCvlanIdListLow_Object = MibTableColumn
h3cEvcSrvInstCvlanIdListLow = _H3cEvcSrvInstCvlanIdListLow_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 106, 1, 2, 1, 8),
    _H3cEvcSrvInstCvlanIdListLow_Type()
)
h3cEvcSrvInstCvlanIdListLow.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cEvcSrvInstCvlanIdListLow.setStatus("current")


class _H3cEvcSrvInstCvlanIdListHigh_Type(OctetString):
    """Custom type h3cEvcSrvInstCvlanIdListHigh based on OctetString"""
    defaultHexValue = ""
...
_H3cEvcSrvInstCvlanIdListHigh_Type.__name__ = "OctetString"
_H3cEvcSrvInstCvlanIdListHigh_Object = MibTableColumn
h3cEvcSrvInstCvlanIdListHigh = _H3cEvcSrvInstCvlanIdListHigh_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 106, 1, 2, 1, 9),
    _H3cEvcSrvInstCvlanIdListHigh_Type()
)
h3cEvcSrvInstCvlanIdListHigh.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cEvcSrvInstCvlanIdListHigh.setStatus("current")
_H3cEvcSrvInstCarTable_Object = MibTable
h3cEvcSrvInstCarTable = _H3cEvcSrvInstCarTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 106, 1, 3)
)
if mibBuilder.loadTexts:
...
h3cEvcSrvInstCarEntry = _H3cEvcSrvInstCarEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 106, 1, 3, 1)
)
...
h3cEvcSrvInstStatInfoEntry = _H3cEvcSrvInstStatInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 106, 1, 4, 1)
)
...
mibBuilder.exportSymbols(
    ...
    **{"h3cEvc": h3cEvc,
       ...
       "h3cEvcSrvInstCvlanIdListLow": h3cEvcSrvInstCvlanIdListLow,
       "h3cEvcSrvInstCvlanIdListHigh": h3cEvcSrvInstCvlanIdListHigh,
