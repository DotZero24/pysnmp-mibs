...
# Notes
# -----
# ASN.1 source file://mibs/microsens/MS-SWITCH30-MIB
...
class _AgentIpv4Mode_Type(Integer32):
    """Custom type agentIpv4Mode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentIpv4Mode_Type.__name__ = "Integer32"
_AgentIpv4Mode_Object = MibScalar
agentIpv4Mode = _AgentIpv4Mode_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 2, 3),
    _AgentIpv4Mode_Type()
)
agentIpv4Mode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentIpv4Mode.setStatus("current")
_AgentIpv4Address_Type = IpAddress
_AgentIpv4Address_Object = MibScalar
agentIpv4Address = _AgentIpv4Address_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 2, 4),
    _AgentIpv4Address_Type()
)
agentIpv4Address.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentIpv4Address.setStatus("current")
_AgentIpv4SubnetMask_Type = IpAddress
_AgentIpv4SubnetMask_Object = MibScalar
agentIpv4SubnetMask = _AgentIpv4SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 2, 5),
    _AgentIpv4SubnetMask_Type()
)
agentIpv4SubnetMask.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentIpv4SubnetMask.setStatus("current")
_AgentIpv4Gateway_Type = IpAddress
_AgentIpv4Gateway_Object = MibScalar
agentIpv4Gateway = _AgentIpv4Gateway_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 2, 6),
    _AgentIpv4Gateway_Type()
)
agentIpv4Gateway.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentIpv4Gateway.setStatus("current")
...
class _AgentDhcpConfigRequest_Type(Integer32):
    """Custom type agentDhcpConfigRequest based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentDhcpConfigRequest_Type.__name__ = "Integer32"
_AgentDhcpConfigRequest_Object = MibScalar
agentDhcpConfigRequest = _AgentDhcpConfigRequest_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 2, 15),
    _AgentDhcpConfigRequest_Type()
)
agentDhcpConfigRequest.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentDhcpConfigRequest.setStatus("current")
...
couplingredPartnerIpv4Address = _CouplingredPartnerIpv4Address_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 8, 4),
    _CouplingredPartnerIpv4Address_Type()
)
couplingredPartnerIpv4Address.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    couplingredPartnerIpv4Address.setStatus("current")
...
rtcSNTPServerIpv4Address = _RtcSNTPServerIpv4Address_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 15, 20, 1, 4),
    _RtcSNTPServerIpv4Address_Type()
)
rtcSNTPServerIpv4Address.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rtcSNTPServerIpv4Address.setStatus("current")
...
snmpTrapDestIPv4Address = _SnmpTrapDestIPv4Address_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 22, 10, 1, 4),
    _SnmpTrapDestIPv4Address_Type()
)
snmpTrapDestIPv4Address.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snmpTrapDestIPv4Address.setStatus("current")
...
class _UdpUmacEnable_Type(Integer32):
    """Custom type udpUmacEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_UdpUmacEnable_Type.__name__ = "Integer32"
_UdpUmacEnable_Object = MibScalar
udpUmacEnable = _UdpUmacEnable_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 23, 3),
    _UdpUmacEnable_Type()
)
udpUmacEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    udpUmacEnable.setStatus("current")
...
syslogDestIpv4Address = _SyslogDestIpv4Address_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 24, 10, 1, 4),
    _SyslogDestIpv4Address_Type()
)
syslogDestIpv4Address.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    syslogDestIpv4Address.setStatus("current")
...
class _RadiusMacLettercase_Type(Integer32):
    """Custom type radiusMacLettercase based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_RadiusMacLettercase_Type.__name__ = "Integer32"
_RadiusMacLettercase_Object = MibScalar
radiusMacLettercase = _RadiusMacLettercase_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 25, 9),
    _RadiusMacLettercase_Type()
)
radiusMacLettercase.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    radiusMacLettercase.setStatus("current")
...
radiusServerIpv4Address = _RadiusServerIpv4Address_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 3, 25, 10, 1, 5),
    _RadiusServerIpv4Address_Type()
)
radiusServerIpv4Address.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    radiusServerIpv4Address.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"microsens": microsens,
       ...
       "agentIpv4Mode": agentIpv4Mode,
       "agentIpv4Address": agentIpv4Address,
       "agentIpv4SubnetMask": agentIpv4SubnetMask,
       "agentIpv4Gateway": agentIpv4Gateway,
       ...
       "agentDhcpConfigRequest": agentDhcpConfigRequest,
       "port": port,
       "portCount": portCount,
       ...
       "couplingredPartnerIpv4Address": couplingredPartnerIpv4Address,
       ...
       "rtcSNTPServerIpv4Address": rtcSNTPServerIpv4Address,
       ...
       "snmpTrapDestIPv4Address": snmpTrapDestIPv4Address,
       ...
       "syslogDestIpv4Address": syslogDestIpv4Address,
       ...
       "radiusMacLettercase": radiusMacLettercase,
       ...
       "radiusServerIpv4Address": radiusServerIpv4Address,
