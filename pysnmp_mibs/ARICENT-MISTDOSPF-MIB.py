# SNMP MIB module (ARICENT-MISTDOSPF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MISTDOSPF-MIB
...
fsMIStdOspfAreaEntry = _FsMIStdOspfAreaEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 2, 1)
)
fsMIStdOspfAreaEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfAreaId"),
)
if mibBuilder.loadTexts:
...
fsMIStdOspfStubAreaEntry = _FsMIStdOspfStubAreaEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 3, 1)
)
fsMIStdOspfStubAreaEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfStubAreaId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfStubTOS"),
)
if mibBuilder.loadTexts:
...
fsMIStdOspfLsdbEntry = _FsMIStdOspfLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 4, 1)
)
fsMIStdOspfLsdbEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfLsdbAreaId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfLsdbType"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfLsdbLsid"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
fsMIStdOspfHostEntry = _FsMIStdOspfHostEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 5, 1)
)
fsMIStdOspfHostEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfHostIpAddress"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfHostTOS"),
)
if mibBuilder.loadTexts:
...
fsMIStdOspfIfMetricEntry = _FsMIStdOspfIfMetricEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 7, 1)
)
fsMIStdOspfIfMetricEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfIfMetricIpAddress"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfIfMetricAddressLessIf"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfIfMetricTOS"),
)
if mibBuilder.loadTexts:
...
fsMIStdOspfVirtIfEntry = _FsMIStdOspfVirtIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 8, 1)
)
fsMIStdOspfVirtIfEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfVirtIfAreaId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfVirtIfNeighbor"),
)
if mibBuilder.loadTexts:
...
fsMIStdOspfNbrEntry = _FsMIStdOspfNbrEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 9, 1)
)
fsMIStdOspfNbrEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfNbrIpAddr"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfNbrAddressLessIndex"),
)
if mibBuilder.loadTexts:
...
fsMIStdOspfVirtNbrEntry = _FsMIStdOspfVirtNbrEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 10, 1)
)
fsMIStdOspfVirtNbrEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfVirtNbrArea"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfVirtNbrRtrId"),
)
if mibBuilder.loadTexts:
...
fsMIStdOspfExtLsdbEntry = _FsMIStdOspfExtLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 11, 1)
)
fsMIStdOspfExtLsdbEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfExtLsdbType"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfExtLsdbLsid"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfExtLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
fsMIStdOspfAreaAggregateEntry = _FsMIStdOspfAreaAggregateEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 146, 13, 1)
)
fsMIStdOspfAreaAggregateEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfAreaAggregateAreaID"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfAreaAggregateLsdbType"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfAreaAggregateNet"),
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfAreaAggregateMask"),
)
if mibBuilder.loadTexts:
