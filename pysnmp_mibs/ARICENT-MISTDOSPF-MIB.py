...
class UpToMaxAge(TextualConvention,Integer32):status=_A;displayHint=_I;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,3600))
...
fsMIStdOspfGeneralGroup=_FsMIStdOspfGeneralGroup_ObjectIdentity((1,3,6,1,4,1,2076,146,1))
_FsMIStdOspfTable_Object=MibTable
fsMIStdOspfTable=_FsMIStdOspfTable_Object((1,3,6,1,4,1,2076,146,1,1))
if mibBuilder.loadTexts:fsMIStdOspfTable.setStatus(_A)
_FsMIStdOspfEntry_Object=MibTableRow
fsMIStdOspfEntry=_FsMIStdOspfEntry_Object((1,3,6,1,4,1,2076,146,1,1,1))
...
fsMIStdOspfContextId=_FsMIStdOspfContextId_Object((1,3,6,1,4,1,2076,146,1,1,1,1),_FsMIStdOspfContextId_Type())
...
fsMIStdOspfRouterId=_FsMIStdOspfRouterId_Object((1,3,6,1,4,1,2076,146,1,1,1,2),_FsMIStdOspfRouterId_Type())
...
fsMIStdOspfAdminStat=_FsMIStdOspfAdminStat_Object((1,3,6,1,4,1,2076,146,1,1,1,3),_FsMIStdOspfAdminStat_Type())
...
fsMIStdOspfVersionNumber=_FsMIStdOspfVersionNumber_Object((1,3,6,1,4,1,2076,146,1,1,1,4),_FsMIStdOspfVersionNumber_Type())
...
fsMIStdOspfAreaBdrRtrStatus=_FsMIStdOspfAreaBdrRtrStatus_Object((1,3,6,1,4,1,2076,146,1,1,1,5),_FsMIStdOspfAreaBdrRtrStatus_Type())
...
fsMIStdOspfASBdrRtrStatus=_FsMIStdOspfASBdrRtrStatus_Object((1,3,6,1,4,1,2076,146,1,1,1,6),_FsMIStdOspfASBdrRtrStatus_Type())
...
fsMIStdOspfExternLsaCount=_FsMIStdOspfExternLsaCount_Object((1,3,6,1,4,1,2076,146,1,1,1,7),_FsMIStdOspfExternLsaCount_Type())
...
fsMIStdOspfExternLsaCksumSum=_FsMIStdOspfExternLsaCksumSum_Object((1,3,6,1,4,1,2076,146,1,1,1,8),_FsMIStdOspfExternLsaCksumSum_Type())
...
fsMIStdOspfTOSSupport=_FsMIStdOspfTOSSupport_Object((1,3,6,1,4,1,2076,146,1,1,1,9),_FsMIStdOspfTOSSupport_Type())
...
fsMIStdOspfOriginateNewLsas=_FsMIStdOspfOriginateNewLsas_Object((1,3,6,1,4,1,2076,146,1,1,1,10),_FsMIStdOspfOriginateNewLsas_Type())
...
fsMIStdOspfRxNewLsas=_FsMIStdOspfRxNewLsas_Object((1,3,6,1,4,1,2076,146,1,1,1,11),_FsMIStdOspfRxNewLsas_Type())
...
fsMIStdOspfExtLsdbLimit=_FsMIStdOspfExtLsdbLimit_Object((1,3,6,1,4,1,2076,146,1,1,1,12),_FsMIStdOspfExtLsdbLimit_Type())
...
fsMIStdOspfMulticastExtensions=_FsMIStdOspfMulticastExtensions_Object((1,3,6,1,4,1,2076,146,1,1,1,13),_FsMIStdOspfMulticastExtensions_Type())
...
fsMIStdOspfExitOverflowInterval=_FsMIStdOspfExitOverflowInterval_Object((1,3,6,1,4,1,2076,146,1,1,1,14),_FsMIStdOspfExitOverflowInterval_Type())
...
fsMIStdOspfDemandExtensions=_FsMIStdOspfDemandExtensions_Object((1,3,6,1,4,1,2076,146,1,1,1,15),_FsMIStdOspfDemandExtensions_Type())
...
fsMIStdOspfStatus=_FsMIStdOspfStatus_Object((1,3,6,1,4,1,2076,146,1,1,1,16),_FsMIStdOspfStatus_Type())
...
fsMIStdOspfAreaTable=_FsMIStdOspfAreaTable_Object((1,3,6,1,4,1,2076,146,2))
if mibBuilder.loadTexts:fsMIStdOspfAreaTable.setStatus(_A)
_FsMIStdOspfAreaEntry_Object=MibTableRow
fsMIStdOspfAreaEntry=_FsMIStdOspfAreaEntry_Object((1,3,6,1,4,1,2076,146,2,1))
...
fsMIStdOspfAreaId=_FsMIStdOspfAreaId_Object((1,3,6,1,4,1,2076,146,2,1,1),_FsMIStdOspfAreaId_Type())
...
fsMIStdOspfImportAsExtern=_FsMIStdOspfImportAsExtern_Object((1,3,6,1,4,1,2076,146,2,1,3),_FsMIStdOspfImportAsExtern_Type())
...
fsMIStdOspfSpfRuns=_FsMIStdOspfSpfRuns_Object((1,3,6,1,4,1,2076,146,2,1,4),_FsMIStdOspfSpfRuns_Type())
...
fsMIStdOspfAreaBdrRtrCount=_FsMIStdOspfAreaBdrRtrCount_Object((1,3,6,1,4,1,2076,146,2,1,5),_FsMIStdOspfAreaBdrRtrCount_Type())
...
fsMIStdOspfAsBdrRtrCount=_FsMIStdOspfAsBdrRtrCount_Object((1,3,6,1,4,1,2076,146,2,1,6),_FsMIStdOspfAsBdrRtrCount_Type())
...
fsMIStdOspfAreaLsaCount=_FsMIStdOspfAreaLsaCount_Object((1,3,6,1,4,1,2076,146,2,1,7),_FsMIStdOspfAreaLsaCount_Type())
...
fsMIStdOspfAreaLsaCksumSum=_FsMIStdOspfAreaLsaCksumSum_Object((1,3,6,1,4,1,2076,146,2,1,8),_FsMIStdOspfAreaLsaCksumSum_Type())
...
fsMIStdOspfAreaSummary=_FsMIStdOspfAreaSummary_Object((1,3,6,1,4,1,2076,146,2,1,9),_FsMIStdOspfAreaSummary_Type())
...
fsMIStdOspfAreaStatus=_FsMIStdOspfAreaStatus_Object((1,3,6,1,4,1,2076,146,2,1,10),_FsMIStdOspfAreaStatus_Type())
...
fsMIStdOspfStubAreaTable=_FsMIStdOspfStubAreaTable_Object((1,3,6,1,4,1,2076,146,3))
if mibBuilder.loadTexts:fsMIStdOspfStubAreaTable.setStatus(_A)
_FsMIStdOspfStubAreaEntry_Object=MibTableRow
fsMIStdOspfStubAreaEntry=_FsMIStdOspfStubAreaEntry_Object((1,3,6,1,4,1,2076,146,3,1))
...
fsMIStdOspfStubAreaId=_FsMIStdOspfStubAreaId_Object((1,3,6,1,4,1,2076,146,3,1,1),_FsMIStdOspfStubAreaId_Type())
...
fsMIStdOspfStubTOS=_FsMIStdOspfStubTOS_Object((1,3,6,1,4,1,2076,146,3,1,2),_FsMIStdOspfStubTOS_Type())
...
fsMIStdOspfStubMetric=_FsMIStdOspfStubMetric_Object((1,3,6,1,4,1,2076,146,3,1,3),_FsMIStdOspfStubMetric_Type())
...
fsMIStdOspfStubStatus=_FsMIStdOspfStubStatus_Object((1,3,6,1,4,1,2076,146,3,1,4),_FsMIStdOspfStubStatus_Type())
...
fsMIStdOspfStubMetricType=_FsMIStdOspfStubMetricType_Object((1,3,6,1,4,1,2076,146,3,1,5),_FsMIStdOspfStubMetricType_Type())
...
fsMIStdOspfLsdbTable=_FsMIStdOspfLsdbTable_Object((1,3,6,1,4,1,2076,146,4))
if mibBuilder.loadTexts:fsMIStdOspfLsdbTable.setStatus(_A)
_FsMIStdOspfLsdbEntry_Object=MibTableRow
fsMIStdOspfLsdbEntry=_FsMIStdOspfLsdbEntry_Object((1,3,6,1,4,1,2076,146,4,1))
...
fsMIStdOspfLsdbAreaId=_FsMIStdOspfLsdbAreaId_Object((1,3,6,1,4,1,2076,146,4,1,1),_FsMIStdOspfLsdbAreaId_Type())
...
fsMIStdOspfLsdbType=_FsMIStdOspfLsdbType_Object((1,3,6,1,4,1,2076,146,4,1,2),_FsMIStdOspfLsdbType_Type())
...
fsMIStdOspfLsdbLsid=_FsMIStdOspfLsdbLsid_Object((1,3,6,1,4,1,2076,146,4,1,3),_FsMIStdOspfLsdbLsid_Type())
...
fsMIStdOspfLsdbRouterId=_FsMIStdOspfLsdbRouterId_Object((1,3,6,1,4,1,2076,146,4,1,4),_FsMIStdOspfLsdbRouterId_Type())
...
fsMIStdOspfLsdbSequence=_FsMIStdOspfLsdbSequence_Object((1,3,6,1,4,1,2076,146,4,1,5),_FsMIStdOspfLsdbSequence_Type())
...
fsMIStdOspfLsdbAge=_FsMIStdOspfLsdbAge_Object((1,3,6,1,4,1,2076,146,4,1,6),_FsMIStdOspfLsdbAge_Type())
...
fsMIStdOspfLsdbChecksum=_FsMIStdOspfLsdbChecksum_Object((1,3,6,1,4,1,2076,146,4,1,7),_FsMIStdOspfLsdbChecksum_Type())
...
fsMIStdOspfLsdbAdvertisement=_FsMIStdOspfLsdbAdvertisement_Object((1,3,6,1,4,1,2076,146,4,1,8),_FsMIStdOspfLsdbAdvertisement_Type())
...
fsMIStdOspfHostTable=_FsMIStdOspfHostTable_Object((1,3,6,1,4,1,2076,146,5))
if mibBuilder.loadTexts:fsMIStdOspfHostTable.setStatus(_A)
_FsMIStdOspfHostEntry_Object=MibTableRow
fsMIStdOspfHostEntry=_FsMIStdOspfHostEntry_Object((1,3,6,1,4,1,2076,146,5,1))
...
fsMIStdOspfHostIpAddress=_FsMIStdOspfHostIpAddress_Object((1,3,6,1,4,1,2076,146,5,1,1),_FsMIStdOspfHostIpAddress_Type())
...
fsMIStdOspfHostTOS=_FsMIStdOspfHostTOS_Object((1,3,6,1,4,1,2076,146,5,1,2),_FsMIStdOspfHostTOS_Type())
...
fsMIStdOspfHostMetric=_FsMIStdOspfHostMetric_Object((1,3,6,1,4,1,2076,146,5,1,3),_FsMIStdOspfHostMetric_Type())
...
fsMIStdOspfHostStatus=_FsMIStdOspfHostStatus_Object((1,3,6,1,4,1,2076,146,5,1,4),_FsMIStdOspfHostStatus_Type())
...
fsMIStdOspfHostAreaID=_FsMIStdOspfHostAreaID_Object((1,3,6,1,4,1,2076,146,5,1,5),_FsMIStdOspfHostAreaID_Type())
...
fsMIStdOspfIfTable=_FsMIStdOspfIfTable_Object((1,3,6,1,4,1,2076,146,6))
if mibBuilder.loadTexts:fsMIStdOspfIfTable.setStatus(_A)
_FsMIStdOspfIfEntry_Object=MibTableRow
fsMIStdOspfIfEntry=_FsMIStdOspfIfEntry_Object((1,3,6,1,4,1,2076,146,6,1))
...
fsMIStdOspfIfIpAddress=_FsMIStdOspfIfIpAddress_Object((1,3,6,1,4,1,2076,146,6,1,1),_FsMIStdOspfIfIpAddress_Type())
...
fsMIStdOspfAddressLessIf=_FsMIStdOspfAddressLessIf_Object((1,3,6,1,4,1,2076,146,6,1,2),_FsMIStdOspfAddressLessIf_Type())
...
fsMIStdOspfIfAreaId=_FsMIStdOspfIfAreaId_Object((1,3,6,1,4,1,2076,146,6,1,3),_FsMIStdOspfIfAreaId_Type())
...
fsMIStdOspfIfType=_FsMIStdOspfIfType_Object((1,3,6,1,4,1,2076,146,6,1,4),_FsMIStdOspfIfType_Type())
...
fsMIStdOspfIfAdminStat=_FsMIStdOspfIfAdminStat_Object((1,3,6,1,4,1,2076,146,6,1,5),_FsMIStdOspfIfAdminStat_Type())
...
fsMIStdOspfIfRtrPriority=_FsMIStdOspfIfRtrPriority_Object((1,3,6,1,4,1,2076,146,6,1,6),_FsMIStdOspfIfRtrPriority_Type())
...
fsMIStdOspfIfTransitDelay=_FsMIStdOspfIfTransitDelay_Object((1,3,6,1,4,1,2076,146,6,1,7),_FsMIStdOspfIfTransitDelay_Type())
...
fsMIStdOspfIfRetransInterval=_FsMIStdOspfIfRetransInterval_Object((1,3,6,1,4,1,2076,146,6,1,8),_FsMIStdOspfIfRetransInterval_Type())
...
fsMIStdOspfIfHelloInterval=_FsMIStdOspfIfHelloInterval_Object((1,3,6,1,4,1,2076,146,6,1,9),_FsMIStdOspfIfHelloInterval_Type())
fsMIStdOspfIfHelloInterval.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMIStdOspfIfHelloInterval.setStatus(_A)
class _FsMIStdOspfIfRtrDeadInterval_Type(PositiveInteger):defaultValue=40;subtypeSpec=PositiveInteger.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,65535))
_FsMIStdOspfIfRtrDeadInterval_Type.__name__=_K
_FsMIStdOspfIfRtrDeadInterval_Object=MibTableColumn
fsMIStdOspfIfRtrDeadInterval=_FsMIStdOspfIfRtrDeadInterval_Object((1,3,6,1,4,1,2076,146,6,1,10),_FsMIStdOspfIfRtrDeadInterval_Type())
...
fsMIStdOspfIfPollInterval=_FsMIStdOspfIfPollInterval_Object((1,3,6,1,4,1,2076,146,6,1,11),_FsMIStdOspfIfPollInterval_Type())
...
fsMIStdOspfIfState=_FsMIStdOspfIfState_Object((1,3,6,1,4,1,2076,146,6,1,12),_FsMIStdOspfIfState_Type())
...
fsMIStdOspfIfDesignatedRouter=_FsMIStdOspfIfDesignatedRouter_Object((1,3,6,1,4,1,2076,146,6,1,13),_FsMIStdOspfIfDesignatedRouter_Type())
...
fsMIStdOspfIfBackupDesignatedRouter=_FsMIStdOspfIfBackupDesignatedRouter_Object((1,3,6,1,4,1,2076,146,6,1,14),_FsMIStdOspfIfBackupDesignatedRouter_Type())
...
fsMIStdOspfIfEvents=_FsMIStdOspfIfEvents_Object((1,3,6,1,4,1,2076,146,6,1,15),_FsMIStdOspfIfEvents_Type())
...
fsMIStdOspfIfAuthKey=_FsMIStdOspfIfAuthKey_Object((1,3,6,1,4,1,2076,146,6,1,16),_FsMIStdOspfIfAuthKey_Type())
...
fsMIStdOspfIfStatus=_FsMIStdOspfIfStatus_Object((1,3,6,1,4,1,2076,146,6,1,17),_FsMIStdOspfIfStatus_Type())
...
fsMIStdOspfIfMulticastForwarding=_FsMIStdOspfIfMulticastForwarding_Object((1,3,6,1,4,1,2076,146,6,1,18),_FsMIStdOspfIfMulticastForwarding_Type())
...
fsMIStdOspfIfDemand=_FsMIStdOspfIfDemand_Object((1,3,6,1,4,1,2076,146,6,1,19),_FsMIStdOspfIfDemand_Type())
...
fsMIStdOspfIfAuthType=_FsMIStdOspfIfAuthType_Object((1,3,6,1,4,1,2076,146,6,1,20),_FsMIStdOspfIfAuthType_Type())
...
fsMIStdOspfIfCryptoAuthType=_FsMIStdOspfIfCryptoAuthType_Object((1,3,6,1,4,1,2076,146,6,1,21),_FsMIStdOspfIfCryptoAuthType_Type())
...
fsMIStdOspfIfMetricTable=_FsMIStdOspfIfMetricTable_Object((1,3,6,1,4,1,2076,146,7))
if mibBuilder.loadTexts:fsMIStdOspfIfMetricTable.setStatus(_A)
_FsMIStdOspfIfMetricEntry_Object=MibTableRow
fsMIStdOspfIfMetricEntry=_FsMIStdOspfIfMetricEntry_Object((1,3,6,1,4,1,2076,146,7,1))
...
fsMIStdOspfIfMetricIpAddress=_FsMIStdOspfIfMetricIpAddress_Object((1,3,6,1,4,1,2076,146,7,1,1),_FsMIStdOspfIfMetricIpAddress_Type())
...
fsMIStdOspfIfMetricAddressLessIf=_FsMIStdOspfIfMetricAddressLessIf_Object((1,3,6,1,4,1,2076,146,7,1,2),_FsMIStdOspfIfMetricAddressLessIf_Type())
...
fsMIStdOspfIfMetricTOS=_FsMIStdOspfIfMetricTOS_Object((1,3,6,1,4,1,2076,146,7,1,3),_FsMIStdOspfIfMetricTOS_Type())
...
fsMIStdOspfIfMetricValue=_FsMIStdOspfIfMetricValue_Object((1,3,6,1,4,1,2076,146,7,1,4),_FsMIStdOspfIfMetricValue_Type())
...
fsMIStdOspfIfMetricStatus=_FsMIStdOspfIfMetricStatus_Object((1,3,6,1,4,1,2076,146,7,1,5),_FsMIStdOspfIfMetricStatus_Type())
...
fsMIStdOspfVirtIfTable=_FsMIStdOspfVirtIfTable_Object((1,3,6,1,4,1,2076,146,8))
if mibBuilder.loadTexts:fsMIStdOspfVirtIfTable.setStatus(_A)
_FsMIStdOspfVirtIfEntry_Object=MibTableRow
fsMIStdOspfVirtIfEntry=_FsMIStdOspfVirtIfEntry_Object((1,3,6,1,4,1,2076,146,8,1))
...
fsMIStdOspfVirtIfAreaId=_FsMIStdOspfVirtIfAreaId_Object((1,3,6,1,4,1,2076,146,8,1,1),_FsMIStdOspfVirtIfAreaId_Type())
...
fsMIStdOspfVirtIfNeighbor=_FsMIStdOspfVirtIfNeighbor_Object((1,3,6,1,4,1,2076,146,8,1,2),_FsMIStdOspfVirtIfNeighbor_Type())
...
fsMIStdOspfVirtIfTransitDelay=_FsMIStdOspfVirtIfTransitDelay_Object((1,3,6,1,4,1,2076,146,8,1,3),_FsMIStdOspfVirtIfTransitDelay_Type())
...
fsMIStdOspfVirtIfRetransInterval=_FsMIStdOspfVirtIfRetransInterval_Object((1,3,6,1,4,1,2076,146,8,1,4),_FsMIStdOspfVirtIfRetransInterval_Type())
...
fsMIStdOspfVirtIfHelloInterval=_FsMIStdOspfVirtIfHelloInterval_Object((1,3,6,1,4,1,2076,146,8,1,5),_FsMIStdOspfVirtIfHelloInterval_Type())
...
fsMIStdOspfVirtIfRtrDeadInterval=_FsMIStdOspfVirtIfRtrDeadInterval_Object((1,3,6,1,4,1,2076,146,8,1,6),_FsMIStdOspfVirtIfRtrDeadInterval_Type())
...
fsMIStdOspfVirtIfState=_FsMIStdOspfVirtIfState_Object((1,3,6,1,4,1,2076,146,8,1,7),_FsMIStdOspfVirtIfState_Type())
...
fsMIStdOspfVirtIfEvents=_FsMIStdOspfVirtIfEvents_Object((1,3,6,1,4,1,2076,146,8,1,8),_FsMIStdOspfVirtIfEvents_Type())
...
fsMIStdOspfVirtIfAuthKey=_FsMIStdOspfVirtIfAuthKey_Object((1,3,6,1,4,1,2076,146,8,1,9),_FsMIStdOspfVirtIfAuthKey_Type())
...
fsMIStdOspfVirtIfStatus=_FsMIStdOspfVirtIfStatus_Object((1,3,6,1,4,1,2076,146,8,1,10),_FsMIStdOspfVirtIfStatus_Type())
...
fsMIStdOspfVirtIfAuthType=_FsMIStdOspfVirtIfAuthType_Object((1,3,6,1,4,1,2076,146,8,1,11),_FsMIStdOspfVirtIfAuthType_Type())
...
fsMIStdOspfVirtIfCryptoAuthType=_FsMIStdOspfVirtIfCryptoAuthType_Object((1,3,6,1,4,1,2076,146,8,1,12),_FsMIStdOspfVirtIfCryptoAuthType_Type())
...
fsMIStdOspfNbrTable=_FsMIStdOspfNbrTable_Object((1,3,6,1,4,1,2076,146,9))
if mibBuilder.loadTexts:fsMIStdOspfNbrTable.setStatus(_A)
_FsMIStdOspfNbrEntry_Object=MibTableRow
fsMIStdOspfNbrEntry=_FsMIStdOspfNbrEntry_Object((1,3,6,1,4,1,2076,146,9,1))
...
fsMIStdOspfNbrIpAddr=_FsMIStdOspfNbrIpAddr_Object((1,3,6,1,4,1,2076,146,9,1,1),_FsMIStdOspfNbrIpAddr_Type())
...
fsMIStdOspfNbrAddressLessIndex=_FsMIStdOspfNbrAddressLessIndex_Object((1,3,6,1,4,1,2076,146,9,1,2),_FsMIStdOspfNbrAddressLessIndex_Type())
...
fsMIStdOspfNbrRtrId=_FsMIStdOspfNbrRtrId_Object((1,3,6,1,4,1,2076,146,9,1,3),_FsMIStdOspfNbrRtrId_Type())
...
fsMIStdOspfNbrOptions=_FsMIStdOspfNbrOptions_Object((1,3,6,1,4,1,2076,146,9,1,4),_FsMIStdOspfNbrOptions_Type())
...
fsMIStdOspfNbrPriority=_FsMIStdOspfNbrPriority_Object((1,3,6,1,4,1,2076,146,9,1,5),_FsMIStdOspfNbrPriority_Type())
...
fsMIStdOspfNbrState=_FsMIStdOspfNbrState_Object((1,3,6,1,4,1,2076,146,9,1,6),_FsMIStdOspfNbrState_Type())
...
fsMIStdOspfNbrEvents=_FsMIStdOspfNbrEvents_Object((1,3,6,1,4,1,2076,146,9,1,7),_FsMIStdOspfNbrEvents_Type())
...
fsMIStdOspfNbrLsRetransQLen=_FsMIStdOspfNbrLsRetransQLen_Object((1,3,6,1,4,1,2076,146,9,1,8),_FsMIStdOspfNbrLsRetransQLen_Type())
...
fsMIStdOspfNbmaNbrStatus=_FsMIStdOspfNbmaNbrStatus_Object((1,3,6,1,4,1,2076,146,9,1,9),_FsMIStdOspfNbmaNbrStatus_Type())
...
fsMIStdOspfNbmaNbrPermanence=_FsMIStdOspfNbmaNbrPermanence_Object((1,3,6,1,4,1,2076,146,9,1,10),_FsMIStdOspfNbmaNbrPermanence_Type())
...
fsMIStdOspfNbrHelloSuppressed=_FsMIStdOspfNbrHelloSuppressed_Object((1,3,6,1,4,1,2076,146,9,1,11),_FsMIStdOspfNbrHelloSuppressed_Type())
...
fsMIStdOspfVirtNbrTable=_FsMIStdOspfVirtNbrTable_Object((1,3,6,1,4,1,2076,146,10))
if mibBuilder.loadTexts:fsMIStdOspfVirtNbrTable.setStatus(_A)
_FsMIStdOspfVirtNbrEntry_Object=MibTableRow
fsMIStdOspfVirtNbrEntry=_FsMIStdOspfVirtNbrEntry_Object((1,3,6,1,4,1,2076,146,10,1))
...
fsMIStdOspfVirtNbrArea=_FsMIStdOspfVirtNbrArea_Object((1,3,6,1,4,1,2076,146,10,1,1),_FsMIStdOspfVirtNbrArea_Type())
...
fsMIStdOspfVirtNbrRtrId=_FsMIStdOspfVirtNbrRtrId_Object((1,3,6,1,4,1,2076,146,10,1,2),_FsMIStdOspfVirtNbrRtrId_Type())
...
fsMIStdOspfVirtNbrIpAddr=_FsMIStdOspfVirtNbrIpAddr_Object((1,3,6,1,4,1,2076,146,10,1,3),_FsMIStdOspfVirtNbrIpAddr_Type())
...
fsMIStdOspfVirtNbrOptions=_FsMIStdOspfVirtNbrOptions_Object((1,3,6,1,4,1,2076,146,10,1,4),_FsMIStdOspfVirtNbrOptions_Type())
...
fsMIStdOspfVirtNbrState=_FsMIStdOspfVirtNbrState_Object((1,3,6,1,4,1,2076,146,10,1,5),_FsMIStdOspfVirtNbrState_Type())
...
fsMIStdOspfVirtNbrEvents=_FsMIStdOspfVirtNbrEvents_Object((1,3,6,1,4,1,2076,146,10,1,6),_FsMIStdOspfVirtNbrEvents_Type())
...
fsMIStdOspfVirtNbrLsRetransQLen=_FsMIStdOspfVirtNbrLsRetransQLen_Object((1,3,6,1,4,1,2076,146,10,1,7),_FsMIStdOspfVirtNbrLsRetransQLen_Type())
...
fsMIStdOspfVirtNbrHelloSuppressed=_FsMIStdOspfVirtNbrHelloSuppressed_Object((1,3,6,1,4,1,2076,146,10,1,8),_FsMIStdOspfVirtNbrHelloSuppressed_Type())
...
fsMIStdOspfExtLsdbTable=_FsMIStdOspfExtLsdbTable_Object((1,3,6,1,4,1,2076,146,11))
if mibBuilder.loadTexts:fsMIStdOspfExtLsdbTable.setStatus(_A)
_FsMIStdOspfExtLsdbEntry_Object=MibTableRow
fsMIStdOspfExtLsdbEntry=_FsMIStdOspfExtLsdbEntry_Object((1,3,6,1,4,1,2076,146,11,1))
...
fsMIStdOspfExtLsdbType=_FsMIStdOspfExtLsdbType_Object((1,3,6,1,4,1,2076,146,11,1,1),_FsMIStdOspfExtLsdbType_Type())
...
fsMIStdOspfExtLsdbLsid=_FsMIStdOspfExtLsdbLsid_Object((1,3,6,1,4,1,2076,146,11,1,2),_FsMIStdOspfExtLsdbLsid_Type())
...
fsMIStdOspfExtLsdbRouterId=_FsMIStdOspfExtLsdbRouterId_Object((1,3,6,1,4,1,2076,146,11,1,3),_FsMIStdOspfExtLsdbRouterId_Type())
...
fsMIStdOspfExtLsdbSequence=_FsMIStdOspfExtLsdbSequence_Object((1,3,6,1,4,1,2076,146,11,1,4),_FsMIStdOspfExtLsdbSequence_Type())
...
fsMIStdOspfExtLsdbAge=_FsMIStdOspfExtLsdbAge_Object((1,3,6,1,4,1,2076,146,11,1,5),_FsMIStdOspfExtLsdbAge_Type())
...
fsMIStdOspfExtLsdbChecksum=_FsMIStdOspfExtLsdbChecksum_Object((1,3,6,1,4,1,2076,146,11,1,6),_FsMIStdOspfExtLsdbChecksum_Type())
...
fsMIStdOspfExtLsdbAdvertisement=_FsMIStdOspfExtLsdbAdvertisement_Object((1,3,6,1,4,1,2076,146,11,1,7),_FsMIStdOspfExtLsdbAdvertisement_Type())
...
fsMIStdOspfRouteGroup=_FsMIStdOspfRouteGroup_ObjectIdentity((1,3,6,1,4,1,2076,146,12))
_FsMIStdOspfIntraArea_ObjectIdentity=ObjectIdentity
fsMIStdOspfIntraArea=_FsMIStdOspfIntraArea_ObjectIdentity((1,3,6,1,4,1,2076,146,12,1))
_FsMIStdOspfInterArea_ObjectIdentity=ObjectIdentity
fsMIStdOspfInterArea=_FsMIStdOspfInterArea_ObjectIdentity((1,3,6,1,4,1,2076,146,12,2))
_FsMIStdOspfExternalType1_ObjectIdentity=ObjectIdentity
fsMIStdOspfExternalType1=_FsMIStdOspfExternalType1_ObjectIdentity((1,3,6,1,4,1,2076,146,12,3))
_FsMIStdOspfExternalType2_ObjectIdentity=ObjectIdentity
fsMIStdOspfExternalType2=_FsMIStdOspfExternalType2_ObjectIdentity((1,3,6,1,4,1,2076,146,12,4))
_FsMIStdOspfAreaAggregateTable_Object=MibTable
fsMIStdOspfAreaAggregateTable=_FsMIStdOspfAreaAggregateTable_Object((1,3,6,1,4,1,2076,146,13))
if mibBuilder.loadTexts:fsMIStdOspfAreaAggregateTable.setStatus(_A)
_FsMIStdOspfAreaAggregateEntry_Object=MibTableRow
fsMIStdOspfAreaAggregateEntry=_FsMIStdOspfAreaAggregateEntry_Object((1,3,6,1,4,1,2076,146,13,1))
...
fsMIStdOspfAreaAggregateAreaID=_FsMIStdOspfAreaAggregateAreaID_Object((1,3,6,1,4,1,2076,146,13,1,1),_FsMIStdOspfAreaAggregateAreaID_Type())
...
fsMIStdOspfAreaAggregateLsdbType=_FsMIStdOspfAreaAggregateLsdbType_Object((1,3,6,1,4,1,2076,146,13,1,2),_FsMIStdOspfAreaAggregateLsdbType_Type())
...
fsMIStdOspfAreaAggregateNet=_FsMIStdOspfAreaAggregateNet_Object((1,3,6,1,4,1,2076,146,13,1,3),_FsMIStdOspfAreaAggregateNet_Type())
...
fsMIStdOspfAreaAggregateMask=_FsMIStdOspfAreaAggregateMask_Object((1,3,6,1,4,1,2076,146,13,1,4),_FsMIStdOspfAreaAggregateMask_Type())
...
fsMIStdOspfAreaAggregateStatus=_FsMIStdOspfAreaAggregateStatus_Object((1,3,6,1,4,1,2076,146,13,1,5),_FsMIStdOspfAreaAggregateStatus_Type())
...
fsMIStdOspfAreaAggregateEffect=_FsMIStdOspfAreaAggregateEffect_Object((1,3,6,1,4,1,2076,146,13,1,6),_FsMIStdOspfAreaAggregateEffect_Type())
