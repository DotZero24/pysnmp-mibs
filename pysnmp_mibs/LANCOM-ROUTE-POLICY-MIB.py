...
fastPathRouting,=mibBuilder.importSymbols('LANCOM-ROUTING-MIB','fastPathRouting')
...
fastPathRoutePolicy=ModuleIdentity((1,3,6,1,4,1,2356,16,1,2,20))
...
fastpathRoutePolicyNameTable=_FastpathRoutePolicyNameTable_Object((1,3,6,1,4,1,2356,16,1,2,20,1))
if mibBuilder.loadTexts:fastpathRoutePolicyNameTable.setStatus(_A)
_FastpathRoutePolicyNameEntry_Object=MibTableRow
fastpathRoutePolicyNameEntry=_FastpathRoutePolicyNameEntry_Object((1,3,6,1,4,1,2356,16,1,2,20,1,1))
...
fastpathRoutePolicyName=_FastpathRoutePolicyName_Object((1,3,6,1,4,1,2356,16,1,2,20,1,1,1),_FastpathRoutePolicyName_Type())
...
fastpathRoutePolicyStmtActionType=_FastpathRoutePolicyStmtActionType_Object((1,3,6,1,4,1,2356,16,1,2,20,1,1,2),_FastpathRoutePolicyStmtActionType_Type())
...
fastpathRoutePolicySequence=_FastpathRoutePolicySequence_Object((1,3,6,1,4,1,2356,16,1,2,20,1,1,3),_FastpathRoutePolicySequence_Type())
...
fastpathRoutePolicyNameRowStatus=_FastpathRoutePolicyNameRowStatus_Object((1,3,6,1,4,1,2356,16,1,2,20,1,1,4),_FastpathRoutePolicyNameRowStatus_Type())
...
fastpathRoutePolicyStamentTable=_FastpathRoutePolicyStamentTable_Object((1,3,6,1,4,1,2356,16,1,2,20,2))
...
fastpathRoutePolicyStatementEntry=_FastpathRoutePolicyStatementEntry_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1))
...
fastpathRoutePolicyStmtName=_FastpathRoutePolicyStmtName_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,1),_FastpathRoutePolicyStmtName_Type())
...
fastpathRoutePolicyStmtSeqNum=_FastpathRoutePolicyStmtSeqNum_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,2),_FastpathRoutePolicyStmtSeqNum_Type())
...
fastpathRoutePolicyStmtAction=_FastpathRoutePolicyStmtAction_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,3),_FastpathRoutePolicyStmtAction_Type())
...
fastpathRoutePolicyStmtMatchIpv4AclList=_FastpathRoutePolicyStmtMatchIpv4AclList_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,4),_FastpathRoutePolicyStmtMatchIpv4AclList_Type())
...
fastpathRoutePolicyStmtMatchIpv4AclDelList=_FastpathRoutePolicyStmtMatchIpv4AclDelList_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,5),_FastpathRoutePolicyStmtMatchIpv4AclDelList_Type())
...
fastpathRoutePolicyStmtMatchMacAclList=_FastpathRoutePolicyStmtMatchMacAclList_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,6),_FastpathRoutePolicyStmtMatchMacAclList_Type())
...
fastpathRoutePolicyStmtMatchMacAclDelList=_FastpathRoutePolicyStmtMatchMacAclDelList_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,7),_FastpathRoutePolicyStmtMatchMacAclDelList_Type())
...
fastpathRoutePolicyStmtMatchPacketLengthRangeMin=_FastpathRoutePolicyStmtMatchPacketLengthRangeMin_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,8),_FastpathRoutePolicyStmtMatchPacketLengthRangeMin_Type())
...
fastpathRoutePolicyStmtMatchPacketLengthRangeMax=_FastpathRoutePolicyStmtMatchPacketLengthRangeMax_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,9),_FastpathRoutePolicyStmtMatchPacketLengthRangeMax_Type())
...
fastpathRoutePolicyStmtSetIpNextHopList=_FastpathRoutePolicyStmtSetIpNextHopList_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,10),_FastpathRoutePolicyStmtSetIpNextHopList_Type())
...
fastpathRoutePolicyStmtSetIpNextHopDelList=_FastpathRoutePolicyStmtSetIpNextHopDelList_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,11),_FastpathRoutePolicyStmtSetIpNextHopDelList_Type())
...
fastpathRoutePolicyStmtSetDefaultIpNextHopList=_FastpathRoutePolicyStmtSetDefaultIpNextHopList_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,12),_FastpathRoutePolicyStmtSetDefaultIpNextHopList_Type())
...
fastpathRoutePolicyStmtSetDefaultIpNextHopDelList=_FastpathRoutePolicyStmtSetDefaultIpNextHopDelList_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,13),_FastpathRoutePolicyStmtSetDefaultIpNextHopDelList_Type())
...
fastpathRoutePolicyStmtSetIpPrecedence=_FastpathRoutePolicyStmtSetIpPrecedence_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,14),_FastpathRoutePolicyStmtSetIpPrecedence_Type())
...
fastpathRoutePolicyStmtSetIntfNull0=_FastpathRoutePolicyStmtSetIntfNull0_Object((1,3,6,1,4,1,2356,16,1,2,20,2,1,15),_FastpathRoutePolicyStmtSetIntfNull0_Type())
...
fastpathRoutePolicyIfTable=_FastpathRoutePolicyIfTable_Object((1,3,6,1,4,1,2356,16,1,2,20,3))
if mibBuilder.loadTexts:fastpathRoutePolicyIfTable.setStatus(_A)
_FastpathRoutePolicyIfEntry_Object=MibTableRow
fastpathRoutePolicyIfEntry=_FastpathRoutePolicyIfEntry_Object((1,3,6,1,4,1,2356,16,1,2,20,3,1))
...
fastpathRoutePolicyIfIndex=_FastpathRoutePolicyIfIndex_Object((1,3,6,1,4,1,2356,16,1,2,20,3,1,1),_FastpathRoutePolicyIfIndex_Type())
...
fastpathRoutePolicyIfName=_FastpathRoutePolicyIfName_Object((1,3,6,1,4,1,2356,16,1,2,20,3,1,2),_FastpathRoutePolicyIfName_Type())
...
fastpathRoutePolicyIfRowStatus=_FastpathRoutePolicyIfRowStatus_Object((1,3,6,1,4,1,2356,16,1,2,20,3,1,3),_FastpathRoutePolicyIfRowStatus_Type())
