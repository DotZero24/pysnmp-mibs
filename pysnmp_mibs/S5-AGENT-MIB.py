...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/nortel/S5-AGENT-MIB
...
s5AgInfoBootMode = MibScalar((1, 3, 6, 1, 4, 1, 45, 1, 6, 4, 2, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8, 9))).clone(namedValues=NamedValues(("other", 1), ("local", 2), ("net", 3), ("netWhenNeeded", 4), ("netOrLastAddress", 5), ("dhcp", 6), ("dhcpWhenNeeded", 7), ("dhcpOrLastAddress", 8), ("netOrDhcpAddress", 9)))).setMaxAccess("readwrite")
...
s5AgSnmpMaxPktSize = MibScalar((1, 3, 6, 1, 4, 1, 45, 1, 6, 4, 3, 6), Integer32().subtype(subtypeSpec=ValueRangeConstraint(484, 8192)).clone(2048)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: s5AgSnmpMaxPktSize.setStatus('current')
...
s5AgSysBinaryConfigFilename = MibScalar((1, 3, 6, 1, 4, 1, 45, 1, 6, 4, 4, 4), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 255))).setMaxAccess("readwrite")
...
s5AgSysAsciiConfigFilename = MibScalar((1, 3, 6, 1, 4, 1, 45, 1, 6, 4, 4, 6), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 255))).setMaxAccess("readwrite")
...
s5AgSysAsciiConfigManualUploadApplications = MibScalar((1, 3, 6, 1, 4, 1, 45, 1, 6, 4, 4, 43), Bits().clone(namedValues=NamedValues(("ieee802dot1ab", 0), ("aaur", 1), ("adac", 2), ("arpInspection", 3), ("assetId", 4), ("aur", 5), ("banner", 6), ("brouter", 7), ("cops", 8), ("core", 9), ("defaultCmdInterface", 10), ("dhcpRelay", 11), ("dhcpSnooping", 12), ("eap", 13), ("esu", 14), ("interface", 15), ("ip", 16), ("ipSourceGuard", 17), ("ipfix", 18), ("ipmc", 19), ("ipmgr", 20), ("ipv6", 21), ("l3", 22), ("l3Protocols", 23), ("lacp", 24), ("logging", 25), ("macSecurity", 26), ("mlt", 27), ("pim", 28), ("poe", 29), ("portMirroring", 30), ("pvst", 31), ("qos", 32), ("rateLimit", 33), ("rmon", 34), ("rtc", 35), ("slpp", 36), ("snmp", 37), ("smlt", 38), ("nsna", 39), ("ssh", 40), ("ssl", 41), ("stack", 42), ("stkmon", 43), ("stp", 44), ("vlacp", 45), ("vlan", 46), ("energySaver", 47), ("unicastStormControl", 48), ("wireless", 49), ("sshc", 50), ("dhcpServer", 51), ("fcoe", 52), ("cfm", 53), ("slamon", 54), ("spbm", 55), ("lst", 56), ("sflow", 57), ("ipv6-mld", 58), ("ipv6-fhs", 59), ("stormControl", 60), ("aaa", 61), ("fabric-attach", 62), ("ipv6-ripng", 63), ("radius", 64), ("tacacs", 65), ("mvr", 66), ("vrrpv3", 67), ("macsec", 68), ("ipsec", 69), ("ike", 70), ("digicert", 71), ("apptel", 72)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: s5AgSysAsciiConfigManualUploadApplications.setStatus('current')
s5AgSysOperationalLicense = MibScalar((1, 3, 6, 1, 4, 1, 45, 1, 6, 4, 4, 44), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))).clone(namedValues=NamedValues(("basic", 1), ("advanced", 2), ("premier", 3), ("stack", 4), ("macsec", 5), ("advanced-macsec", 6), ("premier-macsec", 7), ("demo", 8)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: s5AgSysOperationalLicense.setStatus('current')
s5AgSysInstalledLicense = MibScalar((1, 3, 6, 1, 4, 1, 45, 1, 6, 4, 4, 45), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))).clone(namedValues=NamedValues(("basic", 1), ("advanced", 2), ("premier", 3), ("stack", 4), ("macsec", 5), ("advanced-macsec", 6), ("premier-macsec", 7), ("demo", 8)))).setMaxAccess("readonly")
...
s5AgBannerControl = MibScalar((1, 3, 6, 1, 4, 1, 45, 1, 6, 4, 5, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("static", 1), ("custom", 2), ("disabled", 3), ("usg", 4)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("S5-AGENT-MIB", s5AgentLicenseNumUniqueIds=s5AgentLicenseNumUniqueIds, s5AgBootCfgBlocksTime=s5AgBootCfgBlocksTime, s5AgSysTftpServerInetAddressType=s5AgSysTftpServerInetAddressType, s5AgInfoLoadProtocolLast=s5AgInfoLoadProtocolLast, s5AgInfoStackBootpMACUsage=s5AgInfoStackBootpMACUsage, s5AgSntpSecondaryServerAddress=s5AgSntpSecondaryServerAddress, s5AgSysAutoPvid=s5AgSysAutoPvid, s5AgRemoteLoginInetAddressType=s5AgRemoteLoginInetAddressType, s5AgAsciiConfigScriptOperStatus=s5AgAsciiConfigScriptOperStatus, s5AgInfoNumBootBanks=s5AgInfoNumBootBanks, s5AgRemoteLoginStatus=s5AgRemoteLoginStatus, s5AgTrapEntryStatus=s5AgTrapEntryStatus, s5AgBannerControl=s5AgBannerControl, s5AgSysGlobalFlowControlEnabled=s5AgSysGlobalFlowControlEnabled, s5AgDaylightSavingsStartMonth=s5AgDaylightSavingsStartMonth, s5AgOthIfEntry=s5AgOthIfEntry, s5AgInfoImgDownloadPercentComplete=s5AgInfoImgDownloadPercentComplete, s5AgSysLicenseFilename=s5AgSysLicenseFilename, s5AgentLicenseMd5Key=s5AgentLicenseMd5Key, s5AgDaylightSavingsRecurringEndWeek=s5AgDaylightSavingsRecurringEndWeek, s5AgentSntp=s5AgentSntp, s5AgTrpRcvrAddrType=s5AgTrpRcvrAddrType, s5AgMyIfNxtBootNetMask=s5AgMyIfNxtBootNetMask, s5AgDataCollectIfIndex=s5AgDataCollectIfIndex, s5AgSysStackIpv6MgmtNetMask=s5AgSysStackIpv6MgmtNetMask, s5AgDaylightSavingsRecurringStartDay=s5AgDaylightSavingsRecurringStartDay, s5AgAsciiConfigScriptBootPriority=s5AgAsciiConfigScriptBootPriority, s5AgDataCollectEntry=s5AgDataCollectEntry, s5AgIpDefaultRtrSelectionMode=s5AgIpDefaultRtrSelectionMode, s5AgUnAuthInetAddress=s5AgUnAuthInetAddress, s5AgDaylightSavingsTimeZoneAcronym=s5AgDaylightSavingsTimeZoneAcronym, s5AgSysAutoUnitReplacementForceSave=s5AgSysAutoUnitReplacementForceSave, s5AgTrpRcvrAgeTime=s5AgTrpRcvrAgeTime, s5AgAsciiConfigScriptLastStatusChange=s5AgAsciiConfigScriptLastStatusChange, s5AgTrapFilterTrapInitiator1=s5AgTrapFilterTrapInitiator1, s5AgSysBinaryConfigFilename=s5AgSysBinaryConfigFilename, s5AgInfoImgType=s5AgInfoImgType, s5AgDaylightSavingsRecurringEndMinute=s5AgDaylightSavingsRecurringEndMinute, s5AgBootCfgBlocksValid=s5AgBootCfgBlocksValid, s5AgentLicenseVersion=s5AgentLicenseVersion, s5AgTrapFilterIndex=s5AgTrapFilterIndex, s5AgTrapFilterTable=s5AgTrapFilterTable, s5AgSysSpanningTreeAdminCompatibility=s5AgSysSpanningTreeAdminCompatibility, s5AgentScriptParameters=s5AgentScriptParameters, s5AgSslServerControl=s5AgSslServerControl, s5AgentScriptEntry=s5AgentScriptEntry, s5AgTrpRcvrMaxEnt=s5AgTrpRcvrMaxEnt, s5AgSysFlushMacAddrTableByTrunk=s5AgSysFlushMacAddrTableByTrunk, s5AgSysVlanConfigControl=s5AgSysVlanConfigControl, s5AgUnAuthComm=s5AgUnAuthComm, s5AgSysSpanningTreeAdminMode=s5AgSysSpanningTreeAdminMode, s5AgSysInstalledLicense=s5AgSysInstalledLicense, s5AgSntpPrimaryServerAddress=s5AgSntpPrimaryServerAddress, s5AgUnAuthInetAddressType=s5AgUnAuthInetAddressType, s5AgSysManagementVlanId=s5AgSysManagementVlanId, s5AgMyIfImgFname=s5AgMyIfImgFname, s5AgSysAutoUnitReplacementSaveEnabled=s5AgSysAutoUnitReplacementSaveEnabled, s5AgSysBlinkLedsUnit=s5AgSysBlinkLedsUnit, s5AgSntpSyncRetryInterval=s5AgSntpSyncRetryInterval, s5AgSslEnabled=s5AgSslEnabled, s5AgAsciiConfigScriptTable=s5AgAsciiConfigScriptTable, s5AgTrapFilterGlobalStatus=s5AgTrapFilterGlobalStatus, s5AgSysSerialSecurityEnable=s5AgSysSerialSecurityEnable, s5AgSntpLastSyncTime=s5AgSntpLastSyncTime, s5AgMyComIndx=s5AgMyComIndx, s5AgentLicenseTable=s5AgentLicenseTable, s5AgSslCertificateExists=s5AgSslCertificateExists, s5AgInfoNextBootBank=s5AgInfoNextBootBank, s5AgMyIfBootRouterAddr=s5AgMyIfBootRouterAddr, s5AgSysAsciiConfigAutoDldStatus=s5AgSysAsciiConfigAutoDldStatus, s5AgDaylightSavingsEndMonth=s5AgDaylightSavingsEndMonth, s5AgAsciiConfigScriptIndex=s5AgAsciiConfigScriptIndex, s5AgentLicenseTimeBase=s5AgentLicenseTimeBase, s5AgSntpTimeZone=s5AgSntpTimeZone, s5AgClockRtcTime=s5AgClockRtcTime, s5AgDaylightSavingsRecurringStartHour=s5AgDaylightSavingsRecurringStartHour, s5AgSysSpanningTreePortMode=s5AgSysSpanningTreePortMode, s5AgTrapFilterDelayTime=s5AgTrapFilterDelayTime, s5AgentLicenseEntry=s5AgentLicenseEntry, s5AgBootCfgCurrentBootBlock=s5AgBootCfgCurrentBootBlock, s5AgSysStackInsertionUnitNumber=s5AgSysStackInsertionUnitNumber, s5AgSysIpv6MgmtGateway=s5AgSysIpv6MgmtGateway, s5AgSysNextBootOperationalMode=s5AgSysNextBootOperationalMode, s5AgDaylightSavingsStartDay=s5AgDaylightSavingsStartDay, s5AgDaylightSavingsRecurringStartWeek=s5AgDaylightSavingsRecurringStartWeek, s5AgDaylightSavingsRecurringStartMonth=s5AgDaylightSavingsRecurringStartMonth, s5AgTrpRcvrComm=s5AgTrpRcvrComm, s5AgInfoLoadProtocolNxtBoot=s5AgInfoLoadProtocolNxtBoot, s5AgSysMgmtStackIpAddress=s5AgSysMgmtStackIpAddress, s5AgClockSource=s5AgClockSource, s5AgentDaylightSavings=s5AgentDaylightSavings, s5AgTrapFilterTrapOID=s5AgTrapFilterTrapOID, s5AgInfoMgmtProtocolNxtBoot=s5AgInfoMgmtProtocolNxtBoot, s5AgentClock=s5AgentClock, s5AgOthIfIpAddr=s5AgOthIfIpAddr, s5AgentScriptTable=s5AgentScriptTable, PYSNMP_MODULE_ID=s5AgentMib, s5AgentLicenseIndex=s5AgentLicenseIndex, s5AgentScriptRun=s5AgentScriptRun, s5AgMyIfMacAddr=s5AgMyIfMacAddr, s5AgSysTftpServerInetAddress=s5AgSysTftpServerInetAddress, s5AgBootCfgBlocksIndex=s5AgBootCfgBlocksIndex, s5AgSysAuditEnable=s5AgSysAuditEnable, s5AgSysStackIpv6NetMask=s5AgSysStackIpv6NetMask, s5AgDaylightSavingsStartHour=s5AgDaylightSavingsStartHour, s5AgentLicenseTimeExpiration=s5AgentLicenseTimeExpiration, s5AgSntpSecondaryServerInetAddress=s5AgSntpSecondaryServerInetAddress, s5AgSysSflowGlobalEnable=s5AgSysSflowGlobalEnable, s5AgSysDiagnosticsQuickModeEnabled=s5AgSysDiagnosticsQuickModeEnabled, s5AgSysAsciiConfigManualDownload=s5AgSysAsciiConfigManualDownload, s5AgSysFlushMacAddrTableByPortList=s5AgSysFlushMacAddrTableByPortList, s5AgBootCfgBlocksTable=s5AgBootCfgBlocksTable, s5AgInfoDstLoadBank=s5AgInfoDstLoadBank, s5AgentLicense=s5AgentLicense, s5AgOthIfTable=s5AgOthIfTable, s5AgSysSpanningTreeOperCompatibility=s5AgSysSpanningTreeOperCompatibility, s5AgSntpPrimaryServerSyncFailures=s5AgSntpPrimaryServerSyncFailures, s5AgAsciiConfigScriptManual=s5AgAsciiConfigScriptManual, s5AgInfoNxtBootDfltGwAddr=s5AgInfoNxtBootDfltGwAddr, s5AgentBootConfigScalars=s5AgentBootConfigScalars, s5AgentGbl=s5AgentGbl, s5AgInfoMgmtProtocolCur=s5AgInfoMgmtProtocolCur, s5AgSysFlushMacAddrTableByAddress=s5AgSysFlushMacAddrTableByAddress, s5AgSysAsciiConfigFilename=s5AgSysAsciiConfigFilename, s5AgSysTftpServerAddress=s5AgSysTftpServerAddress, s5AgSntpSyncInterval=s5AgSntpSyncInterval, s5AgDaylightSavingsOffset=s5AgDaylightSavingsOffset, s5AgSysMacAddrTableLearningPorts=s5AgSysMacAddrTableLearningPorts, s5AgSysOperationalLicense=s5AgSysOperationalLicense, s5AgCustomBannerId=s5AgCustomBannerId, s5AgSysForcedStackModeEnabled=s5AgSysForcedStackModeEnabled, s5AgSysTelnetSessionLoginAuthenType=s5AgSysTelnetSessionLoginAuthenType, s5AgOthIfComIndx=s5AgOthIfComIndx, s5AgOthIfGrpIndx=s5AgOthIfGrpIndx, s5AgClockRtcSyncWithNtp=s5AgClockRtcSyncWithNtp, s5AgInfoScheduleBootTime=s5AgInfoScheduleBootTime, s5AgSysCpuIpv6NetMask=s5AgSysCpuIpv6NetMask, s5AgOthIfIpxAddr=s5AgOthIfIpxAddr, s5AgInfoSlotScope=s5AgInfoSlotScope, s5AgentSsl=s5AgentSsl, s5AgDaylightSavingsEndMinutes=s5AgDaylightSavingsEndMinutes, s5AgInfoFileAction=s5AgInfoFileAction, s5AgDataCollectTable=s5AgDataCollectTable, s5AgSysAutoUnitReplacementRestore=s5AgSysAutoUnitReplacementRestore, s5AgSysSshAuthKeyFilename=s5AgSysSshAuthKeyFilename, s5AgUnAuthIpAddr=s5AgUnAuthIpAddr, s5AgSysAsciiConfigManualUpload=s5AgSysAsciiConfigManualUpload, s5AgTrpRcvrNext=s5AgTrpRcvrNext, s5AgTrapFilterTrapInitiator2=s5AgTrapFilterTrapInitiator2, s5AgAsciiConfigScriptSource=s5AgAsciiConfigScriptSource, s5AgSnmpMaxPktSize=s5AgSnmpMaxPktSize, s5AgInfoScheduleBootCancel=s5AgInfoScheduleBootCancel, s5AgentLicenseStatus=s5AgentLicenseStatus, s5AgMyIfTable=s5AgMyIfTable, s5AgMyIfIndx=s5AgMyIfIndx, s5AgSysSpanningTreePathCostCalculationMode=s5AgSysSpanningTreePathCostCalculationMode, s5AgSslCertificateControl=s5AgSslCertificateControl, s5AgInfoBootMode=s5AgInfoBootMode, s5AgInfoImgLoadMode=s5AgInfoImgLoadMode, s5AgSysCpuIpv6Address=s5AgSysCpuIpv6Address, s5AgBootCfgNextBootBlock=s5AgBootCfgNextBootBlock, s5AgMyIfLdSvrAddr=s5AgMyIfLdSvrAddr, s5AgTrpRcvrEntry=s5AgTrpRcvrEntry, s5AgSntpManualSyncRequest=s5AgSntpManualSyncRequest, s5AgDaylightSavingsEndHour=s5AgDaylightSavingsEndHour, s5AgSntpPrimaryServerInetAddress=s5AgSntpPrimaryServerInetAddress, s5AgSysAsciiConfigManualUploadApplications=s5AgSysAsciiConfigManualUploadApplications, s5AgTrpRcvrCurEnt=s5AgTrpRcvrCurEnt, s5AgDaylightSavingsEndDay=s5AgDaylightSavingsEndDay, s5AgSntpSecondaryServerSyncFailures=s5AgSntpSecondaryServerSyncFailures, s5AgSysTimeStampEnabled=s5AgSysTimeStampEnabled, s5AgSysIdentifyUnits=s5AgSysIdentifyUnits, s5AgentLicenseFlags=s5AgentLicenseFlags, s5AgentInfo=s5AgentInfo, s5AgDaylightSavingsStartMinutes=s5AgDaylightSavingsStartMinutes, s5AgDaylightSavingsRecurringEndMonth=s5AgDaylightSavingsRecurringEndMonth, s5AgSntpSecondaryServerInetAddressType=s5AgSntpSecondaryServerInetAddressType, s5AgentLicenseMd5File=s5AgentLicenseMd5File, s5AgentSystem=s5AgentSystem, s5AgMyIfNxtBootIpAddr=s5AgMyIfNxtBootIpAddr, s5AgSysAutosaveToNvramEnabled=s5AgSysAutosaveToNvramEnabled, s5AgInfoDramUsage=s5AgInfoDramUsage, s5AgentLicenseType=s5AgentLicenseType, s5AgTrpRcvrStatus=s5AgTrpRcvrStatus, s5AgentHw=s5AgentHw, s5AgDaylightSavingsRecurringEndDay=s5AgDaylightSavingsRecurringEndDay, s5AgSntpNextSyncTime=s5AgSntpNextSyncTime, s5AgSysFlushMacAddrTableByVlan=s5AgSysFlushMacAddrTableByVlan, s5AgSntpCurrentTime=s5AgSntpCurrentTime, s5AgSysFlushMacAddrTableAll=s5AgSysFlushMacAddrTableAll, s5AgInfoImgSaveStatus=s5AgInfoImgSaveStatus, s5AgRemoteLoginInetAddress=s5AgRemoteLoginInetAddress, s5AgDaylightSavingsEnabled=s5AgDaylightSavingsEnabled, s5AgTrapFilterEntry=s5AgTrapFilterEntry, s5AgSysStackIpAddress=s5AgSysStackIpAddress, s5AgInfoImgSaveMode=s5AgInfoImgSaveMode, s5AgInfoLocStorVer=s5AgInfoLocStorVer, s5AgDaylightSavingsEndYear=s5AgDaylightSavingsEndYear, s5AgMyIfValidFlag=s5AgMyIfValidFlag, s5AgentScriptStatus=s5AgentScriptStatus, s5AgClockNtpTime=s5AgClockNtpTime, s5AgTrapFilterTrapInitiator3=s5AgTrapFilterTrapInitiator3, s5AgSysQuickConfigEnable=s5AgSysQuickConfigEnable, s5AgCustomBannerLine=s5AgCustomBannerLine, s5AgSntpPrimaryServerInetAddressType=s5AgSntpPrimaryServerInetAddressType, s5AgSysCpuNetMask=s5AgSysCpuNetMask, s5AgentMgmt=s5AgentMgmt, s5AgCustomBannerType=s5AgCustomBannerType, s5AgInfoCurDfltGwAddr=s5AgInfoCurDfltGwAddr, s5AgBootCfgBlocksEntry=s5AgBootCfgBlocksEntry, s5AgSysSpanningTreeBpduFilterIgnoreSelf=s5AgSysSpanningTreeBpduFilterIgnoreSelf, s5AgMyGrpIndx=s5AgMyGrpIndx, s5AgSntpLastSyncSource=s5AgSntpLastSyncSource, s5AgSysStackIpv6Address=s5AgSysStackIpv6Address, s5AgInfoVer=s5AgInfoVer, s5AgTrpRcvrTable=s5AgTrpRcvrTable, s5AgentSslScalars=s5AgentSslScalars, s5AgSysBinaryConfigUnitNumber=s5AgSysBinaryConfigUnitNumber, s5AgDaylightSavingsStartYear=s5AgDaylightSavingsStartYear, s5AgSysIpv6DefaultGateway=s5AgSysIpv6DefaultGateway, s5AgSysSpanningTreeOperMode=s5AgSysSpanningTreeOperMode, s5AgSysSerialConsoleLoginAuthenType=s5AgSysSerialConsoleLoginAuthenType, s5AgSntpState=s5AgSntpState, s5AgAsciiConfigScriptUploadApplications=s5AgAsciiConfigScriptUploadApplications, s5AgSysJumboFramesEnabled=s5AgSysJumboFramesEnabled, s5AgSysAutoUnitReplacementEnabled=s5AgSysAutoUnitReplacementEnabled, s5AgMyIfEntry=s5AgMyIfEntry, s5AgentLicenseTimeModify=s5AgentLicenseTimeModify, s5AgentScriptIndex=s5AgentScriptIndex, s5AgSntpLastSyncSourceInetAddress=s5AgSntpLastSyncSourceInetAddress, s5AgUnAuthIpxAddr=s5AgUnAuthIpxAddr, s5AgRemoteLoginMgmt=s5AgRemoteLoginMgmt, s5AgentLicenseMemo=s5AgentLicenseMemo, s5AgIpRtrDiscoverySolicitMode=s5AgIpRtrDiscoverySolicitMode, s5AgOthIfIndx=s5AgOthIfIndx, s5AgentMib=s5AgentMib, s5AgentAsciiConfig=s5AgentAsciiConfig, s5AgInfoReBoot=s5AgInfoReBoot, s5AgSysUsbTargetUnit=s5AgSysUsbTargetUnit, s5AgSysAsciiConfigAutoDownload=s5AgSysAsciiConfigAutoDownload, s5AgSysBlinkLedsTimeThreshold=s5AgSysBlinkLedsTimeThreshold, s5AgCustomBannerTable=s5AgCustomBannerTable, s5AgInfoFileStatus=s5AgInfoFileStatus, s5AgInfoImgDownloadStatus=s5AgInfoImgDownloadStatus, s5AgMyIfNxtBootIpxAddr=s5AgMyIfNxtBootIpxAddr, s5AgSslCertificateData=s5AgSslCertificateData, s5AgSysCpuIpAddress=s5AgSysCpuIpAddress, s5AgDaylightSavingsRecurringStartMinute=s5AgDaylightSavingsRecurringStartMinute, s5AgDaylightSavingsRecurring=s5AgDaylightSavingsRecurring, s5AgBootCfgBlocksName=s5AgBootCfgBlocksName, s5AgSysStackIpv6MgmtAddress=s5AgSysStackIpv6MgmtAddress, s5AgSysCurrentOperationalMode=s5AgSysCurrentOperationalMode, s5AgDataCollectNetworkAddrStatus=s5AgDataCollectNetworkAddrStatus, s5AgSysBlinkLeds=s5AgSysBlinkLeds)
mibBuilder.exportSymbols("S5-AGENT-MIB", s5AgSslCertificateControlStatus=s5AgSslCertificateControlStatus, s5AgAsciiConfigScriptEntry=s5AgAsciiConfigScriptEntry, s5AgClockSystemTime=s5AgClockSystemTime, s5AgClockSntpTime=s5AgClockSntpTime, s5AgTrpRcvrNetAddr=s5AgTrpRcvrNetAddr, s5AgDaylightSavingsRecurringOffset=s5AgDaylightSavingsRecurringOffset, s5AgTrpRcvrIndx=s5AgTrpRcvrIndx, s5AgRemoteLoginIp=s5AgRemoteLoginIp, s5AgSntpLastSyncSourceInetAddressType=s5AgSntpLastSyncSourceInetAddressType, s5AgentScript=s5AgentScript, s5AgMyIfCfgFname=s5AgMyIfCfgFname, s5AgSntpTimeZoneAcronym=s5AgSntpTimeZoneAcronym, s5AgCustomBannerEntry=s5AgCustomBannerEntry, s5AgDaylightSavingsRecurringEndHour=s5AgDaylightSavingsRecurringEndHour, s5AgIpRtrDefaultTimeToLive=s5AgIpRtrDefaultTimeToLive, s5AgSysJumboFramesSize=s5AgSysJumboFramesSize, s5AgBootCfgSaveToBlock=s5AgBootCfgSaveToBlock, s5AgInfoCfgLoadMode=s5AgInfoCfgLoadMode, s5AgentBanner=s5AgentBanner, s5AgentBootConfig=s5AgentBootConfig, s5AgTrapFilterStatus=s5AgTrapFilterStatus, s5AgDataCollectSnTimeStamp=s5AgDataCollectSnTimeStamp, s5AgInfoWriteCfg=s5AgInfoWriteCfg)
