...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-AON-STATUS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:33:18 2025
...
ciscoAonStatusMIBCompliance.setObjects(
      *(("CISCO-AON-STATUS-MIB", "caonNodeObjectGroup"),
        ("CISCO-AON-STATUS-MIB", "caonPepObjectGroup"),
        ("CISCO-AON-STATUS-MIB", "caonPepEndPointObjectGroup"),
        ("CISCO-AON-STATUS-MIB", "caonUpNotificationGroup"),
        ("CISCO-AON-STATUS-MIB", "caonDownNotificationGroup"),
        ("CISCO-AON-STATUS-MIB", "caonNewPepDeployedNotifGroup"),
        ("CISCO-AON-STATUS-MIB", "caonSendThresholdExceededNotifGroup"),
        ("CISCO-AON-STATUS-MIB", "caonMessageDeliveryFailedNotifGroup"),
        ("CISCO-AON-STATUS-MIB", "caonCustomNotifGroup"),
        ("CISCO-AON-STATUS-MIB", "caonNotificationObjectGroup"),
        ("CISCO-AON-STATUS-MIB", "caonCustomNotifObjectsGroup"),
        ("CISCO-AON-STATUS-MIB", "caonMessageDeliveryFailedNotifObjectsGroup"),
        ("CISCO-AON-STATUS-MIB", "caonSendThresholdExceededNotifObjectsGroup"),
