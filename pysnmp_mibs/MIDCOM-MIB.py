...
mibBuilder.exportSymbols("MIDCOM-MIB", midcomTotalTerminatedEnableRules=midcomTotalTerminatedEnableRules, midcomRuleTable=midcomRuleTable, midcomRuleInternalIpAddr=midcomRuleInternalIpAddr, midcomMIB=midcomMIB, midcomRuleInsideIpAddr=midcomRuleInsideIpAddr, midcomGroupTable=midcomGroupTable, midcomRscNatInsideAddrBindMode=midcomRscNatInsideAddrBindMode, midcomConfigIfEntry=midcomConfigIfEntry, midcomRuleMaxIdleTime=midcomRuleMaxIdleTime, midcomRuleAdminStatus=midcomRuleAdminStatus, midcomGroupLifetime=midcomGroupLifetime, midcomStatistics=midcomStatistics, midcomRuleRowStatus=midcomRuleRowStatus, midcomRscNatInternalAddrBindMode=midcomRscNatInternalAddrBindMode, midcomUnsolicitedRuleEvent=midcomUnsolicitedRuleEvent, midcomRuleExternalPort=midcomRuleExternalPort, midcomRscNatSessionId2=midcomRscNatSessionId2, midcomConformance=midcomConformance, midcomRuleOwner=midcomRuleOwner, midcomRscNatSessionId1=midcomRscNatSessionId1, midcomObjects=midcomObjects, midcomCompliances=midcomCompliances, midcomNotificationsGroup=midcomNotificationsGroup, midcomConfigFirewallTable=midcomConfigFirewallTable, midcomStatisticsGroup=midcomStatisticsGroup, PYSNMP_MODULE_ID=midcomMIB, midcomTotalRejectedReserveRules=midcomTotalRejectedReserveRules, midcomConfigFirewallGroup=midcomConfigFirewallGroup, midcomConfigIfIndex=midcomConfigIfIndex, midcomRuleFlowDirection=midcomRuleFlowDirection, midcomConfigFirewallPriority=midcomConfigFirewallPriority, midcomGroupIndex=midcomGroupIndex, midcomRscFirewallRuleId=midcomRscFirewallRuleId, midcomTotalExpiredReserveRules=midcomTotalExpiredReserveRules, midcomTransaction=midcomTransaction, midcomTotalRejectedEnableRules=midcomTotalRejectedEnableRules, midcomCurrentActiveEnableRules=midcomCurrentActiveEnableRules, midcomRuleExternalIpVersion=midcomRuleExternalIpVersion, midcomConfigFirewallEntry=midcomConfigFirewallEntry, midcomRuleEntry=midcomRuleEntry, MidcomNatBindMode=MidcomNatBindMode, midcomRuleInternalIpPrefixLength=midcomRuleInternalIpPrefixLength, midcomRulePortRange=midcomRulePortRange, midcomRuleStorageType=midcomRuleStorageType, midcomRuleIndex=midcomRuleIndex, midcomResourceGroup=midcomResourceGroup, midcomResourceTable=midcomResourceTable, midcomConfigIfTable=midcomConfigIfTable, midcomRuleOutsidePort=midcomRuleOutsidePort, midcomConfigIfBits=midcomConfigIfBits, midcomCurrentOwners=midcomCurrentOwners, midcomRuleOperStatus=midcomRuleOperStatus, midcomConfigFirewallGroupId=midcomConfigFirewallGroupId, midcomRuleOutsideIpAddr=midcomRuleOutsideIpAddr, midcomRscNatInsideAddrBindId=midcomRscNatInsideAddrBindId, midcomRuleStorageTime=midcomRuleStorageTime, midcomRuleGroup=midcomRuleGroup, midcomSolicitedGroupEvent=midcomSolicitedGroupEvent, midcomTotalIncorrectReserveRules=midcomTotalIncorrectReserveRules, midcomConfigIfEnabled=midcomConfigIfEnabled, midcomRuleError=midcomRuleError, midcomRuleExternalIpAddr=midcomRuleExternalIpAddr, midcomRuleInternalIpVersion=midcomRuleInternalIpVersion, midcomConfigFirewallIndex=midcomConfigFirewallIndex, midcomTotalRejectedRuleEntries=midcomTotalRejectedRuleEntries, midcomRuleInsidePort=midcomRuleInsidePort, MidcomNatSessionIdOrZero=MidcomNatSessionIdOrZero, midcomTotalExpiredEnableRules=midcomTotalExpiredEnableRules, midcomCurrentActiveReserveRules=midcomCurrentActiveReserveRules, midcomGroups=midcomGroups, midcomRscNatInternalAddrBindId=midcomRscNatInternalAddrBindId, midcomTotalTerminatedOnRqEnableRules=midcomTotalTerminatedOnRqEnableRules, midcomCompliance=midcomCompliance, midcomCapabilitiesGroup=midcomCapabilitiesGroup, midcomTotalIncorrectEnableRules=midcomTotalIncorrectEnableRules, midcomConfigPersistentRules=midcomConfigPersistentRules, midcomSolicitedRuleEvent=midcomSolicitedRuleEvent, midcomMonitoring=midcomMonitoring, midcomRuleLifetime=midcomRuleLifetime, midcomResourceEntry=midcomResourceEntry, midcomRuleExternalIpPrefixLength=midcomRuleExternalIpPrefixLength, midcomTotalTerminatedReserveRules=midcomTotalTerminatedReserveRules, midcomRuleInternalPort=midcomRuleInternalPort, midcomConfig=midcomConfig, midcomRuleInterface=midcomRuleInterface, midcomConfigMaxLifetime=midcomConfigMaxLifetime, midcomNotifications=midcomNotifications, midcomRuleTransportProtocol=midcomRuleTransportProtocol, midcomCurrentRulesIncomplete=midcomCurrentRulesIncomplete, midcomGroupEntry=midcomGroupEntry, midcomTotalTerminatedOnRqReserveRules=midcomTotalTerminatedOnRqReserveRules)
