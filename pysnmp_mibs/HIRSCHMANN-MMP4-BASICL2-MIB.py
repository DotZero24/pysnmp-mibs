...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hirschmann/HIRSCHMANN-MMP4-BASICL2-MIB
...
hmAgentConfigEncryptionSecret = MibScalar((1, 3, 6, 1, 4, 1, 248, 15, 1, 2, 1, 250), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 255))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hmAgentConfigEncryptionSecret.setStatus('current')
hmAgentConfigEncryptionStatus = MibScalar((1, 3, 6, 1, 4, 1, 248, 15, 1, 2, 1, 251), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2))).clone('disabled')).setMaxAccess("readonly")
if mibBuilder.loadTexts: hmAgentConfigEncryptionStatus.setStatus('current')
...
hmAgentRadiusServerSecret = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 15, 8, 1, 8, 1, 4), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 25))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("HIRSCHMANN-MMP4-BASICL2-MIB", hmAgentStpMstDesignatedRootId=hmAgentStpMstDesignatedRootId, hmAgentUserStatus=hmAgentUserStatus, hmAgentStpMstTimeSinceTopologyChange=hmAgentStpMstTimeSinceTopologyChange, hmAgentPortMirrorEntry=hmAgentPortMirrorEntry, hmAgentRadiusAccountingStatus=hmAgentRadiusAccountingStatus, hmAgentPortConfigTable=hmAgentPortConfigTable, hmAgentStpCstBridgeFwdDelay=hmAgentStpCstBridgeFwdDelay, hmAgentUserAuthenticationType=hmAgentUserAuthenticationType, hmAgentStpPortStatsMstpBpduRx=hmAgentStpPortStatsMstpBpduRx, hmAgentConfigEncryptionStatus=hmAgentConfigEncryptionStatus, hmAgentTransferConfigGroup=hmAgentTransferConfigGroup, hmAgentLogHostTableIpAddress=hmAgentLogHostTableIpAddress, hmAgentCLIConfigGroup=hmAgentCLIConfigGroup, hmAgentRadiusAccountingConfigEntry=hmAgentRadiusAccountingConfigEntry, hmAgentPortMirrorIngressMask=hmAgentPortMirrorIngressMask, hmAgentStpMstPortId=hmAgentStpMstPortId, hmAgentStpMstPortPriority=hmAgentStpMstPortPriority, hmAgentStpCstPortEdge=hmAgentStpCstPortEdge, hmAgentStpMstDesignatedBridgeId=hmAgentStpMstDesignatedBridgeId, hmAgentPortSTPState=hmAgentPortSTPState, hmAgentStpCstPortTopologyChangeAck=hmAgentStpCstPortTopologyChangeAck, hmAgentTrapLogTotal=hmAgentTrapLogTotal, hmAgentPortClearStats=hmAgentPortClearStats, hmPlatform4=hmPlatform4, hmAgentPortMaxFrameSizeLimit=hmAgentPortMaxFrameSizeLimit, hmAgentStpMstBridgePriority=hmAgentStpMstBridgePriority, hmAgentRadiusServerConfigEntry=hmAgentRadiusServerConfigEntry, hmAgentSwitchMFDBSummaryForwardingPortMask=hmAgentSwitchMFDBSummaryForwardingPortMask, hmAgentCableTesterMaximumCableLength=hmAgentCableTesterMaximumCableLength, failedUserLoginTrap=failedUserLoginTrap, hmAgentProtocolConfigGroup=hmAgentProtocolConfigGroup, hmAgentStpPortStatsStpBpduTx=hmAgentStpPortStatsStpBpduTx, hmAgentRadiusServerConfigTable=hmAgentRadiusServerConfigTable, hmAgentUserConfigTable=hmAgentUserConfigTable, hmAgentDot1xSafeVlanMode=hmAgentDot1xSafeVlanMode, hmAgentSwitchAddressAgingTimeoutEntry=hmAgentSwitchAddressAgingTimeoutEntry, hmAgentPortMirrorSourcePortMask=hmAgentPortMirrorSourcePortMask, hmAgentStpMstTopologyChangeCount=hmAgentStpMstTopologyChangeCount, hmAgentDot1xClientAuthPAEstate=hmAgentDot1xClientAuthPAEstate, vlanDeleteLastTrap=vlanDeleteLastTrap, hmAgentDot1xLogicalPort=hmAgentDot1xLogicalPort, hmAgentStpCstPortBpduFlood=hmAgentStpCstPortBpduFlood, hmAgentUserConfigEntry=hmAgentUserConfigEntry, hmAgentStpCstPortPathCost=hmAgentStpCstPortPathCost, hmAgentStpMstVlanEntry=hmAgentStpMstVlanEntry, hmAgentResetSystem=hmAgentResetSystem, hmAgentStpCstRootFwdDelay=hmAgentStpCstRootFwdDelay, hmAgentSSHProtocolLevel=hmAgentSSHProtocolLevel, hmAgentConfigEncryptionSecret=hmAgentConfigEncryptionSecret, hmAgentTrapLogIndex=hmAgentTrapLogIndex, hmAgentPortDVlanTagMode=hmAgentPortDVlanTagMode, hmAgentDot1xClientMacAddress=hmAgentDot1xClientMacAddress, hmAgentSwitchVoiceVlanInterfaceNum=hmAgentSwitchVoiceVlanInterfaceNum, hmAgentDot3adAggPort=hmAgentDot3adAggPort, hmAgentLogConfigGroup=hmAgentLogConfigGroup, hmAgentRadiusAccountingIndexNextValid=hmAgentRadiusAccountingIndexNextValid, hmAgentSwitchIGMPSnoopingMRPExpirationTime=hmAgentSwitchIGMPSnoopingMRPExpirationTime, hmAgentProtocolGroupProtocolIP=hmAgentProtocolGroupProtocolIP, hmAgentSwitchIGMPSnoopingGroupMembershipInterval=hmAgentSwitchIGMPSnoopingGroupMembershipInterval, hmAgentLogSyslogHostEntry=hmAgentLogSyslogHostEntry, hmAgentTransferDownloadStatus=hmAgentTransferDownloadStatus, hmAgentLoginSessionIdleTime=hmAgentLoginSessionIdleTime, hmAgentProtocolGroupId=hmAgentProtocolGroupId, hmAgentProtocolGroupCreate=hmAgentProtocolGroupCreate, hmAgentSwitchMFDBTable=hmAgentSwitchMFDBTable, vlanRequestFailureTrap=vlanRequestFailureTrap, hmAgentDot1xClientTerminationAction=hmAgentDot1xClientTerminationAction, PYSNMP_MODULE_ID=hmPlatform4BasicL2, hmAgentTelnetLoginTimeout=hmAgentTelnetLoginTimeout, dot1xTraps=dot1xTraps, hmAgentStpMstPortTransitionsIntoLoopInconsistentState=hmAgentStpMstPortTransitionsIntoLoopInconsistentState, hmAgentRadiusAccountingSecret=hmAgentRadiusAccountingSecret, hmAgentStpMstReceivedBridgeId=hmAgentStpMstReceivedBridgeId, hmAgentStpCstPortRole=hmAgentStpCstPortRole, hmAgentConfigGroup=hmAgentConfigGroup, hmAgentLogHostTableSeverityFilter=hmAgentLogHostTableSeverityFilter, hmAgentLoginSessionIPAddress=hmAgentLoginSessionIPAddress, hmAgentPortDot1dBasePort=hmAgentPortDot1dBasePort, hmAgentDot1xEnhancementConfigGroup=hmAgentDot1xEnhancementConfigGroup, hmAgentSSHSessionsCount=hmAgentSSHSessionsCount, hmAgentPortIanaType=hmAgentPortIanaType, hmAgentStpMstPortRole=hmAgentStpMstPortRole, hmAgentSwitchIGMPSnoopingMaxResponseTime=hmAgentSwitchIGMPSnoopingMaxResponseTime, stpInstanceNewRootTrap=stpInstanceNewRootTrap, hmAgentStpMstRootPathCost=hmAgentStpMstRootPathCost, hmAgentClearPasswords=hmAgentClearPasswords, hmAgentUserConfigCreate=hmAgentUserConfigCreate, hmAgentStpBpduGuardMode=hmAgentStpBpduGuardMode, hmAgentClassOfServiceGroup=hmAgentClassOfServiceGroup, hmAgentProtocolGroupPortIfIndex=hmAgentProtocolGroupPortIfIndex, hmAgentSSHConfigGroup=hmAgentSSHConfigGroup, hmAgentSwitchVoiceVLANGroup=hmAgentSwitchVoiceVLANGroup, hmAgentProbePortIfIndex=hmAgentProbePortIfIndex, hmAgentDot1xClientSessionTime=hmAgentDot1xClientSessionTime, hmAgentSwitchMFDBFilteringPortMask=hmAgentSwitchMFDBFilteringPortMask, hmAgentStpPortStatsStpBpduRx=hmAgentStpPortStatsStpBpduRx, hmAgentStpCstBridgeTimeSinceTopologyChange=hmAgentStpCstBridgeTimeSinceTopologyChange, hmAgentStpCstDesignatedCost=hmAgentStpCstDesignatedCost, hmAgentUserConfigGroup=hmAgentUserConfigGroup, hmAgentSwitchIGMPSnoopingMulticastControlFramesProcessed=hmAgentSwitchIGMPSnoopingMulticastControlFramesProcessed, hmAgentLagSummaryStatus=hmAgentLagSummaryStatus, hmAgentOutboundTelnetTimeout=hmAgentOutboundTelnetTimeout, hmAgentClearSwitchStats=hmAgentClearSwitchStats, hmAgentDot1xAdvanced=hmAgentDot1xAdvanced, hmAgentSwitchIGMPSnoopingAdminMode=hmAgentSwitchIGMPSnoopingAdminMode, hmAgentRadiusServerPort=hmAgentRadiusServerPort, hmAgentMirroredPortIfIndex=hmAgentMirroredPortIfIndex, hmAgentLoginSessionStatus=hmAgentLoginSessionStatus, broadcastStormStartTrap=broadcastStormStartTrap, hmAgentRadiusServerPrimaryMode=hmAgentRadiusServerPrimaryMode, hmAgentLoginSessionConnectionType=hmAgentLoginSessionConnectionType, hmAgentStpMstEntry=hmAgentStpMstEntry, hmAgentDot1xClientVlanAssignedReason=hmAgentDot1xClientVlanAssignedReason, hmAgentDot1xClientConfigEntry=hmAgentDot1xClientConfigEntry, hmAgentLagDetailedPortSpeed=hmAgentLagDetailedPortSpeed, hmAgentDot1xClientUserName=hmAgentDot1xClientUserName, hmAgentTransferDownloadFilename=hmAgentTransferDownloadFilename, HmAgentDot1xSessionTerminationAction=HmAgentDot1xSessionTerminationAction, hmAgentDot1xPortMABenabled=hmAgentDot1xPortMABenabled, hmAgentStpCstBridgePriority=hmAgentStpCstBridgePriority, hmAgentLagConfigGroup=hmAgentLagConfigGroup, hmAgentTransferDownloadDataType=hmAgentTransferDownloadDataType, hmAgentDot1xGuestVlanId=hmAgentDot1xGuestVlanId, hmAgentPortMirrorSessionNum=hmAgentPortMirrorSessionNum, hmAgentLogHostTableRowStatus=hmAgentLogHostTableRowStatus, hmAgentLagSummaryConfigTable=hmAgentLagSummaryConfigTable, hmAgentRadiusAccountingServerAddress=hmAgentRadiusAccountingServerAddress, hmAgentDot1xUnauthenticatedVlan=hmAgentDot1xUnauthenticatedVlan, hmAgentMgmtSecurity=hmAgentMgmtSecurity, hmAgentLoginSessionTable=hmAgentLoginSessionTable, hmAgentSwitchMFDBMostEntriesUsed=hmAgentSwitchMFDBMostEntriesUsed, hmAgentSwitchBroadcastControlMode=hmAgentSwitchBroadcastControlMode, hmRadius=hmRadius, hmAgentDot1xPortVlanAssigned=hmAgentDot1xPortVlanAssigned, hmAgentLagDetailedPortStatus=hmAgentLagDetailedPortStatus, hmAgentStpMstBridgeIdentifier=hmAgentStpMstBridgeIdentifier, hmAgentTrapLogEntry=hmAgentTrapLogEntry, hmAgentProtocolGroupEntry=hmAgentProtocolGroupEntry, hmAgentLagSummaryConfigEntry=hmAgentLagSummaryConfigEntry, hmAgentStpCstRegionalRootId=hmAgentStpCstRegionalRootId, hmAgentSwitchVoiceVlanDeviceTable=hmAgentSwitchVoiceVlanDeviceTable, hmAgentPortDVlanTagCustomerId=hmAgentPortDVlanTagCustomerId, hmAgentStpMstReceivedPortId=hmAgentStpMstReceivedPortId, hmAgentTransferUploadFilename=hmAgentTransferUploadFilename, hmAgentStpCstPortLoopGuard=hmAgentStpCstPortLoopGuard, hmAgentStpCstPortId=hmAgentStpCstPortId, hmAgentStpForceVersion=hmAgentStpForceVersion, hmAgentSwitchMFDBGroup=hmAgentSwitchMFDBGroup, hmAgentRadiusServerMsgAuth=hmAgentRadiusServerMsgAuth, hmAgentRadiusTimeout=hmAgentRadiusTimeout, hmAgentStpCstPortAutoEdge=hmAgentStpCstPortAutoEdge, hmAgentLagConfigCreate=hmAgentLagConfigCreate, hmAgentPortVoiceVlanAuthMode=hmAgentPortVoiceVlanAuthMode, hmPlatform4SwitchingTraps=hmPlatform4SwitchingTraps, hmAgentSwitchStaticMacFilteringVlanId=hmAgentSwitchStaticMacFilteringVlanId, hmAgentDot1xClientFilterID=hmAgentDot1xClientFilterID, hmAgentSaveConfigStatus=hmAgentSaveConfigStatus, hmAgentStpCstRegionalRootPathCost=hmAgentStpCstRegionalRootPathCost, hmAgentSwitchMFDBSummaryVlanId=hmAgentSwitchMFDBSummaryVlanId, hmAgentSwitchMFDBCurrentEntries=hmAgentSwitchMFDBCurrentEntries, hmAgentLagDetailedConfigTable=hmAgentLagDetailedConfigTable, hmAgentStpCstBridgeHelloTime=hmAgentStpCstBridgeHelloTime, hmAgentClearLags=hmAgentClearLags, hmAgentStpMstPortTable=hmAgentStpMstPortTable, hmAgentTrapLogTrap=hmAgentTrapLogTrap, hmAgentSwitchVoiceVlanDeviceEntry=hmAgentSwitchVoiceVlanDeviceEntry, hmAgentTransferUploadPath=hmAgentTransferUploadPath, hmAgentSSHSessionTimeout=hmAgentSSHSessionTimeout, hmAgentProtocolGroupProtocolARP=hmAgentProtocolGroupProtocolARP, hmAgentSpanningTreeMode=hmAgentSpanningTreeMode, hmAgentStpCstBridgeRootPort=hmAgentStpCstBridgeRootPort, hmAgentRadiusServerCurrentMode=hmAgentRadiusServerCurrentMode, hmAgentProtocolGroupPortEntry=hmAgentProtocolGroupPortEntry, hmAgentProtocolGroupStatus=hmAgentProtocolGroupStatus, hmAgentTelnetMaxSessions=hmAgentTelnetMaxSessions, HmAgentPortMask=HmAgentPortMask, hmAgentSwitchStaticMacFilteringStatus=hmAgentSwitchStaticMacFilteringStatus, hmAgentRadiusServerIndexNextValid=hmAgentRadiusServerIndexNextValid, hmAgentClearTrapLog=hmAgentClearTrapLog, hmAgentStpCstBridgeMaxHops=hmAgentStpCstBridgeMaxHops, hmAgentRadiusAccountingMode=hmAgentRadiusAccountingMode, hmAgentLogHostTableIndex=hmAgentLogHostTableIndex, hmAgentSwitchMFDBSummaryTable=hmAgentSwitchMFDBSummaryTable, hmAgentCableTesterMinimumCableLength=hmAgentCableTesterMinimumCableLength, linkFailureTrap=linkFailureTrap, hmAgentTransferUploadGroup=hmAgentTransferUploadGroup, hmAgentLagDetailedConfigEntry=hmAgentLagDetailedConfigEntry, hmAgentTrapLogSystemTime=hmAgentTrapLogSystemTime, hmAgentLoginSessionEntry=hmAgentLoginSessionEntry, hmAgentTransferDownloadMode=hmAgentTransferDownloadMode, hmAgentPortMirrorDestinationPort=hmAgentPortMirrorDestinationPort, hmAgentLagSummaryDeletePort=hmAgentLagSummaryDeletePort, hmAgentPortMaxFrameSize=hmAgentPortMaxFrameSize, hmPlatform4BasicL2=hmPlatform4BasicL2, hmAgentStpMstRowStatus=hmAgentStpMstRowStatus, hmAgentClearLoginSessions=hmAgentClearLoginSessions, hmAgentLagSummaryFlushTimer=hmAgentLagSummaryFlushTimer, hmAgentTransferUploadDataType=hmAgentTransferUploadDataType, hmAgentCableTesterCableStatus=hmAgentCableTesterCableStatus, hmAgentDot3adAggPortLACPMode=hmAgentDot3adAggPortLACPMode, hmAgentStpPortStatsRstpBpduTx=hmAgentStpPortStatsRstpBpduTx, vlanDefaultCfgFailureTrap=vlanDefaultCfgFailureTrap, hmAgentPortMirroringGroup=hmAgentPortMirroringGroup, hmAgentClassOfServicePortTable=hmAgentClassOfServicePortTable, stpInstanceTopologyChangeTrap=stpInstanceTopologyChangeTrap, hmAgentLagConfigStaticCapability=hmAgentLagConfigStaticCapability, hmAgentSwitchStaticMacFilteringEntry=hmAgentSwitchStaticMacFilteringEntry, hmAgentStpMstTable=hmAgentStpMstTable, hmAgentStpPortHelloTime=hmAgentStpPortHelloTime, hmAgentDot1xPortControlMode=hmAgentDot1xPortControlMode, hmAgentStpMstDesignatedPortId=hmAgentStpMstDesignatedPortId, hmAgentPortMirrorAdminMode=hmAgentPortMirrorAdminMode, hmAgentPortAdminMode=hmAgentPortAdminMode, hmAgentStpMstPortPathCost=hmAgentStpMstPortPathCost, hmAgentStpMstPortTransitionsOutOfLoopInconsistentState=hmAgentStpMstPortTransitionsOutOfLoopInconsistentState, hmAgentTrapLogTotalSinceLastViewed=hmAgentTrapLogTotalSinceLastViewed, hmAgentStpPortState=hmAgentStpPortState, hmAgentSwitchAddressAgingTimeoutTable=hmAgentSwitchAddressAgingTimeoutTable, hmAgentTransferUploadServerIP=hmAgentTransferUploadServerIP, hmAgentProtocolGroupVlanId=hmAgentProtocolGroupVlanId, hmAgentLagSummaryAdminMode=hmAgentLagSummaryAdminMode, hmAgentPortMirroringMode=hmAgentPortMirroringMode, hmAgentDot1xClientConfigGroup=hmAgentDot1xClientConfigGroup, broadcastStormEndTrap=broadcastStormEndTrap, hmAgentLagDetailedLagIndex=hmAgentLagDetailedLagIndex, hmAgentTransferDownloadPath=hmAgentTransferDownloadPath, hmAgentStpAdminMode=hmAgentStpAdminMode, hmAgentLagSummaryLagIndex=hmAgentLagSummaryLagIndex, hmAgentLagSummaryAddPort=hmAgentLagSummaryAddPort, hmAgentTelnetAllowNewMode=hmAgentTelnetAllowNewMode, hmAgentProtocolGroupPortTable=hmAgentProtocolGroupPortTable, hmAgentDot1xPortVlanAssignedReason=hmAgentDot1xPortVlanAssignedReason, hmAgentTrapLogTable=hmAgentTrapLogTable, hmAgentProtocolGroupPortStatus=hmAgentProtocolGroupPortStatus, hmAgentSwitchMFDBMaxTableEntries=hmAgentSwitchMFDBMaxTableEntries, dot1xPortStatusUnauthorized=dot1xPortStatusUnauthorized, hmAgentStpCstPortPriority=hmAgentStpCstPortPriority, hmAgentDot1xPortSessionTimeout=hmAgentDot1xPortSessionTimeout, hmAgentDot1xPortConfigTable=hmAgentDot1xPortConfigTable, hmAgentPortDVlanTagEthertype=hmAgentPortDVlanTagEthertype, hmAgentStpCstDesignatedBridgeId=hmAgentStpCstDesignatedBridgeId, hmAgentTelnetConfigGroup=hmAgentTelnetConfigGroup, hmAgentStpCstBridgeHoldTime=hmAgentStpCstBridgeHoldTime, hmAgentUserEncryptionType=hmAgentUserEncryptionType, hmAgentStpConfigDigestKey=hmAgentStpConfigDigestKey, hmAgentCableTesterIfIndex=hmAgentCableTesterIfIndex, hmAgentTrapLogGroup=hmAgentTrapLogGroup, hmAgentOutboundTelnetMaxNoOfSessions=hmAgentOutboundTelnetMaxNoOfSessions, hmAgentDot1xClientConfigTable=hmAgentDot1xClientConfigTable, hmAgentOutboundTelnetGroup=hmAgentOutboundTelnetGroup, hmAgentDot1xPortConfigGroup=hmAgentDot1xPortConfigGroup, hmAgentLoginSessionUserName=hmAgentLoginSessionUserName, hmAgentClassOfServicePortClass=hmAgentClassOfServicePortClass, hmAgentSwitchMFDBEntry=hmAgentSwitchMFDBEntry)
mibBuilder.exportSymbols("HIRSCHMANN-MMP4-BASICL2-MIB", hmAgentTransferUploadStatus=hmAgentTransferUploadStatus, hmAgentStpConfigRevision=hmAgentStpConfigRevision, hmAgentDot1xGuestVlanPeriod=hmAgentDot1xGuestVlanPeriod, hmAgentCableTesterCableFailureLocation=hmAgentCableTesterCableFailureLocation, hmAgentStpPortStatsMstpBpduTx=hmAgentStpPortStatsMstpBpduTx, hmAgentDot1xPortTerminationAction=hmAgentDot1xPortTerminationAction, hmAgentSwitchDVlanTagGroup=hmAgentSwitchDVlanTagGroup, hmAgentPortPhysicalStatus=hmAgentPortPhysicalStatus, hmAgentSystemGroup=hmAgentSystemGroup, hmAgentStpMstPortDisputed=hmAgentStpMstPortDisputed, HmAgentDot1xPortControlMode=HmAgentDot1xPortControlMode, hmAgentStpMstDesignatedCost=hmAgentStpMstDesignatedCost, hmAgentStpCstPortBpduFilter=hmAgentStpCstPortBpduFilter, hmAgentSwitchMFDBSummaryEntry=hmAgentSwitchMFDBSummaryEntry, hmAgentUserIndex=hmAgentUserIndex, hmAgentRadiusMaxTransmit=hmAgentRadiusMaxTransmit, hmAgentLagSummaryLinkTrap=hmAgentLagSummaryLinkTrap, hmAgentSSHMaxSessionsCount=hmAgentSSHMaxSessionsCount, hmAgentStpCstPortEntry=hmAgentStpCstPortEntry, hmAgentSwitchMFDBMacAddress=hmAgentSwitchMFDBMacAddress, hmAgentDot1xInterface=hmAgentDot1xInterface, hmAgentLogSyslogHostTable=hmAgentLogSyslogHostTable, hmAgentLagSummaryType=hmAgentLagSummaryType, hmAgentStpCstBridgeMaxAge=hmAgentStpCstBridgeMaxAge, hmAgentPortVoiceVlanDSCP=hmAgentPortVoiceVlanDSCP, hmAgentSwitchConfigGroup=hmAgentSwitchConfigGroup, hmAgentCableTesterGroup=hmAgentCableTesterGroup, hmAgentSwitchMFDBForwardingPortMask=hmAgentSwitchMFDBForwardingPortMask, hmAgentLagSummaryName=hmAgentLagSummaryName, hmAgentClassOfServicePortEntry=hmAgentClassOfServicePortEntry, hmAgentSwitchDot3FlowControlMode=hmAgentSwitchDot3FlowControlMode, hmAgentStpMstTopologyChangeParm=hmAgentStpMstTopologyChangeParm, hmAgentStpConfigName=hmAgentStpConfigName, hmAgentPortConfigEntry=hmAgentPortConfigEntry, hmAgentSwitchIGMPSnoopingGroup=hmAgentSwitchIGMPSnoopingGroup, dot1xPortStatusAuthorized=dot1xPortStatusAuthorized, hmAgentPortType=hmAgentPortType, hmAgentStpMstPortEntry=hmAgentStpMstPortEntry, hmAgentStpCstPortBpduGuardEffect=hmAgentStpCstPortBpduGuardEffect, hmAgentStpCstPortTCNGuard=hmAgentStpCstPortTCNGuard, hmAgentInfoGroup=hmAgentInfoGroup, vlanRestoreFailureTrap=vlanRestoreFailureTrap, hmAgentTransferUploadMode=hmAgentTransferUploadMode, hmAgentProtocolGroupTable=hmAgentProtocolGroupTable, hmAgentLoginSessionSessionTime=hmAgentLoginSessionSessionTime, multipleUsersTrap=multipleUsersTrap, hmAgentPortIfIndex=hmAgentPortIfIndex, hmAgentRadiusAccountingConfigTable=hmAgentRadiusAccountingConfigTable, hmPlatform4OutboundTelnetPrivate=hmPlatform4OutboundTelnetPrivate, hmAgentPortMirrorEgressMask=hmAgentPortMirrorEgressMask, hmAgentStpCstPortTable=hmAgentStpCstPortTable, powerSupplyStatusChangeTrap=powerSupplyStatusChangeTrap, hmAgentSpanningTreeConfigGroup=hmAgentSpanningTreeConfigGroup, hmAgentPortMirrorTable=hmAgentPortMirrorTable, hmAgentDot3adAggPortEntry=hmAgentDot3adAggPortEntry, hmAgentSwitchMFDBProtocolType=hmAgentSwitchMFDBProtocolType, hmAgentRadiusServerSecret=hmAgentRadiusServerSecret, hmAgentUserPassword=hmAgentUserPassword, hmAgentUserName=hmAgentUserName, hmAgentSwitchMFDBVlanId=hmAgentSwitchMFDBVlanId, hmAgentDot1xMaxUsers=hmAgentDot1xMaxUsers, hmAgentSaveConfig=hmAgentSaveConfig, hmAgentStpCstPortForwardingState=hmAgentStpCstPortForwardingState, hmAgentSwitchIGMPSnoopingPortMask=hmAgentSwitchIGMPSnoopingPortMask, hmAgentStpMstVlanTable=hmAgentStpMstVlanTable, hmAgentSwitchStaticMacFilteringSourcePortMask=hmAgentSwitchStaticMacFilteringSourcePortMask, hmAgentStpPortTable=hmAgentStpPortTable, hmAgentStpCstDesignatedPortId=hmAgentStpCstDesignatedPortId, hmAgentStpCstPortOperEdge=hmAgentStpCstPortOperEdge, hmAgentPortVoiceVlanDataPriorityMode=hmAgentPortVoiceVlanDataPriorityMode, hmAgentSSHAdminMode=hmAgentSSHAdminMode, hmAgentDot3adAggPortTable=hmAgentDot3adAggPortTable, hmAgentRadiusServerAddress=hmAgentRadiusServerAddress, hmAgentStpPortMigrationCheck=hmAgentStpPortMigrationCheck, hmAgentSwitchStaticMacFilteringTable=hmAgentSwitchStaticMacFilteringTable, hmAgentPortDot3FlowControlMode=hmAgentPortDot3FlowControlMode, fanFailureTrap=fanFailureTrap, hmAgentPortLinkTrapMode=hmAgentPortLinkTrapMode, hmAgentClassOfServicePortPriority=hmAgentClassOfServicePortPriority, hmAgentDot1xPortMABenabledOperational=hmAgentDot1xPortMABenabledOperational, hmAgentSwitchAddressAgingTimeout=hmAgentSwitchAddressAgingTimeout, hmAgentStpMstId=hmAgentStpMstId, hmAgentUserAccessMode=hmAgentUserAccessMode, hmAgentClearVlan=hmAgentClearVlan, hmAgentDot1xRadiusVlanAssignment=hmAgentDot1xRadiusVlanAssignment, hmAgentPortVoiceVlanMode=hmAgentPortVoiceVlanMode, hmAgentOutboundTelnetAdminMode=hmAgentOutboundTelnetAdminMode, hmAgentTransferUploadStart=hmAgentTransferUploadStart, hmAgentRadiusStatsClear=hmAgentRadiusStatsClear, hmAgentStpPortUpTime=hmAgentStpPortUpTime, hmAgentStpPortStatsRstpBpduRx=hmAgentStpPortStatsRstpBpduRx, hmAgentStpCstConfigGroup=hmAgentStpCstConfigGroup, hmAgentDot1xDynamicVlanCreationMode=hmAgentDot1xDynamicVlanCreationMode, hmAgentStpCstPortDisputed=hmAgentStpCstPortDisputed, hmAgentSwitchMFDBDescription=hmAgentSwitchMFDBDescription, hmAgentUserDefaultPwdActive=hmAgentUserDefaultPwdActive, hmAgentRadiusAccountingServerIndex=hmAgentRadiusAccountingServerIndex, hmAgentStpMstPortForwardingState=hmAgentStpMstPortForwardingState, hmAgentStpMstPortLoopInconsistentState=hmAgentStpMstPortLoopInconsistentState, hmAgentSwitchMFDBSummaryMacAddress=hmAgentSwitchMFDBSummaryMacAddress, hmAgentStpCstHelloTime=hmAgentStpCstHelloTime, hmAgentRadiusConfigGroup=hmAgentRadiusConfigGroup, BridgeId=BridgeId, hmAgentTransferDownloadServerIP=hmAgentTransferDownloadServerIP, hmAgentStpBpduFilterDefault=hmAgentStpBpduFilterDefault, hmAgentPortVoiceVlanPriority=hmAgentPortVoiceVlanPriority, hmAgentLogSyslogAdminStatus=hmAgentLogSyslogAdminStatus, hmAgentSwitchStaticMacFilteringDestPortMask=hmAgentSwitchStaticMacFilteringDestPortMask, hmAgentClearConfig=hmAgentClearConfig, hmAgentRadiusServerStatus=hmAgentRadiusServerStatus, hmAgentDot1xClientBackendState=hmAgentDot1xClientBackendState, hmAgentStpCstExtPortPathCost=hmAgentStpCstExtPortPathCost, hmAgentStpCstBridgeRootCost=hmAgentStpCstBridgeRootCost, hmAgentProtocolGroupProtocolIPX=hmAgentProtocolGroupProtocolIPX, hmAgentLogSysLogConfigGroup=hmAgentLogSysLogConfigGroup, hmAgentPortVoiceVlanOperationalStatus=hmAgentPortVoiceVlanOperationalStatus, hmAgentStpCstPortRootGuard=hmAgentStpCstPortRootGuard, hmAgentStpMstVlanRowStatus=hmAgentStpMstVlanRowStatus, hmAgentPortVoiceVlanID=hmAgentPortVoiceVlanID, hmAgentStpPortEntry=hmAgentStpPortEntry, hmAgentLagSummaryStpMode=hmAgentLagSummaryStpMode, hmAgentLagDetailedIfIndex=hmAgentLagDetailedIfIndex, hmAgentLogHostTablePort=hmAgentLogHostTablePort, hmAgentLogging=hmAgentLogging, hmAgentPortPhysicalMode=hmAgentPortPhysicalMode, hmAgentPortDefaultType=hmAgentPortDefaultType, hmAgentDot1xClientSessionTimeout=hmAgentDot1xClientSessionTimeout, hmAgentStpCstPortOperPointToPoint=hmAgentStpCstPortOperPointToPoint, hmAgentPortSTPMode=hmAgentPortSTPMode, hmAgentDot1xPortConfigEntry=hmAgentDot1xPortConfigEntry, hmAgentRadiusServerIndex=hmAgentRadiusServerIndex, hmAgentStpCstBridgeHoldCount=hmAgentStpCstBridgeHoldCount, hmAgentStpCstMaxAge=hmAgentStpCstMaxAge, hmAgentTransferDownloadStart=hmAgentTransferDownloadStart, hmAgentTransferDownloadGroup=hmAgentTransferDownloadGroup, hmAgentProtocolGroupName=hmAgentProtocolGroupName, hmAgentUserEncryptionPassword=hmAgentUserEncryptionPassword, hmAgentStpMstRootPortId=hmAgentStpMstRootPortId, hmAgentStpCstBridgeDesignatedRoot=hmAgentStpCstBridgeDesignatedRoot, hmAgentStpConfigFormatSelector=hmAgentStpConfigFormatSelector, hmAgentStpCstBridgeTopChanges=hmAgentStpCstBridgeTopChanges, hmAgentDot1xClientVlanAssigned=hmAgentDot1xClientVlanAssigned, hmAgentCableTesterStatus=hmAgentCableTesterStatus, hmAgentSwitchVoiceVLANAdminMode=hmAgentSwitchVoiceVLANAdminMode, hmAgentClearPortStats=hmAgentClearPortStats, hmAgentRadiusAccountingPort=hmAgentRadiusAccountingPort, hmAgentSwitchMFDBType=hmAgentSwitchMFDBType, hmAgentStpMstReceivedRPC=hmAgentStpMstReceivedRPC, hmAgentPortAutoNegAdminStatus=hmAgentPortAutoNegAdminStatus, hmAgentLoginSessionIndex=hmAgentLoginSessionIndex, hmAgentSwitchVoiceVlanDeviceMacAddress=hmAgentSwitchVoiceVlanDeviceMacAddress, hmAgentStpSwitchConfigGroup=hmAgentStpSwitchConfigGroup, hmAgentSwitchStaticMacFilteringAddress=hmAgentSwitchStaticMacFilteringAddress, hmAgentSwitchDVlanTagEthertype=hmAgentSwitchDVlanTagEthertype)
