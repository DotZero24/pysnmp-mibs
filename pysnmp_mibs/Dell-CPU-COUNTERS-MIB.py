# SNMP MIB module (Dell-CPU-COUNTERS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-CPU-COUNTERS-MIB
...
rlCpuCountersEntry.setIndexNames(
    (0, "Dell-CPU-COUNTERS-MIB", "rlCpuCountersTarget"),
)
if mibBuilder.loadTexts:
