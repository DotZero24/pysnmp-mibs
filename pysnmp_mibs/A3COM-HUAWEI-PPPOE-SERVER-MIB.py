...
h3cPPPoEServerObject=_H3cPPPoEServerObject_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,102,1))
_H3cPPPoEServerMaxSessions_Type=Integer32
_H3cPPPoEServerMaxSessions_Object=MibScalar
h3cPPPoEServerMaxSessions=_H3cPPPoEServerMaxSessions_Object((1,3,6,1,4,1,43,45,1,10,2,102,1,1),_H3cPPPoEServerMaxSessions_Type())
...
h3cPPPoEServerCurrSessions=_H3cPPPoEServerCurrSessions_Object((1,3,6,1,4,1,43,45,1,10,2,102,1,2),_H3cPPPoEServerCurrSessions_Type())
...
h3cPPPoEServerAuthRequests=_H3cPPPoEServerAuthRequests_Object((1,3,6,1,4,1,43,45,1,10,2,102,1,3),_H3cPPPoEServerAuthRequests_Type())
...
h3cPPPoEServerAuthSuccesses=_H3cPPPoEServerAuthSuccesses_Object((1,3,6,1,4,1,43,45,1,10,2,102,1,4),_H3cPPPoEServerAuthSuccesses_Type())
...
h3cPPPoEServerAuthFailures=_H3cPPPoEServerAuthFailures_Object((1,3,6,1,4,1,43,45,1,10,2,102,1,5),_H3cPPPoEServerAuthFailures_Type())
...
h3cPPPoESAbnormOffsThreshold=_H3cPPPoESAbnormOffsThreshold_Object((1,3,6,1,4,1,43,45,1,10,2,102,1,6),_H3cPPPoESAbnormOffsThreshold_Type())
...
h3cPPPoESAbnormOffPerThreshold=_H3cPPPoESAbnormOffPerThreshold_Object((1,3,6,1,4,1,43,45,1,10,2,102,1,7),_H3cPPPoESAbnormOffPerThreshold_Type())
...
h3cPPPoESNormOffPerThreshold=_H3cPPPoESNormOffPerThreshold_Object((1,3,6,1,4,1,43,45,1,10,2,102,1,8),_H3cPPPoESNormOffPerThreshold_Type())
...
h3cPPPoEServerTraps=_H3cPPPoEServerTraps_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,102,2))
_H3cPPPoeServerTrapPrefix_ObjectIdentity=ObjectIdentity
h3cPPPoeServerTrapPrefix=_H3cPPPoeServerTrapPrefix_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,102,2,0))
...
mibBuilder.exportSymbols('A3COM-HUAWEI-PPPOE-SERVER-MIB',**{'h3cPPPoEServer':h3cPPPoEServer,'h3cPPPoEServerObject':h3cPPPoEServerObject,'h3cPPPoEServerMaxSessions':h3cPPPoEServerMaxSessions,'h3cPPPoEServerCurrSessions':h3cPPPoEServerCurrSessions,'h3cPPPoEServerAuthRequests':h3cPPPoEServerAuthRequests,'h3cPPPoEServerAuthSuccesses':h3cPPPoEServerAuthSuccesses,'h3cPPPoEServerAuthFailures':h3cPPPoEServerAuthFailures,'h3cPPPoESAbnormOffsThreshold':h3cPPPoESAbnormOffsThreshold,'h3cPPPoESAbnormOffPerThreshold':h3cPPPoESAbnormOffPerThreshold,'h3cPPPoESNormOffPerThreshold':h3cPPPoESNormOffPerThreshold,'h3cPPPoEServerTraps':h3cPPPoEServerTraps,'h3cPPPoeServerTrapPrefix':h3cPPPoeServerTrapPrefix,'h3cPPPoESAbnormOffsAlarm':h3cPPPoESAbnormOffsAlarm,'h3cPPPoESAbnormOffPerAlarm':h3cPPPoESAbnormOffPerAlarm,'h3cPPPoESNormOffPerAlarm':h3cPPPoESNormOffPerAlarm})