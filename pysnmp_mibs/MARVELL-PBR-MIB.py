...
rlPBRTable=_RlPBRTable_Object((1,3,6,1,4,1,89,228,1))
if mibBuilder.loadTexts:rlPBRTable.setStatus(_A)
_RlPBREntry_Object=MibTableRow
rlPBREntry=_RlPBREntry_Object((1,3,6,1,4,1,89,228,1,1))
...
rlPBRIfIndex=_RlPBRIfIndex_Object((1,3,6,1,4,1,89,228,1,1,1),_RlPBRIfIndex_Type())
...
rlPBRInetType=_RlPBRInetType_Object((1,3,6,1,4,1,89,228,1,1,2),_RlPBRInetType_Type())
...
rlPBRRouteMapName=_RlPBRRouteMapName_Object((1,3,6,1,4,1,89,228,1,1,3),_RlPBRRouteMapName_Type())
...
rlPBRStatus=_RlPBRStatus_Object((1,3,6,1,4,1,89,228,1,1,4),_RlPBRStatus_Type())
...
rlPBRRowStatus=_RlPBRRowStatus_Object((1,3,6,1,4,1,89,228,1,1,5),_RlPBRRowStatus_Type())
rlPBRRowStatus.setMaxAccess(_L)
if mibBuilder.loadTexts:rlPBRRowStatus.setStatus(_A)
_RlPBRInfoTable_Object=MibTable
rlPBRInfoTable=_RlPBRInfoTable_Object((1,3,6,1,4,1,89,228,2))
if mibBuilder.loadTexts:rlPBRInfoTable.setStatus(_A)
_RlPBRInfoEntry_Object=MibTableRow
rlPBRInfoEntry=_RlPBRInfoEntry_Object((1,3,6,1,4,1,89,228,2,1))
...
rlPBRInfoAccessListName=_RlPBRInfoAccessListName_Object((1,3,6,1,4,1,89,228,2,1,1),_RlPBRInfoAccessListName_Type())
...
rlPBRInfoNexthopInetAddressType=_RlPBRInfoNexthopInetAddressType_Object((1,3,6,1,4,1,89,228,2,1,2),_RlPBRInfoNexthopInetAddressType_Type())
...
rlPBRInfoNexthopInetAddress=_RlPBRInfoNexthopInetAddress_Object((1,3,6,1,4,1,89,228,2,1,3),_RlPBRInfoNexthopInetAddress_Type())
...
rlPBRInfoNexthopIfIndex=_RlPBRInfoNexthopIfIndex_Object((1,3,6,1,4,1,89,228,2,1,4),_RlPBRInfoNexthopIfIndex_Type())
...
rlPBRInfoNexthopStatus=_RlPBRInfoNexthopStatus_Object((1,3,6,1,4,1,89,228,2,1,5),_RlPBRInfoNexthopStatus_Type())
