# SNMP MIB module (DES7200-LOG-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-LOG-MIB
...
myLogSendBufferMaxSeverity = _MyLogSendBufferMaxSeverity_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 10),
...
myLogClearBuffer = _MyLogClearBuffer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 11),
...
myLogHisRecordMaxNum = _MyLogHisRecordMaxNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 12),
...
myLogHisIndex = _MyLogHisIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 13, 1, 1),
    _MyLogHisIndex_Type()
)
...
myLogHisSeverity = _MyLogHisSeverity_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 13, 1, 2),
...
myLogHisMsgName = _MyLogHisMsgName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 13, 1, 3),
...
myLogHisDescription = _MyLogHisDescription_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 13, 1, 4),
...
myLogHisTime = _MyLogHisTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 13, 1, 5),
    _MyLogHisTime_Type()
)
...
myLogHisStamps = _MyLogHisStamps_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 13, 1, 6),
...
myLogSequenceGlobalStatus = _MyLogSequenceGlobalStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 14),
...
myLogTimeStampGlobalStatus = _MyLogTimeStampGlobalStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 15),
...
myLogSyslogRelayGlobalStatus = _MyLogSyslogRelayGlobalStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 16),
...
myLogSyslogFacility = _MyLogSyslogFacility_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 17),
...
myLogSyslogSeverity = _MyLogSyslogSeverity_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 18),
...
myLogSyslogServerTable = _MyLogSyslogServerTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 19)
)
if mibBuilder.loadTexts:
...
myLogSyslogServerEntry = _MyLogSyslogServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 19, 1)
)
myLogSyslogServerEntry.setIndexNames(
    (0, "DES7200-LOG-MIB", "myLogSyslogServerIpAddr"),
)
if mibBuilder.loadTexts:
...
myLogSyslogServerIpAddr = _MyLogSyslogServerIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 19, 1, 1),
...
myLogSyslogServerIpStatus = _MyLogSyslogServerIpStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 19, 1, 2),
...
myLogSyslogSendSrcIfindex = _MyLogSyslogSendSrcIfindex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 20),
...
myLogSyslogSendSrcIp = _MyLogSyslogSendSrcIp_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 1, 21),
...
myLogMIBConformance = _MyLogMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 4)
)
_MyLogMIBCompliances_ObjectIdentity = ObjectIdentity
myLogMIBCompliances = _MyLogMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 4, 1)
)
_MyLogMIBGroups_ObjectIdentity = ObjectIdentity
myLogMIBGroups = _MyLogMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 4, 2)
)

# Managed Objects groups

myLogMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 4, 2, 1)
)
myLogMIBGroup.setObjects(
      *(("DES7200-LOG-MIB", "myLogGlobalStatus"),
        ("DES7200-LOG-MIB", "myLogSendConsoleStatus"),
        ("DES7200-LOG-MIB", "myLogSendConsoleMaxSeverity"),
        ("DES7200-LOG-MIB", "myLogSendMonitorStatus"),
        ("DES7200-LOG-MIB", "myLogSendMonitorMaxSeverity"),
        ("DES7200-LOG-MIB", "myLogSaveFileName"),
        ("DES7200-LOG-MIB", "myLogFileMaxSeverity"),
        ("DES7200-LOG-MIB", "myLogFileMaxSize"),
        ("DES7200-LOG-MIB", "myLogSendBufferStatus"),
        ("DES7200-LOG-MIB", "myLogSendBufferMaxSeverity"),
        ("DES7200-LOG-MIB", "myLogClearBuffer"),
        ("DES7200-LOG-MIB", "myLogHisRecordMaxNum"),
        ("DES7200-LOG-MIB", "myLogHisIndex"),
        ("DES7200-LOG-MIB", "myLogHisSeverity"),
        ("DES7200-LOG-MIB", "myLogHisMsgName"),
        ("DES7200-LOG-MIB", "myLogHisDescription"),
        ("DES7200-LOG-MIB", "myLogHisTime"),
        ("DES7200-LOG-MIB", "myLogSequenceGlobalStatus"),
        ("DES7200-LOG-MIB", "myLogTimeStampGlobalStatus"),
        ("DES7200-LOG-MIB", "myLogSyslogRelayGlobalStatus"),
        ("DES7200-LOG-MIB", "myLogSyslogFacility"),
        ("DES7200-LOG-MIB", "myLogSyslogSeverity"),
        ("DES7200-LOG-MIB", "myLogSyslogServerIpAddr"),
        ("DES7200-LOG-MIB", "myLogSyslogServerIpStatus"),
        ("DES7200-LOG-MIB", "myLogSyslogSendSrcIfindex"),
...
myLogHisStampsMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 4, 2, 2)
)
myLogHisStampsMIBGroup.setObjects(
    ("DES7200-LOG-MIB", "myLogHisStamps")
)
if mibBuilder.loadTexts:
...
myLogMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 4, 4, 1, 1)
)
myLogMIBCompliance.setObjects(
      *(("DES7200-LOG-MIB", "myLogMIBGroup"),
        ("DES7200-LOG-MIB", "myLogHisStampsMIBGroup"))
)
if mibBuilder.loadTexts:
