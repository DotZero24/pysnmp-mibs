...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-VOICE-AALX-PROFILE-MIB
...
CCallControlJitterDelayMode, cmgwIndex = mibBuilder.importSymbols("CISCO-MEDIA-GATEWAY-MIB", "CCallControlJitterDelayMode", "cmgwIndex")
...
mibBuilder.exportSymbols("CISCO-VOICE-AALX-PROFILE-MIB", cvapSvcResyncExpiries=cvapSvcResyncExpiries, cvapCodecConfigVbdPacketPeriod=cvapCodecConfigVbdPacketPeriod, cvapSvcTxResyncEnds=cvapSvcTxResyncEnds, cvapSvcReleasExpiries=cvapSvcReleasExpiries, cvapSvcConfigGroup=cvapSvcConfigGroup, ciscoVoiceAalxProfileMIBObjects=ciscoVoiceAalxProfileMIBObjects, cvaProfileMIBComplianceRev1=cvaProfileMIBComplianceRev1, CiscoAal2ProfileNumber=CiscoAal2ProfileNumber, cvapCodecConfigEntry=cvapCodecConfigEntry, cvapSvcRxResyncStrts=cvapSvcRxResyncStrts, cvapSvcTxReleaseCompls=cvapSvcTxReleaseCompls, cvapSvcRxBulkResyncs=cvapSvcRxBulkResyncs, cvapSvcRxCallProcs=cvapSvcRxCallProcs, cvapSvcCallProcExpiries=cvapSvcCallProcExpiries, cvapSvcRxRestarts=cvapSvcRxRestarts, cvapSvcRxRestartAcks=cvapSvcRxRestartAcks, cvapCodecConfigJitterNomDelay=cvapCodecConfigJitterNomDelay, cvapSvcConfigEntry=cvapSvcConfigEntry, cvapSvcDelNotifGuardTimer=cvapSvcDelNotifGuardTimer, cvapCodecConfigTable=cvapCodecConfigTable, cvapCodecConfigGroup=cvapCodecConfigGroup, cvapSvcMgcpSelectorByteValue=cvapSvcMgcpSelectorByteValue, cvapSvcAtmQosCellDelay=cvapSvcAtmQosCellDelay, cvapSvcTxResyncStrts=cvapSvcTxResyncStrts, CiscoAal2ProfileType=CiscoAal2ProfileType, cvapSvcMultiCIDGlareThreshold=cvapSvcMultiCIDGlareThreshold, cvapSvcTxConns=cvapSvcTxConns, cvapSvcRxConnAcks=cvapSvcRxConnAcks, cvapSvcStats=cvapSvcStats, cvapSvcTxCallProcs=cvapSvcTxCallProcs, cvapCodecConfigJitterMinDelay=cvapCodecConfigJitterMinDelay, cvapSvcTxBulkResyncs=cvapSvcTxBulkResyncs, cvapCodecTable=cvapCodecTable, cvapSvcTxRestarts=cvapSvcTxRestarts, cvapSvcStatsEntry=cvapSvcStatsEntry, PYSNMP_MODULE_ID=ciscoVoiceAalxProfileMIB, cvapSvcAtmQosCtd=cvapSvcAtmQosCtd, cvapCodecConfigPayloadType=cvapCodecConfigPayloadType, cvapCodecConfigDtmfRelay=cvapCodecConfigDtmfRelay, cvapCodecConfig=cvapCodecConfig, cvapCodecEntry=cvapCodecEntry, cvapSvcPartialFillSupported=cvapSvcPartialFillSupported, cvapSvcRxResyncEndAcks=cvapSvcRxResyncEndAcks, cvapSvcTxRestartAcks=cvapSvcTxRestartAcks, cvapSvcTxReleases=cvapSvcTxReleases, cvapSvcConnExpiries=cvapSvcConnExpiries, cvapSvcTxResyncEndAcks=cvapSvcTxResyncEndAcks, cvapCodecConfigJitterMaxDelay=cvapCodecConfigJitterMaxDelay, CiscoCodecPacketPeriod=CiscoCodecPacketPeriod, cvapCodecConfigAdaptType=cvapCodecConfigAdaptType, cvapSvcMultiCIDFillTimer=cvapSvcMultiCIDFillTimer, ciscoVoiceAalxProfileMIBNotifs=ciscoVoiceAalxProfileMIBNotifs, cvaProfileMIBCompliances=cvaProfileMIBCompliances, cvapSvcAtmQosClr=cvapSvcAtmQosClr, cvapSvcAggTrafficClipping=cvapSvcAggTrafficClipping, cvaProfileMIBConformance=cvaProfileMIBConformance, cvapSvcRxReleases=cvapSvcRxReleases, cvapSvcRxReleaseCompls=cvapSvcRxReleaseCompls, cvapCodecConfigNewJtrNomDelay=cvapCodecConfigNewJtrNomDelay, cvapSvcAal2CidNumber=cvapSvcAal2CidNumber, cvapCodecConfigGroupRev1=cvapCodecConfigGroupRev1, cvapSvcMultiCIDTerminatDelTimer=cvapSvcMultiCIDTerminatDelTimer, ciscoVoiceAalxProfileMIB=ciscoVoiceAalxProfileMIB, cvapSvcMultiCIDCACPCR=cvapSvcMultiCIDCACPCR, cvapSvcRxResyncStrtAcks=cvapSvcRxResyncStrtAcks, cvapCodecNegotiationAdaptType=cvapCodecNegotiationAdaptType, cvapCodecConfigType=cvapCodecConfigType, cvapCodecConfigPreference=cvapCodecConfigPreference, cvaProfileMIBCompliance=cvaProfileMIBCompliance, cvapSvcStatsGroup=cvapSvcStatsGroup, cvapSvcMultiCIDPerSvc=cvapSvcMultiCIDPerSvc, cvapSvcConfig=cvapSvcConfig, cvapSvcTxResyncStrtAcks=cvapSvcTxResyncStrtAcks, cvapSvcRxResyncEnds=cvapSvcRxResyncEnds, cvapCodecConfigVoicePacketPeriod=cvapCodecConfigVoicePacketPeriod, cvapSvcConnAckExpiries=cvapSvcConnAckExpiries, cvaProfileMIBGroups=cvaProfileMIBGroups, cvapSvcTxConnAcks=cvapSvcTxConnAcks, cvapSvcRestartExpiries=cvapSvcRestartExpiries, cvapSvcMultiCIDOriginatDelTimer=cvapSvcMultiCIDOriginatDelTimer, cvapCodecNegotiationOption=cvapCodecNegotiationOption, cvapSvcTxSetups=cvapSvcTxSetups, cvapSvcRxConns=cvapSvcRxConns, cvapSvcAggLinkState=cvapSvcAggLinkState, cvapSvcH248SelectorByteValue=cvapSvcH248SelectorByteValue, cvapCodecConfigJitterDelayMode=cvapCodecConfigJitterDelayMode, cvapSvcStatsTable=cvapSvcStatsTable, cvapSvcMultiCIDCACSCR=cvapSvcMultiCIDCACSCR, cvapSvcTrfScalingFactor=cvapSvcTrfScalingFactor, cvapSvcConfigTable=cvapSvcConfigTable, cvapSvcRxSetups=cvapSvcRxSetups, cvapAal2Config=cvapAal2Config)
