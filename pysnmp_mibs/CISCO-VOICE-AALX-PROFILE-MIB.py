...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VOICE-AALX-PROFILE-MIB
...
_CvapCodecConfigJitterDelayMode_Type.__name__ = "CCallControlJitterDelayMode"
...
_CvapSvcAggTrafficClipping_Type.__name__ = "TruthValue"
...
_CvapSvcMultiCIDPerSvc_Type.__name__ = "TruthValue"
...
cvaProfileMIBCompliance.setObjects(
      *(("CISCO-VOICE-AALX-PROFILE-MIB", "cvapCodecConfigGroup"),
        ("CISCO-VOICE-AALX-PROFILE-MIB", "cvapSvcConfigGroup"),
        ("CISCO-VOICE-AALX-PROFILE-MIB", "cvapSvcStatsGroup"))
)
if mibBuilder.loadTexts:
...
cvaProfileMIBComplianceRev1.setObjects(
      *(("CISCO-VOICE-AALX-PROFILE-MIB", "cvapCodecConfigGroupRev1"),
        ("CISCO-VOICE-AALX-PROFILE-MIB", "cvapSvcConfigGroup"),
        ("CISCO-VOICE-AALX-PROFILE-MIB", "cvapSvcStatsGroup"))
)
if mibBuilder.loadTexts:
