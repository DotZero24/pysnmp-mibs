...
mibBuilder.exportSymbols("CISCO-DMN-DSG-MOIP-MIB", moipIPOStreamStatusIntf1=moipIPOStreamStatusIntf1, PYSNMP_MODULE_ID=ciscoDSGMOIP, moipIPOStreamStatusID=moipIPOStreamStatusID, moipIPOConfigID=moipIPOConfigID, moipIPOConfigEntry=moipIPOConfigEntry, moipIPOConfigPCRStartNewPkt=moipIPOConfigPCRStartNewPkt, moipIPOConfigInterfaceMode=moipIPOConfigInterfaceMode, ciscoDSGMOIP=ciscoDSGMOIP, moipIPOConfigSAPDestPort=moipIPOConfigSAPDestPort, moipIPOStreamStatusContentOvfl=moipIPOStreamStatusContentOvfl, moipIPOStreamStatusTable=moipIPOStreamStatusTable, moipIPOConfigTable=moipIPOConfigTable, moipIPOConfigInstanceName=moipIPOConfigInstanceName, moipIPOConfigSrcPort=moipIPOConfigSrcPort, moipIPOConfigTPProtocol=moipIPOConfigTPProtocol, moipIPOConfigMaxTransPktPerIP=moipIPOConfigMaxTransPktPerIP, moipIPOConfigTOS=moipIPOConfigTOS, moipIPOFECRowWidth=moipIPOFECRowWidth, moipIPOConfigMinIPPerSec=moipIPOConfigMinIPPerSec, moipIPOFEC1UDPPort=moipIPOFEC1UDPPort, moipIPOConfigDestIPAddr=moipIPOConfigDestIPAddr, moipIPOConfigPCRAddition=moipIPOConfigPCRAddition, moipIPOConfigSAPStr=moipIPOConfigSAPStr, moipIPOConfigTTL=moipIPOConfigTTL, moipIPOFECMode=moipIPOFECMode, moipIPOFEC2UDPPort=moipIPOFEC2UDPPort, moipIPOStatsBandwidthActIntf2=moipIPOStatsBandwidthActIntf2, moipIPOStatsBandwidthConf=moipIPOStatsBandwidthConf, moipIPOConfigSendSAP=moipIPOConfigSendSAP, moipIPOStatsStreamError=moipIPOStatsStreamError, moipIPOAnnexType=moipIPOAnnexType, moipIPOConfigIPVer=moipIPOConfigIPVer, moipIPOStreamStatusIntf2=moipIPOStreamStatusIntf2, moipIPOConfigDestPort=moipIPOConfigDestPort, moipIPOStatsHWGlobalError=moipIPOStatsHWGlobalError, moipIPOFECColDepth=moipIPOFECColDepth, moipIPOConfigOutputEnabled=moipIPOConfigOutputEnabled, moipIPOConfigBitRate=moipIPOConfigBitRate, moipIPOInfo=moipIPOInfo, moipIPOTable=moipIPOTable, moipIPOConfigSAPMulticastIPAddr=moipIPOConfigSAPMulticastIPAddr, moipIPOStreamStatusLinkOvfl=moipIPOStreamStatusLinkOvfl, moipIPOStreamStatusEntry=moipIPOStreamStatusEntry, moipIPOConfigUseSAPStr=moipIPOConfigUseSAPStr, moipIPOStatsBandwidthActIntf1=moipIPOStatsBandwidthActIntf1)
