...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DOT11-SSID-SECURITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:28:26 2025
...
_Cdot11SecAuxSsidBroadcast_Type.__name__ = "TruthValue"
...
_Cdot11SecAuxSsidProxyMobileIp_Type.__name__ = "TruthValue"
...
_Cdot11SecAuxSsidVlan_Type.__name__ = "CDot11IfVlanIdOrZero"
...
_Cdot11SecAuxSsidWpaPsk_Type.__name__ = "CDot11WiFiPaPreSharedKey"
...
class _Cdot11SecAuxRadiusAccounting_Type(SnmpAdminString):
    """Custom type cdot11SecAuxRadiusAccounting based on SnmpAdminString"""
    defaultValue = OctetString("")


_Cdot11SecAuxRadiusAccounting_Type.__name__ = "SnmpAdminString"
...
class _Cdot11SecAuxSsidLoginUsername_Type(SnmpAdminString):
    """Custom type cdot11SecAuxSsidLoginUsername based on SnmpAdminString"""
    defaultValue = OctetString("")


_Cdot11SecAuxSsidLoginUsername_Type.__name__ = "SnmpAdminString"
...
class _Cdot11SecAuxSsidLoginPassword_Type(SnmpAdminString):
    """Custom type cdot11SecAuxSsidLoginPassword based on SnmpAdminString"""
    defaultValue = OctetString("")


_Cdot11SecAuxSsidLoginPassword_Type.__name__ = "SnmpAdminString"
...
_Cdot11SecAuxSsidAuthKeyMgmtOpt_Type.__name__ = "TruthValue"
...
_Cdot11SecSsidRedirectAddrType_Type.__name__ = "InetAddressType"
...
_Cdot11SecSsidRedirectDestAddr_Type.__name__ = "InetAddress"
...
class _Cdot11SecSsidRedirectFilter_Type(SnmpAdminString):
    """Custom type cdot11SecSsidRedirectFilter based on SnmpAdminString"""
    defaultValue = OctetString("")


_Cdot11SecSsidRedirectFilter_Type.__name__ = "SnmpAdminString"
...
_Cdot11SecSsidInformationElement_Type.__name__ = "CDot11InformationElementType"
...
_Cdot11SecAuxSsidVlanName_Type.__name__ = "CDot11VlanName"
...
_Cdot11SecAuxSsidMbssidBroadcast_Type.__name__ = "TruthValue"
...
ciscoDot11SsidSecCompliance.setObjects(
      *(("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11SecSsidManagementGroup"),
        ("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11SsidAuthenticationGroup"),
        ("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11ModuleAuthenticationGroup"),
        ("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11SecVlanManagementGroup"),
        ("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11MbssidSupportGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDot11SsidSecComplianceRev1.setObjects(
      *(("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11SecSsidManagementGroup"),
        ("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11SsidAuthenticationGroup"),
        ("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11ModuleAuthenticationGroup"),
        ("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11SecSsidBackupVlanManagementGroup"),
        ("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11SecVlanManagementGroup"),
        ("CISCO-DOT11-SSID-SECURITY-MIB", "cdot11MbssidSupportGroup"))
)
if mibBuilder.loadTexts:
