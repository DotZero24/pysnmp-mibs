...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-IGMP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:00:43 2025
...
(TNamedItem,
 ...
 TmnxVRtrIDOrZero,
 VRtrIgmpHostMcRDstStatType) = mibBuilder.importSymbols(
    "TIMETRA-TC-MIB",
    "TNamedItem",
    "TPolicyStatementNameOrEmpty",
    "TmnxAdminState",
...
class _VRtrIgmpGenGrpIfQuerySrcIp_Type(IpAddress):
    """Custom type vRtrIgmpGenGrpIfQuerySrcIp based on IpAddress"""
    defaultHexValue = "00000000"


_VRtrIgmpGenGrpIfQuerySrcIp_Type.__name__ = "IpAddress"
...
if mibBuilder.loadTexts:
    vRtrIgmpIfMcacUnconstrainedBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpIfMcacPreRsvdMandBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpIfMcacinUseMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpIfMcacinUseOpnlBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpIfMcacAvailMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpIfMcacAvailOpnlBw.setUnits("kilobps")
...
class _VRtrIgmpIfMcacIfPolicyName_Type(TPolicyStatementNameOrEmpty):
    """Custom type vRtrIgmpIfMcacIfPolicyName based on TPolicyStatementNameOrEmpty"""
    defaultValue = OctetString("")


_VRtrIgmpIfMcacIfPolicyName_Type.__name__ = "TPolicyStatementNameOrEmpty"
_VRtrIgmpIfMcacIfPolicyName_Object = MibTableColumn
vRtrIgmpIfMcacIfPolicyName = _VRtrIgmpIfMcacIfPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 1, 1, 34),
    _VRtrIgmpIfMcacIfPolicyName_Type()
)
vRtrIgmpIfMcacIfPolicyName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrIgmpIfMcacIfPolicyName.setStatus("current")
...
_VRtrIgmpIfGroupUpTime_Type = TimeInterval
...
_VRtrIgmpIfGroupExpiryTime_Type = TimeInterval
...
_VRtrIgmpIfGroupVersion1HostTimer_Type = TimeInterval
...
_VRtrIgmpIfGroupVersion2HostTimer_Type = TimeInterval
...
_VRtrIgmpIfGrpSrcExpiryTime_Type = TimeInterval
...
if mibBuilder.loadTexts:
    vRtrIgmpIfMcacLevelBW.setUnits("kilobps")
...
_VRtrIgmpIfSGrpRangeSrcTblLstChgd_Type = TimeStamp
_VRtrIgmpIfSGrpRangeSrcTblLstChgd_Object = MibScalar
vRtrIgmpIfSGrpRangeSrcTblLstChgd = _VRtrIgmpIfSGrpRangeSrcTblLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 13),
    _VRtrIgmpIfSGrpRangeSrcTblLstChgd_Type()
)
vRtrIgmpIfSGrpRangeSrcTblLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeSrcTblLstChgd.setStatus("current")
_VRtrIgmpIfSGrpRangeSrcTable_Object = MibTable
vRtrIgmpIfSGrpRangeSrcTable = _VRtrIgmpIfSGrpRangeSrcTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14)
)
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeSrcTable.setStatus("current")
_VRtrIgmpIfSGrpRangeSrcEntry_Object = MibTableRow
vRtrIgmpIfSGrpRangeSrcEntry = _VRtrIgmpIfSGrpRangeSrcEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1)
)
vRtrIgmpIfSGrpRangeSrcEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-VRTR-MIB", "vRtrIfIndex"),
    (0, "TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeStartAddrType"),
    (0, "TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeStartAddr"),
    (0, "TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeEndAddrType"),
    (0, "TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeEndAddr"),
    (0, "TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeStepAddrType"),
    (0, "TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeStepAddr"),
    (0, "TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeSrcAddrType"),
    (0, "TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeSrcAddr"),
)
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeSrcEntry.setStatus("current")
_VRtrIgmpIfSGrpRangeStartAddrType_Type = InetAddressType
_VRtrIgmpIfSGrpRangeStartAddrType_Object = MibTableColumn
vRtrIgmpIfSGrpRangeStartAddrType = _VRtrIgmpIfSGrpRangeStartAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 1),
    _VRtrIgmpIfSGrpRangeStartAddrType_Type()
)
vRtrIgmpIfSGrpRangeStartAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeStartAddrType.setStatus("current")


class _VRtrIgmpIfSGrpRangeStartAddr_Type(InetAddress):
    """Custom type vRtrIgmpIfSGrpRangeStartAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
    )
...
_VRtrIgmpIfSGrpRangeStartAddr_Type.__name__ = "InetAddress"
_VRtrIgmpIfSGrpRangeStartAddr_Object = MibTableColumn
vRtrIgmpIfSGrpRangeStartAddr = _VRtrIgmpIfSGrpRangeStartAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 2),
    _VRtrIgmpIfSGrpRangeStartAddr_Type()
)
vRtrIgmpIfSGrpRangeStartAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeStartAddr.setStatus("current")
_VRtrIgmpIfSGrpRangeEndAddrType_Type = InetAddressType
_VRtrIgmpIfSGrpRangeEndAddrType_Object = MibTableColumn
vRtrIgmpIfSGrpRangeEndAddrType = _VRtrIgmpIfSGrpRangeEndAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 3),
    _VRtrIgmpIfSGrpRangeEndAddrType_Type()
)
vRtrIgmpIfSGrpRangeEndAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeEndAddrType.setStatus("current")


class _VRtrIgmpIfSGrpRangeEndAddr_Type(InetAddress):
    """Custom type vRtrIgmpIfSGrpRangeEndAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
    )
...
_VRtrIgmpIfSGrpRangeEndAddr_Type.__name__ = "InetAddress"
_VRtrIgmpIfSGrpRangeEndAddr_Object = MibTableColumn
vRtrIgmpIfSGrpRangeEndAddr = _VRtrIgmpIfSGrpRangeEndAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 4),
    _VRtrIgmpIfSGrpRangeEndAddr_Type()
)
vRtrIgmpIfSGrpRangeEndAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeEndAddr.setStatus("current")
_VRtrIgmpIfSGrpRangeStepAddrType_Type = InetAddressType
_VRtrIgmpIfSGrpRangeStepAddrType_Object = MibTableColumn
vRtrIgmpIfSGrpRangeStepAddrType = _VRtrIgmpIfSGrpRangeStepAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 5),
    _VRtrIgmpIfSGrpRangeStepAddrType_Type()
)
vRtrIgmpIfSGrpRangeStepAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeStepAddrType.setStatus("current")


class _VRtrIgmpIfSGrpRangeStepAddr_Type(InetAddress):
    """Custom type vRtrIgmpIfSGrpRangeStepAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
    )
...
_VRtrIgmpIfSGrpRangeStepAddr_Type.__name__ = "InetAddress"
_VRtrIgmpIfSGrpRangeStepAddr_Object = MibTableColumn
vRtrIgmpIfSGrpRangeStepAddr = _VRtrIgmpIfSGrpRangeStepAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 6),
    _VRtrIgmpIfSGrpRangeStepAddr_Type()
)
vRtrIgmpIfSGrpRangeStepAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeStepAddr.setStatus("current")
_VRtrIgmpIfSGrpRangeSrcAddrType_Type = InetAddressType
_VRtrIgmpIfSGrpRangeSrcAddrType_Object = MibTableColumn
vRtrIgmpIfSGrpRangeSrcAddrType = _VRtrIgmpIfSGrpRangeSrcAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 7),
    _VRtrIgmpIfSGrpRangeSrcAddrType_Type()
)
vRtrIgmpIfSGrpRangeSrcAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeSrcAddrType.setStatus("current")


class _VRtrIgmpIfSGrpRangeSrcAddr_Type(InetAddress):
    """Custom type vRtrIgmpIfSGrpRangeSrcAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
    )
...
_VRtrIgmpIfSGrpRangeSrcAddr_Type.__name__ = "InetAddress"
_VRtrIgmpIfSGrpRangeSrcAddr_Object = MibTableColumn
vRtrIgmpIfSGrpRangeSrcAddr = _VRtrIgmpIfSGrpRangeSrcAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 8),
    _VRtrIgmpIfSGrpRangeSrcAddr_Type()
)
vRtrIgmpIfSGrpRangeSrcAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeSrcAddr.setStatus("current")
_VRtrIgmpIfSGrpRangeSrcRowStatus_Type = RowStatus
_VRtrIgmpIfSGrpRangeSrcRowStatus_Object = MibTableColumn
vRtrIgmpIfSGrpRangeSrcRowStatus = _VRtrIgmpIfSGrpRangeSrcRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 9),
    _VRtrIgmpIfSGrpRangeSrcRowStatus_Type()
)
vRtrIgmpIfSGrpRangeSrcRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeSrcRowStatus.setStatus("current")
_VRtrIgmpIfSGrpRangeLastChanged_Type = TimeStamp
_VRtrIgmpIfSGrpRangeLastChanged_Object = MibTableColumn
vRtrIgmpIfSGrpRangeLastChanged = _VRtrIgmpIfSGrpRangeLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 10),
    _VRtrIgmpIfSGrpRangeLastChanged_Type()
)
vRtrIgmpIfSGrpRangeLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeLastChanged.setStatus("current")
_VRtrIgmpIfSGrpRangeGrpCount_Type = Unsigned32
_VRtrIgmpIfSGrpRangeGrpCount_Object = MibTableColumn
vRtrIgmpIfSGrpRangeGrpCount = _VRtrIgmpIfSGrpRangeGrpCount_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 2, 14, 1, 11),
    _VRtrIgmpIfSGrpRangeGrpCount_Type()
)
vRtrIgmpIfSGrpRangeGrpCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpIfSGrpRangeGrpCount.setStatus("current")
...
_VRtrIgmpNotifyMaxNumOfIPsecIf_Type = Unsigned32
_VRtrIgmpNotifyMaxNumOfIPsecIf_Object = MibScalar
vRtrIgmpNotifyMaxNumOfIPsecIf = _VRtrIgmpNotifyMaxNumOfIPsecIf_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 3, 8),
    _VRtrIgmpNotifyMaxNumOfIPsecIf_Type()
)
vRtrIgmpNotifyMaxNumOfIPsecIf.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrIgmpNotifyMaxNumOfIPsecIf.setStatus("current")
_VRtrIgmpNotifyNumOfIPsecIf_Type = Unsigned32
_VRtrIgmpNotifyNumOfIPsecIf_Object = MibScalar
vRtrIgmpNotifyNumOfIPsecIf = _VRtrIgmpNotifyNumOfIPsecIf_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 3, 9),
    _VRtrIgmpNotifyNumOfIPsecIf_Type()
)
vRtrIgmpNotifyNumOfIPsecIf.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    vRtrIgmpNotifyNumOfIPsecIf.setStatus("current")
...
class _VRtrIgmpHostQueryInterval_Type(Unsigned32):
    """Custom type vRtrIgmpHostQueryInterval based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(2, 1024),
...
_VRtrIgmpHostQueryInterval_Type.__name__ = "Unsigned32"
_VRtrIgmpHostQueryInterval_Object = MibTableColumn
vRtrIgmpHostQueryInterval = _VRtrIgmpHostQueryInterval_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 1, 1, 18),
    _VRtrIgmpHostQueryInterval_Type()
)
vRtrIgmpHostQueryInterval.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostQueryInterval.setStatus("current")
if mibBuilder.loadTexts:
    vRtrIgmpHostQueryInterval.setUnits("seconds")


class _VRtrIgmpHostLastMembQueryIntvl_Type(Unsigned32):
    """Custom type vRtrIgmpHostLastMembQueryIntvl based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 1023),
...
_VRtrIgmpHostLastMembQueryIntvl_Type.__name__ = "Unsigned32"
_VRtrIgmpHostLastMembQueryIntvl_Object = MibTableColumn
vRtrIgmpHostLastMembQueryIntvl = _VRtrIgmpHostLastMembQueryIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 1, 1, 19),
    _VRtrIgmpHostLastMembQueryIntvl_Type()
)
vRtrIgmpHostLastMembQueryIntvl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostLastMembQueryIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrIgmpHostLastMembQueryIntvl.setUnits("seconds")


class _VRtrIgmpHostQueryResponseIntvl_Type(Unsigned32):
    """Custom type vRtrIgmpHostQueryResponseIntvl based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 1023),
...
_VRtrIgmpHostQueryResponseIntvl_Type.__name__ = "Unsigned32"
_VRtrIgmpHostQueryResponseIntvl_Object = MibTableColumn
vRtrIgmpHostQueryResponseIntvl = _VRtrIgmpHostQueryResponseIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 1, 1, 20),
    _VRtrIgmpHostQueryResponseIntvl_Type()
)
vRtrIgmpHostQueryResponseIntvl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostQueryResponseIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrIgmpHostQueryResponseIntvl.setUnits("seconds")
_VRtrIgmpHostDisRtrAlertChk_Type = TruthValue
_VRtrIgmpHostDisRtrAlertChk_Object = MibTableColumn
vRtrIgmpHostDisRtrAlertChk = _VRtrIgmpHostDisRtrAlertChk_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 1, 1, 21),
    _VRtrIgmpHostDisRtrAlertChk_Type()
)
vRtrIgmpHostDisRtrAlertChk.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostDisRtrAlertChk.setStatus("current")
_VRtrIgmpHostBondingConnIndex_Type = Unsigned32
_VRtrIgmpHostBondingConnIndex_Object = MibTableColumn
vRtrIgmpHostBondingConnIndex = _VRtrIgmpHostBondingConnIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 1, 1, 22),
    _VRtrIgmpHostBondingConnIndex_Type()
)
vRtrIgmpHostBondingConnIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostBondingConnIndex.setStatus("current")
_VRtrIgmpHostBondingId_Type = TmnxSubIdentStringOrEmpty
_VRtrIgmpHostBondingId_Object = MibTableColumn
vRtrIgmpHostBondingId = _VRtrIgmpHostBondingId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 1, 1, 23),
    _VRtrIgmpHostBondingId_Type()
)
vRtrIgmpHostBondingId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostBondingId.setStatus("current")
...
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfMcacUnconstrainedBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfMcacPreRsvdMandBW.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfMcacinUseMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfMcacinUseOpnlBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfMcacAvailMandBw.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfMcacAvailOpnlBw.setUnits("kilobps")
...
class _VRtrIgmpGrpIfMcacIfPolicyName_Type(TPolicyStatementNameOrEmpty):
    """Custom type vRtrIgmpGrpIfMcacIfPolicyName based on TPolicyStatementNameOrEmpty"""
    defaultValue = OctetString("")


_VRtrIgmpGrpIfMcacIfPolicyName_Type.__name__ = "TPolicyStatementNameOrEmpty"
_VRtrIgmpGrpIfMcacIfPolicyName_Object = MibTableColumn
vRtrIgmpGrpIfMcacIfPolicyName = _VRtrIgmpGrpIfMcacIfPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 3, 1, 24),
    _VRtrIgmpGrpIfMcacIfPolicyName_Type()
)
vRtrIgmpGrpIfMcacIfPolicyName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfMcacIfPolicyName.setStatus("current")


class _VRtrIgmpGrpIfQueryInterval_Type(Unsigned32):
    """Custom type vRtrIgmpGrpIfQueryInterval based on Unsigned32"""
    defaultValue = 0
...
_VRtrIgmpGrpIfQueryInterval_Type.__name__ = "Unsigned32"
_VRtrIgmpGrpIfQueryInterval_Object = MibTableColumn
vRtrIgmpGrpIfQueryInterval = _VRtrIgmpGrpIfQueryInterval_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 3, 1, 25),
    _VRtrIgmpGrpIfQueryInterval_Type()
)
vRtrIgmpGrpIfQueryInterval.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfQueryInterval.setStatus("current")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfQueryInterval.setUnits("seconds")


class _VRtrIgmpGrpIfLastMembQueryIntvl_Type(Unsigned32):
    """Custom type vRtrIgmpGrpIfLastMembQueryIntvl based on Unsigned32"""
    defaultValue = 0
...
_VRtrIgmpGrpIfLastMembQueryIntvl_Type.__name__ = "Unsigned32"
_VRtrIgmpGrpIfLastMembQueryIntvl_Object = MibTableColumn
vRtrIgmpGrpIfLastMembQueryIntvl = _VRtrIgmpGrpIfLastMembQueryIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 3, 1, 26),
    _VRtrIgmpGrpIfLastMembQueryIntvl_Type()
)
vRtrIgmpGrpIfLastMembQueryIntvl.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfLastMembQueryIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfLastMembQueryIntvl.setUnits("seconds")


class _VRtrIgmpGrpIfQueryResponseIntvl_Type(Unsigned32):
    """Custom type vRtrIgmpGrpIfQueryResponseIntvl based on Unsigned32"""
    defaultValue = 0
...
_VRtrIgmpGrpIfQueryResponseIntvl_Type.__name__ = "Unsigned32"
_VRtrIgmpGrpIfQueryResponseIntvl_Object = MibTableColumn
vRtrIgmpGrpIfQueryResponseIntvl = _VRtrIgmpGrpIfQueryResponseIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 3, 1, 27),
    _VRtrIgmpGrpIfQueryResponseIntvl_Type()
)
vRtrIgmpGrpIfQueryResponseIntvl.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfQueryResponseIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfQueryResponseIntvl.setUnits("seconds")
...
_VRtrIgmpGrpIfHostGrpUpTime_Type = TimeInterval
...
_VRtrIgmpGrpIfHostGrpExpiryTime_Type = TimeInterval
...
_VRtrIgmpGrpIfHostGrpVer1HostTmr_Type = TimeInterval
...
_VRtrIgmpGrpIfHostGrpVer2HostTmr_Type = TimeInterval
...
_VRtrIgmpGrpIfHostGrpMRDstVrId_Type = TmnxVRtrIDOrZero
...
_VRtrIgmpGrpIfHostGrpMRDstIfId_Type = InterfaceIndexOrZero
...
_VRtrIgmpGrpIfHostGrpBondOwner_Type = TruthValue
_VRtrIgmpGrpIfHostGrpBondOwner_Object = MibTableColumn
vRtrIgmpGrpIfHostGrpBondOwner = _VRtrIgmpGrpIfHostGrpBondOwner_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 4, 1, 12),
    _VRtrIgmpGrpIfHostGrpBondOwner_Type()
)
vRtrIgmpGrpIfHostGrpBondOwner.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfHostGrpBondOwner.setStatus("current")
_VRtrIgmpGrpIfHostGrpBondFwd_Type = TruthValue
_VRtrIgmpGrpIfHostGrpBondFwd_Object = MibTableColumn
vRtrIgmpGrpIfHostGrpBondFwd = _VRtrIgmpGrpIfHostGrpBondFwd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 4, 1, 13),
    _VRtrIgmpGrpIfHostGrpBondFwd_Type()
)
vRtrIgmpGrpIfHostGrpBondFwd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfHostGrpBondFwd.setStatus("current")
...
_VRtrIgmpGrpIfHostGrpSrcExpTime_Type = TimeInterval
...
_VRtrIgmpGrpIfHostGrpSrcMRDstVrId_Type = TmnxVRtrIDOrZero
...
_VRtrIgmpGrpIfHostGrpSrcMRDstIfId_Type = InterfaceIndexOrZero
...
_VRtrIgmpGrpIfHostGrpSrcBondOwner_Type = TruthValue
_VRtrIgmpGrpIfHostGrpSrcBondOwner_Object = MibTableColumn
vRtrIgmpGrpIfHostGrpSrcBondOwner = _VRtrIgmpGrpIfHostGrpSrcBondOwner_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 5, 1, 6),
    _VRtrIgmpGrpIfHostGrpSrcBondOwner_Type()
)
vRtrIgmpGrpIfHostGrpSrcBondOwner.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfHostGrpSrcBondOwner.setStatus("current")
_VRtrIgmpGrpIfHostGrpSrcBondFwd_Type = TruthValue
_VRtrIgmpGrpIfHostGrpSrcBondFwd_Object = MibTableColumn
vRtrIgmpGrpIfHostGrpSrcBondFwd = _VRtrIgmpGrpIfHostGrpSrcBondFwd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 5, 1, 7),
    _VRtrIgmpGrpIfHostGrpSrcBondFwd_Type()
)
vRtrIgmpGrpIfHostGrpSrcBondFwd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfHostGrpSrcBondFwd.setStatus("current")
...
_VRtrIgmpHostGrpSrcExpiryTime_Type = TimeInterval
...
_VRtrIgmpHostGrpSrcMcRdrDstVRtrID_Type = TmnxVRtrIDOrZero
...
_VRtrIgmpHostGrpSrcMcRdrDstIfIdx_Type = InterfaceIndexOrZero
...
_VRtrIgmpHostGrpSrcBondOwner_Type = TruthValue
_VRtrIgmpHostGrpSrcBondOwner_Object = MibTableColumn
vRtrIgmpHostGrpSrcBondOwner = _VRtrIgmpHostGrpSrcBondOwner_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 7, 1, 5),
    _VRtrIgmpHostGrpSrcBondOwner_Type()
)
vRtrIgmpHostGrpSrcBondOwner.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostGrpSrcBondOwner.setStatus("current")
_VRtrIgmpHostGrpSrcBondFwd_Type = TruthValue
_VRtrIgmpHostGrpSrcBondFwd_Object = MibTableColumn
vRtrIgmpHostGrpSrcBondFwd = _VRtrIgmpHostGrpSrcBondFwd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 7, 1, 6),
    _VRtrIgmpHostGrpSrcBondFwd_Type()
)
vRtrIgmpHostGrpSrcBondFwd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostGrpSrcBondFwd.setStatus("current")
...
_VRtrIgmpHostGrpUpTime_Type = TimeInterval
...
_VRtrIgmpHostGrpExpiryTime_Type = TimeInterval
...
_VRtrIgmpHostGrpVer1HostTmr_Type = TimeInterval
...
_VRtrIgmpHostGrpVer2HostTmr_Type = TimeInterval
...
_VRtrIgmpHostGrpMcRdrDstVrId_Type = TmnxVRtrIDOrZero
...
_VRtrIgmpHostGrpMcRdrDstIfId_Type = InterfaceIndexOrZero
...
_VRtrIgmpHostGrpBondOwner_Type = TruthValue
_VRtrIgmpHostGrpBondOwner_Object = MibTableColumn
vRtrIgmpHostGrpBondOwner = _VRtrIgmpHostGrpBondOwner_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 8, 1, 10),
    _VRtrIgmpHostGrpBondOwner_Type()
)
vRtrIgmpHostGrpBondOwner.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostGrpBondOwner.setStatus("current")
_VRtrIgmpHostGrpBondFwd_Type = TruthValue
_VRtrIgmpHostGrpBondFwd_Object = MibTableColumn
vRtrIgmpHostGrpBondFwd = _VRtrIgmpHostGrpBondFwd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 4, 8, 1, 11),
    _VRtrIgmpHostGrpBondFwd_Type()
)
vRtrIgmpHostGrpBondFwd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpHostGrpBondFwd.setStatus("current")
...
class _VRtrIgmpGrpIfSapQryInterval_Type(Unsigned32):
    """Custom type vRtrIgmpGrpIfSapQryInterval based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(2, 1024),
...
_VRtrIgmpGrpIfSapQryInterval_Type.__name__ = "Unsigned32"
_VRtrIgmpGrpIfSapQryInterval_Object = MibTableColumn
vRtrIgmpGrpIfSapQryInterval = _VRtrIgmpGrpIfSapQryInterval_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 5, 1, 1, 11),
    _VRtrIgmpGrpIfSapQryInterval_Type()
)
vRtrIgmpGrpIfSapQryInterval.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfSapQryInterval.setStatus("current")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfSapQryInterval.setUnits("seconds")


class _VRtrIgmpGrpIfSapLastMembQryIntvl_Type(Unsigned32):
    """Custom type vRtrIgmpGrpIfSapLastMembQryIntvl based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 1023),
...
_VRtrIgmpGrpIfSapLastMembQryIntvl_Type.__name__ = "Unsigned32"
_VRtrIgmpGrpIfSapLastMembQryIntvl_Object = MibTableColumn
vRtrIgmpGrpIfSapLastMembQryIntvl = _VRtrIgmpGrpIfSapLastMembQryIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 5, 1, 1, 12),
    _VRtrIgmpGrpIfSapLastMembQryIntvl_Type()
)
vRtrIgmpGrpIfSapLastMembQryIntvl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfSapLastMembQryIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfSapLastMembQryIntvl.setUnits("seconds")


class _VRtrIgmpGrpIfSapQryResponseIntvl_Type(Unsigned32):
    """Custom type vRtrIgmpGrpIfSapQryResponseIntvl based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 1023),
...
_VRtrIgmpGrpIfSapQryResponseIntvl_Type.__name__ = "Unsigned32"
_VRtrIgmpGrpIfSapQryResponseIntvl_Object = MibTableColumn
vRtrIgmpGrpIfSapQryResponseIntvl = _VRtrIgmpGrpIfSapQryResponseIntvl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 23, 5, 1, 1, 13),
    _VRtrIgmpGrpIfSapQryResponseIntvl_Type()
)
vRtrIgmpGrpIfSapQryResponseIntvl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfSapQryResponseIntvl.setStatus("current")
if mibBuilder.loadTexts:
    vRtrIgmpGrpIfSapQryResponseIntvl.setUnits("seconds")
...
_VRtrIgmpGrpIfSapGrpUpTime_Type = TimeInterval
...
_VRtrIgmpGrpIfSapGrpExpiryTime_Type = TimeInterval
...
_VRtrIgmpGrpIfSapGrpVer1HostTmr_Type = TimeInterval
...
_VRtrIgmpGrpIfSapGrpVer2HostTmr_Type = TimeInterval
...
_VRtrIgmpGrpIfSapGrpSrcExpTime_Type = TimeInterval
...
tmnxIgmpIfV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 23, 2, 22)
)
tmnxIgmpIfV14v0Group.setObjects(
      *(("TIMETRA-IGMP-MIB", "vRtrIgmpIfMcacIfPolicyName"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfMcacIfPolicyName"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeSrcTblLstChgd"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeSrcRowStatus"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeLastChanged"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpIfSGrpRangeGrpCount"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfQueryInterval"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfLastMembQueryIntvl"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfQueryResponseIntvl"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostQueryInterval"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostLastMembQueryIntvl"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostQueryResponseIntvl"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostDisRtrAlertChk"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfSapQryInterval"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfSapLastMembQryIntvl"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfSapQryResponseIntvl"))
)
if mibBuilder.loadTexts:
    tmnxIgmpIfV14v0Group.setStatus("current")

tmnxIgmpIfV15v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 23, 2, 24)
)
tmnxIgmpIfV15v0Group.setObjects(
      *(("TIMETRA-IGMP-MIB", "vRtrIgmpHostBondingConnIndex"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostBondingId"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfHostGrpBondOwner"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfHostGrpBondFwd"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfHostGrpSrcBondOwner"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpGrpIfHostGrpSrcBondFwd"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostGrpBondOwner"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostGrpBondFwd"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostGrpSrcBondOwner"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostGrpSrcBondFwd"))
)
if mibBuilder.loadTexts:
    tmnxIgmpIfV15v0Group.setStatus("current")

tmnxIgmpNotifyObjsGroupV15v0 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 23, 2, 26)
)
tmnxIgmpNotifyObjsGroupV15v0.setObjects(
      *(("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyMaxNumOfIPsecIf"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyNumOfIPsecIf"))
)
if mibBuilder.loadTexts:
    tmnxIgmpNotifyObjsGroupV15v0.setStatus("current")
...
vRtrIgmpHostQryIntervalConflict = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 23, 0, 20)
)
vRtrIgmpHostQryIntervalConflict.setObjects(
      *(("TIMETRA-IGMP-MIB", "vRtrIgmpHostFwdSvcId"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpHostGrpIfId"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyDescription"))
)
if mibBuilder.loadTexts:
    vRtrIgmpHostQryIntervalConflict.setStatus(
        "current"
    )

vRtrIgmpNotifyNumOfIPsecIfLowWm = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 23, 0, 21)
)
vRtrIgmpNotifyNumOfIPsecIfLowWm.setObjects(
      *(("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyMaxNumOfIPsecIf"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyNumOfIPsecIf"))
)
if mibBuilder.loadTexts:
    vRtrIgmpNotifyNumOfIPsecIfLowWm.setStatus(
        "current"
    )

vRtrIgmpNotifyNumOfIPsecIfHighWm = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 23, 0, 22)
)
vRtrIgmpNotifyNumOfIPsecIfHighWm.setObjects(
      *(("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyMaxNumOfIPsecIf"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyNumOfIPsecIf"))
)
if mibBuilder.loadTexts:
    vRtrIgmpNotifyNumOfIPsecIfHighWm.setStatus(
        "current"
    )

vRtrIgmpNotifyNumOfIPsecIfMaxRch = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 23, 0, 23)
)
vRtrIgmpNotifyNumOfIPsecIfMaxRch.setObjects(
      *(("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyMaxNumOfIPsecIf"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyNumOfIPsecIf"))
)
if mibBuilder.loadTexts:
    vRtrIgmpNotifyNumOfIPsecIfMaxRch.setStatus(
        "current"
    )
...
tmnxIgmpNotificationV14v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 23, 2, 23)
)
tmnxIgmpNotificationV14v0Group.setObjects(
    ("TIMETRA-IGMP-MIB", "vRtrIgmpHostQryIntervalConflict")
)
if mibBuilder.loadTexts:
    tmnxIgmpNotificationV14v0Group.setStatus(
        "current"
    )

tmnxIgmpNotificationGroupV15v0 = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 23, 2, 25)
)
tmnxIgmpNotificationGroupV15v0.setObjects(
      *(("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyNumOfIPsecIfLowWm"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyNumOfIPsecIfHighWm"),
        ("TIMETRA-IGMP-MIB", "vRtrIgmpNotifyNumOfIPsecIfMaxRch"))
)
if mibBuilder.loadTexts:
    tmnxIgmpNotificationGroupV15v0.setStatus(
        "current"
    )
...
tmnxIgmpV14v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 23, 1, 10)
)
tmnxIgmpV14v0Compliance.setObjects(
      *(("TIMETRA-IGMP-MIB", "tmnxIgmpGlobalGroup"),
        ("TIMETRA-IGMP-MIB", "tmnxIgmpGlobalV10v0Group"),
        ("TIMETRA-IGMP-MIB", "tmnxIgmpIfV5v0Group"),
        ("TIMETRA-IGMP-MIB", "tmnxIgmpIfV6v1Group"),
        ...
        ("TIMETRA-IGMP-MIB", "tmnxIgmpIfV11v0Group"),
        ("TIMETRA-IGMP-MIB", "tmnxIgmpIfV12v0Group"),
        ("TIMETRA-IGMP-MIB", "tmnxIgmpIfV14v0Group"),
        ("TIMETRA-IGMP-MIB", "tmnxIgmpNotificationV11v0Group"),
        ("TIMETRA-IGMP-MIB", "tmnxIgmpNotificationV14v0Group"))
)
if mibBuilder.loadTexts:
    tmnxIgmpV14v0Compliance.setStatus(
        "current"
    )

tmnxIgmpV15v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 23, 1, 11)
)
tmnxIgmpV15v0Compliance.setObjects(
      *(("TIMETRA-IGMP-MIB", "tmnxIgmpIfV15v0Group"),
        ("TIMETRA-IGMP-MIB", "tmnxIgmpNotificationGroupV15v0"),
        ("TIMETRA-IGMP-MIB", "tmnxIgmpNotifyObjsGroupV15v0"))
)
if mibBuilder.loadTexts:
    tmnxIgmpV15v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"IgmpGrpItfOperState": IgmpGrpItfOperState,
       ...
       "tmnxIgmpV14v0Compliance": tmnxIgmpV14v0Compliance,
       "tmnxIgmpV15v0Compliance": tmnxIgmpV15v0Compliance,
       ...
       "tmnxIgmpIfV14v0Group": tmnxIgmpIfV14v0Group,
       "tmnxIgmpNotificationV14v0Group": tmnxIgmpNotificationV14v0Group,
       "tmnxIgmpIfV15v0Group": tmnxIgmpIfV15v0Group,
       "tmnxIgmpNotificationGroupV15v0": tmnxIgmpNotificationGroupV15v0,
       "tmnxIgmpNotifyObjsGroupV15v0": tmnxIgmpNotifyObjsGroupV15v0,
       ...
       "vRtrIgmpIfMcacIfPolicyName": vRtrIgmpIfMcacIfPolicyName,
       ...
       "vRtrIgmpIfSGrpRangeSrcTblLstChgd": vRtrIgmpIfSGrpRangeSrcTblLstChgd,
       "vRtrIgmpIfSGrpRangeSrcTable": vRtrIgmpIfSGrpRangeSrcTable,
       "vRtrIgmpIfSGrpRangeSrcEntry": vRtrIgmpIfSGrpRangeSrcEntry,
       "vRtrIgmpIfSGrpRangeStartAddrType": vRtrIgmpIfSGrpRangeStartAddrType,
       "vRtrIgmpIfSGrpRangeStartAddr": vRtrIgmpIfSGrpRangeStartAddr,
       "vRtrIgmpIfSGrpRangeEndAddrType": vRtrIgmpIfSGrpRangeEndAddrType,
       ...
       "vRtrIgmpIfSGrpRangeSrcAddrType": vRtrIgmpIfSGrpRangeSrcAddrType,
       "vRtrIgmpIfSGrpRangeSrcAddr": vRtrIgmpIfSGrpRangeSrcAddr,
       "vRtrIgmpIfSGrpRangeSrcRowStatus": vRtrIgmpIfSGrpRangeSrcRowStatus,
       "vRtrIgmpIfSGrpRangeLastChanged": vRtrIgmpIfSGrpRangeLastChanged,
       "vRtrIgmpIfSGrpRangeGrpCount": vRtrIgmpIfSGrpRangeGrpCount,
       ...
       "vRtrIgmpNotifyMaxNumOfIPsecIf": vRtrIgmpNotifyMaxNumOfIPsecIf,
       "vRtrIgmpNotifyNumOfIPsecIf": vRtrIgmpNotifyNumOfIPsecIf,
       ...
       "vRtrIgmpHostQueryInterval": vRtrIgmpHostQueryInterval,
       "vRtrIgmpHostLastMembQueryIntvl": vRtrIgmpHostLastMembQueryIntvl,
       "vRtrIgmpHostQueryResponseIntvl": vRtrIgmpHostQueryResponseIntvl,
       "vRtrIgmpHostDisRtrAlertChk": vRtrIgmpHostDisRtrAlertChk,
       "vRtrIgmpHostBondingConnIndex": vRtrIgmpHostBondingConnIndex,
       "vRtrIgmpHostBondingId": vRtrIgmpHostBondingId,
       ...
       "vRtrIgmpGrpIfMcacIfPolicyName": vRtrIgmpGrpIfMcacIfPolicyName,
       "vRtrIgmpGrpIfQueryInterval": vRtrIgmpGrpIfQueryInterval,
       "vRtrIgmpGrpIfLastMembQueryIntvl": vRtrIgmpGrpIfLastMembQueryIntvl,
       "vRtrIgmpGrpIfQueryResponseIntvl": vRtrIgmpGrpIfQueryResponseIntvl,
       ...
       "vRtrIgmpGrpIfHostGrpBondOwner": vRtrIgmpGrpIfHostGrpBondOwner,
       "vRtrIgmpGrpIfHostGrpBondFwd": vRtrIgmpGrpIfHostGrpBondFwd,
       ...
       "vRtrIgmpGrpIfHostGrpSrcBondOwner": vRtrIgmpGrpIfHostGrpSrcBondOwner,
       "vRtrIgmpGrpIfHostGrpSrcBondFwd": vRtrIgmpGrpIfHostGrpSrcBondFwd,
       ...
       "vRtrIgmpHostGrpSrcBondOwner": vRtrIgmpHostGrpSrcBondOwner,
       "vRtrIgmpHostGrpSrcBondFwd": vRtrIgmpHostGrpSrcBondFwd,
       ...
       "vRtrIgmpHostGrpBondOwner": vRtrIgmpHostGrpBondOwner,
       "vRtrIgmpHostGrpBondFwd": vRtrIgmpHostGrpBondFwd,
       ...
       "vRtrIgmpGrpIfSapLastMembQryIntvl": vRtrIgmpGrpIfSapLastMembQryIntvl,
       "vRtrIgmpGrpIfSapQryResponseIntvl": vRtrIgmpGrpIfSapQryResponseIntvl,
       ...
       "vRtrIgmpHostQryIntervalConflict": vRtrIgmpHostQryIntervalConflict,
       "vRtrIgmpNotifyNumOfIPsecIfLowWm": vRtrIgmpNotifyNumOfIPsecIfLowWm,
       "vRtrIgmpNotifyNumOfIPsecIfHighWm": vRtrIgmpNotifyNumOfIPsecIfHighWm,
       "vRtrIgmpNotifyNumOfIPsecIfMaxRch": vRtrIgmpNotifyNumOfIPsecIfMaxRch}
)
