_l='fsRstOldRoleType'
_k='fsRstPortRoleType'
_j='fsRstPktErrVal'
_i='fsRstPktErrType'
_h='fsRstPortMigrationType'
_g='fsRstOldDesignatedRoot'
_f='fsRstErrTrapType'
_e='fsRstGenTrapType'
_d='fsRstPortTrapIndex'
_c='EnabledStatus'
_b='Timeout'
_a='timerExpiryEvent'
_Z='bpduEvent'
...
_T='dot1dStpVersion'
_S='RSTP-MIB'
_R='dot1dStpPortState'
_Q='dot1dStpDesignatedRoot'
_P='disable'
_O='enable'
_N='none'
_M='designatedPort'
...
BridgeId,dot1dBaseBridgeAddress,dot1dStpDesignatedRoot,dot1dStpPortState=mibBuilder.importSymbols(_E,'BridgeId',_H,_Q,_R)
dot1dStpVersion,=mibBuilder.importSymbols(_S,_T)
...
class EnabledStatus(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('enabled',1),(_U,2)))
class Timeout(TextualConvention,Integer32):status=_A;displayHint='d4'
_Dot1wFutureRst_ObjectIdentity=ObjectIdentity
dot1wFutureRst=_Dot1wFutureRst_ObjectIdentity((1,3,6,1,4,1,2076,79,1))
...
fsRstSystemControl=_FsRstSystemControl_Object((1,3,6,1,4,1,2076,79,1,1),_FsRstSystemControl_Type())
...
fsRstModuleStatus=_FsRstModuleStatus_Object((1,3,6,1,4,1,2076,79,1,2),_FsRstModuleStatus_Type())
...
fsRstTraceOption=_FsRstTraceOption_Object((1,3,6,1,4,1,2076,79,1,3),_FsRstTraceOption_Type())
...
fsRstDebugOption=_FsRstDebugOption_Object((1,3,6,1,4,1,2076,79,1,4),_FsRstDebugOption_Type())
...
fsRstRstpUpCount=_FsRstRstpUpCount_Object((1,3,6,1,4,1,2076,79,1,5),_FsRstRstpUpCount_Type())
...
fsRstRstpDownCount=_FsRstRstpDownCount_Object((1,3,6,1,4,1,2076,79,1,6),_FsRstRstpDownCount_Type())
...
fsRstBufferFailureCount=_FsRstBufferFailureCount_Object((1,3,6,1,4,1,2076,79,1,7),_FsRstBufferFailureCount_Type())
...
fsRstMemAllocFailureCount=_FsRstMemAllocFailureCount_Object((1,3,6,1,4,1,2076,79,1,8),_FsRstMemAllocFailureCount_Type())
...
fsRstNewRootIdCount=_FsRstNewRootIdCount_Object((1,3,6,1,4,1,2076,79,1,9),_FsRstNewRootIdCount_Type())
...
fsRstPortRoleSelSmState=_FsRstPortRoleSelSmState_Object((1,3,6,1,4,1,2076,79,1,10),_FsRstPortRoleSelSmState_Type())
...
fsRstOldDesignatedRoot=_FsRstOldDesignatedRoot_Object((1,3,6,1,4,1,2076,79,1,11),_FsRstOldDesignatedRoot_Type())
...
fsRstPortExtTable=_FsRstPortExtTable_Object((1,3,6,1,4,1,2076,79,1,12))
if mibBuilder.loadTexts:fsRstPortExtTable.setStatus(_A)
_FsRstPortExtEntry_Object=MibTableRow
fsRstPortExtEntry=_FsRstPortExtEntry_Object((1,3,6,1,4,1,2076,79,1,12,1))
fsRstPortExtEntry.setIndexNames((0,_F,_V))
...
fsRstPort=_FsRstPort_Object((1,3,6,1,4,1,2076,79,1,12,1,1),_FsRstPort_Type())
fsRstPort.setMaxAccess(_W)
...
fsRstPortRole=_FsRstPortRole_Object((1,3,6,1,4,1,2076,79,1,12,1,2),_FsRstPortRole_Type())
...
fsRstPortOperVersion=_FsRstPortOperVersion_Object((1,3,6,1,4,1,2076,79,1,12,1,3),_FsRstPortOperVersion_Type())
fsRstPortOperVersion.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRstPortOperVersion.setStatus(_A)
class _FsRstPortInfoSmState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_U,0),('aged',1),('update',2),('superior',3),('repeat',4),('notdesignated',5),('present',6),('receive',7),('inferiordesignated',8)))
_FsRstPortInfoSmState_Type.__name__=_C
_FsRstPortInfoSmState_Object=MibTableColumn
fsRstPortInfoSmState=_FsRstPortInfoSmState_Object((1,3,6,1,4,1,2076,79,1,12,1,4),_FsRstPortInfoSmState_Type())
...
fsRstPortMigSmState=_FsRstPortMigSmState_Object((1,3,6,1,4,1,2076,79,1,12,1,5),_FsRstPortMigSmState_Type())
...
fsRstPortRoleTransSmState=_FsRstPortRoleTransSmState_Object((1,3,6,1,4,1,2076,79,1,12,1,6),_FsRstPortRoleTransSmState_Type())
fsRstPortRoleTransSmState.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRstPortRoleTransSmState.setStatus(_A)
class _FsRstPortStateTransSmState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*(('discarding',0),(_X,1),('forwarding',2)))
_FsRstPortStateTransSmState_Type.__name__=_C
_FsRstPortStateTransSmState_Object=MibTableColumn
fsRstPortStateTransSmState=_FsRstPortStateTransSmState_Object((1,3,6,1,4,1,2076,79,1,12,1,7),_FsRstPortStateTransSmState_Type())
fsRstPortStateTransSmState.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRstPortStateTransSmState.setStatus(_A)
class _FsRstPortTopoChSmState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3,4,5,6,7)));namedValues=NamedValues(*(('inactive',0),(_X,1),('detected',2),('active',3),('notifiedtcn',4),('notifiedtc',5),('propagating',6),('acknowledged',7)))
_FsRstPortTopoChSmState_Type.__name__=_C
_FsRstPortTopoChSmState_Object=MibTableColumn
fsRstPortTopoChSmState=_FsRstPortTopoChSmState_Object((1,3,6,1,4,1,2076,79,1,12,1,8),_FsRstPortTopoChSmState_Type())
...
fsRstPortTxSmState=_FsRstPortTxSmState_Object((1,3,6,1,4,1,2076,79,1,12,1,9),_FsRstPortTxSmState_Type())
...
fsRstPortRxRstBpduCount=_FsRstPortRxRstBpduCount_Object((1,3,6,1,4,1,2076,79,1,12,1,10),_FsRstPortRxRstBpduCount_Type())
...
fsRstPortRxConfigBpduCount=_FsRstPortRxConfigBpduCount_Object((1,3,6,1,4,1,2076,79,1,12,1,11),_FsRstPortRxConfigBpduCount_Type())
...
fsRstPortRxTcnBpduCount=_FsRstPortRxTcnBpduCount_Object((1,3,6,1,4,1,2076,79,1,12,1,12),_FsRstPortRxTcnBpduCount_Type())
...
fsRstPortTxRstBpduCount=_FsRstPortTxRstBpduCount_Object((1,3,6,1,4,1,2076,79,1,12,1,13),_FsRstPortTxRstBpduCount_Type())
...
fsRstPortTxConfigBpduCount=_FsRstPortTxConfigBpduCount_Object((1,3,6,1,4,1,2076,79,1,12,1,14),_FsRstPortTxConfigBpduCount_Type())
...
fsRstPortTxTcnBpduCount=_FsRstPortTxTcnBpduCount_Object((1,3,6,1,4,1,2076,79,1,12,1,15),_FsRstPortTxTcnBpduCount_Type())
...
fsRstPortInvalidRstBpduRxCount=_FsRstPortInvalidRstBpduRxCount_Object((1,3,6,1,4,1,2076,79,1,12,1,16),_FsRstPortInvalidRstBpduRxCount_Type())
...
fsRstPortInvalidConfigBpduRxCount=_FsRstPortInvalidConfigBpduRxCount_Object((1,3,6,1,4,1,2076,79,1,12,1,17),_FsRstPortInvalidConfigBpduRxCount_Type())
...
fsRstPortInvalidTcnBpduRxCount=_FsRstPortInvalidTcnBpduRxCount_Object((1,3,6,1,4,1,2076,79,1,12,1,18),_FsRstPortInvalidTcnBpduRxCount_Type())
...
fsRstPortProtocolMigrationCount=_FsRstPortProtocolMigrationCount_Object((1,3,6,1,4,1,2076,79,1,12,1,19),_FsRstPortProtocolMigrationCount_Type())
...
fsRstPortEffectivePortState=_FsRstPortEffectivePortState_Object((1,3,6,1,4,1,2076,79,1,12,1,20),_FsRstPortEffectivePortState_Type())
...
fsRstPortAutoEdge=_FsRstPortAutoEdge_Object((1,3,6,1,4,1,2076,79,1,12,1,21),_FsRstPortAutoEdge_Type())
...
fsRstPortRestrictedRole=_FsRstPortRestrictedRole_Object((1,3,6,1,4,1,2076,79,1,12,1,22),_FsRstPortRestrictedRole_Type())
...
fsRstPortRestrictedTCN=_FsRstPortRestrictedTCN_Object((1,3,6,1,4,1,2076,79,1,12,1,23),_FsRstPortRestrictedTCN_Type())
...
_FsRstPortEnableBPDURx_Type.__name__=_G
_FsRstPortEnableBPDURx_Object=MibTableColumn
fsRstPortEnableBPDURx=_FsRstPortEnableBPDURx_Object((1,3,6,1,4,1,2076,79,1,12,1,24),_FsRstPortEnableBPDURx_Type())
...
_FsRstPortEnableBPDUTx_Type.__name__=_G
_FsRstPortEnableBPDUTx_Object=MibTableColumn
fsRstPortEnableBPDUTx=_FsRstPortEnableBPDUTx_Object((1,3,6,1,4,1,2076,79,1,12,1,25),_FsRstPortEnableBPDUTx_Type())
...
fsRstPortPseudoRootId=_FsRstPortPseudoRootId_Object((1,3,6,1,4,1,2076,79,1,12,1,26),_FsRstPortPseudoRootId_Type())
...
_FsRstPortIsL2Gp_Type.__name__=_G
_FsRstPortIsL2Gp_Object=MibTableColumn
fsRstPortIsL2Gp=_FsRstPortIsL2Gp_Object((1,3,6,1,4,1,2076,79,1,12,1,27),_FsRstPortIsL2Gp_Type())
...
_FsRstPortLoopGuard_Type.__name__=_G
_FsRstPortLoopGuard_Object=MibTableColumn
fsRstPortLoopGuard=_FsRstPortLoopGuard_Object((1,3,6,1,4,1,2076,79,1,12,1,28),_FsRstPortLoopGuard_Type())
fsRstPortLoopGuard.setMaxAccess(_D)
if mibBuilder.loadTexts:fsRstPortLoopGuard.setStatus(_A)
class _FsRstPortRcvdEvent_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_Y,1),(_Z,2),(_a,3)))
_FsRstPortRcvdEvent_Type.__name__=_C
_FsRstPortRcvdEvent_Object=MibTableColumn
fsRstPortRcvdEvent=_FsRstPortRcvdEvent_Object((1,3,6,1,4,1,2076,79,1,12,1,29),_FsRstPortRcvdEvent_Type())
...
fsRstPortRcvdEventSubType=_FsRstPortRcvdEventSubType_Object((1,3,6,1,4,1,2076,79,1,12,1,30),_FsRstPortRcvdEventSubType_Type())
...
fsRstPortRcvdEventTimeStamp=_FsRstPortRcvdEventTimeStamp_Object((1,3,6,1,4,1,2076,79,1,12,1,31),_FsRstPortRcvdEventTimeStamp_Type())
...
fsRstPortStateChangeTimeStamp=_FsRstPortStateChangeTimeStamp_Object((1,3,6,1,4,1,2076,79,1,12,1,32),_FsRstPortStateChangeTimeStamp_Type())
...
fsRstPortRowStatus=_FsRstPortRowStatus_Object((1,3,6,1,4,1,2076,79,1,12,1,33),_FsRstPortRowStatus_Type())
fsRstPortRowStatus.setMaxAccess('read-create')
if mibBuilder.loadTexts:fsRstPortRowStatus.setStatus(_A)
class _FsRstPortBpduGuard_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_N,0),(_O,1),(_P,2)))
_FsRstPortBpduGuard_Type.__name__=_C
_FsRstPortBpduGuard_Object=MibTableColumn
fsRstPortBpduGuard=_FsRstPortBpduGuard_Object((1,3,6,1,4,1,2076,79,1,12,1,34),_FsRstPortBpduGuard_Type())
fsRstPortBpduGuard.setMaxAccess(_D)
if mibBuilder.loadTexts:fsRstPortBpduGuard.setStatus(_A)
class _FsRstPortRootGuard_Type(TruthValue):defaultValue=2
_FsRstPortRootGuard_Type.__name__=_G
_FsRstPortRootGuard_Object=MibTableColumn
fsRstPortRootGuard=_FsRstPortRootGuard_Object((1,3,6,1,4,1,2076,79,1,12,1,35),_FsRstPortRootGuard_Type())
fsRstPortRootGuard.setMaxAccess(_D)
if mibBuilder.loadTexts:fsRstPortRootGuard.setStatus(_A)
class _FsRstRootInconsistentState_Type(TruthValue):defaultValue=2
_FsRstRootInconsistentState_Type.__name__=_G
_FsRstRootInconsistentState_Object=MibTableColumn
fsRstRootInconsistentState=_FsRstRootInconsistentState_Object((1,3,6,1,4,1,2076,79,1,12,1,36),_FsRstRootInconsistentState_Type())
fsRstRootInconsistentState.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRstRootInconsistentState.setStatus(_A)
class _FsRstPortErrorRecovery_Type(Timeout):defaultValue=30000;subtypeSpec=Timeout.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(3000,6553500))
_FsRstPortErrorRecovery_Type.__name__=_b
_FsRstPortErrorRecovery_Object=MibTableColumn
fsRstPortErrorRecovery=_FsRstPortErrorRecovery_Object((1,3,6,1,4,1,2076,79,1,12,1,37),_FsRstPortErrorRecovery_Type())
fsRstPortErrorRecovery.setMaxAccess(_D)
if mibBuilder.loadTexts:fsRstPortErrorRecovery.setStatus(_A)
if mibBuilder.loadTexts:fsRstPortErrorRecovery.setUnits('centi-seconds')
class _FsRstPortStpModeDot1wEnabled_Type(EnabledStatus):defaultValue=2
_FsRstPortStpModeDot1wEnabled_Type.__name__=_c
_FsRstPortStpModeDot1wEnabled_Object=MibTableColumn
fsRstPortStpModeDot1wEnabled=_FsRstPortStpModeDot1wEnabled_Object((1,3,6,1,4,1,2076,79,1,12,1,38),_FsRstPortStpModeDot1wEnabled_Type())
fsRstPortStpModeDot1wEnabled.setMaxAccess(_D)
if mibBuilder.loadTexts:fsRstPortStpModeDot1wEnabled.setStatus(_A)
class _FsRstPortBpduInconsistentState_Type(TruthValue):defaultValue=2
_FsRstPortBpduInconsistentState_Type.__name__=_G
_FsRstPortBpduInconsistentState_Object=MibTableColumn
fsRstPortBpduInconsistentState=_FsRstPortBpduInconsistentState_Object((1,3,6,1,4,1,2076,79,1,12,1,39),_FsRstPortBpduInconsistentState_Type())
fsRstPortBpduInconsistentState.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRstPortBpduInconsistentState.setStatus(_A)
class _FsRstPortBpduGuardAction_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('disable-discarding',1),('admin-down',2)))
_FsRstPortBpduGuardAction_Type.__name__=_C
_FsRstPortBpduGuardAction_Object=MibTableColumn
fsRstPortBpduGuardAction=_FsRstPortBpduGuardAction_Object((1,3,6,1,4,1,2076,79,1,12,1,40),_FsRstPortBpduGuardAction_Type())
fsRstPortBpduGuardAction.setMaxAccess(_D)
if mibBuilder.loadTexts:fsRstPortBpduGuardAction.setStatus(_A)
class _FsRstDynamicPathcostCalculation_Type(TruthValue):defaultValue=2
_FsRstDynamicPathcostCalculation_Type.__name__=_G
_FsRstDynamicPathcostCalculation_Object=MibScalar
fsRstDynamicPathcostCalculation=_FsRstDynamicPathcostCalculation_Object((1,3,6,1,4,1,2076,79,1,13),_FsRstDynamicPathcostCalculation_Type())
...
_FsRstCalcPortPathCostOnSpeedChg_Type.__name__=_G
_FsRstCalcPortPathCostOnSpeedChg_Object=MibScalar
fsRstCalcPortPathCostOnSpeedChg=_FsRstCalcPortPathCostOnSpeedChg_Object((1,3,6,1,4,1,2076,79,1,14),_FsRstCalcPortPathCostOnSpeedChg_Type())
fsRstCalcPortPathCostOnSpeedChg.setMaxAccess(_D)
if mibBuilder.loadTexts:fsRstCalcPortPathCostOnSpeedChg.setStatus(_A)
class _FsRstRcvdEvent_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_Y,1),(_Z,2),(_a,3)))
_FsRstRcvdEvent_Type.__name__=_C
_FsRstRcvdEvent_Object=MibScalar
fsRstRcvdEvent=_FsRstRcvdEvent_Object((1,3,6,1,4,1,2076,79,1,15),_FsRstRcvdEvent_Type())
...
fsRstRcvdEventSubType=_FsRstRcvdEventSubType_Object((1,3,6,1,4,1,2076,79,1,16),_FsRstRcvdEventSubType_Type())
...
fsRstRcvdEventTimeStamp=_FsRstRcvdEventTimeStamp_Object((1,3,6,1,4,1,2076,79,1,17),_FsRstRcvdEventTimeStamp_Type())
...
fsRstRcvdPortStateChangeTimeStamp=_FsRstRcvdPortStateChangeTimeStamp_Object((1,3,6,1,4,1,2076,79,1,18),_FsRstRcvdPortStateChangeTimeStamp_Type())
fsRstRcvdPortStateChangeTimeStamp.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRstRcvdPortStateChangeTimeStamp.setStatus(_A)
class _FsRstBpduGuard_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_P,2)))
_FsRstBpduGuard_Type.__name__=_C
_FsRstBpduGuard_Object=MibScalar
fsRstBpduGuard=_FsRstBpduGuard_Object((1,3,6,1,4,1,2076,79,1,19),_FsRstBpduGuard_Type())
fsRstBpduGuard.setMaxAccess(_D)
if mibBuilder.loadTexts:fsRstBpduGuard.setStatus(_A)
class _FsRstStpPerfStatus_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_P,2)))
_FsRstStpPerfStatus_Type.__name__=_C
_FsRstStpPerfStatus_Object=MibScalar
fsRstStpPerfStatus=_FsRstStpPerfStatus_Object((1,3,6,1,4,1,2076,79,1,20),_FsRstStpPerfStatus_Type())
fsRstStpPerfStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:fsRstStpPerfStatus.setStatus(_A)
_Dot1wFsRstTrapsControl_ObjectIdentity=ObjectIdentity
dot1wFsRstTrapsControl=_Dot1wFsRstTrapsControl_ObjectIdentity((1,3,6,1,4,1,2076,79,2))
...
fsRstSetTraps=_FsRstSetTraps_Object((1,3,6,1,4,1,2076,79,2,1),_FsRstSetTraps_Type())
...
fsRstGenTrapType=_FsRstGenTrapType_Object((1,3,6,1,4,1,2076,79,2,2),_FsRstGenTrapType_Type())
...
fsRstErrTrapType=_FsRstErrTrapType_Object((1,3,6,1,4,1,2076,79,2,3),_FsRstErrTrapType_Type())
...
fsRstPortTrapNotificationTable=_FsRstPortTrapNotificationTable_Object((1,3,6,1,4,1,2076,79,2,4))
if mibBuilder.loadTexts:fsRstPortTrapNotificationTable.setStatus(_A)
_FsRstPortTrapNotificationEntry_Object=MibTableRow
fsRstPortTrapNotificationEntry=_FsRstPortTrapNotificationEntry_Object((1,3,6,1,4,1,2076,79,2,4,1))
fsRstPortTrapNotificationEntry.setIndexNames((0,_F,_d))
...
fsRstPortTrapIndex=_FsRstPortTrapIndex_Object((1,3,6,1,4,1,2076,79,2,4,1,1),_FsRstPortTrapIndex_Type())
fsRstPortTrapIndex.setMaxAccess(_W)
...
fsRstPortMigrationType=_FsRstPortMigrationType_Object((1,3,6,1,4,1,2076,79,2,4,1,2),_FsRstPortMigrationType_Type())
...
fsRstPktErrType=_FsRstPktErrType_Object((1,3,6,1,4,1,2076,79,2,4,1,3),_FsRstPktErrType_Type())
...
fsRstPktErrVal=_FsRstPktErrVal_Object((1,3,6,1,4,1,2076,79,2,4,1,4),_FsRstPktErrVal_Type())
...
fsRstPortRoleType=_FsRstPortRoleType_Object((1,3,6,1,4,1,2076,79,2,4,1,5),_FsRstPortRoleType_Type())
...
fsRstOldRoleType=_FsRstOldRoleType_Object((1,3,6,1,4,1,2076,79,2,4,1,6),_FsRstOldRoleType_Type())
