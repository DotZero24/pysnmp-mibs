# SNMP MIB module (ARICENT-RSTP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/siaemic/ARICENT-RSTP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:42:26 2025
...
class _FsRstPortRootGuard_Type(TruthValue):
    """Custom type fsRstPortRootGuard based on TruthValue"""
    defaultValue = 2


_FsRstPortRootGuard_Type.__name__ = "TruthValue"
_FsRstPortRootGuard_Object = MibTableColumn
fsRstPortRootGuard = _FsRstPortRootGuard_Object(
    (1, 3, 6, 1, 4, 1, 2076, 79, 1, 12, 1, 35),
    _FsRstPortRootGuard_Type()
)
fsRstPortRootGuard.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsRstPortRootGuard.setStatus("current")


class _FsRstRootInconsistentState_Type(TruthValue):
    """Custom type fsRstRootInconsistentState based on TruthValue"""
    defaultValue = 2


_FsRstRootInconsistentState_Type.__name__ = "TruthValue"
_FsRstRootInconsistentState_Object = MibTableColumn
fsRstRootInconsistentState = _FsRstRootInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 79, 1, 12, 1, 36),
    _FsRstRootInconsistentState_Type()
)
fsRstRootInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsRstRootInconsistentState.setStatus("current")


class _FsRstPortErrorRecovery_Type(Timeout):
    """Custom type fsRstPortErrorRecovery based on Timeout"""
    defaultValue = 30000
...
_FsRstPortErrorRecovery_Type.__name__ = "Timeout"
_FsRstPortErrorRecovery_Object = MibTableColumn
fsRstPortErrorRecovery = _FsRstPortErrorRecovery_Object(
    (1, 3, 6, 1, 4, 1, 2076, 79, 1, 12, 1, 37),
    _FsRstPortErrorRecovery_Type()
)
fsRstPortErrorRecovery.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsRstPortErrorRecovery.setStatus("current")
if mibBuilder.loadTexts:
    fsRstPortErrorRecovery.setUnits("centi-seconds")


class _FsRstPortStpModeDot1wEnabled_Type(EnabledStatus):
    """Custom type fsRstPortStpModeDot1wEnabled based on EnabledStatus"""
    defaultValue = 2


_FsRstPortStpModeDot1wEnabled_Type.__name__ = "EnabledStatus"
_FsRstPortStpModeDot1wEnabled_Object = MibTableColumn
fsRstPortStpModeDot1wEnabled = _FsRstPortStpModeDot1wEnabled_Object(
    (1, 3, 6, 1, 4, 1, 2076, 79, 1, 12, 1, 38),
    _FsRstPortStpModeDot1wEnabled_Type()
)
fsRstPortStpModeDot1wEnabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsRstPortStpModeDot1wEnabled.setStatus("current")


class _FsRstPortBpduInconsistentState_Type(TruthValue):
    """Custom type fsRstPortBpduInconsistentState based on TruthValue"""
    defaultValue = 2


_FsRstPortBpduInconsistentState_Type.__name__ = "TruthValue"
_FsRstPortBpduInconsistentState_Object = MibTableColumn
fsRstPortBpduInconsistentState = _FsRstPortBpduInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 79, 1, 12, 1, 39),
    _FsRstPortBpduInconsistentState_Type()
)
fsRstPortBpduInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsRstPortBpduInconsistentState.setStatus("current")


class _FsRstPortBpduGuardAction_Type(Integer32):
    """Custom type fsRstPortBpduGuardAction based on Integer32"""
    defaultValue = 1
...
_FsRstPortBpduGuardAction_Type.__name__ = "Integer32"
_FsRstPortBpduGuardAction_Object = MibTableColumn
fsRstPortBpduGuardAction = _FsRstPortBpduGuardAction_Object(
    (1, 3, 6, 1, 4, 1, 2076, 79, 1, 12, 1, 40),
    _FsRstPortBpduGuardAction_Type()
)
fsRstPortBpduGuardAction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsRstPortBpduGuardAction.setStatus("current")
...
class _FsRstStpPerfStatus_Type(Integer32):
    """Custom type fsRstStpPerfStatus based on Integer32"""
    defaultValue = 2
...
_FsRstStpPerfStatus_Type.__name__ = "Integer32"
_FsRstStpPerfStatus_Object = MibScalar
fsRstStpPerfStatus = _FsRstStpPerfStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 79, 1, 20),
    _FsRstStpPerfStatus_Type()
)
fsRstStpPerfStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsRstStpPerfStatus.setStatus("current")
_Dot1wFsRstTrapsControl_ObjectIdentity = ObjectIdentity
dot1wFsRstTrapsControl = _Dot1wFsRstTrapsControl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 79, 2)
)
...
fsRstPortTrapNotificationEntry = _FsRstPortTrapNotificationEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 79, 2, 4, 1)
)
fsRstPortTrapNotificationEntry.setIndexNames(
    (0, "ARICENT-RSTP-MIB", "fsRstPortTrapIndex"),
)
if mibBuilder.loadTexts:
...
fsRstGenTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 79, 3, 0, 1)
)
fsRstGenTrap.setObjects(
      *(("BRIDGE-MIB", "dot1dBaseBridgeAddress"),
        ("ARICENT-RSTP-MIB", "fsRstGenTrapType"))
)
if mibBuilder.loadTexts:
...
fsRstErrTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 79, 3, 0, 2)
)
fsRstErrTrap.setObjects(
      *(("BRIDGE-MIB", "dot1dBaseBridgeAddress"),
        ("ARICENT-RSTP-MIB", "fsRstErrTrapType"))
)
if mibBuilder.loadTexts:
...
fsRstNewRootTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 79, 3, 0, 3)
)
fsRstNewRootTrap.setObjects(
      *(("BRIDGE-MIB", "dot1dBaseBridgeAddress"),
        ("ARICENT-RSTP-MIB", "fsRstOldDesignatedRoot"),
...
fsRstProtocolMigrationTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 79, 3, 0, 5)
)
fsRstProtocolMigrationTrap.setObjects(
      *(("BRIDGE-MIB", "dot1dBaseBridgeAddress"),
        ("RSTP-MIB", "dot1dStpVersion"),
        ("ARICENT-RSTP-MIB", "fsRstPortMigrationType"))
)
if mibBuilder.loadTexts:
...
fsRstInvalidBpduRxdTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 79, 3, 0, 6)
)
fsRstInvalidBpduRxdTrap.setObjects(
      *(("BRIDGE-MIB", "dot1dBaseBridgeAddress"),
        ("ARICENT-RSTP-MIB", "fsRstPktErrType"),
        ("ARICENT-RSTP-MIB", "fsRstPktErrVal"))
)
if mibBuilder.loadTexts:
...
fsRstNewPortRoleTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 79, 3, 0, 7)
)
fsRstNewPortRoleTrap.setObjects(
      *(("BRIDGE-MIB", "dot1dBaseBridgeAddress"),
        ("ARICENT-RSTP-MIB", "fsRstPortRoleType"),
        ("ARICENT-RSTP-MIB", "fsRstOldRoleType"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"EnabledStatus": EnabledStatus,
       ...
       "fsRstPortRootGuard": fsRstPortRootGuard,
       "fsRstRootInconsistentState": fsRstRootInconsistentState,
       "fsRstPortErrorRecovery": fsRstPortErrorRecovery,
       "fsRstPortStpModeDot1wEnabled": fsRstPortStpModeDot1wEnabled,
       "fsRstPortBpduInconsistentState": fsRstPortBpduInconsistentState,
       "fsRstPortBpduGuardAction": fsRstPortBpduGuardAction,
       ...
       "fsRstStpPerfStatus": fsRstStpPerfStatus,
