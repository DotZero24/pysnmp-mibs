...
mibBuilder.exportSymbols("DES7200-TC", myTextualConventions=myTextualConventions, MemberMap=MemberMap, ConfigStatus=ConfigStatus, MyTrapType=MyTrapType, PYSNMP_MODULE_ID=myTextualConventions, IfIndex=IfIndex)
