...
nmsIfThresholdMIBObjects=_NmsIfThresholdMIBObjects_ObjectIdentity((1,3,6,1,4,1,34751,9,218,1))
_NmsifthTemplateGroup_ObjectIdentity=ObjectIdentity
nmsifthTemplateGroup=_NmsifthTemplateGroup_ObjectIdentity((1,3,6,1,4,1,34751,9,218,1,1))
_NmsifthTemplateIndexNext_Type=NMSifthTemplateIndexOrZero
_NmsifthTemplateIndexNext_Object=MibScalar
nmsifthTemplateIndexNext=_NmsifthTemplateIndexNext_Object((1,3,6,1,4,1,34751,9,218,1,1,1),_NmsifthTemplateIndexNext_Type())
...
nmsifthTemplateLastChange=_NmsifthTemplateLastChange_Object((1,3,6,1,4,1,34751,9,218,1,1,2),_NmsifthTemplateLastChange_Type())
...
nmsifthTemplateTable=_NmsifthTemplateTable_Object((1,3,6,1,4,1,34751,9,218,1,1,3))
if mibBuilder.loadTexts:nmsifthTemplateTable.setStatus(_A)
_NmsifthTemplateEntry_Object=MibTableRow
nmsifthTemplateEntry=_NmsifthTemplateEntry_Object((1,3,6,1,4,1,34751,9,218,1,1,3,1))
...
nmsifthTemplateIndex=_NmsifthTemplateIndex_Object((1,3,6,1,4,1,34751,9,218,1,1,3,1,1),_NmsifthTemplateIndex_Type())
...
nmsifthTemplateName=_NmsifthTemplateName_Object((1,3,6,1,4,1,34751,9,218,1,1,3,1,2),_NmsifthTemplateName_Type())
...
nmsifthTemplateNotifyHoldDownType=_NmsifthTemplateNotifyHoldDownType_Object((1,3,6,1,4,1,34751,9,218,1,1,3,1,3),_NmsifthTemplateNotifyHoldDownType_Type())
...
nmsifthTemplateNotifyHoldDownTime=_NmsifthTemplateNotifyHoldDownTime_Object((1,3,6,1,4,1,34751,9,218,1,1,3,1,4),_NmsifthTemplateNotifyHoldDownTime_Type())
...
nmsifthTemplateRowStatus=_NmsifthTemplateRowStatus_Object((1,3,6,1,4,1,34751,9,218,1,1,3,1,5),_NmsifthTemplateRowStatus_Type())
...
nmsifthThresholdLastChange=_NmsifthThresholdLastChange_Object((1,3,6,1,4,1,34751,9,218,1,1,4),_NmsifthThresholdLastChange_Type())
...
nmsifthThresholdTable=_NmsifthThresholdTable_Object((1,3,6,1,4,1,34751,9,218,1,1,5))
if mibBuilder.loadTexts:nmsifthThresholdTable.setStatus(_A)
_NmsifthThresholdEntry_Object=MibTableRow
nmsifthThresholdEntry=_NmsifthThresholdEntry_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1))
...
nmsifthThresholdIndex=_NmsifthThresholdIndex_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,1),_NmsifthThresholdIndex_Type())
...
nmsifthThresholdDescr=_NmsifthThresholdDescr_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,2),_NmsifthThresholdDescr_Type())
...
nmsifthThresholdObject=_NmsifthThresholdObject_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,3),_NmsifthThresholdObject_Type())
...
nmsifthThresholdSeverity=_NmsifthThresholdSeverity_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,4),_NmsifthThresholdSeverity_Type())
...
nmsifthThresholdType=_NmsifthThresholdType_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,5),_NmsifthThresholdType_Type())
...
nmsifthThresholdDirection=_NmsifthThresholdDirection_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,6),_NmsifthThresholdDirection_Type())
...
nmsifthThresholdFiredValue=_NmsifthThresholdFiredValue_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,7),_NmsifthThresholdFiredValue_Type())
...
nmsifthThresholdClearedValue=_NmsifthThresholdClearedValue_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,8),_NmsifthThresholdClearedValue_Type())
...
nmsifthThresholdSampleInterval=_NmsifthThresholdSampleInterval_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,9),_NmsifthThresholdSampleInterval_Type())
...
nmsifthThresholdApsSwitchover=_NmsifthThresholdApsSwitchover_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,10),_NmsifthThresholdApsSwitchover_Type())
...
nmsifthThresholdRowStatus=_NmsifthThresholdRowStatus_Object((1,3,6,1,4,1,34751,9,218,1,1,5,1,11),_NmsifthThresholdRowStatus_Type())
...
nmsifthTemplateIfAssignGroup=_NmsifthTemplateIfAssignGroup_ObjectIdentity((1,3,6,1,4,1,34751,9,218,1,2))
_NmsifthTemplateIfLastChange_Type=TimeStamp
_NmsifthTemplateIfLastChange_Object=MibScalar
nmsifthTemplateIfLastChange=_NmsifthTemplateIfLastChange_Object((1,3,6,1,4,1,34751,9,218,1,2,1),_NmsifthTemplateIfLastChange_Type())
...
nmsifthTemplateIfAssignTable=_NmsifthTemplateIfAssignTable_Object((1,3,6,1,4,1,34751,9,218,1,2,2))
if mibBuilder.loadTexts:nmsifthTemplateIfAssignTable.setStatus(_A)
_NmsifthTemplateIfAssignEntry_Object=MibTableRow
nmsifthTemplateIfAssignEntry=_NmsifthTemplateIfAssignEntry_Object((1,3,6,1,4,1,34751,9,218,1,2,2,1))
...
nmsifthTemplateIfAssignInterface=_NmsifthTemplateIfAssignInterface_Object((1,3,6,1,4,1,34751,9,218,1,2,2,1,1),_NmsifthTemplateIfAssignInterface_Type())
...
nmsifthTemplateIfAssignOperStatus=_NmsifthTemplateIfAssignOperStatus_Object((1,3,6,1,4,1,34751,9,218,1,2,2,1,2),_NmsifthTemplateIfAssignOperStatus_Type())
...
nmsifthTemplateIfAssignRowStatus=_NmsifthTemplateIfAssignRowStatus_Object((1,3,6,1,4,1,34751,9,218,1,2,2,1,3),_NmsifthTemplateIfAssignRowStatus_Type())
...
nmsifthIfThresholdFiredGroup=_NmsifthIfThresholdFiredGroup_ObjectIdentity((1,3,6,1,4,1,34751,9,218,1,3))
...
nmsifthThresholdFiredNotifyEnable=_NmsifthThresholdFiredNotifyEnable_Object((1,3,6,1,4,1,34751,9,218,1,3,1),_NmsifthThresholdFiredNotifyEnable_Type())
...
nmsifthThresholdFiredLastChange=_NmsifthThresholdFiredLastChange_Object((1,3,6,1,4,1,34751,9,218,1,3,2),_NmsifthThresholdFiredLastChange_Type())
...
nmsifthIfThresholdFiredTable=_NmsifthIfThresholdFiredTable_Object((1,3,6,1,4,1,34751,9,218,1,3,3))
if mibBuilder.loadTexts:nmsifthIfThresholdFiredTable.setStatus(_A)
_NmsifthIfThresholdFiredEntry_Object=MibTableRow
nmsifthIfThresholdFiredEntry=_NmsifthIfThresholdFiredEntry_Object((1,3,6,1,4,1,34751,9,218,1,3,3,1))
...
nmsifthIfThresholdFiredTemplate=_NmsifthIfThresholdFiredTemplate_Object((1,3,6,1,4,1,34751,9,218,1,3,3,1,1),_NmsifthIfThresholdFiredTemplate_Type())
...
nmsifthIfThresholdsFired=_NmsifthIfThresholdsFired_Object((1,3,6,1,4,1,34751,9,218,1,3,3,1,2),_NmsifthIfThresholdsFired_Type())
...
nmsifthIfLastThresholdFired=_NmsifthIfLastThresholdFired_Object((1,3,6,1,4,1,34751,9,218,1,3,3,1,3),_NmsifthIfLastThresholdFired_Type())
...
nmsifthIfThresholdFiredLstChange=_NmsifthIfThresholdFiredLstChange_Object((1,3,6,1,4,1,34751,9,218,1,3,3,1,4),_NmsifthIfThresholdFiredLstChange_Type())
...
nmsifthIfThresholdFiredLstSeverity=_NmsifthIfThresholdFiredLstSeverity_Object((1,3,6,1,4,1,34751,9,218,1,3,3,1,5),_NmsifthIfThresholdFiredLstSeverity_Type())
...
nmsifthIfThresholdFiredMaxSeverity=_NmsifthIfThresholdFiredMaxSeverity_Object((1,3,6,1,4,1,34751,9,218,1,3,3,1,6),_NmsifthIfThresholdFiredMaxSeverity_Type())
...
nmsIfThresholdMIBNotifications=_NmsIfThresholdMIBNotifications_ObjectIdentity((1,3,6,1,4,1,34751,9,218,2))
_NmsifthMIBNotificationsPrefix_ObjectIdentity=ObjectIdentity
nmsifthMIBNotificationsPrefix=_NmsifthMIBNotificationsPrefix_ObjectIdentity((1,3,6,1,4,1,34751,9,218,2,0))
_NmsIfThresholdMIBConformance_ObjectIdentity=ObjectIdentity
nmsIfThresholdMIBConformance=_NmsIfThresholdMIBConformance_ObjectIdentity((1,3,6,1,4,1,34751,9,218,3))
_NmsIfThresholdMIBCompliances_ObjectIdentity=ObjectIdentity
nmsIfThresholdMIBCompliances=_NmsIfThresholdMIBCompliances_ObjectIdentity((1,3,6,1,4,1,34751,9,218,3,1))
_NmsIfThresholdMIBGroups_ObjectIdentity=ObjectIdentity
nmsIfThresholdMIBGroups=_NmsIfThresholdMIBGroups_ObjectIdentity((1,3,6,1,4,1,34751,9,218,3,2))
nmsIfThresholdTemplateGroup=ObjectGroup((1,3,6,1,4,1,34751,9,218,3,2,1))
...
nmsIfThresholdFiredGroup=ObjectGroup((1,3,6,1,4,1,34751,9,218,3,2,2))
