# SNMP MIB module (QTECH-NMS-IF-THRESHOLD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-NMS-IF-THRESHOLD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:58:18 2025
...
nmsifthTemplateEntry = _NmsifthTemplateEntry_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 3, 1)
)
nmsifthTemplateEntry.setIndexNames(
    (0, "QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateIndex"),
)
if mibBuilder.loadTexts:
...
nmsifthTemplateIndex = _NmsifthTemplateIndex_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 3, 1, 1),
...
nmsifthTemplateName = _NmsifthTemplateName_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 3, 1, 2),
...
nmsifthTemplateNotifyHoldDownType = _NmsifthTemplateNotifyHoldDownType_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 3, 1, 3),
...
nmsifthTemplateNotifyHoldDownTime = _NmsifthTemplateNotifyHoldDownTime_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 3, 1, 4),
...
nmsifthTemplateRowStatus = _NmsifthTemplateRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 3, 1, 5),
...
nmsifthThresholdEntry = _NmsifthThresholdEntry_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1)
)
nmsifthThresholdEntry.setIndexNames(
    (0, "QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateIndex"),
    (0, "QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdIndex"),
)
if mibBuilder.loadTexts:
...
nmsifthThresholdIndex = _NmsifthThresholdIndex_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 1),
...
nmsifthThresholdDescr = _NmsifthThresholdDescr_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 2),
...
nmsifthThresholdObject = _NmsifthThresholdObject_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 3),
...
nmsifthThresholdSeverity = _NmsifthThresholdSeverity_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 4),
...
nmsifthThresholdType = _NmsifthThresholdType_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 5),
...
nmsifthThresholdDirection = _NmsifthThresholdDirection_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 6),
...
nmsifthThresholdFiredValue = _NmsifthThresholdFiredValue_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 7),
...
nmsifthThresholdClearedValue = _NmsifthThresholdClearedValue_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 8),
...
nmsifthThresholdSampleInterval = _NmsifthThresholdSampleInterval_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 9),
...
nmsifthThresholdApsSwitchover = _NmsifthThresholdApsSwitchover_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 10),
...
nmsifthThresholdRowStatus = _NmsifthThresholdRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 1, 5, 1, 11),
...
nmsifthTemplateIfAssignEntry = _NmsifthTemplateIfAssignEntry_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 2, 2, 1)
)
nmsifthTemplateIfAssignEntry.setIndexNames(
    (0, "QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateIndex"),
    (0, "QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateIfAssignInterface"),
)
if mibBuilder.loadTexts:
...
nmsifthTemplateIfAssignInterface = _NmsifthTemplateIfAssignInterface_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 2, 2, 1, 1),
...
nmsifthTemplateIfAssignOperStatus = _NmsifthTemplateIfAssignOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 2, 2, 1, 2),
...
nmsifthTemplateIfAssignRowStatus = _NmsifthTemplateIfAssignRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 2, 2, 1, 3),
...
nmsifthIfThresholdFiredEntry = _NmsifthIfThresholdFiredEntry_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 3, 3, 1)
)
nmsifthIfThresholdFiredEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthIfThresholdFiredTemplate"),
)
if mibBuilder.loadTexts:
...
nmsifthIfThresholdFiredTemplate = _NmsifthIfThresholdFiredTemplate_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 3, 3, 1, 1),
...
nmsifthIfLastThresholdFired = _NmsifthIfLastThresholdFired_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 3, 3, 1, 3),
...
nmsifthIfThresholdFiredLstChange = _NmsifthIfThresholdFiredLstChange_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 3, 3, 1, 4),
...
nmsifthIfThresholdFiredLstSeverity = _NmsifthIfThresholdFiredLstSeverity_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 3, 3, 1, 5),
...
nmsifthIfThresholdFiredMaxSeverity = _NmsifthIfThresholdFiredMaxSeverity_Object(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 1, 3, 3, 1, 6),
...
nmsIfThresholdMIBCompliances = _NmsIfThresholdMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 3, 1)
)
_NmsIfThresholdMIBGroups_ObjectIdentity = ObjectIdentity
nmsIfThresholdMIBGroups = _NmsIfThresholdMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 3, 2)
)

# Managed Objects groups

nmsIfThresholdTemplateGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 3, 2, 1)
)
nmsIfThresholdTemplateGroup.setObjects(
      *(("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateIndexNext"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateLastChange"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateName"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateNotifyHoldDownType"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateRowStatus"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdLastChange"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdDescr"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdObject"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdSeverity"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdType"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdDirection"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdFiredValue"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdSampleInterval"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdRowStatus"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateIfLastChange"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateIfAssignOperStatus"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateIfAssignRowStatus"))
)
if mibBuilder.loadTexts:
    nmsIfThresholdTemplateGroup.setStatus("current")

nmsIfThresholdFiredGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 3, 2, 2)
)
nmsIfThresholdFiredGroup.setObjects(
      *(("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdFiredNotifyEnable"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthThresholdFiredLastChange"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthIfThresholdsFired"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthIfLastThresholdFired"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthIfThresholdFiredLstChange"),
...
nmsIfThresholdNotifsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 3, 2, 6)
)
nmsIfThresholdNotifsGroup.setObjects(
      *(("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthIfThresholdFired"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthIfThresholdCleared"))
)
if mibBuilder.loadTexts:
...
nmsifthTemplateIfNotifsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 3, 2, 7)
)
nmsifthTemplateIfNotifsGroup.setObjects(
    ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsifthTemplateIfStatusChange")
)
if mibBuilder.loadTexts:
...
nmsIfThresholdMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 34751, 9, 218, 3, 1, 1)
)
nmsIfThresholdMIBCompliance.setObjects(
      *(("QTECH-NMS-IF-THRESHOLD-MIB", "nmsIfThresholdTemplateGroup"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsIfThresholdFiredGroup"),
        ("QTECH-NMS-IF-THRESHOLD-MIB", "nmsIfThresholdNotifsGroup"))
)
if mibBuilder.loadTexts:
