# SNMP MIB module (SUPERMICRO-MPLS-NOTIFICATION-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-MPLS-NOTIFICATION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:04:37 2025
...
fsMplsNotifications = _FsMplsNotifications_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 10, 0)
)
...
fsMplsPwNotifStatusStr = _FsMplsPwNotifStatusStr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 10, 0, 1),
...
fsMplsPwIndex = _FsMplsPwIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 10, 0, 2),
    _FsMplsPwIndex_Type()
)
...
fsMplsNotifConfig = _FsMplsNotifConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 10, 1)
)
...
fsMplsPwStatusNotifEnable = _FsMplsPwStatusNotifEnable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 10, 1, 1),
...
fsMplsPwOAMStatusNotifEnable = _FsMplsPwOAMStatusNotifEnable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 10, 1, 2),
...
fsMplsPwOamStatus = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 10, 0, 3)
)
fsMplsPwOamStatus.setObjects(
      *(("SUPERMICRO-MPLS-NOTIFICATION-MIB", "fsMplsPwIndex"),
        ("SUPERMICRO-MPLS-NOTIFICATION-MIB", "fsMplsPwNotifStatusStr"))
)
if mibBuilder.loadTexts:
...
fsMplsPwStatus = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 10, 0, 4)
)
...
mibBuilder.exportSymbols(
    "SUPERMICRO-MPLS-NOTIFICATION-MIB",
