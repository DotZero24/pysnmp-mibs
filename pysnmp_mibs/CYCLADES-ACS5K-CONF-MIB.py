# SNMP MIB module (CYCLADES-ACS5K-CONF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/vertiv/CYCLADES-ACS5K-CONF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:05:49 2025
...
cyACS5KConf = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2)
)
if mibBuilder.loadTexts:
    cyACS5KConf.setRevisions(
        ("2010-07-26 00:00",)
    )
...
class _CyEnableIPv4_Type(Integer32):
    """Custom type cyEnableIPv4 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_CyEnableIPv4_Type.__name__ = "Integer32"
_CyEnableIPv4_Object = MibScalar
cyEnableIPv4 = _CyEnableIPv4_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 4, 7),
    _CyEnableIPv4_Type()
)
cyEnableIPv4.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cyEnableIPv4.setStatus("current")


class _CyEnableIPv6_Type(Integer32):
    """Custom type cyEnableIPv6 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_CyEnableIPv6_Type.__name__ = "Integer32"
_CyEnableIPv6_Object = MibScalar
cyEnableIPv6 = _CyEnableIPv6_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 4, 8),
    _CyEnableIPv6_Type()
)
cyEnableIPv6.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cyEnableIPv6.setStatus("current")


class _CyIPv6Method_Type(Integer32):
    """Custom type cyIPv6Method based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_CyIPv6Method_Type.__name__ = "Integer32"
_CyIPv6Method_Object = MibScalar
cyIPv6Method = _CyIPv6Method_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 4, 9),
    _CyIPv6Method_Type()
)
cyIPv6Method.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cyIPv6Method.setStatus("current")


class _CyDHCPv6Opts_Type(Integer32):
    """Custom type cyDHCPv6Opts based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_CyDHCPv6Opts_Type.__name__ = "Integer32"
_CyDHCPv6Opts_Object = MibScalar
cyDHCPv6Opts = _CyDHCPv6Opts_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 4, 10),
    _CyDHCPv6Opts_Type()
)
cyDHCPv6Opts.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cyDHCPv6Opts.setStatus("current")
_CyEthIPaddr6_Type = DisplayString
_CyEthIPaddr6_Object = MibScalar
cyEthIPaddr6 = _CyEthIPaddr6_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 4, 11),
    _CyEthIPaddr6_Type()
)
cyEthIPaddr6.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cyEthIPaddr6.setStatus("current")
_CyEthPrefix6_Type = Integer32
_CyEthPrefix6_Object = MibScalar
cyEthPrefix6 = _CyEthPrefix6_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 4, 12),
    _CyEthPrefix6_Type()
)
cyEthPrefix6.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cyEthPrefix6.setStatus("current")
_CyNameService_ObjectIdentity = ObjectIdentity
cyNameService = _CyNameService_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 5)
)
if mibBuilder.loadTexts:
...
cyDNSserv = _CyDNSserv_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 5, 3)
)
if mibBuilder.loadTexts:
    cyDNSserv.setStatus("current")


class _CyDNSpriserv_Type(DisplayString):
    """Custom type cyDNSpriserv based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CyDNSpriserv_Type.__name__ = "DisplayString"
_CyDNSpriserv_Object = MibScalar
cyDNSpriserv = _CyDNSpriserv_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 5, 3, 1),
    _CyDNSpriserv_Type()
)
...
class _CyDNSsecserv_Type(DisplayString):
    """Custom type cyDNSsecserv based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 46),
    )
...
_CyDNSsecserv_Type.__name__ = "DisplayString"
_CyDNSsecserv_Object = MibScalar
cyDNSsecserv = _CyDNSsecserv_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 5, 3, 2),
    _CyDNSsecserv_Type()
)
...
cyGroupIndex = _CyGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 1, 11, 1, 1),
    _CyGroupIndex_Type()
)
...
cyGroupName = _CyGroupName_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 1, 11, 1, 2),
    _CyGroupName_Type()
)
...
cyGroupUsers = _CyGroupUsers_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 1, 11, 1, 3),
    _CyGroupUsers_Type()
)
...
cySPortNumber = _CySPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 1),
    _CySPortNumber_Type()
)
...
cySPortTty = _CySPortTty_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 2),
    _CySPortTty_Type()
)
...
cySPortName = _CySPortName_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 3),
    _CySPortName_Type()
)
...
cySPortSpeed = _CySPortSpeed_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 4),
    _CySPortSpeed_Type()
)
...
cySPortDataSize = _CySPortDataSize_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 5),
...
cySPortStopBits = _CySPortStopBits_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 6),
...
cySPortParity = _CySPortParity_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 7),
    _CySPortParity_Type()
)
...
cySPortFlowCtrl = _CySPortFlowCtrl_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 8),
...
cySPortDTRdelay = _CySPortDTRdelay_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 9),
...
cySPortDCDCtrl = _CySPortDCDCtrl_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 10),
...
cySPortLogUtmp = _CySPortLogUtmp_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 11),
...
cySPortLogWtmp = _CySPortLogWtmp_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 12),
...
cySPortLogform = _CySPortLogform_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 13),
...
cySPortAuthtype = _CySPortAuthtype_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 14),
...
class _CySPortAuthSrv1_Type(DisplayString):
    """Custom type cySPortAuthSrv1 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 46),
    )
...
class _CySPortAccSrv1_Type(DisplayString):
    """Custom type cySPortAccSrv1 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 46),
    )
...
_CySPortAccSrv1_Type.__name__ = "DisplayString"
_CySPortAccSrv1_Object = MibTableColumn
cySPortAccSrv1 = _CySPortAccSrv1_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 16),
...
cySPortAuthTmo = _CySPortAuthTmo_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 17),
...
cySPortAuthRetr = _CySPortAuthRetr_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 18),
...
class _CySPortAuthSrv2_Type(DisplayString):
    """Custom type cySPortAuthSrv2 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 46),
    )
...
class _CySPortAccSrv2_Type(DisplayString):
    """Custom type cySPortAccSrv2 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 46),
    )
...
_CySPortAccSrv2_Type.__name__ = "DisplayString"
_CySPortAccSrv2_Object = MibTableColumn
cySPortAccSrv2 = _CySPortAccSrv2_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 20),
...
cySPortAuthSecret = _CySPortAuthSecret_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 21),
...
cySPortAuthRadP = _CySPortAuthRadP_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 22),
...
cySPortAuthAcc = _CySPortAuthAcc_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 23),
...
cySPortProtocol = _CySPortProtocol_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 24),
...
cySPortRemoteIP = _CySPortRemoteIP_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 25),
...
cySPortSocketPort = _CySPortSocketPort_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 26),
...
class _CySPortRemHost_Type(DisplayString):
    """Custom type cySPortRemHost based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 46),
    )
...
_CySPortRemHost_Type.__name__ = "DisplayString"
_CySPortRemHost_Object = MibTableColumn
cySPortRemHost = _CySPortRemHost_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 27),
...
cySPortBanner = _CySPortBanner_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 28),
    _CySPortBanner_Type()
)
...
cySPortPrompt = _CySPortPrompt_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 29),
    _CySPortPrompt_Type()
)
...
cySPortTermType = _CySPortTermType_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 30),
...
cySPortAutomUsr = _CySPortAutomUsr_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 31),
...
cySPortNetMask = _CySPortNetMask_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 32),
...
cySPortPppMtu = _CySPortPppMtu_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 33),
    _CySPortPppMtu_Type()
)
...
cySPortPppMru = _CySPortPppMru_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 34),
    _CySPortPppMru_Type()
)
...
cySPortPppOptions = _CySPortPppOptions_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 35),
...
cySPortPppFoption = _CySPortPppFoption_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 36),
...
cySPortModemChat = _CySPortModemChat_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 37),
...
cySPortSttyCmd = _CySPortSttyCmd_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 38),
...
cySPortSockTx = _CySPortSockTx_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 39),
    _CySPortSockTx_Type()
)
...
cySPortSockPoll = _CySPortSockPoll_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 40),
...
cySPortSockIdle = _CySPortSockIdle_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 41),
...
cySPortDBsize = _CySPortDBsize_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 42),
    _CySPortDBsize_Type()
)
...
cySPortDBtime = _CySPortDBtime_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 43),
    _CySPortDBtime_Type()
)
...
cySPortDBmode = _CySPortDBmode_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 44),
    _CySPortDBmode_Type()
)
...
cySPortDBsyslog = _CySPortDBsyslog_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 45),
...
cySPortDBmenu = _CySPortDBmenu_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 46),
    _CySPortDBmenu_Type()
)
...
cySPortDBalarm = _CySPortDBalarm_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 47),
...
cySPortSSHbreak = _CySPortSSHbreak_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 48),
...
cySPortSniffSess = _CySPortSniffSess_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 49),
...
cySPortSniffAdm = _CySPortSniffAdm_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 50),
...
cySPortSniffEsc = _CySPortSniffEsc_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 51),
...
cySPortSniffMsess = _CySPortSniffMsess_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 52),
...
cySPortTelnetMode = _CySPortTelnetMode_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 53),
...
cySPortSysBufSess = _CySPortSysBufSess_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 54),
...
cySPortLFSuppress = _CySPortLFSuppress_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 55),
...
cySPortAutoInput = _CySPortAutoInput_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 56),
...
cySPortAutoOutput = _CySPortAutoOutput_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 57),
...
cySPortPmType = _CySPortPmType_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 58),
    _CySPortPmType_Type()
)
...
cySPortPmUsers = _CySPortPmUsers_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 59),
...
cySPortPmOutlet = _CySPortPmOutlet_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 60),
...
cySPortPmKey = _CySPortPmKey_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 61),
    _CySPortPmKey_Type()
)
...
cySPortPmNOutlets = _CySPortPmNOutlets_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 62),
...
cySPortBreakInterval = _CySPortBreakInterval_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 63),
...
class _CySPortRemoteIP6_Type(DisplayString):
    """Custom type cySPortRemoteIP6 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 46),
    )
...
_CySPortRemoteIP6_Type.__name__ = "DisplayString"
_CySPortRemoteIP6_Object = MibTableColumn
cySPortRemoteIP6 = _CySPortRemoteIP6_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 64),
    _CySPortRemoteIP6_Type()
)
cySPortRemoteIP6.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cySPortRemoteIP6.setStatus("current")


class _CySPortPrefix6_Type(Integer32):
    """Custom type cySPortPrefix6 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CySPortPrefix6_Type.__name__ = "Integer32"
_CySPortPrefix6_Object = MibTableColumn
cySPortPrefix6 = _CySPortPrefix6_Object(
    (1, 3, 6, 1, 4, 1, 2925, 8, 2, 6, 2, 1, 1, 65),
    _CySPortPrefix6_Type()
)
cySPortPrefix6.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cySPortPrefix6.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cyACS5KConf": cyACS5KConf,
       ...
       "cyEnableIPv4": cyEnableIPv4,
       "cyEnableIPv6": cyEnableIPv6,
       "cyIPv6Method": cyIPv6Method,
       "cyDHCPv6Opts": cyDHCPv6Opts,
       "cyEthIPaddr6": cyEthIPaddr6,
       "cyEthPrefix6": cyEthPrefix6,
       ...
       "cySPortRemoteIP6": cySPortRemoteIP6,
       "cySPortPrefix6": cySPortPrefix6}
)
