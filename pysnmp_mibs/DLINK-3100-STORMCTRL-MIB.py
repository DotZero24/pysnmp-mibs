# SNMP MIB module (DLINK-3100-STORMCTRL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-3100-STORMCTRL-MIB
...
class RlSormCtrlActionType(Integer32):
    """Custom type RlSormCtrlActionType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
rlStormCtrlSupport = _RlStormCtrlSupport_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 1),
...
rlStormCtrlMibVersion = _RlStormCtrlMibVersion_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 2),
...
rlStormCtrlRateUnitTypeSupport = _RlStormCtrlRateUnitTypeSupport_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 3),
...
rlStormCtrlTypeSupport = _RlStormCtrlTypeSupport_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 4),
...
rlStormCtrlRateSupportPerType = _RlStormCtrlRateSupportPerType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 5),
...
rlStormCtrlEnbaleDependencyBetweenTypes = _RlStormCtrlEnbaleDependencyBetweenTypes_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 6),
...
rlStormCtrlRateDependencyBetweenTypes = _RlStormCtrlRateDependencyBetweenTypes_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 7),
...
rlStormCtrlRateType = _RlStormCtrlRateType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 1),
...
rlStormCtrlUnknownUnicastEnable = _RlStormCtrlUnknownUnicastEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 2),
...
rlStormCtrlUnknownUnicastRate = _RlStormCtrlUnknownUnicastRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 3),
...
rlStormCtrlUnknownMulticastEnable = _RlStormCtrlUnknownMulticastEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 4),
...
rlStormCtrlUnknownMulticastRate = _RlStormCtrlUnknownMulticastRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 5),
...
rlStormCtrlBroadcastEnable = _RlStormCtrlBroadcastEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 6),
...
rlStormCtrlBroadcastRate = _RlStormCtrlBroadcastRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 7),
...
rlStormCtrlMulticastEnable = _RlStormCtrlMulticastEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 8),
...
rlStormCtrlMulticastRate = _RlStormCtrlMulticastRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 9),
...
rlStormCtrlSetDefaultRateType = _RlStormCtrlSetDefaultRateType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 10),
...
rlStormCtrlSetDefaultUnknownUnicastEnable = _RlStormCtrlSetDefaultUnknownUnicastEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 11),
...
rlStormCtrlSetDefaultUnknownUnicastRate = _RlStormCtrlSetDefaultUnknownUnicastRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 12),
...
rlStormCtrlSetDefaultUnknownMulticastEnable = _RlStormCtrlSetDefaultUnknownMulticastEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 13),
...
rlStormCtrlSetDefaultUnknownMulticastRate = _RlStormCtrlSetDefaultUnknownMulticastRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 14),
...
rlStormCtrlSetDefaultBroadcastEnable = _RlStormCtrlSetDefaultBroadcastEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 15),
...
rlStormCtrlSetDefaultBroadcastRate = _RlStormCtrlSetDefaultBroadcastRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 16),
...
rlStormCtrlSetDefaultMulticastEnable = _RlStormCtrlSetDefaultMulticastEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 17),
...
rlStormCtrlSetDefaultMulticastRate = _RlStormCtrlSetDefaultMulticastRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 18),
...
class _RlStormCtrlSWAction_Type(RlSormCtrlActionType):
    """Custom type rlStormCtrlSWAction based on RlSormCtrlActionType"""
    defaultValue = 1


_RlStormCtrlSWAction_Type.__name__ = "RlSormCtrlActionType"
_RlStormCtrlSWAction_Object = MibTableColumn
rlStormCtrlSWAction = _RlStormCtrlSWAction_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 19),
    _RlStormCtrlSWAction_Type()
)
rlStormCtrlSWAction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlStormCtrlSWAction.setStatus("current")
_RlStormCtrlSWInterval_Type = Unsigned32
_RlStormCtrlSWInterval_Object = MibTableColumn
rlStormCtrlSWInterval = _RlStormCtrlSWInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 8, 1, 20),
    _RlStormCtrlSWInterval_Type()
)
rlStormCtrlSWInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlStormCtrlSWInterval.setStatus("current")
_RlStormCtrlGroupTable_Object = MibTable
rlStormCtrlGroupTable = _RlStormCtrlGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 9)
)
if mibBuilder.loadTexts:
...
rlStormCtrlGroupEntry = _RlStormCtrlGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 9, 1)
)
...
rlStormCtrlGroupUnknownUnicastId = _RlStormCtrlGroupUnknownUnicastId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 9, 1, 1),
...
rlStormCtrlGroupUnknownMulticastId = _RlStormCtrlGroupUnknownMulticastId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 9, 1, 2),
...
rlStormCtrlGroupBroadcastId = _RlStormCtrlGroupBroadcastId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 9, 1, 3),
...
rlStormCtrlGroupMulticastId = _RlStormCtrlGroupMulticastId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 9, 1, 4),
...
rlStormCtrlSWTrapEnabled = _RlStormCtrlSWTrapEnabled_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 77, 10),
    _RlStormCtrlSWTrapEnabled_Type()
)
rlStormCtrlSWTrapEnabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlStormCtrlSWTrapEnabled.setStatus("current")
...
mibBuilder.exportSymbols(
    "DLINK-3100-STORMCTRL-MIB",
    **{"RlStormCtrlRateUnit": RlStormCtrlRateUnit,
       "RlSormCtrlActionType": RlSormCtrlActionType,
       ...
       "rlStormCtrlSWAction": rlStormCtrlSWAction,
       ...
       "rlStormCtrlSWTrapEnabled": rlStormCtrlSWTrapEnabled}
)
