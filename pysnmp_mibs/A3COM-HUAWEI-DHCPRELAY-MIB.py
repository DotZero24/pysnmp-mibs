...
h3cDHCPRMibObject=_H3cDHCPRMibObject_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,58,1))
_H3cDHCPRIfSelectTable_Object=MibTable
h3cDHCPRIfSelectTable=_H3cDHCPRIfSelectTable_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,1))
if mibBuilder.loadTexts:h3cDHCPRIfSelectTable.setStatus(_A)
_H3cDHCPRIfSelectEntry_Object=MibTableRow
h3cDHCPRIfSelectEntry=_H3cDHCPRIfSelectEntry_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,1,1))
...
h3cDHCPRIfSelectRelayMode=_H3cDHCPRIfSelectRelayMode_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,1,1,1),_H3cDHCPRIfSelectRelayMode_Type())
...
h3cDHCPRIpToGroupTable=_H3cDHCPRIpToGroupTable_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,2))
if mibBuilder.loadTexts:h3cDHCPRIpToGroupTable.setStatus(_A)
_H3cDHCPRIpToGroupEntry_Object=MibTableRow
h3cDHCPRIpToGroupEntry=_H3cDHCPRIpToGroupEntry_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,2,1))
...
h3cDHCPRIpToGroupGroupId=_H3cDHCPRIpToGroupGroupId_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,2,1,1),_H3cDHCPRIpToGroupGroupId_Type())
...
h3cDHCPRIpToGroupServerIpType=_H3cDHCPRIpToGroupServerIpType_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,2,1,2),_H3cDHCPRIpToGroupServerIpType_Type())
...
h3cDHCPRIpToGroupServerIp=_H3cDHCPRIpToGroupServerIp_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,2,1,3),_H3cDHCPRIpToGroupServerIp_Type())
...
h3cDHCPRIpToGroupRowStatus=_H3cDHCPRIpToGroupRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,2,1,4),_H3cDHCPRIpToGroupRowStatus_Type())
...
h3cDHCPRIfToGroupTable=_H3cDHCPRIfToGroupTable_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,3))
if mibBuilder.loadTexts:h3cDHCPRIfToGroupTable.setStatus(_A)
_H3cDHCPRIfToGroupEntry_Object=MibTableRow
h3cDHCPRIfToGroupEntry=_H3cDHCPRIfToGroupEntry_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,3,1))
...
h3cDHCPRIfToGroupGroupId=_H3cDHCPRIfToGroupGroupId_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,3,1,1),_H3cDHCPRIfToGroupGroupId_Type())
...
h3cDHCPRIfToGroupRowStatus=_H3cDHCPRIfToGroupRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,3,1,2),_H3cDHCPRIfToGroupRowStatus_Type())
...
h3cDHCPRAddrCheckTable=_H3cDHCPRAddrCheckTable_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,4))
if mibBuilder.loadTexts:h3cDHCPRAddrCheckTable.setStatus(_A)
_H3cDHCPRAddrCheckEntry_Object=MibTableRow
h3cDHCPRAddrCheckEntry=_H3cDHCPRAddrCheckEntry_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,4,1))
...
h3cDHCPRAddrCheckSwitch=_H3cDHCPRAddrCheckSwitch_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,4,1,1),_H3cDHCPRAddrCheckSwitch_Type())
...
h3cDHCPRSecurityTable=_H3cDHCPRSecurityTable_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,5))
if mibBuilder.loadTexts:h3cDHCPRSecurityTable.setStatus(_A)
_H3cDHCPRSecurityEntry_Object=MibTableRow
h3cDHCPRSecurityEntry=_H3cDHCPRSecurityEntry_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,5,1))
...
h3cDHCPRSecurityClientIpAddrType=_H3cDHCPRSecurityClientIpAddrType_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,5,1,1),_H3cDHCPRSecurityClientIpAddrType_Type())
...
h3cDHCPRSecurityClientIpAddr=_H3cDHCPRSecurityClientIpAddr_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,5,1,2),_H3cDHCPRSecurityClientIpAddr_Type())
...
h3cDHCPRSecurityClientMacAddr=_H3cDHCPRSecurityClientMacAddr_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,5,1,3),_H3cDHCPRSecurityClientMacAddr_Type())
...
h3cDHCPRSecurityClientProperty=_H3cDHCPRSecurityClientProperty_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,5,1,4),_H3cDHCPRSecurityClientProperty_Type())
...
h3cDHCPRSecurityClientRowStatus=_H3cDHCPRSecurityClientRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,5,1,5),_H3cDHCPRSecurityClientRowStatus_Type())
...
h3cDHCPRStatisticsGroup=_H3cDHCPRStatisticsGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,58,1,6))
_H3cDHCPRRxClientPktNum_Type=Unsigned32
_H3cDHCPRRxClientPktNum_Object=MibScalar
h3cDHCPRRxClientPktNum=_H3cDHCPRRxClientPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,1),_H3cDHCPRRxClientPktNum_Type())
...
h3cDHCPRTxClientPktNum=_H3cDHCPRTxClientPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,2),_H3cDHCPRTxClientPktNum_Type())
...
h3cDHCPRRxServerPktNum=_H3cDHCPRRxServerPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,3),_H3cDHCPRRxServerPktNum_Type())
...
h3cDHCPRTxServerPktNum=_H3cDHCPRTxServerPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,4),_H3cDHCPRTxServerPktNum_Type())
...
h3cDHCPRDiscoverPktNum=_H3cDHCPRDiscoverPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,5),_H3cDHCPRDiscoverPktNum_Type())
...
h3cDHCPRRequestPktNum=_H3cDHCPRRequestPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,6),_H3cDHCPRRequestPktNum_Type())
...
h3cDHCPRDeclinePktNum=_H3cDHCPRDeclinePktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,7),_H3cDHCPRDeclinePktNum_Type())
...
h3cDHCPRReleasePktNum=_H3cDHCPRReleasePktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,8),_H3cDHCPRReleasePktNum_Type())
...
h3cDHCPRInformPktNum=_H3cDHCPRInformPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,9),_H3cDHCPRInformPktNum_Type())
...
h3cDHCPROfferPktNum=_H3cDHCPROfferPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,10),_H3cDHCPROfferPktNum_Type())
...
h3cDHCPRAckPktNum=_H3cDHCPRAckPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,11),_H3cDHCPRAckPktNum_Type())
...
h3cDHCPRNakPktNum=_H3cDHCPRNakPktNum_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,12),_H3cDHCPRNakPktNum_Type())
...
h3cDHCPRStatisticsReset=_H3cDHCPRStatisticsReset_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,6,13),_H3cDHCPRStatisticsReset_Type())
...
h3cDHCPRCycleGroup=_H3cDHCPRCycleGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,58,1,7))
...
h3cDHCPRCycleStatus=_H3cDHCPRCycleStatus_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,7,1),_H3cDHCPRCycleStatus_Type())
...
h3cDHCPRConfigOption82Group=_H3cDHCPRConfigOption82Group_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,58,1,8))
...
h3cDHCPROption82Switch=_H3cDHCPROption82Switch_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,8,1),_H3cDHCPROption82Switch_Type())
...
h3cDHCPROption82HandleStrategy=_H3cDHCPROption82HandleStrategy_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,8,2),_H3cDHCPROption82HandleStrategy_Type())
...
h3cDHCPRConfigOption82IfTable=_H3cDHCPRConfigOption82IfTable_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,8,3))
if mibBuilder.loadTexts:h3cDHCPRConfigOption82IfTable.setStatus(_A)
_H3cDHCPRConfigOption82IfEntry_Object=MibTableRow
h3cDHCPRConfigOption82IfEntry=_H3cDHCPRConfigOption82IfEntry_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,8,3,1))
...
h3cDHCPROption82IfSwitch=_H3cDHCPROption82IfSwitch_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,8,3,1,1),_H3cDHCPROption82IfSwitch_Type())
...
h3cDHCPROption82IfStrategy=_H3cDHCPROption82IfStrategy_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,8,3,1,2),_H3cDHCPROption82IfStrategy_Type())
...
h3cDHCPROption82IfFormat=_H3cDHCPROption82IfFormat_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,8,3,1,3),_H3cDHCPROption82IfFormat_Type())
...
h3cDHCPROption82IfNodeType=_H3cDHCPROption82IfNodeType_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,8,3,1,4),_H3cDHCPROption82IfNodeType_Type())
...
h3cDHCPROption82IfUsrDefString=_H3cDHCPROption82IfUsrDefString_Object((1,3,6,1,4,1,43,45,1,10,2,58,1,8,3,1,5),_H3cDHCPROption82IfUsrDefString_Type())
