...
ModuleIdentity, Counter64, enterprises, Unsigned32, Gauge32, ObjectIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, iso, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "Unsigned32", "Gauge32", "ObjectIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "iso", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
DisplayString, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TextualConvention")
ucdavis = ModuleIdentity((1, 3, 6, 1, 4, 1, 2021))
ucdavis.setRevisions(('2009-01-19 00:00', '2006-11-22 00:00', '2004-04-07 00:00', '2002-09-05 00:00', '2001-09-20 00:00', '2001-01-17 00:00', '1999-12-09 00:00',))
...
mibBuilder.exportSymbols("UCD-SNMP-MIB", logMatchCounter=logMatchCounter, ssIORawReceived=ssIORawReceived, memBuffer=memBuffer, dskMinimum=dskMinimum, ucdTraps=ucdTraps, dskMinPercent=dskMinPercent, ssCpuRawKernel=ssCpuRawKernel, dskIndex=dskIndex, linux=linux, memAvailReal=memAvailReal, memMinimumSwap=memMinimumSwap, prIndex=prIndex, memSwapError=memSwapError, ssCpuRawSystem=ssCpuRawSystem, logMatchCycle=logMatchCycle, extErrFixCmd=extErrFixCmd, ssIOSent=ssIOSent, memCached=memCached, versionCDate=versionCDate, ssCpuRawWait=ssCpuRawWait, UCDErrorFix=UCDErrorFix, dskPercent=dskPercent, hpux10=hpux10, extOutput=extOutput, prErrMessage=prErrMessage, dskUsed=dskUsed, ssCpuRawUser=ssCpuRawUser, memShared=memShared, ssCpuRawInterrupt=ssCpuRawInterrupt, laErrorFlag=laErrorFlag, fileSize=fileSize, snmperrErrorFlag=snmperrErrorFlag, ssIORawSent=ssIORawSent, ssCpuRawSoftIRQ=ssCpuRawSoftIRQ, logMatchTable=logMatchTable, osf=osf, hpux9=hpux9, extEntry=extEntry, ssRawSwapIn=ssRawSwapIn, logMatchCount=logMatchCount, logMatchErrorFlag=logMatchErrorFlag, dskAvailLow=dskAvailLow, logMatchFilename=logMatchFilename, fileName=fileName, dskUsedLow=dskUsedLow, dskEntry=dskEntry, ucdStart=ucdStart, memAvailSwap=memAvailSwap, memAvailRealTXT=memAvailRealTXT, Float=Float, mrIndex=mrIndex, unknown=unknown, macosx=macosx, logMatchGlobalCount=logMatchGlobalCount, versionConfigureOptions=versionConfigureOptions, memAvailSwapTXT=memAvailSwapTXT, versionUpdateConfig=versionUpdateConfig, win32=win32, freebsd=freebsd, fileEntry=fileEntry, laLoadFloat=laLoadFloat, prMax=prMax, mrEntry=mrEntry, ssCpuIdle=ssCpuIdle, mrTable=mrTable, ssSwapIn=ssSwapIn, prErrFixCmd=prErrFixCmd, logMatchRegExCompilation=logMatchRegExCompilation, dskPercentNode=dskPercentNode, sunos4=sunos4, dskTable=dskTable, dskPath=dskPath, prErrorFlag=prErrorFlag, memUsedSwapTXT=memUsedSwapTXT, aix=aix, memTotalSwapTXT=memTotalSwapTXT, versionDoDebugging=versionDoDebugging, ssIOReceive=ssIOReceive, hpux11=hpux11, dskTotal=dskTotal, versionRestartAgent=versionRestartAgent, laIndex=laIndex, ssSysInterrupts=ssSysInterrupts, logMatchMaxEntries=logMatchMaxEntries, extIndex=extIndex, memSwapErrorMsg=memSwapErrorMsg, logMatchIndex=logMatchIndex, solaris=solaris, snmperrNames=snmperrNames, logMatchName=logMatchName, ssSysContext=ssSysContext, systemStats=systemStats, dskTotalLow=dskTotalLow, bsdi=bsdi, openbsd=openbsd, laTable=laTable, laConfig=laConfig, extCommand=extCommand, PYSNMP_MODULE_ID=ucdavis, logMatchCurrentCount=logMatchCurrentCount, ucdInternal=ucdInternal, memTotalRealTXT=memTotalRealTXT, ssSwapOut=ssSwapOut, ucdavis=ucdavis, extErrFix=extErrFix, laLoad=laLoad, dskAvailHigh=dskAvailHigh, memTotalReal=memTotalReal, logMatchGlobalCounter=logMatchGlobalCounter, laEntry=laEntry, logMatchEntry=logMatchEntry, extResult=extResult, ucdExperimental=ucdExperimental, versionDate=versionDate, ssRawSwapOut=ssRawSwapOut, memIndex=memIndex, memTotalFree=memTotalFree, prNames=prNames, laNames=laNames, ssCpuRawNice=ssCpuRawNice, extNames=extNames, versionIndex=versionIndex, ucdSnmpAgent=ucdSnmpAgent, netbsd1=netbsd1, memory=memory, snmperrErrMessage=snmperrErrMessage, ssErrorName=ssErrorName, ssCpuSystem=ssCpuSystem, prMin=prMin, prErrFix=prErrFix, memTotalSwap=memTotalSwap, ucdShutdown=ucdShutdown, versionClearCache=versionClearCache, UCDErrorFlag=UCDErrorFlag, ssRawContexts=ssRawContexts, fileTable=fileTable, laErrMessage=laErrMessage, fileErrorMsg=fileErrorMsg, fileErrorFlag=fileErrorFlag, laLoadInt=laLoadInt, ssRawInterrupts=ssRawInterrupts, dskDevice=dskDevice, dskUsedHigh=dskUsedHigh, versionTag=versionTag, prCount=prCount, dskTotalHigh=dskTotalHigh, snmperrIndex=snmperrIndex, mrModuleName=mrModuleName, memUsedRealTXT=memUsedRealTXT, ssIndex=ssIndex, prEntry=prEntry, dragonfly=dragonfly, fileMax=fileMax, ultrix=ultrix, logMatchRegEx=logMatchRegEx, prTable=prTable, fileIndex=fileIndex, dskAvail=dskAvail, ssCpuRawIdle=ssCpuRawIdle, snmperrs=snmperrs, versionSavePersistentData=versionSavePersistentData, logMatch=logMatch, versionIdent=versionIdent, logMatchCurrentCounter=logMatchCurrentCounter, memErrorName=memErrorName, dskErrorMsg=dskErrorMsg, irix=irix, dskErrorFlag=dskErrorFlag, version=version, ssCpuUser=ssCpuUser, extTable=extTable)
