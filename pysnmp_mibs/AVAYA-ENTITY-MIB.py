...
entPhysicalIndex, PhysicalIndex, entPhysicalParentRelPos, entPhysicalDescr = mibBuilder.importSymbols("ENTITY-MIB", "entPhysicalIndex", "PhysicalIndex", "entPhysicalParentRelPos", "entPhysicalDescr")
...
mibBuilder.exportSymbols("AVAYA-ENTITY-MIB", avEntFanOk=avEntFanOk, avEntPhyUSBDeviceExceedMaxNumber=avEntPhyUSBDeviceExceedMaxNumber, avEntPhySensorHiWarning=avEntPhySensorHiWarning, avEntPhyChFruInsertion=avEntPhyChFruInsertion, avEnt2500mvPwrFltOk=avEnt2500mvPwrFltOk, avEnt5vPwrFltOk=avEnt5vPwrFltOk, avEntPhyUSBDeviceSpeed=avEntPhyUSBDeviceSpeed, avEntPhyNotificationDefinitions=avEntPhyNotificationDefinitions, avEntPhyChFruRemoval=avEntPhyChFruRemoval, avEntPhyUSBDevicePower=avEntPhyUSBDevicePower, avEntPhyUSBDeviceRemovalOnBackupRestoreOperation=avEntPhyUSBDeviceRemovalOnBackupRestoreOperation, avEntPhySensorHiWarningClear=avEntPhySensorHiWarningClear, avEntPhySensorTable=avEntPhySensorTable, avEntPhySensorEntry=avEntPhySensorEntry, avEntPhySensorHiShutdown=avEntPhySensorHiShutdown, avEnt1800mvPwrFltOk=avEnt1800mvPwrFltOk, avEnt1600mvPwrFlt=avEnt1600mvPwrFlt, avEnt48vPwrFltOk=avEnt48vPwrFltOk, avEnt3300mvPwrFltOk=avEnt3300mvPwrFltOk, avEnt3300mvPwrFlt=avEnt3300mvPwrFlt, avEntPhyUSBDeviceSubClassCode=avEntPhyUSBDeviceSubClassCode, avEntPhyUSBDevicesTable=avEntPhyUSBDevicesTable, avEntPhyUSBMassStorageDeviceFileSystemName=avEntPhyUSBMassStorageDeviceFileSystemName, avEntPhyUSBDevicesTraps=avEntPhyUSBDevicesTraps, avEntPhyChFruEntry=avEntPhyChFruEntry, avEntPhyChFruFault=avEntPhyChFruFault, avEntPhyUSBDevicePowerFailure=avEntPhyUSBDevicePowerFailure, avEntPhyChFruExpansionTestClear=avEntPhyChFruExpansionTestClear, avEntAmbientHiTempFlt=avEntAmbientHiTempFlt, avEnt2500mvPwrFlt=avEnt2500mvPwrFlt, avEntPhyUSBDeviceCurrent=avEntPhyUSBDeviceCurrent, avEntPhyUSBDeviceNotSupported=avEntPhyUSBDeviceNotSupported, avEnt1800mvPwrFlt=avEnt1800mvPwrFlt, avEntAmbientHiTempFltOk=avEntAmbientHiTempFltOk, avEntPhySensorLoWarning=avEntPhySensorLoWarning, avEntAmbientLoTempFltOk=avEntAmbientLoTempFltOk, avEntPhyChFruPsuFltOk=avEntPhyChFruPsuFltOk, avEntPhyChFruGroup=avEntPhyChFruGroup, avEntPhyUSBDeviceVendorId=avEntPhyUSBDeviceVendorId, avEntPhyUSBDeviceClassCode=avEntPhyUSBDeviceClassCode, avEntPhyChFruNotificationGroup=avEntPhyChFruNotificationGroup, avEntPhyUSBMassStorageDevicesEntry=avEntPhyUSBMassStorageDevicesEntry, avEntPhyChFruPsuFlt=avEntPhyChFruPsuFlt, avEntPhyChFruOperStat=avEntPhyChFruOperStat, avEntPhyUSBDevices=avEntPhyUSBDevices, avEntPhyUSBDeviceInsecureRemoval=avEntPhyUSBDeviceInsecureRemoval, avayaEntity=avayaEntity, avEntPhySensorLoWarningClear=avEntPhySensorLoWarningClear, avEnt48vPwrFlt=avEnt48vPwrFlt, avEntPhyUSBFileSystemNotSupported=avEntPhyUSBFileSystemNotSupported, avEntPhyChFruExpansionTestFailure=avEntPhyChFruExpansionTestFailure, avEntPhyChFruNotifications=avEntPhyChFruNotifications, avEntPhyUSBMassStorageDeviceCapacity=avEntPhyUSBMassStorageDeviceCapacity, avEntPhyUSBDeviceUSBSupportVersion=avEntPhyUSBDeviceUSBSupportVersion, AvEntPhyItuPerceivedSeverity=AvEntPhyItuPerceivedSeverity, avEntPhyUSBMassStorageDevicesTable=avEntPhyUSBMassStorageDevicesTable, avEnt5vPwrFlt=avEnt5vPwrFlt, avEntPhySensorLoShutdown=avEntPhySensorLoShutdown, avEnt1600mvPwrFltOk=avEnt1600mvPwrFltOk, avEntPhyUSBMassStorageDeviceFreeMemory=avEntPhyUSBMassStorageDeviceFreeMemory, PYSNMP_MODULE_ID=avayaEntity, avEntPhyUSBDeviceProtocol=avEntPhyUSBDeviceProtocol, avEntAmbientLoTempFlt=avEntAmbientLoTempFlt, avEntPhyProductId=avEntPhyProductId, avEntPhysicalIndex=avEntPhysicalIndex, avEntPhyUSBDevicesEntry=avEntPhyUSBDevicesEntry, avEntTrapsV3separator=avEntTrapsV3separator, avEntPhyUSBMassStorageDeviceFs=avEntPhyUSBMassStorageDeviceFs, avEntPhySeverity=avEntPhySeverity, avEntPhyChFru=avEntPhyChFru, avEntTraps=avEntTraps, avEntPhySensorEventSupportMask=avEntPhySensorEventSupportMask, avEntFanFlt=avEntFanFlt, avEntPhyChFruTable=avEntPhyChFruTable)
