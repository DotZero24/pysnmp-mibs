...
SnpxChassisType, series3000, s3SnmpAgent, SnpxBackplaneType = mibBuilder.importSymbols("SYNOPTICS-ROOT-MIB", "SnpxChassisType", "series3000", "s3SnmpAgent", "SnpxBackplaneType")
...
mibBuilder.exportSymbols("SYNOPTICS-COMMON-MIB", s3000TerminalServer=s3000TerminalServer, s3AgentHexDisplay=s3AgentHexDisplay, s3AgentStatus=s3AgentStatus, s3SlotModuleDescr=s3SlotModuleDescr, s3LocImageMajorVersion=s3LocImageMajorVersion, s3AgentConfigActualSource=s3AgentConfigActualSource, s3LocImageLoadMode=s3LocImageLoadMode, s3AgentEpromSize=s3AgentEpromSize, s3AgentNetMask=s3AgentNetMask, s3AgentSecDefaultGateway=s3AgentSecDefaultGateway, s3CommonBoardPsStatus=s3CommonBoardPsStatus, s3AgentBootServerAddr=s3AgentBootServerAddr, s3AgentBootProtocol=s3AgentBootProtocol, s3AgentTrapRcvrAgeTime=s3AgentTrapRcvrAgeTime, s3CommonBoardId=s3CommonBoardId, s3000TokenRing=s3000TokenRing, s3AgentInitString=s3AgentInitString, s3AgentIpAddr=s3AgentIpAddr, s3ChassisPsType=s3ChassisPsType, s3ChassisBkplRev=s3ChassisBkplRev, s3CommonBoardStatus=s3CommonBoardStatus, s3SlotConfigEntry=s3SlotConfigEntry, s3AgentMdaHwVer=s3AgentMdaHwVer, s3CommonBoardPartTime=s3CommonBoardPartTime, s3CommonBoardEntry=s3CommonBoardEntry, s3AgentTrapRcvrStatus=s3AgentTrapRcvrStatus, s3SlotModuleId=s3SlotModuleId, s3SlotModuleLed=s3SlotModuleLed, s3CommonBoardPartStatus=s3CommonBoardPartStatus, s3AgentTrapReceiverTable=s3AgentTrapReceiverTable, s3RedPsDiodeStatus=s3RedPsDiodeStatus, s3AgentSwMajorVer=s3AgentSwMajorVer, s3CommonBoardHwVer=s3CommonBoardHwVer, s3AgentUnAuthComm=s3AgentUnAuthComm, s3RedPsAmbientTemperature=s3RedPsAmbientTemperature, s3AgentLocation=s3AgentLocation, s3LocImageMaintVersion=s3LocImageMaintVersion, s3AgentBootRouter=s3AgentBootRouter, s3AgentTrapRcvrNetAddress=s3AgentTrapRcvrNetAddress, s3AgentHw=s3AgentHw, s3AgentReset=s3AgentReset, s3AgentFlashStatus=s3AgentFlashStatus, s3AgentDefaultGateway=s3AgentDefaultGateway, s3AgentTrapRcvrComm=s3AgentTrapRcvrComm, s3000RedundantPs=s3000RedundantPs, S3ModuleType=S3ModuleType, s3AgentSpecific=s3AgentSpecific, s3ChassisBkPlEthChanDiv=s3ChassisBkPlEthChanDiv, s3AgentBaudRate=s3AgentBaudRate, s3AgentUnAuthIp=s3AgentUnAuthIp, s3AgentBootFile=s3AgentBootFile, s3CommonBoardIndex=s3CommonBoardIndex, s3SlotModuleType=s3SlotModuleType, s3AgentMibLevel=s3AgentMibLevel, s3RedPsPlus12vCurrent=s3RedPsPlus12vCurrent, s3AgentWriteEeprom=s3AgentWriteEeprom, s3AgentMySlotId=s3AgentMySlotId, s3AgentFwVer=s3AgentFwVer, s3LocImageMinorVersion=s3LocImageMinorVersion, s3AgentSwLicenseCode=s3AgentSwLicenseCode, s3AgentPingDefaultRtrTime=s3AgentPingDefaultRtrTime, s3000LattisTalk=s3000LattisTalk, s3AgentAuthTrap=s3AgentAuthTrap, s3000FDDI=s3000FDDI, s3ChassisFanStatus=s3ChassisFanStatus, s3AgentLocImage=s3AgentLocImage, s3ChassisBkplType=s3ChassisBkplType, s3RedPsAmbientTempStatus=s3RedPsAmbientTempStatus, s3000Ethernet=s3000Ethernet, s3AgentMode=s3AgentMode, s3AgentPerformance=s3AgentPerformance, s3000Bridge=s3000Bridge, s3RedPsPrimaryConfig=s3RedPsPrimaryConfig, s3AgentType=s3AgentType, s3AgentMgmtProtoMode=s3AgentMgmtProtoMode, s3AgentSwMaintVer=s3AgentSwMaintVer, s3SlotModuleMdaId=s3SlotModuleMdaId, s3AgentSw=s3AgentSw, s3RedPsPlus5vCurrent=s3RedPsPlus5vCurrent, s3AgentBootMode=s3AgentBootMode, s3SlotConfigOctetString=s3SlotConfigOctetString, s3CommonBoardNmCntlStatus=s3CommonBoardNmCntlStatus, s3AgentSwMinorVer=s3AgentSwMinorVer, s3ChassisType=s3ChassisType, s3SlotConfigTable=s3SlotConfigTable, s3CommonBoardReset=s3CommonBoardReset, s3AgentFeatureLevel=s3AgentFeatureLevel, s3RedPsPowerAlarm=s3RedPsPowerAlarm, s3ChassisEnetChannelAType=s3ChassisEnetChannelAType, s3AgentNetProtocol=s3AgentNetProtocol, S3PsType=S3PsType, s3RedPsSecondaryConfig=s3RedPsSecondaryConfig, s3AgentIpProtocol=s3AgentIpProtocol, s3ChassisPsStatus=s3ChassisPsStatus, s3AgentActualMgmtProtocol=s3AgentActualMgmtProtocol, s3AgentTrapReceiverEntry=s3AgentTrapReceiverEntry, s3000Trb=s3000Trb, s3SlotNumber=s3SlotNumber, s3AgentPingDefaultRtrSwitch=s3AgentPingDefaultRtrSwitch, s3LocImageActualSource=s3LocImageActualSource, s3CommonBoardTable=s3CommonBoardTable, s3AgentRestart=s3AgentRestart, s3000Chassis=s3000Chassis, s3AgentConfigLoadMode=s3AgentConfigLoadMode, s3AgentEepromSize=s3AgentEepromSize, s3AgentDramSize=s3AgentDramSize, s3AgentImageFile=s3AgentImageFile, s3LocImageValid=s3LocImageValid)
