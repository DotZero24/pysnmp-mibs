...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/nortel/SYNOPTICS-COMMON-MIB
...
SnpxBackplaneType, SnpxChassisType, series3000, s3SnmpAgent = mibBuilder.importSymbols("SYNOPTICS-ROOT-MIB", "SnpxBackplaneType", "SnpxChassisType", "series3000", "s3SnmpAgent")
...
mibBuilder.exportSymbols("SYNOPTICS-COMMON-MIB", s3ChassisBkplType=s3ChassisBkplType, s3AgentFeatureLevel=s3AgentFeatureLevel, s3AgentBootRouter=s3AgentBootRouter, s3AgentImageFile=s3AgentImageFile, s3000Ethernet=s3000Ethernet, s3CommonBoardPartStatus=s3CommonBoardPartStatus, s3AgentTrapRcvrStatus=s3AgentTrapRcvrStatus, s3000FDDI=s3000FDDI, s3AgentAuthTrap=s3AgentAuthTrap, s3AgentBootProtocol=s3AgentBootProtocol, s3AgentHexDisplay=s3AgentHexDisplay, s3CommonBoardTable=s3CommonBoardTable, s3SlotConfigOctetString=s3SlotConfigOctetString, s3000Chassis=s3000Chassis, s3AgentType=s3AgentType, s3AgentPingDefaultRtrTime=s3AgentPingDefaultRtrTime, s3AgentNetProtocol=s3AgentNetProtocol, s3000TerminalServer=s3000TerminalServer, s3ChassisType=s3ChassisType, s3AgentIpProtocol=s3AgentIpProtocol, s3AgentLocImage=s3AgentLocImage, s3AgentSwMinorVer=s3AgentSwMinorVer, s3AgentDefaultGateway=s3AgentDefaultGateway, s3AgentWriteEeprom=s3AgentWriteEeprom, s3AgentSwMaintVer=s3AgentSwMaintVer, s3000TokenRing=s3000TokenRing, s3ChassisEnetChannelAType=s3ChassisEnetChannelAType, s3AgentConfigActualSource=s3AgentConfigActualSource, s3LocImageLoadMode=s3LocImageLoadMode, s3CommonBoardId=s3CommonBoardId, s3SlotConfigEntry=s3SlotConfigEntry, s3RedPsDiodeStatus=s3RedPsDiodeStatus, s3AgentActualMgmtProtocol=s3AgentActualMgmtProtocol, s3AgentTrapReceiverTable=s3AgentTrapReceiverTable, s3AgentMode=s3AgentMode, s3AgentMibLevel=s3AgentMibLevel, s3LocImageValid=s3LocImageValid, s3AgentIpAddr=s3AgentIpAddr, s3RedPsAmbientTemperature=s3RedPsAmbientTemperature, s3AgentBootMode=s3AgentBootMode, s3RedPsPowerAlarm=s3RedPsPowerAlarm, s3AgentMdaHwVer=s3AgentMdaHwVer, s3AgentFwVer=s3AgentFwVer, s3LocImageMinorVersion=s3LocImageMinorVersion, s3AgentStatus=s3AgentStatus, s3AgentSw=s3AgentSw, s3AgentNetMask=s3AgentNetMask, s3AgentDramSize=s3AgentDramSize, s3AgentBootServerAddr=s3AgentBootServerAddr, s3RedPsAmbientTempStatus=s3RedPsAmbientTempStatus, s3AgentSpecific=s3AgentSpecific, s3AgentSwMajorVer=s3AgentSwMajorVer, s3LocImageMajorVersion=s3LocImageMajorVersion, s3RedPsPlus5vCurrent=s3RedPsPlus5vCurrent, s3SlotConfigTable=s3SlotConfigTable, s3CommonBoardHwVer=s3CommonBoardHwVer, s3SlotModuleLed=s3SlotModuleLed, s3AgentTrapReceiverEntry=s3AgentTrapReceiverEntry, s3RedPsSecondaryConfig=s3RedPsSecondaryConfig, s3CommonBoardPartTime=s3CommonBoardPartTime, s3ChassisBkplRev=s3ChassisBkplRev, s3CommonBoardReset=s3CommonBoardReset, s3AgentTrapRcvrComm=s3AgentTrapRcvrComm, s3CommonBoardPsStatus=s3CommonBoardPsStatus, s3AgentHw=s3AgentHw, s3RedPsPlus12vCurrent=s3RedPsPlus12vCurrent, s3CommonBoardNmCntlStatus=s3CommonBoardNmCntlStatus, s3SlotModuleId=s3SlotModuleId, s3000Bridge=s3000Bridge, s3AgentConfigLoadMode=s3AgentConfigLoadMode, s3AgentMySlotId=s3AgentMySlotId, S3ModuleType=S3ModuleType, s3AgentUnAuthIp=s3AgentUnAuthIp, s3000LattisTalk=s3000LattisTalk, s3AgentInitString=s3AgentInitString, s3RedPsPrimaryConfig=s3RedPsPrimaryConfig, s3AgentRestart=s3AgentRestart, s3ChassisPsType=s3ChassisPsType, s3SlotModuleDescr=s3SlotModuleDescr, s3SlotModuleMdaId=s3SlotModuleMdaId, s3AgentBaudRate=s3AgentBaudRate, s3SlotModuleType=s3SlotModuleType, s3AgentTrapRcvrNetAddress=s3AgentTrapRcvrNetAddress, s3AgentEepromSize=s3AgentEepromSize, s3000Trb=s3000Trb, s3AgentPerformance=s3AgentPerformance, s3ChassisBkPlEthChanDiv=s3ChassisBkPlEthChanDiv, s3LocImageActualSource=s3LocImageActualSource, s3ChassisPsStatus=s3ChassisPsStatus, s3CommonBoardEntry=s3CommonBoardEntry, s3AgentLocation=s3AgentLocation, S3PsType=S3PsType, s3AgentSwLicenseCode=s3AgentSwLicenseCode, s3AgentPingDefaultRtrSwitch=s3AgentPingDefaultRtrSwitch, s3CommonBoardStatus=s3CommonBoardStatus, s3AgentEpromSize=s3AgentEpromSize, s3AgentTrapRcvrAgeTime=s3AgentTrapRcvrAgeTime, s3AgentMgmtProtoMode=s3AgentMgmtProtoMode, s3AgentSecDefaultGateway=s3AgentSecDefaultGateway, s3ChassisFanStatus=s3ChassisFanStatus, s3CommonBoardIndex=s3CommonBoardIndex, s3AgentReset=s3AgentReset, s3LocImageMaintVersion=s3LocImageMaintVersion, s3AgentBootFile=s3AgentBootFile, s3AgentUnAuthComm=s3AgentUnAuthComm, s3SlotNumber=s3SlotNumber, s3000RedundantPs=s3000RedundantPs, s3AgentFlashStatus=s3AgentFlashStatus)
