...
rlRouteMapPbrTable=_RlRouteMapPbrTable_Object((1,3,6,1,4,1,89,227,1))
if mibBuilder.loadTexts:rlRouteMapPbrTable.setStatus(_A)
_RlRouteMapPbrEntry_Object=MibTableRow
rlRouteMapPbrEntry=_RlRouteMapPbrEntry_Object((1,3,6,1,4,1,89,227,1,1))
...
rlRouteMapPbrRouteMapName=_RlRouteMapPbrRouteMapName_Object((1,3,6,1,4,1,89,227,1,1,1),_RlRouteMapPbrRouteMapName_Type())
...
rlRouteMapPbrRouteMapSectionId=_RlRouteMapPbrRouteMapSectionId_Object((1,3,6,1,4,1,89,227,1,1,2),_RlRouteMapPbrRouteMapSectionId_Type())
...
rlRouteMapPbrInetType=_RlRouteMapPbrInetType_Object((1,3,6,1,4,1,89,227,1,1,3),_RlRouteMapPbrInetType_Type())
...
rlRouteMapPbrMatchAccessListName=_RlRouteMapPbrMatchAccessListName_Object((1,3,6,1,4,1,89,227,1,1,4),_RlRouteMapPbrMatchAccessListName_Type())
...
rlRouteMapPbrActionNexthopInetAddressType=_RlRouteMapPbrActionNexthopInetAddressType_Object((1,3,6,1,4,1,89,227,1,1,5),_RlRouteMapPbrActionNexthopInetAddressType_Type())
...
rlRouteMapPbrActionNexthopInetAddress=_RlRouteMapPbrActionNexthopInetAddress_Object((1,3,6,1,4,1,89,227,1,1,6),_RlRouteMapPbrActionNexthopInetAddress_Type())
...
rlRouteMapPbrActionNexthopIfIndex=_RlRouteMapPbrActionNexthopIfIndex_Object((1,3,6,1,4,1,89,227,1,1,7),_RlRouteMapPbrActionNexthopIfIndex_Type())
...
rlRouteMapPbrRowStatus=_RlRouteMapPbrRowStatus_Object((1,3,6,1,4,1,89,227,1,1,8),_RlRouteMapPbrRowStatus_Type())
