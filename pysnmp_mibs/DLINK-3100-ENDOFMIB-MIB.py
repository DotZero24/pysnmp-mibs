...
rndEndOfMib=_RndEndOfMib_Object((1,3,6,1,4,1,171,10,94,89,89,1000,1),_RndEndOfMib_Type())
rndEndOfMib.setMaxAccess('read-only')
if mibBuilder.loadTexts:rndEndOfMib.setStatus('current')
mibBuilder.exportSymbols('DLINK-3100-ENDOFMIB-MIB',**{'rndEndOfMibGroup':rndEndOfMibGroup,'rndEndOfMib':rndEndOfMib})