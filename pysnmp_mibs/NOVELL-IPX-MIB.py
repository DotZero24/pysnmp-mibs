# SNMP MIB module (NOVELL-IPX-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/cisco/NOVELL-IPX-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:43:30 2025
...
novellMib = _NovellMib_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 23)
)
...
ipxBasicSysEntry.setIndexNames(
    (0, "NOVELL-IPX-MIB", "ipxBasicSysInstance"),
)
if mibBuilder.loadTexts:
...
ipxAdvSysEntry.setIndexNames(
    (0, "NOVELL-IPX-MIB", "ipxAdvSysInstance"),
)
if mibBuilder.loadTexts:
...
ipxCircEntry.setIndexNames(
    (0, "NOVELL-IPX-MIB", "ipxCircSysInstance"),
    (0, "NOVELL-IPX-MIB", "ipxCircIndex"),
)
if mibBuilder.loadTexts:
...
ipxDestEntry.setIndexNames(
    (0, "NOVELL-IPX-MIB", "ipxDestSysInstance"),
    (0, "NOVELL-IPX-MIB", "ipxDestNetNum"),
)
if mibBuilder.loadTexts:
...
ipxStaticRouteEntry.setIndexNames(
    (0, "NOVELL-IPX-MIB", "ipxStaticRouteSysInstance"),
    (0, "NOVELL-IPX-MIB", "ipxStaticRouteCircIndex"),
    (0, "NOVELL-IPX-MIB", "ipxStaticRouteNetNum"),
)
if mibBuilder.loadTexts:
...
ipxServEntry.setIndexNames(
    (0, "NOVELL-IPX-MIB", "ipxServSysInstance"),
    (0, "NOVELL-IPX-MIB", "ipxServType"),
    (0, "NOVELL-IPX-MIB", "ipxServName"),
)
if mibBuilder.loadTexts:
...
ipxDestServEntry.setIndexNames(
    (0, "NOVELL-IPX-MIB", "ipxDestServSysInstance"),
    (0, "NOVELL-IPX-MIB", "ipxDestServNetNum"),
    (0, "NOVELL-IPX-MIB", "ipxDestServNode"),
    (0, "NOVELL-IPX-MIB", "ipxDestServSocket"),
    (0, "NOVELL-IPX-MIB", "ipxDestServName"),
    (0, "NOVELL-IPX-MIB", "ipxDestServType"),
)
if mibBuilder.loadTexts:
...
ipxStaticServEntry.setIndexNames(
    (0, "NOVELL-IPX-MIB", "ipxStaticServSysInstance"),
    (0, "NOVELL-IPX-MIB", "ipxStaticServCircIndex"),
    (0, "NOVELL-IPX-MIB", "ipxStaticServName"),
    (0, "NOVELL-IPX-MIB", "ipxStaticServType"),
)
if mibBuilder.loadTexts:
...
ipxTrapCircuitDown.setObjects(
      *(("NOVELL-IPX-MIB", "ipxCircSysInstance"),
        ("NOVELL-IPX-MIB", "ipxCircIndex"))
)
if mibBuilder.loadTexts:
