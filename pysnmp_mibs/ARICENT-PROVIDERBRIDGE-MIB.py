# SNMP MIB module (ARICENT-PROVIDERBRIDGE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/siaemic/ARICENT-PROVIDERBRIDGE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:44:14 2025
...
class _FsPbInnerTPID_Type(Integer32):
    """Custom type fsPbInnerTPID based on Integer32"""
    defaultValue = 33024
...
fsPbSrcMacSVlanEntry = _FsPbSrcMacSVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 2, 1)
)
fsPbSrcMacSVlanEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbSrcMacAddress"),
)
if mibBuilder.loadTexts:
...
fsPbDstMacSVlanEntry = _FsPbDstMacSVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 3, 1)
)
fsPbDstMacSVlanEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbDstMacAddress"),
)
if mibBuilder.loadTexts:
...
fsPbCVlanSrcMacSVlanEntry = _FsPbCVlanSrcMacSVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 4, 1)
)
fsPbCVlanSrcMacSVlanEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbCVlanSrcMacCVlan"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbCVlanSrcMacAddr"),
)
if mibBuilder.loadTexts:
...
fsPbCVlanDstMacSVlanEntry = _FsPbCVlanDstMacSVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 5, 1)
)
fsPbCVlanDstMacSVlanEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbCVlanDstMacCVlan"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbCVlanDstMacAddr"),
)
if mibBuilder.loadTexts:
...
fsPbCVlanDscpSVlanEntry = _FsPbCVlanDscpSVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 7, 1)
)
fsPbCVlanDscpSVlanEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbCVlanDscpCVlan"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbCVlanDscp"),
)
if mibBuilder.loadTexts:
...
fsPbSrcIpAddrSVlanEntry = _FsPbSrcIpAddrSVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 8, 1)
)
fsPbSrcIpAddrSVlanEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbSrcIpAddr"),
)
if mibBuilder.loadTexts:
...
fsPbDstIpAddrSVlanEntry = _FsPbDstIpAddrSVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 9, 1)
)
fsPbDstIpAddrSVlanEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbDstIpAddr"),
)
if mibBuilder.loadTexts:
...
fsPbSrcDstIpSVlanEntry = _FsPbSrcDstIpSVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 10, 1)
)
fsPbSrcDstIpSVlanEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbSrcDstSrcIpAddr"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbSrcDstDstIpAddr"),
)
if mibBuilder.loadTexts:
...
fsPbCVlanDstIpSVlanEntry = _FsPbCVlanDstIpSVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 11, 1)
)
fsPbCVlanDstIpSVlanEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbCVlanDstIpCVlan"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbCVlanDstIp"),
)
if mibBuilder.loadTexts:
...
fsPbPortCVlanPriority = _FsPbPortCVlanPriority_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 12, 1, 3),
    _FsPbPortCVlanPriority_Type()
)
fsPbPortCVlanPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPbPortCVlanPriority.setStatus("current")


class _FsPbPortEgressUntaggedStatus_Type(Integer32):
    """Custom type fsPbPortEgressUntaggedStatus based on Integer32"""
    defaultValue = 2
...
_FsPbPortEgressUntaggedStatus_Type.__name__ = "Integer32"
_FsPbPortEgressUntaggedStatus_Object = MibTableColumn
fsPbPortEgressUntaggedStatus = _FsPbPortEgressUntaggedStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 12, 1, 4),
    _FsPbPortEgressUntaggedStatus_Type()
)
fsPbPortEgressUntaggedStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsPbPortEgressUntaggedStatus.setStatus("current")
_FsPbEtherTypeSwapTable_Object = MibTable
fsPbEtherTypeSwapTable = _FsPbEtherTypeSwapTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 13)
)
if mibBuilder.loadTexts:
...
fsPbEtherTypeSwapEntry = _FsPbEtherTypeSwapEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 13, 1)
)
fsPbEtherTypeSwapEntry.setIndexNames(
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbPort"),
    (0, "ARICENT-PROVIDERBRIDGE-MIB", "fsPbLocalEtherType"),
)
if mibBuilder.loadTexts:
...
fsPbTunnelProtocolGmrpPktsSent = _FsPbTunnelProtocolGmrpPktsSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 16, 1, 10),
...
fsPbTunnelProtocolIgmpPktsRecvd = _FsPbTunnelProtocolIgmpPktsRecvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 16, 1, 11),
...
fsPbTunnelProtocolIgmpPktsSent = _FsPbTunnelProtocolIgmpPktsSent_Object(
    (1, 3, 6, 1, 4, 1, 2076, 113, 2, 16, 1, 12),
...
mibBuilder.exportSymbols(
    ...
    **{"TunnelStatus": TunnelStatus,
       ...
       "fsPbPortEgressUntaggedStatus": fsPbPortEgressUntaggedStatus,
