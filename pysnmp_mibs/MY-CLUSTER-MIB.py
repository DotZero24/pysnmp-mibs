# SNMP MIB module (MY-CLUSTER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-CLUSTER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:34:38 2025
...
scMemberEntry.setIndexNames(
    (0, "MY-CLUSTER-MIB", "scMemberMacAddress"),
)
if mibBuilder.loadTexts:
...
scCandidateEntry.setIndexNames(
    (0, "MY-CLUSTER-MIB", "scCandidateMacAddress"),
)
if mibBuilder.loadTexts:
...
myClusterStatusGroup.setObjects(
      *(("MY-CLUSTER-MIB", "scStatusTimeOfLastChange"),
        ("MY-CLUSTER-MIB", "scStatusMaxNumberOfMembers"),
        ("MY-CLUSTER-MIB", "scStatusLastFailureAddMember"))
)
if mibBuilder.loadTexts:
...
myClusterMemberStatusGroup.setObjects(
      *(("MY-CLUSTER-MIB", "scStatusClusterName"),
        ("MY-CLUSTER-MIB", "scStatusClusterMode"),
        ("MY-CLUSTER-MIB", "scStatusClusterStatus"),
        ("MY-CLUSTER-MIB", "scStatusCommanderMacAddress"))
)
if mibBuilder.loadTexts:
...
myClusterMemberGroup.setObjects(
      *(("MY-CLUSTER-MIB", "scMemberOperStatus"),
        ("MY-CLUSTER-MIB", "scMemberNumber"),
        ("MY-CLUSTER-MIB", "scMemberDeviceID"),
        ("MY-CLUSTER-MIB", "scMemberRowStatus"))
)
if mibBuilder.loadTexts:
...
myClusterCandidateGroup.setObjects(
    ("MY-CLUSTER-MIB", "scCandidateMacAddress")
)
if mibBuilder.loadTexts:
...
myClusterCompliance.setObjects(
      *(("MY-CLUSTER-MIB", "myClusterStatusGroup"),
        ("MY-CLUSTER-MIB", "myClusterMemberStatusGroup"),
        ("MY-CLUSTER-MIB", "myClusterMemberGroup"),
        ("MY-CLUSTER-MIB", "myClusterCandidateGroup"))
)
if mibBuilder.loadTexts:
