...
# Notes
# -----
# ASN.1 source file://mibs/nortel/NTN-QOS-POLICY-EXT-PIB
...
_NtnQosIfPriAssignmentStorageType_Type.__name__ = "StorageType"
...
ntnQosPolicyExtPibCompliance.setObjects(
      *(("NTN-QOS-POLICY-EXT-PIB", "ntnQosIfPriAssignmentGroup"),
        ("NTN-QOS-POLICY-EXT-PIB", "ntnQosInterfaceTypeExtGroup"),
        ("NTN-QOS-POLICY-EXT-PIB", "ntnQosIfDscpMappingExtGroup"),
        ("NTN-QOS-POLICY-EXT-PIB", "ntnQosActionExtGroup"),
        ("NTN-QOS-POLICY-EXT-PIB", "ntnQos802FilterExtGroup"))
)
if mibBuilder.loadTexts:
