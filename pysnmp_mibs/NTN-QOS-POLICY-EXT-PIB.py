...
mibBuilder.exportSymbols("NTN-QOS-POLICY-EXT-PIB", ntnQos802FilterExtGroup=ntnQos802FilterExtGroup, ntnQos802FilterProtocol=ntnQos802FilterProtocol, ntnQosInterfaceTypeExtIfClass=ntnQosInterfaceTypeExtIfClass, ntnQosIfPriAssignmentEntry=ntnQosIfPriAssignmentEntry, ntnQosActionExtMirrorFrame=ntnQosActionExtMirrorFrame, ntnQos802FilterVlanIdSet=ntnQos802FilterVlanIdSet, ntnQosActionExtGroup=ntnQosActionExtGroup, ntnQos802FilterDstL4PortMin=ntnQos802FilterDstL4PortMin, ntnQosPolicyExtPibGroups=ntnQosPolicyExtPibGroups, ntnQosIfDscpMappingExtGroup=ntnQosIfDscpMappingExtGroup, ntnQosInterfaceTypeExtEntry=ntnQosInterfaceTypeExtEntry, PYSNMP_MODULE_ID=ntnQosPolicyExtPib, ntnQosActionExtSetDropPrec=ntnQosActionExtSetDropPrec, ntnQosIfPriAssignmentTable=ntnQosIfPriAssignmentTable, ntnQosActionExtMirrorDirection=ntnQosActionExtMirrorDirection, ntnQosIfPriAssignmentStorageType=ntnQosIfPriAssignmentStorageType, ntnQosIfDscpMappingExtDropPrec=ntnQosIfDscpMappingExtDropPrec, ntnQos802FilterExtTable=ntnQos802FilterExtTable, ntnQosPolicyExtPibCompliance=ntnQosPolicyExtPibCompliance, ntnQosInterfaceTypeExtGroup=ntnQosInterfaceTypeExtGroup, ntnQos802FilterDstL4PortMax=ntnQos802FilterDstL4PortMax, ntnQos802FilterExt=ntnQos802FilterExt, ntnQosIfPriAssignmentGroup=ntnQosIfPriAssignmentGroup, ntnQosPolicyExtPibClasses=ntnQosPolicyExtPibClasses, ntnQosActionExtCopyToCpu=ntnQosActionExtCopyToCpu, ntnQosIfDscpMappingExtEntry=ntnQosIfDscpMappingExtEntry, ntnQos802FilterSrcL4PortMin=ntnQos802FilterSrcL4PortMin, ntnQosActionExtTable=ntnQosActionExtTable, ntnQosActionExtEntry=ntnQosActionExtEntry, ntnQosPolicyExtPibConformance=ntnQosPolicyExtPibConformance, ntnQosActionExtUpdatePri=ntnQosActionExtUpdatePri, ntnQosActionExtAssignFlowId=ntnQosActionExtAssignFlowId, ntnQosIfPriAssignmentRoles=ntnQosIfPriAssignmentRoles, ntnQosPolicyExtPibCompliances=ntnQosPolicyExtPibCompliances, DropPrecedence=DropPrecedence, ntnQosPolicyExtPib=ntnQosPolicyExtPib, ntnQosInterfaceTypeExtTable=ntnQosInterfaceTypeExtTable, ntnQosIfPriAssignmentQueue=ntnQosIfPriAssignmentQueue, ntnQosIfParametersExt=ntnQosIfParametersExt, ntnQosActionExt=ntnQosActionExt, ntnQosIfPriAssignmentStatus=ntnQosIfPriAssignmentStatus, ntnQos802FilterDscp=ntnQos802FilterDscp, ntnQos802FilterExtEntry=ntnQos802FilterExtEntry, ntnQosIfPriAssignmentPri=ntnQosIfPriAssignmentPri, ntnQos802FilterSrcL4PortMax=ntnQos802FilterSrcL4PortMax, ntnQosIfDscpMappingExtTable=ntnQosIfDscpMappingExtTable, ntnQosIfPriAssignmentId=ntnQosIfPriAssignmentId)
