...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-GTP-DIRECTOR-MIB
...
_CgdNotifEnable_Type.__name__ = "TruthValue"
...
ciscoGtpDirectorMIBCompliance.setObjects(
      *(("CISCO-GTP-DIRECTOR-MIB", "ciscoGtpDirectorConfigurationsGroup"),
        ("CISCO-GTP-DIRECTOR-MIB", "ciscoGtpDirectorStatusGroup"),
        ("CISCO-GTP-DIRECTOR-MIB", "ciscoGtpDirectorStatisticsGroup"),
        ("CISCO-GTP-DIRECTOR-MIB", "ciscoGtpDirectorNotifMgmtGroup"),
        ("CISCO-GTP-DIRECTOR-MIB", "ciscoGtpDirectorNotifGroup"))
)
if mibBuilder.loadTexts:
