...
mibBuilder.exportSymbols("PPPOE-MGMT-MIB", swPPPoECirIDInsertPortCirID=swPPPoECirIDInsertPortCirID, swPPPoECirIDInsertState=swPPPoECirIDInsertState, swPPPoECirIDInsertPortEntry=swPPPoECirIDInsertPortEntry, swPPPoEMIB=swPPPoEMIB, swPPPoECirIDInsertPortIndex=swPPPoECirIDInsertPortIndex, swPPPoECirIDInsertPortMgmt=swPPPoECirIDInsertPortMgmt, swPPPoECirIDInsertPortTable=swPPPoECirIDInsertPortTable, swPPPoECirIDInsertPortUDFString=swPPPoECirIDInsertPortUDFString, PYSNMP_MODULE_ID=swPPPoEMIB, swPPPoECirIDInsertPortState=swPPPoECirIDInsertPortState, swPPPoEMgmtCtrl=swPPPoEMgmtCtrl)
