...
DBmHundreths, MilliInteger32, DeciInteger32 = mibBuilder.importSymbols("LANCOM-TC", "DBmHundreths", "MilliInteger32", "DeciInteger32")
...
mibBuilder.exportSymbols("LANCOM-BOXSERVICES-PRIVATE-MIB", boxServicesTempSensorIndex=boxServicesTempSensorIndex, boxServicesTempSensorTemperature=boxServicesTempSensorTemperature, boxServicesTempUnitState=boxServicesTempUnitState, boxServicesDiskUtilizationUsedSpaceInPercentage=boxServicesDiskUtilizationUsedSpaceInPercentage, boxsTemperatureChange=boxsTemperatureChange, boxServicesDiskUtilizationEntry=boxServicesDiskUtilizationEntry, boxServicesPowSuppliesTable=boxServicesPowSuppliesTable, boxServicesThermalShutdownTemperature=boxServicesThermalShutdownTemperature, boxServicesFanDutyLevel=boxServicesFanDutyLevel, BoxsTemperatureStatus=BoxsTemperatureStatus, boxsDyingGaspEventChange=boxsDyingGaspEventChange, boxServicesFansEntry=boxServicesFansEntry, boxServicesGroup=boxServicesGroup, boxServicesDiskUtilizationUnitIndex=boxServicesDiskUtilizationUnitIndex, boxServicesTempUnitIndex=boxServicesTempUnitIndex, boxServicesNotificationsGroup=boxServicesNotificationsGroup, fastPathBoxServices=fastPathBoxServices, boxServicesFanStateTrapEnable=boxServicesFanStateTrapEnable, boxServicesFansIndex=boxServicesFansIndex, boxServicesDiskUtilizationTable=boxServicesDiskUtilizationTable, boxServicesUnitIndex=boxServicesUnitIndex, boxServicesTempUnitTable=boxServicesTempUnitTable, boxServicesPowerSuppUnitIndex=boxServicesPowerSuppUnitIndex, boxServicesPowSupplyIndex=boxServicesPowSupplyIndex, boxServicesTemperatureTrapEnable=boxServicesTemperatureTrapEnable, boxServicesPowSupplyItemType=boxServicesPowSupplyItemType, boxsThermalShutdown=boxsThermalShutdown, boxServicesFansTable=boxServicesFansTable, boxServicesPowSuppliesEntry=boxServicesPowSuppliesEntry, boxServicesPowSupplyItemState=boxServicesPowSupplyItemState, boxServicesTempUnitTemperature=boxServicesTempUnitTemperature, boxsTemperatureStateChange=boxsTemperatureStateChange, boxServicesPSMStateTrapEnable=boxServicesPSMStateTrapEnable, boxsItemStateChangeEvent=boxsItemStateChangeEvent, boxServicesFanItemType=boxServicesFanItemType, boxsFanStateChange=boxsFanStateChange, boxServicesDiskUtilizationFreeSpaceKb=boxServicesDiskUtilizationFreeSpaceKb, boxServicesNormalTempRangeMax=boxServicesNormalTempRangeMax, boxServicesFanUnitIndex=boxServicesFanUnitIndex, boxServicesFanItemState=boxServicesFanItemState, boxsTemperatureStatusCurrentEvent=boxsTemperatureStatusCurrentEvent, boxsDyingGaspEventReason=boxsDyingGaspEventReason, boxServicesTempSensorType=boxServicesTempSensorType, boxServicesTempSensorState=boxServicesTempSensorState, boxServicesFanSpeed=boxServicesFanSpeed, boxServicesTempSensorsEntry=boxServicesTempSensorsEntry, boxServicesTempUnitEntry=boxServicesTempUnitEntry, PYSNMP_MODULE_ID=fastPathBoxServices, boxServicesDiskUtilizationUsedSpaceKb=boxServicesDiskUtilizationUsedSpaceKb, boxServicesTempSensorsTable=boxServicesTempSensorsTable, boxsTemperatureChangeEvent=boxsTemperatureChangeEvent, boxServicesThermalShutdownSensor=boxServicesThermalShutdownSensor, boxServicesDiskUtilizationTotalSpaceKb=boxServicesDiskUtilizationTotalSpaceKb, fastPathBoxServicesTraps=fastPathBoxServicesTraps, boxsPowSupplyStateChange=boxsPowSupplyStateChange, boxsTemperatureStatusPreviousEvent=boxsTemperatureStatusPreviousEvent, boxServicesNormalTempRangeMin=boxServicesNormalTempRangeMin)
