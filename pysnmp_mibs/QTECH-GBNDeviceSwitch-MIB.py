# SNMP MIB module (QTECH-GBNDeviceSwitch-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-GBNDeviceSwitch-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:59:42 2025
...
ingressMirrorMac = _IngressMirrorMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 1, 4),
    _IngressMirrorMac_Type()
)
ingressMirrorMac.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ingressMirrorMac.setStatus("current")
_EgressMirrorMac_Type = MacAddress
_EgressMirrorMac_Object = MibScalar
egressMirrorMac = _EgressMirrorMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 1, 5),
    _EgressMirrorMac_Type()
)
egressMirrorMac.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    egressMirrorMac.setStatus("current")
_IngressMirrorMacType_Type = MirrorMacType
_IngressMirrorMacType_Object = MibScalar
ingressMirrorMacType = _IngressMirrorMacType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 1, 6),
    _IngressMirrorMacType_Type()
)
ingressMirrorMacType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ingressMirrorMacType.setStatus("current")
_EgressMirrorMacType_Type = MirrorMacType
_EgressMirrorMacType_Object = MibScalar
egressMirrorMacType = _EgressMirrorMacType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 1, 7),
    _EgressMirrorMacType_Type()
)
egressMirrorMacType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    egressMirrorMacType.setStatus("current")


class _IngressMirrorDivider_Type(Integer32):
    """Custom type ingressMirrorDivider based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_IngressMirrorDivider_Type.__name__ = "Integer32"
_IngressMirrorDivider_Object = MibScalar
ingressMirrorDivider = _IngressMirrorDivider_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 1, 8),
    _IngressMirrorDivider_Type()
)
ingressMirrorDivider.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ingressMirrorDivider.setStatus("current")


class _EgressMirrorDivider_Type(Integer32):
    """Custom type egressMirrorDivider based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1023),
    )
...
_EgressMirrorDivider_Type.__name__ = "Integer32"
_EgressMirrorDivider_Object = MibScalar
egressMirrorDivider = _EgressMirrorDivider_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 1, 9),
    _EgressMirrorDivider_Type()
)
egressMirrorDivider.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    egressMirrorDivider.setStatus("current")
_GbnDeviceSwitchPort_ObjectIdentity = ObjectIdentity
gbnDeviceSwitchPort = _GbnDeviceSwitchPort_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 2)
)
_PortTypeTable_Object = MibTable
portTypeTable = _PortTypeTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 2, 1)
)
if mibBuilder.loadTexts:
    portTypeTable.setStatus("current")
_PortTypeEntry_Object = MibTableRow
portTypeEntry = _PortTypeEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 2, 1, 1)
)
portTypeEntry.setIndexNames(
    (0, "QTECH-GBNDeviceSwitch-MIB", "portNumber"),
)
if mibBuilder.loadTexts:
...
portNumber = _PortNumber_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 2, 1, 1, 1),
    _PortNumber_Type()
)
...
gbnDeviceSwitchAggregation = _GbnDeviceSwitchAggregation_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 3)
)
_AggTable_Object = MibTable
aggTable = _AggTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 3, 1)
)
if mibBuilder.loadTexts:
    aggTable.setStatus("obsolete")
_AggEntry_Object = MibTableRow
aggEntry = _AggEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 3, 1, 1)
)
aggEntry.setIndexNames(
    (0, "QTECH-GBNDeviceSwitch-MIB", "aggUnit"),
    (0, "QTECH-GBNDeviceSwitch-MIB", "aggPort"),
)
if mibBuilder.loadTexts:
...
aggUnit = _AggUnit_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 3, 1, 1, 1),
    _AggUnit_Type()
)
...
aggPort = _AggPort_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 3, 1, 1, 2),
    _AggPort_Type()
)
...
aggPortListPorts = _AggPortListPorts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 3, 1, 1, 3),
...
aggRule = _AggRule_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 3, 1, 1, 4),
    _AggRule_Type()
)
...
aggRowstatus = _AggRowstatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 3, 1, 1, 5),
    _AggRowstatus_Type()
)
...
l3IpAddress = _L3IpAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 4, 1, 1, 1),
    _L3IpAddress_Type()
)
...
l3NextHopMacAddress = _L3NextHopMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 4, 1, 1, 2),
...
l3Vlan = _L3Vlan_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 4, 1, 1, 3),
    _L3Vlan_Type()
)
...
l3Port = _L3Port_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 4, 1, 1, 4),
    _L3Port_Type()
)
...
l3CreateTime = _L3CreateTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 4, 1, 1, 5),
    _L3CreateTime_Type()
)
...
l3UpdateTime = _L3UpdateTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 4, 1, 1, 6),
    _L3UpdateTime_Type()
)
...
portFlowAlarmPort = _PortFlowAlarmPort_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 7, 1, 1, 1),
...
portFlowAlarmEnable = _PortFlowAlarmEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 7, 1, 1, 2),
...
portFlowAlarmExceedStatus = _PortFlowAlarmExceedStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 7, 1, 1, 3),
...
portFlowAlarmExceedThreshold = _PortFlowAlarmExceedThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 7, 1, 1, 4),
...
portFlowAlarmNormalThreshold = _PortFlowAlarmNormalThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 7, 1, 1, 5),
...
qosWrrQueue1Weight = _QosWrrQueue1Weight_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 1),
...
qosWrrQueue2Weight = _QosWrrQueue2Weight_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 2),
...
qosWrrQueue3Weight = _QosWrrQueue3Weight_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 3),
...
qosWrrQueue4Weight = _QosWrrQueue4Weight_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 4),
...
qosWrrMaxDelayValue = _QosWrrMaxDelayValue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 5),
...
qosQueueSchedulerMode = _QosQueueSchedulerMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 6),
...
qosWrrQueue5Weight = _QosWrrQueue5Weight_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 7),
...
qosWrrQueue6Weight = _QosWrrQueue6Weight_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 8),
...
qosWrrQueue7Weight = _QosWrrQueue7Weight_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 9),
...
qosWrrQueue8Weight = _QosWrrQueue8Weight_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 8, 1, 10),
...
qosLineRateInterface = _QosLineRateInterface_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 9, 1, 1, 1),
...
qosLineRateTargetRate = _QosLineRateTargetRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 9, 1, 1, 2),
...
portIsolationDownLinkPorts = _PortIsolationDownLinkPorts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 10, 1, 1),
...
stormControlInterface = _StormControlInterface_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 11, 1, 1, 1),
...
stormControlType = _StormControlType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 11, 1, 1, 2),
...
stormControlTargetRate = _StormControlTargetRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 11, 1, 1, 3),
...
stormControlRowStatus = _StormControlRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 11, 1, 1, 4),
...
gbnDeviceSwitchAntiDos = _GbnDeviceSwitchAntiDos_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 12)
)


class _Ipfragmnetnumber_Type(Integer32):
    """Custom type ipfragmnetnumber based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Ipfragmnetnumber_Type.__name__ = "Integer32"
_Ipfragmnetnumber_Object = MibScalar
ipfragmnetnumber = _Ipfragmnetnumber_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 12, 1),
    _Ipfragmnetnumber_Type()
)
ipfragmnetnumber.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ipfragmnetnumber.setStatus("current")
_IpTTL_Type = TruthValue
_IpTTL_Object = MibScalar
ipTTL = _IpTTL_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 12, 2),
    _IpTTL_Type()
)
ipTTL.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ipTTL.setStatus("current")
_GbnDeviceSwitchBandWidth_ObjectIdentity = ObjectIdentity
gbnDeviceSwitchBandWidth = _GbnDeviceSwitchBandWidth_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 13)
)
_BandwidthcontrolTable_Object = MibTable
bandwidthcontrolTable = _BandwidthcontrolTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 13, 1)
)
if mibBuilder.loadTexts:
...
bandwidthcontrolEntry = _BandwidthcontrolEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 13, 1, 1)
)
bandwidthcontrolEntry.setIndexNames(
    (0, "QTECH-GBNDeviceSwitch-MIB", "controlPort"),
)
if mibBuilder.loadTexts:
...
controlPort = _ControlPort_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 13, 1, 1, 1),
    _ControlPort_Type()
)
controlPort.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
portEgressBandwidthcontrol = _PortEgressBandwidthcontrol_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 13, 1, 1, 2),
...
portIngressBandwidthcontrol = _PortIngressBandwidthcontrol_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 13, 1, 1, 3),
...
portFlowAlarmExceedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 7, 5, 1)
)
portFlowAlarmExceedTrap.setObjects(
    ("QTECH-GBNDeviceSwitch-MIB", "portFlowAlarmPort")
)
if mibBuilder.loadTexts:
...
portFlowAlarmNormalTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 2, 1, 7, 5, 2)
)
...
mibBuilder.exportSymbols(
    ...
    **{"MirrorMacType": MirrorMacType,
       ...
       "ingressMirrorMac": ingressMirrorMac,
       "egressMirrorMac": egressMirrorMac,
       "ingressMirrorMacType": ingressMirrorMacType,
       "egressMirrorMacType": egressMirrorMacType,
       "ingressMirrorDivider": ingressMirrorDivider,
       "egressMirrorDivider": egressMirrorDivider,
       ...
       "gbnDeviceSwitchAntiDos": gbnDeviceSwitchAntiDos,
       "ipfragmnetnumber": ipfragmnetnumber,
       "ipTTL": ipTTL,
