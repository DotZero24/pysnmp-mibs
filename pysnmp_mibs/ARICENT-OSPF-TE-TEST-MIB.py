...
fsOspfTeSas=_FsOspfTeSas_ObjectIdentity((1,3,6,1,4,1,2076,72,20,1))
_FsOspfTeSasTable_ObjectIdentity=ObjectIdentity
fsOspfTeSasTable=_FsOspfTeSasTable_ObjectIdentity((1,3,6,1,4,1,2076,72,20,2))
_FsOspfTeSasConstraintTable_Object=MibTable
fsOspfTeSasConstraintTable=_FsOspfTeSasConstraintTable_Object((1,3,6,1,4,1,2076,72,20,2,1))
if mibBuilder.loadTexts:fsOspfTeSasConstraintTable.setStatus(_A)
_FsOspfTeSasConstraintEntry_Object=MibTableRow
fsOspfTeSasConstraintEntry=_FsOspfTeSasConstraintEntry_Object((1,3,6,1,4,1,2076,72,20,2,1,1))
...
fsOspfTeSasConstraintId=_FsOspfTeSasConstraintId_Object((1,3,6,1,4,1,2076,72,20,2,1,1,1),_FsOspfTeSasConstraintId_Type())
...
fsOspfTeSasConstraintSourceIpAddr=_FsOspfTeSasConstraintSourceIpAddr_Object((1,3,6,1,4,1,2076,72,20,2,1,1,2),_FsOspfTeSasConstraintSourceIpAddr_Type())
...
fsOspfTeSasConstraintDestinationIpAddr=_FsOspfTeSasConstraintDestinationIpAddr_Object((1,3,6,1,4,1,2076,72,20,2,1,1,3),_FsOspfTeSasConstraintDestinationIpAddr_Type())
...
fsOspfTeSasConstraintWPSourceIpAddr=_FsOspfTeSasConstraintWPSourceIpAddr_Object((1,3,6,1,4,1,2076,72,20,2,1,1,4),_FsOspfTeSasConstraintWPSourceIpAddr_Type())
...
fsOspfTeSasConstraintWPDestinationIpAddr=_FsOspfTeSasConstraintWPDestinationIpAddr_Object((1,3,6,1,4,1,2076,72,20,2,1,1,5),_FsOspfTeSasConstraintWPDestinationIpAddr_Type())
...
fsOspfTeSasConstraintMaxPathMetric=_FsOspfTeSasConstraintMaxPathMetric_Object((1,3,6,1,4,1,2076,72,20,2,1,1,6),_FsOspfTeSasConstraintMaxPathMetric_Type())
...
fsOspfTeSasConstraintMaxHopsInPath=_FsOspfTeSasConstraintMaxHopsInPath_Object((1,3,6,1,4,1,2076,72,20,2,1,1,7),_FsOspfTeSasConstraintMaxHopsInPath_Type())
...
fsOspfTeSasConstraintBw=_FsOspfTeSasConstraintBw_Object((1,3,6,1,4,1,2076,72,20,2,1,1,8),_FsOspfTeSasConstraintBw_Type())
...
fsOspfTeSasConstraintIncludeAllSet=_FsOspfTeSasConstraintIncludeAllSet_Object((1,3,6,1,4,1,2076,72,20,2,1,1,9),_FsOspfTeSasConstraintIncludeAllSet_Type())
...
fsOspfTeSasConstraintIncludeAnySet=_FsOspfTeSasConstraintIncludeAnySet_Object((1,3,6,1,4,1,2076,72,20,2,1,1,10),_FsOspfTeSasConstraintIncludeAnySet_Type())
...
fsOspfTeSasConstraintExcludeAnySet=_FsOspfTeSasConstraintExcludeAnySet_Object((1,3,6,1,4,1,2076,72,20,2,1,1,11),_FsOspfTeSasConstraintExcludeAnySet_Type())
...
fsOspfTeSasConstraintPriority=_FsOspfTeSasConstraintPriority_Object((1,3,6,1,4,1,2076,72,20,2,1,1,12),_FsOspfTeSasConstraintPriority_Type())
...
fsOspfTeSasConstraintExplicitRoute=_FsOspfTeSasConstraintExplicitRoute_Object((1,3,6,1,4,1,2076,72,20,2,1,1,13),_FsOspfTeSasConstraintExplicitRoute_Type())
...
fsOspfTeSasConstraintSwitchingCapability=_FsOspfTeSasConstraintSwitchingCapability_Object((1,3,6,1,4,1,2076,72,20,2,1,1,14),_FsOspfTeSasConstraintSwitchingCapability_Type())
...
fsOspfTeSasConstraintEncodingType=_FsOspfTeSasConstraintEncodingType_Object((1,3,6,1,4,1,2076,72,20,2,1,1,15),_FsOspfTeSasConstraintEncodingType_Type())
...
fsOspfTeSasConstraintLinkProtectionType=_FsOspfTeSasConstraintLinkProtectionType_Object((1,3,6,1,4,1,2076,72,20,2,1,1,16),_FsOspfTeSasConstraintLinkProtectionType_Type())
...
fsOspfTeSasConstraintDiversity=_FsOspfTeSasConstraintDiversity_Object((1,3,6,1,4,1,2076,72,20,2,1,1,17),_FsOspfTeSasConstraintDiversity_Type())
...
fsOspfTeSasConstraintIndication=_FsOspfTeSasConstraintIndication_Object((1,3,6,1,4,1,2076,72,20,2,1,1,18),_FsOspfTeSasConstraintIndication_Type())
...
fsOspfTeSasConstraintFlag=_FsOspfTeSasConstraintFlag_Object((1,3,6,1,4,1,2076,72,20,2,1,1,19),_FsOspfTeSasConstraintFlag_Type())
...
fsOspfTeSasConstraintStatus=_FsOspfTeSasConstraintStatus_Object((1,3,6,1,4,1,2076,72,20,2,1,1,20),_FsOspfTeSasConstraintStatus_Type())
...
fsOspfTeSasCspfPathTable=_FsOspfTeSasCspfPathTable_Object((1,3,6,1,4,1,2076,72,20,2,2))
if mibBuilder.loadTexts:fsOspfTeSasCspfPathTable.setStatus(_A)
_FsOspfTeSasCspfPathEntry_Object=MibTableRow
fsOspfTeSasCspfPathEntry=_FsOspfTeSasCspfPathEntry_Object((1,3,6,1,4,1,2076,72,20,2,2,1))
...
fsOspfTeSasCspfPathConstraintId=_FsOspfTeSasCspfPathConstraintId_Object((1,3,6,1,4,1,2076,72,20,2,2,1,1),_FsOspfTeSasCspfPathConstraintId_Type())
...
fsOspfTeSasCspfPathType=_FsOspfTeSasCspfPathType_Object((1,3,6,1,4,1,2076,72,20,2,2,1,2),_FsOspfTeSasCspfPathType_Type())
...
fsOspfTeSasCspfPathNumHops=_FsOspfTeSasCspfPathNumHops_Object((1,3,6,1,4,1,2076,72,20,2,2,1,3),_FsOspfTeSasCspfPathNumHops_Type())
...
fsOspfTeSasCspfPathRouterId=_FsOspfTeSasCspfPathRouterId_Object((1,3,6,1,4,1,2076,72,20,2,2,1,4),_FsOspfTeSasCspfPathRouterId_Type())
...
fsOspfTeSasCspfPathNextHopIpAddress=_FsOspfTeSasCspfPathNextHopIpAddress_Object((1,3,6,1,4,1,2076,72,20,2,2,1,5),_FsOspfTeSasCspfPathNextHopIpAddress_Type())
...
fsOspfTeSasCspfPathLocalIdentifier=_FsOspfTeSasCspfPathLocalIdentifier_Object((1,3,6,1,4,1,2076,72,20,2,2,1,6),_FsOspfTeSasCspfPathLocalIdentifier_Type())
