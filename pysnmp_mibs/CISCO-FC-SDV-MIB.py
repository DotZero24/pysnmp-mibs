...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FC-SDV-MIB
...
_CFcSdvVdVirtDomain_Type.__name__ = "DomainIdOrZero"
...
_CFcSdvVdFcId_Type.__name__ = "FcAddressId"
...
_CFcSdvVdStorageType_Type.__name__ = "StorageType"
...
_CFcSdvVirtRealDeviceIdType_Type.__name__ = "CiscoFcSdvDevIdType"
...
_CFcSdvVirtRealDevMapType_Type.__name__ = "CiscoFcSdvRealDevMapType"
...
_CFcSdvVirtRealDevMapStorageType_Type.__name__ = "StorageType"
...
ciscoFcSdvMIBCompliance.setObjects(
    ("CISCO-FC-SDV-MIB", "ciscoFcSdvConfigGroup")
)
if mibBuilder.loadTexts:
