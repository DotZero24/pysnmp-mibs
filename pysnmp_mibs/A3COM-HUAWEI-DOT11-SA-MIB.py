...
_C='read-only'
_B='A3COM-HUAWEI-DOT11-SA-MIB'
_A='current'
if'mibBuilder'not in globals():import sys;sys.stderr.write(__doc__);sys.exit(1)
Integer,OctetString,ObjectIdentifier=mibBuilder.importSymbols('ASN1','Integer','OctetString','ObjectIdentifier')
NamedValues,=mibBuilder.importSymbols('ASN1-ENUMERATION','NamedValues')
ConstraintsIntersection,ConstraintsUnion,SingleValueConstraint,ValueRangeConstraint,ValueSizeConstraint=mibBuilder.importSymbols('ASN1-REFINEMENT','ConstraintsIntersection','ConstraintsUnion','SingleValueConstraint','ValueRangeConstraint','ValueSizeConstraint')
H3cDot11ChannelScopeType,H3cDot11ObjectIDType,H3cDot11RadioScopeType,H3cDot11SaIntfDevType,h3cDot11=mibBuilder.importSymbols('A3COM-HUAWEI-DOT11-REF-MIB','H3cDot11ChannelScopeType','H3cDot11ObjectIDType','H3cDot11RadioScopeType','H3cDot11SaIntfDevType','h3cDot11')
...
h3cDot11SaCfgGroup=_H3cDot11SaCfgGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,13,1))
_H3cDot11SaCfgTable_Object=MibTable
h3cDot11SaCfgTable=_H3cDot11SaCfgTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1))
if mibBuilder.loadTexts:h3cDot11SaCfgTable.setStatus(_A)
_H3cDot11SaCfgEntry_Object=MibTableRow
h3cDot11SaCfgEntry=_H3cDot11SaCfgEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1))
...
h3cDot11SaCfgRadioType=_H3cDot11SaCfgRadioType_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1,1),_H3cDot11SaCfgRadioType_Type())
...
h3cDot11SaEnable=_H3cDot11SaEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1,2),_H3cDot11SaEnable_Type())
...
h3cDot11SaRptDevType=_H3cDot11SaRptDevType_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1,3),_H3cDot11SaRptDevType_Type())
...
h3cDot11SaTrapDevEnable=_H3cDot11SaTrapDevEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1,4),_H3cDot11SaTrapDevEnable_Type())
...
h3cDot11SaTrapDevType=_H3cDot11SaTrapDevType_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1,5),_H3cDot11SaTrapDevType_Type())
...
h3cDot11SaTrapAQEnable=_H3cDot11SaTrapAQEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1,6),_H3cDot11SaTrapAQEnable_Type())
...
h3cDot11SaTrapAQThreshold=_H3cDot11SaTrapAQThreshold_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1,7),_H3cDot11SaTrapAQThreshold_Type())
...
h3cDot11SaDrivenRRMEnable=_H3cDot11SaDrivenRRMEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1,8),_H3cDot11SaDrivenRRMEnable_Type())
...
h3cDot11SaDrivenRRMSnt=_H3cDot11SaDrivenRRMSnt_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,1,1,1,9),_H3cDot11SaDrivenRRMSnt_Type())
...
h3cDot11SaStatusGroup=_H3cDot11SaStatusGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,13,2))
_H3cDot11SaRtFFTDataTable_Object=MibTable
h3cDot11SaRtFFTDataTable=_H3cDot11SaRtFFTDataTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1))
if mibBuilder.loadTexts:h3cDot11SaRtFFTDataTable.setStatus(_A)
_H3cDot11SaRtFFTDataEntry_Object=MibTableRow
h3cDot11SaRtFFTDataEntry=_H3cDot11SaRtFFTDataEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1,1))
...
h3cDot11SaAPID=_H3cDot11SaAPID_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1,1,1),_H3cDot11SaAPID_Type())
...
h3cDot11SaRadioID=_H3cDot11SaRadioID_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1,1,2),_H3cDot11SaRadioID_Type())
...
h3cDot11SaRtDataGroupID=_H3cDot11SaRtDataGroupID_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1,1,3),_H3cDot11SaRtDataGroupID_Type())
...
h3cDot11SaFrequency=_H3cDot11SaFrequency_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1,1,4),_H3cDot11SaFrequency_Type())
...
h3cDot11SaRtFreqPower=_H3cDot11SaRtFreqPower_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1,1,5),_H3cDot11SaRtFreqPower_Type())
...
h3cDot11SaRtFreqMaxPower=_H3cDot11SaRtFreqMaxPower_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1,1,6),_H3cDot11SaRtFreqMaxPower_Type())
...
h3cDot11SaRtFreqDutyCycle=_H3cDot11SaRtFreqDutyCycle_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1,1,7),_H3cDot11SaRtFreqDutyCycle_Type())
...
h3cDot11SaRtFreqDataSeqNo=_H3cDot11SaRtFreqDataSeqNo_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,1,1,8),_H3cDot11SaRtFreqDataSeqNo_Type())
...
h3cDot11SaIntfDevTable=_H3cDot11SaIntfDevTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,2))
if mibBuilder.loadTexts:h3cDot11SaIntfDevTable.setStatus(_A)
_H3cDot11SaIntfDevEntry_Object=MibTableRow
h3cDot11SaIntfDevEntry=_H3cDot11SaIntfDevEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,2,1))
...
h3cDot11SaDevID=_H3cDot11SaDevID_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,2,1,1),_H3cDot11SaDevID_Type())
...
h3cDot11SaDevType=_H3cDot11SaDevType_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,2,1,2),_H3cDot11SaDevType_Type())
...
h3cDot11SaDevSI=_H3cDot11SaDevSI_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,2,1,3),_H3cDot11SaDevSI_Type())
...
h3cDot11SaDevRSSI=_H3cDot11SaDevRSSI_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,2,1,4),_H3cDot11SaDevRSSI_Type())
...
h3cDot11SaDevDutyCycle=_H3cDot11SaDevDutyCycle_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,2,1,5),_H3cDot11SaDevDutyCycle_Type())
...
h3cDot11SaDevAffectedChls=_H3cDot11SaDevAffectedChls_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,2,1,6),_H3cDot11SaDevAffectedChls_Type())
...
h3cDot11SaDevDetectedTime=_H3cDot11SaDevDetectedTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,2,1,7),_H3cDot11SaDevDetectedTime_Type())
...
h3cDot11SaAirQualityTable=_H3cDot11SaAirQualityTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,3))
if mibBuilder.loadTexts:h3cDot11SaAirQualityTable.setStatus(_A)
_H3cDot11SaAirQualityEntry_Object=MibTableRow
h3cDot11SaAirQualityEntry=_H3cDot11SaAirQualityEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,3,1))
...
h3cDot11SaChlNum=_H3cDot11SaChlNum_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,3,1,1),_H3cDot11SaChlNum_Type())
...
h3cDot11SaAvgQuality=_H3cDot11SaAvgQuality_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,3,1,2),_H3cDot11SaAvgQuality_Type())
...
h3cDot11SaMinQuality=_H3cDot11SaMinQuality_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,3,1,3),_H3cDot11SaMinQuality_Type())
...
h3cDot11SaIntfDevNum=_H3cDot11SaIntfDevNum_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,3,1,4),_H3cDot11SaIntfDevNum_Type())
...
h3cDot11SaWiFiUtil=_H3cDot11SaWiFiUtil_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,3,1,5),_H3cDot11SaWiFiUtil_Type())
...
h3cDot11SaNonWiFiUtil=_H3cDot11SaNonWiFiUtil_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,3,1,6),_H3cDot11SaNonWiFiUtil_Type())
...
h3cDot11SaNoiseFloor=_H3cDot11SaNoiseFloor_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,2,3,1,7),_H3cDot11SaNoiseFloor_Type())
...
h3cDot11SaNotifyGroup=_H3cDot11SaNotifyGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,13,3))
_H3cDot11SaTraps_ObjectIdentity=ObjectIdentity
h3cDot11SaTraps=_H3cDot11SaTraps_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,13,3,0))
_H3cDot11SaTrapVars_ObjectIdentity=ObjectIdentity
h3cDot11SaTrapVars=_H3cDot11SaTrapVars_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1))
_H3cDot11SaTrapAPID_Type=H3cDot11ObjectIDType
_H3cDot11SaTrapAPID_Object=MibScalar
h3cDot11SaTrapAPID=_H3cDot11SaTrapAPID_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,1),_H3cDot11SaTrapAPID_Type())
...
h3cDot11SaTrapRadioID=_H3cDot11SaTrapRadioID_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,2),_H3cDot11SaTrapRadioID_Type())
...
h3cDot11SaTrapDevID=_H3cDot11SaTrapDevID_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,3),_H3cDot11SaTrapDevID_Type())
...
h3cDot11SaTrapIntfDevType=_H3cDot11SaTrapIntfDevType_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,4),_H3cDot11SaTrapIntfDevType_Type())
...
h3cDot11APTrapDevSI=_H3cDot11APTrapDevSI_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,5),_H3cDot11APTrapDevSI_Type())
...
h3cDot11SaTrapDevRSSI=_H3cDot11SaTrapDevRSSI_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,6),_H3cDot11SaTrapDevRSSI_Type())
...
h3cDot11APTrapDevDC=_H3cDot11APTrapDevDC_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,7),_H3cDot11APTrapDevDC_Type())
...
h3cDot11APTrapDevChls=_H3cDot11APTrapDevChls_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,8),_H3cDot11APTrapDevChls_Type())
...
h3cDot11APTrapDevDctTime=_H3cDot11APTrapDevDctTime_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,9),_H3cDot11APTrapDevDctTime_Type())
...
h3cDot11SaTrapChlNum=_H3cDot11SaTrapChlNum_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,10),_H3cDot11SaTrapChlNum_Type())
...
h3cDot11SaTrapChlQlt=_H3cDot11SaTrapChlQlt_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,11),_H3cDot11SaTrapChlQlt_Type())
...
h3cDot11SaTrapChlIntfNum=_H3cDot11SaTrapChlIntfNum_Object((1,3,6,1,4,1,43,45,1,10,2,75,13,3,1,12),_H3cDot11SaTrapChlIntfNum_Type())
h3cDot11SaTrapChlIntfNum.setMaxAccess(_D)
if mibBuilder.loadTexts:h3cDot11SaTrapChlIntfNum.setStatus(_A)
h3cDot11SaIntfDevDetected=NotificationType((1,3,6,1,4,1,43,45,1,10,2,75,13,3,0,1))
...
h3cDot11SaIntfDevDisappear=NotificationType((1,3,6,1,4,1,43,45,1,10,2,75,13,3,0,2))
...
h3cDot11SaChlQltLow=NotificationType((1,3,6,1,4,1,43,45,1,10,2,75,13,3,0,3))
h3cDot11SaChlQltLow.setObjects(*((_B,_G),(_B,_H),(_B,_O),(_B,_P),(_B,_Q)))
if mibBuilder.loadTexts:h3cDot11SaChlQltLow.setStatus(_A)
h3cDot11SaChlQltRecover=NotificationType((1,3,6,1,4,1,43,45,1,10,2,75,13,3,0,4))
