# SNMP MIB module (FS-PTOPO-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/fscom/FS-PTOPO-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:14:48 2025
...
fsPotopoMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33)
)
if mibBuilder.loadTexts:
    fsPotopoMIB.setRevisions(
        ("2003-04-28 00:00",)
    )
...
ptopoConnIndex = _PtopoConnIndex_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 1, 1, 1, 1),
...
ptopoConnLocalDevice = _PtopoConnLocalDevice_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 1, 1, 1, 2),
...
ptopoConnLocalPort = _PtopoConnLocalPort_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 1, 1, 1, 3),
...
ptopoConnRemoteDevice = _PtopoConnRemoteDevice_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 1, 1, 1, 4),
...
ptopoConnRemotePort = _PtopoConnRemotePort_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 1, 1, 1, 5),
...
ptopoDevID = _PtopoDevID_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 2, 1, 1, 1),
    _PtopoDevID_Type()
)
...
ptopoDevHostname = _PtopoDevHostname_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 2, 1, 1, 2),
...
ptopoDevClusStatus = _PtopoDevClusStatus_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 2, 1, 1, 3),
...
ptopoDevClusMode = _PtopoDevClusMode_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 2, 1, 1, 4),
...
ptopoDevClusName = _PtopoDevClusName_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 2, 1, 1, 5),
...
ptopoDevCSMac = _PtopoDevCSMac_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 2, 1, 1, 6),
    _PtopoDevCSMac_Type()
)
...
ptopoDevHopsToCs = _PtopoDevHopsToCs_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 2, 1, 1, 7),
...
ptopoDevLastVerifyTime = _PtopoDevLastVerifyTime_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 2, 1, 1, 8),
...
ptopoConfig = _PtopoConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 3)
)
...
ptopoConfigInterval = _PtopoConfigInterval_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 3, 1),
...
ptopoConfigMaxHoldTime = _PtopoConfigMaxHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 3, 2),
...
ptopoConfigHopCount = _PtopoConfigHopCount_Object(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 1, 3, 3),
...
fsptopoMIBConformance = _FsptopoMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 2)
)
_FsptopoMIBCompliances_ObjectIdentity = ObjectIdentity
fsptopoMIBCompliances = _FsptopoMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 2, 1)
)
_FsptopoMIBGroups_ObjectIdentity = ObjectIdentity
fsptopoMIBGroups = _FsptopoMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 2, 2)
)

# Managed Objects groups

fsptopoMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 2, 2, 1)
)
fsptopoMIBGroup.setObjects(
      *(("FS-PTOPO-MIB", "ptopoConnRemoteDevice"),
        ("FS-PTOPO-MIB", "ptopoConnRemotePort"),
        ("FS-PTOPO-MIB", "ptopoConnIsUpStream"),
        ("FS-PTOPO-MIB", "ptopoDevHostname"),
        ("FS-PTOPO-MIB", "ptopoDevClusStatus"),
        ("FS-PTOPO-MIB", "ptopoDevClusMode"),
        ("FS-PTOPO-MIB", "ptopoDevClusName"),
        ("FS-PTOPO-MIB", "ptopoDevCSMac"),
        ("FS-PTOPO-MIB", "ptopoDevHopsToCs"),
        ("FS-PTOPO-MIB", "ptopoDevLastVerifyTime"),
        ("FS-PTOPO-MIB", "ptopoConfigInterval"),
        ("FS-PTOPO-MIB", "ptopoConfigMaxHoldTime"),
        ("FS-PTOPO-MIB", "ptopoConfigHopCount"))
)
if mibBuilder.loadTexts:
    fsptopoMIBGroup.setStatus("current")
...
fsptopoMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 52642, 1, 1, 10, 2, 33, 2, 1, 1)
)
fsptopoMIBCompliance.setObjects(
    ("FS-PTOPO-MIB", "fsptopoMIBGroup")
)
if mibBuilder.loadTexts:
    fsptopoMIBCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"fsPotopoMIB": fsPotopoMIB,
       ...
       "fsptopoMIBConformance": fsptopoMIBConformance,
       "fsptopoMIBCompliances": fsptopoMIBCompliances,
       "fsptopoMIBCompliance": fsptopoMIBCompliance,
       "fsptopoMIBGroups": fsptopoMIBGroups,
       "fsptopoMIBGroup": fsptopoMIBGroup}
)
