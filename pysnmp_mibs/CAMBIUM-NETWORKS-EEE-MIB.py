...
mibBuilder.exportSymbols("CAMBIUM-NETWORKS-EEE-MIB", PYSNMP_MODULE_ID=cnEeeMib, cnEeeObjects=cnEeeObjects, cnEeeCapabilities=cnEeeCapabilities, cnEeeLpAbilities=cnEeeLpAbilities, cnEeePortTable=cnEeePortTable, cnEeeEnabled=cnEeeEnabled, cnEeePortEntry=cnEeePortEntry, cnEeePortIndex=cnEeePortIndex, cnEeeMib=cnEeeMib)
