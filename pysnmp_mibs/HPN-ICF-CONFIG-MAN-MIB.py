...
mibBuilder.exportSymbols("HPN-ICF-CONFIG-MAN-MIB", hpnicfConfig=hpnicfConfig, hpnicfCfgLogDeletedEntries=hpnicfCfgLogDeletedEntries, hpnicfCfgRunModifiedLast=hpnicfCfgRunModifiedLast, hpnicfCfgOperateResultOpType=hpnicfCfgOperateResultOpType, hpnicfCfgOperateUserName=hpnicfCfgOperateUserName, hpnicfCfgLogDesData=hpnicfCfgLogDesData, ConfigOperationType=ConfigOperationType, hpnicfCfgManNotificationGroup=hpnicfCfgManNotificationGroup, hpnicfCfgLogServerAddress=hpnicfCfgLogServerAddress, hpnicfCfgLogTerminalUser=hpnicfCfgLogTerminalUser, hpnicfCfgLogVirHost=hpnicfCfgLogVirHost, ConfigOperationStateType=ConfigOperationStateType, hpnicfCfgOperateEntry=hpnicfCfgOperateEntry, hpnicfCfgOperateType=hpnicfCfgOperateType, hpnicfCfgLogTable=hpnicfCfgLogTable, hpnicfCfgOperateGlobalEntryLimit=hpnicfCfgOperateGlobalEntryLimit, hpnicfCfgExecuteResultIndex=hpnicfCfgExecuteResultIndex, hpnicfCfgLogCmdSrcAddrRev=hpnicfCfgLogCmdSrcAddrRev, hpnicfCfgOperateEndTime=hpnicfCfgOperateEndTime, hpnicfCfgManEventlog=hpnicfCfgManEventlog, hpnicfCfgExecuteResultOpType=hpnicfCfgExecuteResultOpType, hpnicfCfgOperateRowStatus=hpnicfCfgOperateRowStatus, hpnicfCfgLog=hpnicfCfgLog, hpnicfCfgLogEntry=hpnicfCfgLogEntry, hpnicfCfgExecuteState=hpnicfCfgExecuteState, hpnicfCfgLogSrcData=hpnicfCfgLogSrcData, hpnicfCfgReset2=hpnicfCfgReset2, hpnicfCfgOperateEndNotificationSwitch=hpnicfCfgOperateEndNotificationSwitch, hpnicfCfgOperate=hpnicfCfgOperate, hpnicfCfgOperateSrvAddrType=hpnicfCfgOperateSrvAddrType, hpnicfCfgLogWantBackup=hpnicfCfgLogWantBackup, hpnicfCfgOperateTime=hpnicfCfgOperateTime, hpnicfConfigManNotifications=hpnicfConfigManNotifications, hpnicfCfgInvalidConfigFile=hpnicfCfgInvalidConfigFile, hpnicfCfgLogServerAddrRev=hpnicfCfgLogServerAddrRev, hpnicfCfgReset=hpnicfCfgReset, hpnicfCfgLogTerminalNum=hpnicfCfgLogTerminalNum, hpnicfCfgExecuteOperateResultEntryLimit=hpnicfCfgExecuteOperateResultEntryLimit, hpnicfCfgExecuteResultTable=hpnicfCfgExecuteResultTable, hpnicfCfgOperateCompletion=hpnicfCfgOperateCompletion, hpnicfConfigManGroups=hpnicfConfigManGroups, hpnicfCfgLogUserName=hpnicfCfgLogUserName, hpnicfCfgRunSavedLast=hpnicfCfgRunSavedLast, hpnicfConfigManCompliances=hpnicfConfigManCompliances, hpnicfCfgExecuteEndTime=hpnicfCfgExecuteEndTime, hpnicfConfigManConformance=hpnicfConfigManConformance, hpnicfCfgLogTime=hpnicfCfgLogTime, hpnicfCfgOperateServerAddress=hpnicfCfgOperateServerAddress, hpnicfCfgOperateProtocol=hpnicfCfgOperateProtocol, hpnicfConfigManCompliance=hpnicfConfigManCompliance, hpnicfCfgOperateResultEntry=hpnicfCfgOperateResultEntry, hpnicfCfgExecuteOperate=hpnicfCfgExecuteOperate, hpnicfCfgOperateUserPassword=hpnicfCfgOperateUserPassword, hpnicfCfgLogTerminalType=hpnicfCfgLogTerminalType, hpnicfCfgExecuteResultEntry=hpnicfCfgExecuteResultEntry, hpnicfCfgOperateEntryAgeOutTime=hpnicfCfgOperateEntryAgeOutTime, hpnicfCfgOperateResultIndex=hpnicfCfgOperateResultIndex, hpnicfCfgLogServerAddrVPNName=hpnicfCfgLogServerAddrVPNName, hpnicfCfgOperateIndex=hpnicfCfgOperateIndex, hpnicfCfgOperateSrvVPNName=hpnicfCfgOperateSrvVPNName, hpnicfConfigManObjects=hpnicfConfigManObjects, hpnicfCfgExecuteResultOptIndex=hpnicfCfgExecuteResultOptIndex, hpnicfCfgOperateResultOptIndex=hpnicfCfgOperateResultOptIndex, hpnicfCfgOperateResultTable=hpnicfCfgOperateResultTable, hpnicfCfgLogTerminalLocation=hpnicfCfgLogTerminalLocation, hpnicfCfgFirstTrapTime=hpnicfCfgFirstTrapTime, hpnicfCfgOperateGroup=hpnicfCfgOperateGroup, hpnicfCfgOperateFileName=hpnicfCfgOperateFileName, hpnicfCfgStartModifiedLast=hpnicfCfgStartModifiedLast, hpnicfCfgLogIndex=hpnicfCfgLogIndex, hpnicfCfgLogCmdSrcAddrVPNName=hpnicfCfgLogCmdSrcAddrVPNName, PYSNMP_MODULE_ID=hpnicfConfig, hpnicfCfgLogCmdSrcAddrType=hpnicfCfgLogCmdSrcAddrType, hpnicfCfgLogFile=hpnicfCfgLogFile, hpnicfCfgLogServerAddrType=hpnicfCfgLogServerAddrType, hpnicfCfgLogSrcCmd=hpnicfCfgLogSrcCmd, hpnicfCfgOperateState=hpnicfCfgOperateState, hpnicfCfgOperFailReason=hpnicfCfgOperFailReason, hpnicfCfgExecuteTime=hpnicfCfgExecuteTime, hpnicfCfgLogLimitedEntries=hpnicfCfgLogLimitedEntries, hpnicfCfgOperateTable=hpnicfCfgOperateTable, hpnicfCfgOperateSrvAddrRev=hpnicfCfgOperateSrvAddrRev, hpnicfCfgLogCmdSrcAddress=hpnicfCfgLogCmdSrcAddress, hpnicfCfgOperateServerPort=hpnicfCfgOperateServerPort, hpnicfCfgManLogGroup=hpnicfCfgManLogGroup, hpnicfCfgOperateResultGlobalEntryLimit=hpnicfCfgOperateResultGlobalEntryLimit)
