...
mibBuilder.exportSymbols("ZHONE-PHY-WTN-RADIO-MIB", wtnIduEquipFail=wtnIduEquipFail, wtnChannelSeparation=wtnChannelSeparation, wtnTxLevel=wtnTxLevel, wtnConfigEntry=wtnConfigEntry, zhonePhyWtnRadio=zhonePhyWtnRadio, radioTotalES=radioTotalES, wtnTSSI=wtnTSSI, wtnIduOduLinkFail=wtnIduOduLinkFail, wtnStandbyChannelNumber=wtnStandbyChannelNumber, wtnActiveChannelNumber=wtnActiveChannelNumber, wtnOduLoopback=wtnOduLoopback, wtnTrapsEnable=wtnTrapsEnable, wtnCriticalAlarmStatusLastChange=wtnCriticalAlarmStatusLastChange, wtnIduOutOfLockCritical=wtnIduOutOfLockCritical, radioTotalTable=radioTotalTable, wtnMinorAlarmStatus=wtnMinorAlarmStatus, wtnEbNoAlarm=wtnEbNoAlarm, wtnInfoEntry=wtnInfoEntry, wtnSnapshotEntry=wtnSnapshotEntry, wtnRcvEbNoFloat=wtnRcvEbNoFloat, wtnConfigTable=wtnConfigTable, wtnIduOduCableLength=wtnIduOduCableLength, wtnStandbyTransmitFrequency=wtnStandbyTransmitFrequency, wtnOduTempAlert=wtnOduTempAlert, wtnRxBERThresh=wtnRxBERThresh, wtnOduTemperature=wtnOduTemperature, wtnSnapshotTable=wtnSnapshotTable, wtnMinorAlarmStatusLastChange=wtnMinorAlarmStatusLastChange, wtnRadioAmplifiersEnable=wtnRadioAmplifiersEnable, wtnRssiThresh=wtnRssiThresh, wtnInfoTable=wtnInfoTable, wtnRxBerFloat=wtnRxBerFloat, wtnActiveTransmitFrequency=wtnActiveTransmitFrequency, wtnOduTempAlertCritical=wtnOduTempAlertCritical, wtnTrapCondition=wtnTrapCondition, radioTotalUAS=radioTotalUAS, wtnStatusEntry=wtnStatusEntry, wtnBerAlarm=wtnBerAlarm, wtnStatusTable=wtnStatusTable, wtnMcChannelFailCritical=wtnMcChannelFailCritical, wtnRSSIDeviation=wtnRSSIDeviation, wtnOduIdentifier=wtnOduIdentifier, wtnRSSI=wtnRSSI, wtnIduOutOfLock=wtnIduOutOfLock, wtnOduEquipFail=wtnOduEquipFail, wtnOduMfgCLEICode=wtnOduMfgCLEICode, wtnTraps=wtnTraps, PYSNMP_MODULE_ID=zhonePhyWtnRadio, wtnTrapData=wtnTrapData, wtnReceiveFrequency=wtnReceiveFrequency, wtnAutoChannelSwitchEnable=wtnAutoChannelSwitchEnable, wtnRxBERHysteresisWindow=wtnRxBERHysteresisWindow, wtnCriticalAlarmStatus=wtnCriticalAlarmStatus, wtnOduSerialNumber=wtnOduSerialNumber, wtnOduEquipFailCritical=wtnOduEquipFailCritical, wtnAntennaSize=wtnAntennaSize, radioTotalEntry=radioTotalEntry, wtnIduEquipFailCritical=wtnIduEquipFailCritical, wtnIduOduLinkFailCritical=wtnIduOduLinkFailCritical, wtnMcChannelFail=wtnMcChannelFail, wtnServiceAffected=wtnServiceAffected, wtnRssiHysteresisWindow=wtnRssiHysteresisWindow, wtnRadioIfIndex=wtnRadioIfIndex, radioTotalSES=radioTotalSES)
