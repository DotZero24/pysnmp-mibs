...
# Notes
# -----
# ASN.1 source file://mibs/hp/CPQNIC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:42:50 2025
...
class _CpqNicIfLogMapDHCP_Type(Integer32):
    """Custom type cpqNicIfLogMapDHCP based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqNicIfLogMapDHCP_Type.__name__ = "Integer32"
_CpqNicIfLogMapDHCP_Object = MibTableColumn
cpqNicIfLogMapDHCP = _CpqNicIfLogMapDHCP_Object(
    (1, 3, 6, 1, 4, 1, 232, 18, 2, 2, 1, 1, 22),
    _CpqNicIfLogMapDHCP_Type()
)
cpqNicIfLogMapDHCP.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqNicIfLogMapDHCP.setStatus("mandatory")


class _CpqNicIfLogMapPciLocation_Type(DisplayString):
    """Custom type cpqNicIfLogMapPciLocation based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqNicIfLogMapPciLocation_Type.__name__ = "DisplayString"
_CpqNicIfLogMapPciLocation_Object = MibTableColumn
cpqNicIfLogMapPciLocation = _CpqNicIfLogMapPciLocation_Object(
    (1, 3, 6, 1, 4, 1, 232, 18, 2, 2, 1, 1, 23),
    _CpqNicIfLogMapPciLocation_Type()
)
cpqNicIfLogMapPciLocation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqNicIfLogMapPciLocation.setStatus("optional")
...
cpqNicIfPhysAdapterVirtualPortNumber = _CpqNicIfPhysAdapterVirtualPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 232, 18, 2, 3, 1, 1, 42),
    _CpqNicIfPhysAdapterVirtualPortNumber_Type()
)
cpqNicIfPhysAdapterVirtualPortNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqNicIfPhysAdapterVirtualPortNumber.setStatus("optional")


class _CpqNicIfPhysAdapterPciLocation_Type(DisplayString):
    """Custom type cpqNicIfPhysAdapterPciLocation based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqNicIfPhysAdapterPciLocation_Type.__name__ = "DisplayString"
_CpqNicIfPhysAdapterPciLocation_Object = MibTableColumn
cpqNicIfPhysAdapterPciLocation = _CpqNicIfPhysAdapterPciLocation_Object(
    (1, 3, 6, 1, 4, 1, 232, 18, 2, 3, 1, 1, 43),
    _CpqNicIfPhysAdapterPciLocation_Type()
)
cpqNicIfPhysAdapterPciLocation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqNicIfPhysAdapterPciLocation.setStatus("optional")
...
class _CpqNicFlexLomPhySlot_Type(Integer32):
    """Custom type cpqNicFlexLomPhySlot based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_CpqNicFlexLomPhySlot_Type.__name__ = "Integer32"
_CpqNicFlexLomPhySlot_Object = MibScalar
cpqNicFlexLomPhySlot = _CpqNicFlexLomPhySlot_Object(
    (1, 3, 6, 1, 4, 1, 232, 18, 2, 3, 3),
    _CpqNicFlexLomPhySlot_Type()
)
cpqNicFlexLomPhySlot.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqNicFlexLomPhySlot.setStatus("mandatory")
...
cpqNicAllLinksDown = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 18015)
)
cpqNicAllLinksDown.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQNIC-MIB", "cpqNicIfPhysAdapterSlot"),
        ("CPQSINFO-MIB", "cpqSiServerSystemId"),
...
if mibBuilder.loadTexts:
    cpqNicAllLinksDown.setStatus(
        ""
    )

cpqNicAllLinksDownRepaired = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 18016)
)
cpqNicAllLinksDownRepaired.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQNIC-MIB", "cpqNicIfPhysAdapterSlot"),
        ("CPQSINFO-MIB", "cpqSiServerSystemId"),
...
if mibBuilder.loadTexts:
    cpqNicAllLinksDownRepaired.setStatus(
        ""
    )

cpqNicFlexLomTrainingFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 18017)
)
cpqNicFlexLomTrainingFailed.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQNIC-MIB", "cpqNicFlexLomPhySlot"))
)
if mibBuilder.loadTexts:
    cpqNicFlexLomTrainingFailed.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"cpqNicConnectivityRestored": cpqNicConnectivityRestored,
       ...
       "cpqNicAllLinksDown": cpqNicAllLinksDown,
       "cpqNicAllLinksDownRepaired": cpqNicAllLinksDownRepaired,
       "cpqNicFlexLomTrainingFailed": cpqNicFlexLomTrainingFailed,
       "cpqNic": cpqNic,
       ...
       "cpqNicIfLogMapDHCP": cpqNicIfLogMapDHCP,
       "cpqNicIfLogMapPciLocation": cpqNicIfLogMapPciLocation,
       ...
       "cpqNicIfPhysAdapterVirtualPortNumber": cpqNicIfPhysAdapterVirtualPortNumber,
       "cpqNicIfPhysAdapterPciLocation": cpqNicIfPhysAdapterPciLocation,
       ...
       "cpqNicFlexLomPhySlot": cpqNicFlexLomPhySlot,
