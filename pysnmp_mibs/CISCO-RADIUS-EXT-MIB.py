...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-RADIUS-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:25:44 2025
...
creClientTotalAccessAccepts = _CreClientTotalAccessAccepts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 736, 1, 1, 10),
    _CreClientTotalAccessAccepts_Type()
)
creClientTotalAccessAccepts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    creClientTotalAccessAccepts.setStatus("current")
if mibBuilder.loadTexts:
    creClientTotalAccessAccepts.setUnits("RADIUS packets")
...
creClientGlobalGroup.setObjects(
      *(("CISCO-RADIUS-EXT-MIB", "creClientTotalMaxInQLength"),
        ...
        ("CISCO-RADIUS-EXT-MIB", "creClientTotalAccessAccepts"))
)
if mibBuilder.loadTexts:
...
creMIBCompliance.setObjects(
      *(("CISCO-RADIUS-EXT-MIB", "creClientAuthenenticationGroup"),
        ("CISCO-RADIUS-EXT-MIB", "creClientGlobalGroup"),
        ("CISCO-RADIUS-EXT-MIB", "creClientAccountingGroup"))
)
if mibBuilder.loadTexts:
