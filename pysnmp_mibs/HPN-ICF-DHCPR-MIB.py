...
mibBuilder.exportSymbols("HPN-ICF-DHCPR-MIB", hpnicfDHCPRelayMibObject=hpnicfDHCPRelayMibObject, hpnicfDHCPRRxServerPktNum=hpnicfDHCPRRxServerPktNum, hpnicfDHCPRTxClientPktNum=hpnicfDHCPRTxClientPktNum, PYSNMP_MODULE_ID=hpnicfDHCPRelayMib, hpnicfDHCPRelayReleasePktNum=hpnicfDHCPRelayReleasePktNum, hpnicfDHCPRelayCycleStatus=hpnicfDHCPRelayCycleStatus, hpnicfDHCPRelayOfferPktNum=hpnicfDHCPRelayOfferPktNum, hpnicfDHCPRelayMIBGroups=hpnicfDHCPRelayMIBGroups, hpnicfDHCPRelayMIBGroup=hpnicfDHCPRelayMIBGroup, hpnicfDHCPRTxClientBroPktNum=hpnicfDHCPRTxClientBroPktNum, hpnicfDHCPRelayMIBConformance=hpnicfDHCPRelayMIBConformance, hpnicfDHCPRIPEntry=hpnicfDHCPRIPEntry, hpnicfDHCPRRxBadPktNum=hpnicfDHCPRRxBadPktNum, hpnicfDHCPRelayRequestPktNum=hpnicfDHCPRelayRequestPktNum, hpnicfDHCPRIPTable=hpnicfDHCPRIPTable, hpnicfDHCPRelayStatisticsReset=hpnicfDHCPRelayStatisticsReset, hpnicfDHCPRSeletAllocateModeTable=hpnicfDHCPRSeletAllocateModeTable, hpnicfDHCPRelayDiscoverPktNum=hpnicfDHCPRelayDiscoverPktNum, hpnicfDHCPRelayAckPktNum=hpnicfDHCPRelayAckPktNum, hpnicfDHCPRelayDeclinePktNum=hpnicfDHCPRelayDeclinePktNum, hpnicfDHCPRelayMIBCompliances=hpnicfDHCPRelayMIBCompliances, hpnicfDHCPRSeletAllocateModeEntry=hpnicfDHCPRSeletAllocateModeEntry, hpnicfDHCPRTxServerPktNum=hpnicfDHCPRTxServerPktNum, hpnicfDHCPRIPAddr=hpnicfDHCPRIPAddr, hpnicfDHCPRTxClientUniPktNum=hpnicfDHCPRTxClientUniPktNum, hpnicfDHCPRRxClientPktNum=hpnicfDHCPRRxClientPktNum, hpnicfDHCPRelayNakPktNum=hpnicfDHCPRelayNakPktNum, hpnicfDHCPRIPRowStatus=hpnicfDHCPRIPRowStatus, hpnicfDHCPRelayMib=hpnicfDHCPRelayMib, hpnicfDHCPRelayInformPktNum=hpnicfDHCPRelayInformPktNum, hpnicfDHCPRSelectAllocateMode=hpnicfDHCPRSelectAllocateMode)
