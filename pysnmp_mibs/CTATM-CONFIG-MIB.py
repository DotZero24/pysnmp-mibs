...
mibBuilder.exportSymbols("CTATM-CONFIG-MIB", ctATMTrafficManagementAllocBandwidth=ctATMTrafficManagementAllocBandwidth, ctATMVclTable=ctATMVclTable, ctATMIlmi=ctATMIlmi, ctATMDiscoveryElanPhysIface=ctATMDiscoveryElanPhysIface, ctATMLANEInfoExtTMEntry=ctATMLANEInfoExtTMEntry, ctATMPhyRedundPrimaryRevert=ctATMPhyRedundPrimaryRevert, ctATMIlmiTable=ctATMIlmiTable, ctATMDiscoveryElanName=ctATMDiscoveryElanName, ctATMSignalEntry=ctATMSignalEntry, ctATMIlmiEntry=ctATMIlmiEntry, ctATMPhyRedundPrimaryPort=ctATMPhyRedundPrimaryPort, ctATMPhyRedundPerformTest=ctATMPhyRedundPerformTest, ctATMLecArpMacTable=ctATMLecArpMacTable, ctATMSignalRestart=ctATMSignalRestart, ctATMBaseConfig=ctATMBaseConfig, ctATMDiscoveryElanStatus=ctATMDiscoveryElanStatus, ctATMSignalConfig=ctATMSignalConfig, ctATMLANEInfoExtTMTable=ctATMLANEInfoExtTMTable, ctATMLANEInfoExtStatusUpTime=ctATMLANEInfoExtStatusUpTime, ctATMTrafficServiceCategoriesSupportedEntry=ctATMTrafficServiceCategoriesSupportedEntry, ctATMLANEInfoExtTMIndex=ctATMLANEInfoExtTMIndex, ctATMLANEInfoExtStatusTimeLeft=ctATMLANEInfoExtStatusTimeLeft, ctATMPhyRedundReset=ctATMPhyRedundReset, ctATMIlmiStatus=ctATMIlmiStatus, ctATMLANEInfoExtStatusTable=ctATMLANEInfoExtStatusTable, ctATMPvcBwAllocPhysIface=ctATMPvcBwAllocPhysIface, ctATMVclATMAddress=ctATMVclATMAddress, ctATMPvcBwAllocTable=ctATMPvcBwAllocTable, ctATMPhysicalRedundancyInterface=ctATMPhysicalRedundancyInterface, ctATMDefApplicationTable=ctATMDefApplicationTable, ctATMLecArpMacVci=ctATMLecArpMacVci, ctATMTrafficDescrName=ctATMTrafficDescrName, ctATMLecArpMacVpi=ctATMLecArpMacVpi, ctATMDiscoveryElanTable=ctATMDiscoveryElanTable, ctATMSignalStatus=ctATMSignalStatus, ctATMLANEInfoExtStatusMaxNumQueues=ctATMLANEInfoExtStatusMaxNumQueues, ctATMIlmiIfIndex=ctATMIlmiIfIndex, ctATMPhyRedundTestResult=ctATMPhyRedundTestResult, ctATMDiscoveryElanMode=ctATMDiscoveryElanMode, ctATMLecArpMacATMAddress=ctATMLecArpMacATMAddress, ctATMPvcBwAllocEntry=ctATMPvcBwAllocEntry, ctATMLANEInfoExtStatusNumQueues=ctATMLANEInfoExtStatusNumQueues, ctATMPvcIfDef=ctATMPvcIfDef, ctATMDiscoveryElanEntry=ctATMDiscoveryElanEntry, ctATMVclEntry=ctATMVclEntry, ctATMTrafficManagementGroup=ctATMTrafficManagementGroup, ctATMVclVci=ctATMVclVci, ctATMSignalIfIndex=ctATMSignalIfIndex, ctATMVclEncapsulationType=ctATMVclEncapsulationType, ctATMPhyRedundStatus=ctATMPhyRedundStatus, ctATMSignalType=ctATMSignalType, ctATMFramerStatusEntry=ctATMFramerStatusEntry, ctATMLANEInfoExtTMTrafficDescrIndex=ctATMLANEInfoExtTMTrafficDescrIndex, ctATMVclIfIndex=ctATMVclIfIndex, ctATMPvcBwAllocBandwidth=ctATMPvcBwAllocBandwidth, ctATMPhyRedundTable=ctATMPhyRedundTable, ctATMLecArpMacAddress=ctATMLecArpMacAddress, ctATMIlmiRestart=ctATMIlmiRestart, AtmAddress=AtmAddress, ctATMLANEServices=ctATMLANEServices, ctATMSignalTable=ctATMSignalTable, ctATMLANEInfoExtStatusSendTopo=ctATMLANEInfoExtStatusSendTopo, ctATMLecIfDef=ctATMLecIfDef, ctATMSignalQsaalStatus=ctATMSignalQsaalStatus, ctATMLecArpMacLecIndex=ctATMLecArpMacLecIndex, ctATMDefApplicationEntry=ctATMDefApplicationEntry, ctATMLecArpMacElanName=ctATMLecArpMacElanName, ctATMIlmiState=ctATMIlmiState, ctATMTrafficDescrNameEntry=ctATMTrafficDescrNameEntry, ctATMFramerStatusTable=ctATMFramerStatusTable, ctATMTrafficDescrNameTable=ctATMTrafficDescrNameTable, ctATMFramerStatus=ctATMFramerStatus, ctATMPhysicalRedundancy=ctATMPhysicalRedundancy, ctATMPhyRedundActivePort=ctATMPhyRedundActivePort, ctATMPhyRedundActivation=ctATMPhyRedundActivation, ctATMSignalQ93Status=ctATMSignalQ93Status, ctATMPhyRedundTestTOD=ctATMPhyRedundTestTOD, ctATMPhyRedundIfIndex=ctATMPhyRedundIfIndex, ctATMTrafficServiceCategoriesSupportedBitMask=ctATMTrafficServiceCategoriesSupportedBitMask, ctATMLecArpMacEntry=ctATMLecArpMacEntry, ctATMFramerStatusIfIndex=ctATMFramerStatusIfIndex, ctATMDiscoveryElanIndex=ctATMDiscoveryElanIndex, ctATMPhyRedundEntry=ctATMPhyRedundEntry, ctATMLANEInfoExtGroup=ctATMLANEInfoExtGroup, ctATMVclVirtualIfIndex=ctATMVclVirtualIfIndex, ctATMTrafficServiceCategoriesSupportedTable=ctATMTrafficServiceCategoriesSupportedTable, ctATMLANEInfoExtStatus=ctATMLANEInfoExtStatus, ctATMLANEInfoExtStatusEntry=ctATMLANEInfoExtStatusEntry, ctATMDefApplicationIfIndex=ctATMDefApplicationIfIndex, ctATMVclVpi=ctATMVclVpi, ctATMDefApplication=ctATMDefApplication, ctATMPvcBwAllocStatus=ctATMPvcBwAllocStatus, ctATMIlmiAtmAddress=ctATMIlmiAtmAddress, ctATMVclApplicationPort=ctATMVclApplicationPort)
