...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cabletron/CTATM-CONFIG-MIB
...
atmVclVci, atmVclVpi, atmTrafficDescrParamIndex = mibBuilder.importSymbols("ATM-MIB", "atmVclVci", "atmVclVpi", "atmTrafficDescrParamIndex")
...
mibBuilder.exportSymbols("CTATM-CONFIG-MIB", ctATMSignalEntry=ctATMSignalEntry, ctATMTrafficDescrNameTable=ctATMTrafficDescrNameTable, ctATMLecArpMacVpi=ctATMLecArpMacVpi, ctATMDiscoveryElanTable=ctATMDiscoveryElanTable, ctATMTrafficDescrNameEntry=ctATMTrafficDescrNameEntry, ctATMPhyRedundTestTOD=ctATMPhyRedundTestTOD, ctATMIlmiRestart=ctATMIlmiRestart, ctATMPhyRedundEntry=ctATMPhyRedundEntry, ctATMSignalQ93Status=ctATMSignalQ93Status, ctATMIlmiStatus=ctATMIlmiStatus, ctATMSignalQsaalStatus=ctATMSignalQsaalStatus, ctATMDiscoveryElanMode=ctATMDiscoveryElanMode, ctATMLANEInfoExtStatusUpTime=ctATMLANEInfoExtStatusUpTime, ctATMLANEInfoExtGroup=ctATMLANEInfoExtGroup, ctATMLANEInfoExtStatus=ctATMLANEInfoExtStatus, ctATMDiscoveryElanIndex=ctATMDiscoveryElanIndex, ctATMDiscoveryElanName=ctATMDiscoveryElanName, ctATMPvcBwAllocPhysIface=ctATMPvcBwAllocPhysIface, ctATMDiscoveryElanEntry=ctATMDiscoveryElanEntry, ctATMIlmiState=ctATMIlmiState, ctATMSignalType=ctATMSignalType, ctATMTrafficServiceCategoriesSupportedBitMask=ctATMTrafficServiceCategoriesSupportedBitMask, AtmAddress=AtmAddress, ctATMLANEServices=ctATMLANEServices, ctATMPhysicalRedundancyInterface=ctATMPhysicalRedundancyInterface, ctATMVclApplicationPort=ctATMVclApplicationPort, ctATMFramerStatusTable=ctATMFramerStatusTable, ctATMLANEInfoExtTMTable=ctATMLANEInfoExtTMTable, ctATMBaseConfig=ctATMBaseConfig, ctATMTrafficServiceCategoriesSupportedTable=ctATMTrafficServiceCategoriesSupportedTable, ctATMVclTable=ctATMVclTable, ctATMSignalStatus=ctATMSignalStatus, ctATMIlmiIfIndex=ctATMIlmiIfIndex, ctATMTrafficManagementAllocBandwidth=ctATMTrafficManagementAllocBandwidth, ctATMPhyRedundActivePort=ctATMPhyRedundActivePort, ctATMLecArpMacAddress=ctATMLecArpMacAddress, ctATMSignalConfig=ctATMSignalConfig, ctATMPvcBwAllocTable=ctATMPvcBwAllocTable, ctATMDefApplicationIfIndex=ctATMDefApplicationIfIndex, ctATMDefApplicationEntry=ctATMDefApplicationEntry, ctATMLANEInfoExtStatusMaxNumQueues=ctATMLANEInfoExtStatusMaxNumQueues, ctATMVclVpi=ctATMVclVpi, ctATMPhyRedundPerformTest=ctATMPhyRedundPerformTest, ctATMLecArpMacATMAddress=ctATMLecArpMacATMAddress, ctATMFramerStatusEntry=ctATMFramerStatusEntry, ctATMPhyRedundTable=ctATMPhyRedundTable, ctATMSignalRestart=ctATMSignalRestart, ctATMLANEInfoExtTMEntry=ctATMLANEInfoExtTMEntry, ctATMLecArpMacTable=ctATMLecArpMacTable, ctATMPhyRedundIfIndex=ctATMPhyRedundIfIndex, ctATMPvcBwAllocStatus=ctATMPvcBwAllocStatus, ctATMIlmiTable=ctATMIlmiTable, ctATMIlmi=ctATMIlmi, ctATMIlmiAtmAddress=ctATMIlmiAtmAddress, ctATMTrafficDescrName=ctATMTrafficDescrName, ctATMPhyRedundPrimaryPort=ctATMPhyRedundPrimaryPort, ctATMDefApplication=ctATMDefApplication, ctATMVclEntry=ctATMVclEntry, ctATMFramerStatus=ctATMFramerStatus, ctATMLecArpMacLecIndex=ctATMLecArpMacLecIndex, ctATMPhyRedundActivation=ctATMPhyRedundActivation, ctATMSignalTable=ctATMSignalTable, ctATMVclEncapsulationType=ctATMVclEncapsulationType, ctATMLANEInfoExtStatusSendTopo=ctATMLANEInfoExtStatusSendTopo, ctATMSignalIfIndex=ctATMSignalIfIndex, ctATMLANEInfoExtTMTrafficDescrIndex=ctATMLANEInfoExtTMTrafficDescrIndex, ctATMLecIfDef=ctATMLecIfDef, ctATMPhysicalRedundancy=ctATMPhysicalRedundancy, ctATMLecArpMacEntry=ctATMLecArpMacEntry, ctATMTrafficServiceCategoriesSupportedEntry=ctATMTrafficServiceCategoriesSupportedEntry, ctATMDefApplicationTable=ctATMDefApplicationTable, ctATMLecArpMacElanName=ctATMLecArpMacElanName, ctATMDiscoveryElanPhysIface=ctATMDiscoveryElanPhysIface, ctATMVclVirtualIfIndex=ctATMVclVirtualIfIndex, ctATMLANEInfoExtStatusTimeLeft=ctATMLANEInfoExtStatusTimeLeft, ctATMLANEInfoExtTMIndex=ctATMLANEInfoExtTMIndex, ctATMPvcBwAllocBandwidth=ctATMPvcBwAllocBandwidth, ctATMLANEInfoExtStatusNumQueues=ctATMLANEInfoExtStatusNumQueues, ctATMDiscoveryElanStatus=ctATMDiscoveryElanStatus, ctATMPhyRedundTestResult=ctATMPhyRedundTestResult, ctATMVclIfIndex=ctATMVclIfIndex, ctATMPhyRedundPrimaryRevert=ctATMPhyRedundPrimaryRevert, ctATMLecArpMacVci=ctATMLecArpMacVci, ctATMVclATMAddress=ctATMVclATMAddress, ctATMLANEInfoExtStatusTable=ctATMLANEInfoExtStatusTable, ctATMPhyRedundStatus=ctATMPhyRedundStatus, ctATMTrafficManagementGroup=ctATMTrafficManagementGroup, ctATMLANEInfoExtStatusEntry=ctATMLANEInfoExtStatusEntry, ctATMIlmiEntry=ctATMIlmiEntry, ctATMPvcIfDef=ctATMPvcIfDef, ctATMPhyRedundReset=ctATMPhyRedundReset, ctATMPvcBwAllocEntry=ctATMPvcBwAllocEntry, ctATMFramerStatusIfIndex=ctATMFramerStatusIfIndex, ctATMVclVci=ctATMVclVci)
