...
# Notes
# -----
# ASN.1 source file://mibs/rfc/MSDP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:22:31 2025
...
msdpMIBCompliance.setObjects(
      *(("MSDP-MIB", "msdpMIBGlobalsGroup"),
        ("MSDP-MIB", "msdpMIBPeerGroup"),
        ("MSDP-MIB", "msdpMIBNotificationGroup"),
        ("MSDP-MIB", "msdpMIBEncapsulationGroup"),
        ("MSDP-MIB", "msdpMIBSACacheGroup"),
        ("MSDP-MIB", "msdpMIBRequestsGroup"),
        ("MSDP-MIB", "msdpMIBRPGroup"),
        ("MSDP-MIB", "msdpMIBMeshGroupGroup"))
)
if mibBuilder.loadTexts:
...
msdpMIBFullCompliance.setObjects(
      *(("MSDP-MIB", "msdpMIBGlobalsGroup"),
        ("MSDP-MIB", "msdpMIBPeerGroup2"),
        ("MSDP-MIB", "msdpMIBSACacheGroup"),
        ("MSDP-MIB", "msdpMIBEncapsulationGroup"),
        ("MSDP-MIB", "msdpMIBRPGroup"),
        ("MSDP-MIB", "msdpMIBMeshGroupGroup"))
...
msdpMIBReadOnlyCompliance.setObjects(
      *(("MSDP-MIB", "msdpMIBGlobalsGroup"),
        ("MSDP-MIB", "msdpMIBPeerGroup2"),
        ("MSDP-MIB", "msdpMIBSACacheGroup"),
        ("MSDP-MIB", "msdpMIBEncapsulationGroup"),
