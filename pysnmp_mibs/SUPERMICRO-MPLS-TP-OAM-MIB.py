# SNMP MIB module (SUPERMICRO-MPLS-TP-OAM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-MPLS-TP-OAM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:02:49 2025
...
fsMplsTpMegIndex = _FsMplsTpMegIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 2, 1, 1),
...
fsMplsTpMegName = _FsMplsTpMegName_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 2, 1, 2),
...
fsMplsTpMegOperatorType = _FsMplsTpMegOperatorType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 2, 1, 3),
...
fsMplsTpMegIdIcc = _FsMplsTpMegIdIcc_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 2, 1, 4),
...
fsMplsTpMegIdUmc = _FsMplsTpMegIdUmc_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 2, 1, 5),
...
fsMplsTpMegRowStatus = _FsMplsTpMegRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 2, 1, 8),
...
fsMplsTpMeTable = _FsMplsTpMeTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3)
)
if mibBuilder.loadTexts:
    fsMplsTpMeTable.setStatus("current")
_FsMplsTpMeEntry_Object = MibTableRow
fsMplsTpMeEntry = _FsMplsTpMeEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1)
)
fsMplsTpMeEntry.setIndexNames(
    (0, "SUPERMICRO-MPLS-TP-MIB", "fsMplsTpContextId"),
    (0, "SUPERMICRO-MPLS-TP-OAM-MIB", "fsMplsTpMegIndex"),
    (0, "SUPERMICRO-MPLS-TP-OAM-MIB", "fsMplsTpMeIndex"),
    (0, "SUPERMICRO-MPLS-TP-OAM-MIB", "fsMplsTpMeMpIndex"),
)
if mibBuilder.loadTexts:
...
fsMplsTpMeIndex = _FsMplsTpMeIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 1),
...
fsMplsTpMeMpIndex = _FsMplsTpMeMpIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 2),
...
fsMplsTpMeName = _FsMplsTpMeName_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 3),
...
fsMplsTpMeMpIfIndex = _FsMplsTpMeMpIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 4),
...
fsMplsTpMeSourceMepIndex = _FsMplsTpMeSourceMepIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 5),
...
fsMplsTpMeSinkMepIndex = _FsMplsTpMeSinkMepIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 6),
...
fsMplsTpMeMepDirection = _FsMplsTpMeMepDirection_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 8),
...
fsMplsTpMeProactiveOamSessIndex = _FsMplsTpMeProactiveOamSessIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 9),
...
fsMplsTpMeProactiveOamPhbTCValue = _FsMplsTpMeProactiveOamPhbTCValue_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 10),
...
fsMplsTpMeOnDemandOamPhbTCValue = _FsMplsTpMeOnDemandOamPhbTCValue_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 11),
...
fsMplsTpMeServiceSignaled = _FsMplsTpMeServiceSignaled_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 12),
...
fsMplsTpMeServicePointer = _FsMplsTpMeServicePointer_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 13),
...
fsMplsTpMeRowStatus = _FsMplsTpMeRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 3, 1, 14),
...
fsMplsTpOamContextName = _FsMplsTpOamContextName_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 4),
...
fsMplsTpOamMegSubOperStatus = _FsMplsTpOamMegSubOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 1, 6),
...
fsMplsTpOamConformance = _FsMplsTpOamConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 2)
)
...
fsMplsTpOamDefectCondition = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 13, 9, 0, 1)
)
fsMplsTpOamDefectCondition.setObjects(
      *(("SUPERMICRO-MPLS-TP-OAM-MIB", "fsMplsTpOamContextName"),
        ("SUPERMICRO-MPLS-TP-OAM-MIB", "fsMplsTpMegName"),
        ("SUPERMICRO-MPLS-TP-OAM-MIB", "fsMplsTpMeName"),
        ("SUPERMICRO-MPLS-TP-OAM-MIB", "fsMplsTpOamMegOperStatus"),
        ("SUPERMICRO-MPLS-TP-OAM-MIB", "fsMplsTpOamMegSubOperStatus"))
)
if mibBuilder.loadTexts:
