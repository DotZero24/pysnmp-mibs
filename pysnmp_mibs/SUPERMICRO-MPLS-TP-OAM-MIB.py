...
_G='SUPERMICRO-MPLS-TP-MIB'
_F='Unsigned32'
_E='DisplayString'
_D='Integer32'
_C='SUPERMICRO-MPLS-TP-OAM-MIB'
_B='read-create'
_A='current'
...
fsMplsTpOamMIB=ModuleIdentity((1,3,6,1,4,1,10876,101,1,13,9))
...
fsMplsTpOamNotifications=_FsMplsTpOamNotifications_ObjectIdentity((1,3,6,1,4,1,10876,101,1,13,9,0))
_FsMplsTpOamObjects_ObjectIdentity=ObjectIdentity
fsMplsTpOamObjects=_FsMplsTpOamObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,1,13,9,1))
_FsMplsTpOamScalarObjects_ObjectIdentity=ObjectIdentity
fsMplsTpOamScalarObjects=_FsMplsTpOamScalarObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,1,13,9,1,1))
_FsMplsTpMegTable_Object=MibTable
fsMplsTpMegTable=_FsMplsTpMegTable_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2))
if mibBuilder.loadTexts:fsMplsTpMegTable.setStatus(_A)
_FsMplsTpMegEntry_Object=MibTableRow
fsMplsTpMegEntry=_FsMplsTpMegEntry_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2,1))
...
fsMplsTpMegIndex=_FsMplsTpMegIndex_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2,1,1),_FsMplsTpMegIndex_Type())
...
fsMplsTpMegName=_FsMplsTpMegName_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2,1,2),_FsMplsTpMegName_Type())
...
fsMplsTpMegOperatorType=_FsMplsTpMegOperatorType_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2,1,3),_FsMplsTpMegOperatorType_Type())
...
fsMplsTpMegIdIcc=_FsMplsTpMegIdIcc_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2,1,4),_FsMplsTpMegIdIcc_Type())
...
fsMplsTpMegIdUmc=_FsMplsTpMegIdUmc_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2,1,5),_FsMplsTpMegIdUmc_Type())
...
fsMplsTpMegServiceType=_FsMplsTpMegServiceType_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2,1,6),_FsMplsTpMegServiceType_Type())
...
fsMplsTpMegMpLocation=_FsMplsTpMegMpLocation_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2,1,7),_FsMplsTpMegMpLocation_Type())
...
fsMplsTpMegRowStatus=_FsMplsTpMegRowStatus_Object((1,3,6,1,4,1,10876,101,1,13,9,1,2,1,8),_FsMplsTpMegRowStatus_Type())
...
fsMplsTpMeTable=_FsMplsTpMeTable_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3))
if mibBuilder.loadTexts:fsMplsTpMeTable.setStatus(_A)
_FsMplsTpMeEntry_Object=MibTableRow
fsMplsTpMeEntry=_FsMplsTpMeEntry_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1))
...
fsMplsTpMeIndex=_FsMplsTpMeIndex_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,1),_FsMplsTpMeIndex_Type())
...
fsMplsTpMeMpIndex=_FsMplsTpMeMpIndex_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,2),_FsMplsTpMeMpIndex_Type())
...
fsMplsTpMeName=_FsMplsTpMeName_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,3),_FsMplsTpMeName_Type())
...
fsMplsTpMeMpIfIndex=_FsMplsTpMeMpIfIndex_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,4),_FsMplsTpMeMpIfIndex_Type())
...
fsMplsTpMeSourceMepIndex=_FsMplsTpMeSourceMepIndex_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,5),_FsMplsTpMeSourceMepIndex_Type())
...
fsMplsTpMeSinkMepIndex=_FsMplsTpMeSinkMepIndex_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,6),_FsMplsTpMeSinkMepIndex_Type())
...
fsMplsTpMeMpType=_FsMplsTpMeMpType_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,7),_FsMplsTpMeMpType_Type())
...
fsMplsTpMeMepDirection=_FsMplsTpMeMepDirection_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,8),_FsMplsTpMeMepDirection_Type())
...
fsMplsTpMeProactiveOamSessIndex=_FsMplsTpMeProactiveOamSessIndex_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,9),_FsMplsTpMeProactiveOamSessIndex_Type())
...
fsMplsTpMeProactiveOamPhbTCValue=_FsMplsTpMeProactiveOamPhbTCValue_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,10),_FsMplsTpMeProactiveOamPhbTCValue_Type())
...
fsMplsTpMeOnDemandOamPhbTCValue=_FsMplsTpMeOnDemandOamPhbTCValue_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,11),_FsMplsTpMeOnDemandOamPhbTCValue_Type())
...
fsMplsTpMeServiceSignaled=_FsMplsTpMeServiceSignaled_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,12),_FsMplsTpMeServiceSignaled_Type())
...
fsMplsTpMeServicePointer=_FsMplsTpMeServicePointer_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,13),_FsMplsTpMeServicePointer_Type())
...
fsMplsTpMeRowStatus=_FsMplsTpMeRowStatus_Object((1,3,6,1,4,1,10876,101,1,13,9,1,3,1,14),_FsMplsTpMeRowStatus_Type())
...
fsMplsTpOamContextName=_FsMplsTpOamContextName_Object((1,3,6,1,4,1,10876,101,1,13,9,1,4),_FsMplsTpOamContextName_Type())
...
fsMplsTpOamMegOperStatus=_FsMplsTpOamMegOperStatus_Object((1,3,6,1,4,1,10876,101,1,13,9,1,5),_FsMplsTpOamMegOperStatus_Type())
...
fsMplsTpOamMegSubOperStatus=_FsMplsTpOamMegSubOperStatus_Object((1,3,6,1,4,1,10876,101,1,13,9,1,6),_FsMplsTpOamMegSubOperStatus_Type())
...
fsMplsTpOamConformance=_FsMplsTpOamConformance_ObjectIdentity((1,3,6,1,4,1,10876,101,1,13,9,2))
fsMplsTpOamDefectCondition=NotificationType((1,3,6,1,4,1,10876,101,1,13,9,0,1))
