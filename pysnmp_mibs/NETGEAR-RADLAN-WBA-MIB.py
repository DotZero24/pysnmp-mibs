# SNMP MIB module (NETGEAR-RADLAN-WBA-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-WBA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:50 2025
...
rlWBAAuxiliaryEntry = _RlWBAAuxiliaryEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 230, 1, 1)
)
rlWBAAuxiliaryEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-WBA-MIB", "rlWBAIp"),
)
if mibBuilder.loadTexts:
...
rlWBADataTable = _RlWBADataTable_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 230, 3)
)
if mibBuilder.loadTexts:
    rlWBADataTable.setStatus("current")
_RlWBADataEntry_Object = MibTableRow
rlWBADataEntry = _RlWBADataEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 230, 3, 1)
)
rlWBADataEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-WBA-MIB", "rlWBADataNumber"),
    (0, "NETGEAR-RADLAN-WBA-MIB", "rlWBADataIndex"),
)
if mibBuilder.loadTexts:
...
rlWBAImageInfoEntry = _RlWBAImageInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 230, 4, 1)
)
rlWBAImageInfoEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-WBA-MIB", "rlWBAImageInfoNumber"),
)
if mibBuilder.loadTexts:
