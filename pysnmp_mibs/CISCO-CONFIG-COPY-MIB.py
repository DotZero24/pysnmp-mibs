...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CONFIG-COPY-MIB
...
_CcCopyProtocol_Type.__name__ = "ConfigCopyProtocol"
...
_CcCopyNotificationOnCompletion_Type.__name__ = "TruthValue"
...
ccCopyMIBCompliance.setObjects(
      *(("CISCO-CONFIG-COPY-MIB", "ccCopyGroup"),
        ("CISCO-CONFIG-COPY-MIB", "ccCopyNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
ccCopyMIBComplianceRev1.setObjects(
      *(("CISCO-CONFIG-COPY-MIB", "ccCopyGroupRev1"),
        ("CISCO-CONFIG-COPY-MIB", "ccCopyNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
ccCopyMIBComplianceRev2.setObjects(
      *(("CISCO-CONFIG-COPY-MIB", "ccCopyGroupRev1"),
        ("CISCO-CONFIG-COPY-MIB", "ccCopyNotificationsGroup"),
        ("CISCO-CONFIG-COPY-MIB", "ccCopyErrorGroup"))
)
if mibBuilder.loadTexts:
...
ccCopyMIBComplianceRev3.setObjects(
      *(("CISCO-CONFIG-COPY-MIB", "ccCopyGroupRev1"),
        ("CISCO-CONFIG-COPY-MIB", "ccCopyNotificationsGroup"),
        ("CISCO-CONFIG-COPY-MIB", "ccCopyGroupVpn"),
        ("CISCO-CONFIG-COPY-MIB", "ccCopyErrorGroup"))
)
if mibBuilder.loadTexts:
