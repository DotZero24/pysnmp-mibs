...
mibBuilder.exportSymbols("CISCO-CONFIG-COPY-MIB", ConfigCopyProtocol=ConfigCopyProtocol, ciscoConfigCopyMIBTrapPrefix=ciscoConfigCopyMIBTrapPrefix, ccCopyErrorDeviceIpAddressType=ccCopyErrorDeviceIpAddressType, ConfigCopyState=ConfigCopyState, ccCopyErrorGroup=ccCopyErrorGroup, ccCopyServerAddress=ccCopyServerAddress, ccCopyTimeStarted=ccCopyTimeStarted, ccCopyUserName=ccCopyUserName, ccCopyMIBComplianceRev1=ccCopyMIBComplianceRev1, ccCopyMIBComplianceRev3=ccCopyMIBComplianceRev3, ConfigFileType=ConfigFileType, ccCopyErrorTable=ccCopyErrorTable, ccCopyServerAddressRev1=ccCopyServerAddressRev1, ccCopyGroupRev1=ccCopyGroupRev1, ccCopyErrorDeviceIpAddress=ccCopyErrorDeviceIpAddress, ccCopyTable=ccCopyTable, ccCopySourceFileType=ccCopySourceFileType, ciscoConfigCopyMIBConformance=ciscoConfigCopyMIBConformance, ccCopyCompletion=ccCopyCompletion, ccCopyErrorDescription=ccCopyErrorDescription, ccCopyTimeCompleted=ccCopyTimeCompleted, ccCopyUserPassword=ccCopyUserPassword, ciscoConfigCopyMIBObjects=ciscoConfigCopyMIBObjects, ccCopyProtocol=ccCopyProtocol, ccCopyNotificationsGroup=ccCopyNotificationsGroup, ccCopyErrorIndex=ccCopyErrorIndex, ccCopyGroup=ccCopyGroup, ccCopy=ccCopy, ccCopyMIBCompliance=ccCopyMIBCompliance, ConfigCopyFailCause=ConfigCopyFailCause, ccCopyErrorDeviceWWN=ccCopyErrorDeviceWWN, ccCopyState=ccCopyState, ccCopyDestFileType=ccCopyDestFileType, ccCopyGroupVpn=ccCopyGroupVpn, ciscoConfigCopyMIB=ciscoConfigCopyMIB, PYSNMP_MODULE_ID=ciscoConfigCopyMIB, ccCopyEntry=ccCopyEntry, ccCopyMIBTraps=ccCopyMIBTraps, ccCopyVrfName=ccCopyVrfName, ccCopyNotificationOnCompletion=ccCopyNotificationOnCompletion, ccCopyErrorEntry=ccCopyErrorEntry, ccCopyServerAddressType=ccCopyServerAddressType, ccCopyEntryRowStatus=ccCopyEntryRowStatus, ccCopyFileName=ccCopyFileName, ccCopyFailCause=ccCopyFailCause, ccCopyMIBCompliances=ccCopyMIBCompliances, ccCopyMIBGroups=ccCopyMIBGroups, ccCopyIndex=ccCopyIndex, ccCopyMIBComplianceRev2=ccCopyMIBComplianceRev2)
