...
mibBuilder.exportSymbols("SQUID-MIB", cacheFqdnEntries=cacheFqdnEntries, cacheProtoClientHttpRequests=cacheProtoClientHttpRequests, cachePeerIndex=cachePeerIndex, PYSNMP_MODULE_ID=squid, cacheProtoAggregateStats=cacheProtoAggregateStats, cacheClientHttpHits=cacheClientHttpHits, cacheClientAddress=cacheClientAddress, cacheAdmin=cacheAdmin, cacheCurrentResFileDescrCnt=cacheCurrentResFileDescrCnt, cachePeerTable=cachePeerTable, cacheClientHttpRequests=cacheClientHttpRequests, cacheVersionId=cacheVersionId, cacheHttpOutKb=cacheHttpOutKb, CachePeerTableIndex=CachePeerTableIndex, cacheUniqName=cacheUniqName, cacheServerOutKb=cacheServerOutKb, cacheHttpMissSvcTime=cacheHttpMissSvcTime, cachePeerPortHttp=cachePeerPortHttp, cacheDns=cacheDns, cacheNumObjCount=cacheNumObjCount, squid=squid, cacheIpHits=cacheIpHits, cacheCurrentFileDescrCnt=cacheCurrentFileDescrCnt, cacheFqdnPendingHits=cacheFqdnPendingHits, cachePeerAddress=cachePeerAddress, cachePeerFetches=cachePeerFetches, cacheProtoStats=cacheProtoStats, cacheSysNumReads=cacheSysNumReads, cacheHttpAllSvcTime=cacheHttpAllSvcTime, cacheHttpHitSvcTime=cacheHttpHitSvcTime, cachePeerAddressType=cachePeerAddressType, cacheCurrentUnusedFDescrCnt=cacheCurrentUnusedFDescrCnt, cacheMedianSvcTable=cacheMedianSvcTable, cacheMedianTime=cacheMedianTime, cacheIpMisses=cacheIpMisses, cacheClientAddressType=cacheClientAddressType, cacheConfig=cacheConfig, cacheNetwork=cacheNetwork, cacheIpRequests=cacheIpRequests, cachePeerRtt=cachePeerRtt, cachePerf=cachePerf, cacheIcpKbSent=cacheIcpKbSent, cacheMaxResSize=cacheMaxResSize, cacheUptime=cacheUptime, cacheFqdnRequests=cacheFqdnRequests, cacheIpNegativeHits=cacheIpNegativeHits, cacheCurrentSwapSize=cacheCurrentSwapSize, cacheCpuUsage=cacheCpuUsage, cacheFqdnHits=cacheFqdnHits, cacheClientHTTPHitKb=cacheClientHTTPHitKb, cacheCurrentUnlinkRequests=cacheCurrentUnlinkRequests, cacheBlockingGetHostByName=cacheBlockingGetHostByName, cacheFqdnCache=cacheFqdnCache, cacheIpEntries=cacheIpEntries, cacheSwapHighWM=cacheSwapHighWM, cacheRequestByteRatio=cacheRequestByteRatio, cacheStorageConfig=cacheStorageConfig, cachePeerKeepAlSent=cachePeerKeepAlSent, cacheClientHttpKb=cacheClientHttpKb, cacheFqdnMisses=cacheFqdnMisses, cacheCurrentFileDescrMax=cacheCurrentFileDescrMax, cacheClientTable=cacheClientTable, cacheHttpInKb=cacheHttpInKb, cacheIcpReplySvcTime=cacheIcpReplySvcTime, cacheDnsNumberServers=cacheDnsNumberServers, cacheIpPendingHits=cacheIpPendingHits, cacheCpuTime=cacheCpuTime, cacheClientIcpRequests=cacheClientIcpRequests, cacheServerErrors=cacheServerErrors, cachePeerIgnored=cachePeerIgnored, cacheBlockingGetHostByAddr=cacheBlockingGetHostByAddr, cacheIcpQuerySvcTime=cacheIcpQuerySvcTime, cacheIpCache=cacheIpCache, cachePeerName=cachePeerName, cacheDnsSvcTime=cacheDnsSvcTime, cacheServerInKb=cacheServerInKb, cachePeerKeepAlRecv=cachePeerKeepAlRecv, cacheAttemptReleaseLckEntries=cacheAttemptReleaseLckEntries, cacheHttpNmSvcTime=cacheHttpNmSvcTime, cacheServerRequests=cacheServerRequests, cacheIcpPktsRecv=cacheIcpPktsRecv, cacheRequestHitRatio=cacheRequestHitRatio, cacheClientIcpHits=cacheClientIcpHits, cacheLoggingFacility=cacheLoggingFacility, cachePeerPingsSent=cachePeerPingsSent, cacheSysPerf=cacheSysPerf, cacheSoftware=cacheSoftware, nlanr=nlanr, cachePeerPingsAcked=cachePeerPingsAcked, cacheDnsReplies=cacheDnsReplies, cacheClientIcpHitKb=cacheClientIcpHitKb, cacheSystem=cacheSystem, cacheSwapLowWM=cacheSwapLowWM, cacheIcpPktsSent=cacheIcpPktsSent, cachePeerPortIcp=cachePeerPortIcp, cacheSysStorage=cacheSysStorage, cacheMesh=cacheMesh, cacheIcpKbRecv=cacheIcpKbRecv, cacheHttpNhSvcTime=cacheHttpNhSvcTime, cacheSysPageFaults=cacheSysPageFaults, cacheSysVMsize=cacheSysVMsize, cacheFqdnNegativeHits=cacheFqdnNegativeHits, cacheCurrentLRUExpiration=cacheCurrentLRUExpiration, cachePeerState=cachePeerState, cacheHttpErrors=cacheHttpErrors, cacheHttpHits=cacheHttpHits, cacheDnsRequests=cacheDnsRequests, cachePeerEntry=cachePeerEntry, cacheMemMaxSize=cacheMemMaxSize, cachePeerType=cachePeerType, cacheMedianSvcEntry=cacheMedianSvcEntry, ValidPort=ValidPort, cacheClientIcpKb=cacheClientIcpKb, cacheMemUsage=cacheMemUsage, cacheClientEntry=cacheClientEntry, cacheClients=cacheClients, cacheSwapMaxSize=cacheSwapMaxSize)
