...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/squid/SQUID-MIB
...
ModuleIdentity, Counter64, Integer32, enterprises, Gauge32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, MibIdentifier, TimeTicks, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "enterprises", "Gauge32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("SQUID-MIB", cacheStorageConfig=cacheStorageConfig, cacheDnsReplies=cacheDnsReplies, cacheIcpReplySvcTime=cacheIcpReplySvcTime, cacheSwapMaxSize=cacheSwapMaxSize, cachePeerRtt=cachePeerRtt, cacheClientHttpRequests=cacheClientHttpRequests, cacheClientHTTPHitKb=cacheClientHTTPHitKb, cacheCurrentLRUExpiration=cacheCurrentLRUExpiration, cacheDnsSvcTime=cacheDnsSvcTime, cacheMesh=cacheMesh, cachePeerType=cachePeerType, cacheCurrentSwapSize=cacheCurrentSwapSize, cachePeerTable=cachePeerTable, cacheIpCache=cacheIpCache, cachePeerKeepAlRecv=cachePeerKeepAlRecv, cacheHttpAllSvcTime=cacheHttpAllSvcTime, cacheRequestHitRatio=cacheRequestHitRatio, cacheSysNumReads=cacheSysNumReads, cacheServerRequests=cacheServerRequests, cacheClientAddressType=cacheClientAddressType, cacheIpNegativeHits=cacheIpNegativeHits, cachePeerName=cachePeerName, cacheClientAddress=cacheClientAddress, cachePeerIndex=cachePeerIndex, cachePeerPingsSent=cachePeerPingsSent, cacheIpMisses=cacheIpMisses, cacheSwapHighWM=cacheSwapHighWM, cacheMemMaxSize=cacheMemMaxSize, cacheFqdnPendingHits=cacheFqdnPendingHits, cacheAttemptReleaseLckEntries=cacheAttemptReleaseLckEntries, nlanr=nlanr, cacheHttpErrors=cacheHttpErrors, cacheDnsNumberServers=cacheDnsNumberServers, cacheClientHttpKb=cacheClientHttpKb, cacheCpuTime=cacheCpuTime, cacheNumObjCount=cacheNumObjCount, cachePeerEntry=cachePeerEntry, cacheClientIcpRequests=cacheClientIcpRequests, cacheLoggingFacility=cacheLoggingFacility, cacheIpHits=cacheIpHits, cacheIpPendingHits=cacheIpPendingHits, cacheSysVMsize=cacheSysVMsize, cacheSystem=cacheSystem, cacheUptime=cacheUptime, cacheBlockingGetHostByName=cacheBlockingGetHostByName, cacheFqdnCache=cacheFqdnCache, cacheServerErrors=cacheServerErrors, CachePeerTableIndex=CachePeerTableIndex, cacheClientIcpHits=cacheClientIcpHits, cacheSoftware=cacheSoftware, cachePeerIgnored=cachePeerIgnored, cacheMedianTime=cacheMedianTime, cacheDns=cacheDns, cacheHttpMissSvcTime=cacheHttpMissSvcTime, cacheConfig=cacheConfig, cacheClientIcpHitKb=cacheClientIcpHitKb, cachePeerState=cachePeerState, cachePeerPortIcp=cachePeerPortIcp, cacheHttpNmSvcTime=cacheHttpNmSvcTime, cacheHttpHitSvcTime=cacheHttpHitSvcTime, cacheNetwork=cacheNetwork, cacheIcpKbRecv=cacheIcpKbRecv, cacheCurrentUnusedFDescrCnt=cacheCurrentUnusedFDescrCnt, PYSNMP_MODULE_ID=squid, cacheCurrentUnlinkRequests=cacheCurrentUnlinkRequests, cacheServerOutKb=cacheServerOutKb, cacheClientHttpHits=cacheClientHttpHits, cacheProtoAggregateStats=cacheProtoAggregateStats, cacheServerInKb=cacheServerInKb, cacheHttpInKb=cacheHttpInKb, cacheBlockingGetHostByAddr=cacheBlockingGetHostByAddr, cacheMemUsage=cacheMemUsage, cacheRequestByteRatio=cacheRequestByteRatio, cacheFqdnRequests=cacheFqdnRequests, cacheClients=cacheClients, cacheAdmin=cacheAdmin, cacheClientEntry=cacheClientEntry, cacheClientTable=cacheClientTable, cacheIcpPktsRecv=cacheIcpPktsRecv, cachePeerAddress=cachePeerAddress, cacheCurrentFileDescrMax=cacheCurrentFileDescrMax, cacheSwapLowWM=cacheSwapLowWM, cacheIcpKbSent=cacheIcpKbSent, cacheFqdnNegativeHits=cacheFqdnNegativeHits, cacheIcpQuerySvcTime=cacheIcpQuerySvcTime, cacheHttpOutKb=cacheHttpOutKb, cachePeerPortHttp=cachePeerPortHttp, cacheHttpHits=cacheHttpHits, cacheVersionId=cacheVersionId, cachePeerKeepAlSent=cachePeerKeepAlSent, cacheDnsRequests=cacheDnsRequests, cachePerf=cachePerf, cachePeerAddressType=cachePeerAddressType, cacheCpuUsage=cacheCpuUsage, cachePeerPingsAcked=cachePeerPingsAcked, cacheIcpPktsSent=cacheIcpPktsSent, cacheClientIcpKb=cacheClientIcpKb, cacheMaxResSize=cacheMaxResSize, cacheFqdnHits=cacheFqdnHits, cacheUniqName=cacheUniqName, cacheIpRequests=cacheIpRequests, squid=squid, cacheSysPerf=cacheSysPerf, cacheCurrentFileDescrCnt=cacheCurrentFileDescrCnt, cacheFqdnEntries=cacheFqdnEntries, cacheIpEntries=cacheIpEntries, cacheFqdnMisses=cacheFqdnMisses, cacheSysStorage=cacheSysStorage, cacheMedianSvcEntry=cacheMedianSvcEntry, cacheHttpNhSvcTime=cacheHttpNhSvcTime, ValidPort=ValidPort, cacheSysPageFaults=cacheSysPageFaults, cachePeerFetches=cachePeerFetches, cacheProtoStats=cacheProtoStats, cacheCurrentResFileDescrCnt=cacheCurrentResFileDescrCnt, cacheMedianSvcTable=cacheMedianSvcTable, cacheProtoClientHttpRequests=cacheProtoClientHttpRequests)
