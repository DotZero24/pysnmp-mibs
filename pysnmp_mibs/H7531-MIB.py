# SNMP MIB module (H7531-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/H7531-MIB
...
trapTest.setObjects(
      *(("H7531-MIB", "sensorName"),
        ("H7531-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
