...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ATM-VIRTUAL-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:29:44 2025
...
_CaviFileId_Type.__name__ = "Unsigned32"
...
_CaviVpiNum_Type.__name__ = "AtmVpIdentifier"
...
_CaviMinVpiNum_Type.__name__ = "AtmVpIdentifier"
...
caviMIBCompliance.setObjects(
      *(("CISCO-ATM-VIRTUAL-IF-MIB", "caviMIBGroup"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressStatMIBGroup"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressHighSpeedStatMIBGroup"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressIntervalMIBGroup"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviIngressStatMIBGroup"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviIngressHighSpeedStatMIBGroup"))
)
if mibBuilder.loadTexts:
...
caviMIBComplianceRev1.setObjects(
      *(("CISCO-ATM-VIRTUAL-IF-MIB", "caviMIBGroupRev1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressStatMIBGroup"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressHighSpeedStatMIBGroup"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressIntervalMIBGroup"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviIngressStatMIBGroup"),
...
caviMIBComplianceRev2.setObjects(
      *(("CISCO-ATM-VIRTUAL-IF-MIB", "caviMIBGroupRev1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressStatMIBGroup1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressHighSpeedStatMIBGroup1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressIntervalMIBGroup1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviIngressStatMIBGroup1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviIngHighSpeedStatMIBGroup1"))
)
if mibBuilder.loadTexts:
...
caviMIBComplianceRev3.setObjects(
      *(("CISCO-ATM-VIRTUAL-IF-MIB", "caviMIBGroupRev1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressStatMIBGroup1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressHighSpeedStatMIBGroup1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviEgressIntervalMIBGroup1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviIngressStatMIBGroup1"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviIngHighSpeedStatMIBGroup2"),
        ("CISCO-ATM-VIRTUAL-IF-MIB", "caviIngressIntervalStatMIBGroup"))
)
if mibBuilder.loadTexts:
