# SNMP MIB module (NETGEAR-RADLAN-BRGMACSWITCH-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-BRGMACSWITCH-MIB
