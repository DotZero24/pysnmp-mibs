...
mibBuilder.exportSymbols("CPQIDE-MIB", cpqIdeIdent=cpqIdeIdent, cpqIdeOsCommonModuleIndex=cpqIdeOsCommonModuleIndex, cpqIdeAtapiDeviceTable=cpqIdeAtapiDeviceTable, cpqIdeLogicalDriveIndex=cpqIdeLogicalDriveIndex, cpqIdeAtaDiskIsSpare=cpqIdeAtaDiskIsSpare, cpqIdeIdentIndex=cpqIdeIdentIndex, cpqIdeAtaDiskPowerOnHours=cpqIdeAtaDiskPowerOnHours, cpqIdeAtaDiskStatusChange=cpqIdeAtaDiskStatusChange, cpqIdeLogicalDriveTable=cpqIdeLogicalDriveTable, cpqIdeOsCommonModuleTable=cpqIdeOsCommonModuleTable, cpqIdeAtapiDevice=cpqIdeAtapiDevice, cpqIdeInterface=cpqIdeInterface, cpqIdeControllerSerialNumber=cpqIdeControllerSerialNumber, cpqIdeAtapiDeviceChannel=cpqIdeAtapiDeviceChannel, cpqIdeControllerHwLocation=cpqIdeControllerHwLocation, cpqIdeAtaDiskIndex=cpqIdeAtaDiskIndex, cpqIdeLogicalDriveStripeSize=cpqIdeLogicalDriveStripeSize, cpqIdeAtaSecureEraseFailed=cpqIdeAtaSecureEraseFailed, cpqIdeIdentErrorNumber=cpqIdeIdentErrorNumber, cpqIdeAtaDiskCapacity=cpqIdeAtaDiskCapacity, cpqIdeAtaDiskFwRev=cpqIdeAtaDiskFwRev, cpqIdeComponent=cpqIdeComponent, cpqIdeLogicalDriveDiskIds=cpqIdeLogicalDriveDiskIds, cpqIdeAtaDiskLogicalDriveMember=cpqIdeAtaDiskLogicalDriveMember, cpqIdeControllerModel=cpqIdeControllerModel, cpqIdeIdentTable=cpqIdeIdentTable, cpqIdeMibRev=cpqIdeMibRev, cpqIdeAtaDiskSSDEstTimeRemainingHours=cpqIdeAtaDiskSSDEstTimeRemainingHours, cpqIdeLogicalDriveCondition=cpqIdeLogicalDriveCondition, cpqIde=cpqIde, cpqIdeIdentCondition=cpqIdeIdentCondition, cpqIdeAtaDiskSataVersion=cpqIdeAtaDiskSataVersion, cpqIdeIdentCondition2=cpqIdeIdentCondition2, cpqIdeAtaDiskCondition=cpqIdeAtaDiskCondition, cpqIdeAtaDiskTable=cpqIdeAtaDiskTable, cpqIdeControllerPciLocation=cpqIdeControllerPciLocation, cpqIdeLogicalDriveControllerIndex=cpqIdeLogicalDriveControllerIndex, cpqIdeAtaDiskSSDPercntEndrnceUsed=cpqIdeAtaDiskSSDPercntEndrnceUsed, cpqIdeAtaDiskMediaType=cpqIdeAtaDiskMediaType, cpqIdeOsCommon=cpqIdeOsCommon, cpqIdeIdentModel=cpqIdeIdentModel, cpqIdeAtaDiskSSDWearStatusChange=cpqIdeAtaDiskSSDWearStatusChange, cpqIdeControllerSlot=cpqIdeControllerSlot, cpqIdeAtapiDeviceControllerIndex=cpqIdeAtapiDeviceControllerIndex, cpqIdeLogicalDriveStatusChange=cpqIdeLogicalDriveStatusChange, cpqIdeAtapiDeviceFwRev=cpqIdeAtapiDeviceFwRev, cpqIdeAtaDiskSSDWearStatusChange2=cpqIdeAtaDiskSSDWearStatusChange2, cpqIdeAtaDiskStatus=cpqIdeAtaDiskStatus, cpqIdeControllerIndex=cpqIdeControllerIndex, cpqIdeDriveOk=cpqIdeDriveOk, cpqIdeAtaDiskTemperatureThreshold=cpqIdeAtaDiskTemperatureThreshold, cpqIdeAtaDiskType=cpqIdeAtaDiskType, cpqIdeControllerStatus=cpqIdeControllerStatus, cpqIdeOsCommonModuleVersion=cpqIdeOsCommonModuleVersion, cpqIdeControllerFwRev=cpqIdeControllerFwRev, cpqIdeAtaDiskLocation=cpqIdeAtaDiskLocation, cpqIdeOsCommonModuleDate=cpqIdeOsCommonModuleDate, cpqIdeIdentTypeExtended=cpqIdeIdentTypeExtended, cpqIdeControllerCondition=cpqIdeControllerCondition, cpqIdeAtaDiskStatusChange2=cpqIdeAtaDiskStatusChange2, cpqIdeOsCommonModuleEntry=cpqIdeOsCommonModuleEntry, cpqIdeIdentSerNum=cpqIdeIdentSerNum, cpqIdeIdentType=cpqIdeIdentType, cpqIdeMibRevMinor=cpqIdeMibRevMinor, cpqIdeMibRevMajor=cpqIdeMibRevMajor, cpqIdeControllerTable=cpqIdeControllerTable, cpqIdeDriveUltraAtaDegraded=cpqIdeDriveUltraAtaDegraded, cpqIdeAtapiDeviceNumber=cpqIdeAtapiDeviceNumber, cpqIdeAtaDiskSerialNumber=cpqIdeAtaDiskSerialNumber, cpqIdeAtaDiskChannel=cpqIdeAtaDiskChannel, cpqIdeAtaDiskModel=cpqIdeAtaDiskModel, cpqIdeAtapiDeviceModel=cpqIdeAtapiDeviceModel, cpqIdeIdentStatus=cpqIdeIdentStatus, cpqIdeDriveDegraded=cpqIdeDriveDegraded, cpqIdeOsCommonModuleName=cpqIdeOsCommonModuleName, cpqIdeLogicalDriveCapacity=cpqIdeLogicalDriveCapacity, cpqIdeController=cpqIdeController, cpqIdeLogicalDriveEntry=cpqIdeLogicalDriveEntry, cpqIdeAtaDisk=cpqIdeAtaDisk, cpqIdeIdentUltraAtaAvailability=cpqIdeIdentUltraAtaAvailability, cpqIdeAtapiDeviceIndex=cpqIdeAtapiDeviceIndex, cpqIdeAtaDiskSSDWearStatus=cpqIdeAtaDiskSSDWearStatus, cpqIdeLogicalDriveStatus=cpqIdeLogicalDriveStatus, cpqIdeAtapiDeviceEntry=cpqIdeAtapiDeviceEntry, cpqIdeAtaDiskTransferMode=cpqIdeAtaDiskTransferMode, cpqIdeControllerEntry=cpqIdeControllerEntry, cpqIdeOsCommonModulePurpose=cpqIdeOsCommonModulePurpose, cpqIdeAtaDiskNumber=cpqIdeAtaDiskNumber, cpqIdeOsCommonPollFreq=cpqIdeOsCommonPollFreq, cpqIdeAtaDiskDestructiveOperatingTemp=cpqIdeAtaDiskDestructiveOperatingTemp, cpqIdeControllerOverallCondition=cpqIdeControllerOverallCondition, cpqIdeAtaDiskEntry=cpqIdeAtaDiskEntry, cpqIdeMibCondition=cpqIdeMibCondition, cpqIdeIdentEntry=cpqIdeIdentEntry, cpqIdeAtaEraseFailureType=cpqIdeAtaEraseFailureType, cpqIdeAtapiDeviceType=cpqIdeAtapiDeviceType, cpqIdeLogicalDriveSpareIds=cpqIdeLogicalDriveSpareIds, cpqIdeIdentFWVers=cpqIdeIdentFWVers, cpqIdeAtaDiskCurrTemperature=cpqIdeAtaDiskCurrTemperature, cpqIdeAtapiDeviceTypeExtended=cpqIdeAtapiDeviceTypeExtended, cpqIdeLogicalDrive=cpqIdeLogicalDrive, cpqIdeLogicalDriveOsName=cpqIdeLogicalDriveOsName, cpqIdeAtaDiskMaximumOperatingTemp=cpqIdeAtaDiskMaximumOperatingTemp, cpqIdeAtaDiskControllerIndex=cpqIdeAtaDiskControllerIndex, cpqIdeAtaDiskOsName=cpqIdeAtaDiskOsName, cpqIdeAtaDiskSmartEnabled=cpqIdeAtaDiskSmartEnabled, cpqIdeLogicalDriveRaidLevel=cpqIdeLogicalDriveRaidLevel, cpqIdeLogicalDriveRebuildingDisk=cpqIdeLogicalDriveRebuildingDisk)
