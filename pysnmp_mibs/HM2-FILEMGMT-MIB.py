...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-FILEMGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:52:35 2025
...
_Hm2FMActionSourceInterface_Type.__name__ = "InterfaceIndexOrZero"
...
_Hm2ConfigWatchdogAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2FileMgmtConfigPasswordStatus_Type.__name__ = "TruthValue"
...
hm2FileMgmtConfigRemoteSaveGroup = _Hm2FileMgmtConfigRemoteSaveGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 21, 1, 4, 5)
)


class _Hm2FMConfigRemoteSaveAdminStatus_Type(HmEnabledStatus):
    """Custom type hm2FMConfigRemoteSaveAdminStatus based on HmEnabledStatus"""
    defaultValue = 2


_Hm2FMConfigRemoteSaveAdminStatus_Type.__name__ = "HmEnabledStatus"
_Hm2FMConfigRemoteSaveAdminStatus_Object = MibScalar
hm2FMConfigRemoteSaveAdminStatus = _Hm2FMConfigRemoteSaveAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 21, 1, 4, 5, 1),
    _Hm2FMConfigRemoteSaveAdminStatus_Type()
)
hm2FMConfigRemoteSaveAdminStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2FMConfigRemoteSaveAdminStatus.setStatus("current")


class _Hm2FMConfigRemoteSaveDestination_Type(SnmpAdminString):
    """Custom type hm2FMConfigRemoteSaveDestination based on SnmpAdminString"""
    defaultValue = OctetString("")
...
_Hm2FMConfigRemoteSaveDestination_Type.__name__ = "SnmpAdminString"
_Hm2FMConfigRemoteSaveDestination_Object = MibScalar
hm2FMConfigRemoteSaveDestination = _Hm2FMConfigRemoteSaveDestination_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 21, 1, 4, 5, 2),
    _Hm2FMConfigRemoteSaveDestination_Type()
)
hm2FMConfigRemoteSaveDestination.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2FMConfigRemoteSaveDestination.setStatus("current")


class _Hm2FMConfigRemoteSaveUsername_Type(SnmpAdminString):
    """Custom type hm2FMConfigRemoteSaveUsername based on SnmpAdminString"""
    defaultValue = OctetString("")
...
_Hm2FMConfigRemoteSaveUsername_Type.__name__ = "SnmpAdminString"
_Hm2FMConfigRemoteSaveUsername_Object = MibScalar
hm2FMConfigRemoteSaveUsername = _Hm2FMConfigRemoteSaveUsername_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 21, 1, 4, 5, 3),
    _Hm2FMConfigRemoteSaveUsername_Type()
)
hm2FMConfigRemoteSaveUsername.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2FMConfigRemoteSaveUsername.setStatus("current")


class _Hm2FMConfigRemoteSavePassword_Type(SnmpAdminString):
    """Custom type hm2FMConfigRemoteSavePassword based on SnmpAdminString"""
    defaultValue = OctetString("")
...
_Hm2FMConfigRemoteSavePassword_Type.__name__ = "SnmpAdminString"
_Hm2FMConfigRemoteSavePassword_Object = MibScalar
hm2FMConfigRemoteSavePassword = _Hm2FMConfigRemoteSavePassword_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 21, 1, 4, 5, 4),
    _Hm2FMConfigRemoteSavePassword_Type()
)
hm2FMConfigRemoteSavePassword.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2FMConfigRemoteSavePassword.setStatus("current")
...
_Hm2FileMgmtGlobalSourceInterface_Type.__name__ = "InterfaceIndexOrZero"
...
hm2FileMgmtActionStatusErrorReturn = _Hm2FileMgmtActionStatusErrorReturn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 21, 3, 9)
)
if mibBuilder.loadTexts:
    hm2FileMgmtActionStatusErrorReturn.setStatus("current")
_Hm2FileMgmtConfigRemoteSaveDestinationErrorReturn_ObjectIdentity = ObjectIdentity
hm2FileMgmtConfigRemoteSaveDestinationErrorReturn = _Hm2FileMgmtConfigRemoteSaveDestinationErrorReturn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 21, 3, 10)
)
if mibBuilder.loadTexts:
    hm2FileMgmtConfigRemoteSaveDestinationErrorReturn.setStatus("current")
_Hm2FileMgmtConfigCannotDeleteActiveProfile_ObjectIdentity = ObjectIdentity
hm2FileMgmtConfigCannotDeleteActiveProfile = _Hm2FileMgmtConfigCannotDeleteActiveProfile_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 21, 3, 11)
)
if mibBuilder.loadTexts:
    hm2FileMgmtConfigCannotDeleteActiveProfile.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hm2FileMgmtMib": hm2FileMgmtMib,
       ...
       "hm2FMConfigRemoteSaveAdminStatus": hm2FMConfigRemoteSaveAdminStatus,
       "hm2FMConfigRemoteSaveDestination": hm2FMConfigRemoteSaveDestination,
       "hm2FMConfigRemoteSaveUsername": hm2FMConfigRemoteSaveUsername,
       "hm2FMConfigRemoteSavePassword": hm2FMConfigRemoteSavePassword,
       ...
       "hm2FileMgmtActionStatusErrorReturn": hm2FileMgmtActionStatusErrorReturn,
       "hm2FileMgmtConfigRemoteSaveDestinationErrorReturn": hm2FileMgmtConfigRemoteSaveDestinationErrorReturn,
