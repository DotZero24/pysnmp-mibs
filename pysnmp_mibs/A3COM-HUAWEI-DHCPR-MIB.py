...
mibBuilder.exportSymbols("A3COM-HUAWEI-DHCPR-MIB", hwDHCPRelayNakPktNum=hwDHCPRelayNakPktNum, hwDHCPRIPRowStatus=hwDHCPRIPRowStatus, hwDHCPRelayAckPktNum=hwDHCPRelayAckPktNum, hwDHCPRelayMIBConformance=hwDHCPRelayMIBConformance, hwDHCPRIPTable=hwDHCPRIPTable, hwDHCPRTxClientUniPktNum=hwDHCPRTxClientUniPktNum, hwDHCPRelayMIBGroup=hwDHCPRelayMIBGroup, hwDHCPRTxServerPktNum=hwDHCPRTxServerPktNum, hwDHCPRSeletAllocateModeTable=hwDHCPRSeletAllocateModeTable, hwDHCPRelayStatisticsReset=hwDHCPRelayStatisticsReset, hwDHCPRelayReleasePktNum=hwDHCPRelayReleasePktNum, hwDHCPRelayMib=hwDHCPRelayMib, hwDHCPRelayCycleStatus=hwDHCPRelayCycleStatus, hwDHCPRRxClientPktNum=hwDHCPRRxClientPktNum, hwDHCPRSeletAllocateModeEntry=hwDHCPRSeletAllocateModeEntry, hwDHCPRelayMibObject=hwDHCPRelayMibObject, hwDHCPRSelectAllocateMode=hwDHCPRSelectAllocateMode, hwDHCPRRxBadPktNum=hwDHCPRRxBadPktNum, hwDHCPRelayRequestPktNum=hwDHCPRelayRequestPktNum, hwDHCPRelayDiscoverPktNum=hwDHCPRelayDiscoverPktNum, hwDHCPRelayDeclinePktNum=hwDHCPRelayDeclinePktNum, hwDHCPRIPAddr=hwDHCPRIPAddr, hwDHCPRelayInformPktNum=hwDHCPRelayInformPktNum, hwDHCPRIPEntry=hwDHCPRIPEntry, hwDHCPRTxClientBroPktNum=hwDHCPRTxClientBroPktNum, hwDHCPRelayOfferPktNum=hwDHCPRelayOfferPktNum, hwDHCPRelayMIBGroups=hwDHCPRelayMIBGroups, PYSNMP_MODULE_ID=hwDHCPRelayMib, hwDHCPRRxServerPktNum=hwDHCPRRxServerPktNum, hwDHCPRelayMIBCompliances=hwDHCPRelayMIBCompliances, hwDHCPRTxClientPktNum=hwDHCPRTxClientPktNum)
