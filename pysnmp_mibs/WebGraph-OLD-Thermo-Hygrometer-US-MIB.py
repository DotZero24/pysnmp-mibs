# SNMP MIB module (WebGraph-OLD-Thermo-Hygrometer-US-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/webgraph/WebGraph-OLD-Thermo-Hygrometer-US-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:17:03 2025
...
wtWebGraphThermHygroSensorEntry.setIndexNames(
    (0, "WebGraph-OLD-Thermo-Hygrometer-US-MIB", "wtWebGraphThermHygroSensorNo"),
)
if mibBuilder.loadTexts:
...
wtWebGraphThermHygroAlarmIfEntry.setIndexNames(
    (0, "WebGraph-OLD-Thermo-Hygrometer-US-MIB", "wtWebGraphThermHygroAlarmNo"),
)
if mibBuilder.loadTexts:
...
wtWebGraphThermHygroAlert1.setObjects(
    ("WebGraph-OLD-Thermo-Hygrometer-US-MIB", "wtWebGraphThermHygroAlarmTrapText")
)
if mibBuilder.loadTexts:
...
wtWebGraphThermHygroAlert9.setObjects(
    ("WebGraph-OLD-Thermo-Hygrometer-US-MIB", "wtWebGraphThermHygroAlarmClearTrapText")
)
if mibBuilder.loadTexts:
...
wtWebGraphThermHygroAlertDiag.setObjects(
      *(("WebGraph-OLD-Thermo-Hygrometer-US-MIB", "wtWebGraphThermHygroDiagErrorIndex"),
        ("WebGraph-OLD-Thermo-Hygrometer-US-MIB", "wtWebGraphThermHygroDiagErrorMessage"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "WebGraph-OLD-Thermo-Hygrometer-US-MIB",
    **{"wut": wut,
