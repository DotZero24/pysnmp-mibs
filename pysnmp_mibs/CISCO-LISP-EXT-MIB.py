...
lispUseMapResolverState, lispFeaturesMapCacheLimit, lispGlobalStatsEntry, lispUseProxyEtrState, lispUseMapServerState, lispMappingDatabaseTimeStamp, lispEidRegistrationSiteName, LispAddressType, lispFeaturesEntry = mibBuilder.importSymbols("LISP-MIB", "lispUseMapResolverState", "lispFeaturesMapCacheLimit", "lispGlobalStatsEntry", "lispUseProxyEtrState", "lispUseMapServerState", "lispMappingDatabaseTimeStamp", "lispEidRegistrationSiteName", "LispAddressType", "lispFeaturesEntry")
...
mibBuilder.exportSymbols("CISCO-LISP-EXT-MIB", clispExtReliableTransportSessionLocalAddressLength=clispExtReliableTransportSessionLocalAddressLength, clispExtGlobalObjects=clispExtGlobalObjects, clispExtEidRegMoreSpecificCount=clispExtEidRegMoreSpecificCount, clispExtReliableTransportSessionEntry=clispExtReliableTransportSessionEntry, clispExtFeaturesMapCacheLimitReached=clispExtFeaturesMapCacheLimitReached, clispExtReliableTransportSessionMessagesIn=clispExtReliableTransportSessionMessagesIn, clispExtReliableTransportSessionMessagesOut=clispExtReliableTransportSessionMessagesOut, ciscoLispExtMIBComplianceAll=ciscoLispExtMIBComplianceAll, ciscoLispExtConformance=ciscoLispExtConformance, clispExtFeaturesEidRegMoreSpecificWarningThreshold=clispExtFeaturesEidRegMoreSpecificWarningThreshold, clispExtReliableTransportSessionPeerAddressLength=clispExtReliableTransportSessionPeerAddressLength, clispExtFeaturesEidRegMoreSpecificWarningThresholdReached=clispExtFeaturesEidRegMoreSpecificWarningThresholdReached, clispExtEidRegMoreSpecificWarningThresholdReached=clispExtEidRegMoreSpecificWarningThresholdReached, clispExtGlobalStatsTable=clispExtGlobalStatsTable, clispExtFeaturesEntry=clispExtFeaturesEntry, clispExtRlocMembershipRlocLength=clispExtRlocMembershipRlocLength, clispExtEidRegFailureCause=clispExtEidRegFailureCause, clispExtRlocMembershipTable=clispExtRlocMembershipTable, clispExtFeaturesMapCacheWarningThreshold=clispExtFeaturesMapCacheWarningThreshold, clispExtReliableTransportSessionLocalPort=clispExtReliableTransportSessionLocalPort, clispExtFeaturesTable=clispExtFeaturesTable, clispExtReliableTransportSessionLastStateChangeTime=clispExtReliableTransportSessionLastStateChangeTime, clispExtReliableTransportSessionTable=clispExtReliableTransportSessionTable, clispExtReliableTransportSessionBytesIn=clispExtReliableTransportSessionBytesIn, clispExtEidRegRlocMembershipRlocLength=clispExtEidRegRlocMembershipRlocLength, ciscoLispExtMIBComplianceMapServer=ciscoLispExtMIBComplianceMapServer, clispExtRlocMembershipConfigured=clispExtRlocMembershipConfigured, clispExtEidRegMoreSpecificLimitReached=clispExtEidRegMoreSpecificLimitReached, clispExtRlocMembershipMemberSince=clispExtRlocMembershipMemberSince, clispExtRlocMembershipGroup=clispExtRlocMembershipGroup, clispExtNotificationObjects=clispExtNotificationObjects, clispExtRlocMembershipInstanceID=clispExtRlocMembershipInstanceID, clispExtEidRegMapRequestDropped=clispExtEidRegMapRequestDropped, clispExtEidRegRlocMembershipRloc=clispExtEidRegRlocMembershipRloc, clispExtReliableTransportSessionEstablishmentRole=clispExtReliableTransportSessionEstablishmentRole, ciscoLispExtNotifications=ciscoLispExtNotifications, clispExtEidRegMoreSpecificValuesGroup=clispExtEidRegMoreSpecificValuesGroup, clispExtEidRegRlocMembershipConfigured=clispExtEidRegRlocMembershipConfigured, clispExtEidRegMoreSpecificWarningThreshold=clispExtEidRegMoreSpecificWarningThreshold, clispExtEidRegRlocMembershipEidAfi=clispExtEidRegRlocMembershipEidAfi, clispExtEidRegFailure=clispExtEidRegFailure, clispExtGlobalStatsGroup=clispExtGlobalStatsGroup, clispExtFeaturesEidRegMoreSpecificLimitReached=clispExtFeaturesEidRegMoreSpecificLimitReached, clispExtReliableTransportSessionGroup=clispExtReliableTransportSessionGroup, clispExtNotificationSupportGroup=clispExtNotificationSupportGroup, ciscoLispExtCompliances=ciscoLispExtCompliances, clispExtRlocMembershipDiscovered=clispExtRlocMembershipDiscovered, clispExtRlocMembershipRloc=clispExtRlocMembershipRloc, clispExtRlocMembershipEidAfi=clispExtRlocMembershipEidAfi, PYSNMP_MODULE_ID=ciscoLispExtMIB, clispExtFeaturesMapCacheWarningThresholdReached=clispExtFeaturesMapCacheWarningThresholdReached, ciscoLispExtMIB=ciscoLispExtMIB, clispExtReliableTransportSessionLocalAddress=clispExtReliableTransportSessionLocalAddress, clispExtRlocMembershipEntry=clispExtRlocMembershipEntry, clispExtEidRegMapRequestDroppedCause=clispExtEidRegMapRequestDroppedCause, ciscoLispExtGroups=ciscoLispExtGroups, clispExtEidRegRlocMembershipInstanceID=clispExtEidRegRlocMembershipInstanceID, clispExtEidRegRlocMembershipGleaned=clispExtEidRegRlocMembershipGleaned, clispExtEidRegMoreSpecificLimit=clispExtEidRegMoreSpecificLimit, clispExtEidRegSiteAllRegistrationsExpired=clispExtEidRegSiteAllRegistrationsExpired, clispExtUseMapResolverStateChange=clispExtUseMapResolverStateChange, clispExtReliableTransportSessionBytesOut=clispExtReliableTransportSessionBytesOut, clispExtMappingDatabaseEidRegFailure=clispExtMappingDatabaseEidRegFailure, clispExtUseProxyEtrStateChange=clispExtUseProxyEtrStateChange, clispExtReliableTransportSessionPeerPort=clispExtReliableTransportSessionPeerPort, clispExtUseMapServerStateChange=clispExtUseMapServerStateChange, clispExtGlobalStatsEntry=clispExtGlobalStatsEntry, clispExtEidRegRlocMembershipMemberSince=clispExtEidRegRlocMembershipMemberSince, clispExtEidRegRlocMembershipTable=clispExtEidRegRlocMembershipTable, clispExtGlobalStatsEidRegMoreSpecificEntryCount=clispExtGlobalStatsEidRegMoreSpecificEntryCount, clispExtReliableTransportSessionPeerAddress=clispExtReliableTransportSessionPeerAddress, clispExtEidRegRlocMembershipEntry=clispExtEidRegRlocMembershipEntry, clispExtNotificationsGroup=clispExtNotificationsGroup, clispExtFeaturesGroup=clispExtFeaturesGroup, clispExtReliableTransportSessionState=clispExtReliableTransportSessionState, clispExtFeaturesEidRegMoreSpecificLimit=clispExtFeaturesEidRegMoreSpecificLimit, clispExtReliableTransportStateChange=clispExtReliableTransportStateChange, ciscoLispExtObjects=ciscoLispExtObjects, clispExtEidRegRlocMembershipGroup=clispExtEidRegRlocMembershipGroup)
