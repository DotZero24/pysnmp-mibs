...
agentFeatureKeyingGroup=_AgentFeatureKeyingGroup_ObjectIdentity((1,3,6,1,4,1,2356,16,1,24,1))
_AgentFeatureKeyingEnableKey_Type=DisplayString
_AgentFeatureKeyingEnableKey_Object=MibScalar
agentFeatureKeyingEnableKey=_AgentFeatureKeyingEnableKey_Object((1,3,6,1,4,1,2356,16,1,24,1,1),_AgentFeatureKeyingEnableKey_Type())
...
agentFeatureKeyingDisableKey=_AgentFeatureKeyingDisableKey_Object((1,3,6,1,4,1,2356,16,1,24,1,2),_AgentFeatureKeyingDisableKey_Type())
...
agentFeatureKeyingTable=_AgentFeatureKeyingTable_Object((1,3,6,1,4,1,2356,16,1,24,1,3))
if mibBuilder.loadTexts:agentFeatureKeyingTable.setStatus(_A)
_AgentFeatureKeyingEntry_Object=MibTableRow
agentFeatureKeyingEntry=_AgentFeatureKeyingEntry_Object((1,3,6,1,4,1,2356,16,1,24,1,3,1))
...
agentFeatureKeyingIndex=_AgentFeatureKeyingIndex_Object((1,3,6,1,4,1,2356,16,1,24,1,3,1,1),_AgentFeatureKeyingIndex_Type())
...
agentFeatureKeyingName=_AgentFeatureKeyingName_Object((1,3,6,1,4,1,2356,16,1,24,1,3,1,2),_AgentFeatureKeyingName_Type())
...
agentFeatureKeyingStatus=_AgentFeatureKeyingStatus_Object((1,3,6,1,4,1,2356,16,1,24,1,3,1,3),_AgentFeatureKeyingStatus_Type())
