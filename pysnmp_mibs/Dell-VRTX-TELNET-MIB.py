# SNMP MIB module (Dell-VRTX-TELNET-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-VRTX-TELNET-MIB
...
rlTelnetUsersEntry.setIndexNames(
    (0, "Dell-VRTX-TELNET-MIB", "rlTelnetSessionId"),
)
if mibBuilder.loadTexts:
