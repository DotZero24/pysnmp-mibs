...
# Notes
# -----
# ASN.1 source file://mibs/cisco/LANOPTICS-SYSTEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:27:13 2025
...
snSysCMOSIpInterfaceEntry.setIndexNames(
    (0, "LANOPTICS-SYSTEM-MIB", "pysmiFakeCol14"),
)
if mibBuilder.loadTexts:
...
_PysmiFakeCol14_Type = Integer32
_PysmiFakeCol14_Object = MibTableColumn
pysmiFakeCol14 = _PysmiFakeCol14_Object(
    (1, 3, 6, 1, 4, 1, 224, 2, 3, 1, 1, 1, 4294967295),
    _PysmiFakeCol14_Type()
)
pysmiFakeCol14.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    pysmiFakeCol14.setStatus("mandatory")
...
snSysCMOSHubSlotConfigEntry.setIndexNames(
    (0, "LANOPTICS-SYSTEM-MIB", "pysmiFakeCol15"),
)
if mibBuilder.loadTexts:
...
_PysmiFakeCol15_Type = Integer32
_PysmiFakeCol15_Object = MibTableColumn
pysmiFakeCol15 = _PysmiFakeCol15_Object(
    (1, 3, 6, 1, 4, 1, 224, 2, 3, 2, 1, 1, 4294967295),
    _PysmiFakeCol15_Type()
)
pysmiFakeCol15.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    pysmiFakeCol15.setStatus("mandatory")
...
snSysCMOSSNMPCommunitiesEntry.setIndexNames(
    (0, "LANOPTICS-SYSTEM-MIB", "pysmiFakeCol16"),
)
if mibBuilder.loadTexts:
...
_PysmiFakeCol16_Type = Integer32
_PysmiFakeCol16_Object = MibTableColumn
pysmiFakeCol16 = _PysmiFakeCol16_Object(
    (1, 3, 6, 1, 4, 1, 224, 2, 3, 6, 3, 1, 4294967295),
    _PysmiFakeCol16_Type()
)
pysmiFakeCol16.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    pysmiFakeCol16.setStatus("mandatory")
...
snSysCMOSSNMPTrapCommunitiesEntry.setIndexNames(
    (0, "LANOPTICS-SYSTEM-MIB", "pysmiFakeCol17"),
)
if mibBuilder.loadTexts:
...
_PysmiFakeCol17_Type = Integer32
_PysmiFakeCol17_Object = MibTableColumn
pysmiFakeCol17 = _PysmiFakeCol17_Object(
    (1, 3, 6, 1, 4, 1, 224, 2, 3, 6, 4, 1, 4294967295),
    _PysmiFakeCol17_Type()
)
pysmiFakeCol17.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    pysmiFakeCol17.setStatus("mandatory")
