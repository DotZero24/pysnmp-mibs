...
# Notes
# -----
# ASN.1 source file://mibs/siaemic/SIAE-EQUIPTYPE-MIB
...
equipTypeALFO80HDx = _EquipTypeALFO80HDx_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 5, 79)
)
if mibBuilder.loadTexts:
    equipTypeALFO80HDx.setStatus("current")
_EquipTypeALFOplus1_ObjectIdentity = ObjectIdentity
equipTypeALFOplus1 = _EquipTypeALFOplus1_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 5, 80)
)
if mibBuilder.loadTexts:
    equipTypeALFOplus1.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"equipTypeList": equipTypeList,
       ...
       "equipTypeALFO80HDx": equipTypeALFO80HDx,
       "equipTypeALFOplus1": equipTypeALFOplus1,
