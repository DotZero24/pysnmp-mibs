...
mibBuilder.exportSymbols("INFINERA-TP-FEEDPTP-MIB", feedPtpCompliances=feedPtpCompliances, feedPtpPmHistStatsEnable=feedPtpPmHistStatsEnable, feedPtpGroup=feedPtpGroup, PYSNMP_MODULE_ID=feedPtpMIB, feedPtpMIB=feedPtpMIB, feedPtpTable=feedPtpTable, feedPtpConformance=feedPtpConformance, feedPtpEntry=feedPtpEntry, feedPtpCompliance=feedPtpCompliance, feedPtpGroups=feedPtpGroups)
