...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FLEX-LINKS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:22:01 2025
...
_CflIfConfigStorageType_Type.__name__ = "StorageType"
...
ciscoFlexLinksMIBCompliance.setObjects(
      *(("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksIfConfigGroup"),
        ("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksIfStatusGroup"),
        ("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksEnableNotifGroup"),
        ("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksNotifGroup"))
)
if mibBuilder.loadTexts:
...
ciscoFlexLinksMIBCompliance2.setObjects(
      *(("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksIfConfigGroup"),
        ("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksIfStatusGroup"),
        ("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksEnableNotifGroup"),
        ("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksNotifGroup"),
        ("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksMmuPrimaryVlanGroup"),
        ("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksPreemptionGroup"),
        ("CISCO-FLEX-LINKS-MIB", "ciscoFlexLinksPreferVlanGroup"))
)
if mibBuilder.loadTexts:
