...
nms1705Objects = MibIdentifier((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1))
adslLineTable = MibTable((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 1), )
if mibBuilder.loadTexts: adslLineTable.setStatus('mandatory')
adslLineEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 1, 1), ).setIndexNames((0, "FS-NMS-1705", "adslLineNumber"))
if mibBuilder.loadTexts: adslLineEntry.setStatus('mandatory')
adslLineUser = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 1, 1, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslLineUser.setStatus('mandatory')
adslProductID = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 1, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslProductID.setStatus('mandatory')
adslConfigAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 1, 1, 3), IpAddress()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslConfigAddr.setStatus('mandatory')
adslLineNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 1, 1, 4), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslLineNumber.setStatus('mandatory')
adslPeriodTable = MibTable((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2), )
if mibBuilder.loadTexts: adslPeriodTable.setStatus('mandatory')
adslPeriodEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1), ).setIndexNames((0, "FS-NMS-1705", "adslLineNumber"))
if mibBuilder.loadTexts: adslPeriodEntry.setStatus('mandatory')
adslMemLoad = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 1), ObjectIdentifier()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslMemLoad.setStatus('mandatory')
adslCPULoad = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 2), ObjectIdentifier()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslCPULoad.setStatus('mandatory')
adslPtInCRC = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 3), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslPtInCRC.setStatus('mandatory')
adslPtStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("up", 1), ("down", 2), ("testing", 3)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: adslPtStatus.setStatus('current')
adslPtSpeed = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 5), ObjectIdentifier()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslPtSpeed.setStatus('mandatory')
adslPtOutPkts = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 6), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslPtOutPkts.setStatus('mandatory')
adslPtInPkts = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 7), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslPtInPkts.setStatus('mandatory')
adslPtOutError = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 8), ObjectIdentifier()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslPtOutError.setStatus('mandatory')
adslPtInError = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 9), ObjectIdentifier()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslPtInError.setStatus('mandatory')
adslPtOutSpeed = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 10), ObjectIdentifier()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslPtOutSpeed.setStatus('mandatory')
adslPtInSpeed = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 11), ObjectIdentifier()).setMaxAccess("readonly")
if mibBuilder.loadTexts: adslPtInSpeed.setStatus('mandatory')
adslPtOutDrop = MibTableColumn((1, 3, 6, 1, 4, 1, 52642, 9, 175, 1, 2, 1, 12), ObjectIdentifier()).setMaxAccess("readonly")
