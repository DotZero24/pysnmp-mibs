...
mibBuilder.exportSymbols("BLUESERVER-MIB", httpExServerChoice=httpExServerChoice, serviceMgmtName=serviceMgmtName, time=time, exRdAuthServSecret=exRdAuthServSecret, ex802AuthServNotes=ex802AuthServNotes, exRdAccServAddr=exRdAccServAddr, certType=certType, sysLogFacility=sysLogFacility, exLdapServTable=exLdapServTable, autoBkupFtpServUser=autoBkupFtpServUser, blueNotification=blueNotification, exRdAuthServRdAccId=exRdAuthServRdAccId, tDay=tDay, paSMTPServerIp=paSMTPServerIp, blueEventEntry=blueEventEntry, l2tpRemoteIpEndAddr=l2tpRemoteIpEndAddr, blueFailureTraps=blueFailureTraps, nativeUserRoleId=nativeUserRoleId, schedEntry=schedEntry, pptpRemoteIpEndAddr=pptpRemoteIpEndAddr, snmpTrapMgmtRowStatus=snmpTrapMgmtRowStatus, exNtlmServDefRoleId=exNtlmServDefRoleId, httpPort=httpPort, serviceName=serviceName, macDevAuthEntry=macDevAuthEntry, btLinkUp=btLinkUp, roleQosPriInOverride=roleQosPriInOverride, btProcessFailure=btProcessFailure, schedEndDateAndTime=schedEndDateAndTime, schedGrpTable=schedGrpTable, schedGrpRowStatus=schedGrpRowStatus, sysStatDiskSpaceUsed=sysStatDiskSpaceUsed, refreshThresholdInSecs=refreshThresholdInSecs, confLog=confLog, pIntIpAddress=pIntIpAddress, logNoOfDelLogEntries=logNoOfDelLogEntries, schedGrpMemId=schedGrpMemId, slaveMobility=slaveMobility, exRdAuthServName=exRdAuthServName, cctServiceConfChange=cctServiceConfChange, mIntVlanInterface=mIntVlanInterface, snmpTrapMgmtTable=snmpTrapMgmtTable, hostName=hostName, nativeUserAccess=nativeUserAccess, exLdapServSecret=exLdapServSecret, exLdapServSslServer=exLdapServSslServer, connectionHost=connectionHost, cctSystemConfChange=cctSystemConfChange, exModeAggressive=exModeAggressive, exRdAuthServTable=exRdAuthServTable, sysStatCpuUtil=sysStatCpuUtil, PYSNMP_MODULE_ID=blueSocket, snmpConf=snmpConf, l2tpEnable=l2tpEnable, roleQosDscpOut=roleQosDscpOut, certTable=certTable, mobilityMeshKey=mobilityMeshKey, httpAutoRedirectStatus=httpAutoRedirectStatus, adminUserEmailId=adminUserEmailId, heartBeatInterval=heartBeatInterval, pptpLdapPwdAttrName=pptpLdapPwdAttrName, vlanGrpMemRowStatus=vlanGrpMemRowStatus, connectionDev=connectionDev, ipsecConfEsp56BitDESWithSHA1=ipsecConfEsp56BitDESWithSHA1, exLdapServEntry=exLdapServEntry, misc=misc, roleQosPriOutOverride=roleQosPriOutOverride, macDevAuthNotes=macDevAuthNotes, fixedIpAddrHost=fixedIpAddrHost, nativeUserId=nativeUserId, mIntNetmask=mIntNetmask, roleNotes=roleNotes, snmpTrapMgmtEntry=snmpTrapMgmtEntry, hostGrpName=hostGrpName, mIntName=mIntName, pIntEnableMulticast=pIntEnableMulticast, btSystemGeneralTrap=btSystemGeneralTrap, exLdapServBase=exLdapServBase, authentication=authentication, connection=connection, connectionLoginTime=connectionLoginTime, ex802AuthServName=ex802AuthServName, pptpRoleId=pptpRoleId, serviceGrpMemId=serviceGrpMemId, mIntIpAddress=mIntIpAddress, ipsecConfCompressionLZS=ipsecConfCompressionLZS, vlanGrpName=vlanGrpName, serviceGrpTable=serviceGrpTable, httpLogoutPopup=httpLogoutPopup, ipsecConfLocalAuth=ipsecConfLocalAuth, roleQosRate=roleQosRate, ipsecConfRowStatus=ipsecConfRowStatus, serviceMgmtId=serviceMgmtId, httpMaxNumOfActiveSess=httpMaxNumOfActiveSess, connectionName=connectionName, exUserRuleAttribute=exUserRuleAttribute, users=users, stThresholdAttrName=stThresholdAttrName, stThresholdToFailover=stThresholdToFailover, appLogLevEntry=appLogLevEntry, exLdapServRdAccState=exLdapServRdAccState, exLdapServPort=exLdapServPort, exUserRuleRoleId=exUserRuleRoleId, adminUserPassword=adminUserPassword, pptpRemoteIpStartAddr=pptpRemoteIpStartAddr, natTable=natTable, subnetVpnMode=subnetVpnMode, roleQosQnt=roleQosQnt, vpn=vpn, mIntVlanId=mIntVlanId, certSubject=certSubject, cctMobilityConfChange=cctMobilityConfChange, adminUserNotes=adminUserNotes, pptpEncryption40Bit=pptpEncryption40Bit, statusUpTime=statusUpTime, ipsecConfEsp128BitAESWithSHA1=ipsecConfEsp128BitAESWithSHA1, stThresholdId=stThresholdId, cctNetworkConfChange=cctNetworkConfChange, ipsecConfEsp192BitAESWithMD5=ipsecConfEsp192BitAESWithMD5, failover=failover, policySeqId=policySeqId, exLdapServSsl=exLdapServSsl, adUsrAccessStatus=adUsrAccessStatus, exModeMain=exModeMain, autoBackup=autoBackup, adUsrAccessExServer=adUsrAccessExServer, macDevAuthTable=macDevAuthTable, roleQosPriorityIn=roleQosPriorityIn, roles=roles, ex802AuthServTable=ex802AuthServTable, mIntNatAddresses=mIntNatAddresses, ipsec=ipsec, serviceGrpRowStatus=serviceGrpRowStatus, hostAddress=hostAddress, destination=destination, minLifeTimeInSecs=minLifeTimeInSecs, exNtlmServNotes=exNtlmServNotes, fixedIpAddrMac=fixedIpAddrMac, schedGrpMemEntry=schedGrpMemEntry, vlanGrpTable=vlanGrpTable, pIntHostName=pIntHostName, hostEntry=hostEntry, ipsecConfEsp128BitAESWithMD5=ipsecConfEsp128BitAESWithMD5, l2tpLdapPwdAttrName=l2tpLdapPwdAttrName, connectionChecked=connectionChecked, protected=protected, adUsrAccessTable=adUsrAccessTable, serviceMgmt=serviceMgmt, hostTable=hostTable, nativeUserRowStatus=nativeUserRowStatus, policyDirection=policyDirection, natProtectedIp=natProtectedIp, exNtlmServMsdc=exNtlmServMsdc, schedDayOfMonth=schedDayOfMonth, natEntry=natEntry, schedule=schedule, exNtlmServTable=exNtlmServTable, sysStatNeedRestart=sysStatNeedRestart, ipsecConfDiffieHellmanGrp1=ipsecConfDiffieHellmanGrp1, roleQosDscpIn=roleQosDscpIn, blueConfigTraps=blueConfigTraps, notifyObjects=notifyObjects, ipsecConfCompressionDeflate=ipsecConfCompressionDeflate, httpLoginAttempts=httpLoginAttempts, mobilityMode=mobilityMode, maxLifeTimeInKbs=maxLifeTimeInKbs, pIntGateway=pIntGateway, hostInvertDest=hostInvertDest, serviceGrpName=serviceGrpName, tYear=tYear, certPkeyAlgo=certPkeyAlgo, certVersion=certVersion, pptpLocalIpAddr=pptpLocalIpAddr, serviceGrpMemRowStatus=serviceGrpMemRowStatus, exLdapServName=exLdapServName, mIntEntry=mIntEntry, btCpuLoadEvent=btCpuLoadEvent, roleQosRateQntOut=roleQosRateQntOut, vlanGrpMemId=vlanGrpMemId, exLdapServAccount=exLdapServAccount, btAuthFailure=btAuthFailure, httpLoginHelpButton=httpLoginHelpButton, blueEventTable=blueEventTable, btId=btId, authMethodCertificates=authMethodCertificates, vlanRowId=vlanRowId, serviceId=serviceId, connectionLoginAttemptCnt=connectionLoginAttemptCnt, cctVpnConfChange=cctVpnConfChange, adminUserTable=adminUserTable, hostGrpMemRowStatus=hostGrpMemRowStatus, hostGrpTable=hostGrpTable, btName=btName, cctUserConfChange=cctUserConfChange, exRdAccServName=exRdAccServName, schedGrpName=schedGrpName, vlanGrpRowStatus=vlanGrpRowStatus, fixedIpAddrTable=fixedIpAddrTable, nativeUserRadAcctServId=nativeUserRadAcctServId, mIntDhcpStartIpAddr=mIntDhcpStartIpAddr, connectionAP=connectionAP, ipsecConfDiffieHellmanGrp5=ipsecConfDiffieHellmanGrp5, policyAction=policyAction, mIntNetbiosNameServ=mIntNetbiosNameServ, fixedIpAddrRoleId=fixedIpAddrRoleId, exNtlmServName=exNtlmServName, pptpEncryption128Bit=pptpEncryption128Bit, exLdapServUniqueId=exLdapServUniqueId, serviceTable=serviceTable, ex802AuthServPort=ex802AuthServPort, sysStatLOgSpaceUsed=sysStatLOgSpaceUsed, ipsecConfEspTripleDESWithMD5=ipsecConfEspTripleDESWithMD5, exServId=exServId, certOrg=certOrg, apCheckTime=apCheckTime, tZone=tZone, certId=certId, exLdapServRowStatus=exLdapServRowStatus, fixedIpAddrEntry=fixedIpAddrEntry, ex802AuthServEntry=ex802AuthServEntry, exLdapServAddr=exLdapServAddr, httpLangChangeChoice=httpLangChangeChoice, mIntDefaultLease=mIntDefaultLease, mIntMaximumLease=mIntMaximumLease, subnetIpConfIdInUse=subnetIpConfIdInUse, roleUnGuestLogin=roleUnGuestLogin, policy=policy, schedRowStatus=schedRowStatus, BlueIpAddress=BlueIpAddress, hostGrpMemEntry=hostGrpMemEntry, schedGrpId=schedGrpId, serviceMgmtOptStatus=serviceMgmtOptStatus, ipsecConfPsfMode=ipsecConfPsfMode, apSnmpCommunity=apSnmpCommunity, policyServiceId=policyServiceId, certContent=certContent, policyVlanId=policyVlanId, exRdAccServEntry=exRdAccServEntry, ipsecConfEntry=ipsecConfEntry, hostGrpId=hostGrpId, http=http, ipsecConfId=ipsecConfId, nativeUserEntry=nativeUserEntry, mIntProxyArpStatus=mIntProxyArpStatus, roleId=roleId, certPkeySize=certPkeySize, nativeUserName=nativeUserName, adminUsers=adminUsers, exRdAccServPort=exRdAccServPort, schedGrpMemRowStatus=schedGrpMemRowStatus, cctProcessConfChange=cctProcessConfChange, btConditionalEvent=btConditionalEvent, pIntGetIpFromDhcp=pIntGetIpFromDhcp, schedTable=schedTable)
mibBuilder.exportSymbols("BLUESERVER-MIB", exLdapServSslClient=exLdapServSslClient, exNtlmServState=exNtlmServState, autoBkupFtpDestDir=autoBkupFtpDestDir, roleVpn=roleVpn, roleEntry=roleEntry, macDevAuthId=macDevAuthId, roleQosUserIn=roleQosUserIn, exUserRuleEntry=exUserRuleEntry, adUsrAccessMaintance=adUsrAccessMaintance, certStartDate=certStartDate, adminUserStatus=adminUserStatus, connectionMac=connectionMac, httpRootCaUrl=httpRootCaUrl, logMaxRemSysLogLevel=logMaxRemSysLogLevel, schedName=schedName, stThresholdToSendTrap=stThresholdToSendTrap, adUsrAccessSchedules=adUsrAccessSchedules, appLogLevName=appLogLevName, tNtpServers=tNtpServers, slaveAddress=slaveAddress, sysStatDiskSpaceFree=sysStatDiskSpaceFree, policyTable=policyTable, exNtlmServMsad=exNtlmServMsad, authenticationMethod=authenticationMethod, policyScheduleId=policyScheduleId, vlanGrpId=vlanGrpId, exUserRuleSeqId=exUserRuleSeqId, exNtlmServRdAccState=exNtlmServRdAccState, schedRowId=schedRowId, snmpTrapMgmtIpAddress=snmpTrapMgmtIpAddress, serviceCosPriorityOut=serviceCosPriorityOut, l2tpRemoteIpStartAddr=l2tpRemoteIpStartAddr, pIntPrimaryDNS=pIntPrimaryDNS, ntyobjLevel=ntyobjLevel, schedAllDay=schedAllDay, LocalDateAndTime=LocalDateAndTime, adUsrAccessRoles=adUsrAccessRoles, exRdAuthServRowStatus=exRdAuthServRowStatus, exLdapServId=exLdapServId, subnetVpnRtFirstIp=subnetVpnRtFirstIp, pIntNetmask=pIntNetmask, serviceGrpMemEntry=serviceGrpMemEntry, l2tpLocalIpAddr=l2tpLocalIpAddr, exRdAuthServPrecedence=exRdAuthServPrecedence, exAuthServer=exAuthServer, exUserRuleRowStatus=exUserRuleRowStatus, noOfFailedBeats=noOfFailedBeats, machineRole=machineRole, exNtlmServRdAccId=exNtlmServRdAccId, serviceProtocol=serviceProtocol, pIntVlanId=pIntVlanId, btUserLoginFailure=btUserLoginFailure, mIntDnsDomainName=mIntDnsDomainName, exRdAuthServNotes=exRdAuthServNotes, slaveRowStatus=slaveRowStatus, cctRoleConfChange=cctRoleConfChange, certIssuer=certIssuer, vlanTable=vlanTable, adUsrAccessVpn=adUsrAccessVpn, subnetVpnRtLastIp=subnetVpnRtLastIp, ipsecConfTable=ipsecConfTable, ipsecConfEspTripleDESWithSHA1=ipsecConfEspTripleDESWithSHA1, btDiskUsageEvent=btDiskUsageEvent, hostGrpMemId=hostGrpMemId, adUsrAccessNetwork=adUsrAccessNetwork, hostType=hostType, mIntEnableDhcpRelay=mIntEnableDhcpRelay, ex802AuthServId=ex802AuthServId, tSeconds=tSeconds, slaveEntry=slaveEntry, serviceMgmtTable=serviceMgmtTable, vlanEntry=vlanEntry, blueSocket=blueSocket, httpRedirectToHostName=httpRedirectToHostName, connectionRoamMac=connectionRoamMac, adUsrAccessDestination=adUsrAccessDestination, exRdAuthServEntry=exRdAuthServEntry, blueGeneralTraps0=blueGeneralTraps0, policyId=policyId, exRdAuthServState=exRdAuthServState, connectionCheckTime=connectionCheckTime, exLdapServPrecedence=exLdapServPrecedence, httpAdminACL=httpAdminACL, connectionBytes=connectionBytes, authMethodPreSharedKeys=authMethodPreSharedKeys, btMemSwapUsageEvent=btMemSwapUsageEvent, connectionCurRate=connectionCurRate, hostGrpEntry=hostGrpEntry, cctExternalServConfChange=cctExternalServConfChange, serviceGrpMemTable=serviceGrpMemTable, adminUserRowStatus=adminUserRowStatus, replication=replication, connectionUnReg=connectionUnReg, blueTraps=blueTraps, appLogLevId=appLogLevId, exLdapServState=exLdapServState, hostId=hostId, certRowStatus=certRowStatus, certificate=certificate, adUsrAccessConfiguration=adUsrAccessConfiguration, systemStats=systemStats, mIntDhcpServerOpt=mIntDhcpServerOpt, ex802AuthServState=ex802AuthServState, ex802AuthServRowStatus=ex802AuthServRowStatus, roleQosUserOut=roleQosUserOut, certPkey=certPkey, nativeUserEmailId=nativeUserEmailId, nativeUserPassword=nativeUserPassword, tNtpSync=tNtpSync, refreshThresholdInKbs=refreshThresholdInKbs, adUsrAccessEntry=adUsrAccessEntry, userSummary=userSummary, blueThresholdTraps=blueThresholdTraps, connectionEntry=connectionEntry, exNtlmServDomainName=exNtlmServDomainName, vlanRowStatus=vlanRowStatus, pptpIdleTimeout=pptpIdleTimeout, schedGrpEntry=schedGrpEntry, btEventOptStatus=btEventOptStatus, publicAccess=publicAccess, remoteLog=remoteLog, nativeUsers=nativeUsers, ntyobjName=ntyobjName, hostGrpRowStatus=hostGrpRowStatus, pIntDhcpTimeout=pIntDhcpTimeout, ipsecConfEnableConfiguration=ipsecConfEnableConfiguration, connectionExpiry=connectionExpiry, roleQosPriorityOut=roleQosPriorityOut, schedWeekDay=schedWeekDay, fixedIpAddrId=fixedIpAddrId, exLdapServRdAccId=exLdapServRdAccId, mIntTable=mIntTable, exRdAuthServDefRoleId=exRdAuthServDefRoleId, roleQosDscpInOverride=roleQosDscpInOverride, pIntTable=pIntTable, certSignAlgo=certSignAlgo, ipsecConfName=ipsecConfName, serviceNotes=serviceNotes, exLdapServNotes=exLdapServNotes, schedStartDateAndTime=schedStartDateAndTime, snmpTrapConf=snmpTrapConf, statusRefreshTime=statusRefreshTime, serviceMgmtDesr=serviceMgmtDesr, certSerial=certSerial, exNtlmServId=exNtlmServId, exRdAccServNotes=exRdAccServNotes, macDevAuthRowStatus=macDevAuthRowStatus, vlanGrpMemTable=vlanGrpMemTable, roleName=roleName, adUsrAccessVlans=adUsrAccessVlans, exLdapServFilters=exLdapServFilters, exUserRuleValue=exUserRuleValue, ex802AuthServDefaultRole=ex802AuthServDefaultRole, exUserRuleId=exUserRuleId, configuration=configuration, mIntMulticastOpt=mIntMulticastOpt, pIntId=pIntId, fixedIpAddrAddress=fixedIpAddrAddress, stThresholdToLogMessage=stThresholdToLogMessage, hostNetmask=hostNetmask, logMaxLogEntries=logMaxLogEntries, btSysGeneralFailure=btSysGeneralFailure, exUserRuleOperator=exUserRuleOperator, roleUnUserLogin=roleUnUserLogin, httpRedirect=httpRedirect, interface=interface, confLogGroup=confLogGroup, userSumNoOfLogdInUsr=userSumNoOfLogdInUsr, mIntRowStatus=mIntRowStatus, systemTracker=systemTracker, exRdAuthServPort=exRdAuthServPort, pIntVlanInterface=pIntVlanInterface, roleVlanId=roleVlanId, vlanId=vlanId, adminUserEntry=adminUserEntry, macDevAuthDefaultRole=macDevAuthDefaultRole, usmSumTtlBandWthInUse=usmSumTtlBandWthInUse, pIntSecondaryDNS=pIntSecondaryDNS, vlanGrpMemEntry=vlanGrpMemEntry, subnetVpnSharedSec=subnetVpnSharedSec, maxLifeTimeInSecs=maxLifeTimeInSecs, paFixedIpClientAccess=paFixedIpClientAccess, roleQosDscpOutOverride=roleQosDscpOutOverride, vlanGrpEntry=vlanGrpEntry, l2tp=l2tp, serviceMgmtEntry=serviceMgmtEntry, userSumNoOfLogdVPNUsr=userSumNoOfLogdVPNUsr, tMinutes=tMinutes, adUsrAccessMacDev=adUsrAccessMacDev, ipsecConfEsp256BitAESWithMD5=ipsecConfEsp256BitAESWithMD5, ex802AuthServAddr=ex802AuthServAddr, slaveNotes=slaveNotes, autoBkupFtpServPasswd=autoBkupFtpServPasswd, natRowStatus=natRowStatus, httpAttemptWait=httpAttemptWait, slaveId=slaveId, btLinkDown=btLinkDown, adminUserName=adminUserName, certEndDate=certEndDate, policyRowStatus=policyRowStatus, service=service, schedGrpMemTable=schedGrpMemTable, exRdAccServState=exRdAccServState, mIntDynamicDNS=mIntDynamicDNS, stThresholdEntry=stThresholdEntry, connectionLoginAttempt=connectionLoginAttempt, ipsecConfEsp192BitAESWithSHA1=ipsecConfEsp192BitAESWithSHA1, httpDefaultUrl=httpDefaultUrl, connectionTable=connectionTable, blueConfigTraps0=blueConfigTraps0, pptp=pptp, natManagedIp=natManagedIp, adminUserAccess=adminUserAccess, exUserRuleTable=exUserRuleTable, hostRowStatus=hostRowStatus, tMonth=tMonth, serviceGrpId=serviceGrpId, macDevAuthMac=macDevAuthMac, sysStatTotalDiskSpace=sysStatTotalDiskSpace, adUsrAccessAdminUser=adUsrAccessAdminUser, exRdAccServTable=exRdAccServTable, vlanName=vlanName, nativeUserTable=nativeUserTable, stThresholdTable=stThresholdTable, macDevAuthName=macDevAuthName, exRdAuthServId=exRdAuthServId, mobility=mobility, servicePort=servicePort, l2tpRoleId=l2tpRoleId, serviceCosPriorityIn=serviceCosPriorityIn, snmpTrapMgmtId=snmpTrapMgmtId, schedMonth=schedMonth, pIntEntry=pIntEntry, minLifeTimeInKbs=minLifeTimeInKbs, ntyobjOID=ntyobjOID, macDevAuthState=macDevAuthState, ipsecConfEsp56BitDESWithMD5=ipsecConfEsp56BitDESWithMD5, pIntName=pIntName, slaveEnabled=slaveEnabled, slaveTable=slaveTable, nativeUserFixedIpAddr=nativeUserFixedIpAddr, policyEntry=policyEntry, vlan=vlan, genSnapshot=genSnapshot, appLogLevTable=appLogLevTable, roleRedirect=roleRedirect, snmpTrapMgmtCommunity=snmpTrapMgmtCommunity, serviceEntry=serviceEntry, connectionRoleId=connectionRoleId, exNtlmServRowStatus=exNtlmServRowStatus, certName=certName, blueGeneralTraps=blueGeneralTraps, httpAutoPause=httpAutoPause, mIntDhcpEndIpAddr=mIntDhcpEndIpAddr)
mibBuilder.exportSymbols("BLUESERVER-MIB", appLogLevLevel=appLogLevLevel, cctDestinationConfChange=cctDestinationConfChange, connectionId=connectionId, exNtlmServEntry=exNtlmServEntry, blueFailureTraps0=blueFailureTraps0, exRdAuthServAddr=exRdAuthServAddr, userSumNoOfUsr=userSumNoOfUsr, sysStatMemUtil=sysStatMemUtil, roleQosRateOut=roleQosRateOut, idleTimeout=idleTimeout, btSystemFailover=btSystemFailover, policyHostId=policyHostId, ipsecConfDiffieHellmanGrp2=ipsecConfDiffieHellmanGrp2, BlueMacAddress=BlueMacAddress, connectionIp=connectionIp, roleRowStatus=roleRowStatus, subnetVpn=subnetVpn, fixedIpAddrRowStatus=fixedIpAddrRowStatus, exNtlmServMsrpc=exNtlmServMsrpc, autoBkupFtpServName=autoBkupFtpServName, autoBkupRate=autoBkupRate, httpChainCertChangeChoice=httpChainCertChangeChoice, ipsecConfEsp256BitAESWithSHA1=ipsecConfEsp256BitAESWithSHA1, exRdAccServRowStatus=exRdAccServRowStatus, exRdAccServId=exRdAccServId, schedEveryDay=schedEveryDay, roleTable=roleTable, httpPasswdChangeChoice=httpPasswdChangeChoice, connectionUserId=connectionUserId, adminUserId=adminUserId, adUsrAccessReplication=adUsrAccessReplication, l2tpIdleTimeout=l2tpIdleTimeout, roleInherit=roleInherit, logStorage=logStorage, natId=natId, pIntRowStatus=pIntRowStatus, adUsrAccessServices=adUsrAccessServices, certEntry=certEntry, serviceCosDscpOut=serviceCosDscpOut, pIntProxyArpStatus=pIntProxyArpStatus, serviceRowStatus=serviceRowStatus, serviceGrpEntry=serviceGrpEntry, roleType=roleType, ntyobjDesc=ntyobjDesc, exRdAccServSecret=exRdAccServSecret, pIntDefaultDomain=pIntDefaultDomain, pptpEnable=pptpEnable, mIntId=mIntId, tHours=tHours, hostNotes=hostNotes, serviceCosDscpIn=serviceCosDscpIn, adUsrAccessNativeUser=adUsrAccessNativeUser, exchangeMode=exchangeMode, ntyobjValue=ntyobjValue, managed=managed, vlanNotes=vlanNotes, nativeUserNotes=nativeUserNotes, statistics=statistics, hostGrpMemTable=hostGrpMemTable, adUsrAccessAccounting=adUsrAccessAccounting, blueServer=blueServer, blueThresholdTraps0=blueThresholdTraps0, exLdapServDefRoleId=exLdapServDefRoleId)
