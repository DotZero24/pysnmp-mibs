# SNMP MIB module (ALCATEL-ENT1-MAC-SERVER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-MAC-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:09:34 2025
...
chasMacAddrRangeTableEntry.setIndexNames(
    ...
    (0, "ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacRangeIndex"),
)
if mibBuilder.loadTexts:
...
chasMacAddressAllocTableEntry.setIndexNames(
    (0, "ALCATEL-ENT1-MAC-SERVER-MIB", "chasAppId"),
    (0, "ALCATEL-ENT1-MAC-SERVER-MIB", "chasObjectId"),
)
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    chasRingStatus.setStatus("deprecated")
...
chasMacAddrRangeGroup.setObjects(
      *(("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacAddressStart"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacAddressCount"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasGlobalLocal"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacRowStatus"))
)
if mibBuilder.loadTexts:
...
chasMacAddressAllocGroup.setObjects(
      *(("ALCATEL-ENT1-MAC-SERVER-MIB", "chasAllocMacRangeIndex"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasAllocMacAddress"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasAllocRowStatus"))
)
if mibBuilder.loadTexts:
...
chasMacAddrDupAllocStatusGroup.setObjects(
      *(("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacAddrDuplicationStatus"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacAddrAllocLocallyAdminStatus"))
)
if mibBuilder.loadTexts:
...
chasMacAddrRetentionGroup.setObjects(
      *(("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacAddrRetentionStatus"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasPossibleDuplicateMacTrapStatus"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasRingStatus"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasBaseMacAddrSource"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasBaseMacAddr"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasBaseMacReleaseAction"),
...
chasNotificationObjectGroup.setObjects(
      *(("ALCATEL-ENT1-MAC-SERVER-MIB", "baseMacAddress"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasTrapMacRangeIndex"))
)
if mibBuilder.loadTexts:
...
chasTrapsMacOverlapGroup.setObjects(
    ("ALCATEL-ENT1-MAC-SERVER-MIB", "chassisTrapsMacOverlap")
)
if mibBuilder.loadTexts:
...
chasTrapsPossibleDuplicateMacGroup.setObjects(
      *(("ALCATEL-ENT1-MAC-SERVER-MIB", "chassisTrapsPossibleDuplicateMac"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chassisTrapsDuplicateMacCleared"))
)
if mibBuilder.loadTexts:
...
alcatelIND1MacServerMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacAddrRangeGroup"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacAddressAllocGroup"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacAddrDupAllocStatusGroup"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasTrapsMacOverlapGroup"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasMacAddrRetentionGroup"),
        ("ALCATEL-ENT1-MAC-SERVER-MIB", "chasTrapsPossibleDuplicateMacGroup"))
)
if mibBuilder.loadTexts:
