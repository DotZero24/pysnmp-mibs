...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-DMN-DSG-PRGMENTRY-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:28:30 2025
...
mibBuilder.exportSymbols("CISCO-DMN-DSG-PRGMENTRY-MIB", programEntryControlTable=programEntryControlTable, programEntryStatusSRType=programEntryStatusSRType, programEntryStatusSRStatus=programEntryStatusSRStatus, programEntryPIDIndex=programEntryPIDIndex, programEntryTable=programEntryTable, programEntryStatusTable=programEntryStatusTable, programEntryStatusCAScram=programEntryStatusCAScram, programEntryPIDTypeDetail=programEntryPIDTypeDetail, programEntryPIDPEIndex=programEntryPIDPEIndex, programEntryStatusPMTPID=programEntryStatusPMTPID, ciscoDSGProgramEntry=ciscoDSGProgramEntry, programEntryStatusSRStartTime=programEntryStatusSRStartTime, programEntryPIDTable=programEntryPIDTable, programEntryControlIndex=programEntryControlIndex, programEntryStatusPCRPID=programEntryStatusPCRPID, programEntryPIDPresent=programEntryPIDPresent, programEntryControlResourceId=programEntryControlResourceId, programEntryStatusChName=programEntryStatusChName, programEntryControlChCmd=programEntryControlChCmd, programEntryPIDEntry=programEntryPIDEntry, programEntryControlEntry=programEntryControlEntry, programEntryStatusEntry=programEntryStatusEntry, programEntryStatusIndex=programEntryStatusIndex, programEntryStatusCAID=programEntryStatusCAID, programEntryStatusCAAuth=programEntryStatusCAAuth, programEntryPIDTypeName=programEntryPIDTypeName, programEntryStatusPRGMStatus=programEntryStatusPRGMStatus, programEntryStatusSREndTime=programEntryStatusSREndTime, programEntryPIDValue=programEntryPIDValue, programEntryStatusCAEncry=programEntryStatusCAEncry, programEntryControlChNum=programEntryControlChNum, PYSNMP_MODULE_ID=ciscoDSGProgramEntry)
