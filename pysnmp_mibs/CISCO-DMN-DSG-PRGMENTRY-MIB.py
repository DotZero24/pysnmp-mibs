...
mibBuilder.exportSymbols("CISCO-DMN-DSG-PRGMENTRY-MIB", programEntryStatusPMTPID=programEntryStatusPMTPID, programEntryPIDValue=programEntryPIDValue, programEntryControlEntry=programEntryControlEntry, programEntryStatusTable=programEntryStatusTable, programEntryPIDTypeName=programEntryPIDTypeName, programEntryStatusPCRPID=programEntryStatusPCRPID, programEntryPIDTable=programEntryPIDTable, programEntryStatusChName=programEntryStatusChName, programEntryPIDPEIndex=programEntryPIDPEIndex, programEntryPIDPresent=programEntryPIDPresent, programEntryStatusCAScram=programEntryStatusCAScram, programEntryControlResourceId=programEntryControlResourceId, programEntryControlIndex=programEntryControlIndex, programEntryStatusSRStartTime=programEntryStatusSRStartTime, programEntryPIDTypeDetail=programEntryPIDTypeDetail, programEntryStatusIndex=programEntryStatusIndex, programEntryStatusCAID=programEntryStatusCAID, programEntryControlChCmd=programEntryControlChCmd, ciscoDSGProgramEntry=ciscoDSGProgramEntry, programEntryStatusSREndTime=programEntryStatusSREndTime, programEntryStatusCAEncry=programEntryStatusCAEncry, programEntryControlChNum=programEntryControlChNum, programEntryStatusCAAuth=programEntryStatusCAAuth, programEntryStatusPRGMStatus=programEntryStatusPRGMStatus, programEntryStatusSRStatus=programEntryStatusSRStatus, programEntryStatusSRType=programEntryStatusSRType, programEntryPIDIndex=programEntryPIDIndex, programEntryControlTable=programEntryControlTable, programEntryPIDEntry=programEntryPIDEntry, programEntryTable=programEntryTable, PYSNMP_MODULE_ID=ciscoDSGProgramEntry, programEntryStatusEntry=programEntryStatusEntry)
