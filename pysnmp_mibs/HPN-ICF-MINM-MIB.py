...
mibBuilder.exportSymbols("HPN-ICF-MINM-MIB", hpnicfMinmUplinkTable=hpnicfMinmUplinkTable, hpnicfMinmConnectionLinkId=hpnicfMinmConnectionLinkId, PYSNMP_MODULE_ID=hpnicfMinm, hpnicfMinmVsiEntry=hpnicfMinmVsiEntry, hpnicfMinmConnectionTable=hpnicfMinmConnectionTable, HpnicfMinmEnabledStatus=HpnicfMinmEnabledStatus, hpnicfMinmConnectionPort=hpnicfMinmConnectionPort, hpnicfMinmConnectionRowStatus=hpnicfMinmConnectionRowStatus, hpnicfMinmUplinkRowStatus=hpnicfMinmUplinkRowStatus, hpnicfMinmObjects=hpnicfMinmObjects, hpnicfMinmVsiNextAvailableLinkId=hpnicfMinmVsiNextAvailableLinkId, hpnicfMinmConnectionEntry=hpnicfMinmConnectionEntry, hpnicfMinmVsiReEncapsulation=hpnicfMinmVsiReEncapsulation, hpnicfMinmConnectionAgingStatus=hpnicfMinmConnectionAgingStatus, hpnicfMinmConnectionBmac=hpnicfMinmConnectionBmac, hpnicfMinmVsiTable=hpnicfMinmVsiTable, hpnicfMinmConnectionStatus=hpnicfMinmConnectionStatus, hpnicfMinmBmac=hpnicfMinmBmac, hpnicfMinmConnectionBvlan=hpnicfMinmConnectionBvlan, hpnicfMinm=hpnicfMinm, hpnicfMinmScalarGroup=hpnicfMinmScalarGroup, hpnicfMinmCapabilities=hpnicfMinmCapabilities, hpnicfMinmVsiBvlan=hpnicfMinmVsiBvlan, hpnicfMinmUplinkEntry=hpnicfMinmUplinkEntry)
