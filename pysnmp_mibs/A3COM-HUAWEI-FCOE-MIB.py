# SNMP MIB module (A3COM-HUAWEI-FCOE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-FCOE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:45:37 2025
...
h3cFCoEVLANEntry.setIndexNames(
    (0, "FC-MGMT-MIB", "fcmInstanceIndex"),
    (0, "A3COM-HUAWEI-FCOE-MIB", "h3cFCoEVLANIndex"),
    (0, "A3COM-HUAWEI-FCOE-MIB", "h3cFCoEFabricIndex"),
)
if mibBuilder.loadTexts:
...
h3cFCoEStaticVfcEntry.setIndexNames(
    (0, "FC-MGMT-MIB", "fcmInstanceIndex"),
    (0, "A3COM-HUAWEI-FCOE-MIB", "h3cFCoEStaticVfcIndex"),
)
if mibBuilder.loadTexts:
...
h3cFCoEStaticVfcIfIndex = _H3cFCoEStaticVfcIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 120, 1, 1, 3, 1, 6),
...
h3cFCoEStaticVfcCreationTime = _H3cFCoEStaticVfcCreationTime_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 120, 1, 1, 3, 1, 7),
...
h3cFCoEFIPSnoopingObjects = _H3cFCoEFIPSnoopingObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 120, 1, 2)
)
