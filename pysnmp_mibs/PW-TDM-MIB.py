_AU='pwTDMPerf1DayIntervalGroup'
_AT='pwTDMPerfIntervalGroup'
_AS='pwTDMPerfCurrentGroup'
_AR='pwTDMGroup'
_AQ='pwTDMPerf1DayIntervalFC'
_AP='pwTDMPerf1DayIntervalUASs'
_AO='pwTDMPerf1DayIntervalSESs'
_AN='pwTDMPerf1DayIntervalESs'
_AM='pwTDMPerf1DayIntervalMalformedPkt'
_AL='pwTDMPerf1DayIntervalMisOrderDropped'
_AK='pwTDMPerf1DayIntervalJtrBfrUnderruns'
_AJ='pwTDMPerf1DayIntervalPktsReOrder'
_AI='pwTDMPerf1DayIntervalMissingPkts'
_AH='pwTDMPerf1DayIntervalDuration'
_AG='pwTDMPerf1DayIntervalValidData'
_AF='pwTDMPerfIntervalFC'
_AE='pwTDMPerfIntervalUASs'
_AD='pwTDMPerfIntervalSESs'
_AC='pwTDMPerfIntervalESs'
_AB='pwTDMPerfIntervalMalformedPkt'
_AA='pwTDMPerfIntervalMisOrderDropped'
_A9='pwTDMPerfIntervalJtrBfrUnderruns'
_A8='pwTDMPerfIntervalPktsReOrder'
_A7='pwTDMPerfIntervalMissingPkts'
_A6='pwTDMPerfIntervalDuration'
_A5='pwTDMPerfIntervalValidData'
_A4='pwTDMPerfCurrentFC'
_A3='pwTDMPerfCurrentUASs'
_A2='pwTDMPerfCurrentSESs'
_A1='pwTDMPerfCurrentESs'
_A0='pwTDMPerfCurrentMalformedPkt'
_z='pwTDMPerfCurrentMisOrderDropped'
_y='pwTDMPerfCurrentJtrBfrUnderruns'
_x='pwTDMPerfCurrentPktsReOrder'
_w='pwTDMPerfCurrentMissingPkts'
_v='pwTDMCfgName'
_u='pwTDMCfgPktFiller'
_t='pwTDMCfgStorageType'
_s='pwTDMCfgTimestampMode'
_r='pwTDMCfgMissingPktsToSes'
_q='pwTDMCfgClearAlarmThreshold'
_p='pwTDMCfgAlarmThreshold'
_o='pwTDMCfgExcessivePktLossThreshold'
_n='pwTDMCfgAvePktLossTimeWindow'
_m='pwTDMCfgPktReplacePolicy'
_l='pwTDMCfgSetUp2SynchTimeOut'
_k='pwTDMCfgConsecMissPktsOutSynch'
_j='pwTDMCfgConsecPktsInSynch'
_i='pwTDMCfgPayloadSuppression'
_h='pwTDMCfgJtrBfrDepth'
_g='pwTDMCfgRtpHdrUsed'
_f='pwTDMCfgPktReorder'
_e='pwTDMCfgPayloadSize'
_d='pwTDMCfgRowStatus'
_c='pwTDMCfgIndexNext'
_b='pwTDMLastEsTimeStamp'
_a='pwTDMValidDayIntervals'
_Z='pwTDMValidIntervals'
_Y='pwTDMTimeElapsed'
_X='pwTDMConfigError'
_W='pwRelTDMCfgIndex'
_V='pwGenTDMCfgIndex'
_U='pwTDMIfIndex'
_T='pwTDMRate'
_S='pwTDMPerf1DayIntervalNumber'
_R='seconds'
_Q='pwTDMPerfIntervalNumber'
_P='milisec'
_O='Percent'
_N='millisecond'
_M='pwTDMCfgIndex'
...
if mibBuilder.loadTexts:pwTDMMIB.setRevisions(('2009-06-15 00:00',))
...
pwTDMNotifications=_PwTDMNotifications_ObjectIdentity((1,3,6,1,2,1,186,0))
_PwTDMObjects_ObjectIdentity=ObjectIdentity
pwTDMObjects=_PwTDMObjects_ObjectIdentity((1,3,6,1,2,1,186,1))
_PwTDMTable_Object=MibTable
pwTDMTable=_PwTDMTable_Object((1,3,6,1,2,1,186,1,1))
if mibBuilder.loadTexts:pwTDMTable.setStatus(_A)
_PwTDMEntry_Object=MibTableRow
pwTDMEntry=_PwTDMEntry_Object((1,3,6,1,2,1,186,1,1,1))
...
pwTDMRate=_PwTDMRate_Object((1,3,6,1,2,1,186,1,1,1,1),_PwTDMRate_Type())
pwTDMRate.setMaxAccess(_I)
if mibBuilder.loadTexts:pwTDMRate.setStatus(_A)
_PwTDMIfIndex_Type=InterfaceIndexOrZero
_PwTDMIfIndex_Object=MibTableColumn
pwTDMIfIndex=_PwTDMIfIndex_Object((1,3,6,1,2,1,186,1,1,1,2),_PwTDMIfIndex_Type())
pwTDMIfIndex.setMaxAccess(_I)
...
pwGenTDMCfgIndex=_PwGenTDMCfgIndex_Object((1,3,6,1,2,1,186,1,1,1,3),_PwGenTDMCfgIndex_Type())
pwGenTDMCfgIndex.setMaxAccess(_I)
...
pwRelTDMCfgIndex=_PwRelTDMCfgIndex_Object((1,3,6,1,2,1,186,1,1,1,4),_PwRelTDMCfgIndex_Type())
pwRelTDMCfgIndex.setMaxAccess(_I)
if mibBuilder.loadTexts:pwRelTDMCfgIndex.setStatus(_A)
class _PwTDMConfigError_Type(Bits):namedValues=NamedValues(*((_L,0),('tdmTypeIncompatible',1),('peerRtpIncompatible',2),('peerPayloadSizeIncompatible',3)))
_PwTDMConfigError_Type.__name__='Bits'
_PwTDMConfigError_Object=MibTableColumn
pwTDMConfigError=_PwTDMConfigError_Object((1,3,6,1,2,1,186,1,1,1,5),_PwTDMConfigError_Type())
...
pwTDMTimeElapsed=_PwTDMTimeElapsed_Object((1,3,6,1,2,1,186,1,1,1,6),_PwTDMTimeElapsed_Type())
...
pwTDMValidIntervals=_PwTDMValidIntervals_Object((1,3,6,1,2,1,186,1,1,1,7),_PwTDMValidIntervals_Type())
...
pwTDMValidDayIntervals=_PwTDMValidDayIntervals_Object((1,3,6,1,2,1,186,1,1,1,8),_PwTDMValidDayIntervals_Type())
...
pwTDMLastEsTimeStamp=_PwTDMLastEsTimeStamp_Object((1,3,6,1,2,1,186,1,1,1,11),_PwTDMLastEsTimeStamp_Type())
...
pwTDMCfgIndexNext=_PwTDMCfgIndexNext_Object((1,3,6,1,2,1,186,1,2),_PwTDMCfgIndexNext_Type())
pwTDMCfgIndexNext.setMaxAccess(_C)
if mibBuilder.loadTexts:pwTDMCfgIndexNext.setStatus(_A)
_PwTDMCfgTable_Object=MibTable
pwTDMCfgTable=_PwTDMCfgTable_Object((1,3,6,1,2,1,186,1,3))
if mibBuilder.loadTexts:pwTDMCfgTable.setStatus(_A)
_PwTDMCfgEntry_Object=MibTableRow
pwTDMCfgEntry=_PwTDMCfgEntry_Object((1,3,6,1,2,1,186,1,3,1))
pwTDMCfgEntry.setIndexNames((0,_B,_M))
if mibBuilder.loadTexts:pwTDMCfgEntry.setStatus(_A)
_PwTDMCfgIndex_Type=PwTDMCfgIndex
_PwTDMCfgIndex_Object=MibTableColumn
pwTDMCfgIndex=_PwTDMCfgIndex_Object((1,3,6,1,2,1,186,1,3,1,1),_PwTDMCfgIndex_Type())
pwTDMCfgIndex.setMaxAccess(_J)
...
pwTDMCfgRowStatus=_PwTDMCfgRowStatus_Object((1,3,6,1,2,1,186,1,3,1,2),_PwTDMCfgRowStatus_Type())
...
pwTDMCfgPayloadSize=_PwTDMCfgPayloadSize_Object((1,3,6,1,2,1,186,1,3,1,4),_PwTDMCfgPayloadSize_Type())
...
pwTDMCfgPktReorder=_PwTDMCfgPktReorder_Object((1,3,6,1,2,1,186,1,3,1,5),_PwTDMCfgPktReorder_Type())
...
_PwTDMCfgRtpHdrUsed_Type.__name__=_K
_PwTDMCfgRtpHdrUsed_Object=MibTableColumn
pwTDMCfgRtpHdrUsed=_PwTDMCfgRtpHdrUsed_Object((1,3,6,1,2,1,186,1,3,1,6),_PwTDMCfgRtpHdrUsed_Type())
...
pwTDMCfgJtrBfrDepth=_PwTDMCfgJtrBfrDepth_Object((1,3,6,1,2,1,186,1,3,1,7),_PwTDMCfgJtrBfrDepth_Type())
...
pwTDMCfgPayloadSuppression=_PwTDMCfgPayloadSuppression_Object((1,3,6,1,2,1,186,1,3,1,8),_PwTDMCfgPayloadSuppression_Type())
pwTDMCfgPayloadSuppression.setMaxAccess(_D)
if mibBuilder.loadTexts:pwTDMCfgPayloadSuppression.setStatus(_A)
class _PwTDMCfgConsecPktsInSynch_Type(Unsigned32):defaultValue=2;subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,10))
_PwTDMCfgConsecPktsInSynch_Type.__name__=_E
_PwTDMCfgConsecPktsInSynch_Object=MibTableColumn
pwTDMCfgConsecPktsInSynch=_PwTDMCfgConsecPktsInSynch_Object((1,3,6,1,2,1,186,1,3,1,9),_PwTDMCfgConsecPktsInSynch_Type())
pwTDMCfgConsecPktsInSynch.setMaxAccess(_D)
if mibBuilder.loadTexts:pwTDMCfgConsecPktsInSynch.setStatus(_A)
class _PwTDMCfgConsecMissPktsOutSynch_Type(Unsigned32):defaultValue=10;subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,15))
_PwTDMCfgConsecMissPktsOutSynch_Type.__name__=_E
_PwTDMCfgConsecMissPktsOutSynch_Object=MibTableColumn
pwTDMCfgConsecMissPktsOutSynch=_PwTDMCfgConsecMissPktsOutSynch_Object((1,3,6,1,2,1,186,1,3,1,10),_PwTDMCfgConsecMissPktsOutSynch_Type())
...
pwTDMCfgSetUp2SynchTimeOut=_PwTDMCfgSetUp2SynchTimeOut_Object((1,3,6,1,2,1,186,1,3,1,11),_PwTDMCfgSetUp2SynchTimeOut_Type())
pwTDMCfgSetUp2SynchTimeOut.setMaxAccess(_D)
if mibBuilder.loadTexts:pwTDMCfgSetUp2SynchTimeOut.setStatus(_A)
if mibBuilder.loadTexts:pwTDMCfgSetUp2SynchTimeOut.setUnits(_N)
...
pwTDMCfgPktReplacePolicy=_PwTDMCfgPktReplacePolicy_Object((1,3,6,1,2,1,186,1,3,1,12),_PwTDMCfgPktReplacePolicy_Type())
...
pwTDMCfgAvePktLossTimeWindow=_PwTDMCfgAvePktLossTimeWindow_Object((1,3,6,1,2,1,186,1,3,1,13),_PwTDMCfgAvePktLossTimeWindow_Type())
pwTDMCfgAvePktLossTimeWindow.setMaxAccess(_D)
if mibBuilder.loadTexts:pwTDMCfgAvePktLossTimeWindow.setStatus(_A)
if mibBuilder.loadTexts:pwTDMCfgAvePktLossTimeWindow.setUnits(_N)
_PwTDMCfgExcessivePktLossThreshold_Type=Unsigned32
_PwTDMCfgExcessivePktLossThreshold_Object=MibTableColumn
pwTDMCfgExcessivePktLossThreshold=_PwTDMCfgExcessivePktLossThreshold_Object((1,3,6,1,2,1,186,1,3,1,14),_PwTDMCfgExcessivePktLossThreshold_Type())
pwTDMCfgExcessivePktLossThreshold.setMaxAccess(_D)
if mibBuilder.loadTexts:pwTDMCfgExcessivePktLossThreshold.setStatus(_A)
if mibBuilder.loadTexts:pwTDMCfgExcessivePktLossThreshold.setUnits(_O)
...
pwTDMCfgAlarmThreshold=_PwTDMCfgAlarmThreshold_Object((1,3,6,1,2,1,186,1,3,1,15),_PwTDMCfgAlarmThreshold_Type())
pwTDMCfgAlarmThreshold.setMaxAccess(_D)
if mibBuilder.loadTexts:pwTDMCfgAlarmThreshold.setStatus(_A)
if mibBuilder.loadTexts:pwTDMCfgAlarmThreshold.setUnits(_P)
...
pwTDMCfgClearAlarmThreshold=_PwTDMCfgClearAlarmThreshold_Object((1,3,6,1,2,1,186,1,3,1,16),_PwTDMCfgClearAlarmThreshold_Type())
pwTDMCfgClearAlarmThreshold.setMaxAccess(_D)
if mibBuilder.loadTexts:pwTDMCfgClearAlarmThreshold.setStatus(_A)
if mibBuilder.loadTexts:pwTDMCfgClearAlarmThreshold.setUnits(_P)
...
pwTDMCfgMissingPktsToSes=_PwTDMCfgMissingPktsToSes_Object((1,3,6,1,2,1,186,1,3,1,17),_PwTDMCfgMissingPktsToSes_Type())
pwTDMCfgMissingPktsToSes.setMaxAccess(_D)
if mibBuilder.loadTexts:pwTDMCfgMissingPktsToSes.setStatus(_A)
if mibBuilder.loadTexts:pwTDMCfgMissingPktsToSes.setUnits(_O)
class _PwTDMCfgTimestampMode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_L,1),('absolute',2),('differential',3)))
_PwTDMCfgTimestampMode_Type.__name__=_F
_PwTDMCfgTimestampMode_Object=MibTableColumn
pwTDMCfgTimestampMode=_PwTDMCfgTimestampMode_Object((1,3,6,1,2,1,186,1,3,1,18),_PwTDMCfgTimestampMode_Type())
...
pwTDMCfgStorageType=_PwTDMCfgStorageType_Object((1,3,6,1,2,1,186,1,3,1,19),_PwTDMCfgStorageType_Type())
...
pwTDMCfgPktFiller=_PwTDMCfgPktFiller_Object((1,3,6,1,2,1,186,1,3,1,20),_PwTDMCfgPktFiller_Type())
...
pwTDMCfgName=_PwTDMCfgName_Object((1,3,6,1,2,1,186,1,3,1,21),_PwTDMCfgName_Type())
pwTDMCfgName.setMaxAccess(_D)
if mibBuilder.loadTexts:pwTDMCfgName.setStatus(_A)
_PwTDMPerfCurrentTable_Object=MibTable
pwTDMPerfCurrentTable=_PwTDMPerfCurrentTable_Object((1,3,6,1,2,1,186,1,5))
if mibBuilder.loadTexts:pwTDMPerfCurrentTable.setStatus(_A)
_PwTDMPerfCurrentEntry_Object=MibTableRow
pwTDMPerfCurrentEntry=_PwTDMPerfCurrentEntry_Object((1,3,6,1,2,1,186,1,5,1))
...
pwTDMPerfCurrentMissingPkts=_PwTDMPerfCurrentMissingPkts_Object((1,3,6,1,2,1,186,1,5,1,1),_PwTDMPerfCurrentMissingPkts_Type())
...
pwTDMPerfCurrentPktsReOrder=_PwTDMPerfCurrentPktsReOrder_Object((1,3,6,1,2,1,186,1,5,1,2),_PwTDMPerfCurrentPktsReOrder_Type())
...
pwTDMPerfCurrentJtrBfrUnderruns=_PwTDMPerfCurrentJtrBfrUnderruns_Object((1,3,6,1,2,1,186,1,5,1,3),_PwTDMPerfCurrentJtrBfrUnderruns_Type())
...
pwTDMPerfCurrentMisOrderDropped=_PwTDMPerfCurrentMisOrderDropped_Object((1,3,6,1,2,1,186,1,5,1,4),_PwTDMPerfCurrentMisOrderDropped_Type())
...
pwTDMPerfCurrentMalformedPkt=_PwTDMPerfCurrentMalformedPkt_Object((1,3,6,1,2,1,186,1,5,1,5),_PwTDMPerfCurrentMalformedPkt_Type())
...
pwTDMPerfCurrentESs=_PwTDMPerfCurrentESs_Object((1,3,6,1,2,1,186,1,5,1,6),_PwTDMPerfCurrentESs_Type())
...
pwTDMPerfCurrentSESs=_PwTDMPerfCurrentSESs_Object((1,3,6,1,2,1,186,1,5,1,7),_PwTDMPerfCurrentSESs_Type())
...
pwTDMPerfCurrentUASs=_PwTDMPerfCurrentUASs_Object((1,3,6,1,2,1,186,1,5,1,8),_PwTDMPerfCurrentUASs_Type())
...
pwTDMPerfCurrentFC=_PwTDMPerfCurrentFC_Object((1,3,6,1,2,1,186,1,5,1,9),_PwTDMPerfCurrentFC_Type())
...
pwTDMPerfIntervalTable=_PwTDMPerfIntervalTable_Object((1,3,6,1,2,1,186,1,6))
if mibBuilder.loadTexts:pwTDMPerfIntervalTable.setStatus(_A)
_PwTDMPerfIntervalEntry_Object=MibTableRow
pwTDMPerfIntervalEntry=_PwTDMPerfIntervalEntry_Object((1,3,6,1,2,1,186,1,6,1))
pwTDMPerfIntervalEntry.setIndexNames((0,_G,_H),(0,_B,_Q))
if mibBuilder.loadTexts:pwTDMPerfIntervalEntry.setStatus(_A)
class _PwTDMPerfIntervalNumber_Type(Unsigned32):subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,96))
_PwTDMPerfIntervalNumber_Type.__name__=_E
_PwTDMPerfIntervalNumber_Object=MibTableColumn
pwTDMPerfIntervalNumber=_PwTDMPerfIntervalNumber_Object((1,3,6,1,2,1,186,1,6,1,1),_PwTDMPerfIntervalNumber_Type())
pwTDMPerfIntervalNumber.setMaxAccess(_J)
...
pwTDMPerfIntervalValidData=_PwTDMPerfIntervalValidData_Object((1,3,6,1,2,1,186,1,6,1,2),_PwTDMPerfIntervalValidData_Type())
...
pwTDMPerfIntervalDuration=_PwTDMPerfIntervalDuration_Object((1,3,6,1,2,1,186,1,6,1,3),_PwTDMPerfIntervalDuration_Type())
pwTDMPerfIntervalDuration.setMaxAccess(_C)
if mibBuilder.loadTexts:pwTDMPerfIntervalDuration.setStatus(_A)
if mibBuilder.loadTexts:pwTDMPerfIntervalDuration.setUnits(_R)
_PwTDMPerfIntervalMissingPkts_Type=PerfIntervalCount
_PwTDMPerfIntervalMissingPkts_Object=MibTableColumn
pwTDMPerfIntervalMissingPkts=_PwTDMPerfIntervalMissingPkts_Object((1,3,6,1,2,1,186,1,6,1,4),_PwTDMPerfIntervalMissingPkts_Type())
...
pwTDMPerfIntervalPktsReOrder=_PwTDMPerfIntervalPktsReOrder_Object((1,3,6,1,2,1,186,1,6,1,5),_PwTDMPerfIntervalPktsReOrder_Type())
...
pwTDMPerfIntervalJtrBfrUnderruns=_PwTDMPerfIntervalJtrBfrUnderruns_Object((1,3,6,1,2,1,186,1,6,1,6),_PwTDMPerfIntervalJtrBfrUnderruns_Type())
...
pwTDMPerfIntervalMisOrderDropped=_PwTDMPerfIntervalMisOrderDropped_Object((1,3,6,1,2,1,186,1,6,1,7),_PwTDMPerfIntervalMisOrderDropped_Type())
...
pwTDMPerfIntervalMalformedPkt=_PwTDMPerfIntervalMalformedPkt_Object((1,3,6,1,2,1,186,1,6,1,8),_PwTDMPerfIntervalMalformedPkt_Type())
...
pwTDMPerfIntervalESs=_PwTDMPerfIntervalESs_Object((1,3,6,1,2,1,186,1,6,1,9),_PwTDMPerfIntervalESs_Type())
...
pwTDMPerfIntervalSESs=_PwTDMPerfIntervalSESs_Object((1,3,6,1,2,1,186,1,6,1,10),_PwTDMPerfIntervalSESs_Type())
...
pwTDMPerfIntervalUASs=_PwTDMPerfIntervalUASs_Object((1,3,6,1,2,1,186,1,6,1,11),_PwTDMPerfIntervalUASs_Type())
...
pwTDMPerfIntervalFC=_PwTDMPerfIntervalFC_Object((1,3,6,1,2,1,186,1,6,1,12),_PwTDMPerfIntervalFC_Type())
...
pwTDMPerf1DayIntervalTable=_PwTDMPerf1DayIntervalTable_Object((1,3,6,1,2,1,186,1,7))
if mibBuilder.loadTexts:pwTDMPerf1DayIntervalTable.setStatus(_A)
_PwTDMPerf1DayIntervalEntry_Object=MibTableRow
pwTDMPerf1DayIntervalEntry=_PwTDMPerf1DayIntervalEntry_Object((1,3,6,1,2,1,186,1,7,1))
pwTDMPerf1DayIntervalEntry.setIndexNames((0,_G,_H),(0,_B,_S))
if mibBuilder.loadTexts:pwTDMPerf1DayIntervalEntry.setStatus(_A)
class _PwTDMPerf1DayIntervalNumber_Type(Unsigned32):subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,30))
_PwTDMPerf1DayIntervalNumber_Type.__name__=_E
_PwTDMPerf1DayIntervalNumber_Object=MibTableColumn
pwTDMPerf1DayIntervalNumber=_PwTDMPerf1DayIntervalNumber_Object((1,3,6,1,2,1,186,1,7,1,1),_PwTDMPerf1DayIntervalNumber_Type())
pwTDMPerf1DayIntervalNumber.setMaxAccess(_J)
...
pwTDMPerf1DayIntervalValidData=_PwTDMPerf1DayIntervalValidData_Object((1,3,6,1,2,1,186,1,7,1,2),_PwTDMPerf1DayIntervalValidData_Type())
...
pwTDMPerf1DayIntervalDuration=_PwTDMPerf1DayIntervalDuration_Object((1,3,6,1,2,1,186,1,7,1,3),_PwTDMPerf1DayIntervalDuration_Type())
pwTDMPerf1DayIntervalDuration.setMaxAccess(_C)
if mibBuilder.loadTexts:pwTDMPerf1DayIntervalDuration.setStatus(_A)
if mibBuilder.loadTexts:pwTDMPerf1DayIntervalDuration.setUnits(_R)
_PwTDMPerf1DayIntervalMissingPkts_Type=Counter32
_PwTDMPerf1DayIntervalMissingPkts_Object=MibTableColumn
pwTDMPerf1DayIntervalMissingPkts=_PwTDMPerf1DayIntervalMissingPkts_Object((1,3,6,1,2,1,186,1,7,1,4),_PwTDMPerf1DayIntervalMissingPkts_Type())
...
pwTDMPerf1DayIntervalPktsReOrder=_PwTDMPerf1DayIntervalPktsReOrder_Object((1,3,6,1,2,1,186,1,7,1,5),_PwTDMPerf1DayIntervalPktsReOrder_Type())
...
pwTDMPerf1DayIntervalJtrBfrUnderruns=_PwTDMPerf1DayIntervalJtrBfrUnderruns_Object((1,3,6,1,2,1,186,1,7,1,6),_PwTDMPerf1DayIntervalJtrBfrUnderruns_Type())
...
pwTDMPerf1DayIntervalMisOrderDropped=_PwTDMPerf1DayIntervalMisOrderDropped_Object((1,3,6,1,2,1,186,1,7,1,7),_PwTDMPerf1DayIntervalMisOrderDropped_Type())
...
pwTDMPerf1DayIntervalMalformedPkt=_PwTDMPerf1DayIntervalMalformedPkt_Object((1,3,6,1,2,1,186,1,7,1,8),_PwTDMPerf1DayIntervalMalformedPkt_Type())
...
pwTDMPerf1DayIntervalESs=_PwTDMPerf1DayIntervalESs_Object((1,3,6,1,2,1,186,1,7,1,9),_PwTDMPerf1DayIntervalESs_Type())
...
pwTDMPerf1DayIntervalSESs=_PwTDMPerf1DayIntervalSESs_Object((1,3,6,1,2,1,186,1,7,1,10),_PwTDMPerf1DayIntervalSESs_Type())
...
pwTDMPerf1DayIntervalUASs=_PwTDMPerf1DayIntervalUASs_Object((1,3,6,1,2,1,186,1,7,1,11),_PwTDMPerf1DayIntervalUASs_Type())
...
pwTDMPerf1DayIntervalFC=_PwTDMPerf1DayIntervalFC_Object((1,3,6,1,2,1,186,1,7,1,12),_PwTDMPerf1DayIntervalFC_Type())
...
pwTDMConformance=_PwTDMConformance_ObjectIdentity((1,3,6,1,2,1,186,2))
_PwTDMCompliances_ObjectIdentity=ObjectIdentity
pwTDMCompliances=_PwTDMCompliances_ObjectIdentity((1,3,6,1,2,1,186,2,1))
_PwTDMGroups_ObjectIdentity=ObjectIdentity
pwTDMGroups=_PwTDMGroups_ObjectIdentity((1,3,6,1,2,1,186,2,2))
pwTDMGroup=ObjectGroup((1,3,6,1,2,1,186,2,2,1))
pwTDMGroup.setObjects(*((_B,_T),(_B,_U),(_B,_V),(_B,_W),(_B,_X),(_B,_Y),(_B,_Z),(_B,_a),(_B,_b),(_B,_c),(_B,_d),(_B,_e),(_B,_f),(_B,_g),(_B,_h),(_B,_i),(_B,_j),(_B,_k),(_B,_l),(_B,_m),(_B,_n),(_B,_o),(_B,_p),(_B,_q),(_B,_r),(_B,_s),(_B,_t),(_B,_u),(_B,_v)))
if mibBuilder.loadTexts:pwTDMGroup.setStatus(_A)
pwTDMPerfCurrentGroup=ObjectGroup((1,3,6,1,2,1,186,2,2,2))
pwTDMPerfCurrentGroup.setObjects(*((_B,_w),(_B,_x),(_B,_y),(_B,_z),(_B,_A0),(_B,_A1),(_B,_A2),(_B,_A3),(_B,_A4)))
if mibBuilder.loadTexts:pwTDMPerfCurrentGroup.setStatus(_A)
pwTDMPerfIntervalGroup=ObjectGroup((1,3,6,1,2,1,186,2,2,3))
pwTDMPerfIntervalGroup.setObjects(*((_B,_A5),(_B,_A6),(_B,_A7),(_B,_A8),(_B,_A9),(_B,_AA),(_B,_AB),(_B,_AC),(_B,_AD),(_B,_AE),(_B,_AF)))
if mibBuilder.loadTexts:pwTDMPerfIntervalGroup.setStatus(_A)
pwTDMPerf1DayIntervalGroup=ObjectGroup((1,3,6,1,2,1,186,2,2,4))
pwTDMPerf1DayIntervalGroup.setObjects(*((_B,_AG),(_B,_AH),(_B,_AI),(_B,_AJ),(_B,_AK),(_B,_AL),(_B,_AM),(_B,_AN),(_B,_AO),(_B,_AP),(_B,_AQ)))
if mibBuilder.loadTexts:pwTDMPerf1DayIntervalGroup.setStatus(_A)
pwTDMModuleCompliance=ModuleCompliance((1,3,6,1,2,1,186,2,1,1))
pwTDMModuleCompliance.setObjects(*((_B,_AR),(_B,_AS),(_B,_AT),(_B,_AU)))
if mibBuilder.loadTexts:pwTDMModuleCompliance.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'PwTDMCfgIndex':PwTDMCfgIndex,'pwTDMMIB':pwTDMMIB,'pwTDMNotifications':pwTDMNotifications,'pwTDMObjects':pwTDMObjects,'pwTDMTable':pwTDMTable,'pwTDMEntry':pwTDMEntry,_T:pwTDMRate,_U:pwTDMIfIndex,_V:pwGenTDMCfgIndex,_W:pwRelTDMCfgIndex,_X:pwTDMConfigError,_Y:pwTDMTimeElapsed,_Z:pwTDMValidIntervals,_a:pwTDMValidDayIntervals,_b:pwTDMLastEsTimeStamp,_c:pwTDMCfgIndexNext,'pwTDMCfgTable':pwTDMCfgTable,'pwTDMCfgEntry':pwTDMCfgEntry,_M:pwTDMCfgIndex,_d:pwTDMCfgRowStatus,_e:pwTDMCfgPayloadSize,_f:pwTDMCfgPktReorder,_g:pwTDMCfgRtpHdrUsed,_h:pwTDMCfgJtrBfrDepth,_i:pwTDMCfgPayloadSuppression,_j:pwTDMCfgConsecPktsInSynch,_k:pwTDMCfgConsecMissPktsOutSynch,_l:pwTDMCfgSetUp2SynchTimeOut,_m:pwTDMCfgPktReplacePolicy,_n:pwTDMCfgAvePktLossTimeWindow,_o:pwTDMCfgExcessivePktLossThreshold,_p:pwTDMCfgAlarmThreshold,_q:pwTDMCfgClearAlarmThreshold,_r:pwTDMCfgMissingPktsToSes,_s:pwTDMCfgTimestampMode,_t:pwTDMCfgStorageType,_u:pwTDMCfgPktFiller,_v:pwTDMCfgName,'pwTDMPerfCurrentTable':pwTDMPerfCurrentTable,'pwTDMPerfCurrentEntry':pwTDMPerfCurrentEntry,_w:pwTDMPerfCurrentMissingPkts,_x:pwTDMPerfCurrentPktsReOrder,_y:pwTDMPerfCurrentJtrBfrUnderruns,_z:pwTDMPerfCurrentMisOrderDropped,_A0:pwTDMPerfCurrentMalformedPkt,_A1:pwTDMPerfCurrentESs,_A2:pwTDMPerfCurrentSESs,_A3:pwTDMPerfCurrentUASs,_A4:pwTDMPerfCurrentFC,'pwTDMPerfIntervalTable':pwTDMPerfIntervalTable,'pwTDMPerfIntervalEntry':pwTDMPerfIntervalEntry,_Q:pwTDMPerfIntervalNumber,_A5:pwTDMPerfIntervalValidData,_A6:pwTDMPerfIntervalDuration,_A7:pwTDMPerfIntervalMissingPkts,_A8:pwTDMPerfIntervalPktsReOrder,_A9:pwTDMPerfIntervalJtrBfrUnderruns,_AA:pwTDMPerfIntervalMisOrderDropped,_AB:pwTDMPerfIntervalMalformedPkt,_AC:pwTDMPerfIntervalESs,_AD:pwTDMPerfIntervalSESs,_AE:pwTDMPerfIntervalUASs,_AF:pwTDMPerfIntervalFC,'pwTDMPerf1DayIntervalTable':pwTDMPerf1DayIntervalTable,'pwTDMPerf1DayIntervalEntry':pwTDMPerf1DayIntervalEntry,_S:pwTDMPerf1DayIntervalNumber,_AG:pwTDMPerf1DayIntervalValidData,_AH:pwTDMPerf1DayIntervalDuration,_AI:pwTDMPerf1DayIntervalMissingPkts,_AJ:pwTDMPerf1DayIntervalPktsReOrder,_AK:pwTDMPerf1DayIntervalJtrBfrUnderruns,_AL:pwTDMPerf1DayIntervalMisOrderDropped,_AM:pwTDMPerf1DayIntervalMalformedPkt,_AN:pwTDMPerf1DayIntervalESs,_AO:pwTDMPerf1DayIntervalSESs,_AP:pwTDMPerf1DayIntervalUASs,_AQ:pwTDMPerf1DayIntervalFC,'pwTDMConformance':pwTDMConformance,'pwTDMCompliances':pwTDMCompliances,'pwTDMModuleCompliance':pwTDMModuleCompliance,'pwTDMGroups':pwTDMGroups,_AR:pwTDMGroup,_AS:pwTDMPerfCurrentGroup,_AT:pwTDMPerfIntervalGroup,_AU:pwTDMPerf1DayIntervalGroup})