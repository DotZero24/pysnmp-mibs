_AA='eJapanesePostcardDouble'
_A9='eStatement'
_A8='eWritingImageError'
_A7='eWritingImage'
_A6='eVerifiedImageError'
_A5='eReceivedImageError'
_A4='eUnknownMediaSize'
_A3='eISOandJISA4R'
_A2='eUSLetterR'
_A1='eJapansePostcardDouble'
_A0='eISOandJISA3'
_z='eROC8K'
_y='eLedger'
_x='eInitiateAction'
...
if mibBuilder.loadTexts:hp.setRevisions(('1904-02-18 13:45','1904-02-18 13:55'))
...
class _Sleep_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_c,1),(_Z,2)))
...
class __pysmi_continue_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(1));namedValues=NamedValues((_x,1))
...
class _Show_address_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_Q,1),(_k,3)))
...
class _Mio1_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_l,8),(_m,12)))
...
class _Mio2_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_l,8),(_m,12)))
...
class _Mio3_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_l,8),(_m,12)))
...
class _Phd2_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(11));namedValues=NamedValues(('eOutputPHD',11))
...
class _Job_info_accounting_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_R,1),(_O,2),(_S,3),(_y,11),(_T,17),(_U,18),(_z,19),(_V,25),(_P,26),(_A0,27),(_W,45),('eJISB4',46),('eISOB5',65),(_A1,72),(_d,80),(_e,81),(_f,90),(_g,91),(_h,100),(_X,101),(_A2,258),(_A3,282),(_A4,32767)))
...
class _Ram_disk_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_Q,1),(_k,3)))
...
class _Firmware_download_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_c,1),(_Z,2)))
...
class _Upgradable_devices_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_c,1),(_Z,2)))
...
class _Form_feed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(1));namedValues=NamedValues((_x,1))
...
class _Default_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,15,17,18,25,26,45,72,80,81,90,91,100,101)));namedValues=NamedValues(*((_R,1),(_O,2),(_S,3),(_a,10),(_A9,15),(_T,17),(_U,18),(_V,25),(_P,26),(_W,45),(_AA,72),(_d,80),(_e,81),(_f,90),(_g,91),(_h,100),(_X,101)))
...
class _Reprint_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_Q,1),(_Y,2),(_k,3)))
...
class _Form_feed_needed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_c,1),(_Z,2)))
...
class _Override_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_R,1),(_O,2),(_S,3),(_y,11),(_T,17),(_U,18),(_z,19),(_V,25),(_P,26),(_A0,27),(_W,45),('eJISB4',46),('eISOB5',65),(_AA,72),(_d,80),(_e,81),(_f,90),(_g,91),(_h,100),(_X,101),(_A2,258),(_A3,282),(_A4,32767)))
...
class _Input_tray_auto_select_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_Q,1),(_Y,2)))
...
class _Manually_feed_prompt_test_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_c,1),(_Z,2)))
...
class _Tray1_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,15,17,18,25,26,45,72,80,81,90,91,100,101,32764,32765)));namedValues=NamedValues(*((_R,1),(_O,2),(_S,3),(_a,10),(_A9,15),(_T,17),(_U,18),(_V,25),(_P,26),(_W,45),(_A1,72),(_d,80),(_e,81),(_f,90),(_g,91),(_h,100),(_X,101),(_j,32764),(_b,32765)))
...
class _Tray2_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,17,18,25,26,45,101,32764,32765)));namedValues=NamedValues(*((_R,1),(_O,2),(_S,3),(_a,10),(_T,17),(_U,18),(_V,25),(_P,26),(_W,45),(_X,101),(_j,32764),(_b,32765)))
...
class _Tray3_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,17,18,25,26,45,101,32764,32765)));namedValues=NamedValues(*((_R,1),(_O,2),(_S,3),(_a,10),(_T,17),(_U,18),(_V,25),(_P,26),(_W,45),(_X,101),(_j,32764),(_b,32765)))
...
class _Tray4_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(80,81,90,91,100,32765)));namedValues=NamedValues(*((_d,80),(_e,81),(_f,90),(_g,91),(_h,100),(_b,32765)))
...
class _Tray5_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,17,18,25,26,45,101,32764,32765)));namedValues=NamedValues(*((_R,1),(_O,2),(_S,3),(_a,10),(_T,17),(_U,18),(_V,25),(_P,26),(_W,45),(_X,101),(_j,32764),(_b,32765)))
...
class _Tray6_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,17,18,25,26,45,101,32764,32765)));namedValues=NamedValues(*((_R,1),(_O,2),(_S,3),(_a,10),(_T,17),(_U,18),(_V,25),(_P,26),(_W,45),(_X,101),(_j,32764),(_b,32765)))
...
class _Consumable_status_usage_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_o,1),(_p,2),(_q,3),(_r,4),(_s,5),(_t,6),(_u,7),(_v,8)))
...
class _Consumable_status_engine_usage_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_o,1),(_p,2),(_q,3),(_r,4),(_s,5),(_t,6),(_u,7),(_v,8)))
...
class _Consumable_status_drum_life_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_o,1),(_p,2),(_q,3),(_r,4),(_s,5),(_t,6),(_u,7),(_v,8)))
...
channelEntry.setIndexNames((0,_w,'channelindex'))
...
deviceChannelEntry.setIndexNames((0,_w,'channel-index'))
