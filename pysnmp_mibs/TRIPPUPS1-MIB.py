...
mibBuilder.exportSymbols("TRIPPUPS1-MIB", upsTestId=upsTestId, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfigBatteryPercLow=upsConfigBatteryPercLow, lowBattery=lowBattery, upsOutputPercLoad=upsOutputPercLoad, upsOutputPower=upsOutputPower, ups=ups, upsOutput=upsOutput, powerRestored=powerRestored, upsAlarmDESCR=upsAlarmDESCR, upsSleeping=upsSleeping, upsAlarmTable=upsAlarmTable, upsBatteryChargeRemaining=upsBatteryChargeRemaining, upsBatteryVoltage=upsBatteryVoltage, upsInputVoltage=upsInputVoltage, upsOutputCurrent=upsOutputCurrent, upsStartupAfterDelay=upsStartupAfterDelay, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmTime=upsAlarmTime, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentModel=upsIdentModel, upsInputLineBads=upsInputLineBads, upsConfigOutputPercLoadHigh=upsConfigOutputPercLoadHigh, upsAlarmTempBad=upsAlarmTempBad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsShutdownType=upsShutdownType, upsOutputLineIndex=upsOutputLineIndex, upsTest=upsTest, upsInputNumLines=upsInputNumLines, returnFromLowBattery=returnFromLowBattery, tripplite=tripplite, upsWokeup=upsWokeup, utilityVoltageHigh=utilityVoltageHigh, upsOutputSource=upsOutputSource, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestResultsSummary=upsTestResultsSummary, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdent=upsIdent, upsInputTable=upsInputTable, upsAlarmId=upsAlarmId, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOnBattery=upsOnBattery, upsDiagnosticsPassed=upsDiagnosticsPassed, upsInputVolt=upsInputVolt, upsIdentManufacturer=upsIdentManufacturer, upsBatteryTemperature=upsBatteryTemperature, utilityVoltageLow=utilityVoltageLow, upsInputEntry=upsInputEntry, upsAlarmID=upsAlarmID, upsConfig=upsConfig, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputTable=upsOutputTable, upsIdentName=upsIdentName, upsOutputFrequency=upsOutputFrequency, upsConfigBatteryTemperatureHigh=upsConfigBatteryTemperatureHigh, upsInputFrequency=upsInputFrequency, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputNumLines=upsOutputNumLines, upsBatteryStatus=upsBatteryStatus, utilityVoltageReturnToNormal=utilityVoltageReturnToNormal, upsAutoRestart=upsAutoRestart, upsAlarmDescr=upsAlarmDescr, shutdownPending=shutdownPending, upsOverload=upsOverload, upsOutputEntry=upsOutputEntry, communicationEstablished=communicationEstablished, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInput=upsInput, upsBatteryNeedsReplacement=upsBatteryNeedsReplacement, communicationLost=communicationLost, upsWellKnownAlarms=upsWellKnownAlarms, upsInputLineIndex=upsInputLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsDiagnosticsFailed=upsDiagnosticsFailed, upsOutputVoltage=upsOutputVoltage, trippUPS1=trippUPS1, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmEntry=upsAlarmEntry, upsConfigInputVoltageHigh=upsConfigInputVoltageHigh, upsBattery=upsBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, batteryTemperatureHigh=batteryTemperatureHigh, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsControl=upsControl, upsAlarm=upsAlarm, upsConfigInputVoltageLow=upsConfigInputVoltageLow, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmBatteryBad=upsAlarmBatteryBad, upsRebootDuration=upsRebootDuration)
