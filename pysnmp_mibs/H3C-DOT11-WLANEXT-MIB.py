...
_D='not-accessible'
_C='read-only'
_B='H3C-DOT11-WLANEXT-MIB'
_A='current'
if'mibBuilder'not in globals():import sys;sys.stderr.write(__doc__);sys.exit(1)
Integer,OctetString,ObjectIdentifier=mibBuilder.importSymbols('ASN1','Integer','OctetString','ObjectIdentifier')
NamedValues,=mibBuilder.importSymbols('ASN1-ENUMERATION','NamedValues')
ConstraintsIntersection,ConstraintsUnion,SingleValueConstraint,ValueRangeConstraint,ValueSizeConstraint=mibBuilder.importSymbols('ASN1-REFINEMENT','ConstraintsIntersection','ConstraintsUnion','SingleValueConstraint','ValueRangeConstraint','ValueSizeConstraint')
H3cDot11ObjectIDType,H3cDot11QosAcType,H3cDot11RadioScopeType,h3cDot11=mibBuilder.importSymbols('H3C-DOT11-REF-MIB','H3cDot11ObjectIDType','H3cDot11QosAcType','H3cDot11RadioScopeType','h3cDot11')
...
h3cDot11RFGroup=_H3cDot11RFGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,75,7,1))
_H3cDot11RFSignalStatisTable_Object=MibTable
h3cDot11RFSignalStatisTable=_H3cDot11RFSignalStatisTable_Object((1,3,6,1,4,1,2011,10,2,75,7,1,1))
if mibBuilder.loadTexts:h3cDot11RFSignalStatisTable.setStatus(_A)
_H3cDot11RFSignalStatisEntry_Object=MibTableRow
h3cDot11RFSignalStatisEntry=_H3cDot11RFSignalStatisEntry_Object((1,3,6,1,4,1,2011,10,2,75,7,1,1,1))
...
h3cDot11RFAPID=_H3cDot11RFAPID_Object((1,3,6,1,4,1,2011,10,2,75,7,1,1,1,1),_H3cDot11RFAPID_Type())
...
h3cDot11RFRadioID=_H3cDot11RFRadioID_Object((1,3,6,1,4,1,2011,10,2,75,7,1,1,1,2),_H3cDot11RFRadioID_Type())
...
h3cDot11RFSignalStatisInterv=_H3cDot11RFSignalStatisInterv_Object((1,3,6,1,4,1,2011,10,2,75,7,1,1,1,3),_H3cDot11RFSignalStatisInterv_Type())
...
h3cDot11RFAverageSignalStrength=_H3cDot11RFAverageSignalStrength_Object((1,3,6,1,4,1,2011,10,2,75,7,1,1,1,4),_H3cDot11RFAverageSignalStrength_Type())
...
h3cDot11RFMaxSignalStrength=_H3cDot11RFMaxSignalStrength_Object((1,3,6,1,4,1,2011,10,2,75,7,1,1,1,5),_H3cDot11RFMaxSignalStrength_Type())
...
h3cDot11RFMinSignalStrength=_H3cDot11RFMinSignalStrength_Object((1,3,6,1,4,1,2011,10,2,75,7,1,1,1,6),_H3cDot11RFMinSignalStrength_Type())
...
h3cDot11QosGroup=_H3cDot11QosGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,75,7,2))
_H3cDot11QosStatisTable_Object=MibTable
h3cDot11QosStatisTable=_H3cDot11QosStatisTable_Object((1,3,6,1,4,1,2011,10,2,75,7,2,1))
if mibBuilder.loadTexts:h3cDot11QosStatisTable.setStatus(_A)
_H3cDot11QosStatisEntry_Object=MibTableRow
h3cDot11QosStatisEntry=_H3cDot11QosStatisEntry_Object((1,3,6,1,4,1,2011,10,2,75,7,2,1,1))
...
h3cDot11QosAPID=_H3cDot11QosAPID_Object((1,3,6,1,4,1,2011,10,2,75,7,2,1,1,1),_H3cDot11QosAPID_Type())
...
h3cDot11QosRadioID=_H3cDot11QosRadioID_Object((1,3,6,1,4,1,2011,10,2,75,7,2,1,1,2),_H3cDot11QosRadioID_Type())
...
h3cDot11QosAverageQueLen=_H3cDot11QosAverageQueLen_Object((1,3,6,1,4,1,2011,10,2,75,7,2,1,1,3),_H3cDot11QosAverageQueLen_Type())
...
h3cDot11QosDropFrameRatio=_H3cDot11QosDropFrameRatio_Object((1,3,6,1,4,1,2011,10,2,75,7,2,1,1,4),_H3cDot11QosDropFrameRatio_Type())
...
h3cDot11QosAverageDataRate=_H3cDot11QosAverageDataRate_Object((1,3,6,1,4,1,2011,10,2,75,7,2,1,1,5),_H3cDot11QosAverageDataRate_Type())
...
h3cDot11QosAcStatisTable=_H3cDot11QosAcStatisTable_Object((1,3,6,1,4,1,2011,10,2,75,7,2,2))
if mibBuilder.loadTexts:h3cDot11QosAcStatisTable.setStatus(_A)
_H3cDot11QosAcStatisEntry_Object=MibTableRow
h3cDot11QosAcStatisEntry=_H3cDot11QosAcStatisEntry_Object((1,3,6,1,4,1,2011,10,2,75,7,2,2,1))
...
h3cDot11QosAcType=_H3cDot11QosAcType_Object((1,3,6,1,4,1,2011,10,2,75,7,2,2,1,1),_H3cDot11QosAcType_Type())
...
h3cDot11AcDropFrameCnt=_H3cDot11AcDropFrameCnt_Object((1,3,6,1,4,1,2011,10,2,75,7,2,2,1,2),_H3cDot11AcDropFrameCnt_Type())
