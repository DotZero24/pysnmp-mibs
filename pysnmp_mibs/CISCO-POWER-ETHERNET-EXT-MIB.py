...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:24:11 2025
...
mibBuilder.exportSymbols("CISCO-POWER-ETHERNET-EXT-MIB", cpeExtPsePortLldpPwrPriority=cpeExtPsePortLldpPwrPriority, cpeExtPolicingNotifEnableGroup=cpeExtPolicingNotifEnableGroup, cpeExtPsePortPolicingCapable=cpeExtPsePortPolicingCapable, cpeExtMIBCompliance=cpeExtMIBCompliance, cpeExtPsePortEnable=cpeExtPsePortEnable, cpeExtPsePortLldpPwrType=cpeExtPsePortLldpPwrType, ciscoPowerEthernetExtMIB=ciscoPowerEthernetExtMIB, cpeExtPsePortLldpTable=cpeExtPsePortLldpTable, cpeExtPolicingNotifEnable=cpeExtPolicingNotifEnable, cpeExtPsePortPwrAllocated=cpeExtPsePortPwrAllocated, cpeExtPseGrpPwrGroup=cpeExtPseGrpPwrGroup, cpeExtPsePortLldpPdPwrPriority=cpeExtPsePortLldpPdPwrPriority, cpeExtPortEntityIndexGroup=cpeExtPortEntityIndexGroup, cpeExtPseInfoPwrGroup=cpeExtPseInfoPwrGroup, cpeExtPdStatsTable=cpeExtPdStatsTable, cpeExtPsePortGlobalConfigGroup=cpeExtPsePortGlobalConfigGroup, cpeExtPsePortCapabilitiesGroup=cpeExtPsePortCapabilitiesGroup, CpeExtLldpPwrSrc=CpeExtLldpPwrSrc, CpeExtLldpPwrType=CpeExtLldpPwrType, cpeExtPsePortLldpPdPwrReq=cpeExtPsePortLldpPdPwrReq, cpeExtMIBGroups=cpeExtMIBGroups, CpeExtPwrPriority=CpeExtPwrPriority, cpeExtPsePortPwrMonitorGroup=cpeExtPsePortPwrMonitorGroup, cpeExtPortPwrManAllocGroup=cpeExtPortPwrManAllocGroup, cpeExtMainPseUsedPower=cpeExtMainPseUsedPower, cpeExtMainPseRemainingPower=cpeExtMainPseRemainingPower, cpeExtPdStatsGroup=cpeExtPdStatsGroup, cpeExtMainPseGroup2=cpeExtMainPseGroup2, cpeExtPsePortPolicingAction=cpeExtPsePortPolicingAction, cpeExtPsePortLldpPdPwrSrc=cpeExtPsePortLldpPdPwrSrc, cpeExtMIBNotifs=cpeExtMIBNotifs, cpeExtPsePortDeviceDetected=cpeExtPsePortDeviceDetected, cpeExtPowerPriorityGroup=cpeExtPowerPriorityGroup, cpeExtMainPseTable=cpeExtMainPseTable, cpeExtMainPseDescr=cpeExtMainPseDescr, cpeExtPsePortDiscoverMode=cpeExtPsePortDiscoverMode, cpeExtPsePortPolicingEnable=cpeExtPsePortPolicingEnable, cpeExtMIBCompliance4=cpeExtMIBCompliance4, cpeExtPsePortEntry=cpeExtPsePortEntry, cpeExtPsePortEntPhyIndex=cpeExtPsePortEntPhyIndex, cpeExtPsePortPwrAvailable=cpeExtPsePortPwrAvailable, cpeExtPsePortLldpPwrReq=cpeExtPsePortLldpPwrReq, cpeExtPolicingNotif=cpeExtPolicingNotif, cpeExtMainPseEntry=cpeExtMainPseEntry, cpeExtPsePortLldpPwrClass=cpeExtPsePortLldpPwrClass, cpeExtPsePortPwrMax=cpeExtPsePortPwrMax, cpeExtPdStatistics=cpeExtPdStatistics, cpeExtMIBCompliance3=cpeExtMIBCompliance3, cpeExtPsePortLldpGroup=cpeExtPsePortLldpGroup, cpeExtPsePortLldpPdPwrAlloc=cpeExtPsePortLldpPdPwrAlloc, cpeExtMainPsePwrMonitorCapable=cpeExtMainPsePwrMonitorCapable, cpeExtPowerPriorityEnable=cpeExtPowerPriorityEnable, cpeExtMIBCompliance5=cpeExtMIBCompliance5, cpeExtPsePortIeeePd=cpeExtPsePortIeeePd, cpeExtPdStatsEntry=cpeExtPdStatsEntry, cpeExtMIBConformance=cpeExtMIBConformance, cpeExtMIBCompliances=cpeExtMIBCompliances, cpeExtPsePortTable=cpeExtPsePortTable, cpeExtPsePortPwrConsumption=cpeExtPsePortPwrConsumption, cpeExtPsePortMaxPwrDrawn=cpeExtPsePortMaxPwrDrawn, cpeExtMainPseEntPhyIndex=cpeExtMainPseEntPhyIndex, CpeExtLldpPwrClassOrZero=CpeExtLldpPwrClassOrZero, cpeExtPdStatsTotalDevices=cpeExtPdStatsTotalDevices, cpeExtPsePortLldpPwrAlloc=cpeExtPsePortLldpPwrAlloc, cpeExtPdStatsDeviceCount=cpeExtPdStatsDeviceCount, cpeExtPsePortLldpPdPwrPairsOrZero=cpeExtPsePortLldpPdPwrPairsOrZero, cpeExtPsePortLldpPowerGroup=cpeExtPsePortLldpPowerGroup, cpeExtPsePortLldpPdPwrSupport=cpeExtPsePortLldpPdPwrSupport, cpeExtPsePortPwrManAlloc=cpeExtPsePortPwrManAlloc, cpeExtPsePortLldpEntry=cpeExtPsePortLldpEntry, cpeExtMainPseGroup=cpeExtMainPseGroup, cpeExtPsePortLldpPwrSrc=cpeExtPsePortLldpPwrSrc, cpeExtPolicingNotifGroup=cpeExtPolicingNotifGroup, cpeExtPsePortLldpPdPwrType=cpeExtPsePortLldpPdPwrType, cpeExtDefaultAllocation=cpeExtDefaultAllocation, cpeExtPdStatsClass=cpeExtPdStatsClass, cpeExtPortPolicingActionGroup=cpeExtPortPolicingActionGroup, cpeExtPsePortCapabilities=cpeExtPsePortCapabilities, PYSNMP_MODULE_ID=ciscoPowerEthernetExtMIB, cpeExtMIBCompliance2=cpeExtMIBCompliance2, cpeExtPsePortGroup=cpeExtPsePortGroup, cpeExtPsePortAdditionalStatus=cpeExtPsePortAdditionalStatus, cpeExtPsePortLldpPdPwrClass=cpeExtPsePortLldpPdPwrClass, cpeExtMIBCompliance6=cpeExtMIBCompliance6, cpeExtMIBObjects=cpeExtMIBObjects, cpeExtPortPolicingGroup=cpeExtPortPolicingGroup)
