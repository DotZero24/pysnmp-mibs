# SNMP MIB module (DES7200-PTOPO-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-PTOPO-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:46:34 2025
...
myPotopoMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33)
)
if mibBuilder.loadTexts:
    myPotopoMIB.setRevisions(
        ("2003-04-28 00:00",)
    )
...
ptopoConnIndex = _PtopoConnIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 1, 1, 1, 1),
...
ptopoConnLocalDevice = _PtopoConnLocalDevice_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 1, 1, 1, 2),
...
ptopoConnLocalPort = _PtopoConnLocalPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 1, 1, 1, 3),
...
ptopoConnRemoteDevice = _PtopoConnRemoteDevice_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 1, 1, 1, 4),
...
ptopoConnRemotePort = _PtopoConnRemotePort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 1, 1, 1, 5),
...
ptopoConnIsUpStream = _PtopoConnIsUpStream_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 1, 1, 1, 6),
...
ptopoDevID = _PtopoDevID_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 2, 1, 1, 1),
    _PtopoDevID_Type()
)
...
ptopoDevHostname = _PtopoDevHostname_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 2, 1, 1, 2),
...
ptopoDevClusStatus = _PtopoDevClusStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 2, 1, 1, 3),
...
ptopoDevClusMode = _PtopoDevClusMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 2, 1, 1, 4),
...
ptopoDevClusName = _PtopoDevClusName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 2, 1, 1, 5),
...
ptopoDevCSMac = _PtopoDevCSMac_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 2, 1, 1, 6),
    _PtopoDevCSMac_Type()
)
...
ptopoDevHopsToCs = _PtopoDevHopsToCs_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 2, 1, 1, 7),
...
ptopoDevLastVerifyTime = _PtopoDevLastVerifyTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 2, 1, 1, 8),
...
ptopoConfig = _PtopoConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 3)
)
...
ptopoConfigInterval = _PtopoConfigInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 3, 1),
...
ptopoConfigMaxHoldTime = _PtopoConfigMaxHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 3, 2),
...
ptopoConfigHopCount = _PtopoConfigHopCount_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 33, 1, 3, 3),
