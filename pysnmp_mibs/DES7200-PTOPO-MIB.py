...
ptopoMIBObjects=_PtopoMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,33,1))
_PtopoConnData_ObjectIdentity=ObjectIdentity
ptopoConnData=_PtopoConnData_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,33,1,1))
_PtopoConnTable_Object=MibTable
ptopoConnTable=_PtopoConnTable_Object((1,3,6,1,4,1,171,10,97,2,33,1,1,1))
if mibBuilder.loadTexts:ptopoConnTable.setStatus(_A)
_PtopoConnEntry_Object=MibTableRow
ptopoConnEntry=_PtopoConnEntry_Object((1,3,6,1,4,1,171,10,97,2,33,1,1,1,1))
...
ptopoConnIndex=_PtopoConnIndex_Object((1,3,6,1,4,1,171,10,97,2,33,1,1,1,1,1),_PtopoConnIndex_Type())
...
ptopoConnLocalDevice=_PtopoConnLocalDevice_Object((1,3,6,1,4,1,171,10,97,2,33,1,1,1,1,2),_PtopoConnLocalDevice_Type())
...
ptopoConnLocalPort=_PtopoConnLocalPort_Object((1,3,6,1,4,1,171,10,97,2,33,1,1,1,1,3),_PtopoConnLocalPort_Type())
...
ptopoConnRemoteDevice=_PtopoConnRemoteDevice_Object((1,3,6,1,4,1,171,10,97,2,33,1,1,1,1,4),_PtopoConnRemoteDevice_Type())
...
ptopoConnRemotePort=_PtopoConnRemotePort_Object((1,3,6,1,4,1,171,10,97,2,33,1,1,1,1,5),_PtopoConnRemotePort_Type())
...
ptopoConnIsUpStream=_PtopoConnIsUpStream_Object((1,3,6,1,4,1,171,10,97,2,33,1,1,1,1,6),_PtopoConnIsUpStream_Type())
...
ptopoDevData=_PtopoDevData_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,33,1,2))
_PtopoDevTable_Object=MibTable
ptopoDevTable=_PtopoDevTable_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1))
if mibBuilder.loadTexts:ptopoDevTable.setStatus(_A)
_PtopoDevEntry_Object=MibTableRow
ptopoDevEntry=_PtopoDevEntry_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1,1))
...
ptopoDevID=_PtopoDevID_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1,1,1),_PtopoDevID_Type())
...
ptopoDevHostname=_PtopoDevHostname_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1,1,2),_PtopoDevHostname_Type())
...
ptopoDevClusStatus=_PtopoDevClusStatus_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1,1,3),_PtopoDevClusStatus_Type())
...
ptopoDevClusMode=_PtopoDevClusMode_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1,1,4),_PtopoDevClusMode_Type())
...
ptopoDevClusName=_PtopoDevClusName_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1,1,5),_PtopoDevClusName_Type())
...
ptopoDevCSMac=_PtopoDevCSMac_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1,1,6),_PtopoDevCSMac_Type())
...
ptopoDevHopsToCs=_PtopoDevHopsToCs_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1,1,7),_PtopoDevHopsToCs_Type())
...
ptopoDevLastVerifyTime=_PtopoDevLastVerifyTime_Object((1,3,6,1,4,1,171,10,97,2,33,1,2,1,1,8),_PtopoDevLastVerifyTime_Type())
...
ptopoConfig=_PtopoConfig_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,33,1,3))
...
ptopoConfigInterval=_PtopoConfigInterval_Object((1,3,6,1,4,1,171,10,97,2,33,1,3,1),_PtopoConfigInterval_Type())
...
ptopoConfigMaxHoldTime=_PtopoConfigMaxHoldTime_Object((1,3,6,1,4,1,171,10,97,2,33,1,3,2),_PtopoConfigMaxHoldTime_Type())
...
ptopoConfigHopCount=_PtopoConfigHopCount_Object((1,3,6,1,4,1,171,10,97,2,33,1,3,3),_PtopoConfigHopCount_Type())
