...
# Produced by pysmi-1.1.12 at Thu Sep 11 09:59:30 2025
...
mibBuilder.exportSymbols("Wellfleet-OSPF-MIB", wfOspfVirtIfAreaID=wfOspfVirtIfAreaID, wfOspfNbrLSRetransQLen=wfOspfNbrLSRetransQLen, wfOspfNSSARangeEntry=wfOspfNSSARangeEntry, wfMospfForwardEntry=wfMospfForwardEntry, wfOspfPrimarySlot=wfOspfPrimarySlot, wfMospfForwardSourceNetMask=wfMospfForwardSourceNetMask, wfOspfAreaNssaDefaultRoutePathType=wfOspfAreaNssaDefaultRoutePathType, wfOspfLsdbChecksum=wfOspfLsdbChecksum, wfOspfBackupSlot=wfOspfBackupSlot, wfMospfForwardAge=wfMospfForwardAge, wfOspfNbrState=wfOspfNbrState, wfOspfIfRtrDeadInterval=wfOspfIfRtrDeadInterval, wfOspfNbrDisable=wfOspfNbrDisable, wfOspfNbrOptions=wfOspfNbrOptions, wfOspfVirtIfTransitDelay=wfOspfVirtIfTransitDelay, wfOspfAreaEntry=wfOspfAreaEntry, wfOspfNbrDelete=wfOspfNbrDelete, wfOspfBackupLsdbAseTag=wfOspfBackupLsdbAseTag, wfOspfLsaRefreshMax=wfOspfLsaRefreshMax, wfOspfVirtIfRtrDeadInterval=wfOspfVirtIfRtrDeadInterval, wfMospfForwardUpstreamAddress=wfMospfForwardUpstreamAddress, wfOspfIfRetransInterval=wfOspfIfRetransInterval, wfOspfBackupLsdbAge=wfOspfBackupLsdbAge, wfOspfVirtIfAuthKey=wfOspfVirtIfAuthKey, wfOspfBackupLogMask=wfOspfBackupLogMask, wfOspfMulticastExtensions=wfOspfMulticastExtensions, wfOspfImportSum=wfOspfImportSum, wfOspfAreaRangeMask=wfOspfAreaRangeMask, wfOspfVirtIfDelete=wfOspfVirtIfDelete, wfOspfVirtNbrTable=wfOspfVirtNbrTable, wfOspfVirtIfEntry=wfOspfVirtIfEntry, wfOspfIfDesignatedRouter=wfOspfIfDesignatedRouter, wfOspfOpaqueCapability=wfOspfOpaqueCapability, wfOspfNbrIpAddr=wfOspfNbrIpAddr, wfOspfNSSARangeDelete=wfOspfNSSARangeDelete, wfOspfAreaTable=wfOspfAreaTable, wfOspfLsdbAdv=wfOspfLsdbAdv, wfOspfVirtNbrOptions=wfOspfVirtNbrOptions, wfOspfLsdbAdvLen=wfOspfLsdbAdvLen, wfOspfGeneralDisable=wfOspfGeneralDisable, wfOspfBackupLsdbType=wfOspfBackupLsdbType, wfOspfAddressLessIf=wfOspfAddressLessIf, wfOspfBackupLsdbMetric=wfOspfBackupLsdbMetric, wfOspfVirtNbrEvents=wfOspfVirtNbrEvents, wfOspfDynNbrTable=wfOspfDynNbrTable, wfMospfForwardDownstream=wfMospfForwardDownstream, wfOspfVirtIfTable=wfOspfVirtIfTable, wfOspfDynNbrRtrId=wfOspfDynNbrRtrId, wfOspfDynNbrLSRetransQLen=wfOspfDynNbrLSRetransQLen, wfOspfNSSARangeStatus=wfOspfNSSARangeStatus, wfOspfAseTagDefault=wfOspfAseTagDefault, wfOspfASEMcastEnable=wfOspfASEMcastEnable, wfOspfDynNbrEntry=wfOspfDynNbrEntry, wfOspfIfRxLinkStateUpds=wfOspfIfRxLinkStateUpds, wfOspfBackupLsdbChecksum=wfOspfBackupLsdbChecksum, wfOspfVirtNbrLSRetransQLen=wfOspfVirtNbrLSRetransQLen, wfOspfDynNbrOptions=wfOspfDynNbrOptions, wfOspfIfAreaId=wfOspfIfAreaId, wfOspfNSSARangeTable=wfOspfNSSARangeTable, wfOspfIfTxLinkStateAcks=wfOspfIfTxLinkStateAcks, wfOspfSpfHoldDown=wfOspfSpfHoldDown, wfOspfAuthType=wfOspfAuthType, wfOspfSpfCnt=wfOspfSpfCnt, wfOspfIfHelloInterval=wfOspfIfHelloInterval, wfOspfCurNbrPriority=wfOspfCurNbrPriority, wfOspfMulticastDeterministic=wfOspfMulticastDeterministic, wfOspfDeterministicMcastHoldDown=wfOspfDeterministicMcastHoldDown, wfOspfIfTxLinkStateUpds=wfOspfIfTxLinkStateUpds, wfOspfNSSARangeMask=wfOspfNSSARangeMask, wfOspfLsdbAreaId=wfOspfLsdbAreaId, wfOspfBackupLsdbTable=wfOspfBackupLsdbTable, wfOspfDynNbrIpAddr=wfOspfDynNbrIpAddr, wfOspfMaximumPath=wfOspfMaximumPath, wfOspfVirtIfRxLinkStateReqs=wfOspfVirtIfRxLinkStateReqs, wfOspfStubMetric=wfOspfStubMetric, wfOspfMulticastRoutePinning=wfOspfMulticastRoutePinning, wfOspfLsdbLSID=wfOspfLsdbLSID, wfOspfNbrEvents=wfOspfNbrEvents, wfOspfNSSARangeNet=wfOspfNSSARangeNet, wfOspfImportASExtern=wfOspfImportASExtern, wfOspfVirtIfTxLinkStateUpds=wfOspfVirtIfTxLinkStateUpds, wfOspfNbrRtrId=wfOspfNbrRtrId, wfOspfRouterId=wfOspfRouterId, wfOspfBackupLsdbAdvLen=wfOspfBackupLsdbAdvLen, wfOspfAreaRangeDisable=wfOspfAreaRangeDisable, wfOspfIfRxDBDescripts=wfOspfIfRxDBDescripts, wfOspfMcastUseDynTTL=wfOspfMcastUseDynTTL, wfMospfForwardFlag=wfMospfForwardFlag, wfOspfLsdbAseTag=wfOspfLsdbAseTag, wfOspfAreaNssaPropagateDefaultRoute=wfOspfAreaNssaPropagateDefaultRoute, wfOspfIfDrops=wfOspfIfDrops, wfOspfSlotPriority=wfOspfSlotPriority, wfMospfForwardBwBucketRate=wfMospfForwardBwBucketRate, wfOspfAreaRangeMetric=wfOspfAreaRangeMetric, wfOspfNbrAddressLessIndex=wfOspfNbrAddressLessIndex, wfOspfDynNbrEvents=wfOspfDynNbrEvents, wfOspfAreaRangeAreaID=wfOspfAreaRangeAreaID, wfOspfVirtIfTxHellos=wfOspfVirtIfTxHellos, wfOspfLsdbRouterId=wfOspfLsdbRouterId, wfOspfVirtNbrIpAddr=wfOspfVirtNbrIpAddr, wfOspfAreaRangeEntry=wfOspfAreaRangeEntry, wfOspfLsdbAseForwardAddr=wfOspfLsdbAseForwardAddr, wfOspfRfc1583Compatibility=wfOspfRfc1583Compatibility, wfOspfBackupLsdbSequence=wfOspfBackupLsdbSequence, wfOspfVirtNbrEntry=wfOspfVirtNbrEntry, wfMospfForwardGroup=wfMospfForwardGroup, wfOspfIfDisable=wfOspfIfDisable, wfOspfIfState=wfOspfIfState, wfOspfDynNbrIfAddr=wfOspfDynNbrIfAddr, wfOspfVirtIfRetransInterval=wfOspfVirtIfRetransInterval, wfOspfBackupDisable=wfOspfBackupDisable, wfOspfLsdbAseType=wfOspfLsdbAseType, wfOspfVirtIfHelloInterval=wfOspfVirtIfHelloInterval, wfOspfAreaState=wfOspfAreaState, wfOspfBackupLsdbAreaId=wfOspfBackupLsdbAreaId, wfOspfIfRxLinkStateAcks=wfOspfIfRxLinkStateAcks, wfOspfLsdbCount=wfOspfLsdbCount, wfOspfIfOpaqueOn=wfOspfIfOpaqueOn, wfOspfNbrTable=wfOspfNbrTable, wfOspfBackupLsdbAdv=wfOspfBackupLsdbAdv, wfOspfVirtIfRxHellos=wfOspfVirtIfRxHellos, wfOspfVirtIfTxLinkStateReqs=wfOspfVirtIfTxLinkStateReqs, wfOspfDynNbrState=wfOspfDynNbrState, wfOspfGeneralState=wfOspfGeneralState, wfOspfNbrEntry=wfOspfNbrEntry, wfOspfLsdbSequence=wfOspfLsdbSequence, wfOspfIfIpAddress=wfOspfIfIpAddress, wfOspfIfMetricCost=wfOspfIfMetricCost, wfOspfLsdbEntry=wfOspfLsdbEntry, wfOspfMtuSize=wfOspfMtuSize, wfOspfPtpSpecCostEnable=wfOspfPtpSpecCostEnable, wfOspfIfBwRate=wfOspfIfBwRate, wfOspfVirtNbrState=wfOspfVirtNbrState, wfOspfPrimaryLogMask=wfOspfPrimaryLogMask, wfMospfEntryTimeoutValue=wfMospfEntryTimeoutValue, wfOspfLsdbTable=wfOspfLsdbTable, wfOspfIfTable=wfOspfIfTable, wfOspfLsdbType=wfOspfLsdbType, wfOspfAreaId=wfOspfAreaId, wfOspfAreaRangeDelete=wfOspfAreaRangeDelete, wfOspfIfRxLinkStateReqs=wfOspfIfRxLinkStateReqs, wfOspfAreaNssaOriginateDefaultRoute=wfOspfAreaNssaOriginateDefaultRoute, wfOspfBackupLsdbLSID=wfOspfBackupLsdbLSID, wfOspfAreaDisable=wfOspfAreaDisable, wfOspfIfTxDBDescripts=wfOspfIfTxDBDescripts, wfOspfAreaDelete=wfOspfAreaDelete, wfOspfVirtIfDisable=wfOspfVirtIfDisable, wfOspfMtuUseCommonDefault=wfOspfMtuUseCommonDefault, wfOspfAreaRangeTable=wfOspfAreaRangeTable, wfOspfIfBackupDesignatedRouter=wfOspfIfBackupDesignatedRouter, wfOspfVirtIfTxDBDescripts=wfOspfVirtIfTxDBDescripts, wfMospfForwardSource=wfMospfForwardSource, wfOspfIfPollInterval=wfOspfIfPollInterval, wfOspfDynNbrPriority=wfOspfDynNbrPriority, wfOspfGeneralGroup=wfOspfGeneralGroup, wfOspfVersionNumber=wfOspfVersionNumber, wfOspfAreaNssaTranslateStatus=wfOspfAreaNssaTranslateStatus, wfOspfMaxQueuedMcastPkts=wfOspfMaxQueuedMcastPkts, wfOspfVirtNbrRtrId=wfOspfVirtNbrRtrId, wfMospfForwardBwBucketDepth=wfMospfForwardBwBucketDepth, wfOspfVirtIfRxLinkStateUpds=wfOspfVirtIfRxLinkStateUpds, wfMospfForwardSourceMask=wfMospfForwardSourceMask, wfMospfForwardTable=wfMospfForwardTable, wfOspfFwdAddrComp=wfOspfFwdAddrComp, wfOspfIfTxLinkStateReqs=wfOspfIfTxLinkStateReqs, wfOspfAreaBdrRtrStatus=wfOspfAreaBdrRtrStatus, wfOspfNewAseMetricSupport=wfOspfNewAseMetricSupport, wfOspfAreaRangeStatus=wfOspfAreaRangeStatus, wfOspfVirtIfState=wfOspfVirtIfState, wfOspfIfTxHellos=wfOspfIfTxHellos, wfOspfVirtNbrArea=wfOspfVirtNbrArea, wfOspfLsdbAge=wfOspfLsdbAge, wfMospfForwardUpstreamIfIndex=wfMospfForwardUpstreamIfIndex, wfOspfLsaRefreshDelay=wfOspfLsaRefreshDelay, wfOspfIfAuthKey=wfOspfIfAuthKey, wfOspfIfRtrPriority=wfOspfIfRtrPriority, wfOspfNSSARangeDisable=wfOspfNSSARangeDisable, wfOspfVirtIfTxLinkStateAcks=wfOspfVirtIfTxLinkStateAcks, wfOspfSlotMask=wfOspfSlotMask, wfOspfAreaRangeNet=wfOspfAreaRangeNet, wfOspfNbrPriority=wfOspfNbrPriority, wfOspfIfRxHellos=wfOspfIfRxHellos, wfOspfVirtIfDrops=wfOspfVirtIfDrops, wfOspfDynNbrAddressLessIndex=wfOspfDynNbrAddressLessIndex, wfOspfIfMulticastForwarding=wfOspfIfMulticastForwarding, wfOspfBackupLsdbAseType=wfOspfBackupLsdbAseType, wfOspfAreaRangeState=wfOspfAreaRangeState, wfOspfASBdrRtrStatus=wfOspfASBdrRtrStatus, wfOspfIfDelete=wfOspfIfDelete, wfOspfVirtIfRxDBDescripts=wfOspfVirtIfRxDBDescripts, wfOspfVirtIfRxLinkStateAcks=wfOspfVirtIfRxLinkStateAcks, wfOspfIfBwDepth=wfOspfIfBwDepth, wfOspfBackupLsdbEntry=wfOspfBackupLsdbEntry, wfOspfGeneralDelete=wfOspfGeneralDelete, wfOspfLsdbMetric=wfOspfLsdbMetric, wfOspfIfMtuMismatchDetect=wfOspfIfMtuMismatchDetect, wfOspfNssaBorderRouter=wfOspfNssaBorderRouter, wfOspfVirtIfNeighbor=wfOspfVirtIfNeighbor, wfOspfBackupLsdbAseForwardAddr=wfOspfBackupLsdbAseForwardAddr, wfOspfNbrIfAddr=wfOspfNbrIfAddr, wfOspfIfType=wfOspfIfType, wfOspfAreaNssaTranslateCfg=wfOspfAreaNssaTranslateCfg, wfOspfIfTransitDelay=wfOspfIfTransitDelay, wfOspfBackupLsdbRouterId=wfOspfBackupLsdbRouterId, wfOspfNSSARangeExternRouteTag=wfOspfNSSARangeExternRouteTag, wfOspfAggrUseMaxCost=wfOspfAggrUseMaxCost, wfOspfTOSSupport=wfOspfTOSSupport, wfOspfIfEntry=wfOspfIfEntry)
