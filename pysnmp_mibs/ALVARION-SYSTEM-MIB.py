...
mibBuilder.exportSymbols("ALVARION-SYSTEM-MIB", systemProductFlavor=systemProductFlavor, systemTime=systemTime, alvarionAdminAccessNotificationGroup=alvarionAdminAccessNotificationGroup, adminAccessLogoutNotificationEnabled=adminAccessLogoutNotificationEnabled, heartbeatPeriod=heartbeatPeriod, alvarionSystemMIBCompliance=alvarionSystemMIBCompliance, systemTimeServerEntry=systemTimeServerEntry, systemInfo=systemInfo, adminAccessAuthenMode=adminAccessAuthenMode, heartbeat=heartbeat, systemFirmwareRevision=systemFirmwareRevision, systemWanPortIpAddress=systemWanPortIpAddress, alvarionSystemMIBGroup=alvarionSystemMIBGroup, systemHeartbeatNotification=systemHeartbeatNotification, alvarionTimeNotificationGroup=alvarionTimeNotificationGroup, systemMacAddress=systemMacAddress, adminAccess=adminAccess, adminAccessProfileIndex=adminAccessProfileIndex, alvarionSystemMIBConformance=alvarionSystemMIBConformance, PYSNMP_MODULE_ID=alvarionSystemMIB, systemProductName=systemProductName, systemColdStart=systemColdStart, systemTimeServerNotificationEnabled=systemTimeServerNotificationEnabled, systemHardwareRevision=systemHardwareRevision, heartbeatNotificationEnabled=heartbeatNotificationEnabled, alvarionSystemMIBNotifications=alvarionSystemMIBNotifications, systemTimeOfDay=systemTimeOfDay, adminAccessMaxLoginAttempts=adminAccessMaxLoginAttempts, systemTimeZone=systemTimeZone, adminAccessLockOutPeriod=adminAccessLockOutPeriod, systemTimeLostWhenRebooting=systemTimeLostWhenRebooting, adminAccessInfo=adminAccessInfo, adminAccessAuthFailureNotification=adminAccessAuthFailureNotification, alvarionSystemMIBCompliances=alvarionSystemMIBCompliances, adminAccessAuthFailureNotificationEnabled=adminAccessAuthFailureNotificationEnabled, adminAccessAdministrativeRights=adminAccessAdministrativeRights, alvarionSystemMIBGroups=alvarionSystemMIBGroups, adminAccessLogoutNotification=adminAccessLogoutNotification, systemBootRevision=systemBootRevision, systemTimeServerTable=systemTimeServerTable, systemTimeServerIndex=systemTimeServerIndex, alvarionSystemMIBNotificationPrefix=alvarionSystemMIBNotificationPrefix, adminAccessLoginNotificationEnabled=adminAccessLoginNotificationEnabled, alvarionSystemMIBObjects=alvarionSystemMIBObjects, adminAccessProfileEntry=adminAccessProfileEntry, systemTimeDSTOn=systemTimeDSTOn, adminAccessUserName=adminAccessUserName, alvarionSystemNotificationGroup=alvarionSystemNotificationGroup, adminAccessAuthenProfileIndex=adminAccessAuthenProfileIndex, adminAccessProfileTable=adminAccessProfileTable, adminAccessLoginNotification=adminAccessLoginNotification, alvarionAdminAccessProfileGroup=alvarionAdminAccessProfileGroup, systemSerialNumber=systemSerialNumber, systemDeviceIdentification=systemDeviceIdentification, systemConfigurationVersion=systemConfigurationVersion, timeServerFailure=timeServerFailure, systemUpTime=systemUpTime, systemDate=systemDate, systemTimeUpdateMode=systemTimeUpdateMode, alvarionSystemMIB=alvarionSystemMIB, systemTimeServerAddress=systemTimeServerAddress)
