# SNMP MIB module (H3C-AAL5-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-AAL5-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:19:22 2025
...
h3cAal5VccVpi = _H3cAal5VccVpi_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 1, 1, 1, 1),
    _H3cAal5VccVpi_Type()
)
...
h3cAal5VccVci = _H3cAal5VccVci_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 1, 1, 1, 2),
    _H3cAal5VccVci_Type()
)
...
h3cAal5VccInPkts = _H3cAal5VccInPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 1, 1, 1, 3),
...
h3cAal5VccOutPkts = _H3cAal5VccOutPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 1, 1, 1, 4),
...
h3cAal5VccInOctets = _H3cAal5VccInOctets_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 1, 1, 1, 5),
...
h3cAal5VccOutOctets = _H3cAal5VccOutOctets_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 1, 1, 1, 6),
...
h3cAal5VccState = _H3cAal5VccState_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 1, 1, 1, 7),
...
h3cAal5VccStateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 0, 1)
)
h3cAal5VccStateChange.setObjects(
    ("H3C-AAL5-MIB", "h3cAal5VccState")
)
if mibBuilder.loadTexts:
...
h3cAal5NotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 3, 2, 2)
)
h3cAal5NotificationGroup.setObjects(
    ("H3C-AAL5-MIB", "h3cAal5VccStateChange")
)
if mibBuilder.loadTexts:
...
h3cAal5MIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 21, 1, 3, 1, 1)
)
h3cAal5MIBCompliance.setObjects(
      *(("H3C-AAL5-MIB", "h3cAal5MIBGroup"),
        ("H3C-AAL5-MIB", "h3cAal5NotificationGroup"))
)
if mibBuilder.loadTexts:
