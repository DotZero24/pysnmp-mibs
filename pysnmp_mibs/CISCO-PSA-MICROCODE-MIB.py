...
mibBuilder.exportSymbols("CISCO-PSA-MICROCODE-MIB", ciscoPsaMicrocodeReload=ciscoPsaMicrocodeReload, ciscoPsaMicrocodeMIBConformance=ciscoPsaMicrocodeMIBConformance, ciscoPsaMicrocodeMIBCompliances=ciscoPsaMicrocodeMIBCompliances, ciscoPsaMicrocodeMIBNotifs=ciscoPsaMicrocodeMIBNotifs, cpmcModulePsaPrevBundleId=cpmcModulePsaPrevBundleId, cpmcModulePsaCurrBundleId=cpmcModulePsaCurrBundleId, cpmcBundleId=cpmcBundleId, cpmcBundleFeatures=cpmcBundleFeatures, PsaMicrocodeFeatures=PsaMicrocodeFeatures, ciscoPsaMicrocodeMIBCompliance=ciscoPsaMicrocodeMIBCompliance, cpmcModulePsaTable=cpmcModulePsaTable, cpmcModulePsaEntry=cpmcModulePsaEntry, ciscoPsaMicrocodeParamsGroup=ciscoPsaMicrocodeParamsGroup, cpmcNotifEnables=cpmcNotifEnables, PYSNMP_MODULE_ID=ciscoPsaMicrocodeMIB, ciscoPsaMicrocodeMIB=ciscoPsaMicrocodeMIB, ciscoPsaMicrocodeMIBGroups=ciscoPsaMicrocodeMIBGroups, cpmcModulePsaFeaturesDisabled=cpmcModulePsaFeaturesDisabled, ciscoPsaMicrocodeNotifGroup=ciscoPsaMicrocodeNotifGroup, cpmcBundleTable=cpmcBundleTable, PsaMicrocodeBundleId=PsaMicrocodeBundleId, cpmcModulePsa=cpmcModulePsa, cpmcModulePsaFeaturesEnabled=cpmcModulePsaFeaturesEnabled, cpmcBundle=cpmcBundle, cpmcNotif=cpmcNotif, cpmcBundleEntry=cpmcBundleEntry, ciscoPsaMicrocodeMIBObjects=ciscoPsaMicrocodeMIBObjects)
