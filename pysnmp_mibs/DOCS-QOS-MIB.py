...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/DOCS-QOS-MIB
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowAdmittedTimeout=docsQosServiceFlowAdmittedTimeout, docsQosPktClassInetDestAddr=docsQosPktClassInetDestAddr, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosIfDirection=docsQosIfDirection, docsQosPktClassInetDestAddrType=docsQosPktClassInetDestAddrType, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowTosAndMask=docsQosServiceFlowTosAndMask, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDCCs=docsQosDCCs, docsQosPktClassId=docsQosPktClassId, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosCompliances=docsQosCompliances, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceFlowAdmittedParamSetIndex=docsQosServiceFlowAdmittedParamSetIndex, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPktClassPriority=docsQosPktClassPriority, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowRequestPolicy=docsQosServiceFlowRequestPolicy, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosGroups=docsQosGroups, docsQosPktClassInetSourceAddr=docsQosPktClassInetSourceAddr, docsQosPktClassInetSourceMask=docsQosPktClassInetSourceMask, SchedulingType=SchedulingType, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosObsoleteGroup=docsQosObsoleteGroup, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosCompliance=docsQosCompliance, docsQosServiceFlowSchedulingType=docsQosServiceFlowSchedulingType, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosParamSetGroup=docsQosParamSetGroup, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosDSDReqs=docsQosDSDReqs, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPHSTable=docsQosPHSTable, docsQosDeprecatedGroup=docsQosDeprecatedGroup, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosDSAReqs=docsQosDSAReqs, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosDCCRspDeparts=docsQosDCCRspDeparts, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosSID=docsQosSID, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosPHSSize=docsQosPHSSize, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPHSClassifierIndex=docsQosPHSClassifierIndex, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosPktClassInetDestMask=docsQosPktClassInetDestMask, docsQosServiceFlowActiveTimeout=docsQosServiceFlowActiveTimeout, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosMIB=docsQosMIB, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, BitRate=BitRate, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceFlowTosOrMask=docsQosServiceFlowTosOrMask, docsQosDCCRsps=docsQosDCCRsps, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPHSField=docsQosPHSField, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceFlowProvisionedParamSetIndex=docsQosServiceFlowProvisionedParamSetIndex, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, IfDirection=IfDirection, docsQosParamSetPriority=docsQosParamSetPriority, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassState=docsQosPktClassState, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceClassParamSetIndex=docsQosServiceClassParamSetIndex, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosCmtsGroup=docsQosCmtsGroup, docsQosDSCRsps=docsQosDSCRsps, docsQosMIBObjects=docsQosMIBObjects, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosConformance=docsQosConformance, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosPktClassInetSourceAddrType=docsQosPktClassInetSourceAddrType, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosDSCAcks=docsQosDSCAcks, docsQosPHSIndex=docsQosPHSIndex, docsQosPktClassUserPriApplies=docsQosPktClassUserPriApplies, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassInetSourceMaskType=docsQosPktClassInetSourceMaskType, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetTable=docsQosParamSetTable, docsQosDSCReqs=docsQosDSCReqs, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowId=docsQosServiceFlowId, docsQosPktClassEntry=docsQosPktClassEntry, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceFlowActiveParamSetIndex=docsQosServiceFlowActiveParamSetIndex, docsQosDCCRspArrives=docsQosDCCRspArrives, docsQosPktClassInetDestMaskType=docsQosPktClassInetDestMaskType, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosDCCReqs=docsQosDCCReqs, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosNotification=docsQosNotification, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosPHSMask=docsQosPHSMask)
