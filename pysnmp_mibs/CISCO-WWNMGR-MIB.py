...
RowStatus, TextualConvention, MacAddress, StorageType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "MacAddress", "StorageType", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-WWNMGR-MIB", ciscoWwnmMIBCompliance=ciscoWwnmMIBCompliance, wwnmType1AvailableWwns=wwnmType1AvailableWwns, wwnmType1WwnShortageNotify=wwnmType1WwnShortageNotify, wwnmVsanWwnRowStatus=wwnmVsanWwnRowStatus, ciscoWwnmMIBCompliances=ciscoWwnmMIBCompliances, cwmWwnmConfigurationGroup=cwmWwnmConfigurationGroup, cwmWwnmVsanWwnGroup=cwmWwnmVsanWwnGroup, ciscoWwnmMIBObjects=ciscoWwnmMIBObjects, wwnmTypeOtherWwnShortageNotify=wwnmTypeOtherWwnShortageNotify, wwnmVsanWwn=wwnmVsanWwn, wwnmTypeOtherReservedWwns=wwnmTypeOtherReservedWwns, cwmWwnmNotificationGroup=cwmWwnmNotificationGroup, wwnmVsanWwnEntry=wwnmVsanWwnEntry, wwnmVsanWwnStorageType=wwnmVsanWwnStorageType, wwnmSecondaryBaseMacAddress=wwnmSecondaryBaseMacAddress, wwnmNotificationGroup=wwnmNotificationGroup, ciscoWwnmgrMIB=ciscoWwnmgrMIB, wwnmNotification=wwnmNotification, wwnmType1WwnAvailableNotify=wwnmType1WwnAvailableNotify, PYSNMP_MODULE_ID=ciscoWwnmgrMIB, wwnmConfigurationGroup=wwnmConfigurationGroup, wwnmTypeOtherMaxWwns=wwnmTypeOtherMaxWwns, wwnmVsanWwnTable=wwnmVsanWwnTable, ciscoWwnmMIBGroups=ciscoWwnmMIBGroups, wwnmType1ReservedWwns=wwnmType1ReservedWwns, wwnmTypeOtherAvailableWwns=wwnmTypeOtherAvailableWwns, wwnmNotificationPrefix=wwnmNotificationPrefix, wwnmSecondaryMacAddressRange=wwnmSecondaryMacAddressRange, wwnmType1MaxWwns=wwnmType1MaxWwns, ciscoWwnmMIBCompliance1=ciscoWwnmMIBCompliance1, ciscoWwnmMIBConformance=ciscoWwnmMIBConformance, wwnmTypeOtherWwnAvailableNotify=wwnmTypeOtherWwnAvailableNotify)
