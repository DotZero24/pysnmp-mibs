...
mibBuilder.exportSymbols("FR-ATM-PVC-SERVICE-IWF-MIB", frAtmIwfMIBObjects=frAtmIwfMIBObjects, frAtmIwfConnOverSizedFrames=frAtmIwfConnOverSizedFrames, frAtmIwfTrapsPrefix=frAtmIwfTrapsPrefix, frAtmIwfConnectionDescriptorTable=frAtmIwfConnectionDescriptorTable, frAtmIwfConnFr2AtmLastChange=frAtmIwfConnFr2AtmLastChange, frAtmIwfConnRowStatus=frAtmIwfConnRowStatus, frAtmIwfEquipmentCompliance=frAtmIwfEquipmentCompliance, frAtmIwfVclTable=frAtmIwfVclTable, frAtmIwfConnEncapsulationMappings=frAtmIwfConnEncapsulationMappings, frAtmIwfConnectionTable=frAtmIwfConnectionTable, frAtmIwfConnEncapsulationMappingMode=frAtmIwfConnEncapsulationMappingMode, frAtmIwfConnDescriptorRowStatus=frAtmIwfConnDescriptorRowStatus, frAtmIwfGroups=frAtmIwfGroups, frAtmIwfConnAtm2FrOperStatus=frAtmIwfConnAtm2FrOperStatus, frAtmIwfVclEntry=frAtmIwfVclEntry, frAtmIwfConnectionDescriptorEntry=frAtmIwfConnectionDescriptorEntry, frAtmIwfNotificationsGroup=frAtmIwfNotificationsGroup, frAtmIwfConnVci=frAtmIwfConnVci, frAtmIwfConnectionDescriptorIndex=frAtmIwfConnectionDescriptorIndex, frAtmIwfCompliances=frAtmIwfCompliances, frAtmIwfConnFragAndReassEnabled=frAtmIwfConnFragAndReassEnabled, frAtmIwfConnCrcErrors=frAtmIwfConnCrcErrors, frAtmIwfConnectionEntry=frAtmIwfConnectionEntry, PYSNMP_MODULE_ID=frAtmIwfMIB, frAtmIwfConnDeToClpMappingMode=frAtmIwfConnDeToClpMappingMode, frAtmIwfConnFr2AtmOperStatus=frAtmIwfConnFr2AtmOperStatus, frAtmIwfConnSarTimeOuts=frAtmIwfConnSarTimeOuts, frAtmIwfConnStatusChange=frAtmIwfConnStatusChange, frAtmIwfConnFrPort=frAtmIwfConnFrPort, frAtmIwfConnFailedAal5PduTranslate=frAtmIwfConnFailedAal5PduTranslate, frAtmIwfConnVpi=frAtmIwfConnVpi, frAtmIwfConnFailedFrameTranslate=frAtmIwfConnFailedFrameTranslate, frAtmIwfConnectionDescriptorGroup=frAtmIwfConnectionDescriptorGroup, frAtmIwfConnectionDescriptorIndexNext=frAtmIwfConnectionDescriptorIndexNext, frAtmIwfConnectionDescriptor=frAtmIwfConnectionDescriptor, frAtmIwfConnAtm2FrLastChange=frAtmIwfConnAtm2FrLastChange, frAtmIwfConnArpTranslationEnabled=frAtmIwfConnArpTranslationEnabled, frAtmIwfVclCrossConnectIdentifier=frAtmIwfVclCrossConnectIdentifier, frAtmIwfConnIndex=frAtmIwfConnIndex, frAtmIwfConnCongestionMappingMode=frAtmIwfConnCongestionMappingMode, frAtmIwfMIB=frAtmIwfMIB, frAtmIwfConnDlci=frAtmIwfConnDlci, frAtmIwfConnClpToDeMappingMode=frAtmIwfConnClpToDeMappingMode, frAtmIwfServiceCompliance=frAtmIwfServiceCompliance, frAtmIwfBasicGroup=frAtmIwfBasicGroup, frAtmIwfTraps=frAtmIwfTraps, frAtmIwfConnOverSizedSDUs=frAtmIwfConnOverSizedSDUs, frAtmIwfConnAtmPort=frAtmIwfConnAtmPort, frAtmIwfConnIndexNext=frAtmIwfConnIndexNext, frAtmIwfConformance=frAtmIwfConformance, frAtmIwfAtmVclTableAugmentGroup=frAtmIwfAtmVclTableAugmentGroup, frAtmIwfConnAdminStatus=frAtmIwfConnAdminStatus)
