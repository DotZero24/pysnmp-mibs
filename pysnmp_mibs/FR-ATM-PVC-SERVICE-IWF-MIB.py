...
# Notes
# -----
# ASN.1 source file://mibs/rfc/FR-ATM-PVC-SERVICE-IWF-MIB
...
frAtmIwfEquipmentCompliance.setObjects(
      *(("FR-ATM-PVC-SERVICE-IWF-MIB", "frAtmIwfBasicGroup"),
        ("FR-ATM-PVC-SERVICE-IWF-MIB", "frAtmIwfConnectionDescriptorGroup"),
        ("FR-ATM-PVC-SERVICE-IWF-MIB", "frAtmIwfAtmVclTableAugmentGroup"),
        ("FR-ATM-PVC-SERVICE-IWF-MIB", "frAtmIwfNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
frAtmIwfServiceCompliance.setObjects(
      *(("FR-ATM-PVC-SERVICE-IWF-MIB", "frAtmIwfBasicGroup"),
        ("FR-ATM-PVC-SERVICE-IWF-MIB", "frAtmIwfConnectionDescriptorGroup"),
        ("FR-ATM-PVC-SERVICE-IWF-MIB", "frAtmIwfAtmVclTableAugmentGroup"),
        ("FR-ATM-PVC-SERVICE-IWF-MIB", "frAtmIwfNotificationsGroup"))
