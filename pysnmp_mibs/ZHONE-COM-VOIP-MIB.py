...
mibBuilder.exportSymbols("ZHONE-COM-VOIP-MIB", zhoneVoipServerSessionCallerReqTimer=zhoneVoipServerSessionCallerReqTimer, zhoneVoipSystemInterdigitTimeout=zhoneVoipSystemInterdigitTimeout, zhoneVoipHuntGroupRowStatus=zhoneVoipHuntGroupRowStatus, zhoneVoipServerAddr=zhoneVoipServerAddr, zhoneVoipMaliciousCallerTable=zhoneVoipMaliciousCallerTable, zhoneVoipServerRtcpEnabled=zhoneVoipServerRtcpEnabled, zhoneVoipServerTransportProtocol=zhoneVoipServerTransportProtocol, zhoneVoipSystemSendCallProceedingTone=zhoneVoipSystemSendCallProceedingTone, zhoneVoipServerCfg=zhoneVoipServerCfg, zhoneVoipHuntGroupTable=zhoneVoipHuntGroupTable, zhoneVoipServerTable=zhoneVoipServerTable, zhoneVoipSipDialPrefixStrip=zhoneVoipSipDialPrefixStrip, zhoneVoipMaliciousCallerRowStatus=zhoneVoipMaliciousCallerRowStatus, zhoneVoipMaliciousCallerEnable=zhoneVoipMaliciousCallerEnable, zhoneVoipServerFeatures=zhoneVoipServerFeatures, zhoneVoipServerId=zhoneVoipServerId, zhoneVoipObjects=zhoneVoipObjects, zhoneVoipServerProtocol=zhoneVoipServerProtocol, zhoneVoipServerDtmfPayloadId=zhoneVoipServerDtmfPayloadId, zhoneVoipServerIpTos=zhoneVoipServerIpTos, zhoneVoipSipDialIpAddr=zhoneVoipSipDialIpAddr, zhoneVoipSystemRtcpPacketInterval=zhoneVoipSystemRtcpPacketInterval, zhoneVoipSipDialPlanType=zhoneVoipSipDialPlanType, zhoneVoipSipDialPrefixAdd=zhoneVoipSipDialPrefixAdd, zhoneVoipServerMessageRetryCount=zhoneVoipServerMessageRetryCount, zhoneVoipServerDomainName=zhoneVoipServerDomainName, zhoneVoipSystem=zhoneVoipSystem, zhoneVoipSipDialPlan=zhoneVoipSipDialPlan, zhoneVoipSipDialPlanId=zhoneVoipSipDialPlanId, zhoneVoip=zhoneVoip, zhoneVoipSipDialPlanClass=zhoneVoipSipDialPlanClass, zhoneVoipSipDialNumOfDigits=zhoneVoipSipDialNumOfDigits, zhoneVoipServerEntry=zhoneVoipServerEntry, zhoneVoipServerSessionTimer=zhoneVoipServerSessionTimer, zhoneVoipSipDialPlanTable=zhoneVoipSipDialPlanTable, zhoneVoipMaliciousCallerId=zhoneVoipMaliciousCallerId, zhoneVoipOverrideInterdigitTimeout=zhoneVoipOverrideInterdigitTimeout, zhoneVoipServerBehaviorStringOne=zhoneVoipServerBehaviorStringOne, zhoneVoipHuntGroupId=zhoneVoipHuntGroupId, zhoneVoipHuntGroup=zhoneVoipHuntGroup, zhoneVoipMaliciousCaller=zhoneVoipMaliciousCaller, zhoneVoipMaliciousCallerUri=zhoneVoipMaliciousCallerUri, zhoneVoipServerSendCallProceedingTone=zhoneVoipServerSendCallProceedingTone, zhoneVoipServerRtpTermIdSyntax=zhoneVoipServerRtpTermIdSyntax, zhoneVoipHuntGroupDefaultCodec=zhoneVoipHuntGroupDefaultCodec, zhoneVoipSystemRtcpEnabled=zhoneVoipSystemRtcpEnabled, zhoneVoipServerRegisterReadyTimeout=zhoneVoipServerRegisterReadyTimeout, PYSNMP_MODULE_ID=zhoneVoip, zhoneVoipServerExpiresRegister=zhoneVoipServerExpiresRegister, zhoneVoipServerSessionCallerSpecifyRefresher=zhoneVoipServerSessionCallerSpecifyRefresher, zhoneVoipServerInterDigitTimeout=zhoneVoipServerInterDigitTimeout, zhoneVoipServerSessionCalleeReqTimer=zhoneVoipServerSessionCalleeReqTimer, zhoneVoipSystemDomainName=zhoneVoipSystemDomainName, zhoneVoipSipDialString=zhoneVoipSipDialString, zhoneVoipServerHeaderMethod=zhoneVoipServerHeaderMethod, zhoneVoipSipDialPlanDescription=zhoneVoipSipDialPlanDescription, nextZhoneVoipHuntGroupId=nextZhoneVoipHuntGroupId, zhoneVoipServerAddrType=zhoneVoipServerAddrType, nextVoipSipDialPlanId=nextVoipSipDialPlanId, zhoneVoipServerRtcpPacketInterval=zhoneVoipServerRtcpPacketInterval, zhoneVoipSipDialPlanEntry=zhoneVoipSipDialPlanEntry, zhoneVoipHuntGroupPortMembers=zhoneVoipHuntGroupPortMembers, zhoneVoipSigLocalPortNumber=zhoneVoipSigLocalPortNumber, zhoneVoipServerAddressIndex=zhoneVoipServerAddressIndex, zhoneVoipServerRtpDSCP=zhoneVoipServerRtpDSCP, zhoneVoipServerSignalingDSCP=zhoneVoipServerSignalingDSCP, zhoneVoipServerDtmfMode=zhoneVoipServerDtmfMode, zhoneVoipSipDialPlanRowStatus=zhoneVoipSipDialPlanRowStatus, zhoneVoipServerRowStatus=zhoneVoipServerRowStatus, zhoneVoipServerExpiresInvite=zhoneVoipServerExpiresInvite, zhoneVoipSystemProtocol=zhoneVoipSystemProtocol, zhoneVoipServerSessionExpiration=zhoneVoipServerSessionExpiration, zhoneVoipMaliciousCallerEntry=zhoneVoipMaliciousCallerEntry, zhoneVoipServerEntryIndex=zhoneVoipServerEntryIndex, zhoneVoipHuntGroupEntry=zhoneVoipHuntGroupEntry, zhoneVoipServerUdpPortNumber=zhoneVoipServerUdpPortNumber, zhoneVoipServerSessionMinSE=zhoneVoipServerSessionMinSE, zhoneVoipSipDialDestName=zhoneVoipSipDialDestName, zhoneVoipSystemIpTos=zhoneVoipSystemIpTos, zhoneVoipServerSessionCalleeSpecifyRefresher=zhoneVoipServerSessionCalleeSpecifyRefresher, zhoneVoipHuntGroupDestUri=zhoneVoipHuntGroupDestUri, nextVoipMaliciousCallerId=nextVoipMaliciousCallerId)
