# SNMP MIB module (ALCATEL-ENT1-PIM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-PIM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:09:11 2025
...
class _AlaPimsmRPHashStatus_Type(Integer32):
    """Custom type alaPimsmRPHashStatus based on Integer32"""
    defaultValue = 2
...
_AlaPimsmRPHashStatus_Type.__name__ = "Integer32"
_AlaPimsmRPHashStatus_Object = MibScalar
alaPimsmRPHashStatus = _AlaPimsmRPHashStatus_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 1, 18),
    _AlaPimsmRPHashStatus_Type()
)
alaPimsmRPHashStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimsmRPHashStatus.setStatus("current")


class _AlaPimsmBidirSsmCompat_Type(Integer32):
    """Custom type alaPimsmBidirSsmCompat based on Integer32"""
    defaultValue = 2
...
_AlaPimsmBidirSsmCompat_Type.__name__ = "Integer32"
_AlaPimsmBidirSsmCompat_Object = MibScalar
alaPimsmBidirSsmCompat = _AlaPimsmBidirSsmCompat_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 1, 19),
    _AlaPimsmBidirSsmCompat_Type()
)
alaPimsmBidirSsmCompat.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimsmBidirSsmCompat.setStatus("current")


class _AlaPimsmV6BidirSsmCompat_Type(Integer32):
    """Custom type alaPimsmV6BidirSsmCompat based on Integer32"""
    defaultValue = 2
...
_AlaPimsmV6BidirSsmCompat_Type.__name__ = "Integer32"
_AlaPimsmV6BidirSsmCompat_Object = MibScalar
alaPimsmV6BidirSsmCompat = _AlaPimsmV6BidirSsmCompat_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 1, 20),
    _AlaPimsmV6BidirSsmCompat_Type()
)
alaPimsmV6BidirSsmCompat.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimsmV6BidirSsmCompat.setStatus("current")


class _AlaPimsmBidirFastJoin_Type(Integer32):
    """Custom type alaPimsmBidirFastJoin based on Integer32"""
    defaultValue = 2
...
_AlaPimsmBidirFastJoin_Type.__name__ = "Integer32"
_AlaPimsmBidirFastJoin_Object = MibScalar
alaPimsmBidirFastJoin = _AlaPimsmBidirFastJoin_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 1, 21),
    _AlaPimsmBidirFastJoin_Type()
)
alaPimsmBidirFastJoin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimsmBidirFastJoin.setStatus("current")


class _AlaPimsmV6BidirFastJoin_Type(Integer32):
    """Custom type alaPimsmV6BidirFastJoin based on Integer32"""
    defaultValue = 2
...
_AlaPimsmV6BidirFastJoin_Type.__name__ = "Integer32"
_AlaPimsmV6BidirFastJoin_Object = MibScalar
alaPimsmV6BidirFastJoin = _AlaPimsmV6BidirFastJoin_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 1, 22),
    _AlaPimsmV6BidirFastJoin_Type()
)
alaPimsmV6BidirFastJoin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimsmV6BidirFastJoin.setStatus("current")


class _AlaPimsmAsmFastJoin_Type(Integer32):
    """Custom type alaPimsmAsmFastJoin based on Integer32"""
    defaultValue = 2
...
_AlaPimsmAsmFastJoin_Type.__name__ = "Integer32"
_AlaPimsmAsmFastJoin_Object = MibScalar
alaPimsmAsmFastJoin = _AlaPimsmAsmFastJoin_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 1, 23),
    _AlaPimsmAsmFastJoin_Type()
)
alaPimsmAsmFastJoin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimsmAsmFastJoin.setStatus("current")


class _AlaPimsmV6AsmFastJoin_Type(Integer32):
    """Custom type alaPimsmV6AsmFastJoin based on Integer32"""
    defaultValue = 2
...
_AlaPimsmV6AsmFastJoin_Type.__name__ = "Integer32"
_AlaPimsmV6AsmFastJoin_Object = MibScalar
alaPimsmV6AsmFastJoin = _AlaPimsmV6AsmFastJoin_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 1, 24),
    _AlaPimsmV6AsmFastJoin_Type()
)
alaPimsmV6AsmFastJoin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimsmV6AsmFastJoin.setStatus("current")


class _AlaPimsmSsmFastJoin_Type(Integer32):
    """Custom type alaPimsmSsmFastJoin based on Integer32"""
    defaultValue = 2
...
_AlaPimsmSsmFastJoin_Type.__name__ = "Integer32"
_AlaPimsmSsmFastJoin_Object = MibScalar
alaPimsmSsmFastJoin = _AlaPimsmSsmFastJoin_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 1, 25),
    _AlaPimsmSsmFastJoin_Type()
)
alaPimsmSsmFastJoin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimsmSsmFastJoin.setStatus("current")


class _AlaPimsmV6SsmFastJoin_Type(Integer32):
    """Custom type alaPimsmV6SsmFastJoin based on Integer32"""
    defaultValue = 2
...
_AlaPimsmV6SsmFastJoin_Type.__name__ = "Integer32"
_AlaPimsmV6SsmFastJoin_Object = MibScalar
alaPimsmV6SsmFastJoin = _AlaPimsmV6SsmFastJoin_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 1, 26),
    _AlaPimsmV6SsmFastJoin_Type()
)
alaPimsmV6SsmFastJoin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimsmV6SsmFastJoin.setStatus("current")
...
alaPimdmDenseGroupEntry.setIndexNames(
    (0, "ALCATEL-ENT1-PIM-MIB", "alaPimdmDenseGroupAddressType"),
    (0, "ALCATEL-ENT1-PIM-MIB", "alaPimdmDenseGroupGrpAddress"),
    (0, "ALCATEL-ENT1-PIM-MIB", "alaPimdmDenseGroupGrpPrefixLength"),
)
if mibBuilder.loadTexts:
...
_AlaPimdmDenseGroupOverrideDynamic_Type.__name__ = "TruthValue"
...
alaPimBfdStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
alaPimBfdAllInterfaceStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
alaPimInterfaceBfdStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
class _AlaPimV6BfdStatus_Type(Integer32):
    """Custom type alaPimV6BfdStatus based on Integer32"""
    defaultValue = 2
...
_AlaPimV6BfdStatus_Type.__name__ = "Integer32"
_AlaPimV6BfdStatus_Object = MibScalar
alaPimV6BfdStatus = _AlaPimV6BfdStatus_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 3, 8),
    _AlaPimV6BfdStatus_Type()
)
alaPimV6BfdStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimV6BfdStatus.setStatus("current")


class _AlaPimV6BfdAllInterfaceStatus_Type(Integer32):
    """Custom type alaPimV6BfdAllInterfaceStatus based on Integer32"""
    defaultValue = 2
...
_AlaPimV6BfdAllInterfaceStatus_Type.__name__ = "Integer32"
_AlaPimV6BfdAllInterfaceStatus_Object = MibScalar
alaPimV6BfdAllInterfaceStatus = _AlaPimV6BfdAllInterfaceStatus_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 10, 6, 1, 1, 3, 9),
    _AlaPimV6BfdAllInterfaceStatus_Type()
)
alaPimV6BfdAllInterfaceStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaPimV6BfdAllInterfaceStatus.setStatus("current")
...
alaPimsmConfigMIBGroup.setObjects(
      *(("ALCATEL-ENT1-PIM-MIB", "alaPimsmAdminStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmMaxRPs"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmProbeTime"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmOldRegisterMessageSupport"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmAdminSPTConfig"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmRPThreshold"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmV6AdminStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmV6SPTConfig"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmV6RPSwitchover"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmBidirStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmBidirPeriodicInterval"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmBidirDFAbort"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmNonBidirHelloPeriod"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmNonBidirHelloMsgsRcvd"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmV6BidirStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmRPHashStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmBidirSsmCompat"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmV6BidirSsmCompat"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmBidirFastJoin"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmV6BidirFastJoin"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmAsmFastJoin"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmV6AsmFastJoin"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmSsmFastJoin"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmV6SsmFastJoin"))
)
if mibBuilder.loadTexts:
...
alaPimdmConfigMIBGroup.setObjects(
      *(("ALCATEL-ENT1-PIM-MIB", "alaPimdmAdminStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimdmStateRefreshTimeToLive"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimdmStateRefreshLimitInterval"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimdmV6AdminStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimdmDenseGroupOverrideDynamic"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimdmDenseGroupPrecedence"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimdmDenseGroupRowStatus"))
)
if mibBuilder.loadTexts:
...
alaPimConfigMIBGroup.setObjects(
      *(("ALCATEL-ENT1-PIM-MIB", "alaPimBfdStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimBfdAllInterfaceStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimMoFRRStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimMoFRRAllRouteStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimInterfaceBfdStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimMbrAllSourcesStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimMbrOperStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimV6BfdStatus"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimV6BfdAllInterfaceStatus"))
)
if mibBuilder.loadTexts:
...
alaPimOptionalGroup.setObjects(
      *(("ALCATEL-ENT1-PIM-MIB", "alaPimsmNonBidirHelloAddressType"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimsmNonBidirHelloOrigin"))
)
if mibBuilder.loadTexts:
...
alaPimNotificationGroup.setObjects(
    ("ALCATEL-ENT1-PIM-MIB", "alaPimNonBidirHello")
)
if mibBuilder.loadTexts:
...
alaPimsmCompliance.setObjects(
      *(("ALCATEL-ENT1-PIM-MIB", "alaPimsmConfigMIBGroup"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimConfigMIBGroup"))
)
if mibBuilder.loadTexts:
...
alaPimdmCompliance.setObjects(
      *(("ALCATEL-ENT1-PIM-MIB", "alaPimdmConfigMIBGroup"),
        ("ALCATEL-ENT1-PIM-MIB", "alaPimConfigMIBGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"alcatelIND1PIMMIB": alcatelIND1PIMMIB,
       ...
       "alaPimsmRPHashStatus": alaPimsmRPHashStatus,
       "alaPimsmBidirSsmCompat": alaPimsmBidirSsmCompat,
       "alaPimsmV6BidirSsmCompat": alaPimsmV6BidirSsmCompat,
       "alaPimsmBidirFastJoin": alaPimsmBidirFastJoin,
       "alaPimsmV6BidirFastJoin": alaPimsmV6BidirFastJoin,
       "alaPimsmAsmFastJoin": alaPimsmAsmFastJoin,
       "alaPimsmV6AsmFastJoin": alaPimsmV6AsmFastJoin,
       "alaPimsmSsmFastJoin": alaPimsmSsmFastJoin,
       "alaPimsmV6SsmFastJoin": alaPimsmV6SsmFastJoin,
       ...
       "alaPimV6BfdStatus": alaPimV6BfdStatus,
       "alaPimV6BfdAllInterfaceStatus": alaPimV6BfdAllInterfaceStatus,
