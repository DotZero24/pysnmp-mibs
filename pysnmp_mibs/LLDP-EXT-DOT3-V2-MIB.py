...
# Notes
# -----
# ASN.1 source file://mibs/rfc/LLDP-EXT-DOT3-V2-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:19:32 2025
...
lldpV2Xdot3TxRxCompliance.setObjects(
      *(("LLDP-EXT-DOT3-V2-MIB", "lldpV2Xdot3ConfigGroup"),
        ("LLDP-EXT-DOT3-V2-MIB", "ifGeneralInformationGroup"))
)
if mibBuilder.loadTexts:
...
lldpV2Xdot3TxCompliance.setObjects(
    ("LLDP-EXT-DOT3-V2-MIB", "lldpV2Xdot3LocSysGroup")
)
if mibBuilder.loadTexts:
...
lldpV2Xdot3RxCompliance.setObjects(
    ("LLDP-EXT-DOT3-V2-MIB", "lldpV2Xdot3RemSysGroup")
)
if mibBuilder.loadTexts:
