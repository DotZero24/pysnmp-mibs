# SNMP MIB module (Dell-SSH-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-SSH-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:07:20 2025
...
rlSshServerHostPublicKeyTableEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshServerHostPublicKeyAlgorithm"),
    (0, "Dell-SSH-MIB", "rlSshServerHostPublicKeyFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSshServerHostPublicKeyFingerprintTableEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshServerHostPublicKeyFingerprintAlgorithm"),
    (0, "Dell-SSH-MIB", "rlSshServerHostPublicKeyFingerprintDigestFormat"),
)
if mibBuilder.loadTexts:
...
rlSshServerAuthorizedUsersPublicKeyTableEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshServerAuthorizedUserName"),
    (0, "Dell-SSH-MIB", "rlSshServerAuthorizedUserPublicKeyFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSshServerAuthorizedUsersPublicKeyFingerprintTableEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshServerAuthorizedUserFingerprintName"),
    (0, "Dell-SSH-MIB", "rlSshServerAuthorizedUserPublicKeyFingerprintDigestFormat"),
)
if mibBuilder.loadTexts:
...
rlSshServerSessionTableEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshServerSessionIdentifier"),
)
if mibBuilder.loadTexts:
...
rlSshServerSessionInetTableEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshServerSessionInetIdentifier"),
)
if mibBuilder.loadTexts:
...
rlSshServerImportExportSelfKeyEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshServerImportExportSelfKeyAlgorithm"),
    (0, "Dell-SSH-MIB", "rlSshServerImportExportSelfKeyFormat"),
    (0, "Dell-SSH-MIB", "rlSshServerImportExportSelfKeyFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSshClientSelfPublicKeyTableEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshClientSelfPublicKeyAlgorithm"),
    (0, "Dell-SSH-MIB", "rlSshClientSelfPublicKeyFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSshClientSelfPublicKeyFingerprintTableEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshClientSelfPublicKeyFingerprintAlgorithm"),
    (0, "Dell-SSH-MIB", "rlSshClientSelfPublicKeyFingerprintDigestFormat"),
)
if mibBuilder.loadTexts:
...
rlSshClientPasswordChangeEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshClientPasswordChangeInetAddrType"),
    (0, "Dell-SSH-MIB", "rlSshClientPasswordChangeInetAddr"),
)
if mibBuilder.loadTexts:
...
rlSshClientImportExportSelfKeyEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshClientImportExportSelfKeyAlgorithm"),
    (0, "Dell-SSH-MIB", "rlSshClientImportExportSelfKeyFormat"),
    (0, "Dell-SSH-MIB", "rlSshClientImportExportSelfKeyFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSshClientRemoteServerPublicKeyFingerprintEntry.setIndexNames(
    (0, "Dell-SSH-MIB", "rlSshClientRemoteServerFingerprintInetAddrType"),
    (0, "Dell-SSH-MIB", "rlSshClientRemoteServerFingerprintInetAddr"),
    (0, "Dell-SSH-MIB", "rlSshClientRemoteServerFingerprint"),
)
if mibBuilder.loadTexts:
