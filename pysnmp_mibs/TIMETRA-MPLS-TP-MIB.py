...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-MPLS-TP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:49:08 2025
...
_VRtrMplsTpV14v0Groups_ObjectIdentity = ObjectIdentity
vRtrMplsTpV14v0Groups = _VRtrMplsTpV14v0Groups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 83, 2, 3)
)
...
class _VRtrMplsTpLspPathMepSupBfdNotif_Type(TruthValue):
    """Custom type vRtrMplsTpLspPathMepSupBfdNotif based on TruthValue"""
    defaultValue = 2


_VRtrMplsTpLspPathMepSupBfdNotif_Type.__name__ = "TruthValue"
_VRtrMplsTpLspPathMepSupBfdNotif_Object = MibTableColumn
vRtrMplsTpLspPathMepSupBfdNotif = _VRtrMplsTpLspPathMepSupBfdNotif_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 83, 2, 3, 3, 1, 10),
    _VRtrMplsTpLspPathMepSupBfdNotif_Type()
)
vRtrMplsTpLspPathMepSupBfdNotif.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrMplsTpLspPathMepSupBfdNotif.setStatus("current")
...
_VRtrMplsTpLspPathMepStatTable_Object = MibTable
vRtrMplsTpLspPathMepStatTable = _VRtrMplsTpLspPathMepStatTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 83, 2, 3, 5)
)
if mibBuilder.loadTexts:
    vRtrMplsTpLspPathMepStatTable.setStatus("current")
_VRtrMplsTpLspPathMepStatEntry_Object = MibTableRow
vRtrMplsTpLspPathMepStatEntry = _VRtrMplsTpLspPathMepStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 83, 2, 3, 5, 1)
)
if mibBuilder.loadTexts:
    vRtrMplsTpLspPathMepStatEntry.setStatus("current")
_VRtrMplsTpLspPathMepAisLsrGlbId_Type = TmnxMplsTpGlobalID
_VRtrMplsTpLspPathMepAisLsrGlbId_Object = MibTableColumn
vRtrMplsTpLspPathMepAisLsrGlbId = _VRtrMplsTpLspPathMepAisLsrGlbId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 83, 2, 3, 5, 1, 1),
    _VRtrMplsTpLspPathMepAisLsrGlbId_Type()
)
vRtrMplsTpLspPathMepAisLsrGlbId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMplsTpLspPathMepAisLsrGlbId.setStatus("current")
_VRtrMplsTpLspPathMepAisLsrNodeId_Type = TmnxMplsTpNodeID
_VRtrMplsTpLspPathMepAisLsrNodeId_Object = MibTableColumn
vRtrMplsTpLspPathMepAisLsrNodeId = _VRtrMplsTpLspPathMepAisLsrNodeId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 83, 2, 3, 5, 1, 2),
    _VRtrMplsTpLspPathMepAisLsrNodeId_Type()
)
vRtrMplsTpLspPathMepAisLsrNodeId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMplsTpLspPathMepAisLsrNodeId.setStatus("current")
_VRtrMplsTpLspPathMepAisLsrIfNum_Type = Unsigned32
_VRtrMplsTpLspPathMepAisLsrIfNum_Object = MibTableColumn
vRtrMplsTpLspPathMepAisLsrIfNum = _VRtrMplsTpLspPathMepAisLsrIfNum_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 83, 2, 3, 5, 1, 3),
    _VRtrMplsTpLspPathMepAisLsrIfNum_Type()
)
vRtrMplsTpLspPathMepAisLsrIfNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vRtrMplsTpLspPathMepAisLsrIfNum.setStatus("current")
...
class _VRtrMplsTpIfAisEnable_Type(TruthValue):
    """Custom type vRtrMplsTpIfAisEnable based on TruthValue"""
    defaultValue = 2


_VRtrMplsTpIfAisEnable_Type.__name__ = "TruthValue"
_VRtrMplsTpIfAisEnable_Object = MibTableColumn
vRtrMplsTpIfAisEnable = _VRtrMplsTpIfAisEnable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 83, 2, 6, 1, 1, 5),
    _VRtrMplsTpIfAisEnable_Type()
)
vRtrMplsTpIfAisEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    vRtrMplsTpIfAisEnable.setStatus("current")
...
vRtrMplsTpLspPathMepEntry.registerAugmentions(
    ("TIMETRA-MPLS-TP-MIB",
...
vRtrMplsTpInterfaceV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 83, 2, 3, 1)
)
vRtrMplsTpInterfaceV14v0Group.setObjects(
    ("TIMETRA-MPLS-TP-MIB", "vRtrMplsTpIfAisEnable")
)
if mibBuilder.loadTexts:
    vRtrMplsTpInterfaceV14v0Group.setStatus("current")

vRtrMplsTpLspPathMepV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 83, 2, 3, 2)
)
vRtrMplsTpLspPathMepV14v0Group.setObjects(
      *(("TIMETRA-MPLS-TP-MIB", "vRtrMplsTpLspPathMepSupBfdNotif"),
        ("TIMETRA-MPLS-TP-MIB", "vRtrMplsTpLspPathMepAisLsrGlbId"),
        ("TIMETRA-MPLS-TP-MIB", "vRtrMplsTpLspPathMepAisLsrNodeId"),
        ("TIMETRA-MPLS-TP-MIB", "vRtrMplsTpLspPathMepAisLsrIfNum"))
)
if mibBuilder.loadTexts:
    vRtrMplsTpLspPathMepV14v0Group.setStatus("current")
...
vRtrMplsTpV14v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 83, 1, 3)
)
vRtrMplsTpV14v0Compliance.setObjects(
      *(("TIMETRA-MPLS-TP-MIB", "vRtrMplsTpInterfaceV14v0Group"),
        ("TIMETRA-MPLS-TP-MIB", "vRtrMplsTpLspPathMepV14v0Group"))
)
if mibBuilder.loadTexts:
    vRtrMplsTpV14v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"VRtrMplsTpLspPathMepPduType": VRtrMplsTpLspPathMepPduType,
       ...
       "vRtrMplsTpV14v0Compliance": vRtrMplsTpV14v0Compliance,
       ...
       "vRtrMplsTpV14v0Groups": vRtrMplsTpV14v0Groups,
       "vRtrMplsTpInterfaceV14v0Group": vRtrMplsTpInterfaceV14v0Group,
       "vRtrMplsTpLspPathMepV14v0Group": vRtrMplsTpLspPathMepV14v0Group,
       ...
       "vRtrMplsTpLspPathMepStatTable": vRtrMplsTpLspPathMepStatTable,
       "vRtrMplsTpLspPathMepStatEntry": vRtrMplsTpLspPathMepStatEntry,
       "vRtrMplsTpLspPathMepAisLsrGlbId": vRtrMplsTpLspPathMepAisLsrGlbId,
       "vRtrMplsTpLspPathMepAisLsrNodeId": vRtrMplsTpLspPathMepAisLsrNodeId,
       "vRtrMplsTpLspPathMepAisLsrIfNum": vRtrMplsTpLspPathMepAisLsrIfNum,
       ...
       "vRtrMplsTpIfAisEnable": vRtrMplsTpIfAisEnable,
