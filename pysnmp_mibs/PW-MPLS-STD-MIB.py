...
# Notes
# -----
# ASN.1 source file://mibs/rfc/PW-MPLS-STD-MIB
...
pwMplsModuleFullCompliance.setObjects(
      *(("PW-MPLS-STD-MIB", "pwMplsGroup"),
        ("PW-MPLS-STD-MIB", "pwMplsOutboundMainGroup"),
        ("PW-MPLS-STD-MIB", "pwMplsInboundGroup"),
        ("PW-MPLS-STD-MIB", "pwMplsMappingGroup"),
        ("PW-MPLS-STD-MIB", "pwMplsOutboundTeGroup"))
)
if mibBuilder.loadTexts:
