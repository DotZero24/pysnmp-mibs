# SNMP MIB module (A3COM-HUAWEI-UI-MAN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-UI-MAN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:46:00 2025
...
h3cTerminalUserName = _H3cTerminalUserName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 1, 2, 1),
...
h3cTerminalSource = _H3cTerminalSource_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 1, 2, 2),
...
h3cTerminalUserAuthFailureReason = _H3cTerminalUserAuthFailureReason_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 1, 2, 3),
...
h3cVtyAccUserIndex = _H3cVtyAccUserIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 2, 1, 1, 1),
...
h3cVtyAccConnway = _H3cVtyAccConnway_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 2, 1, 1, 2),
...
h3cVtyAccAclNum = _H3cVtyAccAclNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 2, 1, 1, 3),
...
h3cVtyAccEntryRowStatus = _H3cVtyAccEntryRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 2, 1, 1, 4),
...
h3cConUserIndex = _H3cConUserIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 3, 1, 1, 1),
...
h3cConReAuth = _H3cConReAuth_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 3, 1, 1, 2),
    _H3cConReAuth_Type()
)
...
h3cLogIn = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 1, 3, 0, 1)
)
h3cLogIn.setObjects(
      *(("A3COM-HUAWEI-UI-MAN-MIB", "h3cTerminalUserName"),
        ("A3COM-HUAWEI-UI-MAN-MIB", "h3cTerminalSource"))
)
if mibBuilder.loadTexts:
    h3cLogIn.setStatus(
        "current"
...
h3cLogOut = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 1, 3, 0, 2)
)
...
h3cLogInAuthenFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 1, 1, 3, 0, 3)
)
h3cLogInAuthenFailure.setObjects(
      *(("A3COM-HUAWEI-UI-MAN-MIB", "h3cTerminalUserName"),
        ("A3COM-HUAWEI-UI-MAN-MIB", "h3cTerminalSource"),
        ("A3COM-HUAWEI-UI-MAN-MIB", "h3cTerminalUserAuthFailureReason"))
)
if mibBuilder.loadTexts:
...
h3cUIMgtMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 2, 2, 1, 1)
)
h3cUIMgtMIBCompliance.setObjects(
      *(("A3COM-HUAWEI-UI-MAN-MIB", "h3cUIMgtBasicGroup"),
        ("A3COM-HUAWEI-UI-MAN-MIB", "h3cConStatusGroup"))
)
if mibBuilder.loadTexts:
