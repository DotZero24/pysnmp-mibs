...
agentSntpClientObjects=_AgentSntpClientObjects_ObjectIdentity((1,3,6,1,4,1,4413,1,1,17,1))
_AgentSntpClient_ObjectIdentity=ObjectIdentity
agentSntpClient=_AgentSntpClient_ObjectIdentity((1,3,6,1,4,1,4413,1,1,17,1,1))
...
agentSntpClientVersion=_AgentSntpClientVersion_Object((1,3,6,1,4,1,4413,1,1,17,1,1,1),_AgentSntpClientVersion_Type())
...
agentSntpClientSupportedMode=_AgentSntpClientSupportedMode_Object((1,3,6,1,4,1,4413,1,1,17,1,1,2),_AgentSntpClientSupportedMode_Type())
...
agentSntpClientMode=_AgentSntpClientMode_Object((1,3,6,1,4,1,4413,1,1,17,1,1,3),_AgentSntpClientMode_Type())
...
agentSntpClientPort=_AgentSntpClientPort_Object((1,3,6,1,4,1,4413,1,1,17,1,1,4),_AgentSntpClientPort_Type())
...
agentSntpClientLastUpdateTime=_AgentSntpClientLastUpdateTime_Object((1,3,6,1,4,1,4413,1,1,17,1,1,5),_AgentSntpClientLastUpdateTime_Type())
...
agentSntpClientLastAttemptTime=_AgentSntpClientLastAttemptTime_Object((1,3,6,1,4,1,4413,1,1,17,1,1,6),_AgentSntpClientLastAttemptTime_Type())
...
agentSntpClientLastAttemptStatus=_AgentSntpClientLastAttemptStatus_Object((1,3,6,1,4,1,4413,1,1,17,1,1,7),_AgentSntpClientLastAttemptStatus_Type())
...
agentSntpClientServerAddressType=_AgentSntpClientServerAddressType_Object((1,3,6,1,4,1,4413,1,1,17,1,1,8),_AgentSntpClientServerAddressType_Type())
...
agentSntpClientServerAddress=_AgentSntpClientServerAddress_Object((1,3,6,1,4,1,4413,1,1,17,1,1,9),_AgentSntpClientServerAddress_Type())
...
agentSntpClientServerMode=_AgentSntpClientServerMode_Object((1,3,6,1,4,1,4413,1,1,17,1,1,10),_AgentSntpClientServerMode_Type())
...
agentSntpClientServerStratum=_AgentSntpClientServerStratum_Object((1,3,6,1,4,1,4413,1,1,17,1,1,11),_AgentSntpClientServerStratum_Type())
...
agentSntpClientServerRefClkId=_AgentSntpClientServerRefClkId_Object((1,3,6,1,4,1,4413,1,1,17,1,1,12),_AgentSntpClientServerRefClkId_Type())
...
agentSntpClientPollInterval=_AgentSntpClientPollInterval_Object((1,3,6,1,4,1,4413,1,1,17,1,1,13),_AgentSntpClientPollInterval_Type())
...
agentSntpClientSourceInterface=_AgentSntpClientSourceInterface_Object((1,3,6,1,4,1,4413,1,1,17,1,1,14),_AgentSntpClientSourceInterface_Type())
...
agentSntpClientServicePortSrcInterface=_AgentSntpClientServicePortSrcInterface_Object((1,3,6,1,4,1,4413,1,1,17,1,1,15),_AgentSntpClientServicePortSrcInterface_Type())
...
agentSntpClientUnicast=_AgentSntpClientUnicast_ObjectIdentity((1,3,6,1,4,1,4413,1,1,17,1,2))
...
agentSntpClientUnicastPollInterval=_AgentSntpClientUnicastPollInterval_Object((1,3,6,1,4,1,4413,1,1,17,1,2,1),_AgentSntpClientUnicastPollInterval_Type())
...
agentSntpClientUnicastPollTimeout=_AgentSntpClientUnicastPollTimeout_Object((1,3,6,1,4,1,4413,1,1,17,1,2,2),_AgentSntpClientUnicastPollTimeout_Type())
...
agentSntpClientUnicastPollRetry=_AgentSntpClientUnicastPollRetry_Object((1,3,6,1,4,1,4413,1,1,17,1,2,3),_AgentSntpClientUnicastPollRetry_Type())
...
agentSntpClientUcastServerMaxEntries=_AgentSntpClientUcastServerMaxEntries_Object((1,3,6,1,4,1,4413,1,1,17,1,2,4),_AgentSntpClientUcastServerMaxEntries_Type())
...
agentSntpClientUcastServerCurrEntries=_AgentSntpClientUcastServerCurrEntries_Object((1,3,6,1,4,1,4413,1,1,17,1,2,5),_AgentSntpClientUcastServerCurrEntries_Type())
...
agentSntpClientUcastServerTable=_AgentSntpClientUcastServerTable_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6))
if mibBuilder.loadTexts:agentSntpClientUcastServerTable.setStatus(_A)
_AgentSntpClientUcastServerEntry_Object=MibTableRow
agentSntpClientUcastServerEntry=_AgentSntpClientUcastServerEntry_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1))
...
agentSntpClientUcastServerIndex=_AgentSntpClientUcastServerIndex_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,1),_AgentSntpClientUcastServerIndex_Type())
...
agentSntpClientUcastServerAddressType=_AgentSntpClientUcastServerAddressType_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,2),_AgentSntpClientUcastServerAddressType_Type())
...
agentSntpClientUcastServerAddress=_AgentSntpClientUcastServerAddress_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,3),_AgentSntpClientUcastServerAddress_Type())
...
agentSntpClientUcastServerPort=_AgentSntpClientUcastServerPort_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,4),_AgentSntpClientUcastServerPort_Type())
...
agentSntpClientUcastServerVersion=_AgentSntpClientUcastServerVersion_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,5),_AgentSntpClientUcastServerVersion_Type())
...
agentSntpClientUcastServerPrecedence=_AgentSntpClientUcastServerPrecedence_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,6),_AgentSntpClientUcastServerPrecedence_Type())
...
agentSntpClientUcastServerLastUpdateTime=_AgentSntpClientUcastServerLastUpdateTime_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,7),_AgentSntpClientUcastServerLastUpdateTime_Type())
...
agentSntpClientUcastServerLastAttemptTime=_AgentSntpClientUcastServerLastAttemptTime_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,8),_AgentSntpClientUcastServerLastAttemptTime_Type())
...
agentSntpClientUcastServerLastAttemptStatus=_AgentSntpClientUcastServerLastAttemptStatus_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,9),_AgentSntpClientUcastServerLastAttemptStatus_Type())
...
agentSntpClientUcastServerNumRequests=_AgentSntpClientUcastServerNumRequests_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,10),_AgentSntpClientUcastServerNumRequests_Type())
...
agentSntpClientUcastServerNumFailedRequests=_AgentSntpClientUcastServerNumFailedRequests_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,11),_AgentSntpClientUcastServerNumFailedRequests_Type())
...
agentSntpClientUcastServerRowStatus=_AgentSntpClientUcastServerRowStatus_Object((1,3,6,1,4,1,4413,1,1,17,1,2,6,1,12),_AgentSntpClientUcastServerRowStatus_Type())
...
agentSntpClientBroadcast=_AgentSntpClientBroadcast_ObjectIdentity((1,3,6,1,4,1,4413,1,1,17,1,3))
_AgentSntpClientBroadcastCount_Type=Counter32
_AgentSntpClientBroadcastCount_Object=MibScalar
agentSntpClientBroadcastCount=_AgentSntpClientBroadcastCount_Object((1,3,6,1,4,1,4413,1,1,17,1,3,1),_AgentSntpClientBroadcastCount_Type())
...
agentSntpClientBroadcastInterval=_AgentSntpClientBroadcastInterval_Object((1,3,6,1,4,1,4413,1,1,17,1,3,2),_AgentSntpClientBroadcastInterval_Type())
...
agentSntpClientConformance=_AgentSntpClientConformance_ObjectIdentity((1,3,6,1,4,1,4413,1,1,17,2))
_AgentSntpClientGroups_ObjectIdentity=ObjectIdentity
agentSntpClientGroups=_AgentSntpClientGroups_ObjectIdentity((1,3,6,1,4,1,4413,1,1,17,2,1))
_AgentSntpClientCompliances_ObjectIdentity=ObjectIdentity
agentSntpClientCompliances=_AgentSntpClientCompliances_ObjectIdentity((1,3,6,1,4,1,4413,1,1,17,2,2))
agentSntpClientDeviceGroup=ObjectGroup((1,3,6,1,4,1,4413,1,1,17,2,1,1))
...
agentSntpClientUnicastGroup=ObjectGroup((1,3,6,1,4,1,4413,1,1,17,2,1,2))
...
agentSntpClientBroadcastGroup=ObjectGroup((1,3,6,1,4,1,4413,1,1,17,2,1,3))
agentSntpClientBroadcastGroup.setObjects(*((_B,_v),(_B,_w)))
if mibBuilder.loadTexts:agentSntpClientBroadcastGroup.setStatus(_A)
agentSntpClientCompliance=ModuleCompliance((1,3,6,1,4,1,4413,1,1,17,2,2,1))
