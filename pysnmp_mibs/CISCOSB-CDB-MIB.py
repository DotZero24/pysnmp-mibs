...
rlStartupCDBChanged=_RlStartupCDBChanged_Object((1,3,6,1,4,1,9,6,1,101,94,1),_RlStartupCDBChanged_Type())
...
rlManualReboot=_RlManualReboot_Object((1,3,6,1,4,1,9,6,1,101,94,2),_RlManualReboot_Type())
...
rlStartupCDBEmpty=_RlStartupCDBEmpty_Object((1,3,6,1,4,1,9,6,1,101,94,3),_RlStartupCDBEmpty_Type())
rlStartupCDBEmpty.setMaxAccess(_A)
if mibBuilder.loadTexts:rlStartupCDBEmpty.setStatus(_B)
mibBuilder.exportSymbols('CISCOSB-CDB-MIB',**{'rlCDB':rlCDB,'rlStartupCDBChanged':rlStartupCDBChanged,'rlManualReboot':rlManualReboot,'rlStartupCDBEmpty':rlStartupCDBEmpty})