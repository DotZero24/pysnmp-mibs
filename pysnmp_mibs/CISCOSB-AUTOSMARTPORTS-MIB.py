# SNMP MIB module (CISCOSB-AUTOSMARTPORTS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-AUTOSMARTPORTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:41:40 2025
...
rlAutoSmartportsMib = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 150)
)
if mibBuilder.loadTexts:
    rlAutoSmartportsMib.setRevisions(
        ("2010-09-11 00:00",)
    )
...
rlAutoSmartPortTypesEntry.setIndexNames(
    (0, "CISCOSB-AUTOSMARTPORTS-MIB", "rlAutoSmartPortTypesType"),
)
if mibBuilder.loadTexts:
...
rlAutoSmartPortMacrosParamEntry.setIndexNames(
    (0, "CISCOSB-AUTOSMARTPORTS-MIB", "rlAutoSmartPortTypesType"),
    (0, "CISCOSB-AUTOSMARTPORTS-MIB", "rlAutoSmartPortMacroType"),
    (1, "CISCOSB-AUTOSMARTPORTS-MIB", "rlAutoSmartPortMacrosParamName"),
)
if mibBuilder.loadTexts:
...
rlAutoSmartPortPortsEntry.setIndexNames(
    (0, "CISCOSB-AUTOSMARTPORTS-MIB", "rlAutoSmartPortPort"),
)
if mibBuilder.loadTexts:
...
rlAutoSmartPortParamsEntry.setIndexNames(
    (0, "CISCOSB-AUTOSMARTPORTS-MIB", "rlAutoSmartPortIfIndex"),
    (1, "CISCOSB-AUTOSMARTPORTS-MIB", "rlAutoSmartPortParamName"),
)
if mibBuilder.loadTexts:
...
rlAutoSmartTrunkRefreshEntry.setIndexNames(
    (0, "CISCOSB-AUTOSMARTPORTS-MIB", "rlAutoSmartTrunkRefreshSmartPortType"),
    (0, "CISCOSB-AUTOSMARTPORTS-MIB", "rlAutoSmartTrunkRefreshIfIndex"),
)
if mibBuilder.loadTexts:
