# SNMP MIB module (DNOS-MVR-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/DNOS-MVR-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:27 2025
...
fastpathMvr = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50)
)
...
mvrGlobalConfig = _MvrGlobalConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 1)
)
...
_MvrAdminMode_Type.__name__ = "TruthValue"
_MvrAdminMode_Object = MibScalar
mvrAdminMode = _MvrAdminMode_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 1, 1),
    _MvrAdminMode_Type()
)
...
mvrModeType = _MvrModeType_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 1, 2),
    _MvrModeType_Type()
)
...
_MvrMulticastVlanId_Type.__name__ = "VlanIndex"
_MvrMulticastVlanId_Object = MibScalar
mvrMulticastVlanId = _MvrMulticastVlanId_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 1, 3),
...
mvrMaxMulticastGroupsCount = _MvrMaxMulticastGroupsCount_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 1, 4),
...
mvrCurrentMulticastGroupsCount = _MvrCurrentMulticastGroupsCount_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 1, 5),
...
mvrQueryTime = _MvrQueryTime_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 1, 6),
    _MvrQueryTime_Type()
)
...
_MvrPortMvrEnabled_Type.__name__ = "TruthValue"
_MvrPortMvrEnabled_Object = MibTableColumn
mvrPortMvrEnabled = _MvrPortMvrEnabled_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 2, 1, 1),
...
mvrPortType = _MvrPortType_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 2, 1, 2),
    _MvrPortType_Type()
)
...
mvrPortStatus = _MvrPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 2, 1, 4),
    _MvrPortStatus_Type()
)
...
mvrGroupIPAddress = _MvrGroupIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 3, 1, 1),
...
mvrGroupStatus = _MvrGroupStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 3, 1, 2),
...
mvrGroupRowStatus = _MvrGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 3, 1, 3),
...
mvrPortMembershipTable = _MvrPortMembershipTable_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 4)
)
if mibBuilder.loadTexts:
...
mvrPortMembershipEntry = _MvrPortMembershipEntry_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 4, 1)
)
mvrPortMembershipEntry.setIndexNames(
    (0, "DNOS-MVR-PRIVATE-MIB", "mvrPortMembershipGroupIPAddress"),
    (0, "DNOS-MVR-PRIVATE-MIB", "mvrPortMembershipPortIfIndex"),
)
if mibBuilder.loadTexts:
...
mvrPortMembershipGroupIPAddress = _MvrPortMembershipGroupIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 4, 1, 1),
...
mvrPortMembershipPortIfIndex = _MvrPortMembershipPortIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 4, 1, 2),
...
mvrPortMembershipRowStatus = _MvrPortMembershipRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 4, 1, 3),
...
mvrStatistics = _MvrStatistics_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5)
)
...
mvrIGMPQueryReceived = _MvrIGMPQueryReceived_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 1),
...
mvrIGMPReportV1Received = _MvrIGMPReportV1Received_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 2),
...
mvrIGMPReportV2Received = _MvrIGMPReportV2Received_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 3),
...
mvrIGMPLeaveReceived = _MvrIGMPLeaveReceived_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 4),
...
mvrIGMPQueryTransmitted = _MvrIGMPQueryTransmitted_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 5),
...
mvrIGMPReportV1Transmitted = _MvrIGMPReportV1Transmitted_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 6),
...
mvrIGMPReportV2Transmitted = _MvrIGMPReportV2Transmitted_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 7),
...
mvrIGMPLeaveTransmitted = _MvrIGMPLeaveTransmitted_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 8),
...
mvrIGMPPacketReceiveFailures = _MvrIGMPPacketReceiveFailures_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 9),
...
mvrIGMPPacketTransmitFailures = _MvrIGMPPacketTransmitFailures_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 50, 5, 10),
