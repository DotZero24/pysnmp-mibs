...
swL2DevMgmt=_SwL2DevMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,1))
_SwL2DevInfo_ObjectIdentity=ObjectIdentity
swL2DevInfo=_SwL2DevInfo_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,1,1))
_SwDevInfoSystemUpTime_Type=TimeTicks
_SwDevInfoSystemUpTime_Object=MibScalar
swDevInfoSystemUpTime=_SwDevInfoSystemUpTime_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,1),_SwDevInfoSystemUpTime_Type())
...
swDevInfoTotalNumOfPort=_SwDevInfoTotalNumOfPort_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,2),_SwDevInfoTotalNumOfPort_Type())
...
swDevInfoNumOfPortInUse=_SwDevInfoNumOfPortInUse_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,3),_SwDevInfoNumOfPortInUse_Type())
...
swDevInfoConsoleInUse=_SwDevInfoConsoleInUse_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,4),_SwDevInfoConsoleInUse_Type())
...
swDevInfoModuleType=_SwDevInfoModuleType_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,5),_SwDevInfoModuleType_Type())
...
swDevInfoFrontPanelLedMode=_SwDevInfoFrontPanelLedMode_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,6),_SwDevInfoFrontPanelLedMode_Type())
...
swDevInfoPowerTable=_SwDevInfoPowerTable_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,8))
if mibBuilder.loadTexts:swDevInfoPowerTable.setStatus(_A)
_SwDevInfoPowerEntry_Object=MibTableRow
swDevInfoPowerEntry=_SwDevInfoPowerEntry_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,8,1))
...
swDevInfoPowerUnitIndex=_SwDevInfoPowerUnitIndex_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,8,1,1),_SwDevInfoPowerUnitIndex_Type())
...
swDevInfoPowerID=_SwDevInfoPowerID_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,8,1,2),_SwDevInfoPowerID_Type())
...
swDevInfoPowerStatus=_SwDevInfoPowerStatus_Object((1,3,6,1,4,1,171,11,69,2,2,1,1,8,1,3),_SwDevInfoPowerStatus_Type())
...
swL2DevCtrl=_SwL2DevCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,1,2))
...
swL2DevCtrlStpState=_SwL2DevCtrlStpState_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,1),_SwL2DevCtrlStpState_Type())
...
swL2DevCtrlIGMPSnooping=_SwL2DevCtrlIGMPSnooping_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,2),_SwL2DevCtrlIGMPSnooping_Type())
...
swL2DevCtrlRmonState=_SwL2DevCtrlRmonState_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,3),_SwL2DevCtrlRmonState_Type())
...
swL2DevCtrlCleanAllStatisticCounter=_SwL2DevCtrlCleanAllStatisticCounter_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,4),_SwL2DevCtrlCleanAllStatisticCounter_Type())
...
swL2DevCtrlVlanIdOfFDBTbl=_SwL2DevCtrlVlanIdOfFDBTbl_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,5),_SwL2DevCtrlVlanIdOfFDBTbl_Type())
...
swL2MACNotifyState=_SwL2MACNotifyState_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,6),_SwL2MACNotifyState_Type())
...
swL2MACNotifyHistorySize=_SwL2MACNotifyHistorySize_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,7),_SwL2MACNotifyHistorySize_Type())
...
swL2MACNotifyInterval=_SwL2MACNotifyInterval_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,8),_SwL2MACNotifyInterval_Type())
...
swL2DevCtrlTelnet=_SwL2DevCtrlTelnet_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,1,2,10))
...
swL2DevCtrlTelnetState=_SwL2DevCtrlTelnetState_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,10,1),_SwL2DevCtrlTelnetState_Type())
...
swL2DevCtrlTelnetTcpPort=_SwL2DevCtrlTelnetTcpPort_Object((1,3,6,1,4,1,171,11,69,2,2,1,2,10,2),_SwL2DevCtrlTelnetTcpPort_Type())
...
swL2DevAlarm=_SwL2DevAlarm_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,1,3))
...
swL2DevAlarmNewRoot=_SwL2DevAlarmNewRoot_Object((1,3,6,1,4,1,171,11,69,2,2,1,3,1),_SwL2DevAlarmNewRoot_Type())
...
swL2DevAlarmTopologyChange=_SwL2DevAlarmTopologyChange_Object((1,3,6,1,4,1,171,11,69,2,2,1,3,2),_SwL2DevAlarmTopologyChange_Type())
...
swL2DevAlarmLinkChange=_SwL2DevAlarmLinkChange_Object((1,3,6,1,4,1,171,11,69,2,2,1,3,3),_SwL2DevAlarmLinkChange_Type())
...
swL2VlanMgmt=_SwL2VlanMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,3))
_SwL2VlanAdvertisementTable_Object=MibTable
swL2VlanAdvertisementTable=_SwL2VlanAdvertisementTable_Object((1,3,6,1,4,1,171,11,69,2,2,3,1))
if mibBuilder.loadTexts:swL2VlanAdvertisementTable.setStatus(_A)
_SwL2VlanAdvertisementEntry_Object=MibTableRow
swL2VlanAdvertisementEntry=_SwL2VlanAdvertisementEntry_Object((1,3,6,1,4,1,171,11,69,2,2,3,1,1))
...
swL2VlanIndex=_SwL2VlanIndex_Object((1,3,6,1,4,1,171,11,69,2,2,3,1,1,1),_SwL2VlanIndex_Type())
...
swL2VlanName=_SwL2VlanName_Object((1,3,6,1,4,1,171,11,69,2,2,3,1,1,2),_SwL2VlanName_Type())
...
swL2VlanAdvertiseState=_SwL2VlanAdvertiseState_Object((1,3,6,1,4,1,171,11,69,2,2,3,1,1,3),_SwL2VlanAdvertiseState_Type())
...
swL2PortMgmt=_SwL2PortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,4))
_SwL2PortInfoTable_Object=MibTable
swL2PortInfoTable=_SwL2PortInfoTable_Object((1,3,6,1,4,1,171,11,69,2,2,4,1))
if mibBuilder.loadTexts:swL2PortInfoTable.setStatus(_I)
_SwL2PortInfoEntry_Object=MibTableRow
swL2PortInfoEntry=_SwL2PortInfoEntry_Object((1,3,6,1,4,1,171,11,69,2,2,4,1,1))
...
swL2PortInfoPortIndex=_SwL2PortInfoPortIndex_Object((1,3,6,1,4,1,171,11,69,2,2,4,1,1,1),_SwL2PortInfoPortIndex_Type())
...
swL2PortInfoUnitIndex=_SwL2PortInfoUnitIndex_Object((1,3,6,1,4,1,171,11,69,2,2,4,1,1,2),_SwL2PortInfoUnitIndex_Type())
...
swL2PortInfoType=_SwL2PortInfoType_Object((1,3,6,1,4,1,171,11,69,2,2,4,1,1,3),_SwL2PortInfoType_Type())
...
swL2PortInfoLinkStatus=_SwL2PortInfoLinkStatus_Object((1,3,6,1,4,1,171,11,69,2,2,4,1,1,4),_SwL2PortInfoLinkStatus_Type())
...
swL2PortInfoNwayStatus=_SwL2PortInfoNwayStatus_Object((1,3,6,1,4,1,171,11,69,2,2,4,1,1,5),_SwL2PortInfoNwayStatus_Type())
...
swL2PortInfoModuleType=_SwL2PortInfoModuleType_Object((1,3,6,1,4,1,171,11,69,2,2,4,1,1,6),_SwL2PortInfoModuleType_Type())
...
swL2PortInfoErrorDisabled=_SwL2PortInfoErrorDisabled_Object((1,3,6,1,4,1,171,11,69,2,2,4,1,1,7),_SwL2PortInfoErrorDisabled_Type())
...
swL2PortCtrlTable=_SwL2PortCtrlTable_Object((1,3,6,1,4,1,171,11,69,2,2,4,2))
if mibBuilder.loadTexts:swL2PortCtrlTable.setStatus(_I)
_SwL2PortCtrlEntry_Object=MibTableRow
swL2PortCtrlEntry=_SwL2PortCtrlEntry_Object((1,3,6,1,4,1,171,11,69,2,2,4,2,1))
...
swL2PortCtrlPortIndex=_SwL2PortCtrlPortIndex_Object((1,3,6,1,4,1,171,11,69,2,2,4,2,1,1),_SwL2PortCtrlPortIndex_Type())
...
swL2PortCtrlUnitIndex=_SwL2PortCtrlUnitIndex_Object((1,3,6,1,4,1,171,11,69,2,2,4,2,1,2),_SwL2PortCtrlUnitIndex_Type())
...
swL2PortCtrlAdminState=_SwL2PortCtrlAdminState_Object((1,3,6,1,4,1,171,11,69,2,2,4,2,1,3),_SwL2PortCtrlAdminState_Type())
...
swL2PortCtrlNwayState=_SwL2PortCtrlNwayState_Object((1,3,6,1,4,1,171,11,69,2,2,4,2,1,4),_SwL2PortCtrlNwayState_Type())
...
swL2PortCtrlFlowCtrlState=_SwL2PortCtrlFlowCtrlState_Object((1,3,6,1,4,1,171,11,69,2,2,4,2,1,5),_SwL2PortCtrlFlowCtrlState_Type())
...
swL2PortCtrlLockState=_SwL2PortCtrlLockState_Object((1,3,6,1,4,1,171,11,69,2,2,4,2,1,6),_SwL2PortCtrlLockState_Type())
...
swL2PortCtrlMACNotifyState=_SwL2PortCtrlMACNotifyState_Object((1,3,6,1,4,1,171,11,69,2,2,4,2,1,7),_SwL2PortCtrlMACNotifyState_Type())
...
swL2PortCtrlJumboFrame=_SwL2PortCtrlJumboFrame_Object((1,3,6,1,4,1,171,11,69,2,2,4,3),_SwL2PortCtrlJumboFrame_Type())
...
swL2PortInformationTable=_SwL2PortInformationTable_Object((1,3,6,1,4,1,171,11,69,2,2,4,4))
if mibBuilder.loadTexts:swL2PortInformationTable.setStatus(_A)
_SwL2PortInformationEntry_Object=MibTableRow
swL2PortInformationEntry=_SwL2PortInformationEntry_Object((1,3,6,1,4,1,171,11,69,2,2,4,4,1))
...
swL2PortInformationPortIndex=_SwL2PortInformationPortIndex_Object((1,3,6,1,4,1,171,11,69,2,2,4,4,1,1),_SwL2PortInformationPortIndex_Type())
...
swL2PortInformationMediumType=_SwL2PortInformationMediumType_Object((1,3,6,1,4,1,171,11,69,2,2,4,4,1,2),_SwL2PortInformationMediumType_Type())
...
swL2PortInformationUnitID=_SwL2PortInformationUnitID_Object((1,3,6,1,4,1,171,11,69,2,2,4,4,1,3),_SwL2PortInformationUnitID_Type())
...
swL2PortInformationType=_SwL2PortInformationType_Object((1,3,6,1,4,1,171,11,69,2,2,4,4,1,4),_SwL2PortInformationType_Type())
...
swL2PortInformationLinkStatus=_SwL2PortInformationLinkStatus_Object((1,3,6,1,4,1,171,11,69,2,2,4,4,1,5),_SwL2PortInformationLinkStatus_Type())
...
swL2PortInformationNwayStatus=_SwL2PortInformationNwayStatus_Object((1,3,6,1,4,1,171,11,69,2,2,4,4,1,6),_SwL2PortInformationNwayStatus_Type())
...
swL2PortInformationModuleType=_SwL2PortInformationModuleType_Object((1,3,6,1,4,1,171,11,69,2,2,4,4,1,7),_SwL2PortInformationModuleType_Type())
...
swL2PortInformationErrorDisabled=_SwL2PortInformationErrorDisabled_Object((1,3,6,1,4,1,171,11,69,2,2,4,4,1,8),_SwL2PortInformationErrorDisabled_Type())
...
swL2PortControlTable=_SwL2PortControlTable_Object((1,3,6,1,4,1,171,11,69,2,2,4,5))
if mibBuilder.loadTexts:swL2PortControlTable.setStatus(_A)
_SwL2PortControlEntry_Object=MibTableRow
swL2PortControlEntry=_SwL2PortControlEntry_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1))
...
swL2PortControlPortIndex=_SwL2PortControlPortIndex_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1,1),_SwL2PortControlPortIndex_Type())
...
swL2PortControlMediumType=_SwL2PortControlMediumType_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1,2),_SwL2PortControlMediumType_Type())
...
swL2PortControlUnitIndex=_SwL2PortControlUnitIndex_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1,3),_SwL2PortControlUnitIndex_Type())
...
swL2PortControlAdminState=_SwL2PortControlAdminState_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1,4),_SwL2PortControlAdminState_Type())
...
swL2PortControlNwayState=_SwL2PortControlNwayState_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1,5),_SwL2PortControlNwayState_Type())
...
swL2PortControlFlowCtrlState=_SwL2PortControlFlowCtrlState_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1,6),_SwL2PortControlFlowCtrlState_Type())
...
swL2PortControlLearningState=_SwL2PortControlLearningState_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1,7),_SwL2PortControlLearningState_Type())
...
swL2PortControlMACNotifyState=_SwL2PortControlMACNotifyState_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1,8),_SwL2PortControlMACNotifyState_Type())
...
swL2PortControlMulticastfilter=_SwL2PortControlMulticastfilter_Object((1,3,6,1,4,1,171,11,69,2,2,4,5,1,9),_SwL2PortControlMulticastfilter_Type())
...
swL2QOSMgmt=_SwL2QOSMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,6))
_SwL2QOSBandwidthControlTable_Object=MibTable
swL2QOSBandwidthControlTable=_SwL2QOSBandwidthControlTable_Object((1,3,6,1,4,1,171,11,69,2,2,6,1))
if mibBuilder.loadTexts:swL2QOSBandwidthControlTable.setStatus(_A)
_SwL2QOSBandwidthControlEntry_Object=MibTableRow
swL2QOSBandwidthControlEntry=_SwL2QOSBandwidthControlEntry_Object((1,3,6,1,4,1,171,11,69,2,2,6,1,1))
...
swL2QOSBandwidthPortIndex=_SwL2QOSBandwidthPortIndex_Object((1,3,6,1,4,1,171,11,69,2,2,6,1,1,1),_SwL2QOSBandwidthPortIndex_Type())
...
swL2QOSBandwidthRxRate=_SwL2QOSBandwidthRxRate_Object((1,3,6,1,4,1,171,11,69,2,2,6,1,1,2),_SwL2QOSBandwidthRxRate_Type())
...
swL2QOSBandwidthTxRate=_SwL2QOSBandwidthTxRate_Object((1,3,6,1,4,1,171,11,69,2,2,6,1,1,3),_SwL2QOSBandwidthTxRate_Type())
...
swL2QOSBandwidthRadiusRxRate=_SwL2QOSBandwidthRadiusRxRate_Object((1,3,6,1,4,1,171,11,69,2,2,6,1,1,4),_SwL2QOSBandwidthRadiusRxRate_Type())
...
swL2QOSBandwidthRadiusTxRate=_SwL2QOSBandwidthRadiusTxRate_Object((1,3,6,1,4,1,171,11,69,2,2,6,1,1,5),_SwL2QOSBandwidthRadiusTxRate_Type())
...
swL2QOSSchedulingTable=_SwL2QOSSchedulingTable_Object((1,3,6,1,4,1,171,11,69,2,2,6,2))
if mibBuilder.loadTexts:swL2QOSSchedulingTable.setStatus(_A)
_SwL2QOSSchedulingEntry_Object=MibTableRow
swL2QOSSchedulingEntry=_SwL2QOSSchedulingEntry_Object((1,3,6,1,4,1,171,11,69,2,2,6,2,1))
...
swL2QOSSchedulingClassIndex=_SwL2QOSSchedulingClassIndex_Object((1,3,6,1,4,1,171,11,69,2,2,6,2,1,1),_SwL2QOSSchedulingClassIndex_Type())
...
swL2QOSSchedulingMaxPkts=_SwL2QOSSchedulingMaxPkts_Object((1,3,6,1,4,1,171,11,69,2,2,6,2,1,2),_SwL2QOSSchedulingMaxPkts_Type())
...
swL2QOS8021pUserPriorityTable=_SwL2QOS8021pUserPriorityTable_Object((1,3,6,1,4,1,171,11,69,2,2,6,3))
if mibBuilder.loadTexts:swL2QOS8021pUserPriorityTable.setStatus(_A)
_SwL2QOS8021pUserPriorityEntry_Object=MibTableRow
swL2QOS8021pUserPriorityEntry=_SwL2QOS8021pUserPriorityEntry_Object((1,3,6,1,4,1,171,11,69,2,2,6,3,1))
...
swL2QOS8021pUserPriorityIndex=_SwL2QOS8021pUserPriorityIndex_Object((1,3,6,1,4,1,171,11,69,2,2,6,3,1,1),_SwL2QOS8021pUserPriorityIndex_Type())
...
swL2QOS8021pUserPriorityClass=_SwL2QOS8021pUserPriorityClass_Object((1,3,6,1,4,1,171,11,69,2,2,6,3,1,2),_SwL2QOS8021pUserPriorityClass_Type())
...
swL2QOS8021pDefaultPriorityTable=_SwL2QOS8021pDefaultPriorityTable_Object((1,3,6,1,4,1,171,11,69,2,2,6,4))
...
swL2QOS8021pDefaultPriorityEntry=_SwL2QOS8021pDefaultPriorityEntry_Object((1,3,6,1,4,1,171,11,69,2,2,6,4,1))
...
swL2QOS8021pDefaultPriorityIndex=_SwL2QOS8021pDefaultPriorityIndex_Object((1,3,6,1,4,1,171,11,69,2,2,6,4,1,1),_SwL2QOS8021pDefaultPriorityIndex_Type())
...
swL2QOS8021pDefaultPriority=_SwL2QOS8021pDefaultPriority_Object((1,3,6,1,4,1,171,11,69,2,2,6,4,1,2),_SwL2QOS8021pDefaultPriority_Type())
...
swL2QOS8021pRadiusPriority=_SwL2QOS8021pRadiusPriority_Object((1,3,6,1,4,1,171,11,69,2,2,6,4,1,3),_SwL2QOS8021pRadiusPriority_Type())
...
swL2TrunkMgmt=_SwL2TrunkMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,8))
...
swL2TrunkMaxSupportedEntries=_SwL2TrunkMaxSupportedEntries_Object((1,3,6,1,4,1,171,11,69,2,2,8,1),_SwL2TrunkMaxSupportedEntries_Type())
...
swL2TrunkCurrentNumEntries=_SwL2TrunkCurrentNumEntries_Object((1,3,6,1,4,1,171,11,69,2,2,8,2),_SwL2TrunkCurrentNumEntries_Type())
...
swL2TrunkCtrlTable=_SwL2TrunkCtrlTable_Object((1,3,6,1,4,1,171,11,69,2,2,8,3))
if mibBuilder.loadTexts:swL2TrunkCtrlTable.setStatus(_A)
_SwL2TrunkCtrlEntry_Object=MibTableRow
swL2TrunkCtrlEntry=_SwL2TrunkCtrlEntry_Object((1,3,6,1,4,1,171,11,69,2,2,8,3,1))
...
swL2TrunkIndex=_SwL2TrunkIndex_Object((1,3,6,1,4,1,171,11,69,2,2,8,3,1,1),_SwL2TrunkIndex_Type())
...
swL2TrunkName=_SwL2TrunkName_Object((1,3,6,1,4,1,171,11,69,2,2,8,3,1,2),_SwL2TrunkName_Type())
...
swL2TrunkMasterPort=_SwL2TrunkMasterPort_Object((1,3,6,1,4,1,171,11,69,2,2,8,3,1,3),_SwL2TrunkMasterPort_Type())
...
swL2TrunkMember=_SwL2TrunkMember_Object((1,3,6,1,4,1,171,11,69,2,2,8,3,1,4),_SwL2TrunkMember_Type())
...
swL2TrunkFloodingPort=_SwL2TrunkFloodingPort_Object((1,3,6,1,4,1,171,11,69,2,2,8,3,1,5),_SwL2TrunkFloodingPort_Type())
...
swL2TrunkType=_SwL2TrunkType_Object((1,3,6,1,4,1,171,11,69,2,2,8,3,1,6),_SwL2TrunkType_Type())
...
swL2TrunkState=_SwL2TrunkState_Object((1,3,6,1,4,1,171,11,69,2,2,8,3,1,7),_SwL2TrunkState_Type())
...
swL2TrunkAlgorithm=_SwL2TrunkAlgorithm_Object((1,3,6,1,4,1,171,11,69,2,2,8,4),_SwL2TrunkAlgorithm_Type())
...
swL2MirrorMgmt=_SwL2MirrorMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,9))
...
swL2MirrorLogicTargetPort=_SwL2MirrorLogicTargetPort_Object((1,3,6,1,4,1,171,11,69,2,2,9,1),_SwL2MirrorLogicTargetPort_Type())
...
swL2MirrorPortSourceIngress=_SwL2MirrorPortSourceIngress_Object((1,3,6,1,4,1,171,11,69,2,2,9,2),_SwL2MirrorPortSourceIngress_Type())
...
swL2MirrorPortSourceEgress=_SwL2MirrorPortSourceEgress_Object((1,3,6,1,4,1,171,11,69,2,2,9,3),_SwL2MirrorPortSourceEgress_Type())
...
swL2MirrorPortState=_SwL2MirrorPortState_Object((1,3,6,1,4,1,171,11,69,2,2,9,4),_SwL2MirrorPortState_Type())
...
swL2IGMPMgmt=_SwL2IGMPMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,10))
...
swL2IGMPMaxSupportedVlans=_SwL2IGMPMaxSupportedVlans_Object((1,3,6,1,4,1,171,11,69,2,2,10,1),_SwL2IGMPMaxSupportedVlans_Type())
...
swL2IGMPCtrlTable=_SwL2IGMPCtrlTable_Object((1,3,6,1,4,1,171,11,69,2,2,10,3))
if mibBuilder.loadTexts:swL2IGMPCtrlTable.setStatus(_A)
_SwL2IGMPCtrlEntry_Object=MibTableRow
swL2IGMPCtrlEntry=_SwL2IGMPCtrlEntry_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1))
...
swL2IGMPCtrlVid=_SwL2IGMPCtrlVid_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,1),_SwL2IGMPCtrlVid_Type())
...
swL2IGMPQueryInterval=_SwL2IGMPQueryInterval_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,2),_SwL2IGMPQueryInterval_Type())
...
swL2IGMPMaxResponseTime=_SwL2IGMPMaxResponseTime_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,3),_SwL2IGMPMaxResponseTime_Type())
...
swL2IGMPRobustness=_SwL2IGMPRobustness_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,4),_SwL2IGMPRobustness_Type())
...
swL2IGMPLastMemberQueryInterval=_SwL2IGMPLastMemberQueryInterval_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,5),_SwL2IGMPLastMemberQueryInterval_Type())
...
swL2IGMPHostTimeout=_SwL2IGMPHostTimeout_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,6),_SwL2IGMPHostTimeout_Type())
...
swL2IGMPRouteTimeout=_SwL2IGMPRouteTimeout_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,7),_SwL2IGMPRouteTimeout_Type())
...
swL2IGMPLeaveTimer=_SwL2IGMPLeaveTimer_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,8),_SwL2IGMPLeaveTimer_Type())
...
swL2IGMPQueryState=_SwL2IGMPQueryState_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,9),_SwL2IGMPQueryState_Type())
...
swL2IGMPCurrentState=_SwL2IGMPCurrentState_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,10),_SwL2IGMPCurrentState_Type())
...
swL2IGMPCtrlState=_SwL2IGMPCtrlState_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,11),_SwL2IGMPCtrlState_Type())
...
swL2IGMPFastLeaveState=_SwL2IGMPFastLeaveState_Object((1,3,6,1,4,1,171,11,69,2,2,10,3,1,12),_SwL2IGMPFastLeaveState_Type())
...
swL2IGMPQueryInfoTable=_SwL2IGMPQueryInfoTable_Object((1,3,6,1,4,1,171,11,69,2,2,10,4))
if mibBuilder.loadTexts:swL2IGMPQueryInfoTable.setStatus(_A)
_SwL2IGMPQueryInfoEntry_Object=MibTableRow
swL2IGMPQueryInfoEntry=_SwL2IGMPQueryInfoEntry_Object((1,3,6,1,4,1,171,11,69,2,2,10,4,1))
...
swL2IGMPInfoVid=_SwL2IGMPInfoVid_Object((1,3,6,1,4,1,171,11,69,2,2,10,4,1,1),_SwL2IGMPInfoVid_Type())
...
swL2IGMPInfoQueryCount=_SwL2IGMPInfoQueryCount_Object((1,3,6,1,4,1,171,11,69,2,2,10,4,1,2),_SwL2IGMPInfoQueryCount_Type())
...
swL2IGMPInfoTxQueryCount=_SwL2IGMPInfoTxQueryCount_Object((1,3,6,1,4,1,171,11,69,2,2,10,4,1,3),_SwL2IGMPInfoTxQueryCount_Type())
...
swL2IGMPInfoTable=_SwL2IGMPInfoTable_Object((1,3,6,1,4,1,171,11,69,2,2,10,5))
if mibBuilder.loadTexts:swL2IGMPInfoTable.setStatus(_A)
_SwL2IGMPInfoEntry_Object=MibTableRow
swL2IGMPInfoEntry=_SwL2IGMPInfoEntry_Object((1,3,6,1,4,1,171,11,69,2,2,10,5,1))
...
swL2IGMPVid=_SwL2IGMPVid_Object((1,3,6,1,4,1,171,11,69,2,2,10,5,1,1),_SwL2IGMPVid_Type())
...
swL2IGMPGroupIpAddr=_SwL2IGMPGroupIpAddr_Object((1,3,6,1,4,1,171,11,69,2,2,10,5,1,2),_SwL2IGMPGroupIpAddr_Type())
...
swL2IGMPMacAddr=_SwL2IGMPMacAddr_Object((1,3,6,1,4,1,171,11,69,2,2,10,5,1,3),_SwL2IGMPMacAddr_Type())
...
swL2IGMPPortMap=_SwL2IGMPPortMap_Object((1,3,6,1,4,1,171,11,69,2,2,10,5,1,4),_SwL2IGMPPortMap_Type())
...
swL2IGMPIpGroupReportCount=_SwL2IGMPIpGroupReportCount_Object((1,3,6,1,4,1,171,11,69,2,2,10,5,1,5),_SwL2IGMPIpGroupReportCount_Type())
...
swL2IGMPMulticastVlanTable=_SwL2IGMPMulticastVlanTable_Object((1,3,6,1,4,1,171,11,69,2,2,10,6))
if mibBuilder.loadTexts:swL2IGMPMulticastVlanTable.setStatus(_A)
_SwL2IGMPMulticastVlanEntry_Object=MibTableRow
swL2IGMPMulticastVlanEntry=_SwL2IGMPMulticastVlanEntry_Object((1,3,6,1,4,1,171,11,69,2,2,10,6,1))
...
swL2IGMPMulticastVlanid=_SwL2IGMPMulticastVlanid_Object((1,3,6,1,4,1,171,11,69,2,2,10,6,1,1),_SwL2IGMPMulticastVlanid_Type())
...
swL2IGMPMulticastVlanName=_SwL2IGMPMulticastVlanName_Object((1,3,6,1,4,1,171,11,69,2,2,10,6,1,2),_SwL2IGMPMulticastVlanName_Type())
...
swL2IGMPMulticastVlanSourcePort=_SwL2IGMPMulticastVlanSourcePort_Object((1,3,6,1,4,1,171,11,69,2,2,10,6,1,3),_SwL2IGMPMulticastVlanSourcePort_Type())
...
swL2IGMPMulticastVlanMemberPort=_SwL2IGMPMulticastVlanMemberPort_Object((1,3,6,1,4,1,171,11,69,2,2,10,6,1,4),_SwL2IGMPMulticastVlanMemberPort_Type())
...
swL2IGMPMulticastVlanRowStatus=_SwL2IGMPMulticastVlanRowStatus_Object((1,3,6,1,4,1,171,11,69,2,2,10,6,1,5),_SwL2IGMPMulticastVlanRowStatus_Type())
...
swL2IGMPRouterPortTable=_SwL2IGMPRouterPortTable_Object((1,3,6,1,4,1,171,11,69,2,2,10,7))
if mibBuilder.loadTexts:swL2IGMPRouterPortTable.setStatus(_A)
_SwL2IGMPRouterPortEntry_Object=MibTableRow
swL2IGMPRouterPortEntry=_SwL2IGMPRouterPortEntry_Object((1,3,6,1,4,1,171,11,69,2,2,10,7,1))
...
swL2IGMPRouterPortVlanid=_SwL2IGMPRouterPortVlanid_Object((1,3,6,1,4,1,171,11,69,2,2,10,7,1,1),_SwL2IGMPRouterPortVlanid_Type())
...
swL2IGMPRouterPortVlanName=_SwL2IGMPRouterPortVlanName_Object((1,3,6,1,4,1,171,11,69,2,2,10,7,1,2),_SwL2IGMPRouterPortVlanName_Type())
...
swL2IGMPRouterPortStaticPortList=_SwL2IGMPRouterPortStaticPortList_Object((1,3,6,1,4,1,171,11,69,2,2,10,7,1,3),_SwL2IGMPRouterPortStaticPortList_Type())
...
swL2IGMPRouterPortDynamicPortList=_SwL2IGMPRouterPortDynamicPortList_Object((1,3,6,1,4,1,171,11,69,2,2,10,7,1,4),_SwL2IGMPRouterPortDynamicPortList_Type())
...
swL2IGMPRouterPortForbiddenPortList=_SwL2IGMPRouterPortForbiddenPortList_Object((1,3,6,1,4,1,171,11,69,2,2,10,7,1,5),_SwL2IGMPRouterPortForbiddenPortList_Type())
...
swL2TrafficSegMgmt=_SwL2TrafficSegMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,13))
_SwL2TrafficSegTable_Object=MibTable
swL2TrafficSegTable=_SwL2TrafficSegTable_Object((1,3,6,1,4,1,171,11,69,2,2,13,1))
if mibBuilder.loadTexts:swL2TrafficSegTable.setStatus(_A)
_SwL2TrafficSegEntry_Object=MibTableRow
swL2TrafficSegEntry=_SwL2TrafficSegEntry_Object((1,3,6,1,4,1,171,11,69,2,2,13,1,1))
...
swL2TrafficSegPort=_SwL2TrafficSegPort_Object((1,3,6,1,4,1,171,11,69,2,2,13,1,1,1),_SwL2TrafficSegPort_Type())
...
swL2TrafficSegForwardPorts=_SwL2TrafficSegForwardPorts_Object((1,3,6,1,4,1,171,11,69,2,2,13,1,1,2),_SwL2TrafficSegForwardPorts_Type())
...
swL2BroadcastSegCtrl=_SwL2BroadcastSegCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,13,2))
_SwL2BroadcastSegFilterPorts_Type=PortList
_SwL2BroadcastSegFilterPorts_Object=MibScalar
swL2BroadcastSegFilterPorts=_SwL2BroadcastSegFilterPorts_Object((1,3,6,1,4,1,171,11,69,2,2,13,2,1),_SwL2BroadcastSegFilterPorts_Type())
...
swL2BroadcastSegARPForwardPorts=_SwL2BroadcastSegARPForwardPorts_Object((1,3,6,1,4,1,171,11,69,2,2,13,2,2),_SwL2BroadcastSegARPForwardPorts_Type())
...
swL2PortSecurityMgmt=_SwL2PortSecurityMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,14))
_SwL2PortSecurityControlTable_Object=MibTable
swL2PortSecurityControlTable=_SwL2PortSecurityControlTable_Object((1,3,6,1,4,1,171,11,69,2,2,14,1))
if mibBuilder.loadTexts:swL2PortSecurityControlTable.setStatus(_A)
_SwL2PortSecurityControlEntry_Object=MibTableRow
swL2PortSecurityControlEntry=_SwL2PortSecurityControlEntry_Object((1,3,6,1,4,1,171,11,69,2,2,14,1,1))
...
swL2PortSecurityPortIndex=_SwL2PortSecurityPortIndex_Object((1,3,6,1,4,1,171,11,69,2,2,14,1,1,1),_SwL2PortSecurityPortIndex_Type())
...
swL2PortSecurityMaxLernAddr=_SwL2PortSecurityMaxLernAddr_Object((1,3,6,1,4,1,171,11,69,2,2,14,1,1,2),_SwL2PortSecurityMaxLernAddr_Type())
...
swL2PortSecurityMode=_SwL2PortSecurityMode_Object((1,3,6,1,4,1,171,11,69,2,2,14,1,1,3),_SwL2PortSecurityMode_Type())
...
swL2PortSecurityAdmState=_SwL2PortSecurityAdmState_Object((1,3,6,1,4,1,171,11,69,2,2,14,1,1,4),_SwL2PortSecurityAdmState_Type())
...
swL2PortSecurityTrapLogState=_SwL2PortSecurityTrapLogState_Object((1,3,6,1,4,1,171,11,69,2,2,14,2),_SwL2PortSecurityTrapLogState_Type())
...
swL2MgmtMIBTraps=_SwL2MgmtMIBTraps_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,15))
_SwL2MgmtMIBTrapPrefix_ObjectIdentity=ObjectIdentity
swL2MgmtMIBTrapPrefix=_SwL2MgmtMIBTrapPrefix_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,15,0))
_Swl2NotificationBidings_ObjectIdentity=ObjectIdentity
swl2NotificationBidings=_Swl2NotificationBidings_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,15,1))
...
swL2macNotifyInfo=_SwL2macNotifyInfo_Object((1,3,6,1,4,1,171,11,69,2,2,15,1,1),_SwL2macNotifyInfo_Type())
...
swl2NotifyPortSecurity=_Swl2NotifyPortSecurity_ObjectIdentity((1,3,6,1,4,1,171,11,69,2,2,15,2))
_SwL2PortSecurityViolationMac_Type=MacAddress
_SwL2PortSecurityViolationMac_Object=MibScalar
swL2PortSecurityViolationMac=_SwL2PortSecurityViolationMac_Object((1,3,6,1,4,1,171,11,69,2,2,15,2,1),_SwL2PortSecurityViolationMac_Type())
