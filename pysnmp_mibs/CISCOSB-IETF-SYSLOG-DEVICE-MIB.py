# SNMP MIB module (CISCOSB-IETF-SYSLOG-DEVICE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-IETF-SYSLOG-DEVICE-MIB
...
snmpSyslogCollectorEntry.setIndexNames(
    (0, "CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorIndex"),
)
if mibBuilder.loadTexts:
...
snmpSyslogApplicationEntry.setIndexNames(
    (0, "CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogApplicationIndex"),
)
if mibBuilder.loadTexts:
...
snmpSyslogDeviceGroup.setObjects(
      *(("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogDeviceMessages"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogDeviceMessagesDropped"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogDeviceLastMessageTime"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogDeviceControl"))
)
if mibBuilder.loadTexts:
...
snmpSyslogCollectorGroup.setObjects(
      *(("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorMaxEntries"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorNumEntries"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorTableNextAvailableIndex"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorDescription"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorAddressType"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorAddress"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorUdpPort"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorFacility"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorSeverity"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorMessagesIgnored"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorRowStatus"))
)
if mibBuilder.loadTexts:
...
snmpSyslogApplicationGroup.setObjects(
      *(("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogApplicationDescription"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogApplicationMnemonic"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogApplicationSeverity"))
)
if mibBuilder.loadTexts:
...
snmpSyslogCollectorDefaultsGroup.setObjects(
      *(("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorDefaultUdpPort"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorDefaultFacility"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorDefaultSeverity"))
)
if mibBuilder.loadTexts:
...
snmpSyslogDeviceCompliance.setObjects(
      *(("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogDeviceGroup"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorGroup"),
        ("CISCOSB-IETF-SYSLOG-DEVICE-MIB", "snmpSyslogCollectorDefaultsGroup"),
