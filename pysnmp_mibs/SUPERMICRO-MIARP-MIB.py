...
fsMIArpTable=_FsMIArpTable_Object((1,3,6,1,4,1,10876,101,2,33,1))
if mibBuilder.loadTexts:fsMIArpTable.setStatus(_A)
_FsMIArpEntry_Object=MibTableRow
fsMIArpEntry=_FsMIArpEntry_Object((1,3,6,1,4,1,10876,101,2,33,1,1))
...
fsMIArpCacheTimeout=_FsMIArpCacheTimeout_Object((1,3,6,1,4,1,10876,101,2,33,1,1,1),_FsMIArpCacheTimeout_Type())
...
fsMIArpCachePendTime=_FsMIArpCachePendTime_Object((1,3,6,1,4,1,10876,101,2,33,1,1,2),_FsMIArpCachePendTime_Type())
...
fsMIArpMaxRetries=_FsMIArpMaxRetries_Object((1,3,6,1,4,1,10876,101,2,33,1,1,3),_FsMIArpMaxRetries_Type())
...
fsMIArpPendingEntryCount=_FsMIArpPendingEntryCount_Object((1,3,6,1,4,1,10876,101,2,33,1,1,4),_FsMIArpPendingEntryCount_Type())
