...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VISM-CODEC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:29:21 2025
...
ciscoVismCodecCompliance.setObjects(
      *(("CISCO-VISM-CODEC-MIB", "ciscoVismCodecCnfGroup"),
        ("CISCO-VISM-CODEC-MIB", "ciscoVismCodecTemplateGrp"))
)
if mibBuilder.loadTexts:
...
ciscoVismCodecComplianceRev1.setObjects(
      *(("CISCO-VISM-CODEC-MIB", "ciscoVismCodecCnfGroup"),
        ("CISCO-VISM-CODEC-MIB", "ciscoVismCodecTemplateGrp"),
        ("CISCO-VISM-CODEC-MIB", "ciscoAltVismCodecCnfGroup"))
)
if mibBuilder.loadTexts:
