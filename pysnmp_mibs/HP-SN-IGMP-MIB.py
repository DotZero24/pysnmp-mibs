...
snIgmpMIBObjects=_SnIgmpMIBObjects_ObjectIdentity((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1))
class _SnIgmpQueryInterval_Type(Integer32):defaultValue=60;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,3600))
_SnIgmpQueryInterval_Type.__name__=_C
_SnIgmpQueryInterval_Object=MibScalar
snIgmpQueryInterval=_SnIgmpQueryInterval_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,1),_SnIgmpQueryInterval_Type())
snIgmpQueryInterval.setMaxAccess(_D)
if mibBuilder.loadTexts:snIgmpQueryInterval.setStatus(_A)
class _SnIgmpGroupMembershipTime_Type(Integer32):defaultValue=140;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,7200))
_SnIgmpGroupMembershipTime_Type.__name__=_C
_SnIgmpGroupMembershipTime_Object=MibScalar
snIgmpGroupMembershipTime=_SnIgmpGroupMembershipTime_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,2),_SnIgmpGroupMembershipTime_Type())
...
snIgmpIfTable=_SnIgmpIfTable_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,3))
if mibBuilder.loadTexts:snIgmpIfTable.setStatus(_A)
_SnIgmpIfEntry_Object=MibTableRow
snIgmpIfEntry=_SnIgmpIfEntry_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,3,1))
...
snIgmpIfEntryIndex=_SnIgmpIfEntryIndex_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,3,1,1),_SnIgmpIfEntryIndex_Type())
...
snIgmpIfPortNumber=_SnIgmpIfPortNumber_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,3,1,2),_SnIgmpIfPortNumber_Type())
...
snIgmpIfGroupAddress=_SnIgmpIfGroupAddress_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,3,1,3),_SnIgmpIfGroupAddress_Type())
...
snIgmpIfGroupAge=_SnIgmpIfGroupAge_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,3,1,4),_SnIgmpIfGroupAge_Type())
...
snIgmpStaticGroupTable=_SnIgmpStaticGroupTable_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,4))
if mibBuilder.loadTexts:snIgmpStaticGroupTable.setStatus(_A)
_SnIgmpStaticGroupEntry_Object=MibTableRow
snIgmpStaticGroupEntry=_SnIgmpStaticGroupEntry_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,4,1))
...
snIgmpStaticGroupIfIndex=_SnIgmpStaticGroupIfIndex_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,4,1,1),_SnIgmpStaticGroupIfIndex_Type())
...
snIgmpStaticGroupAddress=_SnIgmpStaticGroupAddress_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,4,1,2),_SnIgmpStaticGroupAddress_Type())
...
snIgmpStaticGroupPortList=_SnIgmpStaticGroupPortList_Object((1,3,6,1,4,1,11,2,3,7,11,12,2,6,1,4,1,3),_SnIgmpStaticGroupPortList_Type())
