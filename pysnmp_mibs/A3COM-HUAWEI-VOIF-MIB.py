...
h3cVoIfObjects=_H3cVoIfObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,2,1))
_H3cVoIfConfigTable_Object=MibTable
h3cVoIfConfigTable=_H3cVoIfConfigTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1))
if mibBuilder.loadTexts:h3cVoIfConfigTable.setStatus(_A)
_H3cVoIfConfigEntry_Object=MibTableRow
h3cVoIfConfigEntry=_H3cVoIfConfigEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1))
...
h3cVoIfCfgPortNumber=_H3cVoIfCfgPortNumber_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,1),_H3cVoIfCfgPortNumber_Type())
...
h3cVoIfCfgGroupNumber=_H3cVoIfCfgGroupNumber_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,2),_H3cVoIfCfgGroupNumber_Type())
...
h3cVoIfCfgCngOn=_H3cVoIfCfgCngOn_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,3),_H3cVoIfCfgCngOn_Type())
...
h3cVoIfConfigInputGain=_H3cVoIfConfigInputGain_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,4),_H3cVoIfConfigInputGain_Type())
...
h3cVoIfConfigOutputGain=_H3cVoIfConfigOutputGain_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,5),_H3cVoIfConfigOutputGain_Type())
...
h3cVoIfCfgEchoCancelSwitch=_H3cVoIfCfgEchoCancelSwitch_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,6),_H3cVoIfCfgEchoCancelSwitch_Type())
...
h3cVoIfCfgEchoCancellDelay=_H3cVoIfCfgEchoCancellDelay_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,7),_H3cVoIfCfgEchoCancellDelay_Type())
...
h3cVoIfCfgPlarNumber=_H3cVoIfCfgPlarNumber_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,8),_H3cVoIfCfgPlarNumber_Type())
...
h3cVoIfCfgDescription=_H3cVoIfCfgDescription_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,9),_H3cVoIfCfgDescription_Type())
...
h3cVoIfCfgStatus=_H3cVoIfCfgStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,10),_H3cVoIfCfgStatus_Type())
...
h3cVoIfCfgCallingNumSubstRule=_H3cVoIfCfgCallingNumSubstRule_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,11),_H3cVoIfCfgCallingNumSubstRule_Type())
...
h3cVoIfCfgCalledNumSubstRule=_H3cVoIfCfgCalledNumSubstRule_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,12),_H3cVoIfCfgCalledNumSubstRule_Type())
...
h3cVoIfCfgSubLine=_H3cVoIfCfgSubLine_Object((1,3,6,1,4,1,43,45,1,10,2,39,2,1,1,1,13),_H3cVoIfCfgSubLine_Type())
