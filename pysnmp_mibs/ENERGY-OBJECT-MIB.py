...
# Notes
# -----
# ASN.1 source file://mibs/rfc/ENERGY-OBJECT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:24:56 2025
...
_EoPowerEnableStatusNotification_Type.__name__ = "TruthValue"
...
class _EoPowerStateEnterReason_Type(OwnerString):
    """Custom type eoPowerStateEnterReason based on OwnerString"""
    defaultValue = OctetString("")


_EoPowerStateEnterReason_Type.__name__ = "OwnerString"
...
_EoEnergyParametersIntervalLength_Type.__name__ = "TimeInterval"
...
_EoEnergyParametersIntervalNumber_Type.__name__ = "Unsigned32"
...
_EoEnergyParametersSampleRate_Type.__name__ = "Unsigned32"
...
_EoEnergyParametersStorageType_Type.__name__ = "StorageType"
...
energyObjectMibFullCompliance.setObjects(
      *(("ENERGY-OBJECT-MIB", "energyObjectMibTableGroup"),
        ("ENERGY-OBJECT-MIB", "energyObjectMibStateTableGroup"),
        ("ENERGY-OBJECT-MIB", "eoPowerEnableStatusNotificationGroup"),
        ("ENERGY-OBJECT-MIB", "energyObjectMibNotifGroup"),
        ("ENERGY-OBJECT-MIB", "energyObjectMibEnergyTableGroup"),
        ("ENERGY-OBJECT-MIB", "energyObjectMibEnergyParametersTableGroup"),
        ("ENERGY-OBJECT-MIB", "energyObjectMibMeterCapabilitiesTableGroup"))
)
if mibBuilder.loadTexts:
...
energyObjectMibReadOnlyCompliance.setObjects(
      *(("ENERGY-OBJECT-MIB", "energyObjectMibTableGroup"),
        ("ENERGY-OBJECT-MIB", "energyObjectMibStateTableGroup"),
        ("ENERGY-OBJECT-MIB", "energyObjectMibNotifGroup"))
)
