...
h3cGreObjects=_H3cGreObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,54,1))
_H3cGreTable_Object=MibTable
h3cGreTable=_H3cGreTable_Object((1,3,6,1,4,1,43,45,1,10,2,54,1,1))
if mibBuilder.loadTexts:h3cGreTable.setStatus(_A)
_H3cGreEntry_Object=MibTableRow
h3cGreEntry=_H3cGreEntry_Object((1,3,6,1,4,1,43,45,1,10,2,54,1,1,1))
...
h3cGreKeyValue=_H3cGreKeyValue_Object((1,3,6,1,4,1,43,45,1,10,2,54,1,1,1,1),_H3cGreKeyValue_Type())
...
h3cGreKey=_H3cGreKey_Object((1,3,6,1,4,1,43,45,1,10,2,54,1,1,1,2),_H3cGreKey_Type())
...
h3cGreChecksum=_H3cGreChecksum_Object((1,3,6,1,4,1,43,45,1,10,2,54,1,1,1,3),_H3cGreChecksum_Type())
h3cGreChecksum.setMaxAccess(_C)
if mibBuilder.loadTexts:h3cGreChecksum.setStatus(_A)
mibBuilder.exportSymbols('A3COM-HUAWEI-GRE-MIB',**{'h3cGre':h3cGre,'h3cGreObjects':h3cGreObjects,'h3cGreTable':h3cGreTable,'h3cGreEntry':h3cGreEntry,'h3cGreKeyValue':h3cGreKeyValue,'h3cGreKey':h3cGreKey,'h3cGreChecksum':h3cGreChecksum})