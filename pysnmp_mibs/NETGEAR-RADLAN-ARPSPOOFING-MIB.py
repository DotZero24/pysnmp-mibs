# SNMP MIB module (NETGEAR-RADLAN-ARPSPOOFING-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-ARPSPOOFING-MIB
...
rlArpSpoofingTable = _RlArpSpoofingTable_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 60, 2)
)
if mibBuilder.loadTexts:
    rlArpSpoofingTable.setStatus("current")
_RlArpSpoofingEntry_Object = MibTableRow
rlArpSpoofingEntry = _RlArpSpoofingEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 60, 2, 1)
)
rlArpSpoofingEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-ARPSPOOFING-MIB", "rlArpSpoofingIfIndex"),
    (0, "NETGEAR-RADLAN-ARPSPOOFING-MIB", "rlArpSpoofingLocalIpAddr"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "NETGEAR-RADLAN-ARPSPOOFING-MIB",
