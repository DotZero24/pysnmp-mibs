...
_C='NETGEAR-RADLAN-ARPSPOOFING-MIB'
_B='read-create'
_A='current'
...
rlArpSpoofingMibVersion=_RlArpSpoofingMibVersion_Object((1,3,6,1,4,1,4526,17,60,1),_RlArpSpoofingMibVersion_Type())
...
rlArpSpoofingTable=_RlArpSpoofingTable_Object((1,3,6,1,4,1,4526,17,60,2))
if mibBuilder.loadTexts:rlArpSpoofingTable.setStatus(_A)
_RlArpSpoofingEntry_Object=MibTableRow
rlArpSpoofingEntry=_RlArpSpoofingEntry_Object((1,3,6,1,4,1,4526,17,60,2,1))
...
rlArpSpoofingIfIndex=_RlArpSpoofingIfIndex_Object((1,3,6,1,4,1,4526,17,60,2,1,1),_RlArpSpoofingIfIndex_Type())
...
rlArpSpoofingLocalIpAddr=_RlArpSpoofingLocalIpAddr_Object((1,3,6,1,4,1,4526,17,60,2,1,2),_RlArpSpoofingLocalIpAddr_Type())
...
rlArpSpoofingMacAddr=_RlArpSpoofingMacAddr_Object((1,3,6,1,4,1,4526,17,60,2,1,3),_RlArpSpoofingMacAddr_Type())
...
rlArpSpoofingRemoteIpAddr=_RlArpSpoofingRemoteIpAddr_Object((1,3,6,1,4,1,4526,17,60,2,1,4),_RlArpSpoofingRemoteIpAddr_Type())
...
rlArpSpoofingOutPhysIfIndex=_RlArpSpoofingOutPhysIfIndex_Object((1,3,6,1,4,1,4526,17,60,2,1,5),_RlArpSpoofingOutPhysIfIndex_Type())
...
rlArpSpoofingStatus=_RlArpSpoofingStatus_Object((1,3,6,1,4,1,4526,17,60,2,1,6),_RlArpSpoofingStatus_Type())
