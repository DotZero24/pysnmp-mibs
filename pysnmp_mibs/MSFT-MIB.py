...
mibBuilder.exportSymbols("MSFT-MIB", windows=windows, microsoft=microsoft, windowsNT=windowsNT, software=software, workstation=workstation, dc=dc, os=os, systems=systems, server=server)
