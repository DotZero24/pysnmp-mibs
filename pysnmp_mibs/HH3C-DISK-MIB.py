...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:41:59 2025
...
hh3cStorageRef, Hh3cStorageActionType, Hh3cStorageEnableState = mibBuilder.importSymbols("HH3C-STORAGE-REF-MIB", "hh3cStorageRef", "Hh3cStorageActionType", "Hh3cStorageEnableState")
...
mibBuilder.exportSymbols("HH3C-DISK-MIB", hh3cDiskFaultLedState=hh3cDiskFaultLedState, hh3cDiskSize=hh3cDiskSize, hh3cDiskReadCache=hh3cDiskReadCache, hh3cDiskPowerOffReason=hh3cDiskPowerOffReason, hh3cDiskGlobalSpare=hh3cDiskGlobalSpare, hh3cDiskLocationState=hh3cDiskLocationState, hh3cDiskIndex=hh3cDiskIndex, PYSNMP_MODULE_ID=hh3cDisk, hh3cDiskPortSpeed=hh3cDiskPortSpeed, hh3cDiskMibObjects=hh3cDiskMibObjects, hh3cDiskEntry=hh3cDiskEntry, hh3cDiskPortType=hh3cDiskPortType, hh3cDiskWriteCache=hh3cDiskWriteCache, hh3cDiskInitialize=hh3cDiskInitialize, hh3cDiskTable=hh3cDiskTable, hh3cDiskLocalSpare=hh3cDiskLocalSpare, hh3cDisk=hh3cDisk, hh3cDiskRunLedState=hh3cDiskRunLedState, hh3cDiskFreeSpace=hh3cDiskFreeSpace)
