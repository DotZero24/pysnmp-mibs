...
_G='GBNPlatformOAMMailalarm-MIB'
_F='disable'
_E='enable'
_D='Integer32'
_C='OctetString'
...
mailalarmState=_MailalarmState_Object((1,3,6,1,4,1,13464,1,2,1,1,12,1),_MailalarmState_Type())
...
mailalarmSrvAddr=_MailalarmSrvAddr_Object((1,3,6,1,4,1,13464,1,2,1,1,12,2),_MailalarmSrvAddr_Type())
...
mailalarmRceiverAddr=_MailalarmRceiverAddr_Object((1,3,6,1,4,1,13464,1,2,1,1,12,3),_MailalarmRceiverAddr_Type())
...
mailalarmLogLevel=_MailalarmLogLevel_Object((1,3,6,1,4,1,13464,1,2,1,1,12,4),_MailalarmLogLevel_Type())
...
mailalarmSmtpAuthEnable=_MailalarmSmtpAuthEnable_Object((1,3,6,1,4,1,13464,1,2,1,1,12,5),_MailalarmSmtpAuthEnable_Type())
...
mailalarmSmtpUsername=_MailalarmSmtpUsername_Object((1,3,6,1,4,1,13464,1,2,1,1,12,6),_MailalarmSmtpUsername_Type())
...
mailalarmSmtpPasswd=_MailalarmSmtpPasswd_Object((1,3,6,1,4,1,13464,1,2,1,1,12,7),_MailalarmSmtpPasswd_Type())
...
mailalarmCcAddrTable=_MailalarmCcAddrTable_Object((1,3,6,1,4,1,13464,1,2,1,1,12,8))
if mibBuilder.loadTexts:mailalarmCcAddrTable.setStatus(_A)
_MailalarmCcAddrEntry_Object=MibTableRow
mailalarmCcAddrEntry=_MailalarmCcAddrEntry_Object((1,3,6,1,4,1,13464,1,2,1,1,12,8,1))
...
mailalarmCcAddrIdx=_MailalarmCcAddrIdx_Object((1,3,6,1,4,1,13464,1,2,1,1,12,8,1,1),_MailalarmCcAddrIdx_Type())
...
mailalarmCcAddr=_MailalarmCcAddr_Object((1,3,6,1,4,1,13464,1,2,1,1,12,8,1,2),_MailalarmCcAddr_Type())
