...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LWAPP-LOCAL-AUTH-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:15 2025
...
class _CllaActiveTimeout_Type(Unsigned32):
    """Custom type cllaActiveTimeout based on Unsigned32"""
    defaultValue = 300
...
_CllaActiveTimeout_Type.__name__ = "Unsigned32"
...
class _CllaEapIdentityReqTimeout_Type(Unsigned32):
    """Custom type cllaEapIdentityReqTimeout based on Unsigned32"""
    defaultValue = 1
...
_CllaEapIdentityReqTimeout_Type.__name__ = "Unsigned32"
...
class _CllaEapIdentityReqMaxRetries_Type(Unsigned32):
    """Custom type cllaEapIdentityReqMaxRetries based on Unsigned32"""
    defaultValue = 20
...
_CllaEapIdentityReqMaxRetries_Type.__name__ = "Unsigned32"
...
class _CllaEapReqTimeout_Type(Unsigned32):
    """Custom type cllaEapReqTimeout based on Unsigned32"""
    defaultValue = 1
...
_CllaEapReqTimeout_Type.__name__ = "Unsigned32"
...
class _CllaEapReqMaxRetries_Type(Unsigned32):
    """Custom type cllaEapReqMaxRetries based on Unsigned32"""
    defaultValue = 2
...
_CllaEapReqMaxRetries_Type.__name__ = "Unsigned32"
...
_CllaEapMaxLoginIgnIdResp_Type.__name__ = "TruthValue"
...
class _CllaEapBroadcastKeyInterval_Type(Unsigned32):
    """Custom type cllaEapBroadcastKeyInterval based on Unsigned32"""
    defaultValue = 120
...
_CllaEapBroadcastKeyInterval_Type.__name__ = "Unsigned32"
_CllaEapBroadcastKeyInterval_Object = MibScalar
cllaEapBroadcastKeyInterval = _CllaEapBroadcastKeyInterval_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 619, 1, 1, 1, 10),
    _CllaEapBroadcastKeyInterval_Type()
)
cllaEapBroadcastKeyInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cllaEapBroadcastKeyInterval.setStatus("current")
if mibBuilder.loadTexts:
    cllaEapBroadcastKeyInterval.setUnits("seconds")
...
_CllaEapProfileCaCertificationCheck_Type.__name__ = "TruthValue"
...
_CllaEapProfileCnCertificationIdVerify_Type.__name__ = "TruthValue"
...
_CllaEapProfileDateValidityEnabled_Type.__name__ = "TruthValue"
...
_CllaEapProfileLocalCertificateRequired_Type.__name__ = "TruthValue"
...
_CllaEapProfileClientCertificateRequired_Type.__name__ = "TruthValue"
...
_CllaEapAnonymousProvEnabled_Type.__name__ = "TruthValue"
...
ciscoLwappLocalAuthMIBConfigGroupSup1.setObjects(
      *(("CISCO-LWAPP-LOCAL-AUTH-MIB", "cllaActiveTimeout"),
        ...
        ("CISCO-LWAPP-LOCAL-AUTH-MIB", "cllaEapBroadcastKeyInterval"))
)
if mibBuilder.loadTexts:
...
ciscoLwappLocalAuthMIBCompliance.setObjects(
    ("CISCO-LWAPP-LOCAL-AUTH-MIB", "ciscoLwappLocalAuthMIBConfigGroup")
)
if mibBuilder.loadTexts:
...
ciscoLwappLocalAuthMIBComplianceRev1.setObjects(
    ("CISCO-LWAPP-LOCAL-AUTH-MIB", "ciscoLwappLocalAuthMIBConfigGroupSup1")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoLwappLocalAuthMIB": ciscoLwappLocalAuthMIB,
       ...
       "cllaEapBroadcastKeyInterval": cllaEapBroadcastKeyInterval,
