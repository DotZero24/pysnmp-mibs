# SNMP MIB module (FASTPATH-NSF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-NSF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:07:51 2025
...
agentNsfStackRestartComplete.setObjects(
      *(("FASTPATH-INVENTORY-MIB", "agentInventoryUnitNumber"),
        ("FASTPATH-NSF-MIB", "agentNsfLastStartupReason"))
)
if mibBuilder.loadTexts:
