...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-NETWORK-REGISTRAR-MIB
...
ciscoNetworkRegistrarMIB.setRevisions(('2023-01-22 00:00', '2017-04-03 00:00', '2016-09-23 00:00', '2014-06-13 00:00', '2013-05-24 00:00', '2010-05-24 00:00', '2005-03-03 00:00', '2003-01-11 00:00', '1999-06-17 00:00', '1998-11-01 00:00',))
if mibBuilder.loadTexts: ciscoNetworkRegistrarMIB.setLastUpdated('202301220000Z')
...
class CnrPhysAddress(TextualConvention, OctetString):
    reference = 'RFC 2131'
    status = 'current'
    subtypeSpec = OctetString.subtypeSpec + ValueSizeConstraint(2, 18)
...
cnrNotifRelatedServerType = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 14), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("dnsPrimary", 1), ("ldap", 2), ("failoverPartner", 3), ("relay-agent", 4)))).setMaxAccess("accessiblefornotify")
...
cnrNotifIPv6Server = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 18), InetAddressIPv6()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifIPv6Server.setStatus('current')
cnrNotifFailoverPairName = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 19), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(1, 255))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifFailoverPairName.setStatus('current')
cnrNotifFailoverCfgErrType = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 20), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))).clone(namedValues=NamedValues(("mclt-error", 1), ("hba-error", 2), ("backup-percentage-error", 3), ("server-address-error", 4), ("config-error", 5), ("internal-error", 6), ("backup-load-balancing-config-error", 7), ("main-load-balancing-config-error", 8)))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifFailoverCfgErrType.setStatus('current')
cnrNotifDnsServerIp6Address = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 21), InetAddressIPv6()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifDnsServerIp6Address.setStatus('current')
cnrNotifMainIPAddress = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 22), IpAddress()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifMainIPAddress.setStatus('current')
cnrNotifMainIPv6Address = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 23), InetAddressIPv6()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifMainIPv6Address.setStatus('current')
cnrNotifBackupIPAddress = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 24), IpAddress()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifBackupIPAddress.setStatus('current')
cnrNotifBackupIPv6Address = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 25), InetAddressIPv6()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifBackupIPv6Address.setStatus('current')
cnrNotifSyncDirection = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 26), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("main-to-backup", 1), ("backup-to-main", 2)))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifSyncDirection.setStatus('current')
cnrNotifSyncError = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 2, 27), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(1, 255))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: cnrNotifSyncError.setStatus('current')
...
cnrEnableFailoverSyncFailure = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 120, 1, 3, 23), TruthValue().clone('false')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: cnrEnableFailoverSyncFailure.setStatus('current')
...
ciscoNetRegAddressConflict = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 8)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifContestedIpAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifServer"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifIPv6Server"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifFailoverPairName"))
...
ciscoNetRegFailoverConfigMismatch = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 10)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifServer"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifIPv6Server"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifFailoverPairName"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifFailoverCfgErrType"))
...
ciscoNetRegOtherServerNotResp = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 13)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifServer"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifRelatedServerType"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifIPv6Server"))
if mibBuilder.loadTexts: ciscoNetRegOtherServerNotResp.setStatus('current')
ciscoNetRegOtherServerResp = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 14)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifServer"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifRelatedServerType"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifIPv6Server"))
if mibBuilder.loadTexts: ciscoNetRegOtherServerResp.setStatus('current')
ciscoNetRegHaDnsPartnerDown = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 15)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifServer"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifIPv6Server"))
if mibBuilder.loadTexts: ciscoNetRegHaDnsPartnerDown.setStatus('current')
ciscoNetRegHaDnsPartnerUp = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 16)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifServer"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifIPv6Server"))
if mibBuilder.loadTexts: ciscoNetRegHaDnsPartnerUp.setStatus('current')
ciscoNetRegMastersNotResp = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 17)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsServerIpAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsServerIp6Address"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifZoneName"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsRemoteServersList"))
if mibBuilder.loadTexts: ciscoNetRegMastersNotResp.setStatus('current')
ciscoNetRegMastersResp = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 18)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsServerIpAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsServerIp6Address"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifZoneName"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsRemoteServersList"))
if mibBuilder.loadTexts: ciscoNetRegMastersResp.setStatus('current')
ciscoNetRegSecondaryZonesExpired = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 19)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsServerIpAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsServerIp6Address"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifZoneName"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsRemoteServersList"))
...
if mibBuilder.loadTexts: ciscoNetRegDnsForwardersNotResp.setStatus('deprecated')
...
if mibBuilder.loadTexts: ciscoNetRegDnsForwardersResp.setStatus('deprecated')
ciscoNetRegHaDnsConfigErr = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 22)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifServer"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifZoneName"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifIPv6Server"))
if mibBuilder.loadTexts: ciscoNetRegHaDnsConfigErr.setStatus('current')
ciscoNetRegFailoverSyncFailure = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 120, 2, 0, 23)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifFailoverPairName"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifMainIPAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifMainIPv6Address"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifBackupIPAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifBackupIPv6Address"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifSyncDirection"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifSyncError"))
if mibBuilder.loadTexts: ciscoNetRegFailoverSyncFailure.setStatus('current')
...
ciscoNetRegistrarNotifInfoGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 120, 3, 2, 5)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDupIpAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifMACAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifServer"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifServerType"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDupIpAddressDetectedBy"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifContestedIpAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDHCPScopeFreeAddrLow"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDHCPScopeFreeAddrHigh"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDHCPScopeFreeAddrValue"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDHCPThresholdType"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDHCPThresholdValue"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDHCPScopeName"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifPrimarySubnetNumber"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifRelatedServerType"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsServerIpAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifZoneName"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsRemoteServersList"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifIPv6Server"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifFailoverPairName"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifFailoverCfgErrType"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifDnsServerIp6Address"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifMainIPAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifMainIPv6Address"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifBackupIPAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifBackupIPv6Address"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifSyncDirection"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrNotifSyncError"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ciscoNetRegistrarNotifInfoGroup = ciscoNetRegistrarNotifInfoGroup.setStatus('current')
ciscoNetRegistrarNotEnableGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 120, 3, 2, 6)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableServerStart"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableServerStop"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableDNSQueueTooBig"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableDuplicateAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableAddressConflict"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableFailoverConfigMismatch"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableFreeAddrLow"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableFreeAddrHigh"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableOtherServerNotResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableOtherServerResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableHaDnsPartnerDown"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableHaDnsPartnerUp"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableMastersNotResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableMastersResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableSecondaryZoneExpired"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableDnsForwardersNotResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableDnsForwardersResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableHaDnsConfigErr"), ("CISCO-NETWORK-REGISTRAR-MIB", "cnrEnableFailoverSyncFailure"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ciscoNetRegistrarNotEnableGroup = ciscoNetRegistrarNotEnableGroup.setStatus('current')
ciscoNetRegistrarNotificatGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 9, 9, 120, 3, 2, 7)).setObjects(("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegServerStart"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegServerStop"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegDNSQueueTooBig"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegFreeAddrLowThreshold"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegFreeAddrHighThreshold"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegAddressConflict"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegDuplicateAddress"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegOtherServerNotResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegOtherServerResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegFailoverConfigMismatch"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegHaDnsPartnerDown"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegHaDnsPartnerUp"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegMastersNotResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegMastersResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegSecondaryZonesExpired"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegDnsForwardersNotResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegDnsForwardersResp"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegHaDnsConfigErr"), ("CISCO-NETWORK-REGISTRAR-MIB", "ciscoNetRegFailoverSyncFailure"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ciscoNetRegistrarNotificatGroup = ciscoNetRegistrarNotificatGroup.setStatus('current')
mibBuilder.exportSymbols("CISCO-NETWORK-REGISTRAR-MIB", ciscoNetRegServerStart=ciscoNetRegServerStart, cnrNotifDnsServerIpAddress=cnrNotifDnsServerIpAddress, cnrNotifPrimarySubnetNumber=cnrNotifPrimarySubnetNumber, cnrEnableDNSQueueTooBig=cnrEnableDNSQueueTooBig, ciscoNetRegDNSQueueTooBig=ciscoNetRegDNSQueueTooBig, ciscoNetworkRegistrarMIBCompliances=ciscoNetworkRegistrarMIBCompliances, cnrNotifFailoverPairName=cnrNotifFailoverPairName, cnrEnableHaDnsPartnerDown=cnrEnableHaDnsPartnerDown, cnrEnableServerStop=cnrEnableServerStop, cnrEnableDnsForwardersResp=cnrEnableDnsForwardersResp, cnrNotifDHCPScopeFreeAddrHigh=cnrNotifDHCPScopeFreeAddrHigh, cnrNotifMainIPv6Address=cnrNotifMainIPv6Address, cnrNotifContestedIpAddress=cnrNotifContestedIpAddress, ciscoNetRegFreeAddressLow=ciscoNetRegFreeAddressLow, ciscoNetRegistrarNotEnableGroup=ciscoNetRegistrarNotEnableGroup, cnrDHCP=cnrDHCP, cnrEnableMastersResp=cnrEnableMastersResp, ciscoNetRegServerStop=ciscoNetRegServerStop, ciscoNetRegAddressConflict=ciscoNetRegAddressConflict, cnrNotifDupIpAddressDetectedBy=cnrNotifDupIpAddressDetectedBy, ciscoNetworkRegistrarMIBObjects=ciscoNetworkRegistrarMIBObjects, cnrEnableFreeAddrHigh=cnrEnableFreeAddrHigh, ciscoNetRegistrarNotifInfoGroup=ciscoNetRegistrarNotifInfoGroup, ciscoNetRegOtherServerResp=ciscoNetRegOtherServerResp, ciscoNetworkRegistrarMIBGroups=ciscoNetworkRegistrarMIBGroups, ciscoNetRegFreeAddressHigh=ciscoNetRegFreeAddressHigh, cnrNotifServer=cnrNotifServer, ciscoNetworkRegistrarNotifObjectsGroup=ciscoNetworkRegistrarNotifObjectsGroup, cnrDHCPScopeName=cnrDHCPScopeName, cnrNotifBackupIPv6Address=cnrNotifBackupIPv6Address, ciscoNetRegOtherServerNotResp=ciscoNetRegOtherServerNotResp, cnrNotifFailoverCfgErrType=cnrNotifFailoverCfgErrType, cnrEnableOtherServerResp=cnrEnableOtherServerResp, ciscoNetRegFreeAddrLowThreshold=ciscoNetRegFreeAddrLowThreshold, cnrNotifMainIPAddress=cnrNotifMainIPAddress, cnrEnableOtherServerNotResp=cnrEnableOtherServerNotResp, cnrEnableServerStart=cnrEnableServerStart, ciscoNetRegHaDnsPartnerUp=ciscoNetRegHaDnsPartnerUp, ciscoNetRegMIBNotifications=ciscoNetRegMIBNotifications, cnrEnableOtherServerResponding=cnrEnableOtherServerResponding, cnrNotifZoneName=cnrNotifZoneName, cnrNotifDHCPScopeName=cnrNotifDHCPScopeName, ciscoNetRegDnsForwardersNotResp=ciscoNetRegDnsForwardersNotResp, cnrNotifBackupIPAddress=cnrNotifBackupIPAddress, ciscoNetRegMastersNotResp=ciscoNetRegMastersNotResp, cnrEnableFailoverConfigMismatch=cnrEnableFailoverConfigMismatch, ciscoNetworkRegistrarDHCPScopeObjectsGroup=ciscoNetworkRegistrarDHCPScopeObjectsGroup, cnrDHCPScopeFreeAddrLowThreshold=cnrDHCPScopeFreeAddrLowThreshold, cnrNotifMACAddress=cnrNotifMACAddress, cnrNotifObjects=cnrNotifObjects, ciscoNetRegDuplicateAddress=ciscoNetRegDuplicateAddress, ciscoNetRegDnsForwardersResp=ciscoNetRegDnsForwardersResp, cnrEnableHaDnsPartnerUp=cnrEnableHaDnsPartnerUp, cnrNotifSyncError=cnrNotifSyncError, cnrEnableAddressConflict=cnrEnableAddressConflict, cnrNotifDnsServerIp6Address=cnrNotifDnsServerIp6Address, cnrNotifDHCPScopeFreeAddrLow=cnrNotifDHCPScopeFreeAddrLow, cnrEnableFreeAddrLow=cnrEnableFreeAddrLow, cnrNotifDupIpAddress=cnrNotifDupIpAddress, cnrEnableFreeAddressLow=cnrEnableFreeAddressLow, cnrDHCPScopeTable=cnrDHCPScopeTable, ciscoNetRegMIBNotificationPrefix=ciscoNetRegMIBNotificationPrefix, ciscoNetRegOtherServerNotResponding=ciscoNetRegOtherServerNotResponding, cnrNotifDHCPThresholdType=cnrNotifDHCPThresholdType, cnrEnableOtherServerNotResponding=cnrEnableOtherServerNotResponding, ciscoNetworkRegistrarMIBCompRev1=ciscoNetworkRegistrarMIBCompRev1, PYSNMP_MODULE_ID=ciscoNetworkRegistrarMIB, cnrDHCPScopeFreeAddrHighThreshold=cnrDHCPScopeFreeAddrHighThreshold, ciscoNetworkRegistrarMIBConformance=ciscoNetworkRegistrarMIBConformance, cnrDHCPScopeEntry=cnrDHCPScopeEntry, ciscoNetRegHaDnsConfigErr=ciscoNetRegHaDnsConfigErr, ciscoNetRegFreeAddrHighThreshold=ciscoNetRegFreeAddrHighThreshold, cnrNotifCfgObjects=cnrNotifCfgObjects, CnrPhysAddress=CnrPhysAddress, ciscoNetRegHaDnsPartnerDown=ciscoNetRegHaDnsPartnerDown, cnrEnableMastersNotResp=cnrEnableMastersNotResp, cnrNotifServerType=cnrNotifServerType, cnrDHCPScopeFreeAddrValue=cnrDHCPScopeFreeAddrValue, cnrDHCPScopeFreeAddrUnits=cnrDHCPScopeFreeAddrUnits, cnrEnableDuplicateAddress=cnrEnableDuplicateAddress, cnrNotifDnsRemoteServersList=cnrNotifDnsRemoteServersList, ciscoNetRegFailoverConfigMismatch=ciscoNetRegFailoverConfigMismatch, ciscoNetRegMastersResp=ciscoNetRegMastersResp, ciscoNetworkRegistrarMIBCompliance=ciscoNetworkRegistrarMIBCompliance, cnrNotifDHCPScopeFreeAddrValue=cnrNotifDHCPScopeFreeAddrValue, cnrEnableSecondaryZoneExpired=cnrEnableSecondaryZoneExpired, ciscoNetRegOtherServerResponding=ciscoNetRegOtherServerResponding, cnrEnableHaDnsConfigErr=cnrEnableHaDnsConfigErr, cnrEnableFreeAddressHigh=cnrEnableFreeAddressHigh, ciscoNetRegSecondaryZonesExpired=ciscoNetRegSecondaryZonesExpired, cnrNotifRelatedServerType=cnrNotifRelatedServerType, ciscoNetworkRegistrarNotificationsGroup=ciscoNetworkRegistrarNotificationsGroup, cnrNotifIPv6Server=cnrNotifIPv6Server, ciscoNetRegFailoverSyncFailure=ciscoNetRegFailoverSyncFailure, ciscoNetworkRegistrarNotifCfgObjectsGroup=ciscoNetworkRegistrarNotifCfgObjectsGroup, ciscoNetRegistrarNotificatGroup=ciscoNetRegistrarNotificatGroup, cnrEnableDnsForwardersNotResp=cnrEnableDnsForwardersNotResp, cnrEnableFailoverSyncFailure=cnrEnableFailoverSyncFailure, ciscoNetworkRegistrarMIB=ciscoNetworkRegistrarMIB, cnrNotifDHCPThresholdValue=cnrNotifDHCPThresholdValue, cnrNotifSyncDirection=cnrNotifSyncDirection)
