...
mibBuilder.exportSymbols("CISCO-NETWORK-REGISTRAR-MIB", cnrEnableServerStart=cnrEnableServerStart, ciscoNetRegOtherServerResp=ciscoNetRegOtherServerResp, ciscoNetRegMastersResp=ciscoNetRegMastersResp, cnrEnableDNSQueueTooBig=cnrEnableDNSQueueTooBig, cnrEnableMastersResp=cnrEnableMastersResp, cnrEnableFreeAddrHigh=cnrEnableFreeAddrHigh, ciscoNetRegServerStart=ciscoNetRegServerStart, ciscoNetworkRegistrarMIBCompliance=ciscoNetworkRegistrarMIBCompliance, cnrNotifDHCPScopeName=cnrNotifDHCPScopeName, cnrNotifZoneName=cnrNotifZoneName, ciscoNetworkRegistrarMIBCompliances=ciscoNetworkRegistrarMIBCompliances, cnrNotifMainIPAddress=cnrNotifMainIPAddress, ciscoNetRegDnsForwardersResp=ciscoNetRegDnsForwardersResp, cnrEnableSecondaryZoneExpired=cnrEnableSecondaryZoneExpired, cnrNotifFailoverPairName=cnrNotifFailoverPairName, cnrNotifMainIPv6Address=cnrNotifMainIPv6Address, cnrDHCPScopeFreeAddrHighThreshold=cnrDHCPScopeFreeAddrHighThreshold, cnrNotifBackupIPAddress=cnrNotifBackupIPAddress, cnrNotifServerType=cnrNotifServerType, ciscoNetRegMIBNotificationPrefix=ciscoNetRegMIBNotificationPrefix, cnrNotifContestedIpAddress=cnrNotifContestedIpAddress, ciscoNetRegDnsForwardersNotResp=ciscoNetRegDnsForwardersNotResp, cnrDHCPScopeTable=cnrDHCPScopeTable, cnrEnableDnsForwardersResp=cnrEnableDnsForwardersResp, cnrEnableFailoverSyncFailure=cnrEnableFailoverSyncFailure, ciscoNetRegServerStop=ciscoNetRegServerStop, cnrNotifDnsServerIp6Address=cnrNotifDnsServerIp6Address, cnrNotifDHCPScopeFreeAddrHigh=cnrNotifDHCPScopeFreeAddrHigh, ciscoNetRegMIBNotifications=ciscoNetRegMIBNotifications, cnrEnableFreeAddressHigh=cnrEnableFreeAddressHigh, ciscoNetRegFreeAddressHigh=ciscoNetRegFreeAddressHigh, cnrNotifObjects=cnrNotifObjects, cnrNotifBackupIPv6Address=cnrNotifBackupIPv6Address, ciscoNetworkRegistrarMIBObjects=ciscoNetworkRegistrarMIBObjects, cnrNotifRelatedServerType=cnrNotifRelatedServerType, cnrDHCP=cnrDHCP, ciscoNetRegistrarNotifInfoGroup=ciscoNetRegistrarNotifInfoGroup, ciscoNetRegHaDnsPartnerDown=ciscoNetRegHaDnsPartnerDown, cnrEnableFreeAddressLow=cnrEnableFreeAddressLow, ciscoNetRegistrarNotificatGroup=ciscoNetRegistrarNotificatGroup, cnrNotifSyncDirection=cnrNotifSyncDirection, cnrNotifServer=cnrNotifServer, ciscoNetRegOtherServerNotResp=ciscoNetRegOtherServerNotResp, cnrNotifSyncError=cnrNotifSyncError, cnrEnableHaDnsPartnerDown=cnrEnableHaDnsPartnerDown, cnrNotifPrimarySubnetNumber=cnrNotifPrimarySubnetNumber, ciscoNetworkRegistrarNotifObjectsGroup=ciscoNetworkRegistrarNotifObjectsGroup, cnrNotifDHCPThresholdValue=cnrNotifDHCPThresholdValue, ciscoNetRegOtherServerResponding=ciscoNetRegOtherServerResponding, ciscoNetRegMastersNotResp=ciscoNetRegMastersNotResp, CnrPhysAddress=CnrPhysAddress, ciscoNetRegSecondaryZonesExpired=ciscoNetRegSecondaryZonesExpired, ciscoNetRegFailoverSyncFailure=ciscoNetRegFailoverSyncFailure, ciscoNetRegOtherServerNotResponding=ciscoNetRegOtherServerNotResponding, ciscoNetRegFreeAddrLowThreshold=ciscoNetRegFreeAddrLowThreshold, cnrNotifDnsRemoteServersList=cnrNotifDnsRemoteServersList, ciscoNetworkRegistrarNotificationsGroup=ciscoNetworkRegistrarNotificationsGroup, PYSNMP_MODULE_ID=ciscoNetworkRegistrarMIB, cnrNotifDupIpAddressDetectedBy=cnrNotifDupIpAddressDetectedBy, ciscoNetworkRegistrarMIBConformance=ciscoNetworkRegistrarMIBConformance, ciscoNetRegFreeAddressLow=ciscoNetRegFreeAddressLow, cnrDHCPScopeEntry=cnrDHCPScopeEntry, ciscoNetRegHaDnsConfigErr=ciscoNetRegHaDnsConfigErr, ciscoNetRegFailoverConfigMismatch=ciscoNetRegFailoverConfigMismatch, cnrNotifIPv6Server=cnrNotifIPv6Server, cnrEnableAddressConflict=cnrEnableAddressConflict, cnrNotifDHCPScopeFreeAddrValue=cnrNotifDHCPScopeFreeAddrValue, ciscoNetRegFreeAddrHighThreshold=ciscoNetRegFreeAddrHighThreshold, cnrNotifDHCPScopeFreeAddrLow=cnrNotifDHCPScopeFreeAddrLow, ciscoNetworkRegistrarDHCPScopeObjectsGroup=ciscoNetworkRegistrarDHCPScopeObjectsGroup, ciscoNetRegistrarNotEnableGroup=ciscoNetRegistrarNotEnableGroup, cnrNotifMACAddress=cnrNotifMACAddress, cnrEnableServerStop=cnrEnableServerStop, ciscoNetRegHaDnsPartnerUp=ciscoNetRegHaDnsPartnerUp, cnrDHCPScopeFreeAddrValue=cnrDHCPScopeFreeAddrValue, cnrNotifDupIpAddress=cnrNotifDupIpAddress, cnrNotifDHCPThresholdType=cnrNotifDHCPThresholdType, cnrEnableDuplicateAddress=cnrEnableDuplicateAddress, ciscoNetworkRegistrarMIBGroups=ciscoNetworkRegistrarMIBGroups, cnrEnableOtherServerResponding=cnrEnableOtherServerResponding, cnrEnableOtherServerResp=cnrEnableOtherServerResp, ciscoNetworkRegistrarNotifCfgObjectsGroup=ciscoNetworkRegistrarNotifCfgObjectsGroup, ciscoNetRegAddressConflict=ciscoNetRegAddressConflict, ciscoNetworkRegistrarMIBCompRev1=ciscoNetworkRegistrarMIBCompRev1, ciscoNetworkRegistrarMIB=ciscoNetworkRegistrarMIB, cnrEnableDnsForwardersNotResp=cnrEnableDnsForwardersNotResp, cnrNotifDnsServerIpAddress=cnrNotifDnsServerIpAddress, cnrEnableOtherServerNotResponding=cnrEnableOtherServerNotResponding, cnrEnableFreeAddrLow=cnrEnableFreeAddrLow, ciscoNetRegDuplicateAddress=ciscoNetRegDuplicateAddress, cnrDHCPScopeName=cnrDHCPScopeName, cnrNotifFailoverCfgErrType=cnrNotifFailoverCfgErrType, cnrEnableFailoverConfigMismatch=cnrEnableFailoverConfigMismatch, cnrEnableHaDnsPartnerUp=cnrEnableHaDnsPartnerUp, ciscoNetRegDNSQueueTooBig=ciscoNetRegDNSQueueTooBig, cnrNotifCfgObjects=cnrNotifCfgObjects, cnrEnableOtherServerNotResp=cnrEnableOtherServerNotResp, cnrDHCPScopeFreeAddrUnits=cnrDHCPScopeFreeAddrUnits, cnrEnableMastersNotResp=cnrEnableMastersNotResp, cnrEnableHaDnsConfigErr=cnrEnableHaDnsConfigErr, cnrDHCPScopeFreeAddrLowThreshold=cnrDHCPScopeFreeAddrLowThreshold)
