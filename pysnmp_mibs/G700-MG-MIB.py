...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:41:52 2025
...
genAppFileVersionNumber, genAppFileId, genAppFileName, genOpLastWarningDisplay, genOpLastFailureIndex = mibBuilder.importSymbols("LOAD-MIB", "genAppFileVersionNumber", "genAppFileId", "genAppFileName", "genOpLastWarningDisplay", "genOpLastFailureIndex")
...
mibBuilder.exportSymbols("G700-MG-MIB", cmgCertErrorCertExpired=cmgCertErrorCertExpired, cmgDsuFpgaConfigureClear=cmgDsuFpgaConfigureClear, cmgVoipOccClear=cmgVoipOccClear, cmgPrimarySearchTime=cmgPrimarySearchTime, cmgMgpFaultMask=cmgMgpFaultMask, cmgCcStatus=cmgCcStatus, cmgHWVintage=cmgHWVintage, cmg8260PowerFault=cmg8260PowerFault, cmgVoipDspStatus=cmgVoipDspStatus, cmgVoipRemoteRsvpParameters=cmgVoipRemoteRsvpParameters, cmgDsuDteDtrClear=cmgDsuDteDtrClear, cmgDsuRxDClear=cmgDsuRxDClear, cmgCcModule=cmgCcModule, cmgFWVersion=cmgFWVersion, cmgTrapManagerMask=cmgTrapManagerMask, cmgVoipLocalRtcpMonitorInetAddress=cmgVoipLocalRtcpMonitorInetAddress, cmgVoipQosControl=cmgVoipQosControl, cmgVoipRemoteRtcpMonitorInetAddressType=cmgVoipRemoteRtcpMonitorInetAddressType, cmgModuleName=cmgModuleName, cmgOcspAccessDenied=cmgOcspAccessDenied, cmgPrimaryClockSource=cmgPrimaryClockSource, cmgTestClear=cmgTestClear, cmgVoipLocalEfDscp=cmgVoipLocalEfDscp, cmgVoipRemoteBbeDscp=cmgVoipRemoteBbeDscp, cmgNoControllerFault=cmgNoControllerFault, cmgDsuRLSD=cmgDsuRLSD, cmgExpansionHWVintage=cmgExpansionHWVintage, cmgHardwareFaultMask=cmgHardwareFaultMask, cmgPower8260=cmgPower8260, cmgDSPCoreDemandTestResult=cmgDSPCoreDemandTestResult, cmgDsuRTS=cmgDsuRTS, cmgExpansionDemandTest=cmgExpansionDemandTest, cmgMgpPowerClear=cmgMgpPowerClear, cmgDhcpRequestClear=cmgDhcpRequestClear, cmgAnalogBalance=cmgAnalogBalance, cmgStatic802Vlan=cmgStatic802Vlan, cmgSyncSignalWarn=cmgSyncSignalWarn, cmgSLAMonitorState=cmgSLAMonitorState, cmgDsuRing=cmgDsuRing, cmgModuleSlot=cmgModuleSlot, cmgVoipLocalRtcpParameters=cmgVoipLocalRtcpParameters, cmgVoipRemoteEfDscp=cmgVoipRemoteEfDscp, cmgDSPCoreStatus=cmgDSPCoreStatus, cmgAnalogReceiveGain=cmgAnalogReceiveGain, cmgChassis=cmgChassis, cmgModulePostFault=cmgModulePostFault, cmgFirmwareDownloadBegun=cmgFirmwareDownloadBegun, cmgVoipAutoReset=cmgVoipAutoReset, cmgVoipStaticInetAddressType=cmgVoipStaticInetAddressType, cmgDSPCoreTotalChannels=cmgDSPCoreTotalChannels, cmgDsuInvertRxD=cmgDsuInvertRxD, cmgDsuCTS=cmgDsuCTS, cmgVoipTotalChannels=cmgVoipTotalChannels, cmgVoipCurrentInetAddressType=cmgVoipCurrentInetAddressType, cmgVoipAdminState=cmgVoipAdminState, cmgVoipLocalParameters=cmgVoipLocalParameters, cmgProcessRestart=cmgProcessRestart, cmgProductId=cmgProductId, cmgVoipEchoCancellerControl=cmgVoipEchoCancellerControl, cmgCertErrorNearExpiry=cmgCertErrorNearExpiry, cmgDspTempWarningThresh=cmgDspTempWarningThresh, cmgModuleInsertSuccess=cmgModuleInsertSuccess, cmgVoipIpConfigClear=cmgVoipIpConfigClear, cmgCpuTempShutdownThresh=cmgCpuTempShutdownThresh, cmgVoipLocalRsvpProfile=cmgVoipLocalRsvpProfile, cmgPsuFanBriefFault=cmgPsuFanBriefFault, cmgDsuReceiveClock=cmgDsuReceiveClock, cmgDynCacRBBL=cmgDynCacRBBL, cmgCcAdminState=cmgCcAdminState, cmgLocalSig802Priority=cmgLocalSig802Priority, cmgDsuTxDClear=cmgDsuTxDClear, cmgDsuRxDFailure=cmgDsuRxDFailure, cmgDSPCoreAdminState=cmgDSPCoreAdminState, cmgDspPowerFault=cmgDspPowerFault, cmgDsuManualReset=cmgDsuManualReset, cmgDsuPortInitiatedLoopback=cmgDsuPortInitiatedLoopback, cmgReset=cmgReset, cmgVoipOccFault=cmgVoipOccFault, cmgRegistrationFaultInetAddress=cmgRegistrationFaultInetAddress, cmgVoipEchoCancellerConfig2=cmgVoipEchoCancellerConfig2, cmgVoipIpConfigFault=cmgVoipIpConfigFault, cmgDspPowerClear=cmgDspPowerClear, cmgVoipLocalRtcpMonitorInetAddressType=cmgVoipLocalRtcpMonitorInetAddressType, cmgSLAMonitorVersion=cmgSLAMonitorVersion, cmgVoipLocalRetryDelay=cmgVoipLocalRetryDelay, cmgTrapTypes=cmgTrapTypes, cmgGatewayNumber=cmgGatewayNumber, cmgStaticControllerHosts=cmgStaticControllerHosts, cmgSLAMonitorPacketCaptureMode=cmgSLAMonitorPacketCaptureMode, cmgDspTemp=cmgDspTemp, cmgHWType=cmgHWType, cmgCurrent802Vlan=cmgCurrent802Vlan, mibs=mibs, cmgControllers=cmgControllers, cmgModuleAutoReset=cmgModuleAutoReset, cmgVoipRemoteRtcpMonitorIpAddress=cmgVoipRemoteRtcpMonitorIpAddress, cmgStaticIpAddress=cmgStaticIpAddress, cmgVoipRemoteRsvpProfile=cmgVoipRemoteRsvpProfile, cmgLocalSigDscp=cmgLocalSigDscp, cmgAnalogEchoCancellerControl=cmgAnalogEchoCancellerControl, cmgCpuTempWarningThresh=cmgCpuTempWarningThresh, cmgTimeslotLowerThreshold=cmgTimeslotLowerThreshold, cmgVoipRemoteRtcpMonitorPort=cmgVoipRemoteRtcpMonitorPort, cmgDSPCoreCoreId=cmgDSPCoreCoreId, cmgModuleParameterFault=cmgModuleParameterFault, cmgModuleTable=cmgModuleTable, cmgDsuLocalDteLoopback=cmgDsuLocalDteLoopback, cmgUseDhcpForVlan=cmgUseDhcpForVlan, cmgSyncExcessClear=cmgSyncExcessClear, cmgConfigUploadSuccess=cmgConfigUploadSuccess, cmgUseDhcpForMgcList=cmgUseDhcpForMgcList, cmgFanPowerClear=cmgFanPowerClear, cmgAuxPowerClear=cmgAuxPowerClear, cmgVoipLocalBbeDscp=cmgVoipLocalBbeDscp, cmgTransitionPoint=cmgTransitionPoint, cmgTotalSearchTime=cmgTotalSearchTime, cmgDynCacLastUpdate=cmgDynCacLastUpdate, cmgExpansionModelNumber=cmgExpansionModelNumber, cmgVoipRemoteRetryOnFailure=cmgVoipRemoteRetryOnFailure, cmgQosControl=cmgQosControl, cmgCpuTemp=cmgCpuTemp, cmgVoipDSPCoreEntry=cmgVoipDSPCoreEntry, cmgSyncSignalExcess=cmgSyncSignalExcess, cmgConfigDownloadSuccess=cmgConfigDownloadSuccess, cmgH248LinkErrorCode=cmgH248LinkErrorCode, cmgVoipEngineUseDhcp=cmgVoipEngineUseDhcp, cmgModuleType=cmgModuleType, cmgDsuRemoteLoopback=cmgDsuRemoteLoopback, cmgDhcpRequestFault=cmgDhcpRequestFault, cmgTrapLocation=cmgTrapLocation, cmgAnalogPort=cmgAnalogPort, g700MediaGateway=g700MediaGateway, cmgDsuLL=cmgDsuLL, cmgDnsHostname=cmgDnsHostname, cmgH248LinkDown=cmgH248LinkDown, products=products, cmgEtrModule=cmgEtrModule, cmgIccAutoReset=cmgIccAutoReset, cmgSLAMonitorServerPort=cmgSLAMonitorServerPort, cmgMultipleFanFault=cmgMultipleFanFault, cmgDsuRL=cmgDsuRL, cmgFanPowerFault=cmgFanPowerFault, cmgHardwareStatusMask=cmgHardwareStatusMask, cmgDsuAutoReset=cmgDsuAutoReset, cmgVoipDSPCoreTable=cmgVoipDSPCoreTable, cmgTrapManagerAddress=cmgTrapManagerAddress, cmgTestFault=cmgTestFault, cmgPrimaryControllerClear=cmgPrimaryControllerClear, cmgDsuFlowControl=cmgDsuFlowControl, cmgDnsServerList=cmgDnsServerList, cmgDsuReset=cmgDsuReset, cmgDsuRxD=cmgDsuRxD, cmgFirmwareDownloadSuccess=cmgFirmwareDownloadSuccess, cmgExpansionHWSuffix=cmgExpansionHWSuffix, cmgRemoteSigDscp=cmgRemoteSigDscp, cmgConfigDownloadFault=cmgConfigDownloadFault, cmgSyncSignalFault=cmgSyncSignalFault, cmgPsuFanProlongedClear=cmgPsuFanProlongedClear, cmgMediaModulePowerClear=cmgMediaModulePowerClear, cmgFipsErrorMode=cmgFipsErrorMode, cmgModuleList=cmgModuleList, cmgMgAutoReset=cmgMgAutoReset, cmgVoipRemoteRtcpReportPeriod=cmgVoipRemoteRtcpReportPeriod, cmgRegistrationFault=cmgRegistrationFault, cmgTrapManagerRowStatus=cmgTrapManagerRowStatus, cmgPowerMediaModules=cmgPowerMediaModules, cmgDsuChannelAssignments=cmgDsuChannelAssignments, cmgDSPCoreDemandTest=cmgDSPCoreDemandTest, cmgDsuStatusMask=cmgDsuStatusMask, cmgDsuPortEnable=cmgDsuPortEnable, cmgModelNumber=cmgModelNumber, cmgDsu=cmgDsu, cmgVoipEngineReset=cmgVoipEngineReset, cmgConfigUploadBegun=cmgConfigUploadBegun, cmgDsuSlot=cmgDsuSlot, cmgSLAMonitorServerInetAddressType=cmgSLAMonitorServerInetAddressType, cmgDSPCoreChannelsInUse=cmgDSPCoreChannelsInUse, cmgVoipRemoteRetryDelay=cmgVoipRemoteRetryDelay, cmgExpansionSerialNumber=cmgExpansionSerialNumber, cmgVoipLocalMaxRtpPort=cmgVoipLocalMaxRtpPort, cmgNoControllerClear=cmgNoControllerClear, cmgDspTempWarningClear=cmgDspTempWarningClear, CmgItuPerceivedSeverity=CmgItuPerceivedSeverity, cmgVoipCurrentIpAddress=cmgVoipCurrentIpAddress, cmgVoipLocalRtcpMonitorPortInetAddress=cmgVoipLocalRtcpMonitorPortInetAddress, cmgTrapSeverity=cmgTrapSeverity, cmgAnalogPortEntry=cmgAnalogPortEntry, cmgContactClosuresTable=cmgContactClosuresTable, cmgExpansionUnitsTable=cmgExpansionUnitsTable, cmgH248LinkStatus=cmgH248LinkStatus, cmgVoipStaticInetAddress=cmgVoipStaticInetAddress, cmg8260PowerClear=cmg8260PowerClear, cmgAnalogEchoCancellerConfig2=cmgAnalogEchoCancellerConfig2, cmgHardware=cmgHardware, cmgSerialNumber=cmgSerialNumber, avaya=avaya, cmgTrapInUseTimeslots=cmgTrapInUseTimeslots, cmgDsuPortStatusEntry=cmgDsuPortStatusEntry, cmgSyncSignalClear=cmgSyncSignalClear, cmgTrapV3separator=cmgTrapV3separator, cmgSLAMonitorServerInetAddress=cmgSLAMonitorServerInetAddress, cmgModuleReset=cmgModuleReset, cmgDsuInvertTxD=cmgDsuInvertTxD, cmgDsuPort=cmgDsuPort, cmgVoipMACAddress=cmgVoipMACAddress, cmgModuleFaultMask=cmgModuleFaultMask, cmgProcessorClock=cmgProcessorClock, cmgModuleRemove=cmgModuleRemove, cmgActiveControllerSoftwareVersion=cmgActiveControllerSoftwareVersion, g700MediaGatewayMIB=g700MediaGatewayMIB, cmgVoipCoreFault=cmgVoipCoreFault, cmgMgpPowerFault=cmgMgpPowerFault, cmgIccMissingClear=cmgIccMissingClear, cmgDspTempShutdownThresh=cmgDspTempShutdownThresh, cmgVoipLocalRtcpReportPeriod=cmgVoipLocalRtcpReportPeriod, cmgDsuDteRtsFault=cmgDsuDteRtsFault, cmgTrapVariables=cmgTrapVariables, cmgModuleStatusMask=cmgModuleStatusMask, cmgVoipRemoteQosParameters=cmgVoipRemoteQosParameters, cmgSLAMonitor=cmgSLAMonitor, cmgVoipStaticIpAddress=cmgVoipStaticIpAddress, cmgTrapManagerControl=cmgTrapManagerControl, cmgClockSwitching=cmgClockSwitching, cmgDsuNearEndDataChannelLoopback=cmgDsuNearEndDataChannelLoopback, cmgModuleFWVersion=cmgModuleFWVersion, cmgConfigDownloadBegun=cmgConfigDownloadBegun, cmgDsuDteRtsClear=cmgDsuDteRtsClear, cmgTrapAvailableTimeslots=cmgTrapAvailableTimeslots, cmgDspTempWarningFault=cmgDspTempWarningFault, cmgPsuFanProlongedFault=cmgPsuFanProlongedFault, cmgVoipLocal802Priority=cmgVoipLocal802Priority, cmgVoipEngineEntry=cmgVoipEngineEntry, cmgTimeslotAvailabilityFault=cmgTimeslotAvailabilityFault, cmgDsuFarEndDataChannelLoopback=cmgDsuFarEndDataChannelLoopback, cmgModuleAutoResetClear=cmgModuleAutoResetClear, cmgTrapManagerEntry=cmgTrapManagerEntry, cmgDsuDTR=cmgDsuDTR, cmgCurrentIpAddress=cmgCurrentIpAddress, cmgDs1Layer2Up=cmgDs1Layer2Up, cmgModuleNumberOfChannels=cmgModuleNumberOfChannels, cmgFipsErrorType=cmgFipsErrorType, cmgTrapSubsystem=cmgTrapSubsystem, cmgDsuNetworkInitiatedLoopback=cmgDsuNetworkInitiatedLoopback, cmgMemoryClear=cmgMemoryClear, cmgProcessorConfig=cmgProcessorConfig, cmgTimeslotAvailabilityClear=cmgTimeslotAvailabilityClear, cmgVoipLocalQosParameters=cmgVoipLocalQosParameters, cmgMgRelease=cmgMgRelease, cmgTrapModule=cmgTrapModule, cmgVoipEngineTable=cmgVoipEngineTable, cmgCcPort=cmgCcPort, cmgTestThresholdFault=cmgTestThresholdFault, cmgDsuTxD=cmgDsuTxD, cmgTimeslotUpperThreshold=cmgTimeslotUpperThreshold)
mibBuilder.exportSymbols("G700-MG-MIB", cmgAnalogSlot=cmgAnalogSlot, cmgVoipLocalRtcpEnabled=cmgVoipLocalRtcpEnabled, cmgTrapDefinitions=cmgTrapDefinitions, cmgDsuDataRate=cmgDsuDataRate, cmgModuleNumberOfPorts=cmgModuleNumberOfPorts, cmgModuleParameterClear=cmgModuleParameterClear, cmgModuleHWVintage=cmgModuleHWVintage, cmgDsuTestMode=cmgDsuTestMode, cmgActiveControllerInetAddressType=cmgActiveControllerInetAddressType, cmgVoipJitterBufferSize=cmgVoipJitterBufferSize, cmgDescription=cmgDescription, cmgDsuInvertTxC=cmgDsuInvertTxC, cmgActiveClockSource=cmgActiveClockSource, cmgClockSourceControl=cmgClockSourceControl, cmgVoipRemoteRtcpMonitorInetAddress=cmgVoipRemoteRtcpMonitorInetAddress, cmgMediaModulePowerFault=cmgMediaModulePowerFault, cmgRegistrationSuccessInetAddress=cmgRegistrationSuccessInetAddress, cmgVoipLocalRsvpEnabled=cmgVoipLocalRsvpEnabled, cmgDynCacStatus=cmgDynCacStatus, cmgAnalogTransmitGain=cmgAnalogTransmitGain, cmgDsuFaultMask=cmgDsuFaultMask, cmgCertErrorCertRevoked=cmgCertErrorCertRevoked, cmgVoipRemoteRsvpEnabled=cmgVoipRemoteRsvpEnabled, cmgExpansionUnits=cmgExpansionUnits, cmgDsuTxDFault=cmgDsuTxDFault, cmgVoipRemoteRtcpEnabled=cmgVoipRemoteRtcpEnabled, cmgSyncWarnClear=cmgSyncWarnClear, cmgVoipLocalRsvpParameters=cmgVoipLocalRsvpParameters, cmgDsuLoopbackPattern=cmgDsuLoopbackPattern, cmgMultipleFanClear=cmgMultipleFanClear, cmgVoipSlot=cmgVoipSlot, cmgDsuPortStatusTable=cmgDsuPortStatusTable, cmgModuleEntry=cmgModuleEntry, cmgFirmwareDownloadWarning=cmgFirmwareDownloadWarning, cmgDsuDteDtrFault=cmgDsuDteDtrFault, cmgTimeslotMonitoring=cmgTimeslotMonitoring, cmgExpansionSlot=cmgExpansionSlot, cmgTrapManagerTable=cmgTrapManagerTable, cmgActiveControllerInetAddress=cmgActiveControllerInetAddress, cmgVoipAvgOccFault=cmgVoipAvgOccFault, cmgPowerVoipComplex=cmgPowerVoipComplex, cmgVoipLocalRtcpMonitorPort=cmgVoipLocalRtcpMonitorPort, cmgDsuFpgaConfigureFault=cmgDsuFpgaConfigureFault, cmgTimeslotOccupancyFault=cmgTimeslotOccupancyFault, cmgCertErrorIdAuthentication=cmgCertErrorIdAuthentication, cmgExpansions=cmgExpansions, cmgDhcpSson=cmgDhcpSson, cmgDsuAutoResetClear=cmgDsuAutoResetClear, cmgUseDhcpForIpAddress=cmgUseDhcpForIpAddress, cmgDsuTestEntry=cmgDsuTestEntry, cmgDsuYellowAlarmAction=cmgDsuYellowAlarmAction, cmgmib=cmgmib, cmgExpansionDemandTestResult=cmgExpansionDemandTestResult, cmgTrapOnIccMissing=cmgTrapOnIccMissing, cmgMemoryFault=cmgMemoryFault, cmgH248LinkUp=cmgH248LinkUp, cmgAuxPowerFault=cmgAuxPowerFault, cmgETREntry=cmgETREntry, cmgVoipHyperactivity=cmgVoipHyperactivity, cmgVoipHardwareClear=cmgVoipHardwareClear, cmgCpuTempWarningClear=cmgCpuTempWarningClear, cmgTempShutdownFault=cmgTempShutdownFault, cmgVoipCurrentInetAddress=cmgVoipCurrentInetAddress, cmgDsuDataFormat=cmgDsuDataFormat, cmgVoipRemoteMaxRtpPort=cmgVoipRemoteMaxRtpPort, cmgHardwareFanLowSpeedLevel=cmgHardwareFanLowSpeedLevel, cmgProcessRestartClear=cmgProcessRestartClear, cmgHWSuffix=cmgHWSuffix, cmgModuleInsertFault=cmgModuleInsertFault, cmgVoipAvgOccClear=cmgVoipAvgOccClear, cmgExpansionDescription=cmgExpansionDescription, cmgModuleManualReset=cmgModuleManualReset, cmgVoipRemote802Priority=cmgVoipRemote802Priority, cmgVoipChannelsInUse=cmgVoipChannelsInUse, cmgPsuFanBriefClear=cmgPsuFanBriefClear, cmgMgManualReset=cmgMgManualReset, cmgProcessor=cmgProcessor, cmgTimeslotOccupancyClear=cmgTimeslotOccupancyClear, cmgDs1Layer2Down=cmgDs1Layer2Down, cmgIccMissingFault=cmgIccMissingFault, cmgVoipTotalChannelsEnforcedByCM=cmgVoipTotalChannelsEnforcedByCM, cmgDataModuleAwohConflict=cmgDataModuleAwohConflict, cmgCrlFileSize=cmgCrlFileSize, cmgCcPulseDuration=cmgCcPulseDuration, cmgContactClosuresEntry=cmgContactClosuresEntry, cmgMACAddress=cmgMACAddress, cmgVoipFaultMask=cmgVoipFaultMask, cmgVoipRemoteRtcpParameters=cmgVoipRemoteRtcpParameters, cmgModulePostClear=cmgModulePostClear, cmgEtrStatus=cmgEtrStatus, cmgDsuInvertRxC=cmgDsuInvertRxC, cmgDhcpControllerHosts=cmgDhcpControllerHosts, PYSNMP_MODULE_ID=cmgmib, cmgVoipEchoCancellerConfig1=cmgVoipEchoCancellerConfig1, cmgModules=cmgModules, cmgAnalogPorts=cmgAnalogPorts, cmgVoipAutoResetClear=cmgVoipAutoResetClear, cmgCcRelay=cmgCcRelay, cmgProcessorQos=cmgProcessorQos, cmgETRTable=cmgETRTable, cmgVoipLocalMinRtpPort=cmgVoipLocalMinRtpPort, cmgPrimaryControllerFault=cmgPrimaryControllerFault, cmgRegistrationState=cmgRegistrationState, cmgDsuConfigTable=cmgDsuConfigTable, cmgVoipPowerClear=cmgVoipPowerClear, cmgConfigUploadFault=cmgConfigUploadFault, cmgCpuTempWarningFault=cmgCpuTempWarningFault, cmgUnsupportedMmEnrolement=cmgUnsupportedMmEnrolement, cmgCrlAccessDenied=cmgCrlAccessDenied, cmgVoipLocalRtcpMonitorIpAddress=cmgVoipLocalRtcpMonitorIpAddress, cmgVoipPowerFault=cmgVoipPowerFault, cmgDsuDataTerminalLoopback=cmgDsuDataTerminalLoopback, cmgCurrentInetAddress=cmgCurrentInetAddress, cmgPowerMgProcessor=cmgPowerMgProcessor, cmgMgBusyout=cmgMgBusyout, cmgDsuConfigEntry=cmgDsuConfigEntry, cmgEtrAdminState=cmgEtrAdminState, cmgVoip=cmgVoip, cmgModuleDescription=cmgModuleDescription, cmgModuleSerialNumber=cmgModuleSerialNumber, cmgRemoteSig802Priority=cmgRemoteSig802Priority, cmgModuleHWSuffix=cmgModuleHWSuffix, cmgVoipCoreClear=cmgVoipCoreClear, cmgEtrCurrentLoopDetect=cmgEtrCurrentLoopDetect, cmgVoipRemoteMinRtpPort=cmgVoipRemoteMinRtpPort, cmgVoipHardwareFault=cmgVoipHardwareFault, cmgAnalogEchoCancellerConfig1=cmgAnalogEchoCancellerConfig1, cmgVoipManualReset=cmgVoipManualReset, CmgModuleSlot=CmgModuleSlot, cmgETR=cmgETR, cmgCurrentInetAddressType=cmgCurrentInetAddressType, cmgActiveControllerAddress=cmgActiveControllerAddress, cmgDsuTestTable=cmgDsuTestTable, cmgVoipAverageOccupancy=cmgVoipAverageOccupancy, cmgIccAutoResetClear=cmgIccAutoResetClear, cmgTrapOnBoard=cmgTrapOnBoard, cmgSecondaryClockSource=cmgSecondaryClockSource, cmgPowerDsp=cmgPowerDsp, cmgFirmwareDownloadFault=cmgFirmwareDownloadFault, cmgVoipRemoteParameters=cmgVoipRemoteParameters, cmgAnalogPortTable=cmgAnalogPortTable, cmgVoipDspFWVersion=cmgVoipDspFWVersion, cmgTraps=cmgTraps, cmgRegistrationSuccess=cmgRegistrationSuccess, cmgTestThresholdClear=cmgTestThresholdClear, cmgEtrNumberOfPairs=cmgEtrNumberOfPairs, cmgStackPosition=cmgStackPosition, cmgDsuDSR=cmgDsuDSR, cmgVoipLocalRetryOnFailure=cmgVoipLocalRetryOnFailure, cmgDynamicCAC=cmgDynamicCAC, cmgVoipRemoteRtcpMonitorPortInetAddress=cmgVoipRemoteRtcpMonitorPortInetAddress, cmgContactClosures=cmgContactClosures)
