...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/avaya/G700-MG-MIB
...
genAppFileName, genOpLastFailureIndex, genAppFileId, genAppFileVersionNumber, genOpLastWarningDisplay = mibBuilder.importSymbols("LOAD-MIB", "genAppFileName", "genOpLastFailureIndex", "genAppFileId", "genAppFileVersionNumber", "genOpLastWarningDisplay")
...
cmgmib.setRevisions(('2015-03-23 06:00',))
if mibBuilder.loadTexts: cmgmib.setLastUpdated('201503230600Z')
...
cmgOcspAccessDenied = NotificationType((1, 3, 6, 1, 4, 1, 6889, 2, 9, 1, 5, 2, 2, 0, 162)).setObjects(("G700-MG-MIB", "cmgTrapSubsystem"), ("G700-MG-MIB", "cmgTrapOnBoard"), ("G700-MG-MIB", "cmgTrapLocation"), ("G700-MG-MIB", "cmgTrapSeverity"))
if mibBuilder.loadTexts: cmgOcspAccessDenied.setStatus('current')
...
mibBuilder.exportSymbols("G700-MG-MIB", cmgActiveControllerSoftwareVersion=cmgActiveControllerSoftwareVersion, cmgDsuDteDtrFault=cmgDsuDteDtrFault, cmgDsuFaultMask=cmgDsuFaultMask, cmgVoipCurrentInetAddressType=cmgVoipCurrentInetAddressType, cmgTimeslotUpperThreshold=cmgTimeslotUpperThreshold, cmgModuleParameterClear=cmgModuleParameterClear, cmgDsuYellowAlarmAction=cmgDsuYellowAlarmAction, cmgPrimaryControllerClear=cmgPrimaryControllerClear, cmgEtrModule=cmgEtrModule, cmgH248LinkStatus=cmgH248LinkStatus, cmgRemoteSig802Priority=cmgRemoteSig802Priority, cmgStackPosition=cmgStackPosition, cmgNoControllerClear=cmgNoControllerClear, cmgVoipLocalRsvpProfile=cmgVoipLocalRsvpProfile, cmgTestClear=cmgTestClear, cmgDsuTestTable=cmgDsuTestTable, cmgETRTable=cmgETRTable, cmgMgRelease=cmgMgRelease, cmgModuleInsertSuccess=cmgModuleInsertSuccess, cmgQosControl=cmgQosControl, cmgVoipEchoCancellerConfig1=cmgVoipEchoCancellerConfig1, cmgDsuDataRate=cmgDsuDataRate, cmgDsuReceiveClock=cmgDsuReceiveClock, cmgTrapInUseTimeslots=cmgTrapInUseTimeslots, cmgFirmwareDownloadWarning=cmgFirmwareDownloadWarning, cmgPrimarySearchTime=cmgPrimarySearchTime, cmgVoipRemoteRtcpMonitorInetAddress=cmgVoipRemoteRtcpMonitorInetAddress, cmgPsuFanProlongedClear=cmgPsuFanProlongedClear, cmgVoipLocalRtcpParameters=cmgVoipLocalRtcpParameters, g700MediaGatewayMIB=g700MediaGatewayMIB, cmgHardwareStatusMask=cmgHardwareStatusMask, cmgVoipCurrentIpAddress=cmgVoipCurrentIpAddress, cmgMgBusyout=cmgMgBusyout, cmgETREntry=cmgETREntry, cmgUseDhcpForVlan=cmgUseDhcpForVlan, cmgMgpFaultMask=cmgMgpFaultMask, cmgDsuTestMode=cmgDsuTestMode, cmgVoipEngineUseDhcp=cmgVoipEngineUseDhcp, cmgTrapVariables=cmgTrapVariables, cmgRegistrationFaultInetAddress=cmgRegistrationFaultInetAddress, cmgVoipAdminState=cmgVoipAdminState, cmgCurrentInetAddressType=cmgCurrentInetAddressType, cmgVoipFaultMask=cmgVoipFaultMask, cmgFirmwareDownloadBegun=cmgFirmwareDownloadBegun, CmgModuleSlot=CmgModuleSlot, cmgVoipLocalRtcpMonitorPort=cmgVoipLocalRtcpMonitorPort, cmgSLAMonitorServerPort=cmgSLAMonitorServerPort, cmgModuleTable=cmgModuleTable, cmgSecondaryClockSource=cmgSecondaryClockSource, cmgMemoryFault=cmgMemoryFault, cmgModuleName=cmgModuleName, cmg8260PowerFault=cmg8260PowerFault, cmgCcAdminState=cmgCcAdminState, cmgSLAMonitorState=cmgSLAMonitorState, cmgProductId=cmgProductId, cmgClockSourceControl=cmgClockSourceControl, cmgVoipMACAddress=cmgVoipMACAddress, cmgDsuPortStatusTable=cmgDsuPortStatusTable, cmgSLAMonitorServerInetAddress=cmgSLAMonitorServerInetAddress, cmgDspTempWarningClear=cmgDspTempWarningClear, cmgProcessorConfig=cmgProcessorConfig, cmgModuleList=cmgModuleList, cmgCpuTempWarningThresh=cmgCpuTempWarningThresh, cmgTraps=cmgTraps, cmgExpansionDescription=cmgExpansionDescription, cmgVoipLocalMinRtpPort=cmgVoipLocalMinRtpPort, cmgH248LinkDown=cmgH248LinkDown, PYSNMP_MODULE_ID=cmgmib, cmgIccAutoResetClear=cmgIccAutoResetClear, cmgVoipAvgOccFault=cmgVoipAvgOccFault, cmgVoipCurrentInetAddress=cmgVoipCurrentInetAddress, cmgHWSuffix=cmgHWSuffix, g700MediaGateway=g700MediaGateway, cmgVoipOccClear=cmgVoipOccClear, cmgCrlAccessDenied=cmgCrlAccessDenied, cmgDsuAutoResetClear=cmgDsuAutoResetClear, cmgMemoryClear=cmgMemoryClear, cmgDspTemp=cmgDspTemp, cmgVoipLocalRtcpReportPeriod=cmgVoipLocalRtcpReportPeriod, cmgMultipleFanClear=cmgMultipleFanClear, cmgCcPulseDuration=cmgCcPulseDuration, cmgExpansions=cmgExpansions, cmgVoipRemoteRsvpEnabled=cmgVoipRemoteRsvpEnabled, cmgSLAMonitor=cmgSLAMonitor, cmgPowerVoipComplex=cmgPowerVoipComplex, cmgVoipLocalRetryOnFailure=cmgVoipLocalRetryOnFailure, cmgDsuInvertRxD=cmgDsuInvertRxD, cmgVoipAutoResetClear=cmgVoipAutoResetClear, cmgConfigDownloadFault=cmgConfigDownloadFault, cmgTimeslotLowerThreshold=cmgTimeslotLowerThreshold, cmgSerialNumber=cmgSerialNumber, cmgVoipAvgOccClear=cmgVoipAvgOccClear, avaya=avaya, cmgH248LinkUp=cmgH248LinkUp, cmgExpansionDemandTestResult=cmgExpansionDemandTestResult, cmgVoipLocalBbeDscp=cmgVoipLocalBbeDscp, cmgCcStatus=cmgCcStatus, cmgVoipEngineReset=cmgVoipEngineReset, cmgTempShutdownFault=cmgTempShutdownFault, cmgExpansionSerialNumber=cmgExpansionSerialNumber, cmgAuxPowerFault=cmgAuxPowerFault, cmgVoipOccFault=cmgVoipOccFault, cmgChassis=cmgChassis, cmgDsuChannelAssignments=cmgDsuChannelAssignments, cmgVoipLocalMaxRtpPort=cmgVoipLocalMaxRtpPort, cmgVoipIpConfigClear=cmgVoipIpConfigClear, cmgCcRelay=cmgCcRelay, cmgUseDhcpForMgcList=cmgUseDhcpForMgcList, cmgVoipTotalChannelsEnforcedByCM=cmgVoipTotalChannelsEnforcedByCM, cmgVoipRemoteRtcpEnabled=cmgVoipRemoteRtcpEnabled, cmgDsuLoopbackPattern=cmgDsuLoopbackPattern, cmgVoipHyperactivity=cmgVoipHyperactivity, cmgMgManualReset=cmgMgManualReset, cmgModuleEntry=cmgModuleEntry, cmgDsu=cmgDsu, cmgDescription=cmgDescription, cmgControllers=cmgControllers, cmgTrapManagerControl=cmgTrapManagerControl, cmgTrapManagerTable=cmgTrapManagerTable, cmgConfigUploadSuccess=cmgConfigUploadSuccess, cmgDsuRTS=cmgDsuRTS, cmgVoipRemoteRtcpReportPeriod=cmgVoipRemoteRtcpReportPeriod, cmgDSPCoreDemandTest=cmgDSPCoreDemandTest, cmgModuleParameterFault=cmgModuleParameterFault, cmgDSPCoreTotalChannels=cmgDSPCoreTotalChannels, cmgModuleAutoResetClear=cmgModuleAutoResetClear, cmgVoipLocal802Priority=cmgVoipLocal802Priority, cmgConfigUploadBegun=cmgConfigUploadBegun, cmgTrapDefinitions=cmgTrapDefinitions, cmgVoipLocalRtcpMonitorIpAddress=cmgVoipLocalRtcpMonitorIpAddress, cmgFanPowerFault=cmgFanPowerFault, cmgVoipRemoteRetryOnFailure=cmgVoipRemoteRetryOnFailure, cmgDynamicCAC=cmgDynamicCAC, cmgDspPowerFault=cmgDspPowerFault, cmgAuxPowerClear=cmgAuxPowerClear, cmgVoipManualReset=cmgVoipManualReset, cmgDsuDteRtsClear=cmgDsuDteRtsClear, cmgVoipLocalRetryDelay=cmgVoipLocalRetryDelay, cmgSyncSignalFault=cmgSyncSignalFault, cmgDsuDteDtrClear=cmgDsuDteDtrClear, cmgClockSwitching=cmgClockSwitching, cmgDSPCoreStatus=cmgDSPCoreStatus, cmgDsuTxD=cmgDsuTxD, cmgVoipRemoteEfDscp=cmgVoipRemoteEfDscp, cmgDsuConfigTable=cmgDsuConfigTable, cmgGatewayNumber=cmgGatewayNumber, cmgVoipLocalRsvpParameters=cmgVoipLocalRsvpParameters, cmgFWVersion=cmgFWVersion, cmgProcessRestart=cmgProcessRestart, cmgModuleFaultMask=cmgModuleFaultMask, cmgDsuLL=cmgDsuLL, cmgDsuDataTerminalLoopback=cmgDsuDataTerminalLoopback, cmgVoipEchoCancellerControl=cmgVoipEchoCancellerControl, cmgDsuInvertRxC=cmgDsuInvertRxC, cmgSLAMonitorServerInetAddressType=cmgSLAMonitorServerInetAddressType, cmgAnalogPort=cmgAnalogPort, cmgTrapAvailableTimeslots=cmgTrapAvailableTimeslots, cmgPowerMgProcessor=cmgPowerMgProcessor, cmgTrapManagerEntry=cmgTrapManagerEntry, cmgSyncSignalClear=cmgSyncSignalClear, cmgAnalogEchoCancellerConfig2=cmgAnalogEchoCancellerConfig2, cmgPower8260=cmgPower8260, cmgMgpPowerClear=cmgMgpPowerClear, cmgPsuFanBriefClear=cmgPsuFanBriefClear, cmgPowerDsp=cmgPowerDsp, cmgProcessor=cmgProcessor, cmgIccAutoReset=cmgIccAutoReset, cmgPsuFanBriefFault=cmgPsuFanBriefFault, cmgFipsErrorType=cmgFipsErrorType, cmgModulePostFault=cmgModulePostFault, cmgDsuConfigEntry=cmgDsuConfigEntry, cmgDspTempWarningFault=cmgDspTempWarningFault, cmgVoipRemoteRtcpMonitorInetAddressType=cmgVoipRemoteRtcpMonitorInetAddressType, cmgCurrent802Vlan=cmgCurrent802Vlan, cmgProcessorQos=cmgProcessorQos, cmgFanPowerClear=cmgFanPowerClear, cmgModelNumber=cmgModelNumber, cmgExpansionUnits=cmgExpansionUnits, cmgDsuRL=cmgDsuRL, cmgVoipLocalEfDscp=cmgVoipLocalEfDscp, cmgModuleSerialNumber=cmgModuleSerialNumber, cmgRegistrationState=cmgRegistrationState, cmgActiveControllerAddress=cmgActiveControllerAddress, cmgVoipDSPCoreTable=cmgVoipDSPCoreTable, cmgDsuDataFormat=cmgDsuDataFormat, cmgDsuFpgaConfigureClear=cmgDsuFpgaConfigureClear, cmgConfigDownloadSuccess=cmgConfigDownloadSuccess, cmgDsuRxDClear=cmgDsuRxDClear, cmgVoipAverageOccupancy=cmgVoipAverageOccupancy, cmgTrapManagerMask=cmgTrapManagerMask, cmgFirmwareDownloadFault=cmgFirmwareDownloadFault, cmgVoipHardwareClear=cmgVoipHardwareClear, cmgTimeslotOccupancyClear=cmgTimeslotOccupancyClear, cmgTrapOnBoard=cmgTrapOnBoard, cmgDsuCTS=cmgDsuCTS, cmgActiveControllerInetAddressType=cmgActiveControllerInetAddressType, cmgVoipLocalRsvpEnabled=cmgVoipLocalRsvpEnabled, cmgFirmwareDownloadSuccess=cmgFirmwareDownloadSuccess, cmgCertErrorNearExpiry=cmgCertErrorNearExpiry, cmgVoipAutoReset=cmgVoipAutoReset, cmgDynCacRBBL=cmgDynCacRBBL, cmgVoipLocalRtcpEnabled=cmgVoipLocalRtcpEnabled, cmgHWVintage=cmgHWVintage, cmgDsuNetworkInitiatedLoopback=cmgDsuNetworkInitiatedLoopback, cmgDhcpSson=cmgDhcpSson, cmgVoipPowerFault=cmgVoipPowerFault, cmgDspTempShutdownThresh=cmgDspTempShutdownThresh, cmgContactClosuresEntry=cmgContactClosuresEntry, cmgVoipRemote802Priority=cmgVoipRemote802Priority, cmgVoipRemoteRtcpMonitorPortInetAddress=cmgVoipRemoteRtcpMonitorPortInetAddress, cmgVoipCoreFault=cmgVoipCoreFault, cmgSyncSignalWarn=cmgSyncSignalWarn, cmgmib=cmgmib, cmgDsuPortEnable=cmgDsuPortEnable, cmgDsuRLSD=cmgDsuRLSD, cmgDhcpRequestClear=cmgDhcpRequestClear, cmgVoipLocalQosParameters=cmgVoipLocalQosParameters, cmgCertErrorIdAuthentication=cmgCertErrorIdAuthentication, cmgStaticControllerHosts=cmgStaticControllerHosts, cmgModuleInsertFault=cmgModuleInsertFault, cmgEtrNumberOfPairs=cmgEtrNumberOfPairs, mibs=mibs, cmgDsuTestEntry=cmgDsuTestEntry, cmgDsuRemoteLoopback=cmgDsuRemoteLoopback, cmgCertErrorCertExpired=cmgCertErrorCertExpired, cmgModuleManualReset=cmgModuleManualReset, cmgDhcpControllerHosts=cmgDhcpControllerHosts, cmgModuleSlot=cmgModuleSlot, cmgLocalSigDscp=cmgLocalSigDscp, cmgExpansionDemandTest=cmgExpansionDemandTest, cmgEtrStatus=cmgEtrStatus, cmgVoip=cmgVoip, cmgDsuLocalDteLoopback=cmgDsuLocalDteLoopback, cmgAnalogEchoCancellerControl=cmgAnalogEchoCancellerControl, cmgSyncExcessClear=cmgSyncExcessClear, cmgDsuRing=cmgDsuRing, cmgEtrCurrentLoopDetect=cmgEtrCurrentLoopDetect, cmgModuleAutoReset=cmgModuleAutoReset, cmgDsuDteRtsFault=cmgDsuDteRtsFault, cmgDsuNearEndDataChannelLoopback=cmgDsuNearEndDataChannelLoopback, cmgVoipDspStatus=cmgVoipDspStatus, cmgDsuFarEndDataChannelLoopback=cmgDsuFarEndDataChannelLoopback, cmgVoipRemoteParameters=cmgVoipRemoteParameters, cmgVoipStaticInetAddressType=cmgVoipStaticInetAddressType, cmgAnalogReceiveGain=cmgAnalogReceiveGain, cmgETR=cmgETR, cmgExpansionUnitsTable=cmgExpansionUnitsTable, cmgDsuTxDClear=cmgDsuTxDClear, cmgActiveClockSource=cmgActiveClockSource, cmgVoipCoreClear=cmgVoipCoreClear, cmgMediaModulePowerFault=cmgMediaModulePowerFault, cmgVoipIpConfigFault=cmgVoipIpConfigFault, cmgTrapV3separator=cmgTrapV3separator, cmgVoipLocalRtcpMonitorInetAddress=cmgVoipLocalRtcpMonitorInetAddress)
mibBuilder.exportSymbols("G700-MG-MIB", cmgModuleHWVintage=cmgModuleHWVintage, cmgExpansionHWSuffix=cmgExpansionHWSuffix, cmgTimeslotAvailabilityFault=cmgTimeslotAvailabilityFault, cmgDnsServerList=cmgDnsServerList, cmgPrimaryClockSource=cmgPrimaryClockSource, cmgVoipRemoteQosParameters=cmgVoipRemoteQosParameters, cmgVoipRemoteRsvpProfile=cmgVoipRemoteRsvpProfile, cmgModuleRemove=cmgModuleRemove, cmgExpansionHWVintage=cmgExpansionHWVintage, cmgStatic802Vlan=cmgStatic802Vlan, cmgVoipLocalRtcpMonitorPortInetAddress=cmgVoipLocalRtcpMonitorPortInetAddress, cmgCrlFileSize=cmgCrlFileSize, cmgCurrentInetAddress=cmgCurrentInetAddress, cmgDsuFpgaConfigureFault=cmgDsuFpgaConfigureFault, cmgVoipRemoteRtcpMonitorPort=cmgVoipRemoteRtcpMonitorPort, cmgLocalSig802Priority=cmgLocalSig802Priority, cmgCpuTempWarningClear=cmgCpuTempWarningClear, cmgVoipEngineTable=cmgVoipEngineTable, cmgVoipRemoteBbeDscp=cmgVoipRemoteBbeDscp, cmgAnalogTransmitGain=cmgAnalogTransmitGain, cmgVoipStaticIpAddress=cmgVoipStaticIpAddress, cmgCpuTemp=cmgCpuTemp, cmgModuleType=cmgModuleType, cmgVoipLocalParameters=cmgVoipLocalParameters, cmgDspPowerClear=cmgDspPowerClear, cmgVoipLocalRtcpMonitorInetAddressType=cmgVoipLocalRtcpMonitorInetAddressType, cmgDsuReset=cmgDsuReset, cmgTrapLocation=cmgTrapLocation, cmgVoipChannelsInUse=cmgVoipChannelsInUse, cmgDsuPortInitiatedLoopback=cmgDsuPortInitiatedLoopback, cmgEtrAdminState=cmgEtrAdminState, cmgFipsErrorMode=cmgFipsErrorMode, cmgAnalogPortEntry=cmgAnalogPortEntry, cmgDataModuleAwohConflict=cmgDataModuleAwohConflict, products=products, cmgDsuFlowControl=cmgDsuFlowControl, cmgTransitionPoint=cmgTransitionPoint, cmgModuleNumberOfChannels=cmgModuleNumberOfChannels, cmgTotalSearchTime=cmgTotalSearchTime, cmgMgpPowerFault=cmgMgpPowerFault, cmgSyncSignalExcess=cmgSyncSignalExcess, cmgTestThresholdClear=cmgTestThresholdClear, cmgTrapSubsystem=cmgTrapSubsystem, cmgTimeslotMonitoring=cmgTimeslotMonitoring, cmgModuleHWSuffix=cmgModuleHWSuffix, cmgExpansionSlot=cmgExpansionSlot, cmgProcessRestartClear=cmgProcessRestartClear, cmgDsuDSR=cmgDsuDSR, cmgDspTempWarningThresh=cmgDspTempWarningThresh, cmgOcspAccessDenied=cmgOcspAccessDenied, cmgTrapTypes=cmgTrapTypes, cmgVoipQosControl=cmgVoipQosControl, cmgProcessorClock=cmgProcessorClock, cmgDsuManualReset=cmgDsuManualReset, cmgDsuSlot=cmgDsuSlot, cmgVoipRemoteRtcpParameters=cmgVoipRemoteRtcpParameters, cmgVoipRemoteMaxRtpPort=cmgVoipRemoteMaxRtpPort, cmgConfigDownloadBegun=cmgConfigDownloadBegun, cmgVoipPowerClear=cmgVoipPowerClear, cmgAnalogPorts=cmgAnalogPorts, cmgModulePostClear=cmgModulePostClear, cmgPsuFanProlongedFault=cmgPsuFanProlongedFault, cmgIccMissingClear=cmgIccMissingClear, cmgTrapModule=cmgTrapModule, cmgTimeslotAvailabilityClear=cmgTimeslotAvailabilityClear, cmgSLAMonitorPacketCaptureMode=cmgSLAMonitorPacketCaptureMode, cmgDsuInvertTxD=cmgDsuInvertTxD, cmgDnsHostname=cmgDnsHostname, cmgModuleFWVersion=cmgModuleFWVersion, cmgDsuPortStatusEntry=cmgDsuPortStatusEntry, cmgTrapSeverity=cmgTrapSeverity, cmgSyncWarnClear=cmgSyncWarnClear, cmgSLAMonitorVersion=cmgSLAMonitorVersion, cmgPrimaryControllerFault=cmgPrimaryControllerFault, cmgNoControllerFault=cmgNoControllerFault, cmgContactClosuresTable=cmgContactClosuresTable, cmgAnalogEchoCancellerConfig1=cmgAnalogEchoCancellerConfig1, cmgDSPCoreCoreId=cmgDSPCoreCoreId, cmgHWType=cmgHWType, cmgDs1Layer2Down=cmgDs1Layer2Down, cmgModuleNumberOfPorts=cmgModuleNumberOfPorts, cmgConfigUploadFault=cmgConfigUploadFault, cmgPowerMediaModules=cmgPowerMediaModules, cmgDynCacStatus=cmgDynCacStatus, cmgExpansionModelNumber=cmgExpansionModelNumber, cmgModules=cmgModules, cmgRegistrationSuccessInetAddress=cmgRegistrationSuccessInetAddress, cmgHardwareFanLowSpeedLevel=cmgHardwareFanLowSpeedLevel, cmgHardwareFaultMask=cmgHardwareFaultMask, cmgCcPort=cmgCcPort, cmgTimeslotOccupancyFault=cmgTimeslotOccupancyFault, cmgUnsupportedMmEnrolement=cmgUnsupportedMmEnrolement, cmgCcModule=cmgCcModule, cmgTestThresholdFault=cmgTestThresholdFault, cmgDsuAutoReset=cmgDsuAutoReset, cmgModuleDescription=cmgModuleDescription, cmgTestFault=cmgTestFault, cmgUseDhcpForIpAddress=cmgUseDhcpForIpAddress, cmgModuleStatusMask=cmgModuleStatusMask, cmgMultipleFanFault=cmgMultipleFanFault, cmg8260PowerClear=cmg8260PowerClear, cmgDhcpRequestFault=cmgDhcpRequestFault, cmgStaticIpAddress=cmgStaticIpAddress, cmgVoipSlot=cmgVoipSlot, cmgDSPCoreChannelsInUse=cmgDSPCoreChannelsInUse, cmgDsuTxDFault=cmgDsuTxDFault, cmgDsuStatusMask=cmgDsuStatusMask, cmgDs1Layer2Up=cmgDs1Layer2Up, CmgItuPerceivedSeverity=CmgItuPerceivedSeverity, cmgDynCacLastUpdate=cmgDynCacLastUpdate, cmgRegistrationFault=cmgRegistrationFault, cmgActiveControllerInetAddress=cmgActiveControllerInetAddress, cmgVoipHardwareFault=cmgVoipHardwareFault, cmgContactClosures=cmgContactClosures, cmgVoipDspFWVersion=cmgVoipDspFWVersion, cmgAnalogPortTable=cmgAnalogPortTable, cmgTrapManagerRowStatus=cmgTrapManagerRowStatus, cmgAnalogBalance=cmgAnalogBalance, cmgDsuDTR=cmgDsuDTR, cmgMgAutoReset=cmgMgAutoReset, cmgHardware=cmgHardware, cmgCertErrorCertRevoked=cmgCertErrorCertRevoked, cmgVoipRemoteMinRtpPort=cmgVoipRemoteMinRtpPort, cmgCurrentIpAddress=cmgCurrentIpAddress, cmgVoipRemoteRsvpParameters=cmgVoipRemoteRsvpParameters, cmgVoipEchoCancellerConfig2=cmgVoipEchoCancellerConfig2, cmgVoipEngineEntry=cmgVoipEngineEntry, cmgIccMissingFault=cmgIccMissingFault, cmgModuleReset=cmgModuleReset, cmgVoipJitterBufferSize=cmgVoipJitterBufferSize, cmgVoipStaticInetAddress=cmgVoipStaticInetAddress, cmgReset=cmgReset, cmgVoipTotalChannels=cmgVoipTotalChannels, cmgDsuInvertTxC=cmgDsuInvertTxC, cmgAnalogSlot=cmgAnalogSlot, cmgTrapOnIccMissing=cmgTrapOnIccMissing, cmgDSPCoreAdminState=cmgDSPCoreAdminState, cmgDsuRxDFailure=cmgDsuRxDFailure, cmgTrapManagerAddress=cmgTrapManagerAddress, cmgDsuPort=cmgDsuPort, cmgMACAddress=cmgMACAddress, cmgCpuTempWarningFault=cmgCpuTempWarningFault, cmgRemoteSigDscp=cmgRemoteSigDscp, cmgCpuTempShutdownThresh=cmgCpuTempShutdownThresh, cmgDsuRxD=cmgDsuRxD, cmgVoipDSPCoreEntry=cmgVoipDSPCoreEntry, cmgMediaModulePowerClear=cmgMediaModulePowerClear, cmgVoipRemoteRetryDelay=cmgVoipRemoteRetryDelay, cmgDSPCoreDemandTestResult=cmgDSPCoreDemandTestResult, cmgRegistrationSuccess=cmgRegistrationSuccess, cmgH248LinkErrorCode=cmgH248LinkErrorCode, cmgVoipRemoteRtcpMonitorIpAddress=cmgVoipRemoteRtcpMonitorIpAddress)
