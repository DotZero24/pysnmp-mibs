...
mibBuilder.exportSymbols("TPLINK-ETHERNETOAMRFICFG-MIB", ethernetOamRfiCfgTable=ethernetOamRfiCfgTable, ethernetOamRfiCfgLAG=ethernetOamRfiCfgLAG, ethernetOamRfiCfgCriticalEventNotify=ethernetOamRfiCfgCriticalEventNotify, ethernetOamRfiCfgDyingGaspNotify=ethernetOamRfiCfgDyingGaspNotify, ethernetOamRfiCfgPort=ethernetOamRfiCfgPort, ethernetOamRfiCfgEntry=ethernetOamRfiCfgEntry)
