...
mibBuilder.exportSymbols("CISCO-CCME-MIB", ccmeStatusChangeNotif=ccmeStatusChangeNotif, ciscoCcmeMIBCompliances=ciscoCcmeMIBCompliances, ccmeEphoneDnCFAllNum=ccmeEphoneDnCFAllNum, ccmeEMLogoutDirNumTag=ccmeEMLogoutDirNumTag, ccmeNightServiceDayTable=ccmeNightServiceDayTable, ccmeEphoneDnChOutBusy=ccmeEphoneDnChOutBusy, ccmeEphoneSpeedDialNumber=ccmeEphoneSpeedDialNumber, ccmeBusyTimeout=ccmeBusyTimeout, ccmeEphoneDnChDiscAtHold=ccmeEphoneDnChDiscAtHold, ccmeMohMulticastRoute=ccmeMohMulticastRoute, ccmeEMUserDirNumConfEntry=ccmeEMUserDirNumConfEntry, ccmeEphonePagingDn=ccmeEphonePagingDn, ccmePhoneFirmwareEntry=ccmePhoneFirmwareEntry, ccmeMaxConferenceNotif=ccmeMaxConferenceNotif, ccmeAfterHrsBlockDateMonth=ccmeAfterHrsBlockDateMonth, ccmeEphoneOverlayDN=ccmeEphoneOverlayDN, ccmeEphoneDnSecPref=ccmeEphoneDnSecPref, ccmeCorScope=ccmeCorScope, ccmeEphoneDnChNum=ccmeEphoneDnChNum, ccmeEphoneFastDialConfTable=ccmeEphoneFastDialConfTable, ccmeEphoneDnCFNoAnNum=ccmeEphoneDnCFNoAnNum, ccmeCorTag=ccmeCorTag, ccmeEphonePendingReset=ccmeEphonePendingReset, ccmeEphoneDnPriNum=ccmeEphoneDnPriNum, ccmeTimeFormat=ccmeTimeFormat, ccmeLoopbackDnRetryTo=ccmeLoopbackDnRetryTo, ccmeEphoneCallLegs=ccmeEphoneCallLegs, ccmeEphoneDnChOutAnswered=ccmeEphoneDnChOutAnswered, ccmeEPhoneRegFailed=ccmeEPhoneRegFailed, ccmeMohMulticastIpAddressType=ccmeMohMulticastIpAddressType, ccmeEphoneDnHuntstop=ccmeEphoneDnHuntstop, ccmeTransferPatternType=ccmeTransferPatternType, ccmeEphoneAftHrsBlkExmptEnabled=ccmeEphoneAftHrsBlkExmptEnabled, ccmeEphoneDnHuntstopCh=ccmeEphoneDnHuntstopCh, ccmeInterDigitTimeout=ccmeInterDigitTimeout, ccmeEphoneDnChInAnswered=ccmeEphoneDnChInAnswered, ccmeMIBNotifications=ccmeMIBNotifications, ccmeEphoneUsername=ccmeEphoneUsername, ccmeNightServiceDateStartHour=ccmeNightServiceDateStartHour, ccmeWebAdminSystemUser=ccmeWebAdminSystemUser, ccmeIPAddress=ccmeIPAddress, ccmeEphoneIpAddressType=ccmeEphoneIpAddressType, ccmeAfterHrsBlockDateTable=ccmeAfterHrsBlockDateTable, ccmeEphoneAddon=ccmeEphoneAddon, ccmeNightServiceChangeNotif=ccmeNightServiceChangeNotif, ccmEMUserProfileDirNumIndex=ccmEMUserProfileDirNumIndex, ccmeAfterHrsBlockPatternAllTime=ccmeAfterHrsBlockPatternAllTime, ccmeEphoneKeepAliveCnt=ccmeEphoneKeepAliveCnt, ccmeEphoneDnChStatsHistoryEntry=ccmeEphoneDnChStatsHistoryEntry, ccmeEphoneDnConfigEntry=ccmeEphoneDnConfigEntry, ccmeMwiSipSvrUnsolicitedEnabled=ccmeMwiSipSvrUnsolicitedEnabled, ccmeMwiRelay=ccmeMwiRelay, ccmeIntercomDnLabel=ccmeIntercomDnLabel, ccmePhoneFirmwareTable=ccmePhoneFirmwareTable, ccmeTransferSystem=ccmeTransferSystem, ccmeEMphoneTot=ccmeEMphoneTot, ccmeEphonePagingPolicy=ccmeEphonePagingPolicy, PYSNMP_MODULE_ID=ciscoCcmeMIB, ccmeNightServiceDayStartMin=ccmeNightServiceDayStartMin, ccmeTransferPatternTable=ccmeTransferPatternTable, ccmeActiveStatsGroupEM=ccmeActiveStatsGroupEM, ccmeAfterHrsBlockDateStartHour=ccmeAfterHrsBlockDateStartHour, ccmeEphoneTrapReason=ccmeEphoneTrapReason, ccmEMLogOutProfileDirNumIndex=ccmEMLogOutProfileDirNumIndex, ccmeEphoneUnRegThresholdExceed=ccmeEphoneUnRegThresholdExceed, ccmeNightServiceCode=ccmeNightServiceCode, ccmeNightServiceDayStartHour=ccmeNightServiceDayStartHour, ccmeCorDirection=ccmeCorDirection, ccmeLoopbackDnPrefix=ccmeLoopbackDnPrefix, ccmePhoneFirmwareIndex=ccmePhoneFirmwareIndex, ccmeEphoneTag=ccmeEphoneTag, ccmeAfterHrsBlockPatternEntry=ccmeAfterHrsBlockPatternEntry, ccmeEphoneCurrentFirmwareRev=ccmeEphoneCurrentFirmwareRev, ccmeEphoneDnType=ccmeEphoneDnType, ccmeConfigGroup=ccmeConfigGroup, ccmeEMLogoutDirNumConfEntry=ccmeEMLogoutDirNumConfEntry, ccmeFXOHookFlashEnabled=ccmeFXOHookFlashEnabled, ccmeLoopbackDnAutoCon=ccmeLoopbackDnAutoCon, ccmeEMLogoutDirNumOverlay=ccmeEMLogoutDirNumOverlay, ccmeEphoneActiveDN=ccmeEphoneActiveDN, ccmeUserLoginDeactivateTime=ccmeUserLoginDeactivateTime, ccmeEphoneMediaCapability=ccmeEphoneMediaCapability, ccmeTransferPatternEntry=ccmeTransferPatternEntry, ccmeTransferPattern=ccmeTransferPattern, ccmeActiveStatsGroup=ccmeActiveStatsGroup, ccmePhoneType=ccmePhoneType, ccmeHistoryStats=ccmeHistoryStats, ccmeNightServiceDate=ccmeNightServiceDate, ccmeConfig=ccmeConfig, ccmeWebAdminCustomerUser=ccmeWebAdminCustomerUser, ccmeEnabled=ccmeEnabled, ccmeCorTableIndex=ccmeCorTableIndex, ccmeIntercomDnExtensionNum=ccmeIntercomDnExtensionNum, ccmeEphoneDnHoldAltType=ccmeEphoneDnHoldAltType, ccmeMohMulticastPortNumber=ccmeMohMulticastPortNumber, ccmeEphoneActTable=ccmeEphoneActTable, ccmeEphoneTotRegistered=ccmeEphoneTotRegistered, ccmeVersion=ccmeVersion, ccmeKeepAliveTimeout=ccmeKeepAliveTimeout, ccmeEphoneDnChIncoming=ccmeEphoneDnChIncoming, ccmeKeyEphoneRegChangeNotif=ccmeKeyEphoneRegChangeNotif, ccmeEphoneLastError=ccmeEphoneLastError, ccmeEphoneFastDialNumber=ccmeEphoneFastDialNumber, ccmeMwiSipServerTransportType=ccmeMwiSipServerTransportType, ccmeNightServiceDayStopMin=ccmeNightServiceDayStopMin, ccmeDialplanPattern=ccmeDialplanPattern, ccmeEphonePreviousFirmwareRev=ccmeEphonePreviousFirmwareRev, ccmeEphoneButtonNumber=ccmeEphoneButtonNumber, ccmeNightServiceDateIndex=ccmeNightServiceDateIndex, ciscoCcmeMIBComplianceRev1=ciscoCcmeMIBComplianceRev1, ccmeEphoneBtnDNAssocConfEntry=ccmeEphoneBtnDNAssocConfEntry, ccmeWebGUITimeEnabled=ccmeWebGUITimeEnabled, ccmeCorStartingNumber=ccmeCorStartingNumber, ccmeConfigGroup1=ccmeConfigGroup1, ccmeNightServiceDayEntry=ccmeNightServiceDayEntry, ccmeEphoneLoginStatus=ccmeEphoneLoginStatus, ccmePhoneFirmwareRev=ccmePhoneFirmwareRev, ccmeEMUserDirNum=ccmeEMUserDirNum, ccmeEphoneNightBellSvcEnabled=ccmeEphoneNightBellSvcEnabled, ccmeEphoneTotKeyPhRegistered=ccmeEphoneTotKeyPhRegistered, ccmeMaxDirectoryNumber=ccmeMaxDirectoryNumber, ccmeEMUserProfileTag=ccmeEMUserProfileTag, ccmeDialplanAllowRegiEnabled=ccmeDialplanAllowRegiEnabled, ccmeEMUserDirNumOverlay=ccmeEMUserDirNumOverlay, ccmeCorListDefaultEnabled=ccmeCorListDefaultEnabled, ciscoCcmeMIB=ciscoCcmeMIB, ccmeNightServiceDateStopHour=ccmeNightServiceDateStopHour, ccmeDateFormat=ccmeDateFormat, ccmeEphoneDnConfigTable=ccmeEphoneDnConfigTable, ccmeCorConfTable=ccmeCorConfTable, ccmeVoiceMailNumber=ccmeVoiceMailNumber, ccmeEphoneDnMwiCapability=ccmeEphoneDnMwiCapability, ccmeEphoneDebugStatus=ccmeEphoneDebugStatus, ccmeSecondaryDialTonePrefix=ccmeSecondaryDialTonePrefix, ccmeDialplanPatternIndex=ccmeDialplanPatternIndex, ccmeIntercomDnConfTable=ccmeIntercomDnConfTable, ccmeHistoryStatsGroup=ccmeHistoryStatsGroup, ccmeAfterHrsBlockDateStartMin=ccmeAfterHrsBlockDateStartMin, ccmeEphoneTemplate=ccmeEphoneTemplate, ccmeLoopbackDnforward=ccmeLoopbackDnforward, ccmeMwiSipServerPortNumber=ccmeMwiSipServerPortNumber, ccmeEphoneRemote=ccmeEphoneRemote, ccmeNightServiceDateTable=ccmeNightServiceDateTable, ccmeIntercomDnBargeInEnabled=ccmeIntercomDnBargeInEnabled, ccmeMohFlashMulticastIPAddrType=ccmeMohFlashMulticastIPAddrType, ccmeNotifGroup=ccmeNotifGroup, ccmeAfterHrsBlockDay=ccmeAfterHrsBlockDay, ccmeMaxConferences=ccmeMaxConferences, ccmeEMLogoutDirNum=ccmeEMLogoutDirNum, ccmeDialplanExtLength=ccmeDialplanExtLength, ccmeAfterHrsBlockDateStopHour=ccmeAfterHrsBlockDateStopHour, ccmeAfterHrsBlockDayStopHour=ccmeAfterHrsBlockDayStopHour, ccmeNightServiceDayStopHour=ccmeNightServiceDayStopHour, ccmeEphoneAutoLineInEnabled=ccmeEphoneAutoLineInEnabled, ccmePortNumber=ccmePortNumber, ccmeIPAddressType=ccmeIPAddressType, ccmeEphoneAutoLineOut=ccmeEphoneAutoLineOut, ccmeLoopbackDnSuffix=ccmeLoopbackDnSuffix, ciscoCcmeMIBObjects=ciscoCcmeMIBObjects, ccmeEphoneIpAddress=ccmeEphoneIpAddress, ccmeMohFlashFile=ccmeMohFlashFile, ccmeEphonePrimaryDn=ccmeEphonePrimaryDn, ccmeEphoneSpeedDialConfTable=ccmeEphoneSpeedDialConfTable, ccmeEphoneUnRegThreshold=ccmeEphoneUnRegThreshold, ccmeLoopbackDnCodec=ccmeLoopbackDnCodec, ccmeEphoneTot=ccmeEphoneTot, ccmeMohSource=ccmeMohSource, ccmeNightServiceDateEntry=ccmeNightServiceDateEntry, ccmeAfterHrsBlockDateStopMin=ccmeAfterHrsBlockDateStopMin, ccmeEphoneRegTime=ccmeEphoneRegTime, ccmeIntercomDnAutoAnsEnabled=ccmeIntercomDnAutoAnsEnabled, ccmeEMUserDirNumConfTable=ccmeEMUserDirNumConfTable, ccmeEphoneDnChStatsHistoryTable=ccmeEphoneDnChStatsHistoryTable, ccmeEphoneBtnDNAssocConfTable=ccmeEphoneBtnDNAssocConfTable, ccmeEphoneFastDialConfEntry=ccmeEphoneFastDialConfEntry, ccmeIntercomDnTag=ccmeIntercomDnTag, ccmeEphoneDnName=ccmeEphoneDnName, ccmeAfterHrsBlockDayStartMin=ccmeAfterHrsBlockDayStartMin, ccmeDialplanPatternEntry=ccmeDialplanPatternEntry, ccmeSysNotificationReason=ccmeSysNotificationReason, ccmeMaxRedirect=ccmeMaxRedirect, ccmeNightServiceDayIndex=ccmeNightServiceDayIndex, ciscoCcmeMIBNotifs=ciscoCcmeMIBNotifs, ccmeUrlforDirectoriesBtn=ccmeUrlforDirectoriesBtn, ccmeEphoneActEntry=ccmeEphoneActEntry, ccmeEphoneTAPIClient=ccmeEphoneTAPIClient, ccmeEphoneMacAddress=ccmeEphoneMacAddress, ccmeEphoneDnChDiscAtRing=ccmeEphoneDnChDiscAtRing, ccmeEphoneFastDialName=ccmeEphoneFastDialName, ccmeEphoneSpeedDialLabel=ccmeEphoneSpeedDialLabel, ciscoCcmeMIBConform=ciscoCcmeMIBConform, ccmeNightServiceDateMonth=ccmeNightServiceDateMonth, ccmeEMLogoutDirNumConfTable=ccmeEMLogoutDirNumConfTable, ccmeLoopbackDnConfTable=ccmeLoopbackDnConfTable, ccmeEphoneKeyPhone=ccmeEphoneKeyPhone, ccmeTransferPatternIndex=ccmeTransferPatternIndex, ccmeAfterHrsBlockDateEntry=ccmeAfterHrsBlockDateEntry, ccmeEphoneDnSecNum=ccmeEphoneDnSecNum, ccmeEphoneObservedType=ccmeEphoneObservedType, ccmeMohFlashMulticastIPAddr=ccmeMohFlashMulticastIPAddr, ccmeEphoneDeviceName=ccmeEphoneDeviceName, ccmeEphoneDnChDiscAtAlert=ccmeEphoneDnChDiscAtAlert, ccmeNightServiceDateStopMin=ccmeNightServiceDateStopMin, ccmeEphoneConfEntry=ccmeEphoneConfEntry, ccmeDialplanPatternTag=ccmeDialplanPatternTag, ccmeMwiSipServerIpAddress=ccmeMwiSipServerIpAddress, ccmeEphoneFastDialTableIndex=ccmeEphoneFastDialTableIndex, ccmeEphoneDnScriptName=ccmeEphoneDnScriptName, ccmeCorConfEntry=ccmeCorConfEntry, ccmeSysTrapSeverity=ccmeSysTrapSeverity, ccmeEphoneDnChDiscAtConn=ccmeEphoneDnChDiscAtConn, ccmeMaxEphones=ccmeMaxEphones, ccmeEphoneDnHoldAltTo=ccmeEphoneDnHoldAltTo, ccmeMohMulticastFromFlashEnabled=ccmeMohMulticastFromFlashEnabled, ccmeAfterHrsBlockDateIndex=ccmeAfterHrsBlockDateIndex, ccmeUrlforServicesBtn=ccmeUrlforServicesBtn, ccmeLoopbackDnConfEntry=ccmeLoopbackDnConfEntry, ciscoCcmeMIBCompliance=ciscoCcmeMIBCompliance, ccmeEphoneRegState=ccmeEphoneRegState, ccmeEphoneDnChOutbound=ccmeEphoneDnChOutbound, ccmeEphoneDnMode=ccmeEphoneDnMode, ccmeDialplanPatternTable=ccmeDialplanPatternTable, ccmeEphoneDnCFBusyNum=ccmeEphoneDnCFBusyNum, ccmeAlertTimeout=ccmeAlertTimeout, ccmeCorListName=ccmeCorListName, ciscoCcmeMIBGroups=ciscoCcmeMIBGroups, ccmeSystemMessage=ccmeSystemMessage, ccmeEphoneDnPriPref=ccmeEphoneDnPriPref, ccmeEphoneDnChDiscCauseFarEnd=ccmeEphoneDnChDiscCauseFarEnd, ccmeEphoneKeepAlive=ccmeEphoneKeepAlive, ccmeEMphoneTotRegistered=ccmeEMphoneTotRegistered, ccmeActiveStats=ccmeActiveStats, ccmeMohMulticastIpAddress=ccmeMohMulticastIpAddress, ccmeEphoneSpeedDialTag=ccmeEphoneSpeedDialTag, ccmeWebGUIEditEnabled=ccmeWebGUIEditEnabled, ccmeNightServiceEnabled=ccmeNightServiceEnabled, ccmeEphoneConfTable=ccmeEphoneConfTable, ccmeEMUserDirNumTag=ccmeEMUserDirNumTag, ccmeDialplanExtPattern=ccmeDialplanExtPattern, ccmeAfterHrsBlockDate=ccmeAfterHrsBlockDate, ccmeConfigGroupEM=ccmeConfigGroupEM, ccmeLoopbackDnStrip=ccmeLoopbackDnStrip, ccmeNightServiceDay=ccmeNightServiceDay, ccmeAfterHrsBlockPatternTable=ccmeAfterHrsBlockPatternTable, ccmeEphoneKeepConfEnabled=ccmeEphoneKeepConfEnabled, ccmeEPhoneDeceased=ccmeEPhoneDeceased, ccmeAfterHrsBlockDayStartHour=ccmeAfterHrsBlockDayStartHour, ccmeAfterHrsBlockDayStopMin=ccmeAfterHrsBlockDayStopMin, ccmeEphoneDnDStatus=ccmeEphoneDnDStatus, ccmeEphoneLoginFailed=ccmeEphoneLoginFailed, ccmeAfterHrsBlockDayIndex=ccmeAfterHrsBlockDayIndex, CcmeNightServiceCodeString=CcmeNightServiceCodeString, ccmeAfterHrsBlockPatternTag=ccmeAfterHrsBlockPatternTag, ccmeUserAutoLogoutTo=ccmeUserAutoLogoutTo)
mibBuilder.exportSymbols("CISCO-CCME-MIB", ccmeEphoneSpeedDialConfEntry=ccmeEphoneSpeedDialConfEntry, ccmeScriptName=ccmeScriptName, ccmeEphoneDnMwiSipSubscrEnabled=ccmeEphoneDnMwiSipSubscrEnabled, ccmeAfterHrsBlockDayEntry=ccmeAfterHrsBlockDayEntry, CcmeDigitPatternString=CcmeDigitPatternString, ccmeEphoneTotKeyPhConfigured=ccmeEphoneTotKeyPhConfigured, ccmeEphoneDnChDiscCauseNearEnd=ccmeEphoneDnChDiscCauseNearEnd, ccmeEphoneDnTag=ccmeEphoneDnTag, ccmeEphoneDnLabel=ccmeEphoneDnLabel, ccmeMwiSipServerRegE164Enabled=ccmeMwiSipServerRegE164Enabled, ccmeCorVoiceRegPoolNumber=ccmeCorVoiceRegPoolNumber, ccmeMohFlashMulticastPortNum=ccmeMohFlashMulticastPortNum, ccmeAfterHrsBlockPattern=ccmeAfterHrsBlockPattern, ccmeIntercomDnConfEntry=ccmeIntercomDnConfEntry, ccmeEphoneActivityStatus=ccmeEphoneActivityStatus, ccmeMwiExpires=ccmeMwiExpires, ccmeEMLogOutProfileTag=ccmeEMLogOutProfileTag, ccmeNotificationEnable=ccmeNotificationEnable, ccmeEphoneMediaActive=ccmeEphoneMediaActive, ccmeNightServiceDateStartMin=ccmeNightServiceDateStartMin, ccmeLivefeedMohFailedNotif=ccmeLivefeedMohFailedNotif, ccmeEphoneModel=ccmeEphoneModel, ccmeCorEndingNumber=ccmeCorEndingNumber, ccmeEphoneDnCFNoAnTo=ccmeEphoneDnCFNoAnTo, ccmeEphoneSpeedDialTableIndex=ccmeEphoneSpeedDialTableIndex, ccmeLoopbackDnTag=ccmeLoopbackDnTag, ciscoCcmeMIBComplianceRev2=ciscoCcmeMIBComplianceRev2, ccmeAfterHrsBlockDayTable=ccmeAfterHrsBlockDayTable)
