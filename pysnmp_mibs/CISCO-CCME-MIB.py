...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-CCME-MIB
...
mibBuilder.exportSymbols("CISCO-CCME-MIB", ccmeLoopbackDnRetryTo=ccmeLoopbackDnRetryTo, ciscoCcmeMIBObjects=ciscoCcmeMIBObjects, ccmeLivefeedMohFailedNotif=ccmeLivefeedMohFailedNotif, ccmeEPhoneRegFailed=ccmeEPhoneRegFailed, ccmeEphoneDnConfigEntry=ccmeEphoneDnConfigEntry, ccmeEphoneFastDialConfTable=ccmeEphoneFastDialConfTable, ccmeEphoneSpeedDialConfTable=ccmeEphoneSpeedDialConfTable, ccmeEphoneDnMode=ccmeEphoneDnMode, ccmeEMLogoutDirNumConfEntry=ccmeEMLogoutDirNumConfEntry, ccmeUrlforServicesBtn=ccmeUrlforServicesBtn, ccmeMaxConferenceNotif=ccmeMaxConferenceNotif, ccmeVoiceMailNumber=ccmeVoiceMailNumber, ccmeAfterHrsBlockPatternAllTime=ccmeAfterHrsBlockPatternAllTime, ccmeMohFlashMulticastIPAddrType=ccmeMohFlashMulticastIPAddrType, ccmeDateFormat=ccmeDateFormat, ccmeEphoneKeepAliveCnt=ccmeEphoneKeepAliveCnt, ccmeDialplanPatternIndex=ccmeDialplanPatternIndex, ccmeEMLogoutDirNum=ccmeEMLogoutDirNum, ccmeLoopbackDnforward=ccmeLoopbackDnforward, ccmeCorConfEntry=ccmeCorConfEntry, ccmeMaxConferences=ccmeMaxConferences, ccmePhoneFirmwareRev=ccmePhoneFirmwareRev, ccmeEMphoneTotRegistered=ccmeEMphoneTotRegistered, ccmeEphoneDnChDiscAtConn=ccmeEphoneDnChDiscAtConn, ccmeMaxEphones=ccmeMaxEphones, ccmeSecondaryDialTonePrefix=ccmeSecondaryDialTonePrefix, ccmeEphoneActiveDN=ccmeEphoneActiveDN, ccmeEphoneCurrentFirmwareRev=ccmeEphoneCurrentFirmwareRev, ccmeNightServiceChangeNotif=ccmeNightServiceChangeNotif, ccmeEphoneDnMwiCapability=ccmeEphoneDnMwiCapability, ccmeEphoneDnChIncoming=ccmeEphoneDnChIncoming, ccmeKeyEphoneRegChangeNotif=ccmeKeyEphoneRegChangeNotif, ccmeAfterHrsBlockDateStartMin=ccmeAfterHrsBlockDateStartMin, ccmeEphoneDnConfigTable=ccmeEphoneDnConfigTable, CcmeDigitPatternString=CcmeDigitPatternString, ccmeEphoneDnChStatsHistoryEntry=ccmeEphoneDnChStatsHistoryEntry, ccmeConfigGroup1=ccmeConfigGroup1, ccmeMohMulticastRoute=ccmeMohMulticastRoute, ccmeKeepAliveTimeout=ccmeKeepAliveTimeout, ccmeCorTag=ccmeCorTag, ccmeDialplanPatternEntry=ccmeDialplanPatternEntry, ccmeLoopbackDnConfEntry=ccmeLoopbackDnConfEntry, ccmeEphoneDnScriptName=ccmeEphoneDnScriptName, ccmeSystemMessage=ccmeSystemMessage, ccmeEphoneBtnDNAssocConfEntry=ccmeEphoneBtnDNAssocConfEntry, ccmeEMLogOutProfileTag=ccmeEMLogOutProfileTag, ccmeVersion=ccmeVersion, ccmeDialplanPattern=ccmeDialplanPattern, ccmeEphonePagingDn=ccmeEphonePagingDn, ccmeEphoneFastDialTableIndex=ccmeEphoneFastDialTableIndex, ccmeCorDirection=ccmeCorDirection, ccmeEphoneDnChInAnswered=ccmeEphoneDnChInAnswered, ccmeActiveStatsGroup=ccmeActiveStatsGroup, ccmeMohMulticastPortNumber=ccmeMohMulticastPortNumber, ciscoCcmeMIB=ciscoCcmeMIB, ccmeEphoneDnChStatsHistoryTable=ccmeEphoneDnChStatsHistoryTable, ccmeNightServiceDayEntry=ccmeNightServiceDayEntry, ccmeIntercomDnBargeInEnabled=ccmeIntercomDnBargeInEnabled, ccmeNightServiceEnabled=ccmeNightServiceEnabled, ccmeEphoneSpeedDialConfEntry=ccmeEphoneSpeedDialConfEntry, ccmeEphoneFastDialNumber=ccmeEphoneFastDialNumber, ccmePhoneFirmwareTable=ccmePhoneFirmwareTable, ccmeEphoneIpAddress=ccmeEphoneIpAddress, ccmeNightServiceCode=ccmeNightServiceCode, ccmeDialplanExtLength=ccmeDialplanExtLength, ccmeEMUserDirNumTag=ccmeEMUserDirNumTag, ccmeEphoneDnPriNum=ccmeEphoneDnPriNum, ccmeEphoneTag=ccmeEphoneTag, ccmeEphoneTrapReason=ccmeEphoneTrapReason, ccmeIntercomDnAutoAnsEnabled=ccmeIntercomDnAutoAnsEnabled, ccmeEphoneDnMwiSipSubscrEnabled=ccmeEphoneDnMwiSipSubscrEnabled, ccmeMwiRelay=ccmeMwiRelay, ccmeEMUserProfileTag=ccmeEMUserProfileTag, ccmeEphoneUsername=ccmeEphoneUsername, ccmeSysTrapSeverity=ccmeSysTrapSeverity, ccmePhoneFirmwareIndex=ccmePhoneFirmwareIndex, ccmeWebAdminCustomerUser=ccmeWebAdminCustomerUser, ccmeCorEndingNumber=ccmeCorEndingNumber, ccmeTransferPatternTable=ccmeTransferPatternTable, ccmeCorVoiceRegPoolNumber=ccmeCorVoiceRegPoolNumber, ccmeEphoneConfTable=ccmeEphoneConfTable, ccmeEphoneDebugStatus=ccmeEphoneDebugStatus, ccmeEphoneDnCFNoAnTo=ccmeEphoneDnCFNoAnTo, ccmeEphoneAddon=ccmeEphoneAddon, ccmeTransferPattern=ccmeTransferPattern, ccmeEphonePendingReset=ccmeEphonePendingReset, ccmeEMphoneTot=ccmeEMphoneTot, ccmeAfterHrsBlockDateIndex=ccmeAfterHrsBlockDateIndex, ccmeBusyTimeout=ccmeBusyTimeout, ccmeLoopbackDnCodec=ccmeLoopbackDnCodec, ccmeEMUserDirNumConfEntry=ccmeEMUserDirNumConfEntry, ccmeAfterHrsBlockDateTable=ccmeAfterHrsBlockDateTable, ccmeCorConfTable=ccmeCorConfTable, ccmeLoopbackDnSuffix=ccmeLoopbackDnSuffix, ccmeIntercomDnConfTable=ccmeIntercomDnConfTable, ccmeAfterHrsBlockDateStopHour=ccmeAfterHrsBlockDateStopHour, ccmeIntercomDnExtensionNum=ccmeIntercomDnExtensionNum, ccmEMLogOutProfileDirNumIndex=ccmEMLogOutProfileDirNumIndex, ccmeEphoneDnChDiscCauseNearEnd=ccmeEphoneDnChDiscCauseNearEnd, ccmeAfterHrsBlockDayStopHour=ccmeAfterHrsBlockDayStopHour, ccmeWebGUIEditEnabled=ccmeWebGUIEditEnabled, ccmeNightServiceDateEntry=ccmeNightServiceDateEntry, ccmeNightServiceDateStartHour=ccmeNightServiceDateStartHour, ccmeAfterHrsBlockDayStartHour=ccmeAfterHrsBlockDayStartHour, ccmeLoopbackDnStrip=ccmeLoopbackDnStrip, ccmeEMLogoutDirNumOverlay=ccmeEMLogoutDirNumOverlay, ccmeLoopbackDnConfTable=ccmeLoopbackDnConfTable, ccmeEphoneTotKeyPhConfigured=ccmeEphoneTotKeyPhConfigured, ccmeNightServiceDateMonth=ccmeNightServiceDateMonth, ccmeEphoneRegState=ccmeEphoneRegState, ccmeEphoneNightBellSvcEnabled=ccmeEphoneNightBellSvcEnabled, ccmePhoneType=ccmePhoneType, ccmeCorTableIndex=ccmeCorTableIndex, ccmeMwiExpires=ccmeMwiExpires, ccmeMaxDirectoryNumber=ccmeMaxDirectoryNumber, ccmeEphoneSpeedDialTableIndex=ccmeEphoneSpeedDialTableIndex, ccmeMIBNotifications=ccmeMIBNotifications, ccmeMohMulticastFromFlashEnabled=ccmeMohMulticastFromFlashEnabled, ccmeEphoneAftHrsBlkExmptEnabled=ccmeEphoneAftHrsBlkExmptEnabled, ccmeEphoneDnHoldAltType=ccmeEphoneDnHoldAltType, ccmeMwiSipServerPortNumber=ccmeMwiSipServerPortNumber, ccmeMohFlashFile=ccmeMohFlashFile, ccmeEphoneSpeedDialNumber=ccmeEphoneSpeedDialNumber, ccmeEphoneDnType=ccmeEphoneDnType, ccmeIntercomDnConfEntry=ccmeIntercomDnConfEntry, ccmeEphoneDnChNum=ccmeEphoneDnChNum, ccmeEphoneFastDialConfEntry=ccmeEphoneFastDialConfEntry, ccmeActiveStats=ccmeActiveStats, ciscoCcmeMIBNotifs=ciscoCcmeMIBNotifs, ccmeEphoneSpeedDialTag=ccmeEphoneSpeedDialTag, ccmeEphoneDnCFAllNum=ccmeEphoneDnCFAllNum, ccmeEphoneActTable=ccmeEphoneActTable, ciscoCcmeMIBCompliance=ciscoCcmeMIBCompliance, ccmeActiveStatsGroupEM=ccmeActiveStatsGroupEM, ccmeEphoneDnChDiscAtHold=ccmeEphoneDnChDiscAtHold, ccmeDialplanPatternTable=ccmeDialplanPatternTable, ciscoCcmeMIBGroups=ciscoCcmeMIBGroups, ccmeScriptName=ccmeScriptName, ccmeEphonePagingPolicy=ccmeEphonePagingPolicy, ccmeEphoneDnDStatus=ccmeEphoneDnDStatus, ccmeMwiSipServerRegE164Enabled=ccmeMwiSipServerRegE164Enabled, ccmeIPAddress=ccmeIPAddress, ccmeMwiSipServerTransportType=ccmeMwiSipServerTransportType, ccmeEphoneMediaCapability=ccmeEphoneMediaCapability, ciscoCcmeMIBComplianceRev1=ciscoCcmeMIBComplianceRev1, ccmeMohFlashMulticastPortNum=ccmeMohFlashMulticastPortNum, ccmeEphoneSpeedDialLabel=ccmeEphoneSpeedDialLabel, ccmeEphoneMediaActive=ccmeEphoneMediaActive, ccmeEPhoneDeceased=ccmeEPhoneDeceased, ccmeCorStartingNumber=ccmeCorStartingNumber, ccmeEphoneObservedType=ccmeEphoneObservedType, ciscoCcmeMIBConform=ciscoCcmeMIBConform, ccmeEphoneLoginStatus=ccmeEphoneLoginStatus, ccmeEphoneAutoLineInEnabled=ccmeEphoneAutoLineInEnabled, ccmeEphoneTotKeyPhRegistered=ccmeEphoneTotKeyPhRegistered, ccmeNotifGroup=ccmeNotifGroup, ccmeEphoneDnSecPref=ccmeEphoneDnSecPref, ccmeEphoneModel=ccmeEphoneModel, ccmeMaxRedirect=ccmeMaxRedirect, ccmeCorListName=ccmeCorListName, ccmeEphoneUnRegThresholdExceed=ccmeEphoneUnRegThresholdExceed, PYSNMP_MODULE_ID=ciscoCcmeMIB, ccmeAfterHrsBlockPatternTag=ccmeAfterHrsBlockPatternTag, ccmeEphoneFastDialName=ccmeEphoneFastDialName, ccmeEphoneDnTag=ccmeEphoneDnTag, ccmeConfigGroup=ccmeConfigGroup, ccmeAfterHrsBlockDateStartHour=ccmeAfterHrsBlockDateStartHour, ccmeEMLogoutDirNumConfTable=ccmeEMLogoutDirNumConfTable, ccmeNightServiceDayStartMin=ccmeNightServiceDayStartMin, ccmeEphoneIpAddressType=ccmeEphoneIpAddressType, ccmeIPAddressType=ccmeIPAddressType, ccmeEphoneConfEntry=ccmeEphoneConfEntry, ccmeEphoneDnLabel=ccmeEphoneDnLabel, ccmeUrlforDirectoriesBtn=ccmeUrlforDirectoriesBtn, ccmeAfterHrsBlockDateStopMin=ccmeAfterHrsBlockDateStopMin, ccmeEphoneMacAddress=ccmeEphoneMacAddress, ccmeWebGUITimeEnabled=ccmeWebGUITimeEnabled, ccmeUserAutoLogoutTo=ccmeUserAutoLogoutTo, ccmeEMUserDirNum=ccmeEMUserDirNum, ccmeEMLogoutDirNumTag=ccmeEMLogoutDirNumTag, CcmeNightServiceCodeString=CcmeNightServiceCodeString, ccmeEphoneDnChOutbound=ccmeEphoneDnChOutbound, ccmeEphoneKeepAlive=ccmeEphoneKeepAlive, ccmeAlertTimeout=ccmeAlertTimeout, ccmeEphoneDnHuntstopCh=ccmeEphoneDnHuntstopCh, ccmeEphoneButtonNumber=ccmeEphoneButtonNumber, ccmeNightServiceDateStopMin=ccmeNightServiceDateStopMin, ccmeMwiSipSvrUnsolicitedEnabled=ccmeMwiSipSvrUnsolicitedEnabled, ccmePhoneFirmwareEntry=ccmePhoneFirmwareEntry, ccmEMUserProfileDirNumIndex=ccmEMUserProfileDirNumIndex, ccmeEphoneDnHuntstop=ccmeEphoneDnHuntstop, ccmeAfterHrsBlockDayEntry=ccmeAfterHrsBlockDayEntry, ccmeIntercomDnTag=ccmeIntercomDnTag, ccmeEphoneDnChOutBusy=ccmeEphoneDnChOutBusy, ccmeAfterHrsBlockDayStartMin=ccmeAfterHrsBlockDayStartMin, ccmeAfterHrsBlockDateMonth=ccmeAfterHrsBlockDateMonth, ccmeNightServiceDateIndex=ccmeNightServiceDateIndex, ccmePortNumber=ccmePortNumber, ccmeNightServiceDayStopMin=ccmeNightServiceDayStopMin, ccmeNightServiceDay=ccmeNightServiceDay, ccmeFXOHookFlashEnabled=ccmeFXOHookFlashEnabled, ccmeEphoneBtnDNAssocConfTable=ccmeEphoneBtnDNAssocConfTable, ccmeEphoneDnCFNoAnNum=ccmeEphoneDnCFNoAnNum, ciscoCcmeMIBCompliances=ciscoCcmeMIBCompliances, ccmeDialplanExtPattern=ccmeDialplanExtPattern, ccmeEphoneDnPriPref=ccmeEphoneDnPriPref, ccmeMwiSipServerIpAddress=ccmeMwiSipServerIpAddress, ccmeEMUserDirNumConfTable=ccmeEMUserDirNumConfTable, ccmeNightServiceDayIndex=ccmeNightServiceDayIndex, ccmeEphoneDeviceName=ccmeEphoneDeviceName, ccmeTransferSystem=ccmeTransferSystem, ccmeUserLoginDeactivateTime=ccmeUserLoginDeactivateTime, ccmeLoopbackDnAutoCon=ccmeLoopbackDnAutoCon, ccmeEphonePrimaryDn=ccmeEphonePrimaryDn, ccmeEphoneTot=ccmeEphoneTot, ccmeEphoneDnSecNum=ccmeEphoneDnSecNum, ccmeEphoneAutoLineOut=ccmeEphoneAutoLineOut, ccmeEphoneRemote=ccmeEphoneRemote, ccmeNightServiceDateStopHour=ccmeNightServiceDateStopHour, ccmeEphoneDnChOutAnswered=ccmeEphoneDnChOutAnswered, ccmeEnabled=ccmeEnabled, ccmeNightServiceDayStartHour=ccmeNightServiceDayStartHour, ccmeStatusChangeNotif=ccmeStatusChangeNotif, ccmeEphoneActivityStatus=ccmeEphoneActivityStatus, ccmeMohMulticastIpAddress=ccmeMohMulticastIpAddress, ccmeLoopbackDnPrefix=ccmeLoopbackDnPrefix, ccmeNightServiceDate=ccmeNightServiceDate, ccmeCorListDefaultEnabled=ccmeCorListDefaultEnabled, ccmeEphoneKeepConfEnabled=ccmeEphoneKeepConfEnabled, ccmeHistoryStatsGroup=ccmeHistoryStatsGroup, ccmeConfigGroupEM=ccmeConfigGroupEM, ccmeAfterHrsBlockDate=ccmeAfterHrsBlockDate, ccmeEphoneDnChDiscCauseFarEnd=ccmeEphoneDnChDiscCauseFarEnd, ccmeEphoneTotRegistered=ccmeEphoneTotRegistered, ccmeNightServiceDateStartMin=ccmeNightServiceDateStartMin, ccmeNightServiceDayStopHour=ccmeNightServiceDayStopHour, ccmeEphoneLoginFailed=ccmeEphoneLoginFailed, ccmeAfterHrsBlockDayIndex=ccmeAfterHrsBlockDayIndex, ccmeEphoneDnName=ccmeEphoneDnName, ccmeEphoneTAPIClient=ccmeEphoneTAPIClient, ccmeTransferPatternEntry=ccmeTransferPatternEntry, ccmeAfterHrsBlockPatternTable=ccmeAfterHrsBlockPatternTable, ccmeAfterHrsBlockPattern=ccmeAfterHrsBlockPattern, ccmeNotificationEnable=ccmeNotificationEnable, ccmeAfterHrsBlockPatternEntry=ccmeAfterHrsBlockPatternEntry, ccmeMohSource=ccmeMohSource, ccmeAfterHrsBlockDay=ccmeAfterHrsBlockDay, ccmeEphoneDnChDiscAtAlert=ccmeEphoneDnChDiscAtAlert, ccmeIntercomDnLabel=ccmeIntercomDnLabel, ccmeAfterHrsBlockDayStopMin=ccmeAfterHrsBlockDayStopMin, ccmeEphoneKeyPhone=ccmeEphoneKeyPhone, ccmeTransferPatternIndex=ccmeTransferPatternIndex, ccmeNightServiceDayTable=ccmeNightServiceDayTable, ccmeWebAdminSystemUser=ccmeWebAdminSystemUser)
mibBuilder.exportSymbols("CISCO-CCME-MIB", ccmeDialplanPatternTag=ccmeDialplanPatternTag, ccmeInterDigitTimeout=ccmeInterDigitTimeout, ccmeDialplanAllowRegiEnabled=ccmeDialplanAllowRegiEnabled, ccmeHistoryStats=ccmeHistoryStats, ccmeEphoneOverlayDN=ccmeEphoneOverlayDN, ccmeCorScope=ccmeCorScope, ccmeEphoneLastError=ccmeEphoneLastError, ccmeEphoneCallLegs=ccmeEphoneCallLegs, ccmeSysNotificationReason=ccmeSysNotificationReason, ccmeTimeFormat=ccmeTimeFormat, ccmeLoopbackDnTag=ccmeLoopbackDnTag, ccmeMohFlashMulticastIPAddr=ccmeMohFlashMulticastIPAddr, ccmeEphoneTemplate=ccmeEphoneTemplate, ccmeConfig=ccmeConfig, ccmeEphoneDnHoldAltTo=ccmeEphoneDnHoldAltTo, ccmeEphoneDnChDiscAtRing=ccmeEphoneDnChDiscAtRing, ciscoCcmeMIBComplianceRev2=ciscoCcmeMIBComplianceRev2, ccmeAfterHrsBlockDateEntry=ccmeAfterHrsBlockDateEntry, ccmeMohMulticastIpAddressType=ccmeMohMulticastIpAddressType, ccmeEphonePreviousFirmwareRev=ccmeEphonePreviousFirmwareRev, ccmeTransferPatternType=ccmeTransferPatternType, ccmeEphoneUnRegThreshold=ccmeEphoneUnRegThreshold, ccmeEphoneActEntry=ccmeEphoneActEntry, ccmeEphoneRegTime=ccmeEphoneRegTime, ccmeAfterHrsBlockDayTable=ccmeAfterHrsBlockDayTable, ccmeNightServiceDateTable=ccmeNightServiceDateTable, ccmeEphoneDnCFBusyNum=ccmeEphoneDnCFBusyNum, ccmeEMUserDirNumOverlay=ccmeEMUserDirNumOverlay)
