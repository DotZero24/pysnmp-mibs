# SNMP MIB module (EDGECORE-SMON-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/edgecore/EDGECORE-SMON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:52:48 2025
...
rlPortCopyMibVersion = _RlPortCopyMibVersion_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 84, 1),
...
rlPortCopySupport = _RlPortCopySupport_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 84, 2),
...
rlPortCopyVlanTaggingTable = _RlPortCopyVlanTaggingTable_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 84, 3)
)
if mibBuilder.loadTexts:
...
rlPortCopyVlanTaggingEntry = _RlPortCopyVlanTaggingEntry_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 84, 3, 1)
)
...
rlPortCopyVlanTagging = _RlPortCopyVlanTagging_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 84, 3, 1, 1),
...
rlPortCopyMode = _RlPortCopyMode_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 84, 4),
