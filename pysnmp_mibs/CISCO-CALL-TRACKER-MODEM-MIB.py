...
mibBuilder.exportSymbols("CISCO-CALL-TRACKER-MODEM-MIB", cctmHistorySupportedDC=cctmHistorySupportedDC, cctmActiveTxHighWatermark=cctmActiveTxHighWatermark, cctmActiveRxHighWatermark=cctmActiveRxHighWatermark, cctmActiveEntry=cctmActiveEntry, cctmXHistoryConstellation=cctmXHistoryConstellation, cctmMIBObjects=cctmMIBObjects, cctmActiveRetrainFailures=cctmActiveRetrainFailures, cctmHistoryLocalDownRateShifts=cctmHistoryLocalDownRateShifts, cctmHistoryProjectedMaxTxRate=cctmHistoryProjectedMaxTxRate, cctmActiveInitialModulation=cctmActiveInitialModulation, cctmHistoryRetrainFailures=cctmHistoryRetrainFailures, cctmXHistoryEntry=cctmXHistoryEntry, cctmHistoryEntry=cctmHistoryEntry, cctmXHistoryTable=cctmXHistoryTable, cctmHistoryTxHighWatermark=cctmHistoryTxHighWatermark, cctmActiveECLinkTimeouts=cctmActiveECLinkTimeouts, cctmHistoryRemoteDownRateShifts=cctmHistoryRemoteDownRateShifts, cctmHistoryInitialModulation=cctmHistoryInitialModulation, cctmActiveRxECFramesBad=cctmActiveRxECFramesBad, cctmXHistoryV90Failure=cctmXHistoryV90Failure, cctmActiveDataCompression=cctmActiveDataCompression, cctmActiveECProtocol=cctmActiveECProtocol, cctmHistoryDisconnectReason=cctmHistoryDisconnectReason, cctmMIBGroups=cctmMIBGroups, cctmHistoryLocalRetrains=cctmHistoryLocalRetrains, cctmHistoryRxECFrames=cctmHistoryRxECFrames, cctmActiveTxLinkOctets=cctmActiveTxLinkOctets, PYSNMP_MODULE_ID=ciscoCallTrackerModemMIB, CctmModulation=CctmModulation, cctmHistoryECFramesResent=cctmHistoryECFramesResent, cctmActiveGroup=cctmActiveGroup, cctmXHistoryTxLevel=cctmXHistoryTxLevel, ciscoCallTrackerModemMIB=ciscoCallTrackerModemMIB, cctmHistory=cctmHistory, cctmActiveModulation=cctmActiveModulation, cctmActiveRxECFrames=cctmActiveRxECFrames, cctmActiveRemoteRetrains=cctmActiveRemoteRetrains, cctmHistoryRxHighWatermark=cctmHistoryRxHighWatermark, cctmHistoryRemoteRetrains=cctmHistoryRemoteRetrains, cctmActiveLocalRetrains=cctmActiveLocalRetrains, cctmHistoryFinalRxRate=cctmHistoryFinalRxRate, cctmXHistoryV90ClientId=cctmXHistoryV90ClientId, cctmActiveRateShiftFailures=cctmActiveRateShiftFailures, cctmXHistoryGroup=cctmXHistoryGroup, cctmMIBNotificationPrefix=cctmMIBNotificationPrefix, cctmHistoryTxLowWatermark=cctmHistoryTxLowWatermark, cctmActiveECFramesResent=cctmActiveECFramesResent, cctmHistoryRateShiftFailures=cctmHistoryRateShiftFailures, cctmActiveRemoteDownRateShifts=cctmActiveRemoteDownRateShifts, cctmXHistoryRxECWindowSize=cctmXHistoryRxECWindowSize, cctmActiveAttemptedModulation=cctmActiveAttemptedModulation, cctmActiveRxRate=cctmActiveRxRate, cctmHistoryFinalModulation=cctmHistoryFinalModulation, cctmHistoryRxLowWatermark=cctmHistoryRxLowWatermark, cctmActiveTxECNAKs=cctmActiveTxECNAKs, cctmActiveTable=cctmActiveTable, cctmHistoryTable=cctmHistoryTable, cctmHistoryRxLinkOctets=cctmHistoryRxLinkOctets, cctmMIBCompliances=cctmMIBCompliances, cctmActiveProjectedMaxTxRate=cctmActiveProjectedMaxTxRate, cctmHistoryDataCompression=cctmHistoryDataCompression, cctmXHistoryTxECWindowSize=cctmXHistoryTxECWindowSize, cctmHistoryTxECFrames=cctmHistoryTxECFrames, cctmHistoryTxLinkOctets=cctmHistoryTxLinkOctets, cctmActiveProjectedMaxRxRate=cctmActiveProjectedMaxRxRate, cctmHistoryGroup=cctmHistoryGroup, cctmMIBConformance=cctmMIBConformance, cctmActiveLocalDownRateShifts=cctmActiveLocalDownRateShifts, cctmHistoryAttemptedModulation=cctmHistoryAttemptedModulation, cctmActiveTxLowWatermark=cctmActiveTxLowWatermark, cctmHistoryRemoteUpRateShifts=cctmHistoryRemoteUpRateShifts, CctmECProtocol=CctmECProtocol, cctmActiveLocalUpRateShifts=cctmActiveLocalUpRateShifts, cctmHistoryRxECNAKs=cctmHistoryRxECNAKs, cctmActiveRxCharLost=cctmActiveRxCharLost, cctmHistoryECProtocol=cctmHistoryECProtocol, cctmHistoryFinalTxRate=cctmHistoryFinalTxRate, CctmDataCompression=CctmDataCompression, cctmHistoryECLinkTimeouts=cctmHistoryECLinkTimeouts, cctmActiveRemoteUpRateShifts=cctmActiveRemoteUpRateShifts, cctmHistoryTxECNAKs=cctmHistoryTxECNAKs, cctmActiveRxECNAKs=cctmActiveRxECNAKs, cctmXHistoryRxLevel=cctmXHistoryRxLevel, cctmXHistoryV90Status=cctmXHistoryV90Status, cctmHistoryRxECFramesBad=cctmHistoryRxECFramesBad, cctmXHistoryRxECInfoFrameSize=cctmXHistoryRxECInfoFrameSize, cctmHistoryProjectedMaxRxRate=cctmHistoryProjectedMaxRxRate, cctmActive=cctmActive, cctmXHistoryTxECInfoFrameSize=cctmXHistoryTxECInfoFrameSize, cctmActiveTxRate=cctmActiveTxRate, cctmHistoryAttemptedECProtocol=cctmHistoryAttemptedECProtocol, cctmMIBCompliance=cctmMIBCompliance, cctmActiveAttemptedECProtocol=cctmActiveAttemptedECProtocol, cctmActiveSupportedDC=cctmActiveSupportedDC, cctmHistoryDisconnectReasonText=cctmHistoryDisconnectReasonText, cctmXHistoryECWindowClosures=cctmXHistoryECWindowClosures, cctmHistoryLocalUpRateShifts=cctmHistoryLocalUpRateShifts, cctmMIBNotifications=cctmMIBNotifications, cctmActiveRxLinkOctets=cctmActiveRxLinkOctets, cctmActiveRxLowWatermark=cctmActiveRxLowWatermark, cctmActiveTxECFrames=cctmActiveTxECFrames, cctmHistoryRxCharLost=cctmHistoryRxCharLost)
