...
h3cAAANasIdObjects=_H3cAAANasIdObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,114,1))
_H3cAAANasIdTable_Object=MibTable
h3cAAANasIdTable=_H3cAAANasIdTable_Object((1,3,6,1,4,1,2011,10,2,114,1,1))
if mibBuilder.loadTexts:h3cAAANasIdTable.setStatus(_A)
_H3cAAANasIdEntry_Object=MibTableRow
h3cAAANasIdEntry=_H3cAAANasIdEntry_Object((1,3,6,1,4,1,2011,10,2,114,1,1,1))
...
h3cAAANasIdName=_H3cAAANasIdName_Object((1,3,6,1,4,1,2011,10,2,114,1,1,1,1),_H3cAAANasIdName_Type())
