...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-GGSN-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:43:20 2025
...
_CGgsnExtPrepaidStandAlone_Type.__name__ = "TruthValue"
...
_CGgsnExtRedundancyEnabled_Type.__name__ = "TruthValue"
...
_CGgsnExtTraceNotifEnable_Type.__name__ = "TruthValue"
...
cGgsnExtMIBCompliance.setObjects(
      *(("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatusGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtConfigurationsGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtThruputGroup"))
)
if mibBuilder.loadTexts:
...
cGgsnExtMIBComplianceRev1.setObjects(
      *(("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroupRev1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatusGroupRev1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtConfigurationsGroupRev1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtThruputGroup"))
)
if mibBuilder.loadTexts:
...
cGgsnExtMIBComplianceRev2.setObjects(
      *(("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroupRev1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatusGroupRev1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtConfigurationsGroupRev1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtThruputGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtConfigurationsGroupRev1Sup1"))
)
if mibBuilder.loadTexts:
...
cGgsnExtMIBComplianceRev3.setObjects(
      *(("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtThruputGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtConfigurationsGroupRev1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroupRev1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtConfigurationsGroupRev1Sup1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroupSup1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatusGroupSup1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatusGroupRev1"))
)
if mibBuilder.loadTexts:
...
cGgsnExtMIBComplianceRev4.setObjects(
      *(("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtThruputGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtConfigurationsGroupRev1"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroupRev1"),
        ...
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtConfigurationsGroupRev1Sup2"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroupSup2"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtNotificationsGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtNotificationInfoGroup"),
        ("CISCO-GGSN-EXT-MIB", "cGgsnExtStatisticsGroupSup3"))
)
if mibBuilder.loadTexts:
