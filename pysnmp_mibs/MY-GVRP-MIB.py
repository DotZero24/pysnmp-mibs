...
myVlanMIBObjects,=mibBuilder.importSymbols('MY-VLAN-MIB','myVlanMIBObjects')
...
myGvrpMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,25))
if mibBuilder.loadTexts:myGvrpMIB.setRevisions(('2002-03-20 00:00',))
_MyVlanIfStateTable_Object=MibTable
myVlanIfStateTable=_MyVlanIfStateTable_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,6))
if mibBuilder.loadTexts:myVlanIfStateTable.setStatus(_A)
_MyVlanIfStateEntry_Object=MibTableRow
myVlanIfStateEntry=_MyVlanIfStateEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,6,1))
...
myVlanIfStateVid=_MyVlanIfStateVid_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,6,1,1),_MyVlanIfStateVid_Type())
...
myVlanIfStateIndex=_MyVlanIfStateIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,6,1,2),_MyVlanIfStateIndex_Type())
...
myVlanIfState=_MyVlanIfState_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,6,1,3),_MyVlanIfState_Type())
myVlanIfState.setMaxAccess(_C)
if mibBuilder.loadTexts:myVlanIfState.setStatus(_A)
_MyVlanDynTable_Object=MibTable
myVlanDynTable=_MyVlanDynTable_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,7))
if mibBuilder.loadTexts:myVlanDynTable.setStatus(_A)
_MyVlanDynEntry_Object=MibTableRow
myVlanDynEntry=_MyVlanDynEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,7,1))
...
myVlanDynVID=_MyVlanDynVID_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,7,1,1),_MyVlanDynVID_Type())
...
myVlanDynPortMemberAction=_MyVlanDynPortMemberAction_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,7,1,2),_MyVlanDynPortMemberAction_Type())
...
myVlanDynApMemberAction=_MyVlanDynApMemberAction_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,7,1,3),_MyVlanDynApMemberAction_Type())
...
myVlanDynAlias=_MyVlanDynAlias_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,7,1,4),_MyVlanDynAlias_Type())
...
myVlanDynEntryStatus=_MyVlanDynEntryStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,9,1,7,1,5),_MyVlanDynEntryStatus_Type())
...
myGvrpMIBObjects=_MyGvrpMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,25,1))
class _MyGvrpStatus_Type(EnabledStatus):defaultValue=2
_MyGvrpStatus_Type.__name__=_E
_MyGvrpStatus_Object=MibScalar
myGvrpStatus=_MyGvrpStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,1),_MyGvrpStatus_Type())
...
myGvrpDynamicVlanCreateStauts=_MyGvrpDynamicVlanCreateStauts_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,2),_MyGvrpDynamicVlanCreateStauts_Type())
...
myGvrpJoinTimer=_MyGvrpJoinTimer_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,3),_MyGvrpJoinTimer_Type())
...
myGvrpLeaveTimer=_MyGvrpLeaveTimer_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,4),_MyGvrpLeaveTimer_Type())
...
myGvrpLeaveAllTimer=_MyGvrpLeaveAllTimer_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,5),_MyGvrpLeaveAllTimer_Type())
myGvrpLeaveAllTimer.setMaxAccess(_D)
if mibBuilder.loadTexts:myGvrpLeaveAllTimer.setStatus(_A)
_MyGvrpTable_Object=MibTable
myGvrpTable=_MyGvrpTable_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,6))
if mibBuilder.loadTexts:myGvrpTable.setStatus(_A)
_MyGvrpEntry_Object=MibTableRow
myGvrpEntry=_MyGvrpEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,6,1))
...
myGvrpIfIndex=_MyGvrpIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,6,1,1),_MyGvrpIfIndex_Type())
...
myGvrpRegistrationMode=_MyGvrpRegistrationMode_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,6,1,2),_MyGvrpRegistrationMode_Type())
...
myGvrpApplicantState=_MyGvrpApplicantState_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,6,1,3),_MyGvrpApplicantState_Type())
...
myGvrpStatsTable=_MyGvrpStatsTable_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7))
if mibBuilder.loadTexts:myGvrpStatsTable.setStatus(_A)
_MyGvrpStatsEntry_Object=MibTableRow
myGvrpStatsEntry=_MyGvrpStatsEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1))
...
myGvrpStatsIfIndex=_MyGvrpStatsIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,1),_MyGvrpStatsIfIndex_Type())
...
myGvrpRecValidGvrpPdu=_MyGvrpRecValidGvrpPdu_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,2),_MyGvrpRecValidGvrpPdu_Type())
...
myGvrpRecInvalidGvrpPdu=_MyGvrpRecInvalidGvrpPdu_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,3),_MyGvrpRecInvalidGvrpPdu_Type())
...
myGvrpRecJoin=_MyGvrpRecJoin_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,4),_MyGvrpRecJoin_Type())
...
myGvrpRecJoinIn=_MyGvrpRecJoinIn_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,5),_MyGvrpRecJoinIn_Type())
...
myGvrpRecEmpty=_MyGvrpRecEmpty_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,6),_MyGvrpRecEmpty_Type())
...
myGvrpRecLeaveEmpty=_MyGvrpRecLeaveEmpty_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,7),_MyGvrpRecLeaveEmpty_Type())
...
myGvrpRecLeaveIn=_MyGvrpRecLeaveIn_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,8),_MyGvrpRecLeaveIn_Type())
...
myGvrpRecLeaveAll=_MyGvrpRecLeaveAll_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,9),_MyGvrpRecLeaveAll_Type())
...
myGvrpSentGvrpPdu=_MyGvrpSentGvrpPdu_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,10),_MyGvrpSentGvrpPdu_Type())
...
myGvrpSentJoin=_MyGvrpSentJoin_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,11),_MyGvrpSentJoin_Type())
...
myGvrpSentJoinIn=_MyGvrpSentJoinIn_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,12),_MyGvrpSentJoinIn_Type())
...
myGvrpSentEmpty=_MyGvrpSentEmpty_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,13),_MyGvrpSentEmpty_Type())
...
myGvrpSentLeaveEmpty=_MyGvrpSentLeaveEmpty_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,14),_MyGvrpSentLeaveEmpty_Type())
...
myGvrpSentLeaveIn=_MyGvrpSentLeaveIn_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,15),_MyGvrpSentLeaveIn_Type())
...
myGvrpSentLeaveAll=_MyGvrpSentLeaveAll_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,16),_MyGvrpSentLeaveAll_Type())
...
myGvrpJoinIndicated=_MyGvrpJoinIndicated_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,17),_MyGvrpJoinIndicated_Type())
...
myGvrpLeaveIndicated=_MyGvrpLeaveIndicated_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,18),_MyGvrpLeaveIndicated_Type())
...
myGvrpJoinPropagated=_MyGvrpJoinPropagated_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,19),_MyGvrpJoinPropagated_Type())
...
myGvrpLeavePropagated=_MyGvrpLeavePropagated_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,20),_MyGvrpLeavePropagated_Type())
...
myGvrpStatisticsPortClear=_MyGvrpStatisticsPortClear_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,7,1,21),_MyGvrpStatisticsPortClear_Type())
...
myGvrpOperVid=_MyGvrpOperVid_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,8),_MyGvrpOperVid_Type())
...
myGvrpStatisticsClear=_MyGvrpStatisticsClear_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,9),_MyGvrpStatisticsClear_Type())
...
myGvrpResetTimer=_MyGvrpResetTimer_Object((1,3,6,1,4,1,4881,1,1,10,2,25,1,10),_MyGvrpResetTimer_Type())
...
myGvrpMIBConformance=_MyGvrpMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,25,2))
_MyGvrpMIBCompliances_ObjectIdentity=ObjectIdentity
myGvrpMIBCompliances=_MyGvrpMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,25,2,1))
_MyGvrpMIBGroups_ObjectIdentity=ObjectIdentity
myGvrpMIBGroups=_MyGvrpMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,25,2,2))
myGvrpMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,25,2,2,1))
...
myGvrpStatsMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,25,2,2,2))
...
myGvrpMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,25,2,1,1))
