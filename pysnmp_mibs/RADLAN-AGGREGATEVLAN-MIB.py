...
rlAggregateVlanMibVersion=_RlAggregateVlanMibVersion_Object((1,3,6,1,4,1,89,73,1),_RlAggregateVlanMibVersion_Type())
...
rlAggregateVlanTable=_RlAggregateVlanTable_Object((1,3,6,1,4,1,89,73,2))
if mibBuilder.loadTexts:rlAggregateVlanTable.setStatus(_A)
_RlAggregateVlanEntry_Object=MibTableRow
rlAggregateVlanEntry=_RlAggregateVlanEntry_Object((1,3,6,1,4,1,89,73,2,1))
...
rlAggregateVlanIndex=_RlAggregateVlanIndex_Object((1,3,6,1,4,1,89,73,2,1,1),_RlAggregateVlanIndex_Type())
...
rlAggregateVlanName=_RlAggregateVlanName_Object((1,3,6,1,4,1,89,73,2,1,2),_RlAggregateVlanName_Type())
...
rlAggregateVlanPhysAddressType=_RlAggregateVlanPhysAddressType_Object((1,3,6,1,4,1,89,73,2,1,3),_RlAggregateVlanPhysAddressType_Type())
...
rlAggregateVlanStatus=_RlAggregateVlanStatus_Object((1,3,6,1,4,1,89,73,2,1,4),_RlAggregateVlanStatus_Type())
...
rlAggregateSubVlanTable=_RlAggregateSubVlanTable_Object((1,3,6,1,4,1,89,73,3))
if mibBuilder.loadTexts:rlAggregateSubVlanTable.setStatus(_A)
_RlAggregateSubVlanEntry_Object=MibTableRow
rlAggregateSubVlanEntry=_RlAggregateSubVlanEntry_Object((1,3,6,1,4,1,89,73,3,1))
...
rlAggregateSubVlanIfIndex=_RlAggregateSubVlanIfIndex_Object((1,3,6,1,4,1,89,73,3,1,1),_RlAggregateSubVlanIfIndex_Type())
...
rlAggregateSubVlanStatus=_RlAggregateSubVlanStatus_Object((1,3,6,1,4,1,89,73,3,1,2),_RlAggregateSubVlanStatus_Type())
...
rlAggregateVlanArpProxy=_RlAggregateVlanArpProxy_Object((1,3,6,1,4,1,89,73,4),_RlAggregateVlanArpProxy_Type())
