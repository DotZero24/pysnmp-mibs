# SNMP MIB module (FOUNDRY-IP-SOURCE-GUARD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/brocade/FOUNDRY-IP-SOURCE-GUARD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:02:27 2025
...
fdryIpSrcGuardPortVlanConfigEntry.setIndexNames(
    (0, "FOUNDRY-IP-SOURCE-GUARD-MIB", "fdryIpSrcGuardPortVlanPortId"),
    (0, "FOUNDRY-IP-SOURCE-GUARD-MIB", "fdryIpSrcGuardPortVlanVlanId"),
)
if mibBuilder.loadTexts:
...
fdryIpSrcGuardBindEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "FOUNDRY-IP-SOURCE-GUARD-MIB", "fdryIpSrcGuardBindIpAddr"),
)
if mibBuilder.loadTexts:
