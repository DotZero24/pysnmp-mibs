# SNMP MIB module (ARECA-SATA-CARD3-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/areca/ARECA-SATA-CARD3-MIB
...
hwControllerBoardPowerEntry = _HwControllerBoardPowerEntry_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 2, 7, 1)
)
hwControllerBoardPowerEntry.setIndexNames(
    (0, "ARECA-SATA-CARD3-MIB", "hwControllerBoardPowerIndex"),
)
if mibBuilder.loadTexts:
...
hwControllerBoardVolEntry = _HwControllerBoardVolEntry_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 2, 8, 1)
)
hwControllerBoardVolEntry.setIndexNames(
    (0, "ARECA-SATA-CARD3-MIB", "hwControllerBoardVolIndex"),
)
if mibBuilder.loadTexts:
...
hwControllerBoardFanEntry = _HwControllerBoardFanEntry_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 2, 9, 1)
)
hwControllerBoardFanEntry.setIndexNames(
    (0, "ARECA-SATA-CARD3-MIB", "hwControllerBoardFanIndex"),
)
if mibBuilder.loadTexts:
...
hwControllerBoardTempEntry = _HwControllerBoardTempEntry_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 2, 10, 1)
)
hwControllerBoardTempEntry.setIndexNames(
    (0, "ARECA-SATA-CARD3-MIB", "hwControllerBoardTempIndex"),
)
if mibBuilder.loadTexts:
...
hwControllerBoardTempIndex = _HwControllerBoardTempIndex_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 2, 10, 1, 1),
...
hwControllerBoardTempDesc = _HwControllerBoardTempDesc_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 2, 10, 1, 2),
...
hwControllerBoardTempValue = _HwControllerBoardTempValue_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 2, 10, 1, 3),
...
volSCSILUN = _VolSCSILUN_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 5, 1, 1, 10),
    _VolSCSILUN_Type()
)
...
volRaidLevel = _VolRaidLevel_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 5, 1, 1, 11),
    _VolRaidLevel_Type()
)
...
volStripes = _VolStripes_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 5, 1, 1, 12),
    _VolStripes_Type()
)
...
volDisks = _VolDisks_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 5, 1, 1, 13),
    _VolDisks_Type()
)
...
volCache = _VolCache_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 5, 1, 1, 14),
    _VolCache_Type()
)
...
volTag = _VolTag_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 5, 1, 1, 15),
    _VolTag_Type()
)
...
volMaxSpeed = _VolMaxSpeed_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 5, 1, 1, 16),
    _VolMaxSpeed_Type()
)
...
volCurrentSpeed = _VolCurrentSpeed_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 5, 1, 1, 17),
...
rsCreate = NotificationType(
    (1, 3, 6, 1, 4, 1, 18928, 1, 3, 7, 0, 128)
)
rsCreate.setObjects(
    ("ARECA-SATA-CARD3-MIB", "eventString")
)
if mibBuilder.loadTexts:
    rsCreate.setStatus(
        ""
...
mibBuilder.exportSymbols(
    "ARECA-SATA-CARD3-MIB",
    **{"areca": areca,
       "arecaGroup1": arecaGroup1,
       "sataRaidCard3": sataRaidCard3,
