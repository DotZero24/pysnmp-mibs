...
# Notes
# -----
# ASN.1 source file://mibs/fortinet/FORTINET-FORTIANALYZER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:21:52 2025
...
faMIBCompliance.setObjects(
      *(("FORTINET-FORTIANALYZER-MIB", "faSystemComplianceGroup"),
        ("FORTINET-FORTIANALYZER-MIB", "faSessionComplianceGroup"),
        ("FORTINET-FORTIANALYZER-MIB", "faMiscComplianceGroup"),
        ("FORTINET-FORTIANALYZER-MIB", "faTrapsComplianceGroup"),
        ("FORTINET-FORTIANALYZER-MIB", "faNotificationObjectsComplianceGroup"))
)
if mibBuilder.loadTexts:
...
faObsoleteMIBCompliance.setObjects(
    ("FORTINET-FORTIANALYZER-MIB", "faHwSensorComplianceGroup")
)
if mibBuilder.loadTexts:
