...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-SECURITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:50:05 2025
...
_TmnxSecurityMGCompliances_ObjectIdentity = ObjectIdentity
tmnxSecurityMGCompliances = _TmnxSecurityMGCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 3)
)
_TmnxSecurityMobileGatewayGroups_ObjectIdentity = ObjectIdentity
tmnxSecurityMobileGatewayGroups = _TmnxSecurityMobileGatewayGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 4)
)
...
class _TmnxUserProfileSshLimit_Type(TmnxSessionLimit):
    """Custom type tmnxUserProfileSshLimit based on TmnxSessionLimit"""
    defaultValue = -1


_TmnxUserProfileSshLimit_Type.__name__ = "TmnxSessionLimit"
_TmnxUserProfileSshLimit_Object = MibTableColumn
tmnxUserProfileSshLimit = _TmnxUserProfileSshLimit_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 6),
    _TmnxUserProfileSshLimit_Type()
)
tmnxUserProfileSshLimit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileSshLimit.setStatus("current")


class _TmnxUserProfileTelnetLimit_Type(TmnxSessionLimit):
    """Custom type tmnxUserProfileTelnetLimit based on TmnxSessionLimit"""
    defaultValue = -1


_TmnxUserProfileTelnetLimit_Type.__name__ = "TmnxSessionLimit"
_TmnxUserProfileTelnetLimit_Object = MibTableColumn
tmnxUserProfileTelnetLimit = _TmnxUserProfileTelnetLimit_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 7),
    _TmnxUserProfileTelnetLimit_Type()
)
tmnxUserProfileTelnetLimit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileTelnetLimit.setStatus("current")


class _TmnxUserProfileTotalLimit_Type(TmnxSessionLimit):
    """Custom type tmnxUserProfileTotalLimit based on TmnxSessionLimit"""
    defaultValue = -1


_TmnxUserProfileTotalLimit_Type.__name__ = "TmnxSessionLimit"
_TmnxUserProfileTotalLimit_Object = MibTableColumn
tmnxUserProfileTotalLimit = _TmnxUserProfileTotalLimit_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 8),
    _TmnxUserProfileTotalLimit_Type()
)
tmnxUserProfileTotalLimit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileTotalLimit.setStatus("current")


class _TmnxUserProfileCliSessionGroup_Type(TNamedItemOrEmpty):
    """Custom type tmnxUserProfileCliSessionGroup based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxUserProfileCliSessionGroup_Type.__name__ = "TNamedItemOrEmpty"
_TmnxUserProfileCliSessionGroup_Object = MibTableColumn
tmnxUserProfileCliSessionGroup = _TmnxUserProfileCliSessionGroup_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 9),
    _TmnxUserProfileCliSessionGroup_Type()
)
tmnxUserProfileCliSessionGroup.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileCliSessionGroup.setStatus("current")


class _TmnxUserProfileNCLock_Type(TruthValue):
    """Custom type tmnxUserProfileNCLock based on TruthValue"""
    defaultValue = 2


_TmnxUserProfileNCLock_Type.__name__ = "TruthValue"
_TmnxUserProfileNCLock_Object = MibTableColumn
tmnxUserProfileNCLock = _TmnxUserProfileNCLock_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 10),
    _TmnxUserProfileNCLock_Type()
)
tmnxUserProfileNCLock.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileNCLock.setStatus("current")


class _TmnxUserProfileGrpcAuthGet_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthGet based on TProfileGrpcRpcAuth"""
    defaultValue = 1


_TmnxUserProfileGrpcAuthGet_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthGet_Object = MibTableColumn
tmnxUserProfileGrpcAuthGet = _TmnxUserProfileGrpcAuthGet_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 11),
    _TmnxUserProfileGrpcAuthGet_Type()
)
tmnxUserProfileGrpcAuthGet.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthGet.setStatus("current")


class _TmnxUserProfileGrpcAuthSet_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthSet based on TProfileGrpcRpcAuth"""
    defaultValue = 1


_TmnxUserProfileGrpcAuthSet_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthSet_Object = MibTableColumn
tmnxUserProfileGrpcAuthSet = _TmnxUserProfileGrpcAuthSet_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 12),
    _TmnxUserProfileGrpcAuthSet_Type()
)
tmnxUserProfileGrpcAuthSet.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthSet.setStatus("current")


class _TmnxUserProfileGrpcAuthSubscribe_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthSubscribe based on TProfileGrpcRpcAuth"""
    defaultValue = 1


_TmnxUserProfileGrpcAuthSubscribe_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthSubscribe_Object = MibTableColumn
tmnxUserProfileGrpcAuthSubscribe = _TmnxUserProfileGrpcAuthSubscribe_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 13),
    _TmnxUserProfileGrpcAuthSubscribe_Type()
)
tmnxUserProfileGrpcAuthSubscribe.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthSubscribe.setStatus("current")


class _TmnxUserProfileGrpcAuthGnmiCap_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthGnmiCap based on TProfileGrpcRpcAuth"""
    defaultValue = 1


_TmnxUserProfileGrpcAuthGnmiCap_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthGnmiCap_Object = MibTableColumn
tmnxUserProfileGrpcAuthGnmiCap = _TmnxUserProfileGrpcAuthGnmiCap_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 14),
    _TmnxUserProfileGrpcAuthGnmiCap_Type()
)
tmnxUserProfileGrpcAuthGnmiCap.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthGnmiCap.setStatus("current")


class _TmnxUserProfileGrpcAuthRAModify_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthRAModify based on TProfileGrpcRpcAuth"""
    defaultValue = 1


_TmnxUserProfileGrpcAuthRAModify_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthRAModify_Object = MibTableColumn
tmnxUserProfileGrpcAuthRAModify = _TmnxUserProfileGrpcAuthRAModify_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 15),
    _TmnxUserProfileGrpcAuthRAModify_Type()
)
tmnxUserProfileGrpcAuthRAModify.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthRAModify.setStatus("current")


class _TmnxUserProfileGrpcAuthRAGetVer_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthRAGetVer based on TProfileGrpcRpcAuth"""
    defaultValue = 1


_TmnxUserProfileGrpcAuthRAGetVer_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthRAGetVer_Object = MibTableColumn
tmnxUserProfileGrpcAuthRAGetVer = _TmnxUserProfileGrpcAuthRAGetVer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 16),
    _TmnxUserProfileGrpcAuthRAGetVer_Type()
)
tmnxUserProfileGrpcAuthRAGetVer.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthRAGetVer.setStatus("current")


class _TmnxUserProfileGrpcAuthCMRotate_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthCMRotate based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthCMRotate_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthCMRotate_Object = MibTableColumn
tmnxUserProfileGrpcAuthCMRotate = _TmnxUserProfileGrpcAuthCMRotate_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 17),
    _TmnxUserProfileGrpcAuthCMRotate_Type()
)
tmnxUserProfileGrpcAuthCMRotate.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthCMRotate.setStatus("current")


class _TmnxUserProfileGrpcAuthCMInstall_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthCMInstall based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthCMInstall_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthCMInstall_Object = MibTableColumn
tmnxUserProfileGrpcAuthCMInstall = _TmnxUserProfileGrpcAuthCMInstall_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 18),
    _TmnxUserProfileGrpcAuthCMInstall_Type()
)
tmnxUserProfileGrpcAuthCMInstall.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthCMInstall.setStatus("current")


class _TmnxUserProfileGrpcAuthCMGetCert_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthCMGetCert based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthCMGetCert_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthCMGetCert_Object = MibTableColumn
tmnxUserProfileGrpcAuthCMGetCert = _TmnxUserProfileGrpcAuthCMGetCert_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 19),
    _TmnxUserProfileGrpcAuthCMGetCert_Type()
)
tmnxUserProfileGrpcAuthCMGetCert.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthCMGetCert.setStatus("current")


class _TmnxUserProfileGrpcAuthCMRevoke_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthCMRevoke based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthCMRevoke_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthCMRevoke_Object = MibTableColumn
tmnxUserProfileGrpcAuthCMRevoke = _TmnxUserProfileGrpcAuthCMRevoke_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 20),
    _TmnxUserProfileGrpcAuthCMRevoke_Type()
)
tmnxUserProfileGrpcAuthCMRevoke.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthCMRevoke.setStatus("current")


class _TmnxUserProfileGrpcAuthCMCanGen_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthCMCanGen based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthCMCanGen_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthCMCanGen_Object = MibTableColumn
tmnxUserProfileGrpcAuthCMCanGen = _TmnxUserProfileGrpcAuthCMCanGen_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 21),
    _TmnxUserProfileGrpcAuthCMCanGen_Type()
)
tmnxUserProfileGrpcAuthCMCanGen.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthCMCanGen.setStatus("current")


class _TmnxUserProfileGrpcAuthMdCliSess_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthMdCliSess based on TProfileGrpcRpcAuth"""
    defaultValue = 1


_TmnxUserProfileGrpcAuthMdCliSess_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthMdCliSess_Object = MibTableColumn
tmnxUserProfileGrpcAuthMdCliSess = _TmnxUserProfileGrpcAuthMdCliSess_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 22),
    _TmnxUserProfileGrpcAuthMdCliSess_Type()
)
tmnxUserProfileGrpcAuthMdCliSess.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthMdCliSess.setStatus("current")


class _TmnxUserProfileGrpcAuthSysSetPkg_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthSysSetPkg based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthSysSetPkg_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthSysSetPkg_Object = MibTableColumn
tmnxUserProfileGrpcAuthSysSetPkg = _TmnxUserProfileGrpcAuthSysSetPkg_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 31),
    _TmnxUserProfileGrpcAuthSysSetPkg_Type()
)
tmnxUserProfileGrpcAuthSysSetPkg.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthSysSetPkg.setStatus("current")


class _TmnxUserProfileGrpcAuthSysSwCP_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthSysSwCP based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthSysSwCP_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthSysSwCP_Object = MibTableColumn
tmnxUserProfileGrpcAuthSysSwCP = _TmnxUserProfileGrpcAuthSysSwCP_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 32),
    _TmnxUserProfileGrpcAuthSysSwCP_Type()
)
tmnxUserProfileGrpcAuthSysSwCP.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthSysSwCP.setStatus("current")


class _TmnxUserProfileGrpcAuthSysReboot_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthSysReboot based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthSysReboot_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthSysReboot_Object = MibTableColumn
tmnxUserProfileGrpcAuthSysReboot = _TmnxUserProfileGrpcAuthSysReboot_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 33),
    _TmnxUserProfileGrpcAuthSysReboot_Type()
)
tmnxUserProfileGrpcAuthSysReboot.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthSysReboot.setStatus("current")


class _TmnxUserProfileGrpcAuthSysRebtSt_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthSysRebtSt based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthSysRebtSt_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthSysRebtSt_Object = MibTableColumn
tmnxUserProfileGrpcAuthSysRebtSt = _TmnxUserProfileGrpcAuthSysRebtSt_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 34),
    _TmnxUserProfileGrpcAuthSysRebtSt_Type()
)
tmnxUserProfileGrpcAuthSysRebtSt.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthSysRebtSt.setStatus("current")


class _TmnxUserProfileGrpcAuthSysCnRebt_Type(TProfileGrpcRpcAuth):
    """Custom type tmnxUserProfileGrpcAuthSysCnRebt based on TProfileGrpcRpcAuth"""
    defaultValue = 2


_TmnxUserProfileGrpcAuthSysCnRebt_Type.__name__ = "TProfileGrpcRpcAuth"
_TmnxUserProfileGrpcAuthSysCnRebt_Object = MibTableColumn
tmnxUserProfileGrpcAuthSysCnRebt = _TmnxUserProfileGrpcAuthSysCnRebt_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 1, 1, 35),
    _TmnxUserProfileGrpcAuthSysCnRebt_Type()
)
tmnxUserProfileGrpcAuthSysCnRebt.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserProfileGrpcAuthSysCnRebt.setStatus("current")
...
_TmnxUserProfileMatchAction_Type = TProfileMatchAction
...
if mibBuilder.loadTexts:
    tmnxUserPasswordChanged.setStatus("obsolete")


class _TmnxUserCliEngine1_Type(TmnxCliEngine):
    """Custom type tmnxUserCliEngine1 based on TmnxCliEngine"""
    defaultValue = 3


_TmnxUserCliEngine1_Type.__name__ = "TmnxCliEngine"
_TmnxUserCliEngine1_Object = MibTableColumn
tmnxUserCliEngine1 = _TmnxUserCliEngine1_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 3, 1, 23),
    _TmnxUserCliEngine1_Type()
)
tmnxUserCliEngine1.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserCliEngine1.setStatus("current")


class _TmnxUserCliEngine2_Type(TmnxCliEngine):
    """Custom type tmnxUserCliEngine2 based on TmnxCliEngine"""
    defaultValue = 3


_TmnxUserCliEngine2_Type.__name__ = "TmnxCliEngine"
_TmnxUserCliEngine2_Object = MibTableColumn
tmnxUserCliEngine2 = _TmnxUserCliEngine2_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 3, 1, 24),
    _TmnxUserCliEngine2_Type()
)
tmnxUserCliEngine2.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserCliEngine2.setStatus("current")
_TmnxUserPasswordChangedTime_Type = DateAndTime
_TmnxUserPasswordChangedTime_Object = MibTableColumn
tmnxUserPasswordChangedTime = _TmnxUserPasswordChangedTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 3, 1, 25),
    _TmnxUserPasswordChangedTime_Type()
)
tmnxUserPasswordChangedTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxUserPasswordChangedTime.setStatus("current")
_TmnxUserPasswordExpirationTime_Type = DateAndTime
_TmnxUserPasswordExpirationTime_Object = MibTableColumn
tmnxUserPasswordExpirationTime = _TmnxUserPasswordExpirationTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 3, 1, 26),
    _TmnxUserPasswordExpirationTime_Type()
)
tmnxUserPasswordExpirationTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxUserPasswordExpirationTime.setStatus("current")
_TmnxUserCreationOrigin_Type = TmnxCreateOrigin
_TmnxUserCreationOrigin_Object = MibTableColumn
tmnxUserCreationOrigin = _TmnxUserCreationOrigin_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 3, 1, 27),
    _TmnxUserCreationOrigin_Type()
)
tmnxUserCreationOrigin.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxUserCreationOrigin.setStatus("current")
...
class _TmnxMafMatchSrcIpPrefixList_Type(TNamedItemOrEmpty):
    """Custom type tmnxMafMatchSrcIpPrefixList based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxMafMatchSrcIpPrefixList_Type.__name__ = "TNamedItemOrEmpty"
_TmnxMafMatchSrcIpPrefixList_Object = MibTableColumn
tmnxMafMatchSrcIpPrefixList = _TmnxMafMatchSrcIpPrefixList_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 4, 6, 1, 18),
    _TmnxMafMatchSrcIpPrefixList_Type()
)
tmnxMafMatchSrcIpPrefixList.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMafMatchSrcIpPrefixList.setStatus("current")
...
class _TmnxMacMafMatchDot1pMask_Type(Dot1PPriorityNonZeroMask):
    """Custom type tmnxMacMafMatchDot1pMask based on Dot1PPriorityNonZeroMask"""
    defaultValue = 7


_TmnxMacMafMatchDot1pMask_Type.__name__ = "Dot1PPriorityNonZeroMask"
...
class _TmnxPasswordAuthenOrder1_Type(TmnxPasswordAuthenOrder):
    """Custom type tmnxPasswordAuthenOrder1 based on TmnxPasswordAuthenOrder"""
    defaultValue = 2


_TmnxPasswordAuthenOrder1_Type.__name__ = "TmnxPasswordAuthenOrder"
...
class _TmnxPasswordAuthenOrder2_Type(TmnxPasswordAuthenOrder):
    """Custom type tmnxPasswordAuthenOrder2 based on TmnxPasswordAuthenOrder"""
    defaultValue = 3


_TmnxPasswordAuthenOrder2_Type.__name__ = "TmnxPasswordAuthenOrder"
...
class _TmnxPasswordAuthenOrder3_Type(TmnxPasswordAuthenOrder):
    """Custom type tmnxPasswordAuthenOrder3 based on TmnxPasswordAuthenOrder"""
    defaultValue = 4


_TmnxPasswordAuthenOrder3_Type.__name__ = "TmnxPasswordAuthenOrder"
...
class _TmnxVsdPassword_Type(DisplayString):
    """Custom type tmnxVsdPassword based on DisplayString"""
    defaultValue = OctetString("")
...
_TmnxVsdPassword_Type.__name__ = "DisplayString"
_TmnxVsdPassword_Object = MibScalar
tmnxVsdPassword = _TmnxVsdPassword_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 5, 31),
    _TmnxVsdPassword_Type()
)
tmnxVsdPassword.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxVsdPassword.setStatus("current")


class _TmnxPasswordAuthenOrder4_Type(TmnxPasswordAuthenOrder):
    """Custom type tmnxPasswordAuthenOrder4 based on TmnxPasswordAuthenOrder"""
    defaultValue = 1


_TmnxPasswordAuthenOrder4_Type.__name__ = "TmnxPasswordAuthenOrder"
_TmnxPasswordAuthenOrder4_Object = MibScalar
tmnxPasswordAuthenOrder4 = _TmnxPasswordAuthenOrder4_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 5, 32),
    _TmnxPasswordAuthenOrder4_Type()
)
tmnxPasswordAuthenOrder4.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPasswordAuthenOrder4.setStatus("current")


class _TmnxPasswordHashing_Type(TmnxPassHashType):
    """Custom type tmnxPasswordHashing based on TmnxPassHashType"""
    defaultValue = 1


_TmnxPasswordHashing_Type.__name__ = "TmnxPassHashType"
_TmnxPasswordHashing_Object = MibScalar
tmnxPasswordHashing = _TmnxPasswordHashing_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 5, 33),
    _TmnxPasswordHashing_Type()
)
tmnxPasswordHashing.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPasswordHashing.setStatus("current")
...
class _TmnxRadiusAdminStatus_Type(TmnxAdminStateUpDown):
    """Custom type tmnxRadiusAdminStatus based on TmnxAdminStateUpDown"""
    defaultValue = 1


_TmnxRadiusAdminStatus_Type.__name__ = "TmnxAdminStateUpDown"
...
if mibBuilder.loadTexts:
    tmnxRadiusConfigured.setStatus("obsolete")
...
class _TmnxRadiusInteractiveAuthen_Type(TruthValue):
    """Custom type tmnxRadiusInteractiveAuthen based on TruthValue"""
    defaultValue = 2


_TmnxRadiusInteractiveAuthen_Type.__name__ = "TruthValue"
_TmnxRadiusInteractiveAuthen_Object = MibScalar
tmnxRadiusInteractiveAuthen = _TmnxRadiusInteractiveAuthen_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 6, 19),
    _TmnxRadiusInteractiveAuthen_Type()
)
tmnxRadiusInteractiveAuthen.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxRadiusInteractiveAuthen.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxTacPlusConfigured.setStatus("obsolete")
...
class _TCpmFilterQueueCBS_Type(TCpmFilterBurstSize):
    """Custom type tCpmFilterQueueCBS based on TCpmFilterBurstSize"""
    defaultValue = -1


_TCpmFilterQueueCBS_Type.__name__ = "TCpmFilterBurstSize"
...
class _TCpmFilterQueueMBS_Type(TCpmFilterBurstSize):
    """Custom type tCpmFilterQueueMBS based on TCpmFilterBurstSize"""
    defaultValue = -1


_TCpmFilterQueueMBS_Type.__name__ = "TCpmFilterBurstSize"
...
class _TCpmIpFilterEntryIcmpCode_Type(TIcmpCodeOrNone):
    """Custom type tCpmIpFilterEntryIcmpCode based on TIcmpCodeOrNone"""
    defaultValue = -1


_TCpmIpFilterEntryIcmpCode_Type.__name__ = "TIcmpCodeOrNone"
...
class _TCpmIpFilterEntryIcmpType_Type(TIcmpTypeOrNone):
    """Custom type tCpmIpFilterEntryIcmpType based on TIcmpTypeOrNone"""
    defaultValue = -1


_TCpmIpFilterEntryIcmpType_Type.__name__ = "TIcmpTypeOrNone"
...
class _TCpmIPv6FilterEntryIcmpCode_Type(TIcmpCodeOrNone):
    """Custom type tCpmIPv6FilterEntryIcmpCode based on TIcmpCodeOrNone"""
    defaultValue = -1


_TCpmIPv6FilterEntryIcmpCode_Type.__name__ = "TIcmpCodeOrNone"
...
class _TCpmIPv6FilterEntryIcmpType_Type(TIcmpTypeOrNone):
    """Custom type tCpmIPv6FilterEntryIcmpType based on TIcmpTypeOrNone"""
    defaultValue = -1


_TCpmIPv6FilterEntryIcmpType_Type.__name__ = "TIcmpTypeOrNone"
...
class _TmnxDCpuProtStaticPlcrPackets_Type(TmnxDistCpuProtPacketPolicerRateLimit):
    """Custom type tmnxDCpuProtStaticPlcrPackets based on TmnxDistCpuProtPacketPolicerRateLimit"""
    defaultValue = -1


_TmnxDCpuProtStaticPlcrPackets_Type.__name__ = "TmnxDistCpuProtPacketPolicerRateLimit"
...
if mibBuilder.loadTexts:
    tmnxDCpuProtStaticPlcrKbps.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    tmnxDCpuProtLocMonPlcrKbps.setUnits("kilobps")
...
if mibBuilder.loadTexts:
    tmnxDCpuProtProtocolDynKbps.setUnits("kilobps")
...
class _TmnxPassHashReadVersion_Type(TmnxPassHashReadType):
    """Custom type tmnxPassHashReadVersion based on TmnxPassHashReadType"""
    defaultValue = 0


_TmnxPassHashReadVersion_Type.__name__ = "TmnxPassHashReadType"
...
class _TmnxPassHashWriteVersion_Type(TmnxPassHashWriteType):
    """Custom type tmnxPassHashWriteVersion based on TmnxPassHashWriteType"""
    defaultValue = 2


_TmnxPassHashWriteVersion_Type.__name__ = "TmnxPassHashWriteType"
...
class _TmnxPassHashWriteVersionMdCli_Type(TmnxPassHashWriteType):
    """Custom type tmnxPassHashWriteVersionMdCli based on TmnxPassHashWriteType"""
    defaultValue = 2


_TmnxPassHashWriteVersionMdCli_Type.__name__ = "TmnxPassHashWriteType"
_TmnxPassHashWriteVersionMdCli_Object = MibScalar
tmnxPassHashWriteVersionMdCli = _TmnxPassHashWriteVersionMdCli_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 10, 3),
    _TmnxPassHashWriteVersionMdCli_Type()
)
tmnxPassHashWriteVersionMdCli.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPassHashWriteVersionMdCli.setStatus("current")


class _TmnxPassHashWriteVersionNetconf_Type(TmnxPassHashWriteType):
    """Custom type tmnxPassHashWriteVersionNetconf based on TmnxPassHashWriteType"""
    defaultValue = 2


_TmnxPassHashWriteVersionNetconf_Type.__name__ = "TmnxPassHashWriteType"
_TmnxPassHashWriteVersionNetconf_Object = MibScalar
tmnxPassHashWriteVersionNetconf = _TmnxPassHashWriteVersionNetconf_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 10, 4),
    _TmnxPassHashWriteVersionNetconf_Type()
)
tmnxPassHashWriteVersionNetconf.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPassHashWriteVersionNetconf.setStatus("current")


class _TmnxPassHashWriteVersionGrpc_Type(TmnxPassHashWriteType):
    """Custom type tmnxPassHashWriteVersionGrpc based on TmnxPassHashWriteType"""
    defaultValue = 2


_TmnxPassHashWriteVersionGrpc_Type.__name__ = "TmnxPassHashWriteType"
_TmnxPassHashWriteVersionGrpc_Object = MibScalar
tmnxPassHashWriteVersionGrpc = _TmnxPassHashWriteVersionGrpc_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 10, 5),
    _TmnxPassHashWriteVersionGrpc_Type()
)
tmnxPassHashWriteVersionGrpc.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPassHashWriteVersionGrpc.setStatus("current")
...
_TmnxSecNotifTunnelName_Type = TXLNamedItemOrEmpty
...
_TmnxPkiExpRemainingHours_Type = Unsigned32
_TmnxPkiExpRemainingHours_Object = MibScalar
tmnxPkiExpRemainingHours = _TmnxPkiExpRemainingHours_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 14),
    _TmnxPkiExpRemainingHours_Type()
)
tmnxPkiExpRemainingHours.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxPkiExpRemainingHours.setStatus("current")
if mibBuilder.loadTexts:
    tmnxPkiExpRemainingHours.setUnits("hours")
_TmnxPkiExpRemainingMinutes_Type = Unsigned32
_TmnxPkiExpRemainingMinutes_Object = MibScalar
tmnxPkiExpRemainingMinutes = _TmnxPkiExpRemainingMinutes_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 15),
    _TmnxPkiExpRemainingMinutes_Type()
)
tmnxPkiExpRemainingMinutes.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxPkiExpRemainingMinutes.setStatus("current")
if mibBuilder.loadTexts:
    tmnxPkiExpRemainingMinutes.setUnits("minutes")
_TmnxPkiExpReason_Type = DisplayString
_TmnxPkiExpReason_Object = MibScalar
tmnxPkiExpReason = _TmnxPkiExpReason_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 16),
    _TmnxPkiExpReason_Type()
)
tmnxPkiExpReason.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxPkiExpReason.setStatus("current")
_TmnxSecNotifFileType_Type = DisplayString
_TmnxSecNotifFileType_Object = MibScalar
tmnxSecNotifFileType = _TmnxSecNotifFileType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 17),
    _TmnxSecNotifFileType_Type()
)
tmnxSecNotifFileType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifFileType.setStatus("current")


class _TmnxSecPwdHistLoadFailReason_Type(Integer32):
    """Custom type tmnxSecPwdHistLoadFailReason based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_TmnxSecPwdHistLoadFailReason_Type.__name__ = "Integer32"
_TmnxSecPwdHistLoadFailReason_Object = MibScalar
tmnxSecPwdHistLoadFailReason = _TmnxSecPwdHistLoadFailReason_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 18),
    _TmnxSecPwdHistLoadFailReason_Type()
)
tmnxSecPwdHistLoadFailReason.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecPwdHistLoadFailReason.setStatus("current")
_TmnxPkiCAProfileNameForNotify_Type = TNamedItem
_TmnxPkiCAProfileNameForNotify_Object = MibScalar
tmnxPkiCAProfileNameForNotify = _TmnxPkiCAProfileNameForNotify_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 19),
    _TmnxPkiCAProfileNameForNotify_Type()
)
tmnxPkiCAProfileNameForNotify.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxPkiCAProfileNameForNotify.setStatus("current")
_TmnxSecNotifFileSize_Type = CounterBasedGauge64
_TmnxSecNotifFileSize_Object = MibScalar
tmnxSecNotifFileSize = _TmnxSecNotifFileSize_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 20),
    _TmnxSecNotifFileSize_Type()
)
tmnxSecNotifFileSize.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifFileSize.setStatus("current")
if mibBuilder.loadTexts:
    tmnxSecNotifFileSize.setUnits("bytes")
_TmnxSessionLimitExceededName_Type = TNamedItem
_TmnxSessionLimitExceededName_Object = MibScalar
tmnxSessionLimitExceededName = _TmnxSessionLimitExceededName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 21),
    _TmnxSessionLimitExceededName_Type()
)
tmnxSessionLimitExceededName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSessionLimitExceededName.setStatus("current")


class _TmnxSessionLimitExceededType_Type(Integer32):
    """Custom type tmnxSessionLimitExceededType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_TmnxSessionLimitExceededType_Type.__name__ = "Integer32"
_TmnxSessionLimitExceededType_Object = MibScalar
tmnxSessionLimitExceededType = _TmnxSessionLimitExceededType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 22),
    _TmnxSessionLimitExceededType_Type()
)
tmnxSessionLimitExceededType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSessionLimitExceededType.setStatus("current")
_TmnxSecNotifyUserName_Type = TNamedItem
_TmnxSecNotifyUserName_Object = MibScalar
tmnxSecNotifyUserName = _TmnxSecNotifyUserName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 23),
    _TmnxSecNotifyUserName_Type()
)
tmnxSecNotifyUserName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyUserName.setStatus("current")
_TmnxSecNotifyAddrType_Type = InetAddressType
_TmnxSecNotifyAddrType_Object = MibScalar
tmnxSecNotifyAddrType = _TmnxSecNotifyAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 24),
    _TmnxSecNotifyAddrType_Type()
)
tmnxSecNotifyAddrType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyAddrType.setStatus("current")
_TmnxSecNotifyAddr_Type = InetAddress
_TmnxSecNotifyAddr_Object = MibScalar
tmnxSecNotifyAddr = _TmnxSecNotifyAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 25),
    _TmnxSecNotifyAddr_Type()
)
tmnxSecNotifyAddr.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyAddr.setStatus("current")
_TmnxSecNotifClientAppName_Type = TXLNamedItemOrEmpty
_TmnxSecNotifClientAppName_Object = MibScalar
tmnxSecNotifClientAppName = _TmnxSecNotifClientAppName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 26),
    _TmnxSecNotifClientAppName_Type()
)
tmnxSecNotifClientAppName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifClientAppName.setStatus("current")
_TmnxSecNotifyUrl_Type = DisplayString
_TmnxSecNotifyUrl_Object = MibScalar
tmnxSecNotifyUrl = _TmnxSecNotifyUrl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 27),
    _TmnxSecNotifyUrl_Type()
)
tmnxSecNotifyUrl.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyUrl.setStatus("current")
_TmnxSecNotifyCurve_Type = DisplayString
_TmnxSecNotifyCurve_Object = MibScalar
tmnxSecNotifyCurve = _TmnxSecNotifyCurve_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 28),
    _TmnxSecNotifyCurve_Type()
)
tmnxSecNotifyCurve.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyCurve.setStatus("current")
_TmnxSecNotifyKeySize_Type = Unsigned32
_TmnxSecNotifyKeySize_Object = MibScalar
tmnxSecNotifyKeySize = _TmnxSecNotifyKeySize_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 29),
    _TmnxSecNotifyKeySize_Type()
)
tmnxSecNotifyKeySize.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyKeySize.setStatus("current")
_TmnxSecNotifyKeyType_Type = DisplayString
_TmnxSecNotifyKeyType_Object = MibScalar
tmnxSecNotifyKeyType = _TmnxSecNotifyKeyType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 30),
    _TmnxSecNotifyKeyType_Type()
)
tmnxSecNotifyKeyType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyKeyType.setStatus("current")
_TmnxSecNotifyImportExportType_Type = DisplayString
_TmnxSecNotifyImportExportType_Object = MibScalar
tmnxSecNotifyImportExportType = _TmnxSecNotifyImportExportType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 31),
    _TmnxSecNotifyImportExportType_Type()
)
tmnxSecNotifyImportExportType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyImportExportType.setStatus("current")
_TmnxSecNotifyImportExportFormat_Type = DisplayString
_TmnxSecNotifyImportExportFormat_Object = MibScalar
tmnxSecNotifyImportExportFormat = _TmnxSecNotifyImportExportFormat_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 32),
    _TmnxSecNotifyImportExportFormat_Type()
)
tmnxSecNotifyImportExportFormat.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyImportExportFormat.setStatus("current")
_TmnxSecNotifyCertificateProtocol_Type = DisplayString
_TmnxSecNotifyCertificateProtocol_Object = MibScalar
tmnxSecNotifyCertificateProtocol = _TmnxSecNotifyCertificateProtocol_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 33),
    _TmnxSecNotifyCertificateProtocol_Type()
)
tmnxSecNotifyCertificateProtocol.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyCertificateProtocol.setStatus("current")
_TmnxSecNotifyNewUrl_Type = DisplayString
_TmnxSecNotifyNewUrl_Object = MibScalar
tmnxSecNotifyNewUrl = _TmnxSecNotifyNewUrl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 34),
    _TmnxSecNotifyNewUrl_Type()
)
tmnxSecNotifyNewUrl.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyNewUrl.setStatus("current")


class _TmnxSecEventOutcome_Type(Integer32):
    """Custom type tmnxSecEventOutcome based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_TmnxSecEventOutcome_Type.__name__ = "Integer32"
_TmnxSecEventOutcome_Object = MibScalar
tmnxSecEventOutcome = _TmnxSecEventOutcome_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 35),
    _TmnxSecEventOutcome_Type()
)
tmnxSecEventOutcome.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecEventOutcome.setStatus("current")
_TmnxSecNotifyDestUrl_Type = DisplayString
_TmnxSecNotifyDestUrl_Object = MibScalar
tmnxSecNotifyDestUrl = _TmnxSecNotifyDestUrl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 36),
    _TmnxSecNotifyDestUrl_Type()
)
tmnxSecNotifyDestUrl.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyDestUrl.setStatus("current")


class _TmnxSecNotifFileUnzipResult_Type(Integer32):
    """Custom type tmnxSecNotifFileUnzipResult based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TmnxSecNotifFileUnzipResult_Type.__name__ = "Integer32"
_TmnxSecNotifFileUnzipResult_Object = MibScalar
tmnxSecNotifFileUnzipResult = _TmnxSecNotifFileUnzipResult_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 37),
    _TmnxSecNotifFileUnzipResult_Type()
)
tmnxSecNotifFileUnzipResult.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifFileUnzipResult.setStatus("current")
_TmnxSecNotifNewPasswordHashing_Type = TmnxPassHashType
_TmnxSecNotifNewPasswordHashing_Object = MibScalar
tmnxSecNotifNewPasswordHashing = _TmnxSecNotifNewPasswordHashing_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 38),
    _TmnxSecNotifNewPasswordHashing_Type()
)
tmnxSecNotifNewPasswordHashing.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifNewPasswordHashing.setStatus("current")
_TmnxSecNotifOldPasswordHashing_Type = TmnxPassHashType
_TmnxSecNotifOldPasswordHashing_Object = MibScalar
tmnxSecNotifOldPasswordHashing = _TmnxSecNotifOldPasswordHashing_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 39),
    _TmnxSecNotifOldPasswordHashing_Type()
)
tmnxSecNotifOldPasswordHashing.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifOldPasswordHashing.setStatus("current")
_TmnxSecNotifyLocalUserName_Type = TNamedItem
_TmnxSecNotifyLocalUserName_Object = MibScalar
tmnxSecNotifyLocalUserName = _TmnxSecNotifyLocalUserName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 40),
    _TmnxSecNotifyLocalUserName_Type()
)
tmnxSecNotifyLocalUserName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyLocalUserName.setStatus("current")
_TmnxSecNotifyAdminUserName_Type = TNamedItem
_TmnxSecNotifyAdminUserName_Object = MibScalar
tmnxSecNotifyAdminUserName = _TmnxSecNotifyAdminUserName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 16, 41),
    _TmnxSecNotifyAdminUserName_Type()
)
tmnxSecNotifyAdminUserName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxSecNotifyAdminUserName.setStatus("current")
...
class _TmnxPkiCAProfCmpSvcName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxPkiCAProfCmpSvcName based on TLNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxPkiCAProfCmpSvcName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxPkiCAProfCmpSvcName_Object = MibTableColumn
tmnxPkiCAProfCmpSvcName = _TmnxPkiCAProfCmpSvcName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 3, 1, 25),
    _TmnxPkiCAProfCmpSvcName_Type()
)
tmnxPkiCAProfCmpSvcName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfCmpSvcName.setStatus("current")


class _TmnxPkiCAProfOcspSvcName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxPkiCAProfOcspSvcName based on TLNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxPkiCAProfOcspSvcName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxPkiCAProfOcspSvcName_Object = MibTableColumn
tmnxPkiCAProfOcspSvcName = _TmnxPkiCAProfOcspSvcName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 3, 1, 26),
    _TmnxPkiCAProfOcspSvcName_Type()
)
tmnxPkiCAProfOcspSvcName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfOcspSvcName.setStatus("current")


class _TmnxPkiCAProfOcspTransProf_Type(TNamedItemOrEmpty):
    """Custom type tmnxPkiCAProfOcspTransProf based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxPkiCAProfOcspTransProf_Type.__name__ = "TNamedItemOrEmpty"
_TmnxPkiCAProfOcspTransProf_Object = MibTableColumn
tmnxPkiCAProfOcspTransProf = _TmnxPkiCAProfOcspTransProf_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 3, 1, 27),
    _TmnxPkiCAProfOcspTransProf_Type()
)
tmnxPkiCAProfOcspTransProf.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfOcspTransProf.setStatus("current")
...
class _TmnxPkiCertExpWarningHours_Type(Integer32):
    """Custom type tmnxPkiCertExpWarningHours based on Integer32"""
    defaultValue = -1

    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-1, 8760),
    )


_TmnxPkiCertExpWarningHours_Type.__name__ = "Integer32"
_TmnxPkiCertExpWarningHours_Object = MibScalar
tmnxPkiCertExpWarningHours = _TmnxPkiCertExpWarningHours_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 8),
    _TmnxPkiCertExpWarningHours_Type()
)
tmnxPkiCertExpWarningHours.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPkiCertExpWarningHours.setStatus("current")
if mibBuilder.loadTexts:
    tmnxPkiCertExpWarningHours.setUnits("hours")


class _TmnxPkiCertExpWarningRepeatHrs_Type(Integer32):
    """Custom type tmnxPkiCertExpWarningRepeatHrs based on Integer32"""
    defaultValue = 0
...
_TmnxPkiCertExpWarningRepeatHrs_Type.__name__ = "Integer32"
_TmnxPkiCertExpWarningRepeatHrs_Object = MibScalar
tmnxPkiCertExpWarningRepeatHrs = _TmnxPkiCertExpWarningRepeatHrs_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 9),
    _TmnxPkiCertExpWarningRepeatHrs_Type()
)
tmnxPkiCertExpWarningRepeatHrs.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPkiCertExpWarningRepeatHrs.setStatus("current")
if mibBuilder.loadTexts:
    tmnxPkiCertExpWarningRepeatHrs.setUnits("hours")


class _TmnxPkiCRLExpWarningHours_Type(Integer32):
    """Custom type tmnxPkiCRLExpWarningHours based on Integer32"""
    defaultValue = -1
...
_TmnxPkiCRLExpWarningHours_Type.__name__ = "Integer32"
_TmnxPkiCRLExpWarningHours_Object = MibScalar
tmnxPkiCRLExpWarningHours = _TmnxPkiCRLExpWarningHours_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 10),
    _TmnxPkiCRLExpWarningHours_Type()
)
tmnxPkiCRLExpWarningHours.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPkiCRLExpWarningHours.setStatus("current")
if mibBuilder.loadTexts:
    tmnxPkiCRLExpWarningHours.setUnits("hours")


class _TmnxPkiCRLExpWarningRepeatHrs_Type(Integer32):
    """Custom type tmnxPkiCRLExpWarningRepeatHrs based on Integer32"""
    defaultValue = 0
...
_TmnxPkiCRLExpWarningRepeatHrs_Type.__name__ = "Integer32"
_TmnxPkiCRLExpWarningRepeatHrs_Object = MibScalar
tmnxPkiCRLExpWarningRepeatHrs = _TmnxPkiCRLExpWarningRepeatHrs_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 11),
    _TmnxPkiCRLExpWarningRepeatHrs_Type()
)
tmnxPkiCRLExpWarningRepeatHrs.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPkiCRLExpWarningRepeatHrs.setStatus("current")
if mibBuilder.loadTexts:
    tmnxPkiCRLExpWarningRepeatHrs.setUnits("hours")
_TmnxPkiCAProfAtCrlUpdTblLstChgd_Type = TimeStamp
_TmnxPkiCAProfAtCrlUpdTblLstChgd_Object = MibScalar
tmnxPkiCAProfAtCrlUpdTblLstChgd = _TmnxPkiCAProfAtCrlUpdTblLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 12),
    _TmnxPkiCAProfAtCrlUpdTblLstChgd_Type()
)
tmnxPkiCAProfAtCrlUpdTblLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdTblLstChgd.setStatus("current")
_TmnxPkiCAProfAtCrlUpdTable_Object = MibTable
tmnxPkiCAProfAtCrlUpdTable = _TmnxPkiCAProfAtCrlUpdTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13)
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdTable.setStatus("current")
_TmnxPkiCAProfAtCrlUpdEntry_Object = MibTableRow
tmnxPkiCAProfAtCrlUpdEntry = _TmnxPkiCAProfAtCrlUpdEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1)
)
tmnxPkiCAProfAtCrlUpdEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxPkiCAProfile"),
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdEntry.setStatus("current")
_TmnxPkiCAProfAtCrlUpdRowStatus_Type = RowStatus
_TmnxPkiCAProfAtCrlUpdRowStatus_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdRowStatus = _TmnxPkiCAProfAtCrlUpdRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 1),
    _TmnxPkiCAProfAtCrlUpdRowStatus_Type()
)
tmnxPkiCAProfAtCrlUpdRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdRowStatus.setStatus("current")
_TmnxPkiCAProfAtCrlUpdLastChgd_Type = TimeStamp
_TmnxPkiCAProfAtCrlUpdLastChgd_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdLastChgd = _TmnxPkiCAProfAtCrlUpdLastChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 2),
    _TmnxPkiCAProfAtCrlUpdLastChgd_Type()
)
tmnxPkiCAProfAtCrlUpdLastChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdLastChgd.setStatus("current")


class _TmnxPkiCAProfAtCrlUpdAdminState_Type(TmnxAdminState):
    """Custom type tmnxPkiCAProfAtCrlUpdAdminState based on TmnxAdminState"""
    defaultValue = 3


_TmnxPkiCAProfAtCrlUpdAdminState_Type.__name__ = "TmnxAdminState"
_TmnxPkiCAProfAtCrlUpdAdminState_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdAdminState = _TmnxPkiCAProfAtCrlUpdAdminState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 3),
    _TmnxPkiCAProfAtCrlUpdAdminState_Type()
)
tmnxPkiCAProfAtCrlUpdAdminState.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdAdminState.setStatus("current")


class _TmnxPkiCAProfAtCrlUpdScheduleT_Type(Integer32):
    """Custom type tmnxPkiCAProfAtCrlUpdScheduleT based on Integer32"""
    defaultValue = 1
...
_TmnxPkiCAProfAtCrlUpdScheduleT_Type.__name__ = "Integer32"
_TmnxPkiCAProfAtCrlUpdScheduleT_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdScheduleT = _TmnxPkiCAProfAtCrlUpdScheduleT_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 4),
    _TmnxPkiCAProfAtCrlUpdScheduleT_Type()
)
tmnxPkiCAProfAtCrlUpdScheduleT.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdScheduleT.setStatus("current")


class _TmnxPkiCAProfAtCrlUpdPrdcUpdIntv_Type(Unsigned32):
    """Custom type tmnxPkiCAProfAtCrlUpdPrdcUpdIntv based on Unsigned32"""
    defaultValue = 86400

    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(3600, 31622400),
    )


_TmnxPkiCAProfAtCrlUpdPrdcUpdIntv_Type.__name__ = "Unsigned32"
_TmnxPkiCAProfAtCrlUpdPrdcUpdIntv_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdPrdcUpdIntv = _TmnxPkiCAProfAtCrlUpdPrdcUpdIntv_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 5),
    _TmnxPkiCAProfAtCrlUpdPrdcUpdIntv_Type()
)
tmnxPkiCAProfAtCrlUpdPrdcUpdIntv.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdPrdcUpdIntv.setStatus("current")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdPrdcUpdIntv.setUnits("seconds")


class _TmnxPkiCAProfAtCrlUpdPreUpdTime_Type(Unsigned32):
    """Custom type tmnxPkiCAProfAtCrlUpdPreUpdTime based on Unsigned32"""
    defaultValue = 3600
...
_TmnxPkiCAProfAtCrlUpdPreUpdTime_Type.__name__ = "Unsigned32"
_TmnxPkiCAProfAtCrlUpdPreUpdTime_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdPreUpdTime = _TmnxPkiCAProfAtCrlUpdPreUpdTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 6),
    _TmnxPkiCAProfAtCrlUpdPreUpdTime_Type()
)
tmnxPkiCAProfAtCrlUpdPreUpdTime.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdPreUpdTime.setStatus("current")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdPreUpdTime.setUnits("seconds")


class _TmnxPkiCAProfAtCrlUpdRetryIntv_Type(Unsigned32):
    """Custom type tmnxPkiCAProfAtCrlUpdRetryIntv based on Unsigned32"""
    defaultValue = 3600
...
_TmnxPkiCAProfAtCrlUpdRetryIntv_Type.__name__ = "Unsigned32"
_TmnxPkiCAProfAtCrlUpdRetryIntv_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdRetryIntv = _TmnxPkiCAProfAtCrlUpdRetryIntv_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 7),
    _TmnxPkiCAProfAtCrlUpdRetryIntv_Type()
)
tmnxPkiCAProfAtCrlUpdRetryIntv.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdRetryIntv.setStatus("current")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdRetryIntv.setUnits("seconds")


class _TmnxPkiCAProfAtCrlUpdLstSucsEtId_Type(Unsigned32):
    """Custom type tmnxPkiCAProfAtCrlUpdLstSucsEtId based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
...
_TmnxPkiCAProfAtCrlUpdLstSucsEtId_Type.__name__ = "Unsigned32"
_TmnxPkiCAProfAtCrlUpdLstSucsEtId_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdLstSucsEtId = _TmnxPkiCAProfAtCrlUpdLstSucsEtId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 8),
    _TmnxPkiCAProfAtCrlUpdLstSucsEtId_Type()
)
tmnxPkiCAProfAtCrlUpdLstSucsEtId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdLstSucsEtId.setStatus("current")
_TmnxPkiCAProfAtCrlUpdLstSucsTmSt_Type = Unsigned32
_TmnxPkiCAProfAtCrlUpdLstSucsTmSt_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdLstSucsTmSt = _TmnxPkiCAProfAtCrlUpdLstSucsTmSt_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 9),
    _TmnxPkiCAProfAtCrlUpdLstSucsTmSt_Type()
)
tmnxPkiCAProfAtCrlUpdLstSucsTmSt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdLstSucsTmSt.setStatus("current")
_TmnxPkiCAProfAtCrlUpdLstSucsTmEd_Type = Unsigned32
_TmnxPkiCAProfAtCrlUpdLstSucsTmEd_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdLstSucsTmEd = _TmnxPkiCAProfAtCrlUpdLstSucsTmEd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 10),
    _TmnxPkiCAProfAtCrlUpdLstSucsTmEd_Type()
)
tmnxPkiCAProfAtCrlUpdLstSucsTmEd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdLstSucsTmEd.setStatus("current")
_TmnxPkiCAProfAtCrlUpdNxCrlUpdTm_Type = Unsigned32
_TmnxPkiCAProfAtCrlUpdNxCrlUpdTm_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdNxCrlUpdTm = _TmnxPkiCAProfAtCrlUpdNxCrlUpdTm_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 13, 1, 11),
    _TmnxPkiCAProfAtCrlUpdNxCrlUpdTm_Type()
)
tmnxPkiCAProfAtCrlUpdNxCrlUpdTm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdNxCrlUpdTm.setStatus("current")
_TmnxPkiCAProfUrlTablLastChgd_Type = TimeStamp
_TmnxPkiCAProfUrlTablLastChgd_Object = MibScalar
tmnxPkiCAProfUrlTablLastChgd = _TmnxPkiCAProfUrlTablLastChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 14),
    _TmnxPkiCAProfUrlTablLastChgd_Type()
)
tmnxPkiCAProfUrlTablLastChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfUrlTablLastChgd.setStatus("current")
_TmnxPkiCAProfUrlTable_Object = MibTable
tmnxPkiCAProfUrlTable = _TmnxPkiCAProfUrlTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 15)
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfUrlTable.setStatus("current")
_TmnxPkiCAProfUrlEntry_Object = MibTableRow
tmnxPkiCAProfUrlEntry = _TmnxPkiCAProfUrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 15, 1)
)
tmnxPkiCAProfUrlEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxPkiCAProfile"),
    (0, "TIMETRA-SECURITY-MIB", "tmnxPkiCAProfUrlId"),
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfUrlEntry.setStatus("current")


class _TmnxPkiCAProfUrlId_Type(Unsigned32):
    """Custom type tmnxPkiCAProfUrlId based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 8),
    )
...
_TmnxPkiCAProfUrlId_Type.__name__ = "Unsigned32"
_TmnxPkiCAProfUrlId_Object = MibTableColumn
tmnxPkiCAProfUrlId = _TmnxPkiCAProfUrlId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 15, 1, 1),
    _TmnxPkiCAProfUrlId_Type()
)
tmnxPkiCAProfUrlId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxPkiCAProfUrlId.setStatus("current")
_TmnxPkiCAProfUrlRowStatus_Type = RowStatus
_TmnxPkiCAProfUrlRowStatus_Object = MibTableColumn
tmnxPkiCAProfUrlRowStatus = _TmnxPkiCAProfUrlRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 15, 1, 2),
    _TmnxPkiCAProfUrlRowStatus_Type()
)
tmnxPkiCAProfUrlRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfUrlRowStatus.setStatus("current")
_TmnxPkiCAProfUrlLastChanged_Type = TimeStamp
_TmnxPkiCAProfUrlLastChanged_Object = MibTableColumn
tmnxPkiCAProfUrlLastChanged = _TmnxPkiCAProfUrlLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 15, 1, 3),
    _TmnxPkiCAProfUrlLastChanged_Type()
)
tmnxPkiCAProfUrlLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfUrlLastChanged.setStatus("current")


class _TmnxPkiCAProfUrl_Type(TmnxDisplayStringURL):
    """Custom type tmnxPkiCAProfUrl based on TmnxDisplayStringURL"""
    defaultValue = OctetString("")


_TmnxPkiCAProfUrl_Type.__name__ = "TmnxDisplayStringURL"
_TmnxPkiCAProfUrl_Object = MibTableColumn
tmnxPkiCAProfUrl = _TmnxPkiCAProfUrl_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 15, 1, 4),
    _TmnxPkiCAProfUrl_Type()
)
tmnxPkiCAProfUrl.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfUrl.setStatus("current")


class _TmnxPkiCAProfUrlFileTransProf_Type(TNamedItemOrEmpty):
    """Custom type tmnxPkiCAProfUrlFileTransProf based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxPkiCAProfUrlFileTransProf_Type.__name__ = "TNamedItemOrEmpty"
_TmnxPkiCAProfUrlFileTransProf_Object = MibTableColumn
tmnxPkiCAProfUrlFileTransProf = _TmnxPkiCAProfUrlFileTransProf_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 15, 1, 5),
    _TmnxPkiCAProfUrlFileTransProf_Type()
)
tmnxPkiCAProfUrlFileTransProf.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfUrlFileTransProf.setStatus("current")
_TmnxPkiCAProfManCrlUpdTable_Object = MibTable
tmnxPkiCAProfManCrlUpdTable = _TmnxPkiCAProfManCrlUpdTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 16)
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfManCrlUpdTable.setStatus("current")
_TmnxPkiCAProfManCrlUpdEntry_Object = MibTableRow
tmnxPkiCAProfManCrlUpdEntry = _TmnxPkiCAProfManCrlUpdEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 16, 1)
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfManCrlUpdEntry.setStatus("current")
_TmnxPkiCAProfManCrlUpdAct_Type = TmnxActionType
_TmnxPkiCAProfManCrlUpdAct_Object = MibTableColumn
tmnxPkiCAProfManCrlUpdAct = _TmnxPkiCAProfManCrlUpdAct_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 16, 1, 1),
    _TmnxPkiCAProfManCrlUpdAct_Type()
)
tmnxPkiCAProfManCrlUpdAct.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfManCrlUpdAct.setStatus("current")
_TmnxPkiCAProfManCrlUpdAbort_Type = TmnxActionType
_TmnxPkiCAProfManCrlUpdAbort_Object = MibTableColumn
tmnxPkiCAProfManCrlUpdAbort = _TmnxPkiCAProfManCrlUpdAbort_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 16, 1, 2),
    _TmnxPkiCAProfManCrlUpdAbort_Type()
)
tmnxPkiCAProfManCrlUpdAbort.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCAProfManCrlUpdAbort.setStatus("current")
_TmnxPkiCAProfCrlUpdTable_Object = MibTable
tmnxPkiCAProfCrlUpdTable = _TmnxPkiCAProfCrlUpdTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 17)
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlUpdTable.setStatus("current")
_TmnxPkiCAProfCrlUpdEntry_Object = MibTableRow
tmnxPkiCAProfCrlUpdEntry = _TmnxPkiCAProfCrlUpdEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 17, 1)
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlUpdEntry.setStatus("current")


class _TmnxPkiCAProfCrlCurUpdStatus_Type(Integer32):
    """Custom type tmnxPkiCAProfCrlCurUpdStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TmnxPkiCAProfCrlCurUpdStatus_Type.__name__ = "Integer32"
_TmnxPkiCAProfCrlCurUpdStatus_Object = MibTableColumn
tmnxPkiCAProfCrlCurUpdStatus = _TmnxPkiCAProfCrlCurUpdStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 17, 1, 1),
    _TmnxPkiCAProfCrlCurUpdStatus_Type()
)
tmnxPkiCAProfCrlCurUpdStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlCurUpdStatus.setStatus("current")


class _TmnxPkiCAProfCrlCurUpdEtId_Type(Unsigned32):
    """Custom type tmnxPkiCAProfCrlCurUpdEtId based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 8),
...
_TmnxPkiCAProfCrlCurUpdEtId_Type.__name__ = "Unsigned32"
_TmnxPkiCAProfCrlCurUpdEtId_Object = MibTableColumn
tmnxPkiCAProfCrlCurUpdEtId = _TmnxPkiCAProfCrlCurUpdEtId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 17, 1, 2),
    _TmnxPkiCAProfCrlCurUpdEtId_Type()
)
tmnxPkiCAProfCrlCurUpdEtId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlCurUpdEtId.setStatus("current")
_TmnxPkiCAProfCrlCurUpdStartTime_Type = Unsigned32
_TmnxPkiCAProfCrlCurUpdStartTime_Object = MibTableColumn
tmnxPkiCAProfCrlCurUpdStartTime = _TmnxPkiCAProfCrlCurUpdStartTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 17, 1, 3),
    _TmnxPkiCAProfCrlCurUpdStartTime_Type()
)
tmnxPkiCAProfCrlCurUpdStartTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlCurUpdStartTime.setStatus("current")


class _TmnxPkiCAProfAtCrlUpdLstFailedId_Type(Unsigned32):
    """Custom type tmnxPkiCAProfAtCrlUpdLstFailedId based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
        ValueRangeConstraint(1, 8),
...
_TmnxPkiCAProfAtCrlUpdLstFailedId_Type.__name__ = "Unsigned32"
_TmnxPkiCAProfAtCrlUpdLstFailedId_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdLstFailedId = _TmnxPkiCAProfAtCrlUpdLstFailedId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 17, 1, 4),
    _TmnxPkiCAProfAtCrlUpdLstFailedId_Type()
)
tmnxPkiCAProfAtCrlUpdLstFailedId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdLstFailedId.setStatus("current")
_TmnxPkiCAProfAtCrlUpdLstFailTmSt_Type = Unsigned32
_TmnxPkiCAProfAtCrlUpdLstFailTmSt_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdLstFailTmSt = _TmnxPkiCAProfAtCrlUpdLstFailTmSt_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 17, 1, 5),
    _TmnxPkiCAProfAtCrlUpdLstFailTmSt_Type()
)
tmnxPkiCAProfAtCrlUpdLstFailTmSt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdLstFailTmSt.setStatus("current")
_TmnxPkiCAProfAtCrlUpdLstFailTmEd_Type = Unsigned32
_TmnxPkiCAProfAtCrlUpdLstFailTmEd_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdLstFailTmEd = _TmnxPkiCAProfAtCrlUpdLstFailTmEd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 17, 1, 6),
    _TmnxPkiCAProfAtCrlUpdLstFailTmEd_Type()
)
tmnxPkiCAProfAtCrlUpdLstFailTmEd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdLstFailTmEd.setStatus("current")


class _TmnxPkiCAProfAtCrlUpdLstFailReas_Type(Integer32):
    """Custom type tmnxPkiCAProfAtCrlUpdLstFailReas based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TmnxPkiCAProfAtCrlUpdLstFailReas_Type.__name__ = "Integer32"
_TmnxPkiCAProfAtCrlUpdLstFailReas_Object = MibTableColumn
tmnxPkiCAProfAtCrlUpdLstFailReas = _TmnxPkiCAProfAtCrlUpdLstFailReas_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 17, 1, 7),
    _TmnxPkiCAProfAtCrlUpdLstFailReas_Type()
)
tmnxPkiCAProfAtCrlUpdLstFailReas.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdLstFailReas.setStatus("current")
...
class _TmnxPkiCAProfActnDomain_Type(TmnxLongDisplayString):
    """Custom type tmnxPkiCAProfActnDomain based on TmnxLongDisplayString"""
    defaultHexValue = ""
...
_TmnxPkiCAProfActnDomain_Type.__name__ = "TmnxLongDisplayString"
_TmnxPkiCAProfActnDomain_Object = MibTableColumn
tmnxPkiCAProfActnDomain = _TmnxPkiCAProfActnDomain_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 22, 1, 19),
    _TmnxPkiCAProfActnDomain_Type()
)
tmnxPkiCAProfActnDomain.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPkiCAProfActnDomain.setStatus("current")


class _TmnxPkiCAProfActnInetAddrType_Type(InetAddressType):
    """Custom type tmnxPkiCAProfActnInetAddrType based on InetAddressType"""
    defaultValue = 0


_TmnxPkiCAProfActnInetAddrType_Type.__name__ = "InetAddressType"
_TmnxPkiCAProfActnInetAddrType_Object = MibTableColumn
tmnxPkiCAProfActnInetAddrType = _TmnxPkiCAProfActnInetAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 22, 1, 20),
    _TmnxPkiCAProfActnInetAddrType_Type()
)
tmnxPkiCAProfActnInetAddrType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPkiCAProfActnInetAddrType.setStatus("current")


class _TmnxPkiCAProfActnInetAddr_Type(InetAddress):
    """Custom type tmnxPkiCAProfActnInetAddr based on InetAddress"""
    defaultHexValue = ""
...
_TmnxPkiCAProfActnInetAddr_Type.__name__ = "InetAddress"
_TmnxPkiCAProfActnInetAddr_Object = MibTableColumn
tmnxPkiCAProfActnInetAddr = _TmnxPkiCAProfActnInetAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 22, 1, 21),
    _TmnxPkiCAProfActnInetAddr_Type()
)
tmnxPkiCAProfActnInetAddr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxPkiCAProfActnInetAddr.setStatus("current")
_TmnxPkiCNListTableLastChanged_Type = TimeStamp
_TmnxPkiCNListTableLastChanged_Object = MibScalar
tmnxPkiCNListTableLastChanged = _TmnxPkiCNListTableLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 23),
    _TmnxPkiCNListTableLastChanged_Type()
)
tmnxPkiCNListTableLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCNListTableLastChanged.setStatus("current")
_TmnxPkiCNListTable_Object = MibTable
tmnxPkiCNListTable = _TmnxPkiCNListTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 24)
)
if mibBuilder.loadTexts:
    tmnxPkiCNListTable.setStatus("current")
_TmnxPkiCNListEntry_Object = MibTableRow
tmnxPkiCNListEntry = _TmnxPkiCNListEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 24, 1)
)
tmnxPkiCNListEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxPkiCNListName"),
)
if mibBuilder.loadTexts:
    tmnxPkiCNListEntry.setStatus("current")
_TmnxPkiCNListName_Type = TNamedItem
_TmnxPkiCNListName_Object = MibTableColumn
tmnxPkiCNListName = _TmnxPkiCNListName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 24, 1, 1),
    _TmnxPkiCNListName_Type()
)
tmnxPkiCNListName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxPkiCNListName.setStatus("current")
_TmnxPkiCNListLastChanged_Type = TimeStamp
_TmnxPkiCNListLastChanged_Object = MibTableColumn
tmnxPkiCNListLastChanged = _TmnxPkiCNListLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 24, 1, 2),
    _TmnxPkiCNListLastChanged_Type()
)
tmnxPkiCNListLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCNListLastChanged.setStatus("current")
_TmnxPkiCNListRowStatus_Type = RowStatus
_TmnxPkiCNListRowStatus_Object = MibTableColumn
tmnxPkiCNListRowStatus = _TmnxPkiCNListRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 24, 1, 3),
    _TmnxPkiCNListRowStatus_Type()
)
tmnxPkiCNListRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCNListRowStatus.setStatus("current")
_TmnxPkiCNListParamTableLstChgd_Type = TimeStamp
_TmnxPkiCNListParamTableLstChgd_Object = MibScalar
tmnxPkiCNListParamTableLstChgd = _TmnxPkiCNListParamTableLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 25),
    _TmnxPkiCNListParamTableLstChgd_Type()
)
tmnxPkiCNListParamTableLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCNListParamTableLstChgd.setStatus("current")
_TmnxPkiCNListParamTable_Object = MibTable
tmnxPkiCNListParamTable = _TmnxPkiCNListParamTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 26)
)
if mibBuilder.loadTexts:
    tmnxPkiCNListParamTable.setStatus("current")
_TmnxPkiCNListParamEntry_Object = MibTableRow
tmnxPkiCNListParamEntry = _TmnxPkiCNListParamEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 26, 1)
)
tmnxPkiCNListParamEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxPkiCNListName"),
    (0, "TIMETRA-SECURITY-MIB", "tmnxPkiCNListParamIndex"),
)
if mibBuilder.loadTexts:
    tmnxPkiCNListParamEntry.setStatus("current")


class _TmnxPkiCNListParamIndex_Type(Unsigned32):
    """Custom type tmnxPkiCNListParamIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TmnxPkiCNListParamIndex_Type.__name__ = "Unsigned32"
_TmnxPkiCNListParamIndex_Object = MibTableColumn
tmnxPkiCNListParamIndex = _TmnxPkiCNListParamIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 26, 1, 1),
    _TmnxPkiCNListParamIndex_Type()
)
tmnxPkiCNListParamIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxPkiCNListParamIndex.setStatus("current")
_TmnxPkiCNListParamLastChanged_Type = TimeStamp
_TmnxPkiCNListParamLastChanged_Object = MibTableColumn
tmnxPkiCNListParamLastChanged = _TmnxPkiCNListParamLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 26, 1, 2),
    _TmnxPkiCNListParamLastChanged_Type()
)
tmnxPkiCNListParamLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxPkiCNListParamLastChanged.setStatus("current")
_TmnxPkiCNListParamRowStatus_Type = RowStatus
_TmnxPkiCNListParamRowStatus_Object = MibTableColumn
tmnxPkiCNListParamRowStatus = _TmnxPkiCNListParamRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 26, 1, 3),
    _TmnxPkiCNListParamRowStatus_Type()
)
tmnxPkiCNListParamRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCNListParamRowStatus.setStatus("current")
_TmnxPkiCNListParamCNType_Type = TmnxPkiCNType
_TmnxPkiCNListParamCNType_Object = MibTableColumn
tmnxPkiCNListParamCNType = _TmnxPkiCNListParamCNType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 26, 1, 4),
    _TmnxPkiCNListParamCNType_Type()
)
tmnxPkiCNListParamCNType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCNListParamCNType.setStatus("current")
_TmnxPkiCNListParamCNValue_Type = TRegularExpression
_TmnxPkiCNListParamCNValue_Object = MibTableColumn
tmnxPkiCNListParamCNValue = _TmnxPkiCNListParamCNValue_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 26, 1, 5),
    _TmnxPkiCNListParamCNValue_Type()
)
tmnxPkiCNListParamCNValue.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiCNListParamCNValue.setStatus("current")


class _TmnxPkiImportedFormat_Type(Integer32):
    """Custom type tmnxPkiImportedFormat based on Integer32"""
    defaultValue = 1
...
_TmnxPkiImportedFormat_Type.__name__ = "Integer32"
_TmnxPkiImportedFormat_Object = MibScalar
tmnxPkiImportedFormat = _TmnxPkiImportedFormat_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 18, 27),
    _TmnxPkiImportedFormat_Type()
)
tmnxPkiImportedFormat.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxPkiImportedFormat.setStatus("current")
...
class _TmnxUserPublicKeyName_Type(TmnxLongDisplayString):
    """Custom type tmnxUserPublicKeyName based on TmnxLongDisplayString"""
    defaultHexValue = ""
...
_TmnxUserPublicKeyName_Type.__name__ = "TmnxLongDisplayString"
...
class _TmnxUserPublicKeyDescription_Type(TItemDescription):
    """Custom type tmnxUserPublicKeyDescription based on TItemDescription"""
    defaultHexValue = ""


_TmnxUserPublicKeyDescription_Type.__name__ = "TItemDescription"
_TmnxUserPublicKeyDescription_Object = MibTableColumn
tmnxUserPublicKeyDescription = _TmnxUserPublicKeyDescription_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 1, 1, 5),
    _TmnxUserPublicKeyDescription_Type()
)
tmnxUserPublicKeyDescription.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserPublicKeyDescription.setStatus("current")
_TmnxUserPubKeyTableLastChanged_Type = TimeStamp
_TmnxUserPubKeyTableLastChanged_Object = MibScalar
tmnxUserPubKeyTableLastChanged = _TmnxUserPubKeyTableLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 2),
    _TmnxUserPubKeyTableLastChanged_Type()
)
tmnxUserPubKeyTableLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxUserPubKeyTableLastChanged.setStatus("current")
_TmnxUserPubEcdsaKeyTable_Object = MibTable
tmnxUserPubEcdsaKeyTable = _TmnxUserPubEcdsaKeyTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 3)
)
if mibBuilder.loadTexts:
    tmnxUserPubEcdsaKeyTable.setStatus("current")
_TmnxUserPubEcdsaKeyEntry_Object = MibTableRow
tmnxUserPubEcdsaKeyEntry = _TmnxUserPubEcdsaKeyEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 3, 1)
)
tmnxUserPubEcdsaKeyEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxUserName"),
    (0, "TIMETRA-SECURITY-MIB", "tmnxUserPubEcdsaKeyNumber"),
)
if mibBuilder.loadTexts:
    tmnxUserPubEcdsaKeyEntry.setStatus("current")


class _TmnxUserPubEcdsaKeyNumber_Type(Unsigned32):
    """Custom type tmnxUserPubEcdsaKeyNumber based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 32),
    )
...
_TmnxUserPubEcdsaKeyNumber_Type.__name__ = "Unsigned32"
_TmnxUserPubEcdsaKeyNumber_Object = MibTableColumn
tmnxUserPubEcdsaKeyNumber = _TmnxUserPubEcdsaKeyNumber_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 3, 1, 1),
    _TmnxUserPubEcdsaKeyNumber_Type()
)
tmnxUserPubEcdsaKeyNumber.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxUserPubEcdsaKeyNumber.setStatus("current")
_TmnxUserPubEcdsaKeyRowStatus_Type = RowStatus
_TmnxUserPubEcdsaKeyRowStatus_Object = MibTableColumn
tmnxUserPubEcdsaKeyRowStatus = _TmnxUserPubEcdsaKeyRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 3, 1, 2),
    _TmnxUserPubEcdsaKeyRowStatus_Type()
)
tmnxUserPubEcdsaKeyRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserPubEcdsaKeyRowStatus.setStatus("current")
_TmnxUserPubEcdsaKeyLastChanged_Type = TimeStamp
_TmnxUserPubEcdsaKeyLastChanged_Object = MibTableColumn
tmnxUserPubEcdsaKeyLastChanged = _TmnxUserPubEcdsaKeyLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 3, 1, 3),
    _TmnxUserPubEcdsaKeyLastChanged_Type()
)
tmnxUserPubEcdsaKeyLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxUserPubEcdsaKeyLastChanged.setStatus("current")


class _TmnxUserPubEcdsaKeyName_Type(DisplayString):
    """Custom type tmnxUserPubEcdsaKeyName based on DisplayString"""
    defaultHexValue = ""
...
_TmnxUserPubEcdsaKeyName_Type.__name__ = "DisplayString"
_TmnxUserPubEcdsaKeyName_Object = MibTableColumn
tmnxUserPubEcdsaKeyName = _TmnxUserPubEcdsaKeyName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 3, 1, 4),
    _TmnxUserPubEcdsaKeyName_Type()
)
tmnxUserPubEcdsaKeyName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserPubEcdsaKeyName.setStatus("current")


class _TmnxUserPubEcdsaKeyDescription_Type(TItemDescription):
    """Custom type tmnxUserPubEcdsaKeyDescription based on TItemDescription"""
    defaultHexValue = ""


_TmnxUserPubEcdsaKeyDescription_Type.__name__ = "TItemDescription"
_TmnxUserPubEcdsaKeyDescription_Object = MibTableColumn
tmnxUserPubEcdsaKeyDescription = _TmnxUserPubEcdsaKeyDescription_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 3, 1, 5),
    _TmnxUserPubEcdsaKeyDescription_Type()
)
tmnxUserPubEcdsaKeyDescription.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxUserPubEcdsaKeyDescription.setStatus("current")
_TmnxUserPubEcdsaKeyTblLstChgd_Type = TimeStamp
_TmnxUserPubEcdsaKeyTblLstChgd_Object = MibScalar
tmnxUserPubEcdsaKeyTblLstChgd = _TmnxUserPubEcdsaKeyTblLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 20, 4),
    _TmnxUserPubEcdsaKeyTblLstChgd_Type()
)
tmnxUserPubEcdsaKeyTblLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxUserPubEcdsaKeyTblLstChgd.setStatus("current")
...
_TmnxCliScriptAuthObjs_ObjectIdentity = ObjectIdentity
tmnxCliScriptAuthObjs = _TmnxCliScriptAuthObjs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 29)
)
_TmnxCliScriptAuthTblLastChange_Type = TimeStamp
_TmnxCliScriptAuthTblLastChange_Object = MibScalar
tmnxCliScriptAuthTblLastChange = _TmnxCliScriptAuthTblLastChange_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 29, 1),
    _TmnxCliScriptAuthTblLastChange_Type()
)
tmnxCliScriptAuthTblLastChange.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxCliScriptAuthTblLastChange.setStatus("current")
_TmnxCliScriptAuthTable_Object = MibTable
tmnxCliScriptAuthTable = _TmnxCliScriptAuthTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 29, 2)
)
if mibBuilder.loadTexts:
    tmnxCliScriptAuthTable.setStatus("current")
_TmnxCliScriptAuthEntry_Object = MibTableRow
tmnxCliScriptAuthEntry = _TmnxCliScriptAuthEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 29, 2, 1)
)
tmnxCliScriptAuthEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxCliScriptAuthUserType"),
    (1, "TIMETRA-SECURITY-MIB", "tmnxCliScriptAuthUserName"),
)
if mibBuilder.loadTexts:
    tmnxCliScriptAuthEntry.setStatus("current")
_TmnxCliScriptAuthUserType_Type = TmnxScriptAuthType
_TmnxCliScriptAuthUserType_Object = MibTableColumn
tmnxCliScriptAuthUserType = _TmnxCliScriptAuthUserType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 29, 2, 1, 1),
    _TmnxCliScriptAuthUserType_Type()
)
tmnxCliScriptAuthUserType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxCliScriptAuthUserType.setStatus("current")
_TmnxCliScriptAuthUserName_Type = TNamedItem
_TmnxCliScriptAuthUserName_Object = MibTableColumn
tmnxCliScriptAuthUserName = _TmnxCliScriptAuthUserName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 29, 2, 1, 2),
    _TmnxCliScriptAuthUserName_Type()
)
tmnxCliScriptAuthUserName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxCliScriptAuthUserName.setStatus("current")
_TmnxCliScriptAuthRowStatus_Type = RowStatus
_TmnxCliScriptAuthRowStatus_Object = MibTableColumn
tmnxCliScriptAuthRowStatus = _TmnxCliScriptAuthRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 29, 2, 1, 3),
    _TmnxCliScriptAuthRowStatus_Type()
)
tmnxCliScriptAuthRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxCliScriptAuthRowStatus.setStatus("current")
_TmnxCliSessionGroupTableLstChgd_Type = TimeStamp
_TmnxCliSessionGroupTableLstChgd_Object = MibScalar
tmnxCliSessionGroupTableLstChgd = _TmnxCliSessionGroupTableLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 30),
    _TmnxCliSessionGroupTableLstChgd_Type()
)
tmnxCliSessionGroupTableLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxCliSessionGroupTableLstChgd.setStatus("current")
_TmnxCliSessionGroupTable_Object = MibTable
tmnxCliSessionGroupTable = _TmnxCliSessionGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 31)
)
if mibBuilder.loadTexts:
    tmnxCliSessionGroupTable.setStatus("current")
_TmnxCliSessionGroupEntry_Object = MibTableRow
tmnxCliSessionGroupEntry = _TmnxCliSessionGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 31, 1)
)
tmnxCliSessionGroupEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxCliSessionGroupName"),
)
if mibBuilder.loadTexts:
    tmnxCliSessionGroupEntry.setStatus("current")
_TmnxCliSessionGroupName_Type = TNamedItem
_TmnxCliSessionGroupName_Object = MibTableColumn
tmnxCliSessionGroupName = _TmnxCliSessionGroupName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 31, 1, 1),
    _TmnxCliSessionGroupName_Type()
)
tmnxCliSessionGroupName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxCliSessionGroupName.setStatus("current")
_TmnxCliSessionGroupLastChanged_Type = TimeStamp
_TmnxCliSessionGroupLastChanged_Object = MibTableColumn
tmnxCliSessionGroupLastChanged = _TmnxCliSessionGroupLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 31, 1, 2),
    _TmnxCliSessionGroupLastChanged_Type()
)
tmnxCliSessionGroupLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxCliSessionGroupLastChanged.setStatus("current")
_TmnxCliSessionGroupRowStatus_Type = RowStatus
_TmnxCliSessionGroupRowStatus_Object = MibTableColumn
tmnxCliSessionGroupRowStatus = _TmnxCliSessionGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 31, 1, 3),
    _TmnxCliSessionGroupRowStatus_Type()
)
tmnxCliSessionGroupRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxCliSessionGroupRowStatus.setStatus("current")


class _TmnxCliSessionGroupDescription_Type(TItemDescription):
    """Custom type tmnxCliSessionGroupDescription based on TItemDescription"""
    defaultHexValue = ""


_TmnxCliSessionGroupDescription_Type.__name__ = "TItemDescription"
_TmnxCliSessionGroupDescription_Object = MibTableColumn
tmnxCliSessionGroupDescription = _TmnxCliSessionGroupDescription_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 31, 1, 4),
    _TmnxCliSessionGroupDescription_Type()
)
tmnxCliSessionGroupDescription.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxCliSessionGroupDescription.setStatus("current")


class _TmnxCliSessionGroupSshLimit_Type(TmnxSessionLimit):
    """Custom type tmnxCliSessionGroupSshLimit based on TmnxSessionLimit"""
    defaultValue = -1


_TmnxCliSessionGroupSshLimit_Type.__name__ = "TmnxSessionLimit"
_TmnxCliSessionGroupSshLimit_Object = MibTableColumn
tmnxCliSessionGroupSshLimit = _TmnxCliSessionGroupSshLimit_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 31, 1, 5),
    _TmnxCliSessionGroupSshLimit_Type()
)
tmnxCliSessionGroupSshLimit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxCliSessionGroupSshLimit.setStatus("current")


class _TmnxCliSessionGroupTelnetLimit_Type(TmnxSessionLimit):
    """Custom type tmnxCliSessionGroupTelnetLimit based on TmnxSessionLimit"""
    defaultValue = -1


_TmnxCliSessionGroupTelnetLimit_Type.__name__ = "TmnxSessionLimit"
_TmnxCliSessionGroupTelnetLimit_Object = MibTableColumn
tmnxCliSessionGroupTelnetLimit = _TmnxCliSessionGroupTelnetLimit_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 31, 1, 6),
    _TmnxCliSessionGroupTelnetLimit_Type()
)
tmnxCliSessionGroupTelnetLimit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxCliSessionGroupTelnetLimit.setStatus("current")


class _TmnxCliSessionGroupTotalLimit_Type(TmnxSessionLimit):
    """Custom type tmnxCliSessionGroupTotalLimit based on TmnxSessionLimit"""
    defaultValue = -1


_TmnxCliSessionGroupTotalLimit_Type.__name__ = "TmnxSessionLimit"
_TmnxCliSessionGroupTotalLimit_Object = MibTableColumn
tmnxCliSessionGroupTotalLimit = _TmnxCliSessionGroupTotalLimit_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 31, 1, 7),
    _TmnxCliSessionGroupTotalLimit_Type()
)
tmnxCliSessionGroupTotalLimit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxCliSessionGroupTotalLimit.setStatus("current")
_TmnxSSHMacTable_Object = MibTable
tmnxSSHMacTable = _TmnxSSHMacTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 32)
)
if mibBuilder.loadTexts:
    tmnxSSHMacTable.setStatus("current")
_TmnxSSHMacEntry_Object = MibTableRow
tmnxSSHMacEntry = _TmnxSSHMacEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 32, 1)
)
tmnxSSHMacEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxSSHMacNumber"),
)
if mibBuilder.loadTexts:
    tmnxSSHMacEntry.setStatus("current")
_TmnxSSHMacNumber_Type = TSSHMacNumber
_TmnxSSHMacNumber_Object = MibTableColumn
tmnxSSHMacNumber = _TmnxSSHMacNumber_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 32, 1, 1),
    _TmnxSSHMacNumber_Type()
)
tmnxSSHMacNumber.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxSSHMacNumber.setStatus("current")


class _TmnxSSHMacName_Type(DisplayString):
    """Custom type tmnxSSHMacName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_TmnxSSHMacName_Type.__name__ = "DisplayString"
_TmnxSSHMacName_Object = MibTableColumn
tmnxSSHMacName = _TmnxSSHMacName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 32, 1, 2),
    _TmnxSSHMacName_Type()
)
tmnxSSHMacName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHMacName.setStatus("current")
_TmnxSSHServerMacListTableLstChgd_Type = TimeStamp
_TmnxSSHServerMacListTableLstChgd_Object = MibScalar
tmnxSSHServerMacListTableLstChgd = _TmnxSSHServerMacListTableLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 33),
    _TmnxSSHServerMacListTableLstChgd_Type()
)
tmnxSSHServerMacListTableLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHServerMacListTableLstChgd.setStatus("current")
_TmnxSSHServerMacListTable_Object = MibTable
tmnxSSHServerMacListTable = _TmnxSSHServerMacListTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 34)
)
if mibBuilder.loadTexts:
    tmnxSSHServerMacListTable.setStatus("current")
_TmnxSSHServerMacListEntry_Object = MibTableRow
tmnxSSHServerMacListEntry = _TmnxSSHServerMacListEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 34, 1)
)
tmnxSSHServerMacListEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxSSHServerMacListIndex"),
)
if mibBuilder.loadTexts:
    tmnxSSHServerMacListEntry.setStatus("current")


class _TmnxSSHServerMacListIndex_Type(Unsigned32):
    """Custom type tmnxSSHServerMacListIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_TmnxSSHServerMacListIndex_Type.__name__ = "Unsigned32"
_TmnxSSHServerMacListIndex_Object = MibTableColumn
tmnxSSHServerMacListIndex = _TmnxSSHServerMacListIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 34, 1, 1),
    _TmnxSSHServerMacListIndex_Type()
)
tmnxSSHServerMacListIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxSSHServerMacListIndex.setStatus("current")
_TmnxSSHServerMacListLastChanged_Type = TimeStamp
_TmnxSSHServerMacListLastChanged_Object = MibTableColumn
tmnxSSHServerMacListLastChanged = _TmnxSSHServerMacListLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 34, 1, 2),
    _TmnxSSHServerMacListLastChanged_Type()
)
tmnxSSHServerMacListLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHServerMacListLastChanged.setStatus("current")
_TmnxSSHServerMacListRowStatus_Type = RowStatus
_TmnxSSHServerMacListRowStatus_Object = MibTableColumn
tmnxSSHServerMacListRowStatus = _TmnxSSHServerMacListRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 34, 1, 3),
    _TmnxSSHServerMacListRowStatus_Type()
)
tmnxSSHServerMacListRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSSHServerMacListRowStatus.setStatus("current")
_TmnxSSHServerMacListNumber_Type = TSSHMacNumber
_TmnxSSHServerMacListNumber_Object = MibTableColumn
tmnxSSHServerMacListNumber = _TmnxSSHServerMacListNumber_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 34, 1, 4),
    _TmnxSSHServerMacListNumber_Type()
)
tmnxSSHServerMacListNumber.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSSHServerMacListNumber.setStatus("current")
_TmnxSSHClientMacListTableLstChgd_Type = TimeStamp
_TmnxSSHClientMacListTableLstChgd_Object = MibScalar
tmnxSSHClientMacListTableLstChgd = _TmnxSSHClientMacListTableLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 35),
    _TmnxSSHClientMacListTableLstChgd_Type()
)
tmnxSSHClientMacListTableLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHClientMacListTableLstChgd.setStatus("current")
_TmnxSSHClientMacListTable_Object = MibTable
tmnxSSHClientMacListTable = _TmnxSSHClientMacListTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 36)
)
if mibBuilder.loadTexts:
    tmnxSSHClientMacListTable.setStatus("current")
_TmnxSSHClientMacListEntry_Object = MibTableRow
tmnxSSHClientMacListEntry = _TmnxSSHClientMacListEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 36, 1)
)
tmnxSSHClientMacListEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxSSHClientMacListIndex"),
)
if mibBuilder.loadTexts:
    tmnxSSHClientMacListEntry.setStatus("current")


class _TmnxSSHClientMacListIndex_Type(Unsigned32):
    """Custom type tmnxSSHClientMacListIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_TmnxSSHClientMacListIndex_Type.__name__ = "Unsigned32"
_TmnxSSHClientMacListIndex_Object = MibTableColumn
tmnxSSHClientMacListIndex = _TmnxSSHClientMacListIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 36, 1, 1),
    _TmnxSSHClientMacListIndex_Type()
)
tmnxSSHClientMacListIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxSSHClientMacListIndex.setStatus("current")
_TmnxSSHClientMacListLastChanged_Type = TimeStamp
_TmnxSSHClientMacListLastChanged_Object = MibTableColumn
tmnxSSHClientMacListLastChanged = _TmnxSSHClientMacListLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 36, 1, 2),
    _TmnxSSHClientMacListLastChanged_Type()
)
tmnxSSHClientMacListLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHClientMacListLastChanged.setStatus("current")
_TmnxSSHClientMacListRowStatus_Type = RowStatus
_TmnxSSHClientMacListRowStatus_Object = MibTableColumn
tmnxSSHClientMacListRowStatus = _TmnxSSHClientMacListRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 36, 1, 3),
    _TmnxSSHClientMacListRowStatus_Type()
)
tmnxSSHClientMacListRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSSHClientMacListRowStatus.setStatus("current")
_TmnxSSHClientMacListNumber_Type = TSSHMacNumber
_TmnxSSHClientMacListNumber_Object = MibTableColumn
tmnxSSHClientMacListNumber = _TmnxSSHClientMacListNumber_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 36, 1, 4),
    _TmnxSSHClientMacListNumber_Type()
)
tmnxSSHClientMacListNumber.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSSHClientMacListNumber.setStatus("current")
_TmnxSSHServerKeyReExchangeObjs_ObjectIdentity = ObjectIdentity
tmnxSSHServerKeyReExchangeObjs = _TmnxSSHServerKeyReExchangeObjs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 37)
)
_TmnxSSHServerKeyReExLastChanged_Type = TimeStamp
_TmnxSSHServerKeyReExLastChanged_Object = MibScalar
tmnxSSHServerKeyReExLastChanged = _TmnxSSHServerKeyReExLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 37, 1),
    _TmnxSSHServerKeyReExLastChanged_Type()
)
tmnxSSHServerKeyReExLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHServerKeyReExLastChanged.setStatus("current")


class _TmnxSSHServerKeyReExAdminState_Type(TmnxAdminState):
    """Custom type tmnxSSHServerKeyReExAdminState based on TmnxAdminState"""
    defaultValue = 2


_TmnxSSHServerKeyReExAdminState_Type.__name__ = "TmnxAdminState"
_TmnxSSHServerKeyReExAdminState_Object = MibScalar
tmnxSSHServerKeyReExAdminState = _TmnxSSHServerKeyReExAdminState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 37, 2),
    _TmnxSSHServerKeyReExAdminState_Type()
)
tmnxSSHServerKeyReExAdminState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxSSHServerKeyReExAdminState.setStatus("current")


class _TmnxSSHServerKeyReExMinutes_Type(Unsigned32):
    """Custom type tmnxSSHServerKeyReExMinutes based on Unsigned32"""
    defaultValue = 60
...
_TmnxSSHServerKeyReExMinutes_Type.__name__ = "Unsigned32"
_TmnxSSHServerKeyReExMinutes_Object = MibScalar
tmnxSSHServerKeyReExMinutes = _TmnxSSHServerKeyReExMinutes_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 37, 3),
    _TmnxSSHServerKeyReExMinutes_Type()
)
tmnxSSHServerKeyReExMinutes.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxSSHServerKeyReExMinutes.setStatus("current")


class _TmnxSSHServerKeyReExMBytes_Type(Unsigned32):
    """Custom type tmnxSSHServerKeyReExMBytes based on Unsigned32"""
    defaultValue = 1024
...
_TmnxSSHServerKeyReExMBytes_Type.__name__ = "Unsigned32"
_TmnxSSHServerKeyReExMBytes_Object = MibScalar
tmnxSSHServerKeyReExMBytes = _TmnxSSHServerKeyReExMBytes_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 37, 4),
    _TmnxSSHServerKeyReExMBytes_Type()
)
tmnxSSHServerKeyReExMBytes.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxSSHServerKeyReExMBytes.setStatus("current")
_TmnxSSHClientKeyReExchangeObjs_ObjectIdentity = ObjectIdentity
tmnxSSHClientKeyReExchangeObjs = _TmnxSSHClientKeyReExchangeObjs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 38)
)
_TmnxSSHClientKeyReExLastChanged_Type = TimeStamp
_TmnxSSHClientKeyReExLastChanged_Object = MibScalar
tmnxSSHClientKeyReExLastChanged = _TmnxSSHClientKeyReExLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 38, 1),
    _TmnxSSHClientKeyReExLastChanged_Type()
)
tmnxSSHClientKeyReExLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHClientKeyReExLastChanged.setStatus("current")


class _TmnxSSHClientKeyReExAdminState_Type(TmnxAdminState):
    """Custom type tmnxSSHClientKeyReExAdminState based on TmnxAdminState"""
    defaultValue = 2


_TmnxSSHClientKeyReExAdminState_Type.__name__ = "TmnxAdminState"
_TmnxSSHClientKeyReExAdminState_Object = MibScalar
tmnxSSHClientKeyReExAdminState = _TmnxSSHClientKeyReExAdminState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 38, 2),
    _TmnxSSHClientKeyReExAdminState_Type()
)
tmnxSSHClientKeyReExAdminState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxSSHClientKeyReExAdminState.setStatus("current")


class _TmnxSSHClientKeyReExMinutes_Type(Unsigned32):
    """Custom type tmnxSSHClientKeyReExMinutes based on Unsigned32"""
    defaultValue = 60
...
_TmnxSSHClientKeyReExMinutes_Type.__name__ = "Unsigned32"
_TmnxSSHClientKeyReExMinutes_Object = MibScalar
tmnxSSHClientKeyReExMinutes = _TmnxSSHClientKeyReExMinutes_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 38, 3),
    _TmnxSSHClientKeyReExMinutes_Type()
)
tmnxSSHClientKeyReExMinutes.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxSSHClientKeyReExMinutes.setStatus("current")


class _TmnxSSHClientKeyReExMBytes_Type(Unsigned32):
    """Custom type tmnxSSHClientKeyReExMBytes based on Unsigned32"""
    defaultValue = 1024
...
_TmnxSSHClientKeyReExMBytes_Type.__name__ = "Unsigned32"
_TmnxSSHClientKeyReExMBytes_Object = MibScalar
tmnxSSHClientKeyReExMBytes = _TmnxSSHClientKeyReExMBytes_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 38, 4),
    _TmnxSSHClientKeyReExMBytes_Type()
)
tmnxSSHClientKeyReExMBytes.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxSSHClientKeyReExMBytes.setStatus("current")
_TmnxServerAccessCtlObjs_ObjectIdentity = ObjectIdentity
tmnxServerAccessCtlObjs = _TmnxServerAccessCtlObjs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 39)
)


class _TmnxAllowServersAccess_Type(Bits):
    """Custom type tmnxAllowServersAccess based on Bits"""
...
_TmnxAllowServersAccess_Type.__name__ = "Bits"
_TmnxAllowServersAccess_Object = MibScalar
tmnxAllowServersAccess = _TmnxAllowServersAccess_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 39, 1),
    _TmnxAllowServersAccess_Type()
)
tmnxAllowServersAccess.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxAllowServersAccess.setStatus("current")
_TmnxServerAccessCtlObjsLstChgd_Type = TimeStamp
_TmnxServerAccessCtlObjsLstChgd_Object = MibScalar
tmnxServerAccessCtlObjsLstChgd = _TmnxServerAccessCtlObjsLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 39, 2),
    _TmnxServerAccessCtlObjsLstChgd_Type()
)
tmnxServerAccessCtlObjsLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxServerAccessCtlObjsLstChgd.setStatus("current")
_TmnxSSHKexTable_Object = MibTable
tmnxSSHKexTable = _TmnxSSHKexTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 40)
)
if mibBuilder.loadTexts:
    tmnxSSHKexTable.setStatus("current")
_TmnxSSHKexEntry_Object = MibTableRow
tmnxSSHKexEntry = _TmnxSSHKexEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 40, 1)
)
tmnxSSHKexEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxSSHKexNumber"),
)
if mibBuilder.loadTexts:
    tmnxSSHKexEntry.setStatus("current")
_TmnxSSHKexNumber_Type = TSSHKexNumber
_TmnxSSHKexNumber_Object = MibTableColumn
tmnxSSHKexNumber = _TmnxSSHKexNumber_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 40, 1, 1),
    _TmnxSSHKexNumber_Type()
)
tmnxSSHKexNumber.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxSSHKexNumber.setStatus("current")


class _TmnxSSHKexName_Type(DisplayString):
    """Custom type tmnxSSHKexName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_TmnxSSHKexName_Type.__name__ = "DisplayString"
_TmnxSSHKexName_Object = MibTableColumn
tmnxSSHKexName = _TmnxSSHKexName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 40, 1, 2),
    _TmnxSSHKexName_Type()
)
tmnxSSHKexName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHKexName.setStatus("current")
_TmnxSSHServerKexListTableLstChgd_Type = TimeStamp
_TmnxSSHServerKexListTableLstChgd_Object = MibScalar
tmnxSSHServerKexListTableLstChgd = _TmnxSSHServerKexListTableLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 41),
    _TmnxSSHServerKexListTableLstChgd_Type()
)
tmnxSSHServerKexListTableLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHServerKexListTableLstChgd.setStatus("current")
_TmnxSSHServerKexListTable_Object = MibTable
tmnxSSHServerKexListTable = _TmnxSSHServerKexListTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 42)
)
if mibBuilder.loadTexts:
    tmnxSSHServerKexListTable.setStatus("current")
_TmnxSSHServerKexListEntry_Object = MibTableRow
tmnxSSHServerKexListEntry = _TmnxSSHServerKexListEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 42, 1)
)
tmnxSSHServerKexListEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxSSHServerKexListIndex"),
)
if mibBuilder.loadTexts:
    tmnxSSHServerKexListEntry.setStatus("current")


class _TmnxSSHServerKexListIndex_Type(Unsigned32):
    """Custom type tmnxSSHServerKexListIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_TmnxSSHServerKexListIndex_Type.__name__ = "Unsigned32"
_TmnxSSHServerKexListIndex_Object = MibTableColumn
tmnxSSHServerKexListIndex = _TmnxSSHServerKexListIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 42, 1, 1),
    _TmnxSSHServerKexListIndex_Type()
)
tmnxSSHServerKexListIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxSSHServerKexListIndex.setStatus("current")
_TmnxSSHServerKexListLastChanged_Type = TimeStamp
_TmnxSSHServerKexListLastChanged_Object = MibTableColumn
tmnxSSHServerKexListLastChanged = _TmnxSSHServerKexListLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 42, 1, 2),
    _TmnxSSHServerKexListLastChanged_Type()
)
tmnxSSHServerKexListLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHServerKexListLastChanged.setStatus("current")
_TmnxSSHServerKexListRowStatus_Type = RowStatus
_TmnxSSHServerKexListRowStatus_Object = MibTableColumn
tmnxSSHServerKexListRowStatus = _TmnxSSHServerKexListRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 42, 1, 3),
    _TmnxSSHServerKexListRowStatus_Type()
)
tmnxSSHServerKexListRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSSHServerKexListRowStatus.setStatus("current")
_TmnxSSHServerKexListNumber_Type = TSSHKexNumber
_TmnxSSHServerKexListNumber_Object = MibTableColumn
tmnxSSHServerKexListNumber = _TmnxSSHServerKexListNumber_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 42, 1, 4),
    _TmnxSSHServerKexListNumber_Type()
)
tmnxSSHServerKexListNumber.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSSHServerKexListNumber.setStatus("current")
_TmnxSSHClientKexListTableLstChgd_Type = TimeStamp
_TmnxSSHClientKexListTableLstChgd_Object = MibScalar
tmnxSSHClientKexListTableLstChgd = _TmnxSSHClientKexListTableLstChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 43),
    _TmnxSSHClientKexListTableLstChgd_Type()
)
tmnxSSHClientKexListTableLstChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHClientKexListTableLstChgd.setStatus("current")
_TmnxSSHClientKexListTable_Object = MibTable
tmnxSSHClientKexListTable = _TmnxSSHClientKexListTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 44)
)
if mibBuilder.loadTexts:
    tmnxSSHClientKexListTable.setStatus("current")
_TmnxSSHClientKexListEntry_Object = MibTableRow
tmnxSSHClientKexListEntry = _TmnxSSHClientKexListEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 44, 1)
)
tmnxSSHClientKexListEntry.setIndexNames(
    (0, "TIMETRA-SECURITY-MIB", "tmnxSSHClientKexListIndex"),
)
if mibBuilder.loadTexts:
    tmnxSSHClientKexListEntry.setStatus("current")


class _TmnxSSHClientKexListIndex_Type(Unsigned32):
    """Custom type tmnxSSHClientKexListIndex based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_TmnxSSHClientKexListIndex_Type.__name__ = "Unsigned32"
_TmnxSSHClientKexListIndex_Object = MibTableColumn
tmnxSSHClientKexListIndex = _TmnxSSHClientKexListIndex_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 44, 1, 1),
    _TmnxSSHClientKexListIndex_Type()
)
tmnxSSHClientKexListIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxSSHClientKexListIndex.setStatus("current")
_TmnxSSHClientKexListLastChanged_Type = TimeStamp
_TmnxSSHClientKexListLastChanged_Object = MibTableColumn
tmnxSSHClientKexListLastChanged = _TmnxSSHClientKexListLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 44, 1, 2),
    _TmnxSSHClientKexListLastChanged_Type()
)
tmnxSSHClientKexListLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxSSHClientKexListLastChanged.setStatus("current")
_TmnxSSHClientKexListRowStatus_Type = RowStatus
_TmnxSSHClientKexListRowStatus_Object = MibTableColumn
tmnxSSHClientKexListRowStatus = _TmnxSSHClientKexListRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 44, 1, 3),
    _TmnxSSHClientKexListRowStatus_Type()
)
tmnxSSHClientKexListRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSSHClientKexListRowStatus.setStatus("current")
_TmnxSSHClientKexListNumber_Type = TSSHKexNumber
_TmnxSSHClientKexListNumber_Object = MibTableColumn
tmnxSSHClientKexListNumber = _TmnxSSHClientKexListNumber_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 44, 1, 4),
    _TmnxSSHClientKexListNumber_Type()
)
tmnxSSHClientKexListNumber.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSSHClientKexListNumber.setStatus("current")
_TmnxSysSecurityMgmtIfOutputAuth_ObjectIdentity = ObjectIdentity
tmnxSysSecurityMgmtIfOutputAuth = _TmnxSysSecurityMgmtIfOutputAuth_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 50)
)


class _TmnxMgmtIfOutAuthMdInterfaces_Type(TruthValue):
    """Custom type tmnxMgmtIfOutAuthMdInterfaces based on TruthValue"""
    defaultValue = 1


_TmnxMgmtIfOutAuthMdInterfaces_Type.__name__ = "TruthValue"
_TmnxMgmtIfOutAuthMdInterfaces_Object = MibScalar
tmnxMgmtIfOutAuthMdInterfaces = _TmnxMgmtIfOutAuthMdInterfaces_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 50, 1),
    _TmnxMgmtIfOutAuthMdInterfaces_Type()
)
tmnxMgmtIfOutAuthMdInterfaces.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxMgmtIfOutAuthMdInterfaces.setStatus("current")


class _TmnxMgmtIfMDCliCmdAccntLoad_Type(TruthValue):
    """Custom type tmnxMgmtIfMDCliCmdAccntLoad based on TruthValue"""
    defaultValue = 1


_TmnxMgmtIfMDCliCmdAccntLoad_Type.__name__ = "TruthValue"
_TmnxMgmtIfMDCliCmdAccntLoad_Object = MibScalar
tmnxMgmtIfMDCliCmdAccntLoad = _TmnxMgmtIfMDCliCmdAccntLoad_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 50, 2),
    _TmnxMgmtIfMDCliCmdAccntLoad_Type()
)
tmnxMgmtIfMDCliCmdAccntLoad.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxMgmtIfMDCliCmdAccntLoad.setStatus("current")


class _TmnxMgmtIfOutAuthTelData_Type(TruthValue):
    """Custom type tmnxMgmtIfOutAuthTelData based on TruthValue"""
    defaultValue = 2


_TmnxMgmtIfOutAuthTelData_Type.__name__ = "TruthValue"
_TmnxMgmtIfOutAuthTelData_Object = MibScalar
tmnxMgmtIfOutAuthTelData = _TmnxMgmtIfOutAuthTelData_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 22, 50, 3),
    _TmnxMgmtIfOutAuthTelData_Type()
)
tmnxMgmtIfOutAuthTelData.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxMgmtIfOutAuthTelData.setStatus("current")
...
tmnxPkiCAProfAtCrlUpdEntry.registerAugmentions(
    ("TIMETRA-SECURITY-MIB",
     "tmnxPkiCAProfManCrlUpdEntry")
)
...
if mibBuilder.loadTexts:
    tmnxSecurityRadiusV5v0Group.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSecurityTacPlusV8v0Group.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSecurityUserV12v0Group.setStatus("obsolete")
...
tmnxSecurityKeyChainV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 93)
)
tmnxSecurityKeyChainV13v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxKeyChainKeyOption")
)
if mibBuilder.loadTexts:
    tmnxSecurityKeyChainV13v0Group.setStatus("current")

tmnxPkiCAProf13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 94)
)
tmnxPkiCAProf13v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfActnDomain"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfActnInetAddrType"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfActnInetAddr"))
)
if mibBuilder.loadTexts:
    tmnxPkiCAProf13v0Group.setStatus("current")

tmnxSecurityNotifyObjsV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 96)
)
tmnxSecurityNotifyObjsV13v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfileNameForNotify"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFileSize"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiExpRemainingHours"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiExpRemainingMinutes"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiExpReason"))
)
if mibBuilder.loadTexts:
    tmnxSecurityNotifyObjsV13v0Group.setStatus("current")

tmnxCertExpWarningV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 98)
)
tmnxCertExpWarningV13v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCertExpWarningHours"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCertExpWarningRepeatHrs"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCRLExpWarningHours"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCRLExpWarningRepeatHrs"))
)
if mibBuilder.loadTexts:
    tmnxCertExpWarningV13v0Group.setStatus("current")

tmnxCliScriptAuthUserV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 99)
)
tmnxCliScriptAuthUserV13v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxCliScriptAuthTblLastChange"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliScriptAuthRowStatus"))
)
if mibBuilder.loadTexts:
    tmnxCliScriptAuthUserV13v0Group.setStatus("current")

tmnxSecurityRadiusV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 100)
)
tmnxSecurityRadiusV13v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxRadiusInteractiveAuthen")
)
if mibBuilder.loadTexts:
    tmnxSecurityRadiusV13v0Group.setStatus("current")

tmnxSecCertRldNotifyObjsV13v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 101)
)
tmnxSecCertRldNotifyObjsV13v0Grp.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFileType")
)
if mibBuilder.loadTexts:
    tmnxSecCertRldNotifyObjsV13v0Grp.setStatus("current")

tmnxPkiCAProfAtCrlUpdV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 103)
)
tmnxPkiCAProfAtCrlUpdV13v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdTblLstChgd"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdLastChgd"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdAdminState"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdScheduleT"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdPrdcUpdIntv"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdPreUpdTime"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdRetryIntv"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdLstSucsEtId"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdLstSucsTmSt"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdLstSucsTmEd"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdNxCrlUpdTm"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlCurUpdStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlCurUpdEtId"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfUrlTablLastChgd"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfUrlRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfUrlLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfUrlFileTransProf"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfManCrlUpdAct"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfManCrlUpdAbort"))
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfAtCrlUpdV13v0Group.setStatus("current")

tmnxCliSessionGroupV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 104)
)
tmnxCliSessionGroupV13v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxCliSessionGroupTableLstChgd"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliSessionGroupLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliSessionGroupRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliSessionGroupDescription"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliSessionGroupSshLimit"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliSessionGroupTelnetLimit"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliSessionGroupTotalLimit"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileSshLimit"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileTelnetLimit"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileTotalLimit"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileCliSessionGroup"))
)
if mibBuilder.loadTexts:
    tmnxCliSessionGroupV13v0Group.setStatus("current")

tmnxSecPwdHistNotifyObjsV12v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 105)
)
tmnxSecPwdHistNotifyObjsV12v0Grp.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxSecPwdHistLoadFailReason")
)
if mibBuilder.loadTexts:
    tmnxSecPwdHistNotifyObjsV12v0Grp.setStatus("current")

tmnxSecVsdGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 107)
)
tmnxSecVsdGroup.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxVsdPassword")
)
if mibBuilder.loadTexts:
    tmnxSecVsdGroup.setStatus("current")

tmnxSessLimNotifyObjsV13v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 108)
)
tmnxSessLimNotifyObjsV13v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSessionLimitExceededName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSessionLimitExceededType"))
)
if mibBuilder.loadTexts:
    tmnxSessLimNotifyObjsV13v0Grp.setStatus("current")

tmnxSecNotifyObjsV14v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 110)
)
tmnxSecNotifyObjsV14v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddrType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddr"))
)
if mibBuilder.loadTexts:
    tmnxSecNotifyObjsV14v0Grp.setStatus("current")

tmnxSecuritySSHv2PubKeyV14v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 112)
)
tmnxSecuritySSHv2PubKeyV14v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxUserPubEcdsaKeyRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserPubEcdsaKeyLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserPubEcdsaKeyName"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserPubEcdsaKeyDescription"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserPublicKeyDescription"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserPubKeyTableLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserPubEcdsaKeyTblLstChgd"))
)
if mibBuilder.loadTexts:
    tmnxSecuritySSHv2PubKeyV14v0Grp.setStatus("current")

tmnxPkiCAProfCrlSizeLimtV14v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 113)
)
tmnxPkiCAProfCrlSizeLimtV14v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlCurUpdStartTime"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdLstFailedId"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdLstFailTmSt"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdLstFailTmEd"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdLstFailReas"))
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlSizeLimtV14v0Grp.setStatus("current")

tmnxSecurityNetconfLockV14v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 114)
)
tmnxSecurityNetconfLockV14v0Grp.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxUserProfileNCLock")
)
if mibBuilder.loadTexts:
    tmnxSecurityNetconfLockV14v0Grp.setStatus("current")

tmnxSecurityRadiusV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 115)
)
tmnxSecurityRadiusV14v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxRadiusAdminStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxRadiusAccounting"),
        ("TIMETRA-SECURITY-MIB", "tmnxRadiusAuthorization"),
        ("TIMETRA-SECURITY-MIB", "tmnxRadiusTimeout"),
...
if mibBuilder.loadTexts:
    tmnxSecurityRadiusV14v0Group.setStatus("current")

tmnxSecurityTacPlusV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 116)
)
tmnxSecurityTacPlusV14v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxTacPlusAdminStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxTacPlusTimeout"),
        ("TIMETRA-SECURITY-MIB", "tmnxTacPlusServerSecret"),
        ("TIMETRA-SECURITY-MIB", "tmnxTacPlusServerRowStatus"),
...
if mibBuilder.loadTexts:
    tmnxSecurityTacPlusV14v0Group.setStatus("current")

tmnxSecurityObsoletedV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 117)
)
tmnxSecurityObsoletedV14v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxRadiusConfigured"),
        ("TIMETRA-SECURITY-MIB", "tmnxTacPlusConfigured"))
)
if mibBuilder.loadTexts:
    tmnxSecurityObsoletedV14v0Group.setStatus("current")

tmnxSecurityPasswordsV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 118)
)
tmnxSecurityPasswordsV14v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxPasswordAuthenOrder4")
)
if mibBuilder.loadTexts:
    tmnxSecurityPasswordsV14v0Group.setStatus("current")

tmnxSecNotifyObjsV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 119)
)
tmnxSecNotifyObjsV14v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxSecNotifClientAppName")
)
if mibBuilder.loadTexts:
    tmnxSecNotifyObjsV14v0Group.setStatus("current")

tmnxSecurityGrpcV15v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 122)
)
tmnxSecurityGrpcV15v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthGet"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthSet"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthSubscribe"))
)
if mibBuilder.loadTexts:
    tmnxSecurityGrpcV15v0Grp.setStatus("current")

tmnxPkiCNV15v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 123)
)
tmnxPkiCNV15v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCNListLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCNListParamCNType"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCNListParamCNValue"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCNListParamLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCNListParamRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCNListParamTableLstChgd"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCNListRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCNListTableLastChanged"))
)
if mibBuilder.loadTexts:
    tmnxPkiCNV15v0Grp.setStatus("current")

tmnxSecuritySSHMacListV15v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 124)
)
tmnxSecuritySSHMacListV15v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSSHMacName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerMacListTableLstChgd"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerMacListLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerMacListRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerMacListNumber"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientMacListTableLstChgd"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientMacListLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientMacListRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientMacListNumber"))
)
if mibBuilder.loadTexts:
    tmnxSecuritySSHMacListV15v0Group.setStatus("current")

tmnxSecuritySSHKeyReExV15v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 125)
)
tmnxSecuritySSHKeyReExV15v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSSHServerKeyReExLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerKeyReExAdminState"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerKeyReExMinutes"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerKeyReExMBytes"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientKeyReExLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientKeyReExAdminState"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientKeyReExMinutes"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientKeyReExMBytes"))
)
if mibBuilder.loadTexts:
    tmnxSecuritySSHKeyReExV15v0Group.setStatus("current")

tmnxSecUserV15v1Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 127)
)
tmnxSecUserV15v1Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxUserCliEngine1"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserCliEngine2"))
)
if mibBuilder.loadTexts:
    tmnxSecUserV15v1Group.setStatus("current")

tmnxCAProfileV15v1Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 128)
)
tmnxCAProfileV15v1Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCmpSvcName"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfOcspSvcName"))
)
if mibBuilder.loadTexts:
    tmnxCAProfileV15v1Group.setStatus("current")

tmnxSecurityGrpcV16v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 130)
)
tmnxSecurityGrpcV16v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthGnmiCap"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthRAModify"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthRAGetVer"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthCMRotate"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthCMInstall"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthCMGetCert"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthCMRevoke"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthCMCanGen"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthMdCliSess"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthSysSetPkg"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthSysSwCP"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthSysReboot"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthSysRebtSt"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileGrpcAuthSysCnRebt"))
)
if mibBuilder.loadTexts:
    tmnxSecurityGrpcV16v0Grp.setStatus("current")

tmnxHashControlV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 131)
)
tmnxHashControlV16v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPassHashWriteVersionMdCli"),
        ("TIMETRA-SECURITY-MIB", "tmnxPassHashWriteVersionNetconf"),
        ("TIMETRA-SECURITY-MIB", "tmnxPassHashWriteVersionGrpc"))
)
if mibBuilder.loadTexts:
    tmnxHashControlV16v0Group.setStatus("current")

tmnxPkiV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 132)
)
tmnxPkiV16v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxPkiImportedFormat")
)
if mibBuilder.loadTexts:
    tmnxPkiV16v0Group.setStatus("current")

tmnxCAProfileV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 133)
)
tmnxCAProfileV16v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfOcspTransProf")
)
if mibBuilder.loadTexts:
    tmnxCAProfileV16v0Group.setStatus("current")

tmnxServerAccessCtlV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 134)
)
tmnxServerAccessCtlV16v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxAllowServersAccess"),
        ("TIMETRA-SECURITY-MIB", "tmnxServerAccessCtlObjsLstChgd"))
)
if mibBuilder.loadTexts:
    tmnxServerAccessCtlV16v0Group.setStatus("current")

tmnxSecUserV19v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 135)
)
tmnxSecUserV19v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxUserProfileRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileDefaultAction"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileMatchRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserProfileMatchDescription"),
        ...
        ("TIMETRA-SECURITY-MIB", "tmnxTemplateConsoleLoginExecFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxTemplateProfile"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserPasswordChangedTime"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserPasswordExpirationTime"))
)
if mibBuilder.loadTexts:
    tmnxSecUserV19v0Group.setStatus("current")

tmnxSecUserV19v0GroupObsoleted = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 136)
)
tmnxSecUserV19v0GroupObsoleted.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxUserPasswordChanged")
)
if mibBuilder.loadTexts:
    tmnxSecUserV19v0GroupObsoleted.setStatus("current")

tmnxSecuritySSHKexListV19v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 137)
)
tmnxSecuritySSHKexListV19v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSSHKexName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerKexListTableLstChgd"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerKexListLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerKexListRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHServerKexListNumber"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientKexListTableLstChgd"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientKexListLastChanged"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientKexListRowStatus"),
        ("TIMETRA-SECURITY-MIB", "tmnxSSHClientKexListNumber"))
)
if mibBuilder.loadTexts:
    tmnxSecuritySSHKexListV19v0Group.setStatus("current")

tmnxSecurityNiapsNotifyObjsGrp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 140)
)
tmnxSecurityNiapsNotifyObjsGrp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyCurve"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyKeySize"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyKeyType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyImportExportType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyImportExportFormat"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyCertificateProtocol"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyNewUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecEventOutcome"))
)
if mibBuilder.loadTexts:
    tmnxSecurityNiapsNotifyObjsGrp.setStatus("current")

tmnxSecurityMafV20v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 141)
)
tmnxSecurityMafV20v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxMafMatchSrcIpPrefixList")
)
if mibBuilder.loadTexts:
    tmnxSecurityMafV20v0Group.setStatus("current")

tmnxSecurityMgmtIfV20v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 142)
)
tmnxSecurityMgmtIfV20v0Group.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxMgmtIfOutAuthMdInterfaces"),
        ("TIMETRA-SECURITY-MIB", "tmnxMgmtIfMDCliCmdAccntLoad"),
        ("TIMETRA-SECURITY-MIB", "tmnxMgmtIfOutAuthTelData"))
)
if mibBuilder.loadTexts:
    tmnxSecurityMgmtIfV20v0Group.setStatus("current")

tmnxSecurityNotifyObjsV20v0Grp = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 143)
)
tmnxSecurityNotifyObjsV20v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyDestUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFileUnzipResult"))
)
if mibBuilder.loadTexts:
    tmnxSecurityNotifyObjsV20v0Grp.setStatus("current")

tmnxSecurityPasswordsV20v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 145)
)
tmnxSecurityPasswordsV20v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxPasswordHashing")
)
if mibBuilder.loadTexts:
    tmnxSecurityPasswordsV20v0Group.setStatus("current")

tmnxSecUserV20v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 146)
)
tmnxSecUserV20v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxUserCreationOrigin")
)
if mibBuilder.loadTexts:
    tmnxSecUserV20v0Group.setStatus("current")

tmnxSecPwdHashNotifyObjsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 148)
)
tmnxSecPwdHashNotifyObjsGroup.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifNewPasswordHashing"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifOldPasswordHashing"))
)
if mibBuilder.loadTexts:
    tmnxSecPwdHashNotifyObjsGroup.setStatus("current")

tmnxSecUsrPwdNotifyObjsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 150)
)
tmnxSecUsrPwdNotifyObjsGroup.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyLocalUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAdminUserName"))
)
if mibBuilder.loadTexts:
    tmnxSecUsrPwdNotifyObjsGroup.setStatus("current")
...
tmnxPkiCertBeforeExpWarning = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 28)
)
tmnxPkiCertBeforeExpWarning.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiExpRemainingHours"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiExpRemainingMinutes"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifClientAppName"))
...
if mibBuilder.loadTexts:
    tmnxPkiCertBeforeExpWarning.setStatus(
        "current"
    )

tmnxPkiCertAfterExpWarning = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 29)
)
tmnxPkiCertAfterExpWarning.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifClientAppName"))
)
if mibBuilder.loadTexts:
    tmnxPkiCertAfterExpWarning.setStatus(
        "current"
    )

tmnxPkiCertExpWarningCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 30)
)
tmnxPkiCertExpWarningCleared.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiExpReason"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifClientAppName"))
)
if mibBuilder.loadTexts:
    tmnxPkiCertExpWarningCleared.setStatus(
        "current"
    )

tmnxPkiCRLBeforeExpWarning = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 31)
)
tmnxPkiCRLBeforeExpWarning.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiExpRemainingHours"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiExpRemainingMinutes"))
)
if mibBuilder.loadTexts:
    tmnxPkiCRLBeforeExpWarning.setStatus(
        "current"
    )

tmnxPkiCRLAfterExpWarning = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 32)
)
tmnxPkiCRLAfterExpWarning.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile")
)
if mibBuilder.loadTexts:
    tmnxPkiCRLAfterExpWarning.setStatus(
        "current"
    )

tmnxPkiCRLExpWarningCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 33)
)
tmnxPkiCRLExpWarningCleared.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiExpReason"))
)
if mibBuilder.loadTexts:
    tmnxPkiCRLExpWarningCleared.setStatus(
        "current"
    )

tmnxSecNotifFileReloaded = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 34)
)
tmnxSecNotifFileReloaded.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFileType"))
)
if mibBuilder.loadTexts:
    tmnxSecNotifFileReloaded.setStatus(
        "current"
    )

tmnxSecPwdHistoryFileLoadFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 35)
)
tmnxSecPwdHistoryFileLoadFailed.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxSecPwdHistLoadFailReason")
)
if mibBuilder.loadTexts:
    tmnxSecPwdHistoryFileLoadFailed.setStatus(
        "current"
    )

tmnxSecPwdHistoryFileWriteFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 36)
)
if mibBuilder.loadTexts:
    tmnxSecPwdHistoryFileWriteFailed.setStatus(
        "current"
    )

tmnxPkiCAProfCrlUpdateStart = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 37)
)
tmnxPkiCAProfCrlUpdateStart.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfileNameForNotify")
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlUpdateStart.setStatus(
        "current"
    )

tmnxPkiCAProfCrlUpdateSuccess = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 38)
)
tmnxPkiCAProfCrlUpdateSuccess.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfUrl")
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlUpdateSuccess.setStatus(
        "current"
    )

tmnxPkiCAProfCrlUpdateUrlFail = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 39)
)
tmnxPkiCAProfCrlUpdateUrlFail.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFailureReason"))
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlUpdateUrlFail.setStatus(
        "current"
    )

tmnxPkiCAProfCrlUpdAllUrlsFail = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 40)
)
tmnxPkiCAProfCrlUpdAllUrlsFail.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFailureReason"))
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlUpdAllUrlsFail.setStatus(
        "current"
    )

tmnxPkiFileWriteFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 41)
)
tmnxPkiFileWriteFailed.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFailureReason"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFileSize"))
)
if mibBuilder.loadTexts:
    tmnxPkiFileWriteFailed.setStatus(
        "current"
    )

tmnxPkiCAProfCrlUpdNoNxtUpdTime = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 42)
)
tmnxPkiCAProfCrlUpdNoNxtUpdTime.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfileNameForNotify")
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlUpdNoNxtUpdTime.setStatus(
        "current"
    )

tmnxUsrProfSessionLimitExceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 43)
)
tmnxUsrProfSessionLimitExceeded.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSessionLimitExceededName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSessionLimitExceededType"))
)
if mibBuilder.loadTexts:
    tmnxUsrProfSessionLimitExceeded.setStatus(
        "current"
    )

tmnxCliGroupSessionLimitExceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 44)
)
tmnxCliGroupSessionLimitExceeded.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSessionLimitExceededName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSessionLimitExceededType"))
)
if mibBuilder.loadTexts:
    tmnxCliGroupSessionLimitExceeded.setStatus(
        "current"
    )

tmnxPkiCAProfCrlUpdLargPreUpdTm = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 45)
)
tmnxPkiCAProfCrlUpdLargPreUpdTm.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfileNameForNotify")
)
if mibBuilder.loadTexts:
    tmnxPkiCAProfCrlUpdLargPreUpdTm.setStatus(
        "current"
    )

tmnxUserCliLoginMaxAttempts = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 46)
)
tmnxUserCliLoginMaxAttempts.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddrType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddr"),
        ("TIMETRA-SECURITY-MIB", "tmnxPasswordAttemptsCount"),
...
if mibBuilder.loadTexts:
    tmnxUserCliLoginMaxAttempts.setStatus(
        "current"
    )

tmnxUserFtpLoginMaxAttempts = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 47)
)
tmnxUserFtpLoginMaxAttempts.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddrType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddr"),
        ("TIMETRA-SECURITY-MIB", "tmnxPasswordAttemptsCount"),
...
if mibBuilder.loadTexts:
    tmnxUserFtpLoginMaxAttempts.setStatus(
        "current"
    )

tmnxUserSshLoginMaxAttempts = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 48)
)
tmnxUserSshLoginMaxAttempts.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddrType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddr"),
        ("TIMETRA-SECURITY-MIB", "tmnxPasswordAttemptsCount"),
...
if mibBuilder.loadTexts:
    tmnxUserSshLoginMaxAttempts.setStatus(
        "current"
    )

tmnxPkiCertNotYetValid = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 49)
)
tmnxPkiCertNotYetValid.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifClientAppName"))
)
if mibBuilder.loadTexts:
    tmnxPkiCertNotYetValid.setStatus(
        "current"
    )

tmnxPkiCRLNotYetValid = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 50)
)
tmnxPkiCRLNotYetValid.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile")
)
if mibBuilder.loadTexts:
    tmnxPkiCRLNotYetValid.setStatus(
        "current"
    )

tmnxLiUserCliLoginMaxAttempts = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 51)
)
tmnxLiUserCliLoginMaxAttempts.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddrType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddr"),
        ("TIMETRA-SECURITY-MIB", "tmnxPasswordAttemptsCount"),
...
if mibBuilder.loadTexts:
    tmnxLiUserCliLoginMaxAttempts.setStatus(
        "current"
    )

tmnxLiUserSshLoginMaxAttempts = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 52)
)
tmnxLiUserSshLoginMaxAttempts.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddrType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddr"),
        ("TIMETRA-SECURITY-MIB", "tmnxPasswordAttemptsCount"),
...
if mibBuilder.loadTexts:
    tmnxLiUserSshLoginMaxAttempts.setStatus(
        "current"
    )

tmnxLiUserFtpLoginMaxAttempts = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 53)
)
tmnxLiUserFtpLoginMaxAttempts.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddrType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddr"),
        ("TIMETRA-SECURITY-MIB", "tmnxPasswordAttemptsCount"),
...
if mibBuilder.loadTexts:
    tmnxLiUserFtpLoginMaxAttempts.setStatus(
        "current"
    )

tmnxAppPkiCertVerificationFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 54)
)
tmnxAppPkiCertVerificationFailed.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifClientAppName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifCert"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFailureReason"))
)
if mibBuilder.loadTexts:
    tmnxAppPkiCertVerificationFailed.setStatus(
        "current"
    )

tmnxUserNetconfLoginMaxAttempts = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 55)
)
tmnxUserNetconfLoginMaxAttempts.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddrType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAddr"),
        ("TIMETRA-SECURITY-MIB", "tmnxPasswordAttemptsCount"),
...
if mibBuilder.loadTexts:
    tmnxUserNetconfLoginMaxAttempts.setStatus(
        "current"
    )

tmnxCertKeyPairGen = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 56)
)
tmnxCertKeyPairGen.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyCurve"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyKeySize"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyKeyType"),
...
if mibBuilder.loadTexts:
    tmnxCertKeyPairGen.setStatus(
        "current"
    )

tmnxCertImport = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 57)
)
tmnxCertImport.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyImportExportType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyImportExportFormat"),
...
if mibBuilder.loadTexts:
    tmnxCertImport.setStatus(
        "current"
    )

tmnxCertExport = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 58)
)
tmnxCertExport.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFile"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyImportExportType"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyImportExportFormat"),
...
if mibBuilder.loadTexts:
    tmnxCertExport.setStatus(
        "current"
    )

tmnxFileDeleted = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 59)
)
tmnxFileDeleted.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecEventOutcome"))
)
if mibBuilder.loadTexts:
    tmnxFileDeleted.setStatus(
        "current"
    )

tmnxFileMoved = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 60)
)
tmnxFileMoved.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyNewUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecEventOutcome"))
)
if mibBuilder.loadTexts:
    tmnxFileMoved.setStatus(
        "current"
    )

tmnxFileCopied = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 61)
)
tmnxFileCopied.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyNewUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecEventOutcome"))
)
if mibBuilder.loadTexts:
    tmnxFileCopied.setStatus(
        "current"
    )

tmnxFileUnzip = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 62)
)
tmnxFileUnzip.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyDestUrl"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFileUnzipResult"))
)
if mibBuilder.loadTexts:
    tmnxFileUnzip.setStatus(
        "current"
    )

tmnxPasswordHashingChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 63)
)
tmnxPasswordHashingChanged.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifNewPasswordHashing"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifOldPasswordHashing"))
)
if mibBuilder.loadTexts:
    tmnxPasswordHashingChanged.setStatus(
        "current"
    )

tmnxUserPasswordChangedByAdmin = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 22, 0, 64)
)
tmnxUserPasswordChangedByAdmin.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecNotifyLocalUserName"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyAdminUserName"))
)
if mibBuilder.loadTexts:
    tmnxUserPasswordChangedByAdmin.setStatus(
        "current"
    )
...
tmnxCertNotifyGroup.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlUpdateStart"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlUpdateSuccess"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlUpdateUrlFail"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlUpdAllUrlsFail"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiFileWriteFailed"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlUpdNoNxtUpdTime"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlUpdLargPreUpdTm"),
...
tmnxCertExpNotificationV13v0Grp = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 97)
)
tmnxCertExpNotificationV13v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxPkiCertNotYetValid"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCRLNotYetValid"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCertBeforeExpWarning"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCertAfterExpWarning"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCertExpWarningCleared"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCRLBeforeExpWarning"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCRLAfterExpWarning"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCRLExpWarningCleared"))
)
if mibBuilder.loadTexts:
    tmnxCertExpNotificationV13v0Grp.setStatus(
        "current"
    )

tmnxCertRldNotificationV13v0Grp = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 102)
)
tmnxCertRldNotificationV13v0Grp.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxSecNotifFileReloaded")
)
if mibBuilder.loadTexts:
    tmnxCertRldNotificationV13v0Grp.setStatus(
        "current"
    )

tmnxSecPwdHistNotifV12v0Grp = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 106)
)
tmnxSecPwdHistNotifV12v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecPwdHistoryFileLoadFailed"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecPwdHistoryFileWriteFailed"))
)
if mibBuilder.loadTexts:
    tmnxSecPwdHistNotifV12v0Grp.setStatus(
        "current"
    )

tmnxSessLimNotifyV13v0Grp = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 109)
)
tmnxSessLimNotifyV13v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxUsrProfSessionLimitExceeded"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliGroupSessionLimitExceeded"))
)
if mibBuilder.loadTexts:
    tmnxSessLimNotifyV13v0Grp.setStatus(
        "current"
    )

tmnxLogMaxAttNotifyV14v0Grp = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 111)
)
tmnxLogMaxAttNotifyV14v0Grp.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxUserCliLoginMaxAttempts"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserFtpLoginMaxAttempts"),
        ("TIMETRA-SECURITY-MIB", "tmnxUserSshLoginMaxAttempts"),
        ("TIMETRA-SECURITY-MIB", "tmnxLiUserCliLoginMaxAttempts"),
        ("TIMETRA-SECURITY-MIB", "tmnxLiUserFtpLoginMaxAttempts"),
        ("TIMETRA-SECURITY-MIB", "tmnxLiUserSshLoginMaxAttempts"))
)
if mibBuilder.loadTexts:
    tmnxLogMaxAttNotifyV14v0Grp.setStatus(
        "current"
    )

tmnxCertNotifyV14v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 120)
)
tmnxCertNotifyV14v0Group.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxAppPkiCertVerificationFailed")
)
if mibBuilder.loadTexts:
    tmnxCertNotifyV14v0Group.setStatus(
        "current"
    )

tmnxLogMaxAttNotifyV15v1Grp = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 129)
)
tmnxLogMaxAttNotifyV15v1Grp.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxUserNetconfLoginMaxAttempts")
)
if mibBuilder.loadTexts:
    tmnxLogMaxAttNotifyV15v1Grp.setStatus(
        "current"
    )

tmnxSecurityNiapsNotifyGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 139)
)
tmnxSecurityNiapsNotifyGroup.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxCertKeyPairGen"),
        ("TIMETRA-SECURITY-MIB", "tmnxCertImport"),
        ("TIMETRA-SECURITY-MIB", "tmnxCertExport"),
        ("TIMETRA-SECURITY-MIB", "tmnxFileDeleted"),
        ("TIMETRA-SECURITY-MIB", "tmnxFileMoved"),
        ("TIMETRA-SECURITY-MIB", "tmnxFileCopied"))
)
if mibBuilder.loadTexts:
    tmnxSecurityNiapsNotifyGroup.setStatus(
        "current"
    )

tmnxSecurityNotificationV20v0Grp = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 144)
)
tmnxSecurityNotificationV20v0Grp.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxFileUnzip")
)
if mibBuilder.loadTexts:
    tmnxSecurityNotificationV20v0Grp.setStatus(
        "current"
    )

tmnxSecPwdHashNotifyGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 149)
)
tmnxSecPwdHashNotifyGroup.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxPasswordHashingChanged")
)
if mibBuilder.loadTexts:
    tmnxSecPwdHashNotifyGroup.setStatus(
        "current"
    )

tmnxSecUsrPwdNotifyGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 2, 151)
)
tmnxSecUsrPwdNotifyGroup.setObjects(
    ("TIMETRA-SECURITY-MIB", "tmnxUserPasswordChangedByAdmin")
)
if mibBuilder.loadTexts:
    tmnxSecUsrPwdNotifyGroup.setStatus(
        "current"
    )
...
tmnxSecurityV12v0Compliance.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecurityUserV12v0Group"),
        ...
        ("TIMETRA-SECURITY-MIB", "tmnxSecPwdHistNotifyObjsV12v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecPwdHistNotifV12v0Grp"))
)
if mibBuilder.loadTexts:
...
tmnxSecurityV13v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 1, 26)
)
tmnxSecurityV13v0Compliance.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecurityUserV12v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityUserActionGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityMafV6v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityPasswordsV12v0Group"),
        ...
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityKeyChainV5v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityKeyChainV12v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityKeyChainV13v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityCpmProtectGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityLiGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityCpmProtNotificationGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityCpmMacFilterGroup"),
        ...
        ("TIMETRA-SECURITY-MIB", "tmnxSecCpmProtProtocolV12v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfRevokeChkGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProf13v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliScriptAuthUserV13v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityNotifyObjsV13v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxCertExpNotificationV13v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxCertExpWarningV13v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityRadiusV13v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecCertRldNotifyObjsV13v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxCertRldNotificationV13v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfAtCrlUpdV13v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxCliSessionGroupV13v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecPwdHistNotifyObjsV12v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecPwdHistNotifV12v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecVsdGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSessLimNotifyV13v0Grp"))
)
if mibBuilder.loadTexts:
    tmnxSecurityV13v0Compliance.setStatus(
        "obsolete"
    )

tmnxSecurityV14v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 1, 27)
)
tmnxSecurityV14v0Compliance.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecurityUserV12v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityUserActionGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityMafV6v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityPasswordsV12v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityRadiusV14v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityTacPlusV11v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityTacPlusV14v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityServerCtlV4v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityCpmGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityPasswordHashGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityCpmIpFilterV11v0Grp"),
        ...
        ("TIMETRA-SECURITY-MIB", "tmnxSecVsdGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSessLimNotifyV13v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxLogMaxAttNotifyV14v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecuritySSHv2PubKeyV14v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCAProfCrlSizeLimtV14v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityNetconfLockV14v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityPasswordsV14v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecNotifyObjsV14v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxCertNotifyV14v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityGrpcV15v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiCNV15v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecuritySSHMacListV15v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecuritySSHKeyReExV15v0Group"))
)
if mibBuilder.loadTexts:
    tmnxSecurityV14v0Compliance.setStatus(
        "obsolete"
    )

tmnxSecurityV15v1Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 1, 28)
)
tmnxSecurityV15v1Compliance.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecUserV15v1Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxCAProfileV15v1Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxLogMaxAttNotifyV15v1Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityMafMacFilterGroup"))
)
if mibBuilder.loadTexts:
    tmnxSecurityV15v1Compliance.setStatus(
        "current"
    )

tmnxSecurityV16v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 1, 29)
)
tmnxSecurityV16v0Compliance.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecurityGrpcV16v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxHashControlV16v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxServerAccessCtlV16v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxPkiV16v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxCAProfileV16v0Group"))
)
if mibBuilder.loadTexts:
    tmnxSecurityV16v0Compliance.setStatus(
        "current"
    )

tmnxSecurityV19v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 1, 30)
)
tmnxSecurityV19v0Compliance.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecurityUserActionGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityMafV6v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityPasswordsV12v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityRadiusV14v0Group"),
        ...
        ("TIMETRA-SECURITY-MIB", "tmnxSecuritySSHMacListV15v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecuritySSHKeyReExV15v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecUserV19v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecuritySSHKexListV19v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityNiapsNotifyGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityNiapsNotifyObjsGrp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityMafV20v0Group"))
)
if mibBuilder.loadTexts:
    tmnxSecurityV19v0Compliance.setStatus(
        "current"
    )

tmnxSecurityV20v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 22, 1, 31)
)
tmnxSecurityV20v0Compliance.setObjects(
      *(("TIMETRA-SECURITY-MIB", "tmnxSecurityMgmtIfV20v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityNotifyObjsV20v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityNotificationV20v0Grp"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecurityPasswordsV20v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecUserV20v0Group"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecPwdHashNotifyObjsGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecPwdHashNotifyGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecUsrPwdNotifyObjsGroup"),
        ("TIMETRA-SECURITY-MIB", "tmnxSecUsrPwdNotifyGroup"))
)
if mibBuilder.loadTexts:
    tmnxSecurityV20v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TProfileAction": TProfileAction,
       "TProfileGrpcRpcAuth": TProfileGrpcRpcAuth,
       "TProfileMatchAction": TProfileMatchAction,
       ...
       "TmnxSessionLimit": TmnxSessionLimit,
       "TmnxPasswordAuthenOrder": TmnxPasswordAuthenOrder,
       "TmnxPkiCNType": TmnxPkiCNType,
       "TSSHMacNumber": TSSHMacNumber,
       "TmnxPassHashReadType": TmnxPassHashReadType,
       "TmnxPassHashWriteType": TmnxPassHashWriteType,
       "TSSHKexNumber": TSSHKexNumber,
       "TmnxPassHashType": TmnxPassHashType,
       ...
       "tmnxSecurityV13v0Compliance": tmnxSecurityV13v0Compliance,
       "tmnxSecurityV14v0Compliance": tmnxSecurityV14v0Compliance,
       "tmnxSecurityV15v1Compliance": tmnxSecurityV15v1Compliance,
       "tmnxSecurityV16v0Compliance": tmnxSecurityV16v0Compliance,
       "tmnxSecurityV19v0Compliance": tmnxSecurityV19v0Compliance,
       "tmnxSecurityV20v0Compliance": tmnxSecurityV20v0Compliance,
       ...
       "tmnxSecurityKeyChainV13v0Group": tmnxSecurityKeyChainV13v0Group,
       "tmnxPkiCAProf13v0Group": tmnxPkiCAProf13v0Group,
       "tmnxSecurityNotifyObjsV13v0Group": tmnxSecurityNotifyObjsV13v0Group,
       "tmnxCertExpNotificationV13v0Grp": tmnxCertExpNotificationV13v0Grp,
       "tmnxCertExpWarningV13v0Group": tmnxCertExpWarningV13v0Group,
       "tmnxCliScriptAuthUserV13v0Group": tmnxCliScriptAuthUserV13v0Group,
       "tmnxSecurityRadiusV13v0Group": tmnxSecurityRadiusV13v0Group,
       "tmnxSecCertRldNotifyObjsV13v0Grp": tmnxSecCertRldNotifyObjsV13v0Grp,
       "tmnxCertRldNotificationV13v0Grp": tmnxCertRldNotificationV13v0Grp,
       "tmnxPkiCAProfAtCrlUpdV13v0Group": tmnxPkiCAProfAtCrlUpdV13v0Group,
       "tmnxCliSessionGroupV13v0Group": tmnxCliSessionGroupV13v0Group,
       "tmnxSecPwdHistNotifyObjsV12v0Grp": tmnxSecPwdHistNotifyObjsV12v0Grp,
       "tmnxSecPwdHistNotifV12v0Grp": tmnxSecPwdHistNotifV12v0Grp,
       "tmnxSecVsdGroup": tmnxSecVsdGroup,
       "tmnxSessLimNotifyObjsV13v0Grp": tmnxSessLimNotifyObjsV13v0Grp,
       "tmnxSessLimNotifyV13v0Grp": tmnxSessLimNotifyV13v0Grp,
       "tmnxSecNotifyObjsV14v0Grp": tmnxSecNotifyObjsV14v0Grp,
       "tmnxLogMaxAttNotifyV14v0Grp": tmnxLogMaxAttNotifyV14v0Grp,
       "tmnxSecuritySSHv2PubKeyV14v0Grp": tmnxSecuritySSHv2PubKeyV14v0Grp,
       "tmnxPkiCAProfCrlSizeLimtV14v0Grp": tmnxPkiCAProfCrlSizeLimtV14v0Grp,
       "tmnxSecurityNetconfLockV14v0Grp": tmnxSecurityNetconfLockV14v0Grp,
       "tmnxSecurityRadiusV14v0Group": tmnxSecurityRadiusV14v0Group,
       "tmnxSecurityTacPlusV14v0Group": tmnxSecurityTacPlusV14v0Group,
       "tmnxSecurityObsoletedV14v0Group": tmnxSecurityObsoletedV14v0Group,
       "tmnxSecurityPasswordsV14v0Group": tmnxSecurityPasswordsV14v0Group,
       "tmnxSecNotifyObjsV14v0Group": tmnxSecNotifyObjsV14v0Group,
       "tmnxCertNotifyV14v0Group": tmnxCertNotifyV14v0Group,
       "tmnxSecurityGrpcV15v0Grp": tmnxSecurityGrpcV15v0Grp,
       "tmnxPkiCNV15v0Grp": tmnxPkiCNV15v0Grp,
       "tmnxSecuritySSHMacListV15v0Group": tmnxSecuritySSHMacListV15v0Group,
       "tmnxSecuritySSHKeyReExV15v0Group": tmnxSecuritySSHKeyReExV15v0Group,
       "tmnxSecUserV15v1Group": tmnxSecUserV15v1Group,
       "tmnxCAProfileV15v1Group": tmnxCAProfileV15v1Group,
       "tmnxLogMaxAttNotifyV15v1Grp": tmnxLogMaxAttNotifyV15v1Grp,
       "tmnxSecurityGrpcV16v0Grp": tmnxSecurityGrpcV16v0Grp,
       "tmnxHashControlV16v0Group": tmnxHashControlV16v0Group,
       "tmnxPkiV16v0Group": tmnxPkiV16v0Group,
       "tmnxCAProfileV16v0Group": tmnxCAProfileV16v0Group,
       "tmnxServerAccessCtlV16v0Group": tmnxServerAccessCtlV16v0Group,
       "tmnxSecUserV19v0Group": tmnxSecUserV19v0Group,
       "tmnxSecUserV19v0GroupObsoleted": tmnxSecUserV19v0GroupObsoleted,
       "tmnxSecuritySSHKexListV19v0Group": tmnxSecuritySSHKexListV19v0Group,
       "tmnxSecurityNiapsNotifyGroup": tmnxSecurityNiapsNotifyGroup,
       "tmnxSecurityNiapsNotifyObjsGrp": tmnxSecurityNiapsNotifyObjsGrp,
       "tmnxSecurityMafV20v0Group": tmnxSecurityMafV20v0Group,
       "tmnxSecurityMgmtIfV20v0Group": tmnxSecurityMgmtIfV20v0Group,
       "tmnxSecurityNotifyObjsV20v0Grp": tmnxSecurityNotifyObjsV20v0Grp,
       "tmnxSecurityNotificationV20v0Grp": tmnxSecurityNotificationV20v0Grp,
       "tmnxSecurityPasswordsV20v0Group": tmnxSecurityPasswordsV20v0Group,
       "tmnxSecUserV20v0Group": tmnxSecUserV20v0Group,
       "tmnxSecPwdHashNotifyObjsGroup": tmnxSecPwdHashNotifyObjsGroup,
       "tmnxSecPwdHashNotifyGroup": tmnxSecPwdHashNotifyGroup,
       "tmnxSecUsrPwdNotifyObjsGroup": tmnxSecUsrPwdNotifyObjsGroup,
       "tmnxSecUsrPwdNotifyGroup": tmnxSecUsrPwdNotifyGroup,
       "tmnxSecurityMGCompliances": tmnxSecurityMGCompliances,
       "tmnxSecurityMobileGatewayGroups": tmnxSecurityMobileGatewayGroups,
       ...
       "tmnxUserProfileSshLimit": tmnxUserProfileSshLimit,
       "tmnxUserProfileTelnetLimit": tmnxUserProfileTelnetLimit,
       "tmnxUserProfileTotalLimit": tmnxUserProfileTotalLimit,
       "tmnxUserProfileCliSessionGroup": tmnxUserProfileCliSessionGroup,
       "tmnxUserProfileNCLock": tmnxUserProfileNCLock,
       "tmnxUserProfileGrpcAuthGet": tmnxUserProfileGrpcAuthGet,
       "tmnxUserProfileGrpcAuthSet": tmnxUserProfileGrpcAuthSet,
       "tmnxUserProfileGrpcAuthSubscribe": tmnxUserProfileGrpcAuthSubscribe,
       "tmnxUserProfileGrpcAuthGnmiCap": tmnxUserProfileGrpcAuthGnmiCap,
       "tmnxUserProfileGrpcAuthRAModify": tmnxUserProfileGrpcAuthRAModify,
       "tmnxUserProfileGrpcAuthRAGetVer": tmnxUserProfileGrpcAuthRAGetVer,
       "tmnxUserProfileGrpcAuthCMRotate": tmnxUserProfileGrpcAuthCMRotate,
       "tmnxUserProfileGrpcAuthCMInstall": tmnxUserProfileGrpcAuthCMInstall,
       "tmnxUserProfileGrpcAuthCMGetCert": tmnxUserProfileGrpcAuthCMGetCert,
       "tmnxUserProfileGrpcAuthCMRevoke": tmnxUserProfileGrpcAuthCMRevoke,
       "tmnxUserProfileGrpcAuthCMCanGen": tmnxUserProfileGrpcAuthCMCanGen,
       "tmnxUserProfileGrpcAuthMdCliSess": tmnxUserProfileGrpcAuthMdCliSess,
       "tmnxUserProfileGrpcAuthSysSetPkg": tmnxUserProfileGrpcAuthSysSetPkg,
       "tmnxUserProfileGrpcAuthSysSwCP": tmnxUserProfileGrpcAuthSysSwCP,
       "tmnxUserProfileGrpcAuthSysReboot": tmnxUserProfileGrpcAuthSysReboot,
       "tmnxUserProfileGrpcAuthSysRebtSt": tmnxUserProfileGrpcAuthSysRebtSt,
       "tmnxUserProfileGrpcAuthSysCnRebt": tmnxUserProfileGrpcAuthSysCnRebt,
       ...
       "tmnxUserCliEngine1": tmnxUserCliEngine1,
       "tmnxUserCliEngine2": tmnxUserCliEngine2,
       "tmnxUserPasswordChangedTime": tmnxUserPasswordChangedTime,
       "tmnxUserPasswordExpirationTime": tmnxUserPasswordExpirationTime,
       "tmnxUserCreationOrigin": tmnxUserCreationOrigin,
       ...
       "tmnxMafMatchSrcIpPrefixList": tmnxMafMatchSrcIpPrefixList,
       ...
       "tmnxVsdPassword": tmnxVsdPassword,
       "tmnxPasswordAuthenOrder4": tmnxPasswordAuthenOrder4,
       "tmnxPasswordHashing": tmnxPasswordHashing,
       ...
       "tmnxRadiusInteractiveAuthen": tmnxRadiusInteractiveAuthen,
       ...
       "tmnxPassHashWriteVersionMdCli": tmnxPassHashWriteVersionMdCli,
       "tmnxPassHashWriteVersionNetconf": tmnxPassHashWriteVersionNetconf,
       "tmnxPassHashWriteVersionGrpc": tmnxPassHashWriteVersionGrpc,
       ...
       "tmnxPkiExpRemainingHours": tmnxPkiExpRemainingHours,
       "tmnxPkiExpRemainingMinutes": tmnxPkiExpRemainingMinutes,
       "tmnxPkiExpReason": tmnxPkiExpReason,
       "tmnxSecNotifFileType": tmnxSecNotifFileType,
       "tmnxSecPwdHistLoadFailReason": tmnxSecPwdHistLoadFailReason,
       "tmnxPkiCAProfileNameForNotify": tmnxPkiCAProfileNameForNotify,
       "tmnxSecNotifFileSize": tmnxSecNotifFileSize,
       "tmnxSessionLimitExceededName": tmnxSessionLimitExceededName,
       "tmnxSessionLimitExceededType": tmnxSessionLimitExceededType,
       "tmnxSecNotifyUserName": tmnxSecNotifyUserName,
       "tmnxSecNotifyAddrType": tmnxSecNotifyAddrType,
       "tmnxSecNotifyAddr": tmnxSecNotifyAddr,
       "tmnxSecNotifClientAppName": tmnxSecNotifClientAppName,
       "tmnxSecNotifyUrl": tmnxSecNotifyUrl,
       "tmnxSecNotifyCurve": tmnxSecNotifyCurve,
       "tmnxSecNotifyKeySize": tmnxSecNotifyKeySize,
       "tmnxSecNotifyKeyType": tmnxSecNotifyKeyType,
       "tmnxSecNotifyImportExportType": tmnxSecNotifyImportExportType,
       "tmnxSecNotifyImportExportFormat": tmnxSecNotifyImportExportFormat,
       "tmnxSecNotifyCertificateProtocol": tmnxSecNotifyCertificateProtocol,
       "tmnxSecNotifyNewUrl": tmnxSecNotifyNewUrl,
       "tmnxSecEventOutcome": tmnxSecEventOutcome,
       "tmnxSecNotifyDestUrl": tmnxSecNotifyDestUrl,
       "tmnxSecNotifFileUnzipResult": tmnxSecNotifFileUnzipResult,
       "tmnxSecNotifNewPasswordHashing": tmnxSecNotifNewPasswordHashing,
       "tmnxSecNotifOldPasswordHashing": tmnxSecNotifOldPasswordHashing,
       "tmnxSecNotifyLocalUserName": tmnxSecNotifyLocalUserName,
       "tmnxSecNotifyAdminUserName": tmnxSecNotifyAdminUserName,
       ...
       "tmnxPkiCAProfCmpSvcName": tmnxPkiCAProfCmpSvcName,
       "tmnxPkiCAProfOcspSvcName": tmnxPkiCAProfOcspSvcName,
       "tmnxPkiCAProfOcspTransProf": tmnxPkiCAProfOcspTransProf,
       ...
       "tmnxPkiCertExpWarningHours": tmnxPkiCertExpWarningHours,
       "tmnxPkiCertExpWarningRepeatHrs": tmnxPkiCertExpWarningRepeatHrs,
       "tmnxPkiCRLExpWarningHours": tmnxPkiCRLExpWarningHours,
       "tmnxPkiCRLExpWarningRepeatHrs": tmnxPkiCRLExpWarningRepeatHrs,
       "tmnxPkiCAProfAtCrlUpdTblLstChgd": tmnxPkiCAProfAtCrlUpdTblLstChgd,
       "tmnxPkiCAProfAtCrlUpdTable": tmnxPkiCAProfAtCrlUpdTable,
       "tmnxPkiCAProfAtCrlUpdEntry": tmnxPkiCAProfAtCrlUpdEntry,
       "tmnxPkiCAProfAtCrlUpdRowStatus": tmnxPkiCAProfAtCrlUpdRowStatus,
       "tmnxPkiCAProfAtCrlUpdLastChgd": tmnxPkiCAProfAtCrlUpdLastChgd,
       "tmnxPkiCAProfAtCrlUpdAdminState": tmnxPkiCAProfAtCrlUpdAdminState,
       "tmnxPkiCAProfAtCrlUpdScheduleT": tmnxPkiCAProfAtCrlUpdScheduleT,
       "tmnxPkiCAProfAtCrlUpdPrdcUpdIntv": tmnxPkiCAProfAtCrlUpdPrdcUpdIntv,
       "tmnxPkiCAProfAtCrlUpdPreUpdTime": tmnxPkiCAProfAtCrlUpdPreUpdTime,
       "tmnxPkiCAProfAtCrlUpdRetryIntv": tmnxPkiCAProfAtCrlUpdRetryIntv,
       "tmnxPkiCAProfAtCrlUpdLstSucsEtId": tmnxPkiCAProfAtCrlUpdLstSucsEtId,
       "tmnxPkiCAProfAtCrlUpdLstSucsTmSt": tmnxPkiCAProfAtCrlUpdLstSucsTmSt,
       "tmnxPkiCAProfAtCrlUpdLstSucsTmEd": tmnxPkiCAProfAtCrlUpdLstSucsTmEd,
       "tmnxPkiCAProfAtCrlUpdNxCrlUpdTm": tmnxPkiCAProfAtCrlUpdNxCrlUpdTm,
       "tmnxPkiCAProfUrlTablLastChgd": tmnxPkiCAProfUrlTablLastChgd,
       "tmnxPkiCAProfUrlTable": tmnxPkiCAProfUrlTable,
       "tmnxPkiCAProfUrlEntry": tmnxPkiCAProfUrlEntry,
       "tmnxPkiCAProfUrlId": tmnxPkiCAProfUrlId,
       "tmnxPkiCAProfUrlRowStatus": tmnxPkiCAProfUrlRowStatus,
       "tmnxPkiCAProfUrlLastChanged": tmnxPkiCAProfUrlLastChanged,
       "tmnxPkiCAProfUrl": tmnxPkiCAProfUrl,
       "tmnxPkiCAProfUrlFileTransProf": tmnxPkiCAProfUrlFileTransProf,
       "tmnxPkiCAProfManCrlUpdTable": tmnxPkiCAProfManCrlUpdTable,
       "tmnxPkiCAProfManCrlUpdEntry": tmnxPkiCAProfManCrlUpdEntry,
       "tmnxPkiCAProfManCrlUpdAct": tmnxPkiCAProfManCrlUpdAct,
       "tmnxPkiCAProfManCrlUpdAbort": tmnxPkiCAProfManCrlUpdAbort,
       "tmnxPkiCAProfCrlUpdTable": tmnxPkiCAProfCrlUpdTable,
       "tmnxPkiCAProfCrlUpdEntry": tmnxPkiCAProfCrlUpdEntry,
       "tmnxPkiCAProfCrlCurUpdStatus": tmnxPkiCAProfCrlCurUpdStatus,
       "tmnxPkiCAProfCrlCurUpdEtId": tmnxPkiCAProfCrlCurUpdEtId,
       "tmnxPkiCAProfCrlCurUpdStartTime": tmnxPkiCAProfCrlCurUpdStartTime,
       "tmnxPkiCAProfAtCrlUpdLstFailedId": tmnxPkiCAProfAtCrlUpdLstFailedId,
       "tmnxPkiCAProfAtCrlUpdLstFailTmSt": tmnxPkiCAProfAtCrlUpdLstFailTmSt,
       "tmnxPkiCAProfAtCrlUpdLstFailTmEd": tmnxPkiCAProfAtCrlUpdLstFailTmEd,
       "tmnxPkiCAProfAtCrlUpdLstFailReas": tmnxPkiCAProfAtCrlUpdLstFailReas,
       ...
       "tmnxPkiCAProfActnDomain": tmnxPkiCAProfActnDomain,
       "tmnxPkiCAProfActnInetAddrType": tmnxPkiCAProfActnInetAddrType,
       "tmnxPkiCAProfActnInetAddr": tmnxPkiCAProfActnInetAddr,
       "tmnxPkiCNListTableLastChanged": tmnxPkiCNListTableLastChanged,
       "tmnxPkiCNListTable": tmnxPkiCNListTable,
       "tmnxPkiCNListEntry": tmnxPkiCNListEntry,
       "tmnxPkiCNListName": tmnxPkiCNListName,
       "tmnxPkiCNListLastChanged": tmnxPkiCNListLastChanged,
       "tmnxPkiCNListRowStatus": tmnxPkiCNListRowStatus,
       "tmnxPkiCNListParamTableLstChgd": tmnxPkiCNListParamTableLstChgd,
       "tmnxPkiCNListParamTable": tmnxPkiCNListParamTable,
       "tmnxPkiCNListParamEntry": tmnxPkiCNListParamEntry,
       "tmnxPkiCNListParamIndex": tmnxPkiCNListParamIndex,
       "tmnxPkiCNListParamLastChanged": tmnxPkiCNListParamLastChanged,
       "tmnxPkiCNListParamRowStatus": tmnxPkiCNListParamRowStatus,
       "tmnxPkiCNListParamCNType": tmnxPkiCNListParamCNType,
       "tmnxPkiCNListParamCNValue": tmnxPkiCNListParamCNValue,
       "tmnxPkiImportedFormat": tmnxPkiImportedFormat,
       ...
       "tmnxUserPublicKeyDescription": tmnxUserPublicKeyDescription,
       "tmnxUserPubKeyTableLastChanged": tmnxUserPubKeyTableLastChanged,
       "tmnxUserPubEcdsaKeyTable": tmnxUserPubEcdsaKeyTable,
       "tmnxUserPubEcdsaKeyEntry": tmnxUserPubEcdsaKeyEntry,
       "tmnxUserPubEcdsaKeyNumber": tmnxUserPubEcdsaKeyNumber,
       "tmnxUserPubEcdsaKeyRowStatus": tmnxUserPubEcdsaKeyRowStatus,
       "tmnxUserPubEcdsaKeyLastChanged": tmnxUserPubEcdsaKeyLastChanged,
       "tmnxUserPubEcdsaKeyName": tmnxUserPubEcdsaKeyName,
       "tmnxUserPubEcdsaKeyDescription": tmnxUserPubEcdsaKeyDescription,
       "tmnxUserPubEcdsaKeyTblLstChgd": tmnxUserPubEcdsaKeyTblLstChgd,
       ...
       "tmnxCliScriptAuthObjs": tmnxCliScriptAuthObjs,
       "tmnxCliScriptAuthTblLastChange": tmnxCliScriptAuthTblLastChange,
       "tmnxCliScriptAuthTable": tmnxCliScriptAuthTable,
       "tmnxCliScriptAuthEntry": tmnxCliScriptAuthEntry,
       "tmnxCliScriptAuthUserType": tmnxCliScriptAuthUserType,
       "tmnxCliScriptAuthUserName": tmnxCliScriptAuthUserName,
       "tmnxCliScriptAuthRowStatus": tmnxCliScriptAuthRowStatus,
       "tmnxCliSessionGroupTableLstChgd": tmnxCliSessionGroupTableLstChgd,
       "tmnxCliSessionGroupTable": tmnxCliSessionGroupTable,
       "tmnxCliSessionGroupEntry": tmnxCliSessionGroupEntry,
       "tmnxCliSessionGroupName": tmnxCliSessionGroupName,
       "tmnxCliSessionGroupLastChanged": tmnxCliSessionGroupLastChanged,
       "tmnxCliSessionGroupRowStatus": tmnxCliSessionGroupRowStatus,
       "tmnxCliSessionGroupDescription": tmnxCliSessionGroupDescription,
       "tmnxCliSessionGroupSshLimit": tmnxCliSessionGroupSshLimit,
       "tmnxCliSessionGroupTelnetLimit": tmnxCliSessionGroupTelnetLimit,
       "tmnxCliSessionGroupTotalLimit": tmnxCliSessionGroupTotalLimit,
       "tmnxSSHMacTable": tmnxSSHMacTable,
       "tmnxSSHMacEntry": tmnxSSHMacEntry,
       "tmnxSSHMacNumber": tmnxSSHMacNumber,
       "tmnxSSHMacName": tmnxSSHMacName,
       "tmnxSSHServerMacListTableLstChgd": tmnxSSHServerMacListTableLstChgd,
       "tmnxSSHServerMacListTable": tmnxSSHServerMacListTable,
       "tmnxSSHServerMacListEntry": tmnxSSHServerMacListEntry,
       "tmnxSSHServerMacListIndex": tmnxSSHServerMacListIndex,
       "tmnxSSHServerMacListLastChanged": tmnxSSHServerMacListLastChanged,
       "tmnxSSHServerMacListRowStatus": tmnxSSHServerMacListRowStatus,
       "tmnxSSHServerMacListNumber": tmnxSSHServerMacListNumber,
       "tmnxSSHClientMacListTableLstChgd": tmnxSSHClientMacListTableLstChgd,
       "tmnxSSHClientMacListTable": tmnxSSHClientMacListTable,
       "tmnxSSHClientMacListEntry": tmnxSSHClientMacListEntry,
       "tmnxSSHClientMacListIndex": tmnxSSHClientMacListIndex,
       "tmnxSSHClientMacListLastChanged": tmnxSSHClientMacListLastChanged,
       "tmnxSSHClientMacListRowStatus": tmnxSSHClientMacListRowStatus,
       "tmnxSSHClientMacListNumber": tmnxSSHClientMacListNumber,
       "tmnxSSHServerKeyReExchangeObjs": tmnxSSHServerKeyReExchangeObjs,
       "tmnxSSHServerKeyReExLastChanged": tmnxSSHServerKeyReExLastChanged,
       "tmnxSSHServerKeyReExAdminState": tmnxSSHServerKeyReExAdminState,
       "tmnxSSHServerKeyReExMinutes": tmnxSSHServerKeyReExMinutes,
       "tmnxSSHServerKeyReExMBytes": tmnxSSHServerKeyReExMBytes,
       "tmnxSSHClientKeyReExchangeObjs": tmnxSSHClientKeyReExchangeObjs,
       "tmnxSSHClientKeyReExLastChanged": tmnxSSHClientKeyReExLastChanged,
       "tmnxSSHClientKeyReExAdminState": tmnxSSHClientKeyReExAdminState,
       "tmnxSSHClientKeyReExMinutes": tmnxSSHClientKeyReExMinutes,
       "tmnxSSHClientKeyReExMBytes": tmnxSSHClientKeyReExMBytes,
       "tmnxServerAccessCtlObjs": tmnxServerAccessCtlObjs,
       "tmnxAllowServersAccess": tmnxAllowServersAccess,
       "tmnxServerAccessCtlObjsLstChgd": tmnxServerAccessCtlObjsLstChgd,
       "tmnxSSHKexTable": tmnxSSHKexTable,
       "tmnxSSHKexEntry": tmnxSSHKexEntry,
       "tmnxSSHKexNumber": tmnxSSHKexNumber,
       "tmnxSSHKexName": tmnxSSHKexName,
       "tmnxSSHServerKexListTableLstChgd": tmnxSSHServerKexListTableLstChgd,
       "tmnxSSHServerKexListTable": tmnxSSHServerKexListTable,
       "tmnxSSHServerKexListEntry": tmnxSSHServerKexListEntry,
       "tmnxSSHServerKexListIndex": tmnxSSHServerKexListIndex,
       "tmnxSSHServerKexListLastChanged": tmnxSSHServerKexListLastChanged,
       "tmnxSSHServerKexListRowStatus": tmnxSSHServerKexListRowStatus,
       "tmnxSSHServerKexListNumber": tmnxSSHServerKexListNumber,
       "tmnxSSHClientKexListTableLstChgd": tmnxSSHClientKexListTableLstChgd,
       "tmnxSSHClientKexListTable": tmnxSSHClientKexListTable,
       "tmnxSSHClientKexListEntry": tmnxSSHClientKexListEntry,
       "tmnxSSHClientKexListIndex": tmnxSSHClientKexListIndex,
       "tmnxSSHClientKexListLastChanged": tmnxSSHClientKexListLastChanged,
       "tmnxSSHClientKexListRowStatus": tmnxSSHClientKexListRowStatus,
       "tmnxSSHClientKexListNumber": tmnxSSHClientKexListNumber,
       "tmnxSysSecurityMgmtIfOutputAuth": tmnxSysSecurityMgmtIfOutputAuth,
       "tmnxMgmtIfOutAuthMdInterfaces": tmnxMgmtIfOutAuthMdInterfaces,
       "tmnxMgmtIfMDCliCmdAccntLoad": tmnxMgmtIfMDCliCmdAccntLoad,
       "tmnxMgmtIfOutAuthTelData": tmnxMgmtIfOutAuthTelData,
       ...
       "tmnxPkiCertBeforeExpWarning": tmnxPkiCertBeforeExpWarning,
       "tmnxPkiCertAfterExpWarning": tmnxPkiCertAfterExpWarning,
       "tmnxPkiCertExpWarningCleared": tmnxPkiCertExpWarningCleared,
       "tmnxPkiCRLBeforeExpWarning": tmnxPkiCRLBeforeExpWarning,
       "tmnxPkiCRLAfterExpWarning": tmnxPkiCRLAfterExpWarning,
       "tmnxPkiCRLExpWarningCleared": tmnxPkiCRLExpWarningCleared,
       "tmnxSecNotifFileReloaded": tmnxSecNotifFileReloaded,
       "tmnxSecPwdHistoryFileLoadFailed": tmnxSecPwdHistoryFileLoadFailed,
       "tmnxSecPwdHistoryFileWriteFailed": tmnxSecPwdHistoryFileWriteFailed,
       "tmnxPkiCAProfCrlUpdateStart": tmnxPkiCAProfCrlUpdateStart,
       "tmnxPkiCAProfCrlUpdateSuccess": tmnxPkiCAProfCrlUpdateSuccess,
       "tmnxPkiCAProfCrlUpdateUrlFail": tmnxPkiCAProfCrlUpdateUrlFail,
       "tmnxPkiCAProfCrlUpdAllUrlsFail": tmnxPkiCAProfCrlUpdAllUrlsFail,
       "tmnxPkiFileWriteFailed": tmnxPkiFileWriteFailed,
       "tmnxPkiCAProfCrlUpdNoNxtUpdTime": tmnxPkiCAProfCrlUpdNoNxtUpdTime,
       "tmnxUsrProfSessionLimitExceeded": tmnxUsrProfSessionLimitExceeded,
       "tmnxCliGroupSessionLimitExceeded": tmnxCliGroupSessionLimitExceeded,
       "tmnxPkiCAProfCrlUpdLargPreUpdTm": tmnxPkiCAProfCrlUpdLargPreUpdTm,
       "tmnxUserCliLoginMaxAttempts": tmnxUserCliLoginMaxAttempts,
       "tmnxUserFtpLoginMaxAttempts": tmnxUserFtpLoginMaxAttempts,
       "tmnxUserSshLoginMaxAttempts": tmnxUserSshLoginMaxAttempts,
       "tmnxPkiCertNotYetValid": tmnxPkiCertNotYetValid,
       "tmnxPkiCRLNotYetValid": tmnxPkiCRLNotYetValid,
       "tmnxLiUserCliLoginMaxAttempts": tmnxLiUserCliLoginMaxAttempts,
       "tmnxLiUserSshLoginMaxAttempts": tmnxLiUserSshLoginMaxAttempts,
       "tmnxLiUserFtpLoginMaxAttempts": tmnxLiUserFtpLoginMaxAttempts,
       "tmnxAppPkiCertVerificationFailed": tmnxAppPkiCertVerificationFailed,
       "tmnxUserNetconfLoginMaxAttempts": tmnxUserNetconfLoginMaxAttempts,
       "tmnxCertKeyPairGen": tmnxCertKeyPairGen,
       "tmnxCertImport": tmnxCertImport,
       "tmnxCertExport": tmnxCertExport,
       "tmnxFileDeleted": tmnxFileDeleted,
       "tmnxFileMoved": tmnxFileMoved,
       "tmnxFileCopied": tmnxFileCopied,
       "tmnxFileUnzip": tmnxFileUnzip,
       "tmnxPasswordHashingChanged": tmnxPasswordHashingChanged,
       "tmnxUserPasswordChangedByAdmin": tmnxUserPasswordChangedByAdmin}
)
