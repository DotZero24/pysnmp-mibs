...
rlPfcGlobalEnable=_RlPfcGlobalEnable_Object((1,3,6,1,4,1,4526,17,148,1),_RlPfcGlobalEnable_Type())
rlPfcGlobalEnable.setMaxAccess(_B)
if mibBuilder.loadTexts:rlPfcGlobalEnable.setStatus(_A)
_RlPfcPortTable_Object=MibTable
rlPfcPortTable=_RlPfcPortTable_Object((1,3,6,1,4,1,4526,17,148,2))
if mibBuilder.loadTexts:rlPfcPortTable.setStatus(_A)
_RlPfcPortEntry_Object=MibTableRow
rlPfcPortEntry=_RlPfcPortEntry_Object((1,3,6,1,4,1,4526,17,148,2,1))
...
rlPfcPortEnableAdmin=_RlPfcPortEnableAdmin_Object((1,3,6,1,4,1,4526,17,148,2,1,1),_RlPfcPortEnableAdmin_Type())
...
rlPfcPortEnableOper=_RlPfcPortEnableOper_Object((1,3,6,1,4,1,4526,17,148,2,1,2),_RlPfcPortEnableOper_Type())
...
rlPfcPriorityTable=_RlPfcPriorityTable_Object((1,3,6,1,4,1,4526,17,148,3))
if mibBuilder.loadTexts:rlPfcPriorityTable.setStatus(_A)
_RlPfcPriorityEntry_Object=MibTableRow
rlPfcPriorityEntry=_RlPfcPriorityEntry_Object((1,3,6,1,4,1,4526,17,148,3,1))
...
rlPfcPriority=_RlPfcPriority_Object((1,3,6,1,4,1,4526,17,148,3,1,1),_RlPfcPriority_Type())
...
rlPfcPriorityEnable=_RlPfcPriorityEnable_Object((1,3,6,1,4,1,4526,17,148,3,1,2),_RlPfcPriorityEnable_Type())
...
rlPfcPriorityEnableOperStatus=_RlPfcPriorityEnableOperStatus_Object((1,3,6,1,4,1,4526,17,148,3,1,3),_RlPfcPriorityEnableOperStatus_Type())
...
rlPfcPriorityEnableOperStatusReason=_RlPfcPriorityEnableOperStatusReason_Object((1,3,6,1,4,1,4526,17,148,3,1,4),_RlPfcPriorityEnableOperStatusReason_Type())
