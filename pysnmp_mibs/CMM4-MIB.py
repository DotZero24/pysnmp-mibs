...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cambium/CMM4-MIB
...
mibBuilder.exportSymbols("CMM4-MIB", cmm4SnmpAccessSubnet9=cmm4SnmpAccessSubnet9, cmm4SnmpAccessSubnet6=cmm4SnmpAccessSubnet6, cmm4SnmpTrapIp4=cmm4SnmpTrapIp4, cmm4SnmpAccessSubnet3=cmm4SnmpAccessSubnet3, cmm4PortDevType=cmm4PortDevType, cmm4SnmpTrapIp9=cmm4SnmpTrapIp9, cmm4FPGAPlatform=cmm4FPGAPlatform, cmm4pldVersion=cmm4pldVersion, cmm4GPSNoSync=cmm4GPSNoSync, userPswd=userPswd, cmm4PortPowerCfg=cmm4PortPowerCfg, longitude=longitude, gpsSyncStatus=gpsSyncStatus, gpsAntennaConnection=gpsAntennaConnection, gpsTrackingMode=gpsTrackingMode, cmm4SnmpAccessSubnet5=cmm4SnmpAccessSubnet5, cmm4IpAccess2=cmm4IpAccess2, cmm4NTPServerIp=cmm4NTPServerIp, cmm4SnmpTrapIp8=cmm4SnmpTrapIp8, syncStatus=syncStatus, cmm4PortResetCfg=cmm4PortResetCfg, cmm4PortText=cmm4PortText, cmm4Status=cmm4Status, cmm4PortStatusTable=cmm4PortStatusTable, cmm4SnmpTrapIp3=cmm4SnmpTrapIp3, cmm4GPSEvent=cmm4GPSEvent, cmm4RebootIfRequired=cmm4RebootIfRequired, cmm4SnmpTrapIp5=cmm4SnmpTrapIp5, cmm4StatusGroup=cmm4StatusGroup, cmm4SnmpAccessSubnet4=cmm4SnmpAccessSubnet4, defaultGateway=defaultGateway, cmm4ConfigGroup=cmm4ConfigGroup, height=height, cmm4SnmpGPSSyncTrapEnable=cmm4SnmpGPSSyncTrapEnable, cmm4Event=cmm4Event, cmm4Gps=cmm4Gps, accessLevel=accessLevel, cmm4SnmpTrapIp10=cmm4SnmpTrapIp10, cmm4PortPowerStatus=cmm4PortPowerStatus, cmm4UserTable=cmm4UserTable, cmm4SnmpAccessSubnet7=cmm4SnmpAccessSubnet7, satellitesTracked=satellitesTracked, gpsDate=gpsDate, cmm4EventLog=cmm4EventLog, deviceType=deviceType, portCfgIndex=portCfgIndex, lan1Ip=lan1Ip, defaultStatus=defaultStatus, gpsSyncMasterSlave=gpsSyncMasterSlave, vlanEnable=vlanEnable, gpsLatitude=gpsLatitude, trackingMode=trackingMode, cmm4MacAddress=cmm4MacAddress, entryIndex=entryIndex, satellitesVisible=satellitesVisible, cmm4MibModule=cmm4MibModule, gpsSatellitesVisible=gpsSatellitesVisible, cmm4SnmpAccessSubnet8=cmm4SnmpAccessSubnet8, gpsTime=gpsTime, gpsSatellitesTracked=gpsSatellitesTracked, cmm4SnmpTrapIp6=cmm4SnmpTrapIp6, cmm4SoftwareVersion=cmm4SoftwareVersion, gpsHeight=gpsHeight, gpsReceiverInfo=gpsReceiverInfo, cmm4WebAutoUpdate=cmm4WebAutoUpdate, cmm4FPGAVersion=cmm4FPGAVersion, cmm4PortCfgGroup=cmm4PortCfgGroup, cmm4Snmp=cmm4Snmp, cmm4ExtEthPowerReset=cmm4ExtEthPowerReset, cmm4SnmpAccessSubnet2=cmm4SnmpAccessSubnet2, latitude=latitude, siteInfoViewable=siteInfoViewable, cmm4SnmpReadOnly=cmm4SnmpReadOnly, gpsReInitCount=gpsReInitCount, gpsRestartCount=gpsRestartCount, cmm4ControlsGroup=cmm4ControlsGroup, cmm4Reboot=cmm4Reboot, cmm4Config=cmm4Config, gpsTimingPulse=gpsTimingPulse, gpsLongitude=gpsLongitude, sessionTimeout=sessionTimeout, cmm4Controls=cmm4Controls, cmm4UserTableGroup=cmm4UserTableGroup, cmm4ExtEthPwrStat=cmm4ExtEthPwrStat, cmm4UserEntry=cmm4UserEntry, cmm4SnmpComString=cmm4SnmpComString, cmm4PortStatusGroup=cmm4PortStatusGroup, cmm4SystemTime=cmm4SystemTime, gpsLog=gpsLog, cmm4PortCfgEntry=cmm4PortCfgEntry, cmm4SnmpTrapIp2=cmm4SnmpTrapIp2, cmm4SnmpAccessSubnet=cmm4SnmpAccessSubnet, cmm4PortStatusEntry=cmm4PortStatusEntry, cmm4SnmpTrapIp7=cmm4SnmpTrapIp7, lan1SubnetMask=lan1SubnetMask, cmm4ClearEventLog=cmm4ClearEventLog, cmm4IpAccess3=cmm4IpAccess3, cmm4SNMPGroup=cmm4SNMPGroup, cmm4IpAccess1=cmm4IpAccess1, PYSNMP_MODULE_ID=cmm4MibModule, cmm4MgmtPortSpeed=cmm4MgmtPortSpeed, cmm4GPSGroup=cmm4GPSGroup, userLoginName=userLoginName, gpsInvalidMsg=gpsInvalidMsg, cmm4UpTime=cmm4UpTime, managementVID=managementVID, cmm4SnmpTrapIp1=cmm4SnmpTrapIp1, cmm4IpAccessFilter=cmm4IpAccessFilter, eventLog=eventLog, ntpLog=ntpLog, cmm4Groups=cmm4Groups, cmm4PortCfgTable=cmm4PortCfgTable, cmm4GPSInSync=cmm4GPSInSync, cmm4SnmpAccessSubnet10=cmm4SnmpAccessSubnet10, portStatusIndex=portStatusIndex)
