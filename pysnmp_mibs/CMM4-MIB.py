...
mibBuilder.exportSymbols("CMM4-MIB", lan1SubnetMask=lan1SubnetMask, cmm4SnmpTrapIp5=cmm4SnmpTrapIp5, cmm4SnmpTrapIp2=cmm4SnmpTrapIp2, eventLog=eventLog, cmm4RebootIfRequired=cmm4RebootIfRequired, portCfgIndex=portCfgIndex, trackingMode=trackingMode, cmm4ExtEthPwrStat=cmm4ExtEthPwrStat, cmm4SnmpTrapIp7=cmm4SnmpTrapIp7, cmm4pldVersion=cmm4pldVersion, entryIndex=entryIndex, cmm4IpAccess1=cmm4IpAccess1, cmm4UpTime=cmm4UpTime, cmm4UserEntry=cmm4UserEntry, cmm4PortCfgEntry=cmm4PortCfgEntry, cmm4SnmpTrapIp4=cmm4SnmpTrapIp4, gpsRestartCount=gpsRestartCount, cmm4Config=cmm4Config, cmm4GPSInSync=cmm4GPSInSync, cmm4StatusGroup=cmm4StatusGroup, cmm4ControlsGroup=cmm4ControlsGroup, cmm4MgmtPortSpeed=cmm4MgmtPortSpeed, defaultStatus=defaultStatus, cmm4GPSNoSync=cmm4GPSNoSync, cmm4SNMPGroup=cmm4SNMPGroup, cmm4ClearEventLog=cmm4ClearEventLog, cmm4IpAccessFilter=cmm4IpAccessFilter, syncStatus=syncStatus, gpsSyncStatus=gpsSyncStatus, accessLevel=accessLevel, cmm4SnmpAccessSubnet8=cmm4SnmpAccessSubnet8, cmm4Gps=cmm4Gps, gpsSatellitesTracked=gpsSatellitesTracked, cmm4SnmpAccessSubnet=cmm4SnmpAccessSubnet, longitude=longitude, cmm4WebAutoUpdate=cmm4WebAutoUpdate, cmm4MacAddress=cmm4MacAddress, cmm4SnmpTrapIp3=cmm4SnmpTrapIp3, cmm4PortPowerStatus=cmm4PortPowerStatus, cmm4FPGAPlatform=cmm4FPGAPlatform, cmm4PortDevType=cmm4PortDevType, PYSNMP_MODULE_ID=cmm4MibModule, cmm4SnmpGPSSyncTrapEnable=cmm4SnmpGPSSyncTrapEnable, cmm4PortCfgGroup=cmm4PortCfgGroup, ntpLog=ntpLog, cmm4SnmpReadOnly=cmm4SnmpReadOnly, cmm4SnmpAccessSubnet6=cmm4SnmpAccessSubnet6, cmm4PortStatusEntry=cmm4PortStatusEntry, gpsTimingPulse=gpsTimingPulse, cmm4SnmpComString=cmm4SnmpComString, cmm4PortStatusGroup=cmm4PortStatusGroup, cmm4ConfigGroup=cmm4ConfigGroup, cmm4Event=cmm4Event, gpsSatellitesVisible=gpsSatellitesVisible, cmm4PortPowerCfg=cmm4PortPowerCfg, cmm4SnmpTrapIp8=cmm4SnmpTrapIp8, cmm4SnmpAccessSubnet2=cmm4SnmpAccessSubnet2, latitude=latitude, gpsLog=gpsLog, cmm4Groups=cmm4Groups, cmm4SystemTime=cmm4SystemTime, gpsReInitCount=gpsReInitCount, cmm4EventLog=cmm4EventLog, lan1Ip=lan1Ip, cmm4IpAccess2=cmm4IpAccess2, cmm4SnmpAccessSubnet10=cmm4SnmpAccessSubnet10, cmm4Controls=cmm4Controls, cmm4FPGAVersion=cmm4FPGAVersion, cmm4SoftwareVersion=cmm4SoftwareVersion, gpsInvalidMsg=gpsInvalidMsg, cmm4UserTableGroup=cmm4UserTableGroup, deviceType=deviceType, cmm4SnmpAccessSubnet4=cmm4SnmpAccessSubnet4, cmm4GPSEvent=cmm4GPSEvent, height=height, cmm4SnmpTrapIp6=cmm4SnmpTrapIp6, cmm4SnmpAccessSubnet7=cmm4SnmpAccessSubnet7, managementVID=managementVID, cmm4SnmpAccessSubnet5=cmm4SnmpAccessSubnet5, gpsTime=gpsTime, cmm4PortStatusTable=cmm4PortStatusTable, siteInfoViewable=siteInfoViewable, cmm4IpAccess3=cmm4IpAccess3, userLoginName=userLoginName, cmm4PortText=cmm4PortText, cmm4GPSGroup=cmm4GPSGroup, cmm4PortResetCfg=cmm4PortResetCfg, vlanEnable=vlanEnable, gpsTrackingMode=gpsTrackingMode, gpsSyncMasterSlave=gpsSyncMasterSlave, cmm4SnmpTrapIp9=cmm4SnmpTrapIp9, cmm4SnmpTrapIp1=cmm4SnmpTrapIp1, cmm4Status=cmm4Status, cmm4ExtEthPowerReset=cmm4ExtEthPowerReset, gpsAntennaConnection=gpsAntennaConnection, gpsDate=gpsDate, userPswd=userPswd, cmm4Snmp=cmm4Snmp, cmm4PortCfgTable=cmm4PortCfgTable, sessionTimeout=sessionTimeout, portStatusIndex=portStatusIndex, gpsReceiverInfo=gpsReceiverInfo, gpsLongitude=gpsLongitude, gpsLatitude=gpsLatitude, cmm4SnmpAccessSubnet9=cmm4SnmpAccessSubnet9, satellitesVisible=satellitesVisible, cmm4Reboot=cmm4Reboot, satellitesTracked=satellitesTracked, cmm4NTPServerIp=cmm4NTPServerIp, cmm4MibModule=cmm4MibModule, cmm4UserTable=cmm4UserTable, cmm4SnmpAccessSubnet3=cmm4SnmpAccessSubnet3, defaultGateway=defaultGateway, cmm4SnmpTrapIp10=cmm4SnmpTrapIp10, gpsHeight=gpsHeight)
