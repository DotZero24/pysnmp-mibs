...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VIRTUAL-SWITCH-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:25:16 2025
...
cvsMIBCompliance.setObjects(
      *(("CISCO-VIRTUAL-SWITCH-MIB", "cvsGlobalGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsModuleGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsCoreSwitchGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsChassisGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsVSLConnectionGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsVSLStatisticsGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsConnectionNotifsGroup"))
)
if mibBuilder.loadTexts:
...
cvsMIBComplianceV02.setObjects(
      *(("CISCO-VIRTUAL-SWITCH-MIB", "cvsGlobalGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsModuleGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsVssModuleStandbyGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsCoreSwitchGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsChassisGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsVSLConnectionGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsVSLStatisticsGroup"),
...
cvsMIBComplianceV03.setObjects(
      *(("CISCO-VIRTUAL-SWITCH-MIB", "cvsGlobalGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsModuleGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsVssModuleStandbyGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsCoreSwitchGroup"),
        ...
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsConnectionNotifsGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsVSLStatisticsExtGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsCoreSwitchLocationGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsDualActiveDetectionNotifsControlGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsDualActiveDetectionNotifsInfoGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsDualActiveDetectionNotifsGroup"))
)
if mibBuilder.loadTexts:
...
cvsMIBComplianceV04.setObjects(
      *(("CISCO-VIRTUAL-SWITCH-MIB", "cvsGlobalGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsModuleGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsVssModuleStandbyGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsCoreSwitchGroup"),
        ...
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsDualActiveDetectionNotifsInfoGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsDualActiveDetectionNotifsGroup"),
        ("CISCO-VIRTUAL-SWITCH-MIB", "cvsVSLLinkPortGroup"))
)
if mibBuilder.loadTexts:
