...
# Notes
# -----
# ASN.1 source file://mibs/zhone/ZHONE-RMON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:11:58 2025
...
rmonCompliance.setObjects(
      *(("ZHONE-RMON-MIB", "zhoneRmonEtherStatsGroup"),
        ("ZHONE-RMON-MIB", "rmonHistoryControlGroup"),
        ("ZHONE-RMON-MIB", "rmonEthernetHistoryGroup"),
        ("ZHONE-RMON-MIB", "rmonAlarmGroup"),
        ("ZHONE-RMON-MIB", "rmonHostGroup"),
        ("ZHONE-RMON-MIB", "rmonHostTopNGroup"),
        ("ZHONE-RMON-MIB", "rmonMatrixGroup"),
        ("ZHONE-RMON-MIB", "rmonFilterGroup"),
        ("ZHONE-RMON-MIB", "rmonPacketCaptureGroup"),
        ("ZHONE-RMON-MIB", "rmonEventGroup"))
)
if mibBuilder.loadTexts:
