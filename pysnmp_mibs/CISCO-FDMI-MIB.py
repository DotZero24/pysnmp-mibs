...
mibBuilder.exportSymbols("CISCO-FDMI-MIB", ciscoFdmiMIBNotifications=ciscoFdmiMIBNotifications, cfdmiHbaInfoDriverVer=cfdmiHbaInfoDriverVer, cfdmiHbaInfoModelDescr=cfdmiHbaInfoModelDescr, cfdmiHbaPortId=cfdmiHbaPortId, cfdmiHbaInformationGroup=cfdmiHbaInformationGroup, cfdmiHbaInfoHwVer=cfdmiHbaInfoHwVer, PYSNMP_MODULE_ID=ciscoFdmiMIB, ciscoFdmiMIBConformance=ciscoFdmiMIBConformance, ciscoFdmiMIBCompliance=ciscoFdmiMIBCompliance, cfdmiRejectRegNotify=cfdmiRejectRegNotify, cfdmiHbaPortSupportedSpeed=cfdmiHbaPortSupportedSpeed, ciscoFdmiMIBGroups=ciscoFdmiMIBGroups, ciscoFdmiMIBObjects=ciscoFdmiMIBObjects, cfdmiConfig=cfdmiConfig, cfdmiNotificationGroup=cfdmiNotificationGroup, cfdmiHbaPortCurrentSpeed=cfdmiHbaPortCurrentSpeed, cfdmiHbaPortHostName=cfdmiHbaPortHostName, cfdmiNotifyHBAPortId=cfdmiNotifyHBAPortId, cfdmiHbaInfoEntry=cfdmiHbaInfoEntry, cfdmiInfo=cfdmiInfo, cfdmiHbaInfoOSInfo=cfdmiHbaInfoOSInfo, cfdmiRejectRegNotifyEnable=cfdmiRejectRegNotifyEnable, cfdmiHbaPortMaxFrameSize=cfdmiHbaPortMaxFrameSize, ciscoFdmiMIBCompliances=ciscoFdmiMIBCompliances, cfdmiHbaPortInformationGroup=cfdmiHbaPortInformationGroup, cfdmiRejectReasonCode=cfdmiRejectReasonCode, cfdmiHbaPortSupportedFC4Type=cfdmiHbaPortSupportedFC4Type, cfdmiRejectReasonCodeExpl=cfdmiRejectReasonCodeExpl, cfdmiNotifyRegOperType=cfdmiNotifyRegOperType, cfdmiHbaInfoId=cfdmiHbaInfoId, cfdmiConfigGroup=cfdmiConfigGroup, CFdmiRejectReasonCode=CFdmiRejectReasonCode, cfdmiStatistics=cfdmiStatistics, cfdmiHbaInfoOptROMVer=cfdmiHbaInfoOptROMVer, cfdmiHbaInfoSn=cfdmiHbaInfoSn, cfdmiHbaPortOsDevName=cfdmiHbaPortOsDevName, cfdmiHbaPortTable=cfdmiHbaPortTable, cfdmiHbaInfoMaxCTPayload=cfdmiHbaInfoMaxCTPayload, cfdmiHbaInfoTable=cfdmiHbaInfoTable, cfdmiHbaPortEntry=cfdmiHbaPortEntry, cfdmiHbaInfoMfg=cfdmiHbaInfoMfg, ciscoFdmiMIB=ciscoFdmiMIB, CFdmiRejectReasonCodeExpl=CFdmiRejectReasonCodeExpl, cfdmiHbaInfoFwVer=cfdmiHbaInfoFwVer, cfdmiHbaInfoNodeName=cfdmiHbaInfoNodeName, cfdmiHbaInfoModel=cfdmiHbaInfoModel)
