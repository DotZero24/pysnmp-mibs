...
mibBuilder.exportSymbols("CISCO-VDC-MIB", ciscoVdcResAvail=ciscoVdcResAvail, ciscoVdcResUsageGroup=ciscoVdcResUsageGroup, ciscoVdcSharedInterfaceRowStatus=ciscoVdcSharedInterfaceRowStatus, ciscoVdcBootOrder=ciscoVdcBootOrder, ciscoVdcFCoEVlansSecond2K=ciscoVdcFCoEVlansSecond2K, ciscoVdcGlobalResUsed=ciscoVdcGlobalResUsed, ciscoVdcMac=ciscoVdcMac, ciscoVdcResTemplateTable=ciscoVdcResTemplateTable, ciscoVdcFCoEVlansFirst2K=ciscoVdcFCoEVlansFirst2K, ciscoVdcFcoeCapable=ciscoVdcFcoeCapable, ciscoVdcRestartCount=ciscoVdcRestartCount, ciscoVdcMaxNumberVdcAllowed=ciscoVdcMaxNumberVdcAllowed, ciscoVdcGlobalResUnused=ciscoVdcGlobalResUnused, ciscoVdcMIBCompliance=ciscoVdcMIBCompliance, ciscoVdcState=ciscoVdcState, ciscoVdcResourceTemplate=ciscoVdcResourceTemplate, ciscoVdcGlobal=ciscoVdcGlobal, ciscoVdcResUnused=ciscoVdcResUnused, ciscoVdcRowStatus=ciscoVdcRowStatus, ciscoVdcFeatureSetList=ciscoVdcFeatureSetList, ciscoVdcIfMembershipifIndex=ciscoVdcIfMembershipifIndex, ciscoVdcGlobalResUsageGroup=ciscoVdcGlobalResUsageGroup, ciscoVdcSwitchId=ciscoVdcSwitchId, ciscoVdcResTemplateMin=ciscoVdcResTemplateMin, ciscoVdcExtGroup=ciscoVdcExtGroup, ciscoVdcMIBConform=ciscoVdcMIBConform, ciscoVdcCpuPriority=ciscoVdcCpuPriority, ciscoVdcStorageType=ciscoVdcStorageType, ciscoVdcMIBNotifs=ciscoVdcMIBNotifs, ciscoVdcResTemplateStorageType=ciscoVdcResTemplateStorageType, ciscoVdcMIBGroups=ciscoVdcMIBGroups, ciscoVdcGlobalResUsageTable=ciscoVdcGlobalResUsageTable, ciscoVdcIfMembershipGroup=ciscoVdcIfMembershipGroup, ciscoVdcResource=ciscoVdcResource, ciscoVdcMIBCompliances=ciscoVdcMIBCompliances, ciscoVdcGroup=ciscoVdcGroup, ciscoVdcResTemplateMax=ciscoVdcResTemplateMax, ciscoVdcExt=ciscoVdcExt, ciscoVdcType=ciscoVdcType, ciscoVdcFCoEVlansGroup=ciscoVdcFCoEVlansGroup, CiscoVdcHaPolicy=CiscoVdcHaPolicy, ciscoVdcTimeCreated=ciscoVdcTimeCreated, ciscoVdcResID=ciscoVdcResID, ciscoVdcDualSupHaPolicy=ciscoVdcDualSupHaPolicy, ciscoVdcName=ciscoVdcName, ciscoVdcMIBObjects=ciscoVdcMIBObjects, ciscoVdcSharedInterfaceEntry=ciscoVdcSharedInterfaceEntry, ciscoVdcSharedInterfaceStorageType=ciscoVdcSharedInterfaceStorageType, CiscoVdcPercentOrMinusOne=CiscoVdcPercentOrMinusOne, ciscoVdcIfMembershipStorageType=ciscoVdcIfMembershipStorageType, ciscoVdcFromUnallocatedIntf=ciscoVdcFromUnallocatedIntf, ciscoVdcGlobalResUsageEntry=ciscoVdcGlobalResUsageEntry, ciscoVdcRestartReason=ciscoVdcRestartReason, ciscoVdcGlobalGroup=ciscoVdcGlobalGroup, ciscoVdcMIBCompliance1=ciscoVdcMIBCompliance1, ciscoVdcSharedInterfaceifIndex=ciscoVdcSharedInterfaceifIndex, ciscoVdcFCoEVlansTable=ciscoVdcFCoEVlansTable, ciscoVdcSharedInterfaceTable=ciscoVdcSharedInterfaceTable, ciscoVdcInterface=ciscoVdcInterface, ciscoVdcSharedInterfaceGroup=ciscoVdcSharedInterfaceGroup, ciscoVdcResTemplateStatus=ciscoVdcResTemplateStatus, ciscoVdcResUsageTable=ciscoVdcResUsageTable, ciscoVdcIfMembershipTable=ciscoVdcIfMembershipTable, ciscoVdcGlobalResFree=ciscoVdcGlobalResFree, ciscoVdcExtTable=ciscoVdcExtTable, ciscoVdcFCoEVlansFromVdc=ciscoVdcFCoEVlansFromVdc, PYSNMP_MODULE_ID=ciscoVdcMIB, ciscoVdcModuleCapList=ciscoVdcModuleCapList, ciscoVdcResMin=ciscoVdcResMin, ciscoVdcIfMembershipStatus=ciscoVdcIfMembershipStatus, ciscoVdcMIB=ciscoVdcMIB, ciscoVdcGlobalResAvail=ciscoVdcGlobalResAvail, ciscoVdcSingleSupHaPolicy=ciscoVdcSingleSupHaPolicy, ciscoVdcId=ciscoVdcId, ciscoVdcIfMembershipEntry=ciscoVdcIfMembershipEntry, ciscoVdcGlobalResID=ciscoVdcGlobalResID, ciscoVdcResMax=ciscoVdcResMax, ciscoVdcResTemplateName=ciscoVdcResTemplateName, ciscoVdcReloadCount=ciscoVdcReloadCount, ciscoVdcRestartTime=ciscoVdcRestartTime, ciscoVdcCpuSharePercent=ciscoVdcCpuSharePercent, ciscoVdcResUsageEntry=ciscoVdcResUsageEntry, ciscoVdcResUsed=ciscoVdcResUsed, ciscoVdcCombinedHostnameEnabled=ciscoVdcCombinedHostnameEnabled, ciscoVdcEntry=ciscoVdcEntry, ciscoVdcGlobalResName=ciscoVdcGlobalResName, ciscoVdcTable=ciscoVdcTable, ciscoVdcExtEntry=ciscoVdcExtEntry, ciscoVdcResTemplateGroup=ciscoVdcResTemplateGroup, ciscoVdcGlobalResTotal=ciscoVdcGlobalResTotal, ciscoVdcResTemplateEntry=ciscoVdcResTemplateEntry, ciscoVdcResTemplateResID=ciscoVdcResTemplateResID, ciscoVdcAdminStatus=ciscoVdcAdminStatus, ciscoVdcFCoEVlansEntry=ciscoVdcFCoEVlansEntry)
