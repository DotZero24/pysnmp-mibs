...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-ETHER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:27:14 2025
...
(CucsConditionRemoteInvRslt,
 ...
 CucsPortEthSpeed,
 CucsPortMode,
 CucsPortapiPeerCapability) = mibBuilder.importSymbols(
...
cucsEtherPIoIsBreakoutXcvr = _CucsEtherPIoIsBreakoutXcvr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 16, 6, 1, 53),
    _CucsEtherPIoIsBreakoutXcvr_Type()
)
cucsEtherPIoIsBreakoutXcvr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsEtherPIoIsBreakoutXcvr.setStatus("current")
_CucsEtherPIoPortCapability_Type = CucsPortapiPeerCapability
_CucsEtherPIoPortCapability_Object = MibTableColumn
cucsEtherPIoPortCapability = _CucsEtherPIoPortCapability_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 16, 6, 1, 54),
    _CucsEtherPIoPortCapability_Type()
)
cucsEtherPIoPortCapability.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsEtherPIoPortCapability.setStatus("current")
...
cucsEtherServerIntFIoUserRecoveryOperation = _CucsEtherServerIntFIoUserRecoveryOperation_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 16, 11, 1, 51),
    _CucsEtherServerIntFIoUserRecoveryOperation_Type()
)
cucsEtherServerIntFIoUserRecoveryOperation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsEtherServerIntFIoUserRecoveryOperation.setStatus("current")
...
cucsEtherPortChanIdElemReserved = _CucsEtherPortChanIdElemReserved_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 16, 16, 1, 7),
    _CucsEtherPortChanIdElemReserved_Type()
)
cucsEtherPortChanIdElemReserved.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsEtherPortChanIdElemReserved.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsEtherObjects": cucsEtherObjects,
       ...
       "cucsEtherPIoIsBreakoutXcvr": cucsEtherPIoIsBreakoutXcvr,
       ...
       "cucsEtherServerIntFIoUserRecoveryOperation": cucsEtherServerIntFIoUserRecoveryOperation,
       ...
       "cucsEtherPortChanIdElemReserved": cucsEtherPortChanIdElemReserved,
