...
# Produced by pysmi-1.6.2 at Fri Oct 10 19:16:04 2025
...
extremePortUtilizationAvgTxPkts64 = _ExtremePortUtilizationAvgTxPkts64_Object(
    (1, 3, 6, 1, 4, 1, 1916, 1, 4, 11, 1, 9),
    _ExtremePortUtilizationAvgTxPkts64_Type()
)
extremePortUtilizationAvgTxPkts64.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    extremePortUtilizationAvgTxPkts64.setStatus("current")
_ExtremePortUtilizationAvgRxPkts64_Type = Counter64
_ExtremePortUtilizationAvgRxPkts64_Object = MibTableColumn
extremePortUtilizationAvgRxPkts64 = _ExtremePortUtilizationAvgRxPkts64_Object(
    (1, 3, 6, 1, 4, 1, 1916, 1, 4, 11, 1, 10),
    _ExtremePortUtilizationAvgRxPkts64_Type()
)
extremePortUtilizationAvgRxPkts64.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    extremePortUtilizationAvgRxPkts64.setStatus("current")
_ExtremePortUtilizationPeakTxPkts64_Type = Counter64
_ExtremePortUtilizationPeakTxPkts64_Object = MibTableColumn
extremePortUtilizationPeakTxPkts64 = _ExtremePortUtilizationPeakTxPkts64_Object(
    (1, 3, 6, 1, 4, 1, 1916, 1, 4, 11, 1, 11),
    _ExtremePortUtilizationPeakTxPkts64_Type()
)
extremePortUtilizationPeakTxPkts64.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    extremePortUtilizationPeakTxPkts64.setStatus("current")
_ExtremePortUtilizationPeakRxPkts64_Type = Counter64
_ExtremePortUtilizationPeakRxPkts64_Object = MibTableColumn
extremePortUtilizationPeakRxPkts64 = _ExtremePortUtilizationPeakRxPkts64_Object(
    (1, 3, 6, 1, 4, 1, 1916, 1, 4, 11, 1, 12),
    _ExtremePortUtilizationPeakRxPkts64_Type()
)
extremePortUtilizationPeakRxPkts64.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    extremePortUtilizationPeakRxPkts64.setStatus("current")
_ExtremePortUtilizationAvgTxBytes64_Type = Counter64
_ExtremePortUtilizationAvgTxBytes64_Object = MibTableColumn
extremePortUtilizationAvgTxBytes64 = _ExtremePortUtilizationAvgTxBytes64_Object(
    (1, 3, 6, 1, 4, 1, 1916, 1, 4, 11, 1, 13),
    _ExtremePortUtilizationAvgTxBytes64_Type()
)
extremePortUtilizationAvgTxBytes64.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    extremePortUtilizationAvgTxBytes64.setStatus("current")
_ExtremePortUtilizationAvgRxBytes64_Type = Counter64
_ExtremePortUtilizationAvgRxBytes64_Object = MibTableColumn
extremePortUtilizationAvgRxBytes64 = _ExtremePortUtilizationAvgRxBytes64_Object(
    (1, 3, 6, 1, 4, 1, 1916, 1, 4, 11, 1, 14),
    _ExtremePortUtilizationAvgRxBytes64_Type()
)
extremePortUtilizationAvgRxBytes64.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    extremePortUtilizationAvgRxBytes64.setStatus("current")
_ExtremePortUtilizationPeakTxBytes64_Type = Counter64
_ExtremePortUtilizationPeakTxBytes64_Object = MibTableColumn
extremePortUtilizationPeakTxBytes64 = _ExtremePortUtilizationPeakTxBytes64_Object(
    (1, 3, 6, 1, 4, 1, 1916, 1, 4, 11, 1, 15),
    _ExtremePortUtilizationPeakTxBytes64_Type()
)
extremePortUtilizationPeakTxBytes64.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    extremePortUtilizationPeakTxBytes64.setStatus("current")
_ExtremePortUtilizationPeakRxBytes64_Type = Counter64
_ExtremePortUtilizationPeakRxBytes64_Object = MibTableColumn
extremePortUtilizationPeakRxBytes64 = _ExtremePortUtilizationPeakRxBytes64_Object(
    (1, 3, 6, 1, 4, 1, 1916, 1, 4, 11, 1, 16),
    _ExtremePortUtilizationPeakRxBytes64_Type()
)
extremePortUtilizationPeakRxBytes64.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    extremePortUtilizationPeakRxBytes64.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ExtremePortTrafficDirection": ExtremePortTrafficDirection,
       ...
       "extremePortUtilizationAvgTxPkts64": extremePortUtilizationAvgTxPkts64,
       "extremePortUtilizationAvgRxPkts64": extremePortUtilizationAvgRxPkts64,
       "extremePortUtilizationPeakTxPkts64": extremePortUtilizationPeakTxPkts64,
       "extremePortUtilizationPeakRxPkts64": extremePortUtilizationPeakRxPkts64,
       "extremePortUtilizationAvgTxBytes64": extremePortUtilizationAvgTxBytes64,
       "extremePortUtilizationAvgRxBytes64": extremePortUtilizationAvgRxBytes64,
       "extremePortUtilizationPeakTxBytes64": extremePortUtilizationPeakTxBytes64,
       "extremePortUtilizationPeakRxBytes64": extremePortUtilizationPeakRxBytes64,
