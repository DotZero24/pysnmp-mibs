...
# Notes
# -----
# ASN.1 source file://mibs/ubiquiti/EdgeSwitch-ROUTING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:58:44 2025
...
agentSwitchIpInterfaceAutoStateMode = _AgentSwitchIpInterfaceAutoStateMode_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 2, 2, 3, 1, 18),
...
agentSwitchIpInterfaceFptiName = _AgentSwitchIpInterfaceFptiName_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 2, 2, 3, 1, 19),
...
agentBootpDhcpRelayIntfEntry = _AgentBootpDhcpRelayIntfEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 2, 6, 10, 1)
)
agentBootpDhcpRelayIntfEntry.setIndexNames(
    (0, "EdgeSwitch-ROUTING-MIB", "agentBootpVlanId"),
)
if mibBuilder.loadTexts:
...
agentBootpVlanId = _AgentBootpVlanId_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 2, 6, 10, 1, 1),
...
agentBootpDhcpRelayIntfCircuitIdOptionMode = _AgentBootpDhcpRelayIntfCircuitIdOptionMode_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 2, 6, 10, 1, 2),
...
agentBootpDhcpRelayIntfCheckReply = _AgentBootpDhcpRelayIntfCheckReply_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 2, 6, 10, 1, 3),
