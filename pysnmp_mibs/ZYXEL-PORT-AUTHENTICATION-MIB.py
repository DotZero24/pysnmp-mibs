...
# Notes
# -----
# ASN.1 source file://mibs/zyxel/ZYXEL-PORT-AUTHENTICATION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:01:49 2025
...
class _ZyPortAuthenticationPortCompoundAuthenticationMode_Type(Integer32):
    """Custom type zyPortAuthenticationPortCompoundAuthenticationMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_ZyPortAuthenticationPortCompoundAuthenticationMode_Type.__name__ = "Integer32"
_ZyPortAuthenticationPortCompoundAuthenticationMode_Object = MibTableColumn
zyPortAuthenticationPortCompoundAuthenticationMode = _ZyPortAuthenticationPortCompoundAuthenticationMode_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 62, 1, 2, 1, 12),
    _ZyPortAuthenticationPortCompoundAuthenticationMode_Type()
)
zyPortAuthenticationPortCompoundAuthenticationMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyPortAuthenticationPortCompoundAuthenticationMode.setStatus("current")
_ZyPortAuthenticationEapolFloodState_Type = EnabledStatus
_ZyPortAuthenticationEapolFloodState_Object = MibScalar
zyPortAuthenticationEapolFloodState = _ZyPortAuthenticationEapolFloodState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 62, 1, 3),
    _ZyPortAuthenticationEapolFloodState_Type()
)
zyPortAuthenticationEapolFloodState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyPortAuthenticationEapolFloodState.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"zyxelPortAuthentication": zyxelPortAuthentication,
       ...
       "zyPortAuthenticationPortCompoundAuthenticationMode": zyPortAuthenticationPortCompoundAuthenticationMode,
       "zyPortAuthenticationEapolFloodState": zyPortAuthenticationEapolFloodState}
)
