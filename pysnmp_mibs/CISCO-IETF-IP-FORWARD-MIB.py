...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-IP-FORWARD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:39:10 2025
...
_CIpForwardMask_Type.__name__ = "IpAddress"
...
_CInetCidrRouteNextHopAS_Type.__name__ = "InetAutonomousSystemNumber"
...
cIpForwardCompliance.setObjects(
    ("CISCO-IETF-IP-FORWARD-MIB", "cIpForwardCidrRouteGroup")
)
if mibBuilder.loadTexts:
...
cIpForwardOldCompliance.setObjects(
    ("CISCO-IETF-IP-FORWARD-MIB", "cIpForwardMultiPathGroup")
)
if mibBuilder.loadTexts:
...
cIpForwardCompliance2.setObjects(
    ("CISCO-IETF-IP-FORWARD-MIB", "cInetForwardCidrRouteGroup")
)
if mibBuilder.loadTexts:
