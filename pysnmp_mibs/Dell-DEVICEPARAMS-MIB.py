# SNMP MIB module (Dell-DEVICEPARAMS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-DEVICEPARAMS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:09 2025
...
rndCommunityEntry.setIndexNames(
    (0, "Dell-DEVICEPARAMS-MIB", "rndCommunityMngStationAddr"),
    (1, "Dell-DEVICEPARAMS-MIB", "rndCommunityString"),
)
if mibBuilder.loadTexts:
...
rndActiveSoftwareFileEntry.setIndexNames(
    (0, "Dell-DEVICEPARAMS-MIB", "rndUnitNumber"),
)
if mibBuilder.loadTexts:
...
rndImageInfoEntry.setIndexNames(
    (0, "Dell-DEVICEPARAMS-MIB", "rndStackUnitNumber"),
)
if mibBuilder.loadTexts:
...
rlComponentsInfoEntry.setIndexNames(
    (0, "Dell-DEVICEPARAMS-MIB", "rlComponentsInfoStackUnitNumber"),
    (0, "Dell-DEVICEPARAMS-MIB", "rlComponentsInfoImageId"),
    (1, "Dell-DEVICEPARAMS-MIB", "rlComponentsInfoComponent"),
)
if mibBuilder.loadTexts:
