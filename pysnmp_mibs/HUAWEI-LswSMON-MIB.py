# SNMP MIB module (HUAWEI-LswSMON-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/HUAWEI-LswSMON-MIB
...
hwdot1qVlanStatStatusEntry = _Hwdot1qVlanStatStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 26, 1, 2, 1)
)
...
hwdot1qVlanStatEnableIndex = _Hwdot1qVlanStatEnableIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 26, 1, 2, 1, 1),
...
hwdot1qVlanStatEnableStatus = _Hwdot1qVlanStatEnableStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 26, 1, 2, 1, 2),
