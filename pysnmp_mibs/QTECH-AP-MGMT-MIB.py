...
mibBuilder.exportSymbols("QTECH-AP-MGMT-MIB", qtechApMgmtMIBObjects=qtechApMgmtMIBObjects, qtechApMgmtMIB=qtechApMgmtMIB, qtechApMode=qtechApMode, qtechApMgmt=qtechApMgmt, PYSNMP_MODULE_ID=qtechApMgmtMIB)
