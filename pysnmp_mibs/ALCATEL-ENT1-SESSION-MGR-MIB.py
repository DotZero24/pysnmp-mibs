# SNMP MIB module (ALCATEL-ENT1-SESSION-MGR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-SESSION-MGR-MIB
...
sessionConfigEntry.setIndexNames(
    (0, "ALCATEL-ENT1-SESSION-MGR-MIB", "sessionType"),
)
if mibBuilder.loadTexts:
...
sessionActiveEntry.setIndexNames(
    (0, "ALCATEL-ENT1-SESSION-MGR-MIB", "sessionIndex"),
)
if mibBuilder.loadTexts:
...
sessionConfigGroup.setObjects(
      *(("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionType"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionBannerFileName"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionInactivityTimerValue"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionDefaultPromptString"))
)
if mibBuilder.loadTexts:
...
sessionActiveGroup.setObjects(
      *(("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionIndex"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionAccessType"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionPhysicalPort"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionUserName"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionUserReadPrivileges"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionUserWritePrivileges"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionUserProfileName"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionUserIpAddress"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionRowStatus"))
)
if mibBuilder.loadTexts:
...
sessionObjectGroup.setObjects(
      *(("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionLoginTimeout"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionLoginAttempt"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionCliCommandLogEnable"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionXonXoffEnable"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionAuthFailure"))
)
if mibBuilder.loadTexts:
...
sessionTrapsGroup.setObjects(
    ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionAuthenticationTrap")
)
if mibBuilder.loadTexts:
...
alcatelIND1SessionMgrMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionConfigGroup"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionActiveGroup"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionObjectGroup"),
        ("ALCATEL-ENT1-SESSION-MGR-MIB", "sessionTrapsGroup"))
)
if mibBuilder.loadTexts:
