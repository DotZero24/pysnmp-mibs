...
mibBuilder.exportSymbols("ALCATEL-ENT1-SESSION-MGR-MIB", sessionLoginTimeout=sessionLoginTimeout, sessionType=sessionType, sessionInactivityTimerValue=sessionInactivityTimerValue, alcatelIND1SessionMgrMIBCompliances=alcatelIND1SessionMgrMIBCompliances, sessionObjectGroup=sessionObjectGroup, sessionLoginAttempt=sessionLoginAttempt, sessionActiveGroup=sessionActiveGroup, sessionPhysicalPort=sessionPhysicalPort, sessionUserProfileName=sessionUserProfileName, sessionAuthFailure=sessionAuthFailure, sessionUserName=sessionUserName, sessionUserWritePrivileges=sessionUserWritePrivileges, alcatelIND1SessionMgrMIBGroups=alcatelIND1SessionMgrMIBGroups, sessionConfigGroup=sessionConfigGroup, alcatelIND1SessionMgrMIBNotifications=alcatelIND1SessionMgrMIBNotifications, sessionBannerFileName=sessionBannerFileName, sessionAccessType=sessionAccessType, sessionActiveEntry=sessionActiveEntry, alcatelIND1SessionMgrMIB=alcatelIND1SessionMgrMIB, sessionRowStatus=sessionRowStatus, sessionCliCommandLogEnable=sessionCliCommandLogEnable, sessionDefaultPromptString=sessionDefaultPromptString, alcatelIND1SessionMgrMIBObjects=alcatelIND1SessionMgrMIBObjects, sessionUserIpAddress=sessionUserIpAddress, sessionMgr=sessionMgr, sessionTrapsGroup=sessionTrapsGroup, switchMgtTrapsObj=switchMgtTrapsObj, alcatelIND1SessionMgrMIBConformance=alcatelIND1SessionMgrMIBConformance, sessionConfigTable=sessionConfigTable, sessionActiveTable=sessionActiveTable, alcatelIND1SessionMgrMIBCompliance=alcatelIND1SessionMgrMIBCompliance, sessionUserReadPrivileges=sessionUserReadPrivileges, sessionConfigEntry=sessionConfigEntry, sessionAuthenticationTrap=sessionAuthenticationTrap, PYSNMP_MODULE_ID=alcatelIND1SessionMgrMIB, sessionXonXoffEnable=sessionXonXoffEnable, sessionIndex=sessionIndex)
