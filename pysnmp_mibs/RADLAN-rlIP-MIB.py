# SNMP MIB module (RADLAN-rlIP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-rlIP-MIB
...
rlIpAddressEntry.setIndexNames(
    (0, "RADLAN-rlIP-MIB", "rlIpAddressAddrType"),
    (0, "RADLAN-rlIP-MIB", "rlIpAddressAddr"),
    (0, "RADLAN-rlIP-MIB", "rlIpAddressOrigin"),
    (0, "RADLAN-rlIP-MIB", "rlIpAddressGeneralPrefixName"),
)
if mibBuilder.loadTexts:
