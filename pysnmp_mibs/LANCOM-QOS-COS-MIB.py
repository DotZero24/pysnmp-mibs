# SNMP MIB module (LANCOM-QOS-COS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-QOS-COS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:19:48 2025
...
agentCosMapIpPrecEntry = _AgentCosMapIpPrecEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 1, 1)
)
agentCosMapIpPrecEntry.setIndexNames(
    (0, "LANCOM-QOS-COS-MIB", "agentCosMapIpPrecIntfIndex"),
    (0, "LANCOM-QOS-COS-MIB", "agentCosMapIpPrecValue"),
)
if mibBuilder.loadTexts:
...
agentCosMapIpPrecIntfIndex = _AgentCosMapIpPrecIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 1, 1, 1),
...
agentCosMapIpPrecValue = _AgentCosMapIpPrecValue_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 1, 1, 2),
...
agentCosMapIpPrecTrafficClass = _AgentCosMapIpPrecTrafficClass_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 1, 1, 3),
...
agentCosMapIpDscpEntry = _AgentCosMapIpDscpEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 2, 1)
)
agentCosMapIpDscpEntry.setIndexNames(
    (0, "LANCOM-QOS-COS-MIB", "agentCosMapIpDscpIntfIndex"),
    (0, "LANCOM-QOS-COS-MIB", "agentCosMapIpDscpValue"),
)
if mibBuilder.loadTexts:
...
agentCosMapIpDscpIntfIndex = _AgentCosMapIpDscpIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 2, 1, 1),
...
agentCosMapIpDscpValue = _AgentCosMapIpDscpValue_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 2, 1, 2),
...
agentCosMapIpDscpTrafficClass = _AgentCosMapIpDscpTrafficClass_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 2, 1, 3),
...
agentCosMapIntfTrustEntry = _AgentCosMapIntfTrustEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 3, 1)
)
agentCosMapIntfTrustEntry.setIndexNames(
    (0, "LANCOM-QOS-COS-MIB", "agentCosMapIntfTrustIntfIndex"),
)
if mibBuilder.loadTexts:
...
agentCosMapIntfTrustIntfIndex = _AgentCosMapIntfTrustIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 3, 1, 1),
...
agentCosMapIntfTrustMode = _AgentCosMapIntfTrustMode_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 3, 1, 2),
...
agentCosMapUntrustedTrafficClass = _AgentCosMapUntrustedTrafficClass_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 3, 1, 3),
...
agentCosMapMplsExpEntry = _AgentCosMapMplsExpEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 4, 1)
)
agentCosMapMplsExpEntry.setIndexNames(
    (0, "LANCOM-QOS-COS-MIB", "agentCosMapMplsExpIntfIndex"),
    (0, "LANCOM-QOS-COS-MIB", "agentCosMapMplsExpValue"),
)
if mibBuilder.loadTexts:
...
agentCosMapMplsExpIntfIndex = _AgentCosMapMplsExpIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 4, 1, 1),
...
agentCosMapMplsExpValue = _AgentCosMapMplsExpValue_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 4, 1, 2),
...
agentCosMapMplsExpTrafficClass = _AgentCosMapMplsExpTrafficClass_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 1, 4, 1, 3),
...
agentCosQueueControlEntry = _AgentCosQueueControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 3, 1)
)
agentCosQueueControlEntry.setIndexNames(
    (0, "LANCOM-QOS-COS-MIB", "agentCosQueueIntfIndex"),
)
if mibBuilder.loadTexts:
...
agentCosQueueIntfIndex = _AgentCosQueueIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 3, 1, 1),
...
agentCosQueueIntfShapingRate = _AgentCosQueueIntfShapingRate_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 3, 1, 2),
...
agentCosQueueMgmtTypeIntf = _AgentCosQueueMgmtTypeIntf_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 3, 1, 3),
...
agentCosQueueWredDecayExponent = _AgentCosQueueWredDecayExponent_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 3, 1, 4),
...
agentCosQueueDefaultsRestore = _AgentCosQueueDefaultsRestore_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 3, 1, 5),
...
agentCosQueueIntfShapingRateUnits = _AgentCosQueueIntfShapingRateUnits_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 3, 1, 6),
...
agentCosQueueIndex = _AgentCosQueueIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 4, 1, 1),
...
agentCosQueueSchedulerType = _AgentCosQueueSchedulerType_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 4, 1, 2),
...
agentCosQueueMinBandwidth = _AgentCosQueueMinBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 4, 1, 3),
...
agentCosQueueMaxBandwidth = _AgentCosQueueMaxBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 4, 1, 4),
...
agentCosQueueMgmtType = _AgentCosQueueMgmtType_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 4, 1, 5),
...
agentCosQueueMgmtEntry = _AgentCosQueueMgmtEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1)
)
agentCosQueueMgmtEntry.setIndexNames(
    (0, "LANCOM-QOS-COS-MIB", "agentCosQueueIntfIndex"),
    (0, "LANCOM-QOS-COS-MIB", "agentCosQueueIndex"),
    (0, "LANCOM-QOS-COS-MIB", "agentCosQueueDropPrecIndex"),
)
if mibBuilder.loadTexts:
...
agentCosQueueDropPrecIndex = _AgentCosQueueDropPrecIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 1),
...
agentCosQueueMgmtTailDropThreshold = _AgentCosQueueMgmtTailDropThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 2),
...
agentCosQueueMgmtWredMinThreshold = _AgentCosQueueMgmtWredMinThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 3),
...
agentCosQueueMgmtWredMaxThreshold = _AgentCosQueueMgmtWredMaxThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 4),
...
agentCosQueueMgmtWredDropProbScale = _AgentCosQueueMgmtWredDropProbScale_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 5),
...
agentCosQueueMgmtPercentTailDropThreshold = _AgentCosQueueMgmtPercentTailDropThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 6),
...
agentCosQueueMgmtPercentWredMinThreshold = _AgentCosQueueMgmtPercentWredMinThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 7),
...
agentCosQueueMgmtPercentWredMaxThreshold = _AgentCosQueueMgmtPercentWredMaxThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 8),
...
agentCosQueueMgmtWredDropProbability = _AgentCosQueueMgmtWredDropProbability_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 9),
...
agentCosQueueMgmtWredEcn = _AgentCosQueueMgmtWredEcn_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 10),
...
agentCosQueueMgmtComboWredMinThreshold = _AgentCosQueueMgmtComboWredMinThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 12),
...
agentCosQueueMgmtComboWredMaxThreshold = _AgentCosQueueMgmtComboWredMaxThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 5, 1, 13),
...
agentCosQueueIntfCounterEntry = _AgentCosQueueIntfCounterEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 6, 1)
)
...
agentCosQueueIntfCounterHCTotalDropPackets = _AgentCosQueueIntfCounterHCTotalDropPackets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 6, 1, 1),
...
agentCosQueueIntfCounterHCTransmitOctets = _AgentCosQueueIntfCounterHCTransmitOctets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 6, 1, 2),
...
agentCosQueueIntfCounterHCReceiveOctets = _AgentCosQueueIntfCounterHCReceiveOctets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 6, 1, 3),
...
agentCosQueueIntfCounterHCDropsGreenPackets = _AgentCosQueueIntfCounterHCDropsGreenPackets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 6, 1, 4),
...
agentCosQueueIntfCounterHCDropsYellowPackets = _AgentCosQueueIntfCounterHCDropsYellowPackets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 6, 1, 5),
...
agentCosQueueIntfCounterHCDropsRedPackets = _AgentCosQueueIntfCounterHCDropsRedPackets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 6, 1, 6),
...
agentCosQueueIntfCounterHCTransmitQueueSizeOctets = _AgentCosQueueIntfCounterHCTransmitQueueSizeOctets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 6, 1, 7),
...
agentCosQueueIntfCounterHCEcnTransmitPackets = _AgentCosQueueIntfCounterHCEcnTransmitPackets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 6, 1, 8),
...
agentCosQueueStatisticsEntry = _AgentCosQueueStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 7, 1)
)
...
agentCosQueueStatisticsHCTotalDropPackets = _AgentCosQueueStatisticsHCTotalDropPackets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 7, 1, 1),
...
agentCosQueueStatisticsHCTotalOctets = _AgentCosQueueStatisticsHCTotalOctets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 7, 1, 2),
...
agentCosQueueStatisticsPeakOctets = _AgentCosQueueStatisticsPeakOctets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 7, 1, 3),
...
agentCosQueueStatisticsCurrentOctets = _AgentCosQueueStatisticsCurrentOctets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 7, 1, 4),
...
agentCosQueueStatisticsAverageOctets = _AgentCosQueueStatisticsAverageOctets_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 3, 3, 2, 7, 1, 5),
