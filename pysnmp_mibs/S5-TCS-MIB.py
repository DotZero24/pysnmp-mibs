...
mibBuilder.exportSymbols("S5-TCS-MIB", BkNetId=BkNetId, PYSNMP_MODULE_ID=s5TcsMib, FddiBkNetMode=FddiBkNetMode, MediaType=MediaType, IpxAddress=IpxAddress, LocChan=LocChan, SrcIndx=SrcIndx, TimeIntervalSec=TimeIntervalSec, BkChan=BkChan, AttId=AttId, TimeIntervalHrd=TimeIntervalHrd, s5TcsMib=s5TcsMib)
