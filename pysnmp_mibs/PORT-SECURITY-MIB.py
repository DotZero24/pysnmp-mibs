# SNMP MIB module (PORT-SECURITY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/PORT-SECURITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:53:05 2025
...
swPortSecPortEntry.setIndexNames(
    (0, "PORT-SECURITY-MIB", "swPortSecPortIndex"),
)
if mibBuilder.loadTexts:
...
swPortSecVLANEntry.setIndexNames(
    (0, "PORT-SECURITY-MIB", "swPortSecVLANID"),
)
if mibBuilder.loadTexts:
...
swPortSecEntriesEntry.setIndexNames(
    (0, "PORT-SECURITY-MIB", "swPortSecMac"),
    (0, "PORT-SECURITY-MIB", "swPortSecVID"),
)
if mibBuilder.loadTexts:
