...
# Notes
# -----
# ASN.1 source file://mibs/dell/DNOS-GREENETHERNET-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:09:52 2025
...
class _AgentGreenEeeTxIdleTime_Type(Unsigned32):
    """Custom type agentGreenEeeTxIdleTime based on Unsigned32"""
...
_AgentGreenEeeTxIdleTime_Type.__name__ = "Unsigned32"
...
class _AgentGreenEeeLpiHistoryIntfPercentLpiTime_Type(Gauge32):
    """Custom type agentGreenEeeLpiHistoryIntfPercentLpiTime based on Gauge32"""
...
_AgentGreenEeeLpiHistoryIntfPercentLpiTime_Type.__name__ = "Gauge32"
...
if mibBuilder.loadTexts:
    agentGreenEeeLpiHistoryIntfPercentLpiTime.setUnits("percent")


class _AgentGreenEeeLpiHistoryIntfPercentLpiTimeTotal_Type(Gauge32):
    """Custom type agentGreenEeeLpiHistoryIntfPercentLpiTimeTotal based on Gauge32"""
    subtypeSpec = Gauge32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_AgentGreenEeeLpiHistoryIntfPercentLpiTimeTotal_Type.__name__ = "Gauge32"
...
if mibBuilder.loadTexts:
    agentGreenEeeLpiHistoryIntfPercentLpiTimeTotal.setUnits("percent")
...
class _AgentGreenEeeLpiHistoryLpiTimePerStack_Type(Gauge32):
    """Custom type agentGreenEeeLpiHistoryLpiTimePerStack based on Gauge32"""
    subtypeSpec = Gauge32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_AgentGreenEeeLpiHistoryLpiTimePerStack_Type.__name__ = "Gauge32"
...
if mibBuilder.loadTexts:
    agentGreenEeeLpiHistoryLpiTimePerStack.setUnits("percent")
...
class _AgentGreenStackPowerSaving_Type(Gauge32):
    """Custom type agentGreenStackPowerSaving based on Gauge32"""
    subtypeSpec = Gauge32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_AgentGreenStackPowerSaving_Type.__name__ = "Gauge32"
...
if mibBuilder.loadTexts:
    agentGreenStackPowerSaving.setUnits("percent")
