...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/NAT-MIB
...
mibBuilder.exportSymbols("NAT-MIB", natAddrMapStorageType=natAddrMapStorageType, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrMapTable=natAddrMapTable, NatAssociationType=NatAssociationType, natSessionPublicDstPort=natSessionPublicDstPort, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionAddrMapIndex=natSessionAddrMapIndex, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natSessionProtocolType=natSessionProtocolType, natMIB=natMIB, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natInterfaceRowStatus=natInterfaceRowStatus, natAddrPortBindId=natAddrPortBindId, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natMIBNotificationGroup=natMIBNotificationGroup, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrMapName=natAddrMapName, natAddrMapEntryType=natAddrMapEntryType, natPacketDiscard=natPacketDiscard, NatBindIdOrZero=NatBindIdOrZero, natSessionPrivateDstPort=natSessionPrivateDstPort, natTranslationGroup=natTranslationGroup, natAddrBindTable=natAddrBindTable, natProtocolOutTranslates=natProtocolOutTranslates, natStatsAddrMapGroup=natStatsAddrMapGroup, NatProtocolMap=NatProtocolMap, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natAddrMapDiscards=natAddrMapDiscards, natStatsProtocolGroup=natStatsProtocolGroup, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natInterfaceRealm=natInterfaceRealm, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrBindId=natAddrBindId, natSessionIndex=natSessionIndex, NatSessionId=NatSessionId, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natAddrMapRowStatus=natAddrMapRowStatus, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natInterfaceServiceType=natInterfaceServiceType, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrMapInTranslates=natAddrMapInTranslates, NatTranslationEntity=NatTranslationEntity, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrBindType=natAddrBindType, natProtocolInTranslates=natProtocolInTranslates, natInterfaceTable=natInterfaceTable, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrMapEntry=natAddrMapEntry, natAddrPortBindProtocol=natAddrPortBindProtocol, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natInterfaceInTranslates=natInterfaceInTranslates, natMIBConformance=natMIBConformance, natAddrBindSessions=natAddrBindSessions, natInterfaceDiscards=natInterfaceDiscards, natBindDefIdleTimeout=natBindDefIdleTimeout, natSessionPublicAddrType=natSessionPublicAddrType, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natAddrBindEntry=natAddrBindEntry, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natInterfaceStorageType=natInterfaceStorageType, natMIBObjects=natMIBObjects, natProtocolDiscards=natProtocolDiscards, natSessionPublicSrcPort=natSessionPublicSrcPort, natProtocolTable=natProtocolTable, natTcpDefNegTimeout=natTcpDefNegTimeout, natInterfaceEntry=natInterfaceEntry, natAddrBindMapIndex=natAddrBindMapIndex, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natDefTimeouts=natDefTimeouts, natAddrPortBindSessions=natAddrPortBindSessions, natAddrBindOutTranslates=natAddrBindOutTranslates, natNotifCtrl=natNotifCtrl, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrMapOutTranslates=natAddrMapOutTranslates, natProtocol=natProtocol, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natAddrPortBindEntry=natAddrPortBindEntry, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natMIBGroups=natMIBGroups, NatAddrMapId=NatAddrMapId, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, PYSNMP_MODULE_ID=natMIB, natAddrMapIndex=natAddrMapIndex, natSessionDirection=natSessionDirection, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natSessionEntry=natSessionEntry, natSessionOutTranslates=natSessionOutTranslates, natMIBFullCompliance=natMIBFullCompliance, natMIBCompliances=natMIBCompliances, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, NatProtocolType=NatProtocolType, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natSessionMaxIdleTime=natSessionMaxIdleTime, NatBindId=NatBindId, NatBindMode=NatBindMode, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natSessionInTranslates=natSessionInTranslates, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrBindInTranslates=natAddrBindInTranslates, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrMapProtocol=natAddrMapProtocol, natMIBNotifications=natMIBNotifications, natAddrPortBindTable=natAddrPortBindTable, natProtocolEntry=natProtocolEntry, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSessionTable=natSessionTable, natAddrPortBindType=natAddrPortBindType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrMapAddrUsed=natAddrMapAddrUsed, natConfigGroup=natConfigGroup, natSessionUpTime=natSessionUpTime)
