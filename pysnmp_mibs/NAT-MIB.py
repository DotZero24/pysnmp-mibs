...
mibBuilder.exportSymbols("NAT-MIB", natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrBindEntry=natAddrBindEntry, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrMapRowStatus=natAddrMapRowStatus, natSessionInTranslates=natSessionInTranslates, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natInterfaceOutTranslates=natInterfaceOutTranslates, NatAddrMapId=NatAddrMapId, natBindDefIdleTimeout=natBindDefIdleTimeout, natInterfaceServiceType=natInterfaceServiceType, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natAddrPortBindType=natAddrPortBindType, natInterfaceDiscards=natInterfaceDiscards, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrBindInTranslates=natAddrBindInTranslates, natMIB=natMIB, natInterfaceRealm=natInterfaceRealm, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrMapName=natAddrMapName, natAddrMapEntry=natAddrMapEntry, natSessionPublicDstPort=natSessionPublicDstPort, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natProtocolTable=natProtocolTable, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natMIBNotifications=natMIBNotifications, natMIBFullCompliance=natMIBFullCompliance, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrMapDiscards=natAddrMapDiscards, natInterfaceRowStatus=natInterfaceRowStatus, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natMIBGroups=natMIBGroups, natAddrMapIndex=natAddrMapIndex, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natInterfaceStorageType=natInterfaceStorageType, NatProtocolMap=NatProtocolMap, natAddrMapEntryType=natAddrMapEntryType, natAddrBindSessions=natAddrBindSessions, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natProtocolInTranslates=natProtocolInTranslates, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSessionIndex=natSessionIndex, natConfigGroup=natConfigGroup, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrBindOutTranslates=natAddrBindOutTranslates, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrBindId=natAddrBindId, natSessionEntry=natSessionEntry, NatBindId=NatBindId, natInterfaceInTranslates=natInterfaceInTranslates, natSessionOutTranslates=natSessionOutTranslates, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natMIBConformance=natMIBConformance, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natStatsProtocolGroup=natStatsProtocolGroup, NatProtocolType=NatProtocolType, natProtocolDiscards=natProtocolDiscards, natAddrPortBindSessions=natAddrPortBindSessions, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrBindTable=natAddrBindTable, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natPacketDiscard=natPacketDiscard, natInterfaceEntry=natInterfaceEntry, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natProtocolOutTranslates=natProtocolOutTranslates, natTranslationGroup=natTranslationGroup, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSessionTable=natSessionTable, natSessionUpTime=natSessionUpTime, natAddrBindType=natAddrBindType, natInterfaceTable=natInterfaceTable, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, NatSessionId=NatSessionId, NatTranslationEntity=NatTranslationEntity, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natMIBNotificationGroup=natMIBNotificationGroup, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natAddrMapProtocol=natAddrMapProtocol, natAddrMapStorageType=natAddrMapStorageType, natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natSessionMaxIdleTime=natSessionMaxIdleTime, NatAssociationType=NatAssociationType, natAddrPortBindId=natAddrPortBindId, natAddrPortBindTable=natAddrPortBindTable, natProtocolEntry=natProtocolEntry, natSessionProtocolType=natSessionProtocolType, natAddrMapTable=natAddrMapTable, natMIBCompliances=natMIBCompliances, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, PYSNMP_MODULE_ID=natMIB, NatBindMode=NatBindMode, natNotifThrottlingInterval=natNotifThrottlingInterval, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natMIBObjects=natMIBObjects, natSessionDirection=natSessionDirection, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natTcpDefNegTimeout=natTcpDefNegTimeout, natDefTimeouts=natDefTimeouts, natAddrBindMapIndex=natAddrBindMapIndex, natSessionPublicAddrType=natSessionPublicAddrType, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natProtocol=natProtocol, natStatsAddrMapGroup=natStatsAddrMapGroup, NatBindIdOrZero=NatBindIdOrZero, natAddrPortBindEntry=natAddrPortBindEntry, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrMapInTranslates=natAddrMapInTranslates, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrBindLocalAddr=natAddrBindLocalAddr, natNotifCtrl=natNotifCtrl, natTcpDefIdleTimeout=natTcpDefIdleTimeout)
