...
# Notes
# -----
# ASN.1 source file://mibs/rfc/NAT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:24:05 2025
...
_NatInterfaceStorageType_Type.__name__ = "StorageType"
...
_NatAddrMapLocalPortFrom_Type.__name__ = "InetPortNumber"
...
_NatAddrMapLocalPortTo_Type.__name__ = "InetPortNumber"
...
_NatAddrMapGlobalPortFrom_Type.__name__ = "InetPortNumber"
...
_NatAddrMapGlobalPortTo_Type.__name__ = "InetPortNumber"
...
_NatAddrMapStorageType_Type.__name__ = "StorageType"
...
natMIBFullCompliance.setObjects(
      *(("IF-MIB", "ifCounterDiscontinuityGroup"),
        ("NAT-MIB", "natConfigGroup"),
        ("NAT-MIB", "natTranslationGroup"),
        ("NAT-MIB", "natStatsInterfaceGroup"),
        ("NAT-MIB", "natStatsProtocolGroup"),
        ("NAT-MIB", "natStatsAddrMapGroup"),
        ("NAT-MIB", "natMIBNotificationGroup"))
)
if mibBuilder.loadTexts:
...
natMIBReadOnlyCompliance.setObjects(
      *(("IF-MIB", "ifCounterDiscontinuityGroup"),
        ("NAT-MIB", "natConfigGroup"),
        ("NAT-MIB", "natTranslationGroup"),
        ("NAT-MIB", "natStatsInterfaceGroup"),
