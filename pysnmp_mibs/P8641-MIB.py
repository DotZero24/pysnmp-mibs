# SNMP MIB module (P8641-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/P8641-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:16:17 2025
...
_P8641_ObjectIdentity = ObjectIdentity
p8641 = _P8641_ObjectIdentity(
...
trapTest.setObjects(
      *(("P8641-MIB", "sensorName"),
        ("P8641-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
