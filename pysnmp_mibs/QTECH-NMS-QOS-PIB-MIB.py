...
Unsigned32,=mibBuilder.importSymbols('QTECH-NMS-TC',_G)
...
qosPIBConformance=_QosPIBConformance_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,1))
_QosPIBCompliances_ObjectIdentity=ObjectIdentity
qosPIBCompliances=_QosPIBCompliances_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,1,1))
_QosPIBGroups_ObjectIdentity=ObjectIdentity
qosPIBGroups=_QosPIBGroups_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,1,2))
_QosDeviceConfig_ObjectIdentity=ObjectIdentity
qosDeviceConfig=_QosDeviceConfig_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,2))
_QosDevicePibIncarnationTable_Object=MibTable
qosDevicePibIncarnationTable=_QosDevicePibIncarnationTable_Object((1,3,6,1,4,1,34751,18,2,1,2,1))
if mibBuilder.loadTexts:qosDevicePibIncarnationTable.setStatus(_A)
_QosDevicePibIncarnationEntry_Object=MibTableRow
qosDevicePibIncarnationEntry=_QosDevicePibIncarnationEntry_Object((1,3,6,1,4,1,34751,18,2,1,2,1,1))
...
qosDeviceIncarnationId=_QosDeviceIncarnationId_Object((1,3,6,1,4,1,34751,18,2,1,2,1,1,1),_QosDeviceIncarnationId_Type())
...
qosDevicePdpName=_QosDevicePdpName_Object((1,3,6,1,4,1,34751,18,2,1,2,1,1,2),_QosDevicePdpName_Type())
...
qosDevicePibIncarnation=_QosDevicePibIncarnation_Object((1,3,6,1,4,1,34751,18,2,1,2,1,1,3),_QosDevicePibIncarnation_Type())
...
qosDevicePibTtl=_QosDevicePibTtl_Object((1,3,6,1,4,1,34751,18,2,1,2,1,1,4),_QosDevicePibTtl_Type())
...
qosDeviceAttributeTable=_QosDeviceAttributeTable_Object((1,3,6,1,4,1,34751,18,2,1,2,2))
if mibBuilder.loadTexts:qosDeviceAttributeTable.setStatus(_A)
_QosDeviceAttributeEntry_Object=MibTableRow
qosDeviceAttributeEntry=_QosDeviceAttributeEntry_Object((1,3,6,1,4,1,34751,18,2,1,2,2,1))
...
qosDeviceAttributeId=_QosDeviceAttributeId_Object((1,3,6,1,4,1,34751,18,2,1,2,2,1,1),_QosDeviceAttributeId_Type())
...
qosDevicePepDomain=_QosDevicePepDomain_Object((1,3,6,1,4,1,34751,18,2,1,2,2,1,2),_QosDevicePepDomain_Type())
...
qosDevicePrimaryPdp=_QosDevicePrimaryPdp_Object((1,3,6,1,4,1,34751,18,2,1,2,2,1,3),_QosDevicePrimaryPdp_Type())
...
qosDeviceSecondaryPdp=_QosDeviceSecondaryPdp_Object((1,3,6,1,4,1,34751,18,2,1,2,2,1,4),_QosDeviceSecondaryPdp_Type())
...
qosDeviceMaxMessageSize=_QosDeviceMaxMessageSize_Object((1,3,6,1,4,1,34751,18,2,1,2,2,1,5),_QosDeviceMaxMessageSize_Type())
...
qosDeviceCapabilities=_QosDeviceCapabilities_Object((1,3,6,1,4,1,34751,18,2,1,2,2,1,6),_QosDeviceCapabilities_Type())
...
qosInterfaceTypeTable=_QosInterfaceTypeTable_Object((1,3,6,1,4,1,34751,18,2,1,2,3))
if mibBuilder.loadTexts:qosInterfaceTypeTable.setStatus(_A)
_QosInterfaceTypeEntry_Object=MibTableRow
qosInterfaceTypeEntry=_QosInterfaceTypeEntry_Object((1,3,6,1,4,1,34751,18,2,1,2,3,1))
...
qosInterfaceTypeId=_QosInterfaceTypeId_Object((1,3,6,1,4,1,34751,18,2,1,2,3,1,1),_QosInterfaceTypeId_Type())
...
qosInterfaceQueueType=_QosInterfaceQueueType_Object((1,3,6,1,4,1,34751,18,2,1,2,3,1,2),_QosInterfaceQueueType_Type())
...
qosInterfaceTypeRoles=_QosInterfaceTypeRoles_Object((1,3,6,1,4,1,34751,18,2,1,2,3,1,3),_QosInterfaceTypeRoles_Type())
...
qosInterfaceTypeCapabilities=_QosInterfaceTypeCapabilities_Object((1,3,6,1,4,1,34751,18,2,1,2,3,1,4),_QosInterfaceTypeCapabilities_Type())
...
qosDomainConfig=_QosDomainConfig_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,3))
_QosDiffServMappingTable_Object=MibTable
qosDiffServMappingTable=_QosDiffServMappingTable_Object((1,3,6,1,4,1,34751,18,2,1,3,1))
if mibBuilder.loadTexts:qosDiffServMappingTable.setStatus(_A)
_QosDiffServMappingEntry_Object=MibTableRow
qosDiffServMappingEntry=_QosDiffServMappingEntry_Object((1,3,6,1,4,1,34751,18,2,1,3,1,1))
...
qosDscp=_QosDscp_Object((1,3,6,1,4,1,34751,18,2,1,3,1,1,1),_QosDscp_Type())
...
qosMarkedDscp=_QosMarkedDscp_Object((1,3,6,1,4,1,34751,18,2,1,3,1,1,2),_QosMarkedDscp_Type())
...
qosL2Cos=_QosL2Cos_Object((1,3,6,1,4,1,34751,18,2,1,3,1,1,3),_QosL2Cos_Type())
qosL2Cos.setMaxAccess(_C)
if mibBuilder.loadTexts:qosL2Cos.setStatus(_A)
_QosCosToDscpTable_Object=MibTable
qosCosToDscpTable=_QosCosToDscpTable_Object((1,3,6,1,4,1,34751,18,2,1,3,2))
if mibBuilder.loadTexts:qosCosToDscpTable.setStatus(_A)
_QosCosToDscpEntry_Object=MibTableRow
qosCosToDscpEntry=_QosCosToDscpEntry_Object((1,3,6,1,4,1,34751,18,2,1,3,2,1))
...
qosCosToDscpCos=_QosCosToDscpCos_Object((1,3,6,1,4,1,34751,18,2,1,3,2,1,1),_QosCosToDscpCos_Type())
...
qosCosToDscpDscp=_QosCosToDscpDscp_Object((1,3,6,1,4,1,34751,18,2,1,3,2,1,2),_QosCosToDscpDscp_Type())
...
qosUnmatchedPolicy=_QosUnmatchedPolicy_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,4))
_QosUnmatchedPolicyTable_Object=MibTable
qosUnmatchedPolicyTable=_QosUnmatchedPolicyTable_Object((1,3,6,1,4,1,34751,18,2,1,4,1))
if mibBuilder.loadTexts:qosUnmatchedPolicyTable.setStatus(_A)
_QosUnmatchedPolicyEntry_Object=MibTableRow
qosUnmatchedPolicyEntry=_QosUnmatchedPolicyEntry_Object((1,3,6,1,4,1,34751,18,2,1,4,1,1))
...
qosUnmatchedPolicyId=_QosUnmatchedPolicyId_Object((1,3,6,1,4,1,34751,18,2,1,4,1,1,1),_QosUnmatchedPolicyId_Type())
...
qosUnmatchedPolicyRole=_QosUnmatchedPolicyRole_Object((1,3,6,1,4,1,34751,18,2,1,4,1,1,2),_QosUnmatchedPolicyRole_Type())
...
qosUnmatchedPolicyDirection=_QosUnmatchedPolicyDirection_Object((1,3,6,1,4,1,34751,18,2,1,4,1,1,3),_QosUnmatchedPolicyDirection_Type())
...
qosUnmatchedPolicyDscp=_QosUnmatchedPolicyDscp_Object((1,3,6,1,4,1,34751,18,2,1,4,1,1,4),_QosUnmatchedPolicyDscp_Type())
...
qosUnmatchedPolicyDscpTrusted=_QosUnmatchedPolicyDscpTrusted_Object((1,3,6,1,4,1,34751,18,2,1,4,1,1,5),_QosUnmatchedPolicyDscpTrusted_Type())
...
qosUnmatchPolMicroFlowPolicerId=_QosUnmatchPolMicroFlowPolicerId_Object((1,3,6,1,4,1,34751,18,2,1,4,1,1,6),_QosUnmatchPolMicroFlowPolicerId_Type())
...
qosUnmatchedPolicyAggregateId=_QosUnmatchedPolicyAggregateId_Object((1,3,6,1,4,1,34751,18,2,1,4,1,1,7),_QosUnmatchedPolicyAggregateId_Type())
...
qosPolicer=_QosPolicer_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,5))
_QosPolicerTable_Object=MibTable
qosPolicerTable=_QosPolicerTable_Object((1,3,6,1,4,1,34751,18,2,1,5,1))
if mibBuilder.loadTexts:qosPolicerTable.setStatus(_A)
_QosPolicerEntry_Object=MibTableRow
qosPolicerEntry=_QosPolicerEntry_Object((1,3,6,1,4,1,34751,18,2,1,5,1,1))
...
qosPolicerId=_QosPolicerId_Object((1,3,6,1,4,1,34751,18,2,1,5,1,1,1),_QosPolicerId_Type())
...
qosPolicerRate=_QosPolicerRate_Object((1,3,6,1,4,1,34751,18,2,1,5,1,1,2),_QosPolicerRate_Type())
...
qosPolicerNormalBurst=_QosPolicerNormalBurst_Object((1,3,6,1,4,1,34751,18,2,1,5,1,1,3),_QosPolicerNormalBurst_Type())
...
qosPolicerExcessBurst=_QosPolicerExcessBurst_Object((1,3,6,1,4,1,34751,18,2,1,5,1,1,4),_QosPolicerExcessBurst_Type())
...
qosPolicerAction=_QosPolicerAction_Object((1,3,6,1,4,1,34751,18,2,1,5,1,1,5),_QosPolicerAction_Type())
qosPolicerAction.setMaxAccess(_C)
if mibBuilder.loadTexts:qosPolicerAction.setStatus(_A)
_QosAggregateTable_Object=MibTable
qosAggregateTable=_QosAggregateTable_Object((1,3,6,1,4,1,34751,18,2,1,5,2))
if mibBuilder.loadTexts:qosAggregateTable.setStatus(_A)
_QosAggregateEntry_Object=MibTableRow
qosAggregateEntry=_QosAggregateEntry_Object((1,3,6,1,4,1,34751,18,2,1,5,2,1))
...
qosAggregateId=_QosAggregateId_Object((1,3,6,1,4,1,34751,18,2,1,5,2,1,1),_QosAggregateId_Type())
...
qosAggregatePolicerId=_QosAggregatePolicerId_Object((1,3,6,1,4,1,34751,18,2,1,5,2,1,2),_QosAggregatePolicerId_Type())
...
qosMacQos=_QosMacQos_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,6))
_QosMacClassificationTable_Object=MibTable
qosMacClassificationTable=_QosMacClassificationTable_Object((1,3,6,1,4,1,34751,18,2,1,6,1))
if mibBuilder.loadTexts:qosMacClassificationTable.setStatus(_A)
_QosMacClassificationEntry_Object=MibTableRow
qosMacClassificationEntry=_QosMacClassificationEntry_Object((1,3,6,1,4,1,34751,18,2,1,6,1,1))
...
qosMacClassificationId=_QosMacClassificationId_Object((1,3,6,1,4,1,34751,18,2,1,6,1,1,1),_QosMacClassificationId_Type())
...
qosDstMacVlan=_QosDstMacVlan_Object((1,3,6,1,4,1,34751,18,2,1,6,1,1,2),_QosDstMacVlan_Type())
...
qosDstMacAddress=_QosDstMacAddress_Object((1,3,6,1,4,1,34751,18,2,1,6,1,1,3),_QosDstMacAddress_Type())
...
qosDstMacCos=_QosDstMacCos_Object((1,3,6,1,4,1,34751,18,2,1,6,1,1,4),_QosDstMacCos_Type())
qosDstMacCos.setMaxAccess(_C)
if mibBuilder.loadTexts:qosDstMacCos.setStatus(_A)
_QosIpQos_ObjectIdentity=ObjectIdentity
qosIpQos=_QosIpQos_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,7))
_QosIpAceTable_Object=MibTable
qosIpAceTable=_QosIpAceTable_Object((1,3,6,1,4,1,34751,18,2,1,7,1))
if mibBuilder.loadTexts:qosIpAceTable.setStatus(_A)
_QosIpAceEntry_Object=MibTableRow
qosIpAceEntry=_QosIpAceEntry_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1))
...
qosIpAceId=_QosIpAceId_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,1),_QosIpAceId_Type())
...
qosIpAceDstAddr=_QosIpAceDstAddr_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,2),_QosIpAceDstAddr_Type())
...
qosIpAceDstAddrMask=_QosIpAceDstAddrMask_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,3),_QosIpAceDstAddrMask_Type())
...
qosIpAceSrcAddr=_QosIpAceSrcAddr_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,4),_QosIpAceSrcAddr_Type())
...
qosIpAceSrcAddrMask=_QosIpAceSrcAddrMask_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,5),_QosIpAceSrcAddrMask_Type())
...
qosIpAceDscpMin=_QosIpAceDscpMin_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,6),_QosIpAceDscpMin_Type())
...
qosIpAceDscpMax=_QosIpAceDscpMax_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,7),_QosIpAceDscpMax_Type())
...
qosIpAceProtocol=_QosIpAceProtocol_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,8),_QosIpAceProtocol_Type())
...
qosIpAceDstL4PortMin=_QosIpAceDstL4PortMin_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,9),_QosIpAceDstL4PortMin_Type())
...
qosIpAceDstL4PortMax=_QosIpAceDstL4PortMax_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,10),_QosIpAceDstL4PortMax_Type())
...
qosIpAceSrcL4PortMin=_QosIpAceSrcL4PortMin_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,11),_QosIpAceSrcL4PortMin_Type())
...
qosIpAceSrcL4PortMax=_QosIpAceSrcL4PortMax_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,12),_QosIpAceSrcL4PortMax_Type())
...
qosIpAcePermit=_QosIpAcePermit_Object((1,3,6,1,4,1,34751,18,2,1,7,1,1,13),_QosIpAcePermit_Type())
...
qosIpAclDefinitionTable=_QosIpAclDefinitionTable_Object((1,3,6,1,4,1,34751,18,2,1,7,2))
if mibBuilder.loadTexts:qosIpAclDefinitionTable.setStatus(_A)
_QosIpAclDefinitionEntry_Object=MibTableRow
qosIpAclDefinitionEntry=_QosIpAclDefinitionEntry_Object((1,3,6,1,4,1,34751,18,2,1,7,2,1))
...
qosIpAclDefinitionId=_QosIpAclDefinitionId_Object((1,3,6,1,4,1,34751,18,2,1,7,2,1,1),_QosIpAclDefinitionId_Type())
...
qosIpAclId=_QosIpAclId_Object((1,3,6,1,4,1,34751,18,2,1,7,2,1,2),_QosIpAclId_Type())
...
qosIpAceOrder=_QosIpAceOrder_Object((1,3,6,1,4,1,34751,18,2,1,7,2,1,3),_QosIpAceOrder_Type())
...
qosIpAclDefAceId=_QosIpAclDefAceId_Object((1,3,6,1,4,1,34751,18,2,1,7,2,1,4),_QosIpAclDefAceId_Type())
...
qosIpAclActionTable=_QosIpAclActionTable_Object((1,3,6,1,4,1,34751,18,2,1,7,3))
if mibBuilder.loadTexts:qosIpAclActionTable.setStatus(_A)
_QosIpAclActionEntry_Object=MibTableRow
qosIpAclActionEntry=_QosIpAclActionEntry_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1))
...
qosIpAclActionId=_QosIpAclActionId_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1,1),_QosIpAclActionId_Type())
...
qosIpAclActAclId=_QosIpAclActAclId_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1,2),_QosIpAclActAclId_Type())
...
qosIpAclInterfaceRoles=_QosIpAclInterfaceRoles_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1,3),_QosIpAclInterfaceRoles_Type())
...
qosIpAclInterfaceDirection=_QosIpAclInterfaceDirection_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1,4),_QosIpAclInterfaceDirection_Type())
...
qosIpAclOrder=_QosIpAclOrder_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1,5),_QosIpAclOrder_Type())
...
qosIpAclDscp=_QosIpAclDscp_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1,6),_QosIpAclDscp_Type())
...
qosIpAclDscpTrusted=_QosIpAclDscpTrusted_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1,7),_QosIpAclDscpTrusted_Type())
...
qosIpAclMicroFlowPolicerId=_QosIpAclMicroFlowPolicerId_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1,8),_QosIpAclMicroFlowPolicerId_Type())
...
qosIpAclAggregateId=_QosIpAclAggregateId_Object((1,3,6,1,4,1,34751,18,2,1,7,3,1,9),_QosIpAclAggregateId_Type())
...
qosIfParameters=_QosIfParameters_ObjectIdentity((1,3,6,1,4,1,34751,18,2,1,8))
_QosIfSchedulingPreferencesTable_Object=MibTable
qosIfSchedulingPreferencesTable=_QosIfSchedulingPreferencesTable_Object((1,3,6,1,4,1,34751,18,2,1,8,1))
if mibBuilder.loadTexts:qosIfSchedulingPreferencesTable.setStatus(_A)
_QosIfSchedulingPreferenceEntry_Object=MibTableRow
qosIfSchedulingPreferenceEntry=_QosIfSchedulingPreferenceEntry_Object((1,3,6,1,4,1,34751,18,2,1,8,1,1))
...
qosIfSchedulingPreferenceId=_QosIfSchedulingPreferenceId_Object((1,3,6,1,4,1,34751,18,2,1,8,1,1,1),_QosIfSchedulingPreferenceId_Type())
...
qosIfSchedulingRoles=_QosIfSchedulingRoles_Object((1,3,6,1,4,1,34751,18,2,1,8,1,1,2),_QosIfSchedulingRoles_Type())
...
qosIfSchedulingPreference=_QosIfSchedulingPreference_Object((1,3,6,1,4,1,34751,18,2,1,8,1,1,3),_QosIfSchedulingPreference_Type())
...
qosIfSchedulingDiscipline=_QosIfSchedulingDiscipline_Object((1,3,6,1,4,1,34751,18,2,1,8,1,1,4),_QosIfSchedulingDiscipline_Type())
...
qosIfSchedulingQueueType=_QosIfSchedulingQueueType_Object((1,3,6,1,4,1,34751,18,2,1,8,1,1,5),_QosIfSchedulingQueueType_Type())
...
qosIfDropPreferenceTable=_QosIfDropPreferenceTable_Object((1,3,6,1,4,1,34751,18,2,1,8,2))
if mibBuilder.loadTexts:qosIfDropPreferenceTable.setStatus(_A)
_QosIfDropPreferenceEntry_Object=MibTableRow
qosIfDropPreferenceEntry=_QosIfDropPreferenceEntry_Object((1,3,6,1,4,1,34751,18,2,1,8,2,1))
...
qosIfDropPreferenceId=_QosIfDropPreferenceId_Object((1,3,6,1,4,1,34751,18,2,1,8,2,1,1),_QosIfDropPreferenceId_Type())
...
qosIfDropRoles=_QosIfDropRoles_Object((1,3,6,1,4,1,34751,18,2,1,8,2,1,2),_QosIfDropRoles_Type())
...
qosIfDropPreference=_QosIfDropPreference_Object((1,3,6,1,4,1,34751,18,2,1,8,2,1,3),_QosIfDropPreference_Type())
...
qosIfDropDiscipline=_QosIfDropDiscipline_Object((1,3,6,1,4,1,34751,18,2,1,8,2,1,4),_QosIfDropDiscipline_Type())
...
qosIfDscpAssignmentTable=_QosIfDscpAssignmentTable_Object((1,3,6,1,4,1,34751,18,2,1,8,3))
if mibBuilder.loadTexts:qosIfDscpAssignmentTable.setStatus(_A)
_QosIfDscpAssignmentEntry_Object=MibTableRow
qosIfDscpAssignmentEntry=_QosIfDscpAssignmentEntry_Object((1,3,6,1,4,1,34751,18,2,1,8,3,1))
...
qosIfDscpAssignmentId=_QosIfDscpAssignmentId_Object((1,3,6,1,4,1,34751,18,2,1,8,3,1,1),_QosIfDscpAssignmentId_Type())
...
qosIfDscpRoles=_QosIfDscpRoles_Object((1,3,6,1,4,1,34751,18,2,1,8,3,1,2),_QosIfDscpRoles_Type())
...
qosIfQueueType=_QosIfQueueType_Object((1,3,6,1,4,1,34751,18,2,1,8,3,1,3),_QosIfQueueType_Type())
...
qosIfDscp=_QosIfDscp_Object((1,3,6,1,4,1,34751,18,2,1,8,3,1,4),_QosIfDscp_Type())
...
qosIfQueue=_QosIfQueue_Object((1,3,6,1,4,1,34751,18,2,1,8,3,1,5),_QosIfQueue_Type())
...
qosIfThresholdSet=_QosIfThresholdSet_Object((1,3,6,1,4,1,34751,18,2,1,8,3,1,6),_QosIfThresholdSet_Type())
qosIfThresholdSet.setMaxAccess(_C)
if mibBuilder.loadTexts:qosIfThresholdSet.setStatus(_A)
_QosIfRedTable_Object=MibTable
qosIfRedTable=_QosIfRedTable_Object((1,3,6,1,4,1,34751,18,2,1,8,4))
if mibBuilder.loadTexts:qosIfRedTable.setStatus(_A)
_QosIfRedEntry_Object=MibTableRow
qosIfRedEntry=_QosIfRedEntry_Object((1,3,6,1,4,1,34751,18,2,1,8,4,1))
...
qosIfRedId=_QosIfRedId_Object((1,3,6,1,4,1,34751,18,2,1,8,4,1,1),_QosIfRedId_Type())
...
qosIfRedRoles=_QosIfRedRoles_Object((1,3,6,1,4,1,34751,18,2,1,8,4,1,2),_QosIfRedRoles_Type())
...
qosIfRedNumThresholdSets=_QosIfRedNumThresholdSets_Object((1,3,6,1,4,1,34751,18,2,1,8,4,1,3),_QosIfRedNumThresholdSets_Type())
...
qosIfRedThresholdSet=_QosIfRedThresholdSet_Object((1,3,6,1,4,1,34751,18,2,1,8,4,1,4),_QosIfRedThresholdSet_Type())
...
qosIfRedThresholdSetLower=_QosIfRedThresholdSetLower_Object((1,3,6,1,4,1,34751,18,2,1,8,4,1,5),_QosIfRedThresholdSetLower_Type())
...
qosIfRedThresholdSetUpper=_QosIfRedThresholdSetUpper_Object((1,3,6,1,4,1,34751,18,2,1,8,4,1,6),_QosIfRedThresholdSetUpper_Type())
...
qosIfTailDropTable=_QosIfTailDropTable_Object((1,3,6,1,4,1,34751,18,2,1,8,5))
if mibBuilder.loadTexts:qosIfTailDropTable.setStatus(_A)
_QosIfTailDropEntry_Object=MibTableRow
qosIfTailDropEntry=_QosIfTailDropEntry_Object((1,3,6,1,4,1,34751,18,2,1,8,5,1))
...
qosIfTailDropId=_QosIfTailDropId_Object((1,3,6,1,4,1,34751,18,2,1,8,5,1,1),_QosIfTailDropId_Type())
...
qosIfTailDropRoles=_QosIfTailDropRoles_Object((1,3,6,1,4,1,34751,18,2,1,8,5,1,2),_QosIfTailDropRoles_Type())
...
qosIfTailDropNumThresholdSets=_QosIfTailDropNumThresholdSets_Object((1,3,6,1,4,1,34751,18,2,1,8,5,1,3),_QosIfTailDropNumThresholdSets_Type())
...
qosIfTailDropThresholdSet=_QosIfTailDropThresholdSet_Object((1,3,6,1,4,1,34751,18,2,1,8,5,1,4),_QosIfTailDropThresholdSet_Type())
...
qosIfTailDropThresholdSetValue=_QosIfTailDropThresholdSetValue_Object((1,3,6,1,4,1,34751,18,2,1,8,5,1,5),_QosIfTailDropThresholdSetValue_Type())
...
qosIfWeightsTable=_QosIfWeightsTable_Object((1,3,6,1,4,1,34751,18,2,1,8,6))
if mibBuilder.loadTexts:qosIfWeightsTable.setStatus(_A)
_QosIfWeightsEntry_Object=MibTableRow
qosIfWeightsEntry=_QosIfWeightsEntry_Object((1,3,6,1,4,1,34751,18,2,1,8,6,1))
...
qosIfWeightsId=_QosIfWeightsId_Object((1,3,6,1,4,1,34751,18,2,1,8,6,1,1),_QosIfWeightsId_Type())
...
qosIfWeightsRoles=_QosIfWeightsRoles_Object((1,3,6,1,4,1,34751,18,2,1,8,6,1,2),_QosIfWeightsRoles_Type())
...
qosIfWeightsNumQueues=_QosIfWeightsNumQueues_Object((1,3,6,1,4,1,34751,18,2,1,8,6,1,3),_QosIfWeightsNumQueues_Type())
...
qosIfWeightsQueue=_QosIfWeightsQueue_Object((1,3,6,1,4,1,34751,18,2,1,8,6,1,4),_QosIfWeightsQueue_Type())
...
qosIfWeightsDrainSize=_QosIfWeightsDrainSize_Object((1,3,6,1,4,1,34751,18,2,1,8,6,1,5),_QosIfWeightsDrainSize_Type())
...
qosIfWeightsQueueSize=_QosIfWeightsQueueSize_Object((1,3,6,1,4,1,34751,18,2,1,8,6,1,6),_QosIfWeightsQueueSize_Type())
qosIfWeightsQueueSize.setMaxAccess(_C)
if mibBuilder.loadTexts:qosIfWeightsQueueSize.setStatus(_A)
qosDevicePibIncarnationTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,1))
...
qosDeviceAttributeTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,2))
...
qosIpAceTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,10))
...
qosIpAclDefinitionTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,11))
...
qosIpAclActionTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,12))
...
qosIfSchedulingPreferencesTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,13))
...
qosIfDropPreferenceTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,14))
...
qosIfDscpAssignmentTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,15))
...
qosIfRedTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,16))
qosIfRedTableGroup.setObjects(*((_B,_Ac),(_B,_Ad),(_B,_Ae),(_B,_Af),(_B,_Ag)))
if mibBuilder.loadTexts:qosIfRedTableGroup.setStatus(_A)
qosIfTailDropTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,17))
...
qosIfWeightsTableGroup=ObjectGroup((1,3,6,1,4,1,34751,18,2,1,1,2,18))
...
qosPIBCompliance=ModuleCompliance((1,3,6,1,4,1,34751,18,2,1,1,1,1))
