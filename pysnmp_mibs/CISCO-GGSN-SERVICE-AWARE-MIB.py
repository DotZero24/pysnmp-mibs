...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:27:51 2025
...
mibBuilder.exportSymbols("CISCO-GGSN-SERVICE-AWARE-MIB", cGgsnSANotifMgmtGroup=cGgsnSANotifMgmtGroup, cGgsnSATotalQuotaPushAcks=cGgsnSATotalQuotaPushAcks, cGgsnSACsgRowStatus=cGgsnSACsgRowStatus, cGgsnSACsgStatsQuotaReturns=cGgsnSACsgStatsQuotaReturns, cGgsnSAMIBObjects=cGgsnSAMIBObjects, cGgsnSACsgInboundMsgs=cGgsnSACsgInboundMsgs, cGgsnSACsgOutboundOctets=cGgsnSACsgOutboundOctets, cGgsnSADccaUserUnknownNotif=cGgsnSADccaUserUnknownNotif, cGgsnSAStatistics=cGgsnSAStatistics, cGgsnSACsgQuotaReturnReqs=cGgsnSACsgQuotaReturnReqs, cGgsnSACategoryFsmRtnErrors=cGgsnSACategoryFsmRtnErrors, cGgsnSACsgQuotaPushMsgs=cGgsnSACsgQuotaPushMsgs, cGgsnSATotalDeletePdps=cGgsnSATotalDeletePdps, cGgsnSAQsRcvdPathRequests=cGgsnSAQsRcvdPathRequests, cGgsnSANotifInfo=cGgsnSANotifInfo, cGgsnSACsgServiceStopMsgs=cGgsnSACsgServiceStopMsgs, CGgsnCsgPathState=CGgsnCsgPathState, cGgsnSAQsDroppedMsgs=cGgsnSAQsDroppedMsgs, cGgsnSADccaProfileName=cGgsnSADccaProfileName, cGgsnSACsgServiceReAuthReqs=cGgsnSACsgServiceReAuthReqs, cGgsnSACsgTable=cGgsnSACsgTable, cGgsnSATotalServiceReAuthMsgs=cGgsnSATotalServiceReAuthMsgs, cGgsnSANotifCsgRealAddress=cGgsnSANotifCsgRealAddress, cGgsnSADccaTriggerUserLocChange=cGgsnSADccaTriggerUserLocChange, cGgsnSANotifCsgPort=cGgsnSANotifCsgPort, cGgsnSAQuotaServerCsgGroup=cGgsnSAQuotaServerCsgGroup, cGgsnSACsgStatsServiceStopReqs=cGgsnSACsgStatsServiceStopReqs, cGgsnSATotalCsgEvents=cGgsnSATotalCsgEvents, cGgsnSACsgInboundOctets=cGgsnSACsgInboundOctets, cGgsnSACsgQuotaReturns=cGgsnSACsgQuotaReturns, cGgsnSADccaProfileTable=cGgsnSADccaProfileTable, cGgsnSAQuotaServerT3Response=cGgsnSAQuotaServerT3Response, cGgsnSADccaAuthRejectedNotif=cGgsnSADccaAuthRejectedNotif, cGgsnSAQuotaServerTable=cGgsnSAQuotaServerTable, cGgsnSACsgStatsQuotaPushMsgs=cGgsnSACsgStatsQuotaPushMsgs, cGgsnSACsgStatsServiceAuthReqs=cGgsnSACsgStatsServiceAuthReqs, cGgsnSAQsNoResponseToMsgs=cGgsnSAQsNoResponseToMsgs, cGgsnSATotalBlackListCategories=cGgsnSATotalBlackListCategories, cGgsnSAQuotaServerStatistics=cGgsnSAQuotaServerStatistics, cGgsnSATotalPostpaidConversions=cGgsnSATotalPostpaidConversions, cGgsnSAQuotaServerN3Requests=cGgsnSAQuotaServerN3Requests, cGgsnSADccaCcfh=cGgsnSADccaCcfh, cGgsnSADccaDestinationRealm=cGgsnSADccaDestinationRealm, cGgsnSAMIB=cGgsnSAMIB, cGgsnSACsgStatsOutboundMsgs=cGgsnSACsgStatsOutboundMsgs, cGgsnSADccaRatingFailed=cGgsnSADccaRatingFailed, cGgsnSAQsInvalidMsgFormats=cGgsnSAQsInvalidMsgFormats, cGgsnSACsgVirtualAddress=cGgsnSACsgVirtualAddress, cGgsnSACsgServiceStopReqs=cGgsnSACsgServiceStopReqs, cGgsnSAQsRcvdResponses=cGgsnSAQsRcvdResponses, cGgsnSAQsMandTlvIncorrectMsgs=cGgsnSAQsMandTlvIncorrectMsgs, cGgsnSADccaTriggerPlmnChange=cGgsnSADccaTriggerPlmnChange, cGgsnSATotalRAREvents=cGgsnSATotalRAREvents, PYSNMP_MODULE_ID=cGgsnSAMIB, cGgsnSAQsUnknownMsgs=cGgsnSAQsUnknownMsgs, cGgsnSATotalGgsnEvents=cGgsnSATotalGgsnEvents, cGgsnSACsgVirtualAddressType=cGgsnSACsgVirtualAddressType, cGgsnSACsgRealAddress1=cGgsnSACsgRealAddress1, cGgsnSAQsRequestsUnreplied=cGgsnSAQsRequestsUnreplied, cGgsnSACsgAaaAcctGroup=cGgsnSACsgAaaAcctGroup, cGgsnSATotalServiceAuthMsgs=cGgsnSATotalServiceAuthMsgs, cGgsnSATotalDeletedCategories=cGgsnSATotalDeletedCategories, cGgsnSAQsSentRequests=cGgsnSAQsSentRequests, cGgsnSATotalQuotaReturns=cGgsnSATotalQuotaReturns, cGgsnSACsgServiceAuthResps=cGgsnSACsgServiceAuthResps, cGgsnSAQsRcvdRequests=cGgsnSAQsRcvdRequests, cGgsnSAQsRcvdNegativeResponses=cGgsnSAQsRcvdNegativeResponses, cGgsnSATotalServiceStopMsgs=cGgsnSATotalServiceStopMsgs, cGgsnSAServiceAwareStatistics=cGgsnSAServiceAwareStatistics, cGgsnSACsgStatsQuotaPushRsps=cGgsnSACsgStatsQuotaPushRsps, cGgsnSAQuotaServerName=cGgsnSAQuotaServerName, cGgsnSAMIBComplianceRev4=cGgsnSAMIBComplianceRev4, cGgsnSATotalDccaEvents=cGgsnSATotalDccaEvents, cGgsnSADccaEndUsrServDeniedNotif=cGgsnSADccaEndUsrServDeniedNotif, cGgsnSAQsSentPathRequests=cGgsnSAQsSentPathRequests, cGgsnSACsgGroupName=cGgsnSACsgGroupName, cGgsnSADccaSessionFailover=cGgsnSADccaSessionFailover, cGgsnSANotifGroupR100=cGgsnSANotifGroupR100, cGgsnSACsgPort=cGgsnSACsgPort, cGgsnSADccaTriggerSgsnChange=cGgsnSADccaTriggerSgsnChange, cGgsnSATotalDeletedSyncObjects=cGgsnSATotalDeletedSyncObjects, cGgsnSARejDccaFailures=cGgsnSARejDccaFailures, cGgsnSAMIBGroups=cGgsnSAMIBGroups, cGgsnSACsgNotifEnabled=cGgsnSACsgNotifEnabled, cGgsnSANotifications=cGgsnSANotifications, cGgsnSACsgRealAddressType=cGgsnSACsgRealAddressType, cGgsnSAQsIEErrorMsgs=cGgsnSAQsIEErrorMsgs, cGgsnSACsgR100StateUpNotif=cGgsnSACsgR100StateUpNotif, cGgsnSATotalRatingChanges=cGgsnSATotalRatingChanges, cGgsnSADccaNotifEnabled=cGgsnSADccaNotifEnabled, cGgsnSAQuotaServerEchoInterval=cGgsnSAQuotaServerEchoInterval, cGgsnSACsgEntry=cGgsnSACsgEntry, cGgsnSAQuotaServerInterface=cGgsnSAQuotaServerInterface, cGgsnSAMIBComplianceRev1=cGgsnSAMIBComplianceRev1, cGgsnSANotifMgmt=cGgsnSANotifMgmt, cGgsnSATotalCreatedCategories=cGgsnSATotalCreatedCategories, cGgsnSATotalDummyQuotas=cGgsnSATotalDummyQuotas, cGgsnSADccaCreditLimReachedNotif=cGgsnSADccaCreditLimReachedNotif, cGgsnSANotifInfoGroup=cGgsnSANotifInfoGroup, cGgsnSAQsRcvdPathResponses=cGgsnSAQsRcvdPathResponses, cGgsnSANumServiceAwareApns=cGgsnSANumServiceAwareApns, cGgsnSAQsUnknownResponses=cGgsnSAQsUnknownResponses, cGgsnSATotalPrepaidUsers=cGgsnSATotalPrepaidUsers, cGgsnSAMIBConformance=cGgsnSAMIBConformance, cGgsnSACsgStatsOutboundOctets=cGgsnSACsgStatsOutboundOctets, cGgsnSACsgR100StateDownNotif=cGgsnSACsgR100StateDownNotif, cGgsnSAQuotaServerEntry=cGgsnSAQuotaServerEntry, cGgsnSACsgQuotaPushResps=cGgsnSACsgQuotaPushResps, cGgsnSACsgGtpAcks=cGgsnSACsgGtpAcks, cGgsnSAMIBNotificationPrefix=cGgsnSAMIBNotificationPrefix, cGgsnSACsgStatsServiceReAuthReqs=cGgsnSACsgStatsServiceReAuthReqs, cGgsnSARejCsgFailures=cGgsnSARejCsgFailures, cGgsnSATotalQuotaGranted=cGgsnSATotalQuotaGranted, cGgsnSAQuotaServerSvcMsgEnabled=cGgsnSAQuotaServerSvcMsgEnabled, cGgsnSAExtConfigurationsGroup=cGgsnSAExtConfigurationsGroup, cGgsnSAFinalConvertToPostpaidPdps=cGgsnSAFinalConvertToPostpaidPdps, cGgsnSADccaAuthorization=cGgsnSADccaAuthorization, cGgsnSACsgStatsQuotaReturnReqs=cGgsnSACsgStatsQuotaReturnReqs, cGgsnSACsgStatsServiceStopMsgs=cGgsnSACsgStatsServiceStopMsgs, cGgsnSANotifCsgVirtualAddress=cGgsnSANotifCsgVirtualAddress, cGgsnSANotifCsgVirtualAddrType=cGgsnSANotifCsgVirtualAddrType, cggsnSACsgStatisticsEntry=cggsnSACsgStatisticsEntry, cGgsnSANotifGroup=cGgsnSANotifGroup, cGgsnSAQsSentPathResponses=cGgsnSAQsSentPathResponses, cGgsnSAQsVersionUnSupportedMsgs=cGgsnSAQsVersionUnSupportedMsgs, cGgsnSAServiceAware=cGgsnSAServiceAware, cGgsnSACsgStatsServiceAuthResps=cGgsnSACsgStatsServiceAuthResps, cGgsnSANotifInfoGroupR100=cGgsnSANotifInfoGroupR100, cGgsnSADccaTxTimeout=cGgsnSADccaTxTimeout, cGgsnSAConfigurations=cGgsnSAConfigurations, cGgsnSACsgStateUpNotif=cGgsnSACsgStateUpNotif, cGgsnSAQuotaServerRowStatus=cGgsnSAQuotaServerRowStatus, cGgsnSANotifCsgName=cGgsnSANotifCsgName, cGgsnSADccaTriggerRatChange=cGgsnSADccaTriggerRatChange, cGgsnSAMIBCompliance=cGgsnSAMIBCompliance, cGgsnSACsgStatsGtpAcks=cGgsnSACsgStatsGtpAcks, cGgsnSAQsSeqnumFailures=cGgsnSAQsSeqnumFailures, cGgsnSAExtConfigurationsGroupSup1=cGgsnSAExtConfigurationsGroupSup1, cGgsnSADccaProfileEntry=cGgsnSADccaProfileEntry, cGgsnSAMIBComplianceRev3=cGgsnSAMIBComplianceRev3, cGgsnSAStatisticsGroup=cGgsnSAStatisticsGroup, cGgsnSATotalCsgFailures=cGgsnSATotalCsgFailures, cGgsnSACsgStatsQuotaReturnAccept=cGgsnSACsgStatsQuotaReturnAccept, cGgsnSATotalDccaFailures=cGgsnSATotalDccaFailures, cGgsnSADccaRowStatus=cGgsnSADccaRowStatus, cGgsnSACsgStateDownNotif=cGgsnSACsgStateDownNotif, cGgsnSAMIBComplianceRev2=cGgsnSAMIBComplianceRev2, cGgsnSANotifCsgRealAddressType=cGgsnSANotifCsgRealAddressType, cGgsnSACsgStatsInboundMsgs=cGgsnSACsgStatsInboundMsgs, cGgsnSAMIBCompliances=cGgsnSAMIBCompliances, cGgsnSATotalTerminateCategories=cGgsnSATotalTerminateCategories, cGgsnSAStatisticsGroupR100=cGgsnSAStatisticsGroupR100, cGgsnSAConfigurationsGroupR100=cGgsnSAConfigurationsGroupR100, cGgsnSAConfigurationsGroupSup1=cGgsnSAConfigurationsGroupSup1, cGgsnSADccaTriggerQosChange=cGgsnSADccaTriggerQosChange, cGgsnSATotalGgsnFailures=cGgsnSATotalGgsnFailures, cGgsnSAQsSentResponses=cGgsnSAQsSentResponses, cGgsnSADccaClci=cGgsnSADccaClci, cGgsnSAQsMandTlvMissingMsgs=cGgsnSAQsMandTlvMissingMsgs, cGgsnSATotalUnknownCategories=cGgsnSATotalUnknownCategories, cGgsnSACsgStatsInboundOctets=cGgsnSACsgStatsInboundOctets, cGgsnSATotalPostpaidUsers=cGgsnSATotalPostpaidUsers, cGgsnSACsgQuotaPushRsps=cGgsnSACsgQuotaPushRsps, cggsnSACsgStatisticsTable=cggsnSACsgStatisticsTable, cGgsnSAConfigurationsGroup=cGgsnSAConfigurationsGroup, cGgsnSATotalCreatedSyncObjs=cGgsnSATotalCreatedSyncObjs, cGgsnSACsgOutboundMsgs=cGgsnSACsgOutboundMsgs, cGgsnSACsgStatistics=cGgsnSACsgStatistics, cGgsnSACsgServiceAuthReqs=cGgsnSACsgServiceAuthReqs, cGgsnSACsgNumPdps=cGgsnSACsgNumPdps, cGgsnSACsgRealAddress2=cGgsnSACsgRealAddress2, cGgsnSAQsBadSrcAddressMsgs=cGgsnSAQsBadSrcAddressMsgs, cGgsnSACsgPathState=cGgsnSACsgPathState)
