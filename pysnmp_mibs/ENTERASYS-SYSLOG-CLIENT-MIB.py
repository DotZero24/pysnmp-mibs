...
mibBuilder.exportSymbols("ENTERASYS-SYSLOG-CLIENT-MIB", etsysSyslogClientCompliance=etsysSyslogClientCompliance, etsysSyslogClientControl=etsysSyslogClientControl, SyslogSeverity=SyslogSeverity, etsysSyslogServerIndex=etsysSyslogServerIndex, etsysSyslogServerDefaultFacility=etsysSyslogServerDefaultFacility, PYSNMP_MODULE_ID=etsysSyslogClientMIB, etsysSyslogServerSeverity=etsysSyslogServerSeverity, etsysSyslogClientGroup=etsysSyslogClientGroup, etsysSyslogApplicationEntry=etsysSyslogApplicationEntry, etsysSyslogServerGroup2=etsysSyslogServerGroup2, etsysSyslogServerAddressType=etsysSyslogServerAddressType, etsysSyslogSecureCompliance=etsysSyslogSecureCompliance, etsysSyslogServerFacility=etsysSyslogServerFacility, etsysSyslogServerTable=etsysSyslogServerTable, etsysSyslogSecureLogDroppedMsgNotification=etsysSyslogSecureLogDroppedMsgNotification, etsysSyslogServerGroup=etsysSyslogServerGroup, etsysSyslogServerDefaultsGroup=etsysSyslogServerDefaultsGroup, etsysSyslogClient=etsysSyslogClient, etsysSyslogClientCompliance2=etsysSyslogClientCompliance2, etsysSyslogClientMessages=etsysSyslogClientMessages, etsysSyslogApplicationGroup=etsysSyslogApplicationGroup, etsysSyslogServerDefaultUdpPort=etsysSyslogServerDefaultUdpPort, etsysSyslogClientLastMessageTime=etsysSyslogClientLastMessageTime, etsysSyslogServerUdpPort=etsysSyslogServerUdpPort, etsysSyslogServerDescription=etsysSyslogServerDescription, etsysSyslogNotificationGroup=etsysSyslogNotificationGroup, etsysSyslogServerDefaultSeverity=etsysSyslogServerDefaultSeverity, etsysSyslogServerGroup3=etsysSyslogServerGroup3, etsysSyslogApplicationAllowedServers=etsysSyslogApplicationAllowedServers, etsysSyslogServerHostname=etsysSyslogServerHostname, etsysSyslogServerVirtualRouterName=etsysSyslogServerVirtualRouterName, etsysSyslogNotificationCompliance=etsysSyslogNotificationCompliance, etsysSyslogClientCompliance3=etsysSyslogClientCompliance3, etsysSyslogServerMaxEntries=etsysSyslogServerMaxEntries, etsysSyslogApplication=etsysSyslogApplication, etsysSyslogApplicationIndex=etsysSyslogApplicationIndex, etsysSyslogApplicationSeverity=etsysSyslogApplicationSeverity, etsysSyslogServerMessagesIgnored=etsysSyslogServerMessagesIgnored, etsysSyslogApplicationTable=etsysSyslogApplicationTable, etsysSyslogClientSecureMessagesDropped=etsysSyslogClientSecureMessagesDropped, etsysSyslogServerEntry=etsysSyslogServerEntry, SyslogUdpPort=SyslogUdpPort, etsysSyslogSecureGroup=etsysSyslogSecureGroup, etsysSyslogClientConformance=etsysSyslogClientConformance, etsysSyslogClientGroups=etsysSyslogClientGroups, etsysSyslogServer=etsysSyslogServer, etsysSyslogServerAddress=etsysSyslogServerAddress, etsysSyslogApplicationMnemonic=etsysSyslogApplicationMnemonic, etsysSyslogClientCompliances=etsysSyslogClientCompliances, etsysSyslogServerNumEntries=etsysSyslogServerNumEntries, etsysSyslogClientMessagesDropped=etsysSyslogClientMessagesDropped, etsysSyslogServerTableNextAvailableIndex=etsysSyslogServerTableNextAvailableIndex, etsysSyslogSecureLogArchiveNotification=etsysSyslogSecureLogArchiveNotification, etsysSyslogApplicationDescription=etsysSyslogApplicationDescription, etsysSyslogNotification=etsysSyslogNotification, SyslogFacility=SyslogFacility, etsysSyslogServerRowStatus=etsysSyslogServerRowStatus, etsysSyslogClientMIB=etsysSyslogClientMIB)
