...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-SYSLOG-CLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:47:42 2025
...
class _EtsysSyslogServerVirtualRouterName_Type(OctetString):
    """Custom type etsysSyslogServerVirtualRouterName based on OctetString"""
...
_EtsysSyslogServerVirtualRouterName_Type.__name__ = "OctetString"
_EtsysSyslogServerVirtualRouterName_Object = MibTableColumn
etsysSyslogServerVirtualRouterName = _EtsysSyslogServerVirtualRouterName_Object(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 14, 2, 4, 1, 10),
    _EtsysSyslogServerVirtualRouterName_Type()
)
etsysSyslogServerVirtualRouterName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    etsysSyslogServerVirtualRouterName.setStatus("current")
...
_EtsysSyslogServerDefaultUdpPort_Type.__name__ = "SyslogUdpPort"
...
_EtsysSyslogServerDefaultFacility_Type.__name__ = "SyslogFacility"
...
_EtsysSyslogServerDefaultSeverity_Type.__name__ = "SyslogSeverity"
...
class _EtsysSyslogServerHostname_Type(Integer32):
    """Custom type etsysSyslogServerHostname based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_EtsysSyslogServerHostname_Type.__name__ = "Integer32"
_EtsysSyslogServerHostname_Object = MibScalar
etsysSyslogServerHostname = _EtsysSyslogServerHostname_Object(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 14, 2, 8),
    _EtsysSyslogServerHostname_Type()
)
etsysSyslogServerHostname.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    etsysSyslogServerHostname.setStatus("current")
...
_EtsysSyslogApplicationSeverity_Type.__name__ = "SyslogSeverity"
...
class _EtsysSyslogApplicationAllowedServers_Type(Bits):
    ...
    defaultBinValue = "1111111111011111111"
    ...
    namedValues = NamedValues(
        *(("etsysSyslogServerIndex1", 0),
          ...
          ("etsysSyslogServerIndex9", 11),
          ("etsysSyslogServerIndex10", 12),
          ("etsysSyslogServerIndex11", 13),
          ("etsysSyslogServerIndex12", 14),
          ("etsysSyslogServerIndex13", 15),
          ("etsysSyslogServerIndex14", 16),
          ("etsysSyslogServerIndex15", 17),
...
if mibBuilder.loadTexts:
    etsysSyslogServerGroup.setStatus("deprecated")
...
etsysSyslogServerGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 14, 4, 1, 7)
)
etsysSyslogServerGroup2.setObjects(
      *(("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerMaxEntries"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerNumEntries"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerTableNextAvailableIndex"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerDescription"),
        ...
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerMessagesIgnored"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerRowStatus"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerHostname"))
)
if mibBuilder.loadTexts:
    etsysSyslogServerGroup2.setStatus("deprecated")

etsysSyslogServerGroup3 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 14, 4, 1, 8)
)
etsysSyslogServerGroup3.setObjects(
      *(("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerMaxEntries"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerNumEntries"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerTableNextAvailableIndex"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerDescription"),
        ...
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerMessagesIgnored"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerRowStatus"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerVirtualRouterName"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerHostname"))
)
if mibBuilder.loadTexts:
    etsysSyslogServerGroup3.setStatus("current")
...
etsysSyslogClientCompliance.setObjects(
      *(("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogClientGroup"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerGroup"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerDefaultsGroup"),
...
etsysSyslogNotificationCompliance.setObjects(
    ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogNotificationGroup")
)
if mibBuilder.loadTexts:
...
etsysSyslogSecureCompliance.setObjects(
    ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogSecureGroup")
)
if mibBuilder.loadTexts:
...
etsysSyslogClientCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 14, 4, 2, 4)
)
etsysSyslogClientCompliance2.setObjects(
      *(("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogClientGroup"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerGroup2"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerDefaultsGroup"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogApplicationGroup"))
)
if mibBuilder.loadTexts:
    etsysSyslogClientCompliance2.setStatus(
        "deprecated"
    )

etsysSyslogClientCompliance3 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 14, 4, 2, 5)
)
etsysSyslogClientCompliance3.setObjects(
      *(("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogClientGroup"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerGroup3"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogServerDefaultsGroup"),
        ("ENTERASYS-SYSLOG-CLIENT-MIB", "etsysSyslogApplicationGroup"))
)
if mibBuilder.loadTexts:
    etsysSyslogClientCompliance3.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"SyslogUdpPort": SyslogUdpPort,
       ...
       "etsysSyslogServerVirtualRouterName": etsysSyslogServerVirtualRouterName,
       ...
       "etsysSyslogServerHostname": etsysSyslogServerHostname,
       ...
       "etsysSyslogServerGroup2": etsysSyslogServerGroup2,
       "etsysSyslogServerGroup3": etsysSyslogServerGroup3,
       ...
       "etsysSyslogClientCompliance2": etsysSyslogClientCompliance2,
       "etsysSyslogClientCompliance3": etsysSyslogClientCompliance3,
