...
# Notes
# -----
# ASN.1 source file://mibs/rfc/DSMON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:19:27 2025
...
_DsmonAggGroupIndex_Type.__name__ = "DsmonCounterAggGroupIndex"
...
dsmonCompliance.setObjects(
      *(("DSMON-MIB", "dsmonCounterAggControlGroup"),
        ("DSMON-MIB", "dsmonStatsGroup"),
        ("DSMON-MIB", "dsmonCapsGroup"),
        ("DSMON-MIB", "dsmonStatsHCGroup"),
        ("DSMON-MIB", "dsmonPdistGroup"),
        ("DSMON-MIB", "dsmonPdistHCGroup"),
        ("DSMON-MIB", "dsmonHostGroup"),
        ("DSMON-MIB", "dsmonHostHCGroup"),
        ("DSMON-MIB", "dsmonMatrixGroup"),
        ("DSMON-MIB", "dsmonMatrixHCGroup"))
)
if mibBuilder.loadTexts:
...
dsmonHCNoC64Compliance.setObjects(
      *(("DSMON-MIB", "dsmonCounterAggControlGroup"),
        ("DSMON-MIB", "dsmonStatsGroup"),
        ("DSMON-MIB", "dsmonStatsOvflGroup"),
        ("DSMON-MIB", "dsmonCapsGroup"),
        ("DSMON-MIB", "dsmonStatsHCGroup"),
        ("DSMON-MIB", "dsmonPdistGroup"),
        ("DSMON-MIB", "dsmonPdistOvflGroup"),
        ("DSMON-MIB", "dsmonPdistHCGroup"),
        ("DSMON-MIB", "dsmonHostGroup"),
        ("DSMON-MIB", "dsmonHostOvflGroup"),
        ("DSMON-MIB", "dsmonHostHCGroup"),
        ("DSMON-MIB", "dsmonMatrixGroup"),
        ("DSMON-MIB", "dsmonMatrixOvflGroup"),
        ("DSMON-MIB", "dsmonMatrixHCGroup"))
)
if mibBuilder.loadTexts:
