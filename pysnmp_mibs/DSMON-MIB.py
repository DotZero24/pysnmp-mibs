...
ZeroBasedCounter32, LastCreateTime, DataSource, TimeFilter, protocolDirLocalIndex = mibBuilder.importSymbols("RMON2-MIB", "ZeroBasedCounter32", "LastCreateTime", "DataSource", "TimeFilter", "protocolDirLocalIndex")
...
mibBuilder.exportSymbols("DSMON-MIB", dsmonMatrixTimeMark=dsmonMatrixTimeMark, dsmonStatsControlAggProfile=dsmonStatsControlAggProfile, dsmonMatrixTopNCtlMatrixIndex=dsmonMatrixTopNCtlMatrixIndex, dsmonStatsControlIndex=dsmonStatsControlIndex, dsmonPdistTopNHCRate=dsmonPdistTopNHCRate, dsmonPdistCtlDeletes=dsmonPdistCtlDeletes, dsmonMatrixTopNDestAddress=dsmonMatrixTopNDestAddress, DsmonCounterAggProfileIndex=DsmonCounterAggProfileIndex, dsmonStatsHCGroup=dsmonStatsHCGroup, dsmonPdistStatsPkts=dsmonPdistStatsPkts, dsmonPdistTopNCtlRequestedSize=dsmonPdistTopNCtlRequestedSize, dsmonPdistCtlAggProfile=dsmonPdistCtlAggProfile, dsmonPdistStatsTable=dsmonPdistStatsTable, dsmonMatrixDSHCOctets=dsmonMatrixDSHCOctets, dsmonMatrixTopNCtlStartTime=dsmonMatrixTopNCtlStartTime, dsmonMatrixTopNCtlOwner=dsmonMatrixTopNCtlOwner, dsmonPdistTopNCtlGeneratedReprts=dsmonPdistTopNCtlGeneratedReprts, dsmonMatrixDSPkts=dsmonMatrixDSPkts, dsmonHostTopNHCRate=dsmonHostTopNHCRate, dsmonAggControlLocked=dsmonAggControlLocked, dsmonPdistObjects=dsmonPdistObjects, dsmonMatrixTopNIndex=dsmonMatrixTopNIndex, dsmonStatsOutHCOctets=dsmonStatsOutHCOctets, dsmonAggControlIndex=dsmonAggControlIndex, dsmonPdistStatsOctets=dsmonPdistStatsOctets, dsmonHostInOctets=dsmonHostInOctets, dsmonCapsGroup=dsmonCapsGroup, dsmonStatsControlCreateTime=dsmonStatsControlCreateTime, dsmonStatsTable=dsmonStatsTable, dsmonHostCtlTable=dsmonHostCtlTable, dsmonHostCtlMaxDesiredEntries=dsmonHostCtlMaxDesiredEntries, dsmonMatrixTopNCtlGeneratedRpts=dsmonMatrixTopNCtlGeneratedRpts, dsmonAggProfileEntry=dsmonAggProfileEntry, dsmonMatrixHCGroup=dsmonMatrixHCGroup, dsmonAggGroupDescr=dsmonAggGroupDescr, dsmonMatrixTopNRevPktRateOvfl=dsmonMatrixTopNRevPktRateOvfl, dsmonPdistTopNCtlGrantedSize=dsmonPdistTopNCtlGrantedSize, dsmonHostEntry=dsmonHostEntry, DsmonCounterAggGroupIndex=DsmonCounterAggGroupIndex, dsmonPdistStatsHCOctets=dsmonPdistStatsHCOctets, dsmonStatsOvflGroup=dsmonStatsOvflGroup, dsmonPdistTopNCtlDuration=dsmonPdistTopNCtlDuration, dsmonMatrixTopNRevOctetRateOvfl=dsmonMatrixTopNRevOctetRateOvfl, dsmonMatrixTopNPktRateOvfl=dsmonMatrixTopNPktRateOvfl, dsmonPdistCtlDroppedFrames=dsmonPdistCtlDroppedFrames, dsmonHostTopNAggGroup=dsmonHostTopNAggGroup, dsmonMatrixCtlIndex=dsmonMatrixCtlIndex, dsmonPdistCtlOwner=dsmonPdistCtlOwner, dsmonMatrixTopNCtlDuration=dsmonMatrixTopNCtlDuration, dsmonStatsControlStatus=dsmonStatsControlStatus, dsmonPdistTopNCtlRateBase=dsmonPdistTopNCtlRateBase, dsmonMatrixTopNCtlRequestedSize=dsmonMatrixTopNCtlRequestedSize, dsmonMatrixCtlStatus=dsmonMatrixCtlStatus, dsmonHostGroup=dsmonHostGroup, dsmonHostOutOvflPkts=dsmonHostOutOvflPkts, dsmonAggProfileDSCP=dsmonAggProfileDSCP, dsmonAggGroupStatus=dsmonAggGroupStatus, dsmonHostOutOvflOctets=dsmonHostOutOvflOctets, dsmonMatrixTopNRevOctetRate=dsmonMatrixTopNRevOctetRate, dsmonPdistCtlIndex=dsmonPdistCtlIndex, dsmonPdistTopNIndex=dsmonPdistTopNIndex, dsmonHostTopNCtlIndex=dsmonHostTopNCtlIndex, dsmonHostObjects=dsmonHostObjects, dsmonHostTopNCtlRequestedSize=dsmonHostTopNCtlRequestedSize, dsmonMatrixTopNCtlIndex=dsmonMatrixTopNCtlIndex, dsmonStatsGroup=dsmonStatsGroup, dsmonHostOvflGroup=dsmonHostOvflGroup, dsmonGroups=dsmonGroups, dsmonHostTopNRateOvfl=dsmonHostTopNRateOvfl, dsmonHostCtlIndex=dsmonHostCtlIndex, PYSNMP_MODULE_ID=dsmonMIB, dsmonMatrixTopNTable=dsmonMatrixTopNTable, dsmonPdistCtlTable=dsmonPdistCtlTable, dsmonHostCreateTime=dsmonHostCreateTime, dsmonPdistTopNCtlIndex=dsmonPdistTopNCtlIndex, dsmonHostTable=dsmonHostTable, dsmonHostCtlDataSource=dsmonHostCtlDataSource, dsmonStatsInHCPkts=dsmonStatsInHCPkts, dsmonPdistTopNCtlTable=dsmonPdistTopNCtlTable, dsmonObjects=dsmonObjects, dsmonHostOutHCPkts=dsmonHostOutHCPkts, dsmonMatrixCtlInserts=dsmonMatrixCtlInserts, dsmonHostCtlIPv6PrefixLen=dsmonHostCtlIPv6PrefixLen, dsmonAggControlDescr=dsmonAggControlDescr, dsmonMatrixDestAddress=dsmonMatrixDestAddress, dsmonMatrixCtlMaxDesiredEntries=dsmonMatrixCtlMaxDesiredEntries, dsmonStatsObjects=dsmonStatsObjects, dsmonAggGroupEntry=dsmonAggGroupEntry, dsmonNotifications=dsmonNotifications, dsmonStatsOutPkts=dsmonStatsOutPkts, dsmonStatsOutOvflPkts=dsmonStatsOutOvflPkts, dsmonPdistTimeMark=dsmonPdistTimeMark, dsmonHostTopNIndex=dsmonHostTopNIndex, dsmonHostOutHCOctets=dsmonHostOutHCOctets, dsmonPdistTopNCtlOwner=dsmonPdistTopNCtlOwner, dsmonMatrixCtlEntry=dsmonMatrixCtlEntry, dsmonMatrixDSOvflOctets=dsmonMatrixDSOvflOctets, dsmonPdistHCGroup=dsmonPdistHCGroup, dsmonMatrixNLIndex=dsmonMatrixNLIndex, dsmonMatrixSDPkts=dsmonMatrixSDPkts, dsmonAggProfileTable=dsmonAggProfileTable, dsmonAggControlOwner=dsmonAggControlOwner, dsmonPdistTopNPDLocalIndex=dsmonPdistTopNPDLocalIndex, dsmonHostTopNCtlStatus=dsmonHostTopNCtlStatus, dsmonAggGroupTable=dsmonAggGroupTable, dsmonHostCtlAggProfile=dsmonHostCtlAggProfile, dsmonHostTopNTable=dsmonHostTopNTable, dsmonHostTopNEntry=dsmonHostTopNEntry, dsmonPdistOvflGroup=dsmonPdistOvflGroup, dsmonStatsOutHCPkts=dsmonStatsOutHCPkts, dsmonCompliances=dsmonCompliances, dsmonAggControlEntry=dsmonAggControlEntry, dsmonMatrixTopNHCRevOctetRate=dsmonMatrixTopNHCRevOctetRate, dsmonHostTopNPDLocalIndex=dsmonHostTopNPDLocalIndex, dsmonMatrixSDTable=dsmonMatrixSDTable, dsmonMatrixTopNSourceAddress=dsmonMatrixTopNSourceAddress, dsmonMaxAggGroups=dsmonMaxAggGroups, dsmonMatrixDSEntry=dsmonMatrixDSEntry, dsmonMatrixTopNRevPktRate=dsmonMatrixTopNRevPktRate, dsmonMatrixCtlOwner=dsmonMatrixCtlOwner, dsmonMatrixSDCreateTime=dsmonMatrixSDCreateTime, dsmonPdistTopNRateOvfl=dsmonPdistTopNRateOvfl, dsmonMatrixSDOctets=dsmonMatrixSDOctets, dsmonMatrixTopNNLIndex=dsmonMatrixTopNNLIndex, dsmonPdistStatsEntry=dsmonPdistStatsEntry, dsmonStatsInHCOctets=dsmonStatsInHCOctets, dsmonPdistTopNCtlStartTime=dsmonPdistTopNCtlStartTime, dsmonMatrixTopNHCPktRate=dsmonMatrixTopNHCPktRate, dsmonMatrixSourceAddress=dsmonMatrixSourceAddress, dsmonMatrixSDEntry=dsmonMatrixSDEntry, dsmonPdistTopNEntry=dsmonPdistTopNEntry, dsmonHostTimeMark=dsmonHostTimeMark, dsmonHostInHCPkts=dsmonHostInHCPkts, dsmonPdistStatsCreateTime=dsmonPdistStatsCreateTime, dsmonPdistCtlMaxDesiredEntries=dsmonPdistCtlMaxDesiredEntries, dsmonMatrixDSOctets=dsmonMatrixDSOctets, dsmonPdistStatsOvflOctets=dsmonPdistStatsOvflOctets, dsmonMatrixTopNEntry=dsmonMatrixTopNEntry, dsmonStatsInOvflPkts=dsmonStatsInOvflPkts, dsmonHostInOvflPkts=dsmonHostInOvflPkts, dsmonMatrixTopNCtlRateBase=dsmonMatrixTopNCtlRateBase, dsmonMatrixTopNCtlEntry=dsmonMatrixTopNCtlEntry, dsmonAggControlChanges=dsmonAggControlChanges, dsmonHostTopNCtlDuration=dsmonHostTopNCtlDuration, dsmonHostTopNRate=dsmonHostTopNRate, dsmonStatsControlOwner=dsmonStatsControlOwner, dsmonMatrixCtlDroppedFrames=dsmonMatrixCtlDroppedFrames, dsmonStatsControlDroppedFrames=dsmonStatsControlDroppedFrames, dsmonMatrixTopNOctetRate=dsmonMatrixTopNOctetRate, dsmonCapabilities=dsmonCapabilities, dsmonHostTopNAddress=dsmonHostTopNAddress, dsmonHostCtlInserts=dsmonHostCtlInserts, dsmonHostCtlStatus=dsmonHostCtlStatus, dsmonMatrixTopNCtlTimeRemaining=dsmonMatrixTopNCtlTimeRemaining, dsmonHostInPkts=dsmonHostInPkts, dsmonMatrixDSTable=dsmonMatrixDSTable, dsmonPdistTopNRate=dsmonPdistTopNRate, dsmonPdistCtlDataSource=dsmonPdistCtlDataSource, dsmonPdistTopNCtlTimeRemaining=dsmonPdistTopNCtlTimeRemaining, dsmonPdistTopNCtlPdistIndex=dsmonPdistTopNCtlPdistIndex, dsmonHostCtlEntry=dsmonHostCtlEntry, dsmonMatrixDSHCPkts=dsmonMatrixDSHCPkts, dsmonMatrixTopNHCOctetRate=dsmonMatrixTopNHCOctetRate, dsmonMatrixTopNHCRevPktRate=dsmonMatrixTopNHCRevPktRate, dsmonCounterAggControlGroup=dsmonCounterAggControlGroup, dsmonPdistTopNAggGroup=dsmonPdistTopNAggGroup, dsmonStatsInOctets=dsmonStatsInOctets, dsmonHostCtlDeletes=dsmonHostCtlDeletes, dsmonHostCtlIPv4PrefixLen=dsmonHostCtlIPv4PrefixLen, dsmonStatsOutOctets=dsmonStatsOutOctets, dsmonMatrixOvflGroup=dsmonMatrixOvflGroup, dsmonHostTopNCtlTimeRemaining=dsmonHostTopNCtlTimeRemaining, dsmonMatrixCtlTable=dsmonMatrixCtlTable, dsmonPdistTopNTable=dsmonPdistTopNTable, dsmonMatrixTopNCtlGrantedSize=dsmonMatrixTopNCtlGrantedSize, dsmonHostHCGroup=dsmonHostHCGroup, dsmonPdistTopNCtlEntry=dsmonPdistTopNCtlEntry, dsmonStatsControlDataSource=dsmonStatsControlDataSource, dsmonHostTopNCtlTable=dsmonHostTopNCtlTable, dsmonHostTopNCtlHostIndex=dsmonHostTopNCtlHostIndex, dsmonMatrixGroup=dsmonMatrixGroup, dsmonCompliance=dsmonCompliance, dsmonStatsControlTable=dsmonStatsControlTable, dsmonPdistTopNCtlStatus=dsmonPdistTopNCtlStatus, dsmonMatrixTopNCtlStatus=dsmonMatrixTopNCtlStatus, dsmonHostCtlCreateTime=dsmonHostCtlCreateTime, dsmonPdistCtlEntry=dsmonPdistCtlEntry, dsmonHostTopNCtlGeneratedReports=dsmonHostTopNCtlGeneratedReports, dsmonMatrixSDOvflOctets=dsmonMatrixSDOvflOctets, dsmonMatrixTopNPktRate=dsmonMatrixTopNPktRate, dsmonHCCompliance=dsmonHCCompliance, dsmonHostCtlOwner=dsmonHostCtlOwner, dsmonStatsInPkts=dsmonStatsInPkts, dsmonPdistCtlInserts=dsmonPdistCtlInserts, dsmonMatrixCtlDeletes=dsmonMatrixCtlDeletes, dsmonMatrixTopNALIndex=dsmonMatrixTopNALIndex, dsmonHostOutOctets=dsmonHostOutOctets, dsmonHostTopNCtlRateBase=dsmonHostTopNCtlRateBase, dsmonMIB=dsmonMIB, dsmonMatrixALIndex=dsmonMatrixALIndex, dsmonPdistCtlCreateTime=dsmonPdistCtlCreateTime, dsmonMatrixCtlCreateTime=dsmonMatrixCtlCreateTime, dsmonMatrixSDHCOctets=dsmonMatrixSDHCOctets, dsmonMatrixTopNAggGroup=dsmonMatrixTopNAggGroup, dsmonAggControlStatus=dsmonAggControlStatus, dsmonAggControlLastChangeTime=dsmonAggControlLastChangeTime, dsmonMatrixSDOvflPkts=dsmonMatrixSDOvflPkts, dsmonHostTopNCtlStartTime=dsmonHostTopNCtlStartTime, dsmonAggObjects=dsmonAggObjects, dsmonPdistGroup=dsmonPdistGroup, dsmonHostInOvflOctets=dsmonHostInOvflOctets, dsmonPdistCtlStatus=dsmonPdistCtlStatus, dsmonHostAddress=dsmonHostAddress, dsmonPdistStatsOvflPkts=dsmonPdistStatsOvflPkts, dsmonHostCtlDroppedFrames=dsmonHostCtlDroppedFrames, dsmonStatsEntry=dsmonStatsEntry, dsmonMatrixTopNOctetRateOvfl=dsmonMatrixTopNOctetRateOvfl, dsmonMatrixTopNCtlTable=dsmonMatrixTopNCtlTable, dsmonConformance=dsmonConformance, dsmonStatsControlEntry=dsmonStatsControlEntry, dsmonHostTopNCtlEntry=dsmonHostTopNCtlEntry, dsmonAggGroupIndex=dsmonAggGroupIndex, dsmonMatrixDSOvflPkts=dsmonMatrixDSOvflPkts, dsmonMatrixSDHCPkts=dsmonMatrixSDHCPkts, dsmonMatrixDSCreateTime=dsmonMatrixDSCreateTime, dsmonHostInHCOctets=dsmonHostInHCOctets, dsmonAggControlTable=dsmonAggControlTable, dsmonHostOutPkts=dsmonHostOutPkts, dsmonHCNoC64Compliance=dsmonHCNoC64Compliance, dsmonHostTopNCtlGrantedSize=dsmonHostTopNCtlGrantedSize, dsmonCapsObjects=dsmonCapsObjects, dsmonMatrixCtlDataSource=dsmonMatrixCtlDataSource, dsmonHostTopNCtlOwner=dsmonHostTopNCtlOwner, dsmonMatrixCtlAggProfile=dsmonMatrixCtlAggProfile, dsmonPdistStatsHCPkts=dsmonPdistStatsHCPkts, dsmonStatsOutOvflOctets=dsmonStatsOutOvflOctets, dsmonMatrixObjects=dsmonMatrixObjects, dsmonStatsInOvflOctets=dsmonStatsInOvflOctets)
