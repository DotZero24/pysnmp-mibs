...
MibIdentifier, zeroDotZero, NotificationType, Integer32, Bits, Unsigned32, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, Counter64, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "zeroDotZero", "NotificationType", "Integer32", "Bits", "Unsigned32", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("DISMAN-EXPRESSION-MIB", expErrorEntry=expErrorEntry, expObjectEntry=expObjectEntry, expExpressionEntry=expExpressionEntry, expErrorTable=expErrorTable, expResourceDeltaWildcardInstanceResourceLacks=expResourceDeltaWildcardInstanceResourceLacks, expValueCounter32Val=expValueCounter32Val, expResourceDeltaWildcardInstanceMaximum=expResourceDeltaWildcardInstanceMaximum, expObjectDiscontinuityIDType=expObjectDiscontinuityIDType, expErrorInstance=expErrorInstance, expObjectIndex=expObjectIndex, expErrorTime=expErrorTime, expResourceDeltaWildcardInstancesHigh=expResourceDeltaWildcardInstancesHigh, sysUpTimeInstance=sysUpTimeInstance, expObjectEntryStatus=expObjectEntryStatus, expExpressionComment=expExpressionComment, expValueInteger32Val=expValueInteger32Val, expErrorCode=expErrorCode, expDefine=expDefine, expErrorIndex=expErrorIndex, expValueUnsigned32Val=expValueUnsigned32Val, dismanExpressionMIBObjects=dismanExpressionMIBObjects, dismanExpressionMIBCompliances=dismanExpressionMIBCompliances, expValueEntry=expValueEntry, expObjectSampleType=expObjectSampleType, PYSNMP_MODULE_ID=dismanExpressionMIB, expResource=expResource, expExpressionErrors=expExpressionErrors, expObjectID=expObjectID, dismanExpressionResourceGroup=dismanExpressionResourceGroup, expObjectTable=expObjectTable, expExpressionName=expExpressionName, dismanExpressionMIB=dismanExpressionMIB, expValueOidVal=expValueOidVal, dismanExpressionMIBGroups=dismanExpressionMIBGroups, expExpression=expExpression, expExpressionDeltaInterval=expExpressionDeltaInterval, expValueOctetStringVal=expValueOctetStringVal, expObjectConditionalWildcard=expObjectConditionalWildcard, expValueTable=expValueTable, expExpressionPrefix=expExpressionPrefix, expObjectDiscontinuityIDWildcard=expObjectDiscontinuityIDWildcard, expResourceDeltaMinimum=expResourceDeltaMinimum, expExpressionTable=expExpressionTable, expExpressionValueType=expExpressionValueType, expExpressionEntryStatus=expExpressionEntryStatus, expValueCounter64Val=expValueCounter64Val, expValueIpAddressVal=expValueIpAddressVal, expObjectConditional=expObjectConditional, expValue=expValue, expValueTimeTicksVal=expValueTimeTicksVal, expObjectIDWildcard=expObjectIDWildcard, dismanExpressionDefinitionGroup=dismanExpressionDefinitionGroup, dismanExpressionValueGroup=dismanExpressionValueGroup, expResourceDeltaWildcardInstances=expResourceDeltaWildcardInstances, expExpressionOwner=expExpressionOwner, expValueInstance=expValueInstance, dismanExpressionMIBConformance=dismanExpressionMIBConformance, dismanExpressionMIBCompliance=dismanExpressionMIBCompliance, expObjectDeltaDiscontinuityID=expObjectDeltaDiscontinuityID)
