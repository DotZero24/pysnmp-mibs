...
mibBuilder.exportSymbols("NetWare-Host-Ext-MIB", nwhrAdapterPort1Len=nwhrAdapterPort1Len, nwhrMslEntry=nwhrMslEntry, nwhrPrinterTransportAddress=nwhrPrinterTransportAddress, nwhrDeviceNumber=nwhrDeviceNumber, nwhrAdapterDescr=nwhrAdapterDescr, nwhrHotfixUsed=nwhrHotfixUsed, nwhrPrinterTransportDomain=nwhrPrinterTransportDomain, nwhrDiskStorageCount=nwhrDiskStorageCount, nwhrStorageMemoryPermanent=nwhrStorageMemoryPermanent, nwhrAdapterDMA1=nwhrAdapterDMA1, nwhrLslInPkts=nwhrLslInPkts, nwhrPhysicalPartitionIndex=nwhrPhysicalPartitionIndex, nwhrLslOutPkts=nwhrLslOutPkts, nwhrAdapterTable=nwhrAdapterTable, nwhrAdapterDevices=nwhrAdapterDevices, nwhrStorageCodeAndDataMemory=nwhrStorageCodeAndDataMemory, nwhrDiskStorageTable=nwhrDiskStorageTable, nwhrStorageUnclaimedMemory=nwhrStorageUnclaimedMemory, nwhrIfEntry=nwhrIfEntry, nwhrHotfixUnits=nwhrHotfixUnits, nwhrMslSpeed=nwhrMslSpeed, nwhrStorage=nwhrStorage, nwhrIfTable=nwhrIfTable, nwhrHotfixTotal=nwhrHotfixTotal, nwhrAdapterDriverMajorVer=nwhrAdapterDriverMajorVer, nwhrDeviceMirroredServerLink=nwhrDeviceMirroredServerLink, nwhrStorageMSEngineMemory=nwhrStorageMSEngineMemory, pysmiFakeCol1001=pysmiFakeCol1001, nwhrAdapterDriverDescr=nwhrAdapterDriverDescr, nwhrProcessorCount=nwhrProcessorCount, nwhrHotfixTable=nwhrHotfixTable, nwhrAdapterCount=nwhrAdapterCount, nwhrMslInErrors=nwhrMslInErrors, nwHostExtensions=nwHostExtensions, nwhrProtocolName=nwhrProtocolName, nwhrDiskStorageHeads=nwhrDiskStorageHeads, nwhrProtocolOutPkts=nwhrProtocolOutPkts, nwhrHotfixReserved=nwhrHotfixReserved, nwhrStorageDOSMemory=nwhrStorageDOSMemory, nwhrProtocolID=nwhrProtocolID, nwhrStorageCacheMovable=nwhrStorageCacheMovable, nwhrMslOutErrors=nwhrMslOutErrors, nwhrPrinterTable=nwhrPrinterTable, nwhrProtocolEntry=nwhrProtocolEntry, nwhrAdapterDMA2=nwhrAdapterDMA2, nwhrStorageCacheNonMovable=nwhrStorageCacheNonMovable, nwhrStorageCacheBuffers=nwhrStorageCacheBuffers, nwhrPrinterCount=nwhrPrinterCount, nwhrAdapterPort2Len=nwhrAdapterPort2Len, nwhrPrinterQueueName=nwhrPrinterQueueName, nwhrPhysicalPartitionEntry=nwhrPhysicalPartitionEntry, pysmiFakeCol1002=pysmiFakeCol1002, nwhrPhysicalPartitionTable=nwhrPhysicalPartitionTable, nwhrAdapterIndex=nwhrAdapterIndex, nwhrProtocolIgnoredPkts=nwhrProtocolIgnoredPkts, nwhrPhysicalPartitionDescr=nwhrPhysicalPartitionDescr, nwhrPrinterEntry=nwhrPrinterEntry, nwhrIfLogicalBoardNumber=nwhrIfLogicalBoardNumber, nwhrAdapterDriverMinorVer=nwhrAdapterDriverMinorVer, nwhrMslReceives=nwhrMslReceives, nwhrStorageIOEngineMemory=nwhrStorageIOEngineMemory, nwhrProtocolTable=nwhrProtocolTable, nwhrStorageTypes=nwhrStorageTypes, TransportAddress=TransportAddress, nwhrAdapterInterrupt1=nwhrAdapterInterrupt1, nwhrLslUnclaimedPkts=nwhrLslUnclaimedPkts, nwhrDeviceTable=nwhrDeviceTable, nwhrDiskStorageBlockSize=nwhrDiskStorageBlockSize, nwhrDeviceEntry=nwhrDeviceEntry, nwhrPhysicalPartitionType=nwhrPhysicalPartitionType, nwhrAdapterMem2=nwhrAdapterMem2, nwhrAdapterMem1Len=nwhrAdapterMem1Len, nwhrStorageMemoryAlloc=nwhrStorageMemoryAlloc, nwhrDiskStorageCylinders=nwhrDiskStorageCylinders, nwhrMslCount=nwhrMslCount, nwhrMslSends=nwhrMslSends, nwhrDiskStorageSectorSize=nwhrDiskStorageSectorSize, nwhrAdapterMem2Len=nwhrAdapterMem2Len, novell=novell, nwhrDeviceAdapterIndex=nwhrDeviceAdapterIndex, nwhrProtocolInPkts=nwhrProtocolInPkts, nwhrMslTable=nwhrMslTable, nwhrAdapterInterrupt2=nwhrAdapterInterrupt2, nwhrMslState=nwhrMslState, nwhrPrinterType=nwhrPrinterType, nwhrProtocolFullName=nwhrProtocolFullName, nwhrAdapterPort1=nwhrAdapterPort1, nwhrIfLogicalBoardName=nwhrIfLogicalBoardName, nwhrAdapterSlot=nwhrAdapterSlot, nwhrAdapterType=nwhrAdapterType, nwhrProtocolAddress=nwhrProtocolAddress, nwhrDiskStorageSectorsPerTrack=nwhrDiskStorageSectorsPerTrack, nwhrPrinterLocalName=nwhrPrinterLocalName, InternationalDisplayString=InternationalDisplayString, TransportDomain=TransportDomain, nwhrPrinterID=nwhrPrinterID, nwhrDevice=nwhrDevice, nwhrOdi=nwhrOdi, mibDoc=mibDoc, nwhrDeviceTypes=nwhrDeviceTypes, nwhrAdapterPort2=nwhrAdapterPort2, nwhrPhysicalPartitionSize=nwhrPhysicalPartitionSize, nwhrDeviceControllerNumber=nwhrDeviceControllerNumber, nwhrDiskStorageEntry=nwhrDiskStorageEntry, KBytes=KBytes, nwhrHotfixEntry=nwhrHotfixEntry, nwhrIfFrameType=nwhrIfFrameType, nwhrPrinterDeviceIndex=nwhrPrinterDeviceIndex, nwhrPrinterServerName=nwhrPrinterServerName, nwhrAdapterEntry=nwhrAdapterEntry, nwhrStorageVolume=nwhrStorageVolume, nwhrAdapterMem1=nwhrAdapterMem1)
