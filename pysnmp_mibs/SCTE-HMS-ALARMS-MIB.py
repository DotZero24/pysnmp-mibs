...
mibBuilder.exportSymbols("SCTE-HMS-ALARMS-MIB", alarmText=alarmText, alarmLogTable=alarmLogTable, alarmLogNumberOfEntries=alarmLogNumberOfEntries, alarmLogInformation=alarmLogInformation, alarmLogIndex=alarmLogIndex, alarmLogEntry=alarmLogEntry, alarmLogLastIndex=alarmLogLastIndex, hmsAlarmEvent=hmsAlarmEvent)
