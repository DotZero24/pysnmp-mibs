...
_F='commonLogicalID'
_E='OctetString'
_D='SCTE-HMS-ALARMS-MIB'
_C='SCTE-HMS-COMMON-MIB'
_B='read-only'
_A='mandatory'
...
commonLogicalID,commonPhysAddress=mibBuilder.importSymbols(_C,_F,_G)
...
alarmLogNumberOfEntries=_AlarmLogNumberOfEntries_Object((1,3,6,1,4,1,5591,1,2,1),_AlarmLogNumberOfEntries_Type())
...
alarmLogLastIndex=_AlarmLogLastIndex_Object((1,3,6,1,4,1,5591,1,2,2),_AlarmLogLastIndex_Type())
alarmLogLastIndex.setMaxAccess(_B)
if mibBuilder.loadTexts:alarmLogLastIndex.setStatus(_A)
_AlarmLogTable_Object=MibTable
alarmLogTable=_AlarmLogTable_Object((1,3,6,1,4,1,5591,1,2,3))
if mibBuilder.loadTexts:alarmLogTable.setStatus(_A)
_AlarmLogEntry_Object=MibTableRow
alarmLogEntry=_AlarmLogEntry_Object((1,3,6,1,4,1,5591,1,2,3,1))
alarmLogEntry.setIndexNames((0,_D,_J))
...
alarmLogIndex=_AlarmLogIndex_Object((1,3,6,1,4,1,5591,1,2,3,1,1),_AlarmLogIndex_Type())
...
alarmLogInformation=_AlarmLogInformation_Object((1,3,6,1,4,1,5591,1,2,3,1,2),_AlarmLogInformation_Type())
...
alarmText=_AlarmText_Object((1,3,6,1,4,1,5591,1,2,4),_AlarmText_Type())
alarmText.setMaxAccess(_B)
if mibBuilder.loadTexts:alarmText.setStatus('optional')
hmsAlarmEvent=NotificationType((1,3,6,1,4,1,5591,1,0,1))
hmsAlarmEvent.setObjects(*((_C,_G),(_C,_F),(_D,_K)))
if mibBuilder.loadTexts:hmsAlarmEvent.setStatus('')
mibBuilder.exportSymbols(_D,**{'hmsAlarmEvent':hmsAlarmEvent,'alarmLogNumberOfEntries':alarmLogNumberOfEntries,'alarmLogLastIndex':alarmLogLastIndex,'alarmLogTable':alarmLogTable,'alarmLogEntry':alarmLogEntry,_J:alarmLogIndex,_K:alarmLogInformation,'alarmText':alarmText})