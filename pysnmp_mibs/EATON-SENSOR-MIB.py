...
mibBuilder.exportSymbols("EATON-SENSOR-MIB", temperatureThresholdHysteresis=temperatureThresholdHysteresis, digitalInputConfigurationEntry=digitalInputConfigurationEntry, digitalInputMonitoringEntry=digitalInputMonitoringEntry, temperatureMaxValueSince=temperatureMaxValueSince, temperatureConnectionType=temperatureConnectionType, humidityConnectionType=humidityConnectionType, sensorModel=sensorModel, temperatureMonitoringMinMaxTable=temperatureMonitoringMinMaxTable, sensorStatusSince=sensorStatusSince, sensor=sensor, humidityUuid=humidityUuid, digitalInput=digitalInput, temperatureMaxValue=temperatureMaxValue, temperatureIdentificationEntry=temperatureIdentificationEntry, temperatureMinValueSince=temperatureMinValueSince, humidityCommunicationStatus=humidityCommunicationStatus, digitalInputName=digitalInputName, digitalInputEnable=digitalInputEnable, temperatureAlarmEnable=temperatureAlarmEnable, sensorTemperatureCount=sensorTemperatureCount, sensorPosition=sensorPosition, humidityConfigurationEntry=humidityConfigurationEntry, humidityMonitoringEntry=humidityMonitoringEntry, digitalInputMonitoringTable=digitalInputMonitoringTable, humidityIdentificationEntry=humidityIdentificationEntry, digitalInputCommunicationStatusSince=digitalInputCommunicationStatusSince, temperatureMonitoringTable=temperatureMonitoringTable, humidityMaxValue=humidityMaxValue, digitalInputAlarm=digitalInputAlarm, temperatureValue=temperatureValue, ResetCommandType=ResetCommandType, humidityAlarmEnable=humidityAlarmEnable, sensorCount=sensorCount, digitalInputAlarmSeverity=digitalInputAlarmSeverity, humidityAlarm=humidityAlarm, PYSNMP_MODULE_ID=eatonSensor, humidityNotification=humidityNotification, temperatureUuid=temperatureUuid, eatonSensorCompliances=eatonSensorCompliances, AlarmSeverityType=AlarmSeverityType, temperatureConfigurationTable=temperatureConfigurationTable, digitalInputAlarmGracePeriod=digitalInputAlarmGracePeriod, humidityMaxValueSince=humidityMaxValueSince, temperatureIndex=temperatureIndex, sensorSerialNumber=sensorSerialNumber, sensorElevation=sensorElevation, humidityIndex=humidityIndex, humidityMonitoringMinMaxEntry=humidityMonitoringMinMaxEntry, sensorFirmwareVersion=sensorFirmwareVersion, notifydigitalInputCommunicationStatus=notifydigitalInputCommunicationStatus, humidityMinValue=humidityMinValue, PolarityType=PolarityType, AlarmLevelType=AlarmLevelType, sensorDigitalInputCount=sensorDigitalInputCount, temperatureCommunicationStatusSince=temperatureCommunicationStatusSince, ProbeConnectionType=ProbeConnectionType, sensorUElevation=sensorUElevation, humidityConfigurationTable=humidityConfigurationTable, sensorName=sensorName, notifySensorCount=notifySensorCount, EnableType=EnableType, sensorManufacturer=sensorManufacturer, temperature=temperature, sensorConnectionType=sensorConnectionType, PositionType=PositionType, humidityMonitoringMinMaxTable=humidityMonitoringMinMaxTable, digitalInputConnectionType=digitalInputConnectionType, sensorOptionalGroup=sensorOptionalGroup, temperatureResetMinMax=temperatureResetMinMax, notifyHumidityCommunicationStatus=notifyHumidityCommunicationStatus, temperatureUnit=temperatureUnit, humidityThresholdHysteresis=humidityThresholdHysteresis, objectGroups=objectGroups, sensorConfigurationTable=sensorConfigurationTable, temperatureAlarmChangeSince=temperatureAlarmChangeSince, sensorRequiredGroup=sensorRequiredGroup, sensorIdentificationTable=sensorIdentificationTable, sensorStatus=sensorStatus, temperatureConfigurationEntry=temperatureConfigurationEntry, digitalInputConfigurationTable=digitalInputConfigurationTable, humidityResetMinMax=humidityResetMinMax, digitalInputIdentificationEntry=digitalInputIdentificationEntry, humidityOffset=humidityOffset, sensorPartNumber=sensorPartNumber, humidityThresholdHighWarning=humidityThresholdHighWarning, digitalInputAlarmEnable=digitalInputAlarmEnable, temperatureMinValue=temperatureMinValue, humidityThresholdLowCritical=humidityThresholdLowCritical, temperatureThresholdHighCritical=temperatureThresholdHighCritical, humidityMonitoringTable=humidityMonitoringTable, temperatureThresholdLowCritical=temperatureThresholdLowCritical, humidity=humidity, temperatureAlarm=temperatureAlarm, sensorMonitoredBy=sensorMonitoredBy, AlarmType=AlarmType, temperatureMonitoringMinMaxEntry=temperatureMonitoringMinMaxEntry, TemperatureUnitType=TemperatureUnitType, humidityAlarmGracePeriod=humidityAlarmGracePeriod, temperatureThresholdHighWarning=temperatureThresholdHighWarning, eatonSensor=eatonSensor, temperatureIdentificationTable=temperatureIdentificationTable, digitalInputState=digitalInputState, digitalInputIndex=digitalInputIndex, notifyTemperatureCommunicationStatus=notifyTemperatureCommunicationStatus, humidityMinValueSince=humidityMinValueSince, humidityThresholdLowWarning=humidityThresholdLowWarning, digitalInputStateSince=digitalInputStateSince, digitalInputPolarity=digitalInputPolarity, temperatureCommunicationStatus=temperatureCommunicationStatus, sensorConfigurationEntry=sensorConfigurationEntry, temperatureAlarmGracePeriod=temperatureAlarmGracePeriod, CommunicationStatus=CommunicationStatus, humidityThresholdHighCritical=humidityThresholdHighCritical, sensorAddress=sensorAddress, conformance=conformance, UnixTimeStamp=UnixTimeStamp, sensorIndex=sensorIndex, sensorAnalogInputCount=sensorAnalogInputCount, sensorNotification=sensorNotification, sensorNotifyGroup=sensorNotifyGroup, digitalInputCommunicationStatus=digitalInputCommunicationStatus, temperatureOffset=temperatureOffset, sensorIdentificationEntry=sensorIdentificationEntry, temperatureNotification=temperatureNotification, notifyDigitalInputAlarm=notifyDigitalInputAlarm, digitalInputNotification=digitalInputNotification, digitalInputIdentificationTable=digitalInputIdentificationTable, sensorLocation=sensorLocation, temperatureName=temperatureName, sensorMonitoringTable=sensorMonitoringTable, notifyTemperatureAlarm=notifyTemperatureAlarm, humidityEnable=humidityEnable, notifySensorStatus=notifySensorStatus, digitalInputUuid=digitalInputUuid, sensorUuid=sensorUuid, sensorMonitoringEntry=sensorMonitoringEntry, humidityName=humidityName, temperatureEnable=temperatureEnable, humidityAlarmChangeSince=humidityAlarmChangeSince, ElevationType=ElevationType, notifyHumidityAlarm=notifyHumidityAlarm, humidityIdentificationTable=humidityIdentificationTable, temperatureThresholdLowWarning=temperatureThresholdLowWarning, humidityValue=humidityValue, temperatureMonitoringEntry=temperatureMonitoringEntry, humidityCommunicationStatusSince=humidityCommunicationStatusSince, StateType=StateType, sensorHumidityCount=sensorHumidityCount, digitalInputAlarmChangeSince=digitalInputAlarmChangeSince)
