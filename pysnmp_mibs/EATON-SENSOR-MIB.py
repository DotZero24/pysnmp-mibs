...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/eaton/EATON-SENSOR-MIB
...
eatonSensor.setRevisions(('2022-05-06 12:00', '2018-12-17 12:00',))
if mibBuilder.loadTexts: eatonSensor.setLastUpdated('202205061200Z')
...
class AlarmSeverityType(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("informational", 1), ("warning", 2), ("critical", 3))

class AlarmLevelType(TextualConvention, Integer32):
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3))
    namedValues = NamedValues(("good", 0), ("informational", 1), ("warning", 2), ("critical", 3))
...
mibBuilder.exportSymbols("EATON-SENSOR-MIB", sensorConfigurationEntry=sensorConfigurationEntry, temperatureThresholdLowCritical=temperatureThresholdLowCritical, temperatureMonitoringMinMaxTable=temperatureMonitoringMinMaxTable, humidityIdentificationEntry=humidityIdentificationEntry, humidity=humidity, ElevationType=ElevationType, digitalInputNotification=digitalInputNotification, sensorConfigurationTable=sensorConfigurationTable, digitalInputIdentificationEntry=digitalInputIdentificationEntry, temperatureMinValueSince=temperatureMinValueSince, humidityMonitoringMinMaxEntry=humidityMonitoringMinMaxEntry, digitalInputName=digitalInputName, humidityThresholdHysteresis=humidityThresholdHysteresis, PolarityType=PolarityType, digitalInputAlarm=digitalInputAlarm, PYSNMP_MODULE_ID=eatonSensor, sensorUElevation=sensorUElevation, sensorElevation=sensorElevation, sensorMonitoringEntry=sensorMonitoringEntry, temperatureConfigurationTable=temperatureConfigurationTable, notifyDigitalInputAlarm=notifyDigitalInputAlarm, temperatureOffset=temperatureOffset, temperatureAlarmGracePeriod=temperatureAlarmGracePeriod, temperatureMinValue=temperatureMinValue, sensorNotifyGroup=sensorNotifyGroup, temperatureConfigurationEntry=temperatureConfigurationEntry, sensorFirmwareVersion=sensorFirmwareVersion, humidityResetMinMax=humidityResetMinMax, notifyHumidityCommunicationStatus=notifyHumidityCommunicationStatus, sensorNotification=sensorNotification, notifydigitalInputCommunicationStatus=notifydigitalInputCommunicationStatus, humidityEnable=humidityEnable, humidityThresholdLowWarning=humidityThresholdLowWarning, sensorIndex=sensorIndex, conformance=conformance, sensorLocation=sensorLocation, temperatureMaxValueSince=temperatureMaxValueSince, sensorPartNumber=sensorPartNumber, sensorMonitoredBy=sensorMonitoredBy, digitalInput=digitalInput, temperatureMonitoringTable=temperatureMonitoringTable, humidityThresholdHighWarning=humidityThresholdHighWarning, temperatureAlarmEnable=temperatureAlarmEnable, sensorHumidityCount=sensorHumidityCount, temperatureMaxValue=temperatureMaxValue, sensorDigitalInputCount=sensorDigitalInputCount, temperatureResetMinMax=temperatureResetMinMax, UnixTimeStamp=UnixTimeStamp, sensorAnalogInputCount=sensorAnalogInputCount, sensorManufacturer=sensorManufacturer, temperatureCommunicationStatusSince=temperatureCommunicationStatusSince, humidityConfigurationEntry=humidityConfigurationEntry, sensorCount=sensorCount, digitalInputEnable=digitalInputEnable, humidityMonitoringTable=humidityMonitoringTable, sensorTemperatureCount=sensorTemperatureCount, EnableType=EnableType, AlarmType=AlarmType, humidityNotification=humidityNotification, humidityConfigurationTable=humidityConfigurationTable, temperature=temperature, humidityMaxValue=humidityMaxValue, digitalInputState=digitalInputState, digitalInputCommunicationStatus=digitalInputCommunicationStatus, humidityAlarm=humidityAlarm, humidityName=humidityName, sensorIdentificationTable=sensorIdentificationTable, digitalInputAlarmChangeSince=digitalInputAlarmChangeSince, notifySensorStatus=notifySensorStatus, eatonSensorCompliances=eatonSensorCompliances, temperatureEnable=temperatureEnable, ProbeConnectionType=ProbeConnectionType, TemperatureUnitType=TemperatureUnitType, sensorModel=sensorModel, notifySensorCount=notifySensorCount, humidityThresholdHighCritical=humidityThresholdHighCritical, temperatureMonitoringEntry=temperatureMonitoringEntry, humidityAlarmEnable=humidityAlarmEnable, temperatureIdentificationTable=temperatureIdentificationTable, notifyHumidityAlarm=notifyHumidityAlarm, temperatureIndex=temperatureIndex, digitalInputPolarity=digitalInputPolarity, humidityMinValueSince=humidityMinValueSince, temperatureUnit=temperatureUnit, temperatureAlarmChangeSince=temperatureAlarmChangeSince, CommunicationStatus=CommunicationStatus, sensorStatus=sensorStatus, notifyTemperatureCommunicationStatus=notifyTemperatureCommunicationStatus, temperatureIdentificationEntry=temperatureIdentificationEntry, StateType=StateType, humidityCommunicationStatus=humidityCommunicationStatus, temperatureMonitoringMinMaxEntry=temperatureMonitoringMinMaxEntry, temperatureValue=temperatureValue, humidityValue=humidityValue, humidityMinValue=humidityMinValue, AlarmSeverityType=AlarmSeverityType, temperatureUuid=temperatureUuid, digitalInputConnectionType=digitalInputConnectionType, sensorMonitoringTable=sensorMonitoringTable, temperatureNotification=temperatureNotification, sensorUuid=sensorUuid, PositionType=PositionType, temperatureCommunicationStatus=temperatureCommunicationStatus, ResetCommandType=ResetCommandType, sensorConnectionType=sensorConnectionType, digitalInputCommunicationStatusSince=digitalInputCommunicationStatusSince, digitalInputConfigurationEntry=digitalInputConfigurationEntry, digitalInputConfigurationTable=digitalInputConfigurationTable, sensorSerialNumber=sensorSerialNumber, sensorAddress=sensorAddress, humidityThresholdLowCritical=humidityThresholdLowCritical, humidityUuid=humidityUuid, sensorOptionalGroup=sensorOptionalGroup, digitalInputIdentificationTable=digitalInputIdentificationTable, digitalInputMonitoringEntry=digitalInputMonitoringEntry, humidityCommunicationStatusSince=humidityCommunicationStatusSince, sensor=sensor, digitalInputIndex=digitalInputIndex, digitalInputAlarmEnable=digitalInputAlarmEnable, sensorName=sensorName, eatonSensor=eatonSensor, temperatureConnectionType=temperatureConnectionType, temperatureAlarm=temperatureAlarm, humidityConnectionType=humidityConnectionType, sensorPosition=sensorPosition, digitalInputMonitoringTable=digitalInputMonitoringTable, humidityIndex=humidityIndex, temperatureThresholdHighWarning=temperatureThresholdHighWarning, humidityAlarmGracePeriod=humidityAlarmGracePeriod, temperatureThresholdHysteresis=temperatureThresholdHysteresis, humidityIdentificationTable=humidityIdentificationTable, sensorRequiredGroup=sensorRequiredGroup, AlarmLevelType=AlarmLevelType, humidityMonitoringEntry=humidityMonitoringEntry, humidityMaxValueSince=humidityMaxValueSince, humidityAlarmChangeSince=humidityAlarmChangeSince, sensorStatusSince=sensorStatusSince, temperatureName=temperatureName, digitalInputUuid=digitalInputUuid, notifyTemperatureAlarm=notifyTemperatureAlarm, digitalInputAlarmSeverity=digitalInputAlarmSeverity, digitalInputAlarmGracePeriod=digitalInputAlarmGracePeriod, digitalInputStateSince=digitalInputStateSince, temperatureThresholdLowWarning=temperatureThresholdLowWarning, objectGroups=objectGroups, temperatureThresholdHighCritical=temperatureThresholdHighCritical, humidityOffset=humidityOffset, humidityMonitoringMinMaxTable=humidityMonitoringMinMaxTable, sensorIdentificationEntry=sensorIdentificationEntry)
