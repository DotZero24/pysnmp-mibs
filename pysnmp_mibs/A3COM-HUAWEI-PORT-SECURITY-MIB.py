# SNMP MIB module (A3COM-HUAWEI-PORT-SECURITY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-PORT-SECURITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:55 2025
...
h3cPortSecurityLeaf = _H3cPortSecurityLeaf_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 26, 1, 1)
)
...
h3cSecureRalmObjects = _H3cSecureRalmObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 26, 1, 1, 4)
)
...
h3cPortSecurityTables = _H3cPortSecurityTables_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 26, 1, 2)
)
...
h3cSecureAddressEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "A3COM-HUAWEI-PORT-SECURITY-MIB", "h3cSecureAddrMAC"),
    (0, "A3COM-HUAWEI-PORT-SECURITY-MIB", "h3cSecureAddrVlanID"),
)
if mibBuilder.loadTexts:
...
h3cSecureOUIEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORT-SECURITY-MIB", "h3cSecureOUIIndex"),
)
if mibBuilder.loadTexts:
...
h3cSecureBindingEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORT-SECURITY-MIB", "h3cSecureBindingIndex"),
)
if mibBuilder.loadTexts:
...
_H3cSecureAssignEnable_Type.__name__ = "TruthValue"
...
h3cPortSecurityNotifications = _H3cPortSecurityNotifications_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 26, 1, 3)
)
...
h3cSecureAddressLearned.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("A3COM-HUAWEI-PORT-SECURITY-MIB", "h3cSecureAddrMAC"))
)
if mibBuilder.loadTexts:
...
h3cSecureLogon.setObjects(
      *(("IF-MIB", "ifIndex"),
        ...
        ("A3COM-HUAWEI-PORT-SECURITY-MIB", "h3cSecurePortVlanMembershipList"))
)
if mibBuilder.loadTexts:
...
h3cSecureRalmLoginFailure.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("A3COM-HUAWEI-PORT-SECURITY-MIB", "h3cSecureAddrMAC"),
        ("A3COM-HUAWEI-PORT-SECURITY-MIB", "h3cSecureRalmAuthMode"),
        ("A3COM-HUAWEI-PORT-SECURITY-MIB", "h3cSecureRalmAuthUsername"))
)
if mibBuilder.loadTexts:
