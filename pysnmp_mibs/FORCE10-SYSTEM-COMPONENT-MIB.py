_S='camUsageL3ExtPipeId'
_R='camUsageL3ExtSlot'
_Q='camUsageL3PipeId'
_P='camUsageL3Slot'
_O='camUsageL2PipeId'
_N='camUsageL2Slot'
...
_D='not-accessible'
_C='FORCE10-SYSTEM-COMPONENT-MIB'
_B='read-only'
_A='current'
...
f10SysComponentObjects=_F10SysComponentObjects_ObjectIdentity((1,3,6,1,4,1,6027,3,7,1))
_F10CamEntries_ObjectIdentity=ObjectIdentity
f10CamEntries=_F10CamEntries_ObjectIdentity((1,3,6,1,4,1,6027,3,7,1,1))
...
camUsageL2Entry.setIndexNames((0,_C,_N),(0,_C,_O))
...
camUsageL3Entry.setIndexNames((0,_C,_P),(0,_C,_Q))
...
camUsageL3ExtEntry.setIndexNames((0,_C,_R),(0,_C,_S))
...
f10SysComponentTrap=_F10SysComponentTrap_ObjectIdentity((1,3,6,1,4,1,6027,3,7,1,2))
...
mibBuilder.exportSymbols(_C,**{'f10SysComponentMib':f10SysComponentMib,'f10SysComponentObjects':f10SysComponentObjects,'f10CamEntries':f10CamEntries,'camUsageTable':camUsageTable,'camUsageEntry':camUsageEntry,_K:camUsageSlot,_L:camUsagePipeNum,_M:camUsagePartId,'camUsagePartDesc':camUsagePartDesc,'camUsageTotal':camUsageTotal,'camUsageUsed':camUsageUsed,'camUsageL2Table':camUsageL2Table,'camUsageL2Entry':camUsageL2Entry,_N:camUsageL2Slot,_O:camUsageL2PipeId,'camUsageL2IngAclTotal':camUsageL2IngAclTotal,'camUsageL2IngAclUsed':camUsageL2IngAclUsed,'camUsageL2IngFibTotal':camUsageL2IngFibTotal,'camUsageL2IngFibUsed':camUsageL2IngFibUsed,'camUsageL2EgrAclTotal':camUsageL2EgrAclTotal,'camUsageL2EgrAclUsed':camUsageL2EgrAclUsed,'camUsageL3Table':camUsageL3Table,'camUsageL3Entry':camUsageL3Entry,_P:camUsageL3Slot,_Q:camUsageL3PipeId,'camUsageL3IngFibTotal':camUsageL3IngFibTotal,'camUsageL3IngFibUsed':camUsageL3IngFibUsed,'camUsageL3IngSysFlowTotal':camUsageL3IngSysFlowTotal,'camUsageL3IngSysFlowUsed':camUsageL3IngSysFlowUsed,'camUsageL3IngTrcListTotal':camUsageL3IngTrcListTotal,'camUsageL3IngTrcListUsed':camUsageL3IngTrcListUsed,'camUsageL3IngMcastFibTotal':camUsageL3IngMcastFibTotal,'camUsageL3IngMcastFibUsed':camUsageL3IngMcastFibUsed,'camUsageL3IngQosTotal':camUsageL3IngQosTotal,'camUsageL3IngQosUsed':camUsageL3IngQosUsed,'camUsageL3IngPbrTotal':camUsageL3IngPbrTotal,'camUsageL3IngPbrUsed':camUsageL3IngPbrUsed,'camUsageL3IngAclTotal':camUsageL3IngAclTotal,'camUsageL3IngAclUsed':camUsageL3IngAclUsed,'camUsageL3EgrAclTotal':camUsageL3EgrAclTotal,'camUsageL3EgrAclUsed':camUsageL3EgrAclUsed,'camUsageL3ExtTable':camUsageL3ExtTable,'camUsageL3ExtEntry':camUsageL3ExtEntry,_R:camUsageL3ExtSlot,_S:camUsageL3ExtPipeId,'camUsageL3ExtHostTotal':camUsageL3ExtHostTotal,'camUsageL3ExtHostUsed':camUsageL3ExtHostUsed,'camUsageL3ExtLPMTotal':camUsageL3ExtLPMTotal,'camUsageL3ExtLPMUsed':camUsageL3ExtLPMUsed,'f10SysComponentTrap':f10SysComponentTrap,'sysCompAlarmMibNotifications':sysCompAlarmMibNotifications,'camUsageThresholdExceed':camUsageThresholdExceed,'camIsFull':camIsFull,'camAuditError':camAuditError,'sysCompAlarmVariable':sysCompAlarmVariable,_F:sysCompAlarmLevel,_G:sysCompAlarmVarString,_H:sysCompSlotId,_I:sysCompPortPipe,_J:sysCompCamPartId})