...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cabletron/CTRON-IPX-ROUTER-MIB
...
mibBuilder.exportSymbols("CTRON-IPX-ROUTER-MIB", nwIpxNetBIOSIfCtrReset=nwIpxNetBIOSIfCtrReset, nwIpxEchoCtrFilteredPkts=nwIpxEchoCtrFilteredPkts, nwIpxNetBIOSIfCtrDiscardBytes=nwIpxNetBIOSIfCtrDiscardBytes, nwIpxRipCtrOutPkts=nwIpxRipCtrOutPkts, nwIpxNetBIOSVersion=nwIpxNetBIOSVersion, nwIpxSapServerIfNetId=nwIpxSapServerIfNetId, nwIpxRipCtrFilteredPkts=nwIpxRipCtrFilteredPkts, nwIpxEchoIfCtrInBytes=nwIpxEchoIfCtrInBytes, nwIpxSapSystem=nwIpxSapSystem, nwIpxSapServerIfSrcNode=nwIpxSapServerIfSrcNode, nwIpxRipHoldDown=nwIpxRipHoldDown, nwIpxRipRtIfIndex=nwIpxRipRtIfIndex, nwIpxFwdCtrLenErrPkts=nwIpxFwdCtrLenErrPkts, nwIpxAclSrcSocket=nwIpxAclSrcSocket, nwIpxEventSeverity=nwIpxEventSeverity, nwIpxRipInterfaces=nwIpxRipInterfaces, nwIpxBcastOperStatus=nwIpxBcastOperStatus, nwIpxSapCtrFilteredBytes=nwIpxSapCtrFilteredBytes, nwIpxRipIfAclIdentifier=nwIpxRipIfAclIdentifier, nwIpxFwdCtrOperationalTime=nwIpxFwdCtrOperationalTime, nwIpxRipIfCtrDiscardPkts=nwIpxRipIfCtrDiscardPkts, nwIpxFwdCtrHostOutPkts=nwIpxFwdCtrHostOutPkts, nwIpxNetBIOSIfIndex=nwIpxNetBIOSIfIndex, nwIpxFwdIfCtrFilteredPkts=nwIpxFwdIfCtrFilteredPkts, nwIpxHostsToMedia=nwIpxHostsToMedia, nwIpxEventFltrType=nwIpxEventFltrType, nwIpxNetBIOSCtrFilteredPkts=nwIpxNetBIOSCtrFilteredPkts, nwIpxRipOperationalTime=nwIpxRipOperationalTime, nwIpxRipCtrDiscardPkts=nwIpxRipCtrDiscardPkts, nwIpxSapIfCtrOperationalTime=nwIpxSapIfCtrOperationalTime, nwIpxFwdIfCtrHdrErrPkts=nwIpxFwdIfCtrHdrErrPkts, nwIpxAclSrcNode=nwIpxAclSrcNode, nwIpxBcastIfOperStatus=nwIpxBcastIfOperStatus, nwIpxEchoCtrOutBytes=nwIpxEchoCtrOutBytes, nwIpxAclValidEntries=nwIpxAclValidEntries, nwIpxFwdIfCtrOutBytes=nwIpxFwdIfCtrOutBytes, nwIpxEchoIfCtrEntry=nwIpxEchoIfCtrEntry, nwIpxAddrIfAddrType=nwIpxAddrIfAddrType, nwIpxFwdIfMtu=nwIpxFwdIfMtu, nwIpxEchoIfTable=nwIpxEchoIfTable, nwIpxFwdIfCtrTable=nwIpxFwdIfCtrTable, nwIpxHostMapIfIndex=nwIpxHostMapIfIndex, nwIpxEchoIfCtrDiscardPkts=nwIpxEchoIfCtrDiscardPkts, nwIpxHostMapTable=nwIpxHostMapTable, nwIpxFwdCtrInBytes=nwIpxFwdCtrInBytes, nwIpxRipIfCtrOutBytes=nwIpxRipIfCtrOutBytes, nwIpxFwdCounters=nwIpxFwdCounters, nwIpxSapIfCtrTable=nwIpxSapIfCtrTable, nwIpxFwdIfOperStatus=nwIpxFwdIfOperStatus, nwIpxRipIfCtrInBytes=nwIpxRipIfCtrInBytes, nwIpxBcastIfCtrDiscardBytes=nwIpxBcastIfCtrDiscardBytes, nwIpxEchoCtrInPkts=nwIpxEchoCtrInPkts, nwIpxSapServerIfType=nwIpxSapServerIfType, nwIpxEchoIfCtrFilteredPkts=nwIpxEchoIfCtrFilteredPkts, nwIpxRipIfSplitHorizon=nwIpxRipIfSplitHorizon, nwIpxHostMapPortNumber=nwIpxHostMapPortNumber, nwIpxRipRtNetId=nwIpxRipRtNetId, nwIpxRipIfOperationalTime=nwIpxRipIfOperationalTime, nwIpxTopology=nwIpxTopology, nwIpxSapIfAdvertisement=nwIpxSapIfAdvertisement, nwIpxHostMapFraming=nwIpxHostMapFraming, nwIpxFwdIfAclIdentifier=nwIpxFwdIfAclIdentifier, nwIpxAclSrcNetNum=nwIpxAclSrcNetNum, nwIpxRedirector=nwIpxRedirector, nwIpxFwdCtrOutBytes=nwIpxFwdCtrOutBytes, nwIpxAclMatches=nwIpxAclMatches, nwIpxEventIfNum=nwIpxEventIfNum, nwIpxForwarding=nwIpxForwarding, nwIpxEchoIfOperationalTime=nwIpxEchoIfOperationalTime, nwIpxFibTable=nwIpxFibTable, nwIpxFibNextHopNet=nwIpxFibNextHopNet, nwIpxEchoIfEntry=nwIpxEchoIfEntry, nwIpxSapIfCtrIfIndex=nwIpxSapIfCtrIfIndex, nwIpxFwdIfCacheEntries=nwIpxFwdIfCacheEntries, nwIpxSapServerIfFlags=nwIpxSapServerIfFlags, nwIpxSapIfCtrDiscardPkts=nwIpxSapIfCtrDiscardPkts, nwIpxNetBIOSCtrOperationalTime=nwIpxNetBIOSCtrOperationalTime, nwIpxBroadcastIfCounters=nwIpxBroadcastIfCounters, nwIpxEchoIfCounters=nwIpxEchoIfCounters, nwIpxFwdIfCtrDiscardBytes=nwIpxFwdIfCtrDiscardBytes, nwIpxSapIfSplitHorizon=nwIpxSapIfSplitHorizon, nwIpxNetBIOSIfCtrEntry=nwIpxNetBIOSIfCtrEntry, nwIpxBcastIfCtrIfIndex=nwIpxBcastIfCtrIfIndex, nwIpxNetBIOSIfConfig=nwIpxNetBIOSIfConfig, nwIpxRipIfRequestDelay=nwIpxRipIfRequestDelay, nwIpxEchoCtrInBytes=nwIpxEchoCtrInBytes, nwIpxRipCtrFilteredBytes=nwIpxRipCtrFilteredBytes, nwIpxEventFltrSeverity=nwIpxEventFltrSeverity, nwIpxBcastIfIndex=nwIpxBcastIfIndex, nwIpxFwdIfControl=nwIpxFwdIfControl, nwIpxAclEntry=nwIpxAclEntry, nwIpxFwdIfCtrEntry=nwIpxFwdIfCtrEntry, nwIpxEventAdminStatus=nwIpxEventAdminStatus, nwIpxAclSequence=nwIpxAclSequence, nwIpxEchoCtrAdminStatus=nwIpxEchoCtrAdminStatus, nwIpxRipIfCtrAdminStatus=nwIpxRipIfCtrAdminStatus, nwIpxNetBIOSIfCtrFilteredPkts=nwIpxNetBIOSIfCtrFilteredPkts, nwIpxFwdIfCtrFilteredBytes=nwIpxFwdIfCtrFilteredBytes, nwIpxEventTraceAll=nwIpxEventTraceAll, nwIpxSapAgeOut=nwIpxSapAgeOut, nwIpxEventTable=nwIpxEventTable, nwIpxFwdIfCtrHostOutBytes=nwIpxFwdIfCtrHostOutBytes, nwIpxRipIfType=nwIpxRipIfType, nwIpxNetBIOSIfTable=nwIpxNetBIOSIfTable, nwIpxRipCtrOperationalTime=nwIpxRipCtrOperationalTime, nwIpxRipCtrAdminStatus=nwIpxRipCtrAdminStatus, nwIpxSapServerIfIfNum=nwIpxSapServerIfIfNum, nwIpxEventFltrIfNum=nwIpxEventFltrIfNum, nwIpxRipRtTicks=nwIpxRipRtTicks, nwIpxSapCtrReset=nwIpxSapCtrReset, nwIpxEventLogTable=nwIpxEventLogTable, nwIpxFwdCtrHostInBytes=nwIpxFwdCtrHostInBytes, nwIpxRipIfCtrOperationalTime=nwIpxRipIfCtrOperationalTime, nwIpxSapIfConfig=nwIpxSapIfConfig, nwIpxRipIfHelloTimer=nwIpxRipIfHelloTimer, nwIpxSysRouterId=nwIpxSysRouterId, nwIpxRipStackSize=nwIpxRipStackSize, nwIpxNetBIOSIfOperationalTime=nwIpxNetBIOSIfOperationalTime, nwIpxEventType=nwIpxEventType, nwIpxEventMaxEntries=nwIpxEventMaxEntries, nwIpxSapFilters=nwIpxSapFilters, nwIpxEchoIfCtrOperationalTime=nwIpxEchoIfCtrOperationalTime, nwIpxFwdIfCtrInBytes=nwIpxFwdIfCtrInBytes, nwIpxNetBIOSIfCtrFilteredBytes=nwIpxNetBIOSIfCtrFilteredBytes, nwIpxRipIfPoisonReverse=nwIpxRipIfPoisonReverse, nwIpxRipIfOperStatus=nwIpxRipIfOperStatus, nwIpxRipIfConfig=nwIpxRipIfConfig, nwIpxFwdIfCacheControl=nwIpxFwdIfCacheControl, nwIpxBcastCtrFilteredPkts=nwIpxBcastCtrFilteredPkts, nwIpxRipIfVersion=nwIpxRipIfVersion, nwIpxRipAdminStatus=nwIpxRipAdminStatus, nwIpxRouter=nwIpxRouter, nwIpxEchoSCtrDiscardBytes=nwIpxEchoSCtrDiscardBytes, nwIpxBcastAdminStatus=nwIpxBcastAdminStatus, nwIpxEventNumber=nwIpxEventNumber, nwIpxSapCtrOutPkts=nwIpxSapCtrOutPkts, nwIpxRipSystem=nwIpxRipSystem, nwIpxSapIfVersion=nwIpxSapIfVersion, nwIpxEchoOperationalTime=nwIpxEchoOperationalTime, nwIpxRipIfAdvertisement=nwIpxRipIfAdvertisement, nwIpxSapServerIfName=nwIpxSapServerIfName, nwIpxHostMapCircuitID=nwIpxHostMapCircuitID, nwIpxSysOperStatus=nwIpxSysOperStatus, nwIpxSysAdministration=nwIpxSysAdministration, nwIpxHostsSystem=nwIpxHostsSystem, nwIpxNetBIOSIfOperStatus=nwIpxNetBIOSIfOperStatus, nwIpxFwdCtrHostInPkts=nwIpxFwdCtrHostInPkts, nwIpxHostMapEntry=nwIpxHostMapEntry, nwIpxBcastIfOperationalTime=nwIpxBcastIfOperationalTime, nwIpxRipThreadPriority=nwIpxRipThreadPriority, nwIpxAddrIfAddress=nwIpxAddrIfAddress, nwIpxHostMapPhysAddr=nwIpxHostMapPhysAddr, nwIpxRipDatabaseThreshold=nwIpxRipDatabaseThreshold, nwIpxSapInterfaces=nwIpxSapInterfaces, nwIpxFwdInterfaces=nwIpxFwdInterfaces, nwIpxSapIfEntry=nwIpxSapIfEntry, nwIpxSysVersion=nwIpxSysVersion, nwIpxNetBIOSIfCtrOutBytes=nwIpxNetBIOSIfCtrOutBytes, nwIpxSapIfCtrOutPkts=nwIpxSapIfCtrOutPkts, nwIpxSapCtrAdminStatus=nwIpxSapCtrAdminStatus, nwIpxFwdSystem=nwIpxFwdSystem, nwIpxEchoAdminReset=nwIpxEchoAdminReset, nwIpxRipOperStatus=nwIpxRipOperStatus, nwIpxRipIfXmitCost=nwIpxRipIfXmitCost, nwIpxNetBIOSIfCtrInBytes=nwIpxNetBIOSIfCtrInBytes, nwIpxBcastIfCtrInBytes=nwIpxBcastIfCtrInBytes, nwIpxRipAdminReset=nwIpxRipAdminReset, nwIpxHostMapIpxAddr=nwIpxHostMapIpxAddr, nwIpxAddrEntry=nwIpxAddrEntry, nwIpxFwdIfIndex=nwIpxFwdIfIndex, nwIpxFibNetId=nwIpxFibNetId, nwIpxRipRtHops=nwIpxRipRtHops, nwIpxSapCounters=nwIpxSapCounters, nwIpxBroadcast=nwIpxBroadcast, nwIpxFwdIfAdminStatus=nwIpxFwdIfAdminStatus, nwIpxBcastCtrOutBytes=nwIpxBcastCtrOutBytes, nwIpxRipCounters=nwIpxRipCounters, nwIpxSapConfig=nwIpxSapConfig, nwIpxBcastIfCtrAdminStatus=nwIpxBcastIfCtrAdminStatus, nwIpxAddrIfIndex=nwIpxAddrIfIndex, nwIpxEchoCounters=nwIpxEchoCounters, nwIpxEventEntry=nwIpxEventEntry, nwIpxFwdCtrFilteredBytes=nwIpxFwdCtrFilteredBytes, nwIpxFwdCtrInPkts=nwIpxFwdCtrInPkts, nwIpxRipCtrReset=nwIpxRipCtrReset, nwIpxSapIfAdminStatus=nwIpxSapIfAdminStatus, nwIpxBcastCtrFilteredBytes=nwIpxBcastCtrFilteredBytes, nwIpxSapServerIfSocket=nwIpxSapServerIfSocket, nwIpxFwdCtrAdminStatus=nwIpxFwdCtrAdminStatus, nwIpxBcastIfTable=nwIpxBcastIfTable, nwIpxNetBIOSIfCtrOperationalTime=nwIpxNetBIOSIfCtrOperationalTime, nwIpxNetBIOSIfCtrInPkts=nwIpxNetBIOSIfCtrInPkts, nwIpxSapIfAclIdentifier=nwIpxSapIfAclIdentifier, nwIpxSapIfOperStatus=nwIpxSapIfOperStatus, nwIpxEchoIfCtrInPkts=nwIpxEchoIfCtrInPkts, nwIpxFwdIfCacheMisses=nwIpxFwdIfCacheMisses, nwIpxMibs=nwIpxMibs, nwIpxEventTime=nwIpxEventTime, nwIpxFwdIfCtrIfIndex=nwIpxFwdIfCtrIfIndex, nwIpxFwdCtrFilteredPkts=nwIpxFwdCtrFilteredPkts, nwIpxBcastIfCtrInPkts=nwIpxBcastIfCtrInPkts, nwIpxNetBIOSCtrDiscardPkts=nwIpxNetBIOSCtrDiscardPkts, nwIpxDistanceVector=nwIpxDistanceVector, nwIpxEchoCtrOperationalTime=nwIpxEchoCtrOperationalTime, nwIpxRipIfCtrTable=nwIpxRipIfCtrTable, nwIpxSapIfSnooping=nwIpxSapIfSnooping, nwIpxFwdIfCtrInPkts=nwIpxFwdIfCtrInPkts, nwIpxComponents=nwIpxComponents, nwIpxSapIfXmitCost=nwIpxSapIfXmitCost, nwIpxBcastIfCtrOutBytes=nwIpxBcastIfCtrOutBytes, nwIpxBcastIfEntry=nwIpxBcastIfEntry, nwIpxFwdIfCounters=nwIpxFwdIfCounters, nwIpxEchoIfIndex=nwIpxEchoIfIndex, nwIpxSapIfPoisonReverse=nwIpxSapIfPoisonReverse, nwIpxEchoCtrFilteredBytes=nwIpxEchoCtrFilteredBytes, nwIpxBcastIfCtrDiscardPkts=nwIpxBcastIfCtrDiscardPkts, nwIpxSysConfig=nwIpxSysConfig, nwIpxSapIfHelloTimer=nwIpxSapIfHelloTimer, nwIpxNetBIOSCtrReset=nwIpxNetBIOSCtrReset, nwIpxFwdCtrAddrErrPkts=nwIpxFwdCtrAddrErrPkts, nwIpxRipIfPriority=nwIpxRipIfPriority, nwIpxNetBIOSIfAdminStatus=nwIpxNetBIOSIfAdminStatus, nwIpxSapServerIfServiceType=nwIpxSapServerIfServiceType, nwIpxEchoAdminStatus=nwIpxEchoAdminStatus, nwIpxRipRtAge=nwIpxRipRtAge, nwIpxSapIfCtrFilteredBytes=nwIpxSapIfCtrFilteredBytes, nwIpxEchoIfCtrIfIndex=nwIpxEchoIfCtrIfIndex, nwIpxSapDatabaseThreshold=nwIpxSapDatabaseThreshold, nwIpxRipIfEntry=nwIpxRipIfEntry, nwIpxRip=nwIpxRip, nwIpxBcastCtrOperationalTime=nwIpxBcastCtrOperationalTime, nwIpxFwdIfFrameType=nwIpxFwdIfFrameType, nwIpxFwdIfCtrHostDiscardBytes=nwIpxFwdIfCtrHostDiscardBytes, nwIpxNetBIOSCtrOutPkts=nwIpxNetBIOSCtrOutPkts, nwIpxSapCtrDiscardBytes=nwIpxSapCtrDiscardBytes, nwIpxFibNextHopIf=nwIpxFibNextHopIf, nwIpxEchoSystem=nwIpxEchoSystem, nwIpxFwdIfOperationalTime=nwIpxFwdIfOperationalTime, nwIpxAddressTable=nwIpxAddressTable, nwIpxBcastIfCtrFilteredBytes=nwIpxBcastIfCtrFilteredBytes, nwIpxSapIfCtrAdminStatus=nwIpxSapIfCtrAdminStatus, nwIpxEvent=nwIpxEvent, nwIpxAddrIfControl=nwIpxAddrIfControl, nwIpxEchoIfCtrReset=nwIpxEchoIfCtrReset, nwIpxBroadcastInterface=nwIpxBroadcastInterface, nwIpxNetBIOSIfCtrIfIndex=nwIpxNetBIOSIfCtrIfIndex, nwIpxBroadcastSystem=nwIpxBroadcastSystem, nwIpxEchoConfig=nwIpxEchoConfig, nwIpxSapIfType=nwIpxSapIfType, nwIpxFwdIfCtrHostDiscardPkts=nwIpxFwdIfCtrHostDiscardPkts, nwIpxAclDestSocket=nwIpxAclDestSocket, nwIpxFwdCtrHostDiscardBytes=nwIpxFwdCtrHostDiscardBytes, nwIpxSapIfCtrEntry=nwIpxSapIfCtrEntry, nwIpxNetBIOSCtrAdminStatus=nwIpxNetBIOSCtrAdminStatus)
mibBuilder.exportSymbols("CTRON-IPX-ROUTER-MIB", nwIpxRipRouteTable=nwIpxRipRouteTable, nwIpxFwdIfCtrFwdBytes=nwIpxFwdIfCtrFwdBytes, nwIpxSysOperationalTimel=nwIpxSysOperationalTimel, nwIpxAclTable=nwIpxAclTable, nwIpxNetBIOSAdminStatus=nwIpxNetBIOSAdminStatus, nwIpxRipIfFloodDelay=nwIpxRipIfFloodDelay, nwIpxRipIfCtrFilteredPkts=nwIpxRipIfCtrFilteredPkts, nwIpxFwdCtrHdrErrPkts=nwIpxFwdCtrHdrErrPkts, nwIpxFwdIfCtrAddrErrPkts=nwIpxFwdIfCtrAddrErrPkts, nwIpxFibHops=nwIpxFibHops, nwIpxNetBIOSCtrInPkts=nwIpxNetBIOSCtrInPkts, nwIpxSapServerIfEntry=nwIpxSapServerIfEntry, nwIpxNetBIOSSystem=nwIpxNetBIOSSystem, nwIpxBcastCtrDiscardBytes=nwIpxBcastCtrDiscardBytes, nwIpxRipIfTable=nwIpxRipIfTable, nwIpxBcastCtrAdminStatus=nwIpxBcastCtrAdminStatus, nwIpxBcastIfCtrOperationalTime=nwIpxBcastIfCtrOperationalTime, nwIpxSapAdminStatus=nwIpxSapAdminStatus, nwIpxNetBIOSInterface=nwIpxNetBIOSInterface, nwIpxRipAgeOut=nwIpxRipAgeOut, nwIpxEchoVersion=nwIpxEchoVersion, nwIpxSapThreadPriority=nwIpxSapThreadPriority, nwIpxFwdIfCtrOperationalTime=nwIpxFwdIfCtrOperationalTime, nwIpxBcastCtrReset=nwIpxBcastCtrReset, nwIpxFwdIfCtrReset=nwIpxFwdIfCtrReset, nwIpxFwdCtrDiscardPkts=nwIpxFwdCtrDiscardPkts, nwIpxEventFltrProtocol=nwIpxEventFltrProtocol, nwIpxRipIfAdminStatus=nwIpxRipIfAdminStatus, nwIpxRipRtType=nwIpxRipRtType, nwIpxEventFltrAction=nwIpxEventFltrAction, nwIpxEchoIfConfig=nwIpxEchoIfConfig, nwIpxEchoIfCtrOutPkts=nwIpxEchoIfCtrOutPkts, nwIpxMibRevText=nwIpxMibRevText, nwIpxNetBIOSCtrDiscardBytes=nwIpxNetBIOSCtrDiscardBytes, nwIpxBcastAdminReset=nwIpxBcastAdminReset, nwIpxSapOperStatus=nwIpxSapOperStatus, nwIpxSapIfCtrOutBytes=nwIpxSapIfCtrOutBytes, nwIpxSapCtrOutBytes=nwIpxSapCtrOutBytes, nwIpxSapIfAclStatus=nwIpxSapIfAclStatus, nwIpxNetBIOSConfig=nwIpxNetBIOSConfig, nwIpxSapIfCtrFilteredPkts=nwIpxSapIfCtrFilteredPkts, nwIpxSysAdminStatus=nwIpxSysAdminStatus, nwIpxAccessControl=nwIpxAccessControl, nwIpxFwdCtrHostDiscardPkts=nwIpxFwdCtrHostDiscardPkts, nwIpxRipIfCtrEntry=nwIpxRipIfCtrEntry, nwIpxBcastOperationalTime=nwIpxBcastOperationalTime, nwIpxRipFilters=nwIpxRipFilters, nwIpxRipIfSnooping=nwIpxRipIfSnooping, nwIpxFwdIfEntry=nwIpxFwdIfEntry, nwIpxRipConfig=nwIpxRipConfig, nwIpxNetBIOSAdminReset=nwIpxNetBIOSAdminReset, nwIpxBcastIfCtrTable=nwIpxBcastIfCtrTable, nwIpxFwdIfCacheHits=nwIpxFwdIfCacheHits, nwIpxSapStackSize=nwIpxSapStackSize, nwIpxEchoCtrDiscardPkts=nwIpxEchoCtrDiscardPkts, nwIpxBroadcastConfig=nwIpxBroadcastConfig, nwIpxEventLogFilterTable=nwIpxEventLogFilterTable, nwIpxRipIfCtrInPkts=nwIpxRipIfCtrInPkts, nwIpxSapCtrInPkts=nwIpxSapCtrInPkts, nwIpxBcastVersion=nwIpxBcastVersion, nwIpxEventFilterEntry=nwIpxEventFilterEntry, nwIpxFwdIfTable=nwIpxFwdIfTable, nwIpxHostsInterfaces=nwIpxHostsInterfaces, nwIpxSapIfIndex=nwIpxSapIfIndex, nwIpxLinkState=nwIpxLinkState, nwIpxNetBIOSIfCtrDiscardPkts=nwIpxNetBIOSIfCtrDiscardPkts, nwIpxHostMapType=nwIpxHostMapType, nwIpxSapIfRequestDelay=nwIpxSapIfRequestDelay, nwIpxRipCtrDiscardBytes=nwIpxRipCtrDiscardBytes, nwIpxFwdIfCtrAdminStatus=nwIpxFwdIfCtrAdminStatus, nwIpxNetBIOSOperStatus=nwIpxNetBIOSOperStatus, nwIpxFwdCtrHostOutBytes=nwIpxFwdCtrHostOutBytes, nwIpxFwdIfCtrHostInPkts=nwIpxFwdIfCtrHostInPkts, nwIpxEchoIfCtrFilteredBytes=nwIpxEchoIfCtrFilteredBytes, nwIpxSapCtrInBytes=nwIpxSapCtrInBytes, nwIpxSystem=nwIpxSystem, nwIpxSapServerIfNode=nwIpxSapServerIfNode, nwIpxFwdIfForwarding=nwIpxFwdIfForwarding, nwIpxSapIfCtrReset=nwIpxSapIfCtrReset, nwIpxBcastCtrInPkts=nwIpxBcastCtrInPkts, nwIpxRipDatabase=nwIpxRipDatabase, nwIpxEchoIfAdminStatus=nwIpxEchoIfAdminStatus, nwIpxRipCtrInBytes=nwIpxRipCtrInBytes, nwIpxBcastIfCtrOutPkts=nwIpxBcastIfCtrOutPkts, nwIpxEventFilterTable=nwIpxEventFilterTable, nwIpxFwdCtrFwdBytes=nwIpxFwdCtrFwdBytes, nwIpxFwdIfCtrFwdPkts=nwIpxFwdIfCtrFwdPkts, nwIpxRipRouteEntry=nwIpxRipRouteEntry, nwIpxAclDestNode=nwIpxAclDestNode, nwIpxSapCtrDiscardPkts=nwIpxSapCtrDiscardPkts, nwIpxRipRtFlags=nwIpxRipRtFlags, nwIpxRipCtrOutBytes=nwIpxRipCtrOutBytes, nwIpxBcastCtrInBytes=nwIpxBcastCtrInBytes, nwIpxSapHoldDown=nwIpxSapHoldDown, nwIpxNetBIOSIfCounters=nwIpxNetBIOSIfCounters, nwIpxFwdIfCtrDiscardPkts=nwIpxFwdIfCtrDiscardPkts, nwIpxEchoCtrReset=nwIpxEchoCtrReset, nwIpxSapAdminReset=nwIpxSapAdminReset, nwIpxRipCtrInPkts=nwIpxRipCtrInPkts, nwIpxSapIfOperationalTime=nwIpxSapIfOperationalTime, nwIpxSysAdminReset=nwIpxSysAdminReset, nwIpxFib=nwIpxFib, nwIpxFwdCtrReset=nwIpxFwdCtrReset, nwIpxEchoIfCtrAdminStatus=nwIpxEchoIfCtrAdminStatus, nwIpxSapIfCtrInBytes=nwIpxSapIfCtrInBytes, nwIpxNetBIOSCtrOutBytes=nwIpxNetBIOSCtrOutBytes, nwIpxFwdCtrOutPkts=nwIpxFwdCtrOutPkts, nwIpxEchoIfOperStatus=nwIpxEchoIfOperStatus, nwIpxEventTextString=nwIpxEventTextString, nwIpxSapIfCtrInPkts=nwIpxSapIfCtrInPkts, nwIpxEventLogConfig=nwIpxEventLogConfig, nwIpxNetBIOSIfCtrAdminStatus=nwIpxNetBIOSIfCtrAdminStatus, nwIpxFwdCtrFwdPkts=nwIpxFwdCtrFwdPkts, nwIpxNlsp=nwIpxNlsp, nwIpxRipIfCtrOutPkts=nwIpxRipIfCtrOutPkts, nwIpxBroadcastIfConfig=nwIpxBroadcastIfConfig, nwIpxSapIfCounters=nwIpxSapIfCounters, nwIpxSapOperationalTime=nwIpxSapOperationalTime, nwIpxSapVersion=nwIpxSapVersion, nwIpxFwdCtrDiscardBytes=nwIpxFwdCtrDiscardBytes, nwIpxSapIfTable=nwIpxSapIfTable, nwIpxSap=nwIpxSap, nwIpxFwdIfCtrHostOutPkts=nwIpxFwdIfCtrHostOutPkts, nwIpxBcastCtrDiscardPkts=nwIpxBcastCtrDiscardPkts, nwIpxFwdIfConfig=nwIpxFwdIfConfig, nwIpxFwdIfCtrOutPkts=nwIpxFwdIfCtrOutPkts, nwIpxEchoCtrOutPkts=nwIpxEchoCtrOutPkts, nwIpxRipIfCtrDiscardBytes=nwIpxRipIfCtrDiscardBytes, nwIpxEchoOperStatus=nwIpxEchoOperStatus, nwIpxEcho=nwIpxEcho, nwIpxNetBIOSIfCtrTable=nwIpxNetBIOSIfCtrTable, nwIpxFilters=nwIpxFilters, nwIpxFibNextHopNode=nwIpxFibNextHopNode, IpxAddress=IpxAddress, nwIpxRipIfCtrReset=nwIpxRipIfCtrReset, nwIpxRipIfCtrFilteredBytes=nwIpxRipIfCtrFilteredBytes, nwIpxBcastIfCtrReset=nwIpxBcastIfCtrReset, nwIpxNetBIOSCtrFilteredBytes=nwIpxNetBIOSCtrFilteredBytes, nwIpxNetBIOSCtrInBytes=nwIpxNetBIOSCtrInBytes, nwIpxSapServerIfHops=nwIpxSapServerIfHops, nwIpxEchoIfCtrOutBytes=nwIpxEchoIfCtrOutBytes, nwIpxEchoIfCtrDiscardBytes=nwIpxEchoIfCtrDiscardBytes, nwIpxEchoInterface=nwIpxEchoInterface, nwIpxBcastIfAdminStatus=nwIpxBcastIfAdminStatus, nwIpxEventFltrControl=nwIpxEventFltrControl, nwIpxRipIfCtrIfIndex=nwIpxRipIfCtrIfIndex, nwIpxAclIdentifier=nwIpxAclIdentifier, nwIpxBroadcastCounters=nwIpxBroadcastCounters, nwIpxRipIfCounters=nwIpxRipIfCounters, nwIpxSapCtrFilteredPkts=nwIpxSapCtrFilteredPkts, nwIpxNetBIOS=nwIpxNetBIOS, nwIpxSapIfFloodDelay=nwIpxSapIfFloodDelay, nwIpxEventProtocol=nwIpxEventProtocol, nwIpxSapCtrOperationalTime=nwIpxSapCtrOperationalTime, nwIpxSapServerIfAge=nwIpxSapServerIfAge, nwIpxFibEntry=nwIpxFibEntry, nwIpxFwdIfCtrHostInBytes=nwIpxFwdIfCtrHostInBytes, nwIpxAclPermission=nwIpxAclPermission, nwIpxRipIfIndex=nwIpxRipIfIndex, nwIpxRipRtSrcNode=nwIpxRipRtSrcNode, nwIpxWorkGroup=nwIpxWorkGroup, nwIpxFibRouteType=nwIpxFibRouteType, nwIpxNetBIOSIfEntry=nwIpxNetBIOSIfEntry, nwIpxFibTimeTicks=nwIpxFibTimeTicks, nwIpxRipIfAclStatus=nwIpxRipIfAclStatus, nwIpxEndSystems=nwIpxEndSystems, nwIpxBcastIfCtrFilteredPkts=nwIpxBcastIfCtrFilteredPkts, nwIpxSapServerIfTable=nwIpxSapServerIfTable, nwIpxAclDestNetNum=nwIpxAclDestNetNum, nwIpxNetBIOSCounters=nwIpxNetBIOSCounters, nwIpxFwdIfCtrLenErrPkts=nwIpxFwdIfCtrLenErrPkts, nwIpxBcastCtrOutPkts=nwIpxBcastCtrOutPkts, nwIpxFwdIfAclStatus=nwIpxFwdIfAclStatus, nwIpxRipVersion=nwIpxRipVersion, nwIpxSapIfCtrDiscardBytes=nwIpxSapIfCtrDiscardBytes, nwIpxNetBIOSIfCtrOutPkts=nwIpxNetBIOSIfCtrOutPkts, nwIpxEchoIfCtrTable=nwIpxEchoIfCtrTable, nwIpxSapIfPriority=nwIpxSapIfPriority, nwIpxSapServerTable=nwIpxSapServerTable, nwIpxBcastIfCtrEntry=nwIpxBcastIfCtrEntry, nwIpxNetBIOSOperationalTime=nwIpxNetBIOSOperationalTime)
