...
mibBuilder.exportSymbols("CTRON-IPX-ROUTER-MIB", nwIpxFib=nwIpxFib, nwIpxSapIfAdminStatus=nwIpxSapIfAdminStatus, nwIpxBcastIfCtrDiscardBytes=nwIpxBcastIfCtrDiscardBytes, nwIpxEchoIfCtrAdminStatus=nwIpxEchoIfCtrAdminStatus, nwIpxHostMapPhysAddr=nwIpxHostMapPhysAddr, nwIpxRipRtIfIndex=nwIpxRipRtIfIndex, nwIpxRedirector=nwIpxRedirector, nwIpxSapIfAclIdentifier=nwIpxSapIfAclIdentifier, nwIpxFwdIfAdminStatus=nwIpxFwdIfAdminStatus, nwIpxAddrEntry=nwIpxAddrEntry, nwIpxFwdIfCtrHdrErrPkts=nwIpxFwdIfCtrHdrErrPkts, nwIpxForwarding=nwIpxForwarding, nwIpxSapIfCtrDiscardPkts=nwIpxSapIfCtrDiscardPkts, nwIpxSapIfIndex=nwIpxSapIfIndex, nwIpxBcastIfCtrTable=nwIpxBcastIfCtrTable, nwIpxSapIfCtrOutPkts=nwIpxSapIfCtrOutPkts, nwIpxNetBIOSOperationalTime=nwIpxNetBIOSOperationalTime, nwIpxHostsToMedia=nwIpxHostsToMedia, nwIpxNetBIOSIfCtrTable=nwIpxNetBIOSIfCtrTable, nwIpxFwdIfCacheHits=nwIpxFwdIfCacheHits, nwIpxAclValidEntries=nwIpxAclValidEntries, nwIpxHostMapFraming=nwIpxHostMapFraming, nwIpxEcho=nwIpxEcho, nwIpxSapAdminReset=nwIpxSapAdminReset, nwIpxNetBIOSIfCtrOutBytes=nwIpxNetBIOSIfCtrOutBytes, nwIpxFwdIfControl=nwIpxFwdIfControl, nwIpxMibRevText=nwIpxMibRevText, nwIpxRipCtrReset=nwIpxRipCtrReset, nwIpxRipIfCtrInPkts=nwIpxRipIfCtrInPkts, nwIpxSapServerIfSrcNode=nwIpxSapServerIfSrcNode, nwIpxSapServerIfType=nwIpxSapServerIfType, nwIpxRipIfSplitHorizon=nwIpxRipIfSplitHorizon, nwIpxRipIfVersion=nwIpxRipIfVersion, nwIpxRipIfCtrInBytes=nwIpxRipIfCtrInBytes, nwIpxBroadcast=nwIpxBroadcast, nwIpxRipIfCtrIfIndex=nwIpxRipIfCtrIfIndex, nwIpxNetBIOSIfCtrReset=nwIpxNetBIOSIfCtrReset, nwIpxFibRouteType=nwIpxFibRouteType, nwIpxSapServerTable=nwIpxSapServerTable, nwIpxFwdCtrFilteredBytes=nwIpxFwdCtrFilteredBytes, nwIpxBcastCtrOutPkts=nwIpxBcastCtrOutPkts, nwIpxEchoInterface=nwIpxEchoInterface, nwIpxRipInterfaces=nwIpxRipInterfaces, nwIpxBcastCtrInPkts=nwIpxBcastCtrInPkts, nwIpxEventSeverity=nwIpxEventSeverity, nwIpxNetBIOSIfTable=nwIpxNetBIOSIfTable, nwIpxEchoCtrFilteredBytes=nwIpxEchoCtrFilteredBytes, nwIpxBcastIfCtrOperationalTime=nwIpxBcastIfCtrOperationalTime, nwIpxFwdCtrInBytes=nwIpxFwdCtrInBytes, nwIpxHostMapIpxAddr=nwIpxHostMapIpxAddr, nwIpxRipIfRequestDelay=nwIpxRipIfRequestDelay, nwIpxFwdCtrInPkts=nwIpxFwdCtrInPkts, nwIpxSapServerIfName=nwIpxSapServerIfName, nwIpxSapOperStatus=nwIpxSapOperStatus, nwIpxMibs=nwIpxMibs, nwIpxRipIfOperationalTime=nwIpxRipIfOperationalTime, nwIpxRouter=nwIpxRouter, nwIpxNetBIOSIfCtrDiscardPkts=nwIpxNetBIOSIfCtrDiscardPkts, nwIpxEchoIfCtrInPkts=nwIpxEchoIfCtrInPkts, nwIpxBcastCtrAdminStatus=nwIpxBcastCtrAdminStatus, nwIpxFwdCtrDiscardBytes=nwIpxFwdCtrDiscardBytes, nwIpxHostMapPortNumber=nwIpxHostMapPortNumber, nwIpxRipIfCtrFilteredBytes=nwIpxRipIfCtrFilteredBytes, nwIpxFwdIfCtrOutPkts=nwIpxFwdIfCtrOutPkts, nwIpxFwdIfOperationalTime=nwIpxFwdIfOperationalTime, nwIpxRipHoldDown=nwIpxRipHoldDown, nwIpxFwdCtrFilteredPkts=nwIpxFwdCtrFilteredPkts, nwIpxRipIfCtrFilteredPkts=nwIpxRipIfCtrFilteredPkts, nwIpxBcastIfCtrInBytes=nwIpxBcastIfCtrInBytes, nwIpxNetBIOS=nwIpxNetBIOS, nwIpxFwdIfCtrHostInBytes=nwIpxFwdIfCtrHostInBytes, nwIpxFwdCtrLenErrPkts=nwIpxFwdCtrLenErrPkts, nwIpxSapCtrOperationalTime=nwIpxSapCtrOperationalTime, nwIpxFwdCtrFwdBytes=nwIpxFwdCtrFwdBytes, nwIpxSystem=nwIpxSystem, nwIpxSysRouterId=nwIpxSysRouterId, nwIpxAddrIfAddrType=nwIpxAddrIfAddrType, nwIpxRipIfSnooping=nwIpxRipIfSnooping, nwIpxBcastIfCtrAdminStatus=nwIpxBcastIfCtrAdminStatus, nwIpxEchoIfOperStatus=nwIpxEchoIfOperStatus, nwIpxEventFltrProtocol=nwIpxEventFltrProtocol, nwIpxSapOperationalTime=nwIpxSapOperationalTime, nwIpxAclSrcSocket=nwIpxAclSrcSocket, nwIpxRipRouteTable=nwIpxRipRouteTable, nwIpxFwdIfTable=nwIpxFwdIfTable, nwIpxRipCtrOperationalTime=nwIpxRipCtrOperationalTime, nwIpxEventNumber=nwIpxEventNumber, nwIpxBcastCtrDiscardPkts=nwIpxBcastCtrDiscardPkts, nwIpxEchoConfig=nwIpxEchoConfig, nwIpxAclSrcNode=nwIpxAclSrcNode, nwIpxEventFltrSeverity=nwIpxEventFltrSeverity, nwIpxRipRtType=nwIpxRipRtType, nwIpxBcastIfCtrOutPkts=nwIpxBcastIfCtrOutPkts, nwIpxEchoCounters=nwIpxEchoCounters, nwIpxEventFilterTable=nwIpxEventFilterTable, nwIpxSapIfCtrDiscardBytes=nwIpxSapIfCtrDiscardBytes, nwIpxNetBIOSConfig=nwIpxNetBIOSConfig, nwIpxHostsSystem=nwIpxHostsSystem, nwIpxBcastCtrFilteredBytes=nwIpxBcastCtrFilteredBytes, nwIpxFwdIfCtrInBytes=nwIpxFwdIfCtrInBytes, nwIpxFwdSystem=nwIpxFwdSystem, nwIpxSapCtrReset=nwIpxSapCtrReset, nwIpxBcastCtrFilteredPkts=nwIpxBcastCtrFilteredPkts, nwIpxBcastIfCtrIfIndex=nwIpxBcastIfCtrIfIndex, nwIpxRipRtAge=nwIpxRipRtAge, nwIpxNetBIOSIfOperationalTime=nwIpxNetBIOSIfOperationalTime, nwIpxSapIfAclStatus=nwIpxSapIfAclStatus, nwIpxBcastIfCtrFilteredBytes=nwIpxBcastIfCtrFilteredBytes, nwIpxEchoCtrReset=nwIpxEchoCtrReset, nwIpxNetBIOSIfCtrOutPkts=nwIpxNetBIOSIfCtrOutPkts, nwIpxEchoIfEntry=nwIpxEchoIfEntry, nwIpxFwdCtrReset=nwIpxFwdCtrReset, nwIpxSysVersion=nwIpxSysVersion, nwIpxRipIfXmitCost=nwIpxRipIfXmitCost, nwIpxRipConfig=nwIpxRipConfig, nwIpxFwdIfIndex=nwIpxFwdIfIndex, nwIpxSapServerIfEntry=nwIpxSapServerIfEntry, nwIpxBcastIfOperStatus=nwIpxBcastIfOperStatus, nwIpxRipThreadPriority=nwIpxRipThreadPriority, nwIpxEventTable=nwIpxEventTable, nwIpxFwdCtrOutPkts=nwIpxFwdCtrOutPkts, nwIpxFwdIfConfig=nwIpxFwdIfConfig, nwIpxFwdCtrDiscardPkts=nwIpxFwdCtrDiscardPkts, nwIpxFwdIfCtrOutBytes=nwIpxFwdIfCtrOutBytes, nwIpxFwdIfCtrTable=nwIpxFwdIfCtrTable, nwIpxRipStackSize=nwIpxRipStackSize, nwIpxFibNextHopNet=nwIpxFibNextHopNet, nwIpxHostMapCircuitID=nwIpxHostMapCircuitID, nwIpxAclIdentifier=nwIpxAclIdentifier, nwIpxSapCtrOutBytes=nwIpxSapCtrOutBytes, nwIpxNetBIOSIfCtrFilteredBytes=nwIpxNetBIOSIfCtrFilteredBytes, nwIpxSapServerIfIfNum=nwIpxSapServerIfIfNum, nwIpxAclDestNetNum=nwIpxAclDestNetNum, nwIpxSapServerIfAge=nwIpxSapServerIfAge, nwIpxFwdIfMtu=nwIpxFwdIfMtu, nwIpxFwdIfCacheControl=nwIpxFwdIfCacheControl, nwIpxRipRtTicks=nwIpxRipRtTicks, nwIpxNetBIOSCtrOutBytes=nwIpxNetBIOSCtrOutBytes, nwIpxFwdIfCtrDiscardPkts=nwIpxFwdIfCtrDiscardPkts, nwIpxEchoIfCtrTable=nwIpxEchoIfCtrTable, nwIpxNetBIOSInterface=nwIpxNetBIOSInterface, nwIpxSapIfAdvertisement=nwIpxSapIfAdvertisement, nwIpxEchoIfTable=nwIpxEchoIfTable, nwIpxSapCounters=nwIpxSapCounters, nwIpxEchoIfConfig=nwIpxEchoIfConfig, nwIpxRipIfAclStatus=nwIpxRipIfAclStatus, nwIpxSapIfConfig=nwIpxSapIfConfig, nwIpxSapSystem=nwIpxSapSystem, nwIpxFwdCtrAddrErrPkts=nwIpxFwdCtrAddrErrPkts, nwIpxSapCtrInPkts=nwIpxSapCtrInPkts, nwIpxRipIfPoisonReverse=nwIpxRipIfPoisonReverse, nwIpxSapCtrDiscardBytes=nwIpxSapCtrDiscardBytes, nwIpxFibTimeTicks=nwIpxFibTimeTicks, nwIpxSapCtrInBytes=nwIpxSapCtrInBytes, nwIpxSapServerIfSocket=nwIpxSapServerIfSocket, nwIpxSapCtrFilteredBytes=nwIpxSapCtrFilteredBytes, nwIpxRipAgeOut=nwIpxRipAgeOut, nwIpxSapIfCtrTable=nwIpxSapIfCtrTable, nwIpxRipIfFloodDelay=nwIpxRipIfFloodDelay, nwIpxSapAgeOut=nwIpxSapAgeOut, nwIpxHostMapEntry=nwIpxHostMapEntry, nwIpxFwdIfCtrOperationalTime=nwIpxFwdIfCtrOperationalTime, nwIpxAddressTable=nwIpxAddressTable, nwIpxFwdInterfaces=nwIpxFwdInterfaces, nwIpxFwdIfCtrHostInPkts=nwIpxFwdIfCtrHostInPkts, nwIpxSapStackSize=nwIpxSapStackSize, nwIpxEventEntry=nwIpxEventEntry, nwIpxNetBIOSIfAdminStatus=nwIpxNetBIOSIfAdminStatus, nwIpxFwdCtrAdminStatus=nwIpxFwdCtrAdminStatus, nwIpxAddrIfAddress=nwIpxAddrIfAddress, nwIpxFwdIfCtrHostOutBytes=nwIpxFwdIfCtrHostOutBytes, nwIpxAclEntry=nwIpxAclEntry, nwIpxRipIfCtrDiscardPkts=nwIpxRipIfCtrDiscardPkts, nwIpxNetBIOSIfCtrFilteredPkts=nwIpxNetBIOSIfCtrFilteredPkts, nwIpxFwdCtrHdrErrPkts=nwIpxFwdCtrHdrErrPkts, nwIpxAddrIfControl=nwIpxAddrIfControl, nwIpxSapIfCtrIfIndex=nwIpxSapIfCtrIfIndex, nwIpxRipCtrOutBytes=nwIpxRipCtrOutBytes, nwIpxNetBIOSCtrDiscardPkts=nwIpxNetBIOSCtrDiscardPkts, nwIpxBroadcastIfConfig=nwIpxBroadcastIfConfig, nwIpxRipRtFlags=nwIpxRipRtFlags, nwIpxSapIfOperStatus=nwIpxSapIfOperStatus, nwIpxRipDatabase=nwIpxRipDatabase, nwIpxBcastIfEntry=nwIpxBcastIfEntry, nwIpxAclDestSocket=nwIpxAclDestSocket, nwIpxFwdIfCtrHostDiscardPkts=nwIpxFwdIfCtrHostDiscardPkts, nwIpxFwdCtrOperationalTime=nwIpxFwdCtrOperationalTime, nwIpxFwdCtrHostOutPkts=nwIpxFwdCtrHostOutPkts, nwIpxNetBIOSIfCtrIfIndex=nwIpxNetBIOSIfCtrIfIndex, nwIpxSapIfPriority=nwIpxSapIfPriority, nwIpxBcastOperStatus=nwIpxBcastOperStatus, nwIpxBcastIfIndex=nwIpxBcastIfIndex, nwIpxEchoIfCtrOutBytes=nwIpxEchoIfCtrOutBytes, nwIpxNetBIOSCtrAdminStatus=nwIpxNetBIOSCtrAdminStatus, nwIpxRipSystem=nwIpxRipSystem, nwIpxSapIfOperationalTime=nwIpxSapIfOperationalTime, nwIpxSysAdminReset=nwIpxSysAdminReset, nwIpxEvent=nwIpxEvent, nwIpxNlsp=nwIpxNlsp, nwIpxEchoCtrOutBytes=nwIpxEchoCtrOutBytes, nwIpxSapServerIfHops=nwIpxSapServerIfHops, nwIpxBcastIfAdminStatus=nwIpxBcastIfAdminStatus, nwIpxEventTraceAll=nwIpxEventTraceAll, nwIpxNetBIOSCtrOutPkts=nwIpxNetBIOSCtrOutPkts, nwIpxEchoCtrDiscardPkts=nwIpxEchoCtrDiscardPkts, nwIpxBcastCtrDiscardBytes=nwIpxBcastCtrDiscardBytes, nwIpxRipCtrFilteredBytes=nwIpxRipCtrFilteredBytes, nwIpxAccessControl=nwIpxAccessControl, nwIpxNetBIOSIfOperStatus=nwIpxNetBIOSIfOperStatus, nwIpxNetBIOSSystem=nwIpxNetBIOSSystem, nwIpxSysConfig=nwIpxSysConfig, nwIpxSapIfType=nwIpxSapIfType, nwIpxFibNextHopIf=nwIpxFibNextHopIf, nwIpxEchoIfCtrInBytes=nwIpxEchoIfCtrInBytes, nwIpxHostMapType=nwIpxHostMapType, nwIpxSapIfVersion=nwIpxSapIfVersion, nwIpxSapIfRequestDelay=nwIpxSapIfRequestDelay, nwIpxFwdIfCtrLenErrPkts=nwIpxFwdIfCtrLenErrPkts, nwIpxBroadcastInterface=nwIpxBroadcastInterface, nwIpxRipIfAclIdentifier=nwIpxRipIfAclIdentifier, nwIpxSapHoldDown=nwIpxSapHoldDown, nwIpxFibHops=nwIpxFibHops, nwIpxEchoIfAdminStatus=nwIpxEchoIfAdminStatus, nwIpxEventFilterEntry=nwIpxEventFilterEntry, nwIpxFwdCtrFwdPkts=nwIpxFwdCtrFwdPkts, nwIpxFwdCtrHostInBytes=nwIpxFwdCtrHostInBytes, nwIpxSapIfCounters=nwIpxSapIfCounters, nwIpxNetBIOSOperStatus=nwIpxNetBIOSOperStatus, nwIpxNetBIOSIfCtrDiscardBytes=nwIpxNetBIOSIfCtrDiscardBytes, nwIpxEchoCtrAdminStatus=nwIpxEchoCtrAdminStatus, nwIpxEventAdminStatus=nwIpxEventAdminStatus, nwIpxLinkState=nwIpxLinkState, nwIpxSapServerIfServiceType=nwIpxSapServerIfServiceType, nwIpxBroadcastConfig=nwIpxBroadcastConfig, nwIpxNetBIOSIfCounters=nwIpxNetBIOSIfCounters, nwIpxBcastIfCtrReset=nwIpxBcastIfCtrReset, nwIpxSapIfCtrInBytes=nwIpxSapIfCtrInBytes, nwIpxSapCtrOutPkts=nwIpxSapCtrOutPkts, nwIpxSapIfEntry=nwIpxSapIfEntry, nwIpxWorkGroup=nwIpxWorkGroup, nwIpxFwdCtrHostDiscardBytes=nwIpxFwdCtrHostDiscardBytes, nwIpxNetBIOSAdminStatus=nwIpxNetBIOSAdminStatus, nwIpxHostMapIfIndex=nwIpxHostMapIfIndex, nwIpxSapServerIfTable=nwIpxSapServerIfTable, nwIpxHostsInterfaces=nwIpxHostsInterfaces, nwIpxFwdCtrHostInPkts=nwIpxFwdCtrHostInPkts, nwIpxBcastAdminReset=nwIpxBcastAdminReset, nwIpxRip=nwIpxRip, nwIpxSapFilters=nwIpxSapFilters, nwIpxSysAdminStatus=nwIpxSysAdminStatus, nwIpxSapIfXmitCost=nwIpxSapIfXmitCost, nwIpxBcastIfCtrInPkts=nwIpxBcastIfCtrInPkts, nwIpxBcastIfCtrOutBytes=nwIpxBcastIfCtrOutBytes, nwIpxEchoSystem=nwIpxEchoSystem)
mibBuilder.exportSymbols("CTRON-IPX-ROUTER-MIB", nwIpxSapThreadPriority=nwIpxSapThreadPriority, nwIpxSapIfCtrFilteredBytes=nwIpxSapIfCtrFilteredBytes, nwIpxEchoOperationalTime=nwIpxEchoOperationalTime, nwIpxBcastIfOperationalTime=nwIpxBcastIfOperationalTime, nwIpxNetBIOSIfCtrOperationalTime=nwIpxNetBIOSIfCtrOperationalTime, nwIpxRipAdminStatus=nwIpxRipAdminStatus, nwIpxEchoSCtrDiscardBytes=nwIpxEchoSCtrDiscardBytes, nwIpxNetBIOSIfCtrInPkts=nwIpxNetBIOSIfCtrInPkts, nwIpxFwdIfCtrFwdPkts=nwIpxFwdIfCtrFwdPkts, nwIpxFwdIfCtrEntry=nwIpxFwdIfCtrEntry, nwIpxBcastIfCtrEntry=nwIpxBcastIfCtrEntry, nwIpxEchoCtrOperationalTime=nwIpxEchoCtrOperationalTime, nwIpxNetBIOSCtrInPkts=nwIpxNetBIOSCtrInPkts, nwIpxSapIfSplitHorizon=nwIpxSapIfSplitHorizon, nwIpxFwdIfOperStatus=nwIpxFwdIfOperStatus, nwIpxSapServerIfNode=nwIpxSapServerIfNode, nwIpxSapIfHelloTimer=nwIpxSapIfHelloTimer, nwIpxNetBIOSCtrInBytes=nwIpxNetBIOSCtrInBytes, nwIpxBcastAdminStatus=nwIpxBcastAdminStatus, nwIpxEchoIfCtrIfIndex=nwIpxEchoIfCtrIfIndex, nwIpxBcastIfCtrDiscardPkts=nwIpxBcastIfCtrDiscardPkts, nwIpxEchoIfCtrFilteredPkts=nwIpxEchoIfCtrFilteredPkts, nwIpxBcastOperationalTime=nwIpxBcastOperationalTime, nwIpxFwdIfCtrHostDiscardBytes=nwIpxFwdIfCtrHostDiscardBytes, nwIpxRipOperationalTime=nwIpxRipOperationalTime, nwIpxFwdIfCtrAddrErrPkts=nwIpxFwdIfCtrAddrErrPkts, nwIpxRipIfCtrOutPkts=nwIpxRipIfCtrOutPkts, IpxAddress=IpxAddress, nwIpxFwdCtrOutBytes=nwIpxFwdCtrOutBytes, nwIpxEchoCtrInBytes=nwIpxEchoCtrInBytes, nwIpxRipCtrDiscardPkts=nwIpxRipCtrDiscardPkts, nwIpxEventFltrAction=nwIpxEventFltrAction, nwIpxSapServerIfFlags=nwIpxSapServerIfFlags, nwIpxSysOperStatus=nwIpxSysOperStatus, nwIpxFwdIfCtrReset=nwIpxFwdIfCtrReset, nwIpxFwdIfCtrAdminStatus=nwIpxFwdIfCtrAdminStatus, nwIpxRipIfCtrTable=nwIpxRipIfCtrTable, nwIpxRipIfCtrEntry=nwIpxRipIfCtrEntry, nwIpxComponents=nwIpxComponents, nwIpxFwdIfCtrFwdBytes=nwIpxFwdIfCtrFwdBytes, nwIpxSapIfTable=nwIpxSapIfTable, nwIpxRipOperStatus=nwIpxRipOperStatus, nwIpxRipAdminReset=nwIpxRipAdminReset, nwIpxNetBIOSIfCtrEntry=nwIpxNetBIOSIfCtrEntry, nwIpxEchoIfCtrOutPkts=nwIpxEchoIfCtrOutPkts, nwIpxSapIfCtrOutBytes=nwIpxSapIfCtrOutBytes, nwIpxRipIfOperStatus=nwIpxRipIfOperStatus, nwIpxRipCtrOutPkts=nwIpxRipCtrOutPkts, nwIpxBcastCtrOperationalTime=nwIpxBcastCtrOperationalTime, nwIpxEventType=nwIpxEventType, nwIpxEchoOperStatus=nwIpxEchoOperStatus, nwIpxEventLogFilterTable=nwIpxEventLogFilterTable, nwIpxRipCounters=nwIpxRipCounters, nwIpxSapIfFloodDelay=nwIpxSapIfFloodDelay, nwIpxRipVersion=nwIpxRipVersion, nwIpxSapIfSnooping=nwIpxSapIfSnooping, nwIpxRipIfAdminStatus=nwIpxRipIfAdminStatus, nwIpxEchoCtrOutPkts=nwIpxEchoCtrOutPkts, nwIpxFwdIfCtrInPkts=nwIpxFwdIfCtrInPkts, nwIpxFwdIfCtrHostOutPkts=nwIpxFwdIfCtrHostOutPkts, nwIpxFwdIfFrameType=nwIpxFwdIfFrameType, nwIpxEventLogConfig=nwIpxEventLogConfig, nwIpxEchoIfCtrDiscardBytes=nwIpxEchoIfCtrDiscardBytes, nwIpxFwdIfAclIdentifier=nwIpxFwdIfAclIdentifier, nwIpxRipIfAdvertisement=nwIpxRipIfAdvertisement, nwIpxEchoIfCtrEntry=nwIpxEchoIfCtrEntry, nwIpxFwdIfCacheMisses=nwIpxFwdIfCacheMisses, nwIpxEchoIfCtrOperationalTime=nwIpxEchoIfCtrOperationalTime, nwIpxSapIfCtrReset=nwIpxSapIfCtrReset, nwIpxBcastVersion=nwIpxBcastVersion, nwIpxRipRtSrcNode=nwIpxRipRtSrcNode, nwIpxRipIfTable=nwIpxRipIfTable, nwIpxBcastIfTable=nwIpxBcastIfTable, nwIpxSapCtrDiscardPkts=nwIpxSapCtrDiscardPkts, nwIpxEchoIfCtrReset=nwIpxEchoIfCtrReset, nwIpxFibNextHopNode=nwIpxFibNextHopNode, nwIpxFwdIfAclStatus=nwIpxFwdIfAclStatus, nwIpxNetBIOSVersion=nwIpxNetBIOSVersion, nwIpxFibEntry=nwIpxFibEntry, nwIpxEchoIfIndex=nwIpxEchoIfIndex, nwIpxSapIfPoisonReverse=nwIpxSapIfPoisonReverse, nwIpxEchoCtrInPkts=nwIpxEchoCtrInPkts, nwIpxSapDatabaseThreshold=nwIpxSapDatabaseThreshold, nwIpxSapVersion=nwIpxSapVersion, nwIpxFwdCtrHostOutBytes=nwIpxFwdCtrHostOutBytes, nwIpxEchoAdminReset=nwIpxEchoAdminReset, nwIpxSapCtrAdminStatus=nwIpxSapCtrAdminStatus, nwIpxNetBIOSAdminReset=nwIpxNetBIOSAdminReset, nwIpxBcastCtrInBytes=nwIpxBcastCtrInBytes, nwIpxRipIfCtrOperationalTime=nwIpxRipIfCtrOperationalTime, nwIpxNetBIOSCounters=nwIpxNetBIOSCounters, nwIpxBroadcastIfCounters=nwIpxBroadcastIfCounters, nwIpxRipCtrInBytes=nwIpxRipCtrInBytes, nwIpxHostMapTable=nwIpxHostMapTable, nwIpxEventTextString=nwIpxEventTextString, nwIpxEventProtocol=nwIpxEventProtocol, nwIpxRipRtHops=nwIpxRipRtHops, nwIpxAclPermission=nwIpxAclPermission, nwIpxFwdIfCacheEntries=nwIpxFwdIfCacheEntries, nwIpxEchoVersion=nwIpxEchoVersion, nwIpxRipIfCtrAdminStatus=nwIpxRipIfCtrAdminStatus, nwIpxFwdCounters=nwIpxFwdCounters, nwIpxRipIfCtrReset=nwIpxRipIfCtrReset, nwIpxEventMaxEntries=nwIpxEventMaxEntries, nwIpxRipCtrAdminStatus=nwIpxRipCtrAdminStatus, nwIpxFibNetId=nwIpxFibNetId, nwIpxRipFilters=nwIpxRipFilters, nwIpxRipIfEntry=nwIpxRipIfEntry, nwIpxFwdIfCounters=nwIpxFwdIfCounters, nwIpxSapIfCtrOperationalTime=nwIpxSapIfCtrOperationalTime, nwIpxSapIfCtrAdminStatus=nwIpxSapIfCtrAdminStatus, nwIpxEventIfNum=nwIpxEventIfNum, nwIpxFilters=nwIpxFilters, nwIpxRipDatabaseThreshold=nwIpxRipDatabaseThreshold, nwIpxNetBIOSIfCtrAdminStatus=nwIpxNetBIOSIfCtrAdminStatus, nwIpxEchoIfCtrFilteredBytes=nwIpxEchoIfCtrFilteredBytes, nwIpxRipRouteEntry=nwIpxRipRouteEntry, nwIpxRipIfCtrDiscardBytes=nwIpxRipIfCtrDiscardBytes, nwIpxRipIfHelloTimer=nwIpxRipIfHelloTimer, nwIpxNetBIOSCtrFilteredBytes=nwIpxNetBIOSCtrFilteredBytes, nwIpxRipIfPriority=nwIpxRipIfPriority, nwIpxEchoIfCounters=nwIpxEchoIfCounters, nwIpxFwdIfCtrFilteredPkts=nwIpxFwdIfCtrFilteredPkts, nwIpxEventLogTable=nwIpxEventLogTable, nwIpxTopology=nwIpxTopology, nwIpxRipRtNetId=nwIpxRipRtNetId, nwIpxBcastCtrReset=nwIpxBcastCtrReset, nwIpxRipCtrFilteredPkts=nwIpxRipCtrFilteredPkts, nwIpxFwdIfForwarding=nwIpxFwdIfForwarding, nwIpxNetBIOSIfEntry=nwIpxNetBIOSIfEntry, nwIpxAclDestNode=nwIpxAclDestNode, nwIpxBroadcastCounters=nwIpxBroadcastCounters, nwIpxSapAdminStatus=nwIpxSapAdminStatus, nwIpxEchoAdminStatus=nwIpxEchoAdminStatus, nwIpxSapIfCtrFilteredPkts=nwIpxSapIfCtrFilteredPkts, nwIpxRipIfCounters=nwIpxRipIfCounters, nwIpxAclSrcNetNum=nwIpxAclSrcNetNum, nwIpxEchoIfCtrDiscardPkts=nwIpxEchoIfCtrDiscardPkts, nwIpxSapConfig=nwIpxSapConfig, nwIpxEventFltrType=nwIpxEventFltrType, nwIpxSapInterfaces=nwIpxSapInterfaces, nwIpxAddrIfIndex=nwIpxAddrIfIndex, nwIpxRipIfIndex=nwIpxRipIfIndex, nwIpxSysAdministration=nwIpxSysAdministration, nwIpxSapIfCtrInPkts=nwIpxSapIfCtrInPkts, nwIpxFibTable=nwIpxFibTable, nwIpxNetBIOSIfIndex=nwIpxNetBIOSIfIndex, nwIpxFwdCtrHostDiscardPkts=nwIpxFwdCtrHostDiscardPkts, nwIpxNetBIOSCtrOperationalTime=nwIpxNetBIOSCtrOperationalTime, nwIpxNetBIOSCtrReset=nwIpxNetBIOSCtrReset, nwIpxRipIfConfig=nwIpxRipIfConfig, nwIpxSapIfCtrEntry=nwIpxSapIfCtrEntry, nwIpxRipCtrInPkts=nwIpxRipCtrInPkts, nwIpxFwdIfCtrDiscardBytes=nwIpxFwdIfCtrDiscardBytes, nwIpxEventFltrControl=nwIpxEventFltrControl, nwIpxNetBIOSIfCtrInBytes=nwIpxNetBIOSIfCtrInBytes, nwIpxAclMatches=nwIpxAclMatches, nwIpxAclSequence=nwIpxAclSequence, nwIpxRipCtrDiscardBytes=nwIpxRipCtrDiscardBytes, nwIpxEventTime=nwIpxEventTime, nwIpxAclTable=nwIpxAclTable, nwIpxSapCtrFilteredPkts=nwIpxSapCtrFilteredPkts, nwIpxBroadcastSystem=nwIpxBroadcastSystem, nwIpxBcastIfCtrFilteredPkts=nwIpxBcastIfCtrFilteredPkts, nwIpxSap=nwIpxSap, nwIpxRipIfCtrOutBytes=nwIpxRipIfCtrOutBytes, nwIpxSysOperationalTimel=nwIpxSysOperationalTimel, nwIpxNetBIOSIfConfig=nwIpxNetBIOSIfConfig, nwIpxEchoCtrFilteredPkts=nwIpxEchoCtrFilteredPkts, nwIpxFwdIfCtrFilteredBytes=nwIpxFwdIfCtrFilteredBytes, nwIpxEventFltrIfNum=nwIpxEventFltrIfNum, nwIpxBcastCtrOutBytes=nwIpxBcastCtrOutBytes, nwIpxNetBIOSCtrDiscardBytes=nwIpxNetBIOSCtrDiscardBytes, nwIpxFwdIfEntry=nwIpxFwdIfEntry, nwIpxSapServerIfNetId=nwIpxSapServerIfNetId, nwIpxEchoIfOperationalTime=nwIpxEchoIfOperationalTime, nwIpxRipIfType=nwIpxRipIfType, nwIpxEndSystems=nwIpxEndSystems, nwIpxDistanceVector=nwIpxDistanceVector, nwIpxNetBIOSCtrFilteredPkts=nwIpxNetBIOSCtrFilteredPkts, nwIpxFwdIfCtrIfIndex=nwIpxFwdIfCtrIfIndex)
