...
myIgmpMIBObjects=_MyIgmpMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,26,1))
_MyIgmpInterfaceTable_Object=MibTable
myIgmpInterfaceTable=_MyIgmpInterfaceTable_Object((1,3,6,1,4,1,171,10,97,2,26,1,1))
if mibBuilder.loadTexts:myIgmpInterfaceTable.setStatus(_B)
_MyIgmpInterfaceEntry_Object=MibTableRow
myIgmpInterfaceEntry=_MyIgmpInterfaceEntry_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1))
...
myIgmpInterfaceIfIndex=_MyIgmpInterfaceIfIndex_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,1),_MyIgmpInterfaceIfIndex_Type())
...
myIgmpInterfaceQueryInterval=_MyIgmpInterfaceQueryInterval_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,2),_MyIgmpInterfaceQueryInterval_Type())
...
myIgmpInterfaceVersion=_MyIgmpInterfaceVersion_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,3),_MyIgmpInterfaceVersion_Type())
...
myIgmpInterfaceQuerier=_MyIgmpInterfaceQuerier_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,4),_MyIgmpInterfaceQuerier_Type())
...
myIgmpInterfaceQueryMaxResponseTime=_MyIgmpInterfaceQueryMaxResponseTime_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,5),_MyIgmpInterfaceQueryMaxResponseTime_Type())
...
myIgmpInterfaceQuerierUpTime=_MyIgmpInterfaceQuerierUpTime_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,6),_MyIgmpInterfaceQuerierUpTime_Type())
...
myIgmpInterfaceQuerierExpiryTime=_MyIgmpInterfaceQuerierExpiryTime_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,7),_MyIgmpInterfaceQuerierExpiryTime_Type())
...
myIgmpInterfaceVersion1QuerierTimer=_MyIgmpInterfaceVersion1QuerierTimer_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,8),_MyIgmpInterfaceVersion1QuerierTimer_Type())
...
myIgmpInterfaceWrongVersionQueries=_MyIgmpInterfaceWrongVersionQueries_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,9),_MyIgmpInterfaceWrongVersionQueries_Type())
...
myIgmpInterfaceJoins=_MyIgmpInterfaceJoins_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,10),_MyIgmpInterfaceJoins_Type())
...
myIgmpInterfaceProxyIfIndex=_MyIgmpInterfaceProxyIfIndex_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,11),_MyIgmpInterfaceProxyIfIndex_Type())
...
myIgmpInterfaceGroups=_MyIgmpInterfaceGroups_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,12),_MyIgmpInterfaceGroups_Type())
...
myIgmpInterfaceRobustness=_MyIgmpInterfaceRobustness_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,13),_MyIgmpInterfaceRobustness_Type())
...
myIgmpInterfaceLastMembQueryIntvl=_MyIgmpInterfaceLastMembQueryIntvl_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,14),_MyIgmpInterfaceLastMembQueryIntvl_Type())
...
myIgmpInterfaceQuerierPresentTimeout=_MyIgmpInterfaceQuerierPresentTimeout_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,15),_MyIgmpInterfaceQuerierPresentTimeout_Type())
...
myIgmpInterfaceLeaves=_MyIgmpInterfaceLeaves_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,16),_MyIgmpInterfaceLeaves_Type())
...
myIgmpInterfaceAccessGroupAclName=_MyIgmpInterfaceAccessGroupAclName_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,17),_MyIgmpInterfaceAccessGroupAclName_Type())
...
myIgmpInterfaceEnabled=_MyIgmpInterfaceEnabled_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,18),_MyIgmpInterfaceEnabled_Type())
...
myIgmpInterfaceHostVersion=_MyIgmpInterfaceHostVersion_Object((1,3,6,1,4,1,171,10,97,2,26,1,1,1,19),_MyIgmpInterfaceHostVersion_Type())
...
myIgmpInterfaceStaticTable=_MyIgmpInterfaceStaticTable_Object((1,3,6,1,4,1,171,10,97,2,26,1,2))
if mibBuilder.loadTexts:myIgmpInterfaceStaticTable.setStatus(_B)
_MyIgmpInterfaceStaticEntry_Object=MibTableRow
myIgmpInterfaceStaticEntry=_MyIgmpInterfaceStaticEntry_Object((1,3,6,1,4,1,171,10,97,2,26,1,2,1))
...
myIgmpInterfaceStaticInterface=_MyIgmpInterfaceStaticInterface_Object((1,3,6,1,4,1,171,10,97,2,26,1,2,1,1),_MyIgmpInterfaceStaticInterface_Type())
...
myIgmpInterfaceStaticGroupAddress=_MyIgmpInterfaceStaticGroupAddress_Object((1,3,6,1,4,1,171,10,97,2,26,1,2,1,2),_MyIgmpInterfaceStaticGroupAddress_Type())
...
myIgmpInterfaceStaticStatus=_MyIgmpInterfaceStaticStatus_Object((1,3,6,1,4,1,171,10,97,2,26,1,2,1,3),_MyIgmpInterfaceStaticStatus_Type())
...
myIgmpTraps=_MyIgmpTraps_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,26,1,3))
_MyIgmpMIBConformance_ObjectIdentity=ObjectIdentity
myIgmpMIBConformance=_MyIgmpMIBConformance_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,26,2))
_MyIgmpMIBCompliances_ObjectIdentity=ObjectIdentity
myIgmpMIBCompliances=_MyIgmpMIBCompliances_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,26,2,1))
_MyIgmpMIBGroups_ObjectIdentity=ObjectIdentity
myIgmpMIBGroups=_MyIgmpMIBGroups_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,26,2,2))
myIgmpInterfaceMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,26,2,2,1))
...
myIgmpInterfaceStaticMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,26,2,2,2))
...
myIgmpVersionConflicted=NotificationType((1,3,6,1,4,1,171,10,97,2,26,1,3,1))
myIgmpVersionConflicted.setObjects(*((_A,_F),(_A,_J),(_A,_K)))
if mibBuilder.loadTexts:myIgmpVersionConflicted.setStatus(_B)
myIgmpMIBCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,97,2,26,2,1,1))
myIgmpMIBCompliance.setObjects(*((_A,_h),(_A,_i)))
if mibBuilder.loadTexts:myIgmpMIBCompliance.setStatus(_B)
igmpExternCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,97,2,26,2,1,2))
