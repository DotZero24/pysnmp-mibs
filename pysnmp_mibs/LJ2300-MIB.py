...
class _Sleep_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_b,1),(_S,2)))
...
class _Device_configure_duplexer_enabled_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_y,1),(_z,2)))
...
class __pysmi_continue_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(1));namedValues=NamedValues((_A0,1))
...
class _Auto_continue_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_P,2)))
...
class _Show_address_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_O,1),(_j,3)))
...
class _Display_physical_appearance_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('eDisplayIsLight',1),('eDisplayIsNormal',2),('eDisplayIsDark',3)))
_Display_physical_appearance_Type.__name__=_D
_Display_physical_appearance_Object=MibScalar
display_physical_appearance=_Display_physical_appearance_Object((1,3,6,1,4,1,11,2,3,9,4,2,1,1,2,20,1,4),_Display_physical_appearance_Type())
display_physical_appearance.setMaxAccess(_C)
if mibBuilder.loadTexts:display_physical_appearance.setStatus(_A)
...
class _Mio1_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_k,8),(_l,12)))
...
class _Mio2_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_k,8),(_l,12)))
...
class _Mio3_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_k,8),(_l,12)))
...
class _Job_info_accounting_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),('eLedger',11),(_V,17),(_W,18),('eROC8K',19),(_X,25),(_R,26),(_A1,27),(_Y,45),('eJISB4',46),(_Z,65),('eJapansePostcardDouble',72),(_c,80),(_d,81),(_e,90),(_f,91),(_g,100),(_h,101),(_A2,258),(_A3,282),(_m,32767)))
...
class _File_system2_initialize_volume_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(2));namedValues=NamedValues((_n,2))
...
class _File_system3_initialize_volume_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(2));namedValues=NamedValues((_n,2))
...
class _File_system4_initialize_volume_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(2));namedValues=NamedValues((_n,2))
...
class _Mass_storage_resource_changed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(2));namedValues=NamedValues((_S,2))
...
class _Ram_disk_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_O,1),(_j,3)))
...
class _Firmware_download_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_b,1),(_S,2)))
...
class _Upgradable_devices_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_b,1),(_S,2)))
...
class _Upgradable_devices_current_state_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*(('eIdle',1),('eReceivedImage',2),(_A4,3),('eVerifiedImage',4),(_A5,5),(_A6,6),(_A7,7),('eUpgradeComplete',8)))
...
class _Remote_upgrade_enable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_P,2)))
...
class _Form_feed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(1));namedValues=NamedValues((_A0,1))
...
class _Default_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,17,18,25,26,45,65,72,80,81,90,91,100,101,32767)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),('eFoolscap',10),(_V,17),(_W,18),(_X,25),(_R,26),(_Y,45),(_Z,65),(_o,72),(_c,80),(_d,81),(_e,90),(_f,91),(_g,100),(_h,101),(_m,32767)))
...
class _Reprint_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_O,1),(_P,2),(_j,3)))
...
class _Form_feed_needed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_b,1),(_S,2)))
...
class _Postscript_print_errors_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_P,2)))
...
class _Override_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32765,32767)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),('eLedger',11),(_V,17),(_W,18),('eROC8K',19),(_X,25),(_R,26),(_A1,27),(_Y,45),('eJISB4',46),(_Z,65),(_o,72),(_c,80),(_d,81),(_e,90),(_f,91),(_g,100),(_h,101),(_A2,258),(_A3,282),(_i,32765),(_m,32767)))
...
class _Input_tray_auto_select_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_P,2)))
...
class _Tray1_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,17,18,25,26,45,65,72,80,81,90,91,100,101,32764,32765)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_V,17),(_W,18),(_X,25),(_R,26),(_Y,45),(_Z,65),(_o,72),(_c,80),(_d,81),(_e,90),(_f,91),(_g,100),(_h,101),('eAnyCustom',32764),(_i,32765)))
...
class _Tray2_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,17,18,25,26,45,65,32765)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_V,17),(_W,18),(_X,25),(_R,26),(_Y,45),(_Z,65),(_i,32765)))
...
class _Tray3_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(2,26,32765)));namedValues=NamedValues(*((_Q,2),(_R,26),(_i,32765)))
...
channelEntry.setIndexNames((0,_x,'channelindex'))
...
deviceChannelEntry.setIndexNames((0,_x,'channel-index'))
