# SNMP MIB module (H3C-CFCARD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-CFCARD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:20:56 2025
...
h3cCfCardScalarObjects = _H3cCfCardScalarObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 1)
)
if mibBuilder.loadTexts:
...
h3cCfCardNumber = _H3cCfCardNumber_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 1, 1),
...
h3cCfCardIndex = _H3cCfCardIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 1),
...
h3cCfCardIsPresent = _H3cCfCardIsPresent_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 2),
...
h3cCfCardContainedIn = _H3cCfCardContainedIn_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 3),
...
h3cCfCardParentRelPos = _H3cCfCardParentRelPos_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 4),
...
h3cCfCardDescription = _H3cCfCardDescription_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 5),
...
h3cCfCardSerialNumber = _H3cCfCardSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 6),
...
h3cCfCardFirewareVersion = _H3cCfCardFirewareVersion_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 7),
...
h3cCfCardModelNumber = _H3cCfCardModelNumber_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 8),
...
h3cCfCardState = _H3cCfCardState_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 9),
...
h3cCfCardSize = _H3cCfCardSize_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 10),
    _H3cCfCardSize_Type()
)
...
h3cCfCardUsedSize = _H3cCfCardUsedSize_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 11),
...
h3cCfCardFreeSize = _H3cCfCardFreeSize_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 1, 2, 2, 1, 12),
...
h3cCfCardNotificationsV2 = _H3cCfCardNotificationsV2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 2, 0)
)
if mibBuilder.loadTexts:
...
h3cCfCardMIBConformance = _H3cCfCardMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 4)
)
_H3cCfCardMIBGroups_ObjectIdentity = ObjectIdentity
h3cCfCardMIBGroups = _H3cCfCardMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 4, 1)
)
_H3cCfCardMIBCompliances_ObjectIdentity = ObjectIdentity
h3cCfCardMIBCompliances = _H3cCfCardMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 4, 2)
)

# Managed Objects groups

currentObjectGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 4, 1, 1)
)
currentObjectGroup.setObjects(
      *(("H3C-CFCARD-MIB", "h3cCfCardNumber"),
        ("H3C-CFCARD-MIB", "h3cCfCardIndex"),
        ("H3C-CFCARD-MIB", "h3cCfCardIsPresent"),
        ("H3C-CFCARD-MIB", "h3cCfCardContainedIn"),
        ("H3C-CFCARD-MIB", "h3cCfCardParentRelPos"),
        ("H3C-CFCARD-MIB", "h3cCfCardDescription"),
        ("H3C-CFCARD-MIB", "h3cCfCardSerialNumber"),
        ("H3C-CFCARD-MIB", "h3cCfCardFirewareVersion"),
        ("H3C-CFCARD-MIB", "h3cCfCardModelNumber"),
        ("H3C-CFCARD-MIB", "h3cCfCardState"),
        ("H3C-CFCARD-MIB", "h3cCfCardSize"),
        ("H3C-CFCARD-MIB", "h3cCfCardUsedSize"),
        ("H3C-CFCARD-MIB", "h3cCfCardFreeSize"))
)
if mibBuilder.loadTexts:
...
h3cCfCardHotSwapOn = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 2, 0, 1)
)
...
h3cCfCardHotSwapOff = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 2, 0, 2)
)
...
currentNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 4, 1, 2)
)
currentNotificationGroup.setObjects(
      *(("H3C-CFCARD-MIB", "h3cCfCardHotSwapOn"),
        ("H3C-CFCARD-MIB", "h3cCfCardHotSwapOff"))
)
if mibBuilder.loadTexts:
...
basicCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 41, 1, 4, 2, 1)
)
basicCompliance.setObjects(
      *(("H3C-CFCARD-MIB", "currentObjectGroup"),
        ("H3C-CFCARD-MIB", "currentNotificationGroup"))
)
if mibBuilder.loadTexts:
