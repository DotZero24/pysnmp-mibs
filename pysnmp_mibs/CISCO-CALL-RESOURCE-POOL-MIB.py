...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CALL-RESOURCE-POOL-MIB
...
_CcrpResourcePortBased_Type.__name__ = "TruthValue"
...
_CcrpResourceLimit_Type.__name__ = "Unsigned32"
...
_CcrpResourceRangeStartPort_Type.__name__ = "PhysicalPosition"
...
_CcrpResourceRangeEndPort_Type.__name__ = "PhysicalPosition"
...
_CcrpCPSessionLimit_Type.__name__ = "Unsigned32"
...
_CcrpDnisStatisticsTableMaxEntries_Type.__name__ = "Unsigned32"
...
ccrpMIBCompliance.setObjects(
      *(("CISCO-CALL-RESOURCE-POOL-MIB", "ccrpGeneralConfigGroup"),
        ("CISCO-CALL-RESOURCE-POOL-MIB", "ccrpDnisConfigGroup"),
        ("CISCO-CALL-RESOURCE-POOL-MIB", "ccrpCDConfigGroup"),
        ("CISCO-CALL-RESOURCE-POOL-MIB", "ccrpResourceConfigGroup"),
        ("CISCO-CALL-RESOURCE-POOL-MIB", "ccrpCPConfigGroup"),
        ("CISCO-CALL-RESOURCE-POOL-MIB", "ccrpCPStatisticsGroup"),
        ("CISCO-CALL-RESOURCE-POOL-MIB", "ccrpDnisStatisticsGroup"),
        ("CISCO-CALL-RESOURCE-POOL-MIB", "ccrpCDStatisticsGroup"))
)
if mibBuilder.loadTexts:
