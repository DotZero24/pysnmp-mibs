...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LWAPP-MDNS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:41:36 2025
...
class _ClMdnsQueryInterval_Type(Unsigned32):
    """Custom type clMdnsQueryInterval based on Unsigned32"""
    defaultValue = 15


_ClMdnsQueryInterval_Type.__name__ = "Unsigned32"
_ClMdnsQueryInterval_Object = MibScalar
clMdnsQueryInterval = _ClMdnsQueryInterval_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 842, 1, 1, 1, 2),
...
cLMdnsMonitorGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 842, 2, 2, 2)
)
cLMdnsMonitorGroup.setObjects(
      *(("CISCO-LWAPP-MDNS-MIB", "clMdnsProfileWlanCount"),
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsProfileInterfaceCount"),
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsProfileInterfaceGrpCount"),
        ...
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsServiceProviderTimeLeft"),
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsDomainMacAddress"),
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsDomainIpAddressType"),
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsDomainIpAddress"),
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsDomainVlan"),
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsDomainType"),
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsDomainEntryTtl"),
        ("CISCO-LWAPP-MDNS-MIB", "clMdnsDomainEntryTimeLeft"))
)
if mibBuilder.loadTexts:
    cLMdnsMonitorGroup.setStatus("current")

cLMdnsServiceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 842, 2, 2, 3)
)
cLMdnsServiceGroup.setObjects(
      *(("CISCO-LWAPP-MDNS-MIB", "cLMdnsServiceGroupDescription"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsServiceGroupRowStatus"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsServiceGroupDeviceName"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsServiceGroupLocationName"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsServiceGroupLocationType"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsServiceGroupDeviceMacRowStatus"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsRuleRole"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsRuleUserId"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsServiceGroupRuleRowStatus"))
)
if mibBuilder.loadTexts:
    cLMdnsServiceGroup.setStatus("current")
...
ciscoLwappMdnsMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 842, 2, 1, 1)
)
ciscoLwappMdnsMIBCompliance.setObjects(
      *(("CISCO-LWAPP-MDNS-MIB", "cLMdnsConfigGroup"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsMonitorGroup"),
        ("CISCO-LWAPP-MDNS-MIB", "cLMdnsServiceGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoLwappMdnsMIB": ciscoLwappMdnsMIB,
       ...
       "cLMdnsServiceGroup": cLMdnsServiceGroup}
)
