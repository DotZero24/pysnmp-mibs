...
mibBuilder.exportSymbols("CISCO-ADMISSION-POLICY-MIB", ciscoAdmissionPolicyMIB=ciscoAdmissionPolicyMIB, capTotalSessions=capTotalSessions, CapURLString=CapURLString, capSidIngressQosPolicyState=capSidIngressQosPolicyState, CapSessionId=CapSessionId, capSessionStatisticsGroup=capSessionStatisticsGroup, ciscoAdmissionPolicyMIBObjects=ciscoAdmissionPolicyMIBObjects, capSidSessionInfoEntry=capSidSessionInfoEntry, capActiveSessions=capActiveSessions, capSidDownloadableAclState=capSidDownloadableAclState, capSidUrlRedirectAclName=capSidUrlRedirectAclName, ciscoAdmissionPolicyMIBCompliance=ciscoAdmissionPolicyMIBCompliance, capSidSessionAddress=capSidSessionAddress, capSidEgressQosPolicy=capSidEgressQosPolicy, CapAclName=CapAclName, capSidEgressQosPolicyState=capSidEgressQosPolicyState, CapPolicyState=CapPolicyState, capSidSessionFeatureType=capSidSessionFeatureType, capSidSessionInfoTable=capSidSessionInfoTable, capSidSessionIndex=capSidSessionIndex, capSidSessionAddressType=capSidSessionAddressType, ciscoAdmissionPolicyMIBCompliances=ciscoAdmissionPolicyMIBCompliances, capSidSessionInfoGroup=capSidSessionInfoGroup, capSidRedirectUrlString=capSidRedirectUrlString, capSidDownloadableAclName=capSidDownloadableAclName, capSidUrlRedirectAclState=capSidUrlRedirectAclState, CapQosPolicy=CapQosPolicy, capSidSessionPolicyTable=capSidSessionPolicyTable, capSidSessionPolicyIndex=capSidSessionPolicyIndex, capSidSessionMacAddress=capSidSessionMacAddress, capSidSessionIfIndex=capSidSessionIfIndex, capSidIngressQosPolicy=capSidIngressQosPolicy, capSidSessionPolicyEntry=capSidSessionPolicyEntry, capSidSecurityGroupTag=capSidSecurityGroupTag, capSidSessionPolicyGroup=capSidSessionPolicyGroup, ciscoAdmissionPolicyMIBGroups=ciscoAdmissionPolicyMIBGroups, capSessions=capSessions, capSidRedirectUrlStringState=capSidRedirectUrlStringState, ciscoAdmissionPolicyMIBNotifs=ciscoAdmissionPolicyMIBNotifs, ciscoAdmissionPolicyMIBConformance=ciscoAdmissionPolicyMIBConformance, PYSNMP_MODULE_ID=ciscoAdmissionPolicyMIB)
