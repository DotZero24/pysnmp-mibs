...
mibBuilder.exportSymbols("SWITCH-CHASSIS-MIB", tftpRemoteFileName=tftpRemoteFileName, pigVer=pigVer, segBusQmuId=segBusQmuId, snmpIpTrapRcvrPort=snmpIpTrapRcvrPort, chassisFanStatus=chassisFanStatus, ipEncap=ipEncap, tftpLocalFileName=tftpLocalFileName, eventLogCount=eventLogCount, segBusEntry=segBusEntry, ipNetMask=ipNetMask, chassisBaseMacAddress=chassisBaseMacAddress, logParams=logParams, eventLogTable=eventLogTable, tftpUserName=tftpUserName, snmpUnAuthIpAddr=snmpUnAuthIpAddr, eventLogDetail=eventLogDetail, chassisBoardSerialNumber=chassisBoardSerialNumber, consolePortStopBits=consolePortStopBits, chassisFwVersion=chassisFwVersion, tftpOperationStateChange=tftpOperationStateChange, switchChassisMib=switchChassisMib, tftpErrorMessage=tftpErrorMessage, chassisParams=chassisParams, chassisSerialNumber=chassisSerialNumber, ipDomainName=ipDomainName, consolePortParity=consolePortParity, tftpOperation=tftpOperation, ipAddr=ipAddr, cpuVer=cpuVer, snmpIpTrapRcvrTable=snmpIpTrapRcvrTable, HwIdentifier=HwIdentifier, consoleParams=consoleParams, HostNameOrIpAddr=HostNameOrIpAddr, ipBcastForm=ipBcastForm, dramSize=dramSize, snmpIpTrapRcvrCommunity=snmpIpTrapRcvrCommunity, ipDefaultGateway=ipDefaultGateway, snmpIpTrapRcvrStatus=snmpIpTrapRcvrStatus, eventLogRawEntry=eventLogRawEntry, snmpIpTrapRcvrEntry=snmpIpTrapRcvrEntry, deviceReset=deviceReset, chassisOSVersion=chassisOSVersion, bootVer=bootVer, consolePortDataBits=consolePortDataBits, eventLogEntry=eventLogEntry, iscVer=iscVer, eventLogTime=eventLogTime, eventLogDescr=eventLogDescr, segBusIndex=segBusIndex, SwVersionId=SwVersionId, bootFlag=bootFlag, eventLogSize=eventLogSize, tftpServerName=tftpServerName, PYSNMP_MODULE_ID=switchChassisMib, isdVer=isdVer, tftpGroup=tftpGroup, sysConfigParams=sysConfigParams, qmuMemSize=qmuMemSize, bootParams=bootParams, snmpParams=snmpParams, tftpOperationState=tftpOperationState, chassisHwId=chassisHwId, ipParams=ipParams, tftpAdminState=tftpAdminState, snmpIpTrapRcvrIpAddress=snmpIpTrapRcvrIpAddress, snmpUnAuthCommunity=snmpUnAuthCommunity, eventLogIndex=eventLogIndex, segBusTable=segBusTable, consolePortSpeed=consolePortSpeed, segBusPmiuId=segBusPmiuId, postVer=postVer, eventLogEnable=eventLogEnable, chassisLastChanges=chassisLastChanges)
