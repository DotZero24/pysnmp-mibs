...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-CABLE-WIDEBAND-MIB
...
entPhysicalIndex, PhysicalIndexOrZero, entPhysicalName = mibBuilder.importSymbols("ENTITY-MIB", "entPhysicalIndex", "PhysicalIndexOrZero", "entPhysicalName")
...
mibBuilder.exportSymbols("CISCO-CABLE-WIDEBAND-MIB", ciscoCableWidebandMIBComplianceRev1=ciscoCableWidebandMIBComplianceRev1, ccwbSFPLinkTrapEnable=ccwbSFPLinkTrapEnable, ccwbRFChannelQamEntry=ccwbRFChannelQamEntry, ccwbFiberNodeGlobRFID=ccwbFiberNodeGlobRFID, ccwbRFChannelStorageType=ccwbRFChannelStorageType, ccwbFiberNodeNBIfIndx=ccwbFiberNodeNBIfIndx, ccwbRFChannelTable=ccwbRFChannelTable, ccwbFiberNodeStorageType=ccwbFiberNodeStorageType, ccwbFiberNodeDescrEntry=ccwbFiberNodeDescrEntry, ccwbFiberNodeDescrStorageType=ccwbFiberNodeDescrStorageType, ccwbFiberNodeTable=ccwbFiberNodeTable, ccwbRFChanQamTos=ccwbRFChanQamTos, ccwbSFPLinkUpNotification=ccwbSFPLinkUpNotification, ciscoCableWidebandMIBComplianceRev2=ciscoCableWidebandMIBComplianceRev2, ccwbFiberNodeEntry=ccwbFiberNodeEntry, ccwbFiberNodeWBRFPort=ccwbFiberNodeWBRFPort, ccwbRFChanQamIPAddressType=ccwbRFChanQamIPAddressType, ccwbFiberNodeDescrRowStatus=ccwbFiberNodeDescrRowStatus, ccwbFiberNodeWBContlrPhyIndx=ccwbFiberNodeWBContlrPhyIndx, ccwbWBtoNBifIndexForNB=ccwbWBtoNBifIndexForNB, ccwbWBCmStatusExtIndex=ccwbWBCmStatusExtIndex, ccwbWBCmStatusExtEntry=ccwbWBCmStatusExtEntry, ccwbWBCmStatusValue=ccwbWBCmStatusValue, ccwbWBtoRFMappingEntry=ccwbWBtoRFMappingEntry, ciscoCableWidebandMIBComplianceRev3=ciscoCableWidebandMIBComplianceRev3, ccwbRFChannelFrequencyRev1=ccwbRFChannelFrequencyRev1, ccwbFiberNodeDescription=ccwbFiberNodeDescription, ccwbWBtoRFRowStatus=ccwbWBtoRFRowStatus, ciscoCableWidebandMIB=ciscoCableWidebandMIB, ccwbWBtoNBRowStatus=ccwbWBtoNBRowStatus, ccwbFiberNodeRowStatus=ccwbFiberNodeRowStatus, ccwbRFChanQamIPAddress=ccwbRFChanQamIPAddress, ccwbRFChannelEntry=ccwbRFChannelEntry, ccwbWidebandObjGroupSup2=ccwbWidebandObjGroupSup2, ccwbRFChannelWidth=ccwbRFChannelWidth, ccwbRFChanQamDepiTunnel=ccwbRFChanQamDepiTunnel, ccwbWBtoRFStorageType=ccwbWBtoRFStorageType, ccwbRFChanQamUdpPort=ccwbRFChanQamUdpPort, ccwbWBCmStatusExtTable=ccwbWBCmStatusExtTable, ccwbWidebandObjGroupRev1=ccwbWidebandObjGroupRev1, ccwbRFChanQamMacAddress=ccwbRFChanQamMacAddress, ciscoCableWidebandMIBObjects=ciscoCableWidebandMIBObjects, ccwbWBCmWBIfindex=ccwbWBCmWBIfindex, ccwbWidebandObjGroupSup1=ccwbWidebandObjGroupSup1, ccwbRFChannelQamTable=ccwbRFChannelQamTable, ciscoCableWidebandMIBCompliances=ciscoCableWidebandMIBCompliances, ccwbWBtoRFMappingTable=ccwbWBtoRFMappingTable, ccwbWidebandObjGroup=ccwbWidebandObjGroup, ccwbWBtoRFBandwidth=ccwbWBtoRFBandwidth, ccwbWBCmStatusEntry=ccwbWBCmStatusEntry, ccwbRFChannelAnnex=ccwbRFChannelAnnex, ccwbRFChanUtilInterval=ccwbRFChanUtilInterval, ccwbWBBondGrpEntry=ccwbWBBondGrpEntry, PYSNMP_MODULE_ID=ciscoCableWidebandMIB, ciscoCableWidebandMIBConform=ciscoCableWidebandMIBConform, ccwbRFChannelMpegPkts=ccwbRFChannelMpegPkts, ccwbRFChannelUtilization=ccwbRFChannelUtilization, ccwbRFChannelModulation=ccwbRFChannelModulation, ccwbRFChanQamDepiRemoteId=ccwbRFChanQamDepiRemoteId, ccwbFiberNodeDescrTable=ccwbFiberNodeDescrTable, ccwbWBBondGrpSecondary=ccwbWBBondGrpSecondary, ciscoCableWidebandMIBCompliance=ciscoCableWidebandMIBCompliance, ccwbRFChannelFrequency=ccwbRFChannelFrequency, ccwbRFChannelRowStatus=ccwbRFChannelRowStatus, ccwbRFChanQamTsid=ccwbRFChanQamTsid, ciscoCableWidebandMIBGroups=ciscoCableWidebandMIBGroups, ccwbRFChanQamVlanId=ccwbRFChanQamVlanId, ccwbWBtoNBMappingEntry=ccwbWBtoNBMappingEntry, ccwbWBtoNBStorageType=ccwbWBtoNBStorageType, ccwbWBBondGrpTable=ccwbWBBondGrpTable, ccwbFiberNodeID=ccwbFiberNodeID, ccwbRFChannelNum=ccwbRFChannelNum, ccwbWidebandNotifGroup=ccwbWidebandNotifGroup, ccwbRFChanQamPriorityBits=ccwbRFChanQamPriorityBits, ccwbSFPLinkDownNotification=ccwbSFPLinkDownNotification, ccwbWBtoNBMappingTable=ccwbWBtoNBMappingTable, ccwbWBCmStatusTable=ccwbWBCmStatusTable, ciscoCableWidebandMIBNotifs=ciscoCableWidebandMIBNotifs)
