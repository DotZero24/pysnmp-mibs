...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CABLE-WIDEBAND-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:26:35 2025
...
_CcwbRFChannelStorageType_Type.__name__ = "StorageType"
...
_CcwbRFChanQamIPAddressType_Type.__name__ = "InetAddressType"
...
_CcwbWBtoRFStorageType_Type.__name__ = "StorageType"
...
_CcwbWBtoNBStorageType_Type.__name__ = "StorageType"
...
_CcwbFiberNodeDescrStorageType_Type.__name__ = "StorageType"
...
_CcwbFiberNodeNBIfIndx_Type.__name__ = "InterfaceIndexOrZero"
...
_CcwbFiberNodeWBContlrPhyIndx_Type.__name__ = "PhysicalIndexOrZero"
...
_CcwbFiberNodeStorageType_Type.__name__ = "StorageType"
...
ciscoCableWidebandMIBCompliance.setObjects(
    ("CISCO-CABLE-WIDEBAND-MIB", "ccwbWidebandObjGroup")
)
if mibBuilder.loadTexts:
...
ciscoCableWidebandMIBComplianceRev1.setObjects(
      *(("CISCO-CABLE-WIDEBAND-MIB", "ccwbWidebandObjGroup"),
        ("CISCO-CABLE-WIDEBAND-MIB", "ccwbWidebandObjGroupSup1"))
)
if mibBuilder.loadTexts:
...
ciscoCableWidebandMIBComplianceRev2.setObjects(
      *(("CISCO-CABLE-WIDEBAND-MIB", "ccwbWidebandObjGroupRev1"),
        ("CISCO-CABLE-WIDEBAND-MIB", "ccwbWidebandObjGroupSup1"))
)
if mibBuilder.loadTexts:
...
ciscoCableWidebandMIBComplianceRev3.setObjects(
      *(("CISCO-CABLE-WIDEBAND-MIB", "ccwbWidebandObjGroupRev1"),
        ("CISCO-CABLE-WIDEBAND-MIB", "ccwbWidebandObjGroupSup1"),
        ("CISCO-CABLE-WIDEBAND-MIB", "ccwbWidebandObjGroupSup2"),
        ("CISCO-CABLE-WIDEBAND-MIB", "ccwbWidebandNotifGroup"))
)
if mibBuilder.loadTexts:
