# SNMP MIB module (SUPERMICRO-TUNNEL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-TUNNEL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:04:09 2025
...
fsTunlIfAddressType = _FsTunlIfAddressType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 1),
...
fsTunlIfLocalInetAddress = _FsTunlIfLocalInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 2),
...
fsTunlIfRemoteInetAddress = _FsTunlIfRemoteInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 3),
...
fsTunlIfConfigID = _FsTunlIfConfigID_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 5),
...
fsTunlIfHopLimit = _FsTunlIfHopLimit_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 6),
...
fsTunlIfSecurity = _FsTunlIfSecurity_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 7),
...
fsTunlIfTOS = _FsTunlIfTOS_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 8),
    _FsTunlIfTOS_Type()
)
...
fsTunlIfFlowLabel = _FsTunlIfFlowLabel_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 9),
...
fsTunlIfMTU = _FsTunlIfMTU_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 10),
    _FsTunlIfMTU_Type()
)
...
fsTunlIfDirFlag = _FsTunlIfDirFlag_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 11),
...
fsTunlIfDirection = _FsTunlIfDirection_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 12),
...
fsTunlIfEncaplmt = _FsTunlIfEncaplmt_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 13),
...
fsTunlIfEncapOption = _FsTunlIfEncapOption_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 14),
...
fsTunlIfIndex = _FsTunlIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 15),
    _FsTunlIfIndex_Type()
)
...
fsTunlIfAlias = _FsTunlIfAlias_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 16),
    _FsTunlIfAlias_Type()
)
...
fsTunlIfCksumFlag = _FsTunlIfCksumFlag_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 17),
...
fsTunlIfStatus = _FsTunlIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 95, 1, 1, 1, 1, 19),
