...
fsTunlMIBObjects=_FsTunlMIBObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,1,95,1))
_FsTunl_ObjectIdentity=ObjectIdentity
fsTunl=_FsTunl_ObjectIdentity((1,3,6,1,4,1,10876,101,1,95,1,1))
_FsTunlIfTable_Object=MibTable
fsTunlIfTable=_FsTunlIfTable_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1))
if mibBuilder.loadTexts:fsTunlIfTable.setStatus(_A)
_FsTunlIfEntry_Object=MibTableRow
fsTunlIfEntry=_FsTunlIfEntry_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1))
...
fsTunlIfAddressType=_FsTunlIfAddressType_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,1),_FsTunlIfAddressType_Type())
...
fsTunlIfLocalInetAddress=_FsTunlIfLocalInetAddress_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,2),_FsTunlIfLocalInetAddress_Type())
...
fsTunlIfRemoteInetAddress=_FsTunlIfRemoteInetAddress_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,3),_FsTunlIfRemoteInetAddress_Type())
...
fsTunlIfEncapsMethod=_FsTunlIfEncapsMethod_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,4),_FsTunlIfEncapsMethod_Type())
...
fsTunlIfConfigID=_FsTunlIfConfigID_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,5),_FsTunlIfConfigID_Type())
...
fsTunlIfHopLimit=_FsTunlIfHopLimit_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,6),_FsTunlIfHopLimit_Type())
...
fsTunlIfSecurity=_FsTunlIfSecurity_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,7),_FsTunlIfSecurity_Type())
...
fsTunlIfTOS=_FsTunlIfTOS_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,8),_FsTunlIfTOS_Type())
...
fsTunlIfFlowLabel=_FsTunlIfFlowLabel_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,9),_FsTunlIfFlowLabel_Type())
...
fsTunlIfMTU=_FsTunlIfMTU_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,10),_FsTunlIfMTU_Type())
...
fsTunlIfDirFlag=_FsTunlIfDirFlag_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,11),_FsTunlIfDirFlag_Type())
...
fsTunlIfDirection=_FsTunlIfDirection_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,12),_FsTunlIfDirection_Type())
...
fsTunlIfEncaplmt=_FsTunlIfEncaplmt_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,13),_FsTunlIfEncaplmt_Type())
...
fsTunlIfEncapOption=_FsTunlIfEncapOption_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,14),_FsTunlIfEncapOption_Type())
...
fsTunlIfIndex=_FsTunlIfIndex_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,15),_FsTunlIfIndex_Type())
...
fsTunlIfAlias=_FsTunlIfAlias_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,16),_FsTunlIfAlias_Type())
...
fsTunlIfCksumFlag=_FsTunlIfCksumFlag_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,17),_FsTunlIfCksumFlag_Type())
...
fsTunlIfPmtuFlag=_FsTunlIfPmtuFlag_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,18),_FsTunlIfPmtuFlag_Type())
...
fsTunlIfStatus=_FsTunlIfStatus_Object((1,3,6,1,4,1,10876,101,1,95,1,1,1,1,19),_FsTunlIfStatus_Type())
