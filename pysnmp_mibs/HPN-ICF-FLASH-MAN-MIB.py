...
mibBuilder.exportSymbols("HPN-ICF-FLASH-MAN-MIB", hpnicfFlhOperType=hpnicfFlhOperType, hpnicfFlhChipNum=hpnicfFlhChipNum, hpnicfFlhPos=hpnicfFlhPos, hpnicfFlhChipWriteTimesLimit=hpnicfFlhChipWriteTimesLimit, hpnicfFlhChipSerialNo=hpnicfFlhChipSerialNo, hpnicfFlashNotification=hpnicfFlashNotification, hpnicfFlashMIBGroups=hpnicfFlashMIBGroups, hpnicfFlhMIBCompliances=hpnicfFlhMIBCompliances, hpnicfFlashPartitions=hpnicfFlashPartitions, hpnicfFlhDescr=hpnicfFlhDescr, hpnicfFlhHCSize=hpnicfFlhHCSize, hpnicfFlashEntry=hpnicfFlashEntry, hpnicfFlhFileChecksum=hpnicfFlhFileChecksum, hpnicfFlhOperProgress=hpnicfFlhOperProgress, hpnicfFlhPartName=hpnicfFlhPartName, hpnicfFlhOperNotification=hpnicfFlhOperNotification, hpnicfFlhOperSrvVPNName=hpnicfFlhOperSrvVPNName, hpnicfFlhFileGroup=hpnicfFlhFileGroup, hpnicfFlhOperServerUser=hpnicfFlhOperServerUser, HpnicfFlashPartitionUpgradeMode=HpnicfFlashPartitionUpgradeMode, hpnicfFlhChipTable=hpnicfFlhChipTable, hpnicfFlhPartHCSpaceFree=hpnicfFlhPartHCSpaceFree, hpnicfFlhOperSrvAddrType=hpnicfFlhOperSrvAddrType, hpnicfFlhOperSourceFile=hpnicfFlhOperSourceFile, hpnicfFlhChipDescr=hpnicfFlhChipDescr, hpnicfFlhChipEntry=hpnicfFlhChipEntry, hpnicfFlhOpTable=hpnicfFlhOpTable, hpnicfFlhFileTable=hpnicfFlhFileTable, hpnicfFlhPartitionEntry=hpnicfFlhPartitionEntry, hpnicfFlhIndex=hpnicfFlhIndex, hpnicfFlhOperProtocol=hpnicfFlhOperProtocol, hpnicfFlhFileSize=hpnicfFlhFileSize, hpnicfFlhOperServerPort=hpnicfFlhOperServerPort, hpnicfFlhRemovable=hpnicfFlhRemovable, hpnicfFlhFileStatus=hpnicfFlhFileStatus, hpnicfFlhPartUpgradeMode=hpnicfFlhPartUpgradeMode, hpnicfFlhFileName=hpnicfFlhFileName, hpnicfFlhMaxPartitions=hpnicfFlhMaxPartitions, HpnicfFlashOperationStatus=HpnicfFlashOperationStatus, hpnicfFlhOperIndex=hpnicfFlhOperIndex, hpnicfFlhPartFirstChip=hpnicfFlhPartFirstChip, hpnicfFlashOperate=hpnicfFlashOperate, PYSNMP_MODULE_ID=hpnicfFlash, hpnicfFlhOperDestinationFile=hpnicfFlhOperDestinationFile, hpnicfFlhPartFileNum=hpnicfFlhPartFileNum, hpnicfFlhChipGroup=hpnicfFlhChipGroup, hpnicfFlhName=hpnicfFlhName, hpnicfFlhOperPassword=hpnicfFlhOperPassword, hpnicfFlhMIBCompliance=hpnicfFlhMIBCompliance, hpnicfFlhKbyteSize=hpnicfFlhKbyteSize, hpnicfFlhOperSrvAddrRev=hpnicfFlhOperSrvAddrRev, hpnicfFlhPartSpace=hpnicfFlhPartSpace, hpnicfFlhPartLastChip=hpnicfFlhPartLastChip, hpnicfFlhChipEraseTimes=hpnicfFlhChipEraseTimes, hpnicfFlhOperServerAddress=hpnicfFlhOperServerAddress, hpnicfFlhOperEndNotification=hpnicfFlhOperEndNotification, hpnicfFlhPartitionGroup=hpnicfFlhPartitionGroup, hpnicfFlhPartitionNum=hpnicfFlhPartitionNum, hpnicfFlhSupportNum=hpnicfFlhSupportNum, hpnicfFlhMinPartitionSize=hpnicfFlhMinPartitionSize, hpnicfFlhNotificationGroup=hpnicfFlhNotificationGroup, hpnicfFlashChips=hpnicfFlashChips, hpnicfFlhPartRequireErase=hpnicfFlhPartRequireErase, hpnicfFlhOperStatus=hpnicfFlhOperStatus, hpnicfFlhFiles=hpnicfFlhFiles, hpnicfFlhPartPathForGlobalOpt=hpnicfFlhPartPathForGlobalOpt, hpnicfFlhChipWriteTimes=hpnicfFlhChipWriteTimes, hpnicfFlhOperationGroup=hpnicfFlhOperationGroup, hpnicfFlhFileIndex=hpnicfFlhFileIndex, hpnicfFlhChipID=hpnicfFlhChipID, hpnicfFlashDevice=hpnicfFlashDevice, hpnicfFlhPartitionBool=hpnicfFlhPartitionBool, hpnicfFlhGroup=hpnicfFlhGroup, hpnicfFlhOperFailReason=hpnicfFlhOperFailReason, hpnicfFlhFileEntry=hpnicfFlhFileEntry, hpnicfFlhPartHCSpace=hpnicfFlhPartHCSpace, hpnicfFlashManMIBObjects=hpnicfFlashManMIBObjects, hpnicfFlhOpEntry=hpnicfFlhOpEntry, hpnicfFlhOperRowStatus=hpnicfFlhOperRowStatus, hpnicfFlhPartIndex=hpnicfFlhPartIndex, hpnicfFlhPartChecksumMethod=hpnicfFlhPartChecksumMethod, hpnicfFlhPartSpaceFree=hpnicfFlhPartSpaceFree, hpnicfFlhSize=hpnicfFlhSize, hpnicfFlhChipEraseTimesLimit=hpnicfFlhChipEraseTimesLimit, hpnicfFlash=hpnicfFlash, hpnicfFlashTable=hpnicfFlashTable, hpnicfFlhFileHCSize=hpnicfFlhFileHCSize, hpnicfFlhPartBootable=hpnicfFlhPartBootable, hpnicfFlhPartStatus=hpnicfFlhPartStatus, hpnicfFlhPartitionTable=hpnicfFlhPartitionTable, hpnicfFlhPartFileNameLen=hpnicfFlhPartFileNameLen, hpnicfFlashMIBConformance=hpnicfFlashMIBConformance, HpnicfFlashPartitionStatus=HpnicfFlashPartitionStatus, hpnicfFlhInitTime=hpnicfFlhInitTime)
