...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VIDEO-SESSION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:59 2025
...
cVideoSessionMIBCompliance.setObjects(
      *(("CISCO-VIDEO-SESSION-MIB", "cVideoSessionHistoryGroup"),
        ("CISCO-VIDEO-SESSION-MIB", "cVideoSessionActiveGroup"))
)
if mibBuilder.loadTexts:
...
cVideoSessionMIBComplianceRev1.setObjects(
      *(("CISCO-VIDEO-SESSION-MIB", "cVideoSessionCommonStatusGroup"),
        ("CISCO-VIDEO-SESSION-MIB", "cVideoSessionCommonStatisticsGroup"),
        ("CISCO-VIDEO-SESSION-MIB", "cVideoSessionCallStatisticsGroup"),
        ("CISCO-VIDEO-SESSION-MIB", "cVideoSessionConfereeStatisticsGroup"))
)
if mibBuilder.loadTexts:
