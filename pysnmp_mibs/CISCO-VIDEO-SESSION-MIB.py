...
mibBuilder.exportSymbols("CISCO-VIDEO-SESSION-MIB", cVideoCommonStatsActiveEntry=cVideoCommonStatsActiveEntry, ciscoVideoSessionMIBCompliances=ciscoVideoSessionMIBCompliances, cVideoCommonActiveTxCodec=cVideoCommonActiveTxCodec, cVideoCommonActiveTxBytes=cVideoCommonActiveTxBytes, cVideoCommonStatsActiveTxCurrentJitter=cVideoCommonStatsActiveTxCurrentJitter, cVideoConfereeHistoryMaxJitter=cVideoConfereeHistoryMaxJitter, cVideoCallHistoryTxBadHeaderPackets=cVideoCallHistoryTxBadHeaderPackets, cVideoCommonHistoryRxBytes=cVideoCommonHistoryRxBytes, cVideoCommonStatsHistoryTxMaxJitter=cVideoCommonStatsHistoryTxMaxJitter, cVideoConfereeActiveCurrentOutOfSyncDelay=cVideoConfereeActiveCurrentOutOfSyncDelay, cVideoCommonHistoryConnectionId=cVideoCommonHistoryConnectionId, cVideoCallHistoryTxMacroblocksConcealed=cVideoCallHistoryTxMacroblocksConcealed, cVideoCallActiveTxMacroblocksConcealed=cVideoCallActiveTxMacroblocksConcealed, cVideoCommonStatsActiveTxMaxJitter=cVideoCommonStatsActiveTxMaxJitter, cVideoCommonActiveRxBytes=cVideoCommonActiveRxBytes, cVideoCallHistoryTxLostPackets=cVideoCallHistoryTxLostPackets, cVideoCommonActiveCallType=cVideoCommonActiveCallType, cVideoCallActiveTxFramesConcealed=cVideoCallActiveTxFramesConcealed, cVideoCommonStatsActiveRxTotalLostPackets=cVideoCommonStatsActiveRxTotalLostPackets, cVideoCommonStatsHistoryTxAvgDelay=cVideoCommonStatsHistoryTxAvgDelay, cVideoCommonStatsHistoryRxTotalLostPackets=cVideoCommonStatsHistoryRxTotalLostPackets, cVideoSessionActive=cVideoSessionActive, PYSNMP_MODULE_ID=ciscoVideoSessionMIB, cVideoCommonActiveTable=cVideoCommonActiveTable, cVideoConfereeActiveMaxJitter=cVideoConfereeActiveMaxJitter, cVideoCommonHistoryTxPayloadFormat=cVideoCommonHistoryTxPayloadFormat, cVideoCommonHistoryCallReferenceId=cVideoCommonHistoryCallReferenceId, cVideoCommonStatsHistoryEntry=cVideoCommonStatsHistoryEntry, cVideoCommonActiveTxPictureHeight=cVideoCommonActiveTxPictureHeight, cVideoSessionCommonStatisticsGroup=cVideoSessionCommonStatisticsGroup, cVideoCommonStatsHistoryTxAvgJitter=cVideoCommonStatsHistoryTxAvgJitter, cVideoSessionHistoryGroup=cVideoSessionHistoryGroup, cVideoCommonActiveRxDuration=cVideoCommonActiveRxDuration, cVideoCommonHistoryTxCodec=cVideoCommonHistoryTxCodec, cVideoCommonStatsActiveTxTotalOutOfOrderPackets=cVideoCommonStatsActiveTxTotalOutOfOrderPackets, cVideoConfereeHistoryTotalDroppedPackets=cVideoConfereeHistoryTotalDroppedPackets, cVideoCommonActiveRxAnnex=cVideoCommonActiveRxAnnex, cVideoCommonHistoryTxBytes=cVideoCommonHistoryTxBytes, cVideoCommonActiveRxPackets=cVideoCommonActiveRxPackets, ciscoVideoSessionMIBGroups=ciscoVideoSessionMIBGroups, cVideoCommonHistoryCallType=cVideoCommonHistoryCallType, cVideoCommonHistoryRxPayloadFormat=cVideoCommonHistoryRxPayloadFormat, cVideoConfereeActiveMaxDelay=cVideoConfereeActiveMaxDelay, cVideoCommonStatsActiveRxPercentLostPackets=cVideoCommonStatsActiveRxPercentLostPackets, ciscoVideoSessionMIBConform=ciscoVideoSessionMIBConform, cVideoCommonStatsHistoryTxMaxDelay=cVideoCommonStatsHistoryTxMaxDelay, cVideoCommonActiveTxProfile=cVideoCommonActiveTxProfile, cVideoCommonHistoryTxPictureWidth=cVideoCommonHistoryTxPictureWidth, cVideoConfereeActiveTotalLostPackets=cVideoConfereeActiveTotalLostPackets, cVideoCallActiveTxBadHeaderPackets=cVideoCallActiveTxBadHeaderPackets, cVideoCommonHistoryTxLevel=cVideoCommonHistoryTxLevel, cVideoCommonActiveRxPictureHeight=cVideoCommonActiveRxPictureHeight, cVideoCommonHistoryRxProfile=cVideoCommonHistoryRxProfile, cVideoCallActiveTable=cVideoCallActiveTable, cVideoConfereeActiveMaxOutOfSyncDelay=cVideoConfereeActiveMaxOutOfSyncDelay, cVideoConfereeActiveEntry=cVideoConfereeActiveEntry, cVideoCommonActiveRxLevel=cVideoCommonActiveRxLevel, cVideoCallHistoryTxOutOfOrderPackets=cVideoCallHistoryTxOutOfOrderPackets, cVideoCommonStatsActiveTxAvgJitter=cVideoCommonStatsActiveTxAvgJitter, cVideoConfereeActiveTotalDroppedPackets=cVideoConfereeActiveTotalDroppedPackets, cVideoCommonActiveTxConfigFrameRate=cVideoCommonActiveTxConfigFrameRate, ciscoVideoSessionMIBNotifs=ciscoVideoSessionMIBNotifs, cVideoCommonHistoryTxPictureHeight=cVideoCommonHistoryTxPictureHeight, CvcVideoCodecAnnexMap=CvcVideoCodecAnnexMap, cVideoCommonStatsActiveRxCurrentLostPackets=cVideoCommonStatsActiveRxCurrentLostPackets, cVideoCommonActiveRxPictureWidth=cVideoCommonActiveRxPictureWidth, cVideoCommonActiveConnectionId=cVideoCommonActiveConnectionId, cVideoConfereeActiveCurrentLostPackets=cVideoConfereeActiveCurrentLostPackets, cVideoConfereeActiveFastVideoUpdateRate=cVideoConfereeActiveFastVideoUpdateRate, cVideoCommonStatsActiveTxPercentLostPackets=cVideoCommonStatsActiveTxPercentLostPackets, cVideoCommonHistoryRxConfigBitrate=cVideoCommonHistoryRxConfigBitrate, cVideoSessionHistory=cVideoSessionHistory, cVideoCallActiveTxLostPackets=cVideoCallActiveTxLostPackets, cVideoCommonActiveRxCodec=cVideoCommonActiveRxCodec, cVideoCommonActiveTxPictureWidth=cVideoCommonActiveTxPictureWidth, cVideoCommonStatsHistoryRxPercentLostPackets=cVideoCommonStatsHistoryRxPercentLostPackets, cVideoCommonStatsActiveTxTotalLostPackets=cVideoCommonStatsActiveTxTotalLostPackets, cVideoCommonActiveTxDuration=cVideoCommonActiveTxDuration, cVideoCommonStatsActiveTxCurrentDelay=cVideoCommonStatsActiveTxCurrentDelay, CvcVideoProfile=CvcVideoProfile, cVideoCommonActiveTxLevel=cVideoCommonActiveTxLevel, cVideoCommonActiveTxAnnex=cVideoCommonActiveTxAnnex, cVideoCommonHistoryEntry=cVideoCommonHistoryEntry, cVideoCommonStatsActiveTxActualBitrate=cVideoCommonStatsActiveTxActualBitrate, cVideoCommonStatsActiveTxAvgDelay=cVideoCommonStatsActiveTxAvgDelay, cVideoCommonStatsActiveTxCurrentOutOfOrderPackets=cVideoCommonStatsActiveTxCurrentOutOfOrderPackets, cVideoCommonActiveTxPayloadFormat=cVideoCommonActiveTxPayloadFormat, cVideoCommonActiveTxPackets=cVideoCommonActiveTxPackets, cVideoCommonActiveRxProfile=cVideoCommonActiveRxProfile, cVideoCommonHistoryTxDuration=cVideoCommonHistoryTxDuration, cVideoCommonHistoryTxProfile=cVideoCommonHistoryTxProfile, ciscoVideoSessionMIB=ciscoVideoSessionMIB, cVideoCommonStatsHistoryTxPercentLostPackets=cVideoCommonStatsHistoryTxPercentLostPackets, cVideoCallHistoryTxFramesConcealed=cVideoCallHistoryTxFramesConcealed, cVideoCallHistoryEntry=cVideoCallHistoryEntry, cVideoCommonActiveRxConfigBitrate=cVideoCommonActiveRxConfigBitrate, cVideoSessionMIBCompliance=cVideoSessionMIBCompliance, cVideoCommonHistoryRxLevel=cVideoCommonHistoryRxLevel, cVideoConfereeActiveActualBitrate=cVideoConfereeActiveActualBitrate, cVideoCommonStatsActiveTable=cVideoCommonStatsActiveTable, CvcVoIPCallServiceType=CvcVoIPCallServiceType, cVideoCommonHistoryTable=cVideoCommonHistoryTable, cVideoCommonStatsHistoryTxTotalLostPackets=cVideoCommonStatsHistoryTxTotalLostPackets, cVideoConfereeHistoryEntry=cVideoConfereeHistoryEntry, cVideoConfereeHistoryMaxOutOfSyncDelay=cVideoConfereeHistoryMaxOutOfSyncDelay, cVideoCommonHistoryRxConfigFrameRate=cVideoCommonHistoryRxConfigFrameRate, cVideoConfereeHistoryMaxDelay=cVideoConfereeHistoryMaxDelay, cVideoCommonActiveEntry=cVideoCommonActiveEntry, cVideoCommonHistoryTxPackets=cVideoCommonHistoryTxPackets, cVideoCallHistoryTxOverflowPackets=cVideoCallHistoryTxOverflowPackets, cVideoCallActiveTxOverflowPackets=cVideoCallActiveTxOverflowPackets, cVideoCommonStatsHistoryTable=cVideoCommonStatsHistoryTable, cVideoConfereeActiveTable=cVideoConfereeActiveTable, cVideoConfereeActiveCurrentDelay=cVideoConfereeActiveCurrentDelay, cVideoSessionMIBComplianceRev1=cVideoSessionMIBComplianceRev1, cVideoSessionCallStatisticsGroup=cVideoSessionCallStatisticsGroup, cVideoCommonHistoryRxPackets=cVideoCommonHistoryRxPackets, cVideoConfereeHistoryTotalLostPackets=cVideoConfereeHistoryTotalLostPackets, cVideoCommonHistoryRxPictureWidth=cVideoCommonHistoryRxPictureWidth, cVideoConfereeActiveTotalOutOfOrderPackets=cVideoConfereeActiveTotalOutOfOrderPackets, cVideoCommonStatsActiveTxMaxDelay=cVideoCommonStatsActiveTxMaxDelay, cVideoConfereeHistoryTotalOutOfOrderPackets=cVideoConfereeHistoryTotalOutOfOrderPackets, cVideoCommonStatsActiveRxActualBitrate=cVideoCommonStatsActiveRxActualBitrate, cVideoConfereeHistoryTable=cVideoConfereeHistoryTable, cVideoCommonHistoryTxConfigBitrate=cVideoCommonHistoryTxConfigBitrate, cVideoCommonHistoryTxConfigFrameRate=cVideoCommonHistoryTxConfigFrameRate, cVideoSessionConfereeStatisticsGroup=cVideoSessionConfereeStatisticsGroup, cVideoCommonHistoryRxCodec=cVideoCommonHistoryRxCodec, cVideoConfereeActiveActualFrameRate=cVideoConfereeActiveActualFrameRate, cVideoSessionCommonStatusGroup=cVideoSessionCommonStatusGroup, cVideoCommonHistoryRxPictureHeight=cVideoCommonHistoryRxPictureHeight, cVideoCommonStatsActiveTxCurrentLostPackets=cVideoCommonStatsActiveTxCurrentLostPackets, cVideoCommonHistoryTxAnnex=cVideoCommonHistoryTxAnnex, CvcRtpPayloadFormat=CvcRtpPayloadFormat, cVideoCommonHistoryRxDuration=cVideoCommonHistoryRxDuration, cVideoConfereeActiveCurrentJitter=cVideoConfereeActiveCurrentJitter, cVideoCallActiveEntry=cVideoCallActiveEntry, cVideoCommonHistorySessionId=cVideoCommonHistorySessionId, cVideoConfereeActiveCurrentOutOfOrderPackets=cVideoConfereeActiveCurrentOutOfOrderPackets, cVideoCommonActiveRxPayloadFormat=cVideoCommonActiveRxPayloadFormat, ciscoVideoSessionMIBObjects=ciscoVideoSessionMIBObjects, cVideoCommonActiveRxConfigFrameRate=cVideoCommonActiveRxConfigFrameRate, cVideoCommonStatsHistoryTxTotalOutOfOrderPackets=cVideoCommonStatsHistoryTxTotalOutOfOrderPackets, cVideoCommonActiveCallReferenceId=cVideoCommonActiveCallReferenceId, cVideoSessionActiveGroup=cVideoSessionActiveGroup, cVideoCallActiveRxActualBitrate=cVideoCallActiveRxActualBitrate, cVideoConfereeActiveCurrentDroppedPackets=cVideoConfereeActiveCurrentDroppedPackets, cVideoCommonActiveSessionId=cVideoCommonActiveSessionId, cVideoCallHistoryTable=cVideoCallHistoryTable, cVideoCommonActiveTxConfigBitrate=cVideoCommonActiveTxConfigBitrate, cVideoCommonHistoryRxAnnex=cVideoCommonHistoryRxAnnex, CvcVideoLevel=CvcVideoLevel)
