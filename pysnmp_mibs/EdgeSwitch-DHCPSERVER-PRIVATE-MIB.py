# SNMP MIB module (EdgeSwitch-DHCPSERVER-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ubiquiti/EdgeSwitch-DHCPSERVER-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:58:59 2025
...
agentDhcpServerPoolConfigEntry.setIndexNames(
    (0, "EdgeSwitch-DHCPSERVER-PRIVATE-MIB", "agentDhcpServerPoolIndex"),
)
if mibBuilder.loadTexts:
...
agentDhcpServerExcludedAddressRangeEntry.setIndexNames(
    (0, "EdgeSwitch-DHCPSERVER-PRIVATE-MIB", "agentDhcpServerExcludedRangeIndex"),
)
if mibBuilder.loadTexts:
...
agentDhcpServerPoolOptionEntry.setIndexNames(
    (0, "EdgeSwitch-DHCPSERVER-PRIVATE-MIB", "agentDhcpServerPoolOptionIndex"),
    (0, "EdgeSwitch-DHCPSERVER-PRIVATE-MIB", "agentDhcpServerPoolOptionCode"),
)
if mibBuilder.loadTexts:
...
agentDhcpServerLeaseEntry.setIndexNames(
    (0, "EdgeSwitch-DHCPSERVER-PRIVATE-MIB", "agentDhcpServerLeaseIPAddress"),
)
if mibBuilder.loadTexts:
...
agentDhcpServerAddressConflictEntry.setIndexNames(
    (0, "EdgeSwitch-DHCPSERVER-PRIVATE-MIB", "agentDhcpServerAddressConflictIP"),
)
if mibBuilder.loadTexts:
