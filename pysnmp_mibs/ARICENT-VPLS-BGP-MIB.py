...
Bits,Counter32,Counter64,Gauge32,Integer32,IpAddress,ModuleIdentity,MibIdentifier,NotificationType,ObjectIdentity,MibScalar,MibTable,MibTableRow,MibTableColumn,TimeTicks,Unsigned32,enterprises,iso,transmission=mibBuilder.importSymbols('SNMPv2-SMI','Bits','Counter32','Counter64','Gauge32','Integer32','IpAddress','ModuleIdentity','MibIdentifier','NotificationType','ObjectIdentity','MibScalar','MibTable','MibTableRow','MibTableColumn','TimeTicks',_C,'enterprises','iso','transmission')
...
if mibBuilder.loadTexts:fsVplsBgpMIB.setRevisions(('2013-02-22 12:00',))
_VplsBgpObjects_ObjectIdentity=ObjectIdentity
vplsBgpObjects=_VplsBgpObjects_ObjectIdentity((1,3,6,1,4,1,29601,2,86,1))
_VplsBgpConfigTable_Object=MibTable
vplsBgpConfigTable=_VplsBgpConfigTable_Object((1,3,6,1,4,1,29601,2,86,1,1))
if mibBuilder.loadTexts:vplsBgpConfigTable.setStatus(_A)
_VplsBgpConfigEntry_Object=MibTableRow
vplsBgpConfigEntry=_VplsBgpConfigEntry_Object((1,3,6,1,4,1,29601,2,86,1,1,1))
...
vplsBgpConfigVERangeSize=_VplsBgpConfigVERangeSize_Object((1,3,6,1,4,1,29601,2,86,1,1,1,1),_VplsBgpConfigVERangeSize_Type())
...
vplsBgpVETable=_VplsBgpVETable_Object((1,3,6,1,4,1,29601,2,86,1,2))
if mibBuilder.loadTexts:vplsBgpVETable.setStatus(_A)
_VplsBgpVEEntry_Object=MibTableRow
vplsBgpVEEntry=_VplsBgpVEEntry_Object((1,3,6,1,4,1,29601,2,86,1,2,1))
...
vplsBgpVEId=_VplsBgpVEId_Object((1,3,6,1,4,1,29601,2,86,1,2,1,1),_VplsBgpVEId_Type())
...
vplsBgpVEName=_VplsBgpVEName_Object((1,3,6,1,4,1,29601,2,86,1,2,1,2),_VplsBgpVEName_Type())
...
vplsBgpVEPreference=_VplsBgpVEPreference_Object((1,3,6,1,4,1,29601,2,86,1,2,1,3),_VplsBgpVEPreference_Type())
...
vplsBgpVERowStatus=_VplsBgpVERowStatus_Object((1,3,6,1,4,1,29601,2,86,1,2,1,5),_VplsBgpVERowStatus_Type())
...
vplsBgpVEStorageType=_VplsBgpVEStorageType_Object((1,3,6,1,4,1,29601,2,86,1,2,1,6),_VplsBgpVEStorageType_Type())
...
vplsBgpPwBindTable=_VplsBgpPwBindTable_Object((1,3,6,1,4,1,29601,2,86,1,3))
if mibBuilder.loadTexts:vplsBgpPwBindTable.setStatus(_A)
_VplsBgpPwBindEntry_Object=MibTableRow
vplsBgpPwBindEntry=_VplsBgpPwBindEntry_Object((1,3,6,1,4,1,29601,2,86,1,3,1))
...
vplsBgpPwBindLocalVEId=_VplsBgpPwBindLocalVEId_Object((1,3,6,1,4,1,29601,2,86,1,3,1,1),_VplsBgpPwBindLocalVEId_Type())
...
vplsBgpPwBindRemoteVEId=_VplsBgpPwBindRemoteVEId_Object((1,3,6,1,4,1,29601,2,86,1,3,1,2),_VplsBgpPwBindRemoteVEId_Type())
...
vplsBgpConformance=_VplsBgpConformance_ObjectIdentity((1,3,6,1,4,1,29601,2,86,2))
_VplsBgpCompliances_ObjectIdentity=ObjectIdentity
vplsBgpCompliances=_VplsBgpCompliances_ObjectIdentity((1,3,6,1,4,1,29601,2,86,2,1))
_VplsBgpGroups_ObjectIdentity=ObjectIdentity
vplsBgpGroups=_VplsBgpGroups_ObjectIdentity((1,3,6,1,4,1,29601,2,86,2,2))
vplsBgpConfigGroup=ObjectGroup((1,3,6,1,4,1,29601,2,86,2,2,1))
vplsBgpConfigGroup.setObjects((_B,_P))
if mibBuilder.loadTexts:vplsBgpConfigGroup.setStatus(_A)
vplsBgpVEGroup=ObjectGroup((1,3,6,1,4,1,29601,2,86,2,2,2))
vplsBgpVEGroup.setObjects(*((_B,_Q),(_B,_R),(_B,_S),(_B,_T)))
if mibBuilder.loadTexts:vplsBgpVEGroup.setStatus(_A)
vplsBgpPwBindGroup=ObjectGroup((1,3,6,1,4,1,29601,2,86,2,2,3))
vplsBgpPwBindGroup.setObjects(*((_B,_U),(_B,_V)))
if mibBuilder.loadTexts:vplsBgpPwBindGroup.setStatus(_A)
vplsBgpModuleFullCompliance=ModuleCompliance((1,3,6,1,4,1,29601,2,86,2,1,1))
vplsBgpModuleFullCompliance.setObjects(*((_B,_G),(_B,_H),(_B,_I)))
if mibBuilder.loadTexts:vplsBgpModuleFullCompliance.setStatus(_A)
vplsBgpModuleReadOnlyCompliance=ModuleCompliance((1,3,6,1,4,1,29601,2,86,2,1,2))
...
mibBuilder.exportSymbols(_B,**{'fsVplsBgpMIB':fsVplsBgpMIB,'vplsBgpObjects':vplsBgpObjects,'vplsBgpConfigTable':vplsBgpConfigTable,'vplsBgpConfigEntry':vplsBgpConfigEntry,_P:vplsBgpConfigVERangeSize,'vplsBgpVETable':vplsBgpVETable,'vplsBgpVEEntry':vplsBgpVEEntry,_N:vplsBgpVEId,_Q:vplsBgpVEName,_R:vplsBgpVEPreference,_S:vplsBgpVERowStatus,_T:vplsBgpVEStorageType,'vplsBgpPwBindTable':vplsBgpPwBindTable,'vplsBgpPwBindEntry':vplsBgpPwBindEntry,_U:vplsBgpPwBindLocalVEId,_V:vplsBgpPwBindRemoteVEId,'vplsBgpConformance':vplsBgpConformance,'vplsBgpCompliances':vplsBgpCompliances,'vplsBgpModuleFullCompliance':vplsBgpModuleFullCompliance,'vplsBgpModuleReadOnlyCompliance':vplsBgpModuleReadOnlyCompliance,'vplsBgpGroups':vplsBgpGroups,_G:vplsBgpConfigGroup,_H:vplsBgpVEGroup,_I:vplsBgpPwBindGroup})