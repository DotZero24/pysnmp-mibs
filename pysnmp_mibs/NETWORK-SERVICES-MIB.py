...
mibBuilder.exportSymbols("NETWORK-SERVICES-MIB", applAccumulatedOutboundAssociations=applAccumulatedOutboundAssociations, assocRFC2248Group=assocRFC2248Group, assocCompliance=assocCompliance, applURL=applURL, assocRFC2788Compliance=assocRFC2788Compliance, applLastOutboundActivity=applLastOutboundActivity, applLastInboundActivity=applLastInboundActivity, applFailedOutboundAssociations=applFailedOutboundAssociations, assocApplicationType=assocApplicationType, applRFC1565Group=applRFC1565Group, applOutboundAssociations=applOutboundAssociations, applOperStatus=applOperStatus, assocDuration=assocDuration, applRFC2248Compliance=applRFC2248Compliance, applVersion=applVersion, assocRFC1565Group=assocRFC1565Group, applTable=applTable, applRFC2788Compliance=applRFC2788Compliance, applCompliances=applCompliances, applCompliance=applCompliance, applLastChange=applLastChange, applAccumulatedInboundAssociations=applAccumulatedInboundAssociations, applDirectoryName=applDirectoryName, applEntry=applEntry, assocTable=assocTable, applInboundAssociations=applInboundAssociations, PYSNMP_MODULE_ID=application, assocEntry=assocEntry, assocApplicationProtocol=assocApplicationProtocol, applGroups=applGroups, application=application, applRFC2248Group=applRFC2248Group, assocRemoteApplication=assocRemoteApplication, applUDPProtoID=applUDPProtoID, applDescription=applDescription, DistinguishedName=DistinguishedName, applName=applName, applConformance=applConformance, applTCPProtoID=applTCPProtoID, assocRFC2248Compliance=assocRFC2248Compliance, URLString=URLString, assocIndex=assocIndex, applRFC2788Group=applRFC2788Group, assocRFC2788Group=assocRFC2788Group, applIndex=applIndex, applRejectedInboundAssociations=applRejectedInboundAssociations, applUptime=applUptime)
