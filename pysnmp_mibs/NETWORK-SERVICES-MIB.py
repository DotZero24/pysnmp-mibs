...
# Notes
# -----
# ASN.1 source file://mibs/rfc/NETWORK-SERVICES-MIB
...
applCompliance.setObjects(
    ("NETWORK-SERVICES-MIB", "applRFC1565Group")
)
if mibBuilder.loadTexts:
...
assocCompliance.setObjects(
      *(("NETWORK-SERVICES-MIB", "applRFC1565Group"),
        ("NETWORK-SERVICES-MIB", "assocRFC1565Group"))
)
if mibBuilder.loadTexts:
...
applRFC2248Compliance.setObjects(
    ("NETWORK-SERVICES-MIB", "applRFC2248Group")
)
if mibBuilder.loadTexts:
...
assocRFC2248Compliance.setObjects(
      *(("NETWORK-SERVICES-MIB", "applRFC2248Group"),
        ("NETWORK-SERVICES-MIB", "assocRFC2248Group"))
)
if mibBuilder.loadTexts:
...
applRFC2788Compliance.setObjects(
...
assocRFC2788Compliance.setObjects(
      *(("NETWORK-SERVICES-MIB", "applRFC2788Group"),
        ("NETWORK-SERVICES-MIB", "assocRFC2788Group"))
)
if mibBuilder.loadTexts:
