...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/NETWORK-SERVICES-MIB
...
mibBuilder.exportSymbols("NETWORK-SERVICES-MIB", assocRemoteApplication=assocRemoteApplication, applRFC2788Group=applRFC2788Group, PYSNMP_MODULE_ID=application, assocRFC2248Group=assocRFC2248Group, assocTable=assocTable, applLastChange=applLastChange, applUptime=applUptime, applFailedOutboundAssociations=applFailedOutboundAssociations, assocIndex=assocIndex, applOperStatus=applOperStatus, applLastOutboundActivity=applLastOutboundActivity, applName=applName, application=application, assocCompliance=assocCompliance, DistinguishedName=DistinguishedName, applInboundAssociations=applInboundAssociations, applRejectedInboundAssociations=applRejectedInboundAssociations, applURL=applURL, assocRFC2788Group=assocRFC2788Group, applRFC2248Compliance=applRFC2248Compliance, applTCPProtoID=applTCPProtoID, applUDPProtoID=applUDPProtoID, assocRFC2248Compliance=assocRFC2248Compliance, applEntry=applEntry, applRFC1565Group=applRFC1565Group, applCompliance=applCompliance, applRFC2248Group=applRFC2248Group, applDescription=applDescription, applLastInboundActivity=applLastInboundActivity, assocDuration=assocDuration, applAccumulatedOutboundAssociations=applAccumulatedOutboundAssociations, applVersion=applVersion, applDirectoryName=applDirectoryName, applIndex=applIndex, applOutboundAssociations=applOutboundAssociations, URLString=URLString, applTable=applTable, applRFC2788Compliance=applRFC2788Compliance, assocEntry=assocEntry, applGroups=applGroups, assocRFC2788Compliance=assocRFC2788Compliance, assocApplicationProtocol=assocApplicationProtocol, applConformance=applConformance, assocApplicationType=assocApplicationType, applCompliances=applCompliances, applAccumulatedInboundAssociations=applAccumulatedInboundAssociations, assocRFC1565Group=assocRFC1565Group)
