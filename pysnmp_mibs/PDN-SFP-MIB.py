...
mibBuilder.exportSymbols("PDN-SFP-MIB", sfpReadOnlyCompliance=sfpReadOnlyCompliance, sfpMIBObjectsGroup=sfpMIBObjectsGroup, sfpIdentifier=sfpIdentifier, sfpReadWriteCompliance=sfpReadWriteCompliance, sfpNotificationsGroup=sfpNotificationsGroup, sfpCommand=sfpCommand, sfpVendorName=sfpVendorName, sfpCommandGroup=sfpCommandGroup, sfpFibreChannelTransmissionSpeed=sfpFibreChannelTransmissionSpeed, sfpCompliances=sfpCompliances, pdnSfp=pdnSfp, sfpInformationGroup=sfpInformationGroup, sfpFibreChannelLinkLength=sfpFibreChannelLinkLength, sfpVendorOUI=sfpVendorOUI, sfpVendorSN=sfpVendorSN, sfpVendorSpecificLotCode=sfpVendorSpecificLotCode, sfpConnector=sfpConnector, sfpTransceiverComplianceCodes=sfpTransceiverComplianceCodes, sfpEventGroup=sfpEventGroup, sfpEventRemoved=sfpEventRemoved, sfpEventOperational=sfpEventOperational, sfpVendorPN=sfpVendorPN, sfpEventFaulty=sfpEventFaulty, sfpGroups=sfpGroups, sfpNotificationEnable=sfpNotificationEnable, sfpInfoTable=sfpInfoTable, sfpBRMin=sfpBRMin, sfpMIBConformance=sfpMIBConformance, sfpOptions=sfpOptions, sfpLength50Mi10M=sfpLength50Mi10M, sfpVendorSpecificIdentifier=sfpVendorSpecificIdentifier, sfpCommandTable=sfpCommandTable, PYSNMP_MODULE_ID=pdnSfp, sfpVendorDate=sfpVendorDate, sfpBRNominal100Mbps=sfpBRNominal100Mbps, sfpNotificationCompliance=sfpNotificationCompliance, sfpLength9MiKm=sfpLength9MiKm, sfpCompatibleInterfaceCount=sfpCompatibleInterfaceCount, sfpBRMax=sfpBRMax, sfpStatusCurrent=sfpStatusCurrent, sfpFibreChannelTransmitterTechnology=sfpFibreChannelTransmitterTechnology, sfpLength9Mi100M=sfpLength9Mi100M, sfpEncoding=sfpEncoding, sfpNotificationsPrefix=sfpNotificationsPrefix, sfpVendorSpecificConnector=sfpVendorSpecificConnector, sfpExtIdentifier=sfpExtIdentifier, sfpLengthCopperM=sfpLengthCopperM, sfpLength62Pt5Mi10M=sfpLength62Pt5Mi10M, sfpVendorRev=sfpVendorRev, sfpLaserWavelength=sfpLaserWavelength, sfpVendorSpecificData=sfpVendorSpecificData, sfpMIBNotifications=sfpMIBNotifications, sfpInfoEntry=sfpInfoEntry, sfpEventInserted=sfpEventInserted, sfpCommandEntry=sfpCommandEntry, sfpMIBObjects=sfpMIBObjects, sfpFibreChannelTransmissionMedia=sfpFibreChannelTransmissionMedia)
