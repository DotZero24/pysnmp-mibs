...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-SFP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:00:22 2025
...
sfpReadWriteCompliance.setObjects(
      *(("PDN-SFP-MIB", "sfpCommandGroup"),
        ("PDN-SFP-MIB", "sfpNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
sfpReadOnlyCompliance.setObjects(
      *(("PDN-SFP-MIB", "sfpMIBObjectsGroup"),
        ("PDN-SFP-MIB", "sfpInformationGroup"))
)
if mibBuilder.loadTexts:
...
sfpNotificationCompliance.setObjects(
    ("PDN-SFP-MIB", "sfpEventGroup")
)
if mibBuilder.loadTexts:
