#
# PySNMP MIB module IANA-PWE3-R-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rad/IANA-PWE3-R-MIB
...
ianaPwe3MIBR.setRevisions(('2007-02-04 12:00',))
if mibBuilder.loadTexts: ianaPwe3MIBR.setLastUpdated('200702041200Z')
if mibBuilder.loadTexts: ianaPwe3MIBR.setOrganization('IANA')
...
mibBuilder.exportSymbols("IANA-PWE3-R-MIB", IANAPwTypeTC=IANAPwTypeTC, radExperimental=radExperimental, IANAPwCapabilities=IANAPwCapabilities, IANAPwPsnTypeTC=IANAPwPsnTypeTC, PYSNMP_MODULE_ID=ianaPwe3MIBR, ianaPwe3MIBR=ianaPwe3MIBR)
