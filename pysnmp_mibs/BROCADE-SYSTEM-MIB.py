# SNMP MIB module (BROCADE-SYSTEM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/brocade/BROCADE-SYSTEM-MIB
...
swSensorEntry.setIndexNames(
    (0, "BROCADE-SYSTEM-MIB", "swSensorIndex"),
)
if mibBuilder.loadTexts:
...
swFCPortEntry.setIndexNames(
    (0, "BROCADE-SYSTEM-MIB", "swFCPortIndex"),
)
if mibBuilder.loadTexts:
...
swEventEntry.setIndexNames(
    (0, "BROCADE-SYSTEM-MIB", "swEventIndex"),
)
if mibBuilder.loadTexts:
...
swFCPortScn.setObjects(
      *(("BROCADE-SYSTEM-MIB", "swFCPortOpStatus"),
        ("BROCADE-SYSTEM-MIB", "swFCPortIndex"),
        ("BROCADE-SYSTEM-MIB", "swFCPortName"),
        ("BROCADE-SYSTEM-MIB", "swSsn"),
        ("BROCADE-SYSTEM-MIB", "swFCPortFlag"),
        ("BROCADE-SYSTEM-MIB", "swVfId"))
)
if mibBuilder.loadTexts:
...
swEventTrap.setObjects(
      *(("BROCADE-SYSTEM-MIB", "swEventIndex"),
        ("BROCADE-SYSTEM-MIB", "swEventTimeInfo"),
        ("BROCADE-SYSTEM-MIB", "swEventLevel"),
        ("BROCADE-SYSTEM-MIB", "swEventRepeatCount"),
        ("BROCADE-SYSTEM-MIB", "swEventDescr"),
        ("BROCADE-SYSTEM-MIB", "swSsn"),
        ("BROCADE-SYSTEM-MIB", "swVfId"))
)
if mibBuilder.loadTexts:
...
swStateChangeTrap.setObjects(
      *(("BROCADE-SYSTEM-MIB", "swOperStatus"),
        ("BROCADE-SYSTEM-MIB", "swVfId"))
)
if mibBuilder.loadTexts:
