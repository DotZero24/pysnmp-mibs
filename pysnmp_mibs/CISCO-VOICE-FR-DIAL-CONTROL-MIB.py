...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:28:57 2025
...
mibBuilder.exportSymbols("CISCO-VOICE-FR-DIAL-CONTROL-MIB", PYSNMP_MODULE_ID=ciscoVoiceFrDialControlMIB, cvfrdcMIBConformance=cvfrdcMIBConformance, cvFrCallHistoryTable=cvFrCallHistoryTable, cvFrCallHistorySessionTarget=cvFrCallHistorySessionTarget, cvFrCallHistoryLowerIfName=cvFrCallHistoryLowerIfName, cvFrCallHistory=cvFrCallHistory, cvFrCallHistoryConnectionId=cvFrCallHistoryConnectionId, cvFrCallHistoryDlci=cvFrCallHistoryDlci, cvfrdcMIBCompliances=cvfrdcMIBCompliances, ciscoVoiceFrDialControlMIB=ciscoVoiceFrDialControlMIB, cvfrdcMIBGroups=cvfrdcMIBGroups, cvfrdcMIBObjects=cvfrdcMIBObjects, cvFrCallHistoryGroup=cvFrCallHistoryGroup, cvFrCallHistoryEntry=cvFrCallHistoryEntry, cvfrdcMIBCompliance=cvfrdcMIBCompliance)
