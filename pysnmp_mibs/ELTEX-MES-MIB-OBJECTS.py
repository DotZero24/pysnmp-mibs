...
mibBuilder.exportSymbols("ELTEX-MES-MIB-OBJECTS", eltIfLongDescr=eltIfLongDescr, eltIfExtTable=eltIfExtTable, eltIfExtEntry=eltIfExtEntry, eltIfUpDownTrapEnable=eltIfUpDownTrapEnable, eltIfAdminMtu=eltIfAdminMtu)
