...
_G='rndErrorDesc'
_F='Integer32'
_E='NETGEAR-RADLAN-Physicaldescription-old-MIB'
_D='read-write'
_C='NETGEAR-RADLAN-DEVICEPARAMS-MIB'
_B='read-only'
_A='current'
...
rlPhdUnitGenParamCpldVersion=_RlPhdUnitGenParamCpldVersion_Object((1,3,6,1,4,1,4526,17,53,14,1,15),_RlPhdUnitGenParamCpldVersion_Type())
...
rlPhdUnitEnvParamTempSensorValue=_RlPhdUnitEnvParamTempSensorValue_Object((1,3,6,1,4,1,4526,17,53,15,1,9),_RlPhdUnitEnvParamTempSensorValue_Type())
...
rlPhdUnitEnvParamTempSensorStatus=_RlPhdUnitEnvParamTempSensorStatus_Object((1,3,6,1,4,1,4526,17,53,15,1,10),_RlPhdUnitEnvParamTempSensorStatus_Type())
...
rlPhdUnitEnvParamUpTime=_RlPhdUnitEnvParamUpTime_Object((1,3,6,1,4,1,4526,17,53,15,1,11),_RlPhdUnitEnvParamUpTime_Type())
...
rlPhdUnitEnvParamTempSensor2Value=_RlPhdUnitEnvParamTempSensor2Value_Object((1,3,6,1,4,1,4526,17,53,15,1,12),_RlPhdUnitEnvParamTempSensor2Value_Type())
...
rlPhdUnitEnvParamTempSensor2Status=_RlPhdUnitEnvParamTempSensor2Status_Object((1,3,6,1,4,1,4526,17,53,15,1,13),_RlPhdUnitEnvParamTempSensor2Status_Type())
...
rlPhdUnitEnvParamTempSensor3Value=_RlPhdUnitEnvParamTempSensor3Value_Object((1,3,6,1,4,1,4526,17,53,15,1,14),_RlPhdUnitEnvParamTempSensor3Value_Type())
...
rlPhdUnitEnvParamTempSensor3Status=_RlPhdUnitEnvParamTempSensor3Status_Object((1,3,6,1,4,1,4526,17,53,15,1,15),_RlPhdUnitEnvParamTempSensor3Status_Type())
...
rlPhdUnitEnvParamTempSensor4Value=_RlPhdUnitEnvParamTempSensor4Value_Object((1,3,6,1,4,1,4526,17,53,15,1,16),_RlPhdUnitEnvParamTempSensor4Value_Type())
...
rlPhdUnitEnvParamTempSensor4Status=_RlPhdUnitEnvParamTempSensor4Status_Object((1,3,6,1,4,1,4526,17,53,15,1,17),_RlPhdUnitEnvParamTempSensor4Status_Type())
...
rlPhdUnitEnvParamTempSensor5Value=_RlPhdUnitEnvParamTempSensor5Value_Object((1,3,6,1,4,1,4526,17,53,15,1,18),_RlPhdUnitEnvParamTempSensor5Value_Type())
...
rlPhdUnitEnvParamTempSensor5Status=_RlPhdUnitEnvParamTempSensor5Status_Object((1,3,6,1,4,1,4526,17,53,15,1,19),_RlPhdUnitEnvParamTempSensor5Status_Type())
...
rlCascadeAfterResetTable=_RlCascadeAfterResetTable_Object((1,3,6,1,4,1,4526,17,53,24))
if mibBuilder.loadTexts:rlCascadeAfterResetTable.setStatus(_A)
_RlCascadeAfterResetEntry_Object=MibTableRow
rlCascadeAfterResetEntry=_RlCascadeAfterResetEntry_Object((1,3,6,1,4,1,4526,17,53,24,1))
...
rlCascadeIfIndexAfterReset=_RlCascadeIfIndexAfterReset_Object((1,3,6,1,4,1,4526,17,53,24,1,1),_RlCascadeIfIndexAfterReset_Type())
...
rlCascadeTrunkIdAfterReset=_RlCascadeTrunkIdAfterReset_Object((1,3,6,1,4,1,4526,17,53,24,1,2),_RlCascadeTrunkIdAfterReset_Type())
...
rlCascadeRowStatus=_RlCascadeRowStatus_Object((1,3,6,1,4,1,4526,17,53,24,1,3),_RlCascadeRowStatus_Type())
