...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SANTAP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:54 2025
...
_CstDVTLunSizeHandling_Type.__name__ = "TruthValue"
...
ciscoSanTapMIBCompliance.setObjects(
    ("CISCO-SANTAP-MIB", "ciscoSanTapServiceConfigGroup")
)
if mibBuilder.loadTexts:
...
ciscoSanTapMIBComplianceRev1.setObjects(
      *(("CISCO-SANTAP-MIB", "ciscoSanTapServiceConfigGroupRev1"),
        ("CISCO-SANTAP-MIB", "ciscoSanTapDVTConfigGroup"))
)
if mibBuilder.loadTexts:
...
ciscoSanTapMIBComplianceRev2.setObjects(
      *(("CISCO-SANTAP-MIB", "ciscoSanTapServiceConfigGroupRev1"),
        ("CISCO-SANTAP-MIB", "ciscoSanTapDVTConfigGroup1"))
)
if mibBuilder.loadTexts:
