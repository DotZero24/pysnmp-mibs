...
h3cL2IsolateObject=_H3cL2IsolateObject_ObjectIdentity((1,3,6,1,4,1,2011,10,2,103,1))
_H3cL2IsolateEnableTable_Object=MibTable
h3cL2IsolateEnableTable=_H3cL2IsolateEnableTable_Object((1,3,6,1,4,1,2011,10,2,103,1,1))
if mibBuilder.loadTexts:h3cL2IsolateEnableTable.setStatus(_A)
_H3cL2IsolateEnableEntry_Object=MibTableRow
h3cL2IsolateEnableEntry=_H3cL2IsolateEnableEntry_Object((1,3,6,1,4,1,2011,10,2,103,1,1,1))
...
h3cL2IsolateVLANIndex=_H3cL2IsolateVLANIndex_Object((1,3,6,1,4,1,2011,10,2,103,1,1,1,1),_H3cL2IsolateVLANIndex_Type())
...
h3cL2IsolateEnable=_H3cL2IsolateEnable_Object((1,3,6,1,4,1,2011,10,2,103,1,1,1,2),_H3cL2IsolateEnable_Type())
...
h3cL2IsolatePermitMACTable=_H3cL2IsolatePermitMACTable_Object((1,3,6,1,4,1,2011,10,2,103,1,2))
if mibBuilder.loadTexts:h3cL2IsolatePermitMACTable.setStatus(_A)
_H3cL2IsolatePermitMACEntry_Object=MibTableRow
h3cL2IsolatePermitMACEntry=_H3cL2IsolatePermitMACEntry_Object((1,3,6,1,4,1,2011,10,2,103,1,2,1))
...
h3cL2IsoLatePermitMAC=_H3cL2IsoLatePermitMAC_Object((1,3,6,1,4,1,2011,10,2,103,1,2,1,1),_H3cL2IsoLatePermitMAC_Type())
...
h3cL2IsoLatePermitMACRowStatus=_H3cL2IsoLatePermitMACRowStatus_Object((1,3,6,1,4,1,2011,10,2,103,1,2,1,2),_H3cL2IsoLatePermitMACRowStatus_Type())
