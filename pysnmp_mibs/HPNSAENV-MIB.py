...
mibBuilder.exportSymbols("HPNSAENV-MIB", hpnsaEnvTemperatureSensorType=hpnsaEnvTemperatureSensorType, hpnsaEnvFanSensorTable=hpnsaEnvFanSensorTable, hpnsaEnvFanSensorNominalReading=hpnsaEnvFanSensorNominalReading, hpnsaEnvFanSensorLowerCriticalThreshold=hpnsaEnvFanSensorLowerCriticalThreshold, hpnsaEnvTemperatureSensorUpperCriticalThreshold=hpnsaEnvTemperatureSensorUpperCriticalThreshold, hp=hp, hpnsaEnvVoltageSensorTolerance=hpnsaEnvVoltageSensorTolerance, hpnsaEnvFanSensorLocation=hpnsaEnvFanSensorLocation, hpnsaEnvFanSensorNegativeHysterisis=hpnsaEnvFanSensorNegativeHysterisis, hpnsaEnvVoltageSensorMaximum=hpnsaEnvVoltageSensorMaximum, hpnsaEnvTemperatureSensorNormalMinimum=hpnsaEnvTemperatureSensorNormalMinimum, hpnsaEnvFanSensorNormalMinimum=hpnsaEnvFanSensorNormalMinimum, hpnsaEnvVoltageData=hpnsaEnvVoltageData, hpnsaEnvTemperatureSensorDescription=hpnsaEnvTemperatureSensorDescription, hpnsaEnvFanSensorIndex=hpnsaEnvFanSensorIndex, hpnsaEnvTemperatureSensorNormalMaximum=hpnsaEnvTemperatureSensorNormalMaximum, hpnsaEnvVoltageSensorNominalLevel=hpnsaEnvVoltageSensorNominalLevel, hpnsaEnvFanSensorPositiveHysterisis=hpnsaEnvFanSensorPositiveHysterisis, hpnsaEnvVoltageSensorLevel=hpnsaEnvVoltageSensorLevel, hpnsaEnvVoltageSensorAccuracy=hpnsaEnvVoltageSensorAccuracy, hpnsaEnvFanSensorType=hpnsaEnvFanSensorType, hpnsaEnvVoltageSensorType=hpnsaEnvVoltageSensorType, nm=nm, hpnsaEnvironment=hpnsaEnvironment, hpnsaEnvChassisStatus=hpnsaEnvChassisStatus, hpnsaEnvFanSensorReading=hpnsaEnvFanSensorReading, hpnsaEnvVoltageSensorLowerNonCriticalThreshold=hpnsaEnvVoltageSensorLowerNonCriticalThreshold, hpnsaEnvTemperatureSensorNegativeHysterisis=hpnsaEnvTemperatureSensorNegativeHysterisis, hpnsaEnvTemperatureData=hpnsaEnvTemperatureData, hpnsaEnvVoltageSensorLowerCriticalThreshold=hpnsaEnvVoltageSensorLowerCriticalThreshold, hpnsaEnvFanSensorNormalMaximum=hpnsaEnvFanSensorNormalMaximum, hpnsaEnvFanSensorLowerNonCriticalThreshold=hpnsaEnvFanSensorLowerNonCriticalThreshold, hpnsaEnvFanSensorDescription=hpnsaEnvFanSensorDescription, hpnsaEnvVoltageSensorResolution=hpnsaEnvVoltageSensorResolution, hpnsaEnvVoltageSensorEntry=hpnsaEnvVoltageSensorEntry, hpnsaEnvTemperatureSensorMaximum=hpnsaEnvTemperatureSensorMaximum, hpnsaEnvTemperatureSensorLowerNonCriticalThreshold=hpnsaEnvTemperatureSensorLowerNonCriticalThreshold, hpnsaEnvFanSensorUpperNonRecoverableThreshold=hpnsaEnvFanSensorUpperNonRecoverableThreshold, hpnsaEnvTemperatureSensorMinimum=hpnsaEnvTemperatureSensorMinimum, hpnsaEnvFanSensorEntry=hpnsaEnvFanSensorEntry, hpnsaEnvVoltageSensorPositiveHysterisis=hpnsaEnvVoltageSensorPositiveHysterisis, hpnsaEnvChassisData=hpnsaEnvChassisData, hpnsaEnvTemperatureSensorNominalReading=hpnsaEnvTemperatureSensorNominalReading, hpnsaEnvFanSensorMinimum=hpnsaEnvFanSensorMinimum, hpnsaEnvMibRevMinor=hpnsaEnvMibRevMinor, hpnsaEnvVoltageSensorIndex=hpnsaEnvVoltageSensorIndex, hpnsaEnvVoltageSensorNegativeHysterisis=hpnsaEnvVoltageSensorNegativeHysterisis, hpnsaEnvTemperatureSensorLowerNonRecoverableThreshold=hpnsaEnvTemperatureSensorLowerNonRecoverableThreshold, hpnsaEnvVoltageSensorNormalMaximum=hpnsaEnvVoltageSensorNormalMaximum, hpnsaEnvVoltageSensorDescription=hpnsaEnvVoltageSensorDescription, hpnsaEnvVoltageSensorLowerNonRecoverableThreshold=hpnsaEnvVoltageSensorLowerNonRecoverableThreshold, hpnsaEnvVoltageSensorMinimum=hpnsaEnvVoltageSensorMinimum, hpnsa=hpnsa, hpnsaEnvVoltageSensorNormalMinimum=hpnsaEnvVoltageSensorNormalMinimum, hpnsaEnvVoltageSensorUpperCriticalThreshold=hpnsaEnvVoltageSensorUpperCriticalThreshold, hpnsaEnvVoltageSensorUpperNonRecoverableThreshold=hpnsaEnvVoltageSensorUpperNonRecoverableThreshold, hpnsaEnvFanSensorStatus=hpnsaEnvFanSensorStatus, hpnsaEnvTemperatureSensorPositiveHysterisis=hpnsaEnvTemperatureSensorPositiveHysterisis, hpnsaEnvMibRevMajor=hpnsaEnvMibRevMajor, hpnsaEnvFanSensorResolution=hpnsaEnvFanSensorResolution, hpnsaEnvVoltageSensorLocation=hpnsaEnvVoltageSensorLocation, hpnsaEnvVoltageSensorTable=hpnsaEnvVoltageSensorTable, hpnsaEnvTemperatureSensorUpperNonCriticalThreshold=hpnsaEnvTemperatureSensorUpperNonCriticalThreshold, hpnsaEnvFanSensorAccuracy=hpnsaEnvFanSensorAccuracy, hpnsaEnvTemperatureSensorAccuracy=hpnsaEnvTemperatureSensorAccuracy, hpnsaEnvVoltageSensorUpperNonCriticalThreshold=hpnsaEnvVoltageSensorUpperNonCriticalThreshold, hpnsaEnvFanSensorUpperCriticalThreshold=hpnsaEnvFanSensorUpperCriticalThreshold, hpnsaEnvFanSensorMaximum=hpnsaEnvFanSensorMaximum, hpnsaEnvTemperatureSensorLowerCriticalThreshold=hpnsaEnvTemperatureSensorLowerCriticalThreshold, hpnsaEnvFanSensorData=hpnsaEnvFanSensorData, hpnsaEnvTemperatureSensorEntry=hpnsaEnvTemperatureSensorEntry, hpnsaEnvTemperatureSensorReading=hpnsaEnvTemperatureSensorReading, hpnsaEnvTemperatureSensorTable=hpnsaEnvTemperatureSensorTable, hpnsaEnvFanSensorLowerNonRecoverableThreshold=hpnsaEnvFanSensorLowerNonRecoverableThreshold, hpnsaEnvFanSensorUpperNonCriticalThreshold=hpnsaEnvFanSensorUpperNonCriticalThreshold, hpnsaEnvTemperatureSensorResolution=hpnsaEnvTemperatureSensorResolution, hpnsaEnvFanSensorTolerance=hpnsaEnvFanSensorTolerance, hpnsaEnvTemperatureSensorStatus=hpnsaEnvTemperatureSensorStatus, hpnsaEnvTemperatureSensorIndex=hpnsaEnvTemperatureSensorIndex, hpnsaEnvTemperatureSensorUpperNonRecoverableThreshold=hpnsaEnvTemperatureSensorUpperNonRecoverableThreshold, hpnsaEnvTemperatureSensorLocation=hpnsaEnvTemperatureSensorLocation, hpnsaEnvTemperatureSensorTolerance=hpnsaEnvTemperatureSensorTolerance, hpnsaEnvVoltageSensorStatus=hpnsaEnvVoltageSensorStatus, hpnsaEnvMibRev=hpnsaEnvMibRev)
