...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-EPSC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:21 2025
...
rbnEpscMIBCompliance.setObjects(
      *(("RBN-EPSC-MIB", "rbnEpscCommonGeneralGroup"),
        ("RBN-EPSC-MIB", "rbnEpscCommonChargingGroup"),
        ("RBN-EPSC-MIB", "rbnEpscSgwGeneralGroup"),
        ("RBN-EPSC-MIB", "rbnEpscSgwS5S8GtpGroup"),
        ("RBN-EPSC-MIB", "rbnEpscSgwS11S4Group"),
        ("RBN-EPSC-MIB", "rbnEpscSgwChargingGroup"),
        ("RBN-EPSC-MIB", "rbnEpscPgwChargingGroup"),
        ("RBN-EPSC-MIB", "rbnEpscPgwGxGroup"),
        ("RBN-EPSC-MIB", "rbnEpscPgwGnGpGroup"),
        ("RBN-EPSC-MIB", "rbnEpscPgwS5S8GtpGroup"),
        ("RBN-EPSC-MIB", "rbnEpscPgwGyGroup"),
        ("RBN-EPSC-MIB", "rbnEpscPgwS2aPmipGroup"),
        ("RBN-EPSC-MIB", "rbnEpscPgwS6bGroup"),
