...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-IKE-MONITOR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:18:22 2025
...
h3cIKETunIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    h3cIKETunLocalAddr.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    h3cIKETunRemoteAddr.setStatus("deprecated")
...
_H3cIKETunLocalInetAddrType_Type = InetAddressType
_H3cIKETunLocalInetAddrType_Object = MibTableColumn
h3cIKETunLocalInetAddrType = _H3cIKETunLocalInetAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 30, 1, 1, 1, 23),
    _H3cIKETunLocalInetAddrType_Type()
)
h3cIKETunLocalInetAddrType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cIKETunLocalInetAddrType.setStatus("current")
_H3cIKETunLocalInetAddr_Type = InetAddress
_H3cIKETunLocalInetAddr_Object = MibTableColumn
h3cIKETunLocalInetAddr = _H3cIKETunLocalInetAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 30, 1, 1, 1, 24),
    _H3cIKETunLocalInetAddr_Type()
)
h3cIKETunLocalInetAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cIKETunLocalInetAddr.setStatus("current")
_H3cIKETunRemoteInetAddrType_Type = InetAddressType
_H3cIKETunRemoteInetAddrType_Object = MibTableColumn
h3cIKETunRemoteInetAddrType = _H3cIKETunRemoteInetAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 30, 1, 1, 1, 25),
    _H3cIKETunRemoteInetAddrType_Type()
)
h3cIKETunRemoteInetAddrType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cIKETunRemoteInetAddrType.setStatus("current")
_H3cIKETunRemoteInetAddr_Type = InetAddress
_H3cIKETunRemoteInetAddr_Object = MibTableColumn
h3cIKETunRemoteInetAddr = _H3cIKETunRemoteInetAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 30, 1, 1, 1, 26),
    _H3cIKETunRemoteInetAddr_Type()
)
h3cIKETunRemoteInetAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cIKETunRemoteInetAddr.setStatus("current")
...
_H3cIKEScalarObjects_ObjectIdentity = ObjectIdentity
h3cIKEScalarObjects = _H3cIKEScalarObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 30, 1, 7)
)
_H3cIKEMIBVersion_Type = DisplayString
_H3cIKEMIBVersion_Object = MibScalar
h3cIKEMIBVersion = _H3cIKEMIBVersion_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 30, 1, 7, 1),
    _H3cIKEMIBVersion_Type()
)
h3cIKEMIBVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cIKEMIBVersion.setStatus("current")
...
h3cIKETunnelTableGroup.setObjects(
      *(("H3C-IKE-MONITOR-MIB", "h3cIKETunLocalType"),
        ...
        ("H3C-IKE-MONITOR-MIB", "h3cIKETunLocalInetAddrType"),
        ("H3C-IKE-MONITOR-MIB", "h3cIKETunLocalInetAddr"),
        ("H3C-IKE-MONITOR-MIB", "h3cIKETunRemoteInetAddrType"),
        ("H3C-IKE-MONITOR-MIB", "h3cIKETunRemoteInetAddr"))
)
if mibBuilder.loadTexts:
...
h3cIKEScalarObjectsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 30, 2, 2, 7)
)
h3cIKEScalarObjectsGroup.setObjects(
    ("H3C-IKE-MONITOR-MIB", "h3cIKEMIBVersion")
)
if mibBuilder.loadTexts:
    h3cIKEScalarObjectsGroup.setStatus("current")
...
h3cIKECompliance.setObjects(
      *(("H3C-IKE-MONITOR-MIB", "h3cIKETunnelTableGroup"),
        ...
        ("H3C-IKE-MONITOR-MIB", "h3cIKEGlobalStatsGroup"),
        ("H3C-IKE-MONITOR-MIB", "h3cIKETrapObjectGroup"),
        ("H3C-IKE-MONITOR-MIB", "h3cIKETrapCntlGroup"),
        ("H3C-IKE-MONITOR-MIB", "h3cIKETrapGroup"),
        ("H3C-IKE-MONITOR-MIB", "h3cIKEScalarObjectsGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"H3cIKENegoMode": H3cIKENegoMode,
       ...
       "h3cIKETunLocalInetAddrType": h3cIKETunLocalInetAddrType,
       "h3cIKETunLocalInetAddr": h3cIKETunLocalInetAddr,
       "h3cIKETunRemoteInetAddrType": h3cIKETunRemoteInetAddrType,
       "h3cIKETunRemoteInetAddr": h3cIKETunRemoteInetAddr,
       ...
       "h3cIKEScalarObjects": h3cIKEScalarObjects,
       "h3cIKEMIBVersion": h3cIKEMIBVersion,
       ...
       "h3cIKEScalarObjectsGroup": h3cIKEScalarObjectsGroup}
)
