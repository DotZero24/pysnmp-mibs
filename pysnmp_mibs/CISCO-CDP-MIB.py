...
mibBuilder.exportSymbols("CISCO-CDP-MIB", PYSNMP_MODULE_ID=ciscoCdpMIB, cdpCacheDeviceIndex=cdpCacheDeviceIndex, ciscoCdpV2MIBGroup=ciscoCdpV2MIBGroup, cdpInterfaceTable=cdpInterfaceTable, ciscoCdpMIBComplianceV11R02=ciscoCdpMIBComplianceV11R02, ciscoCdpMIBGroup=ciscoCdpMIBGroup, ciscoCdpMIB=ciscoCdpMIB, ciscoCdpMIBGroupV12R03=ciscoCdpMIBGroupV12R03, cdpInterfaceExtTable=cdpInterfaceExtTable, ciscoCdpMIBCompliance=ciscoCdpMIBCompliance, cdpCtAddressEntry=cdpCtAddressEntry, ciscoCdpMIBComplianceV11R01=ciscoCdpMIBComplianceV11R01, cdpCacheLastChange=cdpCacheLastChange, cdpInterfaceMessageInterval=cdpInterfaceMessageInterval, cdpCacheAddress=cdpCacheAddress, cdpCacheVTPMgmtDomain=cdpCacheVTPMgmtDomain, cdpCacheTable=cdpCacheTable, cdpCacheCapabilities=cdpCacheCapabilities, ciscoCdpMIBObjects=ciscoCdpMIBObjects, cdpCtAddressTable=cdpCtAddressTable, ciscoCdpMIBGroupV11R01=ciscoCdpMIBGroupV11R01, cdpGlobalDeviceId=cdpGlobalDeviceId, cdpGlobalLastChange=cdpGlobalLastChange, cdpCacheVlanID=cdpCacheVlanID, cdpInterfaceName=cdpInterfaceName, cdpInterfaceIfIndex=cdpInterfaceIfIndex, cdpInterfacePort=cdpInterfacePort, cdpInterfaceExtendedTrust=cdpInterfaceExtendedTrust, cdpCacheSysObjectID=cdpCacheSysObjectID, cdpCache=cdpCache, cdpCachePrimaryMgmtAddrType=cdpCachePrimaryMgmtAddrType, ciscoCdpMIBCompliances=ciscoCdpMIBCompliances, cdpCacheNativeVLAN=cdpCacheNativeVLAN, ciscoCdpMIBGroups=ciscoCdpMIBGroups, ciscoCdpMIBComplianceV12R03=ciscoCdpMIBComplianceV12R03, cdpGlobal=cdpGlobal, cdpInterfaceExtEntry=cdpInterfaceExtEntry, cdpInterface=cdpInterface, cdpCtAddressIndex=cdpCtAddressIndex, ciscoCdpCtAddressGroup=ciscoCdpCtAddressGroup, cdpCachePlatform=cdpCachePlatform, cdpInterfaceCosForUntrustedPort=cdpInterfaceCosForUntrustedPort, cdpGlobalHoldTime=cdpGlobalHoldTime, cdpCacheMTU=cdpCacheMTU, cdpCacheSecondaryMgmtAddr=cdpCacheSecondaryMgmtAddr, cdpGlobalDeviceIdFormatCpb=cdpGlobalDeviceIdFormatCpb, cdpCacheSecondaryMgmtAddrType=cdpCacheSecondaryMgmtAddrType, ciscoCdpMIBComplianceV12R02=ciscoCdpMIBComplianceV12R02, cdpGlobalRun=cdpGlobalRun, cdpGlobalMessageInterval=cdpGlobalMessageInterval, cdpCachePrimaryMgmtAddr=cdpCachePrimaryMgmtAddr, cdpCacheAddressType=cdpCacheAddressType, cdpCacheIfIndex=cdpCacheIfIndex, cdpCacheVersion=cdpCacheVersion, ciscoCdpMIBGroupV12R02=ciscoCdpMIBGroupV12R02, cdpCacheDuplex=cdpCacheDuplex, ciscoCdpMIBConformance=ciscoCdpMIBConformance, cdpCachePhysLocation=cdpCachePhysLocation, cdpCtAddressType=cdpCtAddressType, cdpCacheApplianceID=cdpCacheApplianceID, cdpInterfaceEntry=cdpInterfaceEntry, cdpCacheDevicePort=cdpCacheDevicePort, cdpCacheSysName=cdpCacheSysName, ciscoCdpMIBCompliance5=ciscoCdpMIBCompliance5, ciscoCdpMIBGroupV11R02=ciscoCdpMIBGroupV11R02, cdpCacheEntry=cdpCacheEntry, ciscoCdpV2IfExtGroup=ciscoCdpV2IfExtGroup, cdpInterfaceGroup=cdpInterfaceGroup, cdpCachePowerConsumption=cdpCachePowerConsumption, cdpCtAddress=cdpCtAddress, cdpInterfaceEnable=cdpInterfaceEnable, cdpCacheDeviceId=cdpCacheDeviceId, cdpGlobalDeviceIdFormat=cdpGlobalDeviceIdFormat)
