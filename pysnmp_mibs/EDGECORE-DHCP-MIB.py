...
DisplayString,PhysAddress,RowStatus,TextualConvention,TruthValue=mibBuilder.importSymbols('SNMPv2-TC',_D,'PhysAddress','RowStatus','TextualConvention',_I)
...
rsDhcpMibVersion=_RsDhcpMibVersion_Object((1,3,6,1,4,1,259,10,1,14,89,38,14),_RsDhcpMibVersion_Type())
...
rlDhcpRelayEnable=_RlDhcpRelayEnable_Object((1,3,6,1,4,1,259,10,1,14,89,38,25),_RlDhcpRelayEnable_Type())
...
rlDhcpRelayExists=_RlDhcpRelayExists_Object((1,3,6,1,4,1,259,10,1,14,89,38,26),_RlDhcpRelayExists_Type())
...
rlDhcpRelayNextServerTable=_RlDhcpRelayNextServerTable_Object((1,3,6,1,4,1,259,10,1,14,89,38,27))
if mibBuilder.loadTexts:rlDhcpRelayNextServerTable.setStatus(_A)
_RlDhcpRelayNextServerEntry_Object=MibTableRow
rlDhcpRelayNextServerEntry=_RlDhcpRelayNextServerEntry_Object((1,3,6,1,4,1,259,10,1,14,89,38,27,1))
...
rlDhcpRelayNextServerIpAddr=_RlDhcpRelayNextServerIpAddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,27,1,1),_RlDhcpRelayNextServerIpAddr_Type())
...
rlDhcpRelayNextServerSecThreshold=_RlDhcpRelayNextServerSecThreshold_Object((1,3,6,1,4,1,259,10,1,14,89,38,27,1,2),_RlDhcpRelayNextServerSecThreshold_Type())
...
rlDhcpRelayNextServerRowStatus=_RlDhcpRelayNextServerRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,38,27,1,3),_RlDhcpRelayNextServerRowStatus_Type())
...
rlDhcpRelayInterfaceTable=_RlDhcpRelayInterfaceTable_Object((1,3,6,1,4,1,259,10,1,14,89,38,28))
if mibBuilder.loadTexts:rlDhcpRelayInterfaceTable.setStatus(_A)
_RlDhcpRelayInterfaceEntry_Object=MibTableRow
rlDhcpRelayInterfaceEntry=_RlDhcpRelayInterfaceEntry_Object((1,3,6,1,4,1,259,10,1,14,89,38,28,1))
...
rlDhcpRelayInterfaceIfindex=_RlDhcpRelayInterfaceIfindex_Object((1,3,6,1,4,1,259,10,1,14,89,38,28,1,1),_RlDhcpRelayInterfaceIfindex_Type())
...
rlDhcpRelayInterfaceUseGiaddr=_RlDhcpRelayInterfaceUseGiaddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,28,1,2),_RlDhcpRelayInterfaceUseGiaddr_Type())
...
rlDhcpRelayInterfaceRowStatus=_RlDhcpRelayInterfaceRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,38,28,1,3),_RlDhcpRelayInterfaceRowStatus_Type())
...
rlDhcpRelayInterfaceListTable=_RlDhcpRelayInterfaceListTable_Object((1,3,6,1,4,1,259,10,1,14,89,38,29))
if mibBuilder.loadTexts:rlDhcpRelayInterfaceListTable.setStatus(_A)
_RlDhcpRelayInterfaceListEntry_Object=MibTableRow
rlDhcpRelayInterfaceListEntry=_RlDhcpRelayInterfaceListEntry_Object((1,3,6,1,4,1,259,10,1,14,89,38,29,1))
...
rlDhcpRelayInterfaceListIndex=_RlDhcpRelayInterfaceListIndex_Object((1,3,6,1,4,1,259,10,1,14,89,38,29,1,1),_RlDhcpRelayInterfaceListIndex_Type())
...
rlDhcpRelayInterfaceListPortList=_RlDhcpRelayInterfaceListPortList_Object((1,3,6,1,4,1,259,10,1,14,89,38,29,1,2),_RlDhcpRelayInterfaceListPortList_Type())
rlDhcpRelayInterfaceListPortList.setMaxAccess(_B)
if mibBuilder.loadTexts:rlDhcpRelayInterfaceListPortList.setStatus(_A)
class _RlDhcpRelayInterfaceListVlanId1To1024_Type(OctetString):subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,128))
_RlDhcpRelayInterfaceListVlanId1To1024_Type.__name__=_F
_RlDhcpRelayInterfaceListVlanId1To1024_Object=MibTableColumn
rlDhcpRelayInterfaceListVlanId1To1024=_RlDhcpRelayInterfaceListVlanId1To1024_Object((1,3,6,1,4,1,259,10,1,14,89,38,29,1,3),_RlDhcpRelayInterfaceListVlanId1To1024_Type())
...
class _RlDhcpRelayInterfaceListVlanId1025To2048_Type(OctetString):subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,128))
_RlDhcpRelayInterfaceListVlanId1025To2048_Type.__name__=_F
_RlDhcpRelayInterfaceListVlanId1025To2048_Object=MibTableColumn
rlDhcpRelayInterfaceListVlanId1025To2048=_RlDhcpRelayInterfaceListVlanId1025To2048_Object((1,3,6,1,4,1,259,10,1,14,89,38,29,1,4),_RlDhcpRelayInterfaceListVlanId1025To2048_Type())
...
class _RlDhcpRelayInterfaceListVlanId2049To3072_Type(OctetString):subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,128))
_RlDhcpRelayInterfaceListVlanId2049To3072_Type.__name__=_F
_RlDhcpRelayInterfaceListVlanId2049To3072_Object=MibTableColumn
rlDhcpRelayInterfaceListVlanId2049To3072=_RlDhcpRelayInterfaceListVlanId2049To3072_Object((1,3,6,1,4,1,259,10,1,14,89,38,29,1,5),_RlDhcpRelayInterfaceListVlanId2049To3072_Type())
...
class _RlDhcpRelayInterfaceListVlanId3073To4094_Type(OctetString):subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,128))
_RlDhcpRelayInterfaceListVlanId3073To4094_Type.__name__=_F
_RlDhcpRelayInterfaceListVlanId3073To4094_Object=MibTableColumn
rlDhcpRelayInterfaceListVlanId3073To4094=_RlDhcpRelayInterfaceListVlanId3073To4094_Object((1,3,6,1,4,1,259,10,1,14,89,38,29,1,6),_RlDhcpRelayInterfaceListVlanId3073To4094_Type())
...
_RlDhcpSrvEnable_Type.__name__=_I
_RlDhcpSrvEnable_Object=MibScalar
rlDhcpSrvEnable=_RlDhcpSrvEnable_Object((1,3,6,1,4,1,259,10,1,14,89,38,30),_RlDhcpSrvEnable_Type())
...
rlDhcpSrvExists=_RlDhcpSrvExists_Object((1,3,6,1,4,1,259,10,1,14,89,38,31),_RlDhcpSrvExists_Type())
...
rlDhcpSrvDbLocation=_RlDhcpSrvDbLocation_Object((1,3,6,1,4,1,259,10,1,14,89,38,32),_RlDhcpSrvDbLocation_Type())
rlDhcpSrvDbLocation.setMaxAccess(_C)
if mibBuilder.loadTexts:rlDhcpSrvDbLocation.setStatus(_J)
_RlDhcpSrvMaxNumOfClients_Type=Unsigned32
_RlDhcpSrvMaxNumOfClients_Object=MibScalar
rlDhcpSrvMaxNumOfClients=_RlDhcpSrvMaxNumOfClients_Object((1,3,6,1,4,1,259,10,1,14,89,38,33),_RlDhcpSrvMaxNumOfClients_Type())
...
rlDhcpSrvDbNumOfActiveEntries=_RlDhcpSrvDbNumOfActiveEntries_Object((1,3,6,1,4,1,259,10,1,14,89,38,34),_RlDhcpSrvDbNumOfActiveEntries_Type())
...
_RlDhcpSrvDbErase_Type.__name__=_I
_RlDhcpSrvDbErase_Object=MibScalar
rlDhcpSrvDbErase=_RlDhcpSrvDbErase_Object((1,3,6,1,4,1,259,10,1,14,89,38,35),_RlDhcpSrvDbErase_Type())
rlDhcpSrvDbErase.setMaxAccess(_B)
if mibBuilder.loadTexts:rlDhcpSrvDbErase.setStatus(_J)
class _RlDhcpSrvProbeEnable_Type(TruthValue):defaultValue=2
_RlDhcpSrvProbeEnable_Type.__name__=_I
_RlDhcpSrvProbeEnable_Object=MibScalar
rlDhcpSrvProbeEnable=_RlDhcpSrvProbeEnable_Object((1,3,6,1,4,1,259,10,1,14,89,38,36),_RlDhcpSrvProbeEnable_Type())
...
_RlDhcpSrvProbeTimeout_Type.__name__=_H
_RlDhcpSrvProbeTimeout_Object=MibScalar
rlDhcpSrvProbeTimeout=_RlDhcpSrvProbeTimeout_Object((1,3,6,1,4,1,259,10,1,14,89,38,37),_RlDhcpSrvProbeTimeout_Type())
...
_RlDhcpSrvProbeRetries_Type.__name__=_H
_RlDhcpSrvProbeRetries_Object=MibScalar
rlDhcpSrvProbeRetries=_RlDhcpSrvProbeRetries_Object((1,3,6,1,4,1,259,10,1,14,89,38,38),_RlDhcpSrvProbeRetries_Type())
...
rlDhcpSrvDefaultNetworkPoolName=_RlDhcpSrvDefaultNetworkPoolName_Object((1,3,6,1,4,1,259,10,1,14,89,38,39),_RlDhcpSrvDefaultNetworkPoolName_Type())
...
rlDhcpSrvIpAddrTable=_RlDhcpSrvIpAddrTable_Object((1,3,6,1,4,1,259,10,1,14,89,38,45))
if mibBuilder.loadTexts:rlDhcpSrvIpAddrTable.setStatus(_A)
_RlDhcpSrvIpAddrEntry_Object=MibTableRow
rlDhcpSrvIpAddrEntry=_RlDhcpSrvIpAddrEntry_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1))
...
rlDhcpSrvIpAddrIpAddr=_RlDhcpSrvIpAddrIpAddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,1),_RlDhcpSrvIpAddrIpAddr_Type())
...
rlDhcpSrvIpAddrIpNetMask=_RlDhcpSrvIpAddrIpNetMask_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,2),_RlDhcpSrvIpAddrIpNetMask_Type())
...
_RlDhcpSrvIpAddrIdentifier_Type.__name__=_F
_RlDhcpSrvIpAddrIdentifier_Object=MibTableColumn
rlDhcpSrvIpAddrIdentifier=_RlDhcpSrvIpAddrIdentifier_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,3),_RlDhcpSrvIpAddrIdentifier_Type())
...
rlDhcpSrvIpAddrIdentifierType=_RlDhcpSrvIpAddrIdentifierType_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,4),_RlDhcpSrvIpAddrIdentifierType_Type())
...
_RlDhcpSrvIpAddrClnHostName_Type.__name__=_K
_RlDhcpSrvIpAddrClnHostName_Object=MibTableColumn
rlDhcpSrvIpAddrClnHostName=_RlDhcpSrvIpAddrClnHostName_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,5),_RlDhcpSrvIpAddrClnHostName_Type())
...
rlDhcpSrvIpAddrMechanism=_RlDhcpSrvIpAddrMechanism_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,6),_RlDhcpSrvIpAddrMechanism_Type())
...
_RlDhcpSrvIpAddrAgeTime_Type.__name__=_H
_RlDhcpSrvIpAddrAgeTime_Object=MibTableColumn
rlDhcpSrvIpAddrAgeTime=_RlDhcpSrvIpAddrAgeTime_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,7),_RlDhcpSrvIpAddrAgeTime_Type())
...
rlDhcpSrvIpAddrPoolName=_RlDhcpSrvIpAddrPoolName_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,8),_RlDhcpSrvIpAddrPoolName_Type())
...
rlDhcpSrvIpAddrConfParamsName=_RlDhcpSrvIpAddrConfParamsName_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,9),_RlDhcpSrvIpAddrConfParamsName_Type())
...
rlDhcpSrvIpAddrRowStatus=_RlDhcpSrvIpAddrRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,10),_RlDhcpSrvIpAddrRowStatus_Type())
...
_RlDhcpSrvIpAddrLeaseTime_Type.__name__=_H
_RlDhcpSrvIpAddrLeaseTime_Object=MibTableColumn
rlDhcpSrvIpAddrLeaseTime=_RlDhcpSrvIpAddrLeaseTime_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,11),_RlDhcpSrvIpAddrLeaseTime_Type())
...
rlDhcpSrvIpAddrState=_RlDhcpSrvIpAddrState_Object((1,3,6,1,4,1,259,10,1,14,89,38,45,1,12),_RlDhcpSrvIpAddrState_Type())
...
rlDhcpSrvDynamicTable=_RlDhcpSrvDynamicTable_Object((1,3,6,1,4,1,259,10,1,14,89,38,46))
if mibBuilder.loadTexts:rlDhcpSrvDynamicTable.setStatus(_A)
_RlDhcpSrvDynamicEntry_Object=MibTableRow
rlDhcpSrvDynamicEntry=_RlDhcpSrvDynamicEntry_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1))
...
rlDhcpSrvDynamicPoolName=_RlDhcpSrvDynamicPoolName_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,1),_RlDhcpSrvDynamicPoolName_Type())
...
rlDhcpSrvDynamicIpAddrFrom=_RlDhcpSrvDynamicIpAddrFrom_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,2),_RlDhcpSrvDynamicIpAddrFrom_Type())
...
rlDhcpSrvDynamicIpAddrTo=_RlDhcpSrvDynamicIpAddrTo_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,3),_RlDhcpSrvDynamicIpAddrTo_Type())
...
rlDhcpSrvDynamicIpNetMask=_RlDhcpSrvDynamicIpNetMask_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,4),_RlDhcpSrvDynamicIpNetMask_Type())
...
_RlDhcpSrvDynamicLeaseTime_Type.__name__=_H
_RlDhcpSrvDynamicLeaseTime_Object=MibTableColumn
rlDhcpSrvDynamicLeaseTime=_RlDhcpSrvDynamicLeaseTime_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,5),_RlDhcpSrvDynamicLeaseTime_Type())
...
_RlDhcpSrvDynamicProbeEnable_Type.__name__=_I
_RlDhcpSrvDynamicProbeEnable_Object=MibTableColumn
rlDhcpSrvDynamicProbeEnable=_RlDhcpSrvDynamicProbeEnable_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,6),_RlDhcpSrvDynamicProbeEnable_Type())
...
rlDhcpSrvDynamicTotalNumOfAddr=_RlDhcpSrvDynamicTotalNumOfAddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,7),_RlDhcpSrvDynamicTotalNumOfAddr_Type())
...
rlDhcpSrvDynamicFreeNumOfAddr=_RlDhcpSrvDynamicFreeNumOfAddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,8),_RlDhcpSrvDynamicFreeNumOfAddr_Type())
...
rlDhcpSrvDynamicConfParamsName=_RlDhcpSrvDynamicConfParamsName_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,9),_RlDhcpSrvDynamicConfParamsName_Type())
...
rlDhcpSrvDynamicRowStatus=_RlDhcpSrvDynamicRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,10),_RlDhcpSrvDynamicRowStatus_Type())
...
rlDhcpSrvDynamicAvailableNumOfAddr=_RlDhcpSrvDynamicAvailableNumOfAddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,11),_RlDhcpSrvDynamicAvailableNumOfAddr_Type())
...
rlDhcpSrvDynamicNumOfPreallocatedAddr=_RlDhcpSrvDynamicNumOfPreallocatedAddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,12),_RlDhcpSrvDynamicNumOfPreallocatedAddr_Type())
...
rlDhcpSrvDynamicNumOfValidAddr=_RlDhcpSrvDynamicNumOfValidAddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,13),_RlDhcpSrvDynamicNumOfValidAddr_Type())
...
rlDhcpSrvDynamicNumOfExpiredAddr=_RlDhcpSrvDynamicNumOfExpiredAddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,14),_RlDhcpSrvDynamicNumOfExpiredAddr_Type())
...
rlDhcpSrvDynamicNumOfDeclinedAddr=_RlDhcpSrvDynamicNumOfDeclinedAddr_Object((1,3,6,1,4,1,259,10,1,14,89,38,46,1,15),_RlDhcpSrvDynamicNumOfDeclinedAddr_Type())
...
rlDhcpSrvConfParamsTable=_RlDhcpSrvConfParamsTable_Object((1,3,6,1,4,1,259,10,1,14,89,38,47))
if mibBuilder.loadTexts:rlDhcpSrvConfParamsTable.setStatus(_A)
_RlDhcpSrvConfParamsEntry_Object=MibTableRow
rlDhcpSrvConfParamsEntry=_RlDhcpSrvConfParamsEntry_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1))
...
rlDhcpSrvConfParamsName=_RlDhcpSrvConfParamsName_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,1),_RlDhcpSrvConfParamsName_Type())
...
rlDhcpSrvConfParamsNextServerIp=_RlDhcpSrvConfParamsNextServerIp_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,2),_RlDhcpSrvConfParamsNextServerIp_Type())
...
rlDhcpSrvConfParamsNextServerName=_RlDhcpSrvConfParamsNextServerName_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,3),_RlDhcpSrvConfParamsNextServerName_Type())
...
rlDhcpSrvConfParamsBootfileName=_RlDhcpSrvConfParamsBootfileName_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,4),_RlDhcpSrvConfParamsBootfileName_Type())
...
rlDhcpSrvConfParamsRoutersList=_RlDhcpSrvConfParamsRoutersList_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,5),_RlDhcpSrvConfParamsRoutersList_Type())
...
rlDhcpSrvConfParamsTimeSrvList=_RlDhcpSrvConfParamsTimeSrvList_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,6),_RlDhcpSrvConfParamsTimeSrvList_Type())
...
rlDhcpSrvConfParamsDnsList=_RlDhcpSrvConfParamsDnsList_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,7),_RlDhcpSrvConfParamsDnsList_Type())
...
_RlDhcpSrvConfParamsDomainName_Type.__name__=_K
_RlDhcpSrvConfParamsDomainName_Object=MibTableColumn
rlDhcpSrvConfParamsDomainName=_RlDhcpSrvConfParamsDomainName_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,8),_RlDhcpSrvConfParamsDomainName_Type())
...
rlDhcpSrvConfParamsNetbiosNameList=_RlDhcpSrvConfParamsNetbiosNameList_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,9),_RlDhcpSrvConfParamsNetbiosNameList_Type())
...
rlDhcpSrvConfParamsNetbiosNodeType=_RlDhcpSrvConfParamsNetbiosNodeType_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,10),_RlDhcpSrvConfParamsNetbiosNodeType_Type())
...
rlDhcpSrvConfParamsCommunity=_RlDhcpSrvConfParamsCommunity_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,11),_RlDhcpSrvConfParamsCommunity_Type())
rlDhcpSrvConfParamsCommunity.setMaxAccess(_B)
if mibBuilder.loadTexts:rlDhcpSrvConfParamsCommunity.setStatus(_J)
_RlDhcpSrvConfParamsNmsIp_Type=IpAddress
_RlDhcpSrvConfParamsNmsIp_Object=MibTableColumn
rlDhcpSrvConfParamsNmsIp=_RlDhcpSrvConfParamsNmsIp_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,12),_RlDhcpSrvConfParamsNmsIp_Type())
rlDhcpSrvConfParamsNmsIp.setMaxAccess(_B)
if mibBuilder.loadTexts:rlDhcpSrvConfParamsNmsIp.setStatus(_J)
_RlDhcpSrvConfParamsOptionsList_Type=DisplayString
_RlDhcpSrvConfParamsOptionsList_Object=MibTableColumn
rlDhcpSrvConfParamsOptionsList=_RlDhcpSrvConfParamsOptionsList_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,13),_RlDhcpSrvConfParamsOptionsList_Type())
rlDhcpSrvConfParamsOptionsList.setMaxAccess(_B)
if mibBuilder.loadTexts:rlDhcpSrvConfParamsOptionsList.setStatus(_A)
_RlDhcpSrvConfParamsRowStatus_Type=RowStatus
_RlDhcpSrvConfParamsRowStatus_Object=MibTableColumn
rlDhcpSrvConfParamsRowStatus=_RlDhcpSrvConfParamsRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,38,47,1,14),_RlDhcpSrvConfParamsRowStatus_Type())
...
rlDhcpSrvNumOfNetworkPools=_RlDhcpSrvNumOfNetworkPools_Object((1,3,6,1,4,1,259,10,1,14,89,38,48),_RlDhcpSrvNumOfNetworkPools_Type())
...
rlDhcpSrvNumOfExcludedPools=_RlDhcpSrvNumOfExcludedPools_Object((1,3,6,1,4,1,259,10,1,14,89,38,49),_RlDhcpSrvNumOfExcludedPools_Type())
...
rlDhcpSrvNumOfHostPools=_RlDhcpSrvNumOfHostPools_Object((1,3,6,1,4,1,259,10,1,14,89,38,50),_RlDhcpSrvNumOfHostPools_Type())
...
rlDhcpSrvNumOfDynamicEntries=_RlDhcpSrvNumOfDynamicEntries_Object((1,3,6,1,4,1,259,10,1,14,89,38,51),_RlDhcpSrvNumOfDynamicEntries_Type())
