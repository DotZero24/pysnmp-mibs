...
agentDot1qMmrp=_AgentDot1qMmrp_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,1))
_AgentDot1qPortMmrpTable_Object=MibTable
agentDot1qPortMmrpTable=_AgentDot1qPortMmrpTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,1,1))
if mibBuilder.loadTexts:agentDot1qPortMmrpTable.setStatus(_A)
_AgentDot1qPortMmrpEntry_Object=MibTableRow
agentDot1qPortMmrpEntry=_AgentDot1qPortMmrpEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,1,1,1))
...
agentDot1qMmrpPort=_AgentDot1qMmrpPort_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,1,1,1,1),_AgentDot1qMmrpPort_Type())
...
agentDot1qPortMmrpMode=_AgentDot1qPortMmrpMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,1,1,1,2),_AgentDot1qPortMmrpMode_Type())
...
agentDot1qBridgeMmrpMode=_AgentDot1qBridgeMmrpMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,1,2),_AgentDot1qBridgeMmrpMode_Type())
...
agentDot1qBridgeMrpPeriodicStateMachineForMmrp=_AgentDot1qBridgeMrpPeriodicStateMachineForMmrp_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,1,3),_AgentDot1qBridgeMrpPeriodicStateMachineForMmrp_Type())
...
agentDot1qMrpMmrpStats=_AgentDot1qMrpMmrpStats_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2))
_AgentDot1qMrpMmrpPktTx_Type=Counter32
_AgentDot1qMrpMmrpPktTx_Object=MibScalar
agentDot1qMrpMmrpPktTx=_AgentDot1qMrpMmrpPktTx_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,1),_AgentDot1qMrpMmrpPktTx_Type())
...
agentDot1qMrpMmrpPktRx=_AgentDot1qMrpMmrpPktRx_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,2),_AgentDot1qMrpMmrpPktRx_Type())
...
agentDot1qMrpMmrpPktRxBadHeader=_AgentDot1qMrpMmrpPktRxBadHeader_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,3),_AgentDot1qMrpMmrpPktRxBadHeader_Type())
...
agentDot1qMrpMmrpPktRxBadFormat=_AgentDot1qMrpMmrpPktRxBadFormat_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,4),_AgentDot1qMrpMmrpPktRxBadFormat_Type())
...
agentDot1qMrpMmrpPktTxFailure=_AgentDot1qMrpMmrpPktTxFailure_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,5),_AgentDot1qMrpMmrpPktTxFailure_Type())
...
agentDot1qMrpMmrpStatsTable=_AgentDot1qMrpMmrpStatsTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,6))
if mibBuilder.loadTexts:agentDot1qMrpMmrpStatsTable.setStatus(_A)
_AgentDot1qMrpMmrpStatisticsEntry_Object=MibTableRow
agentDot1qMrpMmrpStatisticsEntry=_AgentDot1qMrpMmrpStatisticsEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,6,1))
...
agentDot1qMrpMmrpIntf=_AgentDot1qMrpMmrpIntf_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,6,1,1),_AgentDot1qMrpMmrpIntf_Type())
...
agentDot1qMrpMmrpPortPktTx=_AgentDot1qMrpMmrpPortPktTx_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,6,1,2),_AgentDot1qMrpMmrpPortPktTx_Type())
...
agentDot1qMrpMmrpPortPktRx=_AgentDot1qMrpMmrpPortPktRx_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,6,1,3),_AgentDot1qMrpMmrpPortPktRx_Type())
...
agentDot1qMrpMmrpPortPktRxBadHeader=_AgentDot1qMrpMmrpPortPktRxBadHeader_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,6,1,4),_AgentDot1qMrpMmrpPortPktRxBadHeader_Type())
...
agentDot1qMrpMmrpPortPktRxBadFormat=_AgentDot1qMrpMmrpPortPktRxBadFormat_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,6,1,5),_AgentDot1qMrpMmrpPortPktRxBadFormat_Type())
...
agentDot1qMrpMmrpPortPktTxFailure=_AgentDot1qMrpMmrpPortPktTxFailure_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,60,2,1,2,6,1,6),_AgentDot1qMrpMmrpPortPktTxFailure_Type())
