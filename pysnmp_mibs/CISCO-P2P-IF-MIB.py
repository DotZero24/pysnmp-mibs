...
mibBuilder.exportSymbols("CISCO-P2P-IF-MIB", cp2pIfCfgCrcMode=cp2pIfCfgCrcMode, ciscoP2PIfMIB=ciscoP2PIfMIB, Cp2pIfScramblingMode=Cp2pIfScramblingMode, cp2pIfCfgTransmitDelay=cp2pIfCfgTransmitDelay, cp2pIfCfgScramblingMode=cp2pIfCfgScramblingMode, cp2pIfStatsInCrcErrors=cp2pIfStatsInCrcErrors, ciscoP2PIfMIBCompliances=ciscoP2PIfMIBCompliances, cp2pIfCfgTable=cp2pIfCfgTable, cp2pIfStatsEntry=cp2pIfStatsEntry, PYSNMP_MODULE_ID=ciscoP2PIfMIB, cp2pIfGeneralObjects=cp2pIfGeneralObjects, cp2pIfCfgEntry=cp2pIfCfgEntry, ciscoP2PIfMIBGroups=ciscoP2PIfMIBGroups, ciscoP2PIfMIBCompliance=ciscoP2PIfMIBCompliance, ciscoP2PIfMIBNotifs=ciscoP2PIfMIBNotifs, ciscoP2PIfMIBGeneralGroup=ciscoP2PIfMIBGeneralGroup, ciscoP2PIfMIBObjects=ciscoP2PIfMIBObjects, Cp2pIfCrcMode=Cp2pIfCrcMode, cp2pIfStatsTable=cp2pIfStatsTable, ciscoP2PIfMIBConformance=ciscoP2PIfMIBConformance)
