# SNMP MIB module (QTECH-GBNPlatformOAMMailalarm-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-GBNPlatformOAMMailalarm-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:57:20 2025
...
mailalarmState = _MailalarmState_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 1),
...
mailalarmSrvAddr = _MailalarmSrvAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 2),
...
mailalarmRceiverAddr = _MailalarmRceiverAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 3),
...
mailalarmLogLevel = _MailalarmLogLevel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 4),
...
mailalarmSmtpAuthEnable = _MailalarmSmtpAuthEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 5),
...
mailalarmSmtpUsername = _MailalarmSmtpUsername_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 6),
...
mailalarmSmtpPasswd = _MailalarmSmtpPasswd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 7),
...
mailalarmCcAddrTable = _MailalarmCcAddrTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 8)
)
if mibBuilder.loadTexts:
...
mailalarmCcAddrEntry = _MailalarmCcAddrEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 8, 1)
)
mailalarmCcAddrEntry.setIndexNames(
    (0, "QTECH-GBNPlatformOAMMailalarm-MIB", "mailalarmCcAddrIdx"),
)
if mibBuilder.loadTexts:
...
mailalarmCcAddrIdx = _MailalarmCcAddrIdx_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 8, 1, 1),
...
mailalarmCcAddr = _MailalarmCcAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 12, 8, 1, 2),
...
mibBuilder.exportSymbols(
    "QTECH-GBNPlatformOAMMailalarm-MIB",
