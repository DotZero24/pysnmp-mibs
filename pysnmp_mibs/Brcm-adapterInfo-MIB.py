...
mibBuilder.exportSymbols("Brcm-adapterInfo-MIB", baspTrap=baspTrap, ifDuplexMode=ifDuplexMode, ifiTable=ifiTable, ifiNumber=ifiNumber, ifState=ifState, ifLinkStatus=ifLinkStatus, broadcom=broadcom, ifDeviceNumber=ifDeviceNumber, enet=enet, ifFunctionNumber=ifFunctionNumber, baspStat=baspStat, basp=basp, ifInterrupt=ifInterrupt, ifMemBaseHigh=ifMemBaseHigh, ifiIndex=ifiIndex, baspConfig=baspConfig, ifControllers=ifControllers, ifiPhysAddress=ifiPhysAddress, ifiDescr=ifiDescr, ifLineSpeed=ifLineSpeed, ifIpv6NetworkAddress=ifIpv6NetworkAddress, ifBusNumber=ifBusNumber, ifPermPhysAddress=ifPermPhysAddress, ifMemBaseLow=ifMemBaseLow, ifiEntry=ifiEntry, ifName=ifName, ifNetworkAddress=ifNetworkAddress, ifSubnetMask=ifSubnetMask)
