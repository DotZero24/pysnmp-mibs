...
mibBuilder.exportSymbols("OLD-CISCO-SYS-MIB", bufferHgMax=bufferHgMax, envPresent=envPresent, bufferBgTrim=bufferBgTrim, ping=ping, bufferSmTrim=bufferSmTrim, envTestPt4last=envTestPt4last, bufferLgSize=bufferLgSize, envTestPt2MarginVal=envTestPt2MarginVal, bufferMdMiss=bufferMdMiss, sysConfigAddr=sysConfigAddr, bufferMdTrim=bufferMdTrim, bufferBgTotal=bufferBgTotal, envTestPt5warn=envTestPt5warn, romId=romId, envTestPt1warn=envTestPt1warn, bufferHgCreate=bufferHgCreate, lsystem=lsystem, bufferHgFree=bufferHgFree, bufferMdCreate=bufferMdCreate, writeMem=writeMem, envTestPt3Measure=envTestPt3Measure, envSerialNumber=envSerialNumber, bufferBgMiss=bufferBgMiss, envTestPt6warn=envTestPt6warn, envTestPt1last=envTestPt1last, bufferLgMax=bufferLgMax, envTestPt3Descr=envTestPt3Descr, envTestPt5Descr=envTestPt5Descr, bufferElMax=bufferElMax, envTechnicianID=envTechnicianID, envTestPt1MarginVal=envTestPt1MarginVal, bufferMdFree=bufferMdFree, whyReload=whyReload, bufferMdHit=bufferMdHit, idleCount=idleCount, envTestPt2warn=envTestPt2warn, bufferHgHit=bufferHgHit, bufferSmCreate=bufferSmCreate, bufferLgFree=bufferLgFree, bufferSmMax=bufferSmMax, hostConfigProto=hostConfigProto, bufferElHit=bufferElHit, envType=envType, bufferNoMem=bufferNoMem, envTestPt3MarginPercent=envTestPt3MarginPercent, bufferLgTotal=bufferLgTotal, sysClearARP=sysClearARP, envTestPt4warn=envTestPt4warn, bufferMdTotal=bufferMdTotal, bufferHgTotal=bufferHgTotal, avgBusy5=avgBusy5, bufferLgCreate=bufferLgCreate, envTestPt3last=envTestPt3last, envTestPt5last=envTestPt5last, bufferSmHit=bufferSmHit, bufferSmMiss=bufferSmMiss, sysConfigProto=sysConfigProto, envTestPt6Descr=envTestPt6Descr, envFirmVersion=envFirmVersion, authAddr=authAddr, sysConfigName=sysConfigName, netConfigName=netConfigName, bufferHgSize=bufferHgSize, bufferSmSize=bufferSmSize, envTestPt3warn=envTestPt3warn, netConfigProto=netConfigProto, hostConfigAddr=hostConfigAddr, envTestPt1Descr=envTestPt1Descr, hostConfigName=hostConfigName, bufferElMiss=bufferElMiss, bufferBgMax=bufferBgMax, netConfigSet=netConfigSet, envTestPt2Measure=envTestPt2Measure, envTestPt1Measure=envTestPt1Measure, envTestPt6last=envTestPt6last, bufferLgMiss=bufferLgMiss, bufferFail=bufferFail, bufferLgHit=bufferLgHit, bufferElFree=bufferElFree, ciscoContactInfo=ciscoContactInfo, bufferMdSize=bufferMdSize, envTestPt4Measure=envTestPt4Measure, bufferHgMiss=bufferHgMiss, hostName=hostName, bufferSmTotal=bufferSmTotal, avgBusy1=avgBusy1, envBurnDate=envBurnDate, envTestPt5MarginPercent=envTestPt5MarginPercent, idleWired=idleWired, bufferBgHit=bufferBgHit, bufferSmFree=bufferSmFree, envTestPt6Measure=envTestPt6Measure, netConfigAddr=netConfigAddr, bootHost=bootHost, bufferBgFree=bufferBgFree, freeMem=freeMem, sysClearInt=sysClearInt, hostConfigSet=hostConfigSet, bufferElCreate=bufferElCreate, domainName=domainName, envTestPt2Descr=envTestPt2Descr, bufferBgSize=bufferBgSize, writeNet=writeNet, envTestPt5Measure=envTestPt5Measure, bufferBgCreate=bufferBgCreate, busyPer=busyPer, bufferHgTrim=bufferHgTrim, envTestPt2last=envTestPt2last, bufferMdMax=bufferMdMax, envTestPt4Descr=envTestPt4Descr, envTestPt4MarginPercent=envTestPt4MarginPercent, bufferLgTrim=bufferLgTrim, envTestPt6MarginPercent=envTestPt6MarginPercent)
