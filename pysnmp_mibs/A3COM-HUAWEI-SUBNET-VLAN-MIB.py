...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-SUBNET-VLAN-MIB
...
h3cSubnetVlanCompliance.setObjects(
      *(("A3COM-HUAWEI-SUBNET-VLAN-MIB", "h3cSubnetVlanScalarObjectGroup"),
        ("A3COM-HUAWEI-SUBNET-VLAN-MIB", "h3cSubnetVlanSubnetGroup"),
        ("A3COM-HUAWEI-SUBNET-VLAN-MIB", "h3cSubnetVlanPortCreateGroup"))
)
if mibBuilder.loadTexts:
