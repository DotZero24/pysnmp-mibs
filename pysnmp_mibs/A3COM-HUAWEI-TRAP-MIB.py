...
h3cTableGroup=_H3cTableGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1))
_H3cMacTabStatGroup_ObjectIdentity=ObjectIdentity
h3cMacTabStatGroup=_H3cMacTabStatGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,1))
...
h3cMacTabTrapEnable=_H3cMacTabTrapEnable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,1,1),_H3cMacTabTrapEnable_Type())
h3cMacTabTrapEnable.setMaxAccess(_D)
...
h3cMacTabTrapInterval=_H3cMacTabTrapInterval_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,1,2),_H3cMacTabTrapInterval_Type())
h3cMacTabTrapInterval.setMaxAccess(_D)
...
h3cMacTabTrapInfo=_H3cMacTabTrapInfo_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,1,3))
_H3cMacTabLen_Type=Integer32
_H3cMacTabLen_Object=MibScalar
h3cMacTabLen=_H3cMacTabLen_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,1,3,1),_H3cMacTabLen_Type())
...
h3cMacTabTrap=_H3cMacTabTrap_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,1,4))
_H3cArpTabStatGroup_ObjectIdentity=ObjectIdentity
h3cArpTabStatGroup=_H3cArpTabStatGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,2))
...
h3cArpTabTrapEnable=_H3cArpTabTrapEnable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,2,1),_H3cArpTabTrapEnable_Type())
h3cArpTabTrapEnable.setMaxAccess(_D)
...
h3cArpTabTrapInterval=_H3cArpTabTrapInterval_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,2,2),_H3cArpTabTrapInterval_Type())
h3cArpTabTrapInterval.setMaxAccess(_D)
...
h3cArpTabTrapInfo=_H3cArpTabTrapInfo_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,2,3))
_H3cArpTabLen_Type=Integer32
_H3cArpTabLen_Object=MibScalar
h3cArpTabLen=_H3cArpTabLen_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,2,3,1),_H3cArpTabLen_Type())
...
h3cArpTabTrap=_H3cArpTabTrap_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,2,4))
_H3cRtTabStatGroup_ObjectIdentity=ObjectIdentity
h3cRtTabStatGroup=_H3cRtTabStatGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,3))
_H3cDetailRtTrapTable_Object=MibTable
h3cDetailRtTrapTable=_H3cDetailRtTrapTable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,1))
if mibBuilder.loadTexts:h3cDetailRtTrapTable.setStatus(_A)
_H3cDetailRtTrapEntry_Object=MibTableRow
h3cDetailRtTrapEntry=_H3cDetailRtTrapEntry_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,1,1))
h3cDetailRtTrapEntry.setIndexNames((0,_C,_I))
...
h3cDetailRtProType=_H3cDetailRtProType_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,1,1,1),_H3cDetailRtProType_Type())
...
h3cDetailRtEnable=_H3cDetailRtEnable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,1,1,2),_H3cDetailRtEnable_Type())
h3cDetailRtEnable.setMaxAccess(_D)
...
h3cRtTabTrapEnable=_H3cRtTabTrapEnable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,2),_H3cRtTabTrapEnable_Type())
h3cRtTabTrapEnable.setMaxAccess(_D)
...
h3cRtTabTrapInterval=_H3cRtTabTrapInterval_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,3),_H3cRtTabTrapInterval_Type())
h3cRtTabTrapInterval.setMaxAccess(_D)
...
h3cRtTabTrapInfo=_H3cRtTabTrapInfo_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,3,4))
_H3cRtTabLen_Type=Integer32
_H3cRtTabLen_Object=MibScalar
h3cRtTabLen=_H3cRtTabLen_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,4,1),_H3cRtTabLen_Type())
...
h3cDefaultRtNextHopType=_H3cDefaultRtNextHopType_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,4,2),_H3cDefaultRtNextHopType_Type())
...
h3cDefaultRtNextHop=_H3cDefaultRtNextHop_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,4,3),_H3cDefaultRtNextHop_Type())
...
h3cDefaultRtOutIf=_H3cDefaultRtOutIf_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,4,4),_H3cDefaultRtOutIf_Type())
...
h3cRtTabTrap=_H3cRtTabTrap_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,3,5))
...
h3cDefaultRtDelTrapEnable=_H3cDefaultRtDelTrapEnable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,3,6),_H3cDefaultRtDelTrapEnable_Type())
h3cDefaultRtDelTrapEnable.setMaxAccess(_D)
if mibBuilder.loadTexts:h3cDefaultRtDelTrapEnable.setStatus(_A)
_H3cMulticastTabStatGroup_ObjectIdentity=ObjectIdentity
h3cMulticastTabStatGroup=_H3cMulticastTabStatGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,4))
...
h3cMulticastTabTrapEnable=_H3cMulticastTabTrapEnable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,4,1),_H3cMulticastTabTrapEnable_Type())
h3cMulticastTabTrapEnable.setMaxAccess(_D)
...
h3cMulticastTabTrapInterval=_H3cMulticastTabTrapInterval_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,4,2),_H3cMulticastTabTrapInterval_Type())
h3cMulticastTabTrapInterval.setMaxAccess(_D)
...
h3cMulticastTabTrapInfo=_H3cMulticastTabTrapInfo_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,4,3))
...
h3cMulticastTabType=_H3cMulticastTabType_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,4,3,1),_H3cMulticastTabType_Type())
...
h3cMulticastTabLen=_H3cMulticastTabLen_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,4,3,2),_H3cMulticastTabLen_Type())
...
h3cMulticastTabTrap=_H3cMulticastTabTrap_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,4,4))
_H3cNdTabStatGroup_ObjectIdentity=ObjectIdentity
h3cNdTabStatGroup=_H3cNdTabStatGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,5))
...
h3cNdTabTrapEnable=_H3cNdTabTrapEnable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,5,1),_H3cNdTabTrapEnable_Type())
h3cNdTabTrapEnable.setMaxAccess(_D)
...
h3cNdTabTrapInterval=_H3cNdTabTrapInterval_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,5,2),_H3cNdTabTrapInterval_Type())
h3cNdTabTrapInterval.setMaxAccess(_D)
...
h3cNdTabTrapInfo=_H3cNdTabTrapInfo_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,5,3))
_H3cNdTabLen_Type=Integer32
_H3cNdTabLen_Object=MibScalar
h3cNdTabLen=_H3cNdTabLen_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,5,3,1),_H3cNdTabLen_Type())
h3cNdTabLen.setMaxAccess(_E)
if mibBuilder.loadTexts:h3cNdTabLen.setStatus(_A)
_H3cNdTabTrap_ObjectIdentity=ObjectIdentity
h3cNdTabTrap=_H3cNdTabTrap_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,5,4))
_H3cPeriodicalTrapGroup_ObjectIdentity=ObjectIdentity
h3cPeriodicalTrapGroup=_H3cPeriodicalTrapGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,6))
_H3cPeriodicalTrapObjects_ObjectIdentity=ObjectIdentity
h3cPeriodicalTrapObjects=_H3cPeriodicalTrapObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,6,1))
...
h3cPeriodicalTrapInterval=_H3cPeriodicalTrapInterval_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,6,1,1),_H3cPeriodicalTrapInterval_Type())
h3cPeriodicalTrapInterval.setMaxAccess(_D)
...
h3cPeriodicalTrapSwitch=_H3cPeriodicalTrapSwitch_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,6,1,2),_H3cPeriodicalTrapSwitch_Type())
h3cPeriodicalTrapSwitch.setMaxAccess(_D)
if mibBuilder.loadTexts:h3cPeriodicalTrapSwitch.setStatus(_A)
_H3cPeriodicalTrapInfo_ObjectIdentity=ObjectIdentity
h3cPeriodicalTrapInfo=_H3cPeriodicalTrapInfo_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,6,2))
_H3cPeriodicalNotification_ObjectIdentity=ObjectIdentity
h3cPeriodicalNotification=_H3cPeriodicalNotification_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,6,3))
_H3cPeriodicalNotificationPrefix_ObjectIdentity=ObjectIdentity
h3cPeriodicalNotificationPrefix=_H3cPeriodicalNotificationPrefix_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,6,3,0))
_H3cTrapDesInfo_ObjectIdentity=ObjectIdentity
h3cTrapDesInfo=_H3cTrapDesInfo_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,7))
_H3cTrapDesInfoTable_Object=MibTable
h3cTrapDesInfoTable=_H3cTrapDesInfoTable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,7,1))
if mibBuilder.loadTexts:h3cTrapDesInfoTable.setStatus(_A)
_H3cTrapDesInfoEntry_Object=MibTableRow
h3cTrapDesInfoEntry=_H3cTrapDesInfoEntry_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,7,1,1))
h3cTrapDesInfoEntry.setIndexNames((0,_C,_R))
...
h3cTrapDesInfoIndex=_H3cTrapDesInfoIndex_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,7,1,1,1),_H3cTrapDesInfoIndex_Type())
...
h3cTrapDesIPAddress=_H3cTrapDesIPAddress_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,7,1,1,2),_H3cTrapDesIPAddress_Type())
...
h3cTrapDesPort=_H3cTrapDesPort_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,7,1,1,3),_H3cTrapDesPort_Type())
...
h3cTrapDesRowStatus=_H3cTrapDesRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,7,1,1,4),_H3cTrapDesRowStatus_Type())
...
h3cTrapDesAddrTAddress=_H3cTrapDesAddrTAddress_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,7,1,1,5),_H3cTrapDesAddrTAddress_Type())
...
h3cTrapConfig=_H3cTrapConfig_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,38,1,8))
_H3cTrapConfigTable_Object=MibTable
h3cTrapConfigTable=_H3cTrapConfigTable_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,8,1))
if mibBuilder.loadTexts:h3cTrapConfigTable.setStatus(_A)
_H3cTrapConfigEntry_Object=MibTableRow
h3cTrapConfigEntry=_H3cTrapConfigEntry_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,8,1,1))
h3cTrapConfigEntry.setIndexNames((0,_C,_T))
...
h3cTrapConfigIndex=_H3cTrapConfigIndex_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,8,1,1,1),_H3cTrapConfigIndex_Type())
...
h3cTrapConfigName=_H3cTrapConfigName_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,8,1,1,2),_H3cTrapConfigName_Type())
...
h3cTrapConfigDescr=_H3cTrapConfigDescr_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,8,1,1,3),_H3cTrapConfigDescr_Type())
h3cTrapConfigDescr.setMaxAccess(_D)
...
h3cTrapConfigSwitch=_H3cTrapConfigSwitch_Object((1,3,6,1,4,1,43,45,1,10,2,38,1,8,1,1,4),_H3cTrapConfigSwitch_Type())
h3cTrapConfigSwitch.setMaxAccess(_D)
if mibBuilder.loadTexts:h3cTrapConfigSwitch.setStatus(_A)
h3cMacTabFullTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,38,1,1,4,1))
h3cMacTabFullTrap.setObjects((_C,_U))
...
h3cArpTabFullTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,38,1,2,4,1))
h3cArpTabFullTrap.setObjects((_C,_M))
if mibBuilder.loadTexts:h3cArpTabFullTrap.setStatus(_A)
h3cArpPortDynamicEntryFullTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,38,1,2,4,2))
h3cArpPortDynamicEntryFullTrap.setObjects(*((_C,_M),(_K,_P),(_K,_O)))
if mibBuilder.loadTexts:h3cArpPortDynamicEntryFullTrap.setStatus(_A)
h3cRtTabFullTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,38,1,3,5,1))
h3cRtTabFullTrap.setObjects((_C,_N))
if mibBuilder.loadTexts:h3cRtTabFullTrap.setStatus(_A)
h3cDetailRtTabFullTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,38,1,3,5,2))
h3cDetailRtTabFullTrap.setObjects(*((_C,_I),(_C,_N)))
if mibBuilder.loadTexts:h3cDetailRtTabFullTrap.setStatus(_A)
h3cDefaultRtDelTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,38,1,3,5,3))
h3cDefaultRtDelTrap.setObjects(*((_C,_I),(_C,_V),(_C,_W),(_C,_X)))
if mibBuilder.loadTexts:h3cDefaultRtDelTrap.setStatus(_A)
h3cMulticastTabFullTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,38,1,4,4,1))
h3cMulticastTabFullTrap.setObjects(*((_C,_Y),(_C,_Z)))
if mibBuilder.loadTexts:h3cMulticastTabFullTrap.setStatus(_A)
h3cNdTabFullTrap=NotificationType((1,3,6,1,4,1,43,45,1,10,2,38,1,5,4,1))
h3cNdTabFullTrap.setObjects((_C,_a))
