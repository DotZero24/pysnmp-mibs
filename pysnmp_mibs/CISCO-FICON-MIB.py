...
mibBuilder.exportSymbols("CISCO-FICON-MIB", cficonReservedPortNumGroup=cficonReservedPortNumGroup, cficonCfgFileRowStatus=cficonCfgFileRowStatus, cficonVsanTable=cficonVsanTable, cficonAutoSaveState=cficonAutoSaveState, ciscoFiconCompliance=ciscoFiconCompliance, cficonPortAddr=cficonPortAddr, cficonConfigCopyEntry=cficonConfigCopyEntry, cficonCfgFileLastUpdated=cficonCfgFileLastUpdated, cficonPortAddrNumGroup=cficonPortAddrNumGroup, cficonSwapInterfaceActionStatus=cficonSwapInterfaceActionStatus, cficonStatsTable=cficonStatsTable, cfStatsDispErrorsInFrame=cfStatsDispErrorsInFrame, cficonPortMap1=cficonPortMap1, cficonVsanCharSet=cficonVsanCharSet, cficonInterfaceSwapIndex=cficonInterfaceSwapIndex, cficonDirHistEntry=cficonDirHistEntry, cficonVsanDeviceAllegience=cficonVsanDeviceAllegience, cficonInterfaceSwapTable=cficonInterfaceSwapTable, cficonPortMapGroupRev1=cficonPortMapGroupRev1, cficonPortNumber=cficonPortNumber, cfStatsErrorSummary=cfStatsErrorSummary, cficonDirHistGroup=cficonDirHistGroup, cficonCfgFileCmd=cficonCfgFileCmd, cficonPortIfIndex=cficonPortIfIndex, cficonPortAddrPortNumber=cficonPortAddrPortNumber, cficonDirHistTable=cficonDirHistTable, cficonCfgFileCupNameEntry=cficonCfgFileCupNameEntry, cficonVsanAutoSavePortAddrCfg=cficonVsanAutoSavePortAddrCfg, cficonSwapInterfaceIndexSecond=cficonSwapInterfaceIndexSecond, ciscoFiconMIB=ciscoFiconMIB, cficonRunCfgProhibitPrtNums=cficonRunCfgProhibitPrtNums, cfStatsFramePacingTime=cfStatsFramePacingTime, ciscoFiconMIBConform=ciscoFiconMIBConform, cficonVsanHostControlSwOffline=cficonVsanHostControlSwOffline, cficonRunCfgManufacturer=cficonRunCfgManufacturer, cficonRunCfgPlantOfMfg=cficonRunCfgPlantOfMfg, cficonPortBlock=cficonPortBlock, ciscoFiconGlobal=ciscoFiconGlobal, portAddrPortNumber=portAddrPortNumber, cficonSlotPortNumTable=cficonSlotPortNumTable, cficonCfgFilename=cficonCfgFilename, cficonVsanEnableCup=cficonVsanEnableCup, cficonLinkIncidentTable=cficonLinkIncidentTable, cficonInterfaceSwapGroup=cficonInterfaceSwapGroup, cficonLinkIncidentEntry=cficonLinkIncidentEntry, cficonInterfaceSwapEntry=cficonInterfaceSwapEntry, cficonCfgFileGroup=cficonCfgFileGroup, cficonPortNumAddrGroup=cficonPortNumAddrGroup, ciscoFiconComplianceRev3=ciscoFiconComplianceRev3, CficonPortNumOrAddr=CficonPortNumOrAddr, cficonPortMapIndex=cficonPortMapIndex, cficonVsanSerialNum=cficonVsanSerialNum, cficonVsanFiconState=cficonVsanFiconState, cficonStatsGroup=cficonStatsGroup, cficonVsanTime=cficonVsanTime, cficonPortMap3=cficonPortMap3, cficonVsanSnmpControl=cficonVsanSnmpControl, cficonSetHostTimeControl=cficonSetHostTimeControl, cficonPortSwapIndex=cficonPortSwapIndex, cficonCfgFileEntry=cficonCfgFileEntry, cficonCfgFileCmdStatus=cficonCfgFileCmdStatus, cficonVsanEntryStatus=cficonVsanEntryStatus, cficonSlotPortNumEntry=cficonSlotPortNumEntry, cfStatsInvalidOrderSets=cfStatsInvalidOrderSets, cficonPortMap2=cficonPortMap2, cficonRlirErlEntry=cficonRlirErlEntry, cficonLinkIncident=cficonLinkIncident, cficonPortInfoChange=cficonPortInfoChange, cficonShowPorts=cficonShowPorts, cficonCfgFileCmdErrorString=cficonCfgFileCmdErrorString, cficonVsanCodePage=cficonVsanCodePage, cficonPortAddrNumTable=cficonPortAddrNumTable, cfStatsEOFErrs=cfStatsEOFErrs, cficonLinkIncidentTime=cficonLinkIncidentTime, cficonPortEntry=cficonPortEntry, cficonSwapInterfaceFailReason=cficonSwapInterfaceFailReason, cficonPortRunCfgTable=cficonPortRunCfgTable, cficonPortNumIfTable=cficonPortNumIfTable, cficonLinkIncidentClear=cficonLinkIncidentClear, cficonVsanGroup=cficonVsanGroup, cficonRunCfgModelNumber=cficonRunCfgModelNumber, cficonRunCfgTypeNumber=cficonRunCfgTypeNumber, cficonStatsEntry=cficonStatsEntry, cficonCopyEntryRowStatus=cficonCopyEntryRowStatus, cficonPortName=cficonPortName, cficonCopyFailReason=cficonCopyFailReason, cficonConfigCopyGroup=cficonConfigCopyGroup, cficonPortMapMax=cficonPortMapMax, cficonPortNumAddrTable=cficonPortNumAddrTable, portAddress=portAddress, cficonSlotReservedPN=cficonSlotReservedPN, PYSNMP_MODULE_ID=ciscoFiconMIB, cficonRunCfgSerialNumber=cficonRunCfgSerialNumber, cficonCfgFileCupNameGroup=cficonCfgFileCupNameGroup, ciscoFiconComplianceRev2=ciscoFiconComplianceRev2, cficonPortNumAddrEntry=cficonPortNumAddrEntry, cficonRlirErlFcId=cficonRlirErlFcId, cficonLinkIncidentGroup=cficonLinkIncidentGroup, cficonVsanUserAlertMode=cficonVsanUserAlertMode, ciscoFiconMIBNotifications=ciscoFiconMIBNotifications, cficonConfigCopyTable=cficonConfigCopyTable, cficonVsanHostControl=cficonVsanHostControl, cficonPortSwapGroup=cficonPortSwapGroup, cficonPortMap6=cficonPortMap6, cficonCfgFileTable=cficonCfgFileTable, cficonVsanClearAllegience=cficonVsanClearAllegience, cficonRunCfgUnitType=cficonRunCfgUnitType, cficonPortGroup=cficonPortGroup, cficonRlirErlTable=cficonRlirErlTable, cficonVsanHostControlClkAlrtMode=cficonVsanHostControlClkAlrtMode, cficonRunCfgStatus=cficonRunCfgStatus, cficonCopyState=cficonCopyState, cficonDefaultPortBlockGroup=cficonDefaultPortBlockGroup, cficonVsanCupName=cficonVsanCupName, cficonPortAddrNumEntry=cficonPortAddrNumEntry, cficonVsanEntry=cficonVsanEntry, cficonProhibitPortNumbers=cficonProhibitPortNumbers, cficonPortRunCfgAddr=cficonPortRunCfgAddr, cficonInterfaceSwapNextIndex=cficonInterfaceSwapNextIndex, cficonConfigCopyIndex=cficonConfigCopyIndex, cficonAutoSaveStateGroup=cficonAutoSaveStateGroup, cficonRlirErlGroup=cficonRlirErlGroup, ciscoFiconPortMap=ciscoFiconPortMap, cficonSlotIndex=cficonSlotIndex, cficonPortSwapEntry=cficonPortSwapEntry, cficonSwapInterfaceEntryStatus=cficonSwapInterfaceEntryStatus, cficonRlirErlFormat=cficonRlirErlFormat, cficonNotificationGroup=cficonNotificationGroup, cficonPortTable=cficonPortTable, cficonPortAddrPortAddr=cficonPortAddrPortAddr, cficonRlirErlRegType=cficonRlirErlRegType, cficonSwapInterfaceIndexFirst=cficonSwapInterfaceIndexFirst, ciscoFiconComplianceRev1=ciscoFiconComplianceRev1, cficonPortRunCfgBlock=cficonPortRunCfgBlock, ciscoFiconMIBObjects=ciscoFiconMIBObjects, cficonDirHistPortNumbers=cficonDirHistPortNumbers, cficonSwapPortEntryStatus=cficonSwapPortEntryStatus, cficonPortSwapTable=cficonPortSwapTable, cficonCfgFileCupName=cficonCfgFileCupName, cficonPortMap5=cficonPortMap5, cficonLogicReservedPN=cficonLogicReservedPN, cficonCfgFileDescr=cficonCfgFileDescr, cficonPortNumIfGroup=cficonPortNumIfGroup, ciscoFiconCompliances=ciscoFiconCompliances, cfStatsDispErrsOutOfFrame=cfStatsDispErrsOutOfFrame, cficonDefaultPortBlock=cficonDefaultPortBlock, cficonSwapPortNumberFirst=cficonSwapPortNumberFirst, ciscoFiconGroups=ciscoFiconGroups, cficonSwapPortNumberSecond=cficonSwapPortNumberSecond, cficonVsanHostOrDefaultTime=cficonVsanHostOrDefaultTime, cficonPortMap4=cficonPortMap4, cficonCfgFileCupNameTable=cficonCfgFileCupNameTable, cficonPortRunCfgGroup=cficonPortRunCfgGroup, cficonPortMapGroup=cficonPortMapGroup, cficonPortRunCfgEntry=cficonPortRunCfgEntry, cficonVsanKeyCounter=cficonVsanKeyCounter, cficonRunCfgPortId=cficonRunCfgPortId, cficonPortMapTable=cficonPortMapTable, cficonPortMapObj=cficonPortMapObj, cifconShowPortGroup=cifconShowPortGroup, cficonPortRunCfgName=cficonPortRunCfgName, cficonCfgFileStatus=cficonCfgFileStatus, ciscoFiconConfig=ciscoFiconConfig, cficonSwapInterfaceSystemError=cficonSwapInterfaceSystemError, cficonPortMapEntry=cficonPortMapEntry, cficonDirHistKeyCounter=cficonDirHistKeyCounter, cficonPortNumIfEntry=cficonPortNumIfEntry)
