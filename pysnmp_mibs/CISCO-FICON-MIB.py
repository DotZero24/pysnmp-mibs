...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FICON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:29:17 2025
...
_CficonVsanHostControl_Type.__name__ = "TruthValue"
...
_CficonVsanHostControlSwOffline_Type.__name__ = "TruthValue"
...
_CficonVsanHostControlClkAlrtMode_Type.__name__ = "TruthValue"
...
_CficonVsanSnmpControl_Type.__name__ = "TruthValue"
...
_CficonVsanAutoSavePortAddrCfg_Type.__name__ = "TruthValue"
...
_CficonVsanEnableCup_Type.__name__ = "TruthValue"
...
_CficonVsanUserAlertMode_Type.__name__ = "TruthValue"
...
_CficonVsanHostOrDefaultTime_Type.__name__ = "TruthValue"
...
_CficonSetHostTimeControl_Type.__name__ = "TruthValue"
...
_CficonAutoSaveState_Type.__name__ = "TruthValue"
...
ciscoFiconCompliance.setObjects(
      *(("CISCO-FICON-MIB", "cficonPortSwapGroup"),
        ("CISCO-FICON-MIB", "cficonVsanGroup"),
        ("CISCO-FICON-MIB", "cficonPortGroup"),
        ("CISCO-FICON-MIB", "cficonPortRunCfgGroup"),
        ("CISCO-FICON-MIB", "cficonCfgFileGroup"),
        ("CISCO-FICON-MIB", "cficonPortNumIfGroup"),
        ("CISCO-FICON-MIB", "cficonPortAddrNumGroup"),
        ("CISCO-FICON-MIB", "cficonPortNumAddrGroup"),
        ("CISCO-FICON-MIB", "cficonDirHistGroup"),
        ("CISCO-FICON-MIB", "cficonStatsGroup"),
        ("CISCO-FICON-MIB", "cifconShowPortGroup"),
        ("CISCO-FICON-MIB", "cficonLinkIncidentGroup"),
        ("CISCO-FICON-MIB", "cficonCfgFileCupNameGroup"),
        ("CISCO-FICON-MIB", "cficonConfigCopyGroup"),
        ("CISCO-FICON-MIB", "cficonAutoSaveStateGroup"),
        ("CISCO-FICON-MIB", "cficonPortMapGroup"),
        ("CISCO-FICON-MIB", "cficonNotificationGroup"))
)
if mibBuilder.loadTexts:
...
ciscoFiconComplianceRev1.setObjects(
      *(("CISCO-FICON-MIB", "cficonPortSwapGroup"),
        ("CISCO-FICON-MIB", "cficonVsanGroup"),
        ("CISCO-FICON-MIB", "cficonPortGroup"),
        ("CISCO-FICON-MIB", "cficonPortRunCfgGroup"),
        ...
        ("CISCO-FICON-MIB", "cficonAutoSaveStateGroup"),
        ("CISCO-FICON-MIB", "cficonNotificationGroup"),
        ("CISCO-FICON-MIB", "cficonPortMapGroupRev1"),
        ("CISCO-FICON-MIB", "cficonReservedPortNumGroup"),
        ("CISCO-FICON-MIB", "cficonRlirErlGroup"))
)
if mibBuilder.loadTexts:
...
ciscoFiconComplianceRev2.setObjects(
      *(("CISCO-FICON-MIB", "cficonPortSwapGroup"),
        ("CISCO-FICON-MIB", "cficonVsanGroup"),
        ("CISCO-FICON-MIB", "cficonPortGroup"),
        ("CISCO-FICON-MIB", "cficonPortRunCfgGroup"),
        ...
        ("CISCO-FICON-MIB", "cficonReservedPortNumGroup"),
        ("CISCO-FICON-MIB", "cficonRlirErlGroup"),
        ("CISCO-FICON-MIB", "cficonInterfaceSwapGroup"))
)
if mibBuilder.loadTexts:
...
ciscoFiconComplianceRev3.setObjects(
      *(("CISCO-FICON-MIB", "cficonPortSwapGroup"),
        ("CISCO-FICON-MIB", "cficonVsanGroup"),
        ("CISCO-FICON-MIB", "cficonPortGroup"),
        ("CISCO-FICON-MIB", "cficonPortRunCfgGroup"),
