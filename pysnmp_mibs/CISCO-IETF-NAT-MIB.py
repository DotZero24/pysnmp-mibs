...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-IETF-NAT-MIB
...
mibBuilder.exportSymbols("CISCO-IETF-NAT-MIB", cnatConfTimeoutOther=cnatConfTimeoutOther, cnatAddrBindLocalAddr=cnatAddrBindLocalAddr, ciscoNatMIBGroups=ciscoNatMIBGroups, cnatSessionOrigPrivateAddr=cnatSessionOrigPrivateAddr, cnatConfEntry=cnatConfEntry, cnatSessionBindId=cnatSessionBindId, cnatBind=cnatBind, cnatConfStaticAddrMapStorageType=cnatConfStaticAddrMapStorageType, cnatAddrPortBindNumberOfEntries=cnatAddrPortBindNumberOfEntries, cnatConfStorageType=cnatConfStorageType, cnatAddrPortBindProtocol=cnatAddrPortBindProtocol, cnatProtocolStatsTable=cnatProtocolStatsTable, cnatAddrMapStatsAddrUsed=cnatAddrMapStatsAddrUsed, cnatAddrMapStatsMapName=cnatAddrMapStatsMapName, cnatStatistics=cnatStatistics, cnatAddrMapStatsInTranslate=cnatAddrMapStatsInTranslate, cnatConfTimeoutIcmpIdle=cnatConfTimeoutIcmpIdle, cnatAddrBindTable=cnatAddrBindTable, cnatConfMaxBindIdleTime=cnatConfMaxBindIdleTime, cnatConfStaticLocalPortFrom=cnatConfStaticLocalPortFrom, cnatAddrPortBindEntry=cnatAddrPortBindEntry, PYSNMP_MODULE_ID=ciscoIetfNatMIB, cnatConfServiceType=cnatConfServiceType, ciscoNatMIBCompliance=ciscoNatMIBCompliance, cnatAddrBindGlobalAddr=cnatAddrBindGlobalAddr, cnatConfStaticAddrMapType=cnatConfStaticAddrMapType, cnatSessionTransPublicPort=cnatSessionTransPublicPort, cnatAddrPortBindType=cnatAddrPortBindType, cnatConfDynLocalPortTo=cnatConfDynLocalPortTo, cnatConfDynAddrMapStorageType=cnatConfDynAddrMapStorageType, cnatConfDynAddressMapType=cnatConfDynAddressMapType, cnatConfDynAddrMapName=cnatConfDynAddrMapName, cnatSessionTransPrivatePort=cnatSessionTransPrivatePort, cnatSessionOrigPublicPort=cnatSessionOrigPublicPort, cnatSessionCurrentIdletime=cnatSessionCurrentIdletime, cnatAddrPortBindSessionCount=cnatAddrPortBindSessionCount, cnatSessionOrigPrivatePort=cnatSessionOrigPrivatePort, cnatSessionDirection=cnatSessionDirection, cnatInterfacePktsOut=cnatInterfacePktsOut, cnatAddrMapStatsConfName=cnatAddrMapStatsConfName, cnatStatsGroup=cnatStatsGroup, ciscoNatMIBNotifications=ciscoNatMIBNotifications, cnatConfDynAddrMapTable=cnatConfDynAddrMapTable, cnatConfigGroup=cnatConfigGroup, cnatProtocolStatsEntry=cnatProtocolStatsEntry, cnatAddrMapStatsEntry=cnatAddrMapStatsEntry, cnatInterfaceIndex=cnatInterfaceIndex, cnatConfTable=cnatConfTable, cnatInterfaceTable=cnatInterfaceTable, cnatConfStaticProtocol=cnatConfStaticProtocol, cnatAddrBindConfName=cnatAddrBindConfName, cnatSessionOrigPublicAddr=cnatSessionOrigPublicAddr, cnatInterfaceEntry=cnatInterfaceEntry, cnatConfTimeoutUdpIdle=cnatConfTimeoutUdpIdle, cnatConfDynProtocol=cnatConfDynProtocol, cnatConfStaticAddrMapTable=cnatConfStaticAddrMapTable, cnatConfTimeoutTcpNeg=cnatConfTimeoutTcpNeg, cnatBindGroup=cnatBindGroup, cnatAddrMapStatsOutTranslate=cnatAddrMapStatsOutTranslate, cnatConfStaticGlobalAddrFrom=cnatConfStaticGlobalAddrFrom, cnatInterfaceStorageType=cnatInterfaceStorageType, cnatAddrPortBindGlobalPort=cnatAddrPortBindGlobalPort, ciscoIetfNatMIB=ciscoIetfNatMIB, cnatSessionOutTranslate=cnatSessionOutTranslate, cnatConfDynLocalAddrTo=cnatConfDynLocalAddrTo, cnatAddrPortBindCurrentIdleTime=cnatAddrPortBindCurrentIdleTime, cnatConfStaticAddrMapEntry=cnatConfStaticAddrMapEntry, cnatConfDynAddrMapStatus=cnatConfDynAddrMapStatus, ciscoNatMIBObjects=ciscoNatMIBObjects, cnatConfTimeoutTcpIdle=cnatConfTimeoutTcpIdle, cnatConfDynLocalPortFrom=cnatConfDynLocalPortFrom, cnatAddrPortBindId=cnatAddrPortBindId, cnatConfStaticAddrMapName=cnatConfStaticAddrMapName, cnatConfStaticLocalPortTo=cnatConfStaticLocalPortTo, cnatInterfaceRealm=cnatInterfaceRealm, ciscoNatMIBCompliances=ciscoNatMIBCompliances, cnatProtocolStatsOutTranslate=cnatProtocolStatsOutTranslate, cnatConfStaticAddrMapStatus=cnatConfStaticAddrMapStatus, cnatConfDynAddrMapEntry=cnatConfDynAddrMapEntry, cnatAddrBindNumberOfEntries=cnatAddrBindNumberOfEntries, cnatSessionProtocolType=cnatSessionProtocolType, cnatProtocolStatsInTranslate=cnatProtocolStatsInTranslate, cnatInterfaceStatus=cnatInterfaceStatus, cnatAddrPortBindLocalPort=cnatAddrPortBindLocalPort, cnatConfDynGlobalAddrTo=cnatConfDynGlobalAddrTo, cnatAddrBindCurrentIdleTime=cnatAddrBindCurrentIdleTime, ciscoNatMIBConformance=ciscoNatMIBConformance, cnatConfDynGlobalPortFrom=cnatConfDynGlobalPortFrom, cnatAddrBindId=cnatAddrBindId, cnatConfStaticLocalAddrTo=cnatConfStaticLocalAddrTo, cnatAddrBindSessionCount=cnatAddrBindSessionCount, cnatAddrPortBindLocalAddr=cnatAddrPortBindLocalAddr, cnatProtocolStatsName=cnatProtocolStatsName, cnatConfName=cnatConfName, cnatAddrPortBindGlobalAddr=cnatAddrPortBindGlobalAddr, cnatSessionTransPrivateAddr=cnatSessionTransPrivateAddr, ciscoNatMIBNotificationPrefix=ciscoNatMIBNotificationPrefix, cnatConfStatus=cnatConfStatus, cnatConfDynGlobalAddrFrom=cnatConfDynGlobalAddrFrom, cnatProtocolStatsRejectCount=cnatProtocolStatsRejectCount, cnatConfDynGlobalPortTo=cnatConfDynGlobalPortTo, cnatAddrPortBindConfName=cnatAddrPortBindConfName, cnatSessionInTranslate=cnatSessionInTranslate, cnatAddrPortBindTable=cnatAddrPortBindTable, cnatAddrPortBindInTranslate=cnatAddrPortBindInTranslate, NATProtocolType=NATProtocolType, cnatSessionId=cnatSessionId, cnatSessionTable=cnatSessionTable, cnatInterfacePktsIn=cnatInterfacePktsIn, cnatInterfaceStatsTable=cnatInterfaceStatsTable, cnatConfStaticGlobalAddrTo=cnatConfStaticGlobalAddrTo, cnatConfStaticGlobalPortTo=cnatConfStaticGlobalPortTo, cnatConfStaticGlobalPortFrom=cnatConfStaticGlobalPortFrom, cnatConfDynLocalAddrFrom=cnatConfDynLocalAddrFrom, cnatInterfaceStatsEntry=cnatInterfaceStatsEntry, cnatAddrMapStatsTable=cnatAddrMapStatsTable, cnatAddrBindInTranslate=cnatAddrBindInTranslate, cnatAddrBindDirection=cnatAddrBindDirection, cnatSessionTransPublicAddr=cnatSessionTransPublicAddr, cnatAddrBindType=cnatAddrBindType, cnatAddrPortBindOutTranslate=cnatAddrPortBindOutTranslate, cnatAddrPortBindDirection=cnatAddrPortBindDirection, cnatSessionUpTime=cnatSessionUpTime, cnatAddrMapStatsNoResource=cnatAddrMapStatsNoResource, cnatSessionSecondBindId=cnatSessionSecondBindId, cnatAddrBindOutTranslate=cnatAddrBindOutTranslate, cnatConfMaxBindLeaseTime=cnatConfMaxBindLeaseTime, cnatSessionEntry=cnatSessionEntry, cnatConfStaticLocalAddrFrom=cnatConfStaticLocalAddrFrom, cnatAddrBindEntry=cnatAddrBindEntry, cnatConfig=cnatConfig)
