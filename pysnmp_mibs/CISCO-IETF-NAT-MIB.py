...
ModuleIdentity, Counter64, Gauge32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, MibIdentifier, mib_2, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Gauge32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "MibIdentifier", "mib-2", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("CISCO-IETF-NAT-MIB", cnatAddrPortBindNumberOfEntries=cnatAddrPortBindNumberOfEntries, cnatInterfaceStatus=cnatInterfaceStatus, cnatInterfaceStatsTable=cnatInterfaceStatsTable, cnatSessionId=cnatSessionId, cnatAddrPortBindInTranslate=cnatAddrPortBindInTranslate, cnatConfigGroup=cnatConfigGroup, cnatConfStaticLocalAddrFrom=cnatConfStaticLocalAddrFrom, cnatInterfaceTable=cnatInterfaceTable, cnatConfStaticGlobalAddrTo=cnatConfStaticGlobalAddrTo, cnatSessionTransPublicPort=cnatSessionTransPublicPort, cnatAddrBindGlobalAddr=cnatAddrBindGlobalAddr, cnatStatistics=cnatStatistics, cnatSessionBindId=cnatSessionBindId, cnatConfTimeoutTcpIdle=cnatConfTimeoutTcpIdle, cnatAddrBindEntry=cnatAddrBindEntry, ciscoNatMIBGroups=ciscoNatMIBGroups, cnatConfName=cnatConfName, cnatAddrBindId=cnatAddrBindId, cnatConfDynAddrMapTable=cnatConfDynAddrMapTable, cnatSessionTable=cnatSessionTable, cnatConfTimeoutUdpIdle=cnatConfTimeoutUdpIdle, cnatConfStaticLocalPortTo=cnatConfStaticLocalPortTo, cnatSessionOrigPrivatePort=cnatSessionOrigPrivatePort, cnatSessionSecondBindId=cnatSessionSecondBindId, cnatProtocolStatsEntry=cnatProtocolStatsEntry, cnatAddrMapStatsConfName=cnatAddrMapStatsConfName, cnatAddrBindConfName=cnatAddrBindConfName, cnatConfStaticLocalPortFrom=cnatConfStaticLocalPortFrom, ciscoNatMIBNotificationPrefix=ciscoNatMIBNotificationPrefix, ciscoIetfNatMIB=ciscoIetfNatMIB, cnatAddrMapStatsOutTranslate=cnatAddrMapStatsOutTranslate, cnatConfDynLocalPortTo=cnatConfDynLocalPortTo, cnatAddrPortBindGlobalAddr=cnatAddrPortBindGlobalAddr, cnatConfStaticLocalAddrTo=cnatConfStaticLocalAddrTo, cnatConfStaticGlobalPortFrom=cnatConfStaticGlobalPortFrom, cnatConfTimeoutTcpNeg=cnatConfTimeoutTcpNeg, cnatConfTimeoutIcmpIdle=cnatConfTimeoutIcmpIdle, cnatInterfaceIndex=cnatInterfaceIndex, cnatSessionOrigPrivateAddr=cnatSessionOrigPrivateAddr, cnatProtocolStatsRejectCount=cnatProtocolStatsRejectCount, cnatAddrPortBindLocalAddr=cnatAddrPortBindLocalAddr, cnatConfDynGlobalPortFrom=cnatConfDynGlobalPortFrom, cnatSessionOrigPublicAddr=cnatSessionOrigPublicAddr, cnatAddrPortBindLocalPort=cnatAddrPortBindLocalPort, cnatAddrBindCurrentIdleTime=cnatAddrBindCurrentIdleTime, cnatConfDynLocalPortFrom=cnatConfDynLocalPortFrom, cnatAddrBindNumberOfEntries=cnatAddrBindNumberOfEntries, cnatConfDynGlobalPortTo=cnatConfDynGlobalPortTo, PYSNMP_MODULE_ID=ciscoIetfNatMIB, cnatBind=cnatBind, cnatConfStaticAddrMapEntry=cnatConfStaticAddrMapEntry, cnatSessionProtocolType=cnatSessionProtocolType, cnatConfDynAddrMapName=cnatConfDynAddrMapName, cnatConfStaticAddrMapStorageType=cnatConfStaticAddrMapStorageType, cnatConfStorageType=cnatConfStorageType, cnatConfTable=cnatConfTable, cnatAddrBindOutTranslate=cnatAddrBindOutTranslate, cnatConfDynGlobalAddrTo=cnatConfDynGlobalAddrTo, cnatAddrPortBindType=cnatAddrPortBindType, ciscoNatMIBObjects=ciscoNatMIBObjects, cnatConfDynAddrMapStorageType=cnatConfDynAddrMapStorageType, cnatSessionInTranslate=cnatSessionInTranslate, cnatAddrBindType=cnatAddrBindType, cnatConfStaticAddrMapName=cnatConfStaticAddrMapName, cnatAddrMapStatsInTranslate=cnatAddrMapStatsInTranslate, cnatConfDynLocalAddrTo=cnatConfDynLocalAddrTo, cnatConfMaxBindLeaseTime=cnatConfMaxBindLeaseTime, cnatAddrMapStatsTable=cnatAddrMapStatsTable, ciscoNatMIBNotifications=ciscoNatMIBNotifications, cnatSessionTransPrivateAddr=cnatSessionTransPrivateAddr, cnatAddrPortBindTable=cnatAddrPortBindTable, cnatAddrBindInTranslate=cnatAddrBindInTranslate, cnatAddrBindDirection=cnatAddrBindDirection, NATProtocolType=NATProtocolType, cnatAddrBindLocalAddr=cnatAddrBindLocalAddr, cnatConfStaticAddrMapTable=cnatConfStaticAddrMapTable, cnatConfStaticAddrMapType=cnatConfStaticAddrMapType, cnatAddrPortBindOutTranslate=cnatAddrPortBindOutTranslate, cnatConfStaticProtocol=cnatConfStaticProtocol, cnatAddrPortBindConfName=cnatAddrPortBindConfName, cnatSessionOutTranslate=cnatSessionOutTranslate, cnatAddrMapStatsAddrUsed=cnatAddrMapStatsAddrUsed, ciscoNatMIBCompliance=ciscoNatMIBCompliance, cnatSessionDirection=cnatSessionDirection, cnatConfDynAddrMapStatus=cnatConfDynAddrMapStatus, cnatConfig=cnatConfig, cnatAddrPortBindId=cnatAddrPortBindId, cnatAddrMapStatsMapName=cnatAddrMapStatsMapName, ciscoNatMIBCompliances=ciscoNatMIBCompliances, cnatInterfaceStorageType=cnatInterfaceStorageType, cnatConfDynLocalAddrFrom=cnatConfDynLocalAddrFrom, cnatSessionUpTime=cnatSessionUpTime, cnatConfDynProtocol=cnatConfDynProtocol, cnatAddrMapStatsEntry=cnatAddrMapStatsEntry, cnatSessionOrigPublicPort=cnatSessionOrigPublicPort, cnatAddrBindTable=cnatAddrBindTable, cnatAddrPortBindSessionCount=cnatAddrPortBindSessionCount, cnatSessionTransPublicAddr=cnatSessionTransPublicAddr, cnatConfServiceType=cnatConfServiceType, ciscoNatMIBConformance=ciscoNatMIBConformance, cnatProtocolStatsOutTranslate=cnatProtocolStatsOutTranslate, cnatInterfaceStatsEntry=cnatInterfaceStatsEntry, cnatConfDynGlobalAddrFrom=cnatConfDynGlobalAddrFrom, cnatInterfaceRealm=cnatInterfaceRealm, cnatConfTimeoutOther=cnatConfTimeoutOther, cnatSessionTransPrivatePort=cnatSessionTransPrivatePort, cnatConfStaticAddrMapStatus=cnatConfStaticAddrMapStatus, cnatConfMaxBindIdleTime=cnatConfMaxBindIdleTime, cnatProtocolStatsInTranslate=cnatProtocolStatsInTranslate, cnatConfDynAddrMapEntry=cnatConfDynAddrMapEntry, cnatConfEntry=cnatConfEntry, cnatInterfacePktsIn=cnatInterfacePktsIn, cnatConfDynAddressMapType=cnatConfDynAddressMapType, cnatProtocolStatsName=cnatProtocolStatsName, cnatInterfacePktsOut=cnatInterfacePktsOut, cnatConfStatus=cnatConfStatus, cnatBindGroup=cnatBindGroup, cnatAddrPortBindDirection=cnatAddrPortBindDirection, cnatAddrMapStatsNoResource=cnatAddrMapStatsNoResource, cnatConfStaticGlobalAddrFrom=cnatConfStaticGlobalAddrFrom, cnatInterfaceEntry=cnatInterfaceEntry, cnatAddrPortBindCurrentIdleTime=cnatAddrPortBindCurrentIdleTime, cnatStatsGroup=cnatStatsGroup, cnatConfStaticGlobalPortTo=cnatConfStaticGlobalPortTo, cnatAddrPortBindProtocol=cnatAddrPortBindProtocol, cnatProtocolStatsTable=cnatProtocolStatsTable, cnatSessionCurrentIdletime=cnatSessionCurrentIdletime, cnatAddrPortBindGlobalPort=cnatAddrPortBindGlobalPort, cnatSessionEntry=cnatSessionEntry, cnatAddrBindSessionCount=cnatAddrBindSessionCount, cnatAddrPortBindEntry=cnatAddrPortBindEntry)
