...
hwLAGMibObjects=_HwLAGMibObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,5,25,25,1))
_HwAggLinkTable_Object=MibTable
hwAggLinkTable=_HwAggLinkTable_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,1))
if mibBuilder.loadTexts:hwAggLinkTable.setStatus(_B)
_HwAggLinkEntry_Object=MibTableRow
hwAggLinkEntry=_HwAggLinkEntry_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,1,1))
...
hwAggLinkNumber=_HwAggLinkNumber_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,1,1,1),_HwAggLinkNumber_Type())
...
hwAggLinkName=_HwAggLinkName_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,1,1,2),_HwAggLinkName_Type())
...
hwAggLinkMode=_HwAggLinkMode_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,1,1,3),_HwAggLinkMode_Type())
...
hwAggLinkPortList=_HwAggLinkPortList_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,1,1,4),_HwAggLinkPortList_Type())
...
hwAggLinkState=_HwAggLinkState_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,1,1,5),_HwAggLinkState_Type())
...
hwAggPortListSelectedPorts=_HwAggPortListSelectedPorts_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,1,1,6),_HwAggPortListSelectedPorts_Type())
...
hwAggPortListSamePartnerPorts=_HwAggPortListSamePartnerPorts_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,1,1,7),_HwAggPortListSamePartnerPorts_Type())
...
hwAggPortTable=_HwAggPortTable_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,2))
if mibBuilder.loadTexts:hwAggPortTable.setStatus(_B)
_HwAggPortEntry_Object=MibTableRow
hwAggPortEntry=_HwAggPortEntry_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,2,1))
...
hwAggPortIndex=_HwAggPortIndex_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,2,1,1),_HwAggPortIndex_Type())
...
hwAggPortNotAttachedReason=_HwAggPortNotAttachedReason_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,2,1,2),_HwAggPortNotAttachedReason_Type())
...
hwAggPortLacpState=_HwAggPortLacpState_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,2,1,3),_HwAggPortLacpState_Type())
...
hwAggPortNotAttachedString=_HwAggPortNotAttachedString_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,2,1,4),_HwAggPortNotAttachedString_Type())
...
hwAggResourceAllocationValue=_HwAggResourceAllocationValue_Object((1,3,6,1,4,1,43,45,1,5,25,25,1,3),_HwAggResourceAllocationValue_Type())
...
hwLAGMibNotifications=_HwLAGMibNotifications_ObjectIdentity((1,3,6,1,4,1,43,45,1,5,25,25,2))
_HwLAGMibConformance_ObjectIdentity=ObjectIdentity
hwLAGMibConformance=_HwLAGMibConformance_ObjectIdentity((1,3,6,1,4,1,43,45,1,5,25,25,3))
_HwLAGMibCompliances_ObjectIdentity=ObjectIdentity
hwLAGMibCompliances=_HwLAGMibCompliances_ObjectIdentity((1,3,6,1,4,1,43,45,1,5,25,25,3,1))
_HwLAGMibGroup_ObjectIdentity=ObjectIdentity
hwLAGMibGroup=_HwLAGMibGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,5,25,25,3,2))
hwLAGMibObjectGroup=ObjectGroup((1,3,6,1,4,1,43,45,1,5,25,25,3,2,1))
...
hwLAGMibCompliance=ModuleCompliance((1,3,6,1,4,1,43,45,1,5,25,25,3,1,1))
