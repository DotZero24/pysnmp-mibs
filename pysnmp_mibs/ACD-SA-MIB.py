...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/accedian/ACD-SA-MIB
...
acdSa.setRevisions(('2016-09-23 01:00', '2016-06-16 01:00', '2016-05-26 01:00', '2011-12-21 01:00', '2011-03-15 01:00',))
if mibBuilder.loadTexts: acdSa.setLastUpdated('201609230100Z')
...
class AcdSaValidFlag(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("valid", 1), ("adjusted", 2), ("pending", 3), ("invalid", 4))
...
acdSaServiceHistCounterPeriodIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 22420, 2, 12, 1, 2, 2, 1, 1), Unsigned32()).setMaxAccess("readonly")
...
acdSaServiceHistCounterAvailRatio = MibTableColumn((1, 3, 6, 1, 4, 1, 22420, 2, 12, 1, 2, 2, 1, 7), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 100))).setMaxAccess("readonly")
...
acdSaMetricHistCounterID = MibTableColumn((1, 3, 6, 1, 4, 1, 22420, 2, 12, 1, 2, 5, 1, 1), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: acdSaMetricHistCounterID.setStatus('current')
acdSaMetricHistCounterPeriodIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 22420, 2, 12, 1, 2, 5, 1, 2), Unsigned32()).setMaxAccess("readonly")
...
acdSaMetricHistCounterGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 22420, 2, 12, 2, 2, 7)).setObjects(("ACD-SA-MIB", "acdSaMetricHistCounterID"), ("ACD-SA-MIB", "acdSaMetricHistCounterPeriodIndex"), ("ACD-SA-MIB", "acdSaMetricHistCounterIntervalEnd"), ("ACD-SA-MIB", "acdSaMetricHistCounterValidFlag"), ("ACD-SA-MIB", "acdSaMetricHistCounterUaTime"), ("ACD-SA-MIB", "acdSaMetricHistCounterChliTime"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
mibBuilder.exportSymbols("ACD-SA-MIB", acdSaServiceMonoCounterGaps=acdSaServiceMonoCounterGaps, acdSaServiceCounterAvailRatio=acdSaServiceCounterAvailRatio, acdSaServiceMonoCounterValidFlag=acdSaServiceMonoCounterValidFlag, acdSaServiceStatusAdminState=acdSaServiceStatusAdminState, acdSaConformance=acdSaConformance, acdSaMetricHistCounterID=acdSaMetricHistCounterID, acdSaServiceCounterValidFlag=acdSaServiceCounterValidFlag, acdSaServiceHistCounterValidFlag=acdSaServiceHistCounterValidFlag, acdSaMetricCounterTable=acdSaMetricCounterTable, acdSaServiceCounterChliTime=acdSaServiceCounterChliTime, acdSaMetricMonoCounterUaTime=acdSaMetricMonoCounterUaTime, acdSaServiceCounterEntry=acdSaServiceCounterEntry, acdSaMetricHistCounterValidFlag=acdSaMetricHistCounterValidFlag, acdSaCounter=acdSaCounter, acdSaConfig=acdSaConfig, acdSaMetricHistCounterPeriodIndex=acdSaMetricHistCounterPeriodIndex, acdSaMetricConfigRowStatus=acdSaMetricConfigRowStatus, acdSaServiceConfigName=acdSaServiceConfigName, acdSaGroups=acdSaGroups, acdSaServiceHistCounterIntervalEnd=acdSaServiceHistCounterIntervalEnd, acdSaMetricConfigType=acdSaMetricConfigType, acdSaMetricHistCounterUaTime=acdSaMetricHistCounterUaTime, acdSaServiceHistCounterUaTime=acdSaServiceHistCounterUaTime, acdSaMetricMonoCounterValidFlag=acdSaMetricMonoCounterValidFlag, acdSaMetricMonoCounterEntry=acdSaMetricMonoCounterEntry, AcdSaMetricType=AcdSaMetricType, acdSaServiceMonoCounterChliTime=acdSaServiceMonoCounterChliTime, acdSaServiceConfigEntry=acdSaServiceConfigEntry, acdSaServiceConfigReportingPeriod=acdSaServiceConfigReportingPeriod, acdSaMetricConfigTable=acdSaMetricConfigTable, acdSaMetricConfigSrcName=acdSaMetricConfigSrcName, acdSaServiceHistCounterLargestGap=acdSaServiceHistCounterLargestGap, acdSaServiceHistCounterChliRatio=acdSaServiceHistCounterChliRatio, acdSaServiceHistCounterGroup=acdSaServiceHistCounterGroup, acdSaServiceCounterUaTime=acdSaServiceCounterUaTime, acdSaServiceMonoCounterMaintTime=acdSaServiceMonoCounterMaintTime, acdSaServiceStatusName=acdSaServiceStatusName, acdSaServiceConfigTimeInterval=acdSaServiceConfigTimeInterval, acdSaServiceStatusEntry=acdSaServiceStatusEntry, acdSaServiceCounterMaintTime=acdSaServiceCounterMaintTime, acdSaServiceHistCounterUpTime=acdSaServiceHistCounterUpTime, acdSaServiceCounterChliRatio=acdSaServiceCounterChliRatio, acdSaServiceStatusOperState=acdSaServiceStatusOperState, acdSaServiceIndex=acdSaServiceIndex, acdSaMetricCounterValidFlag=acdSaMetricCounterValidFlag, acdSaServiceMonoCounterUaTime=acdSaServiceMonoCounterUaTime, acdSaServiceConfigUaWindowSize=acdSaServiceConfigUaWindowSize, acdSaServiceConfigGroup=acdSaServiceConfigGroup, acdSaMetricIndex=acdSaMetricIndex, acdSaServiceStatusTable=acdSaServiceStatusTable, AcdSaOperStateFlag=AcdSaOperStateFlag, acdSaServiceStatusNbrMetrics=acdSaServiceStatusNbrMetrics, acdSaServiceCounterUpTime=acdSaServiceCounterUpTime, acdSaServiceMonoCounterTable=acdSaServiceMonoCounterTable, acdSaMetricHistCounterTable=acdSaMetricHistCounterTable, acdSaMetricMonoCounterGroup=acdSaMetricMonoCounterGroup, acdSaServiceMonoCounterEntry=acdSaServiceMonoCounterEntry, acdSaServiceHistCounterAvailRatio=acdSaServiceHistCounterAvailRatio, acdSaCompliance=acdSaCompliance, acdSaServiceHistCounterTable=acdSaServiceHistCounterTable, acdSaServiceHistCounterChliTime=acdSaServiceHistCounterChliTime, acdSaMetricCounterChliTime=acdSaMetricCounterChliTime, acdSaServiceConfigHliWindowSize=acdSaServiceConfigHliWindowSize, acdSaMetricConfigGroup=acdSaMetricConfigGroup, acdSaMetricConfigEntry=acdSaMetricConfigEntry, acdSaMetricCounterUaTime=acdSaMetricCounterUaTime, acdSaMetricHistCounterEntry=acdSaMetricHistCounterEntry, acdSaServiceStatusGroup=acdSaServiceStatusGroup, acdSaServiceMonoCounterAvailRatio=acdSaServiceMonoCounterAvailRatio, acdSaServiceCounterPeriodIndex=acdSaServiceCounterPeriodIndex, acdSaMetricCounterEntry=acdSaMetricCounterEntry, acdSaServiceConfigRowStatus=acdSaServiceConfigRowStatus, acdSaMetricHistCounterChliTime=acdSaMetricHistCounterChliTime, acdSaNotifications=acdSaNotifications, acdSaMIBObjects=acdSaMIBObjects, acdSaServiceConfigTable=acdSaServiceConfigTable, acdSaServiceStatusID=acdSaServiceStatusID, acdSaMetricConfigThreshold=acdSaMetricConfigThreshold, acdSaServiceCounterGroup=acdSaServiceCounterGroup, acdSaServiceHistCounterMaintTime=acdSaServiceHistCounterMaintTime, acdSaServiceMonoCounterUpTime=acdSaServiceMonoCounterUpTime, acdSaMetricMonoCounterChliTime=acdSaMetricMonoCounterChliTime, acdSaMetricConfigName=acdSaMetricConfigName, acdSaStatus=acdSaStatus, acdSaServiceCounterTable=acdSaServiceCounterTable, acdSaServiceCounterLargestGap=acdSaServiceCounterLargestGap, acdSaMetricHistCounterGroup=acdSaMetricHistCounterGroup, AcdSaAdminStateFlag=AcdSaAdminStateFlag, AcdSaValidFlag=AcdSaValidFlag, acdSaServiceHistCounterGaps=acdSaServiceHistCounterGaps, acdSa=acdSa, acdSaCompliances=acdSaCompliances, acdSaServiceCounterGaps=acdSaServiceCounterGaps, acdSaServiceHistCounterPeriodIndex=acdSaServiceHistCounterPeriodIndex, acdSaServiceMonoCounterChliRatio=acdSaServiceMonoCounterChliRatio, acdSaServiceConfigAdminState=acdSaServiceConfigAdminState, acdSaMetricHistCounterIntervalEnd=acdSaMetricHistCounterIntervalEnd, acdSaMetricCounterGroup=acdSaMetricCounterGroup, acdSaServiceMonoCounterGroup=acdSaServiceMonoCounterGroup, acdSaServiceHistCounterEntry=acdSaServiceHistCounterEntry, acdSaServiceMonoCounterLargestGap=acdSaServiceMonoCounterLargestGap, PYSNMP_MODULE_ID=acdSa, acdSaMetricMonoCounterTable=acdSaMetricMonoCounterTable)
