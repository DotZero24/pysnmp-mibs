# SNMP MIB module (LANCOM-DNS-RESOLVER-CONTROL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-DNS-RESOLVER-CONTROL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:20:19 2025
...
agentResCtlAdminMode = _AgentResCtlAdminMode_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 1),
...
agentResCtlDefDomainName = _AgentResCtlDefDomainName_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 2),
...
agentResCtlCacheFlushStatus = _AgentResCtlCacheFlushStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 3),
...
agentResCtlRequestTimeout = _AgentResCtlRequestTimeout_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 4),
...
agentResCtlRequestRetransmits = _AgentResCtlRequestRetransmits_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 5),
...
agentResCtlDomainListTable = _AgentResCtlDomainListTable_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 6)
)
if mibBuilder.loadTexts:
...
agentResCtlDomainListEntry = _AgentResCtlDomainListEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 6, 1)
)
agentResCtlDomainListEntry.setIndexNames(
    (0, "LANCOM-DNS-RESOLVER-CONTROL-MIB", "agentResCtlDomainListName"),
)
if mibBuilder.loadTexts:
...
agentResCtlDomainListName = _AgentResCtlDomainListName_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 6, 1, 1),
...
agentResCtlDomainListNameStatus = _AgentResCtlDomainListNameStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 6, 1, 2),
...
agentResCtlSourceInterface = _AgentResCtlSourceInterface_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 7),
...
class _AgentResCtlServicePortSrcInterface_Type(Integer32):
    """Custom type agentResCtlServicePortSrcInterface based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentResCtlServicePortSrcInterface_Type.__name__ = "Integer32"
_AgentResCtlServicePortSrcInterface_Object = MibScalar
agentResCtlServicePortSrcInterface = _AgentResCtlServicePortSrcInterface_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 1, 8),
    _AgentResCtlServicePortSrcInterface_Type()
)
agentResCtlServicePortSrcInterface.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentResCtlServicePortSrcInterface.setStatus("current")
_AgentResCtlServConfig_ObjectIdentity = ObjectIdentity
agentResCtlServConfig = _AgentResCtlServConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 2)
)
_AgentResCtlServConfigTable_Object = MibTable
agentResCtlServConfigTable = _AgentResCtlServConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 2, 1)
)
if mibBuilder.loadTexts:
...
agentResCtlConfigIPEntry = _AgentResCtlConfigIPEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 2, 1, 1)
)
agentResCtlConfigIPEntry.setIndexNames(
    (0, "LANCOM-DNS-RESOLVER-CONTROL-MIB", "agentResCtlDnsNameServerIPType"),
    (0, "LANCOM-DNS-RESOLVER-CONTROL-MIB", "agentResCtlDnsNameServerIP"),
)
if mibBuilder.loadTexts:
...
agentResCtlDnsNameServerIPType = _AgentResCtlDnsNameServerIPType_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 2, 1, 1, 1),
...
agentResCtlDnsNameServerIP = _AgentResCtlDnsNameServerIP_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 2, 1, 1, 2),
...
agentResCtlDnsNameServerStatus = _AgentResCtlDnsNameServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 2, 1, 1, 3),
...
agentResCtlStaticServConfigTable = _AgentResCtlStaticServConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 3, 1)
)
if mibBuilder.loadTexts:
...
agentResCtlStaticServEntry = _AgentResCtlStaticServEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 3, 1, 1)
)
agentResCtlStaticServEntry.setIndexNames(
    (0, "LANCOM-DNS-RESOLVER-CONTROL-MIB", "agentResCtlStaticHostName"),
    (0, "LANCOM-DNS-RESOLVER-CONTROL-MIB", "agentResCtlStaticIPAddress"),
)
if mibBuilder.loadTexts:
...
agentResCtlStaticHostName = _AgentResCtlStaticHostName_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 3, 1, 1, 1),
...
agentResCtlStaticIPAddress = _AgentResCtlStaticIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 3, 1, 1, 2),
...
agentResCtlStaticNameServerStatus = _AgentResCtlStaticNameServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 37, 1, 3, 1, 1, 3),
...
mibBuilder.exportSymbols(
    "LANCOM-DNS-RESOLVER-CONTROL-MIB",
    **{"DnsCacheEntryType": DnsCacheEntryType,
       ...
       "agentResCtlServicePortSrcInterface": agentResCtlServicePortSrcInterface,
