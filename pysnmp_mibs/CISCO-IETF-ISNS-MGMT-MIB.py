...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-ISNS-MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:43:26 2025
...
_CIsnsSrvrInstEnblCntrlNdeMgtScn_Type.__name__ = "TruthValue"
...
_CIsnsDdsStatus_Type.__name__ = "CIsnsDdsStatusId"
...
cIsnsIscsiServerComplianceV1.setObjects(
      *(("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerAttributesGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerNextIdxGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerIscsiCntlNodeGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerIscsiDdsDdObjGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerRegIscsiObjGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsNotificationObjGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerNotificationGroup"))
)
if mibBuilder.loadTexts:
...
cIsnsIscsiClientComplianceV1.setObjects(
      *(("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsClientAttributesGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsNotificationObjGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsClientNotificationGroup"))
)
if mibBuilder.loadTexts:
...
cIsnsIfcpServerComplianceV1.setObjects(
      *(("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerAttributesGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerNextIdxGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerIfcpCntlNodeGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerIfcpDdsDdObjGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerRegIfcpObjGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsNotificationObjGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerNotificationGroup"))
)
if mibBuilder.loadTexts:
...
cIsnsIfcpClientComplianceV1.setObjects(
      *(("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsClientAttributesGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsNotificationObjGroup"),
        ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsClientNotificationGroup"))
)
...
cIsnsServerCountStatsCompliance.setObjects(
    ("CISCO-IETF-ISNS-MGMT-MIB", "cIsnsServerNumObjGroup")
)
if mibBuilder.loadTexts:
