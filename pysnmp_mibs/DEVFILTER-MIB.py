...
mibBuilder.exportSymbols("DEVFILTER-MIB", aniDevFilterPermission=aniDevFilterPermission, aniDevFilterIpDestEnd=aniDevFilterIpDestEnd, aniDevFilterIfIndex=aniDevFilterIfIndex, aniDevFilterIpDaddr=aniDevFilterIpDaddr, aniDevFilterIpOptions=aniDevFilterIpOptions, aniDevFilterIpSecOptions=aniDevFilterIpSecOptions, aniDevFilterLlcDSAP=aniDevFilterLlcDSAP, aniDevFilterLlcSSAP=aniDevFilterLlcSSAP, aniDevFilterIpSmask=aniDevFilterIpSmask, aniDevFilterSourceMac=aniDevFilterSourceMac, aniDevFilterUserPriorityLo=aniDevFilterUserPriorityLo, aniDevFilterEnetType=aniDevFilterEnetType, aniDevFilterLlcControl=aniDevFilterLlcControl, aniDevFilterActivationState=aniDevFilterActivationState, aniDevFilterIfIdentifier=aniDevFilterIfIdentifier, aniDevFilterVlanIdStart=aniDevFilterVlanIdStart, aniDevFilterVlanIdEnd=aniDevFilterVlanIdEnd, aniDevFilterIfFlag=aniDevFilterIfFlag, aniDevFilterRowStatus=aniDevFilterRowStatus, aniDevFilterIcmpMsgType=aniDevFilterIcmpMsgType, aniDevFilterIpProtocol=aniDevFilterIpProtocol, aniDevFilterIdentifier=aniDevFilterIdentifier, aniDevFilterName=aniDevFilterName, aniDevFilterIpDmask=aniDevFilterIpDmask, aniDevFilterIcmpSubcode=aniDevFilterIcmpSubcode, aniDevFilterIfEntry=aniDevFilterIfEntry, aniDevFilterIpSourceEnd=aniDevFilterIpSourceEnd, aniDevFilterIpSaddr=aniDevFilterIpSaddr, aniDevFilterIpDestStart=aniDevFilterIpDestStart, aniDevFilterPriority=aniDevFilterPriority, aniDevFilterLocalCode=aniDevFilterLocalCode, aniDevFilterUserPriorityHi=aniDevFilterUserPriorityHi, aniDevFilterEntry=aniDevFilterEntry, aniDevFilterTable=aniDevFilterTable, aniDevFilterIfTable=aniDevFilterIfTable, aniDevFilter=aniDevFilter, aniDevFilterIpSourceStart=aniDevFilterIpSourceStart, aniDevFilterDestMacMask=aniDevFilterDestMacMask, aniDevFilterTcpFlags=aniDevFilterTcpFlags, PYSNMP_MODULE_ID=aniDevFilter)
