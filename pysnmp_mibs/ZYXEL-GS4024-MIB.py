...
# Notes
# -----
# ASN.1 source file://mibs/zyxel/ZYXEL-GS4024-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:01:54 2025
...
radiusUdpPort = _RadiusUdpPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 13, 8, 2, 2),
    _RadiusUdpPort_Type()
)
...
radiusSharedSecret = _RadiusSharedSecret_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 8, 13, 8, 2, 3),
...
dhcpRemoteServerEntry.setIndexNames(
    (0, "ZYXEL-GS4024-MIB", "dhcpRemoteServerIp"),
)
if mibBuilder.loadTexts:
...
clusterMemberEntry.setIndexNames(
    ...
    (0, "ZYXEL-GS4024-MIB", "clusterMemberPassword"),
)
if mibBuilder.loadTexts:
