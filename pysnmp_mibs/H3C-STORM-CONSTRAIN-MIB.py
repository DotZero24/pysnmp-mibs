# SNMP MIB module (H3C-STORM-CONSTRAIN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-STORM-CONSTRAIN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:19:00 2025
...
if mibBuilder.loadTexts:
    h3cStormConstrain.setRevisions(
        ("2015-06-17 00:00",)
    )
...
h3cStormCtrlPortStatus = _H3cStormCtrlPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 1),
...
h3cStormCtrlBroadcastUnit = _H3cStormCtrlBroadcastUnit_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 2),
...
h3cStormCtrlBroadcastUpper = _H3cStormCtrlBroadcastUpper_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 3),
...
h3cStormCtrlBroadcastLower = _H3cStormCtrlBroadcastLower_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 4),
...
h3cStormCtrlMulticastUnit = _H3cStormCtrlMulticastUnit_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 5),
...
h3cStormCtrlMulticastUpper = _H3cStormCtrlMulticastUpper_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 6),
...
h3cStormCtrlMulticastLower = _H3cStormCtrlMulticastLower_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 7),
...
h3cStormCtrlUnicastUnit = _H3cStormCtrlUnicastUnit_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 8),
...
h3cStormCtrlUnicastUpper = _H3cStormCtrlUnicastUpper_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 9),
...
h3cStormCtrlUnicastLower = _H3cStormCtrlUnicastLower_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 10),
...
h3cStormCtrlRowStatus = _H3cStormCtrlRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 11),
...
h3cStormCtrlPortMode = _H3cStormCtrlPortMode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 2, 1, 1, 12),
...
h3cStormRising = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 66, 3, 1)
)
h3cStormRising.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("H3C-STORM-CONSTRAIN-MIB", "h3cStormTrapType"),
        ("H3C-STORM-CONSTRAIN-MIB", "h3cStormTrapThreshold"),
        ("H3C-STORM-CONSTRAIN-MIB", "h3cStormCtrlPortStatus"))
)
if mibBuilder.loadTexts:
