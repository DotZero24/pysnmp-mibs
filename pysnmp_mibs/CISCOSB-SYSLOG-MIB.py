...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-SYSLOG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:40:19 2025
...
class _RlSyslogLogText5_Type(DisplayString):
    """Custom type rlSyslogLogText5 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 160),
    )
...
_RlSyslogLogText5_Type.__name__ = "DisplayString"
_RlSyslogLogText5_Object = MibTableColumn
rlSyslogLogText5 = _RlSyslogLogText5_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 82, 2, 8, 1, 10),
    _RlSyslogLogText5_Type()
)
rlSyslogLogText5.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlSyslogLogText5.setStatus("current")


class _RlSyslogLogText6_Type(DisplayString):
    """Custom type rlSyslogLogText6 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 160),
    )
...
_RlSyslogLogText6_Type.__name__ = "DisplayString"
_RlSyslogLogText6_Object = MibTableColumn
rlSyslogLogText6 = _RlSyslogLogText6_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 82, 2, 8, 1, 11),
    _RlSyslogLogText6_Type()
)
rlSyslogLogText6.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlSyslogLogText6.setStatus("current")


class _RlSyslogLogText7_Type(DisplayString):
    """Custom type rlSyslogLogText7 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 160),
    )
...
_RlSyslogLogText7_Type.__name__ = "DisplayString"
_RlSyslogLogText7_Object = MibTableColumn
rlSyslogLogText7 = _RlSyslogLogText7_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 82, 2, 8, 1, 12),
    _RlSyslogLogText7_Type()
)
rlSyslogLogText7.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlSyslogLogText7.setStatus("current")
...
class _RlSyslogUnexpectedRestartText5_Type(DisplayString):
    """Custom type rlSyslogUnexpectedRestartText5 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 160),
    )
...
_RlSyslogUnexpectedRestartText5_Type.__name__ = "DisplayString"
_RlSyslogUnexpectedRestartText5_Object = MibTableColumn
rlSyslogUnexpectedRestartText5 = _RlSyslogUnexpectedRestartText5_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 82, 2, 26, 1, 10),
    _RlSyslogUnexpectedRestartText5_Type()
)
rlSyslogUnexpectedRestartText5.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlSyslogUnexpectedRestartText5.setStatus("current")


class _RlSyslogUnexpectedRestartText6_Type(DisplayString):
    """Custom type rlSyslogUnexpectedRestartText6 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 160),
    )
...
_RlSyslogUnexpectedRestartText6_Type.__name__ = "DisplayString"
_RlSyslogUnexpectedRestartText6_Object = MibTableColumn
rlSyslogUnexpectedRestartText6 = _RlSyslogUnexpectedRestartText6_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 82, 2, 26, 1, 11),
    _RlSyslogUnexpectedRestartText6_Type()
)
rlSyslogUnexpectedRestartText6.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlSyslogUnexpectedRestartText6.setStatus("current")


class _RlSyslogUnexpectedRestartText7_Type(DisplayString):
    """Custom type rlSyslogUnexpectedRestartText7 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 160),
    )
...
_RlSyslogUnexpectedRestartText7_Type.__name__ = "DisplayString"
_RlSyslogUnexpectedRestartText7_Object = MibTableColumn
rlSyslogUnexpectedRestartText7 = _RlSyslogUnexpectedRestartText7_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 82, 2, 26, 1, 12),
    _RlSyslogUnexpectedRestartText7_Type()
)
rlSyslogUnexpectedRestartText7.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlSyslogUnexpectedRestartText7.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlSyslogSeverity": RlSyslogSeverity,
       ...
       "rlSyslogLogText5": rlSyslogLogText5,
       "rlSyslogLogText6": rlSyslogLogText6,
       "rlSyslogLogText7": rlSyslogLogText7,
       ...
       "rlSyslogUnexpectedRestartText5": rlSyslogUnexpectedRestartText5,
       "rlSyslogUnexpectedRestartText6": rlSyslogUnexpectedRestartText6,
       "rlSyslogUnexpectedRestartText7": rlSyslogUnexpectedRestartText7,
