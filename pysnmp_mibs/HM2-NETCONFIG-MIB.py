...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hirschmann/HM2-NETCONFIG-MIB
...
IpAddressOriginTC, = mibBuilder.importSymbols("IP-MIB", "IpAddressOriginTC")
...
hm2NetOobUsbMgmtGroup = MibIdentifier((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 7))
...
hm2NetDHCPClientConfigLoad = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 20), HmEnabledStatus().clone('enable')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetDHCPClientConfigLoad.setStatus('current')
hm2NetDHCPClientLeaseTime = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 21), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2NetDHCPClientLeaseTime.setStatus('current')
hm2NetIPv6AdminStatus = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 30), HmEnabledStatus().clone('enable')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetIPv6AdminStatus.setStatus('current')
hm2NetIPv6ConfigProtocol = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 31), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("none", 1), ("auto", 2), ("dhcpv6", 3), ("all", 4))).clone('auto')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetIPv6ConfigProtocol.setStatus('current')
hm2NetIPv6GatewayAddrType = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 32), InetAddressType().clone('ipv6')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetIPv6GatewayAddrType.setStatus('current')
hm2NetIPv6GatewayAddr = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 33), InetAddress().clone(hexValue="00000000000000000000000000000000")).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetIPv6GatewayAddr.setStatus('current')
hm2NetIPv6DupAddrDetectTrans = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 34), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 5)).clone(1)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetIPv6DupAddrDetectTrans.setStatus('current')
hm2NetIPv6DHCPClientId = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 35), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 255))).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2NetIPv6DHCPClientId.setStatus('current')
hm2NetIPv6LocalAddrTable = MibTable((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36), )
if mibBuilder.loadTexts: hm2NetIPv6LocalAddrTable.setStatus('current')
hm2NetIPv6LocalAddrEntry = MibTableRow((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36, 1), ).setIndexNames((0, "HM2-NETCONFIG-MIB", "hm2NetIPv6LocalAddrPrefixType"), (0, "HM2-NETCONFIG-MIB", "hm2NetIPv6LocalAddrPrefix"), (0, "HM2-NETCONFIG-MIB", "hm2NetIPv6LocalAddrPrefixLength"))
if mibBuilder.loadTexts: hm2NetIPv6LocalAddrEntry.setStatus('current')
hm2NetIPv6LocalAddrPrefixType = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36, 1, 1), InetAddressType())
if mibBuilder.loadTexts: hm2NetIPv6LocalAddrPrefixType.setStatus('current')
hm2NetIPv6LocalAddrPrefix = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36, 1, 2), InetAddress())
if mibBuilder.loadTexts: hm2NetIPv6LocalAddrPrefix.setStatus('current')
hm2NetIPv6LocalAddrPrefixLength = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 128)))
if mibBuilder.loadTexts: hm2NetIPv6LocalAddrPrefixLength.setStatus('current')
hm2NetIPv6LocalAddrType = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36, 1, 4), InetAddressType().clone('ipv6')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetIPv6LocalAddrType.setStatus('current')
hm2NetIPv6LocalAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36, 1, 5), InetAddress().clone(hexValue="00000000000000000000000000000000")).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetIPv6LocalAddr.setStatus('current')
hm2NetIPv6LocalAddrEuiFlag = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36, 1, 6), HmEnabledStatus().clone('disable')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetIPv6LocalAddrEuiFlag.setStatus('current')
hm2NetIPv6LocalAddrOrigin = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36, 1, 7), IpAddressOriginTC().clone('manual')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetIPv6LocalAddrOrigin.setStatus('current')
hm2NetIPv6LocalAddrStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 1, 36, 1, 8), RowStatus()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: hm2NetIPv6LocalAddrStatus.setStatus('current')
...
hm2NetOobMgmtDHCPClientLeaseTime = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 6, 10), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2NetOobMgmtDHCPClientLeaseTime.setStatus('current')
...
hm2NetOobUsbMgmtAdminState = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 7, 1), HmEnabledStatus().clone('enable')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetOobUsbMgmtAdminState.setStatus('current')
hm2NetOobUsbMgmtIPAddrType = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 7, 3), InetAddressType().clone('ipv4')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetOobUsbMgmtIPAddrType.setStatus('current')
hm2NetOobUsbMgmtIPAddr = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 7, 4), InetAddress().clone(hexValue="00000000")).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetOobUsbMgmtIPAddr.setStatus('current')
hm2NetOobUsbMgmtPrefixLength = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 7, 5), InetAddressPrefixLength()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetOobUsbMgmtPrefixLength.setStatus('current')
hm2NetOobUsbMgmtHostMacAddress = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 7, 7), MacAddress()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2NetOobUsbMgmtHostMacAddress.setStatus('current')
hm2NetOobUsbMgmtDeviceMacAddress = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 7, 8), MacAddress()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2NetOobUsbMgmtDeviceMacAddress.setStatus('current')
hm2NetOobUsbMgmtAction = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 20, 1, 7, 50), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("other", 1), ("activate", 2))).clone('other')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2NetOobUsbMgmtAction.setStatus('current')
mibBuilder.exportSymbols("HM2-NETCONFIG-MIB", hm2NetOobMgmtMacAddress=hm2NetOobMgmtMacAddress, hm2NetIPv6LocalAddrPrefixLength=hm2NetIPv6LocalAddrPrefixLength, hm2NetACDGroup=hm2NetACDGroup, hm2NetACDStatus=hm2NetACDStatus, hm2NetMgmtPort=hm2NetMgmtPort, hm2NetIPv6DupAddrDetectTrans=hm2NetIPv6DupAddrDetectTrans, hm2NetDHCPClientConfigLoad=hm2NetDHCPClientConfigLoad, hm2NetACDTrapEnable=hm2NetACDTrapEnable, hm2NetIPv6LocalAddrEuiFlag=hm2NetIPv6LocalAddrEuiFlag, hm2NetOobUsbMgmtIPAddr=hm2NetOobUsbMgmtIPAddr, hm2NetIPv6LocalAddrTable=hm2NetIPv6LocalAddrTable, hm2NetACDMAC=hm2NetACDMAC, hm2NetACDMaxProtection=hm2NetACDMaxProtection, hm2NetIPv6LocalAddrType=hm2NetIPv6LocalAddrType, hm2NetVlanPriority=hm2NetVlanPriority, hm2NetIpDscpPriority=hm2NetIpDscpPriority, hm2NetOobMgmtGatewayIPAddrType=hm2NetOobMgmtGatewayIPAddrType, hm2NetOobUsbMgmtDeviceMacAddress=hm2NetOobUsbMgmtDeviceMacAddress, hm2NetOobMgmtIPAddrType=hm2NetOobMgmtIPAddrType, hm2NetConfigMibNotifications=hm2NetConfigMibNotifications, hm2NetOobMgmtPrefixLength=hm2NetOobMgmtPrefixLength, hm2NetIPv6GatewayAddr=hm2NetIPv6GatewayAddr, hm2NetACDAddrTable=hm2NetACDAddrTable, hm2NetMacACDStatus=hm2NetMacACDStatus, hm2NetOobUsbMgmtIPAddrType=hm2NetOobUsbMgmtIPAddrType, hm2NetConfigMibObjects=hm2NetConfigMibObjects, hm2NetHiDiscoveryRelay=hm2NetHiDiscoveryRelay, hm2NetACDDetectionMode=hm2NetACDDetectionMode, hm2NetIPv6DHCPClientId=hm2NetIPv6DHCPClientId, hm2NetACDAddrEntry=hm2NetACDAddrEntry, hm2NetOobMgmtAdminState=hm2NetOobMgmtAdminState, hm2NetHiDiscoveryMode=hm2NetHiDiscoveryMode, hm2NetStaticGroup=hm2NetStaticGroup, hm2NetOobUsbMgmtAction=hm2NetOobUsbMgmtAction, hm2NetACDProtectInterval=hm2NetACDProtectInterval, hm2NetMacAddressType=hm2NetMacAddressType, hm2NetOobUsbMgmtGroup=hm2NetOobUsbMgmtGroup, hm2NetACDTimeMark=hm2NetACDTimeMark, hm2NetACDFaultState=hm2NetACDFaultState, hm2NetDHCPClientLeaseTime=hm2NetDHCPClientLeaseTime, hm2NetOobUsbMgmtPrefixLength=hm2NetOobUsbMgmtPrefixLength, hm2NetMacACDNotification=hm2NetMacACDNotification, hm2NetOobMgmtProtocol=hm2NetOobMgmtProtocol, hm2NetOobMgmtAction=hm2NetOobMgmtAction, hm2NetIPv6LocalAddrStatus=hm2NetIPv6LocalAddrStatus, hm2NetACDNotification=hm2NetACDNotification, hm2NetConfigMib=hm2NetConfigMib, hm2NetACDOngoingProbeStatus=hm2NetACDOngoingProbeStatus, hm2NetIPv6ConfigProtocol=hm2NetIPv6ConfigProtocol, hm2NetACDifIndex=hm2NetACDifIndex, hm2NetOobMgmtGatewayIPAddr=hm2NetOobMgmtGatewayIPAddr, hm2NetGatewayIPAddr=hm2NetGatewayIPAddr, hm2NetDHCPClientId=hm2NetDHCPClientId, hm2NetMacACDGroup=hm2NetMacACDGroup, hm2NetIPv6LocalAddrOrigin=hm2NetIPv6LocalAddrOrigin, hm2NetHiDiscoveryProtocol=hm2NetHiDiscoveryProtocol, hm2NetMacGroup=hm2NetMacGroup, hm2NetMacACDConflictAddress=hm2NetMacACDConflictAddress, hm2NetIPv6GatewayAddrType=hm2NetIPv6GatewayAddrType, hm2NetACDReleaseDelay=hm2NetACDReleaseDelay, hm2NetOobMgmtIPAddr=hm2NetOobMgmtIPAddr, hm2NetConfigProtocol=hm2NetConfigProtocol, hm2NetOobUsbMgmtAdminState=hm2NetOobUsbMgmtAdminState, hm2NetVlanID=hm2NetVlanID, PYSNMP_MODULE_ID=hm2NetConfigMib, hm2NetLocalIPAddrType=hm2NetLocalIPAddrType, hm2NetPrefixLength=hm2NetPrefixLength, hm2NetIPv6LocalAddrPrefix=hm2NetIPv6LocalAddrPrefix, hm2NetHiDiscoveryBlinking=hm2NetHiDiscoveryBlinking, hm2NetOobMgmtOperState=hm2NetOobMgmtOperState, hm2NetIPv6AdminStatus=hm2NetIPv6AdminStatus, hm2NetACDAddrType=hm2NetACDAddrType, hm2NetIPv6LocalAddr=hm2NetIPv6LocalAddr, hm2NetOobMgmtDHCPClientLeaseTime=hm2NetOobMgmtDHCPClientLeaseTime, hm2NetLocalIPAddr=hm2NetLocalIPAddr, hm2NetACDDelay=hm2NetACDDelay, hm2NetACDIPAddr=hm2NetACDIPAddr, hm2NetOobMgmtGroup=hm2NetOobMgmtGroup, hm2NetOobUsbMgmtHostMacAddress=hm2NetOobUsbMgmtHostMacAddress, hm2NetGatewayIPAddrType=hm2NetGatewayIPAddrType, hm2NetHiDiscoveryGroup=hm2NetHiDiscoveryGroup, hm2NetIPv6LocalAddrPrefixType=hm2NetIPv6LocalAddrPrefixType, hm2NetAction=hm2NetAction, hm2NetLocalAdminMacAddress=hm2NetLocalAdminMacAddress, hm2NetIPv6LocalAddrEntry=hm2NetIPv6LocalAddrEntry, hm2NetLocalBurnedInMacAddr=hm2NetLocalBurnedInMacAddr, hm2NetHiDiscoveryOperation=hm2NetHiDiscoveryOperation)
