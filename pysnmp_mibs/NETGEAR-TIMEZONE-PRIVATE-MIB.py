# SNMP MIB module (NETGEAR-TIMEZONE-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-TIMEZONE-PRIVATE-MIB
