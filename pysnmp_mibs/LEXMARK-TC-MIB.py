...
mibBuilder.exportSymbols("LEXMARK-TC-MIB", PYSNMP_MODULE_ID=lexmarkTCMIB, KeyValueTC=KeyValueTC, UnitsTC=UnitsTC, PaperTypeTC=PaperTypeTC, AdminStatusTC=AdminStatusTC, PaperSizeTC=PaperSizeTC, lexmarkTCMIB=lexmarkTCMIB, StatusTC=StatusTC)
