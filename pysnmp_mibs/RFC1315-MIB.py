...
mibBuilder.exportSymbols("RFC1315-MIB", frCircuitThroughput=frCircuitThroughput, frErrData=frErrData, frCircuitReceivedFrames=frCircuitReceivedFrames, frDlcmiFullEnquiryInterval=frDlcmiFullEnquiryInterval, frDlcmiDefaultRouteIfIndex=frDlcmiDefaultRouteIfIndex, frCircuitReceivedBECNs=frCircuitReceivedBECNs, frErrTable=frErrTable, frErrEntry=frErrEntry, frTrapState=frTrapState, frCircuitSentOctets=frCircuitSentOctets, frErrTime=frErrTime, frDlcmiAddressLen=frDlcmiAddressLen, frDlcmiPollingInterval=frDlcmiPollingInterval, frDlcmiErrorThreshold=frDlcmiErrorThreshold, frCircuitRouteType=frCircuitRouteType, frCircuitCreationTime=frCircuitCreationTime, frCircuitIfIndex=frCircuitIfIndex, frDlcmiEntry=frDlcmiEntry, frDlcmiIfIndex=frDlcmiIfIndex, frDlcmiTable=frDlcmiTable, frCircuitLastTimeChange=frCircuitLastTimeChange, frDlcmiDceMonitoredEvents=frDlcmiDceMonitoredEvents, frCircuitRouteIfIndex=frCircuitRouteIfIndex, frDlcmiMonitoredEvents=frDlcmiMonitoredEvents, frCircuitDlci=frCircuitDlci, frDlcmiMode=frDlcmiMode, frCircuitTable=frCircuitTable, frCircuitReceivedOctets=frCircuitReceivedOctets, frErrType=frErrType, frGlobals=frGlobals, frCircuitRouteDlci=frCircuitRouteDlci, frDlcmiMulticast=frDlcmiMulticast, frCircuitExcessBurst=frCircuitExcessBurst, frCircuitState=frCircuitState, frpublic=frpublic, frDlcmiMaxSupportedVCs=frDlcmiMaxSupportedVCs, frDlcmiDceIdleInterval=frDlcmiDceIdleInterval, frDlcmiDceErrorThreshold=frDlcmiDceErrorThreshold, frCircuitEntry=frCircuitEntry, frCircuitReceivedFECNs=frCircuitReceivedFECNs, frCircuitCommittedBurst=frCircuitCommittedBurst, frErrIfIndex=frErrIfIndex, frDlcmiState=frDlcmiState, frDlcmiAddress=frDlcmiAddress, frCircuitSentFrames=frCircuitSentFrames)
