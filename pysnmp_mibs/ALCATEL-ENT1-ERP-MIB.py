# SNMP MIB module (ALCATEL-ENT1-ERP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-ERP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:10:28 2025
...
alaErpRingEntry.setIndexNames(
    (0, "ALCATEL-ENT1-ERP-MIB", "alaErpRingId"),
)
if mibBuilder.loadTexts:
...
class _AlaErpRingLastStateChangeStr_Type(SnmpAdminString):
    """Custom type alaErpRingLastStateChangeStr based on SnmpAdminString"""
...
_AlaErpRingLastStateChangeStr_Type.__name__ = "SnmpAdminString"
_AlaErpRingLastStateChangeStr_Object = MibTableColumn
alaErpRingLastStateChangeStr = _AlaErpRingLastStateChangeStr_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 46, 1, 1, 2, 1, 1, 19),
    _AlaErpRingLastStateChangeStr_Type()
)
alaErpRingLastStateChangeStr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alaErpRingLastStateChangeStr.setStatus("current")
...
alaErpRingPortEntry.setIndexNames(
    (0, "ALCATEL-ENT1-ERP-MIB", "alaErpRingId"),
    (0, "ALCATEL-ENT1-ERP-MIB", "alaErpRingPortIfIndex"),
)
if mibBuilder.loadTexts:
...
_AlaErpRingPortVirtualSfMonitor_Type.__name__ = "TruthValue"
...
alaErpRingVlanEntry.setIndexNames(
    (0, "ALCATEL-ENT1-ERP-MIB", "alaErpRingId"),
    (0, "ALCATEL-ENT1-ERP-MIB", "alaErpRingVlanProtectedVid"),
)
if mibBuilder.loadTexts:
...
alaErpGlobalGroup.setObjects(
    ("ALCATEL-ENT1-ERP-MIB", "alaErpClearStats")
)
if mibBuilder.loadTexts:
...
alaErpRingAttributesGroup.setObjects(
      *(("ALCATEL-ENT1-ERP-MIB", "alaErpRingId"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingServiceVid"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingMEGLevel"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingPort1"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingPort2"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingStatus"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingState"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingWaitToRestoreTimer"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingGuardTimer"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingClearStats"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingLastStateChange"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingTimeToRevert"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingRowStatus"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingVirtualChannel"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingRevertive"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingClearAction"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingPortStatus"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingPortType"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingPortEthOAMEvent"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingPortClearStats"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingPortRmepId"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingVlanRowStatus"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsSignalFailPduTx"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsSignalFailPduRx"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsSignalFailPduDrop"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsNoRequestPduTx"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsNoRequestPduRx"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsNoRequestPduDrop"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsRPLBlockPDUTx"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsRPLBlockPDURx"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsRPLBlockPDUDrop"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpStatsPDUErr"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingPortVirtualSfMonitor"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingActiveVersion"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingResetVersionFallback"))
)
if mibBuilder.loadTexts:
...
alaErpNotificationGroup.setObjects(
      *(("ALCATEL-ENT1-ERP-MIB", "alaErpRingStateChanged"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingMultipleRpl"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingRemoved"))
)
if mibBuilder.loadTexts:
...
alcatelIND1ERPMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-ERP-MIB", "alaErpGlobalGroup"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpRingAttributesGroup"),
        ("ALCATEL-ENT1-ERP-MIB", "alaErpNotificationGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"AlaErpRingPortStatus": AlaErpRingPortStatus,
       ...
       "alaErpRingLastStateChangeStr": alaErpRingLastStateChangeStr,
