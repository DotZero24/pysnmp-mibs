...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-BIND-MIB
...
rbnBindCompliance.setObjects(
    ("RBN-BIND-MIB", "rbnBindConfigGroup")
)
if mibBuilder.loadTexts:
...
rbnBindCompliance2.setObjects(
    ("RBN-BIND-MIB", "rbnBindConfigGroup2")
)
if mibBuilder.loadTexts:
