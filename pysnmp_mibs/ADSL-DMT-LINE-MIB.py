...
# Notes
# -----
# ASN.1 source file://mibs/cisco/ADSL-DMT-LINE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:23:40 2025
...
adslDMTLineMibCompliance.setObjects(
      *(("ADSL-DMT-LINE-MIB", "adslLineDmtGroup"),
        ("ADSL-DMT-LINE-MIB", "adslAtucDmtPhysGroup"),
        ("ADSL-DMT-LINE-MIB", "adslAturDmtPhysGroup"),
        ("ADSL-DMT-LINE-MIB", "adslLineDmtConfProfileGroup"))
)
if mibBuilder.loadTexts:
...
adslLineDmtMIBAturCompliance.setObjects(
      *(("ADSL-DMT-LINE-MIB", "adslLineDmtGroup"),
        ("ADSL-DMT-LINE-MIB", "adslAturDmtPhysGroup"),
        ("ADSL-DMT-LINE-MIB", "adslLineDmtConfProfileGroup"))
)
