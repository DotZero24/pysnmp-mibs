...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/ibm/IBMIROC-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:45:39 2025
...
proResMemHeapNeverAlloc, proResMemHeapTotal, proElsSubSysEventMsg = mibBuilder.importSymbols("PROTEON-MIB", "proResMemHeapNeverAlloc", "proResMemHeapTotal", "proElsSubSysEventMsg")
...
mibBuilder.exportSymbols("IBMIROC-MIB", platformFeatureSlot=platformFeatureSlot, pppLCProtoOutCNs=pppLCProtoOutCNs, pppMSCHAPInChangePasswords=pppMSCHAPInChangePasswords, pppSPAPOutNacks=pppSPAPOutNacks, ibmIROCroutingvoice=ibmIROCroutingvoice, serverCurrConnections=serverCurrConnections, tcpiprouteUnhDirBcast=tcpiprouteUnhDirBcast, ibmIROCsystem=ibmIROCsystem, pppLCProtoInIdents=pppLCProtoInIdents, pppMSCHAPEntry=pppMSCHAPEntry, pppLCProtoOutCRs=pppLCProtoOutCRs, pppCPOutCompressedOctets=pppCPOutCompressedOctets, pppLinkErrInvProtos=pppLinkErrInvProtos, pppBAPOutDropNaks=pppBAPOutDropNaks, ibmSysDumpFatalMsg5=ibmSysDumpFatalMsg5, pppSPAPIfIndex=pppSPAPIfIndex, pppPAPOutPackets=pppPAPOutPackets, ibmSysDumpFatalMsg2=ibmSysDumpFatalMsg2, pppSPAPInPackets=pppSPAPInPackets, pppMSCHAPInPackets=pppMSCHAPInPackets, pppLinkErrConfigTOs=pppLinkErrConfigTOs, pppCBCPIfIndex=pppCBCPIfIndex, pppCPOutInCompressablePkts=pppCPOutInCompressablePkts, pppMSCHAPOutOctets=pppMSCHAPOutOctets, pppCHAPOutSuccesses=pppCHAPOutSuccesses, ibmSysDumpRemotePath=ibmSysDumpRemotePath, ibmIROCconfigWrite=ibmIROCconfigWrite, pppSPAPOutAlertAcks=pppSPAPOutAlertAcks, pppSPAPInChangePasswords=pppSPAPInChangePasswords, elsTrap=elsTrap, pppLinkErrBadCtrls=pppLinkErrBadCtrls, pppMSCHAPOutFailures=pppMSCHAPOutFailures, ibmSysDumpEntry=ibmSysDumpEntry, pppCBCPInOctets=pppCBCPInOctets, pppEPEntry=pppEPEntry, ibmIROCroutingdlsw=ibmIROCroutingdlsw, ibmdlswTConnGroupOperNQexRcvds=ibmdlswTConnGroupOperNQexRcvds, frrcvdFECN=frrcvdFECN, ibmdlswQllcLsQdomain=ibmdlswQllcLsQdomain, pppLCProtoInDiscReqs=pppLCProtoInDiscReqs, pppPAPEntry=pppPAPEntry, pppEPOutDestroyeds=pppEPOutDestroyeds, platformNVRAMSize=platformNVRAMSize, ibmIROCsystemInfo=ibmIROCsystemInfo, pppBAPInCallAcks=pppBAPInCallAcks, agentMemUse=agentMemUse, ibmdlswQllcLsChannel=ibmdlswQllcLsChannel, pppMPPETable=pppMPPETable, pppMPPEInPackets=pppMPPEInPackets, pppCBCPTable=pppCBCPTable, pppBAPIfIndex=pppBAPIfIndex, pppLinkErrEntry=pppLinkErrEntry, pppECPOutResetAcks=pppECPOutResetAcks, pppProtocolCtlInPkts=pppProtocolCtlInPkts, mosMemLow=mosMemLow, ibmSysDumpProductNumber=ibmSysDumpProductNumber, ibmIROCVPNpolicy=ibmIROCVPNpolicy, pppCCPInResetReqs=pppCCPInResetReqs, pppCPIfIndex=pppCPIfIndex, ibmdlswTConnGroupOperICRexRcvds=ibmdlswTConnGroupOperICRexRcvds, pppCHAPInOctets=pppCHAPInOctets, pppEAPEntry=pppEAPEntry, pppMPPEOutPackets=pppMPPEOutPackets, ibmIROCroutingIpSec=ibmIROCroutingIpSec, ibmdlswTConnGroupOperRole=ibmdlswTConnGroupOperRole, ibmSysDumpRemoteIPAddr=ibmSysDumpRemoteIPAddr, pppLCProtoLastTimeChange=pppLCProtoLastTimeChange, ibmIROCtrapsfr=ibmIROCtrapsfr, pppMSCHAPOutPasswordExpiredFailures=pppMSCHAPOutPasswordExpiredFailures, pppMPPEOutDestroyed=pppMPPEOutDestroyed, pppLCProtoState=pppLCProtoState, ibmSysDumpFatalMsg3=ibmSysDumpFatalMsg3, pppMSCHAPInAccountDisabledFailures=pppMSCHAPInAccountDisabledFailures, ibmIROCswitching=ibmIROCswitching, platformDRAMSize=platformDRAMSize, pppCHAPInSuccesses=pppCHAPInSuccesses, tcpiprouteDiscFilt=tcpiprouteDiscFilt, pppEAPOutNaks=pppEAPOutNaks, pppSPAPOutOctets=pppSPAPOutOctets, pppProtocolCtlInOctets=pppProtocolCtlInOctets, platformFLASHSize=platformFLASHSize, pppMPPEInDestroyed=pppMPPEInDestroyed, ibmProd=ibmProd, pppBAPInStatFails=pppBAPInStatFails, ibmdlswQllcLsPuType=ibmdlswQllcLsPuType, tcpiprouteUnhLLbcast=tcpiprouteUnhLLbcast, pppLCProtoOutResetReqs=pppLCProtoOutResetReqs, ibmSysDumpBuildDate=ibmSysDumpBuildDate, pppCHAPInResponses=pppCHAPInResponses, ibmdlswTConnGroupOperCURexRcvds=ibmdlswTConnGroupOperCURexRcvds, pppMSCHAPOutChangePasswords=pppMSCHAPOutChangePasswords, pppBAPOutCallBackReqs=pppBAPOutCallBackReqs, pppBAPInCallBackNaks=pppBAPInCallBackNaks, ibmIROCescon=ibmIROCescon, pppProtocolDataOutOctets=pppProtocolDataOutOctets, tcpiprouteTabUsed=tcpiprouteTabUsed, ibmIROCtrapssys=ibmIROCtrapssys, ibmIROCrouting=ibmIROCrouting, pppMSCHAPInOctets=pppMSCHAPInOctets, pppMSCHAPOutPackets=pppMSCHAPOutPackets, pppBAPTable=pppBAPTable, ibmSysDumpRetainName=ibmSysDumpRetainName, ibmIROCconfigAuth=ibmIROCconfigAuth, pppECPOutDictResets=pppECPOutDictResets, pppLinkErrIfIndex=pppLinkErrIfIndex, ibm=ibm, pppCCPOctetDiscards=pppCCPOctetDiscards, pppPAPTable=pppPAPTable, pppPAPInRequests=pppPAPInRequests, frTrapStateBECN=frTrapStateBECN, pppLCProtoInCAs=pppLCProtoInCAs, pppPAPOutNacks=pppPAPOutNacks, pppLCProtoOutResetAcks=pppLCProtoOutResetAcks, pppBAPInDropReqs=pppBAPInDropReqs, pppPAPInNacks=pppPAPInNacks, pppMSCHAPOutAccountDisabledFailures=pppMSCHAPOutAccountDisabledFailures, pppMSCHAPOutSuccesses=pppMSCHAPOutSuccesses, pppCBCPOutPackets=pppCBCPOutPackets, pppPAPOutRequests=pppPAPOutRequests, ibmIROCconfig=ibmIROCconfig, pppEAPInOctets=pppEAPInOctets, pppMSCHAPInFailures=pppMSCHAPInFailures, pppMPPEEntry=pppMPPEEntry, pppLCProtoInTimeRemains=pppLCProtoInTimeRemains, ibmCacheServer=ibmCacheServer, pppProtocolRegistered=pppProtocolRegistered, pppBAPOutDropRejs=pppBAPOutDropRejs, pppSPAPOutPackets=pppSPAPOutPackets, pppSPAPOutAlerts=pppSPAPOutAlerts, tcpiprouteUnhBcast=tcpiprouteUnhBcast, pppCCPOutResetReqs=pppCCPOutResetReqs, ibmdlswTConnGroupOperCURexSents=ibmdlswTConnGroupOperCURexSents, pppProtocolEntry=pppProtocolEntry, ibmIROCroutingDialOut=ibmIROCroutingDialOut, pppMSCHAPInRestrictedHoursFailures=pppMSCHAPInRestrictedHoursFailures, frCLLMDlciList=frCLLMDlciList, ibmdlswQllcLsRemoteSap=ibmdlswQllcLsRemoteSap, frCLLMStatsIfIndex=frCLLMStatsIfIndex, pppCPOutCopies=pppCPOutCopies, pppCCPOutResetAcks=pppCCPOutResetAcks, ibmdlswQllcLsQaddress=ibmdlswQllcLsQaddress, pppLCProtoInResetReqs=pppLCProtoInResetReqs, frCLLMCauseEntry=frCLLMCauseEntry, pppLCProtoOutOctets=pppLCProtoOutOctets, ibmdlswTConnGroupOperNRexSents=ibmdlswTConnGroupOperNRexSents, frSimpleObjs=frSimpleObjs, ibmIROCroutingtn3270e=ibmIROCroutingtn3270e, ibmdlswTConnGroupOperOutDataOctets=ibmdlswTConnGroupOperOutDataOctets, pppCPInInCompressablePkts=pppCPInInCompressablePkts, tcpiprouteUnhMcast=tcpiprouteUnhMcast, ibmIROCadminDebug=ibmIROCadminDebug, pppECPInResetAcks=pppECPInResetAcks, ibmdlswTConnGroupOperOutCntlPkts=ibmdlswTConnGroupOperOutCntlPkts, pppCHAPOutPackets=pppCHAPOutPackets, pppMSCHAPOutResponses=pppMSCHAPOutResponses, pppCHAPOutFailures=pppCHAPOutFailures, pppCHAPInPackets=pppCHAPInPackets, pppBAPOutCallReqs=pppBAPOutCallReqs, tcpCurrConnections=tcpCurrConnections, pppProtocolTable=pppProtocolTable, tcpiprouteMultRcvd=tcpiprouteMultRcvd, pppCBCPOutOctets=pppCBCPOutOctets, pppLCProtoInOctets=pppLCProtoInOctets, pppBAPInCallBackRejs=pppBAPInCallBackRejs, pppLinkErrLastInvProto=pppLinkErrLastInvProto, ibmSysDumpBuild=ibmSysDumpBuild, pppCHAPIfIndex=pppCHAPIfIndex, pppLCProtoInRejects=pppLCProtoInRejects, pppSPAPOutAcks=pppSPAPOutAcks, pppBAPInCallBackAcks=pppBAPInCallBackAcks, pppECPOutResetReqs=pppECPOutResetReqs, pppMSCHAPInNoPermissionFailures=pppMSCHAPInNoPermissionFailures, ibmSysDumpFatalMsg4=ibmSysDumpFatalMsg4, ibmdlswQllcLsEntry=ibmdlswQllcLsEntry, frCLLMStatsRcvds=frCLLMStatsRcvds, ibmIROCdumpInfo=ibmIROCdumpInfo, pppBAPOutStatSuccs=pppBAPOutStatSuccs, ibmIROCcfgInfo=ibmIROCcfgInfo, ibmIROCadmin=ibmIROCadmin, pppBAPInCallNaks=pppBAPInCallNaks, pppEAPInAcks=pppEAPInAcks, pppEAPInRequests=pppEAPInRequests, pppCBCPInPackets=pppCBCPInPackets, pppMSCHAPInSuccesses=pppMSCHAPInSuccesses, frTrapStateFECN=frTrapStateFECN, ibmIROCroutingfr=ibmIROCroutingfr, pppLCProtoOutEchoReqs=pppLCProtoOutEchoReqs, ibmdlswQllcLsRemoteMac=ibmdlswQllcLsRemoteMac, pppCPEntry=pppCPEntry, ibmdlswTConnGroupOperNQexSents=ibmdlswTConnGroupOperNQexSents, pppMSCHAPOutChallenges=pppMSCHAPOutChallenges, tcpiprouteTabSize=tcpiprouteTabSize, ibmdlswQllcLsTable=ibmdlswQllcLsTable, pppLinkErrLastBadAddr=pppLinkErrLastBadAddr, ibmdlswTConnGroupOperIndex=ibmdlswTConnGroupOperIndex, ibmSysDumpFatalMsg1=ibmSysDumpFatalMsg1, pppSPAPInAcks=pppSPAPInAcks, pppPAPOutAcks=pppPAPOutAcks, ibmdlswQllcLsIdNum=ibmdlswQllcLsIdNum, frTrapStateCLLM=frTrapStateCLLM, pppBAPInStatSuccs=pppBAPInStatSuccs, frCLLMStatsDlci=frCLLMStatsDlci, ibmSysDumpTable=ibmSysDumpTable, pppLCProtoIfIndex=pppLCProtoIfIndex, frCLLMCauseIfIndex=frCLLMCauseIfIndex, frrcvdBECN=frrcvdBECN, pppEAPOutAcks=pppEAPOutAcks, pppLCProtoInCodeRejs=pppLCProtoInCodeRejs, ibmIROChardware=ibmIROChardware, pppLCProtoOutEchoReps=pppLCProtoOutEchoReps, ibmIROCroutingtcpip=ibmIROCroutingtcpip, pppBAPOutDropReqs=pppBAPOutDropReqs, frrcvdCLLM=frrcvdCLLM, pppMPPEOutOctets=pppMPPEOutOctets, pppEAPOutRequests=pppEAPOutRequests, pppLCProtoOutTRs=pppLCProtoOutTRs, pppCHAPTable=pppCHAPTable, frCLLMStatsEntry=frCLLMStatsEntry, pppSPAPInAlertAcks=pppSPAPInAlertAcks, pppProtocolLastTimeChange=pppProtocolLastTimeChange, pppCPInCopies=pppCPInCopies, authTrapSourceIPAddr=authTrapSourceIPAddr, pppSPAPInNacks=pppSPAPInNacks, pppBAPOutCallBackAcks=pppBAPOutCallBackAcks, ibmIROCadminSnmp=ibmIROCadminSnmp, pppEAPOutPackets=pppEAPOutPackets, pppEAPOutOctets=pppEAPOutOctets, ibmdlswTConnGroupOperICRexSents=ibmdlswTConnGroupOperICRexSents, pppMSCHAPOutAuthenticationFailures=pppMSCHAPOutAuthenticationFailures, pppLinkErrTermTOs=pppLinkErrTermTOs, pppBAPInCallReqs=pppBAPInCallReqs, pppCCPInResetAcks=pppCCPInResetAcks, tcpiprouteCacheUsed=tcpiprouteCacheUsed, pppProtocolDataInRejects=pppProtocolDataInRejects, pppProtocolCtlInRejects=pppProtocolCtlInRejects, pppPAPInPackets=pppPAPInPackets, pppCCPOutDictResets=pppCCPOutDictResets, pppProtocolDataOutPkts=pppProtocolDataOutPkts, pppSPAPInOctets=pppSPAPInOctets, ibmdlswQllcLsBlkNum=ibmdlswQllcLsBlkNum, pppProtocolCtlOutOctets=pppProtocolCtlOutOctets, pppSPAPEntry=pppSPAPEntry, pppLCProtoOutCRejs=pppLCProtoOutCRejs, pppLCProtoOutCAs=pppLCProtoOutCAs, pppLCProtoOutCodeRejs=pppLCProtoOutCodeRejs, pppBAPOutCallRejs=pppBAPOutCallRejs, pppLCProtoOutTAs=pppLCProtoOutTAs, pppEAPIfIndex=pppEAPIfIndex, MacAddressNCIROC=MacAddressNCIROC, pppSPAPInPleaseAuthenticates=pppSPAPInPleaseAuthenticates, pppBAPOutCallBackRejs=pppBAPOutCallBackRejs, ibmIROCAgentDebug=ibmIROCAgentDebug, pppEPInDestroyeds=pppEPInDestroyeds, ibmWanRestoralRerouteMIB=ibmWanRestoralRerouteMIB)
mibBuilder.exportSymbols("IBMIROC-MIB", frCLLMStatsTable=frCLLMStatsTable, pppMSCHAPInAuthenticationFailures=pppMSCHAPInAuthenticationFailures, pppBAPInCallBackReqs=pppBAPInCallBackReqs, pppEPOutCopies=pppEPOutCopies, frCLLMCauseCode=frCLLMCauseCode, pppBAPOutCallAcks=pppBAPOutCallAcks, pppLCProtoOutIdents=pppLCProtoOutIdents, ibmIROCroutinginterface=ibmIROCroutinginterface, pppEAPInNaks=pppEAPInNaks, pppLinkErrLastBadCtrl=pppLinkErrLastBadCtrl, ibmIROCtraps=ibmIROCtraps, pppPAPInAcks=pppPAPInAcks, ibmdlswQllcLsLocalSap=ibmdlswQllcLsLocalSap, ibmSysDumpFileDate=ibmSysDumpFileDate, ibmIROCtrapsels=ibmIROCtrapsels, pppSPAPOutDialbacks=pppSPAPOutDialbacks, ibmIROCswhw=ibmIROCswhw, pppLCProtoInCRs=pppLCProtoInCRs, ibmdlswTConnGroupOperEntry=ibmdlswTConnGroupOperEntry, pppLCProtoOutPackets=pppLCProtoOutPackets, pppCHAPInChallenges=pppCHAPInChallenges, pppCBCPAttempts=pppCBCPAttempts, pppLCProtoInEchoReqs=pppLCProtoInEchoReqs, ibmdlswTConnGroupOperInDataPkts=ibmdlswTConnGroupOperInDataPkts, pppLinkErrLastUnkProto=pppLinkErrLastUnkProto, tcpMaxConnections=tcpMaxConnections, pppProtocolState=pppProtocolState, pppMSCHAPIfIndex=pppMSCHAPIfIndex, ibmdlswTConnGroupOperTable=ibmdlswTConnGroupOperTable, pppECPInResetReqs=pppECPInResetReqs, pppCHAPOutOctets=pppCHAPOutOctets, pppPAPInOctets=pppPAPInOctets, pppProtocolCtlOutPkts=pppProtocolCtlOutPkts, pppMSCHAPOutNoPermissionFailures=pppMSCHAPOutNoPermissionFailures, pppLinkErrBadAddrs=pppLinkErrBadAddrs, pppMPPEInOctets=pppMPPEInOctets, pppMPPEIfIndex=pppMPPEIfIndex, pppLCProtoPreviousState=pppLCProtoPreviousState, pppPAPOutOctets=pppPAPOutOctets, pppBAPOutCallNaks=pppBAPOutCallNaks, pppBAPEntry=pppBAPEntry, pppLCProtoInCNs=pppLCProtoInCNs, pppBAPInDropRejs=pppBAPInDropRejs, pppProtocolIfIndex=pppProtocolIfIndex, pppLCProtoOutDiscReqs=pppLCProtoOutDiscReqs, pppMSCHAPOutChangePasswordFailures=pppMSCHAPOutChangePasswordFailures, ibmIROCrmon=ibmIROCrmon, pppCHAPEntry=pppCHAPEntry, ibmdlswTConnGroupOperOutDataPkts=ibmdlswTConnGroupOperOutDataPkts, ibmSysDumpBuildName=ibmSysDumpBuildName, ibmIROCadminproducts=ibmIROCadminproducts, pppEAPInPackets=pppEAPInPackets, ibmIROCroutingRlan=ibmIROCroutingRlan, ibmdlswQllcLsLocalMac=ibmdlswQllcLsLocalMac, ibmIROCadminOID=ibmIROCadminOID, ibmIROChardwareInfo=ibmIROChardwareInfo, pppCHAPOutResponses=pppCHAPOutResponses, ibmdlswQllcLsIfIndex=ibmdlswQllcLsIfIndex, tcpiprouteBadSubnet=tcpiprouteBadSubnet, ibmBANMIB=ibmBANMIB, pppMSCHAPInResponses=pppMSCHAPInResponses, pppEPTable=pppEPTable, pppCPInCompressedOctets=pppCPInCompressedOctets, ibmIROC=ibmIROC, pppBAPInCallRejs=pppBAPInCallRejs, platformType=platformType, pppProtocolId=pppProtocolId, pppECPPacketDiscards=pppECPPacketDiscards, pppBAPInDropNaks=pppBAPInDropNaks, pppPAPIfIndex=pppPAPIfIndex, ibmIROCSnmpAuthFail=ibmIROCSnmpAuthFail, pppBAPOutDropAcks=pppBAPOutDropAcks, pppECPInDictResets=pppECPInDictResets, pppMSCHAPOutRestrictedHoursFailures=pppMSCHAPOutRestrictedHoursFailures, pppProtocolPreviousState=pppProtocolPreviousState, ibmSysDumpBuilder=ibmSysDumpBuilder, pppCHAPInFailures=pppCHAPInFailures, pppCPTable=pppCPTable, pppCCPInDictResets=pppCCPInDictResets, pppBAPOutCallBackNaks=pppBAPOutCallBackNaks, pppLCProtoInTAs=pppLCProtoInTAs, serverMaxConnections=serverMaxConnections, ibmdlswTConnGroupOperConfigIndex=ibmdlswTConnGroupOperConfigIndex, pppSPAPInRequests=pppSPAPInRequests, pppMSCHAPInChangePasswordFailures=pppMSCHAPInChangePasswordFailures, pppEPOutEncryptedOctets=pppEPOutEncryptedOctets, pppECPOctetDiscards=pppECPOctetDiscards, pppSPAPOutPleaseAuthenticates=pppSPAPOutPleaseAuthenticates, pppLCProtoInPackets=pppLCProtoInPackets, pppLCProtoInResetAcks=pppLCProtoInResetAcks, ibmdlswTConnGroupOperJoinTime=ibmdlswTConnGroupOperJoinTime, ibmIROCroutingl2tp=ibmIROCroutingl2tp, ibmdlswTConnGroupOperInCntlPkts=ibmdlswTConnGroupOperInCntlPkts, pppCBCPEntry=pppCBCPEntry, pppLCProtoInTRs=pppLCProtoInTRs, pppLCProtoEntry=pppLCProtoEntry, pppSPAPInDialbacks=pppSPAPInDialbacks, frCLLMCauseTable=frCLLMCauseTable, pppSPAPTable=pppSPAPTable, ibmdlswTConnGroupOperNRexRcvds=ibmdlswTConnGroupOperNRexRcvds, pppLCProtoOutTimeRemains=pppLCProtoOutTimeRemains, pppLinkErrUnkProtos=pppLinkErrUnkProtos, ibmdlswTConnGroupOperInDataOctets=ibmdlswTConnGroupOperInDataOctets, tcpiprouteCacheSize=tcpiprouteCacheSize, ibmIROCfrBRS=ibmIROCfrBRS, pppEPInEncryptedOctets=pppEPInEncryptedOctets, pppMSCHAPTable=pppMSCHAPTable, pppProtocolDataInOctets=pppProtocolDataInOctets, pppCCPPacketDiscards=pppCCPPacketDiscards, pppSPAPOutChangePasswords=pppSPAPOutChangePasswords, ibmIROCroutingppp=ibmIROCroutingppp, pppLCProtoInEchoReps=pppLCProtoInEchoReps, pppSPAPOutRequests=pppSPAPOutRequests, pppCHAPOutChallenges=pppCHAPOutChallenges, pppLinkErrTable=pppLinkErrTable, tcpiprouteNoReach=tcpiprouteNoReach, ibmSysDumpIndex=ibmSysDumpIndex, pppCBCPSuccess=pppCBCPSuccess, pppMSCHAPInPasswordExpiredFailures=pppMSCHAPInPasswordExpiredFailures, tcpiprouteOverFlow=tcpiprouteOverFlow, pppEAPTable=pppEAPTable, pppCPOutDestroyeds=pppCPOutDestroyeds, pppSPAPInAlerts=pppSPAPInAlerts, pppEPIfIndex=pppEPIfIndex, ibmIROCfrcircuit=ibmIROCfrcircuit, pppProtocolDataInPkts=pppProtocolDataInPkts, pppEPInCopies=pppEPInCopies, pppBAPOutStatFails=pppBAPOutStatFails, tcpiprouteBadNet=tcpiprouteBadNet, pppMSCHAPInChallenges=pppMSCHAPInChallenges, pppBAPInDropAcks=pppBAPInDropAcks, pppLCProtoTable=pppLCProtoTable, ibmSysDumpFileName=ibmSysDumpFileName, pppCPInDestroyeds=pppCPInDestroyeds, pppLCProtoInCRejs=pppLCProtoInCRejs)
