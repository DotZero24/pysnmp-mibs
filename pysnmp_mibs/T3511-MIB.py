...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/comet/T3511-MIB
...
historyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 22626, 1, 2, 6, 1, 1), ).setIndexNames((0, "T3511-MIB", "histTemp"))
...
trapTest = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,0)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapNTPError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,1)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapEmailErrLogin = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,2)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapEmailErrAuth = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,3)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapEmailErrSome = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,4)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapEmailErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,5)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapEmailErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,6)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapSOAPErrFile = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,7)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapSOAPErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,8)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapSOAPErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,9)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapSOAPErrDelivery = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,10)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"))
trapTempHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,11)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "temp"), ("T3511-MIB", "tempAlarmInt"))
trapHumHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,12)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "hum"), ("T3511-MIB", "humAlarmInt"))
trapCompValHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,13)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "compVal"), ("T3511-MIB", "compValAlarmInt"))
trapTempLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,21)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "temp"), ("T3511-MIB", "tempAlarmInt"))
trapHumLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,22)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "hum"), ("T3511-MIB", "humAlarmInt"))
trapCompValLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,23)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "compVal"), ("T3511-MIB", "compValAlarmInt"))
trapTempClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,31)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "temp"), ("T3511-MIB", "tempAlarmInt"))
trapHumClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,32)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "hum"), ("T3511-MIB", "humAlarmInt"))
trapCompValClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,33)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "compVal"), ("T3511-MIB", "compValAlarmInt"))
trapTempError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,41)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "temp"), ("T3511-MIB", "tempAlarmInt"))
trapHumError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,42)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "hum"), ("T3511-MIB", "humAlarmInt"))
trapCompValError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,43)).setObjects(("T3511-MIB", "sensorName"), ("T3511-MIB", "messageString"), ("T3511-MIB", "compVal"), ("T3511-MIB", "compValAlarmInt"))
mibBuilder.exportSymbols("T3511-MIB", tempLowInt=tempLowInt, trapNTPError=trapNTPError, historyTable=historyTable, temp=temp, humHystInt=humHystInt, t3511=t3511, comet=comet, settings=settings, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, humHighInt=humHighInt, tempMax=tempMax, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrLogin=trapEmailErrLogin, humInt=humInt, historyEntry=historyEntry, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, sensorName=sensorName, humUnit=humUnit, trapEmailErrAuth=trapEmailErrAuth, humAlarm=humAlarm, compValMin=compValMin, tempMin=tempMin, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, trapHumError=trapHumError, hum=hum, traps=traps, humAlarmInt=humAlarmInt, tables=tables, compValDelayInt=compValDelayInt, trapHumClrAlarm=trapHumClrAlarm, compValInt=compValInt, compValAlarm=compValAlarm, compValUnit=compValUnit, messageString=messageString, humDelayInt=humDelayInt, tempInt=tempInt, tempAlarmInt=tempAlarmInt, values=values, compVal=compVal, humMax=humMax, compValLowInt=compValLowInt, histHum=histHum, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tempHighInt=tempHighInt, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, trapTempLowAlarm=trapTempLowAlarm, compValHighInt=compValHighInt, trapTest=trapTest, tempDelayInt=tempDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, products=products, pysmi_global=pysmi_global, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, histTemp=histTemp, DisplayString=DisplayString, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile)
