...
# Notes
# -----
# ASN.1 source file://mibs/comet/T3511-MIB
...
trapTest.setObjects(
      *(("T3511-MIB", "sensorName"),
        ("T3511-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
