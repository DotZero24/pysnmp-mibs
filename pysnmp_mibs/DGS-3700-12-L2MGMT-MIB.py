...
swL2DevMgmt=_SwL2DevMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,1))
_SwL2DevInfo_ObjectIdentity=ObjectIdentity
swL2DevInfo=_SwL2DevInfo_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,1,1))
...
swDevInfoTotalNumOfPort=_SwDevInfoTotalNumOfPort_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,1,1),_SwDevInfoTotalNumOfPort_Type())
...
swDevInfoNumOfPortInUse=_SwDevInfoNumOfPortInUse_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,1,2),_SwDevInfoNumOfPortInUse_Type())
...
swDevInfoFrontPanelLedStatus=_SwDevInfoFrontPanelLedStatus_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,1,4),_SwDevInfoFrontPanelLedStatus_Type())
...
swL2DevCtrl=_SwL2DevCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,1,2))
...
swL2DevCtrlStpState=_SwL2DevCtrlStpState_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,1),_SwL2DevCtrlStpState_Type())
...
swL2DevCtrlIGMPSnooping=_SwL2DevCtrlIGMPSnooping_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,2),_SwL2DevCtrlIGMPSnooping_Type())
...
swL2DevCtrlIGMPSnoopingMcstRTOnly=_SwL2DevCtrlIGMPSnoopingMcstRTOnly_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,3),_SwL2DevCtrlIGMPSnoopingMcstRTOnly_Type())
...
swL2DevCtrlSnmpTrapState=_SwL2DevCtrlSnmpTrapState_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,5),_SwL2DevCtrlSnmpTrapState_Type())
...
swL2DevCtrlCleanAllStatisticCounter=_SwL2DevCtrlCleanAllStatisticCounter_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,6),_SwL2DevCtrlCleanAllStatisticCounter_Type())
...
swL2DevCtrlVlanIdOfFDBTbl=_SwL2DevCtrlVlanIdOfFDBTbl_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,7),_SwL2DevCtrlVlanIdOfFDBTbl_Type())
...
swL2MACNotifyState=_SwL2MACNotifyState_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,8),_SwL2MACNotifyState_Type())
...
swL2MACNotifyHistorySize=_SwL2MACNotifyHistorySize_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,9),_SwL2MACNotifyHistorySize_Type())
...
swL2MACNotifyInterval=_SwL2MACNotifyInterval_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,10),_SwL2MACNotifyInterval_Type())
...
swL2DevCtrlTelnet=_SwL2DevCtrlTelnet_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,1,2,14))
...
swL2DevCtrlTelnetState=_SwL2DevCtrlTelnetState_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,14,1),_SwL2DevCtrlTelnetState_Type())
...
swL2DevCtrlTelnetTcpPort=_SwL2DevCtrlTelnetTcpPort_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,14,2),_SwL2DevCtrlTelnetTcpPort_Type())
...
swL2DevCtrlManagementVlanId=_SwL2DevCtrlManagementVlanId_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,16),_SwL2DevCtrlManagementVlanId_Type())
...
swL2DevCtrlWeb=_SwL2DevCtrlWeb_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,1,2,17))
...
swL2DevCtrlWebState=_SwL2DevCtrlWebState_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,17,1),_SwL2DevCtrlWebState_Type())
...
swL2DevCtrlWebTcpPort=_SwL2DevCtrlWebTcpPort_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,17,2),_SwL2DevCtrlWebTcpPort_Type())
...
swL2DevCtrlLLDPState=_SwL2DevCtrlLLDPState_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,18),_SwL2DevCtrlLLDPState_Type())
...
swL2DevCtrlLLDPForwardMessageState=_SwL2DevCtrlLLDPForwardMessageState_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,19),_SwL2DevCtrlLLDPForwardMessageState_Type())
...
swL2DevCtrlIpAutoconfig=_SwL2DevCtrlIpAutoconfig_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,20),_SwL2DevCtrlIpAutoconfig_Type())
...
swL2DevCtrlCFM=_SwL2DevCtrlCFM_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,1,2,21))
...
swL2DevCtrlCFMState=_SwL2DevCtrlCFMState_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,21,1),_SwL2DevCtrlCFMState_Type())
...
swL2DevCtrlCFMPortTable=_SwL2DevCtrlCFMPortTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,21,2))
if mibBuilder.loadTexts:swL2DevCtrlCFMPortTable.setStatus(_A)
_SwL2DevCtrlCFMPortEntry_Object=MibTableRow
swL2DevCtrlCFMPortEntry=_SwL2DevCtrlCFMPortEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,21,2,1))
...
swL2DevCtrlCFMPortIndex=_SwL2DevCtrlCFMPortIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,21,2,1,1),_SwL2DevCtrlCFMPortIndex_Type())
...
swL2DevCtrlCFMPortState=_SwL2DevCtrlCFMPortState_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,2,21,2,1,2),_SwL2DevCtrlCFMPortState_Type())
...
swL2DevAlarm=_SwL2DevAlarm_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,1,3))
...
swL2DevAlarmNewRoot=_SwL2DevAlarmNewRoot_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,3,1),_SwL2DevAlarmNewRoot_Type())
...
swL2DevAlarmTopologyChange=_SwL2DevAlarmTopologyChange_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,3,2),_SwL2DevAlarmTopologyChange_Type())
...
swL2DevAlarmLinkChange=_SwL2DevAlarmLinkChange_Object((1,3,6,1,4,1,171,11,102,1,1,2,1,3,3),_SwL2DevAlarmLinkChange_Type())
...
swL2VLANMgmt=_SwL2VLANMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,2))
_SwL2VlanStaticTable_Object=MibTable
swL2VlanStaticTable=_SwL2VlanStaticTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,1))
if mibBuilder.loadTexts:swL2VlanStaticTable.setStatus(_A)
_SwL2VlanStaticEntry_Object=MibTableRow
swL2VlanStaticEntry=_SwL2VlanStaticEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,1,1))
...
swL2VlanIndex=_SwL2VlanIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,1,1,1),_SwL2VlanIndex_Type())
...
swL2VLANAdvertisement=_SwL2VLANAdvertisement_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,1,1,2),_SwL2VLANAdvertisement_Type())
...
swL2PVIDAutoAssignmentState=_SwL2PVIDAutoAssignmentState_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,2),_SwL2PVIDAutoAssignmentState_Type())
...
swL2VlanPortInfoTable=_SwL2VlanPortInfoTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,3))
if mibBuilder.loadTexts:swL2VlanPortInfoTable.setStatus(_A)
_SwL2VlanPortInfoEntry_Object=MibTableRow
swL2VlanPortInfoEntry=_SwL2VlanPortInfoEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,3,1))
...
swL2VlanPortInfoPortIndex=_SwL2VlanPortInfoPortIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,3,1,1),_SwL2VlanPortInfoPortIndex_Type())
...
swL2VlanPortInfoVid=_SwL2VlanPortInfoVid_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,3,1,2),_SwL2VlanPortInfoVid_Type())
...
swL2VlanPortInfoPortRole=_SwL2VlanPortInfoPortRole_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,3,1,3),_SwL2VlanPortInfoPortRole_Type())
...
swL2NniGvrpBpduAddress=_SwL2NniGvrpBpduAddress_Object((1,3,6,1,4,1,171,11,102,1,1,2,2,7),_SwL2NniGvrpBpduAddress_Type())
...
swL2PortMgmt=_SwL2PortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,3))
_SwL2PortInfoTable_Object=MibTable
swL2PortInfoTable=_SwL2PortInfoTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,1))
if mibBuilder.loadTexts:swL2PortInfoTable.setStatus(_A)
_SwL2PortInfoEntry_Object=MibTableRow
swL2PortInfoEntry=_SwL2PortInfoEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,1,1))
...
swL2PortInfoPortIndex=_SwL2PortInfoPortIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,1,1,1),_SwL2PortInfoPortIndex_Type())
...
swL2PortInfoMediumType=_SwL2PortInfoMediumType_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,1,1,2),_SwL2PortInfoMediumType_Type())
...
swL2PortInfoUnitID=_SwL2PortInfoUnitID_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,1,1,3),_SwL2PortInfoUnitID_Type())
...
swL2PortInfoType=_SwL2PortInfoType_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,1,1,4),_SwL2PortInfoType_Type())
...
swL2PortInfoLinkStatus=_SwL2PortInfoLinkStatus_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,1,1,5),_SwL2PortInfoLinkStatus_Type())
...
swL2PortInfoNwayStatus=_SwL2PortInfoNwayStatus_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,1,1,6),_SwL2PortInfoNwayStatus_Type())
...
swL2PortInfoErrorDisabled=_SwL2PortInfoErrorDisabled_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,1,1,8),_SwL2PortInfoErrorDisabled_Type())
...
swL2PortCtrlTable=_SwL2PortCtrlTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2))
if mibBuilder.loadTexts:swL2PortCtrlTable.setStatus(_A)
_SwL2PortCtrlEntry_Object=MibTableRow
swL2PortCtrlEntry=_SwL2PortCtrlEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2,1))
...
swL2PortCtrlPortIndex=_SwL2PortCtrlPortIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2,1,1),_SwL2PortCtrlPortIndex_Type())
...
swL2PortCtrlMediumType=_SwL2PortCtrlMediumType_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2,1,2),_SwL2PortCtrlMediumType_Type())
...
swL2PortCtrlUnitIndex=_SwL2PortCtrlUnitIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2,1,3),_SwL2PortCtrlUnitIndex_Type())
...
swL2PortCtrlAdminState=_SwL2PortCtrlAdminState_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2,1,4),_SwL2PortCtrlAdminState_Type())
...
swL2PortCtrlNwayState=_SwL2PortCtrlNwayState_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2,1,5),_SwL2PortCtrlNwayState_Type())
...
swL2PortCtrlFlowCtrlState=_SwL2PortCtrlFlowCtrlState_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2,1,6),_SwL2PortCtrlFlowCtrlState_Type())
...
swL2PortCtrlLearningState=_SwL2PortCtrlLearningState_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2,1,7),_SwL2PortCtrlLearningState_Type())
...
swL2PortCtrlMACNotifyState=_SwL2PortCtrlMACNotifyState_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,2,1,8),_SwL2PortCtrlMACNotifyState_Type())
...
swL2PortCtrlJumboFrame=_SwL2PortCtrlJumboFrame_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,3),_SwL2PortCtrlJumboFrame_Type())
...
swL2PortCtrlJumboFrameMaxSize=_SwL2PortCtrlJumboFrameMaxSize_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,4),_SwL2PortCtrlJumboFrameMaxSize_Type())
...
swL2PortCounterCtrlTable=_SwL2PortCounterCtrlTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,6))
if mibBuilder.loadTexts:swL2PortCounterCtrlTable.setStatus(_A)
_SwL2PortCounterCtrlEntry_Object=MibTableRow
swL2PortCounterCtrlEntry=_SwL2PortCounterCtrlEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,6,1))
...
swL2PortCounterCtrlPortIndex=_SwL2PortCounterCtrlPortIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,6,1,1),_SwL2PortCounterCtrlPortIndex_Type())
...
swL2PortCounterClearCtrl=_SwL2PortCounterClearCtrl_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,6,1,2),_SwL2PortCounterClearCtrl_Type())
...
swL2PortErrTable=_SwL2PortErrTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,7))
if mibBuilder.loadTexts:swL2PortErrTable.setStatus(_A)
_SwL2PortErrEntry_Object=MibTableRow
swL2PortErrEntry=_SwL2PortErrEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,7,1))
...
swL2PortErrPortIndex=_SwL2PortErrPortIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,7,1,1),_SwL2PortErrPortIndex_Type())
...
swL2PortErrPortState=_SwL2PortErrPortState_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,7,1,2),_SwL2PortErrPortState_Type())
...
swL2PortErrPortConnStatus=_SwL2PortErrPortConnStatus_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,7,1,3),_SwL2PortErrPortConnStatus_Type())
...
swL2PortErrPortReason=_SwL2PortErrPortReason_Object((1,3,6,1,4,1,171,11,102,1,1,2,3,7,1,4),_SwL2PortErrPortReason_Type())
...
swL2DhcpRelayMgmt=_SwL2DhcpRelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,8))
_SwL2TrunkMgmt_ObjectIdentity=ObjectIdentity
swL2TrunkMgmt=_SwL2TrunkMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,9))
...
swL2TrunkMaxSupportedEntries=_SwL2TrunkMaxSupportedEntries_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,1),_SwL2TrunkMaxSupportedEntries_Type())
...
swL2TrunkCurrentNumEntries=_SwL2TrunkCurrentNumEntries_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,2),_SwL2TrunkCurrentNumEntries_Type())
...
swL2TrunkCtrlTable=_SwL2TrunkCtrlTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,3))
if mibBuilder.loadTexts:swL2TrunkCtrlTable.setStatus(_A)
_SwL2TrunkCtrlEntry_Object=MibTableRow
swL2TrunkCtrlEntry=_SwL2TrunkCtrlEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,3,1))
...
swL2TrunkIndex=_SwL2TrunkIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,3,1,1),_SwL2TrunkIndex_Type())
...
swL2TrunkMasterPort=_SwL2TrunkMasterPort_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,3,1,3),_SwL2TrunkMasterPort_Type())
...
swL2TrunkMember=_SwL2TrunkMember_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,3,1,4),_SwL2TrunkMember_Type())
...
swL2TrunkFloodingPort=_SwL2TrunkFloodingPort_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,3,1,5),_SwL2TrunkFloodingPort_Type())
...
swL2TrunkType=_SwL2TrunkType_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,3,1,6),_SwL2TrunkType_Type())
...
swL2TrunkState=_SwL2TrunkState_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,3,1,7),_SwL2TrunkState_Type())
...
swL2TrunkAlgorithm=_SwL2TrunkAlgorithm_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,4),_SwL2TrunkAlgorithm_Type())
...
swL2TrunkLACPPortTable=_SwL2TrunkLACPPortTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,5))
if mibBuilder.loadTexts:swL2TrunkLACPPortTable.setStatus(_A)
_SwL2TrunkLACPPortEntry_Object=MibTableRow
swL2TrunkLACPPortEntry=_SwL2TrunkLACPPortEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,5,1))
...
swL2TrunkLACPPortIndex=_SwL2TrunkLACPPortIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,5,1,1),_SwL2TrunkLACPPortIndex_Type())
...
swL2TrunkLACPPortState=_SwL2TrunkLACPPortState_Object((1,3,6,1,4,1,171,11,102,1,1,2,9,5,1,2),_SwL2TrunkLACPPortState_Type())
...
swL2MirrorMgmt=_SwL2MirrorMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,10))
...
swL2MirrorLogicTargetPort=_SwL2MirrorLogicTargetPort_Object((1,3,6,1,4,1,171,11,102,1,1,2,10,1),_SwL2MirrorLogicTargetPort_Type())
...
swL2MirrorPortSourceIngress=_SwL2MirrorPortSourceIngress_Object((1,3,6,1,4,1,171,11,102,1,1,2,10,2),_SwL2MirrorPortSourceIngress_Type())
...
swL2MirrorPortSourceEgress=_SwL2MirrorPortSourceEgress_Object((1,3,6,1,4,1,171,11,102,1,1,2,10,3),_SwL2MirrorPortSourceEgress_Type())
...
swL2MirrorPortState=_SwL2MirrorPortState_Object((1,3,6,1,4,1,171,11,102,1,1,2,10,4),_SwL2MirrorPortState_Type())
...
swL2TrafficSegMgmt=_SwL2TrafficSegMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,14))
_SwL2TrafficSegTable_Object=MibTable
swL2TrafficSegTable=_SwL2TrafficSegTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,14,1))
if mibBuilder.loadTexts:swL2TrafficSegTable.setStatus(_A)
_SwL2TrafficSegEntry_Object=MibTableRow
swL2TrafficSegEntry=_SwL2TrafficSegEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,14,1,1))
...
swL2TrafficSegPort=_SwL2TrafficSegPort_Object((1,3,6,1,4,1,171,11,102,1,1,2,14,1,1,1),_SwL2TrafficSegPort_Type())
...
swL2TrafficSegForwardPorts=_SwL2TrafficSegForwardPorts_Object((1,3,6,1,4,1,171,11,102,1,1,2,14,1,1,2),_SwL2TrafficSegForwardPorts_Type())
...
swL2MulticastFilterMode=_SwL2MulticastFilterMode_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,17))
_SwL2MulticastFilterModeVlanTable_Object=MibTable
swL2MulticastFilterModeVlanTable=_SwL2MulticastFilterModeVlanTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,17,1))
...
swL2MulticastFilterModeVlanEntry=_SwL2MulticastFilterModeVlanEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,17,1,1))
...
swL2MulticastFilterVid=_SwL2MulticastFilterVid_Object((1,3,6,1,4,1,171,11,102,1,1,2,17,1,1,1),_SwL2MulticastFilterVid_Type())
...
swL2MulticastFilterVlanMode=_SwL2MulticastFilterVlanMode_Object((1,3,6,1,4,1,171,11,102,1,1,2,17,1,1,2),_SwL2MulticastFilterVlanMode_Type())
...
swL2LoopDetectMgmt=_SwL2LoopDetectMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,18))
_SwL2LoopDetectCtrl_ObjectIdentity=ObjectIdentity
swL2LoopDetectCtrl=_SwL2LoopDetectCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,18,1))
...
swL2LoopDetectAdminState=_SwL2LoopDetectAdminState_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,1,1),_SwL2LoopDetectAdminState_Type())
...
swL2LoopDetectInterval=_SwL2LoopDetectInterval_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,1,2),_SwL2LoopDetectInterval_Type())
...
swL2LoopDetectRecoverTime=_SwL2LoopDetectRecoverTime_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,1,3),_SwL2LoopDetectRecoverTime_Type())
...
swL2LoopDetectMode=_SwL2LoopDetectMode_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,1,4),_SwL2LoopDetectMode_Type())
...
swL2LoopDetectTrapMode=_SwL2LoopDetectTrapMode_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,1,5),_SwL2LoopDetectTrapMode_Type())
...
swL2LoopDetectPortMgmt=_SwL2LoopDetectPortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,18,2))
_SwL2LoopDetectPortTable_Object=MibTable
swL2LoopDetectPortTable=_SwL2LoopDetectPortTable_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,2,1))
if mibBuilder.loadTexts:swL2LoopDetectPortTable.setStatus(_A)
_SwL2LoopDetectPortEntry_Object=MibTableRow
swL2LoopDetectPortEntry=_SwL2LoopDetectPortEntry_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,2,1,1))
...
swL2LoopDetectPortIndex=_SwL2LoopDetectPortIndex_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,2,1,1,1),_SwL2LoopDetectPortIndex_Type())
...
swL2LoopDetectPortState=_SwL2LoopDetectPortState_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,2,1,1,2),_SwL2LoopDetectPortState_Type())
...
swL2LoopDetectPortLoopVLAN=_SwL2LoopDetectPortLoopVLAN_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,2,1,1,3),_SwL2LoopDetectPortLoopVLAN_Type())
...
swL2LoopDetectPortLoopStatus=_SwL2LoopDetectPortLoopStatus_Object((1,3,6,1,4,1,171,11,102,1,1,2,18,2,1,1,4),_SwL2LoopDetectPortLoopStatus_Type())
...
swL2MgmtMIBTraps=_SwL2MgmtMIBTraps_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,100))
_SwL2Notify_ObjectIdentity=ObjectIdentity
swL2Notify=_SwL2Notify_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,100,1))
_SwL2NotifyMgmt_ObjectIdentity=ObjectIdentity
swL2NotifyMgmt=_SwL2NotifyMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,100,1,1))
_SwL2NotifyPrefix_ObjectIdentity=ObjectIdentity
swL2NotifyPrefix=_SwL2NotifyPrefix_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2))
_SwL2NotifFirmware_ObjectIdentity=ObjectIdentity
swL2NotifFirmware=_SwL2NotifFirmware_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2,0))
_Swl2NotificationBidings_ObjectIdentity=ObjectIdentity
swl2NotificationBidings=_Swl2NotificationBidings_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2,1))
...
swL2macNotifyInfo=_SwL2macNotifyInfo_Object((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2,1,1),_SwL2macNotifyInfo_Type())
...
swL2VlanLoopDetectVID=_SwL2VlanLoopDetectVID_Object((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2,1,3),_SwL2VlanLoopDetectVID_Type())
swL2VlanLoopDetectVID.setMaxAccess('accessible-for-notify')
if mibBuilder.loadTexts:swL2VlanLoopDetectVID.setStatus(_A)
swL2macNotification=NotificationType((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2,0,1))
swL2macNotification.setObjects((_G,_h))
if mibBuilder.loadTexts:swL2macNotification.setStatus(_A)
swL2PortLoopOccurred=NotificationType((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2,0,3))
swL2PortLoopOccurred.setObjects((_G,_I))
if mibBuilder.loadTexts:swL2PortLoopOccurred.setStatus(_A)
swL2PortLoopRestart=NotificationType((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2,0,4))
swL2PortLoopRestart.setObjects((_G,_I))
if mibBuilder.loadTexts:swL2PortLoopRestart.setStatus(_A)
swL2VlanLoopOccurred=NotificationType((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2,0,5))
swL2VlanLoopOccurred.setObjects(*((_G,_I),(_G,_M)))
if mibBuilder.loadTexts:swL2VlanLoopOccurred.setStatus(_A)
swL2VlanLoopRestart=NotificationType((1,3,6,1,4,1,171,11,102,1,1,2,100,1,2,0,6))
