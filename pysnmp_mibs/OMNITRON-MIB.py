...
mibBuilder.exportSymbols("OMNITRON-MIB", portIngressRateCBS=portIngressRateCBS, traphost7=traphost7, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, subnetmask=subnetmask, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, customertag=customertag, ipAddr2=ipAddr2, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, prodtype=prodtype, snmpTrapType=snmpTrapType, softrev=softrev, modLM80currents=modLM80currents, omnitronConformance=omnitronConformance, txDeferedTransmit=txDeferedTransmit, vlanPri=vlanPri, chassistype=chassistype, cpuVoltageIn=cpuVoltageIn, rxPackets65to127=rxPackets65to127, portFwdCpuList=portFwdCpuList, txSingleCollision=txSingleCollision, modPcbRev=modPcbRev, vlanservicetag=vlanservicetag, slaveTrapsForward=slaveTrapsForward, nmmCfgState=nmmCfgState, snmpv3UserType=snmpv3UserType, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, enhancedchassisTable=enhancedchassisTable, ipaddrEVCassociation=ipaddrEVCassociation, portSfpBitRate=portSfpBitRate, rxSymbolErrors=rxSymbolErrors, rxTotalPkts=rxTotalPkts, moduleCount=moduleCount, index=index, portSfpTxPower=portSfpTxPower, ahLocalParserState=ahLocalParserState, port1Membership=port1Membership, portDuplex=portDuplex, portegresspolicy=portegresspolicy, ahFramePeriodEventTotal=ahFramePeriodEventTotal, port5Membership=port5Membership, ostProtocolStatusTable=ostProtocolStatusTable, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, manufdate=manufdate, gateway=gateway, portvlanidentifier=portvlanidentifier, omnitronProducts=omnitronProducts, validityflag=validityflag, portIngressRate=portIngressRate, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, tftpServerIpAddress=tftpServerIpAddress, moduleMgtCfgEntry=moduleMgtCfgEntry, portingresssecurity=portingresssecurity, portStatsTable=portStatsTable, ahRemoteLinkPort=ahRemoteLinkPort, txErrorPkts=txErrorPkts, portSFPEntry=portSFPEntry, snmpv3PrivPassword=snmpv3PrivPassword, ostProtocolStatusIndex=ostProtocolStatusIndex, modulePortsEntry=modulePortsEntry, extended3=extended3, prodAgent=prodAgent, userTable=userTable, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ftppasswrd=ftppasswrd, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, sysDateTime=sysDateTime, portSfpTemperature=portSfpTemperature, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, nmmIpDisabled=nmmIpDisabled, modenable802dot1qProcessing=modenable802dot1qProcessing, ipaddr2EVCassociation=ipaddr2EVCassociation, vlanidentifier=vlanidentifier, modeType=modeType, rxUnicastPkts=rxUnicastPkts, rxMulticastPkts=rxMulticastPkts, dhcpSubnetmask=dhcpSubnetmask, modswbuildnum=modswbuildnum, traphost5=traphost5, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, rxPausePkts=rxPausePkts, ostProtocolStatusEntry=ostProtocolStatusEntry, ostEnvironmentalTemperature=ostEnvironmentalTemperature, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, trapSrcIpSelect=trapSrcIpSelect, port4Membership=port4Membership, modExpPartNumber=modExpPartNumber, ahErroredFrameWindow=ahErroredFrameWindow, enabledFunctions=enabledFunctions, portmlistcriteria=portmlistcriteria, txCollisions=txCollisions, rxFCSErrors=rxFCSErrors, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, portState=portState, extended2=extended2, portSpeed=portSpeed, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ledstat=ledstat, slotnum=slotnum, dhcpIpAddr=dhcpIpAddr, modchassnum=modchassnum, moduleEntry=moduleEntry, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, PYSNMP_MODULE_ID=omnitronMIB, ipAddr=ipAddr, subnetmask2=subnetmask2, traphost2=traphost2, modcommitNMMCfgChanges=modcommitNMMCfgChanges, moduleTable=moduleTable, ahClearStatistics=ahClearStatistics, modserialnum=modserialnum, sysloc=sysloc, capsMask=capsMask, rxErrorPkts=rxErrorPkts, mychassnum=mychassnum, extended4=extended4, enableSNMPWrites=enableSNMPWrites, ostProtocolStatusType=ostProtocolStatusType, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ahCriticalEventMode=ahCriticalEventMode, rxAlignmentErrors=rxAlignmentErrors, port2Membership=port2Membership, portFwdCpu=portFwdCpu, omnitronGroups=omnitronGroups, modLM80volts=modLM80volts, chassisEntry=chassisEntry, port6Membership=port6Membership, rxBroadcastPkts=rxBroadcastPkts, traphost1=traphost1, partnum=partnum, servicetag=servicetag, tftpFileName=tftpFileName, wrswitch=wrswitch, txLateCollision=txLateCollision, ahRemoteParserState=ahRemoteParserState, portEgressRate=portEgressRate, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ahLocalOUI=ahLocalOUI, rxPackets64=rxPackets64, userEntry=userEntry, slaveWrite=slaveWrite, ahRemoteMuxState=ahRemoteMuxState, ahCriticalEventTrapList=ahCriticalEventTrapList, tftpEnable=tftpEnable, modextfeaturebits=modextfeaturebits, switchstat=switchstat, portEgressQosPolicy=portEgressQosPolicy, enableSNMPv3Function=enableSNMPv3Function, chassisnum=chassisnum, modportvlan=modportvlan, rxJabbers=rxJabbers, sysAdminStatus=sysAdminStatus, cnodeControl=cnodeControl, ahRemoteLinkFlags=ahRemoteLinkFlags, port3Membership=port3Membership, portL2CPmgntProcessing=portL2CPmgntProcessing, extended6=extended6, portSFPpageA2=portSFPpageA2, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, dhcpPortNumber=dhcpPortNumber, ahLocalMode=ahLocalMode, portStatsEntry=portStatsEntry, keepAliveInterval=keepAliveInterval, telnetpass=telnetpass, rxPackets512to1023=rxPackets512to1023, txPausePkts=txPausePkts, rxGoodPkts=rxGoodPkts, modExpLedStatus=modExpLedStatus, rxOctets=rxOctets, chassis=chassis, txUnicastPkts=txUnicastPkts, txGoodPkts=txGoodPkts, gateway2=gateway2, ahEnabled=ahEnabled, moduleVLANTable=moduleVLANTable, userIndex=userIndex, ahErroredFrameThreshold=ahErroredFrameThreshold, chassisname=chassisname, snmpv3SecurityLevel=snmpv3SecurityLevel, modLM80misc=modLM80misc, ostProtocoManagementPort=ostProtocoManagementPort, serialnum=serialnum, rxPackets256to511=rxPackets256to511, modpartnum=modpartnum, modchasstype=modchasstype, txDropPkts=txDropPkts, managementModule=managementModule, slaveTraps=slaveTraps, portnum=portnum, txMultipleCollision=txMultipleCollision, txOctets64=txOctets64, modprodtype=modprodtype, moduleVLANEntry=moduleVLANEntry, rxCRCAlignErrors=rxCRCAlignErrors, portSFPpageA0=portSFPpageA0, modvlanTableClear=modvlanTableClear, ahLocalLinkFlags=ahLocalLinkFlags, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, modchassname=modchassname, modnumports=modnumports, traphost4=traphost4, ostProtocolStatusState=ostProtocolStatusState, readCommunity=readCommunity, nmmOAMmgmtMode=nmmOAMmgmtMode, portAccessType=portAccessType, portLinkState=portLinkState, modcommitVLANchanges=modcommitVLANchanges, portcanonicalformatIndicator=portcanonicalformatIndicator, ahRemoteMode=ahRemoteMode, rxFragments=rxFragments, vlanIdOst=vlanIdOst, cpuVoltageOut=cpuVoltageOut, modsoftrev=modsoftrev, portSfpVendorSerialNumber=portSfpVendorSerialNumber, txOctets=txOctets, nmmIpProtocolState=nmmIpProtocolState, macAddr=macAddr, txMulticastPkts=txMulticastPkts, enableSNMPFunction=enableSNMPFunction, txBroadcastPkts=txBroadcastPkts, ahLocalMuxState=ahLocalMuxState, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portSfpDateCode=portSfpDateCode, ahLocalSupportVar=ahLocalSupportVar, modRestoreFactoryDefaults=modRestoreFactoryDefaults, nmmSecureSlaveSlot=nmmSecureSlaveSlot, modHwRev=modHwRev, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, writeCommunity=writeCommunity, moduleMgtCfgTable=moduleMgtCfgTable, modslotnum=modslotnum, dhcpTagVid=dhcpTagVid, ahLocalLpbkTimeout=ahLocalLpbkTimeout, selfSlot=selfSlot, omnitronMIB=omnitronMIB, traphost8=traphost8, ahTransmissionRate=ahTransmissionRate, modulename=modulename, portSFPstatus=portSFPstatus, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, rxUndersizePkts=rxUndersizePkts, extended1=extended1, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portSFPTable=portSFPTable, omnitronCompliances=omnitronCompliances, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, portSfpVendorPartNumber=portSfpVendorPartNumber, modExpSoftwareRev=modExpSoftwareRev, ahRemoteSupportVar=ahRemoteSupportVar, prodrev=prodrev, portSfpVcc=portSfpVcc, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold)
mibBuilder.exportSymbols("OMNITRON-MIB", omnitronCompliance=omnitronCompliance, modFpgaRev=modFpgaRev, ahLpbkMode=ahLpbkMode, extended5=extended5, portIngressRateDropOrPause=portIngressRateDropOrPause, rxPackets128to255=rxPackets128to255, snmpv3AuthPassword=snmpv3AuthPassword, coreStatusOnly=coreStatusOnly, snmpv3UserName=snmpv3UserName, rxOctets64=rxOctets64, bootpEnable=bootpEnable, chassisTable=chassisTable, ingressPolicingType=ingressPolicingType, modreset=modreset, muxGroupDefaults=muxGroupDefaults, rxDropPkts=rxDropPkts, modtagsubstitution=modtagsubstitution, modulePortsTable=modulePortsTable, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, traphost3=traphost3, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, portSfpBiasCurrent=portSfpBiasCurrent, rxOversizePkts=rxOversizePkts, ahRemoteOUI=ahRemoteOUI, omnitronSFPGroup=omnitronSFPGroup, modmanufdate=modmanufdate, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, cnodeCIR=cnodeCIR, resetmod=resetmod, portSfpRxPower=portSfpRxPower, txExcessiveCollision=txExcessiveCollision, nmmSecureConnState=nmmSecureConnState, nmmSecureMode=nmmSecureMode, portAHTable=portAHTable, ahFrameErrorEventTotal=ahFrameErrorEventTotal, traphost6=traphost6, modprodrev=modprodrev, cpuTemperature=cpuTemperature, mmname=mmname, syscon=syscon, omnitronGroup=omnitronGroup, portStatsClear=portStatsClear, portpriority=portpriority, modname=modname, rxPackets1024to1518=rxPackets1024to1518, portSfpVendorName=portSfpVendorName, txDroppedEvents=txDroppedEvents, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, portMacAddress=portMacAddress, defaultForwardingMap=defaultForwardingMap, serialpass=serialpass, portAHEntry=portAHEntry, dhcpGateway=dhcpGateway)
