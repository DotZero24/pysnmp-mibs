...
mibBuilder.exportSymbols("MADGEBOX-MIB", madgeSecureAllowedIPAddress=madgeSecureAllowedIPAddress, madgeIPRarpEnabled=madgeIPRarpEnabled, madgeConfigIPGateway=madgeConfigIPGateway, madgeSecureAllowedEntry=madgeSecureAllowedEntry, madgeConfigIPAddress=madgeConfigIPAddress, madgeDownloadState=madgeDownloadState, madgeConfigIPSubnetMask=madgeConfigIPSubnetMask, madgeDownloadIPXAddress=madgeDownloadIPXAddress, madgeConfigSerialNumber=madgeConfigSerialNumber, madgeConfigBCodeVersion=madgeConfigBCodeVersion, madgeSecureCurrentTableSize=madgeSecureCurrentTableSize, madgeSecureAllowedType=madgeSecureAllowedType, madgeSecureTrapDestAddress=madgeSecureTrapDestAddress, madgeDownloadFailureCode=madgeDownloadFailureCode, madgeDownloadSize=madgeDownloadSize, madgeBox=madgeBox, madgeVersionTable=madgeVersionTable, madgeConfigAdminStatus=madgeConfigAdminStatus, madgeSecureTrapDestEntry=madgeSecureTrapDestEntry, madgeConfigEraseFlashVersion=madgeConfigEraseFlashVersion, madgeSecureAllowedAddress=madgeSecureAllowedAddress, madgeDownloadStatusText=madgeDownloadStatusText, madgeSecureCurrentAddress=madgeSecureCurrentAddress, madgeSecureCurrentIndex=madgeSecureCurrentIndex, madgeSecureCurrentUpdateTime=madgeSecureCurrentUpdateTime, madge=madge, madgeSecureCurrentTable=madgeSecureCurrentTable, madgeConfigLinkTest=madgeConfigLinkTest, madgeIPDiscoveryMethod=madgeIPDiscoveryMethod, MacAddress=MacAddress, madgeConfigOperStatus=madgeConfigOperStatus, madgeVersionType=madgeVersionType, madgeDownloadIPGateway=madgeDownloadIPGateway, madgeConfigDeviceHealth=madgeConfigDeviceHealth, madgeConfigMCodeFilename=madgeConfigMCodeFilename, madgeIPCurrentSubnetMask=madgeIPCurrentSubnetMask, madgeSecureAllowedEnabled=madgeSecureAllowedEnabled, madgeDownload=madgeDownload, madgeSecureAllowedTableSize=madgeSecureAllowedTableSize, madgeIPCurrentAddress=madgeIPCurrentAddress, madgeVersionEntry=madgeVersionEntry, madgeVersionCount=madgeVersionCount, madgeSecureAllowedTable=madgeSecureAllowedTable, madgeDownloadFileName=madgeDownloadFileName, madgeSecureTrapDestIPAddress=madgeSecureTrapDestIPAddress, madgeSecureCurrentType=madgeSecureCurrentType, madgeSecureTrapDestTableSize=madgeSecureTrapDestTableSize, madgeSecureCurrentTimeout=madgeSecureCurrentTimeout, madgeSecureTrapDestEnabled=madgeSecureTrapDestEnabled, madgeSecureTrapDestTable=madgeSecureTrapDestTable, madgeDownloadNodeAddress=madgeDownloadNodeAddress, madgeIPBootpEnabled=madgeIPBootpEnabled, madgeVersionDescription=madgeVersionDescription, madgeDownloadIPAddress=madgeDownloadIPAddress, madgeSecureAllowedIndex=madgeSecureAllowedIndex, madgeVersionLocation=madgeVersionLocation, madgeSecureCurrentIPAddress=madgeSecureCurrentIPAddress, madgeSecureTrapDestType=madgeSecureTrapDestType, madgeIP=madgeIP, madgeVersionIndex=madgeVersionIndex, madgeConfig=madgeConfig, madgeConfigDefaultFlashVersion=madgeConfigDefaultFlashVersion, madgeVersion=madgeVersion, madgeSecureCurrentEntry=madgeSecureCurrentEntry, madgeSecure=madgeSecure, madgeSecureTrapDestIndex=madgeSecureTrapDestIndex, madgeVersionNumber=madgeVersionNumber, madgeConfigMCodeVersion=madgeConfigMCodeVersion, DisplayString=DisplayString, madgeConfigPassword=madgeConfigPassword, madgeDownloadDestination=madgeDownloadDestination, madgeIPCurrentGateway=madgeIPCurrentGateway)
