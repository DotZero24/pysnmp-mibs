# SNMP MIB module (NETGEAR-QOS-DIFFSERV-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-QOS-DIFFSERV-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:37 2025
...
agentDiffServClassEntry = _AgentDiffServClassEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 7, 2, 2, 1)
)
agentDiffServClassEntry.setIndexNames(
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServClassIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServClassRuleEntry = _AgentDiffServClassRuleEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 7, 2, 3, 1)
)
agentDiffServClassRuleEntry.setIndexNames(
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServClassIndex"),
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServClassRuleIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyEntry = _AgentDiffServPolicyEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 7, 3, 2, 1)
)
agentDiffServPolicyEntry.setIndexNames(
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyInstEntry = _AgentDiffServPolicyInstEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 7, 3, 3, 1)
)
agentDiffServPolicyInstEntry.setIndexNames(
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyIndex"),
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyInstIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServPolicyAttrEntry = _AgentDiffServPolicyAttrEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 7, 3, 4, 1)
)
agentDiffServPolicyAttrEntry.setIndexNames(
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyIndex"),
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyInstIndex"),
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServPolicyAttrIndex"),
)
if mibBuilder.loadTexts:
...
agentDiffServServiceEntry = _AgentDiffServServiceEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 7, 4, 1, 1)
)
agentDiffServServiceEntry.setIndexNames(
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServServiceIfIndex"),
    (0, "NETGEAR-QOS-DIFFSERV-PRIVATE-MIB", "agentDiffServServiceIfDirection"),
)
if mibBuilder.loadTexts:
