...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DIAMETER-CC-APPL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:41:29 2025
...
_CdccaPeerStorageType_Type.__name__ = "StorageType"
...
_CdccaPeerVendorStorageType_Type.__name__ = "StorageType"
...
ciscoDiameterCCAMIBCompliance.setObjects(
      *(("CISCO-DIAMETER-CC-APPL-MIB", "ciscoDiameterCCAPeerStatsGroup"),
        ("CISCO-DIAMETER-CC-APPL-MIB", "ciscoDiameterCCAHostCfgGroup"),
        ("CISCO-DIAMETER-CC-APPL-MIB", "ciscoDiameterCCAPeerCfgGroup"))
)
if mibBuilder.loadTexts:
