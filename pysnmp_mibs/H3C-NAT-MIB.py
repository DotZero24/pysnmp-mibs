...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-NAT-MIB
...
h3cNATStatVer2Table = _H3cNATStatVer2Table_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13)
)
if mibBuilder.loadTexts:
    h3cNATStatVer2Table.setStatus("current")
_H3cNATStatVer2TableEntry_Object = MibTableRow
h3cNATStatVer2TableEntry = _H3cNATStatVer2TableEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1)
)
h3cNATStatVer2TableEntry.setIndexNames(
    (0, "H3C-NAT-MIB", "h3cNATStatChassis"),
    (0, "H3C-NAT-MIB", "h3cNATStatSlot"),
    (0, "H3C-NAT-MIB", "h3cNATStatCPUID"),
)
if mibBuilder.loadTexts:
    h3cNATStatVer2TableEntry.setStatus("current")


class _H3cNATStatChassis_Type(Unsigned32):
    """Custom type h3cNATStatChassis based on Unsigned32"""
...
_H3cNATStatChassis_Type.__name__ = "Unsigned32"
_H3cNATStatChassis_Object = MibTableColumn
h3cNATStatChassis = _H3cNATStatChassis_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 1),
    _H3cNATStatChassis_Type()
)
h3cNATStatChassis.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNATStatChassis.setStatus("current")


class _H3cNATStatSlot_Type(Unsigned32):
    """Custom type h3cNATStatSlot based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65534),
    )
...
_H3cNATStatSlot_Type.__name__ = "Unsigned32"
_H3cNATStatSlot_Object = MibTableColumn
h3cNATStatSlot = _H3cNATStatSlot_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 2),
    _H3cNATStatSlot_Type()
)
h3cNATStatSlot.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNATStatSlot.setStatus("current")


class _H3cNATStatCPUID_Type(Unsigned32):
    """Custom type h3cNATStatCPUID based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cNATStatCPUID_Type.__name__ = "Unsigned32"
_H3cNATStatCPUID_Object = MibTableColumn
h3cNATStatCPUID = _H3cNATStatCPUID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 3),
    _H3cNATStatCPUID_Type()
)
h3cNATStatCPUID.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNATStatCPUID.setStatus("current")
_H3cNATTotalNATSessionCount_Type = Unsigned32
_H3cNATTotalNATSessionCount_Object = MibTableColumn
h3cNATTotalNATSessionCount = _H3cNATTotalNATSessionCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 4),
    _H3cNATTotalNATSessionCount_Type()
)
h3cNATTotalNATSessionCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATTotalNATSessionCount.setStatus("current")
_H3cNATEimTableCount_Type = Unsigned32
_H3cNATEimTableCount_Object = MibTableColumn
h3cNATEimTableCount = _H3cNATEimTableCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 5),
    _H3cNATEimTableCount_Type()
)
h3cNATEimTableCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATEimTableCount.setStatus("current")
_H3cNATInboundNoPATTableCount_Type = Unsigned32
_H3cNATInboundNoPATTableCount_Object = MibTableColumn
h3cNATInboundNoPATTableCount = _H3cNATInboundNoPATTableCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 6),
    _H3cNATInboundNoPATTableCount_Type()
)
h3cNATInboundNoPATTableCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATInboundNoPATTableCount.setStatus("current")
_H3cNATOutboundNoPATTableCount_Type = Unsigned32
_H3cNATOutboundNoPATTableCount_Object = MibTableColumn
h3cNATOutboundNoPATTableCount = _H3cNATOutboundNoPATTableCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 7),
    _H3cNATOutboundNoPATTableCount_Type()
)
h3cNATOutboundNoPATTableCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATOutboundNoPATTableCount.setStatus("current")
_H3cNATMaxDynamicPortblock_Type = Unsigned32
_H3cNATMaxDynamicPortblock_Object = MibTableColumn
h3cNATMaxDynamicPortblock = _H3cNATMaxDynamicPortblock_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 8),
    _H3cNATMaxDynamicPortblock_Type()
)
h3cNATMaxDynamicPortblock.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATMaxDynamicPortblock.setStatus("current")
_H3cNATMaxStaticPortblock_Type = Unsigned32
_H3cNATMaxStaticPortblock_Object = MibTableColumn
h3cNATMaxStaticPortblock = _H3cNATMaxStaticPortblock_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 9),
    _H3cNATMaxStaticPortblock_Type()
)
h3cNATMaxStaticPortblock.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATMaxStaticPortblock.setStatus("current")
_H3cNATActiveDynamicPortblock_Type = Unsigned32
_H3cNATActiveDynamicPortblock_Object = MibTableColumn
h3cNATActiveDynamicPortblock = _H3cNATActiveDynamicPortblock_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 10),
    _H3cNATActiveDynamicPortblock_Type()
)
h3cNATActiveDynamicPortblock.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATActiveDynamicPortblock.setStatus("current")
_H3cNATActiveStaticPortblock_Type = Unsigned32
_H3cNATActiveStaticPortblock_Object = MibTableColumn
h3cNATActiveStaticPortblock = _H3cNATActiveStaticPortblock_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 11),
    _H3cNATActiveStaticPortblock_Type()
)
h3cNATActiveStaticPortblock.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATActiveStaticPortblock.setStatus("current")
_H3cNATSessionCreateRate_Type = Unsigned32
_H3cNATSessionCreateRate_Object = MibTableColumn
h3cNATSessionCreateRate = _H3cNATSessionCreateRate_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 13, 1, 12),
    _H3cNATSessionCreateRate_Type()
)
h3cNATSessionCreateRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATSessionCreateRate.setStatus("current")
_H3cNATAddrGrpStatTable_Object = MibTable
h3cNATAddrGrpStatTable = _H3cNATAddrGrpStatTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 14)
)
if mibBuilder.loadTexts:
    h3cNATAddrGrpStatTable.setStatus("current")
_H3cNATAddrGrpStatTableEntry_Object = MibTableRow
h3cNATAddrGrpStatTableEntry = _H3cNATAddrGrpStatTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 14, 1)
)
h3cNATAddrGrpStatTableEntry.setIndexNames(
    (0, "H3C-NAT-MIB", "h3cNATAddrGrpStatChassis"),
    (0, "H3C-NAT-MIB", "h3cNATAddrGrpStatSlot"),
    (0, "H3C-NAT-MIB", "h3cNATAddrGrpStatCPUID"),
    (0, "H3C-NAT-MIB", "h3cNATAddrGrpStatAddrGrpNum"),
)
if mibBuilder.loadTexts:
    h3cNATAddrGrpStatTableEntry.setStatus("current")


class _H3cNATAddrGrpStatChassis_Type(Unsigned32):
    """Custom type h3cNATAddrGrpStatChassis based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65534),
    )
...
_H3cNATAddrGrpStatChassis_Type.__name__ = "Unsigned32"
_H3cNATAddrGrpStatChassis_Object = MibTableColumn
h3cNATAddrGrpStatChassis = _H3cNATAddrGrpStatChassis_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 14, 1, 1),
    _H3cNATAddrGrpStatChassis_Type()
)
h3cNATAddrGrpStatChassis.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNATAddrGrpStatChassis.setStatus("current")


class _H3cNATAddrGrpStatSlot_Type(Unsigned32):
    """Custom type h3cNATAddrGrpStatSlot based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65534),
    )
...
_H3cNATAddrGrpStatSlot_Type.__name__ = "Unsigned32"
_H3cNATAddrGrpStatSlot_Object = MibTableColumn
h3cNATAddrGrpStatSlot = _H3cNATAddrGrpStatSlot_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 14, 1, 2),
    _H3cNATAddrGrpStatSlot_Type()
)
h3cNATAddrGrpStatSlot.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNATAddrGrpStatSlot.setStatus("current")


class _H3cNATAddrGrpStatCPUID_Type(Unsigned32):
    """Custom type h3cNATAddrGrpStatCPUID based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 7),
    )
...
_H3cNATAddrGrpStatCPUID_Type.__name__ = "Unsigned32"
_H3cNATAddrGrpStatCPUID_Object = MibTableColumn
h3cNATAddrGrpStatCPUID = _H3cNATAddrGrpStatCPUID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 14, 1, 3),
    _H3cNATAddrGrpStatCPUID_Type()
)
h3cNATAddrGrpStatCPUID.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNATAddrGrpStatCPUID.setStatus("current")


class _H3cNATAddrGrpStatAddrGrpNum_Type(Unsigned32):
    """Custom type h3cNATAddrGrpStatAddrGrpNum based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_H3cNATAddrGrpStatAddrGrpNum_Type.__name__ = "Unsigned32"
_H3cNATAddrGrpStatAddrGrpNum_Object = MibTableColumn
h3cNATAddrGrpStatAddrGrpNum = _H3cNATAddrGrpStatAddrGrpNum_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 14, 1, 4),
    _H3cNATAddrGrpStatAddrGrpNum_Type()
)
h3cNATAddrGrpStatAddrGrpNum.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNATAddrGrpStatAddrGrpNum.setStatus("current")
_H3cNATAddrGrpStatFailAllocPort_Type = Unsigned32
_H3cNATAddrGrpStatFailAllocPort_Object = MibTableColumn
h3cNATAddrGrpStatFailAllocPort = _H3cNATAddrGrpStatFailAllocPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 14, 1, 5),
    _H3cNATAddrGrpStatFailAllocPort_Type()
)
h3cNATAddrGrpStatFailAllocPort.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATAddrGrpStatFailAllocPort.setStatus("current")
_H3cNATAddrGrpStatAddrGrpSessCnt_Type = Counter64
_H3cNATAddrGrpStatAddrGrpSessCnt_Object = MibTableColumn
h3cNATAddrGrpStatAddrGrpSessCnt = _H3cNATAddrGrpStatAddrGrpSessCnt_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 18, 2, 14, 1, 6),
    _H3cNATAddrGrpStatAddrGrpSessCnt_Type()
)
h3cNATAddrGrpStatAddrGrpSessCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNATAddrGrpStatAddrGrpSessCnt.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"h3cNat": h3cNat,
       ...
       "h3cNATStatVer2Table": h3cNATStatVer2Table,
       "h3cNATStatVer2TableEntry": h3cNATStatVer2TableEntry,
       "h3cNATStatChassis": h3cNATStatChassis,
       "h3cNATStatSlot": h3cNATStatSlot,
       "h3cNATStatCPUID": h3cNATStatCPUID,
       "h3cNATTotalNATSessionCount": h3cNATTotalNATSessionCount,
       "h3cNATEimTableCount": h3cNATEimTableCount,
       "h3cNATInboundNoPATTableCount": h3cNATInboundNoPATTableCount,
       "h3cNATOutboundNoPATTableCount": h3cNATOutboundNoPATTableCount,
       "h3cNATMaxDynamicPortblock": h3cNATMaxDynamicPortblock,
       "h3cNATMaxStaticPortblock": h3cNATMaxStaticPortblock,
       "h3cNATActiveDynamicPortblock": h3cNATActiveDynamicPortblock,
       "h3cNATActiveStaticPortblock": h3cNATActiveStaticPortblock,
       "h3cNATSessionCreateRate": h3cNATSessionCreateRate,
       "h3cNATAddrGrpStatTable": h3cNATAddrGrpStatTable,
       "h3cNATAddrGrpStatTableEntry": h3cNATAddrGrpStatTableEntry,
       "h3cNATAddrGrpStatChassis": h3cNATAddrGrpStatChassis,
       "h3cNATAddrGrpStatSlot": h3cNATAddrGrpStatSlot,
       "h3cNATAddrGrpStatCPUID": h3cNATAddrGrpStatCPUID,
       "h3cNATAddrGrpStatAddrGrpNum": h3cNATAddrGrpStatAddrGrpNum,
       "h3cNATAddrGrpStatFailAllocPort": h3cNATAddrGrpStatFailAllocPort,
       "h3cNATAddrGrpStatAddrGrpSessCnt": h3cNATAddrGrpStatAddrGrpSessCnt}
)
