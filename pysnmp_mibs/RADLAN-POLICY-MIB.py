...
Percents,VlanPriority,rnd=mibBuilder.importSymbols('RADLAN-MIB','Percents','VlanPriority','rnd')
...
rlPolicyRmNewExceedDscp=_RlPolicyRmNewExceedDscp_Object((1,3,6,1,4,1,89,59,10,3,1,4),_RlPolicyRmNewExceedDscp_Type())
