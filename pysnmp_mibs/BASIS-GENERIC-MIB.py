...
mibBuilder.exportSymbols("BASIS-GENERIC-MIB", secLineModuleType=secLineModuleType, interfaceNumOfPVC=interfaceNumOfPVC, xmtCellsBCM=xmtCellsBCM, selfTestPeriod=selfTestPeriod, configChangeObjectIndex=configChangeObjectIndex, rcvCellsDiscOAM=rcvCellsDiscOAM, secLineModuleFWRev=secLineModuleFWRev, selfTestEnable=selfTestEnable, selfTestClrResultButton=selfTestClrResultButton, xmtCellsSegmentLpBk=xmtCellsSegmentLpBk, ctrlMsgClrButton=ctrlMsgClrButton, xmtCellsAIS=xmtCellsAIS, sarCtrlMsgLastUnkownChan=sarCtrlMsgLastUnkownChan, mibVersionNumber=mibVersionNumber, configChangeSMSpecificObject=configChangeSMSpecificObject, macAddress=macAddress, sarShelfNum=sarShelfNum, functionModuleFWRev=functionModuleFWRev, hwFailures=hwFailures, xmtCellsEnd2EndLpBk=xmtCellsEnd2EndLpBk, interfaceNumOfEgressQueue=interfaceNumOfEgressQueue, secLineModuleDescription=secLineModuleDescription, sarCtrlMsgDiscLenErr=sarCtrlMsgDiscLenErr, rcvCellsAIS=rcvCellsAIS, functionModuleState=functionModuleState, rcvCellsEnd2EndLpBk=rcvCellsEnd2EndLpBk, configChangeParentObjectIndex=configChangeParentObjectIndex, rcvCellsSegmentLpBk=rcvCellsSegmentLpBk, sarCtrlMsgDiscUnknownChan=sarCtrlMsgDiscUnknownChan, controlMsgCounter=controlMsgCounter, interfaceNumOfPortsPerLine=interfaceNumOfPortsPerLine, configChangeTypeBitMap=configChangeTypeBitMap, lineModuleDescription=lineModuleDescription, functionModuleHWRev=functionModuleHWRev, lineModuleFWRev=lineModuleFWRev, cardInterface=cardInterface, secLineModuleHWRev=secLineModuleHWRev, finalTestTechnician=finalTestTechnician, xmtCellsFERF=xmtCellsFERF, interfaceLineEntry=interfaceLineEntry, functionModuleResetReason=functionModuleResetReason, xmtCellsDiscShelfAlarm=xmtCellsDiscShelfAlarm, lineModuleSerialNum=lineModuleSerialNum, sarCtrlMsgDiscCRCErr=sarCtrlMsgDiscCRCErr, functionModuleDescription=functionModuleDescription, sarRcvCtrlMsg=sarRcvCtrlMsg, sarClrButton=sarClrButton, sarSlotNum=sarSlotNum, macAddrBlkSize=macAddrBlkSize, sarXmtCtrlMsg=sarXmtCtrlMsg, sarChanNum=sarChanNum, secLineModuleState=secLineModuleState, lineModuleType=lineModuleType, chanNumOfValidEntries=chanNumOfValidEntries, interfaceLineNum=interfaceLineNum, cardIntegratedAlarmBitMap=cardIntegratedAlarmBitMap, lineModuleHWRev=lineModuleHWRev, selfTestResultDescription=selfTestResultDescription, functionModuleType=functionModuleType, rcvCellsFERF=rcvCellsFERF, moduleSlotNumber=moduleSlotNumber, configChangeGrandParentObjectIndex=configChangeGrandParentObjectIndex, sarChannelCounter=sarChannelCounter, secLineModuleSerialNum=secLineModuleSerialNum, functionModuleSerialNum=functionModuleSerialNum, riscRcvCtrlMsg=riscRcvCtrlMsg, selfTestState=selfTestState, lineModuleState=lineModuleState, interfaceLineType=interfaceLineType, cleiCode=cleiCode, sarChannelCounterTable=sarChannelCounterTable, cardInformation=cardInformation, riscXmtCtrlMsg=riscXmtCtrlMsg, rcvCellsCLP=rcvCellsCLP, hwHistory=hwHistory, sarChannelCounterEntry=sarChannelCounterEntry, transId=transId, interfaceServiceType=interfaceServiceType, rcvCellsBCM=rcvCellsBCM, interfaceNumOfValidEntries=interfaceNumOfValidEntries, rcvCells=rcvCells, xmtCells=xmtCells, cardSelfTest=cardSelfTest, configChangeStatus=configChangeStatus, interfaceLineTable=interfaceLineTable, xmtCellsCLP=xmtCellsCLP, moduleTrapAlarmSeverity=moduleTrapAlarmSeverity)
