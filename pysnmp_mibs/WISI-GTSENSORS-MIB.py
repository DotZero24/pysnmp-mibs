...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/wisi/WISI-GTSENSORS-MIB
...
mibBuilder.exportSymbols("WISI-GTSENSORS-MIB", gtSensorsNotifications=gtSensorsNotifications, gtPSUCurrent=gtPSUCurrent, gtFansTable=gtFansTable, gtPSUPower=gtPSUPower, gtSensorsNotifyPSUCurrent=gtSensorsNotifyPSUCurrent, gtSensorsNotifyPSUFailure=gtSensorsNotifyPSUFailure, gtTempValue=gtTempValue, gtSensorsMIBCompliance=gtSensorsMIBCompliance, gtSensorsNotifyTemperature=gtSensorsNotifyTemperature, gtTempsTable=gtTempsTable, gtSensorsNotifyPSUFailureClear=gtSensorsNotifyPSUFailureClear, gtSensorsNotifyBOARDTemperatureClear=gtSensorsNotifyBOARDTemperatureClear, gtFanSpeed=gtFanSpeed, gtNumTemps=gtNumTemps, gtTemp=gtTemp, gtSensorsTrapGroup=gtSensorsTrapGroup, gtPSUTemperature=gtPSUTemperature, gtPSU=gtPSU, gtSensorsStatsGroup=gtSensorsStatsGroup, gtFanUptime=gtFanUptime, PYSNMP_MODULE_ID=gtSensorsMIB, gtFan=gtFan, gtSensorsConformance=gtSensorsConformance, gtNumFans=gtNumFans, gtPSUsEntry=gtPSUsEntry, gtSensorsObjects=gtSensorsObjects, gtSensorsBasicNotificationsGroup=gtSensorsBasicNotificationsGroup, gtFanName=gtFanName, gtPSUVoltageInt=gtPSUVoltageInt, gtFansEntry=gtFansEntry, gtPSUName=gtPSUName, gtSensorsV1Group=gtSensorsV1Group, gtPSUVoltageOR=gtPSUVoltageOR, gtTempsEntry=gtTempsEntry, gtPSUVoltageExt=gtPSUVoltageExt, gtSensorsGroups=gtSensorsGroups, gtSensorsNotifyPSUPlugin=gtSensorsNotifyPSUPlugin, gtSensorsNotifyFanPlugout=gtSensorsNotifyFanPlugout, gtNumPSUs=gtNumPSUs, gtSensorsNotifyFanPlugin=gtSensorsNotifyFanPlugin, gtSensorsNotifyPSUTemperatureClear=gtSensorsNotifyPSUTemperatureClear, gtSensorsMIB=gtSensorsMIB, gtSensorsNotifyFanSpeed=gtSensorsNotifyFanSpeed, gtSensorsCompliances=gtSensorsCompliances, gtSensorsNotifyPSUTemperature=gtSensorsNotifyPSUTemperature, gtSensorsNotifyPSUPlugout=gtSensorsNotifyPSUPlugout, gtSensorsSetGroup=gtSensorsSetGroup, gtTempName=gtTempName, gtFanLifetime=gtFanLifetime, gtSensorsSystemGroup=gtSensorsSystemGroup, gtSensorsNotifyPSUVoltage=gtSensorsNotifyPSUVoltage, gtFanControl=gtFanControl, gtPSUsTable=gtPSUsTable)
