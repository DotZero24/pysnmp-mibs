...
mibBuilder.exportSymbols("WISI-GTSENSORS-MIB", gtSensorsNotifyPSUVoltage=gtSensorsNotifyPSUVoltage, gtFansEntry=gtFansEntry, gtSensorsNotifyFanPlugin=gtSensorsNotifyFanPlugin, gtSensorsMIB=gtSensorsMIB, gtSensorsNotifyTemperature=gtSensorsNotifyTemperature, gtSensorsMIBCompliance=gtSensorsMIBCompliance, gtSensorsNotifyPSUTemperatureClear=gtSensorsNotifyPSUTemperatureClear, gtSensorsNotifyPSUFailureClear=gtSensorsNotifyPSUFailureClear, gtSensorsNotifyFanSpeed=gtSensorsNotifyFanSpeed, gtTemp=gtTemp, gtSensorsNotifyBOARDTemperatureClear=gtSensorsNotifyBOARDTemperatureClear, gtFanControl=gtFanControl, gtNumPSUs=gtNumPSUs, gtFanLifetime=gtFanLifetime, gtSensorsGroups=gtSensorsGroups, gtSensorsNotifyPSUCurrent=gtSensorsNotifyPSUCurrent, gtFan=gtFan, gtPSUTemperature=gtPSUTemperature, gtSensorsNotifyPSUFailure=gtSensorsNotifyPSUFailure, gtSensorsObjects=gtSensorsObjects, gtSensorsNotifications=gtSensorsNotifications, gtPSUName=gtPSUName, gtPSU=gtPSU, gtNumTemps=gtNumTemps, gtPSUVoltageExt=gtPSUVoltageExt, gtPSUVoltageInt=gtPSUVoltageInt, gtSensorsBasicNotificationsGroup=gtSensorsBasicNotificationsGroup, gtSensorsStatsGroup=gtSensorsStatsGroup, gtSensorsNotifyPSUPlugin=gtSensorsNotifyPSUPlugin, gtTempsEntry=gtTempsEntry, gtSensorsTrapGroup=gtSensorsTrapGroup, gtSensorsV1Group=gtSensorsV1Group, gtSensorsCompliances=gtSensorsCompliances, gtSensorsNotifyPSUTemperature=gtSensorsNotifyPSUTemperature, gtPSUsEntry=gtPSUsEntry, gtPSUPower=gtPSUPower, gtSensorsSetGroup=gtSensorsSetGroup, gtFanUptime=gtFanUptime, gtPSUVoltageOR=gtPSUVoltageOR, gtFanSpeed=gtFanSpeed, gtNumFans=gtNumFans, gtTempValue=gtTempValue, gtSensorsSystemGroup=gtSensorsSystemGroup, gtTempsTable=gtTempsTable, gtTempName=gtTempName, gtFansTable=gtFansTable, gtPSUsTable=gtPSUsTable, PYSNMP_MODULE_ID=gtSensorsMIB, gtFanName=gtFanName, gtPSUCurrent=gtPSUCurrent, gtSensorsNotifyFanPlugout=gtSensorsNotifyFanPlugout, gtSensorsNotifyPSUPlugout=gtSensorsNotifyPSUPlugout, gtSensorsConformance=gtSensorsConformance)
