...
mibBuilder.exportSymbols("SAMSUNG-PRINTER-EXT-TC", ScmPrtOutputOffsetStackingType=ScmPrtOutputOffsetStackingType, ScmPrtPrintScreen=ScmPrtPrintScreen, ScmPrtMediumClassType=ScmPrtMediumClassType, ScmPrtPageSizeErrorPolicy=ScmPrtPageSizeErrorPolicy, sCmPrtTCPCLFontSource=sCmPrtTCPCLFontSource, sCmPrtTCIETFPrintMIBGroupSupport=sCmPrtTCIETFPrintMIBGroupSupport, scmPrintTC=scmPrintTC, ScmPrtChannelType=ScmPrtChannelType, ScmPrtOutputStaplePosition=ScmPrtOutputStaplePosition, ScmPrtIETFPrintMIBGroupSupport=ScmPrtIETFPrintMIBGroupSupport, sCmPrtTCInterpreterLangFamily=sCmPrtTCInterpreterLangFamily, ScmPrtAuxSheetContent=ScmPrtAuxSheetContent, sCmPrtTCMediumClassType=sCmPrtTCMediumClassType, sCmPrtTCPrintScreen=sCmPrtTCPrintScreen, sCmPrtTCMediumSize=sCmPrtTCMediumSize, ScmPrtPCLFontSource=ScmPrtPCLFontSource, PYSNMP_MODULE_ID=scmPrintTC, sCmPrintTCDummy=sCmPrintTCDummy, ScmPrtMediaTypeErrorPolicy=ScmPrtMediaTypeErrorPolicy, sCmPrtTCPageSizeErrorPolicy=sCmPrtTCPageSizeErrorPolicy, ScmPrtPlex=ScmPrtPlex, sCmPrtTCPlex=sCmPrtTCPlex, ScmPrtTraySwitch=ScmPrtTraySwitch, ScmPrtGroupSupport=ScmPrtGroupSupport, sCmPrtTCGeneralMonoPrintOpt=sCmPrtTCGeneralMonoPrintOpt, sCmPrtTCGroupSupport=sCmPrtTCGroupSupport, sCmPrtTCPrintQuality=sCmPrtTCPrintQuality, sCmPrtTCOutputOffsetStackingType=sCmPrtTCOutputOffsetStackingType, ScmPrtMediumSize=ScmPrtMediumSize, sCmPrtOutputStaplePosition=sCmPrtOutputStaplePosition, sCmPrtTCTCChannelType=sCmPrtTCTCChannelType, ScmPrtAuxSheetType=ScmPrtAuxSheetType, sCmPrtTCAuxSheetContent=sCmPrtTCAuxSheetContent, ScmPrtPrintQuality=ScmPrtPrintQuality, ScmPrtInterpreterLangFamily=ScmPrtInterpreterLangFamily, sCmPrtTCScmPrtAuxSheetType=sCmPrtTCScmPrtAuxSheetType, ScmPrtGeneralMonoPrintOpt=ScmPrtGeneralMonoPrintOpt, sCmPrtTCTraySwitch=sCmPrtTCTraySwitch, sCmPrtTCMediaTypeErrorPolicy=sCmPrtTCMediaTypeErrorPolicy)
