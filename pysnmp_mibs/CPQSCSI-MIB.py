...
mibBuilder.exportSymbols("CPQSCSI-MIB", cpqScsiLogDrvStatusChange=cpqScsiLogDrvStatusChange, cpqTapePhyDrvMagSize=cpqTapePhyDrvMagSize, cpqScsiCntlrCondition=cpqScsiCntlrCondition, cpqSasPhyDrvSSDEstTimeRemainingHours=cpqSasPhyDrvSSDEstTimeRemainingHours, cpqScsiOsNetWare=cpqScsiOsNetWare, cpqScsiNw3xHbaDesc=cpqScsiNw3xHbaDesc, cpqTape4PhyDrvStatusChange=cpqTape4PhyDrvStatusChange, cpqScsiNw3xFatalReads=cpqScsiNw3xFatalReads, cpqSasPhyDrvSSDWearStatusChange=cpqSasPhyDrvSSDWearStatusChange, cpqScsi=cpqScsi, cpqSasPhyDrvMemberLogDrv=cpqSasPhyDrvMemberLogDrv, cpqTapePhyDrv=cpqTapePhyDrv, cpqCdLibraryBusIndex=cpqCdLibraryBusIndex, cpqTapeCountersScsiIdIndex=cpqTapeCountersScsiIdIndex, cpqScsiCntlrModelExtended=cpqScsiCntlrModelExtended, cpqSbDevBusIndex=cpqSbDevBusIndex, cpqScsiPhyDrvRecvWriteErrs=cpqScsiPhyDrvRecvWriteErrs, cpqScsiPhyDrvTimeouts=cpqScsiPhyDrvTimeouts, cpqScsiPhyDrvStatusChange=cpqScsiPhyDrvStatusChange, cpqScsiPhyDrvRecvReadErrs=cpqScsiPhyDrvRecvReadErrs, cpqScsiTargetParityErrs=cpqScsiTargetParityErrs, cpqScsiPhyDrvStatsPreserved=cpqScsiPhyDrvStatsPreserved, cpqSasPhyDrvSsBoxSerialNumber=cpqSasPhyDrvSsBoxSerialNumber, cpqScsiPhyDrvUsedReallocs=cpqScsiPhyDrvUsedReallocs, cpqTapeLibraryState=cpqTapeLibraryState, cpqTapeLibraryEntry=cpqTapeLibraryEntry, cpqScsiCntlrModel=cpqScsiCntlrModel, cpqScsiTargetType=cpqScsiTargetType, cpqScsiCd=cpqScsiCd, cpqTapeCountersTotalErrors=cpqTapeCountersTotalErrors, cpqScsiPhyDrvFuncTest1=cpqScsiPhyDrvFuncTest1, cpqTapeLibraryTemperature=cpqTapeLibraryTemperature, cpqScsiVolMapEntry=cpqScsiVolMapEntry, cpqScsiLogDrv=cpqScsiLogDrv, cpqScsiPhyDrvOsName=cpqScsiPhyDrvOsName, cpqSbDevFWRev=cpqSbDevFWRev, cpqSasPhyDrvTemperatureThreshold=cpqSasPhyDrvTemperatureThreshold, cpqCdLibrarySerialNumber=cpqCdLibrarySerialNumber, cpqSasTapeDrv=cpqSasTapeDrv, cpqSbDevice=cpqSbDevice, cpqSasPhyDrvCondition=cpqSasPhyDrvCondition, cpqSasTapeDrvName=cpqSasTapeDrvName, cpqCdLibraryVendor=cpqCdLibraryVendor, cpqSasHbaCondition=cpqSasHbaCondition, cpqScsiLogDrvStatus=cpqScsiLogDrvStatus, cpqScsiCntlrHwLocation=cpqScsiCntlrHwLocation, cpqScsiCdDrvScsiIdIndex=cpqScsiCdDrvScsiIdIndex, cpqTapePhyDrvCleanTapeCount=cpqTapePhyDrvCleanTapeCount, cpqScsiPhyDrvVendor=cpqScsiPhyDrvVendor, cpqScsiNw3xCorrWrites=cpqScsiNw3xCorrWrites, cpqSasLogDrvRaidLevel=cpqSasLogDrvRaidLevel, cpqSbDeviceTable=cpqSbDeviceTable, cpqScsiOsCommonModuleName=cpqScsiOsCommonModuleName, cpqScsiCdDrvTable=cpqScsiCdDrvTable, cpqScsiCdDrvFwRev=cpqScsiCdDrvFwRev, cpqScsiTrapType=cpqScsiTrapType, cpqScsiTargetTable=cpqScsiTargetTable, cpqCdLibraryEntry=cpqCdLibraryEntry, cpqSbDevModel=cpqSbDevModel, cpqScsiCdDrvCntlrIndex=cpqScsiCdDrvCntlrIndex, cpqTapeLibraryScsiIdIndex=cpqTapeLibraryScsiIdIndex, cpqScsiTargetNegSpeed=cpqScsiTargetNegSpeed, cpqSbScsiBus=cpqSbScsiBus, cpqSasPhyDrvType=cpqSasPhyDrvType, cpqScsiNw3xFatalWrites=cpqScsiNw3xFatalWrites, cpqScsi2CntlrStatusChange=cpqScsi2CntlrStatusChange, cpqSasLogDrvCondition=cpqSasLogDrvCondition, cpqScsiLogDrvBusIndex=cpqScsiLogDrvBusIndex, cpqSbDevMsgRejects=cpqSbDevMsgRejects, cpqScsiLogDrvStatEntry=cpqScsiLogDrvStatEntry, cpqTapeLibrarySerialNumber=cpqTapeLibrarySerialNumber, cpqScsiCntlr=cpqScsiCntlr, cpqScsiTargetFWRev=cpqScsiTargetFWRev, cpqScsiLogDrvStatTable=cpqScsiLogDrvStatTable, cpqSasPhyDrv=cpqSasPhyDrv, cpqSasTapeDrvSasAddress=cpqSasTapeDrvSasAddress, cpqSasLogDrvRebuildingPercent=cpqSasLogDrvRebuildingPercent, cpqTapeCountersTotalBytes=cpqTapeCountersTotalBytes, cpqTapePhyDrvTable=cpqTapePhyDrvTable, cpqCdLibraryFwSubtype=cpqCdLibraryFwSubtype, cpqTapePhyDrvLoaderFwRev=cpqTapePhyDrvLoaderFwRev, cpqTape3PhyDrvCleaningRequired=cpqTape3PhyDrvCleaningRequired, cpqScsiTargetScsiIdIndex=cpqScsiTargetScsiIdIndex, cpqScsi3LogDrvStatusChange=cpqScsi3LogDrvStatusChange, cpqScsiTargetSelectTimeouts=cpqScsiTargetSelectTimeouts, cpqScsiTargetBusIndex=cpqScsiTargetBusIndex, cpqScsiNw3xStatCntlrIndex=cpqScsiNw3xStatCntlrIndex, cpqTapePhyDrvCleanReq=cpqTapePhyDrvCleanReq, cpqScsiPhyDrvEntry=cpqScsiPhyDrvEntry, cpqScsiNw3xCorrReads=cpqScsiNw3xCorrReads, cpqTapeCountersEntry=cpqTapeCountersEntry, cpqScsiCntlrTable=cpqScsiCntlrTable, cpqSbDevType=cpqSbDevType, cpqTape3LibraryOkay=cpqTape3LibraryOkay, cpqTapePhyDrvBusIndex=cpqTapePhyDrvBusIndex, cpqSbDevSelectTimeouts=cpqSbDevSelectTimeouts, cpqScsiPhyDrvSize=cpqScsiPhyDrvSize, cpqTapeLibraryStatus=cpqTapeLibraryStatus, cpqScsiMibRev=cpqScsiMibRev, cpqTapePhyDrvScsiIdIndex=cpqTapePhyDrvScsiIdIndex, cpqScsiCntlrStatusChange=cpqScsiCntlrStatusChange, cpqScsiMibRevMinor=cpqScsiMibRevMinor, cpqScsiNw3xCntlrInfoTable=cpqScsiNw3xCntlrInfoTable, cpqTapePhyDrvStatus=cpqTapePhyDrvStatus, cpqSasTapeDrvLocationString=cpqSasTapeDrvLocationString, cpqSasHbaPciLocation=cpqSasHbaPciLocation, cpqSasPhyDrvSSDPercntEndrnceUsed=cpqSasPhyDrvSSDPercntEndrnceUsed, cpqTape3PhyDrvStatusChange=cpqTape3PhyDrvStatusChange, cpqSasHbaTable=cpqSasHbaTable, cpqSasTapeDrvFWRev=cpqSasTapeDrvFWRev, cpqTapeLibraryTapeList=cpqTapeLibraryTapeList, cpqScsiPhyDrvTable=cpqScsiPhyDrvTable, cpqTapeLibraryFwRev=cpqTapeLibraryFwRev, cpqTapePhyDrvCleanTapeRepl=cpqTapePhyDrvCleanTapeRepl, cpqScsiTrapPkts=cpqScsiTrapPkts, cpqScsiTrapLogMaxSize=cpqScsiTrapLogMaxSize, cpqSasPhyDrvSSDWearStatus=cpqSasPhyDrvSSDWearStatus, cpqTapeLibraryStatMoves=cpqTapeLibraryStatMoves, cpqScsiCntlrStatus=cpqScsiCntlrStatus, cpqTape3PhyDrvCleanTapeReplace=cpqTape3PhyDrvCleanTapeReplace, cpqSbDevNegPeriod=cpqSbDevNegPeriod, cpqSasLogDrvStatusChange=cpqSasLogDrvStatusChange, cpqTape3LibraryDoorOpen=cpqTape3LibraryDoorOpen, cpqSbDevLocation=cpqSbDevLocation, cpqTapePhyDrvCntlrIndex=cpqTapePhyDrvCntlrIndex, cpqSasPhyDrvSize=cpqSasPhyDrvSize, cpqSasHbaIndex=cpqSasHbaIndex, cpqSasPhyDrvPlacement=cpqSasPhyDrvPlacement, cpqSasLogDrvStatus=cpqSasLogDrvStatus, cpqScsi2PhyDrvStatusChange=cpqScsi2PhyDrvStatusChange, cpqScsiOsCommonModuleDate=cpqScsiOsCommonModuleDate, cpqScsiTargetNegWidth=cpqScsiTargetNegWidth, cpqScsiPhyDrvParent=cpqScsiPhyDrvParent, cpqSasLogDrvStripeSize=cpqSasLogDrvStripeSize, cpqSasHba=cpqSasHba, cpqScsiPhyDrvStatus=cpqScsiPhyDrvStatus, cpqTapePhyDrvEntry=cpqTapePhyDrvEntry, cpqSasPhyDrvSerialNumber=cpqSasPhyDrvSerialNumber, cpqScsiPhyDrvScsiID=cpqScsiPhyDrvScsiID, cpqScsiNw3xCntlrInfoEntry=cpqScsiNw3xCntlrInfoEntry, cpqTapeLibraryTable=cpqTapeLibraryTable, cpqTapeCountersBusIndex=cpqTapeCountersBusIndex, cpqCdLibraryScsiIdIndex=cpqCdLibraryScsiIdIndex, cpqScsiPhyDrvLocation=cpqScsiPhyDrvLocation, cpqSasPhyDrvEntry=cpqSasPhyDrvEntry, cpqScsiLogDrvCntlrIndex=cpqScsiLogDrvCntlrIndex, cpqScsiPhyDrvIndex=cpqScsiPhyDrvIndex, cpqSasPhyDrvSasAddress=cpqSasPhyDrvSasAddress, cpqCdLibraryDriveList=cpqCdLibraryDriveList, cpqSasPhyDrvSsBoxVendor=cpqSasPhyDrvSsBoxVendor, cpqTapeLibraryCondition=cpqTapeLibraryCondition, cpqScsiTargetPhysWidth=cpqScsiTargetPhysWidth, cpqScsiOsCommonModulePurpose=cpqScsiOsCommonModulePurpose, cpqScsiLogDrvAvailSpares=cpqScsiLogDrvAvailSpares, cpqSasHbaHwLocation=cpqSasHbaHwLocation, cpqScsiLogDrvIndex=cpqScsiLogDrvIndex, cpqScsiLogDrvOsName=cpqScsiLogDrvOsName, cpqTapeLibraryBusIndex=cpqTapeLibraryBusIndex, cpqCdLibraryModel=cpqCdLibraryModel, cpqSasPhyDrvOsName=cpqSasPhyDrvOsName, cpqScsiPhyDrvPreFailMonitoring=cpqScsiPhyDrvPreFailMonitoring, cpqScsiOsCommonPollFreq=cpqScsiOsCommonPollFreq, cpqSbMibRevMajor=cpqSbMibRevMajor, cpqSbDevVendor=cpqSbDevVendor, cpqScsiTargetModel=cpqScsiTargetModel, cpqSasLogDrvCapacity=cpqSasLogDrvCapacity, cpqSasTapeDrvSerialNumber=cpqSasTapeDrvSerialNumber, cpqTapePhyDrvSerialNumber=cpqTapePhyDrvSerialNumber, cpqSasLogDrv=cpqSasLogDrv, cpqScsiTrapLogEntry=cpqScsiTrapLogEntry, cpqScsiTargetEntry=cpqScsiTargetEntry, cpqScsiCntlrEntry=cpqScsiCntlrEntry, cpqSasPhyDrvSmartCarrierAppFWRev=cpqSasPhyDrvSmartCarrierAppFWRev, cpqTapeCountersTable=cpqTapeCountersTable, cpqScsiCdDrvVendor=cpqScsiCdDrvVendor, cpqTapeCountersCntlrIndex=cpqTapeCountersCntlrIndex, cpqTapeLibraryDoorStatus=cpqTapeLibraryDoorStatus, cpqScsiComponent=cpqScsiComponent, cpqTapeCountersReReads=cpqTapeCountersReReads, cpqSasPhyDrvAuthenticationStatus=cpqSasPhyDrvAuthenticationStatus, cpqScsiLogDrvTable=cpqScsiLogDrvTable, cpqSasTapeDrvIndex=cpqSasTapeDrvIndex, cpqCdLibraryCntlrIndex=cpqCdLibraryCntlrIndex, cpqTapePhyDrvStatusChange=cpqTapePhyDrvStatusChange, cpqSbDevScsiIdIndex=cpqSbDevScsiIdIndex, cpqTapePhyDrvName=cpqTapePhyDrvName, cpqScsiTargetPhaseErrs=cpqScsiTargetPhaseErrs, cpqTapePhyDrvLoaderSerialNum=cpqTapePhyDrvLoaderSerialNum, cpqScsiPhyDrvFWRev=cpqScsiPhyDrvFWRev, cpqTapeLibraryCntlrIndex=cpqTapeLibraryCntlrIndex, cpqSasLogDrvOsName=cpqSasLogDrvOsName, cpqScsiPhyDrvPlacement=cpqScsiPhyDrvPlacement, cpqScsiTarget=cpqScsiTarget, cpqScsiNw3xTotalReads=cpqScsiNw3xTotalReads, cpqSasPhyDrvUsedReallocs=cpqSasPhyDrvUsedReallocs, cpqScsiInterface=cpqScsiInterface, cpqScsi3CntlrStatusChange=cpqScsi3CntlrStatusChange, cpqSasPhyDrvIndex=cpqSasPhyDrvIndex, cpqTapePhyDrvLunIndex=cpqTapePhyDrvLunIndex, cpqSbDevPhaseErrs=cpqSbDevPhaseErrs, cpqScsiMibRevMajor=cpqScsiMibRevMajor, cpqScsiTargetCurrentSpeed=cpqScsiTargetCurrentSpeed, cpqTapeLibraryLunIndex=cpqTapeLibraryLunIndex, cpqSasTapeDrvCondition=cpqSasTapeDrvCondition, cpqTapePhyDrvPlacement=cpqTapePhyDrvPlacement, cpqSasHbaBiosVersion=cpqSasHbaBiosVersion, cpqScsiNw3xCntlrIndex=cpqScsiNw3xCntlrIndex, cpqScsiTrapLogTable=cpqScsiTrapLogTable, cpqScsiPhyDrvRotationalSpeed=cpqScsiPhyDrvRotationalSpeed, cpqSasHbaEntry=cpqSasHbaEntry, cpqSasHbaModel=cpqSasHbaModel, cpqScsiOsCommonModuleTable=cpqScsiOsCommonModuleTable, cpqSasPhyDrvLocationString=cpqSasPhyDrvLocationString, cpqScsiPhyDrvFuncTest2=cpqScsiPhyDrvFuncTest2, cpqScsiCdLibraryStatusChange=cpqScsiCdLibraryStatusChange, cpqScsiCntlrSoftResets=cpqScsiCntlrSoftResets, cpqTape3LibraryDoorClosed=cpqTape3LibraryDoorClosed, cpqScsiPhyDrvSectorSize=cpqScsiPhyDrvSectorSize, cpqScsiNw3xDriverPollTime=cpqScsiNw3xDriverPollTime, cpqSasPhyDrvMediaType=cpqSasPhyDrvMediaType, cpqSasTapeDrvHbaIndex=cpqSasTapeDrvHbaIndex, cpqScsiCntlrSlot=cpqScsiCntlrSlot, cpqScsiCdDrvLunIndex=cpqScsiCdDrvLunIndex, cpqScsiNw3xVolBusIndex=cpqScsiNw3xVolBusIndex, cpqScsiNw3xSimVers=cpqScsiNw3xSimVers, cpqScsiPhyDrvSpinupTime=cpqScsiPhyDrvSpinupTime, cpqScsiNw3xTotalWrites=cpqScsiNw3xTotalWrites, cpqSasLogDrvHbaIndex=cpqSasLogDrvHbaIndex, cpqScsiPhyDrvCondition=cpqScsiPhyDrvCondition, cpqSasTapeDrvTable=cpqSasTapeDrvTable, cpqScsi3PhyDrvStatusChange=cpqScsi3PhyDrvStatusChange, cpqScsiCntlrBusIndex=cpqScsiCntlrBusIndex, cpqScsiPhyDrvHardReadErrs=cpqScsiPhyDrvHardReadErrs, cpqSasHbaFwVersion=cpqSasHbaFwVersion, cpqSbDevCntlrIndex=cpqSbDevCntlrIndex, cpqScsiPhyDrvHardWriteErrs=cpqScsiPhyDrvHardWriteErrs, cpqTapePhyDrvLibraryDrive=cpqTapePhyDrvLibraryDrive, cpqScsiNw3xBusIndex=cpqScsiNw3xBusIndex, cpqSasTapeDrvStatus=cpqSasTapeDrvStatus, cpqScsiCntlrHardResets=cpqScsiCntlrHardResets, cpqSasPhyDrvStatus=cpqSasPhyDrvStatus, cpqTapeLibraryStatHours=cpqTapeLibraryStatHours, cpqScsiPhyDrvSeekErrs=cpqScsiPhyDrvSeekErrs, cpqSasLogDrvPhyDrvIds=cpqSasLogDrvPhyDrvIds, cpqSasLogDrvTable=cpqSasLogDrvTable, cpqScsiVolMapTable=cpqScsiVolMapTable, cpqSasPhyDrvStatusChange=cpqSasPhyDrvStatusChange, cpqScsiLogDrvEntry=cpqScsiLogDrvEntry, cpqScsiLogDrvCondition=cpqScsiLogDrvCondition, cpqTapeCountersLunIndex=cpqTapeCountersLunIndex, cpqScsiCntlrSWVers=cpqScsiCntlrSWVers, cpqSbDevParityErrs=cpqSbDevParityErrs, cpqSasComponent=cpqSasComponent, cpqCdLibraryTable=cpqCdLibraryTable)
mibBuilder.exportSymbols("CPQSCSI-MIB", cpqScsiCntlrIndex=cpqScsiCntlrIndex, cpqScsiOsCommonModuleVersion=cpqScsiOsCommonModuleVersion, cpqCdLibraryStatus=cpqCdLibraryStatus, cpqScsiTrapTime=cpqScsiTrapTime, cpqScsiPhyDrvEccCorrReads=cpqScsiPhyDrvEccCorrReads, cpqScsiLogDrvSize=cpqScsiLogDrvSize, cpqSasLogDrvRebuildingDisk=cpqSasLogDrvRebuildingDisk, cpqScsiPhyDrvLowReadSectors=cpqScsiPhyDrvLowReadSectors, cpqSasHbaStatus=cpqSasHbaStatus, cpqScsiOsCommon=cpqScsiOsCommon, cpqScsiCntlrSerialNum=cpqScsiCntlrSerialNum, cpqScsiNw3xVolMap=cpqScsiNw3xVolMap, cpqScsiPhyDrvMemberLogDrv=cpqScsiPhyDrvMemberLogDrv, cpqSasLogDrvEntry=cpqSasLogDrvEntry, cpqSasPhyDrvCurrTemperature=cpqSasPhyDrvCurrTemperature, cpqScsiPhyDrvCntlrIndex=cpqScsiPhyDrvCntlrIndex, cpqSasHbaOverallCondition=cpqSasHbaOverallCondition, cpqTapeLibraryStatusChange=cpqTapeLibraryStatusChange, cpqSas2TapeDrvStatusChange=cpqSas2TapeDrvStatusChange, cpqScsiNw3xDriverVers=cpqScsiNw3xDriverVers, cpqScsiPhyDrv=cpqScsiPhyDrv, cpqScsiTargetNegPeriod=cpqScsiTargetNegPeriod, cpqScsiCntlrTimeouts=cpqScsiCntlrTimeouts, cpqTapeLibraryHotSwap=cpqTapeLibraryHotSwap, cpqTapePhyDrvFwRev=cpqTapePhyDrvFwRev, cpqScsiCntlrPciLocation=cpqScsiCntlrPciLocation, cpqScsiTrapLogIndex=cpqScsiTrapLogIndex, cpqSasPhyDrvSmartCarrierBootldrFWRev=cpqSasPhyDrvSmartCarrierBootldrFWRev, cpqScsiTargetCntlrIndex=cpqScsiTargetCntlrIndex, cpqScsiPhyDrvSerialNum=cpqScsiPhyDrvSerialNum, cpqTapePhyDrvCondition=cpqTapePhyDrvCondition, cpqSasPhyDrvHbaIndex=cpqSasPhyDrvHbaIndex, cpqScsi5PhyDrvStatusChange=cpqScsi5PhyDrvStatusChange, cpqScsiNw3xVolLogDrvIndex=cpqScsiNw3xVolLogDrvIndex, cpqScsiNw3xStatBusIndex=cpqScsiNw3xStatBusIndex, cpqCdLibraryCondition=cpqCdLibraryCondition, cpqScsiTargetTypeExtended=cpqScsiTargetTypeExtended, cpqTape5PhyDrvStatusChange=cpqTape5PhyDrvStatusChange, cpqScsiTargetMsgRejects=cpqScsiTargetMsgRejects, cpqScsiNw3xDriverName=cpqScsiNw3xDriverName, cpqScsiPhyDrvBusIndex=cpqScsiPhyDrvBusIndex, cpqScsiLogDrvPhyDrvIDs=cpqScsiLogDrvPhyDrvIDs, cpqTapeLibraryDriveList=cpqTapeLibraryDriveList, cpqTapePhyDrvFwSubtype=cpqTapePhyDrvFwSubtype, cpqScsiTrap=cpqScsiTrap, cpqScsiMibCondition=cpqScsiMibCondition, cpqScsiPhyDrvServiceHours=cpqScsiPhyDrvServiceHours, cpqScsiPhyDrvPostErrCode=cpqScsiPhyDrvPostErrCode, cpqScsiCdDrvEntry=cpqScsiCdDrvEntry, cpqTapePhyDrvType=cpqTapePhyDrvType, cpqTapeLibraryName=cpqTapeLibraryName, cpqScsiLogDrvStripeSize=cpqScsiLogDrvStripeSize, cpqSasPhyDrvPowerOnHours=cpqSasPhyDrvPowerOnHours, cpqScsiCntlrBaseIOAddr=cpqScsiCntlrBaseIOAddr, cpqSasPhyDrvHotPlug=cpqSasPhyDrvHotPlug, cpqSbDeviceEntry=cpqSbDeviceEntry, cpqScsi2LogDrvStatusChange=cpqScsi2LogDrvStatusChange, cpqScsiPhyDrvHotPlug=cpqScsiPhyDrvHotPlug, cpqSasPhyDrvTable=cpqSasPhyDrvTable, cpqSasPhyDrvModel=cpqSasPhyDrvModel, cpqSbScsiMibRev=cpqSbScsiMibRev, cpqTape3LibraryDegraded=cpqTape3LibraryDegraded, cpqSasLogDrvIndex=cpqSasLogDrvIndex, cpqTapeCountersReWrites=cpqTapeCountersReWrites, cpqScsiNw3xXptVers=cpqScsiNw3xXptVers, cpqSasPhyDrvFWRev=cpqSasPhyDrvFWRev, cpqScsiOsCommonModuleEntry=cpqScsiOsCommonModuleEntry, cpqScsiCdDrvModel=cpqScsiCdDrvModel, cpqScsiNw3xVolCntlrIndex=cpqScsiNw3xVolCntlrIndex, cpqCdLibraryFwRev=cpqCdLibraryFwRev, cpqSasPhyDrvSsBoxFwRev=cpqSasPhyDrvSsBoxFwRev, cpqScsiNw3xStatLogDrvIndex=cpqScsiNw3xStatLogDrvIndex, cpqScsiTargetVendor=cpqScsiTargetVendor, cpqScsiNw3xXptDesc=cpqScsiNw3xXptDesc, cpqTapeLibrary=cpqTapeLibrary, cpqTapePhyDrvHotPlug=cpqTapePhyDrvHotPlug, cpqTapePhyDrvLoaderName=cpqTapePhyDrvLoaderName, cpqScsiCntlrBusWidth=cpqScsiCntlrBusWidth, cpqScsiPhyDrvHighReadSectors=cpqScsiPhyDrvHighReadSectors, cpqTapeCountersTotalUncorrectable=cpqTapeCountersTotalUncorrectable, cpqScsiOsCommonModuleIndex=cpqScsiOsCommonModuleIndex, cpqScsi4PhyDrvStatusChange=cpqScsi4PhyDrvStatusChange, cpqSasPhyDrvRotationalSpeed=cpqSasPhyDrvRotationalSpeed, cpqCdLibraryLunIndex=cpqCdLibraryLunIndex, cpqTapeComponent=cpqTapeComponent, cpqScsiPhyDrvModel=cpqScsiPhyDrvModel, cpqScsiNw3xSimDesc=cpqScsiNw3xSimDesc, cpqScsiCdDrvBusIndex=cpqScsiCdDrvBusIndex, cpqSasPhyDrvSsBoxModel=cpqSasPhyDrvSsBoxModel, cpqScsiPhyDrvPostErrs=cpqScsiPhyDrvPostErrs, cpqScsiNw3xDriverPollType=cpqScsiNw3xDriverPollType, cpqSasTapeDrvEntry=cpqSasTapeDrvEntry, cpqTape3LibraryFailed=cpqTape3LibraryFailed, cpqScsiLogDrvPercentRebuild=cpqScsiLogDrvPercentRebuild, cpqScsiLogDrvFaultTol=cpqScsiLogDrvFaultTol, cpqSasHbaSerialNumber=cpqSasHbaSerialNumber, cpqTapeCounters=cpqTapeCounters, cpqSasLogDrvSpareIds=cpqSasLogDrvSpareIds, cpqScsiTargetLocation=cpqScsiTargetLocation, cpqScsiCntlrFWVers=cpqScsiCntlrFWVers, cpqScsiPhyDrvHighWriteSectors=cpqScsiPhyDrvHighWriteSectors, cpqSbMibRevMinor=cpqSbMibRevMinor, cpqTapeLibraryRedundancy=cpqTapeLibraryRedundancy, cpqScsiPhyDrvLowWriteSectors=cpqScsiPhyDrvLowWriteSectors)
