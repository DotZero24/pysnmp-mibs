...
# Notes
# -----
# ASN.1 source file://mibs/dell/DELL-ASF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:46 2025
...
asfTrapOverCurrentWarning = NotificationType(
    (1, 3, 6, 1, 4, 1, 3183, 1, 1, 0, 196871)
)
if mibBuilder.loadTexts:
    asfTrapOverCurrentWarning.setStatus(
        ""
    )

asfTrapUnderCurrentCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 3183, 1, 1, 0, 196999)
)
if mibBuilder.loadTexts:
    asfTrapUnderCurrentCleared.setStatus(
        ""
    )
...
asfTrapSMBIOSUncorrectableCPU = NotificationType(
    (1, 3, 6, 1, 4, 1, 3183, 1, 1, 0, 460550)
)
if mibBuilder.loadTexts:
    asfTrapSMBIOSUncorrectableCPU.setStatus(
        ""
    )
...
asfTrapCpuCorrectableError = NotificationType(
    (1, 3, 6, 1, 4, 1, 3183, 1, 1, 0, 487180)
)
if mibBuilder.loadTexts:
    asfTrapCpuCorrectableError.setStatus(
        ""
    )
...
asfTrapPSNonRedundantSufficientResources = NotificationType(
    (1, 3, 6, 1, 4, 1, 3183, 1, 1, 0, 527107)
)
if mibBuilder.loadTexts:
    asfTrapPSNonRedundantSufficientResources.setStatus(
        ""
    )
...
asfTrapOverUsageSensorWarning = NotificationType(
    (1, 3, 6, 1, 4, 1, 3183, 1, 1, 0, 721159)
)
if mibBuilder.loadTexts:
    asfTrapOverUsageSensorWarning.setStatus(
        ""
    )

asfTrapSensorUnresponsive = NotificationType(
    (1, 3, 6, 1, 4, 1, 3183, 1, 1, 0, 721664)
)
if mibBuilder.loadTexts:
    asfTrapSensorUnresponsive.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"wiredformgmt": wiredformgmt,
       ...
       "asfTrapOverCurrentWarning": asfTrapOverCurrentWarning,
       "asfTrapUnderCurrentCleared": asfTrapUnderCurrentCleared,
       ...
       "asfTrapSMBIOSUncorrectableCPU": asfTrapSMBIOSUncorrectableCPU,
       ...
       "asfTrapCpuCorrectableError": asfTrapCpuCorrectableError,
       ...
       "asfTrapPSNonRedundantSufficientResources": asfTrapPSNonRedundantSufficientResources,
       ...
       "asfTrapOverUsageSensorWarning": asfTrapOverUsageSensorWarning,
       "asfTrapSensorUnresponsive": asfTrapSensorUnresponsive,
