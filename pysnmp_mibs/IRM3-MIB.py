...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cabletron/IRM3-MIB
...
subSysMMAC, repeaterRev1, repeaterRev2 = mibBuilder.importSymbols("IRM-OIDS", "subSysMMAC", "repeaterRev1", "repeaterRev2")
...
mibBuilder.exportSymbols("IRM3-MIB", deviceRestoreDefaults=deviceRestoreDefaults, port512To1023Frames=port512To1023Frames, deviceActiveUsers=deviceActiveUsers, devCollsEnable=devCollsEnable, devErrorSource=devErrorSource, commonRP=commonRP, devErrorEnable=devErrorEnable, deviceTotalPkts=deviceTotalPkts, deviceBanyanFrames=deviceBanyanFrames, boardR2=boardR2, devError=devError, deviceTRBoardMap=deviceTRBoardMap, portAlignErrs=portAlignErrs, portTrafficEnable=portTrafficEnable, bdBroadEnable=bdBroadEnable, board64To127Frames=board64To127Frames, devErrorThreshold=devErrorThreshold, portOper=portOper, deviceCRCErrs=deviceCRCErrs, portRedundStatus=portRedundStatus, devicePortsOn=devicePortsOn, bdErrorThreshold=bdErrorThreshold, redundancyCircuitTypes=redundancyCircuitTypes, deviceRestart=deviceRestart, deviceResetRedundancy=deviceResetRedundancy, portOtherFrames=portOtherFrames, redundancyCircuitName=redundancyCircuitName, devTrafficThreshold=devTrafficThreshold, boardGiants=boardGiants, boardSrcAddrLocked=boardSrcAddrLocked, boardOper=boardOper, portColls=portColls, deviceTROccupiedSlots=deviceTROccupiedSlots, ethernetB=ethernetB, boardMultPkts=boardMultPkts, boardSpeedFaultPort=boardSpeedFaultPort, devAlrm=devAlrm, deviceIPFrames=deviceIPFrames, deviceOtherFrames=deviceOtherFrames, portOSIFrames=portOSIFrames, deviceOOWColls=deviceOOWColls, redundancyTestTod=redundancyTestTod, ethernetP=ethernetP, boardNoResources=boardNoResources, deviceCtronFrames=deviceCtronFrames, portSrcAddrLocked=portSrcAddrLocked, devTraffic=devTraffic, fDDIB=fDDIB, deviceSrcAddrType=deviceSrcAddrType, boardModeStatus=boardModeStatus, boardBanyanFrames=boardBanyanFrames, deviceTotalPorts=deviceTotalPorts, device1024To1518Frames=device1024To1518Frames, portName=portName, deviceOccupiedSlots=deviceOccupiedSlots, portTopologyType=portTopologyType, boardNovellFrames=boardNovellFrames, bdBroadDisable=bdBroadDisable, ringPort2=ringPort2, devBroad=devBroad, devTrafficEnable=devTrafficEnable, portTrafficThreshold=portTrafficThreshold, deviceNoResources=deviceNoResources, boardOtherFrames=boardOtherFrames, boardOOWColls=boardOOWColls, portRunts=portRunts, portGiants=portGiants, boardFirstRingPort=boardFirstRingPort, stationPortLinkStatus=stationPortLinkStatus, deviceSrcAddrAgingTime=deviceSrcAddrAgingTime, bdCollsThreshold=bdCollsThreshold, portSourceAddr=portSourceAddr, redundancyCircuitMACAddrDisp=redundancyCircuitMACAddrDisp, boardIPFrames=boardIPFrames, portBroadPkts=portBroadPkts, deviceOSIFrames=deviceOSIFrames, sourceAddrBoard=sourceAddrBoard, port1024To1518Frames=port1024To1518Frames, ctIPDefaultFrameType=ctIPDefaultFrameType, deviceGiantFrames=deviceGiantFrames, portErrorPkts=portErrorPkts, tokenRingP=tokenRingP, boardActiveUsers=boardActiveUsers, deviceMMACType=deviceMMACType, redundancyCircuitPort=redundancyCircuitPort, boardErrorPkts=boardErrorPkts, deviceSrcAddrTraps=deviceSrcAddrTraps, portError=portError, deviceTRRingPorts=deviceTRRingPorts, board256To511Frames=board256To511Frames, deviceFDDIOccupiedSlots=deviceFDDIOccupiedSlots, boardBroadPkts=boardBroadPkts, portIndex=portIndex, deviceLinkTraps=deviceLinkTraps, portActiveUsers=portActiveUsers, alarm=alarm, deviceTimeBase=deviceTimeBase, bdError=bdError, bdErrorEnable=bdErrorEnable, deviceRecColls=deviceRecColls, portErrorThreshold=portErrorThreshold, portNoResorces=portNoResorces, portForceTrunkType=portForceTrunkType, commonB=commonB, deviceBroadPkts=deviceBroadPkts, portXmitColls=portXmitColls, board=board, portCollsEnable=portCollsEnable, boardBypassRingPortState=boardBypassRingPortState, autowrapRPFaultStateTime=autowrapRPFaultStateTime, portXNSFrames=portXNSFrames, portDECNetFrames=portDECNetFrames, deviceTRPortsOn=deviceTRPortsOn, bdBroad=bdBroad, deviceDiscover=deviceDiscover, portCtronFrames=portCtronFrames, bdCollsEnable=bdCollsEnable, deviceDECNetFrames=deviceDECNetFrames, boardAppletalkFrames=boardAppletalkFrames, portErrorPortDisable=portErrorPortDisable, boardTotalPorts=boardTotalPorts, portAdminState=portAdminState, autowrapRPFaultStatus=autowrapRPFaultStatus, boardAlignErrs=boardAlignErrs, portBroadEnable=portBroadEnable, portStatus=portStatus, ringPortLinkStateTime=ringPortLinkStateTime, redundancyPollInterval=redundancyPollInterval, boardName=boardName, portBroad=portBroad, portBroadDisable=portBroadDisable, deviceRecBytes=deviceRecBytes, portIPFrames=portIPFrames, tokenRingD=tokenRingD, portCRCErrs=portCRCErrs, boardPortsOn=boardPortsOn, portMultPkts=portMultPkts, boardTotalRingPortsOn=boardTotalRingPortsOn, boardRecColls=boardRecColls, portTrafficPortDisable=portTrafficPortDisable, fNB=fNB, deviceTRLans=deviceTRLans, devColls=devColls, deviceTRRingPortsOn=deviceTRRingPortsOn, fDDIP=fDDIP, bdErrorBdDisable=bdErrorBdDisable, deviceR2=deviceR2, boardRecBytes=boardRecBytes, redundancyCircuitNumAddr=redundancyCircuitNumAddr, portOOWColls=portOOWColls, deviceTransmitColls=deviceTransmitColls, bdTrafficBdDisable=bdTrafficBdDisable, device256To511Frames=device256To511Frames, portAlrm=portAlrm, boardBypassState=boardBypassState, redundancyPerformTest=redundancyPerformTest, networkR2=networkR2, deviceTotalErrors=deviceTotalErrors, device64To127Frames=device64To127Frames, deviceMultPkts=deviceMultPkts, redundancyCircuitMACAddrDel=redundancyCircuitMACAddrDel, bdTrafficEnable=bdTrafficEnable, bdErrorSource=bdErrorSource, tokenRingB=tokenRingB, ringSpeedFault=ringSpeedFault, boardXNSFrames=boardXNSFrames, portLinkStatus=portLinkStatus, board1024To1518Frames=board1024To1518Frames, redundancyNumBPs=redundancyNumBPs, bdTrafficThreshold=bdTrafficThreshold, deviceSrcAddrLocked=deviceSrcAddrLocked, boardTransColls=boardTransColls, bdCollsBdDisable=bdCollsBdDisable, port128To255Frames=port128To255Frames, deviceTRPorts=deviceTRPorts, portCollsThreshold=portCollsThreshold, ringPortLinkStatus=ringPortLinkStatus, redundancyRetryCount=redundancyRetryCount, deviceAlignErrs=deviceAlignErrs, boardType=boardType, boardSpeed=boardSpeed, boardTotalStationPorts=boardTotalStationPorts, bdAlrm=bdAlrm, boardStatus=boardStatus, portTraffic=portTraffic, device128To255Frames=device128To255Frames, commonRPcapabilities=commonRPcapabilities, redundancyCircuitEnable=redundancyCircuitEnable, boardTotalRingPorts=boardTotalRingPorts, commonP=commonP, autowrapRPSelectedType=autowrapRPSelectedType, ringP=ringP, devCollsThreshold=devCollsThreshold, stationPortLinkStateTime=stationPortLinkStateTime, boardTotalPkts=boardTotalPkts, bdTraffic=bdTraffic, bdColls=bdColls, board512To1023Frames=board512To1023Frames, port64To127Frames=port64To127Frames, portRedundCrt=portRedundCrt, portRedundType=portRedundType, redundancyCircuitMACAddrAdd=redundancyCircuitMACAddrAdd, port=port, deviceResetCounters=deviceResetCounters, device512To1023Frames=device512To1023Frames, portRecColls=portRecColls, boardCtronFrames=boardCtronFrames, portMediaType=portMediaType, bdBroadThreshold=bdBroadThreshold, portErrorSource=portErrorSource, boardDECNetFrames=boardDECNetFrames, sourceAddr=sourceAddr, device=device, deviceSlots=deviceSlots, boardOSIFrames=boardOSIFrames, portBroadThreshold=portBroadThreshold, redundancyCircuitReset=redundancyCircuitReset, portErrorEnable=portErrorEnable, boardCRCErrs=boardCRCErrs, portBanyanFrames=portBanyanFrames, deviceNovellFrames=deviceNovellFrames, port256To511Frames=port256To511Frames, connectedRight=connectedRight, deviceThdPartyOccupiedSlots=deviceThdPartyOccupiedSlots, redundancyCircuitBoard=redundancyCircuitBoard, boardTotalStationPortsOn=boardTotalStationPortsOn, redundancy=redundancy, portCollsPortDisable=portCollsPortDisable, autowrapRP=autowrapRP, autowrapRPPhantomCurrent=autowrapRPPhantomCurrent, connectedLeft=connectedLeft, portTotalPkts=portTotalPkts, deviceAppletalkFrames=deviceAppletalkFrames, stationP=stationP, board128To255Frames=board128To255Frames, deviceImimOccupiedSlots=deviceImimOccupiedSlots, boardIndex=boardIndex, portRecBytes=portRecBytes, portNovellFrames=portNovellFrames, deviceRedundantCts=deviceRedundantCts, deviceXNSFrames=deviceXNSFrames, deviceEtherOccupiedSlots=deviceEtherOccupiedSlots, devBroadEnable=devBroadEnable, deviceRunts=deviceRunts, deviceTRBoards=deviceTRBoards, portR2=portR2, portAppletalkFrames=portAppletalkFrames, devBroadThreshold=devBroadThreshold, sourceAddrPort=sourceAddrPort, boardRunts=boardRunts)
