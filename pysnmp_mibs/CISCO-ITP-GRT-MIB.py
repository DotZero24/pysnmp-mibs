...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ITP-GRT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:17 2025
...
_CgrtDestNotifEnabled_Type.__name__ = "TruthValue"
...
_CgrtMgmtNotifEnabled_Type.__name__ = "TruthValue"
...
_CgrtRouteTableLoadNotifEnabled_Type.__name__ = "TruthValue"
...
_CgrtDestNotifEnabledRev1_Type.__name__ = "TruthValue"
...
_CgrtMgmtNotifEnabledRev1_Type.__name__ = "TruthValue"
...
_CgrtOrigTableEnabled_Type.__name__ = "TruthValue"
...
_CgrtNoRouteMSUsNotifEnabled_Type.__name__ = "TruthValue"
...
ciscoGrtMIBCompliance.setObjects(
      *(("CISCO-ITP-GRT-MIB", "ciscoGrtInstGroup"),
        ("CISCO-ITP-GRT-MIB", "ciscoGrtDestGroup"),
        ("CISCO-ITP-GRT-MIB", "ciscoGrtRouteGroup"),
        ("CISCO-ITP-GRT-MIB", "ciscoGrtNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoGrtMIBComplianceRev1.setObjects(
      *(("CISCO-ITP-GRT-MIB", "ciscoGrtInstGroup"),
        ("CISCO-ITP-GRT-MIB", "ciscoGrtScalarsGroup"),
        ("CISCO-ITP-GRT-MIB", "ciscoGrtDestGroupRev1"),
        ("CISCO-ITP-GRT-MIB", "ciscoGrtRouteGroupRev1"),
        ("CISCO-ITP-GRT-MIB", "ciscoGrtOrigGroup"),
        ("CISCO-ITP-GRT-MIB", "ciscoGrtDestSIGroup"),
        ("CISCO-ITP-GRT-MIB", "ciscoGrtOrigSIGroup"),
