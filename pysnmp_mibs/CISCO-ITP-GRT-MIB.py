...
CItpTcPointCode, CItpTcURL, CItpTcQos, CItpTcLinksetId, CItpTcTableLoadStatus, CItpTcDisplayPC, CItpTcServiceIndicator, CItpTcRouteTableName = mibBuilder.importSymbols("CISCO-ITP-TC-MIB", "CItpTcPointCode", "CItpTcURL", "CItpTcQos", "CItpTcLinksetId", "CItpTcTableLoadStatus", "CItpTcDisplayPC", "CItpTcServiceIndicator", "CItpTcRouteTableName")
...
mibBuilder.exportSymbols("CISCO-ITP-GRT-MIB", cgrtRouteTable=cgrtRouteTable, cgrtInstLoadStatus=cgrtInstLoadStatus, cgrtRouteDpc=cgrtRouteDpc, cgrtInstLastChanged=cgrtInstLastChanged, cgrtDestNotifMaxPerWindowRev1=cgrtDestNotifMaxPerWindowRev1, cgrtInstUnknownOrigPCs=cgrtInstUnknownOrigPCs, cgrtOrigMSUs=cgrtOrigMSUs, cgrtDestSITable=cgrtDestSITable, cgrtDestNotifMaxPerWindow=cgrtDestNotifMaxPerWindow, cgrtDestSIMSUsIn=cgrtDestSIMSUsIn, cgrtDestNotifSuppressed=cgrtDestNotifSuppressed, cgrtInstTable=cgrtInstTable, cgrtMgmtNotifDelayTime=cgrtMgmtNotifDelayTime, cgrtOrigSIDisplay=cgrtOrigSIDisplay, cgrtMgmtNotifMaxPerWindowRev1=cgrtMgmtNotifMaxPerWindowRev1, cgrtDynamicRoutes=cgrtDynamicRoutes, cgrtDestNotifDelayTime=cgrtDestNotifDelayTime, cgrtOrigEntry=cgrtOrigEntry, cgrtDestSIDisplay=cgrtDestSIDisplay, cgrtInstNumberRoutes=cgrtInstNumberRoutes, cgrtRouteNotifSuppressed=cgrtRouteNotifSuppressed, cgrtDestNotifEnabled=cgrtDestNotifEnabled, cgrtDestNotifEnabledRev1=cgrtDestNotifEnabledRev1, cgrtDestDisplay=cgrtDestDisplay, ciscoGrtNotificationsGroupRev1=ciscoGrtNotificationsGroupRev1, cgrtOrigPC=cgrtOrigPC, ciscoGrtOrigSIGroup=ciscoGrtOrigSIGroup, cgrtDestSIOctetsIn=cgrtDestSIOctetsIn, cgrtOrigTable=cgrtOrigTable, cgrtInstNumberDestinations=cgrtInstNumberDestinations, ciscoGrtDestGroupRev1=ciscoGrtDestGroupRev1, cgrtNotificationsInfo=cgrtNotificationsInfo, cgrtDestSIEntry=cgrtDestSIEntry, ciscoGrtDestGroup=ciscoGrtDestGroup, cgrtRouteRowStatus=cgrtRouteRowStatus, cgrtDestRestrictedMSUs=cgrtDestRestrictedMSUs, cgrtRouteMgmtStatus=cgrtRouteMgmtStatus, cgrtDestOctetsOut=cgrtDestOctetsOut, cgrtMgmtNotifWindowTime=cgrtMgmtNotifWindowTime, cgrtOrigSIEntry=cgrtOrigSIEntry, cgrtOrigSIMSUs=cgrtOrigSIMSUs, PYSNMP_MODULE_ID=ciscoGrtMIB, cgrtMgmtNotifEnabledRev1=cgrtMgmtNotifEnabledRev1, ciscoGrtDestStateChange=ciscoGrtDestStateChange, cgrtDestMSUsIn=cgrtDestMSUsIn, ciscoGrtMIBObjects=ciscoGrtMIBObjects, cgrtRouteMaxDynamic=cgrtRouteMaxDynamic, cgrtRouteDisplay=cgrtRouteDisplay, cgrtRouteDynamic=cgrtRouteDynamic, cgrtRouteType=cgrtRouteType, ciscoGrtNotifications=ciscoGrtNotifications, ciscoGrtMIBComplianceRev1=ciscoGrtMIBComplianceRev1, ciscoGrtInstGroup=ciscoGrtInstGroup, cgrtDestTable=cgrtDestTable, cgrtDestEntry=cgrtDestEntry, ciscoGrtMgmtStateChange=ciscoGrtMgmtStateChange, cgrtDestNotifSupFlag=cgrtDestNotifSupFlag, cgrtOrigOctets=cgrtOrigOctets, cgrtDestOctetsIn=cgrtDestOctetsIn, cgrtRouteEntry=cgrtRouteEntry, ciscoGrtMgmtStateChangeRev1=ciscoGrtMgmtStateChangeRev1, cgrtInstNoRouteDrops=cgrtInstNoRouteDrops, cgrtMtp3SI=cgrtMtp3SI, cgrtIntervalNoRouteMSUs=cgrtIntervalNoRouteMSUs, cgrtPCStatsInterval=cgrtPCStatsInterval, cgrtNoRouteMSUsNotifWindowTime=cgrtNoRouteMSUsNotifWindowTime, cgrtRouteDestLinkset=cgrtRouteDestLinkset, cgrtRouteRestrictedSeconds=cgrtRouteRestrictedSeconds, cgrtDestSIMSUsOut=cgrtDestSIMSUsOut, ciscoGrtDestStateChangeRev1=ciscoGrtDestStateChangeRev1, cgrtMgmtNotifChanges=cgrtMgmtNotifChanges, ciscoGrtNoRouteMSUDiscards=ciscoGrtNoRouteMSUDiscards, cgrtDestMSUsOut=cgrtDestMSUsOut, ciscoGrtMIBCompliance=ciscoGrtMIBCompliance, cgrtNoRouteMSUsInterval=cgrtNoRouteMSUsInterval, cgrtMgmtNotifSupFlag=cgrtMgmtNotifSupFlag, ciscoGrtRouteGroup=ciscoGrtRouteGroup, cgrtRouteMask=cgrtRouteMask, cgrtOrigSITable=cgrtOrigSITable, cgrtDynamicRoutesDropped=cgrtDynamicRoutesDropped, cgrtInstLastLoadTime=cgrtInstLastLoadTime, ciscoGrtInstGroupSup1=ciscoGrtInstGroupSup1, cgrtNoRouteMSUsNotifEnabled=cgrtNoRouteMSUsNotifEnabled, cgrtDestCongestion=cgrtDestCongestion, CgrtDisplayPCSI=CgrtDisplayPCSI, ciscoGrtMIBConform=ciscoGrtMIBConform, cgrtDestCongestionDrops=cgrtDestCongestionDrops, ciscoGrtMIB=ciscoGrtMIB, cgrtOrigSIOctets=cgrtOrigSIOctets, cgrtMgmtNotifMaxPerWindow=cgrtMgmtNotifMaxPerWindow, ciscoGrtNotificationsGroup=ciscoGrtNotificationsGroup, cgrtRouteDestLsCost=cgrtRouteDestLsCost, ciscoGrtDestSIGroup=ciscoGrtDestSIGroup, cgrtOrigTableEnabled=cgrtOrigTableEnabled, cgrtRouteStatus=cgrtRouteStatus, cgrtDestRestrictedSeconds=cgrtDestRestrictedSeconds, ciscoGrtScalarsGroup=ciscoGrtScalarsGroup, cgrtRouteQos=cgrtRouteQos, cgrtDestNotifWindowTimeRev1=cgrtDestNotifWindowTimeRev1, cgrtOrigDisplay=cgrtOrigDisplay, cgrtRouteAllowedSeconds=cgrtRouteAllowedSeconds, cgrtInstEntry=cgrtInstEntry, cgrtRouteProhibitedSeconds=cgrtRouteProhibitedSeconds, ciscoGrtRouteTableLoad=ciscoGrtRouteTableLoad, cgrtRouteTableLoadNotifEnabled=cgrtRouteTableLoadNotifEnabled, cgrtScalars=cgrtScalars, cgrtMgmtNotifEnabled=cgrtMgmtNotifEnabled, cgrtDestSIOctetsOut=cgrtDestSIOctetsOut, cgrtDestNotifChanges=cgrtDestNotifChanges, cgrtDestStatus=cgrtDestStatus, ciscoGrtRouteGroupRev1=ciscoGrtRouteGroupRev1, ciscoGrtMIBCompliances=ciscoGrtMIBCompliances, cgrtInstLastURL=cgrtInstLastURL, cgrtDestInaccessibleDrops=cgrtDestInaccessibleDrops, cgrtDestAccessibleSeconds=cgrtDestAccessibleSeconds, cgrtRouteAdminStatus=cgrtRouteAdminStatus, cgrtDestInaccessibleSeconds=cgrtDestInaccessibleSeconds, cgrtObjects=cgrtObjects, ciscoGrtMIBGroups=ciscoGrtMIBGroups, cgrtDestNotifWindowTime=cgrtDestNotifWindowTime, ciscoGrtOrigGroup=ciscoGrtOrigGroup, cgrtMgmtNotifWindowTimeRev1=cgrtMgmtNotifWindowTimeRev1, cgrtInstTableName=cgrtInstTableName)
