...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-ITP-GRT-MIB
...
CItpTcPointCode, CItpTcTableLoadStatus, CItpTcURL, CItpTcLinksetId, CItpTcQos, CItpTcRouteTableName, CItpTcServiceIndicator, CItpTcDisplayPC = mibBuilder.importSymbols("CISCO-ITP-TC-MIB", "CItpTcPointCode", "CItpTcTableLoadStatus", "CItpTcURL", "CItpTcLinksetId", "CItpTcQos", "CItpTcRouteTableName", "CItpTcServiceIndicator", "CItpTcDisplayPC")
...
mibBuilder.exportSymbols("CISCO-ITP-GRT-MIB", cgrtDestAccessibleSeconds=cgrtDestAccessibleSeconds, cgrtRouteType=cgrtRouteType, cgrtRouteProhibitedSeconds=cgrtRouteProhibitedSeconds, cgrtRouteDisplay=cgrtRouteDisplay, cgrtObjects=cgrtObjects, cgrtMgmtNotifMaxPerWindow=cgrtMgmtNotifMaxPerWindow, PYSNMP_MODULE_ID=ciscoGrtMIB, cgrtOrigSIDisplay=cgrtOrigSIDisplay, cgrtInstTable=cgrtInstTable, cgrtInstTableName=cgrtInstTableName, cgrtInstEntry=cgrtInstEntry, ciscoGrtMIBObjects=ciscoGrtMIBObjects, cgrtInstUnknownOrigPCs=cgrtInstUnknownOrigPCs, cgrtDestCongestionDrops=cgrtDestCongestionDrops, cgrtRouteMaxDynamic=cgrtRouteMaxDynamic, ciscoGrtRouteGroup=ciscoGrtRouteGroup, cgrtMgmtNotifDelayTime=cgrtMgmtNotifDelayTime, cgrtDestSIMSUsOut=cgrtDestSIMSUsOut, cgrtDestInaccessibleSeconds=cgrtDestInaccessibleSeconds, cgrtMgmtNotifSupFlag=cgrtMgmtNotifSupFlag, cgrtInstLoadStatus=cgrtInstLoadStatus, cgrtOrigSIMSUs=cgrtOrigSIMSUs, ciscoGrtMIB=ciscoGrtMIB, ciscoGrtDestGroup=ciscoGrtDestGroup, cgrtDestRestrictedMSUs=cgrtDestRestrictedMSUs, cgrtDestSIOctetsIn=cgrtDestSIOctetsIn, ciscoGrtMIBCompliances=ciscoGrtMIBCompliances, cgrtRouteTableLoadNotifEnabled=cgrtRouteTableLoadNotifEnabled, cgrtDestSIDisplay=cgrtDestSIDisplay, ciscoGrtDestStateChangeRev1=ciscoGrtDestStateChangeRev1, cgrtOrigMSUs=cgrtOrigMSUs, cgrtNotificationsInfo=cgrtNotificationsInfo, cgrtDestNotifMaxPerWindowRev1=cgrtDestNotifMaxPerWindowRev1, cgrtRouteEntry=cgrtRouteEntry, cgrtOrigPC=cgrtOrigPC, ciscoGrtNotificationsGroup=ciscoGrtNotificationsGroup, cgrtDestStatus=cgrtDestStatus, ciscoGrtRouteGroupRev1=ciscoGrtRouteGroupRev1, cgrtDestInaccessibleDrops=cgrtDestInaccessibleDrops, cgrtMgmtNotifWindowTime=cgrtMgmtNotifWindowTime, ciscoGrtOrigSIGroup=ciscoGrtOrigSIGroup, cgrtRouteRowStatus=cgrtRouteRowStatus, cgrtDestTable=cgrtDestTable, ciscoGrtMgmtStateChange=ciscoGrtMgmtStateChange, cgrtRouteMask=cgrtRouteMask, cgrtRouteStatus=cgrtRouteStatus, cgrtInstNumberRoutes=cgrtInstNumberRoutes, cgrtDestOctetsIn=cgrtDestOctetsIn, cgrtDestMSUsIn=cgrtDestMSUsIn, cgrtOrigTableEnabled=cgrtOrigTableEnabled, cgrtOrigEntry=cgrtOrigEntry, cgrtNoRouteMSUsNotifEnabled=cgrtNoRouteMSUsNotifEnabled, ciscoGrtDestGroupRev1=ciscoGrtDestGroupRev1, cgrtDestRestrictedSeconds=cgrtDestRestrictedSeconds, cgrtOrigSIOctets=cgrtOrigSIOctets, cgrtOrigDisplay=cgrtOrigDisplay, ciscoGrtMIBConform=ciscoGrtMIBConform, cgrtRouteMgmtStatus=cgrtRouteMgmtStatus, cgrtPCStatsInterval=cgrtPCStatsInterval, ciscoGrtMIBComplianceRev1=ciscoGrtMIBComplianceRev1, ciscoGrtNoRouteMSUDiscards=ciscoGrtNoRouteMSUDiscards, cgrtInstLastLoadTime=cgrtInstLastLoadTime, cgrtOrigOctets=cgrtOrigOctets, ciscoGrtMgmtStateChangeRev1=ciscoGrtMgmtStateChangeRev1, ciscoGrtMIBGroups=ciscoGrtMIBGroups, cgrtDestNotifChanges=cgrtDestNotifChanges, cgrtDestNotifEnabled=cgrtDestNotifEnabled, cgrtDestSIOctetsOut=cgrtDestSIOctetsOut, cgrtInstLastChanged=cgrtInstLastChanged, cgrtMgmtNotifEnabled=cgrtMgmtNotifEnabled, cgrtScalars=cgrtScalars, ciscoGrtRouteTableLoad=ciscoGrtRouteTableLoad, cgrtDestSIEntry=cgrtDestSIEntry, cgrtDestEntry=cgrtDestEntry, ciscoGrtInstGroupSup1=ciscoGrtInstGroupSup1, cgrtDestNotifSuppressed=cgrtDestNotifSuppressed, cgrtNoRouteMSUsInterval=cgrtNoRouteMSUsInterval, ciscoGrtInstGroup=ciscoGrtInstGroup, cgrtDestNotifWindowTime=cgrtDestNotifWindowTime, cgrtDestNotifMaxPerWindow=cgrtDestNotifMaxPerWindow, cgrtRouteAdminStatus=cgrtRouteAdminStatus, cgrtMgmtNotifMaxPerWindowRev1=cgrtMgmtNotifMaxPerWindowRev1, cgrtDynamicRoutes=cgrtDynamicRoutes, cgrtMgmtNotifEnabledRev1=cgrtMgmtNotifEnabledRev1, cgrtInstLastURL=cgrtInstLastURL, cgrtDestOctetsOut=cgrtDestOctetsOut, cgrtIntervalNoRouteMSUs=cgrtIntervalNoRouteMSUs, cgrtDestNotifEnabledRev1=cgrtDestNotifEnabledRev1, cgrtRouteQos=cgrtRouteQos, ciscoGrtNotificationsGroupRev1=ciscoGrtNotificationsGroupRev1, ciscoGrtOrigGroup=ciscoGrtOrigGroup, cgrtDestSIMSUsIn=cgrtDestSIMSUsIn, ciscoGrtDestStateChange=ciscoGrtDestStateChange, cgrtRouteDpc=cgrtRouteDpc, cgrtDestNotifSupFlag=cgrtDestNotifSupFlag, ciscoGrtDestSIGroup=ciscoGrtDestSIGroup, ciscoGrtNotifications=ciscoGrtNotifications, cgrtRouteDestLinkset=cgrtRouteDestLinkset, cgrtDestCongestion=cgrtDestCongestion, cgrtMtp3SI=cgrtMtp3SI, cgrtRouteDestLsCost=cgrtRouteDestLsCost, cgrtDestMSUsOut=cgrtDestMSUsOut, ciscoGrtScalarsGroup=ciscoGrtScalarsGroup, cgrtDestDisplay=cgrtDestDisplay, cgrtOrigSITable=cgrtOrigSITable, cgrtRouteRestrictedSeconds=cgrtRouteRestrictedSeconds, cgrtDestSITable=cgrtDestSITable, cgrtOrigSIEntry=cgrtOrigSIEntry, cgrtDestNotifWindowTimeRev1=cgrtDestNotifWindowTimeRev1, cgrtNoRouteMSUsNotifWindowTime=cgrtNoRouteMSUsNotifWindowTime, cgrtInstNumberDestinations=cgrtInstNumberDestinations, cgrtRouteAllowedSeconds=cgrtRouteAllowedSeconds, cgrtRouteTable=cgrtRouteTable, ciscoGrtMIBCompliance=ciscoGrtMIBCompliance, cgrtDynamicRoutesDropped=cgrtDynamicRoutesDropped, cgrtRouteDynamic=cgrtRouteDynamic, cgrtDestNotifDelayTime=cgrtDestNotifDelayTime, cgrtMgmtNotifWindowTimeRev1=cgrtMgmtNotifWindowTimeRev1, cgrtMgmtNotifChanges=cgrtMgmtNotifChanges, cgrtOrigTable=cgrtOrigTable, cgrtRouteNotifSuppressed=cgrtRouteNotifSuppressed, CgrtDisplayPCSI=CgrtDisplayPCSI, cgrtInstNoRouteDrops=cgrtInstNoRouteDrops)
