...
mibBuilder.exportSymbols("NETSWITCH-MIB", hpGlobalMemSlotIndex=hpGlobalMemSlotIndex, hpLocalMemSlabCnt=hpLocalMemSlabCnt, hpMsgBufCorrupted=hpMsgBufCorrupted, hpSwitchOsVersion=hpSwitchOsVersion, hpGlobalMemAllocSegCnt=hpGlobalMemAllocSegCnt, hpPktBuf=hpPktBuf, hpMsgBufMiss=hpMsgBufMiss, hpLocalMem=hpLocalMem, hpMsgBufSize=hpMsgBufSize, hpSwitchBaseMACAddress=hpSwitchBaseMACAddress, hpPktBufSize=hpPktBufSize, hpGlobalMemFreeSegCnt=hpGlobalMemFreeSegCnt, hpLocalMemTotalBytes=hpLocalMemTotalBytes, hpGlobalMemTable=hpGlobalMemTable, hpMsgBufEntry=hpMsgBufEntry, hpPktBufEntry=hpPktBufEntry, hpPktBufCorrupted=hpPktBufCorrupted, hpOpSystem=hpOpSystem, hpLocalMemAllocSegCnt=hpLocalMemAllocSegCnt, hpPktBufMin=hpPktBufMin, hpLocalMemFreeSegCnt=hpLocalMemFreeSegCnt, hpMem=hpMem, hpLocalMemFreeBytes=hpLocalMemFreeBytes, hpPktBufMiss=hpPktBufMiss, hpLocalMemSlotIndex=hpLocalMemSlotIndex, hpPktBufInit=hpPktBufInit, hpGlobalMemAllocBytes=hpGlobalMemAllocBytes, hpGlobalMemSlabCnt=hpGlobalMemSlabCnt, hpPktBufSlotIndex=hpPktBufSlotIndex, hpPktBufTable=hpPktBufTable, hpGlobalMemFreeBytes=hpGlobalMemFreeBytes, hpSwitchRomVersion=hpSwitchRomVersion, hpLocalMemTable=hpLocalMemTable, hpMsgBufInit=hpMsgBufInit, hpGlobalMem=hpGlobalMem, hpPktBufFree=hpPktBufFree, hpGlobalMemTotalBytes=hpGlobalMemTotalBytes, hpMsgBufFree=hpMsgBufFree, MacAddress=MacAddress, hpLocalMemAllocBytes=hpLocalMemAllocBytes, hpMsgBufTable=hpMsgBufTable, hpMsgBufSlotIndex=hpMsgBufSlotIndex, hpSwitchSmartCardType=hpSwitchSmartCardType, hpBuf=hpBuf, hpMsgBuf=hpMsgBuf, hpLocalMemEntry=hpLocalMemEntry, hpMsgBufMin=hpMsgBufMin, hpGlobalMemEntry=hpGlobalMemEntry)
