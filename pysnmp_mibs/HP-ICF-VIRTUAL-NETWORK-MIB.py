...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/HP-ICF-VIRTUAL-NETWORK-MIB
...
tunnelIfRemoteInetAddress, tunnelIfLocalInetAddress, tunnelIfAddressType, tunnelIfEntry = mibBuilder.importSymbols("TUNNEL-MIB", "tunnelIfRemoteInetAddress", "tunnelIfLocalInetAddress", "tunnelIfAddressType", "tunnelIfEntry")
...
mibBuilder.exportSymbols("HP-ICF-VIRTUAL-NETWORK-MIB", hpicfVXLANTunnelIfEntry=hpicfVXLANTunnelIfEntry, hpicfVirtualNetworkConformance=hpicfVirtualNetworkConformance, hpicfVirtualNetworkObjects=hpicfVirtualNetworkObjects, hpicfVXLANTunnelStatsGroup=hpicfVXLANTunnelStatsGroup, hpicfVirtualNetworkNotifyScalarsGroup=hpicfVirtualNetworkNotifyScalarsGroup, hpicfVXLANTunnelIfNextHopIpType=hpicfVXLANTunnelIfNextHopIpType, hpicfMTUDropRouterAddr=hpicfMTUDropRouterAddr, hpicfMTUDropInIfIndex=hpicfMTUDropInIfIndex, hpicfVirtualNetworkIcmpErrorRcvd=hpicfVirtualNetworkIcmpErrorRcvd, hpicfVXLANTunnelGlobalStatsClear=hpicfVXLANTunnelGlobalStatsClear, hpicfVirtualNetworkNotificationsGroup=hpicfVirtualNetworkNotificationsGroup, hpicfVirtualNetworkVLANID=hpicfVirtualNetworkVLANID, PYSNMP_MODULE_ID=hpicfVirtualNetwork, hpicfVXLANTunnelStatsClear=hpicfVXLANTunnelStatsClear, hpicfTotalVXLANTunnels=hpicfTotalVXLANTunnels, hpicfVirtualNetworkEntry=hpicfVirtualNetworkEntry, hpicfMTUDropVTEPSource=hpicfMTUDropVTEPSource, hpicfMaxVXLANTunnels=hpicfMaxVXLANTunnels, hpicfVirtualNetworkScalarGroup=hpicfVirtualNetworkScalarGroup, hpicfMTUDropVTEPSrcAddrType=hpicfMTUDropVTEPSrcAddrType, hpicfVirtualNetworkGroups=hpicfVirtualNetworkGroups, hpicfTunnelObjects=hpicfTunnelObjects, hpicfVXLANTunnelIfNextHopIp=hpicfVXLANTunnelIfNextHopIp, hpicfVirtualNetworkCompliances=hpicfVirtualNetworkCompliances, hpicfVXLANTunnelIfNextHopPortName=hpicfVXLANTunnelIfNextHopPortName, hpicfVXLANTunnelIfDownReason=hpicfVXLANTunnelIfDownReason, hpicfMaxVirtualNetworks=hpicfMaxVirtualNetworks, hpicfVirtualNetworkID=hpicfVirtualNetworkID, hpicfVXLANTunnelUDPPort=hpicfVXLANTunnelUDPPort, hpicfVirtualNetworkScalars=hpicfVirtualNetworkScalars, hpicfVirtualNetworkTable=hpicfVirtualNetworkTable, hpicfVXLANTunnelStatsRxPackets=hpicfVXLANTunnelStatsRxPackets, hpicfVirtualNetworkGroup=hpicfVirtualNetworkGroup, hpicfVXLANTunnelScalars=hpicfVXLANTunnelScalars, hpicfMTUDropRouterMTU=hpicfMTUDropRouterMTU, hpicfVXLANTunnelIfNextHopInterface=hpicfVXLANTunnelIfNextHopInterface, hpicfMTUDropVTEPDstAddrType=hpicfMTUDropVTEPDstAddrType, hpicfVirtualNetworkName=hpicfVirtualNetworkName, hpicfTotalVirtualNetworks=hpicfTotalVirtualNetworks, hpicfVirtualNetworkNotifyScalars=hpicfVirtualNetworkNotifyScalars, hpicfVirtualNetwork=hpicfVirtualNetwork, hpicfVirtualNetworkNotifications=hpicfVirtualNetworkNotifications, hpicfMTUDropRouterAddrType=hpicfMTUDropRouterAddrType, hpicfVXLANTunnelStatsTxPackets=hpicfVXLANTunnelStatsTxPackets, hpicfVirtualNetworkCompliance=hpicfVirtualNetworkCompliance, hpicfVirtualNetworkRowStatus=hpicfVirtualNetworkRowStatus, hpicfVXLANTunnelGlobalStatsDropCount=hpicfVXLANTunnelGlobalStatsDropCount, hpicfVXLANTunnelConfigObjects=hpicfVXLANTunnelConfigObjects, hpicfVXLANTunnelEnable=hpicfVXLANTunnelEnable, hpicfVXLANTunnelIfTable=hpicfVXLANTunnelIfTable, hpicfVXLANTunnelScalarGroup=hpicfVXLANTunnelScalarGroup, hpicfVXLANTunnelStatsTxMTUViolation=hpicfVXLANTunnelStatsTxMTUViolation, hpicfMTUDropNotifyEnable=hpicfMTUDropNotifyEnable, hpicfVXLANTunnelObjects=hpicfVXLANTunnelObjects, hpicfMTUDropVTEPDest=hpicfMTUDropVTEPDest)
