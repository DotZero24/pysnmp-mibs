...
mibBuilder.exportSymbols("HP-ICF-VIRTUAL-NETWORK-MIB", hpicfVXLANTunnelGlobalStatsClear=hpicfVXLANTunnelGlobalStatsClear, hpicfVirtualNetworkCompliances=hpicfVirtualNetworkCompliances, hpicfVirtualNetworkVLANID=hpicfVirtualNetworkVLANID, hpicfVXLANTunnelEnable=hpicfVXLANTunnelEnable, hpicfVXLANTunnelStatsClear=hpicfVXLANTunnelStatsClear, hpicfVXLANTunnelScalarGroup=hpicfVXLANTunnelScalarGroup, hpicfVirtualNetworkRowStatus=hpicfVirtualNetworkRowStatus, hpicfMTUDropNotifyEnable=hpicfMTUDropNotifyEnable, hpicfVXLANTunnelIfNextHopInterface=hpicfVXLANTunnelIfNextHopInterface, hpicfVXLANTunnelIfNextHopIp=hpicfVXLANTunnelIfNextHopIp, hpicfMTUDropVTEPSrcAddrType=hpicfMTUDropVTEPSrcAddrType, hpicfTotalVirtualNetworks=hpicfTotalVirtualNetworks, hpicfVXLANTunnelScalars=hpicfVXLANTunnelScalars, hpicfVXLANTunnelConfigObjects=hpicfVXLANTunnelConfigObjects, hpicfMTUDropVTEPDstAddrType=hpicfMTUDropVTEPDstAddrType, hpicfVXLANTunnelStatsGroup=hpicfVXLANTunnelStatsGroup, hpicfVirtualNetworkName=hpicfVirtualNetworkName, hpicfVirtualNetworkScalars=hpicfVirtualNetworkScalars, hpicfVirtualNetworkTable=hpicfVirtualNetworkTable, hpicfMTUDropRouterMTU=hpicfMTUDropRouterMTU, hpicfVirtualNetworkGroups=hpicfVirtualNetworkGroups, hpicfVXLANTunnelStatsRxPackets=hpicfVXLANTunnelStatsRxPackets, hpicfVirtualNetworkID=hpicfVirtualNetworkID, hpicfTotalVXLANTunnels=hpicfTotalVXLANTunnels, hpicfVirtualNetworkCompliance=hpicfVirtualNetworkCompliance, hpicfMTUDropVTEPSource=hpicfMTUDropVTEPSource, hpicfMaxVXLANTunnels=hpicfMaxVXLANTunnels, hpicfTunnelObjects=hpicfTunnelObjects, hpicfVXLANTunnelIfTable=hpicfVXLANTunnelIfTable, hpicfVirtualNetworkNotifications=hpicfVirtualNetworkNotifications, hpicfVXLANTunnelStatsTxPackets=hpicfVXLANTunnelStatsTxPackets, hpicfVXLANTunnelStatsTxMTUViolation=hpicfVXLANTunnelStatsTxMTUViolation, hpicfVXLANTunnelGlobalStatsDropCount=hpicfVXLANTunnelGlobalStatsDropCount, hpicfVXLANTunnelIfNextHopIpType=hpicfVXLANTunnelIfNextHopIpType, hpicfVirtualNetworkScalarGroup=hpicfVirtualNetworkScalarGroup, PYSNMP_MODULE_ID=hpicfVirtualNetwork, hpicfVXLANTunnelIfDownReason=hpicfVXLANTunnelIfDownReason, hpicfMTUDropRouterAddrType=hpicfMTUDropRouterAddrType, hpicfVirtualNetworkNotificationsGroup=hpicfVirtualNetworkNotificationsGroup, hpicfVXLANTunnelUDPPort=hpicfVXLANTunnelUDPPort, hpicfVXLANTunnelObjects=hpicfVXLANTunnelObjects, hpicfVirtualNetworkConformance=hpicfVirtualNetworkConformance, hpicfVirtualNetwork=hpicfVirtualNetwork, hpicfMTUDropRouterAddr=hpicfMTUDropRouterAddr, hpicfVirtualNetworkObjects=hpicfVirtualNetworkObjects, hpicfMTUDropVTEPDest=hpicfMTUDropVTEPDest, hpicfMTUDropInIfIndex=hpicfMTUDropInIfIndex, hpicfVirtualNetworkGroup=hpicfVirtualNetworkGroup, hpicfVirtualNetworkNotifyScalarsGroup=hpicfVirtualNetworkNotifyScalarsGroup, hpicfVXLANTunnelIfNextHopPortName=hpicfVXLANTunnelIfNextHopPortName, hpicfVXLANTunnelIfEntry=hpicfVXLANTunnelIfEntry, hpicfVirtualNetworkIcmpErrorRcvd=hpicfVirtualNetworkIcmpErrorRcvd, hpicfVirtualNetworkEntry=hpicfVirtualNetworkEntry, hpicfVirtualNetworkNotifyScalars=hpicfVirtualNetworkNotifyScalars, hpicfMaxVirtualNetworks=hpicfMaxVirtualNetworks)
