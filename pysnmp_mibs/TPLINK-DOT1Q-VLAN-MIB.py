...
# Notes
# -----
# ASN.1 source file://mibs/tplink/TPLINK-DOT1Q-VLAN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:55:41 2025
...
class _VlanPortIngressCheck_Type(Integer32):
    """Custom type vlanPortIngressCheck based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VlanPortIngressCheck_Type.__name__ = "Integer32"
_VlanPortIngressCheck_Object = MibTableColumn
vlanPortIngressCheck = _VlanPortIngressCheck_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 14, 1, 1, 1, 1, 3),
    _VlanPortIngressCheck_Type()
)
vlanPortIngressCheck.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanPortIngressCheck.setStatus("current")


class _VlanPortAcceptFrameType_Type(Integer32):
    """Custom type vlanPortAcceptFrameType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VlanPortAcceptFrameType_Type.__name__ = "Integer32"
_VlanPortAcceptFrameType_Object = MibTableColumn
vlanPortAcceptFrameType = _VlanPortAcceptFrameType_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 14, 1, 1, 1, 1, 4),
    _VlanPortAcceptFrameType_Type()
)
vlanPortAcceptFrameType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanPortAcceptFrameType.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"tplinkDot1qVlanMIB": tplinkDot1qVlanMIB,
       ...
       "vlanPortIngressCheck": vlanPortIngressCheck,
       "vlanPortAcceptFrameType": vlanPortAcceptFrameType,
