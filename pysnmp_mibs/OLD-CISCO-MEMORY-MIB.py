...
mibBuilder.exportSymbols("OLD-CISCO-MEMORY-MIB", lmem=lmem, bufferLgMiss=bufferLgMiss, bufferHgMax=bufferHgMax, bufferBgMiss=bufferBgMiss, bufferNoMem=bufferNoMem, bufferBgTrim=bufferBgTrim, bufferLgTotal=bufferLgTotal, bufferSmTrim=bufferSmTrim, bufferFail=bufferFail, bufferMdTotal=bufferMdTotal, bufferHgTotal=bufferHgTotal, bufferLgHit=bufferLgHit, bufferElFree=bufferElFree, bufferLgSize=bufferLgSize, bufferLgMax=bufferLgMax, bufferMdSize=bufferMdSize, bufferLgCreate=bufferLgCreate, bufferMdMiss=bufferMdMiss, bufferHgMiss=bufferHgMiss, bufferSmTotal=bufferSmTotal, bufferElMax=bufferElMax, bufferMdTrim=bufferMdTrim, bufferBgTotal=bufferBgTotal, bufferSmHit=bufferSmHit, bufferSmMiss=bufferSmMiss, bufferMdFree=bufferMdFree, bufferSmFree=bufferSmFree, bufferMdHit=bufferMdHit, bufferBgHit=bufferBgHit, bufferBgFree=bufferBgFree, freeMem=freeMem, bufferElCreate=bufferElCreate, bufferHgHit=bufferHgHit, bufferSmCreate=bufferSmCreate, bufferHgCreate=bufferHgCreate, bufferBgSize=bufferBgSize, bufferLgFree=bufferLgFree, bufferSmMax=bufferSmMax, bufferHgSize=bufferHgSize, bufferSmSize=bufferSmSize, bufferMdCreate=bufferMdCreate, bufferHgFree=bufferHgFree, bufferElMiss=bufferElMiss, bufferBgCreate=bufferBgCreate, bufferBgMax=bufferBgMax, bufferHgTrim=bufferHgTrim, bufferMdMax=bufferMdMax, bufferElHit=bufferElHit, bufferLgTrim=bufferLgTrim)
