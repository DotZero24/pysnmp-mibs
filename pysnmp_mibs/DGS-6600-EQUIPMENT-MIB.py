...
mibBuilder.exportSymbols("DGS-6600-EQUIPMENT-MIB", chassisPowerInfoTable=chassisPowerInfoTable, chassisSlotHwVersion=chassisSlotHwVersion, chassisFanInfoEntry=chassisFanInfoEntry, chassisSlotState=chassisSlotState, chassisPortLEDMode=chassisPortLEDMode, chassisSlotFirsMacAddress=chassisSlotFirsMacAddress, chassisPowerVoltage=chassisPowerVoltage, chassisSlotLEDPoEModeEnabled=chassisSlotLEDPoEModeEnabled, chassisSlotModel=chassisSlotModel, chassisFanIndex=chassisFanIndex, chassisFanStatus=chassisFanStatus, chassisTemperatureInletCurrent=chassisTemperatureInletCurrent, chassisPowerPowerWatt=chassisPowerPowerWatt, chassisControlModuleLEDInfo=chassisControlModuleLEDInfo, chassisTemperatureInfo=chassisTemperatureInfo, chassisPortLEDMediumType=chassisPortLEDMediumType, chassisSlotIndex=chassisSlotIndex, chassisTemperatureOutletOverheat=chassisTemperatureOutletOverheat, chassisControlModuleLEDInfoMaster=chassisControlModuleLEDInfoMaster, chassisTemperatureSlotIndex=chassisTemperatureSlotIndex, chassisSlotInfo=chassisSlotInfo, chassisFanInfoTable=chassisFanInfoTable, chassisPowerInfo=chassisPowerInfo, chassisPortLEDInfoTable=chassisPortLEDInfoTable, chassisSlotInfoTable=chassisSlotInfoTable, chassisPowerFanSpeed=chassisPowerFanSpeed, chassisSlotCPLDVersion=chassisSlotCPLDVersion, chassisTemperatureCenterOverheat=chassisTemperatureCenterOverheat, chassisControlModuleLEDInfoConsole=chassisControlModuleLEDInfoConsole, chassisPowerAlive=chassisPowerAlive, chassisPowerInfoEntry=chassisPowerInfoEntry, chassisSlotRuntimeVersion=chassisSlotRuntimeVersion, chassisTemperatureInfoEntry=chassisTemperatureInfoEntry, chassisPortLEDInfoEntry=chassisPortLEDInfoEntry, chassisPowerExist=chassisPowerExist, chassisPortLEDInfo=chassisPortLEDInfo, chassisSlotSerialNumber=chassisSlotSerialNumber, chassisPortLEDIFIndex=chassisPortLEDIFIndex, chassisTemperatureInletOverheat=chassisTemperatureInletOverheat, chassisFanTrayInfoState=chassisFanTrayInfoState, chassisTemperatureInfoTable=chassisTemperatureInfoTable, chassisControlModuleLEDInfoEntry=chassisControlModuleLEDInfoEntry, chassisTemperatureCenterCurrent=chassisTemperatureCenterCurrent, dgs6600EquipmentMIB=dgs6600EquipmentMIB, chassisControlModuleLEDInfoMgmtPortStatus=chassisControlModuleLEDInfoMgmtPortStatus, chassisTemperatureOutletCurrent=chassisTemperatureOutletCurrent, chassisSlotInfoEntry=chassisSlotInfoEntry, chassisPowerCurrent=chassisPowerCurrent, chassisPortLEDIFName=chassisPortLEDIFName, chassisFanTrayInfo=chassisFanTrayInfo, chassisSlotPCBAVersion=chassisSlotPCBAVersion, chassisPowerType=chassisPowerType, chassisControlModuleLEDInfoTable=chassisControlModuleLEDInfoTable, chassisSlotNumberOfMacAddress=chassisSlotNumberOfMacAddress, chassisTemperatureOutletHeatdown=chassisTemperatureOutletHeatdown, chassisControlModuleLEDInfoCPUUtilization=chassisControlModuleLEDInfoCPUUtilization, chassisFanSpeed=chassisFanSpeed, PYSNMP_MODULE_ID=dgs6600EquipmentMIB, chassisPortLEDStatus=chassisPortLEDStatus, chassisSlotBootloaderVersion=chassisSlotBootloaderVersion, chassisTemperatureInletHeatdown=chassisTemperatureInletHeatdown, chassisPowerIndex=chassisPowerIndex, chassisTemperatureCenterHeatdown=chassisTemperatureCenterHeatdown, chassisControlModuleLEDInfoMgmtPortSpeed=chassisControlModuleLEDInfoMgmtPortSpeed, chassisControlModuleLEDInfoIndex=chassisControlModuleLEDInfoIndex)
