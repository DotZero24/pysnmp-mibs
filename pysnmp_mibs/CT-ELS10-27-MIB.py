# SNMP MIB module (CT-ELS10-27-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/cabletron/CT-ELS10-27-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:55:38 2025
...
els10_27hwPortEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27hwPortIndex"),
)
if mibBuilder.loadTexts:
...
els10_27swFilesetEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27swIndex"),
)
if mibBuilder.loadTexts:
...
els10_27ifEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27ifIndex"),
)
if mibBuilder.loadTexts:
...
els10_27dot3Entry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27dot3Index"),
)
if mibBuilder.loadTexts:
...
els10_27uartEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27uartIndex"),
)
if mibBuilder.loadTexts:
...
els10_27debugEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27debugIndex"),
)
if mibBuilder.loadTexts:
...
els10_27lpbkEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27lpbkIndex"),
)
if mibBuilder.loadTexts:
...
els10_27protoEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27protoIfIndex"),
)
if mibBuilder.loadTexts:
...
els10_27trunkEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27trunkIfIndex"),
)
if mibBuilder.loadTexts:
...
els10_27WorkGroupEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27WorkGroupNumber"),
)
if mibBuilder.loadTexts:
...
els10_27trapControlEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27trapIndex"),
)
if mibBuilder.loadTexts:
...
els10_27trapSeverityControlEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27trapSeverity"),
)
if mibBuilder.loadTexts:
...
els10_27trapEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27trapEntryIndex"),
)
if mibBuilder.loadTexts:
...
els10_27pingEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27pingNMSAddr"),
    (0, "CT-ELS10-27-MIB", "els10-27pingDestAddr"),
)
if mibBuilder.loadTexts:
...
els10_27traceEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27traceNMSAddr"),
    (0, "CT-ELS10-27-MIB", "els10-27traceDestAddr"),
    (0, "CT-ELS10-27-MIB", "els10-27traceHop"),
    (0, "CT-ELS10-27-MIB", "els10-27traceProbe"),
)
if mibBuilder.loadTexts:
...
els10_27volmirrorMacEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27volmirrorIndex"),
)
if mibBuilder.loadTexts:
...
class _Els10_27VlanGVRPEnable_Type(OctetString):
    """Custom type els10_27VlanGVRPEnable based on OctetString"""
...
_Els10_27VlanGVRPEnable_Type.__name__ = "OctetString"
...
class _Els10_27VlanAccessList_Type(OctetString):
    """Custom type els10_27VlanAccessList based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 8),
    )
...
_Els10_27VlanAccessList_Type.__name__ = "OctetString"
...
els10_27VlanConfigEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27VlanConfigVID"),
)
if mibBuilder.loadTexts:
...
class _Els10_27VlanConfigVID_Type(OctetString):
    """Custom type els10_27VlanConfigVID based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 8),
    )
...
_Els10_27VlanConfigVID_Type.__name__ = "OctetString"
...
class _Els10_27VlanConfigPorts_Type(OctetString):
    """Custom type els10_27VlanConfigPorts based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 8),
    )
...
_Els10_27VlanConfigPorts_Type.__name__ = "OctetString"
...
els10_27VlanConfigEgressEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27VlanEgressVID"),
)
if mibBuilder.loadTexts:
...
class _Els10_27VlanEgressVID_Type(OctetString):
    """Custom type els10_27VlanEgressVID based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 8),
    )
...
_Els10_27VlanEgressVID_Type.__name__ = "OctetString"
...
class _Els10_27VlanEgressList_Type(OctetString):
    """Custom type els10_27VlanEgressList based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 8),
    )
...
_Els10_27VlanEgressList_Type.__name__ = "OctetString"
...
els10_27VlanFilterGVRPEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27VlanFilterGVRPVID"),
)
if mibBuilder.loadTexts:
...
class _Els10_27VlanFilterGVRPVID_Type(OctetString):
    """Custom type els10_27VlanFilterGVRPVID based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 8),
    )
...
_Els10_27VlanFilterGVRPVID_Type.__name__ = "OctetString"
...
class _Els10_27VlanFilterGVRPList_Type(OctetString):
    """Custom type els10_27VlanFilterGVRPList based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 8),
    )
...
_Els10_27VlanFilterGVRPList_Type.__name__ = "OctetString"
...
els10_27VlanStaticEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27VlanStaticVID"),
)
if mibBuilder.loadTexts:
    els10_27VlanStaticEntry.setStatus("mandatory")


class _Els10_27VlanStaticVID_Type(OctetString):
    """Custom type els10_27VlanStaticVID based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 8),
    )
...
_Els10_27VlanStaticVID_Type.__name__ = "OctetString"
...
els10_27igmpCacheEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27igmpCacheAddress"),
    (0, "CT-ELS10-27-MIB", "els10-27igmpCacheIfIndex"),
)
if mibBuilder.loadTexts:
...
els10_27FlowControlEntry.setIndexNames(
    (0, "CT-ELS10-27-MIB", "els10-27FlowControlInterface"),
)
if mibBuilder.loadTexts:
...
els10_27WriteStatusTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27swdisWriteStatus"),
        ("CT-ELS10-27-MIB", "els10-27swdisDesc"))
)
if mibBuilder.loadTexts:
...
els10_27PortFunctionsTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27ifFunction"))
)
if mibBuilder.loadTexts:
...
els10_27RxQueuesTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27ifRxQueues"))
)
if mibBuilder.loadTexts:
...
els10_27TxCongestsTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27adminNAMReceiveCongests"))
)
if mibBuilder.loadTexts:
...
els10_27DebugStringIdTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27debugStringID"),
        ("CT-ELS10-27-MIB", "els10-27debugString"))
)
if mibBuilder.loadTexts:
...
els10_27LpbkOperationTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27lpbkOperation"),
        ("CT-ELS10-27-MIB", "els10-27lpbkErrorNoReceives"),
        ("CT-ELS10-27-MIB", "els10-27lpbkErrorBadReceives"))
)
if mibBuilder.loadTexts:
...
els10_27TrunkStateTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27trunkState"))
)
if mibBuilder.loadTexts:
...
els10_27TrunkBridgeAddrTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27trunkRemoteBridgeAddr"))
)
if mibBuilder.loadTexts:
...
els10_27TrunkIPAddrTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27trunkRemoteIp"))
)
if mibBuilder.loadTexts:
...
els10_27TrunkErrorTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27trunkLastError"))
)
if mibBuilder.loadTexts:
...
els10_27TrunkLinkOrdinalTrap = NotificationType(
    (1, 3, 6, 1, 2, 1, 1, 2, 0, 14)
)
els10_27TrunkLinkOrdinalTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27trunkLinkOrdinal"))
)
if mibBuilder.loadTexts:
...
els10_27TrunkLinkCountTrap = NotificationType(
    (1, 3, 6, 1, 2, 1, 1, 2, 0, 15)
)
els10_27TrunkLinkCountTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27trunkLinkCount"))
)
if mibBuilder.loadTexts:
...
els10_27DiagUnitBootedTrap = NotificationType(
    (1, 3, 6, 1, 2, 1, 1, 2, 0, 16)
)
els10_27DiagUnitBootedTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27adminFatalErr"))
)
if mibBuilder.loadTexts:
...
els10_27hwDiagTrap = NotificationType(
    (1, 3, 6, 1, 2, 1, 1, 2, 0, 100)
)
els10_27hwDiagTrap.setObjects(
      *(("CT-ELS10-27-MIB", "els10-27trapSeverity"),
        ("CT-ELS10-27-MIB", "els10-27hwDiagCode"))
)
if mibBuilder.loadTexts:
