...
# Notes
# -----
# ASN.1 source file://mibs/rfc/LLDP-EXT-DOT1-V2-MIB
...
_LldpV2Xdot1ConfigPortVlanTxEnable_Type.__name__ = "TruthValue"
...
_LldpV2Xdot1ConfigVlanNameTxEnable_Type.__name__ = "TruthValue"
...
_LldpV2Xdot1ConfigProtoVlanTxEnable_Type.__name__ = "TruthValue"
...
_LldpV2Xdot1ConfigProtocolTxEnable_Type.__name__ = "TruthValue"
...
_LldpV2Xdot1ConfigVidUsageDigestTxEnable_Type.__name__ = "TruthValue"
...
_LldpV2Xdot1ConfigManVidTxEnable_Type.__name__ = "TruthValue"
...
_LldpXdot1CnConfigCnTxEnable_Type.__name__ = "TruthValue"
...
_LldpXdot1dcbxConfigApplicationVlanTxEnable_Type.__name__ = "TruthValue"
...
lldpV2Xdot1TxRxCompliance.setObjects(
      *(("LLDP-EXT-DOT1-V2-MIB", "lldpV2Xdot1ConfigGroup"),
        ("LLDP-EXT-DOT1-V2-MIB", "ifGeneralInformationGroup"))
)
if mibBuilder.loadTexts:
...
lldpV2Xdot1TxCompliance.setObjects(
    ("LLDP-EXT-DOT1-V2-MIB", "lldpV2Xdot1LocSysGroup")
)
if mibBuilder.loadTexts:
...
lldpV2Xdot1RxCompliance.setObjects(
    ("LLDP-EXT-DOT1-V2-MIB", "lldpV2Xdot1RemSysGroup")
)
if mibBuilder.loadTexts:
...
lldpV2Xdot1RxComplianceV2.setObjects(
    ("LLDP-EXT-DOT1-V2-MIB", "lldpV2Xdot1RemSysV2Group")
)
if mibBuilder.loadTexts:
...
lldpXdot1CnCompliance.setObjects(
      *(("LLDP-EXT-DOT1-V2-MIB", "lldpXdot1CnGroup"),
        ("LLDP-EXT-DOT1-V2-MIB", "ifGeneralInformationGroup"))
)
if mibBuilder.loadTexts:
...
lldpXdot1dcbxCompliance.setObjects(
      *(("LLDP-EXT-DOT1-V2-MIB", "lldpXdot1dcbxETSGroup"),
        ("LLDP-EXT-DOT1-V2-MIB", "lldpXdot1dcbxPFCGroup"),
        ("LLDP-EXT-DOT1-V2-MIB", "lldpXdot1dcbxApplicationPriorityGroup"),
        ("LLDP-EXT-DOT1-V2-MIB", "lldpXdot1dcbxApplicationVlanGroup"),
        ("LLDP-EXT-DOT1-V2-MIB", "ifGeneralInformationGroup"))
)
if mibBuilder.loadTexts:
