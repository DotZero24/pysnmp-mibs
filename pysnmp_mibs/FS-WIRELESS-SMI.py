...
mibBuilder.exportSymbols("FS-WIRELESS-SMI", wirelessMib=wirelessMib, PYSNMP_MODULE_ID=wirelessMib, wireless=wireless, fsWirelessProducts=fsWirelessProducts, fsWirelessMgmt=fsWirelessMgmt)
