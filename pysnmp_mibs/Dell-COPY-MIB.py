# SNMP MIB module (Dell-COPY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-COPY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:37 2025
...
rlCopyHistoryEntry.setIndexNames(
    (0, "Dell-COPY-MIB", "rlCopyHistoryHistoryIndex"),
)
if mibBuilder.loadTexts:
...
rlCopyMessagesEntry.setIndexNames(
    (0, "Dell-COPY-MIB", "rlCopyMessagesCopyIndex"),
    (0, "Dell-COPY-MIB", "rlCopyMessagesMessageIndex"),
)
if mibBuilder.loadTexts:
...
rlCopyInetEntry = _RlCopyInetEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 87, 8, 1)
)
rlCopyInetEntry.setIndexNames(
    (0, "Dell-COPY-MIB", "rlCopyInetIndex"),
)
if mibBuilder.loadTexts:
...
rlCopyHistoryInetEntry = _RlCopyHistoryInetEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 87, 9, 1)
)
rlCopyHistoryInetEntry.setIndexNames(
    (0, "Dell-COPY-MIB", "rlCopyHistoryInetHistoryIndex"),
)
if mibBuilder.loadTexts:
...
rlCopySWToUnits = NotificationType(
    (1, 3, 6, 1, 4, 1, 89, 0, 212)
)
rlCopySWToUnits.setObjects(
      *(("Dell-DEVICEPARAMS-MIB", "rndErrorDesc"),
        ("Dell-DEVICEPARAMS-MIB", "rndErrorSeverity"),
        ("Dell-COPY-MIB", "rlCopyUnitsList"))
)
if mibBuilder.loadTexts:
