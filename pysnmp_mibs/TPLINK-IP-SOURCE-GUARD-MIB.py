...
mibBuilder.exportSymbols("TPLINK-IP-SOURCE-GUARD-MIB", tpIpSourceGuardConfigPort=tpIpSourceGuardConfigPort, tplinkIpSourceGuardMIBObjects=tplinkIpSourceGuardMIBObjects, tplinkIpSourceGuardNotifications=tplinkIpSourceGuardNotifications, PYSNMP_MODULE_ID=tplinkIpSourceGuardMIB, tplinkIpSourceGuardMIB=tplinkIpSourceGuardMIB, tpIpSourceGuardConfigTable=tpIpSourceGuardConfigTable, tpIpSourceGuardConfig=tpIpSourceGuardConfig, tpIpSourceGuardConfigType=tpIpSourceGuardConfigType, tpIpSourceGuardConfigPortLag=tpIpSourceGuardConfigPortLag, tpIpSourceGuardConfigEntry=tpIpSourceGuardConfigEntry, tpIpSourceGuardLoggingConfig=tpIpSourceGuardLoggingConfig, tpIpSourceGuardRxIllegalIpPacket=tpIpSourceGuardRxIllegalIpPacket)
