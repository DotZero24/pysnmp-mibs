...
oacExpIMPstn,oacExpIMPstnNotifications,oacMIBModules=mibBuilder.importSymbols('ONEACCESS-GLOBAL-REG','oacExpIMPstn','oacExpIMPstnNotifications','oacMIBModules')
...
if mibBuilder.loadTexts:oacPstnMIBModule.setRevisions(('2011-10-27 00:00',))
dialDown=NotificationType((1,3,6,1,4,1,13191,10,3,6,0,3))
dialDown.setObjects(*((_A,_E),(_A,_D),(_A,_H),(_A,_B),(_A,_G),(_A,_F),(_A,_C)))
if mibBuilder.loadTexts:dialDown.setStatus(_I)
dialUp=NotificationType((1,3,6,1,4,1,13191,10,3,6,0,4))
dialUp.setObjects(*((_A,_E),(_A,_D),(_A,_H),(_A,_B),(_A,_G),(_A,_F),(_A,_C)))
if mibBuilder.loadTexts:dialUp.setStatus(_I)
mibBuilder.exportSymbols('ONEACCESS-PSTN-MIB',**{'oacPstnMIBModule':oacPstnMIBModule,'dialDown':dialDown,'dialUp':dialUp})