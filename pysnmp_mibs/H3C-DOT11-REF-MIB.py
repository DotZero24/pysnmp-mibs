_R='h3cDot11RadioElementRadioNum'
_Q='not-accessible'
_P='invalidie'
_O='unknownfailure'
_N='cleartxt'
...
if mibBuilder.loadTexts:h3cDot11.setRevisions(('2016-03-11 18:00','2010-01-07 20:00','2009-05-07 20:00','2007-06-21 20:00','2007-04-27 20:00','2006-05-10 19:00'))
...
class H3cDot11RadioType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,4,8,16,32,64,128)));namedValues=NamedValues(*((_G,1),(_H,2),(_I,4),('dot11n',8),(_J,16),(_K,32),(_L,64),(_M,128)))
class H3cDot11RadioType2(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,4,8,16,32,64)));namedValues=NamedValues(*((_G,1),(_H,2),(_I,4),(_K,8),(_J,16),(_L,32),(_M,64)))
...
class H3cDot11SSIDEncryptModeType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_N,1),('cipher',2),(_E,3)))
...
class H3cDot11TunnelSecSchemType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_N,1),('dtls',2),('ipsec',3)))
...
class H3cDot11AssocFailType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6)));namedValues=NamedValues(*((_O,1),('toomanyassoc',2),(_P,3),('unsupportedrate',4),('unsupportedpwrcap',5),('unsupportedcap',6)))
class H3cDot11AuthorFailType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7)));namedValues=NamedValues(*((_O,1),(_P,2),('rsnieversionunsupported',3),('wpaieversionunsupported',4),('groupcipherinvalid',5),('pairwisecipherinvalid',6),('akminvalid',7)))
...
class H3cDot11TruthValueCM(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1)));namedValues=NamedValues(*(('dot11false',0),('dot11true',1)))
_H3cDot11Common_ObjectIdentity=ObjectIdentity
h3cDot11Common=_H3cDot11Common_ObjectIdentity((1,3,6,1,4,1,2011,10,2,75,12))
_H3cDot11ElementGroup_ObjectIdentity=ObjectIdentity
h3cDot11ElementGroup=_H3cDot11ElementGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,75,12,1))
_H3cDot11APElementTable_Object=MibTable
h3cDot11APElementTable=_H3cDot11APElementTable_Object((1,3,6,1,4,1,2011,10,2,75,12,1,1))
if mibBuilder.loadTexts:h3cDot11APElementTable.setStatus(_A)
_H3cDot11APElementEntry_Object=MibTableRow
h3cDot11APElementEntry=_H3cDot11APElementEntry_Object((1,3,6,1,4,1,2011,10,2,75,12,1,1,1))
...
h3cDot11APElementIndex=_H3cDot11APElementIndex_Object((1,3,6,1,4,1,2011,10,2,75,12,1,1,1,1),_H3cDot11APElementIndex_Type())
h3cDot11APElementIndex.setMaxAccess(_Q)
...
h3cDot11APElementTemplateName=_H3cDot11APElementTemplateName_Object((1,3,6,1,4,1,2011,10,2,75,12,1,1,1,2),_H3cDot11APElementTemplateName_Type())
...
h3cDot11APElementSerialID=_H3cDot11APElementSerialID_Object((1,3,6,1,4,1,2011,10,2,75,12,1,1,1,3),_H3cDot11APElementSerialID_Type())
...
h3cDot11APElementModelAlias=_H3cDot11APElementModelAlias_Object((1,3,6,1,4,1,2011,10,2,75,12,1,1,1,4),_H3cDot11APElementModelAlias_Type())
...
h3cDot11RadioElementTable=_H3cDot11RadioElementTable_Object((1,3,6,1,4,1,2011,10,2,75,12,1,2))
if mibBuilder.loadTexts:h3cDot11RadioElementTable.setStatus(_A)
_H3cDot11RadioElementEntry_Object=MibTableRow
h3cDot11RadioElementEntry=_H3cDot11RadioElementEntry_Object((1,3,6,1,4,1,2011,10,2,75,12,1,2,1))
h3cDot11RadioElementEntry.setIndexNames((0,_C,_F),(0,_C,_R))
...
h3cDot11RadioElementRadioNum=_H3cDot11RadioElementRadioNum_Object((1,3,6,1,4,1,2011,10,2,75,12,1,2,1,1),_H3cDot11RadioElementRadioNum_Type())
h3cDot11RadioElementRadioNum.setMaxAccess(_Q)
...
h3cDot11RadioElementRadioPolicy=_H3cDot11RadioElementRadioPolicy_Object((1,3,6,1,4,1,2011,10,2,75,12,1,2,1,2),_H3cDot11RadioElementRadioPolicy_Type())
