...
_J='fsPbbContextId'
_I='fsPbbPipIfIndex'
_H='SUPERMICRO-PBB-MIB'
_G='not-accessible'
_F='read-only'
_E='deprecated'
_D='SUPERMICRO-PROP-PBB-MIB'
_C='Integer32'
_B='read-write'
_A='current'
...
PriorityCodePoint,=mibBuilder.importSymbols('SUPERMICRO-DOT1AD-MIB',_Q)
...
if mibBuilder.loadTexts:supermicroProviderBackboneBridgeMIB.setRevisions(('2012-09-05 00:00',))
_FsPbbSystem_ObjectIdentity=ObjectIdentity
fsPbbSystem=_FsPbbSystem_ObjectIdentity((1,3,6,1,4,1,10876,101,2,15,1))
...
fsPbbShutdownStatus=_FsPbbShutdownStatus_Object((1,3,6,1,4,1,10876,101,2,15,1,1),_FsPbbShutdownStatus_Type())
...
fsPbbGlbOUI=_FsPbbGlbOUI_Object((1,3,6,1,4,1,10876,101,2,15,1,2),_FsPbbGlbOUI_Type())
...
fsPbbMaxNoOfISID=_FsPbbMaxNoOfISID_Object((1,3,6,1,4,1,10876,101,2,15,1,3),_FsPbbMaxNoOfISID_Type())
...
fsPbbMaxNoOfISIDPerContext=_FsPbbMaxNoOfISIDPerContext_Object((1,3,6,1,4,1,10876,101,2,15,1,4),_FsPbbMaxNoOfISIDPerContext_Type())
...
fsPbbMaxPortsPerISID=_FsPbbMaxPortsPerISID_Object((1,3,6,1,4,1,10876,101,2,15,1,5),_FsPbbMaxPortsPerISID_Type())
...
fsPbbMaxPortsPerISIDPerContext=_FsPbbMaxPortsPerISIDPerContext_Object((1,3,6,1,4,1,10876,101,2,15,1,6),_FsPbbMaxPortsPerISIDPerContext_Type())
...
fsPbbMaxCurrentNoOfISID=_FsPbbMaxCurrentNoOfISID_Object((1,3,6,1,4,1,10876,101,2,15,1,7),_FsPbbMaxCurrentNoOfISID_Type())
...
fsPbbMaxCurrentISIDPerContext=_FsPbbMaxCurrentISIDPerContext_Object((1,3,6,1,4,1,10876,101,2,15,1,8),_FsPbbMaxCurrentISIDPerContext_Type())
...
fsPbbMaxCurrentPortsPerISID=_FsPbbMaxCurrentPortsPerISID_Object((1,3,6,1,4,1,10876,101,2,15,1,9),_FsPbbMaxCurrentPortsPerISID_Type())
...
fsPbbMaxCurrPortsPerISIDContext=_FsPbbMaxCurrPortsPerISIDContext_Object((1,3,6,1,4,1,10876,101,2,15,1,10),_FsPbbMaxCurrPortsPerISIDContext_Type())
...
fsPbbTraceInput=_FsPbbTraceInput_Object((1,3,6,1,4,1,10876,101,2,15,1,11),_FsPbbTraceInput_Type())
...
fsPbbTraceOption=_FsPbbTraceOption_Object((1,3,6,1,4,1,10876,101,2,15,1,12),_FsPbbTraceOption_Type())
...
fsPbbISIDConfig=_FsPbbISIDConfig_ObjectIdentity((1,3,6,1,4,1,10876,101,2,15,2))
_FsPbbISIDOUITable_Object=MibTable
fsPbbISIDOUITable=_FsPbbISIDOUITable_Object((1,3,6,1,4,1,10876,101,2,15,2,1))
if mibBuilder.loadTexts:fsPbbISIDOUITable.setStatus(_A)
_FsPbbISIDOUIEntry_Object=MibTableRow
fsPbbISIDOUIEntry=_FsPbbISIDOUIEntry_Object((1,3,6,1,4,1,10876,101,2,15,2,1,1))
...
fsPbbContextId=_FsPbbContextId_Object((1,3,6,1,4,1,10876,101,2,15,2,1,1,1),_FsPbbContextId_Type())
...
fsPbbOUI=_FsPbbOUI_Object((1,3,6,1,4,1,10876,101,2,15,2,1,1,2),_FsPbbOUI_Type())
...
fsPbbOUIRowStatus=_FsPbbOUIRowStatus_Object((1,3,6,1,4,1,10876,101,2,15,2,1,1,3),_FsPbbOUIRowStatus_Type())
...
fsPbbPortConfig=_FsPbbPortConfig_ObjectIdentity((1,3,6,1,4,1,10876,101,2,15,3))
_FsPbbPortPisidTable_Object=MibTable
fsPbbPortPisidTable=_FsPbbPortPisidTable_Object((1,3,6,1,4,1,10876,101,2,15,3,1))
if mibBuilder.loadTexts:fsPbbPortPisidTable.setStatus(_A)
_FsPbbPortPisidEntry_Object=MibTableRow
fsPbbPortPisidEntry=_FsPbbPortPisidEntry_Object((1,3,6,1,4,1,10876,101,2,15,3,1,1))
...
fsPbbPortPisid=_FsPbbPortPisid_Object((1,3,6,1,4,1,10876,101,2,15,3,1,1,1),_FsPbbPortPisid_Type())
...
fsPbbPIsidRowStatus=_FsPbbPIsidRowStatus_Object((1,3,6,1,4,1,10876,101,2,15,3,1,1,2),_FsPbbPIsidRowStatus_Type())
...
fsPbbPortTable=_FsPbbPortTable_Object((1,3,6,1,4,1,10876,101,2,15,3,2))
if mibBuilder.loadTexts:fsPbbPortTable.setStatus(_A)
_FsPbbPortEntry_Object=MibTableRow
fsPbbPortEntry=_FsPbbPortEntry_Object((1,3,6,1,4,1,10876,101,2,15,3,2,1))
...
fsPbbPortPcpSelectionRow=_FsPbbPortPcpSelectionRow_Object((1,3,6,1,4,1,10876,101,2,15,3,2,1,1),_FsPbbPortPcpSelectionRow_Type())
...
fsPbbPortUseDei=_FsPbbPortUseDei_Object((1,3,6,1,4,1,10876,101,2,15,3,2,1,2),_FsPbbPortUseDei_Type())
...
fsPbbPortReqDropEncoding=_FsPbbPortReqDropEncoding_Object((1,3,6,1,4,1,10876,101,2,15,3,2,1,3),_FsPbbPortReqDropEncoding_Type())
...
fsPbbPcpDecodingTable=_FsPbbPcpDecodingTable_Object((1,3,6,1,4,1,10876,101,2,15,3,3))
if mibBuilder.loadTexts:fsPbbPcpDecodingTable.setStatus(_A)
_FsPbbPcpDecodingEntry_Object=MibTableRow
fsPbbPcpDecodingEntry=_FsPbbPcpDecodingEntry_Object((1,3,6,1,4,1,10876,101,2,15,3,3,1))
...
fsPbbPcpDecodingPcpSelRow=_FsPbbPcpDecodingPcpSelRow_Object((1,3,6,1,4,1,10876,101,2,15,3,3,1,1),_FsPbbPcpDecodingPcpSelRow_Type())
...
fsPbbPcpDecodingPcpValue=_FsPbbPcpDecodingPcpValue_Object((1,3,6,1,4,1,10876,101,2,15,3,3,1,2),_FsPbbPcpDecodingPcpValue_Type())
...
fsPbbPcpDecodingPriority=_FsPbbPcpDecodingPriority_Object((1,3,6,1,4,1,10876,101,2,15,3,3,1,3),_FsPbbPcpDecodingPriority_Type())
...
fsPbbPcpDecodingDropEligible=_FsPbbPcpDecodingDropEligible_Object((1,3,6,1,4,1,10876,101,2,15,3,3,1,4),_FsPbbPcpDecodingDropEligible_Type())
...
fsPbbPcpEncodingTable=_FsPbbPcpEncodingTable_Object((1,3,6,1,4,1,10876,101,2,15,3,4))
if mibBuilder.loadTexts:fsPbbPcpEncodingTable.setStatus(_A)
_FsPbbPcpEncodingEntry_Object=MibTableRow
fsPbbPcpEncodingEntry=_FsPbbPcpEncodingEntry_Object((1,3,6,1,4,1,10876,101,2,15,3,4,1))
...
fsPbbPcpEncodingPcpSelRow=_FsPbbPcpEncodingPcpSelRow_Object((1,3,6,1,4,1,10876,101,2,15,3,4,1,1),_FsPbbPcpEncodingPcpSelRow_Type())
...
fsPbbPcpEncodingPriority=_FsPbbPcpEncodingPriority_Object((1,3,6,1,4,1,10876,101,2,15,3,4,1,2),_FsPbbPcpEncodingPriority_Type())
...
fsPbbPcpEncodingDropEligible=_FsPbbPcpEncodingDropEligible_Object((1,3,6,1,4,1,10876,101,2,15,3,4,1,3),_FsPbbPcpEncodingDropEligible_Type())
...
fsPbbPcpEncodingPcpValue=_FsPbbPcpEncodingPcpValue_Object((1,3,6,1,4,1,10876,101,2,15,3,4,1,4),_FsPbbPcpEncodingPcpValue_Type())
...
fsPbbInstanceConfig=_FsPbbInstanceConfig_ObjectIdentity((1,3,6,1,4,1,10876,101,2,15,4))
_FsPbbInstanceTable_Object=MibTable
fsPbbInstanceTable=_FsPbbInstanceTable_Object((1,3,6,1,4,1,10876,101,2,15,4,1))
if mibBuilder.loadTexts:fsPbbInstanceTable.setStatus(_A)
_FsPbbInstanceEntry_Object=MibTableRow
fsPbbInstanceEntry=_FsPbbInstanceEntry_Object((1,3,6,1,4,1,10876,101,2,15,4,1,1))
...
fsPbbInstanceId=_FsPbbInstanceId_Object((1,3,6,1,4,1,10876,101,2,15,4,1,1,1),_FsPbbInstanceId_Type())
...
fsPbbInstanceMacAddr=_FsPbbInstanceMacAddr_Object((1,3,6,1,4,1,10876,101,2,15,4,1,1,2),_FsPbbInstanceMacAddr_Type())
...
fsPbbInstanceName=_FsPbbInstanceName_Object((1,3,6,1,4,1,10876,101,2,15,4,1,1,3),_FsPbbInstanceName_Type())
...
fsPbbInstanceIComponents=_FsPbbInstanceIComponents_Object((1,3,6,1,4,1,10876,101,2,15,4,1,1,4),_FsPbbInstanceIComponents_Type())
...
fsPbbInstanceBComponents=_FsPbbInstanceBComponents_Object((1,3,6,1,4,1,10876,101,2,15,4,1,1,5),_FsPbbInstanceBComponents_Type())
...
fsPbbInstanceBebPorts=_FsPbbInstanceBebPorts_Object((1,3,6,1,4,1,10876,101,2,15,4,1,1,6),_FsPbbInstanceBebPorts_Type())
...
fsPbbInstanceRowStatus=_FsPbbInstanceRowStatus_Object((1,3,6,1,4,1,10876,101,2,15,4,1,1,7),_FsPbbInstanceRowStatus_Type())
...
fsPbbInstanceMappingTable=_FsPbbInstanceMappingTable_Object((1,3,6,1,4,1,10876,101,2,15,4,2))
if mibBuilder.loadTexts:fsPbbInstanceMappingTable.setStatus(_A)
_FsPbbInstanceMappingEntry_Object=MibTableRow
fsPbbInstanceMappingEntry=_FsPbbInstanceMappingEntry_Object((1,3,6,1,4,1,10876,101,2,15,4,2,1))
