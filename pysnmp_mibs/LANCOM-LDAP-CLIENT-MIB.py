# SNMP MIB module (LANCOM-LDAP-CLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-LDAP-CLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:20:21 2025
...
agentLdapBindFirst = _AgentLdapBindFirst_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 73, 1, 1, 1),
...
agentLdapAppendWithBaseDN = _AgentLdapAppendWithBaseDN_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 73, 1, 1, 2),
...
agentLdapServerEntry = _AgentLdapServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 73, 1, 2, 1)
)
agentLdapServerEntry.setIndexNames(
    (0, "LANCOM-LDAP-CLIENT-MIB", "agentLdapServerIpAddrType"),
    (0, "LANCOM-LDAP-CLIENT-MIB", "agentLdapServerIpAddress"),
)
if mibBuilder.loadTexts:
...
agentLdapSearchMapEntry = _AgentLdapSearchMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 73, 1, 3, 1)
)
agentLdapSearchMapEntry.setIndexNames(
    (0, "LANCOM-LDAP-CLIENT-MIB", "agentLdapSearchMapName"),
    (0, "LANCOM-LDAP-CLIENT-MIB", "agentLdapSearchMapMode"),
)
if mibBuilder.loadTexts:
