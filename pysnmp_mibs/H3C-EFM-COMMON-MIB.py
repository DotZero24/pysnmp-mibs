...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/h3c/H3C-EFM-COMMON-MIB
...
h3cEfmOamMIB.setRevisions(('2015-08-04 11:47',))
if mibBuilder.loadTexts: h3cEfmOamMIB.setLastUpdated('201508041147Z')
if mibBuilder.loadTexts: h3cEfmOamMIB.setOrganization('Hangzhou H3C Tech. Co., Ltd.')
...
h3cDot3OamStats2Table = MibTable((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8), )
if mibBuilder.loadTexts: h3cDot3OamStats2Table.setStatus('current')
h3cDot3OamStats2Entry = MibTableRow((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"))
if mibBuilder.loadTexts: h3cDot3OamStats2Entry.setStatus('current')
h3cDot3Oam2InformationTx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 1), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2InformationTx.setStatus('current')
h3cDot3Oam2InformationRx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 2), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2InformationRx.setStatus('current')
h3cDot3Oam2UniqueEventNotificationTx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 3), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2UniqueEventNotificationTx.setStatus('current')
h3cDot3Oam2UniqueEventNotificationRx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 4), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2UniqueEventNotificationRx.setStatus('current')
h3cDot3Oam2DuplicateEventNotificationTx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 5), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2DuplicateEventNotificationTx.setStatus('current')
h3cDot3Oam2DuplicateEventNotificationRx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 6), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2DuplicateEventNotificationRx.setStatus('current')
h3cDot3Oam2LoopbackControlTx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 7), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2LoopbackControlTx.setStatus('current')
h3cDot3Oam2LoopbackControlRx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 8), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2LoopbackControlRx.setStatus('current')
h3cDot3Oam2VariableRequestTx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 9), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2VariableRequestTx.setStatus('current')
h3cDot3Oam2VariableRequestRx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 10), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2VariableRequestRx.setStatus('current')
h3cDot3Oam2VariableResponseTx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 11), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2VariableResponseTx.setStatus('current')
h3cDot3Oam2VariableResponseRx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 12), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2VariableResponseRx.setStatus('current')
h3cDot3Oam2OrgSpecificTx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 13), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2OrgSpecificTx.setStatus('current')
h3cDot3Oam2OrgSpecificRx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 14), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2OrgSpecificRx.setStatus('current')
h3cDot3Oam2UnsupportedCodesTx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 15), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2UnsupportedCodesTx.setStatus('current')
h3cDot3Oam2UnsupportedCodesRx = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 16), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2UnsupportedCodesRx.setStatus('current')
h3cDot3Oam2FramesLostDueToOam = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 1, 8, 1, 17), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cDot3Oam2FramesLostDueToOam.setStatus('current')
...
h3cDot3Oam2StatsBaseGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 3, 2, 1, 11)).setObjects(("H3C-EFM-COMMON-MIB", "h3cDot3Oam2InformationTx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2InformationRx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2UniqueEventNotificationTx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2UniqueEventNotificationRx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2DuplicateEventNotificationTx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2DuplicateEventNotificationRx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2LoopbackControlTx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2LoopbackControlRx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2VariableRequestTx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2VariableRequestRx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2VariableResponseTx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2VariableResponseRx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2OrgSpecificTx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2OrgSpecificRx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2UnsupportedCodesTx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2UnsupportedCodesRx"), ("H3C-EFM-COMMON-MIB", "h3cDot3Oam2FramesLostDueToOam"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    h3cDot3Oam2StatsBaseGroup = h3cDot3Oam2StatsBaseGroup.setStatus('current')
mibBuilder.exportSymbols("H3C-EFM-COMMON-MIB", h3cDot3OamVariableRequestRx=h3cDot3OamVariableRequestRx, h3cDot3OamTraps=h3cDot3OamTraps, h3cDot3OamLoopbackStatus=h3cDot3OamLoopbackStatus, h3cDot3OamErrFramePeriodWindow=h3cDot3OamErrFramePeriodWindow, h3cDot3OamEventLogWindowLo=h3cDot3OamEventLogWindowLo, h3cDot3OamVariableResponseTx=h3cDot3OamVariableResponseTx, h3cDot3OamErrFramePeriodEvNotifEnable=h3cDot3OamErrFramePeriodEvNotifEnable, h3cDot3OamErrSymPeriodWindowHi=h3cDot3OamErrSymPeriodWindowHi, h3cDot3OamVariableResponseRx=h3cDot3OamVariableResponseRx, h3cDot3OamErrFrameEvNotifEnable=h3cDot3OamErrFrameEvNotifEnable, h3cDot3OamNonThresholdEvent=h3cDot3OamNonThresholdEvent, h3cDot3OamFramesLostDueToOam=h3cDot3OamFramesLostDueToOam, h3cDot3OamMaxOamPduSize=h3cDot3OamMaxOamPduSize, h3cDot3OamEventLogThresholdLo=h3cDot3OamEventLogThresholdLo, h3cDot3OamPeerStatus=h3cDot3OamPeerStatus, h3cDot3OamEventLogValue=h3cDot3OamEventLogValue, h3cDot3OamLoopbackEntry=h3cDot3OamLoopbackEntry, h3cDot3OamPeerMaxOamPduSize=h3cDot3OamPeerMaxOamPduSize, h3cDot3OamStats2Table=h3cDot3OamStats2Table, h3cDot3OamEventLogEventTotal=h3cDot3OamEventLogEventTotal, h3cDot3OamPeerConfigRevision=h3cDot3OamPeerConfigRevision, h3cDot3OamPeerMode=h3cDot3OamPeerMode, h3cDot3OamEventConfigTable=h3cDot3OamEventConfigTable, h3cDot3OamNotificationGroup=h3cDot3OamNotificationGroup, h3cDot3OamFunctionsSupported=h3cDot3OamFunctionsSupported, h3cDot3OamDuplicateEventNotificationRx=h3cDot3OamDuplicateEventNotificationRx, h3cDot3OamErrFramePeriodThreshold=h3cDot3OamErrFramePeriodThreshold, h3cDot3OamErrSymbolPeriodEventGroup=h3cDot3OamErrSymbolPeriodEventGroup, h3cDot3Oam2VariableRequestTx=h3cDot3Oam2VariableRequestTx, h3cDot3OamEventLogRunningTotal=h3cDot3OamEventLogRunningTotal, h3cDot3Oam2LoopbackControlTx=h3cDot3Oam2LoopbackControlTx, h3cDot3OamInformationRx=h3cDot3OamInformationRx, h3cDot3OamEventLogThresholdHi=h3cDot3OamEventLogThresholdHi, h3cDot3OamEventLogTable=h3cDot3OamEventLogTable, h3cDot3OamLoopbackGroup=h3cDot3OamLoopbackGroup, h3cDot3OamPeerFunctionsSupported=h3cDot3OamPeerFunctionsSupported, h3cDot3OamEventLogEntry=h3cDot3OamEventLogEntry, h3cDot3Oam2DuplicateEventNotificationTx=h3cDot3Oam2DuplicateEventNotificationTx, h3cDot3OamPeerVendorInfo=h3cDot3OamPeerVendorInfo, h3cDot3Oam2FramesLostDueToOam=h3cDot3Oam2FramesLostDueToOam, h3cDot3OamUniqueEventNotificationRx=h3cDot3OamUniqueEventNotificationRx, h3cDot3OamEventLogIndex=h3cDot3OamEventLogIndex, h3cDot3Oam2OrgSpecificTx=h3cDot3Oam2OrgSpecificTx, h3cDot3OamInformationTx=h3cDot3OamInformationTx, h3cDot3OamEventLogOui=h3cDot3OamEventLogOui, h3cDot3Oam2UniqueEventNotificationRx=h3cDot3Oam2UniqueEventNotificationRx, h3cEfmOamMIB=h3cEfmOamMIB, h3cDot3OamErrFrameSecsSummaryThreshold=h3cDot3OamErrFrameSecsSummaryThreshold, h3cDot3Oam2InformationTx=h3cDot3Oam2InformationTx, h3cDot3OamOrgSpecificTx=h3cDot3OamOrgSpecificTx, h3cDot3OamErrFrameThreshold=h3cDot3OamErrFrameThreshold, h3cDot3Oam2InformationRx=h3cDot3Oam2InformationRx, h3cDot3Oam2VariableResponseRx=h3cDot3Oam2VariableResponseRx, h3cDot3Oam2OrgSpecificRx=h3cDot3Oam2OrgSpecificRx, h3cDot3OamErrSymPeriodThresholdHi=h3cDot3OamErrSymPeriodThresholdHi, h3cDot3OamLoopbackCommand=h3cDot3OamLoopbackCommand, h3cDot3OamUnsupportedCodesTx=h3cDot3OamUnsupportedCodesTx, h3cDot3OamEventLogLocation=h3cDot3OamEventLogLocation, h3cDot3OamErrSymPeriodThresholdLo=h3cDot3OamErrSymPeriodThresholdLo, h3cDot3OamUnsupportedCodesRx=h3cDot3OamUnsupportedCodesRx, h3cDot3OamTable=h3cDot3OamTable, h3cDot3OamErrFrameSecsEvNotifEnable=h3cDot3OamErrFrameSecsEvNotifEnable, h3cDot3Oam2StatsBaseGroup=h3cDot3Oam2StatsBaseGroup, PYSNMP_MODULE_ID=h3cEfmOamMIB, Dot3Oui=Dot3Oui, h3cDot3OamStatsTable=h3cDot3OamStatsTable, h3cDot3OamMIB=h3cDot3OamMIB, h3cDot3OamEventLogWindowHi=h3cDot3OamEventLogWindowHi, h3cDot3Oam2DuplicateEventNotificationRx=h3cDot3Oam2DuplicateEventNotificationRx, h3cDot3OamAdminState=h3cDot3OamAdminState, h3cDot3OamEventConfigEntry=h3cDot3OamEventConfigEntry, h3cDot3OamStats2Entry=h3cDot3OamStats2Entry, h3cDot3OamErrFrameEventGroup=h3cDot3OamErrFrameEventGroup, h3cDot3OamPeerEntry=h3cDot3OamPeerEntry, h3cDot3OamStatsEntry=h3cDot3OamStatsEntry, h3cDot3OamThresholdEvent=h3cDot3OamThresholdEvent, h3cDot3OamErrSymPeriodWindowLo=h3cDot3OamErrSymPeriodWindowLo, h3cDot3OamVariableRequestTx=h3cDot3OamVariableRequestTx, h3cDot3Oam2LoopbackControlRx=h3cDot3Oam2LoopbackControlRx, h3cDot3OamErrFrameSecsSummaryEventGroup=h3cDot3OamErrFrameSecsSummaryEventGroup, h3cDot3OamEntry=h3cDot3OamEntry, h3cDot3Oam2VariableRequestRx=h3cDot3Oam2VariableRequestRx, h3cDot3OamLoopbackControlRx=h3cDot3OamLoopbackControlRx, h3cDot3OamErrFrameSecsSummaryWindow=h3cDot3OamErrFrameSecsSummaryWindow, h3cDot3Oam2UniqueEventNotificationTx=h3cDot3Oam2UniqueEventNotificationTx, h3cDot3Oam2UnsupportedCodesTx=h3cDot3Oam2UnsupportedCodesTx, h3cDot3OamEventLogType=h3cDot3OamEventLogType, h3cDot3OamLoopbackTable=h3cDot3OamLoopbackTable, h3cDot3OamCompliance=h3cDot3OamCompliance, h3cDot3OamGroups=h3cDot3OamGroups, h3cDot3OamConformance=h3cDot3OamConformance, h3cDot3OamUniqueEventNotificationTx=h3cDot3OamUniqueEventNotificationTx, h3cDot3OamPeerMacAddress=h3cDot3OamPeerMacAddress, h3cDot3OamMode=h3cDot3OamMode, h3cDot3OamErrSymPeriodEvNotifEnable=h3cDot3OamErrSymPeriodEvNotifEnable, h3cDot3OamErrFrameWindow=h3cDot3OamErrFrameWindow, h3cDot3OamErrFramePeriodEventGroup=h3cDot3OamErrFramePeriodEventGroup, h3cDot3OamEventLogGroup=h3cDot3OamEventLogGroup, h3cDot3OamCompliances=h3cDot3OamCompliances, h3cDot3OamOperStatus=h3cDot3OamOperStatus, h3cDot3OamControlGroup=h3cDot3OamControlGroup, h3cDot3OamPeerTable=h3cDot3OamPeerTable, h3cDot3OamConfigRevision=h3cDot3OamConfigRevision, h3cDot3OamLoopbackIgnoreRx=h3cDot3OamLoopbackIgnoreRx, h3cDot3OamDuplicateEventNotificationTx=h3cDot3OamDuplicateEventNotificationTx, h3cDot3OamOrgSpecificRx=h3cDot3OamOrgSpecificRx, h3cDot3Oam2VariableResponseTx=h3cDot3Oam2VariableResponseTx, h3cDot3OamStatsBaseGroup=h3cDot3OamStatsBaseGroup, h3cDot3OamPeerVendorOui=h3cDot3OamPeerVendorOui, h3cDot3Oam2UnsupportedCodesRx=h3cDot3Oam2UnsupportedCodesRx, h3cDot3OamPeerGroup=h3cDot3OamPeerGroup, h3cDot3OamTrapsPrefix=h3cDot3OamTrapsPrefix, h3cDot3OamLoopbackControlTx=h3cDot3OamLoopbackControlTx, h3cDot3OamEventLogTimestamp=h3cDot3OamEventLogTimestamp)
