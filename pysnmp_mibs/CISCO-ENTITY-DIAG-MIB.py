...
CeDiagTestList, CeDiagDiagnosticLevel, CeDiagErrorIdentifier, CeDiagTestIdentifier, CeDiagDiagnosticMethod, CeDiagJobIdentifier, CeDiagPortList, CeDiagJobSuite, CeDiagErrorIdentifierOrZero = mibBuilder.importSymbols("CISCO-ENTITY-DIAG-TC-MIB", "CeDiagTestList", "CeDiagDiagnosticLevel", "CeDiagErrorIdentifier", "CeDiagTestIdentifier", "CeDiagDiagnosticMethod", "CeDiagJobIdentifier", "CeDiagPortList", "CeDiagJobSuite", "CeDiagErrorIdentifierOrZero")
...
mibBuilder.exportSymbols("CISCO-ENTITY-DIAG-MIB", ceDiagHMTestEnabled=ceDiagHMTestEnabled, ceDiagEventCount=ceDiagEventCount, ciscoEntityDiagMIB=ciscoEntityDiagMIB, ceDiagTestPeffLastFail=ceDiagTestPeffLastFail, ceDiagOnDemandIterations=ceDiagOnDemandIterations, ceDiagTestPerfTotalRuns=ceDiagTestPerfTotalRuns, ceDiagTestPerfEntry=ceDiagTestPerfEntry, ceDiagEventQueryResultingRows=ceDiagEventQueryResultingRows, ceDiagTestAttributes=ceDiagTestAttributes, ceDiagHMSyslogEnabled=ceDiagHMSyslogEnabled, ceDiagDescriptions=ceDiagDescriptions, ceDiagEventQueryOwner=ceDiagEventQueryOwner, ceDiagHMTestRecoverNotif=ceDiagHMTestRecoverNotif, ceDiagTestPerfGroup=ceDiagTestPerfGroup, ceDiagTestText=ceDiagTestText, ceDiagDescrGroup=ceDiagDescrGroup, ceDiagOnDemandJobTestList=ceDiagOnDemandJobTestList, ceDiagTestPerfLastErrorID=ceDiagTestPerfLastErrorID, ceDiagGlobalConfigGroup=ceDiagGlobalConfigGroup, ceDiagEvents=ceDiagEvents, ceDiagOnDemandErrorAction=ceDiagOnDemandErrorAction, ceDiagHMTestInterval=ceDiagHMTestInterval, ceDiagEventQueryStatus=ceDiagEventQueryStatus, ceDiagTest=ceDiagTest, ceDiagTestPerfLastSuccess=ceDiagTestPerfLastSuccess, ceDiagHMTestEntry=ceDiagHMTestEntry, ceDiagBootupLevel=ceDiagBootupLevel, ciscoEntityDiagMIBNotifs=ciscoEntityDiagMIBNotifs, ceDiagNotificationControl=ceDiagNotificationControl, ceDiagTestPerfTotalFails=ceDiagTestPerfTotalFails, ciscoEntityDiagMIBComplianceRev3=ciscoEntityDiagMIBComplianceRev3, ceDiagScheduledJobRowStatus=ceDiagScheduledJobRowStatus, ceDiagEventResultTable=ceDiagEventResultTable, ceDiagScheduledJobTestList=ceDiagScheduledJobTestList, ceDiagEnableBootUpFailedNotif=ceDiagEnableBootUpFailedNotif, ceDiagNotifErrorMsgGroup=ceDiagNotifErrorMsgGroup, ceDiagTestCustomAttributeEntry=ceDiagTestCustomAttributeEntry, ceDiagHealthMonitor=ceDiagHealthMonitor, ceDiagScheduledTestFailedNotif=ceDiagScheduledTestFailedNotif, ceDiagEventResultIndex=ceDiagEventResultIndex, ceDiagScheduledJobType=ceDiagScheduledJobType, ciscoEntityDiagMIBComplianceRev4=ciscoEntityDiagMIBComplianceRev4, ceDiagErrorInfoTable=ceDiagErrorInfoTable, ceDiagEventMaxQueries=ceDiagEventMaxQueries, ceDiagEnableSchedTestFailedNotif=ceDiagEnableSchedTestFailedNotif, ceDiagTestInfoTable=ceDiagTestInfoTable, ceDiagOnDemandErrorAllowed=ceDiagOnDemandErrorAllowed, ceDiagHMTestThreshWindowGroup=ceDiagHMTestThreshWindowGroup, ceDiagErrorText=ceDiagErrorText, ceDiagEnableHMThreshReachedNotif=ceDiagEnableHMThreshReachedNotif, ceDiagHMTestIntervalDefault=ceDiagHMTestIntervalDefault, ceDiagBootUpFailedNotif=ceDiagBootUpFailedNotif, ceDiagTestPerfLastTestMethodGroup=ceDiagTestPerfLastTestMethodGroup, ceDiagOnDemandJobPortList=ceDiagOnDemandJobPortList, ciscoEntityDiagMIBCompliances=ciscoEntityDiagMIBCompliances, ceDiagEventQueryIndex=ceDiagEventQueryIndex, ceDiagEntityImageOperStatus=ceDiagEntityImageOperStatus, ciscoEntityDiagMIBGroups=ciscoEntityDiagMIBGroups, ceDiagErrorId=ceDiagErrorId, ceDiagEventLogSize=ceDiagEventLogSize, ceDiagEntityGroup=ceDiagEntityGroup, ceDiagOnDemandGroup=ceDiagOnDemandGroup, ceDiagScheduledJobIndex=ceDiagScheduledJobIndex, ceDiagOnDemandJobEntry=ceDiagOnDemandJobEntry, ceDiagEntityImageAdminStatus=ceDiagEntityImageAdminStatus, ceDiagOnDemandJobTable=ceDiagOnDemandJobTable, ceDiagEventResultEntry=ceDiagEventResultEntry, ceDiagTestCustomAttributeDesc=ceDiagTestCustomAttributeDesc, ceDiagTestPerfLastTestMethod=ceDiagTestPerfLastTestMethod, ceDiagOnDemand=ceDiagOnDemand, ceDiagHMTestThreshWindowSize=ceDiagHMTestThreshWindowSize, ceDiagScheduledJobSuiteGroup=ceDiagScheduledJobSuiteGroup, ceDiagOnDemandJobRowStatus=ceDiagOnDemandJobRowStatus, ceDiagEntityTable=ceDiagEntityTable, ceDiagEnableHMTestRecoverNotif=ceDiagEnableHMTestRecoverNotif, ceDiagScheduledJobStart=ceDiagScheduledJobStart, ceDiagEventQueryPhysicalIndex=ceDiagEventQueryPhysicalIndex, ceDiagNotificationGroup=ceDiagNotificationGroup, ceDiagEventErrorMsg=ceDiagEventErrorMsg, ceDiagEventResultSeverity=ceDiagEventResultSeverity, ceDiagScheduledJobDayOfWeek=ceDiagScheduledJobDayOfWeek, ceDiagScheduledJobTable=ceDiagScheduledJobTable, ceDiagHMTestThreshold=ceDiagHMTestThreshold, ceDiagHMTestThreshWindowSuite=ceDiagHMTestThreshWindowSuite, PYSNMP_MODULE_ID=ciscoEntityDiagMIB, ceDiagEntityCurrentTestMethod=ceDiagEntityCurrentTestMethod, ceDiagScheduledJobEntry=ceDiagScheduledJobEntry, ceDiagTestPerfLastRun=ceDiagTestPerfLastRun, ciscoEntityDiagMIBConform=ciscoEntityDiagMIBConform, ceDiagEntityEntry=ceDiagEntityEntry, ceDiagTestId=ceDiagTestId, ceDiagEventResultLogText=ceDiagEventResultLogText, ceDiagEntityFieldDiagnosticUrl=ceDiagEntityFieldDiagnosticUrl, ceDiagEntityCurrentTestEntry=ceDiagEntityCurrentTestEntry, ceDiagScheduledJobSuite=ceDiagScheduledJobSuite, ceDiagHMThresholdReachedNotif=ceDiagHMThresholdReachedNotif, ceDiagEventQueryTable=ceDiagEventQueryTable, ciscoEntityDiagMIBObjects=ciscoEntityDiagMIBObjects, ceDiagTestCustomAttributeTable=ceDiagTestCustomAttributeTable, ceDiagHMTestThresholdDefault=ceDiagHMTestThresholdDefault, ceDiagEntityBootLevel=ceDiagEntityBootLevel, ceDiagScheduled=ceDiagScheduled, ceDiagTestPerfLastResult=ceDiagTestPerfLastResult, ciscoEntityDiagMIBComplianceRev2=ciscoEntityDiagMIBComplianceRev2, ceDiagGlobalConfig=ceDiagGlobalConfig, ceDiagEventGroup=ceDiagEventGroup, ceDiagScheduledGroup=ceDiagScheduledGroup, ceDiagEntityImageGroup=ceDiagEntityImageGroup, ceDiagEventQueryEntry=ceDiagEventQueryEntry, ceDiagTestPerfFirstFail=ceDiagTestPerfFirstFail, ceDiagErrorInfoEntry=ceDiagErrorInfoEntry, ceDiagNotifControlGroup=ceDiagNotifControlGroup, ceDiagEventQuerySeverity=ceDiagEventQuerySeverity, ceDiagTestInfoEntry=ceDiagTestInfoEntry, ceDiagHMTestTable=ceDiagHMTestTable, ciscoEntityDiagMIBComplianceRev1=ciscoEntityDiagMIBComplianceRev1, ceDiagScheduledJobPortList=ceDiagScheduledJobPortList, ceDiagTestPerfTable=ceDiagTestPerfTable, ceDiagTestPerfConsecutiveFails=ceDiagTestPerfConsecutiveFails, ceDiagEventResultPhysicalDescr=ceDiagEventResultPhysicalDescr, ceDiagTestCustomAttributeIndex=ceDiagTestCustomAttributeIndex, ceDiagEventResultTime=ceDiagEventResultTime, ceDiagHealthMonitorGroup=ceDiagHealthMonitorGroup, ceDiagHMTestIntervalMin=ceDiagHMTestIntervalMin, ceDiagEntityCurrentTestTable=ceDiagEntityCurrentTestTable, ceDiagOnDemandJobSuite=ceDiagOnDemandJobSuite, ceDiagEntity=ceDiagEntity, ceDiagEventResultPhysicalIndex=ceDiagEventResultPhysicalIndex)
