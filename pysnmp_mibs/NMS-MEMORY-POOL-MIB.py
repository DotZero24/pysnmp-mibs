...
nmsMemoryPoolUtilization=_NmsMemoryPoolUtilization_Object((1,3,6,1,4,1,3320,9,48,1),_NmsMemoryPoolUtilization_Type())
...
nmsMemoryPoolTotalMemorySize=_NmsMemoryPoolTotalMemorySize_Object((1,3,6,1,4,1,3320,9,48,2),_NmsMemoryPoolTotalMemorySize_Type())
...
nmsMemoryPoolImageRatio=_NmsMemoryPoolImageRatio_Object((1,3,6,1,4,1,3320,9,48,3),_NmsMemoryPoolImageRatio_Type())
...
nmsMemoryPoolRegionRatio=_NmsMemoryPoolRegionRatio_Object((1,3,6,1,4,1,3320,9,48,4),_NmsMemoryPoolRegionRatio_Type())
...
nmsMemoryPoolHeapRatio=_NmsMemoryPoolHeapRatio_Object((1,3,6,1,4,1,3320,9,48,5),_NmsMemoryPoolHeapRatio_Type())
...
nmsMemoryPoolHeapUtilization=_NmsMemoryPoolHeapUtilization_Object((1,3,6,1,4,1,3320,9,48,6),_NmsMemoryPoolHeapUtilization_Type())
...
nmsMemoryPoolMessageBufferRatio=_NmsMemoryPoolMessageBufferRatio_Object((1,3,6,1,4,1,3320,9,48,7),_NmsMemoryPoolMessageBufferRatio_Type())
...
nmsMemoryPoolMessageBufferUtilization=_NmsMemoryPoolMessageBufferUtilization_Object((1,3,6,1,4,1,3320,9,48,8),_NmsMemoryPoolMessageBufferUtilization_Type())
...
nmsMemoryPoolTotalFlashSize=_NmsMemoryPoolTotalFlashSize_Object((1,3,6,1,4,1,3320,9,48,9),_NmsMemoryPoolTotalFlashSize_Type())
