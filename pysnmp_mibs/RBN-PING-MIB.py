...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-PING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:25 2025
...
_RbnPingHistoryIpTargetAddressType_Type.__name__ = "InetAddressType"
...
_RbnPingHistoryIpTargetAddress_Type.__name__ = "InetAddress"
...
_RbnPingCtlMaxHistoryRows_Type.__name__ = "Unsigned32"
...
_RbnPingCtlIpDontFragment_Type.__name__ = "TruthValue"
...
rbnPingIpCompliance.setObjects(
      *(("RBN-PING-MIB", "rbnPingGlobalsGroup"),
        ("RBN-PING-MIB", "rbnPingResultsGroup"),
        ("RBN-PING-MIB", "rbnPingCtlGroup"),
        ("RBN-PING-MIB", "rbnPingIpGroup"))
)
if mibBuilder.loadTexts:
