...
# Notes
# -----
# ASN.1 source file://mibs/colubris/COLUBRIS-USER-SESSION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:29:19 2025
...
class _CoUserSessEgressVLAN_Type(Integer32):
    """Custom type coUserSessEgressVLAN based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 4094),
    )
...
_CoUserSessEgressVLAN_Type.__name__ = "Integer32"
_CoUserSessEgressVLAN_Object = MibTableColumn
coUserSessEgressVLAN = _CoUserSessEgressVLAN_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 36, 1, 2, 1, 1, 20),
    _CoUserSessEgressVLAN_Type()
)
coUserSessEgressVLAN.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coUserSessEgressVLAN.setStatus("current")
_CoUserSessMacAddress_Type = MacAddress
_CoUserSessMacAddress_Object = MibTableColumn
coUserSessMacAddress = _CoUserSessMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 36, 1, 2, 1, 1, 21),
    _CoUserSessMacAddress_Type()
)
coUserSessMacAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coUserSessMacAddress.setStatus("current")
...
colubrisUserSessionStMIBGroup.setObjects(
      *(("COLUBRIS-USER-SESSION-MIB", "coUserSessUserName"),
        ...
        ("COLUBRIS-USER-SESSION-MIB", "coUserSessEgressVLAN"),
        ("COLUBRIS-USER-SESSION-MIB", "coUserSessMacAddress"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"colubrisUserSessionMIB": colubrisUserSessionMIB,
       ...
       "coUserSessEgressVLAN": coUserSessEgressVLAN,
       "coUserSessMacAddress": coUserSessMacAddress,
