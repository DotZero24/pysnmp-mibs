...
mibBuilder.exportSymbols("COLUBRIS-USER-SESSION-MIB", coUserSessionStGroup=coUserSessionStGroup, coUserSessBytesReceived=coUserSessBytesReceived, coUserSessBytesSent=coUserSessBytesSent, coUserSessNonACUserCount=coUserSessNonACUserCount, coUserSessUserName=coUserSessUserName, colubrisUserSessionInfoMIBGroup=colubrisUserSessionInfoMIBGroup, coUserSessionEntry=coUserSessionEntry, coUserSessPacketsSent=coUserSessPacketsSent, coUserSessEgressVLAN=coUserSessEgressVLAN, coUserSessPHYType=coUserSessPHYType, coUserSessACUserMaxCount=coUserSessACUserMaxCount, coUserSessSessionDuration=coUserSessSessionDuration, coUserSessVSCName=coUserSessVSCName, coUserSessCallingStationID=coUserSessCallingStationID, userSessionMIBNotifications=userSessionMIBNotifications, colubrisUserSessionStMIBGroup=colubrisUserSessionStMIBGroup, coUserSessACUserCount=coUserSessACUserCount, coUserSessMacAddress=coUserSessMacAddress, colubrisUserSessionMIBGroups=colubrisUserSessionMIBGroups, colubrisUserSessionMIBCompliance=colubrisUserSessionMIBCompliance, colubrisUserSessionMIBObjects=colubrisUserSessionMIBObjects, userSessionMIBNotificationPrefix=userSessionMIBNotificationPrefix, PYSNMP_MODULE_ID=colubrisUserSessionMIB, coUserSessMAPGroupName=coUserSessMAPGroupName, coUserSessionTable=coUserSessionTable, colubrisUserSessionMIB=colubrisUserSessionMIB, coUserSessIdleTime=coUserSessIdleTime, coUserSessRADIUSServerProfileName=coUserSessRADIUSServerProfileName, coUserSessSSID=coUserSessSSID, coUserSessCalledStationID=coUserSessCalledStationID, colubrisUserSessionMIBCompliances=colubrisUserSessionMIBCompliances, colubrisUserSessionMIBConformance=colubrisUserSessionMIBConformance, coUserSessPacketsReceived=coUserSessPacketsReceived, coUserSessAuthType=coUserSessAuthType, coUserSessNonACUserMaxCount=coUserSessNonACUserMaxCount, coUserSessionInfoGroup=coUserSessionInfoGroup, coUserSessIndex=coUserSessIndex, coUserSessVLAN=coUserSessVLAN, coUserSessClientIpAddress=coUserSessClientIpAddress, coUserSessRADIUSServerIpAddress=coUserSessRADIUSServerIpAddress)
