_g='colubrisUserSessionStMIBGroup'
_f='colubrisUserSessionInfoMIBGroup'
_e='coUserSessMacAddress'
_d='coUserSessEgressVLAN'
...
colubrisUserSessionMIBObjects=_ColubrisUserSessionMIBObjects_ObjectIdentity((1,3,6,1,4,1,8744,5,36,1))
_CoUserSessionInfoGroup_ObjectIdentity=ObjectIdentity
coUserSessionInfoGroup=_CoUserSessionInfoGroup_ObjectIdentity((1,3,6,1,4,1,8744,5,36,1,1))
_CoUserSessACUserMaxCount_Type=Unsigned32
_CoUserSessACUserMaxCount_Object=MibScalar
coUserSessACUserMaxCount=_CoUserSessACUserMaxCount_Object((1,3,6,1,4,1,8744,5,36,1,1,1),_CoUserSessACUserMaxCount_Type())
...
coUserSessNonACUserMaxCount=_CoUserSessNonACUserMaxCount_Object((1,3,6,1,4,1,8744,5,36,1,1,2),_CoUserSessNonACUserMaxCount_Type())
...
coUserSessACUserCount=_CoUserSessACUserCount_Object((1,3,6,1,4,1,8744,5,36,1,1,3),_CoUserSessACUserCount_Type())
...
coUserSessNonACUserCount=_CoUserSessNonACUserCount_Object((1,3,6,1,4,1,8744,5,36,1,1,4),_CoUserSessNonACUserCount_Type())
...
coUserSessionStGroup=_CoUserSessionStGroup_ObjectIdentity((1,3,6,1,4,1,8744,5,36,1,2))
_CoUserSessionTable_Object=MibTable
coUserSessionTable=_CoUserSessionTable_Object((1,3,6,1,4,1,8744,5,36,1,2,1))
if mibBuilder.loadTexts:coUserSessionTable.setStatus(_A)
_CoUserSessionEntry_Object=MibTableRow
coUserSessionEntry=_CoUserSessionEntry_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1))
...
coUserSessIndex=_CoUserSessIndex_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,1),_CoUserSessIndex_Type())
...
coUserSessUserName=_CoUserSessUserName_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,2),_CoUserSessUserName_Type())
...
coUserSessClientIpAddress=_CoUserSessClientIpAddress_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,3),_CoUserSessClientIpAddress_Type())
...
coUserSessSessionDuration=_CoUserSessSessionDuration_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,4),_CoUserSessSessionDuration_Type())
...
coUserSessIdleTime=_CoUserSessIdleTime_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,5),_CoUserSessIdleTime_Type())
...
coUserSessMAPGroupName=_CoUserSessMAPGroupName_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,6),_CoUserSessMAPGroupName_Type())
...
coUserSessVSCName=_CoUserSessVSCName_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,7),_CoUserSessVSCName_Type())
...
coUserSessSSID=_CoUserSessSSID_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,8),_CoUserSessSSID_Type())
...
coUserSessVLAN=_CoUserSessVLAN_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,9),_CoUserSessVLAN_Type())
coUserSessVLAN.setMaxAccess(_C)
if mibBuilder.loadTexts:coUserSessVLAN.setStatus(_A)
class _CoUserSessPHYType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3,4,5)));namedValues=NamedValues(*(('unknown',0),('ieee802dot11a',1),('ieee802dot11b',2),('ieee802dot11g',3),('ieee802dot11n',4),('ieee802dot11ac',5)))
_CoUserSessPHYType_Type.__name__=_E
_CoUserSessPHYType_Object=MibTableColumn
coUserSessPHYType=_CoUserSessPHYType_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,10),_CoUserSessPHYType_Type())
...
coUserSessAuthType=_CoUserSessAuthType_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,11),_CoUserSessAuthType_Type())
...
coUserSessCalledStationID=_CoUserSessCalledStationID_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,12),_CoUserSessCalledStationID_Type())
...
coUserSessCallingStationID=_CoUserSessCallingStationID_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,13),_CoUserSessCallingStationID_Type())
...
coUserSessRADIUSServerProfileName=_CoUserSessRADIUSServerProfileName_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,14),_CoUserSessRADIUSServerProfileName_Type())
...
coUserSessRADIUSServerIpAddress=_CoUserSessRADIUSServerIpAddress_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,15),_CoUserSessRADIUSServerIpAddress_Type())
...
coUserSessBytesSent=_CoUserSessBytesSent_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,16),_CoUserSessBytesSent_Type())
...
coUserSessBytesReceived=_CoUserSessBytesReceived_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,17),_CoUserSessBytesReceived_Type())
...
coUserSessPacketsSent=_CoUserSessPacketsSent_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,18),_CoUserSessPacketsSent_Type())
...
coUserSessPacketsReceived=_CoUserSessPacketsReceived_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,19),_CoUserSessPacketsReceived_Type())
coUserSessPacketsReceived.setMaxAccess(_C)
if mibBuilder.loadTexts:coUserSessPacketsReceived.setStatus(_A)
class _CoUserSessEgressVLAN_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,4094))
_CoUserSessEgressVLAN_Type.__name__=_E
_CoUserSessEgressVLAN_Object=MibTableColumn
coUserSessEgressVLAN=_CoUserSessEgressVLAN_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,20),_CoUserSessEgressVLAN_Type())
coUserSessEgressVLAN.setMaxAccess(_C)
if mibBuilder.loadTexts:coUserSessEgressVLAN.setStatus(_A)
_CoUserSessMacAddress_Type=MacAddress
_CoUserSessMacAddress_Object=MibTableColumn
coUserSessMacAddress=_CoUserSessMacAddress_Object((1,3,6,1,4,1,8744,5,36,1,2,1,1,21),_CoUserSessMacAddress_Type())
coUserSessMacAddress.setMaxAccess(_C)
if mibBuilder.loadTexts:coUserSessMacAddress.setStatus(_A)
_UserSessionMIBNotificationPrefix_ObjectIdentity=ObjectIdentity
userSessionMIBNotificationPrefix=_UserSessionMIBNotificationPrefix_ObjectIdentity((1,3,6,1,4,1,8744,5,36,2))
_UserSessionMIBNotifications_ObjectIdentity=ObjectIdentity
userSessionMIBNotifications=_UserSessionMIBNotifications_ObjectIdentity((1,3,6,1,4,1,8744,5,36,2,0))
_ColubrisUserSessionMIBConformance_ObjectIdentity=ObjectIdentity
colubrisUserSessionMIBConformance=_ColubrisUserSessionMIBConformance_ObjectIdentity((1,3,6,1,4,1,8744,5,36,3))
_ColubrisUserSessionMIBCompliances_ObjectIdentity=ObjectIdentity
colubrisUserSessionMIBCompliances=_ColubrisUserSessionMIBCompliances_ObjectIdentity((1,3,6,1,4,1,8744,5,36,3,1))
_ColubrisUserSessionMIBGroups_ObjectIdentity=ObjectIdentity
colubrisUserSessionMIBGroups=_ColubrisUserSessionMIBGroups_ObjectIdentity((1,3,6,1,4,1,8744,5,36,3,2))
colubrisUserSessionInfoMIBGroup=ObjectGroup((1,3,6,1,4,1,8744,5,36,3,2,1))
colubrisUserSessionInfoMIBGroup.setObjects(*((_B,_H),(_B,_I),(_B,_J),(_B,_K)))
if mibBuilder.loadTexts:colubrisUserSessionInfoMIBGroup.setStatus(_A)
colubrisUserSessionStMIBGroup=ObjectGroup((1,3,6,1,4,1,8744,5,36,3,2,2))
colubrisUserSessionStMIBGroup.setObjects(*((_B,_L),(_B,_M),(_B,_N),(_B,_O),(_B,_P),(_B,_Q),(_B,_R),(_B,_S),(_B,_T),(_B,_U),(_B,_V),(_B,_W),(_B,_X),(_B,_Y),(_B,_Z),(_B,_a),(_B,_b),(_B,_c),(_B,_d),(_B,_e)))
if mibBuilder.loadTexts:colubrisUserSessionStMIBGroup.setStatus(_A)
colubrisUserSessionMIBCompliance=ModuleCompliance((1,3,6,1,4,1,8744,5,36,3,1,1))
colubrisUserSessionMIBCompliance.setObjects(*((_B,_f),(_B,_g)))
if mibBuilder.loadTexts:colubrisUserSessionMIBCompliance.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'colubrisUserSessionMIB':colubrisUserSessionMIB,'colubrisUserSessionMIBObjects':colubrisUserSessionMIBObjects,'coUserSessionInfoGroup':coUserSessionInfoGroup,_H:coUserSessACUserMaxCount,_I:coUserSessNonACUserMaxCount,_J:coUserSessACUserCount,_K:coUserSessNonACUserCount,'coUserSessionStGroup':coUserSessionStGroup,'coUserSessionTable':coUserSessionTable,'coUserSessionEntry':coUserSessionEntry,_F:coUserSessIndex,_L:coUserSessUserName,_M:coUserSessClientIpAddress,_N:coUserSessSessionDuration,_O:coUserSessIdleTime,_P:coUserSessMAPGroupName,_Q:coUserSessVSCName,_R:coUserSessSSID,_S:coUserSessVLAN,_T:coUserSessPHYType,_U:coUserSessAuthType,_V:coUserSessCalledStationID,_W:coUserSessCallingStationID,_X:coUserSessRADIUSServerProfileName,_Y:coUserSessRADIUSServerIpAddress,_Z:coUserSessBytesSent,_a:coUserSessBytesReceived,_b:coUserSessPacketsSent,_c:coUserSessPacketsReceived,_d:coUserSessEgressVLAN,_e:coUserSessMacAddress,'userSessionMIBNotificationPrefix':userSessionMIBNotificationPrefix,'userSessionMIBNotifications':userSessionMIBNotifications,'colubrisUserSessionMIBConformance':colubrisUserSessionMIBConformance,'colubrisUserSessionMIBCompliances':colubrisUserSessionMIBCompliances,'colubrisUserSessionMIBCompliance':colubrisUserSessionMIBCompliance,'colubrisUserSessionMIBGroups':colubrisUserSessionMIBGroups,_f:colubrisUserSessionInfoMIBGroup,_g:colubrisUserSessionStMIBGroup})