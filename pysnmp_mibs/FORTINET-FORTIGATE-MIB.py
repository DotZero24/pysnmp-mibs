...
DateAndTime, TextualConvention, PhysAddress, AutonomousType, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "PhysAddress", "AutonomousType", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgVpn2DialupPhase1Name=fgVpn2DialupPhase1Name, fgIpSessExp=fgIpSessExp, fg41FI=fg41FI, fgObsoleteAppServicesObjectGroup=fgObsoleteAppServicesObjectGroup, fgHaStatsGlobalChecksum=fgHaStatsGlobalChecksum, fgWanOptTrafficStatsTable=fgWanOptTrafficStatsTable, fwf60C=fwf60C, fgProcessorModuleEntry=fgProcessorModuleEntry, fgLastCallTxBytesOK=fgLastCallTxBytesOK, fgSwPortAllowedVlan=fgSwPortAllowedVlan, fgt140P=fgt140P, fgVpnDialupLifetime=fgVpnDialupLifetime, fgWanOptStatsEntry=fgWanOptStatsEntry, fgSIAdvSesEphemeralLimit=fgSIAdvSesEphemeralLimit, fgt94DPOE=fgt94DPOE, fgt3600E=fgt3600E, fgt600C=fgt600C, fgDNSProxyStatsUdpFtgRes=fgDNSProxyStatsUdpFtgRes, fgWcApVdom=fgWcApVdom, fgWcStaOnline=fgWcStaOnline, fgLicVersionDesc=fgLicVersionDesc, fgvm4v=fgvm4v, fgtVM64AZUREONDEMAND=fgtVM64AZUREONDEMAND, fgSlaProbeClientPktloss=fgSlaProbeClientPktloss, fgWcWlanSecurity=fgWcWlanSecurity, fgApIMAPUpTime=fgApIMAPUpTime, FgHaLBSchedule=FgHaLBSchedule, fgt140T=fgt140T, fgProcessorCount=fgProcessorCount, fgAppWanOpt=fgAppWanOpt, fgVpn2Tables=fgVpn2Tables, fgMIBCompliance=fgMIBCompliance, fgVdTpMgmtAddr=fgVdTpMgmtAddr, fdLteMtu=fdLteMtu, fgHaSystemMode=fgHaSystemMode, fgVpnSslStatsEntry=fgVpnSslStatsEntry, fgWfActiveXBlocked=fgWfActiveXBlocked, fgWanOptInfo=fgWanOptInfo, fgFwIppStatsBlockSize=fgFwIppStatsBlockSize, fgApPOP3SpamDetected=fgApPOP3SpamDetected, fgExplicitProxyObjectGroup=fgExplicitProxyObjectGroup, fgt2200E=fgt2200E, fgWcWtpSessionRadioTable=fgWcWtpSessionRadioTable, fgDhcpTrapType=fgDhcpTrapType, fgAdminEntry=fgAdminEntry, fgApPOP3StatsEntry=fgApPOP3StatsEntry, fgIpsCritSevDetections=fgIpsCritSevDetections, fgVpnTunEntVdom=fgVpnTunEntVdom, ffw4200F=ffw4200F, fgDhcpTrapObjects=fgDhcpTrapObjects, fgWcWtpSessionWtpByteTxCount=fgWcWtpSessionWtpByteTxCount, fgVWLHealthCheckLinkID=fgVWLHealthCheckLinkID, fgWcInfoName=fgWcInfoName, fgLicVersionUpdTime=fgLicVersionUpdTime, fgt300E=fgt300E, fgSysInfoAdvSessions=fgSysInfoAdvSessions, fgLicVersionUpdMethod=fgLicVersionUpdMethod, fgFwIppStatsRscUDP=fgFwIppStatsRscUDP, fgFwGtpRtStatsCDropped19=fgFwGtpRtStatsCDropped19, fgTrapVpnTunDown=fgTrapVpnTunDown, fgt3815D=fgt3815D, fgApSMTPStatsTable=fgApSMTPStatsTable, fgSw=fgSw, fgApSMTPUpTime=fgApSMTPUpTime, fgIntfBcCfgSentClassName=fgIntfBcCfgSentClassName, fgt92D=fgt92D, fgIntfVlanHbEntIfName=fgIntfVlanHbEntIfName, fgProcModMemCapacity=fgProcModMemCapacity, fgProcessorFnNP2=fgProcessorFnNP2, fgSgWbSysMemUsage=fgSgWbSysMemUsage, fgApFTPStatsTable=fgApFTPStatsTable, fgWebCacheInfo=fgWebCacheInfo, fgIntfBcGuaranteedBandwidth=fgIntfBcGuaranteedBandwidth, fgNPUNumber=fgNPUNumber, fgApIMAPStatsTable=fgApIMAPStatsTable, fgt300=fgt300, fgVpnTunTable=fgVpnTunTable, fgExplicitProxyArchMultiPart=fgExplicitProxyArchMultiPart, fgFwIppStatsInusePBAs=fgFwIppStatsInusePBAs, fgVpnTunEntRemGwyIp=fgVpnTunEntRemGwyIp, fgApSIPUpTime=fgApSIPUpTime, fgWcWlanStationCapacity=fgWcWlanStationCapacity, fgProcessorsObjectGroup=fgProcessorsObjectGroup, fgWcWtpSessionWtpUpTime=fgWcWtpSessionWtpUpTime, fgIntfVlanHbEntSerial=fgIntfVlanHbEntSerial, fgIntfVrrpCount=fgIntfVrrpCount, fgt3140B=fgt3140B, fgVpnTunEntry=fgVpnTunEntry, fgAvOversizedDetected=fgAvOversizedDetected, fgNPUTables=fgNPUTables, fgSIAdvSesNoListenerCount=fgSIAdvSesNoListenerCount, fgWcWtpProfileDataChannelDtlsPolicy=fgWcWtpProfileDataChannelDtlsPolicy, fgt101E=fgt101E, fgTrapPerCpuHigh=fgTrapPerCpuHigh, fgProcessorSysUsage=fgProcessorSysUsage, fgIpsSignatureDetections=fgIpsSignatureDetections, fgLinkMonitorBandwidthBi=fgLinkMonitorBandwidthBi, fgSysVersion=fgSysVersion, fgSignalInfoTable=fgSignalInfoTable, fgWanOptWanOutTraffic=fgWanOptWanOutTraffic, fg60EC=fg60EC, fgApIMAPStatsEntry=fgApIMAPStatsEntry, fgt800F=fgt800F, fnFortiGateMib=fnFortiGateMib, fgDatausageMdmEntIndex=fgDatausageMdmEntIndex, fgAppFnbamStatsInfo=fgAppFnbamStatsInfo, fgWcWtpProfilePlatform=fgWcWtpProfilePlatform, fgFwAuthUserInfoVdom=fgFwAuthUserInfoVdom, fgNPUGroup=fgNPUGroup, fgVpn2DialupTable=fgVpn2DialupTable, fgAdminTables=fgAdminTables, fdLteIpv6PriDns=fdLteIpv6PriDns, fw41FI=fw41FI, fgWcWtpSessionWtpMemoryUsage=fgWcWtpSessionWtpMemoryUsage, fgFwIppStatsExpiringPBAs=fgFwIppStatsExpiringPBAs, fwf92D=fwf92D, fgVpn2TunSelSrcEndIp=fgVpn2TunSelSrcEndIp, fgExplicitProxyScanStatsTable=fgExplicitProxyScanStatsTable, fgAvFTPVirusDetected=fgAvFTPVirusDetected, fgUsbModemInfoObjects=fgUsbModemInfoObjects, fgLicVersionEntry=fgLicVersionEntry, fgDisks=fgDisks, fgIntfBcCfgIfInBandwidth=fgIntfBcCfgIfInBandwidth, fgFwAuthIpv6UserAddr=fgFwAuthIpv6UserAddr, fgAppProxyNNTP=fgAppProxyNNTP, fgtVM64VMX=fgtVM64VMX, fgApFTPMaxConnections=fgApFTPMaxConnections, fgSIAdvSesClashCount=fgSIAdvSesClashCount, fgWcdmaRssi=fgWcdmaRssi, fgAppVoIPConn=fgAppVoIPConn, fgIntfBcCfgSproEntry=fgIntfBcCfgSproEntry, fgIntfBcQTable=fgIntfBcQTable, fgVWLHealthCheckLinkUsedBandwidthBi=fgVWLHealthCheckLinkUsedBandwidthBi, fgFwGtpRtStatsCDropped11=fgFwGtpRtStatsCDropped11, fgVpnTunEntSelectorDstEndIp=fgVpnTunEntSelectorDstEndIp, fgt1000D=fgt1000D, fgSystemObjectGroup=fgSystemObjectGroup, fgWcWtpConfigWtpAdmin=fgWcWtpConfigWtpAdmin, fgDNSProxyStatsUdpTo=fgDNSProxyStatsUdpTo, fgt81F=fgt81F, fgVpnDialupEntry=fgVpnDialupEntry, fgLinkMonitorOutofSeq=fgLinkMonitorOutofSeq, PYSNMP_MODULE_ID=fnFortiGateMib, fgWcWtpSessionRadioBaseBssid=fgWcWtpSessionRadioBaseBssid, fgMdmDetected=fgMdmDetected, fgFcSwVdom=fgFcSwVdom, fgt3980E=fgt3980E, fgSwDeviceIp=fgSwDeviceIp, fgSysNpuSesRate1=fgSysNpuSesRate1, fgWanOptReductionRate=fgWanOptReductionRate, fgt60M=fgt60M, fgTrapWcApUp=fgTrapWcApUp, fgIntfBcCfgSentMaxBandwidth=fgIntfBcCfgSentMaxBandwidth, fw502R=fw502R, fgDeviceCreated=fgDeviceCreated, fgMdmEsn=fgMdmEsn, fgWcWtpSessionRadioOperatingPower=fgWcWtpSessionRadioOperatingPower, fgIntfBcQPDrops=fgIntfBcQPDrops, fgUsbModemSimId=fgUsbModemSimId, fgVWLHealthCheckLinkUsedBandwidthIn=fgVWLHealthCheckLinkUsedBandwidthIn, fgAvVirusBlocked=fgAvVirusBlocked, fgNPUSessionCount=fgNPUSessionCount, fgFwAddrDynEmsAddresses=fgFwAddrDynEmsAddresses, fgt1800F=fgt1800F, fgVdEnabled=fgVdEnabled, fgIntfBcCfgSpolEntry=fgIntfBcCfgSpolEntry, fgVpnTunEntOutOctets=fgVpnTunEntOutOctets, fgWfHTTPBlocked=fgWfHTTPBlocked, FgHaState=FgHaState, fgFwGtpRtStatsBDroppedMalMsg=fgFwGtpRtStatsBDroppedMalMsg, fgMgmtTrapObjects=fgMgmtTrapObjects, fgWcWtpProfileRadioRadioId=fgWcWtpProfileRadioRadioId, fgUsbportVersion=fgUsbportVersion, fgFwGtpRtStatsCDropped9=fgFwGtpRtStatsCDropped9, fgFwUserVdom=fgFwUserVdom, fgSwMemory=fgSwMemory, fgFwGtpRtStatsDDroppedMsgRateLimit=fgFwGtpRtStatsDDroppedMsgRateLimit, fgSwitchDeviceObjectGroup=fgSwitchDeviceObjectGroup, fgWfAppletBlocked=fgWfAppletBlocked, fgVWLHealthCheckLinkState=fgVWLHealthCheckLinkState, fgAppP2PProtoEntry=fgAppP2PProtoEntry, fgInternalModemDatausageInfoGroup=fgInternalModemDatausageInfoGroup, fgVpn2TunPhase1Name=fgVpn2TunPhase1Name, fgSwDevicePlatform=fgSwDevicePlatform, fgSlaProbeClientPktlossSD=fgSlaProbeClientPktlossSD, fgMdmFsn=fgMdmFsn, fgt400=fgt400, fgIntfBcCfgSproType=fgIntfBcCfgSproType, fgLog=fgLog, fgSIAdvMemEnterKerConsThrsh=fgSIAdvMemEnterKerConsThrsh, fgFwGtpRtStatsCDropped21=fgFwGtpRtStatsCDropped21, fgApSMTPMemUsage=fgApSMTPMemUsage, fgAppSuIndex=fgAppSuIndex, fgProcessors=fgProcessors, fgVdEntSesRate=fgVdEntSesRate, fgWcWtpSessionWtpId=fgWcWtpSessionWtpId, fgMdmInfoEntry=fgMdmInfoEntry, fgLinkMonitorNumber=fgLinkMonitorNumber, fgSoftware=fgSoftware, fgtVM64FGCAWS=fgtVM64FGCAWS, fgRxBytesOK=fgRxBytesOK, fgIntfBcInCurrentBandwidth=fgIntfBcInCurrentBandwidth, fgVpnTunEntTimeout=fgVpnTunEntTimeout, fwf80F=fwf80F, fgWcWlanEncryption=fgWcWlanEncryption, fgHwSensors=fgHwSensors, fgMdmLacTac=fgMdmLacTac, fgWebCacheRequests=fgWebCacheRequests, fgt4200F=fgt4200F, fdLteProfType=fdLteProfType, fgt620B=fgt620B, fgt7000E=fgt7000E, FgWcWtpRadioId=FgWcWtpRadioId, fgVpnDialupTimeout=fgVpnDialupTimeout, fgMdmModel=fgMdmModel, fgProcessorUserUsage=fgProcessorUserUsage, fgHaAutoSync=fgHaAutoSync, fgDpdkEngTable=fgDpdkEngTable, fgt30D=fgt30D, fgFwGtpRtStatsDDroppedMsgFilter=fgFwGtpRtStatsDDroppedMsgFilter, fgWcWtpConfigRadioApScan=fgWcWtpConfigRadioApScan, fgLicContractEntry=fgLicContractEntry, fgFwAddrDynEmsTable=fgFwAddrDynEmsTable, fgIntfVlanTable=fgIntfVlanTable, fgNPU=fgNPU, fgWcInfoStationCount=fgWcInfoStationCount, fgSysNpuSes6Rate10=fgSysNpuSes6Rate10, fgFgWfHTTPLogged=fgFgWfHTTPLogged, fgt111C=fgt111C, fgWcApSerial=fgWcApSerial, fgVWLHealthCheckLinkUsedBandwidthOut=fgVWLHealthCheckLinkUsedBandwidthOut, fgt40C=fgt40C, fgTrapAvEnterConserve=fgTrapAvEnterConserve, fosVM64HV=fosVM64HV, fgMdmEntIndex=fgMdmEntIndex, fgAvNNTPVirusBlocked=fgAvNNTPVirusBlocked, fgWcStaEntry=fgWcStaEntry, fgWcWtpSessionWtpByteRxCount=fgWcWtpSessionWtpByteRxCount, fgDNSProxyStatsUdpRes=fgDNSProxyStatsUdpRes, fgWanOptDisk=fgWanOptDisk, fgProcessorPktTxDroppedCount=fgProcessorPktTxDroppedCount, fgHaTrapObjects=fgHaTrapObjects, fgWcWtpProfileRadioProfileName=fgWcWtpProfileRadioProfileName, fgt200A=fgt200A, fgFwPolLastUsed=fgFwPolLastUsed, fgSwPortPOEPower=fgSwPortPOEPower, fgFwGtpRtStatsCDropped10=fgFwGtpRtStatsCDropped10, fgSystem=fgSystem, fgVdEntOpMode=fgVdEntOpMode, fgAppVoIPStatsEntry=fgAppVoIPStatsEntry, fgUsbportProduct=fgUsbportProduct, fgIntfBcEntry=fgIntfBcEntry, fgt5001E1=fgt5001E1, fgVWLHealthCheckLinkBandwidthIn=fgVWLHealthCheckLinkBandwidthIn)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgFazTrapType=fgFazTrapType, fgWfHTTPSBlocked=fgWfHTTPSBlocked, fgTrapIpsAnomaly=fgTrapIpsAnomaly, fgLteRsrq=fgLteRsrq, fgt3600C=fgt3600C, fgFwIppStatsTable=fgFwIppStatsTable, fgApPOP3Connections=fgApPOP3Connections, fgApNNTPMaxConnections=fgApNNTPMaxConnections, fgt81E=fgt81E, fgt3500F=fgt3500F, fgFwAuthUserInfoTable=fgFwAuthUserInfoTable, fgWcWtpConfigRadioEnable=fgWcWtpConfigRadioEnable, fgSwPortNum=fgSwPortNum, fgApSIPStatsTable=fgApSIPStatsTable, fgSgWbSysCpuUsage=fgSgWbSysCpuUsage, fgFwGtpStatsTunnelV0=fgFwGtpStatsTunnelV0, fgMdmRevision=fgMdmRevision, fgIntrusionPrevtObjectGroup=fgIntrusionPrevtObjectGroup, fgSlaProbeClientOutofSeqDS=fgSlaProbeClientOutofSeqDS, fgVpn=fgVpn, fgApPOP3StatsTable=fgApPOP3StatsTable, fgIntfTables=fgIntfTables, fosVM64XEN=fosVM64XEN, fgFwGtpRtStatsBPkts=fgFwGtpRtStatsBPkts, fgVdEntSesCount=fgVdEntSesCount, fgvmxx=fgvmxx, fgSIAdvMemLeaveProxyConsThrsh=fgSIAdvMemLeaveProxyConsThrsh, ffvmbb=ffvmbb, fgLocalTime=fgLocalTime, fgFwTrapPoolUtilization=fgFwTrapPoolUtilization, fgv16v=fgv16v, fgProcessorModuleTypes=fgProcessorModuleTypes, fgIntfVrrpEntIfName=fgIntfVrrpEntIfName, fgNPUTable=fgNPUTable, fgt30DPOE=fgt30DPOE, fgt500E=fgt500E, fgLogDeviceSentCount=fgLogDeviceSentCount, fgHwSensorEntIndex=fgHwSensorEntIndex, fgHwSensorEntValue=fgHwSensorEntValue, fgSlaProbeClientMaxJitterDS=fgSlaProbeClientMaxJitterDS, fgAvMAPIVirusBlocked=fgAvMAPIVirusBlocked, fgIpSessFromAddr=fgIpSessFromAddr, fgAppP2PConnBlocked=fgAppP2PConnBlocked, fgIntfBcCfgIfEgressSProfile=fgIntfBcCfgIfEgressSProfile, fgt80FPOE=fgt80FPOE, fgVWLHealthCheckLink=fgVWLHealthCheckLink, fgVpn2DialupIndex=fgVpn2DialupIndex, fgUsbModemSignalStrength=fgUsbModemSignalStrength, fgFwIppStatsFlags=fgFwIppStatsFlags, fgWanOptWANBytesIn=fgWanOptWANBytesIn, fgAvMAPIVirusDetected=fgAvMAPIVirusDetected, fdLteLinkProto=fdLteLinkProto, fgFwPolInfo=fgFwPolInfo, fgIpSessNumber=fgIpSessNumber, fgt60E=fgt60E, fdLteIpv4NetMask=fdLteIpv4NetMask, fgFwGtpStatsImsi=fgFwGtpStatsImsi, fgt4400F=fgt4400F, fgAvStatsEntry=fgAvStatsEntry, fgHaStatsEntry=fgHaStatsEntry, fgLogDeviceCachedCount=fgLogDeviceCachedCount, fgt50A=fgt50A, fgHaPriority=fgHaPriority, fgManIfMask=fgManIfMask, fgWebfilterInfo=fgWebfilterInfo, FgP2PProto=FgP2PProto, fgt100F=fgt100F, fgVpn2TunSelProto=fgVpn2TunSelProto, fgUsbModemSimState=fgUsbModemSimState, fgt5001A=fgt5001A, fgUsbModemStatus=fgUsbModemStatus, fgVpnDialupSrcBegin=fgVpnDialupSrcBegin, fgSysVersionAvEt=fgSysVersionAvEt, fgServerLoadBalanceTrapObjects=fgServerLoadBalanceTrapObjects, fgWebCacheDiskStatsEntry=fgWebCacheDiskStatsEntry, fgIp6SessStatsEntry=fgIp6SessStatsEntry, fgTxPacksDrop=fgTxPacksDrop, fsw5203B=fsw5203B, fgIntfBcCfgSproClassNum=fgIntfBcCfgSproClassNum, fgVpnSslStatsMaxTunnels=fgVpnSslStatsMaxTunnels, fgSysNeedLogPartitionScan=fgSysNeedLogPartitionScan, fgWcStaBandwidthRx=fgWcStaBandwidthRx, fgDNSProxyStatsInfo=fgDNSProxyStatsInfo, fgt80C=fgt80C, fgNPUInfo=fgNPUInfo, fgSysNpuSesRate60=fgSysNpuSesRate60, fgIntfBcCfgSpolDstaddr=fgIntfBcCfgSpolDstaddr, fgDNSProxyObjectGroup=fgDNSProxyObjectGroup, fgLinkMonitorTable=fgLinkMonitorTable, fgIntfVrrpEntState=fgIntfVrrpEntState, fgFwGtpRtStatsDDroppedNoState=fgFwGtpRtStatsDDroppedNoState, fdLteIpv6GwPrefLen=fdLteIpv6GwPrefLen, fgIpSessIndex=fgIpSessIndex, fgVpnTunEntSelectorDstPort=fgVpnTunEntSelectorDstPort, fgProcessorTypes=fgProcessorTypes, fgSwPortName=fgSwPortName, fgSgWbMaster=fgSgWbMaster, fgVWLHealthCheckLinkPacketLoss=fgVWLHealthCheckLinkPacketLoss, fwf30DPOE=fwf30DPOE, fwf81F=fwf81F, fgHaStatsPktCount=fgHaStatsPktCount, fgCdmaEcio=fgCdmaEcio, fgWcStaRadioType=fgWcStaRadioType, fgUsbportTable=fgUsbportTable, fgWcInfoWtpManaged=fgWcInfoWtpManaged, fgVdEntName=fgVdEntName, fwf60E=fwf60E, fgt3800D=fgt3800D, fgDataMemUsage=fgDataMemUsage, fgSysVersionAv=fgSysVersionAv, fgProcModIntegratedNPU=fgProcModIntegratedNPU, fgIntfBcQEntry=fgIntfBcQEntry, fgFwPolByteCountHc=fgFwPolByteCountHc, fgSgWbBaseLink=fgSgWbBaseLink, fgVWLHealthCheckLinkEntry=fgVWLHealthCheckLinkEntry, fgt1000AFA2=fgt1000AFA2, fgIntfBcCfgIfEntry=fgIntfBcCfgIfEntry, fgApHTTPReqProcessed=fgApHTTPReqProcessed, fgAppIMStatsEntry=fgAppIMStatsEntry, fgFwAuthIpv6UserVdom=fgFwAuthIpv6UserVdom, fgWcStaUser=fgWcStaUser, fgSgWbSysVersion=fgSgWbSysVersion, fgt301E=fgt301E, fgWcStaVci=fgWcStaVci, fgChassisTrapObjects=fgChassisTrapObjects, fgIpsTrapObjects=fgIpsTrapObjects, fgAppVoIPCallBlocked=fgAppVoIPCallBlocked, fgSysSes6Count=fgSysSes6Count, fgIntfBcInAllocatedBandwidth=fgIntfBcInAllocatedBandwidth, fgt3600=fgt3600, fgFcObjectGroup=fgFcObjectGroup, fgvm01=fgvm01, fgIntfBcCfgSpolSvr=fgIntfBcCfgSpolSvr, fgVpnDialupTable=fgVpnDialupTable, fgt500D=fgt500D, fgFwGtpStatsTunnelLimiter=fgFwGtpStatsTunnelLimiter, fgGpsMdmEntIndex=fgGpsMdmEntIndex, fgHaStatsMemUsage=fgHaStatsMemUsage, fgFgWfHTTPSAllowed=fgFgWfHTTPSAllowed, fgFwGtpRtStatsCDropped4=fgFwGtpRtStatsCDropped4, fgt300A=fgt300A, fgWcWtpConfigRadioAutoTxPowerLow=fgWcWtpConfigRadioAutoTxPowerLow, fgChassis=fgChassis, fgSlaProbeClientMaxJitter=fgSlaProbeClientMaxJitter, fgAppProxyIM=fgAppProxyIM, fgExplicitProxyRequests=fgExplicitProxyRequests, fdLtePdpType=fdLtePdpType, fgVpn2TunRemGwyIpType=fgVpn2TunRemGwyIpType, fgMibConformance=fgMibConformance, fdLteProfName=fdLteProfName, fgIpSessToPort=fgIpSessToPort, fwf60=fwf60, fgSigMdmEntIndex=fgSigMdmEntIndex, fgWcWtpProfileRadioTxPowerLevel=fgWcWtpProfileRadioTxPowerLevel, fgApPOP3MaxConnections=fgApPOP3MaxConnections, fgHdrEcio=fgHdrEcio, fgIntfVrrpEntGrpId=fgIntfVrrpEntGrpId, fgHaGroupName=fgHaGroupName, fgWcWtpProfileRadioFrequencyHandoff=fgWcWtpProfileRadioFrequencyHandoff, fgSlaProbeClientAvgJitter=fgSlaProbeClientAvgJitter, fgSysSes6Rate10=fgSysSes6Rate10, fgFwGtpRtStatsCDropped8=fgFwGtpRtStatsCDropped8, fgProcessorFnNP6XLITE=fgProcessorFnNP6XLITE, fgFgWfHTTPSOverridden=fgFgWfHTTPSOverridden, fgFcTrapObjects=fgFcTrapObjects, fgTrapPrefix=fgTrapPrefix, fgUsbportVendId=fgUsbportVendId, fgWcWtpProfileCountryString=fgWcWtpProfileCountryString, fgWcWlanEntry=fgWcWlanEntry, fgFwAuthIpv6UserTable=fgFwAuthIpv6UserTable, fgDhcpTable=fgDhcpTable, fgIpsHighSevDetections=fgIpsHighSevDetections, fgIntfBcCfgSproID=fgIntfBcCfgSproID, fgSwPortSwitchId=fgSwPortSwitchId, fgFortiGuardStatsTable=fgFortiGuardStatsTable, fgFgWfHTTPSLogged=fgFgWfHTTPSLogged, fosVM64KVM=fosVM64KVM, fgr90D=fgr90D, fgExplicitProxyFilteredActiveX=fgExplicitProxyFilteredActiveX, fgWcWtpSessionWtpDaemonUpTime=fgWcWtpSessionWtpDaemonUpTime, fgt200D=fgt200D, fgt1500D=fgt1500D, fgWanOptHistoryStatsTable=fgWanOptHistoryStatsTable, fgTrapHaMemberUp=fgTrapHaMemberUp, fgFwHsPolPktCount=fgFwHsPolPktCount, fgMemCacheHits=fgMemCacheHits, fwf61E=fwf61E, fgLicContractDesc=fgLicContractDesc, fgvmsb=fgvmsb, fgr30D=fgr30D, fgWebCacheDiskHits=fgWebCacheDiskHits, fgIntfObjectGroup=fgIntfObjectGroup, fgLinkMonitorID=fgLinkMonitorID, fgLicContractExpiry=fgLicContractExpiry, fgvulv=fgvulv, fgProcessorUsage5sec=fgProcessorUsage5sec, fgFwGtpRtStatsCDropped13=fgFwGtpRtStatsCDropped13, fgTrapAvBypass=fgTrapAvBypass, fgSgWbChassisID=fgSgWbChassisID, fgMdmRssi=fgMdmRssi, fgAppFnbamStatsTotalLdapFails=fgAppFnbamStatsTotalLdapFails, ffw4400F=ffw4400F, fgWcStaEncrypt=fgWcStaEncrypt, fgIntfVlanPhyName=fgIntfVlanPhyName, fgIntfBcCfgSproDefaultClassId=fgIntfBcCfgSproDefaultClassId, fgTraps=fgTraps, fgWanOptWANBytesOut=fgWanOptWANBytesOut, fgt60EV=fgt60EV, fgTrapIpsSignature=fgTrapIpsSignature, fgMdmActState=fgMdmActState, fgVpnTunEntSelectorProto=fgVpnTunEntSelectorProto, fgWanOptDiskLimit=fgWanOptDiskLimit, fdLteProfId=fdLteProfId, fgApSIPOtherReq=fgApSIPOtherReq, fgtARM64XEN=fgtARM64XEN, fgVpnDialupVdom=fgVpnDialupVdom, fgSwPortSwitchPlatform=fgSwPortSwitchPlatform, fgProcessorXlr=fgProcessorXlr, fgtARM64AZURE=fgtARM64AZURE, fgVpnTunnelUpCount=fgVpnTunnelUpCount, fgConfigSerial=fgConfigSerial, fgExplicitProxyArchSize=fgExplicitProxyArchSize, fgMdmCarrierAbbr=fgMdmCarrierAbbr, fgApIMAPMemUsage=fgApIMAPMemUsage, fgSysDiskUsage=fgSysDiskUsage, FgWcWtpRadioChannelNumber=FgWcWtpRadioChannelNumber, fgSlaProbeClientNumber=fgSlaProbeClientNumber, fgFwGtpRtStatsCDropped5=fgFwGtpRtStatsCDropped5, fgVpn2DialupLifetime=fgVpn2DialupLifetime, fgSysSesRate10=fgSysSesRate10, fgtVM64AWS=fgtVM64AWS, fgUsbportSerial=fgUsbportSerial, fgProcessorPktRxCount=fgProcessorPktRxCount, fgExplicitProxyMemUsage=fgExplicitProxyMemUsage, fgFwIppTrapPoolProto=fgFwIppTrapPoolProto, fgProcessorFnNP6LITE=fgProcessorFnNP6LITE, fwf41F=fwf41F, fgFwGtpRtStatsCDropped12=fgFwGtpRtStatsCDropped12, fgWcApName=fgWcApName, fgWanOptLanOutTraffic=fgWanOptLanOutTraffic, fgIpsInfoSevDetections=fgIpsInfoSevDetections, fgAntivirusObjectGroup=fgAntivirusObjectGroup, fgVpn2TunSelSrcBeginIpType=fgVpn2TunSelSrcBeginIpType, fgAvPOP3VirusBlocked=fgAvPOP3VirusBlocked, fgVWLHealthCheckLinkBandwidthOut=fgVWLHealthCheckLinkBandwidthOut, fgFwGtpRtStatsCDropped15=fgFwGtpRtStatsCDropped15, fgDhcpEntry=fgDhcpEntry, fgSimCountry=fgSimCountry, FgSessProto=FgSessProto, fgApSIPCallHandling=fgApSIPCallHandling, fdLteSessConnStat=fdLteSessConnStat, fgt200=fgt200, fgLinkMonitorPacketLoss=fgLinkMonitorPacketLoss, fgWcWtpSessionWtpSessionUpTime=fgWcWtpSessionWtpSessionUpTime)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgFwHsPolLastUsed=fgFwHsPolLastUsed, fgt300C=fgt300C, fgDataCpuUsage=fgDataCpuUsage, fgDNSProxyStatsUdpReq=fgDNSProxyStatsUdpReq, fgt5001C=fgt5001C, fgSysNpuSesRate30=fgSysNpuSesRate30, fgSysSes6Rate1=fgSysSes6Rate1, fgFwGtpStats=fgFwGtpStats, fgFwGtpStatsIeRemovePolicies=fgFwGtpStatsIeRemovePolicies, fgt98DPOE=fgt98DPOE, fgVWLHealthCheckLinkGroup=fgVWLHealthCheckLinkGroup, fgt621B=fgt621B, fgFmTrapIfChange=fgFmTrapIfChange, fgExplicitProxyStatsTable=fgExplicitProxyStatsTable, fgExplicitProxyBlockedURLs=fgExplicitProxyBlockedURLs, fgFwGtpRtStatsCDropped3=fgFwGtpRtStatsCDropped3, fgApNNTPStatsEntry=fgApNNTPStatsEntry, fgtVM64XEN=fgtVM64XEN, fgHwSensorCount=fgHwSensorCount, fgFwIppStatsStartClientIP=fgFwIppStatsStartClientIP, fgLinkMonitorPacketSend=fgLinkMonitorPacketSend, fgt90DPOE=fgt90DPOE, fgt70F=fgt70F, fgFmTrapDeployComplete=fgFmTrapDeployComplete, fgApSIPMemUsage=fgApSIPMemUsage, fdLteIfName=fdLteIfName, fgVpn2TunEntry=fgVpn2TunEntry, fgt90D=fgt90D, fgSysNpuSes6Count=fgSysNpuSes6Count, fgIpSessStatsEntry=fgIpSessStatsEntry, fgApIMMemUsage=fgApIMMemUsage, fgExplicitProxyArchEncrypted=fgExplicitProxyArchEncrypted, fgWcStaRadioId=fgWcStaRadioId, fgSIAdvSesEphemeralCount=fgSIAdvSesEphemeralCount, fgt80D=fgt80D, fgHdrSinr=fgHdrSinr, fgt7000F=fgt7000F, fgHwSensorTable=fgHwSensorTable, FgWcCountryString=FgWcCountryString, fgWcWtpSessionEntry=fgWcWtpSessionEntry, fgConfigLastChangeTime=fgConfigLastChangeTime, fgFwGtpRtStatsCDropped23=fgFwGtpRtStatsCDropped23, fgWcStaWlan=fgWcStaWlan, fgExplicitProxyScriptStatsEntry=fgExplicitProxyScriptStatsEntry, fgWcWtpConfigWtpProfile=fgWcWtpConfigWtpProfile, fgWanOptHistPeriod=fgWanOptHistPeriod, fgTrapFcSwUp=fgTrapFcSwUp, fgApNNTPStatsTable=fgApNNTPStatsTable, fgt3600A=fgt3600A, fgDhcpInfo=fgDhcpInfo, fgIntfBcMaxBandwidth=fgIntfBcMaxBandwidth, fgFwGtpRtStatsCDropped6=fgFwGtpRtStatsCDropped6, fgAppVoIPStatsTable=fgAppVoIPStatsTable, fgSysNpuSesRate10=fgSysNpuSesRate10, fgLicContracts=fgLicContracts, fgMemCacheUsage=fgMemCacheUsage, fgFwIppStatsTotalSessions=fgFwIppStatsTotalSessions, fgExplicitProxyFilteredApplets=fgExplicitProxyFilteredApplets, fgDeviceMacAddress=fgDeviceMacAddress, fgWcWtpConfigTable=fgWcWtpConfigTable, fgMdmImei=fgMdmImei, fgSimImsi=fgSimImsi, fgt5001E=fgt5001E, fgInternalLTEModemsInfo=fgInternalLTEModemsInfo, fgMemCacheMisses=fgMemCacheMisses, fgt110C=fgt110C, fgIpsIntrusionsBlocked=fgIpsIntrusionsBlocked, fgWcWtpConfigWtpLocation=fgWcWtpConfigWtpLocation, fgVpn2DialupGatewayType=fgVpn2DialupGatewayType, fgProcessorTable=fgProcessorTable, fgLinkMonitorName=fgLinkMonitorName, fwf60A=fwf60A, fgVdTpEntry=fgVdTpEntry, fgt200E=fgt200E, fgWcWtpProfileRadioAutoTxPowerLow=fgWcWtpProfileRadioAutoTxPowerLow, fgSIAdvMemCacheInactive=fgSIAdvMemCacheInactive, fgWanOptDiskFailure=fgWanOptDiskFailure, fgLinkMonitorProtocol=fgLinkMonitorProtocol, fgIpsLowSevDetections=fgIpsLowSevDetections, fgSgWbSysUpTime=fgSgWbSysUpTime, fgWcWtpProfileRadioMode=fgWcWtpProfileRadioMode, fgDpdkEngToCpu=fgDpdkEngToCpu, fgt2500E=fgt2500E, fgSwPortInfo=fgSwPortInfo, fgApHTTPUpTime=fgApHTTPUpTime, fgWcStaHost=fgWcStaHost, fgVpnTunEntPhase2Index=fgVpnTunEntPhase2Index, fdLteIpv4Addr=fdLteIpv4Addr, fgProcModOther=fgProcModOther, fgt100D=fgt100D, fgFortiGuardStatsEntry=fgFortiGuardStatsEntry, fgLogDeviceFailedCount=fgLogDeviceFailedCount, fgvm1v=fgvm1v, fgAvTrapObjects=fgAvTrapObjects, fgvm08=fgvm08, fgAvSMBVirusBlocked=fgAvSMBVirusBlocked, fgWcWtpSessionWtpBaseMacAddress=fgWcWtpSessionWtpBaseMacAddress, fgtvmx=fgtvmx, fgNPUEntry=fgNPUEntry, fgt500=fgt500, fgSwPortSwitchSerialNum=fgSwPortSwitchSerialNum, fgByteCacheRAMUsage=fgByteCacheRAMUsage, FgWcWlanEncryptionType=FgWcWlanEncryptionType, fgFwIppStatsOtherSessions=fgFwIppStatsOtherSessions, fgWebCacheDiskFailure=fgWebCacheDiskFailure, fgDpdkEngEntIndex=fgDpdkEngEntIndex, fgt2000E=fgt2000E, fgIntfEntMeaDownBandwidth=fgIntfEntMeaDownBandwidth, fgvm02=fgvm02, fgFwUserState=fgFwUserState, fgWanOptStatsTable=fgWanOptStatsTable, fgWcInfoLocation=fgWcInfoLocation, fgWcStaTable=fgWcStaTable, fgIntfBcCfgSentGuaranteedBandwidth=fgIntfBcCfgSentGuaranteedBandwidth, fgSysRebootReason=fgSysRebootReason, fgFgWfHTTPOverridden=fgFgWfHTTPOverridden, fgVpn2DialupGateway=fgVpn2DialupGateway, fgInternalModemGpsInfoGroup=fgInternalModemGpsInfoGroup, fgIntfVlanHbTable=fgIntfVlanHbTable, fgt400F=fgt400F, fgApHTTPMemUsage=fgApHTTPMemUsage, fgProcModMemUsage=fgProcModMemUsage, fgt3401E=fgt3401E, fgVpnSslStatsLoginUsers=fgVpnSslStatsLoginUsers, fgInternalModemSessInfoGroup=fgInternalModemSessInfoGroup, fgtVM64ALIONDEMAND=fgtVM64ALIONDEMAND, FgSgWorkerBladeState=FgSgWorkerBladeState, fgVpn2TunTable=fgVpn2TunTable, fgVpn2TunSelDstBeginIp=fgVpn2TunSelDstBeginIp, fgFwPolTables=fgFwPolTables, fgWcWtpProfileRadioChannelBonding=fgWcWtpProfileRadioChannelBonding, fgExplicitProxyScanStatsEntry=fgExplicitProxyScanStatsEntry, fgVpnSslStatsTable=fgVpnSslStatsTable, fgt81FPOE=fgt81FPOE, fgAppP2P=fgAppP2P, fgt60F=fgt60F, fdLteNetType=fdLteNetType, fgWanOptDiskMisses=fgWanOptDiskMisses, fgHaOverride=fgHaOverride, fgVpn2DialupSrcBeginType=fgVpn2DialupSrcBeginType, fgFwAuthIpv6UserEntry=fgFwAuthIpv6UserEntry, fgFwUserName=fgFwUserName, fgt5001FA2=fgt5001FA2, fgWcInfoWtpCapacity=fgWcInfoWtpCapacity, fgLogGroup=fgLogGroup, fgt1000A=fgt1000A, fgHighAvailability=fgHighAvailability, fgSlaProbeClientTable=fgSlaProbeClientTable, fgWcWtpProfileRadioDtimPeriod=fgWcWtpProfileRadioDtimPeriod, fgSwDeviceId=fgSwDeviceId, fgFwIppTables=fgFwIppTables, fgWebCacheBypass=fgWebCacheBypass, fgSlaProbeClientAvgLatencySD=fgSlaProbeClientAvgLatencySD, fgLinkMonitorState=fgLinkMonitorState, fgAppWebCache=fgAppWebCache, fgSlaProbeClientAvgLatency=fgSlaProbeClientAvgLatency, fgLteSessEntIndex=fgLteSessEntIndex, fgAppP2PStatsEntry=fgAppP2PStatsEntry, fgWcWtpSessionWtpProfileName=fgWcWtpSessionWtpProfileName, fgSimState=fgSimState, fgtARM64KVM=fgtARM64KVM, fgAppFnbamStatsTotalAuthReqs=fgAppFnbamStatsTotalAuthReqs, fgAdminTable=fgAdminTable, fgHaTrapMemberSerial=fgHaTrapMemberSerial, fgObsolteMIBCompliance=fgObsolteMIBCompliance, fgt20C=fgt20C, fgTxBytesOK=fgTxBytesOK, fgApPOP3UpTime=fgApPOP3UpTime, fgHaStatsSyncDatimeSucc=fgHaStatsSyncDatimeSucc, fw81FP=fw81FP, fgSignalInfoEntry=fgSignalInfoEntry, fgLogDeviceEntry=fgLogDeviceEntry, fgUsbports=fgUsbports, fgFwGtpRtStatsBDroppedSanity=fgFwGtpRtStatsBDroppedSanity, fgt501E=fgt501E, fgSysLowMemUsage=fgSysLowMemUsage, fgFwGtpStatsApnShaper=fgFwGtpStatsApnShaper, fgTrapPoolUsage=fgTrapPoolUsage, fgAdminOptions=fgAdminOptions, fgProcModType=fgProcModType, fgHaGroupId=fgHaGroupId, fgWcWtpSessionRadioStationCount=fgWcWtpSessionRadioStationCount, fgFwIppStatsStartIp=fgFwIppStatsStartIp, FgHaMode=FgHaMode, fgFwAddrDynEmsName=fgFwAddrDynEmsName, fgExplicitProxyFilterStatsTable=fgExplicitProxyFilterStatsTable, fgIntfBcQPackets=fgIntfBcQPackets, fgSysNpuSesCount=fgSysNpuSesCount, fgWcWtpProfileRadioApScan=fgWcWtpProfileRadioApScan, fgProcModIntegrated=fgProcModIntegrated, fgHdrRssi=fgHdrRssi, FgWcWtpChannelWidthType=FgWcWtpChannelWidthType, fgt60=fgt60, fgApplications=fgApplications, fgAppFnbamStatsTotalEagainErrs=fgAppFnbamStatsTotalEagainErrs, fgProcessorsTrapObjects=fgProcessorsTrapObjects, fgt30E=fgt30E, fgIntfEntry=fgIntfEntry, fgSwPortEntry=fgSwPortEntry, fgLastCallRxBytesOK=fgLastCallRxBytesOK, fgt51E=fgt51E, fgExplicitProxyBannedWords=fgExplicitProxyBannedWords, fgFwGtpRtStatsCDropped16=fgFwGtpRtStatsCDropped16, fgt5101C=fgt5101C, fgTrapVpnTunUp=fgTrapVpnTunUp, fgFwHsPolStatsEntry=fgFwHsPolStatsEntry, fgt3200D=fgt3200D, fgSlaProbeClientAvgLatencyDS=fgSlaProbeClientAvgLatencyDS, fgApSMTPReqProcessed=fgApSMTPReqProcessed, FgAdminPermLevel=FgAdminPermLevel, fgWcInfoWtpSessions=fgWcInfoWtpSessions, fgMdmPriFwVer=fgMdmPriFwVer, fgLicVersionTable=fgLicVersionTable, fdLteAutoConn=fdLteAutoConn, fgVpnTunEntLifeSecs=fgVpnTunEntLifeSecs, fgt80FBP=fgt80FBP, fgFwIppStatsType=fgFwIppStatsType, fgApSMTPMaxConnections=fgApSMTPMaxConnections, FgNPUIndex=FgNPUIndex, fgIntfBcCfgSpolID=fgIntfBcCfgSpolID, fgVWLHealthCheckLinkLatency=fgVWLHealthCheckLinkLatency, fgt80F=fgt80F, fgTrapDeviceNew=fgTrapDeviceNew, fgSlaProbeClientIP=fgSlaProbeClientIP, fgExplicitProxyUsers=fgExplicitProxyUsers, fgSysSes6Rate60=fgSysSes6Rate60, fgVWLHealthCheckLinkJitter=fgVWLHealthCheckLinkJitter, fgWcTrapObjects=fgWcTrapObjects, fgIntfTable=fgIntfTable, fgWcWtpSessionRadioWtpId=fgWcWtpSessionRadioWtpId, fgSlaProbeClientOutofSeq=fgSlaProbeClientOutofSeq, FgFwUserAuthType=FgFwUserAuthType, fgNPUEntIndex=fgNPUEntIndex, fgt60EPOE=fgt60EPOE, fgSlaProbeClientMinLatencySD=fgSlaProbeClientMinLatencySD, fgWcWtpSessionWtpLocalIpAddress=fgWcWtpSessionWtpLocalIpAddress, fgvm04=fgvm04, fgFwAuthIpv6UserNumber=fgFwAuthIpv6UserNumber, fgExplicitProxyBlockedDLP=fgExplicitProxyBlockedDLP, fgt3700D=fgt3700D, fgVpn2TunInOctets=fgVpn2TunInOctets, fgWcWtpSessionTable=fgWcWtpSessionTable, fgApIMAPReqProcessed=fgApIMAPReqProcessed, fgWcStaNoise=fgWcStaNoise, fgTxPacksErr=fgTxPacksErr, fgSysSesCount=fgSysSesCount, fgWanOptDiskStatsTable=fgWanOptDiskStatsTable, fgAppProxyPOP3=fgAppProxyPOP3, fgProcessorModuleCount=fgProcessorModuleCount, fgTrapAvPattern=fgTrapAvPattern, fgExplicitProxyFilteredOthScript=fgExplicitProxyFilteredOthScript, fgWcWlanAuthentication=fgWcWlanAuthentication, fgSlaProbeClientMaxLatencyDS=fgSlaProbeClientMaxLatencyDS, fgFwAuthIpv4UserType=fgFwAuthIpv4UserType)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgWcWtpSessionRadioMode=fgWcWtpSessionRadioMode, fgExplicitProxyFilteredJScript=fgExplicitProxyFilteredJScript, fdLteNetTypeLas=fdLteNetTypeLas, fgVpnSslTunnelUpTime=fgVpnSslTunnelUpTime, fgVdEntIndex=fgVdEntIndex, fgDiskTable=fgDiskTable, ffw3980E=ffw3980E, fgVpnTunEntInOctets=fgVpnTunEntInOctets, fgWcWtpProfileRadioTable=fgWcWtpProfileRadioTable, fgApFTPStatsEntry=fgApFTPStatsEntry, fgDpdkEngRxUsage=fgDpdkEngRxUsage, fgWfCookieBlocked=fgWfCookieBlocked, fwf30D=fwf30D, fgVpn2TunLifeBytes=fgVpn2TunLifeBytes, fgDataIn=fgDataIn, fwf60D=fwf60D, fgIpsTrapSigId=fgIpsTrapSigId, fgt201E=fgt201E, fgSlaProbeClientOutofSeqSD=fgSlaProbeClientOutofSeqSD, fgFcSwName=fgFcSwName, fwf90DPOE=fwf90DPOE, fgServerLoadBalanceObjectGroup=fgServerLoadBalanceObjectGroup, fgFwIppStatsUsedRscTCP=fgFwIppStatsUsedRscTCP, fgIntfVlanHbEntIndex=fgIntfVlanHbEntIndex, fgSimIccid=fgSimIccid, fgvm32=fgvm32, fgIntfBcCfgSpolClassName=fgIntfBcCfgSpolClassName, fgApIMAPMaxConnections=fgApIMAPMaxConnections, fgVdTpMgmtAddrType=fgVdTpMgmtAddrType, fgSgWbSysSerial=fgSgWbSysSerial, fgIpsStatsEntry=fgIpsStatsEntry, fgt80E=fgt80E, fgt200BPOE=fgt200BPOE, fgDiskName=fgDiskName, fgt800=fgt800, fgFgWfHTTPExamined=fgFgWfHTTPExamined, fgt3700DX=fgt3700DX, fgFwIppStatsPercentageUDP=fgFwIppStatsPercentageUDP, fgtVM64RAXONDEMAND=fgtVM64RAXONDEMAND, fgVpn2TunLocGwyIp=fgVpn2TunLocGwyIp, fgIntfVlanHbCount=fgIntfVlanHbCount, fgHwSensorEntry=fgHwSensorEntry, fgFmTrapPrefix=fgFmTrapPrefix, FgWcWlanAuthenticationType=FgWcWlanAuthenticationType, fgRxPacksErr=fgRxPacksErr, fgTrapHaStateChange=fgTrapHaStateChange, fgVpnSslTunnelIp=fgVpnSslTunnelIp, fgWcdmaEcio=fgWcdmaEcio, fwf40C=fwf40C, fdLteProfIpFamily=fdLteProfIpFamily, fgSoftwareObjectGroup=fgSoftwareObjectGroup, fgHwSensorEntAlarmStatus=fgHwSensorEntAlarmStatus, fgProcessorAMD=fgProcessorAMD, fgHaSchedule=fgHaSchedule, fgSgWbStatusMsg=fgSgWbStatusMsg, fgWcWtpConfigRadioAutoTxPowerHigh=fgWcWtpConfigRadioAutoTxPowerHigh, fgSysInfoAdvMem=fgSysInfoAdvMem, fgTrapFcSwDown=fgTrapFcSwDown, fgConfigStatus=fgConfigStatus, fgFwAddrTables=fgFwAddrTables, fgWcWtpSessionWtpLocalIpAddressType=fgWcWtpSessionWtpLocalIpAddressType, fgProcessorFnNP6=fgProcessorFnNP6, fgProcModDescr=fgProcModDescr, fgVpn2DialupSrcEndType=fgVpn2DialupSrcEndType, fgProcessorModules=fgProcessorModules, fgAppP2PProtoTable=fgAppP2PProtoTable, fgFwGtpRtStatsCDropped7=fgFwGtpRtStatsCDropped7, fgSwDeviceName=fgSwDeviceName, fgFwIppStatsFreePBAs=fgFwIppStatsFreePBAs, fgr35D=fgr35D, fgApSMTPSpamDetected=fgApSMTPSpamDetected, fgVpnSslStatsMaxUsers=fgVpnSslStatsMaxUsers, fgVWLHealthCheckLinkIfName=fgVWLHealthCheckLinkIfName, fgInetProto=fgInetProto, fgVpnDialupInOctets=fgVpnDialupInOctets, fgt3810A=fgt3810A, fgt80CM=fgt80CM, fgVpnTrapObjects=fgVpnTrapObjects, fgTrafficInfoTable=fgTrafficInfoTable, fwf30B=fwf30B, fgIntfBcInBytes=fgIntfBcInBytes, fgProcessorOther=fgProcessorOther, fgSwPortPOE=fgSwPortPOE, fgIntfEntEstUpBandwidth=fgIntfEntEstUpBandwidth, fgVpn2DialupDstBeginType=fgVpn2DialupDstBeginType, fgTxPacksOverflow=fgTxPacksOverflow, fgt1000ALENC=fgt1000ALENC, fgMdmInfoTable=fgMdmInfoTable, fgIpSessToAddr=fgIpSessToAddr, fgTrapSlbc=fgTrapSlbc, fgIntfVrrps=fgIntfVrrps, fgWanOptWanInTraffic=fgWanOptWanInTraffic, fgVpnSslTunnelUserName=fgVpnSslTunnelUserName, fgLinkMonitorEntry=fgLinkMonitorEntry, fgHaStatsSesCount=fgHaStatsSesCount, fgFwGtpRtStatsDDroppedMalMsg=fgFwGtpRtStatsDDroppedMalMsg, fgDevice=fgDevice, fgProcModSessionCount=fgProcModSessionCount, fgSimNetwork=fgSimNetwork, fgServerLoadBalance=fgServerLoadBalance, fgFwGtp=fgFwGtp, fgApPOP3MemUsage=fgApPOP3MemUsage, fgWcWtpProfileEntry=fgWcWtpProfileEntry, fgtsoc3=fgtsoc3, fgProcessorPktTxCount=fgProcessorPktTxCount, FgWcWtpRadioBandType=FgWcWtpRadioBandType, fgWc=fgWc, ffwVM64KVm=ffwVM64KVm, fgLinkMonitorBandwidthIn=fgLinkMonitorBandwidthIn, fgHaStatsAvCount=fgHaStatsAvCount, fgt1240B=fgt1240B, fgIp6SessStatsTable=fgIp6SessStatsTable, fgVpnTunEntStatus=fgVpnTunEntStatus, fgt240D=fgt240D, fgFwGtpStatsDrop=fgFwGtpStatsDrop, fdLteIpv4GwAddr=fdLteIpv4GwAddr, fgProcModIndex=fgProcModIndex, fgWanOptDiskUsage=fgWanOptDiskUsage, fgt3240C=fgt3240C, fgv32v=fgv32v, fgSIAdvSesExpCount=fgSIAdvSesExpCount, fgWanOptHistoryStatsEntry=fgWanOptHistoryStatsEntry, fgt3000F=fgt3000F, fgIntfBcCfgSproName=fgIntfBcCfgSproName, fgFwHsPolByteCount=fgFwHsPolByteCount, fgt1000C=fgt1000C, fgVpn2TunSelDstPort=fgVpn2TunSelDstPort, fgTrapHaMemberDown=fgTrapHaMemberDown, fgFwUsers=fgFwUsers, fgAppSuStatsTable=fgAppSuStatsTable, fgtVM64KVm=fgtVM64KVm, fgTrafMdmEntIndex=fgTrafMdmEntIndex, fgSlaProbeClientMinJitterDS=fgSlaProbeClientMinJitterDS, fgWanOptTrafficStatsEntry=fgWanOptTrafficStatsEntry, fgVirtualDomain=fgVirtualDomain, fgUsbModemInfo=fgUsbModemInfo, fgFwGtpRtStatsDDroppedMalIe=fgFwGtpRtStatsDDroppedMalIe, FgWcWlanSecurityType=FgWcWlanSecurityType, fgvmev=fgvmev, fgFwAuthUserTables=fgFwAuthUserTables, fgChassisVersion=fgChassisVersion, fgFwAuthIpv4UserEntry=fgFwAuthIpv4UserEntry, fgProcModProcessorCount=fgProcModProcessorCount, fgApHTTPMaxConnections=fgApHTTPMaxConnections, fgWebFilterObjectGroup=fgWebFilterObjectGroup, fgIntfBcCfgSpolSrcaddr=fgIntfBcCfgSpolSrcaddr, fgt5001B=fgt5001B, fgvm2v=fgvm2v, fgProcessorIntel=fgProcessorIntel, fgAppIMStatsTable=fgAppIMStatsTable, fgSgWorkerBladeTable=fgSgWorkerBladeTable, fgSlaProbeClientPktlossDS=fgSlaProbeClientPktlossDS, fgSessMdmEntIndex=fgSessMdmEntIndex, fgt101F=fgt101F, fgFwGtpStatsPath=fgFwGtpStatsPath, fgWebCacheRAMUsage=fgWebCacheRAMUsage, fgVpn2DialupOutOctets=fgVpn2DialupOutOctets, fgDhcpServerNumber=fgDhcpServerNumber, fgt3100D=fgt3100D, fgUsbportEntIndex=fgUsbportEntIndex, fgIntfBcQBDrops=fgIntfBcQBDrops, fgTrapIpsFailOpen=fgTrapIpsFailOpen, fgDiskIndex=fgDiskIndex, fgIntfVrrpTable=fgIntfVrrpTable, fwf60EJ=fwf60EJ, fgGpsInfoEntry=fgGpsInfoEntry, fgUsbModemInfoGroup=fgUsbModemInfoGroup, fgWanOptDiskHits=fgWanOptDiskHits, fgExplicitProxyFilteredVBS=fgExplicitProxyFilteredVBS, fgUsbportCount=fgUsbportCount, fgDpdkEngEntry=fgDpdkEngEntry, fgWcWtpSessionWtpIpAddressType=fgWcWtpSessionWtpIpAddressType, fgSwCpu=fgSwCpu, fgFwGtpRtStatsDDroppedGtpInGtp=fgFwGtpRtStatsDDroppedGtpInGtp, fr30DA=fr30DA, fgApIMStatsEntry=fgApIMStatsEntry, fgVpn2DialupEntry=fgVpn2DialupEntry, fgTrapAvOversize=fgTrapAvOversize, fdLteIpv6PrefLen=fdLteIpv6PrefLen, fgt5001D=fgt5001D, fgWcStaMacAddress=fgWcStaMacAddress, fgIpsStatsTable=fgIpsStatsTable, fgNPUSessionTblSize=fgNPUSessionTblSize, fgMdmMsisdn=fgMdmMsisdn, fgtVM64HV=fgtVM64HV, fgt3016B=fgt3016B, fg40FI=fg40FI, fgLogDeviceEnabled=fgLogDeviceEnabled, fgTrapHaSwitch=fgTrapHaSwitch, fgWebCacheDiskStatsTable=fgWebCacheDiskStatsTable, fgVpn2TunPhase2Index=fgVpn2TunPhase2Index, fgSysMemUsage=fgSysMemUsage, fgFwGtpRtStatsDDroppedUnknownVersion=fgFwGtpRtStatsDDroppedUnknownVersion, fr70FB=fr70FB, fgt70D=fgt70D, fgManIfIp6=fgManIfIp6, fgSessInfoEntry=fgSessInfoEntry, fgWcWtpProfileName=fgWcWtpProfileName, fgWebCacheDiskUsage=fgWebCacheDiskUsage, fgVpn2TunRemGwyPort=fgVpn2TunRemGwyPort, fgVpn2DialupDstEnd=fgVpn2DialupDstEnd, fgWcWtpProfileRadioAutoTxPowerControl=fgWcWtpProfileRadioAutoTxPowerControl, fgSlaProbeClientMaxLatencySD=fgSlaProbeClientMaxLatencySD, fgFwIppStatsEndClientIP=fgFwIppStatsEndClientIP, fgVpnDialupIndex=fgVpnDialupIndex, fgWanOptLANBytesIn=fgWanOptLANBytesIn, fgt601F=fgt601F, fgWcWtpProfileRadioChannelWidth=fgWcWtpProfileRadioChannelWidth, fgMdmActBand=fgMdmActBand, fgInternalModemTrafficInfoGroup=fgInternalModemTrafficInfoGroup, fgt311B=fgt311B, fgt4401F=fgt4401F, fgSIAdvMemLeaveKerConsThrsh=fgSIAdvMemLeaveKerConsThrsh, fgIpSessStatsTable=fgIpSessStatsTable, fgvm16=fgvm16, fgSimInfoEntry=fgSimInfoEntry, fgVpnSslStatsActiveTunnels=fgVpnSslStatsActiveTunnels, fgSwDeviceJoinTime=fgSwDeviceJoinTime, fgtVM64=fgtVM64, fgFwIppStatsPortEnd=fgFwIppStatsPortEnd, fgt1500DT=fgt1500DT, fgApIMAPSpamDetected=fgApIMAPSpamDetected, fgWcStaChannel=fgWcStaChannel, fgExplicitProxySessions=fgExplicitProxySessions, fgFwUserAuthTimeout=fgFwUserAuthTimeout, fgLicVersions=fgLicVersions, fgSgWbServiceGroupID=fgSgWbServiceGroupID, fgAvTrapVirName=fgAvTrapVirName, fgt30B=fgt30B, fgVpn2TunSelDstEndIp=fgVpn2TunSelDstEndIp, fgWcWtpSessionVapEntry=fgWcWtpSessionVapEntry, fgWcWtpSessionWtpCpuUsage=fgWcWtpSessionWtpCpuUsage, fgInternalModemInfoGroup=fgInternalModemInfoGroup, fgt240DP=fgt240DP, fgLatitude=fgLatitude, fgDpdkEngs=fgDpdkEngs, fgAvNNTPVirusDetected=fgAvNNTPVirusDetected, fgApFTPConnections=fgApFTPConnections, fgWanOptDiskStatsEntry=fgWanOptDiskStatsEntry, fgFwAuthIpv6UserName=fgFwAuthIpv6UserName, fgSwDeviceVersion=fgSwDeviceVersion, fgHaStatsCpuUsage=fgHaStatsCpuUsage, fgWcWtpConfigRadioTxPowerLevel=fgWcWtpConfigRadioTxPowerLevel, fgFwPolPktCount=fgFwPolPktCount, fgIpsMedSevDetections=fgIpsMedSevDetections, fgt140EP=fgt140EP, fwf60B=fwf60B, fgVWLHealthCheckLinkBandwidthBi=fgVWLHealthCheckLinkBandwidthBi, fgIntfBcCfgSpolComment=fgIntfBcCfgSpolComment, fgWcWlanStationCount=fgWcWlanStationCount, fgChassisSlotId=fgChassisSlotId, fgWebfilterStatsEntry=fgWebfilterStatsEntry, fgDeviceLastSeen=fgDeviceLastSeen, fgVpn2DialupSrcBegin=fgVpn2DialupSrcBegin)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgFwAuthIpv4UserNumber=fgFwAuthIpv4UserNumber, fgFgWfHTTPSBlocked=fgFgWfHTTPSBlocked, fgt280D=fgt280D, fgFwAuthIpv4UserName=fgFwAuthIpv4UserName, fgIntfBcCfgIfEstUpBandwidth=fgIntfBcCfgIfEstUpBandwidth, ffvmev=ffvmev, fgProcessorType=fgProcessorType, fgDatausageEnabled=fgDatausageEnabled, fgIntfVlanHbEntry=fgIntfVlanHbEntry, fgVpnTunEntSelectorSrcBeginIp=fgVpnTunEntSelectorSrcBeginIp, fgWcWtpSessionVapRadioId=fgWcWtpSessionVapRadioId, fgFwPolPktCountHc=fgFwPolPktCountHc, fgWcWlanUserGroup=fgWcWlanUserGroup, fgVpnSslStatsActiveWebSessions=fgVpnSslStatsActiveWebSessions, fgVdTpTable=fgVdTpTable, fgUsbModemNetwork=fgUsbModemNetwork, fgFwIppStatsRscTCP=fgFwIppStatsRscTCP, fgFwGtpStatsIeWlEntry=fgFwGtpStatsIeWlEntry, fgtVM64SVM=fgtVM64SVM, fgt3601E=fgt3601E, fgSwDeviceEntry=fgSwDeviceEntry, fgConfigChecksum=fgConfigChecksum, fgLinkMonitor=fgLinkMonitor, fgIntfBcCfgSpolTable=fgIntfBcCfgSpolTable, fgt90E=fgt90E, fgWanOptLanTraffic=fgWanOptLanTraffic, fgLicVersionCount=fgLicVersionCount, fgHaInfo=fgHaInfo, fgMdmMeid=fgMdmMeid, fgSlaProbeClientMinJitter=fgSlaProbeClientMinJitter, fgt224B=fgt224B, fgDpdkEngCount=fgDpdkEngCount, fgVpn2DialupDstEndType=fgVpn2DialupDstEndType, fgHwSensorsObjectGroup=fgHwSensorsObjectGroup, fgApIMStatsTable=fgApIMStatsTable, fgSysMemCapacity=fgSysMemCapacity, fgAdminVdom=fgAdminVdom, fgMdmHwRevision=fgMdmHwRevision, fgDNSProxyStatsUdpRatingCacheHit=fgDNSProxyStatsUdpRatingCacheHit, fg60EI=fg60EI, fgFwIppStatsTotalPBAs=fgFwIppStatsTotalPBAs, fgWebfilter=fgWebfilter, fgWcWtpConfigWtpId=fgWcWtpConfigWtpId, fgLinkMonitorVdom=fgLinkMonitorVdom, fgVpnTunEntLifeBytes=fgVpnTunEntLifeBytes, fgSlaProbeClientAvgJitterSD=fgSlaProbeClientAvgJitterSD, fgVpnTunEntPhase1Name=fgVpnTunEntPhase1Name, fgWcWtpSessionVapStationCount=fgWcWtpSessionVapStationCount, fgSgWorkerBladeEntry=fgSgWorkerBladeEntry, fgVpnSslTunnelBytesOut=fgVpnSslTunnelBytesOut, fgAdminLcdProtection=fgAdminLcdProtection, fgt60B=fgt60B, fgAvSMTPVirusDetected=fgAvSMTPVirusDetected, fgWcWlanMeshBackhaul=fgWcWlanMeshBackhaul, fgWcWtpProfileRadioStationCapacity=fgWcWtpProfileRadioStationCapacity, fgDpdkEngIdle=fgDpdkEngIdle, fgt40F=fgt40F, fgSwPortSpeedDuplex=fgSwPortSpeedDuplex, fgIps=fgIps, fgAdminObjectGroup=fgAdminObjectGroup, fgFwGtpRtStatsDDroppedSanity=fgFwGtpRtStatsDDroppedSanity, FgWcWtpRadioMode=FgWcWtpRadioMode, fgLogDeviceNumber=fgLogDeviceNumber, fgIpsInfo=fgIpsInfo, fgt200F=fgt200F, fgt400A=fgt400A, fgFwIppTrapType=fgFwIppTrapType, fgAppIMConnBlocked=fgAppIMConnBlocked, fgSysSesRate1=fgSysSesRate1, fgWcWtpSessionWtpIpAddress=fgWcWtpSessionWtpIpAddress, fgMdmCellId=fgMdmCellId, fgSlaProbeClientEntry=fgSlaProbeClientEntry, fgAppProxySMTP=fgAppProxySMTP, fgApFTPMemUsage=fgApFTPMemUsage, fgt3HD=fgt3HD, fgAvFTPVirusBlocked=fgAvFTPVirusBlocked, fgtVM64GCPONDEMAND=fgtVM64GCPONDEMAND, fgLinkMonitorPacketRecv=fgLinkMonitorPacketRecv, fgUsbModemProduct=fgUsbModemProduct, fwf50B=fwf50B, fgFwGtpRtStatsCDropped14=fgFwGtpRtStatsCDropped14, fgt61F=fgt61F, fgPerCpuHighDetails=fgPerCpuHighDetails, fgExplicitProxyBlockedConType=fgExplicitProxyBlockedConType, fgTrapAvVirus=fgTrapAvVirus, FgWcWtpRadioType=FgWcWtpRadioType, fgSlaProbeClientMinLatency=fgSlaProbeClientMinLatency, fgApHTTPStatsTable=fgApHTTPStatsTable, fgExplicitProxyArchNest=fgExplicitProxyArchNest, fgVpnTunEntSelectorSrcPort=fgVpnTunEntSelectorSrcPort, fgNPUName=fgNPUName, fwf81CM=fwf81CM, fgVpnDialupDstAddr=fgVpnDialupDstAddr, fgApSIPServices=fgApSIPServices, fgAppDNSProxy=fgAppDNSProxy, fwf51E=fwf51E, fgFwAddrDynEmsID=fgFwAddrDynEmsID, fgt30EG=fgt30EG, fgvmsl=fgvmsl, fgSlaProbeClientAvgJitterDS=fgSlaProbeClientAvgJitterDS, fgFwGtpRtStatsCRejected=fgFwGtpRtStatsCRejected, fgt2201E=fgt2201E, fgWcWtpSessionVapByteRxCount=fgWcWtpSessionVapByteRxCount, fgWcWtpSessionRadioOperatingChannel=fgWcWtpSessionRadioOperatingChannel, fgExplicitProxyArchBomb=fgExplicitProxyArchBomb, fgt81EPOE=fgt81EPOE, fgWcWtpSessionVapSsid=fgWcWtpSessionVapSsid, FgHaStatsSyncStatusType=FgHaStatsSyncStatusType, fgt140E=fgt140E, fgWcWlanTable=fgWcWlanTable, fgIpsAnomalyDetections=fgIpsAnomalyDetections, fgAppProxyHTTP=fgAppProxyHTTP, fgIpSessProto=fgIpSessProto, fw20CA=fw20CA, fgExplicitProxyExaminedURLs=fgExplicitProxyExaminedURLs, fgSysSesRate30=fgSysSesRate30, fgIntf=fgIntf, fgWcWtpProfileRadioWidsProfile=fgWcWtpProfileRadioWidsProfile, fgFwGtpStatsFteid=fgFwGtpStatsFteid, fgGpsInfoTable=fgGpsInfoTable, fgVpn2DialupInOctets=fgVpn2DialupInOctets, fgServerLoadBalanceVirtualServerName=fgServerLoadBalanceVirtualServerName, fgWcWtpConfigWtpName=fgWcWtpConfigWtpName, fgFwAuthIpv6UserIndex=fgFwAuthIpv6UserIndex, fgIntfVlanHbs=fgIntfVlanHbs, FgOpMode=FgOpMode, fgIntfBcInMaxBandwidth=fgIntfBcInMaxBandwidth, fgVpnTunEntRemGwyPort=fgVpnTunEntRemGwyPort, fgChassisTrapMessage=fgChassisTrapMessage, fgWcStaIpAddressType=fgWcStaIpAddressType, fgWcWtpProfileRadioDarrp=fgWcWtpProfileRadioDarrp, fgTrapFazDisconnect=fgTrapFazDisconnect, fgCdmaRssi=fgCdmaRssi, ffwVM64=ffwVM64, fwf80CM=fwf80CM, fgDiskCount=fgDiskCount, fgProcessorUsage=fgProcessorUsage, fgServiceGroupWorkerBlades=fgServiceGroupWorkerBlades, fgExplicitProxyAllowedURLs=fgExplicitProxyAllowedURLs, fgProcessorContainedIn=fgProcessorContainedIn, fgtARM64GCP=fgtARM64GCP, fgWanOptTunnels=fgWanOptTunnels, fgWcWtpSessionWtpRegionCode=fgWcWtpSessionWtpRegionCode, fgVWLHealthCheckLinkNumber=fgVWLHealthCheckLinkNumber, fwf60EV=fwf60EV, fgAppIMFileTxBlocked=fgAppIMFileTxBlocked, fgFwGtpRtStatsDPkts=fgFwGtpRtStatsDPkts, fgtVM64FGCKVM=fgtVM64FGCKVM, fgAdminIdleTimeout=fgAdminIdleTimeout, fgtVM64IBM=fgtVM64IBM, fgFwUserEntry=fgFwUserEntry, fgSwDeviceIpv6=fgSwDeviceIpv6, fgt400D=fgt400D, FgLogDeviceIndex=FgLogDeviceIndex, fgt200DP=fgt200DP, fgAvHTTPVirusBlocked=fgAvHTTPVirusBlocked, fgSystemAdvancedObjectGroup=fgSystemAdvancedObjectGroup, fgProcessorEntry=fgProcessorEntry, fgExplicitProxyArchUnsupported=fgExplicitProxyArchUnsupported, fgVpnSslState=fgVpnSslState, fgWebCacheDiskLimit=fgWebCacheDiskLimit, fgModel=fgModel, fgt60DPOE=fgt60DPOE, fgt3001F=fgt3001F, fgUtcTime=fgUtcTime, fgWcWtpProfileRadioAutoTxPowerHigh=fgWcWtpProfileRadioAutoTxPowerHigh, fgt310B=fgt310B, fgVpn2DialupTimeout=fgVpn2DialupTimeout, fgSwPortNativeVlan=fgSwPortNativeVlan, fgSgWbFabricLink=fgSgWbFabricLink, fgDpdkEngIpsUsage=fgDpdkEngIpsUsage, fgAppProxyIMAP=fgAppProxyIMAP, fgExplicitProxyFilterStatsEntry=fgExplicitProxyFilterStatsEntry, fgWcWtpProfileRadioBeaconInterval=fgWcWtpProfileRadioBeaconInterval, fgSwDeviceStatus=fgSwDeviceStatus, fgFwGtpStatsRequest=fgFwGtpStatsRequest, fgIntfBcCfgSentTable=fgIntfBcCfgSentTable, fgVdMaxVdoms=fgVdMaxVdoms, fgSlaProbeClientState=fgSlaProbeClientState, fgt5001=fgt5001, fgSIAdvMemCacheActive=fgSIAdvMemCacheActive, fgSwPortStatus=fgSwPortStatus, fgInternalModemSigInfoGroup=fgInternalModemSigInfoGroup, fgHaStatsPrimarySerial=fgHaStatsPrimarySerial, fgVpnSslTunnelBytesIn=fgVpnSslTunnelBytesIn, fgSystemInfoAdvanced=fgSystemInfoAdvanced, fgt60ADSL=fgt60ADSL, fgProcessorFnNP4=fgProcessorFnNP4, fgProcessorFnNP7=fgProcessorFnNP7, fgSysNpuSes6Rate60=fgSysNpuSes6Rate60, fgIpsIntrusionsDetected=fgIpsIntrusionsDetected, fgVpn2TunSelDstBeginIpType=fgVpn2TunSelDstBeginIpType, fgFwGtpRtStats=fgFwGtpRtStats, fgTrapFaz=fgTrapFaz, fgt800D=fgt800D, fgFwGtpRtStatsCDropped1=fgFwGtpRtStatsCDropped1, fgFirewallObjectGroup=fgFirewallObjectGroup, fgWanOptWanTraffic=fgWanOptWanTraffic, fr70FM=fr70FM, fgWcWtpSessionVapByteTxCount=fgWcWtpSessionVapByteTxCount, fgWcObjectGroup=fgWcObjectGroup, fgt71F=fgt71F, fgDataOut=fgDataOut, fgWcWtpSessionWtpBootVersion=fgWcWtpSessionWtpBootVersion, fgSysUpTimeDetail=fgSysUpTimeDetail, fgApFTPUpTime=fgApFTPUpTime, fgt4201F=fgt4201F, fgAppIM=fgAppIM, fgAppExplicitProxy=fgAppExplicitProxy, fg300MibCompliance=fg300MibCompliance, fgLogInfo=fgLogInfo, fgHaStatsByteCount=fgHaStatsByteCount, fgVpnSslStatsMaxWebSessions=fgVpnSslStatsMaxWebSessions, fgApSMTPConnections=fgApSMTPConnections, fgAvSMBVirusDetected=fgAvSMBVirusDetected, fgWcInfoStationCapacity=fgWcInfoStationCapacity, fgIntfBcCfgIfEstDownBandwidth=fgIntfBcCfgIfEstDownBandwidth, fgLogDeviceEntryIndex=fgLogDeviceEntryIndex, fgVWLHealthCheckLinkVdom=fgVWLHealthCheckLinkVdom, fgAntivirus=fgAntivirus, fgWebCacheDisk=fgWebCacheDisk, fgvm00=fgvm00, fgt401F=fgt401F, fgt60EJ=fgt60EJ, fgWcStaBandwidthTx=fgWcStaBandwidthTx, fgHaStatsNetUsage=fgHaStatsNetUsage, fgExplicitProxyUpTime=fgExplicitProxyUpTime, fgFwGtpStatsEchoRequest=fgFwGtpStatsEchoRequest, fgAvOversizedBlocked=fgAvOversizedBlocked, fgDatausageInfoTable=fgDatausageInfoTable, fgFwIppStatsGroupName=fgFwIppStatsGroupName, fgSgWbState=fgSgWbState, fgVdTable=fgVdTable, fgExplicitProxyScanStatsDisp=fgExplicitProxyScanStatsDisp, fgFwAuthIpv4UserAddr=fgFwAuthIpv4UserAddr, fgIp6SessNumber=fgIp6SessNumber, fgAvVirusDetected=fgAvVirusDetected, fgSessInfoTable=fgSessInfoTable, fgFwGtpRtStatsBDroppedMsgFilter=fgFwGtpRtStatsBDroppedMsgFilter, fgVirtualDomainObjectGroup=fgVirtualDomainObjectGroup, fgt41F=fgt41F, fgUsbportClass=fgUsbportClass, fgSimInfoTable=fgSimInfoTable, fgHaStatsHostname=fgHaStatsHostname, fgFwIppools=fgFwIppools, fgAppServicesObjectGroup=fgAppServicesObjectGroup, fgSlaProbeClient=fgSlaProbeClient, fgUsbportProdId=fgUsbportProdId, fgAppP2PProtEntBytes=fgAppP2PProtEntBytes, fgWcWtpProfileRadioBand=fgWcWtpProfileRadioBand, fgHaStatsAllChecksum=fgHaStatsAllChecksum, fgAvIMVirusDetected=fgAvIMVirusDetected, fgWcWtpSessionWtpModelNumber=fgWcWtpSessionWtpModelNumber, fgVdTables=fgVdTables)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgNotificationGroup=fgNotificationGroup, fgAppSuStatsEntry=fgAppSuStatsEntry, fgt200B=fgt200B, fgVWLHealthCheckLinkMOSCodec=fgVWLHealthCheckLinkMOSCodec, fgAppP2PProtoEntLastReset=fgAppP2PProtoEntLastReset, fgWebCacheRAMLimit=fgWebCacheRAMLimit, fgIpSessEntry=fgIpSessEntry, fgServerLoadBalanceRealServerAddress=fgServerLoadBalanceRealServerAddress, fgApIMUpTime=fgApIMUpTime, fgExplicitProxyLoggedURLs=fgExplicitProxyLoggedURLs, fgVpnDialupOutOctets=fgVpnDialupOutOctets, fgFgWfHTTPSExamined=fgFgWfHTTPSExamined, fgByteCacheRAMLimit=fgByteCacheRAMLimit, fgWcWtpProfileRadioEntry=fgWcWtpProfileRadioEntry, fgVpnSslTunnelEntry=fgVpnSslTunnelEntry, fgFwPolByteCount=fgFwPolByteCount, fgVpnDialupGateway=fgVpnDialupGateway, fgHwSensorEntName=fgHwSensorEntName, fgSgWbEntIndex=fgSgWbEntIndex, fgGsm=fgGsm, fgAppSuFileScanned=fgAppSuFileScanned, fgFgWfHTTPAllowed=fgFgWfHTTPAllowed, fg30EI=fg30EI, fgExplicitProxyVirus=fgExplicitProxyVirus, fgVdTpMgmtMask=fgVdTpMgmtMask, fgLinkMonitorServer=fgLinkMonitorServer, fgIntfBcInGuaranteedBandwidth=fgIntfBcInGuaranteedBandwidth, fgSlaProbeClientMinJitterSD=fgSlaProbeClientMinJitterSD, fgAppIMFileTransfered=fgAppIMFileTransfered, fgDNSProxyStatsUdpCacheHit=fgDNSProxyStatsUdpCacheHit, fgLicVersionTryResult=fgLicVersionTryResult, fgVpnSslTunnelSrcIp=fgVpnSslTunnelSrcIp, fgWcWlanRadiusServer=fgWcWlanRadiusServer, fgIntfBcCfgSproTable=fgIntfBcCfgSproTable, fgt2601F=fgt2601F, fgIpSessTable=fgIpSessTable, fgApIMAPConnections=fgApIMAPConnections, fgSlaProbeClientID=fgSlaProbeClientID, fgWcWtpConfigRadioAutoTxPowerControl=fgWcWtpConfigRadioAutoTxPowerControl, fgLinkMonitorJitter=fgLinkMonitorJitter, fgLogDevices=fgLogDevices, fgFwGtpStatsApn=fgFwGtpStatsApn, fgHdrIo=fgHdrIo, fgRxPacksOK=fgRxPacksOK, fgMdmPrlVer=fgMdmPrlVer, fgMdmVendor=fgMdmVendor, FgScanAvDisposition=FgScanAvDisposition, fgWcWtpSessionWtpHwVersion=fgWcWtpSessionWtpHwVersion, fgDNSProxyStatsUdpFwd=fgDNSProxyStatsUdpFwd, fgAppP2PProtEntProto=fgAppP2PProtEntProto, fw6XMB=fw6XMB, fgWcWtpProfileRadioVaps=fgWcWtpProfileRadioVaps, fgTrapServerLoadBalanceRealServerDown=fgTrapServerLoadBalanceRealServerDown, fgWebfilterStatsTable=fgWebfilterStatsTable, fgr60FI=fgr60FI, fgFwIppStatsPercentageTCP=fgFwIppStatsPercentageTCP, fgUsbModemVendor=fgUsbModemVendor, fgFwGtpStatsProfile=fgFwGtpStatsProfile, fgIpsTrapSigMsg=fgIpsTrapSigMsg, fgServiceGroupWorkerBladesGroup=fgServiceGroupWorkerBladesGroup, fgHaStatsSyncDatimeUnsucc=fgHaStatsSyncDatimeUnsucc, fgIntfBcInTable=fgIntfBcInTable, fgt100EF=fgt100EF, fgWcWtpProfileRadioChannel=fgWcWtpProfileRadioChannel, fgWcWtpProfileTable=fgWcWtpProfileTable, fgFwPolStatsEntry=fgFwPolStatsEntry, fgWebCacheUpTime=fgWebCacheUpTime, fgApNNTPMemUsage=fgApNNTPMemUsage, fgWcWtpSessionWtpStationCount=fgWcWtpSessionWtpStationCount, fgVpn2TunSelDstEndIpType=fgVpn2TunSelDstEndIpType, fgIntfBcCurrentBandwidth=fgIntfBcCurrentBandwidth, fgIntfBcTable=fgIntfBcTable, fgt6000F=fgt6000F, fgLogDeviceDroppedCount=fgLogDeviceDroppedCount, fgFwGtpStatsAdvPolicies=fgFwGtpStatsAdvPolicies, fgManIfIp=fgManIfIp, fwf30E=fwf30E, fgFcSwSerial=fgFcSwSerial, fgt3951B=fgt3951B, fwf40F=fwf40F, fgMdmSwRev=fgMdmSwRev, fgFwGtpStatsIpPolicy=fgFwGtpStatsIpPolicy, fgSwDeviceFlag=fgSwDeviceFlag, fgFwGtpStatsNoipPolicy=fgFwGtpStatsNoipPolicy, fgFwGtpRtStatsCDropped18=fgFwGtpRtStatsCDropped18, fgVpnTrapRemoteGateway=fgVpnTrapRemoteGateway, fgWcWtpSessionRadioCountryString=fgWcWtpSessionRadioCountryString, fgDhcpLeaseUsage=fgDhcpLeaseUsage, fgSysUpTime=fgSysUpTime, fgFwGtpRtStatsDForwarded=fgFwGtpRtStatsDForwarded, fgVpn2TunSelSrcEndIpType=fgVpn2TunSelSrcEndIpType, fgSysNpuSes6Rate30=fgSysNpuSes6Rate30, fgt60D=fgt60D, fgAppIMMessages=fgAppIMMessages, fgVpnSslTunnelVdom=fgVpnSslTunnelVdom, fgUsbModemId=fgUsbModemId, fgVpn2TunSelSrcBeginIp=fgVpn2TunSelSrcBeginIp, fgDhcpTrapMessage=fgDhcpTrapMessage, fwf90D=fwf90D, fgApHTTPConnections=fgApHTTPConnections, fgAvIMAPVirusDetected=fgAvIMAPVirusDetected, fgDNSProxyStatsUdpRetrans=fgDNSProxyStatsUdpRetrans, fgFwAuthIpv4UserIndex=fgFwAuthIpv4UserIndex, fgvmul=fgvmul, fgSimEntIndex=fgSimEntIndex, fgFwGtpStatsTunnel=fgFwGtpStatsTunnel, fgt1100E=fgt1100E, fgVpnTunEntSelectorSrcEndIp=fgVpnTunEntSelectorSrcEndIp, fgWcStaIdle=fgWcStaIdle, fgApFTPReqProcessed=fgApFTPReqProcessed, fgIntfBcInEntry=fgIntfBcInEntry, fgLicVersionTryTime=fgLicVersionTryTime, fgWcStaGroup=fgWcStaGroup, fgVpn2TunVdom=fgVpn2TunVdom, fgSystemInfo=fgSystemInfo, fgWcWtpSessionWtpMemoryCapacity=fgWcWtpSessionWtpMemoryCapacity, fgSwitchPortObjectGroup=fgSwitchPortObjectGroup, fdLteIpv6SecDns=fdLteIpv6SecDns, fgExplicitProxyPolicy=fgExplicitProxyPolicy, fgt51B=fgt51B, fgFwGtpStatsBearer=fgFwGtpStatsBearer, fgt91E=fgt91E, fgvmel=fgvmel, fgDpdkEngTxUsage=fgDpdkEngTxUsage, fw30EN=fw30EN, fgDpdkEngsObjectGroup=fgDpdkEngsObjectGroup, fgFwGtpRtStatsBDroppedMalIe=fgFwGtpRtStatsBDroppedMalIe, fgt82C=fgt82C, fgt50E=fgt50E, fgt50B=fgt50B, fgVpn2TunRemGwyIp=fgVpn2TunRemGwyIp, fgTrafficInfoEntry=fgTrafficInfoEntry, fgSysMgmtVdom=fgSysMgmtVdom, fgVpnSslTunnelTable=fgVpnSslTunnelTable, fgt3950B=fgt3950B, fgNPUDrvDriftSum=fgNPUDrvDriftSum, fgAvSMTPVirusBlocked=fgAvSMTPVirusBlocked, fgIntfEntMeaUpBandwidth=fgIntfEntMeaUpBandwidth, fw60DP=fw60DP, fgt401E=fgt401E, fgFwIppStatsPortStart=fgFwIppStatsPortStart, fgSysVersionIps=fgSysVersionIps, fgAvTables=fgAvTables, fw30EG=fw30EG, fgDatausageInfoEntry=fgDatausageInfoEntry, fgTrapAvFragmented=fgTrapAvFragmented, fgt1000=fgt1000, fgAvInfo=fgAvInfo, fgFirewall=fgFirewall, fgAdministrationObjectGroup=fgAdministrationObjectGroup, fgVpn2TunLocGwyPort=fgVpn2TunLocGwyPort, fgHaStatsSyncStatus=fgHaStatsSyncStatus, fgFwUserIndex=fgFwUserIndex, fgDeviceTrapObjects=fgDeviceTrapObjects, fgWebCacheRAMMisses=fgWebCacheRAMMisses, fgSysSesRate60=fgSysSesRate60, fgFwAuthIpv4UserVdom=fgFwAuthIpv4UserVdom, fgAvIMVirusBlocked=fgAvIMVirusBlocked, fgFmTrapDeployInProgress=fgFmTrapDeployInProgress, fgIpSessVdom=fgIpSessVdom, fgVWLHealthCheckLinkMOS=fgVWLHealthCheckLinkMOS, fwf60AM=fwf60AM, fgHaStatsIndex=fgHaStatsIndex, fgFwAuthIpv4UserTable=fgFwAuthIpv4UserTable, fgVdEntry=fgVdEntry, fgWcWtpTables=fgWcWtpTables, fgLteSnr=fgLteSnr, fgTrapIpsPkgUpdate=fgTrapIpsPkgUpdate, fgWebfilterTables=fgWebfilterTables, fgWebCacheDiskMisses=fgWebCacheDiskMisses, fgSysDiskCapacity=fgSysDiskCapacity, fgFwIppStatsUsedRscUDP=fgFwIppStatsUsedRscUDP, fgIntfVlanID=fgIntfVlanID, fgIntfVrrpEntVrIp=fgIntfVrrpEntVrIp, fgHaStatsTable=fgHaStatsTable, fgWfHTTPURLBlocked=fgWfHTTPURLBlocked, fgFc=fgFc, fwf50E=fwf50E, fgAvPOP3VirusDetected=fgAvPOP3VirusDetected, fgSwPortUntaggedVlan=fgSwPortUntaggedVlan, fgUsbportPlugged=fgUsbportPlugged, fgSlaProbeClientMinLatencyDS=fgSlaProbeClientMinLatencyDS, fgt800C=fgt800C, fgFwGtpRtStatsCDropped22=fgFwGtpRtStatsCDropped22, fgFwIppStatsTcpSessions=fgFwIppStatsTcpSessions, fgt400E=fgt400E, fgr60F=fgr60F, fgt2600F=fgt2600F, fgFmTrapObjectGroup=fgFmTrapObjectGroup, fgTxPacksOK=fgTxPacksOK, fgt5005FA2=fgt5005FA2, fgProcessorModuleTable=fgProcessorModuleTable, fgSlaProbeClientMaxJitterSD=fgSlaProbeClientMaxJitterSD, fgVpnTunEntLocGwyPort=fgVpnTunEntLocGwyPort, fgFwGtpRtStatsCDropped2=fgFwGtpRtStatsCDropped2, fgIntfBcCfgIfOutBandwidth=fgIntfBcCfgIfOutBandwidth, fgVWLHealthCheckLinkPacketRecv=fgVWLHealthCheckLinkPacketRecv, fg30EN=fg30EN, fgFwGtpRtStatsDDroppedSpoof=fgFwGtpRtStatsDDroppedSpoof, fgMemCacheLimit=fgMemCacheLimit, fgIntfBcBytes=fgIntfBcBytes, fgWcStaWtpId=fgWcStaWtpId, fgMdmFwVer=fgMdmFwVer, fgFwIppStatsEntry=fgFwIppStatsEntry, fgDhcpTables=fgDhcpTables, fgSgWbSlotID=fgSgWbSlotID, fgt140D=fgt140D, fgt3000D=fgt3000D, fgtVM64AZURE=fgtVM64AZURE, fgIpsTables=fgIpsTables, fgLicVersionExpiry=fgLicVersionExpiry, fgExplicitProxyOversized=fgExplicitProxyOversized, fgIntfVlanEntry=fgIntfVlanEntry, fgt5002FB2=fgt5002FB2, fgt3810D=fgt3810D, fgWcWtpConfigEntry=fgWcWtpConfigEntry, fgObsoleteNotificationsGroup=fgObsoleteNotificationsGroup, FgSgWorkerBladeIndex=FgSgWorkerBladeIndex, fgFwIppTrapObjects=fgFwIppTrapObjects, fgt400EBP=fgt400EBP, fgAppSuNumber=fgAppSuNumber, fgDNSProxyStatsUdpFtgFwd=fgDNSProxyStatsUdpFtgFwd, fgVdEntHaState=fgVdEntHaState, fgIntfEntVdom=fgIntfEntVdom, fgProcessorEntIndex=fgProcessorEntIndex, fgt600F=fgt600F, fgVWLHealthCheckLinkSeq=fgVWLHealthCheckLinkSeq, FgWanOptProtocols=FgWanOptProtocols, fgFwPolicies=fgFwPolicies, fgFwUserAuth=fgFwUserAuth, fgSgWbMgmtHb=fgSgWbMgmtHb, fgFwGtpStatsClash=fgFwGtpStatsClash, fgExplicitProxyFilteredJS=fgExplicitProxyFilteredJS, fgHaStatsSerial=fgHaStatsSerial, fgExplicitProxyOverriddenURLs=fgExplicitProxyOverriddenURLs, fgSIAdvSesSyncQFCount=fgSIAdvSesSyncQFCount, fgVpn2TunPhase2Name=fgVpn2TunPhase2Name, fgLogDeviceTable=fgLogDeviceTable, fgSwDeviceInfo=fgSwDeviceInfo, fgChassisObjectGroup=fgChassisObjectGroup, fgIntfEntEstDownBandwidth=fgIntfEntEstDownBandwidth, fgLinkMonitorGroup=fgLinkMonitorGroup, fgExplicitProxyInfo=fgExplicitProxyInfo, fgt600D=fgt600D, fgt500A=fgt500A, fgRxPacksOverflow=fgRxPacksOverflow, fgAppVoIP=fgAppVoIP, fgFwGtpRtStatsCForwarded=fgFwGtpRtStatsCForwarded, fgt3501F=fgt3501F, fgFwUserInfo=fgFwUserInfo, fgHighAvailabilityObjectGroup=fgHighAvailabilityObjectGroup, fgGpsEnabled=fgGpsEnabled, fgWcWtpProfileRadioApHandoff=fgWcWtpProfileRadioApHandoff, fgvmpg=fgvmpg)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgt3400E=fgt3400E, fgSwDeviceAuthorized=fgSwDeviceAuthorized, fgVdEntChecksum=fgVdEntChecksum, fgLicVersionNumber=fgLicVersionNumber, fgFwHsPolStatsTable=fgFwHsPolStatsTable, fgFwUserTable=fgFwUserTable, FgVdIndex=FgVdIndex, fdLteIpv4SecDns=fdLteIpv4SecDns, fgExplicitProxyArchCorrupt=fgExplicitProxyArchCorrupt, fosVM64=fosVM64, fgFwGtpRtStatsBForwarded=fgFwGtpRtStatsBForwarded, fgProcModSACount=fgProcModSACount, fgWcWlanBroadcastSsid=fgWcWlanBroadcastSsid, fgWcWtpSessionRadioCountryCode=fgWcWtpSessionRadioCountryCode, fdLteIpv6GwAddr=fdLteIpv6GwAddr, fgt601E=fgt601E, fgt300D=fgt300D, fgFwGtpRtStatsCDropped17=fgFwGtpRtStatsCDropped17, fgDhcp=fgDhcp, fgLteRssi=fgLteRssi, fgSysCpuUsage=fgSysCpuUsage, fgDpdkEngVnpUsage=fgDpdkEngVnpUsage, fgAppProxyFTP=fgAppProxyFTP, fgSIAdvMemBuffer=fgSIAdvMemBuffer, fgLogDeviceName=fgLogDeviceName, fgApIMReqProcessed=fgApIMReqProcessed, fgFwAuthIpv6UserType=fgFwAuthIpv6UserType, fgDisksObjectGroup=fgDisksObjectGroup, fgt620D=fgt620D, fgt3300E=fgt3300E, fgFwIppStatsEndIp=fgFwIppStatsEndIp, fgFwIppStatsName=fgFwIppStatsName, fgSIAdvMemPageCache=fgSIAdvMemPageCache, fgLongitude=fgLongitude, fgt100E=fgt100E, fgFwGtpRtStatsCPkts=fgFwGtpRtStatsCPkts, fgMdmSku=fgMdmSku, fgApNNTPReqProcessed=fgApNNTPReqProcessed, fgVpnTunEntSelectorDstBeginIp=fgVpnTunEntSelectorDstBeginIp, fgUsbportsObjectGroup=fgUsbportsObjectGroup, fwf20C=fwf20C, fgt1801F=fgt1801F, fgDhcpObjectGroup=fgDhcpObjectGroup, fgVdInfo=fgVdInfo, fgVpnTunEntIndex=fgVpnTunEntIndex, fgWcWlanLocalBridging=fgWcWlanLocalBridging, fgWcStaSecurity=fgWcStaSecurity, fgApSMTPStatsEntry=fgApSMTPStatsEntry, fgWanOptObjectGroup=fgWanOptObjectGroup, fgAvIMAPVirusBlocked=fgAvIMAPVirusBlocked, fgWcWtpConfigVaps=fgWcWtpConfigVaps, fgWanOptLANBytesOut=fgWanOptLANBytesOut, fgVpnTrapLocalGateway=fgVpnTrapLocalGateway, fgSIAdvMemEnterProxyConsThrsh=fgSIAdvMemEnterProxyConsThrsh, fgServerLoadBalanceRealServerAddress6=fgServerLoadBalanceRealServerAddress6, fgWcStaVlanId=fgWcStaVlanId, fgAvHTTPVirusDetected=fgAvHTTPVirusDetected, fgSysNpuSes6Rate1=fgSysNpuSes6Rate1, fgFwPolID=fgFwPolID, fgt52E=fgt52E, fgDeviceObjectGroup=fgDeviceObjectGroup, fgVpnTrapPhase1Name=fgVpnTrapPhase1Name, fgWfHTTPSURLBlocked=fgWfHTTPSURLBlocked, fgExplicitProxyScriptStatsTable=fgExplicitProxyScriptStatsTable, fgWcWtpSessionConnectionState=fgWcWtpSessionConnectionState, fgTrapHaHBFail=fgTrapHaHBFail, fdLteProfApn=fdLteProfApn, fgFwGtpRtStatsCDropped0=fgFwGtpRtStatsCDropped0, fgWcStaSignal=fgWcStaSignal, fgt3960E=fgt3960E, fgVdEntMemUsage=fgVdEntMemUsage, fgWcWtpSessionWtpSwVersion=fgWcWtpSessionWtpSwVersion, fgVpn2DialupDstBegin=fgVpn2DialupDstBegin, fgtARM64OCI=fgtARM64OCI, fgApSIPClientReg=fgApSIPClientReg, fgIntfBcCfgTables=fgIntfBcCfgTables, fgIntfBcCfgSentClassID=fgIntfBcCfgSentClassID, fgWcWtpConfigVapAll=fgWcWtpConfigVapAll, fgFwUserTables=fgFwUserTables, fdLteIpv4PriDns=fdLteIpv4PriDns, fgFwGtpRtStatsCDropped20=fgFwGtpRtStatsCDropped20, fgDhcpServerId=fgDhcpServerId, fgt1200D=fgt1200D, fgIntfVlanName=fgIntfVlanName, fgWcWtpSessionVapWtpId=fgWcWtpSessionVapWtpId, fgUsbportEntry=fgUsbportEntry, fgFwPolStatsTable=fgFwPolStatsTable, fgHaStatsIdsCount=fgHaStatsIdsCount, fw60CA=fw60CA, fgVpn2DialupVdom=fgVpn2DialupVdom, fgHaTables=fgHaTables, fgIpsTrapSrcIp=fgIpsTrapSrcIp, fgIpSessFromPort=fgIpSessFromPort, fgProcessorPktDroppedCount=fgProcessorPktDroppedCount, fgIntfVlanHbEntState=fgIntfVlanHbEntState, fgVpn2TunLocGwyIpType=fgVpn2TunLocGwyIpType, fgSgWbDataHb=fgSgWbDataHb, fgConfig=fgConfig, fgWcWtpSessionRadioRadioId=fgWcWtpSessionRadioRadioId, fgVpnTunEntPhase2Name=fgVpnTunEntPhase2Name, fgSwPortTable=fgSwPortTable, fgvm8v=fgvm8v, fgNPUDrvDrift=fgNPUDrvDrift, fgSwPortPOEState=fgSwPortPOEState, fgWebCacheObjectGroup=fgWebCacheObjectGroup, fgVpn2TunSelSrcPort=fgVpn2TunSelSrcPort, FgWanOptHistPeriods=FgWanOptHistPeriods, fgUsbportRevision=fgUsbportRevision, fgTrapWcApDown=fgTrapWcApDown, fgSlaProbeClientMaxLatency=fgSlaProbeClientMaxLatency, fg900D=fg900D, fgVdNumber=fgVdNumber, fgt60CSFP=fgt60CSFP, fgFwUserNumber=fgFwUserNumber, fgLteRsrp=fgLteRsrp, fgIntfBcs=fgIntfBcs, fgInternalModemSIMInfoGroup=fgInternalModemSIMInfoGroup, fgProcModName=fgProcModName, fgProcessorFnSoc=fgProcessorFnSoc, fgFwAddresses=fgFwAddresses, fgIntfBcDrops=fgIntfBcDrops, fgSlaProbeClientGroup=fgSlaProbeClientGroup, fgAvStatsTable=fgAvStatsTable, fgtVM64ALI=fgtVM64ALI, fgVpnInfo=fgVpnInfo, fdLteIpv6Addr=fdLteIpv6Addr, fgLogDeviceRelayedCount=fgLogDeviceRelayedCount, fgWanOptLanInTraffic=fgWanOptLanInTraffic, fgSIAdvLicenseDetails=fgSIAdvLicenseDetails, fw40FI=fw40FI, fgApNNTPUpTime=fgApNNTPUpTime, fgVpnTables=fgVpnTables, fgt1101E=fgt1101E, fgTdma=fgTdma, fgVWLHealthCheckLinkTable=fgVWLHealthCheckLinkTable, fgSysSes6Rate30=fgSysSes6Rate30, fgExplicitProxyStatsEntry=fgExplicitProxyStatsEntry, fgVpn2TunTimeout=fgVpn2TunTimeout, fgWcStaIpAddress=fgWcStaIpAddress, fgLicContractTable=fgLicContractTable, fgFwHsPolID=fgFwHsPolID, fgVpnTunEntLocGwyIp=fgVpnTunEntLocGwyIp, fgWcWlanSsid=fgWcWlanSsid, fgAppFnbam=fgAppFnbam, fgt201F=fgt201F, fgTrapDhcp=fgTrapDhcp, fgSwDeviceTable=fgSwDeviceTable, fgIntfInfo=fgIntfInfo, fgIntfBcQBytes=fgIntfBcQBytes, fgTrapAvOversizeBlock=fgTrapAvOversizeBlock, fgAppProxySIP=fgAppProxySIP, fgtVM64OPC=fgtVM64OPC, fgVpnObjectGroup=fgVpnObjectGroup, fgIntfVrrpEntVrId=fgIntfVrrpEntVrId, fgSysLowMemCapacity=fgSysLowMemCapacity, fgvmml=fgvmml, fgSimMdmEntIndex=fgSimMdmEntIndex, fgRxPacksDrop=fgRxPacksDrop, fgt61E=fgt61E, fw30EI=fw30EI, fgFwAuthUserInfoEntry=fgFwAuthUserInfoEntry, fgDNSProxyStatsUdpFtgRetrans=fgDNSProxyStatsUdpFtgRetrans, fgAppScanUnit=fgAppScanUnit, fw81FD=fw81FD, fgVpnDialupSrcEnd=fgVpnDialupSrcEnd, fgVpn2TunStatus=fgVpn2TunStatus, fgt3040B=fgt3040B, fgLinkMonitorBandwidthOut=fgLinkMonitorBandwidthOut, fgVdEntCpuUsage=fgVdEntCpuUsage, fgVWLHealthCheckLinkPacketSend=fgVWLHealthCheckLinkPacketSend, fgIntfBcCfgIfIngressSProfile=fgIntfBcCfgIfIngressSProfile, fgIntfBcCfgSentEntry=fgIntfBcCfgSentEntry, fgWcWlanVlanId=fgWcWlanVlanId, fgFwIppStatsUdpSessions=fgFwIppStatsUdpSessions, fgSwPortPOEStatus=fgSwPortPOEStatus, fgIntfVrrpEntIndex=fgIntfVrrpEntIndex, fgVpn2TunOutOctets=fgVpn2TunOutOctets, fgConfigGroup=fgConfigGroup, fgtARM64AWS=fgtARM64AWS, fgChassisInfo=fgChassisInfo, FgFwAuthUserType=FgFwAuthUserType, fgIntfBcCfgIfName=fgIntfBcCfgIfName, fgLicContractCount=fgLicContractCount, fgFgWfHTTPBlocked=fgFgWfHTTPBlocked, fw60CM=fw60CM, fgMdmOpMode=fgMdmOpMode, fgVpn2DialupSrcEnd=fgVpn2DialupSrcEnd, fg20CA=fg20CA, fgtVM64GCP=fgtVM64GCP, fgWebCacheRAMHits=fgWebCacheRAMHits, fgWcWtpSessionRadioEntry=fgWcWtpSessionRadioEntry, fgTrapAvOversizePass=fgTrapAvOversizePass, fgIntfBcAllocatedBandwidth=fgIntfBcAllocatedBandwidth, fgWcWtpConfigRadioBand=fgWcWtpConfigRadioBand, fgt600E=fgt600E, fgApPOP3ReqProcessed=fgApPOP3ReqProcessed, fgVpn2TunLifeSecs=fgVpn2TunLifeSecs, fgMgmt=fgMgmt, fgVpn2TunIndex=fgVpn2TunIndex, fgAdmin=fgAdmin, fgApNNTPConnections=fgApNNTPConnections, fgIntfVrrpEntry=fgIntfVrrpEntry, fgFmTrapConfChange=fgFmTrapConfChange, fgt80EPOE=fgt80EPOE, fgSwDeviceSerialNum=fgSwDeviceSerialNum, fgVpnSslTunnelIndex=fgVpnSslTunnelIndex, fgWanOptUpTime=fgWanOptUpTime, fgApSIPStatsEntry=fgApSIPStatsEntry, fgSysVersionIpsEt=fgSysVersionIpsEt, fgt60CP=fgt60CP, fgt60C=fgt60C, fgWcWtpSessionVapTable=fgWcWtpSessionVapTable, fgIntfBcInDrops=fgIntfBcInDrops, fgInetProtoTables=fgInetProtoTables, fgSgWbTables=fgSgWbTables, fgInetProtoInfo=fgInetProtoInfo, fgApHTTPStatsEntry=fgApHTTPStatsEntry, fgWanOptProtocol=fgWanOptProtocol, fgAppP2PStatsTable=fgAppP2PStatsTable, fgDiskEntry=fgDiskEntry, fgt3301E=fgt3301E, fgFmTrapGroup=fgFmTrapGroup, fgUsbportManufacturer=fgUsbportManufacturer, fgWcInfo=fgWcInfo, fgFwGtpRtStatsDDroppedIpPol=fgFwGtpRtStatsDDroppedIpPol, fgVWLHealthCheckLinkName=fgVWLHealthCheckLinkName, fgFwAddrDynEmsEntry=fgFwAddrDynEmsEntry, fgIntfBcCfgIfTable=fgIntfBcCfgIfTable, fgLinkMonitorLatency=fgLinkMonitorLatency, fgSIAdvSesAcceptQFCount=fgSIAdvSesAcceptQFCount)
