...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hwgroup/POSEIDON-MIB
...
sensPortID = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 3, 3, 1, 11), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: sensPortID.setStatus('current')
...
mibBuilder.exportSymbols("POSEIDON-MIB", outEntry=outEntry, tsAlarmTime=tsAlarmTime, inpAlarmStateChanged=inpAlarmStateChanged, charonII=charonII, TimeStamp=TimeStamp, SensorUnitString=SensorUnitString, sensString=sensString, sensEntry=sensEntry, inpEntry=inpEntry, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, OutputMode=OutputMode, SensorID=SensorID, sensFlags=sensFlags, sensLimitMax=sensLimitMax, sensState=sensState, unitType=unitType, PositiveInteger=PositiveInteger, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, outName=outName, sensSetupName=sensSetupName, SensorString=SensorString, inpAlarmState=inpAlarmState, SensorFlags=SensorFlags, sensHysteresis=sensHysteresis, poseidon=poseidon, outType=outType, tsAlarmIdx=tsAlarmIdx, infoAddressMAC=infoAddressMAC, InputAlarmSetup=InputAlarmSetup, outValue=outValue, outMode=outMode, sensName=sensName, tsAlarmSensName=tsAlarmSensName, sensSetupTable=sensSetupTable, setup=setup, sensIndex=sensIndex, sensLimitMin=sensLimitMin, inpValue=inpValue, outTable=outTable, sensTable=sensTable, outIndex=outIndex, inpAlarmSetup=inpAlarmSetup, sensValueRaw=sensValueRaw, OutputType=OutputType, tsAlarmId=tsAlarmId, SensorName=SensorName, inpTable=inpTable, tsAlarmsPresent=tsAlarmsPresent, sensSetup=sensSetup, SensorState=SensorState, sensValue=sensValue, sensAlarmStateChanged=sensAlarmStateChanged, UnitType=UnitType, IOName=IOName, tsAlarmDescr=tsAlarmDescr, inpName=inpName, InputAlarmState=InputAlarmState, inpIndex=inpIndex, SensorValue=SensorValue, info=info, sensUnit=sensUnit, tsAlarmTable=tsAlarmTable, OnOff=OnOff, sensPortID=sensPortID, hwgroup=hwgroup, tsAlarm=tsAlarm, tsAlarmEntry=tsAlarmEntry)
