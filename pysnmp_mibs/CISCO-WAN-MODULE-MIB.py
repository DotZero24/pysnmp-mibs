...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-MODULE-MIB
...
_CwmStatLevelConfigured_Type.__name__ = "StatisticsLevel"
...
ciscoWanModuleMIBCompliance.setObjects(
    ("CISCO-WAN-MODULE-MIB", "cwmConfigGroup")
)
if mibBuilder.loadTexts:
...
ciscoWanModuleMIBComplianceRev1.setObjects(
      *(("CISCO-WAN-MODULE-MIB", "cwmConfigGroup"),
        ("CISCO-WAN-MODULE-MIB", "cwmConfigGroup2"))
)
if mibBuilder.loadTexts:
...
ciscoWanModuleMIBComplianceRev2.setObjects(
      *(("CISCO-WAN-MODULE-MIB", "cwmConfigGroup"),
        ("CISCO-WAN-MODULE-MIB", "cwmConfigGroup2"),
        ("CISCO-WAN-MODULE-MIB", "cwmUploadGroup"),
        ("CISCO-WAN-MODULE-MIB", "cwmStatConfigGroup"))
)
if mibBuilder.loadTexts:
