...
# Notes
# -----
# ASN.1 source file://mibs/rfc/RAQMON-RDS-MIB
...
raqmonDsBasicCompliance.setObjects(
      *(("RAQMON-RDS-MIB", "raqmonDsNotificationGroup"),
        ("RAQMON-RDS-MIB", "raqmonDsPayloadGroup"))
)
if mibBuilder.loadTexts:
