...
mibBuilder.exportSymbols("AETHRA-MIB", trunkType=trunkType, fileTransferStorageFileName=fileTransferStorageFileName, ifcSpeed=ifcSpeed, ping=ping, pingTXpacket=pingTXpacket, ifcDescr=ifcDescr, xdslNeShowtimeCrcErr=xdslNeShowtimeCrcErr, systemAAAProfile=systemAAAProfile, userTerminal=userTerminal, trunkEntry=trunkEntry, trunkIndex=trunkIndex, mgmtPrivilege=mgmtPrivilege, systemLocalDomain=systemLocalDomain, xdslLinkStatus=xdslLinkStatus, systemCryptedPassword=systemCryptedPassword, xdslDsAttenuation=xdslDsAttenuation, mgmtChange=mgmtChange, usTermPotsDspSlic=usTermPotsDspSlic, trunkFxoStatus=trunkFxoStatus, usTermDectStatus=usTermDectStatus, trunkIsdnB1Status=trunkIsdnB1Status, xdslNeTotCrcErr=xdslNeTotCrcErr, trunkProxyHost=trunkProxyHost, trunkUserName=trunkUserName, systemFtpUsername=systemFtpUsername, performanceDynMemFree=performanceDynMemFree, ifcTxRate=ifcTxRate, pingLOSTpacket=pingLOSTpacket, systemDefaultScpServer=systemDefaultScpServer, ifcEntry=ifcEntry, pingRXpacket=pingRXpacket, usTermPotsIndex=usTermPotsIndex, systemBackupAuth=systemBackupAuth, systemLoglevel=systemLoglevel, xdslUsAttenuation=xdslUsAttenuation, pingTries=pingTries, shdslDsNoiseMargin=shdslDsNoiseMargin, xdslEntry=xdslEntry, xdslDsCurrRate=xdslDsCurrRate, usTermISDNEnable=usTermISDNEnable, xdslDsNoiseMargin=xdslDsNoiseMargin, xdslUsMaxTheorRate=xdslUsMaxTheorRate, usTermIsdnStatusB1=usTermIsdnStatusB1, systemRestart=systemRestart, restartDelay=restartDelay, mgmtAddress=mgmtAddress, xdslUsNoiseMargin=xdslUsNoiseMargin, usTermISDNIndex=usTermISDNIndex, pingStatus=pingStatus, usTermPotsTable=usTermPotsTable, xdslTc=xdslTc, fileTransferExec=fileTransferExec, systemDefaultFtpServer=systemDefaultFtpServer, shdslTc=shdslTc, pingParameters=pingParameters, shdslNeShowtimeCrcErr=shdslNeShowtimeCrcErr, performanceDynMemLoad=performanceDynMemLoad, ifcType=ifcType, shdslModulationType=shdslModulationType, voip=voip, pingSource=pingSource, trunkFxoTable=trunkFxoTable, trunkMsgWait=trunkMsgWait, pingMinRTT=pingMinRTT, pingTTL=pingTTL, pingStatistics=pingStatistics, usTermISDNEntry=usTermISDNEntry, usTermPotsStatus=usTermPotsStatus, trunkFxoDescription=trunkFxoDescription, systemScpPassword=systemScpPassword, shdslUsPower=shdslUsPower, xdsl=xdsl, mgmtUser=mgmtUser, shdslEntry=shdslEntry, systemScrollLine=systemScrollLine, performanceCpuAvg5min=performanceCpuAvg5min, trunkTable=trunkTable, trunkFxoName=trunkFxoName, restartExec=restartExec, trunkFxoIndex=trunkFxoIndex, trunkFxoEntry=trunkFxoEntry, shdslUsNoiseMargin=shdslUsNoiseMargin, pingAvgRTT=pingAvgRTT, trunkRegStatus=trunkRegStatus, ifcMtu=ifcMtu, systemLogMsgRate=systemLogMsgRate, trunkRegistered=trunkRegistered, trunkFxoType=trunkFxoType, mgmtTime=mgmtTime, fileTransferOption=fileTransferOption, atosnt=atosnt, trunkIsdnEnable=trunkIsdnEnable, shdslUsCurrRate=shdslUsCurrRate, shdslTable=shdslTable, usTermISDNTable=usTermISDNTable, shdslDsCurrRate=shdslDsCurrRate, trunkIsdnTable=trunkIsdnTable, usTermPotsEnable=usTermPotsEnable, usTermPotsDescription=usTermPotsDescription, pingTimeOut=pingTimeOut, systemSave=systemSave, trunkDescription=trunkDescription, xdslDsTotBytes=xdslDsTotBytes, aethra=aethra, systemFtpLocalAdd=systemFtpLocalAdd, ifcName=ifcName, fileTransferStatus=fileTransferStatus, fileTransferServerName=fileTransferServerName, usTermDectEntry=usTermDectEntry, shdslUsMaxTheorRate=shdslUsMaxTheorRate, mgmtAccesses=mgmtAccesses, shdslDsMaxTheorRate=shdslDsMaxTheorRate, restartOption=restartOption, trunkName=trunkName, trunkFxoEnable=trunkFxoEnable, trunkIsdnName=trunkIsdnName, systemDefaultTftpServer=systemDefaultTftpServer, systemDescription=systemDescription, shdslIndex=shdslIndex, shdslUsTotBytes=shdslUsTotBytes, usTermIsdnStatusB2=usTermIsdnStatusB2, trunkEnable=trunkEnable, ifcPhysAddress=ifcPhysAddress, usTermDectDescription=usTermDectDescription, shdslUsAttenuation=shdslUsAttenuation, performanceCpuAvg1min=performanceCpuAvg1min, ifcTable=ifcTable, ifcRxRate=ifcRxRate, xdslTable=xdslTable, xdslUsCurrRate=xdslUsCurrRate, pingSize=pingSize, shdslNeTotCrcErr=shdslNeTotCrcErr, mgmtLogin=mgmtLogin, dsl=dsl, ifc=ifc, trunk=trunk, systemName=systemName, trunkIsdnIndex=trunkIsdnIndex, fileTransferFileName=fileTransferFileName, performanceCpuAvg15min=performanceCpuAvg15min, trunkUnregistered=trunkUnregistered, traps=traps, pingHost=pingHost, usTermDectIndex=usTermDectIndex, systemTftpLocalAdd=systemTftpLocalAdd, systemKernelLogs=systemKernelLogs, trunkIsdnDescription=trunkIsdnDescription, fileTransferProtocol=fileTransferProtocol, genericError=genericError, systemScpUsername=systemScpUsername, voipMaxConnection=voipMaxConnection, shdsl=shdsl, xdslIndex=xdslIndex, shdslDsPower=shdslDsPower, xdslDsMaxTheorRate=xdslDsMaxTheorRate, systemFtpPassword=systemFtpPassword, performance=performance, fileTransfer=fileTransfer, usTermDectDspSlic=usTermDectDspSlic, interfaceDown=interfaceDown, mgmtLogout=mgmtLogout, xdslUsTotBytes=xdslUsTotBytes, usTermDectTable=usTermDectTable, trunkIsdnType=trunkIsdnType, genericTrap=genericTrap, tools=tools, trunkIsdnEntry=trunkIsdnEntry, usTermDectEnable=usTermDectEnable, system=system, systemConsoleEnable=systemConsoleEnable, xdslModulationType=xdslModulationType, restartStatus=restartStatus, shdslPhyStatus=shdslPhyStatus, pingMaxRTT=pingMaxRTT, pingStart=pingStart, systemAAALogTimeout=systemAAALogTimeout, shdslDsAttenuation=shdslDsAttenuation, performanceDynMemTotal=performanceDynMemTotal, trunkIfcStatus=trunkIfcStatus, trunkIsdnB2Status=trunkIsdnB2Status, usTermPotsEntry=usTermPotsEntry, usTermISDNDescription=usTermISDNDescription, shdslDsTotBytes=shdslDsTotBytes, interfaceUp=interfaceUp, mgmtType=mgmtType, trunkRegHost=trunkRegHost)
