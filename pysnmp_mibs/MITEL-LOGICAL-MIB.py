...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/mitel/MITEL-LOGICAL-MIB
...
mibBuilder.exportSymbols("MITEL-LOGICAL-MIB", mitelIdentification=mitelIdentification, mitelLogGrpLogicalWanTable=mitelLogGrpLogicalWanTable, mitelLogWanPortTblTransType=mitelLogWanPortTblTransType, mitelLogWanPortTblNextDestAddr=mitelLogWanPortTblNextDestAddr, mitelIdCallServers=mitelIdCallServers, mitelLogWanPortTblWanType=mitelLogWanPortTblWanType, mitelLogWanPortTblIndex=mitelLogWanPortTblIndex, mitel=mitel, mitelLogWanTblConnTimer=mitelLogWanTblConnTimer, mitelLogGrpLogicalTable=mitelLogGrpLogicalTable, mitelRouterLogicalGroup=mitelRouterLogicalGroup, mitelLogWanTblDiscTimer=mitelLogWanTblDiscTimer, mitelWanRetryThreshold=mitelWanRetryThreshold, PYSNMP_MODULE_ID=mitelRouterLogicalGroup, mitelLogWanTblCmprsn=mitelLogWanTblCmprsn, mitelLogWanPortTblRetry=mitelLogWanPortTblRetry, mitelIdCsIpera1000=mitelIdCsIpera1000, mitelLogGrpLogicalEntry=mitelLogGrpLogicalEntry, mitelLogWanTblCmprsnStatus=mitelLogWanTblCmprsnStatus, mitelLogWanPortTblStatus=mitelLogWanPortTblStatus, mitelLogWanPortTblOperStatus=mitelLogWanPortTblOperStatus, mitelPropIpNetworking=mitelPropIpNetworking, mitelLogicalTblIndex=mitelLogicalTblIndex, mitelLogGrpLogicalWanEntry=mitelLogGrpLogicalWanEntry, mitelIpera1000Notifications=mitelIpera1000Notifications, mitelLogicalTblAdminStatus=mitelLogicalTblAdminStatus, mitelLogGrpLogicalWanPortEntry=mitelLogGrpLogicalWanPortEntry, mitelLogWanTblBackupOvrflow=mitelLogWanTblBackupOvrflow, mitelLogWanTblEncryptn=mitelLogWanTblEncryptn, mitelLogicalTblDestName=mitelLogicalTblDestName, mitelLogWanPortTblDialback=mitelLogWanPortTblDialback, mitelProprietary=mitelProprietary, mitelLogWanPortTblChId=mitelLogWanPortTblChId, mitelLogWanPortTblRetryPeriod=mitelLogWanPortTblRetryPeriod, mitelLogicalTblType=mitelLogicalTblType, mitelLogWanTblThshld=mitelLogWanTblThshld, mitelLogWanTblProtocolType=mitelLogWanTblProtocolType, mitelIpNetRouter=mitelIpNetRouter, mitelLogWanPortTblPrepend=mitelLogWanPortTblPrepend, mitelLogWanPortTblDestAddr=mitelLogWanPortTblDestAddr, mitelLogWanPortTblAdminStatus=mitelLogWanPortTblAdminStatus, mitelLogGrpLogicalWanPortTable=mitelLogGrpLogicalWanPortTable)
