...
mibBuilder.exportSymbols("MITEL-LOGICAL-MIB", mitelLogWanPortTblOperStatus=mitelLogWanPortTblOperStatus, mitelLogicalTblIndex=mitelLogicalTblIndex, mitelLogGrpLogicalTable=mitelLogGrpLogicalTable, mitelLogWanPortTblRetryPeriod=mitelLogWanPortTblRetryPeriod, mitelLogGrpLogicalWanEntry=mitelLogGrpLogicalWanEntry, mitelLogWanPortTblTransType=mitelLogWanPortTblTransType, mitelLogWanTblDiscTimer=mitelLogWanTblDiscTimer, mitelLogWanPortTblWanType=mitelLogWanPortTblWanType, mitelLogWanTblCmprsn=mitelLogWanTblCmprsn, mitelLogicalTblAdminStatus=mitelLogicalTblAdminStatus, mitelLogWanTblThshld=mitelLogWanTblThshld, mitelLogWanPortTblStatus=mitelLogWanPortTblStatus, mitelLogGrpLogicalEntry=mitelLogGrpLogicalEntry, mitelLogWanTblEncryptn=mitelLogWanTblEncryptn, mitelIdCsIpera1000=mitelIdCsIpera1000, mitel=mitel, mitelRouterLogicalGroup=mitelRouterLogicalGroup, mitelLogicalTblDestName=mitelLogicalTblDestName, mitelLogWanPortTblAdminStatus=mitelLogWanPortTblAdminStatus, mitelLogWanPortTblChId=mitelLogWanPortTblChId, mitelPropIpNetworking=mitelPropIpNetworking, mitelLogWanTblBackupOvrflow=mitelLogWanTblBackupOvrflow, mitelLogWanPortTblDestAddr=mitelLogWanPortTblDestAddr, mitelIpera1000Notifications=mitelIpera1000Notifications, mitelLogWanPortTblPrepend=mitelLogWanPortTblPrepend, mitelLogicalTblType=mitelLogicalTblType, PYSNMP_MODULE_ID=mitelRouterLogicalGroup, mitelIdentification=mitelIdentification, mitelLogGrpLogicalWanTable=mitelLogGrpLogicalWanTable, mitelIdCallServers=mitelIdCallServers, mitelLogWanPortTblRetry=mitelLogWanPortTblRetry, mitelLogWanPortTblIndex=mitelLogWanPortTblIndex, mitelWanRetryThreshold=mitelWanRetryThreshold, mitelProprietary=mitelProprietary, mitelLogGrpLogicalWanPortTable=mitelLogGrpLogicalWanPortTable, mitelLogWanTblProtocolType=mitelLogWanTblProtocolType, mitelLogWanPortTblDialback=mitelLogWanPortTblDialback, mitelLogWanTblConnTimer=mitelLogWanTblConnTimer, mitelLogWanPortTblNextDestAddr=mitelLogWanPortTblNextDestAddr, mitelIpNetRouter=mitelIpNetRouter, mitelLogWanTblCmprsnStatus=mitelLogWanTblCmprsnStatus, mitelLogGrpLogicalWanPortEntry=mitelLogGrpLogicalWanPortEntry)
