...
h3cIpBdstScalarGroup=_H3cIpBdstScalarGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,33,1))
...
h3cIpBdstForwardBroadcast=_H3cIpBdstForwardBroadcast_Object((1,3,6,1,4,1,2011,10,2,33,1,1),_H3cIpBdstForwardBroadcast_Type())
...
h3cIpReceiveBroadcast=_H3cIpReceiveBroadcast_Object((1,3,6,1,4,1,2011,10,2,33,1,2),_H3cIpReceiveBroadcast_Type())
...
h3cIpBdstGroup=_H3cIpBdstGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,33,2))
_H3cIpBdstTrap_ObjectIdentity=ObjectIdentity
h3cIpBdstTrap=_H3cIpBdstTrap_ObjectIdentity((1,3,6,1,4,1,2011,10,2,33,3))
_H3cIpBdstTrapPrex_ObjectIdentity=ObjectIdentity
h3cIpBdstTrapPrex=_H3cIpBdstTrapPrex_ObjectIdentity((1,3,6,1,4,1,2011,10,2,33,3,0))
mibBuilder.exportSymbols('H3C-IP-BROADCAST-MIB',**{'h3cIpBroadcast':h3cIpBroadcast,'h3cIpBdstScalarGroup':h3cIpBdstScalarGroup,'h3cIpBdstForwardBroadcast':h3cIpBdstForwardBroadcast,'h3cIpReceiveBroadcast':h3cIpReceiveBroadcast,'h3cIpBdstGroup':h3cIpBdstGroup,'h3cIpBdstTrap':h3cIpBdstTrap,'h3cIpBdstTrapPrex':h3cIpBdstTrapPrex})