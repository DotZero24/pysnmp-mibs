...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DIAMETER-BASE-PROTOCOL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:42:28 2025
...
class _CdbpLocalOriginHost_Type(SnmpAdminString):
    """Custom type cdbpLocalOriginHost based on SnmpAdminString"""
    defaultValue = OctetString("")


_CdbpLocalOriginHost_Type.__name__ = "SnmpAdminString"
...
class _CdbpLocalRealm_Type(SnmpAdminString):
    """Custom type cdbpLocalRealm based on SnmpAdminString"""
    defaultValue = OctetString("")


_CdbpLocalRealm_Type.__name__ = "SnmpAdminString"
...
_CdbpRedundancyEnabled_Type.__name__ = "TruthValue"
...
_CdbpLocalApplStorageType_Type.__name__ = "StorageType"
...
_CdbpLocalVendorStorageType_Type.__name__ = "StorageType"
...
_CdbpAppAdvToPeerStorageType_Type.__name__ = "StorageType"
...
_CdbpPeerStorageType_Type.__name__ = "StorageType"
...
_CdbpPeerVendorStorageType_Type.__name__ = "StorageType"
...
_CiscoDiaBaseProtEnableProtocolErrorNotif_Type.__name__ = "TruthValue"
...
_CiscoDiaBaseProtEnableTransientFailureNotif_Type.__name__ = "TruthValue"
...
_CiscoDiaBaseProtEnablePermanentFailureNotif_Type.__name__ = "TruthValue"
...
_CiscoDiaBaseProtEnablePeerConnectionDownNotif_Type.__name__ = "TruthValue"
...
_CiscoDiaBaseProtEnablePeerConnectionUpNotif_Type.__name__ = "TruthValue"
...
ciscoDiameterBasePMIBCompliance.setObjects(
      *(("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBLocalCfgGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBPeerCfgGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBPeerStatsGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBNotificationsGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBTrapCfgGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBLocalCfgSkippedGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBLocalStatsSkippedGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBPeerCfgSkippedGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBPeerStatsSkippedGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBRealmCfgSkippedGroup"),
        ("CISCO-DIAMETER-BASE-PROTOCOL-MIB", "ciscoDiameterBasePMIBRealmStatsSkippedGroup"))
)
if mibBuilder.loadTexts:
