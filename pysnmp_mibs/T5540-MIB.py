# SNMP MIB module (T5540-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T5540-MIB
...
trapTest.setObjects(
      *(("T5540-MIB", "sensorName"),
        ("T5540-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
