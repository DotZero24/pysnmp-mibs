...
# Notes
# -----
# ASN.1 source file://mibs/nortel/NTWS-CLIENT-SESSION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:18:16 2025
...
ntwsClientSessionCompliance.setObjects(
    ("NTWS-CLIENT-SESSION-MIB", "ntwsClientSessionCommonGroup")
)
if mibBuilder.loadTexts:
...
ntwsClientSessionComplianceRev2.setObjects(
      *(("NTWS-CLIENT-SESSION-MIB", "ntwsClientSessScalarsGroup"),
        ("NTWS-CLIENT-SESSION-MIB", "ntwsClientSessClientSessionTableGroup"),
        ("NTWS-CLIENT-SESSION-MIB", "ntwsClientSessRoamingHistoryTableGroup"),
        ("NTWS-CLIENT-SESSION-MIB", "ntwsClientSessClientSessionStatisticsTableGroup"))
)
if mibBuilder.loadTexts:
...
ntwsClientSessionComplianceRev3.setObjects(
      *(("NTWS-CLIENT-SESSION-MIB", "ntwsClientSessScalarsGroup"),
        ("NTWS-CLIENT-SESSION-MIB", "ntwsClientSessClientSessionTableGroupRev2"),
        ("NTWS-CLIENT-SESSION-MIB", "ntwsClientSessRoamingHistoryTableGroupRev2"),
        ("NTWS-CLIENT-SESSION-MIB", "ntwsClientSessClientSessionStatisticsTableGroup"))
)
if mibBuilder.loadTexts:
