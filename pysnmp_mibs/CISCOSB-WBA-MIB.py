...
rlWBA=ModuleIdentity((1,3,6,1,4,1,9,6,1,101,230))
...
rlWBAAuxiliaryTable=_RlWBAAuxiliaryTable_Object((1,3,6,1,4,1,9,6,1,101,230,1))
if mibBuilder.loadTexts:rlWBAAuxiliaryTable.setStatus(_A)
_RlWBAAuxiliaryEntry_Object=MibTableRow
rlWBAAuxiliaryEntry=_RlWBAAuxiliaryEntry_Object((1,3,6,1,4,1,9,6,1,101,230,1,1))
...
rlWBAIp=_RlWBAIp_Object((1,3,6,1,4,1,9,6,1,101,230,1,1,1),_RlWBAIp_Type())
...
rlWBAStatus=_RlWBAStatus_Object((1,3,6,1,4,1,9,6,1,101,230,1,1,2),_RlWBAStatus_Type())
...
rlAuxFailReason=_RlAuxFailReason_Object((1,3,6,1,4,1,9,6,1,101,230,1,1,3),_RlAuxFailReason_Type())
...
rlIsRetryFlag=_RlIsRetryFlag_Object((1,3,6,1,4,1,9,6,1,101,230,1,1,4),_RlIsRetryFlag_Type())
...
rlWBAUsername=_RlWBAUsername_Object((1,3,6,1,4,1,9,6,1,101,230,1,1,5),_RlWBAUsername_Type())
...
rlWBAPassword=_RlWBAPassword_Object((1,3,6,1,4,1,9,6,1,101,230,1,1,6),_RlWBAPassword_Type())
rlWBAPassword.setMaxAccess(_B)
if mibBuilder.loadTexts:rlWBAPassword.setStatus(_A)
_RlWBAImageTable_Object=MibTable
rlWBAImageTable=_RlWBAImageTable_Object((1,3,6,1,4,1,9,6,1,101,230,2))
if mibBuilder.loadTexts:rlWBAImageTable.setStatus(_A)
_RlWBAImageEntry_Object=MibTableRow
rlWBAImageEntry=_RlWBAImageEntry_Object((1,3,6,1,4,1,9,6,1,101,230,2,1))
...
rlWBAImageNumber=_RlWBAImageNumber_Object((1,3,6,1,4,1,9,6,1,101,230,2,1,1),_RlWBAImageNumber_Type())
...
rlWBAImageIndex=_RlWBAImageIndex_Object((1,3,6,1,4,1,9,6,1,101,230,2,1,2),_RlWBAImageIndex_Type())
...
rlWBAImageText=_RlWBAImageText_Object((1,3,6,1,4,1,9,6,1,101,230,2,1,3),_RlWBAImageText_Type())
rlWBAImageText.setMaxAccess(_B)
if mibBuilder.loadTexts:rlWBAImageText.setStatus(_A)
_RlWBADataTable_Object=MibTable
rlWBADataTable=_RlWBADataTable_Object((1,3,6,1,4,1,9,6,1,101,230,3))
if mibBuilder.loadTexts:rlWBADataTable.setStatus(_A)
_RlWBADataEntry_Object=MibTableRow
rlWBADataEntry=_RlWBADataEntry_Object((1,3,6,1,4,1,9,6,1,101,230,3,1))
...
rlWBADataNumber=_RlWBADataNumber_Object((1,3,6,1,4,1,9,6,1,101,230,3,1,1),_RlWBADataNumber_Type())
...
rlWBADataIndex=_RlWBADataIndex_Object((1,3,6,1,4,1,9,6,1,101,230,3,1,2),_RlWBADataIndex_Type())
...
rlWBADataText=_RlWBADataText_Object((1,3,6,1,4,1,9,6,1,101,230,3,1,3),_RlWBADataText_Type())
rlWBADataText.setMaxAccess(_B)
if mibBuilder.loadTexts:rlWBADataText.setStatus(_A)
_RlWBAImageInfoTable_Object=MibTable
rlWBAImageInfoTable=_RlWBAImageInfoTable_Object((1,3,6,1,4,1,9,6,1,101,230,4))
if mibBuilder.loadTexts:rlWBAImageInfoTable.setStatus(_A)
_RlWBAImageInfoEntry_Object=MibTableRow
rlWBAImageInfoEntry=_RlWBAImageInfoEntry_Object((1,3,6,1,4,1,9,6,1,101,230,4,1))
...
rlWBAImageInfoNumber=_RlWBAImageInfoNumber_Object((1,3,6,1,4,1,9,6,1,101,230,4,1,1),_RlWBAImageInfoNumber_Type())
...
rlWBAImageInfoName=_RlWBAImageInfoName_Object((1,3,6,1,4,1,9,6,1,101,230,4,1,2),_RlWBAImageInfoName_Type())
...
rlWBAImageInfoSize=_RlWBAImageInfoSize_Object((1,3,6,1,4,1,9,6,1,101,230,4,1,3),_RlWBAImageInfoSize_Type())
...
rlWBAImageClear=_RlWBAImageClear_Object((1,3,6,1,4,1,9,6,1,101,230,5),_RlWBAImageClear_Type())
...
rlWBADataClear=_RlWBADataClear_Object((1,3,6,1,4,1,9,6,1,101,230,6),_RlWBADataClear_Type())
...
rlWBAImageDownloadFinishStatus=_RlWBAImageDownloadFinishStatus_Object((1,3,6,1,4,1,9,6,1,101,230,7),_RlWBAImageDownloadFinishStatus_Type())
