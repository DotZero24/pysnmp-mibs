...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-WBA-MIB
...
rlWBAIp = _RlWBAIp_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 1, 1, 1),
    _RlWBAIp_Type()
)
...
rlWBAStatus = _RlWBAStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 1, 1, 2),
    _RlWBAStatus_Type()
)
...
rlAuxFailReason = _RlAuxFailReason_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 1, 1, 3),
...
rlIsRetryFlag = _RlIsRetryFlag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 1, 1, 4),
    _RlIsRetryFlag_Type()
)
...
rlWBAUsername = _RlWBAUsername_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 1, 1, 5),
    _RlWBAUsername_Type()
)
...
rlWBAPassword = _RlWBAPassword_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 1, 1, 6),
    _RlWBAPassword_Type()
)
...
rlWBAImageNumber = _RlWBAImageNumber_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 2, 1, 1),
...
rlWBAImageIndex = _RlWBAImageIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 2, 1, 2),
...
rlWBAImageText = _RlWBAImageText_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 2, 1, 3),
...
rlWBADataNumber = _RlWBADataNumber_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 3, 1, 1),
...
rlWBADataIndex = _RlWBADataIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 3, 1, 2),
...
rlWBADataText = _RlWBADataText_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 3, 1, 3),
    _RlWBADataText_Type()
)
...
rlWBAImageInfoNumber = _RlWBAImageInfoNumber_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 4, 1, 1),
...
rlWBAImageInfoName = _RlWBAImageInfoName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 4, 1, 2),
...
rlWBAImageInfoSize = _RlWBAImageInfoSize_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 230, 4, 1, 3),
