...
# Notes
# -----
# ASN.1 source file://mibs/nortel/BAY-STACK-DHCP-SNOOPING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:17:23 2025
...
class _BsDhcpSnoopingOrigin_Type(Bits):
    """Custom type bsDhcpSnoopingOrigin based on Bits"""
...
bsDhcpSnoopingOrigin = _BsDhcpSnoopingOrigin_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 17, 1, 2, 1, 4),
    _BsDhcpSnoopingOrigin_Type()
)
bsDhcpSnoopingOrigin.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bsDhcpSnoopingOrigin.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"bayStackDhcpSnoopingMib": bayStackDhcpSnoopingMib,
       ...
       "bsDhcpSnoopingOrigin": bsDhcpSnoopingOrigin,
