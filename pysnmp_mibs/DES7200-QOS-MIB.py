...
mibBuilder.exportSymbols("DES7200-QOS-MIB", myQoSPriorityMIBObjects=myQoSPriorityMIBObjects, myQoSTrafficClassMIBObjects=myQoSTrafficClassMIBObjects, myQoSPoliceMapEntry=myQoSPoliceMapEntry, myQosPoliceIfIndex=myQosPoliceIfIndex, myIfOutPoliceMapName=myIfOutPoliceMapName, myQosClassMapEntryStatus=myQosClassMapEntryStatus, myIfRateLimitInBurstFlowLimit=myIfRateLimitInBurstFlowLimit, myQosPoliceIfExtTable=myQosPoliceIfExtTable, myIfRateLimitOutMaxBandWidth=myIfRateLimitOutMaxBandWidth, myQoSMIBCompliances=myQoSMIBCompliances, myPriorityTrafficClassNum=myPriorityTrafficClassNum, myIpPreClassTable=myIpPreClassTable, myPriorityToDscp=myPriorityToDscp, myDscpClassTable=myDscpClassTable, myIfPriTrafficClassOperMode=myIfPriTrafficClassOperMode, myQoSPoliceMapConfMaxBandWidth=myQoSPoliceMapConfMaxBandWidth, myQoSPoliceMapTable=myQoSPoliceMapTable, myQoSPoliceMapConfNewDscp=myQoSPoliceMapConfNewDscp, myQosPoliceMapEntryStatus=myQosPoliceMapEntryStatus, myQoSPoliceMapConfEntry=myQoSPoliceMapConfEntry, myQoSPoliceMapConfTable=myQoSPoliceMapConfTable, myQoSMIB=myQoSMIB, myIfRateLimitInMaxBandWidth=myIfRateLimitInMaxBandWidth, myIpPreToDscp=myIpPreToDscp, myQosClassAclName=myQosClassAclName, myIfInPoliceMapName=myIfInPoliceMapName, myIfPriority=myIfPriority, PYSNMP_MODULE_ID=myQoSMIB, myTrafficClass=myTrafficClass, myIfPriorityQosTrustMode=myIfPriorityQosTrustMode, myIpPreClassEntry=myIpPreClassEntry, myIpPreClassPriority=myIpPreClassPriority, myQoSTrafficClassEntry=myQoSTrafficClassEntry, myIfRateLimitOutBurstFlowLimit=myIfRateLimitOutBurstFlowLimit, myQosClassMapName=myQosClassMapName, myQoSPoliceCfgPoliceMapName=myQoSPoliceCfgPoliceMapName, myQoSPriorityMIBGroup=myQoSPriorityMIBGroup, myTrafficClassEntry=myTrafficClassEntry, myTrafficClassPriority=myTrafficClassPriority, myDscpClassEntry=myDscpClassEntry, myIfRateLimitEntry=myIfRateLimitEntry, myQoSPoliceMapConfBurstFlowLimit=myQoSPoliceMapConfBurstFlowLimit, myQoSPoliceMapCfgEntryStatus=myQoSPoliceMapCfgEntryStatus, myQoSPoliceMapConfExceedAction=myQoSPoliceMapConfExceedAction, myQoSGlobalStatus=myQoSGlobalStatus, myIfRateLimitTable=myIfRateLimitTable, myTrafficClassTable=myTrafficClassTable, myQoSPoliceMapConfMaxHighBandWidth=myQoSPoliceMapConfMaxHighBandWidth, myQoSMIBGroups=myQoSMIBGroups, myIfRateLimitIndex=myIfRateLimitIndex, myIfPriorityEntry=myIfPriorityEntry, myQoSMIBConformance=myQoSMIBConformance, myIfPriorityTable=myIfPriorityTable, myIfPriorityIfIndex=myIfPriorityIfIndex, myQoSPoliceCfgClassMapName=myQoSPoliceCfgClassMapName, myIfPriorityBandwidth=myIfPriorityBandwidth, myQoSMIBCompliance=myQoSMIBCompliance, myDscpClass=myDscpClass, myQosPoliceMapName=myQosPoliceMapName, myQoSPoliceMapConfExceedDscp=myQoSPoliceMapConfExceedDscp, myQosPoliceIfExtEntry=myQosPoliceIfExtEntry, myPriorityClassNum=myPriorityClassNum, myDscpTrafficClassPriority=myDscpTrafficClassPriority, myPriorityDscpMaxValue=myPriorityDscpMaxValue, myPriorityBandWidth=myPriorityBandWidth, myQoSTrafficClassMIBGroup=myQoSTrafficClassMIBGroup, myQoSTrafficClassTable=myQoSTrafficClassTable, myPriorityTrafficClassOperMode=myPriorityTrafficClassOperMode)
