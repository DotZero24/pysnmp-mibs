#
# PySNMP MIB module DES7200-QOS-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/d-link/DES7200-QOS-MIB
...
myTrafficClassEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 1, 5, 1), ).setIndexNames((0, "DES7200-QOS-MIB", "myTrafficClassPriority"))
...
myDscpClassEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 1, 6, 1), ).setIndexNames((0, "DES7200-QOS-MIB", "myDscpClass"))
...
myIfPriorityEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 1, 9, 1), ).setIndexNames((0, "DES7200-QOS-MIB", "myIfPriorityIfIndex"))
...
myIpPreClassEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 1, 10, 1), ).setIndexNames((0, "DES7200-QOS-MIB", "myIpPreClassPriority"))
...
myIfRateLimitEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 1, 11, 1), ).setIndexNames((0, "DES7200-QOS-MIB", "myIfRateLimitIndex"))
...
myQoSTrafficClassEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 2, 1, 1), ).setIndexNames((0, "DES7200-QOS-MIB", "myQosClassMapName"))
...
myQoSPoliceMapEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 2, 2, 1), ).setIndexNames((0, "DES7200-QOS-MIB", "myQosPoliceMapName"))
...
myQoSPoliceMapConfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 2, 3, 1), ).setIndexNames((0, "DES7200-QOS-MIB", "myQoSPoliceCfgPoliceMapName"), (0, "DES7200-QOS-MIB", "myQoSPoliceCfgClassMapName"))
...
myQosPoliceIfExtEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 2, 5, 1), ).setIndexNames((0, "DES7200-QOS-MIB", "myQosPoliceIfIndex"))
...
myQoSMIBCompliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 3, 1, 1)).setObjects(("DES7200-QOS-MIB", "myQoSPriorityMIBGroup"), ("DES7200-QOS-MIB", "myQoSTrafficClassMIBGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    myQoSMIBCompliance = myQoSMIBCompliance.setStatus('current')
myQoSPriorityMIBGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 3, 2, 1)).setObjects(("DES7200-QOS-MIB", "myQoSGlobalStatus"), ("DES7200-QOS-MIB", "myPriorityTrafficClassNum"), ("DES7200-QOS-MIB", "myPriorityClassNum"), ("DES7200-QOS-MIB", "myPriorityDscpMaxValue"), ("DES7200-QOS-MIB", "myTrafficClassPriority"), ("DES7200-QOS-MIB", "myTrafficClass"), ("DES7200-QOS-MIB", "myPriorityToDscp"), ("DES7200-QOS-MIB", "myDscpClass"), ("DES7200-QOS-MIB", "myDscpTrafficClassPriority"), ("DES7200-QOS-MIB", "myPriorityTrafficClassOperMode"), ("DES7200-QOS-MIB", "myPriorityBandWidth"), ("DES7200-QOS-MIB", "myIfPriorityIfIndex"), ("DES7200-QOS-MIB", "myIfPriority"), ("DES7200-QOS-MIB", "myIfPriTrafficClassOperMode"), ("DES7200-QOS-MIB", "myIfPriorityBandwidth"), ("DES7200-QOS-MIB", "myIfPriorityQosTrustMode"), ("DES7200-QOS-MIB", "myIpPreClassPriority"), ("DES7200-QOS-MIB", "myIpPreToDscp"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    myQoSPriorityMIBGroup = myQoSPriorityMIBGroup.setStatus('current')
myQoSTrafficClassMIBGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 18, 3, 2, 2)).setObjects(("DES7200-QOS-MIB", "myQosClassMapName"), ("DES7200-QOS-MIB", "myQosClassAclName"), ("DES7200-QOS-MIB", "myQosClassMapEntryStatus"), ("DES7200-QOS-MIB", "myQosPoliceMapName"), ("DES7200-QOS-MIB", "myQosPoliceMapEntryStatus"), ("DES7200-QOS-MIB", "myQoSPoliceCfgPoliceMapName"), ("DES7200-QOS-MIB", "myQoSPoliceCfgClassMapName"), ("DES7200-QOS-MIB", "myQoSPoliceMapConfMaxBandWidth"), ("DES7200-QOS-MIB", "myQoSPoliceMapConfExceedAction"), ("DES7200-QOS-MIB", "myQoSPoliceMapConfExceedDscp"), ("DES7200-QOS-MIB", "myQoSPoliceMapConfNewDscp"), ("DES7200-QOS-MIB", "myQoSPoliceMapCfgEntryStatus"), ("DES7200-QOS-MIB", "myQoSPoliceMapConfMaxHighBandWidth"), ("DES7200-QOS-MIB", "myQosPoliceIfIndex"), ("DES7200-QOS-MIB", "myIfInPoliceMapName"), ("DES7200-QOS-MIB", "myIfOutPoliceMapName"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    myQoSTrafficClassMIBGroup = myQoSTrafficClassMIBGroup.setStatus('current')
mibBuilder.exportSymbols("DES7200-QOS-MIB", myIfPriorityEntry=myIfPriorityEntry, myIfRateLimitOutBurstFlowLimit=myIfRateLimitOutBurstFlowLimit, myPriorityDscpMaxValue=myPriorityDscpMaxValue, myIfPriorityBandwidth=myIfPriorityBandwidth, myQoSPoliceCfgClassMapName=myQoSPoliceCfgClassMapName, myQoSPoliceMapConfMaxHighBandWidth=myQoSPoliceMapConfMaxHighBandWidth, myQosPoliceIfExtEntry=myQosPoliceIfExtEntry, myQosClassMapName=myQosClassMapName, myIfRateLimitEntry=myIfRateLimitEntry, myIpPreClassEntry=myIpPreClassEntry, myPriorityBandWidth=myPriorityBandWidth, myQoSPoliceMapConfMaxBandWidth=myQoSPoliceMapConfMaxBandWidth, myQoSTrafficClassMIBGroup=myQoSTrafficClassMIBGroup, myIfRateLimitIndex=myIfRateLimitIndex, myQosClassAclName=myQosClassAclName, myPriorityTrafficClassNum=myPriorityTrafficClassNum, myIfOutPoliceMapName=myIfOutPoliceMapName, myQoSMIBCompliance=myQoSMIBCompliance, myTrafficClass=myTrafficClass, myQoSPoliceMapConfEntry=myQoSPoliceMapConfEntry, myQosClassMapEntryStatus=myQosClassMapEntryStatus, myQoSPoliceCfgPoliceMapName=myQoSPoliceCfgPoliceMapName, myTrafficClassPriority=myTrafficClassPriority, myQoSPoliceMapConfNewDscp=myQoSPoliceMapConfNewDscp, myQoSGlobalStatus=myQoSGlobalStatus, myDscpClassEntry=myDscpClassEntry, myQoSMIBConformance=myQoSMIBConformance, myQoSTrafficClassEntry=myQoSTrafficClassEntry, myIfPriorityIfIndex=myIfPriorityIfIndex, myQosPoliceMapEntryStatus=myQosPoliceMapEntryStatus, myQoSPoliceMapConfExceedAction=myQoSPoliceMapConfExceedAction, myQoSPriorityMIBGroup=myQoSPriorityMIBGroup, myIfRateLimitInBurstFlowLimit=myIfRateLimitInBurstFlowLimit, myIfInPoliceMapName=myIfInPoliceMapName, myIfPriorityQosTrustMode=myIfPriorityQosTrustMode, myQoSTrafficClassMIBObjects=myQoSTrafficClassMIBObjects, myIfRateLimitTable=myIfRateLimitTable, myIpPreClassPriority=myIpPreClassPriority, myDscpClass=myDscpClass, myDscpTrafficClassPriority=myDscpTrafficClassPriority, myQoSPoliceMapConfBurstFlowLimit=myQoSPoliceMapConfBurstFlowLimit, myQoSMIBGroups=myQoSMIBGroups, myQoSPriorityMIBObjects=myQoSPriorityMIBObjects, myIpPreClassTable=myIpPreClassTable, PYSNMP_MODULE_ID=myQoSMIB, myQoSPoliceMapTable=myQoSPoliceMapTable, myIfRateLimitOutMaxBandWidth=myIfRateLimitOutMaxBandWidth, myIfPriority=myIfPriority, myQoSPoliceMapConfTable=myQoSPoliceMapConfTable, myDscpClassTable=myDscpClassTable, myPriorityClassNum=myPriorityClassNum, myQosPoliceMapName=myQosPoliceMapName, myPriorityToDscp=myPriorityToDscp, myQoSMIB=myQoSMIB, myQoSPoliceMapCfgEntryStatus=myQoSPoliceMapCfgEntryStatus, myQosPoliceIfIndex=myQosPoliceIfIndex, myTrafficClassTable=myTrafficClassTable, myIpPreToDscp=myIpPreToDscp, myQosPoliceIfExtTable=myQosPoliceIfExtTable, myQoSMIBCompliances=myQoSMIBCompliances, myQoSPoliceMapEntry=myQoSPoliceMapEntry, myQoSTrafficClassTable=myQoSTrafficClassTable, myQoSPoliceMapConfExceedDscp=myQoSPoliceMapConfExceedDscp, myIfPriTrafficClassOperMode=myIfPriTrafficClassOperMode, myIfRateLimitInMaxBandWidth=myIfRateLimitInMaxBandWidth, myIfPriorityTable=myIfPriorityTable, myTrafficClassEntry=myTrafficClassEntry, myPriorityTrafficClassOperMode=myPriorityTrafficClassOperMode)
