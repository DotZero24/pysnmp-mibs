...
mibBuilder.exportSymbols("ZXR10-EPON-MIB", onuStatisBer=onuStatisBer, oltStatisFer=oltStatisFer, onuVlanAddVid8=onuVlanAddVid8, protectGroupid=protectGroupid, remoteOnuVendorId=remoteOnuVendorId, onuType=onuType, onuBindRowStatus=onuBindRowStatus, onuPortVlanMode=onuPortVlanMode, remoteMaxQueuesPerDSport=remoteMaxQueuesPerDSport, queueValue8=queueValue8, zxr10EponRemoteOnuInfoEntry=zxr10EponRemoteOnuInfoEntry, optiInfoVendorPN=optiInfoVendorPN, onuVlanDelVid6=onuVlanDelVid6, zxr10EponOltEncryptEntry=zxr10EponOltEncryptEntry, zxr10EponObjects=zxr10EponObjects, remoteBatteryBackup=remoteBatteryBackup, remoteGePortNum=remoteGePortNum, cpuPortsFrames=cpuPortsFrames, queueValue2=queueValue2, zxr10EponSwitchRecordTable=zxr10EponSwitchRecordTable, queueSetId=queueSetId, dbaQueueActive=dbaQueueActive, onuAuthSoftVer=onuAuthSoftVer, conditionMacAddressType=conditionMacAddressType, remoteChipRevison=remoteChipRevison, remoteChipModel=remoteChipModel, zxr10EponRemoteFastRebootTable=zxr10EponRemoteFastRebootTable, zxr10EponRemoteOnuVoipTable=zxr10EponRemoteOnuVoipTable, onuBindSN=onuBindSN, inRangeLengthErrorsPerLLID=inRangeLengthErrorsPerLLID, zxr10EponRemoteFastRebootEntry=zxr10EponRemoteFastRebootEntry, onuStatisOutMultiPkts=onuStatisOutMultiPkts, zxr10EponRemoteOnuDbaTable=zxr10EponRemoteOnuDbaTable, onuStatisInPkts=onuStatisInPkts, onuStatisOutOctes=onuStatisOutOctes, zxr10EponProtectGroupEntry=zxr10EponProtectGroupEntry, onuMacMaxNum=onuMacMaxNum, ruleRowStatus=ruleRowStatus, conditionPriority=conditionPriority, conditionL4PortType=conditionL4PortType, onuRulePrecedenceNum=onuRulePrecedenceNum, switchTypeMtoB=switchTypeMtoB, onuStatisInBroadPkts=onuStatisInBroadPkts, remoteOnuModel=remoteOnuModel, remoteUsQueuesNum=remoteUsQueuesNum, conditionPortNum=conditionPortNum, oamFramesCounters=oamFramesCounters, onuMultiVlanTagStripe=onuMultiVlanTagStripe, onuVlanDelVid3=onuVlanDelVid3, onuId=onuId, zxr10EponRemoteOnuInfoTable=zxr10EponRemoteOnuInfoTable, remoteBitmapGePort=remoteBitmapGePort, onuPortUpPolicyCBS=onuPortUpPolicyCBS, remoteBitmapFePort=remoteBitmapFePort, zxr10EponRemoteOnuE1Entry=zxr10EponRemoteOnuE1Entry, oltStatisOutUniPkts=oltStatisOutUniPkts, zxr10EponRemoteOnuVoipEntry=zxr10EponRemoteOnuVoipEntry, conditionIpAddress=conditionIpAddress, remoteMaxQueuesPerUSport=remoteMaxQueuesPerUSport, onuPortUpPolicyCIR=onuPortUpPolicyCIR, onuMacPortName=onuMacPortName, conditionMacAddress=conditionMacAddress, droppedFramesPerLLID=droppedFramesPerLLID, conditionOperatorType=conditionOperatorType, onuStatisOutPkts=onuStatisOutPkts, zxr10EponOnuAuthEntry=zxr10EponOnuAuthEntry, remoteE1PortNum=remoteE1PortNum, onuPortUpPolicyEBS=onuPortUpPolicyEBS, onuVlanDelVid1=onuVlanDelVid1, oltStatisOutBroadPkts=oltStatisOutBroadPkts, onuAutoAuthSwtich=onuAutoAuthSwtich, protectOltActiveIfName=protectOltActiveIfName, eponSlotId=eponSlotId, zxr10=zxr10, zxr10EponRemoteOnuDbaEntry=zxr10EponRemoteOnuDbaEntry, onuE1EnableSwitch=onuE1EnableSwitch, optiInfoWavelength=optiInfoWavelength, queueValue4=queueValue4, onuVlanAddVid3=onuVlanAddVid3, zxr10EponSwitchRecordEntry=zxr10EponSwitchRecordEntry, standardOamMpcpStatistic=standardOamMpcpStatistic, zxr10EponRemoteOnuClassCondiEntry=zxr10EponRemoteOnuClassCondiEntry, zte=zte, onuStatisFer=onuStatisFer, switchTime=switchTime, oltPortSupportedLlidNum=oltPortSupportedLlidNum, oltAlarmThreshold=oltAlarmThreshold, onuVlanAddVid4=onuVlanAddVid4, onuRuleProfile=onuRuleProfile, packetLimitType=packetLimitType, onuVoipEnableSwitch=onuVoipEnableSwitch, onuVlanAddVid2=onuVlanAddVid2, conditionProfileNum=conditionProfileNum, protectOltMasterIfName=protectOltMasterIfName, oltChurningTimer=oltChurningTimer, zxr10EponRemoteOnuPortTable=zxr10EponRemoteOnuPortTable, opticsMeasureHigh=opticsMeasureHigh, onuOpticalLen=onuOpticalLen, remoteFePortNum=remoteFePortNum, onuPortDownPolicyCIR=onuPortDownPolicyCIR, oltStatisInUniPkts=oltStatisInUniPkts, remoteChipVendorId=remoteChipVendorId, oltAlarmDirectSwitch=oltAlarmDirectSwitch, remoteMultiFastLeave=remoteMultiFastLeave, zxr10EponOnuAuthTable=zxr10EponOnuAuthTable, queueValue7=queueValue7, remoteOnuId=remoteOnuId, onuMultiVlanSwitch=onuMultiVlanSwitch, onuRTT=onuRTT, queueValue6=queueValue6, zxr10EponOnuPortStatEntry=zxr10EponOnuPortStatEntry, onuBindMacAddr=onuBindMacAddr, oltStatisPortBer=oltStatisPortBer, protectReverTime=protectReverTime, onuVlanDelVid2=onuVlanDelVid2, queueVlaue=queueVlaue, queueValue1=queueValue1, zxr10EponRemoteOnuClassCondiTable=zxr10EponRemoteOnuClassCondiTable, onuDefaultVlan=onuDefaultVlan, remotePortsNum=remotePortsNum, transmittedFramesPerLLID=transmittedFramesPerLLID, onuPortRowStatus=onuPortRowStatus, onuPortUpPolicySwitch=onuPortUpPolicySwitch, packetLimitSwitch=packetLimitSwitch, eponOltPortName=eponOltPortName, onuE1UniNumber=onuE1UniNumber, queueValue5=queueValue5, conditionIpProtocolType=conditionIpProtocolType, queueValue3=queueValue3, onuPortFlowControl=onuPortFlowControl, zxr10EponRemoteOnuClassRuleTable=zxr10EponRemoteOnuClassRuleTable, zxr10EponAlarmEntry=zxr10EponAlarmEntry, onuVoipUniNumber=onuVoipUniNumber, protocolProtectSwitch=protocolProtectSwitch, onuAuthPCBVer=onuAuthPCBVer, cpuPortsOctets=cpuPortsOctets, conditionVlanId=conditionVlanId, onuVlanDelVid7=onuVlanDelVid7, onuRulePrecedenceSwitch=onuRulePrecedenceSwitch, remoteDSQueuesNum=remoteDSQueuesNum, onuConditionList=onuConditionList, oltPortDBAType=oltPortDBAType, conditionDscp=conditionDscp, zxr10EponTopologyCollect=zxr10EponTopologyCollect, zxr10EponRemoteOnuClassRuleEntry=zxr10EponRemoteOnuClassRuleEntry, oltEncryptRowStatus=oltEncryptRowStatus, onuHostType=onuHostType, oltStatisInMultiPkts=oltStatisInMultiPkts, onuVlanAddVid5=onuVlanAddVid5, onuStatisOutBroadPkts=onuStatisOutBroadPkts, priorityValue=priorityValue, switchRecordNum=switchRecordNum, oltAlarmSwitch=oltAlarmSwitch, onuVlanAddVid7=onuVlanAddVid7, onuEEPROMVer=onuEEPROMVer, protectRowStatus=protectRowStatus, zxr10EponRemoteOnu=zxr10EponRemoteOnu, zxr10EponOnuAuthInfoTable=zxr10EponOnuAuthInfoTable, opticsMeasureLow=opticsMeasureLow, onuPortDownPolicySwitch=onuPortDownPolicySwitch, onuPortVlanTagValue=onuPortVlanTagValue, onuVlanDelVid5=onuVlanDelVid5, zxr10EponLocal=zxr10EponLocal, oltStatisOutOctes=oltStatisOutOctes, oltStatisInPkts=oltStatisInPkts, zxr10EponOnuAuthInfoEntry=zxr10EponOnuAuthInfoEntry, oltStatisBer=oltStatisBer, remoteFirmwareVersion=remoteFirmwareVersion, oltPortSoftwareVersion=oltPortSoftwareVersion, oltStatisOutPkts=oltStatisOutPkts, onuSoftwareAuth=onuSoftwareAuth, zxr10EponOltOptiInfoEntry=zxr10EponOltOptiInfoEntry, oltEncryptAlgorithm=oltEncryptAlgorithm, onuEthUniNumber=onuEthUniNumber, onuMultiGroupMaxNum=onuMultiGroupMaxNum, oltPortAGCLockTime=oltPortAGCLockTime, oltStatisOutMultiPkts=oltStatisOutMultiPkts, onuVlanDelVid4=onuVlanDelVid4, remoteReboot=remoteReboot, frameTooLongErrorsPerLLID=frameTooLongErrorsPerLLID, conditionRowStatus=conditionRowStatus, zxr10EponOltPortStatEntry=zxr10EponOltPortStatEntry, oltMaxRtt=oltMaxRtt, onuDbaRowStatus=onuDbaRowStatus, zxr10EponRemoteOnuPortEntry=zxr10EponRemoteOnuPortEntry, onuVlanDelVid8=onuVlanDelVid8, protectOltEnableSwitch=protectOltEnableSwitch, oltLaserSwitch=oltLaserSwitch, conditionIpAddressType=conditionIpAddressType, onuHardwareSwitch=onuHardwareSwitch, zxr10EponOltEncryptTable=zxr10EponOltEncryptTable, onuStatisInMultiPkts=onuStatisInMultiPkts, onuBindTypeName=onuBindTypeName, optiInfoVendor=optiInfoVendor, oltKeyUpdatePeriod=oltKeyUpdatePeriod, onuVlanAddVid6=onuVlanAddVid6, protectOltBackupIfName=protectOltBackupIfName, optiDiagInterval=optiDiagInterval, zxr10EponProtectGroupTable=zxr10EponProtectGroupTable, conditionEthType=conditionEthType, onuAuthState=onuAuthState, oltStatisInOctes=oltStatisInOctes, onuStatisInOctes=onuStatisInOctes, protocolProtectMode=protocolProtectMode, onuPortDownPolicyPIR=onuPortDownPolicyPIR, remoteSoftwareVersion=remoteSoftwareVersion, ruleProfileNum=ruleProfileNum, oltStatisInBroadPkts=oltStatisInBroadPkts, zxr10EponOnuPortStatTable=zxr10EponOnuPortStatTable, zxr10EponOltPortStatTable=zxr10EponOltPortStatTable, transmittedOctetsPerLLID=transmittedOctetsPerLLID, standardOamStatistics=standardOamStatistics, remoteIcVersion=remoteIcVersion, oltPortCDRLockTime=oltPortCDRLockTime, zxr10EponOltOptiInfoTable=zxr10EponOltOptiInfoTable, zxr10EponAlarmTable=zxr10EponAlarmTable, onuHardVer=onuHardVer, onuMultiVlanList=onuMultiVlanList, remoteHardwareVersion=remoteHardwareVersion, zxr10EponRemoteOnuE1Table=zxr10EponRemoteOnuE1Table, onuVlanAddVid1=onuVlanAddVid1, switchRecordGroupid=switchRecordGroupid, protectReverEnable=protectReverEnable, optiInfoSFPID=optiInfoSFPID, switchType=switchType)
