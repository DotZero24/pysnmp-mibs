...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-LICENSE-KEY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:47:17 2025
...
class _EtsysLicenseKeyString_Type(SnmpAdminString):
    """Custom type etsysLicenseKeyString based on SnmpAdminString"""
    defaultValue = OctetString("")


_EtsysLicenseKeyString_Type.__name__ = "SnmpAdminString"
...
etsysLicenseKeyCompliance.setObjects(
    ("ENTERASYS-LICENSE-KEY-MIB", "etsysLicenseKeyConfigurationGroup")
)
if mibBuilder.loadTexts:
...
etsysLicenseKeyCompliance2.setObjects(
    ("ENTERASYS-LICENSE-KEY-MIB", "etsysLicenseKeyPhysicalConfigGroup")
)
if mibBuilder.loadTexts:
