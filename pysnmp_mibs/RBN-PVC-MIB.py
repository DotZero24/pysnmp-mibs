...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-PVC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:03 2025
...
_RbnAtmPvcCircuitType_Type.__name__ = "RbnPvcCircuitType"
...
_RbnAtmPvcClearCircuit_Type.__name__ = "TruthValue"
...
_RbnFrameRelayPvcCircuitType_Type.__name__ = "RbnPvcCircuitType"
...
_RbnDot1qPvcOnEthCircuitType_Type.__name__ = "RbnPvcCircuitType"
...
_RbnDot1qPvcOnEthClearCircuit_Type.__name__ = "TruthValue"
...
_RbnDot1qPvcOnAtmCircuitType_Type.__name__ = "RbnPvcCircuitType"
...
_RbnDot1qPvcOnAtmClearCircuit_Type.__name__ = "TruthValue"
...
_RbnDot1qPvcOnFrCircuitType_Type.__name__ = "RbnPvcCircuitType"
...
_RbnDot1qPvcOnFrClearCircuit_Type.__name__ = "TruthValue"
...
rbnPvcCompliance.setObjects(
      *(("RBN-PVC-MIB", "rbnAtmPvcGroup"),
        ("RBN-PVC-MIB", "rbnFrameRelayPvcGroup"))
)
if mibBuilder.loadTexts:
...
rbnPvcCompliance2.setObjects(
      *(("RBN-PVC-MIB", "rbnAtmPvcGroup2"),
        ("RBN-PVC-MIB", "rbnFrameRelayPvcGroup2"))
)
if mibBuilder.loadTexts:
...
rbnPvcCompliance3.setObjects(
      *(("RBN-PVC-MIB", "rbnAtmPvcGroup2"),
        ("RBN-PVC-MIB", "rbnFrameRelayPvcGroup2"),
        ("RBN-PVC-MIB", "rbnDot1qPvcOnEthGroup"),
        ("RBN-PVC-MIB", "rbnDot1qPvcOnAtmGroup"),
        ("RBN-PVC-MIB", "rbnDot1qPvcOnFrGroup"))
)
if mibBuilder.loadTexts:
