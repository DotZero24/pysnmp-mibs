...
vrrpMIB, VrId, vrrpOperations = mibBuilder.importSymbols("VRRP-MIB", "vrrpMIB", "VrId", "vrrpOperations")
...
mibBuilder.exportSymbols("TIMETRA-VRRP-V3-MIB", vrrpStatisticsDiscontinuityTime=vrrpStatisticsDiscontinuityTime, vrrpNotifications=vrrpNotifications, PYSNMP_MODULE_ID=timetraVrrpV3MibModule, vrrpStatisticsGroup=vrrpStatisticsGroup, vrrpStatisticsIpTtlErrors=vrrpStatisticsIpTtlErrors, vrrpOperationsStorageType=vrrpOperationsStorageType, vrrpStatisticsRcvdInvalidAuthentications=vrrpStatisticsRcvdInvalidAuthentications, vrrpAssociatedIpAddr=vrrpAssociatedIpAddr, vrrpStatisticsRcvdInvalidTypePkts=vrrpStatisticsRcvdInvalidTypePkts, vrrpStatisticsAdvIntervalErrors=vrrpStatisticsAdvIntervalErrors, vrrpTrapInfoGroup=vrrpTrapInfoGroup, vrrpStatisticsRefreshRate=vrrpStatisticsRefreshRate, vrrpAssociatedStorageType=vrrpAssociatedStorageType, vrrpTrapProtoErrReason=vrrpTrapProtoErrReason, vrrpConformance=vrrpConformance, vrrpRouterStatisticsEntry=vrrpRouterStatisticsEntry, vrrpOperationsEntry=vrrpOperationsEntry, vrrpStatisticsRcvdPriZeroPackets=vrrpStatisticsRcvdPriZeroPackets, vrrpStatisticsMasterTransitions=vrrpStatisticsMasterTransitions, vrrpStatisticsAddressListErrors=vrrpStatisticsAddressListErrors, vrrpStatistics=vrrpStatistics, vrrpModuleReadOnlyCompliance=vrrpModuleReadOnlyCompliance, vrrpOperationsInetAddrType=vrrpOperationsInetAddrType, vrrpStatisticsPacketLengthErrors=vrrpStatisticsPacketLengthErrors, vrrpOperationsUpTime=vrrpOperationsUpTime, vrrpNotificationsGroup=vrrpNotificationsGroup, vrrpOperationsRowStatus=vrrpOperationsRowStatus, vrrpAssociatedIpAddrEntry=vrrpAssociatedIpAddrEntry, vrrpOperationsAcceptMode=vrrpOperationsAcceptMode, vrrpRouterStatisticsTable=vrrpRouterStatisticsTable, vrrpModuleFullCompliance=vrrpModuleFullCompliance, vrrpOperationsAddrCount=vrrpOperationsAddrCount, vrrpTrapProtoError=vrrpTrapProtoError, vrrpOperationsAdvInterval=vrrpOperationsAdvInterval, vrrpOperationsPrimaryIpAddr=vrrpOperationsPrimaryIpAddr, vrrpAssociatedIpAddrTable=vrrpAssociatedIpAddrTable, vrrpOperationsPreemptMode=vrrpOperationsPreemptMode, vrrpOperationsTable=vrrpOperationsTable, vrrpOperationsVirtualMacAddr=vrrpOperationsVirtualMacAddr, vrrpStatisticsSentPriZeroPackets=vrrpStatisticsSentPriZeroPackets, vrrpNewMasterReason=vrrpNewMasterReason, vrrpNotifyObjsGroup=vrrpNotifyObjsGroup, vrrpMIBCompliances=vrrpMIBCompliances, timetraVrrpV3MibModule=timetraVrrpV3MibModule, vrrpStatisticsRcvdAdvertisements=vrrpStatisticsRcvdAdvertisements, vrrpOperationsPriority=vrrpOperationsPriority, vrrpOperationsState=vrrpOperationsState, vrrpAssociatedIpAddrRowStatus=vrrpAssociatedIpAddrRowStatus, vrrpMIBGroups=vrrpMIBGroups, vrrpOperationsVrId=vrrpOperationsVrId, vrrpOperationsMasterIpAddr=vrrpOperationsMasterIpAddr, vrrpOperationsGroup=vrrpOperationsGroup)
