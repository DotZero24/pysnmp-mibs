...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-VRRP-V3-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:58:20 2025
...
(VrId,
 vrrpMIB,
 vrrpOperations) = mibBuilder.importSymbols(
    "VRRP-MIB",
    "VrId",
    "vrrpMIB",
    "vrrpOperations")
...
if mibBuilder.loadTexts:
    vrrpStatisticsRefreshRate.setUnits("milliseconds")
...
vrrpModuleFullCompliance.setObjects(
      *(("TIMETRA-VRRP-V3-MIB", "vrrpOperationsGroup"),
        ("TIMETRA-VRRP-V3-MIB", "vrrpStatisticsGroup"),
        ("TIMETRA-VRRP-V3-MIB", "vrrpTrapInfoGroup"),
        ("TIMETRA-VRRP-V3-MIB", "vrrpNotificationsGroup"),
        ("TIMETRA-VRRP-V3-MIB", "vrrpNotifyObjsGroup"))
)
if mibBuilder.loadTexts:
