...
mibBuilder.exportSymbols("NETI-TRUNK-MIB", dppipTxSlots=dppipTxSlots, dppipPhysIf=dppipPhysIf, dppipGroup=dppipGroup, dppipPeerDTSupport=dppipPeerDTSupport, dppipOperStatus=dppipOperStatus, dppipRxUsedCapacity=dppipRxUsedCapacity, dppipMissingFrames=dppipMissingFrames, dppipLostFrames=dppipLostFrames, dppipTxTranspSlots=dppipTxTranspSlots, dppipRxSlotsPerFrame=dppipRxSlotsPerFrame, dppipNomDTDelay=dppipNomDTDelay, dppipPeerTTSupport=dppipPeerTTSupport, dppipSuppressAlarms=dppipSuppressAlarms, dppipEntry=dppipEntry, dppipLastChange=dppipLastChange, dppipIndex=dppipIndex, dppipTxFecRows=dppipTxFecRows, dppipTxFecCols=dppipTxFecCols, dppipFailure=dppipFailure, dppipPeerMaxFecMode=dppipPeerMaxFecMode, dppipMaxFecMode=dppipMaxFecMode, dppipNetMask=dppipNetMask, dppipMaxTxSlots=dppipMaxTxSlots, dppipRxSlots=dppipRxSlots, dppipMaxFecRows=dppipMaxFecRows, dppipAdminStatus=dppipAdminStatus, dppipMtu=dppipMtu, dppipMinTxSlots=dppipMinTxSlots, dppipLimitsTable=dppipLimitsTable, dppipTable=dppipTable, dppipPeerMinFecRows=dppipPeerMinFecRows, dppipDroppedFrames=dppipDroppedFrames, dppipDscp=dppipDscp, dppipRxTranspSlots=dppipRxTranspSlots, dppipSigFailFilter=dppipSigFailFilter, dppipPeerLimitsEntry=dppipPeerLimitsEntry, PYSNMP_MODULE_ID=netiTrunkMIB, dppipRxFecCols=dppipRxFecCols, dppipPeerMinRxSlots=dppipPeerMinRxSlots, dppipAvailRxSlots=dppipAvailRxSlots, dppipMaxFecCols=dppipMaxFecCols, dppipPeerMaxFecElems=dppipPeerMaxFecElems, dppipTtl=dppipTtl, dppipDefaultGateway=dppipDefaultGateway, dppipDTSupport=dppipDTSupport, dppipDegPeriod=dppipDegPeriod, dppipSentFrames=dppipSentFrames, dppipTxFecMode=dppipTxFecMode, dppipTolJitter=dppipTolJitter, dppipTxUsedCapacity=dppipTxUsedCapacity, DppipSupport=DppipSupport, dppipDeliveredFrames=dppipDeliveredFrames, dppipMinUsageRatio=dppipMinUsageRatio, dppipMinTolJitter=dppipMinTolJitter, dppipMaxFecElems=dppipMaxFecElems, dppipMinFecCols=dppipMinFecCols, dppipDelayVar999=dppipDelayVar999, dppipPeerMaxRxSlots=dppipPeerMaxRxSlots, dppipLimitsEntry=dppipLimitsEntry, dppipReorderedFrames=dppipReorderedFrames, dppipRxFecMode=dppipRxFecMode, dppipCntControl=dppipCntControl, dppipMaxTolJitter=dppipMaxTolJitter, dppipTTSupport=dppipTTSupport, dppipRecoveredFrames=dppipRecoveredFrames, dppipVlan=dppipVlan, dppipDelayVar01=dppipDelayVar01, dppipPeerLimitsTable=dppipPeerLimitsTable, netiTrunkMIB=netiTrunkMIB, dppipRxFecRows=dppipRxFecRows, FecMode=FecMode, dppipPeerMinFecCols=dppipPeerMinFecCols, trunkObjects=trunkObjects, dppipReceivedFrames=dppipReceivedFrames, dppipDelayVarPtp=dppipDelayVarPtp, dppipPeerMaxFecRows=dppipPeerMaxFecRows, dppipMinFecRows=dppipMinFecRows, dppipDuplicateFrames=dppipDuplicateFrames, dppipName=dppipName, dppipAddress=dppipAddress, dppipDegThreshold=dppipDegThreshold, dppipNumber=dppipNumber, dppipPeerMaxFecCols=dppipPeerMaxFecCols, dppipPrio=dppipPrio, dppipPeerAddress=dppipPeerAddress, dppipDelayVariation=dppipDelayVariation, dppipAvailTxSlots=dppipAvailTxSlots)
