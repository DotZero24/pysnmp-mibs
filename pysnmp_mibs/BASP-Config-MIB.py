...
baspTeam=_BaspTeam_ObjectIdentity((1,3,6,1,4,1,4413,1,2,1,1))
_BtTeamNumber_Type=Integer32
_BtTeamNumber_Object=MibScalar
btTeamNumber=_BtTeamNumber_Object((1,3,6,1,4,1,4413,1,2,1,1,1),_BtTeamNumber_Type())
btTeamNumber.setMaxAccess(_B)
if mibBuilder.loadTexts:btTeamNumber.setStatus(_A)
_BtTeamTable_Object=MibTable
btTeamTable=_BtTeamTable_Object((1,3,6,1,4,1,4413,1,2,1,1,2))
if mibBuilder.loadTexts:btTeamTable.setStatus(_A)
_BtTeamEntry_Object=MibTableRow
btTeamEntry=_BtTeamEntry_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1))
...
btTeamIndex=_BtTeamIndex_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,1),_BtTeamIndex_Type())
...
btTeamName=_BtTeamName_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,2),_BtTeamName_Type())
...
btTeamType=_BtTeamType_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,3),_BtTeamType_Type())
...
btTeamMacAddress=_BtTeamMacAddress_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,4),_BtTeamMacAddress_Type())
...
btPhyNumber=_BtPhyNumber_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,5),_BtPhyNumber_Type())
...
btVirNumber=_BtVirNumber_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,6),_BtVirNumber_Type())
...
btMode=_BtMode_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,7),_BtMode_Type())
...
btLiveLinkEnable=_BtLiveLinkEnable_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,8),_BtLiveLinkEnable_Type())
...
btLinkPacketFrequency=_BtLinkPacketFrequency_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,9),_BtLinkPacketFrequency_Type())
...
btLinkMaxRetry=_BtLinkMaxRetry_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,10),_BtLinkMaxRetry_Type())
...
btLinkRetryFrequency=_BtLinkRetryFrequency_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,11),_BtLinkRetryFrequency_Type())
...
btLinkTargetIpAddress1=_BtLinkTargetIpAddress1_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,12),_BtLinkTargetIpAddress1_Type())
...
btLinkTargetIpAddress2=_BtLinkTargetIpAddress2_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,13),_BtLinkTargetIpAddress2_Type())
...
btLinkTargetIpAddress3=_BtLinkTargetIpAddress3_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,14),_BtLinkTargetIpAddress3_Type())
...
btLinkTargetIpAddress4=_BtLinkTargetIpAddress4_Object((1,3,6,1,4,1,4413,1,2,1,1,2,1,15),_BtLinkTargetIpAddress4_Type())
...
baspPhyAdapter=_BaspPhyAdapter_ObjectIdentity((1,3,6,1,4,1,4413,1,2,1,2))
_BtPhyAdapterNumber_Type=Integer32
_BtPhyAdapterNumber_Object=MibScalar
btPhyAdapterNumber=_BtPhyAdapterNumber_Object((1,3,6,1,4,1,4413,1,2,1,2,1),_BtPhyAdapterNumber_Type())
...
btPhyAdapterTable=_BtPhyAdapterTable_Object((1,3,6,1,4,1,4413,1,2,1,2,2))
if mibBuilder.loadTexts:btPhyAdapterTable.setStatus(_A)
_BtPhyAdapterEntry_Object=MibTableRow
btPhyAdapterEntry=_BtPhyAdapterEntry_Object((1,3,6,1,4,1,4413,1,2,1,2,2,1))
...
btpTeamIndex=_BtpTeamIndex_Object((1,3,6,1,4,1,4413,1,2,1,2,2,1,1),_BtpTeamIndex_Type())
...
btpAdapterIndex=_BtpAdapterIndex_Object((1,3,6,1,4,1,4413,1,2,1,2,2,1,2),_BtpAdapterIndex_Type())
...
btpAdapterDesc=_BtpAdapterDesc_Object((1,3,6,1,4,1,4413,1,2,1,2,2,1,3),_BtpAdapterDesc_Type())
...
btpMemberType=_BtpMemberType_Object((1,3,6,1,4,1,4413,1,2,1,2,2,1,4),_BtpMemberType_Type())
...
btpMacAddress=_BtpMacAddress_Object((1,3,6,1,4,1,4413,1,2,1,2,2,1,5),_BtpMacAddress_Type())
...
btpMemberState=_BtpMemberState_Object((1,3,6,1,4,1,4413,1,2,1,2,2,1,6),_BtpMemberState_Type())
...
btpLiveLinkIp=_BtpLiveLinkIp_Object((1,3,6,1,4,1,4413,1,2,1,2,2,1,7),_BtpLiveLinkIp_Type())
...
baspVirAdapter=_BaspVirAdapter_ObjectIdentity((1,3,6,1,4,1,4413,1,2,1,3))
_BtVirAdapterNumber_Type=Integer32
_BtVirAdapterNumber_Object=MibScalar
btVirAdapterNumber=_BtVirAdapterNumber_Object((1,3,6,1,4,1,4413,1,2,1,3,1),_BtVirAdapterNumber_Type())
...
btVirAdapterTable=_BtVirAdapterTable_Object((1,3,6,1,4,1,4413,1,2,1,3,2))
if mibBuilder.loadTexts:btVirAdapterTable.setStatus(_A)
_BtVirAdapterEntry_Object=MibTableRow
btVirAdapterEntry=_BtVirAdapterEntry_Object((1,3,6,1,4,1,4413,1,2,1,3,2,1))
...
btvTeamIndex=_BtvTeamIndex_Object((1,3,6,1,4,1,4413,1,2,1,3,2,1,1),_BtvTeamIndex_Type())
...
btvAdapterIndex=_BtvAdapterIndex_Object((1,3,6,1,4,1,4413,1,2,1,3,2,1,2),_BtvAdapterIndex_Type())
...
btvAdapterDesc=_BtvAdapterDesc_Object((1,3,6,1,4,1,4413,1,2,1,3,2,1,3),_BtvAdapterDesc_Type())
...
btvVlanId=_BtvVlanId_Object((1,3,6,1,4,1,4413,1,2,1,3,2,1,4),_BtvVlanId_Type())
...
btvLinkStatus=_BtvLinkStatus_Object((1,3,6,1,4,1,4413,1,2,1,3,2,1,5),_BtvLinkStatus_Type())
...
btvIPAddress=_BtvIPAddress_Object((1,3,6,1,4,1,4413,1,2,1,3,2,1,6),_BtvIPAddress_Type())
...
btvSubnetMask=_BtvSubnetMask_Object((1,3,6,1,4,1,4413,1,2,1,3,2,1,7),_BtvSubnetMask_Type())
...
btvPhysAddress=_BtvPhysAddress_Object((1,3,6,1,4,1,4413,1,2,1,3,2,1,8),_BtvPhysAddress_Type())
