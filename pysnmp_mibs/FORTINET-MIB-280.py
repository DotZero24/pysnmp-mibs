...
mibBuilder.exportSymbols("FORTINET-MIB-280", fnIpSessTable=fnIpSessTable, fnTraps=fnTraps, fnOptions=fnOptions, fnUserName=fnUserName, fnUserState=fnUserState, fnVpnDialupDstAddr=fnVpnDialupDstAddr, fnVpnDialupIndex=fnVpnDialupIndex, fnVpnDialupSrcEnd=fnVpnDialupSrcEnd, fnVpnDialupGateway=fnVpnDialupGateway, fnIpSessEntry=fnIpSessEntry, fnHaStatsTable=fnHaStatsTable, fnIpSessProto=fnIpSessProto, fnUserIndex=fnUserIndex, fnMessages=fnMessages, FnUserAuth=FnUserAuth, fnVpnDialupLifetime=fnVpnDialupLifetime, fnAdminName=fnAdminName, fnVdName=fnVdName, fnSysSerial=fnSysSerial, fnHaStatsPktCount=fnHaStatsPktCount, fnSystem=fnSystem, fnHaSchedule=fnHaSchedule, FnOpMode=FnOpMode, fnHa=fnHa, fnAdminAddr=fnAdminAddr, FnHaSchedule=FnHaSchedule, fnVpnDialupTimeout=fnVpnDialupTimeout, fnAdminMask=fnAdminMask, fnAdminIndex=fnAdminIndex, fnHaStatsByteCount=fnHaStatsByteCount, fnHaOverride=fnHaOverride, fnIpsSigId=fnIpsSigId, fnIpsSigSrcIp=fnIpsSigSrcIp, fnVdTable=fnVdTable, FnIndex=FnIndex, fnLogging=fnLogging, fnDomains=fnDomains, fnHaStatsSerial=fnHaStatsSerial, fnLogOption=fnLogOption, fnSysSesCount=fnSysSesCount, fnHaStatsCpuUsage=fnHaStatsCpuUsage, FnHaMode=FnHaMode, fnSysHaMode=fnSysHaMode, fnHaAutoSync=fnHaAutoSync, fnVpnDialupSrcBegin=fnVpnDialupSrcBegin, fnIpSessFromAddr=fnIpSessFromAddr, FnIfAddrMode=FnIfAddrMode, fortinet=fortinet, FnSessProto=FnSessProto, fnSysVersionNids=fnSysVersionNids, FnAdminPerm=FnAdminPerm, fnHaStatsMemUsage=fnHaStatsMemUsage, fnVpnDialupTable=fnVpnDialupTable, fnSysVersionAv=fnSysVersionAv, fnHaPriority=fnHaPriority, fnUserAuth=fnUserAuth, fnUserNumber=fnUserNumber, fnVdNumber=fnVdNumber, fnAdminNumber=fnAdminNumber, fnIpSessToPort=fnIpSessToPort, fnIpSessFromPort=fnIpSessFromPort, fnHaGroupId=fnHaGroupId, fnHaStatsIdsCount=fnHaStatsIdsCount, fnAdminTable=fnAdminTable, fnVpn=fnVpn, fnMesgNumber=fnMesgNumber, fnAdmin=fnAdmin, fnHaStatsAvCount=fnHaStatsAvCount, fnVdEntry=fnVdEntry, fnHaStatsSesCount=fnHaStatsSesCount, fnIpSessExp=fnIpSessExp, fnHaStatsNetUsage=fnHaStatsNetUsage, fnBridgeFgtFailure=fnBridgeFgtFailure, fnIps=fnIps, FnBoolState=FnBoolState, fnUserTable=fnUserTable, fnHaStatsIndex=fnHaStatsIndex, fnHaStatsEntry=fnHaStatsEntry, fnOptIdleTimeout=fnOptIdleTimeout, fnVdIndex=fnVdIndex, fnSysCpuUsage=fnSysCpuUsage, fnSysVersion=fnSysVersion, fnBridge=fnBridge, fnVpnDialupEntry=fnVpnDialupEntry, fnIp=fnIp, fnIpSessIndex=fnIpSessIndex, fnAdminPerm=fnAdminPerm, fnSysModel=fnSysModel, fnSysMemUsage=fnSysMemUsage, fnUserEntry=fnUserEntry, fnSysOpMode=fnSysOpMode, fnAdminEntry=fnAdminEntry, fnIpSessToAddr=fnIpSessToAddr, fnUsers=fnUsers)
