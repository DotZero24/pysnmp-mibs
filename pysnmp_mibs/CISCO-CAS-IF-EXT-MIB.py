...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-CAS-IF-EXT-MIB
...
ccasVoiceCfgEntry, ccasGrpCfgEntry = mibBuilder.importSymbols("CISCO-CAS-IF-MIB", "ccasVoiceCfgEntry", "ccasGrpCfgEntry")
CCallControlProfileIndexOrZero, cmgwIndex, CVoiceTonePlanIndexOrZero = mibBuilder.importSymbols("CISCO-MEDIA-GATEWAY-MIB", "CCallControlProfileIndexOrZero", "cmgwIndex", "CVoiceTonePlanIndexOrZero")
...
CvcFaxTransmitRate, CvcCoderTypeRate = mibBuilder.importSymbols("CISCO-VOICE-COMMON-DIAL-CONTROL-MIB", "CvcFaxTransmitRate", "CvcCoderTypeRate")
...
mibBuilder.exportSymbols("CISCO-CAS-IF-EXT-MIB", ccasIfExtDs0GrpRepeatOwner=ccasIfExtDs0GrpRepeatOwner, ccasProfileRegSigTimer=ccasProfileRegSigTimer, ccasFwdRSSatelLinkIncluded=ccasFwdRSSatelLinkIncluded, ccasIfExtVoiceCfgICSEnable=ccasIfExtVoiceCfgICSEnable, ccasLSTSeizeAckRspTimer=ccasLSTSeizeAckRspTimer, ccasGCnfIncCallHiFreqPower=ccasGCnfIncCallHiFreqPower, ccasIfExtVoiceCfgH248PkgIds=ccasIfExtVoiceCfgH248PkgIds, ccasBwdRSAnnouncement=ccasBwdRSAnnouncement, ccasFwdRSEndANICallingPartyRev=ccasFwdRSEndANICallingPartyRev, ccasLSTCASDebounceTimer=ccasLSTCASDebounceTimer, ccasIfExtConfigRegisterSignalGroup=ccasIfExtConfigRegisterSignalGroup, ccasBwdRSAddrCompleteGroupA=ccasBwdRSAddrCompleteGroupA, ccasRSRowStatus=ccasRSRowStatus, ccasOLSCasSignalName=ccasOLSCasSignalName, ccasRSTOutFwdPulseOffTimer=ccasRSTOutFwdPulseOffTimer, ccasIfExtVoiceCfgCasGroup=ccasIfExtVoiceCfgCasGroup, CASRegisterSignal=CASRegisterSignal, ccasIfExtBulkGroup=ccasIfExtBulkGroup, CASForwardSignal=CASForwardSignal, CASBackwardSignal=CASBackwardSignal, ccasIfExtMIBGroups=ccasIfExtMIBGroups, ccasBwdRSXtoGroupBSignals=ccasBwdRSXtoGroupBSignals, ccasRSTCompelledBwdToneOnTimer=ccasRSTCompelledBwdToneOnTimer, ccasVariantIndex=ccasVariantIndex, ccasBwdRSXtoGrpASendNextDNIS=ccasBwdRSXtoGrpASendNextDNIS, ccasRSTIncomingRegSigDuration=ccasRSTIncomingRegSigDuration, ccasIfExtVoiceCfgRepetition=ccasIfExtVoiceCfgRepetition, ccasGCnfRegSigMode=ccasGCnfRegSigMode, ccasFwdRSDataTransInternational=ccasFwdRSDataTransInternational, ccasProfileRowStatus=ccasProfileRowStatus, ccasIfExtIncomingLineSignalTable=ccasIfExtIncomingLineSignalTable, ccasGCnfPulseReceiveTimeout=ccasGCnfPulseReceiveTimeout, ccasIfExtMIBCompliance=ccasIfExtMIBCompliance, ccasIfExtVoiceCfgGroup=ccasIfExtVoiceCfgGroup, ccasGCnfInitialDelay=ccasGCnfInitialDelay, ccasVariantState=ccasVariantState, ccasFwdRSSubPriorNational=ccasFwdRSSubPriorNational, ccasFwdRSMaintenanceEquipment=ccasFwdRSMaintenanceEquipment, ccasIfExtConfigRegisterSignal=ccasIfExtConfigRegisterSignal, ccasFwdRSCCEchoSuppressor=ccasFwdRSCCEchoSuppressor, ccasBwdRSNatureOfCircuit=ccasBwdRSNatureOfCircuit, ciscoCasIfExtMIBConformance=ciscoCasIfExtMIBConformance, CASLineSignal=CASLineSignal, ccasILSMinBreakTime=ccasILSMinBreakTime, ccasIfExtRegisterSignalTable=ccasIfExtRegisterSignalTable, ccasILSSignalName=ccasILSSignalName, ccasBwdRSPlaySITTone=ccasBwdRSPlaySITTone, ccasBwdRSNextDigitANI=ccasBwdRSNextDigitANI, ccasRSTOutgoingRegSigDuration=ccasRSTOutgoingRegSigDuration, ccasFwdRSSatelLinkNotIncluded=ccasFwdRSSatelLinkNotIncluded, ccasIfExtVoiceCfgCcntrlProfile=ccasIfExtVoiceCfgCcntrlProfile, ccasLSTIdleGuardTimer=ccasLSTIdleGuardTimer, ccasIfExtVoiceCfgDs0ChannelsFail=ccasIfExtVoiceCfgDs0ChannelsFail, ccasGCnfNatureOfCircuit=ccasGCnfNatureOfCircuit, ccasIfExtVoiceCfgEventMappingIdx=ccasIfExtVoiceCfgEventMappingIdx, ccasLSTCASGlareTimer=ccasLSTCASGlareTimer, ccasOLSTxPattern=ccasOLSTxPattern, ccasILSMaxBreakTime=ccasILSMaxBreakTime, ccasIfExtVoiceCfgGwyLinkId=ccasIfExtVoiceCfgGwyLinkId, ccasIfExtVariantEntry=ccasIfExtVariantEntry, ccasIfExtConfigTimerGroup=ccasIfExtConfigTimerGroup, ccasGCnfMeteringRepIntThresh=ccasGCnfMeteringRepIntThresh, ccasIfExtVoiceCfgVadEnabled=ccasIfExtVoiceCfgVadEnabled, ccasBwdRSSubLineFreeWithNoCharge=ccasBwdRSSubLineFreeWithNoCharge, ciscoCasIfExtMIB=ciscoCasIfExtMIB, ccasFwdRSSubPriorInternational=ccasFwdRSSubPriorInternational, ccasLSTSeizeAckToDigitTimer=ccasLSTSeizeAckToDigitTimer, ccasProfileLineSigTimer=ccasProfileLineSigTimer, ccasLSTAnswerMeterDelayTimer=ccasLSTAnswerMeterDelayTimer, ccasBwdRSXtoGrpAResendLastDNIS=ccasBwdRSXtoGrpAResendLastDNIS, ccasBwdRSInfoEchoSuppressor=ccasBwdRSInfoEchoSuppressor, ccasIfExtRegSignalTimerTable=ccasIfExtRegSignalTimerTable, ccasFwdRSDataTransNational=ccasFwdRSDataTransNational, ccasGCnfOutCallPowerTwist=ccasGCnfOutCallPowerTwist, ccasBwdRSNextDigitDNIS=ccasBwdRSNextDigitDNIS, ccasIfExtProfileTable=ccasIfExtProfileTable, ccasVariantSource=ccasVariantSource, ccasFwdRSOtherLanguage2=ccasFwdRSOtherLanguage2, ccasFwdRSOtherLanguage=ccasFwdRSOtherLanguage, ccasGCnfLongTimer=ccasGCnfLongTimer, ccasProfileIndex=ccasProfileIndex, ccasGCnfLineSigType=ccasGCnfLineSigType, ccasIfExtVoiceCfgICSIntTimer=ccasIfExtVoiceCfgICSIntTimer, ccasFwdRSCCNoEchoSuppressor=ccasFwdRSCCNoEchoSuppressor, ccasRSGetValueFromValidIndex=ccasRSGetValueFromValidIndex, ccasBwdRSCongestion=ccasBwdRSCongestion, ccasGCnfIncCallPosTwist=ccasGCnfIncCallPosTwist, ccasRSTRowStatus=ccasRSTRowStatus, ccasFwdRSANIDigitAvailable=ccasFwdRSANIDigitAvailable, ciscoCasIfExtMIBNotifications=ciscoCasIfExtMIBNotifications, ccasIfExtVoiceCfgBulkCfgOwner=ccasIfExtVoiceCfgBulkCfgOwner, ccasILSMatchedRxPattern=ccasILSMatchedRxPattern, ccasRSTBwdPulseOnTimer=ccasRSTBwdPulseOnTimer, ccasRSInterpreFirstANIDigit=ccasRSInterpreFirstANIDigit, ccasGCnfIncCallLoFreqPower=ccasGCnfIncCallLoFreqPower, ccasRSTCompelledFwdToneOffTimer=ccasRSTCompelledFwdToneOffTimer, ccasGCnfIncCallBreakThreshold=ccasGCnfIncCallBreakThreshold, ccasGCnfRowStatus=ccasGCnfRowStatus, ccasLSTReleaseGuardTimer=ccasLSTReleaseGuardTimer, ccasRSSeqInfCollect=ccasRSSeqInfCollect, ccasFwdRSOtherLanguage1=ccasFwdRSOtherLanguage1, ccasVariantRowStatus=ccasVariantRowStatus, ccasFwdRSOperFwdTransFacility=ccasFwdRSOperFwdTransFacility, ccasRSTIncFwdPulseOnTimer=ccasRSTIncFwdPulseOnTimer, ccasGCnfDigitType=ccasGCnfDigitType, ccasBwdRSInvalidDialedNumber=ccasBwdRSInvalidDialedNumber, ccasIfExtMIBComplianceRev1=ccasIfExtMIBComplianceRev1, ccasRSTIndex=ccasRSTIndex, ccasGCnfMGCTimer=ccasGCnfMGCTimer, ccasRSTCalledPartyInterDigTimer=ccasRSTCalledPartyInterDigTimer, ccasIfExtVoiceCfgVadTimer=ccasIfExtVoiceCfgVadTimer, ccasGCnfOutCadenceOfftime=ccasGCnfOutCadenceOfftime, ccasFwdRSEndOfDNISDigit=ccasFwdRSEndOfDNISDigit, ccasIfExtRegisterSignalEntry=ccasIfExtRegisterSignalEntry, ccasIfExtLineSignalTimerEntry=ccasIfExtLineSignalTimerEntry, ccasFwdRSEndANICallingPartyNotRev=ccasFwdRSEndANICallingPartyNotRev, ccasIfExtLineSignalTimerTable=ccasIfExtLineSignalTimerTable, ccasGCnfDigitDetectMode=ccasGCnfDigitDetectMode, ccasBwdRSSubLineOutOfOrder=ccasBwdRSSubLineOutOfOrder, ccasFwdRSSubWithoutPriorNational=ccasFwdRSSubWithoutPriorNational, ccasGCnfCompelledSignalingType=ccasGCnfCompelledSignalingType, ccasLSTClearBwdTimer=ccasLSTClearBwdTimer, ccasLSTDelayBetRegAnsAndLineAns=ccasLSTDelayBetRegAnsAndLineAns, ccasIfExtVoiceCfgT38HsRedundancy=ccasIfExtVoiceCfgT38HsRedundancy, ccasGCnfStartTimer=ccasGCnfStartTimer, ccasBwdRSInternationalCongst=ccasBwdRSInternationalCongst, ccasProfileGeneralCfg=ccasProfileGeneralCfg, ccasBwdRSRepeatCalledDigit=ccasBwdRSRepeatCalledDigit, ccasRSTAnswerSigTimer=ccasRSTAnswerSigTimer, ccasIfExtRegSignalTimerEntry=ccasIfExtRegSignalTimerEntry, ccasIfExtGeneralConfigTable=ccasIfExtGeneralConfigTable, ccasLSTClearFwdTimer=ccasLSTClearFwdTimer, ccasFwdRSNoCategoryAvailble=ccasFwdRSNoCategoryAvailble, ciscoCasIfExtMIBObjects=ciscoCasIfExtMIBObjects, ccasRSSendFirstFwdSig=ccasRSSendFirstFwdSig, ccasOLSBreakTime=ccasOLSBreakTime, ccasBwdRSNetworkCongstInGroupB=ccasBwdRSNetworkCongstInGroupB, PYSNMP_MODULE_ID=ciscoCasIfExtMIB, ccasIfExtMIBComplianceRev2=ccasIfExtMIBComplianceRev2, ccasILSRxPattern=ccasILSRxPattern, ccasIfExtVoiceCfgUpspeedCodec=ccasIfExtVoiceCfgUpspeedCodec, ccasIfExtVoiceCfgEntry=ccasIfExtVoiceCfgEntry, ccasIfExtVoiceCfgTable=ccasIfExtVoiceCfgTable, ccasFwdRSIncHalfEchoRequired=ccasFwdRSIncHalfEchoRequired, ccasProfileRegisterSignal=ccasProfileRegisterSignal, ccasIfExtProfile=ccasIfExtProfile, ccasRSTCompelledFwdToneOnTimer=ccasRSTCompelledFwdToneOnTimer, ccasIfExtConfig=ccasIfExtConfig, ccasLSTIndex=ccasLSTIndex, ccasIfExtVoiceCfgT38HsPktPeriod=ccasIfExtVoiceCfgT38HsPktPeriod, ccasIfExtVoiceCfgCasVariant=ccasIfExtVoiceCfgCasVariant, ccasGCnfEchoCancellation=ccasGCnfEchoCancellation, ccasLSTRowStatus=ccasLSTRowStatus, ccasOLSSignalNameIndex=ccasOLSSignalNameIndex, ccasRSCountry=ccasRSCountry, ccasIfExtMIBComplianceRev3=ccasIfExtMIBComplianceRev3, ccasFwdRSSubsrcWithMeter=ccasFwdRSSubsrcWithMeter, ccasIfExtGeneralConfigGroup=ccasIfExtGeneralConfigGroup, ccasFwdRSOperatorCall=ccasFwdRSOperatorCall, ccasGCnfOutCallLoFreqPower=ccasGCnfOutCallLoFreqPower, ccasBwdRSPrevNminus3Digit=ccasBwdRSPrevNminus3Digit, ccasFwdRSTestCall=ccasFwdRSTestCall, ccasIfExtGeneralConfigEntry=ccasIfExtGeneralConfigEntry, ccasGCnfIndex=ccasGCnfIndex, ccasIfExtDs0GrpCfgTable=ccasIfExtDs0GrpCfgTable, ccasOLSMakeTime=ccasOLSMakeTime, ccasIfExtMIBCompliances=ccasIfExtMIBCompliances, ccasGCnfEndPointDirectional=ccasGCnfEndPointDirectional, ccasFwdRSOperNoFwdTransFacility=ccasFwdRSOperNoFwdTransFacility, ccasGCnfLongDurationTimer=ccasGCnfLongDurationTimer, CASCountryCode=CASCountryCode, ccasIfExtGeneralConfig=ccasIfExtGeneralConfig, ccasGCnfMaxNumCallParty=ccasGCnfMaxNumCallParty, ccasGCnfCountryCode=ccasGCnfCountryCode, ccasIfExtVoiceCfgLifNumber=ccasIfExtVoiceCfgLifNumber, ccasIfExtConfigLineSignal=ccasIfExtConfigLineSignal, ccasBwdRSSubscriberLineBusy=ccasBwdRSSubscriberLineBusy, ccasIfExtVoiceCfgT38MaxFaxTxRate=ccasIfExtVoiceCfgT38MaxFaxTxRate, ccasRSIndex=ccasRSIndex, ccasIfExtVariantTable=ccasIfExtVariantTable, ccasIfExtConfigTimer=ccasIfExtConfigTimer, ccasILSMaxMakeTime=ccasILSMaxMakeTime, ccasIfExtVoiceCfgGroupRev1=ccasIfExtVoiceCfgGroupRev1, ccasBwdRSRepeatLastDigit=ccasBwdRSRepeatLastDigit, ccasRSTOutFwdPulseOnTimer=ccasRSTOutFwdPulseOnTimer, ccasIfExtVoiceCfgContinuityTone1=ccasIfExtVoiceCfgContinuityTone1, ccasILSMatchedTxPattern=ccasILSMatchedTxPattern, ccasIfExtVoiceCfgTonePlan=ccasIfExtVoiceCfgTonePlan, ccasBwdRSPrevDigit=ccasBwdRSPrevDigit, ccasGCnfRingBackType=ccasGCnfRingBackType, ccasIfExtVoiceCfgGroupSup1=ccasIfExtVoiceCfgGroupSup1, ccasBwdRSXtoGrpASendDNISFrmBeg=ccasBwdRSXtoGrpASendDNISFrmBeg, ccasFwdRSSubsrcWithIDD=ccasFwdRSSubsrcWithIDD, ccasGCnfOutCadenceOntime=ccasGCnfOutCadenceOntime, ccasFwdRSANIDigitNotAvailable=ccasFwdRSANIDigitNotAvailable, ccasIfExtVoiceCfgGatewayIndex=ccasIfExtVoiceCfgGatewayIndex, ccasGCnfShortTimer=ccasGCnfShortTimer, ccasIfExtIncomingLineSignalEntry=ccasIfExtIncomingLineSignalEntry, ccasIfExtVoiceCfgContinuityTone2=ccasIfExtVoiceCfgContinuityTone2, ccasGCnfSubscriberCategory=ccasGCnfSubscriberCategory, ccasIfExtDs0GrpRepeatResult=ccasIfExtDs0GrpRepeatResult, ccasGCnfParmSource=ccasGCnfParmSource, ccasIfExtOutgoingLineSignalEntry=ccasIfExtOutgoingLineSignalEntry, ccasFwdRSDiscriminatorDigit=ccasFwdRSDiscriminatorDigit, ccasFwdRSRequestNotAccepted=ccasFwdRSRequestNotAccepted, ccasRSSubRegion=ccasRSSubRegion, ccasBwdRSSubLineFreeWithCharge=ccasBwdRSSubLineFreeWithCharge, ccasIfExtVoiceCfgNoiseRegType=ccasIfExtVoiceCfgNoiseRegType, ccasGCnfTxDigitOrder=ccasGCnfTxDigitOrder, ccasBwdRSCallingPartyCategory=ccasBwdRSCallingPartyCategory, ccasILSSignalNameIndex=ccasILSSignalNameIndex, ccasIfExtProfileGroup=ccasIfExtProfileGroup, ccasIfExtProfileEntry=ccasIfExtProfileEntry, ccasBwdRSCountryCode=ccasBwdRSCountryCode, ccasBwdRSSGrpCCong=ccasBwdRSSGrpCCong, ccasGCnfGlarePolicy=ccasGCnfGlarePolicy, ccasFwdRSCCInsertEchoSuppressor=ccasFwdRSCCInsertEchoSuppressor, ccasBwdRSPrevNminus2Digit=ccasBwdRSPrevNminus2Digit, ccasILSMinMakeTime=ccasILSMinMakeTime, ccasBwdRSLangDiscr=ccasBwdRSLangDiscr, ccasIfExtDs0GrpRepetition=ccasIfExtDs0GrpRepetition, ccasVariantNumberCount=ccasVariantNumberCount, ccasBwdRSSSendCatSwGrpB=ccasBwdRSSSendCatSwGrpB, ccasIfExtVoiceCfgCasProfile=ccasIfExtVoiceCfgCasProfile, ccasIfExtVoiceCfgBulkCfgResult=ccasIfExtVoiceCfgBulkCfgResult, ccasIfExtOutgoingLineSignalTable=ccasIfExtOutgoingLineSignalTable, ccasIfExtVoiceCfgModemPassThru=ccasIfExtVoiceCfgModemPassThru, ccasGCnfIncCallNegTwist=ccasGCnfIncCallNegTwist, ccasIfExtDs0GrpCfgEntry=ccasIfExtDs0GrpCfgEntry, ccasBwdRSXtoGroupC=ccasBwdRSXtoGroupC, ccasIfExtConfigLineSignalGroup=ccasIfExtConfigLineSignalGroup, ccasVariantFile=ccasVariantFile)
