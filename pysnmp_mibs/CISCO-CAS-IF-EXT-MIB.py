...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CAS-IF-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:33:11 2025
...
_CcasIfExtVoiceCfgCcntrlProfile_Type.__name__ = "CCallControlProfileIndexOrZero"
...
_CcasIfExtVoiceCfgT38MaxFaxTxRate_Type.__name__ = "CvcFaxTransmitRate"
...
_CcasIfExtVoiceCfgT38HsPktPeriod_Type.__name__ = "CiscoCodecPacketPeriod"
...
_CcasIfExtVoiceCfgRepetition_Type.__name__ = "ConfigIterator"
...
_CcasIfExtVoiceCfgICSEnable_Type.__name__ = "TruthValue"
...
_CcasIfExtDs0GrpRepetition_Type.__name__ = "ConfigIterator"
...
_CcasGCnfRegSigMode_Type.__name__ = "CASRegisterSignal"
...
ccasIfExtMIBCompliance.setObjects(
      *(("CISCO-CAS-IF-EXT-MIB", "ccasIfExtVoiceCfgGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtBulkGroup"))
)
if mibBuilder.loadTexts:
...
ccasIfExtMIBComplianceRev1.setObjects(
      *(("CISCO-CAS-IF-EXT-MIB", "ccasIfExtVoiceCfgGroupRev1"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtBulkGroup"))
)
if mibBuilder.loadTexts:
...
ccasIfExtMIBComplianceRev2.setObjects(
      *(("CISCO-CAS-IF-EXT-MIB", "ccasIfExtVoiceCfgGroupRev1"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtBulkGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtVoiceCfgCasGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtProfileGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtConfigLineSignalGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtConfigRegisterSignalGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtConfigTimerGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtGeneralConfigGroup"))
)
if mibBuilder.loadTexts:
...
ccasIfExtMIBComplianceRev3.setObjects(
      *(("CISCO-CAS-IF-EXT-MIB", "ccasIfExtVoiceCfgGroupRev1"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtBulkGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtVoiceCfgCasGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtProfileGroup"),
        ...
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtConfigTimerGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtGeneralConfigGroup"),
        ("CISCO-CAS-IF-EXT-MIB", "ccasIfExtVoiceCfgGroupSup1"))
)
if mibBuilder.loadTexts:
