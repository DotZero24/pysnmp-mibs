...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-CONFIG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:28:02 2025
...
cucsConfigImpactAffectedChassis = _CucsConfigImpactAffectedChassis_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 61, 2, 1, 13),
    _CucsConfigImpactAffectedChassis_Type()
)
cucsConfigImpactAffectedChassis.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsConfigImpactAffectedChassis.setStatus("current")
...
cucsConfigImpactChassisConfigIssues = _CucsConfigImpactChassisConfigIssues_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 61, 2, 1, 14),
    _CucsConfigImpactChassisConfigIssues_Type()
)
cucsConfigImpactChassisConfigIssues.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsConfigImpactChassisConfigIssues.setStatus("current")
...
cucsConfigImpactChassisConfigQualifier = _CucsConfigImpactChassisConfigQualifier_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 61, 2, 1, 15),
    _CucsConfigImpactChassisConfigQualifier_Type()
)
cucsConfigImpactChassisConfigQualifier.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsConfigImpactChassisConfigQualifier.setStatus("current")
...
cucsConfigImpactChassisConfigState = _CucsConfigImpactChassisConfigState_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 61, 2, 1, 16),
    _CucsConfigImpactChassisConfigState_Type()
)
cucsConfigImpactChassisConfigState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsConfigImpactChassisConfigState.setStatus("current")
...
cucsConfigManagedEpImpactResponseAffectedChassisCnt = _CucsConfigManagedEpImpactResponseAffectedChassisCnt_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 61, 3, 1, 12),
    _CucsConfigManagedEpImpactResponseAffectedChassisCnt_Type()
)
cucsConfigManagedEpImpactResponseAffectedChassisCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsConfigManagedEpImpactResponseAffectedChassisCnt.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsConfigObjects": cucsConfigObjects,
       ...
       "cucsConfigImpactAffectedChassis": cucsConfigImpactAffectedChassis,
       "cucsConfigImpactChassisConfigIssues": cucsConfigImpactChassisConfigIssues,
       "cucsConfigImpactChassisConfigQualifier": cucsConfigImpactChassisConfigQualifier,
       "cucsConfigImpactChassisConfigState": cucsConfigImpactChassisConfigState,
       ...
       "cucsConfigManagedEpImpactResponseAffectedChassisCnt": cucsConfigManagedEpImpactResponseAffectedChassisCnt}
)
