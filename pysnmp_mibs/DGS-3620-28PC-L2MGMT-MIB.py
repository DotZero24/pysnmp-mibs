# SNMP MIB module (DGS-3620-28PC-L2MGMT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DGS-3620-28PC-L2MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:47:27 2025
...
swDevInfoTotalNumOfPort = _SwDevInfoTotalNumOfPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 1, 1),
...
swDevInfoNumOfPortInUse = _SwDevInfoNumOfPortInUse_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 1, 2),
...
swL2DevCtrl = _SwL2DevCtrl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2)
)
...
swL2DevCtrlSnmpTrapState = _SwL2DevCtrlSnmpTrapState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 5),
...
swL2DevCtrlCleanAllStatisticCounter = _SwL2DevCtrlCleanAllStatisticCounter_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 6),
...
swL2DevCtrlVlanIdOfFDBTbl = _SwL2DevCtrlVlanIdOfFDBTbl_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 7),
...
swL2MACNotifyState = _SwL2MACNotifyState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 8),
...
swL2MACNotifyHistorySize = _SwL2MACNotifyHistorySize_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 9),
...
swL2MACNotifyInterval = _SwL2MACNotifyInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 10),
...
swL2DevCtrlAsymVlanState = _SwL2DevCtrlAsymVlanState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 13),
...
swL2DevCtrlTelnet = _SwL2DevCtrlTelnet_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 14)
)
...
swL2DevCtrlTelnetState = _SwL2DevCtrlTelnetState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 14, 1),
...
swL2DevCtrlTelnetTcpPort = _SwL2DevCtrlTelnetTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 14, 2),
...
swL2DevCtrlManagementVlanId = _SwL2DevCtrlManagementVlanId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 16),
...
swL2DevCtrlWeb = _SwL2DevCtrlWeb_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 17)
)
...
swL2DevCtrlWebState = _SwL2DevCtrlWebState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 17, 1),
...
swL2DevCtrlWebTcpPort = _SwL2DevCtrlWebTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 17, 2),
...
swL2DevCtrlLLDPState = _SwL2DevCtrlLLDPState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 18),
...
swL2DevCtrlLLDPForwardMessageState = _SwL2DevCtrlLLDPForwardMessageState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 19),
...
swL2DevCtrlIpAutoconfig = _SwL2DevCtrlIpAutoconfig_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 20),
...
swL2DevCtrlCFM = _SwL2DevCtrlCFM_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21)
)
...
swL2DevCtrlCFMState = _SwL2DevCtrlCFMState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 1),
...
swL2DevCtrlCFMPortTable = _SwL2DevCtrlCFMPortTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 2)
)
if mibBuilder.loadTexts:
...
swL2DevCtrlCFMPortEntry = _SwL2DevCtrlCFMPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 2, 1)
)
swL2DevCtrlCFMPortEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2DevCtrlCFMPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2DevCtrlCFMPortIndex = _SwL2DevCtrlCFMPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 2, 1, 1),
...
swL2DevCtrlCFMPortState = _SwL2DevCtrlCFMPortState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 2, 1, 2),
...
swL2DevCtrlCFMMaTable = _SwL2DevCtrlCFMMaTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 3)
)
if mibBuilder.loadTexts:
...
swL2DevCtrlCFMMaEntry = _SwL2DevCtrlCFMMaEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 3, 1)
)
...
swL2DevCtrlCFMMaMode = _SwL2DevCtrlCFMMaMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 3, 1, 1),
...
swL2DevCtrlCFMMepTable = _SwL2DevCtrlCFMMepTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 4)
)
if mibBuilder.loadTexts:
...
swL2DevCtrlCFMMepEntry = _SwL2DevCtrlCFMMepEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 4, 1)
)
...
swL2DevCtrlCFMMepMode = _SwL2DevCtrlCFMMepMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 21, 4, 1, 1),
...
swL2DevCtrlVLANTrunkState = _SwL2DevCtrlVLANTrunkState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 2, 22),
...
swL2DevAlarm = _SwL2DevAlarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 3)
)
...
swL2DevAlarmNewRoot = _SwL2DevAlarmNewRoot_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 3, 1),
...
swL2DevAlarmTopologyChange = _SwL2DevAlarmTopologyChange_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 3, 2),
...
swL2DevAlarmLinkChange = _SwL2DevAlarmLinkChange_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 1, 3, 3),
...
swL2VlanStaticEntry = _SwL2VlanStaticEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 1, 1)
)
swL2VlanStaticEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2VlanIndex"),
)
if mibBuilder.loadTexts:
...
swL2VlanIndex = _SwL2VlanIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 1, 1, 1),
    _SwL2VlanIndex_Type()
)
...
swL2VLANAdvertisement = _SwL2VLANAdvertisement_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 1, 1, 2),
...
swL2PVIDAutoAssignmentState = _SwL2PVIDAutoAssignmentState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 2),
...
swL2VlanPortInfoTable = _SwL2VlanPortInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 3)
)
if mibBuilder.loadTexts:
...
swL2VlanPortInfoEntry = _SwL2VlanPortInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 3, 1)
)
swL2VlanPortInfoEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2VlanPortInfoPortIndex"),
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2VlanPortInfoVid"),
)
if mibBuilder.loadTexts:
...
swL2VlanPortInfoPortIndex = _SwL2VlanPortInfoPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 3, 1, 1),
...
swL2VlanPortInfoVid = _SwL2VlanPortInfoVid_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 3, 1, 2),
...
swL2VlanPortInfoPortRole = _SwL2VlanPortInfoPortRole_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 3, 1, 3),
...
swL2NniGvrpBpduAddress = _SwL2NniGvrpBpduAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 2, 6),
...
swL2PortInfoPortIndex = _SwL2PortInfoPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 1, 1, 1),
...
swL2PortInfoMediumType = _SwL2PortInfoMediumType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 1, 1, 2),
...
swL2PortInfoUnitID = _SwL2PortInfoUnitID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 1, 1, 3),
...
swL2PortInfoType = _SwL2PortInfoType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 1, 1, 4),
...
swL2PortInfoLinkStatus = _SwL2PortInfoLinkStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 1, 1, 5),
...
swL2PortInfoNwayStatus = _SwL2PortInfoNwayStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 1, 1, 6),
...
swL2PortInfoErrorDisabled = _SwL2PortInfoErrorDisabled_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 1, 1, 8),
...
swL2PortCtrlTable = _SwL2PortCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2)
)
if mibBuilder.loadTexts:
    swL2PortCtrlTable.setStatus("current")
_SwL2PortCtrlEntry_Object = MibTableRow
swL2PortCtrlEntry = _SwL2PortCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1)
)
swL2PortCtrlEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2PortCtrlPortIndex"),
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2PortCtrlMediumType"),
)
if mibBuilder.loadTexts:
...
swL2PortCtrlPortIndex = _SwL2PortCtrlPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1, 1),
...
swL2PortCtrlMediumType = _SwL2PortCtrlMediumType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1, 2),
...
swL2PortCtrlUnitIndex = _SwL2PortCtrlUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1, 3),
...
swL2PortCtrlAdminState = _SwL2PortCtrlAdminState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1, 4),
...
swL2PortCtrlNwayState = _SwL2PortCtrlNwayState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1, 5),
...
swL2PortCtrlFlowCtrlState = _SwL2PortCtrlFlowCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1, 6),
...
swL2PortCtrlLearningState = _SwL2PortCtrlLearningState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1, 7),
...
swL2PortCtrlMACNotifyState = _SwL2PortCtrlMACNotifyState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1, 8),
...
swL2PortCtrlMDIXState = _SwL2PortCtrlMDIXState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 2, 1, 10),
...
swL2PortCtrlJumboFrame = _SwL2PortCtrlJumboFrame_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 3),
...
swL2PortCtrlJumboFrameMaxSize = _SwL2PortCtrlJumboFrameMaxSize_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 4),
...
swL2PortCounterCtrlTable = _SwL2PortCounterCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 6)
)
if mibBuilder.loadTexts:
...
swL2PortCounterCtrlEntry = _SwL2PortCounterCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 6, 1)
)
swL2PortCounterCtrlEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2PortCounterCtrlPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortCounterCtrlPortIndex = _SwL2PortCounterCtrlPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 6, 1, 1),
...
swL2PortCounterClearCtrl = _SwL2PortCounterClearCtrl_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 6, 1, 2),
...
swL2PortDropCounterTable = _SwL2PortDropCounterTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9)
)
if mibBuilder.loadTexts:
...
swL2PortDropCounterEntry = _SwL2PortDropCounterEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1)
)
swL2PortDropCounterEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2PortDropCounterPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortDropCounterPortIndex = _SwL2PortDropCounterPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1, 1),
...
swL2PortBufferFullDrops = _SwL2PortBufferFullDrops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1, 2),
...
swL2PortACLDrops = _SwL2PortACLDrops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1, 3),
...
swL2PortMulticastDrops = _SwL2PortMulticastDrops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1, 4),
...
swL2PortVLANIngressDrops = _SwL2PortVLANIngressDrops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1, 5),
...
swL2PortInvalidIPv6Drops = _SwL2PortInvalidIPv6Drops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1, 7),
...
swL2PortSTPDrops = _SwL2PortSTPDrops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1, 8),
...
swL2PortStormAndFDBDiscard = _SwL2PortStormAndFDBDiscard_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1, 9),
...
swL2PortMTUDrops = _SwL2PortMTUDrops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 9, 1, 10),
...
swL2PortJumboFrameCtrlTable = _SwL2PortJumboFrameCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 10)
)
if mibBuilder.loadTexts:
...
swL2PortJumboFrameCtrlEntry = _SwL2PortJumboFrameCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 10, 1)
)
swL2PortJumboFrameCtrlEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2PortJumboFrameCtrlPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortJumboFrameCtrlPortIndex = _SwL2PortJumboFrameCtrlPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 10, 1, 1),
...
swL2PortJumboFrameCtrlPortState = _SwL2PortJumboFrameCtrlPortState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 10, 1, 2),
...
swL2PortSfpInfoTable = _SwL2PortSfpInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11)
)
if mibBuilder.loadTexts:
...
swL2PortSfpInfoEntry = _SwL2PortSfpInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1)
)
swL2PortSfpInfoEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2PortSfpInfoPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortSfpInfoPortIndex = _SwL2PortSfpInfoPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 1),
...
swL2PortSfpInfoConnectType = _SwL2PortSfpInfoConnectType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 2),
...
swL2PortSfpInfoVendorName = _SwL2PortSfpInfoVendorName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 3),
...
swL2PortSfpInfoVendorPN = _SwL2PortSfpInfoVendorPN_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 4),
...
swL2PortSfpInfoVendorSN = _SwL2PortSfpInfoVendorSN_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 5),
...
swL2PortSfpInfoVendorOUI = _SwL2PortSfpInfoVendorOUI_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 6),
...
swL2PortSfpInfoVendorRev = _SwL2PortSfpInfoVendorRev_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 7),
...
swL2PortSfpInfoDateCode = _SwL2PortSfpInfoDateCode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 8),
...
swL2PortSfpInfoFiberType = _SwL2PortSfpInfoFiberType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 9),
...
swL2PortSfpInfoBaudRate = _SwL2PortSfpInfoBaudRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 10),
...
swL2PortSfpInfoWavelength = _SwL2PortSfpInfoWavelength_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 11, 1, 11),
...
swL2PortStatisTable = _SwL2PortStatisTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 12)
)
if mibBuilder.loadTexts:
...
swL2PortStatisEntry = _SwL2PortStatisEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 12, 1)
)
swL2PortStatisEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2PortStatisPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortStatisPortIndex = _SwL2PortStatisPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 12, 1, 1),
...
swL2PortStatisPkts1519to1522Octets = _SwL2PortStatisPkts1519to1522Octets_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 12, 1, 2),
...
swL2PortStatisPkts1519to2047Octets = _SwL2PortStatisPkts1519to2047Octets_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 12, 1, 3),
...
swL2PortStatisPkts2048to4095Octets = _SwL2PortStatisPkts2048to4095Octets_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 12, 1, 4),
...
swL2PortStatisPkts4096to9216Octets = _SwL2PortStatisPkts4096to9216Octets_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 12, 1, 5),
...
swL2PortTXDropCounterTable = _SwL2PortTXDropCounterTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13)
)
if mibBuilder.loadTexts:
...
swL2PortTXDropCounterEntry = _SwL2PortTXDropCounterEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1)
)
swL2PortTXDropCounterEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2PortTXDropCounterPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortTXDropCounterPortIndex = _SwL2PortTXDropCounterPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 1),
...
swL2PortTXHOLDrops = _SwL2PortTXHOLDrops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 2),
...
swL2PortTXCOS0Drops = _SwL2PortTXCOS0Drops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 3),
...
swL2PortTXCOS1Drops = _SwL2PortTXCOS1Drops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 4),
...
swL2PortTXCOS2Drops = _SwL2PortTXCOS2Drops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 5),
...
swL2PortTXCOS3Drops = _SwL2PortTXCOS3Drops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 6),
...
swL2PortTXCOS4Drops = _SwL2PortTXCOS4Drops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 7),
...
swL2PortTXCOS5Drops = _SwL2PortTXCOS5Drops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 8),
...
swL2PortTXCOS6Drops = _SwL2PortTXCOS6Drops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 9),
...
swL2PortTXCOS7Drops = _SwL2PortTXCOS7Drops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 10),
...
swL2PortTXSTPDrops = _SwL2PortTXSTPDrops_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 13, 1, 11),
...
swL2TrunkMaxSupportedEntries = _SwL2TrunkMaxSupportedEntries_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 1),
...
swL2TrunkCurrentNumEntries = _SwL2TrunkCurrentNumEntries_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 2),
...
swL2TrunkIndex = _SwL2TrunkIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 3, 1, 1),
...
swL2TrunkMasterPort = _SwL2TrunkMasterPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 3, 1, 3),
...
swL2TrunkMember = _SwL2TrunkMember_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 3, 1, 4),
...
swL2TrunkFloodingPort = _SwL2TrunkFloodingPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 3, 1, 5),
...
swL2TrunkType = _SwL2TrunkType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 3, 1, 6),
    _SwL2TrunkType_Type()
)
...
swL2TrunkState = _SwL2TrunkState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 3, 1, 7),
...
swL2TrunkAlgorithm = _SwL2TrunkAlgorithm_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 4),
...
swL2TrunkLACPPortTable = _SwL2TrunkLACPPortTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 5)
)
if mibBuilder.loadTexts:
...
swL2TrunkLACPPortEntry = _SwL2TrunkLACPPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 5, 1)
)
swL2TrunkLACPPortEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2TrunkLACPPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2TrunkLACPPortIndex = _SwL2TrunkLACPPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 5, 1, 1),
...
swL2TrunkLACPPortState = _SwL2TrunkLACPPortState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 5, 1, 2),
...
swL2TrunkVLANPort = _SwL2TrunkVLANPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 6, 1, 1),
...
swL2TrunkVLANState = _SwL2TrunkVLANState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 9, 6, 1, 2),
...
swL2MirrorLogicTargetPort = _SwL2MirrorLogicTargetPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 1),
...
swL2MirrorPortSourceIngress = _SwL2MirrorPortSourceIngress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 2),
...
swL2MirrorPortSourceEgress = _SwL2MirrorPortSourceEgress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 3),
...
swL2MirrorPortState = _SwL2MirrorPortState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 4),
...
swL2MirrorGroupTable = _SwL2MirrorGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 5)
)
if mibBuilder.loadTexts:
...
swL2MirrorGroupEntry = _SwL2MirrorGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 5, 1)
)
swL2MirrorGroupEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2MirrorGroupID"),
)
if mibBuilder.loadTexts:
...
swL2MirrorGroupID = _SwL2MirrorGroupID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 5, 1, 1),
...
swL2MirrorGroupRowStatus = _SwL2MirrorGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 5, 1, 2),
...
swL2MirrorGroupState = _SwL2MirrorGroupState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 5, 1, 3),
...
swL2MirrorGroupLogicTargetPort = _SwL2MirrorGroupLogicTargetPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 5, 1, 4),
...
swL2MirrorGroupPortSourceIngress = _SwL2MirrorGroupPortSourceIngress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 5, 1, 5),
...
swL2MirrorGroupPortSourceEngress = _SwL2MirrorGroupPortSourceEngress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 10, 5, 1, 6),
...
swL2IGMPAccessAuthEntry = _SwL2IGMPAccessAuthEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 11, 13, 1)
)
swL2IGMPAccessAuthEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2IGMPAccessAuthPort"),
)
if mibBuilder.loadTexts:
...
swL2IGMPAccessAuthPort = _SwL2IGMPAccessAuthPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 11, 13, 1, 1),
...
swL2IGMPAccessAuthState = _SwL2IGMPAccessAuthState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 11, 13, 1, 2),
...
swL2TrafficSegEntry = _SwL2TrafficSegEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 14, 1, 1)
)
swL2TrafficSegEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2TrafficSegPort"),
)
if mibBuilder.loadTexts:
...
swL2TrafficSegPort = _SwL2TrafficSegPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 14, 1, 1, 1),
...
swL2TrafficSegForwardPorts = _SwL2TrafficSegForwardPorts_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 14, 1, 1, 2),
...
swL2MulticastFilterModeVlanTable = _SwL2MulticastFilterModeVlanTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 17, 1)
)
if mibBuilder.loadTexts:
...
swL2MulticastFilterModeVlanEntry = _SwL2MulticastFilterModeVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 17, 1, 1)
)
swL2MulticastFilterModeVlanEntry.setIndexNames(
    (0, "DGS-3620-28PC-L2MGMT-MIB", "swL2MulticastFilterVid"),
)
if mibBuilder.loadTexts:
...
swL2MulticastFilterVid = _SwL2MulticastFilterVid_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 17, 1, 1, 1),
...
swL2MulticastFilterVlanMode = _SwL2MulticastFilterVlanMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 17, 1, 1, 2),
...
swL2macNotificationSeverity = _SwL2macNotificationSeverity_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 100, 1, 1, 1),
...
swL2PortSecurityViolationSeverity = _SwL2PortSecurityViolationSeverity_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 100, 1, 1, 2),
...
swL2macNotifyInfo = _SwL2macNotifyInfo_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 100, 1, 2, 1, 1),
...
swL2PortSecurityViolationMac = _SwL2PortSecurityViolationMac_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 100, 1, 2, 1, 2),
...
swL2macNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 100, 1, 2, 0, 1)
)
swL2macNotification.setObjects(
    ("DGS-3620-28PC-L2MGMT-MIB", "swL2macNotifyInfo")
)
if mibBuilder.loadTexts:
...
swL2PortSecurityViolationTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 100, 1, 2, 0, 2)
)
swL2PortSecurityViolationTrap.setObjects(
      *(("PORT-SECURITY-MIB", "swPortSecPortIndex"),
        ("DGS-3620-28PC-L2MGMT-MIB", "swL2PortSecurityViolationMac"))
)
if mibBuilder.loadTexts:
