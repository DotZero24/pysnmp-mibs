...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/eaton/XUPS-MIB
...
xupsEnvRemoteTempLowerLimit, xupsEnvRemoteTempUpperLimit, xupsEnvRemoteHumidityUpperLimit, xupsEnvRemoteHumidityLowerLimit, xupsContactDescr, xupsEnvRemoteTemp, xupsContactState, xupsContactType, xupsEnvRemoteHumidity, xupsContactIndex = mibBuilder.importSymbols("EATON-EMP-MIB", "xupsEnvRemoteTempLowerLimit", "xupsEnvRemoteTempUpperLimit", "xupsEnvRemoteHumidityUpperLimit", "xupsEnvRemoteHumidityLowerLimit", "xupsContactDescr", "xupsEnvRemoteTemp", "xupsContactState", "xupsContactType", "xupsEnvRemoteHumidity", "xupsContactIndex")
...
mibBuilder.exportSymbols("XUPS-MIB", PYSNMP_MODULE_ID=xupsMIB, xupsInverterFailure=xupsInverterFailure, xupsBatteryLowCapacity=xupsBatteryLowCapacity, xupsInputTable=xupsInputTable, xupstdUtilityPowerRestored=xupstdUtilityPowerRestored, xupsRecepStatus=xupsRecepStatus, xupsIdentSerialNumber=xupsIdentSerialNumber, xupsInputSource=xupsInputSource, xupsAlarmTime=xupsAlarmTime, xupsBatteryFullGroup=xupsBatteryFullGroup, xupstdDiagnosticTestPassed=xupstdDiagnosticTestPassed, xupsInputFailure=xupsInputFailure, xupstdOnMaintenanceBypass=xupstdOnMaintenanceBypass, xupsMaxTrapLevel=xupsMaxTrapLevel, xupsOutput=xupsOutput, xupsDualInputStatus=xupsDualInputStatus, xupstdControlOff=xupstdControlOff, xupsRecepCumulativePowerUsageTimer=xupsRecepCumulativePowerUsageTimer, xupstdBatteryDischarged=xupstdBatteryDischarged, xupsAlarmEventEntry=xupsAlarmEventEntry, xupsInputName=xupsInputName, xupsAlarmEntryAdded=xupsAlarmEntryAdded, xupsAlarmFuseFailure=xupsAlarmFuseFailure, xupsBypassAveragePowerFactor=xupsBypassAveragePowerFactor, xupsReturnFromLowBattery=xupsReturnFromLowBattery, xupsEnvAmbientLowerLimit=xupsEnvAmbientLowerLimit, xupsControlOutputOnDelay=xupsControlOutputOnDelay, xupsIdentOemCode=xupsIdentOemCode, xupsBatVoltage=xupsBatVoltage, xupsOutputStatus=xupsOutputStatus, xupsAlarmNumEvents=xupsAlarmNumEvents, xupsHeartbeatMinsInterval=xupsHeartbeatMinsInterval, xupstdAlarmEntryAdded=xupstdAlarmEntryAdded, xupsOutputTableFullGroup=xupsOutputTableFullGroup, xupsTestFullGroup=xupsTestFullGroup, xupstdRemoteTempBad=xupstdRemoteTempBad, xupsAlarmID=xupsAlarmID, xupsOnBypass=xupsOnBypass, xupsRecepEntry=xupsRecepEntry, xupstdOutputOverload=xupstdOutputOverload, xupstdUpsShutdownPending=xupstdUpsShutdownPending, xupsInputTotalFullGroup=xupsInputTotalFullGroup, xupsBattery=xupsBattery, xupsInputCurrentHighPrecision=xupsInputCurrentHighPrecision, xupsInputStatus=xupsInputStatus, xupsOutputLoad=xupsOutputLoad, xupsBypassFrequency=xupsBypassFrequency, xupsTestStart=xupsTestStart, xupsAlarmTempBad=xupsAlarmTempBad, xupsConfigOutputWatts=xupsConfigOutputWatts, xupsInputCurrent=xupsInputCurrent, xupstdEMPNotifyGroup=xupstdEMPNotifyGroup, xupstdLowBattery=xupstdLowBattery, xupsTrapControl=xupsTrapControl, xupsInputLineBads=xupsInputLineBads, xupsRecepCumulativePowerUsage=xupsRecepCumulativePowerUsage, xupsAltPowerNotAvailable=xupsAltPowerNotAvailable, xupsOutputFrequency=xupsOutputFrequency, xupstdInternalFailure=xupstdInternalFailure, xupsRecepFullGroup=xupsRecepFullGroup, xupsTopoMachineCode=xupsTopoMachineCode, xupsAlarmTable=xupsAlarmTable, xupsAlarmFanFailure=xupsAlarmFanFailure, xupstdAgentDown=xupstdAgentDown, xupsInputTableFullGroup=xupsInputTableFullGroup, xupsInputVoltage=xupsInputVoltage, xupsAgentSoftwareVersion=xupsAgentSoftwareVersion, xupsBypassWatts=xupsBypassWatts, xupsOnBattery=xupsOnBattery, xupsOutputAveragePowerFactor=xupsOutputAveragePowerFactor, xupsRecepTable=xupsRecepTable, xupsRecep=xupsRecep, xupsConfigHighOutputVoltageLimit=xupsConfigHighOutputVoltageLimit, xupstdInputFailure=xupstdInputFailure, xupsOutputId=xupsOutputId, xupsInputTotal=xupsInputTotal, xupsLossOfRedundancy=xupsLossOfRedundancy, xupsAlarmAwaitingPower=xupsAlarmAwaitingPower, xupsLoadShedSecsWithRestart=xupsLoadShedSecsWithRestart, xupsBypassId=xupsBypassId, xupsBreakerOpen=xupsBreakerOpen, xupstdInverterFailure=xupstdInverterFailure, xupsAlarms=xupsAlarms, xupsControlOutputOffTrapDelay=xupsControlOutputOffTrapDelay, xupsMIB=xupsMIB, xupsTest=xupsTest, xupsBatCurrent=xupsBatCurrent, xupsLowBattery=xupsLowBattery, xupsTrapControlFullGroup=xupsTrapControlFullGroup, xupsInputFullGroup=xupsInputFullGroup, xupsAlarmDescr=xupsAlarmDescr, xupsOutputNumPhases=xupsOutputNumPhases, xupsOutputTotal=xupsOutputTotal, xupsRemoteTempBad=xupsRemoteTempBad, xupsBypassEntry=xupsBypassEntry, xupstdReturnFromLowBattery=xupstdReturnFromLowBattery, xupstdOutputOffAsRequested=xupstdOutputOffAsRequested, xupsOutputOffAsRequested=xupsOutputOffAsRequested, xupstdNotifyGroup=xupstdNotifyGroup, xupsIdentModel=xupsIdentModel, xupsAlarm=xupsAlarm, xupsBatteryNotPresent=xupsBatteryNotPresent, xupsAgent=xupsAgent, xupsConfigInstallDate=xupsConfigInstallDate, xupsRecepOnDelaySecs=xupsRecepOnDelaySecs, xupsBypassNotAvailable=xupsBypassNotAvailable, xupsTopology=xupsTopology, xupsTopologyFullGroup=xupsTopologyFullGroup, xupsTestBatteryStatus=xupsTestBatteryStatus, xupstdLossOfRedundancy=xupstdLossOfRedundancy, xupsLastGeneralTest=xupsLastGeneralTest, xupsBypassTableFullGroup=xupsBypassTableFullGroup, xupsInput=xupsInput, xupsConfigInputVoltage=xupsConfigInputVoltage, xupsInputAverageVoltage=xupsInputAverageVoltage, xupsBypassTotalWatts=xupsBypassTotalWatts, xupsOutputTable=xupsOutputTable, xupsRemoteHumidityBad=xupsRemoteHumidityBad, xupstdOnBattery=xupstdOnBattery, xupstdAlarmTestInProgress=xupstdAlarmTestInProgress, xupsBypassNumPhases=xupsBypassNumPhases, xupsBypassFullGroup=xupsBypassFullGroup, xupsDiagnosticTestFailed=xupsDiagnosticTestFailed, xupsBuildingAlarm=xupsBuildingAlarm, xupsInputWatts=xupsInputWatts, xupsUtilityPowerRestored=xupsUtilityPowerRestored, xupsConfigDateAndTime=xupsConfigDateAndTime, xupsOutputFullGroup=xupsOutputFullGroup, xupsAlarmBatteryBad=xupsAlarmBatteryBad, xupsConfigLowOutputVoltageLimit=xupsConfigLowOutputVoltageLimit, xupsEnvironmentFullGroup=xupsEnvironmentFullGroup, xupsOnAlternatePowerSource=xupsOnAlternatePowerSource, xupstdContactInactiveNotice=xupstdContactInactiveNotice, xupsIdentFullGroup=xupsIdentFullGroup, xupsOutputAverageVoltage=xupsOutputAverageVoltage, xupsTopoUnitNumber=xupsTopoUnitNumber, xupsInputTotalWatts=xupsInputTotalWatts, xupsBatCapacity=xupsBatCapacity, xupsModuleFailure=xupsModuleFailure, xupstdNoticeCondition=xupstdNoticeCondition, xupsOnInverter=xupsOnInverter, xupsControlOutputOffDelay=xupsControlOutputOffDelay, xupsInputFrequency=xupsInputFrequency, xupsInternalFailure=xupsInternalFailure, xupsAlarmEventID=xupsAlarmEventID, xupsTestTrap=xupsTestTrap, xupsSwitchable=xupsSwitchable, xupsRecepAutoOnDelay=xupsRecepAutoOnDelay, xupsInputEntry=xupsInputEntry, xupsBatTimeRemaining=xupsBatTimeRemaining, xupsOutputHourlyPowerUsage=xupsOutputHourlyPowerUsage, xupsLastGeneralTestResult=xupsLastGeneralTestResult, xupstdCommunicationsLost=xupstdCommunicationsLost, xupstdAlarmTempBad=xupstdAlarmTempBad, xupsOutputName=xupsOutputName, xupsBypassName=xupsBypassName, xupsAlarmEventTable=xupsAlarmEventTable, xupsIdentSoftwareVersion=xupsIdentSoftwareVersion, xupsInputPhase=xupsInputPhase, xupsEnvAmbientUpperLimit=xupsEnvAmbientUpperLimit, xupsConfigOutputFreq=xupsConfigOutputFreq, xupstdOutputOff=xupstdOutputOff, xupsShutdownImminent=xupsShutdownImminent, xupsInputId=xupsInputId, xupsOutputPercentLoad=xupsOutputPercentLoad, xupstdAlarmChargerFailed=xupstdAlarmChargerFailed, xupsOutputOff=xupsOutputOff, xupsOnMaintenanceBypass=xupsOnMaintenanceBypass, xupsControlOutputOnTrapDelay=xupsControlOutputOnTrapDelay, xupsNumReceptacles=xupsNumReceptacles, xupsBatteryAbmStatus=xupsBatteryAbmStatus, xupsOutputCumulativePowerUsageTimer=xupsOutputCumulativePowerUsageTimer, xupsOutputTotalWatts=xupsOutputTotalWatts, xupsTrapOidDefined=xupsTrapOidDefined, xupsBatteryLastReplacedDate=xupsBatteryLastReplacedDate, xupsInputTotalVA=xupsInputTotalVA, xupsBypassTotalVA=xupsBypassTotalVA, xupsRecepOffDelaySecs=xupsRecepOffDelaySecs, xupsOutputVA=xupsOutputVA, xupsBypassTotal=xupsBypassTotal, xupsBypassVoltage=xupsBypassVoltage, xupsInputAveragePowerFactor=xupsInputAveragePowerFactor, xupsIdentManufacturer=xupsIdentManufacturer, xupsOutputTotalVA=xupsOutputTotalVA, xupstdOnBypass=xupstdOnBypass, xupsSendTrapType=xupsSendTrapType, xupsAgentPartNumber=xupsAgentPartNumber, xupsOutputPhase=xupsOutputPhase, xupsSecondaryInputWatch=xupsSecondaryInputWatch, xupsOutputOverload=xupsOutputOverload, xupstdShutdownImminent=xupstdShutdownImminent, xupsControlToBypassDelay=xupsControlToBypassDelay, xupstdAltPowerNotAvailable=xupstdAltPowerNotAvailable, xupsBatteryFailure=xupsBatteryFailure, xupsAgentFullGroup=xupsAgentFullGroup, xupsBypassAverageVoltage=xupsBypassAverageVoltage, xupsOutputCurrentHighPrecision=xupsOutputCurrentHighPrecision, xupsRecepShedSecsWithRestart=xupsRecepShedSecsWithRestart, xupsTopologyType=xupsTopologyType, xupsControlFullGroup=xupsControlFullGroup, xupsAlarmEntry=xupsAlarmEntry, xupsAlarmEventsFullGroup=xupsAlarmEventsFullGroup, xupstdBypassNotAvailable=xupstdBypassNotAvailable, xupsOutputEntry=xupsOutputEntry, xupsInputTotalCurrent=xupsInputTotalCurrent, xupsConfigOutputVoltage=xupsConfigOutputVoltage, xupsTrapSource=xupsTrapSource, xupsAlarmOutputBad=xupsAlarmOutputBad, xupsBypassTable=xupsBypassTable, xupstdOnAlternatePowerSource=xupstdOnAlternatePowerSource, xupsOutputVoltage=xupsOutputVoltage, xupsOutputSource=xupsOutputSource, xupsConfig=xupsConfig, xupsOutputWatts=xupsOutputWatts, xupstdOutputBad=xupstdOutputBad, xupsBypassPhase=xupsBypassPhase, xupsAlarmEntryRemoved=xupsAlarmEntryRemoved, xupsOutputCumulativePowerUsage=xupsOutputCumulativePowerUsage, xupsAmbientTempBad=xupsAmbientTempBad, xupstdModuleFailure=xupstdModuleFailure, xupsConformance=xupsConformance, xupstdContactActiveNotice=xupstdContactActiveNotice, xupsAlarmEventKind=xupsAlarmEventKind, xupsConfigFullGroup=xupsConfigFullGroup, xupsEnvAmbientTemp=xupsEnvAmbientTemp, xupstdPowerSwitchBad=xupstdPowerSwitchBad, xupsDeprecatedGroup=xupsDeprecatedGroup, xupsRecepAutoOffDelay=xupsRecepAutoOffDelay, xupsBypassTotalFullGroup=xupsBypassTotalFullGroup, xupsAgentSerialNumber=xupsAgentSerialNumber, xupsBatteryAged=xupsBatteryAged, xupsEnvAmbientHumidity=xupsEnvAmbientHumidity, xupstdAmbientTempBad=xupstdAmbientTempBad, xupsBypass=xupsBypass, xupsOutputTotalCurrent=xupsOutputTotalCurrent, xupstdOutputNotProtected=xupstdOutputNotProtected, xupstdAwaitingPower=xupstdAwaitingPower, xupsAlarmEventMsg=xupsAlarmEventMsg, xupstdAlarmFanFailure=xupstdAlarmFanFailure, xupsTrapMessage=xupsTrapMessage, xupsAgentManufacturer=xupsAgentManufacturer, xupsOutputNotProtected=xupsOutputNotProtected, xupstdDiagnosticTestFailed=xupstdDiagnosticTestFailed, xupstdRemoteHumidityBad=xupstdRemoteHumidityBad, xupsIdent=xupsIdent, xupsBypassCurrentHighPrecision=xupsBypassCurrentHighPrecision, xupsAlarmEventDateAndTime=xupsAlarmEventDateAndTime, xupsRecepIndex=xupsRecepIndex, xupsTopoPowerStrategy=xupsTopoPowerStrategy, xupstdAlarmEntryRemoved=xupstdAlarmEntryRemoved, xupstdAlarmFuseFailure=xupstdAlarmFuseFailure, xupstdBuildingAlarm=xupstdBuildingAlarm, xupsCommunicationsLost=xupsCommunicationsLost, xupstdTestTrap=xupstdTestTrap)
mibBuilder.exportSymbols("XUPS-MIB", xupstdControlOn=xupstdControlOn, xupsBatteryDischarged=xupsBatteryDischarged, xupstdAlarmBatteryBad=xupstdAlarmBatteryBad, xupsAlarmEventDescr=xupsAlarmEventDescr, xupsIdentPartNumber=xupsIdentPartNumber, xupsPowerSwitchBad=xupsPowerSwitchBad, xupsInputNumPhases=xupsInputNumPhases, xupsAgentModel=xupsAgentModel, xupstdBreakerOpen=xupstdBreakerOpen, xupsMibFullCompliance=xupsMibFullCompliance, xupstdHeartbeat=xupstdHeartbeat, xupsAlarmTestInProgress=xupsAlarmTestInProgress, xupsOutputCurrent=xupsOutputCurrent, xupsOutputTotalFullGroup=xupsOutputTotalFullGroup, xupstdOnInverter=xupstdOnInverter, xupsUpsShutdownPending=xupsUpsShutdownPending, xupsBypassTotalCurrent=xupsBypassTotalCurrent, xupsAlarmChargerFailed=xupsAlarmChargerFailed, xupsNoticeCondition=xupsNoticeCondition, xupsRecepHourlyPowerUsage=xupsRecepHourlyPowerUsage, xupstdCommEstablished=xupstdCommEstablished, xupsTrapDefined=xupsTrapDefined, xupsControl=xupsControl, xupsAlarmFullGroup=xupsAlarmFullGroup)
