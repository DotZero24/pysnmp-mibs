...
xupsEnvRemoteHumidityLowerLimit, xupsEnvRemoteTemp, xupsContactType, xupsEnvRemoteHumidityUpperLimit, xupsContactDescr, xupsContactIndex, xupsEnvRemoteTempUpperLimit, xupsEnvRemoteHumidity, xupsContactState, xupsEnvRemoteTempLowerLimit = mibBuilder.importSymbols("EATON-EMP-MIB", "xupsEnvRemoteHumidityLowerLimit", "xupsEnvRemoteTemp", "xupsContactType", "xupsEnvRemoteHumidityUpperLimit", "xupsContactDescr", "xupsContactIndex", "xupsEnvRemoteTempUpperLimit", "xupsEnvRemoteHumidity", "xupsContactState", "xupsEnvRemoteTempLowerLimit")
...
mibBuilder.exportSymbols("XUPS-MIB", xupsInputId=xupsInputId, xupsIdent=xupsIdent, xupsTopoPowerStrategy=xupsTopoPowerStrategy, xupsEnvironmentFullGroup=xupsEnvironmentFullGroup, xupsInputTable=xupsInputTable, xupsBypassFullGroup=xupsBypassFullGroup, xupstdRemoteTempBad=xupstdRemoteTempBad, xupstdModuleFailure=xupstdModuleFailure, xupsRecepShedSecsWithRestart=xupsRecepShedSecsWithRestart, xupsBypassTotal=xupsBypassTotal, xupsTopologyFullGroup=xupsTopologyFullGroup, xupsBypass=xupsBypass, xupsOutputLoad=xupsOutputLoad, xupsBypassAveragePowerFactor=xupsBypassAveragePowerFactor, xupsBypassName=xupsBypassName, xupsInputNumPhases=xupsInputNumPhases, xupsAgentFullGroup=xupsAgentFullGroup, xupsControlFullGroup=xupsControlFullGroup, xupsInputTotalWatts=xupsInputTotalWatts, xupsTestStart=xupsTestStart, xupstdInverterFailure=xupstdInverterFailure, xupsControlOutputOnTrapDelay=xupsControlOutputOnTrapDelay, xupsBatCapacity=xupsBatCapacity, xupsSwitchable=xupsSwitchable, xupsOutputOff=xupsOutputOff, xupsOutputVoltage=xupsOutputVoltage, xupsAgentManufacturer=xupsAgentManufacturer, xupsLossOfRedundancy=xupsLossOfRedundancy, xupsBatVoltage=xupsBatVoltage, xupsBypassVoltage=xupsBypassVoltage, xupsTrapSource=xupsTrapSource, xupsEnvAmbientTemp=xupsEnvAmbientTemp, xupsBypassId=xupsBypassId, xupsOutputTable=xupsOutputTable, xupsAgentModel=xupsAgentModel, xupstdNotifyGroup=xupstdNotifyGroup, xupsLastGeneralTest=xupsLastGeneralTest, xupsConfigLowOutputVoltageLimit=xupsConfigLowOutputVoltageLimit, xupsOutputAverageVoltage=xupsOutputAverageVoltage, xupsOnBypass=xupsOnBypass, xupsAlarmEventDescr=xupsAlarmEventDescr, xupsAlarmTestInProgress=xupsAlarmTestInProgress, xupsInputName=xupsInputName, xupsAgentSerialNumber=xupsAgentSerialNumber, xupsOnMaintenanceBypass=xupsOnMaintenanceBypass, xupsConfigFullGroup=xupsConfigFullGroup, xupstdInternalFailure=xupstdInternalFailure, xupstdOnAlternatePowerSource=xupstdOnAlternatePowerSource, xupsAlarmEntryAdded=xupsAlarmEntryAdded, xupsOutputAveragePowerFactor=xupsOutputAveragePowerFactor, xupsBypassTotalCurrent=xupsBypassTotalCurrent, xupsOutputNumPhases=xupsOutputNumPhases, xupsOutputHourlyPowerUsage=xupsOutputHourlyPowerUsage, xupsAlarmChargerFailed=xupsAlarmChargerFailed, xupstdControlOn=xupstdControlOn, xupstdAlarmTestInProgress=xupstdAlarmTestInProgress, xupstdAmbientTempBad=xupstdAmbientTempBad, xupstdCommunicationsLost=xupstdCommunicationsLost, xupstdOutputOverload=xupstdOutputOverload, xupsBattery=xupsBattery, xupsBatteryDischarged=xupsBatteryDischarged, xupstdOutputOff=xupstdOutputOff, xupsAlarmAwaitingPower=xupsAlarmAwaitingPower, xupstdAlarmTempBad=xupstdAlarmTempBad, xupsOnInverter=xupsOnInverter, xupsBatTimeRemaining=xupsBatTimeRemaining, xupsNoticeCondition=xupsNoticeCondition, xupsIdentManufacturer=xupsIdentManufacturer, xupsOutputOverload=xupsOutputOverload, xupsDualInputStatus=xupsDualInputStatus, xupsInputSource=xupsInputSource, xupsRecepCumulativePowerUsageTimer=xupsRecepCumulativePowerUsageTimer, xupsBatteryAged=xupsBatteryAged, xupsBypassWatts=xupsBypassWatts, xupsHeartbeatMinsInterval=xupsHeartbeatMinsInterval, xupsBypassEntry=xupsBypassEntry, xupstdEMPNotifyGroup=xupstdEMPNotifyGroup, xupsOnBattery=xupsOnBattery, xupsShutdownImminent=xupsShutdownImminent, xupsBatteryLowCapacity=xupsBatteryLowCapacity, xupsRemoteTempBad=xupsRemoteTempBad, xupsMibFullCompliance=xupsMibFullCompliance, xupsEnvAmbientLowerLimit=xupsEnvAmbientLowerLimit, xupsInputAveragePowerFactor=xupsInputAveragePowerFactor, xupstdRemoteHumidityBad=xupstdRemoteHumidityBad, xupsInverterFailure=xupsInverterFailure, xupsIdentFullGroup=xupsIdentFullGroup, xupsModuleFailure=xupsModuleFailure, xupsConfigOutputVoltage=xupsConfigOutputVoltage, xupsAlarmEventKind=xupsAlarmEventKind, xupsRecepEntry=xupsRecepEntry, xupsSendTrapType=xupsSendTrapType, xupstdAwaitingPower=xupstdAwaitingPower, xupsBypassNotAvailable=xupsBypassNotAvailable, xupsBypassPhase=xupsBypassPhase, xupstdDiagnosticTestPassed=xupstdDiagnosticTestPassed, xupsOutputFullGroup=xupsOutputFullGroup, xupsTestFullGroup=xupsTestFullGroup, xupstdContactInactiveNotice=xupstdContactInactiveNotice, xupsEnvAmbientHumidity=xupsEnvAmbientHumidity, xupsControlOutputOnDelay=xupsControlOutputOnDelay, xupsBatteryFailure=xupsBatteryFailure, xupstdInputFailure=xupstdInputFailure, xupsControlToBypassDelay=xupsControlToBypassDelay, xupsConfigDateAndTime=xupsConfigDateAndTime, xupsRecepOnDelaySecs=xupsRecepOnDelaySecs, xupstdBatteryDischarged=xupstdBatteryDischarged, xupsInputEntry=xupsInputEntry, xupsOutputPercentLoad=xupsOutputPercentLoad, xupsConfig=xupsConfig, xupstdAlarmFuseFailure=xupstdAlarmFuseFailure, xupsInputCurrentHighPrecision=xupsInputCurrentHighPrecision, xupsInputFailure=xupsInputFailure, xupsOutput=xupsOutput, xupsAlarms=xupsAlarms, xupsIdentOemCode=xupsIdentOemCode, xupsPowerSwitchBad=xupsPowerSwitchBad, xupsAgentPartNumber=xupsAgentPartNumber, xupsAlarmEventsFullGroup=xupsAlarmEventsFullGroup, xupsTopoUnitNumber=xupsTopoUnitNumber, xupsConfigInputVoltage=xupsConfigInputVoltage, xupsTestTrap=xupsTestTrap, xupsRecepTable=xupsRecepTable, xupsMIB=xupsMIB, xupstdTestTrap=xupstdTestTrap, xupsBatteryAbmStatus=xupsBatteryAbmStatus, xupsBatteryNotPresent=xupsBatteryNotPresent, xupsTopology=xupsTopology, xupsLastGeneralTestResult=xupsLastGeneralTestResult, xupstdUpsShutdownPending=xupstdUpsShutdownPending, xupstdOutputNotProtected=xupstdOutputNotProtected, xupstdAlarmEntryAdded=xupstdAlarmEntryAdded, xupsInputStatus=xupsInputStatus, xupsAgent=xupsAgent, xupsOutputTotal=xupsOutputTotal, xupsAlarmEventEntry=xupsAlarmEventEntry, xupsOutputOffAsRequested=xupsOutputOffAsRequested, xupsOutputPhase=xupsOutputPhase, xupstdBreakerOpen=xupstdBreakerOpen, xupsTrapOidDefined=xupsTrapOidDefined, xupstdAlarmBatteryBad=xupstdAlarmBatteryBad, xupsInputFullGroup=xupsInputFullGroup, xupstdBypassNotAvailable=xupstdBypassNotAvailable, xupsBypassFrequency=xupsBypassFrequency, xupsInputTotalFullGroup=xupsInputTotalFullGroup, xupsInputPhase=xupsInputPhase, xupsBypassCurrentHighPrecision=xupsBypassCurrentHighPrecision, xupsRecepCumulativePowerUsage=xupsRecepCumulativePowerUsage, xupsOutputTotalFullGroup=xupsOutputTotalFullGroup, xupsConfigInstallDate=xupsConfigInstallDate, xupsIdentSerialNumber=xupsIdentSerialNumber, xupsOutputCumulativePowerUsageTimer=xupsOutputCumulativePowerUsageTimer, xupstdDiagnosticTestFailed=xupstdDiagnosticTestFailed, xupsInputFrequency=xupsInputFrequency, xupsBatteryLastReplacedDate=xupsBatteryLastReplacedDate, xupsAmbientTempBad=xupsAmbientTempBad, xupsRecepOffDelaySecs=xupsRecepOffDelaySecs, xupstdAlarmChargerFailed=xupstdAlarmChargerFailed, xupsConfigOutputFreq=xupsConfigOutputFreq, xupsBypassAverageVoltage=xupsBypassAverageVoltage, xupsTrapDefined=xupsTrapDefined, xupstdAlarmFanFailure=xupstdAlarmFanFailure, xupsSecondaryInputWatch=xupsSecondaryInputWatch, xupsConformance=xupsConformance, xupsInputCurrent=xupsInputCurrent, xupsRecep=xupsRecep, xupsOutputCumulativePowerUsage=xupsOutputCumulativePowerUsage, xupstdLossOfRedundancy=xupstdLossOfRedundancy, xupstdControlOff=xupstdControlOff, xupsOutputCurrent=xupsOutputCurrent, xupsAlarmEventID=xupsAlarmEventID, xupsBreakerOpen=xupsBreakerOpen, xupsIdentPartNumber=xupsIdentPartNumber, xupsCommunicationsLost=xupsCommunicationsLost, xupsConfigHighOutputVoltageLimit=xupsConfigHighOutputVoltageLimit, xupstdOnBattery=xupstdOnBattery, xupstdHeartbeat=xupstdHeartbeat, xupsBypassTableFullGroup=xupsBypassTableFullGroup, xupsInputTotalVA=xupsInputTotalVA, xupsAlarmNumEvents=xupsAlarmNumEvents, xupsOutputTotalWatts=xupsOutputTotalWatts, xupsAlarmTempBad=xupsAlarmTempBad, xupsRecepHourlyPowerUsage=xupsRecepHourlyPowerUsage, xupsRecepAutoOffDelay=xupsRecepAutoOffDelay, xupsInput=xupsInput, xupsInputLineBads=xupsInputLineBads, xupsRecepAutoOnDelay=xupsRecepAutoOnDelay, xupsBypassTotalFullGroup=xupsBypassTotalFullGroup, xupsTrapControlFullGroup=xupsTrapControlFullGroup, xupsOutputCurrentHighPrecision=xupsOutputCurrentHighPrecision, xupsOnAlternatePowerSource=xupsOnAlternatePowerSource, xupsInputVoltage=xupsInputVoltage, xupsControlOutputOffDelay=xupsControlOutputOffDelay, xupstdLowBattery=xupstdLowBattery, xupstdReturnFromLowBattery=xupstdReturnFromLowBattery, xupsUpsShutdownPending=xupsUpsShutdownPending, xupstdNoticeCondition=xupstdNoticeCondition, xupsLowBattery=xupsLowBattery, xupsInputTableFullGroup=xupsInputTableFullGroup, xupsAltPowerNotAvailable=xupsAltPowerNotAvailable, xupsConfigOutputWatts=xupsConfigOutputWatts, xupsAlarmBatteryBad=xupsAlarmBatteryBad, xupsOutputStatus=xupsOutputStatus, xupsBatCurrent=xupsBatCurrent, xupsOutputWatts=xupsOutputWatts, xupsInputTotalCurrent=xupsInputTotalCurrent, xupsOutputId=xupsOutputId, xupsTrapMessage=xupsTrapMessage, xupsIdentSoftwareVersion=xupsIdentSoftwareVersion, xupsRecepIndex=xupsRecepIndex, xupsMaxTrapLevel=xupsMaxTrapLevel, xupsBypassNumPhases=xupsBypassNumPhases, xupstdBuildingAlarm=xupstdBuildingAlarm, xupsNumReceptacles=xupsNumReceptacles, xupsControlOutputOffTrapDelay=xupsControlOutputOffTrapDelay, xupstdAgentDown=xupstdAgentDown, xupstdAlarmEntryRemoved=xupstdAlarmEntryRemoved, xupsInputAverageVoltage=xupsInputAverageVoltage, xupsReturnFromLowBattery=xupsReturnFromLowBattery, xupsDeprecatedGroup=xupsDeprecatedGroup, xupsBypassTable=xupsBypassTable, xupsAlarmTable=xupsAlarmTable, xupsOutputEntry=xupsOutputEntry, xupsOutputTotalCurrent=xupsOutputTotalCurrent, xupsAlarmID=xupsAlarmID, xupsOutputTableFullGroup=xupsOutputTableFullGroup, xupsOutputTotalVA=xupsOutputTotalVA, xupsAlarmTime=xupsAlarmTime, xupsAlarmEventDateAndTime=xupsAlarmEventDateAndTime, xupstdOnInverter=xupstdOnInverter, xupsOutputNotProtected=xupsOutputNotProtected, xupstdContactActiveNotice=xupstdContactActiveNotice, xupsAlarmFullGroup=xupsAlarmFullGroup, xupsInternalFailure=xupsInternalFailure, xupstdCommEstablished=xupstdCommEstablished, xupsDiagnosticTestFailed=xupsDiagnosticTestFailed, xupsAlarmFanFailure=xupsAlarmFanFailure, xupsOutputFrequency=xupsOutputFrequency, xupsRecepStatus=xupsRecepStatus, xupsEnvAmbientUpperLimit=xupsEnvAmbientUpperLimit, xupsAlarmEventMsg=xupsAlarmEventMsg, xupsBypassTotalWatts=xupsBypassTotalWatts, xupsAlarmEntryRemoved=xupsAlarmEntryRemoved, xupsAlarmOutputBad=xupsAlarmOutputBad, xupsLoadShedSecsWithRestart=xupsLoadShedSecsWithRestart, xupsRecepFullGroup=xupsRecepFullGroup, xupsRemoteHumidityBad=xupsRemoteHumidityBad, xupsAgentSoftwareVersion=xupsAgentSoftwareVersion, xupsUtilityPowerRestored=xupsUtilityPowerRestored, xupsTopologyType=xupsTopologyType, xupstdOutputOffAsRequested=xupstdOutputOffAsRequested, xupstdPowerSwitchBad=xupstdPowerSwitchBad, xupsAlarmEventTable=xupsAlarmEventTable, xupsTopoMachineCode=xupsTopoMachineCode)
mibBuilder.exportSymbols("XUPS-MIB", xupsTrapControl=xupsTrapControl, xupsIdentModel=xupsIdentModel, xupstdOutputBad=xupstdOutputBad, xupsTest=xupsTest, xupstdAltPowerNotAvailable=xupstdAltPowerNotAvailable, xupsBatteryFullGroup=xupsBatteryFullGroup, PYSNMP_MODULE_ID=xupsMIB, xupsBypassTotalVA=xupsBypassTotalVA, xupstdOnMaintenanceBypass=xupstdOnMaintenanceBypass, xupsTestBatteryStatus=xupsTestBatteryStatus, xupsAlarmFuseFailure=xupsAlarmFuseFailure, xupsOutputName=xupsOutputName, xupsAlarmDescr=xupsAlarmDescr, xupsOutputSource=xupsOutputSource, xupsInputTotal=xupsInputTotal, xupsAlarm=xupsAlarm, xupstdUtilityPowerRestored=xupstdUtilityPowerRestored, xupstdShutdownImminent=xupstdShutdownImminent, xupsOutputVA=xupsOutputVA, xupstdOnBypass=xupstdOnBypass, xupsInputWatts=xupsInputWatts, xupsControl=xupsControl, xupsBuildingAlarm=xupsBuildingAlarm, xupsAlarmEntry=xupsAlarmEntry)
