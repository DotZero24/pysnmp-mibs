...
dot1adMIB=ModuleIdentity((1,3,6,1,4,1,10876,101,1,130))
...
dot1adProviderBridge=_Dot1adProviderBridge_ObjectIdentity((1,3,6,1,4,1,10876,101,1,130,1))
_Dot1adPortTable_Object=MibTable
dot1adPortTable=_Dot1adPortTable_Object((1,3,6,1,4,1,10876,101,1,130,1,1))
if mibBuilder.loadTexts:dot1adPortTable.setStatus(_A)
_Dot1adPortEntry_Object=MibTableRow
dot1adPortEntry=_Dot1adPortEntry_Object((1,3,6,1,4,1,10876,101,1,130,1,1,1))
dot1adPortEntry.setIndexNames((0,_B,_F))
...
dot1adPortNum=_Dot1adPortNum_Object((1,3,6,1,4,1,10876,101,1,130,1,1,1,1),_Dot1adPortNum_Type())
...
dot1adPortPcpSelectionRow=_Dot1adPortPcpSelectionRow_Object((1,3,6,1,4,1,10876,101,1,130,1,1,1,2),_Dot1adPortPcpSelectionRow_Type())
dot1adPortPcpSelectionRow.setMaxAccess(_C)
...
dot1adPortUseDei=_Dot1adPortUseDei_Object((1,3,6,1,4,1,10876,101,1,130,1,1,1,3),_Dot1adPortUseDei_Type())
dot1adPortUseDei.setMaxAccess(_C)
...
dot1adPortReqDropEncoding=_Dot1adPortReqDropEncoding_Object((1,3,6,1,4,1,10876,101,1,130,1,1,1,4),_Dot1adPortReqDropEncoding_Type())
dot1adPortReqDropEncoding.setMaxAccess(_C)
if mibBuilder.loadTexts:dot1adPortReqDropEncoding.setStatus(_A)
_Dot1adVidTranslationTable_Object=MibTable
dot1adVidTranslationTable=_Dot1adVidTranslationTable_Object((1,3,6,1,4,1,10876,101,1,130,1,2))
if mibBuilder.loadTexts:dot1adVidTranslationTable.setStatus(_A)
_Dot1adVidTranslationEntry_Object=MibTableRow
dot1adVidTranslationEntry=_Dot1adVidTranslationEntry_Object((1,3,6,1,4,1,10876,101,1,130,1,2,1))
dot1adVidTranslationEntry.setIndexNames((0,_B,_F),(0,_B,_J))
...
dot1adVidTranslationLocalVid=_Dot1adVidTranslationLocalVid_Object((1,3,6,1,4,1,10876,101,1,130,1,2,1,1),_Dot1adVidTranslationLocalVid_Type())
...
dot1adVidTranslationRelayVid=_Dot1adVidTranslationRelayVid_Object((1,3,6,1,4,1,10876,101,1,130,1,2,1,2),_Dot1adVidTranslationRelayVid_Type())
dot1adVidTranslationRelayVid.setMaxAccess(_C)
...
dot1adVidTranslationRowStatus=_Dot1adVidTranslationRowStatus_Object((1,3,6,1,4,1,10876,101,1,130,1,2,1,3),_Dot1adVidTranslationRowStatus_Type())
...
dot1adCVidRegistrationTable=_Dot1adCVidRegistrationTable_Object((1,3,6,1,4,1,10876,101,1,130,1,3))
if mibBuilder.loadTexts:dot1adCVidRegistrationTable.setStatus(_A)
_Dot1adCVidRegistrationEntry_Object=MibTableRow
dot1adCVidRegistrationEntry=_Dot1adCVidRegistrationEntry_Object((1,3,6,1,4,1,10876,101,1,130,1,3,1))
dot1adCVidRegistrationEntry.setIndexNames((0,_B,_F),(0,_B,_L))
...
dot1adCVidRegistrationCVid=_Dot1adCVidRegistrationCVid_Object((1,3,6,1,4,1,10876,101,1,130,1,3,1,1),_Dot1adCVidRegistrationCVid_Type())
...
dot1adCVidRegistrationSVid=_Dot1adCVidRegistrationSVid_Object((1,3,6,1,4,1,10876,101,1,130,1,3,1,2),_Dot1adCVidRegistrationSVid_Type())
dot1adCVidRegistrationSVid.setMaxAccess(_C)
...
dot1adCVidRegistrationUntaggedPep=_Dot1adCVidRegistrationUntaggedPep_Object((1,3,6,1,4,1,10876,101,1,130,1,3,1,3),_Dot1adCVidRegistrationUntaggedPep_Type())
dot1adCVidRegistrationUntaggedPep.setMaxAccess(_C)
...
dot1adCVidRegistrationUntaggedCep=_Dot1adCVidRegistrationUntaggedCep_Object((1,3,6,1,4,1,10876,101,1,130,1,3,1,4),_Dot1adCVidRegistrationUntaggedCep_Type())
dot1adCVidRegistrationUntaggedCep.setMaxAccess(_C)
...
dot1adCVidRegistrationRowStatus=_Dot1adCVidRegistrationRowStatus_Object((1,3,6,1,4,1,10876,101,1,130,1,3,1,5),_Dot1adCVidRegistrationRowStatus_Type())
...
dot1adPepTable=_Dot1adPepTable_Object((1,3,6,1,4,1,10876,101,1,130,1,4))
if mibBuilder.loadTexts:dot1adPepTable.setStatus(_A)
_Dot1adPepEntry_Object=MibTableRow
dot1adPepEntry=_Dot1adPepEntry_Object((1,3,6,1,4,1,10876,101,1,130,1,4,1))
dot1adPepEntry.setIndexNames((0,_B,_F),(0,_B,_H))
if mibBuilder.loadTexts:dot1adPepEntry.setStatus(_A)
_Dot1adPepPvid_Type=VlanId
_Dot1adPepPvid_Object=MibTableColumn
dot1adPepPvid=_Dot1adPepPvid_Object((1,3,6,1,4,1,10876,101,1,130,1,4,1,1),_Dot1adPepPvid_Type())
dot1adPepPvid.setMaxAccess(_C)
...
dot1adPepDefaultUserPriority=_Dot1adPepDefaultUserPriority_Object((1,3,6,1,4,1,10876,101,1,130,1,4,1,2),_Dot1adPepDefaultUserPriority_Type())
dot1adPepDefaultUserPriority.setMaxAccess(_C)
...
dot1adPepAccptableFrameTypes=_Dot1adPepAccptableFrameTypes_Object((1,3,6,1,4,1,10876,101,1,130,1,4,1,3),_Dot1adPepAccptableFrameTypes_Type())
dot1adPepAccptableFrameTypes.setMaxAccess(_C)
...
dot1adPepIngressFiltering=_Dot1adPepIngressFiltering_Object((1,3,6,1,4,1,10876,101,1,130,1,4,1,4),_Dot1adPepIngressFiltering_Type())
dot1adPepIngressFiltering.setMaxAccess(_C)
if mibBuilder.loadTexts:dot1adPepIngressFiltering.setStatus(_A)
_Dot1adServicePriorityRegenerationTable_Object=MibTable
dot1adServicePriorityRegenerationTable=_Dot1adServicePriorityRegenerationTable_Object((1,3,6,1,4,1,10876,101,1,130,1,5))
...
dot1adServicePriorityRegenerationEntry=_Dot1adServicePriorityRegenerationEntry_Object((1,3,6,1,4,1,10876,101,1,130,1,5,1))
dot1adServicePriorityRegenerationEntry.setIndexNames((0,_B,_F),(0,_B,_H),(0,_B,_M))
...
dot1adServicePriorityRegenReceivedPriority=_Dot1adServicePriorityRegenReceivedPriority_Object((1,3,6,1,4,1,10876,101,1,130,1,5,1,1),_Dot1adServicePriorityRegenReceivedPriority_Type())
...
dot1adServicePriorityRegenRegeneratedPriority=_Dot1adServicePriorityRegenRegeneratedPriority_Object((1,3,6,1,4,1,10876,101,1,130,1,5,1,2),_Dot1adServicePriorityRegenRegeneratedPriority_Type())
dot1adServicePriorityRegenRegeneratedPriority.setMaxAccess(_C)
...
dot1adPcpDecodingTable=_Dot1adPcpDecodingTable_Object((1,3,6,1,4,1,10876,101,1,130,1,6))
if mibBuilder.loadTexts:dot1adPcpDecodingTable.setStatus(_A)
_Dot1adPcpDecodingEntry_Object=MibTableRow
dot1adPcpDecodingEntry=_Dot1adPcpDecodingEntry_Object((1,3,6,1,4,1,10876,101,1,130,1,6,1))
dot1adPcpDecodingEntry.setIndexNames((0,_B,_F),(0,_B,_N),(0,_B,_O))
...
dot1adPcpDecodingPcpSelRow=_Dot1adPcpDecodingPcpSelRow_Object((1,3,6,1,4,1,10876,101,1,130,1,6,1,1),_Dot1adPcpDecodingPcpSelRow_Type())
...
dot1adPcpDecodingPcpValue=_Dot1adPcpDecodingPcpValue_Object((1,3,6,1,4,1,10876,101,1,130,1,6,1,2),_Dot1adPcpDecodingPcpValue_Type())
...
dot1adPcpDecodingPriority=_Dot1adPcpDecodingPriority_Object((1,3,6,1,4,1,10876,101,1,130,1,6,1,3),_Dot1adPcpDecodingPriority_Type())
dot1adPcpDecodingPriority.setMaxAccess(_C)
...
dot1adPcpDecodingDropEligible=_Dot1adPcpDecodingDropEligible_Object((1,3,6,1,4,1,10876,101,1,130,1,6,1,4),_Dot1adPcpDecodingDropEligible_Type())
dot1adPcpDecodingDropEligible.setMaxAccess(_C)
if mibBuilder.loadTexts:dot1adPcpDecodingDropEligible.setStatus(_A)
_Dot1adPcpEncodingTable_Object=MibTable
dot1adPcpEncodingTable=_Dot1adPcpEncodingTable_Object((1,3,6,1,4,1,10876,101,1,130,1,7))
if mibBuilder.loadTexts:dot1adPcpEncodingTable.setStatus(_A)
_Dot1adPcpEncodingEntry_Object=MibTableRow
dot1adPcpEncodingEntry=_Dot1adPcpEncodingEntry_Object((1,3,6,1,4,1,10876,101,1,130,1,7,1))
dot1adPcpEncodingEntry.setIndexNames((0,_B,_F),(0,_B,_P),(0,_B,_Q),(0,_B,_R))
...
dot1adPcpEncodingPcpSelRow=_Dot1adPcpEncodingPcpSelRow_Object((1,3,6,1,4,1,10876,101,1,130,1,7,1,1),_Dot1adPcpEncodingPcpSelRow_Type())
...
dot1adPcpEncodingPriority=_Dot1adPcpEncodingPriority_Object((1,3,6,1,4,1,10876,101,1,130,1,7,1,2),_Dot1adPcpEncodingPriority_Type())
...
dot1adPcpEncodingDropEligible=_Dot1adPcpEncodingDropEligible_Object((1,3,6,1,4,1,10876,101,1,130,1,7,1,3),_Dot1adPcpEncodingDropEligible_Type())
