...
swL2MgmtMIB=ModuleIdentity((1,3,6,1,4,1,171,11,117,5,1,2))
...
swL2DevMgmt=_SwL2DevMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,1))
_SwL2DevInfo_ObjectIdentity=ObjectIdentity
swL2DevInfo=_SwL2DevInfo_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,1,1))
...
swDevInfoTotalNumOfPort=_SwDevInfoTotalNumOfPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,1,1),_SwDevInfoTotalNumOfPort_Type())
...
swDevInfoNumOfPortInUse=_SwDevInfoNumOfPortInUse_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,1,2),_SwDevInfoNumOfPortInUse_Type())
...
swL2DevCtrl=_SwL2DevCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,1,2))
...
swL2DevCtrlSnmpTrapState=_SwL2DevCtrlSnmpTrapState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,5),_SwL2DevCtrlSnmpTrapState_Type())
...
swL2DevCtrlCleanAllStatisticCounter=_SwL2DevCtrlCleanAllStatisticCounter_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,6),_SwL2DevCtrlCleanAllStatisticCounter_Type())
...
swL2DevCtrlVlanIdOfFDBTbl=_SwL2DevCtrlVlanIdOfFDBTbl_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,7),_SwL2DevCtrlVlanIdOfFDBTbl_Type())
...
swL2MACNotifyState=_SwL2MACNotifyState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,8),_SwL2MACNotifyState_Type())
...
swL2MACNotifyHistorySize=_SwL2MACNotifyHistorySize_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,9),_SwL2MACNotifyHistorySize_Type())
...
swL2MACNotifyInterval=_SwL2MACNotifyInterval_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,10),_SwL2MACNotifyInterval_Type())
...
swL2DevCtrlAsymVlanState=_SwL2DevCtrlAsymVlanState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,13),_SwL2DevCtrlAsymVlanState_Type())
...
swL2DevCtrlTelnet=_SwL2DevCtrlTelnet_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,1,2,14))
...
swL2DevCtrlTelnetState=_SwL2DevCtrlTelnetState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,14,1),_SwL2DevCtrlTelnetState_Type())
...
swL2DevCtrlTelnetTcpPort=_SwL2DevCtrlTelnetTcpPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,14,2),_SwL2DevCtrlTelnetTcpPort_Type())
...
swL2DevCtrlManagementVlanId=_SwL2DevCtrlManagementVlanId_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,16),_SwL2DevCtrlManagementVlanId_Type())
...
swL2DevCtrlWeb=_SwL2DevCtrlWeb_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,1,2,17))
...
swL2DevCtrlWebState=_SwL2DevCtrlWebState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,17,1),_SwL2DevCtrlWebState_Type())
...
swL2DevCtrlWebTcpPort=_SwL2DevCtrlWebTcpPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,17,2),_SwL2DevCtrlWebTcpPort_Type())
...
swL2DevCtrlLLDPState=_SwL2DevCtrlLLDPState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,18),_SwL2DevCtrlLLDPState_Type())
...
swL2DevCtrlLLDPForwardMessageState=_SwL2DevCtrlLLDPForwardMessageState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,19),_SwL2DevCtrlLLDPForwardMessageState_Type())
...
swL2DevCtrlIpAutoconfig=_SwL2DevCtrlIpAutoconfig_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,20),_SwL2DevCtrlIpAutoconfig_Type())
...
swL2DevCtrlCFM=_SwL2DevCtrlCFM_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,1,2,21))
...
swL2DevCtrlCFMState=_SwL2DevCtrlCFMState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,21,1),_SwL2DevCtrlCFMState_Type())
...
swL2DevCtrlCFMPortTable=_SwL2DevCtrlCFMPortTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,21,2))
if mibBuilder.loadTexts:swL2DevCtrlCFMPortTable.setStatus(_A)
_SwL2DevCtrlCFMPortEntry_Object=MibTableRow
swL2DevCtrlCFMPortEntry=_SwL2DevCtrlCFMPortEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,21,2,1))
...
swL2DevCtrlCFMPortIndex=_SwL2DevCtrlCFMPortIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,21,2,1,1),_SwL2DevCtrlCFMPortIndex_Type())
...
swL2DevCtrlCFMPortState=_SwL2DevCtrlCFMPortState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,21,2,1,2),_SwL2DevCtrlCFMPortState_Type())
...
swL2DevCtrlVLANTrunkState=_SwL2DevCtrlVLANTrunkState_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,22),_SwL2DevCtrlVLANTrunkState_Type())
...
swL2DevCtrlLLDPExtPortSubTypeTable=_SwL2DevCtrlLLDPExtPortSubTypeTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,24))
...
swL2DevCtrlLLDPExtPortSubTypeEntry=_SwL2DevCtrlLLDPExtPortSubTypeEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,24,1))
...
swL2DevCtrlLLDPExtPortSubType=_SwL2DevCtrlLLDPExtPortSubType_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,2,24,1,1),_SwL2DevCtrlLLDPExtPortSubType_Type())
...
swL2DevAlarm=_SwL2DevAlarm_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,1,3))
...
swL2DevAlarmNewRoot=_SwL2DevAlarmNewRoot_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,3,1),_SwL2DevAlarmNewRoot_Type())
...
swL2DevAlarmTopologyChange=_SwL2DevAlarmTopologyChange_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,3,2),_SwL2DevAlarmTopologyChange_Type())
...
swL2DevAlarmLinkChange=_SwL2DevAlarmLinkChange_Object((1,3,6,1,4,1,171,11,117,5,1,2,1,3,3),_SwL2DevAlarmLinkChange_Type())
...
swL2VLANMgmt=_SwL2VLANMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,2))
_SwL2VlanStaticTable_Object=MibTable
swL2VlanStaticTable=_SwL2VlanStaticTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,1))
if mibBuilder.loadTexts:swL2VlanStaticTable.setStatus(_A)
_SwL2VlanStaticEntry_Object=MibTableRow
swL2VlanStaticEntry=_SwL2VlanStaticEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,1,1))
...
swL2VlanIndex=_SwL2VlanIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,1,1,1),_SwL2VlanIndex_Type())
...
swL2VLANAdvertisement=_SwL2VLANAdvertisement_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,1,1,2),_SwL2VLANAdvertisement_Type())
...
swL2PVIDAutoAssignmentState=_SwL2PVIDAutoAssignmentState_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,2),_SwL2PVIDAutoAssignmentState_Type())
...
swL2VlanPortInfoTable=_SwL2VlanPortInfoTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,3))
if mibBuilder.loadTexts:swL2VlanPortInfoTable.setStatus(_A)
_SwL2VlanPortInfoEntry_Object=MibTableRow
swL2VlanPortInfoEntry=_SwL2VlanPortInfoEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,3,1))
...
swL2VlanPortInfoPortIndex=_SwL2VlanPortInfoPortIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,3,1,1),_SwL2VlanPortInfoPortIndex_Type())
...
swL2VlanPortInfoVid=_SwL2VlanPortInfoVid_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,3,1,2),_SwL2VlanPortInfoVid_Type())
...
swL2VlanPortInfoPortRole=_SwL2VlanPortInfoPortRole_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,3,1,3),_SwL2VlanPortInfoPortRole_Type())
...
swL2SubnetVLANTable=_SwL2SubnetVLANTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,4))
if mibBuilder.loadTexts:swL2SubnetVLANTable.setStatus(_A)
_SwL2SubnetVLANEntry_Object=MibTableRow
swL2SubnetVLANEntry=_SwL2SubnetVLANEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,4,1))
...
swL2SubnetVLANIPAddress=_SwL2SubnetVLANIPAddress_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,4,1,1),_SwL2SubnetVLANIPAddress_Type())
...
swL2SubnetVLANIPMask=_SwL2SubnetVLANIPMask_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,4,1,2),_SwL2SubnetVLANIPMask_Type())
...
swL2SubnetVLANID=_SwL2SubnetVLANID_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,4,1,3),_SwL2SubnetVLANID_Type())
...
swL2SubnetVLANPriority=_SwL2SubnetVLANPriority_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,4,1,4),_SwL2SubnetVLANPriority_Type())
...
swL2SubnetVLANRowStatus=_SwL2SubnetVLANRowStatus_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,4,1,5),_SwL2SubnetVLANRowStatus_Type())
...
swL2VlanPrecedenceTable=_SwL2VlanPrecedenceTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,5))
if mibBuilder.loadTexts:swL2VlanPrecedenceTable.setStatus(_A)
_SwL2VlanPrecedenceEntry_Object=MibTableRow
swL2VlanPrecedenceEntry=_SwL2VlanPrecedenceEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,5,1))
...
swL2VlanPrecedencePortIndex=_SwL2VlanPrecedencePortIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,5,1,1),_SwL2VlanPrecedencePortIndex_Type())
...
swL2VlanPrecedenceClassification=_SwL2VlanPrecedenceClassification_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,5,1,2),_SwL2VlanPrecedenceClassification_Type())
...
swL2NniGvrpBpduAddress=_SwL2NniGvrpBpduAddress_Object((1,3,6,1,4,1,171,11,117,5,1,2,2,6),_SwL2NniGvrpBpduAddress_Type())
...
swL2PortMgmt=_SwL2PortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,3))
_SwL2PortInfoTable_Object=MibTable
swL2PortInfoTable=_SwL2PortInfoTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,1))
if mibBuilder.loadTexts:swL2PortInfoTable.setStatus(_A)
_SwL2PortInfoEntry_Object=MibTableRow
swL2PortInfoEntry=_SwL2PortInfoEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,1,1))
...
swL2PortInfoPortIndex=_SwL2PortInfoPortIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,1,1,1),_SwL2PortInfoPortIndex_Type())
...
swL2PortInfoMediumType=_SwL2PortInfoMediumType_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,1,1,2),_SwL2PortInfoMediumType_Type())
...
swL2PortInfoUnitID=_SwL2PortInfoUnitID_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,1,1,3),_SwL2PortInfoUnitID_Type())
...
swL2PortInfoType=_SwL2PortInfoType_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,1,1,4),_SwL2PortInfoType_Type())
...
swL2PortInfoLinkStatus=_SwL2PortInfoLinkStatus_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,1,1,5),_SwL2PortInfoLinkStatus_Type())
...
swL2PortInfoNwayStatus=_SwL2PortInfoNwayStatus_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,1,1,6),_SwL2PortInfoNwayStatus_Type())
...
swL2PortInfoErrorDisabled=_SwL2PortInfoErrorDisabled_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,1,1,8),_SwL2PortInfoErrorDisabled_Type())
...
swL2PortCtrlTable=_SwL2PortCtrlTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2))
if mibBuilder.loadTexts:swL2PortCtrlTable.setStatus(_A)
_SwL2PortCtrlEntry_Object=MibTableRow
swL2PortCtrlEntry=_SwL2PortCtrlEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1))
...
swL2PortCtrlPortIndex=_SwL2PortCtrlPortIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,1),_SwL2PortCtrlPortIndex_Type())
...
swL2PortCtrlMediumType=_SwL2PortCtrlMediumType_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,2),_SwL2PortCtrlMediumType_Type())
...
swL2PortCtrlUnitIndex=_SwL2PortCtrlUnitIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,3),_SwL2PortCtrlUnitIndex_Type())
...
swL2PortCtrlAdminState=_SwL2PortCtrlAdminState_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,4),_SwL2PortCtrlAdminState_Type())
...
swL2PortCtrlNwayState=_SwL2PortCtrlNwayState_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,5),_SwL2PortCtrlNwayState_Type())
...
swL2PortCtrlFlowCtrlState=_SwL2PortCtrlFlowCtrlState_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,6),_SwL2PortCtrlFlowCtrlState_Type())
...
swL2PortCtrlLearningState=_SwL2PortCtrlLearningState_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,7),_SwL2PortCtrlLearningState_Type())
...
swL2PortCtrlMACNotifyState=_SwL2PortCtrlMACNotifyState_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,8),_SwL2PortCtrlMACNotifyState_Type())
...
swL2PortCtrlMDIXState=_SwL2PortCtrlMDIXState_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,10),_SwL2PortCtrlMDIXState_Type())
...
swL2PortCtrlAutoSpeedDowngradeState=_SwL2PortCtrlAutoSpeedDowngradeState_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,2,1,13),_SwL2PortCtrlAutoSpeedDowngradeState_Type())
...
swL2PortCtrlJumboFrame=_SwL2PortCtrlJumboFrame_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,3),_SwL2PortCtrlJumboFrame_Type())
...
swL2PortCtrlJumboFrameMaxSize=_SwL2PortCtrlJumboFrameMaxSize_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,4),_SwL2PortCtrlJumboFrameMaxSize_Type())
...
swL2PortCounterCtrlTable=_SwL2PortCounterCtrlTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,6))
if mibBuilder.loadTexts:swL2PortCounterCtrlTable.setStatus(_A)
_SwL2PortCounterCtrlEntry_Object=MibTableRow
swL2PortCounterCtrlEntry=_SwL2PortCounterCtrlEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,6,1))
...
swL2PortCounterCtrlPortIndex=_SwL2PortCounterCtrlPortIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,6,1,1),_SwL2PortCounterCtrlPortIndex_Type())
...
swL2PortCounterClearCtrl=_SwL2PortCounterClearCtrl_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,6,1,2),_SwL2PortCounterClearCtrl_Type())
...
swL2PortSfpInfoTable=_SwL2PortSfpInfoTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11))
if mibBuilder.loadTexts:swL2PortSfpInfoTable.setStatus(_A)
_SwL2PortSfpInfoEntry_Object=MibTableRow
swL2PortSfpInfoEntry=_SwL2PortSfpInfoEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1))
...
swL2PortSfpInfoPortIndex=_SwL2PortSfpInfoPortIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,1),_SwL2PortSfpInfoPortIndex_Type())
...
swL2PortSfpInfoConnectType=_SwL2PortSfpInfoConnectType_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,2),_SwL2PortSfpInfoConnectType_Type())
...
swL2PortSfpInfoVendorName=_SwL2PortSfpInfoVendorName_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,3),_SwL2PortSfpInfoVendorName_Type())
...
swL2PortSfpInfoVendorPN=_SwL2PortSfpInfoVendorPN_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,4),_SwL2PortSfpInfoVendorPN_Type())
...
swL2PortSfpInfoVendorSN=_SwL2PortSfpInfoVendorSN_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,5),_SwL2PortSfpInfoVendorSN_Type())
...
swL2PortSfpInfoVendorOUI=_SwL2PortSfpInfoVendorOUI_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,6),_SwL2PortSfpInfoVendorOUI_Type())
...
swL2PortSfpInfoVendorRev=_SwL2PortSfpInfoVendorRev_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,7),_SwL2PortSfpInfoVendorRev_Type())
...
swL2PortSfpInfoDateCode=_SwL2PortSfpInfoDateCode_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,8),_SwL2PortSfpInfoDateCode_Type())
...
swL2PortSfpInfoFiberType=_SwL2PortSfpInfoFiberType_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,9),_SwL2PortSfpInfoFiberType_Type())
...
swL2PortSfpInfoBaudRate=_SwL2PortSfpInfoBaudRate_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,10),_SwL2PortSfpInfoBaudRate_Type())
...
swL2PortSfpInfoWavelength=_SwL2PortSfpInfoWavelength_Object((1,3,6,1,4,1,171,11,117,5,1,2,3,11,1,11),_SwL2PortSfpInfoWavelength_Type())
...
swL2TrunkMgmt=_SwL2TrunkMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,9))
...
swL2TrunkMaxSupportedEntries=_SwL2TrunkMaxSupportedEntries_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,1),_SwL2TrunkMaxSupportedEntries_Type())
...
swL2TrunkCurrentNumEntries=_SwL2TrunkCurrentNumEntries_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,2),_SwL2TrunkCurrentNumEntries_Type())
...
swL2TrunkCtrlTable=_SwL2TrunkCtrlTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,3))
if mibBuilder.loadTexts:swL2TrunkCtrlTable.setStatus(_A)
_SwL2TrunkCtrlEntry_Object=MibTableRow
swL2TrunkCtrlEntry=_SwL2TrunkCtrlEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,3,1))
...
swL2TrunkIndex=_SwL2TrunkIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,3,1,1),_SwL2TrunkIndex_Type())
...
swL2TrunkMasterPort=_SwL2TrunkMasterPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,3,1,3),_SwL2TrunkMasterPort_Type())
...
swL2TrunkMember=_SwL2TrunkMember_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,3,1,4),_SwL2TrunkMember_Type())
...
swL2TrunkFloodingPort=_SwL2TrunkFloodingPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,3,1,5),_SwL2TrunkFloodingPort_Type())
...
swL2TrunkType=_SwL2TrunkType_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,3,1,6),_SwL2TrunkType_Type())
...
swL2TrunkState=_SwL2TrunkState_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,3,1,7),_SwL2TrunkState_Type())
...
swL2TrunkAlgorithm=_SwL2TrunkAlgorithm_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,4),_SwL2TrunkAlgorithm_Type())
...
swL2TrunkLACPPortTable=_SwL2TrunkLACPPortTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,5))
if mibBuilder.loadTexts:swL2TrunkLACPPortTable.setStatus(_A)
_SwL2TrunkLACPPortEntry_Object=MibTableRow
swL2TrunkLACPPortEntry=_SwL2TrunkLACPPortEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,5,1))
...
swL2TrunkLACPPortIndex=_SwL2TrunkLACPPortIndex_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,5,1,1),_SwL2TrunkLACPPortIndex_Type())
...
swL2TrunkLACPPortState=_SwL2TrunkLACPPortState_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,5,1,2),_SwL2TrunkLACPPortState_Type())
...
swL2TrunkVLANTable=_SwL2TrunkVLANTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,6))
if mibBuilder.loadTexts:swL2TrunkVLANTable.setStatus(_A)
_SwL2TrunkVLANEntry_Object=MibTableRow
swL2TrunkVLANEntry=_SwL2TrunkVLANEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,6,1))
...
swL2TrunkVLANPort=_SwL2TrunkVLANPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,6,1,1),_SwL2TrunkVLANPort_Type())
...
swL2TrunkVLANState=_SwL2TrunkVLANState_Object((1,3,6,1,4,1,171,11,117,5,1,2,9,6,1,2),_SwL2TrunkVLANState_Type())
...
swL2MirrorMgmt=_SwL2MirrorMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,10))
...
swL2MirrorLogicTargetPort=_SwL2MirrorLogicTargetPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,1),_SwL2MirrorLogicTargetPort_Type())
...
swL2MirrorPortSourceIngress=_SwL2MirrorPortSourceIngress_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,2),_SwL2MirrorPortSourceIngress_Type())
...
swL2MirrorPortSourceEgress=_SwL2MirrorPortSourceEgress_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,3),_SwL2MirrorPortSourceEgress_Type())
...
swL2MirrorPortState=_SwL2MirrorPortState_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,4),_SwL2MirrorPortState_Type())
...
swL2MirrorGroupTable=_SwL2MirrorGroupTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,5))
if mibBuilder.loadTexts:swL2MirrorGroupTable.setStatus(_A)
_SwL2MirrorGroupEntry_Object=MibTableRow
swL2MirrorGroupEntry=_SwL2MirrorGroupEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,5,1))
...
swL2MirrorGroupID=_SwL2MirrorGroupID_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,5,1,1),_SwL2MirrorGroupID_Type())
...
swL2MirrorGroupRowStatus=_SwL2MirrorGroupRowStatus_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,5,1,2),_SwL2MirrorGroupRowStatus_Type())
...
swL2MirrorGroupState=_SwL2MirrorGroupState_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,5,1,3),_SwL2MirrorGroupState_Type())
...
swL2MirrorGroupLogicTargetPort=_SwL2MirrorGroupLogicTargetPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,5,1,4),_SwL2MirrorGroupLogicTargetPort_Type())
...
swL2MirrorGroupPortSourceIngress=_SwL2MirrorGroupPortSourceIngress_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,5,1,5),_SwL2MirrorGroupPortSourceIngress_Type())
...
swL2MirrorGroupPortSourceEngress=_SwL2MirrorGroupPortSourceEngress_Object((1,3,6,1,4,1,171,11,117,5,1,2,10,5,1,6),_SwL2MirrorGroupPortSourceEngress_Type())
...
swL2IGMPMgmt=_SwL2IGMPMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,11))
_SwL2IGMPAccessAuthTable_Object=MibTable
swL2IGMPAccessAuthTable=_SwL2IGMPAccessAuthTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,11,13))
if mibBuilder.loadTexts:swL2IGMPAccessAuthTable.setStatus(_A)
_SwL2IGMPAccessAuthEntry_Object=MibTableRow
swL2IGMPAccessAuthEntry=_SwL2IGMPAccessAuthEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,11,13,1))
...
swL2IGMPAccessAuthPort=_SwL2IGMPAccessAuthPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,11,13,1,1),_SwL2IGMPAccessAuthPort_Type())
...
swL2IGMPAccessAuthState=_SwL2IGMPAccessAuthState_Object((1,3,6,1,4,1,171,11,117,5,1,2,11,13,1,2),_SwL2IGMPAccessAuthState_Type())
...
swL2TrafficSegMgmt=_SwL2TrafficSegMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,14))
_SwL2TrafficSegTable_Object=MibTable
swL2TrafficSegTable=_SwL2TrafficSegTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,14,1))
if mibBuilder.loadTexts:swL2TrafficSegTable.setStatus(_A)
_SwL2TrafficSegEntry_Object=MibTableRow
swL2TrafficSegEntry=_SwL2TrafficSegEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,14,1,1))
...
swL2TrafficSegPort=_SwL2TrafficSegPort_Object((1,3,6,1,4,1,171,11,117,5,1,2,14,1,1,1),_SwL2TrafficSegPort_Type())
...
swL2TrafficSegForwardPorts=_SwL2TrafficSegForwardPorts_Object((1,3,6,1,4,1,171,11,117,5,1,2,14,1,1,2),_SwL2TrafficSegForwardPorts_Type())
...
swL2MulticastFilterMode=_SwL2MulticastFilterMode_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,17))
_SwL2MulticastFilterModeVlanTable_Object=MibTable
swL2MulticastFilterModeVlanTable=_SwL2MulticastFilterModeVlanTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,17,1))
...
swL2MulticastFilterModeVlanEntry=_SwL2MulticastFilterModeVlanEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,17,1,1))
...
swL2MulticastFilterVid=_SwL2MulticastFilterVid_Object((1,3,6,1,4,1,171,11,117,5,1,2,17,1,1,1),_SwL2MulticastFilterVid_Type())
...
swL2MulticastFilterVlanMode=_SwL2MulticastFilterVlanMode_Object((1,3,6,1,4,1,171,11,117,5,1,2,17,1,1,2),_SwL2MulticastFilterVlanMode_Type())
...
swL2DhcpLocalRelayMgmt=_SwL2DhcpLocalRelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,24))
...
swL2DhcpLocalRelayState=_SwL2DhcpLocalRelayState_Object((1,3,6,1,4,1,171,11,117,5,1,2,24,1),_SwL2DhcpLocalRelayState_Type())
...
swL2DhcpLocalRelayVLANTable=_SwL2DhcpLocalRelayVLANTable_Object((1,3,6,1,4,1,171,11,117,5,1,2,24,2))
if mibBuilder.loadTexts:swL2DhcpLocalRelayVLANTable.setStatus(_A)
_SwL2DhcpLocalRelayVLANEntry_Object=MibTableRow
swL2DhcpLocalRelayVLANEntry=_SwL2DhcpLocalRelayVLANEntry_Object((1,3,6,1,4,1,171,11,117,5,1,2,24,2,1))
...
swL2DhcpLocalRelayVLANID=_SwL2DhcpLocalRelayVLANID_Object((1,3,6,1,4,1,171,11,117,5,1,2,24,2,1,1),_SwL2DhcpLocalRelayVLANID_Type())
...
swL2DhcpLocalRelayVLANState=_SwL2DhcpLocalRelayVLANState_Object((1,3,6,1,4,1,171,11,117,5,1,2,24,2,1,2),_SwL2DhcpLocalRelayVLANState_Type())
...
swL2MgmtMIBTraps=_SwL2MgmtMIBTraps_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,100))
_SwL2Notify_ObjectIdentity=ObjectIdentity
swL2Notify=_SwL2Notify_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,100,1))
_SwL2NotifyMgmt_ObjectIdentity=ObjectIdentity
swL2NotifyMgmt=_SwL2NotifyMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,100,1,1))
_SwL2macNotificationSeverity_Type=AgentNotifyLevel
_SwL2macNotificationSeverity_Object=MibScalar
swL2macNotificationSeverity=_SwL2macNotificationSeverity_Object((1,3,6,1,4,1,171,11,117,5,1,2,100,1,1,1),_SwL2macNotificationSeverity_Type())
...
swL2PortSecurityViolationSeverity=_SwL2PortSecurityViolationSeverity_Object((1,3,6,1,4,1,171,11,117,5,1,2,100,1,1,2),_SwL2PortSecurityViolationSeverity_Type())
...
swL2NotifyPrefix=_SwL2NotifyPrefix_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,100,1,2))
_SwL2NotifFirmware_ObjectIdentity=ObjectIdentity
swL2NotifFirmware=_SwL2NotifFirmware_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,100,1,2,0))
_Swl2NotificationBidings_ObjectIdentity=ObjectIdentity
swl2NotificationBidings=_Swl2NotificationBidings_ObjectIdentity((1,3,6,1,4,1,171,11,117,5,1,2,100,1,2,1))
...
swL2macNotifyInfo=_SwL2macNotifyInfo_Object((1,3,6,1,4,1,171,11,117,5,1,2,100,1,2,1,1),_SwL2macNotifyInfo_Type())
...
swL2PortSecurityViolationMac=_SwL2PortSecurityViolationMac_Object((1,3,6,1,4,1,171,11,117,5,1,2,100,1,2,1,2),_SwL2PortSecurityViolationMac_Type())
...
swL2macNotification=NotificationType((1,3,6,1,4,1,171,11,117,5,1,2,100,1,2,0,1))
swL2macNotification.setObjects((_G,_m))
if mibBuilder.loadTexts:swL2macNotification.setStatus(_A)
swL2PortSecurityViolationTrap=NotificationType((1,3,6,1,4,1,171,11,117,5,1,2,100,1,2,0,2))
