...
NtnMacAddress, NtnGauge32, ntntechInterfaceModule, NtnTimeTicks, NtnCounter32, NtnDisplayString = mibBuilder.importSymbols("NTNTECH-ROOT-MIB", "NtnMacAddress", "NtnGauge32", "ntntechInterfaceModule", "NtnTimeTicks", "NtnCounter32", "NtnDisplayString")
...
mibBuilder.exportSymbols("NTNTECH-INTERFACE-MODULE-STATUS-MIB", ifStaPortRxWanNUCastUtil=ifStaPortRxWanNUCastUtil, ifStaPortTxWanNUCastAveRate=ifStaPortTxWanNUCastAveRate, ifStaPortSlotIndex=ifStaPortSlotIndex, ifStaPortRxWanNUCastMaxRate=ifStaPortRxWanNUCastMaxRate, ifStaPortTxWanNUCastMaxRate=ifStaPortTxWanNUCastMaxRate, ifStaPortTotRxWanRate=ifStaPortTotRxWanRate, ifStaPortTotTxWanRate=ifStaPortTotTxWanRate, ifStaLoopBondedGroupID=ifStaLoopBondedGroupID, valInterface=valInterface, PYSNMP_MODULE_ID=ntntechInterfaceModuleStatusMIB, ifStaPortFirmwareRev=ifStaPortFirmwareRev, ifStaPortTxWanNUCastRate=ifStaPortTxWanNUCastRate, ifStaPortRxWanNUCastRate=ifStaPortRxWanNUCastRate, ifStaPortEntry=ifStaPortEntry, ifModStaMIBObjects=ifModStaMIBObjects, ifStaPortRxWanUCastRate=ifStaPortRxWanUCastRate, ifStaPortRxWanUCastUtil=ifStaPortRxWanUCastUtil, ifStaFirmwareRev=ifStaFirmwareRev, ifStaPortTotDwnTime=ifStaPortTotDwnTime, ifStaPortTotRxWanPercentUtil=ifStaPortTotRxWanPercentUtil, ifStaLastMacCausingLoop=ifStaLastMacCausingLoop, ifStaSlotIndex=ifStaSlotIndex, ifStaUCastTxPkt=ifStaUCastTxPkt, ntntechInterfaceModuleStatusMIB=ntntechInterfaceModuleStatusMIB, ifStaPortTxWanUCastUtil=ifStaPortTxWanUCastUtil, ifStaPortTxWanUCastRate=ifStaPortTxWanUCastRate, ifStaPortRxWanUCastAveRate=ifStaPortRxWanUCastAveRate, ifStaCount=ifStaCount, ifStaPortTotUpTime=ifStaPortTotUpTime, ifStaNUCastTxPkt=ifStaNUCastTxPkt, ifStaLoopBondedGroupPortList=ifStaLoopBondedGroupPortList, ifStaPortRxWanNUCastAveRate=ifStaPortRxWanNUCastAveRate, ifStaPortTxWanUCastAveRate=ifStaPortTxWanUCastAveRate, ifStaNetworkLoopCount=ifStaNetworkLoopCount, ifStaPortTxWanUCastMaxRate=ifStaPortTxWanUCastMaxRate, ifStaPortLinkState=ifStaPortLinkState, ifStaNUCastRxPkt=ifStaNUCastRxPkt, ifStaEntry=ifStaEntry, ifStaPortTotTxWanPercentUtil=ifStaPortTotTxWanPercentUtil, ifStaTable=ifStaTable, ifModStaValues=ifModStaValues, ifStaLastMacSrcPort=ifStaLastMacSrcPort, ifStaPortRxWanUCastMaxRate=ifStaPortRxWanUCastMaxRate, ifStaUCastRxPkt=ifStaUCastRxPkt, ifStaPortTable=ifStaPortTable, ifStaPortTxWanNUCastUtil=ifStaPortTxWanNUCastUtil, ifStaType=ifStaType, ifStaPortPortIndex=ifStaPortPortIndex)
