...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/zhone/NTNTECH-INTERFACE-MODULE-STATUS-MIB
...
ntntechInterfaceModule, NtnMacAddress, NtnDisplayString, NtnGauge32, NtnTimeTicks, NtnCounter32 = mibBuilder.importSymbols("NTNTECH-ROOT-MIB", "ntntechInterfaceModule", "NtnMacAddress", "NtnDisplayString", "NtnGauge32", "NtnTimeTicks", "NtnCounter32")
...
mibBuilder.exportSymbols("NTNTECH-INTERFACE-MODULE-STATUS-MIB", ifStaPortTotRxWanRate=ifStaPortTotRxWanRate, ifStaNUCastRxPkt=ifStaNUCastRxPkt, ifStaLoopBondedGroupID=ifStaLoopBondedGroupID, ifStaLastMacSrcPort=ifStaLastMacSrcPort, ifStaPortTotRxWanPercentUtil=ifStaPortTotRxWanPercentUtil, ifStaUCastTxPkt=ifStaUCastTxPkt, PYSNMP_MODULE_ID=ntntechInterfaceModuleStatusMIB, ifStaPortRxWanUCastAveRate=ifStaPortRxWanUCastAveRate, ifStaPortFirmwareRev=ifStaPortFirmwareRev, ifStaPortTxWanNUCastRate=ifStaPortTxWanNUCastRate, ntntechInterfaceModuleStatusMIB=ntntechInterfaceModuleStatusMIB, ifStaPortTxWanUCastRate=ifStaPortTxWanUCastRate, ifModStaValues=ifModStaValues, ifStaPortTotTxWanPercentUtil=ifStaPortTotTxWanPercentUtil, ifStaNetworkLoopCount=ifStaNetworkLoopCount, ifStaPortTotTxWanRate=ifStaPortTotTxWanRate, ifStaPortTxWanNUCastMaxRate=ifStaPortTxWanNUCastMaxRate, ifStaFirmwareRev=ifStaFirmwareRev, ifStaPortRxWanNUCastUtil=ifStaPortRxWanNUCastUtil, ifStaPortLinkState=ifStaPortLinkState, ifStaPortTotUpTime=ifStaPortTotUpTime, ifStaPortTable=ifStaPortTable, ifStaLoopBondedGroupPortList=ifStaLoopBondedGroupPortList, ifStaPortPortIndex=ifStaPortPortIndex, ifStaPortTxWanUCastAveRate=ifStaPortTxWanUCastAveRate, ifStaPortTxWanUCastMaxRate=ifStaPortTxWanUCastMaxRate, ifStaPortTxWanNUCastAveRate=ifStaPortTxWanNUCastAveRate, ifStaPortTotDwnTime=ifStaPortTotDwnTime, ifStaPortTxWanUCastUtil=ifStaPortTxWanUCastUtil, ifModStaMIBObjects=ifModStaMIBObjects, ifStaSlotIndex=ifStaSlotIndex, ifStaEntry=ifStaEntry, ifStaPortRxWanNUCastRate=ifStaPortRxWanNUCastRate, ifStaPortRxWanUCastUtil=ifStaPortRxWanUCastUtil, ifStaCount=ifStaCount, ifStaTable=ifStaTable, ifStaUCastRxPkt=ifStaUCastRxPkt, ifStaNUCastTxPkt=ifStaNUCastTxPkt, ifStaPortRxWanNUCastAveRate=ifStaPortRxWanNUCastAveRate, ifStaPortEntry=ifStaPortEntry, ifStaLastMacCausingLoop=ifStaLastMacCausingLoop, valInterface=valInterface, ifStaPortRxWanNUCastMaxRate=ifStaPortRxWanNUCastMaxRate, ifStaPortSlotIndex=ifStaPortSlotIndex, ifStaPortRxWanUCastRate=ifStaPortRxWanUCastRate, ifStaPortTxWanNUCastUtil=ifStaPortTxWanNUCastUtil, ifStaPortRxWanUCastMaxRate=ifStaPortRxWanUCastMaxRate, ifStaType=ifStaType)
