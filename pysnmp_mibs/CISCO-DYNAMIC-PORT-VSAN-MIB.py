...
CpsmActivateResult, CpsmDiffReason, CpsmDiffDb, CpsmDbActivate = mibBuilder.importSymbols("CISCO-PSM-MIB", "CpsmActivateResult", "CpsmDiffReason", "CpsmDiffDb", "CpsmDbActivate")
...
mibBuilder.exportSymbols("CISCO-DYNAMIC-PORT-VSAN-MIB", cdpvmDiffEntry=cdpvmDiffEntry, ciscoDpvmEnforcedGroup=ciscoDpvmEnforcedGroup, cdpvmIndex=cdpvmIndex, cdpvmDynPortVsan=cdpvmDynPortVsan, PYSNMP_MODULE_ID=ciscoDpvmMIB, cdpvmRowStatus=cdpvmRowStatus, cdpvmTable=cdpvmTable, cdpvmEnfLoginDevType=cdpvmEnfLoginDevType, cdpvmEnfLoginDev=cdpvmEnfLoginDev, ciscoDpvmMIBConform=ciscoDpvmMIBConform, cdpvmDynPortsTable=cdpvmDynPortsTable, cdpvmDiffTable=cdpvmDiffTable, ciscoDpvmMIBCompliances=ciscoDpvmMIBCompliances, ciscoDpvmAutoLearnGroup=ciscoDpvmAutoLearnGroup, ciscoDpvmMIBNotifs=ciscoDpvmMIBNotifs, cdpvmEnfIsLearnt=cdpvmEnfIsLearnt, cdpvmActivateResult=cdpvmActivateResult, cdpvmDiffLoginDev=cdpvmDiffLoginDev, cdpvmDiffConfig=cdpvmDiffConfig, cdpvmActivationState=cdpvmActivationState, cdpvmClearAutoLearn=cdpvmClearAutoLearn, ciscoDpvmMIBCompliance=ciscoDpvmMIBCompliance, cdpvmCopyEnfToConfig=cdpvmCopyEnfToConfig, cdpvmLoginDevType=cdpvmLoginDevType, cdpvmDiffReason=cdpvmDiffReason, cdpvmNextAvailIndex=cdpvmNextAvailIndex, cdpvmConfiguration=cdpvmConfiguration, cdpvmAutoLearn=cdpvmAutoLearn, cdpvmLoginDev=cdpvmLoginDev, ciscoDpvmMIB=ciscoDpvmMIB, cdpvmLoginDevVsan=cdpvmLoginDevVsan, CdpvmDevType=CdpvmDevType, cdpvmDynPortDevPwwn=cdpvmDynPortDevPwwn, cdpvmDiffIndex=cdpvmDiffIndex, ciscoDpvmMIBObjects=ciscoDpvmMIBObjects, cdpvmEnfLoginDevVsan=cdpvmEnfLoginDevVsan, ciscoDpvmMIBGroups=ciscoDpvmMIBGroups, cdpvmDiffLoginDevType=cdpvmDiffLoginDevType, ciscoDpvmDiffGroup=ciscoDpvmDiffGroup, cdpvmDynPortsEntry=cdpvmDynPortsEntry, cdpvmActivate=cdpvmActivate, cdpvmEnfTable=cdpvmEnfTable, cdpvmDynPortDevNwwn=cdpvmDynPortDevNwwn, ciscoDpvmConfigGroup=ciscoDpvmConfigGroup, cdpvmEnfIndex=cdpvmEnfIndex, cdpvmClearAutoLearnWwn=cdpvmClearAutoLearnWwn, cdpvmEnfEntry=cdpvmEnfEntry, cdpvmEntry=cdpvmEntry, cdpvmDiffLoginDevVsan=cdpvmDiffLoginDevVsan)
