...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DYNAMIC-PORT-VSAN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:39 2025
...
_CdpvmLoginDevType_Type.__name__ = "CdpvmDevType"
...
_CdpvmLoginDevVsan_Type.__name__ = "VsanIndex"
...
_CdpvmClearAutoLearnWwn_Type.__name__ = "FcNameIdOrZero"
...
ciscoDpvmMIBCompliance.setObjects(
      *(("CISCO-DYNAMIC-PORT-VSAN-MIB", "ciscoDpvmConfigGroup"),
        ("CISCO-DYNAMIC-PORT-VSAN-MIB", "ciscoDpvmEnforcedGroup"),
        ("CISCO-DYNAMIC-PORT-VSAN-MIB", "ciscoDpvmAutoLearnGroup"),
        ("CISCO-DYNAMIC-PORT-VSAN-MIB", "ciscoDpvmDiffGroup"))
)
if mibBuilder.loadTexts:
