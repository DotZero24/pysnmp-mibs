...
myIgmpSnoopingMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,8))
...
myIgmpSnoopingMIBObjects=_MyIgmpSnoopingMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,8,1))
...
mySNIgmpWorkingMode=_MySNIgmpWorkingMode_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,1),_MySNIgmpWorkingMode_Type())
...
mySNIgmpSourcePortCheck=_MySNIgmpSourcePortCheck_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,2),_MySNIgmpSourcePortCheck_Type())
...
mySNIgmpSourceIpCheck=_MySNIgmpSourceIpCheck_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,3),_MySNIgmpSourceIpCheck_Type())
...
mySNIgmpSourceIpCheckDefIp=_MySNIgmpSourceIpCheckDefIp_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,4),_MySNIgmpSourceIpCheckDefIp_Type())
...
mySNIgmpSrcIpCheckTable=_MySNIgmpSrcIpCheckTable_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,5))
if mibBuilder.loadTexts:mySNIgmpSrcIpCheckTable.setStatus(_B)
_MySNIgmpSrcIpCheckEntry_Object=MibTableRow
mySNIgmpSrcIpCheckEntry=_MySNIgmpSrcIpCheckEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,5,1))
...
mySNIgmpSrcIpCheckVID=_MySNIgmpSrcIpCheckVID_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,5,1,1),_MySNIgmpSrcIpCheckVID_Type())
...
mySNIgmpSrcIpCheckMultiIpAddr=_MySNIgmpSrcIpCheckMultiIpAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,5,1,2),_MySNIgmpSrcIpCheckMultiIpAddr_Type())
...
mySNIgmpSrcIpCheckSrcIpAddr=_MySNIgmpSrcIpCheckSrcIpAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,5,1,3),_MySNIgmpSrcIpCheckSrcIpAddr_Type())
...
mySNIgmpSrcIpCheckEntryStatus=_MySNIgmpSrcIpCheckEntryStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,5,1,4),_MySNIgmpSrcIpCheckEntryStatus_Type())
...
mySNIgmpPortTable=_MySNIgmpPortTable_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,6))
if mibBuilder.loadTexts:mySNIgmpPortTable.setStatus(_I)
_MySNIgmpPortEntry_Object=MibTableRow
mySNIgmpPortEntry=_MySNIgmpPortEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,6,1))
...
mySNIgmpPortRouterVID=_MySNIgmpPortRouterVID_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,6,1,1),_MySNIgmpPortRouterVID_Type())
...
mySNIgmpPortIndex=_MySNIgmpPortIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,6,1,2),_MySNIgmpPortIndex_Type())
...
mySNIgmpPortRouterState=_MySNIgmpPortRouterState_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,6,1,3),_MySNIgmpPortRouterState_Type())
...
mySNIgmpPortRouterProfile=_MySNIgmpPortRouterProfile_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,6,1,4),_MySNIgmpPortRouterProfile_Type())
...
mySNIgmpGDANumber=_MySNIgmpGDANumber_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,7),_MySNIgmpGDANumber_Type())
mySNIgmpGDANumber.setMaxAccess(_D)
if mibBuilder.loadTexts:mySNIgmpGDANumber.setStatus(_B)
_MySNIgmpGDATable_Object=MibTable
mySNIgmpGDATable=_MySNIgmpGDATable_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,8))
if mibBuilder.loadTexts:mySNIgmpGDATable.setStatus(_B)
_MySNIgmpGDAEntry_Object=MibTableRow
mySNIgmpGDAEntry=_MySNIgmpGDAEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,8,1))
...
mySNIgmpGDAVID=_MySNIgmpGDAVID_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,8,1,1),_MySNIgmpGDAVID_Type())
...
mySNIgmpGDAAddr=_MySNIgmpGDAAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,8,1,2),_MySNIgmpGDAAddr_Type())
...
mySNIgmpGDAPortMemberAction=_MySNIgmpGDAPortMemberAction_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,8,1,3),_MySNIgmpGDAPortMemberAction_Type())
...
mySNIgmpGDATrunkMemberAction=_MySNIgmpGDATrunkMemberAction_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,8,1,4),_MySNIgmpGDATrunkMemberAction_Type())
...
mySNIgmpSvglVID=_MySNIgmpSvglVID_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,9),_MySNIgmpSvglVID_Type())
...
mySNIgmpSvglProfile=_MySNIgmpSvglProfile_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,10),_MySNIgmpSvglProfile_Type())
...
mySNIgmpMrLearnTable=_MySNIgmpMrLearnTable_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,11))
if mibBuilder.loadTexts:mySNIgmpMrLearnTable.setStatus(_B)
_MySNIgmpMrLearnEntry_Object=MibTableRow
mySNIgmpMrLearnEntry=_MySNIgmpMrLearnEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,11,1))
...
mySNIgmpMrLearnVID=_MySNIgmpMrLearnVID_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,11,1,1),_MySNIgmpMrLearnVID_Type())
...
mySNIgmpMrLearnStatus=_MySNIgmpMrLearnStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,11,1,2),_MySNIgmpMrLearnStatus_Type())
...
mySNIgmpPortFilteringTable=_MySNIgmpPortFilteringTable_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,12))
if mibBuilder.loadTexts:mySNIgmpPortFilteringTable.setStatus(_B)
_MySNIgmpPortFilteringEntry_Object=MibTableRow
mySNIgmpPortFilteringEntry=_MySNIgmpPortFilteringEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,12,1))
...
mySNPortIndex=_MySNPortIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,12,1,1),_MySNPortIndex_Type())
...
mySNIgmpFilteringProfile=_MySNIgmpFilteringProfile_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,12,1,2),_MySNIgmpFilteringProfile_Type())
...
mySNIgmpFilteringMaxGroups=_MySNIgmpFilteringMaxGroups_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,12,1,3),_MySNIgmpFilteringMaxGroups_Type())
...
mySNIgmpGDAConfigTable=_MySNIgmpGDAConfigTable_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,13))
if mibBuilder.loadTexts:mySNIgmpGDAConfigTable.setStatus(_B)
_MySNIgmpGDAConfigEntry_Object=MibTableRow
mySNIgmpGDAConfigEntry=_MySNIgmpGDAConfigEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,13,1))
...
mySNIgmpGDAConfigVID=_MySNIgmpGDAConfigVID_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,13,1,1),_MySNIgmpGDAConfigVID_Type())
...
mySNIgmpGDAConfigAddr=_MySNIgmpGDAConfigAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,13,1,2),_MySNIgmpGDAConfigAddr_Type())
...
mySNIgmpGDAConfigIfIndex=_MySNIgmpGDAConfigIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,13,1,3),_MySNIgmpGDAConfigIfIndex_Type())
...
mySNIgmpGDAConfigType=_MySNIgmpGDAConfigType_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,13,1,4),_MySNIgmpGDAConfigType_Type())
...
mySNIgmpGDAConfigStatus=_MySNIgmpGDAConfigStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,13,1,5),_MySNIgmpGDAConfigStatus_Type())
...
mySNIgmpQueryResponeTime=_MySNIgmpQueryResponeTime_Object((1,3,6,1,4,1,4881,1,1,10,2,8,1,14),_MySNIgmpQueryResponeTime_Type())
...
myIgmpSnoopingMIBConformance=_MyIgmpSnoopingMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,8,2))
_MyIgmpSnoopingMIBCompliances_ObjectIdentity=ObjectIdentity
myIgmpSnoopingMIBCompliances=_MyIgmpSnoopingMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,8,2,1))
_MyIgmpSnoopingMIBGroups_ObjectIdentity=ObjectIdentity
myIgmpSnoopingMIBGroups=_MyIgmpSnoopingMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,8,2,2))
myIgmpSnoopingMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,8,2,2,1))
...
myIgmpSnoopingMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,8,2,1,1))
