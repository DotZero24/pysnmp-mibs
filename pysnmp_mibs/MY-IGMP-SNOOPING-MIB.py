# SNMP MIB module (MY-IGMP-SNOOPING-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-IGMP-SNOOPING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:34:53 2025
...
mySNIgmpSrcIpCheckEntry.setIndexNames(
    (0, "MY-IGMP-SNOOPING-MIB", "mySNIgmpSrcIpCheckVID"),
    (0, "MY-IGMP-SNOOPING-MIB", "mySNIgmpSrcIpCheckMultiIpAddr"),
)
if mibBuilder.loadTexts:
...
mySNIgmpPortEntry.setIndexNames(
    (0, "MY-IGMP-SNOOPING-MIB", "mySNIgmpPortRouterVID"),
    (0, "MY-IGMP-SNOOPING-MIB", "mySNIgmpPortIndex"),
)
if mibBuilder.loadTexts:
...
mySNIgmpGDAEntry.setIndexNames(
    (0, "MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAVID"),
    (0, "MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAAddr"),
)
if mibBuilder.loadTexts:
...
mySNIgmpMrLearnEntry.setIndexNames(
    (0, "MY-IGMP-SNOOPING-MIB", "mySNIgmpMrLearnVID"),
)
if mibBuilder.loadTexts:
...
mySNIgmpPortFilteringEntry.setIndexNames(
    (0, "MY-IGMP-SNOOPING-MIB", "mySNPortIndex"),
)
if mibBuilder.loadTexts:
...
mySNIgmpGDAConfigEntry.setIndexNames(
    (0, "MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAConfigVID"),
    (0, "MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAConfigAddr"),
)
if mibBuilder.loadTexts:
...
myIgmpSnoopingMIBGroup.setObjects(
      *(("MY-IGMP-SNOOPING-MIB", "mySNIgmpWorkingMode"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpSourcePortCheck"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpSourceIpCheck"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpSourceIpCheckDefIp"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpSrcIpCheckVID"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpSrcIpCheckMultiIpAddr"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpSrcIpCheckSrcIpAddr"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpSrcIpCheckEntryStatus"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpPortRouterVID"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpPortIndex"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpPortRouterState"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpPortRouterProfile"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDANumber"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAVID"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAAddr"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAPortMemberAction"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDATrunkMemberAction"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpSvglVID"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpSvglProfile"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpMrLearnVID"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpMrLearnStatus"),
        ("MY-IGMP-SNOOPING-MIB", "mySNPortIndex"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpFilteringProfile"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpFilteringMaxGroups"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAConfigVID"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAConfigAddr"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAConfigIfIndex"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAConfigType"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpGDAConfigStatus"),
        ("MY-IGMP-SNOOPING-MIB", "mySNIgmpQueryResponeTime"))
)
if mibBuilder.loadTexts:
...
myIgmpSnoopingMIBCompliance.setObjects(
    ("MY-IGMP-SNOOPING-MIB", "myIgmpSnoopingMIBGroup")
)
if mibBuilder.loadTexts:
