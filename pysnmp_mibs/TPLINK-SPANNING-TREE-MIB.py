...
# Notes
# -----
# ASN.1 source file://mibs/tplink/TPLINK-SPANNING-TREE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:55:43 2025
...
class _TpStpBPDUFloodEnable_Type(Integer32):
    """Custom type tpStpBPDUFloodEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TpStpBPDUFloodEnable_Type.__name__ = "Integer32"
_TpStpBPDUFloodEnable_Object = MibTableColumn
tpStpBPDUFloodEnable = _TpStpBPDUFloodEnable_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 21, 1, 4, 1, 1, 7),
    _TpStpBPDUFloodEnable_Type()
)
tpStpBPDUFloodEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tpStpBPDUFloodEnable.setStatus("current")
...
tpStpDefendPortLag = _TpStpDefendPortLag_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 21, 1, 4, 1, 1, 8),
...
mibBuilder.exportSymbols(
    ...
    **{"tplinkSpanningTreeMIB": tplinkSpanningTreeMIB,
       ...
       "tpStpBPDUFloodEnable": tpStpBPDUFloodEnable,
