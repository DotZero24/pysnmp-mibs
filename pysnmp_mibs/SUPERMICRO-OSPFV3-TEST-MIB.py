...
futOspfv3TestIfTable=_FutOspfv3TestIfTable_Object((1,3,6,1,4,1,10876,101,1,301,1))
if mibBuilder.loadTexts:futOspfv3TestIfTable.setStatus(_A)
_FutOspfv3TestIfEntry_Object=MibTableRow
futOspfv3TestIfEntry=_FutOspfv3TestIfEntry_Object((1,3,6,1,4,1,10876,101,1,301,1,1))
...
futOspfv3TestIfIndex=_FutOspfv3TestIfIndex_Object((1,3,6,1,4,1,10876,101,1,301,1,1,1),_FutOspfv3TestIfIndex_Type())
...
futOspfv3TestDemandTraffic=_FutOspfv3TestDemandTraffic_Object((1,3,6,1,4,1,10876,101,1,301,1,1,2),_FutOspfv3TestDemandTraffic_Type())
...
futOspfv3ExtRouteTable=_FutOspfv3ExtRouteTable_Object((1,3,6,1,4,1,10876,101,1,301,2))
if mibBuilder.loadTexts:futOspfv3ExtRouteTable.setStatus(_A)
_FutOspfv3ExtRouteEntry_Object=MibTableRow
futOspfv3ExtRouteEntry=_FutOspfv3ExtRouteEntry_Object((1,3,6,1,4,1,10876,101,1,301,2,1))
...
futOspfv3ExtRouteDestType=_FutOspfv3ExtRouteDestType_Object((1,3,6,1,4,1,10876,101,1,301,2,1,1),_FutOspfv3ExtRouteDestType_Type())
...
futOspfv3ExtRouteDest=_FutOspfv3ExtRouteDest_Object((1,3,6,1,4,1,10876,101,1,301,2,1,2),_FutOspfv3ExtRouteDest_Type())
...
futOspfv3ExtRoutePfxLength=_FutOspfv3ExtRoutePfxLength_Object((1,3,6,1,4,1,10876,101,1,301,2,1,3),_FutOspfv3ExtRoutePfxLength_Type())
...
futOspfv3ExtRouteNextHopType=_FutOspfv3ExtRouteNextHopType_Object((1,3,6,1,4,1,10876,101,1,301,2,1,4),_FutOspfv3ExtRouteNextHopType_Type())
...
futOspfv3ExtRouteNextHop=_FutOspfv3ExtRouteNextHop_Object((1,3,6,1,4,1,10876,101,1,301,2,1,5),_FutOspfv3ExtRouteNextHop_Type())
...
futOspfv3ExtRouteStatus=_FutOspfv3ExtRouteStatus_Object((1,3,6,1,4,1,10876,101,1,301,2,1,6),_FutOspfv3ExtRouteStatus_Type())
