# SNMP MIB module (RADLAN-rlBrgMulticast-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-rlBrgMulticast-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:17 2025
...
rlBrgStaticIpMulticastEntry = _RlBrgStaticIpMulticastEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 116, 3, 1)
)
rlBrgStaticIpMulticastEntry.setIndexNames(
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgStaticIpMulticastVlanTag"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgStaticIpMulticastGroupAddress"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgStaticIpMulticastSourceAddress"),
)
if mibBuilder.loadTexts:
...
rlBrgIpMulticastEntry = _RlBrgIpMulticastEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 116, 4, 1)
)
rlBrgIpMulticastEntry.setIndexNames(
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgIpMulticastVlanTag"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgIpMulticastGroupAddress"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgIpMulticastSourceAddress"),
)
if mibBuilder.loadTexts:
...
rlBrgStaticInetMulticastEntry = _RlBrgStaticInetMulticastEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 116, 5, 1)
)
rlBrgStaticInetMulticastEntry.setIndexNames(
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgStaticInetMulticastVlanTag"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgStaticInetMulticastGroupAddressType"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgStaticInetMulticastGroupAddress"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgStaticInetMulticastSourceAddressType"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgStaticInetMulticastSourceAddress"),
)
if mibBuilder.loadTexts:
...
rlBrgInetMulticastEntry = _RlBrgInetMulticastEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 116, 6, 1)
)
rlBrgInetMulticastEntry.setIndexNames(
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgInetMulticastVlanTag"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgInetMulticastGroupAddressType"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgInetMulticastGroupAddress"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgInetMulticastSourceAddressType"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgInetMulticastSourceAddress"),
)
if mibBuilder.loadTexts:
...
rlBrgIpmFdbRefEntry = _RlBrgIpmFdbRefEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 116, 7, 1)
)
rlBrgIpmFdbRefEntry.setIndexNames(
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgIpmFdbRefVlanTag"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgIpmFdbRefGroupAddressType"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgIpmFdbRefGroupAddress"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgIpmFdbRefSourceAddressType"),
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgIpmFdbRefSourceAddress"),
)
if mibBuilder.loadTexts:
...
rlBrgDynamicCmdEntry = _RlBrgDynamicCmdEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 116, 8, 1)
)
rlBrgDynamicCmdEntry.setIndexNames(
    (0, "RADLAN-rlBrgMulticast-MIB", "rlBrgDynamicCmdKey"),
)
if mibBuilder.loadTexts:
...
rlUserAssignedVidxConfigEntry = _RlUserAssignedVidxConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 116, 9, 1, 1)
)
rlUserAssignedVidxConfigEntry.setIndexNames(
    (0, "RADLAN-rlBrgMulticast-MIB", "rlUserAssignedVidxConfigIndex"),
)
if mibBuilder.loadTexts:
