...
# Notes
# -----
# ASN.1 source file://mibs/aruba/WLSX-SYSTEMEXT-MIB
...
if mibBuilder.loadTexts:
    wlsxSysExtSwitchMasterIp.setStatus("obsolete")
...
wlsxSysExtSwitchConductorIp = _WlsxSysExtSwitchConductorIp_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 2, 1, 2, 1, 41),
    _WlsxSysExtSwitchConductorIp_Type()
)
wlsxSysExtSwitchConductorIp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    wlsxSysExtSwitchConductorIp.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"wlsxSystemExtMIB": wlsxSystemExtMIB,
       ...
       "wlsxSysExtSwitchConductorIp": wlsxSysExtSwitchConductorIp,
