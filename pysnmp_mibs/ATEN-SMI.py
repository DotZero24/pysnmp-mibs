# SNMP MIB module (ATEN-SMI) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aten/ATEN-SMI
...
atenExperiment = _AtenExperiment_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 21317, 3)
)
