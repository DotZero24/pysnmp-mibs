# SNMP MIB module (A3COM-HUAWEI-VOGKCLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-VOGKCLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:45:25 2025
...
h3cVoGKClientObjects = _H3cVoGKClientObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1)
)
...
h3cVoRasOn = _H3cVoRasOn_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 1),
    _H3cVoRasOn_Type()
)
...
h3cVoGwIPAddressType = _H3cVoGwIPAddressType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 2),
...
h3cVoGwIPAddress = _H3cVoGwIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 3),
...
h3cVoH323GWID = _H3cVoH323GWID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 4),
    _H3cVoH323GWID_Type()
)
...
h3cVoH323GKID = _H3cVoH323GKID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 5),
    _H3cVoH323GKID_Type()
)
...
h3cVoH323GKIPAddressType = _H3cVoH323GKIPAddressType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 6),
...
h3cVoH323GKIPAddress = _H3cVoH323GKIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 7),
...
h3cVoH323GKPort = _H3cVoH323GKPort_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 8),
...
h3cVoH323GK2ID = _H3cVoH323GK2ID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 9),
...
h3cVoH323GK2IPAddressType = _H3cVoH323GK2IPAddressType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 10),
...
h3cVoH323GK2IPAddress = _H3cVoH323GK2IPAddress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 11),
...
h3cVoH323GK2Port = _H3cVoH323GK2Port_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 12),
...
h3cVoH323GKSecurityCall = _H3cVoH323GKSecurityCall_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 13),
...
h3cVoH323GKSecurityPWDType = _H3cVoH323GKSecurityPWDType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 14),
...
h3cVoH323GKSecurityPWD = _H3cVoH323GKSecurityPWD_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 8, 1, 15),
