...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TN-FILTER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:56:12 2025
...
class _TnMacFilterApplied_Type(TruthValue):
    """Custom type tnMacFilterApplied based on TruthValue"""
    defaultValue = 2


_TnMacFilterApplied_Type.__name__ = "TruthValue"
_TnMacFilterApplied_Object = MibTableColumn
tnMacFilterApplied = _TnMacFilterApplied_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 21, 3, 1, 8),
    _TnMacFilterApplied_Type()
)
tnMacFilterApplied.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnMacFilterApplied.setStatus("current")


class _TnMacFilterNumEntries_Type(Unsigned32):
    """Custom type tnMacFilterNumEntries based on Unsigned32"""
    defaultValue = 0


_TnMacFilterNumEntries_Type.__name__ = "Unsigned32"
_TnMacFilterNumEntries_Object = MibTableColumn
tnMacFilterNumEntries = _TnMacFilterNumEntries_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 21, 3, 1, 9),
    _TnMacFilterNumEntries_Type()
)
tnMacFilterNumEntries.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnMacFilterNumEntries.setStatus("current")
...
tnMacFilterAssociationScalar = _TnMacFilterAssociationScalar_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 21, 7),
    _TnMacFilterAssociationScalar_Type()
)
tnMacFilterAssociationScalar.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnMacFilterAssociationScalar.setStatus("current")
_TnMacFilterAssociationTable_Object = MibTable
tnMacFilterAssociationTable = _TnMacFilterAssociationTable_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 21, 8)
)
if mibBuilder.loadTexts:
    tnMacFilterAssociationTable.setStatus("current")
_TnMacFilterAssociationEntry_Object = MibTableRow
tnMacFilterAssociationEntry = _TnMacFilterAssociationEntry_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 21, 8, 1)
)
tnMacFilterAssociationEntry.setIndexNames(
    (0, "TROPIC-SYSTEM-MIB", "tnSysSwitchId"),
    (0, "TN-FILTER-MIB", "tnMacFilterId"),
...
if mibBuilder.loadTexts:
    tnMacFilterAssociationEntry.setStatus("current")


class _TnMacFilterAssociationDirection_Type(Integer32):
    """Custom type tnMacFilterAssociationDirection based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_TnMacFilterAssociationDirection_Type.__name__ = "Integer32"
_TnMacFilterAssociationDirection_Object = MibTableColumn
tnMacFilterAssociationDirection = _TnMacFilterAssociationDirection_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 21, 8, 1, 1),
    _TnMacFilterAssociationDirection_Type()
)
tnMacFilterAssociationDirection.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnMacFilterAssociationDirection.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"TFilterAction": TFilterAction,
       ...
       "tnMacFilterApplied": tnMacFilterApplied,
       "tnMacFilterNumEntries": tnMacFilterNumEntries,
       ...
       "tnMacFilterAssociationScalar": tnMacFilterAssociationScalar,
       "tnMacFilterAssociationTable": tnMacFilterAssociationTable,
       "tnMacFilterAssociationEntry": tnMacFilterAssociationEntry,
