# SNMP MIB module (QTECH-WLAN-FIT-AP-CF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-WLAN-FIT-AP-CF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:58:53 2025
...
apSystemInfoConfigObjects = _ApSystemInfoConfigObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1)
)
...
apGeneralInfoConfigTableEntry = _ApGeneralInfoConfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 1, 1, 1)
)
...
apSysNEId = _ApSysNEId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 1, 1, 1, 1),
    _ApSysNEId_Type()
)
...
apSysName = _ApSysName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 1, 1, 1, 2),
    _ApSysName_Type()
)
...
apStatWindowTime = _ApStatWindowTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 1, 1, 1, 3),
...
apSampleTime = _ApSampleTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 1, 1, 1, 4),
    _ApSampleTime_Type()
)
...
apRtCollectOnoff = _ApRtCollectOnoff_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 1, 1, 1, 5),
...
apSysRestart = _ApSysRestart_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 1, 1, 1, 6),
    _ApSysRestart_Type()
)
...
apSysReset = _ApSysReset_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 1, 1, 1, 7),
    _ApSysReset_Type()
)
...
apGeneralCfgInfoReadTableEntry = _ApGeneralCfgInfoReadTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1)
)
...
apSysDescr = _ApSysDescr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 1),
    _ApSysDescr_Type()
)
...
apSysManufacture = _ApSysManufacture_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 2),
...
apSerialNumber = _ApSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 3),
...
apSysModel = _ApSysModel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 4),
    _ApSysModel_Type()
)
...
apSysUpTime = _ApSysUpTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 5),
    _ApSysUpTime_Type()
)
...
apSysOnlineTime = _ApSysOnlineTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 6),
...
apSysIPAddress = _ApSysIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 7),
...
apSysIPNetMask = _ApSysIPNetMask_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 8),
...
apSysGateWayAddr = _ApSysGateWayAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 9),
...
apSysMacAddrConnectToAC = _ApSysMacAddrConnectToAC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 10),
...
apSoftwareName = _ApSoftwareName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 11),
...
apSoftwareVersion = _ApSoftwareVersion_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 12),
...
apSoftwareVendor = _ApSoftwareVendor_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 13),
...
apCPUType = _ApCPUType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 14),
    _ApCPUType_Type()
)
...
apMemoryType = _ApMemoryType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 15),
    _ApMemoryType_Type()
)
...
apMemorySize = _ApMemorySize_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 17),
    _ApMemorySize_Type()
)
...
apFlashSize = _ApFlashSize_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 2, 1, 1, 18),
    _ApFlashSize_Type()
)
...
apGeneralStatusCFGTableEntry = _ApGeneralStatusCFGTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 3, 1, 1)
)
apGeneralStatusCFGTableEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apAssoStatusAPMac"),
)
if mibBuilder.loadTexts:
...
apAPName = _ApAPName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 3, 1, 1, 1),
    _ApAPName_Type()
)
...
class _ApACAssociateStatus_Type(Integer32):
    """Custom type apACAssociateStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_ApACAssociateStatus_Type.__name__ = "Integer32"
_ApACAssociateStatus_Object = MibTableColumn
apACAssociateStatus = _ApACAssociateStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 3, 1, 1, 2),
    _ApACAssociateStatus_Type()
)
apACAssociateStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apACAssociateStatus.setStatus("current")


class _ApMonitorMode_Type(Integer32):
    """Custom type apMonitorMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_ApMonitorMode_Type.__name__ = "Integer32"
_ApMonitorMode_Object = MibTableColumn
apMonitorMode = _ApMonitorMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 3, 1, 1, 3),
    _ApMonitorMode_Type()
)
apMonitorMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    apMonitorMode.setStatus("current")
_ApAssoStatusAPMac_Type = MacAddress
_ApAssoStatusAPMac_Object = MibTableColumn
apAssoStatusAPMac = _ApAssoStatusAPMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 3, 1, 1, 4),
    _ApAssoStatusAPMac_Type()
)
apAssoStatusAPMac.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apAssoStatusAPMac.setStatus("current")


class _ApACHbAssocStatus_Type(Integer32):
    """Custom type apACHbAssocStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_ApACHbAssocStatus_Type.__name__ = "Integer32"
_ApACHbAssocStatus_Object = MibTableColumn
apACHbAssocStatus = _ApACHbAssocStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 3, 1, 1, 5),
    _ApACHbAssocStatus_Type()
)
apACHbAssocStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apACHbAssocStatus.setStatus("current")
_ApScanType_Type = Integer32
_ApScanType_Object = MibTableColumn
apScanType = _ApScanType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 1, 3, 1, 1, 6),
    _ApScanType_Type()
)
apScanType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    apScanType.setStatus("current")
_ApInterfaceConfigObjects_ObjectIdentity = ObjectIdentity
apInterfaceConfigObjects = _ApInterfaceConfigObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2)
)
_ApInterfaceNumberObjects_ObjectIdentity = ObjectIdentity
apInterfaceNumberObjects = _ApInterfaceNumberObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 1)
)
_ApInterfaceNumberTable_Object = MibTable
apInterfaceNumberTable = _ApInterfaceNumberTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 1, 1)
)
if mibBuilder.loadTexts:
...
apInterfaceNumberTableEntry = _ApInterfaceNumberTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 1, 1, 1)
)
...
apIfNumber = _ApIfNumber_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 1, 1, 1, 1),
    _ApIfNumber_Type()
)
...
apBSSIDNum = _ApBSSIDNum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 1, 1, 1, 2),
    _ApBSSIDNum_Type()
)
...
apInterfaceRGMIIconfigTableEntry = _ApInterfaceRGMIIconfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1)
)
apInterfaceRGMIIconfigTableEntry.setIndexNames(
    (0, "QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apIfLocalRGMIINum"),
)
if mibBuilder.loadTexts:
...
apIfLocalRGMIINum = _ApIfLocalRGMIINum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1, 1),
...
apIfRGMIIDescr = _ApIfRGMIIDescr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1, 2),
...
apIfRGMIIType = _ApIfRGMIIType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1, 3),
    _ApIfRGMIIType_Type()
)
...
apIfRGMIIMtu = _ApIfRGMIIMtu_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1, 4),
    _ApIfRGMIIMtu_Type()
)
...
apIfRGMIISpeed = _ApIfRGMIISpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1, 5),
...
apIfRGMIIPhysAddress = _ApIfRGMIIPhysAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1, 6),
...
apIfRGMIIAdminStatusEnable = _ApIfRGMIIAdminStatusEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1, 7),
...
apIfRGMIIOperStatus = _ApIfRGMIIOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1, 8),
...
apIfRGMIILastChange = _ApIfRGMIILastChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 2, 1, 1, 9),
...
apInterfaceWirelessconfigTableEntry = _ApInterfaceWirelessconfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1)
)
...
apIfWireDescr = _ApIfWireDescr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 1),
    _ApIfWireDescr_Type()
)
...
apIfWireType = _ApIfWireType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 2),
    _ApIfWireType_Type()
)
...
apIfWireMtu = _ApIfWireMtu_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 3),
    _ApIfWireMtu_Type()
)
...
apIfWireSpeed = _ApIfWireSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 4),
    _ApIfWireSpeed_Type()
)
...
apIfWirePhysAddress = _ApIfWirePhysAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 5),
...
apIfWireAdminStatusEnable = _ApIfWireAdminStatusEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 6),
...
apIfWireOperStatus = _ApIfWireOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 7),
...
apIfWireLastChange = _ApIfWireLastChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 8),
...
apIfWireChannelAutoSelectEnable = _ApIfWireChannelAutoSelectEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 9),
...
apIfWireRadioChannelConfig = _ApIfWireRadioChannelConfig_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 10),
...
apIfWireRadioChannelUsing = _ApIfWireRadioChannelUsing_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 11),
...
apIfWireCurrRadioModeSupport = _ApIfWireCurrRadioModeSupport_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 12),
...
apIfWireRadioModeConfig = _ApIfWireRadioModeConfig_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 13),
...
apIfWireTransmitSpeedConfig = _ApIfWireTransmitSpeedConfig_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 14),
...
apIfWireMaxTxPwrLvl = _ApIfWireMaxTxPwrLvl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 15),
...
apIfWirePwrAttRange = _ApIfWirePwrAttRange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 16),
...
apIfWirePwrAttValue = _ApIfWirePwrAttValue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 17),
...
apIfWireAntennaGain = _ApIfWireAntennaGain_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 18),
...
apIfWirePowerMgmtEnable = _ApIfWirePowerMgmtEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 19),
...
apTxPwr = _ApTxPwr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 20),
    _ApTxPwr_Type()
)
...
apIfWireMaxStationNumPermitted = _ApIfWireMaxStationNumPermitted_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 21),
...
apIfWireAMPDUEnabled = _ApIfWireAMPDUEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 22),
...
apIfWireBWMode = _ApIfWireBWMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 23),
...
apIfWireShortGIEnabled = _ApIfWireShortGIEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 24),
...
apIfWireIs11nOnly = _ApIfWireIs11nOnly_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 25),
...
apIfWireBeaconIntvl = _ApIfWireBeaconIntvl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 26),
...
apIfWireDtimIntvl = _ApIfWireDtimIntvl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 27),
...
apIfWireRtsThreshold = _ApIfWireRtsThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 28),
...
apIfWireFragThreshlod = _ApIfWireFragThreshlod_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 29),
...
apIfWirePreambleLen = _ApIfWirePreambleLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 30),
...
apAntennaReceiveMask = _ApAntennaReceiveMask_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 31),
...
apAntennaTransmitMask = _ApAntennaTransmitMask_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 32),
...
apIfWireAMSDUEnabled = _ApIfWireAMSDUEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 33),
...
apIfwireMcsSuppIndex = _ApIfwireMcsSuppIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 34),
...
apIfwireMcsMandIndex = _ApIfwireMcsMandIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 35),
...
apIfwire11nSuppEnable = _ApIfwire11nSuppEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 36),
...
apShtRetryThld = _ApShtRetryThld_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 37),
...
apLongRetryThld = _ApLongRetryThld_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 38),
...
apIfWireResponseRssi = _ApIfWireResponseRssi_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 39),
...
apIfWireMaxStationLimit = _ApIfWireMaxStationLimit_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 40),
...
apIfWireLinkscan = _ApIfWireLinkscan_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 2, 3, 1, 1, 41),
...
apSSIDListCreateTableEntry = _ApSSIDListCreateTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 1, 1)
)
apSSIDListCreateTableEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDAPMac"),
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDRadioId"),
...
apSSIDAPMac = _ApSSIDAPMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 1, 1, 1),
    _ApSSIDAPMac_Type()
)
...
apSSIDRadioId = _ApSSIDRadioId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 1, 1, 2),
    _ApSSIDRadioId_Type()
)
...
apSSIDListName = _ApSSIDListName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 1, 1, 3),
    _ApSSIDListName_Type()
)
apSSIDListName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
apListBSSIDAddr = _ApListBSSIDAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 1, 1, 4),
    _ApListBSSIDAddr_Type()
)
apListBSSIDAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
apSSIDListStatus = _ApSSIDListStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 1, 1, 5),
...
apSSIDConfigTable = _ApSSIDConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2)
)
if mibBuilder.loadTexts:
...
apSSIDConfigTableEntry = _ApSSIDConfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1)
)
...
apSSIDName = _ApSSIDName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 1),
    _ApSSIDName_Type()
)
...
apSSIDEnabled = _ApSSIDEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 2),
    _ApSSIDEnabled_Type()
)
...
apSSIDHidden = _ApSSIDHidden_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 3),
    _ApSSIDHidden_Type()
)
...
apStaIsolate = _ApStaIsolate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 4),
    _ApStaIsolate_Type()
)
...
apDot11Auth = _ApDot11Auth_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 5),
    _ApDot11Auth_Type()
)
...
apsecurityMode = _ApsecurityMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 6),
...
apAuthenMode = _ApAuthenMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 7),
    _ApAuthenMode_Type()
)
...
apSecurityCiphers = _ApSecurityCiphers_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 8),
...
apVlanId = _ApVlanId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 9),
    _ApVlanId_Type()
)
...
apVlanIpAddr = _ApVlanIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 10),
    _ApVlanIpAddr_Type()
)
...
apMaxSimultUsers = _ApMaxSimultUsers_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 11),
...
apStaUplinkMaxRate = _ApStaUplinkMaxRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 12),
...
apStaDwlinkMaxRate = _ApStaDwlinkMaxRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 13),
...
apSSIDCfgStatus = _ApSSIDCfgStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 3, 2, 1, 14),
...
apSecurityConfigTableEntry = _ApSecurityConfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 4, 1, 1)
)
...
apWEPCipherKeyIndex = _ApWEPCipherKeyIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 4, 1, 1, 1),
...
apWEPCipherKeyValue = _ApWEPCipherKeyValue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 4, 1, 1, 2),
...
apWEPCipherKeyCharType = _ApWEPCipherKeyCharType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 4, 1, 1, 3),
...
apPSKCipherKeyValue = _ApPSKCipherKeyValue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 4, 1, 1, 4),
...
apPSKCipherKeyCharType = _ApPSKCipherKeyCharType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 4, 1, 1, 5),
...
apWAPIAuthModeEnable = _ApWAPIAuthModeEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 4, 1, 1, 6),
...
apWAPIASIPAddress = _ApWAPIASIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 4, 1, 1, 7),
...
apWAPIIsInstalledCer = _ApWAPIIsInstalledCer_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 4, 1, 1, 8),
...
apWAPIExternInfoConfigTableEntry = _ApWAPIExternInfoConfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1)
)
...
apWAPIConfigVersion = _ApWAPIConfigVersion_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 1),
...
apWAPIControlledAuthControl = _ApWAPIControlledAuthControl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 2),
...
apWAPIControlledPortControl = _ApWAPIControlledPortControl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 3),
...
apWAPIOptionImplemented = _ApWAPIOptionImplemented_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 4),
...
apWAPIPreauthenticationImplemented = _ApWAPIPreauthenticationImplemented_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 5),
...
apWAPIEnabled = _ApWAPIEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 6),
    _ApWAPIEnabled_Type()
)
...
apWAPIPreauthEnabled = _ApWAPIPreauthEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 7),
...
apWAPIUnicastKeysSupported = _ApWAPIUnicastKeysSupported_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 8),
...
apWAPIUnicastRekeyMethod = _ApWAPIUnicastRekeyMethod_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 9),
...
apWAPIUnicastRekeyTime = _ApWAPIUnicastRekeyTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 10),
...
apWAPIUnicastRekeyPackets = _ApWAPIUnicastRekeyPackets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 11),
...
apWAPIMulticastCipher = _ApWAPIMulticastCipher_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 12),
...
apWAPIMulticastRekeyMethod = _ApWAPIMulticastRekeyMethod_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 13),
...
apWAPIMulticastRekeyTime = _ApWAPIMulticastRekeyTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 14),
...
apWAPIMulticastRekeyPackets = _ApWAPIMulticastRekeyPackets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 15),
...
apWAPIMulticastRekeyStrict = _ApWAPIMulticastRekeyStrict_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 16),
...
apWAPIPSKValue = _ApWAPIPSKValue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 17),
...
apWAPIPSKPassPhrase = _ApWAPIPSKPassPhrase_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 18),
...
apWAPICertificateUpdateCount = _ApWAPICertificateUpdateCount_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 19),
...
apWAPIMulticastUpdateCount = _ApWAPIMulticastUpdateCount_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 20),
...
apWAPIUnicastUpdateCount = _ApWAPIUnicastUpdateCount_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 21),
...
apWAPIMulticastCipherSize = _ApWAPIMulticastCipherSize_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 22),
...
apWAPIBKLifetime = _ApWAPIBKLifetime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 23),
...
apWAPIBKReauthThreshold = _ApWAPIBKReauthThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 24),
...
apWAPISATimeout = _ApWAPISATimeout_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 25),
...
apWAPIAuthSuiteSelected = _ApWAPIAuthSuiteSelected_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 26),
...
apWAPIUnicastCipherSelected = _ApWAPIUnicastCipherSelected_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 27),
...
apWAPIMulticastCipherSelected = _ApWAPIMulticastCipherSelected_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 28),
...
apWAPIBKIDUsed = _ApWAPIBKIDUsed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 29),
...
apWAPIAuthSuiteRequested = _ApWAPIAuthSuiteRequested_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 30),
...
apWAPIUnicastCipherRequested = _ApWAPIUnicastCipherRequested_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 31),
...
apWAPIMulticastCipherRequested = _ApWAPIMulticastCipherRequested_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 32),
...
apWAPIUnicastCipher = _ApWAPIUnicastCipher_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 33),
...
apWAPIUnicastCipherEnabled = _ApWAPIUnicastCipherEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 34),
...
apWAPIUnicastCipherSize = _ApWAPIUnicastCipherSize_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 35),
...
apWAPIAuthenticationSuite = _ApWAPIAuthenticationSuite_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 36),
...
apWAPIAuthenticationSuiteEnabled = _ApWAPIAuthenticationSuiteEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 37),
...
apWAPIAECertFile = _ApWAPIAECertFile_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 38),
...
apWAPICACertFile = _ApWAPICACertFile_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 39),
...
apWAPIASUCertFile = _ApWAPIASUCertFile_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 5, 1, 1, 40),
...
apStationInfoGetTableEntry = _ApStationInfoGetTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1)
)
...
apStaMAC = _ApStaMAC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 1),
    _ApStaMAC_Type()
)
...
apStaWMMAttr = _ApStaWMMAttr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 2),
    _ApStaWMMAttr_Type()
)
...
apStaIPAddress = _ApStaIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 3),
...
apStaRadioMode = _ApStaRadioMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 4),
...
apStaRadioChannel = _ApStaRadioChannel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 5),
...
apAPTxRates = _ApAPTxRates_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 6),
    _ApAPTxRates_Type()
)
...
apStaPowerSaveMode = _ApStaPowerSaveMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 7),
...
apStaVlanId = _ApStaVlanId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 8),
    _ApStaVlanId_Type()
)
...
apStaSSIDName = _ApStaSSIDName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 9),
    _ApStaSSIDName_Type()
)
...
apAPId = _ApAPId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 10),
    _ApAPId_Type()
)
...
apStaDot11Auth = _ApStaDot11Auth_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 11),
...
apsecurity = _Apsecurity_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 12),
    _Apsecurity_Type()
)
...
apStaAuthenMode = _ApStaAuthenMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 13),
...
apStaSecurityCiphers = _ApStaSecurityCiphers_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 14),
...
apAPIdMac = _ApAPIdMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 15),
    _ApAPIdMac_Type()
)
...
apStaMode = _ApStaMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 16),
    _ApStaMode_Type()
)
...
apStaBand = _ApStaBand_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 1, 1, 17),
    _ApStaBand_Type()
)
...
apStationRefusedAccessTable = _ApStationRefusedAccessTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 2)
)
if mibBuilder.loadTexts:
...
apStationRefusedAccessTableEntry = _ApStationRefusedAccessTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 2, 1)
)
apStationRefusedAccessTableEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apRefusedStaMAC"),
)
if mibBuilder.loadTexts:
...
apRefusedStaMAC = _ApRefusedStaMAC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 2, 1, 1),
...
apFailReason = _ApFailReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 2, 1, 2),
    _ApFailReason_Type()
)
...
apRefusedTime = _ApRefusedTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 2, 1, 3),
    _ApRefusedTime_Type()
)
...
apRefusedAPMac = _ApRefusedAPMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 2, 1, 4),
...
apStationRadiusInfoTable = _ApStationRadiusInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 3)
)
if mibBuilder.loadTexts:
...
apStationRadiusInfoTableEntry = _ApStationRadiusInfoTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 3, 1)
)
apStationRadiusInfoTableEntry.setIndexNames(
    (0, "QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apUserMacAddress"),
)
if mibBuilder.loadTexts:
...
apUserMacAddress = _ApUserMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 3, 1, 1),
...
apUserIpAddress = _ApUserIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 3, 1, 2),
...
apUserLoginName = _ApUserLoginName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 3, 1, 3),
...
apUserLoginTime = _ApUserLoginTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 3, 1, 4),
...
apUserOnlineTime = _ApUserOnlineTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 6, 3, 1, 5),
...
apQOSInfoConfigObjects = _ApQOSInfoConfigObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7)
)
...
apQOSWirelessConfigTableEntry = _ApQOSWirelessConfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 1, 1, 1)
)
apQOSWirelessConfigTableEntry.setIndexNames(
    (0, "QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
    (0, "QTECH-AC-MGMT-MIB", "qtechApCfgRadioId"),
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apWireQoSTrafficClassId"),
)
if mibBuilder.loadTexts:
...
apWireQoSTrafficClassId = _ApWireQoSTrafficClassId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 1, 1, 1, 1),
...
apWireQosAIFS = _ApWireQosAIFS_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 1, 1, 1, 2),
    _ApWireQosAIFS_Type()
)
...
apWireQoSCWmin = _ApWireQoSCWmin_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 1, 1, 1, 3),
...
apWireQoSCWmax = _ApWireQoSCWmax_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 1, 1, 1, 4),
...
apWireQoSTXOPLim = _ApWireQoSTXOPLim_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 1, 1, 1, 5),
...
apQOSBaseInfoConfigTableEntry = _ApQOSBaseInfoConfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1)
)
...
apBaseQoSTrafficClass = _ApBaseQoSTrafficClass_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 1),
...
apBaseQoSEnabled = _ApBaseQoSEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 2),
...
apBaseQoSBW = _ApBaseQoSBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 3),
    _ApBaseQoSBW_Type()
)
...
apBaseQoSResPercent = _ApBaseQoSResPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 4),
...
apBaseQoSsharedBW = _ApBaseQoSsharedBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 5),
...
apBaseQoSsharedBWPercent = _ApBaseQoSsharedBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 6),
...
apBaseQoSSchedAlgName = _ApBaseQoSSchedAlgName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 7),
...
apBaseQoSResPolicyEnabled = _ApBaseQoSResPolicyEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 8),
...
apBaseQoSResPolicyName = _ApBaseQoSResPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 9),
...
apBaseQoSBackgroundSvcAvgSpeed = _ApBaseQoSBackgroundSvcAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 10),
...
apBaseQoSBackgroundSvcMaxBurst = _ApBaseQoSBackgroundSvcMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 11),
...
apBaseQoSBackgroundSvcPriority = _ApBaseQoSBackgroundSvcPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 12),
...
apBaseQoSBackgroundSvcResPriority = _ApBaseQoSBackgroundSvcResPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 13),
...
apBaseQoSBestEffortSvcAvgSpeed = _ApBaseQoSBestEffortSvcAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 14),
...
apBaseQoSBestEffortSvcMaxBurst = _ApBaseQoSBestEffortSvcMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 15),
...
apBaseQoSBestEffortSvcPriority = _ApBaseQoSBestEffortSvcPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 16),
...
apBaseQoSBestEffortSvcResPriority = _ApBaseQoSBestEffortSvcResPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 17),
...
apBaseQoSVoiceSvcAvgSpeed = _ApBaseQoSVoiceSvcAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 18),
...
apBaseQoSVoiceSvcMaxBurst = _ApBaseQoSVoiceSvcMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 19),
...
apBaseQoSVoiceSvcPriority = _ApBaseQoSVoiceSvcPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 20),
...
apBaseQoSVoiceSvcResPriority = _ApBaseQoSVoiceSvcResPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 21),
...
apBaseQoSVideoSvcAvgSpeed = _ApBaseQoSVideoSvcAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 22),
...
apBaseQoSVideoSvcMaxBurst = _ApBaseQoSVideoSvcMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 23),
...
apBaseQoSVideoSvcPriority = _ApBaseQoSVideoSvcPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 24),
...
apBaseQoSVideoSvcResPriority = _ApBaseQoSVideoSvcResPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 2, 1, 1, 25),
...
apQOSBackgroundCfgTableEntry = _ApQOSBackgroundCfgTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 3, 1, 1)
)
...
apQOSBgMaxSvcCnt = _ApQOSBgMaxSvcCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 3, 1, 1, 1),
...
apQOSBgSvcBW = _ApQOSBgSvcBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 3, 1, 1, 2),
    _ApQOSBgSvcBW_Type()
)
...
apQOSBgSvcBWPercent = _ApQOSBgSvcBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 3, 1, 1, 3),
...
apQOSBgIsUseWREDAlg = _ApQOSBgIsUseWREDAlg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 3, 1, 1, 4),
...
apQOSBgIsUseTrafficShaping = _ApQOSBgIsUseTrafficShaping_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 3, 1, 1, 5),
...
apQOSBestEffortCfgTableEntry = _ApQOSBestEffortCfgTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 4, 1, 1)
)
...
apQOSBeMaxSvcCnt = _ApQOSBeMaxSvcCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 4, 1, 1, 1),
...
apQOSBeSvcBW = _ApQOSBeSvcBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 4, 1, 1, 2),
    _ApQOSBeSvcBW_Type()
)
...
apQOSBeSvcBWPercent = _ApQOSBeSvcBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 4, 1, 1, 3),
...
apQOSBeIsUseWREDAlg = _ApQOSBeIsUseWREDAlg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 4, 1, 1, 4),
...
apQOSBeIsUseTrafficShaping = _ApQOSBeIsUseTrafficShaping_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 4, 1, 1, 5),
...
apQOSVoiceInfoCfgTableEntry = _ApQOSVoiceInfoCfgTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1)
)
...
apQOSVoiceMaxSvcCnt = _ApQOSVoiceMaxSvcCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1, 1),
...
apQOSVoiceSvcBW = _ApQOSVoiceSvcBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1, 2),
...
apQOSVoiceSvcBWPercent = _ApQOSVoiceSvcBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1, 3),
...
apQOSVoiceIsUseStreamBasedQueue = _ApQOSVoiceIsUseStreamBasedQueue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1, 4),
...
apQOSVoiceStreamMaxQueueLen = _ApQOSVoiceStreamMaxQueueLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1, 5),
...
apQOSVoiceStreamAvgSpeed = _ApQOSVoiceStreamAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1, 6),
...
apQOSVoiceStreamMaxBurst = _ApQOSVoiceStreamMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1, 7),
...
apQOSVoiceIsUseWREDAlg = _ApQOSVoiceIsUseWREDAlg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1, 8),
...
apQOSVoiceIsUseTrafficShaping = _ApQOSVoiceIsUseTrafficShaping_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 5, 1, 1, 9),
...
apQOSVideoInfoCfgTableEntry = _ApQOSVideoInfoCfgTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1)
)
...
apQOSVideoMaxSvcCnt = _ApQOSVideoMaxSvcCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1, 1),
...
apQOSVideoSvcBW = _ApQOSVideoSvcBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1, 2),
...
apQOSVideoSvcBWPercent = _ApQOSVideoSvcBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1, 3),
...
apQOSVideoIsUseStreamBasedQueue = _ApQOSVideoIsUseStreamBasedQueue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1, 4),
...
apQOSVideoStreamMaxQueueLen = _ApQOSVideoStreamMaxQueueLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1, 5),
...
apQOSVideoStreamAvgSpeed = _ApQOSVideoStreamAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1, 6),
...
apQOSVideoStreamMaxBurst = _ApQOSVideoStreamMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1, 7),
...
apQOSVideoIsUseWREDAlg = _ApQOSVideoIsUseWREDAlg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1, 8),
...
apQOSVideoIsUseTrafficShaping = _ApQOSVideoIsUseTrafficShaping_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 6, 1, 1, 9),
...
apQOSWMMConfigTableEntry = _ApQOSWMMConfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1)
)
...
apQOSMode = _ApQOSMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 1),
    _ApQOSMode_Type()
)
...
apQOSUpdateSeq = _ApQOSUpdateSeq_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 2),
...
apQOSSvpAcIndex = _ApQOSSvpAcIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 3),
...
apQOSUapsd = _ApQOSUapsd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 4),
    _ApQOSUapsd_Type()
)
...
apQOSAcIndx1 = _ApQOSAcIndx1_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 5),
    _ApQOSAcIndx1_Type()
)
...
apQOSAcIndx2 = _ApQOSAcIndx2_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 6),
    _ApQOSAcIndx2_Type()
)
...
apQOSAcIndx3 = _ApQOSAcIndx3_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 7),
    _ApQOSAcIndx3_Type()
)
...
apQOSAcIndx4 = _ApQOSAcIndx4_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 8),
    _ApQOSAcIndx4_Type()
)
...
apQOSAifsn1 = _ApQOSAifsn1_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 9),
    _ApQOSAifsn1_Type()
)
...
apQOSAifsn2 = _ApQOSAifsn2_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 10),
    _ApQOSAifsn2_Type()
)
...
apQOSAifsn3 = _ApQOSAifsn3_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 11),
    _ApQOSAifsn3_Type()
)
...
apQOSAifsn4 = _ApQOSAifsn4_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 12),
    _ApQOSAifsn4_Type()
)
...
apQOSEcwMin1 = _ApQOSEcwMin1_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 13),
    _ApQOSEcwMin1_Type()
)
...
apQOSEcwMin2 = _ApQOSEcwMin2_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 14),
    _ApQOSEcwMin2_Type()
)
...
apQOSEcwMin3 = _ApQOSEcwMin3_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 15),
    _ApQOSEcwMin3_Type()
)
...
apQOSEcwMin4 = _ApQOSEcwMin4_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 16),
    _ApQOSEcwMin4_Type()
)
...
apQOSEcwMax1 = _ApQOSEcwMax1_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 17),
    _ApQOSEcwMax1_Type()
)
...
apQOSEcwMax2 = _ApQOSEcwMax2_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 18),
    _ApQOSEcwMax2_Type()
)
...
apQOSEcwMax3 = _ApQOSEcwMax3_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 19),
    _ApQOSEcwMax3_Type()
)
...
apQOSEcwMax4 = _ApQOSEcwMax4_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 20),
    _ApQOSEcwMax4_Type()
)
...
apQOSTxopLmt1 = _ApQOSTxopLmt1_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 21),
    _ApQOSTxopLmt1_Type()
)
...
apQOSTxopLmt2 = _ApQOSTxopLmt2_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 22),
    _ApQOSTxopLmt2_Type()
)
...
apQOSTxopLmt3 = _ApQOSTxopLmt3_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 23),
    _ApQOSTxopLmt3_Type()
)
...
apQOSTxopLmt4 = _ApQOSTxopLmt4_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 24),
    _ApQOSTxopLmt4_Type()
)
...
apQOSAcmAndAck1 = _ApQOSAcmAndAck1_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 25),
...
apQOSAcmAndAck2 = _ApQOSAcmAndAck2_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 26),
...
apQOSAcmAndAck3 = _ApQOSAcmAndAck3_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 27),
...
apQOSAcmAndAck4 = _ApQOSAcmAndAck4_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 7, 7, 1, 1, 28),
...
apAlarmParamConfigEntry = _ApAlarmParamConfigEntry_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8)
)
...
apStaInterfNumThreshhd = _ApStaInterfNumThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 1),
...
apAPCoInterfThreshhd = _ApAPCoInterfThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 2),
...
apAPNeiborInterfThreshhd = _ApAPNeiborInterfThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 3),
...
apCPUusageThreshhd = _ApCPUusageThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 4),
...
apMemUsageThreshhd = _ApMemUsageThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 5),
...
acUserExcepOfflineTimes = _AcUserExcepOfflineTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 6),
...
acAuthReqTimes = _AcAuthReqTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 7),
...
acAuthSuccessTimes = _AcAuthSuccessTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 8),
...
acAuthReqFailTimes = _AcAuthReqFailTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 9),
...
acDisconnectOnlineUsersCount = _AcDisconnectOnlineUsersCount_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 10),
...
acOnlineUserNum = _AcOnlineUserNum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 8, 11),
...
apVLANConfigTableEntry = _ApVLANConfigTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 9, 1, 1)
)
...
_ApVLANID_Object = MibTableColumn
apVLANID = _ApVLANID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 9, 1, 1, 1),
    _ApVLANID_Type()
)
apVLANID.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
apVlanCfgStatus = _ApVlanCfgStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 9, 1, 1, 2),
...
apStatisticsInfoReadObjects = _ApStatisticsInfoReadObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10)
)
...
apSysCapabilityStatisticsTableEntry = _ApSysCapabilityStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 1, 1, 1)
)
...
apCPURTUsage = _ApCPURTUsage_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 1, 1, 1, 1),
    _ApCPURTUsage_Type()
)
...
apCPUAvgUsage = _ApCPUAvgUsage_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 1, 1, 1, 2),
    _ApCPUAvgUsage_Type()
)
...
apMemRTUsage = _ApMemRTUsage_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 1, 1, 1, 3),
    _ApMemRTUsage_Type()
)
...
apMemAvgUsage = _ApMemAvgUsage_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 1, 1, 1, 4),
    _ApMemAvgUsage_Type()
)
...
apLinkStatisticsTableEntry = _ApLinkStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1)
)
...
apStationAssocSum = _ApStationAssocSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 1),
    _ApStationAssocSum_Type()
)
apStationAssocSum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apStationAssocSum.setStatus("current")
_ApStationOnlineSum_Type = Integer32
_ApStationOnlineSum_Object = MibTableColumn
apStationOnlineSum = _ApStationOnlineSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 2),
    _ApStationOnlineSum_Type()
)
apStationOnlineSum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apStationOnlineSum.setStatus("current")
_ApAssocTimes_Type = Counter32
_ApAssocTimes_Object = MibTableColumn
apAssocTimes = _ApAssocTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 3),
    _ApAssocTimes_Type()
)
...
apAssocFailTimes = _ApAssocFailTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 4),
...
apReassocTimes = _ApReassocTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 5),
...
apPreAssCannotShiftDeassocFailSum = _ApPreAssCannotShiftDeassocFailSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 6),
...
apApStatsDisassociated = _ApApStatsDisassociated_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 7),
...
apAssocRejectSum = _ApAssocRejectSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 8),
...
apBSSNotSupportAssocFailSum = _ApBSSNotSupportAssocFailSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 9),
...
apApAuthReqTimes = _ApApAuthReqTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 10),
    _ApApAuthReqTimes_Type()
)
apApAuthReqTimes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apApAuthReqTimes.setStatus("current")
_ApApAuthSuccessTimes_Type = Counter32
_ApApAuthSuccessTimes_Object = MibTableColumn
apApAuthSuccessTimes = _ApApAuthSuccessTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 11),
    _ApApAuthSuccessTimes_Type()
)
apApAuthSuccessTimes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apApAuthSuccessTimes.setStatus("current")
_AcApAuthReqFailTimes_Type = Counter32
_AcApAuthReqFailTimes_Object = MibTableColumn
acApAuthReqFailTimes = _AcApAuthReqFailTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 12),
    _AcApAuthReqFailTimes_Type()
)
acApAuthReqFailTimes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    acApAuthReqFailTimes.setStatus("current")
_ApReassocFailTimes_Type = Counter32
_ApReassocFailTimes_Object = MibTableColumn
apReassocFailTimes = _ApReassocFailTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 13),
    _ApReassocFailTimes_Type()
)
apReassocFailTimes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apReassocFailTimes.setStatus("current")
_ApRSSILowAssocFailSum_Type = Counter32
_ApRSSILowAssocFailSum_Object = MibTableColumn
apRSSILowAssocFailSum = _ApRSSILowAssocFailSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 14),
    _ApRSSILowAssocFailSum_Type()
)
apRSSILowAssocFailSum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apRSSILowAssocFailSum.setStatus("current")
_ApUnknowReasonAssoFailSum_Type = Counter32
_ApUnknowReasonAssoFailSum_Object = MibTableColumn
apUnknowReasonAssoFailSum = _ApUnknowReasonAssoFailSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 15),
    _ApUnknowReasonAssoFailSum_Type()
)
apUnknowReasonAssoFailSum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apUnknowReasonAssoFailSum.setStatus("current")
_ApOut80211StandardAssocFailSum_Type = Counter32
_ApOut80211StandardAssocFailSum_Object = MibTableColumn
apOut80211StandardAssocFailSum = _ApOut80211StandardAssocFailSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 16),
    _ApOut80211StandardAssocFailSum_Type()
)
apOut80211StandardAssocFailSum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apOut80211StandardAssocFailSum.setStatus("current")
_ApAllStationsTotalUpTime_Type = Integer32
_ApAllStationsTotalUpTime_Object = MibTableColumn
apAllStationsTotalUpTime = _ApAllStationsTotalUpTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 17),
    _ApAllStationsTotalUpTime_Type()
)
apAllStationsTotalUpTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apAllStationsTotalUpTime.setStatus("current")
_ApAssocRespTimes_Type = Counter32
_ApAssocRespTimes_Object = MibTableColumn
apAssocRespTimes = _ApAssocRespTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 18),
    _ApAssocRespTimes_Type()
)
apAssocRespTimes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apAssocRespTimes.setStatus("current")
_ApAssocSuccTimes_Type = Counter32
_ApAssocSuccTimes_Object = MibTableColumn
apAssocSuccTimes = _ApAssocSuccTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 19),
    _ApAssocSuccTimes_Type()
)
apAssocSuccTimes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apAssocSuccTimes.setStatus("current")
_ApUserRadiusOnlineSum_Type = Integer32
_ApUserRadiusOnlineSum_Object = MibTableColumn
apUserRadiusOnlineSum = _ApUserRadiusOnlineSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 20),
    _ApUserRadiusOnlineSum_Type()
)
apUserRadiusOnlineSum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apUserRadiusOnlineSum.setStatus("current")
_ApAllUserOnlineTime_Type = TimeTicks
_ApAllUserOnlineTime_Object = MibTableColumn
apAllUserOnlineTime = _ApAllUserOnlineTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 21),
    _ApAllUserOnlineTime_Type()
)
apAllUserOnlineTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apAllUserOnlineTime.setStatus("current")
_ApRadiusAuthTimes_Type = Counter32
_ApRadiusAuthTimes_Object = MibTableColumn
apRadiusAuthTimes = _ApRadiusAuthTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 22),
    _ApRadiusAuthTimes_Type()
)
apRadiusAuthTimes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apRadiusAuthTimes.setStatus("current")
_ApRadiusAuthSuccTimes_Type = Counter32
_ApRadiusAuthSuccTimes_Object = MibTableColumn
apRadiusAuthSuccTimes = _ApRadiusAuthSuccTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 23),
    _ApRadiusAuthSuccTimes_Type()
)
apRadiusAuthSuccTimes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apRadiusAuthSuccTimes.setStatus("current")
_ApRadiusAuthFailTimes_Type = Counter32
_ApRadiusAuthFailTimes_Object = MibTableColumn
apRadiusAuthFailTimes = _ApRadiusAuthFailTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 2, 1, 1, 24),
    _ApRadiusAuthFailTimes_Type()
)
apRadiusAuthFailTimes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    apRadiusAuthFailTimes.setStatus("current")
...
apInterfaceRGMIIStatisticsTableEntry = _ApInterfaceRGMIIStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1)
)
apInterfaceRGMIIStatisticsTableEntry.setIndexNames(
    (0, "QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apRGMIIIndex"),
)
if mibBuilder.loadTexts:
...
apRGMIIIndex = _ApRGMIIIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 1),
    _ApRGMIIIndex_Type()
)
...
apifInUcastPkts = _ApifInUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 2),
...
apifInNUcastPkts = _ApifInNUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 3),
...
apifInOctets = _ApifInOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 4),
    _ApifInOctets_Type()
)
...
apifInDiscardPkts = _ApifInDiscardPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 5),
...
apifInErrors = _ApifInErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 6),
    _ApifInErrors_Type()
)
...
apifOutUcastPkts = _ApifOutUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 7),
...
apifOutNUcastPkts = _ApifOutNUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 8),
...
apifOutOctets = _ApifOutOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 9),
    _ApifOutOctets_Type()
)
...
apifOutDiscardPkts = _ApifOutDiscardPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 10),
...
apifOutErrors = _ApifOutErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 11),
    _ApifOutErrors_Type()
)
...
apifUpDwnTimes = _ApifUpDwnTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 3, 1, 1, 12),
...
apInterfaceWireStatisticsTableEntry = _ApInterfaceWireStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1)
)
...
apAvgRxSignalStrength = _ApAvgRxSignalStrength_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 1),
...
apHighestRxSignalStrength = _ApHighestRxSignalStrength_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 2),
...
apLowestRxSignalStrength = _ApLowestRxSignalStrength_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 3),
...
apWirelessUpdownTimes = _ApWirelessUpdownTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 4),
...
apChStatsNumStations = _ApChStatsNumStations_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 5),
...
apTxDataPkts = _ApTxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 6),
    _ApTxDataPkts_Type()
)
...
apRxDataPkts = _ApRxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 7),
    _ApRxDataPkts_Type()
)
...
apUplinkDataOctets = _ApUplinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 8),
...
apDwlinkDataOctets = _ApDwlinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 9),
...
apChStatsDwlinkTotRetryPkts = _ApChStatsDwlinkTotRetryPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 10),
...
apChStatsPhyErrPkts = _ApChStatsPhyErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 11),
...
apChStatsMacFcsErrPkts = _ApChStatsMacFcsErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 12),
...
apChStatsMacMicErrPkts = _ApChStatsMacMicErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 13),
...
apChStatsMacDecryptErrPkts = _ApChStatsMacDecryptErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 14),
...
apChStatsTotalErrPkts = _ApChStatsTotalErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 15),
...
apRxMgmtFrameCnt = _ApRxMgmtFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 16),
...
apRxCtrlFrameCnt = _ApRxCtrlFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 17),
...
apRxDataFrameCnt = _ApRxDataFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 18),
...
apTxMgmtFrameCnt = _ApTxMgmtFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 19),
...
apTxCtrlFrameCnt = _ApTxCtrlFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 20),
...
apTxDataFrameCnt = _ApTxDataFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 21),
...
apChStatsFrameErrorCnt = _ApChStatsFrameErrorCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 22),
...
apRetryCnt = _ApRetryCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 23),
    _ApRetryCnt_Type()
)
...
apCurTxPwr = _ApCurTxPwr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 24),
    _ApCurTxPwr_Type()
)
...
apAPNeighborSSIDList = _ApAPNeighborSSIDList_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 25),
...
apChDownUnicastFrame = _ApChDownUnicastFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 26),
...
apChDownNonUnicastFrame = _ApChDownNonUnicastFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 27),
...
apChTxThroughput = _ApChTxThroughput_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 28),
...
apChRxThroughput = _ApChRxThroughput_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 29),
...
apChTxDropPkts = _ApChTxDropPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 30),
...
apChRxDropPkts = _ApChRxDropPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 31),
...
apChTxErrorPkts = _ApChTxErrorPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 32),
...
apChRxErrorPkts = _ApChRxErrorPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 33),
...
apRxBytes = _ApRxBytes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 34),
    _ApRxBytes_Type()
)
...
apRxPkts = _ApRxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 35),
    _ApRxPkts_Type()
)
...
apTxBytes = _ApTxBytes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 36),
    _ApTxBytes_Type()
)
...
apTxPkts = _ApTxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 37),
    _ApTxPkts_Type()
)
...
apDownNonUnicastPkts = _ApDownNonUnicastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 38),
...
apDownUnicastPkts = _ApDownUnicastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 39),
...
apUpNonUnicastPkts = _ApUpNonUnicastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 40),
...
apUpUnicastPkts = _ApUpUnicastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 41),
...
apAssoFailUnknowReason = _ApAssoFailUnknowReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 42),
...
apAssoFailOutofDot11 = _ApAssoFailOutofDot11_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 43),
...
apAssoTotalTime = _ApAssoTotalTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 44),
...
apAuthReqFailTimes = _ApAuthReqFailTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 45),
...
apAuthReqTimes = _ApAuthReqTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 46),
...
apAuthSuccessTimes = _ApAuthSuccessTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 47),
...
apReAssoFailTimes = _ApReAssoFailTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 48),
...
apMacTxCorrectFrameCnt = _ApMacTxCorrectFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 49),
...
apMacRxCorrectFrameCnt = _ApMacRxCorrectFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 50),
...
apPktErrRate = _ApPktErrRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 51),
    _ApPktErrRate_Type()
)
...
apTotalRxBytes = _ApTotalRxBytes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 52),
...
apTotalTxBytes = _ApTotalTxBytes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 53),
...
apTxErrorPkts = _ApTxErrorPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 54),
    _ApTxErrorPkts_Type()
)
...
apTxDropPkts = _ApTxDropPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 55),
    _ApTxDropPkts_Type()
)
...
apIfRadiusOnlineUserNum = _ApIfRadiusOnlineUserNum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 4, 1, 1, 56),
...
apSSIDStatisticsTableEntry = _ApSSIDStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1)
)
apSSIDStatisticsTableEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDStatisticsAPMac"),
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDStatisticsRadioId"),
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDStatisticsWlanId"),
)
if mibBuilder.loadTexts:
...
apSSIDStatisticsAPMac = _ApSSIDStatisticsAPMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 1),
...
apSSIDStatisticsRadioId = _ApSSIDStatisticsRadioId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 2),
...
apSSIDStatisticsWlanId = _ApSSIDStatisticsWlanId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 3),
...
apSSIDTxDataPkts = _ApSSIDTxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 4),
...
apSSIDRxDataPkts = _ApSSIDRxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 5),
...
apSSIDUplinkDataOctets = _ApSSIDUplinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 6),
...
apSSIDDwlinkDataOctets = _ApSSIDDwlinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 7),
...
apSSIDChStatsDwlinkTotRetryPkts = _ApSSIDChStatsDwlinkTotRetryPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 8),
...
apSSIDApChStatsNumStations = _ApSSIDApChStatsNumStations_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 9),
...
apApChStatsOnlineSum = _ApApChStatsOnlineSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 10),
...
apSSIDStatisticsName = _ApSSIDStatisticsName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 11),
...
apSSIDMacTxPkts = _ApSSIDMacTxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 12),
...
apSSIDMacRxPkts = _ApSSIDMacRxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 1, 1, 13),
...
apSSIDStatisticsNewTable = _ApSSIDStatisticsNewTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2)
)
if mibBuilder.loadTexts:
...
apSSIDStatisticsNewTableEntry = _ApSSIDStatisticsNewTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1)
)
apSSIDStatisticsNewTableEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDStatisticsNewAPMac"),
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDStatisticsNewRadioId"),
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDStatisticsNewSSID"),
)
if mibBuilder.loadTexts:
...
apSSIDStatisticsNewAPMac = _ApSSIDStatisticsNewAPMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 1),
...
apSSIDStatisticsNewRadioId = _ApSSIDStatisticsNewRadioId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 2),
...
apSSIDStatisticsNewSSID = _ApSSIDStatisticsNewSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 3),
...
apSSIDNewTxDataPkts = _ApSSIDNewTxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 4),
...
apSSIDNewRxDataPkts = _ApSSIDNewRxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 5),
...
apSSIDNewUplinkDataOctets = _ApSSIDNewUplinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 6),
...
apSSIDNewDwlinkDataOctets = _ApSSIDNewDwlinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 7),
...
apSSIDNewChStatsDwlinkTotRetryPkts = _ApSSIDNewChStatsDwlinkTotRetryPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 8),
...
apSSIDNewApChStatsNumStations = _ApSSIDNewApChStatsNumStations_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 9),
...
apApNewChStatsOnlineSum = _ApApNewChStatsOnlineSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 10),
...
apSSIDNewMacTxPkts = _ApSSIDNewMacTxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 11),
...
apSSIDNewMacRxPkts = _ApSSIDNewMacRxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 5, 2, 1, 12),
...
apWAPIStatisticsTableEntry = _ApWAPIStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1)
)
...
apWAPIControlledPortStatus = _ApWAPIControlledPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 1),
...
apWAPISelectedUnicastCipher = _ApWAPISelectedUnicastCipher_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 2),
...
apWPIReplayCounters = _ApWPIReplayCounters_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 3),
...
apWPIDecryptableErrors = _ApWPIDecryptableErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 4),
...
apWPIMICErrors = _ApWPIMICErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 5),
...
apWAISignatureErrors = _ApWAISignatureErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 6),
...
apWAIHMACErrors = _ApWAIHMACErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 7),
...
apWAIAuthResultFailures = _ApWAIAuthResultFailures_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 8),
...
apWAIDiscardCounters = _ApWAIDiscardCounters_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 9),
...
apWAITimeoutCounters = _ApWAITimeoutCounters_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 10),
...
apWAIFormatErrors = _ApWAIFormatErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 11),
...
apWAICertificateHandshakeFailures = _ApWAICertificateHandshakeFailures_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 12),
...
apWAIUnicastHandshakeFailures = _ApWAIUnicastHandshakeFailures_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 13),
...
apWAIMulticastHandshakeFailures = _ApWAIMulticastHandshakeFailures_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 6, 1, 1, 14),
...
apStationStatisticsTableEntry = _ApStationStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1)
)
...
apStaAddress = _ApStaAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 1),
    _ApStaAddress_Type()
)
...
apStaUpTime = _ApStaUpTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 2),
    _ApStaUpTime_Type()
)
...
apReceivedStaSignalStrength = _ApReceivedStaSignalStrength_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 3),
...
apAPReceiveStaSNR = _ApAPReceiveStaSNR_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 4),
...
apStaTxPkts = _ApStaTxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 5),
    _ApStaTxPkts_Type()
)
...
apStaTxBytes = _ApStaTxBytes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 6),
    _ApStaTxBytes_Type()
)
...
apStaRxPkts = _ApStaRxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 7),
    _ApStaRxPkts_Type()
)
...
apStaRxBytes = _ApStaRxBytes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 8),
    _ApStaRxBytes_Type()
)
...
apWAPISTAAddress = _ApWAPISTAAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 9),
...
apWAPIVersion = _ApWAPIVersion_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 10),
    _ApWAPIVersion_Type()
)
...
apStaLinkSpeed = _ApStaLinkSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 11),
...
apStaUpRate = _ApStaUpRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 12),
    _ApStaUpRate_Type()
)
...
apStaDownRate = _ApStaDownRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 13),
    _ApStaDownRate_Type()
)
...
apStaTxThroughput = _ApStaTxThroughput_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 14),
...
apStaRxThroughput = _ApStaRxThroughput_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 15),
...
apStaRxRetryBytes = _ApStaRxRetryBytes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 7, 1, 1, 16),
...
apQOSStatisticsObjects = _ApQOSStatisticsObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8)
)
...
apQOSBaseStatisticsTableEntry = _ApQOSBaseStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 1, 1, 1)
)
...
apBaseQoSSvcQueAvgLen = _ApBaseQoSSvcQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 1, 1, 1, 1),
...
apBaseQoSSvcPktLossRatio = _ApBaseQoSSvcPktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 1, 1, 1, 2),
...
apBaseAvgTransSpeed = _ApBaseAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 1, 1, 1, 3),
...
apQOSBackgroundStatisticsTableEntry = _ApQOSBackgroundStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 2, 1, 1)
)
...
apQOSBgQueAvgLen = _ApQOSBgQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 2, 1, 1, 1),
...
apQOSBgAvgBurst = _ApQOSBgAvgBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 2, 1, 1, 2),
...
apQOSBgPktLossRatio = _ApQOSBgPktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 2, 1, 1, 3),
...
apQOSBgAvgTransSpeed = _ApQOSBgAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 2, 1, 1, 4),
...
apQOSBgSvcLoss = _ApQOSBgSvcLoss_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 2, 1, 1, 5),
...
apQOSBestEffortStatisticsTableEntry = _ApQOSBestEffortStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 3, 1, 1)
)
...
apQOSBeQueAvgLen = _ApQOSBeQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 3, 1, 1, 1),
...
apQOSBeAvgBurst = _ApQOSBeAvgBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 3, 1, 1, 2),
...
apQOSBePktLossRatio = _ApQOSBePktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 3, 1, 1, 3),
...
apQOSBeAvgTransSpeed = _ApQOSBeAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 3, 1, 1, 4),
...
apQOSBeSvcLoss = _ApQOSBeSvcLoss_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 3, 1, 1, 5),
...
apQOSVoiceStatisticsTableEntry = _ApQOSVoiceStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 4, 1, 1)
)
...
apQOSVoiceQueAvgLen = _ApQOSVoiceQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 4, 1, 1, 1),
...
apQOSVoiceAvgBurst = _ApQOSVoiceAvgBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 4, 1, 1, 2),
...
apQOSVoicePktLossRatio = _ApQOSVoicePktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 4, 1, 1, 3),
...
apQOSVoiceAvgTransSpeed = _ApQOSVoiceAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 4, 1, 1, 4),
...
apQOSVoicePutThroughRatio = _ApQOSVoicePutThroughRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 4, 1, 1, 5),
...
apQOSVoiceDropRatio = _ApQOSVoiceDropRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 4, 1, 1, 6),
...
apQOSVoiceSvcLoss = _ApQOSVoiceSvcLoss_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 4, 1, 1, 7),
...
apQOSVoiceExceedMaxUsersRequest = _ApQOSVoiceExceedMaxUsersRequest_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 4, 1, 1, 8),
...
apQOSVideoStatisticsTableEntry = _ApQOSVideoStatisticsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 5, 1, 1)
)
...
apQOSVideoQueAvgLen = _ApQOSVideoQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 5, 1, 1, 1),
...
apQOSVideoAvgBurst = _ApQOSVideoAvgBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 5, 1, 1, 2),
...
apQOSVideoPktLossRatio = _ApQOSVideoPktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 5, 1, 1, 3),
...
apQOSVideoAvgTransSpeed = _ApQOSVideoAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 5, 1, 1, 4),
...
apQOSVideoPutThroughRatio = _ApQOSVideoPutThroughRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 5, 1, 1, 5),
...
apQOSVideoDropRatio = _ApQOSVideoDropRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 5, 1, 1, 6),
...
apQOSVideoSvcLoss = _ApQOSVideoSvcLoss_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 5, 1, 1, 7),
...
apQOSVideoExceedMaxUsersRequest = _ApQOSVideoExceedMaxUsersRequest_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 8, 5, 1, 1, 8),
...
apWIDSRogueApInfoTableEntry = _ApWIDSRogueApInfoTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 9, 1, 1)
)
apWIDSRogueApInfoTableEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "qtechRogueApMacAddr"),
)
if mibBuilder.loadTexts:
...
qtechRogueApMacAddr = _QtechRogueApMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 9, 1, 1, 1),
    _QtechRogueApMacAddr_Type()
)
qtechRogueApMacAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    qtechRogueApMacAddr.setStatus("current")
_QtechRogueApRSSI_Type = Integer32
_QtechRogueApRSSI_Object = MibTableColumn
qtechRogueApRSSI = _QtechRogueApRSSI_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 10, 9, 1, 1, 2),
    _QtechRogueApRSSI_Type()
)
qtechRogueApRSSI.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    qtechRogueApRSSI.setStatus("current")
_ApQtechAlarmTrapObjects_ObjectIdentity = ObjectIdentity
apQtechAlarmTrapObjects = _ApQtechAlarmTrapObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11)
)
_ApAPMac_Type = MacAddress
_ApAPMac_Object = MibScalar
apAPMac = _ApAPMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 1),
    _ApAPMac_Type()
)
...
apWorkModeBeforeChange = _ApWorkModeBeforeChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 2),
...
apWorkModeAfterChange = _ApWorkModeAfterChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 3),
...
apSSIDKey = _ApSSIDKey_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 4),
    _ApSSIDKey_Type()
)
...
apSSIDKeyConflict = _ApSSIDKeyConflict_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 5),
...
apCyperIndex = _ApCyperIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 6),
    _ApCyperIndex_Type()
)
...
apInterruptReason = _ApInterruptReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 7),
...
apWorkingAPRadioIfInfo = _ApWorkingAPRadioIfInfo_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 8),
...
apWorkingAPChannel = _ApWorkingAPChannel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 9),
...
apInterfAPChannel = _ApInterfAPChannel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 10),
...
apInterfAPBSSID = _ApInterfAPBSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 11),
...
apInterfStaMac = _ApInterfStaMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 12),
...
apPermitAssoUser = _ApPermitAssoUser_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 13),
...
apAssoFailReason = _ApAssoFailReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 14),
...
apChannelBeforeChange = _ApChannelBeforeChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 15),
...
apChannelAfterChange = _ApChannelAfterChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 16),
...
apChanChangeMode = _ApChanChangeMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 17),
...
apWorkingAPBSSID = _ApWorkingAPBSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 18),
...
apWorkingAPSSID = _ApWorkingAPSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 19),
...
apStaMacAddr = _ApStaMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 20),
    _ApStaMacAddr_Type()
)
...
apAuthMode = _ApAuthMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 21),
    _ApAuthMode_Type()
)
...
apAuthFailReason = _ApAuthFailReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 22),
...
updateFailReason = _UpdateFailReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 23),
...
apSWVersionBeforeUpdate = _ApSWVersionBeforeUpdate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 24),
...
apAPRadioId = _ApAPRadioId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 25),
    _ApAPRadioId_Type()
)
...
apRevPackages = _ApRevPackages_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 26),
    _ApRevPackages_Type()
)
...
apCPUUsage = _ApCPUUsage_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 27),
    _ApCPUUsage_Type()
)
...
apSpeciousDeviceMac = _ApSpeciousDeviceMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 28),
...
apRSSI = _ApRSSI_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 29),
    _ApRSSI_Type()
)
...
apAttackReason = _ApAttackReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 30),
...
apWlanId = _ApWlanId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 31),
    _ApWlanId_Type()
)
...
apWlanSSID = _ApWlanSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 32),
    _ApWlanSSID_Type()
)
...
apWlanSecurityModeBeforeChg = _ApWlanSecurityModeBeforeChg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 33),
...
apWlanSecurityModeAfterChg = _ApWlanSecurityModeAfterChg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 34),
...
apTrapIllegalApMac = _ApTrapIllegalApMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 35),
...
apTrapIllegalApChannel = _ApTrapIllegalApChannel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 36),
...
apTrapIllegalApRSSI = _ApTrapIllegalApRSSI_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 37),
...
apTrapWorkingApMac = _ApTrapWorkingApMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 38),
...
apTrapWorkingApBSSID = _ApTrapWorkingApBSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 39),
...
apTrapIllegalApType = _ApTrapIllegalApType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 40),
...
apTrapIllegalApSSID = _ApTrapIllegalApSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 41),
...
apAPRadioType = _ApAPRadioType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 42),
    _ApAPRadioType_Type()
)
...
apAssocAuthMode = _ApAssocAuthMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 43),
...
apStaRSSI = _ApStaRSSI_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 44),
    _ApStaRSSI_Type()
)
...
apAssocFailReason = _ApAssocFailReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 45),
...
apSpectralInfoApMac = _ApSpectralInfoApMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 46),
...
apSpectralInfoType = _ApSpectralInfoType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 47),
...
apSpectralInfoFreq = _ApSpectralInfoFreq_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 48),
...
apSpectralInfoRssi = _ApSpectralInfoRssi_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 49),
...
apCounterMeasureApMac = _ApCounterMeasureApMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 50),
...
apCounterMeasureBssid = _ApCounterMeasureBssid_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 11, 51),
...
apTerminalPermitEntry = _ApTerminalPermitEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 1, 1)
)
apTerminalPermitEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apWhiteListIndex"),
)
if mibBuilder.loadTexts:
...
apWhiteListIndex = _ApWhiteListIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 1, 1, 1),
...
apPermitMAC = _ApPermitMAC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 1, 1, 2),
    _ApPermitMAC_Type()
)
...
apWhiteListStatus = _ApWhiteListStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 1, 1, 3),
...
apTerminalDeniedTable = _ApTerminalDeniedTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 2)
)
if mibBuilder.loadTexts:
...
apTerminalDeniedEntry = _ApTerminalDeniedEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 2, 1)
)
apTerminalDeniedEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apBlackListIndex"),
)
if mibBuilder.loadTexts:
...
apBlackListIndex = _ApBlackListIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 2, 1, 1),
...
apAttackDeviceMAC = _ApAttackDeviceMAC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 2, 1, 2),
...
apBlackListStatus = _ApBlackListStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 2, 1, 3),
...
apTerminalBlackListTable = _ApTerminalBlackListTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 3)
)
if mibBuilder.loadTexts:
...
apTerminalBlackListEntry = _ApTerminalBlackListEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 3, 1)
)
apTerminalBlackListEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apBlackListDeviceMAC"),
)
if mibBuilder.loadTexts:
...
apBlackListDeviceMAC = _ApBlackListDeviceMAC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 3, 1, 1),
...
apBlackListAddReason = _ApBlackListAddReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 3, 1, 2),
...
apBlackListDuration = _ApBlackListDuration_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 12, 3, 1, 3),
...
acCapabilityStatistics = _AcCapabilityStatistics_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13)
)
...
acWirelessDownDropFrame = _AcWirelessDownDropFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13, 1),
...
acWirelessDownRetryFrame = _AcWirelessDownRetryFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13, 2),
...
acWirelessDownFrame = _AcWirelessDownFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13, 3),
...
acWirelessDownErrorFrame = _AcWirelessDownErrorFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13, 4),
...
acWirelessUpFrame = _AcWirelessUpFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13, 5),
...
acWirelessUpDropFrame = _AcWirelessUpDropFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13, 6),
...
acWirelessUpRetryFrame = _AcWirelessUpRetryFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13, 7),
...
acWirelessUpRate = _AcWirelessUpRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13, 8),
...
acWirelessDownRate = _AcWirelessDownRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 13, 9),
...
apWidsIllegalApEntry = _ApWidsIllegalApEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 1, 1)
)
apWidsIllegalApEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apIllegalApMac"),
)
if mibBuilder.loadTexts:
...
apIllegalApMac = _ApIllegalApMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 1, 1, 1),
...
apIllegalApChannel = _ApIllegalApChannel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 1, 1, 2),
...
apIllegalApRSSI = _ApIllegalApRSSI_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 1, 1, 3),
...
apWorkingApMac = _ApWorkingApMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 1, 1, 4),
...
apDetectAPBSSID = _ApDetectAPBSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 1, 1, 5),
...
apIllegalApType = _ApIllegalApType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 1, 1, 6),
...
apIllegalApSSID = _ApIllegalApSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 1, 1, 7),
...
apWidsApCounterTable = _ApWidsApCounterTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 2)
)
if mibBuilder.loadTexts:
...
apWidsApCounterEntry = _ApWidsApCounterEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 2, 1)
)
apWidsApCounterEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apCounterMac"),
)
if mibBuilder.loadTexts:
...
apCounterMac = _ApCounterMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 2, 1, 1),
    _ApCounterMac_Type()
)
...
apCounter = _ApCounter_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 2, 1, 2),
    _ApCounter_Type()
)
...
apCounterMode = _ApCounterMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 2, 1, 3),
    _ApCounterMode_Type()
)
...
apCounterRssiThreshold = _ApCounterRssiThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 2, 1, 4),
...
apWidsDeviceMode = _ApWidsDeviceMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 3),
...
apWidsCounterIllegalAp = _ApWidsCounterIllegalAp_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 4),
...
apWidsCounterModeIllegalAp = _ApWidsCounterModeIllegalAp_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 5),
...
apWidsDeviceModeFlag = _ApWidsDeviceModeFlag_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 6),
...
apWidsCounterIllegalApFlag = _ApWidsCounterIllegalApFlag_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 7),
...
apWidsCounterModeIllegalApFlag = _ApWidsCounterModeIllegalApFlag_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 8),
...
apWidsPermitMacTable = _ApWidsPermitMacTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 9)
)
if mibBuilder.loadTexts:
...
apWidsPermitMacEntry = _ApWidsPermitMacEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 9, 1)
)
apWidsPermitMacEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apWidsPermitMac"),
)
if mibBuilder.loadTexts:
...
apWidsPermitMac = _ApWidsPermitMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 9, 1, 1),
...
apPermitMacrowstatus = _ApPermitMacrowstatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 9, 1, 2),
...
apWidsPermitSSIDTable = _ApWidsPermitSSIDTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 10)
)
if mibBuilder.loadTexts:
...
apWidsPermitSSIDEntry = _ApWidsPermitSSIDEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 10, 1)
)
apWidsPermitSSIDEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apCounterSSID"),
)
if mibBuilder.loadTexts:
...
apCounterSSID = _ApCounterSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 10, 1, 1),
    _ApCounterSSID_Type()
)
...
apPermitSSIDrowstatus = _ApPermitSSIDrowstatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 10, 1, 2),
...
apWidsPermitVendorTable = _ApWidsPermitVendorTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 11)
)
if mibBuilder.loadTexts:
...
apWidsPermitVendorEntry = _ApWidsPermitVendorEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 11, 1)
)
apWidsPermitVendorEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apCounterVendor"),
)
if mibBuilder.loadTexts:
...
apCounterVendor = _ApCounterVendor_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 11, 1, 1),
...
apPermitVendorrowstatus = _ApPermitVendorrowstatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 11, 1, 2),
...
apWidsStaticAttackTable = _ApWidsStaticAttackTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 12)
)
if mibBuilder.loadTexts:
...
apWidsStaticAttackEntry = _ApWidsStaticAttackEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 12, 1)
)
apWidsStaticAttackEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apStaticAttackMac"),
)
if mibBuilder.loadTexts:
...
apStaticAttackMac = _ApStaticAttackMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 12, 1, 1),
...
apStaticAttackrowstatus = _ApStaticAttackrowstatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 12, 1, 2),
...
apWidsNeighborApInfoTable = _ApWidsNeighborApInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 13)
)
if mibBuilder.loadTexts:
...
apWidsNeighborApInfoEntry = _ApWidsNeighborApInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 13, 1)
)
apWidsNeighborApInfoEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "neighborApMac"),
)
if mibBuilder.loadTexts:
...
neighborApMac = _NeighborApMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 13, 1, 1),
    _NeighborApMac_Type()
)
...
neighborApSSID = _NeighborApSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 13, 1, 2),
...
neighborApRSSI = _NeighborApRSSI_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 13, 1, 3),
...
neighborApChannel = _NeighborApChannel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 13, 1, 4),
...
neighborApInControl = _NeighborApInControl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 13, 1, 5),
...
apWidsClearIlleglApListFlag = _ApWidsClearIlleglApListFlag_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 14),
...
apWidsFloodInterval = _ApWidsFloodInterval_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 15),
...
apWidsBlackListThreshold = _ApWidsBlackListThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 16),
...
apWidsBlackListDuration = _ApWidsBlackListDuration_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 17),
...
apWidsFloodDetectOnOff = _ApWidsFloodDetectOnOff_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 18),
...
apWidsCounterRssiThreshold = _ApWidsCounterRssiThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 19),
...
apWidsBlackSSIDTable = _ApWidsBlackSSIDTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 20)
)
if mibBuilder.loadTexts:
...
apWidsBlackSSIDEntry = _ApWidsBlackSSIDEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 20, 1)
)
apWidsBlackSSIDEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apBlackSSID"),
)
if mibBuilder.loadTexts:
...
apBlackSSID = _ApBlackSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 20, 1, 1),
    _ApBlackSSID_Type()
)
...
apBlackSSIDrowstatus = _ApBlackSSIDrowstatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 14, 20, 1, 2),
...
apConfigInfoMac = _ApConfigInfoMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 15, 1, 1, 1),
...
apSpectralSwitch = _ApSpectralSwitch_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 15, 1, 1, 2),
...
apSpectralSupport = _ApSpectralSupport_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 15, 1, 1, 3),
...
apSmartAntSupport = _ApSmartAntSupport_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 15, 1, 1, 4),
...
apSmartDisSupport = _ApSmartDisSupport_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 15, 1, 1, 5),
...
apAntdetectSupport = _ApAntdetectSupport_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 15, 1, 1, 6),
...
apAntdetectEnable = _ApAntdetectEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 15, 1, 1, 7),
...
apAntdetectInterval = _ApAntdetectInterval_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 15, 1, 1, 8),
...
apAntdetectState = _ApAntdetectState_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 15, 1, 1, 9),
...
apAntDetectAPMac = _ApAntDetectAPMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 1, 1, 1),
...
apAntDetectAntIndex = _ApAntDetectAntIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 1, 1, 2),
...
apAntDetectDesc = _ApAntDetectDesc_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 1, 1, 3),
...
apAntDetectRadioId = _ApAntDetectRadioId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 1, 1, 4),
...
apAntDetectStatus = _ApAntDetectStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 1, 1, 5),
...
apAntDetectCfgTable = _ApAntDetectCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 2)
)
if mibBuilder.loadTexts:
...
apAntDetectCfgEntry = _ApAntDetectCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 2, 1)
)
apAntDetectCfgEntry.setIndexNames(
    (0, "QTECH-WLAN-FIT-AP-CF-MIB", "apAntDetectCfgAPMac"),
)
if mibBuilder.loadTexts:
...
apAntDetectCfgAPMac = _ApAntDetectCfgAPMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 2, 1, 1),
...
apAntDetectCfgSupport = _ApAntDetectCfgSupport_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 2, 1, 2),
...
apAntDetectCfgSwitch = _ApAntDetectCfgSwitch_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 16, 2, 1, 3),
...
apCPUusageTooHighTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 1, 1)
)
if mibBuilder.loadTexts:
...
apCPUusageTooHighRecovTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 1, 2)
)
if mibBuilder.loadTexts:
...
apMemUsageTooHighTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 1, 3)
)
if mibBuilder.loadTexts:
...
apMemUsageTooHighRecovTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 1, 4)
)
if mibBuilder.loadTexts:
...
aPOfflineTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 1, 5)
)
if mibBuilder.loadTexts:
...
aPOnlineTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 1, 6)
)
if mibBuilder.loadTexts:
...
aPMtWorkModeChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 1, 7)
)
aPMtWorkModeChgTrap.setObjects(
      *(("QTECH-WLAN-FIT-AP-CF-MIB", "apAPMac"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkModeBeforeChange"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkModeAfterChange"))
)
if mibBuilder.loadTexts:
...
apSoftwareUpdateFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 1, 8)
)
apSoftwareUpdateFailTrap.setObjects(
      *(("QTECH-WLAN-FIT-AP-CF-MIB", "updateFailReason"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apSWVersionBeforeUpdate"))
)
if mibBuilder.loadTexts:
...
apSSIDCyperConflictTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 1, 9)
)
apSSIDCyperConflictTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDKey"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apSSIDKeyConflict"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apCyperIndex"))
)
if mibBuilder.loadTexts:
...
aPCoInterfDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 1)
)
aPCoInterfDetectedTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPChannel"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apInterfAPBSSID"))
)
if mibBuilder.loadTexts:
...
aPCoInterfClearTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 2)
)
...
aPNerborInterfDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 3)
)
aPNerborInterfDetectedTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ...
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPChannel"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apInterfAPBSSID"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apInterfAPChannel"))
)
if mibBuilder.loadTexts:
...
aPNeiborInterfClearTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 4)
)
...
staInterfDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 5)
)
staInterfDetectedTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPChannel"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apInterfStaMac"))
)
if mibBuilder.loadTexts:
...
staInterfClearTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 6)
)
...
otherDeviceInterfDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 7)
)
...
otherDevInterfClearTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 8)
)
...
apRadioDownTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 9)
)
apRadioDownTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apInterruptReason"))
)
if mibBuilder.loadTexts:
...
apRadioDownRecovTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 10)
)
...
aPStaFullTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 11)
)
aPStaFullTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apPermitAssoUser"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apAssoFailReason"))
)
if mibBuilder.loadTexts:
...
aPStaFullRecoverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 12)
)
...
aPMtRdoChanlChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 13)
)
aPMtRdoChanlChgTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apChannelBeforeChange"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apChannelAfterChange"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apChanChangeMode"))
)
if mibBuilder.loadTexts:
...
apSpeciusDeviceDetectTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 14)
)
apSpeciusDeviceDetectTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apSpeciousDeviceMac"))
)
if mibBuilder.loadTexts:
...
apRadioRxPackagesTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 15)
)
apRadioRxPackagesTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apAPRadioId"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apRevPackages"))
)
if mibBuilder.loadTexts:
...
apCPUUsageTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 16)
)
apCPUUsageTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apCPUUsage"))
)
if mibBuilder.loadTexts:
...
apSTARefusedRSSITrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 17)
)
apSTARefusedRSSITrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apStaMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apRSSI"))
)
if mibBuilder.loadTexts:
...
apSTARefusedRatesetTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 18)
)
...
apFindAttackTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 19)
)
apFindAttackTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apAttackReason"))
)
if mibBuilder.loadTexts:
...
wlanSecurityChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 20)
)
wlanSecurityChgTrap.setObjects(
      *(("QTECH-WLAN-FIT-AP-CF-MIB", "apWlanId"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWlanSSID"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWlanSecurityModeBeforeChg"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWlanSecurityModeAfterChg"))
)
if mibBuilder.loadTexts:
...
apRadioFailureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 21)
)
...
apIllegalApTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 22)
)
apIllegalApTrap.setObjects(
      *(("QTECH-WLAN-FIT-AP-CF-MIB", "apTrapIllegalApMac"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apTrapIllegalApChannel"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apTrapIllegalApRSSI"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apTrapWorkingApMac"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apTrapWorkingApBSSID"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apTrapIllegalApType"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apTrapIllegalApSSID"))
)
if mibBuilder.loadTexts:
...
apIllegalApRecoverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 23)
)
...
apStaAssocFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 24)
)
apStaAssocFailTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apStaMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apAPRadioId"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apAPRadioType"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apAssocAuthMode"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apStaRSSI"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPSSID"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apAssocFailReason"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPChannel"))
)
if mibBuilder.loadTexts:
...
apSpectralInfoTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 25)
)
apSpectralInfoTrap.setObjects(
      *(("QTECH-WLAN-FIT-AP-CF-MIB", "apSpectralInfoApMac"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apSpectralInfoType"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apSpectralInfoFreq"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apSpectralInfoRssi"))
)
if mibBuilder.loadTexts:
...
apCounterMeasureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 2, 26)
)
apCounterMeasureTrap.setObjects(
      *(("QTECH-WLAN-FIT-AP-CF-MIB", "apCounterMeasureApMac"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apCounterMeasureBssid"))
)
if mibBuilder.loadTexts:
...
apStaAuthErrorTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 3, 1)
)
apStaAuthErrorTrap.setObjects(
      *(("QTECH-AC-MGMT-MIB", "qtechApMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPBSSID"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apWorkingAPSSID"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apStaMacAddr"),
        ("QTECH-WLAN-FIT-AP-CF-MIB", "apAuthMode"),
...
apStAssociationFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 3, 2)
)
...
userwithInvalidCerficationInbreakNetwork = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 4, 1)
)
...
stationRepititiveAttack = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 4, 2)
)
...
tamperAttack = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 4, 3)
)
...
lowSafeLevelAttack = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 4, 4)
)
...
addressRedirectionAttack = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 81, 0, 4, 5)
)
...
mibBuilder.exportSymbols(
    "QTECH-WLAN-FIT-AP-CF-MIB",
    **{"qtechFitApMibModule": qtechFitApMibModule,
       "apQtechAlarmTraps": apQtechAlarmTraps,
       ...
       "apAPName": apAPName,
       "apACAssociateStatus": apACAssociateStatus,
       "apMonitorMode": apMonitorMode,
       "apAssoStatusAPMac": apAssoStatusAPMac,
       "apACHbAssocStatus": apACHbAssocStatus,
       "apScanType": apScanType,
       ...
       "apStationAssocSum": apStationAssocSum,
       "apStationOnlineSum": apStationOnlineSum,
       ...
       "apApAuthReqTimes": apApAuthReqTimes,
       "apApAuthSuccessTimes": apApAuthSuccessTimes,
       "acApAuthReqFailTimes": acApAuthReqFailTimes,
       "apReassocFailTimes": apReassocFailTimes,
       "apRSSILowAssocFailSum": apRSSILowAssocFailSum,
       "apUnknowReasonAssoFailSum": apUnknowReasonAssoFailSum,
       "apOut80211StandardAssocFailSum": apOut80211StandardAssocFailSum,
       "apAllStationsTotalUpTime": apAllStationsTotalUpTime,
       "apAssocRespTimes": apAssocRespTimes,
       "apAssocSuccTimes": apAssocSuccTimes,
       "apUserRadiusOnlineSum": apUserRadiusOnlineSum,
       "apAllUserOnlineTime": apAllUserOnlineTime,
       "apRadiusAuthTimes": apRadiusAuthTimes,
       "apRadiusAuthSuccTimes": apRadiusAuthSuccTimes,
       "apRadiusAuthFailTimes": apRadiusAuthFailTimes,
       ...
       "qtechRogueApMacAddr": qtechRogueApMacAddr,
       "qtechRogueApRSSI": qtechRogueApRSSI,
       "apQtechAlarmTrapObjects": apQtechAlarmTrapObjects,
       "apAPMac": apAPMac,
