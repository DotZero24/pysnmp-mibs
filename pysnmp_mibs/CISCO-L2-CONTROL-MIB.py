...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-L2-CONTROL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:41:51 2025
...
_ClcVlanMacLimitEnable_Type.__name__ = "TruthValue"
...
_ClcIfMacLimitEnable_Type.__name__ = "TruthValue"
...
_ClcIfVlanMacLimitEnable_Type.__name__ = "TruthValue"
...
ciscoL2ControlMIBCompliance.setObjects(
      *(("CISCO-L2-CONTROL-MIB", "clcMacAddressLimitGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacAddressLimitGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacLimitNotifsGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcUnicastFloodGroup"))
)
if mibBuilder.loadTexts:
...
ciscoL2ControlMIBCompliance2.setObjects(
      *(("CISCO-L2-CONTROL-MIB", "clcMacAddressLimitGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcMacAddressLimitGroup1"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacAddressLimitGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacAddressLimitGroup1"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacLimitNotifControlGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacLimitNotifControlGroup1"),
        ("CISCO-L2-CONTROL-MIB", "clcUnicastFloodGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcMacAddressLimitIntervalGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacLimitNotifsGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacLimitNotifsGroup1"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacLimitEnableGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcIfMacAddressLimitGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcIfMacLimitEnableGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcIfMacLimitNotifControlGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcIfMacLimitNotifsGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcIfVlanMacAddressLimitGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcIfVlanMacLimitEnableGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcIfVlanMacLimitNotifControlGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcIfVlanMacLimitNotifsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoL2ControlMIBCompliance3.setObjects(
      *(("CISCO-L2-CONTROL-MIB", "clcMacAddressLimitGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcMacAddressLimitGroup1"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacAddressLimitGroup"),
        ("CISCO-L2-CONTROL-MIB", "clcVlanMacAddressLimitGroup1"),
