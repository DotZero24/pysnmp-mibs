...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:45:21 2025
...
mibBuilder.exportSymbols("IBM-6611-APPN-MIB", ibmappnLocalTgDelay=ibmappnLocalTgDelay, ibmappnNodeLsInXidBytes=ibmappnNodeLsInXidBytes, ibmappnNodeAdaptiveBindPacing=ibmappnNodeAdaptiveBindPacing, ibmappnCosTgRowUsr3Min=ibmappnCosTgRowUsr3Min, ibmappnCosTgRowName=ibmappnCosTgRowName, ibmappnCosTgRowUsr1Max=ibmappnCosTgRowUsr1Max, ibmappnGeneralInfoAndCaps=ibmappnGeneralInfoAndCaps, ibmappnNodeLsRemoteIpPortNum=ibmappnNodeLsRemoteIpPortNum, ibmappnNodeLsSubState=ibmappnNodeLsSubState, ibmappnNodeDefLsBadXids=ibmappnNodeDefLsBadXids, ibmappnNnNodeFREndptDepleted=ibmappnNnNodeFREndptDepleted, ibmappnNodeLsCpName=ibmappnNodeLsCpName, ibmappnNnTgFRCpCpSession=ibmappnNnTgFRCpCpSession, ibmappnLocalTgByteCost=ibmappnLocalTgByteCost, ibmappnNodeLsRemoteDlsSap=ibmappnNodeLsRemoteDlsSap, ibmappnNnTopoNodeEqualRsns=ibmappnNnTopoNodeEqualRsns, ibmappnLocalEnTgDlcData=ibmappnLocalEnTgDlcData, ibmappnNnTgFRUsr2=ibmappnNnTgFRUsr2, ibmappnNnAdjNodeOutOfSeqTdus=ibmappnNnAdjNodeOutOfSeqTdus, ibmappnLocalNnGateway=ibmappnLocalNnGateway, ibmappnNnTgFRConnCost=ibmappnNnTgFRConnCost, ibmappnNnTgOwner=ibmappnNnTgOwner, ibmappnCosNodeRowMinCongestAllow=ibmappnCosNodeRowMinCongestAllow, ibmappnNnTopoRouteTable=ibmappnNnTopoRouteTable, ibmappnNnTopoNodeTimerUpdates=ibmappnNnTopoNodeTimerUpdates, ibmappnLocalNnCongested=ibmappnLocalNnCongested, ibmappnDirEntry=ibmappnDirEntry, ibmappnNodeLsEchoRsps=ibmappnNodeLsEchoRsps, ibmappnNodeLsEntry=ibmappnNodeLsEntry, ibmappnLocalEnTgConnCost=ibmappnLocalEnTgConnCost, ibmappnNnNodeFRQuiescing=ibmappnNnNodeFRQuiescing, ibmappnNnTopoRouteEntry=ibmappnNnTopoRouteEntry, ibmappnNnTgFRNum=ibmappnNnTgFRNum, ibmappnCosTgRowWgt=ibmappnCosTgRowWgt, ibmappnNnTgCpCpSession=ibmappnNnTgCpCpSession, ibmappnNodePortTable=ibmappnNodePortTable, ibmappnNnTgFROperational=ibmappnNnTgFROperational, ibmappnNodeLsUsr1=ibmappnNodeLsUsr1, ibmappnNnNodeIsr=ibmappnNnNodeIsr, ibmappnNnNodeFRRsn=ibmappnNnNodeFRRsn, ibmappnNodePortDlsMac=ibmappnNodePortDlsMac, ibmappnNodeLsTrTable=ibmappnNodeLsTrTable, ibmappnLocalEnTgSecurity=ibmappnLocalEnTgSecurity, ibmappnCos=ibmappnCos, ibmappnEnUniqueCaps=ibmappnEnUniqueCaps, ibmappnCosNodeRowTable=ibmappnCosNodeRowTable, ibmappnDirOutLocates=ibmappnDirOutLocates, ibmappnNodeLsStatusNofRetry=ibmappnNodeLsStatusNofRetry, ibmappnCosTgRowConnCostMax=ibmappnCosTgRowConnCostMax, ibmappnNnTopoTotalRouteCalcs=ibmappnNnTopoTotalRouteCalcs, ibmappnNodeLsOutMsgFrames=ibmappnNodeLsOutMsgFrames, ibmappnNodeLsDlsName=ibmappnNodeLsDlsName, ibmappnNodeLsStatusNodeId=ibmappnNodeLsStatusNodeId, ibmappnDirLuLocation=ibmappnDirLuLocation, ibmappnCosTgRowIndex=ibmappnCosTgRowIndex, ibmappnNnTgEffCap=ibmappnNnTgEffCap, ibmappnNodeParallelTg=ibmappnNodeParallelTg, ibmappnLocalEnTgOrigin=ibmappnLocalEnTgOrigin, ibmappnNodePortIpTable=ibmappnNodePortIpTable, ibmappnNnNodeCongested=ibmappnNnNodeCongested, ibmappnLocalEnTgDelay=ibmappnLocalEnTgDelay, ibmappnCosTgRowUsr3Max=ibmappnCosTgRowUsr3Max, ibmappnNnTopologyFREntry=ibmappnNnTopologyFREntry, ibmappnNodeLsOutMsgBytes=ibmappnNodeLsOutMsgBytes, ibmappnNnAdjNodeLastFrsnRcvd=ibmappnNnAdjNodeLastFrsnRcvd, ibmappnNodeLsEffCap=ibmappnNodeLsEffCap, ibmappnNnTopoRouteRejs=ibmappnNnTopoRouteRejs, ibmappnNnTopoTgLowRsns=ibmappnNnTopoTgLowRsns, ibmappnLocalTgRsn=ibmappnLocalTgRsn, ibmappnNnTopologyFRTable=ibmappnNnTopologyFRTable, ibmappnNodePortTrEntry=ibmappnNodePortTrEntry, ibmappnMemoryCritThresh=ibmappnMemoryCritThresh, ibmappnNnTgOperational=ibmappnNnTgOperational, ibmappnDirMaxCaches=ibmappnDirMaxCaches, ibmappnNodeLsLocalTrMac=ibmappnNodeLsLocalTrMac, ibmappnNodePortState=ibmappnNodePortState, ibmappnNodeLsDynamic=ibmappnNodeLsDynamic, ibmappnNnTopoCurNumNodes=ibmappnNnTopoCurNumNodes, ibmappnNodePortDlcTracMsgType=ibmappnNodePortDlcTracMsgType, ibmappnNodePortDlcTraceEntry=ibmappnNodePortDlcTraceEntry, ibmappnLocalEnTgDestVirtual=ibmappnLocalEnTgDestVirtual, ibmappnMemoryUse=ibmappnMemoryUse, ibmappnNnTopoTotalRouteRejs=ibmappnNnTopoTotalRouteRejs, ibmappnNnTgFRQuiescing=ibmappnNnTgFRQuiescing, ibmappnLocalEnTgNum=ibmappnLocalEnTgNum, ibmProd=ibmProd, ibmappnNodeLsStatusXidLocalSense=ibmappnNodeLsStatusXidLocalSense, ibmappnNodeLsLocalDlsMac=ibmappnNodeLsLocalDlsMac, ibmappnNnNodeEndptDepleted=ibmappnNnNodeEndptDepleted, ibmappnNodePortDynLsBadXids=ibmappnNodePortDynLsBadXids, ibmappnNodeLsLimResource=ibmappnNodeLsLimResource, ibmappnNodeLsTgNum=ibmappnNodeLsTgNum, ibmappnNnNodeFRCentralDirectory=ibmappnNnNodeFRCentralDirectory, ibmappnNodePortTrTable=ibmappnNodePortTrTable, ibmappnNodeLsConnCost=ibmappnNodeLsConnCost, ibmappnLocalEnTgCpCpSession=ibmappnLocalEnTgCpCpSession, ibmappnNodeNegotLs=ibmappnNodeNegotLs, ibmappnNodeLsIpState=ibmappnNodeLsIpState, ibmappnNodePortEntry=ibmappnNodePortEntry, ibmappnNodeDynLsBadXids=ibmappnNodeDynLsBadXids, ibmappnLocalEnTopology=ibmappnLocalEnTopology, ibmappnNodePortDlcTracRemoteAddr=ibmappnNodePortDlcTracRemoteAddr, ibmappnNnTopoTgEqualRsns=ibmappnNnTopoTgEqualRsns, ibmappnNnNodeRsn=ibmappnNnNodeRsn, ibmappnNnTopoNodeStateUpdates=ibmappnNnTopoNodeStateUpdates, ibmappnCosTgRowEffCapMin=ibmappnCosTgRowEffCapMin, ibmappnNnAdjNodeCpCpSessStatus=ibmappnNnAdjNodeCpCpSessStatus, ibmappnNnTgConnCost=ibmappnNnTgConnCost, ibmappnNnTopoRouteCos=ibmappnNnTopoRouteCos, ibmappnNodePortIpName=ibmappnNodePortIpName, ibmappnNodeLsIpName=ibmappnNodeLsIpName, ibmappnNodeEnLocateCdinit=ibmappnNodeEnLocateCdinit, ibmappnDirCurHomeEntries=ibmappnDirCurHomeEntries, ibmappnNodePortDlcTracUseWan=ibmappnNodePortDlcTracUseWan, ibm=ibm, ibmappnNodePortDlcTracDlcType=ibmappnNodePortDlcTracDlcType, ibmappnCosTgRowUsr2Max=ibmappnCosTgRowUsr2Max, ibmappnDirType=ibmappnDirType, ibmappnNnNodeIsrDepleted=ibmappnNnNodeIsrDepleted, ibmappnNnNodeFRName=ibmappnNnNodeFRName, ibmappnNnAdjNodeAdjName=ibmappnNnAdjNodeAdjName, ibmappnSnmpInGetNextVars=ibmappnSnmpInGetNextVars, ibmappnSnmpInTotalVars=ibmappnSnmpInTotalVars, ibmappnNnNodeChainSupport=ibmappnNnNodeChainSupport, ibmappnNnTopoInTdus=ibmappnNnTopoInTdus, ibmappnNodeLsCurrentStateTime=ibmappnNodeLsCurrentStateTime, ibmappnNnTgUsr2=ibmappnNnTgUsr2, ibmappnCosTgRowTable=ibmappnCosTgRowTable, ibmappnNodePortDynLsGoodXids=ibmappnNodePortDynLsGoodXids, ibmappnNodeLsCurrentDelay=ibmappnNodeLsCurrentDelay, ibmappnLocalTg=ibmappnLocalTg, ibmappnNnTgNum=ibmappnNnTgNum, ibmappnNodeType=ibmappnNodeType, ibmappnNodeLsPortName=ibmappnNodeLsPortName, ibmappnNodeNnIsr=ibmappnNodeNnIsr, ibmappnNodeLsTrName=ibmappnNodeLsTrName, ibmappnLocalEnTgEntry=ibmappnLocalEnTgEntry, ibmappnNnNodeRouteAddResist=ibmappnNnNodeRouteAddResist, ibmappnSnmpOutNoSuchNames=ibmappnSnmpOutNoSuchNames, ibmappnNodeLsDelay=ibmappnNodeLsDelay, ibmappnNnTgRsn=ibmappnNnTgRsn, ibmappnNodeNnFrsn=ibmappnNodeNnFrsn, ibmappnLocalTgUsr3=ibmappnLocalTgUsr3, ibmappnNnNodeFrsn=ibmappnNnNodeFrsn, ibmappnSnmpInGetNexts=ibmappnSnmpInGetNexts, ibmappnLocalTgUsr1=ibmappnLocalTgUsr1, ibmappnLocalNnChainSupport=ibmappnLocalNnChainSupport, ibmappnLocalTgUsr2=ibmappnLocalTgUsr2, ibmappnNodeLsIpTable=ibmappnNodeLsIpTable, ibmappnNodeLsStatusTgNum=ibmappnNodeLsStatusTgNum, ibmappnLocalEnEntry=ibmappnLocalEnEntry, ibmappnSnmpInSetRequests=ibmappnSnmpInSetRequests, ibmappnNodeNnTreeCache=ibmappnNodeNnTreeCache, ibmappnNodePortMaxRcvBtuSize=ibmappnNodePortMaxRcvBtuSize, ibmappnNnTgTopologyFRTable=ibmappnNnTgTopologyFRTable, ibmappnCosModeTable=ibmappnCosModeTable, ibmappnLocalEnTgModemClass=ibmappnLocalEnTgModemClass, ibmappnLocalNnRouteAddResist=ibmappnLocalNnRouteAddResist, ibmappnDirInBcastLocates=ibmappnDirInBcastLocates, ibmappnDirTable=ibmappnDirTable, ibmappnLocalEnTgEffCap=ibmappnLocalEnTgEffCap, ibmappnXidInformation=ibmappnXidInformation, ibmappnNnNodeName=ibmappnNnNodeName, ibmappnNodePortSIMRIM=ibmappnNodePortSIMRIM, ibmappnNodeLsTrState=ibmappnNodeLsTrState, ibmappnCosTgRowByteCostMax=ibmappnCosTgRowByteCostMax, ibmappnNnTgTopologyFREntry=ibmappnNnTgTopologyFREntry, ibmappnNnTgFRDestVirtual=ibmappnNnTgFRDestVirtual, ibmappnNnNodeFRCongested=ibmappnNnNodeFRCongested, ibmappnNodeLsStatusTable=ibmappnNodeLsStatusTable, ibmappnLocalNnRsn=ibmappnLocalNnRsn, ibmappnNnTgFRModemClass=ibmappnNnTgFRModemClass, ibmappn=ibmappn, ibmappnNodeLsUsr3=ibmappnNodeLsUsr3, ibmappnDirLuOwnerName=ibmappnDirLuOwnerName, ibmappnLocalTgEffCap=ibmappnLocalTgEffCap, ibmappnNodeNetid=ibmappnNodeNetid, ibmappnLocalEnTgDest=ibmappnLocalEnTgDest, ibmappnNodeLsLocalDlsSap=ibmappnNodeLsLocalDlsSap, ibmappnNodeLsName=ibmappnNodeLsName, ibmappnNodeBlockNum=ibmappnNodeBlockNum, ibmappnNodePortLsRole=ibmappnNodePortLsRole, ibmappnCosModeCosName=ibmappnCosModeCosName, ibmappnNnTgFRDelay=ibmappnNnTgFRDelay, ibmappnNnNodeFRIsrDepleted=ibmappnNnNodeFRIsrDepleted, ibmappnNodeIdNum=ibmappnNodeIdNum, ibmappnNodePortTrName=ibmappnNodePortTrName, ibmappnNnTopoOutTdus=ibmappnNnTopoOutTdus, ibmappnNodeBindReasm=ibmappnNodeBindReasm, ibmappnNodeLsSpecific=ibmappnNodeLsSpecific, ibmappnNnTopologyEntry=ibmappnNnTopologyEntry, ibmappnNnTgSecurity=ibmappnNnTgSecurity, ibmappnLocalNnCentralDirectory=ibmappnLocalNnCentralDirectory, ibmappnLocalTgOperational=ibmappnLocalTgOperational, ibmappnNodePortDefLsBadXids=ibmappnNodePortDefLsBadXids, ibmappnMemoryUsed=ibmappnMemoryUsed, ibmappnNodeLsOutXidFrames=ibmappnNodeLsOutXidFrames, ibmappnNodeLsInMsgFrames=ibmappnNodeLsInMsgFrames, ibmappnDirLuName=ibmappnDirLuName, ibmappnNodeLsBadXids=ibmappnNodeLsBadXids, ibmappnNodeLsOutXidBytes=ibmappnNodeLsOutXidBytes, ibmappnLocalEnTgUsr3=ibmappnLocalEnTgUsr3, ibmappnNodeLsStatusLsName=ibmappnNodeLsStatusLsName, ibmappnNodeDefLsGoodXids=ibmappnNodeDefLsGoodXids, ibmappnNodeLsDlsEntry=ibmappnNodeLsDlsEntry, ibmappnSnmpInGetRequests=ibmappnSnmpInGetRequests, ibmappnDirCurCaches=ibmappnDirCurCaches, ibmappnCosNameTable=ibmappnCosNameTable, ibmappnNnNodeFRRouteAddResist=ibmappnNnNodeFRRouteAddResist, ibmappnLocalNnIsrDepleted=ibmappnLocalNnIsrDepleted, ibmappnSnmpOutGenErrs=ibmappnSnmpOutGenErrs, ibmappnCosTgRowEntry=ibmappnCosTgRowEntry, ibmappnNode=ibmappnNode, ibmappnLocalTgNum=ibmappnLocalTgNum, ibmappnNodePortDlsName=ibmappnNodePortDlsName, ibmappnNodePortDlcType=ibmappnNodePortDlcType, ibmappnLocalTgModemClass=ibmappnLocalTgModemClass, ibmappnNnTopoNodePurges=ibmappnNnTopoNodePurges, ibmappnCosNameEntry=ibmappnCosNameEntry, ibmappnCosTgRowUsr1Min=ibmappnCosTgRowUsr1Min, ibmappnNodeLsStatusXidRemoteSense=ibmappnNodeLsStatusXidRemoteSense, ibmappnNnTgFRDlcData=ibmappnNnTgFRDlcData, ibmappnSnmpInSetVars=ibmappnSnmpInSetVars, ibmappnNnTgTopologyTable=ibmappnNnTgTopologyTable, ibmappnNodeNnRouteAddResist=ibmappnNodeNnRouteAddResist, ibmappnNnNodeFRGateway=ibmappnNnNodeFRGateway, ibmappnNodePortIpPortNum=ibmappnNodePortIpPortNum, ibmappnNnTopoTgPurges=ibmappnNnTopoTgPurges, ibmappnNodeLsRemoteTrMac=ibmappnNodeLsRemoteTrMac, ibmappnNnTopoMaxNodes=ibmappnNnTopoMaxNodes, ibmappnNodePortPortType=ibmappnNodePortPortType, ibmappnNnTgFRSecurity=ibmappnNnTgFRSecurity, ibmappnNodeLsState=ibmappnNodeLsState, ibmappnNodeLsStatusTime=ibmappnNodeLsStatusTime, ibmappnNodeLsStatusRemoteAddr=ibmappnNodeLsStatusRemoteAddr, ibmappnNodeLsBlockNum=ibmappnNodeLsBlockNum, ibmappnLocalNnEndptDepleted=ibmappnLocalNnEndptDepleted, ibmappnNodeLsTargetPacingCount=ibmappnNodeLsTargetPacingCount, ibmappnNnTgFROwner=ibmappnNnTgFROwner, ibmappnNodeLsCpCpSession=ibmappnNodeLsCpCpSession, ibmappnNodeLsStatusXidBitInError=ibmappnNodeLsStatusXidBitInError, ibmappnCosNodeRowIndex=ibmappnCosNodeRowIndex, ibmappnDirServerName=ibmappnDirServerName, ibmappnNodeLsMinDelay=ibmappnNodeLsMinDelay, ibmappnNodeLsStatusDlcType=ibmappnNodeLsStatusDlcType, ibmappnNnNodeGateway=ibmappnNnNodeGateway, ibmappnNodeLsInXidFrames=ibmappnNodeLsInXidFrames, ibmappnNodeLsTable=ibmappnNodeLsTable, ibmappnCosTgRowSecurityMin=ibmappnCosTgRowSecurityMin, ibmappnNodeLsActiveTime=ibmappnNodeLsActiveTime, ibmappnLocalNodeName=ibmappnLocalNodeName, ibmappnNodePortDlcTracLocalAddr=ibmappnNodePortDlcTracLocalAddr, ibmappnLocalThisNode=ibmappnLocalThisNode, ibmappnNnTgDestVirtual=ibmappnNnTgDestVirtual)
mibBuilder.exportSymbols("IBM-6611-APPN-MIB", ibmappnNodeLsLocalIpPortNum=ibmappnNodeLsLocalIpPortNum, ibmappnNnNodeEntryTimeLeft=ibmappnNnNodeEntryTimeLeft, ibmappnNodeLsIpEntry=ibmappnNodeLsIpEntry, ibmappnNnTopoNodeLowRsns=ibmappnNnTopoNodeLowRsns, ibmappnNnNodeFRFrsn=ibmappnNnNodeFRFrsn, ibmappnNnTopoTgErrors=ibmappnNnTopoTgErrors, ibmappnDirNotFoundLocates=ibmappnDirNotFoundLocates, ibmappnNodeLsMaxSendBtuSize=ibmappnNodeLsMaxSendBtuSize, ibmappnNodeLsLocalTrSap=ibmappnNodeLsLocalTrSap, ibmappnNodeNnCentralDirectory=ibmappnNodeNnCentralDirectory, ibmappnSnmpInPkts=ibmappnSnmpInPkts, ibm6611=ibm6611, ibmappnNnTopoRouteCalcs=ibmappnNnTopoRouteCalcs, ibmappnDirLocateOutstands=ibmappnDirLocateOutstands, ibmappnLinkStationInformation=ibmappnLinkStationInformation, ibmappnDirNotFoundBcastLocates=ibmappnDirNotFoundBcastLocates, ibmappnNnTgFrsn=ibmappnNnTgFrsn, ibmappnNodeLsStatusEntry=ibmappnNodeLsStatusEntry, ibmappnNodeLsStatusXidByteInError=ibmappnNodeLsStatusXidByteInError, ibmappnCosNodeRowEntry=ibmappnCosNodeRowEntry, ibmappnNnNodeType=ibmappnNnNodeType, ibmappnCosNodeRowMaxCongestAllow=ibmappnCosNodeRowMaxCongestAllow, ibmappnNodeLsTrEntry=ibmappnNodeLsTrEntry, ibmappnLocalEnName=ibmappnLocalEnName, ibmappnCosNodeRowResistMax=ibmappnCosNodeRowResistMax, ibmappnNnTgDelay=ibmappnNnTgDelay, ibmappnNodeLsIdNum=ibmappnNodeLsIdNum, ibmappnLocalNnIsr=ibmappnLocalNnIsr, ibmappnNodePortTrMac=ibmappnNodePortTrMac, ibmappnLocalEnType=ibmappnLocalEnType, ibmappnNodePortName=ibmappnNodePortName, ibmappnNodeSegReasm=ibmappnNodeSegReasm, ibmappnCosNodeRowName=ibmappnCosNodeRowName, ibmappnNodeLsStartTime=ibmappnNodeLsStartTime, ibmappnNodeUpTime=ibmappnNodeUpTime, ibmappnNodePortDlsEntry=ibmappnNodePortDlsEntry, ibmappnNodeLsRemoteIpAddr=ibmappnNodeLsRemoteIpAddr, ibmappnDirInLocates=ibmappnDirInLocates, ibmappnNnTgUsr3=ibmappnNnTgUsr3, ibmappnNodePortTrSap=ibmappnNodePortTrSap, ibmappnNodeLsStatusLocalAddr=ibmappnNodeLsStatusLocalAddr, ibmappnCosNodeRowResistMin=ibmappnCosNodeRowResistMin, ibmappnNnTopoTgTimerUpdates=ibmappnNnTopoTgTimerUpdates, ibmappnNodeLsStatusIndex=ibmappnNodeLsStatusIndex, ibmappnNodePortDlcTraceTable=ibmappnNodePortDlcTraceTable, ibmappnNnTopoNodeBadHighRsns=ibmappnNnTopoNodeBadHighRsns, ibmappnLocalEnTgUsr1=ibmappnLocalEnTgUsr1, ibmappnLocalTgTable=ibmappnLocalTgTable, ibmappnLocalTgDest=ibmappnLocalTgDest, ibmappnSnmpInformation=ibmappnSnmpInformation, ibmappnLocalNodeType=ibmappnLocalNodeType, ibmappnLocalEnTgTable=ibmappnLocalEnTgTable, ibmappnCosTgRowDelayMax=ibmappnCosTgRowDelayMax, ibmappnLocalTgEntry=ibmappnLocalTgEntry, ibmappnNodeNnRcvRegChar=ibmappnNodeNnRcvRegChar, ibmappnNodeLsRemoteDlsMac=ibmappnNodeLsRemoteDlsMac, ibmappnNodeLsDlsState=ibmappnNodeLsDlsState, ibmappnNodeLsGoodXids=ibmappnNodeLsGoodXids, ibmappnNodePortDlcTracCmdType=ibmappnNodePortDlcTracCmdType, ibmappnLocalEnTgOperational=ibmappnLocalEnTgOperational, ibmappnLocalEnEntryTimeLeft=ibmappnLocalEnEntryTimeLeft, ibmappnNodePortDlsSap=ibmappnNodePortDlsSap, ibmappnNnTopoNodeErrors=ibmappnNnTopoNodeErrors, ibmappnNodeLsDlcType=ibmappnNodeLsDlcType, ibmappnNodePortMaxIframeWindow=ibmappnNodePortMaxIframeWindow, ibmappnCosTgRowEffCapMax=ibmappnCosTgRowEffCapMax, ibmappnNnTgFRByteCost=ibmappnNnTgFRByteCost, ibmappnNodeCpName=ibmappnNodeCpName, ibmappnMemorySize=ibmappnMemorySize, ibmappnNnNodeFREntryTimeLeft=ibmappnNnNodeFREntryTimeLeft, ibmappnLocalNnQuiescing=ibmappnLocalNnQuiescing, ibmappnDirPerf=ibmappnDirPerf, ibmappnNodeLsRemoteTrSap=ibmappnNodeLsRemoteTrSap, ibmappnLocalTgConnCost=ibmappnLocalTgConnCost, ibmappnNodeDynLsGoodXids=ibmappnNodeDynLsGoodXids, ibmappnNodeLsMaxDelay=ibmappnNodeLsMaxDelay, ibmappnNnNodeQuiescing=ibmappnNnNodeQuiescing, ibmappnLocalTgCpCpSession=ibmappnLocalTgCpCpSession, ibmappnLocalTgQuiescing=ibmappnLocalTgQuiescing, ibmappnNnTopoRouteTrees=ibmappnNnTopoRouteTrees, ibmappnCosTgRowConnCostMin=ibmappnCosTgRowConnCostMin, ibmappnCosTgRowByteCostMin=ibmappnCosTgRowByteCostMin, ibmappnCosModeEntry=ibmappnCosModeEntry, ibmappnCosTgRowUsr2Min=ibmappnCosTgRowUsr2Min, ibmappnNnTopology=ibmappnNnTopology, ibmappnCosNodeRowWgt=ibmappnCosNodeRowWgt, ibmappnNodeEnModeCosMap=ibmappnNodeEnModeCosMap, ibmappnLocalNnFrsn=ibmappnLocalNnFrsn, ibmappnDirWildCard=ibmappnDirWildCard, ibmappnNnTgFRUsr1=ibmappnNnTgFRUsr1, ibmappnNodeService=ibmappnNodeService, ibmappnNnTgFREntryTimeLeft=ibmappnNnTgFREntryTimeLeft, ibmappnCosTgRowDelayMin=ibmappnCosTgRowDelayMin, ibmappnLocalNnSpecific=ibmappnLocalNnSpecific, ibmappnNodeLsUsr2=ibmappnNodeLsUsr2, ibmappnLocalGeneral=ibmappnLocalGeneral, ibmappnNn=ibmappnNn, ibmappnLocalEnTgEntryTimeLeft=ibmappnLocalEnTgEntryTimeLeft, ibmappnLocalTgDlcData=ibmappnLocalTgDlcData, ibmappnNnAdjNodeTable=ibmappnNnAdjNodeTable, ibmappnNnTgDest=ibmappnNnTgDest, ibmappnNodeEnSendRegChar=ibmappnNodeEnSendRegChar, ibmappnCosTgRowSecurityMax=ibmappnCosTgRowSecurityMax, ibmappnNnTgUsr1=ibmappnNnTgUsr1, ibmappnNnTgDlcData=ibmappnNnTgDlcData, ibmappnNnTopologyTable=ibmappnNnTopologyTable, ibmappnNodePortDlcTracIndex=ibmappnNodePortDlcTracIndex, ibmappnNodeLsByteCost=ibmappnNodeLsByteCost, ibmappnNodePortDlcTracPortName=ibmappnNodePortDlcTracPortName, ibmappnDirOutBcastLocates=ibmappnDirOutBcastLocates, ibmappnNnAdjNodeEntry=ibmappnNnAdjNodeEntry, ibmappnCosModeName=ibmappnCosModeName, ibmappnNodeNnGateway=ibmappnNodeNnGateway, ibmappnNnTgFRRsn=ibmappnNnTgFRRsn, ibmappnNnTgFRUsr3=ibmappnNnTgFRUsr3, ibmappnNodePortIpEntry=ibmappnNodePortIpEntry, ibmappnNodePortDlsTable=ibmappnNodePortDlsTable, ibmappnNnTopoTgGoodHighRsns=ibmappnNnTopoTgGoodHighRsns, ibmappnNodeEnSegGen=ibmappnNodeEnSegGen, ibmappnNodeLsDlsTable=ibmappnNodeLsDlsTable, ibmappnNnNodeFRType=ibmappnNnNodeFRType, ibmappnDir=ibmappnDir, ibmappnPortInformation=ibmappnPortInformation, ibmappnLocalEnTgUsr2=ibmappnLocalEnTgUsr2, ibmappnCosTransPriority=ibmappnCosTransPriority, ibmappnNnTopoNodeGoodHighRsns=ibmappnNnTopoNodeGoodHighRsns, ibmappnNodeLsStatusCpName=ibmappnNodeLsStatusCpName, ibmappnDirRegEntries=ibmappnDirRegEntries, ibmappnNodeLsMigration=ibmappnNodeLsMigration, ibmappnNodeLsMaxDelayTime=ibmappnNodeLsMaxDelayTime, ibmappnNnTgQuiescing=ibmappnNnTgQuiescing, ibmappnNnTgFRFrsn=ibmappnNnTgFRFrsn, ibmappnNnNodeCentralDirectory=ibmappnNnNodeCentralDirectory, ibmappnLocalTgSecurity=ibmappnLocalTgSecurity, ibmappnNodeLsInMsgBytes=ibmappnNodeLsInMsgBytes, ibmappnCosName=ibmappnCosName, ibmappnMemoryWarnThresh=ibmappnMemoryWarnThresh, ibmappnSnmpInGetVars=ibmappnSnmpInGetVars, ibmappnNodeLsLocalIpAddr=ibmappnNodeLsLocalIpAddr, ibmappnNnTopoTgBadHighRsns=ibmappnNnTopoTgBadHighRsns, ibmappnNnTopo=ibmappnNnTopo, ibmappnLocalEnTgByteCost=ibmappnLocalEnTgByteCost, ibmappnNnTgEntryTimeLeft=ibmappnNnTgEntryTimeLeft, ibmappnLocalTgDestVirtual=ibmappnLocalTgDestVirtual, ibmappnNnTgModemClass=ibmappnNnTgModemClass, ibmappnNodePortSpecific=ibmappnNodePortSpecific, ibmappnNnNodeFRIsr=ibmappnNnNodeFRIsr, ibmappnNnTgByteCost=ibmappnNnTgByteCost, ibmappnNodeLsSecurity=ibmappnNodeLsSecurity, ibmappnNodeNnTreeUpdate=ibmappnNodeNnTreeUpdate, ibmappnNodeEnSendRegNames=ibmappnNodeEnSendRegNames, ibmappnNnTgFRDest=ibmappnNnTgFRDest, ibmappnNnTgFREffCap=ibmappnNnTgFREffCap, ibmappnLocalTopology=ibmappnLocalTopology, ibmappnLocalEnTable=ibmappnLocalEnTable, ibmappnNnTgTopologyEntry=ibmappnNnTgTopologyEntry, ibmappnNodeLsStatusGeneralSense=ibmappnNodeLsStatusGeneralSense, ibmappnNodePortDefLsGoodXids=ibmappnNodePortDefLsGoodXids, ibmappnNodeLsStatusEndSense=ibmappnNodeLsStatusEndSense, ibmappnNnTopoTgStateUpdates=ibmappnNnTopoTgStateUpdates, ibmappnNnAdjNodeLastFrsnSent=ibmappnNnAdjNodeLastFrsnSent, ibmappnNnUniqueInfoAndCaps=ibmappnNnUniqueInfoAndCaps, ibmappnNnNodeFRChainSupport=ibmappnNnNodeFRChainSupport)
