# SNMP MIB module (DLINK-3100-GMRP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-3100-GMRP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:48:50 2025
...
rlGmrpSupported = _RlGmrpSupported_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 75, 1),
...
rlGmrpMibVersion = _RlGmrpMibVersion_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 75, 2),
...
rlPortGmrpTimersTable = _RlPortGmrpTimersTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 75, 3)
)
if mibBuilder.loadTexts:
...
rlPortGmrpTimersEntry = _RlPortGmrpTimersEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 75, 3, 1)
)
...
rlGmrpVlanTag = _RlGmrpVlanTag_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 75, 4, 1, 1),
    _RlGmrpVlanTag_Type()
)
