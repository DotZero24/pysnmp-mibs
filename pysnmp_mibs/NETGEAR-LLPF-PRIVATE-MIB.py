# SNMP MIB module (NETGEAR-LLPF-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-LLPF-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:25:50 2025
...
agentSwitchLlpfPortConfigEntry = _AgentSwitchLlpfPortConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 48, 1, 1, 1)
)
agentSwitchLlpfPortConfigEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "NETGEAR-LLPF-PRIVATE-MIB", "agentSwitchLlpfProtocolType"),
)
if mibBuilder.loadTexts:
...
agentSwitchLlpfProtocolType = _AgentSwitchLlpfProtocolType_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 48, 1, 1, 1, 1),
...
agentSwitchLlpfPortBlockMode = _AgentSwitchLlpfPortBlockMode_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 48, 1, 1, 1, 2),
