#
# PySNMP MIB module NETGEAR-LLPF-PRIVATE-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/netgear/NETGEAR-LLPF-PRIVATE-MIB
...
fastPathLlpf = ModuleIdentity((1, 3, 6, 1, 4, 1, 4526, 10, 48))
...
if mibBuilder.loadTexts: fastPathLlpf.setOrganization('Netgear Inc')
agentSwitchLlpfGroup = MibIdentifier((1, 3, 6, 1, 4, 1, 4526, 10, 48, 1))
agentSwitchLlpfPortConfigTable = MibTable((1, 3, 6, 1, 4, 1, 4526, 10, 48, 1, 1), )
if mibBuilder.loadTexts: agentSwitchLlpfPortConfigTable.setStatus('current')
agentSwitchLlpfPortConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4526, 10, 48, 1, 1, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"), (0, "NETGEAR-LLPF-PRIVATE-MIB", "agentSwitchLlpfProtocolType"))
if mibBuilder.loadTexts: agentSwitchLlpfPortConfigEntry.setStatus('current')
agentSwitchLlpfProtocolType = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 48, 1, 1, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 6)))
if mibBuilder.loadTexts: agentSwitchLlpfProtocolType.setStatus('current')
agentSwitchLlpfPortBlockMode = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 48, 1, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2))).clone('disable')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: agentSwitchLlpfPortBlockMode.setStatus('current')
mibBuilder.exportSymbols("NETGEAR-LLPF-PRIVATE-MIB", agentSwitchLlpfGroup=agentSwitchLlpfGroup, fastPathLlpf=fastPathLlpf, PYSNMP_MODULE_ID=fastPathLlpf, agentSwitchLlpfPortConfigTable=agentSwitchLlpfPortConfigTable, agentSwitchLlpfPortBlockMode=agentSwitchLlpfPortBlockMode, agentSwitchLlpfPortConfigEntry=agentSwitchLlpfPortConfigEntry, agentSwitchLlpfProtocolType=agentSwitchLlpfProtocolType)
