# SNMP MIB module (NETGEAR-PORTSECURITY-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-PORTSECURITY-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:29:00 2025
...
agentPortSecurityStaticMACs = _AgentPortSecurityStaticMACs_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 20, 1, 2, 1, 6),
...
agentPortSecurityLastDiscardedMAC = _AgentPortSecurityLastDiscardedMAC_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 20, 1, 2, 1, 7),
...
agentPortSecurityMACAddressAdd = _AgentPortSecurityMACAddressAdd_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 20, 1, 2, 1, 8),
...
agentPortSecurityMACAddressRemove = _AgentPortSecurityMACAddressRemove_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 20, 1, 2, 1, 9),
...
agentPortSecurityDynamicEntry = _AgentPortSecurityDynamicEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 20, 1, 3, 1)
)
agentPortSecurityDynamicEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "NETGEAR-PORTSECURITY-PRIVATE-MIB", "agentPortSecurityDynamicVLANId"),
    (0, "NETGEAR-PORTSECURITY-PRIVATE-MIB", "agentPortSecurityDynamicMACAddress"),
)
if mibBuilder.loadTexts:
...
agentPortSecurityViolation = NotificationType(
    (1, 3, 6, 1, 4, 1, 4526, 10, 20, 2, 1)
)
agentPortSecurityViolation.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("NETGEAR-PORTSECURITY-PRIVATE-MIB", "agentPortSecurityLastDiscardedMAC"))
)
if mibBuilder.loadTexts:
