...
Dot1agCfmCcmInterval, VlanId, Dot1agCfmMaintAssocNameType, Dot1agCfmHighestDefectPri, Dot1agCfmLowestAlarmPri, VlanIdOrNone, Dot1agCfmMpDirection = mibBuilder.importSymbols("IEEE8021-CFM-MIB", "Dot1agCfmCcmInterval", "VlanId", "Dot1agCfmMaintAssocNameType", "Dot1agCfmHighestDefectPri", "Dot1agCfmLowestAlarmPri", "VlanIdOrNone", "Dot1agCfmMpDirection")
BwAccountStatus, TagList, EntityName, PortList, MepList, CoS, oaOptiSwitch, EntryValidator, ProfileStatus, PortIndexOrNone, OsCfmMepIdOrZero, EntityNameOrNone, StartTimeType, ServiceType, ServFlowId, CfmMDLevel = mibBuilder.importSymbols("OS-COMMON-TC-MIB", "BwAccountStatus", "TagList", "EntityName", "PortList", "MepList", "CoS", "oaOptiSwitch", "EntryValidator", "ProfileStatus", "PortIndexOrNone", "OsCfmMepIdOrZero", "EntityNameOrNone", "StartTimeType", "ServiceType", "ServFlowId", "CfmMDLevel")
...
DateAndTime, TextualConvention, TimeInterval, MacAddress, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "TimeInterval", "MacAddress", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("OS-ETH-SERV-MIB", osEthServFlowEgBwAccStatus=osEthServFlowEgBwAccStatus, osEthCcmSendPortTlv=osEthCcmSendPortTlv, osEthServFlowPerfDestMepList=osEthServFlowPerfDestMepList, osEthActToCPU=osEthActToCPU, osEthServFlowIngBwAccStatus=osEthServFlowIngBwAccStatus, osEthServFlowUpIngFsSubAgentId=osEthServFlowUpIngFsSubAgentId, osEthServVcEntry=osEthServVcEntry, osEthServVcMDLevel=osEthServVcMDLevel, osEthFloodPrflLastError=osEthFloodPrflLastError, osEthPerfMeasBinsHistorySize=osEthPerfMeasBinsHistorySize, osEthServCPorts=osEthServCPorts, osEthBwMaxCIR=osEthBwMaxCIR, osEthMIBGroups=osEthMIBGroups, osEthServFlowLbmDestMepId=osEthServFlowLbmDestMepId, osEthServTm=osEthServTm, osEthServTmCountEntry=osEthServTmCountEntry, osEthServAdminStatus=osEthServAdminStatus, osEthTagExcpCcmEnabled=osEthTagExcpCcmEnabled, osEthPerfMessages=osEthPerfMessages, osEthServLbrEntry=osEthServLbrEntry, osEthServFlowCountRedOcts=osEthServFlowCountRedOcts, osEthServFlowCountYellowOcts=osEthServFlowCountYellowOcts, osEthMandatoryGroup=osEthMandatoryGroup, osEthServFlowLbmDestType=osEthServFlowLbmDestType, osEthDeprecatedGroup=osEthDeprecatedGroup, osEthServNatPfExternalMode=osEthServNatPfExternalMode, osEthServCMgmtVlan=osEthServCMgmtVlan, osEthBwLastError=osEthBwLastError, osEthActMirrorPortIndex=osEthActMirrorPortIndex, osEthBwMinEBS=osEthBwMinEBS, osEthCcmFngAlarmTime=osEthCcmFngAlarmTime, osEthServClassMethod=osEthServClassMethod, osEthServFlowTestStartTimeType=osEthServFlowTestStartTimeType, osEthActAdminStatus=osEthActAdminStatus, osEthPerfOperStatus=osEthPerfOperStatus, osEthServDnEgPcpRemap=osEthServDnEgPcpRemap, osEthServLbrReplyMac=osEthServLbrReplyMac, osEthServClassTable=osEthServClassTable, osEthActEntry=osEthActEntry, osEthServMepDirection=osEthServMepDirection, osEthTagExcpCcmClean=osEthTagExcpCcmClean, osEthSrvFeaturesSupport=osEthSrvFeaturesSupport, osEthTagExcpSupport=osEthTagExcpSupport, osEthServSpokeVcType=osEthServSpokeVcType, osEthServFlowCountAggrPkts=osEthServFlowCountAggrPkts, osEthPerfTimeout=osEthPerfTimeout, osEthServFlowEgBwPrfl=osEthServFlowEgBwPrfl, osEthServExtTable=osEthServExtTable, osEthTagExcpConfig=osEthTagExcpConfig, osEthLbmEntry=osEthLbmEntry, osEthLbmAdminStatus=osEthLbmAdminStatus, osEthServTable=osEthServTable, osEthTagExcpAdminStatus=osEthTagExcpAdminStatus, osEthLbmTable=osEthLbmTable, osEthServFlowLbmClear=osEthServFlowLbmClear, osEthServLbrTable=osEthServLbrTable, osEthServFlowLbmEnabled=osEthServFlowLbmEnabled, osEthServFlowMarkPcp=osEthServFlowMarkPcp, osEthServCcmCoS=osEthServCcmCoS, osEthServOperStatus=osEthServOperStatus, osEthLbmDataFill=osEthLbmDataFill, osEthServFlowCountDir=osEthServFlowCountDir, osEthFloodPrflRate=osEthFloodPrflRate, osEthServClassifyFlowBy=osEthServClassifyFlowBy, osEthCcmMaCcmInterval=osEthCcmMaCcmInterval, osEthServFlowCountAggrOcts=osEthServFlowCountAggrOcts, osEthFsEntry=osEthFsEntry, osEthSrvMaxNumEnabledServicesExceeded=osEthSrvMaxNumEnabledServicesExceeded, osEthServNodeType=osEthServNodeType, osEthPerfMeasBinsClockSyncFlag=osEthPerfMeasBinsClockSyncFlag, osEthBwMaxCBS=osEthBwMaxCBS, osEthBwEBS=osEthBwEBS, osEthActTable=osEthActTable, osEthServVcSVlanId=osEthServVcSVlanId, osEthTagExcpCfmPrfl=osEthTagExcpCfmPrfl, osEthServFlowPerfPrfl=osEthServFlowPerfPrfl, osEthFloodPrflBwOperStatus=osEthFloodPrflBwOperStatus, osEthServOamMepSlmResponder=osEthServOamMepSlmResponder, osEthLbmBurstInterval=osEthLbmBurstInterval, osEthServTunnelTable=osEthServTunnelTable, osEthBwAggregated=osEthBwAggregated, osEthServExtEntry=osEthServExtEntry, osEthServFlowFloodLimPrfl=osEthServFlowFloodLimPrfl, osEthFloodPrflEntry=osEthFloodPrflEntry, osEthActSwapCTag=osEthActSwapCTag, osEthServVcTable=osEthServVcTable, osEthBwOperStatus=osEthBwOperStatus, osEthPerfFdRiseThold=osEthPerfFdRiseThold, osEthPerfDataLength=osEthPerfDataLength, osEthFloodPrflAdminStatus=osEthFloodPrflAdminStatus, osEthPerfMeasBinsIsAlign=osEthPerfMeasBinsIsAlign, osEthServCcmHighestPrDefect=osEthServCcmHighestPrDefect, osEthServFlowUpEgBwAccStatus=osEthServFlowUpEgBwAccStatus, osEthSrvFsSupported=osEthSrvFsSupported, osEthServFlowId=osEthServFlowId, osEthTagExcpCPorts=osEthTagExcpCPorts, osEthCcmSendIfTlv=osEthCcmSendIfTlv, osEthServFlowTable=osEthServFlowTable, osEthServEPortsBufPrfl=osEthServEPortsBufPrfl, osEthServFlowDnIngFsPrfl=osEthServFlowDnIngFsPrfl, osEthServFlowEntry=osEthServFlowEntry, osEthFsChannel=osEthFsChannel, osEthServFlowCountId=osEthServFlowCountId, osEthServMAIndex=osEthServMAIndex, osEthServMDLevel=osEthServMDLevel, osEthFsLastError=osEthFsLastError, osEthTagExcpMepDirection=osEthTagExcpMepDirection, osEthLbmOperStatus=osEthLbmOperStatus, osEthPerfMeasBinsInterval=osEthPerfMeasBinsInterval, osEthServLbrLbmId=osEthServLbrLbmId, osEthFsRateWndSize=osEthFsRateWndSize, PYSNMP_MODULE_ID=osEthServ, osEthPerfFdFallThold=osEthPerfFdFallThold, osEthLbmDataLength=osEthLbmDataLength, osEthServEntry=osEthServEntry, osEthServId=osEthServId, osEthBwColorMode=osEthBwColorMode, osEthServVcMaTypeName=osEthServVcMaTypeName, osEthServFlowMarkDscp=osEthServFlowMarkDscp, osEthServFlowCountRedPkts=osEthServFlowCountRedPkts, osEthCcmMaCcmRMepAgingTime=osEthCcmMaCcmRMepAgingTime, osEthFloodPrflId=osEthFloodPrflId, osEthServCcmClean=osEthServCcmClean, osEthServFlowCountGreenOcts=osEthServFlowCountGreenOcts, osEthServFlowPerfDestMepId=osEthServFlowPerfDestMepId, osEthBwId=osEthBwId, osEthActMirrorPortMode=osEthActMirrorPortMode, osEthBwCBS=osEthBwCBS, osEthLbmInterval=osEthLbmInterval, osEthServTmCountTable=osEthServTmCountTable, osEthServCVlans=osEthServCVlans, osEthServVcMaName=osEthServVcMaName, osEthBwMinCBS=osEthBwMinCBS, osEthServUpstrDeiRemark=osEthServUpstrDeiRemark, osEthServFlowRestOfTraffic=osEthServFlowRestOfTraffic, osEthServFlowDnEgBwPrfl=osEthServFlowDnEgBwPrfl, osEthServTmPort=osEthServTmPort, osEthServLoopback=osEthServLoopback, osEthServFlowTestRelStartTime=osEthServFlowTestRelStartTime, osEthPerfBurstInterval=osEthPerfBurstInterval, osEthConformance=osEthConformance, osEthServTmCountPassPkts=osEthServTmCountPassPkts, osEthServSVlanId=osEthServSVlanId, osEthServFlowDnIngFsSubAgentId=osEthServFlowDnIngFsSubAgentId, osEthServVcType=osEthServVcType, osEthServVcMAIndex=osEthServVcMAIndex, osEthServMepPortIndex=osEthServMepPortIndex, osEthServClassEntry=osEthServClassEntry, osEthServFlowUpIngFsPrfl=osEthServFlowUpIngFsPrfl, osEthServFlowUpstrDEI=osEthServFlowUpstrDEI, osEthTagExcpTable=osEthTagExcpTable, osEthPerfEntry=osEthPerfEntry, osEthLbmMessages=osEthLbmMessages, osEthServTmCountDir=osEthServTmCountDir, osEthServTmDirs=osEthServTmDirs, osEthServLearning=osEthServLearning, osEthMIBCompliances=osEthMIBCompliances, osEthBwRateLimitType=osEthBwRateLimitType, osEthBwMaxEIR=osEthBwMaxEIR, osEthServSpokeVcOuterVlan=osEthServSpokeVcOuterVlan, osEthBwMinEIR=osEthBwMinEIR, osEthServFlowRemarkBits=osEthServFlowRemarkBits, osEthPerfTable=osEthPerfTable, osEthCfmAdminStatus=osEthCfmAdminStatus, osEthServFlowTestParamEntry=osEthServFlowTestParamEntry, osEthLbmHistorySize=osEthLbmHistorySize, osEthTagExcpMaTypeName=osEthTagExcpMaTypeName, osEthBwEntry=osEthBwEntry, osEthLbmLastError=osEthLbmLastError, osEthPerfSDJittFallThold=osEthPerfSDJittFallThold, osEthPerfHistorySize=osEthPerfHistorySize, osEthSrvTypesSupported=osEthSrvTypesSupported, osEthServActionPrfl=osEthServActionPrfl, osEthCfmTable=osEthCfmTable, osEthTagExcpMAIndex=osEthTagExcpMAIndex, osEthTagExcpCVlan=osEthTagExcpCVlan, osEthServLbrPort=osEthServLbrPort, osEthServLimitBWTF=osEthServLimitBWTF, osEthServVcMtuSize=osEthServVcMtuSize, osEthPerfAdminStatus=osEthPerfAdminStatus, osEthServIncludesUntagged=osEthServIncludesUntagged, osEthServSPorts=osEthServSPorts, osEthCfmEntry=osEthCfmEntry, osEthLbmLbrPerLbmHistSize=osEthLbmLbrPerLbmHistSize, osEthCcmLowPrDef=osEthCcmLowPrDef, osEthFsAdminStatus=osEthFsAdminStatus, osEthServFlowCountStatus=osEthServFlowCountStatus, osEthServRecoverPorts=osEthServRecoverPorts, osEthTagExcpEntry=osEthTagExcpEntry, osEthNotificationsGroup=osEthNotificationsGroup, osEthServFlowTestFixedStartTime=osEthServFlowTestFixedStartTime, osEthActId=osEthActId, osEthLbmLbmHistSize=osEthLbmLbmHistSize, osEthServProtectionRole=osEthServProtectionRole, osEthServFlowTestType=osEthServFlowTestType, osEthFsOperStatus=osEthFsOperStatus, osEthServCountTable=osEthServCountTable, osEthServFlowPerfDestMacAddress=osEthServFlowPerfDestMacAddress, osEthTagExcpMaName=osEthTagExcpMaName, osEthPerfType=osEthPerfType, osEthFsReceiver=osEthFsReceiver, osEthLbmId=osEthLbmId, osEthPerfInterval=osEthPerfInterval, osEthMaxSlValue=osEthMaxSlValue, osEthActOperStatus=osEthActOperStatus, osEthServLbrTime=osEthServLbrTime, osEthPerfVlanDropEnable=osEthPerfVlanDropEnable, osEthBwMaxEBS=osEthBwMaxEBS, osEthTagExcpMepId=osEthTagExcpMepId, osEthCfmOperStatus=osEthCfmOperStatus, osEthFsRateUnit=osEthFsRateUnit, osEthServFlowCountYellowPkts=osEthServFlowCountYellowPkts, osEthCcmFngResetTime=osEthCcmFngResetTime, osEthServTunnelName=osEthServTunnelName, osEthServ=osEthServ, osEthCapabilities=osEthCapabilities, osEthServLbrRtt=osEthServLbrRtt, osEthBwCIR=osEthBwCIR, osEthServFlowCountGreenPkts=osEthServFlowCountGreenPkts, osEthServTunnelEntry=osEthServTunnelEntry, osEthServPVlanId=osEthServPVlanId, osEthTagExcpMepPortIndex=osEthTagExcpMepPortIndex, osEthSrvNotifications=osEthSrvNotifications, osEthServFlowUpEgBwPrfl=osEthServFlowUpEgBwPrfl, osEthServCcmEnabled=osEthServCcmEnabled, osEthBwEIR=osEthBwEIR, osEthFsId=osEthFsId, osEthServTmCountDropPkts=osEthServTmCountDropPkts, osEthFloodPrflTable=osEthFloodPrflTable, osEthServCountEntry=osEthServCountEntry, osEthServClassCoS=osEthServClassCoS, osEthPerfId=osEthPerfId, osEthPerfSDJittRiseThold=osEthPerfSDJittRiseThold, osEthServTmCountDropOcts=osEthServTmCountDropOcts, osEthServFlowMepId=osEthServFlowMepId, osEthBwBuffSize=osEthBwBuffSize, osEthServMflgThreshold=osEthServMflgThreshold, osEthServSpokeVcName=osEthServSpokeVcName, osEthServEPortsPrioQuePrfl=osEthServEPortsPrioQuePrfl, osEthServDescription=osEthServDescription, osEthServFlowAdminStatus=osEthServFlowAdminStatus, osEthLbmNumberOfBursts=osEthLbmNumberOfBursts, osEthServTunnelAdminStatus=osEthServTunnelAdminStatus, osEthFloodPrflTypes=osEthFloodPrflTypes, osEthMIBDeprCompliance=osEthMIBDeprCompliance, osEthServFlowMepReserve1=osEthServFlowMepReserve1, osEthCfmLastError=osEthCfmLastError, osEthBwMinCIR=osEthBwMinCIR, osEthServEgrMarkSl=osEthServEgrMarkSl, osEthServFlowIngBwPrfl=osEthServFlowIngBwPrfl, osEthServFlowPerfDestType=osEthServFlowPerfDestType, osEthServFlowLbmDestMacAddress=osEthServFlowLbmDestMacAddress, osEthServChangeIngCVlan=osEthServChangeIngCVlan, osEthServFlowDownstrDEI=osEthServFlowDownstrDEI)
mibBuilder.exportSymbols("OS-ETH-SERV-MIB", osEthServFlowTestPeriodicity=osEthServFlowTestPeriodicity, osEthSrvMaxNumEnabledServices=osEthSrvMaxNumEnabledServices, osEthPerfNumberOfBursts=osEthPerfNumberOfBursts, osEthFsTable=osEthFsTable, osEthServPPortList=osEthServPPortList, osEthServLastError=osEthServLastError, osEthPerfDataFill=osEthPerfDataFill, osEthTagExcpCcmCoS=osEthTagExcpCcmCoS, osEthServFullDownstreamLpbk=osEthServFullDownstreamLpbk, osEthServFlowDnEgBwAccStatus=osEthServFlowDnEgBwAccStatus, osEthServFlowPerfEnabled=osEthServFlowPerfEnabled, osEthServFlowHistoryClear=osEthServFlowHistoryClear, osEthBwAdminStatus=osEthBwAdminStatus, osEthServTmCountPassOcts=osEthServTmCountPassOcts, osEthMIBCompliance=osEthMIBCompliance, osEthCfmId=osEthCfmId, osEthServClassAdminStatus=osEthServClassAdminStatus, osEthServFlowLbmPrfl=osEthServFlowLbmPrfl, osEthServCfmPrfl=osEthServCfmPrfl, osEthServClassValue=osEthServClassValue, osEthPerfDSJittFallThold=osEthPerfDSJittFallThold, osEthPerfDSJittRiseThold=osEthPerfDSJittRiseThold, osEthPerfLastError=osEthPerfLastError, osEthServTmCountStatus=osEthServTmCountStatus, osEthServLbrPerLbmId=osEthServLbrPerLbmId, osEthBwTable=osEthBwTable, osEthLbmTimeout=osEthLbmTimeout, osEthCfmLtrPortIdSubtype=osEthCfmLtrPortIdSubtype, osEthServFlowTestParamTable=osEthServFlowTestParamTable)
