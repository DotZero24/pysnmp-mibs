...
Dot1agCfmHighestDefectPri, Dot1agCfmMpDirection, Dot1agCfmMaintAssocNameType, Dot1agCfmCcmInterval, Dot1agCfmLowestAlarmPri, VlanId, VlanIdOrNone = mibBuilder.importSymbols("IEEE8021-CFM-MIB", "Dot1agCfmHighestDefectPri", "Dot1agCfmMpDirection", "Dot1agCfmMaintAssocNameType", "Dot1agCfmCcmInterval", "Dot1agCfmLowestAlarmPri", "VlanId", "VlanIdOrNone")
OsCfmMepIdOrZero, MepList, PortIndexOrNone, EntityName, BwAccountStatus, TagList, ProfileStatus, ServFlowId, EntityNameOrNone, oaOptiSwitch, PortList, StartTimeType, CfmMDLevel, ServiceType, EntryValidator, CoS = mibBuilder.importSymbols("OS-COMMON-TC-MIB", "OsCfmMepIdOrZero", "MepList", "PortIndexOrNone", "EntityName", "BwAccountStatus", "TagList", "ProfileStatus", "ServFlowId", "EntityNameOrNone", "oaOptiSwitch", "PortList", "StartTimeType", "CfmMDLevel", "ServiceType", "EntryValidator", "CoS")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
ModuleIdentity, Counter64, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Counter32, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Counter32", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
DisplayString, MacAddress, TimeInterval, DateAndTime, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "MacAddress", "TimeInterval", "DateAndTime", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("OS-ETH-SERV-MIB", osEthServVcMAIndex=osEthServVcMAIndex, osEthBwId=osEthBwId, osEthBwMinCBS=osEthBwMinCBS, osEthLbmDataLength=osEthLbmDataLength, osEthServSpokeVcOuterVlan=osEthServSpokeVcOuterVlan, osEthServLoopback=osEthServLoopback, osEthBwMaxCBS=osEthBwMaxCBS, osEthFloodPrflTable=osEthFloodPrflTable, osEthServProtectionRole=osEthServProtectionRole, osEthServFlowRestOfTraffic=osEthServFlowRestOfTraffic, osEthFsLastError=osEthFsLastError, osEthCfmTable=osEthCfmTable, osEthLbmBurstInterval=osEthLbmBurstInterval, osEthServExtEntry=osEthServExtEntry, osEthLbmDataFill=osEthLbmDataFill, osEthServFlowId=osEthServFlowId, osEthServFlowHistoryClear=osEthServFlowHistoryClear, osEthServCountEntry=osEthServCountEntry, osEthLbmHistorySize=osEthLbmHistorySize, osEthPerfDataFill=osEthPerfDataFill, osEthServFlowTestRelStartTime=osEthServFlowTestRelStartTime, osEthServFlowDnIngFsSubAgentId=osEthServFlowDnIngFsSubAgentId, osEthServCcmEnabled=osEthServCcmEnabled, osEthBwRateLimitType=osEthBwRateLimitType, osEthServTmCountDropPkts=osEthServTmCountDropPkts, osEthServTunnelEntry=osEthServTunnelEntry, osEthServMepDirection=osEthServMepDirection, osEthCfmAdminStatus=osEthCfmAdminStatus, osEthServNatPfExternalMode=osEthServNatPfExternalMode, osEthServTable=osEthServTable, osEthServCcmClean=osEthServCcmClean, osEthServClassValue=osEthServClassValue, osEthBwBuffSize=osEthBwBuffSize, osEthPerfMeasBinsHistorySize=osEthPerfMeasBinsHistorySize, osEthPerfFdRiseThold=osEthPerfFdRiseThold, osEthFloodPrflEntry=osEthFloodPrflEntry, osEthServSPorts=osEthServSPorts, osEthPerfDSJittFallThold=osEthPerfDSJittFallThold, osEthServLbrLbmId=osEthServLbrLbmId, osEthServOamMepSlmResponder=osEthServOamMepSlmResponder, osEthServFlowTestParamTable=osEthServFlowTestParamTable, osEthServ=osEthServ, osEthServFlowTestStartTimeType=osEthServFlowTestStartTimeType, PYSNMP_MODULE_ID=osEthServ, osEthServLastError=osEthServLastError, osEthLbmAdminStatus=osEthLbmAdminStatus, osEthFsAdminStatus=osEthFsAdminStatus, osEthTagExcpCfmPrfl=osEthTagExcpCfmPrfl, osEthServFlowUpIngFsSubAgentId=osEthServFlowUpIngFsSubAgentId, osEthActToCPU=osEthActToCPU, osEthServTmCountPassOcts=osEthServTmCountPassOcts, osEthMIBCompliance=osEthMIBCompliance, osEthBwEIR=osEthBwEIR, osEthActId=osEthActId, osEthServFlowLbmClear=osEthServFlowLbmClear, osEthPerfMeasBinsInterval=osEthPerfMeasBinsInterval, osEthFloodPrflLastError=osEthFloodPrflLastError, osEthServFlowUpstrDEI=osEthServFlowUpstrDEI, osEthBwMinEIR=osEthBwMinEIR, osEthActSwapCTag=osEthActSwapCTag, osEthServFullDownstreamLpbk=osEthServFullDownstreamLpbk, osEthBwColorMode=osEthBwColorMode, osEthActAdminStatus=osEthActAdminStatus, osEthSrvNotifications=osEthSrvNotifications, osEthLbmNumberOfBursts=osEthLbmNumberOfBursts, osEthServFlowMepId=osEthServFlowMepId, osEthServMAIndex=osEthServMAIndex, osEthServLbrRtt=osEthServLbrRtt, osEthTagExcpCPorts=osEthTagExcpCPorts, osEthServOperStatus=osEthServOperStatus, osEthLbmEntry=osEthLbmEntry, osEthServFlowPerfEnabled=osEthServFlowPerfEnabled, osEthServClassAdminStatus=osEthServClassAdminStatus, osEthPerfMessages=osEthPerfMessages, osEthServFlowUpEgBwAccStatus=osEthServFlowUpEgBwAccStatus, osEthSrvMaxNumEnabledServices=osEthSrvMaxNumEnabledServices, osEthPerfTimeout=osEthPerfTimeout, osEthPerfId=osEthPerfId, osEthBwCIR=osEthBwCIR, osEthServVcTable=osEthServVcTable, osEthServDescription=osEthServDescription, osEthServFlowPerfDestType=osEthServFlowPerfDestType, osEthTagExcpConfig=osEthTagExcpConfig, osEthServTmCountDropOcts=osEthServTmCountDropOcts, osEthMIBDeprCompliance=osEthMIBDeprCompliance, osEthServId=osEthServId, osEthServFlowEntry=osEthServFlowEntry, osEthServCcmCoS=osEthServCcmCoS, osEthBwOperStatus=osEthBwOperStatus, osEthServTmCountTable=osEthServTmCountTable, osEthServLimitBWTF=osEthServLimitBWTF, osEthPerfHistorySize=osEthPerfHistorySize, osEthServFlowLbmPrfl=osEthServFlowLbmPrfl, osEthServVcMaName=osEthServVcMaName, osEthBwMinCIR=osEthBwMinCIR, osEthMaxSlValue=osEthMaxSlValue, osEthLbmLastError=osEthLbmLastError, osEthServFlowDnEgBwAccStatus=osEthServFlowDnEgBwAccStatus, osEthBwMaxEBS=osEthBwMaxEBS, osEthPerfEntry=osEthPerfEntry, osEthCfmId=osEthCfmId, osEthTagExcpCcmCoS=osEthTagExcpCcmCoS, osEthServTmPort=osEthServTmPort, osEthLbmId=osEthLbmId, osEthCfmLtrPortIdSubtype=osEthCfmLtrPortIdSubtype, osEthServFlowDownstrDEI=osEthServFlowDownstrDEI, osEthServFlowPerfPrfl=osEthServFlowPerfPrfl, osEthFloodPrflRate=osEthFloodPrflRate, osEthServEntry=osEthServEntry, osEthFsId=osEthFsId, osEthTagExcpCcmClean=osEthTagExcpCcmClean, osEthServSVlanId=osEthServSVlanId, osEthServFlowEgBwAccStatus=osEthServFlowEgBwAccStatus, osEthServFlowAdminStatus=osEthServFlowAdminStatus, osEthServClassEntry=osEthServClassEntry, osEthBwAdminStatus=osEthBwAdminStatus, osEthConformance=osEthConformance, osEthServCVlans=osEthServCVlans, osEthPerfInterval=osEthPerfInterval, osEthPerfOperStatus=osEthPerfOperStatus, osEthLbmOperStatus=osEthLbmOperStatus, osEthLbmTable=osEthLbmTable, osEthServClassifyFlowBy=osEthServClassifyFlowBy, osEthServMDLevel=osEthServMDLevel, osEthServTmCountEntry=osEthServTmCountEntry, osEthCcmLowPrDef=osEthCcmLowPrDef, osEthServClassTable=osEthServClassTable, osEthServFlowTestParamEntry=osEthServFlowTestParamEntry, osEthFsEntry=osEthFsEntry, osEthServMflgThreshold=osEthServMflgThreshold, osEthFsRateWndSize=osEthFsRateWndSize, osEthServAdminStatus=osEthServAdminStatus, osEthServLbrPerLbmId=osEthServLbrPerLbmId, osEthPerfDataLength=osEthPerfDataLength, osEthFsOperStatus=osEthFsOperStatus, osEthServVcMaTypeName=osEthServVcMaTypeName, osEthLbmInterval=osEthLbmInterval, osEthServFlowDnIngFsPrfl=osEthServFlowDnIngFsPrfl, osEthServFlowCountAggrPkts=osEthServFlowCountAggrPkts, osEthServFlowCountYellowPkts=osEthServFlowCountYellowPkts, osEthServFlowFloodLimPrfl=osEthServFlowFloodLimPrfl, osEthPerfMeasBinsIsAlign=osEthPerfMeasBinsIsAlign, osEthFsRateUnit=osEthFsRateUnit, osEthServFlowCountStatus=osEthServFlowCountStatus, osEthServPPortList=osEthServPPortList, osEthCapabilities=osEthCapabilities, osEthServFlowMarkDscp=osEthServFlowMarkDscp, osEthServFlowTestFixedStartTime=osEthServFlowTestFixedStartTime, osEthServFlowLbmDestType=osEthServFlowLbmDestType, osEthServFlowMepReserve1=osEthServFlowMepReserve1, osEthTagExcpMepDirection=osEthTagExcpMepDirection, osEthCcmFngAlarmTime=osEthCcmFngAlarmTime, osEthServSpokeVcName=osEthServSpokeVcName, osEthServFlowCountGreenPkts=osEthServFlowCountGreenPkts, osEthServFlowLbmDestMacAddress=osEthServFlowLbmDestMacAddress, osEthServTmDirs=osEthServTmDirs, osEthServFlowIngBwPrfl=osEthServFlowIngBwPrfl, osEthServTunnelAdminStatus=osEthServTunnelAdminStatus, osEthServVcType=osEthServVcType, osEthPerfSDJittFallThold=osEthPerfSDJittFallThold, osEthFsTable=osEthFsTable, osEthServMepPortIndex=osEthServMepPortIndex, osEthServVcMtuSize=osEthServVcMtuSize, osEthPerfBurstInterval=osEthPerfBurstInterval, osEthServFlowCountId=osEthServFlowCountId, osEthServActionPrfl=osEthServActionPrfl, osEthServFlowCountDir=osEthServFlowCountDir, osEthServTmCountPassPkts=osEthServTmCountPassPkts, osEthFloodPrflTypes=osEthFloodPrflTypes, osEthPerfLastError=osEthPerfLastError, osEthServEgrMarkSl=osEthServEgrMarkSl, osEthTagExcpTable=osEthTagExcpTable, osEthActMirrorPortIndex=osEthActMirrorPortIndex, osEthTagExcpMaTypeName=osEthTagExcpMaTypeName, osEthBwMinEBS=osEthBwMinEBS, osEthServTm=osEthServTm, osEthServSpokeVcType=osEthServSpokeVcType, osEthCcmSendIfTlv=osEthCcmSendIfTlv, osEthServLbrTime=osEthServLbrTime, osEthFsReceiver=osEthFsReceiver, osEthServEPortsPrioQuePrfl=osEthServEPortsPrioQuePrfl, osEthServCMgmtVlan=osEthServCMgmtVlan, osEthServUpstrDeiRemark=osEthServUpstrDeiRemark, osEthServEPortsBufPrfl=osEthServEPortsBufPrfl, osEthPerfSDJittRiseThold=osEthPerfSDJittRiseThold, osEthCcmSendPortTlv=osEthCcmSendPortTlv, osEthServFlowTestType=osEthServFlowTestType, osEthBwEBS=osEthBwEBS, osEthServClassMethod=osEthServClassMethod, osEthServFlowRemarkBits=osEthServFlowRemarkBits, osEthServFlowCountGreenOcts=osEthServFlowCountGreenOcts, osEthActMirrorPortMode=osEthActMirrorPortMode, osEthPerfNumberOfBursts=osEthPerfNumberOfBursts, osEthBwEntry=osEthBwEntry, osEthTagExcpMepPortIndex=osEthTagExcpMepPortIndex, osEthTagExcpAdminStatus=osEthTagExcpAdminStatus, osEthServNodeType=osEthServNodeType, osEthBwCBS=osEthBwCBS, osEthServCcmHighestPrDefect=osEthServCcmHighestPrDefect, osEthLbmLbmHistSize=osEthLbmLbmHistSize, osEthTagExcpEntry=osEthTagExcpEntry, osEthServCountTable=osEthServCountTable, osEthServExtTable=osEthServExtTable, osEthCcmMaCcmInterval=osEthCcmMaCcmInterval, osEthServFlowLbmEnabled=osEthServFlowLbmEnabled, osEthTagExcpMAIndex=osEthTagExcpMAIndex, osEthServDnEgPcpRemap=osEthServDnEgPcpRemap, osEthBwLastError=osEthBwLastError, osEthPerfMeasBinsClockSyncFlag=osEthPerfMeasBinsClockSyncFlag, osEthPerfDSJittRiseThold=osEthPerfDSJittRiseThold, osEthServFlowEgBwPrfl=osEthServFlowEgBwPrfl, osEthFloodPrflBwOperStatus=osEthFloodPrflBwOperStatus, osEthServLbrTable=osEthServLbrTable, osEthTagExcpCcmEnabled=osEthTagExcpCcmEnabled, osEthServFlowMarkPcp=osEthServFlowMarkPcp, osEthTagExcpMepId=osEthTagExcpMepId, osEthServCPorts=osEthServCPorts, osEthServClassCoS=osEthServClassCoS, osEthServVcSVlanId=osEthServVcSVlanId, osEthBwTable=osEthBwTable, osEthFsChannel=osEthFsChannel, osEthCfmOperStatus=osEthCfmOperStatus, osEthServVcMDLevel=osEthServVcMDLevel, osEthCcmMaCcmRMepAgingTime=osEthCcmMaCcmRMepAgingTime, osEthBwMaxCIR=osEthBwMaxCIR, osEthSrvFsSupported=osEthSrvFsSupported, osEthServFlowPerfDestMepList=osEthServFlowPerfDestMepList, osEthPerfType=osEthPerfType, osEthSrvTypesSupported=osEthSrvTypesSupported, osEthActEntry=osEthActEntry, osEthLbmLbrPerLbmHistSize=osEthLbmLbrPerLbmHistSize, osEthServLbrReplyMac=osEthServLbrReplyMac, osEthServLbrPort=osEthServLbrPort, osEthLbmTimeout=osEthLbmTimeout, osEthServTunnelName=osEthServTunnelName, osEthServVcEntry=osEthServVcEntry, osEthPerfTable=osEthPerfTable, osEthTagExcpMaName=osEthTagExcpMaName, osEthNotificationsGroup=osEthNotificationsGroup, osEthServFlowLbmDestMepId=osEthServFlowLbmDestMepId, osEthActOperStatus=osEthActOperStatus, osEthSrvFeaturesSupport=osEthSrvFeaturesSupport, osEthServLearning=osEthServLearning, osEthLbmMessages=osEthLbmMessages, osEthServFlowCountRedOcts=osEthServFlowCountRedOcts, osEthServFlowPerfDestMacAddress=osEthServFlowPerfDestMacAddress, osEthBwAggregated=osEthBwAggregated, osEthServFlowDnEgBwPrfl=osEthServFlowDnEgBwPrfl, osEthServRecoverPorts=osEthServRecoverPorts, osEthServPVlanId=osEthServPVlanId, osEthPerfFdFallThold=osEthPerfFdFallThold, osEthServLbrEntry=osEthServLbrEntry, osEthTagExcpCVlan=osEthTagExcpCVlan, osEthCcmFngResetTime=osEthCcmFngResetTime)
mibBuilder.exportSymbols("OS-ETH-SERV-MIB", osEthCfmLastError=osEthCfmLastError, osEthPerfVlanDropEnable=osEthPerfVlanDropEnable, osEthCfmEntry=osEthCfmEntry, osEthServFlowCountRedPkts=osEthServFlowCountRedPkts, osEthTagExcpSupport=osEthTagExcpSupport, osEthMIBGroups=osEthMIBGroups, osEthServTmCountStatus=osEthServTmCountStatus, osEthServTunnelTable=osEthServTunnelTable, osEthServCfmPrfl=osEthServCfmPrfl, osEthMIBCompliances=osEthMIBCompliances, osEthServChangeIngCVlan=osEthServChangeIngCVlan, osEthServFlowIngBwAccStatus=osEthServFlowIngBwAccStatus, osEthFloodPrflId=osEthFloodPrflId, osEthServFlowUpIngFsPrfl=osEthServFlowUpIngFsPrfl, osEthServIncludesUntagged=osEthServIncludesUntagged, osEthPerfAdminStatus=osEthPerfAdminStatus, osEthActTable=osEthActTable, osEthServFlowUpEgBwPrfl=osEthServFlowUpEgBwPrfl, osEthServFlowTestPeriodicity=osEthServFlowTestPeriodicity, osEthMandatoryGroup=osEthMandatoryGroup, osEthServFlowCountYellowOcts=osEthServFlowCountYellowOcts, osEthServFlowPerfDestMepId=osEthServFlowPerfDestMepId, osEthServFlowTable=osEthServFlowTable, osEthDeprecatedGroup=osEthDeprecatedGroup, osEthBwMaxEIR=osEthBwMaxEIR, osEthFloodPrflAdminStatus=osEthFloodPrflAdminStatus, osEthServTmCountDir=osEthServTmCountDir, osEthServFlowCountAggrOcts=osEthServFlowCountAggrOcts, osEthSrvMaxNumEnabledServicesExceeded=osEthSrvMaxNumEnabledServicesExceeded)
