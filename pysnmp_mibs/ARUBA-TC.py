...
MibIdentifier, NotificationType, Bits, Integer32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectSyntax, Counter32, Counter64, TimeTicks, ModuleIdentity, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Bits", "Integer32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectSyntax", "Counter32", "Counter64", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("ARUBA-TC", ArubaActiveState=ArubaActiveState, ArubaEnet1Mode=ArubaEnet1Mode, ArubaPortDuplex=ArubaPortDuplex, ArubaEncryptionMethods=ArubaEncryptionMethods, ArubaAPUplinkType=ArubaAPUplinkType, ArubaHashAlgorithms=ArubaHashAlgorithms, ArubaCallStates=ArubaCallStates, ArubaPoeState=ArubaPoeState, ArubaESIServerMode=ArubaESIServerMode, ArubaVrrpState=ArubaVrrpState, ArubaDaysOfWeek=ArubaDaysOfWeek, ArubaStationType=ArubaStationType, ArubaDot3azStatus=ArubaDot3azStatus, ArubaDot3bzStatus=ArubaDot3bzStatus, ArubaEncryptionType=ArubaEncryptionType, ArubaEnableValue=ArubaEnableValue, ArubaAPStatus=ArubaAPStatus, ArubaAPMatchMethod=ArubaAPMatchMethod, ArubaPhyType=ArubaPhyType, ArubaHTExtChannel=ArubaHTExtChannel, ArubaSplit5GMode=ArubaSplit5GMode, ArubaStackChangeEvent=ArubaStackChangeEvent, ArubaPortSpeed=ArubaPortSpeed, ArubaAPUplinkChangeReason=ArubaAPUplinkChangeReason, ArubaPortType=ArubaPortType, ArubaAPMatchType=ArubaAPMatchType, ArubaOperStateValue=ArubaOperStateValue, ArubaMonEncryptionCipher=ArubaMonEncryptionCipher, ArubaVoiceCdrDirection=ArubaVoiceCdrDirection, ArubaVlanValidRange=ArubaVlanValidRange, ArubaAntennaSetting=ArubaAntennaSetting, ArubaFlexRadioMode=ArubaFlexRadioMode, ArubaPortalServerDownReason=ArubaPortalServerDownReason, ArubaConfigurationChangeType=ArubaConfigurationChangeType, ArubaHTMode=ArubaHTMode, ArubaAPDot1dState=ArubaAPDot1dState, ArubaThresholdResourceType=ArubaThresholdResourceType, ArubaStackIfTopoJoined=ArubaStackIfTopoJoined, ArubaACLNetworkServiceType=ArubaACLNetworkServiceType, ArubaAPMasterStatus=ArubaAPMasterStatus, ArubaMeshRole=ArubaMeshRole, ArubaUnprovisionedStatus=ArubaUnprovisionedStatus, ArubaStackState=ArubaStackState, ArubaHaRole=ArubaHaRole, ArubaVoipProtocol=ArubaVoipProtocol, ArubaCardType=ArubaCardType, ArubaSwitchRole=ArubaSwitchRole, ArubaVoipRegState=ArubaVoipRegState, ArubaFrameType=ArubaFrameType, ArubaAddressType=ArubaAddressType, ArubaDenyListReason=ArubaDenyListReason, ArubaHTRate=ArubaHTRate, ArubaAuthenticationMethods=ArubaAuthenticationMethods, ArubaAPConductorStatus=ArubaAPConductorStatus, ArubaRogueApType=ArubaRogueApType, ArubaVoiceCacBit=ArubaVoiceCacBit, ArubaPortMode=ArubaPortMode, ArubaACLAction=ArubaACLAction, ArubaMonEncryptionType=ArubaMonEncryptionType, ArubaAccessPointMode=ArubaAccessPointMode, ArubaACLDomain=ArubaACLDomain, ArubaESIServerStatus=ArubaESIServerStatus, ArubaBlackListReason=ArubaBlackListReason, ArubaMonAuthAlgorithm=ArubaMonAuthAlgorithm, InterfaceIndex=InterfaceIndex, ArubaSupportStatus=ArubaSupportStatus, ArubaHaConnectivityStatus=ArubaHaConnectivityStatus, ArubaSubAuthenticationMethods=ArubaSubAuthenticationMethods, ArubaIfState=ArubaIfState, ArubaUserForwardMode=ArubaUserForwardMode, ArubaMonitorMode=ArubaMonitorMode, ArubaVoipProtocolType=ArubaVoipProtocolType, ArubaConfigurationState=ArubaConfigurationState, ArubaDual5GMode=ArubaDual5GMode, ArubaARMChangeReason=ArubaARMChangeReason, ArubaDBType=ArubaDBType, ArubaDot1dState=ArubaDot1dState, ArubaIfStateChangeReason=ArubaIfStateChangeReason, ArubaAuthServerType=ArubaAuthServerType, ArubaIfType=ArubaIfType)
