...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/aruba/ARUBA-TC
...
ModuleIdentity, Counter64, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, TimeTicks, MibIdentifier, Integer32, Bits, ObjectSyntax, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "ObjectSyntax", "IpAddress")
...
class ArubaHTExtChannel(TextualConvention, Integer32):
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))
    namedValues = NamedValues(("none", 1), ("above", 2), ("below", 3), ("eighty", 4), ("onesixty", 5), ("eightyPlusEighty", 6))
...
class ArubaSwitchRole(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("conductor", 1), ("local", 2), ("backupconductor", 3), ("standalone", 4))
...
class ArubaAccessPointMode(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("airMonitor", 1), ("accessPoint", 2), ("accessPointAndMonitor", 3), ("meshPortal", 4), ("meshPoint", 5), ("rfprotectSensor", 6), ("spectrumSensor", 7), ("station", 8), ("stationMeshP", 9), ("amsMode", 10), ("controllerMode", 11), ("airmatchMonitor", 12))
...
mibBuilder.exportSymbols("ARUBA-TC", ArubaSubAuthenticationMethods=ArubaSubAuthenticationMethods, ArubaUserForwardMode=ArubaUserForwardMode, ArubaFrameType=ArubaFrameType, ArubaIfState=ArubaIfState, ArubaAuthServerType=ArubaAuthServerType, ArubaIfType=ArubaIfType, ArubaMonEncryptionType=ArubaMonEncryptionType, ArubaHashAlgorithms=ArubaHashAlgorithms, ArubaSupportStatus=ArubaSupportStatus, ArubaAPUplinkChangeReason=ArubaAPUplinkChangeReason, ArubaActiveState=ArubaActiveState, ArubaAPStatus=ArubaAPStatus, ArubaStationType=ArubaStationType, ArubaARMChangeReason=ArubaARMChangeReason, ArubaSplit5GMode=ArubaSplit5GMode, ArubaAntennaSetting=ArubaAntennaSetting, ArubaAPMasterStatus=ArubaAPMasterStatus, ArubaEncryptionType=ArubaEncryptionType, ArubaPoeState=ArubaPoeState, ArubaHTExtChannel=ArubaHTExtChannel, ArubaVoipProtocol=ArubaVoipProtocol, ArubaOperStateValue=ArubaOperStateValue, ArubaPortDuplex=ArubaPortDuplex, ArubaStackState=ArubaStackState, ArubaVoipRegState=ArubaVoipRegState, ArubaMonAuthAlgorithm=ArubaMonAuthAlgorithm, ArubaHTMode=ArubaHTMode, ArubaCallStates=ArubaCallStates, ArubaPortalServerDownReason=ArubaPortalServerDownReason, ArubaAPConductorStatus=ArubaAPConductorStatus, ArubaACLNetworkServiceType=ArubaACLNetworkServiceType, ArubaStackIfTopoJoined=ArubaStackIfTopoJoined, ArubaHaConnectivityStatus=ArubaHaConnectivityStatus, ArubaConfigurationState=ArubaConfigurationState, ArubaEnet1Mode=ArubaEnet1Mode, ArubaAPDot1dState=ArubaAPDot1dState, ArubaRogueApType=ArubaRogueApType, ArubaStackChangeEvent=ArubaStackChangeEvent, ArubaAuthenticationMethods=ArubaAuthenticationMethods, ArubaMeshRole=ArubaMeshRole, ArubaThresholdResourceType=ArubaThresholdResourceType, ArubaHTRate=ArubaHTRate, ArubaConfigurationChangeType=ArubaConfigurationChangeType, ArubaMonEncryptionCipher=ArubaMonEncryptionCipher, ArubaUnprovisionedStatus=ArubaUnprovisionedStatus, ArubaBlackListReason=ArubaBlackListReason, ArubaVrrpState=ArubaVrrpState, ArubaMonitorMode=ArubaMonitorMode, ArubaDual5GMode=ArubaDual5GMode, ArubaEnableValue=ArubaEnableValue, ArubaAccessPointMode=ArubaAccessPointMode, ArubaEncryptionMethods=ArubaEncryptionMethods, ArubaACLAction=ArubaACLAction, ArubaVoiceCdrDirection=ArubaVoiceCdrDirection, ArubaESIServerMode=ArubaESIServerMode, ArubaVoipProtocolType=ArubaVoipProtocolType, ArubaDot3bzStatus=ArubaDot3bzStatus, ArubaDot3azStatus=ArubaDot3azStatus, ArubaDaysOfWeek=ArubaDaysOfWeek, ArubaVlanValidRange=ArubaVlanValidRange, ArubaDBType=ArubaDBType, ArubaDot1dState=ArubaDot1dState, ArubaPhyType=ArubaPhyType, ArubaAPUplinkType=ArubaAPUplinkType, ArubaPortMode=ArubaPortMode, ArubaPortType=ArubaPortType, ArubaFlexRadioMode=ArubaFlexRadioMode, ArubaAPMatchMethod=ArubaAPMatchMethod, InterfaceIndex=InterfaceIndex, ArubaVoiceCacBit=ArubaVoiceCacBit, ArubaACLDomain=ArubaACLDomain, ArubaAPMatchType=ArubaAPMatchType, ArubaHaRole=ArubaHaRole, ArubaSwitchRole=ArubaSwitchRole, ArubaESIServerStatus=ArubaESIServerStatus, ArubaDenyListReason=ArubaDenyListReason, ArubaAddressType=ArubaAddressType, ArubaCardType=ArubaCardType, ArubaIfStateChangeReason=ArubaIfStateChangeReason, ArubaPortSpeed=ArubaPortSpeed)
