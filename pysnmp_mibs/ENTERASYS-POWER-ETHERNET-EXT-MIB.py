...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:33:49 2025
...
mibBuilder.exportSymbols("ENTERASYS-POWER-ETHERNET-EXT-MIB", etsysPsePowerSupplyModuleStatusChange=etsysPsePowerSupplyModuleStatusChange, etsysPseChassisPowerAllocation=etsysPseChassisPowerAllocation, etsysPseChassisPowerAvailableMaximum=etsysPseChassisPowerAvailableMaximum, etsysPseModulePowerManagementTable=etsysPseModulePowerManagementTable, PYSNMP_MODULE_ID=etsysPowerEthernetMibExtMIB, etsysPsePortPowerManagementEntry=etsysPsePortPowerManagementEntry, etsysPseChassisPowerRedundant=etsysPseChassisPowerRedundant, etsysPseChassisPowerAssigned=etsysPseChassisPowerAssigned, etsysPowerEthernetObjects=etsysPowerEthernetObjects, etsysPsePortCapability=etsysPsePortCapability, etsysPsePowerSupplyModuleStatus=etsysPsePowerSupplyModuleStatus, etsysPseSlotPowerAllocationTable=etsysPseSlotPowerAllocationTable, etsysPsePowerSupplyModuleNumber=etsysPsePowerSupplyModuleNumber, etsysPsePortPowerManagementGroupRev2=etsysPsePortPowerManagementGroupRev2, etsysPseChassisPowerSnmpNotification=etsysPseChassisPowerSnmpNotification, etsysPsePowerAllocationCompliances=etsysPsePowerAllocationCompliances, etsysPsePowerAllocationCompliance2=etsysPsePowerAllocationCompliance2, etsysPseChassisPowerStatusGroup=etsysPseChassisPowerStatusGroup, etsysPseChassisPowerStatus=etsysPseChassisPowerStatus, etsysPsePowerNotification=etsysPsePowerNotification, etsysPsePowerAllocationControlGroup=etsysPsePowerAllocationControlGroup, etsysPsePowerAllocationCompliance2Rev2=etsysPsePowerAllocationCompliance2Rev2, etsysPseSlotPowerManagement=etsysPseSlotPowerManagement, etsysPseModulePowerUsage=etsysPseModulePowerUsage, etsysPseModulePowerMode=etsysPseModulePowerMode, etsysPsePowerAllocationCompliance=etsysPsePowerAllocationCompliance, etsysPsePortPowerManagement=etsysPsePortPowerManagement, etsysPsePowerSupplyStatusTable=etsysPsePowerSupplyStatusTable, etsysPseChassisPowerRedundancy=etsysPseChassisPowerRedundancy, etsysPseChassisPowerAvailable=etsysPseChassisPowerAvailable, etsysPseModulePowerClassBudget=etsysPseModulePowerClassBudget, etsysPsePortCapabilitySelect=etsysPsePortCapabilitySelect, etsysPowerEthernetMibExtMIB=etsysPowerEthernetMibExtMIB, etsysPseModulePowerManagementEntry=etsysPseModulePowerManagementEntry, etsysPsePowerNotificationGroup=etsysPsePowerNotificationGroup, etsysPseSlotPowerAssigned=etsysPseSlotPowerAssigned, etsysPsePortPDType=etsysPsePortPDType, etsysPsePortPowerUsage=etsysPsePortPowerUsage, etsysPseChassisPowerNonRedundant=etsysPseChassisPowerNonRedundant, etsysPseSlotPowerMaximum=etsysPseSlotPowerMaximum, etsysPsePortPowerManagementGroup=etsysPsePortPowerManagementGroup, etsysPseSlotPowerAllocation=etsysPseSlotPowerAllocation, etsysPsePowerAllocationGroups=etsysPsePowerAllocationGroups, etsysPsePortPowerManagementTable=etsysPsePortPowerManagementTable, etsysPseChassisPowerDetected=etsysPseChassisPowerDetected, etsysPsePortPowerLimit=etsysPsePortPowerLimit, etsysPsePowerAllocationConformance=etsysPsePowerAllocationConformance, etsysPseModulePowerManagementGroup=etsysPseModulePowerManagementGroup, etsysPsePowerSupplyStatusEntry=etsysPsePowerSupplyStatusEntry, etsysPseChassisPowerConsumable=etsysPseChassisPowerConsumable, etsysPseChassisPowerAllocationMode=etsysPseChassisPowerAllocationMode, etsysPseSlotPowerAllocationEntry=etsysPseSlotPowerAllocationEntry, etsysPsePortDetectionStatus=etsysPsePortDetectionStatus)
