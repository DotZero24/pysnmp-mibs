...
rlBannerMessageTable=_RlBannerMessageTable_Object((1,3,6,1,4,1,89,133,1))
if mibBuilder.loadTexts:rlBannerMessageTable.setStatus(_A)
_RlBannerMessageEntry_Object=MibTableRow
rlBannerMessageEntry=_RlBannerMessageEntry_Object((1,3,6,1,4,1,89,133,1,1))
...
rlBannerMessageType=_RlBannerMessageType_Object((1,3,6,1,4,1,89,133,1,1,1),_RlBannerMessageType_Type())
...
rlBannerMessageIndex=_RlBannerMessageIndex_Object((1,3,6,1,4,1,89,133,1,1,2),_RlBannerMessageIndex_Type())
...
rlBannerMessageText=_RlBannerMessageText_Object((1,3,6,1,4,1,89,133,1,1,3),_RlBannerMessageText_Type())
...
rlBannerManageTable=_RlBannerManageTable_Object((1,3,6,1,4,1,89,133,2))
if mibBuilder.loadTexts:rlBannerManageTable.setStatus(_A)
_RlBannerManageEntry_Object=MibTableRow
rlBannerManageEntry=_RlBannerManageEntry_Object((1,3,6,1,4,1,89,133,2,1))
...
rlBannerManageSSH=_RlBannerManageSSH_Object((1,3,6,1,4,1,89,133,2,1,1),_RlBannerManageSSH_Type())
...
rlBannerManageTelnet=_RlBannerManageTelnet_Object((1,3,6,1,4,1,89,133,2,1,2),_RlBannerManageTelnet_Type())
...
rlBannerManageConsole=_RlBannerManageConsole_Object((1,3,6,1,4,1,89,133,2,1,3),_RlBannerManageConsole_Type())
...
rlBannerMessageClear=_RlBannerMessageClear_Object((1,3,6,1,4,1,89,133,3),_RlBannerMessageClear_Type())
