# SNMP MIB module (RADLAN-BANNER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-BANNER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:11:06 2025
...
rlBannerMessageEntry = _RlBannerMessageEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 133, 1, 1)
)
rlBannerMessageEntry.setIndexNames(
    (0, "RADLAN-BANNER-MIB", "rlBannerMessageType"),
    (0, "RADLAN-BANNER-MIB", "rlBannerMessageIndex"),
)
if mibBuilder.loadTexts:
