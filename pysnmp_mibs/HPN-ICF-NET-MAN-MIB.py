...
mibBuilder.exportSymbols("HPN-ICF-NET-MAN-MIB", hpnicfNMMonitorObjects=hpnicfNMMonitorObjects, hpnicfNMNotifyScalarObjects=hpnicfNMNotifyScalarObjects, hpnicfNMCustomBuildInfo=hpnicfNMCustomBuildInfo, hpnicfNetManGroups=hpnicfNetManGroups, hpnicfNMMonitorGroup=hpnicfNMMonitorGroup, hpnicfNetMan=hpnicfNetMan, hpnicfNMConfigObjects=hpnicfNMConfigObjects, hpnicfNMNotificationGroup=hpnicfNMNotificationGroup, hpnicfNetManConformance=hpnicfNetManConformance, hpnicfNMNotify=hpnicfNMNotify, hpnicfIpAddrChangeNotify=hpnicfIpAddrChangeNotify, hpnicfNMNotifyObjectsPrefix=hpnicfNMNotifyObjectsPrefix, hpnicfNetManCompliances=hpnicfNetManCompliances, hpnicfNMIpAddress=hpnicfNMIpAddress, PYSNMP_MODULE_ID=hpnicfNetMan, hpnicfNMNotifyObjects=hpnicfNMNotifyObjects, hpnicfNMSerialNum=hpnicfNMSerialNum, hpnicfNetManCompliance=hpnicfNetManCompliance, hpnicfNMIpAddressType=hpnicfNMIpAddressType)
