...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-DHCP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:29 2025
...
rbnDhcpThresholdCompliance.setObjects(
      *(("RBN-DHCP-MIB", "rbnDhcpThresholdGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpThresholdNotifyGroup"))
)
if mibBuilder.loadTexts:
...
rbnDhcpThresholdCompliance2.setObjects(
      *(("RBN-DHCP-MIB", "rbnDhcpIntfThresholdGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpCtxThresholdGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpRangeThresholdGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpIntfThresholdNotifyGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpCtxThresholdNotifyGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpRangeThresholdNotifyGroup"))
)
if mibBuilder.loadTexts:
...
rbnDhcpThresholdCompliance3.setObjects(
      *(("RBN-DHCP-MIB", "rbnDhcpIntfThresholdGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpCtxThresholdGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpRangeThresholdGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpIntfThresholdNotifyGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpCtxThresholdNotifyGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpRangeThresholdNotifyGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpLeaseFileFailureTrapGroup"),
        ("RBN-DHCP-MIB", "rbnDhcpLeaseFileFailureNotifyGroup"))
)
if mibBuilder.loadTexts:
