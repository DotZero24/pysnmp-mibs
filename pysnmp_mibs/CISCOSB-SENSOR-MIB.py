# SNMP MIB module (CISCOSB-SENSOR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-SENSOR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:41:02 2025
...
entPhySensorType = _EntPhySensorType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 1, 1, 1, 1),
...
entPhySensorScale = _EntPhySensorScale_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 1, 1, 1, 2),
...
entPhySensorPrecision = _EntPhySensorPrecision_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 1, 1, 1, 3),
...
entPhySensorValue = _EntPhySensorValue_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 1, 1, 1, 4),
...
entPhySensorOperStatus = _EntPhySensorOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 1, 1, 1, 5),
...
entPhySensorUnitsDisplay = _EntPhySensorUnitsDisplay_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 1, 1, 1, 6),
...
entPhySensorValueTimeStamp = _EntPhySensorValueTimeStamp_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 1, 1, 1, 7),
...
entPhySensorValueUpdateRate = _EntPhySensorValueUpdateRate_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 1, 1, 1, 8),
...
entitySensorConformance = _EntitySensorConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 3)
)
_EntitySensorCompliances_ObjectIdentity = ObjectIdentity
entitySensorCompliances = _EntitySensorCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 3, 1)
)
_EntitySensorGroups_ObjectIdentity = ObjectIdentity
entitySensorGroups = _EntitySensorGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 3, 2)
)

# Managed Objects groups

entitySensorValueGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 3, 2, 1)
)
entitySensorValueGroup.setObjects(
      *(("CISCOSB-SENSOR-MIB", "entPhySensorType"),
        ("CISCOSB-SENSOR-MIB", "entPhySensorScale"),
        ("CISCOSB-SENSOR-MIB", "entPhySensorPrecision"),
        ("CISCOSB-SENSOR-MIB", "entPhySensorValue"),
        ("CISCOSB-SENSOR-MIB", "entPhySensorOperStatus"),
        ("CISCOSB-SENSOR-MIB", "entPhySensorUnitsDisplay"),
        ("CISCOSB-SENSOR-MIB", "entPhySensorValueTimeStamp"),
        ("CISCOSB-SENSOR-MIB", "entPhySensorValueUpdateRate"))
)
if mibBuilder.loadTexts:
...
entitySensorCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 83, 2, 3, 1, 1)
)
entitySensorCompliance.setObjects(
      *(("CISCOSB-SENSOR-MIB", "entitySensorValueGroup"),
