...
_Des_1252a1_ObjectIdentity=ObjectIdentity
des_1252a1=_Des_1252a1_ObjectIdentity((1,3,6,1,4,1,171,10,75,4))
_CompanyCommGroup_ObjectIdentity=ObjectIdentity
companyCommGroup=_CompanyCommGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,1))
_CommSetTable_Object=MibTable
commSetTable=_CommSetTable_Object((1,3,6,1,4,1,171,10,75,4,1,1))
if mibBuilder.loadTexts:commSetTable.setStatus(_A)
_CommSetEntry_Object=MibTableRow
commSetEntry=_CommSetEntry_Object((1,3,6,1,4,1,171,10,75,4,1,1,1))
...
commSetIndex=_CommSetIndex_Object((1,3,6,1,4,1,171,10,75,4,1,1,1,1),_CommSetIndex_Type())
...
commSetName=_CommSetName_Object((1,3,6,1,4,1,171,10,75,4,1,1,1,2),_CommSetName_Type())
...
commSetStatus=_CommSetStatus_Object((1,3,6,1,4,1,171,10,75,4,1,1,1,3),_CommSetStatus_Type())
commSetStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:commSetStatus.setStatus(_A)
_CommGetTable_Object=MibTable
commGetTable=_CommGetTable_Object((1,3,6,1,4,1,171,10,75,4,1,2))
if mibBuilder.loadTexts:commGetTable.setStatus(_A)
_CommGetEntry_Object=MibTableRow
commGetEntry=_CommGetEntry_Object((1,3,6,1,4,1,171,10,75,4,1,2,1))
...
commGetIndex=_CommGetIndex_Object((1,3,6,1,4,1,171,10,75,4,1,2,1,1),_CommGetIndex_Type())
...
commGetName=_CommGetName_Object((1,3,6,1,4,1,171,10,75,4,1,2,1,2),_CommGetName_Type())
...
commGetStatus=_CommGetStatus_Object((1,3,6,1,4,1,171,10,75,4,1,2,1,3),_CommGetStatus_Type())
commGetStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:commGetStatus.setStatus(_A)
_CommTrapTable_Object=MibTable
commTrapTable=_CommTrapTable_Object((1,3,6,1,4,1,171,10,75,4,1,3))
if mibBuilder.loadTexts:commTrapTable.setStatus(_A)
_CommTrapEntry_Object=MibTableRow
commTrapEntry=_CommTrapEntry_Object((1,3,6,1,4,1,171,10,75,4,1,3,1))
...
commTrapIndex=_CommTrapIndex_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,1),_CommTrapIndex_Type())
...
commTrapName=_CommTrapName_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,2),_CommTrapName_Type())
...
commTrapIpAddress=_CommTrapIpAddress_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,3),_CommTrapIpAddress_Type())
...
commTrapSNMPBootup=_CommTrapSNMPBootup_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,5),_CommTrapSNMPBootup_Type())
...
commTrapSNMPTPLinkUpDown=_CommTrapSNMPTPLinkUpDown_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,6),_CommTrapSNMPTPLinkUpDown_Type())
...
commTrapSNMPFiberLinkUpDown=_CommTrapSNMPFiberLinkUpDown_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,7),_CommTrapSNMPFiberLinkUpDown_Type())
...
commTrapTrapAbnormalTPRXError=_CommTrapTrapAbnormalTPRXError_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,9),_CommTrapTrapAbnormalTPRXError_Type())
...
commTrapTrapAbnormalTPTXError=_CommTrapTrapAbnormalTPTXError_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,10),_CommTrapTrapAbnormalTPTXError_Type())
...
commTrapTrapAbnormalFiberRXError=_CommTrapTrapAbnormalFiberRXError_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,11),_CommTrapTrapAbnormalFiberRXError_Type())
...
commTrapTrapAbnormalFiberTXError=_CommTrapTrapAbnormalFiberTXError_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,12),_CommTrapTrapAbnormalFiberTXError_Type())
...
commTrapStatus=_CommTrapStatus_Object((1,3,6,1,4,1,171,10,75,4,1,3,1,13),_CommTrapStatus_Type())
...
companyMiscGroup=_CompanyMiscGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,3))
...
miscReset=_MiscReset_Object((1,3,6,1,4,1,171,10,75,4,3,2),_MiscReset_Type())
...
miscStatisticsReset=_MiscStatisticsReset_Object((1,3,6,1,4,1,171,10,75,4,3,3),_MiscStatisticsReset_Type())
...
companySpanGroup=_CompanySpanGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,4))
...
spanOnOff=_SpanOnOff_Object((1,3,6,1,4,1,171,10,75,4,4,1),_SpanOnOff_Type())
spanOnOff.setMaxAccess(_B)
if mibBuilder.loadTexts:spanOnOff.setStatus(_A)
_CompanyConfigGroup_ObjectIdentity=ObjectIdentity
companyConfigGroup=_CompanyConfigGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,11))
...
configVerSwPrimary=_ConfigVerSwPrimary_Object((1,3,6,1,4,1,171,10,75,4,11,1),_ConfigVerSwPrimary_Type())
...
configVerHwChipSet=_ConfigVerHwChipSet_Object((1,3,6,1,4,1,171,10,75,4,11,2),_ConfigVerHwChipSet_Type())
...
configBootTftpOperation=_ConfigBootTftpOperation_Object((1,3,6,1,4,1,171,10,75,4,11,3),_ConfigBootTftpOperation_Type())
...
configBootTftpServerIp=_ConfigBootTftpServerIp_Object((1,3,6,1,4,1,171,10,75,4,11,4),_ConfigBootTftpServerIp_Type())
...
configBootImageFileName=_ConfigBootImageFileName_Object((1,3,6,1,4,1,171,10,75,4,11,5),_ConfigBootImageFileName_Type())
...
configPortTable=_ConfigPortTable_Object((1,3,6,1,4,1,171,10,75,4,11,6))
if mibBuilder.loadTexts:configPortTable.setStatus(_A)
_ConfigPortEntry_Object=MibTableRow
configPortEntry=_ConfigPortEntry_Object((1,3,6,1,4,1,171,10,75,4,11,6,1))
...
configPort=_ConfigPort_Object((1,3,6,1,4,1,171,10,75,4,11,6,1,1),_ConfigPort_Type())
...
configPortSpeed=_ConfigPortSpeed_Object((1,3,6,1,4,1,171,10,75,4,11,6,1,2),_ConfigPortSpeed_Type())
...
configPortOperStatus=_ConfigPortOperStatus_Object((1,3,6,1,4,1,171,10,75,4,11,6,1,3),_ConfigPortOperStatus_Type())
...
configPortPriority=_ConfigPortPriority_Object((1,3,6,1,4,1,171,10,75,4,11,6,1,6),_ConfigPortPriority_Type())
...
configVLANMode=_ConfigVLANMode_Object((1,3,6,1,4,1,171,10,75,4,11,7),_ConfigVLANMode_Type())
configVLANMode.setMaxAccess(_B)
if mibBuilder.loadTexts:configVLANMode.setStatus(_A)
_ConfigMirrorTable_Object=MibTable
configMirrorTable=_ConfigMirrorTable_Object((1,3,6,1,4,1,171,10,75,4,11,8))
if mibBuilder.loadTexts:configMirrorTable.setStatus(_A)
_ConfigMirrorEntry_Object=MibTableRow
configMirrorEntry=_ConfigMirrorEntry_Object((1,3,6,1,4,1,171,10,75,4,11,8,1))
...
configMirrorId=_ConfigMirrorId_Object((1,3,6,1,4,1,171,10,75,4,11,8,1,1),_ConfigMirrorId_Type())
...
configMirrorMon=_ConfigMirrorMon_Object((1,3,6,1,4,1,171,10,75,4,11,8,1,2),_ConfigMirrorMon_Type())
...
configMirrorTXSrc=_ConfigMirrorTXSrc_Object((1,3,6,1,4,1,171,10,75,4,11,8,1,3),_ConfigMirrorTXSrc_Type())
...
configMirrorRXSrc=_ConfigMirrorRXSrc_Object((1,3,6,1,4,1,171,10,75,4,11,8,1,4),_ConfigMirrorRXSrc_Type())
...
configMirrorStatus=_ConfigMirrorStatus_Object((1,3,6,1,4,1,171,10,75,4,11,8,1,5),_ConfigMirrorStatus_Type())
...
configSNMPEnable=_ConfigSNMPEnable_Object((1,3,6,1,4,1,171,10,75,4,11,9),_ConfigSNMPEnable_Type())
...
configIpAssignmentMode=_ConfigIpAssignmentMode_Object((1,3,6,1,4,1,171,10,75,4,11,12),_ConfigIpAssignmentMode_Type())
...
configPhysAddress=_ConfigPhysAddress_Object((1,3,6,1,4,1,171,10,75,4,11,13),_ConfigPhysAddress_Type())
...
configPasswordAdmin=_ConfigPasswordAdmin_Object((1,3,6,1,4,1,171,10,75,4,11,15),_ConfigPasswordAdmin_Type())
...
configIpAddress=_ConfigIpAddress_Object((1,3,6,1,4,1,171,10,75,4,11,16),_ConfigIpAddress_Type())
...
configNetMask=_ConfigNetMask_Object((1,3,6,1,4,1,171,10,75,4,11,17),_ConfigNetMask_Type())
...
configGateway=_ConfigGateway_Object((1,3,6,1,4,1,171,10,75,4,11,18),_ConfigGateway_Type())
...
configSave=_ConfigSave_Object((1,3,6,1,4,1,171,10,75,4,11,19),_ConfigSave_Type())
...
configRestoreDefaults=_ConfigRestoreDefaults_Object((1,3,6,1,4,1,171,10,75,4,11,22),_ConfigRestoreDefaults_Type())
...
configTftpServerIpAddress=_ConfigTftpServerIpAddress_Object((1,3,6,1,4,1,171,10,75,4,11,32),_ConfigTftpServerIpAddress_Type())
...
configTftpServerFileName=_ConfigTftpServerFileName_Object((1,3,6,1,4,1,171,10,75,4,11,33),_ConfigTftpServerFileName_Type())
...
configTftpOperation=_ConfigTftpOperation_Object((1,3,6,1,4,1,171,10,75,4,11,34),_ConfigTftpOperation_Type())
...
configSafeguardEnable=_ConfigSafeguardEnable_Object((1,3,6,1,4,1,171,10,75,4,11,44),_ConfigSafeguardEnable_Type())
...
companyTVlanGroup=_CompanyTVlanGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,13))
_TvlanTable_Object=MibTable
tvlanTable=_TvlanTable_Object((1,3,6,1,4,1,171,10,75,4,13,1))
if mibBuilder.loadTexts:tvlanTable.setStatus(_A)
_TvlanEntry_Object=MibTableRow
tvlanEntry=_TvlanEntry_Object((1,3,6,1,4,1,171,10,75,4,13,1,1))
...
tvlanId=_TvlanId_Object((1,3,6,1,4,1,171,10,75,4,13,1,1,1),_TvlanId_Type())
...
tvlanName=_TvlanName_Object((1,3,6,1,4,1,171,10,75,4,13,1,1,2),_TvlanName_Type())
...
tvlanMember=_TvlanMember_Object((1,3,6,1,4,1,171,10,75,4,13,1,1,3),_TvlanMember_Type())
...
tvlanUntaggedPorts=_TvlanUntaggedPorts_Object((1,3,6,1,4,1,171,10,75,4,13,1,1,4),_TvlanUntaggedPorts_Type())
...
tvlanStatus=_TvlanStatus_Object((1,3,6,1,4,1,171,10,75,4,13,1,1,5),_TvlanStatus_Type())
...
tvlanManagementOnOff=_TvlanManagementOnOff_Object((1,3,6,1,4,1,171,10,75,4,13,2),_TvlanManagementOnOff_Type())
...
tvlanManagementid=_TvlanManagementid_Object((1,3,6,1,4,1,171,10,75,4,13,3),_TvlanManagementid_Type())
tvlanManagementid.setMaxAccess(_B)
if mibBuilder.loadTexts:tvlanManagementid.setStatus(_A)
_TvlanPortTable_Object=MibTable
tvlanPortTable=_TvlanPortTable_Object((1,3,6,1,4,1,171,10,75,4,13,4))
if mibBuilder.loadTexts:tvlanPortTable.setStatus(_A)
_TvlanPortEntry_Object=MibTableRow
tvlanPortEntry=_TvlanPortEntry_Object((1,3,6,1,4,1,171,10,75,4,13,4,1))
...
tvlanPortPortId=_TvlanPortPortId_Object((1,3,6,1,4,1,171,10,75,4,13,4,1,1),_TvlanPortPortId_Type())
...
tvlanPortVlanId=_TvlanPortVlanId_Object((1,3,6,1,4,1,171,10,75,4,13,4,1,2),_TvlanPortVlanId_Type())
...
tvlanAsyOnOff=_TvlanAsyOnOff_Object((1,3,6,1,4,1,171,10,75,4,13,5),_TvlanAsyOnOff_Type())
...
companyPortTrunkGroup=_CompanyPortTrunkGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,14))
_PortTrunkTable_Object=MibTable
portTrunkTable=_PortTrunkTable_Object((1,3,6,1,4,1,171,10,75,4,14,1))
if mibBuilder.loadTexts:portTrunkTable.setStatus(_A)
_PortTrunkEntry_Object=MibTableRow
portTrunkEntry=_PortTrunkEntry_Object((1,3,6,1,4,1,171,10,75,4,14,1,1))
...
portTrunkId=_PortTrunkId_Object((1,3,6,1,4,1,171,10,75,4,14,1,1,1),_PortTrunkId_Type())
...
portTrunkName=_PortTrunkName_Object((1,3,6,1,4,1,171,10,75,4,14,1,1,2),_PortTrunkName_Type())
...
portTrunkMember=_PortTrunkMember_Object((1,3,6,1,4,1,171,10,75,4,14,1,1,3),_PortTrunkMember_Type())
...
companyStaticGroup=_CompanyStaticGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,21))
...
staticOnOff=_StaticOnOff_Object((1,3,6,1,4,1,171,10,75,4,21,1),_StaticOnOff_Type())
...
staticAutoLearning=_StaticAutoLearning_Object((1,3,6,1,4,1,171,10,75,4,21,2),_StaticAutoLearning_Type())
staticAutoLearning.setMaxAccess(_B)
if mibBuilder.loadTexts:staticAutoLearning.setStatus(_A)
_StaticTable_Object=MibTable
staticTable=_StaticTable_Object((1,3,6,1,4,1,171,10,75,4,21,3))
if mibBuilder.loadTexts:staticTable.setStatus(_A)
_StaticEntry_Object=MibTableRow
staticEntry=_StaticEntry_Object((1,3,6,1,4,1,171,10,75,4,21,3,1))
...
staticId=_StaticId_Object((1,3,6,1,4,1,171,10,75,4,21,3,1,1),_StaticId_Type())
...
staticMac=_StaticMac_Object((1,3,6,1,4,1,171,10,75,4,21,3,1,2),_StaticMac_Type())
...
staticPort=_StaticPort_Object((1,3,6,1,4,1,171,10,75,4,21,3,1,3),_StaticPort_Type())
...
staticVlanID=_StaticVlanID_Object((1,3,6,1,4,1,171,10,75,4,21,3,1,4),_StaticVlanID_Type())
...
staticStatus=_StaticStatus_Object((1,3,6,1,4,1,171,10,75,4,21,3,1,5),_StaticStatus_Type())
...
companyIgsGroup=_CompanyIgsGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,22))
_IgsSystem_ObjectIdentity=ObjectIdentity
igsSystem=_IgsSystem_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,22,1))
...
igsStatus=_IgsStatus_Object((1,3,6,1,4,1,171,10,75,4,22,1,2),_IgsStatus_Type())
...
igsv3Processing=_Igsv3Processing_Object((1,3,6,1,4,1,171,10,75,4,22,1,3),_Igsv3Processing_Type())
...
igsRouterPortPurgeInterval=_IgsRouterPortPurgeInterval_Object((1,3,6,1,4,1,171,10,75,4,22,1,4),_IgsRouterPortPurgeInterval_Type())
...
igsHostPortPurgeInterval=_IgsHostPortPurgeInterval_Object((1,3,6,1,4,1,171,10,75,4,22,1,5),_IgsHostPortPurgeInterval_Type())
...
igsReportForwardInterval=_IgsReportForwardInterval_Object((1,3,6,1,4,1,171,10,75,4,22,1,6),_IgsReportForwardInterval_Type())
...
igsLeaveProcessInterval=_IgsLeaveProcessInterval_Object((1,3,6,1,4,1,171,10,75,4,22,1,7),_IgsLeaveProcessInterval_Type())
...
igsMcastEntryAgeingInterval=_IgsMcastEntryAgeingInterval_Object((1,3,6,1,4,1,171,10,75,4,22,1,8),_IgsMcastEntryAgeingInterval_Type())
...
igsSharedSegmentAggregationInterval=_IgsSharedSegmentAggregationInterval_Object((1,3,6,1,4,1,171,10,75,4,22,1,9),_IgsSharedSegmentAggregationInterval_Type())
...
igsGblReportFwdOnAllPorts=_IgsGblReportFwdOnAllPorts_Object((1,3,6,1,4,1,171,10,75,4,22,1,10),_IgsGblReportFwdOnAllPorts_Type())
...
igsNextMcastFwdMode=_IgsNextMcastFwdMode_Object((1,3,6,1,4,1,171,10,75,4,22,1,13),_IgsNextMcastFwdMode_Type())
...
igsQueryInterval=_IgsQueryInterval_Object((1,3,6,1,4,1,171,10,75,4,22,1,14),_IgsQueryInterval_Type())
...
igsQueryMaxResponseTime=_IgsQueryMaxResponseTime_Object((1,3,6,1,4,1,171,10,75,4,22,1,15),_IgsQueryMaxResponseTime_Type())
...
igsRobustnessValue=_IgsRobustnessValue_Object((1,3,6,1,4,1,171,10,75,4,22,1,16),_IgsRobustnessValue_Type())
...
igsLastMembQueryInterval=_IgsLastMembQueryInterval_Object((1,3,6,1,4,1,171,10,75,4,22,1,17),_IgsLastMembQueryInterval_Type())
...
igsQuerierStateOnOff=_IgsQuerierStateOnOff_Object((1,3,6,1,4,1,171,10,75,4,22,1,18),_IgsQuerierStateOnOff_Type())
...
igsVlan=_IgsVlan_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,22,3))
_IgsVlanMcastFwdTable_Object=MibTable
igsVlanMcastFwdTable=_IgsVlanMcastFwdTable_Object((1,3,6,1,4,1,171,10,75,4,22,3,1))
if mibBuilder.loadTexts:igsVlanMcastFwdTable.setStatus(_A)
_IgsVlanMcastFwdEntry_Object=MibTableRow
igsVlanMcastFwdEntry=_IgsVlanMcastFwdEntry_Object((1,3,6,1,4,1,171,10,75,4,22,3,1,1))
...
igsVlanMcastFwdVlanIdMac=_IgsVlanMcastFwdVlanIdMac_Object((1,3,6,1,4,1,171,10,75,4,22,3,1,1,1),_IgsVlanMcastFwdVlanIdMac_Type())
...
igsVlanMcastFwdGroupAddress=_IgsVlanMcastFwdGroupAddress_Object((1,3,6,1,4,1,171,10,75,4,22,3,1,1,2),_IgsVlanMcastFwdGroupAddress_Type())
...
igsVlanMcastFwdPortListMac=_IgsVlanMcastFwdPortListMac_Object((1,3,6,1,4,1,171,10,75,4,22,3,1,1,3),_IgsVlanMcastFwdPortListMac_Type())
...
igsVlanRouterPortListTable=_IgsVlanRouterPortListTable_Object((1,3,6,1,4,1,171,10,75,4,22,3,3))
if mibBuilder.loadTexts:igsVlanRouterPortListTable.setStatus(_A)
_IgsVlanRouterPortListEntry_Object=MibTableRow
igsVlanRouterPortListEntry=_IgsVlanRouterPortListEntry_Object((1,3,6,1,4,1,171,10,75,4,22,3,3,1))
...
igsVlanRouterPortListVlanId=_IgsVlanRouterPortListVlanId_Object((1,3,6,1,4,1,171,10,75,4,22,3,3,1,1),_IgsVlanRouterPortListVlanId_Type())
...
igsVlanRouterPortList=_IgsVlanRouterPortList_Object((1,3,6,1,4,1,171,10,75,4,22,3,3,1,2),_IgsVlanRouterPortList_Type())
...
igsVlanFilterTable=_IgsVlanFilterTable_Object((1,3,6,1,4,1,171,10,75,4,22,3,4))
if mibBuilder.loadTexts:igsVlanFilterTable.setStatus(_A)
_IgsVlanFilterEntry_Object=MibTableRow
igsVlanFilterEntry=_IgsVlanFilterEntry_Object((1,3,6,1,4,1,171,10,75,4,22,3,4,1))
...
igsVlanId=_IgsVlanId_Object((1,3,6,1,4,1,171,10,75,4,22,3,4,1,1),_IgsVlanId_Type())
...
igsVlanFilterStatus=_IgsVlanFilterStatus_Object((1,3,6,1,4,1,171,10,75,4,22,3,4,1,2),_IgsVlanFilterStatus_Type())
...
companyDot1xGroup=_CompanyDot1xGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,23))
_Radius_ObjectIdentity=ObjectIdentity
radius=_Radius_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,23,1))
_RadiusServerAddress_Type=IpAddress
_RadiusServerAddress_Object=MibScalar
radiusServerAddress=_RadiusServerAddress_Object((1,3,6,1,4,1,171,10,75,4,23,1,1),_RadiusServerAddress_Type())
...
radiusServerPort=_RadiusServerPort_Object((1,3,6,1,4,1,171,10,75,4,23,1,2),_RadiusServerPort_Type())
...
radiusServerSharedSecret=_RadiusServerSharedSecret_Object((1,3,6,1,4,1,171,10,75,4,23,1,3),_RadiusServerSharedSecret_Type())
...
dot1xAuth=_Dot1xAuth_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,23,2))
...
dot1xAuthSystemControl=_Dot1xAuthSystemControl_Object((1,3,6,1,4,1,171,10,75,4,23,2,1),_Dot1xAuthSystemControl_Type())
...
dot1xAuthQuietPeriod=_Dot1xAuthQuietPeriod_Object((1,3,6,1,4,1,171,10,75,4,23,2,2),_Dot1xAuthQuietPeriod_Type())
...
dot1xAuthTxPeriod=_Dot1xAuthTxPeriod_Object((1,3,6,1,4,1,171,10,75,4,23,2,3),_Dot1xAuthTxPeriod_Type())
...
dot1xAuthSuppTimeout=_Dot1xAuthSuppTimeout_Object((1,3,6,1,4,1,171,10,75,4,23,2,4),_Dot1xAuthSuppTimeout_Type())
...
dot1xAuthServerTimeout=_Dot1xAuthServerTimeout_Object((1,3,6,1,4,1,171,10,75,4,23,2,5),_Dot1xAuthServerTimeout_Type())
...
dot1xAuthMaxReq=_Dot1xAuthMaxReq_Object((1,3,6,1,4,1,171,10,75,4,23,2,6),_Dot1xAuthMaxReq_Type())
...
dot1xAuthReAuthPeriod=_Dot1xAuthReAuthPeriod_Object((1,3,6,1,4,1,171,10,75,4,23,2,7),_Dot1xAuthReAuthPeriod_Type())
...
dot1xAuthReAuthEnabled=_Dot1xAuthReAuthEnabled_Object((1,3,6,1,4,1,171,10,75,4,23,2,8),_Dot1xAuthReAuthEnabled_Type())
...
dot1xAuthConfigPortTable=_Dot1xAuthConfigPortTable_Object((1,3,6,1,4,1,171,10,75,4,23,2,9))
if mibBuilder.loadTexts:dot1xAuthConfigPortTable.setStatus(_A)
_Dot1xAuthConfigPortEntry_Object=MibTableRow
dot1xAuthConfigPortEntry=_Dot1xAuthConfigPortEntry_Object((1,3,6,1,4,1,171,10,75,4,23,2,9,1))
...
dot1xAuthConfigPortNumber=_Dot1xAuthConfigPortNumber_Object((1,3,6,1,4,1,171,10,75,4,23,2,9,1,1),_Dot1xAuthConfigPortNumber_Type())
...
dot1xAuthConfigPortControl=_Dot1xAuthConfigPortControl_Object((1,3,6,1,4,1,171,10,75,4,23,2,9,1,2),_Dot1xAuthConfigPortControl_Type())
...
dot1xAuthConfigPortStatus=_Dot1xAuthConfigPortStatus_Object((1,3,6,1,4,1,171,10,75,4,23,2,9,1,3),_Dot1xAuthConfigPortStatus_Type())
...
dot1xAuthConfigPortSessionTime=_Dot1xAuthConfigPortSessionTime_Object((1,3,6,1,4,1,171,10,75,4,23,2,9,1,4),_Dot1xAuthConfigPortSessionTime_Type())
...
dot1xAuthConfigPortSessionUserName=_Dot1xAuthConfigPortSessionUserName_Object((1,3,6,1,4,1,171,10,75,4,23,2,9,1,5),_Dot1xAuthConfigPortSessionUserName_Type())
...
companyQoSGroup=_CompanyQoSGroup_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,26))
...
qosMode=_QosMode_Object((1,3,6,1,4,1,171,10,75,4,26,1),_QosMode_Type())
...
queuingMechanism=_QueuingMechanism_Object((1,3,6,1,4,1,171,10,75,4,26,2),_QueuingMechanism_Type())
queuingMechanism.setMaxAccess(_B)
if mibBuilder.loadTexts:queuingMechanism.setStatus(_A)
_Dot1pPortTable_Object=MibTable
dot1pPortTable=_Dot1pPortTable_Object((1,3,6,1,4,1,171,10,75,4,26,3))
if mibBuilder.loadTexts:dot1pPortTable.setStatus(_A)
_Dot1pPortEntry_Object=MibTableRow
dot1pPortEntry=_Dot1pPortEntry_Object((1,3,6,1,4,1,171,10,75,4,26,3,1))
...
dot1pPortIndex=_Dot1pPortIndex_Object((1,3,6,1,4,1,171,10,75,4,26,3,1,1),_Dot1pPortIndex_Type())
...
dot1pPortPriority=_Dot1pPortPriority_Object((1,3,6,1,4,1,171,10,75,4,26,3,1,2),_Dot1pPortPriority_Type())
dot1pPortPriority.setMaxAccess(_B)
if mibBuilder.loadTexts:dot1pPortPriority.setStatus(_A)
_DscpTable_Object=MibTable
dscpTable=_DscpTable_Object((1,3,6,1,4,1,171,10,75,4,26,4))
if mibBuilder.loadTexts:dscpTable.setStatus(_A)
_DscpEntry_Object=MibTableRow
dscpEntry=_DscpEntry_Object((1,3,6,1,4,1,171,10,75,4,26,4,1))
...
dscpIndex=_DscpIndex_Object((1,3,6,1,4,1,171,10,75,4,26,4,1,1),_DscpIndex_Type())
...
dscpPriority=_DscpPriority_Object((1,3,6,1,4,1,171,10,75,4,26,4,1,2),_DscpPriority_Type())
...
companyTrafficMgmt=_CompanyTrafficMgmt_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,27))
_BroadcastStormCtrlSettings_ObjectIdentity=ObjectIdentity
broadcastStormCtrlSettings=_BroadcastStormCtrlSettings_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,27,3))
...
broadcastStormCtrlGlobalOnOff=_BroadcastStormCtrlGlobalOnOff_Object((1,3,6,1,4,1,171,10,75,4,27,3,1),_BroadcastStormCtrlGlobalOnOff_Type())
...
broadcastStormGlobalThreshold=_BroadcastStormGlobalThreshold_Object((1,3,6,1,4,1,171,10,75,4,27,3,2),_BroadcastStormGlobalThreshold_Type())
...
companySecurity=_CompanySecurity_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,28))
_TrustedHostSettings_ObjectIdentity=ObjectIdentity
trustedHostSettings=_TrustedHostSettings_ObjectIdentity((1,3,6,1,4,1,171,10,75,4,28,1))
...
trustedHostOnOff=_TrustedHostOnOff_Object((1,3,6,1,4,1,171,10,75,4,28,1,1),_TrustedHostOnOff_Type())
trustedHostOnOff.setMaxAccess(_B)
if mibBuilder.loadTexts:trustedHostOnOff.setStatus(_A)
_TrustedHostTable_Object=MibTable
trustedHostTable=_TrustedHostTable_Object((1,3,6,1,4,1,171,10,75,4,28,1,2))
if mibBuilder.loadTexts:trustedHostTable.setStatus(_A)
_TrustedHostEntry_Object=MibTableRow
trustedHostEntry=_TrustedHostEntry_Object((1,3,6,1,4,1,171,10,75,4,28,1,2,1))
...
trustedHostID=_TrustedHostID_Object((1,3,6,1,4,1,171,10,75,4,28,1,2,1,1),_TrustedHostID_Type())
...
trustedHostIpAddress=_TrustedHostIpAddress_Object((1,3,6,1,4,1,171,10,75,4,28,1,2,1,2),_TrustedHostIpAddress_Type())
...
trustedHostIpMask=_TrustedHostIpMask_Object((1,3,6,1,4,1,171,10,75,4,28,1,2,1,3),_TrustedHostIpMask_Type())
...
trustedHostStatus=_TrustedHostStatus_Object((1,3,6,1,4,1,171,10,75,4,28,1,2,1,4),_TrustedHostStatus_Type())
