...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-TELEPRESENCE-MIB
...
mibBuilder.exportSymbols("CISCO-TELEPRESENCE-MIB", ctpSysUserAuthFailSourceAddrType=ctpSysUserAuthFailSourceAddrType, CtpPeripheralStatusCode=CtpPeripheralStatusCode, ciscoTpPeripheralStatusGroupR02=ciscoTpPeripheralStatusGroupR02, ctpVlanId=ctpVlanId, ctpPeripheralErrorHistoryIndex=ctpPeripheralErrorHistoryIndex, ctpSystemReset=ctpSystemReset, ctpSysUserAuthFailHistTableSize=ctpSysUserAuthFailHistTableSize, ctp802dot11PeripheralIndex=ctp802dot11PeripheralIndex, ctpSysUserAuthFailUserName=ctpSysUserAuthFailUserName, ctpPeripheralDescription=ctpPeripheralDescription, ctp802dot11PeripheralLinkStatus=ctp802dot11PeripheralLinkStatus, CtpSystemAccessProtocol=CtpSystemAccessProtocol, ciscoTelepresenceMIB=ciscoTelepresenceMIB, ctpPeripheralErrorDeviceCategory=ctpPeripheralErrorDeviceCategory, ctpEtherPeripheralStatusEntry=ctpEtherPeripheralStatusEntry, ciscoTelepresenceCompliance=ciscoTelepresenceCompliance, ciscoTpPeripheralAttributeGroup=ciscoTpPeripheralAttributeGroup, ctpDVIPeripheralStatusEntry=ctpDVIPeripheralStatusEntry, ctpPeripheralErrorStatus=ctpPeripheralErrorStatus, ciscoTpConfigurationGroupR02=ciscoTpConfigurationGroupR02, PYSNMP_MODULE_ID=ciscoTelepresenceMIB, ctpHDMIPeripheralIndex=ctpHDMIPeripheralIndex, ctp802dot11PeripheralStatusEntry=ctp802dot11PeripheralStatusEntry, ctpDVIPeripheralCableStatus=ctpDVIPeripheralCableStatus, ctpSysUserAuthFailHistLastIndex=ctpSysUserAuthFailHistLastIndex, ctpDPPeripheralIndex=ctpDPPeripheralIndex, ctpUSBPeripheralStatusEntry=ctpUSBPeripheralStatusEntry, ciscoTpRS232PeripheralStatusGroup=ciscoTpRS232PeripheralStatusGroup, ctpSysUserAuthFailNotifyEnable=ctpSysUserAuthFailNotifyEnable, CtpPeripheralPowerCode=CtpPeripheralPowerCode, ctpPeripheralAttributeDescr=ctpPeripheralAttributeDescr, ctpDPPeripheralCableStatus=ctpDPPeripheralCableStatus, ctpSysUserAuthFailSourcePort=ctpSysUserAuthFailSourcePort, ciscoTpConfigurationGroupR01=ciscoTpConfigurationGroupR01, ctpSysUserAuthFailTimeStamp=ctpSysUserAuthFailTimeStamp, CtpPeripheralCableCode=CtpPeripheralCableCode, ctpPeripheralErrorHistLastIndex=ctpPeripheralErrorHistLastIndex, ctpDPPeripheralPowerStatus=ctpDPPeripheralPowerStatus, ctpPeripheralErrorNotification=ctpPeripheralErrorNotification, ctpHDMIPeripheralCableStatus=ctpHDMIPeripheralCableStatus, ctp802dot11PeripheralStatusTable=ctp802dot11PeripheralStatusTable, ctpRS232PeripheralStatusEntry=ctpRS232PeripheralStatusEntry, ciscoTpNotificationGroupR01=ciscoTpNotificationGroupR01, ciscoTelepresenceMIBNotifs=ciscoTelepresenceMIBNotifs, ctpPeripheralAttributeValue=ctpPeripheralAttributeValue, ctpPeripheralErrorHistoryEntry=ctpPeripheralErrorHistoryEntry, ctpDPPeripheralStatusTable=ctpDPPeripheralStatusTable, ctpDefaultGatewayAddrType=ctpDefaultGatewayAddrType, ctpSysUserAuthFailAccessProtocol=ctpSysUserAuthFailAccessProtocol, ctpPeripheralAttributeTable=ctpPeripheralAttributeTable, ctpUSBPeripheralIndex=ctpUSBPeripheralIndex, ctpSysUserAuthFailHistoryEntry=ctpSysUserAuthFailHistoryEntry, ciscoTpPeripheralStatusGroup=ciscoTpPeripheralStatusGroup, ctpSysUserAuthFailHistoryTable=ctpSysUserAuthFailHistoryTable, ciscoTelepresenceComplianceR05=ciscoTelepresenceComplianceR05, ctpRS232PeripheralIndex=ctpRS232PeripheralIndex, ctp802dot11PeripheralAddr=ctp802dot11PeripheralAddr, ciscoTelepresenceMIBObjects=ciscoTelepresenceMIBObjects, ctpPeripheralErrorHistoryTable=ctpPeripheralErrorHistoryTable, ctpPeripheralErrorHistTableSize=ctpPeripheralErrorHistTableSize, ciscoTelepresenceComplianceR02=ciscoTelepresenceComplianceR02, ctpPeripheralErrorDeviceNumber=ctpPeripheralErrorDeviceNumber, ctpSysUserAuthFailHistoryIndex=ctpSysUserAuthFailHistoryIndex, ciscoTelepresenceMIBConform=ciscoTelepresenceMIBConform, ctpUSBPeripheralPowerStatus=ctpUSBPeripheralPowerStatus, ctpRS232PeripheralConnStatus=ctpRS232PeripheralConnStatus, ctpUSBPeripheralCableStatus=ctpUSBPeripheralCableStatus, ctpEtherPeripheralAddrType=ctpEtherPeripheralAddrType, ctpPeripheralStatusObjects=ctpPeripheralStatusObjects, ctpEtherPeripheralStatusTable=ctpEtherPeripheralStatusTable, ciscoTpEventHistoryGroupR01=ciscoTpEventHistoryGroupR01, ctpPeripheralDeviceNumber=ctpPeripheralDeviceNumber, ciscoTelepresenceMIBGroups=ciscoTelepresenceMIBGroups, ctpDefaultGateway=ctpDefaultGateway, ctpEtherPeripheralIfIndex=ctpEtherPeripheralIfIndex, ciscoTpDPPeripheralStatusGroup=ciscoTpDPPeripheralStatusGroup, ciscoTelepresenceComplianceR03=ciscoTelepresenceComplianceR03, ctpPeripheralAttributeEntry=ctpPeripheralAttributeEntry, ctpPeripheralErrorIndex=ctpPeripheralErrorIndex, ctpHDMIPeripheralStatusTable=ctpHDMIPeripheralStatusTable, ciscoTelepresenceCompliances=ciscoTelepresenceCompliances, ctpPeripheralStatusTable=ctpPeripheralStatusTable, ciscoTpConfigurationGroup=ciscoTpConfigurationGroup, ctpHDMIPeripheralStatusEntry=ctpHDMIPeripheralStatusEntry, CtpPeripheralDeviceCategoryCode=CtpPeripheralDeviceCategoryCode, ciscoTpPeripheralStatusGroupR01=ciscoTpPeripheralStatusGroupR01, ctpPeripheralErrorTimeStamp=ctpPeripheralErrorTimeStamp, ctpEtherPeripheralStatus=ctpEtherPeripheralStatus, ctpDPPeripheralStatusEntry=ctpDPPeripheralStatusEntry, ctpSysUserAuthFailNotification=ctpSysUserAuthFailNotification, ctpPeripheralDeviceCategory=ctpPeripheralDeviceCategory, ctp802dot11PeripheralIfIndex=ctp802dot11PeripheralIfIndex, ctpDVIPeripheralStatusTable=ctpDVIPeripheralStatusTable, ctpDVIPeripheralIndex=ctpDVIPeripheralIndex, ctp802dot11PeripheralAddrType=ctp802dot11PeripheralAddrType, ctpEtherPeripheralIndex=ctpEtherPeripheralIndex, ctpSysUserAuthFailSourceAddr=ctpSysUserAuthFailSourceAddr, ciscoTelepresenceComplianceR01=ciscoTelepresenceComplianceR01, ctpUSBPeripheralPortType=ctpUSBPeripheralPortType, ciscoTpNotificationGroup=ciscoTpNotificationGroup, CtpSystemResetMode=CtpSystemResetMode, ctpUSBPeripheralPortRate=ctpUSBPeripheralPortRate, ctpObjects=ctpObjects, ctpPeripheralIndex=ctpPeripheralIndex, ctpPeriStatusChangeNotification=ctpPeriStatusChangeNotification, ciscoTelepresenceComplianceR04=ciscoTelepresenceComplianceR04, ciscoTpEventHistoryGroup=ciscoTpEventHistoryGroup, ctpEventHistory=ctpEventHistory, ctp802dot11PeripheralLinkStrength=ctp802dot11PeripheralLinkStrength, ctpPeripheralStatusEntry=ctpPeripheralStatusEntry, ctpPeripheralAttributeIndex=ctpPeripheralAttributeIndex, ctpEtherPeripheralAddr=ctpEtherPeripheralAddr, ctpRS232PeripheralStatusTable=ctpRS232PeripheralStatusTable, ctpPeripheralErrorNotifyEnable=ctpPeripheralErrorNotifyEnable, ctpUSBPeripheralStatusTable=ctpUSBPeripheralStatusTable, ctpRS232PortIndex=ctpRS232PortIndex, ctpPeripheralStatus=ctpPeripheralStatus, ctpPeriStatusChangeNotifyEnable=ctpPeriStatusChangeNotifyEnable, ctpHDMIPeripheralPowerStatus=ctpHDMIPeripheralPowerStatus)
