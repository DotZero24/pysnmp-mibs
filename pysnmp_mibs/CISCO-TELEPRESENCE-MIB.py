...
mibBuilder.exportSymbols("CISCO-TELEPRESENCE-MIB", ctpEtherPeripheralIfIndex=ctpEtherPeripheralIfIndex, ctpPeripheralErrorNotifyEnable=ctpPeripheralErrorNotifyEnable, ctpEtherPeripheralAddr=ctpEtherPeripheralAddr, ctpRS232PeripheralIndex=ctpRS232PeripheralIndex, ctpEtherPeripheralStatusTable=ctpEtherPeripheralStatusTable, PYSNMP_MODULE_ID=ciscoTelepresenceMIB, ctpSysUserAuthFailHistoryIndex=ctpSysUserAuthFailHistoryIndex, ctpPeripheralStatusEntry=ctpPeripheralStatusEntry, ctpPeripheralStatusTable=ctpPeripheralStatusTable, ctpDPPeripheralIndex=ctpDPPeripheralIndex, ctpRS232PeripheralStatusEntry=ctpRS232PeripheralStatusEntry, ctpPeripheralErrorHistTableSize=ctpPeripheralErrorHistTableSize, ctpPeripheralDescription=ctpPeripheralDescription, ctpPeripheralAttributeTable=ctpPeripheralAttributeTable, ctpSysUserAuthFailHistLastIndex=ctpSysUserAuthFailHistLastIndex, ciscoTpNotificationGroup=ciscoTpNotificationGroup, ctp802dot11PeripheralStatusEntry=ctp802dot11PeripheralStatusEntry, ctpEtherPeripheralStatus=ctpEtherPeripheralStatus, ctpDefaultGatewayAddrType=ctpDefaultGatewayAddrType, ctpUSBPeripheralStatusTable=ctpUSBPeripheralStatusTable, ctpDPPeripheralStatusEntry=ctpDPPeripheralStatusEntry, ctpSysUserAuthFailHistoryEntry=ctpSysUserAuthFailHistoryEntry, ctpRS232PeripheralStatusTable=ctpRS232PeripheralStatusTable, ctpDVIPeripheralStatusTable=ctpDVIPeripheralStatusTable, CtpPeripheralDeviceCategoryCode=CtpPeripheralDeviceCategoryCode, CtpSystemAccessProtocol=CtpSystemAccessProtocol, CtpSystemResetMode=CtpSystemResetMode, ciscoTelepresenceMIBNotifs=ciscoTelepresenceMIBNotifs, ctpPeripheralErrorStatus=ctpPeripheralErrorStatus, ciscoTelepresenceMIBConform=ciscoTelepresenceMIBConform, ctpSysUserAuthFailAccessProtocol=ctpSysUserAuthFailAccessProtocol, ctpPeripheralErrorTimeStamp=ctpPeripheralErrorTimeStamp, ctpSysUserAuthFailSourceAddr=ctpSysUserAuthFailSourceAddr, ciscoTpConfigurationGroupR02=ciscoTpConfigurationGroupR02, ctpEventHistory=ctpEventHistory, ciscoTelepresenceMIBObjects=ciscoTelepresenceMIBObjects, ctpPeripheralStatus=ctpPeripheralStatus, ctpPeripheralAttributeEntry=ctpPeripheralAttributeEntry, ctpPeripheralAttributeValue=ctpPeripheralAttributeValue, ctpPeriStatusChangeNotification=ctpPeriStatusChangeNotification, ctpUSBPeripheralIndex=ctpUSBPeripheralIndex, ctpSysUserAuthFailNotification=ctpSysUserAuthFailNotification, ciscoTelepresenceMIBGroups=ciscoTelepresenceMIBGroups, ciscoTelepresenceMIB=ciscoTelepresenceMIB, ciscoTelepresenceComplianceR04=ciscoTelepresenceComplianceR04, ctpUSBPeripheralStatusEntry=ctpUSBPeripheralStatusEntry, ctpUSBPeripheralCableStatus=ctpUSBPeripheralCableStatus, ctpHDMIPeripheralPowerStatus=ctpHDMIPeripheralPowerStatus, ctpPeripheralErrorHistoryIndex=ctpPeripheralErrorHistoryIndex, ctp802dot11PeripheralAddrType=ctp802dot11PeripheralAddrType, ctpPeripheralErrorHistoryEntry=ctpPeripheralErrorHistoryEntry, ctpHDMIPeripheralIndex=ctpHDMIPeripheralIndex, ciscoTelepresenceComplianceR03=ciscoTelepresenceComplianceR03, ctpSystemReset=ctpSystemReset, ciscoTpPeripheralStatusGroupR01=ciscoTpPeripheralStatusGroupR01, ctpPeripheralIndex=ctpPeripheralIndex, ciscoTpPeripheralAttributeGroup=ciscoTpPeripheralAttributeGroup, ctpPeriStatusChangeNotifyEnable=ctpPeriStatusChangeNotifyEnable, ctpEtherPeripheralIndex=ctpEtherPeripheralIndex, ctpDPPeripheralStatusTable=ctpDPPeripheralStatusTable, ctpPeripheralErrorNotification=ctpPeripheralErrorNotification, CtpPeripheralPowerCode=CtpPeripheralPowerCode, ctpPeripheralDeviceNumber=ctpPeripheralDeviceNumber, ctpPeripheralErrorIndex=ctpPeripheralErrorIndex, ctpSysUserAuthFailUserName=ctpSysUserAuthFailUserName, ctpPeripheralErrorHistoryTable=ctpPeripheralErrorHistoryTable, ctpPeripheralErrorDeviceCategory=ctpPeripheralErrorDeviceCategory, ctpPeripheralErrorDeviceNumber=ctpPeripheralErrorDeviceNumber, ctp802dot11PeripheralIndex=ctp802dot11PeripheralIndex, ciscoTpPeripheralStatusGroupR02=ciscoTpPeripheralStatusGroupR02, ctpDefaultGateway=ctpDefaultGateway, ctpUSBPeripheralPortRate=ctpUSBPeripheralPortRate, ciscoTelepresenceCompliances=ciscoTelepresenceCompliances, ctpDVIPeripheralIndex=ctpDVIPeripheralIndex, ctp802dot11PeripheralLinkStatus=ctp802dot11PeripheralLinkStatus, ciscoTpRS232PeripheralStatusGroup=ciscoTpRS232PeripheralStatusGroup, ctpSysUserAuthFailHistTableSize=ctpSysUserAuthFailHistTableSize, ciscoTelepresenceCompliance=ciscoTelepresenceCompliance, ctpPeripheralAttributeDescr=ctpPeripheralAttributeDescr, ctpHDMIPeripheralCableStatus=ctpHDMIPeripheralCableStatus, ctpRS232PeripheralConnStatus=ctpRS232PeripheralConnStatus, ctpHDMIPeripheralStatusTable=ctpHDMIPeripheralStatusTable, ctpSysUserAuthFailTimeStamp=ctpSysUserAuthFailTimeStamp, ciscoTelepresenceComplianceR01=ciscoTelepresenceComplianceR01, ctpSysUserAuthFailHistoryTable=ctpSysUserAuthFailHistoryTable, ctpVlanId=ctpVlanId, ctpEtherPeripheralAddrType=ctpEtherPeripheralAddrType, ciscoTelepresenceComplianceR02=ciscoTelepresenceComplianceR02, ciscoTpConfigurationGroupR01=ciscoTpConfigurationGroupR01, ctpObjects=ctpObjects, ciscoTelepresenceComplianceR05=ciscoTelepresenceComplianceR05, ctpHDMIPeripheralStatusEntry=ctpHDMIPeripheralStatusEntry, ctpEtherPeripheralStatusEntry=ctpEtherPeripheralStatusEntry, ctpDVIPeripheralCableStatus=ctpDVIPeripheralCableStatus, ciscoTpConfigurationGroup=ciscoTpConfigurationGroup, ctpSysUserAuthFailNotifyEnable=ctpSysUserAuthFailNotifyEnable, ctp802dot11PeripheralLinkStrength=ctp802dot11PeripheralLinkStrength, ctpPeripheralStatusObjects=ctpPeripheralStatusObjects, ciscoTpDPPeripheralStatusGroup=ciscoTpDPPeripheralStatusGroup, ctpDVIPeripheralStatusEntry=ctpDVIPeripheralStatusEntry, ctpSysUserAuthFailSourcePort=ctpSysUserAuthFailSourcePort, CtpPeripheralCableCode=CtpPeripheralCableCode, ctpDPPeripheralPowerStatus=ctpDPPeripheralPowerStatus, ctp802dot11PeripheralAddr=ctp802dot11PeripheralAddr, ctp802dot11PeripheralStatusTable=ctp802dot11PeripheralStatusTable, ctpPeripheralErrorHistLastIndex=ctpPeripheralErrorHistLastIndex, CtpPeripheralStatusCode=CtpPeripheralStatusCode, ciscoTpEventHistoryGroup=ciscoTpEventHistoryGroup, ciscoTpNotificationGroupR01=ciscoTpNotificationGroupR01, ctpDPPeripheralCableStatus=ctpDPPeripheralCableStatus, ctp802dot11PeripheralIfIndex=ctp802dot11PeripheralIfIndex, ctpPeripheralAttributeIndex=ctpPeripheralAttributeIndex, ctpUSBPeripheralPortType=ctpUSBPeripheralPortType, ctpUSBPeripheralPowerStatus=ctpUSBPeripheralPowerStatus, ctpRS232PortIndex=ctpRS232PortIndex, ctpSysUserAuthFailSourceAddrType=ctpSysUserAuthFailSourceAddrType, ciscoTpPeripheralStatusGroup=ciscoTpPeripheralStatusGroup, ciscoTpEventHistoryGroupR01=ciscoTpEventHistoryGroupR01, ctpPeripheralDeviceCategory=ctpPeripheralDeviceCategory)
