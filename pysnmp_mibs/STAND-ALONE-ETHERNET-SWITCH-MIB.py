...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/STAND-ALONE-ETHERNET-SWITCH-MIB
...
mibBuilder.exportSymbols("STAND-ALONE-ETHERNET-SWITCH-MIB", swPortLinkbeatStatus=swPortLinkbeatStatus, swPortBroadcastStormBlocked=swPortBroadcastStormBlocked, swPortTxExcessiveDeferrals=swPortTxExcessiveDeferrals, swPortTxCollEntry=swPortTxCollEntry, sysInfoPortFailedPOSTMap=sysInfoPortFailedPOSTMap, swPortBridgePriority=swPortBridgePriority, switchPortTxStatTable=switchPortTxStatTable, bandwidthUsage=bandwidthUsage, sysInfo=sysInfo, swPortRxAlignmentErrors=swPortRxAlignmentErrors, swPortTxSingleCollisions=swPortTxSingleCollisions, swPortEraseAddresses=swPortEraseAddresses, swPortFullDuplexFlowControl=swPortFullDuplexFlowControl, sysConfigSwitchingMode=sysConfigSwitchingMode, swPortBridgePathCost=swPortBridgePathCost, netMgmtConsolePasswordThresh=netMgmtConsolePasswordThresh, bridgeGroupMemberTable=bridgeGroupMemberTable, sysConfigHigherProtocolMonitor=sysConfigHigherProtocolMonitor, sysConfigHalfDuplexBackPressure=sysConfigHalfDuplexBackPressure, swPortRxTotalOctetsWraps=swPortRxTotalOctetsWraps, switchPortTxCollTable=switchPortTxCollTable, netMgmtTrapClientTable=netMgmtTrapClientTable, netMgmtSetClientStatus=netMgmtSetClientStatus, sysInfoBuffersUsed=sysInfoBuffersUsed, fastLink=fastLink, netMgmtHttpServerAdminState=netMgmtHttpServerAdminState, bandwidthUsageStartTime=bandwidthUsageStartTime, swPortTxTotalOctets=swPortTxTotalOctets, swPortSTPPortFastMode=swPortSTPPortFastMode, sysConfigMonitorPort=sysConfigMonitorPort, swPortControllerRevision=swPortControllerRevision, swPortClearStatistics=swPortClearStatistics, swPortBridgePathCostAlternate=swPortBridgePathCostAlternate, series2000=series2000, swPortTxTotalFrames=swPortTxTotalFrames, netMgmtTrapClientEntry=netMgmtTrapClientEntry, upgradeTFTPServerName=upgradeTFTPServerName, bandwidthUsagePeak=bandwidthUsagePeak, broadcastStorm=broadcastStorm, swPortRxBroadcastOctetsWraps=swPortRxBroadcastOctetsWraps, swPortLastStatus=swPortLastStatus, netMgmtTrapClientAddr=netMgmtTrapClientAddr, sysInfoTotalNumberOfPorts=sysInfoTotalNumberOfPorts, swPortTxDeferrals=swPortTxDeferrals, upgradeTFTPAccept=upgradeTFTPAccept, vlanMaxSupported=vlanMaxSupported, swPortAdminStatus=swPortAdminStatus, bandwidthUsageMaxPeakEntries=bandwidthUsageMaxPeakEntries, sysInfoAddrCapacity=sysInfoAddrCapacity, bandwidthUsagePeakRestart=bandwidthUsagePeakRestart, netMgmtSetClientIndex=netMgmtSetClientIndex, netMgmtDomainServer1IpAddress=netMgmtDomainServer1IpAddress, netMgmtTrapClientName=netMgmtTrapClientName, swPortRxUnicastOctetsWraps=swPortRxUnicastOctetsWraps, swPortRxBroadcastFrames=swPortRxBroadcastFrames, sysInfoFwdEngineRevision=sysInfoFwdEngineRevision, sysConfigReset=sysConfigReset, sysInfoPortDisabledDisplayMap=sysInfoPortDisabledDisplayMap, swPortRxStatIndex=swPortRxStatIndex, upgradeFlashSize=upgradeFlashSize, bridgeGroupMemberPortOfBridgeGroup=bridgeGroupMemberPortOfBridgeGroup, vlanIndex=vlanIndex, swPortStatus=swPortStatus, swPortTxBroadcastFrames=swPortTxBroadcastFrames, swPortTxUnicastFrames=swPortTxUnicastFrames, vlanMemberTable=vlanMemberTable, netMgmtConsoleInactTime=netMgmtConsoleInactTime, sysInfoPortLinkDisplayMap=sysInfoPortLinkDisplayMap, swPortName=swPortName, swPortTxBroadcastOctetsWraps=swPortTxBroadcastOctetsWraps, swPortHalfDuplexBackPressure=swPortHalfDuplexBackPressure, netMgmtHttpPort=netMgmtHttpPort, sysConfigConfigFileAuto=sysConfigConfigFileAuto, addressViolation=addressViolation, bridgeGroupMemberEntry=bridgeGroupMemberEntry, grandjunction=grandjunction, bridgeGroupMemberPorts=bridgeGroupMemberPorts, swPortTxCollFrequencies=swPortTxCollFrequencies, netMgmtCdpTransmissionTime=netMgmtCdpTransmissionTime, bridgeTemplateHelloTime=bridgeTemplateHelloTime, upgradeTFTPInitiate=upgradeTFTPInitiate, vlanTable=vlanTable, netMgmtDomainServer2IpAddress=netMgmtDomainServer2IpAddress, vlanName=vlanName, sysConfig=sysConfig, swPortRxRunts=swPortRxRunts, swPortTxExcessiveCollisions=swPortTxExcessiveCollisions, bridgeGroupMaxSupported=bridgeGroupMaxSupported, swPortRxForwardedFrames=swPortRxForwardedFrames, swPortTxLateCollisions=swPortTxLateCollisions, bridgeTemplateEntry=bridgeTemplateEntry, bridgeTemplateMaxAge=bridgeTemplateMaxAge, swPortTxMulticastOctets=swPortTxMulticastOctets, upgradeTFTPServerAddress=upgradeTFTPServerAddress, bridgeTemplateTable=bridgeTemplateTable, swPortType=swPortType, swPortRxTotalOctets=swPortRxTotalOctets, swPortTxMulticastFrames=swPortTxMulticastFrames, netMgmtSetClientEntry=netMgmtSetClientEntry, upgradeEPROMRevision=upgradeEPROMRevision, vlanBridgeTemplate=vlanBridgeTemplate, swPortRxBroadcastOctets=swPortRxBroadcastOctets, swPortRxStatEntry=swPortRxStatEntry, swPortBridgePriorityAlternate=swPortBridgePriorityAlternate, vlanEntry=vlanEntry, sysConfigStrictSTPTransition=sysConfigStrictSTPTransition, swPortMediaCapability=swPortMediaCapability, swPortRxUnicastOctets=swPortRxUnicastOctets, sysInfoBoardRevision=sysInfoBoardRevision, vlanMemberPortIndex=vlanMemberPortIndex, sysInfoInternalPowerState=sysInfoInternalPowerState, bridgeTemplateForwardDelay=bridgeTemplateForwardDelay, swPortRxFilteredFrames=swPortRxFilteredFrames, netMgmtEnableAuthenTraps=netMgmtEnableAuthenTraps, netMgmtTrapClientComm=netMgmtTrapClientComm, sysConfigDefaultReset=sysConfigDefaultReset, sysInfoNumberOfInstalledModules=sysInfoNumberOfInstalledModules, swPortIfIndex=swPortIfIndex, swPortStatusChanges=swPortStatusChanges, netMgmtCdpHoldTime=netMgmtCdpHoldTime, upgradeFirmwareSource=upgradeFirmwareSource, swPortRxFrameTooLongs=swPortRxFrameTooLongs, bandwidthUsagePeakTime=bandwidthUsagePeakTime, swPortRxMulticastOctetsWraps=swPortRxMulticastOctetsWraps, netMgmtModemDialDelay=netMgmtModemDialDelay, vlanIpSubnetMask=vlanIpSubnetMask, seriesG2xx=seriesG2xx, vlan=vlan, swPortFloodUnknownUnicasts=swPortFloodUnknownUnicasts, vlanAllowMembershipOverlap=vlanAllowMembershipOverlap, bridgeGroupIndex=bridgeGroupIndex, swPortRxTotalFrames=swPortRxTotalFrames, sysInfoNumberOfSharedPorts=sysInfoNumberOfSharedPorts, sysConfigMulticastStoreAndForward=sysConfigMulticastStoreAndForward, netMgmtModemDialString=netMgmtModemDialString, sysConfigBroadcastStormAlert=sysConfigBroadcastStormAlert, swPortMonitoring=swPortMonitoring, netMgmtModemInitString=netMgmtModemInitString, sysInfoPortExceedBroadcastStorm=sysInfoPortExceedBroadcastStorm, swPortRxUnicastFrames=swPortRxUnicastFrames, swPortFloodUnregisteredMulticasts=swPortFloodUnregisteredMulticasts, swPortConnectorType=swPortConnectorType, swPortInternal=swPortInternal, swPortIndex=swPortIndex, netMgmtCgmpRouterHoldTime=netMgmtCgmpRouterHoldTime, sysInfoPOSTResult=sysInfoPOSTResult, netMgmtVlan=netMgmtVlan, sysInfoBroadcastStormLastTime=sysInfoBroadcastStormLastTime, swPortTxQueueFullDiscards=swPortTxQueueFullDiscards, sysConfigClearPortStats=sysConfigClearPortStats, netMgmtTrapClientIndex=netMgmtTrapClientIndex, sysConfigNetworkPort=sysConfigNetworkPort, sysConfigFastEthcParmsPort=sysConfigFastEthcParmsPort, swPortTxExcessiveCollision16s=swPortTxExcessiveCollision16s, sysConfigBroadcastThreshold=sysConfigBroadcastThreshold, sysConfigAddressViolationAction=sysConfigAddressViolationAction, swPortAddressTableSize=swPortAddressTableSize, swPortTxMultipleCollisions=swPortTxMultipleCollisions, ipAddressChange=ipAddressChange, swPortJabberStatus=swPortJabberStatus, swPortAddressingSecurity=swPortAddressingSecurity, bridgeGroupEntry=bridgeGroupEntry, vlanMemberEntry=vlanMemberEntry, vlanMemberIndex=vlanMemberIndex, swPortFullDuplex=swPortFullDuplex, rpsFailed=rpsFailed, switchDiagnostic=switchDiagnostic, swPortRxMulticastFrames=swPortRxMulticastFrames, swPortTxUnicastOctetsWraps=swPortTxUnicastOctetsWraps, swPortTxMulticastOctetsWraps=swPortTxMulticastOctetsWraps, netMgmtTrapClientStatus=netMgmtTrapClientStatus, bridgeGroup=bridgeGroup, vlanMemberPorts=vlanMemberPorts, swPortNumberOfLearnedAddresses=swPortNumberOfLearnedAddresses, netMgmtModemAutoAnswer=netMgmtModemAutoAnswer, swPortLinkbeatLosses=swPortLinkbeatLosses, upgradeTFTPLoadFilename=upgradeTFTPLoadFilename, logonIntruder=logonIntruder, bridgeTemplatePriority=bridgeTemplatePriority, swPortACR=swPortACR, bandwidthUsagePeakEntry=bandwidthUsagePeakEntry, netMgmtSetClientTable=netMgmtSetClientTable, netMgmtCgmpEnable=netMgmtCgmpEnable, swPortEnhancedCongestionControl=swPortEnhancedCongestionControl, sysConfigAddressViolationAlert=sysConfigAddressViolationAlert, swPortRxFCSErrors=swPortRxFCSErrors, bandwidthUsageCurrent=bandwidthUsageCurrent, bridgeGroupStpAdmin=bridgeGroupStpAdmin, bandwidthUsagePeakInterval=bandwidthUsagePeakInterval, sysInfoRestrictedStaticAddrCapacity=sysInfoRestrictedStaticAddrCapacity, esModuleBasic=esModuleBasic, swPortSecuredAddressViolations=swPortSecuredAddressViolations, sysConfigPort25Connector=sysConfigPort25Connector, swPortRxNoBufferDiscards=swPortRxNoBufferDiscards, switchPortRxStatTable=switchPortRxStatTable, swPortTxStatEntry=swPortTxStatEntry, sysConfigTftpServerName=sysConfigTftpServerName, sysConfigMonitor=sysConfigMonitor, swPortDuplexStatus=swPortDuplexStatus, sysInfoRedundantPowerState=sysInfoRedundantPowerState, netMgmtConsoleSilentTime=netMgmtConsoleSilentTime, bridgeGroupMemberPortIndex=bridgeGroupMemberPortIndex, swPortTxUnicastOctets=swPortTxUnicastOctets, vlanMemberPortOfVlan=vlanMemberPortOfVlan, bandwidthUsagePeakIndex=bandwidthUsagePeakIndex, upgrade=upgrade, netMgmtIpAddress=netMgmtIpAddress, sysConfigEnableSTP=sysConfigEnableSTP, swPortNumberOfStaticAddresses=swPortNumberOfStaticAddresses, swPortEntry=swPortEntry, netMgmtDefaultGateway=netMgmtDefaultGateway, port=port, netMgmtSetClientName=netMgmtSetClientName, bridgeGroupMemberIndex=bridgeGroupMemberIndex, netMgmtEnableRIP=netMgmtEnableRIP, sysConfig10MbpsEnhancedCongestionControl=sysConfig10MbpsEnhancedCongestionControl, vlanIpAddress=vlanIpAddress, swPortTxCollCount=swPortTxCollCount, bridgeTemplateIndex=bridgeTemplateIndex, bandwidthUsagePeakTable=bandwidthUsagePeakTable, bridgeGroupTable=bridgeGroupTable, netMgmt=netMgmt, swPortTxCollIndex=swPortTxCollIndex, netMgmtEnableLinkTraps=netMgmtEnableLinkTraps, sysInfoConfigFileStatus=sysInfoConfigFileStatus, sysConfigBroadcastReEnableThreshold=sysConfigBroadcastReEnableThreshold, swPortTxBroadcastOctets=swPortTxBroadcastOctets, swPortTxErrors=swPortTxErrors, netMgmtDefaultSearchDomain=netMgmtDefaultSearchDomain, swPortTxTotalOctetsWraps=swPortTxTotalOctetsWraps, bandwidthUsageCurrentPeakEntry=bandwidthUsageCurrentPeakEntry, vlanStpAdmin=vlanStpAdmin, upgradeAutoExecute=upgradeAutoExecute, sysConfigHeuristics=sysConfigHeuristics, swPortJabbers=swPortJabbers, netMgmtIpSubnetMask=netMgmtIpSubnetMask, sysInfoImageCapability=sysInfoImageCapability, switchPortTable=switchPortTable, swPortTxExcessiveCollision4s=swPortTxExcessiveCollision4s, netMgmtSetClientAddr=netMgmtSetClientAddr, upgradeFlashBankStatus=upgradeFlashBankStatus, bridgeGroupAllowMembershipOverlap=bridgeGroupAllowMembershipOverlap, products=products, sysConfigPortGroupingMode=sysConfigPortGroupingMode, sysConfigBroadcastStormAction=sysConfigBroadcastStormAction, sysInfoMaxBuffers=sysInfoMaxBuffers, bridgeTemplateMax=bridgeTemplateMax, swPortRxMulticastOctets=swPortRxMulticastOctets, sysInfoNumberOfSwitchPorts=sysInfoNumberOfSwitchPorts, sysInfoUtilDisplay=sysInfoUtilDisplay, swPortTxStatIndex=swPortTxStatIndex)
