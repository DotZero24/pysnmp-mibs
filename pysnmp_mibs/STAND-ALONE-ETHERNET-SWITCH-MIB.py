...
mibBuilder.exportSymbols("STAND-ALONE-ETHERNET-SWITCH-MIB", swPortTxCollFrequencies=swPortTxCollFrequencies, swPortTxSingleCollisions=swPortTxSingleCollisions, bridgeTemplateMaxAge=bridgeTemplateMaxAge, sysInfoFwdEngineRevision=sysInfoFwdEngineRevision, sysConfigBroadcastStormAction=sysConfigBroadcastStormAction, swPortName=swPortName, swPortLinkbeatStatus=swPortLinkbeatStatus, netMgmtTrapClientStatus=netMgmtTrapClientStatus, sysConfigDefaultReset=sysConfigDefaultReset, swPortTxBroadcastOctetsWraps=swPortTxBroadcastOctetsWraps, swPortJabberStatus=swPortJabberStatus, netMgmtConsolePasswordThresh=netMgmtConsolePasswordThresh, netMgmtHttpServerAdminState=netMgmtHttpServerAdminState, upgradeTFTPServerName=upgradeTFTPServerName, grandjunction=grandjunction, swPortMonitoring=swPortMonitoring, swPortRxMulticastOctets=swPortRxMulticastOctets, sysInfoTotalNumberOfPorts=sysInfoTotalNumberOfPorts, swPortTxMulticastOctetsWraps=swPortTxMulticastOctetsWraps, swPortTxCollCount=swPortTxCollCount, netMgmtConsoleSilentTime=netMgmtConsoleSilentTime, netMgmtSetClientIndex=netMgmtSetClientIndex, sysInfoNumberOfSharedPorts=sysInfoNumberOfSharedPorts, sysInfoPortDisabledDisplayMap=sysInfoPortDisabledDisplayMap, netMgmtHttpPort=netMgmtHttpPort, swPortRxFilteredFrames=swPortRxFilteredFrames, swPortTxTotalFrames=swPortTxTotalFrames, upgradeTFTPServerAddress=upgradeTFTPServerAddress, sysConfigClearPortStats=sysConfigClearPortStats, swPortDuplexStatus=swPortDuplexStatus, sysInfo=sysInfo, bandwidthUsage=bandwidthUsage, switchPortRxStatTable=switchPortRxStatTable, swPortTxStatIndex=swPortTxStatIndex, sysConfigEnableSTP=sysConfigEnableSTP, swPortRxNoBufferDiscards=swPortRxNoBufferDiscards, sysConfigSwitchingMode=sysConfigSwitchingMode, swPortRxFrameTooLongs=swPortRxFrameTooLongs, sysConfigNetworkPort=sysConfigNetworkPort, netMgmtIpSubnetMask=netMgmtIpSubnetMask, sysInfoInternalPowerState=sysInfoInternalPowerState, sysConfig10MbpsEnhancedCongestionControl=sysConfig10MbpsEnhancedCongestionControl, netMgmtTrapClientEntry=netMgmtTrapClientEntry, sysConfigFastEthcParmsPort=sysConfigFastEthcParmsPort, netMgmtEnableAuthenTraps=netMgmtEnableAuthenTraps, swPortRxAlignmentErrors=swPortRxAlignmentErrors, upgradeTFTPInitiate=upgradeTFTPInitiate, vlanMemberIndex=vlanMemberIndex, swPortRxFCSErrors=swPortRxFCSErrors, bandwidthUsagePeakInterval=bandwidthUsagePeakInterval, sysConfigReset=sysConfigReset, switchPortTable=switchPortTable, switchPortTxCollTable=switchPortTxCollTable, sysConfigMonitor=sysConfigMonitor, sysConfigStrictSTPTransition=sysConfigStrictSTPTransition, netMgmtCgmpRouterHoldTime=netMgmtCgmpRouterHoldTime, netMgmtSetClientStatus=netMgmtSetClientStatus, upgradeEPROMRevision=upgradeEPROMRevision, seriesG2xx=seriesG2xx, sysConfigPort25Connector=sysConfigPort25Connector, netMgmtDefaultSearchDomain=netMgmtDefaultSearchDomain, bridgeTemplatePriority=bridgeTemplatePriority, bandwidthUsageStartTime=bandwidthUsageStartTime, fastLink=fastLink, upgradeFirmwareSource=upgradeFirmwareSource, swPortFullDuplex=swPortFullDuplex, swPortSecuredAddressViolations=swPortSecuredAddressViolations, vlanMemberPortOfVlan=vlanMemberPortOfVlan, sysInfoBroadcastStormLastTime=sysInfoBroadcastStormLastTime, sysInfoAddrCapacity=sysInfoAddrCapacity, swPortAdminStatus=swPortAdminStatus, netMgmtModemAutoAnswer=netMgmtModemAutoAnswer, bridgeGroupMemberEntry=bridgeGroupMemberEntry, swPortRxRunts=swPortRxRunts, swPortFloodUnregisteredMulticasts=swPortFloodUnregisteredMulticasts, swPortTxMulticastOctets=swPortTxMulticastOctets, swPortStatus=swPortStatus, swPortRxTotalOctets=swPortRxTotalOctets, netMgmtCdpHoldTime=netMgmtCdpHoldTime, swPortRxForwardedFrames=swPortRxForwardedFrames, bridgeTemplateForwardDelay=bridgeTemplateForwardDelay, series2000=series2000, swPortRxUnicastOctetsWraps=swPortRxUnicastOctetsWraps, swPortTxDeferrals=swPortTxDeferrals, bridgeTemplateIndex=bridgeTemplateIndex, bandwidthUsagePeakEntry=bandwidthUsagePeakEntry, swPortTxMultipleCollisions=swPortTxMultipleCollisions, swPortTxCollEntry=swPortTxCollEntry, bridgeGroupMemberTable=bridgeGroupMemberTable, vlanMaxSupported=vlanMaxSupported, bridgeGroupStpAdmin=bridgeGroupStpAdmin, vlanAllowMembershipOverlap=vlanAllowMembershipOverlap, logonIntruder=logonIntruder, netMgmt=netMgmt, swPortInternal=swPortInternal, netMgmtTrapClientTable=netMgmtTrapClientTable, swPortAddressingSecurity=swPortAddressingSecurity, netMgmtIpAddress=netMgmtIpAddress, swPortAddressTableSize=swPortAddressTableSize, bridgeGroupEntry=bridgeGroupEntry, sysConfigHalfDuplexBackPressure=sysConfigHalfDuplexBackPressure, swPortIndex=swPortIndex, netMgmtModemDialDelay=netMgmtModemDialDelay, sysConfig=sysConfig, swPortRxTotalOctetsWraps=swPortRxTotalOctetsWraps, bandwidthUsageCurrentPeakEntry=bandwidthUsageCurrentPeakEntry, upgradeTFTPLoadFilename=upgradeTFTPLoadFilename, swPortRxUnicastOctets=swPortRxUnicastOctets, switchDiagnostic=switchDiagnostic, swPortTxCollIndex=swPortTxCollIndex, bridgeTemplateHelloTime=bridgeTemplateHelloTime, swPortBridgePathCost=swPortBridgePathCost, vlan=vlan, netMgmtTrapClientComm=netMgmtTrapClientComm, netMgmtCdpTransmissionTime=netMgmtCdpTransmissionTime, swPortBroadcastStormBlocked=swPortBroadcastStormBlocked, bridgeTemplateTable=bridgeTemplateTable, sysConfigTftpServerName=sysConfigTftpServerName, netMgmtSetClientName=netMgmtSetClientName, vlanIpAddress=vlanIpAddress, sysInfoRestrictedStaticAddrCapacity=sysInfoRestrictedStaticAddrCapacity, swPortEntry=swPortEntry, products=products, swPortTxMulticastFrames=swPortTxMulticastFrames, netMgmtVlan=netMgmtVlan, sysInfoNumberOfSwitchPorts=sysInfoNumberOfSwitchPorts, swPortTxUnicastFrames=swPortTxUnicastFrames, swPortTxExcessiveDeferrals=swPortTxExcessiveDeferrals, vlanBridgeTemplate=vlanBridgeTemplate, vlanMemberTable=vlanMemberTable, bridgeGroupMemberPortOfBridgeGroup=bridgeGroupMemberPortOfBridgeGroup, swPortEraseAddresses=swPortEraseAddresses, swPortNumberOfStaticAddresses=swPortNumberOfStaticAddresses, netMgmtDefaultGateway=netMgmtDefaultGateway, vlanMemberPortIndex=vlanMemberPortIndex, sysConfigPortGroupingMode=sysConfigPortGroupingMode, bridgeGroupMemberPortIndex=bridgeGroupMemberPortIndex, esModuleBasic=esModuleBasic, swPortBridgePriority=swPortBridgePriority, netMgmtEnableLinkTraps=netMgmtEnableLinkTraps, swPortMediaCapability=swPortMediaCapability, netMgmtDomainServer1IpAddress=netMgmtDomainServer1IpAddress, bandwidthUsagePeakRestart=bandwidthUsagePeakRestart, sysConfigHeuristics=sysConfigHeuristics, vlanIpSubnetMask=vlanIpSubnetMask, bridgeGroup=bridgeGroup, swPortRxTotalFrames=swPortRxTotalFrames, swPortACR=swPortACR, sysInfoMaxBuffers=sysInfoMaxBuffers, swPortRxBroadcastFrames=swPortRxBroadcastFrames, sysInfoBuffersUsed=sysInfoBuffersUsed, upgradeFlashSize=upgradeFlashSize, swPortLinkbeatLosses=swPortLinkbeatLosses, swPortJabbers=swPortJabbers, bandwidthUsagePeakIndex=bandwidthUsagePeakIndex, swPortHalfDuplexBackPressure=swPortHalfDuplexBackPressure, swPortEnhancedCongestionControl=swPortEnhancedCongestionControl, swPortTxStatEntry=swPortTxStatEntry, bandwidthUsagePeak=bandwidthUsagePeak, swPortTxTotalOctetsWraps=swPortTxTotalOctetsWraps, upgradeTFTPAccept=upgradeTFTPAccept, sysInfoPortFailedPOSTMap=sysInfoPortFailedPOSTMap, bridgeGroupMemberIndex=bridgeGroupMemberIndex, netMgmtSetClientEntry=netMgmtSetClientEntry, netMgmtConsoleInactTime=netMgmtConsoleInactTime, netMgmtSetClientAddr=netMgmtSetClientAddr, sysConfigMulticastStoreAndForward=sysConfigMulticastStoreAndForward, netMgmtEnableRIP=netMgmtEnableRIP, sysInfoPortExceedBroadcastStorm=sysInfoPortExceedBroadcastStorm, swPortTxTotalOctets=swPortTxTotalOctets, swPortBridgePriorityAlternate=swPortBridgePriorityAlternate, swPortTxQueueFullDiscards=swPortTxQueueFullDiscards, sysConfigHigherProtocolMonitor=sysConfigHigherProtocolMonitor, netMgmtModemDialString=netMgmtModemDialString, swPortRxBroadcastOctets=swPortRxBroadcastOctets, bandwidthUsageCurrent=bandwidthUsageCurrent, swPortConnectorType=swPortConnectorType, bridgeGroupIndex=bridgeGroupIndex, sysInfoImageCapability=sysInfoImageCapability, bridgeGroupAllowMembershipOverlap=bridgeGroupAllowMembershipOverlap, swPortTxUnicastOctets=swPortTxUnicastOctets, sysConfigBroadcastThreshold=sysConfigBroadcastThreshold, sysInfoPortLinkDisplayMap=sysInfoPortLinkDisplayMap, swPortTxBroadcastFrames=swPortTxBroadcastFrames, sysConfigAddressViolationAction=sysConfigAddressViolationAction, upgradeFlashBankStatus=upgradeFlashBankStatus, ipAddressChange=ipAddressChange, bridgeGroupMaxSupported=bridgeGroupMaxSupported, sysInfoNumberOfInstalledModules=sysInfoNumberOfInstalledModules, netMgmtTrapClientName=netMgmtTrapClientName, swPortRxMulticastOctetsWraps=swPortRxMulticastOctetsWraps, swPortTxLateCollisions=swPortTxLateCollisions, netMgmtTrapClientAddr=netMgmtTrapClientAddr, bridgeGroupTable=bridgeGroupTable, swPortStatusChanges=swPortStatusChanges, bridgeTemplateEntry=bridgeTemplateEntry, swPortIfIndex=swPortIfIndex, bandwidthUsageMaxPeakEntries=bandwidthUsageMaxPeakEntries, swPortSTPPortFastMode=swPortSTPPortFastMode, swPortFullDuplexFlowControl=swPortFullDuplexFlowControl, sysConfigMonitorPort=sysConfigMonitorPort, upgrade=upgrade, sysConfigBroadcastStormAlert=sysConfigBroadcastStormAlert, vlanName=vlanName, rpsFailed=rpsFailed, vlanMemberEntry=vlanMemberEntry, swPortNumberOfLearnedAddresses=swPortNumberOfLearnedAddresses, swPortFloodUnknownUnicasts=swPortFloodUnknownUnicasts, sysInfoRedundantPowerState=sysInfoRedundantPowerState, upgradeAutoExecute=upgradeAutoExecute, vlanMemberPorts=vlanMemberPorts, netMgmtCgmpEnable=netMgmtCgmpEnable, swPortTxExcessiveCollision16s=swPortTxExcessiveCollision16s, swPortTxErrors=swPortTxErrors, bridgeGroupMemberPorts=bridgeGroupMemberPorts, sysInfoUtilDisplay=sysInfoUtilDisplay, port=port, swPortLastStatus=swPortLastStatus, swPortTxExcessiveCollisions=swPortTxExcessiveCollisions, sysInfoPOSTResult=sysInfoPOSTResult, bandwidthUsagePeakTime=bandwidthUsagePeakTime, swPortRxStatEntry=swPortRxStatEntry, vlanEntry=vlanEntry, swPortBridgePathCostAlternate=swPortBridgePathCostAlternate, netMgmtModemInitString=netMgmtModemInitString, swPortType=swPortType, sysInfoBoardRevision=sysInfoBoardRevision, broadcastStorm=broadcastStorm, swPortTxUnicastOctetsWraps=swPortTxUnicastOctetsWraps, swPortTxExcessiveCollision4s=swPortTxExcessiveCollision4s, bandwidthUsagePeakTable=bandwidthUsagePeakTable, vlanIndex=vlanIndex, vlanStpAdmin=vlanStpAdmin, addressViolation=addressViolation, sysInfoConfigFileStatus=sysInfoConfigFileStatus, swPortControllerRevision=swPortControllerRevision, vlanTable=vlanTable, netMgmtSetClientTable=netMgmtSetClientTable, swPortRxUnicastFrames=swPortRxUnicastFrames, netMgmtTrapClientIndex=netMgmtTrapClientIndex, bridgeTemplateMax=bridgeTemplateMax, sysConfigConfigFileAuto=sysConfigConfigFileAuto, swPortClearStatistics=swPortClearStatistics, sysConfigBroadcastReEnableThreshold=sysConfigBroadcastReEnableThreshold, swPortRxStatIndex=swPortRxStatIndex, swPortRxBroadcastOctetsWraps=swPortRxBroadcastOctetsWraps, netMgmtDomainServer2IpAddress=netMgmtDomainServer2IpAddress, swPortTxBroadcastOctets=swPortTxBroadcastOctets, switchPortTxStatTable=switchPortTxStatTable, swPortRxMulticastFrames=swPortRxMulticastFrames, sysConfigAddressViolationAlert=sysConfigAddressViolationAlert)
