...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/dell/DNOS-LOOPBACK-MIB
...
if mibBuilder.loadTexts: fastPathLoopback.setOrganization('Dell EMC')
...
mibBuilder.exportSymbols("DNOS-LOOPBACK-MIB", agentLoopbackIfIndex=agentLoopbackIfIndex, agentLoopbackStatus=agentLoopbackStatus, agentLoopbackID=agentLoopbackID, agentLoopbackIPSubnet=agentLoopbackIPSubnet, agentLoopbackTable=agentLoopbackTable, fastPathLoopback=fastPathLoopback, agentLoopbackIPAddress=agentLoopbackIPAddress, agentLoopbackEntry=agentLoopbackEntry, PYSNMP_MODULE_ID=fastPathLoopback, agentLoopbackGroup=agentLoopbackGroup)
