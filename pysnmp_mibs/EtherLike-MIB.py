...
transmission, Gauge32, MibIdentifier, NotificationType, Integer32, Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, Counter64, TimeTicks, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "transmission", "Gauge32", "MibIdentifier", "NotificationType", "Integer32", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "TimeTicks", "mib-2")
...
mibBuilder.exportSymbols("EtherLike-MIB", dot3PauseEntry=dot3PauseEntry, dot3StatsEntry=dot3StatsEntry, dot3CollTable=dot3CollTable, dot3InPauseFrames=dot3InPauseFrames, PYSNMP_MODULE_ID=etherMIB, etherMIBObjects=etherMIBObjects, dot3ErrorInitError=dot3ErrorInitError, dot3StatsRateControlAbility=dot3StatsRateControlAbility, dot3StatsCarrierSenseErrors=dot3StatsCarrierSenseErrors, dot3StatsIndex=dot3StatsIndex, ether100MbsCompliance=ether100MbsCompliance, dot3=dot3, dot3OutPauseFrames=dot3OutPauseFrames, etherMIB=etherMIB, dot3PauseTable=dot3PauseTable, etherCompliance=etherCompliance, dot3HCStatsTable=dot3HCStatsTable, dot3HCInPauseFrames=dot3HCInPauseFrames, dot3StatsInternalMacTransmitErrors=dot3StatsInternalMacTransmitErrors, etherHCControlGroup=etherHCControlGroup, dot3HCStatsInternalMacReceiveErrors=dot3HCStatsInternalMacReceiveErrors, dot3ControlTable=dot3ControlTable, dot3HCStatsEntry=dot3HCStatsEntry, etherStatsGroup=etherStatsGroup, etherConformance=etherConformance, etherStatsLowSpeedGroup=etherStatsLowSpeedGroup, dot3HCStatsInternalMacTransmitErrors=dot3HCStatsInternalMacTransmitErrors, dot3StatsAlignmentErrors=dot3StatsAlignmentErrors, dot3ControlInUnknownOpcodes=dot3ControlInUnknownOpcodes, dot3StatsRateControlStatus=dot3StatsRateControlStatus, dot3StatsFCSErrors=dot3StatsFCSErrors, dot3HCStatsFrameTooLongs=dot3HCStatsFrameTooLongs, etherStatsBaseGroup2=etherStatsBaseGroup2, etherRateControlGroup=etherRateControlGroup, dot3Compliance2=dot3Compliance2, etherStatsBaseGroup=etherStatsBaseGroup, etherCollisionTableGroup=etherCollisionTableGroup, etherCompliances=etherCompliances, dot3Errors=dot3Errors, dot3PauseOperMode=dot3PauseOperMode, etherHCControlPauseGroup=etherHCControlPauseGroup, dot3StatsMultipleCollisionFrames=dot3StatsMultipleCollisionFrames, etherHCStatsGroup=etherHCStatsGroup, dot3StatsSQETestErrors=dot3StatsSQETestErrors, dot3HCOutPauseFrames=dot3HCOutPauseFrames, etherStatsHighSpeedGroup=etherStatsHighSpeedGroup, etherDuplexGroup=etherDuplexGroup, dot3PauseAdminMode=dot3PauseAdminMode, dot3TestLoopBack=dot3TestLoopBack, dot3StatsDeferredTransmissions=dot3StatsDeferredTransmissions, dot3HCControlInUnknownOpcodes=dot3HCControlInUnknownOpcodes, dot3HCStatsAlignmentErrors=dot3HCStatsAlignmentErrors, dot3HCStatsFCSErrors=dot3HCStatsFCSErrors, dot3Compliance=dot3Compliance, etherStats100MbsGroup=etherStats100MbsGroup, dot3StatsLateCollisions=dot3StatsLateCollisions, dot3ControlFunctionsSupported=dot3ControlFunctionsSupported, dot3StatsTable=dot3StatsTable, dot3CollCount=dot3CollCount, dot3StatsFrameTooLongs=dot3StatsFrameTooLongs, dot3ErrorLoopbackError=dot3ErrorLoopbackError, dot3StatsInternalMacReceiveErrors=dot3StatsInternalMacReceiveErrors, etherStatsHalfDuplexGroup=etherStatsHalfDuplexGroup, dot3HCStatsSymbolErrors=dot3HCStatsSymbolErrors, dot3Tests=dot3Tests, etherControlGroup=etherControlGroup, dot3StatsDuplexStatus=dot3StatsDuplexStatus, etherGroups=etherGroups, etherControlPauseGroup=etherControlPauseGroup, dot3TestTdr=dot3TestTdr, dot3StatsSingleCollisionFrames=dot3StatsSingleCollisionFrames, dot3StatsSymbolErrors=dot3StatsSymbolErrors, dot3StatsEtherChipSet=dot3StatsEtherChipSet, dot3CollEntry=dot3CollEntry, dot3ControlEntry=dot3ControlEntry, dot3CollFrequencies=dot3CollFrequencies, dot3StatsExcessiveCollisions=dot3StatsExcessiveCollisions)
