...
ModuleIdentity, transmission, Counter64, ObjectIdentity, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, TimeTicks, MibIdentifier, Integer32, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "transmission", "Counter64", "ObjectIdentity", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("EtherLike-MIB", dot3ControlTable=dot3ControlTable, dot3StatsInternalMacReceiveErrors=dot3StatsInternalMacReceiveErrors, etherConformance=etherConformance, dot3HCStatsFrameTooLongs=dot3HCStatsFrameTooLongs, dot3Compliance2=dot3Compliance2, dot3ErrorLoopbackError=dot3ErrorLoopbackError, etherHCControlGroup=etherHCControlGroup, etherStatsGroup=etherStatsGroup, dot3HCInPauseFrames=dot3HCInPauseFrames, dot3StatsIndex=dot3StatsIndex, etherDuplexGroup=etherDuplexGroup, dot3StatsSingleCollisionFrames=dot3StatsSingleCollisionFrames, dot3PauseAdminMode=dot3PauseAdminMode, dot3TestTdr=dot3TestTdr, dot3StatsMultipleCollisionFrames=dot3StatsMultipleCollisionFrames, dot3HCOutPauseFrames=dot3HCOutPauseFrames, dot3StatsExcessiveCollisions=dot3StatsExcessiveCollisions, dot3PauseEntry=dot3PauseEntry, dot3TestLoopBack=dot3TestLoopBack, PYSNMP_MODULE_ID=etherMIB, dot3PauseOperMode=dot3PauseOperMode, dot3StatsSQETestErrors=dot3StatsSQETestErrors, dot3Errors=dot3Errors, dot3InPauseFrames=dot3InPauseFrames, etherStatsLowSpeedGroup=etherStatsLowSpeedGroup, dot3HCStatsFCSErrors=dot3HCStatsFCSErrors, dot3HCStatsTable=dot3HCStatsTable, dot3CollTable=dot3CollTable, dot3HCStatsEntry=dot3HCStatsEntry, dot3StatsDeferredTransmissions=dot3StatsDeferredTransmissions, dot3ControlFunctionsSupported=dot3ControlFunctionsSupported, dot3StatsEntry=dot3StatsEntry, etherStats100MbsGroup=etherStats100MbsGroup, dot3OutPauseFrames=dot3OutPauseFrames, dot3HCStatsInternalMacTransmitErrors=dot3HCStatsInternalMacTransmitErrors, dot3StatsRateControlAbility=dot3StatsRateControlAbility, dot3StatsFCSErrors=dot3StatsFCSErrors, dot3StatsEtherChipSet=dot3StatsEtherChipSet, etherControlPauseGroup=etherControlPauseGroup, etherStatsHalfDuplexGroup=etherStatsHalfDuplexGroup, ether100MbsCompliance=ether100MbsCompliance, dot3StatsCarrierSenseErrors=dot3StatsCarrierSenseErrors, dot3StatsFrameTooLongs=dot3StatsFrameTooLongs, etherRateControlGroup=etherRateControlGroup, dot3ErrorInitError=dot3ErrorInitError, etherCompliances=etherCompliances, etherMIBObjects=etherMIBObjects, dot3ControlEntry=dot3ControlEntry, etherHCStatsGroup=etherHCStatsGroup, etherStatsHighSpeedGroup=etherStatsHighSpeedGroup, etherStatsBaseGroup=etherStatsBaseGroup, dot3=dot3, dot3HCControlInUnknownOpcodes=dot3HCControlInUnknownOpcodes, dot3PauseTable=dot3PauseTable, dot3Compliance=dot3Compliance, dot3StatsLateCollisions=dot3StatsLateCollisions, etherMIB=etherMIB, dot3HCStatsSymbolErrors=dot3HCStatsSymbolErrors, dot3StatsAlignmentErrors=dot3StatsAlignmentErrors, etherGroups=etherGroups, dot3HCStatsAlignmentErrors=dot3HCStatsAlignmentErrors, dot3Tests=dot3Tests, dot3StatsDuplexStatus=dot3StatsDuplexStatus, dot3CollEntry=dot3CollEntry, dot3CollFrequencies=dot3CollFrequencies, dot3StatsTable=dot3StatsTable, dot3StatsRateControlStatus=dot3StatsRateControlStatus, etherCollisionTableGroup=etherCollisionTableGroup, etherCompliance=etherCompliance, dot3ControlInUnknownOpcodes=dot3ControlInUnknownOpcodes, dot3StatsInternalMacTransmitErrors=dot3StatsInternalMacTransmitErrors, etherStatsBaseGroup2=etherStatsBaseGroup2, etherControlGroup=etherControlGroup, etherHCControlPauseGroup=etherHCControlPauseGroup, dot3HCStatsInternalMacReceiveErrors=dot3HCStatsInternalMacReceiveErrors, dot3StatsSymbolErrors=dot3StatsSymbolErrors, dot3CollCount=dot3CollCount)
