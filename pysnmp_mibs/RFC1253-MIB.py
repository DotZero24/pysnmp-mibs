...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/rfc/RFC1253-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:47:38 2025
...
mibBuilder.exportSymbols("RFC1253-MIB", ospfHostStatus=ospfHostStatus, ospfStubAreaID=ospfStubAreaID, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfGeneralGroup=ospfGeneralGroup, PositiveInteger=PositiveInteger, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrEntry=ospfVirtNbrEntry, Validation=Validation, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, UpToMaxAge=UpToMaxAge, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbTable=ospfLsdbTable, ospfIfEntry=ospfIfEntry, ospfAdminStat=ospfAdminStat, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfMetricStatus=ospfIfMetricStatus, ospfExternLSACksumSum=ospfExternLSACksumSum, TruthValue=TruthValue, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLsdbType=ospfLsdbType, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrRtrId=ospfNbrRtrId, ospfAuthType=ospfAuthType, ospfNbrPriority=ospfNbrPriority, RouterID=RouterID, ospf=ospf, ospfExternLSACount=ospfExternLSACount, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubTOS=ospfStubTOS, ospfIfMetricMetric=ospfIfMetricMetric, ospfLsdbAreaId=ospfLsdbAreaId, ospfSpfRuns=ospfSpfRuns, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaTable=ospfAreaTable, HelloRange=HelloRange, ospfNbrEntry=ospfNbrEntry, ospfIfAreaId=ospfIfAreaId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfStubStatus=ospfStubStatus, ospfHostEntry=ospfHostEntry, ospfIfAdminStat=ospfIfAdminStat, ospfNbrState=ospfNbrState, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfASBdrRtrCount=ospfASBdrRtrCount, ospfVirtIfAreaID=ospfVirtIfAreaID, ospfVirtNbrLSRetransQLen=ospfVirtNbrLSRetransQLen, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfStubMetric=ospfStubMetric, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaEntry=ospfAreaEntry, ospfAreaLSACksumSum=ospfAreaLSACksumSum, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrLSRetransQLen=ospfNbrLSRetransQLen, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfMetricTable=ospfIfMetricTable, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeAreaID=ospfAreaRangeAreaID, ospfVirtIfState=ospfVirtIfState, ospfStubAreaEntry=ospfStubAreaEntry, ospfTOSSupport=ospfTOSSupport, ospfNbrEvents=ospfNbrEvents, TOSType=TOSType, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, Metric=Metric, ospfOriginateNewLSAs=ospfOriginateNewLSAs, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfImportASExtern=ospfImportASExtern, InterfaceIndex=InterfaceIndex, ospfIfState=ospfIfState, ospfNbrOptions=ospfNbrOptions, ospfHostTable=ospfHostTable, ospfNbrTable=ospfNbrTable, ospfHostMetric=ospfHostMetric, ospfAddressLessIf=ospfAddressLessIf, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricTOS=ospfIfMetricTOS, BigMetric=BigMetric, ospfRxNewLSAs=ospfRxNewLSAs, ospfIfType=ospfIfType, ospfRouterId=ospfRouterId, ospfNBMANbrStatus=ospfNBMANbrStatus, Status=Status, ospfIfAuthKey=ospfIfAuthKey, ospfStubAreaTable=ospfStubAreaTable, ospfAreaLSACount=ospfAreaLSACount, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfEvents=ospfIfEvents, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfRtrPriority=ospfIfRtrPriority, AreaID=AreaID, ospfVirtNbrState=ospfVirtNbrState, ospfLsdbLSID=ospfLsdbLSID, ospfIfIpAddress=ospfIfIpAddress, ospfHostTOS=ospfHostTOS, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaId=ospfAreaId, ospfIfTable=ospfIfTable)
