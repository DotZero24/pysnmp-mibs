# SNMP MIB module (RFC1253-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/rfc/RFC1253-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:18:01 2025
...
_OspfAuthType_Type.__name__ = "Integer32"
...
_OspfImportASExtern_Type.__name__ = "TruthValue"
...
_OspfSpfRuns_Type.__name__ = "Counter32"
...
_OspfAreaBdrRtrCount_Type.__name__ = "Gauge32"
...
_OspfASBdrRtrCount_Type.__name__ = "Gauge32"
...
_OspfAreaLSACount_Type.__name__ = "Gauge32"
...
_OspfStubStatus_Type.__name__ = "Validation"
...
ospfLsdbEntry.setIndexNames(
    (0, "RFC1253-MIB", "ospfLsdbAreaId"),
    (0, "RFC1253-MIB", "ospfLsdbType"),
    (0, "RFC1253-MIB", "ospfLsdbLSID"),
    (0, "RFC1253-MIB", "ospfLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
ospfAreaRangeEntry.setIndexNames(
    ...
    (0, "RFC1253-MIB", "ospfAreaRangeNet"),
)
if mibBuilder.loadTexts:
...
_OspfAreaRangeStatus_Type.__name__ = "Validation"
...
ospfHostEntry.setIndexNames(
    (0, "RFC1253-MIB", "ospfHostIpAddress"),
    (0, "RFC1253-MIB", "ospfHostTOS"),
)
if mibBuilder.loadTexts:
...
_OspfHostStatus_Type.__name__ = "Validation"
...
ospfIfEntry.setIndexNames(
    (0, "RFC1253-MIB", "ospfIfIpAddress"),
    (0, "RFC1253-MIB", "ospfAddressLessIf"),
)
if mibBuilder.loadTexts:
...
_OspfIfEvents_Type.__name__ = "Counter32"
...
ospfIfMetricEntry.setIndexNames(
    (0, "RFC1253-MIB", "ospfIfMetricIpAddress"),
    (0, "RFC1253-MIB", "ospfIfMetricAddressLessIf"),
    (0, "RFC1253-MIB", "ospfIfMetricTOS"),
)
if mibBuilder.loadTexts:
...
_OspfIfMetricStatus_Type.__name__ = "Validation"
...
ospfVirtIfEntry.setIndexNames(
    (0, "RFC1253-MIB", "ospfVirtIfAreaID"),
    (0, "RFC1253-MIB", "ospfVirtIfNeighbor"),
)
if mibBuilder.loadTexts:
...
_OspfVirtIfEvents_Type.__name__ = "Counter32"
...
_OspfVirtIfStatus_Type.__name__ = "Validation"
...
ospfNbrEntry.setIndexNames(
    (0, "RFC1253-MIB", "ospfNbrIpAddr"),
    (0, "RFC1253-MIB", "ospfNbrAddressLessIndex"),
)
if mibBuilder.loadTexts:
...
_OspfNbrEvents_Type.__name__ = "Counter32"
...
_OspfNbrLSRetransQLen_Type.__name__ = "Gauge32"
...
_OspfNBMANbrStatus_Type.__name__ = "Validation"
...
ospfVirtNbrEntry.setIndexNames(
    (0, "RFC1253-MIB", "ospfVirtNbrArea"),
    (0, "RFC1253-MIB", "ospfVirtNbrRtrId"),
)
if mibBuilder.loadTexts:
