...
mibBuilder.exportSymbols("RFC1253-MIB", ospfExternLSACount=ospfExternLSACount, ospfASBdrRtrCount=ospfASBdrRtrCount, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfAuthKey=ospfIfAuthKey, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbType=ospfLsdbType, Metric=Metric, ospfRouterId=ospfRouterId, ospfNbrState=ospfNbrState, ospfIfMetricEntry=ospfIfMetricEntry, RouterID=RouterID, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrEntry=ospfNbrEntry, ospfStubMetric=ospfStubMetric, ospfNbrTable=ospfNbrTable, TruthValue=TruthValue, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrEvents=ospfVirtNbrEvents, BigMetric=BigMetric, ospfIfTransitDelay=ospfIfTransitDelay, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeAreaID=ospfAreaRangeAreaID, ospfIfIpAddress=ospfIfIpAddress, ospfAreaId=ospfAreaId, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfEntry=ospfVirtIfEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAuthType=ospfAuthType, Validation=Validation, ospfAreaLSACksumSum=ospfAreaLSACksumSum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbLSID=ospfLsdbLSID, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, TOSType=TOSType, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfTOSSupport=ospfTOSSupport, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfStubAreaTable=ospfStubAreaTable, ospfAdminStat=ospfAdminStat, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostEntry=ospfHostEntry, ospfNbrPriority=ospfNbrPriority, ospfLsdbSequence=ospfLsdbSequence, ospfLsdbEntry=ospfLsdbEntry, ospfIfEntry=ospfIfEntry, ospfAreaTable=ospfAreaTable, ospfIfState=ospfIfState, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaRangeStatus=ospfAreaRangeStatus, HelloRange=HelloRange, ospfHostTOS=ospfHostTOS, ospfHostMetric=ospfHostMetric, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfStubTOS=ospfStubTOS, ospfLsdbTable=ospfLsdbTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfImportASExtern=ospfImportASExtern, AreaID=AreaID, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostTable=ospfHostTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfRetransInterval=ospfIfRetransInterval, ospfStubAreaID=ospfStubAreaID, ospfNBMANbrStatus=ospfNBMANbrStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfAreaId=ospfIfAreaId, ospfIfRtrPriority=ospfIfRtrPriority, UpToMaxAge=UpToMaxAge, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfMetricTable=ospfIfMetricTable, ospfSpfRuns=ospfSpfRuns, ospf=ospf, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrLSRetransQLen=ospfNbrLSRetransQLen, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfGeneralGroup=ospfGeneralGroup, ospfAddressLessIf=ospfAddressLessIf, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaEntry=ospfAreaEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfTable=ospfIfTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, Status=Status, ospfIfEvents=ospfIfEvents, ospfExternLSACksumSum=ospfExternLSACksumSum, ospfVirtNbrLSRetransQLen=ospfVirtNbrLSRetransQLen, ospfVersionNumber=ospfVersionNumber, InterfaceIndex=InterfaceIndex, ospfLsdbAge=ospfLsdbAge, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfAreaID=ospfVirtIfAreaID, ospfVirtIfTable=ospfVirtIfTable, ospfIfPollInterval=ospfIfPollInterval, ospfNbrEvents=ospfNbrEvents, ospfAreaLSACount=ospfAreaLSACount, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfMetricMetric=ospfIfMetricMetric, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostStatus=ospfHostStatus, ospfIfType=ospfIfType, PositiveInteger=PositiveInteger, ospfOriginateNewLSAs=ospfOriginateNewLSAs, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRxNewLSAs=ospfRxNewLSAs, ospfStubStatus=ospfStubStatus)
