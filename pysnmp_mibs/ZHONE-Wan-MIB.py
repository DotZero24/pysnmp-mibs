...
ifIndex, ifAlias, InterfaceIndex = mibBuilder.importSymbols("IF-MIB", "ifIndex", "ifAlias", "InterfaceIndex")
...
mibBuilder.exportSymbols("ZHONE-Wan-MIB", zhoneDs1TimeslotAssignment=zhoneDs1TimeslotAssignment, zhoneCurrentDMs=zhoneCurrentDMs, zhoneTotalDMs=zhoneTotalDMs, zhoneChanMappedIfIndex=zhoneChanMappedIfIndex, zhoneClockSourceEligibility=zhoneClockSourceEligibility, zhoneDs1TxClockRecovery=zhoneDs1TxClockRecovery, zhoneIntervalDMs=zhoneIntervalDMs, zhoneDsxLineLength=zhoneDsxLineLength, zhoneTotalLCVs=zhoneTotalLCVs, zhoneDs1FarEndIntervalTable=zhoneDs1FarEndIntervalTable, zhoneFarEndTotalSEFSs=zhoneFarEndTotalSEFSs, zhoneFarEndTotalPCVs=zhoneFarEndTotalPCVs, zhoneIntervalLCVs=zhoneIntervalLCVs, zhoneIntervalSESs=zhoneIntervalSESs, zhoneIntervalPCVs=zhoneIntervalPCVs, zhoneDsxTrapsV2=zhoneDsxTrapsV2, zhoneDs1TotalEntry=zhoneDs1TotalEntry, zhoneDs1LinePower=zhoneDs1LinePower, zhoneFarEndIntervalSEFSs=zhoneFarEndIntervalSEFSs, zhoneDsxTraps=zhoneDsxTraps, zhoneDs1FarEndIntervalEntry=zhoneDs1FarEndIntervalEntry, zhoneFarEndIntervalDMs=zhoneFarEndIntervalDMs, zhoneFarEndTotalDMs=zhoneFarEndTotalDMs, zhoneCurrentUASs=zhoneCurrentUASs, zhoneTotalESs=zhoneTotalESs, zhoneFarEndIntervalBESs=zhoneFarEndIntervalBESs, zhoneFarEndCurrentDMs=zhoneFarEndCurrentDMs, zhoneBertOutOfSynchSeconds=zhoneBertOutOfSynchSeconds, zhoneLineStatus=zhoneLineStatus, PYSNMP_MODULE_ID=zhoneDs1Mib, zhoneFarEndCurrentBESs=zhoneFarEndCurrentBESs, zhoneSignalMode=zhoneSignalMode, zhoneFarEndTotalSESs=zhoneFarEndTotalSESs, zhoneDs1SignalType=zhoneDs1SignalType, zhoneCurrentSEFSs=zhoneCurrentSEFSs, zhoneChanMappingTable=zhoneChanMappingTable, zhoneDs1GroupIndex=zhoneDs1GroupIndex, zhoneLineStatusLastChange=zhoneLineStatusLastChange, zhoneBertLoopUp=zhoneBertLoopUp, zhoneFarEndIntervalUASs=zhoneFarEndIntervalUASs, zhoneCurrentLESs=zhoneCurrentLESs, zhoneFarEndCurrentSEFSs=zhoneFarEndCurrentSEFSs, zhoneDs1FarEndTotalEntry=zhoneDs1FarEndTotalEntry, zhoneSendCode=zhoneSendCode, zhoneInvalidIntervals=zhoneInvalidIntervals, zhoneTotalCSSs=zhoneTotalCSSs, zhoneDs1FarEndCurrentEntry=zhoneDs1FarEndCurrentEntry, zhoneLineIndex=zhoneLineIndex, zhoneFarEndCurrentCSSs=zhoneFarEndCurrentCSSs, zhoneFarEndIntervalCSSs=zhoneFarEndIntervalCSSs, zhoneIntervalSEFSs=zhoneIntervalSEFSs, zhoneLineStatusChangeTrapEnable=zhoneLineStatusChangeTrapEnable, zhoneBertInterfaceIndex=zhoneBertInterfaceIndex, zhoneBertStatus=zhoneBertStatus, zhoneIntervalCSSs=zhoneIntervalCSSs, zhoneDs1BertResultsTable=zhoneDs1BertResultsTable, zhoneFarEndTotalBESs=zhoneFarEndTotalBESs, zhoneFarEndCurrentPCVs=zhoneFarEndCurrentPCVs, zhoneIntervalESs=zhoneIntervalESs, zhoneCsuLineLength=zhoneCsuLineLength, zhoneTotalSEFSs=zhoneTotalSEFSs, zhoneDs1BertEntry=zhoneDs1BertEntry, zhoneFarEndCurrentESs=zhoneFarEndCurrentESs, zhoneIntervalValidData=zhoneIntervalValidData, zhoneFarEndIntervalNumber=zhoneFarEndIntervalNumber, zhoneTimeElapsed=zhoneTimeElapsed, zhoneCurrentESs=zhoneCurrentESs, zhoneCurrentLCVs=zhoneCurrentLCVs, zhoneIntervalNumber=zhoneIntervalNumber, zhoneIntervalBESs=zhoneIntervalBESs, zhoneDs1Table=zhoneDs1Table, zhoneLineType=zhoneLineType, zhoneBertElapsedTime=zhoneBertElapsedTime, zhoneCurrentSESs=zhoneCurrentSESs, zhoneFarEndTotalCSSs=zhoneFarEndTotalCSSs, zhoneChannelization=zhoneChannelization, zhoneDs1CurrentTable=zhoneDs1CurrentTable, zhoneTotalPCVs=zhoneTotalPCVs, zhoneFarEndCurrentLESs=zhoneFarEndCurrentLESs, zhoneDs1IntervalTable=zhoneDs1IntervalTable, zhoneTransmitClockSource=zhoneTransmitClockSource, zhoneDs1ChannelNumber=zhoneDs1ChannelNumber, zhoneCurrentCSSs=zhoneCurrentCSSs, zhoneIntervalLESs=zhoneIntervalLESs, zhoneFarEndIntervalPCVs=zhoneFarEndIntervalPCVs, zhoneTotalIndex=zhoneTotalIndex, zhoneLoopbackStatus=zhoneLoopbackStatus, zhoneFarEndCurrentUASs=zhoneFarEndCurrentUASs, zhoneCurrentBESs=zhoneCurrentBESs, zhoneTotalSESs=zhoneTotalSESs, zhoneFarEndIntervalValidData=zhoneFarEndIntervalValidData, zhoneFarEndTotalIndex=zhoneFarEndTotalIndex, zhoneBertRequest=zhoneBertRequest, zhoneDs1BertTable=zhoneDs1BertTable, zhoneDs1BertResultsEntry=zhoneDs1BertResultsEntry, zhoneFarEndTotalUASs=zhoneFarEndTotalUASs, zhoneFarEndCurrentIndex=zhoneFarEndCurrentIndex, zhoneCosetPolynomial=zhoneCosetPolynomial, zhoneLineCoding=zhoneLineCoding, zhoneTotalBESs=zhoneTotalBESs, zhoneDs1FarEndCurrentTable=zhoneDs1FarEndCurrentTable, zhoneBertIndex=zhoneBertIndex, zhoneDs1TxClockAdaptiveQuality=zhoneDs1TxClockAdaptiveQuality, zhoneFarEndTotalESs=zhoneFarEndTotalESs, zhoneFarEndInvalidIntervals=zhoneFarEndInvalidIntervals, zhoneFarEndIntervalIndex=zhoneFarEndIntervalIndex, zhoneBertErroredSeconds=zhoneBertErroredSeconds, zhoneCellScramble=zhoneCellScramble, zhoneFarEndIntervalLESs=zhoneFarEndIntervalLESs, zhoneLineStatusChange=zhoneLineStatusChange, zhoneDs1TotalTable=zhoneDs1TotalTable, zhoneBertErrors=zhoneBertErrors, zhoneFarEndValidIntervals=zhoneFarEndValidIntervals, zhoneValidIntervals=zhoneValidIntervals, zhoneDs1FarEndTotalTable=zhoneDs1FarEndTotalTable, zhoneDs1CurrentEntry=zhoneDs1CurrentEntry, zhoneIntervalUASs=zhoneIntervalUASs, zhoneDs1IntervalEntry=zhoneDs1IntervalEntry, zhoneDs1Entry=zhoneDs1Entry, zhoneCircuitIdentifier=zhoneCircuitIdentifier, zhoneFarEndIntervalESs=zhoneFarEndIntervalESs, zhoneFarEndCurrentSESs=zhoneFarEndCurrentSESs, zhoneTotalUASs=zhoneTotalUASs, zhoneDs1Mode=zhoneDs1Mode, zhoneTotalLESs=zhoneTotalLESs, zhoneBertTestDuration=zhoneBertTestDuration, zhoneDs1Mib=zhoneDs1Mib, zhoneCurrentPCVs=zhoneCurrentPCVs, zhoneDs1ProtocolEmulation=zhoneDs1ProtocolEmulation, zhoneIntervalIndex=zhoneIntervalIndex, zhoneBertType=zhoneBertType, zhoneCurrentIndex=zhoneCurrentIndex, zhoneFdl=zhoneFdl, zhoneFarEndIntervalSESs=zhoneFarEndIntervalSESs, zhoneFarEndTimeElapsed=zhoneFarEndTimeElapsed, zhoneChanMappingEntry=zhoneChanMappingEntry, zhoneLoopbackConfig=zhoneLoopbackConfig, zhoneFarEndTotalLESs=zhoneFarEndTotalLESs)
