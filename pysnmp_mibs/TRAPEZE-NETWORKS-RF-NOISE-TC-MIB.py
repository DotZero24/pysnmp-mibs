# SNMP MIB module (TRAPEZE-NETWORKS-RF-NOISE-TC-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/trapeze/TRAPEZE-NETWORKS-RF-NOISE-TC-MIB
...
trpzRFNoiseTc = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 14525, 4, 22)
)
if mibBuilder.loadTexts:
    trpzRFNoiseTc.setRevisions(
        ("2011-01-10 00:00",)
    )
