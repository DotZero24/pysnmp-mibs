...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LWAPP-DHCP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:40:12 2025
...
_CLDhcpClearAllStats_Type.__name__ = "TruthValue"
...
class _CLDhcpClearStats_Type(TruthValue):
    """Custom type cLDhcpClearStats based on TruthValue"""
    defaultValue = 2


_CLDhcpClearStats_Type.__name__ = "TruthValue"
...
ciscoLwappDhcpMIBCompliance.setObjects(
    ("CISCO-LWAPP-DHCP-MIB", "ciscoLwappDhcpMIBConfigGroup")
)
if mibBuilder.loadTexts:
