...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IP-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:26:28 2025
...
_CiiHelperAddressStorage_Type.__name__ = "StorageType"
...
ciscoIPIfMIBCompliance.setObjects(
      *(("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup1"),
        ("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup2"))
)
if mibBuilder.loadTexts:
...
ciscoIPIfMIBCompliance1.setObjects(
      *(("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup1"),
        ("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup2"),
        ("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup3"),
        ("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup4"))
)
if mibBuilder.loadTexts:
...
ciscoIPIfMIBCompliance2.setObjects(
      *(("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup1"),
        ("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup2"),
        ("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup3"),
        ("CISCO-IP-IF-MIB", "ciscoIPIfAddressConfigurationGroup4"),
