...
DisplayString, TimeInterval, TimeStamp, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeInterval", "TimeStamp", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("COPS-CLIENT-MIB", copsClientServerConfigTcpPort=copsClientServerConfigTcpPort, CopsTcpPort=CopsTcpPort, copsClientLastError=copsClientLastError, copsClientServerKeepaliveTime=copsClientServerKeepaliveTime, copsDeviceStatusGroup=copsDeviceStatusGroup, copsClientErrUnsupportClienttype=copsClientErrUnsupportClienttype, copsClientErrAuthMissing=copsClientErrAuthMissing, copsClientServerConfigRetryIntvl=copsClientServerConfigRetryIntvl, copsClientServerClientType=copsClientServerClientType, CopsErrorCode=CopsErrorCode, copsClientServerAuthType=copsClientServerAuthType, copsClientServerAddress=copsClientServerAddress, copsDeviceConfigGroup=copsDeviceConfigGroup, CopsServerEntryType=CopsServerEntryType, copsClientKaTimedoutClients=copsClientKaTimedoutClients, copsClientState=copsClientState, copsClientServerAccountingTime=copsClientServerAccountingTime, copsClientMIB=copsClientMIB, PYSNMP_MODULE_ID=copsClientMIB, copsClientTcpConnectFailures=copsClientTcpConnectFailures, copsClientServerConfigAddress=copsClientServerConfigAddress, copsClientServerConfigRowStatus=copsClientServerConfigRowStatus, copsClientCompliances=copsClientCompliances, copsClientErrUnknownCnum=copsClientErrUnknownCnum, copsClientErrBadSends=copsClientErrBadSends, copsClientServerConfigPriority=copsClientServerConfigPriority, copsClientServerCurrentTable=copsClientServerCurrentTable, copsClientErrWrongOpcode=copsClientErrWrongOpcode, copsClientServerConfigEntry=copsClientServerConfigEntry, copsClientErrAuthFailures=copsClientErrAuthFailures, copsClientOpenAttempts=copsClientOpenAttempts, copsClientServerConfigAuthType=copsClientServerConfigAuthType, copsClientTcpConnectAttempts=copsClientTcpConnectAttempts, copsClientInErrs=copsClientInErrs, CopsAuthType=CopsAuthType, copsClientOutPkts=copsClientOutPkts, copsClientErrBadCtype=copsClientErrBadCtype, copsClientServerConfigClientType=copsClientServerConfigClientType, copsClientCapabilities=copsClientCapabilities, copsClientServerConfigRetryCount=copsClientServerConfigRetryCount, copsClientConformance=copsClientConformance, copsClientErrUnknownOpcode=copsClientErrUnknownOpcode, copsClientStatusGroup=copsClientStatusGroup, copsClientServerTcpPort=copsClientServerTcpPort, copsClientServerCurrentEntry=copsClientServerCurrentEntry, copsClientServerConfigRetryAlgrm=copsClientServerConfigRetryAlgrm, copsClientServerConfigTable=copsClientServerConfigTable, copsClientCapabilitiesGroup=copsClientCapabilitiesGroup, copsClientErrLengthMismatch=copsClientErrLengthMismatch, CopsClientState=CopsClientState, copsClientGroups=copsClientGroups, copsClientMIBObjects=copsClientMIBObjects, copsClientInPkts=copsClientInPkts, copsClientServerType=copsClientServerType, copsClientConfigGroup=copsClientConfigGroup, copsClientServerLastConnAttempt=copsClientServerLastConnAttempt, copsClientServerConfigAddrType=copsClientServerConfigAddrType, copsClientServerAddressType=copsClientServerAddressType, copsClientOpenFailures=copsClientOpenFailures, copsClientErrWrongObjects=copsClientErrWrongObjects, copsClientErrUnsupportedVersion=copsClientErrUnsupportedVersion, copsClientCompliance=copsClientCompliance)
