...
# Notes
# -----
# ASN.1 source file://mibs/rfc/COPS-CLIENT-MIB
...
_CopsClientServerConfigRetryCount_Type.__name__ = "Unsigned32"
...
_CopsClientServerConfigRetryIntvl_Type.__name__ = "TimeInterval"
...
copsClientCompliance.setObjects(
      *(("COPS-CLIENT-MIB", "copsDeviceStatusGroup"),
        ("COPS-CLIENT-MIB", "copsDeviceConfigGroup"))
)
if mibBuilder.loadTexts:
