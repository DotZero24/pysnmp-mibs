...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IF-LINK-CONFIG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:41:50 2025
...
cilConfigMIBCompliance.setObjects(
    ("CISCO-IF-LINK-CONFIG-MIB", "cilConfMIBGroup")
)
if mibBuilder.loadTexts:
...
cilConfigMIBComplianceRev1.setObjects(
    ("CISCO-IF-LINK-CONFIG-MIB", "cilConfMIBGroupRev1")
)
if mibBuilder.loadTexts:
