...
adslConnection=NotificationType((1,3,6,1,4,1,34751,0,0))
adslConnection.setObjects(*((_A,_D),(_A,_F),(_A,_C)))
if mibBuilder.loadTexts:adslConnection.setStatus('')
adslPeriod=NotificationType((1,3,6,1,4,1,34751,0,1))
...
mibBuilder.exportSymbols('QTECH-NMSTRAP-MIB',**{'adslConnection':adslConnection,'adslPeriod':adslPeriod})