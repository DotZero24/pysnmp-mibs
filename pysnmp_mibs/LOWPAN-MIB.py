...
# Notes
# -----
# ASN.1 source file://mibs/rfc/LOWPAN-MIB
...
lowpanCompliance.setObjects(
      *(("LOWPAN-MIB", "lowpanStatsGroup"),
        ("LOWPAN-MIB", "lowpanStatsMeshGroup"),
        ("LOWPAN-MIB", "lowpanIfStatsGroup"),
        ("LOWPAN-MIB", "lowpanIfStatsMeshGroup"))
)
if mibBuilder.loadTexts:
