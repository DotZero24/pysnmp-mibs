...
# Notes
# -----
# ASN.1 source file://mibs/tplink/TPLINK-AAA-MIB
...
class _AaaEnableAdminPassword_Type(OctetString):
    """Custom type aaaEnableAdminPassword based on OctetString"""
...
_AaaEnableAdminPassword_Type.__name__ = "OctetString"
_AaaEnableAdminPassword_Object = MibScalar
aaaEnableAdminPassword = _AaaEnableAdminPassword_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 82, 1, 2),
    _AaaEnableAdminPassword_Type()
)
aaaEnableAdminPassword.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    aaaEnableAdminPassword.setStatus("current")
_AaaApplicationList_ObjectIdentity = ObjectIdentity
aaaApplicationList = _AaaApplicationList_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11863, 6, 82, 1, 3)
)
_AaaApplicationListTable_Object = MibTable
aaaApplicationListTable = _AaaApplicationListTable_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 82, 1, 3, 1)
)
if mibBuilder.loadTexts:
...
aaaApplicationListEntry = _AaaApplicationListEntry_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 82, 1, 3, 1, 1)
)
...
moduleId = _ModuleId_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 82, 1, 3, 1, 1, 1),
    _ModuleId_Type()
)
...
moduleName = _ModuleName_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 82, 1, 3, 1, 1, 2),
    _ModuleName_Type()
)
...
loginList = _LoginList_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 82, 1, 3, 1, 1, 3),
    _LoginList_Type()
)
...
enableList = _EnableList_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 82, 1, 3, 1, 1, 4),
    _EnableList_Type()
)
...
radiusDeamonServerIp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
class _RadiusDeamonNasId_Type(OctetString):
    """Custom type radiusDeamonNasId based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 31),
    )
...
_RadiusDeamonNasId_Type.__name__ = "OctetString"
_RadiusDeamonNasId_Object = MibTableColumn
radiusDeamonNasId = _RadiusDeamonNasId_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 82, 4, 1, 7),
    _RadiusDeamonNasId_Type()
)
radiusDeamonNasId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    radiusDeamonNasId.setStatus("current")
...
tacacsDeamonServerIp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"tplinkAaaMIB": tplinkAaaMIB,
       ...
       "aaaEnableAdminPassword": aaaEnableAdminPassword,
