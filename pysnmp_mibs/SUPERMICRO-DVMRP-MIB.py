...
dvmrpMIB=ModuleIdentity((1,3,6,1,4,1,10876,101,1,60))
...
dvmrpScalar=_DvmrpScalar_ObjectIdentity((1,3,6,1,4,1,10876,101,1,60,1))
_DvmrpVersionString_Type=DisplayString
_DvmrpVersionString_Object=MibScalar
dvmrpVersionString=_DvmrpVersionString_Object((1,3,6,1,4,1,10876,101,1,60,1,1),_DvmrpVersionString_Type())
...
dvmrpGenerationId=_DvmrpGenerationId_Object((1,3,6,1,4,1,10876,101,1,60,1,2),_DvmrpGenerationId_Type())
...
dvmrpNumRoutes=_DvmrpNumRoutes_Object((1,3,6,1,4,1,10876,101,1,60,1,3),_DvmrpNumRoutes_Type())
...
dvmrpReachableRoutes=_DvmrpReachableRoutes_Object((1,3,6,1,4,1,10876,101,1,60,1,4),_DvmrpReachableRoutes_Type())
...
dvmrpStatus=_DvmrpStatus_Object((1,3,6,1,4,1,10876,101,1,60,1,5),_DvmrpStatus_Type())
...
dvmrpLogEnabled=_DvmrpLogEnabled_Object((1,3,6,1,4,1,10876,101,1,60,1,6),_DvmrpLogEnabled_Type())
...
dvmrpLogMask=_DvmrpLogMask_Object((1,3,6,1,4,1,10876,101,1,60,1,7),_DvmrpLogMask_Type())
...
dvmrpPruneLifeTime=_DvmrpPruneLifeTime_Object((1,3,6,1,4,1,10876,101,1,60,1,8),_DvmrpPruneLifeTime_Type())
...
dvmrp=_Dvmrp_ObjectIdentity((1,3,6,1,4,1,10876,101,1,60,2))
_DvmrpInterfaceTable_Object=MibTable
dvmrpInterfaceTable=_DvmrpInterfaceTable_Object((1,3,6,1,4,1,10876,101,1,60,2,9))
if mibBuilder.loadTexts:dvmrpInterfaceTable.setStatus(_A)
_DvmrpInterfaceEntry_Object=MibTableRow
dvmrpInterfaceEntry=_DvmrpInterfaceEntry_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1))
...
dvmrpInterfaceIfIndex=_DvmrpInterfaceIfIndex_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,1),_DvmrpInterfaceIfIndex_Type())
...
dvmrpInterfaceStatus=_DvmrpInterfaceStatus_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,2),_DvmrpInterfaceStatus_Type())
...
dvmrpInterfaceLocalAddress=_DvmrpInterfaceLocalAddress_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,3),_DvmrpInterfaceLocalAddress_Type())
...
dvmrpInterfaceMetric=_DvmrpInterfaceMetric_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,4),_DvmrpInterfaceMetric_Type())
...
dvmrpInterfaceRcvBadPkts=_DvmrpInterfaceRcvBadPkts_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,5),_DvmrpInterfaceRcvBadPkts_Type())
...
dvmrpInterfaceRcvBadRoutes=_DvmrpInterfaceRcvBadRoutes_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,6),_DvmrpInterfaceRcvBadRoutes_Type())
...
dvmrpInterfaceTtl=_DvmrpInterfaceTtl_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,7),_DvmrpInterfaceTtl_Type())
...
dvmrpInterfaceProtocol=_DvmrpInterfaceProtocol_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,8),_DvmrpInterfaceProtocol_Type())
...
dvmrpInterfaceRateLimit=_DvmrpInterfaceRateLimit_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,9),_DvmrpInterfaceRateLimit_Type())
...
dvmrpInterfaceInMcastOctets=_DvmrpInterfaceInMcastOctets_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,10),_DvmrpInterfaceInMcastOctets_Type())
...
dvmrpInterfaceOutMcastOctets=_DvmrpInterfaceOutMcastOctets_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,11),_DvmrpInterfaceOutMcastOctets_Type())
...
dvmrpInterfaceHCInMcastOctets=_DvmrpInterfaceHCInMcastOctets_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,12),_DvmrpInterfaceHCInMcastOctets_Type())
...
dvmrpInterfaceHCOutMcastOctets=_DvmrpInterfaceHCOutMcastOctets_Object((1,3,6,1,4,1,10876,101,1,60,2,9,1,13),_DvmrpInterfaceHCOutMcastOctets_Type())
...
dvmrpNeighborTable=_DvmrpNeighborTable_Object((1,3,6,1,4,1,10876,101,1,60,2,10))
if mibBuilder.loadTexts:dvmrpNeighborTable.setStatus(_A)
_DvmrpNeighborEntry_Object=MibTableRow
dvmrpNeighborEntry=_DvmrpNeighborEntry_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1))
...
dvmrpNeighborIfIndex=_DvmrpNeighborIfIndex_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,1),_DvmrpNeighborIfIndex_Type())
...
dvmrpNeighborAddress=_DvmrpNeighborAddress_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,2),_DvmrpNeighborAddress_Type())
...
dvmrpNeighborUpTime=_DvmrpNeighborUpTime_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,3),_DvmrpNeighborUpTime_Type())
...
dvmrpNeighborExpiryTime=_DvmrpNeighborExpiryTime_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,4),_DvmrpNeighborExpiryTime_Type())
...
dvmrpNeighborGenerationId=_DvmrpNeighborGenerationId_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,5),_DvmrpNeighborGenerationId_Type())
...
dvmrpNeighborMajorVersion=_DvmrpNeighborMajorVersion_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,6),_DvmrpNeighborMajorVersion_Type())
...
dvmrpNeighborMinorVersion=_DvmrpNeighborMinorVersion_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,7),_DvmrpNeighborMinorVersion_Type())
...
dvmrpNeighborCapabilities=_DvmrpNeighborCapabilities_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,8),_DvmrpNeighborCapabilities_Type())
...
dvmrpNeighborRcvRoutes=_DvmrpNeighborRcvRoutes_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,9),_DvmrpNeighborRcvRoutes_Type())
...
dvmrpNeighborRcvBadPkts=_DvmrpNeighborRcvBadPkts_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,10),_DvmrpNeighborRcvBadPkts_Type())
...
dvmrpNeighborRcvBadRoutes=_DvmrpNeighborRcvBadRoutes_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,11),_DvmrpNeighborRcvBadRoutes_Type())
...
dvmrpNeighborAdjFlag=_DvmrpNeighborAdjFlag_Object((1,3,6,1,4,1,10876,101,1,60,2,10,1,12),_DvmrpNeighborAdjFlag_Type())
...
dvmrpRouteTable=_DvmrpRouteTable_Object((1,3,6,1,4,1,10876,101,1,60,2,11))
if mibBuilder.loadTexts:dvmrpRouteTable.setStatus(_A)
_DvmrpRouteEntry_Object=MibTableRow
dvmrpRouteEntry=_DvmrpRouteEntry_Object((1,3,6,1,4,1,10876,101,1,60,2,11,1))
...
dvmrpRouteSource=_DvmrpRouteSource_Object((1,3,6,1,4,1,10876,101,1,60,2,11,1,1),_DvmrpRouteSource_Type())
...
dvmrpRouteSourceMask=_DvmrpRouteSourceMask_Object((1,3,6,1,4,1,10876,101,1,60,2,11,1,2),_DvmrpRouteSourceMask_Type())
...
dvmrpRouteUpstreamNeighbor=_DvmrpRouteUpstreamNeighbor_Object((1,3,6,1,4,1,10876,101,1,60,2,11,1,3),_DvmrpRouteUpstreamNeighbor_Type())
...
dvmrpRouteIfIndex=_DvmrpRouteIfIndex_Object((1,3,6,1,4,1,10876,101,1,60,2,11,1,4),_DvmrpRouteIfIndex_Type())
...
dvmrpRouteMetric=_DvmrpRouteMetric_Object((1,3,6,1,4,1,10876,101,1,60,2,11,1,5),_DvmrpRouteMetric_Type())
...
dvmrpRouteExpiryTime=_DvmrpRouteExpiryTime_Object((1,3,6,1,4,1,10876,101,1,60,2,11,1,6),_DvmrpRouteExpiryTime_Type())
...
dvmrpRouteUpTime=_DvmrpRouteUpTime_Object((1,3,6,1,4,1,10876,101,1,60,2,11,1,7),_DvmrpRouteUpTime_Type())
...
dvmrpRouteStatus=_DvmrpRouteStatus_Object((1,3,6,1,4,1,10876,101,1,60,2,11,1,8),_DvmrpRouteStatus_Type())
...
dvmrpRouteNextHopTable=_DvmrpRouteNextHopTable_Object((1,3,6,1,4,1,10876,101,1,60,2,12))
if mibBuilder.loadTexts:dvmrpRouteNextHopTable.setStatus(_A)
_DvmrpRouteNextHopEntry_Object=MibTableRow
dvmrpRouteNextHopEntry=_DvmrpRouteNextHopEntry_Object((1,3,6,1,4,1,10876,101,1,60,2,12,1))
...
dvmrpRouteNextHopSource=_DvmrpRouteNextHopSource_Object((1,3,6,1,4,1,10876,101,1,60,2,12,1,1),_DvmrpRouteNextHopSource_Type())
...
dvmrpRouteNextHopSourceMask=_DvmrpRouteNextHopSourceMask_Object((1,3,6,1,4,1,10876,101,1,60,2,12,1,2),_DvmrpRouteNextHopSourceMask_Type())
...
dvmrpRouteNextHopIfIndex=_DvmrpRouteNextHopIfIndex_Object((1,3,6,1,4,1,10876,101,1,60,2,12,1,3),_DvmrpRouteNextHopIfIndex_Type())
...
dvmrpRouteNextHopType=_DvmrpRouteNextHopType_Object((1,3,6,1,4,1,10876,101,1,60,2,12,1,4),_DvmrpRouteNextHopType_Type())
...
dvmrpRouteNextHopDesigForw=_DvmrpRouteNextHopDesigForw_Object((1,3,6,1,4,1,10876,101,1,60,2,12,1,5),_DvmrpRouteNextHopDesigForw_Type())
...
dvmrpRouteNextHopDepNbrs=_DvmrpRouteNextHopDepNbrs_Object((1,3,6,1,4,1,10876,101,1,60,2,12,1,6),_DvmrpRouteNextHopDepNbrs_Type())
...
dvmrpForwardTable=_DvmrpForwardTable_Object((1,3,6,1,4,1,10876,101,1,60,2,13))
if mibBuilder.loadTexts:dvmrpForwardTable.setStatus(_A)
_DvmrpForwardEntry_Object=MibTableRow
dvmrpForwardEntry=_DvmrpForwardEntry_Object((1,3,6,1,4,1,10876,101,1,60,2,13,1))
...
dvmrpSourceNetwork=_DvmrpSourceNetwork_Object((1,3,6,1,4,1,10876,101,1,60,2,13,1,1),_DvmrpSourceNetwork_Type())
...
dvmrpGroupAddress=_DvmrpGroupAddress_Object((1,3,6,1,4,1,10876,101,1,60,2,13,1,2),_DvmrpGroupAddress_Type())
...
dvmrpForwardUpstreamNeighbor=_DvmrpForwardUpstreamNeighbor_Object((1,3,6,1,4,1,10876,101,1,60,2,13,1,3),_DvmrpForwardUpstreamNeighbor_Type())
...
dvmrpForwardInIfIndex=_DvmrpForwardInIfIndex_Object((1,3,6,1,4,1,10876,101,1,60,2,13,1,4),_DvmrpForwardInIfIndex_Type())
...
dvmrpForwardInIfState=_DvmrpForwardInIfState_Object((1,3,6,1,4,1,10876,101,1,60,2,13,1,5),_DvmrpForwardInIfState_Type())
...
dvmrpForwardExpiryTime=_DvmrpForwardExpiryTime_Object((1,3,6,1,4,1,10876,101,1,60,2,13,1,6),_DvmrpForwardExpiryTime_Type())
...
dvmrpForwardTblStatus=_DvmrpForwardTblStatus_Object((1,3,6,1,4,1,10876,101,1,60,2,13,1,7),_DvmrpForwardTblStatus_Type())
...
dvmrpForwardPruneNbrTable=_DvmrpForwardPruneNbrTable_Object((1,3,6,1,4,1,10876,101,1,60,2,14))
if mibBuilder.loadTexts:dvmrpForwardPruneNbrTable.setStatus(_A)
_DvmrpForwardPruneNbrEntry_Object=MibTableRow
dvmrpForwardPruneNbrEntry=_DvmrpForwardPruneNbrEntry_Object((1,3,6,1,4,1,10876,101,1,60,2,14,1))
...
dvmrpForwardSourceNetwork=_DvmrpForwardSourceNetwork_Object((1,3,6,1,4,1,10876,101,1,60,2,14,1,1),_DvmrpForwardSourceNetwork_Type())
...
dvmrpForwardGroupAddress=_DvmrpForwardGroupAddress_Object((1,3,6,1,4,1,10876,101,1,60,2,14,1,2),_DvmrpForwardGroupAddress_Type())
...
dvmrpForwardIfIndex=_DvmrpForwardIfIndex_Object((1,3,6,1,4,1,10876,101,1,60,2,14,1,3),_DvmrpForwardIfIndex_Type())
...
dvmrpForwardPruneNeighbor=_DvmrpForwardPruneNeighbor_Object((1,3,6,1,4,1,10876,101,1,60,2,14,1,4),_DvmrpForwardPruneNeighbor_Type())
...
dvmrpForwardNbrPruneTime=_DvmrpForwardNbrPruneTime_Object((1,3,6,1,4,1,10876,101,1,60,2,14,1,5),_DvmrpForwardNbrPruneTime_Type())
...
dvmrpIpMRTable=_DvmrpIpMRTable_Object((1,3,6,1,4,1,10876,101,1,60,2,15))
if mibBuilder.loadTexts:dvmrpIpMRTable.setStatus(_A)
_DvmrpIpMREntry_Object=MibTableRow
dvmrpIpMREntry=_DvmrpIpMREntry_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1))
...
dvmrpIpMRGroup=_DvmrpIpMRGroup_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,1),_DvmrpIpMRGroup_Type())
...
dvmrpIpMRSource=_DvmrpIpMRSource_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,2),_DvmrpIpMRSource_Type())
...
dvmrpIpMRSourceMask=_DvmrpIpMRSourceMask_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,3),_DvmrpIpMRSourceMask_Type())
...
dvmrpIpMRUpstreamNeighbor=_DvmrpIpMRUpstreamNeighbor_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,4),_DvmrpIpMRUpstreamNeighbor_Type())
...
dvmrpIpMRInIfIndex=_DvmrpIpMRInIfIndex_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,5),_DvmrpIpMRInIfIndex_Type())
...
dvmrpIpMRUpTime=_DvmrpIpMRUpTime_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,6),_DvmrpIpMRUpTime_Type())
...
dvmrpIpMRExpiryTime=_DvmrpIpMRExpiryTime_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,7),_DvmrpIpMRExpiryTime_Type())
...
dvmrpIpMRPkts=_DvmrpIpMRPkts_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,8),_DvmrpIpMRPkts_Type())
...
dvmrpIpMRDifferentInIfPackets=_DvmrpIpMRDifferentInIfPackets_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,9),_DvmrpIpMRDifferentInIfPackets_Type())
...
dvmrpIpMROctets=_DvmrpIpMROctets_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,10),_DvmrpIpMROctets_Type())
...
dvmrpIpMRProtocol=_DvmrpIpMRProtocol_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,11),_DvmrpIpMRProtocol_Type())
...
dvmrpIpMRRtProto=_DvmrpIpMRRtProto_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,12),_DvmrpIpMRRtProto_Type())
...
dvmrpIpMRRtAddress=_DvmrpIpMRRtAddress_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,13),_DvmrpIpMRRtAddress_Type())
...
dvmrpIpMRRtMask=_DvmrpIpMRRtMask_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,14),_DvmrpIpMRRtMask_Type())
...
dvmrpIpMRRtType=_DvmrpIpMRRtType_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,15),_DvmrpIpMRRtType_Type())
...
dvmrpIpMRHCOctets=_DvmrpIpMRHCOctets_Object((1,3,6,1,4,1,10876,101,1,60,2,15,1,16),_DvmrpIpMRHCOctets_Type())
...
dvmrpIpMNextHopTable=_DvmrpIpMNextHopTable_Object((1,3,6,1,4,1,10876,101,1,60,2,16))
if mibBuilder.loadTexts:dvmrpIpMNextHopTable.setStatus(_A)
_DvmrpIpMNextHopEntry_Object=MibTableRow
dvmrpIpMNextHopEntry=_DvmrpIpMNextHopEntry_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1))
...
dvmrpIpMNextHopGroup=_DvmrpIpMNextHopGroup_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,1),_DvmrpIpMNextHopGroup_Type())
...
dvmrpIpMNextHopSource=_DvmrpIpMNextHopSource_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,2),_DvmrpIpMNextHopSource_Type())
...
dvmrpIpMNextHopSourceMask=_DvmrpIpMNextHopSourceMask_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,3),_DvmrpIpMNextHopSourceMask_Type())
...
dvmrpIpMNextHopIfIndex=_DvmrpIpMNextHopIfIndex_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,4),_DvmrpIpMNextHopIfIndex_Type())
...
dvmrpIpMNextHopAddress=_DvmrpIpMNextHopAddress_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,5),_DvmrpIpMNextHopAddress_Type())
...
dvmrpIpMNextHopState=_DvmrpIpMNextHopState_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,6),_DvmrpIpMNextHopState_Type())
...
dvmrpIpMNextHopUpTime=_DvmrpIpMNextHopUpTime_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,7),_DvmrpIpMNextHopUpTime_Type())
...
dvmrpIpMNextHopExpiryTime=_DvmrpIpMNextHopExpiryTime_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,8),_DvmrpIpMNextHopExpiryTime_Type())
...
dvmrpIpMNextHopProtocol=_DvmrpIpMNextHopProtocol_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,9),_DvmrpIpMNextHopProtocol_Type())
...
dvmrpIpMNextHopPkts=_DvmrpIpMNextHopPkts_Object((1,3,6,1,4,1,10876,101,1,60,2,16,1,10),_DvmrpIpMNextHopPkts_Type())
...
dvmrpMIBConformance=_DvmrpMIBConformance_ObjectIdentity((1,3,6,1,4,1,10876,101,1,60,3))
_DvmrpMIBCompliances_ObjectIdentity=ObjectIdentity
dvmrpMIBCompliances=_DvmrpMIBCompliances_ObjectIdentity((1,3,6,1,4,1,10876,101,1,60,3,1))
_DvmrpMIBGroups_ObjectIdentity=ObjectIdentity
dvmrpMIBGroups=_DvmrpMIBGroups_ObjectIdentity((1,3,6,1,4,1,10876,101,1,60,3,2))
dvmrpGeneralGroup=ObjectGroup((1,3,6,1,4,1,10876,101,1,60,3,2,2))
dvmrpGeneralGroup.setObjects(*((_C,_c),(_C,_d),(_C,_e),(_C,_f)))
if mibBuilder.loadTexts:dvmrpGeneralGroup.setStatus(_A)
dvmrpInterfaceGroup=ObjectGroup((1,3,6,1,4,1,10876,101,1,60,3,2,3))
dvmrpInterfaceGroup.setObjects(*((_C,_g),(_C,_h),(_C,_i),(_C,_j)))
if mibBuilder.loadTexts:dvmrpInterfaceGroup.setStatus(_A)
dvmrpNeighborGroup=ObjectGroup((1,3,6,1,4,1,10876,101,1,60,3,2,4))
...
dvmrpRoutingGroup=ObjectGroup((1,3,6,1,4,1,10876,101,1,60,3,2,5))
dvmrpRoutingGroup.setObjects(*((_C,_t),(_C,_u),(_C,_v),(_C,_w),(_C,_x),(_C,_y)))
if mibBuilder.loadTexts:dvmrpRoutingGroup.setStatus(_A)
dvmrpMIBCompliance=ModuleCompliance((1,3,6,1,4,1,10876,101,1,60,3,1,1))
