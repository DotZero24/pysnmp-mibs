...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-PIM-MIB
...
cPimSparseV2MIBCompliance.setObjects(
      *(("CISCO-IETF-PIM-MIB", "cPimV2MIBGroup"),
        ("CISCO-IETF-PIM-MIB", "cPimV2CRPMIBGroup"))
)
if mibBuilder.loadTexts:
...
cPimDenseV2MIBCompliance.setObjects(
    ("CISCO-IETF-PIM-MIB", "cPimDenseV2MIBGroup")
)
if mibBuilder.loadTexts:
