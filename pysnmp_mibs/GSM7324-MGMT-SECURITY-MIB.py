# SNMP MIB module (GSM7324-MGMT-SECURITY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/GSM7324-MGMT-SECURITY-MIB
...
gsm7324MgmtSecurity = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 11)
)
if mibBuilder.loadTexts:
    gsm7324MgmtSecurity.setRevisions(
        ("2003-11-21 00:00",)
    )
...
mibBuilder.exportSymbols(
    "GSM7324-MGMT-SECURITY-MIB",
    **{"gsm7324MgmtSecurity": gsm7324MgmtSecurity,
