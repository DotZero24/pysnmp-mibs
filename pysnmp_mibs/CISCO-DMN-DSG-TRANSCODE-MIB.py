...
mibBuilder.exportSymbols("CISCO-DMN-DSG-TRANSCODE-MIB", ciscoDSGTranscode=ciscoDSGTranscode, transcoderCfgHDAspectRatio=transcoderCfgHDAspectRatio, transcoderSubtBackGround=transcoderSubtBackGround, transcoderCfgSDBitRateMode=transcoderCfgSDBitRateMode, transcoderSubtIndex=transcoderSubtIndex, transcoderCfgHDManualGOP=transcoderCfgHDManualGOP, transcoderCfgHDARConversion=transcoderCfgHDARConversion, transcoderStatusEntry=transcoderStatusEntry, transcoderSubtOpMode=transcoderSubtOpMode, transcoderCfgPCRRate=transcoderCfgPCRRate, PYSNMP_MODULE_ID=ciscoDSGTranscode, transcoderCfgCCPkt2=transcoderCfgCCPkt2, transcoderLOIAction=transcoderLOIAction, transcoderCfgSDHRes=transcoderCfgSDHRes, transcoderCfgSDManualGOP=transcoderCfgSDManualGOP, transcoderCfgHDHRes=transcoderCfgHDHRes, transcoderCfgCCPkt1=transcoderCfgCCPkt1, transcoderCfgCCPkt3=transcoderCfgCCPkt3, transcoderSubtForeGround=transcoderSubtForeGround, transcoderCfgApplyInband=transcoderCfgApplyInband, transcoderCfgSDAspectRatio=transcoderCfgSDAspectRatio, transcoderCfgHDBitRate=transcoderCfgHDBitRate, transcoderSubtManualEntry=transcoderSubtManualEntry, transcoderCfgHDVideoPreproc=transcoderCfgHDVideoPreproc, transcoderSubtLangList=transcoderSubtLangList, transcoderCfgHDGOP=transcoderCfgHDGOP, transcoderCfgIndex=transcoderCfgIndex, transcoderCfgSDVideoPreproc=transcoderCfgSDVideoPreproc, transcoderStatusTable=transcoderStatusTable, transcoderCfgSDGOP=transcoderCfgSDGOP, transcoderCfgHD32PullDown=transcoderCfgHD32PullDown, transcoderCfgSDARConversion=transcoderCfgSDARConversion, transcoderSubtPMTOrder=transcoderSubtPMTOrder, transcoderCfgSDBitRate=transcoderCfgSDBitRate, transcoderSubtImitextPos=transcoderSubtImitextPos, transcoderCfgVRes=transcoderCfgVRes, transcoderSubtLangMenu=transcoderSubtLangMenu, transcoderSubtTable=transcoderSubtTable, transcoderCfgTable=transcoderCfgTable, transcoderStatusVideoStream=transcoderStatusVideoStream, transcoderInfo=transcoderInfo, transcoderStatusIndex=transcoderStatusIndex, transcoderCfgHDBitrateMode=transcoderCfgHDBitrateMode, transcoderCfgSD32PullDown=transcoderCfgSD32PullDown, transcoderSubtEntry=transcoderSubtEntry, transcoderCfgEntry=transcoderCfgEntry, transcoderTable=transcoderTable)
