...
mibBuilder.exportSymbols("CALISTA-DPA-MIB", callManagerConnectionEntry=callManagerConnectionEntry, cmConnectionIpPort=cmConnectionIpPort, mwiCommandsReceived=mwiCommandsReceived, outgoingCallsMade=outgoingCallsMade, pbxMWIErrors=pbxMWIErrors, pbxType=pbxType, callManagerConnectionTable=callManagerConnectionTable, portType=portType, integrationMode=integrationMode, callManagerCompletedMWICommands=callManagerCompletedMWICommands, portTable=portTable, cmConnectionIndex=cmConnectionIndex, portDeviceName=portDeviceName, cmConnectionIpAddress=cmConnectionIpAddress, serialNumber=serialNumber, portIndex=portIndex, portErrors=portErrors, callManagerMWIErrors=callManagerMWIErrors, portEntry=portEntry, pbxCompletedMWICommands=pbxCompletedMWICommands, cmConnectionCallManagerName=cmConnectionCallManagerName, calista=calista, cmConnectionState=cmConnectionState, pbxQueuedMWICommands=pbxQueuedMWICommands, loaderVersion=loaderVersion, portCallState=portCallState, portCallManagerLinkState=portCallManagerLinkState, portTelephonyLinkState=portTelephonyLinkState, portDacLevel=portDacLevel, callManagerQueuedMWICommands=callManagerQueuedMWICommands, imageVersion=imageVersion, cmConnectionPortIndex=cmConnectionPortIndex, portCodecInUse=portCodecInUse, products=products, receivedCalls=receivedCalls, DisplayString=DisplayString, dpa=dpa)
