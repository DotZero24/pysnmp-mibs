...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-DSL-ATM-BOND-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:59:41 2025
...
pdnDslAtmBondMIBCompliance.setObjects(
      *(("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondMappingGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondPerfAggDataRateGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondPerfBondGroupStatusGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondNotificationsGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondMaxRateGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondMinRateGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondDiffDelayGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondGroupStatusNotifyEnabledGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondIndexMappingGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondInvMappingGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondDateAndTimeGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondRunTimeGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondRxCellLossGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondPerfFailReasonGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondFailCountGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondUASGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondTrafficCapGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslATmBondAsmRxStatusGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondAlarmConfProfileGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondAlarmConfAtucThreshRateGroup"),
        ("PDN-DSL-ATM-BOND-MIB", "pdnDslAtmBondAlarmConfAturThreshRateGroup"))
)
if mibBuilder.loadTexts:
