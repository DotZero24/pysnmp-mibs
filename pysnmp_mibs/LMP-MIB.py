...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/LMP-MIB
...
ModuleIdentity, transmission, Counter64, Integer32, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, iso, MibIdentifier, TimeTicks, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "transmission", "Counter64", "Integer32", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "iso", "MibIdentifier", "TimeTicks", "Bits", "IpAddress")
...
TeLinkEncodingType, teLinkRemoteIpAddr, teLinkIncomingIfId = mibBuilder.importSymbols("TE-LINK-STD-MIB", "TeLinkEncodingType", "teLinkRemoteIpAddr", "teLinkIncomingIfId")
...
mibBuilder.exportSymbols("LMP-MIB", lmpDataLinkTestReceived=lmpDataLinkTestReceived, lmpCcConfigAckReceived=lmpCcConfigAckReceived, lmpCcTestStatusFailureSent=lmpCcTestStatusFailureSent, lmpTeTestStatusAckSent=lmpTeTestStatusAckSent, lmpCcBeginVerifyReceived=lmpCcBeginVerifyReceived, lmpTeBeginVerifyAckSent=lmpTeBeginVerifyAckSent, lmpCcIsNotInterfaceGroup=lmpCcIsNotInterfaceGroup, lmpMIB=lmpMIB, lmpNbrOperStatus=lmpNbrOperStatus, lmpTeLinkPerfEntry=lmpTeLinkPerfEntry, lmpNbrRetryLimit=lmpNbrRetryLimit, lmpCcChannelStatusRspReceived=lmpCcChannelStatusRspReceived, lmpConformance=lmpConformance, lmpCcAdminStatus=lmpCcAdminStatus, lmpControlChannelGroup=lmpControlChannelGroup, lmpCcConfigRetransmit=lmpCcConfigRetransmit, lmpTeLinkSummaryAckSent=lmpTeLinkSummaryAckSent, lmpCcChannelStatusRetransmit=lmpCcChannelStatusRetransmit, lmpCcBeginVerifyNackSent=lmpCcBeginVerifyNackSent, lmpModuleFullCompliance=lmpModuleFullCompliance, lmpCcChannelStatusSent=lmpCcChannelStatusSent, lmpGroups=lmpGroups, lmpTeCounterDiscontinuityTime=lmpTeCounterDiscontinuityTime, lmpDataLinkPassiveTestFailure=lmpDataLinkPassiveTestFailure, lmpCcAuthentication=lmpCcAuthentication, lmpCcBeginVerifyAckSent=lmpCcBeginVerifyAckSent, lmpTeLinkTable=lmpTeLinkTable, lmpCcHelloIntervalMin=lmpCcHelloIntervalMin, lmpDataLinkEncodingType=lmpDataLinkEncodingType, lmpLinkVerifyWavelength=lmpLinkVerifyWavelength, lmpTeTestStatusFailureReceived=lmpTeTestStatusFailureReceived, lmpCcEndVerifyAckSent=lmpCcEndVerifyAckSent, LmpRetransmitInterval=LmpRetransmitInterval, lmpLinkVerificationTable=lmpLinkVerificationTable, lmpNbrRetransmitDelta=lmpNbrRetransmitDelta, lmpTeBeginVerifyAckReceived=lmpTeBeginVerifyAckReceived, lmpControlChannelPerfEntry=lmpControlChannelPerfEntry, lmpCcChannelStatusReqRetransmit=lmpCcChannelStatusReqRetransmit, lmpTeEndVerifyReceived=lmpTeEndVerifyReceived, lmpDataLinkActiveTestSuccess=lmpDataLinkActiveTestSuccess, lmpLinkPropertyNotificationsEnabled=lmpLinkPropertyNotificationsEnabled, lmpCcRemoteAddressType=lmpCcRemoteAddressType, lmpCompliances=lmpCompliances, lmpTeLinkEntry=lmpTeLinkEntry, lmpCcInOctets=lmpCcInOctets, lmpTeChannelStatusRetransmit=lmpTeChannelStatusRetransmit, lmpDataLinkActiveTestFailure=lmpDataLinkActiveTestFailure, lmpCcLinkSummaryRetransmit=lmpCcLinkSummaryRetransmit, lmpCcInErrors=lmpCcInErrors, lmpCcLinkSummaryNackReceived=lmpCcLinkSummaryNackReceived, lmpLinkVerifyInterval=lmpLinkVerifyInterval, lmpCcIsIf=lmpCcIsIf, lmpCcOutOctets=lmpCcOutOctets, lmpCcLinkSummaryAckReceived=lmpCcLinkSummaryAckReceived, lmpNotificationMaxRate=lmpNotificationMaxRate, lmpCcEndVerifyReceived=lmpCcEndVerifyReceived, lmpTeLinkNotificationsEnabled=lmpTeLinkNotificationsEnabled, lmpCcCounterDiscontinuityTime=lmpCcCounterDiscontinuityTime, lmpCcIsInterfaceGroup=lmpCcIsInterfaceGroup, lmpTeTestStatusFailureRetransmit=lmpTeTestStatusFailureRetransmit, lmpCcHelloDeadIntervalNegotiated=lmpCcHelloDeadIntervalNegotiated, lmpCcHelloReceived=lmpCcHelloReceived, lmpCcChannelStatusReqSent=lmpCcChannelStatusReqSent, lmpTeLinkNotDegraded=lmpTeLinkNotDegraded, lmpCcHelloDeadIntervalDefaultMax=lmpCcHelloDeadIntervalDefaultMax, lmpCcTestStatusAckReceived=lmpCcTestStatusAckReceived, lmpTeLinkSummaryRetransmit=lmpTeLinkSummaryRetransmit, lmpTeLinkVerification=lmpTeLinkVerification, lmpLinkVerificationEntry=lmpLinkVerificationEntry, lmpCcLinkSummaryReceived=lmpCcLinkSummaryReceived, lmpCcUnderlyingIfIndex=lmpCcUnderlyingIfIndex, lmpTeInOctets=lmpTeInOctets, lmpLinkVerifyAllLinks=lmpLinkVerifyAllLinks, lmpCcRemoteId=lmpCcRemoteId, lmpTeChannelStatusReceived=lmpTeChannelStatusReceived, lmpObjects=lmpObjects, lmpCcHelloDeadIntervalDefault=lmpCcHelloDeadIntervalDefault, lmpDataLinkRemoteIfId=lmpDataLinkRemoteIfId, lmpLinkVerifyTransmissionRate=lmpLinkVerifyTransmissionRate, lmpCcTestStatusSuccessRetransmit=lmpCcTestStatusSuccessRetransmit, lmpTeChannelStatusReqSent=lmpTeChannelStatusReqSent, lmpPerfGroup=lmpPerfGroup, lmpCcInDiscards=lmpCcInDiscards, lmpCcNbrNodeId=lmpCcNbrNodeId, lmpTeEndVerifyAckSent=lmpTeEndVerifyAckSent, lmpTeTestStatusFailureSent=lmpTeTestStatusFailureSent, lmpControlChannelUp=lmpControlChannelUp, lmpControlChannelDown=lmpControlChannelDown, lmpTeChannelStatusSent=lmpTeChannelStatusSent, lmpCcEndVerifyAckReceived=lmpCcEndVerifyAckReceived, lmpTeLinkPropertyMismatch=lmpTeLinkPropertyMismatch, lmpDataLinkVerificationFailure=lmpDataLinkVerificationFailure, lmpCcTestStatusSuccessSent=lmpCcTestStatusSuccessSent, lmpCcLinkSummarySent=lmpCcLinkSummarySent, lmpDataLinkRowStatus=lmpDataLinkRowStatus, lmpTeBeginVerifyNackSent=lmpTeBeginVerifyNackSent, lmpNbrAdminStatus=lmpNbrAdminStatus, lmpTeChannelStatusAckReceived=lmpTeChannelStatusAckReceived, lmpCcLinkSummaryNackSent=lmpCcLinkSummaryNackSent, lmpCcRowStatus=lmpCcRowStatus, lmpOperStatus=lmpOperStatus, lmpCcLastChange=lmpCcLastChange, lmpCcOutDiscards=lmpCcOutDiscards, lmpTeBeginVerifyRetransmit=lmpTeBeginVerifyRetransmit, lmpTeChannelStatusReqRetransmit=lmpTeChannelStatusReqRetransmit, lmpNbrRowStatus=lmpNbrRowStatus, lmpDataLinkActiveOperStatus=lmpDataLinkActiveOperStatus, lmpTeLinkRowStatus=lmpTeLinkRowStatus, lmpCcConfigNackReceived=lmpCcConfigNackReceived, LmpNodeId=LmpNodeId, lmpCcTestStatusSuccessReceived=lmpCcTestStatusSuccessReceived, lmpNotificationGroup=lmpNotificationGroup, lmpTeLinkSummaryNackSent=lmpTeLinkSummaryNackSent, lmpCcEndVerifySent=lmpCcEndVerifySent, lmpDataLinkStorageType=lmpDataLinkStorageType, lmpLinkVerificationGroup=lmpLinkVerificationGroup, lmpTeBeginVerifyNackReceived=lmpTeBeginVerifyNackReceived, lmpTeTestStatusAckReceived=lmpTeTestStatusAckReceived, lmpCcHelloIntervalDefaultMax=lmpCcHelloIntervalDefaultMax, lmpCcStorageType=lmpCcStorageType, lmpCcHelloDeadIntervalMax=lmpCcHelloDeadIntervalMax, lmpLinkVerifyStorageType=lmpLinkVerifyStorageType, lmpTeChannelStatusReqReceived=lmpTeChannelStatusReqReceived, lmpDataLinkPerfEntry=lmpDataLinkPerfEntry, lmpLinkVerifyDeadInterval=lmpLinkVerifyDeadInterval, lmpTeLinkSummaryReceived=lmpTeLinkSummaryReceived, lmpLinkPropertyCorrelationGroup=lmpLinkPropertyCorrelationGroup, lmpCcChannelStatusRspSent=lmpCcChannelStatusRspSent, lmpCcSetupRole=lmpCcSetupRole, lmpCcUpDownNotificationsEnabled=lmpCcUpDownNotificationsEnabled, lmpTeEndVerifySent=lmpTeEndVerifySent, lmpDataLinkPerfTable=lmpDataLinkPerfTable, lmpLinkVerifyRowStatus=lmpLinkVerifyRowStatus, lmpTeLinkSummarySent=lmpTeLinkSummarySent, lmpCcConfigAckSent=lmpCcConfigAckSent, lmpGlobalLinkVerificationInterval=lmpGlobalLinkVerificationInterval, lmpTeEndVerifyRetransmit=lmpTeEndVerifyRetransmit, lmpNbrNodeId=lmpNbrNodeId, lmpDataLinkRemoteIpAddress=lmpDataLinkRemoteIpAddress, lmpTeLinkNbrRemoteNodeId=lmpTeLinkNbrRemoteNodeId, lmpControlChannelPerfTable=lmpControlChannelPerfTable, lmpTeLinkDegraded=lmpTeLinkDegraded, lmpTeTestStatusSuccessRetransmit=lmpTeTestStatusSuccessRetransmit, lmpControlChannelTable=lmpControlChannelTable, lmpCcChannelStatusReqReceived=lmpCcChannelStatusReqReceived, lmpDataLinkTable=lmpDataLinkTable, lmpControlChannelEntry=lmpControlChannelEntry, lmpDataLinkNotificationsEnabled=lmpDataLinkNotificationsEnabled, lmpTeChannelStatusAckSent=lmpTeChannelStatusAckSent, lmpCcLinkSummaryAckSent=lmpCcLinkSummaryAckSent, lmpTeOutOctets=lmpTeOutOctets, lmpCcTestStatusFailureReceived=lmpCcTestStatusFailureReceived, lmpNbrTable=lmpNbrTable, lmpLinkVerifyTransportMechanism=lmpLinkVerifyTransportMechanism, lmpDataLinkGroup=lmpDataLinkGroup, lmpCcChannelStatusReceived=lmpCcChannelStatusReceived, lmpCcConfigSent=lmpCcConfigSent, lmpCcBeginVerifyNackReceived=lmpCcBeginVerifyNackReceived, lmpCcHelloIntervalMax=lmpCcHelloIntervalMax, lmpCcBeginVerifyAckReceived=lmpCcBeginVerifyAckReceived, lmpDataLinkEntry=lmpDataLinkEntry, lmpCcRemoteIpAddr=lmpCcRemoteIpAddr, lmpNotifications=lmpNotifications, lmpTeLinkSummaryNackReceived=lmpTeLinkSummaryNackReceived, lmpTeLinkStorageType=lmpTeLinkStorageType, lmpTeTestStatusSuccessReceived=lmpTeTestStatusSuccessReceived, lmpCcConfigNackSent=lmpCcConfigNackSent, lmpTeBeginVerifySent=lmpTeBeginVerifySent, lmpCcOperStatus=lmpCcOperStatus, lmpCcChannelStatusAckSent=lmpCcChannelStatusAckSent, lmpDataLinkTestSent=lmpDataLinkTestSent, lmpTeLinkGroup=lmpTeLinkGroup, lmpCcHelloIntervalDefault=lmpCcHelloIntervalDefault, lmpNbrEntry=lmpNbrEntry, lmpCcTestStatusAckSent=lmpCcTestStatusAckSent, LmpInterval=LmpInterval, lmpCcHelloDeadInterval=lmpCcHelloDeadInterval, lmpTeLinkDwdm=lmpTeLinkDwdm, lmpTeTestStatusSuccessSent=lmpTeTestStatusSuccessSent, lmpModuleReadOnlyCompliance=lmpModuleReadOnlyCompliance, lmpCcConfigReceived=lmpCcConfigReceived, lmpCcHelloSent=lmpCcHelloSent, lmpTeChannelStatusRspReceived=lmpTeChannelStatusRspReceived, lmpDataLinkPropertyMismatch=lmpDataLinkPropertyMismatch, lmpTeLinkFaultManagement=lmpTeLinkFaultManagement, lmpCcBeginVerifySent=lmpCcBeginVerifySent, lmpTeEndVerifyAckReceived=lmpTeEndVerifyAckReceived, lmpCcHelloDeadIntervalDefaultMin=lmpCcHelloDeadIntervalDefaultMin, lmpTeLinkSummaryAckReceived=lmpTeLinkSummaryAckReceived, lmpAdminStatus=lmpAdminStatus, lmpCcBeginVerifyRetransmit=lmpCcBeginVerifyRetransmit, PYSNMP_MODULE_ID=lmpMIB, lmpUnprotectedNotificationsEnabled=lmpUnprotectedNotificationsEnabled, lmpNodeGroup=lmpNodeGroup, lmpCcOutErrors=lmpCcOutErrors, lmpDataLinkPassiveTestSuccess=lmpDataLinkPassiveTestSuccess, lmpTeBeginVerifyReceived=lmpTeBeginVerifyReceived, lmpCcHelloDeadIntervalMin=lmpCcHelloDeadIntervalMin, lmpCcEndVerifyRetransmit=lmpCcEndVerifyRetransmit, lmpCcTestStatusFailureRetransmit=lmpCcTestStatusFailureRetransmit, lmpDataLinkIpAddr=lmpDataLinkIpAddr, lmpNbrStorageType=lmpNbrStorageType, lmpDataLinkAddressType=lmpDataLinkAddressType, lmpUnprotected=lmpUnprotected, lmpCcHelloIntervalNegotiated=lmpCcHelloIntervalNegotiated, lmpTeChannelStatusRspSent=lmpTeChannelStatusRspSent, lmpDataLinkDiscontinuityTime=lmpDataLinkDiscontinuityTime, lmpNbrRetransmitInterval=lmpNbrRetransmitInterval, lmpCcChannelStatusAckReceived=lmpCcChannelStatusAckReceived, lmpTeLinkOperStatus=lmpTeLinkOperStatus, lmpTeLinkPerfTable=lmpTeLinkPerfTable, lmpDataLinkPassiveOperStatus=lmpDataLinkPassiveOperStatus, lmpCcId=lmpCcId, lmpCcHelloInterval=lmpCcHelloInterval, lmpCcHelloIntervalDefaultMin=lmpCcHelloIntervalDefaultMin, lmpDataLinkType=lmpDataLinkType)
