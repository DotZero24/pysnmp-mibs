...
fsMIUdp=_FsMIUdp_ObjectIdentity((1,3,6,1,4,1,10876,101,2,28,1))
_FsMiUdpInDatagrams_Type=Counter32
_FsMiUdpInDatagrams_Object=MibScalar
fsMiUdpInDatagrams=_FsMiUdpInDatagrams_Object((1,3,6,1,4,1,10876,101,2,28,1,1),_FsMiUdpInDatagrams_Type())
...
fsMiUdpNoPorts=_FsMiUdpNoPorts_Object((1,3,6,1,4,1,10876,101,2,28,1,2),_FsMiUdpNoPorts_Type())
...
fsMiUdpInErrors=_FsMiUdpInErrors_Object((1,3,6,1,4,1,10876,101,2,28,1,3),_FsMiUdpInErrors_Type())
...
fsMiUdpOutDatagrams=_FsMiUdpOutDatagrams_Object((1,3,6,1,4,1,10876,101,2,28,1,4),_FsMiUdpOutDatagrams_Type())
...
fsMiUdpInNoCksum=_FsMiUdpInNoCksum_Object((1,3,6,1,4,1,10876,101,2,28,1,5),_FsMiUdpInNoCksum_Type())
...
fsMiUdpInIcmpErr=_FsMiUdpInIcmpErr_Object((1,3,6,1,4,1,10876,101,2,28,1,6),_FsMiUdpInIcmpErr_Type())
...
fsMiUdpInErrCksum=_FsMiUdpInErrCksum_Object((1,3,6,1,4,1,10876,101,2,28,1,7),_FsMiUdpInErrCksum_Type())
...
fsMiUdpInBcast=_FsMiUdpInBcast_Object((1,3,6,1,4,1,10876,101,2,28,1,8),_FsMiUdpInBcast_Type())
...
fsMiUdpHCInDatagrams=_FsMiUdpHCInDatagrams_Object((1,3,6,1,4,1,10876,101,2,28,1,9),_FsMiUdpHCInDatagrams_Type())
...
fsMiUdpHCOutDatagrams=_FsMiUdpHCOutDatagrams_Object((1,3,6,1,4,1,10876,101,2,28,1,10),_FsMiUdpHCOutDatagrams_Type())
...
fsMIUdpStatTable=_FsMIUdpStatTable_Object((1,3,6,1,4,1,10876,101,2,28,1,11))
if mibBuilder.loadTexts:fsMIUdpStatTable.setStatus(_A)
_FsMIUdpStatEntry_Object=MibTableRow
fsMIUdpStatEntry=_FsMIUdpStatEntry_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1))
...
fsMiUdpIpvxContextId=_FsMiUdpIpvxContextId_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,1),_FsMiUdpIpvxContextId_Type())
...
fsMiUdpIpvxInDatagrams=_FsMiUdpIpvxInDatagrams_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,2),_FsMiUdpIpvxInDatagrams_Type())
...
fsMiUdpIpvxNoPorts=_FsMiUdpIpvxNoPorts_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,3),_FsMiUdpIpvxNoPorts_Type())
...
fsMiUdpIpvxInErrors=_FsMiUdpIpvxInErrors_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,4),_FsMiUdpIpvxInErrors_Type())
...
fsMiUdpIpvxOutDatagrams=_FsMiUdpIpvxOutDatagrams_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,5),_FsMiUdpIpvxOutDatagrams_Type())
...
fsMiUdpIpvxInNoCksum=_FsMiUdpIpvxInNoCksum_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,6),_FsMiUdpIpvxInNoCksum_Type())
...
fsMiUdpIpvxInIcmpErr=_FsMiUdpIpvxInIcmpErr_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,7),_FsMiUdpIpvxInIcmpErr_Type())
...
fsMiUdpIpvxInErrCksum=_FsMiUdpIpvxInErrCksum_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,8),_FsMiUdpIpvxInErrCksum_Type())
...
fsMiUdpIpvxInBcast=_FsMiUdpIpvxInBcast_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,9),_FsMiUdpIpvxInBcast_Type())
...
fsMiUdpIpvxHCInDatagrams=_FsMiUdpIpvxHCInDatagrams_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,10),_FsMiUdpIpvxHCInDatagrams_Type())
...
fsMiUdpIpvxHCOutDatagrams=_FsMiUdpIpvxHCOutDatagrams_Object((1,3,6,1,4,1,10876,101,2,28,1,11,1,11),_FsMiUdpIpvxHCOutDatagrams_Type())
...
fsMiUdpEndpointTable=_FsMiUdpEndpointTable_Object((1,3,6,1,4,1,10876,101,2,28,1,12))
if mibBuilder.loadTexts:fsMiUdpEndpointTable.setStatus(_A)
_FsMiUdpEndpointEntry_Object=MibTableRow
fsMiUdpEndpointEntry=_FsMiUdpEndpointEntry_Object((1,3,6,1,4,1,10876,101,2,28,1,12,1))
...
fsMiUdpEndpointLocalAddressType=_FsMiUdpEndpointLocalAddressType_Object((1,3,6,1,4,1,10876,101,2,28,1,12,1,1),_FsMiUdpEndpointLocalAddressType_Type())
...
fsMiUdpEndpointLocalAddress=_FsMiUdpEndpointLocalAddress_Object((1,3,6,1,4,1,10876,101,2,28,1,12,1,2),_FsMiUdpEndpointLocalAddress_Type())
...
fsMiUdpEndpointLocalPort=_FsMiUdpEndpointLocalPort_Object((1,3,6,1,4,1,10876,101,2,28,1,12,1,3),_FsMiUdpEndpointLocalPort_Type())
...
fsMiUdpEndpointRemoteAddressType=_FsMiUdpEndpointRemoteAddressType_Object((1,3,6,1,4,1,10876,101,2,28,1,12,1,4),_FsMiUdpEndpointRemoteAddressType_Type())
...
fsMiUdpEndpointRemoteAddress=_FsMiUdpEndpointRemoteAddress_Object((1,3,6,1,4,1,10876,101,2,28,1,12,1,5),_FsMiUdpEndpointRemoteAddress_Type())
...
fsMiUdpEndpointRemotePort=_FsMiUdpEndpointRemotePort_Object((1,3,6,1,4,1,10876,101,2,28,1,12,1,6),_FsMiUdpEndpointRemotePort_Type())
...
fsMiUdpEndpointInstance=_FsMiUdpEndpointInstance_Object((1,3,6,1,4,1,10876,101,2,28,1,12,1,7),_FsMiUdpEndpointInstance_Type())
...
fsMiUdpEndpointProcess=_FsMiUdpEndpointProcess_Object((1,3,6,1,4,1,10876,101,2,28,1,12,1,8),_FsMiUdpEndpointProcess_Type())
...
fsMiUdpIpvxEndpointTable=_FsMiUdpIpvxEndpointTable_Object((1,3,6,1,4,1,10876,101,2,28,1,13))
if mibBuilder.loadTexts:fsMiUdpIpvxEndpointTable.setStatus(_A)
_FsMiUdpIpvxEndpointEntry_Object=MibTableRow
fsMiUdpIpvxEndpointEntry=_FsMiUdpIpvxEndpointEntry_Object((1,3,6,1,4,1,10876,101,2,28,1,13,1))
...
fsMiUdpIpvxEndpointLocalAddressType=_FsMiUdpIpvxEndpointLocalAddressType_Object((1,3,6,1,4,1,10876,101,2,28,1,13,1,1),_FsMiUdpIpvxEndpointLocalAddressType_Type())
...
fsMiUdpIpvxEndpointLocalAddress=_FsMiUdpIpvxEndpointLocalAddress_Object((1,3,6,1,4,1,10876,101,2,28,1,13,1,2),_FsMiUdpIpvxEndpointLocalAddress_Type())
...
fsMiUdpIpvxEndpointLocalPort=_FsMiUdpIpvxEndpointLocalPort_Object((1,3,6,1,4,1,10876,101,2,28,1,13,1,3),_FsMiUdpIpvxEndpointLocalPort_Type())
...
fsMiUdpIpvxEndpointRemoteAddressType=_FsMiUdpIpvxEndpointRemoteAddressType_Object((1,3,6,1,4,1,10876,101,2,28,1,13,1,4),_FsMiUdpIpvxEndpointRemoteAddressType_Type())
...
fsMiUdpIpvxEndpointRemoteAddress=_FsMiUdpIpvxEndpointRemoteAddress_Object((1,3,6,1,4,1,10876,101,2,28,1,13,1,5),_FsMiUdpIpvxEndpointRemoteAddress_Type())
...
fsMiUdpIpvxEndpointRemotePort=_FsMiUdpIpvxEndpointRemotePort_Object((1,3,6,1,4,1,10876,101,2,28,1,13,1,6),_FsMiUdpIpvxEndpointRemotePort_Type())
...
fsMiUdpIpvxEndpointInstance=_FsMiUdpIpvxEndpointInstance_Object((1,3,6,1,4,1,10876,101,2,28,1,13,1,7),_FsMiUdpIpvxEndpointInstance_Type())
...
fsMiUdpIpvxEndpointProcess=_FsMiUdpIpvxEndpointProcess_Object((1,3,6,1,4,1,10876,101,2,28,1,13,1,8),_FsMiUdpIpvxEndpointProcess_Type())
