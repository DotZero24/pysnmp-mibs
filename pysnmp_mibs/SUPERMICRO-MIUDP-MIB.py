# SNMP MIB module (SUPERMICRO-MIUDP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-MIUDP-MIB
...
fsMiUdpNoPorts = _FsMiUdpNoPorts_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 2),
...
fsMiUdpInErrors = _FsMiUdpInErrors_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 3),
...
fsMiUdpOutDatagrams = _FsMiUdpOutDatagrams_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 4),
...
fsMiUdpInNoCksum = _FsMiUdpInNoCksum_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 5),
...
fsMiUdpInIcmpErr = _FsMiUdpInIcmpErr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 6),
...
fsMiUdpInErrCksum = _FsMiUdpInErrCksum_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 7),
...
fsMiUdpInBcast = _FsMiUdpInBcast_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 8),
...
fsMiUdpHCInDatagrams = _FsMiUdpHCInDatagrams_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 9),
...
fsMiUdpHCOutDatagrams = _FsMiUdpHCOutDatagrams_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 10),
...
fsMiUdpEndpointEntry = _FsMiUdpEndpointEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 12, 1)
)
fsMiUdpEndpointEntry.setIndexNames(
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpEndpointLocalAddressType"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpEndpointLocalAddress"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpEndpointLocalPort"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpEndpointRemoteAddressType"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpEndpointRemoteAddress"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpEndpointRemotePort"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpEndpointInstance"),
)
if mibBuilder.loadTexts:
...
fsMiUdpIpvxEndpointTable = _FsMiUdpIpvxEndpointTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 13)
)
if mibBuilder.loadTexts:
...
fsMiUdpIpvxEndpointEntry = _FsMiUdpIpvxEndpointEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 28, 1, 13, 1)
)
fsMiUdpIpvxEndpointEntry.setIndexNames(
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpIpvxContextId"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpIpvxEndpointLocalAddressType"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpIpvxEndpointLocalAddress"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpIpvxEndpointLocalPort"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpIpvxEndpointRemoteAddressType"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpIpvxEndpointRemoteAddress"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpIpvxEndpointRemotePort"),
    (0, "SUPERMICRO-MIUDP-MIB", "fsMiUdpIpvxEndpointInstance"),
)
if mibBuilder.loadTexts:
