...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/HPN-ICF-LswQos-MIB
...
mibBuilder.exportSymbols("HPN-ICF-LswQos-MIB", hpnicfBandwidthWeight=hpnicfBandwidthWeight, hpnicfFlowtempEnableVlanID=hpnicfFlowtempEnableVlanID, hpnicfBandwidthRowStatus=hpnicfBandwidthRowStatus, hpnicfRateLimitDirection=hpnicfRateLimitDirection, hpnicfQueueWeight7=hpnicfQueueWeight7, hpnicfCosToDscpMapReSet=hpnicfCosToDscpMapReSet, hpnicfBandwidthVlanID=hpnicfBandwidthVlanID, hpnicfCosToDropPrecedenceMapCosIndex=hpnicfCosToDropPrecedenceMapCosIndex, hpnicfRateLimitConformDscp=hpnicfRateLimitConformDscp, hpnicfQueueIfIndex=hpnicfQueueIfIndex, hpnicfMirroringGroupMirrorRowStatus=hpnicfMirroringGroupMirrorRowStatus, hpnicfMirroringGroupReflectorTable=hpnicfMirroringGroupReflectorTable, hpnicfRedIfIndex=hpnicfRedIfIndex, hpnicfWredQueueId=hpnicfWredQueueId, hpnicfRemarkVlanIDDirection=hpnicfRemarkVlanIDDirection, hpnicfRateLimitTargetRateKbps=hpnicfRateLimitTargetRateKbps, hpnicfCosToLocalPrecedenceMapCosIndex=hpnicfCosToLocalPrecedenceMapCosIndex, hpnicfPortTrustEntry=hpnicfPortTrustEntry, hpnicfRateLimitLinkAclRule=hpnicfRateLimitLinkAclRule, hpnicfPortQueueEntry=hpnicfPortQueueEntry, hpnicfRateLimitPeakRate=hpnicfRateLimitPeakRate, hpnicfMirroringGroupReflectorEntry=hpnicfMirroringGroupReflectorEntry, hpnicfMirroringGroupMirrorTable=hpnicfMirroringGroupMirrorTable, hpnicfRateLimitUserAclNum=hpnicfRateLimitUserAclNum, hpnicfQueueWeight5=hpnicfQueueWeight5, hpnicfFlowtempDIp=hpnicfFlowtempDIp, hpnicfPriorityCos=hpnicfPriorityCos, hpnicfDscpToCosMapCosValue=hpnicfDscpToCosMapCosValue, hpnicfMirroringGroupType=hpnicfMirroringGroupType, hpnicfRemarkVlanIDRemarkVlanID=hpnicfRemarkVlanIDRemarkVlanID, hpnicfCosToLocalPrecedenceMapTable=hpnicfCosToLocalPrecedenceMapTable, hpnicfDscpToCosMapDscpIndex=hpnicfDscpToCosMapDscpIndex, hpnicfFlowtempTable=hpnicfFlowtempTable, hpnicfFlowtempIpProtocol=hpnicfFlowtempIpProtocol, hpnicfDscpToDropPreMapReset=hpnicfDscpToDropPreMapReset, hpnicfRedirectAclIndex=hpnicfRedirectAclIndex, hpnicfRedirectRemarkedTos=hpnicfRedirectRemarkedTos, hpnicfBandwidthDirection=hpnicfBandwidthDirection, hpnicfMirroringGroupRowStatus=hpnicfMirroringGroupRowStatus, hpnicfTrafficShapeRowStatus=hpnicfTrafficShapeRowStatus, hpnicfCosToLocalPrecedenceMapLocalPrecedenceValue=hpnicfCosToLocalPrecedenceMapLocalPrecedenceValue, hpnicfPriorityLinkAclRule=hpnicfPriorityLinkAclRule, hpnicfStatisticRowStatus=hpnicfStatisticRowStatus, hpnicfExpMapLocalPrecedence=hpnicfExpMapLocalPrecedence, hpnicfTrafficShapeBurstSize=hpnicfTrafficShapeBurstSize, hpnicfPortWredTable=hpnicfPortWredTable, hpnicfRedTable=hpnicfRedTable, hpnicfFlowtempVpn=hpnicfFlowtempVpn, hpnicfDscpToCosMapEntry=hpnicfDscpToCosMapEntry, hpnicfMirroringGroupMonitorType=hpnicfMirroringGroupMonitorType, hpnicfRateLimitConformActionType=hpnicfRateLimitConformActionType, hpnicfWredYellowMaxProb=hpnicfWredYellowMaxProb, hpnicfPriorityIpPreFromCos=hpnicfPriorityIpPreFromCos, hpnicfRateLimitTable=hpnicfRateLimitTable, hpnicfBandwidthMinGuaranteedWidth=hpnicfBandwidthMinGuaranteedWidth, hpnicfMirroringGroupMonitorIfIndex=hpnicfMirroringGroupMonitorIfIndex, hpnicfMirrorGroupMonitorIfIndex=hpnicfMirrorGroupMonitorIfIndex, hpnicfPortTrustTable=hpnicfPortTrustTable, hpnicfTrafficShapeMaxRate=hpnicfTrafficShapeMaxRate, hpnicfQueueWeight3=hpnicfQueueWeight3, hpnicfMirrorLinkAclNum=hpnicfMirrorLinkAclNum, hpnicfFlowtempSMac=hpnicfFlowtempSMac, hpnicfRedirectLinkAclNum=hpnicfRedirectLinkAclNum, hpnicfWredRedMinThreshold=hpnicfWredRedMinThreshold, hpnicfMirrorAclIndex=hpnicfMirrorAclIndex, hpnicfMirrorToIfIndex=hpnicfMirrorToIfIndex, hpnicfPortQueueWrrPriority=hpnicfPortQueueWrrPriority, hpnicfDscpToCosMapReset=hpnicfDscpToCosMapReset, hpnicfRemarkVlanIDIpAclNum=hpnicfRemarkVlanIDIpAclNum, hpnicfRedirectDirection=hpnicfRedirectDirection, hpnicfFlowtempIpPre=hpnicfFlowtempIpPre, hpnicfStatisticByteXCount=hpnicfStatisticByteXCount, hpnicfPriorityDirection=hpnicfPriorityDirection, hpnicfRedirectLinkAclRule=hpnicfRedirectLinkAclRule, hpnicfTrafficShapeEntry=hpnicfTrafficShapeEntry, hpnicfExpMapDscpValue=hpnicfExpMapDscpValue, hpnicfFlowtempCos=hpnicfFlowtempCos, hpnicfStatisticPacketXCount=hpnicfStatisticPacketXCount, hpnicfLswQosAclMib=hpnicfLswQosAclMib, hpnicfRedirectToNextHop2=hpnicfRedirectToNextHop2, hpnicfDscpToDropPreMapDropPreVal=hpnicfDscpToDropPreMapDropPreVal, hpnicfLineRateIfIndex=hpnicfLineRateIfIndex, hpnicfDscpToDscpMapTable=hpnicfDscpToDscpMapTable, hpnicfPriorityPolicedServiceDscp=hpnicfPriorityPolicedServiceDscp, hpnicfRedirectRuntime=hpnicfRedirectRuntime, hpnicfPortTrustOvercastType=hpnicfPortTrustOvercastType, hpnicfRedirectToNextHop3=hpnicfRedirectToNextHop3, hpnicfMirroringGroupMirrorOutboundIfIndexList=hpnicfMirroringGroupMirrorOutboundIfIndexList, hpnicfMirroringGroupMonitorEntry=hpnicfMirroringGroupMonitorEntry, hpnicfExpMapDropPrecedence=hpnicfExpMapDropPrecedence, hpnicfDscpMapDscpIndex=hpnicfDscpMapDscpIndex, hpnicfRemarkVlanIDVlanID=hpnicfRemarkVlanIDVlanID, hpnicfMirroringGroupReflectorIfIndex=hpnicfMirroringGroupReflectorIfIndex, hpnicfRedVlanID=hpnicfRedVlanID, hpnicfPortQueueTable=hpnicfPortQueueTable, hpnicfQueueWeight1=hpnicfQueueWeight1, hpnicfCosToDscpMapCosIndex=hpnicfCosToDscpMapCosIndex, hpnicfRedProbability=hpnicfRedProbability, hpnicfRateLimitRowStatus=hpnicfRateLimitRowStatus, hpnicfPortQueueQueueID=hpnicfPortQueueQueueID, hpnicfMirroringGroupRprobeVlanEntry=hpnicfMirroringGroupRprobeVlanEntry, hpnicfMirrorGroupMirrorIfIndexList=hpnicfMirrorGroupMirrorIfIndexList, hpnicfStatisticUserAclRule=hpnicfStatisticUserAclRule, hpnicfPortMirrorDirection=hpnicfPortMirrorDirection, hpnicfPriorityDscp=hpnicfPriorityDscp, hpnicfRedirectMode=hpnicfRedirectMode, hpnicfLineRateDirection=hpnicfLineRateDirection, hpnicfPortQueueIfIndex=hpnicfPortQueueIfIndex, hpnicfFlowtempIndex=hpnicfFlowtempIndex, hpnicfPriorityAclIndex=hpnicfPriorityAclIndex, hpnicfPriorityTable=hpnicfPriorityTable, hpnicfPortQueueWeight=hpnicfPortQueueWeight, hpnicfRateLimitEntry=hpnicfRateLimitEntry, hpnicfWredGreenMaxProb=hpnicfWredGreenMaxProb, hpnicfQueueTable=hpnicfQueueTable, hpnicfRemarkVlanIDEntry=hpnicfRemarkVlanIDEntry, hpnicfMirroringGroupReflectorRowStatus=hpnicfMirroringGroupReflectorRowStatus, hpnicfPriorityLocalPre=hpnicfPriorityLocalPre, hpnicfRedirectTargetVlanID=hpnicfRedirectTargetVlanID, hpnicfRedStopQueueLen=hpnicfRedStopQueueLen, hpnicfMirroringGroupMirroMacStatus=hpnicfMirroringGroupMirroMacStatus, hpnicfRedRuntime=hpnicfRedRuntime, hpnicfDscpToDropPreMapEntry=hpnicfDscpToDropPreMapEntry, hpnicfDscpMapCosValue=hpnicfDscpMapCosValue, hpnicfCosToDscpMapDscpValue=hpnicfCosToDscpMapDscpValue, hpnicfDropModeTable=hpnicfDropModeTable, hpnicfRateLimitTargetRateMbps=hpnicfRateLimitTargetRateMbps, hpnicfStatisticLinkAclNum=hpnicfStatisticLinkAclNum, hpnicfPortMirrorTable=hpnicfPortMirrorTable, hpnicfFlowtempSPort=hpnicfFlowtempSPort, hpnicfPriorityEntry=hpnicfPriorityEntry, hpnicfMirroringGroupMirrorEntry=hpnicfMirroringGroupMirrorEntry, hpnicfFlowtempEntry=hpnicfFlowtempEntry, hpnicfFlowtempSIpMask=hpnicfFlowtempSIpMask, hpnicfPortMonitorBothIfIndex=hpnicfPortMonitorBothIfIndex, hpnicfCosToDscpMapEntry=hpnicfCosToDscpMapEntry, hpnicfFlowtempTcpFlag=hpnicfFlowtempTcpFlag, hpnicfMirroringGroupMirrorOutTypeList=hpnicfMirroringGroupMirrorOutTypeList, hpnicfMirroringGroupMirroVlanStatus=hpnicfMirroringGroupMirroVlanStatus, hpnicfMirroringGroupTable=hpnicfMirroringGroupTable, hpnicfDropModeWredIndex=hpnicfDropModeWredIndex, hpnicfLineRateValue=hpnicfLineRateValue, hpnicfMirrorGroupDirection=hpnicfMirrorGroupDirection, hpnicfStatisticRuntime=hpnicfStatisticRuntime, hpnicfMirrorRowStatus=hpnicfMirrorRowStatus, hpnicfWredRedMaxProb=hpnicfWredRedMaxProb, PYSNMP_MODULE_ID=hpnicfLswQosAclMib, hpnicfStatisticPacketCount=hpnicfStatisticPacketCount, hpnicfMirroringGroupID=hpnicfMirroringGroupID, hpnicfMirroringGroupMirrorInTypeList=hpnicfMirroringGroupMirrorInTypeList, hpnicfRemarkVlanIDPacketType=hpnicfRemarkVlanIDPacketType, hpnicfMirrorToCpu=hpnicfMirrorToCpu, hpnicfFlowtempEthProtocol=hpnicfFlowtempEthProtocol, hpnicfRedirectEntry=hpnicfRedirectEntry, hpnicfMirroringGroupMirrorInboundIfIndexList=hpnicfMirroringGroupMirrorInboundIfIndexList, hpnicfDscpToDropPreMapDscpIndex=hpnicfDscpToDropPreMapDscpIndex, hpnicfMirrorGroupTable=hpnicfMirrorGroupTable, hpnicfFlowtempIcmpCode=hpnicfFlowtempIcmpCode, hpnicfPriorityIfIndex=hpnicfPriorityIfIndex, hpnicfRedLinkAclRule=hpnicfRedLinkAclRule, hpnicfExpMapEntry=hpnicfExpMapEntry, hpnicfPriorityRuntime=hpnicfPriorityRuntime, hpnicfLocalPrecedenceMapConformLevel=hpnicfLocalPrecedenceMapConformLevel, hpnicfBandwidthIpAclNum=hpnicfBandwidthIpAclNum, hpnicfLocalPrecedenceMapTable=hpnicfLocalPrecedenceMapTable, hpnicfMirrorTable=hpnicfMirrorTable, hpnicfRedirectToNextHop1=hpnicfRedirectToNextHop1, hpnicfPortMirrorIfIndex=hpnicfPortMirrorIfIndex, hpnicfDscpToLocalPreMapTable=hpnicfDscpToLocalPreMapTable, hpnicfMirroringGroupRprobeVlanID=hpnicfMirroringGroupRprobeVlanID, hpnicfMirrorIpAclRule=hpnicfMirrorIpAclRule, hpnicfWredExponent=hpnicfWredExponent, hpnicfCosToDropPrecedenceMapDropPrecedenceValue=hpnicfCosToDropPrecedenceMapDropPrecedenceValue, hpnicfRateLimitMeterStatByteCount=hpnicfRateLimitMeterStatByteCount, hpnicfTrafficShapeQueueId=hpnicfTrafficShapeQueueId, hpnicfRedirectVlanID=hpnicfRedirectVlanID, hpnicfBandwidthTable=hpnicfBandwidthTable, hpnicfMirroringGroupMirrorMacSeq=hpnicfMirroringGroupMirrorMacSeq, hpnicfStatisticLinkAclRule=hpnicfStatisticLinkAclRule, hpnicfRateLimitConformLocalPre=hpnicfRateLimitConformLocalPre, hpnicfMirroringGroupStatus=hpnicfMirroringGroupStatus, hpnicfFlowtempTos=hpnicfFlowtempTos, hpnicfBandwidthAclIndex=hpnicfBandwidthAclIndex, hpnicfRedirectUserAclRule=hpnicfRedirectUserAclRule, hpnicfWredGreenMinThreshold=hpnicfWredGreenMinThreshold, hpnicfPriorityUserAclNum=hpnicfPriorityUserAclNum, hpnicfCosToDropPrecedenceMapEntry=hpnicfCosToDropPrecedenceMapEntry, hpnicfRedirectRemarkedDSCP=hpnicfRedirectRemarkedDSCP, hpnicfDscpMapDropPrecedence=hpnicfDscpMapDropPrecedence, hpnicfExpMapConformLevel=hpnicfExpMapConformLevel, hpnicfMirrorEntry=hpnicfMirrorEntry, hpnicfRedDirection=hpnicfRedDirection, hpnicfFlowtempEnableEntry=hpnicfFlowtempEnableEntry, hpnicfFlowtempFragment=hpnicfFlowtempFragment, hpnicfTrafficShapeBufferLimit=hpnicfTrafficShapeBufferLimit, hpnicfRedirectToSlotNo=hpnicfRedirectToSlotNo, hpnicfRemarkVlanIDIfIndex=hpnicfRemarkVlanIDIfIndex, hpnicfLineRateTable=hpnicfLineRateTable, hpnicfMirrorIpAclNum=hpnicfMirrorIpAclNum, hpnicfRedirectIpAclNum=hpnicfRedirectIpAclNum, hpnicfCosToLocalPrecedenceMapEntry=hpnicfCosToLocalPrecedenceMapEntry, hpnicfWredTable=hpnicfWredTable, hpnicfStatisticTable=hpnicfStatisticTable, hpnicfMirroringGroupMirrorMacTable=hpnicfMirroringGroupMirrorMacTable, hpnicfMirroringGroupMirrorVlanTable=hpnicfMirroringGroupMirrorVlanTable, hpnicfRedirectTable=hpnicfRedirectTable, hpnicfRedirectToNestedVlanID=hpnicfRedirectToNestedVlanID, hpnicfDscpMapEntry=hpnicfDscpMapEntry, hpnicfRemarkVlanIDLinkAclNum=hpnicfRemarkVlanIDLinkAclNum, hpnicfTrafficShapeIfIndex=hpnicfTrafficShapeIfIndex, hpnicfRateLimitVlanID=hpnicfRateLimitVlanID, hpnicfRedirectIpAclRule=hpnicfRedirectIpAclRule, hpnicfQueueEntry=hpnicfQueueEntry, hpnicfPortWredIfIndex=hpnicfPortWredIfIndex, hpnicfPriorityPolicedServiceLoaclPre=hpnicfPriorityPolicedServiceLoaclPre, hpnicfRemarkVlanIDUserAclRule=hpnicfRemarkVlanIDUserAclRule, hpnicfWredYellowMinThreshold=hpnicfWredYellowMinThreshold, HpnicfMirrorOrMonitorType=HpnicfMirrorOrMonitorType, hpnicfFlowtempDscp=hpnicfFlowtempDscp, hpnicfMirrorGroupRowStatus=hpnicfMirrorGroupRowStatus, hpnicfWredIndex=hpnicfWredIndex, hpnicfDscpMapTable=hpnicfDscpMapTable, hpnicfBandwidthLinkAclRule=hpnicfBandwidthLinkAclRule, hpnicfRedirectToModifiedVlanID=hpnicfRedirectToModifiedVlanID, hpnicfRedirectIfIndex=hpnicfRedirectIfIndex, hpnicfCosToDropPrecedenceMapTable=hpnicfCosToDropPrecedenceMapTable, hpnicfMirroringGroupMirrorVlanID=hpnicfMirroringGroupMirrorVlanID, hpnicfRateLimitUserAclRule=hpnicfRateLimitUserAclRule, hpnicfMirroringGroupMirrorMacEntry=hpnicfMirroringGroupMirrorMacEntry, hpnicfRedRowStatus=hpnicfRedRowStatus, hpnicfMirroringGroupMonitorTable=hpnicfMirroringGroupMonitorTable, hpnicfWredGreenMaxThreshold=hpnicfWredGreenMaxThreshold, hpnicfStatisticUserAclNum=hpnicfStatisticUserAclNum, hpnicfRemarkVlanIDTable=hpnicfRemarkVlanIDTable, hpnicfExpMapTable=hpnicfExpMapTable, hpnicfTrafficShapeTable=hpnicfTrafficShapeTable, hpnicfRemarkVlanIDAclIndex=hpnicfRemarkVlanIDAclIndex, hpnicfPriorityCosFromIpPre=hpnicfPriorityCosFromIpPre, hpnicfRemarkVlanIDRowStatus=hpnicfRemarkVlanIDRowStatus, hpnicfRedirectRowStatus=hpnicfRedirectRowStatus, hpnicfPriorityLinkAclNum=hpnicfPriorityLinkAclNum, hpnicfPriorityPolicedServiceCos=hpnicfPriorityPolicedServiceCos, hpnicfFlowtempSIp=hpnicfFlowtempSIp, hpnicfRemarkVlanIDIpAclRule=hpnicfRemarkVlanIDIpAclRule, hpnicfRateLimitConformCos=hpnicfRateLimitConformCos, hpnicfStatisticCountClear=hpnicfStatisticCountClear, hpnicfRateLimitAclIndex=hpnicfRateLimitAclIndex, hpnicfStatisticAclIndex=hpnicfStatisticAclIndex, hpnicfPriorityPolicedServiceType=hpnicfPriorityPolicedServiceType, hpnicfLineRateRowStatus=hpnicfLineRateRowStatus, hpnicfStatisticIfIndex=hpnicfStatisticIfIndex, hpnicfDscpToDscpMapEntry=hpnicfDscpToDscpMapEntry, hpnicfMirrorGroupEntry=hpnicfMirrorGroupEntry, hpnicfMirroringGroupMirrorVlanEntry=hpnicfMirroringGroupMirrorVlanEntry)
mibBuilder.exportSymbols("HPN-ICF-LswQos-MIB", hpnicfQueueWeight8=hpnicfQueueWeight8, hpnicfFlowtempEnableTable=hpnicfFlowtempEnableTable, hpnicfPriorityPolicedServiceExp=hpnicfPriorityPolicedServiceExp, hpnicfMirroringGroupMirrorVlanDirection=hpnicfMirroringGroupMirrorVlanDirection, hpnicfWredRedMaxThreshold=hpnicfWredRedMaxThreshold, hpnicfPriorityRowStatus=hpnicfPriorityRowStatus, hpnicfDropModeMode=hpnicfDropModeMode, hpnicfMirroringGroupMirrorMac=hpnicfMirroringGroupMirrorMac, hpnicfBandwidthIpAclRule=hpnicfBandwidthIpAclRule, hpnicfFlowtempDMac=hpnicfFlowtempDMac, hpnicfWredEntry=hpnicfWredEntry, hpnicfPriorityIpPre=hpnicfPriorityIpPre, hpnicfExpMapCosValue=hpnicfExpMapCosValue, hpnicfDropModeIfIndex=hpnicfDropModeIfIndex, hpnicfRedirectUserAclNum=hpnicfRedirectUserAclNum, hpnicfRemarkVlanIDLinkAclRule=hpnicfRemarkVlanIDLinkAclRule, hpnicfMirrorUserAclNum=hpnicfMirrorUserAclNum, hpnicfMirrorRuntime=hpnicfMirrorRuntime, hpnicfMirroringGroupMirrorVlanSeq=hpnicfMirroringGroupMirrorVlanSeq, hpnicfDscpToDropPreMapTable=hpnicfDscpToDropPreMapTable, hpnicfDscpToDscpMapDscpIndex=hpnicfDscpToDscpMapDscpIndex, hpnicfDscpMapConformLevel=hpnicfDscpMapConformLevel, hpnicfMirrorDirection=hpnicfMirrorDirection, hpnicfFlowtempSMacMask=hpnicfFlowtempSMacMask, hpnicfFlowtempEnableFlowtempIndex=hpnicfFlowtempEnableFlowtempIndex, hpnicfRateLimitMeterStatByteXCount=hpnicfRateLimitMeterStatByteXCount, hpnicfPortWredEntry=hpnicfPortWredEntry, hpnicfRedirectRemarkedPri=hpnicfRedirectRemarkedPri, hpnicfBandwidthIfIndex=hpnicfBandwidthIfIndex, hpnicfWredYellowMaxThreshold=hpnicfWredYellowMaxThreshold, hpnicfMirroringGroupMonitorRowStatus=hpnicfMirroringGroupMonitorRowStatus, hpnicfPortTrustTrustType=hpnicfPortTrustTrustType, hpnicfFlowtempRowStatus=hpnicfFlowtempRowStatus, hpnicfBandwidthRuntime=hpnicfBandwidthRuntime, hpnicfDscpToLocalPreMapReset=hpnicfDscpToLocalPreMapReset, hpnicfBandwidthMaxGuaranteedWidth=hpnicfBandwidthMaxGuaranteedWidth, hpnicfDscpToDscpMapReset=hpnicfDscpToDscpMapReset, hpnicfRemarkVlanIDUserAclNum=hpnicfRemarkVlanIDUserAclNum, hpnicfMirrorUserAclRule=hpnicfMirrorUserAclRule, hpnicfDscpToLocalPreMapLocalPreVal=hpnicfDscpToLocalPreMapLocalPreVal, hpnicfStatisticEntry=hpnicfStatisticEntry, hpnicfStatisticIpAclNum=hpnicfStatisticIpAclNum, hpnicfMirroringGroupRprobeVlanTable=hpnicfMirroringGroupRprobeVlanTable, hpnicfQueueWeight4=hpnicfQueueWeight4, hpnicfRedEntry=hpnicfRedEntry, hpnicfPortTrustIfIndex=hpnicfPortTrustIfIndex, hpnicfBandwidthLinkAclNum=hpnicfBandwidthLinkAclNum, hpnicfQueueWeight6=hpnicfQueueWeight6, hpnicfDropModeEntry=hpnicfDropModeEntry, hpnicfRedIpAclRule=hpnicfRedIpAclRule, hpnicfPortWredQueueID=hpnicfPortWredQueueID, hpnicfPortWredQueueStartLength=hpnicfPortWredQueueStartLength, hpnicfDscpToLocalPreMapEntry=hpnicfDscpToLocalPreMapEntry, hpnicfExpMapExpValue=hpnicfExpMapExpValue, hpnicfPriorityPolicedServiceDropPriority=hpnicfPriorityPolicedServiceDropPriority, hpnicfPriorityVlanID=hpnicfPriorityVlanID, hpnicfDscpToLocalPreMapDscpIndex=hpnicfDscpToLocalPreMapDscpIndex, hpnicfPortWredQueueProbability=hpnicfPortWredQueueProbability, hpnicfRedLinkAclNum=hpnicfRedLinkAclNum, hpnicfFlowtempDIpMask=hpnicfFlowtempDIpMask, hpnicfPriorityTrustMode=hpnicfPriorityTrustMode, hpnicfStatisticVlanID=hpnicfStatisticVlanID, hpnicfStatisticByteCount=hpnicfStatisticByteCount, hpnicfDscpToCosMapTable=hpnicfDscpToCosMapTable, hpnicfRateLimitMeterStatState=hpnicfRateLimitMeterStatState, hpnicfRateLimitLinkAclNum=hpnicfRateLimitLinkAclNum, hpnicfRateLimitIpAclRule=hpnicfRateLimitIpAclRule, hpnicfStatisticDirection=hpnicfStatisticDirection, hpnicfDscpMapLocalPrecedence=hpnicfDscpMapLocalPrecedence, hpnicfStatisticIpAclRule=hpnicfStatisticIpAclRule, hpnicfRateLimitCIR=hpnicfRateLimitCIR, hpnicfPriorityIpAclNum=hpnicfPriorityIpAclNum, hpnicfMirrorMacVlanID=hpnicfMirrorMacVlanID, hpnicfRateLimitExceedActionType=hpnicfRateLimitExceedActionType, hpnicfMirrorIfIndex=hpnicfMirrorIfIndex, hpnicfPriorityUserAclRule=hpnicfPriorityUserAclRule, hpnicfLocalPrecedenceMapCosValue=hpnicfLocalPrecedenceMapCosValue, hpnicfRateLimitPIR=hpnicfRateLimitPIR, hpnicfLineRateEntry=hpnicfLineRateEntry, hpnicfRateLimitExceedCos=hpnicfRateLimitExceedCos, hpnicfPortTrustReset=hpnicfPortTrustReset, hpnicfDscpToDscpMapDscpValue=hpnicfDscpToDscpMapDscpValue, hpnicfMirrorGroupID=hpnicfMirrorGroupID, hpnicfMirrorLinkAclRule=hpnicfMirrorLinkAclRule, hpnicfLocalPrecedenceMapLocalPrecedenceIndex=hpnicfLocalPrecedenceMapLocalPrecedenceIndex, hpnicfQueueScheduleMode=hpnicfQueueScheduleMode, hpnicfMirroringGroupRprobeVlanRowStatus=hpnicfMirroringGroupRprobeVlanRowStatus, hpnicfQueueWeight2=hpnicfQueueWeight2, hpnicfFlowtempIcmpType=hpnicfFlowtempIcmpType, hpnicfFlowtempEnableIfIndex=hpnicfFlowtempEnableIfIndex, hpnicfLswQosMibObject=hpnicfLswQosMibObject, hpnicfRateLimitEBS=hpnicfRateLimitEBS, hpnicfRateLimitIpAclNum=hpnicfRateLimitIpAclNum, hpnicfMirrorToGroup=hpnicfMirrorToGroup, hpnicfExpMapExpIndex=hpnicfExpMapExpIndex, hpnicfRateLimitExceedDscp=hpnicfRateLimitExceedDscp, hpnicfPortMirrorEntry=hpnicfPortMirrorEntry, hpnicfRedAclIndex=hpnicfRedAclIndex, hpnicfRateLimitCBS=hpnicfRateLimitCBS, hpnicfRedStartQueueLen=hpnicfRedStartQueueLen, hpnicfQueueMaxDelay=hpnicfQueueMaxDelay, hpnicfCosToDscpMapTable=hpnicfCosToDscpMapTable, hpnicfDscpMapExpValue=hpnicfDscpMapExpValue, hpnicfDscpMapDscpValue=hpnicfDscpMapDscpValue, hpnicfRedirectToIfIndex=hpnicfRedirectToIfIndex, hpnicfFlowtempDPort=hpnicfFlowtempDPort, hpnicfFlowtempDMacMask=hpnicfFlowtempDMacMask, hpnicfPriorityIpAclRule=hpnicfPriorityIpAclRule, hpnicfRateLimitIfIndex=hpnicfRateLimitIfIndex, hpnicfRedIpAclNum=hpnicfRedIpAclNum, hpnicfPortMirrorRowStatus=hpnicfPortMirrorRowStatus, hpnicfRateLimitRuntime=hpnicfRateLimitRuntime, hpnicfFlowtempVlanId=hpnicfFlowtempVlanId, hpnicfLocalPrecedenceMapEntry=hpnicfLocalPrecedenceMapEntry, hpnicfRedirectToCpu=hpnicfRedirectToCpu, hpnicfMirroringGroupEntry=hpnicfMirroringGroupEntry, hpnicfBandwidthEntry=hpnicfBandwidthEntry, hpnicfMirrorVlanID=hpnicfMirrorVlanID)
