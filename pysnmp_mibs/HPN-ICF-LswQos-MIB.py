...
mibBuilder.exportSymbols("HPN-ICF-LswQos-MIB", hpnicfDscpToDropPreMapEntry=hpnicfDscpToDropPreMapEntry, hpnicfStatisticRuntime=hpnicfStatisticRuntime, hpnicfFlowtempIpProtocol=hpnicfFlowtempIpProtocol, hpnicfPriorityCos=hpnicfPriorityCos, hpnicfRedDirection=hpnicfRedDirection, hpnicfRedirectRowStatus=hpnicfRedirectRowStatus, hpnicfRateLimitEntry=hpnicfRateLimitEntry, hpnicfMirrorUserAclNum=hpnicfMirrorUserAclNum, hpnicfRedAclIndex=hpnicfRedAclIndex, hpnicfMirroringGroupRprobeVlanEntry=hpnicfMirroringGroupRprobeVlanEntry, HpnicfMirrorOrMonitorType=HpnicfMirrorOrMonitorType, hpnicfRemarkVlanIDRemarkVlanID=hpnicfRemarkVlanIDRemarkVlanID, hpnicfLocalPrecedenceMapCosValue=hpnicfLocalPrecedenceMapCosValue, hpnicfRemarkVlanIDDirection=hpnicfRemarkVlanIDDirection, hpnicfFlowtempSIpMask=hpnicfFlowtempSIpMask, hpnicfMirroringGroupMirrorEntry=hpnicfMirroringGroupMirrorEntry, hpnicfStatisticLinkAclRule=hpnicfStatisticLinkAclRule, hpnicfMirroringGroupTable=hpnicfMirroringGroupTable, hpnicfBandwidthIpAclRule=hpnicfBandwidthIpAclRule, hpnicfBandwidthAclIndex=hpnicfBandwidthAclIndex, hpnicfRedirectToSlotNo=hpnicfRedirectToSlotNo, hpnicfRedirectRuntime=hpnicfRedirectRuntime, hpnicfMirrorGroupID=hpnicfMirrorGroupID, hpnicfTrafficShapeBurstSize=hpnicfTrafficShapeBurstSize, hpnicfMirrorGroupEntry=hpnicfMirrorGroupEntry, hpnicfFlowtempSIp=hpnicfFlowtempSIp, hpnicfMirroringGroupMonitorRowStatus=hpnicfMirroringGroupMonitorRowStatus, hpnicfExpMapExpValue=hpnicfExpMapExpValue, hpnicfPriorityPolicedServiceType=hpnicfPriorityPolicedServiceType, hpnicfMirroringGroupRprobeVlanRowStatus=hpnicfMirroringGroupRprobeVlanRowStatus, hpnicfCosToDropPrecedenceMapCosIndex=hpnicfCosToDropPrecedenceMapCosIndex, hpnicfStatisticIfIndex=hpnicfStatisticIfIndex, hpnicfPriorityLocalPre=hpnicfPriorityLocalPre, hpnicfRemarkVlanIDAclIndex=hpnicfRemarkVlanIDAclIndex, hpnicfMirrorGroupMonitorIfIndex=hpnicfMirrorGroupMonitorIfIndex, hpnicfMirroringGroupReflectorRowStatus=hpnicfMirroringGroupReflectorRowStatus, hpnicfCosToDscpMapDscpValue=hpnicfCosToDscpMapDscpValue, hpnicfMirroringGroupMirrorRowStatus=hpnicfMirroringGroupMirrorRowStatus, hpnicfLocalPrecedenceMapTable=hpnicfLocalPrecedenceMapTable, hpnicfDscpMapConformLevel=hpnicfDscpMapConformLevel, hpnicfMirroringGroupMirrorVlanID=hpnicfMirroringGroupMirrorVlanID, hpnicfMirrorGroupMirrorIfIndexList=hpnicfMirrorGroupMirrorIfIndexList, hpnicfMirroringGroupReflectorIfIndex=hpnicfMirroringGroupReflectorIfIndex, hpnicfExpMapExpIndex=hpnicfExpMapExpIndex, hpnicfRemarkVlanIDIfIndex=hpnicfRemarkVlanIDIfIndex, hpnicfDscpToDscpMapDscpIndex=hpnicfDscpToDscpMapDscpIndex, hpnicfMirrorMacVlanID=hpnicfMirrorMacVlanID, hpnicfPriorityIpPreFromCos=hpnicfPriorityIpPreFromCos, hpnicfFlowtempDIp=hpnicfFlowtempDIp, hpnicfPortQueueWeight=hpnicfPortQueueWeight, hpnicfStatisticByteXCount=hpnicfStatisticByteXCount, hpnicfPriorityEntry=hpnicfPriorityEntry, hpnicfRateLimitMeterStatByteCount=hpnicfRateLimitMeterStatByteCount, hpnicfRedirectLinkAclRule=hpnicfRedirectLinkAclRule, hpnicfLocalPrecedenceMapEntry=hpnicfLocalPrecedenceMapEntry, hpnicfFlowtempIndex=hpnicfFlowtempIndex, hpnicfMirroringGroupID=hpnicfMirroringGroupID, hpnicfDscpMapCosValue=hpnicfDscpMapCosValue, hpnicfRedirectVlanID=hpnicfRedirectVlanID, hpnicfPriorityIpAclRule=hpnicfPriorityIpAclRule, hpnicfPriorityIpPre=hpnicfPriorityIpPre, hpnicfExpMapConformLevel=hpnicfExpMapConformLevel, hpnicfFlowtempEnableFlowtempIndex=hpnicfFlowtempEnableFlowtempIndex, hpnicfRateLimitCBS=hpnicfRateLimitCBS, hpnicfQueueWeight1=hpnicfQueueWeight1, hpnicfPortWredTable=hpnicfPortWredTable, hpnicfLineRateTable=hpnicfLineRateTable, hpnicfRedirectToNextHop2=hpnicfRedirectToNextHop2, hpnicfMirroringGroupMirrorMacTable=hpnicfMirroringGroupMirrorMacTable, hpnicfRateLimitLinkAclNum=hpnicfRateLimitLinkAclNum, hpnicfRateLimitExceedCos=hpnicfRateLimitExceedCos, hpnicfRedirectTargetVlanID=hpnicfRedirectTargetVlanID, hpnicfExpMapEntry=hpnicfExpMapEntry, hpnicfRateLimitConformLocalPre=hpnicfRateLimitConformLocalPre, hpnicfDscpToCosMapCosValue=hpnicfDscpToCosMapCosValue, hpnicfExpMapTable=hpnicfExpMapTable, hpnicfPortMirrorEntry=hpnicfPortMirrorEntry, hpnicfRemarkVlanIDEntry=hpnicfRemarkVlanIDEntry, hpnicfRateLimitExceedActionType=hpnicfRateLimitExceedActionType, hpnicfDscpToDropPreMapDropPreVal=hpnicfDscpToDropPreMapDropPreVal, hpnicfRateLimitExceedDscp=hpnicfRateLimitExceedDscp, hpnicfDscpMapLocalPrecedence=hpnicfDscpMapLocalPrecedence, hpnicfRateLimitUserAclNum=hpnicfRateLimitUserAclNum, hpnicfFlowtempFragment=hpnicfFlowtempFragment, hpnicfRateLimitUserAclRule=hpnicfRateLimitUserAclRule, hpnicfDscpToDropPreMapTable=hpnicfDscpToDropPreMapTable, hpnicfRateLimitIpAclRule=hpnicfRateLimitIpAclRule, hpnicfRemarkVlanIDTable=hpnicfRemarkVlanIDTable, hpnicfExpMapCosValue=hpnicfExpMapCosValue, hpnicfMirroringGroupMirrorMacEntry=hpnicfMirroringGroupMirrorMacEntry, hpnicfRedStopQueueLen=hpnicfRedStopQueueLen, hpnicfMirrorDirection=hpnicfMirrorDirection, hpnicfRemarkVlanIDUserAclNum=hpnicfRemarkVlanIDUserAclNum, hpnicfMirroringGroupReflectorTable=hpnicfMirroringGroupReflectorTable, hpnicfLineRateDirection=hpnicfLineRateDirection, hpnicfRateLimitRuntime=hpnicfRateLimitRuntime, hpnicfRedStartQueueLen=hpnicfRedStartQueueLen, hpnicfRateLimitIpAclNum=hpnicfRateLimitIpAclNum, hpnicfPriorityPolicedServiceDropPriority=hpnicfPriorityPolicedServiceDropPriority, hpnicfStatisticTable=hpnicfStatisticTable, hpnicfPortWredEntry=hpnicfPortWredEntry, hpnicfRateLimitIfIndex=hpnicfRateLimitIfIndex, hpnicfPriorityPolicedServiceExp=hpnicfPriorityPolicedServiceExp, hpnicfExpMapLocalPrecedence=hpnicfExpMapLocalPrecedence, hpnicfRedLinkAclRule=hpnicfRedLinkAclRule, hpnicfLocalPrecedenceMapConformLevel=hpnicfLocalPrecedenceMapConformLevel, hpnicfRateLimitPIR=hpnicfRateLimitPIR, hpnicfWredQueueId=hpnicfWredQueueId, hpnicfRemarkVlanIDIpAclRule=hpnicfRemarkVlanIDIpAclRule, hpnicfBandwidthIpAclNum=hpnicfBandwidthIpAclNum, hpnicfTrafficShapeRowStatus=hpnicfTrafficShapeRowStatus, hpnicfRateLimitMeterStatByteXCount=hpnicfRateLimitMeterStatByteXCount, hpnicfRemarkVlanIDUserAclRule=hpnicfRemarkVlanIDUserAclRule, hpnicfPortQueueTable=hpnicfPortQueueTable, hpnicfDscpToDropPreMapReset=hpnicfDscpToDropPreMapReset, hpnicfMirroringGroupRprobeVlanTable=hpnicfMirroringGroupRprobeVlanTable, hpnicfRemarkVlanIDIpAclNum=hpnicfRemarkVlanIDIpAclNum, hpnicfMirrorGroupTable=hpnicfMirrorGroupTable, hpnicfRemarkVlanIDPacketType=hpnicfRemarkVlanIDPacketType, hpnicfWredEntry=hpnicfWredEntry, hpnicfDscpMapExpValue=hpnicfDscpMapExpValue, hpnicfCosToDscpMapCosIndex=hpnicfCosToDscpMapCosIndex, hpnicfRedirectIfIndex=hpnicfRedirectIfIndex, hpnicfRedirectEntry=hpnicfRedirectEntry, hpnicfMirroringGroupReflectorEntry=hpnicfMirroringGroupReflectorEntry, hpnicfQueueWeight5=hpnicfQueueWeight5, hpnicfBandwidthLinkAclNum=hpnicfBandwidthLinkAclNum, hpnicfDropModeMode=hpnicfDropModeMode, hpnicfPriorityCosFromIpPre=hpnicfPriorityCosFromIpPre, hpnicfFlowtempEnableIfIndex=hpnicfFlowtempEnableIfIndex, hpnicfBandwidthEntry=hpnicfBandwidthEntry, hpnicfMirrorVlanID=hpnicfMirrorVlanID, hpnicfDropModeEntry=hpnicfDropModeEntry, hpnicfDropModeWredIndex=hpnicfDropModeWredIndex, hpnicfCosToDropPrecedenceMapDropPrecedenceValue=hpnicfCosToDropPrecedenceMapDropPrecedenceValue, hpnicfPortMirrorIfIndex=hpnicfPortMirrorIfIndex, hpnicfTrafficShapeIfIndex=hpnicfTrafficShapeIfIndex, hpnicfQueueWeight4=hpnicfQueueWeight4, hpnicfStatisticVlanID=hpnicfStatisticVlanID, hpnicfMirroringGroupStatus=hpnicfMirroringGroupStatus, hpnicfMirroringGroupMonitorTable=hpnicfMirroringGroupMonitorTable, hpnicfQueueScheduleMode=hpnicfQueueScheduleMode, hpnicfBandwidthDirection=hpnicfBandwidthDirection, hpnicfPortWredQueueStartLength=hpnicfPortWredQueueStartLength, hpnicfMirroringGroupType=hpnicfMirroringGroupType, hpnicfDscpToLocalPreMapEntry=hpnicfDscpToLocalPreMapEntry, hpnicfRateLimitRowStatus=hpnicfRateLimitRowStatus, hpnicfRedirectIpAclNum=hpnicfRedirectIpAclNum, hpnicfStatisticPacketCount=hpnicfStatisticPacketCount, hpnicfMirrorGroupDirection=hpnicfMirrorGroupDirection, hpnicfRedIpAclNum=hpnicfRedIpAclNum, hpnicfMirroringGroupMirrorMacSeq=hpnicfMirroringGroupMirrorMacSeq, hpnicfDscpToCosMapTable=hpnicfDscpToCosMapTable, hpnicfMirroringGroupMonitorIfIndex=hpnicfMirroringGroupMonitorIfIndex, hpnicfPortTrustEntry=hpnicfPortTrustEntry, hpnicfWredYellowMinThreshold=hpnicfWredYellowMinThreshold, hpnicfWredExponent=hpnicfWredExponent, hpnicfPriorityAclIndex=hpnicfPriorityAclIndex, hpnicfMirrorAclIndex=hpnicfMirrorAclIndex, hpnicfMirroringGroupMirroVlanStatus=hpnicfMirroringGroupMirroVlanStatus, hpnicfPriorityDscp=hpnicfPriorityDscp, hpnicfDscpToLocalPreMapLocalPreVal=hpnicfDscpToLocalPreMapLocalPreVal, hpnicfMirroringGroupMirrorOutboundIfIndexList=hpnicfMirroringGroupMirrorOutboundIfIndexList, hpnicfPortQueueWrrPriority=hpnicfPortQueueWrrPriority, hpnicfMirroringGroupRowStatus=hpnicfMirroringGroupRowStatus, hpnicfBandwidthVlanID=hpnicfBandwidthVlanID, hpnicfPriorityPolicedServiceLoaclPre=hpnicfPriorityPolicedServiceLoaclPre, hpnicfCosToDropPrecedenceMapTable=hpnicfCosToDropPrecedenceMapTable, hpnicfRateLimitEBS=hpnicfRateLimitEBS, hpnicfPriorityRuntime=hpnicfPriorityRuntime, hpnicfCosToDropPrecedenceMapEntry=hpnicfCosToDropPrecedenceMapEntry, hpnicfFlowtempIcmpCode=hpnicfFlowtempIcmpCode, hpnicfDscpMapDscpValue=hpnicfDscpMapDscpValue, hpnicfWredIndex=hpnicfWredIndex, hpnicfRedirectToIfIndex=hpnicfRedirectToIfIndex, hpnicfTrafficShapeMaxRate=hpnicfTrafficShapeMaxRate, hpnicfFlowtempDMac=hpnicfFlowtempDMac, hpnicfFlowtempTable=hpnicfFlowtempTable, hpnicfRedirectIpAclRule=hpnicfRedirectIpAclRule, hpnicfFlowtempIpPre=hpnicfFlowtempIpPre, hpnicfRateLimitConformDscp=hpnicfRateLimitConformDscp, hpnicfMirroringGroupMonitorType=hpnicfMirroringGroupMonitorType, hpnicfPriorityIpAclNum=hpnicfPriorityIpAclNum, hpnicfFlowtempSMacMask=hpnicfFlowtempSMacMask, hpnicfRemarkVlanIDLinkAclNum=hpnicfRemarkVlanIDLinkAclNum, hpnicfRedirectTable=hpnicfRedirectTable, hpnicfBandwidthRuntime=hpnicfBandwidthRuntime, hpnicfQueueTable=hpnicfQueueTable, hpnicfMirroringGroupMirrorTable=hpnicfMirroringGroupMirrorTable, hpnicfTrafficShapeQueueId=hpnicfTrafficShapeQueueId, hpnicfMirrorIpAclNum=hpnicfMirrorIpAclNum, hpnicfPriorityLinkAclNum=hpnicfPriorityLinkAclNum, hpnicfRateLimitTable=hpnicfRateLimitTable, hpnicfFlowtempSPort=hpnicfFlowtempSPort, hpnicfMirrorIpAclRule=hpnicfMirrorIpAclRule, hpnicfQueueEntry=hpnicfQueueEntry, hpnicfRateLimitDirection=hpnicfRateLimitDirection, hpnicfBandwidthRowStatus=hpnicfBandwidthRowStatus, hpnicfBandwidthLinkAclRule=hpnicfBandwidthLinkAclRule, hpnicfDropModeIfIndex=hpnicfDropModeIfIndex, hpnicfRedirectLinkAclNum=hpnicfRedirectLinkAclNum, hpnicfMirrorTable=hpnicfMirrorTable, hpnicfCosToLocalPrecedenceMapEntry=hpnicfCosToLocalPrecedenceMapEntry, hpnicfQueueMaxDelay=hpnicfQueueMaxDelay, hpnicfFlowtempEthProtocol=hpnicfFlowtempEthProtocol, hpnicfLineRateIfIndex=hpnicfLineRateIfIndex, hpnicfRedProbability=hpnicfRedProbability, hpnicfMirrorRowStatus=hpnicfMirrorRowStatus, hpnicfStatisticEntry=hpnicfStatisticEntry, hpnicfFlowtempIcmpType=hpnicfFlowtempIcmpType, hpnicfMirroringGroupEntry=hpnicfMirroringGroupEntry, hpnicfStatisticRowStatus=hpnicfStatisticRowStatus, hpnicfQueueWeight6=hpnicfQueueWeight6, hpnicfPriorityLinkAclRule=hpnicfPriorityLinkAclRule, hpnicfDscpToDscpMapReset=hpnicfDscpToDscpMapReset, hpnicfFlowtempTos=hpnicfFlowtempTos, hpnicfFlowtempSMac=hpnicfFlowtempSMac, hpnicfWredYellowMaxThreshold=hpnicfWredYellowMaxThreshold, hpnicfExpMapDropPrecedence=hpnicfExpMapDropPrecedence, hpnicfBandwidthMaxGuaranteedWidth=hpnicfBandwidthMaxGuaranteedWidth, PYSNMP_MODULE_ID=hpnicfLswQosAclMib, hpnicfMirrorToCpu=hpnicfMirrorToCpu, hpnicfMirroringGroupMirrorOutTypeList=hpnicfMirroringGroupMirrorOutTypeList, hpnicfQueueWeight8=hpnicfQueueWeight8, hpnicfCosToLocalPrecedenceMapTable=hpnicfCosToLocalPrecedenceMapTable, hpnicfPriorityVlanID=hpnicfPriorityVlanID, hpnicfDscpMapTable=hpnicfDscpMapTable, hpnicfDscpToLocalPreMapReset=hpnicfDscpToLocalPreMapReset, hpnicfCosToDscpMapReSet=hpnicfCosToDscpMapReSet, hpnicfStatisticLinkAclNum=hpnicfStatisticLinkAclNum, hpnicfRedirectAclIndex=hpnicfRedirectAclIndex, hpnicfPriorityUserAclRule=hpnicfPriorityUserAclRule, hpnicfPortWredQueueID=hpnicfPortWredQueueID, hpnicfRateLimitCIR=hpnicfRateLimitCIR, hpnicfWredTable=hpnicfWredTable, hpnicfRateLimitAclIndex=hpnicfRateLimitAclIndex, hpnicfRedirectRemarkedTos=hpnicfRedirectRemarkedTos, hpnicfPortWredQueueProbability=hpnicfPortWredQueueProbability, hpnicfMirroringGroupMirrorInTypeList=hpnicfMirroringGroupMirrorInTypeList, hpnicfFlowtempVpn=hpnicfFlowtempVpn, hpnicfWredRedMaxThreshold=hpnicfWredRedMaxThreshold, hpnicfDscpMapDscpIndex=hpnicfDscpMapDscpIndex, hpnicfPortMirrorTable=hpnicfPortMirrorTable, hpnicfMirroringGroupMonitorEntry=hpnicfMirroringGroupMonitorEntry, hpnicfExpMapDscpValue=hpnicfExpMapDscpValue, hpnicfMirrorEntry=hpnicfMirrorEntry, hpnicfRedRuntime=hpnicfRedRuntime, hpnicfStatisticIpAclNum=hpnicfStatisticIpAclNum, hpnicfLineRateRowStatus=hpnicfLineRateRowStatus, hpnicfPortQueueIfIndex=hpnicfPortQueueIfIndex, hpnicfDscpToLocalPreMapTable=hpnicfDscpToLocalPreMapTable, hpnicfBandwidthTable=hpnicfBandwidthTable, hpnicfPriorityIfIndex=hpnicfPriorityIfIndex, hpnicfDscpToDscpMapDscpValue=hpnicfDscpToDscpMapDscpValue)
mibBuilder.exportSymbols("HPN-ICF-LswQos-MIB", hpnicfDscpToCosMapReset=hpnicfDscpToCosMapReset, hpnicfRemarkVlanIDVlanID=hpnicfRemarkVlanIDVlanID, hpnicfWredGreenMaxThreshold=hpnicfWredGreenMaxThreshold, hpnicfStatisticUserAclNum=hpnicfStatisticUserAclNum, hpnicfFlowtempEnableEntry=hpnicfFlowtempEnableEntry, hpnicfRedirectUserAclNum=hpnicfRedirectUserAclNum, hpnicfTrafficShapeBufferLimit=hpnicfTrafficShapeBufferLimit, hpnicfDscpToDscpMapTable=hpnicfDscpToDscpMapTable, hpnicfRedirectToNestedVlanID=hpnicfRedirectToNestedVlanID, hpnicfFlowtempDMacMask=hpnicfFlowtempDMacMask, hpnicfDscpToCosMapEntry=hpnicfDscpToCosMapEntry, hpnicfLswQosMibObject=hpnicfLswQosMibObject, hpnicfRedIpAclRule=hpnicfRedIpAclRule, hpnicfDscpToDropPreMapDscpIndex=hpnicfDscpToDropPreMapDscpIndex, hpnicfPriorityDirection=hpnicfPriorityDirection, hpnicfRateLimitPeakRate=hpnicfRateLimitPeakRate, hpnicfFlowtempVlanId=hpnicfFlowtempVlanId, hpnicfPriorityTrustMode=hpnicfPriorityTrustMode, hpnicfWredYellowMaxProb=hpnicfWredYellowMaxProb, hpnicfPortMonitorBothIfIndex=hpnicfPortMonitorBothIfIndex, hpnicfFlowtempDscp=hpnicfFlowtempDscp, hpnicfMirroringGroupMirrorVlanEntry=hpnicfMirroringGroupMirrorVlanEntry, hpnicfRateLimitVlanID=hpnicfRateLimitVlanID, hpnicfMirrorRuntime=hpnicfMirrorRuntime, hpnicfDscpMapDropPrecedence=hpnicfDscpMapDropPrecedence, hpnicfQueueIfIndex=hpnicfQueueIfIndex, hpnicfRedRowStatus=hpnicfRedRowStatus, hpnicfCosToDscpMapEntry=hpnicfCosToDscpMapEntry, hpnicfLineRateValue=hpnicfLineRateValue, hpnicfRedLinkAclNum=hpnicfRedLinkAclNum, hpnicfPortMirrorRowStatus=hpnicfPortMirrorRowStatus, hpnicfRateLimitTargetRateMbps=hpnicfRateLimitTargetRateMbps, hpnicfRedirectUserAclRule=hpnicfRedirectUserAclRule, hpnicfMirrorGroupRowStatus=hpnicfMirrorGroupRowStatus, hpnicfPriorityTable=hpnicfPriorityTable, hpnicfTrafficShapeEntry=hpnicfTrafficShapeEntry, hpnicfFlowtempEnableVlanID=hpnicfFlowtempEnableVlanID, hpnicfRedEntry=hpnicfRedEntry, hpnicfPriorityPolicedServiceCos=hpnicfPriorityPolicedServiceCos, hpnicfMirrorIfIndex=hpnicfMirrorIfIndex, hpnicfPortTrustTable=hpnicfPortTrustTable, hpnicfStatisticIpAclRule=hpnicfStatisticIpAclRule, hpnicfPriorityUserAclNum=hpnicfPriorityUserAclNum, hpnicfFlowtempDIpMask=hpnicfFlowtempDIpMask, hpnicfMirroringGroupMirrorMac=hpnicfMirroringGroupMirrorMac, hpnicfMirroringGroupMirroMacStatus=hpnicfMirroringGroupMirroMacStatus, hpnicfQueueWeight2=hpnicfQueueWeight2, hpnicfPortQueueEntry=hpnicfPortQueueEntry, hpnicfRedirectToCpu=hpnicfRedirectToCpu, hpnicfMirroringGroupMirrorInboundIfIndexList=hpnicfMirroringGroupMirrorInboundIfIndexList, hpnicfRedirectToModifiedVlanID=hpnicfRedirectToModifiedVlanID, hpnicfQueueWeight3=hpnicfQueueWeight3, hpnicfBandwidthMinGuaranteedWidth=hpnicfBandwidthMinGuaranteedWidth, hpnicfCosToDscpMapTable=hpnicfCosToDscpMapTable, hpnicfRedirectMode=hpnicfRedirectMode, hpnicfDscpToLocalPreMapDscpIndex=hpnicfDscpToLocalPreMapDscpIndex, hpnicfRedirectDirection=hpnicfRedirectDirection, hpnicfRateLimitConformActionType=hpnicfRateLimitConformActionType, hpnicfPortWredIfIndex=hpnicfPortWredIfIndex, hpnicfCosToLocalPrecedenceMapCosIndex=hpnicfCosToLocalPrecedenceMapCosIndex, hpnicfMirroringGroupMirrorVlanDirection=hpnicfMirroringGroupMirrorVlanDirection, hpnicfLocalPrecedenceMapLocalPrecedenceIndex=hpnicfLocalPrecedenceMapLocalPrecedenceIndex, hpnicfFlowtempDPort=hpnicfFlowtempDPort, hpnicfMirrorToIfIndex=hpnicfMirrorToIfIndex, hpnicfFlowtempTcpFlag=hpnicfFlowtempTcpFlag, hpnicfPriorityRowStatus=hpnicfPriorityRowStatus, hpnicfPortTrustTrustType=hpnicfPortTrustTrustType, hpnicfMirrorUserAclRule=hpnicfMirrorUserAclRule, hpnicfStatisticDirection=hpnicfStatisticDirection, hpnicfMirrorToGroup=hpnicfMirrorToGroup, hpnicfBandwidthIfIndex=hpnicfBandwidthIfIndex, hpnicfFlowtempEntry=hpnicfFlowtempEntry, hpnicfWredRedMinThreshold=hpnicfWredRedMinThreshold, hpnicfRedirectToNextHop3=hpnicfRedirectToNextHop3, hpnicfRedVlanID=hpnicfRedVlanID, hpnicfFlowtempCos=hpnicfFlowtempCos, hpnicfRemarkVlanIDLinkAclRule=hpnicfRemarkVlanIDLinkAclRule, hpnicfRateLimitLinkAclRule=hpnicfRateLimitLinkAclRule, hpnicfMirrorLinkAclRule=hpnicfMirrorLinkAclRule, hpnicfMirrorLinkAclNum=hpnicfMirrorLinkAclNum, hpnicfPortTrustIfIndex=hpnicfPortTrustIfIndex, hpnicfMirroringGroupMirrorVlanSeq=hpnicfMirroringGroupMirrorVlanSeq, hpnicfRedIfIndex=hpnicfRedIfIndex, hpnicfRedirectRemarkedDSCP=hpnicfRedirectRemarkedDSCP, hpnicfQueueWeight7=hpnicfQueueWeight7, hpnicfRateLimitTargetRateKbps=hpnicfRateLimitTargetRateKbps, hpnicfStatisticCountClear=hpnicfStatisticCountClear, hpnicfRemarkVlanIDRowStatus=hpnicfRemarkVlanIDRowStatus, hpnicfFlowtempRowStatus=hpnicfFlowtempRowStatus, hpnicfRateLimitConformCos=hpnicfRateLimitConformCos, hpnicfStatisticAclIndex=hpnicfStatisticAclIndex, hpnicfWredGreenMaxProb=hpnicfWredGreenMaxProb, hpnicfTrafficShapeTable=hpnicfTrafficShapeTable, hpnicfRedirectToNextHop1=hpnicfRedirectToNextHop1, hpnicfDscpToCosMapDscpIndex=hpnicfDscpToCosMapDscpIndex, hpnicfStatisticPacketXCount=hpnicfStatisticPacketXCount, hpnicfRedTable=hpnicfRedTable, hpnicfFlowtempEnableTable=hpnicfFlowtempEnableTable, hpnicfLineRateEntry=hpnicfLineRateEntry, hpnicfBandwidthWeight=hpnicfBandwidthWeight, hpnicfPortQueueQueueID=hpnicfPortQueueQueueID, hpnicfMirroringGroupMirrorVlanTable=hpnicfMirroringGroupMirrorVlanTable, hpnicfPortTrustOvercastType=hpnicfPortTrustOvercastType, hpnicfDropModeTable=hpnicfDropModeTable, hpnicfLswQosAclMib=hpnicfLswQosAclMib, hpnicfWredRedMaxProb=hpnicfWredRedMaxProb, hpnicfMirroringGroupRprobeVlanID=hpnicfMirroringGroupRprobeVlanID, hpnicfDscpToDscpMapEntry=hpnicfDscpToDscpMapEntry, hpnicfRateLimitMeterStatState=hpnicfRateLimitMeterStatState, hpnicfWredGreenMinThreshold=hpnicfWredGreenMinThreshold, hpnicfRedirectRemarkedPri=hpnicfRedirectRemarkedPri, hpnicfCosToLocalPrecedenceMapLocalPrecedenceValue=hpnicfCosToLocalPrecedenceMapLocalPrecedenceValue, hpnicfPriorityPolicedServiceDscp=hpnicfPriorityPolicedServiceDscp, hpnicfPortTrustReset=hpnicfPortTrustReset, hpnicfStatisticByteCount=hpnicfStatisticByteCount, hpnicfDscpMapEntry=hpnicfDscpMapEntry, hpnicfStatisticUserAclRule=hpnicfStatisticUserAclRule, hpnicfPortMirrorDirection=hpnicfPortMirrorDirection)
