...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VISM-CONN-STAT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:43:24 2025
...
ciscoVismConnStatCompliance.setObjects(
    ("CISCO-VISM-CONN-STAT-MIB", "ciscoVismConnStatGroup")
)
if mibBuilder.loadTexts:
...
ciscoVismConnStatCompliance1.setObjects(
    ("CISCO-VISM-CONN-STAT-MIB", "ciscoVismConnStatGroup1")
)
if mibBuilder.loadTexts:
...
ciscoVismConnStatCompliance2.setObjects(
    ("CISCO-VISM-CONN-STAT-MIB", "ciscoVismConnStatGroup2")
)
if mibBuilder.loadTexts:
...
ciscoVismConnStatCompliance3.setObjects(
    ("CISCO-VISM-CONN-STAT-MIB", "ciscoVismConnStatGroup3")
)
if mibBuilder.loadTexts:
