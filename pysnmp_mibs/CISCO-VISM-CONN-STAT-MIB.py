...
mibBuilder.exportSymbols("CISCO-VISM-CONN-STAT-MIB", vismChanOamLpbkTimeoutCnts=vismChanOamLpbkTimeoutCnts, vismChanAal2CpsInvUuiPkts=vismChanAal2CpsInvUuiPkts, vismChan24HrPeakXmtCellRate=vismChan24HrPeakXmtCellRate, ciscoVismConnStatCompliance2=ciscoVismConnStatCompliance2, vismChanAal2OamLpbLostCells=vismChanAal2OamLpbLostCells, ciscoVismConnStatCompliance3=ciscoVismConnStatCompliance3, vismChanAal2CpsSentPkts=vismChanAal2CpsSentPkts, ciscoVismConnStatGroup3=ciscoVismConnStatGroup3, vismChanAal2CpsInvCidPkts=vismChanAal2CpsInvCidPkts, vismChanAal2CrcErrors=vismChanAal2CrcErrors, vismChanCntGrp=vismChanCntGrp, ciscoVismConnStatCompliance1=ciscoVismConnStatCompliance1, ciscoVismConnStatGroup=ciscoVismConnStatGroup, vismChanXmtFerfCnts=vismChanXmtFerfCnts, vismChanOamLpbkTimeoutDuration=vismChanOamLpbkTimeoutDuration, vismChanAal2CpsInvLenPkts=vismChanAal2CpsInvLenPkts, vismChanAal5ReassemTimerExpiryPdus=vismChanAal5ReassemTimerExpiryPdus, vismChanAal5PduRcvdPkts=vismChanAal5PduRcvdPkts, vismChanCntGrpTable=vismChanCntGrpTable, vismChan24HrPeakRcvCellRate=vismChan24HrPeakRcvCellRate, vismCntClrButton=vismCntClrButton, vismChanAal2HecErrors=vismChanAal2HecErrors, vismChanAal5InvCpiPdus=vismChanAal5InvCpiPdus, vismCntChanNum=vismCntChanNum, vismChanXmtAisCnts=vismChanXmtAisCnts, vismChanAal2InvParCells=vismChanAal2InvParCells, vismChanAal5InvLenPdus=vismChanAal5InvLenPdus, vismChanRcvAisCnts=vismChanRcvAisCnts, vismChanAal5PduSentPkts=vismChanAal5PduSentPkts, ciscoVismConnStatGroup2=ciscoVismConnStatGroup2, ciscoVismConnStatGroup1=ciscoVismConnStatGroup1, vismChanAal2CpsRcvdPkts=vismChanAal2CpsRcvdPkts, ciscoVismConnStatCompliance=ciscoVismConnStatCompliance, vismChanAal5Crc32ErrorPdus=vismChanAal5Crc32ErrorPdus, vismChanRcvFerfCnts=vismChanRcvFerfCnts, ciscoVismConnStatMIBConformance=ciscoVismConnStatMIBConformance, vismChanAal2InvOsfCells=vismChanAal2InvOsfCells, vismChanAal5OversizedSdusRcvdPdus=vismChanAal5OversizedSdusRcvdPdus, vismChanCntGrpEntry=vismChanCntGrpEntry, PYSNMP_MODULE_ID=ciscoVismConnStatMIB, vismChanAisSuppressCount=vismChanAisSuppressCount, vismChanCurrentRcvCellRate=vismChanCurrentRcvCellRate, ciscoVismConnStatMIBCompliances=ciscoVismConnStatMIBCompliances, ciscoVismConnStatMIBGroups=ciscoVismConnStatMIBGroups, vismChanCurrentXmtCellRate=vismChanCurrentXmtCellRate, vismChanAisDelayLeft=vismChanAisDelayLeft, ciscoVismConnStatMIB=ciscoVismConnStatMIB)
