# SNMP MIB module (ALCATEL-ENT1-HEALTH-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-HEALTH-MIB
...
healthModuleEntry.setIndexNames(
    (0, "ALCATEL-ENT1-HEALTH-MIB", "healthModuleSlot"),
)
if mibBuilder.loadTexts:
...
healthModuleRxLatest = _HealthModuleRxLatest_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 16, 1, 1, 1, 1, 1, 17),
...
healthModuleRxTxLatest = _HealthModuleRxTxLatest_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 16, 1, 1, 1, 1, 1, 18),
...
healthPortEntry.setIndexNames(
    (0, "ALCATEL-ENT1-HEALTH-MIB", "healthPortIfIndex"),
)
if mibBuilder.loadTexts:
...
class _HealthThreshFlashLimit_Type(Integer32):
    """Custom type healthThreshFlashLimit based on Integer32"""
    defaultValue = 75
...
_HealthThreshFlashLimit_Type.__name__ = "Integer32"
_HealthThreshFlashLimit_Object = MibScalar
healthThreshFlashLimit = _HealthThreshFlashLimit_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 16, 1, 1, 4, 5),
    _HealthThreshFlashLimit_Type()
)
healthThreshFlashLimit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    healthThreshFlashLimit.setStatus("current")
...
class _HealthMonFlashStatus_Type(Integer32):
    """Custom type healthMonFlashStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_HealthMonFlashStatus_Type.__name__ = "Integer32"
_HealthMonFlashStatus_Object = MibScalar
healthMonFlashStatus = _HealthMonFlashStatus_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 16, 1, 1, 5, 5),
    _HealthMonFlashStatus_Type()
)
healthMonFlashStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    healthMonFlashStatus.setStatus("current")
...
healthModuleGroup.setObjects(
      *(("ALCATEL-ENT1-HEALTH-MIB", "healthModuleRx1MinAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleRx1HrAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleRx1DayAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleRxTx1MinAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleRxTx1HrAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleRxTx1DayAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleMemory1MinAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleMemory1HrAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleMemory1DayAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleCpu1MinAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleCpu1HrAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleCpu1DayAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleChassisId"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleCpuLatest"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleMemoryLatest"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleRxLatest"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleRxTxLatest"))
)
if mibBuilder.loadTexts:
...
healthPortGroup.setObjects(
      *(("ALCATEL-ENT1-HEALTH-MIB", "healthPortRx1MinAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthPortRx1HrAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthPortRx1DayAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthPortRxTx1MinAvg"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthPortRxTx1HrAvg"),
...
healthControlGroup.setObjects(
    ("ALCATEL-ENT1-HEALTH-MIB", "healthSamplingInterval")
)
if mibBuilder.loadTexts:
...
healthThreshGroup.setObjects(
      *(("ALCATEL-ENT1-HEALTH-MIB", "healthThreshRxLimit"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthThreshRxTxLimit"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthThreshMemoryLimit"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthThreshCpuLimit"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthThreshFlashLimit"))
)
if mibBuilder.loadTexts:
...
healthTrapObjectsGroup.setObjects(
      *(("ALCATEL-ENT1-HEALTH-MIB", "healthMonRxStatus"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonRxTxStatus"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonMemoryStatus"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonCpuStatus"),
...
healthMonModuleTrap.setObjects(
      *(("ALCATEL-ENT1-HEALTH-MIB", "healthModuleSlot"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonRxStatus"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonRxTxStatus"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonMemoryStatus"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonCpuStatus"),
...
healthMonPortTrap.setObjects(
      *(("ALCATEL-ENT1-HEALTH-MIB", "healthPortIfIndex"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonRxStatus"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonRxTxStatus"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleChassisId"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthModuleSlot"))
...
healthTrapsGroup.setObjects(
      *(("ALCATEL-ENT1-HEALTH-MIB", "healthMonModuleTrap"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonPortTrap"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthMonCmmTrap"))
)
if mibBuilder.loadTexts:
...
alcatelIND1HealthMonitorMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-HEALTH-MIB", "healthModuleGroup"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthPortGroup"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthControlGroup"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthThreshGroup"),
        ("ALCATEL-ENT1-HEALTH-MIB", "healthTrapsGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"alcatelIND1HealthMonitorMIB": alcatelIND1HealthMonitorMIB,
       ...
       "healthThreshFlashLimit": healthThreshFlashLimit,
       ...
       "healthMonFlashStatus": healthMonFlashStatus,
