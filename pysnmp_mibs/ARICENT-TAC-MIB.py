...
fsTacScalars=_FsTacScalars_ObjectIdentity((1,3,6,1,4,1,29601,2,8,1))
...
fsTacMcastChannelDefaultBandwidth=_FsTacMcastChannelDefaultBandwidth_Object((1,3,6,1,4,1,29601,2,8,1,1),_FsTacMcastChannelDefaultBandwidth_Type())
...
fsTacTraceOption=_FsTacTraceOption_Object((1,3,6,1,4,1,29601,2,8,1,2),_FsTacTraceOption_Type())
...
fsTacStatus=_FsTacStatus_Object((1,3,6,1,4,1,29601,2,8,1,3),_FsTacStatus_Type())
fsTacStatus.setMaxAccess(_C)
if mibBuilder.loadTexts:fsTacStatus.setStatus(_A)
_FsTacProfile_ObjectIdentity=ObjectIdentity
fsTacProfile=_FsTacProfile_ObjectIdentity((1,3,6,1,4,1,29601,2,8,2))
_FsTacMcastProfileTable_Object=MibTable
fsTacMcastProfileTable=_FsTacMcastProfileTable_Object((1,3,6,1,4,1,29601,2,8,2,1))
if mibBuilder.loadTexts:fsTacMcastProfileTable.setStatus(_A)
_FsTacMcastProfileEntry_Object=MibTableRow
fsTacMcastProfileEntry=_FsTacMcastProfileEntry_Object((1,3,6,1,4,1,29601,2,8,2,1,1))
...
fsTacMcastProfileId=_FsTacMcastProfileId_Object((1,3,6,1,4,1,29601,2,8,2,1,1,1),_FsTacMcastProfileId_Type())
...
fsTacMcastProfileAddrType=_FsTacMcastProfileAddrType_Object((1,3,6,1,4,1,29601,2,8,2,1,1,2),_FsTacMcastProfileAddrType_Type())
...
fsTacMcastProfileAction=_FsTacMcastProfileAction_Object((1,3,6,1,4,1,29601,2,8,2,1,1,3),_FsTacMcastProfileAction_Type())
...
fsTacMcastProfileDescription=_FsTacMcastProfileDescription_Object((1,3,6,1,4,1,29601,2,8,2,1,1,4),_FsTacMcastProfileDescription_Type())
...
fsTacMcastProfileStatus=_FsTacMcastProfileStatus_Object((1,3,6,1,4,1,29601,2,8,2,1,1,5),_FsTacMcastProfileStatus_Type())
...
fsTacMcastPrfFilterTable=_FsTacMcastPrfFilterTable_Object((1,3,6,1,4,1,29601,2,8,2,2))
if mibBuilder.loadTexts:fsTacMcastPrfFilterTable.setStatus(_A)
_FsTacMcastPrfFilterEntry_Object=MibTableRow
fsTacMcastPrfFilterEntry=_FsTacMcastPrfFilterEntry_Object((1,3,6,1,4,1,29601,2,8,2,2,1))
...
fsTacMcastPrfFilterGrpStartAddr=_FsTacMcastPrfFilterGrpStartAddr_Object((1,3,6,1,4,1,29601,2,8,2,2,1,1),_FsTacMcastPrfFilterGrpStartAddr_Type())
...
fsTacMcastPrfFilterGrpEndAddr=_FsTacMcastPrfFilterGrpEndAddr_Object((1,3,6,1,4,1,29601,2,8,2,2,1,2),_FsTacMcastPrfFilterGrpEndAddr_Type())
...
fsTacMcastPrfFilterSrcStartAddr=_FsTacMcastPrfFilterSrcStartAddr_Object((1,3,6,1,4,1,29601,2,8,2,2,1,3),_FsTacMcastPrfFilterSrcStartAddr_Type())
...
fsTacMcastPrfFilterSrcEndAddr=_FsTacMcastPrfFilterSrcEndAddr_Object((1,3,6,1,4,1,29601,2,8,2,2,1,4),_FsTacMcastPrfFilterSrcEndAddr_Type())
...
fsTacMcastPrfFilterMode=_FsTacMcastPrfFilterMode_Object((1,3,6,1,4,1,29601,2,8,2,2,1,5),_FsTacMcastPrfFilterMode_Type())
...
fsTacMcastPrfFilterStatus=_FsTacMcastPrfFilterStatus_Object((1,3,6,1,4,1,29601,2,8,2,2,1,6),_FsTacMcastPrfFilterStatus_Type())
...
fsTacChannels=_FsTacChannels_ObjectIdentity((1,3,6,1,4,1,29601,2,8,3))
_FsTacMcastChannelTable_Object=MibTable
fsTacMcastChannelTable=_FsTacMcastChannelTable_Object((1,3,6,1,4,1,29601,2,8,3,1))
if mibBuilder.loadTexts:fsTacMcastChannelTable.setStatus(_A)
_FsTacMcastChannelEntry_Object=MibTableRow
fsTacMcastChannelEntry=_FsTacMcastChannelEntry_Object((1,3,6,1,4,1,29601,2,8,3,1,1))
...
fsTacMcastChannelAddressType=_FsTacMcastChannelAddressType_Object((1,3,6,1,4,1,29601,2,8,3,1,1,1),_FsTacMcastChannelAddressType_Type())
...
fsTacMcastChannelGrpAddress=_FsTacMcastChannelGrpAddress_Object((1,3,6,1,4,1,29601,2,8,3,1,1,2),_FsTacMcastChannelGrpAddress_Type())
...
fsTacMcastChannelSrcAddress=_FsTacMcastChannelSrcAddress_Object((1,3,6,1,4,1,29601,2,8,3,1,1,3),_FsTacMcastChannelSrcAddress_Type())
...
fsTacMcastChannelBandWidth=_FsTacMcastChannelBandWidth_Object((1,3,6,1,4,1,29601,2,8,3,1,1,4),_FsTacMcastChannelBandWidth_Type())
...
fsTacMcastChannelRowStatus=_FsTacMcastChannelRowStatus_Object((1,3,6,1,4,1,29601,2,8,3,1,1,5),_FsTacMcastChannelRowStatus_Type())
...
fsTacStatistics=_FsTacStatistics_ObjectIdentity((1,3,6,1,4,1,29601,2,8,4))
_FsTacMcastPrfStatsTable_Object=MibTable
fsTacMcastPrfStatsTable=_FsTacMcastPrfStatsTable_Object((1,3,6,1,4,1,29601,2,8,4,1))
if mibBuilder.loadTexts:fsTacMcastPrfStatsTable.setStatus(_A)
_FsTacMcastPrfStatsEntry_Object=MibTableRow
fsTacMcastPrfStatsEntry=_FsTacMcastPrfStatsEntry_Object((1,3,6,1,4,1,29601,2,8,4,1,1))
...
fsTacMcastPrfStatsPortRefCnt=_FsTacMcastPrfStatsPortRefCnt_Object((1,3,6,1,4,1,29601,2,8,4,1,1,1),_FsTacMcastPrfStatsPortRefCnt_Type())
...
fsTacMcastPrfStatsVlanRefCnt=_FsTacMcastPrfStatsVlanRefCnt_Object((1,3,6,1,4,1,29601,2,8,4,1,1,2),_FsTacMcastPrfStatsVlanRefCnt_Type())
