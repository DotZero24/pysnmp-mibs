...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/bti/BTI-TC-MIB
...
mibBuilder.exportSymbols("BTI-TC-MIB", CommandStateType=CommandStateType, InitializeCmd=InitializeCmd, InetAddressIPv4=InetAddressIPv4, FixedX1000=FixedX1000, FixedX10=FixedX10, OcnType=OcnType, AdminStatus=AdminStatus, PMIntervalType=PMIntervalType, FiberType=FiberType, SwitchIdxType=SwitchIdxType, PmTestCmdState=PmTestCmdState, ProfileNameType=ProfileNameType, XcvrProtocolType=XcvrProtocolType, PvxL1PortType=PvxL1PortType, ZeroBasedCounter32=ZeroBasedCounter32, InetAddressIPv6z=InetAddressIPv6z, AreaID=AreaID, InetAddressIPv6=InetAddressIPv6, XCType=XCType, DuplexModeType=DuplexModeType, ProtectionStatusType=ProtectionStatusType, BERType=BERType, TimeZone=TimeZone, CirTestResult=CirTestResult, InetAddressIPv4z=InetAddressIPv4z, PMValidity=PMValidity, MirrorConfigType=MirrorConfigType, CpType=CpType, NotifObjectType=NotifObjectType, PYSNMP_MODULE_ID=btiTcMib, SlaTestRole=SlaTestRole, InetAddressDNS=InetAddressDNS, ShelfConfigType=ShelfConfigType, VcnType=VcnType, AmdPortType=AmdPortType, ProtSwEvtType=ProtSwEvtType, LldpPortId=LldpPortId, OperStatus=OperStatus, SyncSwEvtType=SyncSwEvtType, UpgradeCompleteStage=UpgradeCompleteStage, btiTcMib=btiTcMib, StsnType=StsnType, FcType=FcType, LoopbackType=LoopbackType, ProtSwOpCmd=ProtSwOpCmd, Unsigned64=Unsigned64, CondReportType=CondReportType, PassivePortType=PassivePortType, CondSeverity=CondSeverity, InetAddress=InetAddress, LldpChassisIdSubtype=LldpChassisIdSubtype, EnvNotifCodeType=EnvNotifCodeType, FixedX100=FixedX100, AmdType=AmdType, CondServiceAffecting=CondServiceAffecting, LldpChassisId=LldpChassisId, HoursAndMinutes=HoursAndMinutes, PowerFeedModeType=PowerFeedModeType, OperStatQlfr=OperStatQlfr, LldpPortIdSubtype=LldpPortIdSubtype, StmnType=StmnType, InetAddressType=InetAddressType, MonitorPeriodType=MonitorPeriodType, ShelfType=ShelfType, MediaRateType=MediaRateType, SlotType=SlotType, PvxPortType=PvxPortType, OaType=OaType, OdunType=OdunType, WDMGrid=WDMGrid, XcvrType=XcvrType, ProtocolActionType=ProtocolActionType, DesignatedRouterPriority=DesignatedRouterPriority, NotifCodeType=NotifCodeType, PMMontype=PMMontype)
