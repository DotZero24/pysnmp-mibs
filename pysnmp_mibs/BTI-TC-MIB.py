...
mibBuilder.exportSymbols("BTI-TC-MIB", InitializeCmd=InitializeCmd, SlotType=SlotType, SlaTestRole=SlaTestRole, LldpPortIdSubtype=LldpPortIdSubtype, EnvNotifCodeType=EnvNotifCodeType, LldpPortId=LldpPortId, PMMontype=PMMontype, ProtSwEvtType=ProtSwEvtType, PMIntervalType=PMIntervalType, ShelfType=ShelfType, ZeroBasedCounter32=ZeroBasedCounter32, ShelfConfigType=ShelfConfigType, InetAddressIPv6=InetAddressIPv6, DesignatedRouterPriority=DesignatedRouterPriority, FiberType=FiberType, ProfileNameType=ProfileNameType, LldpChassisIdSubtype=LldpChassisIdSubtype, InetAddressDNS=InetAddressDNS, BERType=BERType, OperStatQlfr=OperStatQlfr, SyncSwEvtType=SyncSwEvtType, OperStatus=OperStatus, AmdPortType=AmdPortType, InetAddressIPv4z=InetAddressIPv4z, CondReportType=CondReportType, InetAddressType=InetAddressType, MirrorConfigType=MirrorConfigType, DuplexModeType=DuplexModeType, InetAddressIPv4=InetAddressIPv4, btiTcMib=btiTcMib, PYSNMP_MODULE_ID=btiTcMib, OaType=OaType, InetAddress=InetAddress, StmnType=StmnType, FixedX100=FixedX100, StsnType=StsnType, HoursAndMinutes=HoursAndMinutes, XcvrProtocolType=XcvrProtocolType, OdunType=OdunType, CondServiceAffecting=CondServiceAffecting, ProtocolActionType=ProtocolActionType, PvxPortType=PvxPortType, UpgradeCompleteStage=UpgradeCompleteStage, PmTestCmdState=PmTestCmdState, CpType=CpType, PowerFeedModeType=PowerFeedModeType, XcvrType=XcvrType, PassivePortType=PassivePortType, InetAddressIPv6z=InetAddressIPv6z, NotifCodeType=NotifCodeType, WDMGrid=WDMGrid, ProtectionStatusType=ProtectionStatusType, AmdType=AmdType, FixedX1000=FixedX1000, NotifObjectType=NotifObjectType, AreaID=AreaID, MonitorPeriodType=MonitorPeriodType, Unsigned64=Unsigned64, CondSeverity=CondSeverity, MediaRateType=MediaRateType, LoopbackType=LoopbackType, FixedX10=FixedX10, ProtSwOpCmd=ProtSwOpCmd, CirTestResult=CirTestResult, VcnType=VcnType, SwitchIdxType=SwitchIdxType, CommandStateType=CommandStateType, OcnType=OcnType, PMValidity=PMValidity, XCType=XCType, LldpChassisId=LldpChassisId, PvxL1PortType=PvxL1PortType, AdminStatus=AdminStatus, TimeZone=TimeZone, FcType=FcType)
