...
mibBuilder.exportSymbols("PPP-LCP-MIB", pppLinkStatusRemoteToLocalProtocolCompression=pppLinkStatusRemoteToLocalProtocolCompression, pppLinkConfigReceiveACCMap=pppLinkConfigReceiveACCMap, pppLqrEntry=pppLqrEntry, pppLqrRemotePeriod=pppLqrRemotePeriod, pppLinkStatusBadFCSs=pppLinkStatusBadFCSs, pppLqrExtnsTable=pppLqrExtnsTable, pppLqrExtnsLastReceivedLqrPacket=pppLqrExtnsLastReceivedLqrPacket, pppLink=pppLink, pppLqrOutLQRs=pppLqrOutLQRs, pppLinkStatusBadAddresses=pppLinkStatusBadAddresses, pppLqrConfigPeriod=pppLqrConfigPeriod, pppLqrInGoodOctets=pppLqrInGoodOctets, pppLqrConfigStatus=pppLqrConfigStatus, ppp=ppp, pppLinkStatusRemoteMRU=pppLinkStatusRemoteMRU, pppLinkConfigFcsSize=pppLinkConfigFcsSize, pppLqrInLQRs=pppLqrInLQRs, pppDiscardTest=pppDiscardTest, pppLqrConfigTable=pppLqrConfigTable, pppLinkStatusTable=pppLinkStatusTable, pppTests=pppTests, pppLinkConfigMagicNumber=pppLinkConfigMagicNumber, pppLinkStatusPeerToLocalACCMap=pppLinkStatusPeerToLocalACCMap, pppLinkStatusLocalMRU=pppLinkStatusLocalMRU, pppLinkStatusPhysicalIndex=pppLinkStatusPhysicalIndex, pppLinkStatusReceiveFcsSize=pppLinkStatusReceiveFcsSize, pppLcp=pppLcp, pppLinkStatusTransmitFcsSize=pppLinkStatusTransmitFcsSize, pppEchoTest=pppEchoTest, pppLinkConfigTable=pppLinkConfigTable, pppLinkConfigInitialMRU=pppLinkConfigInitialMRU, pppLinkStatusLocalToRemoteACCompression=pppLinkStatusLocalToRemoteACCompression, pppLinkConfigTransmitACCMap=pppLinkConfigTransmitACCMap, pppLinkStatusBadControls=pppLinkStatusBadControls, pppLqrTable=pppLqrTable, pppLqrQuality=pppLqrQuality, pppLqrLocalPeriod=pppLqrLocalPeriod, pppLinkStatusPacketTooLongs=pppLinkStatusPacketTooLongs, pppLqr=pppLqr, pppLinkStatusLocalToPeerACCMap=pppLinkStatusLocalToPeerACCMap, pppLinkConfigEntry=pppLinkConfigEntry, pppLinkStatusEntry=pppLinkStatusEntry, pppLinkStatusLocalToRemoteProtocolCompression=pppLinkStatusLocalToRemoteProtocolCompression, pppLqrConfigEntry=pppLqrConfigEntry, pppLqrExtnsEntry=pppLqrExtnsEntry, pppLinkStatusRemoteToLocalACCompression=pppLinkStatusRemoteToLocalACCompression)
