...
mibBuilder.exportSymbols("CISCO-CIDS-MIB", cidsHealthTCPEstablishedStreams=cidsHealthTCPEstablishedStreams, cidsHealthSecMonDataStorageTable=cidsHealthSecMonDataStorageTable, ciscoCidsMIBComplianceRev4=ciscoCidsMIBComplianceRev4, cidsAlertSeverity=cidsAlertSeverity, cidsGeneralEventId=cidsGeneralEventId, ciscoCidsMIB=ciscoCidsMIB, cidsHealthDatagramsInFRU=cidsHealthDatagramsInFRU, cidsAlertDenyPacketReqNotPerf=cidsAlertDenyPacketReqNotPerf, cidsAlertVictimAddress=cidsAlertVictimAddress, cidsAlertBlockHost=cidsAlertBlockHost, cidsHealthSecMonSoftwareVersion=cidsHealthSecMonSoftwareVersion, cidsGeneralLocalTime=cidsGeneralLocalTime, cidsAlertSignature=cidsAlertSignature, cidsHealthSecMonLicenseStatus=cidsHealthSecMonLicenseStatus, ciscoCidsMIBCompliance=ciscoCidsMIBCompliance, ciscoCidsMIBCompliances=ciscoCidsMIBCompliances, cidsAlertLogVictimPacketsAct=cidsAlertLogVictimPacketsAct, cidsAlertRiskRatingRelevance=cidsAlertRiskRatingRelevance, cidsHealthSecMonAvailability=cidsHealthSecMonAvailability, cidsAlertThreatValueRating=cidsAlertThreatValueRating, cidsAlertRiskRatingTargetValue=cidsAlertRiskRatingTargetValue, ciscoCidsMIBNotifs=ciscoCidsMIBNotifs, cidsAlertIfIndex=cidsAlertIfIndex, cidsHealthAlarmsGenerated=cidsHealthAlarmsGenerated, cidsErrorSeverity=cidsErrorSeverity, cidsAlertVlan=cidsAlertVlan, ciscoCidsMIBComplianceRev1=ciscoCidsMIBComplianceRev1, cidsAlertSummary=cidsAlertSummary, cidsHealthActiveNodes=cidsHealthActiveNodes, cidsHealthSecMonSensorLoad=cidsHealthSecMonSensorLoad, cidsErrorMessage=cidsErrorMessage, ciscoCidsOptionalObjectGroupRev1=ciscoCidsOptionalObjectGroupRev1, cidsGeneral=cidsGeneral, CidsApplicationStatus=CidsApplicationStatus, CidsHealthStatusColor=CidsHealthStatusColor, cidsHealthSensorStatsResetTime=cidsHealthSensorStatsResetTime, cidsAlertTcpOneWayResetSent=cidsAlertTcpOneWayResetSent, cidsGeneralOriginatorHostId=cidsGeneralOriginatorHostId, cidsHealthTcpStreams=cidsHealthTcpStreams, ciscoCidsOptionalObjectGroupRev3=ciscoCidsOptionalObjectGroupRev3, cidsAlertSummaryType=cidsAlertSummaryType, cidsAlertEventRiskRating=cidsAlertEventRiskRating, cidsHealthPacketDenialRate=cidsHealthPacketDenialRate, cidsHealthSecMonPartitionName=cidsHealthSecMonPartitionName, cidsThreatResponseStatus=cidsThreatResponseStatus, cidsHealthSecMonAnalysisEngineStatus=cidsHealthSecMonAnalysisEngineStatus, cidsHealthSecMonSensorLoadColor=cidsHealthSecMonSensorLoadColor, cidsAlertShunRequested=cidsAlertShunRequested, cidsAlertBlockConnectionReq=cidsAlertBlockConnectionReq, cidsHealthTcpClosingStreams=cidsHealthTcpClosingStreams, cidsHealthSecMonDataStorageEntry=cidsHealthSecMonDataStorageEntry, cidsAlertDenyAttackerReqNotPerf=cidsAlertDenyAttackerReqNotPerf, ciscoCidsGeneralObjectGroup=ciscoCidsGeneralObjectGroup, cidsAlertSignatureVersion=cidsAlertSignatureVersion, cidsHealthFragmentsInFRU=cidsHealthFragmentsInFRU, cidsAlertSignatureSigName=cidsAlertSignatureSigName, ciscoCidsAlertObjectGroupRev2=ciscoCidsAlertObjectGroupRev2, cidsAlertTcpResetSent=cidsAlertTcpResetSent, cidsAlertInterfaceGroup=cidsAlertInterfaceGroup, cidsHealthSecMonVirtSensorStatusTable=cidsHealthSecMonVirtSensorStatusTable, cidsHealthTcpDualIpAndPorts=cidsHealthTcpDualIpAndPorts, cidsHealthPacketLoss=cidsHealthPacketLoss, cidsAlertDenyAttackSerReqNotPerf=cidsAlertDenyAttackSerReqNotPerf, cidsAlertVictimContext=cidsAlertVictimContext, cidsAlertProtocol=cidsAlertProtocol, ciscoCidsNotificationsGroup=ciscoCidsNotificationsGroup, ciscoCidsOptionalObjectGroupRev2=ciscoCidsOptionalObjectGroupRev2, cidsAlert=cidsAlert, ciscoCidsError=ciscoCidsError, cidsError=cidsError, cidsHealthSecMonVirtSensorStatusEntry=cidsHealthSecMonVirtSensorStatusEntry, cidsAlertDetails=cidsAlertDetails, cidsAlertSummaryInitialAlert=cidsAlertSummaryInitialAlert, cidsHealth=cidsHealth, cidsHealthSecMonCollaborationAppStatus=cidsHealthSecMonCollaborationAppStatus, cidsHealthSecMonOverallAppColor=cidsHealthSecMonOverallAppColor, cidsHealthSecMonAnalysisEngMemPercent=cidsHealthSecMonAnalysisEngMemPercent, cidsHealthSecMonTotalPartitionSpace=cidsHealthSecMonTotalPartitionSpace, cidsHealthIsSensorActive=cidsHealthIsSensorActive, cidsGeneralOriginatorAppId=cidsGeneralOriginatorAppId, cidsHealthSecMonSignatureVersion=cidsHealthSecMonSignatureVersion, ciscoCidsHealthMetricChange=ciscoCidsHealthMetricChange, ciscoCidsErrorObjectGroup=ciscoCidsErrorObjectGroup, cidsHealthSecMonMainAppStatus=cidsHealthSecMonMainAppStatus, ciscoCidsMIBComplianceRev2=ciscoCidsMIBComplianceRev2, cidsAlertSummaryFinal=cidsAlertSummaryFinal, cidsThreatResponseSeverity=cidsThreatResponseSeverity, cidsAlertDeniedAttacker=cidsAlertDeniedAttacker, ciscoCidsMIBGroups=ciscoCidsMIBGroups, ciscoCidsMIBComplianceRev3=ciscoCidsMIBComplianceRev3, ciscoCidsHealthHeartBeat=ciscoCidsHealthHeartBeat, CidsAttackRelevance=CidsAttackRelevance, cidsAlertDenyPacket=cidsAlertDenyPacket, cidsHealthTcpEmbryonicStreams=cidsHealthTcpEmbryonicStreams, cidsAlertAttackerAddress=cidsAlertAttackerAddress, cidsAlertIpLogId=cidsAlertIpLogId, cidsAlertAlarmTraits=cidsAlertAlarmTraits, cidsAlertDenyAttackVicReqNotPerf=cidsAlertDenyAttackVicReqNotPerf, ciscoCidsOptionalObjectGroup=ciscoCidsOptionalObjectGroup, cidsAlertSignatureSubSigId=cidsAlertSignatureSubSigId, cidsAlertLogAttackerPacketsAct=cidsAlertLogAttackerPacketsAct, cidsAlertAttackerContext=cidsAlertAttackerContext, cidsAlertRateLimitRequested=cidsAlertRateLimitRequested, cidsAlertDeniedAttackVictimPair=cidsAlertDeniedAttackVictimPair, cidsHealthIsSensorMemoryCritical=cidsHealthIsSensorMemoryCritical, cidsAlertRiskRatingWatchList=cidsAlertRiskRatingWatchList, cidsNotificationsEnabled=cidsNotificationsEnabled, ciscoCidsAlertObjectGroup=ciscoCidsAlertObjectGroup, cidsHealthSecMonOverallHealth=cidsHealthSecMonOverallHealth, cidsHealthSecMonUtilizedPartitionSpace=cidsHealthSecMonUtilizedPartitionSpace, cidsHealthSecMonVirtSensorName=cidsHealthSecMonVirtSensorName, ciscoCidsHealthObjectGroup=ciscoCidsHealthObjectGroup, ciscoCidsNotificationsGroupRev1=ciscoCidsNotificationsGroupRev1, CidsErrorCode=CidsErrorCode, cidsAlertDeniedAttackSericePair=cidsAlertDeniedAttackSericePair, ciscoCidsAlertObjectGroupRev1=ciscoCidsAlertObjectGroupRev1, ciscoCidsAlert=ciscoCidsAlert, CidsTargetValue=CidsTargetValue, cidsAlertDeniedFlow=cidsAlertDeniedFlow, ciscoCidsMIBObjects=ciscoCidsMIBObjects, cidsHealthUdpDualIpAndPorts=cidsHealthUdpDualIpAndPorts, cidsAlertDenyFlowReqNotPerf=cidsAlertDenyFlowReqNotPerf, PYSNMP_MODULE_ID=ciscoCidsMIB, cidsAlertSignatureSigId=cidsAlertSignatureSigId, cidsHealthSecMonMissedPktPctAndThresh=cidsHealthSecMonMissedPktPctAndThresh, cidsHealthSecMonVirtSensorStatus=cidsHealthSecMonVirtSensorStatus, cidsHealthCommandAndControlPort=cidsHealthCommandAndControlPort, ciscoCidsGeneralObjectGroupRev1=ciscoCidsGeneralObjectGroupRev1, cidsAlertLogPairPacketsActivated=cidsAlertLogPairPacketsActivated, cidsHealthSecMonByPassMode=cidsHealthSecMonByPassMode, cidsAlertIpLoggingActivated=cidsAlertIpLoggingActivated, cidsGeneralUTCTime=cidsGeneralUTCTime, cidsAlertVirtualSensor=cidsAlertVirtualSensor, cidsGeneralOriginatorAppName=cidsGeneralOriginatorAppName, ciscoCidsHealthObjectGroupRev1=ciscoCidsHealthObjectGroupRev1, cidsHealthIpDualIp=cidsHealthIpDualIp, cidsErrorName=cidsErrorName, ciscoCidsMIBConform=ciscoCidsMIBConform)
