...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CIDS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:26:19 2025
...
_CidsNotificationsEnabled_Type.__name__ = "TruthValue"
...
ciscoCidsMIBCompliance.setObjects(
      *(("CISCO-CIDS-MIB", "ciscoCidsGeneralObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsAlertObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsErrorObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsHealthObjectGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCidsMIBComplianceRev1.setObjects(
      *(("CISCO-CIDS-MIB", "ciscoCidsGeneralObjectGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsAlertObjectGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsErrorObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsHealthObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsNotificationsGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsOptionalObjectGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCidsMIBComplianceRev2.setObjects(
      *(("CISCO-CIDS-MIB", "ciscoCidsGeneralObjectGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsAlertObjectGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsErrorObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsHealthObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsNotificationsGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsOptionalObjectGroupRev1"))
)
if mibBuilder.loadTexts:
...
ciscoCidsMIBComplianceRev3.setObjects(
      *(("CISCO-CIDS-MIB", "ciscoCidsGeneralObjectGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsAlertObjectGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsErrorObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsHealthObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsNotificationsGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsOptionalObjectGroupRev2"),
        ("CISCO-CIDS-MIB", "ciscoCidsOptionalObjectGroupRev1"))
)
if mibBuilder.loadTexts:
...
ciscoCidsMIBComplianceRev4.setObjects(
      *(("CISCO-CIDS-MIB", "ciscoCidsErrorObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsGeneralObjectGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsAlertObjectGroupRev2"),
        ("CISCO-CIDS-MIB", "ciscoCidsHealthObjectGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsNotificationsGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsHealthObjectGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsNotificationsGroup"),
        ("CISCO-CIDS-MIB", "ciscoCidsAlertObjectGroupRev1"),
        ("CISCO-CIDS-MIB", "ciscoCidsOptionalObjectGroupRev3"),
        ("CISCO-CIDS-MIB", "ciscoCidsOptionalObjectGroupRev2"),
        ("CISCO-CIDS-MIB", "ciscoCidsOptionalObjectGroupRev1"))
)
if mibBuilder.loadTexts:
