...
mibBuilder.exportSymbols("OUTBOUNDSSH-PRIVATE-MIB", PYSNMP_MODULE_ID=outboundSSHPrivate, agentOutboundSSHAdminMode=agentOutboundSSHAdminMode, agentOutboundSSHTimeout=agentOutboundSSHTimeout, agentOutboundSSHMaxNoOfSessions=agentOutboundSSHMaxNoOfSessions, agentOutboundSSHGroup=agentOutboundSSHGroup, outboundSSHPrivate=outboundSSHPrivate)
