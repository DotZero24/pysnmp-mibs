...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DHCP-SNOOPING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:24 2025
...
cdsMIBCompliance.setObjects(
      *(("CISCO-DHCP-SNOOPING-MIB", "cdsIfConfigGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsBindingsGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsGlobalEnableGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsDatabaseGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsVlanConfigGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfRateLimitGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsStatisticsGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsRelayAgentInfoOptGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfSrcGuardGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsMatchMacAddressGroup"))
)
if mibBuilder.loadTexts:
...
cdsMIBCompliance2.setObjects(
      *(("CISCO-DHCP-SNOOPING-MIB", "cdsIfConfigGroup"),
        ...
        ("CISCO-DHCP-SNOOPING-MIB", "cdsStatisticsGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsRelayAgentInfoOptGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfSrcGuardGroupRev1"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsMatchMacAddressGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsRelayAgentRemoteIdGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfFeatureConfigGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsBindingsLimitGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsStaticBindingsGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfSrcGuardIpFilterGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfSrcGuardExtGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfSrcGuardTrafficFilterGroup"))
)
if mibBuilder.loadTexts:
...
cdsMIBCompliance3.setObjects(
      *(("CISCO-DHCP-SNOOPING-MIB", "cdsIfConfigGroup"),
        ...
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfSrcGuardExtGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfSrcGuardTrafficFilterGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsBindingsHostnameGroup"))
)
if mibBuilder.loadTexts:
...
cdsMIBCompliance4.setObjects(
      *(("CISCO-DHCP-SNOOPING-MIB", "cdsIfConfigGroup"),
        ...
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfSrcGuardTrafficFilterGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsBindingsHostnameGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsRelayAgentInfoOptRemoteIdSubGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfVlanRelayInfoOptCircuitIdGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsStatisticsExtGroup"))
)
if mibBuilder.loadTexts:
...
cdsMIBCompliance5.setObjects(
      *(("CISCO-DHCP-SNOOPING-MIB", "cdsIfConfigGroup"),
        ...
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfVlanRelayInfoOptCircuitIdGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsStatisticsExtGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsNotifControlGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsBindingsNotificationGroup"))
)
if mibBuilder.loadTexts:
...
cdsMIBCompliance6.setObjects(
      *(("CISCO-DHCP-SNOOPING-MIB", "cdsIfConfigGroup"),
        ...
        ("CISCO-DHCP-SNOOPING-MIB", "cdsNotifControlGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsBindingsNotificationGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfVlanRelayInfoOptCircuitIdGroupSup1"))
)
if mibBuilder.loadTexts:
...
cdsMIBCompliance7.setObjects(
      *(("CISCO-DHCP-SNOOPING-MIB", "cdsIfConfigGroup"),
        ...
        ("CISCO-DHCP-SNOOPING-MIB", "cdsBindingsNotificationGroup"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsIfVlanRelayInfoOptCircuitIdGroupSup1"),
        ("CISCO-DHCP-SNOOPING-MIB", "cdsVlanOperStatusGroup"))
)
if mibBuilder.loadTexts:
