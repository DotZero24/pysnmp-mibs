# SNMP MIB module (MY-PING-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-PING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:35:15 2025
...
traceRouteHopsEntry.setIndexNames(
    (0, "MY-PING-MIB", "traceRouteIndex"),
    (0, "MY-PING-MIB", "traceRouteHopIndex"),
)
if mibBuilder.loadTexts:
...
myPingMIBGroup.setObjects(
      *(("MY-PING-MIB", "myPingIndex"),
        ("MY-PING-MIB", "myPingAddress"),
        ("MY-PING-MIB", "myPingDataLength"),
        ("MY-PING-MIB", "myPingTimes"),
        ("MY-PING-MIB", "myPingTimeOuts"),
        ("MY-PING-MIB", "myPingReturns"),
        ("MY-PING-MIB", "myPingMaxTime"),
        ("MY-PING-MIB", "myPingAvTime"),
        ("MY-PING-MIB", "myPingMinTime"),
        ("MY-PING-MIB", "myPingCompleted"),
        ("MY-PING-MIB", "myPingEntryStauts"),
        ("MY-PING-MIB", "myPingSourceIp"),
        ("MY-PING-MIB", "myPingSourceInterfaceIndex"),
        ("MY-PING-MIB", "myPingTypeOfService"))
)
if mibBuilder.loadTexts:
