...
myPingMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,3))
if mibBuilder.loadTexts:myPingMIB.setRevisions(('2002-03-20 00:00',))
_MyPingMIBObjects_ObjectIdentity=ObjectIdentity
myPingMIBObjects=_MyPingMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,3,1))
_MyPingTable_Object=MibTable
myPingTable=_MyPingTable_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1))
if mibBuilder.loadTexts:myPingTable.setStatus(_A)
_MyPingEntry_Object=MibTableRow
myPingEntry=_MyPingEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1))
...
myPingIndex=_MyPingIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,1),_MyPingIndex_Type())
...
myPingAddress=_MyPingAddress_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,2),_MyPingAddress_Type())
...
myPingDataLength=_MyPingDataLength_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,3),_MyPingDataLength_Type())
...
myPingTimes=_MyPingTimes_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,4),_MyPingTimes_Type())
...
myPingTimeOuts=_MyPingTimeOuts_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,5),_MyPingTimeOuts_Type())
...
myPingReturns=_MyPingReturns_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,6),_MyPingReturns_Type())
...
myPingMaxTime=_MyPingMaxTime_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,7),_MyPingMaxTime_Type())
...
myPingAvTime=_MyPingAvTime_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,8),_MyPingAvTime_Type())
...
myPingMinTime=_MyPingMinTime_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,9),_MyPingMinTime_Type())
...
myPingCompleted=_MyPingCompleted_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,10),_MyPingCompleted_Type())
...
myPingEntryStauts=_MyPingEntryStauts_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,11),_MyPingEntryStauts_Type())
...
myPingSourceIp=_MyPingSourceIp_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,12),_MyPingSourceIp_Type())
...
myPingSourceInterfaceIndex=_MyPingSourceInterfaceIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,13),_MyPingSourceInterfaceIndex_Type())
...
myPingTypeOfService=_MyPingTypeOfService_Object((1,3,6,1,4,1,4881,1,1,10,2,3,1,1,1,14),_MyPingTypeOfService_Type())
...
myPingMIBConformance=_MyPingMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,3,2))
_MyPingMIBCompliances_ObjectIdentity=ObjectIdentity
myPingMIBCompliances=_MyPingMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,3,2,1))
_MyPingMIBGroups_ObjectIdentity=ObjectIdentity
myPingMIBGroups=_MyPingMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,3,2,2))
_TraceRouteMIBObjects_ObjectIdentity=ObjectIdentity
traceRouteMIBObjects=_TraceRouteMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,3,3))
_TraceRouteTable_Object=MibTable
traceRouteTable=_TraceRouteTable_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,1))
if mibBuilder.loadTexts:traceRouteTable.setStatus(_A)
_TraceRouteEntry_Object=MibTableRow
traceRouteEntry=_TraceRouteEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,1,1))
...
traceRouteIndex=_TraceRouteIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,1,1,1),_TraceRouteIndex_Type())
...
traceRouteTargetAddr=_TraceRouteTargetAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,1,1,2),_TraceRouteTargetAddr_Type())
...
traceRouteHopCount=_TraceRouteHopCount_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,1,1,3),_TraceRouteHopCount_Type())
...
traceRoutePingCount=_TraceRoutePingCount_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,1,1,4),_TraceRoutePingCount_Type())
...
traceRoutePingTimeout=_TraceRoutePingTimeout_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,1,1,5),_TraceRoutePingTimeout_Type())
...
traceRouteRowStatus=_TraceRouteRowStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,1,1,6),_TraceRouteRowStatus_Type())
...
traceRouteHopsTable=_TraceRouteHopsTable_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,2))
if mibBuilder.loadTexts:traceRouteHopsTable.setStatus(_A)
_TraceRouteHopsEntry_Object=MibTableRow
traceRouteHopsEntry=_TraceRouteHopsEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,2,1))
...
traceRouteHopIndex=_TraceRouteHopIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,2,1,1),_TraceRouteHopIndex_Type())
...
traceRouteHopPingIndex=_TraceRouteHopPingIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,2,1,2),_TraceRouteHopPingIndex_Type())
...
traceRouteHopPingCompleted=_TraceRouteHopPingCompleted_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,2,1,3),_TraceRouteHopPingCompleted_Type())
...
traceRouteHopPingResult=_TraceRouteHopPingResult_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,2,1,4),_TraceRouteHopPingResult_Type())
...
traceRouteHopPingReturnTime=_TraceRouteHopPingReturnTime_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,2,1,5),_TraceRouteHopPingReturnTime_Type())
...
traceRouteHopAddr=_TraceRouteHopAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,3,3,2,1,6),_TraceRouteHopAddr_Type())
traceRouteHopAddr.setMaxAccess(_C)
if mibBuilder.loadTexts:traceRouteHopAddr.setStatus(_A)
myPingMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,3,2,2,1))
...
myPingMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,3,2,1,1))
