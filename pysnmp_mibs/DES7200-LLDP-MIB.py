# SNMP MIB module (DES7200-LLDP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-LLDP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:48:48 2025
...
myLldpMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32)
)
if mibBuilder.loadTexts:
    myLldpMIB.setRevisions(
        ("2003-04-01 00:00",)
    )
...
lldpAdminStatus = _LldpAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 1, 1),
...
lldpOperStatus = _LldpOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 1, 2),
...
lldpMessageTxInterval = _LldpMessageTxInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 1, 3),
...
lldpMessageTxHoldTime = _LldpMessageTxHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 1, 4),
...
lldpDeviceID = _LldpDeviceID_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 1, 5),
    _LldpDeviceID_Type()
)
...
lldpSuppressPortIfIndex = _LldpSuppressPortIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 1, 6, 1, 1),
...
lldpSuppressPortStatus = _LldpSuppressPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 1, 6, 1, 2),
...
lldpStatsPortIfIndex = _LldpStatsPortIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 2, 1, 1, 1),
...
lldpStatsInGoodPkts = _LldpStatsInGoodPkts_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 2, 1, 1, 2),
...
lldpStatsInErrors = _LldpStatsInErrors_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 2, 1, 1, 3),
...
lldpStatsOutPkts = _LldpStatsOutPkts_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 2, 1, 1, 4),
...
lldpStatsClear = _LldpStatsClear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 2, 1, 1, 5),
...
lldpRcvIfIndex = _LldpRcvIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 1),
...
lldpRcvDeviceID = _LldpRcvDeviceID_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 2),
...
lldpRcvMgmtAddress = _LldpRcvMgmtAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 3),
...
lldpRcvPortIDSubtype = _LldpRcvPortIDSubtype_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 4),
...
lldpRcvPortInfo = _LldpRcvPortInfo_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 5),
...
lldpRcvClusterMode = _LldpRcvClusterMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 6),
...
lldpRcvClusterStatus = _LldpRcvClusterStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 7),
...
lldpRcvClusterName = _LldpRcvClusterName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 8),
...
lldpRcvHostName = _LldpRcvHostName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 9),
...
lldpRcvCommandAddress = _LldpRcvCommandAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 1, 1, 10),
...
lldpRcvTableClear = _LldpRcvTableClear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 1, 3, 2),
...
lldpMIBConformance = _LldpMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 2)
)
_LldpMIBCompliances_ObjectIdentity = ObjectIdentity
lldpMIBCompliances = _LldpMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 2, 1)
)
_LldpMIBGroups_ObjectIdentity = ObjectIdentity
lldpMIBGroups = _LldpMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 2, 2)
)

# Managed Objects groups

lldpConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 2, 2, 1)
)
lldpConfigGroup.setObjects(
      *(("DES7200-LLDP-MIB", "lldpAdminStatus"),
        ("DES7200-LLDP-MIB", "lldpOperStatus"),
        ("DES7200-LLDP-MIB", "lldpMessageTxInterval"),
        ("DES7200-LLDP-MIB", "lldpMessageTxHoldTime"),
        ("DES7200-LLDP-MIB", "lldpSuppressTable"))
)
if mibBuilder.loadTexts:
    lldpConfigGroup.setStatus("current")

lldpStatsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 2, 2, 2)
)
lldpStatsGroup.setObjects(
      *(("DES7200-LLDP-MIB", "lldpStatsInGoodPkts"),
        ("DES7200-LLDP-MIB", "lldpStatsInErrors"),
        ("DES7200-LLDP-MIB", "lldpStatsOutPkts"))
)
if mibBuilder.loadTexts:
...
lldpCompliances = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 32, 2, 1, 1)
)
lldpCompliances.setObjects(
      *(("DES7200-LLDP-MIB", "lldpConfigGroup"),
        ("DES7200-LLDP-MIB", "lldpStatsGroup"))
)
if mibBuilder.loadTexts:
