...
# Notes
# -----
# ASN.1 source file://mibs/zyxel/ZYXEL-DHCP-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:02:06 2025
...
zyDhcpServerLeaseTime = _ZyDhcpServerLeaseTime_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 19, 1, 2, 1, 9),
    _ZyDhcpServerLeaseTime_Type()
)
zyDhcpServerLeaseTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDhcpServerLeaseTime.setStatus("current")
