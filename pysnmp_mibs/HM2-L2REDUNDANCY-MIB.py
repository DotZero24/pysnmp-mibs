...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hirschmann/HM2-L2REDUNDANCY-MIB
...
class Hm2CplRingActiveProt(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("error", 1), ("rstp", 2), ("drstp", 3), ("mrp", 4), ("dlr", 5), ("hiper-ring", 6))
...
hm2RedundantCplRole = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 40, 1, 9, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("master", 1), ("slave", 2), ("single", 3), ("auto", 4))).clone('auto')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2RedundantCplRole.setStatus('current')
hm2RedundantCplCurrentRole = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 40, 1, 9, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(("master", 1), ("slave", 2), ("listening", 3), ("error", 4), ("disabled", 5), ("single", 6)))).setMaxAccess("readonly")
...
hm2RedundantCplPartnerSecondaryPort = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 40, 1, 9, 11), InterfaceIndexOrZero()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2RedundantCplPartnerSecondaryPort.setStatus('current')
...
hm2RedundantCplActiveProtPrimaryRing = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 40, 1, 9, 16), Hm2CplRingActiveProt()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2RedundantCplActiveProtPrimaryRing.setStatus('current')
hm2RedundantCplActiveProtSecondaryRing = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 40, 1, 9, 17), Hm2CplRingActiveProt()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2RedundantCplActiveProtSecondaryRing.setStatus('current')
...
hm2RedundantCplSecondaryGroupUnitMismatched = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 11, 40, 3, 9, 2))
if mibBuilder.loadTexts: hm2RedundantCplSecondaryGroupUnitMismatched.setStatus('current')
mibBuilder.exportSymbols("HM2-L2REDUNDANCY-MIB", hm2RedundantCplCurrentRole=hm2RedundantCplCurrentRole, hm2RingCplControlModeOperState=hm2RingCplControlModeOperState, hm2RingCplExtendedDiag=hm2RingCplExtendedDiag, hm2RingRedPrimaryIntfState=hm2RingRedPrimaryIntfState, hm2RedundantCplRole=hm2RedundantCplRole, hm2SrmMibGroup=hm2SrmMibGroup, hm2RingRedAdminState=hm2RingRedAdminState, hm2SrmSubRingPortOperState=hm2SrmSubRingPortOperState, hm2RingCplCouplingMode=hm2RingCplCouplingMode, hm2MrpNotificationsGroup=hm2MrpNotificationsGroup, hm2MrpRoleOperState=hm2MrpRoleOperState, hm2SrmVlanID=hm2SrmVlanID, hm2MrpRecoveryDelay=hm2MrpRecoveryDelay, hm2RingCplReconfig=hm2RingCplReconfig, hm2RedundantCplConfigMibGroup=hm2RedundantCplConfigMibGroup, hm2SrmSubRingProtocol=hm2SrmSubRingProtocol, hm2SrmSubRingOperState=hm2SrmSubRingOperState, hm2RedundantCplState=hm2RedundantCplState, hm2RingCplPartnerInterconnIfIndex=hm2RingCplPartnerInterconnIfIndex, hm2MrpRingport1GroupID=hm2MrpRingport1GroupID, hm2RingCplPartnerIpAddrType=hm2RingCplPartnerIpAddrType, hm2MrpMRCBlockedSupported=hm2MrpMRCBlockedSupported, hm2MrpMRMReactOnLinkChange=hm2MrpMRMReactOnLinkChange, hm2SrmGlobalAdminState=hm2SrmGlobalAdminState, hm2RingCplNetCoupling=hm2RingCplNetCoupling, hm2RedundantCplReconfig=hm2RedundantCplReconfig, hm2SrmPartnerMAC=hm2SrmPartnerMAC, hm2RingCplCouplingLinks=hm2RingCplCouplingLinks, hm2RingCplPartnerIpAddr=hm2RingCplPartnerIpAddr, hm2MrpConfigOperState=hm2MrpConfigOperState, hm2RingCouplingMibSESGroup=hm2RingCouplingMibSESGroup, hm2MrpRingport1IfIndex=hm2MrpRingport1IfIndex, hm2RedundantCplActiveProtSecondaryRing=hm2RedundantCplActiveProtSecondaryRing, hm2MrpDomainID=hm2MrpDomainID, hm2RingRedMibGroup=hm2RingRedMibGroup, hm2MrpMRMPriority=hm2MrpMRMPriority, hm2SrmMaxInstances=hm2SrmMaxInstances, hm2MrpGroups=hm2MrpGroups, hm2SrmSubRingPortIfIndex=hm2SrmSubRingPortIfIndex, hm2MrpRedundancyOperState=hm2MrpRedundancyOperState, hm2RedundantCplPartnerPrimaryPort=hm2RedundantCplPartnerPrimaryPort, hm2L2RedundancyMibSNMPExtensionGroup=hm2L2RedundancyMibSNMPExtensionGroup, hm2MrpMRMRoundTripDelayReset=hm2MrpMRMRoundTripDelayReset, hm2RingCouplingEntry=hm2RingCouplingEntry, hm2SrmRingID=hm2SrmRingID, hm2MrpMRMRoundTripDelayMin=hm2MrpMRMRoundTripDelayMin, hm2MrpMRMRingOpenCount=hm2MrpMRMRingOpenCount, hm2SrmConfigOperState=hm2SrmConfigOperState, hm2RedundantCplAdminState=hm2RedundantCplAdminState, hm2MrpConformance=hm2MrpConformance, hm2L2RedundancyMib=hm2L2RedundancyMib, hm2RedundantCplTimeout=hm2RedundantCplTimeout, hm2SrmTable=hm2SrmTable, hm2MrpFastMrp=hm2MrpFastMrp, hm2MrpMibGroup=hm2MrpMibGroup, hm2L2RedundancyMibObjects=hm2L2RedundancyMibObjects, hm2RedundantCplRedundancyState=hm2RedundantCplRedundancyState, hm2RingCplPartnerInterconnIfOpState=hm2RingCplPartnerInterconnIfOpState, hm2RedundantCplPartnerIPAddrType=hm2RedundantCplPartnerIPAddrType, hm2RedundantCplSecondaryGroupUnitMismatched=hm2RedundantCplSecondaryGroupUnitMismatched, hm2RingRedSecondaryIntfState=hm2RingRedSecondaryIntfState, hm2MrpRecoveryDelaySupported=hm2MrpRecoveryDelaySupported, hm2RedundantCplOutPrimaryPort=hm2RedundantCplOutPrimaryPort, hm2RedundantCplPartnerIPAddr=hm2RedundantCplPartnerIPAddr, hm2MrpDomainName=hm2MrpDomainName, hm2RingCouplingTable=hm2RingCouplingTable, hm2MrpCompliance=hm2MrpCompliance, hm2MrpMRMNonBlockingMRCSupported=hm2MrpMRMNonBlockingMRCSupported, hm2MrpReconfig=hm2MrpReconfig, hm2SrmMRPDomainID=hm2SrmMRPDomainID, hm2RingCplOperState=hm2RingCplOperState, hm2SrmRowStatus=hm2SrmRowStatus, hm2L2RedundancyMibNotifications=hm2L2RedundancyMibNotifications, hm2RingCouplingInvalidPortConfiguration=hm2RingCouplingInvalidPortConfiguration, hm2MrpMRMRoundTripDelayMax=hm2MrpMRMRoundTripDelayMax, hm2MrpVlanID=hm2MrpVlanID, hm2RingCplRowStatus=hm2RingCplRowStatus, hm2RingRedPrimaryIntf=hm2RingRedPrimaryIntf, hm2MrpRingport1OperState=hm2MrpRingport1OperState, hm2MrpRingport2GroupID=hm2MrpRingport2GroupID, hm2RedundantCplInSecondaryPort=hm2RedundantCplInSecondaryPort, hm2MrpDomainDiagGroup=hm2MrpDomainDiagGroup, hm2MrpCompliances=hm2MrpCompliances, hm2RedundantCplOutSecondaryPort=hm2RedundantCplOutSecondaryPort, hm2SrmOperState=hm2SrmOperState, hm2RingCplControlIfOpState=hm2RingCplControlIfOpState, hm2RingCplInterconnIfOpState=hm2RingCplInterconnIfOpState, hm2MrpRowStatus=hm2MrpRowStatus, hm2RingCplInterconnIfIndex=hm2RingCplInterconnIfIndex, hm2RingCplControlIfIndex=hm2RingCplControlIfIndex, hm2RedundantCplInPrimaryPort=hm2RedundantCplInPrimaryPort, hm2MrpDomainManagerGroup=hm2MrpDomainManagerGroup, hm2SrmSubRingName=hm2SrmSubRingName, hm2RedundantCplPartner=hm2RedundantCplPartner, hm2RingCouplingMibGroup=hm2RingCouplingMibGroup, hm2SrmRedundancyOperState=hm2SrmRedundancyOperState, Hm2CplRingActiveProt=Hm2CplRingActiveProt, hm2MrpRoleAdminState=hm2MrpRoleAdminState, hm2RingCplRedOperState=hm2RingCplRedOperState, hm2RingRedSecondaryIntf=hm2RingRedSecondaryIntf, hm2RingCplModeOperState=hm2RingCplModeOperState, hm2RedundantCplSESGroup=hm2RedundantCplSESGroup, hm2MrpMRMLastRingOpenChange=hm2MrpMRMLastRingOpenChange, hm2MrpRingOperState=hm2MrpRingOperState, hm2RedundantCplPortsMissing=hm2RedundantCplPortsMissing, Hm2CplPortOpState=Hm2CplPortOpState, PYSNMP_MODULE_ID=hm2L2RedundancyMib, hm2RingRedMode=hm2RingRedMode, hm2MrpRingport2OperState=hm2MrpRingport2OperState, hm2RingCplConfigOperState=hm2RingCplConfigOperState, hm2RedundantCplPartnerSecondaryPort=hm2RedundantCplPartnerSecondaryPort, hm2MrpTable=hm2MrpTable, hm2MrpEntry=hm2MrpEntry, hm2SrmAdminState=hm2SrmAdminState, hm2MrpRingport2FixedBackup=hm2MrpRingport2FixedBackup, hm2MrpRingport2IfIndex=hm2MrpRingport2IfIndex, hm2SrmReconfig=hm2SrmReconfig, hm2MrpDomainBasicGroup=hm2MrpDomainBasicGroup, hm2SrmEntry=hm2SrmEntry, hm2RedundantCplActiveProtPrimaryRing=hm2RedundantCplActiveProtPrimaryRing)
