...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-L2REDUNDANCY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:55:16 2025
...
class Hm2CplRingActiveProt(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class _Hm2MrpDomainName_Type(SnmpAdminString):
    """Custom type hm2MrpDomainName based on SnmpAdminString"""
    defaultValue = OctetString("")


_Hm2MrpDomainName_Type.__name__ = "SnmpAdminString"
...
_Hm2MrpVlanID_Type.__name__ = "Integer32"
...
_Hm2MrpRingport2FixedBackup_Type.__name__ = "HmEnabledStatus"
...
_Hm2SrmGlobalAdminState_Type.__name__ = "HmEnabledStatus"
...
_Hm2RingRedAdminState_Type.__name__ = "HmEnabledStatus"
...
_Hm2RingRedPrimaryIntf_Type.__name__ = "InterfaceIndexOrZero"
...
_Hm2RingRedSecondaryIntf_Type.__name__ = "InterfaceIndexOrZero"
...
_Hm2RingCplPartnerIpAddrType_Type.__name__ = "InetAddressType"
...
_Hm2RingCplPartnerIpAddr_Type.__name__ = "InetAddress"
...
_Hm2RedundantCplAdminState_Type.__name__ = "HmEnabledStatus"
...
_Hm2RedundantCplInPrimaryPort_Type.__name__ = "InterfaceIndexOrZero"
...
_Hm2RedundantCplOutPrimaryPort_Type.__name__ = "InterfaceIndexOrZero"
...
_Hm2RedundantCplInSecondaryPort_Type.__name__ = "InterfaceIndexOrZero"
...
_Hm2RedundantCplOutSecondaryPort_Type.__name__ = "InterfaceIndexOrZero"
...
hm2RedundantCplPartnerSecondaryPort = _Hm2RedundantCplPartnerSecondaryPort_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 40, 1, 9, 11),
    _Hm2RedundantCplPartnerSecondaryPort_Type()
)
hm2RedundantCplPartnerSecondaryPort.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2RedundantCplPartnerSecondaryPort.setStatus("current")
...
hm2RedundantCplActiveProtPrimaryRing = _Hm2RedundantCplActiveProtPrimaryRing_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 40, 1, 9, 16),
    _Hm2RedundantCplActiveProtPrimaryRing_Type()
)
hm2RedundantCplActiveProtPrimaryRing.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2RedundantCplActiveProtPrimaryRing.setStatus("current")
...
hm2RedundantCplActiveProtSecondaryRing = _Hm2RedundantCplActiveProtSecondaryRing_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 40, 1, 9, 17),
    _Hm2RedundantCplActiveProtSecondaryRing_Type()
)
hm2RedundantCplActiveProtSecondaryRing.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2RedundantCplActiveProtSecondaryRing.setStatus("current")
...
hm2RedundantCplSecondaryGroupUnitMismatched = _Hm2RedundantCplSecondaryGroupUnitMismatched_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 40, 3, 9, 2)
)
if mibBuilder.loadTexts:
    hm2RedundantCplSecondaryGroupUnitMismatched.setStatus("current")
...
hm2MrpCompliance.setObjects(
      *(("HM2-L2REDUNDANCY-MIB", "hm2MrpDomainBasicGroup"),
        ("HM2-L2REDUNDANCY-MIB", "hm2MrpDomainManagerGroup"),
        ("HM2-L2REDUNDANCY-MIB", "hm2MrpNotificationsGroup"),
        ("HM2-L2REDUNDANCY-MIB", "hm2MrpDomainDiagGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"Hm2CplPortOpState": Hm2CplPortOpState,
       "Hm2CplRingActiveProt": Hm2CplRingActiveProt,
       ...
       "hm2RedundantCplPartnerSecondaryPort": hm2RedundantCplPartnerSecondaryPort,
       ...
       "hm2RedundantCplActiveProtPrimaryRing": hm2RedundantCplActiveProtPrimaryRing,
       "hm2RedundantCplActiveProtSecondaryRing": hm2RedundantCplActiveProtSecondaryRing,
       ...
       "hm2RedundantCplSecondaryGroupUnitMismatched": hm2RedundantCplSecondaryGroupUnitMismatched}
)
