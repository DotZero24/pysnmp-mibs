...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/bti/PACKET-VX-BRIDGE-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:46:12 2025
...
pvxERPSSrvcEvtNotifications, pvxL2IntfSwitchIdx, tcaValue, evtDateAndTime, pvxERPSSrvcNNIEvtNotifications, performance, pvxObjects, evtDescription, evtCodeType, tcaDateAndTime, tcaThreshold, condReportType, pvxSlaMsmtEvtNotifications, tcaMontype, pvxESrvcBWPrflEvtNotifications, swMemberCondNotifications, condObjectType, condSeverity, evtObjectType, pvxESrvcEvtNotifications, pvxL2IntfPortTypeIdx, pvxSUniEvtNotifications, condDateAndTime, mstpCondNotifications, pvxL2IntfSubPortNumber, erpsCondNotifications, eventNotifications, pvxL2IntfPortIdx, lagCondNotifications, condCodeType, trapSeqNum, pvxBridge, mstpEvtNotifications, condServiceAffecting, condDescription, pvxL2IntfSlotIdx, mstpNotificationObjects, pvxL2IntfShelfIdx = mibBuilder.importSymbols("BTI-7000-MIB", "pvxERPSSrvcEvtNotifications", "pvxL2IntfSwitchIdx", "tcaValue", "evtDateAndTime", "pvxERPSSrvcNNIEvtNotifications", "performance", "pvxObjects", "evtDescription", "evtCodeType", "tcaDateAndTime", "tcaThreshold", "condReportType", "pvxSlaMsmtEvtNotifications", "tcaMontype", "pvxESrvcBWPrflEvtNotifications", "swMemberCondNotifications", "condObjectType", "condSeverity", "evtObjectType", "pvxESrvcEvtNotifications", "pvxL2IntfPortTypeIdx", "pvxSUniEvtNotifications", "condDateAndTime", "mstpCondNotifications", "pvxL2IntfSubPortNumber", "erpsCondNotifications", "eventNotifications", "pvxL2IntfPortIdx", "lagCondNotifications", "condCodeType", "trapSeqNum", "pvxBridge", "mstpEvtNotifications", "condServiceAffecting", "condDescription", "pvxL2IntfSlotIdx", "mstpNotificationObjects", "pvxL2IntfShelfIdx")
btiModules, = mibBuilder.importSymbols("BTI-MIB", "btiModules")
PMIntervalType, SwitchIdxType, PmTestCmdState, CommandStateType, CondSeverity, OperStatus, CondServiceAffecting, ProfileNameType, PvxPortType, FixedX100, InetAddress, CondReportType, InitializeCmd, CirTestResult, ProtocolActionType, Unsigned64, PMValidity, AdminStatus, SlaTestRole, FixedX1000, MonitorPeriodType, InetAddressType = mibBuilder.importSymbols("BTI-TC-MIB", "PMIntervalType", "SwitchIdxType", "PmTestCmdState", "CommandStateType", "CondSeverity", "OperStatus", "CondServiceAffecting", "ProfileNameType", "PvxPortType", "FixedX100", "InetAddress", "CondReportType", "InitializeCmd", "CirTestResult", "ProtocolActionType", "Unsigned64", "PMValidity", "AdminStatus", "SlaTestRole", "FixedX1000", "MonitorPeriodType", "InetAddressType")
...
packetVxBridgeMib.setRevisions(('2012-12-20 12:00', '2012-12-06 12:00', '2012-06-20 12:00', '2012-02-10 12:00', '2011-06-23 12:00', '2010-08-06 12:00', '2010-06-18 12:00', '2010-02-12 12:00', '2008-12-19 12:00', '2008-03-10 12:00',))
if mibBuilder.loadTexts: packetVxBridgeMib.setLastUpdated('201212201200Z')
...
pvxBWMeterCbs = MibTableColumn((1, 3, 6, 1, 4, 1, 18070, 2, 2, 1, 14, 3, 10, 1, 16), Integer32().subtype(subtypeSpec=ValueRangeConstraint(4, 2048))).setMaxAccess("readcreate")
...
pvxBWMeterEbs = MibTableColumn((1, 3, 6, 1, 4, 1, 18070, 2, 2, 1, 14, 3, 10, 1, 18), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 2048))).setMaxAccess("readcreate")
...
cfmRMepStateChangeEvt = NotificationType((1, 3, 6, 1, 4, 1, 18070, 2, 2, 2, 1, 36, 0, 1)).setObjects(("PACKET-VX-BRIDGE-MIB", "pvxEcfmMepDbRMepState"), ("PACKET-VX-BRIDGE-MIB", "pvxEcfmMepDefects"))
if mibBuilder.loadTexts: cfmRMepStateChangeEvt.setStatus('deprecated')
...
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxESrvcBWPrflCrntPMOctetsVltValidity=pvxESrvcBWPrflCrntPMOctetsVltValidity, pvxERPSPortHistPMUnblockedValidity=pvxERPSPortHistPMUnblockedValidity, pvxMSTPCrntPMRCCCValidity=pvxMSTPCrntPMRCCCValidity, pvxESrvcBWPrflCrntPMOctetsCnfExcInitialize=pvxESrvcBWPrflCrntPMOctetsCnfExcInitialize, mstpTopologyChangeEvt=mstpTopologyChangeEvt, pvxEServiceSlaCrntPM2WayDelayVariationAverageValidity=pvxEServiceSlaCrntPM2WayDelayVariationAverageValidity, pvxEServiceSlaHistPMShelfIdx=pvxEServiceSlaHistPMShelfIdx, pvxERPSPortHistPMFsPduRxTimeStamp=pvxERPSPortHistPMFsPduRxTimeStamp, pvxEcfmMipTable=pvxEcfmMipTable, pvxStaticMulticastTable=pvxStaticMulticastTable, pvxERPSPortHistPMNrrbPduRxTimeStamp=pvxERPSPortHistPMNrrbPduRxTimeStamp, pvxEcfmMipShelfId=pvxEcfmMipShelfId, pvxERPSPortCrntPMFailuresValue=pvxERPSPortCrntPMFailuresValue, pvxERPSServiceTable=pvxERPSServiceTable, pvxEcfmLtrTable=pvxEcfmLtrTable, pvxY1731LbStatsAvgLbrsPerResponder=pvxY1731LbStatsAvgLbrsPerResponder, pvxLagPortSlotIdx=pvxLagPortSlotIdx, pvxERPSSrvcNNIProtectionSwitch=pvxERPSSrvcNNIProtectionSwitch, pvxSvidXlateSwitchId=pvxSvidXlateSwitchId, pvxSwitchMemberStackingState=pvxSwitchMemberStackingState, pvxERPSSrvcDownMegLevel=pvxERPSSrvcDownMegLevel, pvxPolicyMapClassMapName=pvxPolicyMapClassMapName, pvxTunnelMacAddrProfileTable=pvxTunnelMacAddrProfileTable, pvxEcfmMepLbrOut=pvxEcfmMepLbrOut, pvxMSTPCrntPMTCCInitialize=pvxMSTPCrntPMTCCInitialize, pvxPCPEncPriority4=pvxPCPEncPriority4, pvxERPSPortCrntPMNrrbPduRxTimeStamp=pvxERPSPortCrntPMNrrbPduRxTimeStamp, pvxPolicyMapProfileTable=pvxPolicyMapProfileTable, pvxClassMapSVlanPriFilter=pvxClassMapSVlanPriFilter, pvxTunnelMacAddrProfileEntry=pvxTunnelMacAddrProfileEntry, pvxEServiceSlaHistPMFarEndFrameLossTimeStamp=pvxEServiceSlaHistPMFarEndFrameLossTimeStamp, pvxEServiceSlaCrntPM2WayDelayMaximumInitialize=pvxEServiceSlaCrntPM2WayDelayMaximumInitialize, pvxEthSrvcMaxNNIs=pvxEthSrvcMaxNNIs, pvxEServiceSlaCrntPM2WayDelayMaximum=pvxEServiceSlaCrntPM2WayDelayMaximum, pvxSwitchMIPAutoCreate=pvxSwitchMIPAutoCreate, pvxERPSPortHistPMUnblockedInitialize=pvxERPSPortHistPMUnblockedInitialize, pvxSrvcUNISlotId=pvxSrvcUNISlotId, pvxMSTPXstPortDesigCost=pvxMSTPXstPortDesigCost, pvxLAGPortHistPMMRKRSPPDURXValue=pvxLAGPortHistPMMRKRSPPDURXValue, pvxEServiceSlaHistPM2WayDelayVariationMaximum=pvxEServiceSlaHistPM2WayDelayVariationMaximum, pvxPCVRTUntaggedCEP=pvxPCVRTUntaggedCEP, pvxUNIPortId=pvxUNIPortId, pvxVLANUnTaggedPortList=pvxVLANUnTaggedPortList, PvxQoSPmCounterMode=PvxQoSPmCounterMode, pvxSrvcUNIIngressBW=pvxSrvcUNIIngressBW, pvxERPSSrvcConfigFailEvent=pvxERPSSrvcConfigFailEvent, pvxEServiceSlaHistPM2WayDelayAverageValidity=pvxEServiceSlaHistPM2WayDelayAverageValidity, pvxLGMaxLinks=pvxLGMaxLinks, pvxFRowStatus=pvxFRowStatus, pvxMSTPPortHistPMBPDURXValidity=pvxMSTPPortHistPMBPDURXValidity, pvxFlowEntry=pvxFlowEntry, pvxERPSPortHistPMPortIdx=pvxERPSPortHistPMPortIdx, pvxERPSPortHistPMNrPduRxTimeStamp=pvxERPSPortHistPMNrPduRxTimeStamp, pvxEthSrvcRowStatus=pvxEthSrvcRowStatus, pvxLAGPortHistPMMRKPDUTXInitialize=pvxLAGPortHistPMMRKPDUTXInitialize, pvxERPSSrvcNNINextNeighborPort=pvxERPSSrvcNNINextNeighborPort, pvxEcfmMepXconnRMepId=pvxEcfmMepXconnRMepId, pvxMSTPCrntPMXstIdx=pvxMSTPCrntPMXstIdx, pvxMSTPCrntPMRCCCValue=pvxMSTPCrntPMRCCCValue, pvxSrvcUNIEFPSDLocalEFPSDState=pvxSrvcUNIEFPSDLocalEFPSDState, pvxMSTPPortPriority=pvxMSTPPortPriority, pvxLagSwitchIdx=pvxLagSwitchIdx, pvxBWMeterCir=pvxBWMeterCir, pvxEServiceSlaCrntPM2WayDelayMinimum=pvxEServiceSlaCrntPM2WayDelayMinimum, pvxSrvcNNISlotId=pvxSrvcNNISlotId, pvxESrvcBWPrflCrntPMOctetsVltValue=pvxESrvcBWPrflCrntPMOctetsVltValue, pvxMSTPPortCrntPMBPDUTXValue=pvxMSTPPortCrntPMBPDUTXValue, pvxESrvcBWPrflCrntPMOctetsCnfExcTimeStamp=pvxESrvcBWPrflCrntPMOctetsCnfExcTimeStamp, pvxMgmtVLANEntry=pvxMgmtVLANEntry, pvxERPSPortCrntPMMsPduRxValue=pvxERPSPortCrntPMMsPduRxValue, pvxEServiceSlaHistPM2WayDelayMinimumTimeStamp=pvxEServiceSlaHistPM2WayDelayMinimumTimeStamp, pvxMSTPGenTable=pvxMSTPGenTable, pvxERPSPortCrntPMNrrbPduRxValue=pvxERPSPortCrntPMNrrbPduRxValue, pvxMSTPCrntPMTCCTimeStamp=pvxMSTPCrntPMTCCTimeStamp, pvxERPSPortCrntPMFailuresInitialize=pvxERPSPortCrntPMFailuresInitialize, pvxCoSProfileEntry=pvxCoSProfileEntry, pvxLAGPortHistPMLACPDUTXInitialize=pvxLAGPortHistPMLACPDUTXInitialize, pvxEServiceSlaCrntPMESName=pvxEServiceSlaCrntPMESName, pvxSLAMsmtResponderDBShelfIdx=pvxSLAMsmtResponderDBShelfIdx, pvxMSTPXstRootPortType=pvxMSTPXstRootPortType, pvxPCPDecPriority6=pvxPCPDecPriority6, pvxSLAMsmtResponderDBRowStatus=pvxSLAMsmtResponderDBRowStatus, pvxFloActSVlanAction=pvxFloActSVlanAction, pvxClassMapDstMACAddrFilter=pvxClassMapDstMACAddrFilter, pvxEcfmLtrRelayAction=pvxEcfmLtrRelayAction, pvxBWPIdx=pvxBWPIdx, pvxBridgeGVRP=pvxBridgeGVRP, pvxMSTPGenBrdgId=pvxMSTPGenBrdgId, pvxNNIShelfId=pvxNNIShelfId, pvxEcfmLtrSwitchIdx=pvxEcfmLtrSwitchIdx, pvxFlowStatsEntry=pvxFlowStatsEntry, pvxESrvcBWPrflHistPMOctetsCnfExcInitialize=pvxESrvcBWPrflHistPMOctetsCnfExcInitialize, pvxERPSPortCrntPMNrrbPduTxValue=pvxERPSPortCrntPMNrrbPduTxValue, pvxLagRowStatus=pvxLagRowStatus, pvxFMPColorAware=pvxFMPColorAware, pvxESrvcBWPrflHistPMSwitchIdx=pvxESrvcBWPrflHistPMSwitchIdx, pvxESrvcBWPrflHistPMESrvcNameIdx=pvxESrvcBWPrflHistPMESrvcNameIdx, pvxEcfmMepTransmitLbmCount=pvxEcfmMepTransmitLbmCount, pvxESrvcBWPrflHistPMIntervalIdx=pvxESrvcBWPrflHistPMIntervalIdx, pvxEcfmMepDbMacAddress=pvxEcfmMepDbMacAddress, pvxERPSPortCrntPMBlockedValidity=pvxERPSPortCrntPMBlockedValidity, pvxSchedProfMaxBwQ1=pvxSchedProfMaxBwQ1, pvxERPSSrvcNNIRingProtectLink=pvxERPSSrvcNNIRingProtectLink, pvxERPSSrvcNNIRemoteMepId=pvxERPSSrvcNNIRemoteMepId, pvxPolicyMapBWProfileName=pvxPolicyMapBWProfileName, pvxStaticMCReceivePort=pvxStaticMCReceivePort, pvxEthSrvcExceedMaxUNI=pvxEthSrvcExceedMaxUNI, pvxESrvcBWPrflCrntPMDirectionIdx=pvxESrvcBWPrflCrntPMDirectionIdx, pvxEServiceSlaCrntPM2WayDelayVariationAverageInitialize=pvxEServiceSlaCrntPM2WayDelayVariationAverageInitialize, pvxY1731LbStatsSwitchIdx=pvxY1731LbStatsSwitchIdx, pvxEcfmMepTransmitLtmSeqNumber=pvxEcfmMepTransmitLtmSeqNumber, pvxEcfmMipMegLevel=pvxEcfmMipMegLevel, pvxMSTPPortHistPMFWDTRTimeStamp=pvxMSTPPortHistPMFWDTRTimeStamp, pvxMSTPPortHistPMINVBPDUTCNRXValue=pvxMSTPPortHistPMINVBPDUTCNRXValue, pvxMSTPXstRootPortShelf=pvxMSTPXstRootPortShelf, pvxY1731LbStatsLbmOut=pvxY1731LbStatsLbmOut, pvxVlanPortLastBpduOrigin=pvxVlanPortLastBpduOrigin, pvxDscpClassSelector4=pvxDscpClassSelector4, pvxSLAThroughputTestRowStatus=pvxSLAThroughputTestRowStatus, pvxMSTPPortHistPMINVBPDUCFGRXValidity=pvxMSTPPortHistPMINVBPDUCFGRXValidity, pvxSwitchMasterNode=pvxSwitchMasterNode, pvxMSTPPortCrntPMFWDTRInitialize=pvxMSTPPortCrntPMFWDTRInitialize, pvxFMBWProfileId=pvxFMBWProfileId, pvxMSTPHistPMEntry=pvxMSTPHistPMEntry, pvxEServiceSlaHistPM2WayDelayMinimumInitialize=pvxEServiceSlaHistPM2WayDelayMinimumInitialize, pvxFloActCVlanAction=pvxFloActCVlanAction, pvxERPSSrvcRingSemStateChangeEvent=pvxERPSSrvcRingSemStateChangeEvent, pvxMultiCastEntry=pvxMultiCastEntry, pvxERPSPortCrntPMSfPduRxValue=pvxERPSPortCrntPMSfPduRxValue, pvxMSTPGenIdRevisionLevel=pvxMSTPGenIdRevisionLevel, pvxLAGPortHistPMMRKPDURXTimeStamp=pvxLAGPortHistPMMRKPDURXTimeStamp, PvxErpsVirtualLinkList=PvxErpsVirtualLinkList, pvxClassMapProfileEntry=pvxClassMapProfileEntry, pvxUNIMaxFrameSize=pvxUNIMaxFrameSize, pvxERPSSrvcProtectionSwitchMode=pvxERPSSrvcProtectionSwitchMode, pvxERPSSrvcFOPProvisionMismatchCond=pvxERPSSrvcFOPProvisionMismatchCond, pvxDscpClassSelector5=pvxDscpClassSelector5, pvxSchedProfMaxBwQ5=pvxSchedProfMaxBwQ5, pvxPCPDecPriority3=pvxPCPDecPriority3, pvxERPSPortCrntPMFsPduTxTimeStamp=pvxERPSPortCrntPMFsPduTxTimeStamp, pvxERPSPortCrntPMNrPduTxValidity=pvxERPSPortCrntPMNrPduTxValidity, pvxDscpClassSelector1=pvxDscpClassSelector1, pvxFloActGreenCNGAction=pvxFloActGreenCNGAction, pvxSLAMsmtThresholdFarEndLossRatio=pvxSLAMsmtThresholdFarEndLossRatio, pvxERPSPortHistPMNrrbPduTxInitialize=pvxERPSPortHistPMNrrbPduTxInitialize, pvxMSTPPortHistPMFWDTRValidity=pvxMSTPPortHistPMFWDTRValidity, pvxEServiceSlaCrntPMPortIdx=pvxEServiceSlaCrntPMPortIdx, pvxMSTPHistPMSwitchIdx=pvxMSTPHistPMSwitchIdx, pvxClassMapL4SrcPortEndFilter=pvxClassMapL4SrcPortEndFilter, pvxClassMapProfileRowStatus=pvxClassMapProfileRowStatus, pvxESrvcBWPrflCrntPMBDWUtlzTimeStamp=pvxESrvcBWPrflCrntPMBDWUtlzTimeStamp, pvxEthSrvcSwitchIdx=pvxEthSrvcSwitchIdx, pvxFloActIdx=pvxFloActIdx, pvxERPSSrvcNNIProtectionSwitchChangeEvent=pvxERPSSrvcNNIProtectionSwitchChangeEvent, pvxERPSServiceEntry=pvxERPSServiceEntry, pvxEcfmMepErrCcmRMepId=pvxEcfmMepErrCcmRMepId, pvxERPSPortCrntPMNrrbPduTxTimeStamp=pvxERPSPortCrntPMNrrbPduTxTimeStamp, PvxVLANPortList=PvxVLANPortList, pvxESrvcHistPMUASValue=pvxESrvcHistPMUASValue, pvxERPSPortHistPMNrrbPduRxValidity=pvxERPSPortHistPMNrrbPduRxValidity, pvxFlowActionsEntry=pvxFlowActionsEntry, pvxSLAMsmtResponderDBPortIdx=pvxSLAMsmtResponderDBPortIdx, pvxMgmtVLANIpAddress=pvxMgmtVLANIpAddress, pvxMSTPXstPortTable=pvxMSTPXstPortTable, pvxFDBMACAddrIdx=pvxFDBMACAddrIdx, pvxSvidXlatePortId=pvxSvidXlatePortId, pvxERPSPortHistPMVersionDiscardValue=pvxERPSPortHistPMVersionDiscardValue, pvxEServiceSlaHistPM2WayDelayVariationAverageInitialize=pvxEServiceSlaHistPM2WayDelayVariationAverageInitialize, pvxMCMACAddrIdx=pvxMCMACAddrIdx, pvxMSTPHistPMTCCValidity=pvxMSTPHistPMTCCValidity, pvxLGSwitchIdx=pvxLGSwitchIdx, pvxESrvcBWPrflCrntPMPortTypeIdx=pvxESrvcBWPrflCrntPMPortTypeIdx, pvxMSTPPortHistPMINVBPDURXValue=pvxMSTPPortHistPMINVBPDURXValue, pvxSLAMsmtMonitorPeriod=pvxSLAMsmtMonitorPeriod, pvxVLANForbiddenPortList=pvxVLANForbiddenPortList, pvxSrvcUNIPortId=pvxSrvcUNIPortId, pvxERPSPortCrntPMBlockedValue=pvxERPSPortCrntPMBlockedValue, pvxSvidXlateExternalSVid=pvxSvidXlateExternalSVid, pvxEcfmMepMacAddress=pvxEcfmMepMacAddress, pvxFClassificationIdList=pvxFClassificationIdList, pvxEServiceSlaHistPM2WayDelayAverageInitialize=pvxEServiceSlaHistPM2WayDelayAverageInitialize, pvxESrvcBWPrflPMThresholdSwitchIdx=pvxESrvcBWPrflPMThresholdSwitchIdx, pvxSrvcUNINumCVids=pvxSrvcUNINumCVids, pvxPCPEncDecProfEntry=pvxPCPEncDecProfEntry, pvxTMAPDot1xTunnMacAddr=pvxTMAPDot1xTunnMacAddr, pvxSwitchMemberTable=pvxSwitchMemberTable, pvxY1731LbStatsLbrTimeMax=pvxY1731LbStatsLbrTimeMax, pvxY1731LbmTransId=pvxY1731LbmTransId, pvxFDBRowStatus=pvxFDBRowStatus, pvxEServiceSlaCrntPM2WayDelayMinimumTimeStamp=pvxEServiceSlaCrntPM2WayDelayMinimumTimeStamp, pvxEcfmService=pvxEcfmService, pvxLAGPortHistPMMRKPDUTXValidity=pvxLAGPortHistPMMRKPDUTXValidity, pvxFSStatsIdx=pvxFSStatsIdx, pvxDynamicVlanPortEntry=pvxDynamicVlanPortEntry, pvxFlowStatsTable=pvxFlowStatsTable, pvxEServiceSlaHistPMTable=pvxEServiceSlaHistPMTable, pvxEthServiceEntry=pvxEthServiceEntry, pvxEServiceSlaHistPM2WayDelayAverageTimeStamp=pvxEServiceSlaHistPM2WayDelayAverageTimeStamp, pvxSwitchErpsVlanPropagate=pvxSwitchErpsVlanPropagate, pvxERPSPortHistPMVersionDiscardTimeStamp=pvxERPSPortHistPMVersionDiscardTimeStamp, pvxNextFreeIndexEntry=pvxNextFreeIndexEntry, pvxMCVlanIdx=pvxMCVlanIdx, pvxEthSrvcState=pvxEthSrvcState, pvxMSTPHistPMRCCCValidity=pvxMSTPHistPMRCCCValidity, pvxMSTPPortCrntPMBPDUTCNRXValue=pvxMSTPPortCrntPMBPDUTCNRXValue, pvxEServiceSlaCrntPM2WayDelayVariationMaximumInitialize=pvxEServiceSlaCrntPM2WayDelayVariationMaximumInitialize, pvxSLAMsmtInitiatorDBEntry=pvxSLAMsmtInitiatorDBEntry, pvxBWMeterMode=pvxBWMeterMode, pvxEServiceSlaHistPM2WayDelayVariationMinimumInitialize=pvxEServiceSlaHistPM2WayDelayVariationMinimumInitialize, pvxSwitchTable=pvxSwitchTable, pvxSLAThroughputTestFrameSize3NearEndThroughput=pvxSLAThroughputTestFrameSize3NearEndThroughput, pvxMSTPGenCistPriority=pvxMSTPGenCistPriority, pvxEcfmLtrSeqNumber=pvxEcfmLtrSeqNumber, pvxEcfmMepTransmitLtmTargetMepId=pvxEcfmMepTransmitLtmTargetMepId, pvxMSTPPortRegRootCost=pvxMSTPPortRegRootCost, pvxERPSSrvcNumRingPorts=pvxERPSSrvcNumRingPorts, pvxERPSPortHistPMNrrbPduTxValidity=pvxERPSPortHistPMNrrbPduTxValidity, pvxMSTPXstRootPortNum=pvxMSTPXstRootPortNum, pvxFloClRowStatus=pvxFloClRowStatus, pvxERPSPortHistPMBlockedInitialize=pvxERPSPortHistPMBlockedInitialize, pvxVLANMSTPId=pvxVLANMSTPId, pvxLAGPortCrntPMMRKRSPPDUTXTimeStamp=pvxLAGPortCrntPMMRKRSPPDUTXTimeStamp, pvxEServiceSlaHistPMSwitchIdx=pvxEServiceSlaHistPMSwitchIdx, pvxESrvcBWPrflCrntPMBDWUtlzValue=pvxESrvcBWPrflCrntPMBDWUtlzValue, pvxStaticMulticastEntry=pvxStaticMulticastEntry, pvxERPSSrvcRingProperty=pvxERPSSrvcRingProperty, pvxLAGPortHistPMINVLACFRRXValue=pvxLAGPortHistPMINVLACFRRXValue, pvxMSTPPortState=pvxMSTPPortState, pvxMSTPCrntPMNRBCValue=pvxMSTPCrntPMNRBCValue, pvxMSTPMapSwitchIdx=pvxMSTPMapSwitchIdx, pvxLAGPortCrntPMMRKRSPPDURXValidity=pvxLAGPortCrntPMMRKRSPPDURXValidity, pvxPCVRTUntaggedPEP=pvxPCVRTUntaggedPEP, pvxESrvcBWPrflPMThresholdClsMapNameIdx=pvxESrvcBWPrflPMThresholdClsMapNameIdx, pvxPbCVidRegistrationTable=pvxPbCVidRegistrationTable, pvxFloClIdx=pvxFloClIdx, pvxERPSPortCrntPMFailuresTimeStamp=pvxERPSPortCrntPMFailuresTimeStamp, pvxERPSPortHistPMMsPduRxTimeStamp=pvxERPSPortHistPMMsPduRxTimeStamp, pvxPriority1TrafficClass=pvxPriority1TrafficClass, pvxSLAThroughputTestFrameSize5FarEndThroughput=pvxSLAThroughputTestFrameSize5FarEndThroughput, pvxMSTPPortShelfIdx=pvxMSTPPortShelfIdx, pvxPriorityTCMapRowStatus=pvxPriorityTCMapRowStatus, pvxESrvcBWPrflCrntPMOctetsCnfExcValue=pvxESrvcBWPrflCrntPMOctetsCnfExcValue, pvxMSTPPortCrntPMSwitchIdx=pvxMSTPPortCrntPMSwitchIdx, pvxMSTPPortCrntPMBPDUTXTimeStamp=pvxMSTPPortCrntPMBPDUTXTimeStamp, pvxLGOperStatus=pvxLGOperStatus, pvxLGDataRate=pvxLGDataRate, pvxVlanPortEthPortAllowedFrametType=pvxVlanPortEthPortAllowedFrametType, pvxMSTPPortCrntPMBPDUTCNRXTimeStamp=pvxMSTPPortCrntPMBPDUTCNRXTimeStamp, PvxESrvcBWPrflPMThresholdLevelType=PvxESrvcBWPrflPMThresholdLevelType, pvxERPSPortHistPMNrPduRxInitialize=pvxERPSPortHistPMNrPduRxInitialize, pvxVlanCurrentStatus=pvxVlanCurrentStatus, pvxBWPRowStatus=pvxBWPRowStatus, pvxEServiceSlaHistPM2WayDelayVariationMaximumInitialize=pvxEServiceSlaHistPM2WayDelayVariationMaximumInitialize, pvxESrvcBWPrflCrntPMBDWUtlzInitialize=pvxESrvcBWPrflCrntPMBDWUtlzInitialize)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxFlowMeterProfileTable=pvxFlowMeterProfileTable, pvxLAGPortHistPMIntervalTypeIdx=pvxLAGPortHistPMIntervalTypeIdx, pvxERPSPortHistPMFsPduRxInitialize=pvxERPSPortHistPMFsPduRxInitialize, pvxPbCVidRegistrationTableEntry=pvxPbCVidRegistrationTableEntry, pvxEServiceSlaCrntPM2WayDelayVariationMinimumInitialize=pvxEServiceSlaCrntPM2WayDelayVariationMinimumInitialize, pvxBWMeterEbs=pvxBWMeterEbs, pvxEServiceSlaHistPM2WayDelayVariationMaximumTimeStamp=pvxEServiceSlaHistPM2WayDelayVariationMaximumTimeStamp, pvxESrvcBWPrflHistPMPortIdx=pvxESrvcBWPrflHistPMPortIdx, pvxERPSPortHistPMMsPduTxTimeStamp=pvxERPSPortHistPMMsPduTxTimeStamp, pvxEcfmLtrTtl=pvxEcfmLtrTtl, pvxEcfmMepDbTable=pvxEcfmMepDbTable, pvxEcfmMipPortId=pvxEcfmMipPortId, pvxMSTPGenCistRoot=pvxMSTPGenCistRoot, pvxSrvcUNIRowStatus=pvxSrvcUNIRowStatus, pvxDscpPHBProfileRowStatus=pvxDscpPHBProfileRowStatus, pvxVLANOperStatus=pvxVLANOperStatus, pvxTMAPRowStatus=pvxTMAPRowStatus, pvxLagPortIdx=pvxLagPortIdx, pvxMSTPPortHistPMINVBPDURXInitialize=pvxMSTPPortHistPMINVBPDURXInitialize, pvxFloActPacketAction=pvxFloActPacketAction, pvxEServiceSlaHistPM2WayDelayMaximumInitialize=pvxEServiceSlaHistPM2WayDelayMaximumInitialize, pvxERPSPortCrntPMFsPduRxValue=pvxERPSPortCrntPMFsPduRxValue, pvxESrvcBWPrflHistPMDirectionIdx=pvxESrvcBWPrflHistPMDirectionIdx, pvxClassMapIpProtocolFilter=pvxClassMapIpProtocolFilter, pvxY1731LbStatsTotalResponders=pvxY1731LbStatsTotalResponders, pvxESrvcBWPrflHistPMTable=pvxESrvcBWPrflHistPMTable, pvxMgmtVLANSrvcName=pvxMgmtVLANSrvcName, pvxControlFrameProfileLldp=pvxControlFrameProfileLldp, pvxLAGPortCrntPMMRKPDUTXValue=pvxLAGPortCrntPMMRKPDUTXValue, pvxSwitchMemberInstIdx=pvxSwitchMemberInstIdx, pvxMSTPCrntPMIntervalTypeIdx=pvxMSTPCrntPMIntervalTypeIdx, pvxFloClDestMacFilter=pvxFloClDestMacFilter, pvxSrvcUNIFilterSequence=pvxSrvcUNIFilterSequence, pvxPCPEncPriority6DE=pvxPCPEncPriority6DE, pvxESrvcBWPrflHistPMOctetsCnfExcValue=pvxESrvcBWPrflHistPMOctetsCnfExcValue, pvxSLAThroughputTestFrameSize3=pvxSLAThroughputTestFrameSize3, pvxSlaMeasurementTcaEvt=pvxSlaMeasurementTcaEvt, pvxTMAPStpTunnMacAddr=pvxTMAPStpTunnMacAddr, pvxEServiceSlaCrntPMNearEndFrameLossValidity=pvxEServiceSlaCrntPMNearEndFrameLossValidity, pvxLAGPortCrntPMIntervalTypeIdx=pvxLAGPortCrntPMIntervalTypeIdx, pvxSLAThroughputTestShelfIdx=pvxSLAThroughputTestShelfIdx, pvxMSTPXstPortEntry=pvxMSTPXstPortEntry, pvxFloClL2InterfaceRange=pvxFloClL2InterfaceRange, pvxESrvcBWPrflHistPMEntry=pvxESrvcBWPrflHistPMEntry, pvxERPSPortHistPMNrPduRxValidity=pvxERPSPortHistPMNrPduRxValidity, pvxESrvcBWPrflCrntPMTable=pvxESrvcBWPrflCrntPMTable, pvxVlanCurrentTimeMark=pvxVlanCurrentTimeMark, pvxESrvcBWPrflHistPMBDWUtlzValidity=pvxESrvcBWPrflHistPMBDWUtlzValidity, pvxServiceNNIEntry=pvxServiceNNIEntry, pvxSrvcUNIPortTypeId=pvxSrvcUNIPortTypeId, pvxESrvcBWPrflHistPMOctetsTotalValue=pvxESrvcBWPrflHistPMOctetsTotalValue, pvxVlanPortRestrictedVlanState=pvxVlanPortRestrictedVlanState, pvxSvidXlateInternalSVid=pvxSvidXlateInternalSVid, pvxClassMapSrcIpFilter=pvxClassMapSrcIpFilter, pvxESrvcBWPrflCrntPMPlcyNameIdx=pvxESrvcBWPrflCrntPMPlcyNameIdx, pvxMSTPGenMaxHops=pvxMSTPGenMaxHops, pvxSLAThroughputTestSrvcPolicyName=pvxSLAThroughputTestSrvcPolicyName, pvxMSTPHistPMNRBCValidity=pvxMSTPHistPMNRBCValidity, pvxMSTPPortCrntPMINVBPDURXValue=pvxMSTPPortCrntPMINVBPDURXValue, pvxStaticUnicastAddressType=pvxStaticUnicastAddressType, pvxEServiceSlaCrntPMTable=pvxEServiceSlaCrntPMTable, pvxCoSProfileTable=pvxCoSProfileTable, pvxLAGPortHistPMSlotIdx=pvxLAGPortHistPMSlotIdx, pvxClassMapDstMACMaskFilter=pvxClassMapDstMACMaskFilter, pvxEcfmMepTransmitLtmStatus=pvxEcfmMepTransmitLtmStatus, pvxClassMapL4DstPortFilter=pvxClassMapL4DstPortFilter, pvxMSTPXstPortDesigRoot=pvxMSTPXstPortDesigRoot, pvxERPSPortCrntPMIntervalTypeIdx=pvxERPSPortCrntPMIntervalTypeIdx, pvxBWPEir=pvxBWPEir, pvxERPSPortCrntPMEventPduRxValidity=pvxERPSPortCrntPMEventPduRxValidity, pvxSchedProfRowStatus=pvxSchedProfRowStatus, pvxLagPortEntry=pvxLagPortEntry, PvxVlanId=PvxVlanId, pvxNNITable=pvxNNITable, pvxEServiceSlaCrntPMPortTypeIdx=pvxEServiceSlaCrntPMPortTypeIdx, pvxSLAMsmtThresholdDelayVarAverage=pvxSLAMsmtThresholdDelayVarAverage, pvxEcfmMepDbSwitchIdx=pvxEcfmMepDbSwitchIdx, pvxMSTPPortHistPMPMCInitialize=pvxMSTPPortHistPMPMCInitialize, pvxERPSPortCrntPMMsPduRxTimeStamp=pvxERPSPortCrntPMMsPduRxTimeStamp, pvxEcfmLtrVlanId=pvxEcfmLtrVlanId, pvxFloActSVlanValue=pvxFloActSVlanValue, pvxERPSPortHistPMEventPduTxTimeStamp=pvxERPSPortHistPMEventPduTxTimeStamp, pvxVlanCurrentCreationTime=pvxVlanCurrentCreationTime, pvxStaticMCAddressType=pvxStaticMCAddressType, pvxMSTPPortPathCost=pvxMSTPPortPathCost, pvxMepLocalRemoteFlag=pvxMepLocalRemoteFlag, pvxPCPEncPriority5DE=pvxPCPEncPriority5DE, pvxMSTPHistPMTable=pvxMSTPHistPMTable, pvxMSTPPortCrntPMBPDUTXValidity=pvxMSTPPortCrntPMBPDUTXValidity, pvxSLAMsmtResponderDBTable=pvxSLAMsmtResponderDBTable, pvxERPSSrvcNNIRingPortStatus=pvxERPSSrvcNNIRingPortStatus, pvxSLAThroughputTestPortTypeIdx=pvxSLAThroughputTestPortTypeIdx, pvxEServiceSlaHistPM2WayDelayVariationMaximumValidity=pvxEServiceSlaHistPM2WayDelayVariationMaximumValidity, pvxMgmtVLANTable=pvxMgmtVLANTable, pvxMSTPXstPortIdx=pvxMSTPXstPortIdx, pvxERPSPortCrntPMPduTxInitialize=pvxERPSPortCrntPMPduTxInitialize, pvxMultiCastGroupTable=pvxMultiCastGroupTable, pvxEthSrvcMaxUNIs=pvxEthSrvcMaxUNIs, pvxMSTPHistPMNRBCInitialize=pvxMSTPHistPMNRBCInitialize, pvxPCVRTMapOperStatus=pvxPCVRTMapOperStatus, pvxMSTPMapIdx=pvxMSTPMapIdx, pvxFlowActionsTable=pvxFlowActionsTable, pvxEthSrvcTransportType=pvxEthSrvcTransportType, pvxLagSystemIdentifier=pvxLagSystemIdentifier, pvxESrvcBWPrflCrntPMPortIdx=pvxESrvcBWPrflCrntPMPortIdx, pvxERPSSrvcRingSemState=pvxERPSSrvcRingSemState, pvxESrvcCrntPMUASValue=pvxESrvcCrntPMUASValue, pvxMSTPXstPortDesigBridge=pvxMSTPXstPortDesigBridge, pvxLAGPortCrntPMINVLACFRRXTimeStamp=pvxLAGPortCrntPMINVLACFRRXTimeStamp, pvxSLAMsmtInitiatorDBRowStatus=pvxSLAMsmtInitiatorDBRowStatus, pvxEthSrvcMEName=pvxEthSrvcMEName, pvxERPSPortCrntPMNrrbPduTxValidity=pvxERPSPortCrntPMNrrbPduTxValidity, pvxMSTPMapEntry=pvxMSTPMapEntry, pvxPriorityTCMapName=pvxPriorityTCMapName, pvxLAGPortCrntPMINVLACFRRXValidity=pvxLAGPortCrntPMINVLACFRRXValidity, pvxSLAThroughputTestInitiatorCmdState=pvxSLAThroughputTestInitiatorCmdState, pvxMSTPPortHistPMBPDUTCNRXValidity=pvxMSTPPortHistPMBPDUTCNRXValidity, pvxERPSPortHistPMNrPduTxTimeStamp=pvxERPSPortHistPMNrPduTxTimeStamp, pvxERPSPortCrntPMNrPduRxValue=pvxERPSPortCrntPMNrPduRxValue, pvxFlowTable=pvxFlowTable, pvxFloClEtherTypeFilter=pvxFloClEtherTypeFilter, pvxEthSrvcName=pvxEthSrvcName, pvxPCPEncPriority7=pvxPCPEncPriority7, pvxNNIPortTypeId=pvxNNIPortTypeId, pvxMSTPPortHistPMBPDUTXValidity=pvxMSTPPortHistPMBPDUTXValidity, pvxERPSSrvcNNIFlushRemoteMEP=pvxERPSSrvcNNIFlushRemoteMEP, pvxLAGPortCrntPMLACPDUTXInitialize=pvxLAGPortCrntPMLACPDUTXInitialize, pvxERPSSrvcPeriodicTimer=pvxERPSSrvcPeriodicTimer, pvxSLAMsmtThresholdDelayAverage=pvxSLAMsmtThresholdDelayAverage, pvxMSTPPortCrntPMPMCInitialize=pvxMSTPPortCrntPMPMCInitialize, pvxFloClSwitchIdx=pvxFloClSwitchIdx, pvxERPSPortHistPMIntervalIdx=pvxERPSPortHistPMIntervalIdx, pvxStaticUnicastReceivePort=pvxStaticUnicastReceivePort, pvxERPSPortHistPMFsPduRxValidity=pvxERPSPortHistPMFsPduRxValidity, pvxEcfmMepESrvcName=pvxEcfmMepESrvcName, pvxMSTPPortHistPMEntry=pvxMSTPPortHistPMEntry, pvxLagPortPriority=pvxLagPortPriority, pvxESrvcHistPMSwitchIdx=pvxESrvcHistPMSwitchIdx, pvxSwitchMemberEntry=pvxSwitchMemberEntry, pvxVlanPortGvrpAdminState=pvxVlanPortGvrpAdminState, pvxERPSPortHistPMNrrbPduTxValue=pvxERPSPortHistPMNrrbPduTxValue, pvxERPSPortHistPMSfPduRxValue=pvxERPSPortHistPMSfPduRxValue, pvxMSTPPortCrntPMBPDURXValidity=pvxMSTPPortCrntPMBPDURXValidity, pvxSLAThroughputTestFrameSize2NearEndThroughput=pvxSLAThroughputTestFrameSize2NearEndThroughput, pvxSLAMsmtResponderDBRMepId=pvxSLAMsmtResponderDBRMepId, pvxMSTPPortCrntPMXstIdx=pvxMSTPPortCrntPMXstIdx, pvxERPSPortCrntPMRecoveriesValue=pvxERPSPortCrntPMRecoveriesValue, pvxSchedProfMTUQuanta=pvxSchedProfMTUQuanta, pvxMCRowStatus=pvxMCRowStatus, pvxERPSPortCrntPMSfPduTxInitialize=pvxERPSPortCrntPMSfPduTxInitialize, mstpGlobalErrType=mstpGlobalErrType, pvxLagPortGroupId=pvxLagPortGroupId, pvxDscpPHBProfileEntry=pvxDscpPHBProfileEntry, pvxMSTPPortHistPMPMCTimeStamp=pvxMSTPPortHistPMPMCTimeStamp, pvxLAGPortHistPMLACPDUTXValidity=pvxLAGPortHistPMLACPDUTXValidity, pvxMSTPPortCrntPMBPDUCFGTXInitialize=pvxMSTPPortCrntPMBPDUCFGTXInitialize, pvxERPSPortHistPMNrPduTxInitialize=pvxERPSPortHistPMNrPduTxInitialize, pvxUNIEntry=pvxUNIEntry, pvxFloActYellowAction=pvxFloActYellowAction, pvxDynamicVlanPortTable=pvxDynamicVlanPortTable, pvxERPSPortHistPMUnblockedValue=pvxERPSPortHistPMUnblockedValue, pvxSLAThroughputTestFrameSize5NearEndThroughput=pvxSLAThroughputTestFrameSize5NearEndThroughput, pvxERPSSrvcNNISrvcName=pvxERPSSrvcNNISrvcName, pvxMSTPPortDesignatedBridge=pvxMSTPPortDesignatedBridge, pvxSLAMsmtThresholdDelayVarMaximum=pvxSLAMsmtThresholdDelayVarMaximum, pvxUNIMode=pvxUNIMode, pvxEServiceSlaHistPM2WayDelayVariationAverageTimeStamp=pvxEServiceSlaHistPM2WayDelayVariationAverageTimeStamp, pvxEcfmMepPortTypeId=pvxEcfmMepPortTypeId, pvxMSTPHistPMRCCCValue=pvxMSTPHistPMRCCCValue, pvxFCoSName=pvxFCoSName, pvxBWCnfrmActionChangeTOSFrmPri=pvxBWCnfrmActionChangeTOSFrmPri, pvxMSTPPortTypeIdx=pvxMSTPPortTypeIdx, pvxDscpClassSelector3=pvxDscpClassSelector3, pvxMSTPPortRole=pvxMSTPPortRole, pvxLagPortTable=pvxLagPortTable, pvxFSRowStatus=pvxFSRowStatus, pvxMSTPXstPortRole=pvxMSTPXstPortRole, pvxServiceUNIEntry=pvxServiceUNIEntry, pvxESrvcHistPMTable=pvxESrvcHistPMTable, pvxERPSPortHistPMShelfIdx=pvxERPSPortHistPMShelfIdx, pvxLAGPortHistPMMRKRSPPDUTXValidity=pvxLAGPortHistPMMRKRSPPDUTXValidity, pvxERPSPortCrntPMNrrbPduRxValidity=pvxERPSPortCrntPMNrrbPduRxValidity, pvxERPSSrvcNNIRingPortId=pvxERPSSrvcNNIRingPortId, pvxY1731LbStatsTable=pvxY1731LbStatsTable, pvxERPSPortCrntPMVersionDiscardTimeStamp=pvxERPSPortCrntPMVersionDiscardTimeStamp, pvxSrvcNNIEgressBW=pvxSrvcNNIEgressBW, pvxSLAMsmtInitiatorDBPortTypeIdx=pvxSLAMsmtInitiatorDBPortTypeIdx, pvxESrvcCrntPMEntry=pvxESrvcCrntPMEntry, pvxPCPEncPriority4DE=pvxPCPEncPriority4DE, pvxSrvcUNIEFPSDEnabled=pvxSrvcUNIEFPSDEnabled, pvxVLANRowStatus=pvxVLANRowStatus, pvxLAGPortHistPMShelfIdx=pvxLAGPortHistPMShelfIdx, pvxEcfmMepOutOfService=pvxEcfmMepOutOfService, pvxSrvcNNIPortId=pvxSrvcNNIPortId, pvxLAGPortHistPMINVLACFRRXTimeStamp=pvxLAGPortHistPMINVLACFRRXTimeStamp, pvxMSTPCrntPMRCCCTimeStamp=pvxMSTPCrntPMRCCCTimeStamp, pvxPriority3TrafficClass=pvxPriority3TrafficClass, pvxSchedProfMaxBwQ3=pvxSchedProfMaxBwQ3, pvxSLAThroughputTestTable=pvxSLAThroughputTestTable, pvxERPSSrvcName=pvxERPSSrvcName, pvxMSTPPortLinkType=pvxMSTPPortLinkType, pvxEcfmMipSwitchIdx=pvxEcfmMipSwitchIdx, pvxEServiceSlaCrntPM2WayDelayMinimumInitialize=pvxEServiceSlaCrntPM2WayDelayMinimumInitialize, pvxSLAThroughputTestSVlanPriority=pvxSLAThroughputTestSVlanPriority, pvxMSTPMapRowStatus=pvxMSTPMapRowStatus, pvxESrvcBWPrflCrntPMOctetsTotalValue=pvxESrvcBWPrflCrntPMOctetsTotalValue, pvxERPSPortHistPMSfPduRxTimeStamp=pvxERPSPortHistPMSfPduRxTimeStamp, pvxMSTPGenIdName=pvxMSTPGenIdName, pvxSLAThroughputTestFrameSize5=pvxSLAThroughputTestFrameSize5, pvxVlanPortTable=pvxVlanPortTable, pvxVLANService=pvxVLANService, pvxFlowMeterTable=pvxFlowMeterTable, pvxMSTPPortLoopGuardState=pvxMSTPPortLoopGuardState, pvxLAGPortCrntPMMRKPDUTXInitialize=pvxLAGPortCrntPMMRKPDUTXInitialize, pvxERPSPortHistPMMsPduTxInitialize=pvxERPSPortHistPMMsPduTxInitialize, pvxERPSPortHistPMRecoveriesValue=pvxERPSPortHistPMRecoveriesValue, pvxMSTPPortHistPMBPDUTCNTXValue=pvxMSTPPortHistPMBPDUTCNTXValue, pvxEcfmMipRowStatus=pvxEcfmMipRowStatus, pvxSrvcUNIIngressBWperCos=pvxSrvcUNIIngressBWperCos, pvxY1731LbStatsLbrIn=pvxY1731LbStatsLbrIn, pvxSLAThroughputTestFrameSize6=pvxSLAThroughputTestFrameSize6, pvxMSTPPortCrntPMBPDUTCNRXValidity=pvxMSTPPortCrntPMBPDUTCNRXValidity, pvxMSTPPortHistPMIntervalIdx=pvxMSTPPortHistPMIntervalIdx, pvxERPSPortHistPMPduTxTimeStamp=pvxERPSPortHistPMPduTxTimeStamp, pvxLAGPortCrntPMLACPDUTXValue=pvxLAGPortCrntPMLACPDUTXValue, pvxERPSPortHistPMPduRxValidity=pvxERPSPortHistPMPduRxValidity, pvxLAGPortCrntPMINVLACFRRXValue=pvxLAGPortCrntPMINVLACFRRXValue, pvxEcfmLtrReceiveOrder=pvxEcfmLtrReceiveOrder, pvxStaticMCForbiddenIntfIdList=pvxStaticMCForbiddenIntfIdList, pvxMSTPPortDesignatedPort=pvxMSTPPortDesignatedPort, pvxEServiceSlaCrntPMSwitchIdx=pvxEServiceSlaCrntPMSwitchIdx, PvxEcfmRelayActionFieldValue=PvxEcfmRelayActionFieldValue, pvxPriorityTCMapEntry=pvxPriorityTCMapEntry, pvxVLANSwitchIdx=pvxVLANSwitchIdx, PvxEcfmMepDefects=PvxEcfmMepDefects, pvxNextFreeIndexSwitchIdx=pvxNextFreeIndexSwitchIdx, pvxVlanPortAddDynamicVlanEvt=pvxVlanPortAddDynamicVlanEvt, pvxLAGPortCrntPMLACPDURXInitialize=pvxLAGPortCrntPMLACPDURXInitialize, pvxERPSPortCrntPMRecoveriesTimeStamp=pvxERPSPortCrntPMRecoveriesTimeStamp, pvxFloActRedirectToInterfaceIndex=pvxFloActRedirectToInterfaceIndex, pvxFSOutOfProfilePackets=pvxFSOutOfProfilePackets, pvxMSTPMapVlanS3k=pvxMSTPMapVlanS3k, pvxEcfmMepDbEntry=pvxEcfmMepDbEntry, pvxUNIPortTypeId=pvxUNIPortTypeId, PvxPhyPortList=PvxPhyPortList, pvxSLAThroughputTestEntry=pvxSLAThroughputTestEntry, pvxMSTPPortHistPMIdx=pvxMSTPPortHistPMIdx, pvxMSTPGenExternalRootCost=pvxMSTPGenExternalRootCost, pvxESrvcBWPrflHistPMOctetsVltValue=pvxESrvcBWPrflHistPMOctetsVltValue, pvxStaticUnicastRowStatus=pvxStaticUnicastRowStatus, pvxDscpClassBestEffort=pvxDscpClassBestEffort, pvxERPSSrvcFOPProvisionMismatchClear=pvxERPSSrvcFOPProvisionMismatchClear, pvxFloClSourceIPFilter=pvxFloClSourceIPFilter, pvxERPSPortHistPMEventPduRxValidity=pvxERPSPortHistPMEventPduRxValidity)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxClassMapSrcMACAddrFilter=pvxClassMapSrcMACAddrFilter, pvxERPSPortHistPMMsPduRxInitialize=pvxERPSPortHistPMMsPduRxInitialize, pvxSLAThroughputTestFrameSize4=pvxSLAThroughputTestFrameSize4, resourceUnavailableCond=resourceUnavailableCond, pvxClassMapDscpFilter=pvxClassMapDscpFilter, pvxMSTPPortCrntPMPMCValidity=pvxMSTPPortCrntPMPMCValidity, pvxPCPDecPriority4=pvxPCPDecPriority4, pvxNNISwitchId=pvxNNISwitchId, pvxESrvcCrntPMTable=pvxESrvcCrntPMTable, pvxControlFrameProfileLacp=pvxControlFrameProfileLacp, pvxMSTPXstBrdgRegRoot=pvxMSTPXstBrdgRegRoot, pvxMSTPPortHistPMIntervalTypeIdx=pvxMSTPPortHistPMIntervalTypeIdx, pvxERPSPortHistPMPduRxInitialize=pvxERPSPortHistPMPduRxInitialize, pvxERPSPortCrntPMPduDiscardValidity=pvxERPSPortCrntPMPduDiscardValidity, pvxSchedProfWeightQ2=pvxSchedProfWeightQ2, pvxLAGPortCrntPMSwitchIdx=pvxLAGPortCrntPMSwitchIdx, pvxSrvcUNIEgressBW=pvxSrvcUNIEgressBW, pvxSwitchIdx=pvxSwitchIdx, pvxERPSPortCrntPMPduDiscardInitialize=pvxERPSPortCrntPMPduDiscardInitialize, pvxFMRowStatus=pvxFMRowStatus, pvxPolicyMapProfileEntry=pvxPolicyMapProfileEntry, pvxFloClSourceUDPorTCPFilter=pvxFloClSourceUDPorTCPFilter, pvxESrvcHistPMIntervalIdx=pvxESrvcHistPMIntervalIdx, pvxLagPortMode=pvxLagPortMode, pvxEcfmLtrIngressAction=pvxEcfmLtrIngressAction, pvxSLAThroughputTestRole=pvxSLAThroughputTestRole, pvxPCVRTCVlanIdFrom=pvxPCVRTCVlanIdFrom, pvxFMPIdx=pvxFMPIdx, pvxEServiceSlaCrntPM2WayDelayVariationMinimum=pvxEServiceSlaCrntPM2WayDelayVariationMinimum, pvxERPSPortHistPMPduRxValue=pvxERPSPortHistPMPduRxValue, pvxVLANMacLearning=pvxVLANMacLearning, pvxERPSPortHistPMFsPduTxValue=pvxERPSPortHistPMFsPduTxValue, pvxLagSystemPriority=pvxLagSystemPriority, pvxSLAMeasurementProfileEntry=pvxSLAMeasurementProfileEntry, pvxClassMapSrcIpNetMaskFilter=pvxClassMapSrcIpNetMaskFilter, pvxMSTPPortTable=pvxMSTPPortTable, pvxEcfmMepSwitchIdx=pvxEcfmMepSwitchIdx, pvxLAGPortCrntPMMRKRSPPDUTXInitialize=pvxLAGPortCrntPMMRKRSPPDUTXInitialize, pvxY1731LbStatsLbrTimeAverage=pvxY1731LbStatsLbrTimeAverage, pvxMSTPPortRestrictedRole=pvxMSTPPortRestrictedRole, pvxERPSPortCrntPMFsPduRxValidity=pvxERPSPortCrntPMFsPduRxValidity, pvxPriority4TrafficClass=pvxPriority4TrafficClass, pvxLAGPortCrntPMMRKPDURXValue=pvxLAGPortCrntPMMRKPDURXValue, pvxERPSSrvcGuardTimer=pvxERPSSrvcGuardTimer, pvxY1731LbStatsLbrTimeMin=pvxY1731LbStatsLbrTimeMin, pvxPCPEncPriority0DE=pvxPCPEncPriority0DE, pvxSvidXlateShelfId=pvxSvidXlateShelfId, pvxMSTPPortHistPMBPDUTXValue=pvxMSTPPortHistPMBPDUTXValue, pvxPriority2TrafficClass=pvxPriority2TrafficClass, pvxFloActNewPriority=pvxFloActNewPriority, pvxPCVRTRowStatus=pvxPCVRTRowStatus, pvxERPSPortHistPMMsPduRxValidity=pvxERPSPortHistPMMsPduRxValidity, pvxESrvcHistPMUASTimeStamp=pvxESrvcHistPMUASTimeStamp, pvxFloClSVlanFilter=pvxFloClSVlanFilter, pvxMSTPCrntPMEntry=pvxMSTPCrntPMEntry, pvxEServiceSlaHistPMIntervalTypeIdx=pvxEServiceSlaHistPMIntervalTypeIdx, pvxUNISpeed=pvxUNISpeed, pvxEcfmLtrEntry=pvxEcfmLtrEntry, pvxLAGPortHistPMLACPDURXInitialize=pvxLAGPortHistPMLACPDURXInitialize, pvxMSTPPortCrntPMIdx=pvxMSTPPortCrntPMIdx, pvxEcfmMepTransmitLbmResultOK=pvxEcfmMepTransmitLbmResultOK, pvxMSTPHistPMIntervalIdx=pvxMSTPHistPMIntervalIdx, pvxClassMapSVlanFilter=pvxClassMapSVlanFilter, pvxMSTPPortHistPMBPDUCFGTXInitialize=pvxMSTPPortHistPMBPDUCFGTXInitialize, pvxVlanPortSlotIdx=pvxVlanPortSlotIdx, pvxSrvcUNIShelfId=pvxSrvcUNIShelfId, pvxERPSSrvcWaitToBlockTimer=pvxERPSSrvcWaitToBlockTimer, pvxESrvcBWPrflCrntPMShelfIdx=pvxESrvcBWPrflCrntPMShelfIdx, pvxSLAThroughputTestFrameSize6FarEndThroughput=pvxSLAThroughputTestFrameSize6FarEndThroughput, pvxESrvcBWPrflCrntPMSwitchIdx=pvxESrvcBWPrflCrntPMSwitchIdx, pvxESrvcBWPrflHistPMOctetsCnfExcTimeStamp=pvxESrvcBWPrflHistPMOctetsCnfExcTimeStamp, pvxFloClStatus=pvxFloClStatus, PvxL2PortList=PvxL2PortList, pvxUNIServiceType=pvxUNIServiceType, pvxMSTPPortCrntPMBPDUCFGRXValidity=pvxMSTPPortCrntPMBPDUCFGRXValidity, pvxMSTPGenCistRootCost=pvxMSTPGenCistRootCost, pvxEcfmMepDefects=pvxEcfmMepDefects, pvxMSTPGenIdFmtSel=pvxMSTPGenIdFmtSel, pvxLAGPortHistPMEntry=pvxLAGPortHistPMEntry, pvxMSTPHistPMTCCTimeStamp=pvxMSTPHistPMTCCTimeStamp, pvxMSTPGenCistRootPriority=pvxMSTPGenCistRootPriority, pvxDscpClassSelector6=pvxDscpClassSelector6, pvxMSTPPortCrntPMBPDURXInitialize=pvxMSTPPortCrntPMBPDURXInitialize, pvxERPSSrvcNNILocalMepId=pvxERPSSrvcNNILocalMepId, pvxEcfmLtrIngressMac=pvxEcfmLtrIngressMac, pvxERPSPortCrntPMNrrbPduRxInitialize=pvxERPSPortCrntPMNrrbPduRxInitialize, pvxERPSSrvcNodeType=pvxERPSSrvcNodeType, pvxStaticUnicastEntry=pvxStaticUnicastEntry, pvxStaticMCMACAddrIdx=pvxStaticMCMACAddrIdx, pvxEServiceSlaCrntPMFarEndFrameLoss=pvxEServiceSlaCrntPMFarEndFrameLoss, pvxERPSPortCrntPMMsPduTxValidity=pvxERPSPortCrntPMMsPduTxValidity, pvxFMSwitchIdx=pvxFMSwitchIdx, pvxERPSPortHistPMPduTxValidity=pvxERPSPortHistPMPduTxValidity, pvxPCPEncDecRowStatus=pvxPCPEncDecRowStatus, pvxESrvcBWPrflHistPMBDWUtlzInitialize=pvxESrvcBWPrflHistPMBDWUtlzInitialize, pvxPCVRTSVlanId=pvxPCVRTSVlanId, pvxNextFreeIndexValue=pvxNextFreeIndexValue, pvxLagPortPrtnrAdminState=pvxLagPortPrtnrAdminState, pvxBWPCoSQueue=pvxBWPCoSQueue, pvxERPSSrvcWaitToRestoreTimer=pvxERPSSrvcWaitToRestoreTimer, pvxDscpAssuredFwd1y=pvxDscpAssuredFwd1y, pvxEServiceSlaCrntPMRMepId=pvxEServiceSlaCrntPMRMepId, pvxEcfmMepDbVlanId=pvxEcfmMepDbVlanId, pvxLAGPortCrntPMMRKRSPPDUTXValidity=pvxLAGPortCrntPMMRKRSPPDUTXValidity, pvxEcfmMepIdentifier=pvxEcfmMepIdentifier, pvxERPSPortCrntPMMsPduRxInitialize=pvxERPSPortCrntPMMsPduRxInitialize, pvxLAGPortHistPMSwitchIdx=pvxLAGPortHistPMSwitchIdx, pvxSLAThroughputTestFrameSize1FarEndThroughput=pvxSLAThroughputTestFrameSize1FarEndThroughput, pvxEcfmMepSlotId=pvxEcfmMepSlotId, pvxERPSPortHistPMFailuresInitialize=pvxERPSPortHistPMFailuresInitialize, pvxEServiceSlaCrntPM2WayDelayVariationMaximumValidity=pvxEServiceSlaCrntPM2WayDelayVariationMaximumValidity, pvxERPSPortCrntPMVersionDiscardInitialize=pvxERPSPortCrntPMVersionDiscardInitialize, pvxERPSPortHistPMNrPduTxValidity=pvxERPSPortHistPMNrPduTxValidity, pvxUNICurrentFrameSize=pvxUNICurrentFrameSize, pvxESrvcBWPrflHistPMShelfIdx=pvxESrvcBWPrflHistPMShelfIdx, pvxPCPEncPriority1DE=pvxPCPEncPriority1DE, pvxSwitchMemberSlotId=pvxSwitchMemberSlotId, pvxVLANAdminState=pvxVLANAdminState, pvxBandwidthProfileTable=pvxBandwidthProfileTable, pvxSrvcNNIIngressBWperCos=pvxSrvcNNIIngressBWperCos, pvxEcfmMepLbrBadMsdu=pvxEcfmMepLbrBadMsdu, pvxMSTPPortCrntPMINVBPDUTCNRXInitialize=pvxMSTPPortCrntPMINVBPDUTCNRXInitialize, pvxMSTPGenVersionSupported=pvxMSTPGenVersionSupported, pvxMepSequenceId=pvxMepSequenceId, pvxVlanPortRemoveDynamicVlanEvt=pvxVlanPortRemoveDynamicVlanEvt, pvxMSTPPortCrntPMINVBPDURXInitialize=pvxMSTPPortCrntPMINVBPDURXInitialize, pvxERPSPortHistPMUnblockedTimeStamp=pvxERPSPortHistPMUnblockedTimeStamp, pvxMSTPGenIdDigest=pvxMSTPGenIdDigest, pvxERPSPortCrntPMBlockedInitialize=pvxERPSPortCrntPMBlockedInitialize, pvxBWExceedActionChangeDscp=pvxBWExceedActionChangeDscp, pvxLAGPortHistPMMRKRSPPDURXInitialize=pvxLAGPortHistPMMRKRSPPDURXInitialize, pvxEcfmMepDbRMepRDI=pvxEcfmMepDbRMepRDI, pvxMSTPXstPortInstIdx=pvxMSTPXstPortInstIdx, pvxEServiceSlaCrntPM2WayDelayMaximumTimeStamp=pvxEServiceSlaCrntPM2WayDelayMaximumTimeStamp, mstpPacketErrType=mstpPacketErrType, pvxERPSPortHistPMEntry=pvxERPSPortHistPMEntry, pvxESrvcBWPrflHistPMBDWUtlzTimeStamp=pvxESrvcBWPrflHistPMBDWUtlzTimeStamp, pvxERPSPortHistPMVersionDiscardInitialize=pvxERPSPortHistPMVersionDiscardInitialize, pvxESrvcCrntPMUASTimeStamp=pvxESrvcCrntPMUASTimeStamp, pvxMSTPPortSwitchIdx=pvxMSTPPortSwitchIdx, pvxFSCountOfClassifiedPackets=pvxFSCountOfClassifiedPackets, pvxBWProfileTable=pvxBWProfileTable, pvxERPSPortHistPMNrPduTxValue=pvxERPSPortHistPMNrPduTxValue, pvxESrvcBWPrflCrntPMOctetsVltInitialize=pvxESrvcBWPrflCrntPMOctetsVltInitialize, pvxPCPDecPriority1=pvxPCPDecPriority1, pvxMSTPPortCrntPMFWDTRValue=pvxMSTPPortCrntPMFWDTRValue, pvxMSTPPortCrntPMBPDUCFGTXValue=pvxMSTPPortCrntPMBPDUCFGTXValue, pvxMSTPPortCrntPMBPDUTXInitialize=pvxMSTPPortCrntPMBPDUTXInitialize, switchMemberStkPortDownCond=switchMemberStkPortDownCond, pvxMSTPPortHistPMBPDUTCNTXInitialize=pvxMSTPPortHistPMBPDUTCNTXInitialize, pvxEServiceSlaCrntPMFarEndFrameLossTimeStamp=pvxEServiceSlaCrntPMFarEndFrameLossTimeStamp, pvxLagPortActAdminState=pvxLagPortActAdminState, pvxMSTPCrntPMSwitchIdx=pvxMSTPCrntPMSwitchIdx, pvxMSTPPortHistPMBPDUCFGTXTimeStamp=pvxMSTPPortHistPMBPDUCFGTXTimeStamp, pvxESrvcBWPrflCrntPMBDWUtlzValidity=pvxESrvcBWPrflCrntPMBDWUtlzValidity, pvxESrvcBWPrflCrntPMIntervalTypeIdx=pvxESrvcBWPrflCrntPMIntervalTypeIdx, pvxTMAPGvrpTunnMacAddr=pvxTMAPGvrpTunnMacAddr, pvxSwitchTunnMacAddrProfile=pvxSwitchTunnMacAddrProfile, pvxERPSSrvcNNIPortTypeId=pvxERPSSrvcNNIPortTypeId, pvxERPSSrvcSVLAN=pvxERPSSrvcSVLAN, pvxEthSrvcType=pvxEthSrvcType, pvxUNINumServices=pvxUNINumServices, pvxSLAMsmtInitiatorDBCmdState=pvxSLAMsmtInitiatorDBCmdState, pvxLAGPortHistPMMRKPDUTXTimeStamp=pvxLAGPortHistPMMRKPDUTXTimeStamp, pvxLagTable=pvxLagTable, pvxMSTPXstPortTypeIdx=pvxMSTPXstPortTypeIdx, pvxLAGPortHistPMIntervalIdx=pvxLAGPortHistPMIntervalIdx, pvxFloActMirrorToInterfaceIndex=pvxFloActMirrorToInterfaceIndex, pvxESrvcCrntPMESrvcNameIdx=pvxESrvcCrntPMESrvcNameIdx, pvxSLAThroughputTestESName=pvxSLAThroughputTestESName, pvxMSTPXstBrdgRegRootCost=pvxMSTPXstBrdgRegRootCost, pvxLGPortList=pvxLGPortList, mstpProtocolMigrationType=mstpProtocolMigrationType, pvxMSTPPortCrntPMINVBPDUTCNRXValidity=pvxMSTPPortCrntPMINVBPDUTCNRXValidity, pvxMgmtVLANBWProfileName=pvxMgmtVLANBWProfileName, pvxMgmtVLANCVLANId=pvxMgmtVLANCVLANId, pvxEcfmMepUnexpLtrIn=pvxEcfmMepUnexpLtrIn, pvxMSTPGenEntry=pvxMSTPGenEntry, pvxERPSPortCrntPMPduDiscardTimeStamp=pvxERPSPortCrntPMPduDiscardTimeStamp, pvxERPSPortHistPMEventPduRxTimeStamp=pvxERPSPortHistPMEventPduRxTimeStamp, pvxMSTPPortHistPMFWDTRInitialize=pvxMSTPPortHistPMFWDTRInitialize, pvxMSTPPortHistPMBPDUCFGTXValidity=pvxMSTPPortHistPMBPDUCFGTXValidity, pvxERPSPortCrntPMSfPduRxTimeStamp=pvxERPSPortCrntPMSfPduRxTimeStamp, pvxEServiceSlaHistPM2WayDelayMaximumValidity=pvxEServiceSlaHistPM2WayDelayMaximumValidity, pvxEthSrvcNumNNIs=pvxEthSrvcNumNNIs, pvxMSTPXstBrdgId=pvxMSTPXstBrdgId, pvxERPSPortCrntPMMsPduTxValue=pvxERPSPortCrntPMMsPduTxValue, pvxLAGPortCrntPMEntry=pvxLAGPortCrntPMEntry, pvxERPSSrvcNNINeighborPort=pvxERPSSrvcNNINeighborPort, pvxPCVRTCVlanIdTo=pvxPCVRTCVlanIdTo, pvxEthServiceTable=pvxEthServiceTable, pvxPCPEncDecSelectRow=pvxPCPEncDecSelectRow, pvxMSTPXstPortPathCost=pvxMSTPXstPortPathCost, PvxEcfmConfigErrors=PvxEcfmConfigErrors, pvxVlanPortIngressFiltering=pvxVlanPortIngressFiltering, pvxEcfmMepDbRMepSwitchName=pvxEcfmMepDbRMepSwitchName, pvxERPSSrvcCompatibleVersion=pvxERPSSrvcCompatibleVersion, pvxSchedProfAlgorithm=pvxSchedProfAlgorithm, pvxERPSPortCrntPMPduTxTimeStamp=pvxERPSPortCrntPMPduTxTimeStamp, pvxFDBAddressType=pvxFDBAddressType, pvxERPSPortHistPMEventPduTxInitialize=pvxERPSPortHistPMEventPduTxInitialize, pvxStaticMCSwitchIdx=pvxStaticMCSwitchIdx, pvxSLAThroughputTestFrameSize2=pvxSLAThroughputTestFrameSize2, pvxSchedProfMaxBwQ7=pvxSchedProfMaxBwQ7, pvxERPSPortCrntPMRecoveriesValidity=pvxERPSPortCrntPMRecoveriesValidity, pvxEServiceSlaHistPM2WayDelayAverage=pvxEServiceSlaHistPM2WayDelayAverage, pvxPolicyMapPolicyName=pvxPolicyMapPolicyName, pvxDynamicVlanPortTimeMark=pvxDynamicVlanPortTimeMark, pvxERPSPortCrntPMPduRxValue=pvxERPSPortCrntPMPduRxValue, mstpInvalidPacketRcvdEvt=mstpInvalidPacketRcvdEvt, pvxFDBEntry=pvxFDBEntry, pvxMSTPPortForcedPortState=pvxMSTPPortForcedPortState, pvxSLAMsmtInitiatorDBRMepId=pvxSLAMsmtInitiatorDBRMepId, pvxEthSrvcNumUNIs=pvxEthSrvcNumUNIs, pvxPriority7TrafficClass=pvxPriority7TrafficClass, pvxLAGPortHistPMMRKRSPPDUTXValue=pvxLAGPortHistPMMRKRSPPDUTXValue, pvxERPSPortCrntPMMsPduRxValidity=pvxERPSPortCrntPMMsPduRxValidity, pvxControlFrameProfileGvrp=pvxControlFrameProfileGvrp, pvxVlanPortIdx=pvxVlanPortIdx, pvxBWPCir=pvxBWPCir, pvxNNIMaxFrameSize=pvxNNIMaxFrameSize, pvxFloClCVlanFilter=pvxFloClCVlanFilter, pvxFMMeterIdx=pvxFMMeterIdx, pvxClassMapDstIpNetMaskFilter=pvxClassMapDstIpNetMaskFilter, pvxBandwidthProfileRowStatus=pvxBandwidthProfileRowStatus, pvxY1731LbStatsIdentifier=pvxY1731LbStatsIdentifier, pvxMSTPPortHistPMBPDUTXTimeStamp=pvxMSTPPortHistPMBPDUTXTimeStamp, pvxControlFrameProfileGmrp=pvxControlFrameProfileGmrp, pvxESrvcBWPrflHistPMOctetsTotalTimeStamp=pvxESrvcBWPrflHistPMOctetsTotalTimeStamp, pvxESrvcBWPrflHistPMIntervalTypeIdx=pvxESrvcBWPrflHistPMIntervalTypeIdx, pvxMSTPPortHistPMBPDURXTimeStamp=pvxMSTPPortHistPMBPDURXTimeStamp, pvxVlanPortRemoveDynamicVlanEvtNotifications=pvxVlanPortRemoveDynamicVlanEvtNotifications, pvxVlanPortLastBpduOriginChangeEvt=pvxVlanPortLastBpduOriginChangeEvt, pvxERPSPortCrntPMVersionDiscardValue=pvxERPSPortCrntPMVersionDiscardValue, pvxMSTPPortCrntPMBPDURXTimeStamp=pvxMSTPPortCrntPMBPDURXTimeStamp, pvxMSTPPortHistPMBPDUTCNRXTimeStamp=pvxMSTPPortHistPMBPDUTCNRXTimeStamp, pvxERPSPortCrntPMShelfIdx=pvxERPSPortCrntPMShelfIdx, pvxSwitchMemberIdx=pvxSwitchMemberIdx, pvxERPSPortHistPMRecoveriesTimeStamp=pvxERPSPortHistPMRecoveriesTimeStamp, pvxERPSPortHistPMEventPduTxValidity=pvxERPSPortHistPMEventPduTxValidity, pvxERPSPortHistPMPduDiscardTimeStamp=pvxERPSPortHistPMPduDiscardTimeStamp, pvxDscpClassSelector2=pvxDscpClassSelector2, pvxEServiceSlaCrntPM2WayDelayVariationAverage=pvxEServiceSlaCrntPM2WayDelayVariationAverage, pvxLagGroupEntry=pvxLagGroupEntry, pvxEcfmLtrSwitchName=pvxEcfmLtrSwitchName, pvxVLANIdx=pvxVLANIdx, pvxLAGPortHistPMMRKPDURXInitialize=pvxLAGPortHistPMMRKPDURXInitialize, pvxERPSPortCrntPMSlotIdx=pvxERPSPortCrntPMSlotIdx, pvxERPSSrvcVersionMismatchCond=pvxERPSSrvcVersionMismatchCond, pvxEServiceSlaHistPMRMepId=pvxEServiceSlaHistPMRMepId, pvxERPSPortHistPMEventPduRxInitialize=pvxERPSPortHistPMEventPduRxInitialize, pvxERPSPortCrntPMNrPduTxValue=pvxERPSPortCrntPMNrPduTxValue, pvxMSTPXstPortState=pvxMSTPXstPortState, pvxSrvcNNIShelfId=pvxSrvcNNIShelfId)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxMSTPPortHistPMINVBPDURXValidity=pvxMSTPPortHistPMINVBPDURXValidity, pvxSLAThroughputTestBwProfileName=pvxSLAThroughputTestBwProfileName, pvxEcfmMepEntry=pvxEcfmMepEntry, pvxMSTPPortCrntPMINVBPDUCFGRXInitialize=pvxMSTPPortCrntPMINVBPDUCFGRXInitialize, pvxESrvcBWPrflBDWUtlzTcaEvt=pvxESrvcBWPrflBDWUtlzTcaEvt, pvxSLAMsmtResponderDBEntry=pvxSLAMsmtResponderDBEntry, pvxLAGPortHistPMLACPDURXValue=pvxLAGPortHistPMLACPDURXValue, pvxESrvcBWPrflPMThresholdDirectionIdx=pvxESrvcBWPrflPMThresholdDirectionIdx, pvxLAGPortHistPMIdx=pvxLAGPortHistPMIdx, pvxMSTPHistPMIntervalTypeIdx=pvxMSTPHistPMIntervalTypeIdx, pvxControlFrameProfileDot1x=pvxControlFrameProfileDot1x, pvxFMMeterProfileId=pvxFMMeterProfileId, pvxMSTPPortCrntPMFWDTRValidity=pvxMSTPPortCrntPMFWDTRValidity, pvxPCPEncPriority3DE=pvxPCPEncPriority3DE, pvxLAGPortHistPMMRKRSPPDURXValidity=pvxLAGPortHistPMMRKRSPPDURXValidity, pvxFloClMeterId=pvxFloClMeterId, pvxERPSPortHistPMSfPduTxValidity=pvxERPSPortHistPMSfPduTxValidity, pvxERPSPortCrntPMUnblockedInitialize=pvxERPSPortCrntPMUnblockedInitialize, pvxSrvcUNIForwarding=pvxSrvcUNIForwarding, pvxSrvcUNISrvcName=pvxSrvcUNISrvcName, pvxClassMapCVlanPriFilter=pvxClassMapCVlanPriFilter, pvxStackingPortRowStatus=pvxStackingPortRowStatus, pvxEServiceSlaCrntPMNearEndFrameLoss=pvxEServiceSlaCrntPMNearEndFrameLoss, pvxPCPEncDecProfileTable=pvxPCPEncDecProfileTable, pvxClassMapDstIpFilter=pvxClassMapDstIpFilter, pvxEcfmMepDbRMepPortInfo=pvxEcfmMepDbRMepPortInfo, pvxLagPortAggState=pvxLagPortAggState, pvxERPSSrvcUpMegLevel=pvxERPSSrvcUpMegLevel, pvxDynamicVlanPortVlanIdx=pvxDynamicVlanPortVlanIdx, pvxClassMapCVlanFilter=pvxClassMapCVlanFilter, pvxEServiceSlaHistPM2WayDelayVariationMinimum=pvxEServiceSlaHistPM2WayDelayVariationMinimum, pvxMSTPPortHistPMINVBPDUCFGRXTimeStamp=pvxMSTPPortHistPMINVBPDUCFGRXTimeStamp, pvxStaticUnicastSwitchIdx=pvxStaticUnicastSwitchIdx, pvxFloActYellowCNGAction=pvxFloActYellowCNGAction, pvxEcfmMepLbrInOutOfOrder=pvxEcfmMepLbrInOutOfOrder, pvxEServiceSlaHistPMEntry=pvxEServiceSlaHistPMEntry, pvxFSInProfilePackets=pvxFSInProfilePackets, pvxESrvcBWPrflHistPMBDWUtlzValue=pvxESrvcBWPrflHistPMBDWUtlzValue, pvxMSTPHistPMXstIdx=pvxMSTPHistPMXstIdx, pvxFloActMirrorType=pvxFloActMirrorType, pvxEthSrvcCVidXlate=pvxEthSrvcCVidXlate, pvxSrvcNNISrvcName=pvxSrvcNNISrvcName, pvxERPSPortCrntPMPduDiscardValue=pvxERPSPortCrntPMPduDiscardValue, pvxClassMapCVlanEndFilter=pvxClassMapCVlanEndFilter, PvxPolicyDropAction=PvxPolicyDropAction, pvxSLAThroughputTestFrameSize6NearEndThroughput=pvxSLAThroughputTestFrameSize6NearEndThroughput, pvxESrvcBWPrflCrntPMClsMapNameIdx=pvxESrvcBWPrflCrntPMClsMapNameIdx, pvxERPSSrvcNNIShelfId=pvxERPSSrvcNNIShelfId, pvxEServiceSlaCrntPM2WayDelayVariationMinimumTimeStamp=pvxEServiceSlaCrntPM2WayDelayVariationMinimumTimeStamp, pvxSwitchStackingPrimary=pvxSwitchStackingPrimary, pvxEthSrvcSpanTreeInstance=pvxEthSrvcSpanTreeInstance, pvxLAGPortHistPMMRKRSPPDURXTimeStamp=pvxLAGPortHistPMMRKRSPPDURXTimeStamp, pvxMSTPPortCrntPMBPDUCFGRXTimeStamp=pvxMSTPPortCrntPMBPDUCFGRXTimeStamp, pvxMSTPPortCrntPMBPDUTCNTXInitialize=pvxMSTPPortCrntPMBPDUTCNTXInitialize, PvxEcfmRemoteMepState=PvxEcfmRemoteMepState, pvxERPSPortHistPMMsPduTxValue=pvxERPSPortHistPMMsPduTxValue, pvxBridgeServices=pvxBridgeServices, pvxERPSPortCrntPMFsPduTxValidity=pvxERPSPortCrntPMFsPduTxValidity, pvxERPSPortHistPMEventPduRxValue=pvxERPSPortHistPMEventPduRxValue, pvxEServiceSlaHistPM2WayDelayVariationAverageValidity=pvxEServiceSlaHistPM2WayDelayVariationAverageValidity, pvxLGAdminStatus=pvxLGAdminStatus, pvxMSTPMapVlanS4k=pvxMSTPMapVlanS4k, pvxMSTPPortHistPMBPDUCFGRXValidity=pvxMSTPPortHistPMBPDUCFGRXValidity, PvxStackingPortCommState=PvxStackingPortCommState, pvxERPSPortCrntPMSfPduRxInitialize=pvxERPSPortCrntPMSfPduRxInitialize, pvxESrvcBWPrflPMThresholdLevelTypeIdx=pvxESrvcBWPrflPMThresholdLevelTypeIdx, pvxMSTPPortCrntPMPMCValue=pvxMSTPPortCrntPMPMCValue, pvxERPSPortHistPMPduTxValue=pvxERPSPortHistPMPduTxValue, pvxEthSrvcFrameSize=pvxEthSrvcFrameSize, pvxLAGPortCrntPMLACPDURXValue=pvxLAGPortCrntPMLACPDURXValue, pvxEcfmMepTransmitLbmDestMepId=pvxEcfmMepTransmitLbmDestMepId, pvxESrvcBWPrflPMThresholdEntry=pvxESrvcBWPrflPMThresholdEntry, pvxControlFrameProfileStp=pvxControlFrameProfileStp, pvxUNISwitchId=pvxUNISwitchId, pvxMepListEntry=pvxMepListEntry, pvxESrvcBWPrflCrntPMSlotIdx=pvxESrvcBWPrflCrntPMSlotIdx, pvxERPSPortHistPMPduTxInitialize=pvxERPSPortHistPMPduTxInitialize, pvxERPSSrvcVersionMismatchClear=pvxERPSSrvcVersionMismatchClear, pvxUNIShelfId=pvxUNIShelfId, pvxEcfmMepAutoGenerateFlag=pvxEcfmMepAutoGenerateFlag, pvxLGRowStatus=pvxLGRowStatus, pvxMSTPHistPMTCCInitialize=pvxMSTPHistPMTCCInitialize, pvxMSTPPortCrntPMBPDUTCNTXValidity=pvxMSTPPortCrntPMBPDUTCNTXValidity, pvxESrvcCrntPMUASInitialize=pvxESrvcCrntPMUASInitialize, pvxEcfmMepDbRMepCcmDefect=pvxEcfmMepDbRMepCcmDefect, pvxFloClSourceMacFilter=pvxFloClSourceMacFilter, pvxEServiceSlaCrntPMEntry=pvxEServiceSlaCrntPMEntry, pvxDscpAssuredFwd3y=pvxDscpAssuredFwd3y, pvxLGMinLinks=pvxLGMinLinks, pvxMgmtVLANNetMask=pvxMgmtVLANNetMask, pvxEServiceSlaHistPMNearEndFrameLossInitialize=pvxEServiceSlaHistPMNearEndFrameLossInitialize, mstpRoleChangeEvt=mstpRoleChangeEvt, cfmRMepStateChangeEvt=cfmRMepStateChangeEvt, pvxEcfmMipESrvcName=pvxEcfmMipESrvcName, pvxSLAMsmtInitiatorDBTable=pvxSLAMsmtInitiatorDBTable, pvxEcfmLtrEgressMac=pvxEcfmLtrEgressMac, pvxSrvcUNIUserDefinedMepId=pvxSrvcUNIUserDefinedMepId, pvxERPSPortCrntPMSfPduTxTimeStamp=pvxERPSPortCrntPMSfPduTxTimeStamp, pvxEServiceSlaHistPMPortTypeIdx=pvxEServiceSlaHistPMPortTypeIdx, pvxERPSPortCrntPMNrPduRxInitialize=pvxERPSPortCrntPMNrPduRxInitialize, pvxESrvcBWPrflHistPMOctetsTotalInitialize=pvxESrvcBWPrflHistPMOctetsTotalInitialize, pvxMSTPPortHistPMINVBPDUTCNRXValidity=pvxMSTPPortHistPMINVBPDUTCNRXValidity, pvxStaticUnicastMACAddrIdx=pvxStaticUnicastMACAddrIdx, pvxMSTPPortCrntPMINVBPDUCFGRXTimeStamp=pvxMSTPPortCrntPMINVBPDUCFGRXTimeStamp, pvxEServiceSlaHistPM2WayDelayMaximum=pvxEServiceSlaHistPM2WayDelayMaximum, pvxCPMaxBandwidth=pvxCPMaxBandwidth, pvxEcfmMepFlushRMepDb=pvxEcfmMepFlushRMepDb, pvxERPSPortCrntPMMsPduTxInitialize=pvxERPSPortCrntPMMsPduTxInitialize, pvxERPSServiceNNIEntry=pvxERPSServiceNNIEntry, pvxLAGPortCrntPMMRKPDURXValidity=pvxLAGPortCrntPMMRKPDURXValidity, pvxMSTPPortHistPMINVBPDURXTimeStamp=pvxMSTPPortHistPMINVBPDURXTimeStamp, pvxSwitchClearDynamicFDBEntries=pvxSwitchClearDynamicFDBEntries, pvxERPSPortCrntPMPortIdx=pvxERPSPortCrntPMPortIdx, pvxEServiceSlaCrntPMNearEndFrameLossInitialize=pvxEServiceSlaCrntPMNearEndFrameLossInitialize, pvxLAGPortHistPMMRKPDUTXValue=pvxLAGPortHistPMMRKPDUTXValue, pvxSrvcNNIRowStatus=pvxSrvcNNIRowStatus, pvxLAGPortHistPMTypeIdx=pvxLAGPortHistPMTypeIdx, pvxEServiceSlaCrntPMNearEndFrameLossTimeStamp=pvxEServiceSlaCrntPMNearEndFrameLossTimeStamp, pvxESrvcHistPMIntervalTypeIdx=pvxESrvcHistPMIntervalTypeIdx, pvxControlFrameProfileName=pvxControlFrameProfileName, pvxFloActGreenAction=pvxFloActGreenAction, pvxSLAMsmtThresholdDelayMaximum=pvxSLAMsmtThresholdDelayMaximum, pvxSLAThroughputTestFrameSize1NearEndThroughput=pvxSLAThroughputTestFrameSize1NearEndThroughput, pvxERPSPortCrntPMMsPduTxTimeStamp=pvxERPSPortCrntPMMsPduTxTimeStamp, pvxTunnMacAddrProfileTable=pvxTunnMacAddrProfileTable, pvxEServiceSlaHistPMFarEndFrameLossInitialize=pvxEServiceSlaHistPMFarEndFrameLossInitialize, pvxSchedProfWeightQ3=pvxSchedProfWeightQ3, pvxSLAMsmtResponderDBESName=pvxSLAMsmtResponderDBESName, pvxTMAPGmrpTunnMacAddr=pvxTMAPGmrpTunnMacAddr, pvxMSTPPortCrntPMPMCTimeStamp=pvxMSTPPortCrntPMPMCTimeStamp, pvxESrvcBWPrflCrntPMOctetsCnfExcValidity=pvxESrvcBWPrflCrntPMOctetsCnfExcValidity, pvxMSTPXstEntry=pvxMSTPXstEntry, pvxFMPRowStatus=pvxFMPRowStatus, pvxSrvcUNIEFPSDLocalEFPSDStateChangeEvent=pvxSrvcUNIEFPSDLocalEFPSDStateChangeEvent, pvxEServiceSlaCrntPMSlotIdx=pvxEServiceSlaCrntPMSlotIdx, pvxEServiceSlaHistPMNearEndFrameLossTimeStamp=pvxEServiceSlaHistPMNearEndFrameLossTimeStamp, pvxMSTPPortHistPMPMCValidity=pvxMSTPPortHistPMPMCValidity, pvxMSTPPortCrntPMSlotIdx=pvxMSTPPortCrntPMSlotIdx, pvxMSTPMapTable=pvxMSTPMapTable, pvxMSTPXstPortSlotIdx=pvxMSTPXstPortSlotIdx, pvxMSTPXstRootPortSwitch=pvxMSTPXstRootPortSwitch, pvxEcfmMipSlotId=pvxEcfmMipSlotId, pvxESrvcBWPrflPMThresholdShelfIdx=pvxESrvcBWPrflPMThresholdShelfIdx, pvxUNISlotId=pvxUNISlotId, pvxVlanCurrentEntry=pvxVlanCurrentEntry, pvxLAGPortHistPMLACPDUTXTimeStamp=pvxLAGPortHistPMLACPDUTXTimeStamp, pvxPCVRTSource=pvxPCVRTSource, pvxEthSrvcPointedness=pvxEthSrvcPointedness, pvxERPSSrvcRingNodeStatus=pvxERPSSrvcRingNodeStatus, pvxClassMapType=pvxClassMapType, pvxPCPEncPriority6=pvxPCPEncPriority6, pvxERPSPortHistPMRecoveriesValidity=pvxERPSPortHistPMRecoveriesValidity, pvxSchedProfMinBwQ4=pvxSchedProfMinBwQ4, pvxMSTPHistPMNRBCValue=pvxMSTPHistPMNRBCValue, pvxERPSPortCrntPMFsPduRxTimeStamp=pvxERPSPortCrntPMFsPduRxTimeStamp, pvxEcfmMepDbRMepState=pvxEcfmMepDbRMepState, pvxSrvcNNIEgressBWperCos=pvxSrvcNNIEgressBWperCos, pvxEcfmMepPortId=pvxEcfmMepPortId, pvxESrvcBWPrflCrntPMOctetsTotalTimeStamp=pvxESrvcBWPrflCrntPMOctetsTotalTimeStamp, pvxMSTPCrntPMNRBCValidity=pvxMSTPCrntPMNRBCValidity, pvxDscpAssuredFwd2y=pvxDscpAssuredFwd2y, pvxMSTPPortHistPMSwitchIdx=pvxMSTPPortHistPMSwitchIdx, pvxMSTPPortHistPMINVBPDUCFGRXInitialize=pvxMSTPPortHistPMINVBPDUCFGRXInitialize, pvxLagPortSwitchIdx=pvxLagPortSwitchIdx, pvxCPMinBandwidth=pvxCPMinBandwidth, pvxLAGPortCrntPMLACPDUTXValidity=pvxLAGPortCrntPMLACPDUTXValidity, pvxEcfmMepActive=pvxEcfmMepActive, pvxLAGPortCrntPMLACPDUTXTimeStamp=pvxLAGPortCrntPMLACPDUTXTimeStamp, pvxESrvcBWPrflPMThresholdTable=pvxESrvcBWPrflPMThresholdTable, pvxESrvcHistPMESrvcNameIdx=pvxESrvcHistPMESrvcNameIdx, pvxLAGPortCrntPMSlotIdx=pvxLAGPortCrntPMSlotIdx, pvxERPSSrvcNNISwitchId=pvxERPSSrvcNNISwitchId, pvxERPSPortHistPMSfPduTxTimeStamp=pvxERPSPortHistPMSfPduTxTimeStamp, pvxSchedProfMinBwQ0=pvxSchedProfMinBwQ0, pvxEServiceSlaCrntPM2WayDelayAverageValidity=pvxEServiceSlaCrntPM2WayDelayAverageValidity, pvxEcfmMipEntry=pvxEcfmMipEntry, pvxEcfmMipPortTypeId=pvxEcfmMipPortTypeId, pvxEServiceSlaHistPM2WayDelayVariationMinimumValidity=pvxEServiceSlaHistPM2WayDelayVariationMinimumValidity, pvxVlanPortEntry=pvxVlanPortEntry, pvxLGIdx=pvxLGIdx, pvxERPSPortHistPMBlockedValue=pvxERPSPortHistPMBlockedValue, pvxERPSPortHistPMBlockedValidity=pvxERPSPortHistPMBlockedValidity, pvxMepListRowStatus=pvxMepListRowStatus, pvxEcfmMipActiveState=pvxEcfmMipActiveState, pvxLAGPortCrntPMShelfIdx=pvxLAGPortCrntPMShelfIdx, pvxFDBVlanIdx=pvxFDBVlanIdx, pvxLAGPortCrntPMLACPDURXTimeStamp=pvxLAGPortCrntPMLACPDURXTimeStamp, switchMemberStkPortDownClear=switchMemberStkPortDownClear, pvxEServiceSlaCrntPM2WayDelayVariationMinimumValidity=pvxEServiceSlaCrntPM2WayDelayVariationMinimumValidity, pvxMSTPCrntPMTCCValue=pvxMSTPCrntPMTCCValue, pvxMSTPHistPMNRBCTimeStamp=pvxMSTPHistPMNRBCTimeStamp, pvxMSTPPortHistPMSlotIdx=pvxMSTPPortHistPMSlotIdx, pvxFloClEntryType=pvxFloClEntryType, pvxERPSPortCrntPMEventPduTxValue=pvxERPSPortCrntPMEventPduTxValue, pvxSLAThroughputTestFrameSize4FarEndThroughput=pvxSLAThroughputTestFrameSize4FarEndThroughput, pvxMSTPPortHistPMBPDUCFGTXValue=pvxMSTPPortHistPMBPDUCFGTXValue, pvxSwitchName=pvxSwitchName, pvxERPSSrvcVirtualLink=pvxERPSSrvcVirtualLink, pvxMSTPCrntPMNRBCTimeStamp=pvxMSTPCrntPMNRBCTimeStamp, pvxVlanPortLastBpduOriginChangeEvtNotifications=pvxVlanPortLastBpduOriginChangeEvtNotifications, pvxERPSPortCrntPMNrPduTxTimeStamp=pvxERPSPortCrntPMNrPduTxTimeStamp, pvxVlanPortSwitchIdx=pvxVlanPortSwitchIdx, pvxSwitchEntry=pvxSwitchEntry, pvxERPSPortHistPMPduDiscardInitialize=pvxERPSPortHistPMPduDiscardInitialize, pvxMepListESrvcVlanId=pvxMepListESrvcVlanId, pvxFloClDestIPFilter=pvxFloClDestIPFilter, pvxLGDistribution=pvxLGDistribution, pvxMSTPPortCrntPMINVBPDUCFGRXValidity=pvxMSTPPortCrntPMINVBPDUCFGRXValidity, pvxUNITable=pvxUNITable, pvxLAGPortHistPMMRKPDURXValidity=pvxLAGPortHistPMMRKPDURXValidity, pvxSLAThroughputTestRMepId=pvxSLAThroughputTestRMepId, pvxEcfmMepCcmSequenceErr=pvxEcfmMepCcmSequenceErr, pvxBWCnfrmActionChangeDscp=pvxBWCnfrmActionChangeDscp, pvxERPSPortHistPMVersionDiscardValidity=pvxERPSPortHistPMVersionDiscardValidity, pvxLAGPortCrntPMINVLACFRRXInitialize=pvxLAGPortCrntPMINVLACFRRXInitialize, lagLinkDownClear=lagLinkDownClear, pvxPriority0TrafficClass=pvxPriority0TrafficClass, pvxERPSPortHistPMSwitchIdx=pvxERPSPortHistPMSwitchIdx, pvxY1731LbStatsEntry=pvxY1731LbStatsEntry, pvxMSTPPortIdx=pvxMSTPPortIdx, pvxSLAMsmtProfileName=pvxSLAMsmtProfileName, pvxSLAMsmtRowStatus=pvxSLAMsmtRowStatus, pvxERPSPortHistPMPduDiscardValidity=pvxERPSPortHistPMPduDiscardValidity, pvxPCPEncPriority0=pvxPCPEncPriority0, pvxStaticMCStaticIntfIdList=pvxStaticMCStaticIntfIdList, pvxSvidXlatePortTypeId=pvxSvidXlatePortTypeId, pvxERPSPortCrntPMPduRxInitialize=pvxERPSPortCrntPMPduRxInitialize, pvxFlowMeterProfileEntry=pvxFlowMeterProfileEntry, pvxMSTPPortHistPMXstIdx=pvxMSTPPortHistPMXstIdx, pvxERPSPortHistPMIntervalTypeIdx=pvxERPSPortHistPMIntervalTypeIdx, pvxPriority6TrafficClass=pvxPriority6TrafficClass, pvxMSTPXstBrdgPriority=pvxMSTPXstBrdgPriority, pvxTMAPName=pvxTMAPName, pvxSchedProfWeightQ1=pvxSchedProfWeightQ1, pvxESrvcBWPrflHistPMOctetsVltTimeStamp=pvxESrvcBWPrflHistPMOctetsVltTimeStamp, pvxSchedulerProfileEntry=pvxSchedulerProfileEntry, pvxMSTPHistPMRCCCInitialize=pvxMSTPHistPMRCCCInitialize, PvxMSTPVlanList=PvxMSTPVlanList, pvxESrvcBWPrflHistPMSlotIdx=pvxESrvcBWPrflHistPMSlotIdx, pvxLagPortRowStatus=pvxLagPortRowStatus, pvxMSTPPortEntry=pvxMSTPPortEntry, pvxLAGPortHistPMLACPDUTXValue=pvxLAGPortHistPMLACPDUTXValue, pvxPriority5TrafficClass=pvxPriority5TrafficClass, PvxPCPDecodingList=PvxPCPDecodingList, pvxEcfmLtrIngressPortInfo=pvxEcfmLtrIngressPortInfo, pvxDscpPHBProfileName=pvxDscpPHBProfileName, pvxERPSPortHistPMFsPduTxValidity=pvxERPSPortHistPMFsPduTxValidity, pvxUNIRowStatus=pvxUNIRowStatus, pvxPCPEncPriority1=pvxPCPEncPriority1, pvxMSTPXstPortForcedPortState=pvxMSTPXstPortForcedPortState, pvxMSTPPortCrntPMBPDUTCNTXValue=pvxMSTPPortCrntPMBPDUTCNTXValue, pvxEcfmMepTransmitLtmResultOK=pvxEcfmMepTransmitLtmResultOK, pvxMSTPPortCrntPMBPDUCFGTXTimeStamp=pvxMSTPPortCrntPMBPDUCFGTXTimeStamp, pvxERPSPortCrntPMPduTxValue=pvxERPSPortCrntPMPduTxValue)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxServiceNNITable=pvxServiceNNITable, pvxERPSPortCrntPMSfPduRxValidity=pvxERPSPortCrntPMSfPduRxValidity, pvxERPSPortHistPMSfPduTxInitialize=pvxERPSPortHistPMSfPduTxInitialize, PvxCVidMapOperStatus=PvxCVidMapOperStatus, pvxLAGPortCrntPMMRKRSPPDURXTimeStamp=pvxLAGPortCrntPMMRKRSPPDURXTimeStamp, pvxClassMapProfileTable=pvxClassMapProfileTable, pvxSwitchForceSwitch=pvxSwitchForceSwitch, pvxLGActivePortCount=pvxLGActivePortCount, pvxMSTPPortHistPMBPDURXValue=pvxMSTPPortHistPMBPDURXValue, pvxMSTPXstPortDesigPortId=pvxMSTPXstPortDesigPortId, pvxSLAThroughputTestClassMapName=pvxSLAThroughputTestClassMapName, pvxSLAMsmtResponderDBSwitchIdx=pvxSLAMsmtResponderDBSwitchIdx, pvxESrvcHistPMEntry=pvxESrvcHistPMEntry, packetVxBridgeMib=packetVxBridgeMib, pvxBridgeProfiles=pvxBridgeProfiles, pvxERPSPortHistPMFsPduTxInitialize=pvxERPSPortHistPMFsPduTxInitialize, pvxSchedProfMaxBwQ0=pvxSchedProfMaxBwQ0, pvxStackingPortOperStatus=pvxStackingPortOperStatus, pvxSchedProfWeightQ4=pvxSchedProfWeightQ4, pvxFloClDestUDPorTCPFilter=pvxFloClDestUDPorTCPFilter, pvxLAGPortCrntPMMRKPDURXTimeStamp=pvxLAGPortCrntPMMRKPDURXTimeStamp, pvxEcfmMepTransmitLbmStatus=pvxEcfmMepTransmitLbmStatus, pvxCPQueueAlgo=pvxCPQueueAlgo, pvxMSTPXstPortShelfIdx=pvxMSTPXstPortShelfIdx, pvxClassMapL4SrcPortFilter=pvxClassMapL4SrcPortFilter, pvxERPSPortHistPMPduDiscardValue=pvxERPSPortHistPMPduDiscardValue, pvxSrvcNNISwitchId=pvxSrvcNNISwitchId, pvxEServiceSlaHistPM2WayDelayVariationAverage=pvxEServiceSlaHistPM2WayDelayVariationAverage, pvxERPSSrvcNNIECFMInfo=pvxERPSSrvcNNIECFMInfo, PvxEcfmEgressActionFieldValue=PvxEcfmEgressActionFieldValue, pvxEthSrvcSVLAN=pvxEthSrvcSVLAN, pvxEthSrvcLockNNIs=pvxEthSrvcLockNNIs, pvxERPSPortCrntPMEventPduTxInitialize=pvxERPSPortCrntPMEventPduTxInitialize, pvxERPSPortCrntPMNrPduTxInitialize=pvxERPSPortCrntPMNrPduTxInitialize, cfmRMepStateChangeEvtNotifications=cfmRMepStateChangeEvtNotifications, pvxMSTPPortHistPMBPDUCFGRXInitialize=pvxMSTPPortHistPMBPDUCFGRXInitialize, pvxLAGPortCrntPMLACPDURXValidity=pvxLAGPortCrntPMLACPDURXValidity, pvxSvidXlateSlotId=pvxSvidXlateSlotId, pvxERPSPortCrntPMUnblockedValue=pvxERPSPortCrntPMUnblockedValue, pvxEcfmMepShelfId=pvxEcfmMepShelfId, pvxESrvcBWPrflPMThresholdPortTypeIdx=pvxESrvcBWPrflPMThresholdPortTypeIdx, pvxFDBTable=pvxFDBTable, pvxSLAThroughputTestFrameSize2FarEndThroughput=pvxSLAThroughputTestFrameSize2FarEndThroughput, pvxERPSPortHistPMMsPduRxValue=pvxERPSPortHistPMMsPduRxValue, PvxY1731MepDefects=PvxY1731MepDefects, pvxFloActRedCNGAction=pvxFloActRedCNGAction, pvxSLAMsmtInitiatorDBESName=pvxSLAMsmtInitiatorDBESName, pvxSwitchLearning=pvxSwitchLearning, pvxPolicyMapProfileRowStatus=pvxPolicyMapProfileRowStatus, pvxFlowMeterEntry=pvxFlowMeterEntry, pvxFlowClassificationEntry=pvxFlowClassificationEntry, pvxESrvcBWPrflHistPMPortTypeIdx=pvxESrvcBWPrflHistPMPortTypeIdx, pvxSrvcNNIPortTypeId=pvxSrvcNNIPortTypeId, pvxFDBPort=pvxFDBPort, pvxMSTPPortHistPMBPDUTCNTXTimeStamp=pvxMSTPPortHistPMBPDUTCNTXTimeStamp, pvxESrvcCrntPMSwitchIdx=pvxESrvcCrntPMSwitchIdx, pvxEcfmMepDirection=pvxEcfmMepDirection, pvxMSTPXstPortSwitchIdx=pvxMSTPXstPortSwitchIdx, pvxSrvcUNISlaMeasurementProfile=pvxSrvcUNISlaMeasurementProfile, pvxEcfmLtrEgressAction=pvxEcfmLtrEgressAction, pvxEServiceSlaCrntPMIntervalTypeIdx=pvxEServiceSlaCrntPMIntervalTypeIdx, pvxERPSSrvcNNISlotId=pvxERPSSrvcNNISlotId, pvxERPSPortCrntPMFsPduTxValue=pvxERPSPortCrntPMFsPduTxValue, pvxVLANTable=pvxVLANTable, pvxMepListIdentifier=pvxMepListIdentifier, pvxSLAThroughputTestCirRateTestResult=pvxSLAThroughputTestCirRateTestResult, pvxERPSPortCrntPMUnblockedValidity=pvxERPSPortCrntPMUnblockedValidity, pvxEServiceSlaCrntPM2WayDelayMinimumValidity=pvxEServiceSlaCrntPM2WayDelayMinimumValidity, pvxVlanCurrentVlanIdx=pvxVlanCurrentVlanIdx, resourceUnavailableClear=resourceUnavailableClear, pvxStaticUnicastVlanIdx=pvxStaticUnicastVlanIdx, pvxEcfmMepLbrIn=pvxEcfmMepLbrIn, pvxMSTPPortCrntPMBPDUCFGRXInitialize=pvxMSTPPortCrntPMBPDUCFGRXInitialize, pvxESrvcCrntPMIntervalTypeIdx=pvxESrvcCrntPMIntervalTypeIdx, pvxMSTPPortSlotIdx=pvxMSTPPortSlotIdx, pvxSwitchMode=pvxSwitchMode, pvxStaticUnicastIntfIdList=pvxStaticUnicastIntfIdList, pvxEthSrvcMECciInterval=pvxEthSrvcMECciInterval, pvxERPSPortCrntPMFailuresValidity=pvxERPSPortCrntPMFailuresValidity, pvxERPSSrvcRingMonitoring=pvxERPSSrvcRingMonitoring, pvxERPSPortHistPMSfPduRxValidity=pvxERPSPortHistPMSfPduRxValidity, pvxESrvcBWPrflHistPMPlcyNameIdx=pvxESrvcBWPrflHistPMPlcyNameIdx, pvxEServiceSlaCrntPMShelfIdx=pvxEServiceSlaCrntPMShelfIdx, pvxLGMacAddress=pvxLGMacAddress, pvxESrvcBWPrflPMThresholdPlcyNameIdx=pvxESrvcBWPrflPMThresholdPlcyNameIdx, pvxSLAThroughputTestResponderOpState=pvxSLAThroughputTestResponderOpState, pvxPCPDecPriority0=pvxPCPDecPriority0, pvxERPSPortHistPMFailuresValidity=pvxERPSPortHistPMFailuresValidity, pvxERPSPortCrntPMPduRxTimeStamp=pvxERPSPortCrntPMPduRxTimeStamp, pvxEcfmMepTransmitLtmTtl=pvxEcfmMepTransmitLtmTtl, pvxSLAThroughputTestSlotIdx=pvxSLAThroughputTestSlotIdx, pvxEcfmMipESrvcVlanId=pvxEcfmMipESrvcVlanId, pvxEServiceSlaCrntPM2WayDelayVariationMaximumTimeStamp=pvxEServiceSlaCrntPM2WayDelayVariationMaximumTimeStamp, pvxMSTPPortCrntPMINVBPDURXValidity=pvxMSTPPortCrntPMINVBPDURXValidity, pvxERPSSrvcSubRingWithoutVC=pvxERPSSrvcSubRingWithoutVC, pvxSchedProfMaxBwQ4=pvxSchedProfMaxBwQ4, pvxEthSrvcOperState=pvxEthSrvcOperState, pvxERPSPortCrntPMSwitchIdx=pvxERPSPortCrntPMSwitchIdx, pvxERPSPortHistPMPduRxTimeStamp=pvxERPSPortHistPMPduRxTimeStamp, pvxNNISpeed=pvxNNISpeed, pvxEServiceSlaCrntPM2WayDelayVariationAverageTimeStamp=pvxEServiceSlaCrntPM2WayDelayVariationAverageTimeStamp, pvxLagPortTimeout=pvxLagPortTimeout, pvxSLAMsmtInitiatorDBSwitchIdx=pvxSLAMsmtInitiatorDBSwitchIdx, pvxPCPEncPriority2=pvxPCPEncPriority2, pvxSwitchEvcMEGName=pvxSwitchEvcMEGName, pvxSLAMsmtThresholdNearEndLossRatio=pvxSLAMsmtThresholdNearEndLossRatio, pvxMSTPPortHistPMBPDUTCNRXInitialize=pvxMSTPPortHistPMBPDUTCNRXInitialize, pvxUNICPVid=pvxUNICPVid, pvxFSwitchIdx=pvxFSwitchIdx, pvxESrvcBWPrflHistPMOctetsVltValidity=pvxESrvcBWPrflHistPMOctetsVltValidity, pvxVlanPortGvrpFailedRegistrations=pvxVlanPortGvrpFailedRegistrations, pvxClassMapProfileName=pvxClassMapProfileName, pvxSwitchIntfBouncingTimerPeriod=pvxSwitchIntfBouncingTimerPeriod, pvxMSTPPortHistPMINVBPDUTCNRXTimeStamp=pvxMSTPPortHistPMINVBPDUTCNRXTimeStamp, pvxSwitchAgingTimer=pvxSwitchAgingTimer, pvxPCPDecPriority5=pvxPCPDecPriority5, pvxSchedProfWeightQ0=pvxSchedProfWeightQ0, pvxMSTPXstSwitchIdx=pvxMSTPXstSwitchIdx, pvxLagEntry=pvxLagEntry, pvxSrvcUNISwitchId=pvxSrvcUNISwitchId, pvxEServiceSlaHistPMPortIdx=pvxEServiceSlaHistPMPortIdx, pvxFloActCVlanValue=pvxFloActCVlanValue, pvxMSTPXstPortPriority=pvxMSTPXstPortPriority, pvxClassMapMatchType=pvxClassMapMatchType, pvxSchedProfMinBwQ2=pvxSchedProfMinBwQ2, pvxSLAMsmtResponderDBPortTypeIdx=pvxSLAMsmtResponderDBPortTypeIdx, pvxPCPEncDecProfileName=pvxPCPEncDecProfileName, pvxESrvcBWPrflPMThresholdSlotIdx=pvxESrvcBWPrflPMThresholdSlotIdx, pvxSLAThroughputTestPortIdx=pvxSLAThroughputTestPortIdx, pvxMSTPPortCrntPMBPDUCFGRXValue=pvxMSTPPortCrntPMBPDUCFGRXValue, pvxERPSPortCrntPMEntry=pvxERPSPortCrntPMEntry, pvxERPSPortCrntPMNrrbPduTxInitialize=pvxERPSPortCrntPMNrrbPduTxInitialize, pvxDscpExpeditedFwd=pvxDscpExpeditedFwd, pvxFDBSwitchIdx=pvxFDBSwitchIdx, pvxERPSSrvcMultipleFailure=pvxERPSSrvcMultipleFailure, pvxEcfmMepTable=pvxEcfmMepTable, pvxDscpClassSelector7=pvxDscpClassSelector7, pvxERPSPortCrntPMTypeIdx=pvxERPSPortCrntPMTypeIdx, pvxFloClIPProtocolFilter=pvxFloClIPProtocolFilter, pvxMSTPPortCrntPMINVBPDUTCNRXTimeStamp=pvxMSTPPortCrntPMINVBPDUTCNRXTimeStamp, pvxFloActSwitchIdx=pvxFloActSwitchIdx, pvxLAGPortHistPMMRKRSPPDUTXInitialize=pvxLAGPortHistPMMRKRSPPDUTXInitialize, pvxERPSPortCrntPMFsPduRxInitialize=pvxERPSPortCrntPMFsPduRxInitialize, pvxPCPEncPriority5=pvxPCPEncPriority5, pvxEcfmLtrTerminalMep=pvxEcfmLtrTerminalMep, pvxEServiceSlaHistPMNearEndFrameLossValidity=pvxEServiceSlaHistPMNearEndFrameLossValidity, pvxMSTPPortRegRoot=pvxMSTPPortRegRoot, pvxBWProfileEntry=pvxBWProfileEntry, pvxEServiceSlaHistPMSlotIdx=pvxEServiceSlaHistPMSlotIdx, pvxPriorityTCMapTable=pvxPriorityTCMapTable, pvxERPSPortHistPMTypeIdx=pvxERPSPortHistPMTypeIdx, pvxMSTPPortHistPMBPDUCFGRXValue=pvxMSTPPortHistPMBPDUCFGRXValue, pvxY1731LbStatsESrvcName=pvxY1731LbStatsESrvcName, pvxERPSPortHistPMFailuresValue=pvxERPSPortHistPMFailuresValue, pvxERPSPortCrntPMPduTxValidity=pvxERPSPortCrntPMPduTxValidity, pvxMSTPPortHistPMINVBPDUCFGRXValue=pvxMSTPPortHistPMINVBPDUCFGRXValue, pvxFloActRedAction=pvxFloActRedAction, pvxLagPortTypeIdx=pvxLagPortTypeIdx, pvxERPSPortHistPMNrrbPduRxValue=pvxERPSPortHistPMNrrbPduRxValue, pvxERPSPortHistPMFsPduRxValue=pvxERPSPortHistPMFsPduRxValue, pvxNextFreeIndexTableIndex=pvxNextFreeIndexTableIndex, pvxPCPDecPriority7=pvxPCPDecPriority7, pvxSwitchRowStatus=pvxSwitchRowStatus, cfmRMepStateChangeV2Evt=cfmRMepStateChangeV2Evt, pvxDscpPHBProfileTable=pvxDscpPHBProfileTable, pvxSwitchMemberRowStatus=pvxSwitchMemberRowStatus, pvxEServiceSlaHistPMESName=pvxEServiceSlaHistPMESName, pvxERPSSrvcTimerStartEvent=pvxERPSSrvcTimerStartEvent, pvxERPSPortCrntPMBlockedTimeStamp=pvxERPSPortCrntPMBlockedTimeStamp, pvxERPSPortCrntPMRecoveriesInitialize=pvxERPSPortCrntPMRecoveriesInitialize, pvxNextFreeIndexTable=pvxNextFreeIndexTable, pvxERPSPortHistPMNrrbPduRxInitialize=pvxERPSPortHistPMNrrbPduRxInitialize, pvxSwitchProtocolAdminState=pvxSwitchProtocolAdminState, pvxERPSPortHistPMSlotIdx=pvxERPSPortHistPMSlotIdx, pvxLGPortCount=pvxLGPortCount, pvxSLAMsmtInitiatorDBPortIdx=pvxSLAMsmtInitiatorDBPortIdx, pvxERPSPortCrntPMFsPduTxInitialize=pvxERPSPortCrntPMFsPduTxInitialize, pvxMSTPPortHistPMBPDUCFGRXTimeStamp=pvxMSTPPortHistPMBPDUCFGRXTimeStamp, pvxVlanCurrentTable=pvxVlanCurrentTable, PvxPhyPort=PvxPhyPort, pvxEcfmMepDbRMepIntfStatusDefect=pvxEcfmMepDbRMepIntfStatusDefect, pvxVLANMemberPortList=pvxVLANMemberPortList, pvxEcfmLtrForwarded=pvxEcfmLtrForwarded, pvxMSTPXstIdx=pvxMSTPXstIdx, pvxLagState=pvxLagState, pvxESrvcBWPrflCrntPMEntry=pvxESrvcBWPrflCrntPMEntry, pvxMSTPPortCrntPMBPDUCFGTXValidity=pvxMSTPPortCrntPMBPDUCFGTXValidity, pvxERPSPortCrntPMVersionDiscardValidity=pvxERPSPortCrntPMVersionDiscardValidity, pvxEcfmMepSentCcms=pvxEcfmMepSentCcms, mstpRegionConfigChangeEvt=mstpRegionConfigChangeEvt, pvxMSTPPortRestrictedTCN=pvxMSTPPortRestrictedTCN, pvxERPSPortCrntPMPduRxValidity=pvxERPSPortCrntPMPduRxValidity, pvxStaticMCVlanIdx=pvxStaticMCVlanIdx, pvxESrvcBWPrflHistPMOctetsCnfExcValidity=pvxESrvcBWPrflHistPMOctetsCnfExcValidity, pvxSwitchMemberStackingPortCommState=pvxSwitchMemberStackingPortCommState, pvxFMPMeterType=pvxFMPMeterType, pvxLAGPortHistPMMRKPDURXValue=pvxLAGPortHistPMMRKPDURXValue, pvxMSTPPortCrntPMFWDTRTimeStamp=pvxMSTPPortCrntPMFWDTRTimeStamp, pvxESrvcOperStateChangeEvt=pvxESrvcOperStateChangeEvt, pvxLagGroupTable=pvxLagGroupTable, pvxMSTPMapVlanS1k=pvxMSTPMapVlanS1k, pvxBandwidthProfileName=pvxBandwidthProfileName, pvxEthSrvcMECciEnable=pvxEthSrvcMECciEnable, pvxESrvcBWPrflPMThresholdBDWUtlzValue=pvxESrvcBWPrflPMThresholdBDWUtlzValue, pvxESrvcBWPrflHistPMOctetsTotalValidity=pvxESrvcBWPrflHistPMOctetsTotalValidity, pvxBWSetInternalPriority=pvxBWSetInternalPriority, pvxESrvcBWPrflCrntPMOctetsTotalValidity=pvxESrvcBWPrflCrntPMOctetsTotalValidity, pvxSrvcNNIIngressBW=pvxSrvcNNIIngressBW, pvxMgmtVLANRowStatus=pvxMgmtVLANRowStatus, pvxMSTPPortCrntPMBPDUTCNTXTimeStamp=pvxMSTPPortCrntPMBPDUTCNTXTimeStamp, pvxMSTPPortCrntPMINVBPDURXTimeStamp=pvxMSTPPortCrntPMINVBPDURXTimeStamp, pvxMSTPCrntPMRCCCInitialize=pvxMSTPCrntPMRCCCInitialize, pvxStaticUnicastTable=pvxStaticUnicastTable, pvxBandwidthProfileEntry=pvxBandwidthProfileEntry, pvxSLAThroughputTestSwitchIdx=pvxSLAThroughputTestSwitchIdx, pvxMSTPXstTable=pvxMSTPXstTable, pvxEServiceSlaHistPMFarEndFrameLoss=pvxEServiceSlaHistPMFarEndFrameLoss, PvxEcfmTransmitStatus=PvxEcfmTransmitStatus, pvxEcfmMepDbLocalMepId=pvxEcfmMepDbLocalMepId, pvxPCPEncPriority2DE=pvxPCPEncPriority2DE, PvxL2Port=PvxL2Port, pvxLAGPortHistPMTable=pvxLAGPortHistPMTable, pvxMSTPXstRootPort=pvxMSTPXstRootPort, pvxMSTPPortCrntPMTable=pvxMSTPPortCrntPMTable, pvxBWExceedActionSetDEI=pvxBWExceedActionSetDEI, pvxERPSSrvcNNIPortId=pvxERPSSrvcNNIPortId, pvxEcfmLtrEgressPortInfo=pvxEcfmLtrEgressPortInfo, pvxESrvcHistPMUASInitialize=pvxESrvcHistPMUASInitialize, pvxSwitchEvcMEGLevel=pvxSwitchEvcMEGLevel, pvxEServiceSlaCrntPM2WayDelayAverage=pvxEServiceSlaCrntPM2WayDelayAverage, pvxERPSPortCrntPMTable=pvxERPSPortCrntPMTable, pvxERPSPortHistPMNrrbPduTxTimeStamp=pvxERPSPortHistPMNrrbPduTxTimeStamp, pvxDscpAssuredFwd4y=pvxDscpAssuredFwd4y, pvxSwitchStackingTimeAsPrimary=pvxSwitchStackingTimeAsPrimary, pvxSchedProfMinBwQ6=pvxSchedProfMinBwQ6, pvxCtrlFrmProfileTable=pvxCtrlFrmProfileTable, pvxMSTPPortHistPMBPDUTCNTXValidity=pvxMSTPPortHistPMBPDUTCNTXValidity, pvxEServiceSlaHistPM2WayDelayMinimum=pvxEServiceSlaHistPM2WayDelayMinimum, pvxLAGPortHistPMLACPDURXValidity=pvxLAGPortHistPMLACPDURXValidity, pvxServiceUNITable=pvxServiceUNITable, pvxBWMeterColorAware=pvxBWMeterColorAware, pvxERPSPortHistPMMsPduTxValidity=pvxERPSPortHistPMMsPduTxValidity, pvxESrvcBWPrflPMThresholdESrvcNameIdx=pvxESrvcBWPrflPMThresholdESrvcNameIdx, pvxSwitchTimeToAge=pvxSwitchTimeToAge, pvxEServiceSlaHistPM2WayDelayVariationMinimumTimeStamp=pvxEServiceSlaHistPM2WayDelayVariationMinimumTimeStamp, mstpProtocolGeneralEvt=mstpProtocolGeneralEvt, pvxMSTPPortHistPMBPDURXInitialize=pvxMSTPPortHistPMBPDURXInitialize, pvxBWPCbs=pvxBWPCbs, pvxEServiceSlaHistPMIntervalIdx=pvxEServiceSlaHistPMIntervalIdx, pvxERPSPortCrntPMNrPduRxTimeStamp=pvxERPSPortCrntPMNrPduRxTimeStamp, pvxEcfmMepY1731DefectConditions=pvxEcfmMepY1731DefectConditions, pvxESrvcHistPMUASValidity=pvxESrvcHistPMUASValidity, pvxSvidXlateTable=pvxSvidXlateTable, pvxVlanPortShelfIdx=pvxVlanPortShelfIdx)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxLAGPortCrntPMMRKRSPPDURXInitialize=pvxLAGPortCrntPMMRKRSPPDURXInitialize, pvxFSFlowId=pvxFSFlowId, pvxERPSSrvcPropagateTC=pvxERPSSrvcPropagateTC, pvxSchedProfMinBwQ3=pvxSchedProfMinBwQ3, pvxPCPDecPriority2=pvxPCPDecPriority2, pvxTMAPLacpTunnMacAddr=pvxTMAPLacpTunnMacAddr, pvxTMAPLldpTunnMacAddr=pvxTMAPLldpTunnMacAddr, pvxBWPEbs=pvxBWPEbs, pvxMSTPCrntPMTable=pvxMSTPCrntPMTable, pvxClassMapEtherTypeFilter=pvxClassMapEtherTypeFilter, pvxERPSPortCrntPMEventPduTxTimeStamp=pvxERPSPortCrntPMEventPduTxTimeStamp, pvxMSTPPortHistPMShelfIdx=pvxMSTPPortHistPMShelfIdx, pvxEServiceSlaCrntPM2WayDelayAverageTimeStamp=pvxEServiceSlaCrntPM2WayDelayAverageTimeStamp, pvxLAGPortCrntPMMRKRSPPDURXValue=pvxLAGPortCrntPMMRKRSPPDURXValue, pvxMgmtVLANAddressType=pvxMgmtVLANAddressType, pvxMSTPPortCrntPMINVBPDUTCNRXValue=pvxMSTPPortCrntPMINVBPDUTCNRXValue, lagLinkDownCond=lagLinkDownCond, pvxLGMtuSize=pvxLGMtuSize, pvxEServiceSlaHistPM2WayDelayMaximumTimeStamp=pvxEServiceSlaHistPM2WayDelayMaximumTimeStamp, pvxESrvcBWPrflCrntPMOctetsTotalInitialize=pvxESrvcBWPrflCrntPMOctetsTotalInitialize, pvxLAGPortCrntPMTypeIdx=pvxLAGPortCrntPMTypeIdx, pvxEcfmLtrMepIdentifier=pvxEcfmLtrMepIdentifier, pvxSchedProfMinBwQ7=pvxSchedProfMinBwQ7, pvxMSTPPortHistPMFWDTRValue=pvxMSTPPortHistPMFWDTRValue, pvxESrvcCrntPMUASValidity=pvxESrvcCrntPMUASValidity, pvxVlanPortTypeIdx=pvxVlanPortTypeIdx, pvxPCVRTXlateOperStatus=pvxPCVRTXlateOperStatus, pvxMCIntfIdList=pvxMCIntfIdList, pvxESrvcBWPrflHistPMOctetsVltInitialize=pvxESrvcBWPrflHistPMOctetsVltInitialize, pvxSrvcUNIServiceMap=pvxSrvcUNIServiceMap, pvxMSTPCrntPMNRBCInitialize=pvxMSTPCrntPMNRBCInitialize, pvxNNIPortId=pvxNNIPortId, pvxSLAMeasurementProfileTable=pvxSLAMeasurementProfileTable, pvxEServiceSlaHistPMNearEndFrameLoss=pvxEServiceSlaHistPMNearEndFrameLoss, pvxERPSPortHistPMSfPduRxInitialize=pvxERPSPortHistPMSfPduRxInitialize, pvxEServiceSlaHistPMFarEndFrameLossValidity=pvxEServiceSlaHistPMFarEndFrameLossValidity, pvxLAGPortCrntPMTable=pvxLAGPortCrntPMTable, pvxControlFrameProfileRowStatus=pvxControlFrameProfileRowStatus, pvxCPIdx=pvxCPIdx, pvxSchedProfWeightQ7=pvxSchedProfWeightQ7, pvxERPSSrvcSwitchIdx=pvxERPSSrvcSwitchIdx, mstpProtocolMigrationEvt=mstpProtocolMigrationEvt, pvxEServiceSlaCrntPM2WayDelayVariationMaximum=pvxEServiceSlaCrntPM2WayDelayVariationMaximum, pvxMSTPPortCrntPMShelfIdx=pvxMSTPPortCrntPMShelfIdx, pvxStaticMCRowStatus=pvxStaticMCRowStatus, pvxFSSwitchIdx=pvxFSSwitchIdx, pvxClassMapTcpControlFilter=pvxClassMapTcpControlFilter, pvxSchedProfMinBwQ5=pvxSchedProfMinBwQ5, pvxESrvcBWPrflHistPMClsMapNameIdx=pvxESrvcBWPrflHistPMClsMapNameIdx, pvxMSTPPortDesignatedRoot=pvxMSTPPortDesignatedRoot, pvxEcfmMepDbRMepPortStatusDefect=pvxEcfmMepDbRMepPortStatusDefect, PvxQoSColorMode=PvxQoSColorMode, pvxFloClActionId=pvxFloClActionId, pvxERPSPortCrntPMSfPduTxValue=pvxERPSPortCrntPMSfPduTxValue, pvxERPSPortHistPMBlockedTimeStamp=pvxERPSPortHistPMBlockedTimeStamp, pvxLagPortWaitTime=pvxLagPortWaitTime, pvxFMPBWProfileId=pvxFMPBWProfileId, pvxERPSPortCrntPMUnblockedTimeStamp=pvxERPSPortCrntPMUnblockedTimeStamp, pvxSLAMsmtResponderDBSlotIdx=pvxSLAMsmtResponderDBSlotIdx, pvxEServiceSlaCrntPM2WayDelayMaximumValidity=pvxEServiceSlaCrntPM2WayDelayMaximumValidity, pvxVlanCurrentSwitchIdx=pvxVlanCurrentSwitchIdx, pvxLAGPortHistPMLACPDURXTimeStamp=pvxLAGPortHistPMLACPDURXTimeStamp, pvxERPSPortHistPMRecoveriesInitialize=pvxERPSPortHistPMRecoveriesInitialize, pvxSLAThroughputTestFrameSize4NearEndThroughput=pvxSLAThroughputTestFrameSize4NearEndThroughput, pvxEServiceSlaCrntPM2WayDelayAverageInitialize=pvxEServiceSlaCrntPM2WayDelayAverageInitialize, pvxERPSSrvcRevertMode=pvxERPSSrvcRevertMode, pvxMepListTable=pvxMepListTable, pvxLAGPortCrntPMMRKPDUTXTimeStamp=pvxLAGPortCrntPMMRKPDUTXTimeStamp, pvxClassMapL4DstPortEndFilter=pvxClassMapL4DstPortEndFilter, pvxERPSSrvcNNIMEName=pvxERPSSrvcNNIMEName, pvxLAGPortHistPMMRKRSPPDUTXTimeStamp=pvxLAGPortHistPMMRKRSPPDUTXTimeStamp, pvxLAGPortCrntPMIdx=pvxLAGPortCrntPMIdx, mstpPacketErrValue=mstpPacketErrValue, pvxLAGPortCrntPMMRKPDURXInitialize=pvxLAGPortCrntPMMRKPDURXInitialize, pvxEcfmMepDbRemoteMepId=pvxEcfmMepDbRemoteMepId, pvxMSTPPortCrntPMBPDURXValue=pvxMSTPPortCrntPMBPDURXValue, pvxMSTPCrntPMTCCValidity=pvxMSTPCrntPMTCCValidity, pvxESrvcBWPrflPMThresholdPortIdx=pvxESrvcBWPrflPMThresholdPortIdx, pvxMepListSwitchIdx=pvxMepListSwitchIdx, pvxStackingPortTable=pvxStackingPortTable, pvxSchedProfMaxBwQ2=pvxSchedProfMaxBwQ2, pvxMSTPPortCrntPMTypeIdx=pvxMSTPPortCrntPMTypeIdx, pvxSvidXlateEntry=pvxSvidXlateEntry, pvxMSTPGenRegionalRoot=pvxMSTPGenRegionalRoot, pvxMSTPXstRootPortSlot=pvxMSTPXstRootPortSlot, pvxVlanPortAddDynamicVlanEvtNotifications=pvxVlanPortAddDynamicVlanEvtNotifications, pvxSLAMsmtInitiatorDBSlotIdx=pvxSLAMsmtInitiatorDBSlotIdx, pvxSwitchMemberShelfId=pvxSwitchMemberShelfId, pvxControlFrameProfileTable=pvxControlFrameProfileTable, pvxMSTPGenSwitchIdx=pvxMSTPGenSwitchIdx, pvxSchedulerProfileTable=pvxSchedulerProfileTable, pvxBWMeterEir=pvxBWMeterEir, pvxEServiceSlaHistPM2WayDelayMinimumValidity=pvxEServiceSlaHistPM2WayDelayMinimumValidity, pvxMgmtVLANSwitchIdx=pvxMgmtVLANSwitchIdx, pvxERPSPortCrntPMEventPduRxValue=pvxERPSPortCrntPMEventPduRxValue, pvxERPSServiceNNITable=pvxERPSServiceNNITable, pvxNNIMode=pvxNNIMode, pvxClassMapSrcMACMaskFilter=pvxClassMapSrcMACMaskFilter, pvxERPSPortCrntPMEventPduRxTimeStamp=pvxERPSPortCrntPMEventPduRxTimeStamp, pvxSLAMsmtInitiatorDBDelayMsmtSVlanPriority=pvxSLAMsmtInitiatorDBDelayMsmtSVlanPriority, pvxERPSPortHistPMTable=pvxERPSPortHistPMTable, pvxMSTPPortCrntPMIntervalTypeIdx=pvxMSTPPortCrntPMIntervalTypeIdx, pvxERPSPortCrntPMEventPduRxInitialize=pvxERPSPortCrntPMEventPduRxInitialize, pvxPCPEncPriority7DE=pvxPCPEncPriority7DE, pvxFloActRowStatus=pvxFloActRowStatus, pvxLAGPortHistPMINVLACFRRXValidity=pvxLAGPortHistPMINVLACFRRXValidity, pvxMCSwitchIdx=pvxMCSwitchIdx, pvxSwitchCfmDestinationAddress=pvxSwitchCfmDestinationAddress, pvxSchedProfMinBwQ1=pvxSchedProfMinBwQ1, pvxERPSPortHistPMNrPduRxValue=pvxERPSPortHistPMNrPduRxValue, pvxMSTPPortHistPMBPDUTXInitialize=pvxMSTPPortHistPMBPDUTXInitialize, pvxFMPStatsEnabled=pvxFMPStatsEnabled, pvxSrvcUNIEgressBWperCos=pvxSrvcUNIEgressBWperCos, pvxMSTPMapVlanS2k=pvxMSTPMapVlanS2k, pvxDynamicVlanPortTagged=pvxDynamicVlanPortTagged, pvxEServiceSlaCrntPMFarEndFrameLossInitialize=pvxEServiceSlaCrntPMFarEndFrameLossInitialize, pvxMSTPHistPMRCCCTimeStamp=pvxMSTPHistPMRCCCTimeStamp, pvxMSTPPortCrntPMINVBPDUCFGRXValue=pvxMSTPPortCrntPMINVBPDUCFGRXValue, pvxPCPEncPriority3=pvxPCPEncPriority3, pvxERPSPortCrntPMNrPduRxValidity=pvxERPSPortCrntPMNrPduRxValidity, pvxSchedProfWeightQ6=pvxSchedProfWeightQ6, pvxMSTPPortHistPMTypeIdx=pvxMSTPPortHistPMTypeIdx, pvxLAGPortHistPMINVLACFRRXInitialize=pvxLAGPortHistPMINVLACFRRXInitialize, pvxERPSPortHistPMFsPduTxTimeStamp=pvxERPSPortHistPMFsPduTxTimeStamp, mstpNewRootEvt=mstpNewRootEvt, pvxFIdx=pvxFIdx, pvxStackingPortEntry=pvxStackingPortEntry, pvxSLAThroughputTestFrameSize3FarEndThroughput=pvxSLAThroughputTestFrameSize3FarEndThroughput, pvxSchedProfWeightQ5=pvxSchedProfWeightQ5, pvxMSTPHistPMTCCValue=pvxMSTPHistPMTCCValue, mstpGeneralEvtType=mstpGeneralEvtType, pvxCPRowStatus=pvxCPRowStatus, pvxERPSPortCrntPMEventPduTxValidity=pvxERPSPortCrntPMEventPduTxValidity, pvxSLAThroughputTestFrameSize1=pvxSLAThroughputTestFrameSize1, pvxControlFrameProfileEntry=pvxControlFrameProfileEntry, pvxERPSSrvcHoldTimer=pvxERPSSrvcHoldTimer, pvxNNIEntry=pvxNNIEntry, pvxVLANEntry=pvxVLANEntry, pvxLagPortShelfIdx=pvxLagPortShelfIdx, pvxERPSPortHistPMFailuresTimeStamp=pvxERPSPortHistPMFailuresTimeStamp, pvxFloActChangePriority=pvxFloActChangePriority, pvxMSTPPortCrntPMBPDUTCNRXInitialize=pvxMSTPPortCrntPMBPDUTCNRXInitialize, pvxLAGPortCrntPMMRKRSPPDUTXValue=pvxLAGPortCrntPMMRKRSPPDUTXValue, pvxNNIRowStatus=pvxNNIRowStatus, pvxCPWeight=pvxCPWeight, pvxERPSPortCrntPMSfPduTxValidity=pvxERPSPortCrntPMSfPduTxValidity, pvxBWMeterCbs=pvxBWMeterCbs, PvxEcfmIngressActionFieldValue=PvxEcfmIngressActionFieldValue, pvxMSTPPortHistPMPMCValue=pvxMSTPPortHistPMPMCValue, pvxMSTPPortHistPMINVBPDUTCNRXInitialize=pvxMSTPPortHistPMINVBPDUTCNRXInitialize, pvxEcfmMepY1731LbmCurrentTransId=pvxEcfmMepY1731LbmCurrentTransId, pvxEServiceSlaCrntPMFarEndFrameLossValidity=pvxEServiceSlaCrntPMFarEndFrameLossValidity, pvxSwitchMIPAutoCreateMEL=pvxSwitchMIPAutoCreateMEL, PYSNMP_MODULE_ID=packetVxBridgeMib, pvxSwitchMemberBackplaneCommState=pvxSwitchMemberBackplaneCommState, pvxSchedProfMaxBwQ6=pvxSchedProfMaxBwQ6, pvxMSTPPortCrntPMEntry=pvxMSTPPortCrntPMEntry, pvxLAGPortCrntPMMRKPDUTXValidity=pvxLAGPortCrntPMMRKPDUTXValidity, pvxFlowClassificationTable=pvxFlowClassificationTable, pvxSwitchInnerEthType=pvxSwitchInnerEthType, pvxMSTPPortHistPMTable=pvxMSTPPortHistPMTable, pvxESrvcBWPrflCrntPMESrvcNameIdx=pvxESrvcBWPrflCrntPMESrvcNameIdx, pvxESrvcBWPrflCrntPMOctetsVltTimeStamp=pvxESrvcBWPrflCrntPMOctetsVltTimeStamp, pvxERPSPortHistPMEventPduTxValue=pvxERPSPortHistPMEventPduTxValue, pvxSLAMsmtInitiatorDBShelfIdx=pvxSLAMsmtInitiatorDBShelfIdx, pvxFMeterId=pvxFMeterId, pvxERPSPortHistPMSfPduTxValue=pvxERPSPortHistPMSfPduTxValue, pvxMSTPPortHistPMBPDUTCNRXValue=pvxMSTPPortHistPMBPDUTCNRXValue, pvxSchedProfName=pvxSchedProfName, pvxLagPortLcapId=pvxLagPortLcapId, pvxNNISlotId=pvxNNISlotId)
