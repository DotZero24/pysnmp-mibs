...
condSeverity, condReportType, evtObjectType, condCodeType, pvxL2IntfSlotIdx, pvxL2IntfPortTypeIdx, mstpEvtNotifications, tcaValue, pvxObjects, evtDescription, condServiceAffecting, swMemberCondNotifications, tcaMontype, pvxESrvcBWPrflEvtNotifications, lagCondNotifications, pvxBridge, erpsCondNotifications, evtDateAndTime, eventNotifications, condDescription, pvxSlaMsmtEvtNotifications, pvxERPSSrvcEvtNotifications, tcaDateAndTime, mstpCondNotifications, condObjectType, pvxL2IntfSubPortNumber, mstpNotificationObjects, condDateAndTime, pvxERPSSrvcNNIEvtNotifications, pvxL2IntfShelfIdx, pvxSUniEvtNotifications, pvxL2IntfSwitchIdx, pvxESrvcEvtNotifications, tcaThreshold, trapSeqNum, evtCodeType, performance, pvxL2IntfPortIdx = mibBuilder.importSymbols("BTI-7000-MIB", "condSeverity", "condReportType", "evtObjectType", "condCodeType", "pvxL2IntfSlotIdx", "pvxL2IntfPortTypeIdx", "mstpEvtNotifications", "tcaValue", "pvxObjects", "evtDescription", "condServiceAffecting", "swMemberCondNotifications", "tcaMontype", "pvxESrvcBWPrflEvtNotifications", "lagCondNotifications", "pvxBridge", "erpsCondNotifications", "evtDateAndTime", "eventNotifications", "condDescription", "pvxSlaMsmtEvtNotifications", "pvxERPSSrvcEvtNotifications", "tcaDateAndTime", "mstpCondNotifications", "condObjectType", "pvxL2IntfSubPortNumber", "mstpNotificationObjects", "condDateAndTime", "pvxERPSSrvcNNIEvtNotifications", "pvxL2IntfShelfIdx", "pvxSUniEvtNotifications", "pvxL2IntfSwitchIdx", "pvxESrvcEvtNotifications", "tcaThreshold", "trapSeqNum", "evtCodeType", "performance", "pvxL2IntfPortIdx")
btiModules, = mibBuilder.importSymbols("BTI-MIB", "btiModules")
CirTestResult, PMValidity, InetAddress, FixedX1000, PvxPortType, OperStatus, CondServiceAffecting, AdminStatus, ProfileNameType, FixedX100, InitializeCmd, CondSeverity, CondReportType, CommandStateType, Unsigned64, InetAddressType, PmTestCmdState, SwitchIdxType, ProtocolActionType, MonitorPeriodType, PMIntervalType, SlaTestRole = mibBuilder.importSymbols("BTI-TC-MIB", "CirTestResult", "PMValidity", "InetAddress", "FixedX1000", "PvxPortType", "OperStatus", "CondServiceAffecting", "AdminStatus", "ProfileNameType", "FixedX100", "InitializeCmd", "CondSeverity", "CondReportType", "CommandStateType", "Unsigned64", "InetAddressType", "PmTestCmdState", "SwitchIdxType", "ProtocolActionType", "MonitorPeriodType", "PMIntervalType", "SlaTestRole")
...
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxMSTPPortCrntPMSlotIdx=pvxMSTPPortCrntPMSlotIdx, pvxSwitchMemberSlotId=pvxSwitchMemberSlotId, pvxERPSPortHistPMNrPduRxTimeStamp=pvxERPSPortHistPMNrPduRxTimeStamp, pvxERPSPortCrntPMVersionDiscardValidity=pvxERPSPortCrntPMVersionDiscardValidity, pvxEServiceSlaHistPM2WayDelayVariationAverageValidity=pvxEServiceSlaHistPM2WayDelayVariationAverageValidity, pvxFSSwitchIdx=pvxFSSwitchIdx, pvxERPSPortCrntPMNrPduTxValidity=pvxERPSPortCrntPMNrPduTxValidity, pvxStackingPortRowStatus=pvxStackingPortRowStatus, pvxMSTPPortHistPMSwitchIdx=pvxMSTPPortHistPMSwitchIdx, pvxERPSPortCrntPMBlockedValidity=pvxERPSPortCrntPMBlockedValidity, pvxMSTPXstRootPortSwitch=pvxMSTPXstRootPortSwitch, pvxEcfmMepTransmitLbmStatus=pvxEcfmMepTransmitLbmStatus, pvxLAGPortHistPMMRKRSPPDUTXInitialize=pvxLAGPortHistPMMRKRSPPDUTXInitialize, pvxEServiceSlaCrntPMSlotIdx=pvxEServiceSlaCrntPMSlotIdx, pvxUNISlotId=pvxUNISlotId, pvxSrvcUNIForwarding=pvxSrvcUNIForwarding, pvxERPSPortCrntPMMsPduTxInitialize=pvxERPSPortCrntPMMsPduTxInitialize, pvxMSTPPortHistPMBPDURXTimeStamp=pvxMSTPPortHistPMBPDURXTimeStamp, pvxMSTPXstPortSwitchIdx=pvxMSTPXstPortSwitchIdx, pvxSrvcNNIEgressBWperCos=pvxSrvcNNIEgressBWperCos, pvxMSTPPortHistPMIntervalTypeIdx=pvxMSTPPortHistPMIntervalTypeIdx, pvxERPSPortCrntPMPduRxInitialize=pvxERPSPortCrntPMPduRxInitialize, pvxESrvcBWPrflHistPMTable=pvxESrvcBWPrflHistPMTable, pvxMCIntfIdList=pvxMCIntfIdList, pvxEcfmMipESrvcVlanId=pvxEcfmMipESrvcVlanId, pvxFDBEntry=pvxFDBEntry, pvxEcfmMepTransmitLbmDestMepId=pvxEcfmMepTransmitLbmDestMepId, pvxERPSPortHistPMFailuresTimeStamp=pvxERPSPortHistPMFailuresTimeStamp, pvxERPSPortCrntPMPduDiscardInitialize=pvxERPSPortCrntPMPduDiscardInitialize, pvxERPSPortHistPMPduRxValidity=pvxERPSPortHistPMPduRxValidity, pvxEcfmLtrEgressMac=pvxEcfmLtrEgressMac, PvxEcfmIngressActionFieldValue=PvxEcfmIngressActionFieldValue, pvxESrvcBWPrflBDWUtlzTcaEvt=pvxESrvcBWPrflBDWUtlzTcaEvt, pvxClassMapEtherTypeFilter=pvxClassMapEtherTypeFilter, pvxSLAThroughputTestTable=pvxSLAThroughputTestTable, pvxEcfmMepDbRMepRDI=pvxEcfmMepDbRMepRDI, PvxEcfmRemoteMepState=PvxEcfmRemoteMepState, pvxMSTPPortPathCost=pvxMSTPPortPathCost, pvxSrvcNNIShelfId=pvxSrvcNNIShelfId, pvxLAGPortHistPMSwitchIdx=pvxLAGPortHistPMSwitchIdx, pvxMSTPPortHistPMBPDUTXInitialize=pvxMSTPPortHistPMBPDUTXInitialize, pvxEcfmLtrEgressPortInfo=pvxEcfmLtrEgressPortInfo, pvxESrvcBWPrflHistPMOctetsVltTimeStamp=pvxESrvcBWPrflHistPMOctetsVltTimeStamp, pvxBandwidthProfileName=pvxBandwidthProfileName, pvxERPSPortHistPMMsPduRxInitialize=pvxERPSPortHistPMMsPduRxInitialize, pvxFloClStatus=pvxFloClStatus, pvxEcfmLtrSwitchName=pvxEcfmLtrSwitchName, pvxBWCnfrmActionChangeDscp=pvxBWCnfrmActionChangeDscp, pvxFlowMeterEntry=pvxFlowMeterEntry, pvxSwitchStackingTimeAsPrimary=pvxSwitchStackingTimeAsPrimary, pvxSchedProfRowStatus=pvxSchedProfRowStatus, pvxMgmtVLANCVLANId=pvxMgmtVLANCVLANId, pvxERPSSrvcWaitToRestoreTimer=pvxERPSSrvcWaitToRestoreTimer, pvxClassMapL4DstPortFilter=pvxClassMapL4DstPortFilter, pvxFloActGreenAction=pvxFloActGreenAction, pvxERPSPortHistPMPduTxInitialize=pvxERPSPortHistPMPduTxInitialize, mstpProtocolMigrationType=mstpProtocolMigrationType, pvxSchedProfMinBwQ0=pvxSchedProfMinBwQ0, pvxPCPEncDecRowStatus=pvxPCPEncDecRowStatus, pvxLGPortCount=pvxLGPortCount, pvxERPSSrvcRingNodeStatus=pvxERPSSrvcRingNodeStatus, pvxMSTPPortCrntPMBPDUTCNTXValue=pvxMSTPPortCrntPMBPDUTCNTXValue, pvxEcfmLtrIngressAction=pvxEcfmLtrIngressAction, pvxERPSPortCrntPMMsPduTxValue=pvxERPSPortCrntPMMsPduTxValue, pvxEcfmLtrMepIdentifier=pvxEcfmLtrMepIdentifier, pvxSwitchEntry=pvxSwitchEntry, pvxMSTPPortState=pvxMSTPPortState, pvxEcfmMipActiveState=pvxEcfmMipActiveState, pvxERPSPortHistPMTable=pvxERPSPortHistPMTable, pvxERPSPortHistPMFailuresInitialize=pvxERPSPortHistPMFailuresInitialize, pvxESrvcBWPrflCrntPMOctetsCnfExcTimeStamp=pvxESrvcBWPrflCrntPMOctetsCnfExcTimeStamp, pvxEthSrvcCVidXlate=pvxEthSrvcCVidXlate, mstpProtocolGeneralEvt=mstpProtocolGeneralEvt, pvxERPSPortHistPMMsPduRxTimeStamp=pvxERPSPortHistPMMsPduRxTimeStamp, pvxMSTPPortHistPMBPDUTCNRXInitialize=pvxMSTPPortHistPMBPDUTCNRXInitialize, pvxEcfmMepTransmitLtmTtl=pvxEcfmMepTransmitLtmTtl, pvxLAGPortHistPMLACPDURXInitialize=pvxLAGPortHistPMLACPDURXInitialize, pvxDscpClassSelector1=pvxDscpClassSelector1, pvxESrvcBWPrflCrntPMClsMapNameIdx=pvxESrvcBWPrflCrntPMClsMapNameIdx, pvxEServiceSlaCrntPMEntry=pvxEServiceSlaCrntPMEntry, pvxSwitchMemberRowStatus=pvxSwitchMemberRowStatus, pvxLGMinLinks=pvxLGMinLinks, PvxMSTPVlanList=PvxMSTPVlanList, pvxFlowMeterProfileTable=pvxFlowMeterProfileTable, pvxLAGPortCrntPMSwitchIdx=pvxLAGPortCrntPMSwitchIdx, pvxLAGPortCrntPMLACPDURXValidity=pvxLAGPortCrntPMLACPDURXValidity, pvxMSTPPortHistPMTypeIdx=pvxMSTPPortHistPMTypeIdx, pvxStaticMCRowStatus=pvxStaticMCRowStatus, pvxSwitchStackingPrimary=pvxSwitchStackingPrimary, pvxEthSrvcTransportType=pvxEthSrvcTransportType, pvxERPSPortHistPMFailuresValidity=pvxERPSPortHistPMFailuresValidity, pvxESrvcBWPrflHistPMOctetsCnfExcValidity=pvxESrvcBWPrflHistPMOctetsCnfExcValidity, pvxEServiceSlaCrntPM2WayDelayVariationMinimumValidity=pvxEServiceSlaCrntPM2WayDelayVariationMinimumValidity, pvxMCSwitchIdx=pvxMCSwitchIdx, pvxMgmtVLANBWProfileName=pvxMgmtVLANBWProfileName, pvxFlowTable=pvxFlowTable, resourceUnavailableClear=resourceUnavailableClear, pvxSLAMsmtResponderDBRowStatus=pvxSLAMsmtResponderDBRowStatus, PvxY1731MepDefects=PvxY1731MepDefects, pvxLagState=pvxLagState, pvxSrvcNNIPortId=pvxSrvcNNIPortId, pvxFloClDestMacFilter=pvxFloClDestMacFilter, pvxClassMapDstIpFilter=pvxClassMapDstIpFilter, pvxMSTPPortCrntPMBPDUTCNTXInitialize=pvxMSTPPortCrntPMBPDUTCNTXInitialize, pvxLAGPortHistPMLACPDUTXInitialize=pvxLAGPortHistPMLACPDUTXInitialize, pvxMSTPPortHistPMBPDUCFGRXValidity=pvxMSTPPortHistPMBPDUCFGRXValidity, pvxMSTPXstEntry=pvxMSTPXstEntry, pvxESrvcBWPrflHistPMBDWUtlzInitialize=pvxESrvcBWPrflHistPMBDWUtlzInitialize, pvxControlFrameProfileLldp=pvxControlFrameProfileLldp, pvxSLAMsmtMonitorPeriod=pvxSLAMsmtMonitorPeriod, pvxLAGPortHistPMMRKRSPPDUTXValidity=pvxLAGPortHistPMMRKRSPPDUTXValidity, pvxSwitchMode=pvxSwitchMode, pvxMSTPPortCrntPMBPDUTCNTXTimeStamp=pvxMSTPPortCrntPMBPDUTCNTXTimeStamp, pvxEcfmMepActive=pvxEcfmMepActive, pvxSLAMsmtResponderDBPortTypeIdx=pvxSLAMsmtResponderDBPortTypeIdx, pvxESrvcBWPrflHistPMShelfIdx=pvxESrvcBWPrflHistPMShelfIdx, pvxERPSPortHistPMBlockedValue=pvxERPSPortHistPMBlockedValue, pvxSchedProfWeightQ1=pvxSchedProfWeightQ1, pvxMSTPXstSwitchIdx=pvxMSTPXstSwitchIdx, pvxMSTPPortCrntPMINVBPDURXTimeStamp=pvxMSTPPortCrntPMINVBPDURXTimeStamp, pvxDscpExpeditedFwd=pvxDscpExpeditedFwd, pvxEServiceSlaHistPMESName=pvxEServiceSlaHistPMESName, PvxEcfmRelayActionFieldValue=PvxEcfmRelayActionFieldValue, pvxSrvcUNIEFPSDLocalEFPSDStateChangeEvent=pvxSrvcUNIEFPSDLocalEFPSDStateChangeEvent, pvxMSTPMapTable=pvxMSTPMapTable, pvxERPSPortHistPMSwitchIdx=pvxERPSPortHistPMSwitchIdx, pvxERPSPortCrntPMUnblockedTimeStamp=pvxERPSPortCrntPMUnblockedTimeStamp, pvxBWMeterEir=pvxBWMeterEir, pvxCPQueueAlgo=pvxCPQueueAlgo, pvxEServiceSlaCrntPMFarEndFrameLossTimeStamp=pvxEServiceSlaCrntPMFarEndFrameLossTimeStamp, pvxEServiceSlaHistPM2WayDelayVariationAverage=pvxEServiceSlaHistPM2WayDelayVariationAverage, pvxEthSrvcState=pvxEthSrvcState, pvxEServiceSlaHistPMNearEndFrameLossTimeStamp=pvxEServiceSlaHistPMNearEndFrameLossTimeStamp, PvxPhyPort=PvxPhyPort, pvxMSTPPortCrntPMEntry=pvxMSTPPortCrntPMEntry, pvxESrvcHistPMIntervalIdx=pvxESrvcHistPMIntervalIdx, pvxERPSPortHistPMUnblockedValue=pvxERPSPortHistPMUnblockedValue, pvxSwitchProtocolAdminState=pvxSwitchProtocolAdminState, pvxBandwidthProfileRowStatus=pvxBandwidthProfileRowStatus, pvxMSTPHistPMNRBCTimeStamp=pvxMSTPHistPMNRBCTimeStamp, pvxERPSPortCrntPMNrPduTxInitialize=pvxERPSPortCrntPMNrPduTxInitialize, pvxESrvcBWPrflCrntPMOctetsVltTimeStamp=pvxESrvcBWPrflCrntPMOctetsVltTimeStamp, pvxTunnMacAddrProfileTable=pvxTunnMacAddrProfileTable, pvxServiceNNIEntry=pvxServiceNNIEntry, pvxMSTPPortHistPMBPDUTXTimeStamp=pvxMSTPPortHistPMBPDUTXTimeStamp, pvxERPSPortCrntPMFailuresInitialize=pvxERPSPortCrntPMFailuresInitialize, pvxMSTPGenIdName=pvxMSTPGenIdName, pvxERPSPortHistPMPduRxTimeStamp=pvxERPSPortHistPMPduRxTimeStamp, pvxMSTPPortCrntPMBPDUCFGTXTimeStamp=pvxMSTPPortCrntPMBPDUCFGTXTimeStamp, pvxMSTPPortCrntPMXstIdx=pvxMSTPPortCrntPMXstIdx, pvxESrvcBWPrflHistPMEntry=pvxESrvcBWPrflHistPMEntry, pvxCPMinBandwidth=pvxCPMinBandwidth, pvxMSTPPortLinkType=pvxMSTPPortLinkType, pvxFloClSwitchIdx=pvxFloClSwitchIdx, pvxSLAThroughputTestFrameSize6=pvxSLAThroughputTestFrameSize6, pvxVLANUnTaggedPortList=pvxVLANUnTaggedPortList, pvxESrvcBWPrflHistPMIntervalIdx=pvxESrvcBWPrflHistPMIntervalIdx, pvxStaticUnicastEntry=pvxStaticUnicastEntry, pvxERPSPortHistPMTypeIdx=pvxERPSPortHistPMTypeIdx, pvxLGOperStatus=pvxLGOperStatus, pvxESrvcBWPrflHistPMOctetsCnfExcInitialize=pvxESrvcBWPrflHistPMOctetsCnfExcInitialize, PvxErpsVirtualLinkList=PvxErpsVirtualLinkList, pvxERPSSrvcNNIMEName=pvxERPSSrvcNNIMEName, pvxMgmtVLANSrvcName=pvxMgmtVLANSrvcName, pvxERPSPortHistPMEventPduRxInitialize=pvxERPSPortHistPMEventPduRxInitialize, pvxSchedProfMaxBwQ1=pvxSchedProfMaxBwQ1, pvxY1731LbStatsESrvcName=pvxY1731LbStatsESrvcName, pvxEServiceSlaHistPMFarEndFrameLossInitialize=pvxEServiceSlaHistPMFarEndFrameLossInitialize, mstpInvalidPacketRcvdEvt=mstpInvalidPacketRcvdEvt, pvxFMPIdx=pvxFMPIdx, pvxVLANService=pvxVLANService, pvxESrvcBWPrflPMThresholdTable=pvxESrvcBWPrflPMThresholdTable, pvxMSTPPortRestrictedTCN=pvxMSTPPortRestrictedTCN, cfmRMepStateChangeEvt=cfmRMepStateChangeEvt, pvxFCoSName=pvxFCoSName, pvxERPSSrvcVersionMismatchClear=pvxERPSSrvcVersionMismatchClear, pvxERPSSrvcNNIFlushRemoteMEP=pvxERPSSrvcNNIFlushRemoteMEP, pvxMSTPGenRegionalRoot=pvxMSTPGenRegionalRoot, pvxNNIPortTypeId=pvxNNIPortTypeId, pvxMSTPPortHistPMINVBPDURXInitialize=pvxMSTPPortHistPMINVBPDURXInitialize, pvxEServiceSlaHistPM2WayDelayVariationMinimumValidity=pvxEServiceSlaHistPM2WayDelayVariationMinimumValidity, pvxSLAThroughputTestFrameSize5NearEndThroughput=pvxSLAThroughputTestFrameSize5NearEndThroughput, pvxLAGPortHistPMMRKPDUTXInitialize=pvxLAGPortHistPMMRKPDUTXInitialize, pvxVlanPortRemoveDynamicVlanEvtNotifications=pvxVlanPortRemoveDynamicVlanEvtNotifications, pvxEthSrvcRowStatus=pvxEthSrvcRowStatus, pvxEServiceSlaHistPM2WayDelayMaximumValidity=pvxEServiceSlaHistPM2WayDelayMaximumValidity, cfmRMepStateChangeEvtNotifications=cfmRMepStateChangeEvtNotifications, pvxStaticUnicastAddressType=pvxStaticUnicastAddressType, pvxLAGPortCrntPMMRKRSPPDUTXTimeStamp=pvxLAGPortCrntPMMRKRSPPDUTXTimeStamp, pvxVlanPortEthPortAllowedFrametType=pvxVlanPortEthPortAllowedFrametType, pvxClassMapProfileTable=pvxClassMapProfileTable, pvxPCVRTCVlanIdFrom=pvxPCVRTCVlanIdFrom, pvxMSTPPortCrntPMINVBPDURXValue=pvxMSTPPortCrntPMINVBPDURXValue, pvxEcfmMepShelfId=pvxEcfmMepShelfId, pvxSLAThroughputTestPortIdx=pvxSLAThroughputTestPortIdx, pvxVlanPortIngressFiltering=pvxVlanPortIngressFiltering, pvxBWPRowStatus=pvxBWPRowStatus, pvxMSTPCrntPMNRBCInitialize=pvxMSTPCrntPMNRBCInitialize, pvxFloActPacketAction=pvxFloActPacketAction, pvxESrvcHistPMUASValue=pvxESrvcHistPMUASValue, pvxSLAThroughputTestBwProfileName=pvxSLAThroughputTestBwProfileName, pvxTunnelMacAddrProfileTable=pvxTunnelMacAddrProfileTable, pvxFlowEntry=pvxFlowEntry, pvxVLANAdminState=pvxVLANAdminState, pvxMSTPPortEntry=pvxMSTPPortEntry, pvxERPSPortHistPMPduTxValidity=pvxERPSPortHistPMPduTxValidity, pvxEServiceSlaCrntPM2WayDelayVariationMaximum=pvxEServiceSlaCrntPM2WayDelayVariationMaximum, pvxStaticMulticastEntry=pvxStaticMulticastEntry, pvxMSTPXstPortRole=pvxMSTPXstPortRole, pvxERPSSrvcNNISrvcName=pvxERPSSrvcNNISrvcName, pvxSLAThroughputTestFrameSize6NearEndThroughput=pvxSLAThroughputTestFrameSize6NearEndThroughput, pvxSLAMsmtInitiatorDBESName=pvxSLAMsmtInitiatorDBESName, pvxEcfmMepFlushRMepDb=pvxEcfmMepFlushRMepDb, pvxESrvcBWPrflPMThresholdESrvcNameIdx=pvxESrvcBWPrflPMThresholdESrvcNameIdx, pvxFDBTable=pvxFDBTable, pvxLAGPortHistPMMRKRSPPDURXTimeStamp=pvxLAGPortHistPMMRKRSPPDURXTimeStamp, pvxPriority3TrafficClass=pvxPriority3TrafficClass, pvxSrvcUNIPortTypeId=pvxSrvcUNIPortTypeId, pvxEServiceSlaCrntPM2WayDelayVariationAverage=pvxEServiceSlaCrntPM2WayDelayVariationAverage, pvxFloClSourceMacFilter=pvxFloClSourceMacFilter, pvxERPSPortHistPMSfPduTxTimeStamp=pvxERPSPortHistPMSfPduTxTimeStamp, pvxFIdx=pvxFIdx, pvxSLAThroughputTestFrameSize1FarEndThroughput=pvxSLAThroughputTestFrameSize1FarEndThroughput, pvxMSTPPortCrntPMBPDUTCNRXValue=pvxMSTPPortCrntPMBPDUTCNRXValue, pvxBandwidthProfileEntry=pvxBandwidthProfileEntry, pvxPCPEncDecProfEntry=pvxPCPEncDecProfEntry, pvxESrvcBWPrflCrntPMPlcyNameIdx=pvxESrvcBWPrflCrntPMPlcyNameIdx, pvxSLAThroughputTestFrameSize2FarEndThroughput=pvxSLAThroughputTestFrameSize2FarEndThroughput, pvxERPSPortHistPMPduRxValue=pvxERPSPortHistPMPduRxValue, pvxERPSPortHistPMBlockedValidity=pvxERPSPortHistPMBlockedValidity, pvxVlanPortShelfIdx=pvxVlanPortShelfIdx, pvxMSTPPortHistPMINVBPDUCFGRXTimeStamp=pvxMSTPPortHistPMINVBPDUCFGRXTimeStamp, pvxERPSServiceNNIEntry=pvxERPSServiceNNIEntry, pvxMSTPPortPriority=pvxMSTPPortPriority, pvxDscpClassSelector7=pvxDscpClassSelector7, pvxSchedProfMaxBwQ7=pvxSchedProfMaxBwQ7, pvxEServiceSlaCrntPM2WayDelayMaximumTimeStamp=pvxEServiceSlaCrntPM2WayDelayMaximumTimeStamp, pvxERPSPortCrntPMPduRxValidity=pvxERPSPortCrntPMPduRxValidity, pvxERPSPortCrntPMFsPduRxValue=pvxERPSPortCrntPMFsPduRxValue, pvxVlanPortSlotIdx=pvxVlanPortSlotIdx, pvxMSTPCrntPMSwitchIdx=pvxMSTPCrntPMSwitchIdx, pvxEcfmMipPortTypeId=pvxEcfmMipPortTypeId, pvxESrvcBWPrflCrntPMOctetsCnfExcValue=pvxESrvcBWPrflCrntPMOctetsCnfExcValue, pvxEcfmMepMacAddress=pvxEcfmMepMacAddress, pvxMSTPMapVlanS3k=pvxMSTPMapVlanS3k, pvxMSTPCrntPMRCCCValue=pvxMSTPCrntPMRCCCValue, pvxERPSSrvcSwitchIdx=pvxERPSSrvcSwitchIdx, pvxY1731LbmTransId=pvxY1731LbmTransId, pvxEServiceSlaHistPM2WayDelayVariationMaximum=pvxEServiceSlaHistPM2WayDelayVariationMaximum, pvxPriority7TrafficClass=pvxPriority7TrafficClass, pvxPCPDecPriority3=pvxPCPDecPriority3, pvxSLAMsmtInitiatorDBTable=pvxSLAMsmtInitiatorDBTable, pvxPolicyMapProfileTable=pvxPolicyMapProfileTable, pvxESrvcBWPrflCrntPMDirectionIdx=pvxESrvcBWPrflCrntPMDirectionIdx)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxLagPortPrtnrAdminState=pvxLagPortPrtnrAdminState, pvxClassMapType=pvxClassMapType, pvxERPSPortCrntPMSfPduRxValue=pvxERPSPortCrntPMSfPduRxValue, pvxBWMeterCbs=pvxBWMeterCbs, pvxClassMapCVlanPriFilter=pvxClassMapCVlanPriFilter, pvxERPSPortHistPMNrPduTxTimeStamp=pvxERPSPortHistPMNrPduTxTimeStamp, PvxEcfmConfigErrors=PvxEcfmConfigErrors, pvxEServiceSlaHistPMPortIdx=pvxEServiceSlaHistPMPortIdx, pvxMSTPPortCrntPMPMCValidity=pvxMSTPPortCrntPMPMCValidity, pvxERPSPortCrntPMNrrbPduRxTimeStamp=pvxERPSPortCrntPMNrrbPduRxTimeStamp, pvxPCPEncPriority4=pvxPCPEncPriority4, pvxY1731LbStatsLbrTimeMax=pvxY1731LbStatsLbrTimeMax, PvxQoSPmCounterMode=PvxQoSPmCounterMode, pvxEcfmMepY1731DefectConditions=pvxEcfmMepY1731DefectConditions, pvxUNIServiceType=pvxUNIServiceType, pvxUNINumServices=pvxUNINumServices, pvxSLAThroughputTestFrameSize3FarEndThroughput=pvxSLAThroughputTestFrameSize3FarEndThroughput, pvxMSTPPortCrntPMBPDURXValue=pvxMSTPPortCrntPMBPDURXValue, pvxSvidXlateSwitchId=pvxSvidXlateSwitchId, pvxEcfmMepSentCcms=pvxEcfmMepSentCcms, pvxControlFrameProfileLacp=pvxControlFrameProfileLacp, pvxNNISpeed=pvxNNISpeed, pvxESrvcBWPrflCrntPMSwitchIdx=pvxESrvcBWPrflCrntPMSwitchIdx, pvxLAGPortHistPMINVLACFRRXValue=pvxLAGPortHistPMINVLACFRRXValue, pvxFloClActionId=pvxFloClActionId, pvxESrvcBWPrflPMThresholdLevelTypeIdx=pvxESrvcBWPrflPMThresholdLevelTypeIdx, PvxCVidMapOperStatus=PvxCVidMapOperStatus, pvxERPSPortCrntPMSfPduTxTimeStamp=pvxERPSPortCrntPMSfPduTxTimeStamp, pvxERPSPortHistPMSfPduRxInitialize=pvxERPSPortHistPMSfPduRxInitialize, pvxEServiceSlaCrntPM2WayDelayMaximumValidity=pvxEServiceSlaCrntPM2WayDelayMaximumValidity, pvxERPSSrvcNNIRingProtectLink=pvxERPSSrvcNNIRingProtectLink, pvxSLAThroughputTestFrameSize4NearEndThroughput=pvxSLAThroughputTestFrameSize4NearEndThroughput, pvxDscpPHBProfileName=pvxDscpPHBProfileName, pvxLAGPortHistPMEntry=pvxLAGPortHistPMEntry, pvxStackingPortOperStatus=pvxStackingPortOperStatus, pvxPCVRTMapOperStatus=pvxPCVRTMapOperStatus, pvxMepLocalRemoteFlag=pvxMepLocalRemoteFlag, pvxEcfmMepErrCcmRMepId=pvxEcfmMepErrCcmRMepId, pvxERPSPortCrntPMFailuresTimeStamp=pvxERPSPortCrntPMFailuresTimeStamp, pvxERPSPortCrntPMNrrbPduTxTimeStamp=pvxERPSPortCrntPMNrrbPduTxTimeStamp, pvxFlowActionsTable=pvxFlowActionsTable, pvxFDBPort=pvxFDBPort, pvxMSTPPortCrntPMBPDUCFGRXValidity=pvxMSTPPortCrntPMBPDUCFGRXValidity, pvxLAGPortCrntPMMRKRSPPDURXInitialize=pvxLAGPortCrntPMMRKRSPPDURXInitialize, pvxTMAPDot1xTunnMacAddr=pvxTMAPDot1xTunnMacAddr, pvxPriorityTCMapRowStatus=pvxPriorityTCMapRowStatus, pvxSwitchLearning=pvxSwitchLearning, pvxMSTPXstPortDesigPortId=pvxMSTPXstPortDesigPortId, pvxLAGPortHistPMINVLACFRRXTimeStamp=pvxLAGPortHistPMINVLACFRRXTimeStamp, pvxEServiceSlaHistPM2WayDelayMinimumInitialize=pvxEServiceSlaHistPM2WayDelayMinimumInitialize, pvxClassMapSrcIpNetMaskFilter=pvxClassMapSrcIpNetMaskFilter, pvxMSTPGenIdDigest=pvxMSTPGenIdDigest, pvxEcfmMepDefects=pvxEcfmMepDefects, pvxERPSPortCrntPMUnblockedValidity=pvxERPSPortCrntPMUnblockedValidity, pvxEcfmMepCcmSequenceErr=pvxEcfmMepCcmSequenceErr, pvxSLAThroughputTestESName=pvxSLAThroughputTestESName, pvxERPSPortHistPMSfPduRxTimeStamp=pvxERPSPortHistPMSfPduRxTimeStamp, pvxPCPEncPriority7DE=pvxPCPEncPriority7DE, pvxPCPEncPriority3=pvxPCPEncPriority3, pvxERPSSrvcVersionMismatchCond=pvxERPSSrvcVersionMismatchCond, pvxSwitchAgingTimer=pvxSwitchAgingTimer, pvxESrvcBWPrflHistPMIntervalTypeIdx=pvxESrvcBWPrflHistPMIntervalTypeIdx, pvxEServiceSlaCrntPMFarEndFrameLossValidity=pvxEServiceSlaCrntPMFarEndFrameLossValidity, pvxNextFreeIndexTableIndex=pvxNextFreeIndexTableIndex, pvxControlFrameProfileStp=pvxControlFrameProfileStp, pvxEthSrvcMaxNNIs=pvxEthSrvcMaxNNIs, pvxEcfmMepDbRMepPortInfo=pvxEcfmMepDbRMepPortInfo, pvxLAGPortCrntPMLACPDURXInitialize=pvxLAGPortCrntPMLACPDURXInitialize, pvxEcfmMepTransmitLtmTargetMepId=pvxEcfmMepTransmitLtmTargetMepId, pvxCPRowStatus=pvxCPRowStatus, pvxFlowClassificationTable=pvxFlowClassificationTable, pvxEcfmLtrTable=pvxEcfmLtrTable, pvxLAGPortCrntPMLACPDUTXValidity=pvxLAGPortCrntPMLACPDUTXValidity, pvxClassMapTcpControlFilter=pvxClassMapTcpControlFilter, pvxERPSPortCrntPMPduDiscardValidity=pvxERPSPortCrntPMPduDiscardValidity, pvxERPSPortCrntPMTypeIdx=pvxERPSPortCrntPMTypeIdx, pvxERPSPortCrntPMVersionDiscardTimeStamp=pvxERPSPortCrntPMVersionDiscardTimeStamp, pvxERPSSrvcRevertMode=pvxERPSSrvcRevertMode, pvxESrvcBWPrflHistPMPortTypeIdx=pvxESrvcBWPrflHistPMPortTypeIdx, pvxERPSPortHistPMUnblockedInitialize=pvxERPSPortHistPMUnblockedInitialize, pvxPCPEncPriority0DE=pvxPCPEncPriority0DE, pvxMSTPXstPortDesigRoot=pvxMSTPXstPortDesigRoot, pvxERPSPortHistPMVersionDiscardTimeStamp=pvxERPSPortHistPMVersionDiscardTimeStamp, pvxSLAMsmtResponderDBSlotIdx=pvxSLAMsmtResponderDBSlotIdx, pvxMepListRowStatus=pvxMepListRowStatus, pvxEthSrvcSVLAN=pvxEthSrvcSVLAN, pvxERPSSrvcTimerStartEvent=pvxERPSSrvcTimerStartEvent, pvxBWPCoSQueue=pvxBWPCoSQueue, pvxUNIEntry=pvxUNIEntry, pvxDscpPHBProfileEntry=pvxDscpPHBProfileEntry, pvxLAGPortCrntPMMRKPDUTXInitialize=pvxLAGPortCrntPMMRKPDUTXInitialize, pvxMSTPPortIdx=pvxMSTPPortIdx, pvxMepListTable=pvxMepListTable, pvxSwitchRowStatus=pvxSwitchRowStatus, pvxCPIdx=pvxCPIdx, pvxERPSPortCrntPMSfPduTxValidity=pvxERPSPortCrntPMSfPduTxValidity, pvxMSTPPortCrntPMBPDUCFGRXValue=pvxMSTPPortCrntPMBPDUCFGRXValue, pvxERPSPortHistPMFsPduTxValidity=pvxERPSPortHistPMFsPduTxValidity, pvxEServiceSlaCrntPM2WayDelayMinimumTimeStamp=pvxEServiceSlaCrntPM2WayDelayMinimumTimeStamp, pvxLAGPortCrntPMMRKPDURXValidity=pvxLAGPortCrntPMMRKPDURXValidity, pvxEServiceSlaCrntPM2WayDelayMinimumInitialize=pvxEServiceSlaCrntPM2WayDelayMinimumInitialize, pvxERPSSrvcNNIPortTypeId=pvxERPSSrvcNNIPortTypeId, pvxSwitchMemberInstIdx=pvxSwitchMemberInstIdx, mstpGeneralEvtType=mstpGeneralEvtType, pvxESrvcCrntPMSwitchIdx=pvxESrvcCrntPMSwitchIdx, pvxMSTPPortHistPMTable=pvxMSTPPortHistPMTable, pvxFloActRedirectToInterfaceIndex=pvxFloActRedirectToInterfaceIndex, pvxStaticMCStaticIntfIdList=pvxStaticMCStaticIntfIdList, pvxSchedProfWeightQ5=pvxSchedProfWeightQ5, mstpNewRootEvt=mstpNewRootEvt, pvxERPSSrvcDownMegLevel=pvxERPSSrvcDownMegLevel, pvxFSFlowId=pvxFSFlowId, pvxERPSPortCrntPMFailuresValue=pvxERPSPortCrntPMFailuresValue, pvxERPSPortCrntPMNrrbPduRxValidity=pvxERPSPortCrntPMNrrbPduRxValidity, pvxMSTPPortCrntPMBPDUTCNRXTimeStamp=pvxMSTPPortCrntPMBPDUTCNRXTimeStamp, pvxMgmtVLANNetMask=pvxMgmtVLANNetMask, pvxMSTPGenExternalRootCost=pvxMSTPGenExternalRootCost, pvxEcfmMepPortTypeId=pvxEcfmMepPortTypeId, pvxStackingPortTable=pvxStackingPortTable, pvxFlowActionsEntry=pvxFlowActionsEntry, pvxEServiceSlaCrntPM2WayDelayVariationMinimumInitialize=pvxEServiceSlaCrntPM2WayDelayVariationMinimumInitialize, PvxEcfmTransmitStatus=PvxEcfmTransmitStatus, pvxPCPDecPriority7=pvxPCPDecPriority7, pvxMSTPGenCistRoot=pvxMSTPGenCistRoot, pvxVlanPortSwitchIdx=pvxVlanPortSwitchIdx, pvxMSTPPortCrntPMBPDUCFGRXTimeStamp=pvxMSTPPortCrntPMBPDUCFGRXTimeStamp, pvxEcfmMepDbLocalMepId=pvxEcfmMepDbLocalMepId, pvxEcfmLtrRelayAction=pvxEcfmLtrRelayAction, pvxVlanPortAddDynamicVlanEvtNotifications=pvxVlanPortAddDynamicVlanEvtNotifications, pvxPCPEncPriority3DE=pvxPCPEncPriority3DE, pvxERPSPortHistPMFsPduRxValidity=pvxERPSPortHistPMFsPduRxValidity, pvxFDBSwitchIdx=pvxFDBSwitchIdx, pvxMSTPPortCrntPMBPDUTXTimeStamp=pvxMSTPPortCrntPMBPDUTXTimeStamp, pvxERPSPortHistPMPortIdx=pvxERPSPortHistPMPortIdx, pvxLAGPortHistPMShelfIdx=pvxLAGPortHistPMShelfIdx, pvxEthSrvcSwitchIdx=pvxEthSrvcSwitchIdx, pvxERPSPortHistPMNrrbPduTxInitialize=pvxERPSPortHistPMNrrbPduTxInitialize, pvxY1731LbStatsIdentifier=pvxY1731LbStatsIdentifier, pvxDscpClassSelector2=pvxDscpClassSelector2, pvxERPSSrvcSVLAN=pvxERPSSrvcSVLAN, pvxVlanPortGvrpFailedRegistrations=pvxVlanPortGvrpFailedRegistrations, pvxLagRowStatus=pvxLagRowStatus, pvxLGMaxLinks=pvxLGMaxLinks, pvxSchedProfMinBwQ2=pvxSchedProfMinBwQ2, pvxSLAMsmtThresholdDelayMaximum=pvxSLAMsmtThresholdDelayMaximum, pvxESrvcCrntPMESrvcNameIdx=pvxESrvcCrntPMESrvcNameIdx, pvxESrvcCrntPMUASValidity=pvxESrvcCrntPMUASValidity, pvxEServiceSlaHistPM2WayDelayVariationMaximumValidity=pvxEServiceSlaHistPM2WayDelayVariationMaximumValidity, pvxERPSSrvcNNIProtectionSwitchChangeEvent=pvxERPSSrvcNNIProtectionSwitchChangeEvent, pvxERPSSrvcNumRingPorts=pvxERPSSrvcNumRingPorts, pvxERPSPortHistPMMsPduTxValue=pvxERPSPortHistPMMsPduTxValue, pvxSwitchTunnMacAddrProfile=pvxSwitchTunnMacAddrProfile, pvxERPSPortCrntPMBlockedInitialize=pvxERPSPortCrntPMBlockedInitialize, pvxESrvcBWPrflCrntPMOctetsVltValue=pvxESrvcBWPrflCrntPMOctetsVltValue, pvxERPSPortHistPMSfPduRxValidity=pvxERPSPortHistPMSfPduRxValidity, pvxY1731LbStatsLbmOut=pvxY1731LbStatsLbmOut, pvxMSTPPortDesignatedBridge=pvxMSTPPortDesignatedBridge, pvxEcfmMepDbSwitchIdx=pvxEcfmMepDbSwitchIdx, pvxESrvcBWPrflCrntPMOctetsVltInitialize=pvxESrvcBWPrflCrntPMOctetsVltInitialize, pvxVlanPortIdx=pvxVlanPortIdx, pvxServiceUNIEntry=pvxServiceUNIEntry, pvxEcfmLtrReceiveOrder=pvxEcfmLtrReceiveOrder, pvxERPSPortCrntPMSwitchIdx=pvxERPSPortCrntPMSwitchIdx, pvxSrvcNNIIngressBW=pvxSrvcNNIIngressBW, pvxY1731LbStatsLbrTimeMin=pvxY1731LbStatsLbrTimeMin, pvxSLAThroughputTestSrvcPolicyName=pvxSLAThroughputTestSrvcPolicyName, pvxERPSSrvcRingSemStateChangeEvent=pvxERPSSrvcRingSemStateChangeEvent, pvxMSTPXstBrdgRegRootCost=pvxMSTPXstBrdgRegRootCost, pvxMSTPPortHistPMBPDUTCNTXTimeStamp=pvxMSTPPortHistPMBPDUTCNTXTimeStamp, pvxESrvcBWPrflCrntPMEntry=pvxESrvcBWPrflCrntPMEntry, pvxERPSPortHistPMBlockedTimeStamp=pvxERPSPortHistPMBlockedTimeStamp, pvxClassMapProfileRowStatus=pvxClassMapProfileRowStatus, pvxERPSPortHistPMEventPduRxTimeStamp=pvxERPSPortHistPMEventPduRxTimeStamp, pvxESrvcBWPrflPMThresholdBDWUtlzValue=pvxESrvcBWPrflPMThresholdBDWUtlzValue, pvxPolicyMapPolicyName=pvxPolicyMapPolicyName, pvxMSTPPortHistPMINVBPDUTCNRXTimeStamp=pvxMSTPPortHistPMINVBPDUTCNRXTimeStamp, pvxSLAMsmtInitiatorDBRMepId=pvxSLAMsmtInitiatorDBRMepId, pvxSLAThroughputTestRMepId=pvxSLAThroughputTestRMepId, pvxLGRowStatus=pvxLGRowStatus, pvxStaticUnicastTable=pvxStaticUnicastTable, pvxSLAMsmtInitiatorDBCmdState=pvxSLAMsmtInitiatorDBCmdState, pvxTunnelMacAddrProfileEntry=pvxTunnelMacAddrProfileEntry, pvxUNISwitchId=pvxUNISwitchId, pvxESrvcHistPMUASTimeStamp=pvxESrvcHistPMUASTimeStamp, pvxERPSPortHistPMNrrbPduRxValidity=pvxERPSPortHistPMNrrbPduRxValidity, pvxMSTPGenCistPriority=pvxMSTPGenCistPriority, pvxSwitchMasterNode=pvxSwitchMasterNode, pvxMSTPXstIdx=pvxMSTPXstIdx, pvxSwitchClearDynamicFDBEntries=pvxSwitchClearDynamicFDBEntries, pvxEthSrvcExceedMaxUNI=pvxEthSrvcExceedMaxUNI, pvxMSTPHistPMIntervalIdx=pvxMSTPHistPMIntervalIdx, pvxCPWeight=pvxCPWeight, pvxEcfmMepDbMacAddress=pvxEcfmMepDbMacAddress, pvxFDBRowStatus=pvxFDBRowStatus, pvxUNIMaxFrameSize=pvxUNIMaxFrameSize, pvxLAGPortHistPMIntervalIdx=pvxLAGPortHistPMIntervalIdx, pvxESrvcBWPrflHistPMOctetsCnfExcTimeStamp=pvxESrvcBWPrflHistPMOctetsCnfExcTimeStamp, pvxMSTPXstPortTable=pvxMSTPXstPortTable, pvxERPSPortCrntPMMsPduRxTimeStamp=pvxERPSPortCrntPMMsPduRxTimeStamp, pvxMSTPPortHistPMFWDTRValidity=pvxMSTPPortHistPMFWDTRValidity, pvxMepListESrvcVlanId=pvxMepListESrvcVlanId, pvxERPSPortHistPMVersionDiscardValue=pvxERPSPortHistPMVersionDiscardValue, pvxEServiceSlaHistPMFarEndFrameLoss=pvxEServiceSlaHistPMFarEndFrameLoss, pvxSLAThroughputTestCirRateTestResult=pvxSLAThroughputTestCirRateTestResult, pvxSrvcUNIPortId=pvxSrvcUNIPortId, pvxERPSPortHistPMEntry=pvxERPSPortHistPMEntry, pvxEServiceSlaCrntPMNearEndFrameLossInitialize=pvxEServiceSlaCrntPMNearEndFrameLossInitialize, pvxEcfmMipSlotId=pvxEcfmMipSlotId, pvxVlanCurrentEntry=pvxVlanCurrentEntry, pvxClassMapL4SrcPortFilter=pvxClassMapL4SrcPortFilter, pvxMSTPXstPortTypeIdx=pvxMSTPXstPortTypeIdx, pvxSvidXlateSlotId=pvxSvidXlateSlotId, pvxSchedProfWeightQ7=pvxSchedProfWeightQ7, pvxLAGPortCrntPMLACPDUTXTimeStamp=pvxLAGPortCrntPMLACPDUTXTimeStamp, pvxMSTPPortSlotIdx=pvxMSTPPortSlotIdx, pvxERPSPortCrntPMFsPduTxValidity=pvxERPSPortCrntPMFsPduTxValidity, pvxBandwidthProfileTable=pvxBandwidthProfileTable, pvxEServiceSlaCrntPMPortIdx=pvxEServiceSlaCrntPMPortIdx, pvxPCPEncPriority1=pvxPCPEncPriority1, pvxMSTPMapVlanS4k=pvxMSTPMapVlanS4k, pvxVlanCurrentStatus=pvxVlanCurrentStatus, pvxERPSPortCrntPMSfPduTxInitialize=pvxERPSPortCrntPMSfPduTxInitialize, pvxMSTPMapVlanS1k=pvxMSTPMapVlanS1k, pvxSlaMeasurementTcaEvt=pvxSlaMeasurementTcaEvt, pvxERPSPortCrntPMRecoveriesTimeStamp=pvxERPSPortCrntPMRecoveriesTimeStamp, pvxSLAThroughputTestFrameSize6FarEndThroughput=pvxSLAThroughputTestFrameSize6FarEndThroughput, pvxFloActSVlanAction=pvxFloActSVlanAction, pvxEServiceSlaCrntPMNearEndFrameLoss=pvxEServiceSlaCrntPMNearEndFrameLoss, pvxSwitchIdx=pvxSwitchIdx, pvxNNISlotId=pvxNNISlotId, pvxMSTPPortCrntPMFWDTRValidity=pvxMSTPPortCrntPMFWDTRValidity, pvxDscpPHBProfileTable=pvxDscpPHBProfileTable, pvxESrvcBWPrflCrntPMBDWUtlzValidity=pvxESrvcBWPrflCrntPMBDWUtlzValidity, pvxMSTPGenEntry=pvxMSTPGenEntry, pvxMSTPPortShelfIdx=pvxMSTPPortShelfIdx, pvxDscpAssuredFwd2y=pvxDscpAssuredFwd2y, pvxERPSPortHistPMPduDiscardValidity=pvxERPSPortHistPMPduDiscardValidity, pvxStaticMCMACAddrIdx=pvxStaticMCMACAddrIdx, pvxFloActMirrorType=pvxFloActMirrorType, pvxSchedProfMinBwQ1=pvxSchedProfMinBwQ1, pvxControlFrameProfileName=pvxControlFrameProfileName, pvxCoSProfileTable=pvxCoSProfileTable, pvxPolicyMapProfileEntry=pvxPolicyMapProfileEntry, pvxMSTPPortCrntPMPMCInitialize=pvxMSTPPortCrntPMPMCInitialize, pvxEServiceSlaCrntPM2WayDelayAverageValidity=pvxEServiceSlaCrntPM2WayDelayAverageValidity, pvxLagGroupEntry=pvxLagGroupEntry, pvxMSTPPortDesignatedPort=pvxMSTPPortDesignatedPort, pvxMSTPPortHistPMINVBPDUCFGRXValidity=pvxMSTPPortHistPMINVBPDUCFGRXValidity, pvxERPSPortHistPMRecoveriesValidity=pvxERPSPortHistPMRecoveriesValidity, pvxMSTPCrntPMXstIdx=pvxMSTPCrntPMXstIdx, pvxERPSPortHistPMUnblockedTimeStamp=pvxERPSPortHistPMUnblockedTimeStamp, pvxERPSPortCrntPMNrPduRxValidity=pvxERPSPortCrntPMNrPduRxValidity, pvxEServiceSlaHistPM2WayDelayAverage=pvxEServiceSlaHistPM2WayDelayAverage, pvxFlowMeterProfileEntry=pvxFlowMeterProfileEntry)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxLGIdx=pvxLGIdx, pvxLGMacAddress=pvxLGMacAddress, pvxMSTPPortHistPMPMCValue=pvxMSTPPortHistPMPMCValue, pvxMSTPXstPortInstIdx=pvxMSTPXstPortInstIdx, pvxBWMeterMode=pvxBWMeterMode, pvxEServiceSlaCrntPMIntervalTypeIdx=pvxEServiceSlaCrntPMIntervalTypeIdx, pvxEcfmMipESrvcName=pvxEcfmMipESrvcName, pvxMSTPPortCrntPMBPDUCFGRXInitialize=pvxMSTPPortCrntPMBPDUCFGRXInitialize, pvxPCPEncPriority0=pvxPCPEncPriority0, pvxMSTPPortSwitchIdx=pvxMSTPPortSwitchIdx, pvxEcfmLtrTerminalMep=pvxEcfmLtrTerminalMep, pvxERPSPortHistPMNrrbPduTxTimeStamp=pvxERPSPortHistPMNrrbPduTxTimeStamp, pvxEServiceSlaHistPMIntervalTypeIdx=pvxEServiceSlaHistPMIntervalTypeIdx, pvxSrvcNNISwitchId=pvxSrvcNNISwitchId, pvxMSTPPortCrntPMINVBPDUCFGRXValidity=pvxMSTPPortCrntPMINVBPDUCFGRXValidity, pvxERPSServiceNNITable=pvxERPSServiceNNITable, pvxVLANIdx=pvxVLANIdx, pvxPCPEncPriority6DE=pvxPCPEncPriority6DE, pvxMSTPXstBrdgPriority=pvxMSTPXstBrdgPriority, pvxSrvcUNISwitchId=pvxSrvcUNISwitchId, pvxERPSPortHistPMIntervalIdx=pvxERPSPortHistPMIntervalIdx, pvxDscpPHBProfileRowStatus=pvxDscpPHBProfileRowStatus, pvxERPSPortHistPMNrPduRxValidity=pvxERPSPortHistPMNrPduRxValidity, pvxERPSPortHistPMMsPduRxValue=pvxERPSPortHistPMMsPduRxValue, pvxVlanCurrentTimeMark=pvxVlanCurrentTimeMark, pvxDscpClassSelector3=pvxDscpClassSelector3, pvxLAGPortHistPMMRKPDUTXValidity=pvxLAGPortHistPMMRKPDUTXValidity, pvxERPSPortCrntPMNrrbPduRxInitialize=pvxERPSPortCrntPMNrrbPduRxInitialize, pvxSwitchMemberStackingPortCommState=pvxSwitchMemberStackingPortCommState, pvxFloClEtherTypeFilter=pvxFloClEtherTypeFilter, pvxSwitchErpsVlanPropagate=pvxSwitchErpsVlanPropagate, pvxLAGPortCrntPMMRKPDURXValue=pvxLAGPortCrntPMMRKPDURXValue, pvxEcfmMepLbrOut=pvxEcfmMepLbrOut, pvxLGDistribution=pvxLGDistribution, pvxMSTPPortCrntPMFWDTRValue=pvxMSTPPortCrntPMFWDTRValue, pvxTMAPStpTunnMacAddr=pvxTMAPStpTunnMacAddr, pvxESrvcBWPrflCrntPMIntervalTypeIdx=pvxESrvcBWPrflCrntPMIntervalTypeIdx, pvxEcfmMepSwitchIdx=pvxEcfmMepSwitchIdx, pvxERPSPortHistPMPduDiscardInitialize=pvxERPSPortHistPMPduDiscardInitialize, pvxEServiceSlaHistPM2WayDelayVariationMaximumInitialize=pvxEServiceSlaHistPM2WayDelayVariationMaximumInitialize, pvxMSTPPortForcedPortState=pvxMSTPPortForcedPortState, pvxEthSrvcNumUNIs=pvxEthSrvcNumUNIs, pvxMSTPPortCrntPMBPDUCFGTXInitialize=pvxMSTPPortCrntPMBPDUCFGTXInitialize, pvxPriority5TrafficClass=pvxPriority5TrafficClass, pvxPCVRTXlateOperStatus=pvxPCVRTXlateOperStatus, pvxMSTPPortCrntPMShelfIdx=pvxMSTPPortCrntPMShelfIdx, pvxMSTPPortCrntPMINVBPDUTCNRXValue=pvxMSTPPortCrntPMINVBPDUTCNRXValue, pvxERPSPortHistPMNrrbPduRxValue=pvxERPSPortHistPMNrrbPduRxValue, pvxERPSSrvcNNIPortId=pvxERPSSrvcNNIPortId, pvxLAGPortHistPMTypeIdx=pvxLAGPortHistPMTypeIdx, pvxSchedulerProfileEntry=pvxSchedulerProfileEntry, pvxFMPBWProfileId=pvxFMPBWProfileId, pvxESrvcBWPrflCrntPMESrvcNameIdx=pvxESrvcBWPrflCrntPMESrvcNameIdx, pvxBWProfileTable=pvxBWProfileTable, mstpRoleChangeEvt=mstpRoleChangeEvt, pvxMSTPPortHistPMIntervalIdx=pvxMSTPPortHistPMIntervalIdx, pvxMSTPPortCrntPMBPDURXTimeStamp=pvxMSTPPortCrntPMBPDURXTimeStamp, pvxPriority0TrafficClass=pvxPriority0TrafficClass, pvxMSTPPortRegRootCost=pvxMSTPPortRegRootCost, pvxPriorityTCMapName=pvxPriorityTCMapName, pvxStaticUnicastReceivePort=pvxStaticUnicastReceivePort, pvxESrvcBWPrflCrntPMPortIdx=pvxESrvcBWPrflCrntPMPortIdx, pvxESrvcBWPrflHistPMOctetsTotalInitialize=pvxESrvcBWPrflHistPMOctetsTotalInitialize, pvxERPSSrvcMultipleFailure=pvxERPSSrvcMultipleFailure, pvxClassMapIpProtocolFilter=pvxClassMapIpProtocolFilter, pvxEServiceSlaCrntPM2WayDelayVariationAverageTimeStamp=pvxEServiceSlaCrntPM2WayDelayVariationAverageTimeStamp, pvxMSTPCrntPMTCCValue=pvxMSTPCrntPMTCCValue, pvxERPSPortCrntPMEventPduRxInitialize=pvxERPSPortCrntPMEventPduRxInitialize, pvxMSTPXstRootPortNum=pvxMSTPXstRootPortNum, pvxMSTPPortHistPMFWDTRTimeStamp=pvxMSTPPortHistPMFWDTRTimeStamp, pvxEcfmMepIdentifier=pvxEcfmMepIdentifier, pvxERPSSrvcPeriodicTimer=pvxERPSSrvcPeriodicTimer, pvxEServiceSlaCrntPMSwitchIdx=pvxEServiceSlaCrntPMSwitchIdx, pvxMepListSwitchIdx=pvxMepListSwitchIdx, pvxLAGPortHistPMLACPDUTXTimeStamp=pvxLAGPortHistPMLACPDUTXTimeStamp, pvxPCPDecPriority1=pvxPCPDecPriority1, pvxTMAPRowStatus=pvxTMAPRowStatus, pvxESrvcOperStateChangeEvt=pvxESrvcOperStateChangeEvt, pvxControlFrameProfileTable=pvxControlFrameProfileTable, pvxLAGPortCrntPMMRKPDURXTimeStamp=pvxLAGPortCrntPMMRKPDURXTimeStamp, pvxMSTPPortCrntPMFWDTRTimeStamp=pvxMSTPPortCrntPMFWDTRTimeStamp, pvxPCPEncPriority6=pvxPCPEncPriority6, pvxBWExceedActionSetDEI=pvxBWExceedActionSetDEI, pvxEcfmLtrTtl=pvxEcfmLtrTtl, pvxEServiceSlaCrntPM2WayDelayVariationAverageValidity=pvxEServiceSlaCrntPM2WayDelayVariationAverageValidity, pvxESrvcHistPMIntervalTypeIdx=pvxESrvcHistPMIntervalTypeIdx, pvxERPSPortHistPMFsPduRxTimeStamp=pvxERPSPortHistPMFsPduRxTimeStamp, pvxClassMapDstMACMaskFilter=pvxClassMapDstMACMaskFilter, pvxPriority1TrafficClass=pvxPriority1TrafficClass, pvxLagPortActAdminState=pvxLagPortActAdminState, pvxPCPEncPriority5=pvxPCPEncPriority5, pvxEServiceSlaHistPM2WayDelayVariationMinimumInitialize=pvxEServiceSlaHistPM2WayDelayVariationMinimumInitialize, pvxBWCnfrmActionChangeTOSFrmPri=pvxBWCnfrmActionChangeTOSFrmPri, pvxCoSProfileEntry=pvxCoSProfileEntry, pvxERPSSrvcNNIRingPortId=pvxERPSSrvcNNIRingPortId, pvxFloActCVlanValue=pvxFloActCVlanValue, pvxEServiceSlaHistPMFarEndFrameLossValidity=pvxEServiceSlaHistPMFarEndFrameLossValidity, pvxLGPortList=pvxLGPortList, pvxEServiceSlaCrntPMFarEndFrameLoss=pvxEServiceSlaCrntPMFarEndFrameLoss, pvxMSTPPortLoopGuardState=pvxMSTPPortLoopGuardState, mstpTopologyChangeEvt=mstpTopologyChangeEvt, resourceUnavailableCond=resourceUnavailableCond, pvxLAGPortHistPMMRKPDURXInitialize=pvxLAGPortHistPMMRKPDURXInitialize, pvxMSTPPortCrntPMBPDUTXValue=pvxMSTPPortCrntPMBPDUTXValue, pvxLagSwitchIdx=pvxLagSwitchIdx, pvxLAGPortCrntPMINVLACFRRXTimeStamp=pvxLAGPortCrntPMINVLACFRRXTimeStamp, pvxESrvcHistPMTable=pvxESrvcHistPMTable, pvxSLAMsmtResponderDBTable=pvxSLAMsmtResponderDBTable, pvxSwitchMIPAutoCreate=pvxSwitchMIPAutoCreate, pvxMSTPHistPMRCCCInitialize=pvxMSTPHistPMRCCCInitialize, pvxMSTPPortCrntPMBPDUCFGTXValidity=pvxMSTPPortCrntPMBPDUCFGTXValidity, pvxEcfmMepLbrIn=pvxEcfmMepLbrIn, pvxTMAPName=pvxTMAPName, pvxEcfmMepPortId=pvxEcfmMepPortId, pvxLAGPortHistPMINVLACFRRXValidity=pvxLAGPortHistPMINVLACFRRXValidity, pvxESrvcCrntPMEntry=pvxESrvcCrntPMEntry, pvxESrvcBWPrflPMThresholdEntry=pvxESrvcBWPrflPMThresholdEntry, pvxERPSPortCrntPMSfPduRxInitialize=pvxERPSPortCrntPMSfPduRxInitialize, pvxEthSrvcLockNNIs=pvxEthSrvcLockNNIs, pvxERPSPortHistPMBlockedInitialize=pvxERPSPortHistPMBlockedInitialize, pvxLAGPortCrntPMEntry=pvxLAGPortCrntPMEntry, pvxMSTPMapIdx=pvxMSTPMapIdx, pvxEcfmMepTransmitLtmSeqNumber=pvxEcfmMepTransmitLtmSeqNumber, pvxVLANRowStatus=pvxVLANRowStatus, pvxMSTPPortCrntPMINVBPDURXInitialize=pvxMSTPPortCrntPMINVBPDURXInitialize, pvxEcfmLtrSeqNumber=pvxEcfmLtrSeqNumber, pvxERPSPortCrntPMPduTxInitialize=pvxERPSPortCrntPMPduTxInitialize, pvxStaticMulticastTable=pvxStaticMulticastTable, pvxERPSPortCrntPMNrrbPduRxValue=pvxERPSPortCrntPMNrrbPduRxValue, pvxSwitchIntfBouncingTimerPeriod=pvxSwitchIntfBouncingTimerPeriod, pvxMSTPXstTable=pvxMSTPXstTable, pvxMSTPXstPortSlotIdx=pvxMSTPXstPortSlotIdx, pvxESrvcBWPrflHistPMPlcyNameIdx=pvxESrvcBWPrflHistPMPlcyNameIdx, pvxMSTPPortHistPMINVBPDURXTimeStamp=pvxMSTPPortHistPMINVBPDURXTimeStamp, pvxERPSPortCrntPMFsPduTxInitialize=pvxERPSPortCrntPMFsPduTxInitialize, pvxESrvcBWPrflCrntPMOctetsCnfExcInitialize=pvxESrvcBWPrflCrntPMOctetsCnfExcInitialize, pvxESrvcCrntPMUASTimeStamp=pvxESrvcCrntPMUASTimeStamp, pvxMSTPPortHistPMBPDUCFGTXInitialize=pvxMSTPPortHistPMBPDUCFGTXInitialize, pvxVLANTable=pvxVLANTable, pvxClassMapDscpFilter=pvxClassMapDscpFilter, pvxMSTPPortTable=pvxMSTPPortTable, pvxFloActChangePriority=pvxFloActChangePriority, pvxSwitchMemberShelfId=pvxSwitchMemberShelfId, pvxDynamicVlanPortEntry=pvxDynamicVlanPortEntry, pvxERPSPortHistPMFsPduTxTimeStamp=pvxERPSPortHistPMFsPduTxTimeStamp, pvxMSTPHistPMNRBCValue=pvxMSTPHistPMNRBCValue, PvxQoSColorMode=PvxQoSColorMode, pvxERPSPortCrntPMFsPduTxValue=pvxERPSPortCrntPMFsPduTxValue, pvxSchedProfMaxBwQ5=pvxSchedProfMaxBwQ5, pvxLAGPortCrntPMINVLACFRRXInitialize=pvxLAGPortCrntPMINVLACFRRXInitialize, pvxMSTPPortHistPMBPDUCFGTXValue=pvxMSTPPortHistPMBPDUCFGTXValue, pvxERPSPortCrntPMNrPduTxValue=pvxERPSPortCrntPMNrPduTxValue, pvxESrvcBWPrflCrntPMSlotIdx=pvxESrvcBWPrflCrntPMSlotIdx, pvxESrvcBWPrflPMThresholdShelfIdx=pvxESrvcBWPrflPMThresholdShelfIdx, pvxControlFrameProfileDot1x=pvxControlFrameProfileDot1x, pvxLagPortTable=pvxLagPortTable, pvxMultiCastGroupTable=pvxMultiCastGroupTable, pvxERPSPortHistPMPduDiscardTimeStamp=pvxERPSPortHistPMPduDiscardTimeStamp, pvxMSTPPortHistPMSlotIdx=pvxMSTPPortHistPMSlotIdx, pvxMSTPMapEntry=pvxMSTPMapEntry, pvxERPSPortCrntPMFsPduRxInitialize=pvxERPSPortCrntPMFsPduRxInitialize, pvxLagPortMode=pvxLagPortMode, pvxERPSPortHistPMEventPduTxValidity=pvxERPSPortHistPMEventPduTxValidity, pvxERPSPortCrntPMPduRxTimeStamp=pvxERPSPortCrntPMPduRxTimeStamp, pvxSrvcUNIEgressBWperCos=pvxSrvcUNIEgressBWperCos, pvxMSTPPortCrntPMINVBPDURXValidity=pvxMSTPPortCrntPMINVBPDURXValidity, pvxLagSystemIdentifier=pvxLagSystemIdentifier, pvxLagGroupTable=pvxLagGroupTable, pvxEServiceSlaHistPM2WayDelayAverageInitialize=pvxEServiceSlaHistPM2WayDelayAverageInitialize, pvxVLANMacLearning=pvxVLANMacLearning, pvxERPSPortHistPMMsPduTxTimeStamp=pvxERPSPortHistPMMsPduTxTimeStamp, pvxLagEntry=pvxLagEntry, pvxEcfmMipTable=pvxEcfmMipTable, pvxPriorityTCMapTable=pvxPriorityTCMapTable, pvxSLAMsmtInitiatorDBPortIdx=pvxSLAMsmtInitiatorDBPortIdx, pvxMSTPPortHistPMBPDUTCNRXValidity=pvxMSTPPortHistPMBPDUTCNRXValidity, pvxEcfmMipPortId=pvxEcfmMipPortId, pvxLGMtuSize=pvxLGMtuSize, pvxEServiceSlaCrntPM2WayDelayAverage=pvxEServiceSlaCrntPM2WayDelayAverage, pvxLAGPortCrntPMINVLACFRRXValidity=pvxLAGPortCrntPMINVLACFRRXValidity, pvxNNITable=pvxNNITable, pvxClassMapProfileName=pvxClassMapProfileName, pvxERPSPortCrntPMEventPduTxValidity=pvxERPSPortCrntPMEventPduTxValidity, pvxERPSSrvcCompatibleVersion=pvxERPSSrvcCompatibleVersion, pvxEcfmLtrEgressAction=pvxEcfmLtrEgressAction, PvxStackingPortCommState=PvxStackingPortCommState, pvxLAGPortHistPMMRKRSPPDURXInitialize=pvxLAGPortHistPMMRKRSPPDURXInitialize, pvxESrvcCrntPMIntervalTypeIdx=pvxESrvcCrntPMIntervalTypeIdx, pvxLagSystemPriority=pvxLagSystemPriority, pvxFSOutOfProfilePackets=pvxFSOutOfProfilePackets, pvxEServiceSlaCrntPMShelfIdx=pvxEServiceSlaCrntPMShelfIdx, pvxFloActRedAction=pvxFloActRedAction, pvxEthSrvcOperState=pvxEthSrvcOperState, pvxMSTPPortCrntPMINVBPDUCFGRXTimeStamp=pvxMSTPPortCrntPMINVBPDUCFGRXTimeStamp, pvxVLANSwitchIdx=pvxVLANSwitchIdx, pvxMSTPHistPMTCCValidity=pvxMSTPHistPMTCCValidity, pvxERPSPortCrntPMFsPduRxValidity=pvxERPSPortCrntPMFsPduRxValidity, pvxERPSPortCrntPMPduDiscardTimeStamp=pvxERPSPortCrntPMPduDiscardTimeStamp, pvxClassMapCVlanEndFilter=pvxClassMapCVlanEndFilter, pvxPriority6TrafficClass=pvxPriority6TrafficClass, pvxSwitchForceSwitch=pvxSwitchForceSwitch, pvxLAGPortHistPMLACPDUTXValidity=pvxLAGPortHistPMLACPDUTXValidity, pvxMSTPCrntPMTCCTimeStamp=pvxMSTPCrntPMTCCTimeStamp, pvxERPSSrvcVirtualLink=pvxERPSSrvcVirtualLink, pvxEthSrvcType=pvxEthSrvcType, pvxSLAThroughputTestResponderOpState=pvxSLAThroughputTestResponderOpState, pvxLAGPortHistPMMRKPDURXTimeStamp=pvxLAGPortHistPMMRKPDURXTimeStamp, pvxMSTPXstRootPortSlot=pvxMSTPXstRootPortSlot, PvxESrvcBWPrflPMThresholdLevelType=PvxESrvcBWPrflPMThresholdLevelType, pvxLAGPortHistPMMRKPDURXValue=pvxLAGPortHistPMMRKPDURXValue, pvxERPSPortCrntPMUnblockedValue=pvxERPSPortCrntPMUnblockedValue, pvxESrvcBWPrflHistPMClsMapNameIdx=pvxESrvcBWPrflHistPMClsMapNameIdx, pvxMSTPPortCrntPMPMCValue=pvxMSTPPortCrntPMPMCValue, pvxVlanPortTable=pvxVlanPortTable, pvxESrvcBWPrflHistPMPortIdx=pvxESrvcBWPrflHistPMPortIdx, pvxESrvcBWPrflPMThresholdSwitchIdx=pvxESrvcBWPrflPMThresholdSwitchIdx, pvxStackingPortEntry=pvxStackingPortEntry, pvxFlowClassificationEntry=pvxFlowClassificationEntry, pvxMSTPPortHistPMShelfIdx=pvxMSTPPortHistPMShelfIdx, pvxERPSSrvcNNINextNeighborPort=pvxERPSSrvcNNINextNeighborPort, pvxSLAMsmtThresholdDelayVarMaximum=pvxSLAMsmtThresholdDelayVarMaximum, pvxBWPEbs=pvxBWPEbs, pvxSwitchMemberTable=pvxSwitchMemberTable, pvxMSTPPortHistPMBPDUTXValue=pvxMSTPPortHistPMBPDUTXValue, pvxPriorityTCMapEntry=pvxPriorityTCMapEntry, pvxEcfmMepDbRMepSwitchName=pvxEcfmMepDbRMepSwitchName, pvxMSTPPortCrntPMFWDTRInitialize=pvxMSTPPortCrntPMFWDTRInitialize, pvxPCVRTCVlanIdTo=pvxPCVRTCVlanIdTo, pvxERPSSrvcWaitToBlockTimer=pvxERPSSrvcWaitToBlockTimer, pvxLAGPortCrntPMTypeIdx=pvxLAGPortCrntPMTypeIdx, pvxClassMapL4SrcPortEndFilter=pvxClassMapL4SrcPortEndFilter, pvxUNISpeed=pvxUNISpeed, pvxEcfmMepTransmitLbmCount=pvxEcfmMepTransmitLbmCount, pvxERPSPortCrntPMSfPduRxValidity=pvxERPSPortCrntPMSfPduRxValidity, pvxMSTPXstPortPathCost=pvxMSTPXstPortPathCost, pvxSLAMsmtThresholdDelayAverage=pvxSLAMsmtThresholdDelayAverage, pvxMCVlanIdx=pvxMCVlanIdx, pvxEServiceSlaHistPM2WayDelayMaximum=pvxEServiceSlaHistPM2WayDelayMaximum, pvxVlanPortRemoveDynamicVlanEvt=pvxVlanPortRemoveDynamicVlanEvt, pvxLAGPortCrntPMTable=pvxLAGPortCrntPMTable, pvxESrvcBWPrflPMThresholdPortIdx=pvxESrvcBWPrflPMThresholdPortIdx, pvxPCVRTRowStatus=pvxPCVRTRowStatus, pvxBWProfileEntry=pvxBWProfileEntry, pvxPCVRTSource=pvxPCVRTSource, pvxFMeterId=pvxFMeterId, pvxLGAdminStatus=pvxLGAdminStatus, pvxLGDataRate=pvxLGDataRate, pvxESrvcBWPrflCrntPMOctetsTotalInitialize=pvxESrvcBWPrflCrntPMOctetsTotalInitialize, pvxMSTPPortHistPMPMCTimeStamp=pvxMSTPPortHistPMPMCTimeStamp, pvxERPSPortHistPMFsPduRxValue=pvxERPSPortHistPMFsPduRxValue, pvxMSTPXstRootPortType=pvxMSTPXstRootPortType, pvxEServiceSlaCrntPM2WayDelayVariationMaximumInitialize=pvxEServiceSlaCrntPM2WayDelayVariationMaximumInitialize, pvxFMPColorAware=pvxFMPColorAware, pvxMepSequenceId=pvxMepSequenceId)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxMSTPXstPortDesigCost=pvxMSTPXstPortDesigCost, pvxESrvcBWPrflHistPMSwitchIdx=pvxESrvcBWPrflHistPMSwitchIdx, mstpProtocolMigrationEvt=mstpProtocolMigrationEvt, pvxSwitchName=pvxSwitchName, pvxFlowStatsTable=pvxFlowStatsTable, pvxMSTPCrntPMNRBCTimeStamp=pvxMSTPCrntPMNRBCTimeStamp, pvxVlanPortLastBpduOriginChangeEvt=pvxVlanPortLastBpduOriginChangeEvt, pvxEServiceSlaHistPMEntry=pvxEServiceSlaHistPMEntry, pvxSLAThroughputTestFrameSize4FarEndThroughput=pvxSLAThroughputTestFrameSize4FarEndThroughput, pvxClassMapSVlanPriFilter=pvxClassMapSVlanPriFilter, pvxERPSPortCrntPMNrPduRxTimeStamp=pvxERPSPortCrntPMNrPduRxTimeStamp, pvxERPSPortHistPMNrPduTxValidity=pvxERPSPortHistPMNrPduTxValidity, pvxLagPortSwitchIdx=pvxLagPortSwitchIdx, pvxMSTPXstPortDesigBridge=pvxMSTPXstPortDesigBridge, pvxMSTPPortHistPMFWDTRInitialize=pvxMSTPPortHistPMFWDTRInitialize, pvxEcfmMepY1731LbmCurrentTransId=pvxEcfmMepY1731LbmCurrentTransId, pvxESrvcBWPrflHistPMOctetsTotalTimeStamp=pvxESrvcBWPrflHistPMOctetsTotalTimeStamp, pvxSrvcUNIEFPSDLocalEFPSDState=pvxSrvcUNIEFPSDLocalEFPSDState, pvxEServiceSlaCrntPM2WayDelayMinimumValidity=pvxEServiceSlaCrntPM2WayDelayMinimumValidity, pvxMSTPPortHistPMINVBPDUCFGRXValue=pvxMSTPPortHistPMINVBPDUCFGRXValue, PvxEcfmEgressActionFieldValue=PvxEcfmEgressActionFieldValue, pvxESrvcCrntPMTable=pvxESrvcCrntPMTable, pvxPCPEncPriority2DE=pvxPCPEncPriority2DE, pvxEServiceSlaCrntPMNearEndFrameLossTimeStamp=pvxEServiceSlaCrntPMNearEndFrameLossTimeStamp, pvxEcfmMipSwitchIdx=pvxEcfmMipSwitchIdx, pvxMSTPHistPMTable=pvxMSTPHistPMTable, pvxESrvcBWPrflCrntPMPortTypeIdx=pvxESrvcBWPrflCrntPMPortTypeIdx, pvxEServiceSlaCrntPM2WayDelayMinimum=pvxEServiceSlaCrntPM2WayDelayMinimum, pvxStaticUnicastRowStatus=pvxStaticUnicastRowStatus, pvxTMAPGmrpTunnMacAddr=pvxTMAPGmrpTunnMacAddr, pvxMSTPHistPMTCCValue=pvxMSTPHistPMTCCValue, pvxEServiceSlaHistPMNearEndFrameLossValidity=pvxEServiceSlaHistPMNearEndFrameLossValidity, pvxERPSPortCrntPMFailuresValidity=pvxERPSPortCrntPMFailuresValidity, pvxFMSwitchIdx=pvxFMSwitchIdx, pvxLAGPortHistPMMRKPDURXValidity=pvxLAGPortHistPMMRKPDURXValidity, pvxERPSPortHistPMUnblockedValidity=pvxERPSPortHistPMUnblockedValidity, pvxSchedulerProfileTable=pvxSchedulerProfileTable, pvxESrvcBWPrflHistPMESrvcNameIdx=pvxESrvcBWPrflHistPMESrvcNameIdx, pvxBWSetInternalPriority=pvxBWSetInternalPriority, pvxControlFrameProfileGmrp=pvxControlFrameProfileGmrp, pvxMSTPGenVersionSupported=pvxMSTPGenVersionSupported, pvxMSTPHistPMNRBCValidity=pvxMSTPHistPMNRBCValidity, pvxFSInProfilePackets=pvxFSInProfilePackets, pvxFSStatsIdx=pvxFSStatsIdx, pvxERPSSrvcFOPProvisionMismatchClear=pvxERPSSrvcFOPProvisionMismatchClear, pvxSLAThroughputTestFrameSize3NearEndThroughput=pvxSLAThroughputTestFrameSize3NearEndThroughput, pvxESrvcBWPrflHistPMBDWUtlzValidity=pvxESrvcBWPrflHistPMBDWUtlzValidity, pvxLAGPortHistPMLACPDURXTimeStamp=pvxLAGPortHistPMLACPDURXTimeStamp, pvxBWPCbs=pvxBWPCbs, pvxFlowStatsEntry=pvxFlowStatsEntry, pvxERPSPortHistPMNrrbPduRxInitialize=pvxERPSPortHistPMNrrbPduRxInitialize, pvxSrvcNNIEgressBW=pvxSrvcNNIEgressBW, pvxEServiceSlaCrntPM2WayDelayVariationMinimumTimeStamp=pvxEServiceSlaCrntPM2WayDelayVariationMinimumTimeStamp, pvxLAGPortHistPMSlotIdx=pvxLAGPortHistPMSlotIdx, pvxERPSPortCrntPMBlockedValue=pvxERPSPortCrntPMBlockedValue, pvxFMBWProfileId=pvxFMBWProfileId, pvxERPSPortHistPMPduTxTimeStamp=pvxERPSPortHistPMPduTxTimeStamp, pvxNextFreeIndexEntry=pvxNextFreeIndexEntry, pvxSwitchMemberIdx=pvxSwitchMemberIdx, pvxERPSPortCrntPMPduRxValue=pvxERPSPortCrntPMPduRxValue, pvxControlFrameProfileGvrp=pvxControlFrameProfileGvrp, pvxERPSPortHistPMFsPduRxInitialize=pvxERPSPortHistPMFsPduRxInitialize, pvxEthServiceTable=pvxEthServiceTable, pvxSrvcUNIServiceMap=pvxSrvcUNIServiceMap, pvxSrvcUNISlotId=pvxSrvcUNISlotId, pvxControlFrameProfileEntry=pvxControlFrameProfileEntry, pvxSvidXlateShelfId=pvxSvidXlateShelfId, pvxESrvcBWPrflCrntPMOctetsTotalValue=pvxESrvcBWPrflCrntPMOctetsTotalValue, pvxFMPStatsEnabled=pvxFMPStatsEnabled, pvxUNICurrentFrameSize=pvxUNICurrentFrameSize, pvxEcfmMepDirection=pvxEcfmMepDirection, pvxY1731LbStatsAvgLbrsPerResponder=pvxY1731LbStatsAvgLbrsPerResponder, pvxVlanPortGvrpAdminState=pvxVlanPortGvrpAdminState, pvxSchedProfWeightQ3=pvxSchedProfWeightQ3, pvxMSTPPortCrntPMPMCTimeStamp=pvxMSTPPortCrntPMPMCTimeStamp, pvxSLAThroughputTestInitiatorCmdState=pvxSLAThroughputTestInitiatorCmdState, pvxMSTPMapSwitchIdx=pvxMSTPMapSwitchIdx, pvxERPSPortHistPMRecoveriesValue=pvxERPSPortHistPMRecoveriesValue, pvxERPSPortCrntPMSfPduRxTimeStamp=pvxERPSPortCrntPMSfPduRxTimeStamp, pvxSchedProfWeightQ2=pvxSchedProfWeightQ2, pvxLAGPortCrntPMLACPDUTXValue=pvxLAGPortCrntPMLACPDUTXValue, pvxStaticMCSwitchIdx=pvxStaticMCSwitchIdx, pvxBWExceedActionChangeDscp=pvxBWExceedActionChangeDscp, pvxESrvcBWPrflHistPMBDWUtlzTimeStamp=pvxESrvcBWPrflHistPMBDWUtlzTimeStamp, pvxMgmtVLANSwitchIdx=pvxMgmtVLANSwitchIdx, pvxESrvcBWPrflHistPMOctetsVltValue=pvxESrvcBWPrflHistPMOctetsVltValue, pvxESrvcBWPrflHistPMBDWUtlzValue=pvxESrvcBWPrflHistPMBDWUtlzValue, pvxEcfmMepEntry=pvxEcfmMepEntry, pvxFloActSwitchIdx=pvxFloActSwitchIdx, pvxMSTPPortRole=pvxMSTPPortRole, pvxControlFrameProfileRowStatus=pvxControlFrameProfileRowStatus, pvxClassMapDstIpNetMaskFilter=pvxClassMapDstIpNetMaskFilter, pvxFloClDestUDPorTCPFilter=pvxFloClDestUDPorTCPFilter, pvxMSTPPortCrntPMTable=pvxMSTPPortCrntPMTable, pvxSLAMsmtInitiatorDBSlotIdx=pvxSLAMsmtInitiatorDBSlotIdx, pvxESrvcBWPrflHistPMOctetsTotalValue=pvxESrvcBWPrflHistPMOctetsTotalValue, pvxMSTPCrntPMTCCInitialize=pvxMSTPCrntPMTCCInitialize, pvxERPSPortCrntPMNrPduRxInitialize=pvxERPSPortCrntPMNrPduRxInitialize, pvxEServiceSlaHistPM2WayDelayVariationMaximumTimeStamp=pvxEServiceSlaHistPM2WayDelayVariationMaximumTimeStamp, pvxSvidXlateInternalSVid=pvxSvidXlateInternalSVid, pvxEServiceSlaCrntPMPortTypeIdx=pvxEServiceSlaCrntPMPortTypeIdx, pvxERPSPortCrntPMPduDiscardValue=pvxERPSPortCrntPMPduDiscardValue, pvxEcfmMipMegLevel=pvxEcfmMipMegLevel, pvxClassMapDstMACAddrFilter=pvxClassMapDstMACAddrFilter, pvxMSTPPortHistPMINVBPDUTCNRXValue=pvxMSTPPortHistPMINVBPDUTCNRXValue, pvxSrvcNNIPortTypeId=pvxSrvcNNIPortTypeId, pvxERPSPortCrntPMPduTxTimeStamp=pvxERPSPortCrntPMPduTxTimeStamp, pvxBWPCir=pvxBWPCir, pvxStaticUnicastIntfIdList=pvxStaticUnicastIntfIdList, pvxERPSPortHistPMNrPduTxInitialize=pvxERPSPortHistPMNrPduTxInitialize, pvxClassMapSVlanFilter=pvxClassMapSVlanFilter, pvxMSTPXstRootPort=pvxMSTPXstRootPort, pvxFDBVlanIdx=pvxFDBVlanIdx, pvxERPSPortCrntPMVersionDiscardInitialize=pvxERPSPortCrntPMVersionDiscardInitialize, packetVxBridgeMib=packetVxBridgeMib, pvxMgmtVLANEntry=pvxMgmtVLANEntry, pvxERPSPortHistPMMsPduTxValidity=pvxERPSPortHistPMMsPduTxValidity, pvxERPSPortCrntPMIntervalTypeIdx=pvxERPSPortCrntPMIntervalTypeIdx, pvxMSTPPortDesignatedRoot=pvxMSTPPortDesignatedRoot, pvxMSTPHistPMSwitchIdx=pvxMSTPHistPMSwitchIdx, pvxERPSSrvcNNIECFMInfo=pvxERPSSrvcNNIECFMInfo, pvxSchedProfMTUQuanta=pvxSchedProfMTUQuanta, pvxERPSPortCrntPMNrPduRxValue=pvxERPSPortCrntPMNrPduRxValue, pvxPCPEncPriority1DE=pvxPCPEncPriority1DE, pvxMSTPMapRowStatus=pvxMSTPMapRowStatus, pvxSrvcUNIIngressBWperCos=pvxSrvcUNIIngressBWperCos, pvxESrvcHistPMESrvcNameIdx=pvxESrvcHistPMESrvcNameIdx, pvxEcfmMepLbrInOutOfOrder=pvxEcfmMepLbrInOutOfOrder, pvxPbCVidRegistrationTableEntry=pvxPbCVidRegistrationTableEntry, pvxEServiceSlaHistPM2WayDelayAverageTimeStamp=pvxEServiceSlaHistPM2WayDelayAverageTimeStamp, pvxServiceNNITable=pvxServiceNNITable, pvxERPSServiceEntry=pvxERPSServiceEntry, pvxEcfmMipRowStatus=pvxEcfmMipRowStatus, pvxFloActYellowCNGAction=pvxFloActYellowCNGAction, pvxFloClSourceIPFilter=pvxFloClSourceIPFilter, pvxStaticMCReceivePort=pvxStaticMCReceivePort, pvxSchedProfMaxBwQ3=pvxSchedProfMaxBwQ3, PvxL2PortList=PvxL2PortList, pvxLAGPortCrntPMIdx=pvxLAGPortCrntPMIdx, pvxNNIShelfId=pvxNNIShelfId, pvxDscpAssuredFwd3y=pvxDscpAssuredFwd3y, pvxMSTPPortHistPMBPDUTCNRXValue=pvxMSTPPortHistPMBPDUTCNRXValue, pvxEcfmMipEntry=pvxEcfmMipEntry, pvxMSTPHistPMNRBCInitialize=pvxMSTPHistPMNRBCInitialize, pvxTMAPGvrpTunnMacAddr=pvxTMAPGvrpTunnMacAddr, pvxBWMeterEbs=pvxBWMeterEbs, pvxStaticMCVlanIdx=pvxStaticMCVlanIdx, pvxEcfmLtrForwarded=pvxEcfmLtrForwarded, pvxEthServiceEntry=pvxEthServiceEntry, pvxESrvcBWPrflCrntPMBDWUtlzInitialize=pvxESrvcBWPrflCrntPMBDWUtlzInitialize, pvxEServiceSlaHistPM2WayDelayMinimum=pvxEServiceSlaHistPM2WayDelayMinimum, pvxDynamicVlanPortTagged=pvxDynamicVlanPortTagged, pvxSrvcUNIIngressBW=pvxSrvcUNIIngressBW, pvxESrvcBWPrflCrntPMBDWUtlzValue=pvxESrvcBWPrflCrntPMBDWUtlzValue, pvxMgmtVLANTable=pvxMgmtVLANTable, pvxY1731LbStatsEntry=pvxY1731LbStatsEntry, pvxVLANOperStatus=pvxVLANOperStatus, pvxEcfmMepAutoGenerateFlag=pvxEcfmMepAutoGenerateFlag, pvxDynamicVlanPortTimeMark=pvxDynamicVlanPortTimeMark, pvxDscpClassSelector6=pvxDscpClassSelector6, pvxMSTPPortCrntPMINVBPDUCFGRXValue=pvxMSTPPortCrntPMINVBPDUCFGRXValue, PvxVLANPortList=PvxVLANPortList, pvxEServiceSlaCrntPM2WayDelayMaximumInitialize=pvxEServiceSlaCrntPM2WayDelayMaximumInitialize, pvxMSTPPortCrntPMBPDUTXInitialize=pvxMSTPPortCrntPMBPDUTXInitialize, pvxEcfmService=pvxEcfmService, pvxPolicyMapClassMapName=pvxPolicyMapClassMapName, pvxSLAThroughputTestFrameSize2=pvxSLAThroughputTestFrameSize2, PvxPhyPortList=PvxPhyPortList, pvxEServiceSlaHistPMFarEndFrameLossTimeStamp=pvxEServiceSlaHistPMFarEndFrameLossTimeStamp, pvxEcfmLtrIngressPortInfo=pvxEcfmLtrIngressPortInfo, pvxNNISwitchId=pvxNNISwitchId, pvxMSTPHistPMRCCCTimeStamp=pvxMSTPHistPMRCCCTimeStamp, pvxESrvcCrntPMUASInitialize=pvxESrvcCrntPMUASInitialize, pvxERPSPortCrntPMMsPduTxTimeStamp=pvxERPSPortCrntPMMsPduTxTimeStamp, pvxMSTPPortHistPMINVBPDUCFGRXInitialize=pvxMSTPPortHistPMINVBPDUCFGRXInitialize, pvxSLAMsmtResponderDBRMepId=pvxSLAMsmtResponderDBRMepId, pvxSchedProfMaxBwQ0=pvxSchedProfMaxBwQ0, pvxERPSSrvcNNIShelfId=pvxERPSSrvcNNIShelfId, pvxPCPDecPriority4=pvxPCPDecPriority4, pvxDscpClassSelector5=pvxDscpClassSelector5, pvxERPSSrvcNNISlotId=pvxERPSSrvcNNISlotId, pvxStaticMCForbiddenIntfIdList=pvxStaticMCForbiddenIntfIdList, pvxVlanPortLastBpduOrigin=pvxVlanPortLastBpduOrigin, pvxEcfmMepOutOfService=pvxEcfmMepOutOfService, pvxERPSSrvcRingMonitoring=pvxERPSSrvcRingMonitoring, pvxEcfmLtrIngressMac=pvxEcfmLtrIngressMac, pvxLagPortPriority=pvxLagPortPriority, pvxNNIPortId=pvxNNIPortId, pvxMSTPHistPMTCCInitialize=pvxMSTPHistPMTCCInitialize, pvxERPSPortHistPMEventPduTxValue=pvxERPSPortHistPMEventPduTxValue, pvxFlowMeterTable=pvxFlowMeterTable, pvxSLAMsmtResponderDBEntry=pvxSLAMsmtResponderDBEntry, pvxPriority4TrafficClass=pvxPriority4TrafficClass, pvxMSTPPortCrntPMTypeIdx=pvxMSTPPortCrntPMTypeIdx, pvxClassMapSrcIpFilter=pvxClassMapSrcIpFilter, pvxPCPDecPriority2=pvxPCPDecPriority2, pvxERPSPortHistPMEventPduTxInitialize=pvxERPSPortHistPMEventPduTxInitialize, pvxERPSPortCrntPMNrrbPduTxValidity=pvxERPSPortCrntPMNrrbPduTxValidity, pvxLAGPortHistPMMRKRSPPDUTXTimeStamp=pvxLAGPortHistPMMRKRSPPDUTXTimeStamp, pvxEcfmMepTable=pvxEcfmMepTable, pvxDscpClassBestEffort=pvxDscpClassBestEffort, pvxEthSrvcMECciInterval=pvxEthSrvcMECciInterval, pvxSrvcUNIEFPSDEnabled=pvxSrvcUNIEFPSDEnabled, pvxEServiceSlaCrntPM2WayDelayMaximum=pvxEServiceSlaCrntPM2WayDelayMaximum, pvxSchedProfMinBwQ4=pvxSchedProfMinBwQ4, pvxPbCVidRegistrationTable=pvxPbCVidRegistrationTable, pvxESrvcBWPrflCrntPMOctetsTotalTimeStamp=pvxESrvcBWPrflCrntPMOctetsTotalTimeStamp, pvxDscpClassSelector4=pvxDscpClassSelector4, pvxMSTPPortHistPMBPDUTCNTXValidity=pvxMSTPPortHistPMBPDUTCNTXValidity, pvxEServiceSlaCrntPM2WayDelayAverageInitialize=pvxEServiceSlaCrntPM2WayDelayAverageInitialize, pvxERPSPortCrntPMMsPduRxInitialize=pvxERPSPortCrntPMMsPduRxInitialize, pvxMSTPGenBrdgId=pvxMSTPGenBrdgId, pvxMSTPPortHistPMINVBPDURXValidity=pvxMSTPPortHistPMINVBPDURXValidity, pvxEthSrvcMaxUNIs=pvxEthSrvcMaxUNIs, pvxMSTPPortHistPMBPDUCFGTXTimeStamp=pvxMSTPPortHistPMBPDUCFGTXTimeStamp, pvxStaticMCAddressType=pvxStaticMCAddressType, pvxERPSPortHistPMSfPduTxValidity=pvxERPSPortHistPMSfPduTxValidity, pvxERPSPortCrntPMNrrbPduTxValue=pvxERPSPortCrntPMNrrbPduTxValue, lagLinkDownClear=lagLinkDownClear, pvxMSTPMapVlanS2k=pvxMSTPMapVlanS2k, pvxLAGPortHistPMMRKPDUTXValue=pvxLAGPortHistPMMRKPDUTXValue, pvxFloActYellowAction=pvxFloActYellowAction, pvxLagPortWaitTime=pvxLagPortWaitTime, pvxSrvcUNISrvcName=pvxSrvcUNISrvcName, pvxERPSPortHistPMIntervalTypeIdx=pvxERPSPortHistPMIntervalTypeIdx, pvxEcfmMepDbRMepCcmDefect=pvxEcfmMepDbRMepCcmDefect, pvxSrvcUNIEgressBW=pvxSrvcUNIEgressBW, pvxERPSSrvcNNINeighborPort=pvxERPSSrvcNNINeighborPort, pvxERPSPortCrntPMShelfIdx=pvxERPSPortCrntPMShelfIdx, pvxFloActSVlanValue=pvxFloActSVlanValue, pvxEcfmMepDbEntry=pvxEcfmMepDbEntry, pvxMSTPPortCrntPMBPDUTXValidity=pvxMSTPPortCrntPMBPDUTXValidity, pvxLAGPortCrntPMMRKRSPPDUTXInitialize=pvxLAGPortCrntPMMRKRSPPDUTXInitialize, pvxSLAMsmtThresholdFarEndLossRatio=pvxSLAMsmtThresholdFarEndLossRatio, pvxERPSPortHistPMFailuresValue=pvxERPSPortHistPMFailuresValue, pvxESrvcBWPrflCrntPMOctetsCnfExcValidity=pvxESrvcBWPrflCrntPMOctetsCnfExcValidity, pvxFloClDestIPFilter=pvxFloClDestIPFilter, pvxFSwitchIdx=pvxFSwitchIdx, pvxERPSPortHistPMNrrbPduRxTimeStamp=pvxERPSPortHistPMNrrbPduRxTimeStamp, pvxMepListEntry=pvxMepListEntry, pvxFDBAddressType=pvxFDBAddressType, pvxPCPEncPriority2=pvxPCPEncPriority2, pvxVlanPortAddDynamicVlanEvt=pvxVlanPortAddDynamicVlanEvt, pvxERPSPortHistPMFsPduTxInitialize=pvxERPSPortHistPMFsPduTxInitialize, mstpPacketErrValue=mstpPacketErrValue, pvxMSTPPortHistPMINVBPDURXValue=pvxMSTPPortHistPMINVBPDURXValue, pvxEcfmMepDbRemoteMepId=pvxEcfmMepDbRemoteMepId, pvxERPSPortCrntPMVersionDiscardValue=pvxERPSPortCrntPMVersionDiscardValue, pvxLAGPortCrntPMIntervalTypeIdx=pvxLAGPortCrntPMIntervalTypeIdx, pvxFloActNewPriority=pvxFloActNewPriority, PvxL2Port=PvxL2Port, pvxLAGPortCrntPMMRKRSPPDUTXValue=pvxLAGPortCrntPMMRKRSPPDUTXValue, PvxPCPDecodingList=PvxPCPDecodingList, pvxMSTPCrntPMTable=pvxMSTPCrntPMTable)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxERPSPortCrntPMFsPduRxTimeStamp=pvxERPSPortCrntPMFsPduRxTimeStamp, pvxSLAMsmtResponderDBSwitchIdx=pvxSLAMsmtResponderDBSwitchIdx, pvxERPSPortHistPMRecoveriesTimeStamp=pvxERPSPortHistPMRecoveriesTimeStamp, pvxLagPortLcapId=pvxLagPortLcapId, pvxERPSPortHistPMPduRxInitialize=pvxERPSPortHistPMPduRxInitialize, pvxERPSPortCrntPMPduTxValue=pvxERPSPortCrntPMPduTxValue, pvxERPSPortCrntPMNrrbPduTxInitialize=pvxERPSPortCrntPMNrrbPduTxInitialize, pvxMSTPPortHistPMBPDUCFGRXTimeStamp=pvxMSTPPortHistPMBPDUCFGRXTimeStamp, PvxPolicyDropAction=PvxPolicyDropAction, pvxSLAThroughputTestPortTypeIdx=pvxSLAThroughputTestPortTypeIdx, pvxERPSSrvcSubRingWithoutVC=pvxERPSSrvcSubRingWithoutVC, pvxY1731LbStatsTotalResponders=pvxY1731LbStatsTotalResponders, pvxSLAThroughputTestEntry=pvxSLAThroughputTestEntry, pvxERPSPortHistPMVersionDiscardInitialize=pvxERPSPortHistPMVersionDiscardInitialize, pvxEServiceSlaHistPM2WayDelayVariationMinimumTimeStamp=pvxEServiceSlaHistPM2WayDelayVariationMinimumTimeStamp, pvxERPSPortCrntPMEntry=pvxERPSPortCrntPMEntry, pvxERPSPortHistPMNrrbPduTxValidity=pvxERPSPortHistPMNrrbPduTxValidity, pvxSrvcUNIShelfId=pvxSrvcUNIShelfId, pvxEcfmMepDbRMepState=pvxEcfmMepDbRMepState, pvxFloActMirrorToInterfaceIndex=pvxFloActMirrorToInterfaceIndex, pvxMSTPPortHistPMBPDUCFGTXValidity=pvxMSTPPortHistPMBPDUCFGTXValidity, pvxERPSSrvcConfigFailEvent=pvxERPSSrvcConfigFailEvent, pvxMSTPHistPMRCCCValidity=pvxMSTPHistPMRCCCValidity, pvxMSTPPortHistPMBPDUTCNTXValue=pvxMSTPPortHistPMBPDUTCNTXValue, pvxLAGPortCrntPMMRKPDURXInitialize=pvxLAGPortCrntPMMRKPDURXInitialize, pvxLagPortEntry=pvxLagPortEntry, pvxMSTPPortHistPMBPDURXValue=pvxMSTPPortHistPMBPDURXValue, pvxSrvcUNINumCVids=pvxSrvcUNINumCVids, pvxERPSPortCrntPMFsPduTxTimeStamp=pvxERPSPortCrntPMFsPduTxTimeStamp, pvxStaticUnicastSwitchIdx=pvxStaticUnicastSwitchIdx, pvxMSTPXstPortShelfIdx=pvxMSTPXstPortShelfIdx, pvxSLAThroughputTestFrameSize5FarEndThroughput=pvxSLAThroughputTestFrameSize5FarEndThroughput, pvxLAGPortCrntPMShelfIdx=pvxLAGPortCrntPMShelfIdx, pvxMSTPPortHistPMXstIdx=pvxMSTPPortHistPMXstIdx, pvxERPSPortHistPMFsPduTxValue=pvxERPSPortHistPMFsPduTxValue, pvxVlanPortLastBpduOriginChangeEvtNotifications=pvxVlanPortLastBpduOriginChangeEvtNotifications, pvxERPSPortCrntPMRecoveriesValue=pvxERPSPortCrntPMRecoveriesValue, pvxMSTPXstBrdgRegRoot=pvxMSTPXstBrdgRegRoot, pvxSLAThroughputTestFrameSize1NearEndThroughput=pvxSLAThroughputTestFrameSize1NearEndThroughput, pvxClassMapProfileEntry=pvxClassMapProfileEntry, pvxMSTPCrntPMNRBCValidity=pvxMSTPCrntPMNRBCValidity, pvxEServiceSlaHistPM2WayDelayMinimumTimeStamp=pvxEServiceSlaHistPM2WayDelayMinimumTimeStamp, pvxERPSPortCrntPMEventPduRxValidity=pvxERPSPortCrntPMEventPduRxValidity, pvxSchedProfMaxBwQ4=pvxSchedProfMaxBwQ4, pvxSchedProfWeightQ4=pvxSchedProfWeightQ4, pvxERPSSrvcNNISwitchId=pvxERPSSrvcNNISwitchId, pvxClassMapCVlanFilter=pvxClassMapCVlanFilter, pvxFSRowStatus=pvxFSRowStatus, pvxPCPDecPriority6=pvxPCPDecPriority6, pvxLAGPortHistPMMRKRSPPDUTXValue=pvxLAGPortHistPMMRKRSPPDUTXValue, pvxBWPEir=pvxBWPEir, pvxFloClIPProtocolFilter=pvxFloClIPProtocolFilter, pvxMSTPCrntPMRCCCTimeStamp=pvxMSTPCrntPMRCCCTimeStamp, pvxUNIPortTypeId=pvxUNIPortTypeId, pvxMCMACAddrIdx=pvxMCMACAddrIdx, pvxSrvcUNIFilterSequence=pvxSrvcUNIFilterSequence, pvxMSTPCrntPMRCCCInitialize=pvxMSTPCrntPMRCCCInitialize, pvxUNIShelfId=pvxUNIShelfId, pvxFloActGreenCNGAction=pvxFloActGreenCNGAction, pvxPCPEncPriority7=pvxPCPEncPriority7, pvxUNIRowStatus=pvxUNIRowStatus, pvxERPSPortHistPMNrPduRxValue=pvxERPSPortHistPMNrPduRxValue, pvxLagPortGroupId=pvxLagPortGroupId, pvxSrvcNNIRowStatus=pvxSrvcNNIRowStatus, pvxSvidXlatePortTypeId=pvxSvidXlatePortTypeId, pvxPCVRTSVlanId=pvxPCVRTSVlanId, pvxEServiceSlaHistPM2WayDelayMaximumTimeStamp=pvxEServiceSlaHistPM2WayDelayMaximumTimeStamp, pvxPCPEncDecSelectRow=pvxPCPEncDecSelectRow, pvxVlanCurrentVlanIdx=pvxVlanCurrentVlanIdx, pvxSLAMeasurementProfileTable=pvxSLAMeasurementProfileTable, pvxSLAMsmtRowStatus=pvxSLAMsmtRowStatus, pvxESrvcBWPrflHistPMOctetsTotalValidity=pvxESrvcBWPrflHistPMOctetsTotalValidity, pvxLGSwitchIdx=pvxLGSwitchIdx, pvxEServiceSlaHistPMNearEndFrameLoss=pvxEServiceSlaHistPMNearEndFrameLoss, pvxPCVRTUntaggedPEP=pvxPCVRTUntaggedPEP, pvxMSTPHistPMIntervalTypeIdx=pvxMSTPHistPMIntervalTypeIdx, pvxMSTPPortCrntPMBPDURXValidity=pvxMSTPPortCrntPMBPDURXValidity, pvxY1731LbStatsLbrTimeAverage=pvxY1731LbStatsLbrTimeAverage, pvxERPSPortCrntPMTable=pvxERPSPortCrntPMTable, pvxERPSPortHistPMEventPduTxTimeStamp=pvxERPSPortHistPMEventPduTxTimeStamp, pvxMSTPPortHistPMINVBPDUTCNRXValidity=pvxMSTPPortHistPMINVBPDUTCNRXValidity, pvxESrvcBWPrflHistPMOctetsVltInitialize=pvxESrvcBWPrflHistPMOctetsVltInitialize, pvxMSTPPortCrntPMBPDUTCNRXInitialize=pvxMSTPPortCrntPMBPDUTCNRXInitialize, pvxSLAMsmtResponderDBShelfIdx=pvxSLAMsmtResponderDBShelfIdx, pvxMSTPPortHistPMINVBPDUTCNRXInitialize=pvxMSTPPortHistPMINVBPDUTCNRXInitialize, pvxMSTPPortCrntPMIntervalTypeIdx=pvxMSTPPortCrntPMIntervalTypeIdx, pvxLAGPortCrntPMMRKRSPPDURXValue=pvxLAGPortCrntPMMRKRSPPDURXValue, pvxPolicyMapProfileRowStatus=pvxPolicyMapProfileRowStatus, pvxSLAThroughputTestClassMapName=pvxSLAThroughputTestClassMapName, pvxMSTPGenSwitchIdx=pvxMSTPGenSwitchIdx, pvxLAGPortCrntPMSlotIdx=pvxLAGPortCrntPMSlotIdx, pvxERPSPortHistPMNrPduTxValue=pvxERPSPortHistPMNrPduTxValue, pvxERPSSrvcNodeType=pvxERPSSrvcNodeType, PvxVlanId=PvxVlanId, pvxEServiceSlaCrntPMFarEndFrameLossInitialize=pvxEServiceSlaCrntPMFarEndFrameLossInitialize, pvxESrvcBWPrflCrntPMOctetsTotalValidity=pvxESrvcBWPrflCrntPMOctetsTotalValidity, pvxMSTPPortHistPMBPDUTCNRXTimeStamp=pvxMSTPPortHistPMBPDUTCNRXTimeStamp, pvxNextFreeIndexValue=pvxNextFreeIndexValue, pvxERPSSrvcNNILocalMepId=pvxERPSSrvcNNILocalMepId, pvxLAGPortHistPMLACPDURXValidity=pvxLAGPortHistPMLACPDURXValidity, pvxLAGPortCrntPMMRKPDUTXValidity=pvxLAGPortCrntPMMRKPDUTXValidity, pvxPCPEncDecProfileTable=pvxPCPEncDecProfileTable, pvxNextFreeIndexSwitchIdx=pvxNextFreeIndexSwitchIdx, pvxSLAThroughputTestFrameSize4=pvxSLAThroughputTestFrameSize4, pvxFDBMACAddrIdx=pvxFDBMACAddrIdx, pvxSwitchMIPAutoCreateMEL=pvxSwitchMIPAutoCreateMEL, pvxPCPEncPriority4DE=pvxPCPEncPriority4DE, pvxMSTPPortHistPMBPDUTCNTXInitialize=pvxMSTPPortHistPMBPDUTCNTXInitialize, pvxSLAMsmtInitiatorDBRowStatus=pvxSLAMsmtInitiatorDBRowStatus, pvxSrvcNNIIngressBWperCos=pvxSrvcNNIIngressBWperCos, pvxPCPEncPriority5DE=pvxPCPEncPriority5DE, pvxFloActRowStatus=pvxFloActRowStatus, pvxFClassificationIdList=pvxFClassificationIdList, pvxFloClRowStatus=pvxFloClRowStatus, pvxERPSPortHistPMMsPduRxValidity=pvxERPSPortHistPMMsPduRxValidity, pvxERPSSrvcHoldTimer=pvxERPSSrvcHoldTimer, PvxEcfmMepDefects=PvxEcfmMepDefects, pvxSLAMsmtProfileName=pvxSLAMsmtProfileName, pvxMSTPPortCrntPMINVBPDUCFGRXInitialize=pvxMSTPPortCrntPMINVBPDUCFGRXInitialize, pvxMSTPGenIdRevisionLevel=pvxMSTPGenIdRevisionLevel, pvxESrvcCrntPMUASValue=pvxESrvcCrntPMUASValue, pvxSwitchInnerEthType=pvxSwitchInnerEthType, pvxClassMapSrcMACAddrFilter=pvxClassMapSrcMACAddrFilter, pvxESrvcBWPrflHistPMOctetsVltValidity=pvxESrvcBWPrflHistPMOctetsVltValidity, pvxEServiceSlaCrntPM2WayDelayVariationMaximumValidity=pvxEServiceSlaCrntPM2WayDelayVariationMaximumValidity, pvxLAGPortCrntPMMRKRSPPDURXValidity=pvxLAGPortCrntPMMRKRSPPDURXValidity, pvxTMAPLacpTunnMacAddr=pvxTMAPLacpTunnMacAddr, pvxSwitchMemberEntry=pvxSwitchMemberEntry, pvxVlanCurrentCreationTime=pvxVlanCurrentCreationTime, pvxLagPortTimeout=pvxLagPortTimeout, pvxMSTPPortRegRoot=pvxMSTPPortRegRoot, pvxEServiceSlaHistPM2WayDelayAverageValidity=pvxEServiceSlaHistPM2WayDelayAverageValidity, pvxFloClL2InterfaceRange=pvxFloClL2InterfaceRange, pvxVLANForbiddenPortList=pvxVLANForbiddenPortList, pvxSLAThroughputTestRole=pvxSLAThroughputTestRole, pvxEServiceSlaHistPMSwitchIdx=pvxEServiceSlaHistPMSwitchIdx, pvxSchedProfMinBwQ3=pvxSchedProfMinBwQ3, pvxSLAMsmtInitiatorDBEntry=pvxSLAMsmtInitiatorDBEntry, pvxERPSPortHistPMShelfIdx=pvxERPSPortHistPMShelfIdx, pvxERPSSrvcProtectionSwitchMode=pvxERPSSrvcProtectionSwitchMode, pvxMSTPPortHistPMFWDTRValue=pvxMSTPPortHistPMFWDTRValue, pvxLagPortShelfIdx=pvxLagPortShelfIdx, pvxTMAPLldpTunnMacAddr=pvxTMAPLldpTunnMacAddr, pvxMSTPPortHistPMBPDUCFGRXInitialize=pvxMSTPPortHistPMBPDUCFGRXInitialize, pvxFloClSVlanFilter=pvxFloClSVlanFilter, pvxFloActIdx=pvxFloActIdx, pvxMSTPPortCrntPMINVBPDUTCNRXInitialize=pvxMSTPPortCrntPMINVBPDUTCNRXInitialize, pvxERPSPortCrntPMNrPduTxTimeStamp=pvxERPSPortCrntPMNrPduTxTimeStamp, pvxEServiceSlaCrntPMTable=pvxEServiceSlaCrntPMTable, pvxERPSSrvcNNIProtectionSwitch=pvxERPSSrvcNNIProtectionSwitch, pvxESrvcBWPrflCrntPMShelfIdx=pvxESrvcBWPrflCrntPMShelfIdx, pvxEServiceSlaCrntPM2WayDelayVariationMaximumTimeStamp=pvxEServiceSlaCrntPM2WayDelayVariationMaximumTimeStamp, pvxERPSPortHistPMSlotIdx=pvxERPSPortHistPMSlotIdx, pvxBridgeProfiles=pvxBridgeProfiles, pvxSLAThroughputTestFrameSize2NearEndThroughput=pvxSLAThroughputTestFrameSize2NearEndThroughput, pvxESrvcBWPrflCrntPMTable=pvxESrvcBWPrflCrntPMTable, pvxEcfmMepTransmitLtmResultOK=pvxEcfmMepTransmitLtmResultOK, pvxSLAThroughputTestSVlanPriority=pvxSLAThroughputTestSVlanPriority, pvxERPSPortCrntPMMsPduTxValidity=pvxERPSPortCrntPMMsPduTxValidity, pvxESrvcHistPMUASValidity=pvxESrvcHistPMUASValidity, pvxSLAMsmtInitiatorDBPortTypeIdx=pvxSLAMsmtInitiatorDBPortTypeIdx, pvxClassMapSrcMACMaskFilter=pvxClassMapSrcMACMaskFilter, pvxSchedProfMinBwQ6=pvxSchedProfMinBwQ6, pvxMSTPPortHistPMBPDUTXValidity=pvxMSTPPortHistPMBPDUTXValidity, pvxMSTPPortTypeIdx=pvxMSTPPortTypeIdx, pvxBridgeGVRP=pvxBridgeGVRP, pvxERPSPortHistPMMsPduTxInitialize=pvxERPSPortHistPMMsPduTxInitialize, pvxMSTPPortHistPMBPDURXValidity=pvxMSTPPortHistPMBPDURXValidity, pvxStaticUnicastMACAddrIdx=pvxStaticUnicastMACAddrIdx, pvxERPSPortHistPMSfPduTxInitialize=pvxERPSPortHistPMSfPduTxInitialize, pvxEServiceSlaHistPM2WayDelayVariationAverageTimeStamp=pvxEServiceSlaHistPM2WayDelayVariationAverageTimeStamp, pvxBridgeServices=pvxBridgeServices, pvxLAGPortHistPMTable=pvxLAGPortHistPMTable, pvxSLAMsmtResponderDBPortIdx=pvxSLAMsmtResponderDBPortIdx, pvxLAGPortCrntPMMRKPDUTXValue=pvxLAGPortCrntPMMRKPDUTXValue, pvxERPSSrvcNNIRingPortStatus=pvxERPSSrvcNNIRingPortStatus, pvxVlanPortTypeIdx=pvxVlanPortTypeIdx, pvxPriority2TrafficClass=pvxPriority2TrafficClass, pvxEthSrvcNumNNIs=pvxEthSrvcNumNNIs, pvxLAGPortCrntPMLACPDUTXInitialize=pvxLAGPortCrntPMLACPDUTXInitialize, pvxMgmtVLANRowStatus=pvxMgmtVLANRowStatus, pvxERPSPortCrntPMSfPduTxValue=pvxERPSPortCrntPMSfPduTxValue, pvxSLAThroughputTestSlotIdx=pvxSLAThroughputTestSlotIdx, pvxEServiceSlaCrntPMNearEndFrameLossValidity=pvxEServiceSlaCrntPMNearEndFrameLossValidity, pvxMSTPXstPortForcedPortState=pvxMSTPXstPortForcedPortState, pvxEServiceSlaHistPM2WayDelayMinimumValidity=pvxEServiceSlaHistPM2WayDelayMinimumValidity, pvxStaticUnicastVlanIdx=pvxStaticUnicastVlanIdx, pvxMSTPCrntPMRCCCValidity=pvxMSTPCrntPMRCCCValidity, pvxMSTPGenTable=pvxMSTPGenTable, pvxPCPDecPriority5=pvxPCPDecPriority5, pvxERPSSrvcPropagateTC=pvxERPSSrvcPropagateTC, pvxSrvcUNIUserDefinedMepId=pvxSrvcUNIUserDefinedMepId, pvxServiceUNITable=pvxServiceUNITable, pvxEcfmMepLbrBadMsdu=pvxEcfmMepLbrBadMsdu, pvxLagPortTypeIdx=pvxLagPortTypeIdx, pvxNNIEntry=pvxNNIEntry, pvxLAGPortHistPMLACPDUTXValue=pvxLAGPortHistPMLACPDUTXValue, pvxEServiceSlaHistPM2WayDelayVariationMinimum=pvxEServiceSlaHistPM2WayDelayVariationMinimum, pvxERPSSrvcGuardTimer=pvxERPSSrvcGuardTimer, pvxERPSPortCrntPMEventPduTxTimeStamp=pvxERPSPortCrntPMEventPduTxTimeStamp, pvxFloClEntryType=pvxFloClEntryType, pvxERPSPortHistPMNrrbPduTxValue=pvxERPSPortHistPMNrrbPduTxValue, pvxEServiceSlaHistPMSlotIdx=pvxEServiceSlaHistPMSlotIdx, pvxERPSPortCrntPMMsPduRxValidity=pvxERPSPortCrntPMMsPduRxValidity, pvxSwitchMemberStackingState=pvxSwitchMemberStackingState, pvxERPSPortCrntPMBlockedTimeStamp=pvxERPSPortCrntPMBlockedTimeStamp, pvxFloActCVlanAction=pvxFloActCVlanAction, pvxEServiceSlaHistPMShelfIdx=pvxEServiceSlaHistPMShelfIdx, pvxFloClSourceUDPorTCPFilter=pvxFloClSourceUDPorTCPFilter, pvxERPSPortCrntPMEventPduTxValue=pvxERPSPortCrntPMEventPduTxValue, pvxERPSPortHistPMSfPduTxValue=pvxERPSPortHistPMSfPduTxValue, pvxMSTPPortCrntPMBPDUTCNTXValidity=pvxMSTPPortCrntPMBPDUTCNTXValidity, pvxERPSPortHistPMEventPduRxValidity=pvxERPSPortHistPMEventPduRxValidity, pvxLAGPortHistPMMRKRSPPDURXValue=pvxLAGPortHistPMMRKRSPPDURXValue, pvxSwitchEvcMEGName=pvxSwitchEvcMEGName, pvxVLANMemberPortList=pvxVLANMemberPortList, pvxLAGPortCrntPMMRKRSPPDURXTimeStamp=pvxLAGPortCrntPMMRKRSPPDURXTimeStamp, pvxNNIRowStatus=pvxNNIRowStatus, pvxMSTPCrntPMIntervalTypeIdx=pvxMSTPCrntPMIntervalTypeIdx, pvxMSTPPortRestrictedRole=pvxMSTPPortRestrictedRole, pvxSLAMeasurementProfileEntry=pvxSLAMeasurementProfileEntry, pvxSLAThroughputTestFrameSize5=pvxSLAThroughputTestFrameSize5, pvxMSTPPortHistPMEntry=pvxMSTPPortHistPMEntry, pvxMSTPCrntPMEntry=pvxMSTPCrntPMEntry, pvxVLANMSTPId=pvxVLANMSTPId, pvxEServiceSlaCrntPM2WayDelayVariationAverageInitialize=pvxEServiceSlaCrntPM2WayDelayVariationAverageInitialize, pvxSLAThroughputTestFrameSize3=pvxSLAThroughputTestFrameSize3, PYSNMP_MODULE_ID=packetVxBridgeMib, pvxFMMeterIdx=pvxFMMeterIdx, mstpPacketErrType=mstpPacketErrType, pvxUNITable=pvxUNITable, pvxSwitchTable=pvxSwitchTable, pvxMSTPXstPortIdx=pvxMSTPXstPortIdx, pvxMSTPHistPMRCCCValue=pvxMSTPHistPMRCCCValue, mstpRegionConfigChangeEvt=mstpRegionConfigChangeEvt, pvxSrvcNNISlotId=pvxSrvcNNISlotId, pvxVLANEntry=pvxVLANEntry, pvxMSTPHistPMXstIdx=pvxMSTPHistPMXstIdx, pvxBWPIdx=pvxBWPIdx, pvxLAGPortHistPMMRKRSPPDURXValidity=pvxLAGPortHistPMMRKRSPPDURXValidity, pvxEServiceSlaHistPM2WayDelayMaximumInitialize=pvxEServiceSlaHistPM2WayDelayMaximumInitialize, pvxDynamicVlanPortTable=pvxDynamicVlanPortTable, pvxUNICPVid=pvxUNICPVid, pvxSvidXlateTable=pvxSvidXlateTable, pvxSwitchCfmDestinationAddress=pvxSwitchCfmDestinationAddress, pvxVlanCurrentTable=pvxVlanCurrentTable, pvxSLAThroughputTestSwitchIdx=pvxSLAThroughputTestSwitchIdx, pvxEthSrvcName=pvxEthSrvcName, pvxSLAThroughputTestFrameSize1=pvxSLAThroughputTestFrameSize1, pvxY1731LbStatsLbrIn=pvxY1731LbStatsLbrIn, pvxSchedProfName=pvxSchedProfName, pvxEcfmMepESrvcName=pvxEcfmMepESrvcName, pvxESrvcBWPrflPMThresholdDirectionIdx=pvxESrvcBWPrflPMThresholdDirectionIdx, pvxDynamicVlanPortVlanIdx=pvxDynamicVlanPortVlanIdx)
mibBuilder.exportSymbols("PACKET-VX-BRIDGE-MIB", pvxESrvcBWPrflHistPMSlotIdx=pvxESrvcBWPrflHistPMSlotIdx, pvxSLAMsmtThresholdDelayVarAverage=pvxSLAMsmtThresholdDelayVarAverage, pvxLAGPortHistPMIdx=pvxLAGPortHistPMIdx, pvxMSTPHistPMEntry=pvxMSTPHistPMEntry, pvxCPMaxBandwidth=pvxCPMaxBandwidth, pvxSchedProfAlgorithm=pvxSchedProfAlgorithm, pvxEServiceSlaHistPMNearEndFrameLossInitialize=pvxEServiceSlaHistPMNearEndFrameLossInitialize, pvxERPSPortHistPMPduDiscardValue=pvxERPSPortHistPMPduDiscardValue, pvxLagPortRowStatus=pvxLagPortRowStatus, pvxMSTPXstPortEntry=pvxMSTPXstPortEntry, pvxMSTPPortCrntPMBPDURXInitialize=pvxMSTPPortCrntPMBPDURXInitialize, pvxNNIMode=pvxNNIMode, pvxMSTPHistPMTCCTimeStamp=pvxMSTPHistPMTCCTimeStamp, pvxERPSPortHistPMVersionDiscardValidity=pvxERPSPortHistPMVersionDiscardValidity, pvxCtrlFrmProfileTable=pvxCtrlFrmProfileTable, pvxMCRowStatus=pvxMCRowStatus, pvxBWMeterColorAware=pvxBWMeterColorAware, pvxSrvcUNIRowStatus=pvxSrvcUNIRowStatus, pvxLAGPortHistPMLACPDURXValue=pvxLAGPortHistPMLACPDURXValue, pvxSchedProfMaxBwQ2=pvxSchedProfMaxBwQ2, pvxERPSPortCrntPMEventPduTxInitialize=pvxERPSPortCrntPMEventPduTxInitialize, pvxMSTPPortHistPMIdx=pvxMSTPPortHistPMIdx, pvxVlanCurrentSwitchIdx=pvxVlanCurrentSwitchIdx, pvxSLAThroughputTestShelfIdx=pvxSLAThroughputTestShelfIdx, pvxPCVRTUntaggedCEP=pvxPCVRTUntaggedCEP, pvxSchedProfWeightQ6=pvxSchedProfWeightQ6, pvxFloClCVlanFilter=pvxFloClCVlanFilter, pvxSwitchTimeToAge=pvxSwitchTimeToAge, pvxERPSPortCrntPMPortIdx=pvxERPSPortCrntPMPortIdx, pvxY1731LbStatsSwitchIdx=pvxY1731LbStatsSwitchIdx, switchMemberStkPortDownClear=switchMemberStkPortDownClear, pvxEcfmMepDbRMepPortStatusDefect=pvxEcfmMepDbRMepPortStatusDefect, pvxEcfmMipShelfId=pvxEcfmMipShelfId, pvxLagPortSlotIdx=pvxLagPortSlotIdx, pvxY1731LbStatsTable=pvxY1731LbStatsTable, pvxSwitchMemberBackplaneCommState=pvxSwitchMemberBackplaneCommState, pvxMSTPXstBrdgId=pvxMSTPXstBrdgId, pvxPolicyMapBWProfileName=pvxPolicyMapBWProfileName, pvxSvidXlatePortId=pvxSvidXlatePortId, pvxERPSPortCrntPMRecoveriesValidity=pvxERPSPortCrntPMRecoveriesValidity, pvxLGActivePortCount=pvxLGActivePortCount, pvxMSTPCrntPMNRBCValue=pvxMSTPCrntPMNRBCValue, pvxMSTPGenCistRootCost=pvxMSTPGenCistRootCost, pvxFloClMeterId=pvxFloClMeterId, pvxMSTPPortHistPMBPDURXInitialize=pvxMSTPPortHistPMBPDURXInitialize, pvxDscpAssuredFwd1y=pvxDscpAssuredFwd1y, pvxEthSrvcFrameSize=pvxEthSrvcFrameSize, pvxClassMapL4DstPortEndFilter=pvxClassMapL4DstPortEndFilter, pvxSLAMsmtInitiatorDBDelayMsmtSVlanPriority=pvxSLAMsmtInitiatorDBDelayMsmtSVlanPriority, pvxESrvcHistPMSwitchIdx=pvxESrvcHistPMSwitchIdx, pvxERPSSrvcRingProperty=pvxERPSSrvcRingProperty, pvxSrvcNNISrvcName=pvxSrvcNNISrvcName, pvxMSTPPortCrntPMBPDUCFGTXValue=pvxMSTPPortCrntPMBPDUCFGTXValue, pvxERPSPortCrntPMUnblockedInitialize=pvxERPSPortCrntPMUnblockedInitialize, pvxERPSServiceTable=pvxERPSServiceTable, pvxEServiceSlaHistPMTable=pvxEServiceSlaHistPMTable, pvxEcfmMepXconnRMepId=pvxEcfmMepXconnRMepId, pvxESrvcBWPrflPMThresholdSlotIdx=pvxESrvcBWPrflPMThresholdSlotIdx, pvxMSTPGenCistRootPriority=pvxMSTPGenCistRootPriority, pvxSLAMsmtThresholdNearEndLossRatio=pvxSLAMsmtThresholdNearEndLossRatio, pvxSwitchEvcMEGLevel=pvxSwitchEvcMEGLevel, pvxMSTPPortCrntPMINVBPDUTCNRXValidity=pvxMSTPPortCrntPMINVBPDUTCNRXValidity, pvxESrvcBWPrflPMThresholdPortTypeIdx=pvxESrvcBWPrflPMThresholdPortTypeIdx, pvxEcfmMepDbRMepIntfStatusDefect=pvxEcfmMepDbRMepIntfStatusDefect, pvxFRowStatus=pvxFRowStatus, pvxNextFreeIndexTable=pvxNextFreeIndexTable, pvxERPSSrvcRingSemState=pvxERPSSrvcRingSemState, pvxClassMapMatchType=pvxClassMapMatchType, pvxLAGPortCrntPMINVLACFRRXValue=pvxLAGPortCrntPMINVLACFRRXValue, pvxLAGPortCrntPMMRKRSPPDUTXValidity=pvxLAGPortCrntPMMRKRSPPDUTXValidity, pvxERPSPortHistPMSfPduRxValue=pvxERPSPortHistPMSfPduRxValue, pvxMSTPPortCrntPMINVBPDUTCNRXTimeStamp=pvxMSTPPortCrntPMINVBPDUTCNRXTimeStamp, pvxESrvcBWPrflHistPMOctetsCnfExcValue=pvxESrvcBWPrflHistPMOctetsCnfExcValue, pvxERPSSrvcName=pvxERPSSrvcName, pvxEServiceSlaCrntPMESName=pvxEServiceSlaCrntPMESName, pvxESrvcBWPrflPMThresholdClsMapNameIdx=pvxESrvcBWPrflPMThresholdClsMapNameIdx, pvxPCPDecPriority0=pvxPCPDecPriority0, pvxLagPortAggState=pvxLagPortAggState, pvxESrvcBWPrflCrntPMBDWUtlzTimeStamp=pvxESrvcBWPrflCrntPMBDWUtlzTimeStamp, pvxERPSPortCrntPMRecoveriesInitialize=pvxERPSPortCrntPMRecoveriesInitialize, pvxEcfmMepDbTable=pvxEcfmMepDbTable, pvxERPSPortHistPMNrPduRxInitialize=pvxERPSPortHistPMNrPduRxInitialize, pvxESrvcBWPrflPMThresholdPlcyNameIdx=pvxESrvcBWPrflPMThresholdPlcyNameIdx, pvxERPSSrvcNNIRemoteMepId=pvxERPSSrvcNNIRemoteMepId, pvxMepListIdentifier=pvxMepListIdentifier, pvxERPSPortCrntPMSlotIdx=pvxERPSPortCrntPMSlotIdx, lagLinkDownCond=lagLinkDownCond, pvxLAGPortHistPMIntervalTypeIdx=pvxLAGPortHistPMIntervalTypeIdx, pvxMSTPPortCrntPMSwitchIdx=pvxMSTPPortCrntPMSwitchIdx, pvxSLAMsmtInitiatorDBShelfIdx=pvxSLAMsmtInitiatorDBShelfIdx, pvxVlanPortEntry=pvxVlanPortEntry, pvxLAGPortHistPMINVLACFRRXInitialize=pvxLAGPortHistPMINVLACFRRXInitialize, pvxERPSSrvcUpMegLevel=pvxERPSSrvcUpMegLevel, pvxMSTPPortCrntPMIdx=pvxMSTPPortCrntPMIdx, pvxESrvcHistPMEntry=pvxESrvcHistPMEntry, pvxFMRowStatus=pvxFMRowStatus, pvxEServiceSlaHistPMIntervalIdx=pvxEServiceSlaHistPMIntervalIdx, pvxEServiceSlaCrntPMRMepId=pvxEServiceSlaCrntPMRMepId, pvxMSTPPortHistPMPMCInitialize=pvxMSTPPortHistPMPMCInitialize, pvxFloClIdx=pvxFloClIdx, pvxMSTPXstRootPortShelf=pvxMSTPXstRootPortShelf, pvxERPSSrvcFOPProvisionMismatchCond=pvxERPSSrvcFOPProvisionMismatchCond, pvxLagPortIdx=pvxLagPortIdx, pvxEcfmLtrVlanId=pvxEcfmLtrVlanId, pvxERPSPortCrntPMEventPduRxValue=pvxERPSPortCrntPMEventPduRxValue, pvxERPSPortHistPMPduTxValue=pvxERPSPortHistPMPduTxValue, pvxBWMeterCir=pvxBWMeterCir, pvxLAGPortCrntPMLACPDURXTimeStamp=pvxLAGPortCrntPMLACPDURXTimeStamp, pvxLagTable=pvxLagTable, switchMemberStkPortDownCond=switchMemberStkPortDownCond, pvxEcfmMepDbVlanId=pvxEcfmMepDbVlanId, pvxDscpAssuredFwd4y=pvxDscpAssuredFwd4y, pvxSchedProfMinBwQ7=pvxSchedProfMinBwQ7, pvxESrvcBWPrflHistPMDirectionIdx=pvxESrvcBWPrflHistPMDirectionIdx, pvxSvidXlateExternalSVid=pvxSvidXlateExternalSVid, pvxLAGPortHistPMMRKPDUTXTimeStamp=pvxLAGPortHistPMMRKPDUTXTimeStamp, pvxSrvcUNISlaMeasurementProfile=pvxSrvcUNISlaMeasurementProfile, pvxMultiCastEntry=pvxMultiCastEntry, pvxSLAThroughputTestRowStatus=pvxSLAThroughputTestRowStatus, pvxEcfmLtrEntry=pvxEcfmLtrEntry, pvxSLAMsmtInitiatorDBSwitchIdx=pvxSLAMsmtInitiatorDBSwitchIdx, pvxERPSPortHistPMEventPduRxValue=pvxERPSPortHistPMEventPduRxValue, pvxLAGPortCrntPMMRKPDUTXTimeStamp=pvxLAGPortCrntPMMRKPDUTXTimeStamp, pvxEthSrvcSpanTreeInstance=pvxEthSrvcSpanTreeInstance, pvxSchedProfWeightQ0=pvxSchedProfWeightQ0, pvxMSTPPortHistPMBPDUCFGRXValue=pvxMSTPPortHistPMBPDUCFGRXValue, pvxEthSrvcPointedness=pvxEthSrvcPointedness, pvxEServiceSlaHistPMRMepId=pvxEServiceSlaHistPMRMepId, pvxFMMeterProfileId=pvxFMMeterProfileId, pvxFMPMeterType=pvxFMPMeterType, pvxEcfmMepSlotId=pvxEcfmMepSlotId, pvxERPSPortCrntPMEventPduRxTimeStamp=pvxERPSPortCrntPMEventPduRxTimeStamp, pvxUNIPortId=pvxUNIPortId, pvxSvidXlateEntry=pvxSvidXlateEntry, pvxMgmtVLANIpAddress=pvxMgmtVLANIpAddress, pvxMSTPGenMaxHops=pvxMSTPGenMaxHops, pvxEServiceSlaHistPMPortTypeIdx=pvxEServiceSlaHistPMPortTypeIdx, pvxEcfmMepTransmitLtmStatus=pvxEcfmMepTransmitLtmStatus, pvxESrvcBWPrflCrntPMOctetsVltValidity=pvxESrvcBWPrflCrntPMOctetsVltValidity, pvxEcfmMepUnexpLtrIn=pvxEcfmMepUnexpLtrIn, pvxMSTPXstPortPriority=pvxMSTPXstPortPriority, pvxMSTPPortHistPMPMCValidity=pvxMSTPPortHistPMPMCValidity, pvxMSTPCrntPMTCCValidity=pvxMSTPCrntPMTCCValidity, pvxSLAMsmtResponderDBESName=pvxSLAMsmtResponderDBESName, pvxEServiceSlaCrntPM2WayDelayVariationMinimum=pvxEServiceSlaCrntPM2WayDelayVariationMinimum, pvxMgmtVLANAddressType=pvxMgmtVLANAddressType, pvxUNIMode=pvxUNIMode, pvxERPSPortCrntPMPduTxValidity=pvxERPSPortCrntPMPduTxValidity, mstpGlobalErrType=mstpGlobalErrType, pvxEthSrvcMECciEnable=pvxEthSrvcMECciEnable, pvxMSTPPortCrntPMBPDUTCNRXValidity=pvxMSTPPortCrntPMBPDUTCNRXValidity, pvxEServiceSlaCrntPM2WayDelayAverageTimeStamp=pvxEServiceSlaCrntPM2WayDelayAverageTimeStamp, pvxSchedProfMaxBwQ6=pvxSchedProfMaxBwQ6, pvxFMPRowStatus=pvxFMPRowStatus, pvxLAGPortCrntPMLACPDURXValue=pvxLAGPortCrntPMLACPDURXValue, pvxEcfmMepTransmitLbmResultOK=pvxEcfmMepTransmitLbmResultOK, pvxERPSPortHistPMRecoveriesInitialize=pvxERPSPortHistPMRecoveriesInitialize, pvxMSTPXstPortState=pvxMSTPXstPortState, pvxVlanPortRestrictedVlanState=pvxVlanPortRestrictedVlanState, pvxFloActRedCNGAction=pvxFloActRedCNGAction, pvxSchedProfMinBwQ5=pvxSchedProfMinBwQ5, cfmRMepStateChangeV2Evt=cfmRMepStateChangeV2Evt, pvxFSCountOfClassifiedPackets=pvxFSCountOfClassifiedPackets, pvxESrvcHistPMUASInitialize=pvxESrvcHistPMUASInitialize, pvxMSTPGenIdFmtSel=pvxMSTPGenIdFmtSel, pvxEcfmLtrSwitchIdx=pvxEcfmLtrSwitchIdx, pvxEthSrvcMEName=pvxEthSrvcMEName, pvxPCPEncDecProfileName=pvxPCPEncDecProfileName, pvxEServiceSlaHistPM2WayDelayVariationAverageInitialize=pvxEServiceSlaHistPM2WayDelayVariationAverageInitialize, pvxNNIMaxFrameSize=pvxNNIMaxFrameSize, pvxERPSPortCrntPMMsPduRxValue=pvxERPSPortCrntPMMsPduRxValue)
