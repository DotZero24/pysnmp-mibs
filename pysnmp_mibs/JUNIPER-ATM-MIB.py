...
mibBuilder.exportSymbols("JUNIPER-ATM-MIB", jnxAtmVCOutPkts=jnxAtmVCOutPkts, jnxAtmIfTxCellFIFOOverRuns=jnxAtmIfTxCellFIFOOverRuns, jnxAtmVCTailQueuePktDrops=jnxAtmVCTailQueuePktDrops, jnxAtmTrunkFlags=jnxAtmTrunkFlags, jnxAtmTrunkId=jnxAtmTrunkId, jnxAtmIfRxCellFIFOOverRuns=jnxAtmIfRxCellFIFOOverRuns, jnxAtmVpTotalDownTime=jnxAtmVpTotalDownTime, jnxAtmIfTxIdleCellCount=jnxAtmIfTxIdleCellCount, jnxAtmVpInOamF4LoopCells=jnxAtmVpInOamF4LoopCells, jnxAtmIfOutVCQueueDrops=jnxAtmIfOutVCQueueDrops, jnxAtmIfInTimeoutPkts=jnxAtmIfInTimeoutPkts, jnxAtmVCMpDestIPv6Addr=jnxAtmVCMpDestIPv6Addr, jnxAtmVCInOAMF5RDICells=jnxAtmVCInOAMF5RDICells, jnxAtmVCTable=jnxAtmVCTable, jnxAtmVpEntry=jnxAtmVpEntry, jnxAtmIfEntry=jnxAtmIfEntry, jnxAtmVpInBytes=jnxAtmVpInBytes, jnxAtmVCOutBytes=jnxAtmVCOutBytes, jnxAtmVCInOAMF5AISCells=jnxAtmVCInOAMF5AISCells, jnxAtmTrunkInOAMF4AISCells=jnxAtmTrunkInOAMF4AISCells, jnxAtmVpOutBytes=jnxAtmVpOutBytes, jnxAtmTrunkTotalDownTime=jnxAtmTrunkTotalDownTime, jnxAtmVCInOAMF5LoopCells=jnxAtmVCInOAMF5LoopCells, jnxAtmVpOutOamF4RdiCells=jnxAtmVpOutOamF4RdiCells, jnxAtmIfCorrHCSErrs=jnxAtmIfCorrHCSErrs, jnxAtmVpInOamF4AisCells=jnxAtmVpInOamF4AisCells, jnxAtmVCOutOAMF5RDICells=jnxAtmVCOutOAMF5RDICells, jnxAtmVCOAMUpCellCount=jnxAtmVCOAMUpCellCount, jnxAtmVCInBytes=jnxAtmVCInBytes, jnxAtmIfUncorrHCSErrs=jnxAtmIfUncorrHCSErrs, jnxAtmVCOAMPeriod=jnxAtmVCOAMPeriod, jnxAtmIfInLenErrPkts=jnxAtmIfInLenErrPkts, jnxAtmIfRxCellFIFOUnderRuns=jnxAtmIfRxCellFIFOUnderRuns, jnxAtmIfInNoBufDropPkts=jnxAtmIfInNoBufDropPkts, jnxAtmVpInOamF4RdiCells=jnxAtmVpInOamF4RdiCells, jnxAtmVpOutOamF4Cells=jnxAtmVpOutOamF4Cells, jnxAtmIfTable=jnxAtmIfTable, jnxAtmVCInPkts=jnxAtmVCInPkts, jnxAtmIfL2CircuitMode=jnxAtmIfL2CircuitMode, jnxAtmVCFlags=jnxAtmVCFlags, jnxAtmIfTxCellCount=jnxAtmIfTxCellCount, jnxAtmIfScrambleEnable=jnxAtmIfScrambleEnable, jnxAtmIfInBadCrcs=jnxAtmIfInBadCrcs, jnxAtmVCMpDestIPv4Addr=jnxAtmVCMpDestIPv4Addr, jnxAtmVpOamUpCellCount=jnxAtmVpOamUpCellCount, jnxAtm=jnxAtm, jnxAtmVpFlags=jnxAtmVpFlags, jnxAtmIfLpBackInfo=jnxAtmIfLpBackInfo, jnxAtmTrunkConnType=jnxAtmTrunkConnType, jnxAtmVCOutOAMF5LoopCells=jnxAtmVCOutOAMF5LoopCells, jnxAtmVCOAMDownCellCount=jnxAtmVCOAMDownCellCount, jnxAtmVpInOamF4Cells=jnxAtmVpInOamF4Cells, jnxAtmVCOutOAMF5AISCells=jnxAtmVCOutOAMF5AISCells, jnxAtmVCEntry=jnxAtmVCEntry, jnxAtmIfEncaps=jnxAtmIfEncaps, JnxAtmFlags=JnxAtmFlags, jnxAtmTrunkInPkts=jnxAtmTrunkInPkts, jnxAtmIfInNoBufferOAMCells=jnxAtmIfInNoBufferOAMCells, jnxAtmIfPortType=jnxAtmIfPortType, jnxAtmTrunkInBytes=jnxAtmTrunkInBytes, jnxAtmVCConnType=jnxAtmVCConnType, jnxAtmVpTable=jnxAtmVpTable, jnxAtmVpOutOamF4LoopCells=jnxAtmVpOutOamF4LoopCells, jnxAtmVCEncapsulation=jnxAtmVCEncapsulation, jnxAtmTrunkEntry=jnxAtmTrunkEntry, jnxAtmTrunkOutOAMF4AISCells=jnxAtmTrunkOutOAMF4AISCells, jnxAtmTrunkOutPkts=jnxAtmTrunkOutPkts, jnxAtmTrunkTailQueuePktDrops=jnxAtmTrunkTailQueuePktDrops, jnxAtmIfInInvalidVCCells=jnxAtmIfInInvalidVCCells, jnxAtmVpOamDownCellCount=jnxAtmVpOamDownCellCount, jnxAtmVpOamPeriod=jnxAtmVpOamPeriod, jnxAtmTrunkOutBytes=jnxAtmTrunkOutBytes, jnxAtmIfRxCellCount=jnxAtmIfRxCellCount, PYSNMP_MODULE_ID=jnxAtm, jnxAtmVpOutPkts=jnxAtmVpOutPkts, jnxAtmVCTotalDownTime=jnxAtmVCTotalDownTime, jnxAtmTrunkEncapsulation=jnxAtmTrunkEncapsulation, jnxAtmVpInPkts=jnxAtmVpInPkts, jnxAtmTrunkTable=jnxAtmTrunkTable)
