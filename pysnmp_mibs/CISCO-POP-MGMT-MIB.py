...
mibBuilder.exportSymbols("CISCO-POP-MGMT-MIB", cpmCallHistorySummaryEntry=cpmCallHistorySummaryEntry, cpmDS0UsageGroupRev2=cpmDS0UsageGroupRev2, cpmDS1CurrentIdle=cpmDS1CurrentIdle, cpmCallFailure=cpmCallFailure, cpmDS0StatusTable=cpmDS0StatusTable, cpmCallHistorySummaryTable=cpmCallHistorySummaryTable, cpmActiveCallSummaryIndex=cpmActiveCallSummaryIndex, cpmMIBCompliances=cpmMIBCompliances, cpmActiveCallSummary=cpmActiveCallSummary, cpmActiveCallSummaryTable=cpmActiveCallSummaryTable, cpmDS0Status=cpmDS0Status, cpmOutOctets=cpmOutOctets, cpmDS0BusyoutSource=cpmDS0BusyoutSource, cpmCallDuration=cpmCallDuration, cpmDS1UsageGroup=cpmDS1UsageGroup, ciscoPopMgmtMIBObjects=ciscoPopMgmtMIBObjects, cpmDS1TotalAnalogCalls=cpmDS1TotalAnalogCalls, cpmMIBConformance=cpmMIBConformance, cpmDS0UsageTable=cpmDS0UsageTable, cpmDS0BusyoutNotification=cpmDS0BusyoutNotification, cpmNotifications=cpmNotifications, cpmISDNCfgBChanInUseForAnalog=cpmISDNCfgBChanInUseForAnalog, cpmISDNCfgBChannelsInUse=cpmISDNCfgBChannelsInUse, cpmTotalISDNSyncPPPCalls=cpmTotalISDNSyncPPPCalls, cpmCASCfgBChanInUseForVoice=cpmCASCfgBChanInUseForVoice, cpmModemCallsRejected=cpmModemCallsRejected, cpmActiveUserID=cpmActiveUserID, cpmTTYNumber=cpmTTYNumber, cpmDS0StatusGroup=cpmDS0StatusGroup, cpmInOctets=cpmInOctets, cpmCallStartTimeIndex=cpmCallStartTimeIndex, cpmActiveRemotePhoneNumber=cpmActiveRemotePhoneNumber, cpmEntryChannel=cpmEntryChannel, cpmDS1CurrentOutOfService=cpmDS1CurrentOutOfService, cpmRemotePhoneNumber=cpmRemotePhoneNumber, cpmUserID=cpmUserID, cpmDS1TotalTimeInUse=cpmDS1TotalTimeInUse, cpmDS0UsageEntry=cpmDS0UsageEntry, cpmOutPackets=cpmOutPackets, cpmDS0Usage=cpmDS0Usage, cpmTimeInUse=cpmTimeInUse, cpmDS0UsageGroup=cpmDS0UsageGroup, cpmActiveEntryPort=cpmActiveEntryPort, cpmDS1TotalDigitalCalls=cpmDS1TotalDigitalCalls, cpmActiveCallSummaryEntry=cpmActiveCallSummaryEntry, cpmEntryPort=cpmEntryPort, cpmISDNCallsRejected=cpmISDNCallsRejected, cpmDS0BusyoutNotifyEnable=cpmDS0BusyoutNotifyEnable, cpmModemSlot=cpmModemSlot, cpmSystemGroup=cpmSystemGroup, cpmCallHistorySummaryRetainTimer=cpmCallHistorySummaryRetainTimer, cpmDS1UsagePortIndex=cpmDS1UsagePortIndex, cpmMIBGroups=cpmMIBGroups, cpmDS0BusyoutStatus=cpmDS0BusyoutStatus, cpmActiveTTYNumber=cpmActiveTTYNumber, cpmConfiguredType=cpmConfiguredType, cpmNotificationGroup=cpmNotificationGroup, cpmCallVolume=cpmCallVolume, cpmCallType=cpmCallType, cpmDS1PortIndex=cpmDS1PortIndex, cpmPPPCalls=cpmPPPCalls, cpmDS0CallType=cpmDS0CallType, cpmDS0BusyoutTime=cpmDS0BusyoutTime, cpmDS1LoopbackNotifyConfigGroup=cpmDS1LoopbackNotifyConfigGroup, cpmCallVolumeGroup=cpmCallVolumeGroup, cpmCallHistorySummaryGroup=cpmCallHistorySummaryGroup, cpmCallDisconnectTimeIndex=cpmCallDisconnectTimeIndex, cpmChannelIndex=cpmChannelIndex, cpmDS1CurrentBusyout=cpmDS1CurrentBusyout, cpmActiveEntryChannel=cpmActiveEntryChannel, cpmDS1OutPackets=cpmDS1OutPackets, cpmISDNCfgActiveDChannels=cpmISDNCfgActiveDChannels, cpmV110Calls=cpmV110Calls, cpmDS1TotalV110Calls=cpmDS1TotalV110Calls, cpmCallCount=cpmCallCount, cpmDS1ActiveDS0sHighWaterMark=cpmDS1ActiveDS0sHighWaterMark, cpmActiveLocalPhoneNumber=cpmActiveLocalPhoneNumber, cpmISDNCfgBChannelAnalogCalls=cpmISDNCfgBChannelAnalogCalls, cpmDS0BusyoutAllow=cpmDS0BusyoutAllow, cpmActiveEntrySlot=cpmActiveEntrySlot, PYSNMP_MODULE_ID=ciscoPopMgmtMIB, cpmV120Calls=cpmV120Calls, cpmDS1LoopbackNotification=cpmDS1LoopbackNotification, cpmMIBCompliance=cpmMIBCompliance, cPopMgmtMIBNotificationPrefix=cPopMgmtMIBNotificationPrefix, cpmISDNCfgBChannelsTimeInUse=cpmISDNCfgBChannelsTimeInUse, cpmEntrySlot=cpmEntrySlot, cpmDS0BusyoutAdminStatus=cpmDS0BusyoutAdminStatus, cpmMIBComplianceRev4=cpmMIBComplianceRev4, cpmModemCallsClearedAbnormally=cpmModemCallsClearedAbnormally, cpmDS1TotalCalls=cpmDS1TotalCalls, cpmActiveCallType=cpmActiveCallType, cpmCallHistorySummaryIndex=cpmCallHistorySummaryIndex, cpmDS1OutOctets=cpmDS1OutOctets, cpmMIBComplianceRev1=cpmMIBComplianceRev1, cpmInPackets=cpmInPackets, cpmDS1ActiveDS0s=cpmDS1ActiveDS0s, cpmISDNCallsClearedAbnormally=cpmISDNCallsClearedAbnormally, cpmCallVolAnalogCallClearedNormally=cpmCallVolAnalogCallClearedNormally, cpmDS0ConfigFunction=cpmDS0ConfigFunction, cpmDS0InterfaceIndex=cpmDS0InterfaceIndex, cpmModemNoResource=cpmModemNoResource, cpmDS1LoopbackNotifyEnable=cpmDS1LoopbackNotifyEnable, cpmCallHistorySummary=cpmCallHistorySummary, cpmDS0OperStatus=cpmDS0OperStatus, cpmMIBComplianceRev5=cpmMIBComplianceRev5, cpmL2Encapsulation=cpmL2Encapsulation, cpmNotificationGroupRev1=cpmNotificationGroupRev1, cpmDS1UsageSlotIndex=cpmDS1UsageSlotIndex, cpmSW56CfgBChannelsInUse=cpmSW56CfgBChannelsInUse, cpmDS0UsageGroupRev1=cpmDS0UsageGroupRev1, cpmDS1DS0UsageEntry=cpmDS1DS0UsageEntry, cpmDS1TotalV120Calls=cpmDS1TotalV120Calls, cpmLocalPhoneNumber=cpmLocalPhoneNumber, cpmISDNCfgBChanInUseForVoice=cpmISDNCfgBChanInUseForVoice, ciscoPopMgmtMIB=ciscoPopMgmtMIB, cpmISDNCfgBChannelCalls=cpmISDNCfgBChannelCalls, cpmComplianceRev2=cpmComplianceRev2, cpmISDNNoResource=cpmISDNNoResource, cpmCallHistorySummaryTableMaxLength=cpmCallHistorySummaryTableMaxLength, cpmCallFailureGroup=cpmCallFailureGroup, cpmActiveDS0sHighWaterMark=cpmActiveDS0sHighWaterMark, cpmCallVolSuccISDNDigital=cpmCallVolSuccISDNDigital, cpmActiveModemSlot=cpmActiveModemSlot, cpmActiveUserIpAddr=cpmActiveUserIpAddr, cpmActiveModemPort=cpmActiveModemPort, cpmActiveCallDuration=cpmActiveCallDuration, cpmISDNCfgBChannelsTimeInUseAnlg=cpmISDNCfgBChannelsTimeInUseAnlg, cpmDS1LoopbackNotifyConfig=cpmDS1LoopbackNotifyConfig, cpmActiveCallStartTimeIndex=cpmActiveCallStartTimeIndex, cpmActiveDS0s=cpmActiveDS0s, cpmUserIpAddr=cpmUserIpAddr, cpmActiveCallSummaryGroup=cpmActiveCallSummaryGroup, cpmDS1InOctets=cpmDS1InOctets, cpmModemPort=cpmModemPort, cpmAssociatedInterface=cpmAssociatedInterface, cpmDS1SlotIndex=cpmDS1SlotIndex, cpmMIBComplianceRev3=cpmMIBComplianceRev3, cpmDS1InPackets=cpmDS1InPackets, cpmDS0StatusEntry=cpmDS0StatusEntry, cpmDS1DS0UsageTable=cpmDS1DS0UsageTable)
