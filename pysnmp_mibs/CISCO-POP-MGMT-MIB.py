...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-POP-MGMT-MIB
...
mibBuilder.exportSymbols("CISCO-POP-MGMT-MIB", cpmDS1SlotIndex=cpmDS1SlotIndex, cpmCallHistorySummaryRetainTimer=cpmCallHistorySummaryRetainTimer, cpmDS1DS0UsageTable=cpmDS1DS0UsageTable, cpmMIBGroups=cpmMIBGroups, cpmDS1UsagePortIndex=cpmDS1UsagePortIndex, cpmCallHistorySummaryTable=cpmCallHistorySummaryTable, cpmDS0UsageEntry=cpmDS0UsageEntry, cpmDS0StatusTable=cpmDS0StatusTable, cpmConfiguredType=cpmConfiguredType, cpmCASCfgBChanInUseForVoice=cpmCASCfgBChanInUseForVoice, cpmDS0InterfaceIndex=cpmDS0InterfaceIndex, cpmModemCallsClearedAbnormally=cpmModemCallsClearedAbnormally, cpmISDNCfgBChannelAnalogCalls=cpmISDNCfgBChannelAnalogCalls, cpmCallFailureGroup=cpmCallFailureGroup, cpmISDNNoResource=cpmISDNNoResource, cpmEntrySlot=cpmEntrySlot, cpmDS1DS0UsageEntry=cpmDS1DS0UsageEntry, cpmCallHistorySummaryIndex=cpmCallHistorySummaryIndex, cpmISDNCfgBChannelCalls=cpmISDNCfgBChannelCalls, cpmISDNCfgBChannelsTimeInUse=cpmISDNCfgBChannelsTimeInUse, cpmMIBCompliances=cpmMIBCompliances, cpmDS0Status=cpmDS0Status, cpmTimeInUse=cpmTimeInUse, cpmDS1TotalCalls=cpmDS1TotalCalls, cpmDS1ActiveDS0sHighWaterMark=cpmDS1ActiveDS0sHighWaterMark, cpmDS1OutPackets=cpmDS1OutPackets, cpmActiveDS0s=cpmActiveDS0s, cpmChannelIndex=cpmChannelIndex, cpmDS1LoopbackNotification=cpmDS1LoopbackNotification, cpmActiveCallSummary=cpmActiveCallSummary, cpmDS0BusyoutAllow=cpmDS0BusyoutAllow, cpmDS0BusyoutSource=cpmDS0BusyoutSource, cpmDS0UsageGroup=cpmDS0UsageGroup, cpmUserIpAddr=cpmUserIpAddr, cpmV120Calls=cpmV120Calls, cpmDS1InOctets=cpmDS1InOctets, cpmDS0CallType=cpmDS0CallType, cpmISDNCfgBChanInUseForVoice=cpmISDNCfgBChanInUseForVoice, cpmActiveCallSummaryTable=cpmActiveCallSummaryTable, cpmDS0StatusEntry=cpmDS0StatusEntry, cpmModemCallsRejected=cpmModemCallsRejected, cpmModemSlot=cpmModemSlot, cpmCallVolAnalogCallClearedNormally=cpmCallVolAnalogCallClearedNormally, cpmAssociatedInterface=cpmAssociatedInterface, cpmNotificationGroupRev1=cpmNotificationGroupRev1, cpmCallVolSuccISDNDigital=cpmCallVolSuccISDNDigital, cpmCallDuration=cpmCallDuration, cpmCallFailure=cpmCallFailure, cpmInPackets=cpmInPackets, cpmActiveCallStartTimeIndex=cpmActiveCallStartTimeIndex, cpmCallHistorySummary=cpmCallHistorySummary, cpmISDNCfgBChannelsInUse=cpmISDNCfgBChannelsInUse, cpmISDNCallsRejected=cpmISDNCallsRejected, cpmOutPackets=cpmOutPackets, cpmISDNCfgBChanInUseForAnalog=cpmISDNCfgBChanInUseForAnalog, cpmDS1UsageGroup=cpmDS1UsageGroup, cpmISDNCfgBChannelsTimeInUseAnlg=cpmISDNCfgBChannelsTimeInUseAnlg, cpmDS1CurrentOutOfService=cpmDS1CurrentOutOfService, cpmDS1ActiveDS0s=cpmDS1ActiveDS0s, cpmCallCount=cpmCallCount, cpmCallType=cpmCallType, cpmDS1TotalAnalogCalls=cpmDS1TotalAnalogCalls, cpmOutOctets=cpmOutOctets, cpmRemotePhoneNumber=cpmRemotePhoneNumber, cpmL2Encapsulation=cpmL2Encapsulation, cpmV110Calls=cpmV110Calls, cpmDS0OperStatus=cpmDS0OperStatus, cpmDS1LoopbackNotifyEnable=cpmDS1LoopbackNotifyEnable, cpmPPPCalls=cpmPPPCalls, cpmDS0UsageGroupRev2=cpmDS0UsageGroupRev2, cpmDS0BusyoutNotifyEnable=cpmDS0BusyoutNotifyEnable, cpmMIBConformance=cpmMIBConformance, cpmMIBCompliance=cpmMIBCompliance, cpmActiveCallType=cpmActiveCallType, cpmActiveEntryChannel=cpmActiveEntryChannel, cpmActiveCallSummaryIndex=cpmActiveCallSummaryIndex, cpmDS1CurrentBusyout=cpmDS1CurrentBusyout, cpmMIBComplianceRev5=cpmMIBComplianceRev5, cpmDS1OutOctets=cpmDS1OutOctets, cpmDS0BusyoutNotification=cpmDS0BusyoutNotification, cpmActiveCallSummaryEntry=cpmActiveCallSummaryEntry, cpmCallHistorySummaryGroup=cpmCallHistorySummaryGroup, cpmActiveRemotePhoneNumber=cpmActiveRemotePhoneNumber, cpmDS0UsageTable=cpmDS0UsageTable, cpmCallHistorySummaryTableMaxLength=cpmCallHistorySummaryTableMaxLength, cpmActiveTTYNumber=cpmActiveTTYNumber, cpmTTYNumber=cpmTTYNumber, cpmActiveLocalPhoneNumber=cpmActiveLocalPhoneNumber, cpmModemPort=cpmModemPort, cpmLocalPhoneNumber=cpmLocalPhoneNumber, cpmEntryPort=cpmEntryPort, cpmSW56CfgBChannelsInUse=cpmSW56CfgBChannelsInUse, cpmDS1LoopbackNotifyConfigGroup=cpmDS1LoopbackNotifyConfigGroup, cpmCallVolumeGroup=cpmCallVolumeGroup, cpmCallDisconnectTimeIndex=cpmCallDisconnectTimeIndex, cpmDS0BusyoutTime=cpmDS0BusyoutTime, cpmModemNoResource=cpmModemNoResource, cpmActiveEntrySlot=cpmActiveEntrySlot, cpmMIBComplianceRev4=cpmMIBComplianceRev4, cpmMIBComplianceRev1=cpmMIBComplianceRev1, cPopMgmtMIBNotificationPrefix=cPopMgmtMIBNotificationPrefix, PYSNMP_MODULE_ID=ciscoPopMgmtMIB, cpmDS1UsageSlotIndex=cpmDS1UsageSlotIndex, cpmDS1PortIndex=cpmDS1PortIndex, cpmActiveDS0sHighWaterMark=cpmActiveDS0sHighWaterMark, cpmCallVolume=cpmCallVolume, cpmDS1TotalV120Calls=cpmDS1TotalV120Calls, cpmDS1LoopbackNotifyConfig=cpmDS1LoopbackNotifyConfig, cpmActiveEntryPort=cpmActiveEntryPort, ciscoPopMgmtMIBObjects=ciscoPopMgmtMIBObjects, cpmComplianceRev2=cpmComplianceRev2, cpmDS1TotalTimeInUse=cpmDS1TotalTimeInUse, cpmTotalISDNSyncPPPCalls=cpmTotalISDNSyncPPPCalls, cpmMIBComplianceRev3=cpmMIBComplianceRev3, cpmDS0StatusGroup=cpmDS0StatusGroup, cpmActiveModemSlot=cpmActiveModemSlot, cpmActiveCallSummaryGroup=cpmActiveCallSummaryGroup, cpmDS1CurrentIdle=cpmDS1CurrentIdle, cpmNotificationGroup=cpmNotificationGroup, cpmDS1InPackets=cpmDS1InPackets, cpmSystemGroup=cpmSystemGroup, ciscoPopMgmtMIB=ciscoPopMgmtMIB, cpmActiveUserIpAddr=cpmActiveUserIpAddr, cpmUserID=cpmUserID, cpmActiveModemPort=cpmActiveModemPort, cpmActiveCallDuration=cpmActiveCallDuration, cpmInOctets=cpmInOctets, cpmDS0BusyoutAdminStatus=cpmDS0BusyoutAdminStatus, cpmDS0ConfigFunction=cpmDS0ConfigFunction, cpmDS0BusyoutStatus=cpmDS0BusyoutStatus, cpmNotifications=cpmNotifications, cpmCallHistorySummaryEntry=cpmCallHistorySummaryEntry, cpmDS0Usage=cpmDS0Usage, cpmEntryChannel=cpmEntryChannel, cpmDS1TotalV110Calls=cpmDS1TotalV110Calls, cpmActiveUserID=cpmActiveUserID, cpmISDNCfgActiveDChannels=cpmISDNCfgActiveDChannels, cpmISDNCallsClearedAbnormally=cpmISDNCallsClearedAbnormally, cpmDS0UsageGroupRev1=cpmDS0UsageGroupRev1, cpmDS1TotalDigitalCalls=cpmDS1TotalDigitalCalls, cpmCallStartTimeIndex=cpmCallStartTimeIndex)
