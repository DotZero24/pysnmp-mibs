# SNMP MIB module (DNOS-MRP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/DNOS-MRP-MIB
...
fastPathMRP = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 60)
)
...
agentDot1qPortMrpEntry = _AgentDot1qPortMrpEntry_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 60, 1, 1, 1)
)
agentDot1qPortMrpEntry.setIndexNames(
    (0, "DNOS-MRP-MIB", "agentDot1qMrpPort"),
)
if mibBuilder.loadTexts:
...
agentDot1qMrpPort = _AgentDot1qMrpPort_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 60, 1, 1, 1, 1),
...
agentDot1qPortMrpJoinTime = _AgentDot1qPortMrpJoinTime_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 60, 1, 1, 1, 2),
...
agentDot1qPortMrpLeaveTime = _AgentDot1qPortMrpLeaveTime_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 60, 1, 1, 1, 3),
...
agentDot1qPortMrpLeaveAllTime = _AgentDot1qPortMrpLeaveAllTime_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 60, 1, 1, 1, 4),
...
agentDot1qMrpMxrp = _AgentDot1qMrpMxrp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 60, 2)
)
