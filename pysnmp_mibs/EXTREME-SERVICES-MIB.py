...
class _ExtremeDNSServerAddressIndex_Type(Integer32):
    """Custom type extremeDNSServerAddressIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ExtremeDNSServerAddressIndex_Type.__name__ = "Integer32"
