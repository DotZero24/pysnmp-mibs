#
# PySNMP MIB module ALCATEL-ENT1-DA-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-DA-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 09:57:47 2025
# On host macmini.vegmond.io platform Darwin version 24.6.0 by user rob
# Using Python version 3.12.8 (main, Dec  3 2024, 18:42:41) [Clang 16.0.0 (clang-1600.0.26.4)]
#
softentIND1Da, = mibBuilder.importSymbols("ALCATEL-ENT1-BASE", "softentIND1Da")
TmnxEncapVal, = mibBuilder.importSymbols("ALCATEL-ENT1-TIMETRA-TC-MIB", "TmnxEncapVal")
...
alaDaUserNetProfileEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileName"))
...
alaDaUNPIpNetRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpNetRuleAddrType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpNetRuleAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpNetRuleMask"))
...
alaDaUNPMacRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRuleAddr"))
...
alaDaUNPMacRangeRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeRuleLoAddr"))
...
alaDaUNPVlanTagRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 5, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanTagRuleVlan"))
...
alaDaMacUserEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 6, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaMacUserIntfNum"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaMacUserMACAddress"))
...
alaDaUNPPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 7, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPPortIfIndex"))
...
alaDaMacVlanUserEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 9, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserIntfNum"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserMACAddress"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserVlanID"))
...
unpMcLagMacIgnored = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 0, 1)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUnpMacAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpSourceIpAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpNativeVlan"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpVlan"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpMCLAGId"))
if mibBuilder.loadTexts: unpMcLagMacIgnored.setStatus('current')
unpMcLagConfigInconsistency = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 0, 2)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUnpCommandType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpMacAddr1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpMacAddr2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpIpAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpIpMask"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpMCLAGId"))
if mibBuilder.loadTexts: unpMcLagConfigInconsistency.setStatus('current')
alaDaKerberosReqTimeoutTrap = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 0, 3)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaKerberosIpAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserMac"))
if mibBuilder.loadTexts: alaDaKerberosReqTimeoutTrap.setStatus('current')
alaDaKerberosInactivityTimerExpiryTrap = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 0, 4)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserName"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserMac"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserDomain"))
if mibBuilder.loadTexts: alaDaKerberosInactivityTimerExpiryTrap.setStatus('current')
alaDaKerberosRateLimitExceed = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 0, 5)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaKerberosRateLimitString"))
...
alaDaUnpCustomerDomainEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 11, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUnpCustomerDomainId"))
...
alaDaSpbProfileEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 12, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileName"))
...
alaDaUNPCustDomainEvbGpIdRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 13, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainEvbGpIdRuleCustomerDomainId"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainEvbGpIdRuleGroupId"))
...
alaDaUNPCustDomainVlanTagRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 14, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleDomainId"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleVlan"))
...
alaDaUNPCustDomainIpNetRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 15, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleDomainId"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleAddrType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleMask"))
...
alaDaUNPCustDomainMacRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 16, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleDomainId"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleAddr"))
...
alaDaUNPCustDomainMacRangeRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 17, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleDomainId"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleLoAddr"))
...
alaDaSaaProfileEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 18, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaSaaProfileName"))
...
alaDaCPortalAuthPassEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 19, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaCPortalAuthDomainName"))
...
alaDaCPortalProfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 19, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfName"))
...
alaDaCPortalProfDomainEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 19, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfName"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfDomainAuthDomainName"))
...
alaDaHICSvrEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 20, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaHICSvrName"))
...
alaDaHICAllowedEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 20, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaHICAllowedName"))
...
alaDaHICSvrFailPolicyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 20, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaHICSvrFailPolicyName"))
...
alaDaHICHostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 20, 5, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaHICHostMac"))
...
alaDaUNPETmplEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 21, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplName"))
...
alaDaUNPEdgeProfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 22, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfName"))
...
alaDaUNPPortRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 23, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPPortRuleNum"))
...
alaDaUNPGroupRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 24, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPGroupRuleId"))
...
alaDaUNPMacOuiRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 25, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacOuiRuleAddr"))
...
alaDaUNPEndPoinRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 26, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPEndPoinRuleId"))
...
alaDaUNPAuthRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 27, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthRuleType"))
...
alaDaUNPClassifRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 28, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleName"))
...
alaDaUNPMacPortRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 29, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacPortRuleMacAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacPortRuleNum"))
...
alaDaUNPIpPortRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 30, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleAddrType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleNum"))
...
alaDaUNPMacIpPortRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 31, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleMacAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleAddrIpType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleIpAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleNum"))
...
alaDaUNPMacGroupRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 32, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacGroupRuleAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacGroupRuleId"))
...
alaDaUNPIpGroupRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 33, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpGroupRuleAddrType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpGroupRuleAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpGroupRuleNum"))
...
alaDaUNPMacIpGroupRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 34, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpGroupRuleMacAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpGroupRuleIpAddrType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpGroupRuleIpAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpGroupRuleId"))
...
alaDaUNPUserRoleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 35, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRoleName"))
...
alaDaUNPRstrctedRoleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 36, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPRstrctedRoleType"))
...
alaDaUNPVlanMapEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 37, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanMapEdgeProf"))
...
alaDaUnpGroupIdEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 38, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUnpGroupId"))
...
alaDaUNPEdgeFlushEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 39, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeFlushIndex"))
...
alaDaUNPMacRulesEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 40, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRulesMacAddr"))
...
alaDaUNPMacRangeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 41, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeStartMacAddr"))
...
alaDaUNPIpMaskRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 42, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpMaskRuleAddrType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpMaskRuleAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpMaskRuleMaskType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPIpMaskRuleMask"))
...
alaDaQMRAllowedEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 43, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaQMRAllowedName"))
...
alaDaUNPValidityPeriodEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 44, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodName"))
...
alaDaUNPLocationPolicyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 45, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPLocationPolicyName"))
...
alaDaUNPRedirectAllowedServerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 46, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectAllowedServerName"))
...
alaDaMacVlanUserExtEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 47, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserExtIntfNum"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserExtMACAddress"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserExtVlanID"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserExtAppID"))
...
alaDaUNPVxlanProfileEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 48, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileName"))
...
alaDaUNPVxlanFlushEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 49, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFlushIndex"))
...
alaDaUNPVxlanFarEndIPListEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 50, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFarEndIPListName"))
...
alaDaUNPVxlanFarEndIPAddressListEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 51, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFarEndIPListName"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFarEndIPAddressListIPType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFarEndIPAddressListIP"))
...
alaDaUNPSpbFlushEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 52, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPSpbFlushIndex"))
...
alaDaKerberosPolicyConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 53, 2, 1), ).setIndexNames((1, "ALCATEL-ENT1-DA-MIB", "alaDaKerberosPolicyDomainName"))
...
alaDaKerberosUserEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 53, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserMac"))
...
alaDaKerberosPortStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 53, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaKerberosStatsIfIndex"))
...
alaDaKerberosServerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 53, 5, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaKerberosIpAddressType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaKerberosIpAddress"))
...
alaDaUNPPortVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 54, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPPortIfIndex"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPPortVlanVID"))
...
alaDaUNPVlanRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 55, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanRuleVlanTag"))
...
alaDaUNPETmplVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 56, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplName"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplVlanVID"))
...
alaDaUNPUserFlushEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 57, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushIndex"))
...
alaDaUNPCustDomainRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 58, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainRuleId"))
...
alaDaUNPPortTemplateEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 59, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateName"))
...
alaDaUNPProfileEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 60, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileName"))
...
alaDaUNPProfileMapVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 61, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileName"))
...
alaDaUNPProfileMapSpbEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 62, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileName"))
...
alaDaUNPProfileMapVxlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 63, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileName"))
...
alaDaUNPProfileMapStaticEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 64, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileName"))
...
alaDaUNPCustDomainMacIpRuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 65, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleMacAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleIpAddrType"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleIpAddr"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleDomainId"))
...
alaDaUNPPortTemplateVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 1, 66, 1), ).setIndexNames((0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateName"), (0, "ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateVlanVID"))
...
alaIND1DaMIBCompliances = ModuleCompliance((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 2)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpNetRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanTagGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacUserGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPGlobalGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaNotificationObjectGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaNotificationsGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpCustomerDomainGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainEvbGpIdRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaSaaProfileGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeTemplateGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfileGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassificationRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPGroupIdEdgeClassifyGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacOuiGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEndPointGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacPortClassifyGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortClassifyGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpClassifyGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacClassifyGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpAddressGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRoleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRestrictedRoleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanMappingGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeFlushGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacAddrsRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangesGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpMaskGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaQMRGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPLocationPolicyGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectAllowedServerGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserExtGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortVlanGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplVlanGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVlanGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapSpbGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVxlanGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapStaticGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleGroup"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateVlanGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIND1DaMIBCompliances = alaIND1DaMIBCompliances.setStatus('current')
alaDaUserNetProfileGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 1)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileVlanID"), ("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileQosPolicyListName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileMCLagConfigStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileSaaProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileMobileTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileMaxIngressBw"), ("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileMaxEgressBw"), ("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileMaxIngressDepth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUserNetProfileMaxEgressDepth"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUserNetProfileGroup = alaDaUserNetProfileGroup.setStatus('deprecated')
alaDaUNPIpNetRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 2)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpNetRuleProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpNetRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpNetRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpNetRuleMCLagConfigStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPIpNetRuleGroup = alaDaUNPIpNetRuleGroup.setStatus('current')
alaDaUNPMacRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 3)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRuleProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRuleMCLagConfigStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPMacRuleGroup = alaDaUNPMacRuleGroup.setStatus('current')
alaDaUNPMacRangeGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 4)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeRuleHiAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeRuleProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeRuleMCLagConfigStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPMacRangeGroup = alaDaUNPMacRangeGroup.setStatus('current')
alaDaUNPVlanTagGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 5)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanTagRuleProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanTagRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanTagRuleMCLagConfigStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPVlanTagGroup = alaDaUNPVlanTagGroup.setStatus('current')
alaDaMacUserGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 6)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaMacUserVlanID"), ("ALCATEL-ENT1-DA-MIB", "alaDaAuthenticationStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacUserIpAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacUserUnpUsed"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacUserLoginTimeStamp"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacUserAuthtype"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacUserClassificationSource"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacUserName"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaMacUserGroup = alaDaMacUserGroup.setStatus('current')
alaDaUNPPortGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 7)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortDefaultProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortPassAltProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMacAuthFlag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortClassificationFlag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTrustTagStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMCLagConfigStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPPortGroup = alaDaUNPPortGroup.setStatus('current')
alaDaUNPGlobalGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 8)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPDynamicVlanConfigFlag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthServerDownUnp"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthServerDownTimeout"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPDynamicVlanMCLagConfigStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthServerDownUNPMCLagConfigStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthServerDownTimeoutMCLagConfigStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPDynamicProfileConfigFlag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPDynamicProfileConfigMCLagConfigStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPReloadVsiTypeDB"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthSrvDownEdgeProfName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthServerDowneEdgeProfTimeout"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeUserFlush"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNP8021XEdgeUserFlush"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacEdgeUserFlush"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPNoAuthEdgeUserFlush"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectPortBounce"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectPauseTimer"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectProxyServerPort"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectServerIPType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectServerIP"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthSrvDownVxlanProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthSrvDownVxlanProfileTimeout"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPForceL3Learning"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPForceL3LearningPortBounce"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthServerDownProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthServerDownProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthServerDownProfile3"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanUserFlush"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPGlobalGroup = alaDaUNPGlobalGroup.setStatus('current')
alaDaNotificationObjectGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 9)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUnpMacAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpSourceIpAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpNativeVlan"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpVlan"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpMCLAGId"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpCommandType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpMacAddr1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpMacAddr2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpIpAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpIpMask"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosRateLimitString"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaNotificationObjectGroup = alaDaNotificationObjectGroup.setStatus('current')
alaDaNotificationsGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 10)).setObjects(("ALCATEL-ENT1-DA-MIB", "unpMcLagMacIgnored"), ("ALCATEL-ENT1-DA-MIB", "unpMcLagConfigInconsistency"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosReqTimeoutTrap"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosInactivityTimerExpiryTrap"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosRateLimitExceed"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaNotificationsGroup = alaDaNotificationsGroup.setStatus('current')
alaDaMacVlanUserGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 11)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserAuthStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserIpAddressType"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserIpAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserUnpUsed"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserLoginTimeStamp"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserAuthtype"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserClassificationSource"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserMCLagLearningLoc"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserName"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserRole"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserRoleSource"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserAuthFailReason"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserAuthRetryCount"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserClassifProfRule"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserRoleRule"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserRestAccessStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserLocPolicyStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserTimePolicyStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserCapPortalStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserQMRStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserAuthServerIpType"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserAuthServerIpUsed"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserAuthServerUsed"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserServerMessage"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserRedirectionUrl"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserSIPCallType"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserSIPMediaType"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserUnpFromAuthServer"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserType"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserServiceID"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserServiceSapIDIfIndex"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserServiceSapIDEncapVal"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserVxlanVnid"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserSpbIsid"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserSpbBVlan"), ("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserKerberosStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaMacVlanUserGroup = alaDaMacVlanUserGroup.setStatus('current')
alaDaUnpCustomerDomainGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 12)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUnpCustomerDomainDesc"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpCustomerDomainRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUnpCustomerDomainGroup = alaDaUnpCustomerDomainGroup.setStatus('current')
alaDaSpbProfileGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 13)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileEncapVal"), ("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileQosPolicyListName"), ("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileIsid"), ("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileBVlan"), ("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileMulticastMode"), ("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileSapVlanXlation"), ("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileMobileTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaSpbProfileAFDConfig"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaSpbProfileGroup = alaDaSpbProfileGroup.setStatus('deprecated')
alaDaUNPCustDomainEvbGpIdRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 14)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainEvbGpIdRuleVlanProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainEvbGpIdRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainEvbGpIdRuleSpbProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainEvbGpIdRuleVxlanProfileName"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPCustDomainEvbGpIdRuleGroup = alaDaUNPCustDomainEvbGpIdRuleGroup.setStatus('current')
alaDaUNPCustDomainVlanTagRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 15)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleVlanProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleSpbProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleMCLagConfigStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleTagPosition"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleVxlanProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainVlanTagRuleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPCustDomainVlanTagRuleGroup = alaDaUNPCustDomainVlanTagRuleGroup.setStatus('current')
alaDaUNPCustDomainIpNetRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 16)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleSpbProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleMCLagConfigStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleEdgeProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleVxlanProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainIpNetRuleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPCustDomainIpNetRuleGroup = alaDaUNPCustDomainIpNetRuleGroup.setStatus('current')
alaDaUNPCustDomainMacRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 17)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleSpbProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleMCLagConfigStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleEdgeProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleVxlanProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRuleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPCustDomainMacRuleGroup = alaDaUNPCustDomainMacRuleGroup.setStatus('current')
alaDaUNPCustDomainMacRangeGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 18)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleHiAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleSpbProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleMCLagConfigStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleEdgeProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleVxlanProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacRangeRuleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPCustDomainMacRangeGroup = alaDaUNPCustDomainMacRangeGroup.setStatus('current')
alaDaUNPGroupObjects = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 19)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortCustomerDomainId"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortPassAltSpbProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortDefaultSpbProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortDefaultEdgeProfName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMacPassEdgeProfName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XEdgeProfName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XAuthStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XTxPeriodStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XTxPeriod"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XSuppTimeoutStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XSuppTimeOut"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XMaxReqStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XMaxReq"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortGroupId"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortAaaProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortEdgeTemplate"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortRedirectPortBounce"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XFailurePolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XBypassStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMacAllowEap"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortAdminControlledDirections"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortAdminControlledOperDirections"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XPassAltUserNetProfName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XPassAltSpbProfName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XPassAltVxlanProfName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortPassAltVxlanProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortDefaultVxlanProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortAFDConfig"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMaxIngressBw"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMaxIngressBwSource"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMaxEgressBw"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMaxEgressBwSource"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMaxIngressDepth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortMaxEgressDepth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortIngressSourceProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortEgressSourceProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortForceL3Learning"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortForceL3LearningPortBounce"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPort8021XPassAltProfileName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortPortTemplateName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortDomainID"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortAdminState"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortDynamicService"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortPVlanPortType"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPGroupObjects = alaDaUNPGroupObjects.setStatus('current')
alaDaSaaProfileGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 20)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaSaaProfileLatencyThreshold"), ("ALCATEL-ENT1-DA-MIB", "alaDaSaaProfileJitterThreshold"), ("ALCATEL-ENT1-DA-MIB", "alaDaSaaProfileRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaSaaProfileGroup = alaDaSaaProfileGroup.setStatus('current')
alaDaCPortalGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 21)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaCPortalRedirectUrlName"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalIpAddressType"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalIpAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalMode"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalSuccRedirectUrl"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProxyPort"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalPolicyListName"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalRetryCnt"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalAuthRealm"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalAuthPolicyListName"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalAuthRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalAuthUNPProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalAuthUNPProfileChange"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfMode"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfSuccRedirectUrl"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfRetryCnt"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfAuthPolicyListName"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfAaaProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfDomainAuthPolicyListName"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfDomainAuthRealm"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfDomainRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalCustomization"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfUNPProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfUNPProfileChange"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalUNPProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalUNPProfileChange"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfDomainUNPProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaCPortalProfDomainUNPProfileChange"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaCPortalGroup = alaDaCPortalGroup.setStatus('current')
alaDaHICGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 22)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaHICStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICWebAgentDownloadUrl"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICCustomHttpProxyPort"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICBgPollInterval"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrFailMode"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrIpAddrType"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrIpAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrPort"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrKey"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrRole"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrConnection"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICAllowedIpAddrType"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICAllowedIpAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICAllowedIpMaskType"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICAllowedIpMask"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICAllowedRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrFailChangedPolicyName"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICSvrFailRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaHICHostStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaHICGroup = alaDaHICGroup.setStatus('current')
alaDaUNPEdgeTemplateGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 23)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmpl8021XAuthStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmpl8021XTxPeriodStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmpl8021XTxPeriod"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmpl8021XSuppTimeoutStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmpl8021XSuppTimeOut"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmpl8021XMaxReqStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmpl8021XMaxReq"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmpl8021XPassAltEProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplMacAuthStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplMacPassAltEProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplClassifStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplDefEProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplGroupId"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplAaaProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplRedirectPortBounce"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplFailurePolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplBypassStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplMacAllowEap"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplAdminControlledDirections"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplTrustTagStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplForceL3Learning"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplForceL3LearningPortBounce"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPEdgeTemplateGroup = alaDaUNPEdgeTemplateGroup.setStatus('deprecated')
alaDaUNPEdgeProfileGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 24)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfQosPolicyList"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfLocationPolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfPeriodPolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfHICStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfCPortalAuth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfAuthStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfMobileTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfDHCPEnforcment"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfCPortalProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfRedirectStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfKerberosStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfMaxIngressBw"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfMaxEgressBw"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfMaxIngressDepth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeProfMaxEgressDepth"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPEdgeProfileGroup = alaDaUNPEdgeProfileGroup.setStatus('deprecated')
alaDaUNPClassificationRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 25)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortRuleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPClassificationRuleGroup = alaDaUNPClassificationRuleGroup.setStatus('current')
alaDaUNPGroupIdEdgeClassifyGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 26)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPGroupRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPGroupRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPGroupRuleVlanTag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPGroupIdEdgeClassifyGroup = alaDaUNPGroupIdEdgeClassifyGroup.setStatus('deprecated')
alaDaUNPMacOuiGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 27)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacOuiRuleEdgeProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacOuiRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacOuiRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacOuiRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacOuiRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacOuiRuleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPMacOuiGroup = alaDaUNPMacOuiGroup.setStatus('current')
alaDaUNPEndPointGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 28)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPEndPoinEdgeProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEndPoinRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEndPoinProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEndPoinProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEndPoinProfile3"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEndPoinVlanTag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPEndPointGroup = alaDaUNPEndPointGroup.setStatus('current')
alaDaUNPAuthRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 29)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthRuleEdgeProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPAuthRuleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPAuthRuleGroup = alaDaUNPAuthRuleGroup.setStatus('current')
alaDaUNPRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 30)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRulePrecedenceNum"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleEdgeProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRulePort"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRulePortHigh"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleGroupId"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleMacAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleMacRngLoaddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleMacRngHiaddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleMacOuiAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleEndPoin"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleAuthType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleIpAddressType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleIpAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleIpMaskType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleIpMask"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleCustomerDomain"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPClassifRuleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPRuleGroup = alaDaUNPRuleGroup.setStatus('current')
alaDaUNPMacPortClassifyGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 31)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacPortRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacPortRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacPortRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacPortRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacPortRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacPortRuleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPMacPortClassifyGroup = alaDaUNPMacPortClassifyGroup.setStatus('current')
alaDaUNPIpPortClassifyGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 32)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleProfile3"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleMaskType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpPortRuleMask"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPIpPortClassifyGroup = alaDaUNPIpPortClassifyGroup.setStatus('current')
alaDaUNPMacIpClassifyGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 33)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleProfile3"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleIpMaskType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpPortRuleIpMask"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPMacIpClassifyGroup = alaDaUNPMacIpClassifyGroup.setStatus('current')
alaDaUNPMacClassifyGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 34)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacGroupRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacGroupRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacGroupRuleVlanTag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPMacClassifyGroup = alaDaUNPMacClassifyGroup.setStatus('deprecated')
alaDaUNPIpAddressGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 35)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpGroupRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpGroupRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpGroupRuleVlanTag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPIpAddressGroup = alaDaUNPIpAddressGroup.setStatus('deprecated')
alaDaUNPMacIpGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 36)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpGroupRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpGroupRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacIpGroupRuleVlanTag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPMacIpGroup = alaDaUNPMacIpGroup.setStatus('deprecated')
alaDaUNPUserRoleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 37)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRolePrecedenceNum"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRolePolicyList"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRoleEdgeProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRoleAuthType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRolePostLoginStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRoleKerberosPostLoginStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRoleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRoleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRoleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserRoleProfile3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPUserRoleGroup = alaDaUNPUserRoleGroup.setStatus('current')
alaDaUNPRestrictedRoleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 38)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPRstrctedRolePolicyList"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRstrctedRoleRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPRestrictedRoleGroup = alaDaUNPRestrictedRoleGroup.setStatus('current')
alaDaUNPVlanMappingGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 39)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanMapIdent"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanMapRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPVlanMappingGroup = alaDaUNPVlanMappingGroup.setStatus('deprecated')
alaDaUNPGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 40)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUnpGroupDescription"), ("ALCATEL-ENT1-DA-MIB", "alaDaUnpGroupIdRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPGroup = alaDaUNPGroup.setStatus('deprecated')
alaDaUNPEdgeFlushGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 41)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeFlushPortLow"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeFlushPortHigh"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeFlushType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgrFlushMac"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeFlushComplete"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPEdgeFlushProfile"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPEdgeFlushGroup = alaDaUNPEdgeFlushGroup.setStatus('current')
alaDaUNPMacAddrsRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 42)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRulesEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRulesRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRulesVlanTag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPMacAddrsRuleGroup = alaDaUNPMacAddrsRuleGroup.setStatus('deprecated')
alaDaUNPMacRangesGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 43)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeEndMacAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPMacRangeVlanTag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPMacRangesGroup = alaDaUNPMacRangesGroup.setStatus('deprecated')
alaDaUNPIpMaskGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 44)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpMaskRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpMaskRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPIpMaskRuleVlanTag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPIpMaskGroup = alaDaUNPIpMaskGroup.setStatus('deprecated')
alaDaQMRGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 45)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaQMRPage"), ("ALCATEL-ENT1-DA-MIB", "alaDaQMRPath"), ("ALCATEL-ENT1-DA-MIB", "alaDaQMRCustomHttpProxyPort"), ("ALCATEL-ENT1-DA-MIB", "alaDaQMRPolicyList"), ("ALCATEL-ENT1-DA-MIB", "alaDaQMRAllowedIpAddrType"), ("ALCATEL-ENT1-DA-MIB", "alaDaQMRAllowedIpAddr"), ("ALCATEL-ENT1-DA-MIB", "alaDaQMRAllowedIpMaskType"), ("ALCATEL-ENT1-DA-MIB", "alaDaQMRAllowedIpMask"), ("ALCATEL-ENT1-DA-MIB", "alaDaQMRAllowedRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaQMRGroup = alaDaQMRGroup.setStatus('current')
alaDaUNPValidityPeriodGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 46)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodDays"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodDaysStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodMonths"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodMonthsStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodHour"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodHourStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodEndHour"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodInterval"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodIntervalStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodEndInterval"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodTimezone"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodTimezoneStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodActiveStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPValidityPeriodRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPValidityPeriodGroup = alaDaUNPValidityPeriodGroup.setStatus('current')
alaDaUNPLocationPolicyGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 47)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPLocationPolicyPort"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPLocationPolicyPortHigh"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPLocationPolicyPortStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPLocationPolicySystemName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPLocationPolicySystemLocation"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPLocationPolicyRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPLocationPolicyGroup = alaDaUNPLocationPolicyGroup.setStatus('current')
alaDaUNPRedirectAllowedServerGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 48)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectAllowedServerIPType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectAllowedServerIP"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectAllowedMaskIPType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectAllowedMaskIP"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPRedirectAllowedRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPRedirectAllowedServerGroup = alaDaUNPRedirectAllowedServerGroup.setStatus('current')
alaDaMacVlanUserExtGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 49)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaMacVlanUserExtAppName"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaMacVlanUserExtGroup = alaDaMacVlanUserExtGroup.setStatus('current')
alaDaUNPVxlanProfileGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 50)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileEncapVal"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileVnid"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileQosPolicyListName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileFarEndIPListName"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileMulticastIPAddressType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileMulticastIPAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileSapVlanXlation"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileMobileTagStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileMulticastMode"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanProfileRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPVxlanProfileGroup = alaDaUNPVxlanProfileGroup.setStatus('deprecated')
alaDaUNPVxlanFlushGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 51)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFlushComplete"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFlushAuthType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFlushMacAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFlushSapIDIfIndex"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFlushSapIDEncapVal"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFlushServiceID"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFlushVxlanProfile"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPVxlanFlushGroup = alaDaUNPVxlanFlushGroup.setStatus('deprecated')
alaDaUNPVxlanFarEndIPListGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 52)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFarEndIPListIPAddressCount"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFarEndIPListRemove"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPVxlanFarEndIPListGroup = alaDaUNPVxlanFarEndIPListGroup.setStatus('current')
alaDaUNPVxlanFarEndIPAddressListGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 53)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPVxlanFarEndIPAddressListRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPVxlanFarEndIPAddressListGroup = alaDaUNPVxlanFarEndIPAddressListGroup.setStatus('current')
alaDaUNPSpbFlushGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 54)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPSpbFlushComplete"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPSpbFlushAuthType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPSpbFlushMacAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPSpbFlushSapIDIfIndex"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPSpbFlushSapIDEncapVal"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPSpbFlushServiceID"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPSpbFlushSpbProfile"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPSpbFlushGroup = alaDaUNPSpbFlushGroup.setStatus('deprecated')
alaDaKerberosGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 55)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaKerberosGlobalMacMoveStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosGlobalInactivityTimer"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosGlobalPolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosGlobalPolicyStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosClientPktHwDiscardStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosServerPktHwDiscardStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosTotalClientPktRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosTotalServerPktRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosClientPktSwDiscardStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosServerPktSwDiscardStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosTotalASREQRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosTotalASREPRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosTotalTGSREQRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosTotalTGSREPRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosTotalErrorRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosGlobalClearStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosGlobalClearPortStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosGlobalServerTimeoutTimer"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPolicyName"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPolicyStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPolicyRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserPort"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserName"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserDomain"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserAuthState"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserPolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserLeftTime"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUserState"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortClearStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortClientPktRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortServerPktRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortClientPktSwDiscardStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortServerPktSwDiscardStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortASREQRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortASREPRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortTGSREQRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortTGSREPRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosPortErrorRxStats"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosUdpPort"), ("ALCATEL-ENT1-DA-MIB", "alaDaKerberosRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaKerberosGroup = alaDaKerberosGroup.setStatus('current')
alaDaUNPVlanGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 56)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanRuleVlanTagPosition"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanRuleEdgeProf"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPVlanRuleRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPVlanGroup = alaDaUNPVlanGroup.setStatus('current')
alaDaUNPPortVlanGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 57)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortVlanRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPPortVlanGroup = alaDaUNPPortVlanGroup.setStatus('current')
alaDaUNPETmplVlanGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 58)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPETmplVlanRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPETmplVlanGroup = alaDaUNPETmplVlanGroup.setStatus('current')
alaDaUNPUserFlushGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 59)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushComplete"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushAuthType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushMacAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushPortStart"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushPortEnd"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushSapIDIfIndex"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushSapIDEncapVal"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPUserFlushServiceID"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPUserFlushGroup = alaDaUNPUserFlushGroup.setStatus('current')
alaDaUNPCustDomainRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 60)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainRuleProfile3"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainRuleRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPCustDomainRuleGroup = alaDaUNPCustDomainRuleGroup.setStatus('current')
alaDaUNPPortTemplateGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 61)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateAdminState"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateDirection"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateDomainID"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateClassification"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateTrustTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateDynamicService"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateDefaultProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateAAAProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateRedirectPortBounce"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplate8021XAuth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplate8021XAuthPassAlternate"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplate8021XAuthBypass"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplate8021XAuthFailPolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplate8021XAuthTxPeriod"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplate8021XAuthSuppTimeout"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplate8021XAuthMaxReq"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateMACAuth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateMACAuthPassAlternate"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateMACAuthAllowEAP"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateForceL3Learning"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateForceL3LearningPortBounce"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPPortTemplateGroup = alaDaUNPPortTemplateGroup.setStatus('current')
alaDaUNPProfileGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 62)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileAuthenticationFlag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMobileTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileCPortalAuthentication"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileRedirect"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileQoSPolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfilePeriodPolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileCPortalProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileLocationPolicy"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileSaaProfile"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileInactivityInterval"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileKerberosAuthentication"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMaxIngressBandwidth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMaxEgressBandwidth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMaxIngressDepth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMaxEgressDepth"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileAFDConfig"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPProfileGroup = alaDaUNPProfileGroup.setStatus('current')
alaDaUNPProfileMapVlanGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 63)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVlanVlanID"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVlanRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPProfileMapVlanGroup = alaDaUNPProfileMapVlanGroup.setStatus('current')
alaDaUNPProfileMapSpbGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 64)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapSpbEncapVal"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapSpbIsid"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapSpbBVlan"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapSpbMulticastMode"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapSpbVlanXlation"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapSpbRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPProfileMapSpbGroup = alaDaUNPProfileMapSpbGroup.setStatus('current')
alaDaUNPProfileMapVxlanGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 65)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVxlanEncapVal"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVxlanVnid"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVxlanFarEndIPList"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVxlanMulticastIPAddressType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVxlanMulticastIPAddress"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVxlanVlanXlation"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVxlanMulticastMode"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapVxlanRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPProfileMapVxlanGroup = alaDaUNPProfileMapVxlanGroup.setStatus('current')
alaDaUNPProfileMapStaticGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 66)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapStaticEncapVal"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapStaticServiceID"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPProfileMapStaticRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPProfileMapStaticGroup = alaDaUNPProfileMapStaticGroup.setStatus('current')
alaDaUNPCustDomainMacIpRuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 67)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleVlanTag"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleProfile1"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleProfile2"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleProfile3"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleRowStatus"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleIpMaskType"), ("ALCATEL-ENT1-DA-MIB", "alaDaUNPCustDomainMacIpRuleIpMask"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPCustDomainMacIpRuleGroup = alaDaUNPCustDomainMacIpRuleGroup.setStatus('current')
alaDaUNPPortTemplateVlanGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 63, 1, 2, 1, 68)).setObjects(("ALCATEL-ENT1-DA-MIB", "alaDaUNPPortTemplateVlanRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDaUNPPortTemplateVlanGroup = alaDaUNPPortTemplateVlanGroup.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-DA-MIB", alaDaUNPPortTemplateVlanRowStatus=alaDaUNPPortTemplateVlanRowStatus, alaDaUNPProfileMapStaticRowStatus=alaDaUNPProfileMapStaticRowStatus, alaDaUNPPort8021XPassAltSpbProfName=alaDaUNPPort8021XPassAltSpbProfName, alaDaUNPPortIngressSourceProfile=alaDaUNPPortIngressSourceProfile, alaDaUNPAuthServerDownTimeout=alaDaUNPAuthServerDownTimeout, alaDaUNPCustDomainMacRuleProfileName=alaDaUNPCustDomainMacRuleProfileName, alaDaCPortalIpAddress=alaDaCPortalIpAddress, alaDaUNPUserFlushEntry=alaDaUNPUserFlushEntry, alaDaUNPVlanMapEdgeProf=alaDaUNPVlanMapEdgeProf, alaDaUNPCustDomainIpNetRuleAddr=alaDaUNPCustDomainIpNetRuleAddr, alaDaMacVlanUserServerMessage=alaDaMacVlanUserServerMessage, alaDaSaaProfileRowStatus=alaDaSaaProfileRowStatus, alaDaKerberosGlobalMacMoveStatus=alaDaKerberosGlobalMacMoveStatus, alaDaUNPValidityPeriodHour=alaDaUNPValidityPeriodHour, alaDaUNPValidityPeriodEntry=alaDaUNPValidityPeriodEntry, alaDaKerberosUserEntry=alaDaKerberosUserEntry, alaDaCPortalProfUNPProfile=alaDaCPortalProfUNPProfile, alaDaUNPCustDomainVlanTagRuleRowStatus=alaDaUNPCustDomainVlanTagRuleRowStatus, alaDaUNPIpPortRuleAddr=alaDaUNPIpPortRuleAddr, alaDaUNPVxlanProfileMulticastIPAddressType=alaDaUNPVxlanProfileMulticastIPAddressType, alaDaKerberosUserPolicy=alaDaKerberosUserPolicy, alaDaUNPETmpl8021XPassAltEProf=alaDaUNPETmpl8021XPassAltEProf, alaDaUNPPortTrustTagStatus=alaDaUNPPortTrustTagStatus, alaDaUNPMacPortRuleNum=alaDaUNPMacPortRuleNum, alaDaUNPPortTemplateName=alaDaUNPPortTemplateName, alaDaUNPProfileMapVlanTable=alaDaUNPProfileMapVlanTable, alaDaUNPClassifRuleEdgeProfile=alaDaUNPClassifRuleEdgeProfile, alaDaUNPAuthServerDownTimeoutMCLagConfigStatus=alaDaUNPAuthServerDownTimeoutMCLagConfigStatus, alaDaCPortalMode=alaDaCPortalMode, alaDaUnpGroupIdTable=alaDaUnpGroupIdTable, alaDaUnpVlan=alaDaUnpVlan, alaDaUNPPortTemplateForceL3LearningPortBounce=alaDaUNPPortTemplateForceL3LearningPortBounce, alaDaUNPPortTemplateTable=alaDaUNPPortTemplateTable, alaDaUNPCustDomainMacRuleTable=alaDaUNPCustDomainMacRuleTable, alaDaUNPVxlanFarEndIPListRemove=alaDaUNPVxlanFarEndIPListRemove, alaDaUNPPortGroupId=alaDaUNPPortGroupId, alaDaKerberosPortErrorRxStats=alaDaKerberosPortErrorRxStats, alaDaUNPMacPortRuleProfile3=alaDaUNPMacPortRuleProfile3, alaDaUNPRedirectAllowedServerTable=alaDaUNPRedirectAllowedServerTable, alaDaUNPSpbFlushGroup=alaDaUNPSpbFlushGroup, alaDaUNPVxlanFlushVxlanProfile=alaDaUNPVxlanFlushVxlanProfile, alaDaKerberosClientPktHwDiscardStats=alaDaKerberosClientPktHwDiscardStats, alaDaUNPPortForceL3LearningPortBounce=alaDaUNPPortForceL3LearningPortBounce, alaDaUNPProfileMaxEgressDepth=alaDaUNPProfileMaxEgressDepth, alaDaUNPClassifRuleProfile2=alaDaUNPClassifRuleProfile2, alaDaUNPVlanTagRuleProfileName=alaDaUNPVlanTagRuleProfileName, alaDaCPortalProfDomainTable=alaDaCPortalProfDomainTable, alaDaCPortalAuthDomainName=alaDaCPortalAuthDomainName, alaDaUNPProfileMapStaticEncapVal=alaDaUNPProfileMapStaticEncapVal, alaDaUNPETmplEntry=alaDaUNPETmplEntry, alaDaUNPGroupRuleTable=alaDaUNPGroupRuleTable, alaDaUNPUserRoleKerberosPostLoginStatus=alaDaUNPUserRoleKerberosPostLoginStatus, alaDaUNPCustDomainMacRuleEntry=alaDaUNPCustDomainMacRuleEntry, alaDaUNPEndPoinEdgeProfile=alaDaUNPEndPoinEdgeProfile, alaDaUNPAuthRuleEntry=alaDaUNPAuthRuleEntry, alaDaUNPPortMacPassEdgeProfName=alaDaUNPPortMacPassEdgeProfName, alaDaUNPRstrctedRoleEntry=alaDaUNPRstrctedRoleEntry, alaDaHICSvrName=alaDaHICSvrName, alaDaUNPIpGroupRuleVlanTag=alaDaUNPIpGroupRuleVlanTag, alaDaUNPMacRangeRuleHiAddr=alaDaUNPMacRangeRuleHiAddr, alaDaMacUserName=alaDaMacUserName, alaDaUNPCustDomainRuleVlanTag=alaDaUNPCustDomainRuleVlanTag, alaDaUNPMacIpGroupRuleId=alaDaUNPMacIpGroupRuleId, alaDaUNPMacRulesEntry=alaDaUNPMacRulesEntry, alaDaKerberosServerPktHwDiscardStats=alaDaKerberosServerPktHwDiscardStats, alaDaQMRAllowedIpAddr=alaDaQMRAllowedIpAddr, alaDaUNPCustDomainVlanTagRuleGroup=alaDaUNPCustDomainVlanTagRuleGroup, alaDaUNPCustDomainIpNetRuleProfile3=alaDaUNPCustDomainIpNetRuleProfile3, alaDaKerberosUserLeftTime=alaDaKerberosUserLeftTime, alaDaHICSvrFailPolicyName=alaDaHICSvrFailPolicyName, alaDaSpbProfileSapVlanXlation=alaDaSpbProfileSapVlanXlation, AlaDaAuthenticationType=AlaDaAuthenticationType, alaDaUNPMacIpPortRuleEdgeProf=alaDaUNPMacIpPortRuleEdgeProf, alaDaUNPPortMaxIngressBw=alaDaUNPPortMaxIngressBw, alaDaUNPCustDomainMacRuleVlanTag=alaDaUNPCustDomainMacRuleVlanTag, alaDaUNPETmplMacAuthStatus=alaDaUNPETmplMacAuthStatus, alaDaUNPUserRolePostLoginStatus=alaDaUNPUserRolePostLoginStatus, alaDaUNPPortVlanTable=alaDaUNPPortVlanTable, alaDaMacVlanUserTimePolicyStatus=alaDaMacVlanUserTimePolicyStatus, alaDaUNPCustDomainMacRangeRuleRowStatus=alaDaUNPCustDomainMacRangeRuleRowStatus, alaDaUNPPortVlanVID=alaDaUNPPortVlanVID, alaDaUNPCustDomainEvbGpIdRuleTable=alaDaUNPCustDomainEvbGpIdRuleTable, alaDaKerberosStatsIfIndex=alaDaKerberosStatsIfIndex, alaDaUNPIpGroupRuleNum=alaDaUNPIpGroupRuleNum, alaDaUNPETmplDefEProf=alaDaUNPETmplDefEProf, alaDaUNPAuthServerDownUNPMCLagConfigStatus=alaDaUNPAuthServerDownUNPMCLagConfigStatus, alaDaUNPVxlanFlushEntry=alaDaUNPVxlanFlushEntry, alaDaKerberosTotalTGSREPRxStats=alaDaKerberosTotalTGSREPRxStats, alaDaHICAllowedIpMaskType=alaDaHICAllowedIpMaskType, alaDaUNPEdgeProfRedirectStatus=alaDaUNPEdgeProfRedirectStatus, alaDaKerberosGlobalPolicyStatus=alaDaKerberosGlobalPolicyStatus, alaDaUNPUserFlushServiceID=alaDaUNPUserFlushServiceID, alaDaUNPPortRuleNum=alaDaUNPPortRuleNum, alaDaUNPPortTemplate8021XAuthMaxReq=alaDaUNPPortTemplate8021XAuthMaxReq, alaDaUNPVxlanFarEndIPListName=alaDaUNPVxlanFarEndIPListName, alaDaUNPMacOuiGroup=alaDaUNPMacOuiGroup, alaDaUNPRuleGroup=alaDaUNPRuleGroup, alaDaQMRPage=alaDaQMRPage, alaDaUNPMacRangeRuleTable=alaDaUNPMacRangeRuleTable, alaDaCPortalProfRetryCnt=alaDaCPortalProfRetryCnt, alaDaUNPPortMaxIngressBwSource=alaDaUNPPortMaxIngressBwSource, alaDaUNPValidityPeriodActiveStatus=alaDaUNPValidityPeriodActiveStatus, alaDaUNPMacGroupRuleEdgeProf=alaDaUNPMacGroupRuleEdgeProf, alaDaUNPProfileMapSpbBVlan=alaDaUNPProfileMapSpbBVlan, alaDaUNPPort8021XPassAltProfileName=alaDaUNPPort8021XPassAltProfileName, alaDaUNPCustDomainMacRangeRuleTable=alaDaUNPCustDomainMacRangeRuleTable, alaDaUNPCustDomainMacIpRuleProfile3=alaDaUNPCustDomainMacIpRuleProfile3, alcatelIND1DaMIB=alcatelIND1DaMIB, alaDaUNPPort8021XTxPeriodStatus=alaDaUNPPort8021XTxPeriodStatus, alaDaHICSvrFailRowStatus=alaDaHICSvrFailRowStatus, alaDaUNPIpPortClassifyGroup=alaDaUNPIpPortClassifyGroup, alaDaUNPCustDomainIpNetRuleProfile2=alaDaUNPCustDomainIpNetRuleProfile2, alaDaUNPProfileQoSPolicy=alaDaUNPProfileQoSPolicy, alaDaUNPPortVlanEntry=alaDaUNPPortVlanEntry, alaDaCPortalPolicyListName=alaDaCPortalPolicyListName, alaDaUNPPortMCLagConfigStatus=alaDaUNPPortMCLagConfigStatus, alaDaKerberosUserPort=alaDaKerberosUserPort, alaDaUNPProfileLocationPolicy=alaDaUNPProfileLocationPolicy, alaDaUNPVxlanFlushSapIDEncapVal=alaDaUNPVxlanFlushSapIDEncapVal, alaDaUNPProfileMapVxlanMulticastIPAddress=alaDaUNPProfileMapVxlanMulticastIPAddress, alaDaUNPVlanTagRuleMCLagConfigStatus=alaDaUNPVlanTagRuleMCLagConfigStatus, alaDaUNPETmplMacPassAltEProf=alaDaUNPETmplMacPassAltEProf, alaDaSpbProfileQosPolicyListName=alaDaSpbProfileQosPolicyListName, alaDaUNPVlanMapTable=alaDaUNPVlanMapTable, alaDaUNPPortRuleProfile2=alaDaUNPPortRuleProfile2, alaDaUnpGroupIdRowStatus=alaDaUnpGroupIdRowStatus, alaDaUNPCustDomainMacRangeRuleDomainId=alaDaUNPCustDomainMacRangeRuleDomainId, unpMcLagConfigInconsistency=unpMcLagConfigInconsistency, alaDaUNPCustDomainEvbGpIdRuleEntry=alaDaUNPCustDomainEvbGpIdRuleEntry, alaDaUNPPortDefaultVxlanProfileName=alaDaUNPPortDefaultVxlanProfileName, alaDaUNPPortDefaultSpbProfileName=alaDaUNPPortDefaultSpbProfileName, alaDaCPortalUNPProfileChange=alaDaCPortalUNPProfileChange, alaDaUNPClassifRuleTable=alaDaUNPClassifRuleTable, alaDaUnpGroupId=alaDaUnpGroupId, alaDaUNPProfileMapVxlanMulticastIPAddressType=alaDaUNPProfileMapVxlanMulticastIPAddressType, alaDaUNPClassifRuleProfile3=alaDaUNPClassifRuleProfile3, alaDaUNPRedirectAllowedServerEntry=alaDaUNPRedirectAllowedServerEntry, alaDaUNPEdgeUserFlush=alaDaUNPEdgeUserFlush, AlaDaAuthenticationResult=AlaDaAuthenticationResult, alaDaUNPPort8021XFailurePolicy=alaDaUNPPort8021XFailurePolicy, alaDaMacVlanUserUnpUsed=alaDaMacVlanUserUnpUsed, alaDaSpbProfileBVlan=alaDaSpbProfileBVlan, alaDaUNPEdgeProfMaxEgressBw=alaDaUNPEdgeProfMaxEgressBw, alaDaUNPCustDomainIpNetRuleEntry=alaDaUNPCustDomainIpNetRuleEntry, alaDaUNPEdgeFlushType=alaDaUNPEdgeFlushType, alaDaKerberosServerPktSwDiscardStats=alaDaKerberosServerPktSwDiscardStats, alaDaUNPIpPortRuleTable=alaDaUNPIpPortRuleTable, alaDaHICWebAgentDownloadUrl=alaDaHICWebAgentDownloadUrl, alaDaUNPMacRuleEntry=alaDaUNPMacRuleEntry, alaDaCPortalProfDomainUNPProfileChange=alaDaCPortalProfDomainUNPProfileChange, alaDaUNPUserRoleAuthType=alaDaUNPUserRoleAuthType, alaDaUNPProfileMaxIngressBandwidth=alaDaUNPProfileMaxIngressBandwidth, alaDaUNPCustDomainMacRangeRuleProfile1=alaDaUNPCustDomainMacRangeRuleProfile1, alaDaKerberosPortTGSREPRxStats=alaDaKerberosPortTGSREPRxStats, alaDaMacUserAuthtype=alaDaMacUserAuthtype, alaDaUNPCustDomainMacRuleMCLagConfigStatus=alaDaUNPCustDomainMacRuleMCLagConfigStatus, alaDaUNPVlanMappingGroup=alaDaUNPVlanMappingGroup, alaDaUNPMacRangeRowStatus=alaDaUNPMacRangeRowStatus, alaDaUNPAuthSrvDownVxlanProfileTimeout=alaDaUNPAuthSrvDownVxlanProfileTimeout, alaIND1DaMIBGroups=alaIND1DaMIBGroups, alaDaHICMIBObjects=alaDaHICMIBObjects, alaDaUNPMacIpPortRuleAddrIpType=alaDaUNPMacIpPortRuleAddrIpType, alaDaQMRPolicyList=alaDaQMRPolicyList, alaDaUNPUserFlushGroup=alaDaUNPUserFlushGroup, alaDaUNPEdgeFlushIndex=alaDaUNPEdgeFlushIndex, alaDaUNPMacRangeEdgeProf=alaDaUNPMacRangeEdgeProf, alaDaMacVlanUserAuthtype=alaDaMacVlanUserAuthtype, alaDaUNPVxlanProfileQosPolicyListName=alaDaUNPVxlanProfileQosPolicyListName, alaDaSpbProfileEntry=alaDaSpbProfileEntry, alaDaUNPSpbFlushComplete=alaDaUNPSpbFlushComplete, alaDaKerberosUserTable=alaDaKerberosUserTable, alaDaUNPCustDomainEvbGpIdRuleGroup=alaDaUNPCustDomainEvbGpIdRuleGroup, alaDaUNPClassificationRuleGroup=alaDaUNPClassificationRuleGroup, alaDaMacVlanUserExtGroup=alaDaMacVlanUserExtGroup, alaDaUNPLocationPolicyPortStatus=alaDaUNPLocationPolicyPortStatus, alaDaUNPCustDomainRuleTable=alaDaUNPCustDomainRuleTable, alaDaKerberosIpAddress=alaDaKerberosIpAddress, alaDaMacVlanUserMCLagLearningLoc=alaDaMacVlanUserMCLagLearningLoc, alaDaUNPVxlanProfileSapVlanXlation=alaDaUNPVxlanProfileSapVlanXlation, alaDaUNPRedirectServerIP=alaDaUNPRedirectServerIP, alaDaHICAllowedRowStatus=alaDaHICAllowedRowStatus, alaDaUNPPortEdgeTemplate=alaDaUNPPortEdgeTemplate, alaDaUNPClassifRuleCustomerDomain=alaDaUNPClassifRuleCustomerDomain, alaDaUNPVlanMapIdent=alaDaUNPVlanMapIdent, alaDaUNPMacRangeRuleProfileName=alaDaUNPMacRangeRuleProfileName, alaDaUNPAuthRuleProfile1=alaDaUNPAuthRuleProfile1, alaDaUNPETmplTrustTagStatus=alaDaUNPETmplTrustTagStatus, alaDaMacVlanUserSIPCallType=alaDaMacVlanUserSIPCallType, alaDaMacVlanUserExtMACAddress=alaDaMacVlanUserExtMACAddress, alaDaUNPETmplClassifStatus=alaDaUNPETmplClassifStatus, alaDaCPortalProfDomainAuthPolicyListName=alaDaCPortalProfDomainAuthPolicyListName, alaDaUNPPortRowStatus=alaDaUNPPortRowStatus, alaDaQMRAllowedEntry=alaDaQMRAllowedEntry, alaDaUnpCustomerDomainId=alaDaUnpCustomerDomainId, alaDaUNPIpMaskRuleRowStatus=alaDaUNPIpMaskRuleRowStatus, alaDaUNPRedirectAllowedServerName=alaDaUNPRedirectAllowedServerName, alaDaUNPMacGroupRuleId=alaDaUNPMacGroupRuleId, alaDaUNPMacPortRuleVlanTag=alaDaUNPMacPortRuleVlanTag, alaDaUNPETmplVlanTable=alaDaUNPETmplVlanTable, alaDaUNPCustDomainMacIpRuleEntry=alaDaUNPCustDomainMacIpRuleEntry, alaDaQMRAllowedIpMask=alaDaQMRAllowedIpMask, alaDaUNPMacPortRuleEdgeProf=alaDaUNPMacPortRuleEdgeProf, alaDaUNPCustDomainVlanTagRuleTable=alaDaUNPCustDomainVlanTagRuleTable, alaIND1DaMIBCompliances=alaIND1DaMIBCompliances, alaDaUserNetProfileMCLagConfigStatus=alaDaUserNetProfileMCLagConfigStatus, alaDaUNPPortEntry=alaDaUNPPortEntry, alaDaUNPMacPortRuleEntry=alaDaUNPMacPortRuleEntry, alaDaKerberosPortStatsEntry=alaDaKerberosPortStatsEntry, alaDaMacVlanUserClassifProfRule=alaDaMacVlanUserClassifProfRule, alaDaUNPVxlanFarEndIPAddressListGroup=alaDaUNPVxlanFarEndIPAddressListGroup, alaDaUNPPortCustomerDomainId=alaDaUNPPortCustomerDomainId, alaDaUNPCustDomainEvbGpIdRuleVlanProfileName=alaDaUNPCustDomainEvbGpIdRuleVlanProfileName, alaDaUNPUserFlushIndex=alaDaUNPUserFlushIndex, alaDaUNPIpNetRuleAddr=alaDaUNPIpNetRuleAddr, alaDaMacVlanUserRedirectionUrl=alaDaMacVlanUserRedirectionUrl, alaDaUNPCustDomainVlanTagRuleMCLagConfigStatus=alaDaUNPCustDomainVlanTagRuleMCLagConfigStatus, alaDaUNPPortTemplateRedirectPortBounce=alaDaUNPPortTemplateRedirectPortBounce, alaDaUserNetProfileTable=alaDaUserNetProfileTable, alaDaUNPCustDomainMacIpRuleDomainId=alaDaUNPCustDomainMacIpRuleDomainId, alaDaUNPProfileTable=alaDaUNPProfileTable, alaDaUNPMacIpPortRuleIpMask=alaDaUNPMacIpPortRuleIpMask, alaDaHICCustomHttpProxyPort=alaDaHICCustomHttpProxyPort, alaDaUNPCustDomainIpNetRuleProfile1=alaDaUNPCustDomainIpNetRuleProfile1, alaDaUNPProfileMapVxlanVnid=alaDaUNPProfileMapVxlanVnid, alaDaUNPEdgeProfHICStatus=alaDaUNPEdgeProfHICStatus, alaDaUNPProfileRedirect=alaDaUNPProfileRedirect, alaDaUNPSpbFlushAuthType=alaDaUNPSpbFlushAuthType, alaDaUNPValidityPeriodMonths=alaDaUNPValidityPeriodMonths, alaDaUNPPortAdminControlledOperDirections=alaDaUNPPortAdminControlledOperDirections, alaDaUserNetProfileMaxIngressDepth=alaDaUserNetProfileMaxIngressDepth, alaDaMacUserTable=alaDaMacUserTable, alaDaUNPVlanTagRuleTable=alaDaUNPVlanTagRuleTable, alaDaUNPIpMaskRuleAddrType=alaDaUNPIpMaskRuleAddrType, alaDaUNPIpMaskGroup=alaDaUNPIpMaskGroup, alaDaUNPMacIpPortRuleTable=alaDaUNPMacIpPortRuleTable, alaDaUNPPortEgressSourceProfile=alaDaUNPPortEgressSourceProfile, alaDaUNPMacRangeEntry=alaDaUNPMacRangeEntry, alaDaUserNetProfileMaxEgressDepth=alaDaUserNetProfileMaxEgressDepth, alaDaMacVlanUserCapPortalStatus=alaDaMacVlanUserCapPortalStatus, alaDaUNPPortRuleEdgeProf=alaDaUNPPortRuleEdgeProf, alaDaUNPIpGroupRuleEntry=alaDaUNPIpGroupRuleEntry, alaDaUNPProfileMobileTag=alaDaUNPProfileMobileTag, alaDaHICSvrFailPolicyEntry=alaDaHICSvrFailPolicyEntry, alaDaUNPLocationPolicyTable=alaDaUNPLocationPolicyTable, alaDaUNPPortTemplateDomainID=alaDaUNPPortTemplateDomainID, alaDaUNPProfileMapVxlanVlanXlation=alaDaUNPProfileMapVxlanVlanXlation, alaDaUNPPortTemplateVlanGroup=alaDaUNPPortTemplateVlanGroup, alaDaUNPVxlanProfileEntry=alaDaUNPVxlanProfileEntry, alaDaUNPValidityPeriodTimezone=alaDaUNPValidityPeriodTimezone, alaDaUNPRedirectPauseTimer=alaDaUNPRedirectPauseTimer, alaDaUNPETmplVlanGroup=alaDaUNPETmplVlanGroup, alaDaUNPMacRangesGroup=alaDaUNPMacRangesGroup, alaDaUserNetProfileRowStatus=alaDaUserNetProfileRowStatus, alaDaUNPSpbFlushSapIDIfIndex=alaDaUNPSpbFlushSapIDIfIndex)
mibBuilder.exportSymbols("ALCATEL-ENT1-DA-MIB", alaDaUNPMacIpPortRuleIpAddr=alaDaUNPMacIpPortRuleIpAddr, alaDaKerberosMIBObjects=alaDaKerberosMIBObjects, alaDaUNPPortAdminState=alaDaUNPPortAdminState, alaDaUNPClassifRuleIpAddressType=alaDaUNPClassifRuleIpAddressType, alaDaUnpMacAddr1=alaDaUnpMacAddr1, alaDaUNPCustDomainMacRangeRuleEdgeProfileName=alaDaUNPCustDomainMacRangeRuleEdgeProfileName, alaDaHICAllowedIpAddr=alaDaHICAllowedIpAddr, alaDaUNPMacGroupRuleEntry=alaDaUNPMacGroupRuleEntry, alaDaCPortalUNPProfile=alaDaCPortalUNPProfile, alaDaUserNetProfileSaaProfileName=alaDaUserNetProfileSaaProfileName, alaDaUNPIpGroupRuleAddrType=alaDaUNPIpGroupRuleAddrType, alaDaUNPClassifRuleMacAddr=alaDaUNPClassifRuleMacAddr, alaDaUNPEdgeProfMaxIngressDepth=alaDaUNPEdgeProfMaxIngressDepth, alaDaUNPCustDomainMacRuleAddr=alaDaUNPCustDomainMacRuleAddr, alaDaUNPMacRangeEndMacAddr=alaDaUNPMacRangeEndMacAddr, alaDaUNPIpMaskRuleTable=alaDaUNPIpMaskRuleTable, alaDaUNPDynamicProfileConfigMCLagConfigStatus=alaDaUNPDynamicProfileConfigMCLagConfigStatus, alaDaUNPAuthRuleGroup=alaDaUNPAuthRuleGroup, alaDaUNPProfileMapVxlanEntry=alaDaUNPProfileMapVxlanEntry, alaDaQMRCustomHttpProxyPort=alaDaQMRCustomHttpProxyPort, alaDaUNPVxlanFlushAuthType=alaDaUNPVxlanFlushAuthType, alaDaUNPMacPortRuleRowStatus=alaDaUNPMacPortRuleRowStatus, alaDaUNPReloadVsiTypeDB=alaDaUNPReloadVsiTypeDB, alaDaUNPPort8021XMaxReq=alaDaUNPPort8021XMaxReq, alaDaUNPETmplRedirectPortBounce=alaDaUNPETmplRedirectPortBounce, alaDaUNPMacRuleAddr=alaDaUNPMacRuleAddr, alaDaKerberosGlobalConfig=alaDaKerberosGlobalConfig, alaDaHICHostStatus=alaDaHICHostStatus, alaDaCPortalRedirectUrlName=alaDaCPortalRedirectUrlName, alaDaUserNetProfileGroup=alaDaUserNetProfileGroup, alaDaUNPProfileMapStaticTable=alaDaUNPProfileMapStaticTable, alaDaUNPPortMaxEgressBw=alaDaUNPPortMaxEgressBw, alaDaUNPEdgeFlushComplete=alaDaUNPEdgeFlushComplete, alaDaUNPCustDomainMacRangeRuleProfileName=alaDaUNPCustDomainMacRangeRuleProfileName, alaDaUNPProfileMapVxlanRowStatus=alaDaUNPProfileMapVxlanRowStatus, alaDaCPortalAuthPassTable=alaDaCPortalAuthPassTable, alaDaUNPLocationPolicySystemLocation=alaDaUNPLocationPolicySystemLocation, alaDaUNPRedirectAllowedRowStatus=alaDaUNPRedirectAllowedRowStatus, alaDaMacVlanUserAuthFailReason=alaDaMacVlanUserAuthFailReason, alaDaUNPCustDomainVlanTagRuleProfile3=alaDaUNPCustDomainVlanTagRuleProfile3, alaDaUNPCustDomainMacRuleDomainId=alaDaUNPCustDomainMacRuleDomainId, alaDaUNPETmplVlanVID=alaDaUNPETmplVlanVID, alaDaMacVlanUserClassificationSource=alaDaMacVlanUserClassificationSource, alaDaSaaProfileTable=alaDaSaaProfileTable, alaDaUNPPortMacAllowEap=alaDaUNPPortMacAllowEap, alaDaHICAllowedIpAddrType=alaDaHICAllowedIpAddrType, alaDaUNPCustDomainVlanTagRuleVlan=alaDaUNPCustDomainVlanTagRuleVlan, alaDaMacVlanUserAuthServerUsed=alaDaMacVlanUserAuthServerUsed, alaDaUNPIpPortRuleMaskType=alaDaUNPIpPortRuleMaskType, alaDaMacVlanUserRoleRule=alaDaMacVlanUserRoleRule, alaDaUnpCustomerDomainEntry=alaDaUnpCustomerDomainEntry, alaDaUserNetProfileMaxEgressBw=alaDaUserNetProfileMaxEgressBw, alaDaKerberosPolicyConfigTable=alaDaKerberosPolicyConfigTable, alaDaUNPUserRoleEntry=alaDaUNPUserRoleEntry, alaDaUNPMacRangeStartMacAddr=alaDaUNPMacRangeStartMacAddr, alaDaUNPDynamicVlanMCLagConfigStatus=alaDaUNPDynamicVlanMCLagConfigStatus, alaDaUNPClassifRuleIpAddress=alaDaUNPClassifRuleIpAddress, alaDaUNPVxlanFarEndIPListIPAddressCount=alaDaUNPVxlanFarEndIPListIPAddressCount, alaDaCPortalProfDomainUNPProfile=alaDaCPortalProfDomainUNPProfile, alaDaUNPVxlanProfileTable=alaDaUNPVxlanProfileTable, alaDaKerberosPortClearStats=alaDaKerberosPortClearStats, alaDaKerberosPortASREQRxStats=alaDaKerberosPortASREQRxStats, alaDaUNPPort8021XPassAltVxlanProfName=alaDaUNPPort8021XPassAltVxlanProfName, alaDaHICSvrRowStatus=alaDaHICSvrRowStatus, alaDaUNPIpGroupRuleRowStatus=alaDaUNPIpGroupRuleRowStatus, alaDaUNPCustDomainMacRangeRuleEntry=alaDaUNPCustDomainMacRangeRuleEntry, alaDaUNPUserFlushProfile=alaDaUNPUserFlushProfile, alaDaKerberosPortTGSREQRxStats=alaDaKerberosPortTGSREQRxStats, alaDaUNPMacRangeGroup=alaDaUNPMacRangeGroup, alaDaUNPCustDomainVlanTagRuleProfile2=alaDaUNPCustDomainVlanTagRuleProfile2, alaDaUNPLocationPolicySystemName=alaDaUNPLocationPolicySystemName, alaDaKerberosUserMac=alaDaKerberosUserMac, alaDaUNPUserRoleEdgeProfile=alaDaUNPUserRoleEdgeProfile, alaDaQMRGroup=alaDaQMRGroup, alaDaUNPIpNetRuleProfileName=alaDaUNPIpNetRuleProfileName, alaDaUNPPortTemplateEntry=alaDaUNPPortTemplateEntry, alaDaUNPETmplRowStatus=alaDaUNPETmplRowStatus, alaDaUNPMacIpPortRuleIpMaskType=alaDaUNPMacIpPortRuleIpMaskType, alaDaUNPETmplVlanRowStatus=alaDaUNPETmplVlanRowStatus, alaDaUNPAuthRuleRowStatus=alaDaUNPAuthRuleRowStatus, alaDaMacVlanUserServiceSapIDIfIndex=alaDaMacVlanUserServiceSapIDIfIndex, alaDaCPortalProfDomainAuthRealm=alaDaCPortalProfDomainAuthRealm, alaDaUNPCustDomainRuleProfile1=alaDaUNPCustDomainRuleProfile1, alaDaKerberosTotalASREPRxStats=alaDaKerberosTotalASREPRxStats, alaDaUNPVxlanProfileGroup=alaDaUNPVxlanProfileGroup, alaDaMacVlanUserSpbBVlan=alaDaMacVlanUserSpbBVlan, alaDaUNPMacRangeRuleVlanTag=alaDaUNPMacRangeRuleVlanTag, alaDaSaaProfileEntry=alaDaSaaProfileEntry, alaDaUNPProfileMapVxlanFarEndIPList=alaDaUNPProfileMapVxlanFarEndIPList, alaDaUNPIpPortRuleProfile2=alaDaUNPIpPortRuleProfile2, alaDaUNPProfileMapSpbEntry=alaDaUNPProfileMapSpbEntry, alaDaUNPPortRedirectPortBounce=alaDaUNPPortRedirectPortBounce, alaDaUNPPortClassificationFlag=alaDaUNPPortClassificationFlag, alaDaKerberosPortServerPktRxStats=alaDaKerberosPortServerPktRxStats, alaDaUNPEdgeProfEntry=alaDaUNPEdgeProfEntry, alaDaCPortalProfName=alaDaCPortalProfName, alaDaUNPCustDomainMacIpRuleIpMaskType=alaDaUNPCustDomainMacIpRuleIpMaskType, alaDaUNPCustDomainMacRangeGroup=alaDaUNPCustDomainMacRangeGroup, alaDaKerberosReqTimeoutTrap=alaDaKerberosReqTimeoutTrap, alaDaHICSvrFailMode=alaDaHICSvrFailMode, alaDaKerberosGlobalClearStats=alaDaKerberosGlobalClearStats, alaDaUNPLocationPolicyGroup=alaDaUNPLocationPolicyGroup, alaDaUNPCustDomainIpNetRuleTable=alaDaUNPCustDomainIpNetRuleTable, alaDaUNPUserRoleTable=alaDaUNPUserRoleTable, alaDaUNPMacIpPortRuleProfile3=alaDaUNPMacIpPortRuleProfile3, alaDaSaaProfileName=alaDaSaaProfileName, alaDaUNPEdgeProfMaxIngressBw=alaDaUNPEdgeProfMaxIngressBw, alaDaHICSvrEntry=alaDaHICSvrEntry, alaDaUNPClassifRuleIpMask=alaDaUNPClassifRuleIpMask, alaDaHICGlobalConfig=alaDaHICGlobalConfig, alaDaUNPMacRuleVlanTag=alaDaUNPMacRuleVlanTag, alaDaUNPMacOuiRuleEdgeProfile=alaDaUNPMacOuiRuleEdgeProfile, alaDaUNPProfileAuthenticationFlag=alaDaUNPProfileAuthenticationFlag, alaDaUNPIpGroupRuleTable=alaDaUNPIpGroupRuleTable, alaDaUNPMacIpPortRuleVlanTag=alaDaUNPMacIpPortRuleVlanTag, alaDaUNPUserRoleProfile2=alaDaUNPUserRoleProfile2, alaDaUNPEdgeProfileGroup=alaDaUNPEdgeProfileGroup, alaDaUNPProfileEntry=alaDaUNPProfileEntry, alaDaUNPIpPortRuleVlanTag=alaDaUNPIpPortRuleVlanTag, alaDaUNPGroupRuleId=alaDaUNPGroupRuleId, alaDaUNPVxlanFlushTable=alaDaUNPVxlanFlushTable, alaDaUNPProfileKerberosAuthentication=alaDaUNPProfileKerberosAuthentication, alaDaUNPPortTemplateMACAuthAllowEAP=alaDaUNPPortTemplateMACAuthAllowEAP, alaDaUNPMacIpGroupRuleIpAddr=alaDaUNPMacIpGroupRuleIpAddr, alaDaUNPCustDomainMacIpRuleTable=alaDaUNPCustDomainMacIpRuleTable, alaDaUNPPortVlanGroup=alaDaUNPPortVlanGroup, alaDaMacVlanUserVlanID=alaDaMacVlanUserVlanID, alaDaUNPIpPortRuleMask=alaDaUNPIpPortRuleMask, alaDaUnpName=alaDaUnpName, alaDaUNPUserFlushComplete=alaDaUNPUserFlushComplete, alaDaKerberosPortASREPRxStats=alaDaKerberosPortASREPRxStats, alaDaUNPPortPassAltVxlanProfileName=alaDaUNPPortPassAltVxlanProfileName, alaDaUNPETmpl8021XTxPeriodStatus=alaDaUNPETmpl8021XTxPeriodStatus, alaDaUNPVxlanFarEndIPAddressListTable=alaDaUNPVxlanFarEndIPAddressListTable, alaDaKerberosUserState=alaDaKerberosUserState, alaDaUNPIpNetRuleAddrType=alaDaUNPIpNetRuleAddrType, alaDaUNPUserFlushSapIDIfIndex=alaDaUNPUserFlushSapIDIfIndex, alaDaHICAllowedIpMask=alaDaHICAllowedIpMask, alaDaUNPUserFlushAuthType=alaDaUNPUserFlushAuthType, alaDaUNPIpMaskRuleVlanTag=alaDaUNPIpMaskRuleVlanTag, alaDaUNPMacOuiRuleProfile3=alaDaUNPMacOuiRuleProfile3, alaDaUserNetProfileMobileTag=alaDaUserNetProfileMobileTag, alaDaUNPAuthServerDownProfile1=alaDaUNPAuthServerDownProfile1, alaDaSaaProfileGroup=alaDaSaaProfileGroup, alaDaUNPPortTemplateMACAuthPassAlternate=alaDaUNPPortTemplateMACAuthPassAlternate, alaDaUNPIpPortRuleEdgeProf=alaDaUNPIpPortRuleEdgeProf, alaDaUNPMacRuleMCLagConfigStatus=alaDaUNPMacRuleMCLagConfigStatus, alaDaUNPCustDomainIpNetRuleMCLagConfigStatus=alaDaUNPCustDomainIpNetRuleMCLagConfigStatus, alaDaUNPVxlanProfileMulticastMode=alaDaUNPVxlanProfileMulticastMode, alaDaUNPEdgeProfPeriodPolicy=alaDaUNPEdgeProfPeriodPolicy, alaDaUNPEdgeTemplateGroup=alaDaUNPEdgeTemplateGroup, alaDaUNPValidityPeriodGroup=alaDaUNPValidityPeriodGroup, alaDaUNPProfileMapStaticGroup=alaDaUNPProfileMapStaticGroup, alaDaUNPMacRangeRuleRowStatus=alaDaUNPMacRangeRuleRowStatus, alaDaUNPRedirectProxyServerPort=alaDaUNPRedirectProxyServerPort, alaDaMacVlanUserIpAddressType=alaDaMacVlanUserIpAddressType, alaDaHICAllowedTable=alaDaHICAllowedTable, alaDaUNPVlanTagGroup=alaDaUNPVlanTagGroup, alaDaUnpGroupIdEntry=alaDaUnpGroupIdEntry, alaDaUNPProfileMapVlanGroup=alaDaUNPProfileMapVlanGroup, alaDaUNPPortTemplate8021XAuthTxPeriod=alaDaUNPPortTemplate8021XAuthTxPeriod, alaDaUNPCustDomainMacIpRuleGroup=alaDaUNPCustDomainMacIpRuleGroup, alaDaUNPProfileAFDConfig=alaDaUNPProfileAFDConfig, alaDaUNPEdgeProfLocationPolicy=alaDaUNPEdgeProfLocationPolicy, alaDaUNPPortTemplateAdminState=alaDaUNPPortTemplateAdminState, alaDaUNPPortDefaultEdgeProfName=alaDaUNPPortDefaultEdgeProfName, alaDaUNPPort8021XSuppTimeoutStatus=alaDaUNPPort8021XSuppTimeoutStatus, alaDaKerberosUserDomain=alaDaKerberosUserDomain, alaDaKerberosTotalServerPktRxStats=alaDaKerberosTotalServerPktRxStats, alaDaUNPCustDomainMacRangeRuleVxlanProfileName=alaDaUNPCustDomainMacRangeRuleVxlanProfileName, alaDaUNPMacRangeTable=alaDaUNPMacRangeTable, alaDaMacUserMACAddress=alaDaMacUserMACAddress, alaDaUNPAuthSrvDownVxlanProfileName=alaDaUNPAuthSrvDownVxlanProfileName, alaDaUNPProfilePeriodPolicy=alaDaUNPProfilePeriodPolicy, alaDaUNPAuthRuleVlanTag=alaDaUNPAuthRuleVlanTag, alaDaKerberosGlobalServerTimeoutTimer=alaDaKerberosGlobalServerTimeoutTimer, alaDaUNPPortPortTemplateName=alaDaUNPPortPortTemplateName, alaDaUNPPortTemplate8021XAuthFailPolicy=alaDaUNPPortTemplate8021XAuthFailPolicy, alaDaUnpGroupDescription=alaDaUnpGroupDescription, alaDaMacVlanUserLoginTimeStamp=alaDaMacVlanUserLoginTimeStamp, alaDaCPortalIpAddressType=alaDaCPortalIpAddressType, alaDaCPortalCustomization=alaDaCPortalCustomization, alaDaUNPVlanUserFlush=alaDaUNPVlanUserFlush, alaDaHICSvrIpAddrType=alaDaHICSvrIpAddrType, alaDaUNPPortTemplate8021XAuthSuppTimeout=alaDaUNPPortTemplate8021XAuthSuppTimeout, alaDaUNPProfileMapVxlanMulticastMode=alaDaUNPProfileMapVxlanMulticastMode, alaDaUNPPortTemplate8021XAuthPassAlternate=alaDaUNPPortTemplate8021XAuthPassAlternate, alaDaUNPVxlanProfileMulticastIPAddress=alaDaUNPVxlanProfileMulticastIPAddress, alaDaUNPEdgeFlushEntry=alaDaUNPEdgeFlushEntry, alaDaUNPAuthRuleTable=alaDaUNPAuthRuleTable, alaDaUnpCustomerDomainRowStatus=alaDaUnpCustomerDomainRowStatus, alaDaUNPProfileMapSpbVlanXlation=alaDaUNPProfileMapSpbVlanXlation, alaDaUNPCustDomainMacRangeRuleVlanTag=alaDaUNPCustDomainMacRangeRuleVlanTag, alaDaUNPVxlanProfileEncapVal=alaDaUNPVxlanProfileEncapVal, alaDaUNPProfileMapStaticEntry=alaDaUNPProfileMapStaticEntry, alaDaUNPCustDomainEvbGpIdRuleSpbProfileName=alaDaUNPCustDomainEvbGpIdRuleSpbProfileName, alaDaUNPProfileCPortalProfile=alaDaUNPProfileCPortalProfile, alaDaMacVlanUserRoleSource=alaDaMacVlanUserRoleSource, alaDaUNPPortTemplateMACAuth=alaDaUNPPortTemplateMACAuth, alaDaUserNetProfileEntry=alaDaUserNetProfileEntry, alaDaUNPPort8021XTxPeriod=alaDaUNPPort8021XTxPeriod, alaDaCPortalAuthPolicyListName=alaDaCPortalAuthPolicyListName, alaDaUNPVxlanFlushComplete=alaDaUNPVxlanFlushComplete, alaDaUNPClassifRuleMacRngHiaddr=alaDaUNPClassifRuleMacRngHiaddr, alaDaUNPMacGroupRuleTable=alaDaUNPMacGroupRuleTable, alaDaUNPValidityPeriodMonthsStatus=alaDaUNPValidityPeriodMonthsStatus, alaDaUNPPortPassAltSpbProfileName=alaDaUNPPortPassAltSpbProfileName, alaDaUNPAuthRuleProfile3=alaDaUNPAuthRuleProfile3, alaDaUNPEndPoinVlanTag=alaDaUNPEndPoinVlanTag, alaDaQMRAllowedRowStatus=alaDaQMRAllowedRowStatus, alaDaUNPMacIpPortRuleProfile2=alaDaUNPMacIpPortRuleProfile2, alaIND1DaMIBObjects=alaIND1DaMIBObjects, alaDaUNPValidityPeriodInterval=alaDaUNPValidityPeriodInterval, alaDaUNPRstrctedRoleType=alaDaUNPRstrctedRoleType, alaDaKerberosPolicyConfigEntry=alaDaKerberosPolicyConfigEntry, alaDaUNPAuthRuleProfile2=alaDaUNPAuthRuleProfile2, alaDaCPortalProfDomainEntry=alaDaCPortalProfDomainEntry, alaDaHICSvrKey=alaDaHICSvrKey, alaDaUNPMacIpGroupRuleIpAddrType=alaDaUNPMacIpGroupRuleIpAddrType, alaDaKerberosPolicyStatus=alaDaKerberosPolicyStatus, alaDaUnpIpMask=alaDaUnpIpMask, alaDaUNPMacRangeRuleEntry=alaDaUNPMacRangeRuleEntry, alaDaUNPPortTemplateDefaultProfile=alaDaUNPPortTemplateDefaultProfile, alaDaUNPRedirectAllowedServerIP=alaDaUNPRedirectAllowedServerIP, alaDaUnpSourceIpAddr=alaDaUnpSourceIpAddr, alaDaUNPClassifRuleMacOuiAddr=alaDaUNPClassifRuleMacOuiAddr, alaDaUNPProfileMapSpbMulticastMode=alaDaUNPProfileMapSpbMulticastMode, alaDaUNPIpAddressGroup=alaDaUNPIpAddressGroup, alaDaUNPClassifRuleIpMaskType=alaDaUNPClassifRuleIpMaskType, alaDaMacUserLoginTimeStamp=alaDaMacUserLoginTimeStamp, alaDaUNPMacRangeRuleMCLagConfigStatus=alaDaUNPMacRangeRuleMCLagConfigStatus, alaDaUNPPort8021XBypassStatus=alaDaUNPPort8021XBypassStatus, alaDaUNPRedirectServerIPType=alaDaUNPRedirectServerIPType, alaDaMacVlanUserLocPolicyStatus=alaDaMacVlanUserLocPolicyStatus, alaDaUNPPortRuleTable=alaDaUNPPortRuleTable, alaDaUNPMacIpGroupRuleMacAddr=alaDaUNPMacIpGroupRuleMacAddr, alaDaUNPEndPoinProfile2=alaDaUNPEndPoinProfile2, alaDaUNPIpMaskRuleMask=alaDaUNPIpMaskRuleMask, alaDaUNPPortTemplateVlanVID=alaDaUNPPortTemplateVlanVID, alaDaUNPPortGroup=alaDaUNPPortGroup, alaDaUNPVxlanFarEndIPAddressListIPType=alaDaUNPVxlanFarEndIPAddressListIPType, alaDaUNPCustDomainMacRangeRuleProfile3=alaDaUNPCustDomainMacRangeRuleProfile3, alaDaUNPProfileGroup=alaDaUNPProfileGroup, alaDaUNPCustDomainIpNetRuleAddrType=alaDaUNPCustDomainIpNetRuleAddrType, alaDaSaaProfileLatencyThreshold=alaDaSaaProfileLatencyThreshold, alaDaUNPPortTemplateGroup=alaDaUNPPortTemplateGroup, alaDaHICSvrRole=alaDaHICSvrRole, alaDaUNPClassifRulePrecedenceNum=alaDaUNPClassifRulePrecedenceNum, alaDaUNPLocationPolicyRowStatus=alaDaUNPLocationPolicyRowStatus, alaDaQMRAllowedName=alaDaQMRAllowedName, alaDaMacVlanUserAuthStatus=alaDaMacVlanUserAuthStatus, alaDaQMRAllowedIpMaskType=alaDaQMRAllowedIpMaskType, alaDaUNPCustDomainMacRangeRuleProfile2=alaDaUNPCustDomainMacRangeRuleProfile2, alaDaUNPETmpl8021XMaxReqStatus=alaDaUNPETmpl8021XMaxReqStatus)
mibBuilder.exportSymbols("ALCATEL-ENT1-DA-MIB", alaDaUNPCustDomainIpNetRuleVxlanProfileName=alaDaUNPCustDomainIpNetRuleVxlanProfileName, alaDaCPortalProfRowStatus=alaDaCPortalProfRowStatus, alaDaUNPPortTemplateVlanEntry=alaDaUNPPortTemplateVlanEntry, alaDaUNPEndPointGroup=alaDaUNPEndPointGroup, alaDaMacUserIpAddress=alaDaMacUserIpAddress, alaDaKerberosTotalTGSREQRxStats=alaDaKerberosTotalTGSREQRxStats, alaDaUNPAuthRuleType=alaDaUNPAuthRuleType, alaDaUNPMacOuiRuleProfile2=alaDaUNPMacOuiRuleProfile2, alaDaUNPMacRulesRowStatus=alaDaUNPMacRulesRowStatus, alaDaUNPETmplMacAllowEap=alaDaUNPETmplMacAllowEap, alaDaKerberosPolicyDomainName=alaDaKerberosPolicyDomainName, alaDaUNPVlanMapEntry=alaDaUNPVlanMapEntry, alaDaUNPProfileSaaProfile=alaDaUNPProfileSaaProfile, alaDaUNPMacIpGroup=alaDaUNPMacIpGroup, alaDaUNPCustDomainEvbGpIdRuleVxlanProfileName=alaDaUNPCustDomainEvbGpIdRuleVxlanProfileName, alaDaUNPMacRangeVlanTag=alaDaUNPMacRangeVlanTag, alaDaUserNetProfileName=alaDaUserNetProfileName, MacOui=MacOui, alaDaUNPEdgrFlushMac=alaDaUNPEdgrFlushMac, alaDaMacVlanUserAuthServerIpType=alaDaMacVlanUserAuthServerIpType, alaDaUNPEdgeFlushPortLow=alaDaUNPEdgeFlushPortLow, alaDaHICStatus=alaDaHICStatus, alaDaMacVlanUserGroup=alaDaMacVlanUserGroup, alaDaUNPMacRuleProfileName=alaDaUNPMacRuleProfileName, alaDaUNPValidityPeriodEndInterval=alaDaUNPValidityPeriodEndInterval, alaDaMacVlanUserExtAppID=alaDaMacVlanUserExtAppID, alaDaUNPValidityPeriodDaysStatus=alaDaUNPValidityPeriodDaysStatus, alaDaUNPPortTemplateDirection=alaDaUNPPortTemplateDirection, alaDaUNPETmplForceL3LearningPortBounce=alaDaUNPETmplForceL3LearningPortBounce, alaDaAuthenticationStatus=alaDaAuthenticationStatus, alaDaUNPVxlanFarEndIPListGroup=alaDaUNPVxlanFarEndIPListGroup, alaDaUNPEdgeProfKerberosStatus=alaDaUNPEdgeProfKerberosStatus, alaDaUNPETmplFailurePolicy=alaDaUNPETmplFailurePolicy, alaDaUNPCustDomainMacRuleSpbProfileName=alaDaUNPCustDomainMacRuleSpbProfileName, alaDaKerberosRateLimitString=alaDaKerberosRateLimitString, alaDaQMRAllowedTable=alaDaQMRAllowedTable, alaDaUNPRedirectAllowedServerIPType=alaDaUNPRedirectAllowedServerIPType, alaDaKerberosPortServerPktSwDiscardStats=alaDaKerberosPortServerPktSwDiscardStats, alaDaUNPCustDomainRuleProfile3=alaDaUNPCustDomainRuleProfile3, alaDaUNPEndPoinRuleTable=alaDaUNPEndPoinRuleTable, alaDaUNPEdgeProfQosPolicyList=alaDaUNPEdgeProfQosPolicyList, alaDaUNPPort8021XMaxReqStatus=alaDaUNPPort8021XMaxReqStatus, alaDaCPortalAuthUNPProfileChange=alaDaCPortalAuthUNPProfileChange, alaDaUNPPort8021XPassAltUserNetProfName=alaDaUNPPort8021XPassAltUserNetProfName, alaDaUNPPort8021XAuthStatus=alaDaUNPPort8021XAuthStatus, alaDaUnpCustomerDomainTable=alaDaUnpCustomerDomainTable, alaDaUNPLocationPolicyPort=alaDaUNPLocationPolicyPort, alaDaUNPCustDomainMacRangeRuleHiAddr=alaDaUNPCustDomainMacRangeRuleHiAddr, alaDaUNPIpMaskRuleAddr=alaDaUNPIpMaskRuleAddr, alaDaMacVlanUserType=alaDaMacVlanUserType, alaDaUNPCustDomainEvbGpIdRuleCustomerDomainId=alaDaUNPCustDomainEvbGpIdRuleCustomerDomainId, alaDaUNPProfileMapSpbTable=alaDaUNPProfileMapSpbTable, alaDaUNPIpNetRuleMCLagConfigStatus=alaDaUNPIpNetRuleMCLagConfigStatus, alaDaUNPVlanRuleEdgeProf=alaDaUNPVlanRuleEdgeProf, alaDaSpbProfileGroup=alaDaSpbProfileGroup, alaDaUnpMCLAGId=alaDaUnpMCLAGId, alaDaUNPUserRoleName=alaDaUNPUserRoleName, PYSNMP_MODULE_ID=alcatelIND1DaMIB, alaDaUNPSpbFlushIndex=alaDaUNPSpbFlushIndex, alaDaUNPCustDomainIpNetRuleDomainId=alaDaUNPCustDomainIpNetRuleDomainId, alaDaUNPRedirectAllowedMaskIP=alaDaUNPRedirectAllowedMaskIP, alaDaUNPUserRoleProfile3=alaDaUNPUserRoleProfile3, alaDaUNPIpMaskRuleEdgeProf=alaDaUNPIpMaskRuleEdgeProf, alaDaUNPCustDomainVlanTagRuleVlanProfileName=alaDaUNPCustDomainVlanTagRuleVlanProfileName, alaDaUNPETmpl8021XMaxReq=alaDaUNPETmpl8021XMaxReq, alaDaUNPPortAdminControlledDirections=alaDaUNPPortAdminControlledDirections, alaDaUNPProfileMapSpbRowStatus=alaDaUNPProfileMapSpbRowStatus, alaDaUNPValidityPeriodTimezoneStatus=alaDaUNPValidityPeriodTimezoneStatus, alaDaMacUserClassificationSource=alaDaMacUserClassificationSource, alaDaUNPMacPortRuleMacAddr=alaDaUNPMacPortRuleMacAddr, alaDaUNPRedirectAllowedMaskIPType=alaDaUNPRedirectAllowedMaskIPType, alaDaUNPProfileCPortalAuthentication=alaDaUNPProfileCPortalAuthentication, alaDaUNPCustDomainMacRangeRuleSpbProfileName=alaDaUNPCustDomainMacRangeRuleSpbProfileName, alaDaCPortalProfMode=alaDaCPortalProfMode, alaDaUNP8021XEdgeUserFlush=alaDaUNP8021XEdgeUserFlush, alaDaKerberosGlobalClearPortStats=alaDaKerberosGlobalClearPortStats, alaDaUNPMacIpGroupRuleEdgeProf=alaDaUNPMacIpGroupRuleEdgeProf, alaDaUNPGroupRuleEdgeProf=alaDaUNPGroupRuleEdgeProf, alaDaUNPCustDomainIpNetRuleSpbProfileName=alaDaUNPCustDomainIpNetRuleSpbProfileName, alaDaUNPUserFlushTable=alaDaUNPUserFlushTable, alaDaUNPEdgeProfName=alaDaUNPEdgeProfName, alaDaUNPPortRuleProfile3=alaDaUNPPortRuleProfile3, alaDaUNPIpMaskRuleEntry=alaDaUNPIpMaskRuleEntry, alaDaKerberosPortClientPktSwDiscardStats=alaDaKerberosPortClientPktSwDiscardStats, alaDaUNPCustDomainMacRuleProfile1=alaDaUNPCustDomainMacRuleProfile1, alaDaUNPPortMacAuthFlag=alaDaUNPPortMacAuthFlag, alaDaUnpVlanTag=alaDaUnpVlanTag, alaDaUNPIpGroupRuleEdgeProf=alaDaUNPIpGroupRuleEdgeProf, alaDaUNPVlanRuleTable=alaDaUNPVlanRuleTable, alaDaUNPEdgeProfCPortalAuth=alaDaUNPEdgeProfCPortalAuth, alaDaUNPDynamicVlanConfigFlag=alaDaUNPDynamicVlanConfigFlag, alaDaUNPCustDomainMacRuleRowStatus=alaDaUNPCustDomainMacRuleRowStatus, alaDaQMRMIBObjects=alaDaQMRMIBObjects, alaDaCPortalProfDomainAuthDomainName=alaDaCPortalProfDomainAuthDomainName, alaDaUNPETmpl8021XSuppTimeoutStatus=alaDaUNPETmpl8021XSuppTimeoutStatus, alaDaUNPETmplAaaProf=alaDaUNPETmplAaaProf, alaDaUNPMacOuiRuleRowStatus=alaDaUNPMacOuiRuleRowStatus, alaDaUNPVxlanFarEndIPAddressListRowStatus=alaDaUNPVxlanFarEndIPAddressListRowStatus, alaDaUNPETmplBypassStatus=alaDaUNPETmplBypassStatus, alaDaUNPCustDomainMacRuleVxlanProfileName=alaDaUNPCustDomainMacRuleVxlanProfileName, alaDaUNPPortTemplate8021XAuthBypass=alaDaUNPPortTemplate8021XAuthBypass, alaDaUNPMacIpClassifyGroup=alaDaUNPMacIpClassifyGroup, alaDaMacUserVlanID=alaDaMacUserVlanID, alaDaUNPCustDomainRuleId=alaDaUNPCustDomainRuleId, alaDaHICGroup=alaDaHICGroup, alaDaUNPCustDomainIpNetRuleEdgeProfile=alaDaUNPCustDomainIpNetRuleEdgeProfile, alaDaKerberosRowStatus=alaDaKerberosRowStatus, alaDaUNPCustDomainIpNetRuleMask=alaDaUNPCustDomainIpNetRuleMask, alaDaUNPEdgeProfTable=alaDaUNPEdgeProfTable, alaDaMacVlanUserName=alaDaMacVlanUserName, alaDaKerberosPolicyRowStatus=alaDaKerberosPolicyRowStatus, alaDaUNPPortDomainID=alaDaUNPPortDomainID, alaDaMacVlanUserMACAddress=alaDaMacVlanUserMACAddress, alaDaUNPCustDomainMacRangeRuleLoAddr=alaDaUNPCustDomainMacRangeRuleLoAddr, alaDaSpbProfileAFDConfig=alaDaSpbProfileAFDConfig, alaDaUNPGroupRuleVlanTag=alaDaUNPGroupRuleVlanTag, alaDaUNPPortMaxIngressDepth=alaDaUNPPortMaxIngressDepth, alaDaUNPValidityPeriodHourStatus=alaDaUNPValidityPeriodHourStatus, alaDaCPortalRetryCnt=alaDaCPortalRetryCnt, alaDaUNPETmplGroupId=alaDaUNPETmplGroupId, alaDaSpbProfileRowStatus=alaDaSpbProfileRowStatus, alaDaUNPIpPortRuleAddrType=alaDaUNPIpPortRuleAddrType, alaDaUNPMacIpPortRuleEntry=alaDaUNPMacIpPortRuleEntry, alaDaUNPProfileInactivityInterval=alaDaUNPProfileInactivityInterval, alaDaUNPIpPortRuleProfile1=alaDaUNPIpPortRuleProfile1, alaDaUNPMacRuleTable=alaDaUNPMacRuleTable, alaIND1DaMIBNotifications=alaIND1DaMIBNotifications, alaDaUNPIpGroupRuleAddr=alaDaUNPIpGroupRuleAddr, alaDaHICSvrConnection=alaDaHICSvrConnection, alaDaUNPVlanTagRuleEntry=alaDaUNPVlanTagRuleEntry, alaDaUNPVxlanProfileName=alaDaUNPVxlanProfileName, alaDaUNPRedirectAllowedServerGroup=alaDaUNPRedirectAllowedServerGroup, alaDaSaaProfileJitterThreshold=alaDaSaaProfileJitterThreshold, alaDaUNPProfileMapVlanVlanID=alaDaUNPProfileMapVlanVlanID, alaDaMacVlanUserSIPMediaType=alaDaMacVlanUserSIPMediaType, alaDaUnpNativeVlan=alaDaUnpNativeVlan, alaDaUNPPortTable=alaDaUNPPortTable, alaDaUNPValidityPeriodIntervalStatus=alaDaUNPValidityPeriodIntervalStatus, alaDaUNPIpMaskRuleMaskType=alaDaUNPIpMaskRuleMaskType, alaDaUNPGroupRuleRowStatus=alaDaUNPGroupRuleRowStatus, alaDaQMRGlobalConfig=alaDaQMRGlobalConfig, alaDaCPortalProfAuthPolicyListName=alaDaCPortalProfAuthPolicyListName, alaDaUserNetProfileQosPolicyListName=alaDaUserNetProfileQosPolicyListName, alaDaKerberosPolicyName=alaDaKerberosPolicyName, alaDaUNPCustDomainRuleEntry=alaDaUNPCustDomainRuleEntry, alaDaUNPVlanRuleEntry=alaDaUNPVlanRuleEntry, alaDaUNPSpbFlushEntry=alaDaUNPSpbFlushEntry, alaDaUNPProfileMapStaticServiceID=alaDaUNPProfileMapStaticServiceID, alaDaUNPCustDomainMacRangeRuleMCLagConfigStatus=alaDaUNPCustDomainMacRangeRuleMCLagConfigStatus, alaDaHICAllowedEntry=alaDaHICAllowedEntry, alaDaUNPVxlanFlushGroup=alaDaUNPVxlanFlushGroup, alaDaUNPVxlanProfileMobileTagStatus=alaDaUNPVxlanProfileMobileTagStatus, alaDaKerberosUserAuthState=alaDaKerberosUserAuthState, alaDaUNPForceL3Learning=alaDaUNPForceL3Learning, alaDaHICSvrTable=alaDaHICSvrTable, alaDaUNPCustDomainMacIpRuleIpAddrType=alaDaUNPCustDomainMacIpRuleIpAddrType, AlaMultiChassisConfigStatus=AlaMultiChassisConfigStatus, alaDaCPortalProfSuccRedirectUrl=alaDaCPortalProfSuccRedirectUrl, alaDaUnpCustomerDomainGroup=alaDaUnpCustomerDomainGroup, alaDaUNPCustDomainMacIpRuleIpAddr=alaDaUNPCustDomainMacIpRuleIpAddr, alaDaUNPRedirectPortBounce=alaDaUNPRedirectPortBounce, alaDaUNPETmplAdminControlledDirections=alaDaUNPETmplAdminControlledDirections, alaDaUNPMacIpPortRuleMacAddr=alaDaUNPMacIpPortRuleMacAddr, alaDaUNPEndPoinProfile3=alaDaUNPEndPoinProfile3, alaDaUNPVlanGroup=alaDaUNPVlanGroup, alaDaUNPValidityPeriodName=alaDaUNPValidityPeriodName, alaDaUNPIpPortRuleProfile3=alaDaUNPIpPortRuleProfile3, alaDaUNPPortRuleEntry=alaDaUNPPortRuleEntry, alaDaUNPSpbFlushTable=alaDaUNPSpbFlushTable, alaDaUNPPortTemplate8021XAuth=alaDaUNPPortTemplate8021XAuth, alaDaUNPIpPortRuleNum=alaDaUNPIpPortRuleNum, alaDaUNPEdgeProfMobileTag=alaDaUNPEdgeProfMobileTag, alaDaUNPVlanTagRuleVlan=alaDaUNPVlanTagRuleVlan, alaDaMacVlanUserKerberosStatus=alaDaMacVlanUserKerberosStatus, alaDaUNPRstrctedRolePolicyList=alaDaUNPRstrctedRolePolicyList, alaDaUNPNoAuthEdgeUserFlush=alaDaUNPNoAuthEdgeUserFlush, alaDaUNPCustDomainMacIpRuleIpMask=alaDaUNPCustDomainMacIpRuleIpMask, alaDaMacVlanUserQMRStatus=alaDaMacVlanUserQMRStatus, alaDaUNPMacOuiRuleEntry=alaDaUNPMacOuiRuleEntry, alaDaUNPEdgeFlushPortHigh=alaDaUNPEdgeFlushPortHigh, alaDaUnpCommandType=alaDaUnpCommandType, alaDaUnpMacAddr2=alaDaUnpMacAddr2, alaDaUNPGroupIdEdgeClassifyGroup=alaDaUNPGroupIdEdgeClassifyGroup, alaDaUNPLocationPolicyPortHigh=alaDaUNPLocationPolicyPortHigh, alaDaCPortalProfAaaProf=alaDaCPortalProfAaaProf, alaDaUNPMacGroupRuleAddr=alaDaUNPMacGroupRuleAddr, alaDaUNPVlanRuleRowStatus=alaDaUNPVlanRuleRowStatus, alaDaHICHostEntry=alaDaHICHostEntry, alaDaUnpMacAddr=alaDaUnpMacAddr, alaDaUNPETmpl8021XAuthStatus=alaDaUNPETmpl8021XAuthStatus, alaDaHICSvrIpAddr=alaDaHICSvrIpAddr, alaDaUNPEdgeFlushProfile=alaDaUNPEdgeFlushProfile, alaDaUNPAuthServerDownUnp=alaDaUNPAuthServerDownUnp, alaDaUNPMacPortRuleProfile2=alaDaUNPMacPortRuleProfile2, alaDaHICAllowedName=alaDaHICAllowedName, alaDaUNPProfileMapSpbIsid=alaDaUNPProfileMapSpbIsid, alaDaMacUserUnpUsed=alaDaMacUserUnpUsed, alaDaUNPMacAddrsRuleGroup=alaDaUNPMacAddrsRuleGroup, alaDaUNPVlanMapRowStatus=alaDaUNPVlanMapRowStatus, alaDaUNPProfileMapVxlanGroup=alaDaUNPProfileMapVxlanGroup, alaDaUNPClassifRowStatus=alaDaUNPClassifRowStatus, alaDaUNPMacPortRuleTable=alaDaUNPMacPortRuleTable, alaDaUserNetProfileVlanID=alaDaUserNetProfileVlanID, alaDaCPortalProfTable=alaDaCPortalProfTable, alaDaUserNetProfileMaxIngressBw=alaDaUserNetProfileMaxIngressBw, alaDaSpbProfileEncapVal=alaDaSpbProfileEncapVal, alaDaUNPMacIpGroupRuleVlanTag=alaDaUNPMacIpGroupRuleVlanTag, alaDaUNPValidityPeriodDays=alaDaUNPValidityPeriodDays, alaDaUNPCustDomainMacIpRuleVlanTag=alaDaUNPCustDomainMacIpRuleVlanTag, alaDaUNPEndPoinRuleRowStatus=alaDaUNPEndPoinRuleRowStatus, alaDaMacVlanUserSpbIsid=alaDaMacVlanUserSpbIsid, alaDaMacVlanUserAuthRetryCount=alaDaMacVlanUserAuthRetryCount, alaDaUNPProfileMapVxlanEncapVal=alaDaUNPProfileMapVxlanEncapVal, alaDaUNPPortType=alaDaUNPPortType, alaDaUNPGroupRuleEntry=alaDaUNPGroupRuleEntry, alaDaKerberosGlobalPolicy=alaDaKerberosGlobalPolicy, alaDaKerberosClientPktSwDiscardStats=alaDaKerberosClientPktSwDiscardStats, alaDaUNPMacClassifyGroup=alaDaUNPMacClassifyGroup, alaDaUNPMacGroupRuleVlanTag=alaDaUNPMacGroupRuleVlanTag, alaDaUNPIpNetRuleMask=alaDaUNPIpNetRuleMask, alaDaUNPVxlanFarEndIPListTable=alaDaUNPVxlanFarEndIPListTable, alaDaUNPSpbFlushMacAddress=alaDaUNPSpbFlushMacAddress, alaDaUNPPortTemplateForceL3Learning=alaDaUNPPortTemplateForceL3Learning, alaDaUNPEdgeFlushGroup=alaDaUNPEdgeFlushGroup, alaDaUNPCustDomainMacIpRuleMacAddr=alaDaUNPCustDomainMacIpRuleMacAddr, alaDaMacVlanUserExtAppName=alaDaMacVlanUserExtAppName, alaDaUNPPortMaxEgressDepth=alaDaUNPPortMaxEgressDepth, alaDaKerberosPortStatsTable=alaDaKerberosPortStatsTable, alaDaUNPAuthServerDowneEdgeProfTimeout=alaDaUNPAuthServerDowneEdgeProfTimeout, alaDaUNPUserRoleGroup=alaDaUNPUserRoleGroup, alaDaUNPForceL3LearningPortBounce=alaDaUNPForceL3LearningPortBounce, alaDaMacVlanUserUnpFromAuthServer=alaDaMacVlanUserUnpFromAuthServer, alaDaUnpCustomerDomainDesc=alaDaUnpCustomerDomainDesc, alaDaMacUserIntfNum=alaDaMacUserIntfNum, alaDaUNPClassifRuleAuthType=alaDaUNPClassifRuleAuthType, alaDaUNPAuthSrvDownEdgeProfName=alaDaUNPAuthSrvDownEdgeProfName, alaDaUNPGroupObjects=alaDaUNPGroupObjects, alaDaUNPPortTemplateRowStatus=alaDaUNPPortTemplateRowStatus, alaDaCPortalAuthRealm=alaDaCPortalAuthRealm, alaDaUNPMacEdgeUserFlush=alaDaUNPMacEdgeUserFlush, alaDaUNPAuthRuleEdgeProfile=alaDaUNPAuthRuleEdgeProfile, alaDaUNPCustDomainMacIpRuleProfile1=alaDaUNPCustDomainMacIpRuleProfile1, alaDaUNPSpbFlushSpbProfile=alaDaUNPSpbFlushSpbProfile, alaDaCPortalMIBObjects=alaDaCPortalMIBObjects, alaDaCPortalAuthPassEntry=alaDaCPortalAuthPassEntry, alaDaUNPPortTemplateClassification=alaDaUNPPortTemplateClassification, alaDaUNPClassifRuleProfile1=alaDaUNPClassifRuleProfile1, alaDaUNPCustDomainRuleGroup=alaDaUNPCustDomainRuleGroup, alaDaUNPCustDomainVlanTagRuleTagPosition=alaDaUNPCustDomainVlanTagRuleTagPosition, alaDaUNPMacOuiRuleVlanTag=alaDaUNPMacOuiRuleVlanTag, alaDaUNPEdgeProfRowStatus=alaDaUNPEdgeProfRowStatus, alaDaCPortalAuthUNPProfile=alaDaCPortalAuthUNPProfile, alaDaUNPPortDefaultProfileName=alaDaUNPPortDefaultProfileName, alaDaUNPValidityPeriodTable=alaDaUNPValidityPeriodTable)
mibBuilder.exportSymbols("ALCATEL-ENT1-DA-MIB", AlaDaMacLearntState=AlaDaMacLearntState, alaDaCPortalGroup=alaDaCPortalGroup, alaDaMacUserEntry=alaDaMacUserEntry, alaDaUNPLocationPolicyName=alaDaUNPLocationPolicyName, alaDaUNPDynamicProfileConfigFlag=alaDaUNPDynamicProfileConfigFlag, alaDaMacVlanUserRole=alaDaMacVlanUserRole, alaDaUNPIpNetRuleRowStatus=alaDaUNPIpNetRuleRowStatus, alaDaUNPProfileMapSpbGroup=alaDaUNPProfileMapSpbGroup, alaDaHICSvrPort=alaDaHICSvrPort, alaDaUNPIpNetRuleGroup=alaDaUNPIpNetRuleGroup, alaDaUNPCustDomainVlanTagRuleProfile1=alaDaUNPCustDomainVlanTagRuleProfile1, alaDaUNPPortRuleProfile1=alaDaUNPPortRuleProfile1, alaDaUNPProfileMaxEgressBandwidth=alaDaUNPProfileMaxEgressBandwidth, alaDaMacUserGroup=alaDaMacUserGroup, alaDaUNPMacRangeRuleLoAddr=alaDaUNPMacRangeRuleLoAddr, alaDaUNPPortPassAltProfileName=alaDaUNPPortPassAltProfileName, alaDaHICSvrFailChangedPolicyName=alaDaHICSvrFailChangedPolicyName, alaDaUNPCustDomainMacIpRuleRowStatus=alaDaUNPCustDomainMacIpRuleRowStatus, alaDaUNPCustDomainIpNetRuleProfileName=alaDaUNPCustDomainIpNetRuleProfileName, alaDaUNPUserRolePolicyList=alaDaUNPUserRolePolicyList, alaDaUNPETmplForceL3Learning=alaDaUNPETmplForceL3Learning, alaDaUNPMacOuiRuleTable=alaDaUNPMacOuiRuleTable, alaDaCPortalSuccRedirectUrl=alaDaCPortalSuccRedirectUrl, alaDaKerberosGlobalInactivityTimer=alaDaKerberosGlobalInactivityTimer, alaDaUNPSpbFlushSapIDEncapVal=alaDaUNPSpbFlushSapIDEncapVal, alaDaMacVlanUserServiceID=alaDaMacVlanUserServiceID, alaDaUNPPortAaaProfile=alaDaUNPPortAaaProfile, alaDaUNPClassifRuleGroupId=alaDaUNPClassifRuleGroupId, alaDaUNPProfileMapVlanEntry=alaDaUNPProfileMapVlanEntry, alaDaUNPCustDomainVlanTagRuleEntry=alaDaUNPCustDomainVlanTagRuleEntry, alaDaUNPRstrctedRoleTable=alaDaUNPRstrctedRoleTable, alaDaUNPMacOuiRuleAddr=alaDaUNPMacOuiRuleAddr, alaDaUNPGlobalGroup=alaDaUNPGlobalGroup, alaDaMacVlanUserAuthServerIpUsed=alaDaMacVlanUserAuthServerIpUsed, alaDaUNPClassifRulePort=alaDaUNPClassifRulePort, alaDaUNPPort8021XEdgeProfName=alaDaUNPPort8021XEdgeProfName, alaDaCPortalProxyPort=alaDaCPortalProxyPort, alaDaUNPVlanRuleVlanTag=alaDaUNPVlanRuleVlanTag, alaDaNotificationObjectGroup=alaDaNotificationObjectGroup, alaDaUNPCustDomainMacRuleEdgeProfileName=alaDaUNPCustDomainMacRuleEdgeProfileName, alaDaUNPGlobalConfiguration=alaDaUNPGlobalConfiguration, alaDaQMRAllowedIpAddrType=alaDaQMRAllowedIpAddrType, alaDaHICHostMac=alaDaHICHostMac, alaDaUNPETmplVlanEntry=alaDaUNPETmplVlanEntry, alaDaUNPMacPortClassifyGroup=alaDaUNPMacPortClassifyGroup, alaDaKerberosRateLimitExceed=alaDaKerberosRateLimitExceed, alaDaUNPETmpl8021XSuppTimeOut=alaDaUNPETmpl8021XSuppTimeOut, alaDaUNPEdgeProfCPortalProf=alaDaUNPEdgeProfCPortalProf, alaDaUNPEndPoinProfile1=alaDaUNPEndPoinProfile1, alaDaUNPPortTemplateTrustTag=alaDaUNPPortTemplateTrustTag, alaDaUNPPortIfIndex=alaDaUNPPortIfIndex, alaDaUNPUserFlushPortEnd=alaDaUNPUserFlushPortEnd, alaDaUNPPortPVlanPortType=alaDaUNPPortPVlanPortType, alaDaUNPCustDomainMacIpRuleProfile2=alaDaUNPCustDomainMacIpRuleProfile2, alaDaUNPCustDomainMacRuleGroup=alaDaUNPCustDomainMacRuleGroup, alaDaUNPMacIpPortRuleNum=alaDaUNPMacIpPortRuleNum, alaDaUNPEndPoinRuleEntry=alaDaUNPEndPoinRuleEntry, alaDaMacVlanUserEntry=alaDaMacVlanUserEntry, alaDaMacVlanUserVxlanVnid=alaDaMacVlanUserVxlanVnid, alaDaUNPETmplName=alaDaUNPETmplName, alaDaUNPMacRulesVlanTag=alaDaUNPMacRulesVlanTag, alaDaUNPRestrictedRoleGroup=alaDaUNPRestrictedRoleGroup, alaDaUNPUserFlushMacAddress=alaDaUNPUserFlushMacAddress, alaDaUNPPort8021XSuppTimeOut=alaDaUNPPort8021XSuppTimeOut, alaDaKerberosInactivityTimerExpiryTrap=alaDaKerberosInactivityTimerExpiryTrap, alaDaUNPCustDomainEvbGpIdRuleRowStatus=alaDaUNPCustDomainEvbGpIdRuleRowStatus, alaDaUNPClassifRuleName=alaDaUNPClassifRuleName, alaDaUNPMacIpPortRuleProfile1=alaDaUNPMacIpPortRuleProfile1, alaDaUNPVlanRuleVlanTagPosition=alaDaUNPVlanRuleVlanTagPosition, alaDaSpbProfileIsid=alaDaSpbProfileIsid, alaDaUNPGroup=alaDaUNPGroup, alaDaUNPAuthServerDownProfile2=alaDaUNPAuthServerDownProfile2, alaDaUNPClassifRuleMacRngLoaddr=alaDaUNPClassifRuleMacRngLoaddr, alaDaUNPUserRoleRowStatus=alaDaUNPUserRoleRowStatus, alaDaUNPProfileRowStatus=alaDaUNPProfileRowStatus, alaDaCPortalProfUNPProfileChange=alaDaCPortalProfUNPProfileChange, alaDaKerberosUserName=alaDaKerberosUserName, alaDaSpbProfileName=alaDaSpbProfileName, alaDaKerberosServerTable=alaDaKerberosServerTable, alaDaCPortalGlobalConfig=alaDaCPortalGlobalConfig, alaDaUNPCustDomainIpNetRuleGroup=alaDaUNPCustDomainIpNetRuleGroup, alaDaUNPProfileName=alaDaUNPProfileName, alaDaUNPCustDomainIpNetRuleRowStatus=alaDaUNPCustDomainIpNetRuleRowStatus, alaDaUNPLocationPolicyEntry=alaDaUNPLocationPolicyEntry, alaDaUNPEdgeProfAuthStatus=alaDaUNPEdgeProfAuthStatus, alaDaKerberosPortClientPktRxStats=alaDaKerberosPortClientPktRxStats, alaDaUNPPortTemplateVlanTable=alaDaUNPPortTemplateVlanTable, unpMcLagMacIgnored=unpMcLagMacIgnored, alaDaCPortalProfEntry=alaDaCPortalProfEntry, alaDaUNPEdgeFlushTable=alaDaUNPEdgeFlushTable, alaDaUNPCustDomainVlanTagRuleSpbProfileName=alaDaUNPCustDomainVlanTagRuleSpbProfileName, alaDaUNPVxlanProfileFarEndIPListName=alaDaUNPVxlanProfileFarEndIPListName, alaDaUNPPortTemplateAAAProfile=alaDaUNPPortTemplateAAAProfile, alaDaUNPCustDomainIpNetRuleVlanTag=alaDaUNPCustDomainIpNetRuleVlanTag, alaIND1DaMIBConformance=alaIND1DaMIBConformance, alaDaHICBgPollInterval=alaDaHICBgPollInterval, alaDaUNPSpbFlushServiceID=alaDaUNPSpbFlushServiceID, alaDaSpbProfileMulticastMode=alaDaSpbProfileMulticastMode, alaDaUNPPortRuleRowStatus=alaDaUNPPortRuleRowStatus, alaDaUNPVxlanFarEndIPAddressListIP=alaDaUNPVxlanFarEndIPAddressListIP, alaDaUNPMacPortRuleProfile1=alaDaUNPMacPortRuleProfile1, alaDaHICHostTable=alaDaHICHostTable, alaDaUNPPortForceL3Learning=alaDaUNPPortForceL3Learning, alaDaUNPVxlanProfileRowStatus=alaDaUNPVxlanProfileRowStatus, alaDaUNPVxlanFarEndIPAddressListEntry=alaDaUNPVxlanFarEndIPAddressListEntry, alaDaUNPVxlanProfileVnid=alaDaUNPVxlanProfileVnid, alaDaUNPMacRulesMacAddr=alaDaUNPMacRulesMacAddr, alaDaUNPProfileMapSpbEncapVal=alaDaUNPProfileMapSpbEncapVal, alaDaUNPVxlanFlushIndex=alaDaUNPVxlanFlushIndex, alaDaUNPIpNetRuleEntry=alaDaUNPIpNetRuleEntry, alaDaUNPEdgeProfDHCPEnforcment=alaDaUNPEdgeProfDHCPEnforcment, alaDaUNPVxlanFlushMacAddress=alaDaUNPVxlanFlushMacAddress, alaDaMacVlanUserRestAccessStatus=alaDaMacVlanUserRestAccessStatus, alaDaUNPClassifRuleVlanTag=alaDaUNPClassifRuleVlanTag, alaDaUNPClassifRulePortHigh=alaDaUNPClassifRulePortHigh, alaDaMacVlanUserIntfNum=alaDaMacVlanUserIntfNum, alaDaMacVlanUserExtIntfNum=alaDaMacVlanUserExtIntfNum, alaDaUNPMacIpGroupRuleRowStatus=alaDaUNPMacIpGroupRuleRowStatus, alaDaUNPETmpl8021XTxPeriod=alaDaUNPETmpl8021XTxPeriod, alaDaUNPNotificationObjects=alaDaUNPNotificationObjects, alaDaKerberosServerEntry=alaDaKerberosServerEntry, alaDaUNPPortRuleVlanTag=alaDaUNPPortRuleVlanTag, alaDaSpbProfileTable=alaDaSpbProfileTable, alaDaMacVlanUserIpAddress=alaDaMacVlanUserIpAddress, alaDaUNPValidityPeriodRowStatus=alaDaUNPValidityPeriodRowStatus, alaDaUNPUserRolePrecedenceNum=alaDaUNPUserRolePrecedenceNum, alaDaUNPMacRuleRowStatus=alaDaUNPMacRuleRowStatus, alaDaUNPMacRulesEdgeProf=alaDaUNPMacRulesEdgeProf, alaDaUNPMacIpPortRuleRowStatus=alaDaUNPMacIpPortRuleRowStatus, alaDaKerberosGroup=alaDaKerberosGroup, alaDaHICSvrFailPolicyTable=alaDaHICSvrFailPolicyTable, alaDaUNPPortTemplateDynamicService=alaDaUNPPortTemplateDynamicService, alaDaCPortalAuthRowStatus=alaDaCPortalAuthRowStatus, alaDaUNPUserRoleProfile1=alaDaUNPUserRoleProfile1, alaDaKerberosUdpPort=alaDaKerberosUdpPort, alaDaUNPCustDomainRuleProfile2=alaDaUNPCustDomainRuleProfile2, alaDaMacVlanUserServiceSapIDEncapVal=alaDaMacVlanUserServiceSapIDEncapVal, alaDaUNPCustDomainVlanTagRuleDomainId=alaDaUNPCustDomainVlanTagRuleDomainId, alaDaUNPVxlanFlushServiceID=alaDaUNPVxlanFlushServiceID, alaDaUNPIpPortRuleEntry=alaDaUNPIpPortRuleEntry, alaDaUNPMacGroupRuleRowStatus=alaDaUNPMacGroupRuleRowStatus, alaDaUNPPortVlanRowStatus=alaDaUNPPortVlanRowStatus, alaDaUNPIpNetRuleTable=alaDaUNPIpNetRuleTable, alaDaMacVlanUserTable=alaDaMacVlanUserTable, alaDaSpbProfileMobileTag=alaDaSpbProfileMobileTag, alaDaUNPEndPoinRuleId=alaDaUNPEndPoinRuleId, alaDaUnpIpAddr=alaDaUnpIpAddr, alaDaMacVlanUserExtTable=alaDaMacVlanUserExtTable, alaDaMacVlanUserExtEntry=alaDaMacVlanUserExtEntry, alaDaUNPUserFlushPortStart=alaDaUNPUserFlushPortStart, alaDaUNPCustDomainRuleRowStatus=alaDaUNPCustDomainRuleRowStatus, alaDaUNPIpNetRuleVlanTag=alaDaUNPIpNetRuleVlanTag, alaDaCPortalProfDomainRowStatus=alaDaCPortalProfDomainRowStatus, alaDaUNPVlanTagRuleRowStatus=alaDaUNPVlanTagRuleRowStatus, alaDaUNPProfileMapVxlanTable=alaDaUNPProfileMapVxlanTable, alaDaHICSvrStatus=alaDaHICSvrStatus, alaDaNotificationsGroup=alaDaNotificationsGroup, alaDaUNPMacIpGroupRuleEntry=alaDaUNPMacIpGroupRuleEntry, alaDaUNPUserFlushSapIDEncapVal=alaDaUNPUserFlushSapIDEncapVal, alaDaUNPVxlanFarEndIPListEntry=alaDaUNPVxlanFarEndIPListEntry, alaDaUNPProfileMaxIngressDepth=alaDaUNPProfileMaxIngressDepth, alaDaUNPCustDomainMacRuleProfile3=alaDaUNPCustDomainMacRuleProfile3, alaDaUNPETmplTable=alaDaUNPETmplTable, AlaDaClassificationPolicyType=AlaDaClassificationPolicyType, alaDaUNPMacIpGroupRuleTable=alaDaUNPMacIpGroupRuleTable, alaDaMacVlanUserExtVlanID=alaDaMacVlanUserExtVlanID, alaDaKerberosTotalErrorRxStats=alaDaKerberosTotalErrorRxStats, alaDaUNPMacRulesTable=alaDaUNPMacRulesTable, alaDaKerberosTotalASREQRxStats=alaDaKerberosTotalASREQRxStats, alaDaUNPMacRuleGroup=alaDaUNPMacRuleGroup, alaDaUNPValidityPeriodEndHour=alaDaUNPValidityPeriodEndHour, alaDaUNPPortAFDConfig=alaDaUNPPortAFDConfig, alaDaUNPCustDomainMacRuleProfile2=alaDaUNPCustDomainMacRuleProfile2, alaDaUNPCustDomainVlanTagRuleVxlanProfileName=alaDaUNPCustDomainVlanTagRuleVxlanProfileName, alaDaUNPMacOuiRuleProfile1=alaDaUNPMacOuiRuleProfile1, alaDaQMRPath=alaDaQMRPath, alaDaUNPEdgeProfMaxEgressDepth=alaDaUNPEdgeProfMaxEgressDepth, alaDaUNPIpPortRuleRowStatus=alaDaUNPIpPortRuleRowStatus, alaDaUNPRstrctedRoleRowStatus=alaDaUNPRstrctedRoleRowStatus, alaDaUNPClassifRuleEndPoin=alaDaUNPClassifRuleEndPoin, alaDaUNPVxlanFlushSapIDIfIndex=alaDaUNPVxlanFlushSapIDIfIndex, alaDaUNPProfileMapVlanRowStatus=alaDaUNPProfileMapVlanRowStatus, alaDaUNPClassifRuleEntry=alaDaUNPClassifRuleEntry, alaDaUNPCustDomainEvbGpIdRuleGroupId=alaDaUNPCustDomainEvbGpIdRuleGroupId, alaDaKerberosIpAddressType=alaDaKerberosIpAddressType, alaDaUNPAuthServerDownProfile3=alaDaUNPAuthServerDownProfile3, alaDaUNPPortMaxEgressBwSource=alaDaUNPPortMaxEgressBwSource, alaDaUNPPortDynamicService=alaDaUNPPortDynamicService, alaDaKerberosTotalClientPktRxStats=alaDaKerberosTotalClientPktRxStats)
