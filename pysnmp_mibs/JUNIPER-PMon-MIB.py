...
mibBuilder.exportSymbols("JUNIPER-PMon-MIB", PYSNMP_MODULE_ID=jnxPMon, jnxPMonFlowTotalFree=jnxPMonFlowTotalFree, jnxPMonOverloadCleared=jnxPMonOverloadCleared, jnxPMonTotalMemoryFree=jnxPMonTotalMemoryFree, jnxPMonFlowFreeFailures=jnxPMonFlowFreeFailures, jnxPMonFlowEntry=jnxPMonFlowEntry, jnxPMonMemoryTable=jnxPMonMemoryTable, jnxPMonFreePerSecond=jnxPMonFreePerSecond, jnxPMonErrorEntry=jnxPMonErrorEntry, jnxPMonTotalFlows=jnxPMonTotalFlows, jnxPMonTenSecondAverageFlowBytes=jnxPMonTenSecondAverageFlowBytes, jnxPMonFreeListFailures=jnxPMonFreeListFailures, jnxPMonTotalFlowsPacketsExported=jnxPMonTotalFlowsPacketsExported, jnxPMonTenSecondAverageFlowPackets=jnxPMonTenSecondAverageFlowPackets, jnxPMonTotalFlowsAged=jnxPMonTotalFlowsAged, jnxPMonOverloadSet=jnxPMonOverloadSet, jnxPMonTotalFlowsExpired=jnxPMonTotalFlowsExpired, jnxPMonLastOverload=jnxPMonLastOverload, jnxPMonCurrentOverload=jnxPMonCurrentOverload, JnxPMonOverloadId=JnxPMonOverloadId, jnxPMonNotificationPrefix=jnxPMonNotificationPrefix, jnxPMonLastOverloadDate=jnxPMonLastOverloadDate, jnxPMon=jnxPMon, jnxPMonFlowTable=jnxPMonFlowTable, jnxPMonMemoryEntry=jnxPMonMemoryEntry, jnxPMonCurrentActiveFlows=jnxPMonCurrentActiveFlows, jnxPMonTooSmallDrops=jnxPMonTooSmallDrops, jnxPMonNoMemDrops=jnxPMonNoMemDrops, jnxPMonLastOverloadTime=jnxPMonLastOverloadTime, jnxPMonNotIPDrops=jnxPMonNotIPDrops, jnxPMonNotIPv4Drops=jnxPMonNotIPv4Drops, jnxPMonTotalMemoryUsed=jnxPMonTotalMemoryUsed, jnxPMonErrorTable=jnxPMonErrorTable, jnxPMonLastOverloadEvent=jnxPMonLastOverloadEvent, jnxPMonAllocPerSecond=jnxPMonAllocPerSecond, jnxPMonFlowTotalAlloc=jnxPMonFlowTotalAlloc, jnxPMonTotalFlowsPackets=jnxPMonTotalFlowsPackets, jnxPMonFlowAllocFailures=jnxPMonFlowAllocFailures, jnxPMonFlowMaxAlloc=jnxPMonFlowMaxAlloc, jnxPMonTotalFlowsExported=jnxPMonTotalFlowsExported, jnxPMonTotalFlowsBytes=jnxPMonTotalFlowsBytes)
