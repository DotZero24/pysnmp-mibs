...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-SSE-MIB
...
_RbnFSGroupRevert_Type.__name__ = "TruthValue"
...
rbnSseMIBCompliance.setObjects(
      *(("RBN-SSE-MIB", "rbnSseFileServerGroup"),
        ("RBN-SSE-MIB", "rbnSsePartitionGroup"),
        ("RBN-SSE-MIB", "rbnSseEventObjectGroup"),
        ("RBN-SSE-MIB", "rbnSseEventGroup"))
)
if mibBuilder.loadTexts:
