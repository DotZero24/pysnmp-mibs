...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-ALPS-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:26:05 2025
...
mibBuilder.exportSymbols("CISCO-ALPS-MIB", alpsAscuEntry=alpsAscuEntry, alpsRemPeerDropsQFull=alpsRemPeerDropsQFull, alpsSvcMsgListNum=alpsSvcMsgListNum, alpsIfP1024ServMsgFormat=alpsIfP1024ServMsgFormat, PYSNMP_MODULE_ID=ciscoAlpsMIB, alpsCktBaseDropsQOverflow=alpsCktBaseDropsQOverflow, alpsRemPeerNumActiveCkts=alpsRemPeerNumActiveCkts, alpsAscuAutoReset=alpsAscuAutoReset, ciscoAlpsMIB=ciscoAlpsMIB, alpsCktBaseEntry=alpsCktBaseEntry, alpsIfP1024NumAscus=alpsIfP1024NumAscus, alpsPeerStatusChange=alpsPeerStatusChange, alpsIfP1024PollingRatio=alpsIfP1024PollingRatio, alpsAscuDropsAscuDown=alpsAscuDropsAscuDown, alpsCktX25IfIndex=alpsCktX25IfIndex, alpsCktP1024Table=alpsCktP1024Table, alpsCktAscuA1=alpsCktAscuA1, alpsCktX25Entry=alpsCktX25Entry, alpsX121=alpsX121, alpsRemPeerConnEntry=alpsRemPeerConnEntry, alpsRemPeerCfgEntry=alpsRemPeerCfgEntry, alpsCktP1024SvcMsgList=alpsCktP1024SvcMsgList, alpsIfP1024MaxErrCnt=alpsIfP1024MaxErrCnt, alpsRemPeerOutPackets=alpsRemPeerOutPackets, alpsRemPeerEntry=alpsRemPeerEntry, alpsSvcMsgEntry=alpsSvcMsgEntry, alpsAscuId=alpsAscuId, alpsGlobalObjects=alpsGlobalObjects, alpsPeerLocalIpAddr=alpsPeerLocalIpAddr, alpsIfP1024GroupRev1=alpsIfP1024GroupRev1, alpsRemPeerCfgActivation=alpsRemPeerCfgActivation, alpsRemPeerConnLastRxAny=alpsRemPeerConnLastRxAny, alpsRemPeerCfgStatRetry=alpsRemPeerCfgStatRetry, alpsRemPeerConnActivation=alpsRemPeerConnActivation, alpsRemPeerConnOutPackets=alpsRemPeerConnOutPackets, alpsRemPeerConnInPackets=alpsRemPeerConnInPackets, alpsSvcMsgNum=alpsSvcMsgNum, ciscoAlpsMIBNotificationPrefix=ciscoAlpsMIBNotificationPrefix, alpsNotificationGroup=alpsNotificationGroup, alpsCktStatusChange=alpsCktStatusChange, alpsCktP1024EmtoxX121=alpsCktP1024EmtoxX121, alpsAscuStatusChange=alpsAscuStatusChange, alpsRemPeerInOctets=alpsRemPeerInOctets, alpsIfP1024MaxRetrans=alpsIfP1024MaxRetrans, alpsCktGroup=alpsCktGroup, alpsAscuGroup=alpsAscuGroup, alpsRemPeerCfgIpAddr=alpsRemPeerCfgIpAddr, alpsAscuDropsAscuDisabled=alpsAscuDropsAscuDisabled, alpsNotificationGroupRev1=alpsNotificationGroupRev1, alpsRemPeerUptime=alpsRemPeerUptime, alpsRemPeerCfgTable=alpsRemPeerCfgTable, alpsCktBasePriPeerAddr=alpsCktBasePriPeerAddr, alpsMibConformance=alpsMibConformance, alpsRemPeerCfgNoCircTimer=alpsRemPeerCfgNoCircTimer, alpsCktBaseHostLinkType=alpsCktBaseHostLinkType, alpsAscuOutPackets=alpsAscuOutPackets, alpsRemPeerCfgRowStatus=alpsRemPeerCfgRowStatus, alpsRemPeerConnDownReason=alpsRemPeerConnDownReason, alpsIfHLinkEmtoxHostX121=alpsIfHLinkEmtoxHostX121, alpsAscuDropsGarbledPkts=alpsAscuDropsGarbledPkts, alpsRemPeerConnNumActCirc=alpsRemPeerConnNumActCirc, alpsCktP1024RowStatus=alpsCktP1024RowStatus, alpsRemPeerRowStatus=alpsRemPeerRowStatus, alpsIfP1024PollRespTimeout=alpsIfP1024PollRespTimeout, alpsCktP1024DropsUnkAscu=alpsCktP1024DropsUnkAscu, alpsRemPeerConnStatRetry=alpsRemPeerConnStatRetry, alpsIfP1024MinGoodPollResp=alpsIfP1024MinGoodPollResp, alpsIfP1024ServMsgStatusChange=alpsIfP1024ServMsgStatusChange, alpsCktBaseAlarmsEnabled=alpsCktBaseAlarmsEnabled, alpsRemPeerOutOctets=alpsRemPeerOutOctets, alpsAscuRowStatus=alpsAscuRowStatus, alpsPeer=alpsPeer, alpsSvcMsg=alpsSvcMsg, alpsAscuDownReason=alpsAscuDownReason, alpsCktBaseLifeTimeTimer=alpsCktBaseLifeTimeTimer, alpsRemPeerConnType=alpsRemPeerConnType, alpsAscuMaxMsgLength=alpsAscuMaxMsgLength, alpsIfP1024EncapType=alpsIfP1024EncapType, alpsRemPeerTable=alpsRemPeerTable, alpsCktAscuIfIndex=alpsCktAscuIfIndex, alpsCktAscuId=alpsCktAscuId, alpsPeerInCallsAcceptFlag=alpsPeerInCallsAcceptFlag, alpsPeerConnStatusChange=alpsPeerConnStatusChange, alpsCktP1024BackupPeerAddr=alpsCktP1024BackupPeerAddr, alpsCktAscuCktName=alpsCktAscuCktName, alpsIfHLinkNumber=alpsIfHLinkNumber, alpsAscuA1=alpsAscuA1, alpsPeerKeepaliveTimeout=alpsPeerKeepaliveTimeout, alpsRemPeerCfgStatIntvl=alpsRemPeerCfgStatIntvl, alpsRemPeerConnTable=alpsRemPeerConnTable, alpsRemPeerConnProtocol=alpsRemPeerConnProtocol, alpsCktX25DropsVcReset=alpsCktX25DropsVcReset, alpsIfP1024Table=alpsIfP1024Table, alpsRemPeerConnLastTxRx=alpsRemPeerConnLastTxRx, alpsRemPeerConnIdleTimer=alpsRemPeerConnIdleTimer, alpsCktBaseInPackets=alpsCktBaseInPackets, alpsRemPeerTCPQlen=alpsRemPeerTCPQlen, alpsCktBaseDropsLifeTimeExpd=alpsCktBaseDropsLifeTimeExpd, alpsMibCompliances=alpsMibCompliances, alpsCktBaseOutPackets=alpsCktBaseOutPackets, alpsCktBaseRowStatus=alpsCktBaseRowStatus, alpsCktP1024MatipCloseDelay=alpsCktP1024MatipCloseDelay, alpsAscuObjects=alpsAscuObjects, alpsAscuAlarmsEnabled=alpsAscuAlarmsEnabled, alpsRemPeerRemotePort=alpsRemPeerRemotePort, alpsRemPeerConnNoCircTimer=alpsRemPeerConnNoCircTimer, alpsCktBaseName=alpsCktBaseName, alpsAscuState=alpsAscuState, alpsRemPeerLocalPort=alpsRemPeerLocalPort, alpsCktX25HostX121=alpsCktX25HostX121, alpsIpAddress=alpsIpAddress, alpsRemPeerConnTCPQLen=alpsRemPeerConnTCPQLen, alpsCktP1024WinIn=alpsCktP1024WinIn, alpsCktBaseState=alpsCktBaseState, alpsCktBaseInOctets=alpsCktBaseInOctets, alpsRemPeerConnForeignPort=alpsRemPeerConnForeignPort, alpsAscuInPackets=alpsAscuInPackets, alpsRemPeerCfgAlarmsOn=alpsRemPeerCfgAlarmsOn, ciscoAlpsMIBObjects=ciscoAlpsMIBObjects, alpsSvcMsgTable=alpsSvcMsgTable, alpsIfP1024Entry=alpsIfP1024Entry, alpsRemPeerConnLocalPort=alpsRemPeerConnLocalPort, alpsCktBaseRemHld=alpsCktBaseRemHld, alpsIfP1024GATimeout=alpsIfP1024GATimeout, alpsIfP1024PollPauseTimeout=alpsIfP1024PollPauseTimeout, alpsCktP1024Ax25LCN=alpsCktP1024Ax25LCN, alpsCktP1024WinOut=alpsCktP1024WinOut, alpsMibComplianceRev2=alpsMibComplianceRev2, alpsRemPeerConnAlarmsOn=alpsRemPeerConnAlarmsOn, alpsRemPeerConnDropsVersion=alpsRemPeerConnDropsVersion, alpsCktAscuEntry=alpsCktAscuEntry, alpsAscuFwdStatusOption=alpsAscuFwdStatusOption, alpsCktX25LCN=alpsCktX25LCN, alpsAscuA2=alpsAscuA2, alpsAscuEnabled=alpsAscuEnabled, alpsIfHLinkX25ProtocolType=alpsIfHLinkX25ProtocolType, alpsPeerGroup=alpsPeerGroup, alpsMibGroups=alpsMibGroups, alpsRemPeerConnCreation=alpsRemPeerConnCreation, alpsRemPeerConnOutOctets=alpsRemPeerConnOutOctets, alpsCktX25Table=alpsCktX25Table, alpsAscuOutOctets=alpsAscuOutOctets, alpsAscuCktName=alpsAscuCktName, alpsCktP1024OutPktSize=alpsCktP1024OutPktSize, alpsCktP1024Entry=alpsCktP1024Entry, alpsCktObjects=alpsCktObjects, alpsCktX25DlcType=alpsCktX25DlcType, alpsCktAscuCktDlcType=alpsCktAscuCktDlcType, alpsCktP1024IdleTimer=alpsCktP1024IdleTimer, AlpsCktName=AlpsCktName, alpsCktBaseLocalHld=alpsCktBaseLocalHld, alpsCktBaseHostLinkNumber=alpsCktBaseHostLinkNumber, alpsIfP1024Group=alpsIfP1024Group, alpsSvcMsgGroup=alpsSvcMsgGroup, alpsX121ToIpTransRowStatus=alpsX121ToIpTransRowStatus, alpsAddrTransGroup=alpsAddrTransGroup, alpsAscuGroupRev1=alpsAscuGroupRev1, alpsIfP1024ServMsgDropTermAddr=alpsIfP1024ServMsgDropTermAddr, alpsIfHLinkTable=alpsIfHLinkTable, alpsRemPeerConnState=alpsRemPeerConnState, AlpsAscuA1A2Value=AlpsAscuA1A2Value, alpsMibComplianceRev1=alpsMibComplianceRev1, alpsRemPeerCfgTCPQLen=alpsRemPeerCfgTCPQLen, alpsIfHLinkEntry=alpsIfHLinkEntry, alpsAscuInOctets=alpsAscuInOctets, alpsRemPeerIpAddr=alpsRemPeerIpAddr, alpsX121ToIpTransEntry=alpsX121ToIpTransEntry, alpsCktAscuA2=alpsCktAscuA2, alpsCktOpenFailure=alpsCktOpenFailure, alpsIfP1024CurrErrCnt=alpsIfP1024CurrErrCnt, ciscoAlpsMIBNotifications=ciscoAlpsMIBNotifications, alpsIfHLinkAx25PvcDamp=alpsIfHLinkAx25PvcDamp, alpsCktBaseEnabled=alpsCktBaseEnabled, alpsCktP1024SvcMsgIntvl=alpsCktP1024SvcMsgIntvl, alpsRemPeerCfgIdleTimer=alpsRemPeerCfgIdleTimer, alpsCktBaseConnType=alpsCktBaseConnType, alpsCktBaseDropsCktDisabled=alpsCktBaseDropsCktDisabled, alpsCktP1024InPktSize=alpsCktP1024InPktSize, alpsIfHLinkActiveCkts=alpsIfHLinkActiveCkts, alpsRemPeerConnIpAddr=alpsRemPeerConnIpAddr, alpsCktBaseTable=alpsCktBaseTable, alpsCktBaseDlcType=alpsCktBaseDlcType, alpsCktP1024DlcType=alpsCktP1024DlcType, alpsRemPeerIdleTimer=alpsRemPeerIdleTimer, alpsCktBaseOutOctets=alpsCktBaseOutOctets, alpsMibCompliance=alpsMibCompliance, alpsRemPeerConnInOctets=alpsRemPeerConnInOctets, alpsPeerLocalAtpPort=alpsPeerLocalAtpPort, alpsAscuTable=alpsAscuTable, alpsCktBaseNumActiveAscus=alpsCktBaseNumActiveAscus, alpsCktPartialReject=alpsCktPartialReject, alpsRemPeerInPackets=alpsRemPeerInPackets, alpsCktAscuTable=alpsCktAscuTable, alpsGroups=alpsGroups, alpsRemPeerState=alpsRemPeerState, alpsCktP1024RetryTimer=alpsCktP1024RetryTimer, alpsPeerGroupRev1=alpsPeerGroupRev1, alpsIfHLinkHostHld=alpsIfHLinkHostHld, alpsPeerKeepaliveMaxRetries=alpsPeerKeepaliveMaxRetries, alpsX121ToIpTransTable=alpsX121ToIpTransTable, alpsRemPeerConnDropsQFull=alpsRemPeerConnDropsQFull, alpsRemPeerAlarmsEnabled=alpsRemPeerAlarmsEnabled, alpsRemPeerConnIdString=alpsRemPeerConnIdString, alpsCktBaseCurrentPeer=alpsCktBaseCurrentPeer, alpsRemPeerDropsGiant=alpsRemPeerDropsGiant, alpsAscuRetryOption=alpsAscuRetryOption, alpsRemPeerConnUptime=alpsRemPeerConnUptime, alpsSvcMsgRowStatus=alpsSvcMsgRowStatus, alpsPeerObjects=alpsPeerObjects, alpsCktAscuStatus=alpsCktAscuStatus, alpsNotificationGroupRev2=alpsNotificationGroupRev2, alpsRemPeerCfgProtocol=alpsRemPeerCfgProtocol, alpsCktBaseCurrPeerConnId=alpsCktBaseCurrPeerConnId, alpsIfHostlinkGroup=alpsIfHostlinkGroup, alpsRemPeerConnStatIntvl=alpsRemPeerConnStatIntvl, alpsCktBaseDownReason=alpsCktBaseDownReason, alpsRemPeerConnDropsUnreach=alpsRemPeerConnDropsUnreach, alpsCktX25RemoteX121=alpsCktX25RemoteX121, alpsRemPeerDropsPeerUnreach=alpsRemPeerDropsPeerUnreach, alpsRemPeerConnDropsGiant=alpsRemPeerConnDropsGiant, alpsIfObjects=alpsIfObjects)
