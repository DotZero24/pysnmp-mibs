...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/eaton/MG-SNMP-UPS-MIB
...
mibBuilder.exportSymbols("MG-SNMP-UPS-MIB", mgmanagerAddress=mgmanagerAddress, upsmgBatteryNotHighCharge=upsmgBatteryNotHighCharge, upsmgOutputOverTemp=upsmgOutputOverTemp, upsRedundancyLost=upsRedundancyLost, upsmgConfigLowBatteryTime=upsmgConfigLowBatteryTime, upsmgControlDayOn=upsmgControlDayOn, upsmgEnvironAmbientHumidity=upsmgEnvironAmbientHumidity, upsmgConfigOutputNomFrequency=upsmgConfigOutputNomFrequency, upsmgReturnFromBoost=upsmgReturnFromBoost, upsmgEnvironInput1Open=upsmgEnvironInput1Open, upsmgEnvironSensorNum=upsmgEnvironSensorNum, mgreceptacleType=mgreceptacleType, upsmgEnvironmentSensorEntry=upsmgEnvironmentSensorEntry, upsmgReceptaclesNum=upsmgReceptaclesNum, upsmgConfigInput2ClosedLabel=upsmgConfigInput2ClosedLabel, upsmgBatteryReplacement=upsmgBatteryReplacement, upsmgTest=upsmgTest, upsmgInputOK=upsmgInputOK, upsmgOutputUnavailableByPass=upsmgOutputUnavailableByPass, upsmgByPassAvailable=upsmgByPassAvailable, upsmgIdentUserID=upsmgIdentUserID, upsmgBatteryReplacementIndicated=upsmgBatteryReplacementIndicated, mgreceptacleOffCtrl=mgreceptacleOffCtrl, upsmgOutputOnBuck=upsmgOutputOnBuck, upsmgBatteryTemperature=upsmgBatteryTemperature, upsmgEnvironInput2Closed=upsmgEnvironInput2Closed, upsmgTestCommandLine=upsmgTestCommandLine, mgdeviceSequenceOn=mgdeviceSequenceOn, upsmgConfigReceptaclesTable=upsmgConfigReceptaclesTable, mgreceptacleBootUpDuration=mgreceptacleBootUpDuration, mgextAlarmUID=mgextAlarmUID, upsmgBatteryLowRecharge=upsmgBatteryLowRecharge, mgreceptacleOverload=mgreceptacleOverload, mgreceptacleStateTurnOn=mgreceptacleStateTurnOn, mgcontrolDayOff=mgcontrolDayOff, mgreceptacleIndexc=mgreceptacleIndexc, upsmgConfigMaxRechargeTime=upsmgConfigMaxRechargeTime, mgmanagerIndex=mgmanagerIndex, mgreceptacleOnStatus=mgreceptacleOnStatus, upsmgEnvironHumidityLow=upsmgEnvironHumidityLow, upsmgAgentTrapAlarmDelay=upsmgAgentTrapAlarmDelay, upsmgTestBatteryResult=upsmgTestBatteryResult, upsmgEnvironSensorTable=upsmgEnvironSensorTable, mgreceptacleToggleDuration=mgreceptacleToggleDuration, upsmgInput=upsmgInput, upsmgConfigTemperatureLow=upsmgConfigTemperatureLow, upsmgBatteryChargerFault=upsmgBatteryChargerFault, upsmgEnvironmentHumidity=upsmgEnvironmentHumidity, upsmgAgentDefGateway=upsmgAgentDefGateway, mgcontrolDayIndex=mgcontrolDayIndex, upsmgInputLineFailCause=upsmgInputLineFailCause, upsmgEnvironTemperatureOK=upsmgEnvironTemperatureOK, upsmgConfigSensorIndex=upsmgConfigSensorIndex, upsmgBatteryRechargeTime=upsmgBatteryRechargeTime, upsmgConfigNominalBatteryTime=upsmgConfigNominalBatteryTime, upsmgEnvironmentComFailure=upsmgEnvironmentComFailure, upsmgBatteryRemainingTime=upsmgBatteryRemainingTime, upsmgTestCommandReady=upsmgTestCommandReady, mgdeviceReceptacleNum=mgdeviceReceptacleNum, upsmgReturnFromBattery=upsmgReturnFromBattery, upsmgToggleInProgress=upsmgToggleInProgress, mgoutputPhaseIndex=mgoutputPhaseIndex, mgsensorHumidity=mgsensorHumidity, upsmgToggleToStart=upsmgToggleToStart, upsmgBatteryAvailable=upsmgBatteryAvailable, upsmgAgentFactReset=upsmgAgentFactReset, upsmgConfigHumidityHigh=upsmgConfigHumidityHigh, upsmgOutputPhaseNum=upsmgOutputPhaseNum, upsmgInputPhaseTable=upsmgInputPhaseTable, upsmgDiagnosticTestOK=upsmgDiagnosticTestOK, upsmgConfigVARating=upsmgConfigVARating, mgmanagerNMSType=mgmanagerNMSType, upsmgAgentFirmwareVersion=upsmgAgentFirmwareVersion, upsmgConfigLowFader=upsmgConfigLowFader, upsmgLoadOK=upsmgLoadOK, upsmgChargerOK=upsmgChargerOK, upsmgOutputNoByPass=upsmgOutputNoByPass, upsmgEnvironmentInput1State=upsmgEnvironmentInput1State, upsmgToggleAbort=upsmgToggleAbort, upsmgEnvironmentTemperatureHigh=upsmgEnvironmentTemperatureHigh, upsmgConfigEnvironmentEntry=upsmgConfigEnvironmentEntry, upsmgToggleComplete=upsmgToggleComplete, upsmgConfigLowBatteryLevel=upsmgConfigLowBatteryLevel, upsmgConfigSysShutDuration=upsmgConfigSysShutDuration, upsmgEnvironSensorEntry=upsmgEnvironSensorEntry, upsmgAgentTrapSignature=upsmgAgentTrapSignature, upsmgEnvironAmbientTemp=upsmgEnvironAmbientTemp, mgreceptacleShutdownDuration=mgreceptacleShutdownDuration, upsmgTestIndicators=upsmgTestIndicators, upsmgInputBad=upsmgInputBad, upsmgBatteryFault=upsmgBatteryFault, upsmgIdent=upsmgIdent, upsmgConfigEnvironmentTable=upsmgConfigEnvironmentTable, upsmgAgentPollRate=upsmgAgentPollRate, upsmgOffComplete=upsmgOffComplete, mgdeviceBootUpDuration=mgdeviceBootUpDuration, upsmgOffToStart=upsmgOffToStart, upsmgFromLowBattery=upsmgFromLowBattery, upsmgControlReceptaclesTable=upsmgControlReceptaclesTable, upsmgConfigNominalRechargeTime=upsmgConfigNominalRechargeTime, upsmgEnvironmentInput2State=upsmgEnvironmentInput2State, upsmgEnvironmentNum=upsmgEnvironmentNum, upsmgIdentModelName=upsmgIdentModelName, upsmgConfigDevicesTable=upsmgConfigDevicesTable, mgreceptacleStateMainReturn=mgreceptacleStateMainReturn, upsmgTestBatterySchedule=upsmgTestBatterySchedule, mgdeviceShutdownDuration=mgdeviceShutdownDuration, mgmanagerCommunity=mgmanagerCommunity, upsmgEnvironmentTemperatureLow=upsmgEnvironmentTemperatureLow, mgmanagerCommType=mgmanagerCommType, upsmgConfigSensorName=upsmgConfigSensorName, upsmgOnToStart=upsmgOnToStart, upsmgEnviron=upsmgEnviron, upsmgEnvironInput2Open=upsmgEnvironInput2Open, upsmgConfigEmergencyOverload=upsmgConfigEmergencyOverload, upsmgByPassUnavailable=upsmgByPassUnavailable, upsmgAgentType=upsmgAgentType, mgreceptaclePowerCons=mgreceptaclePowerCons, mgoutputFrequency=mgoutputFrequency, upsmgConfigInput2OpenLabel=upsmgConfigInput2OpenLabel, upsmgReceptaclesEntry=upsmgReceptaclesEntry, upsmgConfigLowBooster=upsmgConfigLowBooster, upsmgConfigDevicesNum=upsmgConfigDevicesNum, mgreceptacleReceptacle=mgreceptacleReceptacle, upsmgTestDiagResult=upsmgTestDiagResult, mginputFrequency=mginputFrequency, upsmgBatteryLowCondition=upsmgBatteryLowCondition, upsmgManagement=upsmgManagement, upsmgManagersEntry=upsmgManagersEntry, upsmgBattery=upsmgBattery, mgoutputVoltage=mgoutputVoltage, mgreceptacleIndex=mgreceptacleIndex, mgreceptacleIdent=mgreceptacleIdent, upsmgEnvironComFailure=upsmgEnvironComFailure, mgreceptacleStateDischarge=mgreceptacleStateDischarge, upsmgOnAbort=upsmgOnAbort, mgreceptacleIndexb=mgreceptacleIndexb, mgreceptacleLevel=mgreceptacleLevel, upsmgConfigAutoRestart=upsmgConfigAutoRestart, mgextAlarmIndex=mgextAlarmIndex, upsmgControlReceptaclesEntry=upsmgControlReceptaclesEntry, upsmgManagersTable=upsmgManagersTable, upsmgOnBoost=upsmgOnBoost, upsmgUtilityRestored=upsmgUtilityRestored, upsmgAtLowBattery=upsmgAtLowBattery, upsmgConfigEmergencyOnByPass=upsmgConfigEmergencyOnByPass, upsmgBatteryUnavailableBattery=upsmgBatteryUnavailableBattery, upsmgConfigOutputNominalCurrent=upsmgConfigOutputNominalCurrent, upsmgConfigByPassType=upsmgConfigByPassType, mginputMaximumVoltage=mginputMaximumVoltage, upsmgConfigTemperatureHysteresis=upsmgConfigTemperatureHysteresis, upsmgFromLowRecharge=upsmgFromLowRecharge, upsmgAgentTrapAlarmRetry=upsmgAgentTrapAlarmRetry, upsmgEnvironmentHumidityHigh=upsmgEnvironmentHumidityHigh, upsmgOnInProgress=upsmgOnInProgress, upsmgTestResponseLine=upsmgTestResponseLine, upsmgControlDayOff=upsmgControlDayOff, mgreceptacleOnCtrl=mgreceptacleOnCtrl, upsmgManagersNum=upsmgManagersNum, mgdeviceIdent=mgdeviceIdent, upsmgEnvironInput1Closed=upsmgEnvironInput1Closed, upsmgEnvironmentHumidityLow=upsmgEnvironmentHumidityLow, upsmgBatteryLowBattery=upsmgBatteryLowBattery, upsmgOutputOnBoost=upsmgOutputOnBoost, upsmgReturnFromByPass=upsmgReturnFromByPass, upsmgUtilityFailure=upsmgUtilityFailure, upsmgEnvironTemperatureHigh=upsmgEnvironTemperatureHigh, upsmgConfigHumidityLow=upsmgConfigHumidityLow, upsmgBatteryFullRechargeTime=upsmgBatteryFullRechargeTime, upsmgAtLowRecharge=upsmgAtLowRecharge, mgmanagerTrapAck=mgmanagerTrapAck, upsmgBatteryNoBattery=upsmgBatteryNoBattery, upsmgOnComplete=upsmgOnComplete, upsmgFromLowCondition=upsmgFromLowCondition, upsmgConfigHighTransfer=upsmgConfigHighTransfer, upsmgOutputPhaseEntry=upsmgOutputPhaseEntry, upsmgOutputPhaseTable=upsmgOutputPhaseTable, upsmgOutputUtilityOff=upsmgOutputUtilityOff, upsmgChargerFault=upsmgChargerFault, upsmgConfigMinRechargeLevel=upsmgConfigMinRechargeLevel, upsmgConfigControlDayTable=upsmgConfigControlDayTable, upsmgEnvironmentTemperature=upsmgEnvironmentTemperature, upsmgBatteryReplaceNotIndicated=upsmgBatteryReplaceNotIndicated, upsmgAgentMibVersion=upsmgAgentMibVersion, upsmgOnByPass=upsmgOnByPass, upsmgEnvironExtAlarmEntry=upsmgEnvironExtAlarmEntry, mgmanagerDescr=mgmanagerDescr, upsmgConfigShutdownTimer=upsmgConfigShutdownTimer, upsmgIdentRevisionLevel=upsmgIdentRevisionLevel, upsmgOutputOnBattery=upsmgOutputOnBattery, upsmgBatteryRechargeLevel=upsmgBatteryRechargeLevel, merlinGerin=merlinGerin, upsmgOutputOnByPass=upsmgOutputOnByPass, upsmgConfig=upsmgConfig, mgmanagerDeviceNumber=mgmanagerDeviceNumber, upsmgAgentAutoLearning=upsmgAgentAutoLearning, upsmgConfigReceptaclesEntry=upsmgConfigReceptaclesEntry, upsmgEnvironHumidityHigh=upsmgEnvironHumidityHigh, upsmgOverLoad=upsmgOverLoad, upsmg=upsmg, upsmgAgentBaudRate=upsmgAgentBaudRate, upsmgReturnFromBuck=upsmgReturnFromBuck, upsmgReceptaclesTable=upsmgReceptaclesTable, mginputMinimumVoltage=mginputMinimumVoltage, upsmgControl=upsmgControl, upsmgOffInProgress=upsmgOffInProgress, upsmgConfigInput1OpenLabel=upsmgConfigInput1OpenLabel, upsmgConfigExtAlarmEntry=upsmgConfigExtAlarmEntry, upsmgConfigEmergencyTestFail=upsmgConfigEmergencyTestFail, mginputCurrent=mginputCurrent, upsmgBatteryLevel=upsmgBatteryLevel, upsmgAgentTFTP=upsmgAgentTFTP, upsmgEnvironComOK=upsmgEnvironComOK, upsRedundancyOK=upsRedundancyOK, mgreceptacleToggleStatus=mgreceptacleToggleStatus, upsmgBatteryVoltage=upsmgBatteryVoltage, mgoutputLoadPerPhase=mgoutputLoadPerPhase, upsmgOffAbort=upsmgOffAbort, mgsensorNum=mgsensorNum, upsmgBatteryTestFail=upsmgBatteryTestFail, upsmgAgentBootP=upsmgAgentBootP, upsmgConfigInput1ClosedLabel=upsmgConfigInput1ClosedLabel, upsmgConfigExtAlarmTable=upsmgConfigExtAlarmTable, mgreceptacleOffDelay=mgreceptacleOffDelay, upsmgConfigBatteryInstalled=upsmgConfigBatteryInstalled, mgreceptacleAutonomy=mgreceptacleAutonomy, mgcontrolDayOn=mgcontrolDayOn, upsmgConfigAlarmAudible=upsmgConfigAlarmAudible, upsmgAtLowCondition=upsmgAtLowCondition, mgreceptacleState=mgreceptacleState, upsmgExternalAlarmInactive=upsmgExternalAlarmInactive, upsmgConfigTemperatureHigh=upsmgConfigTemperatureHigh, mgalarmNum=mgalarmNum, mgmanagerSeverityLevel=mgmanagerSeverityLevel, upsmgConfigInput2Name=upsmgConfigInput2Name, mgreceptacleToggleCtrl=mgreceptacleToggleCtrl, upsmgCommunicationFailure=upsmgCommunicationFailure, mginputVoltage=mginputVoltage, upsmgOnBuck=upsmgOnBuck, upsmgEnvironExtAlarmTable=upsmgEnvironExtAlarmTable, mgreceptacleOffStatus=mgreceptacleOffStatus, upsmgConfigNominalBatteryVoltage=upsmgConfigNominalBatteryVoltage, upsmgConfigInput1Name=upsmgConfigInput1Name, mginputIndex=mginputIndex, upsmgRemoteIpAddress=upsmgRemoteIpAddress, upsmgTestResponseReady=upsmgTestResponseReady, upsmgBatteryCurrent=upsmgBatteryCurrent, mgreceptacleOnDelay=mgreceptacleOnDelay, upsmgCommunicationRestored=upsmgCommunicationRestored, upsmgAgentReset=upsmgAgentReset, upsmgIdentSerialNumber=upsmgIdentSerialNumber, mgdeviceVaRating=mgdeviceVaRating, upsmgEnvironHumidityOK=upsmgEnvironHumidityOK, upsmgIdentFirmwareVersion=upsmgIdentFirmwareVersion)
mibBuilder.exportSymbols("MG-SNMP-UPS-MIB", mgdeviceSequenceOff=mgdeviceSequenceOff, upsmgConfigLowTransfer=upsmgConfigLowTransfer, upsmgConfigDevicesEntry=upsmgConfigDevicesEntry, upsmgInputPhaseEntry=upsmgInputPhaseEntry, mgreceptacleRestartLevel=mgreceptacleRestartLevel, upsmgBatteryFaultBattery=upsmgBatteryFaultBattery, upsmgBatteryTestOK=upsmgBatteryTestOK, upsmgOutputOverLoad=upsmgOutputOverLoad, upsmgIdentFamilyName=upsmgIdentFamilyName, upsmgEnvironmentIndex=upsmgEnvironmentIndex, upsmgOutputInverterOff=upsmgOutputInverterOff, upsmgConfigExtAlarmNum=upsmgConfigExtAlarmNum, upsmgConfigHighFader=upsmgConfigHighFader, upsmgExternalAlarmActive=upsmgExternalAlarmActive, upsmgConfigOutputNominalVoltage=upsmgConfigOutputNominalVoltage, upsmgTestLastCalibration=upsmgTestLastCalibration, upsmgAgentIpaddress=upsmgAgentIpaddress, upsmgBatteryOK=upsmgBatteryOK, upsmgOnBattery=upsmgOnBattery, upsmgBatteryUnavailable=upsmgBatteryUnavailable, upsmgConfigAlarmTimeDelay=upsmgConfigAlarmTimeDelay, upsmgRemote=upsmgRemote, mgoutputCurrent=mgoutputCurrent, mgalarmState=mgalarmState, upsmgTestDiagnostics=upsmgTestDiagnostics, upsmgIdentInstallationDate=upsmgIdentInstallationDate, mgreceptacleToggleDelay=mgreceptacleToggleDelay, upsmgAgentSubnetMask=upsmgAgentSubnetMask, upsmgOverTemperature=upsmgOverTemperature, mgdeviceIndex=mgdeviceIndex, upsmgReceptacle=upsmgReceptacle, upsmgAgentTrapAck=upsmgAgentTrapAck, mgreceptacleShutoffTimer=mgreceptacleShutoffTimer, upsmgConfigHumidityHysteresis=upsmgConfigHumidityHysteresis, upsmgEnvironTemperatureLow=upsmgEnvironTemperatureLow, upsmgRemoteOnBattery=upsmgRemoteOnBattery, upsmgAgent=upsmgAgent, upsmgOutput=upsmgOutput, mgreceptacleRestartDelay=mgreceptacleRestartDelay, mgreceptacleShutoffLevel=mgreceptacleShutoffLevel, upsmgInputBadStatus=upsmgInputBadStatus, upsmgConfigControlDayEntry=upsmgConfigControlDayEntry, upsmgEnvironmentSensorTable=upsmgEnvironmentSensorTable, mgsensorTemp=mgsensorTemp, upsmgTemperatureOK=upsmgTemperatureOK, upsmgTraps=upsmgTraps, upsmgDiagnosticTestFail=upsmgDiagnosticTestFail, upsProtectionLost=upsProtectionLost, upsmgInputPhaseNum=upsmgInputPhaseNum, upsProtectionOK=upsProtectionOK, upsmgTestBatteryCalibration=upsmgTestBatteryCalibration, upsmgConfigHighBooster=upsmgConfigHighBooster, upsmgAgentCommUPS=upsmgAgentCommUPS)
