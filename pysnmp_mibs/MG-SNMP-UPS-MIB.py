...
mibBuilder.exportSymbols("MG-SNMP-UPS-MIB", upsmgBatteryReplacement=upsmgBatteryReplacement, upsmgConfigDevicesNum=upsmgConfigDevicesNum, upsmgReceptacle=upsmgReceptacle, upsmgByPassUnavailable=upsmgByPassUnavailable, mgmanagerIndex=mgmanagerIndex, upsmgAgentTrapAlarmDelay=upsmgAgentTrapAlarmDelay, upsmgConfigLowBooster=upsmgConfigLowBooster, upsmgIdent=upsmgIdent, upsmgCommunicationFailure=upsmgCommunicationFailure, upsmgTestLastCalibration=upsmgTestLastCalibration, upsmgConfigAutoRestart=upsmgConfigAutoRestart, upsmgInputBad=upsmgInputBad, upsmgOffComplete=upsmgOffComplete, upsmgConfigLowBatteryTime=upsmgConfigLowBatteryTime, upsmgAgentIpaddress=upsmgAgentIpaddress, upsmgBattery=upsmgBattery, upsmgOutputPhaseNum=upsmgOutputPhaseNum, upsmgOutputNoByPass=upsmgOutputNoByPass, mgreceptacleOffStatus=mgreceptacleOffStatus, upsmgAtLowCondition=upsmgAtLowCondition, upsmgManagersTable=upsmgManagersTable, upsmgBatteryFaultBattery=upsmgBatteryFaultBattery, mgdeviceIdent=mgdeviceIdent, upsmgConfigControlDayEntry=upsmgConfigControlDayEntry, upsRedundancyLost=upsRedundancyLost, upsmgConfigAlarmTimeDelay=upsmgConfigAlarmTimeDelay, upsmgAgentTFTP=upsmgAgentTFTP, upsmgControlReceptaclesTable=upsmgControlReceptaclesTable, upsmgConfigByPassType=upsmgConfigByPassType, upsmgAgentSubnetMask=upsmgAgentSubnetMask, upsmgRemote=upsmgRemote, upsmgAgentTrapAck=upsmgAgentTrapAck, upsmgEnvironExtAlarmEntry=upsmgEnvironExtAlarmEntry, upsmgConfigDevicesTable=upsmgConfigDevicesTable, mgreceptacleStateDischarge=mgreceptacleStateDischarge, upsmgBatteryRechargeLevel=upsmgBatteryRechargeLevel, upsmgToggleToStart=upsmgToggleToStart, upsmgAgentCommUPS=upsmgAgentCommUPS, upsmgAgentMibVersion=upsmgAgentMibVersion, upsmgConfigInput2Name=upsmgConfigInput2Name, upsmgOnBuck=upsmgOnBuck, upsmgCommunicationRestored=upsmgCommunicationRestored, upsmgControlDayOn=upsmgControlDayOn, mgoutputCurrent=mgoutputCurrent, mginputIndex=mginputIndex, mgreceptacleRestartDelay=mgreceptacleRestartDelay, upsmgOutputOnBuck=upsmgOutputOnBuck, upsmgUtilityFailure=upsmgUtilityFailure, upsmgOnBoost=upsmgOnBoost, upsmgConfigOutputNominalCurrent=upsmgConfigOutputNominalCurrent, upsmgOnBattery=upsmgOnBattery, upsmgConfigInput1OpenLabel=upsmgConfigInput1OpenLabel, upsmgOnInProgress=upsmgOnInProgress, upsmgManagersEntry=upsmgManagersEntry, upsmgAgent=upsmgAgent, mgreceptacleIndex=mgreceptacleIndex, upsmgToggleComplete=upsmgToggleComplete, upsmgTraps=upsmgTraps, mgreceptacleReceptacle=mgreceptacleReceptacle, upsmgInputPhaseEntry=upsmgInputPhaseEntry, upsmgTestDiagnostics=upsmgTestDiagnostics, upsmgConfigOutputNominalVoltage=upsmgConfigOutputNominalVoltage, upsmgConfigLowBatteryLevel=upsmgConfigLowBatteryLevel, upsmgConfigTemperatureLow=upsmgConfigTemperatureLow, upsmgConfigHighTransfer=upsmgConfigHighTransfer, upsmgConfigLowFader=upsmgConfigLowFader, upsmgBatteryFullRechargeTime=upsmgBatteryFullRechargeTime, mgreceptacleLevel=mgreceptacleLevel, upsmgAtLowBattery=upsmgAtLowBattery, upsmgInputLineFailCause=upsmgInputLineFailCause, upsmgBatteryChargerFault=upsmgBatteryChargerFault, mgsensorNum=mgsensorNum, upsmgConfigNominalBatteryTime=upsmgConfigNominalBatteryTime, mgreceptacleStateMainReturn=mgreceptacleStateMainReturn, mgreceptacleOnDelay=mgreceptacleOnDelay, upsmgIdentSerialNumber=upsmgIdentSerialNumber, upsmgEnvironTemperatureLow=upsmgEnvironTemperatureLow, upsmgBatteryNotHighCharge=upsmgBatteryNotHighCharge, upsmgEnviron=upsmgEnviron, upsmgEnvironTemperatureHigh=upsmgEnvironTemperatureHigh, upsmgBatteryTemperature=upsmgBatteryTemperature, upsmgManagersNum=upsmgManagersNum, mginputVoltage=mginputVoltage, upsmgOutputOverLoad=upsmgOutputOverLoad, mgreceptacleToggleDelay=mgreceptacleToggleDelay, upsmgConfigMaxRechargeTime=upsmgConfigMaxRechargeTime, upsmgBatteryRemainingTime=upsmgBatteryRemainingTime, upsmgConfigAlarmAudible=upsmgConfigAlarmAudible, upsmgConfigInput2OpenLabel=upsmgConfigInput2OpenLabel, upsmgBatteryOK=upsmgBatteryOK, upsmgInputPhaseTable=upsmgInputPhaseTable, upsmgIdentRevisionLevel=upsmgIdentRevisionLevel, upsmgEnvironInput1Open=upsmgEnvironInput1Open, upsmgOutputOnByPass=upsmgOutputOnByPass, upsmgConfigHumidityLow=upsmgConfigHumidityLow, mgreceptacleBootUpDuration=mgreceptacleBootUpDuration, mgreceptacleIdent=mgreceptacleIdent, mgreceptacleToggleStatus=mgreceptacleToggleStatus, upsmgOutputPhaseEntry=upsmgOutputPhaseEntry, upsmgFromLowRecharge=upsmgFromLowRecharge, upsmgBatteryFault=upsmgBatteryFault, upsmgConfigExtAlarmTable=upsmgConfigExtAlarmTable, upsmgBatteryLevel=upsmgBatteryLevel, mgreceptacleOffCtrl=mgreceptacleOffCtrl, upsmgAgentFirmwareVersion=upsmgAgentFirmwareVersion, upsmgReturnFromByPass=upsmgReturnFromByPass, upsmgTestCommandReady=upsmgTestCommandReady, upsmgConfigOutputNomFrequency=upsmgConfigOutputNomFrequency, upsmgBatteryVoltage=upsmgBatteryVoltage, upsmgIdentModelName=upsmgIdentModelName, upsmgTestResponseLine=upsmgTestResponseLine, mgreceptacleToggleDuration=mgreceptacleToggleDuration, mgdeviceShutdownDuration=mgdeviceShutdownDuration, upsProtectionOK=upsProtectionOK, mgcontrolDayOff=mgcontrolDayOff, upsmgEnvironComFailure=upsmgEnvironComFailure, upsmgEnvironHumidityOK=upsmgEnvironHumidityOK, mgmanagerCommunity=mgmanagerCommunity, upsmgOutputInverterOff=upsmgOutputInverterOff, upsmgTestDiagResult=upsmgTestDiagResult, upsmgAtLowRecharge=upsmgAtLowRecharge, upsmgConfigBatteryInstalled=upsmgConfigBatteryInstalled, upsmgEnvironExtAlarmTable=upsmgEnvironExtAlarmTable, upsmgAgentReset=upsmgAgentReset, upsmgBatteryCurrent=upsmgBatteryCurrent, upsmgExternalAlarmActive=upsmgExternalAlarmActive, upsmgEnvironComOK=upsmgEnvironComOK, upsmgConfigEnvironmentTable=upsmgConfigEnvironmentTable, upsmgTestIndicators=upsmgTestIndicators, upsmgReturnFromBoost=upsmgReturnFromBoost, upsmgChargerFault=upsmgChargerFault, upsmgControl=upsmgControl, upsmgTemperatureOK=upsmgTemperatureOK, upsmgControlDayOff=upsmgControlDayOff, upsmgConfigSensorIndex=upsmgConfigSensorIndex, mgcontrolDayOn=mgcontrolDayOn, upsmgBatteryReplaceNotIndicated=upsmgBatteryReplaceNotIndicated, upsmgUtilityRestored=upsmgUtilityRestored, upsmgEnvironHumidityHigh=upsmgEnvironHumidityHigh, upsmgConfigReceptaclesEntry=upsmgConfigReceptaclesEntry, mgoutputVoltage=mgoutputVoltage, mgoutputPhaseIndex=mgoutputPhaseIndex, upsmgInput=upsmgInput, upsmgByPassAvailable=upsmgByPassAvailable, upsmgExternalAlarmInactive=upsmgExternalAlarmInactive, upsmg=upsmg, upsmgConfigControlDayTable=upsmgConfigControlDayTable, mgreceptacleOffDelay=mgreceptacleOffDelay, upsmgOnByPass=upsmgOnByPass, upsmgTestBatteryResult=upsmgTestBatteryResult, mgreceptacleShutdownDuration=mgreceptacleShutdownDuration, upsmgConfigReceptaclesTable=upsmgConfigReceptaclesTable, upsmgConfigInput1ClosedLabel=upsmgConfigInput1ClosedLabel, upsmgEnvironmentSensorEntry=upsmgEnvironmentSensorEntry, mgsensorTemp=mgsensorTemp, mgreceptacleOverload=mgreceptacleOverload, upsmgControlReceptaclesEntry=upsmgControlReceptaclesEntry, mgdeviceVaRating=mgdeviceVaRating, upsmgConfigSensorName=upsmgConfigSensorName, upsmgInputPhaseNum=upsmgInputPhaseNum, mgdeviceReceptacleNum=mgdeviceReceptacleNum, mgmanagerCommType=mgmanagerCommType, mgreceptacleState=mgreceptacleState, upsmgOffToStart=upsmgOffToStart, mgreceptacleIndexc=mgreceptacleIndexc, upsmgTestBatteryCalibration=upsmgTestBatteryCalibration, mgmanagerNMSType=mgmanagerNMSType, upsmgOutputUnavailableByPass=upsmgOutputUnavailableByPass, upsmgConfigTemperatureHysteresis=upsmgConfigTemperatureHysteresis, mgmanagerDeviceNumber=mgmanagerDeviceNumber, mgreceptacleAutonomy=mgreceptacleAutonomy, upsmgOnComplete=upsmgOnComplete, upsmgConfigHumidityHigh=upsmgConfigHumidityHigh, upsmgInputOK=upsmgInputOK, upsmgBatteryAvailable=upsmgBatteryAvailable, upsmgConfigExtAlarmNum=upsmgConfigExtAlarmNum, upsmgEnvironmentTemperature=upsmgEnvironmentTemperature, upsmgToggleAbort=upsmgToggleAbort, mgmanagerDescr=mgmanagerDescr, upsmgEnvironmentTemperatureHigh=upsmgEnvironmentTemperatureHigh, mgmanagerSeverityLevel=mgmanagerSeverityLevel, upsmgDiagnosticTestFail=upsmgDiagnosticTestFail, upsmgReceptaclesNum=upsmgReceptaclesNum, upsmgConfigExtAlarmEntry=upsmgConfigExtAlarmEntry, mgreceptacleShutoffLevel=mgreceptacleShutoffLevel, upsmgBatteryTestOK=upsmgBatteryTestOK, upsmgAgentFactReset=upsmgAgentFactReset, mgoutputFrequency=mgoutputFrequency, upsmgEnvironmentIndex=upsmgEnvironmentIndex, upsmgEnvironmentInput1State=upsmgEnvironmentInput1State, upsmgIdentFamilyName=upsmgIdentFamilyName, upsmgTestCommandLine=upsmgTestCommandLine, mgdeviceBootUpDuration=mgdeviceBootUpDuration, upsmgBatteryTestFail=upsmgBatteryTestFail, upsmgOutputOnBattery=upsmgOutputOnBattery, mginputMaximumVoltage=mginputMaximumVoltage, mgmanagerAddress=mgmanagerAddress, upsmgLoadOK=upsmgLoadOK, upsmgEnvironmentInput2State=upsmgEnvironmentInput2State, mgcontrolDayIndex=mgcontrolDayIndex, upsmgOverTemperature=upsmgOverTemperature, upsmgBatteryUnavailableBattery=upsmgBatteryUnavailableBattery, upsmgConfigMinRechargeLevel=upsmgConfigMinRechargeLevel, upsmgEnvironHumidityLow=upsmgEnvironHumidityLow, upsmgConfigEmergencyOnByPass=upsmgConfigEmergencyOnByPass, upsmgFromLowCondition=upsmgFromLowCondition, upsmgEnvironSensorTable=upsmgEnvironSensorTable, upsmgBatteryLowBattery=upsmgBatteryLowBattery, upsmgIdentFirmwareVersion=upsmgIdentFirmwareVersion, upsmgAgentType=upsmgAgentType, upsmgEnvironTemperatureOK=upsmgEnvironTemperatureOK, upsmgTestResponseReady=upsmgTestResponseReady, upsmgConfigInput1Name=upsmgConfigInput1Name, upsmgConfigHighBooster=upsmgConfigHighBooster, upsmgConfig=upsmgConfig, upsmgOutputOnBoost=upsmgOutputOnBoost, upsmgBatteryReplacementIndicated=upsmgBatteryReplacementIndicated, upsmgOutputUtilityOff=upsmgOutputUtilityOff, mginputCurrent=mginputCurrent, upsmgOnToStart=upsmgOnToStart, upsmgOnAbort=upsmgOnAbort, upsmgConfigNominalBatteryVoltage=upsmgConfigNominalBatteryVoltage, upsmgEnvironAmbientHumidity=upsmgEnvironAmbientHumidity, upsmgConfigSysShutDuration=upsmgConfigSysShutDuration, upsmgEnvironmentTemperatureLow=upsmgEnvironmentTemperatureLow, upsmgInputBadStatus=upsmgInputBadStatus, mgdeviceSequenceOn=mgdeviceSequenceOn, upsmgEnvironSensorNum=upsmgEnvironSensorNum, upsmgReceptaclesTable=upsmgReceptaclesTable, upsmgConfigNominalRechargeTime=upsmgConfigNominalRechargeTime, upsProtectionLost=upsProtectionLost, mgdeviceIndex=mgdeviceIndex, mgreceptacleType=mgreceptacleType, upsmgEnvironInput1Closed=upsmgEnvironInput1Closed, upsmgBatteryRechargeTime=upsmgBatteryRechargeTime, upsmgAgentBootP=upsmgAgentBootP, mginputFrequency=mginputFrequency, mgmanagerTrapAck=mgmanagerTrapAck, upsmgEnvironmentNum=upsmgEnvironmentNum, mgextAlarmUID=mgextAlarmUID, upsmgEnvironmentComFailure=upsmgEnvironmentComFailure, upsmgIdentUserID=upsmgIdentUserID, mgextAlarmIndex=mgextAlarmIndex, upsmgTest=upsmgTest, upsmgConfigTemperatureHigh=upsmgConfigTemperatureHigh, upsmgConfigLowTransfer=upsmgConfigLowTransfer, mgalarmNum=mgalarmNum, mginputMinimumVoltage=mginputMinimumVoltage, upsmgAgentDefGateway=upsmgAgentDefGateway, mgreceptacleIndexb=mgreceptacleIndexb, mgreceptacleShutoffTimer=mgreceptacleShutoffTimer, upsmgDiagnosticTestOK=upsmgDiagnosticTestOK, upsmgAgentPollRate=upsmgAgentPollRate, mgsensorHumidity=mgsensorHumidity)
mibBuilder.exportSymbols("MG-SNMP-UPS-MIB", upsmgEnvironmentHumidityLow=upsmgEnvironmentHumidityLow, upsmgAgentBaudRate=upsmgAgentBaudRate, upsmgAgentTrapSignature=upsmgAgentTrapSignature, upsmgBatteryUnavailable=upsmgBatteryUnavailable, upsmgBatteryNoBattery=upsmgBatteryNoBattery, upsmgTestBatterySchedule=upsmgTestBatterySchedule, upsmgOffInProgress=upsmgOffInProgress, upsmgOverLoad=upsmgOverLoad, upsmgAgentAutoLearning=upsmgAgentAutoLearning, upsmgConfigShutdownTimer=upsmgConfigShutdownTimer, upsmgConfigEnvironmentEntry=upsmgConfigEnvironmentEntry, upsmgFromLowBattery=upsmgFromLowBattery, upsmgEnvironInput2Open=upsmgEnvironInput2Open, mgreceptacleRestartLevel=mgreceptacleRestartLevel, upsmgToggleInProgress=upsmgToggleInProgress, mgreceptacleToggleCtrl=mgreceptacleToggleCtrl, upsmgEnvironSensorEntry=upsmgEnvironSensorEntry, upsmgOutputOverTemp=upsmgOutputOverTemp, upsmgChargerOK=upsmgChargerOK, upsmgOffAbort=upsmgOffAbort, upsRedundancyOK=upsRedundancyOK, upsmgEnvironAmbientTemp=upsmgEnvironAmbientTemp, upsmgConfigEmergencyOverload=upsmgConfigEmergencyOverload, upsmgManagement=upsmgManagement, upsmgEnvironmentHumidityHigh=upsmgEnvironmentHumidityHigh, mgoutputLoadPerPhase=mgoutputLoadPerPhase, merlinGerin=merlinGerin, mgdeviceSequenceOff=mgdeviceSequenceOff, mgreceptacleOnCtrl=mgreceptacleOnCtrl, upsmgReturnFromBattery=upsmgReturnFromBattery, upsmgBatteryLowRecharge=upsmgBatteryLowRecharge, upsmgRemoteOnBattery=upsmgRemoteOnBattery, upsmgConfigHumidityHysteresis=upsmgConfigHumidityHysteresis, upsmgConfigEmergencyTestFail=upsmgConfigEmergencyTestFail, upsmgEnvironmentSensorTable=upsmgEnvironmentSensorTable, upsmgConfigVARating=upsmgConfigVARating, upsmgReturnFromBuck=upsmgReturnFromBuck, upsmgOutput=upsmgOutput, upsmgOutputPhaseTable=upsmgOutputPhaseTable, mgreceptaclePowerCons=mgreceptaclePowerCons, upsmgEnvironInput2Closed=upsmgEnvironInput2Closed, upsmgConfigDevicesEntry=upsmgConfigDevicesEntry, upsmgBatteryLowCondition=upsmgBatteryLowCondition, mgreceptacleOnStatus=mgreceptacleOnStatus, mgreceptacleStateTurnOn=mgreceptacleStateTurnOn, upsmgRemoteIpAddress=upsmgRemoteIpAddress, upsmgAgentTrapAlarmRetry=upsmgAgentTrapAlarmRetry, upsmgConfigInput2ClosedLabel=upsmgConfigInput2ClosedLabel, upsmgReceptaclesEntry=upsmgReceptaclesEntry, upsmgIdentInstallationDate=upsmgIdentInstallationDate, upsmgEnvironmentHumidity=upsmgEnvironmentHumidity, upsmgConfigHighFader=upsmgConfigHighFader, mgalarmState=mgalarmState)
