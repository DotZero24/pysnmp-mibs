# SNMP MIB module (LANCOM-DENIALOFSERVICE-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-DENIALOFSERVICE-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:20:48 2025
...
class _AgentSwitchDenialOfServiceICMPv6Mode_Type(Integer32):
    """Custom type agentSwitchDenialOfServiceICMPv6Mode based on Integer32"""
    defaultValue = 2
...
_AgentSwitchDenialOfServiceICMPv6Mode_Type.__name__ = "Integer32"
_AgentSwitchDenialOfServiceICMPv6Mode_Object = MibScalar
agentSwitchDenialOfServiceICMPv6Mode = _AgentSwitchDenialOfServiceICMPv6Mode_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 31, 1, 20),
    _AgentSwitchDenialOfServiceICMPv6Mode_Type()
)
agentSwitchDenialOfServiceICMPv6Mode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSwitchDenialOfServiceICMPv6Mode.setStatus("current")


class _AgentSwitchDenialOfServicePortDdisable_Type(Integer32):
    """Custom type agentSwitchDenialOfServicePortDdisable based on Integer32"""
    defaultValue = 2
...
_AgentSwitchDenialOfServicePortDdisable_Type.__name__ = "Integer32"
_AgentSwitchDenialOfServicePortDdisable_Object = MibScalar
agentSwitchDenialOfServicePortDdisable = _AgentSwitchDenialOfServicePortDdisable_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 31, 1, 21),
    _AgentSwitchDenialOfServicePortDdisable_Type()
)
agentSwitchDenialOfServicePortDdisable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentSwitchDenialOfServicePortDdisable.setStatus("current")
...
mibBuilder.exportSymbols(
    "LANCOM-DENIALOFSERVICE-PRIVATE-MIB",
    **{"fastPathDenialOfService": fastPathDenialOfService,
       ...
       "agentSwitchDenialOfServiceICMPv6Mode": agentSwitchDenialOfServiceICMPv6Mode,
       "agentSwitchDenialOfServicePortDdisable": agentSwitchDenialOfServicePortDdisable}
)
