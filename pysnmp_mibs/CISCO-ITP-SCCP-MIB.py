...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ITP-SCCP-MIB
...
_CItpSccpGttMapStateNotifEnabled_Type.__name__ = "TruthValue"
...
cItpSccpMIBCompliance.setObjects(
      *(("CISCO-ITP-SCCP-MIB", "cItpSccpScalarsGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttConPcGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttMapGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttSelGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttGtaGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttAppGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
cItpSccpMIBComplianceRev1.setObjects(
      *(("CISCO-ITP-SCCP-MIB", "cItpSccpScalarsGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttConPcGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttMapGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpNotificationsGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpConfigStatusGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttSelGroupRev1"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttGtaGroupRev1"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttAppGrGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttPrefGroup"))
)
if mibBuilder.loadTexts:
...
cItpSccpMIBComplianceRev2.setObjects(
      *(("CISCO-ITP-SCCP-MIB", "cItpSccpScalarsGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttConPcGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttMapGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpNotificationsGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpConfigStatusGroup"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttSelGroupRev1"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttGtaGroupRev2"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttAppGrGroupRev2"),
        ("CISCO-ITP-SCCP-MIB", "cItpSccpGttPrefGroup"))
)
if mibBuilder.loadTexts:
