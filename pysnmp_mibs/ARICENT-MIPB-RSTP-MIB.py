# SNMP MIB module (ARICENT-MIPB-RSTP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MIPB-RSTP-MIB
...
fsMIPbRstContextInfoEntry = _FsMIPbRstContextInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 134, 1, 1, 1)
)
fsMIPbRstContextInfoEntry.setIndexNames(
    (0, "ARICENT-MIPB-RSTP-MIB", "fsMIPbRstContextId"),
)
if mibBuilder.loadTexts:
...
fsMIPbRstCVlanBridgeEntry = _FsMIPbRstCVlanBridgeEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 134, 1, 2, 1)
)
fsMIPbRstCVlanBridgeEntry.setIndexNames(
    (0, "ARICENT-MIPB-RSTP-MIB", "fsMIPbRstPort"),
)
if mibBuilder.loadTexts:
...
fsMIPbRstCVlanPortInfoEntry = _FsMIPbRstCVlanPortInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 134, 1, 3, 1)
)
fsMIPbRstCVlanPortInfoEntry.setIndexNames(
    (0, "ARICENT-MIPB-RSTP-MIB", "fsMIPbRstPort"),
    (0, "ARICENT-MIPB-RSTP-MIB", "fsMIPbRstCepSvid"),
)
if mibBuilder.loadTexts:
