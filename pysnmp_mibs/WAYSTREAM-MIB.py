...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/waystream/WAYSTREAM-MIB
...
wsIfXTable = MibTable((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7), )
if mibBuilder.loadTexts: wsIfXTable.setStatus('current')
wsIfXEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1), )
ifEntry.registerAugmentions(("WAYSTREAM-MIB", "wsIfXEntry"))
wsIfXEntry.setIndexNames(*ifEntry.getIndexNames())
if mibBuilder.loadTexts: wsIfXEntry.setStatus('current')
ifHCInErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 1), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCInErrors.setStatus('current')
ifHCInRunts = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 2), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCInRunts.setStatus('current')
ifHCInOversized = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 3), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCInOversized.setStatus('current')
ifHCInCRCErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 4), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCInCRCErrors.setStatus('current')
ifHCInJabbers = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 5), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCInJabbers.setStatus('current')
ifHCInFragments = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 6), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCInFragments.setStatus('current')
ifHCInSymbolErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 7), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCInSymbolErrors.setStatus('current')
ifHCInAlignmentErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 8), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCInAlignmentErrors.setStatus('current')
ifHCOutErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 9), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCOutErrors.setStatus('current')
ifHCOutCollisions = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 10), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCOutCollisions.setStatus('current')
ifHCOutDeferred = MibTableColumn((1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 11), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: ifHCOutDeferred.setStatus('current')
...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltTable=wsVoltTable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, ifHCOutErrors=ifHCOutErrors, ifHCInFragments=ifHCInFragments, wsPolicyName=wsPolicyName, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsFanEntry=wsFanEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTable=wsSFPTable, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortName=wsNeighbourPortName, wsFanNumber=wsFanNumber, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPCopperLen=wsSFPCopperLen, wsTempTHYST=wsTempTHYST, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsWritedummy=wsWritedummy, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyEntry=wsPolicyEntry, PYSNMP_MODULE_ID=ibos, wsFanRPM=wsFanRPM, wsEnvironment=wsEnvironment, wsSFPIndex=wsSFPIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPBitrate=wsSFPBitrate, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPConnector=wsSFPConnector, wsTempStatus=wsTempStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyOutBytes=wsPolicyOutBytes, wsTempMeasured=wsTempMeasured, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPVolt=wsSFPVolt, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyIfName=wsPolicyIfName, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempEntry=wsTempEntry, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTable=wsXFPTable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsIbosTempHigh=wsIbosTempHigh, wsXFPTemp=wsXFPTemp, ifHCInOversized=ifHCInOversized, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPEntry=wsSFPEntry, wsXFPTXPower=wsXFPTXPower, wsNeighbourState=wsNeighbourState, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPFDP=wsPFDP, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyCookie=wsPolicyCookie, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPIndex=wsXFPIndex, wsPolicyInPkts=wsPolicyInPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosVoltHigh=wsIbosVoltHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXPower=wsSFPTXPower, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyInBytes=wsPolicyInBytes, wsTempSensor=wsTempSensor, wsXFPEntry=wsXFPEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPStatus=wsXFPStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempTOS=wsTempTOS, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPSerialNumber=wsSFPSerialNumber, ifHCInCRCErrors=ifHCInCRCErrors, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, ifHCInSymbolErrors=ifHCInSymbolErrors, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltChannel=wsVoltChannel, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTemp=wsSFPTemp, wsVoltNominal=wsVoltNominal, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXPower=wsSFPRXPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourIfIndex=wsNeighbourIfIndex, ibos=ibos, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighboursTable=wsNeighboursTable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPEncoding=wsSFPEncoding, wsReload=wsReload, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPPartNumber=wsSFPPartNumber, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighboursEntry=wsNeighboursEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourCreated=wsNeighbourCreated, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPStatus=wsSFPStatus, wsFanTable=wsFanTable, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIfXTable=wsIfXTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTransceiver=wsXFPTransceiver, wsTempTable=wsTempTable, ifHCInAlignmentErrors=ifHCInAlignmentErrors, ifHCOutCollisions=ifHCOutCollisions, ifHCInErrors=ifHCInErrors, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortState=wsNeighbourPortState, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsVersion=wsVersion, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, ifHCInJabbers=ifHCInJabbers, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsVoltEntry=wsVoltEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIfXEntry=wsIfXEntry, wsAccounting=wsAccounting, wsSFPVoltNormalLow=wsSFPVoltNormalLow, ifHCInRunts=ifHCInRunts, wsNeighbourNIndex=wsNeighbourNIndex, wsVersionString=wsVersionString, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPEncoding=wsXFPEncoding, wsAsrRevision=wsAsrRevision, wsSystem=wsSystem, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVoltStatus=wsVoltStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyInDrops=wsPolicyInDrops, ifHCOutDeferred=ifHCOutDeferred, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXPowerStatus=wsSFPRXPowerStatus)
