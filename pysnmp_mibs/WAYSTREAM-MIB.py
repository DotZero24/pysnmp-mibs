...
wsIfXTable = _WsIfXTable_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7)
)
if mibBuilder.loadTexts:
    wsIfXTable.setStatus("current")
_WsIfXEntry_Object = MibTableRow
wsIfXEntry = _WsIfXEntry_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1)
)
if mibBuilder.loadTexts:
    wsIfXEntry.setStatus("current")
_IfHCInErrors_Type = Counter64
_IfHCInErrors_Object = MibTableColumn
ifHCInErrors = _IfHCInErrors_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 1),
    _IfHCInErrors_Type()
)
...
ifHCInRunts = _IfHCInRunts_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 2),
    _IfHCInRunts_Type()
)
ifHCInRunts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifHCInRunts.setStatus("current")
_IfHCInOversized_Type = Counter64
_IfHCInOversized_Object = MibTableColumn
ifHCInOversized = _IfHCInOversized_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 3),
    _IfHCInOversized_Type()
)
ifHCInOversized.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifHCInOversized.setStatus("current")
_IfHCInCRCErrors_Type = Counter64
_IfHCInCRCErrors_Object = MibTableColumn
ifHCInCRCErrors = _IfHCInCRCErrors_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 4),
    _IfHCInCRCErrors_Type()
)
ifHCInCRCErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifHCInCRCErrors.setStatus("current")
_IfHCInJabbers_Type = Counter64
_IfHCInJabbers_Object = MibTableColumn
ifHCInJabbers = _IfHCInJabbers_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 5),
    _IfHCInJabbers_Type()
)
ifHCInJabbers.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifHCInJabbers.setStatus("current")
_IfHCInFragments_Type = Counter64
_IfHCInFragments_Object = MibTableColumn
ifHCInFragments = _IfHCInFragments_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 6),
    _IfHCInFragments_Type()
)
ifHCInFragments.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifHCInFragments.setStatus("current")
_IfHCInSymbolErrors_Type = Counter64
_IfHCInSymbolErrors_Object = MibTableColumn
ifHCInSymbolErrors = _IfHCInSymbolErrors_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 7),
    _IfHCInSymbolErrors_Type()
)
ifHCInSymbolErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifHCInSymbolErrors.setStatus("current")
_IfHCInAlignmentErrors_Type = Counter64
_IfHCInAlignmentErrors_Object = MibTableColumn
ifHCInAlignmentErrors = _IfHCInAlignmentErrors_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 8),
    _IfHCInAlignmentErrors_Type()
)
ifHCInAlignmentErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifHCInAlignmentErrors.setStatus("current")
_IfHCOutErrors_Type = Counter64
_IfHCOutErrors_Object = MibTableColumn
ifHCOutErrors = _IfHCOutErrors_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 9),
    _IfHCOutErrors_Type()
)
...
ifHCOutCollisions = _IfHCOutCollisions_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 10),
    _IfHCOutCollisions_Type()
)
ifHCOutCollisions.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifHCOutCollisions.setStatus("current")
_IfHCOutDeferred_Type = Counter64
_IfHCOutDeferred_Object = MibTableColumn
ifHCOutDeferred = _IfHCOutDeferred_Object(
    (1, 3, 6, 1, 4, 1, 9303, 4, 1, 7, 1, 11),
    _IfHCOutDeferred_Type()
)
ifHCOutDeferred.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifHCOutDeferred.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ibos": ibos,
       ...
       "wsIfXTable": wsIfXTable,
       "wsIfXEntry": wsIfXEntry,
       "ifHCInErrors": ifHCInErrors,
       "ifHCInRunts": ifHCInRunts,
       "ifHCInOversized": ifHCInOversized,
       "ifHCInCRCErrors": ifHCInCRCErrors,
       "ifHCInJabbers": ifHCInJabbers,
       "ifHCInFragments": ifHCInFragments,
       "ifHCInSymbolErrors": ifHCInSymbolErrors,
       "ifHCInAlignmentErrors": ifHCInAlignmentErrors,
       "ifHCOutErrors": ifHCOutErrors,
       "ifHCOutCollisions": ifHCOutCollisions,
       "ifHCOutDeferred": ifHCOutDeferred}
)
