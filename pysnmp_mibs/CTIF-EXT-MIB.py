...
mibBuilder.exportSymbols("CTIF-EXT-MIB", commonDev=commonDev, ctIfPortType=ctIfPortType, enableSNMPv1=enableSNMPv1, ctIfLAA=ctIfLAA, ctIfCapability=ctIfCapability, ctStatsIfEnable=ctStatsIfEnable, ctCpFunction=ctCpFunction, ctIfNum=ctIfNum, ctIfPortIfNumber=ctIfPortIfNumber, ctSonet=ctSonet, ctIfOutMulticastPkts=ctIfOutMulticastPkts, ctIfHCStatsTable=ctIfHCStatsTable, ctIfOutUcastPkts=ctIfOutUcastPkts, ctCpAdminStatus=ctCpAdminStatus, ctIfInBroadcastPkts=ctIfInBroadcastPkts, ctSNMP=ctSNMP, ctVirtual=ctVirtual, ctIf=ctIf, ctIfInMulticastPktsOverflows=ctIfInMulticastPktsOverflows, ctIfOutOctetsOverflows=ctIfOutOctetsOverflows, ctIfConnectionType=ctIfConnectionType, ctIfInOctets=ctIfInOctets, ctCpTable=ctCpTable, ctIfPortCnt=ctIfPortCnt, comDeviceDate=comDeviceDate, ctCpEntry=ctCpEntry, ctIfCp=ctIfCp, ctVirtualIfNumPorts=ctVirtualIfNumPorts, ctVirtualIfPortIfIndex=ctVirtualIfPortIfIndex, ctIfNumber=ctIfNumber, ctComPort=ctComPort, ctIfInMulticastPkts=ctIfInMulticastPkts, ctIfPort=ctIfPort, ctIfInOctetsOverflows=ctIfInOctetsOverflows, ctVirtualIfPhysicalInterface=ctVirtualIfPhysicalInterface, ctSonetTable=ctSonetTable, ctVirtualIfTable=ctVirtualIfTable, ctIfDuplex=ctIfDuplex, ctVirtualIfType=ctVirtualIfType, ctVirtualIfPortType=ctVirtualIfPortType, ctStats=ctStats, ctIfOutMulticastPktsOverflows=ctIfOutMulticastPktsOverflows, ctIfPortTable=ctIfPortTable, ctIfEntry=ctIfEntry, ctIfHC=ctIfHC, ctSonetIfIndex=ctSonetIfIndex, ctIfPortLinkStatus=ctIfPortLinkStatus, ctStatsTable=ctStatsTable, enableSNMPv1Counter64=enableSNMPv1Counter64, ctStatsEntry=ctStatsEntry, ctVirtualIfPortNumber=ctVirtualIfPortNumber, ctIfPortEntry=ctIfPortEntry, comDeviceBoardMap=comDeviceBoardMap, ctVirtualIfPortTable=ctVirtualIfPortTable, ctVirtualIfPortVPI=ctVirtualIfPortVPI, ctSonetMediumType=ctSonetMediumType, ctIfOutOctets=ctIfOutOctets, ctIfOutUcastPktsOverflows=ctIfOutUcastPktsOverflows, ctIfInUcastPkts=ctIfInUcastPkts, ctSonetEntry=ctSonetEntry, ctIfInBroadcastPktsOverflows=ctIfInBroadcastPktsOverflows, enableSNMPv2=enableSNMPv2, ctVirtualIfIndex=ctVirtualIfIndex, ctIfHCStatsEntry=ctIfHCStatsEntry, ctIfPortTrapStatus=ctIfPortTrapStatus, ctFramerConfig=ctFramerConfig, ctIfOutBroadcastPktsOverflows=ctIfOutBroadcastPktsOverflows, ctIfRedundancy=ctIfRedundancy, ctIfTable=ctIfTable, ctVirtualIfPortVCI=ctVirtualIfPortVCI, ctIfOutBroadcastPkts=ctIfOutBroadcastPkts, ctIfInUcastPktsOverflows=ctIfInUcastPktsOverflows, ctVirtualIfEntry=ctVirtualIfEntry, ctIfPortPortNumber=ctIfPortPortNumber, ctVirtualIfPortEntry=ctVirtualIfPortEntry, comDeviceTime=comDeviceTime, ctStatsIfIndex=ctStatsIfIndex)
