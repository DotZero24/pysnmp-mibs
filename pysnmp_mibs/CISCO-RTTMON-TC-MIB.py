...
mibBuilder.exportSymbols("CISCO-RTTMON-TC-MIB", CipslaPercentileVar=CipslaPercentileVar, RttMplsVpnMonLpdGrpStatus=RttMplsVpnMonLpdGrpStatus, RttResponseSense=RttResponseSense, RttMonTargetAddress=RttMonTargetAddress, RttReset=RttReset, RttMplsVpnMonRttType=RttMplsVpnMonRttType, RttMonScheduleStartType=RttMonScheduleStartType, PYSNMP_MODULE_ID=ciscoRttMonTCMIB, RttMonCodecType=RttMonCodecType, RttMonIdLst=RttMonIdLst, RttMonProtocol=RttMonProtocol, RttMonReactVar=RttMonReactVar, RttMonCtrlIndex=RttMonCtrlIndex, RttMplsVpnMonLpdFailureSense=RttMplsVpnMonLpdFailureSense, RttMonRttType=RttMonRttType, RttMonOperation=RttMonOperation, RttMonLSPPingReplyMode=RttMonLSPPingReplyMode, ciscoRttMonTCMIB=ciscoRttMonTCMIB)
