...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-RTTMON-TC-MIB
...
if mibBuilder.loadTexts: ciscoRttMonTCMIB.setLastUpdated('201709060000Z')
...
mibBuilder.exportSymbols("CISCO-RTTMON-TC-MIB", RttMonOperation=RttMonOperation, ciscoRttMonTCMIB=ciscoRttMonTCMIB, RttMonScheduleStartType=RttMonScheduleStartType, RttMplsVpnMonRttType=RttMplsVpnMonRttType, RttReset=RttReset, RttMplsVpnMonLpdGrpStatus=RttMplsVpnMonLpdGrpStatus, RttResponseSense=RttResponseSense, RttMonCtrlIndex=RttMonCtrlIndex, RttMonCodecType=RttMonCodecType, RttMplsVpnMonLpdFailureSense=RttMplsVpnMonLpdFailureSense, RttMonRttType=RttMonRttType, RttMonIdLst=RttMonIdLst, RttMonLSPPingReplyMode=RttMonLSPPingReplyMode, RttMonReactVar=RttMonReactVar, RttMonTargetAddress=RttMonTargetAddress, PYSNMP_MODULE_ID=ciscoRttMonTCMIB, CipslaPercentileVar=CipslaPercentileVar, RttMonProtocol=RttMonProtocol)
