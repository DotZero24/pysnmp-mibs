# SNMP MIB module (ARUBA-CPPM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aruba/ARUBA-CPPM-MIB
...
cppmSystemTableEntry.setIndexNames(
    (0, "ARUBA-CPPM-MIB", "cppmSystemIdx"),
)
if mibBuilder.loadTexts:
...
radiusServerTableEntry.setIndexNames(
    (0, "ARUBA-CPPM-MIB", "cppmSystemHostname"),
)
if mibBuilder.loadTexts:
...
radiusServerAuthTableEntry.setIndexNames(
    (0, "ARUBA-CPPM-MIB", "radAuthSourceIdx"),
)
if mibBuilder.loadTexts:
...
policyServerProtoTableEntry.setIndexNames(
    (0, "ARUBA-CPPM-MIB", "psProtocolIdx"),
)
if mibBuilder.loadTexts:
...
policyServerAutzTableEntry.setIndexNames(
    (0, "ARUBA-CPPM-MIB", "psAutzSourceIdx"),
)
if mibBuilder.loadTexts:
...
webAuthProtoTableEntry.setIndexNames(
    (0, "ARUBA-CPPM-MIB", "waProtocolIdx"),
)
if mibBuilder.loadTexts:
...
cppmLicenseExpiry.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmLicenseDaysRemaining"),
        ("ARUBA-CPPM-MIB", "cppmNodeApplicationName"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmActivationExpiry.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmActivationDaysRemaining"),
        ("ARUBA-CPPM-MIB", "cppmNodeApplicationName"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmNodeCertExpiry.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmNodeCertApplicationName"),
        ("ARUBA-CPPM-MIB", "cppmCertDaysRemaining"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmLowDiskSpace.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmDiskSpaceRemaining"),
        ("ARUBA-CPPM-MIB", "cppmResourceUnit"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmLowMemory.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmMemoryRemaining"),
        ("ARUBA-CPPM-MIB", "cppmResourceUnit"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmClusterNodeAddNotification.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmClusterServerIp"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmClusterNodeNSyncNotification.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmClusterServerIp"),
        ("ARUBA-CPPM-MIB", "cppmClusterOutOfSyncMinutes"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmUpdateNotification.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmImageFile"),
        ("ARUBA-CPPM-MIB", "cppmImageInstallStatus"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmClusterLicenseUsage.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmNodeApplicationName"),
        ("ARUBA-CPPM-MIB", "cppmClusterLicenseTotalCount"),
        ("ARUBA-CPPM-MIB", "cppmClusterLicenseUsageCount"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmServiceStopNotification.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmServiceName"),
        ("ARUBA-CPPM-MIB", "cppmServiceStatus"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmHighCPULoadNotification.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmCPUAverageLoad"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
...
cppmClusterLicenseOverrun.setObjects(
      *(("ARUBA-CPPM-MIB", "cppmLicenseApplicationName"),
        ("ARUBA-CPPM-MIB", "cppmLicenseOverrunDailyCount"),
        ("ARUBA-CPPM-MIB", "cppmTrapMessage"))
)
if mibBuilder.loadTexts:
