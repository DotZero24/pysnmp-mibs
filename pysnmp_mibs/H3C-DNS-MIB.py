...
h3cDnsObjects=_H3cDnsObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,97,1))
_H3cDnsStaticSrvIpTable_Object=MibTable
h3cDnsStaticSrvIpTable=_H3cDnsStaticSrvIpTable_Object((1,3,6,1,4,1,2011,10,2,97,1,1))
if mibBuilder.loadTexts:h3cDnsStaticSrvIpTable.setStatus(_A)
_H3cDnsStaticSrvIpEntry_Object=MibTableRow
h3cDnsStaticSrvIpEntry=_H3cDnsStaticSrvIpEntry_Object((1,3,6,1,4,1,2011,10,2,97,1,1,1))
...
h3cDnsStaticSrvIpType=_H3cDnsStaticSrvIpType_Object((1,3,6,1,4,1,2011,10,2,97,1,1,1,1),_H3cDnsStaticSrvIpType_Type())
...
h3cDnsStaticSrvIpAddr=_H3cDnsStaticSrvIpAddr_Object((1,3,6,1,4,1,2011,10,2,97,1,1,1,2),_H3cDnsStaticSrvIpAddr_Type())
...
h3cDnsStaticSrvIpPriority=_H3cDnsStaticSrvIpPriority_Object((1,3,6,1,4,1,2011,10,2,97,1,1,1,3),_H3cDnsStaticSrvIpPriority_Type())
...
h3cDnsStaticSrvIpRowStatus=_H3cDnsStaticSrvIpRowStatus_Object((1,3,6,1,4,1,2011,10,2,97,1,1,1,4),_H3cDnsStaticSrvIpRowStatus_Type())
...
h3cDnsDynamicSrvIpTable=_H3cDnsDynamicSrvIpTable_Object((1,3,6,1,4,1,2011,10,2,97,1,2))
if mibBuilder.loadTexts:h3cDnsDynamicSrvIpTable.setStatus(_A)
_H3cDnsDynamicSrvIpEntry_Object=MibTableRow
h3cDnsDynamicSrvIpEntry=_H3cDnsDynamicSrvIpEntry_Object((1,3,6,1,4,1,2011,10,2,97,1,2,1))
...
h3cDnsDynamicSrvIpType=_H3cDnsDynamicSrvIpType_Object((1,3,6,1,4,1,2011,10,2,97,1,2,1,1),_H3cDnsDynamicSrvIpType_Type())
...
h3cDnsDynamicSrvIpAddr=_H3cDnsDynamicSrvIpAddr_Object((1,3,6,1,4,1,2011,10,2,97,1,2,1,2),_H3cDnsDynamicSrvIpAddr_Type())
...
h3cDnsDynamicSrvIpPriority=_H3cDnsDynamicSrvIpPriority_Object((1,3,6,1,4,1,2011,10,2,97,1,2,1,3),_H3cDnsDynamicSrvIpPriority_Type())
...
h3cDnsMIBConformance=_H3cDnsMIBConformance_ObjectIdentity((1,3,6,1,4,1,2011,10,2,97,2))
_H3cDnsMIBCompliances_ObjectIdentity=ObjectIdentity
h3cDnsMIBCompliances=_H3cDnsMIBCompliances_ObjectIdentity((1,3,6,1,4,1,2011,10,2,97,2,1))
_H3cDnsMIBGroups_ObjectIdentity=ObjectIdentity
h3cDnsMIBGroups=_H3cDnsMIBGroups_ObjectIdentity((1,3,6,1,4,1,2011,10,2,97,2,2))
h3cDnsStaticSrvIpGroup=ObjectGroup((1,3,6,1,4,1,2011,10,2,97,2,2,1))
h3cDnsStaticSrvIpGroup.setObjects(*((_B,_K),(_B,_L)))
if mibBuilder.loadTexts:h3cDnsStaticSrvIpGroup.setStatus(_A)
h3cDnsDynamicSrvIpGroup=ObjectGroup((1,3,6,1,4,1,2011,10,2,97,2,2,2))
h3cDnsDynamicSrvIpGroup.setObjects((_B,_M))
if mibBuilder.loadTexts:h3cDnsDynamicSrvIpGroup.setStatus(_A)
h3cDnsMIBCompliance=ModuleCompliance((1,3,6,1,4,1,2011,10,2,97,2,1,1))
