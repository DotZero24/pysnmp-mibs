# SNMP MIB module (H3C-DNS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-DNS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:18:51 2025
...
h3cDnsStaticSrvIpEntry = _H3cDnsStaticSrvIpEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 97, 1, 1, 1)
)
h3cDnsStaticSrvIpEntry.setIndexNames(
    (0, "H3C-DNS-MIB", "h3cDnsStaticSrvIpType"),
    (0, "H3C-DNS-MIB", "h3cDnsStaticSrvIpAddr"),
)
if mibBuilder.loadTexts:
...
h3cDnsDynamicSrvIpEntry = _H3cDnsDynamicSrvIpEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 97, 1, 2, 1)
)
h3cDnsDynamicSrvIpEntry.setIndexNames(
    (0, "H3C-DNS-MIB", "h3cDnsDynamicSrvIpType"),
    (0, "H3C-DNS-MIB", "h3cDnsDynamicSrvIpAddr"),
)
if mibBuilder.loadTexts:
...
h3cDnsMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 97, 2, 1, 1)
)
h3cDnsMIBCompliance.setObjects(
      *(("H3C-DNS-MIB", "h3cDnsStaticSrvIpGroup"),
        ("H3C-DNS-MIB", "h3cDnsDynamicSrvIpGroup"))
)
if mibBuilder.loadTexts:
