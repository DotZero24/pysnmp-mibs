...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hirschmann/HM2-PLATFORM-DOT1X-ADVANCED-MIB
...
hm2AgentDot1xMABFormatGroupSize = MibScalar((1, 3, 6, 1, 4, 1, 248, 12, 36, 1, 250), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 4, 12))).clone(namedValues=NamedValues(("group-size-1", 1), ("group-size-2", 2), ("group-size-4", 4), ("group-size-12", 12))).clone('group-size-12')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2AgentDot1xMABFormatGroupSize.setStatus('current')
hm2AgentDot1xMABFormatGroupSeparator = MibScalar((1, 3, 6, 1, 4, 1, 248, 12, 36, 1, 251), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("hyphen", 1), ("colon", 2), ("dot", 3))).clone('hyphen')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2AgentDot1xMABFormatGroupSeparator.setStatus('current')
hm2AgentDot1xMABFormatLetterCase = MibScalar((1, 3, 6, 1, 4, 1, 248, 12, 36, 1, 252), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("lower-case", 1), ("upper-case", 2))).clone('upper-case')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2AgentDot1xMABFormatLetterCase.setStatus('current')
hm2AgentDot1xMABPassword = MibScalar((1, 3, 6, 1, 4, 1, 248, 12, 36, 1, 253), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(0, 64))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2AgentDot1xMABPassword.setStatus('current')
...
hm2AgentDot1xGuestVlanPeriod = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 12, 36, 2, 1, 1, 3), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 300)).clone(90)).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("HM2-PLATFORM-DOT1X-ADVANCED-MIB", hm2AgentDot1xMABFormatLetterCase=hm2AgentDot1xMABFormatLetterCase, hm2AgentDot1xMABFormatGroupSeparator=hm2AgentDot1xMABFormatGroupSeparator, hm2AgentDot1xStatisticsClear=hm2AgentDot1xStatisticsClear, hm2AgentDot1xPortControlMode=hm2AgentDot1xPortControlMode, hm2PlatformDot1xAdvanced=hm2PlatformDot1xAdvanced, hm2AgentDot1xPortStatsClear=hm2AgentDot1xPortStatsClear, hm2AgentDot1xClientConfigEntry=hm2AgentDot1xClientConfigEntry, hm2AgentDot1xClientUserName=hm2AgentDot1xClientUserName, hm2AgentDot1xMonitorModeEnabled=hm2AgentDot1xMonitorModeEnabled, hm2AgentDot1xClientMacAddress=hm2AgentDot1xClientMacAddress, hm2AgentDot1xMonitorModeClients=hm2AgentDot1xMonitorModeClients, hm2AgentDot1xClientBackendState=hm2AgentDot1xClientBackendState, hm2AgentDot1xAuthHistoryResultIndex=hm2AgentDot1xAuthHistoryResultIndex, hm2AgentDot1xDynamicVlanCreationMode=hm2AgentDot1xDynamicVlanCreationMode, hm2AgentDot1xAuthHistoryResultVlanAssignedType=hm2AgentDot1xAuthHistoryResultVlanAssignedType, hm2AgentDot1xAuthHistoryResultReasonCode=hm2AgentDot1xAuthHistoryResultReasonCode, hm2AgentDot1xPortAuthHistoryResultClearTable=hm2AgentDot1xPortAuthHistoryResultClearTable, hm2AgentDot1xPortStatsClearTable=hm2AgentDot1xPortStatsClearTable, hm2AgentDot1xEnhancementConfigGroup=hm2AgentDot1xEnhancementConfigGroup, hm2AgentDot1xPortMABenabled=hm2AgentDot1xPortMABenabled, hm2AgentDot1xAuthHistoryResultIfaceIndex=hm2AgentDot1xAuthHistoryResultIfaceIndex, hm2AgentDot1xMABPassword=hm2AgentDot1xMABPassword, hm2AgentDot1xPortAuthHistoryResultsClear=hm2AgentDot1xPortAuthHistoryResultsClear, hm2AgentDot1xAuthHistoryResultsGroup=hm2AgentDot1xAuthHistoryResultsGroup, hm2AgentDot1xClientAuthPAEstate=hm2AgentDot1xClientAuthPAEstate, hm2AgentDot1xPortMABenabledOperational=hm2AgentDot1xPortMABenabledOperational, hm2AgentDot1xAuthHistoryResultTimeStamp=hm2AgentDot1xAuthHistoryResultTimeStamp, hm2AgentDot1xMABFormatGroupSize=hm2AgentDot1xMABFormatGroupSize, hm2AgentDot1xInterface=hm2AgentDot1xInterface, hm2AgentDot1xPortAuthHistoryResultTable=hm2AgentDot1xPortAuthHistoryResultTable, hm2AgentDot1xClientVlanAssignedReason=hm2AgentDot1xClientVlanAssignedReason, hm2AgentDot1xPortTerminationAction=hm2AgentDot1xPortTerminationAction, hm2AgentDot1xPortAuthHistoryResultClearEntry=hm2AgentDot1xPortAuthHistoryResultClearEntry, hm2AgentDot1xAuthHistoryResultFilterID=hm2AgentDot1xAuthHistoryResultFilterID, hm2AgentDot1xRadiusVlanAssignment=hm2AgentDot1xRadiusVlanAssignment, hm2AgentDot1xPortAuthHistoryResultEntry=hm2AgentDot1xPortAuthHistoryResultEntry, hm2AgentDot1xClientConfigTable=hm2AgentDot1xClientConfigTable, hm2AgentDot1xPortConfigGroup=hm2AgentDot1xPortConfigGroup, hm2AgentDot1xPortConfigTable=hm2AgentDot1xPortConfigTable, hm2AgentDot1xPortSessionTimeout=hm2AgentDot1xPortSessionTimeout, hm2AgentDot1xGuestVlanPeriod=hm2AgentDot1xGuestVlanPeriod, hm2AgentDot1xAuthHistoryResultAccessStatus=hm2AgentDot1xAuthHistoryResultAccessStatus, hm2AgentDot1xMaxUsers=hm2AgentDot1xMaxUsers, hm2AgentDot1xNonMonitorModeClients=hm2AgentDot1xNonMonitorModeClients, hm2AgentDot1xClientConfigGroup=hm2AgentDot1xClientConfigGroup, hm2AgentDot1xClientTerminationAction=hm2AgentDot1xClientTerminationAction, hm2AgentDot1xMonitorModeConfigGroup=hm2AgentDot1xMonitorModeConfigGroup, hm2AgentDot1xLogicalPort=hm2AgentDot1xLogicalPort, hm2AgentDot1xAuthHistoryResultVlanAssigned=hm2AgentDot1xAuthHistoryResultVlanAssigned, hm2AgentDot1xClientSessionTime=hm2AgentDot1xClientSessionTime, hm2AgentDot1xPortVlanAssignedReason=hm2AgentDot1xPortVlanAssignedReason, PYSNMP_MODULE_ID=hm2PlatformDot1xAdvanced, hm2AgentDot1xStatsIfIndex=hm2AgentDot1xStatsIfIndex, hm2AgentDot1xAuthHistoryResultAuthStatus=hm2AgentDot1xAuthHistoryResultAuthStatus, hm2AgentDot1xPortVlanAssigned=hm2AgentDot1xPortVlanAssigned, hm2AgentDot1xAuthHistoryResultAge=hm2AgentDot1xAuthHistoryResultAge, hm2AgentDot1xClientSessionTimeout=hm2AgentDot1xClientSessionTimeout, hm2AgentDot1xAuthHistoryResultVlanId=hm2AgentDot1xAuthHistoryResultVlanId, hm2AgentDot1xAuthHistoryResultsClear=hm2AgentDot1xAuthHistoryResultsClear, hm2AgentDot1xPortConfigEntry=hm2AgentDot1xPortConfigEntry, hm2AgentDot1xClientVlanAssigned=hm2AgentDot1xClientVlanAssigned, hm2AgentDot1xAuthHistoryResultIfIndex=hm2AgentDot1xAuthHistoryResultIfIndex, hm2AgentDot1xPortStatsClearEntry=hm2AgentDot1xPortStatsClearEntry, hm2AgentDot1xUnauthenticatedVlan=hm2AgentDot1xUnauthenticatedVlan, Dot1xSessionTerminationAction=Dot1xSessionTerminationAction, hm2AgentDot1xGuestVlanId=hm2AgentDot1xGuestVlanId, Dot1xPortControlMode=Dot1xPortControlMode, hm2AgentDot1xClientFilterID=hm2AgentDot1xClientFilterID, hm2AgentDot1xAuthHistoryResultMacAddress=hm2AgentDot1xAuthHistoryResultMacAddress)
