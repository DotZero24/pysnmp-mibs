# SNMP MIB module (NETGEAR-RADLAN-QCN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-QCN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:55 2025
...
rlQcnPriorityStateEntry = _RlQcnPriorityStateEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 202, 2, 1)
)
rlQcnPriorityStateEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-QCN-MIB", "rlQcnPriorityStatePriority"),
)
if mibBuilder.loadTexts:
