...
rlBonjourPublish=_RlBonjourPublish_Object((1,3,6,1,4,1,9,6,1,101,114,1),_RlBonjourPublish_Type())
...
rlBonjourStatusTable=_RlBonjourStatusTable_Object((1,3,6,1,4,1,9,6,1,101,114,2))
if mibBuilder.loadTexts:rlBonjourStatusTable.setStatus(_A)
_RlBonjourStatusEntry_Object=MibTableRow
rlBonjourStatusEntry=_RlBonjourStatusEntry_Object((1,3,6,1,4,1,9,6,1,101,114,2,1))
...
rlBonjourStatusServiceName=_RlBonjourStatusServiceName_Object((1,3,6,1,4,1,9,6,1,101,114,2,1,1),_RlBonjourStatusServiceName_Type())
...
rlBonjourStatusIPInterfaceType=_RlBonjourStatusIPInterfaceType_Object((1,3,6,1,4,1,9,6,1,101,114,2,1,2),_RlBonjourStatusIPInterfaceType_Type())
...
rlBonjourStatusIPInterfaceAddr=_RlBonjourStatusIPInterfaceAddr_Object((1,3,6,1,4,1,9,6,1,101,114,2,1,3),_RlBonjourStatusIPInterfaceAddr_Type())
...
rlBonjourStatusState=_RlBonjourStatusState_Object((1,3,6,1,4,1,9,6,1,101,114,2,1,4),_RlBonjourStatusState_Type())
...
rlBonjourStateTable=_RlBonjourStateTable_Object((1,3,6,1,4,1,9,6,1,101,114,3))
if mibBuilder.loadTexts:rlBonjourStateTable.setStatus(_A)
_RlBonjourStateEntry_Object=MibTableRow
rlBonjourStateEntry=_RlBonjourStateEntry_Object((1,3,6,1,4,1,9,6,1,101,114,3,1))
...
rlBonjourStateServiceName=_RlBonjourStateServiceName_Object((1,3,6,1,4,1,9,6,1,101,114,3,1,1),_RlBonjourStateServiceName_Type())
...
rlBonjourStateL2Interface=_RlBonjourStateL2Interface_Object((1,3,6,1,4,1,9,6,1,101,114,3,1,2),_RlBonjourStateL2Interface_Type())
...
rlBonjourStateOperationMode=_RlBonjourStateOperationMode_Object((1,3,6,1,4,1,9,6,1,101,114,3,1,3),_RlBonjourStateOperationMode_Type())
...
rlBonjourStateOperationReason=_RlBonjourStateOperationReason_Object((1,3,6,1,4,1,9,6,1,101,114,3,1,4),_RlBonjourStateOperationReason_Type())
...
rlBonjourStateIPv6OperationMode=_RlBonjourStateIPv6OperationMode_Object((1,3,6,1,4,1,9,6,1,101,114,3,1,5),_RlBonjourStateIPv6OperationMode_Type())
...
rlBonjourStateIPv6OperationReason=_RlBonjourStateIPv6OperationReason_Object((1,3,6,1,4,1,9,6,1,101,114,3,1,6),_RlBonjourStateIPv6OperationReason_Type())
...
rlBonjourL2Table=_RlBonjourL2Table_Object((1,3,6,1,4,1,9,6,1,101,114,4))
if mibBuilder.loadTexts:rlBonjourL2Table.setStatus(_A)
_RlBonjourL2Entry_Object=MibTableRow
rlBonjourL2Entry=_RlBonjourL2Entry_Object((1,3,6,1,4,1,9,6,1,101,114,4,1))
...
rlBonjourL2Ifindex=_RlBonjourL2Ifindex_Object((1,3,6,1,4,1,9,6,1,101,114,4,1,1),_RlBonjourL2Ifindex_Type())
...
rlBonjourL2RowStatus=_RlBonjourL2RowStatus_Object((1,3,6,1,4,1,9,6,1,101,114,4,1,2),_RlBonjourL2RowStatus_Type())
...
rlBonjourL2Mode=_RlBonjourL2Mode_Object((1,3,6,1,4,1,9,6,1,101,114,5),_RlBonjourL2Mode_Type())
...
rlBonjourInstanceName=_RlBonjourInstanceName_Object((1,3,6,1,4,1,9,6,1,101,114,6),_RlBonjourInstanceName_Type())
...
rlBonjourHostName=_RlBonjourHostName_Object((1,3,6,1,4,1,9,6,1,101,114,7),_RlBonjourHostName_Type())
