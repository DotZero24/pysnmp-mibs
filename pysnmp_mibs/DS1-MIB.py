...
mibBuilder.exportSymbols("DS1-MIB", dsx1FarEndIntervalEntry=dsx1FarEndIntervalEntry, ds1NearEndConfigGroup=ds1NearEndConfigGroup, dsx1ConfigEntry=dsx1ConfigEntry, dsx1TotalLESs=dsx1TotalLESs, ds1MibE1PriCompliance=ds1MibE1PriCompliance, dsx1CurrentSESs=dsx1CurrentSESs, dsx1FarEndCurrentUASs=dsx1FarEndCurrentUASs, ds1NearEndOptionalConfigGroup=ds1NearEndOptionalConfigGroup, dsx1IntervalLCVs=dsx1IntervalLCVs, dsx1IntervalValidData=dsx1IntervalValidData, dsx1FarEndTotalBESs=dsx1FarEndTotalBESs, dsx1FarEndCurrentBESs=dsx1FarEndCurrentBESs, dsx1FracTable=dsx1FracTable, dsx1FarEndInvalidIntervals=dsx1FarEndInvalidIntervals, dsx1FarEndIntervalValidData=dsx1FarEndIntervalValidData, dsx1IntervalBESs=dsx1IntervalBESs, dsx1FracEntry=dsx1FracEntry, ds1NMibE1PriNCompliance=ds1NMibE1PriNCompliance, dsx1FracIndex=dsx1FracIndex, ds1MibT1PriCompliance=ds1MibT1PriCompliance, dsx1FarEndIntervalUASs=dsx1FarEndIntervalUASs, dsx1Fdl=dsx1Fdl, dsx1IntervalNumber=dsx1IntervalNumber, ds1NMibT1PriNCompliance=ds1NMibT1PriNCompliance, ds1MibE1PriNCompliance=ds1MibE1PriNCompliance, dsx1LineLength=dsx1LineLength, dsx1SendCode=dsx1SendCode, dsx1FarEndValidIntervals=dsx1FarEndValidIntervals, dsx1FarEndCurrentSEFSs=dsx1FarEndCurrentSEFSs, dsx1FarEndCurrentTable=dsx1FarEndCurrentTable, ds1DS2Group=ds1DS2Group, ds1NCompliance=ds1NCompliance, dsx1TotalSEFSs=dsx1TotalSEFSs, dsx1IntervalUASs=dsx1IntervalUASs, dsx1CurrentTable=dsx1CurrentTable, dsx1ChanMappingTable=dsx1ChanMappingTable, dsx1IntervalCSSs=dsx1IntervalCSSs, dsx1LineStatus=dsx1LineStatus, dsx1TotalUASs=dsx1TotalUASs, dsx1LoopbackStatus=dsx1LoopbackStatus, dsx1IntervalSESs=dsx1IntervalSESs, dsx1FarEndCurrentCSSs=dsx1FarEndCurrentCSSs, dsx1FarEndIntervalSEFSs=dsx1FarEndIntervalSEFSs, dsx1LineBuildOut=dsx1LineBuildOut, dsx1FarEndIntervalNumber=dsx1FarEndIntervalNumber, dsx1ChanMappedIfIndex=dsx1ChanMappedIfIndex, dsx1LineType=dsx1LineType, dsx1FarEndIntervalESs=dsx1FarEndIntervalESs, ds1Ds2Compliance=ds1Ds2Compliance, dsx1FarEndIntervalIndex=dsx1FarEndIntervalIndex, dsx1TotalDMs=dsx1TotalDMs, dsx1FarEndTotalEntry=dsx1FarEndTotalEntry, dsx1FarEndTotalUASs=dsx1FarEndTotalUASs, dsx1CurrentDMs=dsx1CurrentDMs, dsx1ValidIntervals=dsx1ValidIntervals, dsx1FarEndTotalLESs=dsx1FarEndTotalLESs, dsx1TotalIndex=dsx1TotalIndex, ds1Groups=ds1Groups, dsx1FarEndCurrentSESs=dsx1FarEndCurrentSESs, dsx1SignalMode=dsx1SignalMode, dsx1IntervalEntry=dsx1IntervalEntry, dsx1CurrentIndex=dsx1CurrentIndex, dsx1FarEndCurrentIndex=dsx1FarEndCurrentIndex, ds1NearEndConfigurationGroup=ds1NearEndConfigurationGroup, ds1Conformance=ds1Conformance, dsx1IntervalESs=dsx1IntervalESs, ds1Compliances=ds1Compliances, dsx1FarEndCurrentPCVs=dsx1FarEndCurrentPCVs, dsx1FarEndTimeElapsed=dsx1FarEndTimeElapsed, dsx1TotalSESs=dsx1TotalSESs, dsx1FarEndIntervalPCVs=dsx1FarEndIntervalPCVs, dsx1LineStatusLastChange=dsx1LineStatusLastChange, dsx1CurrentCSSs=dsx1CurrentCSSs, dsx1LineImpedance=dsx1LineImpedance, dsx1FarEndIntervalSESs=dsx1FarEndIntervalSESs, dsx1ConfigTable=dsx1ConfigTable, dsx1CurrentBESs=dsx1CurrentBESs, ds1NearEndStatisticsGroup=ds1NearEndStatisticsGroup, dsx1FracIfIndex=dsx1FracIfIndex, ds1NearEndCfgGroup=ds1NearEndCfgGroup, dsx1LineIndex=dsx1LineIndex, dsx1FracNumber=dsx1FracNumber, dsx1Channelization=dsx1Channelization, dsx1InvalidIntervals=dsx1InvalidIntervals, dsx1FarEndTotalCSSs=dsx1FarEndTotalCSSs, dsx1FarEndCurrentLESs=dsx1FarEndCurrentLESs, dsx1CurrentESs=dsx1CurrentESs, dsx1TotalLCVs=dsx1TotalLCVs, dsx1CurrentEntry=dsx1CurrentEntry, dsx1TotalTable=dsx1TotalTable, ds1J1Compliance=ds1J1Compliance, dsx1TimeElapsed=dsx1TimeElapsed, dsx1FarEndCurrentESs=dsx1FarEndCurrentESs, ds1=ds1, dsx1Ds1ChannelNumber=dsx1Ds1ChannelNumber, dsx1FarEndTotalPCVs=dsx1FarEndTotalPCVs, dsx1FarEndTotalDMs=dsx1FarEndTotalDMs, dsx1TotalESs=dsx1TotalESs, dsx1FarEndTotalTable=dsx1FarEndTotalTable, ds1ChanMappingGroup=ds1ChanMappingGroup, ds1FarEndNGroup=ds1FarEndNGroup, dsx1IfIndex=dsx1IfIndex, ds1Traps=ds1Traps, dsx1FarEndTotalESs=dsx1FarEndTotalESs, dsx1IntervalDMs=dsx1IntervalDMs, dsx1CurrentUASs=dsx1CurrentUASs, dsx1LineMode=dsx1LineMode, dsx1CurrentLCVs=dsx1CurrentLCVs, dsx1IntervalPCVs=dsx1IntervalPCVs, dsx1LineStatusChangeTrapEnable=dsx1LineStatusChangeTrapEnable, ds1Compliance=ds1Compliance, dsx1TransmitClockSource=dsx1TransmitClockSource, dsx1FarEndIntervalBESs=dsx1FarEndIntervalBESs, dsx1LoopbackConfig=dsx1LoopbackConfig, dsx1CurrentPCVs=dsx1CurrentPCVs, ds1NearEndStatGroup=ds1NearEndStatGroup, dsx1LineCoding=dsx1LineCoding, dsx1CurrentSEFSs=dsx1CurrentSEFSs, dsx1CurrentLESs=dsx1CurrentLESs, dsx1ChanMappingEntry=dsx1ChanMappingEntry, dsx1IntervalSEFSs=dsx1IntervalSEFSs, dsx1IntervalLESs=dsx1IntervalLESs, dsx1TotalEntry=dsx1TotalEntry, dsx1CircuitIdentifier=dsx1CircuitIdentifier, dsx1TotalBESs=dsx1TotalBESs, dsx1FarEndIntervalDMs=dsx1FarEndIntervalDMs, dsx1TotalPCVs=dsx1TotalPCVs, dsx1FarEndCurrentDMs=dsx1FarEndCurrentDMs, dsx1FarEndCurrentEntry=dsx1FarEndCurrentEntry, dsx1FarEndIntervalTable=dsx1FarEndIntervalTable, dsx1FarEndIntervalCSSs=dsx1FarEndIntervalCSSs, PYSNMP_MODULE_ID=ds1, dsx1IntervalIndex=dsx1IntervalIndex, dsx1LineStatusChange=dsx1LineStatusChange, dsx1TotalCSSs=dsx1TotalCSSs, ds1TransStatsGroup=ds1TransStatsGroup, dsx1FarEndTotalSEFSs=dsx1FarEndTotalSEFSs, dsx1FarEndTotalIndex=dsx1FarEndTotalIndex, dsx1FarEndIntervalLESs=dsx1FarEndIntervalLESs, dsx1FarEndTotalSESs=dsx1FarEndTotalSESs, ds1NearEndOptionalTrapGroup=ds1NearEndOptionalTrapGroup, ds1MibT1PriNCompliance=ds1MibT1PriNCompliance, ds1DeprecatedGroup=ds1DeprecatedGroup, dsx1IntervalTable=dsx1IntervalTable, ds1FarEndGroup=ds1FarEndGroup)
