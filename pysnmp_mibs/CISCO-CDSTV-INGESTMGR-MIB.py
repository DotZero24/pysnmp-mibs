...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CDSTV-INGESTMGR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:56 2025
...
ciscoCdstvIngestMgrMIBCompliance.setObjects(
      *(("CISCO-CDSTV-INGESTMGR-MIB", "ciscoCdstvIngestMgrMIBMainObjectGroup"),
        ("CISCO-CDSTV-INGESTMGR-MIB", "ciscoCdstvIngestMgrMIBIngestSettingsGroup"),
        ("CISCO-CDSTV-INGESTMGR-MIB", "ciscoCdstvIngestMgrMIBBackOfficeSettingsGroup"),
        ("CISCO-CDSTV-INGESTMGR-MIB", "ciscoCdstvIngestMgrMIBContentStoreSettingsGroup"),
        ("CISCO-CDSTV-INGESTMGR-MIB", "ciscoCdstvIngestMgrMIBEncryptionSettingsGroup"))
)
if mibBuilder.loadTexts:
