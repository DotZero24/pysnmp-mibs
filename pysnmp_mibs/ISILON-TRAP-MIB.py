...
# Notes
# -----
# ASN.1 source file://mibs/isilon/ISILON-TRAP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:00:52 2025
...
trapGroupCompliance.setObjects(
      *(("ISILON-TRAP-MIB", "groupStateTrapsGroup"),
        ("ISILON-TRAP-MIB", "filesystemTrapsGroup"),
        ("ISILON-TRAP-MIB", "smartQuotaTrapsGroup"),
        ("ISILON-TRAP-MIB", "snapshotTrapsGroup"),
        ("ISILON-TRAP-MIB", "syncIQTrapsGroup"),
        ("ISILON-TRAP-MIB", "softwareTrapsGroup"),
        ("ISILON-TRAP-MIB", "avscanTrapsGroup"),
        ("ISILON-TRAP-MIB", "netProtoTrapsGroup"),
        ("ISILON-TRAP-MIB", "networkingTrapsGroup"),
        ("ISILON-TRAP-MIB", "hardwareTrapsGroup"),
        ("ISILON-TRAP-MIB", "systemDiskTrapsGroup"),
        ("ISILON-TRAP-MIB", "sensorTrapsGroup"),
        ("ISILON-TRAP-MIB", "storageTransportTrapsGroup"),
        ("ISILON-TRAP-MIB", "cloudPoolsTrapsGroup"),
        ("ISILON-TRAP-MIB", "upgradeTrapsGroup"),
        ("ISILON-TRAP-MIB", "variablesGroup"))
)
if mibBuilder.loadTexts:
