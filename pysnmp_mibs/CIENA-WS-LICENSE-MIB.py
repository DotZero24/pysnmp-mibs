...
StringMaxl128, StringMaxl32, StringMaxl16, StringMaxl64 = mibBuilder.importSymbols("CIENA-WS-TYPEDEFS-MIB", "StringMaxl128", "StringMaxl32", "StringMaxl16", "StringMaxl64")
...
mibBuilder.exportSymbols("CIENA-WS-LICENSE-MIB", cwsLicenseLicenseslistIssuerName=cwsLicenseLicenseslistIssuerName, cwsLicenseLicenseslistNotice=cwsLicenseLicenseslistNotice, cwsLicenseServerHostAddress=cwsLicenseServerHostAddress, cwsLicenseClientIdRegistrationId=cwsLicenseClientIdRegistrationId, cwsLicenseClientStateComplianceState=cwsLicenseClientStateComplianceState, cwsLicenseLicenseslistExpiryDate=cwsLicenseLicenseslistExpiryDate, cienaWsLicenseMIB=cienaWsLicenseMIB, cwsLicenseLicenseslistEntry=cwsLicenseLicenseslistEntry, cienaWsLicenseGroups=cienaWsLicenseGroups, cwsLicenseLicenseslistName=cwsLicenseLicenseslistName, cienaWsLicenseGroup=cienaWsLicenseGroup, PYSNMP_MODULE_ID=cienaWsLicenseMIB, cwsLicenseLicenseslistIssuedDate=cwsLicenseLicenseslistIssuedDate, cwsLicenseLicenseslistTable=cwsLicenseLicenseslistTable, cwsLicenseServerEntry=cwsLicenseServerEntry, cwsLicenseClientIdTable=cwsLicenseClientIdTable, cwsLicenseServerTable=cwsLicenseServerTable, cwsLicenseClientStateEntry=cwsLicenseClientStateEntry, cwsLicenseClientStateTableSnmpKey=cwsLicenseClientStateTableSnmpKey, cwsLicenseLicenseslistVersion=cwsLicenseLicenseslistVersion, cwsLicenseLicenseslistHostId=cwsLicenseLicenseslistHostId, cwsLicenseLicenseslistCount=cwsLicenseLicenseslistCount, cienaWsLicenseConformance=cienaWsLicenseConformance, cwsLicenseClientIdTableSnmpKey=cwsLicenseClientIdTableSnmpKey, cwsLicenseLicenseslistSource=cwsLicenseLicenseslistSource, LicenseComplianceState=LicenseComplianceState, cienaWsLicenseCompliances=cienaWsLicenseCompliances, cwsLicenseClientStateTable=cwsLicenseClientStateTable, cwsLicenseServerNumLicenseServers=cwsLicenseServerNumLicenseServers, cienaWsLicenseCompliance=cienaWsLicenseCompliance, cwsLicenseLicenseslistLicenseIndex=cwsLicenseLicenseslistLicenseIndex, cwsLicenseClientIdEntry=cwsLicenseClientIdEntry, cwsLicenseLicenseslistType=cwsLicenseLicenseslistType, cwsLicenseLicenseslistDescription=cwsLicenseLicenseslistDescription, cwsLicenseLicenseslistStatus=cwsLicenseLicenseslistStatus, LicenseStatus=LicenseStatus, cwsLicenseServerTableSnmpKey=cwsLicenseServerTableSnmpKey, cwsLicenseLicenseslistCheckedOutCount=cwsLicenseLicenseslistCheckedOutCount, LicenseSource=LicenseSource, LicenseType=LicenseType, cienaWsLicenseObjects=cienaWsLicenseObjects)
