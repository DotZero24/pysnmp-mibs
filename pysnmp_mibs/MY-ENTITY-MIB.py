...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-ENTITY-MIB
...
myDeviceMIBCompliance.setObjects(
      *(("MY-ENTITY-MIB", "myDeviceInfoMIBGroup"),
        ("MY-ENTITY-MIB", "myModuleInfoMIBGroup"),
        ("MY-ENTITY-MIB", "myOptionalDevInfoMIBGroup"),
        ("MY-ENTITY-MIB", "myEntityChgDescGroup"),
        ("MY-ENTITY-MIB", "myDeviceMIBNotificationGroup"),
        ("MY-ENTITY-MIB", "myModuleTempStateGroup"),
        ("MY-ENTITY-MIB", "myPowerStateGroup"),
        ("MY-ENTITY-MIB", "myFanStateGroup"),
        ("MY-ENTITY-MIB", "myTemperatureWarningDescGroup"),
        ("MY-ENTITY-MIB", "myTemperatureWarningGroup"))
)
if mibBuilder.loadTexts:
