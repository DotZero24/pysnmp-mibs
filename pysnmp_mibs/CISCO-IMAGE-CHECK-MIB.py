...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IMAGE-CHECK-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:27:44 2025
...
ciscoImageCheckMIBCompliance.setObjects(
      *(("CISCO-IMAGE-CHECK-MIB", "ciscoImageCheckOpGroup"),
        ("CISCO-IMAGE-CHECK-MIB", "ciscoImgChkResultsGroup"))
)
if mibBuilder.loadTexts:
