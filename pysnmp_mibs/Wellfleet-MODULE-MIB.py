...
mibBuilder.exportSymbols("Wellfleet-MODULE-MIB", wfHwModuleMemorySize2=wfHwModuleMemorySize2, wfHwModuleLEDState1=wfHwModuleLEDState1, wfModuleBufferBalance=wfModuleBufferBalance, wfModuleDelete=wfModuleDelete, wfHwModuleMemorySize1=wfHwModuleMemorySize1, wfHwModuleEntry=wfHwModuleEntry, wfModuleRestart=wfModuleRestart, wfModuleSlot=wfModuleSlot, wfHwModuleLEDStatus3=wfHwModuleLEDStatus3, wfHwModuleArtworkRev=wfHwModuleArtworkRev, wfModuleTokenRingWeight=wfModuleTokenRingWeight, wfModuleBisyncWeight=wfModuleBisyncWeight, wfHwModuleModRev=wfHwModuleModRev, wfHwModuleLEDStatus2=wfHwModuleLEDStatus2, wfHwModuleSlot=wfHwModuleSlot, wfModuleTotalBufferCredits=wfModuleTotalBufferCredits, wfHwModuleModule=wfHwModuleModule, wfModuleEntry=wfModuleEntry, wfModuleHssiWeight=wfModuleHssiWeight, wfHwModuleLEDState2=wfHwModuleLEDState2, wfHwModuleLEDState3=wfHwModuleLEDState3, wfHwModuleTable=wfHwModuleTable, wfModuleTable=wfModuleTable, wfHwModuleDaughterBdIdOpt=wfHwModuleDaughterBdIdOpt, wfHwModuleLEDStatus1=wfHwModuleLEDStatus1, wfModuleTimerFrequency=wfModuleTimerFrequency, wfModuleFreeBufferCredits=wfModuleFreeBufferCredits, wfModuleCsmacd100Weight=wfModuleCsmacd100Weight, wfModuleCsmacdWeight=wfModuleCsmacdWeight, wfModuleFddiWeight=wfModuleFddiWeight, wfHwModuleModIdOpt=wfHwModuleModIdOpt, wfHwModuleModSerialNumber=wfHwModuleModSerialNumber, wfModuleSyncWeight=wfModuleSyncWeight)
