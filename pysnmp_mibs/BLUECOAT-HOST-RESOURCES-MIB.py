...
mibBuilder.exportSymbols("BLUECOAT-HOST-RESOURCES-MIB", PYSNMP_MODULE_ID=blueCoatHostResourcesMIB, bchrDevice=bchrDevice, bchrSerial=bchrSerial, blueCoatHostResourcesMIB=blueCoatHostResourcesMIB)
