# SNMP MIB module (NETAPP-OUTBOUNDTELNET-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netapp/NETAPP-OUTBOUNDTELNET-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:07:50 2025
...
agentOutboundTelnetAdminMode = _AgentOutboundTelnetAdminMode_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 19, 1, 1),
...
agentOutboundTelnetMaxNoOfSessions = _AgentOutboundTelnetMaxNoOfSessions_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 19, 1, 2),
...
agentOutboundTelnetTimeout = _AgentOutboundTelnetTimeout_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 19, 1, 3),
...
mibBuilder.exportSymbols(
    "NETAPP-OUTBOUNDTELNET-PRIVATE-MIB",
