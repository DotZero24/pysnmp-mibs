...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoLastSfpEventMessage=infoLastSfpEventMessage, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminAgentNetmask=adminAgentNetmask, vlanId=vlanId, sfpPortIndex=sfpPortIndex, sfpState=sfpState, portErrorCounter=portErrorCounter, portLEDGreen=portLEDGreen, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, switchFunctionInputAlarm=switchFunctionInputAlarm, adminMemoryCardMode=adminMemoryCardMode, portSecurityMacAddr2=portSecurityMacAddr2, PYSNMP_MODULE_ID=bmSwitchMIB, adminAgentPhysAddress=adminAgentPhysAddress, adminReset=adminReset, sfpDiagTxOutputPower=sfpDiagTxOutputPower, bmSwitchPortEntry=bmSwitchPortEntry, bmSwitchSfpTable=bmSwitchSfpTable, portBandwidthLimitRxd=portBandwidthLimitRxd, portSpeedDuplexSetup=portSpeedDuplexSetup, switchConfigurationChanged=switchConfigurationChanged, portIndex=portIndex, portSecurityAdminState=portSecurityAdminState, infoNoOfPorts=infoNoOfPorts, portRemoteFault=portRemoteFault, portSecurityMacAddr1=portSecurityMacAddr1, infoUnauthIpAddr=infoUnauthIpAddr, sfpDiagTemperature=sfpDiagTemperature, radiusPortSecurityReject=radiusPortSecurityReject, bmSwitchInfo=bmSwitchInfo, bmSwitchVlan=bmSwitchVlan, bmTraps=bmTraps, infoAlarmStateM1=infoAlarmStateM1, internalMgmtWarning=internalMgmtWarning, adminSwitchPortMirror=adminSwitchPortMirror, sfpInfoDateCode=sfpInfoDateCode, adminSnmpMacTableMode=adminSnmpMacTableMode, portPoeVoltage=portPoeVoltage, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoFunctionInputStateF1=infoFunctionInputStateF1, infoProductNo=infoProductNo, infoPoeInputPower=infoPoeInputPower, bmSwitchPortTable=bmSwitchPortTable, portDescr=portDescr, vlanIndex=vlanIndex, adminAlarmNameM2=adminAlarmNameM2, adminAgentIpAddress=adminAgentIpAddress, vlanDescr=vlanDescr, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portDefaultPrioQueue=portDefaultPrioQueue, sfpEvent=sfpEvent, sfpInfoPartNumber=sfpInfoPartNumber, infoLastTftpMessage=infoLastTftpMessage, portPoeOverloadFailure=portPoeOverloadFailure, adminAgentPrioValue=adminAgentPrioValue, sfpInfoVendorName=sfpInfoVendorName, portLimiterPacketType=portLimiterPacketType, portDefaultVlanId=portDefaultVlanId, radiusMgmtAuthReject=radiusMgmtAuthReject, infoPoeInputVoltage=infoPoeInputVoltage, portSecurityMacAddr3=portSecurityMacAddr3, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoLastFuncInputAlarmNumber=infoLastFuncInputAlarmNumber, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portSecurityForwardingState=portSecurityForwardingState, switchPoeVoltageFailure=switchPoeVoltageFailure, infoSerie=infoSerie, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, bmSwitchVlanTable=bmSwitchVlanTable, adminFunctionInputNameF2=adminFunctionInputNameF2, adminAgentVlanId=adminAgentVlanId, portAcApSetup=portAcApSetup, switchInternalVoltageFailure=switchInternalVoltageFailure, infoLastFuncInputAlarmState=infoLastFuncInputAlarmState, infoLastConfigChangeSource=infoLastConfigChangeSource, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portLinkState=portLinkState, infoSeriesNo=infoSeriesNo, adminFunctionInputNameF1=adminFunctionInputNameF1, infoManufactureDate=infoManufactureDate, sfpInfoBitRate=sfpInfoBitRate, portBandwidthLimitTxd=portBandwidthLimitTxd, infoNewMacAddr=infoNewMacAddr, adminTftpAccess=adminTftpAccess, infoLastPortStateChangeSource=infoLastPortStateChangeSource, infoDescr=infoDescr, portLinkChange=portLinkChange, switchTemperatureFailure=switchTemperatureFailure, portActiveDefaultVlanId=portActiveDefaultVlanId, sfpInfoLength50um=sfpInfoLength50um, adminAgentDhcp=adminAgentDhcp, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoTemperature=infoTemperature, adminLedGlobalMode=adminLedGlobalMode, infoFunctionInputStateF3=infoFunctionInputStateF3, bmSwitchAdmin=bmSwitchAdmin, infoAlarmStateM2=infoAlarmStateM2, tftpMessage=tftpMessage, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portNewMacAddress=portNewMacAddress, portErrorCountFailure=portErrorCountFailure, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, switchMgmtAuthFailure=switchMgmtAuthFailure, infoFunctionInputStateF2=infoFunctionInputStateF2, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminAlarmM2=adminAlarmM2, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoLastFuncInputAlarmName=infoLastFuncInputAlarmName, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoPowerVoltage2500=infoPowerVoltage2500, bmSwitchSfp=bmSwitchSfp, bmSwitchMIB=bmSwitchMIB, portVoiceVlanId=portVoiceVlanId, portActiveVoiceVlanId=portActiveVoiceVlanId, clientRemoved=clientRemoved, portPrioDot1p=portPrioDot1p, portPrioIp=portPrioIp, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portSecurityFailure=portSecurityFailure, bmSwitchSfpEntry=bmSwitchSfpEntry, portErrorDisabled=portErrorDisabled, infoSwitchHardwareVersion=infoSwitchHardwareVersion, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portLoopBcastFailure=portLoopBcastFailure, portPoePower=portPoePower, infoFunctionInputStateF4=infoFunctionInputStateF4, bmSwitchPort=bmSwitchPort, infoNoOfReboots=infoNoOfReboots, adminAlarmNameM1=adminAlarmNameM1, portLinkType=portLinkType, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminFunctionInputNameF3=adminFunctionInputNameF3, infoTotalConfigChanges=infoTotalConfigChanges, portPoePowerLimit=portPoePowerLimit, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpInfoLength62um=sfpInfoLength62um, sfpInfoWavelength=sfpInfoWavelength, portName=portName, switchPoeOverloadFailure=switchPoeOverloadFailure, infoPowerVoltage3300=infoPowerVoltage3300, adminAlarmM1=adminAlarmM1, bmSwitchVlanEntry=bmSwitchVlanEntry, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portTrunkingMode=portTrunkingMode, adminFunctionInputNameF4=adminFunctionInputNameF4, sfpInfoLength9um=sfpInfoLength9um, adminMgmtAccessList=adminMgmtAccessList, portPoeAdminState=portPoeAdminState, portStateChanged=portStateChanged, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminUnsecureVlanId=adminUnsecureVlanId, adminSwitchVlanTableMode=adminSwitchVlanTableMode, infoType=infoType, portPoeCurrent=portPoeCurrent, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portLEDYellow=portLEDYellow, portAdminState=portAdminState)
