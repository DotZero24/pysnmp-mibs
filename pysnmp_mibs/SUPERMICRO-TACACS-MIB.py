_J='fsTacClntServerAddress'
_I='SUPERMICRO-TACACS-MIB'
_H='enable'
_G='disable'
_F='DisplayString'
_E='read-create'
...
futureTacacsClientScalarGroup=_FutureTacacsClientScalarGroup_ObjectIdentity((1,3,6,1,4,1,10876,101,1,77,1))
_FsTacClntActiveServer_Type=IpAddress
_FsTacClntActiveServer_Object=MibScalar
fsTacClntActiveServer=_FsTacClntActiveServer_Object((1,3,6,1,4,1,10876,101,1,77,1,1),_FsTacClntActiveServer_Type())
fsTacClntActiveServer.setMaxAccess(_D)
...
fsTacClntTraceLevel=_FsTacClntTraceLevel_Object((1,3,6,1,4,1,10876,101,1,77,1,2),_FsTacClntTraceLevel_Type())
fsTacClntTraceLevel.setMaxAccess(_D)
...
fsTacClntRetransmit=_FsTacClntRetransmit_Object((1,3,6,1,4,1,10876,101,1,77,1,3),_FsTacClntRetransmit_Type())
fsTacClntRetransmit.setMaxAccess(_D)
if mibBuilder.loadTexts:fsTacClntRetransmit.setStatus(_A)
_FsTacClntStatisticsGroup_ObjectIdentity=ObjectIdentity
fsTacClntStatisticsGroup=_FsTacClntStatisticsGroup_ObjectIdentity((1,3,6,1,4,1,10876,101,1,77,1,4))
_FsTacClntAuthenStartRequests_Type=Counter32
_FsTacClntAuthenStartRequests_Object=MibScalar
fsTacClntAuthenStartRequests=_FsTacClntAuthenStartRequests_Object((1,3,6,1,4,1,10876,101,1,77,1,4,1),_FsTacClntAuthenStartRequests_Type())
...
fsTacClntAuthenContinueRequests=_FsTacClntAuthenContinueRequests_Object((1,3,6,1,4,1,10876,101,1,77,1,4,2),_FsTacClntAuthenContinueRequests_Type())
...
fsTacClntAuthenEnableRequests=_FsTacClntAuthenEnableRequests_Object((1,3,6,1,4,1,10876,101,1,77,1,4,3),_FsTacClntAuthenEnableRequests_Type())
...
fsTacClntAuthenAbortRequests=_FsTacClntAuthenAbortRequests_Object((1,3,6,1,4,1,10876,101,1,77,1,4,4),_FsTacClntAuthenAbortRequests_Type())
...
fsTacClntAuthenPassReceived=_FsTacClntAuthenPassReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,5),_FsTacClntAuthenPassReceived_Type())
...
fsTacClntAuthenFailReceived=_FsTacClntAuthenFailReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,6),_FsTacClntAuthenFailReceived_Type())
...
fsTacClntAuthenGetUserReceived=_FsTacClntAuthenGetUserReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,7),_FsTacClntAuthenGetUserReceived_Type())
...
fsTacClntAuthenGetPassReceived=_FsTacClntAuthenGetPassReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,8),_FsTacClntAuthenGetPassReceived_Type())
...
fsTacClntAuthenGetDataReceived=_FsTacClntAuthenGetDataReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,9),_FsTacClntAuthenGetDataReceived_Type())
...
fsTacClntAuthenErrorReceived=_FsTacClntAuthenErrorReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,10),_FsTacClntAuthenErrorReceived_Type())
...
fsTacClntAuthenFollowReceived=_FsTacClntAuthenFollowReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,11),_FsTacClntAuthenFollowReceived_Type())
...
fsTacClntAuthenRestartReceived=_FsTacClntAuthenRestartReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,12),_FsTacClntAuthenRestartReceived_Type())
...
fsTacClntAuthenSessionTimouts=_FsTacClntAuthenSessionTimouts_Object((1,3,6,1,4,1,10876,101,1,77,1,4,13),_FsTacClntAuthenSessionTimouts_Type())
...
fsTacClntAuthorRequests=_FsTacClntAuthorRequests_Object((1,3,6,1,4,1,10876,101,1,77,1,4,14),_FsTacClntAuthorRequests_Type())
...
fsTacClntAuthorPassAddReceived=_FsTacClntAuthorPassAddReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,15),_FsTacClntAuthorPassAddReceived_Type())
...
fsTacClntAuthorPassReplReceived=_FsTacClntAuthorPassReplReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,16),_FsTacClntAuthorPassReplReceived_Type())
...
fsTacClntAuthorFailReceived=_FsTacClntAuthorFailReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,17),_FsTacClntAuthorFailReceived_Type())
...
fsTacClntAuthorErrorReceived=_FsTacClntAuthorErrorReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,18),_FsTacClntAuthorErrorReceived_Type())
...
fsTacClntAuthorFollowReceived=_FsTacClntAuthorFollowReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,19),_FsTacClntAuthorFollowReceived_Type())
...
fsTacClntAuthorSessionTimeouts=_FsTacClntAuthorSessionTimeouts_Object((1,3,6,1,4,1,10876,101,1,77,1,4,20),_FsTacClntAuthorSessionTimeouts_Type())
...
fsTacClntAcctStartRequests=_FsTacClntAcctStartRequests_Object((1,3,6,1,4,1,10876,101,1,77,1,4,21),_FsTacClntAcctStartRequests_Type())
...
fsTacClntAcctWdRequests=_FsTacClntAcctWdRequests_Object((1,3,6,1,4,1,10876,101,1,77,1,4,22),_FsTacClntAcctWdRequests_Type())
...
fsTacClntAcctStopRequests=_FsTacClntAcctStopRequests_Object((1,3,6,1,4,1,10876,101,1,77,1,4,23),_FsTacClntAcctStopRequests_Type())
...
fsTacClntAcctSuccessReceived=_FsTacClntAcctSuccessReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,24),_FsTacClntAcctSuccessReceived_Type())
...
fsTacClntAcctErrorReceived=_FsTacClntAcctErrorReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,25),_FsTacClntAcctErrorReceived_Type())
...
fsTacClntAcctFollowReceived=_FsTacClntAcctFollowReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,26),_FsTacClntAcctFollowReceived_Type())
...
fsTacClntAcctSessionTimeouts=_FsTacClntAcctSessionTimeouts_Object((1,3,6,1,4,1,10876,101,1,77,1,4,27),_FsTacClntAcctSessionTimeouts_Type())
...
fsTacClntMalformedPktsReceived=_FsTacClntMalformedPktsReceived_Object((1,3,6,1,4,1,10876,101,1,77,1,4,28),_FsTacClntMalformedPktsReceived_Type())
...
fsTacClntSocketFailures=_FsTacClntSocketFailures_Object((1,3,6,1,4,1,10876,101,1,77,1,4,29),_FsTacClntSocketFailures_Type())
...
fsTacClntConnectionFailures=_FsTacClntConnectionFailures_Object((1,3,6,1,4,1,10876,101,1,77,1,4,30),_FsTacClntConnectionFailures_Type())
fsTacClntConnectionFailures.setMaxAccess(_B)
if mibBuilder.loadTexts:fsTacClntConnectionFailures.setStatus(_A)
class _FsTacClntAuthorStatus_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_G,0),(_H,1),('enableFallback',2)))
_FsTacClntAuthorStatus_Type.__name__=_C
_FsTacClntAuthorStatus_Object=MibScalar
fsTacClntAuthorStatus=_FsTacClntAuthorStatus_Object((1,3,6,1,4,1,10876,101,1,77,1,6),_FsTacClntAuthorStatus_Type())
fsTacClntAuthorStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:fsTacClntAuthorStatus.setStatus(_A)
class _FsTacClntAuthorServerGroup_Type(DisplayString):defaultValue=OctetString('');subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,31))
_FsTacClntAuthorServerGroup_Type.__name__=_F
_FsTacClntAuthorServerGroup_Object=MibScalar
fsTacClntAuthorServerGroup=_FsTacClntAuthorServerGroup_Object((1,3,6,1,4,1,10876,101,1,77,1,7),_FsTacClntAuthorServerGroup_Type())
fsTacClntAuthorServerGroup.setMaxAccess(_D)
if mibBuilder.loadTexts:fsTacClntAuthorServerGroup.setStatus(_A)
class _FsTacClntAccountingStatus_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1)));namedValues=NamedValues(*((_G,0),(_H,1)))
_FsTacClntAccountingStatus_Type.__name__=_C
_FsTacClntAccountingStatus_Object=MibScalar
fsTacClntAccountingStatus=_FsTacClntAccountingStatus_Object((1,3,6,1,4,1,10876,101,1,77,1,8),_FsTacClntAccountingStatus_Type())
fsTacClntAccountingStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:fsTacClntAccountingStatus.setStatus(_A)
class _FsTacClntAccountingPrivilege_Type(Integer32):defaultValue=255;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,15),ValueRangeConstraint(255,255))
_FsTacClntAccountingPrivilege_Type.__name__=_C
_FsTacClntAccountingPrivilege_Object=MibScalar
fsTacClntAccountingPrivilege=_FsTacClntAccountingPrivilege_Object((1,3,6,1,4,1,10876,101,1,77,1,9),_FsTacClntAccountingPrivilege_Type())
fsTacClntAccountingPrivilege.setMaxAccess(_D)
if mibBuilder.loadTexts:fsTacClntAccountingPrivilege.setStatus(_A)
class _FsTacClntAccountingSendType_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1)));namedValues=NamedValues(*(('sendStopOnly',0),('sendStartStop',1)))
_FsTacClntAccountingSendType_Type.__name__=_C
_FsTacClntAccountingSendType_Object=MibScalar
fsTacClntAccountingSendType=_FsTacClntAccountingSendType_Object((1,3,6,1,4,1,10876,101,1,77,1,10),_FsTacClntAccountingSendType_Type())
fsTacClntAccountingSendType.setMaxAccess(_D)
if mibBuilder.loadTexts:fsTacClntAccountingSendType.setStatus(_A)
class _FsTacClntAccountingServerGroup_Type(DisplayString):defaultValue=OctetString('');subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,31))
_FsTacClntAccountingServerGroup_Type.__name__=_F
_FsTacClntAccountingServerGroup_Object=MibScalar
fsTacClntAccountingServerGroup=_FsTacClntAccountingServerGroup_Object((1,3,6,1,4,1,10876,101,1,77,1,11),_FsTacClntAccountingServerGroup_Type())
fsTacClntAccountingServerGroup.setMaxAccess(_D)
if mibBuilder.loadTexts:fsTacClntAccountingServerGroup.setStatus(_A)
_FutureTacacsClientTableGroup_ObjectIdentity=ObjectIdentity
futureTacacsClientTableGroup=_FutureTacacsClientTableGroup_ObjectIdentity((1,3,6,1,4,1,10876,101,1,77,2))
_FsTacClntServerTable_Object=MibTable
fsTacClntServerTable=_FsTacClntServerTable_Object((1,3,6,1,4,1,10876,101,1,77,2,1))
if mibBuilder.loadTexts:fsTacClntServerTable.setStatus(_A)
_FsTacClntServerEntry_Object=MibTableRow
fsTacClntServerEntry=_FsTacClntServerEntry_Object((1,3,6,1,4,1,10876,101,1,77,2,1,1))
fsTacClntServerEntry.setIndexNames((0,_I,_J))
...
fsTacClntServerAddress=_FsTacClntServerAddress_Object((1,3,6,1,4,1,10876,101,1,77,2,1,1,1),_FsTacClntServerAddress_Type())
...
fsTacClntServerStatus=_FsTacClntServerStatus_Object((1,3,6,1,4,1,10876,101,1,77,2,1,1,2),_FsTacClntServerStatus_Type())
fsTacClntServerStatus.setMaxAccess(_E)
...
fsTacClntServerSingleConnect=_FsTacClntServerSingleConnect_Object((1,3,6,1,4,1,10876,101,1,77,2,1,1,3),_FsTacClntServerSingleConnect_Type())
fsTacClntServerSingleConnect.setMaxAccess(_E)
...
fsTacClntServerPort=_FsTacClntServerPort_Object((1,3,6,1,4,1,10876,101,1,77,2,1,1,4),_FsTacClntServerPort_Type())
fsTacClntServerPort.setMaxAccess(_E)
...
fsTacClntServerTimeout=_FsTacClntServerTimeout_Object((1,3,6,1,4,1,10876,101,1,77,2,1,1,5),_FsTacClntServerTimeout_Type())
fsTacClntServerTimeout.setMaxAccess(_E)
