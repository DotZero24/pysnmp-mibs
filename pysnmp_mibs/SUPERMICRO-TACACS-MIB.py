# SNMP MIB module (SUPERMICRO-TACACS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-TACACS-MIB
...
fsTacClntActiveServer = _FsTacClntActiveServer_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 1),
...
fsTacClntTraceLevel = _FsTacClntTraceLevel_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 2),
...
fsTacClntRetransmit = _FsTacClntRetransmit_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 3),
...
fsTacClntStatisticsGroup = _FsTacClntStatisticsGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4)
)
...
fsTacClntAuthenStartRequests = _FsTacClntAuthenStartRequests_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 1),
...
fsTacClntAuthenContinueRequests = _FsTacClntAuthenContinueRequests_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 2),
...
fsTacClntAuthenEnableRequests = _FsTacClntAuthenEnableRequests_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 3),
...
fsTacClntAuthenAbortRequests = _FsTacClntAuthenAbortRequests_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 4),
...
fsTacClntAuthenPassReceived = _FsTacClntAuthenPassReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 5),
...
fsTacClntAuthenFailReceived = _FsTacClntAuthenFailReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 6),
...
fsTacClntAuthenGetUserReceived = _FsTacClntAuthenGetUserReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 7),
...
fsTacClntAuthenGetPassReceived = _FsTacClntAuthenGetPassReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 8),
...
fsTacClntAuthenGetDataReceived = _FsTacClntAuthenGetDataReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 9),
...
fsTacClntAuthenErrorReceived = _FsTacClntAuthenErrorReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 10),
...
fsTacClntAuthenFollowReceived = _FsTacClntAuthenFollowReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 11),
...
fsTacClntAuthenRestartReceived = _FsTacClntAuthenRestartReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 12),
...
fsTacClntAuthenSessionTimouts = _FsTacClntAuthenSessionTimouts_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 13),
...
fsTacClntAuthorRequests = _FsTacClntAuthorRequests_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 14),
...
fsTacClntAuthorPassAddReceived = _FsTacClntAuthorPassAddReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 15),
...
fsTacClntAuthorPassReplReceived = _FsTacClntAuthorPassReplReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 16),
...
fsTacClntAuthorFailReceived = _FsTacClntAuthorFailReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 17),
...
fsTacClntAuthorErrorReceived = _FsTacClntAuthorErrorReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 18),
...
fsTacClntAuthorFollowReceived = _FsTacClntAuthorFollowReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 19),
...
fsTacClntAuthorSessionTimeouts = _FsTacClntAuthorSessionTimeouts_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 20),
...
fsTacClntAcctStartRequests = _FsTacClntAcctStartRequests_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 21),
...
fsTacClntAcctWdRequests = _FsTacClntAcctWdRequests_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 22),
...
fsTacClntAcctStopRequests = _FsTacClntAcctStopRequests_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 23),
...
fsTacClntAcctSuccessReceived = _FsTacClntAcctSuccessReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 24),
...
fsTacClntAcctErrorReceived = _FsTacClntAcctErrorReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 25),
...
fsTacClntAcctFollowReceived = _FsTacClntAcctFollowReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 26),
...
fsTacClntAcctSessionTimeouts = _FsTacClntAcctSessionTimeouts_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 27),
...
fsTacClntMalformedPktsReceived = _FsTacClntMalformedPktsReceived_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 28),
...
fsTacClntSocketFailures = _FsTacClntSocketFailures_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 29),
...
fsTacClntConnectionFailures = _FsTacClntConnectionFailures_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 4, 30),
...
class _FsTacClntAuthorStatus_Type(Integer32):
    """Custom type fsTacClntAuthorStatus based on Integer32"""
    defaultValue = 0
...
_FsTacClntAuthorStatus_Type.__name__ = "Integer32"
_FsTacClntAuthorStatus_Object = MibScalar
fsTacClntAuthorStatus = _FsTacClntAuthorStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 6),
    _FsTacClntAuthorStatus_Type()
)
fsTacClntAuthorStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsTacClntAuthorStatus.setStatus("current")


class _FsTacClntAuthorServerGroup_Type(DisplayString):
    """Custom type fsTacClntAuthorServerGroup based on DisplayString"""
...
_FsTacClntAuthorServerGroup_Type.__name__ = "DisplayString"
_FsTacClntAuthorServerGroup_Object = MibScalar
fsTacClntAuthorServerGroup = _FsTacClntAuthorServerGroup_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 7),
    _FsTacClntAuthorServerGroup_Type()
)
fsTacClntAuthorServerGroup.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsTacClntAuthorServerGroup.setStatus("current")


class _FsTacClntAccountingStatus_Type(Integer32):
    """Custom type fsTacClntAccountingStatus based on Integer32"""
    defaultValue = 0
...
_FsTacClntAccountingStatus_Type.__name__ = "Integer32"
_FsTacClntAccountingStatus_Object = MibScalar
fsTacClntAccountingStatus = _FsTacClntAccountingStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 8),
    _FsTacClntAccountingStatus_Type()
)
fsTacClntAccountingStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsTacClntAccountingStatus.setStatus("current")


class _FsTacClntAccountingPrivilege_Type(Integer32):
    """Custom type fsTacClntAccountingPrivilege based on Integer32"""
    defaultValue = 255
...
_FsTacClntAccountingPrivilege_Type.__name__ = "Integer32"
_FsTacClntAccountingPrivilege_Object = MibScalar
fsTacClntAccountingPrivilege = _FsTacClntAccountingPrivilege_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 9),
    _FsTacClntAccountingPrivilege_Type()
)
fsTacClntAccountingPrivilege.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsTacClntAccountingPrivilege.setStatus("current")


class _FsTacClntAccountingSendType_Type(Integer32):
    """Custom type fsTacClntAccountingSendType based on Integer32"""
    defaultValue = 0
...
_FsTacClntAccountingSendType_Type.__name__ = "Integer32"
_FsTacClntAccountingSendType_Object = MibScalar
fsTacClntAccountingSendType = _FsTacClntAccountingSendType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 10),
    _FsTacClntAccountingSendType_Type()
)
fsTacClntAccountingSendType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsTacClntAccountingSendType.setStatus("current")


class _FsTacClntAccountingServerGroup_Type(DisplayString):
    """Custom type fsTacClntAccountingServerGroup based on DisplayString"""
    defaultValue = OctetString("")
...
_FsTacClntAccountingServerGroup_Type.__name__ = "DisplayString"
_FsTacClntAccountingServerGroup_Object = MibScalar
fsTacClntAccountingServerGroup = _FsTacClntAccountingServerGroup_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 1, 11),
    _FsTacClntAccountingServerGroup_Type()
)
fsTacClntAccountingServerGroup.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsTacClntAccountingServerGroup.setStatus("current")
...
fsTacClntServerEntry = _FsTacClntServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 77, 2, 1, 1)
)
fsTacClntServerEntry.setIndexNames(
    (0, "SUPERMICRO-TACACS-MIB", "fsTacClntServerAddress"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"futureTacacsClientMIB": futureTacacsClientMIB,
       ...
       "fsTacClntAuthorStatus": fsTacClntAuthorStatus,
       "fsTacClntAuthorServerGroup": fsTacClntAuthorServerGroup,
       "fsTacClntAccountingStatus": fsTacClntAccountingStatus,
       "fsTacClntAccountingPrivilege": fsTacClntAccountingPrivilege,
       "fsTacClntAccountingSendType": fsTacClntAccountingSendType,
       "fsTacClntAccountingServerGroup": fsTacClntAccountingServerGroup,
