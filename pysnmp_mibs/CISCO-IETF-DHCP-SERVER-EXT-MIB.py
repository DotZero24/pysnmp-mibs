...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-DHCP-SERVER-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:39:09 2025
...
_CDhcpv4ServerIfLeaseLimitEnable_Type.__name__ = "TruthValue"
...
_CDhcpv4ServerSubnetFreeAddressLowEnable_Type.__name__ = "TruthValue"
...
_CDhcpv4ServerSubnetFreeAddressHighEnable_Type.__name__ = "TruthValue"
...
cDhcpv4SrvExtCompliance.setObjects(
      *(("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4SrvExtSystemObjects"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4ExtCountersGroup"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4CountersIntervalGroup"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4FOCountersGroup"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4FOCountersIntervalGroup"),
...
cDhcpv4SrvExtComplianceRev1.setObjects(
      *(("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4SrvExtSystemObjects"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4ExtCountersGroup"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4CountersIntervalGroup"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4FOCountersGroup"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4FOCountersIntervalGroup"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4CfgObjectsGroup"),
        ("CISCO-IETF-DHCP-SERVER-EXT-MIB", "cDhcpv4SrvExtNotifyGroup"))
)
if mibBuilder.loadTexts:
