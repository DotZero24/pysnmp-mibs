...
hwLswLastSwitchDate=_HwLswLastSwitchDate_Object((1,3,6,1,4,1,43,45,1,2,23,1,17,1),_HwLswLastSwitchDate_Type())
...
hwLswLastSwitchTime=_HwLswLastSwitchTime_Object((1,3,6,1,4,1,43,45,1,2,23,1,17,2),_HwLswLastSwitchTime_Type())
...
hwLswMpuSwitchsNum=_HwLswMpuSwitchsNum_Object((1,3,6,1,4,1,43,45,1,2,23,1,17,3),_HwLswMpuSwitchsNum_Type())
...
hwLswMpuSwitch=_HwLswMpuSwitch_Object((1,3,6,1,4,1,43,45,1,2,23,1,17,4),_HwLswMpuSwitch_Type())
...
hwLswXSlotTable=_HwLswXSlotTable_Object((1,3,6,1,4,1,43,45,1,2,23,1,17,5))
if mibBuilder.loadTexts:hwLswXSlotTable.setStatus(_A)
_HwLswXSlotEntry_Object=MibTableRow
hwLswXSlotEntry=_HwLswXSlotEntry_Object((1,3,6,1,4,1,43,45,1,2,23,1,17,5,1))
...
hwLswMainCardBoardStatus=_HwLswMainCardBoardStatus_Object((1,3,6,1,4,1,43,45,1,2,23,1,17,5,1,1),_HwLswMainCardBoardStatus_Type())
...
hwLswCrossBarStatus=_HwLswCrossBarStatus_Object((1,3,6,1,4,1,43,45,1,2,23,1,17,5,1,2),_HwLswCrossBarStatus_Type())
...
hwsMixTrapMib=_HwsMixTrapMib_ObjectIdentity((1,3,6,1,4,1,43,45,1,2,23,1,17,10))
