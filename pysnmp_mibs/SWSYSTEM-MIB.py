...
mibBuilder.exportSymbols("SWSYSTEM-MIB", swEtherIPMask=swEtherIPMask, swCpuPollingInterval=swCpuPollingInterval, swCpuOrMemoryUsage=swCpuOrMemoryUsage, swBootDate=swBootDate, swIPv6Status=swIPv6Status, swCpuAction=swCpuAction, swNumSensors=swNumSensors, swSensorIndex=swSensorIndex, swEventTrapLevel=swEventTrapLevel, swFWLastUpdated=swFWLastUpdated, swSystem=swSystem, swCurrentDate=swCurrentDate, swFlashLastUpdated=swFlashLastUpdated, swSensorStatus=swSensorStatus, swEventIndex=swEventIndex, swCpuUsageLimit=swCpuUsageLimit, swEventLevel=swEventLevel, swEventTrap=swEventTrap, swEtherIPAddress=swEtherIPAddress, swSensorType=swSensorType, swEventVfId=swEventVfId, swEventNumEntries=swEventNumEntries, swEventEntry=swEventEntry, swMemAction=swMemAction, swBeaconOperStatus=swBeaconOperStatus, PYSNMP_MODULE_ID=swSystem, swEvent=swEvent, swID=swID, swSensorTable=swSensorTable, swCpuNoOfRetries=swCpuNoOfRetries, swEventDescr=swEventDescr, swBeaconAdmStatus=swBeaconAdmStatus, FcPortFlag=FcPortFlag, swEventRepeatCount=swEventRepeatCount, swSensorEntry=swSensorEntry, swIPv6Address=swIPv6Address, swCpuUsage=swCpuUsage, swMemUsage=swMemUsage, swMemPollingInterval=swMemPollingInterval, swSensorValue=swSensorValue, swMemUsageLimit=swMemUsageLimit, swSsn=swSsn, swBootPromLastUpdated=swBootPromLastUpdated, swTrapsV2=swTrapsV2, swFirmwareVersion=swFirmwareVersion, swOperStatus=swOperStatus, swStateChangeTrap=swStateChangeTrap, SwFwEvent=SwFwEvent, swDiagResult=swDiagResult, swEventTable=swEventTable, swEventTimeInfo=swEventTimeInfo, swMemNoOfRetries=swMemNoOfRetries, swSensorInfo=swSensorInfo)
