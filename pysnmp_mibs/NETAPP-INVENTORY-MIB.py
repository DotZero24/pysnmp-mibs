...
agentInventoryStackGroup=_AgentInventoryStackGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,13,1))
...
agentInventoryStackSTKname=_AgentInventoryStackSTKname_Object((1,3,6,1,4,1,789,4413,1,1,13,1,5),_AgentInventoryStackSTKname_Type())
...
agentInventoryStackActivateSTK=_AgentInventoryStackActivateSTK_Object((1,3,6,1,4,1,789,4413,1,1,13,1,6),_AgentInventoryStackActivateSTK_Type())
...
agentInventoryStackDeleteSTK=_AgentInventoryStackDeleteSTK_Object((1,3,6,1,4,1,789,4413,1,1,13,1,7),_AgentInventoryStackDeleteSTK_Type())
...
agentInventoryCardGroup=_AgentInventoryCardGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,13,4))
_AgentInventoryCardTypeTable_Object=MibTable
agentInventoryCardTypeTable=_AgentInventoryCardTypeTable_Object((1,3,6,1,4,1,789,4413,1,1,13,4,1))
if mibBuilder.loadTexts:agentInventoryCardTypeTable.setStatus(_A)
_AgentInventoryCardTypeEntry_Object=MibTableRow
agentInventoryCardTypeEntry=_AgentInventoryCardTypeEntry_Object((1,3,6,1,4,1,789,4413,1,1,13,4,1,1))
...
agentInventoryCardIndex=_AgentInventoryCardIndex_Object((1,3,6,1,4,1,789,4413,1,1,13,4,1,1,1),_AgentInventoryCardIndex_Type())
...
agentInventoryCardType=_AgentInventoryCardType_Object((1,3,6,1,4,1,789,4413,1,1,13,4,1,1,2),_AgentInventoryCardType_Type())
...
agentInventoryCardModelIdentifier=_AgentInventoryCardModelIdentifier_Object((1,3,6,1,4,1,789,4413,1,1,13,4,1,1,3),_AgentInventoryCardModelIdentifier_Type())
...
agentInventoryCardDescription=_AgentInventoryCardDescription_Object((1,3,6,1,4,1,789,4413,1,1,13,4,1,1,4),_AgentInventoryCardDescription_Type())
...
agentInventoryComponentGroup=_AgentInventoryComponentGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,13,5))
_AgentInventoryComponentTable_Object=MibTable
agentInventoryComponentTable=_AgentInventoryComponentTable_Object((1,3,6,1,4,1,789,4413,1,1,13,5,1))
if mibBuilder.loadTexts:agentInventoryComponentTable.setStatus(_A)
_AgentInventoryComponentEntry_Object=MibTableRow
agentInventoryComponentEntry=_AgentInventoryComponentEntry_Object((1,3,6,1,4,1,789,4413,1,1,13,5,1,1))
...
agentInventoryComponentIndex=_AgentInventoryComponentIndex_Object((1,3,6,1,4,1,789,4413,1,1,13,5,1,1,1),_AgentInventoryComponentIndex_Type())
...
agentInventoryComponentMnemonic=_AgentInventoryComponentMnemonic_Object((1,3,6,1,4,1,789,4413,1,1,13,5,1,1,2),_AgentInventoryComponentMnemonic_Type())
...
agentInventoryComponentName=_AgentInventoryComponentName_Object((1,3,6,1,4,1,789,4413,1,1,13,5,1,1,3),_AgentInventoryComponentName_Type())
