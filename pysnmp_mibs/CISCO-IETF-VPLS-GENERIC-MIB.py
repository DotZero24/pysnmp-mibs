...
mibBuilder.exportSymbols("CISCO-IETF-VPLS-GENERIC-MIB", cvplsConfigFwdFullLowWatermark=cvplsConfigFwdFullLowWatermark, cvplsConfigStorageType=cvplsConfigStorageType, cvplsConfigDescr=cvplsConfigDescr, cvplsPwBindConfigType=cvplsPwBindConfigType, cvplsFwdFullAlarmRaised=cvplsFwdFullAlarmRaised, cvplsStatusEntry=cvplsStatusEntry, cvplsNotificationMaxRate=cvplsNotificationMaxRate, cvplsCompliances=cvplsCompliances, cvplsConfigAdminStatus=cvplsConfigAdminStatus, cvplsConfigEntry=cvplsConfigEntry, cvplsGroups=cvplsGroups, cvplsConfigName=cvplsConfigName, cvplsConfigRowStatus=cvplsConfigRowStatus, cvplsGenericMIB=cvplsGenericMIB, cvplsConfigFwdFullHighWatermark=cvplsConfigFwdFullHighWatermark, cvplsNotificationGroup=cvplsNotificationGroup, cvplsConfigMacLearning=cvplsConfigMacLearning, cvplsConfigVpnId=cvplsConfigVpnId, cvplsConfigIndex=cvplsConfigIndex, cvplsPwBindRowStatus=cvplsPwBindRowStatus, cvplsStatusNotifEnable=cvplsStatusNotifEnable, cvplsPwBindStorageType=cvplsPwBindStorageType, cvplsPwBindGroup=cvplsPwBindGroup, cvplsNotifications=cvplsNotifications, cvplsConformance=cvplsConformance, cvplsObjects=cvplsObjects, cvplsStatusChanged=cvplsStatusChanged, cvplsConfigMtu=cvplsConfigMtu, cvplsStatusTable=cvplsStatusTable, cvplsPwBindEntry=cvplsPwBindEntry, PYSNMP_MODULE_ID=cvplsGenericMIB, cvplsPwBindIndex=cvplsPwBindIndex, cvplsModuleFullCompliance=cvplsModuleFullCompliance, cvplsStatusPeerCount=cvplsStatusPeerCount, cvplsStatusOperStatus=cvplsStatusOperStatus, cvplsGroup=cvplsGroup, cvplsConfigTable=cvplsConfigTable, cvplsConfigIndexNext=cvplsConfigIndexNext, cvplsPwBindTable=cvplsPwBindTable, cvplsPwBindType=cvplsPwBindType, cvplsConfigMacAging=cvplsConfigMacAging, cvplsFwdFullAlarmCleared=cvplsFwdFullAlarmCleared, cvplsConfigDiscardUnknownDest=cvplsConfigDiscardUnknownDest, cvplsModuleReadOnlyCompliance=cvplsModuleReadOnlyCompliance, cvplsConfigServiceType=cvplsConfigServiceType)
