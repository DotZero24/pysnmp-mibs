...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-VPLS-GENERIC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:40:23 2025
...
class _CvplsConfigName_Type(SnmpAdminString):
    """Custom type cvplsConfigName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CvplsConfigName_Type.__name__ = "SnmpAdminString"
...
class _CvplsConfigDescr_Type(SnmpAdminString):
    """Custom type cvplsConfigDescr based on SnmpAdminString"""
    defaultValue = OctetString("")


_CvplsConfigDescr_Type.__name__ = "SnmpAdminString"
...
_CvplsConfigMacLearning_Type.__name__ = "TruthValue"
...
_CvplsConfigDiscardUnknownDest_Type.__name__ = "TruthValue"
...
_CvplsConfigMacAging_Type.__name__ = "TruthValue"
...
_CvplsConfigStorageType_Type.__name__ = "StorageType"
...
_CvplsPwBindStorageType_Type.__name__ = "StorageType"
...
_CvplsStatusNotifEnable_Type.__name__ = "TruthValue"
...
_CvplsNotificationMaxRate_Type.__name__ = "Unsigned32"
...
cvplsModuleFullCompliance.setObjects(
      *(("CISCO-IETF-VPLS-GENERIC-MIB", "cvplsGroup"),
        ("CISCO-IETF-VPLS-GENERIC-MIB", "cvplsPwBindGroup"),
        ("CISCO-IETF-VPLS-GENERIC-MIB", "cvplsNotificationGroup"))
)
if mibBuilder.loadTexts:
...
cvplsModuleReadOnlyCompliance.setObjects(
      *(("CISCO-IETF-VPLS-GENERIC-MIB", "cvplsGroup"),
        ("CISCO-IETF-VPLS-GENERIC-MIB", "cvplsPwBindGroup"),
        ("CISCO-IETF-VPLS-GENERIC-MIB", "cvplsNotificationGroup"))
)
