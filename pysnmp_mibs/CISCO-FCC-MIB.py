...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FCC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:09 2025
...
_CFCCNotificationEnable_Type.__name__ = "TruthValue"
...
ciscoFCCMIBCompliance.setObjects(
      *(("CISCO-FCC-MIB", "cFCCConfigurationGroup"),
        ("CISCO-FCC-MIB", "cFCCPortEntriesGroup"),
        ("CISCO-FCC-MIB", "cFCCNotificationObjectsGroup"),
        ("CISCO-FCC-MIB", "cFCCNotificationGroup"))
)
if mibBuilder.loadTexts:
...
ciscoFCCMIBComplianceRev1.setObjects(
      *(("CISCO-FCC-MIB", "cFCCConfigurationGroup"),
        ("CISCO-FCC-MIB", "cFCCPortEntriesGroupRev1"),
        ("CISCO-FCC-MIB", "cFCCNotificationObjectsGroup"),
        ("CISCO-FCC-MIB", "cFCCNotificationGroup"))
)
if mibBuilder.loadTexts:
