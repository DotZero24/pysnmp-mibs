...
mibBuilder.exportSymbols("F10-FPSTATS-MIB", fpTxPktCOS7=fpTxPktCOS7, fpEgPktDropsOfAnyCondition=fpEgPktDropsOfAnyCondition, fpIngPacketsDroppedByFP=fpIngPacketsDroppedByFP, fpIngPortBitMapZeroDrops=fpIngPortBitMapZeroDrops, fpPacketBufferTable=fpPacketBufferTable, fpIngRxVLANDrops=fpIngRxVLANDrops, fpRxPktUnit1=fpRxPktUnit1, fpPacketBufferEntry=fpPacketBufferEntry, fpCpuPartyBusPortStatsInDropPkts=fpCpuPartyBusPortStatsInDropPkts, fpIngPgBuffSnapshotTable=fpIngPgBuffSnapshotTable, ifPrioIndex=ifPrioIndex, fpEgrQTxPackets=fpEgrQTxPackets, fpCpuPartyBusPortStatsOutBroadcastPkts=fpCpuPartyBusPortStatsOutBroadcastPkts, fpIfIngressFCSDrops=fpIfIngressFCSDrops, fpCpuPartyBusPortStatsInOversizePkts=fpCpuPartyBusPortStatsInOversizePkts, fpIfIngHeadroomCells=fpIfIngHeadroomCells, fpStatsPerIfEntry=fpStatsPerIfEntry, fpRxPktCOS4=fpRxPktCOS4, fpCpuPartyBusPortStatsOutCOS3Pkts=fpCpuPartyBusPortStatsOutCOS3Pkts, fpPacketBufferAlloc=fpPacketBufferAlloc, fpCpuPartyBusPortStatsIn1024ToMaxOctetPkts=fpCpuPartyBusPortStatsIn1024ToMaxOctetPkts, fpRxPktCOS7=fpRxPktCOS7, fpIfDefaultPacketBuffAllocPerCOS=fpIfDefaultPacketBuffAllocPerCOS, fpStatsPerPgEntry=fpStatsPerPgEntry, fpCpuDataPlaneTable=fpCpuDataPlaneTable, fpTxPktCOS5=fpTxPktCOS5, fpIngPolicyDiscards=fpIngPolicyDiscards, fpTxPktCOS4=fpTxPktCOS4, pfcPerPrioIndications=pfcPerPrioIndications, fpCpuPartyBusPortStatsIn512To1023OctetPkts=fpCpuPartyBusPortStatsIn512To1023OctetPkts, ifPfcPerPrioRequests=ifPfcPerPrioRequests, fpCpuPartyBusPortStatsIn256To511OctetPkts=fpCpuPartyBusPortStatsIn256To511OctetPkts, fpTxPktUnit3=fpTxPktUnit3, fpIfStatsPgHdrmCells=fpIfStatsPgHdrmCells, fpIfPerCOSNumber=fpIfPerCOSNumber, fpIfIngPortBitMapZeroDrops=fpIfIngPortBitMapZeroDrops, fpIfEgL2MCDrops=fpIfEgL2MCDrops, fpIfEgPktDropsOfAnyCondition=fpIfEgPktDropsOfAnyCondition, fpStatsObjects=fpStatsObjects, fpPartyBusOutputError=fpPartyBusOutputError, fpCpuPartyBusPortStatsInInRangeErrors=fpCpuPartyBusPortStatsInInRangeErrors, fpIfIngPortSTPnotFwdDrops=fpIfIngPortSTPnotFwdDrops, fpTxInternalError=fpTxInternalError, fpDropsIfEntry=fpDropsIfEntry, fpIfCurrentUsagePerPort=fpIfCurrentUsagePerPort, fpEgrQBuffSnapshotIfTable=fpEgrQBuffSnapshotIfTable, fpStatsPerPortEntry=fpStatsPerPortEntry, fpIfIngRxVLANDrops=fpIfIngRxVLANDrops, fpCpuPartyBusPortStatsInSrcAddrChanges=fpCpuPartyBusPortStatsInSrcAddrChanges, fpIfIngIBPCBPFullDrops=fpIfIngIBPCBPFullDrops, fpRxHandle=fpRxHandle, fpEgressFCSDrops=fpEgressFCSDrops, fpCpuPartyBusPortStatsInMulticastPkts=fpCpuPartyBusPortStatsInMulticastPkts, fpIfStatsPgCounterMinCells=fpIfStatsPgCounterMinCells, fpTxPktCOS3=fpTxPktCOS3, fpDefaultPacketBuffAlloc=fpDefaultPacketBuffAlloc, fpIngressMTUExceeds=fpIngressMTUExceeds, fpCpuPartyBusPortStatsOutSingleCollisions=fpCpuPartyBusPortStatsOutSingleCollisions, fpRxPktUnit0=fpRxPktUnit0, fpIfIngPolicyDiscards=fpIfIngPolicyDiscards, fpCpuDataPlaneCOSEntry=fpCpuDataPlaneCOSEntry, fpTxPktCOS6=fpTxPktCOS6, fpEgInvalidVLANCounterDrops=fpEgInvalidVLANCounterDrops, fpMaxLimitPerCOS=fpMaxLimitPerCOS, fpTxPktCOS2=fpTxPktCOS2, f10FpStatsMib=f10FpStatsMib, f10FpStatsObject=f10FpStatsObject, fpIngPgBuffSnapshotEntry=fpIngPgBuffSnapshotEntry, fpTxDatapathErr=fpTxDatapathErr, fpPartyBusOutputBytes=fpPartyBusOutputBytes, fpIfEgHgMacUnderFlow=fpIfEgHgMacUnderFlow, fpEgrQTxBytes=fpEgrQTxBytes, fpIfEgressFCSDrops=fpIfEgressFCSDrops, fpIngPortSTPnotFwdDrops=fpIngPortSTPnotFwdDrops, fpIfPerPGIndex=fpIfPerPGIndex, fpIfDefaultPacketBuffAlloc=fpIfDefaultPacketBuffAlloc, fpPartyBusInputPackets=fpPartyBusInputPackets, fpIngressDrops=fpIngressDrops, fpCpuPartyBusPortStatsOutLateCollisions=fpCpuPartyBusPortStatsOutLateCollisions, fpCpuPartyBusPortStatsOutDeferred=fpCpuPartyBusPortStatsOutDeferred, fpCpuPartyBusPortStatsInJumboPkts=fpCpuPartyBusPortStatsInJumboPkts, fpRxPktCOS3=fpRxPktCOS3, fpEgrQBuffSnapshotTable=fpEgrQBuffSnapshotTable, fpEgTTLThresholdDrops=fpEgTTLThresholdDrops, fpRxPktCOS2=fpRxPktCOS2, fpStatsPgCounterHdrmCells=fpStatsPgCounterHdrmCells, fpRxPktCOS=fpRxPktCOS, fpIngPgBuffSnapshotIfEntry=fpIngPgBuffSnapshotIfEntry, fpStatsPgSharedMode=fpStatsPgSharedMode, fpStatsPerIfCOSEntry=fpStatsPerIfCOSEntry, fpIfStatsPgSharedMode=fpIfStatsPgSharedMode, fpIngIBPCBPFullDrops=fpIngIBPCBPFullDrops, fpStatsPgCounterSharedCells=fpStatsPgCounterSharedCells, fpIfIngL2L3Drops=fpIfIngL2L3Drops, fpCpuPartyBusPortStatsOutCOS5Pkts=fpCpuPartyBusPortStatsOutCOS5Pkts, fpIfMMUTxPurgeCellErr=fpIfMMUTxPurgeCellErr, ifPfcPerPrioIndications=ifPfcPerPrioIndications, fpCpuPartyBusPortStatsOutDiscarded=fpCpuPartyBusPortStatsOutDiscarded, fpCpuPartyBusPortStatsIn64OctetPkts=fpCpuPartyBusPortStatsIn64OctetPkts, fpRxDatapathError=fpRxDatapathError, fpIfEgrQTotBuffCells=fpIfEgrQTotBuffCells, fpCpuPartyBusPortStatsInBroadcastPkts=fpCpuPartyBusPortStatsInBroadcastPkts, fpTransmitted=fpTransmitted, fpIngL2L3Drops=fpIngL2L3Drops, fpCpuDataPlaneCOSTable=fpCpuDataPlaneCOSTable, fpCpuPartyBusPortStatsOutCOS2Pkts=fpCpuPartyBusPortStatsOutCOS2Pkts, fpEgrQComType=fpEgrQComType, fpCpuPartyBusPortStatsOutDropPkts=fpCpuPartyBusPortStatsOutDropPkts, fpStatsPerPortTable=fpStatsPerPortTable, fpCpuPartyBusPortStatsInAlignErrors=fpCpuPartyBusPortStatsInAlignErrors, fpIfMMUAgedDrops=fpIfMMUAgedDrops, fpIfStatsPgCounterHdrmCells=fpIfStatsPgCounterHdrmCells, fpCurrentUsagePerPort=fpCurrentUsagePerPort, fpPartyBusOutputPackets=fpPartyBusOutputPackets, fpCpuPartyBusPortStatsTable=fpCpuPartyBusPortStatsTable, fpCpuPartyBusPortStatsInOutRangeErrors=fpCpuPartyBusPortStatsInOutRangeErrors, fpDropsEntry=fpDropsEntry, fpRxPktUnit3=fpRxPktUnit3, fpRxPktCOS6=fpRxPktCOS6, fpTxPktCOS1=fpTxPktCOS1, fpIfIngPacketsDroppedByFP=fpIfIngPacketsDroppedByFP, fpMaxLimitPerPort=fpMaxLimitPerPort, fpPartyBusInputBytes=fpPartyBusInputBytes, fpCpuPartyBusStatsEntry=fpCpuPartyBusStatsEntry, fpIfIngressMTUExceeds=fpIfIngressMTUExceeds, fpIfEgTTLThresholdDrops=fpIfEgTTLThresholdDrops, pfcPerPrioRequests=pfcPerPrioRequests, fpTotalPacketBuffer=fpTotalPacketBuffer, fpCpuPartyBusPortStatsOutCOS4Pkts=fpCpuPartyBusPortStatsOutCOS4Pkts, fpFlowControlDrops=fpFlowControlDrops, fpRxPktCOS0=fpRxPktCOS0, fpStatsPgSharedCells=fpStatsPgSharedCells, fpStatsPerCOSTable=fpStatsPerCOSTable, fpIfIngressDrops=fpIfIngressDrops, fpIngPgBuffSnapshotIfTable=fpIngPgBuffSnapshotIfTable, fpCpuPartyBusPortStatsInSymbolErrors=fpCpuPartyBusPortStatsInSymbolErrors, fpIfEgTxErrPktCounter=fpIfEgTxErrPktCounter, fpStatsPerPgIfTable=fpStatsPerPgIfTable, fpIngIPv4L3Discards=fpIngIPv4L3Discards, fpCpuPartyBusPortStatsInOctets=fpCpuPartyBusPortStatsInOctets, fpStatsPgCounterMinCells=fpStatsPgCounterMinCells, pfcPerPrioTable=pfcPerPrioTable, fpStackPortIndex=fpStackPortIndex, fpStatsPerCOSEntry=fpStatsPerCOSEntry, fpPortPipe=fpPortPipe, fpEgL2MCDrops=fpEgL2MCDrops, fpStackUnitIndex=fpStackUnitIndex, fpNoMhdr=fpNoMhdr, fpNoMBuf=fpNoMBuf, fpStatsPerPgIfEntry=fpStatsPerPgIfEntry, pfcPerPrioIfEntry=pfcPerPrioIfEntry, fpRecvd=fpRecvd, fpCpuPartyBusPortStatsInUndersizePkts=fpCpuPartyBusPortStatsInUndersizePkts, fpIfMaxLimitPerCOS=fpIfMaxLimitPerCOS, fpIngHeadroomCells=fpIngHeadroomCells, fpIfStatsPgCounterSharedCells=fpIfStatsPgCounterSharedCells, fpTxPktCOS0=fpTxPktCOS0, ComType=ComType, fpCpuPartyBusPortStatsOutPausePkts=fpCpuPartyBusPortStatsOutPausePkts, fpStatsPerPgTable=fpStatsPerPgTable, fpHOLDropsPerCOS=fpHOLDropsPerCOS, fpDefaultPacketBuffAllocPerCOS=fpDefaultPacketBuffAllocPerCOS, fpPartyBusInputError=fpPartyBusInputError, fpEgrQIfCounterEntry=fpEgrQIfCounterEntry, fpCpuDataPlaneStatsEntry=fpCpuDataPlaneStatsEntry, fpEgrQBuffSnapshotIfEntry=fpEgrQBuffSnapshotIfEntry, fpIfMaxLimitPerPort=fpIfMaxLimitPerPort, pfcPerPrioIfTable=pfcPerPrioIfTable, fpCpuPartyBusPortStatsOutOctets=fpCpuPartyBusPortStatsOutOctets, fpCpuPartyBusPortStatsOutMultiCollisions=fpCpuPartyBusPortStatsOutMultiCollisions, fpIfHOLDropsPerCOS=fpIfHOLDropsPerCOS, fpNoTxDesc=fpNoTxDesc, fpRxPktUnit2=fpRxPktUnit2, fpIfStatsPgLimitMinCells=fpIfStatsPgLimitMinCells, fpDropsTable=fpDropsTable, prioIndex=prioIndex, fpTxPktUnit1=fpTxPktUnit1, fpCpuPartyBusPortStatsOutCOS1Pkts=fpCpuPartyBusPortStatsOutCOS1Pkts, fpCpuPartyBusPortStatsInJabbers=fpCpuPartyBusPortStatsInJabbers, fpIfIngSharedCells=fpIfIngSharedCells, fpDropsIfTable=fpDropsIfTable, fpIfEgInvalidVLANCounterDrops=fpIfEgInvalidVLANCounterDrops, fpTxPktCOS=fpTxPktCOS, fpCpuPartyBusPortStatsOutUnicastPkts=fpCpuPartyBusPortStatsOutUnicastPkts, fpEgrQDroppedPackets=fpEgrQDroppedPackets, fpIfIngIPv4L3Discards=fpIfIngIPv4L3Discards, fpCpuPartyBusPortStatsOutExcessCollisions=fpCpuPartyBusPortStatsOutExcessCollisions, fpCpuPartyBusPortStatsIn65To127OctetPkts=fpCpuPartyBusPortStatsIn65To127OctetPkts, fpIfCurrentUsagePerCOS=fpIfCurrentUsagePerCOS, fpCpuPartyBusPortStatsInFcsErrors=fpCpuPartyBusPortStatsInFcsErrors, fpCpuPartyBusPortStatsEntry=fpCpuPartyBusPortStatsEntry, fpMMUTxPurgeCellErr=fpMMUTxPurgeCellErr, fpCpuPartyBusPortStatsInUnicastPkts=fpCpuPartyBusPortStatsInUnicastPkts, fpStatsPerIfTable=fpStatsPerIfTable, fpMMUAgedDrops=fpMMUAgedDrops, fpEgrQBuffSnapshotEntry=fpEgrQBuffSnapshotEntry, fpTxPktUnit0=fpTxPktUnit0, fpMMUHOLDrops=fpMMUHOLDrops, fpCpuPartyBusPortStatsOutCOS0Pkts=fpCpuPartyBusPortStatsOutCOS0Pkts, pfcPerPrioEntry=pfcPerPrioEntry, fpRxPktCOS1=fpRxPktCOS1, fpCpuPartyBusPortStatsInPausePkts=fpCpuPartyBusPortStatsInPausePkts, fpEgIPv4L3UCAgedDrops=fpEgIPv4L3UCAgedDrops, fpCurrentUsagePerCOS=fpCurrentUsagePerCOS, fpEgrQIfCounterTable=fpEgrQIfCounterTable, fpRecvToNet=fpRecvToNet, fpDropped=fpDropped, fpCurrentAvailBuffer=fpCurrentAvailBuffer, fpTxReqTooLarge=fpTxReqTooLarge, fpIngSharedCells=fpIngSharedCells, fpIfMMUHOLDrops=fpIfMMUHOLDrops, fpIfEgIPv4L3UCAgedDrops=fpIfEgIPv4L3UCAgedDrops, fpEgTxErrPktCounter=fpEgTxErrPktCounter, fpPartyBusInputDropped=fpPartyBusInputDropped, fpPerPortPGIndex=fpPerPortPGIndex, PYSNMP_MODULE_ID=f10FpStatsMib, fpEgrQDroppedBytes=fpEgrQDroppedBytes, fpEgHgMacUnderFlow=fpEgHgMacUnderFlow, fpCpuPartyBusPortStatsOutCollisions=fpCpuPartyBusPortStatsOutCollisions, fpCpuPartyBusPortStatsInFragments=fpCpuPartyBusPortStatsInFragments, fpCpuPartyBusTable=fpCpuPartyBusTable, fpCpuPartyBusPortStatsInGoodOctets=fpCpuPartyBusPortStatsInGoodOctets, fpStatsPgHdrmCells=fpStatsPgHdrmCells, fpCpuPartyBusPortStatsOutMulticastPkts=fpCpuPartyBusPortStatsOutMulticastPkts, fpIngressFCSDrops=fpIngressFCSDrops, fpTxPktUnit2=fpTxPktUnit2, fpCOSIndex=fpCOSIndex, fpEgrQTotBuffCells=fpEgrQTotBuffCells, fpStatsPgLimitMinCells=fpStatsPgLimitMinCells, fpTxRequested=fpTxRequested, fpIfStatsPgSharedCells=fpIfStatsPgSharedCells, fpRxPktCOS5=fpRxPktCOS5, fpTxError=fpTxError, fpRxError=fpRxError, fpPerPortCOSNumber=fpPerPortCOSNumber, fpNoClus=fpNoClus, fpStatsPerIfCOSTable=fpStatsPerIfCOSTable, fpCpuPartyBusPortStatsIn128To255OctetPkts=fpCpuPartyBusPortStatsIn128To255OctetPkts)
