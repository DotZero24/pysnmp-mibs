...
# Notes
# -----
# ASN.1 source file://mibs/edgecore/ES4612-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:53:38 2025
...
portVlanTrunkingEntry = _PortVlanTrunkingEntry_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 2, 7, 1)
)
portVlanTrunkingEntry.setIndexNames(
    (0, "ES4612-MIB", "portVlanTrunkingIfIndex"),
)
if mibBuilder.loadTexts:
...
portVlanTrunkingIfIndex = _PortVlanTrunkingIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 2, 7, 1, 1),
...
portVlanTrunkingStatus = _PortVlanTrunkingStatus_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 2, 7, 1, 2),
...
radiusMultipleServerTable = _RadiusMultipleServerTable_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 17, 4, 7)
)
if mibBuilder.loadTexts:
...
radiusMultipleServerEntry = _RadiusMultipleServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 17, 4, 7, 1)
)
radiusMultipleServerEntry.setIndexNames(
    (0, "ES4612-MIB", "radiusMultipleServerIndex"),
)
if mibBuilder.loadTexts:
...
radiusMultipleServerIndex = _RadiusMultipleServerIndex_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 17, 4, 7, 1, 1),
...
radiusMultipleServerAddress = _RadiusMultipleServerAddress_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 17, 4, 7, 1, 2),
...
radiusMultipleServerPortNumber = _RadiusMultipleServerPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 17, 4, 7, 1, 3),
...
radiusMultipleServerKey = _RadiusMultipleServerKey_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 17, 4, 7, 1, 4),
...
radiusMultipleServerRetransmit = _RadiusMultipleServerRetransmit_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 17, 4, 7, 1, 5),
...
radiusMultipleServerTimeout = _RadiusMultipleServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 17, 4, 7, 1, 6),
...
radiusMultipleServerStatus = _RadiusMultipleServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 259, 6, 10, 57, 1, 17, 4, 7, 1, 8),
