...
fileTransferManagement=_FileTransferManagement_ObjectIdentity((1,3,6,1,4,1,52642,9,185,1))
if mibBuilder.loadTexts:fileTransferManagement.setStatus(_A)
_FileTransferTable_Object=MibTable
fileTransferTable=_FileTransferTable_Object((1,3,6,1,4,1,52642,9,185,1,1))
if mibBuilder.loadTexts:fileTransferTable.setStatus(_A)
_FileTransferEntry_Object=MibTableRow
fileTransferEntry=_FileTransferEntry_Object((1,3,6,1,4,1,52642,9,185,1,1,1))
...
fileTransferIndex=_FileTransferIndex_Object((1,3,6,1,4,1,52642,9,185,1,1,1,1),_FileTransferIndex_Type())
...
fileTransferProtocolType=_FileTransferProtocolType_Object((1,3,6,1,4,1,52642,9,185,1,1,1,2),_FileTransferProtocolType_Type())
...
serverIpAddress=_ServerIpAddress_Object((1,3,6,1,4,1,52642,9,185,1,1,1,3),_ServerIpAddress_Type())
...
ftpUserName=_FtpUserName_Object((1,3,6,1,4,1,52642,9,185,1,1,1,4),_FtpUserName_Type())
...
ftpUserPassword=_FtpUserPassword_Object((1,3,6,1,4,1,52642,9,185,1,1,1,5),_FtpUserPassword_Type())
...
transferFileSrcNamePath=_TransferFileSrcNamePath_Object((1,3,6,1,4,1,52642,9,185,1,1,1,6),_TransferFileSrcNamePath_Type())
...
transferFileDstNamePath=_TransferFileDstNamePath_Object((1,3,6,1,4,1,52642,9,185,1,1,1,7),_TransferFileDstNamePath_Type())
...
transferAction=_TransferAction_Object((1,3,6,1,4,1,52642,9,185,1,1,1,8),_TransferAction_Type())
...
transferStatus=_TransferStatus_Object((1,3,6,1,4,1,52642,9,185,1,1,1,9),_TransferStatus_Type())
...
fileInfoManagementTable=_FileInfoManagementTable_Object((1,3,6,1,4,1,52642,9,185,1,2))
if mibBuilder.loadTexts:fileInfoManagementTable.setStatus(_A)
_FileInfoManagementEntry_Object=MibTableRow
fileInfoManagementEntry=_FileInfoManagementEntry_Object((1,3,6,1,4,1,52642,9,185,1,2,1))
...
filePath=_FilePath_Object((1,3,6,1,4,1,52642,9,185,1,2,1,1),_FilePath_Type())
...
fileName=_FileName_Object((1,3,6,1,4,1,52642,9,185,1,2,1,2),_FileName_Type())
...
fileSize=_FileSize_Object((1,3,6,1,4,1,52642,9,185,1,2,1,3),_FileSize_Type())
...
fileModifyTime=_FileModifyTime_Object((1,3,6,1,4,1,52642,9,185,1,2,1,4),_FileModifyTime_Type())
...
fileManagementAction=_FileManagementAction_Object((1,3,6,1,4,1,52642,9,185,1,2,1,5),_FileManagementAction_Type())
...
fileAttribute=_FileAttribute_Object((1,3,6,1,4,1,52642,9,185,1,2,1,6),_FileAttribute_Type())
