# SNMP MIB module (FS-NMS-FILE-MGMT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/fscom/FS-NMS-FILE-MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:12:40 2025
...
fileTransferIndex = _FileTransferIndex_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 1, 1, 1),
...
fileTransferProtocolType = _FileTransferProtocolType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 1, 1, 2),
...
serverIpAddress = _ServerIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 1, 1, 3),
...
ftpUserName = _FtpUserName_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 1, 1, 4),
    _FtpUserName_Type()
)
...
ftpUserPassword = _FtpUserPassword_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 1, 1, 5),
...
transferFileSrcNamePath = _TransferFileSrcNamePath_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 1, 1, 6),
...
transferFileDstNamePath = _TransferFileDstNamePath_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 1, 1, 7),
...
transferAction = _TransferAction_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 1, 1, 8),
...
transferStatus = _TransferStatus_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 1, 1, 9),
...
fileInfoManagementEntry = _FileInfoManagementEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 2, 1)
)
fileInfoManagementEntry.setIndexNames(
    (0, "FS-NMS-FILE-MGMT-MIB", "filePath"),
    (0, "FS-NMS-FILE-MGMT-MIB", "fileName"),
)
if mibBuilder.loadTexts:
...
filePath = _FilePath_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 2, 1, 1),
    _FilePath_Type()
)
...
fileSize = _FileSize_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 2, 1, 3),
    _FileSize_Type()
)
...
fileModifyTime = _FileModifyTime_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 2, 1, 4),
...
fileManagementAction = _FileManagementAction_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 2, 1, 5),
...
fileAttribute = _FileAttribute_Object(
    (1, 3, 6, 1, 4, 1, 52642, 9, 185, 1, 2, 1, 6),
    _FileAttribute_Type()
)
