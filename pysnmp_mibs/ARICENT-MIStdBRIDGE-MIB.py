...
fsDot1dBridge=ModuleIdentity((1,3,6,1,4,1,2076,116))
...
fsDot1dNotifications=_FsDot1dNotifications_ObjectIdentity((1,3,6,1,4,1,2076,116,0))
_FsDot1dBase_ObjectIdentity=ObjectIdentity
fsDot1dBase=_FsDot1dBase_ObjectIdentity((1,3,6,1,4,1,2076,116,1))
_FsDot1dBaseTable_Object=MibTable
fsDot1dBaseTable=_FsDot1dBaseTable_Object((1,3,6,1,4,1,2076,116,1,1))
if mibBuilder.loadTexts:fsDot1dBaseTable.setStatus(_A)
_FsDot1dBaseEntry_Object=MibTableRow
fsDot1dBaseEntry=_FsDot1dBaseEntry_Object((1,3,6,1,4,1,2076,116,1,1,1))
...
fsDot1dBaseContextId=_FsDot1dBaseContextId_Object((1,3,6,1,4,1,2076,116,1,1,1,1),_FsDot1dBaseContextId_Type())
...
fsDot1dBaseBridgeAddress=_FsDot1dBaseBridgeAddress_Object((1,3,6,1,4,1,2076,116,1,1,1,2),_FsDot1dBaseBridgeAddress_Type())
...
fsDot1dBaseNumPorts=_FsDot1dBaseNumPorts_Object((1,3,6,1,4,1,2076,116,1,1,1,3),_FsDot1dBaseNumPorts_Type())
...
fsDot1dBaseType=_FsDot1dBaseType_Object((1,3,6,1,4,1,2076,116,1,1,1,4),_FsDot1dBaseType_Type())
fsDot1dBaseType.setMaxAccess(_B)
if mibBuilder.loadTexts:fsDot1dBaseType.setStatus(_A)
_FsDot1dBasePortTable_Object=MibTable
fsDot1dBasePortTable=_FsDot1dBasePortTable_Object((1,3,6,1,4,1,2076,116,1,2))
if mibBuilder.loadTexts:fsDot1dBasePortTable.setStatus(_A)
_FsDot1dBasePortEntry_Object=MibTableRow
fsDot1dBasePortEntry=_FsDot1dBasePortEntry_Object((1,3,6,1,4,1,2076,116,1,2,1))
...
fsDot1dBasePort=_FsDot1dBasePort_Object((1,3,6,1,4,1,2076,116,1,2,1,1),_FsDot1dBasePort_Type())
...
fsDot1dBasePortIfIndex=_FsDot1dBasePortIfIndex_Object((1,3,6,1,4,1,2076,116,1,2,1,2),_FsDot1dBasePortIfIndex_Type())
...
fsDot1dBasePortCircuit=_FsDot1dBasePortCircuit_Object((1,3,6,1,4,1,2076,116,1,2,1,3),_FsDot1dBasePortCircuit_Type())
...
fsDot1dBasePortDelayExceededDiscards=_FsDot1dBasePortDelayExceededDiscards_Object((1,3,6,1,4,1,2076,116,1,2,1,4),_FsDot1dBasePortDelayExceededDiscards_Type())
...
fsDot1dBasePortMtuExceededDiscards=_FsDot1dBasePortMtuExceededDiscards_Object((1,3,6,1,4,1,2076,116,1,2,1,5),_FsDot1dBasePortMtuExceededDiscards_Type())
...
fsDot1dStp=_FsDot1dStp_ObjectIdentity((1,3,6,1,4,1,2076,116,2))
_FsDot1dStpTable_Object=MibTable
fsDot1dStpTable=_FsDot1dStpTable_Object((1,3,6,1,4,1,2076,116,2,1))
if mibBuilder.loadTexts:fsDot1dStpTable.setStatus(_A)
_FsDot1dStpEntry_Object=MibTableRow
fsDot1dStpEntry=_FsDot1dStpEntry_Object((1,3,6,1,4,1,2076,116,2,1,1))
...
fsDot1dStpContextId=_FsDot1dStpContextId_Object((1,3,6,1,4,1,2076,116,2,1,1,1),_FsDot1dStpContextId_Type())
...
fsDot1dStpProtocolSpecification=_FsDot1dStpProtocolSpecification_Object((1,3,6,1,4,1,2076,116,2,1,1,2),_FsDot1dStpProtocolSpecification_Type())
...
fsDot1dStpPriority=_FsDot1dStpPriority_Object((1,3,6,1,4,1,2076,116,2,1,1,3),_FsDot1dStpPriority_Type())
...
fsDot1dStpTimeSinceTopologyChange=_FsDot1dStpTimeSinceTopologyChange_Object((1,3,6,1,4,1,2076,116,2,1,1,4),_FsDot1dStpTimeSinceTopologyChange_Type())
...
fsDot1dStpTopChanges=_FsDot1dStpTopChanges_Object((1,3,6,1,4,1,2076,116,2,1,1,5),_FsDot1dStpTopChanges_Type())
...
fsDot1dStpDesignatedRoot=_FsDot1dStpDesignatedRoot_Object((1,3,6,1,4,1,2076,116,2,1,1,6),_FsDot1dStpDesignatedRoot_Type())
...
fsDot1dStpRootCost=_FsDot1dStpRootCost_Object((1,3,6,1,4,1,2076,116,2,1,1,7),_FsDot1dStpRootCost_Type())
...
fsDot1dStpRootPort=_FsDot1dStpRootPort_Object((1,3,6,1,4,1,2076,116,2,1,1,8),_FsDot1dStpRootPort_Type())
...
fsDot1dStpMaxAge=_FsDot1dStpMaxAge_Object((1,3,6,1,4,1,2076,116,2,1,1,9),_FsDot1dStpMaxAge_Type())
...
fsDot1dStpHelloTime=_FsDot1dStpHelloTime_Object((1,3,6,1,4,1,2076,116,2,1,1,10),_FsDot1dStpHelloTime_Type())
...
fsDot1dStpHoldTime=_FsDot1dStpHoldTime_Object((1,3,6,1,4,1,2076,116,2,1,1,11),_FsDot1dStpHoldTime_Type())
...
fsDot1dStpForwardDelay=_FsDot1dStpForwardDelay_Object((1,3,6,1,4,1,2076,116,2,1,1,12),_FsDot1dStpForwardDelay_Type())
...
fsDot1dStpBridgeMaxAge=_FsDot1dStpBridgeMaxAge_Object((1,3,6,1,4,1,2076,116,2,1,1,13),_FsDot1dStpBridgeMaxAge_Type())
...
fsDot1dStpBridgeHelloTime=_FsDot1dStpBridgeHelloTime_Object((1,3,6,1,4,1,2076,116,2,1,1,14),_FsDot1dStpBridgeHelloTime_Type())
...
fsDot1dStpBridgeForwardDelay=_FsDot1dStpBridgeForwardDelay_Object((1,3,6,1,4,1,2076,116,2,1,1,15),_FsDot1dStpBridgeForwardDelay_Type())
...
fsDot1dStpPortTable=_FsDot1dStpPortTable_Object((1,3,6,1,4,1,2076,116,2,2))
if mibBuilder.loadTexts:fsDot1dStpPortTable.setStatus(_A)
_FsDot1dStpPortEntry_Object=MibTableRow
fsDot1dStpPortEntry=_FsDot1dStpPortEntry_Object((1,3,6,1,4,1,2076,116,2,2,1))
...
fsDot1dStpPort=_FsDot1dStpPort_Object((1,3,6,1,4,1,2076,116,2,2,1,1),_FsDot1dStpPort_Type())
...
fsDot1dStpPortPriority=_FsDot1dStpPortPriority_Object((1,3,6,1,4,1,2076,116,2,2,1,2),_FsDot1dStpPortPriority_Type())
...
fsDot1dStpPortState=_FsDot1dStpPortState_Object((1,3,6,1,4,1,2076,116,2,2,1,3),_FsDot1dStpPortState_Type())
...
fsDot1dStpPortEnable=_FsDot1dStpPortEnable_Object((1,3,6,1,4,1,2076,116,2,2,1,4),_FsDot1dStpPortEnable_Type())
...
fsDot1dStpPortPathCost=_FsDot1dStpPortPathCost_Object((1,3,6,1,4,1,2076,116,2,2,1,5),_FsDot1dStpPortPathCost_Type())
...
fsDot1dStpPortDesignatedRoot=_FsDot1dStpPortDesignatedRoot_Object((1,3,6,1,4,1,2076,116,2,2,1,6),_FsDot1dStpPortDesignatedRoot_Type())
...
fsDot1dStpPortDesignatedCost=_FsDot1dStpPortDesignatedCost_Object((1,3,6,1,4,1,2076,116,2,2,1,7),_FsDot1dStpPortDesignatedCost_Type())
...
fsDot1dStpPortDesignatedBridge=_FsDot1dStpPortDesignatedBridge_Object((1,3,6,1,4,1,2076,116,2,2,1,8),_FsDot1dStpPortDesignatedBridge_Type())
...
fsDot1dStpPortDesignatedPort=_FsDot1dStpPortDesignatedPort_Object((1,3,6,1,4,1,2076,116,2,2,1,9),_FsDot1dStpPortDesignatedPort_Type())
...
fsDot1dStpPortForwardTransitions=_FsDot1dStpPortForwardTransitions_Object((1,3,6,1,4,1,2076,116,2,2,1,10),_FsDot1dStpPortForwardTransitions_Type())
...
fsDot1dStpPortPathCost32=_FsDot1dStpPortPathCost32_Object((1,3,6,1,4,1,2076,116,2,2,1,11),_FsDot1dStpPortPathCost32_Type())
...
fsDot1dSr=_FsDot1dSr_ObjectIdentity((1,3,6,1,4,1,2076,116,3))
_FsDot1dTp_ObjectIdentity=ObjectIdentity
fsDot1dTp=_FsDot1dTp_ObjectIdentity((1,3,6,1,4,1,2076,116,4))
_FsDot1dTpTable_Object=MibTable
fsDot1dTpTable=_FsDot1dTpTable_Object((1,3,6,1,4,1,2076,116,4,1))
if mibBuilder.loadTexts:fsDot1dTpTable.setStatus(_A)
_FsDot1dTpEntry_Object=MibTableRow
fsDot1dTpEntry=_FsDot1dTpEntry_Object((1,3,6,1,4,1,2076,116,4,1,1))
...
fsDot1dTpLearnedEntryDiscards=_FsDot1dTpLearnedEntryDiscards_Object((1,3,6,1,4,1,2076,116,4,1,1,1),_FsDot1dTpLearnedEntryDiscards_Type())
...
fsDot1dTpAgingTime=_FsDot1dTpAgingTime_Object((1,3,6,1,4,1,2076,116,4,1,1,2),_FsDot1dTpAgingTime_Type())
...
fsDot1dTpFdbTable=_FsDot1dTpFdbTable_Object((1,3,6,1,4,1,2076,116,4,2))
if mibBuilder.loadTexts:fsDot1dTpFdbTable.setStatus(_A)
_FsDot1dTpFdbEntry_Object=MibTableRow
fsDot1dTpFdbEntry=_FsDot1dTpFdbEntry_Object((1,3,6,1,4,1,2076,116,4,2,1))
...
fsDot1dTpFdbAddress=_FsDot1dTpFdbAddress_Object((1,3,6,1,4,1,2076,116,4,2,1,1),_FsDot1dTpFdbAddress_Type())
...
fsDot1dTpFdbPort=_FsDot1dTpFdbPort_Object((1,3,6,1,4,1,2076,116,4,2,1,2),_FsDot1dTpFdbPort_Type())
...
fsDot1dTpFdbStatus=_FsDot1dTpFdbStatus_Object((1,3,6,1,4,1,2076,116,4,2,1,3),_FsDot1dTpFdbStatus_Type())
...
fsDot1dTpPortTable=_FsDot1dTpPortTable_Object((1,3,6,1,4,1,2076,116,4,3))
if mibBuilder.loadTexts:fsDot1dTpPortTable.setStatus(_A)
_FsDot1dTpPortEntry_Object=MibTableRow
fsDot1dTpPortEntry=_FsDot1dTpPortEntry_Object((1,3,6,1,4,1,2076,116,4,3,1))
...
fsDot1dTpPort=_FsDot1dTpPort_Object((1,3,6,1,4,1,2076,116,4,3,1,1),_FsDot1dTpPort_Type())
...
fsDot1dTpPortMaxInfo=_FsDot1dTpPortMaxInfo_Object((1,3,6,1,4,1,2076,116,4,3,1,2),_FsDot1dTpPortMaxInfo_Type())
...
fsDot1dTpPortInFrames=_FsDot1dTpPortInFrames_Object((1,3,6,1,4,1,2076,116,4,3,1,3),_FsDot1dTpPortInFrames_Type())
...
fsDot1dTpPortOutFrames=_FsDot1dTpPortOutFrames_Object((1,3,6,1,4,1,2076,116,4,3,1,4),_FsDot1dTpPortOutFrames_Type())
...
fsDot1dTpPortInDiscards=_FsDot1dTpPortInDiscards_Object((1,3,6,1,4,1,2076,116,4,3,1,5),_FsDot1dTpPortInDiscards_Type())
...
fsDot1dStatic=_FsDot1dStatic_ObjectIdentity((1,3,6,1,4,1,2076,116,5))
_FsDot1dStaticTable_Object=MibTable
fsDot1dStaticTable=_FsDot1dStaticTable_Object((1,3,6,1,4,1,2076,116,5,1))
if mibBuilder.loadTexts:fsDot1dStaticTable.setStatus(_A)
_FsDot1dStaticEntry_Object=MibTableRow
fsDot1dStaticEntry=_FsDot1dStaticEntry_Object((1,3,6,1,4,1,2076,116,5,1,1))
...
fsDot1dStaticAddress=_FsDot1dStaticAddress_Object((1,3,6,1,4,1,2076,116,5,1,1,1),_FsDot1dStaticAddress_Type())
...
fsDot1dStaticReceivePort=_FsDot1dStaticReceivePort_Object((1,3,6,1,4,1,2076,116,5,1,1,2),_FsDot1dStaticReceivePort_Type())
...
fsDot1dStaticRowStatus=_FsDot1dStaticRowStatus_Object((1,3,6,1,4,1,2076,116,5,1,1,3),_FsDot1dStaticRowStatus_Type())
...
fsDot1dStaticStatus=_FsDot1dStaticStatus_Object((1,3,6,1,4,1,2076,116,5,1,1,4),_FsDot1dStaticStatus_Type())
...
fsDot1dStaticAllowedToGoTable=_FsDot1dStaticAllowedToGoTable_Object((1,3,6,1,4,1,2076,116,5,2))
if mibBuilder.loadTexts:fsDot1dStaticAllowedToGoTable.setStatus(_A)
_FsDot1dStaticAllowedToGoEntry_Object=MibTableRow
fsDot1dStaticAllowedToGoEntry=_FsDot1dStaticAllowedToGoEntry_Object((1,3,6,1,4,1,2076,116,5,2,1))
...
fsDot1dStaticAllowedIsMember=_FsDot1dStaticAllowedIsMember_Object((1,3,6,1,4,1,2076,116,5,2,1,1),_FsDot1dStaticAllowedIsMember_Type())
fsDot1dStaticAllowedIsMember.setMaxAccess(_E)
if mibBuilder.loadTexts:fsDot1dStaticAllowedIsMember.setStatus(_A)
newRoot=NotificationType((1,3,6,1,4,1,2076,116,0,1))
if mibBuilder.loadTexts:newRoot.setStatus(_A)
topologyChange=NotificationType((1,3,6,1,4,1,2076,116,0,2))
