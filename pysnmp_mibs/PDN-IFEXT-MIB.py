...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-IFEXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:01:20 2025
...
if mibBuilder.loadTexts:
    pdnIfTable.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    pdnIfEntry.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    pdnIfAddr.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    pdnIfAddrMask.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    pdnIfStatus.setStatus("deprecated")
