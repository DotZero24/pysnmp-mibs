...
h3cVoiceGeneralObjects=_H3cVoiceGeneralObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,1,1))
...
h3cVoGeneralJitterLen=_H3cVoGeneralJitterLen_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,1),_H3cVoGeneralJitterLen_Type())
...
h3cVoGeneralMatchPolicy=_H3cVoGeneralMatchPolicy_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,2),_H3cVoGeneralMatchPolicy_Type())
...
h3cVoGeneralDataStatistics=_H3cVoGeneralDataStatistics_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,5),_H3cVoGeneralDataStatistics_Type())
...
h3cVoGeneralDialTerminator=_H3cVoGeneralDialTerminator_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,7),_H3cVoGeneralDialTerminator_Type())
...
h3cVoGeneralCallStart=_H3cVoGeneralCallStart_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,8),_H3cVoGeneralCallStart_Type())
...
h3cVoGeneralCalledTunnel=_H3cVoGeneralCalledTunnel_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,9),_H3cVoGeneralCalledTunnel_Type())
...
h3cVoGeneralSpecialService=_H3cVoGeneralSpecialService_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,10),_H3cVoGeneralSpecialService_Type())
...
h3cVoGeneralPeerSearchStop=_H3cVoGeneralPeerSearchStop_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,12),_H3cVoGeneralPeerSearchStop_Type())
...
h3cVoGeneralPeerSelectOrderRule=_H3cVoGeneralPeerSelectOrderRule_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,13),_H3cVoGeneralPeerSelectOrderRule_Type())
...
h3cVoGeneralPeerSelectTypePriority=_H3cVoGeneralPeerSelectTypePriority_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,14),_H3cVoGeneralPeerSelectTypePriority_Type())
...
h3cVoGeneralDscpSignal=_H3cVoGeneralDscpSignal_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,15),_H3cVoGeneralDscpSignal_Type())
...
h3cVoGeneralDscpMedia=_H3cVoGeneralDscpMedia_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,1,16),_H3cVoGeneralDscpMedia_Type())
...
h3cVoiceNumberSubstGroup=_H3cVoiceNumberSubstGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,1,4))
_H3cVoNumSubstTable_Object=MibTable
h3cVoNumSubstTable=_H3cVoNumSubstTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,1))
if mibBuilder.loadTexts:h3cVoNumSubstTable.setStatus(_A)
_H3cVoNumSubstEntry_Object=MibTableRow
h3cVoNumSubstEntry=_H3cVoNumSubstEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,1,1))
...
h3cVoNumSubstIndex=_H3cVoNumSubstIndex_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,1,1,1),_H3cVoNumSubstIndex_Type())
...
h3cVoNumSubstFirstRule=_H3cVoNumSubstFirstRule_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,1,1,2),_H3cVoNumSubstFirstRule_Type())
...
h3cVoNumSubstDotMatchRule=_H3cVoNumSubstDotMatchRule_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,1,1,3),_H3cVoNumSubstDotMatchRule_Type())
...
h3cVoNumSubstRowStatus=_H3cVoNumSubstRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,1,1,4),_H3cVoNumSubstRowStatus_Type())
...
h3cVoNumSubstRuleTable=_H3cVoNumSubstRuleTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,2))
if mibBuilder.loadTexts:h3cVoNumSubstRuleTable.setStatus(_A)
_H3cVoNumSubstRuleEntry_Object=MibTableRow
h3cVoNumSubstRuleEntry=_H3cVoNumSubstRuleEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,2,1))
...
h3cVoNumSubstRuleIndex=_H3cVoNumSubstRuleIndex_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,2,1,1),_H3cVoNumSubstRuleIndex_Type())
...
h3cVoNumSubstRuleInputFormat=_H3cVoNumSubstRuleInputFormat_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,2,1,2),_H3cVoNumSubstRuleInputFormat_Type())
...
h3cVoNumSubstRuleOutputFormat=_H3cVoNumSubstRuleOutputFormat_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,2,1,3),_H3cVoNumSubstRuleOutputFormat_Type())
...
h3cVoNumSubstRuleRowStatus=_H3cVoNumSubstRuleRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,4,2,1,4),_H3cVoNumSubstRuleRowStatus_Type())
...
h3cVoMaxCallTable=_H3cVoMaxCallTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,5))
if mibBuilder.loadTexts:h3cVoMaxCallTable.setStatus(_A)
_H3cVoMaxCallEntry_Object=MibTableRow
h3cVoMaxCallEntry=_H3cVoMaxCallEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,5,1))
...
h3cVoMaxCallTableIndex=_H3cVoMaxCallTableIndex_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,5,1,1),_H3cVoMaxCallTableIndex_Type())
...
h3cVoMaxCallValue=_H3cVoMaxCallValue_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,5,1,2),_H3cVoMaxCallValue_Type())
...
h3cVoMaxCallTableRowStatus=_H3cVoMaxCallTableRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,5,1,3),_H3cVoMaxCallTableRowStatus_Type())
...
h3cVoInCallingNumSubstTable=_H3cVoInCallingNumSubstTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,6))
if mibBuilder.loadTexts:h3cVoInCallingNumSubstTable.setStatus(_A)
_H3cVoInCallingNumSubstEntry_Object=MibTableRow
h3cVoInCallingNumSubstEntry=_H3cVoInCallingNumSubstEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,6,1))
...
h3cVoInCallingNumSubstIndex=_H3cVoInCallingNumSubstIndex_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,6,1,1),_H3cVoInCallingNumSubstIndex_Type())
...
h3cVoInCallingSubstRowStatus=_H3cVoInCallingSubstRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,6,1,2),_H3cVoInCallingSubstRowStatus_Type())
...
h3cVoInCalledNumSubstTable=_H3cVoInCalledNumSubstTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,7))
if mibBuilder.loadTexts:h3cVoInCalledNumSubstTable.setStatus(_A)
_H3cVoInCalledNumSubstEntry_Object=MibTableRow
h3cVoInCalledNumSubstEntry=_H3cVoInCalledNumSubstEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,7,1))
...
h3cVoInCalledNumSubstIndex=_H3cVoInCalledNumSubstIndex_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,7,1,1),_H3cVoInCalledNumSubstIndex_Type())
...
h3cVoInCalledSubstRowStatus=_H3cVoInCalledSubstRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,7,1,2),_H3cVoInCalledSubstRowStatus_Type())
...
h3cVoOutCallingNumSubstTable=_H3cVoOutCallingNumSubstTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,8))
if mibBuilder.loadTexts:h3cVoOutCallingNumSubstTable.setStatus(_A)
_H3cVoOutCallingNumSubstEntry_Object=MibTableRow
h3cVoOutCallingNumSubstEntry=_H3cVoOutCallingNumSubstEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,8,1))
...
h3cVoOutCallingNumSubstIndex=_H3cVoOutCallingNumSubstIndex_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,8,1,1),_H3cVoOutCallingNumSubstIndex_Type())
...
h3cVoOutCallingSubstRowStatus=_H3cVoOutCallingSubstRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,8,1,2),_H3cVoOutCallingSubstRowStatus_Type())
...
h3cVoOutCalledNumSubstTable=_H3cVoOutCalledNumSubstTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,9))
if mibBuilder.loadTexts:h3cVoOutCalledNumSubstTable.setStatus(_A)
_H3cVoOutgoingCalledNumSubstEntry_Object=MibTableRow
h3cVoOutgoingCalledNumSubstEntry=_H3cVoOutgoingCalledNumSubstEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,9,1))
...
h3cVoOutCalledNumSubstIndex=_H3cVoOutCalledNumSubstIndex_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,9,1,1),_H3cVoOutCalledNumSubstIndex_Type())
...
h3cVoOutCalledSubstRowStatus=_H3cVoOutCalledSubstRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,1,9,1,2),_H3cVoOutCalledSubstRowStatus_Type())
