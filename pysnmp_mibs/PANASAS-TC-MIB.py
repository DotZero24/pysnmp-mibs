...
mibBuilder.exportSymbols("PANASAS-TC-MIB", PanTemperature=PanTemperature, PanBoolean=PanBoolean, PanSerialNumber=PanSerialNumber, PanUtilization=PanUtilization)
