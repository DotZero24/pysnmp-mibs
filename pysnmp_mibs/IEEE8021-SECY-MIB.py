...
# Notes
# -----
# ASN.1 source file://mibs/rfc/IEEE8021-SECY-MIB
...
_SecyIfProtectFramesEnable_Type.__name__ = "TruthValue"
...
_SecyIfReplayProtectEnable_Type.__name__ = "TruthValue"
...
_SecyIfReplayProtectWindow_Type.__name__ = "Unsigned32"
...
_SecyIfIncludeSCIEnable_Type.__name__ = "TruthValue"
...
_SecyIfUseESEnable_Type.__name__ = "TruthValue"
...
_SecyIfUseSCBEnable_Type.__name__ = "TruthValue"
...
_SecyIfIncludingSCI_Type.__name__ = "TruthValue"
...
_SecyIfCipherImplemented_Type.__name__ = "TruthValue"
...
_SecyIfCipherEnableUse_Type.__name__ = "TruthValue"
...
_SecyIfCipherRqConfidentiality_Type.__name__ = "TruthValue"
...
secyMIBCompliance.setObjects(
      *(("IEEE8021-SECY-MIB", "secyIfCtrlGroup"),
        ("IEEE8021-SECY-MIB", "secyTxSCGroup"),
        ("IEEE8021-SECY-MIB", "secyTxSAGroup"),
        ("IEEE8021-SECY-MIB", "secyRxSCGroup"),
        ("IEEE8021-SECY-MIB", "secyRxSAGroup"),
        ("IEEE8021-SECY-MIB", "secyCipherSuiteGroup"),
        ("IEEE8021-SECY-MIB", "secyTxSAStatsGroup"),
        ("IEEE8021-SECY-MIB", "secyTxSCStatsGroup"),
        ("IEEE8021-SECY-MIB", "secyRxSAStatsGroup"),
        ("IEEE8021-SECY-MIB", "secyRxSCStatsGroup"),
        ("IEEE8021-SECY-MIB", "secyStatsGroup"))
)
if mibBuilder.loadTexts:
...
secyMIBTcCompliance.setObjects(
      *(("IF-MIB", "ifCounterDiscontinuityGroup"),
        ("IEEE8021-SECY-MIB", "secyIfGroup"),
        ("IEEE8021-SECY-MIB", "secyIfCipherGroup"),
        ("IEEE8021-SECY-MIB", "secyIfTCGroup"),
        ("IEEE8021-SECY-MIB", "secyIfAPGroup"),
        ("IEEE8021-SECY-MIB", "secyTSCGroup"),
        ("IEEE8021-SECY-MIB", "secyTSAGroup"),
        ("IEEE8021-SECY-MIB", "secyRSCGroup"),
        ("IEEE8021-SECY-MIB", "secyRSAGroup"),
        ("IEEE8021-SECY-MIB", "secyCipherInfoGroup"),
        ("IEEE8021-SECY-MIB", "secyCipherStatsGroup"),
        ("IEEE8021-SECY-MIB", "secyTSCStatsGroup"),
        ("IEEE8021-SECY-MIB", "secyRSCStatsGroup"),
