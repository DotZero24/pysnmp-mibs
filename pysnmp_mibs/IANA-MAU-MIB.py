...
# Notes
# -----
# ASN.1 source file://mibs/rfc/IANA-MAU-MIB
...
dot3MauType2p5GigT = _Dot3MauType2p5GigT_ObjectIdentity(
    (1, 3, 6, 1, 2, 1, 26, 4, 103)
)
if mibBuilder.loadTexts:
    dot3MauType2p5GigT.setStatus("current")
_Dot3MauType5GigT_ObjectIdentity = ObjectIdentity
dot3MauType5GigT = _Dot3MauType5GigT_ObjectIdentity(
    (1, 3, 6, 1, 2, 1, 26, 4, 104)
)
if mibBuilder.loadTexts:
    dot3MauType5GigT.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"IANAifMauTypeListBits": IANAifMauTypeListBits,
       ...
       "dot3MauType2p5GigT": dot3MauType2p5GigT,
       "dot3MauType5GigT": dot3MauType5GigT,
