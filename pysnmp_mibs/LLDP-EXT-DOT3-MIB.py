...
# Notes
# -----
# ASN.1 source file://mibs/rfc/LLDP-EXT-DOT3-MIB
...
lldpXdot3Compliance.setObjects(
      *(("LLDP-EXT-DOT3-MIB", "lldpXdot3ConfigGroup"),
        ("LLDP-EXT-DOT3-MIB", "lldpXdot3LocSysGroup"),
        ("LLDP-EXT-DOT3-MIB", "lldpXdot3RemSysGroup"))
)
if mibBuilder.loadTexts:
