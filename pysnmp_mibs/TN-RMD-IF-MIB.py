...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TN-RMD-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:03:24 2025
...
tnRmdIfEvcLoopBack = _TnRmdIfEvcLoopBack_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 4, 1, 3, 8, 1, 3),
    _TnRmdIfEvcLoopBack_Type()
)
tnRmdIfEvcLoopBack.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tnRmdIfEvcLoopBack.setStatus("current")
_TnRmdIfEvcLoopBackVlanId_Type = VlanIdOrNone
_TnRmdIfEvcLoopBackVlanId_Object = MibTableColumn
tnRmdIfEvcLoopBackVlanId = _TnRmdIfEvcLoopBackVlanId_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 4, 1, 3, 8, 1, 4),
    _TnRmdIfEvcLoopBackVlanId_Type()
)
tnRmdIfEvcLoopBackVlanId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tnRmdIfEvcLoopBackVlanId.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"TnRmdIfOperationalState": TnRmdIfOperationalState,
       ...
       "tnRmdIfEvcLoopBack": tnRmdIfEvcLoopBack,
       "tnRmdIfEvcLoopBackVlanId": tnRmdIfEvcLoopBackVlanId,
