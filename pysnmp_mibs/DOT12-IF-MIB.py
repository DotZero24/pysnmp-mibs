...
mibBuilder.exportSymbols("DOT12-IF-MIB", dot12InNormPriorityFrames=dot12InNormPriorityFrames, dot12TransitionIntoTrainings=dot12TransitionIntoTrainings, dot12Groups=dot12Groups, dot12StatTable=dot12StatTable, dot12TrainingVersion=dot12TrainingVersion, dot12InOversizeFrameErrors=dot12InOversizeFrameErrors, dot12Compliances=dot12Compliances, dot12Compliance=dot12Compliance, dot12HCInHighPriorityOctets=dot12HCInHighPriorityOctets, dot12CurrentFramingType=dot12CurrentFramingType, dot12InDataErrors=dot12InDataErrors, dot12StatsGroup=dot12StatsGroup, dot12HCOutHighPriorityOctets=dot12HCOutHighPriorityOctets, dot12ConfigGroup=dot12ConfigGroup, dot12OutHighPriorityFrames=dot12OutHighPriorityFrames, dot12ConfigTable=dot12ConfigTable, dot12InHighPriorityOctets=dot12InHighPriorityOctets, dot12LastTrainingConfig=dot12LastTrainingConfig, dot12ControlMode=dot12ControlMode, dot12OutHighPriorityOctets=dot12OutHighPriorityOctets, dot12DesiredPromiscStatus=dot12DesiredPromiscStatus, dot12HCInNormPriorityOctets=dot12HCInNormPriorityOctets, PYSNMP_MODULE_ID=dot12MIB, dot12InIPMErrors=dot12InIPMErrors, dot12InNullAddressedFrames=dot12InNullAddressedFrames, dot12InHighPriorityFrames=dot12InHighPriorityFrames, dot12Conformance=dot12Conformance, dot12MIBObjects=dot12MIBObjects, dot12InNormPriorityOctets=dot12InNormPriorityOctets, dot12FramingCapability=dot12FramingCapability, dot12Commands=dot12Commands, dot12Status=dot12Status, dot12MIB=dot12MIB, dot12StatEntry=dot12StatEntry, dot12ConfigEntry=dot12ConfigEntry, dot12DesiredFramingType=dot12DesiredFramingType)
