...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-DIAGNOSTICS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:01:26 2025
...
ifBLERTObjectsTable = _IfBLERTObjectsTable_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3)
)
if mibBuilder.loadTexts:
    ifBLERTObjectsTable.setStatus("mandatory")
_IfBLERTObjectsEntry_Object = MibTableRow
ifBLERTObjectsEntry = _IfBLERTObjectsEntry_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1)
)
ifBLERTObjectsEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    ifBLERTObjectsEntry.setStatus("mandatory")
_IfBLERTTestDuration_Type = Integer32
_IfBLERTTestDuration_Object = MibTableColumn
ifBLERTTestDuration = _IfBLERTTestDuration_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 1),
    _IfBLERTTestDuration_Type()
)
ifBLERTTestDuration.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ifBLERTTestDuration.setStatus("mandatory")
_IfBLERTElapsedTime_Type = Integer32
_IfBLERTElapsedTime_Object = MibTableColumn
ifBLERTElapsedTime = _IfBLERTElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 2),
    _IfBLERTElapsedTime_Type()
)
ifBLERTElapsedTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifBLERTElapsedTime.setStatus("mandatory")
_IfBLERTTxSeqCount_Type = Integer32
_IfBLERTTxSeqCount_Object = MibTableColumn
ifBLERTTxSeqCount = _IfBLERTTxSeqCount_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 3),
    _IfBLERTTxSeqCount_Type()
)
ifBLERTTxSeqCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifBLERTTxSeqCount.setStatus("mandatory")
_IfBLERTRxSeqCount_Type = Integer32
_IfBLERTRxSeqCount_Object = MibTableColumn
ifBLERTRxSeqCount = _IfBLERTRxSeqCount_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 4),
    _IfBLERTRxSeqCount_Type()
)
ifBLERTRxSeqCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifBLERTRxSeqCount.setStatus("mandatory")
_IfBLERTRxGoodFrames_Type = Integer32
_IfBLERTRxGoodFrames_Object = MibTableColumn
ifBLERTRxGoodFrames = _IfBLERTRxGoodFrames_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 5),
    _IfBLERTRxGoodFrames_Type()
)
ifBLERTRxGoodFrames.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifBLERTRxGoodFrames.setStatus("mandatory")
_IfBLERTTxGoodFrames_Type = Integer32
_IfBLERTTxGoodFrames_Object = MibTableColumn
ifBLERTTxGoodFrames = _IfBLERTTxGoodFrames_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 6),
    _IfBLERTTxGoodFrames_Type()
)
ifBLERTTxGoodFrames.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifBLERTTxGoodFrames.setStatus("mandatory")
_IfBLERTRxBadFrames_Type = Integer32
_IfBLERTRxBadFrames_Object = MibTableColumn
ifBLERTRxBadFrames = _IfBLERTRxBadFrames_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 7),
    _IfBLERTRxBadFrames_Type()
)
ifBLERTRxBadFrames.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifBLERTRxBadFrames.setStatus("mandatory")
_IfBLERTTxBadFrames_Type = Integer32
_IfBLERTTxBadFrames_Object = MibTableColumn
ifBLERTTxBadFrames = _IfBLERTTxBadFrames_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 8),
    _IfBLERTTxBadFrames_Type()
)
ifBLERTTxBadFrames.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifBLERTTxBadFrames.setStatus("mandatory")
_IfBLERTDnLineRate_Type = Integer32
_IfBLERTDnLineRate_Object = MibTableColumn
ifBLERTDnLineRate = _IfBLERTDnLineRate_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 9),
    _IfBLERTDnLineRate_Type()
)
ifBLERTDnLineRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifBLERTDnLineRate.setStatus("mandatory")
_IfBLERTUpLineRate_Type = Integer32
_IfBLERTUpLineRate_Object = MibTableColumn
ifBLERTUpLineRate = _IfBLERTUpLineRate_Object(
    (1, 3, 6, 1, 4, 1, 1795, 2, 24, 2, 16, 1, 1, 3, 1, 10),
    _IfBLERTUpLineRate_Type()
)
ifBLERTUpLineRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ifBLERTUpLineRate.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"diagTestMIBObjects": diagTestMIBObjects,
       ...
       "ifBLERTObjectsTable": ifBLERTObjectsTable,
       "ifBLERTObjectsEntry": ifBLERTObjectsEntry,
       "ifBLERTTestDuration": ifBLERTTestDuration,
       "ifBLERTElapsedTime": ifBLERTElapsedTime,
       "ifBLERTTxSeqCount": ifBLERTTxSeqCount,
       "ifBLERTRxSeqCount": ifBLERTRxSeqCount,
       "ifBLERTRxGoodFrames": ifBLERTRxGoodFrames,
       "ifBLERTTxGoodFrames": ifBLERTTxGoodFrames,
       "ifBLERTRxBadFrames": ifBLERTRxBadFrames,
       "ifBLERTTxBadFrames": ifBLERTTxBadFrames,
       "ifBLERTDnLineRate": ifBLERTDnLineRate,
       "ifBLERTUpLineRate": ifBLERTUpLineRate,
