# SNMP MIB module (T7511-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T7511-MIB
...
trapTest.setObjects(
      *(("T7511-MIB", "sensorName"),
        ("T7511-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
