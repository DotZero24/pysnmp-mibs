...
mibBuilder.exportSymbols("MALLOC-MIB", mallocGroups=mallocGroups, mallocScopeTable=mallocScopeTable, mallocRequestTable=mallocRequestTable, mallocRequestServerAddressType=mallocRequestServerAddressType, mallocAddressEntry=mallocAddressEntry, madcap=madcap, madcapServerGroup=madcapServerGroup, mallocAddressAddressType=mallocAddressAddressType, mallocScopeStorage=mallocScopeStorage, mallocRequestEndTime=mallocRequestEndTime, mallocAddressTable=mallocAddressTable, malloc=malloc, PYSNMP_MODULE_ID=mallocMIB, mallocScopeFirstAddress=mallocScopeFirstAddress, mallocServerFullCompliance=mallocServerFullCompliance, madcapRequestsDenied=madcapRequestsDenied, madcapConfigExtraAllocationTime=madcapConfigExtraAllocationTime, mallocRequestLeaseIdentifier=mallocRequestLeaseIdentifier, mallocServerGroup=mallocServerGroup, madcapCounters=madcapCounters, mallocAllocRangeStorage=mallocAllocRangeStorage, mallocScopeNameStorage=mallocScopeNameStorage, mallocScopeNameLangName=mallocScopeNameLangName, mallocScopeLastAddress=mallocScopeLastAddress, mallocCapabilities=mallocCapabilities, mallocAllocRangeNumAllocatedAddrs=mallocAllocRangeNumAllocatedAddrs, mallocScopeEntry=mallocScopeEntry, mallocRequestId=mallocRequestId, madcapRequests=madcapRequests, mallocClientReadOnlyCompliance=mallocClientReadOnlyCompliance, mallocScopeNameTable=mallocScopeNameTable, mallocPrefixCoordinatorReadOnlyCompliance=mallocPrefixCoordinatorReadOnlyCompliance, mallocScopeAddressType=mallocScopeAddressType, mallocRequestStartTime=mallocRequestStartTime, mallocMIBObjects=mallocMIBObjects, mallocScopeServerAddress=mallocScopeServerAddress, madcapBadLeaseIds=madcapBadLeaseIds, mallocBasicGroup=mallocBasicGroup, mallocScopeNameScopeName=mallocScopeNameScopeName, madcapDiscovers=madcapDiscovers, mallocScopeNameDefault=mallocScopeNameDefault, mallocClientFullCompliance=mallocClientFullCompliance, mallocAllocRangeLifetime=mallocAllocRangeLifetime, madcapInforms=madcapInforms, mallocScopeNameEntry=mallocScopeNameEntry, mallocClientGroup=mallocClientGroup, mallocAllocRangeMaxLeaseTime=mallocAllocRangeMaxLeaseTime, mallocScopeStatus=mallocScopeStatus, mallocAllocRangeTotalRequestedAddrs=mallocAllocRangeTotalRequestedAddrs, madcapInvalidRequests=madcapInvalidRequests, madcapRenews=madcapRenews, mallocRequestServerAddress=mallocRequestServerAddress, mallocAllocRangeTotalAllocatedAddrs=mallocAllocRangeTotalAllocatedAddrs, mallocRequestScopeFirstAddress=mallocRequestScopeFirstAddress, mallocAddressFirstAddress=mallocAddressFirstAddress, madcapExcessiveClockSkews=madcapExcessiveClockSkews, mallocAddressNumAddrs=mallocAddressNumAddrs, mallocAllocRangeEntry=mallocAllocRangeEntry, mallocRequestNumAddrs=mallocRequestNumAddrs, mallocAllocRangeNumOfferedAddrs=mallocAllocRangeNumOfferedAddrs, mallocPrefixCoordinatorFullCompliance=mallocPrefixCoordinatorFullCompliance, mallocAllocRangeNumWaitingAddrs=mallocAllocRangeNumWaitingAddrs, mallocRequestEntry=mallocRequestEntry, mallocAllocRangeLastAddress=mallocAllocRangeLastAddress, mallocAllocRangeMaxLeaseAddrs=mallocAllocRangeMaxLeaseAddrs, mallocMIB=mallocMIB, madcapConfig=madcapConfig, mallocScopeDivisible=mallocScopeDivisible, mallocAllocRangeTable=mallocAllocRangeTable, madcapConfigNoResponseDelay=madcapConfigNoResponseDelay, madcapTotalErrors=madcapTotalErrors, mallocScopeNameStatus=mallocScopeNameStatus, mallocConformance=mallocConformance, mallocAllocRangeFirstAddress=mallocAllocRangeFirstAddress, mallocRequestState=mallocRequestState, mallocServerReadOnlyCompliance=mallocServerReadOnlyCompliance, mallocPrefixCoordinatorGroup=mallocPrefixCoordinatorGroup, mallocScopeSSM=mallocScopeSSM, mallocCompliances=mallocCompliances, mallocScopeSource=mallocScopeSource, mallocClientScopeGroup=mallocClientScopeGroup, madcapConfigClockSkewAllowance=madcapConfigClockSkewAllowance, mallocAddressRequestId=mallocAddressRequestId, mallocAllocRangeNumTryingAddrs=mallocAllocRangeNumTryingAddrs, madcapConfigOfferHold=madcapConfigOfferHold, mallocAllocRangeSource=mallocAllocRangeSource, mallocRequestScopeAddressType=mallocRequestScopeAddressType, mallocScopeHopLimit=mallocScopeHopLimit, mallocAllocRangeStatus=mallocAllocRangeStatus, madcapConfigResponseCacheInterval=madcapConfigResponseCacheInterval, mallocRequestClientAddress=mallocRequestClientAddress, mallocAllocRangeAdvertisable=mallocAllocRangeAdvertisable, madcapReleases=madcapReleases, mallocRequestClientAddressType=mallocRequestClientAddressType, madcapClientGroup=madcapClientGroup, mallocScopeServerAddressType=mallocScopeServerAddressType)
