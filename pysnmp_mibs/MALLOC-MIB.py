...
# Notes
# -----
# ASN.1 source file://mibs/rfc/MALLOC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:20:12 2025
...
_MallocScopeDivisible_Type.__name__ = "TruthValue"
...
_MallocScopeServerAddressType_Type.__name__ = "InetAddressType"
...
_MallocScopeServerAddress_Type.__name__ = "InetAddress"
...
_MallocScopeSSM_Type.__name__ = "TruthValue"
...
_MallocScopeStorage_Type.__name__ = "StorageType"
...
_MallocScopeNameDefault_Type.__name__ = "TruthValue"
...
_MallocScopeNameStorage_Type.__name__ = "StorageType"
...
_MallocAllocRangeLifetime_Type.__name__ = "Unsigned32"
...
_MallocAllocRangeMaxLeaseAddrs_Type.__name__ = "Unsigned32"
...
_MallocAllocRangeMaxLeaseTime_Type.__name__ = "Unsigned32"
...
_MallocAllocRangeStorage_Type.__name__ = "StorageType"
...
mallocServerReadOnlyCompliance.setObjects(
      *(("MALLOC-MIB", "mallocBasicGroup"),
        ("MALLOC-MIB", "mallocServerGroup"))
)
if mibBuilder.loadTexts:
...
mallocClientReadOnlyCompliance.setObjects(
      *(("MALLOC-MIB", "mallocBasicGroup"),
        ("MALLOC-MIB", "mallocClientGroup"),
        ("MALLOC-MIB", "mallocClientScopeGroup"),
        ("MALLOC-MIB", "madcapClientGroup"))
)
if mibBuilder.loadTexts:
...
mallocPrefixCoordinatorReadOnlyCompliance.setObjects(
      *(("MALLOC-MIB", "mallocBasicGroup"),
        ("MALLOC-MIB", "mallocPrefixCoordinatorGroup"))
)
if mibBuilder.loadTexts:
...
mallocServerFullCompliance.setObjects(
      *(("MALLOC-MIB", "mallocBasicGroup"),
        ("MALLOC-MIB", "mallocServerGroup"),
        ("MALLOC-MIB", "madcapServerGroup"))
)
if mibBuilder.loadTexts:
...
mallocClientFullCompliance.setObjects(
      *(("MALLOC-MIB", "mallocBasicGroup"),
        ("MALLOC-MIB", "mallocClientGroup"),
        ("MALLOC-MIB", "mallocClientScopeGroup"),
        ("MALLOC-MIB", "madcapClientGroup"))
...
mallocPrefixCoordinatorFullCompliance.setObjects(
      *(("MALLOC-MIB", "mallocBasicGroup"),
        ("MALLOC-MIB", "mallocPrefixCoordinatorGroup"))
)
if mibBuilder.loadTexts:
