...
_D='DOT3-OAM-MIB'
_C='Integer32'
_B='ALCATEL-ENT1-DOT3-OAM-MIB'
_A='current'
if'mibBuilder'not in globals():import sys;sys.stderr.write(__doc__);sys.exit(1)
Integer,OctetString,ObjectIdentifier=mibBuilder.importSymbols('ASN1','Integer','OctetString','ObjectIdentifier')
NamedValues,=mibBuilder.importSymbols('ASN1-ENUMERATION','NamedValues')
ConstraintsIntersection,ConstraintsUnion,SingleValueConstraint,ValueRangeConstraint,ValueSizeConstraint=mibBuilder.importSymbols('ASN1-REFINEMENT','ConstraintsIntersection','ConstraintsUnion','SingleValueConstraint','ValueRangeConstraint','ValueSizeConstraint')
softentIND1Dot3Oam,=mibBuilder.importSymbols('ALCATEL-ENT1-BASE','softentIND1Dot3Oam')
...
alcatelIND1Dot3OamNotifications=_AlcatelIND1Dot3OamNotifications_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,0))
...
alcatelIND1Dot3OamMIBObjects=_AlcatelIND1Dot3OamMIBObjects_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,1))
...
alaDot3OamStatus=_AlaDot3OamStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,1),_AlaDot3OamStatus_Type())
...
alaDot3OamGlobalClearStats=_AlaDot3OamGlobalClearStats_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,2),_AlaDot3OamGlobalClearStats_Type())
...
alaDot3OamGlobalClearEventLogs=_AlaDot3OamGlobalClearEventLogs_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,3),_AlaDot3OamGlobalClearEventLogs_Type())
...
alaDot3OamGlobalClearVariableTransactions=_AlaDot3OamGlobalClearVariableTransactions_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,4),_AlaDot3OamGlobalClearVariableTransactions_Type())
...
alaDot3OamMultiplePduCount=_AlaDot3OamMultiplePduCount_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,5),_AlaDot3OamMultiplePduCount_Type())
...
alaDot3OamPortConfig=_AlaDot3OamPortConfig_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,8))
_AlaDot3OamTable_Object=MibTable
alaDot3OamTable=_AlaDot3OamTable_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,8,1))
if mibBuilder.loadTexts:alaDot3OamTable.setStatus(_A)
_AlaDot3OamEntry_Object=MibTableRow
alaDot3OamEntry=_AlaDot3OamEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,8,1,1))
...
alaDot3OamKeepAliveInterval=_AlaDot3OamKeepAliveInterval_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,8,1,1,1),_AlaDot3OamKeepAliveInterval_Type())
...
alaDot3OamHelloInterval=_AlaDot3OamHelloInterval_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,8,1,1,2),_AlaDot3OamHelloInterval_Type())
...
alaDot3OamNextTransactionId=_AlaDot3OamNextTransactionId_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,8,1,1,3),_AlaDot3OamNextTransactionId_Type())
...
alaDot3OamPortLoopbackControl=_AlaDot3OamPortLoopbackControl_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,9))
_AlaDot3OamLoopbackTable_Object=MibTable
alaDot3OamLoopbackTable=_AlaDot3OamLoopbackTable_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,9,1))
if mibBuilder.loadTexts:alaDot3OamLoopbackTable.setStatus(_A)
_AlaDot3OamLoopbackEntry_Object=MibTableRow
alaDot3OamLoopbackEntry=_AlaDot3OamLoopbackEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,9,1,1))
...
alaDot3OamPortL1PingFramesConf=_AlaDot3OamPortL1PingFramesConf_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,9,1,1,1),_AlaDot3OamPortL1PingFramesConf_Type())
...
alaDot3OamPortL1PingFramesDelay=_AlaDot3OamPortL1PingFramesDelay_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,9,1,1,2),_AlaDot3OamPortL1PingFramesDelay_Type())
...
alaDot3OamPortL1PingStatus=_AlaDot3OamPortL1PingStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,9,1,1,3),_AlaDot3OamPortL1PingStatus_Type())
...
alaDot3OamPortL1PingFramesSent=_AlaDot3OamPortL1PingFramesSent_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,9,1,1,4),_AlaDot3OamPortL1PingFramesSent_Type())
...
alaDot3OamPortL1PingFramesReceived=_AlaDot3OamPortL1PingFramesReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,9,1,1,5),_AlaDot3OamPortL1PingFramesReceived_Type())
...
alaDot3OamPortL1PingAverageRoundTripDelay=_AlaDot3OamPortL1PingAverageRoundTripDelay_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,9,1,1,6),_AlaDot3OamPortL1PingAverageRoundTripDelay_Type())
...
alaDot3OamPortStats=_AlaDot3OamPortStats_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,10))
_AlaDot3OamStatsTable_Object=MibTable
alaDot3OamStatsTable=_AlaDot3OamStatsTable_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,10,1))
if mibBuilder.loadTexts:alaDot3OamStatsTable.setStatus(_A)
_AlaDot3OamStatsEntry_Object=MibTableRow
alaDot3OamStatsEntry=_AlaDot3OamStatsEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,10,1,1))
...
alaDot3OamPortClearStats=_AlaDot3OamPortClearStats_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,10,1,1,1),_AlaDot3OamPortClearStats_Type())
...
alaDot3OamPortEventLogs=_AlaDot3OamPortEventLogs_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,11))
_AlaDot3OamEventLogTable_Object=MibTable
alaDot3OamEventLogTable=_AlaDot3OamEventLogTable_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,11,1))
if mibBuilder.loadTexts:alaDot3OamEventLogTable.setStatus(_A)
_AlaDot3OamEventLogEntry_Object=MibTableRow
alaDot3OamEventLogEntry=_AlaDot3OamEventLogEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,11,1,1))
...
alaDot3OamPortClearEventLogs=_AlaDot3OamPortClearEventLogs_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,11,1,1,1),_AlaDot3OamPortClearEventLogs_Type())
...
alaDot3OamRetrieveRequest=_AlaDot3OamRetrieveRequest_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,12))
_AlaDot3OamRetrieveRequestTable_Object=MibTable
alaDot3OamRetrieveRequestTable=_AlaDot3OamRetrieveRequestTable_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,12,1))
if mibBuilder.loadTexts:alaDot3OamRetrieveRequestTable.setStatus(_A)
_AlaDot3OamRetrieveRequestEntry_Object=MibTableRow
alaDot3OamRetrieveRequestEntry=_AlaDot3OamRetrieveRequestEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,12,1,1))
...
alaDot3OamTransactionId=_AlaDot3OamTransactionId_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,12,1,1,1),_AlaDot3OamTransactionId_Type())
...
alaDot3OamVariableRequestBranch=_AlaDot3OamVariableRequestBranch_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,12,1,1,2),_AlaDot3OamVariableRequestBranch_Type())
...
alaDot3OamVariableRequestLeaf=_AlaDot3OamVariableRequestLeaf_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,12,1,1,3),_AlaDot3OamVariableRequestLeaf_Type())
...
alaDot3OamVariableRequestRetrieveStatus=_AlaDot3OamVariableRequestRetrieveStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,12,1,1,4),_AlaDot3OamVariableRequestRetrieveStatus_Type())
...
alaDot3OamVariableRequestRowStatus=_AlaDot3OamVariableRequestRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,12,1,1,5),_AlaDot3OamVariableRequestRowStatus_Type())
...
alaDot3OamPortClearVariableTransactions=_AlaDot3OamPortClearVariableTransactions_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,12,1,1,6),_AlaDot3OamPortClearVariableTransactions_Type())
...
alaDot3OamRetrieveResponse=_AlaDot3OamRetrieveResponse_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,13))
_AlaDot3OamRetrieveResponseTable_Object=MibTable
alaDot3OamRetrieveResponseTable=_AlaDot3OamRetrieveResponseTable_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,13,1))
if mibBuilder.loadTexts:alaDot3OamRetrieveResponseTable.setStatus(_A)
_AlaDot3OamRetrieveResponseEntry_Object=MibTableRow
alaDot3OamRetrieveResponseEntry=_AlaDot3OamRetrieveResponseEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,13,1,1))
...
alaDot3OamVariableResponseBranch=_AlaDot3OamVariableResponseBranch_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,13,1,1,1),_AlaDot3OamVariableResponseBranch_Type())
...
alaDot3OamVariableResponseLeaf=_AlaDot3OamVariableResponseLeaf_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,13,1,1,2),_AlaDot3OamVariableResponseLeaf_Type())
...
alaDot3OamVariableResponseValue=_AlaDot3OamVariableResponseValue_Object((1,3,6,1,4,1,6486,801,1,2,1,52,1,1,13,1,1,3),_AlaDot3OamVariableResponseValue_Type())
...
alcatelIND1Dot3OamMIBConformance=_AlcatelIND1Dot3OamMIBConformance_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,2))
...
alcatelIND1Dot3OamMIBGroups=_AlcatelIND1Dot3OamMIBGroups_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,2,1))
...
alcatelIND1Dot3OamMIBCompliances=_AlcatelIND1Dot3OamMIBCompliances_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,52,1,2,2))
...
alaDot3OamPortStatsGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,52,1,2,1,4))
alaDot3OamPortStatsGroup.setObjects((_B,_x))
if mibBuilder.loadTexts:alaDot3OamPortStatsGroup.setStatus(_A)
alaDot3OamPortEventLogsGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,52,1,2,1,5))
alaDot3OamPortEventLogsGroup.setObjects((_B,_y))
if mibBuilder.loadTexts:alaDot3OamPortEventLogsGroup.setStatus(_A)
alaDot3OamRetrieveRequestGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,52,1,2,1,6))
...
alaDot3OamRetrieveResponseGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,52,1,2,1,7))
alaDot3OamRetrieveResponseGroup.setObjects((_B,_A2))
if mibBuilder.loadTexts:alaDot3OamRetrieveResponseGroup.setStatus(_A)
alaDot3OamThresholdEventClear=NotificationType((1,3,6,1,4,1,6486,801,1,2,1,52,1,0,1))
...
alaDot3OamNonThresholdEventClear=NotificationType((1,3,6,1,4,1,6486,801,1,2,1,52,1,0,2))
...
alaDot3OamNotificationGroup=NotificationGroup((1,3,6,1,4,1,6486,801,1,2,1,52,1,2,1,8))
alaDot3OamNotificationGroup.setObjects(*((_B,_A3),(_B,_A4)))
if mibBuilder.loadTexts:alaDot3OamNotificationGroup.setStatus(_A)
alcatelIND1Dot3OamMIBCompliance=ModuleCompliance((1,3,6,1,4,1,6486,801,1,2,1,52,1,2,2,1))
