#
# PySNMP MIB module P8611-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/comet/P8611-MIB
...
p8611 = MibIdentifier((1, 3, 6, 1, 4, 1, 22626, 1, 5))
...
historyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 22626, 1, 5, 4, 1, 1), ).setIndexNames((0, "P8611-MIB", "ch1value"))
...
trapTest = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,0)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapNTPError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,1)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapEmailErrLogin = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,2)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapEmailErrAuth = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,3)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapEmailErrSome = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,4)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapEmailErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,5)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapEmailErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,6)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapSOAPErrFile = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,7)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapSOAPErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,8)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapSOAPErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,9)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapSOAPErrDelivery = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,10)).setObjects(("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapCh1HighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,11)).setObjects(("P8611-MIB", "ch1Name"), ("P8611-MIB", "ch1Val"), ("P8611-MIB", "ch1Alarm"), ("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapCh2HighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,12)).setObjects(("P8611-MIB", "ch2Name"), ("P8611-MIB", "ch2Val"), ("P8611-MIB", "ch2Alarm"), ("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapCh1LowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,21)).setObjects(("P8611-MIB", "ch1Name"), ("P8611-MIB", "ch1Val"), ("P8611-MIB", "ch1Alarm"), ("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapCh2LowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,22)).setObjects(("P8611-MIB", "ch2Name"), ("P8611-MIB", "ch2Val"), ("P8611-MIB", "ch2Alarm"), ("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapCh1ClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,31)).setObjects(("P8611-MIB", "ch1Name"), ("P8611-MIB", "ch1Val"), ("P8611-MIB", "ch1Alarm"), ("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapCh2ClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,32)).setObjects(("P8611-MIB", "ch2Name"), ("P8611-MIB", "ch2Val"), ("P8611-MIB", "ch2Alarm"), ("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapCh1Error = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,41)).setObjects(("P8611-MIB", "ch1Name"), ("P8611-MIB", "ch1Val"), ("P8611-MIB", "ch1Alarm"), ("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
trapCh2Error = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,42)).setObjects(("P8611-MIB", "ch2Name"), ("P8611-MIB", "ch2Val"), ("P8611-MIB", "ch2Alarm"), ("P8611-MIB", "sensorName"), ("P8611-MIB", "messageString"))
mibBuilder.exportSymbols("P8611-MIB", ch2LimHi=ch2LimHi, trapNTPError=trapNTPError, historyTable=historyTable, comet=comet, ch1LimHyst=ch1LimHyst, trapEmailErrDNS=trapEmailErrDNS, ch2Min=ch2Min, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, ch1IntVal=ch1IntVal, ch1value=ch1value, ch1Alarm=ch1Alarm, trapSOAPErrDelivery=trapSOAPErrDelivery, ch1Min=ch1Min, trapCh1ClrAlarm=trapCh1ClrAlarm, serialNumber=serialNumber, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, ch2value=ch2value, trapCh2LowAlarm=trapCh2LowAlarm, ch1LimLo=ch1LimLo, ch1Unit=ch1Unit, ch1Name=ch1Name, channel1=channel1, traps=traps, trapCh2HighAlarm=trapCh2HighAlarm, tables=tables, ch2Alarm=ch2Alarm, channel2=channel2, messageString=messageString, ch2Val=ch2Val, ch1LimDelay=ch1LimDelay, trapCh1LowAlarm=trapCh1LowAlarm, trapCh2ClrAlarm=trapCh2ClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, trapCh1Error=trapCh1Error, ch1AlarmStr=ch1AlarmStr, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, p8611=p8611, ch2Max=ch2Max, trapEmailErrSome=trapEmailErrSome, ch2IntVal=ch2IntVal, ch1LimHi=ch1LimHi, ch2LimDelay=ch2LimDelay, ch2Name=ch2Name, ch2AlarmStr=ch2AlarmStr, channels=channels, trapTest=trapTest, trapCh2Error=trapCh2Error, products=products, ch1Max=ch1Max, ch1Val=ch1Val, ch2LimHyst=ch2LimHyst, pysmi_global=pysmi_global, trapCh1HighAlarm=trapCh1HighAlarm, DisplayString=DisplayString, ch2LimLo=ch2LimLo, ch2Unit=ch2Unit, trapSOAPErrFile=trapSOAPErrFile)
