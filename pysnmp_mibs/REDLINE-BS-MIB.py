...
# Notes
# -----
# ASN.1 source file://mibs/redline/REDLINE-BS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:47:55 2025
...
redlineBsCompliance.setObjects(
      *(("REDLINE-BS-MIB", "redlineBsDhcpGroup"),
        ("REDLINE-BS-MIB", "redlineBsSntpGroup"),
        ("REDLINE-BS-MIB", "redlineBsConfigSaveGroup"),
        ("REDLINE-BS-MIB", "redlineBsSystemGroup"),
        ("REDLINE-BS-MIB", "redlineBsRfGroup"),
        ("REDLINE-BS-MIB", "redlineBsPhyGroup"),
        ("REDLINE-BS-MIB", "redlineBsEthGroup"),
        ("REDLINE-BS-MIB", "redlineBsVlanGroup"),
        ("REDLINE-BS-MIB", "redlineBsSmcGroup"),
        ("REDLINE-BS-MIB", "redlineBsPowerSupplyAndCoolingGroup"),
        ("REDLINE-BS-MIB", "redlineBsNotificationGroup"))
)
if mibBuilder.loadTexts:
