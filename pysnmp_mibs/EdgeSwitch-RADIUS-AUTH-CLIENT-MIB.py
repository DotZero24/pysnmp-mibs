# SNMP MIB module (EdgeSwitch-RADIUS-AUTH-CLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ubiquiti/EdgeSwitch-RADIUS-AUTH-CLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:59:18 2025
...
agentRadiusAccountingConfigEntry.setIndexNames(
    (0, "EdgeSwitch-RADIUS-AUTH-CLIENT-MIB", "agentRadiusAccountingServerIndex"),
)
if mibBuilder.loadTexts:
...
agentRadiusServerConfigEntry.setIndexNames(
    (0, "EdgeSwitch-RADIUS-AUTH-CLIENT-MIB", "agentRadiusServerIndex"),
)
if mibBuilder.loadTexts:
...
class _AgentRadiusNasIdentifier_Type(DisplayString):
    """Custom type agentRadiusNasIdentifier based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentRadiusNasIdentifier_Type.__name__ = "DisplayString"
_AgentRadiusNasIdentifier_Object = MibScalar
agentRadiusNasIdentifier = _AgentRadiusNasIdentifier_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 8, 1, 28),
    _AgentRadiusNasIdentifier_Type()
)
agentRadiusNasIdentifier.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentRadiusNasIdentifier.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"fastPathRadius": fastPathRadius,
       ...
       "agentRadiusNasIdentifier": agentRadiusNasIdentifier}
)
