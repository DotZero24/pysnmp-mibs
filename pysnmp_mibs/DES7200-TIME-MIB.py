...
myTimeMIBObjects=_MyTimeMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,15,1))
_MyClockDateAndTime_Type=DateAndTime
_MyClockDateAndTime_Object=MibScalar
myClockDateAndTime=_MyClockDateAndTime_Object((1,3,6,1,4,1,171,10,97,2,15,1,1),_MyClockDateAndTime_Type())
...
myClockWeek=_MyClockWeek_Object((1,3,6,1,4,1,171,10,97,2,15,1,2),_MyClockWeek_Type())
...
myTimeRangeMIBObjects=_MyTimeRangeMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,15,2))
_MyTimeRangeTable_Object=MibTable
myTimeRangeTable=_MyTimeRangeTable_Object((1,3,6,1,4,1,171,10,97,2,15,2,1))
if mibBuilder.loadTexts:myTimeRangeTable.setStatus(_A)
_MyTimeRangeEntry_Object=MibTableRow
myTimeRangeEntry=_MyTimeRangeEntry_Object((1,3,6,1,4,1,171,10,97,2,15,2,1,1))
...
myTimeRangeName=_MyTimeRangeName_Object((1,3,6,1,4,1,171,10,97,2,15,2,1,1,1),_MyTimeRangeName_Type())
...
myTimeRangePeriodMy=_MyTimeRangePeriodMy_Object((1,3,6,1,4,1,171,10,97,2,15,2,1,1,2),_MyTimeRangePeriodMy_Type())
...
myTimeRangePeriodEnd=_MyTimeRangePeriodEnd_Object((1,3,6,1,4,1,171,10,97,2,15,2,1,1,3),_MyTimeRangePeriodEnd_Type())
...
myTimeRangeRowStatus=_MyTimeRangeRowStatus_Object((1,3,6,1,4,1,171,10,97,2,15,2,1,1,4),_MyTimeRangeRowStatus_Type())
...
myTimeRangePeriodicTable=_MyTimeRangePeriodicTable_Object((1,3,6,1,4,1,171,10,97,2,15,2,2))
if mibBuilder.loadTexts:myTimeRangePeriodicTable.setStatus(_A)
_MyTimeRangePeriodicEntry_Object=MibTableRow
myTimeRangePeriodicEntry=_MyTimeRangePeriodicEntry_Object((1,3,6,1,4,1,171,10,97,2,15,2,2,1))
...
myTimeRangePeriodicTRName=_MyTimeRangePeriodicTRName_Object((1,3,6,1,4,1,171,10,97,2,15,2,2,1,1),_MyTimeRangePeriodicTRName_Type())
...
myTimeRangePeriodicIndex=_MyTimeRangePeriodicIndex_Object((1,3,6,1,4,1,171,10,97,2,15,2,2,1,2),_MyTimeRangePeriodicIndex_Type())
...
myTimeRangePeriodicType=_MyTimeRangePeriodicType_Object((1,3,6,1,4,1,171,10,97,2,15,2,2,1,3),_MyTimeRangePeriodicType_Type())
...
myTimeRangePeriodicMyWeekDay=_MyTimeRangePeriodicMyWeekDay_Object((1,3,6,1,4,1,171,10,97,2,15,2,2,1,4),_MyTimeRangePeriodicMyWeekDay_Type())
...
myTimeRangePeriodicEndWeekDay=_MyTimeRangePeriodicEndWeekDay_Object((1,3,6,1,4,1,171,10,97,2,15,2,2,1,5),_MyTimeRangePeriodicEndWeekDay_Type())
...
myTimeRangePeriodicTimeOfDayMy=_MyTimeRangePeriodicTimeOfDayMy_Object((1,3,6,1,4,1,171,10,97,2,15,2,2,1,6),_MyTimeRangePeriodicTimeOfDayMy_Type())
...
myTimeRangePeriodicTimeOfDayEnd=_MyTimeRangePeriodicTimeOfDayEnd_Object((1,3,6,1,4,1,171,10,97,2,15,2,2,1,7),_MyTimeRangePeriodicTimeOfDayEnd_Type())
...
myTimeRangePeriodicRowStatus=_MyTimeRangePeriodicRowStatus_Object((1,3,6,1,4,1,171,10,97,2,15,2,2,1,8),_MyTimeRangePeriodicRowStatus_Type())
...
myTimeMIBConformance=_MyTimeMIBConformance_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,15,3))
_MyTimeMIBCompliances_ObjectIdentity=ObjectIdentity
myTimeMIBCompliances=_MyTimeMIBCompliances_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,15,3,1))
_MyTimeMIBGroups_ObjectIdentity=ObjectIdentity
myTimeMIBGroups=_MyTimeMIBGroups_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,15,3,2))
myTimeMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,15,3,2,1))
myTimeMIBGroup.setObjects(*((_B,_M),(_B,_N)))
if mibBuilder.loadTexts:myTimeMIBGroup.setStatus(_A)
myTimeRangeMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,15,3,2,2))
...
myTimeMIBCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,97,2,15,3,1,1))
