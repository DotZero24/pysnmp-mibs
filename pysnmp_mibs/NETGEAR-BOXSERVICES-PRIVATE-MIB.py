...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/netgear/NETGEAR-BOXSERVICES-PRIVATE-MIB
...
fastPathBoxServices.setRevisions(('2011-01-26 00:00', '2008-02-22 00:00', '2019-12-23 00:00',))
...
boxServicesFanSpeed = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 6, 1, 4), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 13))).setMaxAccess("readonly")
if mibBuilder.loadTexts: boxServicesFanSpeed.setStatus('current')
boxServicesFanDutyLevel = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 6, 1, 5), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 13))).setMaxAccess("readonly")
...
boxServicesFiberPortsOpticsTable = MibTable((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16), )
if mibBuilder.loadTexts: boxServicesFiberPortsOpticsTable.setStatus('current')
boxServicesFiberPortsOpticsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1), ).setIndexNames((0, "NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesFiberPortIndex"))
if mibBuilder.loadTexts: boxServicesFiberPortsOpticsEntry.setStatus('current')
boxServicesFiberPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1, 1), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: boxServicesFiberPortIndex.setStatus('current')
boxServicesFiberPortOpticsTemperature = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1, 2), DisplayString()).setUnits('DEGREES').setMaxAccess("readonly")
if mibBuilder.loadTexts: boxServicesFiberPortOpticsTemperature.setStatus('current')
boxServicesFiberPortOpticsVoltage = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1, 3), DisplayString()).setUnits('Volts').setMaxAccess("readonly")
if mibBuilder.loadTexts: boxServicesFiberPortOpticsVoltage.setStatus('current')
boxServicesFiberPortOpticsCurrent = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1, 4), DisplayString()).setUnits('Milliamps').setMaxAccess("readonly")
if mibBuilder.loadTexts: boxServicesFiberPortOpticsCurrent.setStatus('current')
boxServicesFiberPortOpticsPowerOut = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1, 5), DisplayString()).setUnits('dBm').setMaxAccess("readonly")
if mibBuilder.loadTexts: boxServicesFiberPortOpticsPowerOut.setStatus('current')
boxServicesFiberPortOpticsPowerIn = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1, 6), DisplayString()).setUnits('dBm').setMaxAccess("readonly")
if mibBuilder.loadTexts: boxServicesFiberPortOpticsPowerIn.setStatus('current')
boxServicesFiberPortOpticsTxFault = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1, 7), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: boxServicesFiberPortOpticsTxFault.setStatus('current')
boxServicesFiberPortOpticsLos = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1, 8), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: boxServicesFiberPortOpticsLos.setStatus('current')
boxServicesFiberPortOpticsFaultStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 16, 1, 9), DisplayString()).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("NETGEAR-BOXSERVICES-PRIVATE-MIB", boxServicesTempSensorIndex=boxServicesTempSensorIndex, boxServicesTempSensorTemperature=boxServicesTempSensorTemperature, boxServicesTempUnitState=boxServicesTempUnitState, boxsTemperatureChange=boxsTemperatureChange, boxServicesPowSuppliesTable=boxServicesPowSuppliesTable, boxServicesThermalShutdownTemperature=boxServicesThermalShutdownTemperature, boxServicesFanDutyLevel=boxServicesFanDutyLevel, BoxsTemperatureStatus=BoxsTemperatureStatus, boxsLocatorLedEnable=boxsLocatorLedEnable, boxServicesFansEntry=boxServicesFansEntry, boxServicesGroup=boxServicesGroup, boxServicesNotificationsGroup=boxServicesNotificationsGroup, boxServicesTempUnitIndex=boxServicesTempUnitIndex, boxServicesFiberPortOpticsPowerIn=boxServicesFiberPortOpticsPowerIn, boxsLocatorLedUnit=boxsLocatorLedUnit, fastPathBoxServices=fastPathBoxServices, boxServicesFanStateTrapEnable=boxServicesFanStateTrapEnable, boxServicesFansIndex=boxServicesFansIndex, boxServicesFiberPortOpticsTemperature=boxServicesFiberPortOpticsTemperature, boxServicesUnitIndex=boxServicesUnitIndex, boxServicesTempUnitTable=boxServicesTempUnitTable, boxServicesPowerSuppUnitIndex=boxServicesPowerSuppUnitIndex, boxServicesPowSupplyIndex=boxServicesPowSupplyIndex, boxServicesTemperatureTrapEnable=boxServicesTemperatureTrapEnable, boxServicesPowSupplyItemType=boxServicesPowSupplyItemType, boxsThermalShutdown=boxsThermalShutdown, boxServicesFansTable=boxServicesFansTable, boxServicesPowSuppliesEntry=boxServicesPowSuppliesEntry, boxServicesPowSupplyItemState=boxServicesPowSupplyItemState, boxServicesTempUnitTemperature=boxServicesTempUnitTemperature, boxServicesFiberPortOpticsCurrent=boxServicesFiberPortOpticsCurrent, boxsTemperatureStateChange=boxsTemperatureStateChange, boxServicesPSMStateTrapEnable=boxServicesPSMStateTrapEnable, boxsItemStateChangeEvent=boxsItemStateChangeEvent, boxsLocatorLedConfigGroup=boxsLocatorLedConfigGroup, boxServicesFanItemType=boxServicesFanItemType, boxsFanStateChange=boxsFanStateChange, boxServicesNormalTempRangeMax=boxServicesNormalTempRangeMax, boxServicesFanUnitIndex=boxServicesFanUnitIndex, boxServicesFanItemState=boxServicesFanItemState, boxsLocatorLedTime=boxsLocatorLedTime, boxServicesFiberPortOpticsTxFault=boxServicesFiberPortOpticsTxFault, boxsTemperatureStatusCurrentEvent=boxsTemperatureStatusCurrentEvent, boxServicesFiberPortOpticsFaultStatus=boxServicesFiberPortOpticsFaultStatus, boxServicesTempSensorType=boxServicesTempSensorType, boxServicesTempSensorState=boxServicesTempSensorState, boxServicesFanSpeed=boxServicesFanSpeed, boxServicesTempSensorsEntry=boxServicesTempSensorsEntry, boxServicesTempUnitEntry=boxServicesTempUnitEntry, PYSNMP_MODULE_ID=fastPathBoxServices, boxServicesFiberPortsOpticsTable=boxServicesFiberPortsOpticsTable, boxServicesTempSensorsTable=boxServicesTempSensorsTable, boxServicesFiberPortsOpticsEntry=boxServicesFiberPortsOpticsEntry, boxServicesFiberPortOpticsPowerOut=boxServicesFiberPortOpticsPowerOut, boxServicesFiberPortIndex=boxServicesFiberPortIndex, boxServicesFiberPortOpticsLos=boxServicesFiberPortOpticsLos, boxsTemperatureChangeEvent=boxsTemperatureChangeEvent, boxServicesThermalShutdownSensor=boxServicesThermalShutdownSensor, boxServicesFiberPortOpticsVoltage=boxServicesFiberPortOpticsVoltage, fastPathBoxServicesTraps=fastPathBoxServicesTraps, boxsPowSupplyStateChange=boxsPowSupplyStateChange, boxsTemperatureStatusPreviousEvent=boxsTemperatureStatusPreviousEvent, boxServicesNormalTempRangeMin=boxServicesNormalTempRangeMin)
