...
# Notes
# -----
# ASN.1 source file://mibs/rfc/TED-MIB
...
_TedStatusChangeNotificationMaxRate_Type.__name__ = "Unsigned32"
...
_TedCreatedDeletedNotificationMaxRate_Type.__name__ = "Unsigned32"
...
tedModuleFullCompliance.setObjects(
      *(("TED-MIB", "tedMainGroup"),
        ("TED-MIB", "tedObjectsGroup"),
        ("TED-MIB", "tedNotificationGroup"),
        ("TED-MIB", "tedUnnumberedLinkGroup"),
        ("TED-MIB", "tedNumberedLinkGroup"),
        ("TED-MIB", "tedSwCapGroup"),
        ("TED-MIB", "tedSwCapMinLspBandwidthGroup"),
        ("TED-MIB", "tedSwCapIfMtuGroup"),
        ("TED-MIB", "tedSwCapIndicationGroup"),
        ("TED-MIB", "tedSrlgGroup"))
)
if mibBuilder.loadTexts:
...
tedModuleReadOnlyCompliance.setObjects(
      *(("TED-MIB", "tedMainGroup"),
        ("TED-MIB", "tedUnnumberedLinkGroup"),
        ("TED-MIB", "tedNumberedLinkGroup"),
        ("TED-MIB", "tedSwCapGroup"),
