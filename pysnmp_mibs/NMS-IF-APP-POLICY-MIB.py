...
# Notes
# -----
# ASN.1 source file://mibs/bdcom/NMS-IF-APP-POLICY-MIB
...
nmsIfAppPolicyEntry = _NmsIfAppPolicyEntry_Object(
    (1, 3, 6, 1, 4, 1, 3320, 9, 65, 1, 1)
)
nmsIfAppPolicyEntry.setIndexNames(
    (0, "NMS-IF-APP-POLICY-MIB", "nmsIfIndex"),
)
if mibBuilder.loadTexts:
