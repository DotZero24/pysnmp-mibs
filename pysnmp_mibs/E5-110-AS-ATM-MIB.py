...
asMaxNumOfChannels=_AsMaxNumOfChannels_Object((1,3,6,1,4,1,6321,1,2,3,1,99,1),_AsMaxNumOfChannels_Type())
asMaxNumOfChannels.setMaxAccess(_D)
if mibBuilder.loadTexts:asMaxNumOfChannels.setStatus(_A)
_AsChannelTable_Object=MibTable
asChannelTable=_AsChannelTable_Object((1,3,6,1,4,1,6321,1,2,3,1,99,2))
if mibBuilder.loadTexts:asChannelTable.setStatus(_A)
_AsChannelEntry_Object=MibTableRow
asChannelEntry=_AsChannelEntry_Object((1,3,6,1,4,1,6321,1,2,3,1,99,2,1))
...
asChannelVpi=_AsChannelVpi_Object((1,3,6,1,4,1,6321,1,2,3,1,99,2,1,1),_AsChannelVpi_Type())
...
asChannelVci=_AsChannelVci_Object((1,3,6,1,4,1,6321,1,2,3,1,99,2,1,2),_AsChannelVci_Type())
...
asChannelPvid=_AsChannelPvid_Object((1,3,6,1,4,1,6321,1,2,3,1,99,2,1,3),_AsChannelPvid_Type())
...
asChannelPriority=_AsChannelPriority_Object((1,3,6,1,4,1,6321,1,2,3,1,99,2,1,5),_AsChannelPriority_Type())
...
asChannelProfile=_AsChannelProfile_Object((1,3,6,1,4,1,6321,1,2,3,1,99,2,1,6),_AsChannelProfile_Type())
...
asChannelRowStatus=_AsChannelRowStatus_Object((1,3,6,1,4,1,6321,1,2,3,1,99,2,1,7),_AsChannelRowStatus_Type())
...
asMaxNumOfChannelProfiles=_AsMaxNumOfChannelProfiles_Object((1,3,6,1,4,1,6321,1,2,3,1,99,3),_AsMaxNumOfChannelProfiles_Type())
...
asChannelProfileTable=_AsChannelProfileTable_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6))
if mibBuilder.loadTexts:asChannelProfileTable.setStatus(_A)
_AsChannelProfileEntry_Object=MibTableRow
asChannelProfileEntry=_AsChannelProfileEntry_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1))
...
asChannelProfileName=_AsChannelProfileName_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1,1),_AsChannelProfileName_Type())
...
asChannelProfileEncap=_AsChannelProfileEncap_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1,2),_AsChannelProfileEncap_Type())
...
asChannelProfileAAL=_AsChannelProfileAAL_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1,3),_AsChannelProfileAAL_Type())
...
asChannelProfileClass=_AsChannelProfileClass_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1,4),_AsChannelProfileClass_Type())
...
asChannelProfilePcr=_AsChannelProfilePcr_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1,5),_AsChannelProfilePcr_Type())
...
asChannelProfileCdvt=_AsChannelProfileCdvt_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1,6),_AsChannelProfileCdvt_Type())
...
asChannelProfileScrMcr=_AsChannelProfileScrMcr_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1,7),_AsChannelProfileScrMcr_Type())
...
asChannelProfileBt=_AsChannelProfileBt_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1,8),_AsChannelProfileBt_Type())
...
asChannelProfileRowStatus=_AsChannelProfileRowStatus_Object((1,3,6,1,4,1,6321,1,2,3,1,99,6,1,9),_AsChannelProfileRowStatus_Type())
...
asChannelStatusTable=_AsChannelStatusTable_Object((1,3,6,1,4,1,6321,1,2,3,1,99,7))
if mibBuilder.loadTexts:asChannelStatusTable.setStatus(_A)
_AsChannelStatusEntry_Object=MibTableRow
asChannelStatusEntry=_AsChannelStatusEntry_Object((1,3,6,1,4,1,6321,1,2,3,1,99,7,1))
...
asChannelTxPackets=_AsChannelTxPackets_Object((1,3,6,1,4,1,6321,1,2,3,1,99,7,1,1),_AsChannelTxPackets_Type())
...
asChannelRxPackets=_AsChannelRxPackets_Object((1,3,6,1,4,1,6321,1,2,3,1,99,7,1,2),_AsChannelRxPackets_Type())
...
asChannelTxCells=_AsChannelTxCells_Object((1,3,6,1,4,1,6321,1,2,3,1,99,7,1,3),_AsChannelTxCells_Type())
...
asChannelRxCells=_AsChannelRxCells_Object((1,3,6,1,4,1,6321,1,2,3,1,99,7,1,4),_AsChannelRxCells_Type())
...
asMaxNumOfIpqosProfiles=_AsMaxNumOfIpqosProfiles_Object((1,3,6,1,4,1,6321,1,2,3,1,99,8),_AsMaxNumOfIpqosProfiles_Type())
...
asIpqosProfileTable=_AsIpqosProfileTable_Object((1,3,6,1,4,1,6321,1,2,3,1,99,9))
if mibBuilder.loadTexts:asIpqosProfileTable.setStatus(_A)
_AsIpqosProfileEntry_Object=MibTableRow
asIpqosProfileEntry=_AsIpqosProfileEntry_Object((1,3,6,1,4,1,6321,1,2,3,1,99,9,1))
...
asIpqosProfileName=_AsIpqosProfileName_Object((1,3,6,1,4,1,6321,1,2,3,1,99,9,1,1),_AsIpqosProfileName_Type())
...
asIpqosProfileEncap=_AsIpqosProfileEncap_Object((1,3,6,1,4,1,6321,1,2,3,1,99,9,1,2),_AsIpqosProfileEncap_Type())
...
asIpqosProfileQueueNumber=_AsIpqosProfileQueueNumber_Object((1,3,6,1,4,1,6321,1,2,3,1,99,9,1,3),_AsIpqosProfileQueueNumber_Type())
...
asIpqosProfileRowStatus=_AsIpqosProfileRowStatus_Object((1,3,6,1,4,1,6321,1,2,3,1,99,9,1,4),_AsIpqosProfileRowStatus_Type())
...
asIpqosProfileQueueTable=_AsIpqosProfileQueueTable_Object((1,3,6,1,4,1,6321,1,2,3,1,99,10))
if mibBuilder.loadTexts:asIpqosProfileQueueTable.setStatus(_A)
_AsIpqosProfileQueueEntry_Object=MibTableRow
asIpqosProfileQueueEntry=_AsIpqosProfileQueueEntry_Object((1,3,6,1,4,1,6321,1,2,3,1,99,10,1))
...
asIpqosProfileQueueIndex=_AsIpqosProfileQueueIndex_Object((1,3,6,1,4,1,6321,1,2,3,1,99,10,1,1),_AsIpqosProfileQueueIndex_Type())
...
asIpqosProfileAAL=_AsIpqosProfileAAL_Object((1,3,6,1,4,1,6321,1,2,3,1,99,10,1,2),_AsIpqosProfileAAL_Type())
...
asIpqosProfileLevel=_AsIpqosProfileLevel_Object((1,3,6,1,4,1,6321,1,2,3,1,99,10,1,3),_AsIpqosProfileLevel_Type())
...
asIpqosProfileRate=_AsIpqosProfileRate_Object((1,3,6,1,4,1,6321,1,2,3,1,99,10,1,4),_AsIpqosProfileRate_Type())
...
asShapingMode=_AsShapingMode_Object((1,3,6,1,4,1,6321,1,2,3,1,99,11),_AsShapingMode_Type())
