...
ospfVirtIfState, ospfLsdbType, ospfNbrRestartHelperAge, ospfNbrAddressLessIndex, ospfVirtIfNeighbor, ospfLsdbAreaId, ospfVirtNbrRtrId, ospfRestartInterval, ospfIfIpAddress, ospfRestartStatus, ospfNbrRestartHelperStatus, ospfNbrState, ospfVirtNbrRestartHelperExitReason, ospfNbrRtrId, ospfLsdbRouterId, ospfVirtNbrArea, ospf, ospfIfState, ospfVirtNbrRestartHelperAge, ospfVirtNbrState, ospfVirtIfAreaId, ospfAreaId, ospfLsdbLsid, ospfRestartExitReason, ospfAddressLessIf, ospfNbrIpAddr, ospfAreaNssaTranslatorState, ospfVirtNbrRestartHelperStatus, ospfRouterId, ospfExtLsdbLimit, ospfNbrRestartHelperExitReason = mibBuilder.importSymbols("OSPF-MIB", "ospfVirtIfState", "ospfLsdbType", "ospfNbrRestartHelperAge", "ospfNbrAddressLessIndex", "ospfVirtIfNeighbor", "ospfLsdbAreaId", "ospfVirtNbrRtrId", "ospfRestartInterval", "ospfIfIpAddress", "ospfRestartStatus", "ospfNbrRestartHelperStatus", "ospfNbrState", "ospfVirtNbrRestartHelperExitReason", "ospfNbrRtrId", "ospfLsdbRouterId", "ospfVirtNbrArea", "ospf", "ospfIfState", "ospfVirtNbrRestartHelperAge", "ospfVirtNbrState", "ospfVirtIfAreaId", "ospfAreaId", "ospfLsdbLsid", "ospfRestartExitReason", "ospfAddressLessIf", "ospfNbrIpAddr", "ospfAreaNssaTranslatorState", "ospfVirtNbrRestartHelperStatus", "ospfRouterId", "ospfExtLsdbLimit", "ospfNbrRestartHelperExitReason")
...
mibBuilder.exportSymbols("OSPF-TRAP-MIB", ospfIfRxBadPacket=ospfIfRxBadPacket, ospfVirtNbrRestartHelperStatusChange=ospfVirtNbrRestartHelperStatusChange, ospfLsdbApproachingOverflow=ospfLsdbApproachingOverflow, ospfOriginateLsa=ospfOriginateLsa, ospfTraps=ospfTraps, PYSNMP_MODULE_ID=ospfTrap, ospfPacketSrc=ospfPacketSrc, ospfTrapGroups=ospfTrapGroups, ospfVirtIfAuthFailure=ospfVirtIfAuthFailure, ospfIfStateChange=ospfIfStateChange, ospfVirtIfTxRetransmit=ospfVirtIfTxRetransmit, ospfNssaTranslatorStatusChange=ospfNssaTranslatorStatusChange, ospfTrapControlGroup=ospfTrapControlGroup, ospfTrapCompliance=ospfTrapCompliance, ospfTrapConformance=ospfTrapConformance, ospfLsdbOverflow=ospfLsdbOverflow, ospfTxRetransmit=ospfTxRetransmit, ospfNbrStateChange=ospfNbrStateChange, ospfVirtIfConfigError=ospfVirtIfConfigError, ospfVirtNbrStateChange=ospfVirtNbrStateChange, ospfSetTrap=ospfSetTrap, ospfNbrRestartHelperStatusChange=ospfNbrRestartHelperStatusChange, ospfRestartStatusChange=ospfRestartStatusChange, ospfVirtIfStateChange=ospfVirtIfStateChange, ospfConfigErrorType=ospfConfigErrorType, ospfMaxAgeLsa=ospfMaxAgeLsa, ospfTrapCompliance2=ospfTrapCompliance2, ospfIfConfigError=ospfIfConfigError, ospfTrapCompliances=ospfTrapCompliances, ospfVirtIfRxBadPacket=ospfVirtIfRxBadPacket, ospfTrapEventGroup=ospfTrapEventGroup, ospfTrap=ospfTrap, ospfIfAuthFailure=ospfIfAuthFailure, ospfPacketType=ospfPacketType, ospfTrapControl=ospfTrapControl)
