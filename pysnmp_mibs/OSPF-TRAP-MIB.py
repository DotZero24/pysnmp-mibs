...
# Notes
# -----
# ASN.1 source file://mibs/rfc/OSPF-TRAP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:25:00 2025
...
ospfTrapCompliance.setObjects(
      *(("OSPF-TRAP-MIB", "ospfTrapControlGroup"),
        ("OSPF-TRAP-MIB", "ospfTrapControlGroup"))
)
if mibBuilder.loadTexts:
...
ospfTrapCompliance2.setObjects(
      *(("OSPF-TRAP-MIB", "ospfTrapControlGroup"),
        ("OSPF-TRAP-MIB", "ospfTrapEventGroup"))
)
if mibBuilder.loadTexts:
