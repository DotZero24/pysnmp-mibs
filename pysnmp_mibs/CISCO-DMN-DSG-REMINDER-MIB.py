...
mibBuilder.exportSymbols("CISCO-DMN-DSG-REMINDER-MIB", reminderTimerID=reminderTimerID, reminderTimerFrequency=reminderTimerFrequency, reminderTimerDay=reminderTimerDay, reminderTimerEvtParentalRating=reminderTimerEvtParentalRating, reminderTimerChName=reminderTimerChName, reminderTimerEvtName=reminderTimerEvtName, reminderTimerEntry=reminderTimerEntry, reminderTimerStartTime=reminderTimerStartTime, reminderTable=reminderTable, reminderTimerChType=reminderTimerChType, reminderTimerRowStatus=reminderTimerRowStatus, reminderTimerTable=reminderTimerTable, reminderTimerEndTime=reminderTimerEndTime, reminderTimerChNum=reminderTimerChNum, ciscoDSGReminder=ciscoDSGReminder, PYSNMP_MODULE_ID=ciscoDSGReminder)
