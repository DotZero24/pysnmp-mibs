...
fsHttpMIBObjects=_FsHttpMIBObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,2,44,1))
_FutureHttpScalars_ObjectIdentity=ObjectIdentity
futureHttpScalars=_FutureHttpScalars_ObjectIdentity((1,3,6,1,4,1,10876,101,2,44,1,1))
...
fsHttpRedirectionStatus=_FsHttpRedirectionStatus_Object((1,3,6,1,4,1,10876,101,2,44,1,1,1),_FsHttpRedirectionStatus_Type())
...
fsOperHttpAuthScheme=_FsOperHttpAuthScheme_Object((1,3,6,1,4,1,10876,101,2,44,1,1,2),_FsOperHttpAuthScheme_Type())
...
fsConfigHttpAuthScheme=_FsConfigHttpAuthScheme_Object((1,3,6,1,4,1,10876,101,2,44,1,1,3),_FsConfigHttpAuthScheme_Type())
...
fsHttpRequestCount=_FsHttpRequestCount_Object((1,3,6,1,4,1,10876,101,2,44,1,1,4),_FsHttpRequestCount_Type())
...
fsHttpRequestDiscards=_FsHttpRequestDiscards_Object((1,3,6,1,4,1,10876,101,2,44,1,1,5),_FsHttpRequestDiscards_Type())
...
futureHttpTables=_FutureHttpTables_ObjectIdentity((1,3,6,1,4,1,10876,101,2,44,1,2))
_FsHttpRedirectionTable_Object=MibTable
fsHttpRedirectionTable=_FsHttpRedirectionTable_Object((1,3,6,1,4,1,10876,101,2,44,1,2,1))
if mibBuilder.loadTexts:fsHttpRedirectionTable.setStatus(_A)
_FsHttpRedirectionEntry_Object=MibTableRow
fsHttpRedirectionEntry=_FsHttpRedirectionEntry_Object((1,3,6,1,4,1,10876,101,2,44,1,2,1,1))
...
fsHttpRedirectionURL=_FsHttpRedirectionURL_Object((1,3,6,1,4,1,10876,101,2,44,1,2,1,1,1),_FsHttpRedirectionURL_Type())
...
fsHttpRedirectedSrvAddrType=_FsHttpRedirectedSrvAddrType_Object((1,3,6,1,4,1,10876,101,2,44,1,2,1,1,2),_FsHttpRedirectedSrvAddrType_Type())
...
fsHttpRedirectedSrvIP=_FsHttpRedirectedSrvIP_Object((1,3,6,1,4,1,10876,101,2,44,1,2,1,1,3),_FsHttpRedirectedSrvIP_Type())
...
fsHttpRedirectedSrvDomainName=_FsHttpRedirectedSrvDomainName_Object((1,3,6,1,4,1,10876,101,2,44,1,2,1,1,4),_FsHttpRedirectedSrvDomainName_Type())
...
fsHttpRedirectionEntryStatus=_FsHttpRedirectionEntryStatus_Object((1,3,6,1,4,1,10876,101,2,44,1,2,1,1,5),_FsHttpRedirectionEntryStatus_Type())
