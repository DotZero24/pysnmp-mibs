...
# Notes
# -----
# ASN.1 source file://mibs/teltonika/TELTONIKA-MIB
...
relay0Notification = NotificationType(
    (1, 3, 6, 1, 4, 1, 48690, 4, 2, 8)
)
if mibBuilder.loadTexts:
    relay0Notification.setStatus(
        "current"
    )

digitalInput2Notification = NotificationType(
    (1, 3, 6, 1, 4, 1, 48690, 4, 2, 12)
)
if mibBuilder.loadTexts:
    digitalInput2Notification.setStatus(
        "current"
    )

digitalIioNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 48690, 4, 2, 13)
)
if mibBuilder.loadTexts:
    digitalIioNotification.setStatus(
        "current"
    )

digitalOutput2Notification = NotificationType(
    (1, 3, 6, 1, 4, 1, 48690, 4, 2, 14)
)
if mibBuilder.loadTexts:
    digitalOutput2Notification.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"teltonika": teltonika,
       ...
       "relay0Notification": relay0Notification,
       "digitalInput2Notification": digitalInput2Notification,
       "digitalIioNotification": digitalIioNotification,
       "digitalOutput2Notification": digitalOutput2Notification,
       "hotspot": hotspot,
       "hsState": hsState,
       "hsIP": hsIP,
       "hsNet": hsNet,
