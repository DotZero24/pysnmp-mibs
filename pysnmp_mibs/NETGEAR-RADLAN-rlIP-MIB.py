# SNMP MIB module (NETGEAR-RADLAN-rlIP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-rlIP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:28:56 2025
...
rlIpAddressTable = _RlIpAddressTable_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 250, 1)
)
if mibBuilder.loadTexts:
    rlIpAddressTable.setStatus("current")
_RlIpAddressEntry_Object = MibTableRow
rlIpAddressEntry = _RlIpAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 250, 1, 1)
)
rlIpAddressEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-rlIP-MIB", "rlIpAddressAddrType"),
    (0, "NETGEAR-RADLAN-rlIP-MIB", "rlIpAddressAddr"),
    (0, "NETGEAR-RADLAN-rlIP-MIB", "rlIpAddressOrigin"),
    (0, "NETGEAR-RADLAN-rlIP-MIB", "rlIpAddressGeneralPrefixName"),
)
if mibBuilder.loadTexts:
...
rlIpAddressLastChanged = _RlIpAddressLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 250, 1, 1, 10),
...
rlIpAddressRowStatus = _RlIpAddressRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 250, 1, 1, 11),
...
rlIpAddressStorageType = _RlIpAddressStorageType_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 250, 1, 1, 12),
...
rlIpAddressExtdPrefixLength = _RlIpAddressExtdPrefixLength_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 250, 1, 1, 13),
...
rlIpAddressCompleteAddr = _RlIpAddressCompleteAddr_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 250, 1, 1, 14),
