...
rlIp=ModuleIdentity((1,3,6,1,4,1,4526,17,250))
...
rlIpAddressTable=_RlIpAddressTable_Object((1,3,6,1,4,1,4526,17,250,1))
if mibBuilder.loadTexts:rlIpAddressTable.setStatus(_A)
_RlIpAddressEntry_Object=MibTableRow
rlIpAddressEntry=_RlIpAddressEntry_Object((1,3,6,1,4,1,4526,17,250,1,1))
...
rlIpAddressAddrType=_RlIpAddressAddrType_Object((1,3,6,1,4,1,4526,17,250,1,1,1),_RlIpAddressAddrType_Type())
...
rlIpAddressAddr=_RlIpAddressAddr_Object((1,3,6,1,4,1,4526,17,250,1,1,2),_RlIpAddressAddr_Type())
...
rlIpAddressOrigin=_RlIpAddressOrigin_Object((1,3,6,1,4,1,4526,17,250,1,1,3),_RlIpAddressOrigin_Type())
...
rlIpAddressGeneralPrefixName=_RlIpAddressGeneralPrefixName_Object((1,3,6,1,4,1,4526,17,250,1,1,4),_RlIpAddressGeneralPrefixName_Type())
...
rlIpAddressIfIndex=_RlIpAddressIfIndex_Object((1,3,6,1,4,1,4526,17,250,1,1,5),_RlIpAddressIfIndex_Type())
...
rlIpAddressExtdType=_RlIpAddressExtdType_Object((1,3,6,1,4,1,4526,17,250,1,1,6),_RlIpAddressExtdType_Type())
...
rlIpAddressPrefix=_RlIpAddressPrefix_Object((1,3,6,1,4,1,4526,17,250,1,1,7),_RlIpAddressPrefix_Type())
...
rlIpAddressStatus=_RlIpAddressStatus_Object((1,3,6,1,4,1,4526,17,250,1,1,8),_RlIpAddressStatus_Type())
...
rlIpAddressCreated=_RlIpAddressCreated_Object((1,3,6,1,4,1,4526,17,250,1,1,9),_RlIpAddressCreated_Type())
...
rlIpAddressLastChanged=_RlIpAddressLastChanged_Object((1,3,6,1,4,1,4526,17,250,1,1,10),_RlIpAddressLastChanged_Type())
...
rlIpAddressRowStatus=_RlIpAddressRowStatus_Object((1,3,6,1,4,1,4526,17,250,1,1,11),_RlIpAddressRowStatus_Type())
...
rlIpAddressStorageType=_RlIpAddressStorageType_Object((1,3,6,1,4,1,4526,17,250,1,1,12),_RlIpAddressStorageType_Type())
...
rlIpAddressExtdPrefixLength=_RlIpAddressExtdPrefixLength_Object((1,3,6,1,4,1,4526,17,250,1,1,13),_RlIpAddressExtdPrefixLength_Type())
...
rlIpAddressCompleteAddr=_RlIpAddressCompleteAddr_Object((1,3,6,1,4,1,4526,17,250,1,1,14),_RlIpAddressCompleteAddr_Type())
