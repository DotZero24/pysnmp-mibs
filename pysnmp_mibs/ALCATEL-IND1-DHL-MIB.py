...
alcatelIND1DHLMIB=ModuleIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1))
_AlcatelIND1DHLMIBNotifications_ObjectIdentity=ObjectIdentity
alcatelIND1DHLMIBNotifications=_AlcatelIND1DHLMIBNotifications_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,0))
...
alcatelIND1DHLMIBObjects=_AlcatelIND1DHLMIBObjects_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,1))
if mibBuilder.loadTexts:alcatelIND1DHLMIBObjects.setStatus(_A)
_AlaDHLSessionConfig_ObjectIdentity=ObjectIdentity
alaDHLSessionConfig=_AlaDHLSessionConfig_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1))
_AlaDHLSessionTable_Object=MibTable
alaDHLSessionTable=_AlaDHLSessionTable_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1))
if mibBuilder.loadTexts:alaDHLSessionTable.setStatus(_A)
_AlaDHLSessionEntry_Object=MibTableRow
alaDHLSessionEntry=_AlaDHLSessionEntry_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1,1))
...
alaDHLSessionIndex=_AlaDHLSessionIndex_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1,1,1),_AlaDHLSessionIndex_Type())
...
alaDHLSessionDescr=_AlaDHLSessionDescr_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1,1,2),_AlaDHLSessionDescr_Type())
...
alaDHLSessionAdminStatus=_AlaDHLSessionAdminStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1,1,3),_AlaDHLSessionAdminStatus_Type())
...
alaDHLSessionOperStatus=_AlaDHLSessionOperStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1,1,4),_AlaDHLSessionOperStatus_Type())
...
alaDHLSessionPreemptionTime=_AlaDHLSessionPreemptionTime_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1,1,5),_AlaDHLSessionPreemptionTime_Type())
...
alaDHLSessionAdminMacFlushing=_AlaDHLSessionAdminMacFlushing_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1,1,6),_AlaDHLSessionAdminMacFlushing_Type())
...
alaDHLSessionActiveMacFlushing=_AlaDHLSessionActiveMacFlushing_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1,1,7),_AlaDHLSessionActiveMacFlushing_Type())
...
alaDHLSessionRowStatus=_AlaDHLSessionRowStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,1,1,1,8),_AlaDHLSessionRowStatus_Type())
...
alaDHLLinksConfig=_AlaDHLLinksConfig_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,2))
_AlaDHLLinksTable_Object=MibTable
alaDHLLinksTable=_AlaDHLLinksTable_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,2,1))
if mibBuilder.loadTexts:alaDHLLinksTable.setStatus(_A)
_AlaDHLLinksEntry_Object=MibTableRow
alaDHLLinksEntry=_AlaDHLLinksEntry_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,2,1,1))
...
alaDHLLinkslinkA=_AlaDHLLinkslinkA_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,2,1,1,1),_AlaDHLLinkslinkA_Type())
...
alaDHLLinkslinkB=_AlaDHLLinkslinkB_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,2,1,1,2),_AlaDHLLinkslinkB_Type())
...
alaDHLLinkslinkAOperStatus=_AlaDHLLinkslinkAOperStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,2,1,1,3),_AlaDHLLinkslinkAOperStatus_Type())
...
alaDHLLinkslinkBOperStatus=_AlaDHLLinkslinkBOperStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,2,1,1,4),_AlaDHLLinkslinkBOperStatus_Type())
...
alaDHLLinksRowStatus=_AlaDHLLinksRowStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,2,1,1,5),_AlaDHLLinksRowStatus_Type())
...
alaDHLVpa=_AlaDHLVpa_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,3))
_AlaDHLVpaTable_Object=MibTable
alaDHLVpaTable=_AlaDHLVpaTable_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,3,1))
if mibBuilder.loadTexts:alaDHLVpaTable.setStatus(_A)
_AlaDHLVpaEntry_Object=MibTableRow
alaDHLVpaEntry=_AlaDHLVpaEntry_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,3,1,1))
...
alaDHLVpalink=_AlaDHLVpalink_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,3,1,1,1),_AlaDHLVpalink_Type())
...
alaDHLVpaVlan=_AlaDHLVpaVlan_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,3,1,1,2),_AlaDHLVpaVlan_Type())
...
alaDHLVpaVlanType=_AlaDHLVpaVlanType_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,3,1,1,3),_AlaDHLVpaVlanType_Type())
...
alaDHLVpaActiveLink=_AlaDHLVpaActiveLink_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,3,1,1,4),_AlaDHLVpaActiveLink_Type())
...
alaDHLVlanMap=_AlaDHLVlanMap_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,4))
_AlaDHLVlanMapTable_Object=MibTable
alaDHLVlanMapTable=_AlaDHLVlanMapTable_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,4,1))
if mibBuilder.loadTexts:alaDHLVlanMapTable.setStatus(_A)
_AlaDHLVlanMapEntry_Object=MibTableRow
alaDHLVlanMapEntry=_AlaDHLVlanMapEntry_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,4,1,1))
...
alaDHLVlanMapVlanStart=_AlaDHLVlanMapVlanStart_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,4,1,1,1),_AlaDHLVlanMapVlanStart_Type())
...
alaDHLVlanMapVlanEnd=_AlaDHLVlanMapVlanEnd_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,4,1,1,2),_AlaDHLVlanMapVlanEnd_Type())
...
alaDHLVlanMapRowStatus=_AlaDHLVlanMapRowStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,4,1,1,3),_AlaDHLVlanMapRowStatus_Type())
...
alaDHLTrapsObj=_AlaDHLTrapsObj_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,5))
_AlaDHLSessionID_Type=Integer32
_AlaDHLSessionID_Object=MibScalar
alaDHLSessionID=_AlaDHLSessionID_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,5,1),_AlaDHLSessionID_Type())
...
alaDHLPortFrom=_AlaDHLPortFrom_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,5,2),_AlaDHLPortFrom_Type())
...
alaDHLPortTo=_AlaDHLPortTo_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,5,3),_AlaDHLPortTo_Type())
...
alaDHLVlanMoveReason=_AlaDHLVlanMoveReason_Object((1,3,6,1,4,1,6486,800,1,2,1,63,1,1,5,4),_AlaDHLVlanMoveReason_Type())
...
alcatelIND1DHLMIBConformance=_AlcatelIND1DHLMIBConformance_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,2))
if mibBuilder.loadTexts:alcatelIND1DHLMIBConformance.setStatus(_A)
_AlcatelIND1DHLMIBGroups_ObjectIdentity=ObjectIdentity
alcatelIND1DHLMIBGroups=_AlcatelIND1DHLMIBGroups_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,2,1))
if mibBuilder.loadTexts:alcatelIND1DHLMIBGroups.setStatus(_A)
_AlcatelIND1DHLMIBCompliances_ObjectIdentity=ObjectIdentity
alcatelIND1DHLMIBCompliances=_AlcatelIND1DHLMIBCompliances_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,63,1,2,2))
if mibBuilder.loadTexts:alcatelIND1DHLMIBCompliances.setStatus(_A)
alaDHLSessionGroup=ObjectGroup((1,3,6,1,4,1,6486,800,1,2,1,63,1,2,1,1))
...
alaDHLLinksGroup=ObjectGroup((1,3,6,1,4,1,6486,800,1,2,1,63,1,2,1,2))
alaDHLLinksGroup.setObjects(*((_B,_a),(_B,_b),(_B,_c)))
if mibBuilder.loadTexts:alaDHLLinksGroup.setStatus(_A)
alaDHLVpaGroup=ObjectGroup((1,3,6,1,4,1,6486,800,1,2,1,63,1,2,1,3))
alaDHLVpaGroup.setObjects(*((_B,_d),(_B,_e)))
if mibBuilder.loadTexts:alaDHLVpaGroup.setStatus(_A)
alaDHLVlanMapGroup=ObjectGroup((1,3,6,1,4,1,6486,800,1,2,1,63,1,2,1,4))
alaDHLVlanMapGroup.setObjects((_B,_f))
if mibBuilder.loadTexts:alaDHLVlanMapGroup.setStatus(_A)
alaDHLNotificationObjectGroup=ObjectGroup((1,3,6,1,4,1,6486,800,1,2,1,63,1,2,1,5))
...
alaDHLVlanMoveTrap=NotificationType((1,3,6,1,4,1,6486,800,1,2,1,63,1,0,1))
alaDHLVlanMoveTrap.setObjects(*((_B,_J),(_B,_K),(_B,_L),(_B,_M)))
if mibBuilder.loadTexts:alaDHLVlanMoveTrap.setStatus(_A)
alaDHLNotificationGroup=NotificationGroup((1,3,6,1,4,1,6486,800,1,2,1,63,1,2,1,6))
alaDHLNotificationGroup.setObjects((_B,_g))
if mibBuilder.loadTexts:alaDHLNotificationGroup.setStatus(_A)
alcatelIND1DHLMIBCompliance=ModuleCompliance((1,3,6,1,4,1,6486,800,1,2,1,63,1,2,2,1))
