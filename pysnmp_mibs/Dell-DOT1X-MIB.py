# SNMP MIB module (Dell-DOT1X-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-DOT1X-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:40 2025
...
rldot1xAuthMultiStatsEntry.setIndexNames(
    (0, "Dell-DOT1X-MIB", "rldot1xAuthMultiStatsPortNumber"),
    (0, "Dell-DOT1X-MIB", "rldot1xAuthMultiStatsSourceMac"),
)
if mibBuilder.loadTexts:
...
rldot1xAuthMultiDiagEntry.setIndexNames(
    (0, "Dell-DOT1X-MIB", "rldot1xAuthMultiDiagPortNumber"),
    (0, "Dell-DOT1X-MIB", "rldot1xAuthMultiDiagSourceMac"),
)
if mibBuilder.loadTexts:
...
rldot1xAuthMultiSessionStatsEntry.setIndexNames(
    (0, "Dell-DOT1X-MIB", "rldot1xAuthMultiSessionStatsPortNumber"),
    (0, "Dell-DOT1X-MIB", "rldot1xAuthMultiSessionStatsSourceMac"),
)
if mibBuilder.loadTexts:
...
rldot1xAuthMultiConfigEntry.setIndexNames(
    (0, "Dell-DOT1X-MIB", "rldot1xAuthMultiPortNumber"),
    (0, "Dell-DOT1X-MIB", "rldot1xAuthMultiSourceMac"),
)
if mibBuilder.loadTexts:
...
rldot1xLockedCientsEntry.setIndexNames(
    (0, "Dell-DOT1X-MIB", "rldot1xLockedCientsPortNumber"),
    (0, "Dell-DOT1X-MIB", "rldot1xLockedCientsSourceMac"),
)
if mibBuilder.loadTexts:
