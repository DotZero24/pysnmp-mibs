...
mibBuilder.exportSymbols("ELTEX-MES-PHYSICAL-DESCRIPTION-MIB", eltMesPhysicalDescription=eltMesPhysicalDescription, eltPhdTransceiverInfoFiberDiameterType=eltPhdTransceiverInfoFiberDiameterType, eltPhdTransceiverThresholdLowWarning=eltPhdTransceiverThresholdLowWarning, eltPhdTransceiverInfoWaveLength=eltPhdTransceiverInfoWaveLength, eltCascadeLastChange=eltCascadeLastChange, eltMesPhdTransceiver=eltMesPhdTransceiver, eltCascadeTable=eltCascadeTable, eltPhdNsfTime=eltPhdNsfTime, eltPhdTransceiverThresholdHighAlarm=eltPhdTransceiverThresholdHighAlarm, eltCascadeEntry=eltCascadeEntry, eltPhdTransceiverThresholdLowAlarm=eltPhdTransceiverThresholdLowAlarm, eltPhdTransceiverThresholdAction=eltPhdTransceiverThresholdAction, eltCascadeDuplexOperMode=eltCascadeDuplexOperMode, eltPhdTransceiverInfoTable=eltPhdTransceiverInfoTable, eltPhdTransceiverInfoSerialNumber=eltPhdTransceiverInfoSerialNumber, eltPhdTransceiverInfoVendorRev=eltPhdTransceiverInfoVendorRev, eltPhdNsfEnable=eltPhdNsfEnable, eltCascadeOperSpeedDuplexAutoNegotiation=eltCascadeOperSpeedDuplexAutoNegotiation, eltPhdTransceiverInfoVendorName=eltPhdTransceiverInfoVendorName, eltCascadeOperStatus=eltCascadeOperStatus, eltPhdUnitGenParamCommitHash=eltPhdUnitGenParamCommitHash, eltPhdTransceiverInfoTransferDistance=eltPhdTransceiverInfoTransferDistance, eltPhdTransceiverInfoType=eltPhdTransceiverInfoType, eltPhdTransceiverThresholdHighWarning=eltPhdTransceiverThresholdHighWarning, eltPhdTransceiverInfoComplianceCode=eltPhdTransceiverInfoComplianceCode, eltPhdUnitGenParamEntry=eltPhdUnitGenParamEntry, eltPhdTransceiverInfoPartNumber=eltPhdTransceiverInfoPartNumber, eltPhdTransceiverInfoConnectorType=eltPhdTransceiverInfoConnectorType, eltPhdTransceiverThresholdTable=eltPhdTransceiverThresholdTable, eltPhdTransceiverThresholdEntry=eltPhdTransceiverThresholdEntry, eltPhdTransceiverThresholdType=eltPhdTransceiverThresholdType, eltPhdUnitGenParamBuildNumber=eltPhdUnitGenParamBuildNumber, eltMesPhdNsf=eltMesPhdNsf, eltPhdUnitGenParamTable=eltPhdUnitGenParamTable, eltPhdTransceiverInfoEntry=eltPhdTransceiverInfoEntry, eltPhdUnitGenParamBuildTag=eltPhdUnitGenParamBuildTag, eltPhdTransceiverInfoDiagnostic=eltPhdTransceiverInfoDiagnostic, eltCascadeOperMdix=eltCascadeOperMdix, eltCascadeIfType=eltCascadeIfType, eltCascadeTransceiverType=eltCascadeTransceiverType, PYSNMP_MODULE_ID=eltMesPhysicalDescription)
