...
if mibBuilder.loadTexts:fastPathOutboundTelnetPrivate.setRevisions(('2007-05-23 00:00',))
_AgentOutboundTelnetGroup_ObjectIdentity=ObjectIdentity
agentOutboundTelnetGroup=_AgentOutboundTelnetGroup_ObjectIdentity((1,3,6,1,4,1,4413,1,1,19,1))
...
agentOutboundTelnetAdminMode=_AgentOutboundTelnetAdminMode_Object((1,3,6,1,4,1,4413,1,1,19,1,1),_AgentOutboundTelnetAdminMode_Type())
...
agentOutboundTelnetMaxNoOfSessions=_AgentOutboundTelnetMaxNoOfSessions_Object((1,3,6,1,4,1,4413,1,1,19,1,2),_AgentOutboundTelnetMaxNoOfSessions_Type())
