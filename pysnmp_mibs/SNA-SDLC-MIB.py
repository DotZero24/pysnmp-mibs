...
mibBuilder.exportSymbols("SNA-SDLC-MIB", sdlcCorePortAdminGroup=sdlcCorePortAdminGroup, sdlcLSStatsTESTsOut=sdlcLSStatsTESTsOut, sdlcLSStatsUIFramesOut=sdlcLSStatsUIFramesOut, sdlcLSOperEntry=sdlcLSOperEntry, sdlcLSAdminRowStatus=sdlcLSAdminRowStatus, sdlcLSOperMODULO=sdlcLSOperMODULO, sdlcPrimaryGroups=sdlcPrimaryGroups, sdlcLSAdminMAXIN=sdlcLSAdminMAXIN, sdlcLSOperLastFailREPLYTOs=sdlcLSOperLastFailREPLYTOs, sdlcPortOperLastFailCause=sdlcPortOperLastFailCause, sdlc=sdlc, sdlcLSAddress=sdlcLSAddress, sdlcPortStatsDwarfFrames=sdlcPortStatsDwarfFrames, sdlcLSOperMAXOUT=sdlcLSOperMAXOUT, sdlcLSAdminMAXDATARcv=sdlcLSAdminMAXDATARcv, sdlcPortOperName=sdlcPortOperName, sdlcLSOperLastFailTime=sdlcLSOperLastFailTime, sdlcPortOperLastModifyTime=sdlcPortOperLastModifyTime, sdlcLSStatsREJsIn=sdlcLSStatsREJsIn, sdlcPortOperTable=sdlcPortOperTable, sdlcLSStatsRNRLIMITs=sdlcLSStatsRNRLIMITs, sdlcCompliances=sdlcCompliances, sdlcLSOperGPoll=sdlcLSOperGPoll, sdlcLSStatsTESTsIn=sdlcLSStatsTESTsIn, sdlcLSStatsRetriesExps=sdlcLSStatsRetriesExps, sdlcLSStatsLocalBusies=sdlcLSStatsLocalBusies, sdlcLSStatsSNRMIn=sdlcLSStatsSNRMIn, sdlcPortStatsRNRLIMITs=sdlcPortStatsRNRLIMITs, sdlcLSStatsDISCOut=sdlcLSStatsDISCOut, sdlcLSStatsActivityTOs=sdlcLSStatsActivityTOs, sdlcPrimaryMultipointCompliance=sdlcPrimaryMultipointCompliance, sdlcLSOperRETRIESm=sdlcLSOperRETRIESm, sdlcLSOperLastFailFRMRInfo=sdlcLSOperLastFailFRMRInfo, sdlcPrimaryGroup=sdlcPrimaryGroup, sdlcPortAdminRole=sdlcPortAdminRole, sdlcLSStatsIFramesOut=sdlcLSStatsIFramesOut, sdlcPrimaryMultipointGroup=sdlcPrimaryMultipointGroup, PYSNMP_MODULE_ID=snaDLC, sdlcPortAdminPAUSE=sdlcPortAdminPAUSE, sdlcPortStatsRemoteBusies=sdlcPortStatsRemoteBusies, sdlcPortStatusChange=sdlcPortStatusChange, sdlcPortOperRole=sdlcPortOperRole, sdlcPortAdminTopology=sdlcPortAdminTopology, sdlcPortOperSlowPollTimer=sdlcPortOperSlowPollTimer, sdlcGroups=sdlcGroups, sdlcPortAdminSERVLIM=sdlcPortAdminSERVLIM, sdlcLSStatsRetransmitsIn=sdlcLSStatsRetransmitsIn, sdlcLSStatsDMIn=sdlcLSStatsDMIn, sdlcPortStatsEntry=sdlcPortStatsEntry, sdlcPortOperACTIVTO=sdlcPortOperACTIVTO, sdlcLSStatsPollRspsIn=sdlcLSStatsPollRspsIn, sdlcLSAdminMAXDATASend=sdlcLSAdminMAXDATASend, sdlcLSAdminMAXOUT=sdlcLSAdminMAXOUT, sdlcLSAdminEntry=sdlcLSAdminEntry, sdlcLSOperMAXDATASend=sdlcLSOperMAXDATASend, sdlcPortStatsOctetsIn=sdlcPortStatsOctetsIn, sdlcPortOperSERVLIM=sdlcPortOperSERVLIM, sdlcLSOperName=sdlcLSOperName, sdlcLSStatsBLUsOut=sdlcLSStatsBLUsOut, sdlcLSOperLastFailCtrlOut=sdlcLSOperLastFailCtrlOut, sdlcLSOperState=sdlcLSOperState, sdlcLSAdminRNRLIMIT=sdlcLSAdminRNRLIMIT, sdlcPortStatsPollRspsOut=sdlcPortStatsPollRspsOut, sdlcLSStatsXIDsOut=sdlcLSStatsXIDsOut, sdlcLSStatsSIMsIn=sdlcLSStatsSIMsIn, sdlcPortOperSlowPollMethod=sdlcPortOperSlowPollMethod, sdlcPortStatsPollsOut=sdlcPortStatsPollsOut, sdlcLSStatsUAOut=sdlcLSStatsUAOut, sdlcPortGroup=sdlcPortGroup, sdlcLSOperEcho=sdlcLSOperEcho, sdlcLSStatsDISCIn=sdlcLSStatsDISCIn, sdlcPortAdminEntry=sdlcPortAdminEntry, sdlcPortOperPAUSE=sdlcPortOperPAUSE, sdlcLSAdminState=sdlcLSAdminState, sdlcLSOperRNRLIMIT=sdlcLSOperRNRLIMIT, sdlcLSOperMAXIN=sdlcLSOperMAXIN, sdlcLSOperXmitRcvCap=sdlcLSOperXmitRcvCap, sdlcLSStatsREJsOut=sdlcLSStatsREJsOut, sdlcLSStatsRetransmitsOut=sdlcLSStatsRetransmitsOut, sdlcLSStatsSIMsOut=sdlcLSStatsSIMsOut, sdlcLSOperDATMODE=sdlcLSOperDATMODE, sdlcCoreLSStatsGroup=sdlcCoreLSStatsGroup, sdlcLSAdminRETRIESn=sdlcLSAdminRETRIESn, sdlcLSAdminMODULO=sdlcLSAdminMODULO, sdlcPortAdminName=sdlcPortAdminName, sdlcLSOperRole=sdlcLSOperRole, sdlcLSStatsSNRMOut=sdlcLSStatsSNRMOut, sdlcPortAdminTable=sdlcPortAdminTable, sdlcCorePortStatsGroup=sdlcCorePortStatsGroup, sdlcLSStatsDMOut=sdlcLSStatsDMOut, sdlcLSAdminGPoll=sdlcLSAdminGPoll, sdlcLSAdminISTATUS=sdlcLSAdminISTATUS, sdlcLSStatsEntry=sdlcLSStatsEntry, sdlcCorePortOperGroup=sdlcCorePortOperGroup, sdlcLSAdminRETRIESm=sdlcLSAdminRETRIESm, sdlcLSOperRETRIESt=sdlcLSOperRETRIESt, sdlcPortAdminType=sdlcPortAdminType, sdlcLSAdminXmitRcvCap=sdlcLSAdminXmitRcvCap, sdlcLSStatsPollsIn=sdlcLSStatsPollsIn, sdlcLSStatsRIMsOut=sdlcLSStatsRIMsOut, sdlcCoreLSOperGroup=sdlcCoreLSOperGroup, sdlcLSAdminDATMODE=sdlcLSAdminDATMODE, sdlcPortAdminSlowPollTimer=sdlcPortAdminSlowPollTimer, sdlcLSStatsOctetsOut=sdlcLSStatsOctetsOut, sdlcLSStatsPollsOut=sdlcLSStatsPollsOut, sdlcPrimaryCompliance=sdlcPrimaryCompliance, sdlcLSOperREPLYTO=sdlcLSOperREPLYTO, sdlcLSStatsRemoteBusies=sdlcLSStatsRemoteBusies, sdlcLSAdminREPLYTO=sdlcLSAdminREPLYTO, sdlcPortStatsPollRspsIn=sdlcPortStatsPollRspsIn, sdlcLSStatsRIMsIn=sdlcLSStatsRIMsIn, sdlcPortOperTopology=sdlcPortOperTopology, sdlcPortOperType=sdlcPortOperType, sdlcLSStatsXIDsIn=sdlcLSStatsXIDsIn, sdlcLSAdminSimRim=sdlcLSAdminSimRim, sdlcPortAdminACTIVTO=sdlcPortAdminACTIVTO, sdlcPortStatsRetriesExps=sdlcPortStatsRetriesExps, sdlcLSStatsFRMRsOut=sdlcLSStatsFRMRsOut, sdlcLSStatsFRMRsIn=sdlcLSStatsFRMRsIn, sdlcLSOperSimRim=sdlcLSOperSimRim, sdlcPortStatsPollsIn=sdlcPortStatsPollsIn, sdlcLSOperLastFailCtrlIn=sdlcLSOperLastFailCtrlIn, sdlcPortStatsRetransmitsIn=sdlcPortStatsRetransmitsIn, sdlcLSAdminTable=sdlcLSAdminTable, sdlcPortStatsLocalBusies=sdlcPortStatsLocalBusies, sdlcPortOperEntry=sdlcPortOperEntry, sdlcLSStatsProtocolErrs=sdlcLSStatsProtocolErrs, sdlcPortStatsPhysicalFailures=sdlcPortStatsPhysicalFailures, sdlcLSStatsBLUsIn=sdlcLSStatsBLUsIn, sdlcPortStatsActivityTOs=sdlcPortStatsActivityTOs, sdlcLSStatsIFramesIn=sdlcLSStatsIFramesIn, sdlcTraps=sdlcTraps, sdlcLSStatsPollRspsOut=sdlcLSStatsPollRspsOut, sdlcLSAdminRETRIESt=sdlcLSAdminRETRIESt, sdlcLSOperRETRIESn=sdlcLSOperRETRIESn, sdlcCoreCompliance=sdlcCoreCompliance, sdlcPortStatsTable=sdlcPortStatsTable, sdlcPortStatsRetransmitsOut=sdlcPortStatsRetransmitsOut, sdlcPortAdminISTATUS=sdlcPortAdminISTATUS, sdlcLSGroup=sdlcLSGroup, sdlcLSStatsUIFramesIn=sdlcLSStatsUIFramesIn, sdlcLSStatsUAIn=sdlcLSStatsUAIn, sdlcPortOperLastFailTime=sdlcPortOperLastFailTime, sdlcLSOperLastFailCause=sdlcLSOperLastFailCause, sdlcPortStatsIFramesOut=sdlcPortStatsIFramesOut, snaDLC=snaDLC, sdlcLSStatusChange=sdlcLSStatusChange, sdlcConformance=sdlcConformance, sdlcPortStatsOctetsOut=sdlcPortStatsOctetsOut, sdlcPortStatsProtocolErrs=sdlcPortStatsProtocolErrs, sdlcLSAdminName=sdlcLSAdminName, sdlcLSStatsTable=sdlcLSStatsTable, sdlcCoreGroups=sdlcCoreGroups, sdlcLSOperLastModifyTime=sdlcLSOperLastModifyTime, sdlcPortStatsInvalidAddresses=sdlcPortStatsInvalidAddresses, sdlcPortStatsIFramesIn=sdlcPortStatsIFramesIn, sdlcPortOperISTATUS=sdlcPortOperISTATUS, sdlcLSStatsOctetsIn=sdlcLSStatsOctetsIn, sdlcLSOperTable=sdlcLSOperTable, sdlcCoreLSAdminGroup=sdlcCoreLSAdminGroup)
