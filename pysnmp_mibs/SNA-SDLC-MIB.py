...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/SNA-SDLC-MIB
...
mibBuilder.exportSymbols("SNA-SDLC-MIB", sdlcLSAdminXmitRcvCap=sdlcLSAdminXmitRcvCap, sdlcPortAdminSlowPollTimer=sdlcPortAdminSlowPollTimer, sdlcCompliances=sdlcCompliances, sdlcPortOperLastFailCause=sdlcPortOperLastFailCause, sdlcLSAdminMAXDATARcv=sdlcLSAdminMAXDATARcv, sdlcPortOperACTIVTO=sdlcPortOperACTIVTO, sdlcPortStatsRemoteBusies=sdlcPortStatsRemoteBusies, sdlcLSStatsOctetsIn=sdlcLSStatsOctetsIn, sdlcPortStatsOctetsOut=sdlcPortStatsOctetsOut, sdlcLSStatsSIMsIn=sdlcLSStatsSIMsIn, sdlcLSStatsUAIn=sdlcLSStatsUAIn, sdlcPortStatsProtocolErrs=sdlcPortStatsProtocolErrs, sdlcLSAdminMAXOUT=sdlcLSAdminMAXOUT, sdlcCoreCompliance=sdlcCoreCompliance, sdlcLSOperLastFailREPLYTOs=sdlcLSOperLastFailREPLYTOs, sdlcPortOperSlowPollTimer=sdlcPortOperSlowPollTimer, sdlcLSAdminMODULO=sdlcLSAdminMODULO, sdlcCorePortOperGroup=sdlcCorePortOperGroup, sdlcPortStatsPollRspsIn=sdlcPortStatsPollRspsIn, sdlcLSOperLastFailTime=sdlcLSOperLastFailTime, sdlcPortAdminPAUSE=sdlcPortAdminPAUSE, sdlcLSStatsRetransmitsOut=sdlcLSStatsRetransmitsOut, sdlcLSStatsTESTsIn=sdlcLSStatsTESTsIn, sdlcConformance=sdlcConformance, sdlcPortStatsInvalidAddresses=sdlcPortStatsInvalidAddresses, sdlcPrimaryCompliance=sdlcPrimaryCompliance, sdlcLSStatsUIFramesIn=sdlcLSStatsUIFramesIn, sdlcLSOperName=sdlcLSOperName, sdlcPrimaryGroups=sdlcPrimaryGroups, sdlcPortStatsActivityTOs=sdlcPortStatsActivityTOs, sdlcLSAdminName=sdlcLSAdminName, sdlcPortAdminISTATUS=sdlcPortAdminISTATUS, sdlcLSAdminISTATUS=sdlcLSAdminISTATUS, sdlcPortStatusChange=sdlcPortStatusChange, sdlcLSStatsRIMsIn=sdlcLSStatsRIMsIn, sdlcLSStatsTable=sdlcLSStatsTable, sdlcLSOperState=sdlcLSOperState, sdlcLSOperDATMODE=sdlcLSOperDATMODE, sdlcPrimaryGroup=sdlcPrimaryGroup, sdlcLSStatsPollRspsOut=sdlcLSStatsPollRspsOut, sdlcLSStatsRemoteBusies=sdlcLSStatsRemoteBusies, sdlcLSOperLastFailCtrlOut=sdlcLSOperLastFailCtrlOut, sdlcLSStatsBLUsOut=sdlcLSStatsBLUsOut, sdlcPortStatsIFramesOut=sdlcPortStatsIFramesOut, snaDLC=snaDLC, sdlcPortOperType=sdlcPortOperType, sdlcPortStatsPollRspsOut=sdlcPortStatsPollRspsOut, sdlcPortOperName=sdlcPortOperName, sdlcLSAdminGPoll=sdlcLSAdminGPoll, sdlcLSOperLastFailFRMRInfo=sdlcLSOperLastFailFRMRInfo, sdlcPortStatsRetransmitsIn=sdlcPortStatsRetransmitsIn, sdlcLSStatsPollRspsIn=sdlcLSStatsPollRspsIn, sdlcLSOperMAXOUT=sdlcLSOperMAXOUT, sdlcLSOperEntry=sdlcLSOperEntry, sdlcPrimaryMultipointGroup=sdlcPrimaryMultipointGroup, sdlcLSGroup=sdlcLSGroup, sdlcPortStatsEntry=sdlcPortStatsEntry, sdlcLSOperRETRIESm=sdlcLSOperRETRIESm, sdlcLSOperXmitRcvCap=sdlcLSOperXmitRcvCap, sdlcPortOperPAUSE=sdlcPortOperPAUSE, sdlcLSAdminState=sdlcLSAdminState, sdlcLSStatsRNRLIMITs=sdlcLSStatsRNRLIMITs, sdlcLSStatsXIDsOut=sdlcLSStatsXIDsOut, sdlcCorePortStatsGroup=sdlcCorePortStatsGroup, sdlcLSStatsPollsOut=sdlcLSStatsPollsOut, sdlcLSStatsEntry=sdlcLSStatsEntry, sdlcLSStatsTESTsOut=sdlcLSStatsTESTsOut, sdlcLSStatsUAOut=sdlcLSStatsUAOut, sdlcLSAdminDATMODE=sdlcLSAdminDATMODE, sdlcLSStatsIFramesIn=sdlcLSStatsIFramesIn, sdlcLSOperRETRIESn=sdlcLSOperRETRIESn, sdlcLSStatsIFramesOut=sdlcLSStatsIFramesOut, sdlcLSStatsActivityTOs=sdlcLSStatsActivityTOs, sdlcPortAdminName=sdlcPortAdminName, sdlcLSOperLastModifyTime=sdlcLSOperLastModifyTime, PYSNMP_MODULE_ID=snaDLC, sdlcCoreGroups=sdlcCoreGroups, sdlcPortStatsPollsOut=sdlcPortStatsPollsOut, sdlcTraps=sdlcTraps, sdlcPortOperLastModifyTime=sdlcPortOperLastModifyTime, sdlcPortAdminTable=sdlcPortAdminTable, sdlcLSOperEcho=sdlcLSOperEcho, sdlcLSStatsOctetsOut=sdlcLSStatsOctetsOut, sdlcLSStatsDMOut=sdlcLSStatsDMOut, sdlcLSOperMODULO=sdlcLSOperMODULO, sdlcPortOperTable=sdlcPortOperTable, sdlcPortStatsPhysicalFailures=sdlcPortStatsPhysicalFailures, sdlcPrimaryMultipointCompliance=sdlcPrimaryMultipointCompliance, sdlcLSAdminTable=sdlcLSAdminTable, sdlcLSOperLastFailCause=sdlcLSOperLastFailCause, sdlcLSStatsDISCOut=sdlcLSStatsDISCOut, sdlcLSOperMAXDATASend=sdlcLSOperMAXDATASend, sdlcLSStatsRIMsOut=sdlcLSStatsRIMsOut, sdlcLSStatsBLUsIn=sdlcLSStatsBLUsIn, sdlcPortAdminEntry=sdlcPortAdminEntry, sdlcPortOperTopology=sdlcPortOperTopology, sdlcLSStatsXIDsIn=sdlcLSStatsXIDsIn, sdlcPortStatsLocalBusies=sdlcPortStatsLocalBusies, sdlcPortOperISTATUS=sdlcPortOperISTATUS, sdlcLSAdminRETRIESm=sdlcLSAdminRETRIESm, sdlcPortStatsPollsIn=sdlcPortStatsPollsIn, sdlcPortStatsRetransmitsOut=sdlcPortStatsRetransmitsOut, sdlcLSStatsREJsIn=sdlcLSStatsREJsIn, sdlcPortStatsIFramesIn=sdlcPortStatsIFramesIn, sdlcPortAdminType=sdlcPortAdminType, sdlcCoreLSOperGroup=sdlcCoreLSOperGroup, sdlcPortAdminSERVLIM=sdlcPortAdminSERVLIM, sdlcLSAddress=sdlcLSAddress, sdlcLSOperLastFailCtrlIn=sdlcLSOperLastFailCtrlIn, sdlcLSAdminEntry=sdlcLSAdminEntry, sdlcLSOperTable=sdlcLSOperTable, sdlcGroups=sdlcGroups, sdlc=sdlc, sdlcLSStatsSNRMIn=sdlcLSStatsSNRMIn, sdlcPortGroup=sdlcPortGroup, sdlcLSOperRETRIESt=sdlcLSOperRETRIESt, sdlcPortAdminRole=sdlcPortAdminRole, sdlcLSOperRole=sdlcLSOperRole, sdlcLSStatsPollsIn=sdlcLSStatsPollsIn, sdlcLSStatsRetriesExps=sdlcLSStatsRetriesExps, sdlcLSAdminMAXIN=sdlcLSAdminMAXIN, sdlcLSStatsUIFramesOut=sdlcLSStatsUIFramesOut, sdlcPortStatsRetriesExps=sdlcPortStatsRetriesExps, sdlcPortOperEntry=sdlcPortOperEntry, sdlcLSStatsFRMRsIn=sdlcLSStatsFRMRsIn, sdlcPortStatsDwarfFrames=sdlcPortStatsDwarfFrames, sdlcLSStatsDISCIn=sdlcLSStatsDISCIn, sdlcLSStatsSNRMOut=sdlcLSStatsSNRMOut, sdlcPortOperRole=sdlcPortOperRole, sdlcPortAdminTopology=sdlcPortAdminTopology, sdlcLSOperGPoll=sdlcLSOperGPoll, sdlcLSStatsProtocolErrs=sdlcLSStatsProtocolErrs, sdlcPortAdminACTIVTO=sdlcPortAdminACTIVTO, sdlcLSStatsDMIn=sdlcLSStatsDMIn, sdlcPortStatsTable=sdlcPortStatsTable, sdlcLSAdminMAXDATASend=sdlcLSAdminMAXDATASend, sdlcCoreLSStatsGroup=sdlcCoreLSStatsGroup, sdlcCorePortAdminGroup=sdlcCorePortAdminGroup, sdlcLSAdminRowStatus=sdlcLSAdminRowStatus, sdlcLSStatsLocalBusies=sdlcLSStatsLocalBusies, sdlcLSOperREPLYTO=sdlcLSOperREPLYTO, sdlcPortStatsRNRLIMITs=sdlcPortStatsRNRLIMITs, sdlcPortOperSERVLIM=sdlcPortOperSERVLIM, sdlcLSStatusChange=sdlcLSStatusChange, sdlcLSAdminREPLYTO=sdlcLSAdminREPLYTO, sdlcCoreLSAdminGroup=sdlcCoreLSAdminGroup, sdlcPortOperLastFailTime=sdlcPortOperLastFailTime, sdlcLSStatsRetransmitsIn=sdlcLSStatsRetransmitsIn, sdlcLSStatsFRMRsOut=sdlcLSStatsFRMRsOut, sdlcLSOperSimRim=sdlcLSOperSimRim, sdlcLSAdminRNRLIMIT=sdlcLSAdminRNRLIMIT, sdlcLSStatsSIMsOut=sdlcLSStatsSIMsOut, sdlcPortStatsOctetsIn=sdlcPortStatsOctetsIn, sdlcLSAdminRETRIESt=sdlcLSAdminRETRIESt, sdlcLSAdminRETRIESn=sdlcLSAdminRETRIESn, sdlcLSAdminSimRim=sdlcLSAdminSimRim, sdlcPortOperSlowPollMethod=sdlcPortOperSlowPollMethod, sdlcLSStatsREJsOut=sdlcLSStatsREJsOut, sdlcLSOperMAXIN=sdlcLSOperMAXIN, sdlcLSOperRNRLIMIT=sdlcLSOperRNRLIMIT)
