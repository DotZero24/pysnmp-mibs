...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:48:24 2025
...
mibBuilder.exportSymbols("DECNET-PHIV-MIB", phivCountersCountUsrBuffUnav=phivCountersCountUsrBuffUnav, phivEthLinkParametersEntry=phivEthLinkParametersEntry, phivDDCMPCircuitAdjNodeAddr=phivDDCMPCircuitAdjNodeAddr, phivCountersIndex=phivCountersIndex, phivCountersCountBytesSent=phivCountersCountBytesSent, phivCircuitCountTermCongLoss=phivCircuitCountTermCongLoss, adjacency=adjacency, phivCountersCountUnrecFrameDest=phivCountersCountUnrecFrameDest, phivAdjState=phivAdjState, phivNonBroadcastController=phivNonBroadcastController, phivLineDevice=phivLineDevice, phivDDCMPCircuitRmteBuffErrors=phivDDCMPCircuitRmteBuffErrors, phivEndDelayFact=phivEndDelayFact, phivRouteSystemAddr=phivRouteSystemAddr, phivAreaTable=phivAreaTable, phivEndRemoteHostNodeID=phivEndRemoteHostNodeID, phivCircuitCommonSubState=phivCircuitCommonSubState, phivRouteType=phivRouteType, phivRouteMaxAddr=phivRouteMaxAddr, phivAdjNodeBlockSize=phivAdjNodeBlockSize, ddcmp=ddcmp, phivCountersCountMcastBytesRecd=phivCountersCountMcastBytesRecd, phivExecIdent=phivExecIdent, phivCircuitCountZeroCount=phivCircuitCountZeroCount, phivCountersCountDataBlocksRecd=phivCountersCountDataBlocksRecd, phivEndCountHostNodeID=phivEndCountHostNodeID, phivCircuitCountCircuitDown=phivCircuitCountCircuitDown, phivRouteCountVerifReject=phivRouteCountVerifReject, phivSystem=phivSystem, phivCircuitLineIndex=phivCircuitLineIndex, phivCircuitExecCost=phivCircuitExecCost, phivLineState=phivLineState, phivLineService=phivLineService, phivManagement=phivManagement, phivLevel1RouteNodeAddr=phivLevel1RouteNodeAddr, phivEndCountTable=phivEndCountTable, phivEndCountReponseTimeouts=phivEndCountReponseTimeouts, phivDDCMPLineCountEntry=phivDDCMPLineCountEntry, phivControlDyingBase=phivControlDyingBase, phivAdjNodeAddr=phivAdjNodeAddr, phivLineTable=phivLineTable, phivCountersCountEthUsrBuffUnav=phivCountersCountEthUsrBuffUnav, phivAdjNodeTable=phivAdjNodeTable, phivEndCountZeroCount=phivEndCountZeroCount, phivCircuitParametersTable=phivCircuitParametersTable, phivControlInactTreshold=phivControlInactTreshold, phivNonBroadcastIndex=phivNonBroadcastIndex, phivDDCMPCircuitParametersTable=phivDDCMPCircuitParametersTable, ethernet=ethernet, phivEndMaxLinks=phivEndMaxLinks, phivCircuitCountTermPacketsRecd=phivCircuitCountTermPacketsRecd, phivNonBroadcastEntry=phivNonBroadcastEntry, phivCircuitCountUsrBuffUnav=phivCircuitCountUsrBuffUnav, phivRouteMaxBdcastNonRouters=phivRouteMaxBdcastNonRouters, phivEthMaxRouters=phivEthMaxRouters, phivAdjNodeCircuitIndex=phivAdjNodeCircuitIndex, phivDDCMPLineCountRmteStationErrs=phivDDCMPLineCountRmteStationErrs, phivRouteRoutingTimer=phivRouteRoutingTimer, PhivCounter=PhivCounter, phivEthLinkIndex=phivEthLinkIndex, phivControlParametersTable=phivControlParametersTable, circuit=circuit, phivRouteSystemAddress=phivRouteSystemAddress, phivEthRouterPri=phivEthRouterPri, phivLineProtocol=phivLineProtocol, phivEndNSPVers=phivEndNSPVers, phivLineMaxBlock=phivLineMaxBlock, phivEndCountUsrBytesRec=phivEndCountUsrBytesRec, phivCircuitCountDataBlocksRecd=phivCircuitCountDataBlocksRecd, phivRouteCountNodeUnrPktLoss=phivRouteCountNodeUnrPktLoss, phivControlPollingSubState=phivControlPollingSubState, phivNonBroadcastTable=phivNonBroadcastTable, nonBroadcastLine=nonBroadcastLine, phivControlDeadTimer=phivControlDeadTimer, phivControlParametersEntry=phivControlParametersEntry, phivCircuitCountInitFailure=phivCircuitCountInitFailure, phivEndCircuitIndex=phivEndCircuitIndex, phivCountersCountDataOver=phivCountersCountDataOver, phivAdjNodeCircuitEtherServPhysAddr=phivAdjNodeCircuitEtherServPhysAddr, phivLineName=phivLineName, phivLineEntry=phivLineEntry, phivRouteCountOverSzePktLoss=phivRouteCountOverSzePktLoss, phivSystemState=phivSystemState, phivEndCountSecsLastZeroed=phivEndCountSecsLastZeroed, phivDDCMPCircuitRmteReplyTimeouts=phivDDCMPCircuitRmteReplyTimeouts, phivCircuitCountBytesRecd=phivCircuitCountBytesRecd, phivEndInactivityTimer=phivEndInactivityTimer, phivSessionSystemName=phivSessionSystemName, phivCircuitCountDataBlocksSent=phivCircuitCountDataBlocksSent, phivCircuitService=phivCircuitService, phivDDCMPLineCountIndex=phivDDCMPLineCountIndex, phivControlBabbleTimer=phivControlBabbleTimer, phivControlDeadThreshold=phivControlDeadThreshold, phivAdjCircuitIndex=phivAdjCircuitIndex, phivDDCMPCircuitIndex=phivDDCMPCircuitIndex, phivAdjAddr=phivAdjAddr, phivDDCMPCircuitTributary=phivDDCMPCircuitTributary, phivAreaMaxCost=phivAreaMaxCost, phivAdjExecListenTimer=phivAdjExecListenTimer, phivNonBroadcastDuplex=phivNonBroadcastDuplex, phivSessionInTimer=phivSessionInTimer, phivControlDelayTimer=phivControlDelayTimer, phivLevel1RouteEntry=phivLevel1RouteEntry, phivCountersCountBlksSentDef=phivCountersCountBlksSentDef, phivMgmtMgmtVers=phivMgmtMgmtVers, phivControlPollingState=phivControlPollingState, phivRouteMaxArea=phivRouteMaxArea, phivEndMaxLinksActive=phivEndMaxLinksActive, phivRouteSegBuffSize=phivRouteSegBuffSize, phivControlMaxBuffs=phivControlMaxBuffs, phivLevel1RouteCircuitIndex=phivLevel1RouteCircuitIndex, phivLineIndex=phivLineIndex, phivRouteRoutingVers=phivRouteRoutingVers, phivCountersCountCollDetectFailure=phivCountersCountCollDetectFailure, phivCircuitCountTransitPksRecd=phivCircuitCountTransitPksRecd, phivEthHardwareAddr=phivEthHardwareAddr, phivDDCMPCircuitLocalBuffErrors=phivDDCMPCircuitLocalBuffErrors, phivAdjNodeState=phivAdjNodeState, phivControlMaxTransmits=phivControlMaxTransmits, phivRouteCountZeroCount=phivRouteCountZeroCount, phivEndDelay=phivEndDelay, phivDDCMPCircuitCountEntry=phivDDCMPCircuitCountEntry, phivCountersCountReceiveFailure=phivCountersCountReceiveFailure, phivAdjBlockSize=phivAdjBlockSize, phivNonBroadcastClock=phivNonBroadcastClock, phivCircuitCountAdjDown=phivCircuitCountAdjDown, phivAreaNum=phivAreaNum, phivCountersCountBlksSentMultCol=phivCountersCountBlksSentMultCol, phivEndRemoteTable=phivEndRemoteTable, phivRouteMaxCircuits=phivRouteMaxCircuits, phivLineReceiveBuffs=phivLineReceiveBuffs, phivDDCMPLineCountDataErrsIn=phivDDCMPLineCountDataErrsIn, phivRouteMaxHops=phivRouteMaxHops, phivDDCMPCircuitParametersEntry=phivDDCMPCircuitParametersEntry, phivAdjCircuitEtherServPhysAddr=phivAdjCircuitEtherServPhysAddr, phivAreaCost=phivAreaCost, phivEndActiveLinks=phivEndActiveLinks, phivAreaNextNode=phivAreaNextNode, end=end, phivAdjNodeType=phivAdjNodeType, phivAdjNodePriority=phivAdjNodePriority, phivAdjListenTimer=phivAdjListenTimer, phivRouteCountAgedPktLoss=phivRouteCountAgedPktLoss, phivDDCMPLineCountTable=phivDDCMPLineCountTable, phivCountersCountMcastBlksRecd=phivCountersCountMcastBlksRecd, phivCountersCountDataBlksRecd=phivCountersCountDataBlksRecd, phivCountersCountBlksSentSingleCol=phivCountersCountBlksSentSingleCol, phivControlSchedTimer=phivControlSchedTimer, phivEndRetransmitFactor=phivEndRetransmitFactor, phivDDCMPCircuitCountTable=phivDDCMPCircuitCountTable, phivDDCMPLineCountLocalStationErrs=phivDDCMPLineCountLocalStationErrs, phivAreaEntry=phivAreaEntry, phivCircuitOrigQueueLimit=phivCircuitOrigQueueLimit, phivRouteMaxVisits=phivRouteMaxVisits, phivRouteCountOutRngePktLoss=phivRouteCountOutRngePktLoss, phivControlDyingThreshold=phivControlDyingThreshold, phivEndDelayWeight=phivEndDelayWeight, phivCircuitCountTransitCongestLoss=phivCircuitCountTransitCongestLoss, counters=counters, phivEndCountEntry=phivEndCountEntry, phivCircuitCommonState=phivCircuitCommonState, phivRouteRoutingType=phivRouteRoutingType, phivCircuitCountOriginPackSent=phivCircuitCountOriginPackSent, phivRouteMaxBuffs=phivRouteMaxBuffs, phivCircuitCountTransitPkSent=phivCircuitCountTransitPkSent, phivEthLinkParametersTable=phivEthLinkParametersTable, phivSessionOutTimer=phivSessionOutTimer, phivDDCMPCircuitSelectTimeouts=phivDDCMPCircuitSelectTimeouts, phivEndRemoteEntry=phivEndRemoteEntry, phivLevel1RouteNextNode=phivLevel1RouteNextNode, phivRouteCountPtlRteUpdtLoss=phivRouteCountPtlRteUpdtLoss, phivCountersCountSysBuffUnav=phivCountersCountSysBuffUnav, phivCircuitParametersEntry=phivCircuitParametersEntry, line=line, phivEthDesigRouterNodeAddr=phivEthDesigRouterNodeAddr, phivEndCountTotalMessSent=phivEndCountTotalMessSent, phivAdjNodeListenTimer=phivAdjNodeListenTimer, phivAreaMaxHops=phivAreaMaxHops, phivAdjTable=phivAdjTable, InterfaceIndex=InterfaceIndex, phivRouteMaxCost=phivRouteMaxCost, phivLevel1RouteTable=phivLevel1RouteTable, phivCircuitCountTable=phivCircuitCountTable, phivEndCountTotalBytesRec=phivEndCountTotalBytesRec, phivCountersCountSendFailure=phivCountersCountSendFailure, phivControlCircuitIndex=phivControlCircuitIndex, phivControlTransTimer=phivControlTransTimer, phivEndCountUsrBytesSent=phivEndCountUsrBytesSent, phivLineServiceTimer=phivLineServiceTimer, phivEndCountTotalBytesSent=phivEndCountTotalBytesSent, phivCircuitExecRecallTimer=phivCircuitExecRecallTimer, phivControlDyingIncrement=phivControlDyingIncrement, phivNonBroadcastRetransmitTimer=phivNonBroadcastRetransmitTimer, phivDDCMPCircuitErrorsOutbd=phivDDCMPCircuitErrorsOutbd, phivCircuitExecHelloTimer=phivCircuitExecHelloTimer, phivCircuitCommonName=phivCircuitCommonName, control=control, phivCircuitCommonType=phivCircuitCommonType, phivAdjEntry=phivAdjEntry, phivRouteBuffSize=phivRouteBuffSize, phivCountersCountEntry=phivCountersCountEntry, phivEndUCountUsrMessRec=phivEndUCountUsrMessRec, phivCircuitCountCorruptLoss=phivCircuitCountCorruptLoss, phivCountersCountBytesRecd=phivCountersCountBytesRecd, phivCircuitIndex=phivCircuitIndex, phivCountersCountDataBlocksSent=phivCountersCountDataBlocksSent, phivEndCountConnectsSent=phivEndCountConnectsSent, phivAdjType=phivAdjType, phivDDCMPCircuitErrorsInbd=phivDDCMPCircuitErrorsInbd, phivRouteBroadcastRouteTimer=phivRouteBroadcastRouteTimer, session=session, phivEndCountTotalMessRec=phivEndCountTotalMessRec, phivRouteMaxBdcastRouters=phivRouteMaxBdcastRouters, phivCircuitCountSecLastZeroed=phivCircuitCountSecLastZeroed, phivEndRemoteState=phivEndRemoteState, phivCircuitCountPeakAdj=phivCircuitCountPeakAdj, phivCountersCountTable=phivCountersCountTable, phivCountersCountDataBlksSent=phivCountersCountDataBlksSent, phiv=phiv, phivAdjNodeEntry=phivAdjNodeEntry, phivAreaHops=phivAreaHops, phivAdjPriority=phivAdjPriority, phivAreaState=phivAreaState, phivCircuitCountEntry=phivCircuitCountEntry, routing=routing, PhivAddr=PhivAddr, phivEndCountConnectsRecd=phivEndCountConnectsRecd, phivLevel1RouteCost=phivLevel1RouteCost, area=area, phivCircuitCountBytesSent=phivCircuitCountBytesSent, phivDDCMPCircuitLocalReplyTimeouts=phivDDCMPCircuitLocalReplyTimeouts, phivLevel1RouteHops=phivLevel1RouteHops, phivControlStreamTimer=phivControlStreamTimer, phivAreaCircuitIndex=phivAreaCircuitIndex, phivRouteCountPacketFmtErr=phivRouteCountPacketFmtErr, phivLineSubstate=phivLineSubstate, phivDDCMPCircuitSelectIntervalsElap=phivDDCMPCircuitSelectIntervalsElap, phivEndCountUsrMessSent=phivEndCountUsrMessSent, phivEndCountRecdConnectResErrs=phivEndCountRecdConnectResErrs)
