...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/DECNET-PHIV-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:26:35 2025
...
mibBuilder.exportSymbols("DECNET-PHIV-MIB", phivRouteMaxHops=phivRouteMaxHops, phivDDCMPLineCountEntry=phivDDCMPLineCountEntry, phivCountersCountDataBlocksRecd=phivCountersCountDataBlocksRecd, phivLineEntry=phivLineEntry, phivCircuitIndex=phivCircuitIndex, phivCircuitCommonType=phivCircuitCommonType, phivDDCMPCircuitRmteReplyTimeouts=phivDDCMPCircuitRmteReplyTimeouts, phivDDCMPCircuitLocalReplyTimeouts=phivDDCMPCircuitLocalReplyTimeouts, phivLineState=phivLineState, adjacency=adjacency, phivEndRemoteState=phivEndRemoteState, phivCircuitLineIndex=phivCircuitLineIndex, phivCircuitExecCost=phivCircuitExecCost, phivCountersCountDataBlksSent=phivCountersCountDataBlksSent, phivCircuitCountTermCongLoss=phivCircuitCountTermCongLoss, phivCircuitCountTransitPksRecd=phivCircuitCountTransitPksRecd, phivRouteMaxVisits=phivRouteMaxVisits, phivNonBroadcastIndex=phivNonBroadcastIndex, phivRouteMaxCost=phivRouteMaxCost, phivCircuitCountTermPacketsRecd=phivCircuitCountTermPacketsRecd, phivAdjNodeCircuitEtherServPhysAddr=phivAdjNodeCircuitEtherServPhysAddr, phivCountersCountSendFailure=phivCountersCountSendFailure, phivEndRemoteHostNodeID=phivEndRemoteHostNodeID, phivDDCMPCircuitSelectIntervalsElap=phivDDCMPCircuitSelectIntervalsElap, phivSessionInTimer=phivSessionInTimer, phivEndCountTotalBytesRec=phivEndCountTotalBytesRec, phivLineServiceTimer=phivLineServiceTimer, phivControlInactTreshold=phivControlInactTreshold, phivAdjBlockSize=phivAdjBlockSize, PhivAddr=PhivAddr, phivDDCMPLineCountRmteStationErrs=phivDDCMPLineCountRmteStationErrs, phivLineProtocol=phivLineProtocol, phivRouteMaxAddr=phivRouteMaxAddr, phivCountersCountCollDetectFailure=phivCountersCountCollDetectFailure, phivDDCMPCircuitLocalBuffErrors=phivDDCMPCircuitLocalBuffErrors, phivDDCMPCircuitRmteBuffErrors=phivDDCMPCircuitRmteBuffErrors, phivEthLinkParametersEntry=phivEthLinkParametersEntry, phivEndCountRecdConnectResErrs=phivEndCountRecdConnectResErrs, phivCountersCountBytesSent=phivCountersCountBytesSent, phivAdjExecListenTimer=phivAdjExecListenTimer, phivAdjNodeTable=phivAdjNodeTable, phivLineDevice=phivLineDevice, phivCircuitCountInitFailure=phivCircuitCountInitFailure, phivCountersCountEntry=phivCountersCountEntry, phivDDCMPCircuitTributary=phivDDCMPCircuitTributary, phivRouteCountPacketFmtErr=phivRouteCountPacketFmtErr, phivRouteBuffSize=phivRouteBuffSize, phivCountersCountMcastBlksRecd=phivCountersCountMcastBlksRecd, phivLevel1RouteHops=phivLevel1RouteHops, phivControlParametersTable=phivControlParametersTable, phivCircuitCountEntry=phivCircuitCountEntry, phivLineReceiveBuffs=phivLineReceiveBuffs, phivAreaNum=phivAreaNum, phivDDCMPLineCountTable=phivDDCMPLineCountTable, phivAreaCost=phivAreaCost, phivSessionSystemName=phivSessionSystemName, phivCircuitParametersEntry=phivCircuitParametersEntry, phivCircuitService=phivCircuitService, phivCircuitCountBytesRecd=phivCircuitCountBytesRecd, phivLevel1RouteCost=phivLevel1RouteCost, phivEndActiveLinks=phivEndActiveLinks, phivRouteRoutingVers=phivRouteRoutingVers, phivCircuitCountUsrBuffUnav=phivCircuitCountUsrBuffUnav, phivCountersCountDataOver=phivCountersCountDataOver, phivRouteSystemAddr=phivRouteSystemAddr, phivCircuitCommonState=phivCircuitCommonState, phivCircuitCountDataBlocksSent=phivCircuitCountDataBlocksSent, phivLineService=phivLineService, phivEndCountTable=phivEndCountTable, phivAdjNodeEntry=phivAdjNodeEntry, phivEndCountConnectsSent=phivEndCountConnectsSent, phivRouteRoutingTimer=phivRouteRoutingTimer, phivEndUCountUsrMessRec=phivEndUCountUsrMessRec, phivDDCMPCircuitSelectTimeouts=phivDDCMPCircuitSelectTimeouts, phivCountersCountBytesRecd=phivCountersCountBytesRecd, phivRouteMaxCircuits=phivRouteMaxCircuits, phivEndCountReponseTimeouts=phivEndCountReponseTimeouts, phivCircuitCountZeroCount=phivCircuitCountZeroCount, phivAdjNodeCircuitIndex=phivAdjNodeCircuitIndex, phivEndRemoteEntry=phivEndRemoteEntry, ethernet=ethernet, phiv=phiv, phivRouteCountVerifReject=phivRouteCountVerifReject, phivCircuitCommonName=phivCircuitCommonName, phivCountersCountReceiveFailure=phivCountersCountReceiveFailure, phivAdjTable=phivAdjTable, phivAdjPriority=phivAdjPriority, phivDDCMPCircuitCountEntry=phivDDCMPCircuitCountEntry, phivEndCountUsrBytesSent=phivEndCountUsrBytesSent, phivCountersCountMcastBytesRecd=phivCountersCountMcastBytesRecd, phivCircuitParametersTable=phivCircuitParametersTable, phivControlBabbleTimer=phivControlBabbleTimer, phivRouteSegBuffSize=phivRouteSegBuffSize, phivLineIndex=phivLineIndex, phivNonBroadcastRetransmitTimer=phivNonBroadcastRetransmitTimer, phivCountersIndex=phivCountersIndex, nonBroadcastLine=nonBroadcastLine, phivRouteRoutingType=phivRouteRoutingType, phivCircuitCountDataBlocksRecd=phivCircuitCountDataBlocksRecd, phivAdjNodePriority=phivAdjNodePriority, phivEndCountTotalMessRec=phivEndCountTotalMessRec, area=area, phivRouteCountZeroCount=phivRouteCountZeroCount, phivCircuitExecRecallTimer=phivCircuitExecRecallTimer, phivEndMaxLinksActive=phivEndMaxLinksActive, phivControlDyingThreshold=phivControlDyingThreshold, phivCircuitOrigQueueLimit=phivCircuitOrigQueueLimit, phivControlDyingBase=phivControlDyingBase, phivEndDelay=phivEndDelay, phivCountersCountTable=phivCountersCountTable, phivCircuitCountCorruptLoss=phivCircuitCountCorruptLoss, phivCircuitCountCircuitDown=phivCircuitCountCircuitDown, phivDDCMPCircuitParametersTable=phivDDCMPCircuitParametersTable, phivCountersCountBlksSentMultCol=phivCountersCountBlksSentMultCol, phivRouteCountOutRngePktLoss=phivRouteCountOutRngePktLoss, phivCountersCountUsrBuffUnav=phivCountersCountUsrBuffUnav, phivEndCountZeroCount=phivEndCountZeroCount, phivAreaTable=phivAreaTable, phivCountersCountUnrecFrameDest=phivCountersCountUnrecFrameDest, phivNonBroadcastController=phivNonBroadcastController, line=line, phivDDCMPCircuitErrorsOutbd=phivDDCMPCircuitErrorsOutbd, phivExecIdent=phivExecIdent, phivNonBroadcastClock=phivNonBroadcastClock, phivLevel1RouteEntry=phivLevel1RouteEntry, phivDDCMPLineCountDataErrsIn=phivDDCMPLineCountDataErrsIn, phivControlCircuitIndex=phivControlCircuitIndex, phivEndCountTotalMessSent=phivEndCountTotalMessSent, phivRouteMaxBuffs=phivRouteMaxBuffs, phivCircuitCountBytesSent=phivCircuitCountBytesSent, phivAreaEntry=phivAreaEntry, phivEndNSPVers=phivEndNSPVers, phivCircuitCountTable=phivCircuitCountTable, phivDDCMPLineCountLocalStationErrs=phivDDCMPLineCountLocalStationErrs, control=control, phivEthHardwareAddr=phivEthHardwareAddr, end=end, phivControlDeadTimer=phivControlDeadTimer, circuit=circuit, phivLineSubstate=phivLineSubstate, phivAreaMaxCost=phivAreaMaxCost, phivCountersCountSysBuffUnav=phivCountersCountSysBuffUnav, phivCountersCountDataBlksRecd=phivCountersCountDataBlksRecd, phivNonBroadcastDuplex=phivNonBroadcastDuplex, phivCircuitCountTransitPkSent=phivCircuitCountTransitPkSent, phivMgmtMgmtVers=phivMgmtMgmtVers, phivSystemState=phivSystemState, phivDDCMPCircuitErrorsInbd=phivDDCMPCircuitErrorsInbd, phivNonBroadcastEntry=phivNonBroadcastEntry, phivAreaHops=phivAreaHops, phivControlDyingIncrement=phivControlDyingIncrement, phivDDCMPLineCountIndex=phivDDCMPLineCountIndex, phivCircuitCountSecLastZeroed=phivCircuitCountSecLastZeroed, phivLevel1RouteNextNode=phivLevel1RouteNextNode, phivControlStreamTimer=phivControlStreamTimer, phivCountersCountEthUsrBuffUnav=phivCountersCountEthUsrBuffUnav, phivDDCMPCircuitIndex=phivDDCMPCircuitIndex, phivRouteCountAgedPktLoss=phivRouteCountAgedPktLoss, phivCircuitCountTransitCongestLoss=phivCircuitCountTransitCongestLoss, phivCountersCountBlksSentDef=phivCountersCountBlksSentDef, phivCircuitExecHelloTimer=phivCircuitExecHelloTimer, phivControlDeadThreshold=phivControlDeadThreshold, phivEndCountSecsLastZeroed=phivEndCountSecsLastZeroed, phivRouteCountPtlRteUpdtLoss=phivRouteCountPtlRteUpdtLoss, phivDDCMPCircuitAdjNodeAddr=phivDDCMPCircuitAdjNodeAddr, phivDDCMPCircuitCountTable=phivDDCMPCircuitCountTable, phivAdjEntry=phivAdjEntry, phivEndCountTotalBytesSent=phivEndCountTotalBytesSent, phivEndRetransmitFactor=phivEndRetransmitFactor, phivCircuitCountOriginPackSent=phivCircuitCountOriginPackSent, phivLevel1RouteTable=phivLevel1RouteTable, phivCircuitCommonSubState=phivCircuitCommonSubState, phivAdjListenTimer=phivAdjListenTimer, phivAdjCircuitIndex=phivAdjCircuitIndex, phivRouteBroadcastRouteTimer=phivRouteBroadcastRouteTimer, phivEthDesigRouterNodeAddr=phivEthDesigRouterNodeAddr, phivEthLinkIndex=phivEthLinkIndex, phivDDCMPCircuitParametersEntry=phivDDCMPCircuitParametersEntry, phivManagement=phivManagement, phivAdjAddr=phivAdjAddr, phivLineName=phivLineName, phivAreaNextNode=phivAreaNextNode, phivAdjNodeType=phivAdjNodeType, phivControlPollingSubState=phivControlPollingSubState, phivAreaState=phivAreaState, PhivCounter=PhivCounter, phivEthMaxRouters=phivEthMaxRouters, ddcmp=ddcmp, phivEthRouterPri=phivEthRouterPri, phivEndCountConnectsRecd=phivEndCountConnectsRecd, phivControlMaxBuffs=phivControlMaxBuffs, phivControlDelayTimer=phivControlDelayTimer, phivControlSchedTimer=phivControlSchedTimer, phivAdjNodeBlockSize=phivAdjNodeBlockSize, phivEndCircuitIndex=phivEndCircuitIndex, phivEndCountUsrBytesRec=phivEndCountUsrBytesRec, phivAdjState=phivAdjState, phivSystem=phivSystem, session=session, phivControlPollingState=phivControlPollingState, phivRouteCountNodeUnrPktLoss=phivRouteCountNodeUnrPktLoss, phivEndCountHostNodeID=phivEndCountHostNodeID, phivControlMaxTransmits=phivControlMaxTransmits, phivRouteMaxArea=phivRouteMaxArea, phivLevel1RouteCircuitIndex=phivLevel1RouteCircuitIndex, InterfaceIndex=InterfaceIndex, phivAdjNodeAddr=phivAdjNodeAddr, phivAdjNodeListenTimer=phivAdjNodeListenTimer, phivEndCountEntry=phivEndCountEntry, phivLineMaxBlock=phivLineMaxBlock, phivEndDelayFact=phivEndDelayFact, routing=routing, phivCountersCountBlksSentSingleCol=phivCountersCountBlksSentSingleCol, phivRouteMaxBdcastNonRouters=phivRouteMaxBdcastNonRouters, phivSessionOutTimer=phivSessionOutTimer, phivCircuitCountPeakAdj=phivCircuitCountPeakAdj, phivNonBroadcastTable=phivNonBroadcastTable, phivAreaCircuitIndex=phivAreaCircuitIndex, phivEndInactivityTimer=phivEndInactivityTimer, phivCircuitCountAdjDown=phivCircuitCountAdjDown, phivCountersCountDataBlocksSent=phivCountersCountDataBlocksSent, phivRouteSystemAddress=phivRouteSystemAddress, phivRouteType=phivRouteType, phivLineTable=phivLineTable, phivEndRemoteTable=phivEndRemoteTable, phivEndDelayWeight=phivEndDelayWeight, phivAdjNodeState=phivAdjNodeState, phivAdjCircuitEtherServPhysAddr=phivAdjCircuitEtherServPhysAddr, phivLevel1RouteNodeAddr=phivLevel1RouteNodeAddr, counters=counters, phivAdjType=phivAdjType, phivRouteCountOverSzePktLoss=phivRouteCountOverSzePktLoss, phivAreaMaxHops=phivAreaMaxHops, phivEndCountUsrMessSent=phivEndCountUsrMessSent, phivEndMaxLinks=phivEndMaxLinks, phivRouteMaxBdcastRouters=phivRouteMaxBdcastRouters, phivControlTransTimer=phivControlTransTimer, phivControlParametersEntry=phivControlParametersEntry, phivEthLinkParametersTable=phivEthLinkParametersTable)
