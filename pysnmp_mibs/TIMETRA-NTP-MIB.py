...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-NTP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:51:24 2025
...
class _TmnxNtpMulticastAddressType_Type(InetAddressType):
    """Custom type tmnxNtpMulticastAddressType based on InetAddressType"""
    defaultValue = 1


_TmnxNtpMulticastAddressType_Type.__name__ = "InetAddressType"
...
class _TmnxNtpServersVersion_Type(NTPVersionPeerServer):
    """Custom type tmnxNtpServersVersion based on NTPVersionPeerServer"""
    defaultValue = 4


_TmnxNtpServersVersion_Type.__name__ = "NTPVersionPeerServer"
...
class _TmnxNtpPeersVersion_Type(NTPVersionPeerServer):
    """Custom type tmnxNtpPeersVersion based on NTPVersionPeerServer"""
    defaultValue = 4


_TmnxNtpPeersVersion_Type.__name__ = "NTPVersionPeerServer"
...
tmnxNtpPeersPeerVRtrID = _TmnxNtpPeersPeerVRtrID_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 38, 3, 2, 1, 20),
    _TmnxNtpPeersPeerVRtrID_Type()
)
tmnxNtpPeersPeerVRtrID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxNtpPeersPeerVRtrID.setStatus("current")
...
tmnxNtpPeersGroup.setObjects(
      *(("TIMETRA-NTP-MIB", "tmnxNtpPeersEntryStatus"),
        ...
        ("TIMETRA-NTP-MIB", "tmnxNtpPeersPeerVRtrID"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"NTPTimeStamp": NTPTimeStamp,
       ...
       "NTPVersionPeerServer": NTPVersionPeerServer,
       ...
       "tmnxNtpPeersPeerVRtrID": tmnxNtpPeersPeerVRtrID,
