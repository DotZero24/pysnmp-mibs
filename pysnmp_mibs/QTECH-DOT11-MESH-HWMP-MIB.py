# SNMP MIB module (QTECH-DOT11-MESH-HWMP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-DOT11-MESH-HWMP-MIB
...
qtechDot11MeshHWMPMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92)
)
if mibBuilder.loadTexts:
    qtechDot11MeshHWMPMIB.setRevisions(
        ("2010-02-28 00:00",)
    )
...
dot11MeshHWMPConfigEntry = _Dot11MeshHWMPConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1)
)
...
dot11MeshHWMPmaxPREQretries = _Dot11MeshHWMPmaxPREQretries_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 1),
...
dot11MeshHWMPnetDiameter = _Dot11MeshHWMPnetDiameter_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 2),
...
dot11MeshHWMPnetDiameterTraversalTime = _Dot11MeshHWMPnetDiameterTraversalTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 3),
...
dot11MeshHWMPpreqMinInterval = _Dot11MeshHWMPpreqMinInterval_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 4),
...
dot11MeshHWMPperrMinInterval = _Dot11MeshHWMPperrMinInterval_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 5),
...
dot11MeshHWMPactivePathToRootTimeout = _Dot11MeshHWMPactivePathToRootTimeout_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 6),
...
dot11MeshHWMPactivePathTimeout = _Dot11MeshHWMPactivePathTimeout_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 7),
...
dot11MeshHWMProotMode = _Dot11MeshHWMProotMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 8),
...
dot11MeshHWMProotInterval = _Dot11MeshHWMProotInterval_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 9),
...
dot11MeshHWMPrannInterval = _Dot11MeshHWMPrannInterval_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 10),
...
dot11MeshHWMPtargetOnly = _Dot11MeshHWMPtargetOnly_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 11),
...
dot11MeshHWMPmaintenanceInterval = _Dot11MeshHWMPmaintenanceInterval_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 12),
...
dot11MeshHWMPconfirmationInterval = _Dot11MeshHWMPconfirmationInterval_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 1, 1, 1, 13),
...
qtechDot11MeshHWMPConformance = _QtechDot11MeshHWMPConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 2)
)
_QtechDot11MeshHWMPCompliances_ObjectIdentity = ObjectIdentity
qtechDot11MeshHWMPCompliances = _QtechDot11MeshHWMPCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 2, 1)
)
_QtechDot11MeshHWMPGroups_ObjectIdentity = ObjectIdentity
qtechDot11MeshHWMPGroups = _QtechDot11MeshHWMPGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 2, 2)
)

# Managed Objects groups

qtechDot11MeshHWMPGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 2, 2, 1)
)
qtechDot11MeshHWMPGroup.setObjects(
      *(("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPmaxPREQretries"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPnetDiameter"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPnetDiameterTraversalTime"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPpreqMinInterval"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPperrMinInterval"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPactivePathToRootTimeout"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPactivePathTimeout"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMProotMode"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMProotInterval"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPrannInterval"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPtargetOnly"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPmaintenanceInterval"),
        ("QTECH-DOT11-MESH-HWMP-MIB", "dot11MeshHWMPconfirmationInterval"))
)
if mibBuilder.loadTexts:
    qtechDot11MeshHWMPGroup.setStatus("current")
...
qtechDot11MeshHWMPCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 92, 2, 1, 1)
)
qtechDot11MeshHWMPCompliance.setObjects(
    ("QTECH-DOT11-MESH-HWMP-MIB", "qtechDot11MeshHWMPGroup")
)
if mibBuilder.loadTexts:
    qtechDot11MeshHWMPCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    "QTECH-DOT11-MESH-HWMP-MIB",
    **{"qtechDot11MeshHWMPMIB": qtechDot11MeshHWMPMIB,
       ...
       "qtechDot11MeshHWMPCompliance": qtechDot11MeshHWMPCompliance,
       "qtechDot11MeshHWMPGroups": qtechDot11MeshHWMPGroups,
