...
DisplayString,PhysAddress,RowStatus,TextualConvention,TruthValue=mibBuilder.importSymbols('SNMPv2-TC',_J,'PhysAddress','RowStatus','TextualConvention',_G)
fsMIStdIpContextId,=mibBuilder.importSymbols(_K,_L)
...
fsMITunlMIBObjects=_FsMITunlMIBObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,2,39,1))
_FsMITunl_ObjectIdentity=ObjectIdentity
fsMITunl=_FsMITunl_ObjectIdentity((1,3,6,1,4,1,10876,101,2,39,1,1))
_FsMITunlIfTable_Object=MibTable
fsMITunlIfTable=_FsMITunlIfTable_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1))
if mibBuilder.loadTexts:fsMITunlIfTable.setStatus(_A)
_FsMITunlIfEntry_Object=MibTableRow
fsMITunlIfEntry=_FsMITunlIfEntry_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1))
fsMITunlIfEntry.setIndexNames((0,_K,_L),(0,_D,_M),(0,_D,_N),(0,_D,_O),(0,_D,_P),(0,_D,_Q))
...
fsMITunlIfAddressType=_FsMITunlIfAddressType_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,1),_FsMITunlIfAddressType_Type())
...
fsMITunlIfLocalInetAddress=_FsMITunlIfLocalInetAddress_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,2),_FsMITunlIfLocalInetAddress_Type())
...
fsMITunlIfRemoteInetAddress=_FsMITunlIfRemoteInetAddress_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,3),_FsMITunlIfRemoteInetAddress_Type())
...
fsMITunlIfEncapsMethod=_FsMITunlIfEncapsMethod_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,4),_FsMITunlIfEncapsMethod_Type())
...
fsMITunlIfConfigID=_FsMITunlIfConfigID_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,5),_FsMITunlIfConfigID_Type())
...
fsMITunlIfHopLimit=_FsMITunlIfHopLimit_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,6),_FsMITunlIfHopLimit_Type())
...
fsMITunlIfSecurity=_FsMITunlIfSecurity_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,7),_FsMITunlIfSecurity_Type())
...
fsMITunlIfTOS=_FsMITunlIfTOS_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,8),_FsMITunlIfTOS_Type())
...
fsMITunlIfFlowLabel=_FsMITunlIfFlowLabel_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,9),_FsMITunlIfFlowLabel_Type())
...
fsMITunlIfMTU=_FsMITunlIfMTU_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,10),_FsMITunlIfMTU_Type())
...
fsMITunlIfDirFlag=_FsMITunlIfDirFlag_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,11),_FsMITunlIfDirFlag_Type())
...
fsMITunlIfDirection=_FsMITunlIfDirection_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,12),_FsMITunlIfDirection_Type())
...
_FsMITunlIfEncaplmt_Type.__name__=_I
_FsMITunlIfEncaplmt_Object=MibTableColumn
fsMITunlIfEncaplmt=_FsMITunlIfEncaplmt_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,13),_FsMITunlIfEncaplmt_Type())
...
fsMITunlIfEncapOption=_FsMITunlIfEncapOption_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,14),_FsMITunlIfEncapOption_Type())
...
fsMITunlIfIndex=_FsMITunlIfIndex_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,15),_FsMITunlIfIndex_Type())
...
_FsMITunlIfAlias_Type.__name__=_J
_FsMITunlIfAlias_Object=MibTableColumn
fsMITunlIfAlias=_FsMITunlIfAlias_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,16),_FsMITunlIfAlias_Type())
...
fsMITunlIfCksumFlag=_FsMITunlIfCksumFlag_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,17),_FsMITunlIfCksumFlag_Type())
...
fsMITunlIfPmtuFlag=_FsMITunlIfPmtuFlag_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,18),_FsMITunlIfPmtuFlag_Type())
...
fsMITunlIfStatus=_FsMITunlIfStatus_Object((1,3,6,1,4,1,10876,101,2,39,1,1,1,1,19),_FsMITunlIfStatus_Type())
