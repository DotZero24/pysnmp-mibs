# SNMP MIB module (SUPERMICRO-MPTUNNEL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-MPTUNNEL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:03:08 2025
...
fsMITunlMIBObjects = _FsMITunlMIBObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1)
)
_FsMITunl_ObjectIdentity = ObjectIdentity
fsMITunl = _FsMITunl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1)
)
_FsMITunlIfTable_Object = MibTable
fsMITunlIfTable = _FsMITunlIfTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1)
)
if mibBuilder.loadTexts:
    fsMITunlIfTable.setStatus("current")
_FsMITunlIfEntry_Object = MibTableRow
fsMITunlIfEntry = _FsMITunlIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1)
)
fsMITunlIfEntry.setIndexNames(
    (0, "SUPERMICRO-MISTD-IPVX-MIB", "fsMIStdIpContextId"),
    (0, "SUPERMICRO-MPTUNNEL-MIB", "fsMITunlIfAddressType"),
    (0, "SUPERMICRO-MPTUNNEL-MIB", "fsMITunlIfLocalInetAddress"),
    (0, "SUPERMICRO-MPTUNNEL-MIB", "fsMITunlIfRemoteInetAddress"),
    (0, "SUPERMICRO-MPTUNNEL-MIB", "fsMITunlIfEncapsMethod"),
    (0, "SUPERMICRO-MPTUNNEL-MIB", "fsMITunlIfConfigID"),
)
if mibBuilder.loadTexts:
...
fsMITunlIfAddressType = _FsMITunlIfAddressType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 1),
...
fsMITunlIfLocalInetAddress = _FsMITunlIfLocalInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 2),
...
fsMITunlIfRemoteInetAddress = _FsMITunlIfRemoteInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 3),
...
fsMITunlIfConfigID = _FsMITunlIfConfigID_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 5),
...
fsMITunlIfHopLimit = _FsMITunlIfHopLimit_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 6),
...
fsMITunlIfSecurity = _FsMITunlIfSecurity_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 7),
...
fsMITunlIfTOS = _FsMITunlIfTOS_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 8),
    _FsMITunlIfTOS_Type()
)
...
fsMITunlIfFlowLabel = _FsMITunlIfFlowLabel_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 9),
...
fsMITunlIfMTU = _FsMITunlIfMTU_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 10),
    _FsMITunlIfMTU_Type()
)
...
fsMITunlIfDirFlag = _FsMITunlIfDirFlag_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 11),
...
fsMITunlIfDirection = _FsMITunlIfDirection_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 12),
...
fsMITunlIfEncaplmt = _FsMITunlIfEncaplmt_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 13),
...
fsMITunlIfEncapOption = _FsMITunlIfEncapOption_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 14),
...
fsMITunlIfIndex = _FsMITunlIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 15),
...
fsMITunlIfAlias = _FsMITunlIfAlias_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 16),
...
fsMITunlIfCksumFlag = _FsMITunlIfCksumFlag_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 17),
...
fsMITunlIfStatus = _FsMITunlIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 39, 1, 1, 1, 1, 19),
