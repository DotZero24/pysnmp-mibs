...
mibBuilder.exportSymbols("LJ1220-MIB", hrprinterdetectederrorstate=hrprinterdetectederrorstate, prtalertcode=prtalertcode, error7_time_stamp=error7_time_stamp, default_lines_per_page=default_lines_per_page, prtmediapathdefaultindex=prtmediapathdefaultindex, imaging=imaging, postscript_resource_saving_memory_size=postscript_resource_saving_memory_size, prtmarkerlifecount=prtmarkerlifecount, prtchannelstate=prtchannelstate, prtInputTable=prtInputTable, fw_rom_datecode=fw_rom_datecode, job_info_attr_13=job_info_attr_13, settings_job=settings_job, hrdeviceid=hrdeviceid, system=system, job_info_size=job_info_size, prtalerttraininglevel=prtalerttraininglevel, prtinterpreterlangversion=prtinterpreterlangversion, errorlog=errorlog, settings_io=settings_io, copier_print_page_count=copier_print_page_count, copier_job=copier_job, error4=error4, custom_paper_feed_dim=custom_paper_feed_dim, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, copier_quality=copier_quality, error9=error9, prtoutputcapacityunit=prtoutputcapacityunit, prtChannelEntry=prtChannelEntry, ui_delete_option=ui_delete_option, prtalerttime=prtalerttime, prtmarkerstatus=prtmarkerstatus, prtMarkerTable=prtMarkerTable, prtconsolenumberofdisplaylines=prtconsolenumberofdisplaylines, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, dark_courier=dark_courier, device=device, default_print_quality=default_print_quality, prtMediaPath=prtMediaPath, job_info_attr_10=job_info_attr_10, default_horizontal_black_resolution=default_horizontal_black_resolution, prtconsoledisable=prtconsoledisable, prtCoverTable=prtCoverTable, prtMarkerEntry=prtMarkerEntry, source_subsystem=source_subsystem, prtalertdescription=prtalertdescription, job_info_attr_15=job_info_attr_15, ui_add_option=ui_add_option, prtchanneltype=prtchanneltype, prtchannelstatus=prtchannelstatus, form_feed_needed=form_feed_needed, prtconsolelocalization=prtconsolelocalization, prtchannelcurrentjobcntllangindex=prtchannelcurrentjobcntllangindex, job_info_attr_8=job_info_attr_8, prtconsolenumberofdisplaychars=prtconsolenumberofdisplaychars, prtgeneralreset=prtgeneralreset, settings_scanner=settings_scanner, copier_job_contrast=copier_job_contrast, hrstoragedescr=hrstoragedescr, prtCover=prtCover, destination_subsystem=destination_subsystem, scanner_scanline_statistics=scanner_scanline_statistics, error1_code=error1_code, prtalertseveritylevel=prtalertseveritylevel, prtoutputdefaultindex=prtoutputdefaultindex, on_off_line=on_off_line, prtinputtype=prtinputtype, error5=error5, prtGeneral=prtGeneral, error5_time_stamp=error5_time_stamp, intray1=intray1, model_name=model_name, job_info_outcome=job_info_outcome, prtMarkerSuppliesTable=prtMarkerSuppliesTable, job_info_attr_5=job_info_attr_5, prtInterpreter=prtInterpreter, prtmarkereastmargin=prtmarkereastmargin, auto_continue=auto_continue, pcl_default_font_number=pcl_default_font_number, error10_code=error10_code, prtInputEntry=prtInputEntry, form_feed=form_feed, simm2_capacity=simm2_capacity, prtLocalization=prtLocalization, pcl_default_font_source=pcl_default_font_source, job_info=job_info, prtinputmodel=prtinputmodel, device_name=device_name, status_system=status_system, settings_prt_eng=settings_prt_eng, simm2_type=simm2_type, prtmarkerprocesscolorants=prtmarkerprocesscolorants, asset_number=asset_number, prtinterpreterdefaultorientation=prtinterpreterdefaultorientation, prtmarkersuppliesmaxcapacity=prtmarkersuppliesmaxcapacity, default_bits_per_pixel=default_bits_per_pixel, mio1_type=mio1_type, prtlocalizationcharacterset=prtlocalizationcharacterset, prtmarkerpoweroncount=prtmarkerpoweroncount, device_config_token=device_config_token, prtmediapathminmediaxfeeddir=prtmediapathminmediaxfeeddir, hrdeviceindex=hrdeviceindex, postscript_print_errors=postscript_print_errors, prtinterpretertwoway=prtinterpretertwoway, prtinputdimunit=prtinputdimunit, job_info_name1=job_info_name1, prtchannelprotocolversion=prtchannelprotocolversion, hrDeviceEntry=hrDeviceEntry, scan_compression_factor=scan_compression_factor, copier_job_num_copies=copier_job_num_copies, tray1_media_size_loaded=tray1_media_size_loaded, prtlocalizationlanguage=prtlocalizationlanguage, pdl_pcl=pdl_pcl, channel_bytes_sent=channel_bytes_sent, io_timeout=io_timeout, copier_job_collation=copier_job_collation, print_engine_mispick_count=print_engine_mispick_count, prtgeneralprintername=prtgeneralprintername, id=id, simm2=simm2, intrays=intrays, settings_copier=settings_copier, channel=channel, channel_table=channel_table, copier_num_copies=copier_num_copies, job_info_change_id=job_info_change_id, hrdevicetype=hrdevicetype, scan_compression=scan_compression, job_info_attr_12=job_info_attr_12, error10=error10, copier_reduction=copier_reduction, pcl_default_font_height=pcl_default_font_height, reprint=reprint, scan_contrast=scan_contrast, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtmediapathmaxspeedprintunit=prtmediapathmaxspeedprintunit, copier=copier, hrstorageallocationfailures=hrstorageallocationfailures, prtoutputremainingcapacity=prtoutputremainingcapacity, prtchannelinformation=prtchannelinformation, current_job_parsing_id=current_job_parsing_id, settings_intray=settings_intray, default_ret=default_ret, scan_token=scan_token, prtinterpreterlanglevel=prtinterpreterlanglevel, prtmarkersuppliescolorantindex=prtmarkersuppliescolorantindex, prtinputname=prtinputname, prtOutput=prtOutput, job_info_name2=job_info_name2, prtmediapathminmediafeeddir=prtmediapathminmediafeeddir, error7=error7, copier_collation=copier_collation, scanner_retrieve_scanline=scanner_retrieve_scanline, prtconsoleofftime=prtconsoleofftime, resource_saving=resource_saving, scan_control_descriptor=scan_control_descriptor, prtlocalizationcountry=prtlocalizationcountry, prtinterpreterversion=prtinterpreterversion, prtinputversion=prtinputversion, prtalertgroup=prtalertgroup, prtoutputtype=prtoutputtype, scan_resolution=scan_resolution, error1=error1, prtmediapathmediasizeunit=prtmediapathmediasizeunit, prtmarkersouthmargin=prtmarkersouthmargin, print_density=print_density, job_input_auto_continue_mode=job_input_auto_continue_mode, channelnumberofchannels=channelnumberofchannels, prtalertgroupindex=prtalertgroupindex, prtinputcapacityunit=prtinputcapacityunit, error8_code=error8_code, scan_calibration_download=scan_calibration_download, hrdeviceerrors=hrdeviceerrors, job_info_physical_outbins_used=job_info_physical_outbins_used, io_switch=io_switch, prtLocalizationEntry=prtLocalizationEntry, hrdevicedescr=hrdevicedescr, prtConsoleLightEntry=prtConsoleLightEntry, prtmarkermarktech=prtmarkermarktech, hrDevice=hrDevice, hrprinterstatus=hrprinterstatus, simm1_type=simm1_type, tables=tables, hrDeviceTable=hrDeviceTable, prtMarkerSupplies=prtMarkerSupplies, serial_number=serial_number, prtmarkercounterunit=prtmarkercounterunit, prtOutputEntry=prtOutputEntry, prtmarkeraddressabilityfeeddir=prtmarkeraddressabilityfeeddir, scan_calibration_error=scan_calibration_error, transfer_setting=transfer_setting, hrstorageused=hrstorageused, job_info_attr_14=job_info_attr_14, job_info_attr_11=job_info_attr_11, job_being_parsed=job_being_parsed, tray1_fuser_temperature=tray1_fuser_temperature, pysmi_continue=pysmi_continue, prtmarkerspotcolorants=prtmarkerspotcolorants, prtGeneralTable=prtGeneralTable, processing_subsystem=processing_subsystem, prtmediapathmaxmediafeeddir=prtmediapathmaxmediafeeddir, prtoutputmaxcapacity=prtoutputmaxcapacity, prtinputcurrentlevel=prtinputcurrentlevel, error1_time_stamp=error1_time_stamp, sleep_mode=sleep_mode, hrPrinterEntry=hrPrinterEntry, prtinputstatus=prtinputstatus, error8=error8, energy_star=energy_star, not_ready_source_scanner=not_ready_source_scanner, scan_gamma_correction=scan_gamma_correction, job_info_attr_7=job_info_attr_7, mio=mio, job_info_attribute=job_info_attribute, pdl_postscript=pdl_postscript, default_vmi=default_vmi, prtmarkeraddressabilityxfeeddir=prtmarkeraddressabilityxfeeddir, hrPrinterTable=hrPrinterTable, prtconsoledisplaybuffertext=prtconsoledisplaybuffertext, simm1=simm1, prtStorageRefTable=prtStorageRefTable, copier_job_media_size=copier_job_media_size, hrstoragesize=hrstoragesize, prtMediaPathEntry=prtMediaPathEntry, channel_jobs_received=channel_jobs_received, default_vertical_black_resolution=default_vertical_black_resolution, prtconsoleontime=prtconsoleontime, scan_calibration=scan_calibration, simm=simm, prtinputvendorname=prtinputvendorname, error3_code=error3_code, hrstorageallocationunits=hrstorageallocationunits, prtcoverdescription=prtcoverdescription, status_pdl=status_pdl, copier_contrast=copier_contrast, total_engine_page_count=total_engine_page_count, scan_pad_image=scan_pad_image, job_info_attr_16=job_info_attr_16, pjl_password=pjl_password, custom_paper_xfeed_dim=custom_paper_xfeed_dim, error3=error3, hrstorageindex=hrstorageindex, prtChannelTable=prtChannelTable, error8_time_stamp=error8_time_stamp, prtOutputTable=prtOutputTable, job_info_io_source=job_info_io_source, prtmarkersupplieslevel=prtmarkersupplieslevel, default_scanner_margin_left=default_scanner_margin_left, error9_time_stamp=error9_time_stamp, prtmediapathstatus=prtmediapathstatus, prtoutputstatus=prtoutputstatus, prtgeneralserviceperson=prtgeneralserviceperson, prtDeviceRefEntry=prtDeviceRefEntry, scan_pixel_data_type=scan_pixel_data_type)
mibBuilder.exportSymbols("LJ1220-MIB", default_page_protect=default_page_protect, error2_code=error2_code, prtchannelifindex=prtchannelifindex, prtAlertTable=prtAlertTable, pcl_default_font_width=pcl_default_font_width, channelprinteralert=channelprinteralert, error_log_clear=error_log_clear, job_info_attr_9=job_info_attr_9, scan_upload=scan_upload, active_print_jobs=active_print_jobs, status_scanner=status_scanner, pdl=pdl, intray=intray, copier_job_reduction=copier_job_reduction, simm1_capacity=simm1_capacity, prtstoragerefindex=prtstoragerefindex, prtinterpreterxfeedaddressability=prtinterpreterxfeedaddressability, custom_paper_dim_unit=custom_paper_dim_unit, test=test, mio1=mio1, copier_job_quality=copier_job_quality, hrmemorysize=hrmemorysize, prtConsoleLightTable=prtConsoleLightTable, job_info_stage=job_info_stage, error3_time_stamp=error3_time_stamp, ui_select_option=ui_select_option, prtgeneralcurrentoperator=prtgeneralcurrentoperator, settings_pdl=settings_pdl, error6_time_stamp=error6_time_stamp, prtinterpreterdefaultcharsetin=prtinterpreterdefaultcharsetin, prtAlert=prtAlert, prtConsoleLights=prtConsoleLights, prtgeneralserialnumber=prtgeneralserialnumber, print_internal_page=print_internal_page, status_copier=status_copier, self_test=self_test, job_info_attr_1=job_info_attr_1, prtChannel=prtChannel, prtinputdescription=prtinputdescription, hrStorageTable=hrStorageTable, channel_bytes_received=channel_bytes_received, pcl_resource_saving_memory_size=pcl_resource_saving_memory_size, prtInterpreterEntry=prtInterpreterEntry, hrStorage=hrStorage, interface=interface, scanner=scanner, hrstoragetype=hrstoragetype, prtAlertEntry=prtAlertEntry, device_location=device_location, error2=error2, job_info_pages_printed=job_info_pages_printed, prtmarkerdefaultindex=prtmarkerdefaultindex, error5_code=error5_code, hp=hp, prtmediapathtype=prtmediapathtype, prtinputsecurity=prtinputsecurity, default_scanner_margin_right=default_scanner_margin_right, default_media_size=default_media_size, scanner_adf_page_count=scanner_adf_page_count, error6=error6, prtalertallevents=prtalertallevents, prtmediapathmaxmediaxfeeddir=prtmediapathmaxmediaxfeeddir, prtMarker=prtMarker, service_password=service_password, prtmarkersuppliessupplyunit=prtmarkersuppliessupplyunit, printmib=printmib, prtinputmedianame=prtinputmedianame, job_input_auto_continue_timeout=job_input_auto_continue_timeout, prtinputmediadimfeeddirdeclared=prtinputmediadimfeeddirdeclared, install_date=install_date, prtinputmaxcapacity=prtinputmaxcapacity, DisplayString=DisplayString, hrdevicestatus=hrdevicestatus, hrStorageEntry=hrStorageEntry, default_copies=default_copies, prtmarkeraddressabilityunit=prtmarkeraddressabilityunit, job_info_attr_2=job_info_attr_2, scanner_button_status=scanner_button_status, prtmarkersuppliestype=prtmarkersuppliestype, prtMediaPathTable=prtMediaPathTable, settings_system=settings_system, prtmarkernorthmargin=prtmarkernorthmargin, scan_calibration_target=scan_calibration_target, status_prt_eng=status_prt_eng, prtmediapathdescription=prtmediapathdescription, prtalertlocation=prtalertlocation, prtgeneralcurrentlocalization=prtgeneralcurrentlocalization, prtLocalizationTable=prtLocalizationTable, copier_job_status=copier_job_status, prtalertcriticalevents=prtalertcriticalevents, scanner_motor_control=scanner_motor_control, prtmarkersuppliesclass=prtmarkersuppliesclass, job_info_attr_3=job_info_attr_3, cold_reset_media_size=cold_reset_media_size, io=io, copier_adf_page_count=copier_adf_page_count, prtinterpreterdescription=prtinterpreterdescription, error9_code=error9_code, prtcoverstatus=prtcoverstatus, prtmediapathmaxspeed=prtmediapathmaxspeed, pjl=pjl, scan_height=scan_height, prtinterpreterfeedaddressability=prtinterpreterfeedaddressability, maximum_resource_saving_memory=maximum_resource_saving_memory, job=job, prtInput=prtInput, error10_time_stamp=error10_time_stamp, prtgeneralconfigchanges=prtgeneralconfigchanges, scan_adf_page_count=scan_adf_page_count, prtmarkersuppliesdescription=prtmarkersuppliesdescription, job_info_attr_6=job_info_attr_6, prtInterpreterTable=prtInterpreterTable, prtDeviceRefTable=prtDeviceRefTable, prtGeneralEntry=prtGeneralEntry, prtinputdefaultindex=prtinputdefaultindex, job_info_attr_4=job_info_attr_4, scan_upload_error=scan_upload_error, prtdevicerefindex=prtdevicerefindex, prtinterpreterlangfamily=prtinterpreterlangfamily, prtinputserialnumber=prtinputserialnumber, scan_image_type=scan_image_type, prtconsolecolor=prtconsolecolor, prtinterpreterdefaultcharsetout=prtinterpreterdefaultcharsetout, scanner_jam_page_count=scanner_jam_page_count, prtinputmediadimxfeeddirdeclared=prtinputmediadimxfeeddirdeclared, channel_entry=channel_entry, error2_time_stamp=error2_time_stamp, prtchanneldefaultpagedesclangindex=prtchanneldefaultpagedesclangindex, wide_a4=wide_a4, error7_code=error7_code, hrm=hrm, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, job_info_pages_processed=job_info_pages_processed, prtmarkerwestmargin=prtmarkerwestmargin, error4_time_stamp=error4_time_stamp, error6_code=error6_code, channel_io_errors=channel_io_errors, print_engine_jam_count=print_engine_jam_count, prtStorageRefEntry=prtStorageRefEntry, print_engine=print_engine, copier_token=copier_token, error4_code=error4_code, dm=dm, job_info_outbins_used=job_info_outbins_used, prtinputmediadimfeeddirchosen=prtinputmediadimfeeddirchosen, scan_subsample=scan_subsample, prtCoverEntry=prtCoverEntry, prtmarkersuppliesmarkerindex=prtmarkersuppliesmarkerindex, job_info_state=job_info_state, prtconsoledescription=prtconsoledescription, scan_resolution_range=scan_resolution_range, prtinputmediadimxfeeddirchosen=prtinputmediadimxfeeddirchosen)
