...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/LJ1220-MIB
...
mibBuilder.exportSymbols("LJ1220-MIB", mio1_type=mio1_type, dm=dm, DisplayString=DisplayString, copier_job_num_copies=copier_job_num_copies, prtmarkeraddressabilityunit=prtmarkeraddressabilityunit, prtoutputstatus=prtoutputstatus, prtmarkerdefaultindex=prtmarkerdefaultindex, hrdeviceindex=hrdeviceindex, error2_code=error2_code, destination_subsystem=destination_subsystem, prtcoverdescription=prtcoverdescription, job_info_attr_12=job_info_attr_12, prtInput=prtInput, prtinputmediadimxfeeddirdeclared=prtinputmediadimxfeeddirdeclared, channelprinteralert=channelprinteralert, interface=interface, resource_saving=resource_saving, prtMediaPathEntry=prtMediaPathEntry, prtconsoleontime=prtconsoleontime, prtOutputEntry=prtOutputEntry, hrmemorysize=hrmemorysize, prtOutput=prtOutput, job_info_pages_printed=job_info_pages_printed, prtMediaPathTable=prtMediaPathTable, error5_time_stamp=error5_time_stamp, job_info_physical_outbins_used=job_info_physical_outbins_used, on_off_line=on_off_line, status_scanner=status_scanner, settings_copier=settings_copier, pdl_pcl=pdl_pcl, print_internal_page=print_internal_page, hrstoragesize=hrstoragesize, scan_pad_image=scan_pad_image, intray=intray, prtgeneralcurrentlocalization=prtgeneralcurrentlocalization, prtmarkersuppliesmaxcapacity=prtmarkersuppliesmaxcapacity, default_vmi=default_vmi, hrstorageallocationunits=hrstorageallocationunits, prtchannelifindex=prtchannelifindex, device_name=device_name, channel_io_errors=channel_io_errors, hrDeviceTable=hrDeviceTable, job_input_auto_continue_mode=job_input_auto_continue_mode, channel_bytes_sent=channel_bytes_sent, settings_system=settings_system, prtInputTable=prtInputTable, scan_height=scan_height, hrdevicetype=hrdevicetype, prtinterpreterdefaultcharsetout=prtinterpreterdefaultcharsetout, prtdevicerefindex=prtdevicerefindex, hrDeviceEntry=hrDeviceEntry, hrstorageindex=hrstorageindex, form_feed_needed=form_feed_needed, copier_job_collation=copier_job_collation, default_ret=default_ret, prtinputmediadimxfeeddirchosen=prtinputmediadimxfeeddirchosen, prtmarkersuppliesdescription=prtmarkersuppliesdescription, custom_paper_feed_dim=custom_paper_feed_dim, error5_code=error5_code, prtmediapathminmediaxfeeddir=prtmediapathminmediaxfeeddir, prtinputcurrentlevel=prtinputcurrentlevel, prtalertgroup=prtalertgroup, scanner_jam_page_count=scanner_jam_page_count, prtChannelEntry=prtChannelEntry, prtinterpreterlangfamily=prtinterpreterlangfamily, tray1_media_size_loaded=tray1_media_size_loaded, copier_job=copier_job, error1=error1, job_input_auto_continue_timeout=job_input_auto_continue_timeout, error7=error7, simm=simm, tray1_fuser_temperature=tray1_fuser_temperature, prtalerttime=prtalerttime, device=device, prtchanneltype=prtchanneltype, error8_time_stamp=error8_time_stamp, prtoutputtype=prtoutputtype, prtConsoleLights=prtConsoleLights, prtconsolenumberofdisplaychars=prtconsolenumberofdisplaychars, prtmediapathminmediafeeddir=prtmediapathminmediafeeddir, error2=error2, active_print_jobs=active_print_jobs, pjl=pjl, scan_compression_factor=scan_compression_factor, error10_time_stamp=error10_time_stamp, channel_table=channel_table, prtalertlocation=prtalertlocation, scanner_button_status=scanner_button_status, scan_image_type=scan_image_type, prtinterpreterlangversion=prtinterpreterlangversion, prtgeneralreset=prtgeneralreset, prtinterpreterfeedaddressability=prtinterpreterfeedaddressability, prtAlert=prtAlert, copier_reduction=copier_reduction, hrdevicedescr=hrdevicedescr, prtconsoledisable=prtconsoledisable, prtgeneralserviceperson=prtgeneralserviceperson, scanner=scanner, io_switch=io_switch, error4_time_stamp=error4_time_stamp, scanner_adf_page_count=scanner_adf_page_count, hrprinterdetectederrorstate=hrprinterdetectederrorstate, custom_paper_dim_unit=custom_paper_dim_unit, hrPrinterTable=hrPrinterTable, prtinterpretertwoway=prtinterpretertwoway, prtinterpreterversion=prtinterpreterversion, hrstoragetype=hrstoragetype, prtinputdimunit=prtinputdimunit, prtmediapathtype=prtmediapathtype, copier=copier, wide_a4=wide_a4, error2_time_stamp=error2_time_stamp, scan_upload=scan_upload, prtinterpreterdescription=prtinterpreterdescription, device_config_token=device_config_token, prtinputname=prtinputname, error9=error9, mio=mio, scan_resolution_range=scan_resolution_range, default_media_size=default_media_size, prtmarkerspotcolorants=prtmarkerspotcolorants, error8=error8, prtInputEntry=prtInputEntry, source_subsystem=source_subsystem, prtmarkerprocesscolorants=prtmarkerprocesscolorants, hrdevicestatus=hrdevicestatus, printmib=printmib, prtGeneralTable=prtGeneralTable, default_lines_per_page=default_lines_per_page, prtinputversion=prtinputversion, prtmediapathmaxspeed=prtmediapathmaxspeed, prtconsoleofftime=prtconsoleofftime, prtmarkersuppliessupplyunit=prtmarkersuppliessupplyunit, default_copies=default_copies, prtMarkerTable=prtMarkerTable, prtmarkernorthmargin=prtmarkernorthmargin, prtmediapathdescription=prtmediapathdescription, prtalertdescription=prtalertdescription, prtconsolecolor=prtconsolecolor, job_info_attr_6=job_info_attr_6, job_info_attr_15=job_info_attr_15, prtmediapathdefaultindex=prtmediapathdefaultindex, prtmarkeraddressabilityfeeddir=prtmarkeraddressabilityfeeddir, install_date=install_date, scan_calibration=scan_calibration, copier_num_copies=copier_num_copies, error3=error3, error3_time_stamp=error3_time_stamp, prtInterpreterTable=prtInterpreterTable, status_prt_eng=status_prt_eng, id=id, job_info_change_id=job_info_change_id, prtmediapathstatus=prtmediapathstatus, auto_continue=auto_continue, prtalertcode=prtalertcode, prtinputserialnumber=prtinputserialnumber, hrStorage=hrStorage, prtMarker=prtMarker, error6_code=error6_code, prtchannelprotocolversion=prtchannelprotocolversion, hrdeviceid=hrdeviceid, pcl_default_font_height=pcl_default_font_height, tables=tables, channel_bytes_received=channel_bytes_received, prtinputsecurity=prtinputsecurity, prtmediapathmaxmediafeeddir=prtmediapathmaxmediafeeddir, scan_calibration_error=scan_calibration_error, error7_time_stamp=error7_time_stamp, copier_job_media_size=copier_job_media_size, fw_rom_datecode=fw_rom_datecode, io=io, prtmediapathmediasizeunit=prtmediapathmediasizeunit, pcl_default_font_width=pcl_default_font_width, scanner_scanline_statistics=scanner_scanline_statistics, error6_time_stamp=error6_time_stamp, cold_reset_media_size=cold_reset_media_size, scan_adf_page_count=scan_adf_page_count, prtAlertTable=prtAlertTable, settings_scanner=settings_scanner, prtStorageRefTable=prtStorageRefTable, current_job_parsing_id=current_job_parsing_id, error4_code=error4_code, errorlog=errorlog, hp=hp, job_info_attr_9=job_info_attr_9, prtstoragerefindex=prtstoragerefindex, job_info_stage=job_info_stage, prtinputmaxcapacity=prtinputmaxcapacity, simm2_capacity=simm2_capacity, job=job, default_bits_per_pixel=default_bits_per_pixel, status_pdl=status_pdl, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, total_engine_page_count=total_engine_page_count, job_info_attr_7=job_info_attr_7, scan_calibration_download=scan_calibration_download, settings_io=settings_io, sleep_mode=sleep_mode, job_info_attr_5=job_info_attr_5, job_info=job_info, default_scanner_margin_right=default_scanner_margin_right, prtalertcriticalevents=prtalertcriticalevents, prtlocalizationcountry=prtlocalizationcountry, scan_token=scan_token, pysmi_continue=pysmi_continue, print_engine_jam_count=print_engine_jam_count, prtalertallevents=prtalertallevents, default_print_quality=default_print_quality, status_copier=status_copier, scan_subsample=scan_subsample, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, error_log_clear=error_log_clear, copier_collation=copier_collation, scan_calibration_target=scan_calibration_target, copier_quality=copier_quality, job_info_attr_3=job_info_attr_3, hrstorageallocationfailures=hrstorageallocationfailures, prtmarkersuppliestype=prtmarkersuppliestype, prtCoverTable=prtCoverTable, prtinterpreterlanglevel=prtinterpreterlanglevel, job_info_pages_processed=job_info_pages_processed, job_info_outcome=job_info_outcome, error6=error6, scan_contrast=scan_contrast, prtmarkersuppliescolorantindex=prtmarkersuppliescolorantindex, not_ready_source_scanner=not_ready_source_scanner, hrstorageused=hrstorageused, energy_star=energy_star, job_info_attr_8=job_info_attr_8, prtgeneralcurrentoperator=prtgeneralcurrentoperator, prtmarkerstatus=prtmarkerstatus, pcl_resource_saving_memory_size=pcl_resource_saving_memory_size, prtlocalizationcharacterset=prtlocalizationcharacterset, prtLocalization=prtLocalization, prtinputtype=prtinputtype, error9_code=error9_code, intray1=intray1, prtmarkersouthmargin=prtmarkersouthmargin, prtinputdescription=prtinputdescription, settings_pdl=settings_pdl, error1_time_stamp=error1_time_stamp, prtinputdefaultindex=prtinputdefaultindex, prtinterpreterdefaultcharsetin=prtinterpreterdefaultcharsetin, prtInterpreterEntry=prtInterpreterEntry, copier_job_status=copier_job_status, prtchannelinformation=prtchannelinformation, prtinterpreterxfeedaddressability=prtinterpreterxfeedaddressability, mio1=mio1, job_info_io_source=job_info_io_source, prtgeneralprintername=prtgeneralprintername, job_info_outbins_used=job_info_outbins_used, prtconsoledisplaybuffertext=prtconsoledisplaybuffertext, reprint=reprint, test=test)
mibBuilder.exportSymbols("LJ1220-MIB", copier_token=copier_token, settings_prt_eng=settings_prt_eng, pdl=pdl, scan_pixel_data_type=scan_pixel_data_type, prtlocalizationlanguage=prtlocalizationlanguage, prtCover=prtCover, copier_job_contrast=copier_job_contrast, job_info_attribute=job_info_attribute, job_info_attr_13=job_info_attr_13, scan_control_descriptor=scan_control_descriptor, prtOutputTable=prtOutputTable, prtinputmediadimfeeddirchosen=prtinputmediadimfeeddirchosen, ui_select_option=ui_select_option, asset_number=asset_number, default_scanner_margin_left=default_scanner_margin_left, job_info_attr_16=job_info_attr_16, prtinputmediadimfeeddirdeclared=prtinputmediadimfeeddirdeclared, ui_add_option=ui_add_option, io_timeout=io_timeout, prtoutputremainingcapacity=prtoutputremainingcapacity, print_engine_mispick_count=print_engine_mispick_count, prtConsoleLightEntry=prtConsoleLightEntry, prtDeviceRefTable=prtDeviceRefTable, error1_code=error1_code, hrStorageEntry=hrStorageEntry, scan_upload_error=scan_upload_error, settings_intray=settings_intray, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtmarkereastmargin=prtmarkereastmargin, prtmarkerpoweroncount=prtmarkerpoweroncount, hrm=hrm, scanner_retrieve_scanline=scanner_retrieve_scanline, prtinputmedianame=prtinputmedianame, system=system, job_info_name1=job_info_name1, default_horizontal_black_resolution=default_horizontal_black_resolution, prtChannelTable=prtChannelTable, postscript_resource_saving_memory_size=postscript_resource_saving_memory_size, error5=error5, maximum_resource_saving_memory=maximum_resource_saving_memory, prtmarkersuppliesmarkerindex=prtmarkersuppliesmarkerindex, hrdeviceerrors=hrdeviceerrors, prtmarkercounterunit=prtmarkercounterunit, settings_job=settings_job, default_page_protect=default_page_protect, prtmarkerwestmargin=prtmarkerwestmargin, prtmarkersuppliesclass=prtmarkersuppliesclass, simm2=simm2, simm1_type=simm1_type, copier_print_page_count=copier_print_page_count, prtConsoleLightTable=prtConsoleLightTable, form_feed=form_feed, intrays=intrays, prtMediaPath=prtMediaPath, channel_entry=channel_entry, pjl_password=pjl_password, job_info_state=job_info_state, processing_subsystem=processing_subsystem, prtalertgroupindex=prtalertgroupindex, transfer_setting=transfer_setting, prtgeneralconfigchanges=prtgeneralconfigchanges, prtDeviceRefEntry=prtDeviceRefEntry, pcl_default_font_source=pcl_default_font_source, job_info_attr_14=job_info_attr_14, pdl_postscript=pdl_postscript, prtconsoledescription=prtconsoledescription, error3_code=error3_code, scan_resolution=scan_resolution, hrDevice=hrDevice, self_test=self_test, postscript_print_errors=postscript_print_errors, prtGeneral=prtGeneral, scan_gamma_correction=scan_gamma_correction, prtmarkeraddressabilityxfeeddir=prtmarkeraddressabilityxfeeddir, prtmarkerlifecount=prtmarkerlifecount, error7_code=error7_code, error10_code=error10_code, prtinputcapacityunit=prtinputcapacityunit, hrstoragedescr=hrstoragedescr, prtchannelstatus=prtchannelstatus, prtcoverstatus=prtcoverstatus, error9_time_stamp=error9_time_stamp, scan_compression=scan_compression, prtoutputdefaultindex=prtoutputdefaultindex, prtchannelstate=prtchannelstate, job_info_name2=job_info_name2, prtalerttraininglevel=prtalerttraininglevel, channelnumberofchannels=channelnumberofchannels, job_info_attr_1=job_info_attr_1, prtchanneldefaultpagedesclangindex=prtchanneldefaultpagedesclangindex, prtinputstatus=prtinputstatus, prtmarkermarktech=prtmarkermarktech, job_info_size=job_info_size, model_name=model_name, prtmarkersupplieslevel=prtmarkersupplieslevel, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertEntry=prtAlertEntry, prtinterpreterdefaultorientation=prtinterpreterdefaultorientation, prtoutputcapacityunit=prtoutputcapacityunit, ui_delete_option=ui_delete_option, prtStorageRefEntry=prtStorageRefEntry, default_vertical_black_resolution=default_vertical_black_resolution, job_info_attr_10=job_info_attr_10, error8_code=error8_code, hrprinterstatus=hrprinterstatus, hrStorageTable=hrStorageTable, channel_jobs_received=channel_jobs_received, print_engine=print_engine, prtmediapathmaxmediaxfeeddir=prtmediapathmaxmediaxfeeddir, prtLocalizationEntry=prtLocalizationEntry, prtinputmodel=prtinputmodel, copier_contrast=copier_contrast, prtconsolelocalization=prtconsolelocalization, job_being_parsed=job_being_parsed, prtmediapathmaxspeedprintunit=prtmediapathmaxspeedprintunit, hrPrinterEntry=hrPrinterEntry, prtchannelcurrentjobcntllangindex=prtchannelcurrentjobcntllangindex, pcl_default_font_number=pcl_default_font_number, prtCoverEntry=prtCoverEntry, prtChannel=prtChannel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMarkerEntry=prtMarkerEntry, copier_job_reduction=copier_job_reduction, prtgeneralserialnumber=prtgeneralserialnumber, prtinputvendorname=prtinputvendorname, imaging=imaging, service_password=service_password, prtconsolenumberofdisplaylines=prtconsolenumberofdisplaylines, prtMarkerSupplies=prtMarkerSupplies, scanner_motor_control=scanner_motor_control, error4=error4, dark_courier=dark_courier, job_info_attr_4=job_info_attr_4, prtInterpreter=prtInterpreter, copier_job_quality=copier_job_quality, simm1=simm1, simm2_type=simm2_type, error10=error10, prtalertseveritylevel=prtalertseveritylevel, serial_number=serial_number, print_density=print_density, channel=channel, prtoutputmaxcapacity=prtoutputmaxcapacity, job_info_attr_11=job_info_attr_11, device_location=device_location, copier_adf_page_count=copier_adf_page_count, custom_paper_xfeed_dim=custom_paper_xfeed_dim, simm1_capacity=simm1_capacity, status_system=status_system, prtGeneralEntry=prtGeneralEntry, prtLocalizationTable=prtLocalizationTable, job_info_attr_2=job_info_attr_2)
