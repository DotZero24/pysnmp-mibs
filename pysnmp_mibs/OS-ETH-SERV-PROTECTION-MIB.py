...
mibBuilder.exportSymbols("OS-ETH-SERV-PROTECTION-MIB", osEthElpRemoteMepIdWorking=osEthElpRemoteMepIdWorking, osEthElpTrackCcmStateWorking=osEthElpTrackCcmStateWorking, osEthElpTrackCcm=osEthElpTrackCcm, osEthElpFarEndFsmStateName=osEthElpFarEndFsmStateName, osEthElpCommand=osEthElpCommand, osEthElpRemoteMepIdProtection=osEthElpRemoteMepIdProtection, osEthElpHoldOffDelay=osEthElpHoldOffDelay, osEthElpRevertDelay=osEthElpRevertDelay, osEthProtectionNotificationsGroup=osEthProtectionNotificationsGroup, osEthServProtection=osEthServProtection, osEthElpWorkingSignalState=osEthElpWorkingSignalState, osEthProtConformance=osEthProtConformance, osEthElpTimeToRevert=osEthElpTimeToRevert, osEthElpPendingCommand=osEthElpPendingCommand, TrailSignalState=TrailSignalState, osEthElpApsMacAddress=osEthElpApsMacAddress, osEthElpTrackCcmStateProtection=osEthElpTrackCcmStateProtection, osEthElpFsmStateName=osEthElpFsmStateName, osEthProtectionMandatoryGroup=osEthProtectionMandatoryGroup, osEthElpTrailSwitch=osEthElpTrailSwitch, osEthElpProtectionIndexName=osEthElpProtectionIndexName, osEthElpProtectionSignalState=osEthElpProtectionSignalState, osEthProtMIBCompliances=osEthProtMIBCompliances, osEthServProtNotifications=osEthServProtNotifications, ElpCommand=ElpCommand, osEthServElpTable=osEthServElpTable, osEthProtMIBCompliance=osEthProtMIBCompliance, osEthElpApsTxCount=osEthElpApsTxCount, PYSNMP_MODULE_ID=osEthServProtection, osEthElpAdminStatus=osEthElpAdminStatus, osEthElpActiveTrail=osEthElpActiveTrail, osEthProtMIBGroups=osEthProtMIBGroups, osEthElpApsRxCount=osEthElpApsRxCount, CcmTrackState=CcmTrackState, osEthServElpEntry=osEthServElpEntry)
