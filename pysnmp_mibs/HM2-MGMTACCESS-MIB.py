...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-MGMTACCESS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:56:13 2025
...
class Hm2SshHmacAlgorithms(TextualConvention, Bits):
    status = "current"
    namedValues = NamedValues(
        *(("hmac-sha1", 0),
          ("hmac-sha2-256", 1),
...
class Hm2SshKexAlgorithms(TextualConvention, Bits):
    status = "current"
    namedValues = NamedValues(
...
class Hm2SshEncryptionAlgorithms(TextualConvention, Bits):
    status = "current"
    namedValues = NamedValues(
        *(("aes128-ctr", 0),
          ("aes192-ctr", 1),
...
_Hm2SnmpV1AdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2SnmpV2AdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2SnmpV3AdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2SnmpPortNumber_Type.__name__ = "InetPortNumber"
...
_Hm2SnmpOver802AdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2SnmpTrapServiceAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2WebHttpAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2WebHttpsAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2WebHttpPortNumber_Type.__name__ = "InetPortNumber"
...
_Hm2WebHttpsPortNumber_Type.__name__ = "InetPortNumber"
...
_Hm2WebTrapEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2WebHttpsServerTlsVersions_Type.__name__ = "Hm2TlsVersions"
...
class _Hm2WebHttpsServerTlsCipherSuites_Type(Hm2TlsCipherSuites):
    ...
    defaultBinValue = "00000011"


_Hm2WebHttpsServerTlsCipherSuites_Type.__name__ = "Hm2TlsCipherSuites"
...
_Hm2TelnetServerAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2TelnetServerPort_Type.__name__ = "InetPortNumber"
...
_Hm2TelnetTrapEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2SshAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2SshPortNumber_Type.__name__ = "InetPortNumber"
...
if mibBuilder.loadTexts:
    hm2SshDSAKeyControl.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    hm2SshFingerPrintDSA.setStatus("obsolete")
...
_Hm2SshTrapEnable_Type.__name__ = "HmEnabledStatus"
...
class _Hm2SshKeyFingerPrintType_Type(Integer32):
    """Custom type hm2SshKeyFingerPrintType based on Integer32"""
    defaultValue = 2
...
_Hm2SshKeyFingerPrintType_Type.__name__ = "Integer32"
_Hm2SshKeyFingerPrintType_Object = MibScalar
hm2SshKeyFingerPrintType = _Hm2SshKeyFingerPrintType_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 4, 18),
    _Hm2SshKeyFingerPrintType_Type()
)
hm2SshKeyFingerPrintType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SshKeyFingerPrintType.setStatus("current")


class _Hm2SshHmacAlgorithms_Type(Hm2SshHmacAlgorithms):
    """Custom type hm2SshHmacAlgorithms based on Hm2SshHmacAlgorithms"""
    defaultBinValue = "11011"


_Hm2SshHmacAlgorithms_Type.__name__ = "Hm2SshHmacAlgorithms"
_Hm2SshHmacAlgorithms_Object = MibScalar
hm2SshHmacAlgorithms = _Hm2SshHmacAlgorithms_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 4, 19),
    _Hm2SshHmacAlgorithms_Type()
)
hm2SshHmacAlgorithms.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SshHmacAlgorithms.setStatus("current")


class _Hm2SshKexAlgorithms_Type(Hm2SshKexAlgorithms):
    """Custom type hm2SshKexAlgorithms based on Hm2SshKexAlgorithms"""
    defaultBinValue = "0001111"


_Hm2SshKexAlgorithms_Type.__name__ = "Hm2SshKexAlgorithms"
_Hm2SshKexAlgorithms_Object = MibScalar
hm2SshKexAlgorithms = _Hm2SshKexAlgorithms_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 4, 20),
    _Hm2SshKexAlgorithms_Type()
)
hm2SshKexAlgorithms.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SshKexAlgorithms.setStatus("current")


class _Hm2SshEncryptionAlgorithms_Type(Hm2SshEncryptionAlgorithms):
    """Custom type hm2SshEncryptionAlgorithms based on Hm2SshEncryptionAlgorithms"""
    defaultBinValue = "100101"


_Hm2SshEncryptionAlgorithms_Type.__name__ = "Hm2SshEncryptionAlgorithms"
_Hm2SshEncryptionAlgorithms_Object = MibScalar
hm2SshEncryptionAlgorithms = _Hm2SshEncryptionAlgorithms_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 4, 21),
    _Hm2SshEncryptionAlgorithms_Type()
)
hm2SshEncryptionAlgorithms.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2SshEncryptionAlgorithms.setStatus("current")
...
_Hm2PreLoginBannerAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2CliLoginBannerAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2ConsoleTrapEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2ConsoleServiceShellAdminState_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaIpAddrType_Type.__name__ = "InetAddressType"
...
_Hm2RmaIpAddr_Type.__name__ = "InetAddress"
...
_Hm2RmaPrefixLength_Type.__name__ = "InetAddressPrefixLength"
...
_Hm2RmaSrvHttp_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaSrvHttps_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaSrvSnmp_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaSrvTelnet_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaSrvSsh_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaSrvIEC61850_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaSrvModbusTcp_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaSrvEthernetIP_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaSrvProfinetIO_Type.__name__ = "HmEnabledStatus"
...
_Hm2RmaOperation_Type.__name__ = "HmEnabledStatus"
...
hm2MgmtAccessStatisticsGroup = _Hm2MgmtAccessStatisticsGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10)
)
_Hm2HttpPacketsSent_Type = Counter64
_Hm2HttpPacketsSent_Object = MibScalar
hm2HttpPacketsSent = _Hm2HttpPacketsSent_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 1),
    _Hm2HttpPacketsSent_Type()
)
hm2HttpPacketsSent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2HttpPacketsSent.setStatus("current")
_Hm2HttpPacketsReceived_Type = Counter64
_Hm2HttpPacketsReceived_Object = MibScalar
hm2HttpPacketsReceived = _Hm2HttpPacketsReceived_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 2),
    _Hm2HttpPacketsReceived_Type()
)
hm2HttpPacketsReceived.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2HttpPacketsReceived.setStatus("current")
_Hm2HttpsPacketsSent_Type = Counter64
_Hm2HttpsPacketsSent_Object = MibScalar
hm2HttpsPacketsSent = _Hm2HttpsPacketsSent_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 3),
    _Hm2HttpsPacketsSent_Type()
)
hm2HttpsPacketsSent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2HttpsPacketsSent.setStatus("current")
_Hm2HttpsPacketsReceived_Type = Counter64
_Hm2HttpsPacketsReceived_Object = MibScalar
hm2HttpsPacketsReceived = _Hm2HttpsPacketsReceived_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 4),
    _Hm2HttpsPacketsReceived_Type()
)
hm2HttpsPacketsReceived.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2HttpsPacketsReceived.setStatus("current")
_Hm2TelnetPacketsSent_Type = Counter64
_Hm2TelnetPacketsSent_Object = MibScalar
hm2TelnetPacketsSent = _Hm2TelnetPacketsSent_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 5),
    _Hm2TelnetPacketsSent_Type()
)
hm2TelnetPacketsSent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2TelnetPacketsSent.setStatus("current")
_Hm2TelnetPacketsReceived_Type = Counter64
_Hm2TelnetPacketsReceived_Object = MibScalar
hm2TelnetPacketsReceived = _Hm2TelnetPacketsReceived_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 6),
    _Hm2TelnetPacketsReceived_Type()
)
hm2TelnetPacketsReceived.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2TelnetPacketsReceived.setStatus("current")
_Hm2SshPacketsSent_Type = Counter64
_Hm2SshPacketsSent_Object = MibScalar
hm2SshPacketsSent = _Hm2SshPacketsSent_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 7),
    _Hm2SshPacketsSent_Type()
)
hm2SshPacketsSent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2SshPacketsSent.setStatus("current")
_Hm2SshPacketsReceived_Type = Counter64
_Hm2SshPacketsReceived_Object = MibScalar
hm2SshPacketsReceived = _Hm2SshPacketsReceived_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 8),
    _Hm2SshPacketsReceived_Type()
)
hm2SshPacketsReceived.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2SshPacketsReceived.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"Hm2RestartAction": Hm2RestartAction,
       ...
       "Hm2SshHmacAlgorithms": Hm2SshHmacAlgorithms,
       "Hm2SshKexAlgorithms": Hm2SshKexAlgorithms,
       "Hm2SshEncryptionAlgorithms": Hm2SshEncryptionAlgorithms,
       ...
       "hm2SshKeyFingerPrintType": hm2SshKeyFingerPrintType,
       "hm2SshHmacAlgorithms": hm2SshHmacAlgorithms,
       "hm2SshKexAlgorithms": hm2SshKexAlgorithms,
       "hm2SshEncryptionAlgorithms": hm2SshEncryptionAlgorithms,
       ...
       "hm2MgmtAccessStatisticsGroup": hm2MgmtAccessStatisticsGroup,
       "hm2HttpPacketsSent": hm2HttpPacketsSent,
       "hm2HttpPacketsReceived": hm2HttpPacketsReceived,
       "hm2HttpsPacketsSent": hm2HttpsPacketsSent,
       "hm2HttpsPacketsReceived": hm2HttpsPacketsReceived,
       "hm2TelnetPacketsSent": hm2TelnetPacketsSent,
       "hm2TelnetPacketsReceived": hm2TelnetPacketsReceived,
       "hm2SshPacketsSent": hm2SshPacketsSent,
       "hm2SshPacketsReceived": hm2SshPacketsReceived,
