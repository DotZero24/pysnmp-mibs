...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hirschmann/HM2-MGMTACCESS-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 09:56:31 2025
...
HmLargeDisplayString, hm2ConfigurationMibs, HmEnabledStatus = mibBuilder.importSymbols("HM2-TC-MIB", "HmLargeDisplayString", "hm2ConfigurationMibs", "HmEnabledStatus")
...
class Hm2SshHmacAlgorithms(TextualConvention, Bits):
    status = 'current'
    namedValues = NamedValues(("hmac-sha1", 0), ("hmac-sha2-256", 1), ("hmac-sha2-512", 2), ("hmac-sha1-etm-at-openssh-com", 3), ("hmac-sha2-256-etm-at-openssh-com", 4), ("hmac-sha2-512-etm-at-openssh-com", 5))

class Hm2SshKexAlgorithms(TextualConvention, Bits):
    status = 'current'
    namedValues = NamedValues(("diffie-hellman-group1-sha1", 0), ("diffie-hellman-group14-sha1", 1), ("diffie-hellman-group14-sha256", 2), ("diffie-hellman-group16-sha512", 3), ("diffie-hellman-group18-sha512", 4), ("diffie-hellman-group-exchange-sha256", 5), ("ecdh-sha2-nistp256", 6), ("ecdh-sha2-nistp384", 7))

class Hm2SshEncryptionAlgorithms(TextualConvention, Bits):
    status = 'current'
    namedValues = NamedValues(("aes128-ctr", 0), ("aes192-ctr", 1), ("aes256-ctr", 2), ("aes128-gcm-at-openssh-com", 3), ("aes256-gcm-at-openssh-com", 4), ("chacha20-poly1305-at-openssh-com", 5))
...
hm2MgmtAccessStatisticsGroup = MibIdentifier((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10))
hm2SnmpV1AdminStatus = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 1, 1), HmEnabledStatus().clone('disable')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2SnmpV1AdminStatus.setStatus('current')
hm2SnmpV2AdminStatus = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 1, 2), HmEnabledStatus().clone('disable')).setMaxAccess("readwrite")
...
hm2WebHttpsServerTlsVersions = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 2, 17), Hm2TlsVersions().clone(namedValues=NamedValues(("tlsv1-2", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2WebHttpsServerTlsVersions.setStatus('current')
hm2WebHttpsServerTlsCipherSuites = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 2, 18), Hm2TlsCipherSuites().clone(namedValues=NamedValues(("tls-ecdhe-rsa-with-aes-128-gcm-sha256", 6), ("tls-ecdhe-rsa-with-aes-256-gcm-sha384", 7)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2WebHttpsServerTlsCipherSuites.setStatus('current')
hm2TelnetServerAdminStatus = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 3, 1), HmEnabledStatus().clone('disable')).setMaxAccess("readwrite")
...
if mibBuilder.loadTexts: hm2SshDSAKeyControl.setStatus('obsolete')
...
if mibBuilder.loadTexts: hm2SshFingerPrintDSA.setStatus('obsolete')
...
hm2SshKeyFingerPrintType = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 4, 18), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("md5", 1), ("sha256", 2))).clone('sha256')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2SshKeyFingerPrintType.setStatus('current')
hm2SshHmacAlgorithms = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 4, 19), Hm2SshHmacAlgorithms().clone(namedValues=NamedValues(("hmac-sha1", 0), ("hmac-sha2-256", 1), ("hmac-sha1-etm-at-openssh-com", 3), ("hmac-sha2-256-etm-at-openssh-com", 4)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2SshHmacAlgorithms.setStatus('current')
hm2SshKexAlgorithms = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 4, 20), Hm2SshKexAlgorithms().clone(namedValues=NamedValues(("diffie-hellman-group16-sha512", 3), ("diffie-hellman-group18-sha512", 4), ("diffie-hellman-group-exchange-sha256", 5), ("ecdh-sha2-nistp256", 6)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2SshKexAlgorithms.setStatus('current')
hm2SshEncryptionAlgorithms = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 4, 21), Hm2SshEncryptionAlgorithms().clone(namedValues=NamedValues(("aes128-ctr", 0), ("aes128-gcm-at-openssh-com", 3), ("chacha20-poly1305-at-openssh-com", 5)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2SshEncryptionAlgorithms.setStatus('current')
...
hm2HttpPacketsSent = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 1), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2HttpPacketsSent.setStatus('current')
hm2HttpPacketsReceived = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 2), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2HttpPacketsReceived.setStatus('current')
hm2HttpsPacketsSent = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 3), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2HttpsPacketsSent.setStatus('current')
hm2HttpsPacketsReceived = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 4), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2HttpsPacketsReceived.setStatus('current')
hm2TelnetPacketsSent = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 5), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2TelnetPacketsSent.setStatus('current')
hm2TelnetPacketsReceived = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 6), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2TelnetPacketsReceived.setStatus('current')
hm2SshPacketsSent = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 7), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2SshPacketsSent.setStatus('current')
hm2SshPacketsReceived = MibScalar((1, 3, 6, 1, 4, 1, 248, 11, 25, 1, 10, 8), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2SshPacketsReceived.setStatus('current')
...
mibBuilder.exportSymbols("HM2-MGMTACCESS-MIB", hm2ConsoleLogoutTrap=hm2ConsoleLogoutTrap, hm2WebHttpsServerRestart=hm2WebHttpsServerRestart, hm2RmaIndex=hm2RmaIndex, hm2TelnetServerSessionsTimeOut=hm2TelnetServerSessionsTimeOut, Hm2TlsVersions=Hm2TlsVersions, hm2WebHttpsServerTlsVersions=hm2WebHttpsServerTlsVersions, hm2CliLoginPrompt=hm2CliLoginPrompt, hm2SshProtocolLevel=hm2SshProtocolLevel, hm2SshPacketsReceived=hm2SshPacketsReceived, hm2TelnetPacketsSent=hm2TelnetPacketsSent, hm2HttpsPacketsReceived=hm2HttpsPacketsReceived, hm2WebTrapEnable=hm2WebTrapEnable, hm2SshLastLoginUserName=hm2SshLastLoginUserName, hm2MgmtAccessSshSESGroup=hm2MgmtAccessSshSESGroup, hm2SshKeyOperStatus=hm2SshKeyOperStatus, hm2WebHttpsCertPresent=hm2WebHttpsCertPresent, hm2MgmtAccessPreLoginBannerSESGroup=hm2MgmtAccessPreLoginBannerSESGroup, hm2SshKeyFingerPrintType=hm2SshKeyFingerPrintType, hm2RmaIpAddrType=hm2RmaIpAddrType, hm2RmaPrefixLength=hm2RmaPrefixLength, hm2SshOutboundMaxSessionsCount=hm2SshOutboundMaxSessionsCount, hm2ConsoleTrapEnable=hm2ConsoleTrapEnable, hm2MgmtAccessSshSESServerEnabled=hm2MgmtAccessSshSESServerEnabled, hm2WebLastLoginInetAddress=hm2WebLastLoginInetAddress, hm2WebHttpsCertFingerPrint=hm2WebHttpsCertFingerPrint, hm2MgmtAccessMibNotifications=hm2MgmtAccessMibNotifications, hm2WebHttpAdminStatus=hm2WebHttpAdminStatus, hm2RmaSrvEthernetIP=hm2RmaSrvEthernetIP, hm2SshTrapEnable=hm2SshTrapEnable, hm2TelnetServerSessionsCount=hm2TelnetServerSessionsCount, hm2SshOutboundSessionsCount=hm2SshOutboundSessionsCount, hm2RmaTable=hm2RmaTable, hm2SshMaxSessionsCount=hm2SshMaxSessionsCount, hm2CliLoginTimeoutSerial=hm2CliLoginTimeoutSerial, hm2WebHttpsCertOperStatus=hm2WebHttpsCertOperStatus, Hm2SshHmacAlgorithms=Hm2SshHmacAlgorithms, hm2SnmpOver802AdminStatus=hm2SnmpOver802AdminStatus, hm2TelnetLastLoginUserName=hm2TelnetLastLoginUserName, hm2SshLastLoginInetAddress=hm2SshLastLoginInetAddress, hm2MgmtAccessSnmpGroup=hm2MgmtAccessSnmpGroup, hm2RmaSrvProfinetIO=hm2RmaSrvProfinetIO, hm2TelnetLastLoginInetAddressType=hm2TelnetLastLoginInetAddressType, hm2SshKexAlgorithms=hm2SshKexAlgorithms, hm2RmaSrvModbusTcp=hm2RmaSrvModbusTcp, hm2SshFingerPrintDSA=hm2SshFingerPrintDSA, hm2RmaEntry=hm2RmaEntry, hm2TelnetLoginFailedTrap=hm2TelnetLoginFailedTrap, hm2TelnetLoginSuccessTrap=hm2TelnetLoginSuccessTrap, hm2WebLastLogoutUserName=hm2WebLastLogoutUserName, hm2SshPortNumber=hm2SshPortNumber, hm2SshLogoutTrap=hm2SshLogoutTrap, hm2MgmtAccessWebSESCertNotPresent=hm2MgmtAccessWebSESCertNotPresent, hm2SshLastLogoutUserName=hm2SshLastLogoutUserName, hm2MgmtAccessWebSESGroup=hm2MgmtAccessWebSESGroup, hm2SshFingerPrintRSA=hm2SshFingerPrintRSA, hm2SshPacketsSent=hm2SshPacketsSent, hm2HttpPacketsSent=hm2HttpPacketsSent, hm2HttpsPacketsSent=hm2HttpsPacketsSent, hm2WebLastLoginUserName=hm2WebLastLoginUserName, hm2CliLoginBannerText=hm2CliLoginBannerText, hm2RmaSrvTelnet=hm2RmaSrvTelnet, hm2WebHttpsServerTlsCipherSuites=hm2WebHttpsServerTlsCipherSuites, hm2ConsoleLoginFailedTrap=hm2ConsoleLoginFailedTrap, hm2PreLoginBannerText=hm2PreLoginBannerText, hm2SshLoginSuccessTrap=hm2SshLoginSuccessTrap, hm2WebHttpPortNumber=hm2WebHttpPortNumber, hm2WebLoginFailedTrap=hm2WebLoginFailedTrap, hm2MgmtAccessWebGroup=hm2MgmtAccessWebGroup, hm2TelnetServerPort=hm2TelnetServerPort, hm2SshKeysPresent=hm2SshKeysPresent, hm2SshLoginFailedTrap=hm2SshLoginFailedTrap, hm2MgmtAccessCliSESGroup=hm2MgmtAccessCliSESGroup, hm2TelnetTrapEnable=hm2TelnetTrapEnable, hm2SnmpV1AdminStatus=hm2SnmpV1AdminStatus, hm2WebLastLoginInetAddressType=hm2WebLastLoginInetAddressType, hm2SshHmacAlgorithms=hm2SshHmacAlgorithms, PYSNMP_MODULE_ID=hm2MgmtAccessMib, hm2WebLoginSuccessTrap=hm2WebLoginSuccessTrap, hm2SshLastLoginInetAddressType=hm2SshLastLoginInetAddressType, hm2TelnetServerAdminStatus=hm2TelnetServerAdminStatus, hm2TelnetLogoutTrap=hm2TelnetLogoutTrap, hm2SnmpV3AdminStatus=hm2SnmpV3AdminStatus, hm2MgmtAccessStatisticsGroup=hm2MgmtAccessStatisticsGroup, hm2SnmpTrapServiceAdminStatus=hm2SnmpTrapServiceAdminStatus, hm2TelnetServerMaxSessions=hm2TelnetServerMaxSessions, hm2CliLoginBannerAdminStatus=hm2CliLoginBannerAdminStatus, hm2WebHttpsCertControl=hm2WebHttpsCertControl, hm2SshEncryptionAlgorithms=hm2SshEncryptionAlgorithms, hm2MgmtAccessSshSESKeyNotAvailable=hm2MgmtAccessSshSESKeyNotAvailable, hm2SshOutboundSessionTimeout=hm2SshOutboundSessionTimeout, hm2RmaIpAddr=hm2RmaIpAddr, hm2ConsoleServiceShellAdminState=hm2ConsoleServiceShellAdminState, hm2RmaSrvHttps=hm2RmaSrvHttps, hm2ConsoleLastLoginUserName=hm2ConsoleLastLoginUserName, Hm2RestartAction=Hm2RestartAction, hm2RestrictedMgmtAccessGroup=hm2RestrictedMgmtAccessGroup, hm2MgmtAccessTelnetSESGroup=hm2MgmtAccessTelnetSESGroup, hm2MgmtAccessTelnetGroup=hm2MgmtAccessTelnetGroup, hm2MgmtAccessMib=hm2MgmtAccessMib, Hm2SshEncryptionAlgorithms=Hm2SshEncryptionAlgorithms, hm2TelnetLastLoginInetAddress=hm2TelnetLastLoginInetAddress, hm2RmaRowStatus=hm2RmaRowStatus, hm2RmaSrvSsh=hm2RmaSrvSsh, hm2SshDSAKeyControl=hm2SshDSAKeyControl, hm2ConsoleLoginSuccessTrap=hm2ConsoleLoginSuccessTrap, hm2WebHttpsCertFingerPrintType=hm2WebHttpsCertFingerPrintType, Hm2SshKexAlgorithms=Hm2SshKexAlgorithms, hm2MgmtAccessCliGroup=hm2MgmtAccessCliGroup, hm2MgmtAccessPreLoginBannerGroup=hm2MgmtAccessPreLoginBannerGroup, hm2RmaSrvSnmp=hm2RmaSrvSnmp, hm2SnmpV2AdminStatus=hm2SnmpV2AdminStatus, hm2HttpPacketsReceived=hm2HttpPacketsReceived, hm2WebIntfTimeOut=hm2WebIntfTimeOut, hm2WebLogoutTrap=hm2WebLogoutTrap, hm2MgmtAccessMibSNMPExtensionGroup=hm2MgmtAccessMibSNMPExtensionGroup, hm2PreLoginBannerAdminStatus=hm2PreLoginBannerAdminStatus, hm2ConsoleLastLogoutUserName=hm2ConsoleLastLogoutUserName, hm2TelnetLastLogoutUserName=hm2TelnetLastLogoutUserName, hm2MgmtAccessSnmpSESGroup=hm2MgmtAccessSnmpSESGroup, hm2RmaSrvHttp=hm2RmaSrvHttp, hm2MgmtAccessWebSESCertGenInProgress=hm2MgmtAccessWebSESCertGenInProgress, hm2MgmtAccessSshGroup=hm2MgmtAccessSshGroup, hm2MgmtAccessSshSESKeyGenInProgress=hm2MgmtAccessSshSESKeyGenInProgress, hm2RmaSrvIEC61850=hm2RmaSrvIEC61850, hm2MgmtAccessMibObjects=hm2MgmtAccessMibObjects, hm2TelnetPacketsReceived=hm2TelnetPacketsReceived, hm2SnmpPortNumber=hm2SnmpPortNumber, hm2SshSessionTimeout=hm2SshSessionTimeout, hm2WebHttpsAdminStatus=hm2WebHttpsAdminStatus, hm2RmaOperation=hm2RmaOperation, hm2SshSessionsCount=hm2SshSessionsCount, Hm2TlsCipherSuites=Hm2TlsCipherSuites, hm2WebHttpsPortNumber=hm2WebHttpsPortNumber, hm2SshAdminStatus=hm2SshAdminStatus, hm2SshRSAKeyControl=hm2SshRSAKeyControl, hm2RestrictedMgmtAccessSESGroup=hm2RestrictedMgmtAccessSESGroup)
