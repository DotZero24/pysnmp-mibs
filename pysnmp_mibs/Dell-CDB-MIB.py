...
mibBuilder.exportSymbols('Dell-CDB-MIB',**{'rlCDB':rlCDB,'rlStartupCDBChanged':rlStartupCDBChanged,'rlManualReboot':rlManualReboot,'rlStartupCDBEmpty':rlStartupCDBEmpty})