...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:31:15 2025
...
mibBuilder.exportSymbols("CISCO-WAN-SVC-MIB", ciscoWANSpvcFailReason=ciscoWANSpvcFailReason, cwspCallFwdFrameDiscard=cwspCallFwdFrameDiscard, cwspConnTraceEgressPortId=cwspConnTraceEgressPortId, cwspInCrankbacks=cwspInCrankbacks, ciscoWANSvcMIBGroups=ciscoWANSvcMIBGroups, cwspLoadAvlVcAbr=cwspLoadAvlVcAbr, cwspAbrCallClipSusceptibility=cwspAbrCallClipSusceptibility, cwspAbrCallBwdMcr=cwspAbrCallBwdMcr, cwspSscopBgnRcv=cwspSscopBgnRcv, cwspSscopPollRcv=cwspSscopPollRcv, cwspInFilterFailures=cwspInFilterFailures, cwspDropPtyXmt=cwspDropPtyXmt, cwspSscopStatRcv=cwspSscopStatRcv, cwspSpvcNodePrefix=cwspSpvcNodePrefix, cwspCallCalledAddress=cwspCallCalledAddress, cwspMinVcNrtVbr=cwspMinVcNrtVbr, cwspSscopEntry=cwspSscopEntry, cwspOperMinSvpcVpi=cwspOperMinSvpcVpi, cwspCacConfigTable=cwspCacConfigTable, cwspSscopRsRcv=cwspSscopRsRcv, cwspConnTraceSrcVci=cwspConnTraceSrcVci, cwspSscopMaxPD=cwspSscopMaxPD, cwspAddrType=cwspAddrType, cwspSigCfgT399=cwspSigCfgT399, cwspRoutingGrp=cwspRoutingGrp, cwspSetupXmt=cwspSetupXmt, cwspSscopConfigGrp=cwspSscopConfigGrp, cwspSscopEndakXmt=cwspSscopEndakXmt, cwsSwRevision=cwsSwRevision, cwspConnTraceLeafRef=cwspConnTraceLeafRef, cwspAbrCallFwdTbe=cwspAbrCallFwdTbe, cwspUtilFactorUbr=cwspUtilFactorUbr, cwspLoadClr01NrtVbr=cwspLoadClr01NrtVbr, cwspConnTraceGrp=cwspConnTraceGrp, cwspAbrCallOtherIntfVci=cwspAbrCallOtherIntfVci, cwspLoadAvlVcRtVbr=cwspLoadAvlVcRtVbr, cwspOperation=cwspOperation, ciscoWANSvcInfo=ciscoWANSvcInfo, cwspUniVersion=cwspUniVersion, cwspOperMaxSvccVpi=cwspOperMaxSvccVpi, cwspIncorrectMsgRcv=cwspIncorrectMsgRcv, cwspConnTrace=cwspConnTrace, cwspInCallFailures=cwspInCallFailures, cwspIlmiAttachmentPoint=cwspIlmiAttachmentPoint, cwspConnTraceResultStatus=cwspConnTraceResultStatus, cwspCallGrp=cwspCallGrp, cwspRegAddress=cwspRegAddress, ciscoWANPnniRemoteNodeId=ciscoWANPnniRemoteNodeId, cwspCall=cwspCall, cwspIlmiServRegEnable=cwspIlmiServRegEnable, cwspNotifyXmt=cwspNotifyXmt, cwspConfigTable=cwspConfigTable, cwspConnTraceNextIndex=cwspConnTraceNextIndex, cwspMaxP2mpRoots=cwspMaxP2mpRoots, cwspMaxVcCbr=cwspMaxVcCbr, cwspSscopBgakXmt=cwspSscopBgakXmt, cwspMaxVciBits=cwspMaxVciBits, cwspCacConfig=cwspCacConfig, cwspLoadClr0NrtVbr=cwspLoadClr0NrtVbr, cwspAbrCallCastType=cwspAbrCallCastType, cwspRoutingVpi=cwspRoutingVpi, cwspCountReset=cwspCountReset, cwspSscopSdpRcv=cwspSscopSdpRcv, cwspLoadAvlVcNrtVbr=cwspLoadAvlVcNrtVbr, cwspSscopBgakRcv=cwspSscopBgakRcv, cwspSscopRsakRcv=cwspSscopRsakRcv, cwspRegAddressOrgSscope=cwspRegAddressOrgSscope, cwspPrefixTable=cwspPrefixTable, cwspEnhancedIisp=cwspEnhancedIisp, cwspLoadMinGurCrUbr=cwspLoadMinGurCrUbr, cwspLoadClr0Cbr=cwspLoadClr0Cbr, cwspAbrCallTable=cwspAbrCallTable, cwspPnniControllerStatus=cwspPnniControllerStatus, cwspMaxVcBwCbr=cwspMaxVcBwCbr, cwspLoadAvlBwUbr=cwspLoadAvlBwUbr, ciscoWANSvcMIBCompliance3=ciscoWANSvcMIBCompliance3, cwspDefaultCdvtCbr=cwspDefaultCdvtCbr, cwspMaxVcBwNrtVbr=cwspMaxVcBwNrtVbr, cwspAbrCallMaxCtd=cwspAbrCallMaxCtd, cwspAddrLen=cwspAddrLen, cwspMaxVcBwRtVbr=cwspMaxVcBwRtVbr, cwspMinBwAbr=cwspMinBwAbr, cwspSigConfig=cwspSigConfig, cwspSigCfgT301=cwspSigCfgT301, cwspMinSvccVpi=cwspMinSvccVpi, cwspCallType=cwspCallType, cwspLoadCtdNrtVbr=cwspLoadCtdNrtVbr, cwspConnTraceSrcVpi=cwspConnTraceSrcVpi, cwspCallOtherIntfIndex=cwspCallOtherIntfIndex, cwspConnTraceQueryStatus=cwspConnTraceQueryStatus, cwspAddressTable=cwspAddressTable, cwspOperationTable=cwspOperationTable, cwspProgressXmt=cwspProgressXmt, cwspStatusRcv=cwspStatusRcv, cwspAbrCallMaxBwdCdv=cwspAbrCallMaxBwdCdv, cwspAddPtyRejRcv=cwspAddPtyRejRcv, cwspConnTraceifIndex=cwspConnTraceifIndex, cwspConnTraceType=cwspConnTraceType, cwspPrefixRowStatus=cwspPrefixRowStatus, cwspAbrCallCldAddress=cwspAbrCallCldAddress, cwspAddressGrp=cwspAddressGrp, cwspMinSvccVci=cwspMinSvccVci, cwspCallBwdScr=cwspCallBwdScr, cwspCallMaxFwdClr=cwspCallMaxFwdClr, cwspPrefix=cwspPrefix, cwspMaxSvccVpi=cwspMaxSvccVpi, cwspSscopPollXmt=cwspSscopPollXmt, cwspCallStartTime=cwspCallStartTime, cwspConfigGrp3=cwspConfigGrp3, cwspSscopEndRcv=cwspSscopEndRcv, cwspDefaultCdvtUbr=cwspDefaultCdvtUbr, cwspCallFwdMbs=cwspCallFwdMbs, cwspSscopMdRcv=cwspSscopMdRcv, cwspOutTimerFailures=cwspOutTimerFailures, cwspOperUniVersion=cwspOperUniVersion, cwspCallFwdConformance=cwspCallFwdConformance, cwspLoadAvlBwNrtVbr=cwspLoadAvlBwNrtVbr, cwspSignallingVpi=cwspSignallingVpi, cwspConnTraceCntlTable=cwspConnTraceCntlTable, cwspSscopUdXmt=cwspSscopUdXmt, cwspSigCfgT317=cwspSigCfgT317, ciscoWANPnniReachability=ciscoWANPnniReachability, cwspTimerExpiries=cwspTimerExpiries, cwspMinVcCbr=cwspMinVcCbr, cwspMaxVcUbr=cwspMaxVcUbr, cwspLoadGrp=cwspLoadGrp, cwspSetupRcv=cwspSetupRcv, cwspMaxBwRtVbr=cwspMaxBwRtVbr, cwspSigCfgT397=cwspSigCfgT397, cwspSscopSdpXmt=cwspSscopSdpXmt, cwspSigCfgT308=cwspSigCfgT308, cwspLoadBwAvail=cwspLoadBwAvail, cwspAbrCallCallRef=cwspAbrCallCallRef, cwspAbrCallMaxBwdClr=cwspAbrCallMaxBwdClr, cwspSscopErakXmt=cwspSscopErakXmt, cwspConnTraceCallRef=cwspConnTraceCallRef, cwspAlertRcv=cwspAlertRcv, cwspSscopStatsGrp=cwspSscopStatsGrp, cwspIlmiAutoConfEnable=cwspIlmiAutoConfEnable, cwspConnTraceEgressVpi=cwspConnTraceEgressVpi, cwspCallFwdCdvt=cwspCallFwdCdvt, cwspSscopEndakRcv=cwspSscopEndakRcv, cwspDefaultMbsNrtVbr=cwspDefaultMbsNrtVbr, cwspLoadTable=cwspLoadTable, cwspInResrcFailures=cwspInResrcFailures, cwspSvcBlocked=cwspSvcBlocked, cwspIlmiUCSMEnable=cwspIlmiUCSMEnable, ciscoWANSpvc=ciscoWANSpvc, cwspAddressRowStatus=cwspAddressRowStatus, cwspConnTraceLastNode=cwspConnTraceLastNode, cwspMaxP2mpLeafs=cwspMaxP2mpLeafs, cwspMaxVcBwAbr=cwspMaxVcBwAbr, cwspMaxBwNrtVbr=cwspMaxBwNrtVbr, cwspLoadClr01Ubr=cwspLoadClr01Ubr, cwspAddPtyAckXmt=cwspAddPtyAckXmt, cwspAbrCallVpi=cwspAbrCallVpi, cwspDefaultMbsRtVbr=cwspDefaultMbsRtVbr, cwspNniVersion=cwspNniVersion, cwsControllerStatus=cwsControllerStatus, cwspCacConfigEntry=cwspCacConfigEntry, cwspOutCallEstabs=cwspOutCallEstabs, cwspUtilFactorNrtVbr=cwspUtilFactorNrtVbr, cwspAddPtyXmt=cwspAddPtyXmt, cwspAbrCallFwdRdf=cwspAbrCallFwdRdf, cwsInfoGrp=cwsInfoGrp, cwspSscopErakRcv=cwspSscopErakRcv, cwspMinBwUbr=cwspMinBwUbr, cwspMaxBwAbr=cwspMaxBwAbr, cwspSscopTable=cwspSscopTable, ciscoWANSvcPort=ciscoWANSvcPort, cwspCallMaxBwdCdv=cwspCallMaxBwdCdv, cwspAbrCallFrtt=cwspAbrCallFrtt, cwspLoadCdvUbr=cwspLoadCdvUbr, cwspLoadCdvCbr=cwspLoadCdvCbr, cwspSscopTmtIdle=cwspSscopTmtIdle, cwspAbrCallFwdCdf=cwspAbrCallFwdCdf, cwspSigStatsEntry=cwspSigStatsEntry, cwspRegAtmAddress=cwspRegAtmAddress, ciscoWANPnniPortId=ciscoWANPnniPortId, cwspSscopStatXmt=cwspSscopStatXmt, cwspUtilFactorRtVbr=cwspUtilFactorRtVbr, cwspIlmiSecureLink=cwspIlmiSecureLink, cwspOperIlmiEnable=cwspOperIlmiEnable, cwspConnTraceGrp2=cwspConnTraceGrp2, cwspLoadClr01Abr=cwspLoadClr01Abr, cwspLoadMaxBwRtVbr=cwspLoadMaxBwRtVbr, cwspAbrCallBwdPcr=cwspAbrCallBwdPcr, cwspLoadCdvNrtVbr=cwspLoadCdvNrtVbr, ciscoWANSvcMIBCompliance=ciscoWANSvcMIBCompliance, cwspSscopSdRcv=cwspSscopSdRcv, cwspConnTraceDestCallRef=cwspConnTraceDestCallRef, cwspUtilFactorAbr=cwspUtilFactorAbr, cwspConnTraceDestVci=cwspConnTraceDestVci, cwspCallFwdScr=cwspCallFwdScr, cwspAddrPlanSupported=cwspAddrPlanSupported, cwspMaxVcBwUbr=cwspMaxVcBwUbr, cwspOperationGrp=cwspOperationGrp, cwspOutCallAttempts=cwspOutCallAttempts, cwspLoadMinGurCrNrtVbr=cwspLoadMinGurCrNrtVbr, cwspOperIfcType=cwspOperIfcType, cwspCallCastType=cwspCallCastType, cwspMaxSvpcVpi=cwspMaxSvpcVpi, cwspSscopStatus=cwspSscopStatus, cwspConnectAckXmt=cwspConnectAckXmt, cwspAbrCallCldSubAddr=cwspAbrCallCldSubAddr, cwspConnTraceTable=cwspConnTraceTable, cwspCallCalledSubAddr=cwspCallCalledSubAddr, cwspOperationEntry=cwspOperationEntry, cwspLoadCdvRtVbr=cwspLoadCdvRtVbr, cwspAbrCallMaxFwdClr=cwspAbrCallMaxFwdClr, cwspConnTraceDataIndex=cwspConnTraceDataIndex, cwspAddPtyAckRcv=cwspAddPtyAckRcv, cwspAbrCallBearerClass=cwspAbrCallBearerClass, cwspSscopMaxSTAT=cwspSscopMaxSTAT, cwspConnTraceCntlEntry=cwspConnTraceCntlEntry, cwspConnTraceEgressPhyPortId=cwspConnTraceEgressPhyPortId, cwspLoadMinGurCrAbr=cwspLoadMinGurCrAbr, cwspIlmiLocalAttrStd=cwspIlmiLocalAttrStd, cwspOperMaxVCCs=cwspOperMaxVCCs, cwspIlmiAddrRegEnable=cwspIlmiAddrRegEnable, cwspOutFilterFailures=cwspOutFilterFailures, cwspOutResrcFailures=cwspOutResrcFailures, cwspCallOtherIntfVpi=cwspCallOtherIntfVpi, cwspLoadAvlVcCbr=cwspLoadAvlVcCbr, cwspCallMaxFwdCdv=cwspCallMaxFwdCdv, cwspCallStatsEntry=cwspCallStatsEntry, cwspAddressEntry=cwspAddressEntry, cwspCallTable=cwspCallTable, cwspCallOtherIntfCallRef=cwspCallOtherIntfCallRef, ciscoWANSvcMIBConformance=ciscoWANSvcMIBConformance, cwspLoadAvlVcUbr=cwspLoadAvlVcUbr, cwspLoadBwTotal=cwspLoadBwTotal, cwspAbrCallMaxFwdCdv=cwspAbrCallMaxFwdCdv, cwspAbrCallClgSubAddr=cwspAbrCallClgSubAddr, cwspLoadAvlBwCbr=cwspLoadAvlBwCbr, cwspSscopStatsEntry=cwspSscopStatsEntry, cwspPnniControllerPhySlot=cwspPnniControllerPhySlot, cwspOperMinSvccVci=cwspOperMinSvccVci, cwspOperFailReason=cwspOperFailReason, cwspCallBwdCdvt=cwspCallBwdCdvt, cwspAbrCallServiceCategory=cwspAbrCallServiceCategory, cwspCallBwdFrameDiscard=cwspCallBwdFrameDiscard, cwspAbrCallVci=cwspAbrCallVci, cwspLoadMaxBwAbr=cwspLoadMaxBwAbr, cwspLoadAvlBwAbr=cwspLoadAvlBwAbr, cwspSscopUstatRcv=cwspSscopUstatRcv, cwspConnectRcv=cwspConnectRcv, cwspLoadCtdUbr=cwspLoadCtdUbr, cwspSigCfgT322=cwspSigCfgT322, cwspAddrProto=cwspAddrProto, cwspSigCfgT316=cwspSigCfgT316, cwspInRouteFailures=cwspInRouteFailures, cwspCallVpi=cwspCallVpi, cwspAbrCallBwdAdtf=cwspAbrCallBwdAdtf)
mibBuilder.exportSymbols("CISCO-WAN-SVC-MIB", cwspSscopBgnXmt=cwspSscopBgnXmt, cwspConnTraceEgressCallRef=cwspConnTraceEgressCallRef, cwspConnTraceIndex=cwspConnTraceIndex, cwspStatusXmt=cwspStatusXmt, cwspNetPrefix=cwspNetPrefix, cwspProgressRcv=cwspProgressRcv, cwspCallProcXmt=cwspCallProcXmt, cwspAbrCallType=cwspAbrCallType, cwspLoadMaxBwUbr=cwspLoadMaxBwUbr, cwspOperNniSigVersion=cwspOperNniSigVersion, cwspAbrCallBwdCdf=cwspAbrCallBwdCdf, cwspLoadEntry=cwspLoadEntry, cwspOperMaxVpiBits=cwspOperMaxVpiBits, cwspCallVci=cwspCallVci, cwspSscopBgrejXmt=cwspSscopBgrejXmt, cwspConfigTableRowStatus=cwspConfigTableRowStatus, cwspAbrCallBwdRif=cwspAbrCallBwdRif, cwspConnectXmt=cwspConnectXmt, cwspLoadClr0Ubr=cwspLoadClr0Ubr, cwspCallEntry=cwspCallEntry, cwspCallCallingAddress=cwspCallCallingAddress, cwspAbrCallBwdFrameDiscard=cwspAbrCallBwdFrameDiscard, cwspLastDiagnostic=cwspLastDiagnostic, cwspAbrCallBwdRdf=cwspAbrCallBwdRdf, cwspMinBwRtVbr=cwspMinBwRtVbr, cwspMaxP2pCalls=cwspMaxP2pCalls, cwspStatusEnqXmt=cwspStatusEnqXmt, cwspReleaseRcv=cwspReleaseRcv, cwspAbrCallBwdIcr=cwspAbrCallBwdIcr, ciscoWANSvcMIBCompliances=ciscoWANSvcMIBCompliances, cwspAbrCallBwdTbe=cwspAbrCallBwdTbe, ciscoWANSvcMIBObjects=ciscoWANSvcMIBObjects, CwspSpvcState=CwspSpvcState, cwspOutCallFailures=cwspOutCallFailures, cwspAddPtyRejXmt=cwspAddPtyRejXmt, cwspOperMaxVPCs=cwspOperMaxVPCs, cwspSscopCounterReset=cwspSscopCounterReset, ciscoWANPnniRouting=ciscoWANPnniRouting, ciscoWANPnniLinkStatus=ciscoWANPnniLinkStatus, cwspLoadCtdAbr=cwspLoadCtdAbr, cwspConfigGrp=cwspConfigGrp, cwspCallCallingSubAddr=cwspCallCallingSubAddr, cwspAbrCallEntry=cwspAbrCallEntry, cwspLoadClr01Cbr=cwspLoadClr01Cbr, cwspAbrCallFwdMcr=cwspAbrCallFwdMcr, ciscoWANSvcMIBCompliance2=ciscoWANSvcMIBCompliance2, cwspPrefixEntry=cwspPrefixEntry, cwspCallMaxCtd=cwspCallMaxCtd, cwspCallFwdPcr=cwspCallFwdPcr, cwspSigCounterReset=cwspSigCounterReset, cwspMinVcAbr=cwspMinVcAbr, cwspSscopTmrPoll=cwspSscopTmrPoll, cwspCallMaxBwdClr=cwspCallMaxBwdClr, cwspOperIlmiVersion=cwspOperIlmiVersion, cwspSscopRsakXmt=cwspSscopRsakXmt, cwspAdminStatus=cwspAdminStatus, cwspLoadCtdCbr=cwspLoadCtdCbr, cwspCallCallRef=cwspCallCallRef, cwspRegAddressGrp=cwspRegAddressGrp, PYSNMP_MODULE_ID=ciscoWANSvcMIB, cwspAbrCallFwdNrm=cwspAbrCallFwdNrm, cwspMaxVcAbr=cwspMaxVcAbr, cwspDropPtyRcv=cwspDropPtyRcv, cwspSpvcBlocked=cwspSpvcBlocked, cwspLoadCdvAbr=cwspLoadCdvAbr, cwspInCallEstabs=cwspInCallEstabs, cwspLastCause=cwspLastCause, cwspAbrCallFwdRif=cwspAbrCallFwdRif, cwspMinVcRtVbr=cwspMinVcRtVbr, cwspAbrCallFwdAdtf=cwspAbrCallFwdAdtf, cwspOutCrankbacks=cwspOutCrankbacks, cwspRegAddressEntry=cwspRegAddressEntry, cwspAbrCallBwdNrm=cwspAbrCallBwdNrm, cwspConnTraceAvail=cwspConnTraceAvail, cwspMaxBwUbr=cwspMaxBwUbr, cwspConfig=cwspConfig, cwspLoadCtdRtVbr=cwspLoadCtdRtVbr, cwspSignallingVci=cwspSignallingVci, cwspInTimerFailures=cwspInTimerFailures, cwspCallBwdPcr=cwspCallBwdPcr, cwspLoadMinGurCrCbr=cwspLoadMinGurCrCbr, cwspMinBwCbr=cwspMinBwCbr, cwspOperMaxSvpcVpi=cwspOperMaxSvpcVpi, cwspLoadMaxBwCbr=cwspLoadMaxBwCbr, cwspRegAddressTable=cwspRegAddressTable, cwspConnTraceDestVpi=cwspConnTraceDestVpi, cwspSscopStatsTable=cwspSscopStatsTable, CwspControllerState=CwspControllerState, cwspOutRouteFailures=cwspOutRouteFailures, cwspAbrCallOtherIntfVpi=cwspAbrCallOtherIntfVpi, cwspDefaultCdvtRtVbr=cwspDefaultCdvtRtVbr, cwspSpvcGrp=cwspSpvcGrp, cwspOperUniType=cwspOperUniType, cwspRestartRcv=cwspRestartRcv, cwspUtilFactorCbr=cwspUtilFactorCbr, cwspSscopTmrCC=cwspSscopTmrCC, cwspReleaseComplRcv=cwspReleaseComplRcv, cwspSscopSdXmt=cwspSscopSdXmt, cwspSpvcAddress=cwspSpvcAddress, cwspAbrCallClgAddress=cwspAbrCallClgAddress, cwspLoadClr01RtVbr=cwspLoadClr01RtVbr, cwspConnTraceEntry=cwspConnTraceEntry, cwspMinBwNrtVbr=cwspMinBwNrtVbr, cwspSscopTmrNoResp=cwspSscopTmrNoResp, cwspSigConfigEntry=cwspSigConfigEntry, cwspSigStats=cwspSigStats, cwspAddrRedistribute=cwspAddrRedistribute, cwspAddress=cwspAddress, cwspStatusEnqRcv=cwspStatusEnqRcv, cwspRoutingPriority=cwspRoutingPriority, cwspSscopMdXmt=cwspSscopMdXmt, cwspDefaultCdvtNrtVbr=cwspDefaultCdvtNrtVbr, cwspAbrCallStartTime=cwspAbrCallStartTime, cwspAbrCallFwdConformance=cwspAbrCallFwdConformance, cwspSigConfigGrp=cwspSigConfigGrp, cwspConfigGrp2=cwspConfigGrp2, cwspLoadVcAvail=cwspLoadVcAvail, cwspMaxSvccVci=cwspMaxSvccVci, cwspAbrCallFwdIcr=cwspAbrCallFwdIcr, cwspSigCfgT303=cwspSigCfgT303, cwspAlertXmt=cwspAlertXmt, cwspAbrCallOtherIntfCallRef=cwspAbrCallOtherIntfCallRef, cwspMinSvpcVpi=cwspMinSvpcVpi, cwspRestartXmt=cwspRestartXmt, cwspCallOtherIntfVci=cwspCallOtherIntfVci, cwspAbrCall=cwspAbrCall, cwspSigConfigTable=cwspSigConfigTable, cwspLoad=cwspLoad, cwspRestartAckRcv=cwspRestartAckRcv, cwspOperIfcSide=cwspOperIfcSide, ciscoWANSvcMIB=ciscoWANSvcMIB, cwspSscopMaxCC=cwspSscopMaxCC, cwspUniType=cwspUniType, cwspDefaultCdvtAbr=cwspDefaultCdvtAbr, cwspCallServiceCategory=cwspCallServiceCategory, cwspAbrCallOtherIntfIndex=cwspAbrCallOtherIntfIndex, cwspConnectAckRcv=cwspConnectAckRcv, cwspPhyIdentifier=cwspPhyIdentifier, cwspOperMinSvccVpi=cwspOperMinSvccVpi, cwspCallLeafReference=cwspCallLeafReference, cwspNotifyRcv=cwspNotifyRcv, cwspSscopTmrKeepAlive=cwspSscopTmrKeepAlive, cwspPrefixGrp=cwspPrefixGrp, cwspSide=cwspSide, cwspOperMaxVciBits=cwspOperMaxVciBits, cwspCallStatsGrp=cwspCallStatsGrp, cwspPnniStndbyControllerStatus=cwspPnniStndbyControllerStatus, cwspRoutingVci=cwspRoutingVci, cwspLoadAvlBwRtVbr=cwspLoadAvlBwRtVbr, cwspInCallAttempts=cwspInCallAttempts, cwspLoadMaxBwNrtVbr=cwspLoadMaxBwNrtVbr, cwspSscopBgrejRcv=cwspSscopBgrejRcv, cwspOperStatus=cwspOperStatus, cwspAbrCallFwdPcr=cwspAbrCallFwdPcr, cwspAddrScope=cwspAddrScope, cwspMaxBwCbr=cwspMaxBwCbr, cwspSscopEndXmt=cwspSscopEndXmt, cwspLoadClr0RtVbr=cwspLoadClr0RtVbr, ciscoWANPnniPglStatus=ciscoWANPnniPglStatus, cwspSigStatsGrp=cwspSigStatsGrp, cwspSscopRsXmt=cwspSscopRsXmt, cwspOperAddrPlanSupported=cwspOperAddrPlanSupported, cwspCallStatsTable=cwspCallStatsTable, cwspCallBearerClass=cwspCallBearerClass, cwspReleaseComplXmt=cwspReleaseComplXmt, cwspCallProcRcv=cwspCallProcRcv, cwspAbrCallBwdTrm=cwspAbrCallBwdTrm, cwspSigStatsTable=cwspSigStatsTable, cwspConnTraceNodeId=cwspConnTraceNodeId, cwspCallBwdMbs=cwspCallBwdMbs, cwspSscopIgnoredPduRcv=cwspSscopIgnoredPduRcv, cwspSscopConfig=cwspSscopConfig, cwspSscopUstatXmt=cwspSscopUstatXmt, cwspAddrPlan=cwspAddrPlan, cwspAbrCallGrp=cwspAbrCallGrp, cwspCallStats=cwspCallStats, cwspMinVcUbr=cwspMinVcUbr, cwspOperMaxSvccVci=cwspOperMaxSvccVci, cwspLoadMinGurCrRtVbr=cwspLoadMinGurCrRtVbr, cwspCallClipSusceptibility=cwspCallClipSusceptibility, cwspOperDeviceType=cwspOperDeviceType, cwspConfigEntry=cwspConfigEntry, cwspMaxVcRtVbr=cwspMaxVcRtVbr, cwspAbrCallFwdTrm=cwspAbrCallFwdTrm, cwspConnTraceEgressVci=cwspConnTraceEgressVci, cwspCacConfigGrp=cwspCacConfigGrp, cwspAbrCallFwdFrameDiscard=cwspAbrCallFwdFrameDiscard, cwspReleaseXmt=cwspReleaseXmt, cwspLoadClr0Abr=cwspLoadClr0Abr, cwspAddPtyRcv=cwspAddPtyRcv, cwspSscopUdRcv=cwspSscopUdRcv, cwspMaxVcNrtVbr=cwspMaxVcNrtVbr, cwspAtmAddress=cwspAtmAddress, cwspSigCfgT398=cwspSigCfgT398, cwspCallBwdConformance=cwspCallBwdConformance, cwspRestartAckXmt=cwspRestartAckXmt, cwspMaxVpiBits=cwspMaxVpiBits, cwspSscopStats=cwspSscopStats, cwspSigCfgT310=cwspSigCfgT310)
