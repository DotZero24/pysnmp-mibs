...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-WAN-SVC-MIB
...
mibBuilder.exportSymbols("CISCO-WAN-SVC-MIB", cwspAbrCallFwdIcr=cwspAbrCallFwdIcr, cwspCallMaxCtd=cwspCallMaxCtd, cwspLoadAvlBwAbr=cwspLoadAvlBwAbr, cwspIlmiUCSMEnable=cwspIlmiUCSMEnable, cwspAbrCallOtherIntfIndex=cwspAbrCallOtherIntfIndex, cwspOperUniVersion=cwspOperUniVersion, cwspPnniStndbyControllerStatus=cwspPnniStndbyControllerStatus, cwspLoadAvlVcCbr=cwspLoadAvlVcCbr, cwspSscopStatRcv=cwspSscopStatRcv, cwspDefaultMbsRtVbr=cwspDefaultMbsRtVbr, cwspAbrCallVpi=cwspAbrCallVpi, cwspSscopStatsTable=cwspSscopStatsTable, cwspSigConfigEntry=cwspSigConfigEntry, cwspSscopEndakXmt=cwspSscopEndakXmt, cwspSigStats=cwspSigStats, cwspSigConfigTable=cwspSigConfigTable, cwspAbrCallClgAddress=cwspAbrCallClgAddress, cwspLoadMaxBwUbr=cwspLoadMaxBwUbr, cwspSscopCounterReset=cwspSscopCounterReset, cwspAbrCallFwdFrameDiscard=cwspAbrCallFwdFrameDiscard, cwspDefaultCdvtNrtVbr=cwspDefaultCdvtNrtVbr, cwspCallFwdScr=cwspCallFwdScr, cwspSigCfgT397=cwspSigCfgT397, cwspCallType=cwspCallType, cwspCallBwdConformance=cwspCallBwdConformance, cwspConfigTableRowStatus=cwspConfigTableRowStatus, cwspAbrCallFwdConformance=cwspAbrCallFwdConformance, cwspCall=cwspCall, cwspUtilFactorRtVbr=cwspUtilFactorRtVbr, cwspCallMaxBwdClr=cwspCallMaxBwdClr, cwspLoadAvlBwNrtVbr=cwspLoadAvlBwNrtVbr, cwspMaxVcBwNrtVbr=cwspMaxVcBwNrtVbr, cwspSscopStatsEntry=cwspSscopStatsEntry, cwspAlertXmt=cwspAlertXmt, cwspMinBwRtVbr=cwspMinBwRtVbr, cwspOperDeviceType=cwspOperDeviceType, cwspDropPtyRcv=cwspDropPtyRcv, cwspNetPrefix=cwspNetPrefix, cwspConnTraceAvail=cwspConnTraceAvail, cwspCallFwdConformance=cwspCallFwdConformance, cwspRoutingVpi=cwspRoutingVpi, cwspLoadGrp=cwspLoadGrp, cwspLoad=cwspLoad, cwspAbrCallFwdAdtf=cwspAbrCallFwdAdtf, cwspInCallAttempts=cwspInCallAttempts, cwspConnTraceEgressPhyPortId=cwspConnTraceEgressPhyPortId, cwspSscopEntry=cwspSscopEntry, cwspAbrCallMaxCtd=cwspAbrCallMaxCtd, cwspAddPtyXmt=cwspAddPtyXmt, cwspOperMaxVpiBits=cwspOperMaxVpiBits, cwspOperationTable=cwspOperationTable, cwspConnTraceSrcVci=cwspConnTraceSrcVci, cwspAbrCallOtherIntfVpi=cwspAbrCallOtherIntfVpi, cwspConnTraceResultStatus=cwspConnTraceResultStatus, cwspSscopRsXmt=cwspSscopRsXmt, cwspAddressRowStatus=cwspAddressRowStatus, cwspSscopRsakRcv=cwspSscopRsakRcv, cwspConfigGrp3=cwspConfigGrp3, cwspPrefixTable=cwspPrefixTable, cwspSetupXmt=cwspSetupXmt, cwspAbrCallOtherIntfVci=cwspAbrCallOtherIntfVci, cwspCallStats=cwspCallStats, cwspIlmiLocalAttrStd=cwspIlmiLocalAttrStd, cwspRestartXmt=cwspRestartXmt, cwspTimerExpiries=cwspTimerExpiries, cwspConfigEntry=cwspConfigEntry, cwspUtilFactorUbr=cwspUtilFactorUbr, cwspSscopUdRcv=cwspSscopUdRcv, cwspMaxVcBwAbr=cwspMaxVcBwAbr, cwspAbrCallCldSubAddr=cwspAbrCallCldSubAddr, cwspRestartAckXmt=cwspRestartAckXmt, cwspLoadAvlBwUbr=cwspLoadAvlBwUbr, cwspSigCfgT308=cwspSigCfgT308, cwspLoadMaxBwNrtVbr=cwspLoadMaxBwNrtVbr, cwspAddressGrp=cwspAddressGrp, cwspCallProcXmt=cwspCallProcXmt, cwspCallCallingSubAddr=cwspCallCallingSubAddr, cwspReleaseComplRcv=cwspReleaseComplRcv, cwspCallVci=cwspCallVci, cwspAddPtyAckXmt=cwspAddPtyAckXmt, cwspConnTraceGrp2=cwspConnTraceGrp2, cwspSigConfig=cwspSigConfig, cwspOperAddrPlanSupported=cwspOperAddrPlanSupported, cwspSscopConfigGrp=cwspSscopConfigGrp, cwspMaxBwAbr=cwspMaxBwAbr, cwspCacConfigEntry=cwspCacConfigEntry, cwspAddrPlanSupported=cwspAddrPlanSupported, cwspAddPtyRejXmt=cwspAddPtyRejXmt, cwspLoadAvlBwRtVbr=cwspLoadAvlBwRtVbr, cwspConnectXmt=cwspConnectXmt, cwspAbrCallClgSubAddr=cwspAbrCallClgSubAddr, cwspSigCfgT398=cwspSigCfgT398, cwspCacConfigTable=cwspCacConfigTable, cwspCallStatsGrp=cwspCallStatsGrp, cwspConnTraceEntry=cwspConnTraceEntry, cwspSigCounterReset=cwspSigCounterReset, ciscoWANSpvc=ciscoWANSpvc, cwspCallBwdPcr=cwspCallBwdPcr, cwspAbrCallFwdNrm=cwspAbrCallFwdNrm, cwspPrefixRowStatus=cwspPrefixRowStatus, cwspOperNniSigVersion=cwspOperNniSigVersion, cwspCallBwdScr=cwspCallBwdScr, cwspSigConfigGrp=cwspSigConfigGrp, cwspSscopErakXmt=cwspSscopErakXmt, cwspInCallFailures=cwspInCallFailures, cwspInResrcFailures=cwspInResrcFailures, cwspOperUniType=cwspOperUniType, cwspLoadMaxBwRtVbr=cwspLoadMaxBwRtVbr, cwspConnectRcv=cwspConnectRcv, cwspUtilFactorAbr=cwspUtilFactorAbr, cwspAbrCallOtherIntfCallRef=cwspAbrCallOtherIntfCallRef, cwspAbrCallGrp=cwspAbrCallGrp, cwsControllerStatus=cwsControllerStatus, cwspProgressXmt=cwspProgressXmt, cwspInFilterFailures=cwspInFilterFailures, cwspRegAddressEntry=cwspRegAddressEntry, cwspLoadAvlVcUbr=cwspLoadAvlVcUbr, cwspAbrCallTable=cwspAbrCallTable, cwspMaxVcAbr=cwspMaxVcAbr, cwspAbrCallCldAddress=cwspAbrCallCldAddress, cwspAbrCallClipSusceptibility=cwspAbrCallClipSusceptibility, cwspAbrCallFwdTrm=cwspAbrCallFwdTrm, cwspOutCallEstabs=cwspOutCallEstabs, cwspMaxVcUbr=cwspMaxVcUbr, cwspAbrCallFwdCdf=cwspAbrCallFwdCdf, cwspSignallingVci=cwspSignallingVci, cwspSscopEndRcv=cwspSscopEndRcv, cwspIlmiAddrRegEnable=cwspIlmiAddrRegEnable, cwspLoadMinGurCrRtVbr=cwspLoadMinGurCrRtVbr, ciscoWANSvcInfo=ciscoWANSvcInfo, cwspSscopMdXmt=cwspSscopMdXmt, cwspAbrCallBwdRdf=cwspAbrCallBwdRdf, cwspMaxVpiBits=cwspMaxVpiBits, cwspMaxVcBwUbr=cwspMaxVcBwUbr, cwspAbrCallBearerClass=cwspAbrCallBearerClass, cwspSigStatsEntry=cwspSigStatsEntry, cwspAbrCallBwdTrm=cwspAbrCallBwdTrm, cwspIlmiServRegEnable=cwspIlmiServRegEnable, cwspSscopSdpXmt=cwspSscopSdpXmt, cwspLoadAvlVcAbr=cwspLoadAvlVcAbr, cwspCallFwdFrameDiscard=cwspCallFwdFrameDiscard, cwspOperIlmiEnable=cwspOperIlmiEnable, cwspCallBwdCdvt=cwspCallBwdCdvt, ciscoWANPnniRemoteNodeId=ciscoWANPnniRemoteNodeId, cwspAddPtyRejRcv=cwspAddPtyRejRcv, cwspAddressTable=cwspAddressTable, cwspConnTraceifIndex=cwspConnTraceifIndex, cwspMaxP2pCalls=cwspMaxP2pCalls, cwsSwRevision=cwsSwRevision, cwspSscopTmrKeepAlive=cwspSscopTmrKeepAlive, cwspConnTraceCallRef=cwspConnTraceCallRef, cwspConnTraceTable=cwspConnTraceTable, cwspSpvcGrp=cwspSpvcGrp, cwspLoadClr0RtVbr=cwspLoadClr0RtVbr, cwspAbrCallBwdRif=cwspAbrCallBwdRif, cwspSscopEndakRcv=cwspSscopEndakRcv, cwspIlmiAutoConfEnable=cwspIlmiAutoConfEnable, cwspSscopBgrejXmt=cwspSscopBgrejXmt, cwspLoadClr0NrtVbr=cwspLoadClr0NrtVbr, cwspAddPtyAckRcv=cwspAddPtyAckRcv, cwspOutResrcFailures=cwspOutResrcFailures, cwspAbrCallMaxBwdClr=cwspAbrCallMaxBwdClr, cwspAddrLen=cwspAddrLen, cwspLoadClr01Abr=cwspLoadClr01Abr, cwspAbrCallMaxBwdCdv=cwspAbrCallMaxBwdCdv, cwspCallBearerClass=cwspCallBearerClass, cwspSigCfgT303=cwspSigCfgT303, cwspRestartRcv=cwspRestartRcv, cwspConnTraceCntlTable=cwspConnTraceCntlTable, cwspLoadCdvUbr=cwspLoadCdvUbr, cwspSscopSdXmt=cwspSscopSdXmt, cwspCallOtherIntfVci=cwspCallOtherIntfVci, cwspLastDiagnostic=cwspLastDiagnostic, cwspConnTraceDestVci=cwspConnTraceDestVci, cwspConnTraceCntlEntry=cwspConnTraceCntlEntry, cwspUtilFactorNrtVbr=cwspUtilFactorNrtVbr, cwspSscopBgakRcv=cwspSscopBgakRcv, cwspCallEntry=cwspCallEntry, cwspOperMaxSvccVpi=cwspOperMaxSvccVpi, cwspDefaultMbsNrtVbr=cwspDefaultMbsNrtVbr, cwspCacConfigGrp=cwspCacConfigGrp, cwspSscopBgrejRcv=cwspSscopBgrejRcv, cwspAbrCallStartTime=cwspAbrCallStartTime, cwspAbrCallFwdRif=cwspAbrCallFwdRif, cwspCallGrp=cwspCallGrp, ciscoWANSvcMIBObjects=ciscoWANSvcMIBObjects, cwspAbrCallBwdIcr=cwspAbrCallBwdIcr, cwspSide=cwspSide, cwspStatusRcv=cwspStatusRcv, cwspLoadCdvNrtVbr=cwspLoadCdvNrtVbr, cwspStatusEnqXmt=cwspStatusEnqXmt, cwspSscopConfig=cwspSscopConfig, cwspInTimerFailures=cwspInTimerFailures, cwspConnTraceEgressVci=cwspConnTraceEgressVci, cwspMaxVcBwRtVbr=cwspMaxVcBwRtVbr, cwspConnTraceGrp=cwspConnTraceGrp, cwspMinVcAbr=cwspMinVcAbr, cwspDropPtyXmt=cwspDropPtyXmt, cwspConnectAckXmt=cwspConnectAckXmt, cwspCallProcRcv=cwspCallProcRcv, cwspUniType=cwspUniType, cwsInfoGrp=cwsInfoGrp, cwspAddPtyRcv=cwspAddPtyRcv, cwspCallServiceCategory=cwspCallServiceCategory, cwspSscopErakRcv=cwspSscopErakRcv, cwspCallStartTime=cwspCallStartTime, cwspConnTraceSrcVpi=cwspConnTraceSrcVpi, cwspSigStatsGrp=cwspSigStatsGrp, cwspReleaseRcv=cwspReleaseRcv, cwspConnTraceQueryStatus=cwspConnTraceQueryStatus, cwspOperMinSvpcVpi=cwspOperMinSvpcVpi, cwspCallMaxFwdCdv=cwspCallMaxFwdCdv, cwspSigCfgT310=cwspSigCfgT310, cwspAbrCallServiceCategory=cwspAbrCallServiceCategory, cwspSscopPollXmt=cwspSscopPollXmt, cwspSscopStatsGrp=cwspSscopStatsGrp, cwspSpvcAddress=cwspSpvcAddress, cwspAddressEntry=cwspAddressEntry, cwspAbrCallFwdRdf=cwspAbrCallFwdRdf, cwspSigCfgT316=cwspSigCfgT316, cwspRestartAckRcv=cwspRestartAckRcv, cwspCallFwdPcr=cwspCallFwdPcr, cwspOperIlmiVersion=cwspOperIlmiVersion, cwspConnTraceEgressCallRef=cwspConnTraceEgressCallRef, cwspNotifyXmt=cwspNotifyXmt, cwspCallStatsEntry=cwspCallStatsEntry, cwspMinBwAbr=cwspMinBwAbr, cwspMaxSvpcVpi=cwspMaxSvpcVpi, ciscoWANSvcMIBGroups=ciscoWANSvcMIBGroups, cwspAddrType=cwspAddrType, cwspLoadMinGurCrCbr=cwspLoadMinGurCrCbr, cwspMaxVciBits=cwspMaxVciBits, cwspSscopBgakXmt=cwspSscopBgakXmt, ciscoWANSvcMIBConformance=ciscoWANSvcMIBConformance, cwspConnTraceIndex=cwspConnTraceIndex, cwspMinSvccVpi=cwspMinSvccVpi, cwspOutTimerFailures=cwspOutTimerFailures, cwspIncorrectMsgRcv=cwspIncorrectMsgRcv, ciscoWANSvcMIB=ciscoWANSvcMIB, cwspRegAddressTable=cwspRegAddressTable, cwspAbrCallEntry=cwspAbrCallEntry, cwspLoadVcAvail=cwspLoadVcAvail, cwspLoadClr01NrtVbr=cwspLoadClr01NrtVbr, cwspSscopTable=cwspSscopTable, cwspLoadClr0Abr=cwspLoadClr0Abr, cwspAbrCallMaxFwdCdv=cwspAbrCallMaxFwdCdv, cwspCountReset=cwspCountReset, cwspConnTraceLeafRef=cwspConnTraceLeafRef, cwspConfigTable=cwspConfigTable, cwspCallTable=cwspCallTable, cwspSigCfgT301=cwspSigCfgT301, cwspOperMaxSvccVci=cwspOperMaxSvccVci, cwspPnniControllerPhySlot=cwspPnniControllerPhySlot, cwspOutCrankbacks=cwspOutCrankbacks)
mibBuilder.exportSymbols("CISCO-WAN-SVC-MIB", cwspAbrCallBwdMcr=cwspAbrCallBwdMcr, cwspAddrProto=cwspAddrProto, cwspOperMinSvccVci=cwspOperMinSvccVci, cwspSscopMaxPD=cwspSscopMaxPD, cwspLoadClr01Cbr=cwspLoadClr01Cbr, cwspMaxVcBwCbr=cwspMaxVcBwCbr, cwspAbrCallFwdPcr=cwspAbrCallFwdPcr, cwspRoutingPriority=cwspRoutingPriority, cwspCallOtherIntfIndex=cwspCallOtherIntfIndex, cwspConnTraceEgressPortId=cwspConnTraceEgressPortId, cwspCallBwdFrameDiscard=cwspCallBwdFrameDiscard, cwspAbrCallCallRef=cwspAbrCallCallRef, cwspSscopStatXmt=cwspSscopStatXmt, cwspOutCallAttempts=cwspOutCallAttempts, cwspLoadClr01RtVbr=cwspLoadClr01RtVbr, cwspSvcBlocked=cwspSvcBlocked, cwspSpvcNodePrefix=cwspSpvcNodePrefix, cwspMaxSvccVpi=cwspMaxSvccVpi, cwspSscopStats=cwspSscopStats, cwspMaxBwRtVbr=cwspMaxBwRtVbr, cwspAbrCallBwdTbe=cwspAbrCallBwdTbe, CwspSpvcState=CwspSpvcState, cwspAtmAddress=cwspAtmAddress, cwspSscopUstatXmt=cwspSscopUstatXmt, cwspLoadMaxBwCbr=cwspLoadMaxBwCbr, cwspSscopEndXmt=cwspSscopEndXmt, cwspAdminStatus=cwspAdminStatus, cwspSscopRsakXmt=cwspSscopRsakXmt, cwspLoadCtdRtVbr=cwspLoadCtdRtVbr, cwspCallMaxFwdClr=cwspCallMaxFwdClr, cwspSscopTmrPoll=cwspSscopTmrPoll, cwspMaxSvccVci=cwspMaxSvccVci, cwspLoadMinGurCrAbr=cwspLoadMinGurCrAbr, cwspSscopMaxCC=cwspSscopMaxCC, cwspCallCallRef=cwspCallCallRef, cwspCallMaxBwdCdv=cwspCallMaxBwdCdv, cwspAbrCallBwdCdf=cwspAbrCallBwdCdf, cwspMinBwUbr=cwspMinBwUbr, cwspLoadBwTotal=cwspLoadBwTotal, cwspSignallingVpi=cwspSignallingVpi, cwspOutRouteFailures=cwspOutRouteFailures, cwspMaxBwCbr=cwspMaxBwCbr, cwspDefaultCdvtRtVbr=cwspDefaultCdvtRtVbr, cwspAbrCallVci=cwspAbrCallVci, cwspOperIfcType=cwspOperIfcType, cwspCallLeafReference=cwspCallLeafReference, cwspSigCfgT399=cwspSigCfgT399, cwspSscopTmrNoResp=cwspSscopTmrNoResp, cwspAbrCallFwdMcr=cwspAbrCallFwdMcr, cwspConnTraceNextIndex=cwspConnTraceNextIndex, cwspPnniControllerStatus=cwspPnniControllerStatus, cwspIlmiAttachmentPoint=cwspIlmiAttachmentPoint, cwspCallCalledSubAddr=cwspCallCalledSubAddr, cwspMaxBwNrtVbr=cwspMaxBwNrtVbr, cwspAbrCall=cwspAbrCall, cwspConnTraceDestVpi=cwspConnTraceDestVpi, cwspRoutingGrp=cwspRoutingGrp, cwspOperation=cwspOperation, cwspSigCfgT322=cwspSigCfgT322, cwspCallFwdMbs=cwspCallFwdMbs, cwspLoadMaxBwAbr=cwspLoadMaxBwAbr, cwspLoadTable=cwspLoadTable, cwspLoadClr0Ubr=cwspLoadClr0Ubr, cwspSscopMaxSTAT=cwspSscopMaxSTAT, cwspAbrCallType=cwspAbrCallType, cwspAbrCallCastType=cwspAbrCallCastType, cwspConfig=cwspConfig, cwspRegAtmAddress=cwspRegAtmAddress, cwspAbrCallBwdAdtf=cwspAbrCallBwdAdtf, cwspMinBwCbr=cwspMinBwCbr, cwspRegAddressGrp=cwspRegAddressGrp, cwspAbrCallBwdFrameDiscard=cwspAbrCallBwdFrameDiscard, cwspSetupRcv=cwspSetupRcv, cwspLoadCtdUbr=cwspLoadCtdUbr, cwspAbrCallBwdPcr=cwspAbrCallBwdPcr, ciscoWANSvcMIBCompliance3=ciscoWANSvcMIBCompliance3, cwspCallVpi=cwspCallVpi, cwspLoadEntry=cwspLoadEntry, cwspCallBwdMbs=cwspCallBwdMbs, cwspConnTraceType=cwspConnTraceType, cwspSscopUstatRcv=cwspSscopUstatRcv, cwspMinSvccVci=cwspMinSvccVci, cwspDefaultCdvtUbr=cwspDefaultCdvtUbr, cwspConnTraceDataIndex=cwspConnTraceDataIndex, ciscoWANPnniReachability=ciscoWANPnniReachability, cwspLoadCtdCbr=cwspLoadCtdCbr, cwspOperIfcSide=cwspOperIfcSide, ciscoWANSvcMIBCompliance=ciscoWANSvcMIBCompliance, cwspMinVcRtVbr=cwspMinVcRtVbr, cwspIlmiSecureLink=cwspIlmiSecureLink, ciscoWANPnniRouting=ciscoWANPnniRouting, cwspConnTraceDestCallRef=cwspConnTraceDestCallRef, cwspLoadCtdNrtVbr=cwspLoadCtdNrtVbr, cwspLoadCdvCbr=cwspLoadCdvCbr, cwspLoadCdvAbr=cwspLoadCdvAbr, cwspMaxVcRtVbr=cwspMaxVcRtVbr, cwspConfigGrp=cwspConfigGrp, cwspMaxVcCbr=cwspMaxVcCbr, ciscoWANSvcMIBCompliance2=ciscoWANSvcMIBCompliance2, cwspInRouteFailures=cwspInRouteFailures, cwspAbrCallFwdTbe=cwspAbrCallFwdTbe, cwspRegAddressOrgSscope=cwspRegAddressOrgSscope, cwspOperMinSvccVpi=cwspOperMinSvccVpi, cwspUniVersion=cwspUniVersion, CwspControllerState=CwspControllerState, cwspLoadAvlVcNrtVbr=cwspLoadAvlVcNrtVbr, cwspAddrRedistribute=cwspAddrRedistribute, cwspConnTrace=cwspConnTrace, cwspLoadMinGurCrUbr=cwspLoadMinGurCrUbr, cwspOperMaxVCCs=cwspOperMaxVCCs, cwspSscopBgnXmt=cwspSscopBgnXmt, PYSNMP_MODULE_ID=ciscoWANSvcMIB, cwspSscopRsRcv=cwspSscopRsRcv, cwspOperMaxVPCs=cwspOperMaxVPCs, cwspSpvcBlocked=cwspSpvcBlocked, cwspConnTraceEgressVpi=cwspConnTraceEgressVpi, cwspLoadAvlBwCbr=cwspLoadAvlBwCbr, cwspSscopBgnRcv=cwspSscopBgnRcv, cwspOperMaxSvpcVpi=cwspOperMaxSvpcVpi, cwspStatusEnqRcv=cwspStatusEnqRcv, cwspAddrPlan=cwspAddrPlan, cwspPrefixEntry=cwspPrefixEntry, cwspPhyIdentifier=cwspPhyIdentifier, cwspSscopTmtIdle=cwspSscopTmtIdle, cwspNotifyRcv=cwspNotifyRcv, cwspReleaseXmt=cwspReleaseXmt, cwspCallOtherIntfVpi=cwspCallOtherIntfVpi, cwspProgressRcv=cwspProgressRcv, cwspLoadMinGurCrNrtVbr=cwspLoadMinGurCrNrtVbr, cwspConnTraceLastNode=cwspConnTraceLastNode, cwspAbrCallMaxFwdClr=cwspAbrCallMaxFwdClr, cwspOperFailReason=cwspOperFailReason, ciscoWANPnniLinkStatus=ciscoWANPnniLinkStatus, cwspLastCause=cwspLastCause, cwspUtilFactorCbr=cwspUtilFactorCbr, cwspSscopPollRcv=cwspSscopPollRcv, cwspCallStatsTable=cwspCallStatsTable, cwspConfigGrp2=cwspConfigGrp2, cwspLoadCtdAbr=cwspLoadCtdAbr, cwspMaxBwUbr=cwspMaxBwUbr, cwspSigCfgT317=cwspSigCfgT317, cwspMaxP2mpRoots=cwspMaxP2mpRoots, cwspMinBwNrtVbr=cwspMinBwNrtVbr, cwspAddrScope=cwspAddrScope, cwspCacConfig=cwspCacConfig, cwspAddress=cwspAddress, cwspRoutingVci=cwspRoutingVci, cwspReleaseComplXmt=cwspReleaseComplXmt, cwspOutFilterFailures=cwspOutFilterFailures, cwspSscopSdpRcv=cwspSscopSdpRcv, ciscoWANSvcPort=ciscoWANSvcPort, cwspEnhancedIisp=cwspEnhancedIisp, cwspRegAddress=cwspRegAddress, cwspNniVersion=cwspNniVersion, cwspLoadClr01Ubr=cwspLoadClr01Ubr, cwspAbrCallBwdNrm=cwspAbrCallBwdNrm, cwspSigStatsTable=cwspSigStatsTable, cwspSscopMdRcv=cwspSscopMdRcv, cwspMaxP2mpLeafs=cwspMaxP2mpLeafs, cwspStatusXmt=cwspStatusXmt, cwspLoadAvlVcRtVbr=cwspLoadAvlVcRtVbr, cwspMinVcUbr=cwspMinVcUbr, cwspOperationGrp=cwspOperationGrp, cwspCallOtherIntfCallRef=cwspCallOtherIntfCallRef, cwspOutCallFailures=cwspOutCallFailures, cwspCallFwdCdvt=cwspCallFwdCdvt, cwspMinVcNrtVbr=cwspMinVcNrtVbr, cwspPrefix=cwspPrefix, cwspOperMaxVciBits=cwspOperMaxVciBits, cwspCallCastType=cwspCallCastType, cwspInCrankbacks=cwspInCrankbacks, cwspDefaultCdvtCbr=cwspDefaultCdvtCbr, cwspConnTraceNodeId=cwspConnTraceNodeId, cwspSscopIgnoredPduRcv=cwspSscopIgnoredPduRcv, cwspPrefixGrp=cwspPrefixGrp, cwspLoadBwAvail=cwspLoadBwAvail, cwspSscopStatus=cwspSscopStatus, ciscoWANPnniPortId=ciscoWANPnniPortId, cwspMinVcCbr=cwspMinVcCbr, cwspInCallEstabs=cwspInCallEstabs, cwspCallCalledAddress=cwspCallCalledAddress, cwspOperationEntry=cwspOperationEntry, ciscoWANSvcMIBCompliances=ciscoWANSvcMIBCompliances, cwspMinSvpcVpi=cwspMinSvpcVpi, cwspSscopTmrCC=cwspSscopTmrCC, cwspMaxVcNrtVbr=cwspMaxVcNrtVbr, cwspSscopSdRcv=cwspSscopSdRcv, cwspLoadClr0Cbr=cwspLoadClr0Cbr, cwspAbrCallFrtt=cwspAbrCallFrtt, ciscoWANPnniPglStatus=ciscoWANPnniPglStatus, cwspOperStatus=cwspOperStatus, cwspLoadCdvRtVbr=cwspLoadCdvRtVbr, cwspAlertRcv=cwspAlertRcv, cwspCallCallingAddress=cwspCallCallingAddress, ciscoWANSpvcFailReason=ciscoWANSpvcFailReason, cwspSscopUdXmt=cwspSscopUdXmt, cwspConnectAckRcv=cwspConnectAckRcv, cwspDefaultCdvtAbr=cwspDefaultCdvtAbr, cwspCallClipSusceptibility=cwspCallClipSusceptibility)
