# SNMP MIB module (ALCATEL-ENT1-MAC-ADDRESS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-MAC-ADDRESS-MIB
...
alaSlMacAddressGlobalEntry.setIndexNames(
    (0, "ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacDomain"),
    (0, "ALCATEL-ENT1-MAC-ADDRESS-MIB", "slLocaleType"),
    (0, "ALCATEL-ENT1-MAC-ADDRESS-MIB", "slOriginId"),
    (0, "ALCATEL-ENT1-MAC-ADDRESS-MIB", "slServiceId"),
    (0, "ALCATEL-ENT1-MAC-ADDRESS-MIB", "slSubId"),
    (0, "ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAddressGbl"),
)
if mibBuilder.loadTexts:
...
class _SlVxLanVnID_Type(Unsigned32):
    """Custom type slVxLanVnID based on Unsigned32"""
...
_SlVxLanVnID_Type.__name__ = "Unsigned32"
_SlVxLanVnID_Object = MibTableColumn
slVxLanVnID = _SlVxLanVnID_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 8, 1, 1, 8, 1, 13),
    _SlVxLanVnID_Type()
)
slVxLanVnID.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    slVxLanVnID.setStatus("current")
...
slMacAddressGroup.setObjects(
      *(("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAddressGblManagement"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAddressGblDisposition"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAddressGblRowStatus"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAddressGblProtocol"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAddressGblGroupField"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slSvcISID"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slVxLanVnID"))
)
if mibBuilder.loadTexts:
...
slMacAgingGroup.setObjects(
      *(("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAgingValue"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAgingRowStatus"))
)
if mibBuilder.loadTexts:
...
slMacGeneralGroup.setObjects(
    ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slDistributedMacMode")
)
if mibBuilder.loadTexts:
...
slMacLearningGroup.setObjects(
    ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacLearningControlStatus")
)
if mibBuilder.loadTexts:
...
slMacVlanLearningGroup.setObjects(
    ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacLearningVlanControlStatus")
)
if mibBuilder.loadTexts:
...
alcatelIND1MacAddressMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAddressGroup"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacAgingGroup"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacGeneralGroup"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacLearningGroup"),
        ("ALCATEL-ENT1-MAC-ADDRESS-MIB", "slMacVlanLearningGroup"))
)
if mibBuilder.loadTexts:
