...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPNSAECC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:42:13 2025
...
hPECCMemory1 = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 6, 0, 4353)
)
if mibBuilder.loadTexts:
    hPECCMemory1.setStatus(
        ""
    )

hPECCMemory4 = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 6, 0, 4354)
)
if mibBuilder.loadTexts:
    hPECCMemory4.setStatus(
        ""
    )

hPECCMemory5 = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 6, 0, 4355)
)
if mibBuilder.loadTexts:
    hPECCMemory5.setStatus(
        ""
    )

hPECCMemory6 = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 6, 0, 4357)
)
if mibBuilder.loadTexts:
    hPECCMemory6.setStatus(
        ""
    )

hPECCMemory8 = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 6, 0, 4358)
)
if mibBuilder.loadTexts:
    hPECCMemory8.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hp": hp,
       ...
       "hpnsa": hpnsa,
       "hpnsaECC": hpnsaECC,
       "hPECCMemory1": hPECCMemory1,
       "hPECCMemory4": hPECCMemory4,
       "hPECCMemory5": hPECCMemory5,
       "hPECCMemory6": hPECCMemory6,
       "hPECCMemory8": hPECCMemory8,
