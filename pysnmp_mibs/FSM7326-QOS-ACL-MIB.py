...
if mibBuilder.loadTexts:fsm7326QOSACL.setRevisions(('2003-11-10 12:00',))
_AclTable_Object=MibTable
aclTable=_AclTable_Object((1,3,6,1,4,1,4526,1,9,3,2,1))
if mibBuilder.loadTexts:aclTable.setStatus(_A)
_AclEntry_Object=MibTableRow
aclEntry=_AclEntry_Object((1,3,6,1,4,1,4526,1,9,3,2,1,1))
...
aclIndex=_AclIndex_Object((1,3,6,1,4,1,4526,1,9,3,2,1,1,1),_AclIndex_Type())
...
aclStatus=_AclStatus_Object((1,3,6,1,4,1,4526,1,9,3,2,1,1,3),_AclStatus_Type())
aclStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:aclStatus.setStatus(_A)
_AclIfTable_Object=MibTable
aclIfTable=_AclIfTable_Object((1,3,6,1,4,1,4526,1,9,3,2,2))
if mibBuilder.loadTexts:aclIfTable.setStatus(_A)
_AclIfEntry_Object=MibTableRow
aclIfEntry=_AclIfEntry_Object((1,3,6,1,4,1,4526,1,9,3,2,2,1))
...
aclIfIndex=_AclIfIndex_Object((1,3,6,1,4,1,4526,1,9,3,2,2,1,1),_AclIfIndex_Type())
...
aclIfDirection=_AclIfDirection_Object((1,3,6,1,4,1,4526,1,9,3,2,2,1,2),_AclIfDirection_Type())
...
aclIfStatus=_AclIfStatus_Object((1,3,6,1,4,1,4526,1,9,3,2,2,1,3),_AclIfStatus_Type())
aclIfStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:aclIfStatus.setStatus(_A)
_AclRuleTable_Object=MibTable
aclRuleTable=_AclRuleTable_Object((1,3,6,1,4,1,4526,1,9,3,2,3))
if mibBuilder.loadTexts:aclRuleTable.setStatus(_A)
_AclRuleEntry_Object=MibTableRow
aclRuleEntry=_AclRuleEntry_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1))
...
aclRuleIndex=_AclRuleIndex_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,1),_AclRuleIndex_Type())
...
aclRuleAction=_AclRuleAction_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,2),_AclRuleAction_Type())
...
aclRuleProtocol=_AclRuleProtocol_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,3),_AclRuleProtocol_Type())
...
aclRuleSrcIpAddress=_AclRuleSrcIpAddress_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,4),_AclRuleSrcIpAddress_Type())
...
aclRuleSrcIpMask=_AclRuleSrcIpMask_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,5),_AclRuleSrcIpMask_Type())
...
aclRuleSrcL4Port=_AclRuleSrcL4Port_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,6),_AclRuleSrcL4Port_Type())
...
aclRuleSrcL4PortRangeStart=_AclRuleSrcL4PortRangeStart_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,7),_AclRuleSrcL4PortRangeStart_Type())
...
aclRuleSrcL4PortRangeEnd=_AclRuleSrcL4PortRangeEnd_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,8),_AclRuleSrcL4PortRangeEnd_Type())
...
aclRuleDestIpAddress=_AclRuleDestIpAddress_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,9),_AclRuleDestIpAddress_Type())
...
aclRuleDestIpMask=_AclRuleDestIpMask_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,10),_AclRuleDestIpMask_Type())
...
aclRuleDestL4Port=_AclRuleDestL4Port_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,11),_AclRuleDestL4Port_Type())
...
aclRuleDestL4PortRangeStart=_AclRuleDestL4PortRangeStart_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,12),_AclRuleDestL4PortRangeStart_Type())
...
aclRuleDestL4PortRangeEnd=_AclRuleDestL4PortRangeEnd_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,13),_AclRuleDestL4PortRangeEnd_Type())
...
aclRuleIPDSCP=_AclRuleIPDSCP_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,14),_AclRuleIPDSCP_Type())
...
aclRuleIpPrecedence=_AclRuleIpPrecedence_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,15),_AclRuleIpPrecedence_Type())
...
aclRuleIpTosBits=_AclRuleIpTosBits_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,16),_AclRuleIpTosBits_Type())
...
aclRuleIpTosMask=_AclRuleIpTosMask_Object((1,3,6,1,4,1,4526,1,9,3,2,3,1,17),_AclRuleIpTosMask_Type())
