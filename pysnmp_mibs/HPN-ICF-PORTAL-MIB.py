...
mibBuilder.exportSymbols("HPN-ICF-PORTAL-MIB", hpnicfPortalConfig=hpnicfPortalConfig, hpnicfPortalFreeRuleSrcMac=hpnicfPortalFreeRuleSrcMac, hpnicfPortalFreeRuleIndex=hpnicfPortalFreeRuleIndex, hpnicfPortalStatAuthBusy=hpnicfPortalStatAuthBusy, hpnicfPortalMacTriggerOnIfIfIndex=hpnicfPortalMacTriggerOnIfIfIndex, hpnicfPortalForbiddenRuleEntry=hpnicfPortalForbiddenRuleEntry, hpnicfPortalStatAuthReq=hpnicfPortalStatAuthReq, hpnicfPortalForbiddenRuleSrcAddr=hpnicfPortalForbiddenRuleSrcAddr, hpnicfPortalMacTriggerSrvIP=hpnicfPortalMacTriggerSrvIP, hpnicfPortalStatAuthDisordered=hpnicfPortalStatAuthDisordered, hpnicfPortalMacTriggerSrvIndex=hpnicfPortalMacTriggerSrvIndex, hpnicfPortalMacTriggerSrvPort=hpnicfPortalMacTriggerSrvPort, hpnicfPortalSSIDFreeRuleTable=hpnicfPortalSSIDFreeRuleTable, hpnicfPortalSSIDFreeRuleRowStatus=hpnicfPortalSSIDFreeRuleRowStatus, hpnicfPortalPktStaAckChallengeAuthFail=hpnicfPortalPktStaAckChallengeAuthFail, hpnicfPortalForbiddenRuleDstPort=hpnicfPortalForbiddenRuleDstPort, hpnicfPortalMacTriggerSrvIPAddrType=hpnicfPortalMacTriggerSrvIPAddrType, hpnicfPortalSSIDFreeRuleIndex=hpnicfPortalSSIDFreeRuleIndex, hpnicfPortalStatAuthUnknownError=hpnicfPortalStatAuthUnknownError, hpnicfPortalAuthFailNumber=hpnicfPortalAuthFailNumber, hpnicfPortalStatAckLogout=hpnicfPortalStatAckLogout, hpnicfPortalStatHttpResp=hpnicfPortalStatHttpResp, hpnicfPortalIfInfoTable=hpnicfPortalIfInfoTable, hpnicfPortalStatNotifyLogout=hpnicfPortalStatNotifyLogout, hpnicfPortalPktStaAckAuthEstablish=hpnicfPortalPktStaAckAuthEstablish, hpnicfPortalFreeRuleDstAddr=hpnicfPortalFreeRuleDstAddr, hpnicfPortalFreeRuleSrcAddr=hpnicfPortalFreeRuleSrcAddr, hpnicfPortalStatistic=hpnicfPortalStatistic, hpnicfPortalIfInfoEntry=hpnicfPortalIfInfoEntry, hpnicfPortalFreeRuleSrcPrefix=hpnicfPortalFreeRuleSrcPrefix, hpnicfPortalForbiddenRuleIndex=hpnicfPortalForbiddenRuleIndex, hpnicfPortalForbiddenRuleTable=hpnicfPortalForbiddenRuleTable, hpnicfPortalStatChallengeFail=hpnicfPortalStatChallengeFail, hpnicfPortalPktStaReqAuthNum=hpnicfPortalPktStaReqAuthNum, hpnicfPortalStatChallengeResp=hpnicfPortalStatChallengeResp, hpnicfPortalTraps=hpnicfPortalTraps, hpnicfPortalIfVlanNasIDIfIndex=hpnicfPortalIfVlanNasIDIfIndex, hpnicfPortalForbiddenRuleSrcPrefix=hpnicfPortalForbiddenRuleSrcPrefix, hpnicfPortalServerTable=hpnicfPortalServerTable, hpnicfPortalTrapPrefix=hpnicfPortalTrapPrefix, hpnicfPortalIfServerTable=hpnicfPortalIfServerTable, hpnicfPortalFreeRuleDstPrefix=hpnicfPortalFreeRuleDstPrefix, hpnicfPortalPktStaAckAuthReject=hpnicfPortalPktStaAckAuthReject, hpnicfPortalFreeRuleSrcIfIndex=hpnicfPortalFreeRuleSrcIfIndex, hpnicfPortalPktStaAckChallengeBusy=hpnicfPortalPktStaAckChallengeBusy, hpnicfPortalPktStaReqChallengeNum=hpnicfPortalPktStaReqChallengeNum, hpnicfPortalAuthSuccNumber=hpnicfPortalAuthSuccNumber, hpnicfPortalForbiddenRuleDstPrefix=hpnicfPortalForbiddenRuleDstPrefix, hpnicfPortalPktStaAckAuthBusy=hpnicfPortalPktStaAckAuthBusy, hpnicfPortalFreeRuleAddrType=hpnicfPortalFreeRuleAddrType, hpnicfPortalSSIDFreeRuleSrcSSID=hpnicfPortalSSIDFreeRuleSrcSSID, hpnicfPortalForbiddenRuleSrcVlanID=hpnicfPortalForbiddenRuleSrcVlanID, hpnicfPortalStatPwdError=hpnicfPortalStatPwdError, hpnicfPortalSSIDFreeRuleEntry=hpnicfPortalSSIDFreeRuleEntry, hpnicfPortalPktStaAckAuthSuccess=hpnicfPortalPktStaAckAuthSuccess, hpnicfPortalServerUrl=hpnicfPortalServerUrl, hpnicfPortalPktStaAckChallengeEstablish=hpnicfPortalPktStaAckChallengeEstablish, hpnicfPortalFreeRuleRowStatus=hpnicfPortalFreeRuleRowStatus, hpnicfPortalMacTriggerOnIfThresholdFlow=hpnicfPortalMacTriggerOnIfThresholdFlow, hpnicfPortalTables=hpnicfPortalTables, hpnicfPortalMacTriggerOnIfDetctFlowPeriod=hpnicfPortalMacTriggerOnIfDetctFlowPeriod, hpnicfPortalForbiddenRuleSrcMac=hpnicfPortalForbiddenRuleSrcMac, hpnicfPortalFreeRuleEntry=hpnicfPortalFreeRuleEntry, hpnicfPortalStatAuthTimeout=hpnicfPortalStatAuthTimeout, hpnicfPortalMacTriggerOnIfRowStatus=hpnicfPortalMacTriggerOnIfRowStatus, hpnicfPortalFreeRuleSrcPort=hpnicfPortalFreeRuleSrcPort, hpnicfPortalIfServerRowStatus=hpnicfPortalIfServerRowStatus, hpnicfPortalServerIP=hpnicfPortalServerIP, hpnicfPortalStatAuthResp=hpnicfPortalStatAuthResp, hpnicfPortalIfServerUrl=hpnicfPortalIfServerUrl, hpnicfPortalFirstTrapTime=hpnicfPortalFirstTrapTime, hpnicfPortalForbiddenRuleSrcPort=hpnicfPortalForbiddenRuleSrcPort, hpnicfPortalFreeRuleTable=hpnicfPortalFreeRuleTable, hpnicfPortalNasId=hpnicfPortalNasId, hpnicfPortalStatChallengeReq=hpnicfPortalStatChallengeReq, hpnicfPortalServerLost=hpnicfPortalServerLost, hpnicfPortalIfVlanNasIDVlanID=hpnicfPortalIfVlanNasIDVlanID, hpnicfPortalIfVlanNasIDEntry=hpnicfPortalIfVlanNasIDEntry, hpnicfPortalPktStatistic=hpnicfPortalPktStatistic, hpnicfPortalMacTriggerSrvTable=hpnicfPortalMacTriggerSrvTable, hpnicfPortalForbiddenRuleAddrType=hpnicfPortalForbiddenRuleAddrType, hpnicfPortalAuthReqNumber=hpnicfPortalAuthReqNumber, hpnicfPortalServerGet=hpnicfPortalServerGet, hpnicfPortalCurrentUserNumber=hpnicfPortalCurrentUserNumber, hpnicfPortalForbiddenRuleRowStatus=hpnicfPortalForbiddenRuleRowStatus, hpnicfPortalServerPort=hpnicfPortalServerPort, hpnicfPortalPktStaAckAuthAuthFail=hpnicfPortalPktStaAckAuthAuthFail, hpnicfPortalFreeRuleProtocol=hpnicfPortalFreeRuleProtocol, hpnicfPortalIfServerEntry=hpnicfPortalIfServerEntry, hpnicfPortalServerEntry=hpnicfPortalServerEntry, hpnicfPortalFreeRuleDstPort=hpnicfPortalFreeRuleDstPort, PYSNMP_MODULE_ID=hpnicfPortal, hpnicfPortalForbiddenRuleProtocol=hpnicfPortalForbiddenRuleProtocol, hpnicfPortalMacTriggerSrvEntry=hpnicfPortalMacTriggerSrvEntry, hpnicfPortalTrapVarObjects=hpnicfPortalTrapVarObjects, hpnicfPortalSSIDFreeRuleSrcSpot=hpnicfPortalSSIDFreeRuleSrcSpot, hpnicfPortalIfServerIndex=hpnicfPortalIfServerIndex, hpnicfPortalStatChallengeBusy=hpnicfPortalStatChallengeBusy, hpnicfPortalMaxUserNumber=hpnicfPortalMaxUserNumber, hpnicfPortalUserNumberUpperLimit=hpnicfPortalUserNumberUpperLimit, hpnicfPortalMacTriggerOnIfEntry=hpnicfPortalMacTriggerOnIfEntry, hpnicfPortalStatHttpReq=hpnicfPortalStatHttpReq, hpnicfPortalIfVlanNasIDNasID=hpnicfPortalIfVlanNasIDNasID, hpnicfPortalServerName=hpnicfPortalServerName, hpnicfPortalPktStaAckChallengeReject=hpnicfPortalPktStaAckChallengeReject, hpnicfPortalPktStaAckChallengeSuccess=hpnicfPortalPktStaAckChallengeSuccess, hpnicfPortalFreeRuleSrcVlanID=hpnicfPortalFreeRuleSrcVlanID, hpnicfPortalStatChallengeTimeout=hpnicfPortalStatChallengeTimeout, hpnicfPortal=hpnicfPortal, hpnicfPortalStatAuthFail=hpnicfPortalStatAuthFail, hpnicfPortalMacTriggerOnIfTable=hpnicfPortalMacTriggerOnIfTable, hpnicfPortalForbiddenRuleSrcIfIndex=hpnicfPortalForbiddenRuleSrcIfIndex, hpnicfPortalMacTriggerSrvRowStatus=hpnicfPortalMacTriggerSrvRowStatus, hpnicfPortalForbiddenRuleDstAddr=hpnicfPortalForbiddenRuleDstAddr, hpnicfPortalStatus=hpnicfPortalStatus, hpnicfPortalIfVlanNasIDTable=hpnicfPortalIfVlanNasIDTable)
