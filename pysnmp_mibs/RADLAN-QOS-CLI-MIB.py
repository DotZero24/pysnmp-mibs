...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:57 2025
...
rlQosPortPolicyStatisticsEntry.setIndexNames(
    (0, "RADLAN-QOS-CLI-MIB", "rlIfIndex"),
    (0, "RADLAN-QOS-CLI-MIB", "rlIfType"),
    (0, "RADLAN-QOS-CLI-MIB", "rlQosPortPolicyStatisticsCntrType"),
)
if mibBuilder.loadTexts:
...
rlQosOutQueueStatisticsEntry.setIndexNames(
    (0, "RADLAN-QOS-CLI-MIB", "rlQosOutQueueStatisticsCountrID"),
)
if mibBuilder.loadTexts:
...
rlQosGlobalStatisticsCntrsEntry.setIndexNames(
    (0, "RADLAN-QOS-CLI-MIB", "rlQosGlobalStatisticsCntrsType"),
)
if mibBuilder.loadTexts:
...
rlQosClassifierUtilizationEntry.setIndexNames(
    (0, "RADLAN-QOS-CLI-MIB", "rlQosClassifierUtilizationUnitId"),
)
if mibBuilder.loadTexts:
...
rlQosPortToProfileMappingEntry.setIndexNames(
    (0, "RADLAN-QOS-CLI-MIB", "rlQosPort"),
)
if mibBuilder.loadTexts:
...
rlQosPolicyClassPriorityRefEntry.setIndexNames(
    (0, "RADLAN-QOS-CLI-MIB", "rlQosPolicyClassPriorityRefPriority"),
    (0, "RADLAN-QOS-CLI-MIB", "rlQosPolicyClassPriorityRefClassPointer"),
)
if mibBuilder.loadTexts:
...
rlQosDenyAceStatisticsEntry.setIndexNames(
    (0, "RADLAN-QOS-CLI-MIB", "rlQosDenyAceStatisticsIfIndex"),
)
if mibBuilder.loadTexts:
...
rlQosModeGlobalCfgEntry.setIndexNames(
    (0, "RADLAN-QOS-CLI-MIB", "rlQosGlobalIndex"),
)
if mibBuilder.loadTexts:
...
rlQosApplicationTrapIdEntry.setIndexNames(
    (1, "RADLAN-QOS-CLI-MIB", "rlQosApplicationName"),
)
if mibBuilder.loadTexts:
...
rlQosLogInputInterfacesAceMatchedEntry.setIndexNames(
    (0, "RADLAN-QOS-CLI-MIB", "rlQosLogInputInterfacesAceMatchedIndex"),
)
if mibBuilder.loadTexts:
