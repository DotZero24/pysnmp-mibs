...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/HpicfHighAvailability-MIB
...
hpicfHAMgmtModuleBackUpState = MibTableColumn((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 11, 2, 5, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(("failed", 0), ("unknown", 1), ("waiting", 2), ("realtimeBackupToSlot", 3), ("slotIsAbsent", 4), ("batchBackup", 5), ("receivingRealtimeData", 6), ("offline", 7)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("HpicfHighAvailability-MIB", hpicfHAConfigGroup=hpicfHAConfigGroup, hpicfHAPreferredActiveManagement=hpicfHAPreferredActiveManagement, hpicfHAConformance=hpicfHAConformance, PYSNMP_MODULE_ID=hpicfHighAvailability, hpicfHAContinuousFwdingTime=hpicfHAContinuousFwdingTime, hpicfHAFailOverReason=hpicfHAFailOverReason, hpicfHAMgmtModuleBackUpState=hpicfHAMgmtModuleBackUpState, hpicfHAFailOverState=hpicfHAFailOverState, hpicfHAMgmtModuleCardUpSince=hpicfHAMgmtModuleCardUpSince, hpicfHACompliance2=hpicfHACompliance2, hpicfHAFailOverLogTable=hpicfHAFailOverLogTable, hpicfHALastFailoverTime=hpicfHALastFailoverTime, hpicfHAStatusGroup=hpicfHAStatusGroup, hpicfHAMgmtRedundancyFailureReason=hpicfHAMgmtRedundancyFailureReason, hpicfHACompliance3=hpicfHACompliance3, hpicfHAMgmtModuleGroup1=hpicfHAMgmtModuleGroup1, hpicfHAGroups=hpicfHAGroups, hpicfHAConfigGroup1=hpicfHAConfigGroup1, hpicfHAFailOverLogEntry=hpicfHAFailOverLogEntry, hpicfHAMgmtModuleStateSince=hpicfHAMgmtModuleStateSince, hpicfHAFailOverGroup=hpicfHAFailOverGroup, hpicfHAFailOverIndex=hpicfHAFailOverIndex, hpicfHAFailOverTime=hpicfHAFailOverTime, hpicfHACompliances=hpicfHACompliances, hpicfHAMgmtModuleTable=hpicfHAMgmtModuleTable, hpicfHAMgmtModuleState=hpicfHAMgmtModuleState, hpicfHAConfigObjects=hpicfHAConfigObjects, hpicfHAMgmtModuleRedundancyState=hpicfHAMgmtModuleRedundancyState, hpicfHAFailOverMgmtModule=hpicfHAFailOverMgmtModule, hpicfHighAvailability=hpicfHighAvailability, hpicfHACompliance=hpicfHACompliance, hpicfHACompliance1=hpicfHACompliance1, hpicfHARedundancyManagementModuleMode=hpicfHARedundancyManagementModuleMode, hpicfHAMgmtFailovers=hpicfHAMgmtFailovers, hpicfHAMgmtModuleGroup=hpicfHAMgmtModuleGroup, hpicfHAMgmtModuleEntry=hpicfHAMgmtModuleEntry, hpicfHAStatusObjects=hpicfHAStatusObjects)
