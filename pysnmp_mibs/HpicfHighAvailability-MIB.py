...
# Notes
# -----
# ASN.1 source file://mibs/hp/HpicfHighAvailability-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:33:50 2025
...
_HpicfHAContinuousFwdingTime_Type.__name__ = "Unsigned32"
...
hpicfHACompliance.setObjects(
      *(("HpicfHighAvailability-MIB", "hpicfHAConfigGroup"),
        ("HpicfHighAvailability-MIB", "hpicfHAStatusGroup"))
)
if mibBuilder.loadTexts:
...
hpicfHACompliance1.setObjects(
      *(("HpicfHighAvailability-MIB", "hpicfHAFailOverGroup"),
        ("HpicfHighAvailability-MIB", "hpicfHAMgmtModuleGroup"))
)
if mibBuilder.loadTexts:
...
hpicfHACompliance2.setObjects(
      *(("HpicfHighAvailability-MIB", "hpicfHAFailOverGroup"),
        ("HpicfHighAvailability-MIB", "hpicfHAMgmtModuleGroup1"))
)
if mibBuilder.loadTexts:
...
hpicfHACompliance3.setObjects(
      *(("HpicfHighAvailability-MIB", "hpicfHAConfigGroup1"),
        ("HpicfHighAvailability-MIB", "hpicfHAStatusGroup"))
)
if mibBuilder.loadTexts:
