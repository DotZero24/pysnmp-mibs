...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-EIGRP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:32:40 2025
...
cEigrpMIBCompliance.setObjects(
      *(("CISCO-EIGRP-MIB", "cEigrpVpnDataGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpTrafficStatsGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpInterfaceDataGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpPeerDataGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpTopoDataGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
cEigrpMIBComplianceRev1.setObjects(
      *(("CISCO-EIGRP-MIB", "cEigrpVpnDataGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpTrafficStatsGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpInterfaceDataGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpPeerDataGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpTopoDataGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpNotificationsGroup"),
        ("CISCO-EIGRP-MIB", "cEigrpNotificationsGroupSupR01"),
        ("CISCO-EIGRP-MIB", "cEigrpTopoDataGroupSupR01"))
)
if mibBuilder.loadTexts:
