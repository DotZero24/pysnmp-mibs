_f='colubrisSatelliteNotificationGroup'
_e='colubrisSatelliteNotificationControlGroup'
_d='colubrisSatelliteManagementMIBGroup'
...
_C='read-only'
_B='current'
_A='COLUBRIS-SATELLITE-MANAGEMENT-MIB'
if'mibBuilder'not in globals():import sys;sys.stderr.write(__doc__);sys.exit(1)
Integer,OctetString,ObjectIdentifier=mibBuilder.importSymbols('ASN1','Integer','OctetString','ObjectIdentifier')
NamedValues,=mibBuilder.importSymbols('ASN1-ENUMERATION','NamedValues')
ConstraintsIntersection,ConstraintsUnion,SingleValueConstraint,ValueRangeConstraint,ValueSizeConstraint=mibBuilder.importSymbols('ASN1-REFINEMENT','ConstraintsIntersection','ConstraintsUnion','SingleValueConstraint','ValueRangeConstraint','ValueSizeConstraint')
colubrisMgmtV2,=mibBuilder.importSymbols('COLUBRIS-SMI','colubrisMgmtV2')
ColubrisNotificationEnable,ColubrisSSIDOrNone=mibBuilder.importSymbols('COLUBRIS-TC',_J,'ColubrisSSIDOrNone')
...
colubrisSatelliteManagementMIBObjects=_ColubrisSatelliteManagementMIBObjects_ObjectIdentity((1,3,6,1,4,1,8744,5,7,1))
_SatelliteInfo_ObjectIdentity=ObjectIdentity
satelliteInfo=_SatelliteInfo_ObjectIdentity((1,3,6,1,4,1,8744,5,7,1,1))
_SatelliteTable_Object=MibTable
satelliteTable=_SatelliteTable_Object((1,3,6,1,4,1,8744,5,7,1,1,1))
if mibBuilder.loadTexts:satelliteTable.setStatus(_B)
_SatelliteEntry_Object=MibTableRow
satelliteEntry=_SatelliteEntry_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1))
...
satelliteIndex=_SatelliteIndex_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,1),_SatelliteIndex_Type())
...
satelliteDeviceId=_SatelliteDeviceId_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,2),_SatelliteDeviceId_Type())
...
satelliteMacAddress=_SatelliteMacAddress_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,3),_SatelliteMacAddress_Type())
...
satelliteIpAddress=_SatelliteIpAddress_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,4),_SatelliteIpAddress_Type())
...
satelliteName=_SatelliteName_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,5),_SatelliteName_Type())
...
satelliteSSID=_SatelliteSSID_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,6),_SatelliteSSID_Type())
...
satelliteChannelNumber=_SatelliteChannelNumber_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,7),_SatelliteChannelNumber_Type())
...
satelliteForwardWirelessToWireless=_SatelliteForwardWirelessToWireless_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,8),_SatelliteForwardWirelessToWireless_Type())
...
satelliteMasterTrafficOnly=_SatelliteMasterTrafficOnly_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,9),_SatelliteMasterTrafficOnly_Type())
...
satelliteSNMPPort=_SatelliteSNMPPort_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,10),_SatelliteSNMPPort_Type())
...
satelliteSecureWebPort=_SatelliteSecureWebPort_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,11),_SatelliteSecureWebPort_Type())
...
satelliteDeviceMacAddress=_SatelliteDeviceMacAddress_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,12),_SatelliteDeviceMacAddress_Type())
...
satelliteProductName=_SatelliteProductName_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,13),_SatelliteProductName_Type())
...
satelliteFirmwareRevision=_SatelliteFirmwareRevision_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,14),_SatelliteFirmwareRevision_Type())
...
satelliteGroupName=_SatelliteGroupName_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,15),_SatelliteGroupName_Type())
...
satelliteChannelNumberRadio2=_SatelliteChannelNumberRadio2_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,16),_SatelliteChannelNumberRadio2_Type())
...
satelliteVLAN=_SatelliteVLAN_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,17),_SatelliteVLAN_Type())
...
satelliteDetectionPort=_SatelliteDetectionPort_Object((1,3,6,1,4,1,8744,5,7,1,1,1,1,18),_SatelliteDetectionPort_Type())
...
satelliteNumber=_SatelliteNumber_Object((1,3,6,1,4,1,8744,5,7,1,1,2),_SatelliteNumber_Type())
...
masterSettings=_MasterSettings_ObjectIdentity((1,3,6,1,4,1,8744,5,7,1,2))
class _SatelliteUpNotificationEnabled_Type(ColubrisNotificationEnable):defaultValue=1
_SatelliteUpNotificationEnabled_Type.__name__=_J
_SatelliteUpNotificationEnabled_Object=MibScalar
satelliteUpNotificationEnabled=_SatelliteUpNotificationEnabled_Object((1,3,6,1,4,1,8744,5,7,1,2,1),_SatelliteUpNotificationEnabled_Type())
satelliteUpNotificationEnabled.setMaxAccess(_L)
if mibBuilder.loadTexts:satelliteUpNotificationEnabled.setStatus(_B)
class _SatelliteDownNotificationEnabled_Type(ColubrisNotificationEnable):defaultValue=1
_SatelliteDownNotificationEnabled_Type.__name__=_J
_SatelliteDownNotificationEnabled_Object=MibScalar
satelliteDownNotificationEnabled=_SatelliteDownNotificationEnabled_Object((1,3,6,1,4,1,8744,5,7,1,2,2),_SatelliteDownNotificationEnabled_Type())
...
colubrisSatelliteManagementMIBNotificationPrefix=_ColubrisSatelliteManagementMIBNotificationPrefix_ObjectIdentity((1,3,6,1,4,1,8744,5,7,2))
_ColubrisSatelliteManagementMIBNotifications_ObjectIdentity=ObjectIdentity
colubrisSatelliteManagementMIBNotifications=_ColubrisSatelliteManagementMIBNotifications_ObjectIdentity((1,3,6,1,4,1,8744,5,7,2,0))
_ColubrisSatelliteManagementMIBConformance_ObjectIdentity=ObjectIdentity
colubrisSatelliteManagementMIBConformance=_ColubrisSatelliteManagementMIBConformance_ObjectIdentity((1,3,6,1,4,1,8744,5,7,3))
_ColubrisSatelliteManagementMIBCompliances_ObjectIdentity=ObjectIdentity
colubrisSatelliteManagementMIBCompliances=_ColubrisSatelliteManagementMIBCompliances_ObjectIdentity((1,3,6,1,4,1,8744,5,7,3,1))
_ColubrisSatelliteManagementMIBGroups_ObjectIdentity=ObjectIdentity
colubrisSatelliteManagementMIBGroups=_ColubrisSatelliteManagementMIBGroups_ObjectIdentity((1,3,6,1,4,1,8744,5,7,3,2))
colubrisSatelliteManagementMIBGroup=ObjectGroup((1,3,6,1,4,1,8744,5,7,3,2,1))
colubrisSatelliteManagementMIBGroup.setObjects(*((_A,_E),(_A,_F),(_A,_G),(_A,_H),(_A,_I),(_A,_M),(_A,_N),(_A,_O),(_A,_P),(_A,_Q),(_A,_R),(_A,_S),(_A,_T),(_A,_U),(_A,_V),(_A,_W),(_A,_X),(_A,_Y)))
if mibBuilder.loadTexts:colubrisSatelliteManagementMIBGroup.setStatus(_B)
colubrisSatelliteNotificationControlGroup=ObjectGroup((1,3,6,1,4,1,8744,5,7,3,2,2))
colubrisSatelliteNotificationControlGroup.setObjects(*((_A,_Z),(_A,_a)))
if mibBuilder.loadTexts:colubrisSatelliteNotificationControlGroup.setStatus(_B)
satelliteUpNotification=NotificationType((1,3,6,1,4,1,8744,5,7,2,0,1))
...
satelliteDownNotification=NotificationType((1,3,6,1,4,1,8744,5,7,2,0,2))
...
colubrisSatelliteNotificationGroup=NotificationGroup((1,3,6,1,4,1,8744,5,7,3,2,3))
colubrisSatelliteNotificationGroup.setObjects(*((_A,_b),(_A,_c)))
if mibBuilder.loadTexts:colubrisSatelliteNotificationGroup.setStatus(_B)
colubrisSatelliteManagementMIBCompliance=ModuleCompliance((1,3,6,1,4,1,8744,5,7,3,1,1))
colubrisSatelliteManagementMIBCompliance.setObjects(*((_A,_d),(_A,_e),(_A,_f)))
if mibBuilder.loadTexts:colubrisSatelliteManagementMIBCompliance.setStatus(_B)
mibBuilder.exportSymbols(_A,**{'colubrisSatelliteManagementMIB':colubrisSatelliteManagementMIB,'colubrisSatelliteManagementMIBObjects':colubrisSatelliteManagementMIBObjects,'satelliteInfo':satelliteInfo,'satelliteTable':satelliteTable,'satelliteEntry':satelliteEntry,_K:satelliteIndex,_E:satelliteDeviceId,_F:satelliteMacAddress,_G:satelliteIpAddress,_H:satelliteName,_I:satelliteSSID,_M:satelliteChannelNumber,_N:satelliteForwardWirelessToWireless,_O:satelliteMasterTrafficOnly,_P:satelliteSNMPPort,_Q:satelliteSecureWebPort,_R:satelliteDeviceMacAddress,_S:satelliteProductName,_T:satelliteFirmwareRevision,_U:satelliteGroupName,_W:satelliteChannelNumberRadio2,_X:satelliteVLAN,_Y:satelliteDetectionPort,_V:satelliteNumber,'masterSettings':masterSettings,_Z:satelliteUpNotificationEnabled,_a:satelliteDownNotificationEnabled,'colubrisSatelliteManagementMIBNotificationPrefix':colubrisSatelliteManagementMIBNotificationPrefix,'colubrisSatelliteManagementMIBNotifications':colubrisSatelliteManagementMIBNotifications,_b:satelliteUpNotification,_c:satelliteDownNotification,'colubrisSatelliteManagementMIBConformance':colubrisSatelliteManagementMIBConformance,'colubrisSatelliteManagementMIBCompliances':colubrisSatelliteManagementMIBCompliances,'colubrisSatelliteManagementMIBCompliance':colubrisSatelliteManagementMIBCompliance,'colubrisSatelliteManagementMIBGroups':colubrisSatelliteManagementMIBGroups,_d:colubrisSatelliteManagementMIBGroup,_e:colubrisSatelliteNotificationControlGroup,_f:colubrisSatelliteNotificationGroup})