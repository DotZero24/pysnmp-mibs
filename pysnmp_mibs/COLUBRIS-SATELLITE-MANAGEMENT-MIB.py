...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/colubris/COLUBRIS-SATELLITE-MANAGEMENT-MIB
...
mibBuilder.exportSymbols("COLUBRIS-SATELLITE-MANAGEMENT-MIB", colubrisSatelliteManagementMIBGroup=colubrisSatelliteManagementMIBGroup, satelliteIndex=satelliteIndex, satelliteSSID=satelliteSSID, satelliteDetectionPort=satelliteDetectionPort, colubrisSatelliteManagementMIBObjects=colubrisSatelliteManagementMIBObjects, satelliteChannelNumberRadio2=satelliteChannelNumberRadio2, satelliteNumber=satelliteNumber, satelliteProductName=satelliteProductName, colubrisSatelliteManagementMIBConformance=colubrisSatelliteManagementMIBConformance, satelliteIpAddress=satelliteIpAddress, satelliteDeviceId=satelliteDeviceId, masterSettings=masterSettings, satelliteTable=satelliteTable, satelliteEntry=satelliteEntry, satelliteForwardWirelessToWireless=satelliteForwardWirelessToWireless, satelliteVLAN=satelliteVLAN, colubrisSatelliteManagementMIBCompliance=colubrisSatelliteManagementMIBCompliance, satelliteUpNotification=satelliteUpNotification, satelliteDownNotification=satelliteDownNotification, satelliteGroupName=satelliteGroupName, satelliteSecureWebPort=satelliteSecureWebPort, colubrisSatelliteManagementMIBNotificationPrefix=colubrisSatelliteManagementMIBNotificationPrefix, colubrisSatelliteNotificationControlGroup=colubrisSatelliteNotificationControlGroup, satelliteDeviceMacAddress=satelliteDeviceMacAddress, satelliteFirmwareRevision=satelliteFirmwareRevision, satelliteDownNotificationEnabled=satelliteDownNotificationEnabled, satelliteInfo=satelliteInfo, colubrisSatelliteNotificationGroup=colubrisSatelliteNotificationGroup, satelliteName=satelliteName, colubrisSatelliteManagementMIBNotifications=colubrisSatelliteManagementMIBNotifications, satelliteMasterTrafficOnly=satelliteMasterTrafficOnly, satelliteChannelNumber=satelliteChannelNumber, colubrisSatelliteManagementMIBGroups=colubrisSatelliteManagementMIBGroups, colubrisSatelliteManagementMIBCompliances=colubrisSatelliteManagementMIBCompliances, colubrisSatelliteManagementMIB=colubrisSatelliteManagementMIB, PYSNMP_MODULE_ID=colubrisSatelliteManagementMIB, satelliteSNMPPort=satelliteSNMPPort, satelliteUpNotificationEnabled=satelliteUpNotificationEnabled, satelliteMacAddress=satelliteMacAddress)
