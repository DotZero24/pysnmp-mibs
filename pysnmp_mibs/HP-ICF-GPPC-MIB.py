...
mibBuilder.exportSymbols("HP-ICF-GPPC-MIB", hpicfGppcAcEgressIfList=hpicfGppcAcEgressIfList, hpicfGppcAcIngressVlanMap1k=hpicfGppcAcIngressVlanMap1k, hpicfGppcPolicyRulesEntry=hpicfGppcPolicyRulesEntry, hpicfGppcMIBCompliances=hpicfGppcMIBCompliances, hpicfGppcPrRuleId=hpicfGppcPrRuleId, hpicfGppcAppControlEntry=hpicfGppcAppControlEntry, hpicfGppcMIB=hpicfGppcMIB, hpicfGppcAcExpPolicy=hpicfGppcAcExpPolicy, hpicfGppcNamedPolicyTable=hpicfGppcNamedPolicyTable, hpicfGppcMIBCompliance=hpicfGppcMIBCompliance, hpicfGppcAcAppInstance=hpicfGppcAcAppInstance, hpicfGppcNpRowStatus=hpicfGppcNpRowStatus, hpicfGppcNpPolicyName=hpicfGppcNpPolicyName, hpicfGppcAcIngressIfList=hpicfGppcAcIngressIfList, hpicfGppcAcIngressVlanMap4k=hpicfGppcAcIngressVlanMap4k, hpicfGppcAcEgressVlanMap3k=hpicfGppcAcEgressVlanMap3k, hpicfGppcAcPolicyName=hpicfGppcAcPolicyName, hpicfGppcAcIngressVlanMap3k=hpicfGppcAcIngressVlanMap3k, hpicfGppcNamedPolicyEntry=hpicfGppcNamedPolicyEntry, hpicfGppcMIBGroups=hpicfGppcMIBGroups, hpicfGppcAcRowAdminStatus=hpicfGppcAcRowAdminStatus, hpicfGppcAppControlTable=hpicfGppcAppControlTable, hpicfGppcAcEgressVlanMap1k=hpicfGppcAcEgressVlanMap1k, hpicfGppcAcLastErrorString=hpicfGppcAcLastErrorString, hpicfGppcPrRowStatus=hpicfGppcPrRowStatus, hpicfGppcPrPolicyRule=hpicfGppcPrPolicyRule, hpicfGppcAcIngressVlanMap2k=hpicfGppcAcIngressVlanMap2k, hpicfGppcAcAppName=hpicfGppcAcAppName, hpicfGppcNpPolicyType=hpicfGppcNpPolicyType, hpicfGppcAcEgressVlanMap4k=hpicfGppcAcEgressVlanMap4k, hpicfGppcPolicyRulesTable=hpicfGppcPolicyRulesTable, hpicfGppcAcLastErrorCode=hpicfGppcAcLastErrorCode, HpicfGppcPolicyName=HpicfGppcPolicyName, hpicfGppcConformance=hpicfGppcConformance, hpicfGppcAcRowStatus=hpicfGppcAcRowStatus, PYSNMP_MODULE_ID=hpicfGppcMIB, hpicfGppcAcExpString=hpicfGppcAcExpString, hpicfGppcAcEgressVlanMap2k=hpicfGppcAcEgressVlanMap2k, hpicfGppcGroup=hpicfGppcGroup)
