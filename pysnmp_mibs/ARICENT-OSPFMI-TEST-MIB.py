# SNMP MIB module (ARICENT-OSPFMI-TEST-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-OSPFMI-TEST-MIB
...
fsMIOspfBRRouteEntry = _FsMIOspfBRRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 147, 1, 1)
)
fsMIOspfBRRouteEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-OSPFMI-TEST-MIB", "fsMIOspfBRRouteIpAddr"),
    (0, "ARICENT-OSPFMI-TEST-MIB", "fsMIOspfBRRouteIpAddrMask"),
    (0, "ARICENT-OSPFMI-TEST-MIB", "fsMIOspfBRRouteIpTos"),
    (0, "ARICENT-OSPFMI-TEST-MIB", "fsMIOspfBRRouteIpNextHop"),
    (0, "ARICENT-OSPFMI-TEST-MIB", "fsMIOspfBRRouteDestType"),
)
if mibBuilder.loadTexts:
...
fsMIOspfExtRouteEntry = _FsMIOspfExtRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 147, 2, 1)
)
fsMIOspfExtRouteEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPF-MIB", "fsMIStdOspfContextId"),
    (0, "ARICENT-OSPFMI-TEST-MIB", "fsMIOspfExtRouteDest"),
    (0, "ARICENT-OSPFMI-TEST-MIB", "fsMIOspfExtRouteMask"),
    (0, "ARICENT-OSPFMI-TEST-MIB", "fsMIOspfExtRouteTOS"),
)
if mibBuilder.loadTexts:
...
fsMIOspfGrShutdown = _FsMIOspfGrShutdown_Object(
    (1, 3, 6, 1, 4, 1, 2076, 147, 100, 2, 1, 1),
