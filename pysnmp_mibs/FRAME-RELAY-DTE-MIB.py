...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/FRAME-RELAY-DTE-MIB
...
mibBuilder.exportSymbols("FRAME-RELAY-DTE-MIB", frCompliance0=frCompliance0, frCircuitGroup0=frCircuitGroup0, frDlcmiErrorThreshold=frDlcmiErrorThreshold, frTrapGroup0=frTrapGroup0, frDlcmiAddressLen=frDlcmiAddressLen, frDlcmiFullEnquiryInterval=frDlcmiFullEnquiryInterval, frCircuitType=frCircuitType, frCircuitReceivedFrames=frCircuitReceivedFrames, frCircuitMulticast=frCircuitMulticast, frCompliance=frCompliance, frNotificationGroup=frNotificationGroup, frCircuitTable=frCircuitTable, frCircuitLogicalIfIndex=frCircuitLogicalIfIndex, frConformance=frConformance, frCircuitEntry=frCircuitEntry, DLCI=DLCI, frDlcmiState=frDlcmiState, frErrEntry=frErrEntry, frCircuitCreationTime=frCircuitCreationTime, frDlcmiEntry=frDlcmiEntry, frCircuitDlci=frCircuitDlci, frCircuitExcessBurst=frCircuitExcessBurst, frPortGroup=frPortGroup, frErrFaults=frErrFaults, frCircuitSentOctets=frCircuitSentOctets, frCircuitLastTimeChange=frCircuitLastTimeChange, frDlcmiMaxSupportedVCs=frDlcmiMaxSupportedVCs, frameRelayDTE=frameRelayDTE, frCircuitReceivedOctets=frCircuitReceivedOctets, frCircuitReceivedFECNs=frCircuitReceivedFECNs, frCircuitGroup=frCircuitGroup, frPortGroup0=frPortGroup0, frCompliances=frCompliances, frCircuitIfIndex=frCircuitIfIndex, frDlcmiRowStatus=frDlcmiRowStatus, frDlcmiTable=frDlcmiTable, frCircuitRowStatus=frCircuitRowStatus, frTrapGroup=frTrapGroup, frCircuitSentDEs=frCircuitSentDEs, frCircuitCommittedBurst=frCircuitCommittedBurst, frDlcmiAddress=frDlcmiAddress, frCircuitThroughput=frCircuitThroughput, frErrType=frErrType, frCircuitReceivedDEs=frCircuitReceivedDEs, frCircuitSentFrames=frCircuitSentFrames, frDlcmiPollingInterval=frDlcmiPollingInterval, frDlcmiMulticast=frDlcmiMulticast, PYSNMP_MODULE_ID=frameRelayDTE, frDlcmiMonitoredEvents=frDlcmiMonitoredEvents, frErrFaultTime=frErrFaultTime, frGroups=frGroups, frErrIfIndex=frErrIfIndex, frErrGroup=frErrGroup, frDlcmiIfIndex=frDlcmiIfIndex, frTrapState=frTrapState, frCircuitState=frCircuitState, frErrTable=frErrTable, frameRelayTrapControl=frameRelayTrapControl, frTrapMaxRate=frTrapMaxRate, frDLCIStatusChange=frDLCIStatusChange, frameRelayTraps=frameRelayTraps, frDlcmiStatus=frDlcmiStatus, frCircuitReceivedBECNs=frCircuitReceivedBECNs, frCircuitDiscards=frCircuitDiscards, frErrGroup0=frErrGroup0, frErrData=frErrData, frErrTime=frErrTime)
