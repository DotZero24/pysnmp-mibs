...
mibBuilder.exportSymbols("FRAME-RELAY-DTE-MIB", frCircuitThroughput=frCircuitThroughput, frameRelayDTE=frameRelayDTE, frErrData=frErrData, PYSNMP_MODULE_ID=frameRelayDTE, frCircuitReceivedFrames=frCircuitReceivedFrames, frDlcmiFullEnquiryInterval=frDlcmiFullEnquiryInterval, frErrFaultTime=frErrFaultTime, frCompliances=frCompliances, frCompliance0=frCompliance0, frTrapGroup=frTrapGroup, frErrGroup0=frErrGroup0, frCircuitReceivedBECNs=frCircuitReceivedBECNs, frErrTable=frErrTable, frErrEntry=frErrEntry, frTrapState=frTrapState, frCircuitSentOctets=frCircuitSentOctets, frNotificationGroup=frNotificationGroup, frErrTime=frErrTime, frDlcmiAddressLen=frDlcmiAddressLen, frDlcmiPollingInterval=frDlcmiPollingInterval, frDlcmiErrorThreshold=frDlcmiErrorThreshold, frCircuitType=frCircuitType, frConformance=frConformance, frDlcmiStatus=frDlcmiStatus, frCircuitIfIndex=frCircuitIfIndex, frCircuitCreationTime=frCircuitCreationTime, frCircuitRowStatus=frCircuitRowStatus, frDlcmiEntry=frDlcmiEntry, frDlcmiIfIndex=frDlcmiIfIndex, frTrapMaxRate=frTrapMaxRate, frPortGroup0=frPortGroup0, frTrapGroup0=frTrapGroup0, frCircuitDiscards=frCircuitDiscards, frDlcmiTable=frDlcmiTable, frCircuitLastTimeChange=frCircuitLastTimeChange, frDLCIStatusChange=frDLCIStatusChange, frGroups=frGroups, frPortGroup=frPortGroup, frameRelayTrapControl=frameRelayTrapControl, frDlcmiMonitoredEvents=frDlcmiMonitoredEvents, frDlcmiRowStatus=frDlcmiRowStatus, frCircuitTable=frCircuitTable, frCircuitDlci=frCircuitDlci, frCircuitMulticast=frCircuitMulticast, frCircuitReceivedDEs=frCircuitReceivedDEs, frCircuitReceivedOctets=frCircuitReceivedOctets, frErrType=frErrType, frCircuitGroup=frCircuitGroup, frErrGroup=frErrGroup, DLCI=DLCI, frameRelayTraps=frameRelayTraps, frErrFaults=frErrFaults, frCircuitSentDEs=frCircuitSentDEs, frDlcmiMulticast=frDlcmiMulticast, frCircuitExcessBurst=frCircuitExcessBurst, frCircuitState=frCircuitState, frCircuitReceivedFECNs=frCircuitReceivedFECNs, frDlcmiMaxSupportedVCs=frDlcmiMaxSupportedVCs, frCircuitCommittedBurst=frCircuitCommittedBurst, frCircuitEntry=frCircuitEntry, frCircuitLogicalIfIndex=frCircuitLogicalIfIndex, frErrIfIndex=frErrIfIndex, frCompliance=frCompliance, frDlcmiState=frDlcmiState, frDlcmiAddress=frDlcmiAddress, frCircuitSentFrames=frCircuitSentFrames, frCircuitGroup0=frCircuitGroup0)
