_b='swACLPayloadRuleAccessID'
_a='swACLPayloadRuleProfileID'
_Z='swACLIpRuleAccessID'
_Y='swACLIpRuleProfileID'
_X='swACLEtherRuleAccessID'
_W='swACLEtherRuleProfileID'
_V='swACLPayloadProfileID'
_U='dst-src-addr'
_T='src-addr'
_S='dst-addr'
_R='protocolId'
...
swACLEthernetEntry.setIndexNames((0,_G,_P))
...
class _SwACLEthernetMacAddrMaskState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_I,1),('dst-mac-addr',2),('src-mac-addr',3),('dst-src-mac-addr',4)))
...
swACLIpEntry.setIndexNames((0,_G,_Q))
...
class _SwACLIpIpAddrMaskState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_I,1),('dst-ip-addr',2),('src-ip-addr',3),('dst-src-ip-addr',4)))
...
class _SwACLIpUseProtoType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6)));namedValues=NamedValues(*((_K,1),('icmp',2),('igmp',3),('tcp',4),('udp',5),(_R,6)))
...
class _SwACLIpIcmpOption_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_K,1),('type',2),('code',3),('type-code',4)))
...
class _SwACLIpIgmpOption_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_L,1),(_M,2)))
...
class _SwACLIpTcpOption_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_I,1),(_S,2),(_T,3),(_U,4)))
...
class _SwACLIpUdpOption_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_I,1),(_S,2),(_T,3),(_U,4)))
...
class _SwACLIpTCPFlagBit_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_L,1),(_M,2)))
...
class _SwACLIpProtoIDOption_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_L,1),(_M,2)))
_SwACLIpProtoIDOption_Type.__name__=_C
_SwACLIpProtoIDOption_Object=MibTableColumn
swACLIpProtoIDOption=_SwACLIpProtoIDOption_Object((1,3,6,1,4,1,171,11,5,1,2,1,16),_SwACLIpProtoIDOption_Type())
...
swACLIpProtoIDMask=_SwACLIpProtoIDMask_Object((1,3,6,1,4,1,171,11,5,1,2,1,17),_SwACLIpProtoIDMask_Type())
...
swACLIpPort=_SwACLIpPort_Object((1,3,6,1,4,1,171,11,5,1,2,1,18),_SwACLIpPort_Type())
...
swACLIpRowStatus=_SwACLIpRowStatus_Object((1,3,6,1,4,1,171,11,5,1,2,1,19),_SwACLIpRowStatus_Type())
...
swACLIpTCPFlagBitMask=_SwACLIpTCPFlagBitMask_Object((1,3,6,1,4,1,171,11,5,1,2,1,115),_SwACLIpTCPFlagBitMask_Type())
...
swACLPayloadEntry.setIndexNames((0,_G,_V))
...
swACLPayloadPort=_SwACLPayloadPort_Object((1,3,6,1,4,1,171,11,5,1,3,1,2),_SwACLPayloadPort_Type())
...
swACLPayloadOffSet0to15=_SwACLPayloadOffSet0to15_Object((1,3,6,1,4,1,171,11,5,1,3,1,3),_SwACLPayloadOffSet0to15_Type())
...
swACLPayloadOffSet16to31=_SwACLPayloadOffSet16to31_Object((1,3,6,1,4,1,171,11,5,1,3,1,4),_SwACLPayloadOffSet16to31_Type())
...
swACLPayloadOffSet32to47=_SwACLPayloadOffSet32to47_Object((1,3,6,1,4,1,171,11,5,1,3,1,5),_SwACLPayloadOffSet32to47_Type())
...
swACLPayloadOffSet48to63=_SwACLPayloadOffSet48to63_Object((1,3,6,1,4,1,171,11,5,1,3,1,6),_SwACLPayloadOffSet48to63_Type())
...
swACLPayloadOffSet64to79=_SwACLPayloadOffSet64to79_Object((1,3,6,1,4,1,171,11,5,1,3,1,7),_SwACLPayloadOffSet64to79_Type())
...
swACLEtherRuleEntry.setIndexNames((0,_G,_W),(0,_G,_X))
...
_SwACLEtherRuleVlan_Type.__name__=_J
...
class _SwACLEtherRulePermit_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_N,1),(_O,2)))
_SwACLEtherRulePermit_Type.__name__=_C
_SwACLEtherRulePermit_Object=MibTableColumn
swACLEtherRulePermit=_SwACLEtherRulePermit_Object((1,3,6,1,4,1,171,11,5,2,1,1,14),_SwACLEtherRulePermit_Type())
...
swACLEtherRuleRowStatus=_SwACLEtherRuleRowStatus_Object((1,3,6,1,4,1,171,11,5,2,1,1,15),_SwACLEtherRuleRowStatus_Type())
...
swACLIpRuleEntry.setIndexNames((0,_G,_Y),(0,_G,_Z))
...
_SwACLIpRuleVlan_Type.__name__=_J
...
class _SwACLIpRuleProtocol_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6)));namedValues=NamedValues(*((_K,1),('icmp',2),('igmp',3),('tcp',4),('udp',5),(_R,6)))
...
class _SwACLIpRulePermit_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_N,1),(_O,2)))
_SwACLIpRulePermit_Type.__name__=_C
_SwACLIpRulePermit_Object=MibTableColumn
swACLIpRulePermit=_SwACLIpRulePermit_Object((1,3,6,1,4,1,171,11,5,2,2,1,21),_SwACLIpRulePermit_Type())
...
swACLIpRuleRowStatus=_SwACLIpRuleRowStatus_Object((1,3,6,1,4,1,171,11,5,2,2,1,22),_SwACLIpRuleRowStatus_Type())
...
swACLPayloadRuleEntry.setIndexNames((0,_G,_a),(0,_G,_b))
...
swACLPayloadRuleOffSet0to15=_SwACLPayloadRuleOffSet0to15_Object((1,3,6,1,4,1,171,11,5,2,3,1,4),_SwACLPayloadRuleOffSet0to15_Type())
...
swACLPayloadRuleOffSet16to31=_SwACLPayloadRuleOffSet16to31_Object((1,3,6,1,4,1,171,11,5,2,3,1,5),_SwACLPayloadRuleOffSet16to31_Type())
...
swACLPayloadRuleOffSet32to47=_SwACLPayloadRuleOffSet32to47_Object((1,3,6,1,4,1,171,11,5,2,3,1,6),_SwACLPayloadRuleOffSet32to47_Type())
...
swACLPayloadRuleOffSet48to63=_SwACLPayloadRuleOffSet48to63_Object((1,3,6,1,4,1,171,11,5,2,3,1,7),_SwACLPayloadRuleOffSet48to63_Type())
...
swACLPayloadRuleOffSet64to79=_SwACLPayloadRuleOffSet64to79_Object((1,3,6,1,4,1,171,11,5,2,3,1,8),_SwACLPayloadRuleOffSet64to79_Type())
...
swACLPayloadRuleEnablePriority=_SwACLPayloadRuleEnablePriority_Object((1,3,6,1,4,1,171,11,5,2,3,1,9),_SwACLPayloadRuleEnablePriority_Type())
...
swACLPayloadRulePriority=_SwACLPayloadRulePriority_Object((1,3,6,1,4,1,171,11,5,2,3,1,10),_SwACLPayloadRulePriority_Type())
...
swACLPayloadRuleReplacePriority=_SwACLPayloadRuleReplacePriority_Object((1,3,6,1,4,1,171,11,5,2,3,1,11),_SwACLPayloadRuleReplacePriority_Type())
...
swACLPayloadRuleEnableReplaceDscp=_SwACLPayloadRuleEnableReplaceDscp_Object((1,3,6,1,4,1,171,11,5,2,3,1,12),_SwACLPayloadRuleEnableReplaceDscp_Type())
...
swACLPayloadRuleRepDscp=_SwACLPayloadRuleRepDscp_Object((1,3,6,1,4,1,171,11,5,2,3,1,13),_SwACLPayloadRuleRepDscp_Type())
swACLPayloadRuleRepDscp.setMaxAccess(_B)
if mibBuilder.loadTexts:swACLPayloadRuleRepDscp.setStatus(_A)
class _SwACLPayloadRulePermit_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_N,1),(_O,2)))
_SwACLPayloadRulePermit_Type.__name__=_C
_SwACLPayloadRulePermit_Object=MibTableColumn
swACLPayloadRulePermit=_SwACLPayloadRulePermit_Object((1,3,6,1,4,1,171,11,5,2,3,1,14),_SwACLPayloadRulePermit_Type())
