...
mibBuilder.exportSymbols("COLUBRIS-DEVICE-IF-MIB", coDeviceIfFdbGroup=coDeviceIfFdbGroup, coDevIfStsRxPackets=coDevIfStsRxPackets, coDevIfStaPowerForwardingStatus=coDevIfStaPowerForwardingStatus, coDeviceIfStatsEntry=coDeviceIfStatsEntry, coDeviceIfFdbEntry=coDeviceIfFdbEntry, colubrisDeviceIfMIBNotificationPrefix=colubrisDeviceIfMIBNotificationPrefix, colubrisDeviceIfMIBCompliance=colubrisDeviceIfMIBCompliance, colubrisDeviceIfMIBConformance=colubrisDeviceIfMIBConformance, colubrisDeviceIfStatusMIBGroup=colubrisDeviceIfStatusMIBGroup, coDevIfStaNetworkMask=coDevIfStaNetworkMask, coDevIfStaMACAddress=coDevIfStaMACAddress, coDevIfStsRxBytes=coDevIfStsRxBytes, coDeviceIfFdbTable=coDeviceIfFdbTable, coDevIfStaIpAddress=coDevIfStaIpAddress, colubrisDeviceIfMIBCompliances=colubrisDeviceIfMIBCompliances, coDevIfStaState=coDevIfStaState, colubrisDeviceIfStatsMIBGroup=colubrisDeviceIfStatsMIBGroup, colubrisDeviceIfMIBNotifications=colubrisDeviceIfMIBNotifications, coDeviceIfStatusGroup=coDeviceIfStatusGroup, colubrisDeviceIfFdbMIBGroup=colubrisDeviceIfFdbMIBGroup, coDeviceIfStatsTable=coDeviceIfStatsTable, coDevIfStaType=coDevIfStaType, coDevIfFdbMACAddress=coDevIfFdbMACAddress, coDevIfStsTxPackets=coDevIfStsTxPackets, PYSNMP_MODULE_ID=colubrisDeviceIfMIB, coDeviceIfStatusTable=coDeviceIfStatusTable, coDevIfStsTxBytes=coDevIfStsTxBytes, coDeviceIfStatsGroup=coDeviceIfStatsGroup, colubrisDeviceIfMIB=colubrisDeviceIfMIB, coDevIfStaVLAN=coDevIfStaVLAN, coDevIfStaIfIndex=coDevIfStaIfIndex, coDevIfStsTxErrors=coDevIfStsTxErrors, coDevIfStaFriendlyInterfaceName=coDevIfStaFriendlyInterfaceName, colubrisDeviceIfMIBObjects=colubrisDeviceIfMIBObjects, coDevIfFdbAgeing=coDevIfFdbAgeing, coDeviceIfStatusEntry=coDeviceIfStatusEntry, coDevIfFdbMacIndex=coDevIfFdbMacIndex, colubrisDeviceIfMIBGroups=colubrisDeviceIfMIBGroups, coDevIfFdbAuthorized=coDevIfFdbAuthorized, coDevIfStsRxErrors=coDevIfStsRxErrors)
