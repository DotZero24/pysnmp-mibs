...
# Notes
# -----
# ASN.1 source file://mibs/colubris/COLUBRIS-DEVICE-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:29:34 2025
...
colubrisDeviceIfMIBCompliance.setObjects(
      *(("COLUBRIS-DEVICE-IF-MIB", "colubrisDeviceIfStatusMIBGroup"),
        ...
        ("COLUBRIS-DEVICE-IF-MIB", "colubrisDeviceIfFdbMIBGroup"))
)
if mibBuilder.loadTexts:
