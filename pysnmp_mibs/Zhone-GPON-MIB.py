...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/zhone/Zhone-GPON-MIB
...
mibBuilder.exportSymbols("Zhone-GPON-MIB", zhoneGponOltConfigPreambleOverride=zhoneGponOltConfigPreambleOverride, zhoneGponOltStatisticsUpstreamTmQ2DroppedPkts=zhoneGponOltStatisticsUpstreamTmQ2DroppedPkts, zhoneGponOltConfigLoamAlpha=zhoneGponOltConfigLoamAlpha, zhoneGponOltConfiguredOnuCount=zhoneGponOltConfiguredOnuCount, zhoneGponOmciOnuAlarmsText=zhoneGponOmciOnuAlarmsText, zhoneGponOmciOnuImageUpgradeMethod=zhoneGponOmciOnuImageUpgradeMethod, zhoneGponPortConfigRowShelf=zhoneGponPortConfigRowShelf, zhoneGponOmciStatusTable=zhoneGponOmciStatusTable, zhoneGponOltOnuConfigAutoUpgrade=zhoneGponOltOnuConfigAutoUpgrade, zhoneGponOltOnuConfigAutoLearn=zhoneGponOltOnuConfigAutoLearn, zhoneGponOltStatisticsUpstreamPonInvalidPkts=zhoneGponOltStatisticsUpstreamPonInvalidPkts, zhoneOnuOmciImageUpgradeDownloadStatus=zhoneOnuOmciImageUpgradeDownloadStatus, zhoneGponTrapPrefix=zhoneGponTrapPrefix, zhoneOnuOmciGenericProfileRowStatus=zhoneOnuOmciGenericProfileRowStatus, zhoneGponPortConfigRowTrafficProfile=zhoneGponPortConfigRowTrafficProfile, zhoneGponOltDbaTotalOltGemPorts=zhoneGponOltDbaTotalOltGemPorts, zhoneGponUpgradeModel=zhoneGponUpgradeModel, zhoneGponOltStatisticsUpstreamTmQ7DroppedPkts=zhoneGponOltStatisticsUpstreamTmQ7DroppedPkts, zhoneGponUpstreamOntStatisticsGroup=zhoneGponUpstreamOntStatisticsGroup, zhoneGponOltConfigRogueOnuDetection=zhoneGponOltConfigRogueOnuDetection, zhoneGponOltStatisticsUpstreamTmQ5ValidPkts=zhoneGponOltStatisticsUpstreamTmQ5ValidPkts, zhoneGponCmdShelf=zhoneGponCmdShelf, zhoneOnuOmciGenericProfileName=zhoneOnuOmciGenericProfileName, zhoneGponOltOnuConfigUsRxPowerHighThreshold=zhoneGponOltOnuConfigUsRxPowerHighThreshold, zhoneGponTrafficProfileExtraUsBwType=zhoneGponTrafficProfileExtraUsBwType, zhoneGponOltStatisticsDownstreamTmQ3ValidPkts=zhoneGponOltStatisticsDownstreamTmQ3ValidPkts, zhoneGponUpgradeIfIndex=zhoneGponUpgradeIfIndex, zhoneGponOltOpticVoltage=zhoneGponOltOpticVoltage, zhoneGponOltConfigLofAlpha=zhoneGponOltConfigLofAlpha, zhoneGponOltOnuConfigModel=zhoneGponOltOnuConfigModel, zhoneGponOltDbaAllocatedAssuredBw=zhoneGponOltDbaAllocatedAssuredBw, zhoneGponSerialNumberLost=zhoneGponSerialNumberLost, zhoneGponSerialNoOltLgIfIndex=zhoneGponSerialNoOltLgIfIndex, zhoneGponOmciStatsCurrentMEId=zhoneGponOmciStatsCurrentMEId, zhoneGponOltStatusWord=zhoneGponOltStatusWord, zhoneGponOltOnuConfigSnmpDataSync=zhoneGponOltOnuConfigSnmpDataSync, zhoneGponCmdGroup=zhoneGponCmdGroup, zhoneGponPortConfigRowStatus=zhoneGponPortConfigRowStatus, zhoneGponOmciOnuDownloadStatusChange=zhoneGponOmciOnuDownloadStatusChange, zhoneGponOmciOnuPortAdminMEId=zhoneGponOmciOnuPortAdminMEId, zhoneGponOltConfigBerSdThreshold=zhoneGponOltConfigBerSdThreshold, zhoneGponSerialNoVendorSpecific=zhoneGponSerialNoVendorSpecific, zhoneGponUpstreamOntStatisticsDriftOfWindowIndications=zhoneGponUpstreamOntStatisticsDriftOfWindowIndications, zhoneOnuOmciSpecificProfileGroup=zhoneOnuOmciSpecificProfileGroup, zhoneGponOltStatisticsGroup=zhoneGponOltStatisticsGroup, zhoneGponUpgradeByStateWillBeCommitted=zhoneGponUpgradeByStateWillBeCommitted, zhoneGponOnuLineStatusChange=zhoneGponOnuLineStatusChange, zhoneGponTrafficProfileRowStatus=zhoneGponTrafficProfileRowStatus, zhoneOnuOmciGenericProfileGroup=zhoneOnuOmciGenericProfileGroup, zhoneGponTrafficProfileShared=zhoneGponTrafficProfileShared, zhoneGponTrafficProfileClass=zhoneGponTrafficProfileClass, zhoneGponOltStatisticsDownstreamTmQ2DroppedPkts=zhoneGponOltStatisticsDownstreamTmQ2DroppedPkts, zhoneGponPortConfigTable=zhoneGponPortConfigTable, zhoneGponOltOnuConfigTable=zhoneGponOltOnuConfigTable, zhoneGponOltDbaAllocatedNonAssuredBw=zhoneGponOltDbaAllocatedNonAssuredBw, zhoneGponPortIfIndex=zhoneGponPortIfIndex, zhoneGponUpstreamOntStatisticsRemoteBipErrors=zhoneGponUpstreamOntStatisticsRemoteBipErrors, zhoneGponOntRxPower=zhoneGponOntRxPower, zhoneOnuOmciSpecificProfileEntry=zhoneOnuOmciSpecificProfileEntry, zhoneOnuOmciMeProfileGroup=zhoneOnuOmciMeProfileGroup, zhoneGponOmciOnuRebootGroup=zhoneGponOmciOnuRebootGroup, zhoneGponOltDbaAvailDbaAllocIds=zhoneGponOltDbaAvailDbaAllocIds, zhoneGponOltOnuConfigSerialNoVendorSpecificFsan=zhoneGponOltOnuConfigSerialNoVendorSpecificFsan, zhoneGponOltConfigProtectionSwitchoverTimer=zhoneGponOltConfigProtectionSwitchoverTimer, zhoneGponOltConfigUsBerInterval=zhoneGponOltConfigUsBerInterval, zhoneGponOltConfigPowerLevel=zhoneGponOltConfigPowerLevel, zhoneGponOmciStatsCurrentLogicalPort=zhoneGponOmciStatsCurrentLogicalPort, zhoneGponOltOnuConfigGenericProfileName=zhoneGponOltOnuConfigGenericProfileName, zhoneGponOltStatisticsUpstreamTmQ7ValidPkts=zhoneGponOltStatisticsUpstreamTmQ7ValidPkts, zhoneGponOltStatisticsDownstreamPloamFrames=zhoneGponOltStatisticsDownstreamPloamFrames, zhoneGponCmdOnu=zhoneGponCmdOnu, zhoneGponPortConfigRowSlot=zhoneGponPortConfigRowSlot, zhoneGponOltConfigPreambleType1=zhoneGponOltConfigPreambleType1, zhoneGponUpgradeStartTime=zhoneGponUpgradeStartTime, zhoneGponOnuStatusGroup=zhoneGponOnuStatusGroup, zhoneGponUpgradeByStateWillBeActivated=zhoneGponUpgradeByStateWillBeActivated, zhoneGponOltOnuConfigLinkStatusAlarmSeverity=zhoneGponOltOnuConfigLinkStatusAlarmSeverity, zhoneGponUpstreamOntStatisticsBipErrors=zhoneGponUpstreamOntStatisticsBipErrors, zhoneGponTrafficProfileMaxUsBw=zhoneGponTrafficProfileMaxUsBw, zhoneGponOltStatisticsDownstreamTmQ0DroppedPkts=zhoneGponOltStatisticsDownstreamTmQ0DroppedPkts, zhoneGponOltOnuConfigPowerLevel=zhoneGponOltOnuConfigPowerLevel, zhoneGponUpstreamOntStatisticsUnreceivedBursts=zhoneGponUpstreamOntStatisticsUnreceivedBursts, zhoneGponDeprecated=zhoneGponDeprecated, GponCacRc=GponCacRc, zhoneGponOltDbaStatusEntry=zhoneGponOltDbaStatusEntry, zhoneGponOltOnuConfigOmciFileName=zhoneGponOltOnuConfigOmciFileName, zhoneGponOltConfigSrDbaReportingBlockSize=zhoneGponOltConfigSrDbaReportingBlockSize, zhoneGponOmciStatsCurrentTable=zhoneGponOmciStatsCurrentTable, zhoneOnuOmciSpecificProfileFileName=zhoneOnuOmciSpecificProfileFileName, zhoneGponOmciStatsPreviousMEId=zhoneGponOmciStatsPreviousMEId, zhoneGponOltConfigRogueOnuRxPowerThreshold=zhoneGponOltConfigRogueOnuRxPowerThreshold, zhoneOnuOmciSpecificProfileMESrcProfileName=zhoneOnuOmciSpecificProfileMESrcProfileName, zhoneGponRssiRogueOnuTrap=zhoneGponRssiRogueOnuTrap, zhoneGponOltDbaMaxAllocIds=zhoneGponOltDbaMaxAllocIds, zhoneGponOltStatisticsDownstreamPonCpuPkts=zhoneGponOltStatisticsDownstreamPonCpuPkts, zhoneGponOltStatisticsUpstreamDroppedPloamsFifoFull=zhoneGponOltStatisticsUpstreamDroppedPloamsFifoFull, zhoneGponOltStatisticsDownstreamTmQ0ValidPkts=zhoneGponOltStatisticsDownstreamTmQ0ValidPkts, zhoneGponOltOnuConfigNextAvailableGemPort=zhoneGponOltOnuConfigNextAvailableGemPort, zhoneGponOmciStatsPreviousTable=zhoneGponOmciStatsPreviousTable, zhoneGponCmdOperation=zhoneGponCmdOperation, zhoneOnuOmciMEProfileIndex=zhoneOnuOmciMEProfileIndex, zhoneGponOnuOpticRssi=zhoneGponOnuOpticRssi, zhoneGponOltStatisticsUpstreamTmQ6ValidPkts=zhoneGponOltStatisticsUpstreamTmQ6ValidPkts, zhoneGponOltOnuConfigMEProfileName=zhoneGponOltOnuConfigMEProfileName, zhoneGponOltStatisticsUpstreamIdlePloamFrames=zhoneGponOltStatisticsUpstreamIdlePloamFrames, zhoneGponOmciOnuPortAdminEntry=zhoneGponOmciOnuPortAdminEntry, zhoneGponOltDbaUsedDbaAllocIds=zhoneGponOltDbaUsedDbaAllocIds, zhoneGponOltConfigBipErroredSamplesThreshold=zhoneGponOltConfigBipErroredSamplesThreshold, zhoneGponOmciStatusGroup=zhoneGponOmciStatusGroup, zhoneGponOltConfigScrambler=zhoneGponOltConfigScrambler, zhoneGponOmciOnuPortAdminState=zhoneGponOmciOnuPortAdminState, zhoneGponOltDbaStatusTable=zhoneGponOltDbaStatusTable, zhoneGponPortStatusDbaStatus=zhoneGponPortStatusDbaStatus, zhoneGponOltStatisticsUpstreamTmQ0ValidPkts=zhoneGponOltStatisticsUpstreamTmQ0ValidPkts, zhoneGponOltStatisticsUpstreamTmDroppedCpuPkts=zhoneGponOltStatisticsUpstreamTmDroppedCpuPkts, zhoneGponOltStatisticsUpstreamTmQ3DroppedPkts=zhoneGponOltStatisticsUpstreamTmQ3DroppedPkts, zhoneGponOltStatisticsUpstreamTmQ2ValidPkts=zhoneGponOltStatisticsUpstreamTmQ2ValidPkts, zhoneOnuOmciImageUpgradeIsActivatedPartition1=zhoneOnuOmciImageUpgradeIsActivatedPartition1, zhoneGponOltStatisticsDownstreamTmQ6DroppedPkts=zhoneGponOltStatisticsDownstreamTmQ6DroppedPkts, zhoneGponUpstreamOntStatisticsClearStats=zhoneGponUpstreamOntStatisticsClearStats, OnuUpgradeState=OnuUpgradeState, zhoneGponObjectID=zhoneGponObjectID, zhoneOnuOmciImageUpgradeIsCommittedPartition1=zhoneOnuOmciImageUpgradeIsCommittedPartition1, zhoneGponOltConfigPreambleType3Pattern=zhoneGponOltConfigPreambleType3Pattern, zhoneGponOltStatisticsUpstreamDroppedPktsInactivePorts=zhoneGponOltStatisticsUpstreamDroppedPktsInactivePorts, zhoneGponOmciOnuRebootTable=zhoneGponOmciOnuRebootTable, zhoneOnuOmciMEProfileTable=zhoneOnuOmciMEProfileTable, zhoneGponOmciStatsPreviousLogicalPort=zhoneGponOmciStatsPreviousLogicalPort, PYSNMP_MODULE_ID=zhoneGponOltMIB, zhoneGponOltOnuConfigOntVersion=zhoneGponOltOnuConfigOntVersion, zhoneGponOnuStatusEntry=zhoneGponOnuStatusEntry, zhoneGponOltOnuConfigOmciDataSync=zhoneGponOltOnuConfigOmciDataSync, zhoneGponOmciOnuAlarmsTrap=zhoneGponOmciOnuAlarmsTrap, zhoneGponOmciOnuRebootEntry=zhoneGponOmciOnuRebootEntry, zhoneGponOmciStatsPreviousEntry=zhoneGponOmciStatsPreviousEntry, zhoneOnuOmciGenericProfileTable=zhoneOnuOmciGenericProfileTable, zhoneGponOltStatisticsUpstreamTmLearnFailures=zhoneGponOltStatisticsUpstreamTmLearnFailures, zhoneGponOltDbaLastCacRc=zhoneGponOltDbaLastCacRc, zhoneOnuOmciGenericProfileMESrcProfileName=zhoneOnuOmciGenericProfileMESrcProfileName, zhoneGponOltConfigMaxRtPropagationDelay=zhoneGponOltConfigMaxRtPropagationDelay, zhoneGponOltStatisticsUpstreamTmQ1DroppedPkts=zhoneGponOltStatisticsUpstreamTmQ1DroppedPkts, zhoneGponOltConfigRogueOnuDetectFrequency=zhoneGponOltConfigRogueOnuDetectFrequency, zhoneGponOmciStatusEntry=zhoneGponOmciStatusEntry, zhoneGponOltOpticStatus=zhoneGponOltOpticStatus, zhoneGponOltOnuConfigOnuAdded=zhoneGponOltOnuConfigOnuAdded, zhoneGponOmciStatsPreviousText=zhoneGponOmciStatsPreviousText, zhoneGponOltConfigPreambleType3PreRange=zhoneGponOltConfigPreambleType3PreRange, zhoneGponOmciOnuImageUpgradeGroup=zhoneGponOmciOnuImageUpgradeGroup, zhoneGponOmciOnuImageUpgradeTable=zhoneGponOmciOnuImageUpgradeTable, zhoneGponOltOnuConfigUsRxPowerLowThreshold=zhoneGponOltOnuConfigUsRxPowerLowThreshold, zhoneGponOmciOnuImageUpgradePartition=zhoneGponOmciOnuImageUpgradePartition, zhoneOnuOmciImageUpgradeImageVersionPartition0=zhoneOnuOmciImageUpgradeImageVersionPartition0, zhoneGponOltConfigGuardBitCount=zhoneGponOltConfigGuardBitCount, zhoneOnuOmciImageUpgradeIsValidPartition1=zhoneOnuOmciImageUpgradeIsValidPartition1, zhoneGponUpstreamOntStatisticsEntry=zhoneGponUpstreamOntStatisticsEntry, zhoneGponOltStatisticsDownstreamTmCrcPkts=zhoneGponOltStatisticsDownstreamTmCrcPkts, zhoneGponAllocIdIndex=zhoneGponAllocIdIndex, zhoneGponTrafficProfileCompensated=zhoneGponTrafficProfileCompensated, zhoneGponOltStatisticsDownstreamDiscardedFrames=zhoneGponOltStatisticsDownstreamDiscardedFrames, zhoneGponOltStatusWordTrap=zhoneGponOltStatusWordTrap, zhoneOnuOmciMEProfileName=zhoneOnuOmciMEProfileName, zhoneGponAllocIdGuaranteedBw=zhoneGponAllocIdGuaranteedBw, zhoneGponTraps=zhoneGponTraps, zhoneGponOltConfigBerSfThreshold=zhoneGponOltConfigBerSfThreshold, zhoneGponOltConfigGroup=zhoneGponOltConfigGroup, zhoneGponAllocIdTrafficClass=zhoneGponAllocIdTrafficClass, zhoneGponOnuStatusWord=zhoneGponOnuStatusWord, zhoneGponOltDbaAllocatedCompensatedCbrBw=zhoneGponOltDbaAllocatedCompensatedCbrBw, zhoneGponPortConfigDirection=zhoneGponPortConfigDirection, zhoneGponOltDbaTotalAvailableCompensatedCbrBw=zhoneGponOltDbaTotalAvailableCompensatedCbrBw, zhoneGponOltDbaMaxDbaAllocIds=zhoneGponOltDbaMaxDbaAllocIds, zhoneGponOltConfigDriftControlInterval=zhoneGponOltConfigDriftControlInterval, zhoneGponPortConfigMulticast=zhoneGponPortConfigMulticast, zhoneGponOmciOnuImageUpgradeWillBeCommitted=zhoneGponOmciOnuImageUpgradeWillBeCommitted, zhoneGponOltConfigFecRequest=zhoneGponOltConfigFecRequest, zhoneGponOltConfigPreambleType3PostRange=zhoneGponOltConfigPreambleType3PostRange, zhoneGponeOltDbaStatusGroup=zhoneGponeOltDbaStatusGroup, zhoneGponOltConfigBipErrorMonitoring=zhoneGponOltConfigBipErrorMonitoring, zhoneGponOltOnuConfigSerialNoVendorSpecific=zhoneGponOltOnuConfigSerialNoVendorSpecific, zhoneGponOltStatisticsUpstreamTmQ5DroppedPkts=zhoneGponOltStatisticsUpstreamTmQ5DroppedPkts, zhoneGponOnuAutoAssign=zhoneGponOnuAutoAssign, zhoneGponOltConfigLosAlpha=zhoneGponOltConfigLosAlpha, zhoneGponOltStatisticsDownstreamTmQ7DroppedPkts=zhoneGponOltStatisticsDownstreamTmQ7DroppedPkts, zhoneGponUpstreamOntStatisticsFecCorrectedBytes=zhoneGponUpstreamOntStatisticsFecCorrectedBytes, zhoneGponOltStatisticsClearStats=zhoneGponOltStatisticsClearStats, zhoneOnuOmciGenericProfileIndex=zhoneOnuOmciGenericProfileIndex, zhoneGponTrafficProfileEntry=zhoneGponTrafficProfileEntry, zhoneGponUpgradeProgressPercentage=zhoneGponUpgradeProgressPercentage, zhoneGponOltStatusTable=zhoneGponOltStatusTable, zhoneGponOltOnuConfigDsBerInterval=zhoneGponOltOnuConfigDsBerInterval, zhoneGponPortConfigEncrypted=zhoneGponPortConfigEncrypted, zhoneGponTrafficProfileDbaEnabled=zhoneGponTrafficProfileDbaEnabled, zhoneGponOltStatisticsUpstreamOmciFrames=zhoneGponOltStatisticsUpstreamOmciFrames, zhoneGponOltOnuConfigImageVersionStandby=zhoneGponOltOnuConfigImageVersionStandby, zhoneGponOltConfigFecMode=zhoneGponOltConfigFecMode, zhoneGponAllocIdRowStatus=zhoneGponAllocIdRowStatus, zhoneGponOltStatisticsUpstreamTmQ0DroppedPkts=zhoneGponOltStatisticsUpstreamTmQ0DroppedPkts, zhoneOnuOmciImageUpgradeIsActivatedPartition0=zhoneOnuOmciImageUpgradeIsActivatedPartition0, zhoneGponTrafficProfileTable=zhoneGponTrafficProfileTable, zhoneGponOltStatisticsUpstreamPonValidPkts=zhoneGponOltStatisticsUpstreamPonValidPkts, zhoneGponOltStatisticsDownstreamTmMacLookupMiss=zhoneGponOltStatisticsDownstreamTmMacLookupMiss, zhoneGponOltOpticsAlarmsTrap=zhoneGponOltOpticsAlarmsTrap, zhoneGponOmciStatsCurrentText=zhoneGponOmciStatsCurrentText, zhoneGponOltStatusGroup=zhoneGponOltStatusGroup, zhoneGponOltStatisticsDownstreamTmQ4DroppedPkts=zhoneGponOltStatisticsDownstreamTmQ4DroppedPkts, zhoneGponOltStatisticsDownstreamPonValidEthernetPkts=zhoneGponOltStatisticsDownstreamPonValidEthernetPkts, zhoneGponOmciStatusLogicalPort=zhoneGponOmciStatusLogicalPort, zhoneGponCmdFilterMask=zhoneGponCmdFilterMask, zhoneGponOltOnuConfigUsRxPowerMonitoring=zhoneGponOltOnuConfigUsRxPowerMonitoring, zhoneGponOltStatisticsUpstreamTmDroppedPktsCrcError=zhoneGponOltStatisticsUpstreamTmDroppedPktsCrcError, zhoneGponOltStatisticsDownstreamTxBytes=zhoneGponOltStatisticsDownstreamTxBytes, zhoneGponOltStatisticsDownstreamTmDroppedCpuPkts=zhoneGponOltStatisticsDownstreamTmDroppedCpuPkts, zhoneGponOltOnuConfigAutoConfigState=zhoneGponOltOnuConfigAutoConfigState, zhoneOnuOmciSpecificProfileIndex=zhoneOnuOmciSpecificProfileIndex, zhoneGponOltStatisticsTable=zhoneGponOltStatisticsTable, zhoneGponOltStatisticsUpstreamDiscardedFrames=zhoneGponOltStatisticsUpstreamDiscardedFrames, zhoneGponUpstreamOntStatisticsFecUncorrectedCodewords=zhoneGponUpstreamOntStatisticsFecUncorrectedCodewords, zhoneGponOltConfigDbaCycle=zhoneGponOltConfigDbaCycle, zhoneGponOltStatisticsDownstreamTmQ5ValidPkts=zhoneGponOltStatisticsDownstreamTmQ5ValidPkts, zhoneGponOltDbaAllocatedCbrBw=zhoneGponOltDbaAllocatedCbrBw, zhoneGponSerialNoEntry=zhoneGponSerialNoEntry, zhoneGponOmciOnuImageDownloadProgressPercentage=zhoneGponOmciOnuImageDownloadProgressPercentage, zhoneGponOltConfigDriftControlLimit=zhoneGponOltConfigDriftControlLimit, zhoneGponTrafficProfileIndex=zhoneGponTrafficProfileIndex, zhoneGponTrafficProfileDbaFixedUsCbrBw=zhoneGponTrafficProfileDbaFixedUsCbrBw, zhoneGponOltConfigAutoLearn=zhoneGponOltConfigAutoLearn, zhoneGponPortConfigRowOnuId=zhoneGponPortConfigRowOnuId, zhoneGponOltDbaTotalAvailableBw=zhoneGponOltDbaTotalAvailableBw, zhoneGponOltStatisticsUpstreamTmDroppedPktsSecurity=zhoneGponOltStatisticsUpstreamTmDroppedPktsSecurity, zhoneGponOmciOnuAlarmsGroup=zhoneGponOmciOnuAlarmsGroup, zhoneGponOltConfigMinOnuResponseTime=zhoneGponOltConfigMinOnuResponseTime, zhoneGponOltConfigPreambleType0=zhoneGponOltConfigPreambleType0, zhoneGponOltConfigTable=zhoneGponOltConfigTable, zhoneGponOltOnuConfigUsBerInterval=zhoneGponOltOnuConfigUsBerInterval, zhoneGponOltConfigGemBlockSize=zhoneGponOltConfigGemBlockSize, zhoneGponOltDbaAllocatedBestEffortBw=zhoneGponOltDbaAllocatedBestEffortBw, zhoneGponOltStatisticsUpstreamTmQ3ValidPkts=zhoneGponOltStatisticsUpstreamTmQ3ValidPkts, zhoneGponOltDbaAvailAllocIds=zhoneGponOltDbaAvailAllocIds, zhoneGponOltConfigKeyExchange=zhoneGponOltConfigKeyExchange, zhoneGponOltStatisticsUpstreamPonErrorPloams=zhoneGponOltStatisticsUpstreamPonErrorPloams, zhoneGponOmciOnuPortAdminLogicalPort=zhoneGponOmciOnuPortAdminLogicalPort, zhoneGponOltOnuConfigPassword=zhoneGponOltOnuConfigPassword, zhoneGponUpstreamOntStatisticsFecCorrectedCodewords=zhoneGponUpstreamOntStatisticsFecCorrectedCodewords, zhoneGponOltActiveOnuCount=zhoneGponOltActiveOnuCount, zhoneGponOltOnuConfigSerialNoVendorId=zhoneGponOltOnuConfigSerialNoVendorId, zhoneGponOltConfigAckTimeout=zhoneGponOltConfigAckTimeout, zhoneGponOltOpticAlarms=zhoneGponOltOpticAlarms, zhoneGponPortConfigTrafficProfile=zhoneGponPortConfigTrafficProfile, zhoneGponOltOpticTxPower=zhoneGponOltOpticTxPower, zhoneGponOltStatisticsUpstreamPloamFrames=zhoneGponOltStatisticsUpstreamPloamFrames, zhoneGponOltStatisticsDownstreamTmValidPkts=zhoneGponOltStatisticsDownstreamTmValidPkts, zhoneGponSerialNumberFound=zhoneGponSerialNumberFound, zhoneGponOmciOnuPortAdminTable=zhoneGponOmciOnuPortAdminTable, zhoneGponOmciOnuPortAdminAutoDetect=zhoneGponOmciOnuPortAdminAutoDetect)
mibBuilder.exportSymbols("Zhone-GPON-MIB", zhoneGponTrafficProfileDbaFixedUsUbrBw=zhoneGponTrafficProfileDbaFixedUsUbrBw, zhoneGponOltOpticTxBiasCurrent=zhoneGponOltOpticTxBiasCurrent, zhoneGponPortConfigRowPort=zhoneGponPortConfigRowPort, zhoneGponOmciOnuImageUpgradeStartTime=zhoneGponOmciOnuImageUpgradeStartTime, zhoneGponSerialNoTable=zhoneGponSerialNoTable, zhoneGponOltConfigDsBerInterval=zhoneGponOltConfigDsBerInterval, zhoneGponOltDbaAllocatedUbrBw=zhoneGponOltDbaAllocatedUbrBw, zhoneGponAllocIdOnuId=zhoneGponAllocIdOnuId, zhoneGponOltIfIndex=zhoneGponOltIfIndex, zhoneGponOltOnuConfigImageVersionActive=zhoneGponOltOnuConfigImageVersionActive, zhoneGponOltStatisticsDownstreamValidGemFrames=zhoneGponOltStatisticsDownstreamValidGemFrames, zhoneGponOltOnuConfigDbaStatusReporting=zhoneGponOltOnuConfigDbaStatusReporting, zhoneGponPortStatusAllocId=zhoneGponPortStatusAllocId, zhoneGponCmd=zhoneGponCmd, zhoneGponUpgradeByStateUpgradeType=zhoneGponUpgradeByStateUpgradeType, zhoneGponOmciOnuPortAdminGroup=zhoneGponOmciOnuPortAdminGroup, zhoneGponOltStatisticsUpstreamGemFrames=zhoneGponOltStatisticsUpstreamGemFrames, zhoneGponOmciOnuImageUpgradeWillBeActivated=zhoneGponOmciOnuImageUpgradeWillBeActivated, zhoneGponOmciOnuReboot=zhoneGponOmciOnuReboot, zhoneGponOltConfigAllocCycleLength=zhoneGponOltConfigAllocCycleLength, zhoneOnuOmciMEProfileEntry=zhoneOnuOmciMEProfileEntry, zhoneGponOnuOmciState=zhoneGponOnuOmciState, zhoneGponCmdSlot=zhoneGponCmdSlot, zhoneGponOltConfigPlsMaxAllocSize=zhoneGponOltConfigPlsMaxAllocSize, zhoneGponPortConfigEntry=zhoneGponPortConfigEntry, zhoneGponOltStatisticsDownstreamTmQ1ValidPkts=zhoneGponOltStatisticsDownstreamTmQ1ValidPkts, zhoneOnuOmciGenericProfileOmciCommands=zhoneOnuOmciGenericProfileOmciCommands, zhoneGponAllocIdEntry=zhoneGponAllocIdEntry, zhoneGponSerialNoTimeStamp=zhoneGponSerialNoTimeStamp, zhoneGponOmciStatusText=zhoneGponOmciStatusText, zhoneGponOntVersion=zhoneGponOntVersion, zhoneGponOltStatisticsDownstreamTmQ5DroppedPkts=zhoneGponOltStatisticsDownstreamTmQ5DroppedPkts, zhoneGponOnuStatusTable=zhoneGponOnuStatusTable, zhoneGponOltConfigDbaMode=zhoneGponOltConfigDbaMode, zhoneGponOmciOnuAlarmsTable=zhoneGponOmciOnuAlarmsTable, zhoneGponUpstreamOntStatisticsTable=zhoneGponUpstreamOntStatisticsTable, zhoneGponOltConfigEqDMeasureCycles=zhoneGponOltConfigEqDMeasureCycles, zhoneGponOltStatisticsEntry=zhoneGponOltStatisticsEntry, zhoneGponOmciOnuImageUpgradeAction=zhoneGponOmciOnuImageUpgradeAction, zhoneGponOltStatisticsUpstreamValidGemFrames=zhoneGponOltStatisticsUpstreamValidGemFrames, zhoneGponOmciStatusMEId=zhoneGponOmciStatusMEId, zhoneOnuOmciMEProfileOmciCommands=zhoneOnuOmciMEProfileOmciCommands, zhoneGponPortConfigTrafficManagementProfileIndex=zhoneGponPortConfigTrafficManagementProfileIndex, zhoneGponOltStatisticsDownstreamTmQ1DroppedPkts=zhoneGponOltStatisticsDownstreamTmQ1DroppedPkts, zhoneGponUpgradeByStatePartition=zhoneGponUpgradeByStatePartition, zhoneGponTrafficProfileDbaAssuredUsBw=zhoneGponTrafficProfileDbaAssuredUsBw, zhoneGponOltStatisticsDownstreamOmciFrames=zhoneGponOltStatisticsDownstreamOmciFrames, zhoneGponOnuDistance=zhoneGponOnuDistance, zhoneGponTrafficProfileGuaranteedUpstreamBw=zhoneGponTrafficProfileGuaranteedUpstreamBw, zhoneOnuOmciImageUpgradeImageVersionPartition1=zhoneOnuOmciImageUpgradeImageVersionPartition1, zhoneOnuOmciGenericProfileEntry=zhoneOnuOmciGenericProfileEntry, zhoneGponOltConfigBipMaxSampleGap=zhoneGponOltConfigBipMaxSampleGap, zhoneGponOltStatisticsDownstreamTmQ2ValidPkts=zhoneGponOltStatisticsDownstreamTmQ2ValidPkts, zhoneGponOltConfigBipErrorsPerSampleThreshold=zhoneGponOltConfigBipErrorsPerSampleThreshold, zhoneGponOmciOnuAlarmsEntry=zhoneGponOmciOnuAlarmsEntry, zhoneGponUpstreamOntStatisticsTotalRxCodewords=zhoneGponUpstreamOntStatisticsTotalRxCodewords, zhoneGponOltStatisticsUpstreamPonValidNotIdlePloams=zhoneGponOltStatisticsUpstreamPonValidNotIdlePloams, zhoneOnuOmciSpecificProfileTable=zhoneOnuOmciSpecificProfileTable, zhoneOnuOmciImageUpgradeFilename=zhoneOnuOmciImageUpgradeFilename, zhoneGponOltStatisticsDownstreamTmQ4ValidPkts=zhoneGponOltStatisticsDownstreamTmQ4ValidPkts, zhoneGponOnuConfigGroup=zhoneGponOnuConfigGroup, zhoneGponOltStatisticsDownstreamTmPktsForwardedFromHmToPon=zhoneGponOltStatisticsDownstreamTmPktsForwardedFromHmToPon, zhoneGponPortStatusEntry=zhoneGponPortStatusEntry, zhoneGponOltOpticTemperature=zhoneGponOltOpticTemperature, zhoneGponOltOnuConfigUseRegId=zhoneGponOltOnuConfigUseRegId, zhoneGponOltConfigMinUsAlloc=zhoneGponOltConfigMinUsAlloc, zhoneOnuOmciSpecificProfileRowStatus=zhoneOnuOmciSpecificProfileRowStatus, zhoneGponUpgradeByStateMethod=zhoneGponUpgradeByStateMethod, zhoneGponPortConfigRowOlt=zhoneGponPortConfigRowOlt, zhoneGponOltStatusEntry=zhoneGponOltStatusEntry, zhoneOnuOmciMEProfileFileName=zhoneOnuOmciMEProfileFileName, zhoneGponOltDbaUsedAllocIds=zhoneGponOltDbaUsedAllocIds, zhoneGponCmdOlt=zhoneGponCmdOlt, zhoneGponOmciOnuImageUpgradeType=zhoneGponOmciOnuImageUpgradeType, zhoneGponOltConfigMinRtPropagationDelay=zhoneGponOltConfigMinRtPropagationDelay, zhoneGponOltOnuConfigLineStatusTraps=zhoneGponOltOnuConfigLineStatusTraps, zhoneGponAllocIdTable=zhoneGponAllocIdTable, zhoneGponOltStatisticsUpstreamTmQ4DroppedPkts=zhoneGponOltStatisticsUpstreamTmQ4DroppedPkts, zhoneGponUpgradeByStateOnuState=zhoneGponUpgradeByStateOnuState, zhoneOnuOmciMEProfileRowStatus=zhoneOnuOmciMEProfileRowStatus, zhoneGponOltStatisticsUpstreamTmQ1ValidPkts=zhoneGponOltStatisticsUpstreamTmQ1ValidPkts, zhoneGponOltStatisticsDownstreamGemFrames=zhoneGponOltStatisticsDownstreamGemFrames, zhoneGponSerialNoGroup=zhoneGponSerialNoGroup, zhoneGponSerialNoVendorId=zhoneGponSerialNoVendorId, zhoneGponAllocIdGroup=zhoneGponAllocIdGroup, zhoneGponOltOnuConfigOntTraps=zhoneGponOltOnuConfigOntTraps, zhoneOnuOmciImageUpgradeIsValidPartition0=zhoneOnuOmciImageUpgradeIsValidPartition0, zhoneGponOltConfigEntry=zhoneGponOltConfigEntry, zhoneGponOmciStatsCurrentEntry=zhoneGponOmciStatsCurrentEntry, zhoneGponOmciOnuImageUpgradeModel=zhoneGponOmciOnuImageUpgradeModel, zhoneGponOltStatisticsUpstreamTmQ4ValidPkts=zhoneGponOltStatisticsUpstreamTmQ4ValidPkts, zhoneGponUpstreamOntStatisticsUpstreamBipErrors=zhoneGponUpstreamOntStatisticsUpstreamBipErrors, zhoneGponOltStatisticsDownstreamTmQ3DroppedPkts=zhoneGponOltStatisticsDownstreamTmQ3DroppedPkts, zhoneGponUpgradeByStateTable=zhoneGponUpgradeByStateTable, zhoneGponOltMIB=zhoneGponOltMIB, zhoneGponOltStatisticsUpstreamTmQ6DroppedPkts=zhoneGponOltStatisticsUpstreamTmQ6DroppedPkts, zhoneGponRogueOnuTrap=zhoneGponRogueOnuTrap, zhoneGponPortConfigGroup=zhoneGponPortConfigGroup, zhoneGponOltStatisticsDownstreamTmPktsDroppedGemPidNotEnabled=zhoneGponOltStatisticsDownstreamTmPktsDroppedGemPidNotEnabled, zhoneGponOltOnuIfIndex=zhoneGponOltOnuIfIndex, zhoneOnuOmciImageUpgradeIsCommittedPartition0=zhoneOnuOmciImageUpgradeIsCommittedPartition0, zhoneGponOmciOnuImageUpgradeEntry=zhoneGponOmciOnuImageUpgradeEntry, zhoneGponOltStatisticsDownstreamIdlePloamFrames=zhoneGponOltStatisticsDownstreamIdlePloamFrames, zhoneGponTrafficProfileGroup=zhoneGponTrafficProfileGroup, zhoneGponOltConfigMaxOnuResponseTime=zhoneGponOltConfigMaxOnuResponseTime, zhoneGponTrapGroup=zhoneGponTrapGroup, zhoneGponOltConfigPreassignedEqD=zhoneGponOltConfigPreassignedEqD, zhoneGponPortStatusTable=zhoneGponPortStatusTable, zhoneGponAllocIdCompensated=zhoneGponAllocIdCompensated, zhoneGponUpgradeByStateEntry=zhoneGponUpgradeByStateEntry, zhoneGponUpgradeOnu=zhoneGponUpgradeOnu, zhoneGponOltStatisticsDownstreamTmQ6ValidPkts=zhoneGponOltStatisticsDownstreamTmQ6ValidPkts, zhoneGponUpstreamOntStatisticsMessageErrorMessage=zhoneGponUpstreamOntStatisticsMessageErrorMessage, zhoneOnuOmciGenericProfileFileName=zhoneOnuOmciGenericProfileFileName, zhoneGponOltOnuConfigPhysicalTraps=zhoneGponOltOnuConfigPhysicalTraps, zhoneGponSerialNoIndexId=zhoneGponSerialNoIndexId, zhoneGponOnuError=zhoneGponOnuError, zhoneOnuOmciSpecificProfileOmciCommands=zhoneOnuOmciSpecificProfileOmciCommands, zhoneGponPortStatusGroup=zhoneGponPortStatusGroup, zhoneGponOltOnuConfigEntry=zhoneGponOltOnuConfigEntry, zhoneGponOltStatisticsDownstreamTmQ7ValidPkts=zhoneGponOltStatisticsDownstreamTmQ7ValidPkts, zhoneGponUpgradeOlt=zhoneGponUpgradeOlt)
