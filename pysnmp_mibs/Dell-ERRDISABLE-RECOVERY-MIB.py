...
_F='Dell-ERRDISABLE-RECOVERY-MIB'
_E='read-write'
_D='Integer32'
_C='ifIndex'
_B='IF-MIB'
...
class RlErrdisableRecoveryCauseType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*(('loopback-detection',1),('port-security',2),('dot1x-src-address',3),('acl-deny',4),('stp-bpdu-guard',5),('stp-loopback-guard',6),('pcb-overheat',7),('udld',8)))
