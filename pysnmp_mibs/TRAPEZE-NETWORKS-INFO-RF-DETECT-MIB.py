...
# Notes
# -----
# ASN.1 source file://mibs/trapeze/TRAPEZE-NETWORKS-INFO-RF-DETECT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:05:13 2025
...
trpzInfoRFDetectCompliance.setObjects(
      *(("TRAPEZE-NETWORKS-INFO-RF-DETECT-MIB", "trpzInfoRFDetectXmtrGroup"),
        ("TRAPEZE-NETWORKS-INFO-RF-DETECT-MIB", "trpzInfoRFDetectXmtrClassificationGroup"),
...
trpzInfoRFDetectComplianceRev2.setObjects(
      *(("TRAPEZE-NETWORKS-INFO-RF-DETECT-MIB", "trpzInfoRFDetectXmtrGroup"),
        ("TRAPEZE-NETWORKS-INFO-RF-DETECT-MIB", "trpzInfoRFDetectXmtrClassificationGroup"),
        ("TRAPEZE-NETWORKS-INFO-RF-DETECT-MIB", "trpzInfoRFDetectCurrentXmtrTableSizeGroup"),
        ("TRAPEZE-NETWORKS-INFO-RF-DETECT-MIB", "trpzInfoRFDetectClientGroup"))
)
if mibBuilder.loadTexts:
