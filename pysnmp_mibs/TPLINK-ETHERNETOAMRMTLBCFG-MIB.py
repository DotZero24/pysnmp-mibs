...
mibBuilder.exportSymbols("TPLINK-ETHERNETOAMRMTLBCFG-MIB", ethernetOamRmtLbCfgReceivedRemoteLoopback=ethernetOamRmtLbCfgReceivedRemoteLoopback, ethernetOamRmtLbCfgTable=ethernetOamRmtLbCfgTable, ethernetOamRmtLbCfgLAG=ethernetOamRmtLbCfgLAG, ethernetOamRmtLbCfgRemoteLoopback=ethernetOamRmtLbCfgRemoteLoopback, ethernetOamRmtLbCfgEntry=ethernetOamRmtLbCfgEntry, ethernetOamRmtLbCfgPort=ethernetOamRmtLbCfgPort)
