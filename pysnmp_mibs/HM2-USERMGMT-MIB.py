...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-USERMGMT-MIB
...
_Hm2UserAccessRole_Type.__name__ = "Hm2UserAccessRoles"
...
_Hm2UserLockoutStatus_Type.__name__ = "TruthValue"
...
_Hm2UserPwdChangePerm_Type.__name__ = "TruthValue"
...
_Hm2UserPwdPolicyChk_Type.__name__ = "HmEnabledStatus"
...
class _Hm2UserSnmpAuthPassword_Type(DisplayString):
    """Custom type hm2UserSnmpAuthPassword based on DisplayString"""
    defaultValue = OctetString("")
...
_Hm2UserSnmpAuthPassword_Type.__name__ = "DisplayString"
_Hm2UserSnmpAuthPassword_Object = MibTableColumn
hm2UserSnmpAuthPassword = _Hm2UserSnmpAuthPassword_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 24, 1, 1, 1, 1, 10),
    _Hm2UserSnmpAuthPassword_Type()
)
hm2UserSnmpAuthPassword.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hm2UserSnmpAuthPassword.setStatus("current")


class _Hm2UserSnmpEncPassword_Type(DisplayString):
    """Custom type hm2UserSnmpEncPassword based on DisplayString"""
    defaultValue = OctetString("")
...
_Hm2UserSnmpEncPassword_Type.__name__ = "DisplayString"
_Hm2UserSnmpEncPassword_Object = MibTableColumn
hm2UserSnmpEncPassword = _Hm2UserSnmpEncPassword_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 24, 1, 1, 1, 1, 11),
    _Hm2UserSnmpEncPassword_Type()
)
hm2UserSnmpEncPassword.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hm2UserSnmpEncPassword.setStatus("current")
...
class _Hm2UserForcePasswordStatus_Type(HmEnabledStatus):
    """Custom type hm2UserForcePasswordStatus based on HmEnabledStatus"""
    defaultValue = 1


_Hm2UserForcePasswordStatus_Type.__name__ = "HmEnabledStatus"
_Hm2UserForcePasswordStatus_Object = MibScalar
hm2UserForcePasswordStatus = _Hm2UserForcePasswordStatus_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 24, 1, 1, 10, 3),
    _Hm2UserForcePasswordStatus_Type()
)
hm2UserForcePasswordStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2UserForcePasswordStatus.setStatus("current")
...
_Hm2UserCustomCliBaseAccessRole_Type.__name__ = "Hm2UserAccessRoles"
...
class _Hm2PwdMgmtLoginAttemptsTimePeriod_Type(Integer32):
    """Custom type hm2PwdMgmtLoginAttemptsTimePeriod based on Integer32"""
    defaultValue = 0
...
_Hm2PwdMgmtLoginAttemptsTimePeriod_Type.__name__ = "Integer32"
_Hm2PwdMgmtLoginAttemptsTimePeriod_Object = MibScalar
hm2PwdMgmtLoginAttemptsTimePeriod = _Hm2PwdMgmtLoginAttemptsTimePeriod_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 24, 1, 2, 7),
    _Hm2PwdMgmtLoginAttemptsTimePeriod_Type()
)
hm2PwdMgmtLoginAttemptsTimePeriod.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2PwdMgmtLoginAttemptsTimePeriod.setStatus("current")
...
_Hm2UserAuthListPolicy1_Type.__name__ = "Hm2UserAuthList"
...
_Hm2UserAuthListPolicy2_Type.__name__ = "Hm2UserAuthList"
...
_Hm2UserAuthListPolicy3_Type.__name__ = "Hm2UserAuthList"
...
_Hm2UserAuthListPolicy4_Type.__name__ = "Hm2UserAuthList"
...
_Hm2UserAuthListPolicy5_Type.__name__ = "Hm2UserAuthList"
...
hm2UserMgmtUserSESActivateExisting = _Hm2UserMgmtUserSESActivateExisting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 24, 3, 2, 3)
)
if mibBuilder.loadTexts:
    hm2UserMgmtUserSESActivateExisting.setStatus("current")
...
hm2UserMgmtApplSESAuthDeactivated = _Hm2UserMgmtApplSESAuthDeactivated_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 24, 3, 3, 3)
)
if mibBuilder.loadTexts:
    hm2UserMgmtApplSESAuthDeactivated.setStatus("current")
...
hm2UserPwdChangedSnmpv3AuthTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 248, 11, 24, 0, 6)
)
hm2UserPwdChangedSnmpv3AuthTrap.setObjects(
    ("HM2-USERMGMT-MIB", "hm2UserName")
)
if mibBuilder.loadTexts:
    hm2UserPwdChangedSnmpv3AuthTrap.setStatus(
        "current"
    )

hm2UserPwdChangedSnmpv3EncTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 248, 11, 24, 0, 7)
)
hm2UserPwdChangedSnmpv3EncTrap.setObjects(
    ("HM2-USERMGMT-MIB", "hm2UserName")
)
if mibBuilder.loadTexts:
    hm2UserPwdChangedSnmpv3EncTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"Hm2UserAccessRoles": Hm2UserAccessRoles,
       ...
       "hm2UserPwdChangedSnmpv3AuthTrap": hm2UserPwdChangedSnmpv3AuthTrap,
       "hm2UserPwdChangedSnmpv3EncTrap": hm2UserPwdChangedSnmpv3EncTrap,
       ...
       "hm2UserSnmpAuthPassword": hm2UserSnmpAuthPassword,
       "hm2UserSnmpEncPassword": hm2UserSnmpEncPassword,
       ...
       "hm2UserForcePasswordStatus": hm2UserForcePasswordStatus,
       ...
       "hm2PwdMgmtLoginAttemptsTimePeriod": hm2PwdMgmtLoginAttemptsTimePeriod,
       ...
       "hm2UserMgmtUserSESActivateExisting": hm2UserMgmtUserSESActivateExisting,
       ...
       "hm2UserMgmtApplSESAuthDeactivated": hm2UserMgmtApplSESAuthDeactivated,
