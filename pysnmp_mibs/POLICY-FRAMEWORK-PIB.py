...
# Notes
# -----
# ASN.1 source file://mibs/nortel/POLICY-FRAMEWORK-PIB
...
policyBasePibCompliance.setObjects(
      *(("POLICY-FRAMEWORK-PIB", "policyPrcSupportGroup"),
        ("POLICY-FRAMEWORK-PIB", "policyPibIncarnationGroup"),
        ("POLICY-FRAMEWORK-PIB", "policyDeviceIdentificationGroup"),
        ("POLICY-FRAMEWORK-PIB", "policyCompLimitsGroup"))
)
if mibBuilder.loadTexts:
