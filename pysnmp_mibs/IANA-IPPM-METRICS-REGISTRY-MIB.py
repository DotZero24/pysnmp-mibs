...
mibBuilder.exportSymbols("IANA-IPPM-METRICS-REGISTRY-MIB", ietfOneWayPdvRefminMean=ietfOneWayPdvRefminMean, ietfOneToGroupPacketLossVector=ietfOneToGroupPacketLossVector, ietfOneWayIpdvPercentile=ietfOneWayIpdvPercentile, ietfOneWayPktLossPoissonStream=ietfOneWayPktLossPoissonStream, ietfReorderingGapTime=ietfReorderingGapTime, ietfOneToGroupDelayVector=ietfOneToGroupDelayVector, ietfFiniteOneWayDelayMinimum=ietfFiniteOneWayDelayMinimum, ietfOneWayLossDistanceStream=ietfOneWayLossDistanceStream, ietfOneWayReplicatedPacketRate=ietfOneWayReplicatedPacketRate, ietfSpatialPacketLossVector=ietfSpatialPacketLossVector, ietfOneWayLossPeriodLengths=ietfOneWayLossPeriodLengths, ietfOneWayDelayInversePercentile=ietfOneWayDelayInversePercentile, ietfReorderingGap=ietfReorderingGap, ietfRoundTripDelay=ietfRoundTripDelay, ietfOneWayPdvRefminSkewness=ietfOneWayPdvRefminSkewness, ietfOneWayPeakToPeakIpdv=ietfOneWayPeakToPeakIpdv, ietfFiniteOneWayDelayStream=ietfFiniteOneWayDelayStream, ietfReorderingByteOffset=ietfReorderingByteOffset, ietfReorderingLateTimeOffset=ietfReorderingLateTimeOffset, ietfSegmentPacketLossStream=ietfSegmentPacketLossStream, ietfOneWayIpdv=ietfOneWayIpdv, ietfReorderingExtent=ietfReorderingExtent, ietfIntervalBidirConnectivity=ietfIntervalBidirConnectivity, ietfOneToGroupRangeMeanDelay=ietfOneToGroupRangeMeanDelay, ietfOneWayLossNoticeableRate=ietfOneWayLossNoticeableRate, ietfReorderedPacketRatio=ietfReorderedPacketRatio, ietfOneWayDelayPoissonStream=ietfOneWayDelayPoissonStream, ietfFiniteOneWayDelayMean=ietfFiniteOneWayDelayMean, ietfCompositeOneWayPktLossEmpiricProb=ietfCompositeOneWayPktLossEmpiricProb, ietfOneWayPacketArrivalCount=ietfOneWayPacketArrivalCount, ietfReorderingFreeRunq=ietfReorderingFreeRunq, ietfOneWayDelay=ietfOneWayDelay, ietfOneToGroupMaxMeanDelay=ietfOneToGroupMaxMeanDelay, ietfOneWayDelayMedian=ietfOneWayDelayMedian, ietfIntervalUnidirConnectivity=ietfIntervalUnidirConnectivity, ietfOneWayPacketDuplicationPoissonStream=ietfOneWayPacketDuplicationPoissonStream, ietfRoundTripDelayInvPercentile=ietfRoundTripDelayInvPercentile, ietfInstantUnidirConnectivity=ietfInstantUnidirConnectivity, ietfOneWayPacketDuplication=ietfOneWayPacketDuplication, ietfOneWayDelayPeriodicStream=ietfOneWayDelayPeriodicStream, PYSNMP_MODULE_ID=ianaIppmMetricsRegistry, ietfOneToGroupIpdvVector=ietfOneToGroupIpdvVector, ietfRoundTripDelayPercentile=ietfRoundTripDelayPercentile, ietfRoundTripDelayMinimum=ietfRoundTripDelayMinimum, ietfOneToGroupRangeDelayVariation=ietfOneToGroupRangeDelayVariation, ietfSpatialOneWayIpdvVector=ietfSpatialOneWayIpdvVector, ietfReorderingFreeRuna=ietfReorderingFreeRuna, ietfCompositeOneWayDelayMinimum=ietfCompositeOneWayDelayMinimum, ietfOneWayDelayPercentile=ietfOneWayDelayPercentile, ietfOneToGroupReceiverNCompLossRatio=ietfOneToGroupReceiverNCompLossRatio, ietfOneWayIpdvPoissonStream=ietfOneWayIpdvPoissonStream, ietfOneWayIpdvJitter=ietfOneWayIpdvJitter, ietfReorderedSingleton=ietfReorderedSingleton, ietfRoundTripDelayMedian=ietfRoundTripDelayMedian, ietfSpatialOneWayDelayVector=ietfSpatialOneWayDelayVector, ietfSegmentOneWayDelayStream=ietfSegmentOneWayDelayStream, ianaIppmMetrics=ianaIppmMetrics, ietfRoundTripDelayPoissonStream=ietfRoundTripDelayPoissonStream, ietfReorderingFreeRunx=ietfReorderingFreeRunx, ietfReorderingFreeRunp=ietfReorderingFreeRunp, ietfOneWayIpdvInversePercentile=ietfOneWayIpdvInversePercentile, ietfOneWayPacketDuplicationPeriodicStream=ietfOneWayPacketDuplicationPeriodicStream, ietfOneToGroupLossRatio=ietfOneToGroupLossRatio, ietfInstantBidirConnectivity=ietfInstantBidirConnectivity, ietfOnetoGroupReceiverNMeanDelay=ietfOnetoGroupReceiverNMeanDelay, ietfOneWayPktLossAverage=ietfOneWayPktLossAverage, ietfOneToGroupRangeLossRatio=ietfOneToGroupRangeLossRatio, ietfnReordering=ietfnReordering, ietfOneWayPdvRefminStream=ietfOneWayPdvRefminStream, ietfCompositeOneWayPdvRefminQtil=ietfCompositeOneWayPdvRefminQtil, ietfOneWayPktLossEmpiricProb=ietfOneWayPktLossEmpiricProb, ietfOneWayInterLossPeriodLengths=ietfOneWayInterLossPeriodLengths, ietfOneToGroupReceiverNLossRatio=ietfOneToGroupReceiverNLossRatio, ietfCompositeOneWayPdvRefminNPA=ietfCompositeOneWayPdvRefminNPA, ietfIntervalTemporalConnectivity=ietfIntervalTemporalConnectivity, ietfOneWayDelayMinimum=ietfOneWayDelayMinimum, ietfOneWayPktLoss=ietfOneWayPktLoss, ietfCompositeOneWayDelayMean=ietfCompositeOneWayDelayMean, ietfOneToGroupMeanDelay=ietfOneToGroupMeanDelay, ietfOneWayPdvRefminVariance=ietfOneWayPdvRefminVariance, ietfOneWayLossPeriodTotal=ietfOneWayLossPeriodTotal, ianaIppmMetricsRegistry=ianaIppmMetricsRegistry, ietfSegmentIpdvMinStream=ietfSegmentIpdvMinStream, ietfSegmentIpdvPrevStream=ietfSegmentIpdvPrevStream, ietfOneWayPacketDuplicationFraction=ietfOneWayPacketDuplicationFraction, ietfOneWayLossPeriodStream=ietfOneWayLossPeriodStream)
