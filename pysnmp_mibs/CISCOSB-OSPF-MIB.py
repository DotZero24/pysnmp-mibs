# SNMP MIB module (CISCOSB-OSPF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-OSPF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:41:53 2025
...
class RlOspfAdminAuthenticationType(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
rlOspfGeneralGroupEntry = _RlOspfGeneralGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1)
)
rlOspfGeneralGroupEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfProcessId"),
)
if mibBuilder.loadTexts:
...
rlOspfProcessId = _RlOspfProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 1),
...
rlOspfRouterId = _RlOspfRouterId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 2),
...
rlOspfAdminStat = _RlOspfAdminStat_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 3),
...
rlOspfVersionNumber = _RlOspfVersionNumber_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 4),
...
rlOspfAreaBdrRtrStatus = _RlOspfAreaBdrRtrStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 5),
...
rlOspfASBdrRtrStatus = _RlOspfASBdrRtrStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 6),
...
rlOspfExternLsaCount = _RlOspfExternLsaCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 7),
...
rlOspfExternLsaCksumSum = _RlOspfExternLsaCksumSum_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 8),
...
rlOspfTOSSupport = _RlOspfTOSSupport_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 9),
...
rlOspfOriginateNewLsas = _RlOspfOriginateNewLsas_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 10),
...
rlOspfRxNewLsas = _RlOspfRxNewLsas_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 11),
...
rlOspfExtLsdbLimit = _RlOspfExtLsdbLimit_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 12),
...
rlOspfDemandExtensions = _RlOspfDemandExtensions_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 15),
...
rlOspfRFC1583Compatibility = _RlOspfRFC1583Compatibility_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 16),
...
rlOspfOpaqueLsaSupport = _RlOspfOpaqueLsaSupport_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 17),
...
rlOspfReferenceBandwidth = _RlOspfReferenceBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 18),
...
rlOspfRestartSupport = _RlOspfRestartSupport_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 19),
...
rlOspfRestartInterval = _RlOspfRestartInterval_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 20),
...
rlOspfRestartStrictLsaChecking = _RlOspfRestartStrictLsaChecking_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 21),
...
rlOspfRestartStatus = _RlOspfRestartStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 22),
...
rlOspfRestartAge = _RlOspfRestartAge_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 23),
...
rlOspfRestartExitReason = _RlOspfRestartExitReason_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 24),
...
rlOspfAsLsaCount = _RlOspfAsLsaCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 25),
...
rlOspfAsLsaCksumSum = _RlOspfAsLsaCksumSum_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 26),
...
rlOspfStubRouterSupport = _RlOspfStubRouterSupport_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 27),
...
rlOspfStubRouterAdvertisement = _RlOspfStubRouterAdvertisement_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 28),
...
rlOspfDiscontinuityTime = _RlOspfDiscontinuityTime_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 29),
...
rlOspfGeneralGroupStatus = _RlOspfGeneralGroupStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 30),
...
rlOspfLogAdjacencyChanges = _RlOspfLogAdjacencyChanges_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 31),
...
rlOspfPassiveInterface = _RlOspfPassiveInterface_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 32),
...
class _RlOspfDefaultMetric_Type(Unsigned32):
    """Custom type rlOspfDefaultMetric based on Unsigned32"""
    defaultValue = 0


_RlOspfDefaultMetric_Type.__name__ = "Unsigned32"
_RlOspfDefaultMetric_Object = MibTableColumn
rlOspfDefaultMetric = _RlOspfDefaultMetric_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 33),
...
_RlOspfMaximumRedistPrefixThreshold_Type.__name__ = "Integer32"
...
rlOspfMaximumRedistPrefixThreshold = _RlOspfMaximumRedistPrefixThreshold_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 35),
...
_RlOspfMaximumRedistPrefixWarningOnly_Type.__name__ = "TruthValue"
...
rlOspfMaximumRedistPrefixWarningOnly = _RlOspfMaximumRedistPrefixWarningOnly_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 36),
...
rlOspfOperStatus = _RlOspfOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 37),
...
rlOspfNextRouterId = _RlOspfNextRouterId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 38),
...
rlOspfRouterIdType = _RlOspfRouterIdType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 39),
...
rlOspfNextRouterIdType = _RlOspfNextRouterIdType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 40),
...
rlOspfASBdrRtrActualStatus = _RlOspfASBdrRtrActualStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 41),
...
rlOspfRteMaxEqCostPaths = _RlOspfRteMaxEqCostPaths_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 43),
...
class _RlOspfPrefixSuppression_Type(TruthValue):
    """Custom type rlOspfPrefixSuppression based on TruthValue"""
    defaultValue = 2


_RlOspfPrefixSuppression_Type.__name__ = "TruthValue"
_RlOspfPrefixSuppression_Object = MibTableColumn
rlOspfPrefixSuppression = _RlOspfPrefixSuppression_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 2, 1, 44),
    _RlOspfPrefixSuppression_Type()
)
rlOspfPrefixSuppression.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlOspfPrefixSuppression.setStatus("current")
_RlOspfAreaTable_Object = MibTable
rlOspfAreaTable = _RlOspfAreaTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3)
)
if mibBuilder.loadTexts:
    rlOspfAreaTable.setStatus("current")
_RlOspfAreaEntry_Object = MibTableRow
rlOspfAreaEntry = _RlOspfAreaEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1)
)
rlOspfAreaEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaId"),
)
if mibBuilder.loadTexts:
...
rlOspfAreaProcessId = _RlOspfAreaProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 1),
...
rlOspfAreaId = _RlOspfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 2),
    _RlOspfAreaId_Type()
)
...
rlOspfImportAsExtern = _RlOspfImportAsExtern_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 3),
...
rlOspfSpfRuns = _RlOspfSpfRuns_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 4),
    _RlOspfSpfRuns_Type()
)
...
rlOspfAreaBdrRtrCount = _RlOspfAreaBdrRtrCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 5),
...
rlOspfAsBdrRtrCount = _RlOspfAsBdrRtrCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 6),
...
rlOspfAreaLsaCount = _RlOspfAreaLsaCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 7),
...
rlOspfAreaSummary = _RlOspfAreaSummary_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 9),
...
rlOspfAreaStatus = _RlOspfAreaStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 10),
...
rlOspfAreaNssaTranslatorRole = _RlOspfAreaNssaTranslatorRole_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 11),
...
rlOspfAreaNssaTranslatorState = _RlOspfAreaNssaTranslatorState_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 12),
...
_RlOspfAreaNssaTranslatorStabilityInterval_Type.__name__ = "PositiveInteger"
...
rlOspfAreaNssaTranslatorStabilityInterval = _RlOspfAreaNssaTranslatorStabilityInterval_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 13),
...
rlOspfAreaNssaTranslatorEvents = _RlOspfAreaNssaTranslatorEvents_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 14),
...
class _RlOspfAuthType_Type(RlOspfAdminAuthenticationType):
    """Custom type rlOspfAuthType based on RlOspfAdminAuthenticationType"""
    defaultValue = 0


_RlOspfAuthType_Type.__name__ = "RlOspfAdminAuthenticationType"
_RlOspfAuthType_Object = MibTableColumn
rlOspfAuthType = _RlOspfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 15),
...
rlOspfAreaOperStatus = _RlOspfAreaOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 17),
...
rlOspfAreaFilterPrefixListIn = _RlOspfAreaFilterPrefixListIn_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 18),
...
rlOspfAreaFilterPrefixListOut = _RlOspfAreaFilterPrefixListOut_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 3, 1, 19),
...
rlOspfStubAreaEntry = _RlOspfStubAreaEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 4, 1)
)
rlOspfStubAreaEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfStubProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfStubAreaId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfStubTOS"),
)
if mibBuilder.loadTexts:
...
rlOspfStubProcessId = _RlOspfStubProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 4, 1, 1),
...
rlOspfStubAreaId = _RlOspfStubAreaId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 4, 1, 2),
...
rlOspfStubTOS = _RlOspfStubTOS_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 4, 1, 3),
    _RlOspfStubTOS_Type()
)
...
rlOspfStubMetric = _RlOspfStubMetric_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 4, 1, 4),
...
rlOspfStubStatus = _RlOspfStubStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 4, 1, 5),
...
rlOspfStubMetricType = _RlOspfStubMetricType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 4, 1, 6),
...
rlOspfLsdbTable = _RlOspfLsdbTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5)
)
if mibBuilder.loadTexts:
    rlOspfLsdbTable.setStatus("current")
_RlOspfLsdbEntry_Object = MibTableRow
rlOspfLsdbEntry = _RlOspfLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5, 1)
)
rlOspfLsdbEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfLsdbProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfLsdbAreaId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfLsdbType"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfLsdbLsid"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
rlOspfLsdbProcessId = _RlOspfLsdbProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5, 1, 1),
...
rlOspfLsdbAreaId = _RlOspfLsdbAreaId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5, 1, 2),
...
rlOspfLsdbLsid = _RlOspfLsdbLsid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5, 1, 4),
...
rlOspfLsdbRouterId = _RlOspfLsdbRouterId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5, 1, 5),
...
rlOspfLsdbSequence = _RlOspfLsdbSequence_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5, 1, 6),
...
rlOspfLsdbAge = _RlOspfLsdbAge_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5, 1, 7),
    _RlOspfLsdbAge_Type()
)
...
rlOspfLsdbChecksum = _RlOspfLsdbChecksum_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5, 1, 8),
...
rlOspfLsdbAdvertisement = _RlOspfLsdbAdvertisement_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 5, 1, 9),
...
rlOspfAreaRangeEntry = _RlOspfAreaRangeEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 6, 1)
)
rlOspfAreaRangeEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaRangeProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaRangeAreaId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaRangeNet"),
)
if mibBuilder.loadTexts:
...
rlOspfAreaRangeProcessId = _RlOspfAreaRangeProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 6, 1, 1),
...
rlOspfAreaRangeAreaId = _RlOspfAreaRangeAreaId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 6, 1, 2),
...
rlOspfAreaRangeNet = _RlOspfAreaRangeNet_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 6, 1, 3),
...
rlOspfAreaRangeMask = _RlOspfAreaRangeMask_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 6, 1, 4),
...
rlOspfAreaRangeStatus = _RlOspfAreaRangeStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 6, 1, 5),
...
rlOspfAreaRangeEffect = _RlOspfAreaRangeEffect_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 6, 1, 6),
...
rlOspfHostTable = _RlOspfHostTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 7)
)
if mibBuilder.loadTexts:
    rlOspfHostTable.setStatus("current")
_RlOspfHostEntry_Object = MibTableRow
rlOspfHostEntry = _RlOspfHostEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 7, 1)
)
rlOspfHostEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfHostProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfHostIpAddress"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfHostTOS"),
)
if mibBuilder.loadTexts:
...
rlOspfHostProcessId = _RlOspfHostProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 7, 1, 1),
...
rlOspfHostIpAddress = _RlOspfHostIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 7, 1, 2),
...
rlOspfHostTOS = _RlOspfHostTOS_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 7, 1, 3),
    _RlOspfHostTOS_Type()
)
...
rlOspfHostMetric = _RlOspfHostMetric_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 7, 1, 4),
...
rlOspfHostStatus = _RlOspfHostStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 7, 1, 5),
...
rlOspfHostAreaID = _RlOspfHostAreaID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 7, 1, 6),
...
rlOspfHostCfgAreaID = _RlOspfHostCfgAreaID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 7, 1, 7),
...
rlOspfIfTable = _RlOspfIfTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8)
)
if mibBuilder.loadTexts:
    rlOspfIfTable.setStatus("current")
_RlOspfIfEntry_Object = MibTableRow
rlOspfIfEntry = _RlOspfIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1)
)
rlOspfIfEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfIfProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfIfIpAddress"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfAddressLessIf"),
)
if mibBuilder.loadTexts:
...
rlOspfIfProcessId = _RlOspfIfProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 1),
...
rlOspfIfIpAddress = _RlOspfIfIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 2),
...
rlOspfAddressLessIf = _RlOspfAddressLessIf_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 3),
...
rlOspfIfType = _RlOspfIfType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 5),
    _RlOspfIfType_Type()
)
...
_RlOspfIfRtrPriority_Type.__name__ = "DesignatedRouterPriority"
_RlOspfIfRtrPriority_Object = MibTableColumn
rlOspfIfRtrPriority = _RlOspfIfRtrPriority_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 7),
...
_RlOspfIfTransitDelay_Type.__name__ = "RlOspfUpToRefreshIntervalTC"
_RlOspfIfTransitDelay_Object = MibTableColumn
rlOspfIfTransitDelay = _RlOspfIfTransitDelay_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 8),
...
rlOspfIfState = _RlOspfIfState_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 13),
    _RlOspfIfState_Type()
)
...
_RlOspfIfBackupDesignatedRouter_Type.__name__ = "IpAddress"
...
rlOspfIfBackupDesignatedRouter = _RlOspfIfBackupDesignatedRouter_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 15),
...
rlOspfIfEvents = _RlOspfIfEvents_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 16),
...
rlOspfIfAuthKey = _RlOspfIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 17),
...
rlOspfIfStatus = _RlOspfIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 18),
...
rlOspfIfMulticastForwarding = _RlOspfIfMulticastForwarding_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 19),
...
class _RlOspfIfAuthType_Type(RlOspfAdminAuthenticationType):
    """Custom type rlOspfIfAuthType based on RlOspfAdminAuthenticationType"""
    defaultValue = 0


_RlOspfIfAuthType_Type.__name__ = "RlOspfAdminAuthenticationType"
_RlOspfIfAuthType_Object = MibTableColumn
rlOspfIfAuthType = _RlOspfIfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 21),
...
rlOspfIfLsaCount = _RlOspfIfLsaCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 22),
...
rlOspfIfLsaCksumSum = _RlOspfIfLsaCksumSum_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 23),
...
rlOspfIfDesignatedRouterId = _RlOspfIfDesignatedRouterId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 24),
...
rlOspfIfBackupDesignatedRouterId = _RlOspfIfBackupDesignatedRouterId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 25),
...
rlOspfIfOperStatus = _RlOspfIfOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 26),
...
rlOspfIfAuthKeyChain = _RlOspfIfAuthKeyChain_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 27),
...
rlOspfIfLsaRefreshIntvl = _RlOspfIfLsaRefreshIntvl_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 29),
...
rlOspfIfNameLookup = _RlOspfIfNameLookup_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 32),
...
rlOspfIfIfIndex = _RlOspfIfIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 33),
...
class _RlOspfIfMd5DigestAuthKeyId_Type(Integer32):
    """Custom type rlOspfIfMd5DigestAuthKeyId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_RlOspfIfMd5DigestAuthKeyId_Type.__name__ = "Integer32"
_RlOspfIfMd5DigestAuthKeyId_Object = MibTableColumn
rlOspfIfMd5DigestAuthKeyId = _RlOspfIfMd5DigestAuthKeyId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 35),
    _RlOspfIfMd5DigestAuthKeyId_Type()
)
rlOspfIfMd5DigestAuthKeyId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlOspfIfMd5DigestAuthKeyId.setStatus("current")


class _RlOspfIfMd5DigestAuthKey_Type(OctetString):
    """Custom type rlOspfIfMd5DigestAuthKey based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_RlOspfIfMd5DigestAuthKey_Type.__name__ = "OctetString"
_RlOspfIfMd5DigestAuthKey_Object = MibTableColumn
rlOspfIfMd5DigestAuthKey = _RlOspfIfMd5DigestAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 36),
    _RlOspfIfMd5DigestAuthKey_Type()
)
rlOspfIfMd5DigestAuthKey.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    rlOspfIfMd5DigestAuthKey.setStatus("current")


class _RlOspfIfPrefixSuppression_Type(Integer32):
    """Custom type rlOspfIfPrefixSuppression based on Integer32"""
    defaultValue = 1
...
_RlOspfIfPrefixSuppression_Type.__name__ = "Integer32"
_RlOspfIfPrefixSuppression_Object = MibTableColumn
rlOspfIfPrefixSuppression = _RlOspfIfPrefixSuppression_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 8, 1, 37),
    _RlOspfIfPrefixSuppression_Type()
)
rlOspfIfPrefixSuppression.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlOspfIfPrefixSuppression.setStatus("current")
_RlOspfIfMetricTable_Object = MibTable
rlOspfIfMetricTable = _RlOspfIfMetricTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 9)
)
if mibBuilder.loadTexts:
...
rlOspfIfMetricEntry = _RlOspfIfMetricEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 9, 1)
)
rlOspfIfMetricEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfIfMetricProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfIfMetricIpAddress"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfIfMetricAddressLessIf"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfIfMetricTOS"),
)
if mibBuilder.loadTexts:
...
rlOspfIfMetricProcessId = _RlOspfIfMetricProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 9, 1, 1),
...
rlOspfIfMetricIpAddress = _RlOspfIfMetricIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 9, 1, 2),
...
rlOspfIfMetricAddressLessIf = _RlOspfIfMetricAddressLessIf_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 9, 1, 3),
...
rlOspfIfMetricTOS = _RlOspfIfMetricTOS_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 9, 1, 4),
...
rlOspfIfMetricValue = _RlOspfIfMetricValue_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 9, 1, 5),
...
rlOspfIfMetricStatus = _RlOspfIfMetricStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 9, 1, 6),
...
rlOspfVirtIfTable = _RlOspfVirtIfTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10)
)
if mibBuilder.loadTexts:
    rlOspfVirtIfTable.setStatus("current")
_RlOspfVirtIfEntry_Object = MibTableRow
rlOspfVirtIfEntry = _RlOspfVirtIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1)
)
rlOspfVirtIfEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtIfProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtIfAreaId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtIfNeighbor"),
)
if mibBuilder.loadTexts:
...
rlOspfVirtIfProcessId = _RlOspfVirtIfProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 1),
...
rlOspfVirtIfAreaId = _RlOspfVirtIfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 2),
...
rlOspfVirtIfNeighbor = _RlOspfVirtIfNeighbor_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 3),
...
rlOspfVirtIfState = _RlOspfVirtIfState_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 8),
...
rlOspfVirtIfEvents = _RlOspfVirtIfEvents_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 9),
...
rlOspfVirtIfAuthKey = _RlOspfVirtIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 10),
...
rlOspfVirtIfStatus = _RlOspfVirtIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 11),
...
_RlOspfVirtIfAuthType_Type.__name__ = "RlOspfAuthenticationType"
...
rlOspfVirtIfLsaCount = _RlOspfVirtIfLsaCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 13),
...
rlOspfVirtIfLsaCksumSum = _RlOspfVirtIfLsaCksumSum_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 14),
...
rlOspfVirtIfAuthKeyChain = _RlOspfVirtIfAuthKeyChain_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 15),
...
rlOspfVirtIfOperStatus = _RlOspfVirtIfOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 17),
...
rlOspfVirtIfIndex = _RlOspfVirtIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 18),
...
rlOspfVirtIfActualAuthType = _RlOspfVirtIfActualAuthType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 19),
...
class _RlOspfVirtIfMd5DigestAuthKeyId_Type(Integer32):
    """Custom type rlOspfVirtIfMd5DigestAuthKeyId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_RlOspfVirtIfMd5DigestAuthKeyId_Type.__name__ = "Integer32"
_RlOspfVirtIfMd5DigestAuthKeyId_Object = MibTableColumn
rlOspfVirtIfMd5DigestAuthKeyId = _RlOspfVirtIfMd5DigestAuthKeyId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 20),
    _RlOspfVirtIfMd5DigestAuthKeyId_Type()
)
rlOspfVirtIfMd5DigestAuthKeyId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlOspfVirtIfMd5DigestAuthKeyId.setStatus("current")


class _RlOspfVirtIfMd5DigestAuthKey_Type(OctetString):
    """Custom type rlOspfVirtIfMd5DigestAuthKey based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_RlOspfVirtIfMd5DigestAuthKey_Type.__name__ = "OctetString"
_RlOspfVirtIfMd5DigestAuthKey_Object = MibTableColumn
rlOspfVirtIfMd5DigestAuthKey = _RlOspfVirtIfMd5DigestAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 10, 1, 21),
    _RlOspfVirtIfMd5DigestAuthKey_Type()
)
rlOspfVirtIfMd5DigestAuthKey.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    rlOspfVirtIfMd5DigestAuthKey.setStatus("current")
_RlOspfNbrTable_Object = MibTable
rlOspfNbrTable = _RlOspfNbrTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11)
)
if mibBuilder.loadTexts:
    rlOspfNbrTable.setStatus("current")
_RlOspfNbrEntry_Object = MibTableRow
rlOspfNbrEntry = _RlOspfNbrEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1)
)
rlOspfNbrEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfNbrProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfNbrIpAddr"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfNbrAddressLessIndex"),
)
if mibBuilder.loadTexts:
...
rlOspfNbrProcessId = _RlOspfNbrProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 1),
...
rlOspfNbrIpAddr = _RlOspfNbrIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 2),
...
rlOspfNbrAddressLessIndex = _RlOspfNbrAddressLessIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 3),
...
_RlOspfNbrPriority_Type.__name__ = "DesignatedRouterPriority"
_RlOspfNbrPriority_Object = MibTableColumn
rlOspfNbrPriority = _RlOspfNbrPriority_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 6),
...
rlOspfNbrState = _RlOspfNbrState_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 7),
...
rlOspfNbrEvents = _RlOspfNbrEvents_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 8),
...
rlOspfNbrLsRetransQLen = _RlOspfNbrLsRetransQLen_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 9),
...
rlOspfNbmaNbrStatus = _RlOspfNbmaNbrStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 10),
...
rlOspfNbmaNbrPermanence = _RlOspfNbmaNbrPermanence_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 11),
...
rlOspfNbrHelloSuppressed = _RlOspfNbrHelloSuppressed_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 12),
...
rlOspfNbrRestartHelperStatus = _RlOspfNbrRestartHelperStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 13),
...
rlOspfNbrRestartHelperAge = _RlOspfNbrRestartHelperAge_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 14),
...
rlOspfNbrRestartHelperExitReason = _RlOspfNbrRestartHelperExitReason_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 15),
...
rlOspfNbrDeadTime = _RlOspfNbrDeadTime_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 16),
...
rlOspfNbrAreaId = _RlOspfNbrAreaId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 17),
...
rlOspfNbrIfIndex = _RlOspfNbrIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 18),
...
rlOspfNbrIfIpAddr = _RlOspfNbrIfIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 11, 1, 19),
...
rlOspfVirtNbrTable = _RlOspfVirtNbrTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12)
)
if mibBuilder.loadTexts:
    rlOspfVirtNbrTable.setStatus("current")
_RlOspfVirtNbrEntry_Object = MibTableRow
rlOspfVirtNbrEntry = _RlOspfVirtNbrEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1)
)
rlOspfVirtNbrEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtNbrProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtNbrArea"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtNbrRtrId"),
)
if mibBuilder.loadTexts:
...
rlOspfVirtNbrProcessId = _RlOspfVirtNbrProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 1),
...
rlOspfVirtNbrArea = _RlOspfVirtNbrArea_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 2),
...
rlOspfVirtNbrRtrId = _RlOspfVirtNbrRtrId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 3),
...
rlOspfVirtNbrIpAddr = _RlOspfVirtNbrIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 4),
...
rlOspfVirtNbrOptions = _RlOspfVirtNbrOptions_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 5),
...
rlOspfVirtNbrState = _RlOspfVirtNbrState_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 6),
...
rlOspfVirtNbrEvents = _RlOspfVirtNbrEvents_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 7),
...
rlOspfVirtNbrLsRetransQLen = _RlOspfVirtNbrLsRetransQLen_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 8),
...
rlOspfVirtNbrHelloSuppressed = _RlOspfVirtNbrHelloSuppressed_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 9),
...
rlOspfVirtNbrRestartHelperStatus = _RlOspfVirtNbrRestartHelperStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 10),
...
rlOspfVirtNbrRestartHelperAge = _RlOspfVirtNbrRestartHelperAge_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 11),
...
rlOspfVirtNbrRestartHelperExitReason = _RlOspfVirtNbrRestartHelperExitReason_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 12),
...
rlOspfVirtNbrDeadTime = _RlOspfVirtNbrDeadTime_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 12, 1, 13),
...
rlOspfExtLsdbEntry = _RlOspfExtLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 13, 1)
)
rlOspfExtLsdbEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfExtLsdbProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfExtLsdbType"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfExtLsdbLsid"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfExtLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
rlOspfExtLsdbProcessId = _RlOspfExtLsdbProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 13, 1, 1),
...
rlOspfExtLsdbType = _RlOspfExtLsdbType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 13, 1, 2),
...
rlOspfExtLsdbLsid = _RlOspfExtLsdbLsid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 13, 1, 3),
...
rlOspfExtLsdbRouterId = _RlOspfExtLsdbRouterId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 13, 1, 4),
...
rlOspfExtLsdbSequence = _RlOspfExtLsdbSequence_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 13, 1, 5),
...
rlOspfExtLsdbAge = _RlOspfExtLsdbAge_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 13, 1, 6),
...
rlOspfExtLsdbChecksum = _RlOspfExtLsdbChecksum_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 13, 1, 7),
...
rlOspfExtLsdbAdvertisement = _RlOspfExtLsdbAdvertisement_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 13, 1, 8),
...
rlOspfAreaAggregateEntry = _RlOspfAreaAggregateEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 14, 1)
)
rlOspfAreaAggregateEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaAggregateProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaAggregateAreaID"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaAggregateLsdbType"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaAggregateNet"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfAreaAggregateMask"),
)
if mibBuilder.loadTexts:
...
rlOspfAreaAggregateProcessId = _RlOspfAreaAggregateProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 14, 1, 1),
...
rlOspfAreaAggregateAreaID = _RlOspfAreaAggregateAreaID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 14, 1, 2),
...
rlOspfAreaAggregateLsdbType = _RlOspfAreaAggregateLsdbType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 14, 1, 3),
...
rlOspfAreaAggregateNet = _RlOspfAreaAggregateNet_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 14, 1, 4),
...
rlOspfAreaAggregateMask = _RlOspfAreaAggregateMask_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 14, 1, 5),
...
rlOspfAreaAggregateStatus = _RlOspfAreaAggregateStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 14, 1, 6),
...
rlOspfAreaAggregateEffect = _RlOspfAreaAggregateEffect_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 14, 1, 7),
...
_RlOspfAreaAggregateExtRouteTag_Type.__name__ = "Unsigned32"
...
rlOspfAreaAggregateExtRouteTag = _RlOspfAreaAggregateExtRouteTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 14, 1, 8),
...
rlOspfLocalLsdbEntry = _RlOspfLocalLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1)
)
rlOspfLocalLsdbEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfLocalLsdbProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfLocalLsdbIpAddress"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfLocalLsdbAddressLessIf"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfLocalLsdbType"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfLocalLsdbLsid"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfLocalLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
rlOspfLocalLsdbProcessId = _RlOspfLocalLsdbProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 1),
...
rlOspfLocalLsdbIpAddress = _RlOspfLocalLsdbIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 2),
...
rlOspfLocalLsdbAddressLessIf = _RlOspfLocalLsdbAddressLessIf_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 3),
...
rlOspfLocalLsdbType = _RlOspfLocalLsdbType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 4),
...
rlOspfLocalLsdbLsid = _RlOspfLocalLsdbLsid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 5),
...
rlOspfLocalLsdbRouterId = _RlOspfLocalLsdbRouterId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 6),
...
rlOspfLocalLsdbSequence = _RlOspfLocalLsdbSequence_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 7),
...
rlOspfLocalLsdbAge = _RlOspfLocalLsdbAge_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 8),
...
rlOspfLocalLsdbChecksum = _RlOspfLocalLsdbChecksum_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 9),
...
rlOspfLocalLsdbAdvertisement = _RlOspfLocalLsdbAdvertisement_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 10),
...
rlOspfLocalLsdbAreaId = _RlOspfLocalLsdbAreaId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 18, 1, 11),
...
rlOspfVirtLocalLsdbEntry = _RlOspfVirtLocalLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1)
)
rlOspfVirtLocalLsdbEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtLocalLsdbProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtLocalLsdbTransitArea"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtLocalLsdbNeighbor"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtLocalLsdbType"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtLocalLsdbLsid"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfVirtLocalLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
rlOspfVirtLocalLsdbProcessId = _RlOspfVirtLocalLsdbProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 1),
...
rlOspfVirtLocalLsdbTransitArea = _RlOspfVirtLocalLsdbTransitArea_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 2),
...
rlOspfVirtLocalLsdbNeighbor = _RlOspfVirtLocalLsdbNeighbor_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 3),
...
rlOspfVirtLocalLsdbType = _RlOspfVirtLocalLsdbType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 4),
...
rlOspfVirtLocalLsdbLsid = _RlOspfVirtLocalLsdbLsid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 5),
...
rlOspfVirtLocalLsdbRouterId = _RlOspfVirtLocalLsdbRouterId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 6),
...
rlOspfVirtLocalLsdbSequence = _RlOspfVirtLocalLsdbSequence_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 7),
...
rlOspfVirtLocalLsdbAge = _RlOspfVirtLocalLsdbAge_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 8),
...
rlOspfVirtLocalLsdbChecksum = _RlOspfVirtLocalLsdbChecksum_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 9),
...
rlOspfVirtLocalLsdbAdvertisement = _RlOspfVirtLocalLsdbAdvertisement_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 19, 1, 10),
...
_RlOspfEnableTrapsOspfRateLimitSeconds_Type.__name__ = "Integer32"
...
_RlOspfEnableTrapsOspfRateLimitTrapNumber_Type.__name__ = "Integer32"
...
rlOspfBrRouterEntry = _RlOspfBrRouterEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 1, 1)
)
rlOspfBrRouterEntry.setIndexNames(
    (0, "CISCOSB-OSPF-MIB", "rlOspfBrRouterProcessId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfBrRouterAreaId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfBrRouterRouterId"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfBrRouterNextHopIp"),
    (0, "CISCOSB-OSPF-MIB", "rlOspfBrRouterOutIf"),
)
if mibBuilder.loadTexts:
...
rlOspfBrRouterProcessId = _RlOspfBrRouterProcessId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 1, 1, 1),
...
rlOspfBrRouterAreaId = _RlOspfBrRouterAreaId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 1, 1, 2),
...
rlOspfBrRouterRouterId = _RlOspfBrRouterRouterId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 1, 1, 3),
...
rlOspfBrRouterNextHopIp = _RlOspfBrRouterNextHopIp_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 1, 1, 4),
...
rlOspfBrRouterOutIf = _RlOspfBrRouterOutIf_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 1, 1, 5),
...
rlOspfBrRouterRouteType = _RlOspfBrRouterRouteType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 1, 1, 6),
...
rlOspfBrRouterRouteCost = _RlOspfBrRouterRouteCost_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 1, 1, 7),
...
rlOspfBrRouterRouterType = _RlOspfBrRouterRouterType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 1, 1, 8),
...
rlOspfNameLookupEnabled = _RlOspfNameLookupEnabled_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 210, 26, 2),
    _RlOspfNameLookupEnabled_Type()
)
rlOspfNameLookupEnabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlOspfNameLookupEnabled.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlOspfProcessID": RlOspfProcessID,
       ...
       "RlOspfAdminAuthenticationType": RlOspfAdminAuthenticationType,
       ...
       "rlOspfPrefixSuppression": rlOspfPrefixSuppression,
       ...
       "rlOspfIfMd5DigestAuthKeyId": rlOspfIfMd5DigestAuthKeyId,
       "rlOspfIfMd5DigestAuthKey": rlOspfIfMd5DigestAuthKey,
       "rlOspfIfPrefixSuppression": rlOspfIfPrefixSuppression,
       ...
       "rlOspfVirtIfMd5DigestAuthKeyId": rlOspfVirtIfMd5DigestAuthKeyId,
       "rlOspfVirtIfMd5DigestAuthKey": rlOspfVirtIfMd5DigestAuthKey,
       ...
       "rlOspfNameLookupEnabled": rlOspfNameLookupEnabled}
)
