# SNMP MIB module (ALCATEL-ENT1-QCN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-QCN-MIB
...
alaQcnGlobalEntry.setIndexNames(
    (0, "ALCATEL-ENT1-QCN-MIB", "alaQcnGlobalCompId"),
)
if mibBuilder.loadTexts:
...
alaQcnPortInstanceEntry.setIndexNames(
    (0, "ALCATEL-ENT1-QCN-MIB", "alaQcnPIIfIndex"),
    (0, "ALCATEL-ENT1-QCN-MIB", "alaQcnPIPriority"),
)
if mibBuilder.loadTexts:
...
alaQcnGlobalGroup.setObjects(
      *(("ALCATEL-ENT1-QCN-MIB", "alaQcnGlobalCNMVlanTag"),
        ("ALCATEL-ENT1-QCN-MIB", "alaQcnGlobalCID"))
)
if mibBuilder.loadTexts:
...
alaQcnPortInstanceGroup.setObjects(
      *(("ALCATEL-ENT1-QCN-MIB", "alaQcnPIPriorityReset"),
        ("ALCATEL-ENT1-QCN-MIB", "alaQcnPICncpStatsClear"),
        ("ALCATEL-ENT1-QCN-MIB", "alaQcnPICncpReset"))
)
if mibBuilder.loadTexts:
...
alcatelIND1QcnMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-QCN-MIB", "alaQcnGlobalGroup"),
        ("ALCATEL-ENT1-QCN-MIB", "alaQcnPortInstanceGroup"))
)
if mibBuilder.loadTexts:
