...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPNSAPCI-MIB
...
hpnsaPciSlotNumber = _HpnsaPciSlotNumber_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 10, 4, 1, 1, 21),
    _HpnsaPciSlotNumber_Type()
)
hpnsaPciSlotNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpnsaPciSlotNumber.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"hp": hp,
       ...
       "hpnsaPciSlotNumber": hpnsaPciSlotNumber}
)
