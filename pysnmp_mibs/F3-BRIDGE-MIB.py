...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/adva/F3-BRIDGE-MIB
...
cmFlowIndex, cmMPFlowIndex, cmEthernetAccPortIndex, cmFlowEntry = mibBuilder.importSymbols("CM-FACILITY-MIB", "cmFlowIndex", "cmMPFlowIndex", "cmEthernetAccPortIndex", "cmFlowEntry")
cmFlowStatsEntry, cmFlowHistoryEntry = mibBuilder.importSymbols("CM-PERFORMANCE-MIB", "cmFlowStatsEntry", "cmFlowHistoryEntry")
...
RowStatus, TextualConvention, MacAddress, VariablePointer, StorageType, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "MacAddress", "VariablePointer", "StorageType", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("F3-BRIDGE-MIB", f3FwdTSizeProfileTableSize=f3FwdTSizeProfileTableSize, f3BridgeGroups=f3BridgeGroups, f3FwdTSizeProfileGroup=f3FwdTSizeProfileGroup, f3FlowLearningStatsGroup=f3FlowLearningStatsGroup, f3MPFlowFDBEntry=f3MPFlowFDBEntry, f3MPFlowStaticFwdControlAction=f3MPFlowStaticFwdControlAction, f3MGRFPIndex=f3MGRFPIndex, f3FlowLearningHistoryFDNoDest=f3FlowLearningHistoryFDNoDest, f3MGRFPMemberEntry=f3MGRFPMemberEntry, f3FlowStaticFwdEntStorageType=f3FlowStaticFwdEntStorageType, f3FlowLearningConfigAgingTimer=f3FlowLearningConfigAgingTimer, f3FlowLearningStatsFDHairPin=f3FlowLearningStatsFDHairPin, LearningEntryType=LearningEntryType, f3FlowStaticFwdEntDestPort=f3FlowStaticFwdEntDestPort, f3BridgeStatsObjects=f3BridgeStatsObjects, f3FlowLearningConfigTableFullAction=f3FlowLearningConfigTableFullAction, f3FlowLearningConfigNetMaxFwdEntries=f3FlowLearningConfigNetMaxFwdEntries, neBridgeParamsRtrvMacAction=neBridgeParamsRtrvMacAction, f3FlowFdbEntry=f3FlowFdbEntry, f3MPFlowFDBControlAction=f3MPFlowFDBControlAction, f3FlowStaticFwdEntRowStatus=f3FlowStaticFwdEntRowStatus, f3FlowLearningHistoryMacTableDiscards=f3FlowLearningHistoryMacTableDiscards, f3FlowLearningConfigAccMaxFwdEntries=f3FlowLearningConfigAccMaxFwdEntries, f3FlowLearningConfigAccIfLearningCtrl=f3FlowLearningConfigAccIfLearningCtrl, PYSNMP_MODULE_ID=f3BridgeMIB, f3FlowLearningHistoryMacTableFlushes=f3FlowLearningHistoryMacTableFlushes, f3MPFlowStaticFwdStorageType=f3MPFlowStaticFwdStorageType, f3MPFlowStaticFwdEntry=f3MPFlowStaticFwdEntry, f3BridgeConfigObjects=f3BridgeConfigObjects, f3FlowLearningConfigAction=f3FlowLearningConfigAction, f3FlowStaticFwdValid=f3FlowStaticFwdValid, f3BridgeCompliance=f3BridgeCompliance, f3FwdTSizeProfileEntry=f3FwdTSizeProfileEntry, f3MPFlowFDBMacAddress=f3MPFlowFDBMacAddress, f3FlowLearningStatsFDStaticBlock=f3FlowLearningStatsFDStaticBlock, f3FwdTSizeProfileIndex=f3FwdTSizeProfileIndex, f3MPFlowStaticFwdValid=f3MPFlowStaticFwdValid, f3FlowFdbGroup=f3FlowFdbGroup, f3FlowFdbAction=f3FlowFdbAction, f3MGRFPList=f3MGRFPList, f3FlowFdbTable=f3FlowFdbTable, LearningAction=LearningAction, f3MGRGroupValid=f3MGRGroupValid, f3FlowStaticFwdEntTable=f3FlowStaticFwdEntTable, f3FlowStaticFwdEntGroup=f3FlowStaticFwdEntGroup, f3MPFlowStaticFwdRowStatus=f3MPFlowStaticFwdRowStatus, f3MPFlowStaticFwdTable=f3MPFlowStaticFwdTable, f3FlowStaticFwdEntEntry=f3FlowStaticFwdEntEntry, f3MGRMulticastAddress=f3MGRMulticastAddress, f3MultiGroupRegistrationTable=f3MultiGroupRegistrationTable, f3MGRGroupRowStatus=f3MGRGroupRowStatus, f3FlowFdbDestMac=f3FlowFdbDestMac, f3FlowLearningHistoryTable=f3FlowLearningHistoryTable, f3NetworkElementBridgeParamsGroup=f3NetworkElementBridgeParamsGroup, FlowLearningConfigAction=FlowLearningConfigAction, f3MGRGroupAction=f3MGRGroupAction, f3FlowLearningStatsMacTableDiscards=f3FlowLearningStatsMacTableDiscards, f3MGRFPIndexRowStatus=f3MGRFPIndexRowStatus, LearningControl=LearningControl, f3FlowLearningStatsEntry=f3FlowLearningStatsEntry, f3MGGroupFPGroup=f3MGGroupFPGroup, f3MGRGroupStorageType=f3MGRGroupStorageType, f3FlowLearningStatsFDNoDest=f3FlowLearningStatsFDNoDest, f3FwdTSizeProfileTable=f3FwdTSizeProfileTable, f3BridgeMIB=f3BridgeMIB, f3FwdTSizeProfileName=f3FwdTSizeProfileName, ProtectLearningControl=ProtectLearningControl, f3MPFlowStaticFwdGroup=f3MPFlowStaticFwdGroup, f3MPFlowStaticFwdFP=f3MPFlowStaticFwdFP, f3MGRFPMemberTable=f3MGRFPMemberTable, f3MPFlowFDBGroup=f3MPFlowFDBGroup, f3FlowLearningHistoryFDStaticBlock=f3FlowLearningHistoryFDStaticBlock, f3FlowLearningConfigTable=f3FlowLearningConfigTable, f3FlowLearningStatsMacTableFlushes=f3FlowLearningStatsMacTableFlushes, f3FlowLearningHistoryGroup=f3FlowLearningHistoryGroup, f3FlowLearningConfigAccIfProtectLearningCtrl=f3FlowLearningConfigAccIfProtectLearningCtrl, RetrieveMacAction=RetrieveMacAction, f3FlowStaticFwdEntDestMac=f3FlowStaticFwdEntDestMac, f3FlowLearningConfigNetIfProtectLearningCtrl=f3FlowLearningConfigNetIfProtectLearningCtrl, f3FlowLearningConfigNetIfLearningCtrl=f3FlowLearningConfigNetIfLearningCtrl, networkElementBridgeParamsTable=networkElementBridgeParamsTable, networkElementBridgeParamsEntry=networkElementBridgeParamsEntry, f3FlowStaticFwdEntAction=f3FlowStaticFwdEntAction, f3FlowFdbDestPort=f3FlowFdbDestPort, f3MGRGroupType=f3MGRGroupType, f3BridgeCompliances=f3BridgeCompliances, f3FlowLearningHistoryEntry=f3FlowLearningHistoryEntry, f3FlowLearningHistoryFDHairPin=f3FlowLearningHistoryFDHairPin, f3MPFlowFDBType=f3MPFlowFDBType, f3MPFlowStaticFwdMacAddress=f3MPFlowStaticFwdMacAddress, f3MultiGroupRegistrationEntry=f3MultiGroupRegistrationEntry, f3BridgeConformance=f3BridgeConformance, f3MPFlowFDBTable=f3MPFlowFDBTable, f3FlowLearningConfigEntry=f3FlowLearningConfigEntry, f3FlowFdbEntryType=f3FlowFdbEntryType, f3FlowLearningConfigGroup=f3FlowLearningConfigGroup, f3FlowLearningStatsTable=f3FlowLearningStatsTable, f3MPFlowFDBFP=f3MPFlowFDBFP)
