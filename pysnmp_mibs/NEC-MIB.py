...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/nec/NEC-MIB
...
ModuleIdentity, Counter64, enterprises, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Counter32, iso, NotificationType, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Counter32", "iso", "NotificationType", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("NEC-MIB", connSoftPvcSrcParam2=connSoftPvcSrcParam2, connRouteType=connRouteType, connPvcParam3=connPvcParam3, cardStatusServerType=cardStatusServerType, perfIfReceivedCells=perfIfReceivedCells, connOamIndex=connOamIndex, perfIfPhysTable=perfIfPhysTable, connOamOpeVpi2=connOamOpeVpi2, connProfileName2Index=connProfileName2Index, connSoftPvcDstParam5=connSoftPvcDstParam5, nodePCMCIATable=nodePCMCIATable, linfParam3=linfParam3, nodePCMCIAType=nodePCMCIAType, linfStatusTable=linfStatusTable, pnniNodeLeadershipPriority=pnniNodeLeadershipPriority, connSvcTable=connSvcTable, connOamOpeVci1=connOamOpeVci1, slotIfConfRev=slotIfConfRev, perfTrapEnable=perfTrapEnable, connCeVcUpPartialFillSize=connCeVcUpPartialFillSize, perfIfPhysHCSEZs=perfIfPhysHCSEZs, LinfCodingMode=LinfCodingMode, connPvcContrastFifoIndex=connPvcContrastFifoIndex, clockOpeSlaveLine1=clockOpeSlaveLine1, connFrProfileCause=connFrProfileCause, connConfNodePvcs=connConfNodePvcs, slotIfConfEntry=slotIfConfEntry, connPvcParam5=connPvcParam5, perfIfReceivedCellsCounters=perfIfReceivedCellsCounters, connRouteSixthryVPI=connRouteSixthryVPI, connPvcVpi=connPvcVpi, connPvcEntry=connPvcEntry, connConfNodeUnCompleteSvcs=connConfNodeUnCompleteSvcs, connPvcTrfInDropCellsCounters=connPvcTrfInDropCellsCounters, nodeStatusOperStatus=nodeStatusOperStatus, scaleCause=scaleCause, connConfIfSvcs=connConfIfSvcs, DstSecondaryIfIndex=DstSecondaryIfIndex, linfFifoConfTable=linfFifoConfTable, perfIfPhysHCB2Errors=perfIfPhysHCB2Errors, connPvcOpeHighFifoIndex=connPvcOpeHighFifoIndex, linfFifoConfStatus=linfFifoConfStatus, connConfIfTable=connConfIfTable, connLoopOpeLoopBackPointNodeId=connLoopOpeLoopBackPointNodeId, connSoftPvcSrcVPI=connSoftPvcSrcVPI, connPvcOpeHighVci=connPvcOpeHighVci, connFrDlci=connFrDlci, connSoftPvcSrcParam4=connSoftPvcSrcParam4, perfIfUpcErrorCells=perfIfUpcErrorCells, connConfNode=connConfNode, cardOpeCopyResult=cardOpeCopyResult, slotIfConfBufferRev=slotIfConfBufferRev, perfIfPhysHCFEBEs=perfIfPhysHCFEBEs, connSoftPvcDstFifoIndex=connSoftPvcDstFifoIndex, perfIfPhysReceivedCells=perfIfPhysReceivedCells, linfMaxActiveVpiBits=linfMaxActiveVpiBits, connPvcOpeHighParam2=connPvcOpeHighParam2, linfFifoConfPeekRate=linfFifoConfPeekRate, linfFifoConfMaxBurstSize=linfFifoConfMaxBurstSize, linfFifoConfEntry=linfFifoConfEntry, perfIfPhysBitErrors=perfIfPhysBitErrors, connOamOpePort2=connOamOpePort2, connLoopOpeNormalEndCount=connLoopOpeNormalEndCount, connPvcOpeLowParam2=connPvcOpeLowParam2, diagParam1=diagParam1, connPvcContrastParam6=connPvcContrastParam6, connConfNodeSoftPvcs=connConfNodeSoftPvcs, connSoftPvcRowStatus=connSoftPvcRowStatus, connPvcPort=connPvcPort, perfIfPhysIecErrors=perfIfPhysIecErrors, connRoutePrimaryStatus=connRoutePrimaryStatus, nodeStatusSwitchType=nodeStatusSwitchType, connSoftPvcCause=connSoftPvcCause, connOamOpeVci2=connOamOpeVci2, connPvcContrastParam3=connPvcContrastParam3, connPvcTable=connPvcTable, connPvcTrfInCellsCounters=connPvcTrfInCellsCounters, connPvcTrfInDropCells=connPvcTrfInDropCells, connProfileCause=connProfileCause, pnniNodeTable=pnniNodeTable, perfIfPhysB2Errors=perfIfPhysB2Errors, nodeOpeSave=nodeOpeSave, LinfMaxVci=LinfMaxVci, connPvcOpeLowParam1=connPvcOpeLowParam1, connFrProfileCLPtoDE=connFrProfileCLPtoDE, perfIfPhysLcvErrors=perfIfPhysLcvErrors, LinfFractionalType=LinfFractionalType, connProfileParam2=connProfileParam2, connOamDefectNodeID=connOamDefectNodeID, connOamOpe=connOamOpe, connRouteOpeTertiaryIfIndex=connRouteOpeTertiaryIfIndex, perfIfPhysHecDropCells=perfIfPhysHecDropCells, matCmdOutput=matCmdOutput, connPvcParam1=connPvcParam1, connFrDlciRowStatus=connFrDlciRowStatus, connCeVcCDVT=connCeVcCDVT, nodePCMCIAEntry=nodePCMCIAEntry, linfStatus=linfStatus, LinfMinVci=LinfMinVci, nodeStatusSelfSystem=nodeStatusSelfSystem, connSoftPvcSrcIfIndex=connSoftPvcSrcIfIndex, diagActionKind=diagActionKind, linfFifoConfIndex=linfFifoConfIndex, connOamOpeStatus=connOamOpeStatus, connCe=connCe, connFrProfile=connFrProfile, connPvcTrafficType=connPvcTrafficType, connPvc=connPvc, nodeStatusSwitchMode=nodeStatusSwitchMode, connPvcTrfOutCells=connPvcTrfOutCells, DstAtmAddressFormat=DstAtmAddressFormat, connRouteSixthryIfIndex=connRouteSixthryIfIndex, pnniNodePeerGroupId=pnniNodePeerGroupId, connOamOpeSection=connOamOpeSection, clockSlaveLine3=clockSlaveLine3, connOamPort=connOamPort, connPvcOpeTopology=connPvcOpeTopology, pnniNodeLevel=pnniNodeLevel, connSvcInf=connSvcInf, connSoftPvcSrcAtmAddress=connSoftPvcSrcAtmAddress, connRouteOpeFifthryIfIndex=connRouteOpeFifthryIfIndex, connRouteOpePrimaryVPI=connRouteOpePrimaryVPI, linfCacFactor=linfCacFactor, connCeVcVci=connCeVcVci, ConnFrProfileIndex=ConnFrProfileIndex, perfIfSlotReceivedCells=perfIfSlotReceivedCells, perfIfSlotInDropCells=perfIfSlotInDropCells, connSoftPvcDstAtmAddress=connSoftPvcDstAtmAddress, connSoftPvcDstVCI=connSoftPvcDstVCI, connPvcTrfInCells=connPvcTrfInCells, connSoftPvcEstSrcInfIndex=connSoftPvcEstSrcInfIndex, connRouteOpeStatus=connRouteOpeStatus, diagCause=diagCause, connCeVcCause=connCeVcCause, connSoftPvcDstParam2=connSoftPvcDstParam2, PnniPeerGroupId=PnniPeerGroupId, nodeStatusStartTime=nodeStatusStartTime, perfIfSlotTransmittedCellsCounters=perfIfSlotTransmittedCellsCounters, DstPrimaryVPI=DstPrimaryVPI, card=card, linfParam1=linfParam1, connCeVcDownTimeSlot3=connCeVcDownTimeSlot3, connProfileName=connProfileName, connProfileIndex=connProfileIndex, connOamOpePort1=connOamOpePort1, connSoftPvcSrcParam7=connSoftPvcSrcParam7, connSoftPvcIndexNext=connSoftPvcIndexNext, connSoftPvcEndpointType=connSoftPvcEndpointType, perfIfPhysFramingBitErrors=perfIfPhysFramingBitErrors, connRouteAtmAddressFormat=connRouteAtmAddressFormat, perfIfPhysCrcErrors=perfIfPhysCrcErrors, cardOpeSave=cardOpeSave, connPvcOpeCause=connPvcOpeCause, connCeVcCondition=connCeVcCondition, perfIfPhysIdelUnassignedCells=perfIfPhysIdelUnassignedCells, connLoopOpe=connLoopOpe, perfIfPhysLineFEBEs=perfIfPhysLineFEBEs, connSoftPvcEstablishedSrcInfEntry=connSoftPvcEstablishedSrcInfEntry, connConfIfEntry=connConfIfEntry, connRouteOpeSecondaryIfIndex=connRouteOpeSecondaryIfIndex, linfJ2Rate=linfJ2Rate, nodeStatusNodeId=nodeStatusNodeId, DstPrimaryIfIndex=DstPrimaryIfIndex, connRouteFourthryVPI=connRouteFourthryVPI, matCmdStatus=matCmdStatus, nodePCMCIAIndex=nodePCMCIAIndex, cardOpeTable=cardOpeTable, PnniLevel=PnniLevel, connPvcTopology=connPvcTopology, connProfileEntry=connProfileEntry, connFrProfileName2IndexResult=connFrProfileName2IndexResult, connOamVci=connOamVci, connPvcContrastParam7=connPvcContrastParam7, connRouteSeventhryVPI=connRouteSeventhryVPI, connLoopOpeAbortCount=connLoopOpeAbortCount, connLoopOpeBase=connLoopOpeBase, slot=slot, LinfCellMappingMode=LinfCellMappingMode, connPvcTrfConf=connPvcTrfConf, connRouteOpeSeventhryIfIndex=connRouteOpeSeventhryIfIndex, m7_phase2=m7_phase2, perfIfMisDelivdCellsCounters=perfIfMisDelivdCellsCounters, pnniNodeEntry=pnniNodeEntry, perfIfPhysB3Errors=perfIfPhysB3Errors, cardStatusPriority=cardStatusPriority, perfIfPhysHCBip8Errors=perfIfPhysHCBip8Errors, LinfScramble=LinfScramble, connPvcContrastParam1=connPvcContrastParam1, connConfNodeTrafs=connConfNodeTrafs, nodeOpeCopy=nodeOpeCopy, connProfileTrafficType=connProfileTrafficType, slotIfConfStatus=slotIfConfStatus, perfIfTable=perfIfTable, perfIfSlotUpcErrorCells=perfIfSlotUpcErrorCells, nodePCMCIAStatus=nodePCMCIAStatus, clockOpeMode=clockOpeMode, connSoftPvcEstablishedSrcInfTable=connSoftPvcEstablishedSrcInfTable, atomis=atomis, connFr=connFr, connConfNodeTrafClear=connConfNodeTrafClear, connFrProfileCapsulationMode=connFrProfileCapsulationMode, pnniNodeId=pnniNodeId, scaleTarget=scaleTarget, connCeVcUpPCR=connCeVcUpPCR, linfParam5=linfParam5, connCeVcDirection=connCeVcDirection, connSoftPvcEntry=connSoftPvcEntry, cardOpeSaveResult=cardOpeSaveResult, clockMode=clockMode, connSoftPvcRetry=connSoftPvcRetry, connOamOpeCause=connOamOpeCause, connOamEntry=connOamEntry, connPvcOpeTrafficType=connPvcOpeTrafficType, perfIfPhysPort=perfIfPhysPort, perfIfPhysHCReceivedCells=perfIfPhysHCReceivedCells, clockOpeSlaveLine3=clockOpeSlaveLine3, connCeVcDownTimeSlot2=connCeVcDownTimeSlot2, necProductDepend=necProductDepend, connRouteOpe=connRouteOpe, connLoop=connLoop, nodeStatusEntry=nodeStatusEntry, connRouteSecondaryIfIndex=connRouteSecondaryIfIndex, connPvcTrfOutCellsCounters=connPvcTrfOutCellsCounters, connSoftPvcSrcParam3=connSoftPvcSrcParam3, connFrProfileRowStatus=connFrProfileRowStatus, scaleDataType=scaleDataType, LinfService=LinfService, ConnSoftPvcDstAtmAddressFormat=ConnSoftPvcDstAtmAddressFormat, diag=diag, perfIfPhysFEBEErrors=perfIfPhysFEBEErrors, perfIfPhysPathFEBEs=perfIfPhysPathFEBEs, connOamOpeVpi1=connOamOpeVpi1, connFrDlciFrProfile=connFrDlciFrProfile, connSoftPvcSrcParam1=connSoftPvcSrcParam1, connRoutePrimaryVPI=connRoutePrimaryVPI, diagActionStatus=diagActionStatus, perfIfSlotThresholdExcessCells=perfIfSlotThresholdExcessCells, connOamOpeMode=connOamOpeMode, connRouteOpeTertiaryVPI=connRouteOpeTertiaryVPI, cardStatusAtmAddr=cardStatusAtmAddr, cardOpeEntry=cardOpeEntry, connRouteAtmAddressLength=connRouteAtmAddressLength, connFrDlciPort=connFrDlciPort, pnniNodeAtmAddress=pnniNodeAtmAddress, connCeVcDownPartialFillSize=connCeVcDownPartialFillSize, clockSlaveLine1=clockSlaveLine1, connSvcEntry=connSvcEntry, matCmdInput=matCmdInput, connFrProfileDEValue=connFrProfileDEValue, LinfVendor=LinfVendor, perfIfPhysTransmittedCells=perfIfPhysTransmittedCells, connConfNodeSvcs=connConfNodeSvcs, connSoftPvcIndex=connSoftPvcIndex, perfIfThresholdExcessCells=perfIfThresholdExcessCells)
mibBuilder.exportSymbols("NEC-MIB", perf=perf, cardOpeReset=cardOpeReset, connLoopOpePort=connLoopOpePort, linfBandWidth=linfBandWidth, perfIfPhysHCIdelUnassignedCells=perfIfPhysHCIdelUnassignedCells, PnniAtmAddr=PnniAtmAddr, clockOpeStatus=clockOpeStatus, linfParam7=linfParam7, connPvcDirection=connPvcDirection, connSoftPvcDstParam7=connSoftPvcDstParam7, connPvcOpeHighVpi=connPvcOpeHighVpi, perfIfSlotReceivedCellsCounters=perfIfSlotReceivedCellsCounters, connSoftPvcRestRetry=connSoftPvcRestRetry, ConnProfileIndex=ConnProfileIndex, connCeVcDownPCR=connCeVcDownPCR, atomis_mib=atomis_mib, connPvcContrastParam2=connPvcContrastParam2, linfMaxActiveVciBits=linfMaxActiveVciBits, pnniNodeOpe=pnniNodeOpe, clockSlaveLine4Status=clockSlaveLine4Status, connOamStatus=connOamStatus, conn=conn, clockSlaveLine=clockSlaveLine, connRouteFifthryIfIndex=connRouteFifthryIfIndex, connProfileName2IndexResult=connProfileName2IndexResult, connCeVcPort=connCeVcPort, connSoftPvcSrcAtmAddressLength=connSoftPvcSrcAtmAddressLength, linfUnassignedIdle=linfUnassignedIdle, LinfFilterMaskVci=LinfFilterMaskVci, connRouteEntry=connRouteEntry, connCeVc=connCeVc, cardStatusMateSlotNumber=cardStatusMateSlotNumber, connPvcOpe=connPvcOpe, connFrDlciIndex=connFrDlciIndex, clockAccuracy=clockAccuracy, connSoftPvcNodeKind=connSoftPvcNodeKind, LinfInterWorking=LinfInterWorking, perfIfPhysHCLcvErrors=perfIfPhysHCLcvErrors, connProfile=connProfile, connFrDlciMBS=connFrDlciMBS, connFrDlciSCR=connFrDlciSCR, clockOpeSlaveLine4=clockOpeSlaveLine4, connRoutePrimaryIfIndex=connRoutePrimaryIfIndex, connPvcTrfTable=connPvcTrfTable, connOamOpePoint=connOamOpePoint, clockOpe=clockOpe, ClockSlaveLineStatus=ClockSlaveLineStatus, ConnRouteOpeFailureCause=ConnRouteOpeFailureCause, scaleSwSide=scaleSwSide, connCeVcEntry=connCeVcEntry, connPvcContrastParam5=connPvcContrastParam5, connRouteSeventhryIfIndex=connRouteSeventhryIfIndex, perfIfPhysHCB1Errors=perfIfPhysHCB1Errors, perfIfTransmittedCells=perfIfTransmittedCells, connFrDlciPCR=connFrDlciPCR, connConfIfSoftPvcs=connConfIfSoftPvcs, connRouteOpeFourthryVPI=connRouteOpeFourthryVPI, connLoopOpeVpi=connLoopOpeVpi, clockOpeCause=clockOpeCause, perfIfPhysHCFEBEErrors=perfIfPhysHCFEBEErrors, linfConf=linfConf, perfIfPhysHCCrcErrors=perfIfPhysHCCrcErrors, m7_corporate_mib=m7_corporate_mib, matCmdTimeOut=matCmdTimeOut, connPvcContrastVci=connPvcContrastVci, connRouteTertiaryVPI=connRouteTertiaryVPI, connSoftPvcDstParam6=connSoftPvcDstParam6, perfIfPhysHCFramingPatternErrors=perfIfPhysHCFramingPatternErrors, connOamSection=connOamSection, connRouteFifthryVPI=connRouteFifthryVPI, ConnSoftPvcSrcAtmAddressFormat=ConnSoftPvcSrcAtmAddressFormat, linfLoopBackCause=linfLoopBackCause, connFrProfileInterworkingType=connFrProfileInterworkingType, connRouteOpeFourthryIfIndex=connRouteOpeFourthryIfIndex, connRouteOpeAddressFormat=connRouteOpeAddressFormat, slotIfConfIndex=slotIfConfIndex, perfIfPhysHCPathParityErrors=perfIfPhysHCPathParityErrors, connFrProfileCIR=connFrProfileCIR, connSoftPvcSrcAtmAddressFormat=connSoftPvcSrcAtmAddressFormat, DstAtmAddress=DstAtmAddress, connSoftPvcTopology=connSoftPvcTopology, connFrProfileTable=connFrProfileTable, connRouteOpeSeventhryVPI=connRouteOpeSeventhryVPI, connSoftPvcSrcParam5=connSoftPvcSrcParam5, connPvcContrastParam4=connPvcContrastParam4, slotIfConfReset=slotIfConfReset, connLoopOpeCause=connLoopOpeCause, connRouteOpeAddress=connRouteOpeAddress, PnniNodeId=PnniNodeId, linfRecommendation=linfRecommendation, cardStatusRevision=cardStatusRevision, perfIfPhysFramingErrors=perfIfPhysFramingErrors, linfLoopBack=linfLoopBack, slotIfConfResetResult=slotIfConfResetResult, perfIfSlotTable=perfIfSlotTable, connLoopOpeMode=connLoopOpeMode, nodeStatusPower=nodeStatusPower, connPvcParam7=connPvcParam7, connRouteOpeAddressLength=connRouteOpeAddressLength, connCeVcDownTimeSlot1=connCeVcDownTimeSlot1, connProfileTable=connProfileTable, nodeOpeReset=nodeOpeReset, connPvcOpeHighPort=connPvcOpeHighPort, connFrProfileDEtoCLP=connFrProfileDEtoCLP, LinfFilterMaskVpi=LinfFilterMaskVpi, connRouteFourthryIfIndex=connRouteFourthryIfIndex, perfIfSlotTransmittedCells=perfIfSlotTransmittedCells, clockSlaveLine3Status=clockSlaveLine3Status, connProfileParam3=connProfileParam3, perfIfTransmittedCellsCounters=perfIfTransmittedCellsCounters, perfIfPhysHCHecDropCells=perfIfPhysHCHecDropCells, connRouteOpeFailureCause=connRouteOpeFailureCause, connProfileParam1=connProfileParam1, perfIfPhysBip8Errors=perfIfPhysBip8Errors, m7_corporate=m7_corporate, linfBkwdAvailableBandWidth=linfBkwdAvailableBandWidth, connSoftPvcEstablishedSrcInf=connSoftPvcEstablishedSrcInf, connProfileRowStatus=connProfileRowStatus, connFrProfileCLPValue=connFrProfileCLPValue, pnniNodeRestrictedTransit=pnniNodeRestrictedTransit, nodeOpe=nodeOpe, connRouteTertiaryIfIndex=connRouteTertiaryIfIndex, linf=linf, nodeStatusFan=nodeStatusFan, DstAtmAddressLength=DstAtmAddressLength, connRouteOpeSixthryVPI=connRouteOpeSixthryVPI, connOam=connOam, linfIndex=linfIndex, linfStatusEntry=linfStatusEntry, linfFifoConfRowStatus=linfFifoConfRowStatus, linfFwdAvailableBandWidth=linfFwdAvailableBandWidth, connPvcContrastPort=connPvcContrastPort, perfIfPhysFramingPatternErrors=perfIfPhysFramingPatternErrors, perfIfPhysHCTransmittedCells=perfIfPhysHCTransmittedCells, connLoopOpeVci=connLoopOpeVci, nec_mib=nec_mib, linfPhysType=linfPhysType, cardStatusEntry=cardStatusEntry, connSoftPvcTrafficType=connSoftPvcTrafficType, perfIfSlotInDropCellsCounters=perfIfSlotInDropCellsCounters, connFrProfileName=connFrProfileName, connPvcIndex=connPvcIndex, cardOpeDiagnosis=cardOpeDiagnosis, slotIfConfBufferType=slotIfConfBufferType, slotIfConfTable=slotIfConfTable, connSoftPvcDstParam3=connSoftPvcDstParam3, connPvcVci=connPvcVci, cardOpeCopy=cardOpeCopy, perfIfEntry=perfIfEntry, pnni=pnni, pnniNodeRestrictedBranching=pnniNodeRestrictedBranching, clockOpeAccuracy=clockOpeAccuracy, m7_phase2_mib=m7_phase2_mib, perfIfPhysHCHecErorrs=perfIfPhysHCHecErorrs, diagPreCause=diagPreCause, clockSlaveLine2Status=clockSlaveLine2Status, connConfNodeCompleteSvcs=connConfNodeCompleteSvcs, perfIfPhysHCFramingBitErrors=perfIfPhysHCFramingBitErrors, linfFifoConfSustainRate=linfFifoConfSustainRate, connRouteAtmAddress=connRouteAtmAddress, perfIfPhysHCIecErrors=perfIfPhysHCIecErrors, connOamPoint=connOamPoint, ConnSoftPvcEstSrcInfIndex=ConnSoftPvcEstSrcInfIndex, nodeOpeSaveResult=nodeOpeSaveResult, perfIfPhysHCB3Errors=perfIfPhysHCB3Errors, perfIfPhysParityErrors=perfIfPhysParityErrors, connPvcOpeStatus=connPvcOpeStatus, perfIfPhysFEBEs=perfIfPhysFEBEs, connPvcOpeLowPort=connPvcOpeLowPort, perfIfPhysB1Errors=perfIfPhysB1Errors, pnniNode=pnniNode, connPvcOpeLowVci=connPvcOpeLowVci, perfIfSlotHCUpcErrorCells=perfIfSlotHCUpcErrorCells, LinfCasMode=LinfCasMode, connCeVcUpTimeSlot2=connCeVcUpTimeSlot2, connPvcParam2=connPvcParam2, connFrProfileName2Index=connFrProfileName2Index, connSoftPvcSrcVCI=connSoftPvcSrcVCI, perfIfPhysHCParityErrors=perfIfPhysHCParityErrors, DstSecondaryVPI=DstSecondaryVPI, connLoopOpeAbnormalEndCount=connLoopOpeAbnormalEndCount, cardStatusMode=cardStatusMode, nec=nec, connProfileIndexNext=connProfileIndexNext, connPvcOpeLowFifoIndex=connPvcOpeLowFifoIndex, connSoftPvcDstParam4=connSoftPvcDstParam4, connSvcIndex=connSvcIndex, connPvcTrfEntry=connPvcTrfEntry, connRouteTable=connRouteTable, connOamTable=connOamTable, connLoopOpeStatus=connLoopOpeStatus, connOamVpi=connOamVpi, nodeStatusIndex=nodeStatusIndex, connRoute=connRoute, connLoopOpeLoopBackPointIdLength=connLoopOpeLoopBackPointIdLength, perfIfMisDelivdCells=perfIfMisDelivdCells, cardStatusMateAtmAddr=cardStatusMateAtmAddr, perfIfSlotEntry=perfIfSlotEntry, connOamContrastPort=connOamContrastPort, connLoopOpeCount=connLoopOpeCount, perfIfPhysHCBitErrors=perfIfPhysHCBitErrors, connConf=connConf, connSoftPvcDstParam1=connSoftPvcDstParam1, connPvcContrastVpi=connPvcContrastVpi, connRouteSecondaryVPI=connRouteSecondaryVPI, connCeVcUpTimeSlot1=connCeVcUpTimeSlot1, connProfileParam4=connProfileParam4, clockOpeSlaveLine2=clockOpeSlaveLine2, connSoftPvcSrcParam6=connSoftPvcSrcParam6, cardStatusTable=cardStatusTable, connFrDlciCause=connFrDlciCause, clockSlaveLine2=clockSlaveLine2, connPvcTrfResult=connPvcTrfResult, connSoftPvcTable=connSoftPvcTable, perfIfPhysHecErorrs=perfIfPhysHecErorrs, perfIfPhysPathParityErrors=perfIfPhysPathParityErrors, connRouteOpeSixthryIfIndex=connRouteOpeSixthryIfIndex, LinfFractionalSet=LinfFractionalSet, perfIfPhysHCLineFEBEs=perfIfPhysHCLineFEBEs, connLoopOpeCorrelationTag=connLoopOpeCorrelationTag, connPvcOpeLowVpi=connPvcOpeLowVpi, connFrProfileEntry=connFrProfileEntry, necProduct=necProduct, connFrProfileIndexNext=connFrProfileIndexNext, nodeStatus=nodeStatus, connPvcParam6=connPvcParam6, perfIfPhysEntry=perfIfPhysEntry, linfFifoConfifIndex=linfFifoConfifIndex, perfIfThresholdExcessCellsCounters=perfIfThresholdExcessCellsCounters, connPvcParam4=connPvcParam4, connPvcFifoIndex=connPvcFifoIndex, scale=scale, connFrDlciEntry=connFrDlciEntry, perfIfUpcErrorCellsCounters=perfIfUpcErrorCellsCounters, LinfFrameMode=LinfFrameMode, connRouteOpeFifthryVPI=connRouteOpeFifthryVPI, scaleFileName=scaleFileName, perfIfSlotHCThresholdExcessCells=perfIfSlotHCThresholdExcessCells, connOamContrastVci=connOamContrastVci, nodeOpeCopyResult=nodeOpeCopyResult, node=node, connFrProfileIndex=connFrProfileIndex, linfParam4=linfParam4, LinfLBO=LinfLBO, linfParam6=linfParam6, perfIfPhysHCPathFEBEs=perfIfPhysHCPathFEBEs, scaleStatus=scaleStatus, connCeVcTable=connCeVcTable, connCeVcRowStatus=connCeVcRowStatus, matCmd=matCmd, connFrProfileCongestionMode=connFrProfileCongestionMode, connOamContrastVpi=connOamContrastVpi, connSoftPvcDstVPI=connSoftPvcDstVPI, connRouteOpePrimaryIfIndex=connRouteOpePrimaryIfIndex)
mibBuilder.exportSymbols("NEC-MIB", perfIfIndex=perfIfIndex, connRoutePrimaryCause=connRoutePrimaryCause, nodeStatusSwitch=nodeStatusSwitch, LinfUnUsedParam=LinfUnUsedParam, connPvcOpeHighParam1=connPvcOpeHighParam1, clockSlaveLine1Status=clockSlaveLine1Status, slotIfConfPhysType=slotIfConfPhysType, connOamMode=connOamMode, connSoftPvcDstAtmAddressFormat=connSoftPvcDstAtmAddressFormat, matCmdStop=matCmdStop, connSoftPvcSrcFifoIndex=connSoftPvcSrcFifoIndex, matCmdOutputType=matCmdOutputType, connSoftPvcDstAtmAddressLength=connSoftPvcDstAtmAddressLength, perfIfPhysSEZs=perfIfPhysSEZs, connRouteOpeSecondaryVPI=connRouteOpeSecondaryVPI, nodeStatusTable=nodeStatusTable, connSoftPvcDstIfIndex=connSoftPvcDstIfIndex, connFrDlciTable=connFrDlciTable, perfIfPhysHCFramingErrors=perfIfPhysHCFramingErrors, connOamDefectType=connOamDefectType, connConfIfPvcs=connConfIfPvcs, connCeVcUpTimeSlot3=connCeVcUpTimeSlot3, linfParam2=linfParam2, nodeStatusEnvironment=nodeStatusEnvironment, clockSlaveLine4=clockSlaveLine4, clock=clock)
