...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:11:34 2025
...
RttMonRttType, RttMonReactVar, RttMonIdLst, RttResponseSense, RttMonCtrlIndex = mibBuilder.importSymbols("CISCO-RTTMON-TC-MIB", "RttMonRttType", "RttMonReactVar", "RttMonIdLst", "RttResponseSense", "RttMonCtrlIndex")
...
mibBuilder.exportSymbols("CISCO-IPSLA-ETHERNET-MIB", ipslaEtherJAggMeasuredOWSum2DSHs=ipslaEtherJAggMeasuredOWSum2DSHs, ipslaEtherJitterLatestNumOverThresh=ipslaEtherJitterLatestNumOverThresh, ipslaEtherDelayAggMeasuredRTTMin=ipslaEtherDelayAggMeasuredRTTMin, ipslaEthernetGrpCtrlDomainName=ipslaEthernetGrpCtrlDomainName, ipslaEtherJitterLatestNumPosSD=ipslaEtherJitterLatestNumPosSD, ipslaEtherJitterLatestMinPosSD=ipslaEtherJitterLatestMinPosSD, ipslaEtherJitterLatestSumPosSD=ipslaEtherJitterLatestSumPosSD, ciscoIpSlaEthernetCompliance=ciscoIpSlaEthernetCompliance, ipslaEtherJitterLatestMaxPosSD=ipslaEtherJitterLatestMaxPosSD, ipslaEtherJAggStatsBinStartTimeId=ipslaEtherJAggStatsBinStartTimeId, ipslaEtherJitterLatestMaxSucFrmL=ipslaEtherJitterLatestMaxSucFrmL, ipslaEtherDelayAggMeasuredNumNegTW=ipslaEtherDelayAggMeasuredNumNegTW, ipslaEtherJAggMeasuredFrmSkippds=ipslaEtherJAggMeasuredFrmSkippds, ipslaEtherJAggMeasuredOWSum2SDHs=ipslaEtherJAggMeasuredOWSum2SDHs, ipslaEtherJAggMeasuredRxFrmsSD=ipslaEtherJAggMeasuredRxFrmsSD, ipslaEtherJitterLatestOWSum2SD=ipslaEtherJitterLatestOWSum2SD, ipslaEtherJAggMeasuredRTTMin=ipslaEtherJAggMeasuredRTTMin, ipslaEtherDelayAggMeasuredMinNegDS=ipslaEtherDelayAggMeasuredMinNegDS, ipslaEthernetGrpCtrlInterval=ipslaEthernetGrpCtrlInterval, ipslaEtherJAggMeasuredFrmMIAes=ipslaEtherJAggMeasuredFrmMIAes, ipslaEtherJAggMeasuredNumRTTs=ipslaEtherJAggMeasuredNumRTTs, ipslaEtherJitterAggBinTable=ipslaEtherJitterAggBinTable, ipslaEthernetGrpSchedulePeriod=ipslaEthernetGrpSchedulePeriod, ciscoIpSlaEthernetMIBGroups=ciscoIpSlaEthernetMIBGroups, ipslaEtherJAggMeasuredSum2NDSLs=ipslaEtherJAggMeasuredSum2NDSLs, ipslaEthernetGrpCtrlTag=ipslaEthernetGrpCtrlTag, ipslaEthernetGrpScheduleRttStartTime=ipslaEthernetGrpScheduleRttStartTime, ipslaEtherJAggMeasuredTxFrmsSD=ipslaEtherJAggMeasuredTxFrmsSD, ipslaEtherJitterLatestMinNegSD=ipslaEtherJitterLatestMinNegSD, ipslaEtherJitterLatestMaxPosDS=ipslaEtherJitterLatestMaxPosDS, ipslaEtherJAggMeasuredCumulativeLossDenominatorSD=ipslaEtherJAggMeasuredCumulativeLossDenominatorSD, ipslaEtherJitterLatestFrmLossSD=ipslaEtherJitterLatestFrmLossSD, ipslaEtherJAggMeasuredOWMinDS=ipslaEtherJAggMeasuredOWMinDS, ipslaEthernetGrpReactActionType=ipslaEthernetGrpReactActionType, ipslaEthernetGrpReactVar=ipslaEthernetGrpReactVar, ipslaEtherJitterLatestNumRTT=ipslaEtherJitterLatestNumRTT, ciscoIpSlaEthernetMIBObjects=ciscoIpSlaEthernetMIBObjects, ipslaEthernetGrpReactEntry=ipslaEthernetGrpReactEntry, ipslaEtherJitterLatestOWMaxSD=ipslaEtherJitterLatestOWMaxSD, ipslaEtherJAggMeasuredMinNegSD=ipslaEtherJAggMeasuredMinNegSD, ipslaEtherDelayAggMeasuredSumNegTW=ipslaEtherDelayAggMeasuredSumNegTW, ipslaEtherJAggMeasuredOvThrshlds=ipslaEtherJAggMeasuredOvThrshlds, ipslaEthernetGrpCtrlReqDataSize=ipslaEthernetGrpCtrlReqDataSize, ipslaEtherJAggMinSucFrmLoss=ipslaEtherJAggMinSucFrmLoss, ipslaEthernetGrpReactStatus=ipslaEthernetGrpReactStatus, ipslaEtherJAggMeasuredErrors=ipslaEtherJAggMeasuredErrors, ipslaEthernetGrpCtrlNumFrames=ipslaEthernetGrpCtrlNumFrames, ipslaEtherJitterLatestOWMinDS=ipslaEtherJitterLatestOWMinDS, ipslaEthernetGrpCtrlThreshold=ipslaEthernetGrpCtrlThreshold, PYSNMP_MODULE_ID=ciscoIpSlaEthernetMIB, ipslaEtherJitterLatestSum2NegDS=ipslaEtherJitterLatestSum2NegDS, ipslaEtherJAggMeasuredMaxPosDS=ipslaEtherJAggMeasuredMaxPosDS, ipslaEtherJAggMeasuredFrmLossSDs=ipslaEtherJAggMeasuredFrmLossSDs, ipslaEtherJitterLatestStatsEntry=ipslaEtherJitterLatestStatsEntry, ipslaEtherJAggMeasuredNumPosSDs=ipslaEtherJAggMeasuredNumPosSDs, ipslaEtherJAggStatsStartTimeId=ipslaEtherJAggStatsStartTimeId, ipslaEtherJAggMeasuredCumulativeAvgLossDenominatorSD=ipslaEtherJAggMeasuredCumulativeAvgLossDenominatorSD, ipslaEthernetStats=ipslaEthernetStats, ipslaEtherJAggStatsBinType=ipslaEtherJAggStatsBinType, ipslaEtherJAggMeasuredOWSum2DSLs=ipslaEtherJAggMeasuredOWSum2DSLs, ciscoIpSlaEthernetY1731BinStatsGroup=ciscoIpSlaEthernetY1731BinStatsGroup, ipslaEtherJAggMeasuredSum2PSDHs=ipslaEtherJAggMeasuredSum2PSDHs, ipslaEtherJitterLatestOWAvgSD=ipslaEtherJitterLatestOWAvgSD, ipslaEtherDelayAggMeasuredSumNegSDs=ipslaEtherDelayAggMeasuredSumNegSDs, ipslaEtherDelayAggMeasuredSumPosTW=ipslaEtherDelayAggMeasuredSumPosTW, ipslaEtherJitterLatestOWMinSD=ipslaEtherJitterLatestOWMinSD, ipslaEthernetGrpCtrlStatus=ipslaEthernetGrpCtrlStatus, ipslaEthernetGrpReactThresholdCountX=ipslaEthernetGrpReactThresholdCountX, ipslaEthernetGrpCtrlMPIDExLst=ipslaEthernetGrpCtrlMPIDExLst, ipslaEtherLossAggMeasuredLostFrmsSD=ipslaEtherLossAggMeasuredLostFrmsSD, ipslaEtherJitterLatestFrmMIA=ipslaEtherJitterLatestFrmMIA, ciscoIpSlaEthernetMIB=ciscoIpSlaEthernetMIB, ipslaEtherJitterAggStatsTable=ipslaEtherJitterAggStatsTable, ipslaEtherJAggMeasuredNumNegSDs=ipslaEtherJAggMeasuredNumNegSDs, ipslaEtherJitterLatestRTTMin=ipslaEtherJitterLatestRTTMin, ipslaEtherJAggMeasuredBusies=ipslaEtherJAggMeasuredBusies, ipslaEtherJAggMeasuredMinLossNumeratorDS=ipslaEtherJAggMeasuredMinLossNumeratorDS, ciscoIpSlaEthernetY1731Group=ciscoIpSlaEthernetY1731Group, ipslaEtherDelayAggMeasuredOWMinSD=ipslaEtherDelayAggMeasuredOWMinSD, ipslaEthernetGrpCtrlTable=ipslaEthernetGrpCtrlTable, ipslaEtherJAggMeasuredSumNegDSes=ipslaEtherJAggMeasuredSumNegDSes, ipslaEtherJAggMeasuredCumulativeLossNumeratorDS=ipslaEtherJAggMeasuredCumulativeLossNumeratorDS, ipslaEtherJAggMeasuredAvgLossDenominatorDS=ipslaEtherJAggMeasuredAvgLossDenominatorDS, ipslaEtherDelayAggMeasuredOWSumDSes=ipslaEtherDelayAggMeasuredOWSumDSes, ipslaEtherJAggMaxSucFrmLoss=ipslaEtherJAggMaxSucFrmLoss, ipslaEtherJAggMeasuredNumNegDSes=ipslaEtherJAggMeasuredNumNegDSes, ipslaEtherJitterLatestFrmSkipped=ipslaEtherJitterLatestFrmSkipped, ipslaEtherJAggMeasuredMinNegTW=ipslaEtherJAggMeasuredMinNegTW, ipslaEtherJAggMeasuredCumulativeAvgLossNumeratorDS=ipslaEtherJAggMeasuredCumulativeAvgLossNumeratorDS, ipslaEtherDelayAggMeasuredOWMaxDS=ipslaEtherDelayAggMeasuredOWMaxDS, ipslaEtherJitterLatestStatsTable=ipslaEtherJitterLatestStatsTable, ipslaEtherJitterLatestSum2NegSD=ipslaEtherJitterLatestSum2NegSD, ipslaEtherJitterLatestMaxNegDS=ipslaEtherJitterLatestMaxNegDS, ipslaEtherJAggMeasuredFrmOutSeqs=ipslaEtherJAggMeasuredFrmOutSeqs, ciscoIpSlaEthernetStatsGroup=ciscoIpSlaEthernetStatsGroup, ipslaEtherJAggMeasuredMinPosSD=ipslaEtherJAggMeasuredMinPosSD, ipslaEtherJAggMeasuredIAJIn=ipslaEtherJAggMeasuredIAJIn, ipslaEtherJAggStatsBinLowerRange=ipslaEtherJAggStatsBinLowerRange, ipslaEtherJAggMeasuredOWMinSD=ipslaEtherJAggMeasuredOWMinSD, ipslaEtherJAggMeasuredCumulativeLossDenominatorDS=ipslaEtherJAggMeasuredCumulativeLossDenominatorDS, ipslaEtherDelayAggMeasuredAvgJSD=ipslaEtherDelayAggMeasuredAvgJSD, ipslaEtherJitterLatestOWSumSD=ipslaEtherJitterLatestOWSumSD, ipslaEtherJAggMeasuredFrmLssDSes=ipslaEtherJAggMeasuredFrmLssDSes, ipslaEtherJAggMeasuredMaxLossNumeratorDS=ipslaEtherJAggMeasuredMaxLossNumeratorDS, ipslaEtherJAggStatsBinObservation=ipslaEtherJAggStatsBinObservation, ciscoIpSlaEthernetCompliances=ciscoIpSlaEthernetCompliances, ipslaEtherDelayAggMeasuredOWMinDS=ipslaEtherDelayAggMeasuredOWMinDS, ipslaEtherDelayAggMeasuredAvgJDS=ipslaEtherDelayAggMeasuredAvgJDS, ciscoIpSlaEthernetComplianceRev3=ciscoIpSlaEthernetComplianceRev3, ipslaEtherJitterLatestSumPosDS=ipslaEtherJitterLatestSumPosDS, ipslaEtherDelayAggMeasuredMaxPosTW=ipslaEtherDelayAggMeasuredMaxPosTW, ipslaEtherDelayAggMeasuredMaxNegTW=ipslaEtherDelayAggMeasuredMaxNegTW, ciscoIpSlaEthernetMIBConform=ciscoIpSlaEthernetMIBConform, ipslaEtherJAggMeasuredRTTSum2Hs=ipslaEtherJAggMeasuredRTTSum2Hs, ipslaEthernetGrpReactStorageType=ipslaEthernetGrpReactStorageType, ipslaEtherJAggMeasuredMaxPosTW=ipslaEtherJAggMeasuredMaxPosTW, ipslaEtherDelayAggMeasuredMaxPosSD=ipslaEtherDelayAggMeasuredMaxPosSD, ipslaEtherDelayAggMeasuredRTTMax=ipslaEtherDelayAggMeasuredRTTMax, ipslaEtherJAggMeasuredFrmUnPrcds=ipslaEtherJAggMeasuredFrmUnPrcds, ipslaEtherDelayAggMeasuredOWMaxSD=ipslaEtherDelayAggMeasuredOWMaxSD, ciscoIpSlaEthernetComplianceRev4=ciscoIpSlaEthernetComplianceRev4, ipslaEtherJitterLatestAvgJitter=ipslaEtherJitterLatestAvgJitter, ipslaEtherJitterLatestRTTSum2=ipslaEtherJitterLatestRTTSum2, ipslaEtherJAggMeasuredRTTSum2Ls=ipslaEtherJAggMeasuredRTTSum2Ls, ipslaEtherJAggMeasuredMinNegDS=ipslaEtherJAggMeasuredMinNegDS, ipslaEtherJAggMeasuredSum2NDSHs=ipslaEtherJAggMeasuredSum2NDSHs, ipslaEtherJAggMeasuredRTTMax=ipslaEtherJAggMeasuredRTTMax, ipslaEtherJLatestFrmUnProcessed=ipslaEtherJLatestFrmUnProcessed, ipslaEtherJitterLatestSum2PosDS=ipslaEtherJitterLatestSum2PosDS, ciscoIpSlaEthernetAutoEVCGroup=ciscoIpSlaEthernetAutoEVCGroup, ipslaEtherJitterLatestRTTSum=ipslaEtherJitterLatestRTTSum, ipslaEtherJAggLossMeasurementRate=ipslaEtherJAggLossMeasurementRate, ipslaEtherJAggMeasuredAvgLossDenominatorSD=ipslaEtherJAggMeasuredAvgLossDenominatorSD, ipslaEtherJAggMeasuredSum2NSDLs=ipslaEtherJAggMeasuredSum2NSDLs, ipslaEtherJitterLatestSense=ipslaEtherJitterLatestSense, ipslaEthernetGrpCtrlRttType=ipslaEthernetGrpCtrlRttType, ipslaEtherJAggMeasuredSum2NSDHs=ipslaEtherJAggMeasuredSum2NSDHs, ipslaEtherJAggMeasuredCumulativeAvgLossNumeratorSD=ipslaEtherJAggMeasuredCumulativeAvgLossNumeratorSD, ipslaEtherJAggMeasuredMaxNegDS=ipslaEtherJAggMeasuredMaxNegDS, ciscoIpSlaEthernetDelayStatsGroup=ciscoIpSlaEthernetDelayStatsGroup, ipslaEtherJAggMeasuredAvgJDS=ipslaEtherJAggMeasuredAvgJDS, ipslaEtherJitterLatestOWAvgDS=ipslaEtherJitterLatestOWAvgDS, ipslaEtherJAggMeasuredOWSum2SDLs=ipslaEtherJAggMeasuredOWSum2SDLs, ipslaEtherDelayAggMeasuredOWSumSDs=ipslaEtherDelayAggMeasuredOWSumSDs, ipslaEtherJitterLatestFrmLateA=ipslaEtherJitterLatestFrmLateA, ipslaEtherDelayAggMeasuredNumPosTW=ipslaEtherDelayAggMeasuredNumPosTW, ipslaEtherDelayAggMeasuredMinNegTW=ipslaEtherDelayAggMeasuredMinNegTW, ipslaEtherJAggMeasuredNumPosDSes=ipslaEtherJAggMeasuredNumPosDSes, ipslaEthernetGrpCtrlDomainNameType=ipslaEthernetGrpCtrlDomainNameType, ipslaEtherDelayAggMeasuredMinPosDS=ipslaEtherDelayAggMeasuredMinPosDS, ipslaEtherJitterLatestAvgDSJ=ipslaEtherJitterLatestAvgDSJ, ipslaEtherDelayAggMeasuredMaxPosDS=ipslaEtherDelayAggMeasuredMaxPosDS, ipslaEtherJAggMeasuredAvgLossNumeratorDS=ipslaEtherJAggMeasuredAvgLossNumeratorDS, ipslaEtherJAggMeasuredCumulativeAvgLossDenominatorDS=ipslaEtherJAggMeasuredCumulativeAvgLossDenominatorDS, ipslaEtherJAggMeasuredFrmLateAs=ipslaEtherJAggMeasuredFrmLateAs, ipslaEtherDelayAggMeasuredMaxNegSD=ipslaEtherDelayAggMeasuredMaxNegSD, ciscoIpSlaEthernetComplianceRev2=ciscoIpSlaEthernetComplianceRev2, ipslaEthernetGrpReactTable=ipslaEthernetGrpReactTable, ipslaEtherJAggMeasuredSum2PSDLs=ipslaEtherJAggMeasuredSum2PSDLs, ipslaEtherDelayAggMeasuredTWAvgJ=ipslaEtherDelayAggMeasuredTWAvgJ, ipslaEtherJAggMeasuredMaxLossDenominatorSD=ipslaEtherJAggMeasuredMaxLossDenominatorSD, ipslaEtherJAggMeasuredSumPosDSes=ipslaEtherJAggMeasuredSumPosDSes, ipslaEtherJAggMeasuredMinPosDS=ipslaEtherJAggMeasuredMinPosDS, ipslaEthernetGrpCtrlIndex=ipslaEthernetGrpCtrlIndex, ipslaEtherJAggMeasuredOWSumDSes=ipslaEtherJAggMeasuredOWSumDSes, ipslaEthernetGrpScheduleFrequency=ipslaEthernetGrpScheduleFrequency, ipslaEtherJAggMeasuredNumOWs=ipslaEtherJAggMeasuredNumOWs, ipslaEtherJitterLatestNumNegSD=ipslaEtherJitterLatestNumNegSD, ipslaEtherJAggMeasuredSum2PDSLs=ipslaEtherJAggMeasuredSum2PDSLs, ipslaEthernetGrpCtrlTimeout=ipslaEthernetGrpCtrlTimeout, ipslaEtherJitterLatestMinPosDS=ipslaEtherJitterLatestMinPosDS, ipslaEthernetGrpCtrlEntry=ipslaEthernetGrpCtrlEntry, ipslaEthernetGrpCtrlVLAN=ipslaEthernetGrpCtrlVLAN, ipslaEtherJitterLatestOWSum2DS=ipslaEtherJitterLatestOWSum2DS, ipslaEtherJitterLatestAvgSDJ=ipslaEtherJitterLatestAvgSDJ, ciscoIpSlaEthernetOverThreshGroup=ciscoIpSlaEthernetOverThreshGroup, ipslaEtherJitterLatestFrmLossDS=ipslaEtherJitterLatestFrmLossDS, ipslaEtherDelayAggMeasuredSumPosSDs=ipslaEtherDelayAggMeasuredSumPosSDs, ipslaEtherJitterLatestNumPosDS=ipslaEtherJitterLatestNumPosDS, ipslaEtherJitterLatestSumNegDS=ipslaEtherJitterLatestSumNegDS, ipslaEtherJAggMeasuredOWSumSDs=ipslaEtherJAggMeasuredOWSumSDs, ipslaEtherDelayAggMeasuredMaxNegDS=ipslaEtherDelayAggMeasuredMaxNegDS, ipslaEtherJAggMeasuredMaxLossDenominatorDS=ipslaEtherJAggMeasuredMaxLossDenominatorDS, ipslaEthernetGrpReactThresholdCountY=ipslaEthernetGrpReactThresholdCountY, ipslaEtherJAggMeasuredRTTSums=ipslaEtherJAggMeasuredRTTSums, ipslaEtherJAggMeasuredOWMaxSD=ipslaEtherJAggMeasuredOWMaxSD, ipslaEtherJitterLatestMaxNegSD=ipslaEtherJitterLatestMaxNegSD, ipslaEtherJAggMeasuredMinLossDenominatorSD=ipslaEtherJAggMeasuredMinLossDenominatorSD, ipslaEthernetGrpCtrlOwner=ipslaEthernetGrpCtrlOwner, ipslaEtherLossAggMeasuredLostFrmsDS=ipslaEtherLossAggMeasuredLostFrmsDS, ipslaEthernetGrpCtrlProbeList=ipslaEthernetGrpCtrlProbeList, ipslaEtherJitterLatestMinNegDS=ipslaEtherJitterLatestMinNegDS, ipslaEtherJitterLatestIAJOut=ipslaEtherJitterLatestIAJOut, ipslaEtherJitterAggBinEntry=ipslaEtherJitterAggBinEntry, ipslaEtherJAggMeasuredAvgJ=ipslaEtherJAggMeasuredAvgJ, ipslaEtherJitterLatestRTTMax=ipslaEtherJitterLatestRTTMax, ipslaEtherJAggMeasuredOWMaxDS=ipslaEtherJAggMeasuredOWMaxDS, ipslaEtherJAggMeasuredMaxPosSD=ipslaEtherJAggMeasuredMaxPosSD, ipslaEtherJitterAggStatsEntry=ipslaEtherJitterAggStatsEntry, ipslaEtherJAggMeasuredSum2PDSHs=ipslaEtherJAggMeasuredSum2PDSHs, ipslaEtherDelayAggMeasuredMinNegSD=ipslaEtherDelayAggMeasuredMinNegSD, ipslaEthernetGrpReactThresholdRising=ipslaEthernetGrpReactThresholdRising, ipslaEthernetLatestOper=ipslaEthernetLatestOper, ciscoIpSlaEthernetComplianceRev6=ciscoIpSlaEthernetComplianceRev6, ipslaEtherJitterLatestSum2PosSD=ipslaEtherJitterLatestSum2PosSD, ipslaEtherJAggMeasuredSumNegSDs=ipslaEtherJAggMeasuredSumNegSDs, ipslaEthernetGrpReactThresholdType=ipslaEthernetGrpReactThresholdType, ipslaEthernetGrpCtrlEVC=ipslaEthernetGrpCtrlEVC, ipslaEthernetGrpCtrlCOS=ipslaEthernetGrpCtrlCOS, ipslaEtherJAggMeasuredNumOverThresh=ipslaEtherJAggMeasuredNumOverThresh, ipslaEtherJAggMeasuredMaxNegTW=ipslaEtherJAggMeasuredMaxNegTW, ipslaEtherJitterLatestOWSumDS=ipslaEtherJitterLatestOWSumDS, ipslaEtherJitterLatestIAJIn=ipslaEtherJitterLatestIAJIn, ipslaEthernetGrpCtrlStorageType=ipslaEthernetGrpCtrlStorageType, ipslaEtherJAggMeasuredRxFrmsDS=ipslaEtherJAggMeasuredRxFrmsDS, ipslaEtherJAggMeasuredSumPosSDs=ipslaEtherJAggMeasuredSumPosSDs, ipslaEtherJAggMeasuredMinLossDenominatorDS=ipslaEtherJAggMeasuredMinLossDenominatorDS, ipslaEtherDelayAggMeasuredSumNegDSes=ipslaEtherDelayAggMeasuredSumNegDSes, ipslaEtherJAggMeasuredMinPosTW=ipslaEtherJAggMeasuredMinPosTW, ipslaEtherJitterLatestMinSucFrmL=ipslaEtherJitterLatestMinSucFrmL, ipslaEtherDelayAggMeasuredAvgJ=ipslaEtherDelayAggMeasuredAvgJ, ipslaEthernetGrpReactThresholdFalling=ipslaEthernetGrpReactThresholdFalling, ipslaEtherDelayAggMeasuredRTTSums=ipslaEtherDelayAggMeasuredRTTSums, ipslaEtherJAggMeasuredIAJOut=ipslaEtherJAggMeasuredIAJOut, ipslaEthernetGrpCtrlServiceInsType=ipslaEthernetGrpCtrlServiceInsType, ipslaEtherJitterLatestOWMaxDS=ipslaEtherJitterLatestOWMaxDS, ipslaEtherJitterLatestFrmOutSeq=ipslaEtherJitterLatestFrmOutSeq, ipslaEtherJitterLatestSumNegSD=ipslaEtherJitterLatestSumNegSD, ciscoIpSlaEthernetComplianceRev5=ciscoIpSlaEthernetComplianceRev5, ipslaEthernetGrpReactConfigIndex=ipslaEthernetGrpReactConfigIndex, ipslaEtherJAggMeasuredAvgLossNumeratorSD=ipslaEtherJAggMeasuredAvgLossNumeratorSD, ipslaEtherJAggMeasuredMaxNegSD=ipslaEtherJAggMeasuredMaxNegSD, ipslaEtherDelayAggMeasuredMinPosTW=ipslaEtherDelayAggMeasuredMinPosTW, ciscoIpSlaEthernetMIBNotifs=ciscoIpSlaEthernetMIBNotifs, ipslaEtherJAggMeasuredCumulativeLossNumeratorSD=ipslaEtherJAggMeasuredCumulativeLossNumeratorSD, ipslaEtherDelayAggMeasuredMinPosSD=ipslaEtherDelayAggMeasuredMinPosSD, ipslaEtherJitterLatestNumOW=ipslaEtherJitterLatestNumOW, ipslaEthernetGrpCtrl=ipslaEthernetGrpCtrl, ipslaEtherJAggMeasuredCmpletions=ipslaEtherJAggMeasuredCmpletions, ipslaEtherJAggMeasuredAvgJSD=ipslaEtherJAggMeasuredAvgJSD, ipslaEtherJAggMeasuredTxFrmsDS=ipslaEtherJAggMeasuredTxFrmsDS, ipslaEtherJAggMeasuredMaxLossNumeratorSD=ipslaEtherJAggMeasuredMaxLossNumeratorSD, ciscoIpSlaEthernetAutoGroup=ciscoIpSlaEthernetAutoGroup, ipslaEtherJitterLatestNumNegDS=ipslaEtherJitterLatestNumNegDS, ipslaEtherJAggMeasuredMinLossNumeratorSD=ipslaEtherJAggMeasuredMinLossNumeratorSD, ipslaEtherDelayAggMeasuredSumPosDSes=ipslaEtherDelayAggMeasuredSumPosDSes, ipslaEtherJAggStatsBinUpperRange=ipslaEtherJAggStatsBinUpperRange)
