...
mibBuilder.exportSymbols("PNNI-MIB", pnniIfAdmWeightRtVbr=pnniIfAdmWeightRtVbr, PnniPrefixLength=PnniPrefixLength, pnniSvccRccXmtHellos=pnniSvccRccXmtHellos, pnniNodePeerDelayedAckInterval=pnniNodePeerDelayedAckInterval, pnniPtseType=pnniPtseType, pnniLinkRemoteNodeId=pnniLinkRemoteNodeId, pnniRouteNodeBwdMetric7=pnniRouteNodeBwdMetric7, pnniMapTnsAdvertisingNodeId=pnniMapTnsAdvertisingNodeId, pnniNodeSvccTrafficDescriptorIndex=pnniNodeSvccTrafficDescriptorIndex, pnniNodePglLeadershipPriority=pnniNodePglLeadershipPriority, pnniIfNodeIndex=pnniIfNodeIndex, pnniRouteTnsTable=pnniRouteTnsTable, pnniRouteNodeTable=pnniRouteNodeTable, pnniPtseLifeTime=pnniPtseLifeTime, pnniLinkPortId=pnniLinkPortId, pnniMapMetricsTag=pnniMapMetricsTag, pnniRouteFailUnreachableOriginator=pnniRouteFailUnreachableOriginator, pnniNodeLowest=pnniNodeLowest, pnniRouteNodeEntry=pnniRouteNodeEntry, pnniRouteAddrIndex=pnniRouteAddrIndex, pnniMetrics2=pnniMetrics2, pnniSvccRccIfIndex=pnniSvccRccIfIndex, pnniMetrics4=pnniMetrics4, pnniNodeRestrictedTransit=pnniNodeRestrictedTransit, pnniRouteNodeFwdMetric1=pnniRouteNodeFwdMetric1, PnniAggrToken=PnniAggrToken, pnniPtseOptionalGroup=pnniPtseOptionalGroup, pnniRoutingGroup=pnniRoutingGroup, pnniNbrPeerPortTable=pnniNbrPeerPortTable, pnniMapAddrAdvertisedPortId=pnniMapAddrAdvertisedPortId, pnniLinkDerivedAggrToken=pnniLinkDerivedAggrToken, pnniRouteTnsProto=pnniRouteTnsProto, pnniRouteNodeBwdMetric4=pnniRouteNodeBwdMetric4, pnniNbrPeerRemoteNodeId=pnniNbrPeerRemoteNodeId, pnniMapNodeEntry=pnniMapNodeEntry, TnsType=TnsType, pnniMapAddrAddress=pnniMapAddrAddress, pnniNodeSvccTable=pnniNodeSvccTable, pnniRouteAddrPnniScope=pnniRouteAddrPnniScope, pnniNodePglMinGroup=pnniNodePglMinGroup, pnniRouteTnsTimeStamp=pnniRouteTnsTimeStamp, pnniSummaryAddressPrefixLength=pnniSummaryAddressPrefixLength, pnniRouteNodeBwdMetric6=pnniRouteNodeBwdMetric6, pnniRouteTnsIfIndex=pnniRouteTnsIfIndex, pnniRouteTnsOriginateAdvertisement=pnniRouteTnsOriginateAdvertisement, pnniRouteAddrType=pnniRouteAddrType, pnniSummaryAddressAddress=pnniSummaryAddressAddress, pnniMapTnsOptionalGroup=pnniMapTnsOptionalGroup, pnniNbrPeerState=pnniNbrPeerState, pnniSvccRccRemoteAtmAddress=pnniSvccRccRemoteAtmAddress, ClpType=ClpType, pnniDtlCountBorder=pnniDtlCountBorder, pnniMapRemoteNodeId=pnniMapRemoteNodeId, pnniMapNodeAtmAddress=pnniMapNodeAtmAddress, pnniMetrics1=pnniMetrics1, pnniNodeHlinkInact=pnniNodeHlinkInact, pnniNodePglState=pnniNodePglState, pnniNodeRestrictedBranching=pnniNodeRestrictedBranching, pnniRouteNodeBwdMetric3=pnniRouteNodeBwdMetric3, pnniNodeHelloInactivityFactor=pnniNodeHelloInactivityFactor, pnniPtseEntry=pnniPtseEntry, pnniMapOptionalGroup=pnniMapOptionalGroup, pnniScopeGlobal=pnniScopeGlobal, pnniRouteGeneralOptionalGroup=pnniRouteGeneralOptionalGroup, pnniMapNodeRestrictedBranching=pnniMapNodeRestrictedBranching, pnniRouteTnsMetricsTag=pnniRouteTnsMetricsTag, pnniMapOriginatingPortId=pnniMapOriginatingPortId, pnniMetrics6=pnniMetrics6, pnniNodePtseRefreshInterval=pnniNodePtseRefreshInterval, pnniRouteNodeBwdMetric5=pnniRouteNodeBwdMetric5, pnniRouteNodeFwdMetric2=pnniRouteNodeFwdMetric2, pnniLinkType=pnniLinkType, pnniGeneralBorderGroup=pnniGeneralBorderGroup, pnniIfRccTrafficDescrIndex=pnniIfRccTrafficDescrIndex, pnniScopeRegional=pnniScopeRegional, pnniIfEntry=pnniIfEntry, pnniPtseSequenceNum=pnniPtseSequenceNum, pnniMapNodeParentPglNodeId=pnniMapNodeParentPglNodeId, pnniSummaryType=pnniSummaryType, pnniMapNodePeerGroupId=pnniMapNodePeerGroupId, pnniNbrPeerXmtPtseReqs=pnniNbrPeerXmtPtseReqs, pnniNbrPeerPortCount=pnniNbrPeerPortCount, pnniRouteNodeFwdMetricAW=pnniRouteNodeFwdMetricAW, pnniDTLPortId=pnniDTLPortId, pnniMetrics8=pnniMetrics8, pnniNbrPeerPortFloodStatus=pnniNbrPeerPortFloodStatus, PnniSvccRccIndex=PnniSvccRccIndex, pnniLinkEntry=pnniLinkEntry, pnniSvccRccEntry=pnniSvccRccEntry, pnniRouteAddrTable=pnniRouteAddrTable, pnniMetrics7=pnniMetrics7, pnniMetricsTag=pnniMetricsTag, pnniIfBorderGroup=pnniIfBorderGroup, pnniAltRouteCountBorder=pnniAltRouteCountBorder, pnniNodeAvcrMt=pnniNodeAvcrMt, PnniPortId=PnniPortId, pnniLinkSvccRccIndex=pnniLinkSvccRccIndex, pnniNodeTimerEntry=pnniNodeTimerEntry, pnniRouteNodeNumber=pnniRouteNodeNumber, pnniSvccRccTable=pnniSvccRccTable, pnniMapAggrToken=pnniMapAggrToken, pnniMetricsAdminWeight=pnniMetricsAdminWeight, pnniRouteNodeDTL=pnniRouteNodeDTL, pnniNodePeerGroupLeader=pnniNodePeerGroupLeader, pnniMapAddrEntry=pnniMapAddrEntry, pnniPtseTable=pnniPtseTable, pnniMapTnsEntry=pnniMapTnsEntry, pnniNbrPeerSvccRccIndex=pnniNbrPeerSvccRccIndex, pnniMapNodeComplexRep=pnniMapNodeComplexRep, pnniMetricsDirection=pnniMetricsDirection, pnniHighestVersion=pnniHighestVersion, pnniNodeSvccInitTime=pnniNodeSvccInitTime, pnniMapNodeTable=pnniMapNodeTable, pnniCrankbackCountBorder=pnniCrankbackCountBorder, pnniNodeActiveParentNodeId=pnniNodeActiveParentNodeId, pnniMapTnsType=pnniMapTnsType, pnniMetricsClasses=pnniMetricsClasses, pnniScopeLocalNetwork=pnniScopeLocalNetwork, pnniNodeSvccRetryTime=pnniNodeSvccRetryTime, pnniRouteTnsAdvertisingNodeId=pnniRouteTnsAdvertisingNodeId, pnniNodeCtdPm=pnniNodeCtdPm, pnniSummaryEntry=pnniSummaryEntry, pnniLinkUpnodeAtmAddress=pnniLinkUpnodeAtmAddress, pnniDTLOptionalGroup=pnniDTLOptionalGroup, atmfPnni=atmfPnni, pnniRouteTnsEntry=pnniRouteTnsEntry, pnniNodePglTimeStamp=pnniNodePglTimeStamp, pnniNbrPeerRcvPtsps=pnniNbrPeerRcvPtsps, pnniSvccRccHelloState=pnniSvccRccHelloState, pnniMapPtseId=pnniMapPtseId, pnniRouteTnsRowStatus=pnniRouteTnsRowStatus, pnniMapIndex=pnniMapIndex, pnniMetricsRowStatus=pnniMetricsRowStatus, pnniIfRccServiceCategory=pnniIfRccServiceCategory, pnniNodeCfgParentNodeIndex=pnniNodeCfgParentNodeIndex, PnniHelloState=PnniHelloState, pnniRouteNodeBwdMetric1=pnniRouteNodeBwdMetric1, pnniRouteAddrAdvertisingNodeId=pnniRouteAddrAdvertisingNodeId, pnniDTLStatus=pnniDTLStatus, PYSNMP_MODULE_ID=pnniMIB, pnniRouteNodeBwdMetricAW=pnniRouteNodeBwdMetricAW, pnniNodeId=pnniNodeId, pnniRouteFailCountOriginator=pnniRouteFailCountOriginator, pnniMapNodeOptionalGroup=pnniMapNodeOptionalGroup, pnniRouteNodeFwdMetric6=pnniRouteNodeFwdMetric6, pnniSvccRccRcvHellos=pnniSvccRccRcvHellos, pnniSummaryRowStatus=pnniSummaryRowStatus, pnniRouteAddrOperStatus=pnniRouteAddrOperStatus, pnniNbrPeerTable=pnniNbrPeerTable, pnniNodeTable=pnniNodeTable, pnniRouteAddrOriginateAdvertisement=pnniRouteAddrOriginateAdvertisement, pnniNbrPeerXmtDbSums=pnniNbrPeerXmtDbSums, pnniRouteTnsType=pnniRouteTnsType, pnniSummarySuppress=pnniSummarySuppress, pnniNodeRxmtInterval=pnniNodeRxmtInterval, pnniSummaryAddressType=pnniSummaryAddressType, pnniNodeOperStatus=pnniNodeOperStatus, pnniRouteNodeClass=pnniRouteNodeClass, pnniSvccRccVpi=pnniSvccRccVpi, pnniRouteNodeTimeStamp=pnniRouteNodeTimeStamp, pnniIfAggrToken=pnniIfAggrToken, pnniNodePtseLifetimeFactor=pnniNodePtseLifetimeFactor, pnniLinkHelloState=pnniLinkHelloState, pnniNodeAvcrPm=pnniNodeAvcrPm, pnniSummaryAddressLgnGroup=pnniSummaryAddressLgnGroup, pnniNodeIndex=pnniNodeIndex, pnniRouteTnsIndex=pnniRouteTnsIndex, pnniSummaryAddressTable=pnniSummaryAddressTable, pnniMIBConformance=pnniMIBConformance, pnniRouteNodeInfo=pnniRouteNodeInfo, pnniPtseInfo=pnniPtseInfo, pnniMapTable=pnniMapTable, pnniMapAddrPrefixLength=pnniMapAddrPrefixLength, pnniRouteNodeDestPortId=pnniRouteNodeDestPortId, TnsPlan=TnsPlan, pnniDTLLinkType=pnniDTLLinkType, pnniNodePglOverrideDelay=pnniNodePglOverrideDelay, pnniRouteTnsOptionalGroup=pnniRouteTnsOptionalGroup, pnniRouteNodeStatus=pnniRouteNodeStatus, pnniRouteTnsId=pnniRouteTnsId, pnniNbrPeerPortId=pnniNbrPeerPortId, pnniRouteAddrPrefixLength=pnniRouteAddrPrefixLength, pnniNbrPeerLgnGroup=pnniNbrPeerLgnGroup, pnniNodeAtmAddress=pnniNodeAtmAddress, pnniNbrPeerXmtPtseAcks=pnniNbrPeerXmtPtseAcks, pnniMIB=pnniMIB, pnniNodeEntry=pnniNodeEntry, PnniVersion=PnniVersion, pnniRouteTnsOperStatus=pnniRouteTnsOperStatus, pnniNodeTimerMinGroup=pnniNodeTimerMinGroup, pnniIfAdmWeightNrtVbr=pnniIfAdmWeightNrtVbr, pnniNbrPeerRcvDbSums=pnniNbrPeerRcvDbSums, pnniSummaryAddressSuppress=pnniSummaryAddressSuppress, pnniIfVPCapability=pnniIfVPCapability, pnniAltRouteCountOriginator=pnniAltRouteCountOriginator, pnniRouteAddrAdvertisedPortId=pnniRouteAddrAdvertisedPortId, pnniMIBGroups=pnniMIBGroups, pnniMapTnsTable=pnniMapTnsTable, pnniRouteAddrAddress=pnniRouteAddrAddress, pnniNodeRowStatus=pnniNodeRowStatus, pnniScopeSiteMinusOne=pnniScopeSiteMinusOne, pnniMapPeerGroupId=pnniMapPeerGroupId, pnniRouteNodeBwdMetric2=pnniRouteNodeBwdMetric2, pnniRouteNodeProto=pnniRouteNodeProto, pnniRouteFailCountBorder=pnniRouteFailCountBorder, pnniNbrPeerRcvPtseAcks=pnniNbrPeerRcvPtseAcks, pnniScopeInterRegional=pnniScopeInterRegional, pnniDTLEntryIndex=pnniDTLEntryIndex, pnniNodeCdvPm=pnniNodeCdvPm, pnniRouteAddrProto=pnniRouteAddrProto, pnniNodePtseHolddown=pnniNodePtseHolddown, pnniRouteTnsInfo=pnniRouteTnsInfo, pnniNodeSvccEntry=pnniNodeSvccEntry, pnniMapNodeLeadershipPriority=pnniMapNodeLeadershipPriority, pnniSummaryAddressRowStatus=pnniSummaryAddressRowStatus, pnniNbrPeerRcvPtseReqs=pnniNbrPeerRcvPtseReqs, pnniNbrPeerEntry=pnniNbrPeerEntry, pnniMapNodeParentPeerGroupId=pnniMapNodeParentPeerGroupId, pnniMapRemotePortId=pnniMapRemotePortId, pnniNodeMinGroup=pnniNodeMinGroup, pnniNodePeerGroupId=pnniNodePeerGroupId, pnniRouteNodeBwdMetric8=pnniRouteNodeBwdMetric8, pnniNodePreferredPgl=pnniNodePreferredPgl, pnniNodeHelloInterval=pnniNodeHelloInterval, pnniRouteNodeFwdMetric5=pnniRouteNodeFwdMetric5, pnniIfMinGroup=pnniIfMinGroup, pnniNodeSvccCallingIntegrityTime=pnniNodeSvccCallingIntegrityTime, AtmAddrPrefix=AtmAddrPrefix, pnniMetrics3=pnniMetrics3, pnniMetricsEntry=pnniMetricsEntry, PnniMetricsTag=PnniMetricsTag, pnniLinkXmtHellos=pnniLinkXmtHellos, ServiceCategory=ServiceCategory, pnniMapType=pnniMapType, pnniNodePglInitTime=pnniNodePglInitTime, pnniSummaryPrefixLength=pnniSummaryPrefixLength, pnniSummaryAddressState=pnniSummaryAddressState, pnniPtseOriginatingNodeId=pnniPtseOriginatingNodeId, pnniLinkTable=pnniLinkTable, pnniMapNodeRestrictedTransit=pnniMapNodeRestrictedTransit, pnniLinkLgnGroup=pnniLinkLgnGroup, pnniSvccRccIndex=pnniSvccRccIndex, pnniRouteTnsAdvertisedPortId=pnniRouteTnsAdvertisedPortId, pnniScopeCommunityMinusOne=pnniScopeCommunityMinusOne, pnniRouteAddrNumber=pnniRouteAddrNumber, pnniLowestVersion=pnniLowestVersion, pnniMapTnsId=pnniMapTnsId, pnniRouteAddrInfo=pnniRouteAddrInfo, pnniRouteTnsVPCapability=pnniRouteTnsVPCapability, pnniNbrPeerXmtPtsps=pnniNbrPeerXmtPtsps, pnniNodePglLgnGroup=pnniNodePglLgnGroup, pnniMIBObjects=pnniMIBObjects, PnniAtmAddr=PnniAtmAddr, pnniRouteTnsRouteType=pnniRouteTnsRouteType)
mibBuilder.exportSymbols("PNNI-MIB", pnniMapNodeParentNodeId=pnniMapNodeParentNodeId, pnniCrankbackCountOriginator=pnniCrankbackCountOriginator, pnniIfAdmWeightAbr=pnniIfAdmWeightAbr, pnniLinkIfIndex=pnniLinkIfIndex, pnniBaseGroup=pnniBaseGroup, pnniSummaryTable=pnniSummaryTable, pnniMetricsGcacClp=pnniMetricsGcacClp, pnniNodeHelloHolddown=pnniNodeHelloHolddown, pnniPtseId=pnniPtseId, PnniPeerGroupId=PnniPeerGroupId, pnniNodePglEntry=pnniNodePglEntry, pnniMapAddrTable=pnniMapAddrTable, pnniNodePtses=pnniNodePtses, pnniRouteTnsPnniScope=pnniRouteTnsPnniScope, pnniIfAdmWeightCbr=pnniIfAdmWeightCbr, pnniNodePglReelectTime=pnniNodePglReelectTime, pnniRouteTnsPlan=pnniRouteTnsPlan, pnniNodeSvccLgnGroup=pnniNodeSvccLgnGroup, pnniScopeMinGroup=pnniScopeMinGroup, pnniMetrics5=pnniMetrics5, pnniRouteAddrTimeStamp=pnniRouteAddrTimeStamp, pnniNodeDomainName=pnniNodeDomainName, pnniSummaryAddressEntry=pnniSummaryAddressEntry, pnniMapEntry=pnniMapEntry, pnniRouteAddrEntry=pnniRouteAddrEntry, pnniSvccRccRemoteNodeId=pnniSvccRccRemoteNodeId, pnniMapOriginatingNodeId=pnniMapOriginatingNodeId, pnniRouteAddrVPCapability=pnniRouteAddrVPCapability, pnniRouteAddrRowStatus=pnniRouteAddrRowStatus, pnniIfTable=pnniIfTable, pnniNbrPeerMinGroup=pnniNbrPeerMinGroup, PnniLevel=PnniLevel, pnniRouteTnsPtseId=pnniRouteTnsPtseId, pnniIfPortId=pnniIfPortId, pnniMapNodeDatabaseOverload=pnniMapNodeDatabaseOverload, pnniRouteAddrMetricsTag=pnniRouteAddrMetricsTag, pnniLinkBorderOrLgnGroup=pnniLinkBorderOrLgnGroup, pnniScopeLocalNetworkPlusTwo=pnniScopeLocalNetworkPlusTwo, pnniMapNodeId=pnniMapNodeId, pnniNbrPeerPortMinGroup=pnniNbrPeerPortMinGroup, pnniScopeIntraOrganization=pnniScopeIntraOrganization, pnniMetricsIndex=pnniMetricsIndex, pnniNodeDatabaseOverload=pnniNodeDatabaseOverload, pnniScopeIntraSite=pnniScopeIntraSite, pnniRouteFailUnreachableBorder=pnniRouteFailUnreachableBorder, pnniRouteNodeFwdMetric4=pnniRouteNodeFwdMetric4, pnniDTLTable=pnniDTLTable, pnniScopeCommunityPlusOne=pnniScopeCommunityPlusOne, pnniRouteAddrIfIndex=pnniRouteAddrIfIndex, pnniLinkMinGroup=pnniLinkMinGroup, pnniNodeTimerTable=pnniNodeTimerTable, pnniRouteNodeDestNodeId=pnniRouteNodeDestNodeId, pnniDTLNodeId=pnniDTLNodeId, pnniMapVPCapability=pnniMapVPCapability, pnniLinkUpnodeId=pnniLinkUpnodeId, pnniPtseChecksum=pnniPtseChecksum, pnniMapTnsAdvertisedPortId=pnniMapTnsAdvertisedPortId, pnniNodeLevel=pnniNodeLevel, pnniMIBCompliance=pnniMIBCompliance, pnniMapNodeParentAtmAddress=pnniMapNodeParentAtmAddress, pnniDtlCountOriginator=pnniDtlCountOriginator, pnniMapAddrOptionalGroup=pnniMapAddrOptionalGroup, pnniDTLEntry=pnniDTLEntry, pnniScopeOrganizationPlusOne=pnniScopeOrganizationPlusOne, pnniSvccRccVci=pnniSvccRccVci, pnniRouteNodeFwdMetric8=pnniRouteNodeFwdMetric8, pnniDTLIndex=pnniDTLIndex, pnniSvccRccVersion=pnniSvccRccVersion, pnniMetricsOptionalGroup=pnniMetricsOptionalGroup, pnniRouteBaseGroup=pnniRouteBaseGroup, pnniNbrPeerPortEntry=pnniNbrPeerPortEntry, pnniRouteNodeFwdMetric3=pnniRouteNodeFwdMetric3, atmForum=atmForum, pnniRouteNodeOptionalGroup=pnniRouteNodeOptionalGroup, pnniMapNodeIAmLeader=pnniMapNodeIAmLeader, PnniNodeIndex=PnniNodeIndex, pnniRouteNodeFwdMetric7=pnniRouteNodeFwdMetric7, pnniMapAddrAdvertisingNodeId=pnniMapAddrAdvertisingNodeId, pnniMIBCompliances=pnniMIBCompliances, pnniGeneralMinGroup=pnniGeneralMinGroup, pnniSummaryAddress=pnniSummaryAddress, pnniIfAdmWeightUbr=pnniIfAdmWeightUbr, pnniScopeMappingEntry=pnniScopeMappingEntry, atmForumNetworkManagement=atmForumNetworkManagement, pnniMapAddrIndex=pnniMapAddrIndex, pnniMetricsTable=pnniMetricsTable, pnniLinkRcvHellos=pnniLinkRcvHellos, pnniLinkCommonPeerGroupId=pnniLinkCommonPeerGroupId, pnniNodeTimerLgnGroup=pnniNodeTimerLgnGroup, pnniSvccRccLgnGroup=pnniSvccRccLgnGroup, pnniRouteNodeVPCapability=pnniRouteNodeVPCapability, pnniRouteAddrPtseId=pnniRouteAddrPtseId, pnniSummaryState=pnniSummaryState, PnniNodeId=PnniNodeId, pnniRouteAddrOptionalGroup=pnniRouteAddrOptionalGroup, pnniRouteNodeGcacClp=pnniRouteNodeGcacClp, pnniScopeMappingTable=pnniScopeMappingTable, pnniNodeSvccCalledIntegrityTime=pnniNodeSvccCalledIntegrityTime, pnniNodeAdminStatus=pnniNodeAdminStatus, pnniScopeOrganizationMinusOne=pnniScopeOrganizationMinusOne, pnniMapNodePreferredPgl=pnniMapNodePreferredPgl, pnniLinkVersion=pnniLinkVersion, pnniScopeIntraCommunity=pnniScopeIntraCommunity, pnniMapTnsPlan=pnniMapTnsPlan, pnniNodeComplexRep=pnniNodeComplexRep, pnniScopeSitePlusOne=pnniScopeSitePlusOne, pnniNodePglTable=pnniNodePglTable, pnniSummaryLgnGroup=pnniSummaryLgnGroup, pnniLinkRemotePortId=pnniLinkRemotePortId, pnniScopeLocalNetworkPlusOne=pnniScopeLocalNetworkPlusOne)
