...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/PNNI-MIB
...
ModuleIdentity, Counter64, enterprises, Gauge32, Unsigned32, zeroDotZero, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, ObjectIdentity, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "Gauge32", "Unsigned32", "zeroDotZero", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "ObjectIdentity", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("PNNI-MIB", pnniNodePglLeadershipPriority=pnniNodePglLeadershipPriority, pnniNodeSvccRetryTime=pnniNodeSvccRetryTime, pnniMapNodeDatabaseOverload=pnniMapNodeDatabaseOverload, pnniMapRemoteNodeId=pnniMapRemoteNodeId, pnniRouteAddrTimeStamp=pnniRouteAddrTimeStamp, pnniNodeCdvPm=pnniNodeCdvPm, pnniRouteNodeProto=pnniRouteNodeProto, pnniRouteAddrOriginateAdvertisement=pnniRouteAddrOriginateAdvertisement, pnniMapTnsOptionalGroup=pnniMapTnsOptionalGroup, pnniMetricsOptionalGroup=pnniMetricsOptionalGroup, pnniScopeIntraCommunity=pnniScopeIntraCommunity, pnniLinkRcvHellos=pnniLinkRcvHellos, pnniScopeMappingTable=pnniScopeMappingTable, pnniRouteNodeFwdMetric1=pnniRouteNodeFwdMetric1, pnniNbrPeerPortTable=pnniNbrPeerPortTable, pnniNbrPeerLgnGroup=pnniNbrPeerLgnGroup, pnniNodeDomainName=pnniNodeDomainName, pnniNodeSvccInitTime=pnniNodeSvccInitTime, pnniIfAdmWeightAbr=pnniIfAdmWeightAbr, pnniRouteTnsPlan=pnniRouteTnsPlan, pnniMapNodeParentAtmAddress=pnniMapNodeParentAtmAddress, pnniRouteNodeFwdMetric2=pnniRouteNodeFwdMetric2, pnniLinkHelloState=pnniLinkHelloState, pnniRouteAddrRowStatus=pnniRouteAddrRowStatus, pnniSummaryAddressLgnGroup=pnniSummaryAddressLgnGroup, pnniRouteTnsAdvertisingNodeId=pnniRouteTnsAdvertisingNodeId, pnniNodeSvccTable=pnniNodeSvccTable, pnniNodePtseRefreshInterval=pnniNodePtseRefreshInterval, pnniLinkUpnodeAtmAddress=pnniLinkUpnodeAtmAddress, pnniSummaryType=pnniSummaryType, pnniNodeCfgParentNodeIndex=pnniNodeCfgParentNodeIndex, pnniRouteNodeInfo=pnniRouteNodeInfo, pnniRouteNodeFwdMetric5=pnniRouteNodeFwdMetric5, pnniPtseType=pnniPtseType, pnniNodeHelloInactivityFactor=pnniNodeHelloInactivityFactor, pnniRouteAddrTable=pnniRouteAddrTable, pnniMapNodeLeadershipPriority=pnniMapNodeLeadershipPriority, pnniLowestVersion=pnniLowestVersion, pnniMapTable=pnniMapTable, pnniMetricsGcacClp=pnniMetricsGcacClp, pnniSummaryTable=pnniSummaryTable, pnniSvccRccIndex=pnniSvccRccIndex, pnniRouteAddrVPCapability=pnniRouteAddrVPCapability, pnniPtseInfo=pnniPtseInfo, atmfPnni=atmfPnni, pnniNodeTimerMinGroup=pnniNodeTimerMinGroup, pnniNodeHlinkInact=pnniNodeHlinkInact, pnniSummaryAddressPrefixLength=pnniSummaryAddressPrefixLength, pnniNodeOperStatus=pnniNodeOperStatus, pnniMIBCompliance=pnniMIBCompliance, pnniLinkTable=pnniLinkTable, pnniScopeLocalNetworkPlusOne=pnniScopeLocalNetworkPlusOne, pnniRouteNodeEntry=pnniRouteNodeEntry, pnniNodePglTimeStamp=pnniNodePglTimeStamp, pnniScopeSitePlusOne=pnniScopeSitePlusOne, pnniMapIndex=pnniMapIndex, pnniNbrPeerPortCount=pnniNbrPeerPortCount, pnniMapNodeId=pnniMapNodeId, pnniRouteTnsOriginateAdvertisement=pnniRouteTnsOriginateAdvertisement, pnniSummaryAddressType=pnniSummaryAddressType, pnniMapNodeTable=pnniMapNodeTable, pnniMapNodeEntry=pnniMapNodeEntry, pnniDTLStatus=pnniDTLStatus, pnniDTLEntryIndex=pnniDTLEntryIndex, pnniMetricsEntry=pnniMetricsEntry, pnniMapPtseId=pnniMapPtseId, pnniNbrPeerXmtPtseAcks=pnniNbrPeerXmtPtseAcks, pnniNodeTable=pnniNodeTable, pnniSummaryAddressSuppress=pnniSummaryAddressSuppress, pnniScopeIntraSite=pnniScopeIntraSite, pnniDTLOptionalGroup=pnniDTLOptionalGroup, pnniSvccRccRcvHellos=pnniSvccRccRcvHellos, pnniRouteNodeVPCapability=pnniRouteNodeVPCapability, pnniMapTnsPlan=pnniMapTnsPlan, pnniScopeGlobal=pnniScopeGlobal, pnniSummaryAddressAddress=pnniSummaryAddressAddress, pnniRouteAddrType=pnniRouteAddrType, pnniLinkDerivedAggrToken=pnniLinkDerivedAggrToken, pnniBaseGroup=pnniBaseGroup, pnniMIBConformance=pnniMIBConformance, pnniIfTable=pnniIfTable, pnniIfAggrToken=pnniIfAggrToken, pnniNbrPeerPortEntry=pnniNbrPeerPortEntry, pnniNodeSvccTrafficDescriptorIndex=pnniNodeSvccTrafficDescriptorIndex, pnniRouteNodeTable=pnniRouteNodeTable, pnniMetrics2=pnniMetrics2, pnniScopeOrganizationPlusOne=pnniScopeOrganizationPlusOne, pnniNodeHelloInterval=pnniNodeHelloInterval, pnniNbrPeerRcvDbSums=pnniNbrPeerRcvDbSums, pnniPtseSequenceNum=pnniPtseSequenceNum, pnniNodePeerGroupId=pnniNodePeerGroupId, pnniRouteTnsType=pnniRouteTnsType, pnniRouteNodeBwdMetric1=pnniRouteNodeBwdMetric1, pnniCrankbackCountBorder=pnniCrankbackCountBorder, pnniSvccRccIfIndex=pnniSvccRccIfIndex, pnniNbrPeerXmtPtsps=pnniNbrPeerXmtPtsps, pnniSvccRccXmtHellos=pnniSvccRccXmtHellos, pnniLinkRemoteNodeId=pnniLinkRemoteNodeId, pnniNodeLevel=pnniNodeLevel, PnniMetricsTag=PnniMetricsTag, pnniRoutingGroup=pnniRoutingGroup, AtmAddrPrefix=AtmAddrPrefix, pnniNodeAdminStatus=pnniNodeAdminStatus, pnniDtlCountBorder=pnniDtlCountBorder, pnniScopeLocalNetwork=pnniScopeLocalNetwork, pnniScopeCommunityPlusOne=pnniScopeCommunityPlusOne, pnniMapMetricsTag=pnniMapMetricsTag, pnniRouteNodeDestNodeId=pnniRouteNodeDestNodeId, pnniNodeSvccCalledIntegrityTime=pnniNodeSvccCalledIntegrityTime, pnniNodeTimerTable=pnniNodeTimerTable, pnniRouteNodeBwdMetric3=pnniRouteNodeBwdMetric3, pnniMapNodeParentPglNodeId=pnniMapNodeParentPglNodeId, PnniPeerGroupId=PnniPeerGroupId, pnniNodePglTable=pnniNodePglTable, pnniNodeActiveParentNodeId=pnniNodeActiveParentNodeId, pnniLinkType=pnniLinkType, ClpType=ClpType, pnniNbrPeerSvccRccIndex=pnniNbrPeerSvccRccIndex, pnniMetrics5=pnniMetrics5, pnniMapNodeParentPeerGroupId=pnniMapNodeParentPeerGroupId, PnniPortId=PnniPortId, pnniNbrPeerXmtDbSums=pnniNbrPeerXmtDbSums, pnniRouteTnsVPCapability=pnniRouteTnsVPCapability, pnniMetricsAdminWeight=pnniMetricsAdminWeight, pnniRouteNodeBwdMetric8=pnniRouteNodeBwdMetric8, pnniScopeInterRegional=pnniScopeInterRegional, pnniRouteAddrPtseId=pnniRouteAddrPtseId, pnniLinkXmtHellos=pnniLinkXmtHellos, pnniRouteBaseGroup=pnniRouteBaseGroup, pnniSummaryState=pnniSummaryState, pnniNodePtses=pnniNodePtses, ServiceCategory=ServiceCategory, pnniDTLPortId=pnniDTLPortId, PnniVersion=PnniVersion, pnniDTLTable=pnniDTLTable, pnniNbrPeerEntry=pnniNbrPeerEntry, pnniNodeSvccLgnGroup=pnniNodeSvccLgnGroup, pnniMapTnsId=pnniMapTnsId, pnniRouteAddrAdvertisingNodeId=pnniRouteAddrAdvertisingNodeId, pnniMapNodeParentNodeId=pnniMapNodeParentNodeId, pnniRouteFailCountBorder=pnniRouteFailCountBorder, PnniLevel=PnniLevel, pnniRouteTnsProto=pnniRouteTnsProto, pnniNodeEntry=pnniNodeEntry, pnniSummaryPrefixLength=pnniSummaryPrefixLength, pnniMapNodeAtmAddress=pnniMapNodeAtmAddress, pnniRouteAddrInfo=pnniRouteAddrInfo, pnniSvccRccVersion=pnniSvccRccVersion, pnniNbrPeerState=pnniNbrPeerState, pnniRouteNodeFwdMetric6=pnniRouteNodeFwdMetric6, pnniRouteAddrAdvertisedPortId=pnniRouteAddrAdvertisedPortId, pnniNodeCtdPm=pnniNodeCtdPm, pnniMetricsRowStatus=pnniMetricsRowStatus, pnniRouteAddrProto=pnniRouteAddrProto, pnniRouteNodeBwdMetric6=pnniRouteNodeBwdMetric6, pnniNodeId=pnniNodeId, pnniNodeMinGroup=pnniNodeMinGroup, pnniPtseId=pnniPtseId, pnniMIB=pnniMIB, pnniMetrics8=pnniMetrics8, pnniIfEntry=pnniIfEntry, pnniRouteAddrOptionalGroup=pnniRouteAddrOptionalGroup, pnniScopeMinGroup=pnniScopeMinGroup, pnniSummarySuppress=pnniSummarySuppress, pnniRouteAddrAddress=pnniRouteAddrAddress, pnniNodePglOverrideDelay=pnniNodePglOverrideDelay, pnniRouteNodeBwdMetric2=pnniRouteNodeBwdMetric2, pnniDTLLinkType=pnniDTLLinkType, pnniMapNodeRestrictedBranching=pnniMapNodeRestrictedBranching, pnniRouteNodeFwdMetricAW=pnniRouteNodeFwdMetricAW, pnniRouteNodeBwdMetric7=pnniRouteNodeBwdMetric7, pnniMIBGroups=pnniMIBGroups, pnniRouteNodeBwdMetric5=pnniRouteNodeBwdMetric5, pnniDTLEntry=pnniDTLEntry, pnniRouteAddrPrefixLength=pnniRouteAddrPrefixLength, pnniIfRccServiceCategory=pnniIfRccServiceCategory, pnniMapAddrAdvertisingNodeId=pnniMapAddrAdvertisingNodeId, pnniDTLNodeId=pnniDTLNodeId, pnniNodePeerDelayedAckInterval=pnniNodePeerDelayedAckInterval, pnniRouteNodeBwdMetric4=pnniRouteNodeBwdMetric4, pnniNodeAtmAddress=pnniNodeAtmAddress, pnniNodeAvcrPm=pnniNodeAvcrPm, pnniMapTnsTable=pnniMapTnsTable, pnniNodePtseHolddown=pnniNodePtseHolddown, pnniIfMinGroup=pnniIfMinGroup, pnniPtseLifeTime=pnniPtseLifeTime, pnniMapNodePeerGroupId=pnniMapNodePeerGroupId, pnniScopeOrganizationMinusOne=pnniScopeOrganizationMinusOne, pnniRouteAddrEntry=pnniRouteAddrEntry, pnniRouteTnsRouteType=pnniRouteTnsRouteType, pnniMapAddrAddress=pnniMapAddrAddress, PnniAtmAddr=PnniAtmAddr, pnniNodeComplexRep=pnniNodeComplexRep, TnsPlan=TnsPlan, pnniRouteNodeClass=pnniRouteNodeClass, pnniScopeRegional=pnniScopeRegional, pnniSvccRccLgnGroup=pnniSvccRccLgnGroup, pnniLinkPortId=pnniLinkPortId, pnniMIBObjects=pnniMIBObjects, pnniMapTnsAdvertisedPortId=pnniMapTnsAdvertisedPortId, pnniMetrics6=pnniMetrics6, pnniRouteAddrIfIndex=pnniRouteAddrIfIndex, atmForum=atmForum, pnniAltRouteCountBorder=pnniAltRouteCountBorder, TnsType=TnsType, pnniMapOriginatingNodeId=pnniMapOriginatingNodeId, pnniGeneralMinGroup=pnniGeneralMinGroup, PnniAggrToken=PnniAggrToken, pnniSvccRccEntry=pnniSvccRccEntry, pnniRouteAddrPnniScope=pnniRouteAddrPnniScope, pnniIfAdmWeightCbr=pnniIfAdmWeightCbr, pnniScopeSiteMinusOne=pnniScopeSiteMinusOne, pnniDTLIndex=pnniDTLIndex, pnniAltRouteCountOriginator=pnniAltRouteCountOriginator, pnniPtseChecksum=pnniPtseChecksum, pnniSummaryAddressState=pnniSummaryAddressState, pnniNodeTimerLgnGroup=pnniNodeTimerLgnGroup, pnniNodePglLgnGroup=pnniNodePglLgnGroup, pnniRouteNodeFwdMetric8=pnniRouteNodeFwdMetric8, pnniMetrics3=pnniMetrics3, pnniRouteFailUnreachableBorder=pnniRouteFailUnreachableBorder, pnniMapType=pnniMapType, pnniNodePglMinGroup=pnniNodePglMinGroup, pnniDtlCountOriginator=pnniDtlCountOriginator, pnniMapNodeRestrictedTransit=pnniMapNodeRestrictedTransit, pnniNodeSvccEntry=pnniNodeSvccEntry, pnniMapNodeOptionalGroup=pnniMapNodeOptionalGroup, pnniRouteTnsAdvertisedPortId=pnniRouteTnsAdvertisedPortId, pnniMapEntry=pnniMapEntry, pnniNodeAvcrMt=pnniNodeAvcrMt, pnniSummaryAddress=pnniSummaryAddress, pnniLinkIfIndex=pnniLinkIfIndex, pnniLinkMinGroup=pnniLinkMinGroup, PnniNodeIndex=PnniNodeIndex, pnniNbrPeerPortId=pnniNbrPeerPortId, PYSNMP_MODULE_ID=pnniMIB, pnniNodePtseLifetimeFactor=pnniNodePtseLifetimeFactor, pnniRouteTnsIndex=pnniRouteTnsIndex, pnniMapPeerGroupId=pnniMapPeerGroupId, pnniMIBCompliances=pnniMIBCompliances, pnniLinkVersion=pnniLinkVersion, pnniCrankbackCountOriginator=pnniCrankbackCountOriginator, pnniNbrPeerTable=pnniNbrPeerTable, PnniNodeId=PnniNodeId, pnniSummaryLgnGroup=pnniSummaryLgnGroup, pnniMapOptionalGroup=pnniMapOptionalGroup, pnniNodeRowStatus=pnniNodeRowStatus, pnniNodePglInitTime=pnniNodePglInitTime, pnniMapAddrAdvertisedPortId=pnniMapAddrAdvertisedPortId, pnniGeneralBorderGroup=pnniGeneralBorderGroup, pnniHighestVersion=pnniHighestVersion, pnniLinkEntry=pnniLinkEntry, pnniLinkCommonPeerGroupId=pnniLinkCommonPeerGroupId, pnniNodePreferredPgl=pnniNodePreferredPgl)
mibBuilder.exportSymbols("PNNI-MIB", pnniRouteNodeOptionalGroup=pnniRouteNodeOptionalGroup, pnniMapNodeIAmLeader=pnniMapNodeIAmLeader, pnniSvccRccTable=pnniSvccRccTable, pnniMapAddrOptionalGroup=pnniMapAddrOptionalGroup, pnniRouteNodeFwdMetric4=pnniRouteNodeFwdMetric4, pnniNodePglState=pnniNodePglState, pnniSummaryRowStatus=pnniSummaryRowStatus, pnniRouteNodeTimeStamp=pnniRouteNodeTimeStamp, pnniNodeSvccCallingIntegrityTime=pnniNodeSvccCallingIntegrityTime, pnniScopeIntraOrganization=pnniScopeIntraOrganization, pnniRouteTnsMetricsTag=pnniRouteTnsMetricsTag, pnniNbrPeerRemoteNodeId=pnniNbrPeerRemoteNodeId, pnniMapNodeComplexRep=pnniMapNodeComplexRep, pnniRouteNodeStatus=pnniRouteNodeStatus, pnniRouteGeneralOptionalGroup=pnniRouteGeneralOptionalGroup, pnniMetricsTable=pnniMetricsTable, pnniRouteTnsOperStatus=pnniRouteTnsOperStatus, pnniSvccRccRemoteAtmAddress=pnniSvccRccRemoteAtmAddress, pnniMapNodePreferredPgl=pnniMapNodePreferredPgl, pnniNodeRestrictedTransit=pnniNodeRestrictedTransit, pnniRouteTnsInfo=pnniRouteTnsInfo, pnniIfBorderGroup=pnniIfBorderGroup, pnniScopeLocalNetworkPlusTwo=pnniScopeLocalNetworkPlusTwo, pnniScopeCommunityMinusOne=pnniScopeCommunityMinusOne, pnniRouteFailCountOriginator=pnniRouteFailCountOriginator, pnniMapAddrIndex=pnniMapAddrIndex, pnniRouteNodeFwdMetric3=pnniRouteNodeFwdMetric3, pnniRouteTnsTable=pnniRouteTnsTable, pnniPtseTable=pnniPtseTable, pnniRouteAddrNumber=pnniRouteAddrNumber, pnniNodeRxmtInterval=pnniNodeRxmtInterval, pnniLinkBorderOrLgnGroup=pnniLinkBorderOrLgnGroup, pnniIfAdmWeightNrtVbr=pnniIfAdmWeightNrtVbr, pnniSvccRccVci=pnniSvccRccVci, pnniRouteTnsTimeStamp=pnniRouteTnsTimeStamp, pnniIfAdmWeightUbr=pnniIfAdmWeightUbr, pnniNodePglReelectTime=pnniNodePglReelectTime, pnniNbrPeerMinGroup=pnniNbrPeerMinGroup, pnniSvccRccRemoteNodeId=pnniSvccRccRemoteNodeId, pnniRouteTnsPnniScope=pnniRouteTnsPnniScope, pnniRouteFailUnreachableOriginator=pnniRouteFailUnreachableOriginator, pnniRouteNodeGcacClp=pnniRouteNodeGcacClp, pnniIfPortId=pnniIfPortId, pnniLinkSvccRccIndex=pnniLinkSvccRccIndex, pnniScopeMappingEntry=pnniScopeMappingEntry, pnniNodePeerGroupLeader=pnniNodePeerGroupLeader, pnniSvccRccHelloState=pnniSvccRccHelloState, pnniNodeRestrictedBranching=pnniNodeRestrictedBranching, pnniMetricsIndex=pnniMetricsIndex, pnniRouteNodeDTL=pnniRouteNodeDTL, pnniNbrPeerRcvPtseReqs=pnniNbrPeerRcvPtseReqs, pnniRouteAddrOperStatus=pnniRouteAddrOperStatus, pnniMapTnsAdvertisingNodeId=pnniMapTnsAdvertisingNodeId, pnniRouteAddrMetricsTag=pnniRouteAddrMetricsTag, pnniIfRccTrafficDescrIndex=pnniIfRccTrafficDescrIndex, pnniIfNodeIndex=pnniIfNodeIndex, pnniSummaryAddressTable=pnniSummaryAddressTable, pnniMapTnsType=pnniMapTnsType, pnniMetricsClasses=pnniMetricsClasses, pnniPtseOptionalGroup=pnniPtseOptionalGroup, pnniSvccRccVpi=pnniSvccRccVpi, pnniMapRemotePortId=pnniMapRemotePortId, pnniMapAddrPrefixLength=pnniMapAddrPrefixLength, pnniLinkRemotePortId=pnniLinkRemotePortId, pnniNbrPeerXmtPtseReqs=pnniNbrPeerXmtPtseReqs, pnniNodeLowest=pnniNodeLowest, pnniNodeHelloHolddown=pnniNodeHelloHolddown, pnniRouteNodeBwdMetricAW=pnniRouteNodeBwdMetricAW, pnniIfAdmWeightRtVbr=pnniIfAdmWeightRtVbr, pnniRouteAddrIndex=pnniRouteAddrIndex, PnniSvccRccIndex=PnniSvccRccIndex, pnniNbrPeerPortMinGroup=pnniNbrPeerPortMinGroup, pnniLinkUpnodeId=pnniLinkUpnodeId, pnniNodePglEntry=pnniNodePglEntry, pnniRouteNodeDestPortId=pnniRouteNodeDestPortId, pnniNbrPeerPortFloodStatus=pnniNbrPeerPortFloodStatus, pnniLinkLgnGroup=pnniLinkLgnGroup, pnniSummaryAddressEntry=pnniSummaryAddressEntry, pnniPtseOriginatingNodeId=pnniPtseOriginatingNodeId, pnniMapAggrToken=pnniMapAggrToken, pnniMapAddrTable=pnniMapAddrTable, pnniMetricsDirection=pnniMetricsDirection, pnniMapTnsEntry=pnniMapTnsEntry, pnniSummaryEntry=pnniSummaryEntry, pnniNodeIndex=pnniNodeIndex, pnniNbrPeerRcvPtseAcks=pnniNbrPeerRcvPtseAcks, pnniNodeTimerEntry=pnniNodeTimerEntry, pnniRouteNodeNumber=pnniRouteNodeNumber, PnniPrefixLength=PnniPrefixLength, pnniRouteTnsId=pnniRouteTnsId, pnniSummaryAddressRowStatus=pnniSummaryAddressRowStatus, pnniNodeDatabaseOverload=pnniNodeDatabaseOverload, pnniNbrPeerRcvPtsps=pnniNbrPeerRcvPtsps, pnniMapAddrEntry=pnniMapAddrEntry, pnniMapVPCapability=pnniMapVPCapability, pnniMetricsTag=pnniMetricsTag, pnniMetrics7=pnniMetrics7, pnniRouteTnsEntry=pnniRouteTnsEntry, atmForumNetworkManagement=atmForumNetworkManagement, pnniRouteTnsIfIndex=pnniRouteTnsIfIndex, pnniIfVPCapability=pnniIfVPCapability, pnniRouteTnsOptionalGroup=pnniRouteTnsOptionalGroup, pnniMapOriginatingPortId=pnniMapOriginatingPortId, pnniRouteTnsRowStatus=pnniRouteTnsRowStatus, pnniRouteTnsPtseId=pnniRouteTnsPtseId, pnniRouteNodeFwdMetric7=pnniRouteNodeFwdMetric7, pnniPtseEntry=pnniPtseEntry, pnniMetrics4=pnniMetrics4, pnniMetrics1=pnniMetrics1, PnniHelloState=PnniHelloState)
