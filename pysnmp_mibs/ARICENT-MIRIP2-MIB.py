# SNMP MIB module (ARICENT-MIRIP2-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MIRIP2-MIB
...
(fsMIStdRip2PeerAddress,) = mibBuilder.importSymbols(
...
fsMIRip2NBRTrustListEntry = _FsMIRip2NBRTrustListEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 151, 1, 3, 1)
)
fsMIRip2NBRTrustListEntry.setIndexNames(
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipContextId"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRip2TrustNBRIpAddr"),
)
if mibBuilder.loadTexts:
...
fsMIRip2IfConfEntry = _FsMIRip2IfConfEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 151, 1, 4, 1)
)
fsMIRip2IfConfEntry.setIndexNames(
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipContextId"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRip2IfConfAddress"),
)
if mibBuilder.loadTexts:
...
fsMIRipMd5AuthEntry = _FsMIRipMd5AuthEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 151, 1, 5, 1)
)
fsMIRipMd5AuthEntry.setIndexNames(
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipContextId"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipMd5AuthAddress"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipMd5AuthKeyId"),
)
if mibBuilder.loadTexts:
...
fsMIRip2NBRUnicastListEntry = _FsMIRip2NBRUnicastListEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 151, 1, 6, 1)
)
fsMIRip2NBRUnicastListEntry.setIndexNames(
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipContextId"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRip2NBRUnicastIpAddr"),
)
if mibBuilder.loadTexts:
...
fsMIRip2LocalRouteEntry = _FsMIRip2LocalRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 151, 1, 7, 1)
)
fsMIRip2LocalRouteEntry.setIndexNames(
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipContextId"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRip2DestNet"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRip2DestMask"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRip2Tos"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRip2NextHop"),
)
if mibBuilder.loadTexts:
...
fsMIRipAggTable = _FsMIRipAggTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 151, 1, 8)
)
if mibBuilder.loadTexts:
    fsMIRipAggTable.setStatus("current")
_FsMIRipAggEntry_Object = MibTableRow
fsMIRipAggEntry = _FsMIRipAggEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 151, 1, 8, 1)
)
fsMIRipAggEntry.setIndexNames(
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipContextId"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipIfIndex"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipAggAddress"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipAggAddressMask"),
)
if mibBuilder.loadTexts:
...
fsMIRipCryptoAuthEntry = _FsMIRipCryptoAuthEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 151, 1, 9, 1)
)
fsMIRipCryptoAuthEntry.setIndexNames(
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipContextId"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipCryptoAuthIfIndex"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipCryptoAuthAddress"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipCryptoAuthKeyId"),
)
if mibBuilder.loadTexts:
...
fsMIRipDistInOutRouteMapEntry = _FsMIRipDistInOutRouteMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 151, 3, 1, 1)
)
fsMIRipDistInOutRouteMapEntry.setIndexNames(
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipContextId"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipDistInOutRouteMapName"),
    (0, "ARICENT-MIRIP2-MIB", "fsMIRipDistInOutRouteMapType"),
)
if mibBuilder.loadTexts:
...
fsMIRip2AuthenticationFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 151, 6, 0, 1)
)
fsMIRip2AuthenticationFailure.setObjects(
      *(("ARICENT-MIRIP2-MIB", "fsMIRip2ContextId"),
        ("ARICENT-MIRIP2-MIB", "fsMIRipPeerAddress"),
        ("ARICENT-MIRIP2-MIB", "fsMIRipAuthIfIndex"),
        ("ARICENT-MIRIP2-MIB", "fsMIRipAuthKeyId"))
)
if mibBuilder.loadTexts:
