...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CALL-APPLICATION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:40:44 2025
...
class _CcapAppDescr_Type(SnmpAdminString):
    """Custom type ccapAppDescr based on SnmpAdminString"""
    defaultValue = OctetString("")


_CcapAppDescr_Type.__name__ = "SnmpAdminString"
...
ciscoCallApplicationMIBCompliance.setObjects(
    ("CISCO-CALL-APPLICATION-MIB", "ccapGeneralCfgGroup")
)
if mibBuilder.loadTexts:
...
ciscoCallApplicationMIBComplianceRev1.setObjects(
      *(("CISCO-CALL-APPLICATION-MIB", "ccapGeneralCfgGroupRev1"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppTypeHistoryGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppInstanceHistoryGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppGblActGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppGblCfgGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppGblHisGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfGblCfgGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfHTTPGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfRTSPGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfTFTPGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfSMTPGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfAAAMethodListGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfASRGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfTTSGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfFlashGroup"),
        ("CISCO-CALL-APPLICATION-MIB", "ccapAppIntfRAMRecordGroup"))
)
if mibBuilder.loadTexts:
