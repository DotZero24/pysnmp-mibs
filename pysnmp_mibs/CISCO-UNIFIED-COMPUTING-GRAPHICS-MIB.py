...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:14:26 2025
...
CucsEquipmentPowerState, CucsGraphicsGpuMode, CucsEquipmentOperability, CucsEquipmentSensorThresholdStatus, CucsFsmLifecycle, CucsEquipmentPresence = mibBuilder.importSymbols("CISCO-UNIFIED-COMPUTING-TC-MIB", "CucsEquipmentPowerState", "CucsGraphicsGpuMode", "CucsEquipmentOperability", "CucsEquipmentSensorThresholdStatus", "CucsFsmLifecycle", "CucsEquipmentPresence")
...
mibBuilder.exportSymbols("CISCO-UNIFIED-COMPUTING-GRAPHICS-MIB", cucsGraphicsCardSerial=cucsGraphicsCardSerial, cucsGraphicsControllerPciAddr=cucsGraphicsControllerPciAddr, cucsGraphicsCardSubDeviceId=cucsGraphicsCardSubDeviceId, cucsGraphicsCardVoltage=cucsGraphicsCardVoltage, cucsGraphicsCardDeviceId=cucsGraphicsCardDeviceId, cucsGraphicsCardModel=cucsGraphicsCardModel, cucsGraphicsControllerRevision=cucsGraphicsControllerRevision, cucsGraphicsCardThermal=cucsGraphicsCardThermal, cucsGraphicsCardPerf=cucsGraphicsCardPerf, cucsGraphicsControllerInstanceId=cucsGraphicsControllerInstanceId, cucsGraphicsControllerModel=cucsGraphicsControllerModel, cucsGraphicsCardOperQualifierReason=cucsGraphicsCardOperQualifierReason, cucsGraphicsCardInstanceId=cucsGraphicsCardInstanceId, cucsGraphicsCardSubVendorId=cucsGraphicsCardSubVendorId, cucsGraphicsControllerId=cucsGraphicsControllerId, cucsGraphicsControllerPerf=cucsGraphicsControllerPerf, cucsGraphicsControllerTable=cucsGraphicsControllerTable, cucsGraphicsCardOperState=cucsGraphicsCardOperState, cucsGraphicsCardPower=cucsGraphicsCardPower, cucsGraphicsCardId=cucsGraphicsCardId, cucsGraphicsCardDn=cucsGraphicsCardDn, cucsGraphicsCardPresence=cucsGraphicsCardPresence, cucsGraphicsCardTable=cucsGraphicsCardTable, cucsGraphicsControllerOperState=cucsGraphicsControllerOperState, cucsGraphicsCardRevision=cucsGraphicsCardRevision, cucsGraphicsControllerDn=cucsGraphicsControllerDn, cucsGraphicsControllerPower=cucsGraphicsControllerPower, PYSNMP_MODULE_ID=cucsGraphicsObjects, cucsGraphicsCardMode=cucsGraphicsCardMode, cucsGraphicsCardEntry=cucsGraphicsCardEntry, cucsGraphicsCardPciAddr=cucsGraphicsCardPciAddr, cucsGraphicsControllerOperability=cucsGraphicsControllerOperability, cucsGraphicsCardLocationDn=cucsGraphicsCardLocationDn, cucsGraphicsCardExpanderSlot=cucsGraphicsCardExpanderSlot, cucsGraphicsControllerPresence=cucsGraphicsControllerPresence, cucsGraphicsControllerLocationDn=cucsGraphicsControllerLocationDn, cucsGraphicsControllerOperQualifierReason=cucsGraphicsControllerOperQualifierReason, cucsGraphicsCardIsSupported=cucsGraphicsCardIsSupported, cucsGraphicsCardVendorId=cucsGraphicsCardVendorId, cucsGraphicsCardRn=cucsGraphicsCardRn, cucsGraphicsControllerEntry=cucsGraphicsControllerEntry, cucsGraphicsCardStepping=cucsGraphicsCardStepping, cucsGraphicsControllerSerial=cucsGraphicsControllerSerial, cucsGraphicsControllerVendor=cucsGraphicsControllerVendor, cucsGraphicsControllerVoltage=cucsGraphicsControllerVoltage, cucsGraphicsControllerPciSlot=cucsGraphicsControllerPciSlot, cucsGraphicsCardOperability=cucsGraphicsCardOperability, cucsGraphicsCardVendor=cucsGraphicsCardVendor, cucsGraphicsControllerRn=cucsGraphicsControllerRn, cucsGraphicsControllerThermal=cucsGraphicsControllerThermal, cucsGraphicsObjects=cucsGraphicsObjects, cucsGraphicsCardPciSlot=cucsGraphicsCardPciSlot, cucsGraphicsCardFirmwareVersion=cucsGraphicsCardFirmwareVersion, cucsGraphicsCardPciAddrList=cucsGraphicsCardPciAddrList, cucsGraphicsCardLc=cucsGraphicsCardLc)
