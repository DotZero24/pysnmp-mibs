...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-GRAPHICS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:26 2025
...
cucsGraphicsCardMode = _CucsGraphicsCardMode_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 73, 1, 1, 30),
    _CucsGraphicsCardMode_Type()
)
cucsGraphicsCardMode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsGraphicsCardMode.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsGraphicsObjects": cucsGraphicsObjects,
       ...
       "cucsGraphicsCardMode": cucsGraphicsCardMode,
