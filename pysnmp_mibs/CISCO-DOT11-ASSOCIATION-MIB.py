...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-DOT11-ASSOCIATION-MIB
...
ciscoDot11AssociationMIB.setRevisions(('2016-12-06 00:00', '2007-01-05 00:00', '2006-06-12 00:00', '2005-03-08 00:00', '2004-11-28 00:00', '2004-10-18 00:00', '2004-02-19 00:00', '2003-07-27 00:00', '2003-04-11 00:00', '2003-01-29 00:00', '2002-07-15 00:00', '2002-04-17 00:00', '2002-03-06 00:00',))
if mibBuilder.loadTexts: ciscoDot11AssociationMIB.setLastUpdated('201612060000Z')
...
ciscoDot11StationTraps = MibIdentifier((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 4))
...
ciscoDot11StationInfoTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5), )
if mibBuilder.loadTexts: ciscoDot11StationInfoTable.setStatus('current')
ciscoDot11StationInfoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"))
if mibBuilder.loadTexts: ciscoDot11StationInfoEntry.setStatus('current')
clientMacAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 1), MacAddress()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: clientMacAddr.setStatus('current')
clientDeviceType = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 2), CDot11ClientRoleClassType()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: clientDeviceType.setStatus('current')
clientDeviceName = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 3), SnmpAdminString()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: clientDeviceName.setStatus('current')
clientIpv4Address = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 4), InetAddress()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: clientIpv4Address.setStatus('current')
clientIpv6Address = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 5), InetAddress()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: clientIpv6Address.setStatus('current')
apMacAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 6), InetAddress()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: apMacAddr.setStatus('current')
apIpv4Address = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 7), InetAddress()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: apIpv4Address.setStatus('current')
apIpv6Address = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 8), InetAddress()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: apIpv6Address.setStatus('current')
clientStationState = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 9), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("associated", 1), ("disAssociated", 2), ("run", 3)))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: clientStationState.setStatus('current')
clientDisassocReasonStr = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 5, 1, 10), SnmpAdminString()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: clientDisassocReasonStr.setStatus('current')
ciscoDot11StationStatusTrap = NotificationType((1, 3, 6, 1, 4, 1, 9, 9, 273, 1, 4, 1)).setObjects(("IF-MIB", "ifIndex"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientMacAddr"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientDeviceType"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientDeviceName"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientIpv4Address"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientIpv6Address"), ("CISCO-DOT11-ASSOCIATION-MIB", "apMacAddr"), ("CISCO-DOT11-ASSOCIATION-MIB", "apIpv4Address"), ("CISCO-DOT11-ASSOCIATION-MIB", "apIpv6Address"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientStationState"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientDisassocReasonStr"))
if mibBuilder.loadTexts: ciscoDot11StationStatusTrap.setStatus('current')
...
ciscoDot11AssocMIBComplianceRev6 = ModuleCompliance((1, 3, 6, 1, 4, 1, 9, 9, 273, 2, 1, 7)).setObjects(("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11ClientConfigGroup"), ("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11ClientAuthenGroup"), ("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11ClientStatGroup"), ("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11ClientInfoGroup"), ("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11IfAssocStatGroup"), ("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11IfCipherStatGroup"), ("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11ClientConfigExtGroup"), ("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11ClientNewAuthenGroup"), ("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11ApAssocGlobalGroup"), ("CISCO-DOT11-ASSOCIATION-MIB", "ciscoDot11ClientStatusTrapsGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ciscoDot11AssocMIBComplianceRev6 = ciscoDot11AssocMIBComplianceRev6.setStatus('current')
...
ciscoDot11ClientStatusTrapsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 9, 9, 273, 2, 2, 11)).setObjects(("CISCO-DOT11-ASSOCIATION-MIB", "clientMacAddr"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientDeviceType"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientDeviceName"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientIpv4Address"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientIpv6Address"), ("CISCO-DOT11-ASSOCIATION-MIB", "apMacAddr"), ("CISCO-DOT11-ASSOCIATION-MIB", "apIpv4Address"), ("CISCO-DOT11-ASSOCIATION-MIB", "apIpv6Address"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientStationState"), ("CISCO-DOT11-ASSOCIATION-MIB", "clientDisassocReasonStr"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ciscoDot11ClientStatusTrapsGroup = ciscoDot11ClientStatusTrapsGroup.setStatus('current')
mibBuilder.exportSymbols("CISCO-DOT11-ASSOCIATION-MIB", cd11IfCipherStatsEntry=cd11IfCipherStatsEntry, cDot11ClientConfigInfoTable=cDot11ClientConfigInfoTable, apIpv6Address=apIpv6Address, cDot11ClientAid=cDot11ClientAid, cDot11ClientStatisticEntry=cDot11ClientStatisticEntry, CDot11ClientDevType=CDot11ClientDevType, clientIpv4Address=clientIpv4Address, cDot11ClientConfiguration=cDot11ClientConfiguration, cDot11ClientIpAddressType=cDot11ClientIpAddressType, cDot11AssStatsRoamedAway=cDot11AssStatsRoamedAway, cDot11ClientNewKeyManagement=cDot11ClientNewKeyManagement, cDot11ClientMsduRetries=cDot11ClientMsduRetries, cd11IfCipherStatsTable=cd11IfCipherStatsTable, CDot11AdditionalAuthenMethod=CDot11AdditionalAuthenMethod, cDot11ClientUpTime=cDot11ClientUpTime, cd11IfCipherTkipReplaysDetected=cd11IfCipherTkipReplaysDetected, ciscoDot11AssocMIBCompliance=ciscoDot11AssocMIBCompliance, ciscoDot11ClientInfoGroup=ciscoDot11ClientInfoGroup, ciscoDot11AssocMIBObjects=ciscoDot11AssocMIBObjects, CDot11Dot1xAuthenMethod=CDot11Dot1xAuthenMethod, cDot11AssStatsRoamedIn=cDot11AssStatsRoamedIn, ciscoDot11StationTraps=ciscoDot11StationTraps, cd11IfCipherTkipCounterMeasInvok=cd11IfCipherTkipCounterMeasInvok, cDot11ClientAgingLeft=cDot11ClientAgingLeft, ciscoDot11AssocMIBComplianceRev1=ciscoDot11AssocMIBComplianceRev1, ciscoDot11AssocMIBComplianceRev6=ciscoDot11AssocMIBComplianceRev6, ciscoDot11ClientStatusTrapsGroup=ciscoDot11ClientStatusTrapsGroup, cDot11ClientName=cDot11ClientName, cDot11AssociationStatsEntry=cDot11AssociationStatsEntry, clientMacAddr=clientMacAddr, cDot11AssStatsAssociated=cDot11AssStatsAssociated, cDot11ClientMicErrors=cDot11ClientMicErrors, cDot11ParentAddress=cDot11ParentAddress, ciscoDot11AssocGlobalGroup=ciscoDot11AssocGlobalGroup, CDot11NewKeyManagementMethod=CDot11NewKeyManagementMethod, ciscoDot11StationInfoTable=ciscoDot11StationInfoTable, cDot11ClientSoftwareVersion=cDot11ClientSoftwareVersion, ciscoDot11ClientConfigGroup=ciscoDot11ClientConfigGroup, clientDeviceType=clientDeviceType, cDot11ActiveDevicesTable=cDot11ActiveDevicesTable, PYSNMP_MODULE_ID=ciscoDot11AssociationMIB, ciscoDot11AssociationMIB=ciscoDot11AssociationMIB, ciscoDot11ClientStatGroup=ciscoDot11ClientStatGroup, cDot11ClientAssociationState=cDot11ClientAssociationState, clientIpv6Address=clientIpv6Address, ciscoDot11ClientConfigExtGroup=ciscoDot11ClientConfigExtGroup, cDot11AssStatsDisassociated=cDot11AssStatsDisassociated, cDot11ClientRadioType=cDot11ClientRadioType, cDot11ClientUnicastCipher=cDot11ClientUnicastCipher, cd11IfCipherMicFailClientAddress=cd11IfCipherMicFailClientAddress, cDot11ClientVlanId=cDot11ClientVlanId, ciscoDot11StationInfoEntry=ciscoDot11StationInfoEntry, cDot11ClientPacketsSent=cDot11ClientPacketsSent, CDot11ClientRoleClassType=CDot11ClientRoleClassType, cDot11ClientAddress=cDot11ClientAddress, cDot11ActiveRepeaters=cDot11ActiveRepeaters, ciscoDot11AssocMIBComplianceRev5=ciscoDot11AssocMIBComplianceRev5, ciscoDot11AssocMIBGroups=ciscoDot11AssocMIBGroups, clientStationState=clientStationState, cDot11AssociationGlobal=cDot11AssociationGlobal, cDot11ClientCurrentTxRateSet=cDot11ClientCurrentTxRateSet, ciscoDot11AssocMIBComplianceRev3=ciscoDot11AssocMIBComplianceRev3, ciscoDot11AssocMIBComplianceRev4=ciscoDot11AssocMIBComplianceRev4, ciscoDot11IfCipherStatGroup=ciscoDot11IfCipherStatGroup, clientDisassocReasonStr=clientDisassocReasonStr, cDot11AssStatsAuthenticated=cDot11AssStatsAuthenticated, CDot11KeyManagementMethod=CDot11KeyManagementMethod, cDot11AssociationStatsTable=cDot11AssociationStatsTable, cd11IfCipherCcmpReplaysDiscarded=cd11IfCipherCcmpReplaysDiscarded, ciscoDot11AssocMIBCompliances=ciscoDot11AssocMIBCompliances, cDot11ClientStatisticTable=cDot11ClientStatisticTable, cDot11ClientBytesReceived=cDot11ClientBytesReceived, ciscoDot11StationStatusTrap=ciscoDot11StationStatusTrap, CDot11AuthenticationMethod=CDot11AuthenticationMethod, cDot11ClientAuthenAlgorithm=cDot11ClientAuthenAlgorithm, cDot11ClientBytesSent=cDot11ClientBytesSent, ciscoDot11ApAssocGlobalGroup=ciscoDot11ApAssocGlobalGroup, ciscoDot11AssocMIBComplianceRev2=ciscoDot11AssocMIBComplianceRev2, cDot11ClientAdditionalAuthen=cDot11ClientAdditionalAuthen, clientDeviceName=clientDeviceName, cDot11ClientRoleClassType=cDot11ClientRoleClassType, cDot11AssStatsDeauthenticated=cDot11AssStatsDeauthenticated, cDot11ClientDuplicates=cDot11ClientDuplicates, cDot11ClientStatistics=cDot11ClientStatistics, cDot11ActiveBridges=cDot11ActiveBridges, cDot11ClientSignalStrength=cDot11ClientSignalStrength, cDot11ClientPowerSaveMode=cDot11ClientPowerSaveMode, cDot11ClientMulticastCipher=cDot11ClientMulticastCipher, cDot11ActiveWirelessClients=cDot11ActiveWirelessClients, cDot11ClientWepEnabled=cDot11ClientWepEnabled, cDot11ActiveDevicesEntry=cDot11ActiveDevicesEntry, cDot11ClientDot1xAuthenAlgorithm=cDot11ClientDot1xAuthenAlgorithm, cDot11ClientDevType=cDot11ClientDevType, apIpv4Address=apIpv4Address, ciscoDot11AssocMIBConformance=ciscoDot11AssocMIBConformance, cDot11ClientPacketsReceived=cDot11ClientPacketsReceived, apMacAddr=apMacAddr, cDot11ClientParentAddress=cDot11ClientParentAddress, cDot11ClientWepKeyMixEnabled=cDot11ClientWepKeyMixEnabled, cDot11ClientSubIfIndex=cDot11ClientSubIfIndex, ciscoDot11IfAssocStatGroup=ciscoDot11IfAssocStatGroup, CDot11ClientRadioType=CDot11ClientRadioType, cDot11ClientWepErrors=cDot11ClientWepErrors, cDot11ClientIpAddress=cDot11ClientIpAddress, cDot11ClientMicMissingFrames=cDot11ClientMicMissingFrames, cDot11ClientSigQuality=cDot11ClientSigQuality, cDot11ClientKeyManagement=cDot11ClientKeyManagement, cDot11ClientMicEnabled=cDot11ClientMicEnabled, cd11IfCipherTkipRemotMicFailures=cd11IfCipherTkipRemotMicFailures, cDot11ClientMsduFails=cDot11ClientMsduFails, cd11IfCipherTkipLocalMicFailures=cd11IfCipherTkipLocalMicFailures, cDot11ClientDevObjectID=cDot11ClientDevObjectID, cDot11ClientConfigInfoEntry=cDot11ClientConfigInfoEntry, cDot11ClientDataRateSet=cDot11ClientDataRateSet, ciscoDot11ClientNewAuthenGroup=ciscoDot11ClientNewAuthenGroup, ciscoDot11ClientAuthenGroup=ciscoDot11ClientAuthenGroup)
