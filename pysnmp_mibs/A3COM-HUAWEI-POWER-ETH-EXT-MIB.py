# SNMP MIB module (A3COM-HUAWEI-POWER-ETH-EXT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-POWER-ETH-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:46:32 2025
...
h3cPsePortFaultDescription = _H3cPsePortFaultDescription_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 1, 1, 2),
...
h3cPsePortPeakPower = _H3cPsePortPeakPower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 1, 1, 3),
...
h3cPsePortAveragePower = _H3cPsePortAveragePower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 1, 1, 4),
...
h3cPsePortCurrentPower = _H3cPsePortCurrentPower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 1, 1, 5),
...
h3cPsePortPowerLimit = _H3cPsePortPowerLimit_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 1, 1, 6),
...
h3cPsePortProfileIndex = _H3cPsePortProfileIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 1, 1, 7),
...
h3cMainPsePowerLimit = _H3cMainPsePowerLimit_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 2, 1, 1),
...
h3cMainPseAveragePower = _H3cMainPseAveragePower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 2, 1, 2),
...
h3cMainPsePeakPower = _H3cMainPsePeakPower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 2, 1, 3),
...
h3cMainGuaranteedPowerRemaining = _H3cMainGuaranteedPowerRemaining_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 2, 1, 4),
...
h3cMainPsePriorityMode = _H3cMainPsePriorityMode_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 2, 1, 5),
...
h3cMainPseLegacy = _H3cMainPseLegacy_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 2, 1, 6),
...
h3cMainPsePowerPriority = _H3cMainPsePowerPriority_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 2, 1, 7),
...
h3cPseProfilesEntry = _H3cPseProfilesEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 7, 1)
)
h3cPseProfilesEntry.setIndexNames(
    (0, "A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseProfileIndex"),
)
if mibBuilder.loadTexts:
...
h3cPseProfileIndex = _H3cPseProfileIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 7, 1, 1),
...
h3cPseProfileName = _H3cPseProfileName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 7, 1, 2),
...
h3cPseProfilePowerMode = _H3cPseProfilePowerMode_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 7, 1, 3),
...
h3cPseProfilePowerLimit = _H3cPseProfilePowerLimit_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 7, 1, 4),
...
h3cPseProfilePriority = _H3cPseProfilePriority_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 7, 1, 5),
...
h3cPseProfilePairs = _H3cPseProfilePairs_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 7, 1, 6),
...
h3cPseProfileApplyNum = _H3cPseProfileApplyNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 7, 1, 7),
...
h3cPseProfileRowStatus = _H3cPseProfileRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 7, 1, 8),
...
h3cPOEThresholdACMimimum = _H3cPOEThresholdACMimimum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 1, 1),
...
h3cPOEThresholdACMaximum = _H3cPOEThresholdACMaximum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 1, 2),
...
h3cPOEThresholdDCMinimum = _H3cPOEThresholdDCMinimum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 1, 3),
...
h3cPOEThresholdDCMaximum = _H3cPOEThresholdDCMaximum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 1, 4),
...
h3cPOESupModuleInfoObjs = _H3cPOESupModuleInfoObjs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2)
)
...
h3cPOEPowerType = _H3cPOEPowerType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 1),
...
h3cPOEPowerModuleNum = _H3cPOEPowerModuleNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 2),
...
h3cPOESupervisionModuleName = _H3cPOESupervisionModuleName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 3),
...
h3cPOESMMajorVersion = _H3cPOESMMajorVersion_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 4),
...
h3cPOESMMinorVersion = _H3cPOESMMinorVersion_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 5),
...
h3cPOESMFactorName = _H3cPOESMFactorName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 6),
...
h3cPOEModuleInfoTable = _H3cPOEModuleInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 7)
)
if mibBuilder.loadTexts:
...
h3cPOEModuleInfoEntry = _H3cPOEModuleInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 7, 1)
)
h3cPOEModuleInfoEntry.setIndexNames(
    (0, "A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEModuleIndex"),
)
if mibBuilder.loadTexts:
...
h3cPOEModuleIndex = _H3cPOEModuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 7, 1, 1),
...
h3cPOEModuleID = _H3cPOEModuleID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 7, 1, 2),
...
h3cPOEModuleInfoPower = _H3cPOEModuleInfoPower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 7, 1, 3),
...
h3cPOEModuleHardVerInfo = _H3cPOEModuleHardVerInfo_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 2, 7, 1, 4),
...
h3cPOEDCOutStateObjects = _H3cPOEDCOutStateObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 3)
)
...
h3cPOEDCOutStateModuleNum = _H3cPOEDCOutStateModuleNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 3, 1),
...
h3cPOEDCOutStateTable = _H3cPOEDCOutStateTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 3, 2)
)
if mibBuilder.loadTexts:
...
h3cPOEDCOutStateEntry = _H3cPOEDCOutStateEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 3, 2, 1)
)
h3cPOEDCOutStateEntry.setIndexNames(
    (0, "A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEDCOutStateIndex"),
)
if mibBuilder.loadTexts:
...
h3cPOEDCOutStateIndex = _H3cPOEDCOutStateIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 3, 2, 1, 1),
...
h3cPOEDCOutDCVolAlarm = _H3cPOEDCOutDCVolAlarm_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 3, 2, 1, 2),
...
h3cPOEDCOutInfoTable = _H3cPOEDCOutInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 4, 2)
)
if mibBuilder.loadTexts:
...
h3cPOEDCOutInfoEntry = _H3cPOEDCOutInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 4, 2, 1)
)
h3cPOEDCOutInfoEntry.setIndexNames(
    (0, "A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEDCOutInfoIndex"),
)
if mibBuilder.loadTexts:
...
h3cPOEDCOutInfoIndex = _H3cPOEDCOutInfoIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 4, 2, 1, 1),
...
h3cPOEDCOutVol = _H3cPOEDCOutVol_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 4, 2, 1, 2),
...
h3cPOEDCOutInfoLoadCur = _H3cPOEDCOutInfoLoadCur_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 4, 2, 1, 3),
...
h3cPOEACSwitchStateModuleObjs = _H3cPOEACSwitchStateModuleObjs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 5)
)
...
h3cPOEACSwitchStateModuleNum = _H3cPOEACSwitchStateModuleNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 5, 1),
...
h3cPOEACSwitchStateTable = _H3cPOEACSwitchStateTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 5, 2)
)
if mibBuilder.loadTexts:
...
h3cPOEACSwitchStateEntry = _H3cPOEACSwitchStateEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 5, 2, 1)
)
h3cPOEACSwitchStateEntry.setIndexNames(
    (0, "A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEACSwitchStateIndex"),
)
if mibBuilder.loadTexts:
...
h3cPOEACSwitchStateIndex = _H3cPOEACSwitchStateIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 5, 2, 1, 1),
...
h3cPOEACSwitchState = _H3cPOEACSwitchState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 5, 2, 1, 2),
...
h3cPOEInCurStateObjects = _H3cPOEInCurStateObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6)
)
...
h3cPOEInCurStateModuleNum = _H3cPOEInCurStateModuleNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 1),
...
h3cPOEInCurAState = _H3cPOEInCurAState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 2),
...
h3cPOEInCurBState = _H3cPOEInCurBState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 3),
...
h3cPOEInCurCState = _H3cPOEInCurCState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 4),
...
h3cPOESwitchStateVolExTable = _H3cPOESwitchStateVolExTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 5)
)
if mibBuilder.loadTexts:
...
h3cPOESwitchStateVolExEntry = _H3cPOESwitchStateVolExEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 5, 1)
)
h3cPOESwitchStateVolExEntry.setIndexNames(
    (0, "A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESwitchStateVolExIndex"),
)
if mibBuilder.loadTexts:
...
h3cPOESwitchStateVolExIndex = _H3cPOESwitchStateVolExIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 5, 1, 1),
...
h3cPOESwitchStateInVolAB = _H3cPOESwitchStateInVolAB_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 5, 1, 2),
...
h3cPOESwitchStateInVolBC = _H3cPOESwitchStateInVolBC_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 5, 1, 3),
...
h3cPOESwitchStateInVolCA = _H3cPOESwitchStateInVolCA_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 6, 5, 1, 4),
...
h3cPOEAlarmStateObjects = _H3cPOEAlarmStateObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7)
)
...
h3cPOEAlarmStateModuleNum = _H3cPOEAlarmStateModuleNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 1),
...
h3cPOEAlarmStateInfoTable = _H3cPOEAlarmStateInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2)
)
if mibBuilder.loadTexts:
...
h3cPOEAlarmStateInfoEntry = _H3cPOEAlarmStateInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1)
)
h3cPOEAlarmStateInfoEntry.setIndexNames(
    (0, "A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmModuleInfoIndex"),
)
if mibBuilder.loadTexts:
...
h3cPOEAlarmModuleInfoIndex = _H3cPOEAlarmModuleInfoIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1, 1),
...
h3cPOEModuleDisconnect = _H3cPOEModuleDisconnect_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1, 2),
...
h3cPOEModuleInputError = _H3cPOEModuleInputError_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1, 3),
...
h3cPOEModuleOutputError = _H3cPOEModuleOutputError_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1, 4),
...
h3cPOEModuleOverVoltage = _H3cPOEModuleOverVoltage_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1, 5),
...
h3cPOEModuleOverTemp = _H3cPOEModuleOverTemp_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1, 6),
...
h3cPOEModuleFanError = _H3cPOEModuleFanError_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1, 7),
...
h3cPOEModuleShutdown = _H3cPOEModuleShutdown_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1, 8),
...
h3cPOEModuleCurRestricted = _H3cPOEModuleCurRestricted_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 8, 7, 2, 1, 9),
...
h3cPDPolicyMode = _H3cPDPolicyMode_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 10),
...
h3cPsePortGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 1)
)
h3cPsePortGroup.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePortProfileIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePortPowerLimit"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePortCurrentPower"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePortAveragePower"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePortPeakPower"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePortFaultDescription"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cMainPsePriorityMode"))
)
if mibBuilder.loadTexts:
    h3cPsePortGroup.setStatus("current")

h3cMainPseGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 2)
)
h3cMainPseGroup.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cMainPsePowerLimit"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cMainPseAveragePower"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cMainPsePeakPower"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cMainGuaranteedPowerRemaining"))
)
if mibBuilder.loadTexts:
    h3cMainPseGroup.setStatus("current")

h3cPseScalarGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 3)
)
h3cPseScalarGroup.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseAutoDetectActive"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePowerMaxValue"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePolicyMode"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPDPolicyMode"))
)
if mibBuilder.loadTexts:
    h3cPseScalarGroup.setStatus("current")

h3cPsePDNotificationGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 4)
)
h3cPsePDNotificationGroup.setObjects(
    ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cpsePDChangeNotification")
)
if mibBuilder.loadTexts:
    h3cPsePDNotificationGroup.setStatus("current")

h3cPseProfilesGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 5)
)
h3cPseProfilesGroup.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseProfileName"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseProfilePowerMode"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseProfilePowerLimit"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseProfilePriority"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseProfilePairs"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseProfileApplyNum"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseProfileRowStatus"))
)
if mibBuilder.loadTexts:
    h3cPseProfilesGroup.setStatus("current")

h3cPOEPowerThresholdLimitGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 6)
)
h3cPOEPowerThresholdLimitGroup.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEThresholdACMimimum"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEThresholdACMaximum"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEThresholdDCMinimum"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEThresholdDCMaximum"))
)
if mibBuilder.loadTexts:
    h3cPOEPowerThresholdLimitGroup.setStatus("current")

h3cPOEPowerSupInfoGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 7)
)
h3cPOEPowerSupInfoGroup.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEPowerType"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEPowerModuleNum"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESupervisionModuleName"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESMMajorVersion"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESMMinorVersion"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESMFactorName"))
)
if mibBuilder.loadTexts:
    h3cPOEPowerSupInfoGroup.setStatus("current")

h3cPOEPowerDCOutStateGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 8)
)
h3cPOEPowerDCOutStateGroup.setObjects(
    ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEDCOutStateModuleNum")
)
if mibBuilder.loadTexts:
    h3cPOEPowerDCOutStateGroup.setStatus("current")

h3cPOEPowerDCOutInfoGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 9)
)
h3cPOEPowerDCOutInfoGroup.setObjects(
    ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEDCOutCurNum")
)
if mibBuilder.loadTexts:
    h3cPOEPowerDCOutInfoGroup.setStatus("current")

h3cPOEPowerACSwitchStateModuleGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 10)
)
h3cPOEPowerACSwitchStateModuleGroup.setObjects(
    ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEACSwitchStateModuleNum")
)
if mibBuilder.loadTexts:
    h3cPOEPowerACSwitchStateModuleGroup.setStatus("current")

h3cPOEPowerInCurStateGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 11)
)
h3cPOEPowerInCurStateGroup.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEInCurStateModuleNum"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEInCurAState"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEInCurBState"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEInCurCState"))
)
if mibBuilder.loadTexts:
    h3cPOEPowerInCurStateGroup.setStatus("current")

h3cPOEPowerAlarmStateGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 2, 12)
)
h3cPOEPowerAlarmStateGroup.setObjects(
    ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmStateModuleNum")
)
if mibBuilder.loadTexts:
...
h3cpsePDChangeNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 1)
)
...
h3cPOEDisconnectNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 2)
)
h3cPOEDisconnectNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmModuleInfoIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEModuleDisconnect"))
)
if mibBuilder.loadTexts:
...
h3cPOEInputErrorNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 3)
)
h3cPOEInputErrorNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmModuleInfoIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEModuleInputError"))
)
if mibBuilder.loadTexts:
...
h3cPOEOutputErrorNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 4)
)
h3cPOEOutputErrorNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmModuleInfoIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEModuleOutputError"))
)
if mibBuilder.loadTexts:
...
h3cPOEOverVoltageNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 5)
)
h3cPOEOverVoltageNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmModuleInfoIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEModuleOverVoltage"))
)
if mibBuilder.loadTexts:
...
h3cPOEOverTempNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 6)
)
h3cPOEOverTempNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmModuleInfoIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEModuleOverTemp"))
)
if mibBuilder.loadTexts:
...
h3cPOEFanErrorNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 7)
)
h3cPOEFanErrorNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmModuleInfoIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEModuleFanError"))
)
if mibBuilder.loadTexts:
...
h3cPOEModuleShutdownNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 8)
)
h3cPOEModuleShutdownNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmModuleInfoIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEModuleShutdown"))
)
if mibBuilder.loadTexts:
...
h3cPOECurRestrictedNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 9)
)
h3cPOECurRestrictedNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEAlarmModuleInfoIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEModuleCurRestricted"))
)
if mibBuilder.loadTexts:
...
h3cPOEACSwitchNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 10)
)
h3cPOEACSwitchNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEACSwitchStateIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEACSwitchState"))
)
if mibBuilder.loadTexts:
...
h3cPOEACInCurANotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 11)
)
...
h3cPOEACInCurBNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 12)
)
...
h3cPOEACInCurCNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 13)
)
...
h3cPOEACSwitchVolABNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 14)
)
h3cPOEACSwitchVolABNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESwitchStateVolExIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESwitchStateInVolAB"))
)
if mibBuilder.loadTexts:
...
h3cPOEACSwitchVolBCNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 15)
)
h3cPOEACSwitchVolBCNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESwitchStateVolExIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESwitchStateInVolBC"))
)
if mibBuilder.loadTexts:
...
h3cPOEACSwitchVolCANotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 16)
)
h3cPOEACSwitchVolCANotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESwitchStateVolExIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOESwitchStateInVolCA"))
)
if mibBuilder.loadTexts:
...
h3cPOEDCOutVolNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 17)
)
h3cPOEDCOutVolNotification.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEDCOutStateIndex"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPOEDCOutDCVolAlarm"))
)
if mibBuilder.loadTexts:
...
h3cPOEShutdownNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 6, 18)
)
if mibBuilder.loadTexts:
...
h3cPseCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 14, 4, 1, 1)
)
h3cPseCompliance.setObjects(
      *(("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePortGroup"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cMainPseGroup"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseScalarGroup"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPsePDNotificationGroup"),
        ("A3COM-HUAWEI-POWER-ETH-EXT-MIB", "h3cPseProfilesGroup"))
)
if mibBuilder.loadTexts:
