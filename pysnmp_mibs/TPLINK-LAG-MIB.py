...
# Notes
# -----
# ASN.1 source file://mibs/tplink/TPLINK-LAG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:56:25 2025
...
tpLacpAdminKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
tpLacpMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
