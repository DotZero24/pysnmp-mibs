_S='hwvLANMibHoldTimeEntry'
_R='hwvLANMibSwitchCountEntry'
_Q='hwPrimaryVlanID'
_P='hwifSuperVlanID'
...
if mibBuilder.loadTexts:hwLswVlan.setRevisions(('2016-08-31 00:00',))
...
hwLswVlanMngObject=_HwLswVlanMngObject_ObjectIdentity((1,3,6,1,4,1,2011,2,23,1,2,1))
if mibBuilder.loadTexts:hwLswVlanMngObject.setStatus(_A)
_Hwdot1qVlanMIBTable_Object=MibTable
hwdot1qVlanMIBTable=_Hwdot1qVlanMIBTable_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1))
if mibBuilder.loadTexts:hwdot1qVlanMIBTable.setStatus(_A)
_Hwdot1qVlanMIBEntry_Object=MibTableRow
hwdot1qVlanMIBEntry=_Hwdot1qVlanMIBEntry_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1))
...
hwdot1qVlanIndex=_Hwdot1qVlanIndex_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,1),_Hwdot1qVlanIndex_Type())
hwdot1qVlanIndex.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1qVlanIndex.setStatus(_A)
class _Hwdot1qVlanName_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,80))
_Hwdot1qVlanName_Type.__name__=_H
_Hwdot1qVlanName_Object=MibTableColumn
hwdot1qVlanName=_Hwdot1qVlanName_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,2),_Hwdot1qVlanName_Type())
...
hwdot1qVlanPorts=_Hwdot1qVlanPorts_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,3),_Hwdot1qVlanPorts_Type())
hwdot1qVlanPorts.setMaxAccess(_C)
if mibBuilder.loadTexts:hwdot1qVlanPorts.setStatus(_A)
class _Hwdot1qVlanType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6)));namedValues=NamedValues(*(('superVlan',1),('common-vlan',2),('sub-vlan',3),('isolate-user-vlan',4),('secondary-vlan',5),('primaryVlan',6)))
_Hwdot1qVlanType_Type.__name__=_D
_Hwdot1qVlanType_Object=MibTableColumn
hwdot1qVlanType=_Hwdot1qVlanType_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,4),_Hwdot1qVlanType_Type())
...
hwdot1qVlanMacFilter=_Hwdot1qVlanMacFilter_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,5),_Hwdot1qVlanMacFilter_Type())
...
hwdot1qVlanMcastUnknownProtos=_Hwdot1qVlanMcastUnknownProtos_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,6),_Hwdot1qVlanMcastUnknownProtos_Type())
...
hwExistInterface=_HwExistInterface_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,7),_HwExistInterface_Type())
...
hwVlanInterfaceIndex=_HwVlanInterfaceIndex_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,8),_HwVlanInterfaceIndex_Type())
...
hwdot1qVlanMacLearn=_Hwdot1qVlanMacLearn_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,9),_Hwdot1qVlanMacLearn_Type())
...
hwdot1qVlanStatus=_Hwdot1qVlanStatus_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,10),_Hwdot1qVlanStatus_Type())
...
hwdot1qVlanCreationTime=_Hwdot1qVlanCreationTime_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,11),_Hwdot1qVlanCreationTime_Type())
...
hwdot1qVlanPriority=_Hwdot1qVlanPriority_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,12),_Hwdot1qVlanPriority_Type())
...
hwdot1qVlanRowStatus=_Hwdot1qVlanRowStatus_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,13),_Hwdot1qVlanRowStatus_Type())
...
hwdot1qVlanBroadcastSuppression=_Hwdot1qVlanBroadcastSuppression_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,14),_Hwdot1qVlanBroadcastSuppression_Type())
...
hwdot1qVlanBcastSuppressionPPS=_Hwdot1qVlanBcastSuppressionPPS_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,15),_Hwdot1qVlanBcastSuppressionPPS_Type())
...
hwdot1qVlanMulticast=_Hwdot1qVlanMulticast_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,16),_Hwdot1qVlanMulticast_Type())
...
hwdot1qVlanTaggedPorts=_Hwdot1qVlanTaggedPorts_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,17),_Hwdot1qVlanTaggedPorts_Type())
...
hwdot1qVlanUntaggedPorts=_Hwdot1qVlanUntaggedPorts_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,18),_Hwdot1qVlanUntaggedPorts_Type())
...
hwdot1qVlanPortIndexs=_Hwdot1qVlanPortIndexs_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,19),_Hwdot1qVlanPortIndexs_Type())
hwdot1qVlanPortIndexs.setMaxAccess(_C)
if mibBuilder.loadTexts:hwdot1qVlanPortIndexs.setStatus(_A)
_Hwdot1qVlanStatisticStatus_Type=TruthValue
_Hwdot1qVlanStatisticStatus_Object=MibTableColumn
hwdot1qVlanStatisticStatus=_Hwdot1qVlanStatisticStatus_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,20),_Hwdot1qVlanStatisticStatus_Type())
hwdot1qVlanStatisticStatus.setMaxAccess(_C)
if mibBuilder.loadTexts:hwdot1qVlanStatisticStatus.setStatus(_A)
class _Hwdot1qVlanStatisticClear_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(1));namedValues=NamedValues(('clear',1))
_Hwdot1qVlanStatisticClear_Type.__name__=_D
_Hwdot1qVlanStatisticClear_Object=MibTableColumn
hwdot1qVlanStatisticClear=_Hwdot1qVlanStatisticClear_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,21),_Hwdot1qVlanStatisticClear_Type())
hwdot1qVlanStatisticClear.setMaxAccess(_C)
if mibBuilder.loadTexts:hwdot1qVlanStatisticClear.setStatus(_A)
_Hwdot1qVlanStatisticInTotalPkts_Type=Counter64
_Hwdot1qVlanStatisticInTotalPkts_Object=MibTableColumn
hwdot1qVlanStatisticInTotalPkts=_Hwdot1qVlanStatisticInTotalPkts_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,22),_Hwdot1qVlanStatisticInTotalPkts_Type())
hwdot1qVlanStatisticInTotalPkts.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1qVlanStatisticInTotalPkts.setStatus(_A)
_Hwdot1qVlanStatisticInTotalBytes_Type=Counter64
_Hwdot1qVlanStatisticInTotalBytes_Object=MibTableColumn
hwdot1qVlanStatisticInTotalBytes=_Hwdot1qVlanStatisticInTotalBytes_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,23),_Hwdot1qVlanStatisticInTotalBytes_Type())
hwdot1qVlanStatisticInTotalBytes.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1qVlanStatisticInTotalBytes.setStatus(_A)
_Hwdot1qVlanStatisticInPPS_Type=Counter64
_Hwdot1qVlanStatisticInPPS_Object=MibTableColumn
hwdot1qVlanStatisticInPPS=_Hwdot1qVlanStatisticInPPS_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,24),_Hwdot1qVlanStatisticInPPS_Type())
hwdot1qVlanStatisticInPPS.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1qVlanStatisticInPPS.setStatus(_A)
_Hwdot1qVlanStatisticInBPS_Type=Counter64
_Hwdot1qVlanStatisticInBPS_Object=MibTableColumn
hwdot1qVlanStatisticInBPS=_Hwdot1qVlanStatisticInBPS_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,25),_Hwdot1qVlanStatisticInBPS_Type())
hwdot1qVlanStatisticInBPS.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1qVlanStatisticInBPS.setStatus(_A)
_Hwdot1qVlanStatisticOutTotalPkts_Type=Counter64
_Hwdot1qVlanStatisticOutTotalPkts_Object=MibTableColumn
hwdot1qVlanStatisticOutTotalPkts=_Hwdot1qVlanStatisticOutTotalPkts_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,26),_Hwdot1qVlanStatisticOutTotalPkts_Type())
hwdot1qVlanStatisticOutTotalPkts.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1qVlanStatisticOutTotalPkts.setStatus(_A)
_Hwdot1qVlanStatisticOutTotalBytes_Type=Counter64
_Hwdot1qVlanStatisticOutTotalBytes_Object=MibTableColumn
hwdot1qVlanStatisticOutTotalBytes=_Hwdot1qVlanStatisticOutTotalBytes_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,27),_Hwdot1qVlanStatisticOutTotalBytes_Type())
hwdot1qVlanStatisticOutTotalBytes.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1qVlanStatisticOutTotalBytes.setStatus(_A)
_Hwdot1qVlanStatisticOutPPS_Type=Counter64
_Hwdot1qVlanStatisticOutPPS_Object=MibTableColumn
hwdot1qVlanStatisticOutPPS=_Hwdot1qVlanStatisticOutPPS_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,28),_Hwdot1qVlanStatisticOutPPS_Type())
hwdot1qVlanStatisticOutPPS.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1qVlanStatisticOutPPS.setStatus(_A)
_Hwdot1qVlanStatisticOutBPS_Type=Counter64
_Hwdot1qVlanStatisticOutBPS_Object=MibTableColumn
hwdot1qVlanStatisticOutBPS=_Hwdot1qVlanStatisticOutBPS_Object((1,3,6,1,4,1,2011,2,23,1,2,1,1,1,29),_Hwdot1qVlanStatisticOutBPS_Type())
hwdot1qVlanStatisticOutBPS.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1qVlanStatisticOutBPS.setStatus(_A)
_HwVlanInterfaceTable_Object=MibTable
hwVlanInterfaceTable=_HwVlanInterfaceTable_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2))
if mibBuilder.loadTexts:hwVlanInterfaceTable.setStatus(_A)
_HwVlanInterfaceEntry_Object=MibTableRow
hwVlanInterfaceEntry=_HwVlanInterfaceEntry_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1))
...
hwVlanInterfaceID=_HwVlanInterfaceID_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1,1),_HwVlanInterfaceID_Type())
...
hwdot1qVlanID=_Hwdot1qVlanID_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1,2),_Hwdot1qVlanID_Type())
...
hwdot1qVlanIpAddress=_Hwdot1qVlanIpAddress_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1,3),_Hwdot1qVlanIpAddress_Type())
...
hwdot1qVlanIpAddressMask=_Hwdot1qVlanIpAddressMask_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1,4),_Hwdot1qVlanIpAddressMask_Type())
...
hwVlanInterfaceAdminStatus=_HwVlanInterfaceAdminStatus_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1,5),_HwVlanInterfaceAdminStatus_Type())
...
hwVlanInterfaceFrameType=_HwVlanInterfaceFrameType_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1,6),_HwVlanInterfaceFrameType_Type())
...
hwInterfaceRowStatus=_HwInterfaceRowStatus_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1,7),_HwInterfaceRowStatus_Type())
...
hwVlanInterfaceIpMethod=_HwVlanInterfaceIpMethod_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1,8),_HwVlanInterfaceIpMethod_Type())
...
hwVlanInterfaceIfIndex=_HwVlanInterfaceIfIndex_Object((1,3,6,1,4,1,2011,2,23,1,2,1,2,1,9),_HwVlanInterfaceIfIndex_Type())
...
hwifIsolateMappingTable=_HwifIsolateMappingTable_Object((1,3,6,1,4,1,2011,2,23,1,2,1,4))
if mibBuilder.loadTexts:hwifIsolateMappingTable.setStatus(_A)
_HwifIsolateMappingEntry_Object=MibTableRow
hwifIsolateMappingEntry=_HwifIsolateMappingEntry_Object((1,3,6,1,4,1,2011,2,23,1,2,1,4,1))
...
hwifIsolatePrimaryVlanID=_HwifIsolatePrimaryVlanID_Object((1,3,6,1,4,1,2011,2,23,1,2,1,4,1,1),_HwifIsolatePrimaryVlanID_Type())
...
hwifIsolateSecondaryVlanlistLow=_HwifIsolateSecondaryVlanlistLow_Object((1,3,6,1,4,1,2011,2,23,1,2,1,4,1,2),_HwifIsolateSecondaryVlanlistLow_Type())
...
hwifIsolateSecondaryVlanlistHigh=_HwifIsolateSecondaryVlanlistHigh_Object((1,3,6,1,4,1,2011,2,23,1,2,1,4,1,3),_HwifIsolateSecondaryVlanlistHigh_Type())
...
hwVlanInterfaceAddrTable=_HwVlanInterfaceAddrTable_Object((1,3,6,1,4,1,2011,2,23,1,2,1,5))
if mibBuilder.loadTexts:hwVlanInterfaceAddrTable.setStatus(_A)
_HwVlanInterfaceAddrEntry_Object=MibTableRow
hwVlanInterfaceAddrEntry=_HwVlanInterfaceAddrEntry_Object((1,3,6,1,4,1,2011,2,23,1,2,1,5,1))
...
hwVlanInterfaceIpIfIndex=_HwVlanInterfaceIpIfIndex_Object((1,3,6,1,4,1,2011,2,23,1,2,1,5,1,1),_HwVlanInterfaceIpIfIndex_Type())
...
hwVlanInterfaceIpAddr=_HwVlanInterfaceIpAddr_Object((1,3,6,1,4,1,2011,2,23,1,2,1,5,1,2),_HwVlanInterfaceIpAddr_Type())
hwVlanInterfaceIpAddr.setMaxAccess(_B)
...
hwVlanInterfaceIpMask=_HwVlanInterfaceIpMask_Object((1,3,6,1,4,1,2011,2,23,1,2,1,5,1,3),_HwVlanInterfaceIpMask_Type())
hwVlanInterfaceIpMask.setMaxAccess(_G)
...
hwVlanInterfaceIpType=_HwVlanInterfaceIpType_Object((1,3,6,1,4,1,2011,2,23,1,2,1,5,1,4),_HwVlanInterfaceIpType_Type())
hwVlanInterfaceIpType.setMaxAccess(_G)
...
hwVlanInterfaceIpRowStatus=_HwVlanInterfaceIpRowStatus_Object((1,3,6,1,4,1,2011,2,23,1,2,1,5,1,5),_HwVlanInterfaceIpRowStatus_Type())
...
hwdot1qVlanBatchMIBTable=_Hwdot1qVlanBatchMIBTable_Object((1,3,6,1,4,1,2011,2,23,1,2,1,6))
if mibBuilder.loadTexts:hwdot1qVlanBatchMIBTable.setStatus(_A)
_HwDot1qVlanBatchMIBEntry_Object=MibTableRow
hwDot1qVlanBatchMIBEntry=_HwDot1qVlanBatchMIBEntry_Object((1,3,6,1,4,1,2011,2,23,1,2,1,6,1))
...
hwdot1qVlanBatchOperIndex=_Hwdot1qVlanBatchOperIndex_Object((1,3,6,1,4,1,2011,2,23,1,2,1,6,1,1),_Hwdot1qVlanBatchOperIndex_Type())
...
hwdot1qVlanBatchStartIndex=_Hwdot1qVlanBatchStartIndex_Object((1,3,6,1,4,1,2011,2,23,1,2,1,6,1,2),_Hwdot1qVlanBatchStartIndex_Type())
...
hwdot1qVlanBatchEndIndex=_Hwdot1qVlanBatchEndIndex_Object((1,3,6,1,4,1,2011,2,23,1,2,1,6,1,3),_Hwdot1qVlanBatchEndIndex_Type())
...
hwdot1qVlanBatchOperStatus=_Hwdot1qVlanBatchOperStatus_Object((1,3,6,1,4,1,2011,2,23,1,2,1,6,1,4),_Hwdot1qVlanBatchOperStatus_Type())
...
hwdot1qVlanBatchRowStatus=_Hwdot1qVlanBatchRowStatus_Object((1,3,6,1,4,1,2011,2,23,1,2,1,6,1,5),_Hwdot1qVlanBatchRowStatus_Type())
...
hwdot1qVlanBatchSetOperate=_Hwdot1qVlanBatchSetOperate_Object((1,3,6,1,4,1,2011,2,23,1,2,1,6,1,6),_Hwdot1qVlanBatchSetOperate_Type())
...
hwifSuperVlanMappingTable=_HwifSuperVlanMappingTable_Object((1,3,6,1,4,1,2011,2,23,1,2,1,7))
if mibBuilder.loadTexts:hwifSuperVlanMappingTable.setStatus(_A)
_HwifSuperVlanMappingEntry_Object=MibTableRow
hwifSuperVlanMappingEntry=_HwifSuperVlanMappingEntry_Object((1,3,6,1,4,1,2011,2,23,1,2,1,7,1))
...
hwifSuperVlanID=_HwifSuperVlanID_Object((1,3,6,1,4,1,2011,2,23,1,2,1,7,1,1),_HwifSuperVlanID_Type())
...
hwifSubVlanlistLow=_HwifSubVlanlistLow_Object((1,3,6,1,4,1,2011,2,23,1,2,1,7,1,2),_HwifSubVlanlistLow_Type())
...
hwifSubVlanlistHigh=_HwifSubVlanlistHigh_Object((1,3,6,1,4,1,2011,2,23,1,2,1,7,1,3),_HwifSubVlanlistHigh_Type())
hwifSubVlanlistHigh.setMaxAccess(_C)
if mibBuilder.loadTexts:hwifSubVlanlistHigh.setStatus(_A)
_HwPrivateVlanMappingTable_Object=MibTable
hwPrivateVlanMappingTable=_HwPrivateVlanMappingTable_Object((1,3,6,1,4,1,2011,2,23,1,2,1,8))
if mibBuilder.loadTexts:hwPrivateVlanMappingTable.setStatus(_A)
_HwPrivateVlanMappingEntry_Object=MibTableRow
hwPrivateVlanMappingEntry=_HwPrivateVlanMappingEntry_Object((1,3,6,1,4,1,2011,2,23,1,2,1,8,1))
hwPrivateVlanMappingEntry.setIndexNames((0,_E,_Q))
if mibBuilder.loadTexts:hwPrivateVlanMappingEntry.setStatus(_A)
_HwPrimaryVlanID_Type=HwVlanIndex
_HwPrimaryVlanID_Object=MibTableColumn
hwPrimaryVlanID=_HwPrimaryVlanID_Object((1,3,6,1,4,1,2011,2,23,1,2,1,8,1,1),_HwPrimaryVlanID_Type())
hwPrimaryVlanID.setMaxAccess(_B)
if mibBuilder.loadTexts:hwPrimaryVlanID.setStatus(_A)
class _HwSecondaryVlanlistLow_Type(OctetString):subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,256))
_HwSecondaryVlanlistLow_Type.__name__=_F
_HwSecondaryVlanlistLow_Object=MibTableColumn
hwSecondaryVlanlistLow=_HwSecondaryVlanlistLow_Object((1,3,6,1,4,1,2011,2,23,1,2,1,8,1,2),_HwSecondaryVlanlistLow_Type())
hwSecondaryVlanlistLow.setMaxAccess(_C)
if mibBuilder.loadTexts:hwSecondaryVlanlistLow.setStatus(_A)
class _HwSecondaryVlanlistHigh_Type(OctetString):subtypeSpec=OctetString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,256))
_HwSecondaryVlanlistHigh_Type.__name__=_F
_HwSecondaryVlanlistHigh_Object=MibTableColumn
hwSecondaryVlanlistHigh=_HwSecondaryVlanlistHigh_Object((1,3,6,1,4,1,2011,2,23,1,2,1,8,1,3),_HwSecondaryVlanlistHigh_Type())
hwSecondaryVlanlistHigh.setMaxAccess(_C)
if mibBuilder.loadTexts:hwSecondaryVlanlistHigh.setStatus(_A)
_HwLswVlanProtoObject_ObjectIdentity=ObjectIdentity
hwLswVlanProtoObject=_HwLswVlanProtoObject_ObjectIdentity((1,3,6,1,4,1,2011,2,23,1,2,2))
...
hwVLANMibGarpLeaveAllTime=_HwVLANMibGarpLeaveAllTime_Object((1,3,6,1,4,1,2011,2,23,1,2,2,14),_HwVLANMibGarpLeaveAllTime_Type())
...
hwvLANMibSwitchCountTable=_HwvLANMibSwitchCountTable_Object((1,3,6,1,4,1,2011,2,23,1,2,2,15))
if mibBuilder.loadTexts:hwvLANMibSwitchCountTable.setStatus(_A)
_HwvLANMibSwitchCountEntry_Object=MibTableRow
hwvLANMibSwitchCountEntry=_HwvLANMibSwitchCountEntry_Object((1,3,6,1,4,1,2011,2,23,1,2,2,15,1))
...
hwVLANMibSwitchGMRPRXPkt=_HwVLANMibSwitchGMRPRXPkt_Object((1,3,6,1,4,1,2011,2,23,1,2,2,15,1,1),_HwVLANMibSwitchGMRPRXPkt_Type())
...
hwVLANMibSwitchGVRPRXPkt=_HwVLANMibSwitchGVRPRXPkt_Object((1,3,6,1,4,1,2011,2,23,1,2,2,15,1,2),_HwVLANMibSwitchGVRPRXPkt_Type())
...
hwVLANMibSwitchGMRPTXPkt=_HwVLANMibSwitchGMRPTXPkt_Object((1,3,6,1,4,1,2011,2,23,1,2,2,15,1,3),_HwVLANMibSwitchGMRPTXPkt_Type())
...
hwVLANMibSwitchGVRPTXPkt=_HwVLANMibSwitchGVRPTXPkt_Object((1,3,6,1,4,1,2011,2,23,1,2,2,15,1,4),_HwVLANMibSwitchGVRPTXPkt_Type())
...
hwVLANMibSwitchDiscardedPkt=_HwVLANMibSwitchDiscardedPkt_Object((1,3,6,1,4,1,2011,2,23,1,2,2,15,1,5),_HwVLANMibSwitchDiscardedPkt_Type())
...
hwVLANMibSwitchGarpStatClear=_HwVLANMibSwitchGarpStatClear_Object((1,3,6,1,4,1,2011,2,23,1,2,2,15,1,6),_HwVLANMibSwitchGarpStatClear_Type())
...
hwvLANMibHoldTimeTable=_HwvLANMibHoldTimeTable_Object((1,3,6,1,4,1,2011,2,23,1,2,2,16))
if mibBuilder.loadTexts:hwvLANMibHoldTimeTable.setStatus(_A)
_HwvLANMibHoldTimeEntry_Object=MibTableRow
hwvLANMibHoldTimeEntry=_HwvLANMibHoldTimeEntry_Object((1,3,6,1,4,1,2011,2,23,1,2,2,16,1))
...
hwVLANMibHoldTime=_HwVLANMibHoldTime_Object((1,3,6,1,4,1,2011,2,23,1,2,2,16,1,1),_HwVLANMibHoldTime_Type())
hwVLANMibHoldTime.setMaxAccess(_C)
if mibBuilder.loadTexts:hwVLANMibHoldTime.setStatus(_A)
hwifVLANTrunkStatusEntry.registerAugmentions((_E,_R))
