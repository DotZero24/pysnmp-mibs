...
# Notes
# -----
# ASN.1 source file://mibs/h3c/HUAWEI-LswVLAN-MIB
...
hwdot1qVlanStatisticStatus = _Hwdot1qVlanStatisticStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 20),
    _Hwdot1qVlanStatisticStatus_Type()
)
hwdot1qVlanStatisticStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticStatus.setStatus("current")


class _Hwdot1qVlanStatisticClear_Type(Integer32):
    """Custom type hwdot1qVlanStatisticClear based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            1
...
_Hwdot1qVlanStatisticClear_Type.__name__ = "Integer32"
_Hwdot1qVlanStatisticClear_Object = MibTableColumn
hwdot1qVlanStatisticClear = _Hwdot1qVlanStatisticClear_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 21),
    _Hwdot1qVlanStatisticClear_Type()
)
hwdot1qVlanStatisticClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticClear.setStatus("current")
_Hwdot1qVlanStatisticInTotalPkts_Type = Counter64
_Hwdot1qVlanStatisticInTotalPkts_Object = MibTableColumn
hwdot1qVlanStatisticInTotalPkts = _Hwdot1qVlanStatisticInTotalPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 22),
    _Hwdot1qVlanStatisticInTotalPkts_Type()
)
hwdot1qVlanStatisticInTotalPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticInTotalPkts.setStatus("current")
_Hwdot1qVlanStatisticInTotalBytes_Type = Counter64
_Hwdot1qVlanStatisticInTotalBytes_Object = MibTableColumn
hwdot1qVlanStatisticInTotalBytes = _Hwdot1qVlanStatisticInTotalBytes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 23),
    _Hwdot1qVlanStatisticInTotalBytes_Type()
)
hwdot1qVlanStatisticInTotalBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticInTotalBytes.setStatus("current")
_Hwdot1qVlanStatisticInPPS_Type = Counter64
_Hwdot1qVlanStatisticInPPS_Object = MibTableColumn
hwdot1qVlanStatisticInPPS = _Hwdot1qVlanStatisticInPPS_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 24),
    _Hwdot1qVlanStatisticInPPS_Type()
)
hwdot1qVlanStatisticInPPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticInPPS.setStatus("current")
_Hwdot1qVlanStatisticInBPS_Type = Counter64
_Hwdot1qVlanStatisticInBPS_Object = MibTableColumn
hwdot1qVlanStatisticInBPS = _Hwdot1qVlanStatisticInBPS_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 25),
    _Hwdot1qVlanStatisticInBPS_Type()
)
hwdot1qVlanStatisticInBPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticInBPS.setStatus("current")
_Hwdot1qVlanStatisticOutTotalPkts_Type = Counter64
_Hwdot1qVlanStatisticOutTotalPkts_Object = MibTableColumn
hwdot1qVlanStatisticOutTotalPkts = _Hwdot1qVlanStatisticOutTotalPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 26),
    _Hwdot1qVlanStatisticOutTotalPkts_Type()
)
hwdot1qVlanStatisticOutTotalPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticOutTotalPkts.setStatus("current")
_Hwdot1qVlanStatisticOutTotalBytes_Type = Counter64
_Hwdot1qVlanStatisticOutTotalBytes_Object = MibTableColumn
hwdot1qVlanStatisticOutTotalBytes = _Hwdot1qVlanStatisticOutTotalBytes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 27),
    _Hwdot1qVlanStatisticOutTotalBytes_Type()
)
hwdot1qVlanStatisticOutTotalBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticOutTotalBytes.setStatus("current")
_Hwdot1qVlanStatisticOutPPS_Type = Counter64
_Hwdot1qVlanStatisticOutPPS_Object = MibTableColumn
hwdot1qVlanStatisticOutPPS = _Hwdot1qVlanStatisticOutPPS_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 28),
    _Hwdot1qVlanStatisticOutPPS_Type()
)
hwdot1qVlanStatisticOutPPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticOutPPS.setStatus("current")
_Hwdot1qVlanStatisticOutBPS_Type = Counter64
_Hwdot1qVlanStatisticOutBPS_Object = MibTableColumn
hwdot1qVlanStatisticOutBPS = _Hwdot1qVlanStatisticOutBPS_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 1, 1, 29),
    _Hwdot1qVlanStatisticOutBPS_Type()
)
hwdot1qVlanStatisticOutBPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwdot1qVlanStatisticOutBPS.setStatus("current")
...
hwVlanInterfaceIpAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
hwVlanInterfaceIpMask.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
hwVlanInterfaceIpType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
hwPrivateVlanMappingTable = _HwPrivateVlanMappingTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 8)
)
if mibBuilder.loadTexts:
    hwPrivateVlanMappingTable.setStatus("current")
_HwPrivateVlanMappingEntry_Object = MibTableRow
hwPrivateVlanMappingEntry = _HwPrivateVlanMappingEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 8, 1)
)
hwPrivateVlanMappingEntry.setIndexNames(
    (0, "HUAWEI-LswVLAN-MIB", "hwPrimaryVlanID"),
)
if mibBuilder.loadTexts:
    hwPrivateVlanMappingEntry.setStatus("current")
_HwPrimaryVlanID_Type = HwVlanIndex
_HwPrimaryVlanID_Object = MibTableColumn
hwPrimaryVlanID = _HwPrimaryVlanID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 8, 1, 1),
    _HwPrimaryVlanID_Type()
)
hwPrimaryVlanID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwPrimaryVlanID.setStatus("current")


class _HwSecondaryVlanlistLow_Type(OctetString):
    """Custom type hwSecondaryVlanlistLow based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 256),
    )
...
_HwSecondaryVlanlistLow_Type.__name__ = "OctetString"
_HwSecondaryVlanlistLow_Object = MibTableColumn
hwSecondaryVlanlistLow = _HwSecondaryVlanlistLow_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 8, 1, 2),
    _HwSecondaryVlanlistLow_Type()
)
hwSecondaryVlanlistLow.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hwSecondaryVlanlistLow.setStatus("current")


class _HwSecondaryVlanlistHigh_Type(OctetString):
    """Custom type hwSecondaryVlanlistHigh based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 256),
    )
...
_HwSecondaryVlanlistHigh_Type.__name__ = "OctetString"
_HwSecondaryVlanlistHigh_Object = MibTableColumn
hwSecondaryVlanlistHigh = _HwSecondaryVlanlistHigh_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 23, 1, 2, 1, 8, 1, 3),
    _HwSecondaryVlanlistHigh_Type()
)
hwSecondaryVlanlistHigh.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hwSecondaryVlanlistHigh.setStatus("current")
...
_HwVLANMibGarpLeaveAllTime_Type.__name__ = "TimeInterval"
...
mibBuilder.exportSymbols(
    ...
    **{"HwVlanIndex": HwVlanIndex,
       ...
       "hwdot1qVlanStatisticStatus": hwdot1qVlanStatisticStatus,
       "hwdot1qVlanStatisticClear": hwdot1qVlanStatisticClear,
       "hwdot1qVlanStatisticInTotalPkts": hwdot1qVlanStatisticInTotalPkts,
       "hwdot1qVlanStatisticInTotalBytes": hwdot1qVlanStatisticInTotalBytes,
       "hwdot1qVlanStatisticInPPS": hwdot1qVlanStatisticInPPS,
       "hwdot1qVlanStatisticInBPS": hwdot1qVlanStatisticInBPS,
       "hwdot1qVlanStatisticOutTotalPkts": hwdot1qVlanStatisticOutTotalPkts,
       "hwdot1qVlanStatisticOutTotalBytes": hwdot1qVlanStatisticOutTotalBytes,
       "hwdot1qVlanStatisticOutPPS": hwdot1qVlanStatisticOutPPS,
       "hwdot1qVlanStatisticOutBPS": hwdot1qVlanStatisticOutBPS,
       ...
       "hwPrivateVlanMappingEntry": hwPrivateVlanMappingEntry,
       "hwPrimaryVlanID": hwPrimaryVlanID,
       "hwSecondaryVlanlistLow": hwSecondaryVlanlistLow,
       "hwSecondaryVlanlistHigh": hwSecondaryVlanlistHigh,
