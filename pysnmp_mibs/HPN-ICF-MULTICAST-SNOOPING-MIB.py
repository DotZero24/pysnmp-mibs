...
mibBuilder.exportSymbols("HPN-ICF-MULTICAST-SNOOPING-MIB", hpnicfMcsPortJoinGroupVlanID=hpnicfMcsPortJoinGroupVlanID, hpnicfMcsGlobalConfigTable=hpnicfMcsGlobalConfigTable, hpnicfMcsPortStaticGroupIfIndex=hpnicfMcsPortStaticGroupIfIndex, hpnicfMcsVUID=hpnicfMcsVUID, hpnicfMcsPortConfigIfIndex=hpnicfMcsPortConfigIfIndex, hpnicfMcsPortConfigEntry=hpnicfMcsPortConfigEntry, hpnicfMcsGlbLastMemQryInterval=hpnicfMcsGlbLastMemQryInterval, hpnicfMcsStatisticsSnoopingType=hpnicfMcsStatisticsSnoopingType, hpnicfMcsGlobalConfigEntry=hpnicfMcsGlobalConfigEntry, hpnicfMcsVirtualUnitConfigTable=hpnicfMcsVirtualUnitConfigTable, hpnicfMcsPortConfigTable=hpnicfMcsPortConfigTable, hpnicfMulticastSnoopObject=hpnicfMulticastSnoopObject, hpnicfMcsRouterPortConfigRowStatus=hpnicfMcsRouterPortConfigRowStatus, hpnicfMcsPortConfigGroupLimitNumber=hpnicfMcsPortConfigGroupLimitNumber, hpnicfMcsL2EntrySourceAddress=hpnicfMcsL2EntrySourceAddress, hpnicfMcsPortStaticGroupSnoopingType=hpnicfMcsPortStaticGroupSnoopingType, hpnicfMcsRxV3SpecificSGQueryNum=hpnicfMcsRxV3SpecificSGQueryNum, hpnicfMcsRouterPortConfigTable=hpnicfMcsRouterPortConfigTable, hpnicfMcsRouterPortConfigSnoopingType=hpnicfMcsRouterPortConfigSnoopingType, hpnicfMcsGlbRowStatus=hpnicfMcsGlbRowStatus, hpnicfMcsVURouterAgingTime=hpnicfMcsVURouterAgingTime, hpnicfMcsPortStaticGroupConfigTable=hpnicfMcsPortStaticGroupConfigTable, hpnicfMcsRxV3ReportNum=hpnicfMcsRxV3ReportNum, hpnicfMcsGlbHostAgingTime=hpnicfMcsGlbHostAgingTime, hpnicfMcsL2EntryVUID=hpnicfMcsL2EntryVUID, hpnicfMcsVUType=hpnicfMcsVUType, hpnicfMcsRxV2ReportNum=hpnicfMcsRxV2ReportNum, hpnicfMulticastSnoop=hpnicfMulticastSnoop, hpnicfMcsPortStaticGroupGroupAddress=hpnicfMcsPortStaticGroupGroupAddress, hpnicfMcsRxV3ErrCorReportNum=hpnicfMcsRxV3ErrCorReportNum, hpnicfMcsPortStaticGroupConfigEntry=hpnicfMcsPortStaticGroupConfigEntry, hpnicfMcsRouterPortConfigEntry=hpnicfMcsRouterPortConfigEntry, hpnicfMcsRxLeaveNum=hpnicfMcsRxLeaveNum, hpnicfMcsPortConfigOverflowReplace=hpnicfMcsPortConfigOverflowReplace, hpnicfMcsVULeaveSourceAddress=hpnicfMcsVULeaveSourceAddress, hpnicfMcsPortStaticGroupVlanID=hpnicfMcsPortStaticGroupVlanID, hpnicfMcsVURowStatus=hpnicfMcsVURowStatus, hpnicfMcsVUGeneQuerierSourceAddress=hpnicfMcsVUGeneQuerierSourceAddress, hpnicfMcsTxV2SpecificQueryNum=hpnicfMcsTxV2SpecificQueryNum, hpnicfMcsVUHostAgingTime=hpnicfMcsVUHostAgingTime, hpnicfMcsPortConfigRowStatus=hpnicfMcsPortConfigRowStatus, hpnicfMcsPortJoinGroupConfigEntry=hpnicfMcsPortJoinGroupConfigEntry, hpnicfMcsRxGeneryQueryNum=hpnicfMcsRxGeneryQueryNum, hpnicfMcsPacketStatisticsTable=hpnicfMcsPacketStatisticsTable, hpnicfMcsPortConfigFastLeaveStatus=hpnicfMcsPortConfigFastLeaveStatus, hpnicfMcsRxV1ReportNum=hpnicfMcsRxV1ReportNum, hpnicfMcsRouterPortConfigVlanID=hpnicfMcsRouterPortConfigVlanID, hpnicfMcsL2EntryTable=hpnicfMcsL2EntryTable, hpnicfMcsVUQuerierEnabled=hpnicfMcsVUQuerierEnabled, hpnicfMcsL2EntryEntry=hpnicfMcsL2EntryEntry, hpnicfMcsGlbSnoopingType=hpnicfMcsGlbSnoopingType, hpnicfMcsPortConfigSnoopingType=hpnicfMcsPortConfigSnoopingType, hpnicfMcsPortJoinGroupGroupAddress=hpnicfMcsPortJoinGroupGroupAddress, hpnicfMcsVUVersion=hpnicfMcsVUVersion, hpnicfMcsPortConfigGroupPolicyParameter=hpnicfMcsPortConfigGroupPolicyParameter, hpnicfMcsL2EntryVUType=hpnicfMcsL2EntryVUType, hpnicfMcsRxV3SpecificQueryNum=hpnicfMcsRxV3SpecificQueryNum, hpnicfMcsVUReportSourceAddress=hpnicfMcsVUReportSourceAddress, hpnicfMcsGlbMaxResponseTime=hpnicfMcsGlbMaxResponseTime, hpnicfMcsRxErrorPacketNum=hpnicfMcsRxErrorPacketNum, hpnicfMcsPortJoinGroupStatus=hpnicfMcsPortJoinGroupStatus, hpnicfMcsL2EntryAddressType=hpnicfMcsL2EntryAddressType, hpnicfMcsRouterPortConfigIfIndex=hpnicfMcsRouterPortConfigIfIndex, hpnicfMcsVUPimSnoopingEnabled=hpnicfMcsVUPimSnoopingEnabled, hpnicfMcsVUQuerierInterval=hpnicfMcsVUQuerierInterval, hpnicfMcsL2EntryPortType=hpnicfMcsL2EntryPortType, hpnicfMcsVUSpecQuerierSourceAddress=hpnicfMcsVUSpecQuerierSourceAddress, hpnicfMcsVULastMemQryInterval=hpnicfMcsVULastMemQryInterval, hpnicfMcsPortJoinGroupIfIndex=hpnicfMcsPortJoinGroupIfIndex, hpnicfMcsPortStaticGroupStatus=hpnicfMcsPortStaticGroupStatus, hpnicfMcsVirtualUnitConfigEntry=hpnicfMcsVirtualUnitConfigEntry, hpnicfMcsPacketStatisticsEntry=hpnicfMcsPacketStatisticsEntry, hpnicfMcsRxV2SpecificQueryNum=hpnicfMcsRxV2SpecificQueryNum, hpnicfMcsGlbEntryLimit=hpnicfMcsGlbEntryLimit, hpnicfMcsL2EntryPortAttribute=hpnicfMcsL2EntryPortAttribute, hpnicfMcsPortJoinGroupConfigTable=hpnicfMcsPortJoinGroupConfigTable, hpnicfMcsVUMaxResponseTime=hpnicfMcsVUMaxResponseTime, hpnicfMcsTxV3SpecificSGQueryNum=hpnicfMcsTxV3SpecificSGQueryNum, hpnicfMcsPortJoinGroupSourceAddress=hpnicfMcsPortJoinGroupSourceAddress, hpnicfMcsL2EntryIfIndex=hpnicfMcsL2EntryIfIndex, HpnicfVirtualUnitType=HpnicfVirtualUnitType, hpnicfMcsGlbDropUnknownEnabled=hpnicfMcsGlbDropUnknownEnabled, hpnicfMcsVUSnoopingType=hpnicfMcsVUSnoopingType, hpnicfMcsL2EntryGroupAddress=hpnicfMcsL2EntryGroupAddress, hpnicfMcsVUDropUnknownEnabled=hpnicfMcsVUDropUnknownEnabled, hpnicfMcsPortJoinGroupSnoopingType=hpnicfMcsPortJoinGroupSnoopingType, hpnicfMcsPortStaticGroupSourceAddress=hpnicfMcsPortStaticGroupSourceAddress, hpnicfMcsRxPimHelloNum=hpnicfMcsRxPimHelloNum, hpnicfMcsPortConfigVlanID=hpnicfMcsPortConfigVlanID, PYSNMP_MODULE_ID=hpnicfMulticastSnoop, hpnicfMcsTxV3SpecificQueryNum=hpnicfMcsTxV3SpecificQueryNum, hpnicfMcsGlbRouterAgingTime=hpnicfMcsGlbRouterAgingTime)
