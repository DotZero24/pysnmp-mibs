...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hp/HPN-ICF-MULTICAST-SNOOPING-MIB
...
mibBuilder.exportSymbols("HPN-ICF-MULTICAST-SNOOPING-MIB", hpnicfMcsPortStaticGroupSnoopingType=hpnicfMcsPortStaticGroupSnoopingType, hpnicfMcsPortStaticGroupConfigTable=hpnicfMcsPortStaticGroupConfigTable, hpnicfMcsRouterPortConfigVlanID=hpnicfMcsRouterPortConfigVlanID, hpnicfMcsGlbRowStatus=hpnicfMcsGlbRowStatus, hpnicfMcsPortJoinGroupVlanID=hpnicfMcsPortJoinGroupVlanID, hpnicfMcsPortJoinGroupSourceAddress=hpnicfMcsPortJoinGroupSourceAddress, hpnicfMcsVUHostAgingTime=hpnicfMcsVUHostAgingTime, hpnicfMcsPortConfigRowStatus=hpnicfMcsPortConfigRowStatus, hpnicfMcsPortConfigIfIndex=hpnicfMcsPortConfigIfIndex, hpnicfMcsVirtualUnitConfigTable=hpnicfMcsVirtualUnitConfigTable, hpnicfMcsTxV3SpecificQueryNum=hpnicfMcsTxV3SpecificQueryNum, hpnicfMcsL2EntrySourceAddress=hpnicfMcsL2EntrySourceAddress, hpnicfMcsPortStaticGroupStatus=hpnicfMcsPortStaticGroupStatus, hpnicfMcsRxV3ReportNum=hpnicfMcsRxV3ReportNum, hpnicfMcsVUReportSourceAddress=hpnicfMcsVUReportSourceAddress, hpnicfMcsVirtualUnitConfigEntry=hpnicfMcsVirtualUnitConfigEntry, hpnicfMcsVUGeneQuerierSourceAddress=hpnicfMcsVUGeneQuerierSourceAddress, hpnicfMcsPortJoinGroupStatus=hpnicfMcsPortJoinGroupStatus, hpnicfMcsPortConfigOverflowReplace=hpnicfMcsPortConfigOverflowReplace, hpnicfMulticastSnoop=hpnicfMulticastSnoop, hpnicfMcsGlbDropUnknownEnabled=hpnicfMcsGlbDropUnknownEnabled, hpnicfMcsVUDropUnknownEnabled=hpnicfMcsVUDropUnknownEnabled, hpnicfMcsRxV3SpecificQueryNum=hpnicfMcsRxV3SpecificQueryNum, hpnicfMcsRouterPortConfigSnoopingType=hpnicfMcsRouterPortConfigSnoopingType, hpnicfMcsVURowStatus=hpnicfMcsVURowStatus, hpnicfMulticastSnoopObject=hpnicfMulticastSnoopObject, hpnicfMcsVURouterAgingTime=hpnicfMcsVURouterAgingTime, hpnicfMcsPortStaticGroupSourceAddress=hpnicfMcsPortStaticGroupSourceAddress, hpnicfMcsPortJoinGroupIfIndex=hpnicfMcsPortJoinGroupIfIndex, hpnicfMcsVUMaxResponseTime=hpnicfMcsVUMaxResponseTime, PYSNMP_MODULE_ID=hpnicfMulticastSnoop, hpnicfMcsRxV1ReportNum=hpnicfMcsRxV1ReportNum, hpnicfMcsRxV2SpecificQueryNum=hpnicfMcsRxV2SpecificQueryNum, HpnicfVirtualUnitType=HpnicfVirtualUnitType, hpnicfMcsRxLeaveNum=hpnicfMcsRxLeaveNum, hpnicfMcsPortConfigTable=hpnicfMcsPortConfigTable, hpnicfMcsVULastMemQryInterval=hpnicfMcsVULastMemQryInterval, hpnicfMcsVUType=hpnicfMcsVUType, hpnicfMcsPortJoinGroupGroupAddress=hpnicfMcsPortJoinGroupGroupAddress, hpnicfMcsGlbHostAgingTime=hpnicfMcsGlbHostAgingTime, hpnicfMcsL2EntryIfIndex=hpnicfMcsL2EntryIfIndex, hpnicfMcsVUPimSnoopingEnabled=hpnicfMcsVUPimSnoopingEnabled, hpnicfMcsGlobalConfigTable=hpnicfMcsGlobalConfigTable, hpnicfMcsL2EntryGroupAddress=hpnicfMcsL2EntryGroupAddress, hpnicfMcsL2EntryPortAttribute=hpnicfMcsL2EntryPortAttribute, hpnicfMcsPortStaticGroupConfigEntry=hpnicfMcsPortStaticGroupConfigEntry, hpnicfMcsVULeaveSourceAddress=hpnicfMcsVULeaveSourceAddress, hpnicfMcsVUQuerierInterval=hpnicfMcsVUQuerierInterval, hpnicfMcsL2EntryTable=hpnicfMcsL2EntryTable, hpnicfMcsL2EntryPortType=hpnicfMcsL2EntryPortType, hpnicfMcsRouterPortConfigRowStatus=hpnicfMcsRouterPortConfigRowStatus, hpnicfMcsPortStaticGroupVlanID=hpnicfMcsPortStaticGroupVlanID, hpnicfMcsVUID=hpnicfMcsVUID, hpnicfMcsPortConfigEntry=hpnicfMcsPortConfigEntry, hpnicfMcsGlbSnoopingType=hpnicfMcsGlbSnoopingType, hpnicfMcsPortConfigGroupLimitNumber=hpnicfMcsPortConfigGroupLimitNumber, hpnicfMcsGlobalConfigEntry=hpnicfMcsGlobalConfigEntry, hpnicfMcsVUQuerierEnabled=hpnicfMcsVUQuerierEnabled, hpnicfMcsPortConfigGroupPolicyParameter=hpnicfMcsPortConfigGroupPolicyParameter, hpnicfMcsVUSnoopingType=hpnicfMcsVUSnoopingType, hpnicfMcsPortJoinGroupConfigTable=hpnicfMcsPortJoinGroupConfigTable, hpnicfMcsVUSpecQuerierSourceAddress=hpnicfMcsVUSpecQuerierSourceAddress, hpnicfMcsRouterPortConfigTable=hpnicfMcsRouterPortConfigTable, hpnicfMcsGlbMaxResponseTime=hpnicfMcsGlbMaxResponseTime, hpnicfMcsPortJoinGroupSnoopingType=hpnicfMcsPortJoinGroupSnoopingType, hpnicfMcsGlbRouterAgingTime=hpnicfMcsGlbRouterAgingTime, hpnicfMcsPortStaticGroupGroupAddress=hpnicfMcsPortStaticGroupGroupAddress, hpnicfMcsL2EntryVUID=hpnicfMcsL2EntryVUID, hpnicfMcsL2EntryAddressType=hpnicfMcsL2EntryAddressType, hpnicfMcsL2EntryVUType=hpnicfMcsL2EntryVUType, hpnicfMcsRxV2ReportNum=hpnicfMcsRxV2ReportNum, hpnicfMcsGlbEntryLimit=hpnicfMcsGlbEntryLimit, hpnicfMcsStatisticsSnoopingType=hpnicfMcsStatisticsSnoopingType, hpnicfMcsPortStaticGroupIfIndex=hpnicfMcsPortStaticGroupIfIndex, hpnicfMcsPortConfigSnoopingType=hpnicfMcsPortConfigSnoopingType, hpnicfMcsVUVersion=hpnicfMcsVUVersion, hpnicfMcsTxV3SpecificSGQueryNum=hpnicfMcsTxV3SpecificSGQueryNum, hpnicfMcsRxV3ErrCorReportNum=hpnicfMcsRxV3ErrCorReportNum, hpnicfMcsRxErrorPacketNum=hpnicfMcsRxErrorPacketNum, hpnicfMcsRouterPortConfigIfIndex=hpnicfMcsRouterPortConfigIfIndex, hpnicfMcsRxPimHelloNum=hpnicfMcsRxPimHelloNum, hpnicfMcsRxGeneryQueryNum=hpnicfMcsRxGeneryQueryNum, hpnicfMcsGlbLastMemQryInterval=hpnicfMcsGlbLastMemQryInterval, hpnicfMcsRouterPortConfigEntry=hpnicfMcsRouterPortConfigEntry, hpnicfMcsPortJoinGroupConfigEntry=hpnicfMcsPortJoinGroupConfigEntry, hpnicfMcsTxV2SpecificQueryNum=hpnicfMcsTxV2SpecificQueryNum, hpnicfMcsPortConfigVlanID=hpnicfMcsPortConfigVlanID, hpnicfMcsRxV3SpecificSGQueryNum=hpnicfMcsRxV3SpecificSGQueryNum, hpnicfMcsPacketStatisticsEntry=hpnicfMcsPacketStatisticsEntry, hpnicfMcsPortConfigFastLeaveStatus=hpnicfMcsPortConfigFastLeaveStatus, hpnicfMcsPacketStatisticsTable=hpnicfMcsPacketStatisticsTable, hpnicfMcsL2EntryEntry=hpnicfMcsL2EntryEntry)
