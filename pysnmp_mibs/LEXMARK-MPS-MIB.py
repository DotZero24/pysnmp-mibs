...
KeyValueTC, AdminStatusTC, StatusTC, PaperTypeTC, PaperSizeTC, UnitsTC = mibBuilder.importSymbols("LEXMARK-TC-MIB", "KeyValueTC", "AdminStatusTC", "StatusTC", "PaperTypeTC", "PaperSizeTC", "UnitsTC")
PrtAlertCodeTC, PrtAlertTrainingLevelTC, PrtAlertSeverityLevelTC, PrtOutputPageDeliveryOrientationTC = mibBuilder.importSymbols("Printer-MIB", "PrtAlertCodeTC", "PrtAlertTrainingLevelTC", "PrtAlertSeverityLevelTC", "PrtOutputPageDeliveryOrientationTC")
...
mibBuilder.exportSymbols("LEXMARK-MPS-MIB", swInventoryAdminStatus=swInventoryAdminStatus, supplyInventoryIndex=supplyInventoryIndex, scanStats=scanStats, scanCountIndex=scanCountIndex, deviceMachineType=deviceMachineType, supplyHistogramHistoryCountIndex=supplyHistogramHistoryCountIndex, supplyHistogramCapacity=supplyHistogramCapacity, deviceEntry=deviceEntry, deviceAlertTime=deviceAlertTime, supplyInventoryColorantValue=supplyInventoryColorantValue, supplyHistoryColorantValue=supplyHistoryColorantValue, deviceV2AlertMPS=deviceV2AlertMPS, paperJobSizeMaximum=paperJobSizeMaximum, swInventoryHWIndex=swInventoryHWIndex, supplyHistoryCalibrations=supplyHistoryCalibrations, swInventoryGroup=swInventoryGroup, outputfaceOrientation=outputfaceOrientation, statsScanGroup=statsScanGroup, swInventoryData=swInventoryData, deviceIndex=deviceIndex, outputStitchingCapable=outputStitchingCapable, paperSheetsSafe=paperSheetsSafe, genCountIndex=genCountIndex, currentSupplyPageCountAtInstall=currentSupplyPageCountAtInstall, scanCountTable=scanCountTable, SeverityTC=SeverityTC, paperSidesMonoPicked=paperSidesMonoPicked, deviceAlertConfigTableIndex=deviceAlertConfigTableIndex, currentSupplyFirstKnownLevel=currentSupplyFirstKnownLevel, paperJobSizeTable=paperJobSizeTable, applications=applications, hwInventoryData=hwInventoryData, deviceAlertTrainingLevel=deviceAlertTrainingLevel, statsPaperGeneralCountGroup=statsPaperGeneralCountGroup, statsPaperSheetsCountGroup=statsPaperSheetsCountGroup, paperStats=paperStats, statsPaperNupCountGroup=statsPaperNupCountGroup, genCountUnits=genCountUnits, supplyHistoryEntry=supplyHistoryEntry, mps=mps, supplyHistogramHistoryEntry=supplyHistogramHistoryEntry, currentSupplyCoverage=currentSupplyCoverage, logs=logs, hwInventoryDescription=hwInventoryDescription, paperSheetsPaperSize=paperSheetsPaperSize, outputFoldSupport=outputFoldSupport, swInventoryTable=swInventoryTable, stats=stats, supplyHistogramHistoryIndex=supplyHistogramHistoryIndex, deviceTable=deviceTable, paperNupCountEntry=paperNupCountEntry, deviceAlertTable=deviceAlertTable, paperSidesMonoSafe=paperSidesMonoSafe, mpsMIBCompliances=mpsMIBCompliances, paperNupLogicalSides=paperNupLogicalSides, scanCountSides=scanCountSides, currentSupplyType=currentSupplyType, supplyHistogramHistoryCountUnits=supplyHistogramHistoryCountUnits, deviceV1AlertMPS=deviceV1AlertMPS, deviceTLI=deviceTLI, paperNupCountIndex=paperNupCountIndex, paperNupNumber=paperNupNumber, deviceSerialNumber=deviceSerialNumber, currentSupplySerialNumber=currentSupplySerialNumber, outputLevelSensing=outputLevelSensing, paperSidesColorPicked=paperSidesColorPicked, paperSidesPaperSize=paperSidesPaperSize, supplyHistogramHistoryCapacityUnit=supplyHistogramHistoryCapacityUnit, outputOffsetting=outputOffsetting, paperNupCountTable=paperNupCountTable, supplyHistoryIndex=supplyHistoryIndex, supplyDynamicIndex=supplyDynamicIndex, paperSidesPaperType=paperSidesPaperType, supplyHistogramEntry=supplyHistogramEntry, outputOptionIndex=outputOptionIndex, swInventoryType=swInventoryType, genCountType=genCountType, devicePort=devicePort, swInventoryName=swInventoryName, statsGeneralCountGroup=statsGeneralCountGroup, currentSupplyCalibrations=currentSupplyCalibrations, deviceModel=deviceModel, paperJobSizeMinimum=paperJobSizeMinimum, currentSupplyIndex=currentSupplyIndex, supplyHistogramHistoryCapacity=supplyHistogramHistoryCapacity, supplyInventoryEntry=supplyInventoryEntry, paperSheetsPaperType=paperSheetsPaperType, swInventoryIndex=swInventoryIndex, supplyHistoryDescription=supplyHistoryDescription, supplyHistoryInventoryIndex=supplyHistoryInventoryIndex, supplyHistogramHistoryCount=supplyHistogramHistoryCount, hwInventoryTable=hwInventoryTable, statsSupplyHistoryGroup=statsSupplyHistoryGroup, hwInventoryPartNumber=hwInventoryPartNumber, currentSupplyCurrentStatus=currentSupplyCurrentStatus, supplyHistogramCountUnits=supplyHistogramCountUnits, swInventoryParentIndex=swInventoryParentIndex, supplyHistogramDescription=supplyHistogramDescription, currentSupplyInventoryIndex=currentSupplyInventoryIndex, currentSupplyDaysRemaining=currentSupplyDaysRemaining, deviceAlertDescription=deviceAlertDescription, SupplyTypeTC=SupplyTypeTC, paperSheetsCountTable=paperSheetsCountTable, supplyHistogramInventoryIndex=supplyHistogramInventoryIndex, scanCountEntry=scanCountEntry, outputOptionFeatureTable=outputOptionFeatureTable, hwInventoryGroup=hwInventoryGroup, deviceMibLocalization=deviceMibLocalization, supplyHistogramHistoryDescription=supplyHistogramHistoryDescription, supplyInventoryGroup=supplyInventoryGroup, paperGeneralCountTable=paperGeneralCountTable, mpsMibModule=mpsMibModule, deviceAlertGroup=deviceAlertGroup, currentSupplyCurrentLevel=currentSupplyCurrentLevel, AlertCodeTC=AlertCodeTC, supplyHistogramHistoryColorantValue=supplyHistogramHistoryColorantValue, paperJobSizeJobCount=paperJobSizeJobCount, paperGeneralCountType=paperGeneralCountType, mpsMIBAdminInfo=mpsMIBAdminInfo, supplyHistogramCapacityUnit=supplyHistogramCapacityUnit, hwInventoryIndex=hwInventoryIndex, outputSeparationCapable=outputSeparationCapable, deviceGroup=deviceGroup, supplyHistoryCoverage=supplyHistoryCoverage, supplyHistogramTable=supplyHistogramTable, supplyHistogramCount=supplyHistogramCount, supplyHistogramColorantValue=supplyHistogramColorantValue, deviceMibSupportLevel=deviceMibSupportLevel, supplyHistoryInstallDate=supplyHistoryInstallDate, swInventoryEntry=swInventoryEntry, supplyInventoryType=supplyInventoryType, deviceAlertSeverity=deviceAlertSeverity, supplyHistoryUsage=supplyHistoryUsage, deviceAlertEntry=deviceAlertEntry, paperSidesColorSafe=paperSidesColorSafe, genCountEntry=genCountEntry, scanCountType=scanCountType, alerts=alerts, supplyHistoryTable=supplyHistoryTable, CartridgeTypeTC=CartridgeTypeTC, supplyHistoryLastLevel=supplyHistoryLastLevel, outputBindingCapable=outputBindingCapable, hwInventoryEntry=hwInventoryEntry, deviceAlertPrtCode=deviceAlertPrtCode, swInventoryDescription=swInventoryDescription, hwInventorySerialNumber=hwInventorySerialNumber, supplyHistogramWithHistoryTable=supplyHistogramWithHistoryTable, scanCountSheets=scanCountSheets, supplyHistoryPageCount=supplyHistoryPageCount, deviceAlertSeverityLevel=deviceAlertSeverityLevel, deviceMibVersion=deviceMibVersion, scanCountSize=scanCountSize, hwInventoryStatus=hwInventoryStatus, supplyHistogramIndex=supplyHistogramIndex, paperNupSides=paperNupSides, supplyHistogramHistorySupplyType=supplyHistogramHistorySupplyType, paperSidesCountEntry=paperSidesCountEntry, paperJobSizeIndex=paperJobSizeIndex, paperSidesCountTable=paperSidesCountTable, deviceAlertCode=deviceAlertCode, currentSuppliesTable=currentSuppliesTable, deviceAlertIndex=deviceAlertIndex, supplyInventoryDescription=supplyInventoryDescription, outputOptionEntry=outputOptionEntry, swInventoryStatus=swInventoryStatus, currentSupplyInstallDate=currentSupplyInstallDate, mpsMIBCompliance=mpsMIBCompliance, inventory=inventory, genCountTable=genCountTable, deviceInstallDate=deviceInstallDate, supplyHistogramHistoryInventoryIndex=supplyHistogramHistoryInventoryIndex, hwInventoryAdminStatus=hwInventoryAdminStatus, statsPaperSidesCountGroup=statsPaperSidesCountGroup, outputfeature=outputfeature, statsCurrentSuppliesGroup=statsCurrentSuppliesGroup, PYSNMP_MODULE_ID=mpsMibModule, mpsMIBGroups=mpsMIBGroups, currentSuppliesEntry=currentSuppliesEntry, supplyStats=supplyStats, generalStats=generalStats, device=device, currentSupplyClass=currentSupplyClass, currentSupplyUsage=currentSupplyUsage, hwInventoryType=hwInventoryType, supplyHistoryCartridgeType=supplyHistoryCartridgeType, paperSidesCountIndex=paperSidesCountIndex, currentSupplyPartNumber=currentSupplyPartNumber, paperSheetsCountIndex=paperSheetsCountIndex, deviceV2AlertMPSPrefix=deviceV2AlertMPSPrefix, outputPunchingCapable=outputPunchingCapable, paperSheetsCountEntry=paperSheetsCountEntry, outputOptionName=outputOptionName, deviceAlertData=deviceAlertData, paperGeneralCountUnits=paperGeneralCountUnits, paperJobSizeSideCount=paperJobSizeSideCount, paperGeneralCountValue=paperGeneralCountValue, supplyHistorySerialNumber=supplyHistorySerialNumber, statsPaperJobSizeGroup=statsPaperJobSizeGroup, genCountValue=genCountValue, paperJobSizeEntry=paperJobSizeEntry, currentSupplyCapacityUnit=currentSupplyCapacityUnit, swInventoryRevision=swInventoryRevision, supplyHistogramSupplyType=supplyHistogramSupplyType, supplyInventoryTable=supplyInventoryTable, deviceAlertConfigTableNode=deviceAlertConfigTableNode, paperGeneralCountIndex=paperGeneralCountIndex, currentSupplyDescription=currentSupplyDescription, hwInventoryParentIndex=hwInventoryParentIndex, currentSupplyCartridgeType=currentSupplyCartridgeType, supplyHistoryCapacity=supplyHistoryCapacity, statsSupplyHistogramGroup=statsSupplyHistogramGroup, paperGeneralCountEntry=paperGeneralCountEntry, deviceHrDeviceIndex=deviceHrDeviceIndex, currentSupplyCapacity=currentSupplyCapacity, currentSupplyColorantValue=currentSupplyColorantValue, supplyHistorySupplyType=supplyHistorySupplyType, supplyHistoryCapacityUnit=supplyHistoryCapacityUnit, paperSheetsPicked=paperSheetsPicked)
