...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-LBV2-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:37:43 2025
...
_HpnicfLBv2VSConnectionsLimit_Type.__name__ = "Unsigned32"
...
_HpnicfLBv2VSConnectionsRateLimit_Type.__name__ = "Unsigned32"
...
class _HpnicfLBv2RSConnectionsLimit_Type(Unsigned32):
    """Custom type hpnicfLBv2RSConnectionsLimit based on Unsigned32"""
    defaultValue = 0


_HpnicfLBv2RSConnectionsLimit_Type.__name__ = "Unsigned32"
_HpnicfLBv2RSConnectionsLimit_Object = MibTableColumn
hpnicfLBv2RSConnectionsLimit = _HpnicfLBv2RSConnectionsLimit_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 148, 4, 1, 1, 3),
    _HpnicfLBv2RSConnectionsLimit_Type()
)
hpnicfLBv2RSConnectionsLimit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpnicfLBv2RSConnectionsLimit.setStatus("current")


class _HpnicfLBv2RSConnectionsRateLimit_Type(Unsigned32):
    """Custom type hpnicfLBv2RSConnectionsRateLimit based on Unsigned32"""
    defaultValue = 0


_HpnicfLBv2RSConnectionsRateLimit_Type.__name__ = "Unsigned32"
_HpnicfLBv2RSConnectionsRateLimit_Object = MibTableColumn
hpnicfLBv2RSConnectionsRateLimit = _HpnicfLBv2RSConnectionsRateLimit_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 148, 4, 1, 1, 4),
    _HpnicfLBv2RSConnectionsRateLimit_Type()
)
hpnicfLBv2RSConnectionsRateLimit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpnicfLBv2RSConnectionsRateLimit.setStatus("current")
...
hpnicfLBv2RSStatChassis.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
hpnicfLBv2RSStatSlot.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
hpnicfLBv2RSStatCpuid.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
hpnicfLBv2RSStatConnectionsRate = _HpnicfLBv2RSStatConnectionsRate_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 148, 4, 2, 1, 13),
    _HpnicfLBv2RSStatConnectionsRate_Type()
)
hpnicfLBv2RSStatConnectionsRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpnicfLBv2RSStatConnectionsRate.setStatus("current")
if mibBuilder.loadTexts:
    hpnicfLBv2RSStatConnectionsRate.setUnits("cps")
...
hpnicfLBv2RSConnOverloadTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 148, 6, 0, 13)
)
hpnicfLBv2RSConnOverloadTrap.setObjects(
      *(("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSName"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSConnectionsLimit"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatChassis"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatSlot"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatCpuid"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatActiveConnections"))
)
if mibBuilder.loadTexts:
    hpnicfLBv2RSConnOverloadTrap.setStatus(
        "current"
    )

hpnicfLBv2RSConnRecoveryTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 148, 6, 0, 14)
)
hpnicfLBv2RSConnRecoveryTrap.setObjects(
      *(("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSName"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSConnectionsLimit"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatChassis"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatSlot"),
...
if mibBuilder.loadTexts:
    hpnicfLBv2RSConnRecoveryTrap.setStatus(
        "current"
    )

hpnicfLBv2RSConnsRateOverloadTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 148, 6, 0, 15)
)
hpnicfLBv2RSConnsRateOverloadTrap.setObjects(
      *(("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSName"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSConnectionsRateLimit"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatChassis"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatSlot"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatCpuid"),
...
if mibBuilder.loadTexts:
    hpnicfLBv2RSConnsRateOverloadTrap.setStatus(
        "current"
    )

hpnicfLBv2RSConnsRateRecoveryTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 2, 148, 6, 0, 16)
)
hpnicfLBv2RSConnsRateRecoveryTrap.setObjects(
      *(("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSName"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSConnectionsRateLimit"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatChassis"),
        ("HPN-ICF-LBV2-MIB", "hpnicfLBv2RSStatSlot"),
...
if mibBuilder.loadTexts:
    hpnicfLBv2RSConnsRateRecoveryTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpnicfLBv2": hpnicfLBv2,
       ...
       "hpnicfLBv2RSConnectionsLimit": hpnicfLBv2RSConnectionsLimit,
       "hpnicfLBv2RSConnectionsRateLimit": hpnicfLBv2RSConnectionsRateLimit,
       ...
       "hpnicfLBv2RSStatConnectionsRate": hpnicfLBv2RSStatConnectionsRate,
       ...
       "hpnicfLBv2RSConnOverloadTrap": hpnicfLBv2RSConnOverloadTrap,
       "hpnicfLBv2RSConnRecoveryTrap": hpnicfLBv2RSConnRecoveryTrap,
       "hpnicfLBv2RSConnsRateOverloadTrap": hpnicfLBv2RSConnsRateOverloadTrap,
       "hpnicfLBv2RSConnsRateRecoveryTrap": hpnicfLBv2RSConnsRateRecoveryTrap}
)
