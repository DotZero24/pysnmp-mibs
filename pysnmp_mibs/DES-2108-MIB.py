# SNMP MIB module (DES-2108-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES-2108-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:46:25 2025
...
commSetIndex = _CommSetIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 1, 1, 1),
    _CommSetIndex_Type()
)
...
commSetName = _CommSetName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 1, 1, 2),
    _CommSetName_Type()
)
...
commSetStatus = _CommSetStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 1, 1, 3),
    _CommSetStatus_Type()
)
...
commGetIndex = _CommGetIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 2, 1, 1),
    _CommGetIndex_Type()
)
...
commGetName = _CommGetName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 2, 1, 2),
    _CommGetName_Type()
)
...
commGetStatus = _CommGetStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 2, 1, 3),
    _CommGetStatus_Type()
)
...
commTrapIndex = _CommTrapIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 1),
    _CommTrapIndex_Type()
)
...
commTrapName = _CommTrapName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 2),
    _CommTrapName_Type()
)
...
commTrapIpAddress = _CommTrapIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 3),
...
commTrapVlanId = _CommTrapVlanId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 4),
...
commTrapSNMPBootup = _CommTrapSNMPBootup_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 5),
...
commTrapSNMPFiberLinkUpDown = _CommTrapSNMPFiberLinkUpDown_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 7),
...
commTrapTrapAbnormalTPRXError = _CommTrapTrapAbnormalTPRXError_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 9),
...
commTrapTrapAbnormalTPTXError = _CommTrapTrapAbnormalTPTXError_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 10),
...
commTrapTrapAbnormalFiberRXError = _CommTrapTrapAbnormalFiberRXError_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 11),
...
commTrapTrapAbnormalFiberTXError = _CommTrapTrapAbnormalFiberTXError_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 12),
...
commTrapStatus = _CommTrapStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 1, 3, 1, 13),
...
configPort = _ConfigPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 6, 1, 1),
    _ConfigPort_Type()
)
...
configPortSpeed = _ConfigPortSpeed_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 6, 1, 2),
...
configPortOperStatus = _ConfigPortOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 6, 1, 3),
...
configPortFlowControl = _ConfigPortFlowControl_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 6, 1, 4),
...
configPortFlowControlOper = _ConfigPortFlowControlOper_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 6, 1, 5),
...
configPortPriority = _ConfigPortPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 6, 1, 6),
...
configMirrorId = _ConfigMirrorId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 8, 1, 1),
...
configMirrorMode = _ConfigMirrorMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 8, 1, 2),
...
configMirrorMon = _ConfigMirrorMon_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 8, 1, 3),
...
configMirrorSrc = _ConfigMirrorSrc_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 8, 1, 4),
...
configMirrorStatus = _ConfigMirrorStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 11, 8, 1, 5),
...
pvlanId = _PvlanId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 12, 1, 1, 1),
    _PvlanId_Type()
)
...
pvlanName = _PvlanName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 12, 1, 1, 2),
    _PvlanName_Type()
)
...
pvlanMember = _PvlanMember_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 12, 1, 1, 3),
    _PvlanMember_Type()
)
...
pvlanStatus = _PvlanStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 12, 1, 1, 5),
    _PvlanStatus_Type()
)
...
tvlanId = _TvlanId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 13, 1, 1, 1),
    _TvlanId_Type()
)
...
tvlanMember = _TvlanMember_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 13, 1, 1, 3),
    _TvlanMember_Type()
)
...
tvlanUntaggedPorts = _TvlanUntaggedPorts_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 13, 1, 1, 4),
...
tvlanStatus = _TvlanStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 13, 1, 1, 5),
    _TvlanStatus_Type()
)
...
tvlanPortPortId = _TvlanPortPortId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 13, 2, 1, 1),
...
tvlanPortVlanId = _TvlanPortVlanId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 13, 2, 1, 2),
...
tvlanPortPriority = _TvlanPortPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 13, 2, 1, 3),
...
staticId = _StaticId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 21, 3, 1, 1),
    _StaticId_Type()
)
...
staticMac = _StaticMac_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 21, 3, 1, 2),
    _StaticMac_Type()
)
...
staticPort = _StaticPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 21, 3, 1, 3),
    _StaticPort_Type()
)
...
staticVlanID = _StaticVlanID_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 21, 3, 1, 4),
    _StaticVlanID_Type()
)
...
staticStatus = _StaticStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 21, 3, 1, 5),
    _StaticStatus_Type()
)
...
igsStatus = _IgsStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 22, 1, 2),
    _IgsStatus_Type()
)
...
igsRouterPortPurgeInterval = _IgsRouterPortPurgeInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 22, 1, 4),
...
igsHostPortPurgeInterval = _IgsHostPortPurgeInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 22, 1, 5),
...
igsBrgRouterPortList = _IgsBrgRouterPortList_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 22, 2, 1),
...
igsBrgMcastFwdTable = _IgsBrgMcastFwdTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 22, 2, 2)
)
if mibBuilder.loadTexts:
...
igsBrgMcastFwdEntry = _IgsBrgMcastFwdEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 22, 2, 2, 1)
)
igsBrgMcastFwdEntry.setIndexNames(
    (0, "DES-2108-MIB", "igsBrgMcastFwdGroupAddress"),
)
if mibBuilder.loadTexts:
...
igsBrgMcastFwdGroupAddress = _IgsBrgMcastFwdGroupAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 22, 2, 2, 1, 1),
...
igsBrgMcastFwdPortListMac = _IgsBrgMcastFwdPortListMac_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 61, 2, 22, 2, 2, 1, 2),
