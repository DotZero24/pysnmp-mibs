...
_Des_2108_ObjectIdentity=ObjectIdentity
des_2108=_Des_2108_ObjectIdentity((1,3,6,1,4,1,171,10,61,2))
_CompanyCommGroup_ObjectIdentity=ObjectIdentity
companyCommGroup=_CompanyCommGroup_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,1))
_CommSetTable_Object=MibTable
commSetTable=_CommSetTable_Object((1,3,6,1,4,1,171,10,61,2,1,1))
if mibBuilder.loadTexts:commSetTable.setStatus(_A)
_CommSetEntry_Object=MibTableRow
commSetEntry=_CommSetEntry_Object((1,3,6,1,4,1,171,10,61,2,1,1,1))
...
commSetIndex=_CommSetIndex_Object((1,3,6,1,4,1,171,10,61,2,1,1,1,1),_CommSetIndex_Type())
...
commSetName=_CommSetName_Object((1,3,6,1,4,1,171,10,61,2,1,1,1,2),_CommSetName_Type())
...
commSetStatus=_CommSetStatus_Object((1,3,6,1,4,1,171,10,61,2,1,1,1,3),_CommSetStatus_Type())
commSetStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:commSetStatus.setStatus(_A)
_CommGetTable_Object=MibTable
commGetTable=_CommGetTable_Object((1,3,6,1,4,1,171,10,61,2,1,2))
if mibBuilder.loadTexts:commGetTable.setStatus(_A)
_CommGetEntry_Object=MibTableRow
commGetEntry=_CommGetEntry_Object((1,3,6,1,4,1,171,10,61,2,1,2,1))
...
commGetIndex=_CommGetIndex_Object((1,3,6,1,4,1,171,10,61,2,1,2,1,1),_CommGetIndex_Type())
...
commGetName=_CommGetName_Object((1,3,6,1,4,1,171,10,61,2,1,2,1,2),_CommGetName_Type())
...
commGetStatus=_CommGetStatus_Object((1,3,6,1,4,1,171,10,61,2,1,2,1,3),_CommGetStatus_Type())
commGetStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:commGetStatus.setStatus(_A)
_CommTrapTable_Object=MibTable
commTrapTable=_CommTrapTable_Object((1,3,6,1,4,1,171,10,61,2,1,3))
if mibBuilder.loadTexts:commTrapTable.setStatus(_A)
_CommTrapEntry_Object=MibTableRow
commTrapEntry=_CommTrapEntry_Object((1,3,6,1,4,1,171,10,61,2,1,3,1))
...
commTrapIndex=_CommTrapIndex_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,1),_CommTrapIndex_Type())
...
commTrapName=_CommTrapName_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,2),_CommTrapName_Type())
...
commTrapIpAddress=_CommTrapIpAddress_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,3),_CommTrapIpAddress_Type())
...
commTrapVlanId=_CommTrapVlanId_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,4),_CommTrapVlanId_Type())
...
commTrapSNMPBootup=_CommTrapSNMPBootup_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,5),_CommTrapSNMPBootup_Type())
...
commTrapSNMPTPLinkUpDown=_CommTrapSNMPTPLinkUpDown_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,6),_CommTrapSNMPTPLinkUpDown_Type())
...
commTrapSNMPFiberLinkUpDown=_CommTrapSNMPFiberLinkUpDown_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,7),_CommTrapSNMPFiberLinkUpDown_Type())
...
commTrapTrapAbnormalTPRXError=_CommTrapTrapAbnormalTPRXError_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,9),_CommTrapTrapAbnormalTPRXError_Type())
...
commTrapTrapAbnormalTPTXError=_CommTrapTrapAbnormalTPTXError_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,10),_CommTrapTrapAbnormalTPTXError_Type())
...
commTrapTrapAbnormalFiberRXError=_CommTrapTrapAbnormalFiberRXError_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,11),_CommTrapTrapAbnormalFiberRXError_Type())
...
commTrapTrapAbnormalFiberTXError=_CommTrapTrapAbnormalFiberTXError_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,12),_CommTrapTrapAbnormalFiberTXError_Type())
...
commTrapStatus=_CommTrapStatus_Object((1,3,6,1,4,1,171,10,61,2,1,3,1,13),_CommTrapStatus_Type())
...
companyMiscGroup=_CompanyMiscGroup_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,3))
...
miscReset=_MiscReset_Object((1,3,6,1,4,1,171,10,61,2,3,2),_MiscReset_Type())
...
miscStatisticsReset=_MiscStatisticsReset_Object((1,3,6,1,4,1,171,10,61,2,3,3),_MiscStatisticsReset_Type())
...
companySpanGroup=_CompanySpanGroup_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,4))
...
spanOnOff=_SpanOnOff_Object((1,3,6,1,4,1,171,10,61,2,4,1),_SpanOnOff_Type())
spanOnOff.setMaxAccess(_B)
if mibBuilder.loadTexts:spanOnOff.setStatus(_A)
_CompanyConfigGroup_ObjectIdentity=ObjectIdentity
companyConfigGroup=_CompanyConfigGroup_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,11))
...
configVerSwPrimary=_ConfigVerSwPrimary_Object((1,3,6,1,4,1,171,10,61,2,11,1),_ConfigVerSwPrimary_Type())
...
configVerHwChipSet=_ConfigVerHwChipSet_Object((1,3,6,1,4,1,171,10,61,2,11,2),_ConfigVerHwChipSet_Type())
...
configPortTable=_ConfigPortTable_Object((1,3,6,1,4,1,171,10,61,2,11,6))
if mibBuilder.loadTexts:configPortTable.setStatus(_A)
_ConfigPortEntry_Object=MibTableRow
configPortEntry=_ConfigPortEntry_Object((1,3,6,1,4,1,171,10,61,2,11,6,1))
...
configPort=_ConfigPort_Object((1,3,6,1,4,1,171,10,61,2,11,6,1,1),_ConfigPort_Type())
...
configPortSpeed=_ConfigPortSpeed_Object((1,3,6,1,4,1,171,10,61,2,11,6,1,2),_ConfigPortSpeed_Type())
...
configPortOperStatus=_ConfigPortOperStatus_Object((1,3,6,1,4,1,171,10,61,2,11,6,1,3),_ConfigPortOperStatus_Type())
...
configPortFlowControl=_ConfigPortFlowControl_Object((1,3,6,1,4,1,171,10,61,2,11,6,1,4),_ConfigPortFlowControl_Type())
...
configPortFlowControlOper=_ConfigPortFlowControlOper_Object((1,3,6,1,4,1,171,10,61,2,11,6,1,5),_ConfigPortFlowControlOper_Type())
...
configPortPriority=_ConfigPortPriority_Object((1,3,6,1,4,1,171,10,61,2,11,6,1,6),_ConfigPortPriority_Type())
...
configVLANMode=_ConfigVLANMode_Object((1,3,6,1,4,1,171,10,61,2,11,7),_ConfigVLANMode_Type())
configVLANMode.setMaxAccess(_B)
if mibBuilder.loadTexts:configVLANMode.setStatus(_A)
_ConfigMirrorTable_Object=MibTable
configMirrorTable=_ConfigMirrorTable_Object((1,3,6,1,4,1,171,10,61,2,11,8))
if mibBuilder.loadTexts:configMirrorTable.setStatus(_A)
_ConfigMirrorEntry_Object=MibTableRow
configMirrorEntry=_ConfigMirrorEntry_Object((1,3,6,1,4,1,171,10,61,2,11,8,1))
...
configMirrorId=_ConfigMirrorId_Object((1,3,6,1,4,1,171,10,61,2,11,8,1,1),_ConfigMirrorId_Type())
...
configMirrorMode=_ConfigMirrorMode_Object((1,3,6,1,4,1,171,10,61,2,11,8,1,2),_ConfigMirrorMode_Type())
...
configMirrorMon=_ConfigMirrorMon_Object((1,3,6,1,4,1,171,10,61,2,11,8,1,3),_ConfigMirrorMon_Type())
...
configMirrorSrc=_ConfigMirrorSrc_Object((1,3,6,1,4,1,171,10,61,2,11,8,1,4),_ConfigMirrorSrc_Type())
...
configMirrorStatus=_ConfigMirrorStatus_Object((1,3,6,1,4,1,171,10,61,2,11,8,1,5),_ConfigMirrorStatus_Type())
...
configSNMPEnable=_ConfigSNMPEnable_Object((1,3,6,1,4,1,171,10,61,2,11,9),_ConfigSNMPEnable_Type())
...
configIpAssignmentMode=_ConfigIpAssignmentMode_Object((1,3,6,1,4,1,171,10,61,2,11,12),_ConfigIpAssignmentMode_Type())
...
configPhysAddress=_ConfigPhysAddress_Object((1,3,6,1,4,1,171,10,61,2,11,13),_ConfigPhysAddress_Type())
...
configPasswordAdmin=_ConfigPasswordAdmin_Object((1,3,6,1,4,1,171,10,61,2,11,15),_ConfigPasswordAdmin_Type())
...
configIpAddress=_ConfigIpAddress_Object((1,3,6,1,4,1,171,10,61,2,11,16),_ConfigIpAddress_Type())
...
configNetMask=_ConfigNetMask_Object((1,3,6,1,4,1,171,10,61,2,11,17),_ConfigNetMask_Type())
...
configGateway=_ConfigGateway_Object((1,3,6,1,4,1,171,10,61,2,11,18),_ConfigGateway_Type())
...
configSave=_ConfigSave_Object((1,3,6,1,4,1,171,10,61,2,11,19),_ConfigSave_Type())
...
configRestoreDefaults=_ConfigRestoreDefaults_Object((1,3,6,1,4,1,171,10,61,2,11,22),_ConfigRestoreDefaults_Type())
...
companyPVlanGroup=_CompanyPVlanGroup_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,12))
_PvlanTable_Object=MibTable
pvlanTable=_PvlanTable_Object((1,3,6,1,4,1,171,10,61,2,12,1))
if mibBuilder.loadTexts:pvlanTable.setStatus(_A)
_PvlanEntry_Object=MibTableRow
pvlanEntry=_PvlanEntry_Object((1,3,6,1,4,1,171,10,61,2,12,1,1))
...
pvlanId=_PvlanId_Object((1,3,6,1,4,1,171,10,61,2,12,1,1,1),_PvlanId_Type())
...
pvlanName=_PvlanName_Object((1,3,6,1,4,1,171,10,61,2,12,1,1,2),_PvlanName_Type())
...
pvlanMember=_PvlanMember_Object((1,3,6,1,4,1,171,10,61,2,12,1,1,3),_PvlanMember_Type())
...
pvlanStatus=_PvlanStatus_Object((1,3,6,1,4,1,171,10,61,2,12,1,1,5),_PvlanStatus_Type())
...
companyTVlanGroup=_CompanyTVlanGroup_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,13))
_TvlanTable_Object=MibTable
tvlanTable=_TvlanTable_Object((1,3,6,1,4,1,171,10,61,2,13,1))
if mibBuilder.loadTexts:tvlanTable.setStatus(_A)
_TvlanEntry_Object=MibTableRow
tvlanEntry=_TvlanEntry_Object((1,3,6,1,4,1,171,10,61,2,13,1,1))
...
tvlanId=_TvlanId_Object((1,3,6,1,4,1,171,10,61,2,13,1,1,1),_TvlanId_Type())
...
tvlanMember=_TvlanMember_Object((1,3,6,1,4,1,171,10,61,2,13,1,1,3),_TvlanMember_Type())
...
tvlanUntaggedPorts=_TvlanUntaggedPorts_Object((1,3,6,1,4,1,171,10,61,2,13,1,1,4),_TvlanUntaggedPorts_Type())
...
tvlanStatus=_TvlanStatus_Object((1,3,6,1,4,1,171,10,61,2,13,1,1,5),_TvlanStatus_Type())
tvlanStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:tvlanStatus.setStatus(_A)
_TvlanPortTable_Object=MibTable
tvlanPortTable=_TvlanPortTable_Object((1,3,6,1,4,1,171,10,61,2,13,2))
if mibBuilder.loadTexts:tvlanPortTable.setStatus(_A)
_TvlanPortEntry_Object=MibTableRow
tvlanPortEntry=_TvlanPortEntry_Object((1,3,6,1,4,1,171,10,61,2,13,2,1))
...
tvlanPortPortId=_TvlanPortPortId_Object((1,3,6,1,4,1,171,10,61,2,13,2,1,1),_TvlanPortPortId_Type())
...
tvlanPortVlanId=_TvlanPortVlanId_Object((1,3,6,1,4,1,171,10,61,2,13,2,1,2),_TvlanPortVlanId_Type())
...
tvlanPortPriority=_TvlanPortPriority_Object((1,3,6,1,4,1,171,10,61,2,13,2,1,3),_TvlanPortPriority_Type())
...
tvlanManagement=_TvlanManagement_Object((1,3,6,1,4,1,171,10,61,2,13,3),_TvlanManagement_Type())
...
companyStaticGroup=_CompanyStaticGroup_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,21))
...
staticOnOff=_StaticOnOff_Object((1,3,6,1,4,1,171,10,61,2,21,1),_StaticOnOff_Type())
...
staticAutoLearning=_StaticAutoLearning_Object((1,3,6,1,4,1,171,10,61,2,21,2),_StaticAutoLearning_Type())
staticAutoLearning.setMaxAccess(_B)
if mibBuilder.loadTexts:staticAutoLearning.setStatus(_A)
_StaticTable_Object=MibTable
staticTable=_StaticTable_Object((1,3,6,1,4,1,171,10,61,2,21,3))
if mibBuilder.loadTexts:staticTable.setStatus(_A)
_StaticEntry_Object=MibTableRow
staticEntry=_StaticEntry_Object((1,3,6,1,4,1,171,10,61,2,21,3,1))
...
staticId=_StaticId_Object((1,3,6,1,4,1,171,10,61,2,21,3,1,1),_StaticId_Type())
...
staticMac=_StaticMac_Object((1,3,6,1,4,1,171,10,61,2,21,3,1,2),_StaticMac_Type())
...
staticPort=_StaticPort_Object((1,3,6,1,4,1,171,10,61,2,21,3,1,3),_StaticPort_Type())
...
staticVlanID=_StaticVlanID_Object((1,3,6,1,4,1,171,10,61,2,21,3,1,4),_StaticVlanID_Type())
...
staticStatus=_StaticStatus_Object((1,3,6,1,4,1,171,10,61,2,21,3,1,5),_StaticStatus_Type())
...
companyIgsGroup=_CompanyIgsGroup_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,22))
_IgsSystem_ObjectIdentity=ObjectIdentity
igsSystem=_IgsSystem_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,22,1))
...
igsStatus=_IgsStatus_Object((1,3,6,1,4,1,171,10,61,2,22,1,2),_IgsStatus_Type())
...
igsRouterPortPurgeInterval=_IgsRouterPortPurgeInterval_Object((1,3,6,1,4,1,171,10,61,2,22,1,4),_IgsRouterPortPurgeInterval_Type())
...
igsHostPortPurgeInterval=_IgsHostPortPurgeInterval_Object((1,3,6,1,4,1,171,10,61,2,22,1,5),_IgsHostPortPurgeInterval_Type())
...
igsBrg=_IgsBrg_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,22,2))
_IgsBrgRouterPortList_Type=PortList
_IgsBrgRouterPortList_Object=MibScalar
igsBrgRouterPortList=_IgsBrgRouterPortList_Object((1,3,6,1,4,1,171,10,61,2,22,2,1),_IgsBrgRouterPortList_Type())
...
igsBrgMcastFwdTable=_IgsBrgMcastFwdTable_Object((1,3,6,1,4,1,171,10,61,2,22,2,2))
if mibBuilder.loadTexts:igsBrgMcastFwdTable.setStatus(_A)
_IgsBrgMcastFwdEntry_Object=MibTableRow
igsBrgMcastFwdEntry=_IgsBrgMcastFwdEntry_Object((1,3,6,1,4,1,171,10,61,2,22,2,2,1))
...
igsBrgMcastFwdGroupAddress=_IgsBrgMcastFwdGroupAddress_Object((1,3,6,1,4,1,171,10,61,2,22,2,2,1,1),_IgsBrgMcastFwdGroupAddress_Type())
...
igsBrgMcastFwdPortListMac=_IgsBrgMcastFwdPortListMac_Object((1,3,6,1,4,1,171,10,61,2,22,2,2,1,2),_IgsBrgMcastFwdPortListMac_Type())
...
companyStormCtrlGroup=_CompanyStormCtrlGroup_ObjectIdentity((1,3,6,1,4,1,171,10,61,2,23))
...
stormctrlOnOff=_StormctrlOnOff_Object((1,3,6,1,4,1,171,10,61,2,23,1),_StormctrlOnOff_Type())
...
stormctrlStatus=_StormctrlStatus_Object((1,3,6,1,4,1,171,10,61,2,23,2),_StormctrlStatus_Type())
