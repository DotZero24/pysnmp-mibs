...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TN-MIRROR-MIB
...
class _TnMirrorDestSapStatsCounterEnable_Type(TruthValue):
    """Custom type tnMirrorDestSapStatsCounterEnable based on TruthValue"""
    defaultValue = 1


_TnMirrorDestSapStatsCounterEnable_Type.__name__ = "TruthValue"
_TnMirrorDestSapStatsCounterEnable_Object = MibTableColumn
tnMirrorDestSapStatsCounterEnable = _TnMirrorDestSapStatsCounterEnable_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 1, 1, 1, 26),
    _TnMirrorDestSapStatsCounterEnable_Type()
)
tnMirrorDestSapStatsCounterEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnMirrorDestSapStatsCounterEnable.setStatus("deprecated")
...
tnMirrorSourceMacFilterTable = _TnMirrorSourceMacFilterTable_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 3)
)
if mibBuilder.loadTexts:
    tnMirrorSourceMacFilterTable.setStatus("current")
_TnMirrorSourceMacFilterEntry_Object = MibTableRow
tnMirrorSourceMacFilterEntry = _TnMirrorSourceMacFilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 3, 1)
)
tnMirrorSourceMacFilterEntry.setIndexNames(
    (0, "TROPIC-SYSTEM-MIB", "tnSysSwitchId"),
    (0, "TN-MIRROR-MIB", "tnMirrorSourceIndex"),
    (0, "TN-MIRROR-MIB", "tnMirrorSourceMacFilter"),
    (0, "TN-MIRROR-MIB", "tnMirrorSourceMacFilterParams"),
)
if mibBuilder.loadTexts:
    tnMirrorSourceMacFilterEntry.setStatus("current")


class _TnMirrorSourceMacFilter_Type(TMACFilterID):
    """Custom type tnMirrorSourceMacFilter based on TMACFilterID"""
...
_TnMirrorSourceMacFilter_Type.__name__ = "TMACFilterID"
_TnMirrorSourceMacFilter_Object = MibTableColumn
tnMirrorSourceMacFilter = _TnMirrorSourceMacFilter_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 3, 1, 1),
    _TnMirrorSourceMacFilter_Type()
)
tnMirrorSourceMacFilter.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tnMirrorSourceMacFilter.setStatus("current")
_TnMirrorSourceMacFilterParams_Type = TEntryId
_TnMirrorSourceMacFilterParams_Object = MibTableColumn
tnMirrorSourceMacFilterParams = _TnMirrorSourceMacFilterParams_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 3, 1, 2),
    _TnMirrorSourceMacFilterParams_Type()
)
tnMirrorSourceMacFilterParams.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tnMirrorSourceMacFilterParams.setStatus("current")
_TnMirrorSourceMacFilterRowStatus_Type = RowStatus
_TnMirrorSourceMacFilterRowStatus_Object = MibTableColumn
tnMirrorSourceMacFilterRowStatus = _TnMirrorSourceMacFilterRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 3, 1, 3),
    _TnMirrorSourceMacFilterRowStatus_Type()
)
tnMirrorSourceMacFilterRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnMirrorSourceMacFilterRowStatus.setStatus("current")
_TnMirrorSourceMacFilterLastChgd_Type = TimeStamp
_TnMirrorSourceMacFilterLastChgd_Object = MibTableColumn
tnMirrorSourceMacFilterLastChgd = _TnMirrorSourceMacFilterLastChgd_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 3, 1, 4),
    _TnMirrorSourceMacFilterLastChgd_Type()
)
tnMirrorSourceMacFilterLastChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnMirrorSourceMacFilterLastChgd.setStatus("current")
...
tnMirrorSourceSapTable = _TnMirrorSourceSapTable_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 6)
)
if mibBuilder.loadTexts:
    tnMirrorSourceSapTable.setStatus("current")
_TnMirrorSourceSapEntry_Object = MibTableRow
tnMirrorSourceSapEntry = _TnMirrorSourceSapEntry_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 6, 1)
)
tnMirrorSourceSapEntry.setIndexNames(
    (0, "TROPIC-SYSTEM-MIB", "tnSysSwitchId"),
    (0, "TN-MIRROR-MIB", "tnMirrorSourceIndex"),
    (0, "TN-MIRROR-MIB", "tnMirrorSourceSapPortId"),
    (0, "TN-MIRROR-MIB", "tnMirrorSourceSapEncapValue"),
)
if mibBuilder.loadTexts:
    tnMirrorSourceSapEntry.setStatus("current")
_TnMirrorSourceSapPortId_Type = TmnxPortID
_TnMirrorSourceSapPortId_Object = MibTableColumn
tnMirrorSourceSapPortId = _TnMirrorSourceSapPortId_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 6, 1, 2),
    _TnMirrorSourceSapPortId_Type()
)
tnMirrorSourceSapPortId.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tnMirrorSourceSapPortId.setStatus("current")
_TnMirrorSourceSapEncapValue_Type = TmnxEncapVal
_TnMirrorSourceSapEncapValue_Object = MibTableColumn
tnMirrorSourceSapEncapValue = _TnMirrorSourceSapEncapValue_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 6, 1, 3),
    _TnMirrorSourceSapEncapValue_Type()
)
tnMirrorSourceSapEncapValue.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tnMirrorSourceSapEncapValue.setStatus("current")
_TnMirrorSourceSapRowStatus_Type = RowStatus
_TnMirrorSourceSapRowStatus_Object = MibTableColumn
tnMirrorSourceSapRowStatus = _TnMirrorSourceSapRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 6, 1, 4),
    _TnMirrorSourceSapRowStatus_Type()
)
tnMirrorSourceSapRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnMirrorSourceSapRowStatus.setStatus("current")


class _TnMirrorSourceSapEgressEnabled_Type(TruthValue):
    """Custom type tnMirrorSourceSapEgressEnabled based on TruthValue"""
    defaultValue = 2


_TnMirrorSourceSapEgressEnabled_Type.__name__ = "TruthValue"
_TnMirrorSourceSapEgressEnabled_Object = MibTableColumn
tnMirrorSourceSapEgressEnabled = _TnMirrorSourceSapEgressEnabled_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 6, 1, 5),
    _TnMirrorSourceSapEgressEnabled_Type()
)
tnMirrorSourceSapEgressEnabled.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnMirrorSourceSapEgressEnabled.setStatus("current")


class _TnMirrorSourceSapIngressEnabled_Type(TruthValue):
    """Custom type tnMirrorSourceSapIngressEnabled based on TruthValue"""
    defaultValue = 2


_TnMirrorSourceSapIngressEnabled_Type.__name__ = "TruthValue"
_TnMirrorSourceSapIngressEnabled_Object = MibTableColumn
tnMirrorSourceSapIngressEnabled = _TnMirrorSourceSapIngressEnabled_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 6, 1, 6),
    _TnMirrorSourceSapIngressEnabled_Type()
)
tnMirrorSourceSapIngressEnabled.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnMirrorSourceSapIngressEnabled.setStatus("current")
_TnMirrorSourceSapLastChgd_Type = TimeStamp
_TnMirrorSourceSapLastChgd_Object = MibTableColumn
tnMirrorSourceSapLastChgd = _TnMirrorSourceSapLastChgd_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 18, 2, 6, 1, 7),
    _TnMirrorSourceSapLastChgd_Type()
)
tnMirrorSourceSapLastChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnMirrorSourceSapLastChgd.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"TMplsLabel": TMplsLabel,
       ...
       "tnMirrorDestSapStatsCounterEnable": tnMirrorDestSapStatsCounterEnable,
       ...
       "tnMirrorSourceMacFilterEntry": tnMirrorSourceMacFilterEntry,
       "tnMirrorSourceMacFilter": tnMirrorSourceMacFilter,
       "tnMirrorSourceMacFilterParams": tnMirrorSourceMacFilterParams,
       "tnMirrorSourceMacFilterRowStatus": tnMirrorSourceMacFilterRowStatus,
       "tnMirrorSourceMacFilterLastChgd": tnMirrorSourceMacFilterLastChgd,
       ...
       "tnMirrorSourceSapTable": tnMirrorSourceSapTable,
       "tnMirrorSourceSapEntry": tnMirrorSourceSapEntry,
       "tnMirrorSourceSapPortId": tnMirrorSourceSapPortId,
       "tnMirrorSourceSapEncapValue": tnMirrorSourceSapEncapValue,
       "tnMirrorSourceSapRowStatus": tnMirrorSourceSapRowStatus,
       "tnMirrorSourceSapEgressEnabled": tnMirrorSourceSapEgressEnabled,
