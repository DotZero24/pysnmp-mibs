...
# Notes
# -----
# ASN.1 source file://mibs/netgear/READYNAS-MIB
...
smartMesg = _SmartMesg_Object(
    (1, 3, 6, 1, 4, 1, 4526, 18, 410),
    _SmartMesg_Type()
)
smartMesg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    smartMesg.setStatus("current")
_PsuMesg_Type = DisplayString
_PsuMesg_Object = MibScalar
psuMesg = _PsuMesg_Object(
    (1, 3, 6, 1, 4, 1, 4526, 18, 411),
    _PsuMesg_Type()
)
psuMesg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    psuMesg.setStatus("current")
...
diskSmartWarning = NotificationType(
    (1, 3, 6, 1, 4, 1, 4526, 18, 300, 0, 110)
)
diskSmartWarning.setObjects(
    ("READYNAS-MIB", "smartMesg")
)
if mibBuilder.loadTexts:
...
psuWarning = NotificationType(
    (1, 3, 6, 1, 4, 1, 4526, 18, 300, 0, 120)
)
psuWarning.setObjects(
    ("READYNAS-MIB", "psuMesg")
)
if mibBuilder.loadTexts:
