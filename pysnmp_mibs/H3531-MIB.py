...
_H3531_ObjectIdentity=ObjectIdentity
h3531=_H3531_ObjectIdentity((1,3,6,1,4,1,22626,1,2))
...
historyEntry.setIndexNames((0,_A,_Z))
...
mibBuilder.exportSymbols(_A,**{_G:DisplayString,'comet':comet,'trapTest':trapTest,'trapNTPError':trapNTPError,'trapEmailErrLogin':trapEmailErrLogin,'trapEmailErrAuth':trapEmailErrAuth,'trapEmailErrSome':trapEmailErrSome,'trapEmailErrSocket':trapEmailErrSocket,'trapEmailErrDNS':trapEmailErrDNS,'trapSOAPErrFile':trapSOAPErrFile,'trapSOAPErrDNS':trapSOAPErrDNS,'trapSOAPErrSocket':trapSOAPErrSocket,'trapSOAPErrDelivery':trapSOAPErrDelivery,'trapTempAlarm1':trapTempAlarm1,'trapHumAlarm1':trapHumAlarm1,'trapCompValAlarm1':trapCompValAlarm1,'trapTempAlarm2':trapTempAlarm2,'trapHumAlarm2':trapHumAlarm2,'trapCompValAlarm2':trapCompValAlarm2,'trapTempClrAlarm1':trapTempClrAlarm1,'trapHumClrAlarm1':trapHumClrAlarm1,'trapCompValClrAlarm1':trapCompValClrAlarm1,'trapTempClrAlarm2':trapTempClrAlarm2,'trapHumClrAlarm2':trapHumClrAlarm2,'trapCompValClrAlarm2':trapCompValClrAlarm2,'trapBin1Alarm':trapBin1Alarm,'trapBin2Alarm':trapBin2Alarm,'trapBin3Alarm':trapBin3Alarm,'trapBin1ClrAlarm':trapBin1ClrAlarm,'trapBin2ClrAlarm':trapBin2ClrAlarm,'trapBin3ClrAlarm':trapBin3ClrAlarm,'trapRelay1Closed':trapRelay1Closed,'trapRelay2Closed':trapRelay2Closed,'trapRelay1Open':trapRelay1Open,'trapRelay2Open':trapRelay2Open,'trapAcousticActivated':trapAcousticActivated,'trapAcousticDeactivated':trapAcousticDeactivated,'products':products,'h3531':h3531,'values':values,_H:temp,_I:hum,_J:compVal,'bin1':bin1,'bin2':bin2,'bin3':bin3,'re1':re1,'re2':re2,'tempAlarm1':tempAlarm1,'humAlarm1':humAlarm1,'compValAlarm1':compValAlarm1,'tempAlarm2':tempAlarm2,'humAlarm2':humAlarm2,'compValAlarm2':compValAlarm2,'bin1Alarm':bin1Alarm,'bin2Alarm':bin2Alarm,'bin3Alarm':bin3Alarm,'tempUnit':tempUnit,'humUnit':humUnit,'compValUnit':compValUnit,'global':_pysmi_global,_E:sensorName,'serialNumber':serialNumber,'deviceType':deviceType,'valuesInt':valuesInt,'tempInt':tempInt,'humInt':humInt,'compValInt':compValInt,_Q:bin1Int,_S:bin2Int,_U:bin3Int,_W:re1Int,_X:re2Int,_K:tempAlarm1Int,_L:humAlarm1Int,_M:compValAlarm1Int,_N:tempAlarm2Int,_O:humAlarm2Int,_P:compValAlarm2Int,_R:bin1AlarmInt,_T:bin2AlarmInt,_V:bin3AlarmInt,'settings':settings,'tempLim1Int':tempLim1Int,'humLim1Int':humLim1Int,'compValLim1Int':compValLim1Int,'tempLim2Int':tempLim2Int,'humLim2Int':humLim2Int,'compValLim2Int':compValLim2Int,'tempHyst1Int':tempHyst1Int,'humHyst1Int':humHyst1Int,'compValHyst1Int':compValHyst1Int,'tempHyst2Int':tempHyst2Int,'humHyst2Int':humHyst2Int,'compValHyst2Int':compValHyst2Int,'tempDelay1Int':tempDelay1Int,'humDelay1Int':humDelay1Int,'compValDelay1Int':compValDelay1Int,'tempDelay2Int':tempDelay2Int,'humDelay2Int':humDelay2Int,'compValDelay2Int':compValDelay2Int,'tempType1Int':tempType1Int,'humType1Int':humType1Int,'compValType1Int':compValType1Int,'tempType2Int':tempType2Int,'humType2Int':humType2Int,'compValType2Int':compValType2Int,'bin1DelayInt':bin1DelayInt,'bin2DelayInt':bin2DelayInt,'bin3DelayInt':bin3DelayInt,'bin1TypeInt':bin1TypeInt,'bin2TypeInt':bin2TypeInt,'bin3TypeInt':bin3TypeInt,'traps':traps,_F:messageString,'tables':tables,'historyTable':historyTable,'historyEntry':historyEntry,_Z:histTemp,'histHum':histHum,'histCompVal':histCompVal})