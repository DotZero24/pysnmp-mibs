# SNMP MIB module (ARICENT-DOT1AD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/siaemic/ARICENT-DOT1AD-MIB
...
class _Dot1adPortSVlanPriorityType_Type(Integer32):
    """Custom type dot1adPortSVlanPriorityType based on Integer32"""
    defaultValue = 1
...
_Dot1adPortSVlanPriorityType_Type.__name__ = "Integer32"
_Dot1adPortSVlanPriorityType_Object = MibTableColumn
dot1adPortSVlanPriorityType = _Dot1adPortSVlanPriorityType_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 1, 1, 5),
    _Dot1adPortSVlanPriorityType_Type()
)
dot1adPortSVlanPriorityType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dot1adPortSVlanPriorityType.setStatus("current")


class _Dot1adPortSVlanPriority_Type(Integer32):
    """Custom type dot1adPortSVlanPriority based on Integer32"""
    defaultValue = 0
...
_Dot1adPortSVlanPriority_Type.__name__ = "Integer32"
_Dot1adPortSVlanPriority_Object = MibTableColumn
dot1adPortSVlanPriority = _Dot1adPortSVlanPriority_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 1, 1, 6),
    _Dot1adPortSVlanPriority_Type()
)
dot1adPortSVlanPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dot1adPortSVlanPriority.setStatus("current")
_Dot1adVidTranslationTable_Object = MibTable
dot1adVidTranslationTable = _Dot1adVidTranslationTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 2)
)
if mibBuilder.loadTexts:
...
dot1adVidTranslationEntry = _Dot1adVidTranslationEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 2, 1)
)
dot1adVidTranslationEntry.setIndexNames(
    (0, "ARICENT-DOT1AD-MIB", "dot1adPortNum"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adVidTranslationLocalVid"),
)
if mibBuilder.loadTexts:
...
dot1adCVidRegistrationEntry = _Dot1adCVidRegistrationEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 3, 1)
)
dot1adCVidRegistrationEntry.setIndexNames(
    (0, "ARICENT-DOT1AD-MIB", "dot1adPortNum"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adCVidRegistrationCVid"),
)
if mibBuilder.loadTexts:
...
class _Dot1adCVidRegistrationSVlanPriorityType_Type(Integer32):
    """Custom type dot1adCVidRegistrationSVlanPriorityType based on Integer32"""
    defaultValue = 1
...
_Dot1adCVidRegistrationSVlanPriorityType_Type.__name__ = "Integer32"
_Dot1adCVidRegistrationSVlanPriorityType_Object = MibTableColumn
dot1adCVidRegistrationSVlanPriorityType = _Dot1adCVidRegistrationSVlanPriorityType_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 3, 1, 6),
    _Dot1adCVidRegistrationSVlanPriorityType_Type()
)
dot1adCVidRegistrationSVlanPriorityType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dot1adCVidRegistrationSVlanPriorityType.setStatus("current")


class _Dot1adCVidRegistrationSVlanPriority_Type(Integer32):
    """Custom type dot1adCVidRegistrationSVlanPriority based on Integer32"""
    defaultValue = 0
...
_Dot1adCVidRegistrationSVlanPriority_Type.__name__ = "Integer32"
_Dot1adCVidRegistrationSVlanPriority_Object = MibTableColumn
dot1adCVidRegistrationSVlanPriority = _Dot1adCVidRegistrationSVlanPriority_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 3, 1, 7),
    _Dot1adCVidRegistrationSVlanPriority_Type()
)
dot1adCVidRegistrationSVlanPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dot1adCVidRegistrationSVlanPriority.setStatus("current")
_Dot1adPepTable_Object = MibTable
dot1adPepTable = _Dot1adPepTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 4)
)
if mibBuilder.loadTexts:
    dot1adPepTable.setStatus("current")
_Dot1adPepEntry_Object = MibTableRow
dot1adPepEntry = _Dot1adPepEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 4, 1)
)
dot1adPepEntry.setIndexNames(
    (0, "ARICENT-DOT1AD-MIB", "dot1adPortNum"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adCVidRegistrationSVid"),
)
if mibBuilder.loadTexts:
...
dot1adServicePriorityRegenerationEntry = _Dot1adServicePriorityRegenerationEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 5, 1)
)
dot1adServicePriorityRegenerationEntry.setIndexNames(
    (0, "ARICENT-DOT1AD-MIB", "dot1adPortNum"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adCVidRegistrationSVid"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adServicePriorityRegenReceivedPriority"),
)
if mibBuilder.loadTexts:
...
dot1adPcpDecodingEntry = _Dot1adPcpDecodingEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 6, 1)
)
dot1adPcpDecodingEntry.setIndexNames(
    (0, "ARICENT-DOT1AD-MIB", "dot1adPortNum"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adPcpDecodingPcpSelRow"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adPcpDecodingPcpValue"),
)
if mibBuilder.loadTexts:
...
dot1adPcpEncodingEntry = _Dot1adPcpEncodingEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 130, 1, 7, 1)
)
dot1adPcpEncodingEntry.setIndexNames(
    (0, "ARICENT-DOT1AD-MIB", "dot1adPortNum"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adPcpEncodingPcpSelRow"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adPcpEncodingPriority"),
    (0, "ARICENT-DOT1AD-MIB", "dot1adPcpEncodingDropEligible"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"PriorityCodePoint": PriorityCodePoint,
       ...
       "dot1adPortSVlanPriorityType": dot1adPortSVlanPriorityType,
       "dot1adPortSVlanPriority": dot1adPortSVlanPriority,
       ...
       "dot1adCVidRegistrationSVlanPriorityType": dot1adCVidRegistrationSVlanPriorityType,
       "dot1adCVidRegistrationSVlanPriority": dot1adCVidRegistrationSVlanPriority,
