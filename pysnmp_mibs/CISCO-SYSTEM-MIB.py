...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-SYSTEM-MIB
...
mibBuilder.exportSymbols("CISCO-SYSTEM-MIB", PYSNMP_MODULE_ID=ciscoSystemMIB, csySummerTimeStatus=csySummerTimeStatus, ciscoSystemMIB=ciscoSystemMIB, ciscoSystemClockChanged=ciscoSystemClockChanged, ciscoSystemSummerTimeGroupRev1=ciscoSystemSummerTimeGroupRev1, ciscoSystemSnmpAuthGroup=ciscoSystemSnmpAuthGroup, csySnmpAuthFailAddressType=csySnmpAuthFailAddressType, ciscoSystemMIBObjects=ciscoSystemMIBObjects, csyClockLostOnReboot=csyClockLostOnReboot, csyScheduledResetTime=csyScheduledResetTime, csyLocation=csyLocation, ciscoSystemScheduledResetGroup=ciscoSystemScheduledResetGroup, csyScheduledResetAction=csyScheduledResetAction, csySummerTimeRecurringStart=csySummerTimeRecurringStart, csySnmpAuthentication=csySnmpAuthentication, csyScheduledResetReason=csyScheduledResetReason, ciscoSystemMIBNotifications=ciscoSystemMIBNotifications, ciscoSystemMIBCompliance4=ciscoSystemMIBCompliance4, csyClockDateAndTime=csyClockDateAndTime, csySnmpAuthFail=csySnmpAuthFail, csyLocationCountry=csyLocationCountry, ciscoSystemMIBCompliance=ciscoSystemMIBCompliance, ciscoSystemMIBCompliance3=ciscoSystemMIBCompliance3, ciscoSystemSummerTimeGroup=ciscoSystemSummerTimeGroup, ciscoSystemGeneralGroup=ciscoSystemGeneralGroup, csySummerTimeRecurringEnd=csySummerTimeRecurringEnd, ciscoSystemMIBCompliances=ciscoSystemMIBCompliances, csySummerTime=csySummerTime, csyNotificationsEnable=csyNotificationsEnable, ciscoSystemNotificationsGroup=ciscoSystemNotificationsGroup, csyGeneral=csyGeneral, csyClock=csyClock, csyStandardTmZnGMTOffset=csyStandardTmZnGMTOffset, csySnmpAuthFailAddress=csySnmpAuthFailAddress, ciscoSystemMIBGroups=ciscoSystemMIBGroups, csySummerTimeOffset=csySummerTimeOffset, ciscoSystemMIBCompliance2=ciscoSystemMIBCompliance2, ciscoSystemLocationGroup=ciscoSystemLocationGroup, ciscoSystemClockGroup=ciscoSystemClockGroup, csyScheduledReset=csyScheduledReset, ciscoSystemMIBNotificationPrefix=ciscoSystemMIBNotificationPrefix, ciscoSystemMIBConformance=ciscoSystemMIBConformance, csySummerTmZnGMTOffset=csySummerTmZnGMTOffset)
