...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SYSTEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:40:37 2025
...
_CsyNotificationsEnable_Type.__name__ = "TruthValue"
...
ciscoSystemMIBCompliance.setObjects(
      *(("CISCO-SYSTEM-MIB", "ciscoSystemClockGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemLocationGroup"))
)
if mibBuilder.loadTexts:
...
ciscoSystemMIBCompliance2.setObjects(
      *(("CISCO-SYSTEM-MIB", "ciscoSystemClockGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemLocationGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemSummerTimeGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemScheduledResetGroup"))
)
if mibBuilder.loadTexts:
...
ciscoSystemMIBCompliance3.setObjects(
      *(("CISCO-SYSTEM-MIB", "ciscoSystemClockGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemLocationGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemSummerTimeGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemScheduledResetGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemSnmpAuthGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemGeneralGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoSystemMIBCompliance4.setObjects(
      *(("CISCO-SYSTEM-MIB", "ciscoSystemClockGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemLocationGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemSummerTimeGroupRev1"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemScheduledResetGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemSnmpAuthGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemGeneralGroup"),
        ("CISCO-SYSTEM-MIB", "ciscoSystemNotificationsGroup"))
