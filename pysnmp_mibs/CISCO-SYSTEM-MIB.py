...
mibBuilder.exportSymbols("CISCO-SYSTEM-MIB", csySnmpAuthentication=csySnmpAuthentication, csySummerTmZnGMTOffset=csySummerTmZnGMTOffset, ciscoSystemClockGroup=ciscoSystemClockGroup, csyClock=csyClock, ciscoSystemMIBCompliance2=ciscoSystemMIBCompliance2, ciscoSystemClockChanged=ciscoSystemClockChanged, csySummerTimeRecurringStart=csySummerTimeRecurringStart, ciscoSystemMIBGroups=ciscoSystemMIBGroups, csyGeneral=csyGeneral, csySummerTimeRecurringEnd=csySummerTimeRecurringEnd, csySummerTimeOffset=csySummerTimeOffset, PYSNMP_MODULE_ID=ciscoSystemMIB, ciscoSystemMIBConformance=ciscoSystemMIBConformance, csyScheduledResetReason=csyScheduledResetReason, csySummerTimeStatus=csySummerTimeStatus, ciscoSystemSnmpAuthGroup=ciscoSystemSnmpAuthGroup, ciscoSystemMIBNotifications=ciscoSystemMIBNotifications, csyScheduledReset=csyScheduledReset, csyClockDateAndTime=csyClockDateAndTime, ciscoSystemMIB=ciscoSystemMIB, ciscoSystemScheduledResetGroup=ciscoSystemScheduledResetGroup, ciscoSystemSummerTimeGroup=ciscoSystemSummerTimeGroup, ciscoSystemGeneralGroup=ciscoSystemGeneralGroup, ciscoSystemSummerTimeGroupRev1=ciscoSystemSummerTimeGroupRev1, csySnmpAuthFailAddress=csySnmpAuthFailAddress, ciscoSystemMIBCompliance=ciscoSystemMIBCompliance, csyScheduledResetTime=csyScheduledResetTime, csyNotificationsEnable=csyNotificationsEnable, ciscoSystemMIBCompliance3=ciscoSystemMIBCompliance3, ciscoSystemNotificationsGroup=ciscoSystemNotificationsGroup, ciscoSystemMIBCompliances=ciscoSystemMIBCompliances, csyLocation=csyLocation, csyStandardTmZnGMTOffset=csyStandardTmZnGMTOffset, ciscoSystemMIBNotificationPrefix=ciscoSystemMIBNotificationPrefix, csyScheduledResetAction=csyScheduledResetAction, csyLocationCountry=csyLocationCountry, csyClockLostOnReboot=csyClockLostOnReboot, ciscoSystemMIBObjects=ciscoSystemMIBObjects, csySummerTime=csySummerTime, ciscoSystemMIBCompliance4=ciscoSystemMIBCompliance4, csySnmpAuthFail=csySnmpAuthFail, csySnmpAuthFailAddressType=csySnmpAuthFailAddressType, ciscoSystemLocationGroup=ciscoSystemLocationGroup)
