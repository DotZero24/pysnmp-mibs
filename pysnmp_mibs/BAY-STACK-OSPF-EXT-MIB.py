...
# Notes
# -----
# ASN.1 source file://mibs/nortel/BAY-STACK-OSPF-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:21:32 2025
...
_BsoeOspfIfExtAdvertiseWhenDown_Type.__name__ = "TruthValue"
...
_BsoeOspfIfExtMtuIgnore_Type.__name__ = "TruthValue"
...
class _BsoeOspfNbrExtAdjacencyErrorCode_Type(Integer32):
    """Custom type bsoeOspfNbrExtAdjacencyErrorCode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_BsoeOspfNbrExtAdjacencyErrorCode_Type.__name__ = "Integer32"
_BsoeOspfNbrExtAdjacencyErrorCode_Object = MibTableColumn
bsoeOspfNbrExtAdjacencyErrorCode = _BsoeOspfNbrExtAdjacencyErrorCode_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 14, 1, 4, 1, 4),
    _BsoeOspfNbrExtAdjacencyErrorCode_Type()
)
bsoeOspfNbrExtAdjacencyErrorCode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bsoeOspfNbrExtAdjacencyErrorCode.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"bayStackOspfExtMib": bayStackOspfExtMib,
       ...
       "bsoeOspfNbrExtAdjacencyErrorCode": bsoeOspfNbrExtAdjacencyErrorCode,
