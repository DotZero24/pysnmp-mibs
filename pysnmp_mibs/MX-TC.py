# SNMP MIB module (MX-TC) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/media5/MX-TC
...
mxTextualConventions = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4935, 90, 1)
)
if mibBuilder.loadTexts:
    mxTextualConventions.setRevisions(
        ("1903-03-11 00:00",)
    )
...
mibBuilder.exportSymbols(
    "MX-TC",
    **{"MxIpHostName": MxIpHostName,
       "MxIpAddress": MxIpAddress,
       "MxIpPort": MxIpPort,
       "MxAdvancedIpPort": MxAdvancedIpPort,
       "MxIpSubnetMask": MxIpSubnetMask,
       "MxIpSelectConfigSource": MxIpSelectConfigSource,
       "MxIpConfigSource": MxIpConfigSource,
       "MxIpDhcpSiteSpecificCode": MxIpDhcpSiteSpecificCode,
       "MxFloatingPoint": MxFloatingPoint,
       "MxEnableState": MxEnableState,
       "MxActivationState": MxActivationState,
       "MxSignalingAddress": MxSignalingAddress,
       "MxDigitMap": MxDigitMap,
       "mxTextualConventions": mxTextualConventions}
)
