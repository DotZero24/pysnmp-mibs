# SNMP MIB module (CAREL-wlprobe-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/carel/CAREL-wlprobe-MIB
...
class _Diginput1_Type(Integer32):
    """Custom type diginput1 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Diginput1_Type.__name__ = "Integer32"
_Diginput1_Object = MibScalar
diginput1 = _Diginput1_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 1),
    _Diginput1_Type()
)
diginput1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    diginput1.setStatus("current")
if mibBuilder.loadTexts:
    diginput1.setUnits("N/A")


class _Diginput2_Type(Integer32):
    """Custom type diginput2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Diginput2_Type.__name__ = "Integer32"
_Diginput2_Object = MibScalar
diginput2 = _Diginput2_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 2),
    _Diginput2_Type()
)
diginput2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    diginput2.setStatus("current")
if mibBuilder.loadTexts:
    diginput2.setUnits("N/A")


class _Alrlowbatt_Type(Integer32):
    """Custom type alrlowbatt based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Alrlowbatt_Type.__name__ = "Integer32"
_Alrlowbatt_Object = MibScalar
alrlowbatt = _Alrlowbatt_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 3),
    _Alrlowbatt_Type()
)
alrlowbatt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alrlowbatt.setStatus("current")
if mibBuilder.loadTexts:
    alrlowbatt.setUnits("N/A")


class _Alrprobefault_Type(Integer32):
    """Custom type alrprobefault based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Alrprobefault_Type.__name__ = "Integer32"
_Alrprobefault_Object = MibScalar
alrprobefault = _Alrprobefault_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 4),
    _Alrprobefault_Type()
)
alrprobefault.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alrprobefault.setStatus("current")
if mibBuilder.loadTexts:
    alrprobefault.setUnits("N/A")


class _Alrhightempprobe1_Type(Integer32):
    """Custom type alrhightempprobe1 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Alrhightempprobe1_Type.__name__ = "Integer32"
_Alrhightempprobe1_Object = MibScalar
alrhightempprobe1 = _Alrhightempprobe1_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 6),
    _Alrhightempprobe1_Type()
)
alrhightempprobe1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alrhightempprobe1.setStatus("current")
if mibBuilder.loadTexts:
    alrhightempprobe1.setUnits("N/A")


class _Alrhightempprobe2_Type(Integer32):
    """Custom type alrhightempprobe2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Alrhightempprobe2_Type.__name__ = "Integer32"
_Alrhightempprobe2_Object = MibScalar
alrhightempprobe2 = _Alrhightempprobe2_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 7),
    _Alrhightempprobe2_Type()
)
alrhightempprobe2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alrhightempprobe2.setStatus("current")
if mibBuilder.loadTexts:
    alrhightempprobe2.setUnits("N/A")


class _Alrlowtempprobe1_Type(Integer32):
    """Custom type alrlowtempprobe1 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Alrlowtempprobe1_Type.__name__ = "Integer32"
_Alrlowtempprobe1_Object = MibScalar
alrlowtempprobe1 = _Alrlowtempprobe1_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 8),
    _Alrlowtempprobe1_Type()
)
alrlowtempprobe1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alrlowtempprobe1.setStatus("current")
if mibBuilder.loadTexts:
    alrlowtempprobe1.setUnits("N/A")


class _Alrlowtempprobe2_Type(Integer32):
    """Custom type alrlowtempprobe2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Alrlowtempprobe2_Type.__name__ = "Integer32"
_Alrlowtempprobe2_Object = MibScalar
alrlowtempprobe2 = _Alrlowtempprobe2_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 9),
    _Alrlowtempprobe2_Type()
)
alrlowtempprobe2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alrlowtempprobe2.setStatus("current")
if mibBuilder.loadTexts:
    alrlowtempprobe2.setUnits("N/A")


class _Hightempalrenabled_Type(Integer32):
    """Custom type hightempalrenabled based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Hightempalrenabled_Type.__name__ = "Integer32"
_Hightempalrenabled_Object = MibScalar
hightempalrenabled = _Hightempalrenabled_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 10),
    _Hightempalrenabled_Type()
)
hightempalrenabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hightempalrenabled.setStatus("current")
if mibBuilder.loadTexts:
    hightempalrenabled.setUnits("N/A")


class _Diginputpol1_Type(Integer32):
    """Custom type diginputpol1 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Diginputpol1_Type.__name__ = "Integer32"
_Diginputpol1_Object = MibScalar
diginputpol1 = _Diginputpol1_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 11),
    _Diginputpol1_Type()
)
diginputpol1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    diginputpol1.setStatus("current")
if mibBuilder.loadTexts:
    diginputpol1.setUnits("N/A")


class _Diginputpol2_Type(Integer32):
    """Custom type diginputpol2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Diginputpol2_Type.__name__ = "Integer32"
_Diginputpol2_Object = MibScalar
diginputpol2 = _Diginputpol2_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 12),
    _Diginputpol2_Type()
)
diginputpol2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    diginputpol2.setStatus("current")
if mibBuilder.loadTexts:
    diginputpol2.setUnits("N/A")


class _Alrdefrost_Type(Integer32):
    """Custom type alrdefrost based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Alrdefrost_Type.__name__ = "Integer32"
_Alrdefrost_Object = MibScalar
alrdefrost = _Alrdefrost_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 1, 13),
    _Alrdefrost_Type()
)
alrdefrost.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alrdefrost.setStatus("current")
if mibBuilder.loadTexts:
    alrdefrost.setUnits("N/A")
...
class _Probe1_Type(Integer32):
    """Custom type probe1 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Probe1_Type.__name__ = "Integer32"
_Probe1_Object = MibScalar
probe1 = _Probe1_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 2, 1),
    _Probe1_Type()
)
probe1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    probe1.setStatus("current")
if mibBuilder.loadTexts:
    probe1.setUnits("N/A")


class _Probe2_Type(Integer32):
    """Custom type probe2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-32767, 32767),
    )
...
_Probe2_Type.__name__ = "Integer32"
_Probe2_Object = MibScalar
probe2 = _Probe2_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 2, 2),
    _Probe2_Type()
)
probe2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    probe2.setStatus("current")
if mibBuilder.loadTexts:
    probe2.setUnits("N/A")


class _Thrshitempprobe1_Type(Integer32):
    """Custom type thrshitempprobe1 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Thrshitempprobe1_Type.__name__ = "Integer32"
_Thrshitempprobe1_Object = MibScalar
thrshitempprobe1 = _Thrshitempprobe1_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 2, 3),
    _Thrshitempprobe1_Type()
)
thrshitempprobe1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    thrshitempprobe1.setStatus("current")
if mibBuilder.loadTexts:
    thrshitempprobe1.setUnits("N/A")


class _Thrshitempprobe2_Type(Integer32):
    """Custom type thrshitempprobe2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1250),
    )
...
_Thrshitempprobe2_Type.__name__ = "Integer32"
_Thrshitempprobe2_Object = MibScalar
thrshitempprobe2 = _Thrshitempprobe2_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 2, 4),
    _Thrshitempprobe2_Type()
)
thrshitempprobe2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    thrshitempprobe2.setStatus("current")
if mibBuilder.loadTexts:
    thrshitempprobe2.setUnits("N/A")


class _Thrslotempprobe1_Type(Integer32):
    """Custom type thrslotempprobe1 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-500, 100),
    )


_Thrslotempprobe1_Type.__name__ = "Integer32"
_Thrslotempprobe1_Object = MibScalar
thrslotempprobe1 = _Thrslotempprobe1_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 2, 5),
    _Thrslotempprobe1_Type()
)
thrslotempprobe1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    thrslotempprobe1.setStatus("current")
if mibBuilder.loadTexts:
    thrslotempprobe1.setUnits("N/A")


class _Thrslotempprobe2_Type(Integer32):
    """Custom type thrslotempprobe2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-500, 100),
    )
...
_Thrslotempprobe2_Type.__name__ = "Integer32"
_Thrslotempprobe2_Object = MibScalar
thrslotempprobe2 = _Thrslotempprobe2_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 2, 6),
    _Thrslotempprobe2_Type()
)
thrslotempprobe2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    thrslotempprobe2.setStatus("current")
if mibBuilder.loadTexts:
    thrslotempprobe2.setUnits("N/A")
...
class _Hightempdelay_Type(Integer32):
    """Custom type hightempdelay based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hightempdelay_Type.__name__ = "Integer32"
_Hightempdelay_Object = MibScalar
hightempdelay = _Hightempdelay_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 3, 1),
    _Hightempdelay_Type()
)
hightempdelay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hightempdelay.setStatus("current")
if mibBuilder.loadTexts:
    hightempdelay.setUnits("min")


class _Defrostdelay_Type(Integer32):
    """Custom type defrostdelay based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 120),
    )
...
_Defrostdelay_Type.__name__ = "Integer32"
_Defrostdelay_Object = MibScalar
defrostdelay = _Defrostdelay_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 3, 2),
    _Defrostdelay_Type()
)
defrostdelay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    defrostdelay.setStatus("current")
if mibBuilder.loadTexts:
    defrostdelay.setUnits("min")


class _Ampsignal_Type(Integer32):
    """Custom type ampsignal based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Ampsignal_Type.__name__ = "Integer32"
_Ampsignal_Object = MibScalar
ampsignal = _Ampsignal_Object(
    (1, 3, 6, 1, 4, 1, 9839, 2, 1, 3, 3),
    _Ampsignal_Type()
)
ampsignal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ampsignal.setStatus("current")
if mibBuilder.loadTexts:
    ampsignal.setUnits("N/A")
...
mibBuilder.exportSymbols(
    ...
    **{"carel": carel,
       ...
       "wlprobeMIB": wlprobeMIB,
       "digitalObjects": digitalObjects,
       "diginput1": diginput1,
       "diginput2": diginput2,
       "alrlowbatt": alrlowbatt,
       "alrprobefault": alrprobefault,
       "alrhightempprobe1": alrhightempprobe1,
       "alrhightempprobe2": alrhightempprobe2,
       "alrlowtempprobe1": alrlowtempprobe1,
       "alrlowtempprobe2": alrlowtempprobe2,
       "hightempalrenabled": hightempalrenabled,
       "diginputpol1": diginputpol1,
       "diginputpol2": diginputpol2,
       "alrdefrost": alrdefrost,
       "analogObjects": analogObjects,
       "probe1": probe1,
       "probe2": probe2,
       "thrshitempprobe1": thrshitempprobe1,
       "thrshitempprobe2": thrshitempprobe2,
       "thrslotempprobe1": thrslotempprobe1,
       "thrslotempprobe2": thrslotempprobe2,
       "integerObjects": integerObjects,
       "hightempdelay": hightempdelay,
       "defrostdelay": defrostdelay,
       "ampsignal": ampsignal}
)
