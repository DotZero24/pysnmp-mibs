# SNMP MIB module (LANCOM-DOT1X-AUTHENTICATION-SERVER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-DOT1X-AUTHENTICATION-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:20:27 2025
...
agentDot1xAuthServUserConfigEntry = _AgentDot1xAuthServUserConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 49, 1, 2, 1)
)
agentDot1xAuthServUserConfigEntry.setIndexNames(
    (0, "LANCOM-DOT1X-AUTHENTICATION-SERVER-MIB", "agentDot1xAuthServUserIndex"),
)
if mibBuilder.loadTexts:
...
agentDot1xAuthServUserIndex = _AgentDot1xAuthServUserIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 49, 1, 2, 1, 1),
...
agentDot1xAuthServUserName = _AgentDot1xAuthServUserName_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 49, 1, 2, 1, 2),
...
agentDot1xAuthServUserPassword = _AgentDot1xAuthServUserPassword_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 49, 1, 2, 1, 3),
...
agentDot1xAuthServUserStatus = _AgentDot1xAuthServUserStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 49, 1, 2, 1, 4),
...
mibBuilder.exportSymbols(
    "LANCOM-DOT1X-AUTHENTICATION-SERVER-MIB",
