...
# Notes
# -----
# ASN.1 source file://mibs/hp/CPQWCRM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:33:52 2025
...
internalSensorValueScale = _InternalSensorValueScale_Object(
    (1, 3, 6, 1, 4, 1, 232, 167, 2, 3, 5, 2, 1, 9),
    _InternalSensorValueScale_Type()
)
internalSensorValueScale.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    internalSensorValueScale.setStatus("mandatory")
_InternalSensorScaledValue_Type = Integer32
_InternalSensorScaledValue_Object = MibTableColumn
internalSensorScaledValue = _InternalSensorScaledValue_Object(
    (1, 3, 6, 1, 4, 1, 232, 167, 2, 3, 5, 2, 1, 10),
    _InternalSensorScaledValue_Type()
)
internalSensorScaledValue.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    internalSensorScaledValue.setStatus("mandatory")
...
class _WaterCoolUnitSensorType_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("tempIn", 4),
          ...
          ("dewPointValue", 31),
          ("foundFans", 32),
          ("isolationValveInlet", 33),
          ("isolationValveFacility", 34),
          ("isolationValveInfrastructure", 35),
          ("controlValveFacility", 36),
          ("controlValveInfrastructure", 37),
          ("tempIn4", 38),
          ("tempIn5", 39),
          ("tempIn6", 40),
          ("waterPressureSupply", 41),
          ("waterPressureReturn", 42),
          ("airDiffPressure1", 43),
          ("airDiffPressure2", 44),
          ("acInput1", 45),
          ("acInput2", 46),
...
waterCoolUnitSensorValueScale = _WaterCoolUnitSensorValueScale_Object(
    (1, 3, 6, 1, 4, 1, 232, 167, 2, 4, 5, 2, 1, 9),
    _WaterCoolUnitSensorValueScale_Type()
)
waterCoolUnitSensorValueScale.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    waterCoolUnitSensorValueScale.setStatus("mandatory")
_WaterCoolUnitSensorScaledValue_Type = Integer32
_WaterCoolUnitSensorScaledValue_Object = MibTableColumn
waterCoolUnitSensorScaledValue = _WaterCoolUnitSensorScaledValue_Object(
    (1, 3, 6, 1, 4, 1, 232, 167, 2, 4, 5, 2, 1, 10),
    _WaterCoolUnitSensorScaledValue_Type()
)
waterCoolUnitSensorScaledValue.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    waterCoolUnitSensorScaledValue.setStatus("mandatory")
...
class _WaterCoolUnitOutputType_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("notAvail", 1),
          ...
          ("offsetHW", 24),
          ("valveControlMode", 25),
          ("isolationValveInletManual", 26),
          ("isolationValveFacilityManual", 27),
          ("isolationValveInfrastructureManual", 28),
          ("controlValveFacilityManual", 29),
          ("controlValveInfrastructureManual", 30),
          ("fanControlMode", 31),
          ("fan1Manual", 32),
          ("fan2Manual", 33),
          ("fan3Manual", 34),
          ("fan4Manual", 35),
          ("setpointAirDifPressure", 36),
          ("pidContrKPFan", 37),
          ("pidContrKIFan", 38),
          ("pidContrKDFan", 39),
          ("pidSampleTimeFan", 40),
          ("dewpointOffset", 41),
          ("maxItAirTemperature", 42),
          ("dewpointControlMode", 43))
    )
...
class _TrapIPV4V6address_Type(DisplayString):
    """Custom type trapIPV4V6address based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TrapIPV4V6address_Type.__name__ = "DisplayString"
_TrapIPV4V6address_Object = MibTableColumn
trapIPV4V6address = _TrapIPV4V6address_Object(
    (1, 3, 6, 1, 4, 1, 232, 167, 4, 7, 2, 1, 4),
    _TrapIPV4V6address_Type()
)
trapIPV4V6address.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    trapIPV4V6address.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"cpqWcrm": cpqWcrm,
       ...
       "internalSensorValueScale": internalSensorValueScale,
       "internalSensorScaledValue": internalSensorScaledValue,
       ...
       "waterCoolUnitSensorValueScale": waterCoolUnitSensorValueScale,
       "waterCoolUnitSensorScaledValue": waterCoolUnitSensorScaledValue,
       ...
       "trapIPV4V6address": trapIPV4V6address,
