...
mibBuilder.exportSymbols("CPQWCRM-MIB", waterCoolUnitMsgText=waterCoolUnitMsgText, trapIPV4V6address=trapIPV4V6address, cpqWcrmSetupGeneral=cpqWcrmSetupGeneral, internalMsgIndex=internalMsgIndex, cpqWcrmInternalOutputTable=cpqWcrmInternalOutputTable, cpqWcrmWaterCoolUnitSerial=cpqWcrmWaterCoolUnitSerial, internalOutputDelay=internalOutputDelay, cpqWcrmSetTempUnit=cpqWcrmSetTempUnit, internalOutputType=internalOutputType, internalSensorType=internalSensorType, cpqWcrmMibMajRev=cpqWcrmMibMajRev, cpqWcrmSetFlowUnit=cpqWcrmSetFlowUnit, internalOutputConfig=internalOutputConfig, cpqWcrmWaterCoolUnitSensorTable=cpqWcrmWaterCoolUnitSensorTable, waterCoolUnitOutputValue=waterCoolUnitOutputValue, waterCoolUnitSensorValue=waterCoolUnitSensorValue, cpqWcrmControl=cpqWcrmControl, internalMsgTrap4=internalMsgTrap4, cpqWcrmTimeOff=cpqWcrmTimeOff, internalSensorScaledValue=internalSensorScaledValue, cpqWcrmTimerStatus=cpqWcrmTimerStatus, cpqWcrmInternalSensorEntry=cpqWcrmInternalSensorEntry, cpqWcrmSetupDate=cpqWcrmSetupDate, waterCoolUnitOutputDelay=waterCoolUnitOutputDelay, waterCoolUnitOutputSet=waterCoolUnitOutputSet, waterCoolUnitMsgTrap2=waterCoolUnitMsgTrap2, waterCoolUnitMsgTrap3=waterCoolUnitMsgTrap3, waterCoolUnitSensorScaledValue=waterCoolUnitSensorScaledValue, waterCoolUnitMsgTrap1=waterCoolUnitMsgTrap1, cpqWcrmTraptableNumber=cpqWcrmTraptableNumber, waterCoolUnitOutputStatus=waterCoolUnitOutputStatus, cpqWcrmWaterCoolUnitText=cpqWcrmWaterCoolUnitText, internalOutputValue=internalOutputValue, cpqWcrmWaterCoolUnitStatus=cpqWcrmWaterCoolUnitStatus, waterCoolUnitSensorText=waterCoolUnitSensorText, cpqWcrmInternalNumberOfSensors=cpqWcrmInternalNumberOfSensors, waterCoolUnitOutputType=waterCoolUnitOutputType, cpqWcrmInternalTypeOfDevice=cpqWcrmInternalTypeOfDevice, internalMsgRelay=internalMsgRelay, cpqWcrmInternalStatus=cpqWcrmInternalStatus, cpqWcrmTimerDayOfWeek=cpqWcrmTimerDayOfWeek, internalOutputStatus=internalOutputStatus, waterCoolUnitMsgReset=waterCoolUnitMsgReset, cpqWcrmTimeControl=cpqWcrmTimeControl, cpqWcrmWebAccess=cpqWcrmWebAccess, cpqWcrmStatusInternalSensors=cpqWcrmStatusInternalSensors, internalMsgTrap2=internalMsgTrap2, cpqWcrmInternalSerial=cpqWcrmInternalSerial, internalSensorIndex=internalSensorIndex, testTrap=testTrap, cpqWcrmWaterCoolUnitOutputTable=cpqWcrmWaterCoolUnitOutputTable, waterCoolUnitMsgStatus=waterCoolUnitMsgStatus, cpqWcrmResetUnit=cpqWcrmResetUnit, cpqWcrmTimerEntry=cpqWcrmTimerEntry, internalSensorSetHigh=internalSensorSetHigh, waterCoolUnitOutputConfig=waterCoolUnitOutputConfig, cpqWcrmTrapControl=cpqWcrmTrapControl, cpqWcrmWaterCoolUnitNumberOfSensors=cpqWcrmWaterCoolUnitNumberOfSensors, cpqWcrmInternalNumberOfOutputs=cpqWcrmInternalNumberOfOutputs, cpqWcrmWaterCoolUnitNumberOfMsgs=cpqWcrmWaterCoolUnitNumberOfMsgs, internalSensorValueScale=internalSensorValueScale, cpqWcrmTimerTable=cpqWcrmTimerTable, cpqWcrmStatusSensorWaterCoolUnit=cpqWcrmStatusSensorWaterCoolUnit, cpqWcrmSetup=cpqWcrmSetup, cpqWcrmInternalMsgTable=cpqWcrmInternalMsgTable, cpqWcrmWaterCoolUnitTypeOfDevice=cpqWcrmWaterCoolUnitTypeOfDevice, cpqWcrmTimeOn=cpqWcrmTimeOn, waterCoolUnitSensorSetHigh=waterCoolUnitSensorSetHigh, cpqWcrmStatusWaterCoolUnitSensors=cpqWcrmStatusWaterCoolUnitSensors, cpqWcrmStatusWaterCoolUnitOutputs=cpqWcrmStatusWaterCoolUnitOutputs, waterCoolUnitSensorValueScale=waterCoolUnitSensorValueScale, cpqWcrmMibMinRev=cpqWcrmMibMinRev, cpqWcrmUnitsConnected=cpqWcrmUnitsConnected, internalMsgBeeper=internalMsgBeeper, cpqWcrmResetRelay=cpqWcrmResetRelay, waterCoolUnitOutputTimeoutAction=waterCoolUnitOutputTimeoutAction, waterCoolUnitMsgRelay=waterCoolUnitMsgRelay, cpqWcrmInternalMsgEntry=cpqWcrmInternalMsgEntry, alarmSensorWaterCoolUnit=alarmSensorWaterCoolUnit, cpqWcrmStatusSensorInternal=cpqWcrmStatusSensorInternal, cpqWcrmTimerIndex=cpqWcrmTimerIndex, trapIPaddress=trapIPaddress, alarmWaterCoolUnit=alarmWaterCoolUnit, internalMsgTrap3=internalMsgTrap3, cpqWcrmInternalNumberOfMsgs=cpqWcrmInternalNumberOfMsgs, cpqWcrmURL=cpqWcrmURL, waterCoolUnitSensorSetLow=waterCoolUnitSensorSetLow, internalSensorSetWarn=internalSensorSetWarn, internalMsgTrap1=internalMsgTrap1, waterCoolUnitMsgBeeper=waterCoolUnitMsgBeeper, trapIndex=trapIndex, cpqWcrmStatus=cpqWcrmStatus, cpqWcrmStatusInternalOutputs=cpqWcrmStatusInternalOutputs, cpqWcrmInternalSensorTable=cpqWcrmInternalSensorTable, cpqWcrmWaterCoolUnitNumberOfOutputs=cpqWcrmWaterCoolUnitNumberOfOutputs, waterCoolUnitMsgTrap4=waterCoolUnitMsgTrap4, cpqWcrmSetupTime=cpqWcrmSetupTime, cpqWcrmTrapTableEntry=cpqWcrmTrapTableEntry, internalMsgText=internalMsgText, cpqWcrmMibCondition=cpqWcrmMibCondition, internalSensorValue=internalSensorValue, internalOutputText=internalOutputText, internalSensorSetLow=internalSensorSetLow, internalOutputTimeoutAction=internalOutputTimeoutAction, cpqWcrmStatusWaterCoolUnitMsg=cpqWcrmStatusWaterCoolUnitMsg, internalSensorStatus=internalSensorStatus, cpqWcrmStatusDeviceEnvironmentalController=cpqWcrmStatusDeviceEnvironmentalController, cpqWcrmWaterCoolUnitMsgEntry=cpqWcrmWaterCoolUnitMsgEntry, internalOutputSet=internalOutputSet, internalMsgReset=internalMsgReset, cpqWcrmTimerTable1=cpqWcrmTimerTable1, waterCoolUnitOutputIndex=waterCoolUnitOutputIndex, cpqWcrmMibRev=cpqWcrmMibRev, cpqWcrmWaterCoolUnitOutputEntry=cpqWcrmWaterCoolUnitOutputEntry, waterCoolUnitSensorIndex=waterCoolUnitSensorIndex, trapStatus=trapStatus, cpqWcrmWaterCoolUnitMsgTable=cpqWcrmWaterCoolUnitMsgTable, cpqWcrmTrapTableTable=cpqWcrmTrapTableTable, waterCoolUnitMsgIndex=waterCoolUnitMsgIndex, waterCoolUnitSensorStatus=waterCoolUnitSensorStatus, internalSensorText=internalSensorText, internalOutputIndex=internalOutputIndex, waterCoolUnitOutputText=waterCoolUnitOutputText, cpqWcrmWaterCoolUnitSensorEntry=cpqWcrmWaterCoolUnitSensorEntry, cpqWcrmTimerFunction=cpqWcrmTimerFunction, waterCoolUnitSensorType=waterCoolUnitSensorType, cpqWcrmLogicRelay=cpqWcrmLogicRelay, cpqWcrmTimerNumber=cpqWcrmTimerNumber, cpqWcrmStatusInternalMsg=cpqWcrmStatusInternalMsg, internalMsgStatus=internalMsgStatus, alarmInternal=alarmInternal, cpqWcrmInternalOutputEntry=cpqWcrmInternalOutputEntry, cpqWcrmTraps=cpqWcrmTraps, waterCoolUnitSensorSetWarn=waterCoolUnitSensorSetWarn, alarmSensorInternal=alarmSensorInternal, cpqWcrm=cpqWcrm, cpqWcrmInternalText=cpqWcrmInternalText, cpqWcrmSetBeeper=cpqWcrmSetBeeper)
