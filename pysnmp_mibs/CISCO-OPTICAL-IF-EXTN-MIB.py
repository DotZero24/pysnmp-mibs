...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-OPTICAL-IF-EXTN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:27 2025
...
coIfExtnMIBCompliance.setObjects(
      *(("CISCO-OPTICAL-IF-EXTN-MIB", "coIfWavelengthMIBGroup"),
        ("CISCO-OPTICAL-IF-EXTN-MIB", "coIfTypeExtnMIBGroup"),
        ("CISCO-OPTICAL-IF-EXTN-MIB", "coIfDwdmChannelGroupMIBGroup"))
)
if mibBuilder.loadTexts:
...
coIfExtnMIBCompliance2.setObjects(
      *(("CISCO-OPTICAL-IF-EXTN-MIB", "coIfWavelengthMIBGroup"),
        ("CISCO-OPTICAL-IF-EXTN-MIB", "coIfTypeExtnMIBGroup"),
        ("CISCO-OPTICAL-IF-EXTN-MIB", "coIfDwdmChannelGroupMIBGroup"),
        ("CISCO-OPTICAL-IF-EXTN-MIB", "coIfXcvrBaseMIBGroup"),
        ("CISCO-OPTICAL-IF-EXTN-MIB", "coIfXcvrTunableLaserMIBGroup"),
