...
mibBuilder.exportSymbols("MSERIES-TC", AlarmPerceivedSeverity=AlarmPerceivedSeverity, AlarmNotificationType=AlarmNotificationType, smartTcMIB=smartTcMIB, PortStatus=PortStatus, PortMode=PortMode, UnitType=UnitType, AlarmProbableCause=AlarmProbableCause, PortType=PortType, PYSNMP_MODULE_ID=smartTcMIB)
