...
# Notes
# -----
# ASN.1 source file://mibs/rfc/MPLS-LC-ATM-STD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:24:37 2025
...
_MplsLcAtmStdVcMerge_Type.__name__ = "TruthValue"
...
_MplsLcAtmVcDirectlyConnected_Type.__name__ = "TruthValue"
...
_MplsLcAtmLcAtmVPI_Type.__name__ = "AtmVpIdentifier"
...
_MplsLcAtmStdIfConfStorageType_Type.__name__ = "StorageType"
...
mplsLcAtmStdModuleFullCompliance.setObjects(
    ("MPLS-LC-ATM-STD-MIB", "mplsLcAtmStdIfGroup")
)
if mibBuilder.loadTexts:
...
mplsLcAtmStdModuleReadOnlyCompliance.setObjects(
    ("MPLS-LC-ATM-STD-MIB", "mplsLcAtmStdIfGroup")
)
if mibBuilder.loadTexts:
