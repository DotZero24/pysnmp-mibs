...
# Notes
# -----
# ASN.1 source file://mibs/peplink/PEPWAVE-MAX-MIB
...
maxCompliance.setObjects(
      *(("PEPWAVE-MAX-MIB", "maxSystemGroup"),
        ("PEPWAVE-MAX-MIB", "maxLinkGroup"),
        ("PEPWAVE-MAX-MIB", "maxWanGroup"),
        ("PEPWAVE-MAX-MIB", "maxSetGroup"))
)
if mibBuilder.loadTexts:
