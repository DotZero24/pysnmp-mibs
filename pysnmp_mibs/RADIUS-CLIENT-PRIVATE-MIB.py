_N='agentRadiusServerIndex'
_M='not-accessible'
_L='agentRadiusAccountingServerIndex'
_K='RADIUS-CLIENT-PRIVATE-MIB'
_J='disable'
_I='enable'
_H='obsolete'
_G='DisplayString'
...
agentRadiusConfigGroup=_AgentRadiusConfigGroup_ObjectIdentity((1,3,6,1,4,1,7244,2,8,1))
...
agentRadiusMaxTransmit=_AgentRadiusMaxTransmit_Object((1,3,6,1,4,1,7244,2,8,1,1),_AgentRadiusMaxTransmit_Type())
...
agentRadiusTimeout=_AgentRadiusTimeout_Object((1,3,6,1,4,1,7244,2,8,1,2),_AgentRadiusTimeout_Type())
agentRadiusTimeout.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusTimeout.setStatus(_A)
class _AgentRadiusAccountingMode_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_I,1),(_J,2)))
_AgentRadiusAccountingMode_Type.__name__=_C
_AgentRadiusAccountingMode_Object=MibScalar
agentRadiusAccountingMode=_AgentRadiusAccountingMode_Object((1,3,6,1,4,1,7244,2,8,1,3),_AgentRadiusAccountingMode_Type())
agentRadiusAccountingMode.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusAccountingMode.setStatus(_A)
class _AgentRadiusStatsClear_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_I,1),(_J,2)))
_AgentRadiusStatsClear_Type.__name__=_C
_AgentRadiusStatsClear_Object=MibScalar
agentRadiusStatsClear=_AgentRadiusStatsClear_Object((1,3,6,1,4,1,7244,2,8,1,4),_AgentRadiusStatsClear_Type())
...
agentRadiusAccountingIndexNextValid=_AgentRadiusAccountingIndexNextValid_Object((1,3,6,1,4,1,7244,2,8,1,5),_AgentRadiusAccountingIndexNextValid_Type())
agentRadiusAccountingIndexNextValid.setMaxAccess(_E)
...
agentRadiusAccountingConfigTable=_AgentRadiusAccountingConfigTable_Object((1,3,6,1,4,1,7244,2,8,1,6))
...
agentRadiusAccountingConfigEntry=_AgentRadiusAccountingConfigEntry_Object((1,3,6,1,4,1,7244,2,8,1,6,1))
agentRadiusAccountingConfigEntry.setIndexNames((0,_K,_L))
...
agentRadiusAccountingServerIndex=_AgentRadiusAccountingServerIndex_Object((1,3,6,1,4,1,7244,2,8,1,6,1,1),_AgentRadiusAccountingServerIndex_Type())
...
agentRadiusAccountingServerAddress=_AgentRadiusAccountingServerAddress_Object((1,3,6,1,4,1,7244,2,8,1,6,1,2),_AgentRadiusAccountingServerAddress_Type())
...
agentRadiusAccountingServerAddressType=_AgentRadiusAccountingServerAddressType_Object((1,3,6,1,4,1,7244,2,8,1,6,1,3),_AgentRadiusAccountingServerAddressType_Type())
...
agentRadiusAccountingPort=_AgentRadiusAccountingPort_Object((1,3,6,1,4,1,7244,2,8,1,6,1,4),_AgentRadiusAccountingPort_Type())
...
agentRadiusAccountingSecret=_AgentRadiusAccountingSecret_Object((1,3,6,1,4,1,7244,2,8,1,6,1,5),_AgentRadiusAccountingSecret_Type())
...
agentRadiusAccountingStatus=_AgentRadiusAccountingStatus_Object((1,3,6,1,4,1,7244,2,8,1,6,1,6),_AgentRadiusAccountingStatus_Type())
...
agentRadiusAccountingServerName=_AgentRadiusAccountingServerName_Object((1,3,6,1,4,1,7244,2,8,1,6,1,7),_AgentRadiusAccountingServerName_Type())
...
agentRadiusServerIndexNextValid=_AgentRadiusServerIndexNextValid_Object((1,3,6,1,4,1,7244,2,8,1,7),_AgentRadiusServerIndexNextValid_Type())
agentRadiusServerIndexNextValid.setMaxAccess(_E)
if mibBuilder.loadTexts:agentRadiusServerIndexNextValid.setStatus(_A)
_AgentRadiusServerConfigTable_Object=MibTable
agentRadiusServerConfigTable=_AgentRadiusServerConfigTable_Object((1,3,6,1,4,1,7244,2,8,1,8))
if mibBuilder.loadTexts:agentRadiusServerConfigTable.setStatus(_A)
_AgentRadiusServerConfigEntry_Object=MibTableRow
agentRadiusServerConfigEntry=_AgentRadiusServerConfigEntry_Object((1,3,6,1,4,1,7244,2,8,1,8,1))
agentRadiusServerConfigEntry.setIndexNames((0,_K,_N))
...
agentRadiusServerIndex=_AgentRadiusServerIndex_Object((1,3,6,1,4,1,7244,2,8,1,8,1,1),_AgentRadiusServerIndex_Type())
...
agentRadiusServerAddress=_AgentRadiusServerAddress_Object((1,3,6,1,4,1,7244,2,8,1,8,1,2),_AgentRadiusServerAddress_Type())
agentRadiusServerAddress.setMaxAccess(_F)
if mibBuilder.loadTexts:agentRadiusServerAddress.setStatus(_H)
_AgentRadiusServerAddressType_Type=InetAddressType
_AgentRadiusServerAddressType_Object=MibTableColumn
agentRadiusServerAddressType=_AgentRadiusServerAddressType_Object((1,3,6,1,4,1,7244,2,8,1,8,1,3),_AgentRadiusServerAddressType_Type())
...
agentRadiusServerPort=_AgentRadiusServerPort_Object((1,3,6,1,4,1,7244,2,8,1,8,1,4),_AgentRadiusServerPort_Type())
...
agentRadiusServerSecret=_AgentRadiusServerSecret_Object((1,3,6,1,4,1,7244,2,8,1,8,1,5),_AgentRadiusServerSecret_Type())
agentRadiusServerSecret.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusServerSecret.setStatus(_A)
class _AgentRadiusServerPrimaryMode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_I,1),(_J,2)))
_AgentRadiusServerPrimaryMode_Type.__name__=_C
_AgentRadiusServerPrimaryMode_Object=MibTableColumn
agentRadiusServerPrimaryMode=_AgentRadiusServerPrimaryMode_Object((1,3,6,1,4,1,7244,2,8,1,8,1,6),_AgentRadiusServerPrimaryMode_Type())
...
agentRadiusServerCurrentMode=_AgentRadiusServerCurrentMode_Object((1,3,6,1,4,1,7244,2,8,1,8,1,7),_AgentRadiusServerCurrentMode_Type())
agentRadiusServerCurrentMode.setMaxAccess(_E)
if mibBuilder.loadTexts:agentRadiusServerCurrentMode.setStatus(_A)
class _AgentRadiusServerMsgAuth_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_I,1),(_J,2)))
_AgentRadiusServerMsgAuth_Type.__name__=_C
_AgentRadiusServerMsgAuth_Object=MibTableColumn
agentRadiusServerMsgAuth=_AgentRadiusServerMsgAuth_Object((1,3,6,1,4,1,7244,2,8,1,8,1,8),_AgentRadiusServerMsgAuth_Type())
...
agentRadiusServerRowStatus=_AgentRadiusServerRowStatus_Object((1,3,6,1,4,1,7244,2,8,1,8,1,9),_AgentRadiusServerRowStatus_Type())
...
agentRadiusServerName=_AgentRadiusServerName_Object((1,3,6,1,4,1,7244,2,8,1,8,1,10),_AgentRadiusServerName_Type())
...
agentRadiusServerInetAddress=_AgentRadiusServerInetAddress_Object((1,3,6,1,4,1,7244,2,8,1,8,1,11),_AgentRadiusServerInetAddress_Type())
...
agentRadiusServerTimeout=_AgentRadiusServerTimeout_Object((1,3,6,1,4,1,7244,2,8,1,8,1,12),_AgentRadiusServerTimeout_Type())
agentRadiusServerTimeout.setMaxAccess(_E)
if mibBuilder.loadTexts:agentRadiusServerTimeout.setStatus(_A)
class _AgentRadiusServerRetransmit_Type(Unsigned32):defaultValue=3;subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,15))
_AgentRadiusServerRetransmit_Type.__name__=_D
_AgentRadiusServerRetransmit_Object=MibTableColumn
agentRadiusServerRetransmit=_AgentRadiusServerRetransmit_Object((1,3,6,1,4,1,7244,2,8,1,8,1,13),_AgentRadiusServerRetransmit_Type())
agentRadiusServerRetransmit.setMaxAccess(_E)
...
agentRadiusServerDeadtime=_AgentRadiusServerDeadtime_Object((1,3,6,1,4,1,7244,2,8,1,8,1,14),_AgentRadiusServerDeadtime_Type())
agentRadiusServerDeadtime.setMaxAccess(_E)
...
agentRadiusServerSourceIPAddr=_AgentRadiusServerSourceIPAddr_Object((1,3,6,1,4,1,7244,2,8,1,8,1,15),_AgentRadiusServerSourceIPAddr_Type())
agentRadiusServerSourceIPAddr.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusServerSourceIPAddr.setStatus(_H)
...
agentRadiusServerPriority=_AgentRadiusServerPriority_Object((1,3,6,1,4,1,7244,2,8,1,8,1,16),_AgentRadiusServerPriority_Type())
agentRadiusServerPriority.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusServerPriority.setStatus(_H)
...
agentRadiusServerUsageType=_AgentRadiusServerUsageType_Object((1,3,6,1,4,1,7244,2,8,1,8,1,17),_AgentRadiusServerUsageType_Type())
agentRadiusServerUsageType.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusServerUsageType.setStatus(_H)
_AgentRadiusAuthenticationServers_Type=Unsigned32
_AgentRadiusAuthenticationServers_Object=MibScalar
agentRadiusAuthenticationServers=_AgentRadiusAuthenticationServers_Object((1,3,6,1,4,1,7244,2,8,1,9),_AgentRadiusAuthenticationServers_Type())
agentRadiusAuthenticationServers.setMaxAccess(_E)
...
agentRadiusAccountingServers=_AgentRadiusAccountingServers_Object((1,3,6,1,4,1,7244,2,8,1,10),_AgentRadiusAccountingServers_Type())
agentRadiusAccountingServers.setMaxAccess(_E)
...
agentRadiusNamedAuthenticationServerGroups=_AgentRadiusNamedAuthenticationServerGroups_Object((1,3,6,1,4,1,7244,2,8,1,11),_AgentRadiusNamedAuthenticationServerGroups_Type())
agentRadiusNamedAuthenticationServerGroups.setMaxAccess(_E)
...
agentRadiusNamedAccountingServerGroups=_AgentRadiusNamedAccountingServerGroups_Object((1,3,6,1,4,1,7244,2,8,1,12),_AgentRadiusNamedAccountingServerGroups_Type())
agentRadiusNamedAccountingServerGroups.setMaxAccess(_E)
...
agentRadiusDeadTime=_AgentRadiusDeadTime_Object((1,3,6,1,4,1,7244,2,8,1,13),_AgentRadiusDeadTime_Type())
...
agentRadiusServerKey=_AgentRadiusServerKey_Object((1,3,6,1,4,1,7244,2,8,1,14),_AgentRadiusServerKey_Type())
agentRadiusServerKey.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusServerKey.setStatus(_H)
_AgentRadiusSourceIPAddr_Type=IpAddress
_AgentRadiusSourceIPAddr_Object=MibScalar
agentRadiusSourceIPAddr=_AgentRadiusSourceIPAddr_Object((1,3,6,1,4,1,7244,2,8,1,15),_AgentRadiusSourceIPAddr_Type())
agentRadiusSourceIPAddr.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusSourceIPAddr.setStatus(_H)
_AgentRadiusNasIpAddress_Type=IpAddress
_AgentRadiusNasIpAddress_Object=MibScalar
agentRadiusNasIpAddress=_AgentRadiusNasIpAddress_Object((1,3,6,1,4,1,7244,2,8,1,16),_AgentRadiusNasIpAddress_Type())
agentRadiusNasIpAddress.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusNasIpAddress.setStatus(_A)
class _AgentAuthorizationNetworkRadiusMode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1)));namedValues=NamedValues(*((_J,0),(_I,1)))
_AgentAuthorizationNetworkRadiusMode_Type.__name__=_C
_AgentAuthorizationNetworkRadiusMode_Object=MibScalar
agentAuthorizationNetworkRadiusMode=_AgentAuthorizationNetworkRadiusMode_Object((1,3,6,1,4,1,7244,2,8,1,17),_AgentAuthorizationNetworkRadiusMode_Type())
...
agentRadiusNasIpv6Address=_AgentRadiusNasIpv6Address_Object((1,3,6,1,4,1,7244,2,8,1,18),_AgentRadiusNasIpv6Address_Type())
...
agentRadiusSourceInterface=_AgentRadiusSourceInterface_Object((1,3,6,1,4,1,7244,2,8,1,19),_AgentRadiusSourceInterface_Type())
agentRadiusSourceInterface.setMaxAccess(_B)
if mibBuilder.loadTexts:agentRadiusSourceInterface.setStatus(_A)
mibBuilder.exportSymbols(_K,**{'radius':radius,'agentRadiusConfigGroup':agentRadiusConfigGroup,'agentRadiusMaxTransmit':agentRadiusMaxTransmit,'agentRadiusTimeout':agentRadiusTimeout,'agentRadiusAccountingMode':agentRadiusAccountingMode,'agentRadiusStatsClear':agentRadiusStatsClear,'agentRadiusAccountingIndexNextValid':agentRadiusAccountingIndexNextValid,'agentRadiusAccountingConfigTable':agentRadiusAccountingConfigTable,'agentRadiusAccountingConfigEntry':agentRadiusAccountingConfigEntry,_L:agentRadiusAccountingServerIndex,'agentRadiusAccountingServerAddress':agentRadiusAccountingServerAddress,'agentRadiusAccountingServerAddressType':agentRadiusAccountingServerAddressType,'agentRadiusAccountingPort':agentRadiusAccountingPort,'agentRadiusAccountingSecret':agentRadiusAccountingSecret,'agentRadiusAccountingStatus':agentRadiusAccountingStatus,'agentRadiusAccountingServerName':agentRadiusAccountingServerName,'agentRadiusServerIndexNextValid':agentRadiusServerIndexNextValid,'agentRadiusServerConfigTable':agentRadiusServerConfigTable,'agentRadiusServerConfigEntry':agentRadiusServerConfigEntry,_N:agentRadiusServerIndex,'agentRadiusServerAddress':agentRadiusServerAddress,'agentRadiusServerAddressType':agentRadiusServerAddressType,'agentRadiusServerPort':agentRadiusServerPort,'agentRadiusServerSecret':agentRadiusServerSecret,'agentRadiusServerPrimaryMode':agentRadiusServerPrimaryMode,'agentRadiusServerCurrentMode':agentRadiusServerCurrentMode,'agentRadiusServerMsgAuth':agentRadiusServerMsgAuth,'agentRadiusServerRowStatus':agentRadiusServerRowStatus,'agentRadiusServerName':agentRadiusServerName,'agentRadiusServerInetAddress':agentRadiusServerInetAddress,'agentRadiusServerTimeout':agentRadiusServerTimeout,'agentRadiusServerRetransmit':agentRadiusServerRetransmit,'agentRadiusServerDeadtime':agentRadiusServerDeadtime,'agentRadiusServerSourceIPAddr':agentRadiusServerSourceIPAddr,'agentRadiusServerPriority':agentRadiusServerPriority,'agentRadiusServerUsageType':agentRadiusServerUsageType,'agentRadiusAuthenticationServers':agentRadiusAuthenticationServers,'agentRadiusAccountingServers':agentRadiusAccountingServers,'agentRadiusNamedAuthenticationServerGroups':agentRadiusNamedAuthenticationServerGroups,'agentRadiusNamedAccountingServerGroups':agentRadiusNamedAccountingServerGroups,'agentRadiusDeadTime':agentRadiusDeadTime,'agentRadiusServerKey':agentRadiusServerKey,'agentRadiusSourceIPAddr':agentRadiusSourceIPAddr,'agentRadiusNasIpAddress':agentRadiusNasIpAddress,'agentAuthorizationNetworkRadiusMode':agentAuthorizationNetworkRadiusMode,'agentRadiusNasIpv6Address':agentRadiusNasIpv6Address,'agentRadiusSourceInterface':agentRadiusSourceInterface})