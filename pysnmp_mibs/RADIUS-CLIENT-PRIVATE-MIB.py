# SNMP MIB module (RADIUS-CLIENT-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/quanta/RADIUS-CLIENT-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:12:56 2025
...
radius = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 8)
)
...
agentRadiusAccountingConfigEntry = _AgentRadiusAccountingConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 8, 1, 6, 1)
)
agentRadiusAccountingConfigEntry.setIndexNames(
    (0, "RADIUS-CLIENT-PRIVATE-MIB", "agentRadiusAccountingServerIndex"),
)
if mibBuilder.loadTexts:
...
agentRadiusServerConfigEntry = _AgentRadiusServerConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 8, 1, 8, 1)
)
agentRadiusServerConfigEntry.setIndexNames(
    (0, "RADIUS-CLIENT-PRIVATE-MIB", "agentRadiusServerIndex"),
)
if mibBuilder.loadTexts:
...
agentRadiusServerTimeout = _AgentRadiusServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 8, 1, 8, 1, 12),
    _AgentRadiusServerTimeout_Type()
)
agentRadiusServerTimeout.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
agentRadiusServerRetransmit = _AgentRadiusServerRetransmit_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 8, 1, 8, 1, 13),
    _AgentRadiusServerRetransmit_Type()
)
agentRadiusServerRetransmit.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
agentRadiusServerDeadtime = _AgentRadiusServerDeadtime_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 8, 1, 8, 1, 14),
    _AgentRadiusServerDeadtime_Type()
)
agentRadiusServerDeadtime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
