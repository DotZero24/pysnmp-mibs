...
mibBuilder.exportSymbols("Cisco90Series-MIB", frxT1OutOctets=frxT1OutOctets, frxNetFrShEs=frxNetFrShEs, DisplayString=DisplayString, frxMgt=frxMgt, frxPortSpeed=frxPortSpeed, frxSysVersion=frxSysVersion, frxDSLHDLCEs=frxDSLHDLCEs, frxDCktBe=frxDCktBe, frxPVCAssigned=frxPVCAssigned, frxPortNetEs=frxPortNetEs, frxDSLLinkEs=frxDSLLinkEs, frxPdSesTx=frxPdSesTx, frxAgtChStatus=frxAgtChStatus, frxDLCIAdLen=frxDLCIAdLen, frxCktInOctets=frxCktInOctets, frxDPortProtocol=frxDPortProtocol, frxChEsTx=frxChEsTx, frxPortIndex=frxPortIndex, frxChUType=frxChUType, frxBrite=frxBrite, frxFarEndOpStat=frxFarEndOpStat, frxAgtChInactive=frxAgtChInactive, frxH7EsTx=frxH7EsTx, frxClockMin=frxClockMin, frxDSLFrLgEs=frxDSLFrLgEs, frxBankType=frxBankType, frxBertBE=frxBertBE, frxPort=frxPort, frxSysLoc=frxSysLoc, frxDConfigFailed=frxDConfigFailed, frxDCktBc=frxDCktBc, frxDConfigSrc=frxDConfigSrc, frxCircuitTable=frxCircuitTable, frxPhEsRx=frxPhEsRx, frxPdSesRx=frxPdSesRx, frxChUnit=frxChUnit, frxTestType=frxTestType, frxClockHour=frxClockHour, frxCdEsTh=frxCdEsTh, frxMgtPortTable=frxMgtPortTable, frMux=frMux, frxChEsRx=frxChEsRx, frxCdSesTh=frxCdSesTh, frxDSLCRCEs=frxDSLCRCEs, frxDSLDLCIEs=frxDSLDLCIEs, frxBankEntry=frxBankEntry, frxUpTime=frxUpTime, frxPortsInSvc=frxPortsInSvc, frxTestInProg=frxTestInProg, frxNetHDLCEs=frxNetHDLCEs, frxNetBadFrames=frxNetBadFrames, frxNetPPPEs=frxNetPPPEs, frxDMgtT391=frxDMgtT391, frxPortProtErrors=frxPortProtErrors, frxAlertMask=frxAlertMask, frxCdEsRx=frxCdEsRx, frxAgtProtErrors=frxAgtProtErrors, frxNetCRCEs=frxNetCRCEs, frxMgtN392=frxMgtN392, frxAdminContact=frxAdminContact, frxNetFrLgEs=frxNetFrLgEs, frxDSLFrShEs=frxDSLFrShEs, frxCktOutFrames=frxCktOutFrames, frxCdEsTx=frxCdEsTx, frxDMgtN391=frxDMgtN391, frxMgtN393=frxMgtN393, frxDMgtN393=frxDMgtN393, frxDefault=frxDefault, frxSigProtocol=frxSigProtocol, frxUPerfTrapEnable=frxUPerfTrapEnable, frxChUVersion=frxChUVersion, frxChSesTx=frxChSesTx, frxNetChStatus=frxNetChStatus, frxChUTable=frxChUTable, frxH5EsTx=frxH5EsTx, frxAgtLinkErrors=frxAgtLinkErrors, frxCktBc=frxCktBc, frxBertTestTime=frxBertTestTime, frxH4EsRx=frxH4EsRx, frxInsertChUTrap=frxInsertChUTrap, frxPortChInactive=frxPortChInactive, frxNetLinkEs=frxNetLinkEs, frxCktOutOctets=frxCktOutOctets, frxMgtT391=frxMgtT391, frxMgtEntry=frxMgtEntry, frxBankIndex=frxBankIndex, frxLoopLoc=frxLoopLoc, frxPortTable=frxPortTable, frxDSLStatus=frxDSLStatus, frxCktDiscards=frxCktDiscards, frxUPerfTrap=frxUPerfTrap, frxPvcIndex=frxPvcIndex, frxNetOutOctets=frxNetOutOctets, frxClockSec=frxClockSec, frxRxBuf=frxRxBuf, frxCdSesRx=frxCdSesRx, frxDSLOutOctets=frxDSLOutOctets, frxLoopCh=frxLoopCh, frxH8EsTx=frxH8EsTx, frxChSesRx=frxChSesRx, frxPMtype=frxPMtype, frxStartTest=frxStartTest, frxDMgtN392=frxDMgtN392, frxNetBufEs=frxNetBufEs, frxUPerfTable=frxUPerfTable, frxPortEntry=frxPortEntry, frxPortProtocol=frxPortProtocol, frxDMgtT392=frxDMgtT392, frxH2EsRx=frxH2EsRx, frxBankTable=frxBankTable, frxSysName=frxSysName, frxUPerfEntry=frxUPerfEntry, frxBertRst=frxBertRst, frxH5EsRx=frxH5EsRx, frxTxBuf=frxTxBuf, frxCircuitEntry=frxCircuitEntry, frxNetInOctets=frxNetInOctets, frxH3EsRx=frxH3EsRx, frxDefaultEnable=frxDefaultEnable, frxResetPM=frxResetPM, frxPAddrIndex=frxPAddrIndex, frxH2EsTx=frxH2EsTx, frxDCktCIR=frxDCktCIR, frxMgtT392=frxMgtT392, frxTestPort=frxTestPort, frxNetLinkErrors=frxNetLinkErrors, frxNetChInactive=frxNetChInactive, frxH4EsTx=frxH4EsTx, frxH7EsRx=frxH7EsRx, frxSysDescr=frxSysDescr, frxBank=frxBank, frxNetProtErrors=frxNetProtErrors, frxChUIndex=frxChUIndex, frxPhSesTx=frxPhSesTx, frxChBeRx=frxChBeRx, frxPhBeRx=frxPhBeRx, frxSys=frxSys, frxUThrTable=frxUThrTable, frxChBeTx=frxChBeTx, frxCktBe=frxCktBe, frxThCond=frxThCond, frxPhSesRx=frxPhSesRx, frxChSesTh=frxChSesTh, frxDownloadTrap=frxDownloadTrap, ciscoTelesend=ciscoTelesend, frxPdEsTx=frxPdEsTx, frxCdSesTx=frxCdSesTx, frxUThrEntry=frxUThrEntry, frxUEocEntry=frxUEocEntry, frxLastChange=frxLastChange, frxPhBeTx=frxPhBeTx, frxT1InOctets=frxT1InOctets, frxChUEntry=frxChUEntry, frxDPortSpeed=frxDPortSpeed, frxPdEsRx=frxPdEsRx, frxChEsTh=frxChEsTh, frxRemoveChUTrap=frxRemoveChUTrap, frxDefaultTrap=frxDefaultTrap, frxConfigSrc=frxConfigSrc, frxMgtN391=frxMgtN391, frxPhEsTx=frxPhEsTx, frxCktInFrames=frxCktInFrames, frxH6EsRx=frxH6EsRx, frxUEocTable=frxUEocTable, frxMgtTable=frxMgtTable, frxH3EsTx=frxH3EsTx, frxCktCIR=frxCktCIR, frxDSLBadFrames=frxDSLBadFrames, frxH8EsRx=frxH8EsRx, frxH6EsTx=frxH6EsTx, frxPortLinkErrors=frxPortLinkErrors, frxDSLInOctets=frxDSLInOctets, frxMgtPortEntry=frxMgtPortEntry)
