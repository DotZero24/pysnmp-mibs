# SNMP MIB module (ARECA-SATA-CARD2-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/areca/ARECA-SATA-CARD2-MIB
...
sataRaidCard2 = _SataRaidCard2_ObjectIdentity(
...
hwControllerBoardPowerEntry.setIndexNames(
    (0, "ARECA-SATA-CARD2-MIB", "hwControllerBoardPowerIndex"),
)
if mibBuilder.loadTexts:
...
hwControllerBoardVolEntry.setIndexNames(
    (0, "ARECA-SATA-CARD2-MIB", "hwControllerBoardVolIndex"),
)
if mibBuilder.loadTexts:
...
hwControllerBoardFanEntry.setIndexNames(
    (0, "ARECA-SATA-CARD2-MIB", "hwControllerBoardFanIndex"),
)
if mibBuilder.loadTexts:
...
hwControllerBoardTempEntry = _HwControllerBoardTempEntry_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 2, 2, 10, 1)
)
hwControllerBoardTempEntry.setIndexNames(
    (0, "ARECA-SATA-CARD2-MIB", "hwControllerBoardTempIndex"),
)
if mibBuilder.loadTexts:
...
hwControllerBoardTempIndex = _HwControllerBoardTempIndex_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 2, 2, 10, 1, 1),
...
hwControllerBoardTempDesc = _HwControllerBoardTempDesc_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 2, 2, 10, 1, 2),
...
hwControllerBoardTempValue = _HwControllerBoardTempValue_Object(
    (1, 3, 6, 1, 4, 1, 18928, 1, 2, 2, 10, 1, 3),
...
hddInfoEntry.setIndexNames(
    (0, "ARECA-SATA-CARD2-MIB", "hddSlots"),
)
if mibBuilder.loadTexts:
...
raidInfoEntry.setIndexNames(
    (0, "ARECA-SATA-CARD2-MIB", "raidNumber"),
)
if mibBuilder.loadTexts:
...
volInfoEntry.setIndexNames(
    (0, "ARECA-SATA-CARD2-MIB", "volNumber"),
)
if mibBuilder.loadTexts:
...
eventInfoEntry.setIndexNames(
    (0, "ARECA-SATA-CARD2-MIB", "eventNumber"),
)
if mibBuilder.loadTexts:
...
rsCreate.setObjects(
    ("ARECA-SATA-CARD2-MIB", "eventString")
)
if mibBuilder.loadTexts:
    rsCreate.setStatus(
        ""
...
mibBuilder.exportSymbols(
    "ARECA-SATA-CARD2-MIB",
    **{"areca": areca,
       "arecaGroup1": arecaGroup1,
       "sataRaidCard2": sataRaidCard2,
