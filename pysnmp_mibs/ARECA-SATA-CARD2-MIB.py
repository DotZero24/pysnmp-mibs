...
_SataRaidCard2_ObjectIdentity=ObjectIdentity
sataRaidCard2=_SataRaidCard2_ObjectIdentity((1,3,6,1,4,1,18928,1,2))
...
siHddSlots=_SiHddSlots_Object((1,3,6,1,4,1,18928,1,2,1,16),_SiHddSlots_Type())
...
siRaidSets=_SiRaidSets_Object((1,3,6,1,4,1,18928,1,2,1,17),_SiRaidSets_Type())
...
siVolumeSets=_SiVolumeSets_Object((1,3,6,1,4,1,18928,1,2,1,18),_SiVolumeSets_Type())
...
siRaid6=_SiRaid6_Object((1,3,6,1,4,1,18928,1,2,1,22),_SiRaid6_Type())
...
siDhcp=_SiDhcp_Object((1,3,6,1,4,1,18928,1,2,1,23),_SiDhcp_Type())
...
siBeeper=_SiBeeper_Object((1,3,6,1,4,1,18928,1,2,1,24),_SiBeeper_Type())
...
siUsage=_SiUsage_Object((1,3,6,1,4,1,18928,1,2,1,25),_SiUsage_Type())
...
siMaxATA=_SiMaxATA_Object((1,3,6,1,4,1,18928,1,2,1,26),_SiMaxATA_Type())
...
siRebuildRate=_SiRebuildRate_Object((1,3,6,1,4,1,18928,1,2,1,27),_SiRebuildRate_Type())
...
siBaudRate=_SiBaudRate_Object((1,3,6,1,4,1,18928,1,2,1,28),_SiBaudRate_Type())
...
hwControllerBoardInstalled=_HwControllerBoardInstalled_Object((1,3,6,1,4,1,18928,1,2,2,1),_HwControllerBoardInstalled_Type())
...
hwControllerBoardDescription=_HwControllerBoardDescription_Object((1,3,6,1,4,1,18928,1,2,2,2),_HwControllerBoardDescription_Type())
...
hwControllerBoardNumberOfPower=_HwControllerBoardNumberOfPower_Object((1,3,6,1,4,1,18928,1,2,2,3),_HwControllerBoardNumberOfPower_Type())
...
hwControllerBoardNumberOfVol=_HwControllerBoardNumberOfVol_Object((1,3,6,1,4,1,18928,1,2,2,4),_HwControllerBoardNumberOfVol_Type())
...
hwControllerBoardNumberOfFan=_HwControllerBoardNumberOfFan_Object((1,3,6,1,4,1,18928,1,2,2,5),_HwControllerBoardNumberOfFan_Type())
...
hwControllerBoardNumberOfTemp=_HwControllerBoardNumberOfTemp_Object((1,3,6,1,4,1,18928,1,2,2,6),_HwControllerBoardNumberOfTemp_Type())
...
hwControllerBoardPowerTable=_HwControllerBoardPowerTable_Object((1,3,6,1,4,1,18928,1,2,2,7))
if mibBuilder.loadTexts:hwControllerBoardPowerTable.setStatus(_C)
_HwControllerBoardPowerEntry_Object=MibTableRow
hwControllerBoardPowerEntry=_HwControllerBoardPowerEntry_Object((1,3,6,1,4,1,18928,1,2,2,7,1))
...
hwControllerBoardPowerIndex=_HwControllerBoardPowerIndex_Object((1,3,6,1,4,1,18928,1,2,2,7,1,1),_HwControllerBoardPowerIndex_Type())
...
hwControllerBoardPowerDesc=_HwControllerBoardPowerDesc_Object((1,3,6,1,4,1,18928,1,2,2,7,1,2),_HwControllerBoardPowerDesc_Type())
...
hwControllerBoardPowerState=_HwControllerBoardPowerState_Object((1,3,6,1,4,1,18928,1,2,2,7,1,3),_HwControllerBoardPowerState_Type())
...
hwControllerBoardVolTable=_HwControllerBoardVolTable_Object((1,3,6,1,4,1,18928,1,2,2,8))
if mibBuilder.loadTexts:hwControllerBoardVolTable.setStatus(_C)
_HwControllerBoardVolEntry_Object=MibTableRow
hwControllerBoardVolEntry=_HwControllerBoardVolEntry_Object((1,3,6,1,4,1,18928,1,2,2,8,1))
...
hwControllerBoardVolIndex=_HwControllerBoardVolIndex_Object((1,3,6,1,4,1,18928,1,2,2,8,1,1),_HwControllerBoardVolIndex_Type())
...
hwControllerBoardVolDesc=_HwControllerBoardVolDesc_Object((1,3,6,1,4,1,18928,1,2,2,8,1,2),_HwControllerBoardVolDesc_Type())
...
hwControllerBoardVolValue=_HwControllerBoardVolValue_Object((1,3,6,1,4,1,18928,1,2,2,8,1,3),_HwControllerBoardVolValue_Type())
...
hwControllerBoardFanTable=_HwControllerBoardFanTable_Object((1,3,6,1,4,1,18928,1,2,2,9))
if mibBuilder.loadTexts:hwControllerBoardFanTable.setStatus(_C)
_HwControllerBoardFanEntry_Object=MibTableRow
hwControllerBoardFanEntry=_HwControllerBoardFanEntry_Object((1,3,6,1,4,1,18928,1,2,2,9,1))
...
hwControllerBoardFanIndex=_HwControllerBoardFanIndex_Object((1,3,6,1,4,1,18928,1,2,2,9,1,1),_HwControllerBoardFanIndex_Type())
...
hwControllerBoardFanDesc=_HwControllerBoardFanDesc_Object((1,3,6,1,4,1,18928,1,2,2,9,1,2),_HwControllerBoardFanDesc_Type())
...
hwControllerBoardFanSpeed=_HwControllerBoardFanSpeed_Object((1,3,6,1,4,1,18928,1,2,2,9,1,3),_HwControllerBoardFanSpeed_Type())
...
hwControllerBoardTempTable=_HwControllerBoardTempTable_Object((1,3,6,1,4,1,18928,1,2,2,10))
if mibBuilder.loadTexts:hwControllerBoardTempTable.setStatus(_C)
_HwControllerBoardTempEntry_Object=MibTableRow
hwControllerBoardTempEntry=_HwControllerBoardTempEntry_Object((1,3,6,1,4,1,18928,1,2,2,10,1))
...
hwControllerBoardTempIndex=_HwControllerBoardTempIndex_Object((1,3,6,1,4,1,18928,1,2,2,10,1,1),_HwControllerBoardTempIndex_Type())
...
hwControllerBoardTempDesc=_HwControllerBoardTempDesc_Object((1,3,6,1,4,1,18928,1,2,2,10,1,2),_HwControllerBoardTempDesc_Type())
...
hwControllerBoardTempValue=_HwControllerBoardTempValue_Object((1,3,6,1,4,1,18928,1,2,2,10,1,3),_HwControllerBoardTempValue_Type())
...
hddInfoTable=_HddInfoTable_Object((1,3,6,1,4,1,18928,1,2,3,1))
if mibBuilder.loadTexts:hddInfoTable.setStatus(_C)
_HddInfoEntry_Object=MibTableRow
hddInfoEntry=_HddInfoEntry_Object((1,3,6,1,4,1,18928,1,2,3,1,1))
...
hddSlots=_HddSlots_Object((1,3,6,1,4,1,18928,1,2,3,1,1,1),_HddSlots_Type())
...
hddName=_HddName_Object((1,3,6,1,4,1,18928,1,2,3,1,1,2),_HddName_Type())
...
hddSerial=_HddSerial_Object((1,3,6,1,4,1,18928,1,2,3,1,1,3),_HddSerial_Type())
...
hddFirmVer=_HddFirmVer_Object((1,3,6,1,4,1,18928,1,2,3,1,1,4),_HddFirmVer_Type())
...
hddCapacity=_HddCapacity_Object((1,3,6,1,4,1,18928,1,2,3,1,1,5),_HddCapacity_Type())
...
hddPio=_HddPio_Object((1,3,6,1,4,1,18928,1,2,3,1,1,6),_HddPio_Type())
hddPio.setMaxAccess(_D)
if mibBuilder.loadTexts:hddPio.setStatus(_C)
_HddCudma_Type=Integer32
_HddCudma_Object=MibTableColumn
hddCudma=_HddCudma_Object((1,3,6,1,4,1,18928,1,2,3,1,1,7),_HddCudma_Type())
...
hddSudma=_HddSudma_Object((1,3,6,1,4,1,18928,1,2,3,1,1,8),_HddSudma_Type())
...
hddState=_HddState_Object((1,3,6,1,4,1,18928,1,2,3,1,1,9),_HddState_Type())
