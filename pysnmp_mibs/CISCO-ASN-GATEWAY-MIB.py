...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:29:32 2025
...
mibBuilder.exportSymbols("CISCO-ASN-GATEWAY-MIB", cagwGlobalStatisticsGroupRev1=cagwGlobalStatisticsGroupRev1, cagwPktsDroppedMipIncomplete=cagwPktsDroppedMipIncomplete, ciscoAgwMaxBaseStationExceededOnsetNotif=ciscoAgwMaxBaseStationExceededOnsetNotif, cagwStatistics=cagwStatistics, cagwPathEthGreBytesSentRev1=cagwPathEthGreBytesSentRev1, ciscoAgwMIBCompliances=ciscoAgwMIBCompliances, cagwCurrentDataPaths=cagwCurrentDataPaths, cagwDeletedFlows=cagwDeletedFlows, cagwMaxBaseStationExceededNotifEnabled=cagwMaxBaseStationExceededNotifEnabled, cagwEthGreSentDataBytes=cagwEthGreSentDataBytes, cagwRepeatNotifInterval=cagwRepeatNotifInterval, cagwFramedRouteInserted=cagwFramedRouteInserted, cagwDhcpAckPackets=cagwDhcpAckPackets, cagwRejectedSessionUnapprovedBs=cagwRejectedSessionUnapprovedBs, cagwFlowPathNotFoundDataPktsDrops=cagwFlowPathNotFoundDataPktsDrops, cagwInstances=cagwInstances, cagwDhcpProxyLeaseQueryPackets=cagwDhcpProxyLeaseQueryPackets, cagwUserGrpDeletedFlows=cagwUserGrpDeletedFlows, cagwUserGrpCoaSuccessNotifsSent=cagwUserGrpCoaSuccessNotifsSent, cagwPathLocalIpType=cagwPathLocalIpType, cagwGeneratedNotifs=cagwGeneratedNotifs, cagwCurrentPmipEnabledSubs=cagwCurrentPmipEnabledSubs, cagwGeneratedMaxSubscNotifs=cagwGeneratedMaxSubscNotifs, cagwNotifGroup=cagwNotifGroup, cagwHotlineDownlinkPktDropAclDeny=cagwHotlineDownlinkPktDropAclDeny, cagwGeneratedMaxBsNotifs=cagwGeneratedMaxBsNotifs, cagwFragmentedDataPktsDrops=cagwFragmentedDataPktsDrops, cagwFramedRouteDeleted=cagwFramedRouteDeleted, cagwPodFailureNotifsSent=cagwPodFailureNotifsSent, cagwStateEntry=cagwStateEntry, cagwDeletedSessions=cagwDeletedSessions, cagwGlobalStatisticsEntry=cagwGlobalStatisticsEntry, cagwIdleModePageAttemptsLocUpdt=cagwIdleModePageAttemptsLocUpdt, cagwDhcpNakPackets=cagwDhcpNakPackets, cagwUserGrpCreatedFlows=cagwUserGrpCreatedFlows, cagwMaxSubscribersExceededNotifSeverity=cagwMaxSubscribersExceededNotifSeverity, cagwUserGrpBytesSent=cagwUserGrpBytesSent, cagwMsgResent=cagwMsgResent, cagwArpReqReceived=cagwArpReqReceived, cagwIgnoredMaxSubscNotifs=cagwIgnoredMaxSubscNotifs, cagwIpGreSentDataPkts=cagwIpGreSentDataPkts, cagwPathPacketsReceived=cagwPathPacketsReceived, ciscoAgwServiceDownNotif=ciscoAgwServiceDownNotif, cagwCreatedSubscribers=cagwCreatedSubscribers, cagwUserGrpGroupRev1Sup1=cagwUserGrpGroupRev1Sup1, cagwCoaReqRecv=cagwCoaReqRecv, cagwUserGrpDomainName=cagwUserGrpDomainName, cagwState=cagwState, cagwMaxSubscribersExceededNotifEnabled=cagwMaxSubscribersExceededNotifEnabled, cagwThrottlingOfPuntsDataPktsDrops=cagwThrottlingOfPuntsDataPktsDrops, cagwIdleModeEntryBwgInitiated=cagwIdleModeEntryBwgInitiated, cagwDhcpUnknownPackets=cagwDhcpUnknownPackets, cagwIdleModeLocUpdtPgidChange=cagwIdleModeLocUpdtPgidChange, cagwIdleModeLocUpdtPowerDown=cagwIdleModeLocUpdtPowerDown, cagwServiceNotifEnabled=cagwServiceNotifEnabled, cagwCurrentFramedRoutes=cagwCurrentFramedRoutes, cagwArpStatisticsTable=cagwArpStatisticsTable, cagwPathGroupRev1=cagwPathGroupRev1, cagwRejectedFlows=cagwRejectedFlows, cagwDeletedSubscribers=cagwDeletedSubscribers, cagwPathIpGreBytesSentRev1=cagwPathIpGreBytesSentRev1, cagwPathStatistics=cagwPathStatistics, cagwUserGrpPodReqRecv=cagwUserGrpPodReqRecv, cagwCreatedPmipEnabledSubs=cagwCreatedPmipEnabledSubs, cagwNetworkBehindMs=cagwNetworkBehindMs, cagwSentDataPkts=cagwSentDataPkts, cagwInstanceSessionRedundancyAdmin=cagwInstanceSessionRedundancyAdmin, cagwGeneratedServiceNotifs=cagwGeneratedServiceNotifs, cagwDhcpRequestPackets=cagwDhcpRequestPackets, cagwMsgTable=cagwMsgTable, cagwPathBytesSent=cagwPathBytesSent, cagwIdleModeDirectedPagingRetries=cagwIdleModeDirectedPagingRetries, cagwPathLocalIpTypeRev1=cagwPathLocalIpTypeRev1, cagwIpGreReceivedDataPkts=cagwIpGreReceivedDataPkts, cagwMessageStatistics=cagwMessageStatistics, cagwUserGrpIpGrePacketsSent=cagwUserGrpIpGrePacketsSent, cagwPathRemoteIpTypeRev1=cagwPathRemoteIpTypeRev1, cagwInstancePhysicalIndex=cagwInstancePhysicalIndex, cagwImpactedInfo=cagwImpactedInfo, cagwNotifEnabled=cagwNotifEnabled, cagwUserGrpIpGrePacketsReceived=cagwUserGrpIpGrePacketsReceived, cagwUserGrpStatistics=cagwUserGrpStatistics, cagwUserGrpDeletedSessions=cagwUserGrpDeletedSessions, cagwPathRemoteIpType=cagwPathRemoteIpType, cagwPathRemoteIp=cagwPathRemoteIp, cagwDownlinkPktDropUsrgrpAclDeny=cagwDownlinkPktDropUsrgrpAclDeny, cagwUserGrpEthGreBytesReceived=cagwUserGrpEthGreBytesReceived, ciscoAgwMIBCompliance=ciscoAgwMIBCompliance, cagwPathEthGreBytesReceivedRev1=cagwPathEthGreBytesReceivedRev1, cagwIpGreReceivedDataBytes=cagwIpGreReceivedDataBytes, cagwDhcpProxyInformPackets=cagwDhcpProxyInformPackets, cagwGlobalStatisticsGroupRev2Sup1=cagwGlobalStatisticsGroupRev2Sup1, cagwIgnoredServiceNotifs=cagwIgnoredServiceNotifs, cagwStateGroupSup2=cagwStateGroupSup2, cagwDisposedSignalingPktsDrops=cagwDisposedSignalingPktsDrops, cagwCurrentSessionsWithIpPktsRedir=cagwCurrentSessionsWithIpPktsRedir, cagwPktsDroppedStaticIpHostNotAllowed=cagwPktsDroppedStaticIpHostNotAllowed, cagwNotifMgmtGroup=cagwNotifMgmtGroup, cagwStateGroup=cagwStateGroup, cagwArpStatistics=cagwArpStatistics, cagwGlobalStatisticsTable=cagwGlobalStatisticsTable, cagwIdleModeExitFailures=cagwIdleModeExitFailures, cagwSlaProfileNotFound=cagwSlaProfileNotFound, cagwArpReplySent=cagwArpReplySent, cagwMaxBaseStationExceededNotifThreshold=cagwMaxBaseStationExceededNotifThreshold, cagwIpGreReceivedRedirectedBytes=cagwIpGreReceivedRedirectedBytes, cagwDhcpProxyDiscoverPackets=cagwDhcpProxyDiscoverPackets, cagwCurrentHosts=cagwCurrentHosts, cagwPodRequestsRecv=cagwPodRequestsRecv, cagwPathLocalIpRev1=cagwPathLocalIpRev1, cagwIpGreReceivedRedirectedPkts=cagwIpGreReceivedRedirectedPkts, cagwUserGrpInvalidSourceBytesDrops=cagwUserGrpInvalidSourceBytesDrops, cagwIpGreSentDataBytes=cagwIpGreSentDataBytes, cagwMsgReceived=cagwMsgReceived, cagwMsgEntry=cagwMsgEntry, cagwIdleModePageFailuresDwnlnkData=cagwIdleModePageFailuresDwnlnkData, cagwSequenceNumberErrorDataPktsDrops=cagwSequenceNumberErrorDataPktsDrops, cagwUplinkPktDropUsrgrpAclDeny=cagwUplinkPktDropUsrgrpAclDeny, cagwUserGrpBytesReceived=cagwUserGrpBytesReceived, cagwServiceFlowProfileNotFound=cagwServiceFlowProfileNotFound, cagwNotifInfo=cagwNotifInfo, cagwEthGreReceivedRedirectedPkts=cagwEthGreReceivedRedirectedPkts, cagwMaximumFlowsPerSession=cagwMaximumFlowsPerSession, cagwPathLocalIp=cagwPathLocalIp, cagwLengthErrorDataPktsDrops=cagwLengthErrorDataPktsDrops, cagwInstanceVersion=cagwInstanceVersion, cagwPuntedDataPkts=cagwPuntedDataPkts, cagwPathTypeRev1=cagwPathTypeRev1, cagwDhcpProxyDeclinePackets=cagwDhcpProxyDeclinePackets, cagwPathEthGrePacketsSentRev1=cagwPathEthGrePacketsSentRev1, cagwPathRemoteIpRev1=cagwPathRemoteIpRev1, cagwDhcpProxyStatsGroup=cagwDhcpProxyStatsGroup, cagwCongestionSignalingPktsDrops=cagwCongestionSignalingPktsDrops, cagwEthGreSentDataPkts=cagwEthGreSentDataPkts, cagwNotifInfoGroup=cagwNotifInfoGroup, cagwSuccessfulHandoff=cagwSuccessfulHandoff, cagwCoaSuccessNotifsSent=cagwCoaSuccessNotifsSent, cagwRejectedBaseStations=cagwRejectedBaseStations, cagwImpactedIpType=cagwImpactedIpType, cagwStateGroupSup1=cagwStateGroupSup1, cagwLearningUpstreamDataPktsDrops=cagwLearningUpstreamDataPktsDrops, cagwIdleModeExitMsBsInitiated=cagwIdleModeExitMsBsInitiated, cagwEthGreReceivedRedirectedBytes=cagwEthGreReceivedRedirectedBytes, cagwDhcpStatisticsTable=cagwDhcpStatisticsTable, cagwDeletedDataPaths=cagwDeletedDataPaths, cagwIdleModeFloodPagingRetries=cagwIdleModeFloodPagingRetries, cagwDhcpProxyOfferPackets=cagwDhcpProxyOfferPackets, ciscoAgwMIBComplianceRev3=ciscoAgwMIBComplianceRev3, cagwPathIpGrePacketsSentRev1=cagwPathIpGrePacketsSentRev1, cagwEthGreReceivedDataBytes=cagwEthGreReceivedDataBytes, cagwPathIpGreBytesReceivedRev1=cagwPathIpGreBytesReceivedRev1, cagwInstanceTable=cagwInstanceTable, cagwPathRev1Table=cagwPathRev1Table, ciscoAgwMaxSubscribersExceededOnsetNotif=ciscoAgwMaxSubscribersExceededOnsetNotif, cagwUserGrpGroupRev1Sup2=cagwUserGrpGroupRev1Sup2, cagwInvalidProtocolTypeDataPktsDrops=cagwInvalidProtocolTypeDataPktsDrops, cagwPathTable=cagwPathTable, cagwCreatedDataPaths=cagwCreatedDataPaths, cagwIdleModeLocUpdtFailures=cagwIdleModeLocUpdtFailures, cagwPathIpGrePacketsReceivedRev1=cagwPathIpGrePacketsReceivedRev1, cagwDhcpLeaseQueryPackets=cagwDhcpLeaseQueryPackets, cagwIdleModeExitBwgInitiated=cagwIdleModeExitBwgInitiated, cagwUserGrpInvalidSourcePacketsDrops=cagwUserGrpInvalidSourcePacketsDrops, ciscoAgwMIBConform=ciscoAgwMIBConform, cagwCoaFailureNotifsSent=cagwCoaFailureNotifsSent, cagwDownlinkPktDropPagingAclDeny=cagwDownlinkPktDropPagingAclDeny, ciscoAgwMaxBaseStationExceededAbateNotif=ciscoAgwMaxBaseStationExceededAbateNotif, cagwStateTable=cagwStateTable, cagwUserGrpCreatedSessions=cagwUserGrpCreatedSessions, cagwSuccessfulCMACKeyUpdate=cagwSuccessfulCMACKeyUpdate, cagwDeletedHosts=cagwDeletedHosts, cagwIdleModeEntryFailures=cagwIdleModeEntryFailures, cagwFramedRouteInsertFailed=cagwFramedRouteInsertFailed, cagwIdleModePageFailuresLocUpdt=cagwIdleModePageFailuresLocUpdt, cagwEncapErrorDataPktsDrops=cagwEncapErrorDataPktsDrops, cagwDhcpDiscoverPackets=cagwDhcpDiscoverPackets, cagwCurrentAutoProvSessions=cagwCurrentAutoProvSessions, cagwFlowPathInvalidSourceDataPktsDrops=cagwFlowPathInvalidSourceDataPktsDrops, cagwUserGrpPodFailureNotifsSent=cagwUserGrpPodFailureNotifsSent, cagwUserGrpCoaReqRecv=cagwUserGrpCoaReqRecv, cagwUserGrpCoaFailureNotifsSent=cagwUserGrpCoaFailureNotifsSent, PYSNMP_MODULE_ID=ciscoAgwMIB, cagwPathEthGrePacketsReceivedRev1=cagwPathEthGrePacketsReceivedRev1, cagwUserGrpServiceMode=cagwUserGrpServiceMode, cagwEthGreReceivedDataPkts=cagwEthGreReceivedDataPkts, cagwDhcpStatisticsEntry=cagwDhcpStatisticsEntry, cagwMaxSubscribersExceededNotifThreshold=cagwMaxSubscribersExceededNotifThreshold, cagwUserGrpEthGrePacketsSent=cagwUserGrpEthGrePacketsSent, cagwPathCurrentFlows=cagwPathCurrentFlows, cagwCreatedHosts=cagwCreatedHosts, cagwCurrentFramedRouteSubs=cagwCurrentFramedRouteSubs, cagwRejectedHosts=cagwRejectedHosts, cagwCreatedBaseStations=cagwCreatedBaseStations, cagwUserGrpIpGreBytesSent=cagwUserGrpIpGreBytesSent, cagwPodSuccessNotifsSent=cagwPodSuccessNotifsSent, cagwUserGrpEthGrePacketsReceived=cagwUserGrpEthGrePacketsReceived, cagwDeletedPmipEnabledSubs=cagwDeletedPmipEnabledSubs, cagwSubscriberNotFoundDataPktsDrops=cagwSubscriberNotFoundDataPktsDrops, cagwInstanceEntry=cagwInstanceEntry, cagwChecksumErrorDataPktsDrops=cagwChecksumErrorDataPktsDrops, cagwFailedHandoff=cagwFailedHandoff, cagwImpactedReason=cagwImpactedReason, cagwRejectedSessions=cagwRejectedSessions, cagwInstanceIndex=cagwInstanceIndex, ciscoAgwMaxSubscribersExceededAbateNotif=ciscoAgwMaxSubscribersExceededAbateNotif, ciscoAgwMIBComplianceRev1=ciscoAgwMIBComplianceRev1, cagwInstanceDescription=cagwInstanceDescription, cagwMsgSent=cagwMsgSent, cagwPathPacketsSent=cagwPathPacketsSent, cagwIdleModeEntryMsBsInitiated=cagwIdleModeEntryMsBsInitiated, cagwMaxBaseStationExceededNotifSeverity=cagwMaxBaseStationExceededNotifSeverity, cagwSuccessfulSecurityKeyExchange=cagwSuccessfulSecurityKeyExchange, cagwPathRev1Entry=cagwPathRev1Entry, cagwSessionNotFoundDataPktsDrops=cagwSessionNotFoundDataPktsDrops, cagwGlobalStatisticsGroupRev2=cagwGlobalStatisticsGroupRev2, cagwCurrentSessions=cagwCurrentSessions, cagwServiceDisabledSignalingPktsDrops=cagwServiceDisabledSignalingPktsDrops, cagwDhcpStatistics=cagwDhcpStatistics, cagwIdleModeFloodPagingSuccess=cagwIdleModeFloodPagingSuccess, cagwReceivedDataPkts=cagwReceivedDataPkts, ciscoAgwMIBObjects=ciscoAgwMIBObjects, cagwSessionsDeletedByAgw=cagwSessionsDeletedByAgw, ciscoAgwMIB=ciscoAgwMIB, cagwDhcpProxyReleasePackets=cagwDhcpProxyReleasePackets, cagwAgedOutStaticHosts=cagwAgedOutStaticHosts, cagwUserGrpPodSuccessNotifsSent=cagwUserGrpPodSuccessNotifsSent, cagwDhcpDeclinePackets=cagwDhcpDeclinePackets, cagwPathBytesReceived=cagwPathBytesReceived, cagwPathCurrentSessionsRev1=cagwPathCurrentSessionsRev1, cagwDhcpProxyUnknownPackets=cagwDhcpProxyUnknownPackets, ciscoAgwMIBNotifs=ciscoAgwMIBNotifs, cagwIdleModePageAttemptsDwnlnkData=cagwIdleModePageAttemptsDwnlnkData, cagwArpPacketsDropped=cagwArpPacketsDropped, cagwProcessedSignalingPkts=cagwProcessedSignalingPkts, cagwFailedCMACKeyUpdate=cagwFailedCMACKeyUpdate, cagwInstanceGroup=cagwInstanceGroup, cagwCurrentSubscribers=cagwCurrentSubscribers, cagwUserGrpRejSession=cagwUserGrpRejSession, cagwEncapErrorSignalingPktsDrops=cagwEncapErrorSignalingPktsDrops, ciscoAgwMIBGroups=ciscoAgwMIBGroups, cagwUserGrpEntry=cagwUserGrpEntry, cagwUserGrpOverwritten=cagwUserGrpOverwritten, cagwGlobalStatisticsGroup=cagwGlobalStatisticsGroup, cagwDhcpOfferPackets=cagwDhcpOfferPackets, cagwAbsentKeyDataPktsDrops=cagwAbsentKeyDataPktsDrops, cagwUserGrpGroupRev1=cagwUserGrpGroupRev1, cagwIdleModeLocUpdtPeriodic=cagwIdleModeLocUpdtPeriodic, cagwNotifMgmt=cagwNotifMgmt, cagwCreatedFlows=cagwCreatedFlows, cagwPathType=cagwPathType, cagwPathCurrentSessions=cagwPathCurrentSessions, cagwDhcpStatisticsGroup=cagwDhcpStatisticsGroup, cagwUserGrpPacketsReceived=cagwUserGrpPacketsReceived, cagwPathCurrentFlowsRev1=cagwPathCurrentFlowsRev1)
mibBuilder.exportSymbols("CISCO-ASN-GATEWAY-MIB", cagwIgnoredNotifs=cagwIgnoredNotifs, cagwCurrentBaseStations=cagwCurrentBaseStations, cagwFlowNotFoundDataPktsDrops=cagwFlowNotFoundDataPktsDrops, cagwIdleModeDirectedPagingSuccess=cagwIdleModeDirectedPagingSuccess, cagwPktsDropPmipStaticIpHost=cagwPktsDropPmipStaticIpHost, cagwInstanceOperState=cagwInstanceOperState, cagwMaximumBaseStations=cagwMaximumBaseStations, cagwDhcpProxyRequestPackets=cagwDhcpProxyRequestPackets, cagwPendingSignalingPkts=cagwPendingSignalingPkts, cagwCreatedSessions=cagwCreatedSessions, cagwMaximumSubscribers=cagwMaximumSubscribers, cagwUserGrpGroup=cagwUserGrpGroup, cagwServiceNotifSeverity=cagwServiceNotifSeverity, cagwPktsDroppedMulticastBroadcast=cagwPktsDroppedMulticastBroadcast, cagwUserGrpEthGreBytesSent=cagwUserGrpEthGreBytesSent, cagwIngressFilteringDataPktsDrops=cagwIngressFilteringDataPktsDrops, cagwReceivedDataBytes=cagwReceivedDataBytes, cagwDhcpReleasePackets=cagwDhcpReleasePackets, cagwUserGrpCurrentFlows=cagwUserGrpCurrentFlows, cagwDhcpProxyAckPackets=cagwDhcpProxyAckPackets, cagwUserGrpPacketsSent=cagwUserGrpPacketsSent, cagwCurrentFlows=cagwCurrentFlows, cagwMessageStatisticsGroup=cagwMessageStatisticsGroup, cagwUserGrpIpGreBytesReceived=cagwUserGrpIpGreBytesReceived, ciscoAgwServiceUpNotif=ciscoAgwServiceUpNotif, cagwArpStatisticsGroup=cagwArpStatisticsGroup, cagwNotifSeverityLevel=cagwNotifSeverityLevel, cagwRequeuedSignalingPkts=cagwRequeuedSignalingPkts, cagwSentDataBytes=cagwSentDataBytes, cagwPathGroup=cagwPathGroup, cagwArpStatisticsEntry=cagwArpStatisticsEntry, ciscoAgwMIBComplianceRev2=ciscoAgwMIBComplianceRev2, cagwClassifierProfileNotFound=cagwClassifierProfileNotFound, cagwPathEntry=cagwPathEntry, cagwInvalidAddressDataPktsDrops=cagwInvalidAddressDataPktsDrops, cagwUserGrpCurrentSessions=cagwUserGrpCurrentSessions, cagwDhcpInformPackets=cagwDhcpInformPackets, cagwDeletedBaseStations=cagwDeletedBaseStations, cagwMsgType=cagwMsgType, cagwFailedSecurityKeyExchange=cagwFailedSecurityKeyExchange, cagwDhcpProxyNakPackets=cagwDhcpProxyNakPackets, cagwUserGrpTable=cagwUserGrpTable, cagwServiceNotReadySignalingPktsDrops=cagwServiceNotReadySignalingPktsDrops, cagwIgnoredMaxBsNotifs=cagwIgnoredMaxBsNotifs, cagwGlobalStatistics=cagwGlobalStatistics, cagwServiceDisabledDataPktsDrops=cagwServiceDisabledDataPktsDrops, cagwQosProfileNotFound=cagwQosProfileNotFound, cagwHotlineUplinkPktDropAclDeny=cagwHotlineUplinkPktDropAclDeny, cagwImpactedIp=cagwImpactedIp)
