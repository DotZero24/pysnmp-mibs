...
mibBuilder.exportSymbols("CTRON-SFPS-PORT-MIB", sfpsInPortStatsOperTime=sfpsInPortStatsOperTime, sfpsPortAttributeAPIVerb=sfpsPortAttributeAPIVerb, sfpsInPortConfigEntry=sfpsInPortConfigEntry, HexInteger=HexInteger, sfpsInPortConfigTable=sfpsInPortConfigTable, sfpsInPortStatsBytes=sfpsInPortStatsBytes, sfpsOutPortStatsQOverflows=sfpsOutPortStatsQOverflows, sfpsInPortConfigSlotNumber=sfpsInPortConfigSlotNumber, sfpsOutPortStatsLinkUps=sfpsOutPortStatsLinkUps, sfpsOutPortStatsDiscardPkts=sfpsOutPortStatsDiscardPkts, sfpsInPortConfigQoS=sfpsInPortConfigQoS, sfpsInPortConfigQLen=sfpsInPortConfigQLen, sfpsInPortConfigLayer3Learning=sfpsInPortConfigLayer3Learning, sfpsInPortConfigReservedBW=sfpsInPortConfigReservedBW, sfpsPortAttributeAPIAttribute=sfpsPortAttributeAPIAttribute, sfpsInPortStatsLinkDowns=sfpsInPortStatsLinkDowns, sfpsInPortStatsDiscardPkts=sfpsInPortStatsDiscardPkts, sfpsInPortConfigSwitchId=sfpsInPortConfigSwitchId, sfpsOutPortConfigLinkStatus=sfpsOutPortConfigLinkStatus, sfpsOutPortStatsPort=sfpsOutPortStatsPort, sfpsPortAttributeLearnSelfArp=sfpsPortAttributeLearnSelfArp, sfpsOutPortStatsTable=sfpsOutPortStatsTable, sfpsPortAttributePort=sfpsPortAttributePort, sfpsInPortStatsAdminStatus=sfpsInPortStatsAdminStatus, sfpsInPortStatsReset=sfpsInPortStatsReset, sfpsOutPortConfigType=sfpsOutPortConfigType, sfpsOutPortConfigLinkStateAge=sfpsOutPortConfigLinkStateAge, sfpsInPortStatsEntry=sfpsInPortStatsEntry, sfpsInPortConfigQSize=sfpsInPortConfigQSize, sfpsOutPortStatsLinkDowns=sfpsOutPortStatsLinkDowns, sfpsInPortConfigLinkStateAge=sfpsInPortConfigLinkStateAge, sfpsInPortConfigPort=sfpsInPortConfigPort, sfpsOutPortConfigOperStatus=sfpsOutPortConfigOperStatus, sfpsOutPortConfigQSize=sfpsOutPortConfigQSize, sfpsInPortStatsLinkUps=sfpsInPortStatsLinkUps, sfpsOutPortStatsEntry=sfpsOutPortStatsEntry, sfpsInPortConfigMediaType=sfpsInPortConfigMediaType, sfpsInPortStatsTable=sfpsInPortStatsTable, sfpsOutPortConfigPort=sfpsOutPortConfigPort, sfpsOutPortConfigAllocBW=sfpsOutPortConfigAllocBW, sfpsOutPortStatsPkts=sfpsOutPortStatsPkts, sfpsOutPortConfigEntry=sfpsOutPortConfigEntry, sfpsOutPortStatsOperTime=sfpsOutPortStatsOperTime, sfpsOutPortConfigSwitchId=sfpsOutPortConfigSwitchId, sfpsInPortConfigOperStatus=sfpsInPortConfigOperStatus, sfpsInPortStatsQOverflows=sfpsInPortStatsQOverflows, sfpsOutPortConfigMib2PortId=sfpsOutPortConfigMib2PortId, sfpsOutPortConfigQLen=sfpsOutPortConfigQLen, sfpsInPortStatsPort=sfpsInPortStatsPort, sfpsOutPortConfigAdminStatus=sfpsOutPortConfigAdminStatus, sfpsPortAttributeAttributes=sfpsPortAttributeAttributes, sfpsInPortConfigTopoAgent=sfpsInPortConfigTopoAgent, sfpsPortAttributeAPIPort=sfpsPortAttributeAPIPort, sfpsInPortStatsPkts=sfpsInPortStatsPkts, sfpsOutPortStatsDiscardBytes=sfpsOutPortStatsDiscardBytes, sfpsInPortConfigMib2PortId=sfpsInPortConfigMib2PortId, sfpsInPortConfigRouterPort=sfpsInPortConfigRouterPort, sfpsInPortConfigFrontPanelPort=sfpsInPortConfigFrontPanelPort, SfpsSwitchPort=SfpsSwitchPort, sfpsInPortConfigAllocBW=sfpsInPortConfigAllocBW, sfpsOutPortConfigTable=sfpsOutPortConfigTable, sfpsInPortConfigOperTime=sfpsInPortConfigOperTime, sfpsOutPortConfigOperTime=sfpsOutPortConfigOperTime, sfpsOutPortConfigFrontPanelPort=sfpsOutPortConfigFrontPanelPort, sfpsInPortConfigType=sfpsInPortConfigType, sfpsInPortConfigLinkStatus=sfpsInPortConfigLinkStatus, sfpsOutPortConfigRouterPort=sfpsOutPortConfigRouterPort, sfpsOutPortConfigSlotNumber=sfpsOutPortConfigSlotNumber, sfpsOutPortStatsReset=sfpsOutPortStatsReset, sfpsOutPortStatsBytes=sfpsOutPortStatsBytes, sfpsInPortConfigAdminStatus=sfpsInPortConfigAdminStatus, sfpsInPortStatsDiscardBytes=sfpsInPortStatsDiscardBytes, sfpsOutPortConfigReservedBW=sfpsOutPortConfigReservedBW, sfpsOutPortConfigMediaType=sfpsOutPortConfigMediaType, sfpsOutPortStatsAdminStatus=sfpsOutPortStatsAdminStatus, sfpsOutPortConfigQoS=sfpsOutPortConfigQoS)
