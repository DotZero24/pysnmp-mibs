...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/ciscosb/CISCOSB-UDLD-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:56:25 2025
...
mibBuilder.exportSymbols("CISCOSB-UDLD-MIB", rlUdldNeighborTable=rlUdldNeighborTable, rlUdldNeighborDeviceName=rlUdldNeighborDeviceName, rlUdldNeighborEntry=rlUdldNeighborEntry, rlUdldNeighborCurrentState=rlUdldNeighborCurrentState, rlUdld=rlUdld, rlUdldNeighborLeftLifeTime=rlUdldNeighborLeftLifeTime, PYSNMP_MODULE_ID=rlUdld, UdldPortMode=UdldPortMode, rlUdldNeighborDeviceMACAddress=rlUdldNeighborDeviceMACAddress, rlUdldPortEntry=rlUdldPortEntry, rlUdldGlobalUDLDMode=rlUdldGlobalUDLDMode, UdldPortBidirectionalState=UdldPortBidirectionalState, rlUdldGlobalMessageTime=rlUdldGlobalMessageTime, UdldNeighborCurrentState=UdldNeighborCurrentState, rlUdldNeighborMessageTime=rlUdldNeighborMessageTime, rlUdldNeighborPortIfIndex=rlUdldNeighborPortIfIndex, UdldGlobalMode=UdldGlobalMode, rlUdldNeighborPortID=rlUdldNeighborPortID, rlUdldPortTable=rlUdldPortTable, rlUdldPortDefaultConfiguration=rlUdldPortDefaultConfiguration, rlUdldPortAdminMode=rlUdldPortAdminMode, rlUdldBidirectionalState=rlUdldBidirectionalState, rlUdldPortOperMode=rlUdldPortOperMode, rlUdldNumberOfDetectedNeighbors=rlUdldNumberOfDetectedNeighbors, UdldString=UdldString, rlUdldNeighborDeviceID=rlUdldNeighborDeviceID, rlUdldPortIfIndex=rlUdldPortIfIndex)
