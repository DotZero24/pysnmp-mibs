...
mibBuilder.exportSymbols("DGS3000-28SC-LED-MIB", swLedInfoFrontPanelLedStatus=swLedInfoFrontPanelLedStatus, swLedMIBObject=swLedMIBObject, swLedMIB=swLedMIB, swLedInfoTable=swLedInfoTable, PYSNMP_MODULE_ID=swLedMIB, swLedInfoEntry=swLedInfoEntry, swLedInfoUnitId=swLedInfoUnitId)
