...
mibBuilder.exportSymbols("USERGROUP-MIB", hmUserGroupMemberEntry=hmUserGroupMemberEntry, hmPortSecAllowedUserID=hmPortSecAllowedUserID, hmUserGroupTable=hmUserGroupTable, hmPortSecAutoReconfigure=hmPortSecAutoReconfigure, hmPortSecPortID=hmPortSecPortID, hmUserGroupRestricted=hmUserGroupRestricted, hmPortSecMAExtendedIndex=hmPortSecMAExtendedIndex, hmUserGroupEntry=hmUserGroupEntry, hmPortSecAllowedGroupIDs=hmPortSecAllowedGroupIDs, hmPortSecConfigErrorTrap=hmPortSecConfigErrorTrap, hmUserGroupMemberUserID=hmUserGroupMemberUserID, hmPortSecAllowedUserIPID=hmPortSecAllowedUserIPID, hmUserTable=hmUserTable, hmUserGroupID=hmUserGroupID, hmUserGroupMemberTable=hmUserGroupMemberTable, hmPortSecurityTable=hmPortSecurityTable, hmPortSecDynamicCount=hmPortSecDynamicCount, hmUserID=hmUserID, hmPortSecMAPortID=hmPortSecMAPortID, PYSNMP_MODULE_ID=hmUserGroup, hmPortSecExtendedGroup=hmPortSecExtendedGroup, hmPortSecPermission=hmPortSecPermission, hmPortSecExtSlotID=hmPortSecExtSlotID, hmPortSecExtendedTable=hmPortSecExtendedTable, hmUserEntry=hmUserEntry, hmPortSecMAAllowedUserIPIDs=hmPortSecMAAllowedUserIPIDs, hmUserGroup=hmUserGroup, hmUserGroupPortSecurityMode=hmUserGroupPortSecurityMode, hmPortSecExtPortStatus=hmPortSecExtPortStatus, hmPortSecExtPortID=hmPortSecExtPortID, hmUserRestricted=hmUserRestricted, hmUserGroupMemberGroupID=hmUserGroupMemberGroupID, hmUserGroupSecurityAction=hmUserGroupSecurityAction, hmPortSecurityTrap=hmPortSecurityTrap, hmPortSecAction=hmPortSecAction, hmPortSecMultipleAdressesTable=hmPortSecMultipleAdressesTable, hmUserGroupSecAction=hmUserGroupSecAction, hmPortSecPortStatus=hmPortSecPortStatus, hmPortSecExtendedEntry=hmPortSecExtendedEntry, hmPortSecMultipleAdressesEntry=hmPortSecMultipleAdressesEntry, MemberID=MemberID, hmPortSecMAAllowedUserIDs=hmPortSecMAAllowedUserIDs, hmUserGroupDescription=hmUserGroupDescription, hmUserGroupEvent=hmUserGroupEvent, hmNewUserTrap=hmNewUserTrap, hmPortSecConnectedUserID=hmPortSecConnectedUserID, hmPortSecMASlotID=hmPortSecMASlotID, hmPortSecMAAllowedUserIDMask=hmPortSecMAAllowedUserIDMask, hmPortSecSlotID=hmPortSecSlotID, hmPortSecDynamicLimit=hmPortSecDynamicLimit, hmPortSecurityEntry=hmPortSecurityEntry, hmPortSecExtAction=hmPortSecExtAction)
