...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-STACK-MIB
...
ifIndex, OwnerString, ifName = mibBuilder.importSymbols("IF-MIB", "ifIndex", "OwnerString", "ifName")
...
mibBuilder.exportSymbols("CISCO-STACK-MIB", vlanTrunkMappingGroup=vlanTrunkMappingGroup, wsc5509sysID=wsc5509sysID, wsc6504esysID=wsc6504esysID, sysEnableRedirects=sysEnableRedirects, brouterEnableSpantree=brouterEnableSpantree, voiceGrp=voiceGrp, mcastGroup1=mcastGroup1, traceRouteQueryPacketCount=traceRouteQueryPacketCount, tokenRingDripAdvertsTransmitted=tokenRingDripAdvertsTransmitted, portAdditionalOperStatus=portAdditionalOperStatus, optionalSystemMiscGroup2=optionalSystemMiscGroup2, voicePortIfDnsDomain=voicePortIfDnsDomain, portCpbTable=portCpbTable, portType=portType, cisco7606sysID=cisco7606sysID, sysClearPortTime=sysClearPortTime, mcastGroup=mcastGroup, wsc2980gasysID=wsc2980gasysID, voicePortIndex=voicePortIndex, sysFddiRingEntry=sysFddiRingEntry, vlanPortModule=vlanPortModule, filterGroup2=filterGroup2, ipPermitDeniedListTable=ipPermitDeniedListTable, vlanGrp=vlanGrp, sysEnableStpxTrap=sysEnableStpxTrap, monitorSourcePort=monitorSourcePort, sysTrafficMeterTable=sysTrafficMeterTable, cisco7603sysID=cisco7603sysID, portAdditionalStatus=portAdditionalStatus, chassisMinorAlarm=chassisMinorAlarm, ciscoStackMIBGroups=ciscoStackMIBGroups, syslogGroup=syslogGroup, tokenRingPortSoftErrResetCounters=tokenRingPortSoftErrResetCounters, chassisGroup=chassisGroup, portAdminTxFlowControl=portAdminTxFlowControl, moduleHwHiVersion=moduleHwHiVersion, brouterPortNetMask=brouterPortNetMask, ipPermitDeniedListEntry=ipPermitDeniedListEntry, portGroup=portGroup, optionalPortGroup1=optionalPortGroup1, vlanPortAuxiliaryVlan=vlanPortAuxiliaryVlan, wsc6509nebasysID=wsc6509nebasysID, chassisComponentSerialNumber=chassisComponentSerialNumber, brouterEnableIpFragmentation=brouterEnableIpFragmentation, sysConfigChangeTrap=sysConfigChangeTrap, portSecurityGroup1=portSecurityGroup1, wsc5505sysID=wsc5505sysID, tokenRingDripLocalNodeID=tokenRingDripLocalNodeID, moduleSubType2=moduleSubType2, portCpbVlanMembership=portCpbVlanMembership, mcastRouterPortIndex=mcastRouterPortIndex, systemMiscGroup1=systemMiscGroup1, wsc1900sysID=wsc1900sysID, portSecurityPortIndex=portSecurityPortIndex, systemFddiGroup=systemFddiGroup, mcastEnableCgmp=mcastEnableCgmp, wsc4006sysID=wsc4006sysID, fileCopySrcFileName=fileCopySrcFileName, portTopNTable=portTopNTable, sysFddiRingTable=sysFddiRingTable, chassisPs3Type=chassisPs3Type, sysConfigRegister=sysConfigRegister, vlanSpantreeEnable=vlanSpantreeEnable, chassisTempAlarm=chassisTempAlarm, ntpAuthenticationTable=ntpAuthenticationTable, portCpbIgmpFilter=portCpbIgmpFilter, brouterEnableRip=brouterEnableRip, wsc1900csysID=wsc1900csysID, moduleFwVersion=moduleFwVersion, portMacControlPauseReceiveFrames=portMacControlPauseReceiveFrames, tokenRingPortSoftErrEnable=tokenRingPortSoftErrEnable, radiusServerType=radiusServerType, tacacsDirectedRequest=tacacsDirectedRequest, optionalModuleGroup=optionalModuleGroup, filterMacPort=filterMacPort, filterPortTable=filterPortTable, brouterCamAgingTime=brouterCamAgingTime, voicePortCallManagerEntry=voicePortCallManagerEntry, sysFddiRingAddress=sysFddiRingAddress, portChannelNeighbourPortId=portChannelNeighbourPortId, moduleGrp=moduleGrp, moduleIPAddress=moduleIPAddress, sysExtendedRmonNetflowModuleMask=sysExtendedRmonNetflowModuleMask, tacacsTimeout=tacacsTimeout, VendorIdType=VendorIdType, moduleSubType=moduleSubType, portInlinePowerDetect=portInlinePowerDetect, filterTestModule=filterTestModule, tokenRingPortEntry=tokenRingPortEntry, wsc1000sysID=wsc1000sysID, filterMacAddress=filterMacAddress, tokenRingPortSoftErrReportInterval=tokenRingPortSoftErrReportInterval, ntpServerEntry=ntpServerEntry, traceRouteDataGatewayIp=traceRouteDataGatewayIp, ipPermitGroup3=ipPermitGroup3, tokenRingPortSoftErrLastCounterReset=tokenRingPortSoftErrLastCounterReset, tacacsServerType=tacacsServerType, portDuplex=portDuplex, portCpbSpan=portCpbSpan, filterGroup=filterGroup, sysAttachType=sysAttachType, traceRouteQueryPacketSize=traceRouteQueryPacketSize, sysEnableIpPermitTraps=sysEnableIpPermitTraps, portSecurityExtTable=portSecurityExtTable, sysCommunityEntry=sysCommunityEntry, vlanTrunkMappingMax=vlanTrunkMappingMax, portTopNControlIndex=portTopNControlIndex, brouterPortBroadcast=brouterPortBroadcast, voicePortIfDHCPEnabled=voicePortIfDHCPEnabled, portCpbGroup4=portCpbGroup4, sysBroadcast=sysBroadcast, radiusDeadtime=radiusDeadtime, traceRouteMaxQueries=traceRouteMaxQueries, chassisPs2Type=chassisPs2Type, portOperStatus=portOperStatus, portCpbDot1x=portCpbDot1x, traceRouteDataHopCount=traceRouteDataHopCount, filterVendorModule=filterVendorModule, portTopNUtilization=portTopNUtilization, sysConfigSupervisorModuleNo=sysConfigSupervisorModuleNo, sysConfigChangeTime=sysConfigChangeTime, moduleFwHiVersion=moduleFwHiVersion, sysStartupConfigSourceFile=sysStartupConfigSourceFile, chassisComponentIndex=chassisComponentIndex, voicePortIfOperDnsDomain=voicePortIfOperDnsDomain, portJumboFrameEntry=portJumboFrameEntry, deprecatedObjectGroup=deprecatedObjectGroup, filterPortBroadcastThrottle=filterPortBroadcastThrottle, ciscoStackgMIBCompliance=ciscoStackgMIBCompliance, configWriteMem=configWriteMem, ntpClient=ntpClient, vlanPortIslPriorityVlans=vlanPortIslPriorityVlans, portChannelAdminStatus=portChannelAdminStatus, traceRouteQueryTable=traceRouteQueryTable, voiceGroup=voiceGroup, filterTestType=filterTestType, portJumboFrameGroup=portJumboFrameGroup, multicastGrp=multicastGrp, syslogServerType=syslogServerType, ntpTimezoneOffsetHour=ntpTimezoneOffsetHour, mcastRouterOperStatus=mcastRouterOperStatus, portCpbSpeed=portCpbSpeed, ntpServerPublicKey=ntpServerPublicKey, filterPortEntry=filterPortEntry, ciscoStackNotificationsPrefix=ciscoStackNotificationsPrefix, sysEnableModem=sysEnableModem, wsc3920sysID=wsc3920sysID, vlanPortIslOperStatus=vlanPortIslOperStatus, wsc4912gsysID=wsc4912gsysID, brouterEthernetReceiveMax=brouterEthernetReceiveMax, traceRouteQueryIndex=traceRouteQueryIndex, vlanGroup1=vlanGroup1, chassisFanStatus=chassisFanStatus, portCpbDuplex=portCpbDuplex, systemTrapGroup2=systemTrapGroup2, traceRouteDataEntry=traceRouteDataEntry, brouterGrp=brouterGrp, sysTrafficMonitorHighWaterMark=sysTrafficMonitorHighWaterMark, filterProtocolType=filterProtocolType, monitorAdminSourcePorts=monitorAdminSourcePorts, wsc5500sysID=wsc5500sysID, mdgGatewayGroup=mdgGatewayGroup, tacacsServerEntry=tacacsServerEntry, portEntry=portEntry, moduleGroup1=moduleGroup1, systemRmonGroup=systemRmonGroup, radiusServerTable=radiusServerTable, cisco7613sysID=cisco7613sysID, moduleEntPhysicalIndex=moduleEntPhysicalIndex, vlanPort=vlanPort, tokenRingSoftErrExceededTrap=tokenRingSoftErrExceededTrap, chassisAlarmOff=chassisAlarmOff, filterTestOffset=filterTestOffset, tokenRingDripOwnerNodeID=tokenRingDripOwnerNodeID, voicePortIfConfigTable=voicePortIfConfigTable, sshPublicKeySize=sshPublicKeySize, portSecuritySecureSrcAddr=portSecuritySecureSrcAddr, portCpbChannel=portCpbChannel, sysExtendedRmonNetflowPassword=sysExtendedRmonNetflowPassword, ciscoStackgMIBCompliance3=ciscoStackgMIBCompliance3, filterGrp=filterGrp, sysHighAvailabilityVersioningEnable=sysHighAvailabilityVersioningEnable, vlanTrunkMappingFromVlan=vlanTrunkMappingFromVlan, syslogConsoleEnable=syslogConsoleEnable, tokenRingDripAdvertsReceived=tokenRingDripAdvertsReceived, ciscoStackMIB=ciscoStackMIB, wsc2948ggetxsysID=wsc2948ggetxsysID, moduleHwVersion=moduleHwVersion, ciscoStackgMIBCompliance8=ciscoStackgMIBCompliance8, moduleHwLoVersion=moduleHwLoVersion, wsc6knamsysID=wsc6knamsysID, filterPortBroadcastThreshold=filterPortBroadcastThreshold, fileCopyResult=fileCopyResult, traceRouteDataErrors=traceRouteDataErrors, adapterCard=adapterCard, chassisPs1Type=chassisPs1Type, voicePortIfTftpServerAddress=voicePortIfTftpServerAddress, wsc3100sysID=wsc3100sysID, portTopNInErrors=portTopNInErrors, ciscoStackgMIBCompliance6=ciscoStackgMIBCompliance6, sysTrafficMeter=sysTrafficMeter, sysErrDisableTimeoutEnable=sysErrDisableTimeoutEnable, radiusLoginAuthentication=radiusLoginAuthentication, optionalSystemMiscGroup5=optionalSystemMiscGroup5, sysBannerMotd=sysBannerMotd, cpw1220isysID=cpw1220isysID, systemMiscGroup=systemMiscGroup, cpw1220csysID=cpw1220csysID, portTopNEntry=portTopNEntry, portIndex=portIndex, chassisSlotConfig=chassisSlotConfig, portSecurityTable=portSecurityTable, tokenRingModuleIndex=tokenRingModuleIndex, portChannelTable=portChannelTable, ipPermitSshConnectLimit=ipPermitSshConnectLimit, filterProtocolModule=filterProtocolModule, ipPermitDeniedTrap=ipPermitDeniedTrap, ipPermitListGrp=ipPermitListGrp, vlanIfIndex=vlanIfIndex, ntpGrp=ntpGrp, wsc1400sysID=wsc1400sysID, voicePortIfConfigModuleIndex=voicePortIfConfigModuleIndex, wsc2948gsysID=wsc2948gsysID, voicePortCallManagerIpAddr=voicePortCallManagerIpAddr, portCpbGroup1=portCpbGroup1, tokenRingPortIndex=tokenRingPortIndex, portGroup4=portGroup4, cpw1601sysID=cpw1601sysID, esStack=esStack, ipPermitGroup1=ipPermitGroup1, sysTelnetPrimaryLoginAuthentication=sysTelnetPrimaryLoginAuthentication, tftpModule=tftpModule, wsc5000sysID=wsc5000sysID, cisco7609sysID=cisco7609sysID, portSecurityAdminStatus=portSecurityAdminStatus, wsc2900sysID=wsc2900sysID, moduleEntry=moduleEntry, sysCommunityAccess=sysCommunityAccess, filterVendorTable=filterVendorTable, sysStandbyPortEnable=sysStandbyPortEnable, filterPortComplex=filterPortComplex, vlanGroup=vlanGroup, sysPortFastBpduGuard=sysPortFastBpduGuard, wsc1900isysID=wsc1900isysID, filterPortBroadcastThresholdFraction=filterPortBroadcastThresholdFraction, chassisFanTestResult=chassisFanTestResult, moduleSerialNumberString=moduleSerialNumberString, systemTrapGroup1=systemTrapGroup1, portOperTxFlowControl=portOperTxFlowControl, sysEnableEntityTrap=sysEnableEntityTrap, wsc6006sysID=wsc6006sysID, vlanTrunkMappingToVlan=vlanTrunkMappingToVlan, ntpSummerTimezoneName=ntpSummerTimezoneName, traceRouteDataIndex=traceRouteDataIndex)
mibBuilder.exportSymbols("CISCO-STACK-MIB", tokenRingDripOutputQueueDrops=tokenRingDripOutputQueueDrops, fileCopyResultRcpErrorMessage=fileCopyResultRcpErrorMessage, moduleTable=moduleTable, sysCommunityString=sysCommunityString, wsc6506sysID=wsc6506sysID, portSecurityEntry=portSecurityEntry, sysHighAvailabilityNotRunningReason=sysHighAvailabilityNotRunningReason, wsc3001sysID=wsc3001sysID, wsc3900sysID=wsc3900sysID, tokenRingPortMode=tokenRingPortMode, portTopNRateBase=portTopNRateBase, systemTrapGroup=systemTrapGroup, tokenRingDripInputQueueDrops=tokenRingDripInputQueueDrops, brouterEnableGiantCheck=brouterEnableGiantCheck, tokenRingDripVlan=tokenRingDripVlan, dnsEnable=dnsEnable, ntpServerType=ntpServerType, filterPortModule=filterPortModule, sysTrafficPeak=sysTrafficPeak, brouterPortIpHelpers=brouterPortIpHelpers, sysCommunityRw=sysCommunityRw, portSecurityExtControlStatus=portSecurityExtControlStatus, filterTestValue=filterTestValue, portChannelIfIndex=portChannelIfIndex, voicePortModuleIndex=voicePortModuleIndex, ipPermitEnable=ipPermitEnable, chassisPs1TestResult=chassisPs1TestResult, chassisNumSlots=chassisNumSlots, chassisComponentEntry=chassisComponentEntry, tacacsLoginAuthentication=tacacsLoginAuthentication, syslogTelnetEnable=syslogTelnetEnable, wsc1100sysID=wsc1100sysID, portJumboFrameGrp=portJumboFrameGrp, filterProtocolValue=filterProtocolValue, portCpbGrp=portCpbGrp, portChannelProtInPackets=portChannelProtInPackets, securityGrp=securityGrp, ipPermitTelnetConnectLimit=ipPermitTelnetConnectLimit, radiusTimeout=radiusTimeout, chassisComponentTable=chassisComponentTable, portCpbModuleIndex=portCpbModuleIndex, vmpsAccessed=vmpsAccessed, filterGroup1=filterGroup1, brouterEthernetTransmitMax=brouterEthernetTransmitMax, filterTestPort=filterTestPort, portSecurityExtSecureSrcAddr=portSecurityExtSecureSrcAddr, authenticationGroup1=authenticationGroup1, sysEnableConfigTraps=sysEnableConfigTraps, mdgGrp=mdgGrp, tftpHost=tftpHost, mdgGatewayTable=mdgGatewayTable, ntpAuthenticationGroup=ntpAuthenticationGroup, portTopNOwner=portTopNOwner, portChannelPortIndex=portChannelPortIndex, wsc6509nebsysID=wsc6509nebsysID, voicePortOperDnsServerSource=voicePortOperDnsServerSource, filterMacModule=filterMacModule, syslogMessageControlEntry=syslogMessageControlEntry, moduleType=moduleType, tokenRingPortSetACbits=tokenRingPortSetACbits, monitorGroup=monitorGroup, cpw1600sysID=cpw1600sysID, wsc5002sysID=wsc5002sysID, dnsServerEntry=dnsServerEntry, tsStack=tsStack, portCpbFlowControl=portCpbFlowControl, ipPermitAccessTypeEnable=ipPermitAccessTypeEnable, wsc1900LiteFxsysID=wsc1900LiteFxsysID, vlanPortTable=vlanPortTable, chassisMajorAlarm=chassisMajorAlarm, tokenRingDripLocalVlanStatusTable=tokenRingDripLocalVlanStatusTable, tokenRingDripRemotePortStatus=tokenRingDripRemotePortStatus, sysIpAddr=sysIpAddr, portTopNControlEntry=portTopNControlEntry, portTopNIOOctets=portTopNIOOctets, moduleGroup2=moduleGroup2, filterPortBroadcastDiscards=filterPortBroadcastDiscards, vlanTrunkMappingOper=vlanTrunkMappingOper, monitorDestinationPort=monitorDestinationPort, mdgGatewayEntry=mdgGatewayEntry, moduleIndex=moduleIndex, fileCopyRuntimeConfigPart=fileCopyRuntimeConfigPart, portCpbAuxiliaryVlan=portCpbAuxiliaryVlan, radiusAuthKey=radiusAuthKey, voicePortDnsModuleIndex=voicePortDnsModuleIndex, cpw2200sysID=cpw2200sysID, tftpGrp=tftpGrp, voicePortIfGatewayAddress=voicePortIfGatewayAddress, portTopNBufferOverFlow=portTopNBufferOverFlow, portCpbInlinePower=portCpbInlinePower, wsc4003sysID=wsc4003sysID, sysEnableChassisTraps=sysEnableChassisTraps, chassisSerialNumberString=chassisSerialNumberString, mcastRouterAdminStatus=mcastRouterAdminStatus, dnsGrp=dnsGrp, dnsServerAddr=dnsServerAddr, mcastRouterEntry=mcastRouterEntry, sysEnableBridgeTraps=sysEnableBridgeTraps, wsc4503sysID=wsc4503sysID, sysExtendedRmonNetflowEnable=sysExtendedRmonNetflowEnable, portChannelOperStatus=portChannelOperStatus, traceRouteQueryDNSEnable=traceRouteQueryDNSEnable, tokenRingPortSoftErrTable=tokenRingPortSoftErrTable, optionalPortGroup=optionalPortGroup, sysIpVlan=sysIpVlan, ipPermitMask=ipPermitMask, portTopNGrantedSize=portTopNGrantedSize, vmpsGroup=vmpsGroup, fileCopyGroup=fileCopyGroup, chassisPs3Status=chassisPs3Status, portTable=portTable, portTopNTimeRemaining=portTopNTimeRemaining, sysStatus=sysStatus, traceRouteDataGatewayName=traceRouteDataGatewayName, portTopNDuration=portTopNDuration, sysFddiRingNext=sysFddiRingNext, chassisSerialNumber=chassisSerialNumber, tftpResult=tftpResult, portTopNIndex=portTopNIndex, fileCopyGrp=fileCopyGrp, moduleModel=moduleModel, syslogTimeStampOption=syslogTimeStampOption, sysStartupConfigSource=sysStartupConfigSource, dcd=dcd, portMacControlTransmitFrames=portMacControlTransmitFrames, portSecurityAgingTime=portSecurityAgingTime, moduleStatus=moduleStatus, traceRouteQueryEntry=traceRouteQueryEntry, configWriteMemStatus=configWriteMemStatus, fileCopyProtocol=fileCopyProtocol, sysNetMask=sysNetMask, vlanIndex=vlanIndex, voicePortCallManagerIndex=voicePortCallManagerIndex, ntpAuthenticationTrustedMode=ntpAuthenticationTrustedMode, portChannelPorts=portChannelPorts, ntpServerTable=ntpServerTable, ipPermitAccessType=ipPermitAccessType, filterVendorEntry=filterVendorEntry, ipPermitType=ipPermitType, switchAccelerationGrp=switchAccelerationGrp, wsc2820sysID=wsc2820sysID, wsc6503sysID=wsc6503sysID, portSecurityShutdownTimeOut=portSecurityShutdownTimeOut, sysConsolePrimaryLoginAuthentication=sysConsolePrimaryLoginAuthentication, switchAccelerationModuleEntry=switchAccelerationModuleEntry, tokenRingPortEarlyTokenRel=tokenRingPortEarlyTokenRel, tacacsNumLoginAttempts=tacacsNumLoginAttempts, ciscoStackgMIBCompliance4=ciscoStackgMIBCompliance4, traceRouteDataTable=traceRouteDataTable, chassisModel=chassisModel, syslogGroup2=syslogGroup2, vlanPortSwitchLevel=vlanPortSwitchLevel, moduleSerialNumber=moduleSerialNumber, tokenRingPortCfgLossThresh=tokenRingPortCfgLossThresh, portCpbEntry=portCpbEntry, fileCopyUserName=fileCopyUserName, vlanTable=vlanTable, filterPortSuppressionViolation=filterPortSuppressionViolation, sysExtendedRmonVlanModeEnable=sysExtendedRmonVlanModeEnable, vlanTrunkMappingStatus=vlanTrunkMappingStatus, portCpbBroadcastSuppression=portCpbBroadcastSuppression, traceRouteGrp=traceRouteGrp, tokenRingDripLastRevision=tokenRingDripLastRevision, sysTrafficMeterType=sysTrafficMeterType, monitorDirection=monitorDirection, portGroup1=portGroup1, portTopNIOMulticast=portTopNIOMulticast, sysFddiRingSMTIndex=sysFddiRingSMTIndex, portMacControlUnknownProtocolFrames=portMacControlUnknownProtocolFrames, tokenRingDripAreReductionMode=tokenRingDripAreReductionMode, moduleSwVersion=moduleSwVersion, chassisPs2TestResult=chassisPs2TestResult, portLinkFaultStatus=portLinkFaultStatus, portCpbSecurity=portCpbSecurity, voicePortIfConfigPortIndex=voicePortIfConfigPortIndex, portSecurityViolationPolicy=portSecurityViolationPolicy, sysTrafficMeterPeakTime=sysTrafficMeterPeakTime, vlanEntry=vlanEntry, syslogMessageControlTable=syslogMessageControlTable, fileCopyGroup2=fileCopyGroup2, wsc3000sysID=wsc3000sysID, syslogHostEnable=syslogHostEnable, syslogServerAddr=syslogServerAddr, mcastEnableRgmp=mcastEnableRgmp, sysCommunityRo=sysCommunityRo, brouterEnableUnreachables=brouterEnableUnreachables, radiusServerAddr=radiusServerAddr, sysErrDisableTimeoutInterval=sysErrDisableTimeoutInterval, voicePortOperDnsServerTable=voicePortOperDnsServerTable, configTextFileLocation=configTextFileLocation, portEntPhysicalIndex=portEntPhysicalIndex, moduleGroup=moduleGroup, chassisSysType=chassisSysType, portTopNIOPkts=portTopNIOPkts, sysTrapReceiverAddr=sysTrapReceiverAddr, optionalChassisGroup=optionalChassisGroup, brouterIpx8023RawToFddi=brouterIpx8023RawToFddi, optionalSystemMiscGroup=optionalSystemMiscGroup, chassisComponentHwVersion=chassisComponentHwVersion, moduleSwHiVersion=moduleSwHiVersion, wsc6509sysID=wsc6509sysID, tacacsLocalLoginAuthentication=tacacsLocalLoginAuthentication, cpw1900sysID=cpw1900sysID, sysEnableModuleTraps=sysEnableModuleTraps, vmpsAddr=vmpsAddr, brouterEnableAPaRT=brouterEnableAPaRT, portCrossIndex=portCrossIndex, filterPortSuppressionOption=filterPortSuppressionOption, wsc1600sysID=wsc1600sysID, brouterCamMode=brouterCamMode, monitorEnable=monitorEnable, portJumboFrameEnable=portJumboFrameEnable, brouterEnableTransitEncapsulation=brouterEnableTransitEncapsulation, portJumboFrameTable=portJumboFrameTable, portChannelEntry=portChannelEntry, sysCommunityRwa=sysCommunityRwa, moduleAction=moduleAction, chassisPs2Status=chassisPs2Status, sysTrapReceiverComm=sysTrapReceiverComm, sysMacReductionAdminEnable=sysMacReductionAdminEnable, ciscoStackMIBCompliances=ciscoStackMIBCompliances, brouteEnableGroup=brouteEnableGroup, fileCopyDstFileName=fileCopyDstFileName, voicePortCallManagerTable=voicePortCallManagerTable, vlanGroup2=vlanGroup2, wsc6513sysID=wsc6513sysID, tokenRingPortCfgLossInterval=tokenRingPortCfgLossInterval, modulePortStatus=modulePortStatus, ipPermitDeniedTime=ipPermitDeniedTime, ntpGroup=ntpGroup, portCpbTosRewrite=portCpbTosRewrite, wsc3200sysID=wsc3200sysID, tokenRingDripLastChangedRevision=tokenRingDripLastChangedRevision, mdgGatewayAddr=mdgGatewayAddr, portCpbGroup2=portCpbGroup2, tokenRingDripDistributedCrf=tokenRingDripDistributedCrf, mdgGatewayType=mdgGatewayType, syslogServerTable=syslogServerTable, portSecurityLastSrcAddr=portSecurityLastSrcAddr, tokenRingDripLocalVlanStatusEntry=tokenRingDripLocalVlanStatusEntry, vlanTrunkMappingType=vlanTrunkMappingType, ipPermitDeniedAddress=ipPermitDeniedAddress, filterProtocolPort=filterProtocolPort, sysMgmtType=sysMgmtType, tacacsLocalEnableAuthentication=tacacsLocalEnableAuthentication, filterVendorType=filterVendorType, lerAlarmOff=lerAlarmOff, voicePortDnsPortIndex=voicePortDnsPortIndex, sysTrapReceiverType=sysTrapReceiverType, voicePortIfDnsServerAddress=voicePortIfDnsServerAddress, portSecurityModuleIndex=portSecurityModuleIndex, sysTrapReceiverTable=sysTrapReceiverTable, vlanTrunkMappingTable=vlanTrunkMappingTable, switchAccelerationModuleGroup=switchAccelerationModuleGroup)
mibBuilder.exportSymbols("CISCO-STACK-MIB", sysTelnetPrimaryEnableAuthentication=sysTelnetPrimaryEnableAuthentication, notificationGroup=notificationGroup, sysExtendedRmonVlanAgentEnable=sysExtendedRmonVlanAgentEnable, syslogMessageFacility=syslogMessageFacility, traceRouteQueryWaitingTime=traceRouteQueryWaitingTime, sysCommunityTable=sysCommunityTable, portTopNType=portTopNType, sysReset=sysReset, traceRouteQueryMaxTTL=traceRouteQueryMaxTTL, sysMacReductionOperEnable=sysMacReductionOperEnable, portCpbGroup5=portCpbGroup5, chassisComponentType=chassisComponentType, portModuleIndex=portModuleIndex, portMacControlReceiveFrames=portMacControlReceiveFrames, sysEnableRepeaterTraps=sysEnableRepeaterTraps, portName=portName, sysInsertMode=sysInsertMode, sysConsolePrimaryEnableAuthentication=sysConsolePrimaryEnableAuthentication, portTopNModuleNumber=portTopNModuleNumber, portTopNIOBroadcast=portTopNIOBroadcast, traceRouteQueryResult=traceRouteQueryResult, configurationGroup=configurationGroup, tokenRingPortSoftErrEntry=tokenRingPortSoftErrEntry, tokenRingGrp=tokenRingGrp, tacacsAuthKey=tacacsAuthKey, filterTestEntry=filterTestEntry, cisco7604sysID=cisco7604sysID, portChannelProtOutPackets=portChannelProtOutPackets, chassisGrp=chassisGrp, portCpbCopsGrouping=portCpbCopsGrouping, moduleIPAddressVlan=moduleIPAddressVlan, portJumboFramePortIndex=portJumboFramePortIndex, chassisGroup1=chassisGroup1, radiusRetransmits=radiusRetransmits, traceRouteQueryOwner=traceRouteQueryOwner, traceRouteQueryTime=traceRouteQueryTime, portTopNStatus=portTopNStatus, optionalSystemMiscGroup4=optionalSystemMiscGroup4, systemStatusGroup=systemStatusGroup, moduleFwLoVersion=moduleFwLoVersion, tftpAction=tftpAction, optionalSystemTrapGroup1=optionalSystemTrapGroup1, traceRouteQueryInitTTL=traceRouteQueryInitTTL, brouterFddiReceiveMax=brouterFddiReceiveMax, sysArpAgingTime=sysArpAgingTime, vlanPortOperStatus=vlanPortOperStatus, tokenRingSoftErrorMonitorGroup=tokenRingSoftErrorMonitorGroup, mcastEnableIgmp=mcastEnableIgmp, voicePortIfConfigEntry=voicePortIfConfigEntry, switchAccelerationModuleEnable=switchAccelerationModuleEnable, ntpTimezoneOffsetMinute=ntpTimezoneOffsetMinute, tokenRingDripAdvertsProcessed=tokenRingDripAdvertsProcessed, portTopNPortNumber=portTopNPortNumber, traceRouteGroup=traceRouteGroup, portSecurityExtEntry=portSecurityExtEntry, fileCopyAction=fileCopyAction, mcastRouterModuleIndex=mcastRouterModuleIndex, systemTrafficGroup=systemTrafficGroup, portGroup3=portGroup3, portChannelNeighbourDeviceId=portChannelNeighbourDeviceId, tokenRingPortSoftErrThresh=tokenRingPortSoftErrThresh, portTopNStartTime=portTopNStartTime, sysBootedImage=sysBootedImage, portSecurityExtModuleIndex=portSecurityExtModuleIndex, brouterPortModule=brouterPortModule, traceRouteHost=traceRouteHost, portJumboFrameModuleIndex=portJumboFrameModuleIndex, ntpBcastDelay=ntpBcastDelay, vmpsEntry=vmpsEntry, filterVendorId=filterVendorId, ipPermitListTable=ipPermitListTable, ipPermitListEntry=ipPermitListEntry, voicePortIfIpAddress=voicePortIfIpAddress, filterTestTable=filterTestTable, optionalChassisGroup1=optionalChassisGroup1, moduleAdditionalStatus=moduleAdditionalStatus, sysExtendedRmonEnable=sysExtendedRmonEnable, portIfIndex=portIfIndex, optionalSystemMiscGroup6=optionalSystemMiscGroup6, ipPermitDeniedAccess=ipPermitDeniedAccess, switchAccelerationModuleIndex=switchAccelerationModuleIndex, sysBootVariable=sysBootVariable, vlanPortIslAdminStatus=vlanPortIslAdminStatus, brouterPortBridgeVlan=brouterPortBridgeVlan, authenticationGroup=authenticationGroup, ntpBcastClient=ntpBcastClient, filterPort=filterPort, sysClearMacTime=sysClearMacTime, portTopNControlTable=portTopNControlTable, tftpFile=tftpFile, ciscoStackgMIBCompliance7=ciscoStackgMIBCompliance7, tokenRingPortPriorityThresh=tokenRingPortPriorityThresh, tacacsEnableAuthentication=tacacsEnableAuthentication, vlanTrunkMappingEntry=vlanTrunkMappingEntry, cpw1800sysID=cpw1800sysID, filterMacType=filterMacType, PYSNMP_MODULE_ID=ciscoStackMIB, sysTraffic=sysTraffic, portCpbTrunkEncapsulationType=portCpbTrunkEncapsulationType, radiusServerAuthPort=radiusServerAuthPort, radiusGrp=radiusGrp, moduleDown=moduleDown, fileCopyRemoteServer=fileCopyRemoteServer, vlanPortEntry=vlanPortEntry, chassisBkplType=chassisBkplType, radiusServerEntry=radiusServerEntry, sysTrafficMeterPeak=sysTrafficMeterPeak, lerAlarmOn=lerAlarmOn, portChannelModuleIndex=portChannelModuleIndex, portCpbUdld=portCpbUdld, sysTrafficPeakTime=sysTrafficPeakTime, portSecurityMaxSrcAddr=portSecurityMaxSrcAddr, ciscoStackgMIBCompliance5=ciscoStackgMIBCompliance5, ntpAuthenticationSecretKey=ntpAuthenticationSecretKey, tacacsGrp=tacacsGrp, portTopNMode=portTopNMode, portSpantreeFastStart=portSpantreeFastStart, portSecurityExtPortIndex=portSecurityExtPortIndex, cpw1420sysID=cpw1420sysID, authenticationGroup2=authenticationGroup2, moduleUp=moduleUp, syslogMessageSeverity=syslogMessageSeverity, monitorGrp=monitorGrp, brouterFddiTransmitMax=brouterFddiTransmitMax, vlanPortVlan=vlanPortVlan, wsc2980gsysID=wsc2980gsysID, brouterPortIpAddr=brouterPortIpAddr, filterTestIndex=filterTestIndex, chassisAlarmOn=chassisAlarmOn, traceRouteQueryTOS=traceRouteQueryTOS, moduleTestResult=moduleTestResult, traceRouteQueryUDPPort=traceRouteQueryUDPPort, traceRouteDataRtt=traceRouteDataRtt, configMode=configMode, ntpServerAddress=ntpServerAddress, tokenRingPortPriorityMinXmit=tokenRingPortPriorityMinXmit, vmpsType=vmpsType, portCpbPortfast=portCpbPortfast, optionalSystemMiscGroup1=optionalSystemMiscGroup1, filterGroup3=filterGroup3, vmpsAction=vmpsAction, ntpSummertimeStatus=ntpSummertimeStatus, tftpGroup=tftpGroup, ciscoStackgMIBCompliance2=ciscoStackgMIBCompliance2, tacacsServerAddr=tacacsServerAddr, tacacsServerTable=tacacsServerTable, chassisPEMInstalled=chassisPEMInstalled, portGroup2=portGroup2, moduleName=moduleName, brouterPortEntry=brouterPortEntry, portTopNReportStatus=portTopNReportStatus, sysHighAvailabilityOperStatus=sysHighAvailabilityOperStatus, tokenRingDripDistCrfMode=tokenRingDripDistCrfMode, dnsGroup=dnsGroup, ciscoStackMIBConformance=ciscoStackMIBConformance, chassisPs1Status=chassisPs1Status, chassisPs3TestResult=chassisPs3TestResult, brouterIpxSnapToEther=brouterIpxSnapToEther, voicePortOperDnsServerIpAddr=voicePortOperDnsServerIpAddr, brouterEnableFddiCheck=brouterEnableFddiCheck, portErrDisableTimeOutEnable=portErrDisableTimeOutEnable, traceRouteQueryStatus=traceRouteQueryStatus, voicePortOperDnsServerIndex=voicePortOperDnsServerIndex, moduleNumPorts=moduleNumPorts, portCpbCosRewrite=portCpbCosRewrite, sysHighAvailabilityEnable=sysHighAvailabilityEnable, sysEnableVmpsTraps=sysEnableVmpsTraps, monitorSourceModule=monitorSourceModule, wsc1200sysID=wsc1200sysID, systemGrp=systemGrp, tokenRingGroup=tokenRingGroup, brouterPort=brouterPort, portCpbTrunkMode=portCpbTrunkMode, ntpTimezoneName=ntpTimezoneName, portAdminRxFlowControl=portAdminRxFlowControl, ipPermitGroup=ipPermitGroup, filterMacEntry=filterMacEntry, portOperRxFlowControl=portOperRxFlowControl, chassisComponentModel=chassisComponentModel, moduleSwLoVersion=moduleSwLoVersion, filterProtocolTable=filterProtocolTable, vmpsTable=vmpsTable, dnsServerTable=dnsServerTable, portCrossGroupIndex=portCrossGroupIndex, brouterPortIpVlan=brouterPortIpVlan, portTopNGrp=portTopNGrp, sysTrafficMeterEntry=sysTrafficMeterEntry, voicePortIfIpNetMask=voicePortIfIpNetMask, portChannelGrp=portChannelGrp, dnsServerType=dnsServerType, tokenRingDripBackupCrf=tokenRingDripBackupCrf, brouterIpx8022ToEther=brouterIpx8022ToEther, ntpAuthenticationPublicKey=ntpAuthenticationPublicKey, tokenRingPortTable=tokenRingPortTable, sysTrapReceiverEntry=sysTrapReceiverEntry, ipPermitGroup2=ipPermitGroup2, fileCopyModuleNumber=fileCopyModuleNumber, moduleStandbyStatus=moduleStandbyStatus, filterMacTable=filterMacTable, portCpbGroup3=portCpbGroup3, portCpbPortIndex=portCpbPortIndex, monitorOperSourcePorts=monitorOperSourcePorts, systemRmonGroup2=systemRmonGroup2, sysMaxRmonMemory=sysMaxRmonMemory, vlanPortIslVlansAllowed=vlanPortIslVlansAllowed, dnsDomainName=dnsDomainName, voicePortOperDnsServerEntry=voicePortOperDnsServerEntry, configGrp=configGrp, ntpAuthenticationEnable=ntpAuthenticationEnable, monitorDestinationModule=monitorDestinationModule, wsc2926sysID=wsc2926sysID, filterTestMask=filterTestMask, wsc4506sysID=wsc4506sysID, portSecurityOperStatus=portSecurityOperStatus, moduleSlotNum=moduleSlotNum, portAdminSpeed=portAdminSpeed, portMacControlPauseTransmitFrames=portMacControlPauseTransmitFrames, switchAccelerationModuleTable=switchAccelerationModuleTable, syslogGrp=syslogGrp, vlanPortAdminStatus=vlanPortAdminStatus, mcastRouterTable=mcastRouterTable, portGrp=portGrp, optionalSystemMiscGroup3=optionalSystemMiscGroup3, tokenRingDripLocalPortStatus=tokenRingDripLocalPortStatus, sysBaudRate=sysBaudRate, brouterPortTable=brouterPortTable, filterVendorPort=filterVendorPort, ipPermitAddress=ipPermitAddress, portTopNRequestedSize=portTopNRequestedSize, cpw1220sysID=cpw1220sysID, radiusEnableAuthentication=radiusEnableAuthentication, wsc6009sysID=wsc6009sysID, filterProtocolEntry=filterProtocolEntry, tokenRingDripRemotePortConfigured=tokenRingDripRemotePortConfigured, syslogServerEntry=syslogServerEntry, optionalSystemTrapGroup=optionalSystemTrapGroup, sysEnableRmon=sysEnableRmon, sysConfigChangeInfo=sysConfigChangeInfo, ntpAuthenticationEntry=ntpAuthenticationEntry, ntpAuthenticationType=ntpAuthenticationType)
