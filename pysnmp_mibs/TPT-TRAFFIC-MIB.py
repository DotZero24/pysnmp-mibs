...
mibBuilder.exportSymbols("TPT-TRAFFIC-MIB", PYSNMP_MODULE_ID=tpt_traffic, thresholdHistMinutesEntry=thresholdHistMinutesEntry, thresholdHistSecondsGlobalID=thresholdHistSecondsGlobalID, tptThresholdNotifyZonePair=tptThresholdNotifyZonePair, interfaceHistMinutesTimestamp=interfaceHistMinutesTimestamp, interfaceHistMinutesIfIndex=interfaceHistMinutesIfIndex, rateLimitGlobalID=rateLimitGlobalID, rateLimitHistMinutesGlobalID=rateLimitHistMinutesGlobalID, thresholdHistMinutesTable=thresholdHistMinutesTable, interfaceHistSecondsUnitCountOut=interfaceHistSecondsUnitCountOut, interfaceHistSecondsEntry=interfaceHistSecondsEntry, interfaceHistHoursTable=interfaceHistHoursTable, thresholdHistMinutesIndex=thresholdHistMinutesIndex, rateLimitHistMinutesBytesSent=rateLimitHistMinutesBytesSent, tptThresholdNotifyDeviceID=tptThresholdNotifyDeviceID, thresholdHistDaysUnitCount=thresholdHistDaysUnitCount, tptThresholdNotifySignatureID=tptThresholdNotifySignatureID, rateLimitHistMinutesTable=rateLimitHistMinutesTable, rateLimitHistSecondsEntry=rateLimitHistSecondsEntry, interfaceHistMinutesUnitCountOut=interfaceHistMinutesUnitCountOut, rateLimitHistMinutesTimestamp=rateLimitHistMinutesTimestamp, rateLimitHistNumHours=rateLimitHistNumHours, interfaceHistDaysTable=interfaceHistDaysTable, thresholdHistHoursUnitCount=thresholdHistHoursUnitCount, tptThresholdNotifySegmentName=tptThresholdNotifySegmentName, interfaceHistSecondsTimestamp=interfaceHistSecondsTimestamp, interfaceHistMinutesUnitCountIn=interfaceHistMinutesUnitCountIn, rateLimitHistSecondsBytesSent=rateLimitHistSecondsBytesSent, rateLimitHistMinutesEntry=rateLimitHistMinutesEntry, tptThresholdFilterNotify=tptThresholdFilterNotify, rateLimitHistHoursTimestamp=rateLimitHistHoursTimestamp, interfaceHistDaysTimestamp=interfaceHistDaysTimestamp, thresholdHistMinutesUnitCount=thresholdHistMinutesUnitCount, thresholdHistSecondsTimestamp=thresholdHistSecondsTimestamp, tptThresholdNotifyPolicyID=tptThresholdNotifyPolicyID, thresholdHistSecondsTable=thresholdHistSecondsTable, rateLimitHistHoursTable=rateLimitHistHoursTable, thresholdHistHoursIndex=thresholdHistHoursIndex, interfaceHistMinutesEntry=interfaceHistMinutesEntry, thresholdHistDaysTable=thresholdHistDaysTable, thresholdHistMinutesTimestamp=thresholdHistMinutesTimestamp, interfaceHistHoursUnitCountOut=interfaceHistHoursUnitCountOut, rateLimitHistSecondsGlobalID=rateLimitHistSecondsGlobalID, rateLimitHistSecondsTimestamp=rateLimitHistSecondsTimestamp, thresholdEntry=thresholdEntry, rateLimitPacketsDropped=rateLimitPacketsDropped, rateLimitHistHoursGlobalID=rateLimitHistHoursGlobalID, rateLimitPacketsSent=rateLimitPacketsSent, rateLimitEntry=rateLimitEntry, rateLimitHistSecondsIndex=rateLimitHistSecondsIndex, thresholdHistDaysIndex=thresholdHistDaysIndex, interfaceHistSecondsUnitCountIn=interfaceHistSecondsUnitCountIn, thresholdUnits=thresholdUnits, rateLimitHistMinutesIndex=rateLimitHistMinutesIndex, rateLimitHistHoursBytesSent=rateLimitHistHoursBytesSent, rateLimitTable=rateLimitTable, rateLimitActualRate=rateLimitActualRate, thresholdHistSecondsEntry=thresholdHistSecondsEntry, rateLimitHistNumMinutes=rateLimitHistNumMinutes, interfaceHistHoursIfIndex=interfaceHistHoursIfIndex, thresholdHistDaysGlobalID=thresholdHistDaysGlobalID, interfaceHistSecondsIfIndex=interfaceHistSecondsIfIndex, interfaceHistMinutesIndex=interfaceHistMinutesIndex, rateLimitHistHoursEntry=rateLimitHistHoursEntry, interfaceHistHoursIndex=interfaceHistHoursIndex, interfaceHistMinutesTable=interfaceHistMinutesTable, interfaceHistHoursUnitCountIn=interfaceHistHoursUnitCountIn, thresholdHistSecondsUnitCount=thresholdHistSecondsUnitCount, thresholdHistDaysEntry=thresholdHistDaysEntry, thresholdTable=thresholdTable, thresholdHistHoursEntry=thresholdHistHoursEntry, ThresholdFilterState=ThresholdFilterState, interfaceHistDaysUnitCountIn=interfaceHistDaysUnitCountIn, thresholdHistSecondsIndex=thresholdHistSecondsIndex, rateLimitHistSecondsTable=rateLimitHistSecondsTable, thresholdState=thresholdState, rateLimitHistHoursIndex=rateLimitHistHoursIndex, thresholdHistHoursTable=thresholdHistHoursTable, interfaceHistDaysIfIndex=interfaceHistDaysIfIndex, interfaceHistHoursTimestamp=interfaceHistHoursTimestamp, interfaceHistDaysIndex=interfaceHistDaysIndex, interfaceHistSecondsTable=interfaceHistSecondsTable, thresholdGlobalID=thresholdGlobalID, interfaceHistDaysEntry=interfaceHistDaysEntry, thresholdHistDaysTimestamp=thresholdHistDaysTimestamp, tpt_traffic=tpt_traffic, thresholdHistMinutesGlobalID=thresholdHistMinutesGlobalID, thresholdHistHoursGlobalID=thresholdHistHoursGlobalID, interfaceHistHoursEntry=interfaceHistHoursEntry, rateLimitPacketsQueued=rateLimitPacketsQueued, interfaceHistDaysUnitCountOut=interfaceHistDaysUnitCountOut, interfaceHistSecondsIndex=interfaceHistSecondsIndex, rateLimitHistNumSeconds=rateLimitHistNumSeconds, rateLimitRequestedRate=rateLimitRequestedRate, thresholdHistHoursTimestamp=thresholdHistHoursTimestamp)
