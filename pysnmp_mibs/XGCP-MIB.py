...
# Notes
# -----
# ASN.1 source file://mibs/cisco/XGCP-MIB
...
_XgcpCapabilityPackageEnable_Type.__name__ = "TruthValue"
...
xgcpMIBCompliance.setObjects(
      *(("XGCP-MIB", "xgcpCoreGroup"),
        ("XGCP-MIB", "xgcpExtensionGroup"),
        ("XGCP-MIB", "xgcpPackageGroup"),
        ("XGCP-MIB", "xgcpVoiceQualityGroup"),
        ("XGCP-MIB", "xgcpDefaultMGCGroup"))
)
if mibBuilder.loadTexts:
