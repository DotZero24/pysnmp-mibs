...
RbtwsApConnectSecurityType, RbtwsRadioMode, RbtwsRadioChannelWidth, RbtwsChannelChangeType, RbtwsRadioType, RbtwsAccessType, RbtwsApSerialNum, RbtwsApPortOrDapNum, RbtwsApFailDetail, RbtwsApAttachType, RbtwsPowerLevel, RbtwsApWasOperational, RbtwsApTransition, RbtwsRadioNum, RbtwsRadioMimoState, RbtwsApNum, RbtwsApServiceAvailability, RbtwsApFingerprint, RbtwsRadioConfigState, RbtwsRadioPowerChangeType, RbtwsCryptoType = mibBuilder.importSymbols("RBTWS-AP-TC", "RbtwsApConnectSecurityType", "RbtwsRadioMode", "RbtwsRadioChannelWidth", "RbtwsChannelChangeType", "RbtwsRadioType", "RbtwsAccessType", "RbtwsApSerialNum", "RbtwsApPortOrDapNum", "RbtwsApFailDetail", "RbtwsApAttachType", "RbtwsPowerLevel", "RbtwsApWasOperational", "RbtwsApTransition", "RbtwsRadioNum", "RbtwsRadioMimoState", "RbtwsApNum", "RbtwsApServiceAvailability", "RbtwsApFingerprint", "RbtwsRadioConfigState", "RbtwsRadioPowerChangeType", "RbtwsCryptoType")
RbtwsClientAuthenProtocolType, RbtwsClientAccessMode, RbtwsClientDot1xState, RbtwsUserAccessType, RbtwsClientSessionState = mibBuilder.importSymbols("RBTWS-CLIENT-SESSION-TC", "RbtwsClientAuthenProtocolType", "RbtwsClientAccessMode", "RbtwsClientDot1xState", "RbtwsUserAccessType", "RbtwsClientSessionState")
...
mibBuilder.exportSymbols("RBTWS-TRAP-MIB", rbtwsClientRoamedFromPortNum=rbtwsClientRoamedFromPortNum, rbtwsApWasOperational=rbtwsApWasOperational, rbtwsRFDetectUnAuthorizedAPTrap=rbtwsRFDetectUnAuthorizedAPTrap, rbtwsClusterFailureTrap=rbtwsClusterFailureTrap, rbtwsClientRoamedFromWsIp=rbtwsClientRoamedFromWsIp, rbtwsClientClearedReason=rbtwsClientClearedReason, rbtwsRFDetectRogueDisappearTrap=rbtwsRFDetectRogueDisappearTrap, rbtwsClientClearedTrap2=rbtwsClientClearedTrap2, rbtwsBlacklistingCause=rbtwsBlacklistingCause, rbtwsRFDetectSuspectDeviceTrap2=rbtwsRFDetectSuspectDeviceTrap2, rbtwsMpMichaelMICFailure=rbtwsMpMichaelMICFailure, rbtwsRFDetectDoSType=rbtwsRFDetectDoSType, rbtwsRFDetectSuspectDeviceTrap=rbtwsRFDetectSuspectDeviceTrap, rbtwsNewChannelNum=rbtwsNewChannelNum, rbtwsRadioMACAddress=rbtwsRadioMACAddress, rbtwsConfigSaveInitiatorType=rbtwsConfigSaveInitiatorType, RbtwsAssociationFailureType=RbtwsAssociationFailureType, rbtwsUserParams=rbtwsUserParams, rbtwsRFDetectRogueDeviceTrap2=rbtwsRFDetectRogueDeviceTrap2, rbtwsRFDetectSpoofedSsidAPTrap=rbtwsRFDetectSpoofedSsidAPTrap, rbtwsApOperRadioStatusTrap=rbtwsApOperRadioStatusTrap, rbtwsDeviceSerNum=rbtwsDeviceSerNum, rbtwsClientClearedTrap=rbtwsClientClearedTrap, rbtwsRFDetectXmtrRadioType=rbtwsRFDetectXmtrRadioType, rbtwsClientAuthenticationSuccessTrap=rbtwsClientAuthenticationSuccessTrap, rbtwsClientLocationPolicyIndex=rbtwsClientLocationPolicyIndex, rbtwsClientDisconnectTrap=rbtwsClientDisconnectTrap, rbtwsConfigSaveGeneration=rbtwsConfigSaveGeneration, rbtwsClientMACAddress=rbtwsClientMACAddress, RbtwsUserAttributeList=RbtwsUserAttributeList, rbtwsClientRadioType=rbtwsClientRadioType, rbtwsAPBootTrap=rbtwsAPBootTrap, rbtwsRFDetectXmtrCryptoType=rbtwsRFDetectXmtrCryptoType, RbtwsSessionDisconnectType=RbtwsSessionDisconnectType, rbtwsRadioSSID=rbtwsRadioSSID, rbtwsClientAssociationSuccessTrap=rbtwsClientAssociationSuccessTrap, rbtwsApNonOperStatusTrap2=rbtwsApNonOperStatusTrap2, rbtwsRadioType=rbtwsRadioType, RbtwsConfigSaveInitiatorType=RbtwsConfigSaveInitiatorType, rbtwsClientDynAuthorChangeFailureTrap=rbtwsClientDynAuthorChangeFailureTrap, rbtwsClientDot1xState=rbtwsClientDot1xState, rbtwsRFDetectXmtrMacAddr=rbtwsRFDetectXmtrMacAddr, rbtwsClientMACAddress2=rbtwsClientMACAddress2, rbtwsClientAuthorizationFailureTrap=rbtwsClientAuthorizationFailureTrap, rbtwsRFDetectBlacklistedTrap=rbtwsRFDetectBlacklistedTrap, rbtwsApAttachType=rbtwsApAttachType, rbtwsApOperRadioStatusTrap2=rbtwsApOperRadioStatusTrap2, rbtwsClientDisconnectDescription=rbtwsClientDisconnectDescription, rbtwsRsaPubKeyFingerPrint=rbtwsRsaPubKeyFingerPrint, rbtwsClientAuthorizationSuccessTrap2=rbtwsClientAuthorizationSuccessTrap2, rbtwsClientSessionId=rbtwsClientSessionId, rbtwsClientVLANtag=rbtwsClientVLANtag, rbtwsClientDisconnectSource=rbtwsClientDisconnectSource, rbtwsClientSessionElapsedTime=rbtwsClientSessionElapsedTime, rbtwsClientAuthenProtocolType=rbtwsClientAuthenProtocolType, rbtwsChangedUserParamNewValues=rbtwsChangedUserParamNewValues, rbtwsClusterFailureDescription=rbtwsClusterFailureDescription, rbtwsClientAccessType=rbtwsClientAccessType, rbtwsClientTimeSinceLastRoam=rbtwsClientTimeSinceLastRoam, rbtwsDAPNum=rbtwsDAPNum, rbtwsConfigSaveFileName=rbtwsConfigSaveFileName, rbtwsDAPConnectWarningTrap=rbtwsDAPConnectWarningTrap, rbtwsClientAssociationFailureCause=rbtwsClientAssociationFailureCause, rbtwsRFDetectInterferingRogueDisappearTrap=rbtwsRFDetectInterferingRogueDisappearTrap, rbtwsCounterMeasureStartTrap=rbtwsCounterMeasureStartTrap, rbtwsChangedUserParamOldValues=rbtwsChangedUserParamOldValues, rbtwsSourceWsIp=rbtwsSourceWsIp, rbtwsClientAuthServerIp=rbtwsClientAuthServerIp, rbtwsClientFailureCause=rbtwsClientFailureCause, rbtwsPhysPortNum=rbtwsPhysPortNum, rbtwsDeviceFailTrap=rbtwsDeviceFailTrap, rbtwsClientFailureCauseDescription=rbtwsClientFailureCauseDescription, rbtwsMobilityDomainResiliencyStatus=rbtwsMobilityDomainResiliencyStatus, rbtwsAutoTuneRadioPowerChangeTrap=rbtwsAutoTuneRadioPowerChangeTrap, rbtwsRadioPowerChangeReason=rbtwsRadioPowerChangeReason, rbtwsUserAccessType=rbtwsUserAccessType, PYSNMP_MODULE_ID=rbtwsTrapMib, rbtwsRadioConfigState=rbtwsRadioConfigState, rbtwsNewPowerLevel=rbtwsNewPowerLevel, rbtwsClientAuthorizationReason=rbtwsClientAuthorizationReason, rbtwsApMgrNewIp=rbtwsApMgrNewIp, rbtwsClientRoamingTrap=rbtwsClientRoamingTrap, rbtwsApTimeoutTrap=rbtwsApTimeoutTrap, rbtwsMobilityDomainTimeoutTrap=rbtwsMobilityDomainTimeoutTrap, RbtwsClientClearedReason=RbtwsClientClearedReason, rbtwsClientDot1xFailureTrap=rbtwsClientDot1xFailureTrap, rbtwsRFDetectAdhocUserTrap=rbtwsRFDetectAdhocUserTrap, rbtwsConfigurationSavedTrap=rbtwsConfigurationSavedTrap, rbtwsMobilityDomainSecondarySeedIp=rbtwsMobilityDomainSecondarySeedIp, rbtwsApMgrOldIp=rbtwsApMgrOldIp, rbtwsClientSessionStartTime=rbtwsClientSessionStartTime, rbtwsOldPowerLevel=rbtwsOldPowerLevel, rbtwsApOperRadioStatusTrap3=rbtwsApOperRadioStatusTrap3, rbtwsTrapsV2=rbtwsTrapsV2, rbtwsClientDeAssociationTrap=rbtwsClientDeAssociationTrap, rbtwsMobilityDomainJoinTrap=rbtwsMobilityDomainJoinTrap, rbtwsDAPconnectWarningType=rbtwsDAPconnectWarningType, rbtwsCounterMeasureStopTrap=rbtwsCounterMeasureStopTrap, rbtwsApServiceAvailability=rbtwsApServiceAvailability, rbtwsRFDetectSpoofedMacAPTrap=rbtwsRFDetectSpoofedMacAPTrap, rbtwsCounterMeasurePerformerListInfo=rbtwsCounterMeasurePerformerListInfo, rbtwsDeviceOkayTrap=rbtwsDeviceOkayTrap, rbtwsRFDetectClassificationChangeTrap=rbtwsRFDetectClassificationChangeTrap, rbtwsRadioMimoState=rbtwsRadioMimoState, rbtwsClientIp=rbtwsClientIp, rbtwsPortNum=rbtwsPortNum, RbtwsAuthorizationFailureType=RbtwsAuthorizationFailureType, rbtwsAPMACAddress=rbtwsAPMACAddress, rbtwsRFDetectRogueDeviceTrap=rbtwsRFDetectRogueDeviceTrap, rbtwsClientAuthorizationSuccessTrap3=rbtwsClientAuthorizationSuccessTrap3, rbtwsMichaelMICFailureCause=rbtwsMichaelMICFailureCause, rbtwsClientRoamedFromDAPNum=rbtwsClientRoamedFromDAPNum, rbtwsDeviceModel=rbtwsDeviceModel, RbtwsClusterFailureReason=RbtwsClusterFailureReason, rbtwsApFailDetail=rbtwsApFailDetail, rbtwsRFDetectDoSPortTrap=rbtwsRFDetectDoSPortTrap, rbtwsClientAuthorizationSuccessTrap=rbtwsClientAuthorizationSuccessTrap, rbtwsApName=rbtwsApName, rbtwsMobilityDomainIp=rbtwsMobilityDomainIp, rbtwsBlacklistingRemainingTime=rbtwsBlacklistingRemainingTime, rbtwsPoEFailTrap=rbtwsPoEFailTrap, rbtwsMichaelMICFailure=rbtwsMichaelMICFailure, rbtwsClientDynAuthorChangeSuccessTrap=rbtwsClientDynAuthorChangeSuccessTrap, rbtwsRadioMode=rbtwsRadioMode, rbtwsClientRoamedFromRadioNum=rbtwsClientRoamedFromRadioNum, rbtwsRadioBSSID=rbtwsRadioBSSID, rbtwsRFDetectUnAuthorizedSsidTrap=rbtwsRFDetectUnAuthorizedSsidTrap, rbtwsRFDetectClientViaRogueWiredAPTrap2=rbtwsRFDetectClientViaRogueWiredAPTrap2, rbtwsRadioPowerChangeDescription=rbtwsRadioPowerChangeDescription, rbtwsClientVLANName=rbtwsClientVLANName, RbtwsMichaelMICFailureCause=RbtwsMichaelMICFailureCause, rbtwsConfigSaveInitiatorIp=rbtwsConfigSaveInitiatorIp, rbtwsRFDetectSuspectDeviceDisappearTrap=rbtwsRFDetectSuspectDeviceDisappearTrap, rbtwsConfigSaveInitiatorDetails=rbtwsConfigSaveInitiatorDetails, rbtwsRFDetectInterferingRogueAPTrap=rbtwsRFDetectInterferingRogueAPTrap, rbtwsChannelChangeReason=rbtwsChannelChangeReason, rbtwsDeviceId=rbtwsDeviceId, RbtwsApMgrChangeReason=RbtwsApMgrChangeReason, rbtwsRFDetectListenerListInfo=rbtwsRFDetectListenerListInfo, rbtwsClientVLANid=rbtwsClientVLANid, rbtwsClientDynAuthorClientIp=rbtwsClientDynAuthorClientIp, RbtwsClientAuthorizationReason=RbtwsClientAuthorizationReason, rbtwsRFDetectAdhocUserDisappearTrap=rbtwsRFDetectAdhocUserDisappearTrap, rbtwsApTransition=rbtwsApTransition, rbtwsMobilityDomainResiliencyStatusTrap=rbtwsMobilityDomainResiliencyStatusTrap, rbtwsClientAuthorizationSuccessTrap4=rbtwsClientAuthorizationSuccessTrap4, rbtwsNumLicensedActiveAPs=rbtwsNumLicensedActiveAPs, rbtwsRadioRssi=rbtwsRadioRssi, rbtwsUserName=rbtwsUserName, rbtwsApNum=rbtwsApNum, rbtwsRFDetectClientViaRogueWiredAPTrap=rbtwsRFDetectClientViaRogueWiredAPTrap, rbtwsClientDeAuthenticationTrap=rbtwsClientDeAuthenticationTrap, rbtwsOldChannelNum=rbtwsOldChannelNum, rbtwsRFDetectRogueDeviceDisappearTrap=rbtwsRFDetectRogueDeviceDisappearTrap, rbtwsClientIpAddrChangeReason=rbtwsClientIpAddrChangeReason, RbtwsClientIpAddrChangeReason=RbtwsClientIpAddrChangeReason, rbtwsApNonOperStatusTrap=rbtwsApNonOperStatusTrap, RbtwsRFDetectDoSType=RbtwsRFDetectDoSType, rbtwsClientAccessMode=rbtwsClientAccessMode, rbtwsApRejectLicenseExceededTrap=rbtwsApRejectLicenseExceededTrap, rbtwsClientRoamedFromAccessType=rbtwsClientRoamedFromAccessType, rbtwsClientAuthenticationFailureTrap=rbtwsClientAuthenticationFailureTrap, rbtwsRFDetectRogueAPTrap=rbtwsRFDetectRogueAPTrap, rbtwsClientDot1xFailureCause=rbtwsClientDot1xFailureCause, RbtwsMobilityDomainResiliencyStatus=RbtwsMobilityDomainResiliencyStatus, rbtwsAutoTuneRadioChannelChangeTrap=rbtwsAutoTuneRadioChannelChangeTrap, RbtwsDot1xFailureType=RbtwsDot1xFailureType, RbtwsBlacklistingCause=RbtwsBlacklistingCause, rbtwsApPortOrDapNum=rbtwsApPortOrDapNum, rbtwsRFDetectRogueAPMacAddr=rbtwsRFDetectRogueAPMacAddr, rbtwsApManagerChangeTrap=rbtwsApManagerChangeTrap, rbtwsClientIpAddrChangeTrap=rbtwsClientIpAddrChangeTrap, rbtwsRFDetectDoSTrap=rbtwsRFDetectDoSTrap, rbtwsClientSessionState=rbtwsClientSessionState, rbtwsAPAccessType=rbtwsAPAccessType, rbtwsTrapMib=rbtwsTrapMib, rbtwsMpMichaelMICFailure2=rbtwsMpMichaelMICFailure2, rbtwsLocalId=rbtwsLocalId, rbtwsMobilityDomainFailBackTrap=rbtwsMobilityDomainFailBackTrap, rbtwsClientSessionElapsedSeconds=rbtwsClientSessionElapsedSeconds, rbtwsClusterFailureReason=rbtwsClusterFailureReason, rbtwsClientAssociationFailureTrap=rbtwsClientAssociationFailureTrap, rbtwsRadioChannelWidth=rbtwsRadioChannelWidth, rbtwsClientAuthorizationFailureCause=rbtwsClientAuthorizationFailureCause, rbtwsAPRadioNum=rbtwsAPRadioNum, rbtwsClientAuthenticationFailureCause=rbtwsClientAuthenticationFailureCause, rbtwsApConnectSecurityType=rbtwsApConnectSecurityType, rbtwsRFDetectUnAuthorizedOuiTrap=rbtwsRFDetectUnAuthorizedOuiTrap, rbtwsRFDetectClientViaRogueWiredAPTrap3=rbtwsRFDetectClientViaRogueWiredAPTrap3, RbtwsAuthenticationFailureType=RbtwsAuthenticationFailureType, rbtwsRFDetectClassificationReason=rbtwsRFDetectClassificationReason, rbtwsApMgrChangeReason=rbtwsApMgrChangeReason, rbtwsMobilityDomainPrimarySeedIp=rbtwsMobilityDomainPrimarySeedIp, rbtwsMobilityDomainFailOverTrap=rbtwsMobilityDomainFailOverTrap)
