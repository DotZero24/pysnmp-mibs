...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cabletron/RBTWS-TRAP-MIB
...
RbtwsApFailDetail, RbtwsRadioPowerChangeType, RbtwsChannelChangeType, RbtwsApPortOrDapNum, RbtwsAccessType, RbtwsRadioChannelWidth, RbtwsApFingerprint, RbtwsPowerLevel, RbtwsApServiceAvailability, RbtwsApAttachType, RbtwsApNum, RbtwsRadioNum, RbtwsApTransition, RbtwsRadioMode, RbtwsRadioType, RbtwsRadioMimoState, RbtwsApWasOperational, RbtwsCryptoType, RbtwsApConnectSecurityType, RbtwsRadioConfigState, RbtwsApSerialNum = mibBuilder.importSymbols("RBTWS-AP-TC", "RbtwsApFailDetail", "RbtwsRadioPowerChangeType", "RbtwsChannelChangeType", "RbtwsApPortOrDapNum", "RbtwsAccessType", "RbtwsRadioChannelWidth", "RbtwsApFingerprint", "RbtwsPowerLevel", "RbtwsApServiceAvailability", "RbtwsApAttachType", "RbtwsApNum", "RbtwsRadioNum", "RbtwsApTransition", "RbtwsRadioMode", "RbtwsRadioType", "RbtwsRadioMimoState", "RbtwsApWasOperational", "RbtwsCryptoType", "RbtwsApConnectSecurityType", "RbtwsRadioConfigState", "RbtwsApSerialNum")
RbtwsClientAuthenProtocolType, RbtwsUserAccessType, RbtwsClientAccessMode, RbtwsClientDot1xState, RbtwsClientSessionState = mibBuilder.importSymbols("RBTWS-CLIENT-SESSION-TC", "RbtwsClientAuthenProtocolType", "RbtwsUserAccessType", "RbtwsClientAccessMode", "RbtwsClientDot1xState", "RbtwsClientSessionState")
RbtwsRFDetectClassificationReason, = mibBuilder.importSymbols("RBTWS-RF-DETECT-TC", "RbtwsRFDetectClassificationReason")
rbtwsTraps, rbtwsTemporary, rbtwsMibs = mibBuilder.importSymbols("RBTWS-ROOT-MIB", "rbtwsTraps", "rbtwsTemporary", "rbtwsMibs")
...
mibBuilder.exportSymbols("RBTWS-TRAP-MIB", rbtwsRadioPowerChangeReason=rbtwsRadioPowerChangeReason, rbtwsOldChannelNum=rbtwsOldChannelNum, rbtwsMobilityDomainFailOverTrap=rbtwsMobilityDomainFailOverTrap, rbtwsClientAuthenticationSuccessTrap=rbtwsClientAuthenticationSuccessTrap, rbtwsClientAuthorizationSuccessTrap2=rbtwsClientAuthorizationSuccessTrap2, rbtwsRFDetectClassificationChangeTrap=rbtwsRFDetectClassificationChangeTrap, rbtwsClientSessionElapsedSeconds=rbtwsClientSessionElapsedSeconds, rbtwsClientAuthenticationFailureCause=rbtwsClientAuthenticationFailureCause, rbtwsLocalId=rbtwsLocalId, rbtwsRFDetectClassificationReason=rbtwsRFDetectClassificationReason, rbtwsUserAccessType=rbtwsUserAccessType, rbtwsRadioRssi=rbtwsRadioRssi, rbtwsConfigSaveInitiatorType=rbtwsConfigSaveInitiatorType, rbtwsClientAccessType=rbtwsClientAccessType, rbtwsMobilityDomainIp=rbtwsMobilityDomainIp, rbtwsClusterFailureReason=rbtwsClusterFailureReason, rbtwsClientDot1xState=rbtwsClientDot1xState, rbtwsNewChannelNum=rbtwsNewChannelNum, rbtwsApRejectLicenseExceededTrap=rbtwsApRejectLicenseExceededTrap, rbtwsClientRoamedFromWsIp=rbtwsClientRoamedFromWsIp, rbtwsConfigurationSavedTrap=rbtwsConfigurationSavedTrap, rbtwsDeviceModel=rbtwsDeviceModel, rbtwsClientDynAuthorClientIp=rbtwsClientDynAuthorClientIp, rbtwsClientVLANName=rbtwsClientVLANName, rbtwsOldPowerLevel=rbtwsOldPowerLevel, rbtwsClientMACAddress2=rbtwsClientMACAddress2, rbtwsRFDetectSuspectDeviceDisappearTrap=rbtwsRFDetectSuspectDeviceDisappearTrap, rbtwsConfigSaveFileName=rbtwsConfigSaveFileName, rbtwsApOperRadioStatusTrap2=rbtwsApOperRadioStatusTrap2, rbtwsClientAuthorizationReason=rbtwsClientAuthorizationReason, rbtwsDeviceId=rbtwsDeviceId, PYSNMP_MODULE_ID=rbtwsTrapMib, rbtwsSourceWsIp=rbtwsSourceWsIp, rbtwsClientRoamingTrap=rbtwsClientRoamingTrap, rbtwsApNum=rbtwsApNum, rbtwsRFDetectClientViaRogueWiredAPTrap3=rbtwsRFDetectClientViaRogueWiredAPTrap3, rbtwsApNonOperStatusTrap2=rbtwsApNonOperStatusTrap2, rbtwsClientClearedTrap2=rbtwsClientClearedTrap2, rbtwsAPMACAddress=rbtwsAPMACAddress, rbtwsClientSessionId=rbtwsClientSessionId, rbtwsApTimeoutTrap=rbtwsApTimeoutTrap, rbtwsRFDetectSpoofedSsidAPTrap=rbtwsRFDetectSpoofedSsidAPTrap, rbtwsClientAuthenProtocolType=rbtwsClientAuthenProtocolType, rbtwsApWasOperational=rbtwsApWasOperational, rbtwsClientAssociationFailureTrap=rbtwsClientAssociationFailureTrap, rbtwsMobilityDomainResiliencyStatus=rbtwsMobilityDomainResiliencyStatus, rbtwsRsaPubKeyFingerPrint=rbtwsRsaPubKeyFingerPrint, rbtwsRFDetectDoSTrap=rbtwsRFDetectDoSTrap, rbtwsClientDeAssociationTrap=rbtwsClientDeAssociationTrap, rbtwsClusterFailureTrap=rbtwsClusterFailureTrap, rbtwsCounterMeasureStartTrap=rbtwsCounterMeasureStartTrap, rbtwsRFDetectRogueAPTrap=rbtwsRFDetectRogueAPTrap, rbtwsClientVLANtag=rbtwsClientVLANtag, rbtwsClientIpAddrChangeReason=rbtwsClientIpAddrChangeReason, rbtwsClientAuthenticationFailureTrap=rbtwsClientAuthenticationFailureTrap, rbtwsMobilityDomainSecondarySeedIp=rbtwsMobilityDomainSecondarySeedIp, rbtwsMpMichaelMICFailure=rbtwsMpMichaelMICFailure, rbtwsDAPNum=rbtwsDAPNum, rbtwsRFDetectRogueAPMacAddr=rbtwsRFDetectRogueAPMacAddr, rbtwsApServiceAvailability=rbtwsApServiceAvailability, rbtwsClientSessionElapsedTime=rbtwsClientSessionElapsedTime, rbtwsClientAuthorizationSuccessTrap=rbtwsClientAuthorizationSuccessTrap, rbtwsRFDetectInterferingRogueAPTrap=rbtwsRFDetectInterferingRogueAPTrap, RbtwsClientAuthorizationReason=RbtwsClientAuthorizationReason, RbtwsConfigSaveInitiatorType=RbtwsConfigSaveInitiatorType, rbtwsTrapMib=rbtwsTrapMib, rbtwsClientAccessMode=rbtwsClientAccessMode, rbtwsApOperRadioStatusTrap=rbtwsApOperRadioStatusTrap, rbtwsRFDetectAdhocUserTrap=rbtwsRFDetectAdhocUserTrap, rbtwsNewPowerLevel=rbtwsNewPowerLevel, rbtwsRFDetectUnAuthorizedOuiTrap=rbtwsRFDetectUnAuthorizedOuiTrap, rbtwsApFailDetail=rbtwsApFailDetail, rbtwsAutoTuneRadioChannelChangeTrap=rbtwsAutoTuneRadioChannelChangeTrap, rbtwsRFDetectUnAuthorizedSsidTrap=rbtwsRFDetectUnAuthorizedSsidTrap, RbtwsAuthenticationFailureType=RbtwsAuthenticationFailureType, rbtwsRadioMACAddress=rbtwsRadioMACAddress, rbtwsClientLocationPolicyIndex=rbtwsClientLocationPolicyIndex, rbtwsClientDynAuthorChangeSuccessTrap=rbtwsClientDynAuthorChangeSuccessTrap, rbtwsClusterFailureDescription=rbtwsClusterFailureDescription, rbtwsClientFailureCause=rbtwsClientFailureCause, RbtwsSessionDisconnectType=RbtwsSessionDisconnectType, rbtwsClientIp=rbtwsClientIp, rbtwsClientAuthorizationFailureTrap=rbtwsClientAuthorizationFailureTrap, rbtwsRadioMode=rbtwsRadioMode, rbtwsClientDeAuthenticationTrap=rbtwsClientDeAuthenticationTrap, rbtwsRFDetectUnAuthorizedAPTrap=rbtwsRFDetectUnAuthorizedAPTrap, rbtwsRFDetectBlacklistedTrap=rbtwsRFDetectBlacklistedTrap, rbtwsClientMACAddress=rbtwsClientMACAddress, rbtwsClientDisconnectSource=rbtwsClientDisconnectSource, rbtwsApMgrChangeReason=rbtwsApMgrChangeReason, rbtwsClientRoamedFromRadioNum=rbtwsClientRoamedFromRadioNum, rbtwsApTransition=rbtwsApTransition, rbtwsTrapsV2=rbtwsTrapsV2, rbtwsDeviceOkayTrap=rbtwsDeviceOkayTrap, rbtwsMpMichaelMICFailure2=rbtwsMpMichaelMICFailure2, rbtwsClientDot1xFailureCause=rbtwsClientDot1xFailureCause, RbtwsApMgrChangeReason=RbtwsApMgrChangeReason, rbtwsRFDetectSuspectDeviceTrap2=rbtwsRFDetectSuspectDeviceTrap2, RbtwsClientClearedReason=RbtwsClientClearedReason, rbtwsRadioType=rbtwsRadioType, rbtwsRFDetectClientViaRogueWiredAPTrap2=rbtwsRFDetectClientViaRogueWiredAPTrap2, rbtwsRadioChannelWidth=rbtwsRadioChannelWidth, rbtwsConfigSaveInitiatorDetails=rbtwsConfigSaveInitiatorDetails, rbtwsClientDot1xFailureTrap=rbtwsClientDot1xFailureTrap, rbtwsMobilityDomainPrimarySeedIp=rbtwsMobilityDomainPrimarySeedIp, rbtwsClientDynAuthorChangeFailureTrap=rbtwsClientDynAuthorChangeFailureTrap, RbtwsMichaelMICFailureCause=RbtwsMichaelMICFailureCause, rbtwsClientRoamedFromDAPNum=rbtwsClientRoamedFromDAPNum, RbtwsRFDetectDoSType=RbtwsRFDetectDoSType, rbtwsClientTimeSinceLastRoam=rbtwsClientTimeSinceLastRoam, rbtwsConfigSaveGeneration=rbtwsConfigSaveGeneration, rbtwsMobilityDomainTimeoutTrap=rbtwsMobilityDomainTimeoutTrap, rbtwsClientClearedTrap=rbtwsClientClearedTrap, rbtwsApMgrOldIp=rbtwsApMgrOldIp, rbtwsRFDetectAdhocUserDisappearTrap=rbtwsRFDetectAdhocUserDisappearTrap, rbtwsRFDetectDoSType=rbtwsRFDetectDoSType, RbtwsDot1xFailureType=RbtwsDot1xFailureType, rbtwsRFDetectXmtrMacAddr=rbtwsRFDetectXmtrMacAddr, rbtwsClientRoamedFromAccessType=rbtwsClientRoamedFromAccessType, rbtwsRFDetectXmtrRadioType=rbtwsRFDetectXmtrRadioType, rbtwsRFDetectRogueDeviceDisappearTrap=rbtwsRFDetectRogueDeviceDisappearTrap, rbtwsClientRoamedFromPortNum=rbtwsClientRoamedFromPortNum, rbtwsDAPconnectWarningType=rbtwsDAPconnectWarningType, rbtwsClientRadioType=rbtwsClientRadioType, rbtwsApPortOrDapNum=rbtwsApPortOrDapNum, RbtwsMobilityDomainResiliencyStatus=RbtwsMobilityDomainResiliencyStatus, rbtwsRadioBSSID=rbtwsRadioBSSID, rbtwsPoEFailTrap=rbtwsPoEFailTrap, rbtwsDeviceFailTrap=rbtwsDeviceFailTrap, rbtwsCounterMeasurePerformerListInfo=rbtwsCounterMeasurePerformerListInfo, rbtwsBlacklistingCause=rbtwsBlacklistingCause, rbtwsPhysPortNum=rbtwsPhysPortNum, rbtwsApName=rbtwsApName, RbtwsUserAttributeList=RbtwsUserAttributeList, rbtwsAPAccessType=rbtwsAPAccessType, rbtwsDeviceSerNum=rbtwsDeviceSerNum, rbtwsClientDisconnectDescription=rbtwsClientDisconnectDescription, rbtwsClientAssociationSuccessTrap=rbtwsClientAssociationSuccessTrap, RbtwsClusterFailureReason=RbtwsClusterFailureReason, rbtwsClientAssociationFailureCause=rbtwsClientAssociationFailureCause, rbtwsClientSessionStartTime=rbtwsClientSessionStartTime, rbtwsMichaelMICFailureCause=rbtwsMichaelMICFailureCause, rbtwsChannelChangeReason=rbtwsChannelChangeReason, rbtwsAPRadioNum=rbtwsAPRadioNum, rbtwsNumLicensedActiveAPs=rbtwsNumLicensedActiveAPs, rbtwsApOperRadioStatusTrap3=rbtwsApOperRadioStatusTrap3, rbtwsCounterMeasureStopTrap=rbtwsCounterMeasureStopTrap, RbtwsClientIpAddrChangeReason=RbtwsClientIpAddrChangeReason, rbtwsUserName=rbtwsUserName, rbtwsConfigSaveInitiatorIp=rbtwsConfigSaveInitiatorIp, rbtwsRFDetectDoSPortTrap=rbtwsRFDetectDoSPortTrap, rbtwsClientClearedReason=rbtwsClientClearedReason, rbtwsApConnectSecurityType=rbtwsApConnectSecurityType, rbtwsBlacklistingRemainingTime=rbtwsBlacklistingRemainingTime, rbtwsRFDetectRogueDeviceTrap2=rbtwsRFDetectRogueDeviceTrap2, rbtwsRFDetectXmtrCryptoType=rbtwsRFDetectXmtrCryptoType, RbtwsAuthorizationFailureType=RbtwsAuthorizationFailureType, rbtwsRadioSSID=rbtwsRadioSSID, rbtwsMobilityDomainFailBackTrap=rbtwsMobilityDomainFailBackTrap, rbtwsRFDetectRogueDeviceTrap=rbtwsRFDetectRogueDeviceTrap, rbtwsApMgrNewIp=rbtwsApMgrNewIp, rbtwsClientIpAddrChangeTrap=rbtwsClientIpAddrChangeTrap, rbtwsMobilityDomainJoinTrap=rbtwsMobilityDomainJoinTrap, rbtwsClientAuthorizationSuccessTrap3=rbtwsClientAuthorizationSuccessTrap3, rbtwsClientDisconnectTrap=rbtwsClientDisconnectTrap, rbtwsPortNum=rbtwsPortNum, rbtwsApNonOperStatusTrap=rbtwsApNonOperStatusTrap, rbtwsChangedUserParamOldValues=rbtwsChangedUserParamOldValues, RbtwsAssociationFailureType=RbtwsAssociationFailureType, RbtwsBlacklistingCause=RbtwsBlacklistingCause, rbtwsRadioPowerChangeDescription=rbtwsRadioPowerChangeDescription, rbtwsRFDetectRogueDisappearTrap=rbtwsRFDetectRogueDisappearTrap, rbtwsRFDetectClientViaRogueWiredAPTrap=rbtwsRFDetectClientViaRogueWiredAPTrap, rbtwsRFDetectSpoofedMacAPTrap=rbtwsRFDetectSpoofedMacAPTrap, rbtwsClientSessionState=rbtwsClientSessionState, rbtwsClientAuthorizationFailureCause=rbtwsClientAuthorizationFailureCause, rbtwsUserParams=rbtwsUserParams, rbtwsAPBootTrap=rbtwsAPBootTrap, rbtwsMobilityDomainResiliencyStatusTrap=rbtwsMobilityDomainResiliencyStatusTrap, rbtwsRFDetectListenerListInfo=rbtwsRFDetectListenerListInfo, rbtwsAutoTuneRadioPowerChangeTrap=rbtwsAutoTuneRadioPowerChangeTrap, rbtwsRadioConfigState=rbtwsRadioConfigState, rbtwsClientAuthorizationSuccessTrap4=rbtwsClientAuthorizationSuccessTrap4, rbtwsChangedUserParamNewValues=rbtwsChangedUserParamNewValues, rbtwsRFDetectSuspectDeviceTrap=rbtwsRFDetectSuspectDeviceTrap, rbtwsRFDetectInterferingRogueDisappearTrap=rbtwsRFDetectInterferingRogueDisappearTrap, rbtwsClientVLANid=rbtwsClientVLANid, rbtwsClientAuthServerIp=rbtwsClientAuthServerIp, rbtwsRadioMimoState=rbtwsRadioMimoState, rbtwsClientFailureCauseDescription=rbtwsClientFailureCauseDescription, rbtwsDAPConnectWarningTrap=rbtwsDAPConnectWarningTrap, rbtwsMichaelMICFailure=rbtwsMichaelMICFailure, rbtwsApAttachType=rbtwsApAttachType, rbtwsApManagerChangeTrap=rbtwsApManagerChangeTrap)
