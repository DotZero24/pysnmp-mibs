...
# Notes
# -----
# ASN.1 source file://mibs/rfc/RPKI-ROUTER-MIB
...
_RpkiRtrCacheServerPreference_Type.__name__ = "Unsigned32"
...
rpkiRtrRFC6945ReadOnlyCompliance.setObjects(
      *(("RPKI-ROUTER-MIB", "rpkiRtrCacheServerGroup"),
        ("RPKI-ROUTER-MIB", "rpkiRtrPrefixOriginGroup"),
        ("RPKI-ROUTER-MIB", "rpkiRtrNotificationsGroup"),
        ("RPKI-ROUTER-MIB", "rpkiRtrCacheServerErrorsGroup"))
)
if mibBuilder.loadTexts:
