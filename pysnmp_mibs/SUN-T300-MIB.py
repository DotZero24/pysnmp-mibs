...
mibBuilder.exportSymbols("SUN-T300-MIB", logFile=logFile, sysWriteRequests=sysWriteRequests, fruCtlrRole=fruCtlrRole, portSunHost=portSunHost, sysBlocksWritten=sysBlocksWritten, volBlocksWritten=volBlocksWritten, fruPowerPowOutput=fruPowerPowOutput, fruMidplaneCount=fruMidplaneCount, fruType=fruType, fruCtlrCount=fruCtlrCount, portType=portType, volCacheReadMisses=volCacheReadMisses, portTable=portTable, volRaidLevel=volRaidLevel, fruCtlrTemp=fruCtlrTemp, fruPowerBatMdate=fruPowerBatMdate, fruLoopCount=fruLoopCount, portIndex=portIndex, attachVolName=attachVolName, fruDiskEntry=fruDiskEntry, portFruId=portFruId, ondgId=ondgId, volIndex=volIndex, sysCacheReadHits=sysCacheReadHits, loopMux=loopMux, portWriteRequests=portWriteRequests, portFibreAlpa=portFibreAlpa, sysStripeUnitSize=sysStripeUnitSize, fruLoopTemp=fruLoopTemp, fruIndex=fruIndex, fruEntry=fruEntry, volSubstitutedDisk=volSubstitutedDisk, sysReadRequests=sysReadRequests, portFibreAlpaMode=portFibreAlpaMode, unitIndex=unitIndex, volHardErrors=volHardErrors, t300Objs=t300Objs, sysId=sysId, sysReadAhead=sysReadAhead, portFibreCount=portFibreCount, sysGuestSession=sysGuestSession, ondgOper=ondgOper, fruCtlrCpuDesc=fruCtlrCpuDesc, fruMidplaneTable=fruMidplaneTable, volCacheWriteMisses=volCacheWriteMisses, attachIndex=attachIndex, sysCacheMirror=sysCacheMirror, loopCount=loopCount, fruCount=fruCount, t300Purple1=t300Purple1, portBlocksRead=portBlocksRead, sysLoop1Split=sysLoop1Split, fruDiskPort2State=fruDiskPort2State, sysHasVolumes=sysHasVolumes, PYSNMP_MODULE_ID=t300, volCacheWriteHits=volCacheWriteHits, attachLun=attachLun, volInitRate=volInitRate, fruModel=fruModel, fruDiskTemp=fruDiskTemp, fruSerialNo=fruSerialNo, fruDiskTable=fruDiskTable, fruMidplaneMdate=fruMidplaneMdate, fruPowerPowSource=fruPowerPowSource, volOper=volOper, sysTftpFile=sysTftpFile, sysDate=sysDate, t300OndgObjs=t300OndgObjs, attachMode=attachMode, t300=t300, unitType=unitType, sysCacheReconFlushes=sysCacheReconFlushes, fruLoopCable1State=fruLoopCable1State, logLevel=logLevel, unitTable=unitTable, t300LogObjs=t300LogObjs, sysCacheStripeFlushes=sysCacheStripeFlushes, fruRevision=fruRevision, unitId=unitId, fruId=fruId, fruPowerPowTemp=fruPowerPowTemp, portFibreTable=portFibreTable, sysAutoDisable=sysAutoDisable, sysMpSupport=sysMpSupport, fruLoopMode=fruLoopMode, sysVendor=sysVendor, fruPowerTable=fruPowerTable, fruPowerPowMdate=fruPowerPowMdate, sysMessage=sysMessage, fruPowerBatState=fruPowerBatState, t300AttachObjs=t300AttachObjs, logTo=logTo, fruTable=fruTable, portFibreEntry=portFibreEntry, sysBootMode=sysBootMode, fruVendor=fruVendor, volCacheReadHits=volCacheReadHits, fruState=fruState, sysTime=sysTime, sysSpinDelay=sysSpinDelay, fruLoopMdate=fruLoopMdate, unitCount=unitCount, loopStatus=loopStatus, ondgOperPending=ondgOperPending, t300VolumeObjs=t300VolumeObjs, portBlocksWritten=portBlocksWritten, portErrors=portErrors, volArrayWidth=volArrayWidth, volCacheMirror=volCacheMirror, sysReconRate=sysReconRate, sysLastMessage=sysLastMessage, volCount=volCount, ondgError=ondgError, sun=sun, loopTable=loopTable, volReadRequests=volReadRequests, portCount=portCount, fruPowerEntry=fruPowerEntry, logPort=logPort, t300LoopObjs=t300LoopObjs, sysOndgTimeslice=sysOndgTimeslice, t300FruObjs=t300FruObjs, fruDiskCount=fruDiskCount, sysFruRemovalShutdown=sysFruRemovalShutdown, sysRarpEnabled=sysRarpEnabled, volCacheStripeFlushes=volCacheStripeFlushes, fruDiskPort1State=fruDiskPort1State, fruLoopTable=fruLoopTable, fruCtlrCtState=fruCtlrCtState, loopIndex=loopIndex, loopId=loopId, volId=volId, fruLoopCable2State=fruLoopCable2State, t300EventsV2=t300EventsV2, t300PortObjs=t300PortObjs, portStatus=portStatus, fruPowerCount=fruPowerCount, portReadRequests=portReadRequests, sysRevision=sysRevision, sysLastRestart=sysLastRestart, unitStandby=unitStandby, volCacheReconFlushes=volCacheReconFlushes, sysGateway=sysGateway, fruErrors=fruErrors, volWWN=volWWN, sysCacheRmwFlushes=sysCacheRmwFlushes, volEntry=volEntry, attachTable=attachTable, sysOndgMode=sysOndgMode, sysTimezone=sysTimezone, portId=portId, volName=volName, volCacheMode=volCacheMode, unitEntry=unitEntry, volBlocksRead=volBlocksRead, fruDiskStatusCode=fruDiskStatusCode, sysSubNet=sysSubNet, fruPowerBatUsed=fruPowerBatUsed, fruDiskVolName=fruDiskVolName, fruCtlrMdate=fruCtlrMdate, fruPowerFan1State=fruPowerFan1State, sysIdleDiskTimeout=sysIdleDiskTimeout, t300UnitObjs=t300UnitObjs, fruDiskCapacity=fruDiskCapacity, t300Reg=t300Reg, sysCacheReadMisses=sysCacheReadMisses, volSoftErrors=volSoftErrors, ondgOperProgress=ondgOperProgress, volOperProgress=volOperProgress, storage_subsystem=storage_subsystem, portEntry=portEntry, fruCtlrTable=fruCtlrTable, fruCtlrPartnerId=fruCtlrPartnerId, fruPowerFan2State=fruPowerFan2State, sysIpAddr=sysIpAddr, volWriteRequests=volWriteRequests, volCapacity=volCapacity, t300SystemObjs=t300SystemObjs, sysCtime=sysCtime, fruStatus=fruStatus, volStatus=volStatus, sysRootSession=sysRootSession, volDisabledDisk=volDisabledDisk, fruMidplaneEntry=fruMidplaneEntry, sysCacheWriteMisses=sysCacheWriteMisses, volTable=volTable, t300Events=t300Events, fruCtlrEntry=fruCtlrEntry, attachEntry=attachEntry, portWWN=portWWN, sysCacheMode=sysCacheMode, fruPowerBatLife=fruPowerBatLife, fruCtlrCacheSize=fruCtlrCacheSize, sysTftpHost=sysTftpHost, sysModel=sysModel, sysBlocksRead=sysBlocksRead, sysCacheWriteHits=sysCacheWriteHits, attachVolId=attachVolId, fruDiskRole=fruDiskRole, products=products, fruLoopEntry=fruLoopEntry, attachVolOwner=attachVolOwner, logStatus=logStatus, attachCount=attachCount, fruCtlrConsoleBaud=fruCtlrConsoleBaud, volVerifyRate=volVerifyRate, volCacheRmwFlushes=volCacheRmwFlushes, loopEntry=loopEntry, sysBootDelay=sysBootDelay, volFirmErrors=volFirmErrors)
