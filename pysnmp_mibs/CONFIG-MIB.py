...
HpSwitchIfMauAutoNegCapReceivedBits, HpSwitchIfMauAutoNegCapabilityBits, HpSwitchIfMauTypeListBits, ConfigStatus, HpSwitchPortType, HpSwitchIfMauAutoNegCapAdvertisedBits = mibBuilder.importSymbols("HP-ICF-TC", "HpSwitchIfMauAutoNegCapReceivedBits", "HpSwitchIfMauAutoNegCapabilityBits", "HpSwitchIfMauTypeListBits", "ConfigStatus", "HpSwitchPortType", "HpSwitchIfMauAutoNegCapAdvertisedBits")
...
mibBuilder.exportSymbols("CONFIG-MIB", hpSwitchCosTosDSCPPolicy=hpSwitchCosTosDSCPPolicy, hpSwitchCosAppTypeDSCPPolicy=hpSwitchCosAppTypeDSCPPolicy, hpSwitchSshReKeyStatus=hpSwitchSshReKeyStatus, hpSwitchStpConfig=hpSwitchStpConfig, hpSwitchCosVlanDSCPPolicy=hpSwitchCosVlanDSCPPolicy, hpSwitchFilterEntryStatus=hpSwitchFilterEntryStatus, hpSwitchBWMinEgressPortConfigEntry=hpSwitchBWMinEgressPortConfigEntry, hpSwitchPortTaggedVlanMap3k=hpSwitchPortTaggedVlanMap3k, hpSwitchIpTimepServerAddr=hpSwitchIpTimepServerAddr, hpSwitchPortIsolationConfigEntry=hpSwitchPortIsolationConfigEntry, hpSwitchSshAdminStatus=hpSwitchSshAdminStatus, HpicfUsrProfilePortSpeed=HpicfUsrProfilePortSpeed, hpSwitchCosAddressConfigTable=hpSwitchCosAddressConfigTable, hpSwitchPortFastEtherMode=hpSwitchPortFastEtherMode, hpSwitchCosVlanConfigTable=hpSwitchCosVlanConfigTable, hpSwitchIgmpPortConfigTable2=hpSwitchIgmpPortConfigTable2, hpSwitchDaylightBeginningMonth=hpSwitchDaylightBeginningMonth, hpSwitchIpxConfigStatus=hpSwitchIpxConfigStatus, hpSwitchCosAddressDSCPPolicy=hpSwitchCosAddressDSCPPolicy, hpSwitchIgmpPortIndex2=hpSwitchIgmpPortIndex2, hpSwitchPortTrunkType=hpSwitchPortTrunkType, hpSwitchRateLimitPortConfigTable=hpSwitchRateLimitPortConfigTable, hpSwitchCosPortConfigEntry=hpSwitchCosPortConfigEntry, hpSwitchCosProtocolType=hpSwitchCosProtocolType, hpSwitchIpTimepPollInterval=hpSwitchIpTimepPollInterval, hpSwitchFilterConfig=hpSwitchFilterConfig, hpSwitchFilterPortMask=hpSwitchFilterPortMask, hpSwitchConfigCosLastConfigError=hpSwitchConfigCosLastConfigError, hpSwitchCosTosApplyPolicy=hpSwitchCosTosApplyPolicy, hpSwitchCosConfig=hpSwitchCosConfig, hpSwitchSshPortNumber=hpSwitchSshPortNumber, hpSwitchTrunkLacpEnableTimer=hpSwitchTrunkLacpEnableTimer, hpSwitchAutoReboot=hpSwitchAutoReboot, hpSwitchConfig=hpSwitchConfig, hpSwitchABCConfigIpRipControl=hpSwitchABCConfigIpRipControl, hpSwitchMacDelimiter=hpSwitchMacDelimiter, hpSwitchCosPortResolvedPriority=hpSwitchCosPortResolvedPriority, hpSwitchIgmpIpMcastState2=hpSwitchIgmpIpMcastState2, hpSwitchABCConfigEntry=hpSwitchABCConfigEntry, hpSwitchCosAppTypeStatus=hpSwitchCosAppTypeStatus, hpSwitchPortTrunkGroup=hpSwitchPortTrunkGroup, hpSwitchCosAddressStatus=hpSwitchCosAddressStatus, hpSwitchABCConfigAutoGatewayConfig=hpSwitchABCConfigAutoGatewayConfig, hpSwitchLACPAllPortsStatus=hpSwitchLACPAllPortsStatus, hpSwitchIpxConfig=hpSwitchIpxConfig, hpicfSwitchSTPVersion=hpicfSwitchSTPVersion, hpSwitchStpPortSrcMac=hpSwitchStpPortSrcMac, hpSwitchTrunkIndex=hpSwitchTrunkIndex, hpicfSwitchRMONLogThreshold=hpicfSwitchRMONLogThreshold, hpSwitchPortEEEAdminStatus=hpSwitchPortEEEAdminStatus, hpSwitchIgmpPortConfigEntry2=hpSwitchIgmpPortConfigEntry2, hpSwitchProbedPortMask=hpSwitchProbedPortMask, hpSwitchSystemConfig=hpSwitchSystemConfig, VlanID=VlanID, hpSwitchTrunkEntry=hpSwitchTrunkEntry, hpSwitchFilterIndex=hpSwitchFilterIndex, hpSwitchCosAppTypeResolvedPriority=hpSwitchCosAppTypeResolvedPriority, hpSwitchCosAddressType=hpSwitchCosAddressType, hpSwitchTerminalType=hpSwitchTerminalType, hpSwitchPortLACPKey=hpSwitchPortLACPKey, hpSwitchMeshActualId=hpSwitchMeshActualId, hpSwitchPortEEEMinTwSysTx=hpSwitchPortEEEMinTwSysTx, hpSwitchCosAppTypeSrcPort=hpSwitchCosAppTypeSrcPort, hpSwitchCosDSCPPolicyConfigEntry=hpSwitchCosDSCPPolicyConfigEntry, hpSwitchIgmpPortType=hpSwitchIgmpPortType, hpSwitchStpVlanEntry=hpSwitchStpVlanEntry, hpSwitchStpVlanTable=hpSwitchStpVlanTable, hpSwitchSLinkStopBits=hpSwitchSLinkStopBits, hpSwitchLACPConfig=hpSwitchLACPConfig, hpSwitchCosDSCPPolicyName=hpSwitchCosDSCPPolicyName, hpSwitchIfMauTypeListBits=hpSwitchIfMauTypeListBits, hpSwitchDSCPRateLimitConfig=hpSwitchDSCPRateLimitConfig, hpSwitchStpPort=hpSwitchStpPort, hpSwitchBWMinEgressPortPrctNormalPriority=hpSwitchBWMinEgressPortPrctNormalPriority, hpSwitchCosPortApplyPolicy=hpSwitchCosPortApplyPolicy, hpSwitchSessionConsoleIdleTimeout=hpSwitchSessionConsoleIdleTimeout, hpSwitchPortPtpAdminStatus=hpSwitchPortPtpAdminStatus, hpSwitchCosAddressApplyPolicy=hpSwitchCosAddressApplyPolicy, hpSwitchSLinkModemDisConnTime=hpSwitchSLinkModemDisConnTime, hpSwitchCosAppTypeApplyPolicy=hpSwitchCosAppTypeApplyPolicy, hpSwitchAllowV2Modules=hpSwitchAllowV2Modules, hpSwitchSerialLinkConfig=hpSwitchSerialLinkConfig, hpSwitchReboot=hpSwitchReboot, hpSwitchABCConfigIpxRipSapControl=hpSwitchABCConfigIpxRipSapControl, hpSwitchDaylightEndingDay=hpSwitchDaylightEndingDay, hpSwitchDaylightTimeRule=hpSwitchDaylightTimeRule, hpSwitchStpPortEntry=hpSwitchStpPortEntry, hpSwitchCosVlanConfigEntry=hpSwitchCosVlanConfigEntry, hpSwitchSLinkConnInactTime=hpSwitchSLinkConnInactTime, hpSwitchCosAddressIpv6PrefixLength=hpSwitchCosAddressIpv6PrefixLength, hpSwitchQosPassThroughModeConfig=hpSwitchQosPassThroughModeConfig, hpSwitchPortFlowControl=hpSwitchPortFlowControl, hpSwitchStpPortPriority=hpSwitchStpPortPriority, hpSwitchStpPortBpduProtection=hpSwitchStpPortBpduProtection, hpSwitchSshReKeyVolume=hpSwitchSshReKeyVolume, hpSwitchPortDevTypeNetworkDevice=hpSwitchPortDevTypeNetworkDevice, hpSwitchConsoleConfigLogoutPrompt=hpSwitchConsoleConfigLogoutPrompt, hpSwitchCosProtocolConfigTable=hpSwitchCosProtocolConfigTable, hpSwitchIfMau=hpSwitchIfMau, hpSwitchDaylightEndingMonth=hpSwitchDaylightEndingMonth, hpSwitchIpTimepInetServerAddrType=hpSwitchIpTimepInetServerAddrType, hpSwitchSystemPortLEDMode=hpSwitchSystemPortLEDMode, hpSwitchPortDescr=hpSwitchPortDescr, hpSwitchPortIndex=hpSwitchPortIndex, hpSwitchMeshMulticastAgingMode=hpSwitchMeshMulticastAgingMode, hpSwitchIpMTU=hpSwitchIpMTU, hpSwitchStpMaxAge=hpSwitchStpMaxAge, hpSwitchCosPortTrustedPartnerState=hpSwitchCosPortTrustedPartnerState, hpSwitchCosAppTypeMaxSrcPort=hpSwitchCosAppTypeMaxSrcPort, hpConfig=hpConfig, hpSwitchDSCPRateLimitPorts=hpSwitchDSCPRateLimitPorts, hpSwitchCosPortTrustMode=hpSwitchCosPortTrustMode, hpSwitchCosAppTypeDestPort=hpSwitchCosAppTypeDestPort, hpSwitchIgmpPortType2=hpSwitchIgmpPortType2, hpSwitchIpTftpMode=hpSwitchIpTftpMode, hpSwitchCosVlanIndex=hpSwitchCosVlanIndex, hpSwitchStpBpduProtectionTimeout=hpSwitchStpBpduProtectionTimeout, hpSwitchTrapsObjects=hpSwitchTrapsObjects, hpSwitchRateLimitPortPrctMedPriority=hpSwitchRateLimitPortPrctMedPriority, hpSwitchQosPassThroughMode=hpSwitchQosPassThroughMode, hpSwitchStpHelloTime=hpSwitchStpHelloTime, hpSwitchDisplayedEvent=hpSwitchDisplayedEvent, hpSwitchIgmpPortConfigTable=hpSwitchIgmpPortConfigTable, hpSwitchSLinkModemConnTime=hpSwitchSLinkModemConnTime, hpSwitchCosVlanPriority=hpSwitchCosVlanPriority, hpSwitchTrunkTable=hpSwitchTrunkTable, hpSwitchCosTosPriority=hpSwitchCosTosPriority, hpSwitchCosAddressIndex=hpSwitchCosAddressIndex, hpSwitchLinkUpDownTrapAllPortsStatus=hpSwitchLinkUpDownTrapAllPortsStatus, hpSwitchPortBcastLimit=hpSwitchPortBcastLimit, hpSwitchPortPtpTxCount=hpSwitchPortPtpTxCount, hpSwitchProbePort=hpSwitchProbePort, hpSwitchStpErrantBpduReceived=hpSwitchStpErrantBpduReceived, hpSwitchSshKex=hpSwitchSshKex, hpSwitchTcpPushPreserve=hpSwitchTcpPushPreserve, hpSwitchConsoleRefRate=hpSwitchConsoleRefRate, hpSwitchStpAdminStatus=hpSwitchStpAdminStatus, hpSwitchCosAppTypePriority=hpSwitchCosAppTypePriority, hpSwitchCosDSCPPolicyPriority=hpSwitchCosDSCPPolicyPriority, hpSwitchCosTosResolvedPriority=hpSwitchCosTosResolvedPriority, hpSwitchPortIsolationPortMode=hpSwitchPortIsolationPortMode, hpSwitchPortPtpRxCount=hpSwitchPortPtpRxCount, hpSwitchFddiIpFragConfigIndex=hpSwitchFddiIpFragConfigIndex, hpSwitchSshTimeout=hpSwitchSshTimeout, hpSwitchRateLimitPortPrctHighPriority=hpSwitchRateLimitPortPrctHighPriority, hpSwitchIgmpIpMcastState=hpSwitchIgmpIpMcastState, hpSwitchCosAddressIpv6=hpSwitchCosAddressIpv6, hpSwitchCosAppTypeConfigTable=hpSwitchCosAppTypeConfigTable, hpSwitchCosVlanApplyPolicy=hpSwitchCosVlanApplyPolicy, hpSwitchSLinkFlowCtrl=hpSwitchSLinkFlowCtrl, hpSwitchCosAppTypeMaxDestPort=hpSwitchCosAppTypeMaxDestPort, hpSwitchPortAutoMDIX=hpSwitchPortAutoMDIX, hpSwitchSLinkConfigStatus=hpSwitchSLinkConfigStatus, hpSwitchPendingConfig=hpSwitchPendingConfig, hpSwitchProbedVlanId=hpSwitchProbedVlanId, hpSwitchCosPortDSCPPolicy=hpSwitchCosPortDSCPPolicy, hpSwitchMeshBackwardCompatibility=hpSwitchMeshBackwardCompatibility, hpSwitchCosAddressIp=hpSwitchCosAddressIp, hpSwitchTelnetAdminStatus=hpSwitchTelnetAdminStatus, hpicfSwitchCLIOptimization=hpicfSwitchCLIOptimization, hpSwitchPortTaggedVlanMap2k=hpSwitchPortTaggedVlanMap2k, hpSwitchMaxUserSessions=hpSwitchMaxUserSessions, hpSwitchBWMinEgressPortPrctMedPriority=hpSwitchBWMinEgressPortPrctMedPriority, hpSwitchPortConfigStatus=hpSwitchPortConfigStatus, hpSwitchRebootConfig=hpSwitchRebootConfig, hpSwitchIpTimepInetServerAddr=hpSwitchIpTimepInetServerAddr, hpSwitchFilterName=hpSwitchFilterName, hpSwitchPortTrafficTemplateName=hpSwitchPortTrafficTemplateName, hpSwitchPortEEEMaxTwSysTx=hpSwitchPortEEEMaxTwSysTx, hpSwitchABCConfigVlanBcastLimit=hpSwitchABCConfigVlanBcastLimit, hpSwitchPortTable=hpSwitchPortTable, hpSwitchPortIsolationConfig=hpSwitchPortIsolationConfig, hpSwitchSLinkParity=hpSwitchSLinkParity, hpSwitchSystemConfigStatus=hpSwitchSystemConfigStatus, hpSwitchIpConfig=hpSwitchIpConfig, hpSwitchRateLimitPortPrctLowPriority=hpSwitchRateLimitPortPrctLowPriority, hpSwitchIgmpPriorityState=hpSwitchIgmpPriorityState, hpSwitchIpConfigStatus=hpSwitchIpConfigStatus, hpSwitchPortIsolationMode=hpSwitchPortIsolationMode, hpSwitchCosDSCPPolicyConfigTable=hpSwitchCosDSCPPolicyConfigTable, hpSwitchIgmpPortIndex=hpSwitchIgmpPortIndex, hpSwitchIgmpState=hpSwitchIgmpState, hpSwitchCosTosConfig=hpSwitchCosTosConfig, hpSwitchCosAppTypeConfigIndex=hpSwitchCosAppTypeConfigIndex, hpSwitchIgmpPortFastLeaveState=hpSwitchIgmpPortFastLeaveState, hpSwitchRebootFastBoot=hpSwitchRebootFastBoot, hpSwitchUsbConsoleAdminStatus=hpSwitchUsbConsoleAdminStatus, hpSwitchCosAddressConfigEntry=hpSwitchCosAddressConfigEntry, hpSwitchPortEEEMinTwSysTx1=hpSwitchPortEEEMinTwSysTx1, hpSwitchPortEEECurrentTwSysTx=hpSwitchPortEEECurrentTwSysTx, hpSwitchDSCPRateLimitConfigEntry=hpSwitchDSCPRateLimitConfigEntry, hpSwitchCosAppTypeConfigEntry=hpSwitchCosAppTypeConfigEntry, hpSwitchSshServerKeySize=hpSwitchSshServerKeySize, hpSwitchFilterSrcPort=hpSwitchFilterSrcPort, hpSwitchCosTosIndex=hpSwitchCosTosIndex, hpSwitchRateLimitPortConfigEntry=hpSwitchRateLimitPortConfigEntry, hpSwitchPortEtherMode=hpSwitchPortEtherMode, hpSwitchFddiIpFragConfigEntry=hpSwitchFddiIpFragConfigEntry, hpSwitchPortIsolationConfigTable=hpSwitchPortIsolationConfigTable, hpSwitchProbeType=hpSwitchProbeType, hpSwitchSshIpVersion=hpSwitchSshIpVersion, hpSwitchStpPortPathCost=hpSwitchStpPortPathCost, hpSwitchRateLimitPortControlMode=hpSwitchRateLimitPortControlMode, hpSwitchPreviewMode=hpSwitchPreviewMode, hpSwitchCosAppTypeConfigType=hpSwitchCosAppTypeConfigType, hpSwitchCosTosConfigTable=hpSwitchCosTosConfigTable, hpSwitchPortTrunkLACPStatus=hpSwitchPortTrunkLACPStatus, hpSwitchSLinkBaudRate=hpSwitchSLinkBaudRate, hpSwitchPendingConfigControl=hpSwitchPendingConfigControl, hpSwitchStpPortPvstProtection=hpSwitchStpPortPvstProtection, hpSwitchCosProtocolConfigEntry=hpSwitchCosProtocolConfigEntry, hpSwitchBWMinEgressPortPrctHighPriority=hpSwitchBWMinEgressPortPrctHighPriority, hpSwitchPortTaggedVlanMap4k=hpSwitchPortTaggedVlanMap4k, hpSwitchProbeConfig=hpSwitchProbeConfig, hpSwitchBWMinConfig=hpSwitchBWMinConfig, hpSwitchProtectedPortsConfig=hpSwitchProtectedPortsConfig, hpSwitchFddiIpFragConfigTable=hpSwitchFddiIpFragConfigTable, hpSwitchFddiIpFragConfigStatus=hpSwitchFddiIpFragConfigStatus, hpSwitchIgmpQuerierInterval=hpSwitchIgmpQuerierInterval, hpSwitchABCConfigControl=hpSwitchABCConfigControl, hpSwitchStpPortBpduFilter=hpSwitchStpPortBpduFilter, hpSwitchIgmpConfigEntry=hpSwitchIgmpConfigEntry, hpSwitchPortDevTypeTable=hpSwitchPortDevTypeTable, hpicfPrivateVlanPromiscuousPorts=hpicfPrivateVlanPromiscuousPorts, hpSwitchFilterConfigEntry=hpSwitchFilterConfigEntry, hpSwitchPortType=hpSwitchPortType, hpSwitchQueueWatchEntry=hpSwitchQueueWatchEntry, hpSwitchCosDSCPPolicyIndex=hpSwitchCosDSCPPolicyIndex, hpSwitchQueueWatchTable=hpSwitchQueueWatchTable, hpSwitchDSCPRateLimitKbps=hpSwitchDSCPRateLimitKbps, hpSwitchSshCipher=hpSwitchSshCipher, hpSwitchSessionGlobalIdleTimeout=hpSwitchSessionGlobalIdleTimeout, hpSwitchIgmpPortForcedLeaveState=hpSwitchIgmpPortForcedLeaveState, hpSwitchStpPortPvstFilter=hpSwitchStpPortPvstFilter, hpSwitchConsoleConfig=hpSwitchConsoleConfig, hpSwitchTraps=hpSwitchTraps, hpSwitchDSCPRateLimitConfigTable=hpSwitchDSCPRateLimitConfigTable, hpSwitchPortTaggedVlanMap1k=hpSwitchPortTaggedVlanMap1k, hpSwitchRateLimitPortSingleControlPrct=hpSwitchRateLimitPortSingleControlPrct, hpSwitchDSCPRateLimitIndex=hpSwitchDSCPRateLimitIndex, hpSwitchIgmpPortConfigEntry=hpSwitchIgmpPortConfigEntry, hpSwitchQueueWatchPort=hpSwitchQueueWatchPort, hpSwitchIfMauAutoNegCapAdvertisedBits=hpSwitchIfMauAutoNegCapAdvertisedBits, hpSwitchSTPAdminStatus=hpSwitchSTPAdminStatus, hpSwitchPortLinkbeat=hpSwitchPortLinkbeat, hpSwitchSshMAC=hpSwitchSshMAC, hpSwitchCosTosConfigMode=hpSwitchCosTosConfigMode, hpSwitchRateLimitPortIndex=hpSwitchRateLimitPortIndex, hpSwitchPortEEECurrentTwSysTx1=hpSwitchPortEEECurrentTwSysTx1, hpSwitchHibernate=hpSwitchHibernate, hpSwitchPortIsolationPort=hpSwitchPortIsolationPort, hpSwitchABCConfigVlan=hpSwitchABCConfigVlan, hpSwitchIpTimepIsOobm=hpSwitchIpTimepIsOobm, hpSwitchStpTrapCntl=hpSwitchStpTrapCntl)
mibBuilder.exportSymbols("CONFIG-MIB", hpSwitchIgmpConfig=hpSwitchIgmpConfig, hpSwitchSLinkModemLostRecvTime=hpSwitchSLinkModemLostRecvTime, hpSwitchFddiIpFragConfig=hpSwitchFddiIpFragConfig, hpSwitchSshFileServerAdminStatus=hpSwitchSshFileServerAdminStatus, hpSwitchMeshConfiguredId=hpSwitchMeshConfiguredId, hpSwitchSLinkCharBits=hpSwitchSLinkCharBits, hpSwitchFilterType=hpSwitchFilterType, hpSwitchIgmpForcedLeaveInterval=hpSwitchIgmpForcedLeaveInterval, hpSwitchSshReKeyTime=hpSwitchSshReKeyTime, hpSwitchStpPriority=hpSwitchStpPriority, hpSwitchMaxSessions=hpSwitchMaxSessions, hpSwitchCosAddressPriority=hpSwitchCosAddressPriority, hpSwitchRateLimitPortPrctNormalPriority=hpSwitchRateLimitPortPrctNormalPriority, hpSwitchPortPvid=hpSwitchPortPvid, hpSwitchCosPortType=hpSwitchCosPortType, hpSwitchProtectedPortsMask=hpSwitchProtectedPortsMask, hpSwitchSshConfig=hpSwitchSshConfig, hpSwitchTrunkConfig=hpSwitchTrunkConfig, hpSwitchDaylightBeginningDay=hpSwitchDaylightBeginningDay, hpSwitchPortEEEMaxTwSysTx1=hpSwitchPortEEEMaxTwSysTx1, hpSwitchCosPortIndex=hpSwitchCosPortIndex, hpSwitchPortEntry=hpSwitchPortEntry, hpSwitchCosAddressResolvedPriority=hpSwitchCosAddressResolvedPriority, hpSwitchCosVlanResolvedPriority=hpSwitchCosVlanResolvedPriority, hpSwitchPortVgMode=hpSwitchPortVgMode, hpSwitchCosLastChange=hpSwitchCosLastChange, hpSwitchProbeAdminStatus=hpSwitchProbeAdminStatus, hpSwitchBWMinEgressPortConfigTable=hpSwitchBWMinEgressPortConfigTable, hpSwitchIgmpDelayedGroupFlushTimer=hpSwitchIgmpDelayedGroupFlushTimer, hpSwitchIgmpProxyDomainMap=hpSwitchIgmpProxyDomainMap, hpSwitchCosPortPriority=hpSwitchCosPortPriority, hpSwitchPortMDIXStatus=hpSwitchPortMDIXStatus, hpSwitchPortDevTypeEntry=hpSwitchPortDevTypeEntry, hpSwitchFilterConfigTable=hpSwitchFilterConfigTable, hpSwitchCosPortConfigTable=hpSwitchCosPortConfigTable, Timeout=Timeout, hpSwitchAllowV1Modules=hpSwitchAllowV1Modules, hpSwitchABCConfig=hpSwitchABCConfig, hpSwitchStpErrantBpduSrcMac=hpSwitchStpErrantBpduSrcMac, hpSwitchBWMinEgressPortPrctLowPriority=hpSwitchBWMinEgressPortPrctLowPriority, hpSwitchStpVlan=hpSwitchStpVlan, hpSwitchPortPtpOperStatus=hpSwitchPortPtpOperStatus, hpSwitchIpTimepAdminStatus=hpSwitchIpTimepAdminStatus, hpSwitchIgmpVlanIndex=hpSwitchIgmpVlanIndex, hpSwitchPortEEEOperStatus=hpSwitchPortEEEOperStatus, hpSwitchCosIpv4AddressMask=hpSwitchCosIpv4AddressMask, hpSwitchFilterMacAddr=hpSwitchFilterMacAddr, hpSwitchTimeZone=hpSwitchTimeZone, hpSwitchRateLimitPortConfig=hpSwitchRateLimitPortConfig, hpSwitchABCConfigTable=hpSwitchABCConfigTable, hpSwitchControlUnknownIPMulticast=hpSwitchControlUnknownIPMulticast, hpSwitchSshVersion=hpSwitchSshVersion, hpSwitchTrunkMinActiveLinks=hpSwitchTrunkMinActiveLinks, hpSwitchMeshConfig=hpSwitchMeshConfig, hpSwitchStpPortErrantBpduCounter=hpSwitchStpPortErrantBpduCounter, hpSwitchIfMauAutoNegCapReceivedBits=hpSwitchIfMauAutoNegCapReceivedBits, hpSwitchConsoleConfigStatus=hpSwitchConsoleConfigStatus, hpSwitchBWMinEgressPortIndex=hpSwitchBWMinEgressPortIndex, hpSwitchQueueWatchState=hpSwitchQueueWatchState, hpSwitchIgmpConfigTable=hpSwitchIgmpConfigTable, hpSwitchStpPortTable=hpSwitchStpPortTable, hpSwitchStpErrantBpduDetector=hpSwitchStpErrantBpduDetector, hpSwitchStpPortType=hpSwitchStpPortType, hpSwitchCosAppTypeIpPacketType=hpSwitchCosAppTypeIpPacketType, hpSwitchPortAdminStatus=hpSwitchPortAdminStatus, hpSwitchTcpPushPreserveConfig=hpSwitchTcpPushPreserveConfig, hpSwitchFilterProtocolType=hpSwitchFilterProtocolType, hpSwitchMaxFrameSize=hpSwitchMaxFrameSize, hpSwitchStpForwardDelay=hpSwitchStpForwardDelay, hpSwitchCosTosConfigEntry=hpSwitchCosTosConfigEntry, hpSwitchIfMauAutoNegCapabilityBits=hpSwitchIfMauAutoNegCapabilityBits, hpSwitchStpPortMode=hpSwitchStpPortMode, hpSwitchIgmpQuerierState=hpSwitchIgmpQuerierState, hpSwitchPortConfig=hpSwitchPortConfig, hpSwitchCosPortPartnerDevice=hpSwitchCosPortPartnerDevice, hpSwitchCosProtocolPriority=hpSwitchCosProtocolPriority, hpSwitchIgmpPortVlanIndex2=hpSwitchIgmpPortVlanIndex2)
