...
mibBuilder.exportSymbols("BRCM-BATTERY-ENGINEERING-MIB", battSimulatePowerSource=battSimulatePowerSource, batteryEngrBase=batteryEngrBase, batteryEngineering=batteryEngineering, PYSNMP_MODULE_ID=batteryEngineering)
