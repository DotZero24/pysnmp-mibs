...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/h3c/H3C-EPON-MIB
...
h3cEponMibObjects.setRevisions(('2017-03-06 11:45', '2017-02-10 11:45', '2015-08-04 11:45',))
if mibBuilder.loadTexts: h3cEponMibObjects.setLastUpdated('201703061145Z')
...
h3cEponMonitorCycle = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 3600)).clone(80)).setMaxAccess("readwrite")
...
h3cEponAutoBindType = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 1, 16, 1, 8), Bits().clone(namedValues=NamedValues(("mac", 0), ("loid", 1), ("loidPassword", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cEponAutoBindType.setStatus('current')
...
h3cEponAuthMode = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 1, 21), Bits().clone(namedValues=NamedValues(("mac", 0), ("loid", 1), ("loidPassword", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cEponAuthMode.setStatus('current')
h3cEponOnuBindOneToOne = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 1, 22), TruthValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cEponOnuBindOneToOne.setStatus('current')
...
h3cOltAuthMode = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 1, 1, 8), Bits().clone(namedValues=NamedValues(("mac", 0), ("loid", 1), ("loidPassword", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOltAuthMode.setStatus('current')
h3cOltOnuBindOneToOne = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 1, 1, 9), TruthValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOltOnuBindOneToOne.setStatus('current')
...
h3cOltDbaDiscoveryLength = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 3, 1, 2), Integer32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOltDbaDiscoveryLength.setStatus('current')
h3cOltDbaDiscovryFrequency = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 3, 1, 3), Integer32()).setMaxAccess("readwrite")
...
h3cOnuSilentLoidTable = MibTable((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 23), )
if mibBuilder.loadTexts: h3cOnuSilentLoidTable.setStatus('current')
h3cOnuSilentLoidEntry = MibTableRow((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 23, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"), (0, "H3C-EPON-MIB", "h3cOnuSilentLoid"))
if mibBuilder.loadTexts: h3cOnuSilentLoidEntry.setStatus('current')
h3cOnuSilentLoid = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 23, 1, 1), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 24)))
if mibBuilder.loadTexts: h3cOnuSilentLoid.setStatus('current')
h3cOnuSilentLoidTime = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 23, 1, 2), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuSilentLoidTime.setStatus('current')
h3cOltTransceiverTxPowerTable = MibTable((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 24), )
if mibBuilder.loadTexts: h3cOltTransceiverTxPowerTable.setStatus('current')
h3cOltTransceiverTxPowerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 24, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"))
if mibBuilder.loadTexts: h3cOltTransceiverTxPowerEntry.setStatus('current')
h3cOltTransTxPwrTransId = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 24, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2))).clone(namedValues=NamedValues(("main", 0), ("standby", 1), ("all", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOltTransTxPwrTransId.setStatus('current')
h3cOltTransTxPwrOffTime = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 24, 1, 2), Unsigned32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOltTransTxPwrOffTime.setStatus('current')
h3cOltTransTxPwrIsAllOnu = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 24, 1, 3), TruthValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOltTransTxPwrIsAllOnu.setStatus('current')
h3cOltTransTxPwrOnuIfList = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 3, 24, 1, 4), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 20))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOltTransTxPwrOnuIfList.setStatus('current')
...
h3cOnuMacAddressTimer = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 1, 1, 16), Unsigned32().clone(300)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuMacAddressTimer.setStatus('current')
...
h3cOnuDownStreamMaxBandWidth = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 3, 1, 2), Integer32().clone(1000000)).setMaxAccess("readwrite")
...
h3cOnuSlaWrrBandWidth = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 4, 1, 8), Integer32().clone(1)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuSlaWrrBandWidth.setStatus('current')
...
h3cOnuBindLoid = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 7, 1, 3), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 24))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuBindLoid.setStatus('current')
h3cOnuBindPassword = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 7, 1, 4), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 12))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuBindPassword.setStatus('current')
...
h3cOnuUpdateProtType = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 8, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1))).clone(namedValues=NamedValues(("private", 0), ("ctc", 1))).clone('private')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuUpdateProtType.setStatus('current')
...
h3cOnuType = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 25, 1, 13), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuType.setStatus('current')
h3cOnuMultiLLID = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 25, 1, 14), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuMultiLLID.setStatus('current')
h3cOnuProtectionType = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 25, 1, 15), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuProtectionType.setStatus('current')
h3cOnuPonIFNum = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 25, 1, 16), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuPonIFNum.setStatus('current')
h3cOnuSlotNum = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 25, 1, 17), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuSlotNum.setStatus('current')
h3cOnuIPv6Supported = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 25, 1, 18), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuIPv6Supported.setStatus('current')
h3cOnuPowerSupplyControl = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 25, 1, 19), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuPowerSupplyControl.setStatus('current')
h3cOnuServiceSLA = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 25, 1, 20), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuServiceSLA.setStatus('current')
...
h3cOnuCosToLocalPrecedenceValue = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 27, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 3))).setMaxAccess("readwrite")
...
h3cEponStpPortDescr = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 28, 1, 2), OctetString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cEponStpPortDescr.setStatus('current')
h3cEponStpPortState = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 28, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("disabled", 1), ("discarding", 2), ("learning", 3), ("forwarding", 4)))).setMaxAccess("readonly")
...
h3cOnuDbaReport2Table = MibTable((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 35), )
if mibBuilder.loadTexts: h3cOnuDbaReport2Table.setStatus('current')
h3cOnuDbaReport2Entry = MibTableRow((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 35, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"), (0, "H3C-EPON-MIB", "h3cOnuDbaReport2QueueSetId"), (0, "H3C-EPON-MIB", "h3cOnuDbaReport2QueueId"))
if mibBuilder.loadTexts: h3cOnuDbaReport2Entry.setStatus('current')
h3cOnuDbaReport2QueueSetId = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 35, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 3)))
if mibBuilder.loadTexts: h3cOnuDbaReport2QueueSetId.setStatus('current')
h3cOnuDbaReport2QueueId = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 35, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 8)))
if mibBuilder.loadTexts: h3cOnuDbaReport2QueueId.setStatus('current')
h3cOnuDbaReport2Threshold = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 35, 1, 3), Integer32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuDbaReport2Threshold.setStatus('current')
h3cOnuDbaReport2Status = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 35, 1, 4), TruthValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuDbaReport2Status.setStatus('current')
h3cOnuLoidInfoTable = MibTable((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 36), )
if mibBuilder.loadTexts: h3cOnuLoidInfoTable.setStatus('current')
h3cOnuLoidInfoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 36, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"), (0, "H3C-EPON-MIB", "h3cOnuLoidIndex"))
if mibBuilder.loadTexts: h3cOnuLoidInfoEntry.setStatus('current')
h3cOnuLoidIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 36, 1, 1), Integer32())
if mibBuilder.loadTexts: h3cOnuLoidIndex.setStatus('current')
h3cOnuLoidFlag = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 36, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("bound", 1), ("registered", 2), ("run", 3), ("regIncorrect", 4)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuLoidFlag.setStatus('current')
h3cOnuLoid = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 36, 1, 3), OctetString().subtype(subtypeSpec=ValueSizeConstraint(1, 24))).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuLoid.setStatus('current')
h3cOnuStatisticsTable = MibTable((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 37), )
if mibBuilder.loadTexts: h3cOnuStatisticsTable.setStatus('current')
h3cOnuStatisticsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 37, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"))
if mibBuilder.loadTexts: h3cOnuStatisticsEntry.setStatus('current')
h3cOnuStatisticsPeriodVal = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 37, 1, 1), Unsigned32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuStatisticsPeriodVal.setStatus('current')
h3cOnuStatisticsEnable = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 37, 1, 2), TruthValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuStatisticsEnable.setStatus('current')
h3cOnuSlaMaxBandWidthMinVal10G = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 38), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuSlaMaxBandWidthMinVal10G.setStatus('current')
h3cOnuSlaMaxBandWidthMaxVal10G = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 39), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuSlaMaxBandWidthMaxVal10G.setStatus('current')
h3cOnuSlaMinBandWidthMinVal10G = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 40), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuSlaMinBandWidthMinVal10G.setStatus('current')
h3cOnuSlaMinBandWidthMaxVal10G = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 5, 41), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: h3cOnuSlaMinBandWidthMaxVal10G.setStatus('current')
...
h3cEponBatchOpBySlotBindType = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 6, 1, 1, 5), Bits().clone(namedValues=NamedValues(("mac", 0), ("loid", 1), ("loidPassword", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cEponBatchOpBySlotBindType.setStatus('current')
...
h3cOnuUpdateByTypeProtType = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 6, 3, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1))).clone(namedValues=NamedValues(("private", 0), ("ctc", 1))).clone('private')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cOnuUpdateByTypeProtType.setStatus('current')
...
h3cEponOnuRegSilentBindType = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 7, 14), Bits().clone(namedValues=NamedValues(("mac", 0), ("loid", 1), ("loidPassword", 2)))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: h3cEponOnuRegSilentBindType.setStatus('current')
h3cEponOnuRegSilentLoid = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 7, 15), OctetString()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: h3cEponOnuRegSilentLoid.setStatus('current')
h3cEponOnuRegSilentLoidPwd = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 7, 16), OctetString()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: h3cEponOnuRegSilentLoidPwd.setStatus('current')
h3cEponOnuRegErrorLoid = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 7, 17), OctetString()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: h3cEponOnuRegErrorLoid.setStatus('current')
h3cEponOnuRegErrorLoidCode = MibScalar((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 7, 18), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(("loidNotExist", 1), ("wrongPassword", 2), ("conflictLoid", 3), ("notSupport", 4), ("mismatch", 5)))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: h3cEponOnuRegErrorLoidCode.setStatus('current')
...
h3cEponOnuRegLoidErrTrap = NotificationType((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 8, 0, 38)).setObjects(("IF-MIB", "ifIndex"), ("IF-MIB", "ifDescr"), ("H3C-EPON-MIB", "h3cEponOnuRegErrorLoid"), ("H3C-EPON-MIB", "h3cEponOnuRegErrorLoidCode"))
if mibBuilder.loadTexts: h3cEponOnuRegLoidErrTrap.setStatus('current')
h3cEponOnuRegLoidErrRecTrap = NotificationType((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 8, 0, 39)).setObjects(("IF-MIB", "ifIndex"), ("IF-MIB", "ifDescr"), ("H3C-EPON-MIB", "h3cEponOnuRegErrorLoid"), ("H3C-EPON-MIB", "h3cEponOnuRegErrorLoidCode"))
if mibBuilder.loadTexts: h3cEponOnuRegLoidErrRecTrap.setStatus('current')
h3cEponOnuSilenceLoidTrap = NotificationType((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 8, 0, 40)).setObjects(("IF-MIB", "ifIndex"), ("IF-MIB", "ifDescr"), ("H3C-EPON-MIB", "h3cEponOnuRegSilentBindType"), ("H3C-EPON-MIB", "h3cEponOnuRegSilentMac"), ("H3C-EPON-MIB", "h3cEponOnuRegSilentLoid"), ("H3C-EPON-MIB", "h3cEponOnuRegSilentLoidPwd"))
if mibBuilder.loadTexts: h3cEponOnuSilenceLoidTrap.setStatus('current')
h3cEponOnuSilenceLoidRecTrap = NotificationType((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 8, 0, 41)).setObjects(("IF-MIB", "ifIndex"), ("IF-MIB", "ifDescr"), ("H3C-EPON-MIB", "h3cEponOnuRegSilentBindType"), ("H3C-EPON-MIB", "h3cEponOnuRegSilentMac"), ("H3C-EPON-MIB", "h3cEponOnuRegSilentLoid"), ("H3C-EPON-MIB", "h3cEponOnuRegSilentLoidPwd"))
if mibBuilder.loadTexts: h3cEponOnuSilenceLoidRecTrap.setStatus('current')
h3cEponOnuUpdateLoidRetTrap = NotificationType((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 8, 0, 42)).setObjects(("IF-MIB", "ifIndex"), ("IF-MIB", "ifDescr"), ("H3C-EPON-MIB", "h3cOnuBindLoid"), ("H3C-EPON-MIB", "h3cOnuUpdateResult"), ("H3C-EPON-MIB", "h3cOnuRegType"), ("H3C-EPON-MIB", "h3cOnuUpdateFileName"))
if mibBuilder.loadTexts: h3cEponOnuUpdateLoidRetTrap.setStatus('current')
h3cEponOnuAutoBindLoidTrap = NotificationType((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 8, 0, 43)).setObjects(("IF-MIB", "ifIndex"), ("IF-MIB", "ifDescr"), ("H3C-EPON-MIB", "h3cOnuBindLoid"), ("H3C-EPON-MIB", "h3cEponOperationResult"))
if mibBuilder.loadTexts: h3cEponOnuAutoBindLoidTrap.setStatus('current')
h3cEponOnuPowerOnTrap = NotificationType((1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 1, 8, 0, 44)).setObjects(("IF-MIB", "ifIndex"), ("IF-MIB", "ifDescr"))
if mibBuilder.loadTexts: h3cEponOnuPowerOnTrap.setStatus('current')
...
mibBuilder.exportSymbols("H3C-EPON-MIB", h3cOnuDownStreamHighPriorityFirst=h3cOnuDownStreamHighPriorityFirst, h3cOnuP2PMaxBandWidth=h3cOnuP2PMaxBandWidth, h3cEponEncryptionKeyErrRecoverTrap=h3cEponEncryptionKeyErrRecoverTrap, h3cEponAutoUpdateRealTimeStatus=h3cEponAutoUpdateRealTimeStatus, h3cOnuPriorityQueueSizeMaxVal=h3cOnuPriorityQueueSizeMaxVal, h3cOnuSmlkFirstPonRole=h3cOnuSmlkFirstPonRole, h3cEponOnuAutoBindLoidTrap=h3cEponOnuAutoBindLoidTrap, h3cOltWorkMode=h3cOltWorkMode, h3cOnuSmlkFirstPonStatus=h3cOnuSmlkFirstPonStatus, h3cOnuCountTable=h3cOnuCountTable, h3cEponSysManTable=h3cEponSysManTable, h3cOnuBandWidthEntry=h3cOnuBandWidthEntry, h3cEponAutoUpdateEntry=h3cEponAutoUpdateEntry, h3cOnuSilentEntry=h3cOnuSilentEntry, h3cOnuQueueMaxBurstsize=h3cOnuQueueMaxBurstsize, h3cEponLoopbackPortDescr=h3cEponLoopbackPortDescr, h3cOltPortAlarmFerMaxVal=h3cOltPortAlarmFerMaxVal, h3cEponMsgTimeOut=h3cEponMsgTimeOut, h3cOnuBindType=h3cOnuBindType, h3cEponOnuSilenceLoidTrap=h3cEponOnuSilenceLoidTrap, h3cOnuDownStreamMaxBandWidth=h3cOnuDownStreamMaxBandWidth, h3cEponMsgTimeOutMaxVal=h3cEponMsgTimeOutMaxVal, h3cOnuRS485Parity=h3cOnuRS485Parity, h3cOnuStpStatus=h3cOnuStpStatus, h3cOnuLinkTestResultSentFrameNum=h3cOnuLinkTestResultSentFrameNum, h3cOnuFirstPonMac=h3cOnuFirstPonMac, h3cOnuUpdate=h3cOnuUpdate, h3cEponPortAlarmBerRecoverTrap=h3cEponPortAlarmBerRecoverTrap, h3cEponMulticastControlEntry=h3cEponMulticastControlEntry, h3cOnuRS485PropertiesEntry=h3cOnuRS485PropertiesEntry, h3cOltUsingOnuEntry=h3cOltUsingOnuEntry, h3cEponLoopBackEnableRecoverTrap=h3cEponLoopBackEnableRecoverTrap, h3cOnuBandWidthTable=h3cOnuBandWidthTable, h3cOltLaserOnTimeMinVal=h3cOltLaserOnTimeMinVal, h3cOnuRS485SessionAddType=h3cOnuRS485SessionAddType, h3cOnuQueueId=h3cOnuQueueId, h3cOltPortAlarmFer=h3cOltPortAlarmFer, h3cOltDbaManEntry=h3cOltDbaManEntry, h3cEponMonitorCycle=h3cEponMonitorCycle, h3cOnuEncryptMan=h3cOnuEncryptMan, h3cOnuFirmwareUpdateEntry=h3cOnuFirmwareUpdateEntry, h3cOltPortAlarmRegistrationEnabled=h3cOltPortAlarmRegistrationEnabled, h3cEponOamDisconnectionTrap=h3cEponOamDisconnectionTrap, h3cOltFirmMinorVersion=h3cOltFirmMinorVersion, h3cEponLoopbackPortIndex=h3cEponLoopbackPortIndex, h3cOnuIgmpSnoopingHostAgingT=h3cOnuIgmpSnoopingHostAgingT, h3cOnuCosToLocalPrecedenceEntry=h3cOnuCosToLocalPrecedenceEntry, h3cOnuLinkTestEntry=h3cOnuLinkTestEntry, h3cOltPortAlarmLlidMismatchEnabled=h3cOltPortAlarmLlidMismatchEnabled, h3cOnuOutDroppedFrames=h3cOnuOutDroppedFrames, h3cOnuDbaReportEntry=h3cOnuDbaReportEntry, h3cOnuProtocolEntry=h3cOnuProtocolEntry, h3cOnuUpdateFileName=h3cOnuUpdateFileName, h3cOnuIpAddressTable=h3cOnuIpAddressTable, h3cOnuOpticalPowerReceivedByOlt=h3cOnuOpticalPowerReceivedByOlt, h3cOnuPriorityQueueBurstsizeMaxVal=h3cOnuPriorityQueueBurstsizeMaxVal, h3cEponBatchOpBySlotBindType=h3cEponBatchOpBySlotBindType, h3cOnuCosToLocalPrecedenceTable=h3cOnuCosToLocalPrecedenceTable, h3cOnuUpdateByTypeProtType=h3cOnuUpdateByTypeProtType, h3cOnuLinkTestResultRetErrFrameNum=h3cOnuLinkTestResultRetErrFrameNum, h3cEponOnuUpdateLoidRetTrap=h3cEponOnuUpdateLoidRetTrap, h3cEponOuiRowStatus=h3cEponOuiRowStatus, h3cOnuSilentTable=h3cOnuSilentTable, h3cOnuSlaBandWidthStepVal=h3cOnuSlaBandWidthStepVal, h3cEponOamVersion=h3cEponOamVersion, h3cEponOltDFETrap=h3cEponOltDFETrap, h3cOnuSlaMaxBandWidth=h3cOnuSlaMaxBandWidth, h3cOnuHardMajorVersion=h3cOnuHardMajorVersion, h3cEponOnuPowerOffTrap=h3cEponOnuPowerOffTrap, h3cOltUsingOnuIfIndex=h3cOltUsingOnuIfIndex, h3cEponEncryptionNoReplyTimeOut=h3cEponEncryptionNoReplyTimeOut, h3cOltUsingOnuTable=h3cOltUsingOnuTable, h3cOltDbaDiscoveryLengthMinVal=h3cOltDbaDiscoveryLengthMinVal, h3cOnuRegType=h3cOnuRegType, h3cOnuSlaFixedPacketSize=h3cOnuSlaFixedPacketSize, h3cOnuPriorityQueueEntry=h3cOnuPriorityQueueEntry, h3cEponStpPortIndex=h3cEponStpPortIndex, h3cOnuQueueScheduler=h3cOnuQueueScheduler, h3cOnuRemoteFecStatus=h3cOnuRemoteFecStatus, h3cOltLaserOffTimeMaxVal=h3cOltLaserOffTimeMaxVal, h3cOnuSlaMaxBandWidthMaxVal10G=h3cOnuSlaMaxBandWidthMaxVal10G, h3cOnuDhcpsnoopingOption82=h3cOnuDhcpsnoopingOption82, h3cOltMultiCopyBrdCast=h3cOltMultiCopyBrdCast, h3cOnuIPv6Supported=h3cOnuIPv6Supported, h3cOltAgcLockTime=h3cOltAgcLockTime, h3cOltDbaCycleLengthMaxVal=h3cOltDbaCycleLengthMaxVal, h3cEponOnuRegSilentLoidPwd=h3cEponOnuRegSilentLoidPwd, h3cEponErrorLLIDFrameTrap=h3cEponErrorLLIDFrameTrap, h3cOnuIpAddressEntry=h3cOnuIpAddressEntry, h3cOnuP2PShortFrameFirst=h3cOnuP2PShortFrameFirst, h3cOltSelfTestResult=h3cOltSelfTestResult, h3cOnuIpAddress=h3cOnuIpAddress, h3cEponOamVendorSpecificTrap=h3cEponOamVendorSpecificTrap, h3cOnuMacAddressTimer=h3cOnuMacAddressTimer, h3cEponMulticastStatus=h3cEponMulticastStatus, h3cOnuP2PHighPriorityFirst=h3cOnuP2PHighPriorityFirst, h3cOnuPowerSupplyControl=h3cOnuPowerSupplyControl, h3cOnuDbaReport2Entry=h3cOnuDbaReport2Entry, h3cOltPortAlarmFerThreshold=h3cOltPortAlarmFerThreshold, h3cOnuDbaReport2Status=h3cOnuDbaReport2Status, h3cEponMibObjects=h3cEponMibObjects, h3cOnuRS485DataBits=h3cOnuRS485DataBits, h3cOnuReAuthorize=h3cOnuReAuthorize, h3cEponPortAlarmFerTrap=h3cEponPortAlarmFerTrap, h3cOnuLinkTestVlanPriority=h3cOnuLinkTestVlanPriority, h3cOnuServiceSupported=h3cOnuServiceSupported, h3cOnuLoidInfoEntry=h3cOnuLoidInfoEntry, h3cOltLaserOffTimeMinVal=h3cOltLaserOffTimeMinVal, h3cEponMsgLoseNum=h3cEponMsgLoseNum, h3cOnuSlaManTable=h3cOnuSlaManTable, h3cOnuDot1xAccount=h3cOnuDot1xAccount, h3cOltHardMajorVersion=h3cOltHardMajorVersion, h3cEponAutomaticMode=h3cEponAutomaticMode, h3cOnuFirmwareUpdateByTypeEntry=h3cOnuFirmwareUpdateByTypeEntry, h3cOltFirmMajorVersion=h3cOltFirmMajorVersion, h3cOnuRS485SessionMaxNum=h3cOnuRS485SessionMaxNum, h3cOnuMacAddrInfoTable=h3cOnuMacAddrInfoTable, h3cEponSlotIndex=h3cEponSlotIndex, h3cEponOnuStpPortEntry=h3cEponOnuStpPortEntry, h3cOnuUpdateByTypeOnuType=h3cOnuUpdateByTypeOnuType, h3cOnuSlaMaxBandWidthMaxVal=h3cOnuSlaMaxBandWidthMaxVal, h3cEponErrorLLIDFrameRecoverTrap=h3cEponErrorLLIDFrameRecoverTrap, h3cEponOnuRegistrationErrTrap=h3cEponOnuRegistrationErrTrap, h3cEponOamVendorSpecificRecoverTrap=h3cEponOamVendorSpecificRecoverTrap, h3cEponAutoUpdateSchedType=h3cEponAutoUpdateSchedType, h3cOltPortAlarmBerEnabled=h3cOltPortAlarmBerEnabled, h3cOnuUpstreamQueueNumber=h3cOnuUpstreamQueueNumber, h3cOnuSlaFixedBandWidth=h3cOnuSlaFixedBandWidth, h3cEponOltSwitchoverTrap=h3cEponOltSwitchoverTrap, h3cOnuRS485ResetStatistics=h3cOnuRS485ResetStatistics, h3cOnuRS485BaudRate=h3cOnuRS485BaudRate, h3cOnuInfoEntry=h3cOnuInfoEntry, h3cOltDbaCycleLength=h3cOltDbaCycleLength, h3cOnuMcastCtrlHostAgingTime=h3cOnuMcastCtrlHostAgingTime, h3cOltPortAlarmLocalStableEnabled=h3cOltPortAlarmLocalStableEnabled, h3cOnuUpdateByTypeFileName=h3cOnuUpdateByTypeFileName, h3cOltSelfTest=h3cOltSelfTest, h3cEponMsgLoseNumMinVal=h3cEponMsgLoseNumMinVal, h3cDot3OamNonThresholdRecoverEvent=h3cDot3OamNonThresholdRecoverEvent, h3cOnuRS485SerialIndex=h3cOnuRS485SerialIndex, h3cOnuBindMacAddrTable=h3cOnuBindMacAddrTable, h3cEponOnuSilenceLoidRecTrap=h3cEponOnuSilenceLoidRecTrap, h3cEponPortLoopBackAlmEnable=h3cEponPortLoopBackAlmEnable, h3cOltMaxRtt=h3cOltMaxRtt, h3cOnuLinkTestFrameNum=h3cOnuLinkTestFrameNum, h3cOnuCapabilityEntry=h3cOnuCapabilityEntry, h3cOnuSmlkEntry=h3cOnuSmlkEntry, h3cEponBatchOperationBySlotIndex=h3cEponBatchOperationBySlotIndex, h3cOnuLinkTestDelay=h3cOnuLinkTestDelay, h3cOamEventLogLocation=h3cOamEventLogLocation, h3cOltDbaDiscovryFrequency=h3cOltDbaDiscovryFrequency, h3cOltDbaDiscovryFrequencyMaxVal=h3cOltDbaDiscovryFrequencyMaxVal, h3cOnuDownStreamShortFrameFirst=h3cOnuDownStreamShortFrameFirst, h3cOnuSlaMinBandWidthMaxVal10G=h3cOnuSlaMinBandWidthMaxVal10G, h3cOnuServiceSLA=h3cOnuServiceSLA, h3cEponEncryptionKeyErrTrap=h3cEponEncryptionKeyErrTrap, h3cOnuQueueDirection=h3cOnuQueueDirection, h3cOltAuthMode=h3cOltAuthMode, h3cOnuRS485SessionRemotePort=h3cOnuRS485SessionRemotePort, h3cOnuBatteryBackup=h3cOnuBatteryBackup, h3cOnuSmlkSecondPonRole=h3cOnuSmlkSecondPonRole, h3cOnuDistance=h3cOnuDistance, h3cEponOuiIndexNext=h3cEponOuiIndexNext, h3cOnuLaserOnTime=h3cOnuLaserOnTime, h3cOnuPortIsolateEnable=h3cOnuPortIsolateEnable, h3cEponAutoUpdateTable=h3cEponAutoUpdateTable, h3cOltDbaManTable=h3cOltDbaManTable, h3cEponSysMan=h3cEponSysMan, h3cEponOnuRegExcessRecoverTrap=h3cEponOnuRegExcessRecoverTrap, h3cOnuBindMacAddress=h3cOnuBindMacAddress, h3cOnuDot1xEntry=h3cOnuDot1xEntry, h3cEponMsgTimeOutMinVal=h3cEponMsgTimeOutMinVal, h3cOnuFirmwareUpdateTable=h3cOnuFirmwareUpdateTable, h3cOnuProtocolTable=h3cOnuProtocolTable, h3cEponOuiIndex=h3cEponOuiIndex, h3cEponBatchOperationByOLT=h3cEponBatchOperationByOLT, h3cOnuReset=h3cOnuReset, h3cOnuUniUpDownTrapStatus=h3cOnuUniUpDownTrapStatus, h3cOltDbaUpdateResult=h3cOltDbaUpdateResult, h3cEponOnuSilenceRecoverTrap=h3cEponOnuSilenceRecoverTrap, h3cOnuRS485SessionErrInfoTable=h3cOnuRS485SessionErrInfoTable, h3cEponBatchOperationByOLTTable=h3cEponBatchOperationByOLTTable, h3cOltLaserOffTime=h3cOltLaserOffTime, h3cEponAutoUpdateSchedTime=h3cEponAutoUpdateSchedTime, h3cOnuLinkTestResultMaxDelay=h3cOnuLinkTestResultMaxDelay, h3cOltInfoEntry=h3cOltInfoEntry, h3cEponBatchOperationByOLTResult=h3cEponBatchOperationByOLTResult, h3cEponMulticastVlanId=h3cEponMulticastVlanId, h3cEponStpPortState=h3cEponStpPortState, h3cOnuPortBerStatus=h3cOnuPortBerStatus, h3cEponOnuMan=h3cEponOnuMan, h3cEponSysScalarGroup=h3cEponSysScalarGroup, h3cEponStat=h3cEponStat, h3cOnuInCRCErrPkts=h3cOnuInCRCErrPkts, h3cOnuStatisticsPeriodVal=h3cOnuStatisticsPeriodVal, h3cEponMonitorCycleMaxVal=h3cEponMonitorCycleMaxVal, h3cOltDbaVersion=h3cOltDbaVersion, h3cEponFileName=h3cEponFileName, h3cEponOnuLaserFailedTrap=h3cEponOnuLaserFailedTrap, h3cEponBatchOperationByOLTType=h3cEponBatchOperationByOLTType, h3cOltPortAlarmEncryptionKeyEnabled=h3cOltPortAlarmEncryptionKeyEnabled, h3cEponAutoBindType=h3cEponAutoBindType, h3cEponOnuScalarGroup=h3cEponOnuScalarGroup, h3cOnuFEPortNumber=h3cOnuFEPortNumber, h3cOnuPriorityTrust=h3cOnuPriorityTrust, h3cEponSysManEntry=h3cEponSysManEntry, h3cEponBatchOperationBySlot=h3cEponBatchOperationBySlot, h3cEponOnuRegErrorLoid=h3cEponOnuRegErrorLoid, h3cOnuFirmwareVersion=h3cOnuFirmwareVersion, h3cEponBatchOperationBySlotType=h3cEponBatchOperationBySlotType, h3cEponOnuRegLoidErrRecTrap=h3cEponOnuRegLoidErrRecTrap, h3cOnuSilentLoidTable=h3cOnuSilentLoidTable, h3cOnuHardMinorVersion=h3cOnuHardMinorVersion, h3cEponLocalStableTrap=h3cEponLocalStableTrap, h3cOltPortAlarmBerMaxVal=h3cOltPortAlarmBerMaxVal, h3cOnuDownStreamMaxBurstSize=h3cOnuDownStreamMaxBurstSize, h3cEponSoftwareErrRecoverTrap=h3cEponSoftwareErrRecoverTrap, h3cOnuPacketManTable=h3cOnuPacketManTable, h3cOnuBindPassword=h3cOnuBindPassword, h3cOnuRS485SessionErrInfoEntry=h3cOnuRS485SessionErrInfoEntry, h3cOnuChipSetInfoEntry=h3cOnuChipSetInfoEntry, h3cOnuCosToLocalPrecedenceCosIndex=h3cOnuCosToLocalPrecedenceCosIndex, h3cOnuLinkTestFrameNumMaxVal=h3cOnuLinkTestFrameNumMaxVal, h3cOltDbaCycleLengthMinVal=h3cOltDbaCycleLengthMinVal, h3cOnuP2PBandWidthPolicy=h3cOnuP2PBandWidthPolicy, h3cEponOnuRegSilentMac=h3cEponOnuRegSilentMac, h3cEponOnuPortStpStateTrap=h3cEponOnuPortStpStateTrap, h3cOnuChipSetRevision=h3cOnuChipSetRevision, h3cOnuE1PortsNumber=h3cOnuE1PortsNumber, h3cOnuLinkTestResultMeanDelay=h3cOnuLinkTestResultMeanDelay, h3cEponRemoteStableRecoverTrap=h3cEponRemoteStableRecoverTrap, h3cOnuPacketManEntry=h3cOnuPacketManEntry, h3cEponOnuRegErrorLoidCode=h3cEponOnuRegErrorLoidCode, h3cOltPortAlarmVendorSpecificEnabled=h3cOltPortAlarmVendorSpecificEnabled, h3cOltPortAlarmLlidMisMinVal=h3cOltPortAlarmLlidMisMinVal, h3cOnuMacIndex=h3cOnuMacIndex, h3cOnuSlotNum=h3cOnuSlotNum, h3cEponEncryptionUpdateTime=h3cEponEncryptionUpdateTime, h3cOnuRS485TXOctets=h3cOnuRS485TXOctets, h3cOltDbaEnabledType=h3cOltDbaEnabledType, h3cEponOperationResult=h3cEponOperationResult, h3cEponOltMan=h3cEponOltMan, h3cOnuIgmpSnoopingRouterAgingT=h3cOnuIgmpSnoopingRouterAgingT, h3cEponOnuTypeManTable=h3cEponOnuTypeManTable, h3cOltTransTxPwrTransId=h3cOltTransTxPwrTransId, h3cEponOnuRegSilentBindType=h3cEponOnuRegSilentBindType, h3cEponErrorInfo=h3cEponErrorInfo, h3cEponStpPortDescr=h3cEponStpPortDescr, h3cOnuEEPROMVersion=h3cOnuEEPROMVersion, h3cOnuAccessVlan=h3cOnuAccessVlan, h3cOltAgcCdrTime=h3cOltAgcCdrTime, h3cOnuPOTSPortNumber=h3cOnuPOTSPortNumber, h3cOnuRS485SessionSummaryEntry=h3cOnuRS485SessionSummaryEntry, h3cEponStatEntry=h3cEponStatEntry)
mibBuilder.exportSymbols("H3C-EPON-MIB", h3cOnuLinkTestTable=h3cOnuLinkTestTable, h3cOamVendorSpecificAlarmCode=h3cOamVendorSpecificAlarmCode, h3cOnuDot1xPassword=h3cOnuDot1xPassword, h3cOnuRS485SessionType=h3cOnuRS485SessionType, h3cOnuSlaWrrBandWidth=h3cOnuSlaWrrBandWidth, h3cOnuPriorityQueueSizeMinVal=h3cOnuPriorityQueueSizeMinVal, h3cOnuIgmpSnoopingAggReportS=h3cOnuIgmpSnoopingAggReportS, h3cOnuQueueBandwidthEntry=h3cOnuQueueBandwidthEntry, h3cOnuDownstreamQueueNumber=h3cOnuDownstreamQueueNumber, h3cEponAutoBindStatus=h3cEponAutoBindStatus, h3cOnuFecStatus=h3cOnuFecStatus, h3cOltOpticalPowerTx=h3cOltOpticalPowerTx, h3cOnuManageVlanIntfS=h3cOnuManageVlanIntfS, h3cOnuPriorityQueueBurstsizeMinVal=h3cOnuPriorityQueueBurstsizeMinVal, h3cOnuRS485SessionLocalPort=h3cOnuRS485SessionLocalPort, h3cOnuUpdateByTypeNextIndex=h3cOnuUpdateByTypeNextIndex, h3cOnuDownStreamBandWidthPolicy=h3cOnuDownStreamBandWidthPolicy, h3cOnuManageVID=h3cOnuManageVID, h3cEponOnuRegistrationErrRecoverTrap=h3cEponOnuRegistrationErrRecoverTrap, h3cEponOnuAutoBindTrap=h3cEponOnuAutoBindTrap, h3cOltTransceiverTxPowerEntry=h3cOltTransceiverTxPowerEntry, h3cEponModeSwitch=h3cEponModeSwitch, h3cOnuUpdateProtType=h3cOnuUpdateProtType, h3cOnuSysManTable=h3cOnuSysManTable, h3cOnuMulticastFastLeaveEnable=h3cOnuMulticastFastLeaveEnable, h3cOltPortAlarmRegExcessEnabled=h3cOltPortAlarmRegExcessEnabled, h3cOltPortAlarmLlidMismatchThreshold=h3cOltPortAlarmLlidMismatchThreshold, h3cOnuDot1xTable=h3cOnuDot1xTable, h3cEponOnuSilenceTrap=h3cEponOnuSilenceTrap, h3cEponOamDiscoveryTimeout=h3cEponOamDiscoveryTimeout, h3cOnuSilentMacAddr=h3cOnuSilentMacAddr, h3cOltDbaDiscovryFrequencyMinVal=h3cOltDbaDiscovryFrequencyMinVal, h3cOnuFirstPonRegState=h3cOnuFirstPonRegState, h3cOnuSlaMaxBandWidthMinVal10G=h3cOnuSlaMaxBandWidthMinVal10G, h3cOnuType=h3cOnuType, h3cOnuStatisticsTable=h3cOnuStatisticsTable, h3cEponTrap=h3cEponTrap, h3cOnuQueueSize=h3cOnuQueueSize, h3cOnuPppoe=h3cOnuPppoe, h3cEponOnuTypeManEntry=h3cEponOnuTypeManEntry, h3cOnuLinkTestVlanTagID=h3cOnuLinkTestVlanTagID, h3cOnuMacAddress=h3cOnuMacAddress, h3cOnuP2PMaxBurstSize=h3cOnuP2PMaxBurstSize, h3cOnuDhcpsnooping=h3cOnuDhcpsnooping, h3cOnuPonIFNum=h3cOnuPonIFNum, h3cOnuChipSetModel=h3cOnuChipSetModel, h3cOnuGrantFifoDep=h3cOnuGrantFifoDep, h3cEponStatBER=h3cEponStatBER, h3cOltPortAlarmRemoteStableEnabled=h3cOltPortAlarmRemoteStableEnabled, h3cOltInfoTable=h3cOltInfoTable, h3cOnuCountEntry=h3cOnuCountEntry, h3cEponStatTable=h3cEponStatTable, h3cOltPortAlarmBerDirect=h3cOltPortAlarmBerDirect, h3cEponAuthMode=h3cEponAuthMode, h3cOltTransTxPwrOffTime=h3cOltTransTxPwrOffTime, h3cOnuIgspFastLeaveSupported=h3cOnuIgspFastLeaveSupported, h3cEponMulticastControlTable=h3cEponMulticastControlTable, h3cOnuSilentLoid=h3cOnuSilentLoid, h3cOnuProtectionType=h3cOnuProtectionType, h3cOnuSmlkSwitchoverTrap=h3cOnuSmlkSwitchoverTrap, h3cOnuIpAddressGateway=h3cOnuIpAddressGateway, h3cOltDbaUpdate=h3cOltDbaUpdate, h3cOnuRS485TXErrOctets=h3cOnuRS485TXErrOctets, h3cOnuRtt=h3cOnuRtt, h3cEponOltDFERecoverTrap=h3cEponOltDFERecoverTrap, h3cOnuBindLoid=h3cOnuBindLoid, h3cOnuLinkTestVlanTag=h3cOnuLinkTestVlanTag, h3cOnuSysManEntry=h3cOnuSysManEntry, h3cOnuPriorityQueueTable=h3cOnuPriorityQueueTable, h3cOnuDbaReportQueueSetNumber=h3cOnuDbaReportQueueSetNumber, h3cOnuLoid=h3cOnuLoid, h3cOnuMulticastFilterStatus=h3cOnuMulticastFilterStatus, h3cEponOnuRegSilentLoid=h3cEponOnuRegSilentLoid, h3cOltUsingOnuRowStatus=h3cOltUsingOnuRowStatus, h3cOnuUpdateByOnuTypeIndex=h3cOnuUpdateByOnuTypeIndex, h3cOnuSmlkGroupID=h3cOnuSmlkGroupID, h3cOnuSmlkTable=h3cOnuSmlkTable, h3cOnuUpdateByTypeRowStatus=h3cOnuUpdateByTypeRowStatus, h3cOnuDhcpallocate=h3cOnuDhcpallocate, h3cOltEnableDiscardPacket=h3cOltEnableDiscardPacket, h3cEponOuiIndexNextEntry=h3cEponOuiIndexNextEntry, h3cOnuWorkMode=h3cOnuWorkMode, h3cOltPortAlarmFerEnabled=h3cOltPortAlarmFerEnabled, h3cOnuRS485PropertiesTable=h3cOnuRS485PropertiesTable, h3cOnuRS485SessionTable=h3cOnuRS485SessionTable, h3cOltTransTxPwrOnuIfList=h3cOltTransTxPwrOnuIfList, h3cOnuQueuePolicyStatus=h3cOnuQueuePolicyStatus, h3cOnuStatisticsEnable=h3cOnuStatisticsEnable, h3cOltLaserOnTimeMaxVal=h3cOltLaserOnTimeMaxVal, h3cEponDbaUpdateFileName=h3cEponDbaUpdateFileName, h3cEponTrapPrefix=h3cEponTrapPrefix, h3cOnuQueueMaxBandwidth=h3cOnuQueueMaxBandwidth, h3cEponOuiIndexNextTable=h3cEponOuiIndexNextTable, h3cOnuRS485SessionIndex=h3cOnuRS485SessionIndex, h3cEponOuiValue=h3cEponOuiValue, h3cEponBatchOperationBySlotTable=h3cEponBatchOperationBySlotTable, h3cEponMonitorCycleEnable=h3cEponMonitorCycleEnable, h3cEponOnuTypeDescr=h3cEponOnuTypeDescr, h3cOnuLoidFlag=h3cOnuLoidFlag, h3cEponOuiTable=h3cEponOuiTable, h3cEponOnuRegLoidErrTrap=h3cEponOnuRegLoidErrTrap, h3cOnuDbaReport2QueueSetId=h3cOnuDbaReport2QueueSetId, h3cOltPortAlarmFerMinVal=h3cOltPortAlarmFerMinVal, h3cOnuMacAddrFlag=h3cOnuMacAddrFlag, h3cOnuDbaReportQueueId=h3cOnuDbaReportQueueId, h3cEponBatchOperationBySlotResult=h3cEponBatchOperationBySlotResult, h3cOltPortAlarmDFEEnabled=h3cOltPortAlarmDFEEnabled, h3cOnuSlaMinBandWidthMinVal10G=h3cOnuSlaMinBandWidthMinVal10G, h3cOnuSilentTime=h3cOnuSilentTime, h3cOltSysManTable=h3cOltSysManTable, h3cEponAutoUpdateFileName=h3cEponAutoUpdateFileName, h3cOltDbaDiscoveryLengthMaxVal=h3cOltDbaDiscoveryLengthMaxVal, h3cOltLaserOnTime=h3cOltLaserOnTime, h3cOnuPhysicalEntry=h3cOnuPhysicalEntry, h3cOnuSecondPonMac=h3cOnuSecondPonMac, h3cEponBatchOperationByOLTEntry=h3cEponBatchOperationByOLTEntry, h3cOltOnuBindOneToOne=h3cOltOnuBindOneToOne, h3cOltPortAlarmOamDisconnectionEnabled=h3cOltPortAlarmOamDisconnectionEnabled, h3cOnuLoidInfoTable=h3cOnuLoidInfoTable, h3cOnuFirmwareUpdateByTypeTable=h3cOnuFirmwareUpdateByTypeTable, h3cOltPortAlarmBerMinVal=h3cOltPortAlarmBerMinVal, h3cOnuMacAddrInfoEntry=h3cOnuMacAddrInfoEntry, h3cOnuRS485SessionSummaryTable=h3cOnuRS485SessionSummaryTable, h3cOnuRS485SessionNextIndex=h3cOnuRS485SessionNextIndex, h3cOnuIgmpSnoopingMaxRespT=h3cOnuIgmpSnoopingMaxRespT, h3cOnuDbaReport2Threshold=h3cOnuDbaReport2Threshold, h3cOnuSlaManEntry=h3cOnuSlaManEntry, h3cOnuSilentLoidEntry=h3cOnuSilentLoidEntry, h3cOnuDbaReport2QueueId=h3cOnuDbaReport2QueueId, h3cOnuLinkTestFrameNumMinVal=h3cOnuLinkTestFrameNumMinVal, h3cOnuDbaReport2Table=h3cOnuDbaReport2Table, h3cEponOamDisconnectionRecoverTrap=h3cEponOamDisconnectionRecoverTrap, h3cOnuIgmpSnoopingStatus=h3cOnuIgmpSnoopingStatus, h3cEponBatchOperationMan=h3cEponBatchOperationMan, h3cOnuLinkTestResultRetFrameNum=h3cOnuLinkTestResultRetFrameNum, h3cEponOnuTypeIndex=h3cEponOnuTypeIndex, h3cEponMulticastAddressList=h3cEponMulticastAddressList, h3cOnuSilentLoidTime=h3cOnuSilentLoidTime, h3cOnuPhysicalTable=h3cOnuPhysicalTable, h3cOltOpticalPowerRx=h3cOltOpticalPowerRx, PYSNMP_MODULE_ID=h3cEponMibObjects, h3cEponOnuUpdateFileName=h3cEponOnuUpdateFileName, h3cOnuIpAddressMask=h3cOnuIpAddressMask, h3cOnuStatisticsEntry=h3cOnuStatisticsEntry, h3cEponStatFER=h3cEponStatFER, h3cOltSysManEntry=h3cOltSysManEntry, h3cOnuDbaReportThreshold=h3cOnuDbaReportThreshold, h3cEponSoftwareErrorCode=h3cEponSoftwareErrorCode, h3cEponRemoteStableTrap=h3cEponRemoteStableTrap, h3cOnuBindMacAddrEntry=h3cOnuBindMacAddrEntry, h3cOnuSlaMaxBandWidthMinVal=h3cOnuSlaMaxBandWidthMinVal, h3cOnuInfoTable=h3cOnuInfoTable, h3cOnuRS485FlowControl=h3cOnuRS485FlowControl, h3cOnuChipSetVendorId=h3cOnuChipSetVendorId, h3cEponAutoUpdateSchedStatus=h3cEponAutoUpdateSchedStatus, h3cOltDbaDiscoveryLength=h3cOltDbaDiscoveryLength, h3cOnuMaxUpstreamQueuePerPort=h3cOnuMaxUpstreamQueuePerPort, h3cEponOnuPowerOnTrap=h3cEponOnuPowerOnTrap, h3cOnuSlaDelay=h3cOnuSlaDelay, h3cOnuUniMacType=h3cOnuUniMacType, h3cEponOnuBindOneToOne=h3cEponOnuBindOneToOne, h3cOnuUpdateResult=h3cOnuUpdateResult, h3cOnuVendorId=h3cOnuVendorId, h3cOnuHostType=h3cOnuHostType, h3cOnuIgmpSnoopingAggLeaveS=h3cOnuIgmpSnoopingAggLeaveS, h3cEponAutoAuthorize=h3cEponAutoAuthorize, h3cOnuPriorityQueueBandwidthMaxVal=h3cOnuPriorityQueueBandwidthMaxVal, h3cOltPortAlarmThresholdEntry=h3cOltPortAlarmThresholdEntry, h3cOnuLinkTestFrameSize=h3cOnuLinkTestFrameSize, h3cEponMonitorCycleMinVal=h3cEponMonitorCycleMinVal, h3cOnuSlaPriorityClass=h3cOnuSlaPriorityClass, h3cOltTransTxPwrIsAllOnu=h3cOltTransTxPwrIsAllOnu, h3cOnuRS485SessionEntry=h3cOnuRS485SessionEntry, h3cOnuRS485StopBits=h3cOnuRS485StopBits, h3cOnuSmlkSecondPonStatus=h3cOnuSmlkSecondPonStatus, h3cEponBatchOperationBySlotEntry=h3cEponBatchOperationBySlotEntry, h3cEponOnuLaserState=h3cEponOnuLaserState, h3cOnuLaserOffTime=h3cOnuLaserOffTime, h3cDot3OamThresholdRecoverEvent=h3cDot3OamThresholdRecoverEvent, h3cOnuQueueBandwidthTable=h3cOnuQueueBandwidthTable, h3cOnuPriorityQueueBandwidthMinVal=h3cOnuPriorityQueueBandwidthMinVal, h3cOnuMaxDownstreamQueuePerPort=h3cOnuMaxDownstreamQueuePerPort, h3cOnuMCtrlFastLeaveSupported=h3cOnuMCtrlFastLeaveSupported, h3cEponOnuUpdateResultTrap=h3cEponOnuUpdateResultTrap, h3cOnuCapabilityTable=h3cOnuCapabilityTable, h3cOltPortAlarmBerThreshold=h3cOltPortAlarmBerThreshold, h3cOnuLinkTestResultMinDelay=h3cOnuLinkTestResultMinDelay, h3cOnuEncryptKey=h3cOnuEncryptKey, h3cOltHardMinorVersion=h3cOltHardMinorVersion, h3cOnuCosToLocalPrecedenceValue=h3cOnuCosToLocalPrecedenceValue, h3cOnuRS485RXOctets=h3cOnuRS485RXOctets, h3cEponPortAlarmFerRecoverTrap=h3cEponPortAlarmFerRecoverTrap, h3cOnuMultiLLID=h3cOnuMultiLLID, h3cOnuRS485SessionRowStatus=h3cOnuRS485SessionRowStatus, h3cEponOltSoftwareErrAlmEnable=h3cEponOltSoftwareErrAlmEnable, h3cOnuMulticastControlMode=h3cOnuMulticastControlMode, h3cOnuChipSetDesignDate=h3cOnuChipSetDesignDate, h3cOnuSlaMinBandWidthMaxVal=h3cOnuSlaMinBandWidthMaxVal, h3cEponSysHasEPONBoard=h3cEponSysHasEPONBoard, h3cOltMacAddress=h3cOltMacAddress, h3cOltPortAlarmLlidMisMaxVal=h3cOltPortAlarmLlidMisMaxVal, h3cOnuGEPortNumber=h3cOnuGEPortNumber, h3cEponOnuRegErrorMacAddr=h3cEponOnuRegErrorMacAddr, h3cOnuRS485SessionRemoteIP=h3cOnuRS485SessionRemoteIP, h3cOnuLoidIndex=h3cOnuLoidIndex, h3cOltPortAlarmThresholdTable=h3cOltPortAlarmThresholdTable, h3cOltPortAlarmBer=h3cOltPortAlarmBer, h3cOnuRS485SessionErrInfo=h3cOnuRS485SessionErrInfo, h3cOnuSlaMinBandWidth=h3cOnuSlaMinBandWidth, h3cOnuSecondPonRegState=h3cOnuSecondPonRegState, h3cOnuChipSetInfoTable=h3cOnuChipSetInfoTable, h3cOnuDbaReportTable=h3cOnuDbaReportTable, h3cOnuRS485RXErrOctets=h3cOnuRS485RXErrOctets, h3cOnuLlid=h3cOnuLlid, h3cEponMsgLoseNumMaxVal=h3cEponMsgLoseNumMaxVal, h3cEponLocalStableRecoverTrap=h3cEponLocalStableRecoverTrap, h3cEponSoftwareErrTrap=h3cEponSoftwareErrTrap, h3cEponOnuStpPortTable=h3cEponOnuStpPortTable, h3cOamEventLogType=h3cOamEventLogType, h3cOltPortAlarmFerDirect=h3cOltPortAlarmFerDirect, h3cEponLoopBackEnableTrap=h3cEponLoopBackEnableTrap, h3cOnuBridgeMac=h3cOnuBridgeMac, h3cEponOuiEntry=h3cEponOuiEntry, h3cOltTransceiverTxPowerTable=h3cOltTransceiverTxPowerTable, h3cOltUsingOnuNum=h3cOltUsingOnuNum, h3cOnuPCBVersion=h3cOnuPCBVersion, h3cOnuSlaMinBandWidthMinVal=h3cOnuSlaMinBandWidthMinVal, h3cEponOnuRegExcessTrap=h3cEponOnuRegExcessTrap, h3cOnuSoftwareVersion=h3cOnuSoftwareVersion, h3cOnuDbaReportStatus=h3cOnuDbaReportStatus, h3cEponPortAlarmBerTrap=h3cEponPortAlarmBerTrap, h3cOltPortAlarmLlidMisFrames=h3cOltPortAlarmLlidMisFrames)
