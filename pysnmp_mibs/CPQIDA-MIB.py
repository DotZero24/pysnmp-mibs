...
# Produced by pysmi-1.6.2 at Fri Oct 10 19:40:18 2025
...
cpqDaSmartArraySecureEraseFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 3903)
)
cpqDaSmartArraySecureEraseFailed.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQIDA-MIB", "cpqDaPhyDrvCntlrIndex"),
        ("CPQIDA-MIB", "cpqDaPhyDrvIndex"),
...
if mibBuilder.loadTexts:
    cpqDaSmartArraySecureEraseFailed.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"cpqDa2LogDrvStatusChange": cpqDa2LogDrvStatusChange,
       ...
       "cpqDaSmartArraySecureEraseFailed": cpqDaSmartArraySecureEraseFailed,
