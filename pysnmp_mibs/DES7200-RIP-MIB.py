# SNMP MIB module (DES7200-RIP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-RIP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:48:32 2025
...
myRipEnable = _MyRipEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 1),
    _MyRipEnable_Type()
)
...
myRipUpdateTime = _MyRipUpdateTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 2),
...
myRipInvalidTime = _MyRipInvalidTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 3),
...
myRipHolddownTime = _MyRipHolddownTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 4),
...
myRipRecommendSetting = _MyRipRecommendSetting_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 5),
...
myRipIfStatIfIndex = _MyRipIfStatIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 6, 1, 1),
...
myRipIfStatRcvBadPackets = _MyRipIfStatRcvBadPackets_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 6, 1, 2),
...
myRipIfStatRcvBadRoutes = _MyRipIfStatRcvBadRoutes_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 6, 1, 3),
...
myRipIfStatSentUpdates = _MyRipIfStatSentUpdates_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 6, 1, 4),
...
myRipIfConfIfIndex = _MyRipIfConfIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 7, 1, 1),
...
myRipIfConfAuthType = _MyRipIfConfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 7, 1, 2),
...
myRipIfConfAuthKeyChain = _MyRipIfConfAuthKeyChain_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 7, 1, 3),
...
myRipIfConfSend = _MyRipIfConfSend_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 7, 1, 4),
...
myRipIfConfReceive = _MyRipIfConfReceive_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 7, 1, 5),
...
myRipIfPassiveStatus = _MyRipIfPassiveStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 7, 1, 6),
...
myRipIfBroadcastEnable = _MyRipIfBroadcastEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 7, 1, 7),
...
myRipIfAdminStat = _MyRipIfAdminStat_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 7, 1, 8),
...
myRipOffsetMetric = _MyRipOffsetMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 8),
...
myRipAdministrativeDistance = _MyRipAdministrativeDistance_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 9),
...
myRipValidateUpdateSrcEnable = _MyRipValidateUpdateSrcEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 10),
...
myRipPassiveStatus = _MyRipPassiveStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 11),
...
myRipNextDueIn = _MyRipNextDueIn_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 12),
...
myRipIfOffsetIfIndex = _MyRipIfOffsetIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 13, 1, 1),
...
myRipIfOffsetMethod = _MyRipIfOffsetMethod_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 13, 1, 2),
...
myRipIfOffsetAclName = _MyRipIfOffsetAclName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 13, 1, 3),
...
myRipIfOffsetMetric = _MyRipIfOffsetMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 13, 1, 4),
...
myRipIfOffsetStatus = _MyRipIfOffsetStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 13, 1, 5),
...
myRipNetworkAddr = _MyRipNetworkAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 14, 1, 1),
...
myRipNetworkMask = _MyRipNetworkMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 14, 1, 2),
...
myRipNetworkStatus = _MyRipNetworkStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 14, 1, 3),
...
myRipNeighborIndex = _MyRipNeighborIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 15, 1, 1),
...
myRipNeighborStatus = _MyRipNeighborStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 1, 15, 1, 2),
...
myRIPMIBConformance = _MyRIPMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 2)
)
_MyRIPMIBCompliances_ObjectIdentity = ObjectIdentity
myRIPMIBCompliances = _MyRIPMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 2, 1)
)
_MyRIPMIBGroups_ObjectIdentity = ObjectIdentity
myRIPMIBGroups = _MyRIPMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 2, 2)
)

# Managed Objects groups

myRipMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 2, 2, 1)
)
myRipMIBGroup.setObjects(
      *(("DES7200-RIP-MIB", "myRipEnable"),
        ("DES7200-RIP-MIB", "myRipUpdateTime"),
        ("DES7200-RIP-MIB", "myRipInvalidTime"),
        ("DES7200-RIP-MIB", "myRipHolddownTime"),
        ("DES7200-RIP-MIB", "myRipRecommendSetting"),
        ("DES7200-RIP-MIB", "myRipIfStatIfIndex"),
        ("DES7200-RIP-MIB", "myRipIfStatRcvBadPackets"),
        ("DES7200-RIP-MIB", "myRipIfStatRcvBadRoutes"),
        ("DES7200-RIP-MIB", "myRipIfStatSentUpdates"),
        ("DES7200-RIP-MIB", "myRipIfConfIfIndex"),
        ("DES7200-RIP-MIB", "myRipIfConfAuthType"),
        ("DES7200-RIP-MIB", "myRipIfConfAuthKeyChain"),
        ("DES7200-RIP-MIB", "myRipIfConfSend"),
        ("DES7200-RIP-MIB", "myRipIfConfReceive"),
        ("DES7200-RIP-MIB", "myRipIfPassiveStatus"),
        ("DES7200-RIP-MIB", "myRipIfBroadcastEnable"),
        ("DES7200-RIP-MIB", "myRipIfAdminStat"),
        ("DES7200-RIP-MIB", "myRipOffsetMetric"),
        ("DES7200-RIP-MIB", "myRipAdministrativeDistance"),
...
myRIPExtendMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 2, 2, 2)
)
myRIPExtendMIBGroup.setObjects(
      *(("DES7200-RIP-MIB", "myRipNextDueIn"),
        ("DES7200-RIP-MIB", "myRipIfOffsetIfIndex"),
        ("DES7200-RIP-MIB", "myRipIfOffsetMethod"),
        ("DES7200-RIP-MIB", "myRipIfOffsetAclName"),
        ("DES7200-RIP-MIB", "myRipIfOffsetMetric"),
        ("DES7200-RIP-MIB", "myRipIfOffsetStatus"),
        ("DES7200-RIP-MIB", "myRipNetworkAddr"),
        ("DES7200-RIP-MIB", "myRipNetworkMask"),
        ("DES7200-RIP-MIB", "myRipNetworkStatus"),
        ("DES7200-RIP-MIB", "myRipNeighborIndex"),
...
myRIPMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 13, 2, 1, 1)
)
myRIPMIBCompliance.setObjects(
      *(("DES7200-RIP-MIB", "myRipMIBGroup"),
        ("DES7200-RIP-MIB", "myRIPExtendMIBGroup"))
)
if mibBuilder.loadTexts:
