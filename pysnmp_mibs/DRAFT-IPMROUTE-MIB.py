#
# PySNMP MIB module DRAFT-IPMROUTE-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/juniper/DRAFT-IPMROUTE-MIB
...
ipMRoute1Entry = MibTableRow((1, 3, 6, 1, 3, 60, 1, 1, 2, 1), ).setIndexNames((0, "DRAFT-IPMROUTE-MIB", "ipMRoute1Group"), (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1Source"), (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1SourceMask"))
...
ipMRoute1NextHopEntry = MibTableRow((1, 3, 6, 1, 3, 60, 1, 1, 3, 1), ).setIndexNames((0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopGroup"), (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopSource"), (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopSourceMask"), (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopIfIndex"), (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopAddress"))
...
ipMRoute1InterfaceEntry = MibTableRow((1, 3, 6, 1, 3, 60, 1, 1, 4, 1), ).setIndexNames((0, "DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceIfIndex"))
...
ipMRoute1BoundaryEntry = MibTableRow((1, 3, 6, 1, 3, 60, 1, 1, 5, 1), ).setIndexNames((0, "DRAFT-IPMROUTE-MIB", "ipMRoute1BoundaryIfIndex"), (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1BoundaryAddress"), (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1BoundaryAddressMask"))
...
ipMRoute1ScopeNameEntry = MibTableRow((1, 3, 6, 1, 3, 60, 1, 1, 6, 1), ).setIndexNames((0, "DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameAddress"), (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameAddressMask"), (1, "DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameLanguage"))
...
ipMRoute1MIBCompliance = ModuleCompliance((1, 3, 6, 1, 3, 60, 2, 1, 1)).setObjects(("DRAFT-IPMROUTE-MIB", "ipMRoute1MIBBasicGroup"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1MIBRouteGroup"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1MIBBoundaryGroup"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1MIBHCInterfaceGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipMRoute1MIBCompliance = ipMRoute1MIBCompliance.setStatus('current')
ipMRoute1MIBBasicGroup = ObjectGroup((1, 3, 6, 1, 3, 60, 2, 2, 1)).setObjects(("DRAFT-IPMROUTE-MIB", "ipMRoute1Enable"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1EntryCount"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1UpstreamNeighbor"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1InIfIndex"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1UpTime"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1ExpiryTime"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopState"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopUpTime"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopExpiryTime"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopProtocol"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopPkts"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceTtl"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceProtocol"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceRateLimit"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceInMcastOctets"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceOutMcastOctets"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1Protocol"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipMRoute1MIBBasicGroup = ipMRoute1MIBBasicGroup.setStatus('current')
ipMRoute1MIBHopCountGroup = ObjectGroup((1, 3, 6, 1, 3, 60, 2, 2, 2)).setObjects(("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopClosestMemberHops"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipMRoute1MIBHopCountGroup = ipMRoute1MIBHopCountGroup.setStatus('current')
ipMRoute1MIBBoundaryGroup = ObjectGroup((1, 3, 6, 1, 3, 60, 2, 2, 3)).setObjects(("DRAFT-IPMROUTE-MIB", "ipMRoute1BoundaryStatus"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameString"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameDefault"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipMRoute1MIBBoundaryGroup = ipMRoute1MIBBoundaryGroup.setStatus('current')
ipMRoute1MIBPktsOutGroup = ObjectGroup((1, 3, 6, 1, 3, 60, 2, 2, 4)).setObjects(("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopPkts"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipMRoute1MIBPktsOutGroup = ipMRoute1MIBPktsOutGroup.setStatus('current')
ipMRoute1MIBHCInterfaceGroup = ObjectGroup((1, 3, 6, 1, 3, 60, 2, 2, 5)).setObjects(("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceHCInMcastOctets"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceHCOutMcastOctets"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1HCOctets"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipMRoute1MIBHCInterfaceGroup = ipMRoute1MIBHCInterfaceGroup.setStatus('current')
ipMRoute1MIBRouteGroup = ObjectGroup((1, 3, 6, 1, 3, 60, 2, 2, 6)).setObjects(("DRAFT-IPMROUTE-MIB", "ipMRoute1RtProto"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1RtAddress"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1RtMask"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1RtType"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipMRoute1MIBRouteGroup = ipMRoute1MIBRouteGroup.setStatus('current')
ipMRoute1MIBPktsGroup = ObjectGroup((1, 3, 6, 1, 3, 60, 2, 2, 7)).setObjects(("DRAFT-IPMROUTE-MIB", "ipMRoute1Pkts"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1DifferentInIfPackets"), ("DRAFT-IPMROUTE-MIB", "ipMRoute1Octets"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    ipMRoute1MIBPktsGroup = ipMRoute1MIBPktsGroup.setStatus('current')
mibBuilder.exportSymbols("DRAFT-IPMROUTE-MIB", IpMRoute1Protocol=IpMRoute1Protocol, ipMRoute1DifferentInIfPackets=ipMRoute1DifferentInIfPackets, ipMRoute1InterfaceIfIndex=ipMRoute1InterfaceIfIndex, ipMRoute1MIBCompliances=ipMRoute1MIBCompliances, ipMRoute1Group=ipMRoute1Group, ipMRoute1Protocol=ipMRoute1Protocol, ipMRoute1MIBCompliance=ipMRoute1MIBCompliance, ipMRoute1BoundaryAddressMask=ipMRoute1BoundaryAddressMask, ipMRoute1MIBHopCountGroup=ipMRoute1MIBHopCountGroup, ipMRoute1NextHopTable=ipMRoute1NextHopTable, ipMRoute1RtProto=ipMRoute1RtProto, ipMRoute1Pkts=ipMRoute1Pkts, ipMRoute1UpTime=ipMRoute1UpTime, ipMRoute1MIB=ipMRoute1MIB, ipMRoute1Octets=ipMRoute1Octets, ipMRoute1InterfaceTable=ipMRoute1InterfaceTable, ipMRoute1BoundaryTable=ipMRoute1BoundaryTable, ipMRoute1ScopeNameLanguage=ipMRoute1ScopeNameLanguage, ipMRoute1MIBGroups=ipMRoute1MIBGroups, ipMRoute1HCOctets=ipMRoute1HCOctets, ipMRoute1NextHopUpTime=ipMRoute1NextHopUpTime, ipMRoute1InterfaceTtl=ipMRoute1InterfaceTtl, ipMRoute1RtType=ipMRoute1RtType, ipMRoute1NextHopPkts=ipMRoute1NextHopPkts, ipMRoute1ScopeNameStatus=ipMRoute1ScopeNameStatus, ipMRoute1MIBRouteGroup=ipMRoute1MIBRouteGroup, ipMRoute1InterfaceProtocol=ipMRoute1InterfaceProtocol, ipMRoute1SourceMask=ipMRoute1SourceMask, ipMRoute1InterfaceHCOutMcastOctets=ipMRoute1InterfaceHCOutMcastOctets, ipMRoute1Entry=ipMRoute1Entry, ipMRoute1MIBBasicGroup=ipMRoute1MIBBasicGroup, ipMRoute1InterfaceOutMcastOctets=ipMRoute1InterfaceOutMcastOctets, ipMRoute1InterfaceInMcastOctets=ipMRoute1InterfaceInMcastOctets, ipMRoute1NextHopIfIndex=ipMRoute1NextHopIfIndex, ipMRoute1ScopeNameAddress=ipMRoute1ScopeNameAddress, ipMRoute1InterfaceEntry=ipMRoute1InterfaceEntry, ipMRoute1MIBPktsOutGroup=ipMRoute1MIBPktsOutGroup, ipMRoute1MIBObjects=ipMRoute1MIBObjects, ipMRoute1NextHopClosestMemberHops=ipMRoute1NextHopClosestMemberHops, ipMRoute1BoundaryEntry=ipMRoute1BoundaryEntry, ipMRoute1InterfaceRateLimit=ipMRoute1InterfaceRateLimit, ipMRoute1NextHopEntry=ipMRoute1NextHopEntry, ipMRoute1ScopeNameAddressMask=ipMRoute1ScopeNameAddressMask, ipMRoute1NextHopSource=ipMRoute1NextHopSource, ipMRoute1EntryCount=ipMRoute1EntryCount, ipMRoute1InterfaceHCInMcastOctets=ipMRoute1InterfaceHCInMcastOctets, ipMRoute1MIBHCInterfaceGroup=ipMRoute1MIBHCInterfaceGroup, PYSNMP_MODULE_ID=ipMRoute1MIB, ipMRoute1ScopeNameEntry=ipMRoute1ScopeNameEntry, ipMRoute1MIBBoundaryGroup=ipMRoute1MIBBoundaryGroup, ipMRoute1InIfIndex=ipMRoute1InIfIndex, ipMRoute1Enable=ipMRoute1Enable, ipMRoute1RtAddress=ipMRoute1RtAddress, ipMRoute1BoundaryIfIndex=ipMRoute1BoundaryIfIndex, ipMRoute1UpstreamNeighbor=ipMRoute1UpstreamNeighbor, ipMRoute1BoundaryStatus=ipMRoute1BoundaryStatus, ipMRoute1NextHopExpiryTime=ipMRoute1NextHopExpiryTime, ipMRoute1NextHopState=ipMRoute1NextHopState, ipMRoute1ScopeNameTable=ipMRoute1ScopeNameTable, ipMRoute1NextHopProtocol=ipMRoute1NextHopProtocol, ipMRoute1BoundaryAddress=ipMRoute1BoundaryAddress, ipMRoute1=ipMRoute1, ipMRoute1Source=ipMRoute1Source, ipMRoute1RtMask=ipMRoute1RtMask, ipMRoute1NextHopSourceMask=ipMRoute1NextHopSourceMask, ipMRoute1MIBConformance=ipMRoute1MIBConformance, ipMRoute1NextHopGroup=ipMRoute1NextHopGroup, ipMRoute1ScopeNameString=ipMRoute1ScopeNameString, ipMRoute1NextHopAddress=ipMRoute1NextHopAddress, ipMRoute1ExpiryTime=ipMRoute1ExpiryTime, ipMRoute1ScopeNameDefault=ipMRoute1ScopeNameDefault, ipMRoute1Table=ipMRoute1Table, ipMRoute1MIBPktsGroup=ipMRoute1MIBPktsGroup)
