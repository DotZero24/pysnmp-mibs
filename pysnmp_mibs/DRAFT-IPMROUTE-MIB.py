# SNMP MIB module (DRAFT-IPMROUTE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/juniper/DRAFT-IPMROUTE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:37:55 2025
...
ipMRoute1Entry.setIndexNames(
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1Group"),
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1Source"),
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1SourceMask"),
)
if mibBuilder.loadTexts:
...
ipMRoute1NextHopEntry.setIndexNames(
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopGroup"),
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopSource"),
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopSourceMask"),
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopIfIndex"),
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopAddress"),
)
if mibBuilder.loadTexts:
...
ipMRoute1InterfaceEntry.setIndexNames(
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
_IpMRoute1InterfaceRateLimit_Type.__name__ = "Integer32"
...
ipMRoute1BoundaryEntry.setIndexNames(
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1BoundaryIfIndex"),
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1BoundaryAddress"),
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1BoundaryAddressMask"),
)
if mibBuilder.loadTexts:
...
ipMRoute1ScopeNameEntry.setIndexNames(
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameAddress"),
    (0, "DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameAddressMask"),
    (1, "DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameLanguage"),
)
if mibBuilder.loadTexts:
...
_IpMRoute1ScopeNameDefault_Type.__name__ = "TruthValue"
...
ipMRoute1MIBBasicGroup.setObjects(
      *(("DRAFT-IPMROUTE-MIB", "ipMRoute1Enable"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1EntryCount"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1UpstreamNeighbor"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1InIfIndex"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1UpTime"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1ExpiryTime"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopState"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopUpTime"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopExpiryTime"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopProtocol"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopPkts"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceTtl"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceProtocol"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceRateLimit"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceInMcastOctets"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceOutMcastOctets"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1Protocol"))
)
if mibBuilder.loadTexts:
...
ipMRoute1MIBHopCountGroup.setObjects(
    ("DRAFT-IPMROUTE-MIB", "ipMRoute1NextHopClosestMemberHops")
)
if mibBuilder.loadTexts:
...
ipMRoute1MIBBoundaryGroup.setObjects(
      *(("DRAFT-IPMROUTE-MIB", "ipMRoute1BoundaryStatus"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameString"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameDefault"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1ScopeNameStatus"))
)
if mibBuilder.loadTexts:
...
ipMRoute1MIBHCInterfaceGroup.setObjects(
      *(("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceHCInMcastOctets"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1InterfaceHCOutMcastOctets"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1HCOctets"))
)
if mibBuilder.loadTexts:
...
ipMRoute1MIBRouteGroup.setObjects(
      *(("DRAFT-IPMROUTE-MIB", "ipMRoute1RtProto"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1RtAddress"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1RtMask"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1RtType"))
)
if mibBuilder.loadTexts:
...
ipMRoute1MIBPktsGroup.setObjects(
      *(("DRAFT-IPMROUTE-MIB", "ipMRoute1Pkts"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1DifferentInIfPackets"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1Octets"))
)
if mibBuilder.loadTexts:
...
ipMRoute1MIBCompliance.setObjects(
      *(("DRAFT-IPMROUTE-MIB", "ipMRoute1MIBBasicGroup"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1MIBRouteGroup"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1MIBBoundaryGroup"),
        ("DRAFT-IPMROUTE-MIB", "ipMRoute1MIBHCInterfaceGroup"))
)
if mibBuilder.loadTexts:
