...
# Notes
# -----
# ASN.1 source file://mibs/rfc/EBN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:20:05 2025
...
ebnCompliance.setObjects(
      *(("EBN-MIB", "ebnDirectoryGroup"),
        ("EBN-MIB", "ebnIsRscvGroup"),
        ("EBN-MIB", "ebnDirectoryConfigGroup"),
        ("EBN-MIB", "ebnCosMappingGroup"),
        ("EBN-MIB", "ebnSubnetRoutingListGroup"),
        ("EBN-MIB", "hbnIsInGroup"))
)
if mibBuilder.loadTexts:
