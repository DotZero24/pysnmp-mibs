...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-MPLS-L3VPN-STD-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:08 2025
...
class _RbnMplsL3VpnVrfRT_Type(MplsL3VpnRouteDistinguisher):
    """Custom type rbnMplsL3VpnVrfRT based on MplsL3VpnRouteDistinguisher"""
    defaultValue = OctetString("")


_RbnMplsL3VpnVrfRT_Type.__name__ = "MplsL3VpnRouteDistinguisher"
...
class _RbnMplsL3VpnVrfRTDescr_Type(SnmpAdminString):
    """Custom type rbnMplsL3VpnVrfRTDescr based on SnmpAdminString"""
    defaultValue = OctetString("")


_RbnMplsL3VpnVrfRTDescr_Type.__name__ = "SnmpAdminString"
...
rbnMplsL3VpnModuleCompliance.setObjects(
    ("RBN-MPLS-L3VPN-STD-EXT-MIB", "rbnMplsL3VpnGroup")
)
if mibBuilder.loadTexts:
