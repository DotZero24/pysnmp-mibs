...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SIP-UA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:42:52 2025
...
_CSipCfgBindSrcAddrInterface_Type.__name__ = "InterfaceIndexOrZero"
...
_CSipCfgRedirectionDisabled_Type.__name__ = "TruthValue"
...
_CSipCfgEarlyMediaCutThruDisabled_Type.__name__ = "TruthValue"
...
_CSipCfgSymNatEnabled_Type.__name__ = "TruthValue"
...
_CSipCfgBindSourceAddrInterface_Type.__name__ = "InterfaceIndexOrZero"
...
_CSipCfgSuspendResumeEnabled_Type.__name__ = "TruthValue"
...
_CSipCfgReasonHeaderOveride_Type.__name__ = "TruthValue"
...
_CSipCfgKeepalivePrimaryTarget_Type = SnmpAdminString
_CSipCfgKeepalivePrimaryTarget_Object = MibScalar
cSipCfgKeepalivePrimaryTarget = _CSipCfgKeepalivePrimaryTarget_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 17),
    _CSipCfgKeepalivePrimaryTarget_Type()
)
cSipCfgKeepalivePrimaryTarget.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgKeepalivePrimaryTarget.setStatus("current")


class _CSipCfgKeepalivePrimaryTransport_Type(Integer32):
    """Custom type cSipCfgKeepalivePrimaryTransport based on Integer32"""
    defaultValue = 2
...
_CSipCfgKeepalivePrimaryTransport_Type.__name__ = "Integer32"
_CSipCfgKeepalivePrimaryTransport_Object = MibScalar
cSipCfgKeepalivePrimaryTransport = _CSipCfgKeepalivePrimaryTransport_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 18),
    _CSipCfgKeepalivePrimaryTransport_Type()
)
cSipCfgKeepalivePrimaryTransport.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgKeepalivePrimaryTransport.setStatus("current")
_CSipCfgKeepaliveSecondaryTarget_Type = SnmpAdminString
_CSipCfgKeepaliveSecondaryTarget_Object = MibScalar
cSipCfgKeepaliveSecondaryTarget = _CSipCfgKeepaliveSecondaryTarget_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 19),
    _CSipCfgKeepaliveSecondaryTarget_Type()
)
cSipCfgKeepaliveSecondaryTarget.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgKeepaliveSecondaryTarget.setStatus("current")


class _CSipCfgKeepaliveSecondaryTransport_Type(Integer32):
    """Custom type cSipCfgKeepaliveSecondaryTransport based on Integer32"""
    defaultValue = 2
...
_CSipCfgKeepaliveSecondaryTransport_Type.__name__ = "Integer32"
_CSipCfgKeepaliveSecondaryTransport_Object = MibScalar
cSipCfgKeepaliveSecondaryTransport = _CSipCfgKeepaliveSecondaryTransport_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 20),
    _CSipCfgKeepaliveSecondaryTransport_Type()
)
cSipCfgKeepaliveSecondaryTransport.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgKeepaliveSecondaryTransport.setStatus("current")


class _CSipCfgKeepaliveTrigger_Type(Integer32):
    """Custom type cSipCfgKeepaliveTrigger based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CSipCfgKeepaliveTrigger_Type.__name__ = "Integer32"
_CSipCfgKeepaliveTrigger_Object = MibScalar
cSipCfgKeepaliveTrigger = _CSipCfgKeepaliveTrigger_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 21),
    _CSipCfgKeepaliveTrigger_Type()
)
cSipCfgKeepaliveTrigger.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgKeepaliveTrigger.setStatus("current")
_CSipCfgPermitHost_Type = SnmpAdminString
_CSipCfgPermitHost_Object = MibScalar
cSipCfgPermitHost = _CSipCfgPermitHost_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 22),
    _CSipCfgPermitHost_Type()
)
cSipCfgPermitHost.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPermitHost.setStatus("current")
_CSipCfgPrimaryRegistrarServer_Type = SnmpAdminString
_CSipCfgPrimaryRegistrarServer_Object = MibScalar
cSipCfgPrimaryRegistrarServer = _CSipCfgPrimaryRegistrarServer_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 23),
    _CSipCfgPrimaryRegistrarServer_Type()
)
cSipCfgPrimaryRegistrarServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPrimaryRegistrarServer.setStatus("current")


class _CSipCfgPrimaryRegistrarScheme_Type(Integer32):
    """Custom type cSipCfgPrimaryRegistrarScheme based on Integer32"""
    defaultValue = 1
...
_CSipCfgPrimaryRegistrarScheme_Type.__name__ = "Integer32"
_CSipCfgPrimaryRegistrarScheme_Object = MibScalar
cSipCfgPrimaryRegistrarScheme = _CSipCfgPrimaryRegistrarScheme_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 24),
    _CSipCfgPrimaryRegistrarScheme_Type()
)
cSipCfgPrimaryRegistrarScheme.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPrimaryRegistrarScheme.setStatus("current")


class _CSipCfgPrimaryRegistrarExpires_Type(Integer32):
    """Custom type cSipCfgPrimaryRegistrarExpires based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CSipCfgPrimaryRegistrarExpires_Type.__name__ = "Integer32"
_CSipCfgPrimaryRegistrarExpires_Object = MibScalar
cSipCfgPrimaryRegistrarExpires = _CSipCfgPrimaryRegistrarExpires_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 25),
    _CSipCfgPrimaryRegistrarExpires_Type()
)
cSipCfgPrimaryRegistrarExpires.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPrimaryRegistrarExpires.setStatus("current")


class _CSipCfgPrimaryRegistrarTransport_Type(Integer32):
    """Custom type cSipCfgPrimaryRegistrarTransport based on Integer32"""
    defaultValue = 1
...
_CSipCfgPrimaryRegistrarTransport_Type.__name__ = "Integer32"
_CSipCfgPrimaryRegistrarTransport_Object = MibScalar
cSipCfgPrimaryRegistrarTransport = _CSipCfgPrimaryRegistrarTransport_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 26),
    _CSipCfgPrimaryRegistrarTransport_Type()
)
cSipCfgPrimaryRegistrarTransport.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPrimaryRegistrarTransport.setStatus("current")
_CSipCfgSecondaryRegistrarServer_Type = SnmpAdminString
_CSipCfgSecondaryRegistrarServer_Object = MibScalar
cSipCfgSecondaryRegistrarServer = _CSipCfgSecondaryRegistrarServer_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 27),
    _CSipCfgSecondaryRegistrarServer_Type()
)
cSipCfgSecondaryRegistrarServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgSecondaryRegistrarServer.setStatus("current")


class _CSipCfgSecondaryRegistrarScheme_Type(Integer32):
    """Custom type cSipCfgSecondaryRegistrarScheme based on Integer32"""
    defaultValue = 1
...
_CSipCfgSecondaryRegistrarScheme_Type.__name__ = "Integer32"
_CSipCfgSecondaryRegistrarScheme_Object = MibScalar
cSipCfgSecondaryRegistrarScheme = _CSipCfgSecondaryRegistrarScheme_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 28),
    _CSipCfgSecondaryRegistrarScheme_Type()
)
cSipCfgSecondaryRegistrarScheme.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgSecondaryRegistrarScheme.setStatus("current")


class _CSipCfgSecondaryRegistrarExpires_Type(Integer32):
    """Custom type cSipCfgSecondaryRegistrarExpires based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 10000),
    )
...
_CSipCfgSecondaryRegistrarExpires_Type.__name__ = "Integer32"
_CSipCfgSecondaryRegistrarExpires_Object = MibScalar
cSipCfgSecondaryRegistrarExpires = _CSipCfgSecondaryRegistrarExpires_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 29),
    _CSipCfgSecondaryRegistrarExpires_Type()
)
cSipCfgSecondaryRegistrarExpires.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgSecondaryRegistrarExpires.setStatus("current")


class _CSipCfgSecondaryRegistrarTransport_Type(Integer32):
    """Custom type cSipCfgSecondaryRegistrarTransport based on Integer32"""
    defaultValue = 1
...
_CSipCfgSecondaryRegistrarTransport_Type.__name__ = "Integer32"
_CSipCfgSecondaryRegistrarTransport_Object = MibScalar
cSipCfgSecondaryRegistrarTransport = _CSipCfgSecondaryRegistrarTransport_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 1, 30),
    _CSipCfgSecondaryRegistrarTransport_Type()
)
cSipCfgSecondaryRegistrarTransport.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgSecondaryRegistrarTransport.setStatus("current")
...
class _CSipCfgTimerOptions_Type(Integer32):
    """Custom type cSipCfgTimerOptions based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(100, 1200),
    )


_CSipCfgTimerOptions_Type.__name__ = "Integer32"
_CSipCfgTimerOptions_Object = MibScalar
cSipCfgTimerOptions = _CSipCfgTimerOptions_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 2, 15),
    _CSipCfgTimerOptions_Type()
)
cSipCfgTimerOptions.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgTimerOptions.setStatus("current")
if mibBuilder.loadTexts:
    cSipCfgTimerOptions.setUnits("milliseconds")


class _CSipCfgTimerkeepaliveActive_Type(Integer32):
    """Custom type cSipCfgTimerkeepaliveActive based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CSipCfgTimerkeepaliveActive_Type.__name__ = "Integer32"
_CSipCfgTimerkeepaliveActive_Object = MibScalar
cSipCfgTimerkeepaliveActive = _CSipCfgTimerkeepaliveActive_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 2, 16),
    _CSipCfgTimerkeepaliveActive_Type()
)
cSipCfgTimerkeepaliveActive.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgTimerkeepaliveActive.setStatus("current")
if mibBuilder.loadTexts:
    cSipCfgTimerkeepaliveActive.setUnits("seconds")


class _CSipCfgTimerKeepaliveDown_Type(Integer32):
    """Custom type cSipCfgTimerKeepaliveDown based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CSipCfgTimerKeepaliveDown_Type.__name__ = "Integer32"
_CSipCfgTimerKeepaliveDown_Object = MibScalar
cSipCfgTimerKeepaliveDown = _CSipCfgTimerKeepaliveDown_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 2, 17),
    _CSipCfgTimerKeepaliveDown_Type()
)
cSipCfgTimerKeepaliveDown.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgTimerKeepaliveDown.setStatus("current")
if mibBuilder.loadTexts:
    cSipCfgTimerKeepaliveDown.setUnits("seconds")
...
class _CSipCfgRetryOptions_Type(Integer32):
    """Custom type cSipCfgRetryOptions based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 10),
    )
...
_CSipCfgRetryOptions_Type.__name__ = "Integer32"
_CSipCfgRetryOptions_Object = MibScalar
cSipCfgRetryOptions = _CSipCfgRetryOptions_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 3, 13),
    _CSipCfgRetryOptions_Type()
)
cSipCfgRetryOptions.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgRetryOptions.setStatus("current")


class _CSipCfgRetryKeepaliveDown_Type(Integer32):
    """Custom type cSipCfgRetryKeepaliveDown based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 10),
    )
...
_CSipCfgRetryKeepaliveDown_Type.__name__ = "Integer32"
_CSipCfgRetryKeepaliveDown_Object = MibScalar
cSipCfgRetryKeepaliveDown = _CSipCfgRetryKeepaliveDown_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 3, 14),
    _CSipCfgRetryKeepaliveDown_Type()
)
cSipCfgRetryKeepaliveDown.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgRetryKeepaliveDown.setStatus("current")


class _CSipCfgRetryKeepaliveActive_Type(Integer32):
    """Custom type cSipCfgRetryKeepaliveActive based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 10),
    )
...
_CSipCfgRetryKeepaliveActive_Type.__name__ = "Integer32"
_CSipCfgRetryKeepaliveActive_Object = MibScalar
cSipCfgRetryKeepaliveActive = _CSipCfgRetryKeepaliveActive_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 3, 15),
    _CSipCfgRetryKeepaliveActive_Type()
)
cSipCfgRetryKeepaliveActive.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgRetryKeepaliveActive.setStatus("current")
...
_CSipCfgPeerReliable1xxRspStr_Type.__name__ = "SnmpAdminString"
...
_CSipCfgPeerSwitchTransEnabled_Type.__name__ = "TruthValue"
...
class _CSipCfgPeerAssertedID_Type(Integer32):
    """Custom type cSipCfgPeerAssertedID based on Integer32"""
    defaultValue = 3
...
_CSipCfgPeerAssertedID_Type.__name__ = "Integer32"
_CSipCfgPeerAssertedID_Object = MibTableColumn
cSipCfgPeerAssertedID = _CSipCfgPeerAssertedID_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 7),
    _CSipCfgPeerAssertedID_Type()
)
cSipCfgPeerAssertedID.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerAssertedID.setStatus("current")


class _CSipCfgPeerPrivacy_Type(Bits):
    """Custom type cSipCfgPeerPrivacy based on Bits"""
    namedValues = NamedValues(
        *(("header", 1),
          ("session", 2),
          ("user", 3),
...
_CSipCfgPeerPrivacy_Type.__name__ = "Bits"
_CSipCfgPeerPrivacy_Object = MibTableColumn
cSipCfgPeerPrivacy = _CSipCfgPeerPrivacy_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 8),
    _CSipCfgPeerPrivacy_Type()
)
cSipCfgPeerPrivacy.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerPrivacy.setStatus("current")


class _CSipCfgPeerAsymmetricPayload_Type(Integer32):
    """Custom type cSipCfgPeerAsymmetricPayload based on Integer32"""
    defaultValue = 4
...
_CSipCfgPeerAsymmetricPayload_Type.__name__ = "Integer32"
_CSipCfgPeerAsymmetricPayload_Object = MibTableColumn
cSipCfgPeerAsymmetricPayload = _CSipCfgPeerAsymmetricPayload_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 9),
    _CSipCfgPeerAsymmetricPayload_Type()
)
cSipCfgPeerAsymmetricPayload.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerAsymmetricPayload.setStatus("current")
_CSipCfgPeerLocalHost_Type = SnmpAdminString
_CSipCfgPeerLocalHost_Object = MibTableColumn
cSipCfgPeerLocalHost = _CSipCfgPeerLocalHost_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 10),
    _CSipCfgPeerLocalHost_Type()
)
cSipCfgPeerLocalHost.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerLocalHost.setStatus("current")


class _CSipCfgPeerResourcePriorityMode_Type(Integer32):
    """Custom type cSipCfgPeerResourcePriorityMode based on Integer32"""
    defaultValue = 1
...
_CSipCfgPeerResourcePriorityMode_Type.__name__ = "Integer32"
_CSipCfgPeerResourcePriorityMode_Object = MibTableColumn
cSipCfgPeerResourcePriorityMode = _CSipCfgPeerResourcePriorityMode_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 11),
    _CSipCfgPeerResourcePriorityMode_Type()
)
cSipCfgPeerResourcePriorityMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerResourcePriorityMode.setStatus("current")


class _CSipCfgPeerResourcePriorityName_Type(Integer32):
    """Custom type cSipCfgPeerResourcePriorityName based on Integer32"""
    defaultValue = 4
...
_CSipCfgPeerResourcePriorityName_Type.__name__ = "Integer32"
_CSipCfgPeerResourcePriorityName_Object = MibTableColumn
cSipCfgPeerResourcePriorityName = _CSipCfgPeerResourcePriorityName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 12),
    _CSipCfgPeerResourcePriorityName_Type()
)
cSipCfgPeerResourcePriorityName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerResourcePriorityName.setStatus("current")


class _CSipCfgPeerE911_Type(TruthValue):
    """Custom type cSipCfgPeerE911 based on TruthValue"""
    defaultValue = 2


_CSipCfgPeerE911_Type.__name__ = "TruthValue"
_CSipCfgPeerE911_Object = MibTableColumn
cSipCfgPeerE911 = _CSipCfgPeerE911_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 13),
    _CSipCfgPeerE911_Type()
)
cSipCfgPeerE911.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerE911.setStatus("current")


class _CSipCfgPeerOptionsPingType_Type(Integer32):
    """Custom type cSipCfgPeerOptionsPingType based on Integer32"""
    defaultValue = 2
...
_CSipCfgPeerOptionsPingType_Type.__name__ = "Integer32"
_CSipCfgPeerOptionsPingType_Object = MibTableColumn
cSipCfgPeerOptionsPingType = _CSipCfgPeerOptionsPingType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 14),
    _CSipCfgPeerOptionsPingType_Type()
)
cSipCfgPeerOptionsPingType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerOptionsPingType.setStatus("current")


class _CSipCfgPeerOptionsPingInt_Type(Integer32):
    """Custom type cSipCfgPeerOptionsPingInt based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CSipCfgPeerOptionsPingInt_Type.__name__ = "Integer32"
_CSipCfgPeerOptionsPingInt_Object = MibTableColumn
cSipCfgPeerOptionsPingInt = _CSipCfgPeerOptionsPingInt_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 15),
    _CSipCfgPeerOptionsPingInt_Type()
)
cSipCfgPeerOptionsPingInt.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerOptionsPingInt.setStatus("current")


class _CSipCfgPeerClidStrip_Type(TruthValue):
    """Custom type cSipCfgPeerClidStrip based on TruthValue"""
    defaultValue = 2


_CSipCfgPeerClidStrip_Type.__name__ = "TruthValue"
_CSipCfgPeerClidStrip_Object = MibTableColumn
cSipCfgPeerClidStrip = _CSipCfgPeerClidStrip_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 16),
    _CSipCfgPeerClidStrip_Type()
)
cSipCfgPeerClidStrip.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerClidStrip.setStatus("current")


class _CSipCfgPeerClidNetpr_Type(TruthValue):
    """Custom type cSipCfgPeerClidNetpr based on TruthValue"""
    defaultValue = 2


_CSipCfgPeerClidNetpr_Type.__name__ = "TruthValue"
_CSipCfgPeerClidNetpr_Object = MibTableColumn
cSipCfgPeerClidNetpr = _CSipCfgPeerClidNetpr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 17),
    _CSipCfgPeerClidNetpr_Type()
)
cSipCfgPeerClidNetpr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerClidNetpr.setStatus("current")


class _CSipCfgPeerClidSubName_Type(TruthValue):
    """Custom type cSipCfgPeerClidSubName based on TruthValue"""
    defaultValue = 2


_CSipCfgPeerClidSubName_Type.__name__ = "TruthValue"
_CSipCfgPeerClidSubName_Object = MibTableColumn
cSipCfgPeerClidSubName = _CSipCfgPeerClidSubName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 1, 1, 18),
    _CSipCfgPeerClidSubName_Type()
)
cSipCfgPeerClidSubName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPeerClidSubName.setStatus("current")
...
_CSipCfgReliable1xxRspStr_Type.__name__ = "SnmpAdminString"
...
class _CSipCfgAssertedID_Type(Integer32):
    """Custom type cSipCfgAssertedID based on Integer32"""
    defaultValue = 3
...
_CSipCfgAssertedID_Type.__name__ = "Integer32"
_CSipCfgAssertedID_Object = MibScalar
cSipCfgAssertedID = _CSipCfgAssertedID_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 6),
    _CSipCfgAssertedID_Type()
)
cSipCfgAssertedID.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgAssertedID.setStatus("current")


class _CSipCfgPrivacy_Type(Bits):
    """Custom type cSipCfgPrivacy based on Bits"""
    namedValues = NamedValues(
        *(("header", 1),
          ("session", 2),
          ("user", 3),
...
_CSipCfgPrivacy_Type.__name__ = "Bits"
_CSipCfgPrivacy_Object = MibScalar
cSipCfgPrivacy = _CSipCfgPrivacy_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 7),
    _CSipCfgPrivacy_Type()
)
cSipCfgPrivacy.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgPrivacy.setStatus("current")


class _CSipCfgAsymmetricPayload_Type(Integer32):
    """Custom type cSipCfgAsymmetricPayload based on Integer32"""
    defaultValue = 4
...
_CSipCfgAsymmetricPayload_Type.__name__ = "Integer32"
_CSipCfgAsymmetricPayload_Object = MibScalar
cSipCfgAsymmetricPayload = _CSipCfgAsymmetricPayload_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 8),
    _CSipCfgAsymmetricPayload_Type()
)
cSipCfgAsymmetricPayload.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgAsymmetricPayload.setStatus("current")
_CSipCfgLocalHost_Type = SnmpAdminString
_CSipCfgLocalHost_Object = MibScalar
cSipCfgLocalHost = _CSipCfgLocalHost_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 9),
    _CSipCfgLocalHost_Type()
)
cSipCfgLocalHost.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgLocalHost.setStatus("current")


class _CSipCfgE911_Type(TruthValue):
    """Custom type cSipCfgE911 based on TruthValue"""
    defaultValue = 2


_CSipCfgE911_Type.__name__ = "TruthValue"
_CSipCfgE911_Object = MibScalar
cSipCfgE911 = _CSipCfgE911_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 10),
    _CSipCfgE911_Type()
)
cSipCfgE911.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgE911.setStatus("current")


class _CSipCfgOptionsPingInt_Type(Integer32):
    """Custom type cSipCfgOptionsPingInt based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(60, 1200),
    )
...
_CSipCfgOptionsPingInt_Type.__name__ = "Integer32"
_CSipCfgOptionsPingInt_Object = MibScalar
cSipCfgOptionsPingInt = _CSipCfgOptionsPingInt_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 11),
    _CSipCfgOptionsPingInt_Type()
)
cSipCfgOptionsPingInt.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgOptionsPingInt.setStatus("current")


class _CSipCfgClidStrip_Type(TruthValue):
    """Custom type cSipCfgClidStrip based on TruthValue"""
    defaultValue = 2


_CSipCfgClidStrip_Type.__name__ = "TruthValue"
_CSipCfgClidStrip_Object = MibScalar
cSipCfgClidStrip = _CSipCfgClidStrip_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 12),
    _CSipCfgClidStrip_Type()
)
cSipCfgClidStrip.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgClidStrip.setStatus("current")


class _CSipCfgClidNetpr_Type(TruthValue):
    """Custom type cSipCfgClidNetpr based on TruthValue"""
    defaultValue = 2


_CSipCfgClidNetpr_Type.__name__ = "TruthValue"
_CSipCfgClidNetpr_Object = MibScalar
cSipCfgClidNetpr = _CSipCfgClidNetpr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 13),
    _CSipCfgClidNetpr_Type()
)
cSipCfgClidNetpr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgClidNetpr.setStatus("current")


class _CSipCfgClidSubName_Type(TruthValue):
    """Custom type cSipCfgClidSubName based on TruthValue"""
    defaultValue = 2


_CSipCfgClidSubName_Type.__name__ = "TruthValue"
_CSipCfgClidSubName_Object = MibScalar
cSipCfgClidSubName = _CSipCfgClidSubName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 1, 4, 14),
    _CSipCfgClidSubName_Type()
)
cSipCfgClidSubName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cSipCfgClidSubName.setStatus("current")
...
_CSipCfgHeaderPassingEnabled_Type.__name__ = "TruthValue"
...
_CSipCfgSwitchTransportEnabled_Type.__name__ = "TruthValue"
...
_CSipStatsRetryOptions_Type = Counter32
_CSipStatsRetryOptions_Object = MibScalar
cSipStatsRetryOptions = _CSipStatsRetryOptions_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 2, 8, 13),
    _CSipStatsRetryOptions_Type()
)
cSipStatsRetryOptions.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cSipStatsRetryOptions.setStatus("current")
...
_CSipStatsActiveTLSConnections_Type = Gauge32
_CSipStatsActiveTLSConnections_Object = MibScalar
cSipStatsActiveTLSConnections = _CSipStatsActiveTLSConnections_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 2, 10, 10),
    _CSipStatsActiveTLSConnections_Type()
)
cSipStatsActiveTLSConnections.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cSipStatsActiveTLSConnections.setStatus("current")
_CSipStatsConnTLSCreateFailures_Type = Counter32
_CSipStatsConnTLSCreateFailures_Object = MibScalar
cSipStatsConnTLSCreateFailures = _CSipStatsConnTLSCreateFailures_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 2, 10, 11),
    _CSipStatsConnTLSCreateFailures_Type()
)
cSipStatsConnTLSCreateFailures.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cSipStatsConnTLSCreateFailures.setStatus("current")
_CSipStatsConnTLSSendFailures_Type = Counter32
_CSipStatsConnTLSSendFailures_Object = MibScalar
cSipStatsConnTLSSendFailures = _CSipStatsConnTLSSendFailures_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 2, 10, 12),
    _CSipStatsConnTLSSendFailures_Type()
)
cSipStatsConnTLSSendFailures.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cSipStatsConnTLSSendFailures.setStatus("current")
_CSipStatsConnTLSInactiveTimeouts_Type = Counter32
_CSipStatsConnTLSInactiveTimeouts_Object = MibScalar
cSipStatsConnTLSInactiveTimeouts = _CSipStatsConnTLSInactiveTimeouts_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 2, 10, 13),
    _CSipStatsConnTLSInactiveTimeouts_Type()
)
cSipStatsConnTLSInactiveTimeouts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cSipStatsConnTLSInactiveTimeouts.setStatus("current")
_CSipStatsConnTLSRemoteClosures_Type = Counter32
_CSipStatsConnTLSRemoteClosures_Object = MibScalar
cSipStatsConnTLSRemoteClosures = _CSipStatsConnTLSRemoteClosures_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 1, 2, 10, 14),
    _CSipStatsConnTLSRemoteClosures_Type()
)
cSipStatsConnTLSRemoteClosures.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cSipStatsConnTLSRemoteClosures.setStatus("current")
...
if mibBuilder.loadTexts:
    ciscoSipTimerConfigGroupRev4.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    ciscoSipRetryStatsGroupRev4.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    ciscoSipBaseIOSConfigGroupRev1.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    ciscoSipCfgPeerGroupRev1.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    ciscoSipStatsConnectionGroup.setStatus("deprecated")

ciscoSipCfgPeerGroupRev2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 3, 2, 48)
)
ciscoSipCfgPeerGroupRev2.setObjects(
      *(("CISCO-SIP-UA-MIB", "cSipCfgPeerOutSessionTransport"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerReliable1xxRspStr"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerReliable1xxRspHdr"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerUrlType"),
        ...
        ("CISCO-SIP-UA-MIB", "cSipCfgUrlType"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerSwitchTransEnabled"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerAssertedID"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerAsymmetricPayload"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerLocalHost"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerResourcePriorityMode"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerResourcePriorityName"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerE911"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerOptionsPingType"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerOptionsPingInt"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerPrivacy"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerClidStrip"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerClidNetpr"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPeerClidSubName"),
        ("CISCO-SIP-UA-MIB", "cSipCfgAssertedID"),
        ("CISCO-SIP-UA-MIB", "cSipCfgAsymmetricPayload"),
        ("CISCO-SIP-UA-MIB", "cSipCfgLocalHost"),
        ("CISCO-SIP-UA-MIB", "cSipCfgE911"),
        ("CISCO-SIP-UA-MIB", "cSipCfgOptionsPingInt"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPrivacy"),
        ("CISCO-SIP-UA-MIB", "cSipCfgClidStrip"),
        ("CISCO-SIP-UA-MIB", "cSipCfgClidNetpr"),
        ("CISCO-SIP-UA-MIB", "cSipCfgClidSubName"))
)
if mibBuilder.loadTexts:
    ciscoSipCfgPeerGroupRev2.setStatus("current")

ciscoSipBaseIOSConfigGroupRev2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 3, 2, 49)
)
ciscoSipBaseIOSConfigGroupRev2.setObjects(
      *(("CISCO-SIP-UA-MIB", "cSipCfgMaximumForwards"),
        ("CISCO-SIP-UA-MIB", "cSipCfgDnsSrvQueryStringFormat"),
        ("CISCO-SIP-UA-MIB", "cSipCfgRedirectionDisabled"),
        ("CISCO-SIP-UA-MIB", "cSipCfgTimerSessionTimer"),
        ...
        ("CISCO-SIP-UA-MIB", "cSipCfgOfferCallHold"),
        ("CISCO-SIP-UA-MIB", "cSipCfgReasonHeaderOveride"),
        ("CISCO-SIP-UA-MIB", "cSipCfgKeepalivePrimaryTarget"),
        ("CISCO-SIP-UA-MIB", "cSipCfgKeepalivePrimaryTransport"),
        ("CISCO-SIP-UA-MIB", "cSipCfgKeepaliveSecondaryTarget"),
        ("CISCO-SIP-UA-MIB", "cSipCfgKeepaliveSecondaryTransport"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPermitHost"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPrimaryRegistrarServer"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPrimaryRegistrarScheme"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPrimaryRegistrarExpires"),
        ("CISCO-SIP-UA-MIB", "cSipCfgPrimaryRegistrarTransport"),
        ("CISCO-SIP-UA-MIB", "cSipCfgSecondaryRegistrarServer"),
        ("CISCO-SIP-UA-MIB", "cSipCfgSecondaryRegistrarScheme"),
        ("CISCO-SIP-UA-MIB", "cSipCfgSecondaryRegistrarExpires"),
        ("CISCO-SIP-UA-MIB", "cSipCfgSecondaryRegistrarTransport"))
)
if mibBuilder.loadTexts:
    ciscoSipBaseIOSConfigGroupRev2.setStatus("current")

ciscoSipTimerConfigGroupRev5 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 3, 2, 50)
)
ciscoSipTimerConfigGroupRev5.setObjects(
      *(("CISCO-SIP-UA-MIB", "cSipCfgTimerTrying"),
        ("CISCO-SIP-UA-MIB", "cSipCfgTimerExpires"),
        ("CISCO-SIP-UA-MIB", "cSipCfgTimerConnect"),
        ("CISCO-SIP-UA-MIB", "cSipCfgTimerDisconnect"),
        ...
        ("CISCO-SIP-UA-MIB", "cSipCfgTimerConnectionAging"),
        ("CISCO-SIP-UA-MIB", "cSipCfgTimerBufferInvite"),
        ("CISCO-SIP-UA-MIB", "cSipCfgTimerOptions"),
        ("CISCO-SIP-UA-MIB", "cSipCfgTimerkeepaliveActive"),
        ("CISCO-SIP-UA-MIB", "cSipCfgTimerKeepaliveDown"))
)
if mibBuilder.loadTexts:
    ciscoSipTimerConfigGroupRev5.setStatus("current")

ciscoSipRetryStatsGroupRev5 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 3, 2, 51)
)
ciscoSipRetryStatsGroupRev5.setObjects(
      *(("CISCO-SIP-UA-MIB", "cSipStatsRetryInvites"),
        ("CISCO-SIP-UA-MIB", "cSipStatsRetryByes"),
        ("CISCO-SIP-UA-MIB", "cSipStatsRetryCancels"),
        ("CISCO-SIP-UA-MIB", "cSipStatsRetryRegisters"),
        ...
        ("CISCO-SIP-UA-MIB", "cSipStatsRetryInfo"),
        ("CISCO-SIP-UA-MIB", "cSipStatsRetrySubscribe"),
        ("CISCO-SIP-UA-MIB", "cSipCfgRetryOptions"),
        ("CISCO-SIP-UA-MIB", "cSipCfgRetryKeepaliveDown"),
        ("CISCO-SIP-UA-MIB", "cSipCfgRetryKeepaliveActive"))
)
if mibBuilder.loadTexts:
    ciscoSipRetryStatsGroupRev5.setStatus("current")

ciscoSipStatsConnectionGroupRev1 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 3, 2, 52)
)
ciscoSipStatsConnectionGroupRev1.setObjects(
      *(("CISCO-SIP-UA-MIB", "cSipStatsConnTCPSendFailures"),
        ("CISCO-SIP-UA-MIB", "cSipStatsConnUDPSendFailures"),
        ("CISCO-SIP-UA-MIB", "cSipStatsConnTCPRemoteClosures"),
        ("CISCO-SIP-UA-MIB", "cSipStatsConnUDPCreateFailures"),
        ...
        ("CISCO-SIP-UA-MIB", "cSipStatsActiveUDPConnections"),
        ("CISCO-SIP-UA-MIB", "cSipStatsActiveTCPConnections"),
        ("CISCO-SIP-UA-MIB", "cSipStatsActiveTLSConnections"),
        ("CISCO-SIP-UA-MIB", "cSipStatsConnTLSSendFailures"),
        ("CISCO-SIP-UA-MIB", "cSipStatsConnTLSRemoteClosures"),
        ("CISCO-SIP-UA-MIB", "cSipStatsConnTLSCreateFailures"),
        ("CISCO-SIP-UA-MIB", "cSipStatsConnTLSInactiveTimeouts"))
)
if mibBuilder.loadTexts:
    ciscoSipStatsConnectionGroupRev1.setStatus("current")
...
ciscoSipCompliance.setObjects(
      *(("CISCO-SIP-UA-MIB", "ciscoSipBaseConfigGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsInfoStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsSuccessStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsGlobalStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTrafficStatsGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTimerConfigGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryConfigGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryStatsGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsRedirStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsClientStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsServerStatusCodesGroup"))
)
if mibBuilder.loadTexts:
...
ciscoSipComplianceRev1.setObjects(
      *(("CISCO-SIP-UA-MIB", "ciscoSipBaseConfigGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsInfoStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsSuccessStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsGlobalStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTrafficStatsGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTimerConfigGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryConfigGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryStatsGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsRedirStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsClientStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsServerStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgPeerGroup"))
)
if mibBuilder.loadTexts:
...
ciscoSipComplianceRev2.setObjects(
      *(("CISCO-SIP-UA-MIB", "ciscoSipBaseConfigGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsInfoStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsSuccessStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsGlobalStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTrafficStatsGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTimerConfigGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryConfigGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryStatsGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsRedirStatusCodesGroupRev1"),
...
ciscoSipComplianceRev3.setObjects(
      *(("CISCO-SIP-UA-MIB", "ciscoSipBaseConfigGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsInfoStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsSuccessStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsGlobalStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTrafficStatsGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTimerConfigGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryConfigGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryStatsGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsRedirStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsClientStatusCodesGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsServerStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgPeerGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgAaaGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatusCauseMapGroup"))
)
if mibBuilder.loadTexts:
...
ciscoSipComplianceRev4.setObjects(
      *(("CISCO-SIP-UA-MIB", "ciscoSipBaseConfigGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsInfoStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsSuccessStatusCodesGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsGlobalStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTrafficStatsGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipTimerConfigGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryConfigGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryStatsGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsRedirStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsClientStatusCodesGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsServerStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgPeerGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgAaaGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatusCauseMapGroup"),
...
ciscoSipComplianceRev5.setObjects(
      *(("CISCO-SIP-UA-MIB", "ciscoSipBaseConfigGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsInfoStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsSuccessStatusCodesGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsGlobalStatusCodesGroup"),
        ...
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryConfigGroupRev4"),
        ("CISCO-SIP-UA-MIB", "ciscoSipRetryStatsGroupRev4"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsRedirStatusCodesGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsClientStatusCodesGroupRev4"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsServerStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgPeerGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgAaaGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatusCauseMapGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsMiscGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipBaseIOSConfigGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgVoiceServiceVoipGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsConnectionGroup"))
)
if mibBuilder.loadTexts:
...
ciscoSipComplianceRev6 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 9, 9, 152, 3, 1, 7)
)
ciscoSipComplianceRev6.setObjects(
      *(("CISCO-SIP-UA-MIB", "ciscoSipBaseConfigGroupRev3"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsInfoStatusCodesGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsSuccessStatusCodesGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsGlobalStatusCodesGroup"),
        ...
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsClientStatusCodesGroupRev4"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsServerStatusCodesGroupRev1"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgPeerGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgAaaGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatusCauseMapGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsMiscGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipBaseIOSConfigGroupRev2"),
        ("CISCO-SIP-UA-MIB", "ciscoSipCfgVoiceServiceVoipGroup"),
        ("CISCO-SIP-UA-MIB", "ciscoSipStatsConnectionGroup"))
)
if mibBuilder.loadTexts:
    ciscoSipComplianceRev6.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"CSipStatusCode": CSipStatusCode,
       ...
       "cSipCfgKeepalivePrimaryTarget": cSipCfgKeepalivePrimaryTarget,
       "cSipCfgKeepalivePrimaryTransport": cSipCfgKeepalivePrimaryTransport,
       "cSipCfgKeepaliveSecondaryTarget": cSipCfgKeepaliveSecondaryTarget,
       "cSipCfgKeepaliveSecondaryTransport": cSipCfgKeepaliveSecondaryTransport,
       "cSipCfgKeepaliveTrigger": cSipCfgKeepaliveTrigger,
       "cSipCfgPermitHost": cSipCfgPermitHost,
       "cSipCfgPrimaryRegistrarServer": cSipCfgPrimaryRegistrarServer,
       "cSipCfgPrimaryRegistrarScheme": cSipCfgPrimaryRegistrarScheme,
       "cSipCfgPrimaryRegistrarExpires": cSipCfgPrimaryRegistrarExpires,
       "cSipCfgPrimaryRegistrarTransport": cSipCfgPrimaryRegistrarTransport,
       "cSipCfgSecondaryRegistrarServer": cSipCfgSecondaryRegistrarServer,
       "cSipCfgSecondaryRegistrarScheme": cSipCfgSecondaryRegistrarScheme,
       "cSipCfgSecondaryRegistrarExpires": cSipCfgSecondaryRegistrarExpires,
       "cSipCfgSecondaryRegistrarTransport": cSipCfgSecondaryRegistrarTransport,
       ...
       "cSipCfgTimerOptions": cSipCfgTimerOptions,
       "cSipCfgTimerkeepaliveActive": cSipCfgTimerkeepaliveActive,
       "cSipCfgTimerKeepaliveDown": cSipCfgTimerKeepaliveDown,
       ...
       "cSipCfgRetryOptions": cSipCfgRetryOptions,
       "cSipCfgRetryKeepaliveDown": cSipCfgRetryKeepaliveDown,
       "cSipCfgRetryKeepaliveActive": cSipCfgRetryKeepaliveActive,
       ...
       "cSipCfgPeerAssertedID": cSipCfgPeerAssertedID,
       "cSipCfgPeerPrivacy": cSipCfgPeerPrivacy,
       "cSipCfgPeerAsymmetricPayload": cSipCfgPeerAsymmetricPayload,
       "cSipCfgPeerLocalHost": cSipCfgPeerLocalHost,
       "cSipCfgPeerResourcePriorityMode": cSipCfgPeerResourcePriorityMode,
       "cSipCfgPeerResourcePriorityName": cSipCfgPeerResourcePriorityName,
       "cSipCfgPeerE911": cSipCfgPeerE911,
       "cSipCfgPeerOptionsPingType": cSipCfgPeerOptionsPingType,
       "cSipCfgPeerOptionsPingInt": cSipCfgPeerOptionsPingInt,
       "cSipCfgPeerClidStrip": cSipCfgPeerClidStrip,
       "cSipCfgPeerClidNetpr": cSipCfgPeerClidNetpr,
       "cSipCfgPeerClidSubName": cSipCfgPeerClidSubName,
       ...
       "cSipCfgAssertedID": cSipCfgAssertedID,
       "cSipCfgPrivacy": cSipCfgPrivacy,
       "cSipCfgAsymmetricPayload": cSipCfgAsymmetricPayload,
       "cSipCfgLocalHost": cSipCfgLocalHost,
       "cSipCfgE911": cSipCfgE911,
       "cSipCfgOptionsPingInt": cSipCfgOptionsPingInt,
       "cSipCfgClidStrip": cSipCfgClidStrip,
       "cSipCfgClidNetpr": cSipCfgClidNetpr,
       "cSipCfgClidSubName": cSipCfgClidSubName,
       ...
       "cSipStatsRetryOptions": cSipStatsRetryOptions,
       ...
       "cSipStatsActiveTLSConnections": cSipStatsActiveTLSConnections,
       "cSipStatsConnTLSCreateFailures": cSipStatsConnTLSCreateFailures,
       "cSipStatsConnTLSSendFailures": cSipStatsConnTLSSendFailures,
       "cSipStatsConnTLSInactiveTimeouts": cSipStatsConnTLSInactiveTimeouts,
       "cSipStatsConnTLSRemoteClosures": cSipStatsConnTLSRemoteClosures,
       ...
       "ciscoSipComplianceRev6": ciscoSipComplianceRev6,
       ...
       "ciscoSipCfgPeerGroupRev2": ciscoSipCfgPeerGroupRev2,
       "ciscoSipBaseIOSConfigGroupRev2": ciscoSipBaseIOSConfigGroupRev2,
       "ciscoSipTimerConfigGroupRev5": ciscoSipTimerConfigGroupRev5,
       "ciscoSipRetryStatsGroupRev5": ciscoSipRetryStatsGroupRev5,
       "ciscoSipStatsConnectionGroupRev1": ciscoSipStatsConnectionGroupRev1}
)
