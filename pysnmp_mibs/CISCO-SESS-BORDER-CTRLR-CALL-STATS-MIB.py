...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:39:41 2025
...
csbCallStatsMIBCompliance.setObjects(
      *(("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbGlobalStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbCurrPeriodicStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbHistoryStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbPerFlowStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbH248StatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbStatsInstanceGroup"))
)
if mibBuilder.loadTexts:
...
csbCallStatsMIBComplianceRev1.setObjects(
      *(("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbGlobalStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbCurrPeriodicStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbHistoryStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbPerFlowStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbH248StatsGroupRev1"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbStatsInstanceGroup"))
)
if mibBuilder.loadTexts:
...
csbCallStatsMIBComplianceRev2.setObjects(
      *(("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbGlobalStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbCurrPeriodicStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbHistoryStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbPerFlowStatsGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbH248StatsGroupRev1"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbStatsInstanceGroup"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbGlobalStatsGroupSup1"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbCurrPeriodicStatsGroupSup1"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbHistoryStatsGroupSup1"),
        ("CISCO-SESS-BORDER-CTRLR-CALL-STATS-MIB", "csbPerFlowStatsGroupSup1"))
)
if mibBuilder.loadTexts:
