# SNMP MIB module (P8610-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/P8610-MIB
...
trapTest.setObjects(
      *(("P8610-MIB", "sensorName"),
        ("P8610-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
