# SNMP MIB module (MY-PRODUCTS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-PRODUCTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:35:06 2025
...
(myModules,
 myRouterProducts,
 mySwitchProducts,
 myWirelessProducts) = mibBuilder.importSymbols(
    "MY-SMI",
    "myModules",
    "myRouterProducts",
    "mySwitchProducts",
...
myProductsMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 4, 1)
)
if mibBuilder.loadTexts:
    myProductsMIB.setRevisions(
        ("2002-03-20 00:00",)
    )
...
s3760_48V2 = _S3760_48V2_ObjectIdentity(
...
s3750E_12SFP_GT = _S3750E_12SFP_GT_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 52)
)
...
s2928G = _S2928G_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 79)
)
_S2952G_ObjectIdentity = ObjectIdentity
s2952G = _S2952G_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 80)
)
_S2028G_ObjectIdentity = ObjectIdentity
s2028G = _S2028G_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 81)
)
_S2528G_ObjectIdentity = ObjectIdentity
s2528G = _S2528G_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 82)
)
_S2552G_ObjectIdentity = ObjectIdentity
s2552G = _S2552G_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 83)
)
_S5750R_48GT_4SFP_ObjectIdentity = ObjectIdentity
s5750R_48GT_4SFP = _S5750R_48GT_4SFP_ObjectIdentity(
...
s5750R_24GT_4SFP = _S5750R_24GT_4SFP_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 86)
)
_S5750P_24GT_4SFP_ObjectIdentity = ObjectIdentity
s5750P_24GT_4SFP = _S5750P_24GT_4SFP_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 87)
)
_S5750_24GT_4SFP_ObjectIdentity = ObjectIdentity
s5750_24GT_4SFP = _S5750_24GT_4SFP_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 88)
)
_S5750S_24GT_4SFP_ObjectIdentity = ObjectIdentity
s5750S_24GT_4SFP = _S5750S_24GT_4SFP_ObjectIdentity(
...
nm2x_24esw = _Nm2x_24esw_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 95)
)
_Nm2x_16esw_ObjectIdentity = ObjectIdentity
nm2x_16esw = _Nm2x_16esw_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 1, 96)
)
...
nm2_16esw = _Nm2_16esw_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 2, 1, 1, 36)
)
_Nm2_24esw_ObjectIdentity = ObjectIdentity
nm2_24esw = _Nm2_24esw_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 2, 1, 1, 37)
)
_Nmx_24esw_ObjectIdentity = ObjectIdentity
nmx_24esw = _Nmx_24esw_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 2, 1, 1, 38)
)
_Nmx_24esw_l2_ObjectIdentity = ObjectIdentity
nmx_24esw_l2 = _Nmx_24esw_l2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 2, 1, 1, 39)
)
_Nmx_24esw_3gel3_ObjectIdentity = ObjectIdentity
nmx_24esw_3gel3 = _Nmx_24esw_3gel3_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4881, 1, 2, 1, 1, 40)
)
...
mibBuilder.exportSymbols(
    ...
    **{"s2126G": s2126G,
       ...
       "s2924": s2924,
       "s3760-24": s3760_24,
       "s3760-48V2": s3760_48V2,
       "s3750E-24": s3750E_24,
       "s3750E-48": s3750E_48,
       "s3750E-12SFP-GT": s3750E_12SFP_GT,
       ...
       "s2352G": s2352G,
       "s8614": s8614,
       "s5650-24GT-4SFP": s5650_24GT_4SFP,
       "s5650-27XG": s5650_27XG,
       "s5650-51XG": s5650_51XG,
       "s5450-28GT": s5450_28GT,
       "s3760E-24": s3760E_24,
       "s3250P-24": s3250P_24,
       "s2928G": s2928G,
       "s2952G": s2952G,
       ...
       "s2528G": s2528G,
       "s2552G": s2552G,
       "s5750R-48GT-4SFP": s5750R_48GT_4SFP,
       "s5750P-48GT-4SFP": s5750P_48GT_4SFP,
       "s5750R-24GT-4SFP": s5750R_24GT_4SFP,
       "s5750P-24GT-4SFP": s5750P_24GT_4SFP,
       "s5750-24GT-4SFP": s5750_24GT_4SFP,
       "s5750S-24GT-4SFP": s5750S_24GT_4SFP,
       "s5750-48GT-4SFP-A": s5750_48GT_4SFP_A,
       "s5750-48GT-4SFP-AP": s5750_48GT_4SFP_AP,
       "nm2x-24esw": nm2x_24esw,
       "nm2x-16esw": nm2x_16esw,
       "myProductsMIB": myProductsMIB,
       "r2620": r2620,
       "r2624": r2624,
       "r2690": r2690,
       "r2692": r2692,
       ...
       "nm2-24esw": nm2_24esw,
       "nmx-24esw": nmx_24esw,
       "nmx-24esw-l2": nmx_24esw_l2,
       "nmx-24esw-3gel3": nmx_24esw_3gel3,
       "rsr20-14": rsr20_14,
       "rsr30-44": rsr30_44,
       "r2700v2v3": r2700v2v3,
       "r2700v5": r2700v5,
