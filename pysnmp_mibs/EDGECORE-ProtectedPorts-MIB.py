# SNMP MIB module (EDGECORE-ProtectedPorts-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/edgecore/EDGECORE-ProtectedPorts-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:52:33 2025
...
rlProtectedPortsTable = _RlProtectedPortsTable_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 132, 1)
)
if mibBuilder.loadTexts:
...
rlProtectedPortsEntry = _RlProtectedPortsEntry_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 132, 1, 1)
)
...
rlProtectedPortType = _RlProtectedPortType_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 132, 1, 1, 1),
...
rlProtectedPortCommunity = _RlProtectedPortCommunity_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 132, 1, 1, 2),
...
rlProtectedPortsStatusTable = _RlProtectedPortsStatusTable_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 132, 2)
)
if mibBuilder.loadTexts:
...
rlProtectedPortsStatusEntry = _RlProtectedPortsStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 132, 2, 1)
)
...
rlProtectedPortEgressPorts = _RlProtectedPortEgressPorts_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 132, 2, 1, 1),
...
rlProtectedPortsGlobalEnable = _RlProtectedPortsGlobalEnable_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 132, 3),
