...
rlProtectedPortsTable=_RlProtectedPortsTable_Object((1,3,6,1,4,1,259,10,1,14,89,132,1))
if mibBuilder.loadTexts:rlProtectedPortsTable.setStatus(_A)
_RlProtectedPortsEntry_Object=MibTableRow
rlProtectedPortsEntry=_RlProtectedPortsEntry_Object((1,3,6,1,4,1,259,10,1,14,89,132,1,1))
...
rlProtectedPortType=_RlProtectedPortType_Object((1,3,6,1,4,1,259,10,1,14,89,132,1,1,1),_RlProtectedPortType_Type())
...
rlProtectedPortCommunity=_RlProtectedPortCommunity_Object((1,3,6,1,4,1,259,10,1,14,89,132,1,1,2),_RlProtectedPortCommunity_Type())
...
rlProtectedPortsStatusTable=_RlProtectedPortsStatusTable_Object((1,3,6,1,4,1,259,10,1,14,89,132,2))
if mibBuilder.loadTexts:rlProtectedPortsStatusTable.setStatus(_A)
_RlProtectedPortsStatusEntry_Object=MibTableRow
rlProtectedPortsStatusEntry=_RlProtectedPortsStatusEntry_Object((1,3,6,1,4,1,259,10,1,14,89,132,2,1))
...
rlProtectedPortEgressPorts=_RlProtectedPortEgressPorts_Object((1,3,6,1,4,1,259,10,1,14,89,132,2,1,1),_RlProtectedPortEgressPorts_Type())
