...
mibBuilder.exportSymbols("NORTEL-NMI-TC-MIB", NortelNMIadminState=NortelNMIadminState, PYSNMP_MODULE_ID=nortelNMItextConvMIB, NortelNMIalarmProblemCategory=NortelNMIalarmProblemCategory, NortelNMIunknownStatusValue=NortelNMIunknownStatusValue, nortelNMItextConvMIB=nortelNMItextConvMIB, NortelNMIoperState=NortelNMIoperState, NortelNMInotificationTypes=NortelNMInotificationTypes, NortelNMItimeStampDef=NortelNMItimeStampDef, NortelNMIalarmProbableCause=NortelNMIalarmProbableCause, NortelNMIneType=NortelNMIneType)
