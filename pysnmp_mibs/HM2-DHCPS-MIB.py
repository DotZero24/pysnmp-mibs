...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-DHCPS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:55:37 2025
...
_Hm2DHCPServerMode_Type.__name__ = "HmEnabledStatus"
...
class _Hm2DHCPServerAddrProbe_Type(HmEnabledStatus):
    """Custom type hm2DHCPServerAddrProbe based on HmEnabledStatus"""
    defaultValue = 1


_Hm2DHCPServerAddrProbe_Type.__name__ = "HmEnabledStatus"
_Hm2DHCPServerAddrProbe_Object = MibScalar
hm2DHCPServerAddrProbe = _Hm2DHCPServerAddrProbe_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 91, 1, 1, 1, 4),
    _Hm2DHCPServerAddrProbe_Type()
)
hm2DHCPServerAddrProbe.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DHCPServerAddrProbe.setStatus("current")
...
_Hm2DHCPServerPoolLeaseTime_Type.__name__ = "Unsigned32"
...
_Hm2DHCPServerPoolHirschmannClient_Type.__name__ = "HmEnabledStatus"
...
_Hm2DHCPServerIfConfigMode_Type.__name__ = "HmEnabledStatus"
...
mibBuilder.exportSymbols(
    ...
    **{"hm2DhcpsMib": hm2DhcpsMib,
       ...
       "hm2DHCPServerAddrProbe": hm2DHCPServerAddrProbe,
