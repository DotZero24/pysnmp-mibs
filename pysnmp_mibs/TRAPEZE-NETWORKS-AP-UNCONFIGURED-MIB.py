...
mibBuilder.exportSymbols("TRAPEZE-NETWORKS-AP-UNCONFIGURED-MIB", trpzApUnconfOrphanApSerialNum=trpzApUnconfOrphanApSerialNum, trpzApUnconfGroups=trpzApUnconfGroups, trpzApUnconfOrphanIpAddress=trpzApUnconfOrphanIpAddress, trpzApUnconfCompliance=trpzApUnconfCompliance, trpzApUnconfOrphanPhysPortNum=trpzApUnconfOrphanPhysPortNum, trpzApUnconfMibObjects=trpzApUnconfMibObjects, PYSNMP_MODULE_ID=trpzApUnconfiguredMib, trpzApUnconfOrphanApModelName=trpzApUnconfOrphanApModelName, trpzApUnconfCompliances=trpzApUnconfCompliances, TrpzApUnconfiguredOrphanReason=TrpzApUnconfiguredOrphanReason, trpzApUnconfOrphanEntry=trpzApUnconfOrphanEntry, trpzApUnconfOrphanVLANName=trpzApUnconfOrphanVLANName, trpzApUnconfOrphanBasicGroup=trpzApUnconfOrphanBasicGroup, trpzApUnconfiguredMib=trpzApUnconfiguredMib, trpzApUnconfOrphanReason=trpzApUnconfOrphanReason, trpzApUnconfConformance=trpzApUnconfConformance, trpzApUnconfOrphanTable=trpzApUnconfOrphanTable)
