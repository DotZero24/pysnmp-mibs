...
ifIndex, ifPhysAddress, ifAlias, InterfaceIndex = mibBuilder.importSymbols("IF-MIB", "ifIndex", "ifPhysAddress", "ifAlias", "InterfaceIndex")
...
mibBuilder.exportSymbols("ZHONE-COM-BRIDGE-REC-MIB", eapsTopologyPrimaryLinkState=eapsTopologyPrimaryLinkState, bridgeOnDemandStatsRulesRemaining=bridgeOnDemandStatsRulesRemaining, bridgeStatusState=bridgeStatusState, genQueryTx=genQueryTx, bridgePPPoEBrasMac=bridgePPPoEBrasMac, vlanId=vlanId, packetRuleGroupMemberIndex=packetRuleGroupMemberIndex, zhoneBridgeGroup=zhoneBridgeGroup, bridgePPPoEEIfIndex=bridgePPPoEEIfIndex, bridgeCmdSlot=bridgeCmdSlot, stpBindRowStatus=stpBindRowStatus, eapsTopologyPrimaryLinkName=eapsTopologyPrimaryLinkName, stpParamBridgePriority=stpParamBridgePriority, eapsTopologyRing=eapsTopologyRing, packetRuleEntry=packetRuleEntry, zhoneGroups=zhoneGroups, specQueryTx=specQueryTx, packetRuleValue=packetRuleValue, eapsConfigDomainName=eapsConfigDomainName, bridgeIfBridgeState=bridgeIfBridgeState, eapsStatusTable=eapsStatusTable, bridgePathAddressLookupEntry=bridgePathAddressLookupEntry, eapsTopologyTable=eapsTopologyTable, zhoneCompliances=zhoneCompliances, stpParamHelloTime=stpParamHelloTime, bridgeIfVlanIdCOS=bridgeIfVlanIdCOS, zhoneBridgeCmdGroup=zhoneBridgeCmdGroup, genQueryRx=genQueryRx, eapsTopologyEntry=eapsTopologyEntry, eapsTraps=eapsTraps, bridgePathIfLookupTable=bridgePathIfLookupTable, bridgeStatsTicksNow=bridgeStatsTicksNow, bridgeIfStagTPID=bridgeIfStagTPID, zhoneBridgeIgmpGroup=zhoneBridgeIgmpGroup, staticBridgeEntry=staticBridgeEntry, bridgeAddressLookupEntry=bridgeAddressLookupEntry, eapsConfigDomainEnable=eapsConfigDomainEnable, bridgePPPoEEncapLLC=bridgePPPoEEncapLLC, packetRuleGroup=packetRuleGroup, bridgeTrapObjects=bridgeTrapObjects, stpParamTxHoldCount=stpParamTxHoldCount, stpBindInstanceID=stpBindInstanceID, eapsStatsTotCtrlMsgRecvd=eapsStatsTotCtrlMsgRecvd, bridgeInterfaceGroup=bridgeInterfaceGroup, mcastIP=mcastIP, hostMac=hostMac, bridgeIfFilterBroadcast=bridgeIfFilterBroadcast, bridgeIfTableBasedFilter=bridgeIfTableBasedFilter, bridgeStatsMcastSent=bridgeStatsMcastSent, zhoneBridgeStatsGroup=zhoneBridgeStatsGroup, bridgeIfLearnUnicast=bridgeIfLearnUnicast, staticBridgeFlapControl=staticBridgeFlapControl, bridgeCmdIpAddress=bridgeCmdIpAddress, bridgeIgmpEntry=bridgeIgmpEntry, bridgePPPoEVlanId=bridgePPPoEVlanId, bridgeIfDhcpLearn=bridgeIfDhcpLearn, bridgeStatsTicksLastCleared=bridgeStatsTicksLastCleared, actChans=actChans, actHosts=actHosts, v3ReportsRx=v3ReportsRx, bridgeStatsBytesSentCount=bridgeStatsBytesSentCount, bridgeIfVlanXlateFrom=bridgeIfVlanXlateFrom, bridgeIgmpTable=bridgeIgmpTable, stpBindPortPriority=stpBindPortPriority, v2ReportsTx=v2ReportsTx, bridgeStatsEntry=bridgeStatsEntry, bridgeCmdIfIndex=bridgeCmdIfIndex, staticBridgeAddressType=staticBridgeAddressType, bridgeCmdPort=bridgeCmdPort, bridgeIfIncomingCOSOption=bridgeIfIncomingCOSOption, eapsConfigTable=eapsConfigTable, eapsConfigPrimaryPortLineGroup=eapsConfigPrimaryPortLineGroup, eapsConfigRowStatus=eapsConfigRowStatus, leavesRx=leavesRx, bridgePPPoESlanId=bridgePPPoESlanId, NetworkAddress=NetworkAddress, eapsLinkDownRingComplete=eapsLinkDownRingComplete, bridgeIfIngressPacketRuleGroupIndex=bridgeIfIngressPacketRuleGroupIndex, staticBridgePathMulticastAging=staticBridgePathMulticastAging, bridgeIfLookupFlush=bridgeIfLookupFlush, eapsTopologyMacAddr=eapsTopologyMacAddr, eapsStatsTotCtrlMsgSent=eapsStatsTotCtrlMsgSent, eapsProtectedVlanEntry=eapsProtectedVlanEntry, eapsFailTimerExpFlagClear=eapsFailTimerExpFlagClear, zhoneBridgeNotificationGroup=zhoneBridgeNotificationGroup, stpParamMaxAge=stpParamMaxAge, bridgeStatsUcastSent=bridgeStatsUcastSent, bridgeStatsErrorSent=bridgeStatsErrorSent, bridgeStatsTicksPerSecond=bridgeStatsTicksPerSecond, eapsProtectedVlanDomainName=eapsProtectedVlanDomainName, packetRuleGroupNextIndexEntry=packetRuleGroupNextIndexEntry, staticBridgePathTable=staticBridgePathTable, bridgeLowerIfIndex=bridgeLowerIfIndex, leavesTx=leavesTx, eapsConfigMsgTxInterval=eapsConfigMsgTxInterval, v3SpecQueryRx=v3SpecQueryRx, eapsConfigEntry=eapsConfigEntry, bridgeAddressLookupStaticOrDynamic=bridgeAddressLookupStaticOrDynamic, zhoneBridgeEapsConfigGroup=zhoneBridgeEapsConfigGroup, bridgeAddressLookupTable=bridgeAddressLookupTable, bridgePathIfAddressType=bridgePathIfAddressType, packetRuleValue2=packetRuleValue2, packetRuleValue3=packetRuleValue3, bridgeCmdOperation=bridgeCmdOperation, packetRuleGroupIndexNext=packetRuleGroupIndexNext, bridgeIfSlanXlateFrom=bridgeIfSlanXlateFrom, staticBridgeTable=staticBridgeTable, bridgeStatsBytesRcvdCount=bridgeStatsBytesRcvdCount, bridgeStatsBSDUcastBlocked=bridgeStatsBSDUcastBlocked, eapsStatusEntry=eapsStatusEntry, eapsPrevState=eapsPrevState, bridgeCmdMacAddress=bridgeCmdMacAddress, bridgeTraps=bridgeTraps, staticBridgePathLoopPrevention=staticBridgePathLoopPrevention, bridgeIfUnblock=bridgeIfUnblock, bridgeCmdSlanId=bridgeCmdSlanId, eapsProtectedVlanUpperRange=eapsProtectedVlanUpperRange, PYSNMP_MODULE_ID=bridgeRecord, bridgeIfIsPPPoA=bridgeIfIsPPPoA, v3ReportsTx=v3ReportsTx, eapsState=eapsState, bridgeIfFloodUnknown=bridgeIfFloodUnknown, bridgeIfCustomARP=bridgeIfCustomARP, bridgeIfVci=bridgeIfVci, bridgeStatsMcastRcvd=bridgeStatsMcastRcvd, bridgePathIfLookupFlush=bridgePathIfLookupFlush, bridgePathAddressLookupFlush=bridgePathAddressLookupFlush, packetRuleValue5=packetRuleValue5, bridgeStatsBcastRcvd=bridgeStatsBcastRcvd, eapsStatsEntry=eapsStatsEntry, mcastMac=mcastMac, bridgeIfAddressType=bridgeIfAddressType, eapsTrapPrefix=eapsTrapPrefix, staticBridgePathIgmpCustomIpAddress=staticBridgePathIgmpCustomIpAddress, bridgeIfStagOutgoingCOSValue=bridgeIfStagOutgoingCOSValue, staticBridgeRowStatus=staticBridgeRowStatus, stpParamRevision=stpParamRevision, eapsProtectedVlanEntryIndex=eapsProtectedVlanEntryIndex, eapsStatsTable=eapsStatsTable, bridgeIfRowStatus=bridgeIfRowStatus, eapsTopologySecondaryLinkState=eapsTopologySecondaryLinkState, bridgeIfGponTrafficProfile=bridgeIfGponTrafficProfile, bridgeIfStagIncomingCOSOption=bridgeIfStagIncomingCOSOption, bridgeIfStripAndInsert=bridgeIfStripAndInsert, mstpInstanceName=mstpInstanceName, eapsConfigSecondaryPortLineGroup=eapsConfigSecondaryPortLineGroup, mstpInstanceEntry=mstpInstanceEntry, staticBridgePathMacOrIpAddress=staticBridgePathMacOrIpAddress, staticBridgeMacOrIpAddress=staticBridgeMacOrIpAddress, stpParamForceVersion=stpParamForceVersion, bridgeInterfaceTable=bridgeInterfaceTable, bridgeStatsBSDMcastBlocked=bridgeStatsBSDMcastBlocked, stpBindEntry=stpBindEntry, eapsTopologyType=eapsTopologyType, bridgeIgmpStatsTable=bridgeIgmpStatsTable, slanId=slanId, staticBridgePathAddressType=staticBridgePathAddressType, stpBindTable=stpBindTable, bridgePathAddressLookupStaticOrDynamic=bridgePathAddressLookupStaticOrDynamic, zhoneBridgeEapsGroup=zhoneBridgeEapsGroup, lastJoinTimer=lastJoinTimer, BridgeState=BridgeState, bridgeIfStagCOS=bridgeIfStagCOS, bridgePPPoETable=bridgePPPoETable, packetRuleValue7=packetRuleValue7, PacketRuleGroupIndex=PacketRuleGroupIndex, bridgeCmdVlanId=bridgeCmdVlanId, bridgePathIfLookupEntry=bridgePathIfLookupEntry, bridgeIfOnDemandStatsEnabled=bridgeIfOnDemandStatsEnabled, staticBridgeUnicastAging=staticBridgeUnicastAging, eapsTopologyRowNumber=eapsTopologyRowNumber, packetRuleRowStatus=packetRuleRowStatus, eapsGroup=eapsGroup, bridgeType=bridgeType, v3GenQueryTx=v3GenQueryTx, packetRuleGroupMemberNextIndex=packetRuleGroupMemberNextIndex, bridgeIfOutgoingCOSOption=bridgeIfOutgoingCOSOption, bridgeGroup=bridgeGroup, unknownRx=unknownRx, bridgeStatusEntry=bridgeStatusEntry, stpParamName=stpParamName, eapsProtectedVlanLowerRange=eapsProtectedVlanLowerRange, bridgePathIfMacOrIpAddress=bridgePathIfMacOrIpAddress, bridgeIfVlanId=bridgeIfVlanId, staticBridgePathIgmpDscp=staticBridgePathIgmpDscp, packetRuleValue6=packetRuleValue6, packetRuleValue4=packetRuleValue4, packetRuleTable=packetRuleTable, bridgePPPoELocalHostMac=bridgePPPoELocalHostMac, bridgePPPoEEntry=bridgePPPoEEntry, eapsFailTimerExpFlagSet=eapsFailTimerExpFlagSet, staticBridgePathIgmpQueryInterval=staticBridgePathIgmpQueryInterval, stpParamMigrateTime=stpParamMigrateTime, eapsConfigControlVlanPriority=eapsConfigControlVlanPriority, bridgeIfCustomDHCP=bridgeIfCustomDHCP, bridgeIfMacOrIpAddress=bridgeIfMacOrIpAddress, bridgeStatsBSDAlarmCount=bridgeStatsBSDAlarmCount, bridgeIfLearnIp=bridgeIfLearnIp, bridgeIfGponGemPortId=bridgeIfGponGemPortId, bridgeStatsUcastRcvd=bridgeStatsUcastRcvd, eapsTopologySecondaryLinkName=eapsTopologySecondaryLinkName, eapsConfigTimeout=eapsConfigTimeout, zhoneBridgeEapsTopologyGroup=zhoneBridgeEapsTopologyGroup, eapsStateChange=eapsStateChange, bridgeStormDetection=bridgeStormDetection, bridgeCmdFilterMask=bridgeCmdFilterMask, bridgeStatusTable=bridgeStatusTable, bridgeIfEgressPacketRuleGroupIndex=bridgeIfEgressPacketRuleGroupIndex, bridgeIfMaxVideoStreams=bridgeIfMaxVideoStreams, v3SpecQueryTx=v3SpecQueryTx, staticBridgePathFlags=staticBridgePathFlags, staticBridgeFlags=staticBridgeFlags, stpParam=stpParam, packetRuleGroupIndex=packetRuleGroupIndex, errorRx=errorRx, staticBridgePathRowStatus=staticBridgePathRowStatus, eapsConfigSnmpTrap=eapsConfigSnmpTrap, bridgeIfForwardToMulticast=bridgeIfForwardToMulticast, staticBridgeIgmpDscp=staticBridgeIgmpDscp, bridgeIfForwardToUnicast=bridgeIfForwardToUnicast, bridgeInterfaceEntry=bridgeInterfaceEntry, packetRuleType=packetRuleType, bridgePPPoESessionID=bridgePPPoESessionID, bridgeStatsBcastSent=bridgeStatsBcastSent, eapsProtectedVlanTable=eapsProtectedVlanTable, bridgeLoopDetection=bridgeLoopDetection, staticBridgeIgmpCustomIpAddress=staticBridgeIgmpCustomIpAddress, mstpInstanceTable=mstpInstanceTable, bridgeMacAddrString=bridgeMacAddrString, bridgeIfOutgoingCOSValue=bridgeIfOutgoingCOSValue, v2ReportsRx=v2ReportsRx, bridgeRecord=bridgeRecord, bridgeCmd=bridgeCmd, specQueryRx=specQueryRx, staticBridgePathEntry=staticBridgePathEntry, bridgeIfLookupEntry=bridgeIfLookupEntry, staticBridgePathUnicastAging=staticBridgePathUnicastAging, bridgeIfForwardToDefault=bridgeIfForwardToDefault, bridgePathAddressLookupTable=bridgePathAddressLookupTable, bridgeIfStagStripAndInsert=bridgeIfStagStripAndInsert, bridgeIfVpi=bridgeIfVpi, bridgeIfStagOutgoingCOSOption=bridgeIfStagOutgoingCOSOption, bridgeIfFloodMulticast=bridgeIfFloodMulticast, bridgeIfMaxUnicast=bridgeIfMaxUnicast, mstpInstanceRowStatus=mstpInstanceRowStatus, bridgeOnDemandStatsRulesSupported=bridgeOnDemandStatsRulesSupported, bridgeIfStagId=bridgeIfStagId, bridgeIfMvrVlan=bridgeIfMvrVlan, staticBridgeIgmpQueryInterval=staticBridgeIgmpQueryInterval, eapsConfigMaxDroppedMessages=eapsConfigMaxDroppedMessages, EapsState=EapsState, eapsTopologyIpAddr=eapsTopologyIpAddr, staticBridgePathFlapControl=staticBridgePathFlapControl, bridgeIfLearnMulticast=bridgeIfLearnMulticast)
mibBuilder.exportSymbols("ZHONE-COM-BRIDGE-REC-MIB", packetRuleGroupNextIndexTable=packetRuleGroupNextIndexTable, eapsTopologyDomainName=eapsTopologyDomainName, eapsConfigControlVlan=eapsConfigControlVlan, bridgePathIfLookupStaticOrDynamic=bridgePathIfLookupStaticOrDynamic, stpParamFwdDelay=stpParamFwdDelay, staticBridgeMulticastAging=staticBridgeMulticastAging, bridgeIfLookupStaticOrDynamic=bridgeIfLookupStaticOrDynamic, bridgeAddressLookupFlush=bridgeAddressLookupFlush, bridgeIfLookupTable=bridgeIfLookupTable, bridgeTrapPrefix=bridgeTrapPrefix, eapsConfigIsMasterNode=eapsConfigIsMasterNode, v3GenQueryRx=v3GenQueryRx, bridgeStatsTable=bridgeStatsTable, staticBridgeLoopPrevention=staticBridgeLoopPrevention, bridgeStatsBSDBcastBlocked=bridgeStatsBSDBcastBlocked, eapsProtectedVlanRowStatus=eapsProtectedVlanRowStatus, bridgeIgmpStatsEntry=bridgeIgmpStatsEntry, bridgeIfMcastControlList=bridgeIfMcastControlList)
