...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/colubris/COLUBRIS-802DOT11-MIB
...
ColubrisSSIDOrNone, ColubrisSSID, ColubrisRadioType, ColubrisDataRate, ColubrisNotificationEnable = mibBuilder.importSymbols("COLUBRIS-TC", "ColubrisSSIDOrNone", "ColubrisSSID", "ColubrisRadioType", "ColubrisDataRate", "ColubrisNotificationEnable")
...
if mibBuilder.loadTexts: colubris802dot11.setLastUpdated('201310180000Z')
...
coDot11VeryHighThroughputOptionImplemented = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 1, 1, 15), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VeryHighThroughputOptionImplemented.setStatus('current')
coDot11RSNAProtectedManagementFramesEnabled = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 1, 1, 16), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11RSNAProtectedManagementFramesEnabled.setStatus('current')
coDot11RSNAUnprotectedManagementFramesAllowed = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 1, 1, 17), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11RSNAUnprotectedManagementFramesAllowed.setStatus('current')
coDot11AssociationSAQueryMaximumTimeout = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 1, 1, 18), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11AssociationSAQueryMaximumTimeout.setStatus('current')
coDot11AssociationSAQueryRetryTime = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 1, 1, 19), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11AssociationSAQueryRetryTime.setStatus('current')
...
coDot11LegacyRates = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 5, 1, 44), Bits().clone(namedValues=NamedValues(("rate1Mbps", 0), ("rate2Mbps", 1), ("rate5dot5Mbps", 2), ("rate11Mbps", 3), ("rate6Mbps", 4), ("rate9Mbps", 5), ("rate12Mbps", 6), ("rate18Mbps", 7), ("rate24Mbps", 8), ("rate36Mbps", 9), ("rate48Mbps", 10), ("rate54Mbps", 11)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11LegacyRates.setStatus('current')
coDot11QOSLevel = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 5, 1, 45), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(("low", 1), ("medium", 2), ("high", 3), ("veryHigh", 4), ("none", 5)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11QOSLevel.setStatus('current')
coDot11NbRetries = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 5, 1, 46), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11NbRetries.setStatus('current')
coDot11StaVHT = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 5, 1, 47), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHT.setStatus('current')
...
coDot11ScanPHYType = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 7, 1, 9), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(("ieee802dot11a", 1), ("ieee802dot11b", 2), ("ieee802dot11g", 3), ("ieee802dot11na", 4), ("ieee802dot11ng", 5), ("ieee802dot11ac", 6)))).setMaxAccess("readonly")
...
coDot11StaNbStreams = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 37), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 4))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaNbStreams.setStatus('current')
coDot11StaPktsTxMCS16 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 38), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsTxMCS16.setStatus('current')
coDot11StaPktsTxMCS17 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 39), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsTxMCS17.setStatus('current')
coDot11StaPktsTxMCS18 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 40), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsTxMCS18.setStatus('current')
coDot11StaPktsTxMCS19 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 41), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsTxMCS19.setStatus('current')
coDot11StaPktsTxMCS20 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 42), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsTxMCS20.setStatus('current')
coDot11StaPktsTxMCS21 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 43), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsTxMCS21.setStatus('current')
coDot11StaPktsTxMCS22 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 44), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsTxMCS22.setStatus('current')
coDot11StaPktsTxMCS23 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 45), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsTxMCS23.setStatus('current')
coDot11StaPktsRxMCS16 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 46), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsRxMCS16.setStatus('current')
coDot11StaPktsRxMCS17 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 47), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsRxMCS17.setStatus('current')
coDot11StaPktsRxMCS18 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 48), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsRxMCS18.setStatus('current')
coDot11StaPktsRxMCS19 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 49), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsRxMCS19.setStatus('current')
coDot11StaPktsRxMCS20 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 50), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsRxMCS20.setStatus('current')
coDot11StaPktsRxMCS21 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 51), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsRxMCS21.setStatus('current')
coDot11StaPktsRxMCS22 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 52), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsRxMCS22.setStatus('current')
coDot11StaPktsRxMCS23 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 53), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaPktsRxMCS23.setStatus('current')
coDot11StaHTRates = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 54), Bits().clone(namedValues=NamedValues(("htRateMCS0", 0), ("htRateMCS1", 1), ("htRateMCS2", 2), ("htRateMCS3", 3), ("htRateMCS4", 4), ("htRateMCS5", 5), ("htRateMCS6", 6), ("htRateMCS7", 7), ("htRateMCS8", 8), ("htRateMCS9", 9), ("htRateMCS10", 10), ("htRateMCS11", 11), ("htRateMCS12", 12), ("htRateMCS13", 13), ("htRateMCS14", 14), ("htRateMCS15", 15), ("htRateMCS16", 16), ("htRateMCS17", 17), ("htRateMCS18", 18), ("htRateMCS19", 19), ("htRateMCS20", 20), ("htRateMCS21", 21), ("htRateMCS22", 22), ("htRateMCS23", 23)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaHTRates.setStatus('current')
...
coDot11StationVHTTable = MibTable((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18), )
if mibBuilder.loadTexts: coDot11StationVHTTable.setStatus('current')
coDot11StationVHTEntry = MibTableRow((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1), )
coDot11AssociationEntry.registerAugmentions(("COLUBRIS-802DOT11-MIB", "coDot11StationVHTEntry"))
coDot11StationVHTEntry.setIndexNames(*coDot11AssociationEntry.getIndexNames())
if mibBuilder.loadTexts: coDot11StationVHTEntry.setStatus('current')
coDot11StaVHTTransmitMCS = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 1), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTTransmitMCS.setStatus('current')
coDot11StaVHTReceiveMCS = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 2), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTReceiveMCS.setStatus('current')
coDot11StaVHTChannelWidth = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("cw20MHz", 1), ("cw40MHz", 2), ("cw80MHz", 3)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTChannelWidth.setStatus('current')
coDot11StaVHTShortGI = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 4), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTShortGI.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS0 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 5), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS0.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS1 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 6), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS1.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS2 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 7), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS2.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS3 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 8), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS3.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS4 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 9), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS4.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS5 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 10), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS5.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS6 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 11), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS6.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS7 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 12), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS7.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS8 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 13), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS8.setStatus('current')
coDot11StaVHTPktsTxNSS1MCS9 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 14), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS1MCS9.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS0 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 15), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS0.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS1 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 16), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS1.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS2 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 17), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS2.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS3 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 18), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS3.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS4 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 19), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS4.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS5 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 20), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS5.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS6 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 21), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS6.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS7 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 22), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS7.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS8 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 23), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS8.setStatus('current')
coDot11StaVHTPktsTxNSS2MCS9 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 24), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS2MCS9.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS0 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 25), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS0.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS1 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 26), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS1.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS2 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 27), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS2.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS3 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 28), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS3.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS4 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 29), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS4.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS5 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 30), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS5.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS6 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 31), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS6.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS7 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 32), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS7.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS8 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 33), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS8.setStatus('current')
coDot11StaVHTPktsTxNSS3MCS9 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 34), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsTxNSS3MCS9.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS0 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 35), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS0.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS1 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 36), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS1.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS2 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 37), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS2.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS3 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 38), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS3.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS4 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 39), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS4.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS5 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 40), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS5.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS6 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 41), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS6.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS7 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 42), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS7.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS8 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 43), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS8.setStatus('current')
coDot11StaVHTPktsRxNSS1MCS9 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 44), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS1MCS9.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS0 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 45), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS0.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS1 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 46), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS1.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS2 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 47), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS2.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS3 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 48), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS3.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS4 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 49), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS4.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS5 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 50), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS5.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS6 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 51), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS6.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS7 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 52), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS7.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS8 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 53), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS8.setStatus('current')
coDot11StaVHTPktsRxNSS2MCS9 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 54), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS2MCS9.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS0 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 55), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS0.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS1 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 56), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS1.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS2 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 57), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS2.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS3 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 58), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS3.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS4 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 59), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS4.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS5 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 60), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS5.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS6 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 61), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS6.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS7 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 62), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS7.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS8 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 63), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS8.setStatus('current')
coDot11StaVHTPktsRxNSS3MCS9 = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 64), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTPktsRxNSS3MCS9.setStatus('current')
coDot11StaVHTNbStreams = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 65), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 4))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTNbStreams.setStatus('current')
coDot11StaVHTRates = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 18, 1, 66), Bits().clone(namedValues=NamedValues(("vhtRateMCS0", 0), ("vhtRateMCS1", 1), ("vhtRateMCS2", 2), ("vhtRateMCS3", 3), ("vhtRateMCS4", 4), ("vhtRateMCS5", 5), ("vhtRateMCS6", 6), ("vhtRateMCS7", 7), ("vhtRateMCS8", 8), ("vhtRateMCS9", 9)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11StaVHTRates.setStatus('current')
...
coDot11TransmitFrameCount = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 2, 2, 1, 15), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11TransmitFrameCount.setStatus('current')
coDot11ReceiveFrameCount = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 2, 2, 1, 16), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11ReceiveFrameCount.setStatus('current')
coDot11ReceiveClearCount = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 2, 2, 1, 17), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11ReceiveClearCount.setStatus('current')
coDot11CycleCount = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 2, 2, 1, 18), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11CycleCount.setStatus('current')
...
coDot11PHYType = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 7, 8))).clone(namedValues=NamedValues(("fhss", 1), ("dsss", 2), ("irbaseband", 3), ("ofdm", 4), ("ht", 7), ("vht", 8)))).setMaxAccess("readonly")
...
coDot11CurrentOperPHYType = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 1, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(("ieee802dot11a", 1), ("ieee802dot11b", 2), ("ieee802dot11g", 3), ("ieee802dot11bAndg", 4), ("ieee802dot11aTurbo", 5), ("ieee802dot11n", 6), ("ieee802dot11ac", 7)))).setMaxAccess("readonly")
...
coDot11ProtectionStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 1, 1, 13), Bits().clone(namedValues=NamedValues(("protStatusDisabled", 0), ("protStatusNonERPClients", 1), ("protStatusNonERPAccessPoints", 2), ("protStatusNonHTClients", 3), ("protStatusNonHTAccessPoints", 4), ("protStatusNotAvailable", 5)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11ProtectionStatus.setStatus('current')
...
coDot11PhyVHTTable = MibTable((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15), )
if mibBuilder.loadTexts: coDot11PhyVHTTable.setStatus('current')
coDot11PhyVHTEntry = MibTableRow((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1), ).setIndexNames((0, "IF-MIB", "ifIndex"))
if mibBuilder.loadTexts: coDot11PhyVHTEntry.setStatus('current')
coDot11VHTEightyMHzOperationImplemented = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 1), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTEightyMHzOperationImplemented.setStatus('current')
coDot11VHTEightyMHzOperationEnabled = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 2), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTEightyMHzOperationEnabled.setStatus('current')
coDot11VHTCurrentPrimaryChannel = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 3), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTCurrentPrimaryChannel.setStatus('current')
coDot11VHTCurrentSecondaryChannel = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 4), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTCurrentSecondaryChannel.setStatus('current')
coDot11VHTGreenfieldOptionImplemented = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 5), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTGreenfieldOptionImplemented.setStatus('current')
coDot11VHTGreenfieldOptionEnabled = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 6), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTGreenfieldOptionEnabled.setStatus('current')
coDot11VHTShortGIOptionInEightyImplemented = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 7), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTShortGIOptionInEightyImplemented.setStatus('current')
coDot11VHTShortGIOptionInEightyEnabled = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 8), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTShortGIOptionInEightyEnabled.setStatus('current')
coDot11VHTTxHighestSupportedDataRate = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 9), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 600))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTTxHighestSupportedDataRate.setStatus('current')
coDot11VHTRxHighestSupportedDataRate = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 15, 1, 10), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 600))).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11VHTRxHighestSupportedDataRate.setStatus('current')
...
coDot11RSNAStatsCMACICVErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 4, 1, 13), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11RSNAStatsCMACICVErrors.setStatus('current')
coDot11RSNAStatsCMACReplays = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 4, 1, 14), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11RSNAStatsCMACReplays.setStatus('current')
coDot11RSNAStatsRobustManagementCCMPReplays = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 4, 1, 15), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11RSNAStatsRobustManagementCCMPReplays.setStatus('current')
coDot11RSNABIPMICErrors = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 4, 4, 1, 16), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coDot11RSNABIPMICErrors.setStatus('current')
...
coDot11ComplianceExt = ModuleCompliance((1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 2, 3)).setObjects(("COLUBRIS-802DOT11-MIB", "coDot11APBaseGroupExt"), ("COLUBRIS-802DOT11-MIB", "coDot11MACBaseGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11CountersGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11SmtAuthenticationAlgorithmsGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyConfigComplianceGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyConfigGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11APPrivacyGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11MACStatisticsGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyAntennaComplianceGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyRegDomainsSupportGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyAntennasListGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyRateGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11AssociationGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11AssociationConfigGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11ScanGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11ScanConfigGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11WDSComplianceGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11NotificationGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11StationHTGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11StationDetectionGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11StationVHTGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyDSSSComplianceGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyOFDMComplianceGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyHTComplianceGroup"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyVHTComplianceGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    coDot11ComplianceExt = coDot11ComplianceExt.setStatus('current')
coDot11APBaseGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 1)).setObjects(("COLUBRIS-802DOT11-MIB", "coDot11RelayBetweenStation"), ("COLUBRIS-802DOT11-MIB", "coDot11PrivacyOptionImplemented"), ("COLUBRIS-802DOT11-MIB", "coDot11RSNAOptionImplemented"), ("COLUBRIS-802DOT11-MIB", "coDot11BeaconPeriod"), ("COLUBRIS-802DOT11-MIB", "coDot11DTIMPeriod"), ("COLUBRIS-802DOT11-MIB", "coDot11NumberOfUsers"), ("COLUBRIS-802DOT11-MIB", "coDot11AddToAssociationNotification"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyTxPowerAdminLevel"), ("COLUBRIS-802DOT11-MIB", "coDot11PhyTxPowerOperLevel"), ("COLUBRIS-802DOT11-MIB", "coDot11BSSID"), ("COLUBRIS-802DOT11-MIB", "coDot11AdminMinimumDataRate"), ("COLUBRIS-802DOT11-MIB", "coDot11AdminMaximumDataRate"), ("COLUBRIS-802DOT11-MIB", "coDot11HighThroughputOptionImplemented"), ("COLUBRIS-802DOT11-MIB", "coDot11VeryHighThroughputOptionImplemented"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
coDot11StationVHTGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 26)).setObjects(("COLUBRIS-802DOT11-MIB", "coDot11StaVHTTransmitMCS"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTReceiveMCS"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTChannelWidth"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTShortGI"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS0"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS1"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS2"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS3"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS4"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS5"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS6"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS7"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS8"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS1MCS9"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS0"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS1"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS2"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS3"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS4"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS5"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS6"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS7"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS8"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS2MCS9"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS0"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS1"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS2"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS3"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS4"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS5"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS6"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS7"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS8"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsTxNSS3MCS9"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS0"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS1"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS2"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS3"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS4"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS5"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS6"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS7"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS8"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS1MCS9"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS0"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS1"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS2"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS3"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS4"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS5"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS6"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS7"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS8"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS2MCS9"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS0"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS1"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS2"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS3"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS4"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS5"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS6"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS7"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS8"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTPktsRxNSS3MCS9"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTNbStreams"), ("COLUBRIS-802DOT11-MIB", "coDot11StaVHTRates"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    coDot11StationVHTGroup = coDot11StationVHTGroup.setStatus('current')
coDot11PhyVHTComplianceGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 27)).setObjects(("COLUBRIS-802DOT11-MIB", "coDot11VHTEightyMHzOperationImplemented"), ("COLUBRIS-802DOT11-MIB", "coDot11VHTEightyMHzOperationEnabled"), ("COLUBRIS-802DOT11-MIB", "coDot11VHTCurrentPrimaryChannel"), ("COLUBRIS-802DOT11-MIB", "coDot11VHTCurrentSecondaryChannel"), ("COLUBRIS-802DOT11-MIB", "coDot11VHTGreenfieldOptionImplemented"), ("COLUBRIS-802DOT11-MIB", "coDot11VHTGreenfieldOptionEnabled"), ("COLUBRIS-802DOT11-MIB", "coDot11VHTShortGIOptionInEightyImplemented"), ("COLUBRIS-802DOT11-MIB", "coDot11VHTShortGIOptionInEightyEnabled"), ("COLUBRIS-802DOT11-MIB", "coDot11VHTTxHighestSupportedDataRate"), ("COLUBRIS-802DOT11-MIB", "coDot11VHTRxHighestSupportedDataRate"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    coDot11PhyVHTComplianceGroup = coDot11PhyVHTComplianceGroup.setStatus('current')
mibBuilder.exportSymbols("COLUBRIS-802DOT11-MIB", coDot11WEPDefaultKeyID=coDot11WEPDefaultKeyID, coDot11ScanConfigGroup=coDot11ScanConfigGroup, coDot11DetStaNoiseLevel=coDot11DetStaNoiseLevel, coDot11SmtAuthenticationAlgorithmsGroup=coDot11SmtAuthenticationAlgorithmsGroup, coDot11StaVHTPktsRxNSS2MCS0=coDot11StaVHTPktsRxNSS2MCS0, coDot11StaPktsTxMCS2=coDot11StaPktsTxMCS2, coDot11TempType=coDot11TempType, coDot11StaPktsTxMCS17=coDot11StaPktsTxMCS17, coDot11WDSPortEntry=coDot11WDSPortEntry, coDot11ExcludeUnencrypted=coDot11ExcludeUnencrypted, coDot11FrameDuplicateCount=coDot11FrameDuplicateCount, coDot11StaVHTPktsRxNSS1MCS1=coDot11StaVHTPktsRxNSS1MCS1, coDot11CycleCount=coDot11CycleCount, coDot11ScanAuthorizedListURL=coDot11ScanAuthorizedListURL, coDot11AutoChannelInterval=coDot11AutoChannelInterval, coDot11PktsRate18=coDot11PktsRate18, coDot11RSNAStatsTKIPLocalMICFailures=coDot11RSNAStatsTKIPLocalMICFailures, coDot11ComplianceExt=coDot11ComplianceExt, coDot11PktsTxRate54=coDot11PktsTxRate54, coDot11ScanIndex=coDot11ScanIndex, coDot11StaVHTPktsRxNSS1MCS4=coDot11StaVHTPktsRxNSS1MCS4, coDot11RelayBetweenStation=coDot11RelayBetweenStation, coDot11WDSPortTxDropped=coDot11WDSPortTxDropped, coDot11StaVHTPktsTxNSS1MCS3=coDot11StaVHTPktsTxNSS1MCS3, coDot11RTSThreshold=coDot11RTSThreshold, coDot11PhyDSSSComplianceGroup=coDot11PhyDSSSComplianceGroup, coDot11PhyHTComplianceGroup=coDot11PhyHTComplianceGroup, coDot11StaVHTPktsTxNSS3MCS1=coDot11StaVHTPktsTxNSS3MCS1, coDot11StaVHTPktsRxNSS2MCS1=coDot11StaVHTPktsRxNSS2MCS1, coDot11StationVLAN=coDot11StationVLAN, coDot11PrivacyOptionImplemented=coDot11PrivacyOptionImplemented, coDot11StationHTGroup=coDot11StationHTGroup, coDot11CurrentRxAntenna=coDot11CurrentRxAntenna, coDot11StaPktsTxMCS21=coDot11StaPktsTxMCS21, coDot11StaPktsTxMCS22=coDot11StaPktsTxMCS22, coDot11StationVHTGroup=coDot11StationVHTGroup, coDot11SupportedRxAntenna=coDot11SupportedRxAntenna, coDot11StaPktsTxMCS10=coDot11StaPktsTxMCS10, coDot11ScanInactivityTime=coDot11ScanInactivityTime, coDot11AssociationConfigGroup=coDot11AssociationConfigGroup, coDot11RSNAStatsCMACICVErrors=coDot11RSNAStatsCMACICVErrors, coDot11CurrentOperPHYType=coDot11CurrentOperPHYType, coDot11StaVHTPktsTxNSS1MCS9=coDot11StaVHTPktsTxNSS1MCS9, coDot11PhyRegDomainsSupportGroup=coDot11PhyRegDomainsSupportGroup, coDot11OutPkts=coDot11OutPkts, coDot11AccessPointConfigEntry=coDot11AccessPointConfigEntry, coDot11ReceiveClearCount=coDot11ReceiveClearCount, coDot11WDSPortCurrentRate=coDot11WDSPortCurrentRate, coDot11PktsTxRate18=coDot11PktsTxRate18, coDot11OperatingMode=coDot11OperatingMode, PYSNMP_MODULE_ID=colubris802dot11, coDot11TransmitFrameCount=coDot11TransmitFrameCount, coDot11StaVHTTransmitMCS=coDot11StaVHTTransmitMCS, coDot11ScanMacAddress=coDot11ScanMacAddress, coDot11StaVHTPktsRxNSS1MCS6=coDot11StaVHTPktsRxNSS1MCS6, coDot11VHTTxHighestSupportedDataRate=coDot11VHTTxHighestSupportedDataRate, coDot11MulticastTransmittedFrameCount=coDot11MulticastTransmittedFrameCount, coDot11RTSSuccessCount=coDot11RTSSuccessCount, coDot11RSNAStatsTKIPRemoteMICFailures=coDot11RSNAStatsTKIPRemoteMICFailures, coDot11InPkts=coDot11InPkts, coDot11VHTGreenfieldOptionImplemented=coDot11VHTGreenfieldOptionImplemented, coDot11APBaseGroupExt=coDot11APBaseGroupExt, coDot11StaPktsRxMCS0=coDot11StaPktsRxMCS0, coDot11StationIPAddress=coDot11StationIPAddress, coDot11StaVHTPktsTxNSS1MCS4=coDot11StaVHTPktsTxNSS1MCS4, coDot11WEPDefaultKeysEntry=coDot11WEPDefaultKeysEntry, coDot11VHTShortGIOptionInEightyEnabled=coDot11VHTShortGIOptionInEightyEnabled, coDot11PhyOFDMComplianceGroup=coDot11PhyOFDMComplianceGroup, coDot11ShortGIOptionInFortyImplemented=coDot11ShortGIOptionInFortyImplemented, coDot11PktsRate9=coDot11PktsRate9, coDot11StaPktsTxMCS12=coDot11StaPktsTxMCS12, coDot11WDSPortMacAddress=coDot11WDSPortMacAddress, coDot11ShortGIOptionInTwentyEnabled=coDot11ShortGIOptionInTwentyEnabled, coDot11StaVHTPktsTxNSS2MCS8=coDot11StaVHTPktsTxNSS2MCS8, coDot11BeaconPeriod=coDot11BeaconPeriod, coDot11AssociationTable=coDot11AssociationTable, coDot11ScanChannel=coDot11ScanChannel, coDot11SignalLevel=coDot11SignalLevel, coDot11RSNAStatsTKIPReplays=coDot11RSNAStatsTKIPReplays, coDot11VHTCurrentSecondaryChannel=coDot11VHTCurrentSecondaryChannel, coDot11CurrentPrimaryChannel=coDot11CurrentPrimaryChannel, coDot11PhyAntennaTable=coDot11PhyAntennaTable, coDot11MaxReceiveLifetime=coDot11MaxReceiveLifetime, coDot11WEPUndecryptableCount=coDot11WEPUndecryptableCount, coDot11StaVHTPktsRxNSS3MCS5=coDot11StaVHTPktsRxNSS3MCS5, coDot11BSSID=coDot11BSSID, coDot11StationName=coDot11StationName, coDot11PhyAdminStatus=coDot11PhyAdminStatus, coDot11AuthenticationAlgorithm=coDot11AuthenticationAlgorithm, coDot11StaPktsTxMCS8=coDot11StaPktsTxMCS8, coDot11PktsRate1=coDot11PktsRate1, coDot11PktsTxRate5dot5=coDot11PktsTxRate5dot5, coDot11PktsRate24=coDot11PktsRate24, coDot11ProductID=coDot11ProductID, coDot11DetStaChannel=coDot11DetStaChannel, coDot11StaVHTChannelWidth=coDot11StaVHTChannelWidth, coDot11AssociationNotification=coDot11AssociationNotification, coDot11StaPktsRxMCS18=coDot11StaPktsRxMCS18, coDot11StaVHTPktsTxNSS3MCS7=coDot11StaVHTPktsTxNSS3MCS7, coDot11StaVHTPktsTxNSS2MCS3=coDot11StaVHTPktsTxNSS2MCS3, coDot11StaPktsTxMCS23=coDot11StaPktsTxMCS23, coDot11PrivacyInvoked=coDot11PrivacyInvoked, coDot11WDSPortRxPackets=coDot11WDSPortRxPackets, coDot11StationConnectTime=coDot11StationConnectTime, coDot11StaVHTPktsRxNSS1MCS5=coDot11StaVHTPktsRxNSS1MCS5, coDot11StaVHTPktsRxNSS3MCS1=coDot11StaVHTPktsRxNSS3MCS1, coDot11StationDetectionState=coDot11StationDetectionState, coDot11RegDomainsSupportValue=coDot11RegDomainsSupportValue, coDot11NoiseLevel=coDot11NoiseLevel, coDot11VHTEightyMHzOperationImplemented=coDot11VHTEightyMHzOperationImplemented, coDot11ScanStatus=coDot11ScanStatus, coDot11StaPktsRxMCS13=coDot11StaPktsRxMCS13, coDot11PktsTxRate2=coDot11PktsTxRate2, coDot11AntennasListEntry=coDot11AntennasListEntry, coDot11CurrentChannel=coDot11CurrentChannel, coDot11TIThreshold=coDot11TIThreshold, coDot11CurrentFrequency=coDot11CurrentFrequency, coDot11StaShortGI=coDot11StaShortGI, coDot11PktsRate36=coDot11PktsRate36, coDot11LegacyRates=coDot11LegacyRates, coDot11StaVHTPktsTxNSS2MCS9=coDot11StaVHTPktsTxNSS2MCS9, coDot11CountersTable=coDot11CountersTable, coDot11StaPktsRxMCS19=coDot11StaPktsRxMCS19, coDot11RSNAStatsTable=coDot11RSNAStatsTable, coDot11StaVHTPktsTxNSS1MCS6=coDot11StaVHTPktsTxNSS1MCS6, coDot11HighThroughputOptionImplemented=coDot11HighThroughputOptionImplemented, coDot11PhyVHTComplianceGroup=coDot11PhyVHTComplianceGroup, coDot11StaChannelWidth=coDot11StaChannelWidth, coDot11ProtectionStatus=coDot11ProtectionStatus, coDot11RSNAStatsSelectedPairwiseCipher=coDot11RSNAStatsSelectedPairwiseCipher, coDot11RSNAUnprotectedManagementFramesAllowed=coDot11RSNAUnprotectedManagementFramesAllowed, coDot11HighestSupportedDataRate=coDot11HighestSupportedDataRate, coDot11PktsRate6=coDot11PktsRate6, coDot11PktsRate48=coDot11PktsRate48, coDot11StaVHTPktsTxNSS3MCS8=coDot11StaVHTPktsTxNSS3MCS8, coDot11StaVHTPktsRxNSS3MCS7=coDot11StaVHTPktsRxNSS3MCS7, coDot11StationSSID=coDot11StationSSID, coDot11FailedCount=coDot11FailedCount, coDot11StaPktsRxMCS17=coDot11StaPktsRxMCS17, coDot11StaPktsRxMCS15=coDot11StaPktsRxMCS15, coDot11CurrentTxAntenna=coDot11CurrentTxAntenna, coDot11CurrentCCAMode=coDot11CurrentCCAMode, coDot11PhyAntennaComplianceGroup=coDot11PhyAntennaComplianceGroup, coDot11StaVHTPktsRxNSS1MCS7=coDot11StaVHTPktsRxNSS1MCS7, coDot11AssociationGroup=coDot11AssociationGroup, coDot11StaVHTPktsRxNSS3MCS6=coDot11StaVHTPktsRxNSS3MCS6, coDot11RSNAStatsCMACReplays=coDot11RSNAStatsCMACReplays, coDot11ReceivedFragmentCount=coDot11ReceivedFragmentCount, coDot11RSNABIPMICErrors=coDot11RSNABIPMICErrors, coDot11VHTGreenfieldOptionEnabled=coDot11VHTGreenfieldOptionEnabled, coDot11StaPktsTxMCS6=coDot11StaPktsTxMCS6, coDot11FortyMHzOperationImplemented=coDot11FortyMHzOperationImplemented, coDot11NbDetectedStation=coDot11NbDetectedStation, coDot11RegDomainsSupportedEntry=coDot11RegDomainsSupportedEntry, coDot11CurrentOperFrequency=coDot11CurrentOperFrequency, coDot11SupportedDataRatesTxValue=coDot11SupportedDataRatesTxValue, coDot11StaVHTPktsTxNSS2MCS0=coDot11StaVHTPktsTxNSS2MCS0, coDot11StaVHTPktsRxNSS1MCS3=coDot11StaVHTPktsRxNSS1MCS3, coDot11StaPktsRxMCS7=coDot11StaPktsRxMCS7, coDot11CountryCode=coDot11CountryCode, coDot11PktsRate2=coDot11PktsRate2, coDot11phy=coDot11phy, coDot11ManufacturerID=coDot11ManufacturerID, coDot11ap=coDot11ap, coDot11RTSFailureCount=coDot11RTSFailureCount, coDot11DetStaTimeDiscovered=coDot11DetStaTimeDiscovered, coDot11DetectedStationEntry=coDot11DetectedStationEntry, coDot11VHTShortGIOptionInEightyImplemented=coDot11VHTShortGIOptionInEightyImplemented, coDot11StaVHTPktsRxNSS2MCS9=coDot11StaVHTPktsRxNSS2MCS9, coDot11SupportedDataRatesRxValue=coDot11SupportedDataRatesRxValue, coDot11StaVHTPktsTxNSS2MCS6=coDot11StaVHTPktsTxNSS2MCS6, coDot11PhyVHTTable=coDot11PhyVHTTable, coDot11PhyAntennaEntry=coDot11PhyAntennaEntry, coDot11StaVHTPktsRxNSS2MCS7=coDot11StaVHTPktsRxNSS2MCS7, coDot11StationLocalInterface=coDot11StationLocalInterface, coDot11AuthenticationAlgorithmsEnable=coDot11AuthenticationAlgorithmsEnable, coDot11StaVHTPktsRxNSS1MCS0=coDot11StaVHTPktsRxNSS1MCS0, coDot11StaPktsTxMCS0=coDot11StaPktsTxMCS0, coDot11CurrentRegDomain=coDot11CurrentRegDomain, coDot11StaTransmitMCS=coDot11StaTransmitMCS, coDot11ManagementMIBNotificationPrefix=coDot11ManagementMIBNotificationPrefix, coDot11AddToAssociationNotification=coDot11AddToAssociationNotification, coDot11AutoPowerEnabled=coDot11AutoPowerEnabled, coDot11ShortGIOptionInTwentyImplemented=coDot11ShortGIOptionInTwentyImplemented, coDot11StationVHTTable=coDot11StationVHTTable, coDot11AdminMaximumDataRate=coDot11AdminMaximumDataRate, coDot11VHTCurrentPrimaryChannel=coDot11VHTCurrentPrimaryChannel, coDot11StaPktsRxMCS9=coDot11StaPktsRxMCS9, coDot11RSNAStatsTKIPCounterMeasuresInvoked=coDot11RSNAStatsTKIPCounterMeasuresInvoked, coDot11NbRetries=coDot11NbRetries, coDot11StaVHTPktsTxNSS3MCS2=coDot11StaVHTPktsTxNSS3MCS2, coDot11StaVHT=coDot11StaVHT, coDot11AntennasListTable=coDot11AntennasListTable, coDot11RSNAStatsEntry=coDot11RSNAStatsEntry, coDot11StaVHTPktsRxNSS3MCS8=coDot11StaVHTPktsRxNSS3MCS8, coDot11AccessPointConfigTable=coDot11AccessPointConfigTable, coDot11MACBaseGroup=coDot11MACBaseGroup, coDot11MACAddress=coDot11MACAddress, coDot11StaPktsTxMCS1=coDot11StaPktsTxMCS1, coDot11AuthenticationAlgorithmsEntry=coDot11AuthenticationAlgorithmsEntry, coDot11StaVHTPktsTxNSS2MCS1=coDot11StaVHTPktsTxNSS2MCS1, coDot11PhyConfigGroup=coDot11PhyConfigGroup, coDot11StaNbStreams=coDot11StaNbStreams, coDot11FrequencyBandsSupported=coDot11FrequencyBandsSupported, coDot11RetryCount=coDot11RetryCount, coDot11StaVHTPktsRxNSS3MCS9=coDot11StaVHTPktsRxNSS3MCS9, coDot11GreenfieldOptionEnabled=coDot11GreenfieldOptionEnabled, coDot11StaVHTPktsTxNSS3MCS9=coDot11StaVHTPktsTxNSS3MCS9, coDot11StaPktsTxMCS5=coDot11StaPktsTxMCS5, coDot11WEPExcludedCount=coDot11WEPExcludedCount, coDot11SNR=coDot11SNR, coDot11StaPktsRxMCS5=coDot11StaPktsRxMCS5, coDot11PktsTxRate12=coDot11PktsTxRate12, coDot11APBaseGroup=coDot11APBaseGroup, coDot11InOctets=coDot11InOctets, coDot11Sensitivity=coDot11Sensitivity, coDot11StaPktsTxMCS13=coDot11StaPktsTxMCS13, coDot11RSNAEnabled=coDot11RSNAEnabled, coDot11DetStaRate=coDot11DetStaRate, coDot11AssociationNotificationEnabled=coDot11AssociationNotificationEnabled, coDot11StaPktsTxMCS18=coDot11StaPktsTxMCS18, coDot11StaHT=coDot11StaHT, coDot11SNRLevelNotification=coDot11SNRLevelNotification, coDot11PhyHTEntry=coDot11PhyHTEntry, coDot11SupportedTxAntenna=coDot11SupportedTxAntenna, coDot11MultipleRetryCount=coDot11MultipleRetryCount, coDot11StaVHTPktsTxNSS3MCS5=coDot11StaVHTPktsTxNSS3MCS5, coDot11CountersGroup=coDot11CountersGroup, coDot11PrivacyEntry=coDot11PrivacyEntry, coDot11CCAModeSupported=coDot11CCAModeSupported, coDot11APPrivacyGroup=coDot11APPrivacyGroup, coDot11PktsTxRate1=coDot11PktsTxRate1, coDot11FortyMHzOperationEnabled=coDot11FortyMHzOperationEnabled, coDot11GreenfieldOptionImplemented=coDot11GreenfieldOptionImplemented, coDot11DetectedStationTable=coDot11DetectedStationTable, coDot11PhyOFDMTable=coDot11PhyOFDMTable, coDot11NotificationGroup=coDot11NotificationGroup, coDot11MACStatisticsGroup=coDot11MACStatisticsGroup, coDot11PktsRate5dot5=coDot11PktsRate5dot5, coDot11QOSLevel=coDot11QOSLevel, coDot11RegDomainsSupportedTable=coDot11RegDomainsSupportedTable, coDot11StaPktsRxMCS10=coDot11StaPktsRxMCS10, coDot11TransmittedFrameCount=coDot11TransmittedFrameCount, coDot11PHYType=coDot11PHYType, coDot11StaPktsTxMCS9=coDot11StaPktsTxMCS9, coDot11AssociationEntry=coDot11AssociationEntry, coDot11StaVHTPktsRxNSS1MCS2=coDot11StaVHTPktsRxNSS1MCS2, coDot11RSNAStatsVersion=coDot11RSNAStatsVersion, coDot11PktsRate11=coDot11PktsRate11, coDot11RadioEnabled=coDot11RadioEnabled, coDot11MulticastReceivedFrameCount=coDot11MulticastReceivedFrameCount, coDot11SupportedDataRatesTxTable=coDot11SupportedDataRatesTxTable, coDot11SupportedDataRatesRxTable=coDot11SupportedDataRatesRxTable, coDot11StaPktsTxMCS7=coDot11StaPktsTxMCS7)
mibBuilder.exportSymbols("COLUBRIS-802DOT11-MIB", coDot11SupportedDataRatesRxIndex=coDot11SupportedDataRatesRxIndex, colubris802dot11=colubris802dot11, coDot11StaVHTPktsTxNSS2MCS2=coDot11StaVHTPktsTxNSS2MCS2, coDot11RSNAStatsCCMPReplays=coDot11RSNAStatsCCMPReplays, coDot11PktsRate12=coDot11PktsRate12, coDot11StaVHTPktsTxNSS3MCS4=coDot11StaVHTPktsTxNSS3MCS4, coDot11StaVHTPktsTxNSS1MCS1=coDot11StaVHTPktsTxNSS1MCS1, coDot11AssociationSAQueryRetryTime=coDot11AssociationSAQueryRetryTime, coDot11ReceiveRate=coDot11ReceiveRate, coDot11PhyAntennasListGroup=coDot11PhyAntennasListGroup, coDot11ScanSignalLevel=coDot11ScanSignalLevel, coDot11CurrentSecondaryChannel=coDot11CurrentSecondaryChannel, coDot11ScanSNR=coDot11ScanSNR, coDot11MinimumSNRLevel=coDot11MinimumSNRLevel, coDot11VHTEightyMHzOperationEnabled=coDot11VHTEightyMHzOperationEnabled, coDot11RSNAStatsTKIPICVErrors=coDot11RSNAStatsTKIPICVErrors, coDot11WEPDefaultKey4Value=coDot11WEPDefaultKey4Value, coDot11StaReceiveMCS=coDot11StaReceiveMCS, coDot11PktsTxRate36=coDot11PktsTxRate36, coDot11OperationEntry=coDot11OperationEntry, coDot11RegDomainsSupportIndex=coDot11RegDomainsSupportIndex, coDot11PhyOperationEntry=coDot11PhyOperationEntry, coDot11PrivacyTable=coDot11PrivacyTable, coDot11ShortGIOptionInFortyEnabled=coDot11ShortGIOptionInFortyEnabled, coDot11ScanGroup=coDot11ScanGroup, coDot11AuthenticationAlgorithmsTable=coDot11AuthenticationAlgorithmsTable, WEPKeytype=WEPKeytype, coDot11StaVHTPktsTxNSS1MCS2=coDot11StaVHTPktsTxNSS1MCS2, coDot11RSNAStatsRobustManagementCCMPReplays=coDot11RSNAStatsRobustManagementCCMPReplays, coDot11WEPDefaultKey3Value=coDot11WEPDefaultKey3Value, coDot11PktsTxRate9=coDot11PktsTxRate9, coDot11StaVHTPktsRxNSS2MCS8=coDot11StaVHTPktsRxNSS2MCS8, coDot11ScanEnabled=coDot11ScanEnabled, coDot11StaPktsTxMCS3=coDot11StaPktsTxMCS3, coDot11StaVHTPktsTxNSS1MCS5=coDot11StaVHTPktsTxNSS1MCS5, coDot11StaPktsRxMCS14=coDot11StaPktsRxMCS14, coDot11DetStaSignalLevel=coDot11DetStaSignalLevel, coDot11ACKFailureCount=coDot11ACKFailureCount, coDot11StaVHTPktsRxNSS2MCS5=coDot11StaVHTPktsRxNSS2MCS5, coDot11ScanNetworkType=coDot11ScanNetworkType, coDot11OperationTable=coDot11OperationTable, coDot11Groups=coDot11Groups, coDot11StaPktsTxMCS4=coDot11StaPktsTxMCS4, coDot11CurrentSNRLevel=coDot11CurrentSNRLevel, coDot11Compliance=coDot11Compliance, coDot11RSNAStatsCCMPDecryptErrors=coDot11RSNAStatsCCMPDecryptErrors, coDot11StaVHTPktsTxNSS1MCS8=coDot11StaVHTPktsTxNSS1MCS8, coDot11ShortRetryLimit=coDot11ShortRetryLimit, coDot11StaVHTReceiveMCS=coDot11StaVHTReceiveMCS, coDot11Conformance=coDot11Conformance, coDot11StationVHTEntry=coDot11StationVHTEntry, coDot11StationHTEntry=coDot11StationHTEntry, coDot11StaPktsRxMCS12=coDot11StaPktsRxMCS12, coDot11mac=coDot11mac, coDot11StaPktsRxMCS23=coDot11StaPktsRxMCS23, coDot11StaEncryptionType=coDot11StaEncryptionType, coDot11ScanPHYType=coDot11ScanPHYType, coDot11RadioType=coDot11RadioType, coDot11PhyDSSSTable=coDot11PhyDSSSTable, coDot11DetStaMacAddress=coDot11DetStaMacAddress, coDot11PhyRateGroup=coDot11PhyRateGroup, coDot11StaPktsTxMCS16=coDot11StaPktsTxMCS16, coDot11StaVHTPktsRxNSS3MCS3=coDot11StaVHTPktsRxNSS3MCS3, coDot11PhyDSSSEntry=coDot11PhyDSSSEntry, coDot11PhyOFDMEntry=coDot11PhyOFDMEntry, coDot11StaVHTPktsRxNSS3MCS2=coDot11StaVHTPktsRxNSS3MCS2, coDot11WDSPortTxPackets=coDot11WDSPortTxPackets, coDot11PhyOperStatus=coDot11PhyOperStatus, coDot11AuthenticationAlgorithmsIndex=coDot11AuthenticationAlgorithmsIndex, coDot11StaVHTPktsTxNSS3MCS3=coDot11StaVHTPktsTxNSS3MCS3, coDot11VeryHighThroughputOptionImplemented=coDot11VeryHighThroughputOptionImplemented, coDot11WDSPortIndex=coDot11WDSPortIndex, coDot11WDSComplianceGroup=coDot11WDSComplianceGroup, coDot11ScanTable=coDot11ScanTable, coDot11UnauthorizedAPNotification=coDot11UnauthorizedAPNotification, coDot11RSNBase=coDot11RSNBase, coDot11AssociationNotificationInterval=coDot11AssociationNotificationInterval, coDot11RSNAOptionImplemented=coDot11RSNAOptionImplemented, coDot11DiversitySupport=coDot11DiversitySupport, coDot11StaPktsRxMCS3=coDot11StaPktsRxMCS3, coDot11StaVHTPktsRxNSS3MCS4=coDot11StaVHTPktsRxNSS3MCS4, coDot11ScanPeriodicity=coDot11ScanPeriodicity, coDot11AdminMinimumDataRate=coDot11AdminMinimumDataRate, coDot11PhyHTTable=coDot11PhyHTTable, coDot11Compliances=coDot11Compliances, coDot11StationMACAddress=coDot11StationMACAddress, coDot11WDSPortTxErrors=coDot11WDSPortTxErrors, coDot11StaPktsRxMCS21=coDot11StaPktsRxMCS21, coDot11SupportedDataRatesRxEntry=coDot11SupportedDataRatesRxEntry, coDot11UnauthorizedAPNotificationInterval=coDot11UnauthorizedAPNotificationInterval, coDot11NumberOfUsers=coDot11NumberOfUsers, coDot11AutoChannelEnabled=coDot11AutoChannelEnabled, coDot11ScanEntry=coDot11ScanEntry, coDot11StaVHTPktsRxNSS2MCS4=coDot11StaVHTPktsRxNSS2MCS4, coDot11LongRetryLimit=coDot11LongRetryLimit, coDot11AssociationSAQueryMaximumTimeout=coDot11AssociationSAQueryMaximumTimeout, coDot11ManagementMIBNotifications=coDot11ManagementMIBNotifications, coDot11DetStaSSID=coDot11DetStaSSID, coDot11StaPktsRxMCS11=coDot11StaPktsRxMCS11, coDot11ReceiveFrameCount=coDot11ReceiveFrameCount, coDot11SupportedDataRatesTxEntry=coDot11SupportedDataRatesTxEntry, coDot11StaPktsRxMCS8=coDot11StaPktsRxMCS8, coDot11StaPktsRxMCS1=coDot11StaPktsRxMCS1, coDot11StaPktsTxMCS20=coDot11StaPktsTxMCS20, coDot11TransmitRate=coDot11TransmitRate, coDot11DetStaNbProbeReq=coDot11DetStaNbProbeReq, coDot11StationHTTable=coDot11StationHTTable, coDot11PktsTxRate24=coDot11PktsTxRate24, coDot11StationDetectionGroup=coDot11StationDetectionGroup, coDot11StaVHTShortGI=coDot11StaVHTShortGI, coDot11RSNAStatsCCMPFormatErrors=coDot11RSNAStatsCCMPFormatErrors, coDot11AntennaListIndex=coDot11AntennaListIndex, coDot11StaVHTPktsRxNSS3MCS0=coDot11StaVHTPktsRxNSS3MCS0, coDot11FragmentationThreshold=coDot11FragmentationThreshold, coDot11StaPktsTxMCS19=coDot11StaPktsTxMCS19, coDot11StaVHTPktsTxNSS3MCS6=coDot11StaVHTPktsTxNSS3MCS6, coDot11PhyVHTEntry=coDot11PhyVHTEntry, coDot11ScanNoiseLevel=coDot11ScanNoiseLevel, coDot11WDSPortTable=coDot11WDSPortTable, coDot11StaVHTRates=coDot11StaVHTRates, coDot11UnauthorizedAPNotificationEnabled=coDot11UnauthorizedAPNotificationEnabled, coDot11PhyConfigTable=coDot11PhyConfigTable, coDot11WDSPortRxErrors=coDot11WDSPortRxErrors, coDot11RSNAProtectedManagementFramesEnabled=coDot11RSNAProtectedManagementFramesEnabled, coDot11PhyConfigComplianceGroup=coDot11PhyConfigComplianceGroup, coDot11StaVHTPktsTxNSS1MCS7=coDot11StaVHTPktsTxNSS1MCS7, coDot11StaPktsTxMCS14=coDot11StaPktsTxMCS14, coDot11StaVHTPktsTxNSS3MCS0=coDot11StaVHTPktsTxNSS3MCS0, coDot11WEPDefaultKey2Value=coDot11WEPDefaultKey2Value, coDot11StaVHTNbStreams=coDot11StaVHTNbStreams, coDot11StaPktsRxMCS4=coDot11StaPktsRxMCS4, coDot11DetStaTimeLastSeen=coDot11DetStaTimeLastSeen, coDot11MaxTransmitMSDULifetime=coDot11MaxTransmitMSDULifetime, coDot11StaVHTPktsRxNSS2MCS6=coDot11StaVHTPktsRxNSS2MCS6, coDot11VHTRxHighestSupportedDataRate=coDot11VHTRxHighestSupportedDataRate, coDot11StaVHTPktsTxNSS2MCS5=coDot11StaVHTPktsTxNSS2MCS5, coDot11StaVHTPktsTxNSS2MCS4=coDot11StaVHTPktsTxNSS2MCS4, coDot11StaVHTPktsTxNSS2MCS7=coDot11StaVHTPktsTxNSS2MCS7, coDot11ScanSSID=coDot11ScanSSID, coDot11PktsTxRate11=coDot11PktsTxRate11, coDot11RSNAStats4WayHandshakeFailures=coDot11RSNAStats4WayHandshakeFailures, coDot11PhyTxPowerAdminLevel=coDot11PhyTxPowerAdminLevel, coDot11WEPDefaultKeysTable=coDot11WEPDefaultKeysTable, coDot11StaVHTPktsRxNSS1MCS9=coDot11StaVHTPktsRxNSS1MCS9, coDot11StaVHTPktsRxNSS1MCS8=coDot11StaVHTPktsRxNSS1MCS8, coDot11SNRLevelNotificationInterval=coDot11SNRLevelNotificationInterval, coDot11WEPDefaultKey1Value=coDot11WEPDefaultKey1Value, coDot11StaVHTPktsRxNSS2MCS2=coDot11StaVHTPktsRxNSS2MCS2, coDot11StaPktsTxMCS15=coDot11StaPktsTxMCS15, coDot11WDSPortRxDropped=coDot11WDSPortRxDropped, coDot11StaVHTPktsTxNSS1MCS0=coDot11StaVHTPktsTxNSS1MCS0, coDot11WEPICVErrorCount=coDot11WEPICVErrorCount, coDot11RSNCompliance=coDot11RSNCompliance, coDot11FCSErrorCount=coDot11FCSErrorCount, coDot11WDSPortSNRLevel=coDot11WDSPortSNRLevel, coDot11PhyTxPowerOperLevel=coDot11PhyTxPowerOperLevel, coDot11StaPktsTxMCS11=coDot11StaPktsTxMCS11, coDot11StaHTRates=coDot11StaHTRates, coDot11StaPktsRxMCS22=coDot11StaPktsRxMCS22, coDot11StaPktsRxMCS6=coDot11StaPktsRxMCS6, coDot11StaPktsRxMCS20=coDot11StaPktsRxMCS20, coDot11StaPktsRxMCS2=coDot11StaPktsRxMCS2, coDot11OutOctets=coDot11OutOctets, coDot11StaVHTPktsRxNSS2MCS3=coDot11StaVHTPktsRxNSS2MCS3, coDot11AutoPowerInterval=coDot11AutoPowerInterval, coDot11SNRLevelNotificationEnabled=coDot11SNRLevelNotificationEnabled, coDot11PktsTxRate6=coDot11PktsTxRate6, coDot11AssociationIndex=coDot11AssociationIndex, coDot11CountersEntry=coDot11CountersEntry, coDot11DTIMPeriod=coDot11DTIMPeriod, coDot11StaPktsRxMCS16=coDot11StaPktsRxMCS16, coDot11SupportedDataRatesTxIndex=coDot11SupportedDataRatesTxIndex, coDot11PktsTxRate48=coDot11PktsTxRate48, coDot11DiversitySelectionRx=coDot11DiversitySelectionRx, coDot11DetStaIndex=coDot11DetStaIndex, coDot11TransmittedFragmentCount=coDot11TransmittedFragmentCount, coDot11PktsRate54=coDot11PktsRate54, coDot11PhyConfigEntry=coDot11PhyConfigEntry, coDot11ScanSecurity=coDot11ScanSecurity, coDot11PhyOperationTable=coDot11PhyOperationTable)
