...
mibBuilder.exportSymbols("ELH100-MIB", elh100System=elh100System, switchPortSpeed=switchPortSpeed, perfMonAgentAlignmentErrors=perfMonAgentAlignmentErrors, sNIndex=sNIndex, cabletronOEM=cabletronOEM, elh100TrapMgtRowCreation=elh100TrapMgtRowCreation, stackInusedGateway=stackInusedGateway, switchPortID=switchPortID, backupPortAction=backupPortAction, switchPortRunts=switchPortRunts, telnetAutoLogoutTimeout=telnetAutoLogoutTimeout, backupPriPortPort=backupPriPortPort, switchModuleActive=switchModuleActive, stackTemporalNetMask=stackTemporalNetMask, cabletronELH100BackupInfo=cabletronELH100BackupInfo, ipInformationReset=ipInformationReset, switchModuleType=switchModuleType, switchPortVeryLongEvents=switchPortVeryLongEvents, portTable=portTable, switchPortTable=switchPortTable, switchPortBroadcastPackets=switchPortBroadcastPackets, switchPortDataRateMismatches=switchPortDataRateMismatches, switchPortStatsID=switchPortStatsID, switchPortLink=switchPortLink, securityGroupID=securityGroupID, securityAddr=securityAddr, stackInusedIP=stackInusedIP, cabletronELH100=cabletronELH100, elh100TrapMgtIndex=elh100TrapMgtIndex, cabletronELH100gGroupInfo=cabletronELH100gGroupInfo, switchPortCollisions=switchPortCollisions, groupTable=groupTable, cabletronELH100SecurityInfo=cabletronELH100SecurityInfo, portSpeedConfig=portSpeedConfig, elh100HardwareVer=elh100HardwareVer, backupSecPortGroup=backupSecPortGroup, mgmtModuleDatabaseVersion=mgmtModuleDatabaseVersion, groupCounterReset=groupCounterReset, perfMonAgentCRCErrors=perfMonAgentCRCErrors, backplaneIsolated=backplaneIsolated, cabletronELH100PerfMonAgentInfo=cabletronELH100PerfMonAgentInfo, elh100DownloadMode=elh100DownloadMode, switchPortShortEvents=switchPortShortEvents, mgmtModuleStatus=mgmtModuleStatus, elh100CommunityStatus=elh100CommunityStatus, groupEntry=groupEntry, switchPortGroupID=switchPortGroupID, switchPortIsolates=switchPortIsolates, cabletronELH100SwitchStatsInfo=cabletronELH100SwitchStatsInfo, portEntry=portEntry, cabletronELH100BackupCapability=cabletronELH100BackupCapability, cabletronELH100SecurityCapability=cabletronELH100SecurityCapability, cabletron=cabletron, securityAutoLearnAction=securityAutoLearnAction, switchPortDuplex=switchPortDuplex, elh100DownloadMgt=elh100DownloadMgt, elh100DownloadAction=elh100DownloadAction, groupType=groupType, elh100MajorVer=elh100MajorVer, serialNumberTable=serialNumberTable, cabletronELH100SwitchInfo=cabletronELH100SwitchInfo, elh100CommunityRowCreation=elh100CommunityRowCreation, securityTable=securityTable, switchPortMulticastPackets=switchPortMulticastPackets, backplaneEntry=backplaneEntry, backplaneGroupID=backplaneGroupID, nicAttachSegment=nicAttachSegment, cabletronELH100BasicCapability=cabletronELH100BasicCapability, backplaneSegmentID=backplaneSegmentID, elh100CommunityString=elh100CommunityString, switchPortStatsTable=switchPortStatsTable, switchPortFCSErrors=switchPortFCSErrors, switchPortStatsGroupID=switchPortStatsGroupID, stackBootpIP=stackBootpIP, serialNumber=serialNumber, switchPortAutoPartitions=switchPortAutoPartitions, backupPriPortGroup=backupPriPortGroup, elh100TrapMgtIpAddress=elh100TrapMgtIpAddress, elh100TrapMgtCommunityString=elh100TrapMgtCommunityString, switchPortFramesTooLong=switchPortFramesTooLong, stackInusedNetMask=stackInusedNetMask, elh100DownloadFilename=elh100DownloadFilename, backupSecPortPort=backupSecPortPort, perfMonAgentSymbolErrors=perfMonAgentSymbolErrors, backupPortEntry=backupPortEntry, backupIndex=backupIndex, elh100CommunityTable=elh100CommunityTable, elh100CommunityEntry=elh100CommunityEntry, telnetMaxSessions=telnetMaxSessions, stackTemporalGateway=stackTemporalGateway, portGroupID=portGroupID, backupPortTable=backupPortTable, securityEnable=securityEnable, perfMonAgentTotalPortIsolates=perfMonAgentTotalPortIsolates, stackBootpEnable=stackBootpEnable, cabletronRepeaters=cabletronRepeaters, cabletronELH100AgentInfo=cabletronELH100AgentInfo, switchPortAdminStatus=switchPortAdminStatus, switchPortLateEvents=switchPortLateEvents, elh100TrapManagerMgt=elh100TrapManagerMgt, elh100CommunityMgt=elh100CommunityMgt, portID=portID, switchPortStatsEntry=switchPortStatsEntry, cabletronELH100Common=cabletronELH100Common, vT100RefreshInterval=vT100RefreshInterval, elh100DownloadServerIP=elh100DownloadServerIP, elh100Restart=elh100Restart, telnetAutoLogoutEnable=telnetAutoLogoutEnable, portLinkSpeed=portLinkSpeed, elh100CommunityIndex=elh100CommunityIndex, cabletronELH100PerfMonCapability=cabletronELH100PerfMonCapability, sNCurrentUnitID=sNCurrentUnitID, groupID=groupID, cabletronELH100PortInfo=cabletronELH100PortInfo, elh100TrapMgtEntry=elh100TrapMgtEntry, switchPortReadableFrames=switchPortReadableFrames, cabletronELH100SwitchCapability=cabletronELH100SwitchCapability, stackTemporalIP=stackTemporalIP, securityPortID=securityPortID, stackHealthMonitor=stackHealthMonitor, switchPortAlignmentErrors=switchPortAlignmentErrors, switchPortReadableOctets=switchPortReadableOctets, elh100MinorVer=elh100MinorVer, cabletronELH100StackInfo=cabletronELH100StackInfo, elh100TrapManagerTable=elh100TrapManagerTable, switchPortEntry=switchPortEntry, backplaneTable=backplaneTable, securityEntry=securityEntry, perfMonAgentCollisions=perfMonAgentCollisions, serialNumberEntry=serialNumberEntry)
