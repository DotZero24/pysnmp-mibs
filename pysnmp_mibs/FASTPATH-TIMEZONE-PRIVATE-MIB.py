# SNMP MIB module (FASTPATH-TIMEZONE-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-TIMEZONE-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:08:18 2025
...
agentSystemDate = _AgentSystemDate_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 32, 1, 2),
    _AgentSystemDate_Type()
)
agentSystemDate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
agentStRecurringZoneOffset = _AgentStRecurringZoneOffset_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 32, 3, 2, 10),
...
agentStNonRecurringZoneAcronym = _AgentStNonRecurringZoneAcronym_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 32, 3, 3, 10),
