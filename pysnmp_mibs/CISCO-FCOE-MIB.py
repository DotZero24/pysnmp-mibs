...
mibBuilder.exportSymbols("CISCO-FCOE-MIB", cfcoeVLANRowStatus=cfcoeVLANRowStatus, cfcoeVLANEntry=cfcoeVLANEntry, cfcoeCfgTable=cfcoeCfgTable, cfcoeStaticVfcIfIndex=cfcoeStaticVfcIfIndex, ciscoFCoEMIB=ciscoFCoEMIB, cfcoeCfgDefaultFCFPriority=cfcoeCfgDefaultFCFPriority, cfcoeVLANConformanceObjects=cfcoeVLANConformanceObjects, cfcoeCfgFcmap=cfcoeCfgFcmap, cfcoeStaticVfcBindMACAddress=cfcoeStaticVfcBindMACAddress, cFCoEMIBGroups=cFCoEMIBGroups, cfcoeEnodeIntfIfIndex=cfcoeEnodeIntfIfIndex, cfcoeStaticVfcFCFPriority=cfcoeStaticVfcFCFPriority, cfcoeCfgAddressingMode=cfcoeCfgAddressingMode, cfcoeStaticVfcFailureCause=cfcoeStaticVfcFailureCause, cfcoeFipSnoopingFcmap=cfcoeFipSnoopingFcmap, cfcoeEnodeIntfRowStatus=cfcoeEnodeIntfRowStatus, cfcoeCfgDATov=cfcoeCfgDATov, cfcoeCfgConformanceObjects=cfcoeCfgConformanceObjects, ciscoFCoEMIBConformance=ciscoFCoEMIBConformance, cfcoeFabricIndex=cfcoeFabricIndex, cfcoeStaticVfcRowStatus=cfcoeStaticVfcRowStatus, PYSNMP_MODULE_ID=ciscoFCoEMIB, cfcoeEnodeIntfTable=cfcoeEnodeIntfTable, cfcoeConfig=cfcoeConfig, cfcoeStaticVfcTable=cfcoeStaticVfcTable, cfcoeStaticVfcIndex=cfcoeStaticVfcIndex, cfcoeStaticVfcBindType=cfcoeStaticVfcBindType, cfcoeStaticVfcCreationTime=cfcoeStaticVfcCreationTime, ciscoFCoEMIBObjects=ciscoFCoEMIBObjects, cfcoeEnodeIntfEntry=cfcoeEnodeIntfEntry, cfcoeFipSnoopingEnable=cfcoeFipSnoopingEnable, cfcoeFipSnoopingConformanceObjects=cfcoeFipSnoopingConformanceObjects, cfcoeStaticVfcBindIfIndex=cfcoeStaticVfcBindIfIndex, cfcoeFipSnoopingObjects=cfcoeFipSnoopingObjects, cfcoeStaticVfcEntry=cfcoeStaticVfcEntry, cfcoeCfgEntry=cfcoeCfgEntry, cfcoeStaticVfcConformanceObjects=cfcoeStaticVfcConformanceObjects, cfcoeCfgDynamicVfcAgeTimer=cfcoeCfgDynamicVfcAgeTimer, cfcoeCfgDynamicVfcCreation=cfcoeCfgDynamicVfcCreation, cfcoeVLANIndex=cfcoeVLANIndex, cFCoEMIBCompliances=cFCoEMIBCompliances, cfcoeVLANOperState=cfcoeVLANOperState, VfcBindType=VfcBindType, cfcoeEnodeIntfObjects=cfcoeEnodeIntfObjects, cFCoEMIBCompliance=cFCoEMIBCompliance, cfcoeVLANTable=cfcoeVLANTable)
