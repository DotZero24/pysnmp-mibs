# SNMP MIB module (NETGEAR-RADLAN-DHCPCL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-DHCPCL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:04 2025
...
rlDhcpClActionEntry = _RlDhcpClActionEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 3, 1)
)
rlDhcpClActionEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpClActionIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpApprovalWaitingEntry = _RlDhcpApprovalWaitingEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 5, 1)
)
rlDhcpApprovalWaitingEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpApprovalWaitingIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpApprovalActionEntry = _RlDhcpApprovalActionEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 6, 1)
)
rlDhcpApprovalActionEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpApprovalActionIfIndex"),
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpApprovalActionAddress"),
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpApprovalActionMask"),
)
if mibBuilder.loadTexts:
...
rlDhcpClManualAutoConfigDataEntry = _RlDhcpClManualAutoConfigDataEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 26, 1)
)
rlDhcpClManualAutoConfigDataEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpClManualAutoConfigDataIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpClInformationEntry = _RlDhcpClInformationEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 27, 1)
)
rlDhcpClInformationEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpClInformationIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpClInformationTftpFileName = _RlDhcpClInformationTftpFileName_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 27, 1, 10),
...
rlDhcpClInformationTimeZone = _RlDhcpClInformationTimeZone_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 27, 1, 11),
...
rlDhcpClInformationTftpImageName = _RlDhcpClInformationTftpImageName_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 27, 1, 12),
...
rlDhcpClInformationDnsServerListEntry = _RlDhcpClInformationDnsServerListEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 28, 1)
)
rlDhcpClInformationDnsServerListEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpClInformationDnsServerListIfIndex"),
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpClInformationDnsServerListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpClInformationTftpServerListEntry = _RlDhcpClInformationTftpServerListEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 29, 1)
)
rlDhcpClInformationTftpServerListEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpClInformationTftpServerListIfIndex"),
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpClInformationTftpServerListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpClEnabledByDefaultRemovedEntry = _RlDhcpClEnabledByDefaultRemovedEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 76, 32, 1)
)
rlDhcpClEnabledByDefaultRemovedEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-DHCPCL-MIB", "rlDhcpClEnabledByDefaultRemovedIfIndex"),
)
if mibBuilder.loadTexts:
