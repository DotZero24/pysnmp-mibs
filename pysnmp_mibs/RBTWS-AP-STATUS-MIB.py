...
# Notes
# -----
# ASN.1 source file://mibs/cabletron/RBTWS-AP-STATUS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:55:28 2025
...
rbtwsApStatusCompliance.setObjects(
    ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusCommonGroup")
)
if mibBuilder.loadTexts:
...
rbtwsApStatusComplianceRev2.setObjects(
      *(("RBTWS-AP-STATUS-MIB", "rbtwsApStatusScalarsGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusApStatusTablesGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioStatusTablesGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioServiceTablesGroup"))
)
if mibBuilder.loadTexts:
...
rbtwsApStatusComplianceRev3.setObjects(
      *(("RBTWS-AP-STATUS-MIB", "rbtwsApStatusScalarsGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusApStatusTablesGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusApStatusVersionsGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioStatusTablesGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioStatusMaxPowerPhyTypeGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioServiceTablesGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioServiceOpRateSetTablesGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioOpStatisticsTablesGroup"),
...
rbtwsApStatusComplianceRev4.setObjects(
      *(("RBTWS-AP-STATUS-MIB", "rbtwsApStatusScalarsGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusApStatusTablesGroupRev2"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusApStatusVersionsGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioStatusTablesGroupRev2"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioStatusMaxPowerPhyTypeGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioServiceTablesGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioServiceOpRateSetTablesGroup"),
        ("RBTWS-AP-STATUS-MIB", "rbtwsApStatusRadioOpStatisticsTablesGroup"),
