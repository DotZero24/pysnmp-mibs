# SNMP MIB module (Dell-SMARTPORTS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-SMARTPORTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:50 2025
...
rlSmartPortsMacroManageEntry.setIndexNames(
    (1, "Dell-SMARTPORTS-MIB", "rlSmartPortsMacroName"),
)
if mibBuilder.loadTexts:
...
rlSmartPortsMacroContentEntry.setIndexNames(
    (0, "Dell-SMARTPORTS-MIB", "rlSmartPortsMacroIndex"),
    (0, "Dell-SMARTPORTS-MIB", "rlSmartPortsMacroOctetIndex"),
)
if mibBuilder.loadTexts:
...
rlSmartPortsMacroDescriptionEntry.setIndexNames(
    (0, "Dell-SMARTPORTS-MIB", "rlSmartPortsMacroDescriptionIndex"),
)
if mibBuilder.loadTexts:
