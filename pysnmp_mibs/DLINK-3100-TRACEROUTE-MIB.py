...
rlTraceRouteMibVersion=_RlTraceRouteMibVersion_Object((1,3,6,1,4,1,171,10,94,89,89,81,1),_RlTraceRouteMibVersion_Type())
rlTraceRouteMibVersion.setMaxAccess('read-only')
if mibBuilder.loadTexts:rlTraceRouteMibVersion.setStatus('current')
mibBuilder.exportSymbols('DLINK-3100-TRACEROUTE-MIB',**{'rlTraceRoute':rlTraceRoute,'rlTraceRouteMibVersion':rlTraceRouteMibVersion})