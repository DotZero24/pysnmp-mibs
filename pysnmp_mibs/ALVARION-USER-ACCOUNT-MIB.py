...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-USER-ACCOUNT-MIB
...
alvarionUserAccountMIBCompliance.setObjects(
    ("ALVARION-USER-ACCOUNT-MIB", "alvarionUserAccountStatusMIBGroup")
)
if mibBuilder.loadTexts:
