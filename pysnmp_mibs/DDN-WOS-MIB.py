...
# Notes
# -----
# ASN.1 source file://mibs/ddn/DDN-WOS-MIB
...
wosCompliance.setObjects(
      *(("DDN-WOS-MIB", "wosEventsGroup"),
        ("DDN-WOS-MIB", "wosNotificationsGroup"),
        ("DDN-WOS-MIB", "wosStatsGroup"),
        ("DDN-WOS-MIB", "wosAlertsGroup"),
        ("DDN-WOS-MIB", "wosClusterGroup"),
        ("DDN-WOS-MIB", "wosZonesGroup"),
        ("DDN-WOS-MIB", "wosNodesGroup"),
        ("DDN-WOS-MIB", "wosPoliciesGroup"),
        ("DDN-WOS-MIB", "wosPrefsGroup"))
)
if mibBuilder.loadTexts:
