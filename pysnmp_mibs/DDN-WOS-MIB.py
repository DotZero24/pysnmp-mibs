...
mibBuilder.exportSymbols("DDN-WOS-MIB", wosPrefEmailAlertServer=wosPrefEmailAlertServer, wosPrefSnmpManagerIndex=wosPrefSnmpManagerIndex, wosTrapType=wosTrapType, wosPolicyNonComplObjCountHigh=wosPolicyNonComplObjCountHigh, wosPrefClientIpFilterIndex=wosPrefClientIpFilterIndex, wosStatsReadLatency=wosStatsReadLatency, wosPendingNodeStatus=wosPendingNodeStatus, wosClusterConnectedClientsCount=wosClusterConnectedClientsCount, wosStatsGroup=wosStatsGroup, wosPoliciesGroup=wosPoliciesGroup, wosPrefSyslogRemoteHost=wosPrefSyslogRemoteHost, wosStatsInfo=wosStatsInfo, wosPolicyId=wosPolicyId, wos=wos, wosAlertTime=wosAlertTime, wosNodesGroup=wosNodesGroup, wosCompliances=wosCompliances, wosClusterActiveNodeCount=wosClusterActiveNodeCount, wosPrefClientIpFilterTable=wosPrefClientIpFilterTable, wosPrefMgmtIpFilterTable=wosPrefMgmtIpFilterTable, wosNodeStatus=wosNodeStatus, wosPrefClientIpFilterEntry=wosPrefClientIpFilterEntry, wosStatsWriteThroughput=wosStatsWriteThroughput, wosAlertType=wosAlertType, wosNodeDriveModel=wosNodeDriveModel, wosPrefEmailAlertRecipientIndex=wosPrefEmailAlertRecipientIndex, wosZoneEntry=wosZoneEntry, wosStatsDeleteLatency=wosStatsDeleteLatency, wosPrefEmailAlertServerTable=wosPrefEmailAlertServerTable, wosAlertIndex=wosAlertIndex, wosCompliance=wosCompliance, wosNotifications=wosNotifications, wosNodeEntry=wosNodeEntry, wosNodeObjectCountLow=wosNodeObjectCountLow, wosAlertDesc=wosAlertDesc, wosClusterUsedCapacity=wosClusterUsedCapacity, wosPrefEmailAlertNewInterval=wosPrefEmailAlertNewInterval, wosNodeAddressType=wosNodeAddressType, wosPrefSnmpManager=wosPrefSnmpManager, wosPendingNodeAddressType=wosPendingNodeAddressType, wosStatsFWPS=wosStatsFWPS, wosPrefSnmpManagerTable=wosPrefSnmpManagerTable, wosStatsWriteCount=wosStatsWriteCount, wosPoliciesInfo=wosPoliciesInfo, wosPrefSyslogFacility=wosPrefSyslogFacility, wosTrapMessage=wosTrapMessage, wosPolicyTable=wosPolicyTable, wosStatsFRPS=wosStatsFRPS, wosPolicyEntry=wosPolicyEntry, wosClusterId=wosClusterId, wosPolicyNonComplObjCountLow=wosPolicyNonComplObjCountLow, wosPolicyLocalDataProtection=wosPolicyLocalDataProtection, wosPrefsGroup=wosPrefsGroup, wosPolicyReplicationType=wosPolicyReplicationType, wosStatsDeleteCount=wosStatsDeleteCount, wosPrefEmailAlertRecipient=wosPrefEmailAlertRecipient, wosPendingNodeTable=wosPendingNodeTable, wosObjects=wosObjects, wosClusterUsableCapacity=wosClusterUsableCapacity, wosZonesInfo=wosZonesInfo, wosMIB=wosMIB, wosZoneNodeCount=wosZoneNodeCount, wosPrefEmailAlertRecipientTable=wosPrefEmailAlertRecipientTable, wosClusterStatus=wosClusterStatus, wosAlertLocation=wosAlertLocation, wosClusterGroup=wosClusterGroup, wosPrefEmailAlertServerIndex=wosPrefEmailAlertServerIndex, wosGroups=wosGroups, wosAlertsGroup=wosAlertsGroup, wosPolicyObjCountHigh=wosPolicyObjCountHigh, wosNodeDriveSlotNbr=wosNodeDriveSlotNbr, wosPolicyReplicaCount=wosPolicyReplicaCount, wosZoneName=wosZoneName, wosPrefStoreUnderReplObjs=wosPrefStoreUnderReplObjs, wosPrefEmailAlertRecipientEntry=wosPrefEmailAlertRecipientEntry, wosPrefSnmpTrapCommunityName=wosPrefSnmpTrapCommunityName, wosPrefSnmpManagerEntry=wosPrefSnmpManagerEntry, wosPrefMgmtIpFilterEntry=wosPrefMgmtIpFilterEntry, wosNodeDriveEntry=wosNodeDriveEntry, wosClusterName=wosClusterName, wosNodeTable=wosNodeTable, datadirect=datadirect, wosPolicyReplicaZoneName=wosPolicyReplicaZoneName, wosNodeDriveTable=wosNodeDriveTable, wosPrefsInfo=wosPrefsInfo, wosAlertEntry=wosAlertEntry, wosPendingNodeIndex=wosPendingNodeIndex, wosNodeDriveNodeName=wosNodeDriveNodeName, WosSyslogFacility=WosSyslogFacility, wosPrefNodeDownDelay=wosPrefNodeDownDelay, wosZoneTable=wosZoneTable, wosPrefMgmtIpFilter=wosPrefMgmtIpFilter, wosClusterTotalNodeCount=wosClusterTotalNodeCount, wosClusterObjectCountHigh=wosClusterObjectCountHigh, wosPolicyIndex=wosPolicyIndex, wosPrefMgmtIpFilterIndex=wosPrefMgmtIpFilterIndex, wosNodesInfo=wosNodesInfo, wosNodeName=wosNodeName, wosPrefEmailAlertServerEntry=wosPrefEmailAlertServerEntry, wosNodeUsedCapacity=wosNodeUsedCapacity, wosNodeObjectCountHigh=wosNodeObjectCountHigh, PYSNMP_MODULE_ID=wosMIB, wosClusterDisconnectedNodeCount=wosClusterDisconnectedNodeCount, wosAlertsInfo=wosAlertsInfo, wosNodeTotalCapacity=wosNodeTotalCapacity, wosConformance=wosConformance, wosNodeDriveStatus=wosNodeDriveStatus, wosNodeIndex=wosNodeIndex, wosNotificationInfo=wosNotificationInfo, wosTrapDesc=wosTrapDesc, wosZoneId=wosZoneId, wosPendingNodeAddress=wosPendingNodeAddress, wosPolicyObjCountLow=wosPolicyObjCountLow, wosNodeDriveCapacity=wosNodeDriveCapacity, wosClusterPrimaryNodeAddressType=wosClusterPrimaryNodeAddressType, wosPolicyReplicaIndex=wosPolicyReplicaIndex, wosClusterObjectCountLow=wosClusterObjectCountLow, wosTrapSeverity=wosTrapSeverity, wosPrefEmailAlertFromAddr=wosPrefEmailAlertFromAddr, wosPrefEmailAlertRmndrInterval=wosPrefEmailAlertRmndrInterval, wosNodeDriveMfgr=wosNodeDriveMfgr, wosPolicyUsedCapacity=wosPolicyUsedCapacity, wosStatsReadCount=wosStatsReadCount, wosPolicyName=wosPolicyName, wosAlertTable=wosAlertTable, wosClusterPrimaryNodeAddress=wosClusterPrimaryNodeAddress, wosEventsGroup=wosEventsGroup, wosNodeFwVersion=wosNodeFwVersion, wosClusterInfo=wosClusterInfo, wosStatsWriteLatency=wosStatsWriteLatency, wosClusterFreeCapacity=wosClusterFreeCapacity, wosPendingNodeEntry=wosPendingNodeEntry, wosStatsReadThroughput=wosStatsReadThroughput, wosZonesGroup=wosZonesGroup, WosSeverityLevel=WosSeverityLevel, wosNodeAddress=wosNodeAddress, wosNodePercentFull=wosNodePercentFull, wosStatsFDPS=wosStatsFDPS, wosNodeDriveSerialNbr=wosNodeDriveSerialNbr, wosAlertSeverity=wosAlertSeverity, wosNotificationsGroup=wosNotificationsGroup, wosNodeZoneName=wosNodeZoneName, wosPrefClientIpFilter=wosPrefClientIpFilter, wosTrapLocation=wosTrapLocation)
