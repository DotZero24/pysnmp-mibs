...
# Notes
# -----
# ASN.1 source file://mibs/rfc/PRINTER-PORT-MONITOR-MIB
...
ppmMIBCompliance.setObjects(
      *(("PRINTER-PORT-MONITOR-MIB", "ppmGeneralGroup"),
        ("PRINTER-PORT-MONITOR-MIB", "ppmPrinterGroup"),
        ("PRINTER-PORT-MONITOR-MIB", "ppmPortGroup"))
)
if mibBuilder.loadTexts:
