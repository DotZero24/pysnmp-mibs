...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TN-SAS-SERV-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:50:21 2025
...
class TSapIngressAggrMeterBurstSize(TextualConvention, Integer32):
    ...
    subtypeSpec += ConstraintsUnion(
        ...
        ValueRangeConstraint(1, 2146959),
    )
...
class _TnSapBaseInfoMacSwapEnable_Type(TruthValue):
    """Custom type tnSapBaseInfoMacSwapEnable based on TruthValue"""
    defaultValue = 2


_TnSapBaseInfoMacSwapEnable_Type.__name__ = "TruthValue"
_TnSapBaseInfoMacSwapEnable_Object = MibTableColumn
tnSapBaseInfoMacSwapEnable = _TnSapBaseInfoMacSwapEnable_Object(
    (1, 3, 6, 1, 4, 1, 7483, 7, 2, 2, 2, 8, 1, 2, 1, 12),
    _TnSapBaseInfoMacSwapEnable_Type()
)
tnSapBaseInfoMacSwapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tnSapBaseInfoMacSwapEnable.setStatus("current")


class _TnSapBaseInfoStatsCounterEnable_Type(TruthValue):
    """Custom type tnSapBaseInfoStatsCounterEnable based on TruthValue"""
    defaultValue = 1


_TnSapBaseInfoStatsCounterEnable_Type.__name__ = "TruthValue"
_TnSapBaseInfoStatsCounterEnable_Object = MibTableColumn
tnSapBaseInfoStatsCounterEnable = _TnSapBaseInfoStatsCounterEnable_Object(
    (1, 3, 6, 1, 4, 1, 7483, 7, 2, 2, 2, 8, 1, 2, 1, 13),
    _TnSapBaseInfoStatsCounterEnable_Type()
)
tnSapBaseInfoStatsCounterEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnSapBaseInfoStatsCounterEnable.setStatus("deprecated")
...
mibBuilder.exportSymbols(
    ...
    **{"TSapIngressAggrMeterBurstSize": TSapIngressAggrMeterBurstSize,
       ...
       "tnSapBaseInfoMacSwapEnable": tnSapBaseInfoMacSwapEnable,
       "tnSapBaseInfoStatsCounterEnable": tnSapBaseInfoStatsCounterEnable,
