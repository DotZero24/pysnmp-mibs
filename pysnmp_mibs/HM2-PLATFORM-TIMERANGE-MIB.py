...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hirschmann/HM2-PLATFORM-TIMERANGE-MIB
...
hm2AgentTimeRangeSNMPExtensionGroup = MibIdentifier((1, 3, 6, 1, 4, 1, 248, 12, 53, 260))
hm2AgentTimeRangeEndGreaterThanStartErrorReturn = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 53, 260, 1))
if mibBuilder.loadTexts: hm2AgentTimeRangeEndGreaterThanStartErrorReturn.setStatus('current')
hm2AgentTimeRangeEntriesOverlapErrorReturn = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 53, 260, 2))
if mibBuilder.loadTexts: hm2AgentTimeRangeEntriesOverlapErrorReturn.setStatus('current')
hm2AgentTimeRangeTooManyAbsoluteEntriesErrorReturn = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 53, 260, 3))
if mibBuilder.loadTexts: hm2AgentTimeRangeTooManyAbsoluteEntriesErrorReturn.setStatus('current')
hm2AgentTimeRangeDifferentMultiDayListsErrorReturn = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 53, 260, 4))
if mibBuilder.loadTexts: hm2AgentTimeRangeDifferentMultiDayListsErrorReturn.setStatus('current')
mibBuilder.exportSymbols("HM2-PLATFORM-TIMERANGE-MIB", hm2AgentTimeRangeAdminMode=hm2AgentTimeRangeAdminMode, hm2AgentTimeRangePeriodicStartDay=hm2AgentTimeRangePeriodicStartDay, hm2AgentTimeRangeAbsoluteStartDateAndTime=hm2AgentTimeRangeAbsoluteStartDateAndTime, hm2AgentTimeRangeGroup=hm2AgentTimeRangeGroup, hm2PlatformTimeRange=hm2PlatformTimeRange, hm2AgentTimeRangePeriodicEndTime=hm2AgentTimeRangePeriodicEndTime, hm2AgentTimeRangePeriodicStartTime=hm2AgentTimeRangePeriodicStartTime, hm2AgentTimeRangeEntriesOverlapErrorReturn=hm2AgentTimeRangeEntriesOverlapErrorReturn, hm2AgentTimeRangePeriodicEndDay=hm2AgentTimeRangePeriodicEndDay, hm2AgentTimeRangeStatus=hm2AgentTimeRangeStatus, hm2AgentTimeRangeIndex=hm2AgentTimeRangeIndex, PYSNMP_MODULE_ID=hm2PlatformTimeRange, hm2AgentTimeRangeSNMPExtensionGroup=hm2AgentTimeRangeSNMPExtensionGroup, hm2AgentTimeRangeAbsoluteEntry=hm2AgentTimeRangeAbsoluteEntry, hm2AgentTimeRangeAbsoluteStatus=hm2AgentTimeRangeAbsoluteStatus, hm2AgentTimeRangePeriodicEntry=hm2AgentTimeRangePeriodicEntry, hm2AgentTimeRangeEntry=hm2AgentTimeRangeEntry, hm2AgentTimeRangePeriodicTable=hm2AgentTimeRangePeriodicTable, hm2AgentTimeRangeAbsoluteEndDateAndTime=hm2AgentTimeRangeAbsoluteEndDateAndTime, Hm2AgentTimeRangePeriodicTime=Hm2AgentTimeRangePeriodicTime, hm2AgentTimeRangeEndGreaterThanStartErrorReturn=hm2AgentTimeRangeEndGreaterThanStartErrorReturn, hm2AgentTimeRangeAbsoluteEntryIndex=hm2AgentTimeRangeAbsoluteEntryIndex, hm2AgentTimeRangeDifferentMultiDayListsErrorReturn=hm2AgentTimeRangeDifferentMultiDayListsErrorReturn, hm2AgentTimeRangePeriodicStatus=hm2AgentTimeRangePeriodicStatus, hm2AgentTimeRangeTable=hm2AgentTimeRangeTable, hm2AgentTimeRangeName=hm2AgentTimeRangeName, hm2AgentTimeRangeIndexNextFree=hm2AgentTimeRangeIndexNextFree, hm2AgentTimeRangeOperState=hm2AgentTimeRangeOperState, hm2AgentTimeRangePeriodicEntryIndex=hm2AgentTimeRangePeriodicEntryIndex, Hm2AgentTimeRangeAbsoluteDateAndTime=Hm2AgentTimeRangeAbsoluteDateAndTime, hm2AgentTimeRangeAbsoluteTable=hm2AgentTimeRangeAbsoluteTable, hm2AgentTimeRangeTooManyAbsoluteEntriesErrorReturn=hm2AgentTimeRangeTooManyAbsoluteEntriesErrorReturn)
