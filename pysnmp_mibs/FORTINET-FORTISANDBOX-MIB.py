...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:21:49 2025
...
fsa3000F = _Fsa3000F_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12356, 118, 1, 30010)
)
_Fsa1000FDC_ObjectIdentity = ObjectIdentity
fsa1000FDC = _Fsa1000FDC_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12356, 118, 1, 30011)
)
...
fsaTrapJobInfo = _FsaTrapJobInfo_Object(
    (1, 3, 6, 1, 4, 1, 12356, 118, 6, 1),
    _FsaTrapJobInfo_Type()
)
fsaTrapJobInfo.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    fsaTrapJobInfo.setStatus("current")
...
fsaTrapRaidMsg = _FsaTrapRaidMsg_Object(
    (1, 3, 6, 1, 4, 1, 12356, 118, 6, 8),
    _FsaTrapRaidMsg_Type()
)
fsaTrapRaidMsg.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    fsaTrapRaidMsg.setStatus("current")
_FsaTrapAvgScanTime_Type = DisplayString
_FsaTrapAvgScanTime_Object = MibScalar
fsaTrapAvgScanTime = _FsaTrapAvgScanTime_Object(
    (1, 3, 6, 1, 4, 1, 12356, 118, 6, 9),
    _FsaTrapAvgScanTime_Type()
)
fsaTrapAvgScanTime.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    fsaTrapAvgScanTime.setStatus("current")
_FsaTrapLinkUp_Type = DisplayString
_FsaTrapLinkUp_Object = MibScalar
fsaTrapLinkUp = _FsaTrapLinkUp_Object(
    (1, 3, 6, 1, 4, 1, 12356, 118, 6, 10),
    _FsaTrapLinkUp_Type()
)
fsaTrapLinkUp.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    fsaTrapLinkUp.setStatus("current")
_FsaTrapLinkDown_Type = DisplayString
_FsaTrapLinkDown_Object = MibScalar
fsaTrapLinkDown = _FsaTrapLinkDown_Object(
    (1, 3, 6, 1, 4, 1, 12356, 118, 6, 11),
    _FsaTrapLinkDown_Type()
)
fsaTrapLinkDown.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    fsaTrapLinkDown.setStatus("current")
_FsaTrapContractExpire_Type = DisplayString
_FsaTrapContractExpire_Object = MibScalar
fsaTrapContractExpire = _FsaTrapContractExpire_Object(
    (1, 3, 6, 1, 4, 1, 12356, 118, 6, 12),
    _FsaTrapContractExpire_Type()
)
fsaTrapContractExpire.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    fsaTrapContractExpire.setStatus("current")
...
fsaTrapMalware.setObjects(
      *(("FORTINET-CORE-MIB", "fnSysSerial"),
        ("SNMPv2-MIB", "sysName"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapJobInfo"))
)
if mibBuilder.loadTexts:
...
fsaTrapRDM = NotificationType(
    (1, 3, 6, 1, 4, 1, 12356, 118, 2, 0, 508)
)
fsaTrapRDM.setObjects(
      *(("FORTINET-CORE-MIB", "fnSysSerial"),
        ("SNMPv2-MIB", "sysName"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapRaidMsg"))
)
if mibBuilder.loadTexts:
    fsaTrapRDM.setStatus(
        "current"
    )

fsaTrapAST = NotificationType(
    (1, 3, 6, 1, 4, 1, 12356, 118, 2, 0, 509)
)
fsaTrapAST.setObjects(
      *(("FORTINET-CORE-MIB", "fnSysSerial"),
        ("SNMPv2-MIB", "sysName"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapAvgScanTime"))
)
if mibBuilder.loadTexts:
    fsaTrapAST.setStatus(
        "current"
    )

fsaTrapLKUP = NotificationType(
    (1, 3, 6, 1, 4, 1, 12356, 118, 2, 0, 510)
)
fsaTrapLKUP.setObjects(
      *(("FORTINET-CORE-MIB", "fnSysSerial"),
        ("SNMPv2-MIB", "sysName"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapLinkUp"))
)
if mibBuilder.loadTexts:
    fsaTrapLKUP.setStatus(
        "current"
    )

fsaTrapLKDN = NotificationType(
    (1, 3, 6, 1, 4, 1, 12356, 118, 2, 0, 511)
)
fsaTrapLKDN.setObjects(
      *(("FORTINET-CORE-MIB", "fnSysSerial"),
        ("SNMPv2-MIB", "sysName"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapLinkDown"))
)
if mibBuilder.loadTexts:
    fsaTrapLKDN.setStatus(
        "current"
    )

fsaTrapCntExp = NotificationType(
    (1, 3, 6, 1, 4, 1, 12356, 118, 2, 0, 512)
)
fsaTrapCntExp.setObjects(
      *(("FORTINET-CORE-MIB", "fnSysSerial"),
        ("SNMPv2-MIB", "sysName"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapContractExpire"))
)
if mibBuilder.loadTexts:
    fsaTrapCntExp.setStatus(
        "current"
    )
...
fsaNotificationGroup.setObjects(
      *(("FORTINET-FORTISANDBOX-MIB", "fsaTrapMalware"),
        ...
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapRDM"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapAST"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapLKUP"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapLKDN"),
        ("FORTINET-FORTISANDBOX-MIB", "fsaTrapCntExp"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"FsaAdminPermLevel": FsaAdminPermLevel,
       ...
       "fsaTrapRDM": fsaTrapRDM,
       "fsaTrapAST": fsaTrapAST,
       "fsaTrapLKUP": fsaTrapLKUP,
       "fsaTrapLKDN": fsaTrapLKDN,
       "fsaTrapCntExp": fsaTrapCntExp,
       "fsaSystem": fsaSystem,
       ...
       "fsaTrapRaidMsg": fsaTrapRaidMsg,
       "fsaTrapAvgScanTime": fsaTrapAvgScanTime,
       "fsaTrapLinkUp": fsaTrapLinkUp,
       "fsaTrapLinkDown": fsaTrapLinkDown,
       "fsaTrapContractExpire": fsaTrapContractExpire,
