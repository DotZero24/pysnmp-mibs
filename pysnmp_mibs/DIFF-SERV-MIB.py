...
Gauge32, zeroDotZero, MibIdentifier, NotificationType, Bits, Integer32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, Counter64, ModuleIdentity, TimeTicks, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "zeroDotZero", "MibIdentifier", "NotificationType", "Bits", "Integer32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "Counter64", "ModuleIdentity", "TimeTicks", "mib-2")
RowStatus, TextualConvention, TestAndIncr, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TestAndIncr", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("DIFF-SERV-MIB", diffServActionDSCP=diffServActionDSCP, diffServTBMeterEntry=diffServTBMeterEntry, diffServTBMeterNumber=diffServTBMeterNumber, diffServQueueMinimumRate=diffServQueueMinimumRate, Dscp=Dscp, diffServQueueTable=diffServQueueTable, diffServQueueOccupancyWeight=diffServQueueOccupancyWeight, diffServClassifierNumber=diffServClassifierNumber, diffServTBMeterStatus=diffServTBMeterStatus, diffServMFClassifierTable=diffServMFClassifierTable, diffServInterfaceDirection=diffServInterfaceDirection, diffServAggregateDSCP=diffServAggregateDSCP, diffServObjects=diffServObjects, diffServMFClassifierSrcAddrMask=diffServMFClassifierSrcAddrMask, diffServClassifierConfigType=diffServClassifierConfigType, diffServTBMeterSucceedNext=diffServTBMeterSucceedNext, diffServQueuePriority=diffServQueuePriority, diffServTBMeterTable=diffServTBMeterTable, diffServClassifierStatus=diffServClassifierStatus, diffServQueueNumber=diffServQueueNumber, diffServClassifierConfigTypeInfo=diffServClassifierConfigTypeInfo, diffServMFClassifierDscp=diffServMFClassifierDscp, diffServTBMeterInterval=diffServTBMeterInterval, diffServQueueEntry=diffServQueueEntry, diffServClassifierSequence=diffServClassifierSequence, diffServActionConformingPackets=diffServActionConformingPackets, diffServMFClassifierDstL4PortMax=diffServMFClassifierDstL4PortMax, diffServActionHCTailDrops=diffServActionHCTailDrops, diffServClassifierTable=diffServClassifierTable, diffServActionNumber=diffServActionNumber, diffServMFClassifierIndex=diffServMFClassifierIndex, diffServMFClassifierDstL4PortMin=diffServMFClassifierDstL4PortMin, diffServMFClassifierSrcAddr=diffServMFClassifierSrcAddr, diffServQueueNextTCB=diffServQueueNextTCB, diffServAggregateEntry=diffServAggregateEntry, diffServMFClassifierSrcL4PortMax=diffServMFClassifierSrcL4PortMax, diffServActionRandomDrops=diffServActionRandomDrops, diffServActionTable=diffServActionTable, diffServMFClassifierUnique=diffServMFClassifierUnique, diffServMFClassifierAddrType=diffServMFClassifierAddrType, diffServClassifierUnique=diffServClassifierUnique, diffServMFClassifierDstAddrMask=diffServMFClassifierDstAddrMask, diffServClassifierNext=diffServClassifierNext, diffServActionUnique=diffServActionUnique, diffServActionMaxThreshold=diffServActionMaxThreshold, diffServActionStatus=diffServActionStatus, diffServClassifierMatchObject=diffServClassifierMatchObject, diffServTables=diffServTables, diffServTBMeterUnique=diffServTBMeterUnique, diffServMFClassifierEntry=diffServMFClassifierEntry, diffServQueueMaximumRate=diffServQueueMaximumRate, diffServActionHCConformingPackets=diffServActionHCConformingPackets, diffServActionHCRandomDrops=diffServActionHCRandomDrops, PYSNMP_MODULE_ID=diffServMib, diffServQueueStatus=diffServQueueStatus, diffServActionConformingOctets=diffServActionConformingOctets, diffServActionDropPolicy=diffServActionDropPolicy, diffServActionHCConformingOctets=diffServActionHCConformingOctets, diffServMFClassifierStatus=diffServMFClassifierStatus, diffServClassifierEntry=diffServClassifierEntry, diffServMFClassifierSrcL4PortMin=diffServMFClassifierSrcL4PortMin, diffServActionMinThreshold=diffServActionMinThreshold, MFClassifierL4Port=MFClassifierL4Port, diffServAggregateTable=diffServAggregateTable, diffServMFClassifierDstAddr=diffServMFClassifierDstAddr, diffServTBMeterFailNext=diffServTBMeterFailNext, diffServActionTailDrops=diffServActionTailDrops, diffServQueueUnique=diffServQueueUnique, diffServActionEntry=diffServActionEntry, diffServActionNext=diffServActionNext, diffServMIBConformance=diffServMIBConformance, diffServMFClassifierProtocol=diffServMFClassifierProtocol, diffServMib=diffServMib, diffServTBMeterBurstSize=diffServTBMeterBurstSize)
