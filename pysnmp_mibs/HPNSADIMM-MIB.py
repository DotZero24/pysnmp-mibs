...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPNSADIMM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:36:11 2025
...
class _HpnsaDIMMSocketDesignation_Type(DisplayString):
    """Custom type hpnsaDIMMSocketDesignation based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_HpnsaDIMMSocketDesignation_Type.__name__ = "DisplayString"
_HpnsaDIMMSocketDesignation_Object = MibTableColumn
hpnsaDIMMSocketDesignation = _HpnsaDIMMSocketDesignation_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 21, 3, 1, 1, 9),
    _HpnsaDIMMSocketDesignation_Type()
)
hpnsaDIMMSocketDesignation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpnsaDIMMSocketDesignation.setStatus("mandatory")
_HpnsaDIMMSoftwareStatus_Type = Integer32
_HpnsaDIMMSoftwareStatus_Object = MibTableColumn
hpnsaDIMMSoftwareStatus = _HpnsaDIMMSoftwareStatus_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 21, 3, 1, 1, 10),
    _HpnsaDIMMSoftwareStatus_Type()
)
hpnsaDIMMSoftwareStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnsaDIMMSoftwareStatus.setStatus("mandatory")
_HpnsaDIMMSingleBitEventCounter_Type = Integer32
_HpnsaDIMMSingleBitEventCounter_Object = MibTableColumn
hpnsaDIMMSingleBitEventCounter = _HpnsaDIMMSingleBitEventCounter_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 21, 3, 1, 1, 11),
    _HpnsaDIMMSingleBitEventCounter_Type()
)
hpnsaDIMMSingleBitEventCounter.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnsaDIMMSingleBitEventCounter.setStatus("mandatory")
_HpnsaDIMMPredictiveEventCounter_Type = Integer32
_HpnsaDIMMPredictiveEventCounter_Object = MibTableColumn
hpnsaDIMMPredictiveEventCounter = _HpnsaDIMMPredictiveEventCounter_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 21, 3, 1, 1, 12),
    _HpnsaDIMMPredictiveEventCounter_Type()
)
hpnsaDIMMPredictiveEventCounter.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnsaDIMMPredictiveEventCounter.setStatus("mandatory")
_HpnsaDIMMDoubleBitEventCounter_Type = Integer32
_HpnsaDIMMDoubleBitEventCounter_Object = MibTableColumn
hpnsaDIMMDoubleBitEventCounter = _HpnsaDIMMDoubleBitEventCounter_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 21, 3, 1, 1, 13),
    _HpnsaDIMMDoubleBitEventCounter_Type()
)
hpnsaDIMMDoubleBitEventCounter.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnsaDIMMDoubleBitEventCounter.setStatus("mandatory")
_HpnsaDIMMMostSevereEventID_Type = Integer32
_HpnsaDIMMMostSevereEventID_Object = MibTableColumn
hpnsaDIMMMostSevereEventID = _HpnsaDIMMMostSevereEventID_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 21, 3, 1, 1, 14),
    _HpnsaDIMMMostSevereEventID_Type()
)
hpnsaDIMMMostSevereEventID.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnsaDIMMMostSevereEventID.setStatus("mandatory")
_HpnsaDIMMHardwareStatus_Type = Integer32
_HpnsaDIMMHardwareStatus_Object = MibTableColumn
hpnsaDIMMHardwareStatus = _HpnsaDIMMHardwareStatus_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 21, 3, 1, 1, 15),
    _HpnsaDIMMHardwareStatus_Type()
)
hpnsaDIMMHardwareStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnsaDIMMHardwareStatus.setStatus("mandatory")
...
hpnsaDIMMStatus = _HpnsaDIMMStatus_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 21, 4)
)
_HpnsaDIMMOverallStatusSeverity_Type = Integer32
_HpnsaDIMMOverallStatusSeverity_Object = MibScalar
hpnsaDIMMOverallStatusSeverity = _HpnsaDIMMOverallStatusSeverity_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 23, 21, 4, 1),
    _HpnsaDIMMOverallStatusSeverity_Type()
)
hpnsaDIMMOverallStatusSeverity.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpnsaDIMMOverallStatusSeverity.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"hp": hp,
       ...
       "hpnsaDIMMSocketDesignation": hpnsaDIMMSocketDesignation,
       "hpnsaDIMMSoftwareStatus": hpnsaDIMMSoftwareStatus,
       "hpnsaDIMMSingleBitEventCounter": hpnsaDIMMSingleBitEventCounter,
       "hpnsaDIMMPredictiveEventCounter": hpnsaDIMMPredictiveEventCounter,
       "hpnsaDIMMDoubleBitEventCounter": hpnsaDIMMDoubleBitEventCounter,
       "hpnsaDIMMMostSevereEventID": hpnsaDIMMMostSevereEventID,
       "hpnsaDIMMHardwareStatus": hpnsaDIMMHardwareStatus,
       ...
       "hpnsaDIMMStatus": hpnsaDIMMStatus,
       "hpnsaDIMMOverallStatusSeverity": hpnsaDIMMOverallStatusSeverity}
)
