...
mibBuilder.exportSymbols("CISCO-DIAL-CONTROL-MIB", cCallHistory=cCallHistory, cCallHistoryLogicalIfIndex=cCallHistoryLogicalIfIndex, cCallHistoryReleaseSrc=cCallHistoryReleaseSrc, cCallHistoryEntry=cCallHistoryEntry, cCallHistoryIec=cCallHistoryIec, cCallHistoryDisconnectText=cCallHistoryDisconnectText, cCallHistoryPeerAddress=cCallHistoryPeerAddress, ciscoDialControlMibComplianceRev4=ciscoDialControlMibComplianceRev4, cCallHistoryTransmitBytes=cCallHistoryTransmitBytes, cCallHistoryReceivePackets=cCallHistoryReceivePackets, cCallHistoryReleaseSource=cCallHistoryReleaseSource, cCallHistoryChargedUnits=cCallHistoryChargedUnits, cCallHistoryIndex=cCallHistoryIndex, cCallHistoryIecTable=cCallHistoryIecTable, ciscoDialControlMibCompliances=ciscoDialControlMibCompliances, cCallHistoryPeerSubAddress=cCallHistoryPeerSubAddress, cCallHistoryCallOrigin=cCallHistoryCallOrigin, cCallHistoryInfoType=cCallHistoryInfoType, cPeerGlobalConfiguration=cPeerGlobalConfiguration, ciscoDialControlMibConformance=ciscoDialControlMibConformance, cPeerGlobalConfigurationGroup=cPeerGlobalConfigurationGroup, ciscoDialControlMibComplianceRev3=ciscoDialControlMibComplianceRev3, ciscoDialControlMibObjects=ciscoDialControlMibObjects, cCallHistoryGroup=cCallHistoryGroup, cCallHistoryGroupRev1=cCallHistoryGroupRev1, cCallHistoryReceiveBytes=cCallHistoryReceiveBytes, ciscoDialControlMibGroups=ciscoDialControlMibGroups, cCallHistoryTable=cCallHistoryTable, cCallHistoryDisconnectCause=cCallHistoryDisconnectCause, cCallHistoryIecIndex=cCallHistoryIecIndex, cCallHistoryIecGroup=cCallHistoryIecGroup, PYSNMP_MODULE_ID=ciscoDialControlMib, cCallHistoryPeerId=cCallHistoryPeerId, cCallHistoryGroupRev2=cCallHistoryGroupRev2, cPeerSearchType=cPeerSearchType, cCallHistoryConnectTime=cCallHistoryConnectTime, ciscoDialControlMibComplianceRev1=ciscoDialControlMibComplianceRev1, cCallHistorySetupTime=cCallHistorySetupTime, cCallHistoryPeerIfIndex=cCallHistoryPeerIfIndex, ciscoDialControlMibCompliance=ciscoDialControlMibCompliance, cCallHistoryTransmitPackets=cCallHistoryTransmitPackets, ciscoDialControlMib=ciscoDialControlMib, cCallHistoryIecEntry=cCallHistoryIecEntry, ciscoDialControlMibComplianceRev2=ciscoDialControlMibComplianceRev2, cCallHistoryDisconnectTime=cCallHistoryDisconnectTime)
