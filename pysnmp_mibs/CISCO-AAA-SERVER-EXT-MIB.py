...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-AAA-SERVER-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:34:57 2025
...
_CAAALoginAuthTypeMSCHAP_Type.__name__ = "TruthValue"
...
_CAAAServerAddrType_Type.__name__ = "InetAddressType"
...
_CAAAServerKeyEncrType_Type.__name__ = "CiscoAAAServerKeyEncrType"
...
class _CAAAServerProtoAuthKey_Type(DisplayString):
    """Custom type cAAAServerProtoAuthKey based on DisplayString"""
    defaultValue = OctetString("")


_CAAAServerProtoAuthKey_Type.__name__ = "DisplayString"
...
_CAAAServerProtoKeyEncrType_Type.__name__ = "CiscoAAAServerKeyEncrType"
...
_CAAAServerProtoDirectedReq_Type.__name__ = "TruthValue"
...
_CAAASvrGrpProtocol_Type.__name__ = "CiscoAAAProtocol"
...
ciscoAAAServerMIBCompliance.setObjects(
      *(("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtGenericConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtSvrTableConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtProtoParamConfigGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtSvrGroupConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtAppSvrGroupConfGroup"))
)
if mibBuilder.loadTexts:
...
ciscoAAAServerMIBCompliance1.setObjects(
      *(("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtGenericConfGroup1"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtSvrTableConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtProtoParamConfigGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtSvrGroupConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtAppSvrGroupConfGroup"))
...
ciscoAAAServerMIBCompliance2.setObjects(
      *(("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtGenericConfGroup1"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtSvrTableConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtProtoParamConfigGroup1"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtSvrGroupConfGroup2"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtAppSvrGroupConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtSvrTableLDAPConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtSvrGroupLDAPConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtSvrMonitorConfGroup"),
        ("CISCO-AAA-SERVER-EXT-MIB", "cAAASvrExtGenericConfGroup2"))
)
if mibBuilder.loadTexts:
