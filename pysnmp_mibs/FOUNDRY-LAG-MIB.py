...
# Notes
# -----
# ASN.1 source file://mibs/brocade/FOUNDRY-LAG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:01:17 2025
...
fdryLinkAggregationGroupId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
fdryLinkAggregationGroupLacpMode = _FdryLinkAggregationGroupLacpMode_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 1, 3, 33, 1, 1, 1, 13),
    _FdryLinkAggregationGroupLacpMode_Type()
)
fdryLinkAggregationGroupLacpMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fdryLinkAggregationGroupLacpMode.setStatus("current")
_FdryLinkAggregationGroupLagMac_Type = MacAddress
_FdryLinkAggregationGroupLagMac_Object = MibTableColumn
fdryLinkAggregationGroupLagMac = _FdryLinkAggregationGroupLagMac_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 1, 3, 33, 1, 1, 1, 14),
    _FdryLinkAggregationGroupLagMac_Type()
)
fdryLinkAggregationGroupLagMac.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fdryLinkAggregationGroupLagMac.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"fdryLinkAggregationGroupMIB": fdryLinkAggregationGroupMIB,
       ...
       "fdryLinkAggregationGroupLacpMode": fdryLinkAggregationGroupLacpMode,
       "fdryLinkAggregationGroupLagMac": fdryLinkAggregationGroupLagMac,
