...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/saf/SAF-INTEGRAB-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:53:56 2025
...
integraB.setRevisions(('2019-04-23 00:00', '2018-06-28 00:00', '2016-05-11 00:00', '2015-09-17 00:00', '2015-09-15 00:00', '2015-08-12 00:00', '2015-07-20 00:00', '2015-05-20 00:00', '2015-04-14 00:00', '2015-03-24 00:00', '2015-02-10 00:00', '2015-02-04 00:00', '2015-01-12 00:00', '2015-01-08 00:00', '2015-01-06 00:00', '2014-12-18 00:00', '2014-12-12 00:00', '2014-12-10 00:00', '2014-12-09 00:00', '2014-11-22 00:00', '2014-10-29 00:00', '2014-09-04 00:00', '2014-08-01 00:00', '2014-06-11 00:00', '2014-04-16 00:00', '2014-02-12 00:00', '2014-02-11 00:00', '2014-01-30 00:00', '2014-01-29 00:00', '2013-12-18 00:00', '2013-12-09 00:00', '2013-12-05 00:00', '2013-09-27 00:00', '2013-09-19 00:00',))
if mibBuilder.loadTexts: integraB.setLastUpdated('201904230000Z')
...
integraBradioRxLevelState = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 2, 12), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("ok", 1), ("low", 2), ("high", 3), ("error", 4)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBradioRxLevelState.setStatus('current')
...
integraBmodemCountTime = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 14), Counter64()).setUnits('s').setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemCountTime.setStatus('current')
integraBmodemErroredBlock = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 15), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemErroredBlock.setStatus('current')
integraBmodemErroredSecond = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 16), Counter64()).setUnits('s').setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemErroredSecond.setStatus('current')
integraBmodemSeverelyErroredSecond = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 17), Counter64()).setUnits('s').setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemSeverelyErroredSecond.setStatus('current')
integraBmodemBackgroundBlockError = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 18), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemBackgroundBlockError.setStatus('current')
integraBmodemTotalBlockNumber = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 19), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemTotalBlockNumber.setStatus('current')
integraBmodemErroredSecondRatio = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 20), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemErroredSecondRatio.setStatus('current')
integraBmodemSeverelyErroredSecondRatio = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 21), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemSeverelyErroredSecondRatio.setStatus('current')
integraBmodemBackgroundBlockErrorRatio = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 22), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemBackgroundBlockErrorRatio.setStatus('current')
integraBmodemUptime = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 23), Counter64()).setUnits('s').setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemUptime.setStatus('current')
integraBmodemUnavailtime = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 3, 24), Counter64()).setUnits('s').setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBmodemUnavailtime.setStatus('current')
...
integraBsysDeviceType = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 4, 11), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBsysDeviceType.setStatus('current')
integraBsysDeviceSerial = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 4, 12), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBsysDeviceSerial.setStatus('current')
integraBsysDeviceProductModel = MibScalar((1, 3, 6, 1, 4, 1, 7571, 100, 1, 1, 7, 1, 4, 13), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: integraBsysDeviceProductModel.setStatus('current')
...
mibBuilder.exportSymbols("SAF-INTEGRAB-MIB", integraBifPortSpeed=integraBifPortSpeed, integraBifCosqStatDroppedBytesCoSQ4=integraBifCosqStatDroppedBytesCoSQ4, integraBEthernetMiiPortGroup=integraBEthernetMiiPortGroup, integraBsysFreeMemory=integraBsysFreeMemory, integraBmodemSeverelyErroredSecond=integraBmodemSeverelyErroredSecond, integraBifProcessedRxPackets=integraBifProcessedRxPackets, integraBifPortLastChange=integraBifPortLastChange, integraBifPortMtu=integraBifPortMtu, integraBifRateLimitDropForUnknownMulticastIngressBytes=integraBifRateLimitDropForUnknownMulticastIngressBytes, integraB=integraB, integraBifEgressBPS=integraBifEgressBPS, integraBmodemErroredSecond=integraBmodemErroredSecond, integraBifEgressPackets=integraBifEgressPackets, integraBifMRUdropEgressPackets=integraBifMRUdropEgressPackets, integraBifRateLimitDropForKnownMulticastIngressPackets=integraBifRateLimitDropForKnownMulticastIngressPackets, integraBifPortDuplex=integraBifPortDuplex, integraBifCosqStatOutBytesCoSQ4=integraBifCosqStatOutBytesCoSQ4, integraBCompliances=integraBCompliances, integraBmodemTxModulation=integraBmodemTxModulation, integraBmodemUnavailtime=integraBmodemUnavailtime, integraBifCosqStatOutPacketsCoSQ3=integraBifCosqStatOutPacketsCoSQ3, integraBifCosqStatDroppedPacketsCoSQ5=integraBifCosqStatDroppedPacketsCoSQ5, integraBifDot1dTpPortInFrames=integraBifDot1dTpPortInFrames, integraBnetCfgIPgateway=integraBnetCfgIPgateway, integraBifDot1dTpPortOutFrames=integraBifDot1dTpPortOutFrames, integraBethernet=integraBethernet, integraBifCosqStatDroppedPacketsCoSQ2=integraBifCosqStatDroppedPacketsCoSQ2, integraBifTransmittedPkts256to511Octets=integraBifTransmittedPkts256to511Octets, integraBifCosqStatGreenDiscardDroppedPacketsCoSQ7=integraBifCosqStatGreenDiscardDroppedPacketsCoSQ7, integraBifPortType=integraBifPortType, integraBifReceivedPkts65to127Octets=integraBifReceivedPkts65to127Octets, integraBifIngressPackets=integraBifIngressPackets, integraBsysPSUpower=integraBsysPSUpower, integraBifCosqStatGreenDiscardDroppedPacketsCoSQ0=integraBifCosqStatGreenDiscardDroppedPacketsCoSQ0, integraBifRateLimitDropForKnownMulticastIngressBytes=integraBifRateLimitDropForKnownMulticastIngressBytes, integraBifCosqStatYellowDiscardDroppedPacketsCoSQ2=integraBifCosqStatYellowDiscardDroppedPacketsCoSQ2, integraBifEtherStatsBroadcastPkts=integraBifEtherStatsBroadcastPkts, integraBmodemRxModulation=integraBmodemRxModulation, integraBmodemACMengine=integraBmodemACMengine, integraBifCosqStatDroppedBytesCoSQ0=integraBifCosqStatDroppedBytesCoSQ0, integraBifCosqStatGreenDiscardDroppedPacketsCoSQ6=integraBifCosqStatGreenDiscardDroppedPacketsCoSQ6, integraBifCosqStatOutBytesCoSQ3=integraBifCosqStatOutBytesCoSQ3, integraBifPortRateLimitDropIngressBytes=integraBifPortRateLimitDropIngressBytes, integraBifPortAutoneg=integraBifPortAutoneg, integraBmodemBandwidth=integraBmodemBandwidth, integraBifIfInMulticastPkts=integraBifIfInMulticastPkts, integraBSystemGroup=integraBSystemGroup, integraBtimestamp=integraBtimestamp, integraBradioTxMute=integraBradioTxMute, integraBifCosqStatYellowDiscardDroppedPacketsCoSQ5=integraBifCosqStatYellowDiscardDroppedPacketsCoSQ5, integraBifCosqStatOutPacketsCoSQ0=integraBifCosqStatOutPacketsCoSQ0, integraBifEtherStatsMulticastPkts=integraBifEtherStatsMulticastPkts, integraBifPausePFCframesGeneratedEgressPackets=integraBifPausePFCframesGeneratedEgressPackets, integraBifIfOutBroadcastPkts=integraBifIfOutBroadcastPkts, integraBMiscGroup=integraBMiscGroup, integraBifCosqStatOutPacketsCoSQ4=integraBifCosqStatOutPacketsCoSQ4, integraBradioTxPower=integraBradioTxPower, integraBifReceivedPkts1024to1518Octets=integraBifReceivedPkts1024to1518Octets, integraBifIfOutMulticastPkts=integraBifIfOutMulticastPkts, integraBsysCPUidle=integraBsysCPUidle, integraBifSTPdropIngressPackets=integraBifSTPdropIngressPackets, integraBradioTxMuteDuration=integraBradioTxMuteDuration, integraBradioRangeTxPower=integraBradioRangeTxPower, integraBifCosqStatDroppedBytesCoSQ1=integraBifCosqStatDroppedBytesCoSQ1, integraBnetCfgRemoteIPaddress=integraBnetCfgRemoteIPaddress, integraBifPortSyncEthActive=integraBifPortSyncEthActive, integraBifStatisticsTable=integraBifStatisticsTable, integraBsysDeviceType=integraBsysDeviceType, integraBradioRangeDescr=integraBradioRangeDescr, integraBifCosqStatDroppedPacketsCoSQ6=integraBifCosqStatDroppedPacketsCoSQ6, integraBmodemSeverelyErroredSecondRatio=integraBmodemSeverelyErroredSecondRatio, integraBifEtherStatsJabbers=integraBifEtherStatsJabbers, integraBifMAClearnLimitDropIngressPackets=integraBifMAClearnLimitDropIngressPackets, integraBifDot3InPauseFrames=integraBifDot3InPauseFrames, integraBifCosqStatOutBytesCoSQ6=integraBifCosqStatOutBytesCoSQ6, integraBifCosqStatOutPacketsCoSQ6=integraBifCosqStatOutPacketsCoSQ6, integraBifPortStatDescr=integraBifPortStatDescr, integraBifTransmittedPkts64Octets=integraBifTransmittedPkts64Octets, integraBifEtherStatsPkts1519to1522Octets=integraBifEtherStatsPkts1519to1522Octets, integraBifCosqStatDroppedPacketsCoSQ1=integraBifCosqStatDroppedPacketsCoSQ1, integraBifRateLimitDropForBroadcastIngressPackets=integraBifRateLimitDropForBroadcastIngressPackets, integraBradioRxFrequency=integraBradioRxFrequency, integraBifCosqStatYellowDiscardDroppedPacketsCoSQ4=integraBifCosqStatYellowDiscardDroppedPacketsCoSQ4, integraBmodemTotalBlockNumber=integraBmodemTotalBlockNumber, integraBradioPLL=integraBradioPLL, integraBifPortStatIndex=integraBifPortStatIndex, integraBifCosqStatOutPacketsCoSQ1=integraBifCosqStatOutPacketsCoSQ1, integraBifMRUdropIngressPackets=integraBifMRUdropIngressPackets, integraBifPortAdminStatus=integraBifPortAdminStatus, integraBifAllCoSQdroppedBytes=integraBifAllCoSQdroppedBytes, integraBifCosqIfaceIndex=integraBifCosqIfaceIndex, integraBifEtherRxOversizePkts=integraBifEtherRxOversizePkts, integraBifCosqStatDroppedPacketsCoSQ0=integraBifCosqStatDroppedPacketsCoSQ0, integraBGroups=integraBGroups, integraBradioRangesTable=integraBradioRangesTable, integraBsysPSUcurrent=integraBsysPSUcurrent, integraBifEtherStatsPkts64Octets=integraBifEtherStatsPkts64Octets, integraBifFlowClassifierDropIngressPackets=integraBifFlowClassifierDropIngressPackets, integraBConformance=integraBConformance, integraBifPortOperStatus=integraBifPortOperStatus, integraBRadioGroup=integraBRadioGroup, integraBifFilterDropIngressPackets=integraBifFilterDropIngressPackets, integraBsysDeviceProductModel=integraBsysDeviceProductModel, integraBifCosqStatYellowDiscardDroppedPacketsCoSQ7=integraBifCosqStatYellowDiscardDroppedPacketsCoSQ7, integraBradio=integraBradio, integraBmodemAcquireStatus=integraBmodemAcquireStatus, integraBifCosqEntry=integraBifCosqEntry, integraBifCosqStatGreenDiscardDroppedPacketsCoSQ5=integraBifCosqStatGreenDiscardDroppedPacketsCoSQ5, integraBnetCfgIPaddress=integraBnetCfgIPaddress, integraBifEtherTxOversizePkts=integraBifEtherTxOversizePkts, integraBstoreConfig=integraBstoreConfig, integraBnetCfg=integraBnetCfg, integraBifTransmittedPkts1024to1518Octets=integraBifTransmittedPkts1024to1518Octets, integraBifCosqStatGreenDiscardDroppedPacketsCoSQ3=integraBifCosqStatGreenDiscardDroppedPacketsCoSQ3, integraBifDot3OutPauseFrames=integraBifDot3OutPauseFrames, integraBifEtherStatsFragments=integraBifEtherStatsFragments, integraBifAllCoSQoutPackets=integraBifAllCoSQoutPackets, integraBifIngressPPS=integraBifIngressPPS, integraBmodemTxCapacity=integraBmodemTxCapacity, integraBifCosqStatDroppedBytesCoSQ6=integraBifCosqStatDroppedBytesCoSQ6, integraBmodemRxCapacity=integraBmodemRxCapacity, integraBifRateLimitDropForUnknownUnicastIngressPackets=integraBifRateLimitDropForUnknownUnicastIngressPackets, integraBifIngressBytes=integraBifIngressBytes, integraBmodemErroredSecondRatio=integraBmodemErroredSecondRatio, integraBsysLicenseGenStatus=integraBsysLicenseGenStatus, integraBifCosqStatOutBytesCoSQ0=integraBifCosqStatOutBytesCoSQ0, integraBifIfInBroadcastPkts=integraBifIfInBroadcastPkts, integraBifCosqStatDroppedBytesCoSQ2=integraBifCosqStatDroppedBytesCoSQ2, integraBifTransmittedPkts512to1023Octets=integraBifTransmittedPkts512to1023Octets, integraBneedStore=integraBneedStore, integraBifCosqStatOutBytesCoSQ7=integraBifCosqStatOutBytesCoSQ7, integraBifCosqStatGreenDiscardDroppedPacketsCoSQ1=integraBifCosqStatGreenDiscardDroppedPacketsCoSQ1, integraBradioRangeTxFrequency=integraBradioRangeTxFrequency, integraBifCosqStatOutBytesCoSQ2=integraBifCosqStatOutBytesCoSQ2, integraBifRateLimitDropForUnknownMulticastIngressPackets=integraBifRateLimitDropForUnknownMulticastIngressPackets, integraBsysPSUvoltage=integraBsysPSUvoltage, integraBmodemCountTime=integraBmodemCountTime, integraBifCosqStatDroppedPacketsCoSQ3=integraBifCosqStatDroppedPacketsCoSQ3, integraBifCosqStatYellowDiscardDroppedPacketsCoSQ3=integraBifCosqStatYellowDiscardDroppedPacketsCoSQ3, integraBifPortSyncEthPrio=integraBifPortSyncEthPrio, integraBifTimePassed=integraBifTimePassed, integraBifEtherStatsPkts512to1023Octets=integraBifEtherStatsPkts512to1023Octets, integraBradioRangeEntry=integraBradioRangeEntry, integraBmodemBackgroundBlockError=integraBmodemBackgroundBlockError, integraBsysLicenseExpire=integraBsysLicenseExpire, integraBradioSide=integraBradioSide, integraBmodemUptime=integraBmodemUptime, integraBifPortEntry=integraBifPortEntry, integraBsysBoardTemperature=integraBsysBoardTemperature, integraBifEtherStatsOctets=integraBifEtherStatsOctets, integraBradioRangeEntryIndex=integraBradioRangeEntryIndex, integraBifEtherStatsCRCAlignErrors=integraBifEtherStatsCRCAlignErrors, integraBifEgressPPS=integraBifEgressPPS, integraBifCosqStatYellowDiscardDroppedPacketsCoSQ1=integraBifCosqStatYellowDiscardDroppedPacketsCoSQ1, integraBifReceivedPkts64Octets=integraBifReceivedPkts64Octets, integraBmodemRadialMse=integraBmodemRadialMse, integraBifAllCoSQoutBytes=integraBifAllCoSQoutBytes, integraBEthernetQosQueueGroup=integraBEthernetQosQueueGroup, integraBifFlowClassifierDropEgressPackets=integraBifFlowClassifierDropEgressPackets, integraBifAllCoSQdroppedPackets=integraBifAllCoSQdroppedPackets, integraBifCosqStatYellowDiscardDroppedPacketsCoSQ0=integraBifCosqStatYellowDiscardDroppedPacketsCoSQ0, integraBifEFMdropIngressPackets=integraBifEFMdropIngressPackets, integraBifCosqStatGreenDiscardDroppedPacketsCoSQ2=integraBifCosqStatGreenDiscardDroppedPacketsCoSQ2, integraBifPortPhysAddress=integraBifPortPhysAddress, integraBradioDuplexShift=integraBradioDuplexShift, integraBmodemTemperature=integraBmodemTemperature, integraBifIfInOctets=integraBifIfInOctets, integraBradioTemperature=integraBradioTemperature, integraBsysCPUtemperature=integraBsysCPUtemperature, integraBifCosqStatOutPacketsCoSQ7=integraBifCosqStatOutPacketsCoSQ7, integraBifCosqStatDroppedBytesCoSQ5=integraBifCosqStatDroppedBytesCoSQ5, integraBifCosqStatDroppedBytesCoSQ3=integraBifCosqStatDroppedBytesCoSQ3, integraBifReceivedPkts128to255Octets=integraBifReceivedPkts128to255Octets, integraBifStatusTable=integraBifStatusTable, integraBradioRxLevel=integraBradioRxLevel, integraBradioTxFrequency=integraBradioTxFrequency, integraBmodemAcquireLastStatusDetails=integraBmodemAcquireLastStatusDetails, integraBifIngressBPS=integraBifIngressBPS, integraBnetCfgIPmask=integraBnetCfgIPmask, integraBifEtherStatsTXNoErrors=integraBifEtherStatsTXNoErrors, integraBifEtherStatsUndersizePkts=integraBifEtherStatsUndersizePkts, integraBifRateLimitDropForBroadcastIngressBytes=integraBifRateLimitDropForBroadcastIngressBytes, integraBifTransmittedPkts128to255Octets=integraBifTransmittedPkts128to255Octets, integraBifEgressBytes=integraBifEgressBytes, integraBifPausePFCframesGeneratedIngressPackets=integraBifPausePFCframesGeneratedIngressPackets, integraBifPortStcDescr=integraBifPortStcDescr, integraBmodemFECload=integraBmodemFECload, integraBsysDeviceSerial=integraBsysDeviceSerial, integraBifCosqStatDroppedBytesCoSQ7=integraBifCosqStatDroppedBytesCoSQ7, integraBifProcessedRxBytes=integraBifProcessedRxBytes, integraBifEtherStatsPkts128to255Octets=integraBifEtherStatsPkts128to255Octets, integraBifEFMdropEgressPackets=integraBifEFMdropEgressPackets, integraBifCosqStatGreenDiscardDroppedPacketsCoSQ4=integraBifCosqStatGreenDiscardDroppedPacketsCoSQ4, integraBifQosStatisticsTable=integraBifQosStatisticsTable, integraBifCosqStatDroppedPacketsCoSQ7=integraBifCosqStatDroppedPacketsCoSQ7, integraBCompliance=integraBCompliance, integraBifCosqStatOutBytesCoSQ5=integraBifCosqStatOutBytesCoSQ5, integraBifCosqStatYellowDiscardDroppedPacketsCoSQ6=integraBifCosqStatYellowDiscardDroppedPacketsCoSQ6, PYSNMP_MODULE_ID=integraB, integraBifEtherStatsOversizePkts=integraBifEtherStatsOversizePkts, integraBifCosqStatOutPacketsCoSQ5=integraBifCosqStatOutPacketsCoSQ5, integraBifEtherStatsPkts256to511Octets=integraBifEtherStatsPkts256to511Octets, integraBifRateLimitDropForUnknownUnicastIngressBytes=integraBifRateLimitDropForUnknownUnicastIngressBytes, integraBifCosqStatOutPacketsCoSQ2=integraBifCosqStatOutPacketsCoSQ2, integraBifReceivedPkts256to511Octets=integraBifReceivedPkts256to511Octets, integraBifPortStcIndex=integraBifPortStcIndex, integraBifIfOutOctets=integraBifIfOutOctets, integraBmodemModulation=integraBmodemModulation, integraBsystem=integraBsystem, integraBifTransmittedPkts65to127Octets=integraBifTransmittedPkts65to127Octets, integraBModemGroup=integraBModemGroup, integraBifEtherStatsPkts65to127Octets=integraBifEtherStatsPkts65to127Octets, integraBmodemErroredBlock=integraBmodemErroredBlock, integraBradioRxLevelState=integraBradioRxLevelState, integraBifSTPdropEgressPackets=integraBifSTPdropEgressPackets, integraBifCosqStatDroppedPacketsCoSQ4=integraBifCosqStatDroppedPacketsCoSQ4, integraBifL2cacheDropIngressPackets=integraBifL2cacheDropIngressPackets, integraBifEtherStatsPkts1024to1518Octets=integraBifEtherStatsPkts1024to1518Octets, integraBifEtherStatsPkts=integraBifEtherStatsPkts, integraBmodemBackgroundBlockErrorRatio=integraBmodemBackgroundBlockErrorRatio, integraBmodemCarrierOffset=integraBmodemCarrierOffset, integraBifPortStcEntry=integraBifPortStcEntry, integraBifPortRateLimitDropIngressPackets=integraBifPortRateLimitDropIngressPackets, integraBifCosqIfaceDescr=integraBifCosqIfaceDescr, integraBifEtherStatsRXNoErrors=integraBifEtherStatsRXNoErrors, integraBexecuteConfig=integraBexecuteConfig, integraBmodem=integraBmodem, integraBifIllegalSAdropIngressPackets=integraBifIllegalSAdropIngressPackets, integraBifReceivedPkts512to1023Octets=integraBifReceivedPkts512to1023Octets, integraBifCosqStatOutBytesCoSQ1=integraBifCosqStatOutBytesCoSQ1, integraBifPortFlowControl=integraBifPortFlowControl, integraBEthernetGeneralGroup=integraBEthernetGeneralGroup)
