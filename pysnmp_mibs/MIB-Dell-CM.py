...
mibBuilder.exportSymbols("MIB-Dell-CM", inventoryGroup=inventoryGroup, applicationComponentType=applicationComponentType, dell=dell, inventoryLocale=inventoryLocale, applicationDisplayString=applicationDisplayString, applicationDeviceIndex=applicationDeviceIndex, inventorySystemID=inventorySystemID, operatingSystemArchitecture=operatingSystemArchitecture, operatingSystemVendor=operatingSystemVendor, operatingSystemSPMinorVersion=operatingSystemSPMinorVersion, Unsigned16BitRange=Unsigned16BitRange, operatingSystemSPMajorVersion=operatingSystemSPMajorVersion, SystemID=SystemID, applicationEntry=applicationEntry, deviceEntry=deviceEntry, deviceTable=deviceTable, deviceVendorID=deviceVendorID, inventorySchemaVersion=inventorySchemaVersion, cm=cm, productIDBuildNumber=productIDBuildNumber, deviceDeviceID=deviceDeviceID, applicationTable=applicationTable, deviceSubID=deviceSubID, productIDDisplayName=productIDDisplayName, productIDVendor=productIDVendor, deviceSubVendorID=deviceSubVendorID, applicationVersion=applicationVersion, applicationSubComponentID=applicationSubComponentID, operatingSystemGroup=operatingSystemGroup, operatingSystemMinorVersion=operatingSystemMinorVersion, deviceIndex=deviceIndex, productID=productID, applicationIndex=applicationIndex, productIDDescription=productIDDescription, deviceComponentID=deviceComponentID, deviceDisplayString=deviceDisplayString, productIDVersion=productIDVersion, operatingSystemMajorVersion=operatingSystemMajorVersion)
