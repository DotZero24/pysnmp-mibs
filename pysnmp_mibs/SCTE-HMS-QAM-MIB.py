...
# Notes
# -----
# ASN.1 source file://mibs/scte/SCTE-HMS-QAM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:53:42 2025
...
_QamConfigQamChannelIdMin_Type.__name__ = "Integer32"
...
_QamConfigIPAddrType_Type.__name__ = "InetAddressType"
...
qamSupport.setObjects(
      *(("SCTE-HMS-QAM-MIB", "qamChannelGroup"),
        ("SCTE-HMS-QAM-MIB", "qamConfigGroup"))
)
if mibBuilder.loadTexts:
...
docsisSupport.setObjects(
    ("SCTE-HMS-QAM-MIB", "qamMpegDocsisCommonGroup")
)
if mibBuilder.loadTexts:
