...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MGX82XX-PXM-CLOCK-MIB
...
cmpClockCompliance.setObjects(
      *(("CISCO-MGX82XX-PXM-CLOCK-MIB", "cmpClockInfoGroup"),
        ("CISCO-MGX82XX-PXM-CLOCK-MIB", "cmpPrimaryClockInfoGroup"),
        ("CISCO-MGX82XX-PXM-CLOCK-MIB", "cmpSecondaryClockInfoGroup"),
        ("CISCO-MGX82XX-PXM-CLOCK-MIB", "cmpExtClockInfoGroup"))
)
if mibBuilder.loadTexts:
