...
mibBuilder.exportSymbols("CISCO-MGX82XX-PXM-CLOCK-MIB", pxmClockConfig=pxmClockConfig, cmpClockMIBCompliances=cmpClockMIBCompliances, CmpClockSourceType=CmpClockSourceType, PYSNMP_MODULE_ID=ciscoMgx82xxPxmClockMIB, ciscoMgx82xxPxmClockMIB=ciscoMgx82xxPxmClockMIB, cmpPrimaryClockInfoGroup=cmpPrimaryClockInfoGroup, CmpClockExistence=CmpClockExistence, pxmClkStratumLevel=pxmClkStratumLevel, pxmClkErrReason=pxmClkErrReason, pxmExtClkSrcImpedance=pxmExtClkSrcImpedance, pxmSecondaryMuxClockSource=pxmSecondaryMuxClockSource, pxmExtClkConnectorType=pxmExtClkConnectorType, pxmSecondarySMClockSourceSlotNumber=pxmSecondarySMClockSourceSlotNumber, cmpClockMIBConformance=cmpClockMIBConformance, pxmSecondaryInbandClockSourceLineNumber=pxmSecondaryInbandClockSourceLineNumber, cmpClockMIBGroups=cmpClockMIBGroups, cmpClockInfoGroup=cmpClockInfoGroup, CmpClockImpedance=CmpClockImpedance, CmpClockConnectorType=CmpClockConnectorType, pxmExtClk2ConnectorType=pxmExtClk2ConnectorType, pxmPrimaryMuxClockSource=pxmPrimaryMuxClockSource, pxmExtClockPresent=pxmExtClockPresent, pxmExtClk2SrcImpedance=pxmExtClk2SrcImpedance, CmpCurrentClock=CmpCurrentClock, pxmPrimarySMClockSourceSlotNumber=pxmPrimarySMClockSourceSlotNumber, pxmPreviousClock=pxmPreviousClock, pxmCurrentClock=pxmCurrentClock, cmpExtClockInfoGroup=cmpExtClockInfoGroup, cmpSecondaryClockInfoGroup=cmpSecondaryClockInfoGroup, pxmPrimaryInbandClockSourceLineNumber=pxmPrimaryInbandClockSourceLineNumber, pxmExtClock2Present=pxmExtClock2Present, cmpClockCompliance=cmpClockCompliance)
