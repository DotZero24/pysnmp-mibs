#
# PySNMP MIB module ALCATEL-ENT1-TIMETRA-TC-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-TIMETRA-TC-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 11:06:49 2025
# On host macmini.vegmond.io platform Darwin version 25.0.0 by user rob
# Using Python version 3.12.11 (main, Jun  3 2025, 15:41:47) [Clang 17.0.0 (clang-1700.0.13.3)]
#
timetraModules, = mibBuilder.importSymbols("ALCATEL-ENT1-TIMETRA-GLOBAL-MIB", "timetraModules")
...
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-TC-MIB", Dot1PPriority=Dot1PPriority, TIngressQueueId=TIngressQueueId, TDSCPValueOrNone=TDSCPValueOrNone, TmnxMldVersion=TmnxMldVersion, TmnxAppProfileStringOrEmpty=TmnxAppProfileStringOrEmpty, TNamedItemOrEmpty=TNamedItemOrEmpty, TmnxVRtrMplsLspID=TmnxVRtrMplsLspID, TmnxIgmpVersion=TmnxIgmpVersion, TmnxDHCP6MsgType=TmnxDHCP6MsgType, TMlpppQoSProfileId=TMlpppQoSProfileId, TQueueId=TQueueId, TPIRRateOverride=TPIRRateOverride, TmnxSubProfileStringOrEmpty=TmnxSubProfileStringOrEmpty, TmnxVcType=TmnxVcType, IpAddressPrefixLength=IpAddressPrefixLength, TmnxVcId=TmnxVcId, TmnxDhcpOptionType=TmnxDhcpOptionType, TmnxStrSapId=TmnxStrSapId, TPortSchedulerCIR=TPortSchedulerCIR, ServiceAdminStatus=ServiceAdminStatus, TmnxAppProfileString=TmnxAppProfileString, TmnxActionType=TmnxActionType, TCIRRate=TCIRRate, TLspExpValue=TLspExpValue, TmnxOspfInstance=TmnxOspfInstance, TmnxSubIdentStringOrEmpty=TmnxSubIdentStringOrEmpty, TmnxMldGroupFilterMode=TmnxMldGroupFilterMode, TDSCPNameOrEmpty=TDSCPNameOrEmpty, TSapEgressPolicyID=TSapEgressPolicyID, TItemLongDescription=TItemLongDescription, TTcpUdpPort=TTcpUdpPort, TmnxVPNRouteDistinguisher=TmnxVPNRouteDistinguisher, TmnxVRtrIDOrZero=TmnxVRtrIDOrZero, TmnxSubMgtIntDestId=TmnxSubMgtIntDestId, TmnxAncpString=TmnxAncpString, TmnxOperState=TmnxOperState, TmnxTunnelID=TmnxTunnelID, TSecondaryShaper10GPIRRate=TSecondaryShaper10GPIRRate, TmnxPppoeUserNameOrEmpty=TmnxPppoeUserNameOrEmpty, TmnxBgpPreference=TmnxBgpPreference, TIpProtocol=TIpProtocol, TmnxIgmpGroupType=TmnxIgmpGroupType, TTcpUdpPortOperator=TTcpUdpPortOperator, TmnxManagedRouteStatus=TmnxManagedRouteStatus, TmnxCustId=TmnxCustId, TmnxStatus=TmnxStatus, TmnxTunnelType=TmnxTunnelType, TmnxSubIdentString=TmnxSubIdentString, TIpOption=TIpOption, TmnxBgpAutonomousSystem=TmnxBgpAutonomousSystem, TmnxSubProfileString=TmnxSubProfileString, timetraTCMIBModule=timetraTCMIBModule, SdpBindId=SdpBindId, TmnxBgpLocalPreference=TmnxBgpLocalPreference, TFCNameOrEmpty=TFCNameOrEmpty, TItemDescription=TItemDescription, TDSCPValue=TDSCPValue, TFCType=TFCType, TFCName=TFCName, TPolicyID=TPolicyID, ServiceOperStatus=ServiceOperStatus, TmnxSubMgtIntDestIdOrEmpty=TmnxSubMgtIntDestIdOrEmpty, TmnxEnabledDisabled=TmnxEnabledDisabled, TmnxEncapVal=TmnxEncapVal, TPolicyStatementNameOrEmpty=TPolicyStatementNameOrEmpty, PYSNMP_MODULE_ID=timetraTCMIBModule, TCpmProtPolicyID=TCpmProtPolicyID, ServiceAccessPoint=ServiceAccessPoint, TmnxServId=TmnxServId, TmnxBGPFamilyType=TmnxBGPFamilyType, TPIRRate=TPIRRate, TFCSet=TFCSet, TmnxBgpRouteTarget=TmnxBgpRouteTarget, TPortSchedulerPIR=TPortSchedulerPIR, InterfaceIndex=InterfaceIndex, TSapIngressPolicyID=TSapIngressPolicyID, TWeight=TWeight, TDSCPName=TDSCPName, TFrameType=TFrameType, TEgressQueueId=TEgressQueueId, TmnxAncpStringOrZero=TmnxAncpStringOrZero, QTagOrZero=QTagOrZero, TmnxPortID=TmnxPortID, TmnxDhcpVendorOption=TmnxDhcpVendorOption, TmnxVRtrID=TmnxVRtrID, TmnxSlaProfileStringOrEmpty=TmnxSlaProfileStringOrEmpty, TNamedItem=TNamedItem, TmnxMldGroupType=TmnxMldGroupType, TmnxIgmpGroupFilterMode=TmnxIgmpGroupFilterMode, TmnxVcIdOrNone=TmnxVcIdOrNone, TmnxAdminState=TmnxAdminState, QTag=QTag, TDSCPFilterActionValue=TDSCPFilterActionValue, TmnxSlaProfileString=TmnxSlaProfileString, TPIRRateOrZero=TPIRRateOrZero, TmnxMulticastAddrFamily=TmnxMulticastAddrFamily)
