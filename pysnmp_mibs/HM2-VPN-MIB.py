...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-VPN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:53:57 2025
...
_Hm2VpnConnIkeReAuth_Type.__name__ = "TruthValue"
...
hm2VpnConnInfoIpsecNumTunnel = _Hm2VpnConnInfoIpsecNumTunnel_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 15, 1, 20),
    _Hm2VpnConnInfoIpsecNumTunnel_Type()
)
hm2VpnConnInfoIpsecNumTunnel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoIpsecNumTunnel.setStatus("current")
_Hm2VpnConnInfoTunnelTable_Object = MibTable
hm2VpnConnInfoTunnelTable = _Hm2VpnConnInfoTunnelTable_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16)
)
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelTable.setStatus("current")
_Hm2VpnConnInfoTunnelEntry_Object = MibTableRow
hm2VpnConnInfoTunnelEntry = _Hm2VpnConnInfoTunnelEntry_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1)
)
hm2VpnConnInfoTunnelEntry.setIndexNames(
    (0, "HM2-VPN-MIB", "hm2VpnConnIndex"),
    (0, "HM2-VPN-MIB", "hm2VpnConnInfoTunnelIndex"),
)
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelEntry.setStatus("current")


class _Hm2VpnConnInfoTunnelIndex_Type(Integer32):
    """Custom type hm2VpnConnInfoTunnelIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hm2VpnConnInfoTunnelIndex_Type.__name__ = "Integer32"
_Hm2VpnConnInfoTunnelIndex_Object = MibTableColumn
hm2VpnConnInfoTunnelIndex = _Hm2VpnConnInfoTunnelIndex_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 1),
    _Hm2VpnConnInfoTunnelIndex_Type()
)
hm2VpnConnInfoTunnelIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelIndex.setStatus("current")


class _Hm2VpnConnInfoTSelIndex_Type(Integer32):
    """Custom type hm2VpnConnInfoTSelIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hm2VpnConnInfoTSelIndex_Type.__name__ = "Integer32"
_Hm2VpnConnInfoTSelIndex_Object = MibTableColumn
hm2VpnConnInfoTSelIndex = _Hm2VpnConnInfoTSelIndex_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 2),
    _Hm2VpnConnInfoTSelIndex_Type()
)
hm2VpnConnInfoTSelIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTSelIndex.setStatus("current")


class _Hm2VpnConnInfoTunnelStatus_Type(Integer32):
    """Custom type hm2VpnConnInfoTunnelStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_Hm2VpnConnInfoTunnelStatus_Type.__name__ = "Integer32"
_Hm2VpnConnInfoTunnelStatus_Object = MibTableColumn
hm2VpnConnInfoTunnelStatus = _Hm2VpnConnInfoTunnelStatus_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 3),
    _Hm2VpnConnInfoTunnelStatus_Type()
)
hm2VpnConnInfoTunnelStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelStatus.setStatus("current")
_Hm2VpnConnInfoTunnelRekeying_Type = Unsigned32
_Hm2VpnConnInfoTunnelRekeying_Object = MibTableColumn
hm2VpnConnInfoTunnelRekeying = _Hm2VpnConnInfoTunnelRekeying_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 4),
    _Hm2VpnConnInfoTunnelRekeying_Type()
)
hm2VpnConnInfoTunnelRekeying.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelRekeying.setStatus("current")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelRekeying.setUnits("seconds")
_Hm2VpnConnInfoTunnelInBytes_Type = Counter64
_Hm2VpnConnInfoTunnelInBytes_Object = MibTableColumn
hm2VpnConnInfoTunnelInBytes = _Hm2VpnConnInfoTunnelInBytes_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 5),
    _Hm2VpnConnInfoTunnelInBytes_Type()
)
hm2VpnConnInfoTunnelInBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelInBytes.setStatus("current")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelInBytes.setUnits("bytes")
_Hm2VpnConnInfoTunnelInPackets_Type = Counter64
_Hm2VpnConnInfoTunnelInPackets_Object = MibTableColumn
hm2VpnConnInfoTunnelInPackets = _Hm2VpnConnInfoTunnelInPackets_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 6),
    _Hm2VpnConnInfoTunnelInPackets_Type()
)
hm2VpnConnInfoTunnelInPackets.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelInPackets.setStatus("current")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelInPackets.setUnits("packets")
_Hm2VpnConnInfoTunnelInUse_Type = Unsigned32
_Hm2VpnConnInfoTunnelInUse_Object = MibTableColumn
hm2VpnConnInfoTunnelInUse = _Hm2VpnConnInfoTunnelInUse_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 7),
    _Hm2VpnConnInfoTunnelInUse_Type()
)
hm2VpnConnInfoTunnelInUse.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelInUse.setStatus("current")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelInUse.setUnits("seconds")
_Hm2VpnConnInfoTunnelOutBytes_Type = Counter64
_Hm2VpnConnInfoTunnelOutBytes_Object = MibTableColumn
hm2VpnConnInfoTunnelOutBytes = _Hm2VpnConnInfoTunnelOutBytes_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 8),
    _Hm2VpnConnInfoTunnelOutBytes_Type()
)
hm2VpnConnInfoTunnelOutBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelOutBytes.setStatus("current")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelOutBytes.setUnits("bytes")
_Hm2VpnConnInfoTunnelOutPackets_Type = Counter64
_Hm2VpnConnInfoTunnelOutPackets_Object = MibTableColumn
hm2VpnConnInfoTunnelOutPackets = _Hm2VpnConnInfoTunnelOutPackets_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 9),
    _Hm2VpnConnInfoTunnelOutPackets_Type()
)
hm2VpnConnInfoTunnelOutPackets.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelOutPackets.setStatus("current")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelOutPackets.setUnits("packets")
_Hm2VpnConnInfoTunnelOutUse_Type = Unsigned32
_Hm2VpnConnInfoTunnelOutUse_Object = MibTableColumn
hm2VpnConnInfoTunnelOutUse = _Hm2VpnConnInfoTunnelOutUse_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 10),
    _Hm2VpnConnInfoTunnelOutUse_Type()
)
hm2VpnConnInfoTunnelOutUse.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelOutUse.setStatus("current")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelOutUse.setUnits("seconds")


class _Hm2VpnConnInfoTunnelInSPI_Type(DisplayString):
    """Custom type hm2VpnConnInfoTunnelInSPI based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_Hm2VpnConnInfoTunnelInSPI_Type.__name__ = "DisplayString"
_Hm2VpnConnInfoTunnelInSPI_Object = MibTableColumn
hm2VpnConnInfoTunnelInSPI = _Hm2VpnConnInfoTunnelInSPI_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 11),
    _Hm2VpnConnInfoTunnelInSPI_Type()
)
hm2VpnConnInfoTunnelInSPI.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelInSPI.setStatus("current")


class _Hm2VpnConnInfoTunnelOutSPI_Type(DisplayString):
    """Custom type hm2VpnConnInfoTunnelOutSPI based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_Hm2VpnConnInfoTunnelOutSPI_Type.__name__ = "DisplayString"
_Hm2VpnConnInfoTunnelOutSPI_Object = MibTableColumn
hm2VpnConnInfoTunnelOutSPI = _Hm2VpnConnInfoTunnelOutSPI_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 12),
    _Hm2VpnConnInfoTunnelOutSPI_Type()
)
hm2VpnConnInfoTunnelOutSPI.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelOutSPI.setStatus("current")


class _Hm2VpnConnInfoTunnelLocalSel_Type(DisplayString):
    """Custom type hm2VpnConnInfoTunnelLocalSel based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hm2VpnConnInfoTunnelLocalSel_Type.__name__ = "DisplayString"
_Hm2VpnConnInfoTunnelLocalSel_Object = MibTableColumn
hm2VpnConnInfoTunnelLocalSel = _Hm2VpnConnInfoTunnelLocalSel_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 13),
    _Hm2VpnConnInfoTunnelLocalSel_Type()
)
hm2VpnConnInfoTunnelLocalSel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelLocalSel.setStatus("current")


class _Hm2VpnConnInfoTunnelRemoteSel_Type(DisplayString):
    """Custom type hm2VpnConnInfoTunnelRemoteSel based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_Hm2VpnConnInfoTunnelRemoteSel_Type.__name__ = "DisplayString"
_Hm2VpnConnInfoTunnelRemoteSel_Object = MibTableColumn
hm2VpnConnInfoTunnelRemoteSel = _Hm2VpnConnInfoTunnelRemoteSel_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 120, 1, 2, 16, 1, 14),
    _Hm2VpnConnInfoTunnelRemoteSel_Type()
)
hm2VpnConnInfoTunnelRemoteSel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2VpnConnInfoTunnelRemoteSel.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hm2VpnMib": hm2VpnMib,
       ...
       "hm2VpnConnInfoIpsecNumTunnel": hm2VpnConnInfoIpsecNumTunnel,
       "hm2VpnConnInfoTunnelTable": hm2VpnConnInfoTunnelTable,
       "hm2VpnConnInfoTunnelEntry": hm2VpnConnInfoTunnelEntry,
       "hm2VpnConnInfoTunnelIndex": hm2VpnConnInfoTunnelIndex,
       "hm2VpnConnInfoTSelIndex": hm2VpnConnInfoTSelIndex,
       "hm2VpnConnInfoTunnelStatus": hm2VpnConnInfoTunnelStatus,
       "hm2VpnConnInfoTunnelRekeying": hm2VpnConnInfoTunnelRekeying,
       "hm2VpnConnInfoTunnelInBytes": hm2VpnConnInfoTunnelInBytes,
       "hm2VpnConnInfoTunnelInPackets": hm2VpnConnInfoTunnelInPackets,
       "hm2VpnConnInfoTunnelInUse": hm2VpnConnInfoTunnelInUse,
       "hm2VpnConnInfoTunnelOutBytes": hm2VpnConnInfoTunnelOutBytes,
       "hm2VpnConnInfoTunnelOutPackets": hm2VpnConnInfoTunnelOutPackets,
       "hm2VpnConnInfoTunnelOutUse": hm2VpnConnInfoTunnelOutUse,
       "hm2VpnConnInfoTunnelInSPI": hm2VpnConnInfoTunnelInSPI,
       "hm2VpnConnInfoTunnelOutSPI": hm2VpnConnInfoTunnelOutSPI,
       "hm2VpnConnInfoTunnelLocalSel": hm2VpnConnInfoTunnelLocalSel,
       "hm2VpnConnInfoTunnelRemoteSel": hm2VpnConnInfoTunnelRemoteSel,
