...
hm2ConfigurationMibs, HmTimeSeconds1970, HmLargeDisplayString = mibBuilder.importSymbols("HM2-TC-MIB", "hm2ConfigurationMibs", "HmTimeSeconds1970", "HmLargeDisplayString")
...
mibBuilder.exportSymbols("HM2-VPN-MIB", hm2VpnMibObjects=hm2VpnMibObjects, hm2VpnConnIkeAuthRemType=hm2VpnConnIkeAuthRemType, hm2VpnConnInfoIpsecOutUse=hm2VpnConnInfoIpsecOutUse, hm2VpnConnIkeAuthPasswd=hm2VpnConnIkeAuthPasswd, hm2VpnCertificateNoConnections=hm2VpnCertificateNoConnections, hm2VpnConnInfoIkeProposal=hm2VpnConnInfoIkeProposal, hm2VpnConnMax=hm2VpnConnMax, hm2VpnConnInfoTunnelInSPI=hm2VpnConnInfoTunnelInSPI, hm2VpnConnInfoTunnelOutUse=hm2VpnConnInfoTunnelOutUse, hm2VpnConnInfoIpsecOutPackets=hm2VpnConnInfoIpsecOutPackets, hm2VpnConnIkeAuthMode=hm2VpnConnIkeAuthMode, hm2VpnConnInfoTunnelOutSPI=hm2VpnConnInfoTunnelOutSPI, hm2VpnConnIkeRemoteAddr=hm2VpnConnIkeRemoteAddr, hm2VpnConnIkeAuthRemId=hm2VpnConnIkeAuthRemId, hm2VpnConnInfoIKEInitiatorSPI=hm2VpnConnInfoIKEInitiatorSPI, hm2VpnConnInfoTable=hm2VpnConnInfoTable, hm2VpnConnIndex=hm2VpnConnIndex, hm2VpnConnInfoTunnelOutBytes=hm2VpnConnInfoTunnelOutBytes, hm2VpnConnInfoLocalHost=hm2VpnConnInfoLocalHost, hm2VpnMibSNMPExtensionTooManyConns=hm2VpnMibSNMPExtensionTooManyConns, hm2VpnConnInfoIpsecOutSPI=hm2VpnConnInfoIpsecOutSPI, hm2VpnCertificatePrivateKeyStatus=hm2VpnCertificatePrivateKeyStatus, hm2VpnConnIpsecLifetime=hm2VpnConnIpsecLifetime, hm2VpnConnInfoRemoteHost=hm2VpnConnInfoRemoteHost, hm2VpnConnIkeAuthPsk=hm2VpnConnIkeAuthPsk, hm2VpnConnInfoTunnelInBytes=hm2VpnConnInfoTunnelInBytes, hm2VpnCertificateSubject=hm2VpnCertificateSubject, hm2VpnCertificateEndDate=hm2VpnCertificateEndDate, hm2VpnConnIkeAuthCertLocal=hm2VpnConnIkeAuthCertLocal, hm2VpnConnDesc=hm2VpnConnDesc, hm2VpnConnIkeVersion=hm2VpnConnIkeVersion, hm2VpnTrafficSelDstAddr=hm2VpnTrafficSelDstAddr, hm2VpnConnInfoTunnelInPackets=hm2VpnConnInfoTunnelInPackets, hm2VpnConnInfoIKEResponderSPI=hm2VpnConnInfoIKEResponderSPI, hm2VpnConnInfoTSelIndex=hm2VpnConnInfoTSelIndex, hm2VpnConnInfoIpsecInBytes=hm2VpnConnInfoIpsecInBytes, hm2VpnConnInfoIpsecInSPI=hm2VpnConnInfoIpsecInSPI, hm2VpnConnIpsecAlgMac=hm2VpnConnIpsecAlgMac, hm2VpnMibSNMPExtensionGroup=hm2VpnMibSNMPExtensionGroup, hm2VpnCertificateGroup=hm2VpnCertificateGroup, hm2VpnMibSNMPExtensionNoTrafficSelector=hm2VpnMibSNMPExtensionNoTrafficSelector, hm2VpnConnIkeDpdTimeout=hm2VpnConnIkeDpdTimeout, hm2VpnConnInfoIpsecOutBytes=hm2VpnConnInfoIpsecOutBytes, PYSNMP_MODULE_ID=hm2VpnMib, hm2VpnConnectionGroup=hm2VpnConnectionGroup, hm2VpnMib=hm2VpnMib, hm2VpnConnInfoIpsecProposal=hm2VpnConnInfoIpsecProposal, hm2VpnCertificateUserActions=hm2VpnCertificateUserActions, hm2VpnConnIkeLocalAddr=hm2VpnConnIkeLocalAddr, hm2VpnTrafficSelDstRest=hm2VpnTrafficSelDstRest, hm2VpnConnInfoIpsecInUse=hm2VpnConnInfoIpsecInUse, hm2VpnConnInfoEstablished=hm2VpnConnInfoEstablished, hm2VpnConnTable=hm2VpnConnTable, hm2VpnConnInfoTunnelStatus=hm2VpnConnInfoTunnelStatus, hm2VpnTrafficSelSrcRest=hm2VpnTrafficSelSrcRest, hm2VpnCertificateType=hm2VpnCertificateType, hm2VpnTrafficSelDesc=hm2VpnTrafficSelDesc, hm2VpnConnIkeAuthCertCA=hm2VpnConnIkeAuthCertCA, hm2VpnConnIpsecAlgDh=hm2VpnConnIpsecAlgDh, hm2VpnConnInfoIKEReauth=hm2VpnConnInfoIKEReauth, hm2VpnConnInfoEntry=hm2VpnConnInfoEntry, hm2VpnConnIkeAuthCertRemote=hm2VpnConnIkeAuthCertRemote, hm2VpnConnInfoTunnelOutPackets=hm2VpnConnInfoTunnelOutPackets, hm2VpnTrafficSelIndex=hm2VpnTrafficSelIndex, hm2VpnMibSNMPExtensionActiveRow=hm2VpnMibSNMPExtensionActiveRow, hm2VpnConnIkeStartup=hm2VpnConnIkeStartup, hm2VpnGeneralGroup=hm2VpnGeneralGroup, hm2VpnMibSNMPExtensionTooManyActive=hm2VpnMibSNMPExtensionTooManyActive, hm2VpnConnInfoTunnelEntry=hm2VpnConnInfoTunnelEntry, hm2VpnConnIkeAuthLocId=hm2VpnConnIkeAuthLocId, hm2VpnCertificateIssuer=hm2VpnCertificateIssuer, hm2VpnConnIkeAlgEncr=hm2VpnConnIkeAlgEncr, hm2VpnConnInfoTunnelRekeying=hm2VpnConnInfoTunnelRekeying, hm2VpnTrafficSelEntry=hm2VpnTrafficSelEntry, hm2VpnConnInfoIKERekeying=hm2VpnConnInfoIKERekeying, hm2VpnConnEntry=hm2VpnConnEntry, hm2VpnConnInfoTunnelTable=hm2VpnConnInfoTunnelTable, hm2VpnConnInfoIpsecRekeying=hm2VpnConnInfoIpsecRekeying, hm2VpnConnActiveMax=hm2VpnConnActiveMax, hm2VpnCertificateTable=hm2VpnCertificateTable, hm2VpnCertificateFileName=hm2VpnCertificateFileName, hm2VpnConnInfoTunnelInUse=hm2VpnConnInfoTunnelInUse, hm2VpnMibSNMPExtensionInitiatorAny=hm2VpnMibSNMPExtensionInitiatorAny, hm2VpnConnOperStatus=hm2VpnConnOperStatus, hm2VpnConnIpsecAlgEncr=hm2VpnConnIpsecAlgEncr, hm2VpnConnInfoIpsecInPackets=hm2VpnConnInfoIpsecInPackets, hm2VpnUpTrap=hm2VpnUpTrap, hm2VpnConnNext=hm2VpnConnNext, hm2VpnConnIkeReAuth=hm2VpnConnIkeReAuth, hm2VpnCertificateUploadPassphrase=hm2VpnCertificateUploadPassphrase, hm2VpnConnInfoIkeVersionUsed=hm2VpnConnInfoIkeVersionUsed, hm2VpnConnIkeAuthLocType=hm2VpnConnIkeAuthLocType, hm2VpnDownTrap=hm2VpnDownTrap, hm2VpnCertificateStartDate=hm2VpnCertificateStartDate, hm2VpnCertificateCertUploadDate=hm2VpnCertificateCertUploadDate, hm2VpnCertificateIndex=hm2VpnCertificateIndex, hm2VpnConnIpsecMode=hm2VpnConnIpsecMode, hm2VpnTrafficSelSrcAddr=hm2VpnTrafficSelSrcAddr, hm2VpnConnDebug=hm2VpnConnDebug, hm2VpnConnLastError=hm2VpnConnLastError, hm2VpnConnIkeAuthType=hm2VpnConnIkeAuthType, hm2VpnCertificateEntry=hm2VpnCertificateEntry, hm2VpnMibNotifications=hm2VpnMibNotifications, hm2VpnConnIkeAlgMac=hm2VpnConnIkeAlgMac, hm2VpnConnIkeAuthPrivKey=hm2VpnConnIkeAuthPrivKey, hm2VpnConnInfoTunnelRemoteSel=hm2VpnConnInfoTunnelRemoteSel, hm2VpnTrafficSelGroup=hm2VpnTrafficSelGroup, hm2VpnCertificatePrivateKeyFile=hm2VpnCertificatePrivateKeyFile, hm2VpnConnInfoTunnelLocalSel=hm2VpnConnInfoTunnelLocalSel, hm2VpnConnInfoTunnelIndex=hm2VpnConnInfoTunnelIndex, hm2VpnTrafficSelTable=hm2VpnTrafficSelTable, hm2VpnConnRowStatus=hm2VpnConnRowStatus, hm2VpnTrafficSelRowStatus=hm2VpnTrafficSelRowStatus, hm2VpnConnMargintime=hm2VpnConnMargintime, hm2VpnConnIkeAlgDh=hm2VpnConnIkeAlgDh, hm2VpnConnInfoIpsecNumTunnel=hm2VpnConnInfoIpsecNumTunnel, hm2VpnConnIkeLifetime=hm2VpnConnIkeLifetime)
