...
mibBuilder.exportSymbols("P8631-MIB", ch3Unit=ch3Unit, ch3Name=ch3Name, trapSOAPErrFile=trapSOAPErrFile, DisplayString=DisplayString, ch3LimHyst=ch3LimHyst, ch2Unit=ch2Unit, ch2LimDelay=ch2LimDelay, trapCh2LowAlarm=trapCh2LowAlarm, ch2value=ch2value, ch3Max=ch3Max, trapEmailErrSome=trapEmailErrSome, ch2AlarmStr=ch2AlarmStr, trapSOAPErrDNS=trapSOAPErrDNS, ch2IntVal=ch2IntVal, p8631=p8631, ch1Name=ch1Name, historyTable=historyTable, ch2LimHyst=ch2LimHyst, ch1Alarm=ch1Alarm, ch1AlarmStr=ch1AlarmStr, ch3IntVal=ch3IntVal, trapEmailErrLogin=trapEmailErrLogin, ch2LimHi=ch2LimHi, trapCh1LowAlarm=trapCh1LowAlarm, ch3Min=ch3Min, ch3LimDelay=ch3LimDelay, trapEmailErrSocket=trapEmailErrSocket, ch2Min=ch2Min, ch1IntVal=ch1IntVal, ch1Min=ch1Min, comet=comet, ch3AlarmStr=ch3AlarmStr, ch1Val=ch1Val, ch2LimLo=ch2LimLo, trapSOAPErrSocket=trapSOAPErrSocket, channel2=channel2, historyEntry=historyEntry, products=products, ch3LimLo=ch3LimLo, channels=channels, ch1LimHi=ch1LimHi, ch1Max=ch1Max, trapCh1Error=trapCh1Error, ch3Val=ch3Val, trapEmailErrAuth=trapEmailErrAuth, trapCh2HighAlarm=trapCh2HighAlarm, messageString=messageString, trapCh2Error=trapCh2Error, serialNumber=serialNumber, ch3value=ch3value, channel3=channel3, deviceType=deviceType, ch1LimDelay=ch1LimDelay, trapCh1ClrAlarm=trapCh1ClrAlarm, tables=tables, trapEmailErrDNS=trapEmailErrDNS, trapCh3Error=trapCh3Error, channel1=channel1, ch2Alarm=ch2Alarm, trapCh3LowAlarm=trapCh3LowAlarm, ch1value=ch1value, trapCh3HighAlarm=trapCh3HighAlarm, trapNTPError=trapNTPError, ch3LimHi=ch3LimHi, traps=traps, ch3Alarm=ch3Alarm, ch2Val=ch2Val, sensorName=sensorName, ch1Unit=ch1Unit, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, trapCh3ClrAlarm=trapCh3ClrAlarm, trapCh1HighAlarm=trapCh1HighAlarm, ch2Name=ch2Name, trapTest=trapTest, ch1LimLo=ch1LimLo, ch2Max=ch2Max, trapCh2ClrAlarm=trapCh2ClrAlarm, ch1LimHyst=ch1LimHyst)
