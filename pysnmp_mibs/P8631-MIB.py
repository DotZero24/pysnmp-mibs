# SNMP MIB module (P8631-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/P8631-MIB
...
trapTest.setObjects(
      *(("P8631-MIB", "sensorName"),
        ("P8631-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
