...
_P8631_ObjectIdentity=ObjectIdentity
p8631=_P8631_ObjectIdentity((1,3,6,1,4,1,22626,1,5))
...
historyEntry.setIndexNames((0,_A,_R))
...
trapCh3HighAlarm.setObjects(*((_A,_N),(_A,_O),(_A,_P),(_A,_D),(_A,_E)))
...
trapCh3LowAlarm.setObjects(*((_A,_N),(_A,_O),(_A,_P),(_A,_D),(_A,_E)))
...
trapCh3ClrAlarm.setObjects(*((_A,_N),(_A,_O),(_A,_P),(_A,_D),(_A,_E)))
...
trapCh3Error.setObjects(*((_A,_N),(_A,_O),(_A,_P),(_A,_D),(_A,_E)))
if mibBuilder.loadTexts:trapCh3Error.setStatus('')
mibBuilder.exportSymbols(_A,**{_G:DisplayString,'comet':comet,'trapTest':trapTest,'trapNTPError':trapNTPError,'trapEmailErrLogin':trapEmailErrLogin,'trapEmailErrAuth':trapEmailErrAuth,'trapEmailErrSome':trapEmailErrSome,'trapEmailErrSocket':trapEmailErrSocket,'trapEmailErrDNS':trapEmailErrDNS,'trapSOAPErrFile':trapSOAPErrFile,'trapSOAPErrDNS':trapSOAPErrDNS,'trapSOAPErrSocket':trapSOAPErrSocket,'trapSOAPErrDelivery':trapSOAPErrDelivery,'trapCh1HighAlarm':trapCh1HighAlarm,'trapCh2HighAlarm':trapCh2HighAlarm,'trapCh3HighAlarm':trapCh3HighAlarm,'trapCh1LowAlarm':trapCh1LowAlarm,'trapCh2LowAlarm':trapCh2LowAlarm,'trapCh3LowAlarm':trapCh3LowAlarm,'trapCh1ClrAlarm':trapCh1ClrAlarm,'trapCh2ClrAlarm':trapCh2ClrAlarm,'trapCh3ClrAlarm':trapCh3ClrAlarm,'trapCh1Error':trapCh1Error,'trapCh2Error':trapCh2Error,'trapCh3Error':trapCh3Error,'products':products,'p8631':p8631,'global':_pysmi_global,_D:sensorName,'serialNumber':serialNumber,'deviceType':deviceType,'channels':channels,'channel1':channel1,_H:ch1Name,_I:ch1Val,'ch1IntVal':ch1IntVal,_J:ch1Alarm,'ch1LimHi':ch1LimHi,'ch1LimLo':ch1LimLo,'ch1LimHyst':ch1LimHyst,'ch1LimDelay':ch1LimDelay,'ch1Unit':ch1Unit,'ch1AlarmStr':ch1AlarmStr,'ch1Min':ch1Min,'ch1Max':ch1Max,'channel2':channel2,_K:ch2Name,_L:ch2Val,'ch2IntVal':ch2IntVal,_M:ch2Alarm,'ch2LimHi':ch2LimHi,'ch2LimLo':ch2LimLo,'ch2LimHyst':ch2LimHyst,'ch2LimDelay':ch2LimDelay,'ch2Unit':ch2Unit,'ch2AlarmStr':ch2AlarmStr,'ch2Min':ch2Min,'ch2Max':ch2Max,'channel3':channel3,_N:ch3Name,_O:ch3Val,'ch3IntVal':ch3IntVal,_P:ch3Alarm,'ch3LimHi':ch3LimHi,'ch3LimLo':ch3LimLo,'ch3LimHyst':ch3LimHyst,'ch3LimDelay':ch3LimDelay,'ch3Unit':ch3Unit,'ch3AlarmStr':ch3AlarmStr,'ch3Min':ch3Min,'ch3Max':ch3Max,'traps':traps,_E:messageString,'tables':tables,'historyTable':historyTable,'historyEntry':historyEntry,_R:ch1value,'ch2value':ch2value,'ch3value':ch3value})