...
mibBuilder.exportSymbols("QTECH-TC", MemberMap=MemberMap, ConfigStatus=ConfigStatus, PYSNMP_MODULE_ID=qtechTextualConventions, qtechTextualConventions=qtechTextualConventions, QtechTrapType=QtechTrapType, IfIndex=IfIndex)
