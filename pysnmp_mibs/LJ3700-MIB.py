...
_w='eFoolscap'
_v='eInitializing'
_u='eUnknownMediaSize'
_t='eIOCard'
_s='eDiskDrive'
_r='eAuto'
_q='eOther'
_p='ePercentLifeRemaining'
_o='eImpressions'
_n='ePages'
_m='eRotations'
_l='eGrams'
...
class _Sleep_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_a,1),(_S,2)))
...
class _Show_address_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_O,1),(_r,3)))
...
class _Mio1_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_s,8),(_t,12)))
...
class _Mio2_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_s,8),(_t,12)))
...
class _Mio3_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_H,1),(_I,2),(_s,8),(_t,12)))
...
class _Job_info_accounting_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),('eLedger',11),(_b,17),(_V,18),('eROC8K',19),(_W,25),(_R,26),(_A0,27),(_X,45),('eJISB4',46),(_Y,65),('eJapansePostcardDouble',72),(_c,80),(_d,81),(_e,90),(_f,91),(_g,100),(_h,101),(_A1,258),(_A2,282),(_u,32767)))
...
class _Ram_disk_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_O,1),(_r,3)))
...
class _Firmware_download_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_a,1),(_S,2)))
...
if mibBuilder.loadTexts:firmware_download_name.setStatus(_Z)
...
if mibBuilder.loadTexts:firmware_download_version.setStatus(_Z)
...
class _Upgradable_devices_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_a,1),(_S,2)))
...
class _Upgradable_devices_current_state_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*(('eIdle',1),('eReceivedImage',2),(_A3,3),('eVerifiedImage',4),(_A4,5),(_A5,6),(_A6,7),('eUpgradeComplete',8)))
...
if mibBuilder.loadTexts:upgradable_devices_name.setStatus(_Z)
...
if mibBuilder.loadTexts:upgradable_devices_version.setStatus(_Z)
...
if mibBuilder.loadTexts:remote_upgrade_enable.setStatus(_Z)
...
class _Reprint_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_O,1),(_P,2),(_r,3)))
...
class _Form_feed_needed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_a,1),(_S,2)))
...
class _Override_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32764,32765,32767)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_b,17),(_V,18),('eROC8K',19),(_W,25),(_R,26),(_A0,27),(_X,45),('eJISB4',46),(_Y,65),(_x,72),(_c,80),(_d,81),(_e,90),(_f,91),(_g,100),(_h,101),(_A1,258),(_A2,282),(_A7,32764),(_i,32765),(_u,32767)))
...
class _Tray1_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,17,18,25,26,45,65,72,80,81,90,91,100,101,32764,32765)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_w,10),(_b,17),(_V,18),(_W,25),(_R,26),(_X,45),(_Y,65),(_x,72),(_c,80),(_d,81),(_e,90),(_f,91),(_g,100),(_h,101),(_A7,32764),(_i,32765)))
...
class _Tray2_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,18,25,26,45,65,32765)));namedValues=NamedValues(*((_T,1),(_Q,2),(_U,3),(_w,10),(_V,18),(_W,25),(_R,26),(_X,45),(_Y,65),(_i,32765)))
...
class _Consumable_status_usage_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_j,1),(_k,2),(_l,3),(_m,4),(_n,5),(_o,6),(_p,7),(_q,8)))
...
class _Consumable_status_engine_usage_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_j,1),(_k,2),(_l,3),(_m,4),(_n,5),(_o,6),(_p,7),(_q,8)))
...
class _Consumable_status_developer_life_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_j,1),(_k,2),(_l,3),(_m,4),(_n,5),(_o,6),(_p,7),(_q,8)))
...
class _Consumable_status_drum_life_units_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*((_j,1),(_k,2),(_l,3),(_m,4),(_n,5),(_o,6),(_p,7),(_q,8)))
