# SNMP MIB module (LANCOM-IPV6-LOOPBACK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-IPV6-LOOPBACK-MIB
...
agentLoopbackIpv6PrefixEntry = _AgentLoopbackIpv6PrefixEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 23, 1, 1, 1)
)
agentLoopbackIpv6PrefixEntry.setIndexNames(
    (0, "LANCOM-LOOPBACK-MIB", "agentLoopbackID"),
    (0, "LANCOM-IPV6-LOOPBACK-MIB", "agentLoopbackIpv6PrefixPrefix"),
    (0, "LANCOM-IPV6-LOOPBACK-MIB", "agentLoopbackIpv6PrefixPrefixLen"),
)
if mibBuilder.loadTexts:
...
agentLoopbackIpv6PrefixPrefix = _AgentLoopbackIpv6PrefixPrefix_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 23, 1, 1, 1, 1),
...
agentLoopbackIpv6PrefixPrefixLen = _AgentLoopbackIpv6PrefixPrefixLen_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 23, 1, 1, 1, 2),
...
agentLoopbackIpv6PrefixStatus = _AgentLoopbackIpv6PrefixStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 23, 1, 1, 1, 3),
