...
SwTrunkMaster, SwDomainIndex, FcWwn, SwNbIndex, SwSensorIndex, SwPortIndex = mibBuilder.importSymbols("Brocade-TC", "SwTrunkMaster", "SwDomainIndex", "FcWwn", "SwNbIndex", "SwSensorIndex", "SwPortIndex")
...
mibBuilder.exportSymbols("SW-MIB", swFCPortRxTooLongs=swFCPortRxTooLongs, swFlashDLAdmStatus=swFlashDLAdmStatus, swBlmPerfEEDid=swBlmPerfEEDid, swAgtCfg=swAgtCfg, swFwClassAreaTable=swFwClassAreaTable, swModel=swModel, swDeviceStatusTrap=swDeviceStatusTrap, swFwCustTimebase=swFwCustTimebase, swGroup=swGroup, swNsNodeSymb=swNsNodeSymb, swFCPortSpecifier=swFCPortSpecifier, swFCPortRxLCs=swFCPortRxLCs, swGroupId=swGroupId, swTopTalkerMntDpid=swTopTalkerMntDpid, swTopTalker=swTopTalker, swTrapsV2=swTrapsV2, swConnUnitFTB1Miss=swConnUnitFTB1Miss, swFlashDLHost=swFlashDLHost, swSensorIndex=swSensorIndex, swBlmPerfEEFCWTx=swBlmPerfEEFCWTx, swFCPortAdmStatus=swFCPortAdmStatus, swTrunkGrpEntry=swTrunkGrpEntry, swAgtCmtyStr=swAgtCmtyStr, swFCport=swFCport, swConnUnitZoneMiss=swConnUnitZoneMiss, swFabricWatchTrap=swFabricWatchTrap, swTopTalkerMntTable=swTopTalkerMntTable, swBlmPerfFltMntTable=swBlmPerfFltMntTable, swCurrentDate=swCurrentDate, swFCPortWwn=swFCPortWwn, swFabricReconfigTrap=swFabricReconfigTrap, swGroupType=swGroupType, swMemUsageLimit3=swMemUsageLimit3, swTrunk=swTrunk, swConnUnitRDYPriority=swConnUnitRDYPriority, swPortTrunked=swPortTrunked, swConnUnitTransferConnection=swConnUnitTransferConnection, swFwThLevel=swFwThLevel, swFCPortTable=swFCPortTable, swConnUnitCRCWithBadEOF=swConnUnitCRCWithBadEOF, swTrunkGrpRx=swTrunkGrpRx, swFwSystem=swFwSystem, swTrunkPortIndex=swTrunkPortIndex, swFwLastSeverityLevel=swFwLastSeverityLevel, swFCPortRxCrcs=swFCPortRxCrcs, swFwThresholdEntry=swFwThresholdEntry, swPortMoveTrap=swPortMoveTrap, swFabricMemGWIP=swFabricMemGWIP, swFCPortCapacity=swFCPortCapacity, swMibModule=swMibModule, swBlmPerfFltPort=swBlmPerfFltPort, swEndDeviceLinkFailure=swEndDeviceLinkFailure, swConnUnitFTB2Miss=swConnUnitFTB2Miss, swConnUnitZeroTenancy=swConnUnitZeroTenancy, swIPv6Address=swIPv6Address, swFCPortLinkState=swFCPortLinkState, swFlashDLPassword=swFlashDLPassword, swprivProtocolPassword=swprivProtocolPassword, swEndDeviceRlsEntry=swEndDeviceRlsEntry, swNsLocalEntry=swNsLocalEntry, swFwDefaultExceededActs=swFwDefaultExceededActs, swTopTalkerMntSwwn=swTopTalkerMntSwwn, swFabricMemType=swFabricMemType, swFwDefaultLow=swFwDefaultLow, swConnUnitPCSErrorCounter=swConnUnitPCSErrorCounter, swFWLastUpdated=swFWLastUpdated, SwFwActs=SwFwActs, sw=sw, swFwLastEvent=swFwLastEvent, swAgtCmtyEntry=swAgtCmtyEntry, swFwWriteActVals=swFwWriteActVals, swBeaconAdmStatus=swBeaconAdmStatus, swFwCustAboveActs=swFwCustAboveActs, swNbIslState=swNbIslState, swFwCurVal=swFwCurVal, swConnUnitLCRX=swConnUnitLCRX, swFabricMemEIP=swFabricMemEIP, swTrunkGroupNumber=swTrunkGroupNumber, swTrunkMaster=swTrunkMaster, swEndDeviceSyncLoss=swEndDeviceSyncLoss, swSensorTable=swSensorTable, swBlmPerfAlpa=swBlmPerfAlpa, swConnUnitUnknownInterrupts=swConnUnitUnknownInterrupts, swNsPortType=swNsPortType, swBlmPerfFltMntEntry=swBlmPerfFltMntEntry, swCpuAction=swCpuAction, swConnUnitFECUnCorrectedCounter=swConnUnitFECUnCorrectedCounter, swFwFabricWatchLicense=swFwFabricWatchLicense, swEndDevice=swEndDevice, swNbRemPort=swNbRemPort, swTopTalkerMntDwwn=swTopTalkerMntDwwn, SwFwTimebase=SwFwTimebase, swEventVfId=swEventVfId, swFwStatus=swFwStatus, swConnUnitTimedOut=swConnUnitTimedOut, swTrunkGrpMaster=swTrunkGrpMaster, swExtTrap=swExtTrap, swConnUnitFTB6Miss=swConnUnitFTB6Miss, swFlashDLOperStatus=swFlashDLOperStatus, swConnUnitC3DiscardOther=swConnUnitC3DiscardOther, swFwLastEventVal=swFwLastEventVal, swFwDefaultUnit=swFwDefaultUnit, swEtherIPAddress=swEtherIPAddress, swConnUnitUnroutableFrameCounter=swConnUnitUnroutableFrameCounter, swNbTable=swNbTable, swNbBaudRate=swNbBaudRate, swTopTalkerMntMode=swTopTalkerMntMode, swBlmPerfFltAlias=swBlmPerfFltAlias, swGroupMemEntry=swGroupMemEntry, swAgtTrapRcp=swAgtTrapRcp, swNsWwn=swNsWwn, swFwDefaultChangedActs=swFwDefaultChangedActs, swFwLabel=swFwLabel, swFCPortName=swFCPortName, swFwDefaultAboveActs=swFwDefaultAboveActs, swPmgrEventType=swPmgrEventType, swTrunkGrpTx=swTrunkGrpTx, swFlashLastUpdated=swFlashLastUpdated, swConnUnitC3DiscardDueToDestUnreachable=swConnUnitC3DiscardDueToDestUnreachable, swGroupTable=swGroupTable, SwFwBehavior=SwFwBehavior, swNbEntry=swNbEntry, swFwBehaviorInt=swFwBehaviorInt, swZoneConfigChangeTrap=swZoneConfigChangeTrap, swEndDeviceAlpa=swEndDeviceAlpa, SwFwState=SwFwState, swNsEntryIndex=swNsEntryIndex, swPmgrEventDescr=swPmgrEventDescr, swPrincipalSwitch=swPrincipalSwitch, swAgtCmtyIdx=swAgtCmtyIdx, swSensorType=swSensorType, swNsNodeName=swNsNodeName, swFCPortRxEncOutFrs=swFCPortRxEncOutFrs, swBrcdTrapBitMask=swBrcdTrapBitMask, swDomainID=swDomainID, swFabricMemShortVersion=swFabricMemShortVersion, PYSNMP_MODULE_ID=swMibModule, swBlmPerfEECRC=swBlmPerfEECRC, swAgtCmtyTable=swAgtCmtyTable, swPmgrEventTrap=swPmgrEventTrap, swAgtTrapSeverityLevel=swAgtTrapSeverityLevel, swEventTrap=swEventTrap, swFwLastState=swFwLastState, swFabricMemName=swFabricMemName, swEventRepeatCount=swEventRepeatCount, swTrunkTable=swTrunkTable, swIODState=swIODState, swGroupMemWwn=swGroupMemWwn, swID=swID, swCpuUsageLimit=swCpuUsageLimit, swConnUnitLunZoneMiss=swConnUnitLunZoneMiss, swModule=swModule, swBlmPerfALPAMntTable=swBlmPerfALPAMntTable, swNsLocalNumEntry=swNsLocalNumEntry, swGroupName=swGroupName, swFCPortLipIns=swFCPortLipIns, swGroupMemPos=swGroupMemPos, swFCPortRxEncInFrs=swFCPortRxEncInFrs, swFwValidActs=swFwValidActs, swNsIPA=swNsIPA, swFwName=swFwName, swEndDevicePort=swEndDevicePort, swPmgrEventTime=swPmgrEventTime, swTrunkEntry=swTrunkEntry, swFCIPMask=swFCIPMask, swauthProtocolPassword=swauthProtocolPassword, swFwClassAreaIndex=swFwClassAreaIndex, swTopTalkerMntPort=swTopTalkerMntPort, swCpuPollingInterval=swCpuPollingInterval, swAdmStatus=swAdmStatus, swEventIndex=swEventIndex, swFwThresholdIndex=swFwThresholdIndex, swFwCustChangedActs=swFwCustChangedActs, swConnUnitInterrupts=swConnUnitInterrupts, swTelnetShellAdmStatus=swTelnetShellAdmStatus, swConnUnitProcRequired=swConnUnitProcRequired, swSwitchTrunkable=swSwitchTrunkable, swFCPortTxMcasts=swFCPortTxMcasts, swBlmPerfEEPort=swBlmPerfEEPort, swConnUnitLli=swConnUnitLli, swMemPollingInterval=swMemPollingInterval, swFCPortRxC2Frames=swFCPortRxC2Frames, swNsIpNxPort=swNsIpNxPort, swEndDevicePortID=swEndDevicePortID, swFCPortScn=swFCPortScn, swFirmwareVersion=swFirmwareVersion, swFabricMemTable=swFabricMemTable, SwFwStatus=SwFwStatus, swFwCustUnit=swFwCustUnit, swFCPortLipOuts=swFCPortLipOuts, swConnUnitFLNumOfTenancy=swConnUnitFLNumOfTenancy, swFCPortNoTxCredits=swFCPortNoTxCredits, swSensorScn=swSensorScn, swEventDescr=swEventDescr, swEventTable=swEventTable, swMemUsageLimit1=swMemUsageLimit1, swCpuNoOfRetries=swCpuNoOfRetries, swFabricMemDid=swFabricMemDid, swNsPortID=swNsPortID, swFCPortTxWords=swFCPortTxWords, swDeviceStatus=swDeviceStatus, swFabricMemFCIP=swFabricMemFCIP, swFwCustLow=swFwCustLow, swMemUsageLimit=swMemUsageLimit, swEndDeviceSigLoss=swEndDeviceSigLoss, swFCPortC3Discards=swFCPortC3Discards, swMemNoOfRetries=swMemNoOfRetries, sw20x0=sw20x0, swSsn=swSsn, swFCPortTxType=swFCPortTxType, swFault=swFault, swFwDefaultTimebase=swFwDefaultTimebase, swNbMyPort=swNbMyPort, SwFwLicense=SwFwLicense, swConnUnitOpend=swConnUnitOpend, swConnUnitStateChange=swConnUnitStateChange, swNsPortSymb=swNsPortSymb, swVfName=swVfName, swFCPortRxWords=swFCPortRxWords, swDiagResult=swDiagResult, swIPv6ChangeTrap=swIPv6ChangeTrap, swConnUnitPortStatEntry=swConnUnitPortStatEntry, swSensorStatus=swSensorStatus, swNsIpAddress=swNsIpAddress, swFwCustBufSize=swFwCustBufSize, swConnUnitPortStatExtentionTable=swConnUnitPortStatExtentionTable, swFCPortType=swFCPortType, swFCPortOpStatus=swFCPortOpStatus, swFabricMemEntry=swFabricMemEntry, swTrackChangesInfo=swTrackChangesInfo, swFabricMemWwn=swFabricMemWwn, swFwDefaultBelowActs=swFwDefaultBelowActs, swEventNumEntries=swEventNumEntries, swTopTalkerMntNumEntries=swTopTalkerMntNumEntries, swFCPortTxFrames=swFCPortTxFrames, swConnUnitBadEOF=swConnUnitBadEOF, swConnUnitC3DiscardDueToTXTimeout=swConnUnitC3DiscardDueToTXTimeout, swFabric=swFabric, swFCPortLipLastAlpa=swFCPortLipLastAlpa, swSensorEntry=swSensorEntry, swConnUnitStopTenancyStarVation=swConnUnitStopTenancyStarVation, swBrcdGenericTrap=swBrcdGenericTrap, swNsCos=swNsCos, swFCPortRxMcasts=swFCPortRxMcasts, swConnUnitInvalidARB=swConnUnitInvalidARB, swPortList=swPortList, sw28k=sw28k, swEventEntry=swEventEntry, swTrackChangesTrap=swTrackChangesTrap, swNbIslCost=swNbIslCost, swEndDeviceProtoErr=swEndDeviceProtoErr, swBlmPerfEESid=swBlmPerfEESid, swBlmPerfEEMntEntry=swBlmPerfEEMntEntry, swEvent=swEvent)
mibBuilder.exportSymbols("SW-MIB", swNbIndex=swNbIndex, SwFwLevels=SwFwLevels, swFwThresholdTable=swFwThresholdTable, swFlashDLUser=swFlashDLUser, swTrunkGrpTable=swTrunkGrpTable, swFwLastEventTime=swFwLastEventTime, swMemUsage=swMemUsage, sw21kN24k=sw21kN24k, SwFwEvent=SwFwEvent, swEndDeviceInvalidWord=swEndDeviceInvalidWord, swFwCustExceededActs=swFwCustExceededActs, swTestString=swTestString, swConnUnitFECCorrectedCounter=swConnUnitFECCorrectedCounter, swFCPortFlag=swFCPortFlag, swFwDefaultBufSize=swFwDefaultBufSize, swFwDefaultInBetweenActs=swFwDefaultInBetweenActs, swFCPortBrcdType=swFCPortBrcdType, swSensorInfo=swSensorInfo, SwFwWriteVals=SwFwWriteVals, swFwDefaultHigh=swFwDefaultHigh, swFwBehaviorType=swFwBehaviorType, swNsHardAddr=swNsHardAddr, swFCPortRxFrames=swFCPortRxFrames, SwFwClassesAreas=SwFwClassesAreas, swEtherIPMask=swEtherIPMask, swStateChangeTrap=swStateChangeTrap, swCpuOrMemoryUsage=swCpuOrMemoryUsage, swTopTalkerMntflow=swTopTalkerMntflow, swFCPortPhyState=swFCPortPhyState, swEventLevel=swEventLevel, swBlmPerfMnt=swBlmPerfMnt, swBlmPerfEEMntTable=swBlmPerfEEMntTable, swVfId=swVfId, swIDIDMode=swIDIDMode, swFwCustInBetweenActs=swFwCustInBetweenActs, swNumSensors=swNumSensors, swEndDeviceInvalidCRC=swEndDeviceInvalidCRC, swFCPortDisableReason=swFCPortDisableReason, swEventTimeInfo=swEventTimeInfo, swSystem=swSystem, swFCPortRxC3Frames=swFCPortRxC3Frames, swTopTalkerMntIndex=swTopTalkerMntIndex, swBlmPerfAlpaPort=swBlmPerfAlpaPort, swFCPortTooManyRdys=swFCPortTooManyRdys, swSensorValue=swSensorValue, swBlmPerfFltCnt=swBlmPerfFltCnt, swBeaconOperStatus=swBeaconOperStatus, swFCPortRxBadEofs=swFCPortRxBadEofs, swGroupEntry=swGroupEntry, swNsFc4=swNsFc4, swFlashDLFile=swFlashDLFile, swBlmPerfAlpaCRCCnt=swBlmPerfAlpaCRCCnt, swFwCustBelowActs=swFwCustBelowActs, swFCPortRxBadOs=swFCPortRxBadOs, swBlmPerfEERefKey=swBlmPerfEERefKey, swTrunkGrpNumber=swTrunkGrpNumber, swFCPortRxTruncs=swFCPortRxTruncs, swFwActLevel=swFwActLevel, swBlmPerfAlpaIndx=swBlmPerfAlpaIndx, swFCPortIndex=swFCPortIndex, swFwCustHigh=swFwCustHigh, swConnUnitOpen=swConnUnitOpen, swNbRemPortName=swNbRemPortName, swNumNbs=swNumNbs, swCpuUsage=swCpuUsage, swGroupIndex=swGroupIndex, swBootPromLastUpdated=swBootPromLastUpdated, swOperStatus=swOperStatus, swNsPortName=swNsPortName, swIPv6Status=swIPv6Status, swConnUnitC3DiscardDueToRXTimeout=swConnUnitC3DiscardDueToRXTimeout, swBrcdBitObjVal=swBrcdBitObjVal, swTopTalkerMntSpid=swTopTalkerMntSpid, swConnUnitTxBufferUnavailable=swConnUnitTxBufferUnavailable, swFCPortEntry=swFCPortEntry, swFabricSegmentTrap=swFabricSegmentTrap, swNs=swNs, swBlmPerfALPAMntEntry=swBlmPerfALPAMntEntry, swFwClassAreaEntry=swFwClassAreaEntry, swBlmPerfFltRefkey=swBlmPerfFltRefkey, swGroupMemTable=swGroupMemTable, swFCPortPrevType=swFCPortPrevType, FcPortFlag=FcPortFlag, swEndDeviceRlsTable=swEndDeviceRlsTable, swTopTalkerMntEntry=swTopTalkerMntEntry, swEventTrapLevel=swEventTrapLevel, swConnUnitNLNumOfTenancy=swConnUnitNLNumOfTenancy, swBootDate=swBootDate, swFCPortMcastTimedOuts=swFCPortMcastTimedOuts, swFCPortSpeed=swFCPortSpeed, swNsLocalTable=swNsLocalTable, swMemAction=swMemAction, SwSevType=SwSevType, swNbRemDomain=swNbRemDomain, swBlmPerfEEFCWRx=swBlmPerfEEFCWRx, swFCIPAddress=swFCIPAddress, swFwWriteThVals=swFwWriteThVals)
