...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/brocade/SW-MIB
...
SwNbIndex, SwDomainIndex, SwTrunkMaster, SwSensorIndex, FcWwn, SwPortIndex = mibBuilder.importSymbols("Brocade-TC", "SwNbIndex", "SwDomainIndex", "SwTrunkMaster", "SwSensorIndex", "FcWwn", "SwPortIndex")
connUnitPortStatEntry, connUnitPortEntry = mibBuilder.importSymbols("FCMGMT-MIB", "connUnitPortStatEntry", "connUnitPortEntry")
...
if mibBuilder.loadTexts: swFwSystem.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfMnt.setStatus('obsolete')
...
if mibBuilder.loadTexts: swTopTalker.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFWLastUpdated.setStatus('obsolete')
...
if mibBuilder.loadTexts: swTelnetShellAdmStatus.setStatus('deprecated')
...
if mibBuilder.loadTexts: swTrackChangesInfo.setStatus('obsolete')
...
swFCPortPrevType = MibScalar((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 1, 35), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))).clone(namedValues=NamedValues(("unknown", 1), ("other", 2), ("fl-port", 3), ("f-port", 4), ("e-port", 5), ("g-port", 6), ("ex-port", 7), ("d-port", 8))))
...
swBrcdBitObjVal = MibScalar((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 1, 37), Integer32())
if mibBuilder.loadTexts: swBrcdBitObjVal.setStatus('current')
swIODState = MibScalar((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 1, 38), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2), ("unknown", 3)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swIODState.setStatus('current')
...
swFCPortBrcdType = MibTableColumn((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 6, 2, 1, 39), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8))).clone(namedValues=NamedValues(("unknown", 1), ("other", 2), ("fl-port", 3), ("f-port", 4), ("e-port", 5), ("g-port", 6), ("ex-port", 7), ("d-port", 8)))).setMaxAccess("readonly")
...
if mibBuilder.loadTexts: swFwDefaultLow.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwDefaultHigh.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwCustLow.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwCustHigh.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwThresholdEntry.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwThresholdIndex.setStatus('obsolete')
swFwStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 10, 3, 1, 2), SwFwStatus()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: swFwStatus.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwName.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwLabel.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwCurVal.setStatus('obsolete')
swFwLastEvent = MibTableColumn((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 10, 3, 1, 6), SwFwEvent()).setMaxAccess("readonly")
if mibBuilder.loadTexts: swFwLastEvent.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwLastEventVal.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFwBehaviorInt.setStatus('obsolete')
swFwLastSeverityLevel = MibTableColumn((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 10, 3, 1, 12), SwSevType()).setMaxAccess("readonly")
if mibBuilder.loadTexts: swFwLastSeverityLevel.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfALPAMntTable.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfALPAMntEntry.setStatus('obsolete')
swBlmPerfAlpaPort = MibTableColumn((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 23, 1, 1, 1), SwPortIndex()).setMaxAccess("readonly")
if mibBuilder.loadTexts: swBlmPerfAlpaPort.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfAlpaIndx.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfAlpa.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfAlpaCRCCnt.setStatus('obsolete')
swBlmPerfEEMntTable = MibTable((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 23, 2), )
if mibBuilder.loadTexts: swBlmPerfEEMntTable.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfEEMntEntry.setStatus('obsolete')
swBlmPerfEEPort = MibTableColumn((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 23, 2, 1, 1), SwPortIndex()).setMaxAccess("readonly")
if mibBuilder.loadTexts: swBlmPerfEEPort.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfEERefKey.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfEECRC.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfEEFCWRx.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfEEFCWTx.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfEESid.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfEEDid.setStatus('obsolete')
swBlmPerfFltMntTable = MibTable((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 23, 3), )
if mibBuilder.loadTexts: swBlmPerfFltMntTable.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfFltMntEntry.setStatus('obsolete')
swBlmPerfFltPort = MibTableColumn((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 23, 3, 1, 1), SwPortIndex()).setMaxAccess("readonly")
if mibBuilder.loadTexts: swBlmPerfFltPort.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfFltRefkey.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfFltCnt.setStatus('obsolete')
...
if mibBuilder.loadTexts: swBlmPerfFltAlias.setStatus('obsolete')
...
if mibBuilder.loadTexts: swTopTalkerMntMode.setStatus('obsolete')
...
if mibBuilder.loadTexts: swTopTalkerMntNumEntries.setStatus('obsolete')
swTopTalkerMntTable = MibTable((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 25, 3), )
if mibBuilder.loadTexts: swTopTalkerMntTable.setStatus('obsolete')
swTopTalkerMntEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 25, 3, 1), ).setIndexNames((0, "SW-MIB", "swTopTalkerMntIndex"))
if mibBuilder.loadTexts: swTopTalkerMntEntry.setStatus('obsolete')
...
if mibBuilder.loadTexts: swTopTalkerMntIndex.setStatus('obsolete')
...
if mibBuilder.loadTexts: swTopTalkerMntPort.setStatus('obsolete')
...
if mibBuilder.loadTexts: swTopTalkerMntSpid.setStatus('obsolete')
...
if mibBuilder.loadTexts: swTopTalkerMntDpid.setStatus('obsolete')
...
if mibBuilder.loadTexts: swFabricWatchTrap.setStatus('obsolete')
...
if mibBuilder.loadTexts: swTrackChangesTrap.setStatus('obsolete')
...
swBrcdGenericTrap = NotificationType((1, 3, 6, 1, 4, 1, 1588, 2, 1, 1, 1, 0, 14)).setObjects(("SW-MIB", "swBrcdTrapBitMask"), ("SW-MIB", "swBrcdBitObjVal"), ("SW-MIB", "swVfId"))
...
mibBuilder.exportSymbols("SW-MIB", swDomainID=swDomainID, swFCPortSpeed=swFCPortSpeed, swIDIDMode=swIDIDMode, swNbRemDomain=swNbRemDomain, swFCPortPhyState=swFCPortPhyState, swNbIslState=swNbIslState, swFCPortWwn=swFCPortWwn, swFCPortName=swFCPortName, swConnUnitFECUnCorrectedCounter=swConnUnitFECUnCorrectedCounter, swEndDeviceRlsTable=swEndDeviceRlsTable, swTrackChangesInfo=swTrackChangesInfo, swFwCustUnit=swFwCustUnit, swFCPortLipLastAlpa=swFCPortLipLastAlpa, swBlmPerfEEMntTable=swBlmPerfEEMntTable, swFwDefaultBelowActs=swFwDefaultBelowActs, swEndDeviceProtoErr=swEndDeviceProtoErr, swOperStatus=swOperStatus, swFwFabricWatchLicense=swFwFabricWatchLicense, swPmgrEventTrap=swPmgrEventTrap, swConnUnitFTB2Miss=swConnUnitFTB2Miss, swBlmPerfEECRC=swBlmPerfEECRC, swFabricMemShortVersion=swFabricMemShortVersion, swBootDate=swBootDate, swEventTrapLevel=swEventTrapLevel, swSystem=swSystem, swFwCustHigh=swFwCustHigh, swFwSystem=swFwSystem, swIODState=swIODState, swTrunkGroupNumber=swTrunkGroupNumber, SwFwStatus=SwFwStatus, swConnUnitTimedOut=swConnUnitTimedOut, swMemUsage=swMemUsage, swFCPortEntry=swFCPortEntry, swFwLastEventTime=swFwLastEventTime, swFwName=swFwName, swEndDeviceInvalidWord=swEndDeviceInvalidWord, swConnUnitFLNumOfTenancy=swConnUnitFLNumOfTenancy, swConnUnitProcRequired=swConnUnitProcRequired, swCpuOrMemoryUsage=swCpuOrMemoryUsage, swFwValidActs=swFwValidActs, swSensorIndex=swSensorIndex, swFWLastUpdated=swFWLastUpdated, swFCIPMask=swFCIPMask, swEndDeviceInvalidCRC=swEndDeviceInvalidCRC, swBrcdGenericTrap=swBrcdGenericTrap, swSensorType=swSensorType, swConnUnitPCSErrorCounter=swConnUnitPCSErrorCounter, swConnUnitOpen=swConnUnitOpen, swEventDescr=swEventDescr, swTopTalkerMntPort=swTopTalkerMntPort, swMemUsageLimit=swMemUsageLimit, swFabricSegmentTrap=swFabricSegmentTrap, swFwLastEventVal=swFwLastEventVal, swprivProtocolPassword=swprivProtocolPassword, swNsIpNxPort=swNsIpNxPort, swGroupMemTable=swGroupMemTable, swBrcdTrapBitMask=swBrcdTrapBitMask, swFCPortNoTxCredits=swFCPortNoTxCredits, swCpuAction=swCpuAction, swFlashDLOperStatus=swFlashDLOperStatus, swBlmPerfEESid=swBlmPerfEESid, swFwLabel=swFwLabel, swNsEntryIndex=swNsEntryIndex, swAgtTrapRcp=swAgtTrapRcp, swFwCurVal=swFwCurVal, swFwDefaultBufSize=swFwDefaultBufSize, swNbIndex=swNbIndex, swCpuNoOfRetries=swCpuNoOfRetries, swID=swID, swBeaconAdmStatus=swBeaconAdmStatus, swBlmPerfMnt=swBlmPerfMnt, swConnUnitC3DiscardDueToDestUnreachable=swConnUnitC3DiscardDueToDestUnreachable, swMemPollingInterval=swMemPollingInterval, swFwClassAreaIndex=swFwClassAreaIndex, swConnUnitRDYPriority=swConnUnitRDYPriority, swIPv6ChangeTrap=swIPv6ChangeTrap, swGroupIndex=swGroupIndex, swConnUnitTxBufferUnavailable=swConnUnitTxBufferUnavailable, swTopTalkerMntEntry=swTopTalkerMntEntry, swBlmPerfAlpaIndx=swBlmPerfAlpaIndx, sw28k=sw28k, swTopTalkerMntNumEntries=swTopTalkerMntNumEntries, swEventTimeInfo=swEventTimeInfo, swConnUnitOpend=swConnUnitOpend, sw20x0=sw20x0, swEtherIPMask=swEtherIPMask, swFCPortSpecifier=swFCPortSpecifier, swTrunkTable=swTrunkTable, swEventIndex=swEventIndex, swNsPortType=swNsPortType, swGroupEntry=swGroupEntry, swAgtCfg=swAgtCfg, swNsNodeSymb=swNsNodeSymb, swFwDefaultAboveActs=swFwDefaultAboveActs, swFwClassAreaEntry=swFwClassAreaEntry, swSwitchTrunkable=swSwitchTrunkable, SwFwActs=SwFwActs, swFCPortTxType=swFCPortTxType, swBlmPerfALPAMntTable=swBlmPerfALPAMntTable, swConnUnitC3DiscardOther=swConnUnitC3DiscardOther, swConnUnitLunZoneMiss=swConnUnitLunZoneMiss, swFabricWatchTrap=swFabricWatchTrap, swDeviceStatusTrap=swDeviceStatusTrap, swDiagResult=swDiagResult, swFlashDLFile=swFlashDLFile, swDeviceStatus=swDeviceStatus, swFwDefaultTimebase=swFwDefaultTimebase, swFwWriteThVals=swFwWriteThVals, swIPv6Status=swIPv6Status, swNsLocalTable=swNsLocalTable, swConnUnitC3DiscardDueToTXTimeout=swConnUnitC3DiscardDueToTXTimeout, swEventLevel=swEventLevel, swNsLocalEntry=swNsLocalEntry, SwSevType=SwSevType, swEventTrap=swEventTrap, swBeaconOperStatus=swBeaconOperStatus, swConnUnitPortStatExtentionTable=swConnUnitPortStatExtentionTable, swFwCustBufSize=swFwCustBufSize, swGroupId=swGroupId, swPrincipalSwitch=swPrincipalSwitch, swTopTalkerMntIndex=swTopTalkerMntIndex, swFwThLevel=swFwThLevel, swFCPortRxMcasts=swFCPortRxMcasts, swConnUnitFTB6Miss=swConnUnitFTB6Miss, swAgtCmtyStr=swAgtCmtyStr, swFCPortAdmStatus=swFCPortAdmStatus, swNsNodeName=swNsNodeName, swFCPortRxEncInFrs=swFCPortRxEncInFrs, swConnUnitZeroTenancy=swConnUnitZeroTenancy, swFCPortDisableReason=swFCPortDisableReason, SwFwBehavior=SwFwBehavior, swCurrentDate=swCurrentDate, swFabricMemDid=swFabricMemDid, swConnUnitStateChange=swConnUnitStateChange, swTopTalkerMntTable=swTopTalkerMntTable, swFlashDLPassword=swFlashDLPassword, swTopTalkerMntDpid=swTopTalkerMntDpid, swBlmPerfEEDid=swBlmPerfEEDid, swFCPortPrevType=swFCPortPrevType, SwFwLevels=SwFwLevels, swTrunk=swTrunk, swEventVfId=swEventVfId, swNbBaudRate=swNbBaudRate, SwFwWriteVals=SwFwWriteVals, swFCPortRxFrames=swFCPortRxFrames, swFabricMemGWIP=swFabricMemGWIP, swFabricMemTable=swFabricMemTable, swBlmPerfEEFCWRx=swBlmPerfEEFCWRx, swNsPortID=swNsPortID, swConnUnitLli=swConnUnitLli, swFwCustInBetweenActs=swFwCustInBetweenActs, swFCPortOpStatus=swFCPortOpStatus, swFwDefaultExceededActs=swFwDefaultExceededActs, swTopTalker=swTopTalker, swConnUnitTransferConnection=swConnUnitTransferConnection, swFlashLastUpdated=swFlashLastUpdated, swPortMoveTrap=swPortMoveTrap, swNsWwn=swNsWwn, swPortList=swPortList, swNsIPA=swNsIPA, PYSNMP_MODULE_ID=swMibModule, swSensorEntry=swSensorEntry, swFCPortLipIns=swFCPortLipIns, swTrackChangesTrap=swTrackChangesTrap, swSensorValue=swSensorValue, swTopTalkerMntMode=swTopTalkerMntMode, swFCPortTxMcasts=swFCPortTxMcasts, swConnUnitFTB1Miss=swConnUnitFTB1Miss, swConnUnitInterrupts=swConnUnitInterrupts, swAdmStatus=swAdmStatus, sw=sw, swVfName=swVfName, SwFwEvent=SwFwEvent, swGroupType=swGroupType, swFwCustChangedActs=swFwCustChangedActs, swFCPortLinkState=swFCPortLinkState, swNbIslCost=swNbIslCost, swPmgrEventTime=swPmgrEventTime, swBlmPerfEEFCWTx=swBlmPerfEEFCWTx, swFlashDLHost=swFlashDLHost, swModel=swModel, swSensorScn=swSensorScn, swNsPortName=swNsPortName, swEtherIPAddress=swEtherIPAddress, swFCPortRxTooLongs=swFCPortRxTooLongs, swTopTalkerMntDwwn=swTopTalkerMntDwwn, swTopTalkerMntflow=swTopTalkerMntflow, swIPv6Address=swIPv6Address, swBlmPerfAlpa=swBlmPerfAlpa, swTrunkGrpEntry=swTrunkGrpEntry, swConnUnitC3DiscardDueToRXTimeout=swConnUnitC3DiscardDueToRXTimeout, swTrapsV2=swTrapsV2, swFirmwareVersion=swFirmwareVersion, swFCPortRxLCs=swFCPortRxLCs, swAgtCmtyTable=swAgtCmtyTable, swFabricReconfigTrap=swFabricReconfigTrap, swStateChangeTrap=swStateChangeTrap, swExtTrap=swExtTrap, swEndDeviceRlsEntry=swEndDeviceRlsEntry, swFCPortType=swFCPortType, swBlmPerfFltCnt=swBlmPerfFltCnt, swFCPortMcastTimedOuts=swFCPortMcastTimedOuts, swGroupMemWwn=swGroupMemWwn, SwFwClassesAreas=SwFwClassesAreas, swFwDefaultHigh=swFwDefaultHigh, swFwStatus=swFwStatus, swConnUnitStopTenancyStarVation=swConnUnitStopTenancyStarVation, swEventEntry=swEventEntry, swTestString=swTestString, SwFwLicense=SwFwLicense, swConnUnitNLNumOfTenancy=swConnUnitNLNumOfTenancy, swBlmPerfEERefKey=swBlmPerfEERefKey, swAgtCmtyEntry=swAgtCmtyEntry, swSsn=swSsn, swFCIPAddress=swFCIPAddress, swFCPortBrcdType=swFCPortBrcdType, swFwDefaultUnit=swFwDefaultUnit, swAgtTrapSeverityLevel=swAgtTrapSeverityLevel, swFCPortC3Discards=swFCPortC3Discards, swFCPortCapacity=swFCPortCapacity, swZoneConfigChangeTrap=swZoneConfigChangeTrap, swFCport=swFCport, swNumNbs=swNumNbs, swFwWriteActVals=swFwWriteActVals, swFwBehaviorInt=swFwBehaviorInt, swTrunkMaster=swTrunkMaster, swFabricMemType=swFabricMemType, swFCPortRxCrcs=swFCPortRxCrcs, swNsIpAddress=swNsIpAddress, swFCPortFlag=swFCPortFlag, swFwLastEvent=swFwLastEvent, swBlmPerfAlpaCRCCnt=swBlmPerfAlpaCRCCnt, swFCPortRxC3Frames=swFCPortRxC3Frames, swFwBehaviorType=swFwBehaviorType, swEndDeviceLinkFailure=swEndDeviceLinkFailure, swNsPortSymb=swNsPortSymb, swConnUnitLCRX=swConnUnitLCRX, swNs=swNs, swFabricMemEntry=swFabricMemEntry, swFCPortTxWords=swFCPortTxWords, swPortTrunked=swPortTrunked, swTrunkGrpTx=swTrunkGrpTx, swBlmPerfALPAMntEntry=swBlmPerfALPAMntEntry, swTelnetShellAdmStatus=swTelnetShellAdmStatus, swNbEntry=swNbEntry, swAgtCmtyIdx=swAgtCmtyIdx, swSensorInfo=swSensorInfo, swFabricMemEIP=swFabricMemEIP, swFCPortRxC2Frames=swFCPortRxC2Frames, swNumSensors=swNumSensors, swFCPortRxBadOs=swFCPortRxBadOs, swBlmPerfFltAlias=swBlmPerfFltAlias, swBlmPerfFltMntEntry=swBlmPerfFltMntEntry, swNbRemPortName=swNbRemPortName)
mibBuilder.exportSymbols("SW-MIB", swBlmPerfFltPort=swBlmPerfFltPort, swFwCustLow=swFwCustLow, swConnUnitFECCorrectedCounter=swConnUnitFECCorrectedCounter, swBlmPerfAlpaPort=swBlmPerfAlpaPort, swFwLastSeverityLevel=swFwLastSeverityLevel, swModule=swModule, swEndDevicePortID=swEndDevicePortID, swBootPromLastUpdated=swBootPromLastUpdated, swFwThresholdIndex=swFwThresholdIndex, swFCPortRxEncOutFrs=swFCPortRxEncOutFrs, swMemUsageLimit1=swMemUsageLimit1, swFCPortTxFrames=swFCPortTxFrames, swSensorStatus=swSensorStatus, swEndDeviceSigLoss=swEndDeviceSigLoss, swFwCustExceededActs=swFwCustExceededActs, swFwThresholdTable=swFwThresholdTable, swFwThresholdEntry=swFwThresholdEntry, swEventNumEntries=swEventNumEntries, swEvent=swEvent, swFabricMemFCIP=swFabricMemFCIP, swNsHardAddr=swNsHardAddr, swGroupMemPos=swGroupMemPos, swFCPortRxTruncs=swFCPortRxTruncs, swConnUnitInvalidARB=swConnUnitInvalidARB, swNbTable=swNbTable, swTrunkPortIndex=swTrunkPortIndex, swTrunkGrpTable=swTrunkGrpTable, swGroupTable=swGroupTable, swTopTalkerMntSpid=swTopTalkerMntSpid, swFwLastState=swFwLastState, SwFwState=SwFwState, swConnUnitUnroutableFrameCounter=swConnUnitUnroutableFrameCounter, swGroupMemEntry=swGroupMemEntry, swFwDefaultChangedActs=swFwDefaultChangedActs, swFCPortScn=swFCPortScn, swFwCustAboveActs=swFwCustAboveActs, swMemUsageLimit3=swMemUsageLimit3, swBlmPerfFltRefkey=swBlmPerfFltRefkey, swFwCustTimebase=swFwCustTimebase, swSensorTable=swSensorTable, FcPortFlag=FcPortFlag, swFlashDLUser=swFlashDLUser, swCpuUsage=swCpuUsage, SwFwTimebase=SwFwTimebase, swFwDefaultInBetweenActs=swFwDefaultInBetweenActs, swTrunkGrpRx=swTrunkGrpRx, swFlashDLAdmStatus=swFlashDLAdmStatus, swFCPortIndex=swFCPortIndex, swFCPortRxWords=swFCPortRxWords, swEventTable=swEventTable, swEndDeviceSyncLoss=swEndDeviceSyncLoss, swTopTalkerMntSwwn=swTopTalkerMntSwwn, swFabricMemName=swFabricMemName, swFwActLevel=swFwActLevel, swMemNoOfRetries=swMemNoOfRetries, swFwClassAreaTable=swFwClassAreaTable, swEndDevice=swEndDevice, swCpuPollingInterval=swCpuPollingInterval, swBlmPerfEEMntEntry=swBlmPerfEEMntEntry, swEndDeviceAlpa=swEndDeviceAlpa, swGroupName=swGroupName, swFault=swFault, swPmgrEventType=swPmgrEventType, swBlmPerfFltMntTable=swBlmPerfFltMntTable, swConnUnitBadEOF=swConnUnitBadEOF, swauthProtocolPassword=swauthProtocolPassword, swFwDefaultLow=swFwDefaultLow, swEventRepeatCount=swEventRepeatCount, swEndDevicePort=swEndDevicePort, swNsCos=swNsCos, swFCPortTooManyRdys=swFCPortTooManyRdys, swFwCustBelowActs=swFwCustBelowActs, swMibModule=swMibModule, swFCPortRxBadEofs=swFCPortRxBadEofs, swTrunkGrpMaster=swTrunkGrpMaster, swFabricMemWwn=swFabricMemWwn, swTrunkGrpNumber=swTrunkGrpNumber, swNbRemPort=swNbRemPort, swFCPortLipOuts=swFCPortLipOuts, swTrunkEntry=swTrunkEntry, swBrcdBitObjVal=swBrcdBitObjVal, swNbMyPort=swNbMyPort, swNsLocalNumEntry=swNsLocalNumEntry, swCpuUsageLimit=swCpuUsageLimit, swConnUnitZoneMiss=swConnUnitZoneMiss, swNsFc4=swNsFc4, swMemAction=swMemAction, sw21kN24k=sw21kN24k, swBlmPerfEEPort=swBlmPerfEEPort, swPmgrEventDescr=swPmgrEventDescr, swVfId=swVfId, swConnUnitPortStatEntry=swConnUnitPortStatEntry, swFCPortTable=swFCPortTable, swGroup=swGroup, swConnUnitUnknownInterrupts=swConnUnitUnknownInterrupts, swConnUnitCRCWithBadEOF=swConnUnitCRCWithBadEOF, swFabric=swFabric)
