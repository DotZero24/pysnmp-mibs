...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-GDOI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:31 2025
...
cgmGdoiMIBCompliance.setObjects(
      *(("CISCO-GDOI-MIB", "cgmGdoiGroupIdGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiGmSecurityAssociationsGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiGmGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiKeyServerGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiKsSecurityAssociationsGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiKeyServerNotificationGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiKeyServerErrorNotificationGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiGmNotificationGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiGmErrorNotificationGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiNotificationControlGroup"))
)
if mibBuilder.loadTexts:
...
cgmGdoiMIBComplianceRev1.setObjects(
      *(("CISCO-GDOI-MIB", "cgmGdoiGroupIdGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiGroupIdGroupRev1"),
        ("CISCO-GDOI-MIB", "cgmGdoiGmSecurityAssociationsGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiGmGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiGmGroupRev1"),
        ("CISCO-GDOI-MIB", "cgmGdoiKeyServerGroup"),
        ...
        ("CISCO-GDOI-MIB", "cgmGdoiGmErrorNotificationGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiNotificationControlGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiNotificationControlGroupRev1"),
        ("CISCO-GDOI-MIB", "cgmGdoiCoopPeerGroup"),
        ("CISCO-GDOI-MIB", "cgmGdoiNotificationVariablesGroup"))
)
if mibBuilder.loadTexts:
