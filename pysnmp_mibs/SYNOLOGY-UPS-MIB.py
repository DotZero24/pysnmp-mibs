...
mibBuilder.exportSymbols("SYNOLOGY-UPS-MIB", upsAmbientHumidityMin=upsAmbientHumidityMin, PYSNMP_MODULE_ID=synoUPS, upsInfoStatus=upsInfoStatus, upsInputVoltageMax=upsInputVoltageMax, upsAmbientHumidityValue=upsAmbientHumidityValue, upsInfoWatchdogStatus=upsInfoWatchdogStatus, upsInfoTimer=upsInfoTimer, upsDeviceSerial=upsDeviceSerial, upsDeviceContact=upsDeviceContact, upsInfoDelay=upsInfoDelay, upsInfoRealPowerNominal=upsInfoRealPowerNominal, upsOutput=upsOutput, upsAmbientTemperatureAlarm=upsAmbientTemperatureAlarm, upsDevice=upsDevice, upsInfoMfr=upsInfoMfr, upsAmbient=upsAmbient, upsBatteryVoltage=upsBatteryVoltage, upsInputTransferLow=upsInputTransferLow, upsInputTransferLowMax=upsInputTransferLowMax, upsInputCurrentValue=upsInputCurrentValue, upsInputVoltage=upsInputVoltage, upsServerInfo=upsServerInfo, upsOutputCurrent=upsOutputCurrent, upsInfoFirmwareAux=upsInfoFirmwareAux, synology=synology, upsInputTransferBoostHigh=upsInputTransferBoostHigh, upsInfoTestInterval=upsInfoTestInterval, upsAmbientTemperatureHigh=upsAmbientTemperatureHigh, upsBatteryAlarmThreshold=upsBatteryAlarmThreshold, upsInfoVendorID=upsInfoVendorID, upsInputTransfer=upsInputTransfer, upsBatteryRuntimeRestart=upsBatteryRuntimeRestart, upsBatteryCharge=upsBatteryCharge, upsBatteryVoltageLow=upsBatteryVoltageLow, upsGroups=upsGroups, upsInputVoltageFault=upsInputVoltageFault, upsDriverPollFrequency=upsDriverPollFrequency, upsInfoSerial=upsInfoSerial, upsInfoContacts=upsInfoContacts, upsInfoTest=upsInfoTest, upsInfoPowerNominal=upsInfoPowerNominal, upsInfoFirmwareName=upsInfoFirmwareName, upsAmbientTemperatureValue=upsAmbientTemperatureValue, upsInputFrequencyNominal=upsInputFrequencyNominal, upsInfoTestResult=upsInfoTestResult, upsInputVoltageValue=upsInputVoltageValue, upsConformance=upsConformance, upsBatteryEnergySave=upsBatteryEnergySave, upsInfoTemperature=upsInfoTemperature, upsBatteryCurrent=upsBatteryCurrent, upsInfoType=upsInfoType, upsAmbientHumidity=upsAmbientHumidity, upsInputFrequencyValue=upsInputFrequencyValue, upsInfoPowerValue=upsInfoPowerValue, upsBatteryMfrDate=upsBatteryMfrDate, upsInfoRealPowerValue=upsInfoRealPowerValue, upsDeviceLocation=upsDeviceLocation, upsDriverProductID=upsDriverProductID, upsGroup=upsGroup, upsOutputFrequencyNominal=upsOutputFrequencyNominal, upsBatteryProtection=upsBatteryProtection, upsInfoStart=upsInfoStart, upsInputVoltageExtend=upsInputVoltageExtend, upsInfoModel=upsInfoModel, upsOutputVoltageNominal=upsOutputVoltageNominal, upsAmbientTemperatureMin=upsAmbientTemperatureMin, upsServerVersion=upsServerVersion, upsBatteryChargeValue=upsBatteryChargeValue, upsBatteryType=upsBatteryType, NonNegativeInteger=NonNegativeInteger, upsAmbientHumidityAlarm=upsAmbientHumidityAlarm, upsInfoEffciency=upsInfoEffciency, upsInputTransferReason=upsInputTransferReason, upsDevicePart=upsDevicePart, upsDriverVersion=upsDriverVersion, upsBatteryRuntimeLow=upsBatteryRuntimeLow, upsInfoRealPower=upsInfoRealPower, upsDeviceType=upsDeviceType, upsInputTransferHighMax=upsInputTransferHighMax, upsInfoDelayReboot=upsInfoDelayReboot, upsDriverSnmpVersion=upsDriverSnmpVersion, upsInfoLoadValue=upsInfoLoadValue, upsInputQuality=upsInputQuality, upsBatteryChargeWarning=upsBatteryChargeWarning, upsBatteryTemperature=upsBatteryTemperature, upsOutputCurrentValue=upsOutputCurrentValue, upsInfoTimerShutdown=upsInfoTimerShutdown, upsDriverPollInterval=upsDriverPollInterval, upsBatteryPacksBad=upsBatteryPacksBad, upsInfoFirmware=upsInfoFirmware, upsInputTransferTrimHigh=upsInputTransferTrimHigh, upsInputCurrentNominal=upsInputCurrentNominal, upsInfoDisplayLanguage=upsInfoDisplayLanguage, upsCompliance=upsCompliance, upsServer=upsServer, upsInputFrequencyHigh=upsInputFrequencyHigh, upsDeviceDescription=upsDeviceDescription, upsInfoBeeperStatus=upsInfoBeeperStatus, upsInputSensitivity=upsInputSensitivity, upsOutputFrequency=upsOutputFrequency, upsOutputFrequencyValue=upsOutputFrequencyValue, upsInfoAlarm=upsInfoAlarm, upsBatteryDate=upsBatteryDate, upsInputFrequency=upsInputFrequency, upsInputTransferTrimLow=upsInputTransferTrimLow, upsInfo=upsInfo, upsAmbientTemperatureMax=upsAmbientTemperatureMax, upsInfoDelayShutdown=upsInfoDelayShutdown, upsBatteryCapacity=upsBatteryCapacity, synoUPS=synoUPS, upsDriverVersionInternal=upsDriverVersionInternal, upsAmbientTemperature=upsAmbientTemperature, upsInfoStartAuto=upsInfoStartAuto, upsInputTransferLowMin=upsInputTransferLowMin, upsInput=upsInput, upsDriverPort=upsDriverPort, upsBatteryRuntimeValue=upsBatteryRuntimeValue, upsInfoLoadHigh=upsInfoLoadHigh, upsInfoMfrName=upsInfoMfrName, upsInfoTimerReboot=upsInfoTimerReboot, upsInfoTime=upsInfoTime, upsInputCurrent=upsInputCurrent, upsAmbientHumidityHigh=upsAmbientHumidityHigh, upsBatteryVoltageNominal=upsBatteryVoltageNominal, upsBatteryRuntime=upsBatteryRuntime, upsInfoStartReboot=upsInfoStartReboot, upsBatteryPacks=upsBatteryPacks, upsInfoDelayStart=upsInfoDelayStart, upsInfoTimerStart=upsInfoTimerStart, upsOutputVoltage=upsOutputVoltage, upsAmbientTemperatureLow=upsAmbientTemperatureLow, upsInputTransferHighMin=upsInputTransferHighMin, upsDriver=upsDriver, upsInfoStartBattery=upsInfoStartBattery, upsDeviceManufacturer=upsDeviceManufacturer, upsInputVoltageMin=upsInputVoltageMin, upsBattery=upsBattery, upsInputTransferHigh=upsInputTransferHigh, upsInputTransferBoostLow=upsInputTransferBoostLow, upsDriverVersionData=upsDriverVersionData, upsInfoID=upsInfoID, upsInputFrequencyLow=upsInputFrequencyLow, upsBatteryVoltageValue=upsBatteryVoltageValue, upsBatteryChargeLow=upsBatteryChargeLow, upsAmbientHumidityMax=upsAmbientHumidityMax, upsInputVoltageNominal=upsInputVoltageNominal, upsDeviceModel=upsDeviceModel, upsOutputVoltageValue=upsOutputVoltageValue, upsInfoProductID=upsInfoProductID, upsOutputCurrentNominal=upsOutputCurrentNominal, upsDeviceMACAddr=upsDeviceMACAddr, upsDriverName=upsDriverName, upsInfoPower=upsInfoPower, upsInfoMfrDate=upsInfoMfrDate, upsBatteryVoltageHigh=upsBatteryVoltageHigh, upsCompliances=upsCompliances, upsInfoLoad=upsInfoLoad, upsInputFrequencyExtend=upsInputFrequencyExtend, upsAmbientHumidityLow=upsAmbientHumidityLow, upsBatteryChargeRestart=upsBatteryChargeRestart, upsInfoDate=upsInfoDate)
