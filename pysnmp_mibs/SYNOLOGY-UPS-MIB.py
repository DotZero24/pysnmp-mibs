...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/synology/SYNOLOGY-UPS-MIB
...
mibBuilder.exportSymbols("SYNOLOGY-UPS-MIB", upsInfoTestResult=upsInfoTestResult, upsInfoMfrDate=upsInfoMfrDate, upsInfoTimerStart=upsInfoTimerStart, upsInput=upsInput, upsBatteryVoltageHigh=upsBatteryVoltageHigh, upsBatteryVoltageNominal=upsBatteryVoltageNominal, upsInputTransferLowMin=upsInputTransferLowMin, upsBattery=upsBattery, upsAmbientHumidityValue=upsAmbientHumidityValue, upsInfoTimerReboot=upsInfoTimerReboot, upsInfoTime=upsInfoTime, upsBatteryVoltage=upsBatteryVoltage, upsAmbientHumidityMin=upsAmbientHumidityMin, upsBatteryAlarmThreshold=upsBatteryAlarmThreshold, upsAmbientTemperature=upsAmbientTemperature, upsDeviceMACAddr=upsDeviceMACAddr, upsInputTransferTrimHigh=upsInputTransferTrimHigh, upsInfoRealPowerValue=upsInfoRealPowerValue, upsBatteryChargeWarning=upsBatteryChargeWarning, upsOutputVoltage=upsOutputVoltage, upsInfoDelayStart=upsInfoDelayStart, NonNegativeInteger=NonNegativeInteger, upsDeviceDescription=upsDeviceDescription, upsAmbientTemperatureLow=upsAmbientTemperatureLow, upsInfoDelayShutdown=upsInfoDelayShutdown, upsInputTransferReason=upsInputTransferReason, upsAmbientTemperatureMin=upsAmbientTemperatureMin, upsInfoTest=upsInfoTest, upsDriver=upsDriver, upsInputVoltage=upsInputVoltage, upsDeviceLocation=upsDeviceLocation, upsInfoMfrName=upsInfoMfrName, upsInputTransferLowMax=upsInputTransferLowMax, upsOutput=upsOutput, upsInfoEffciency=upsInfoEffciency, upsInputQuality=upsInputQuality, upsInfoTemperature=upsInfoTemperature, upsInfoPower=upsInfoPower, upsBatteryCurrent=upsBatteryCurrent, upsInputSensitivity=upsInputSensitivity, upsDriverPort=upsDriverPort, upsInfoType=upsInfoType, upsInputTransferHigh=upsInputTransferHigh, upsBatteryChargeValue=upsBatteryChargeValue, upsInfoFirmwareAux=upsInfoFirmwareAux, upsBatteryPacks=upsBatteryPacks, upsAmbientHumidityMax=upsAmbientHumidityMax, upsInfoDate=upsInfoDate, upsInfoWatchdogStatus=upsInfoWatchdogStatus, upsInputFrequencyValue=upsInputFrequencyValue, upsInfoTimerShutdown=upsInfoTimerShutdown, upsDeviceManufacturer=upsDeviceManufacturer, upsDevice=upsDevice, upsBatteryRuntimeRestart=upsBatteryRuntimeRestart, upsInfoRealPower=upsInfoRealPower, upsDriverVersionInternal=upsDriverVersionInternal, synology=synology, upsInputTransferTrimLow=upsInputTransferTrimLow, upsInputTransferBoostLow=upsInputTransferBoostLow, upsAmbientTemperatureAlarm=upsAmbientTemperatureAlarm, upsInputVoltageValue=upsInputVoltageValue, upsInfoFirmware=upsInfoFirmware, upsBatteryEnergySave=upsBatteryEnergySave, upsInputCurrent=upsInputCurrent, upsDevicePart=upsDevicePart, upsInfoDelayReboot=upsInfoDelayReboot, upsAmbient=upsAmbient, upsInfoLoadValue=upsInfoLoadValue, upsOutputVoltageNominal=upsOutputVoltageNominal, upsBatteryCapacity=upsBatteryCapacity, upsInfoBeeperStatus=upsInfoBeeperStatus, upsBatteryChargeLow=upsBatteryChargeLow, upsDriverVersion=upsDriverVersion, upsDriverPollFrequency=upsDriverPollFrequency, upsGroup=upsGroup, upsDriverProductID=upsDriverProductID, upsInputFrequency=upsInputFrequency, upsBatteryPacksBad=upsBatteryPacksBad, upsInfoTestInterval=upsInfoTestInterval, upsInfoPowerNominal=upsInfoPowerNominal, upsOutputFrequencyValue=upsOutputFrequencyValue, upsAmbientHumidityAlarm=upsAmbientHumidityAlarm, upsOutputCurrent=upsOutputCurrent, upsInputFrequencyNominal=upsInputFrequencyNominal, upsInfoMfr=upsInfoMfr, upsAmbientTemperatureValue=upsAmbientTemperatureValue, upsInfoRealPowerNominal=upsInfoRealPowerNominal, upsBatteryRuntimeLow=upsBatteryRuntimeLow, upsOutputFrequency=upsOutputFrequency, upsInfoStatus=upsInfoStatus, upsInputVoltageExtend=upsInputVoltageExtend, upsBatteryProtection=upsBatteryProtection, upsAmbientHumidity=upsAmbientHumidity, upsInputVoltageMax=upsInputVoltageMax, upsInfoLoadHigh=upsInfoLoadHigh, upsServer=upsServer, upsGroups=upsGroups, upsDeviceContact=upsDeviceContact, PYSNMP_MODULE_ID=synoUPS, upsInfoSerial=upsInfoSerial, upsInfoAlarm=upsInfoAlarm, upsInfoStartReboot=upsInfoStartReboot, upsAmbientHumidityHigh=upsAmbientHumidityHigh, upsBatteryMfrDate=upsBatteryMfrDate, upsDriverName=upsDriverName, upsBatteryRuntime=upsBatteryRuntime, upsBatteryCharge=upsBatteryCharge, upsOutputCurrentNominal=upsOutputCurrentNominal, upsBatteryTemperature=upsBatteryTemperature, upsDeviceType=upsDeviceType, upsInfoStartBattery=upsInfoStartBattery, upsInfoDisplayLanguage=upsInfoDisplayLanguage, upsInputVoltageMin=upsInputVoltageMin, upsInfo=upsInfo, upsAmbientTemperatureMax=upsAmbientTemperatureMax, upsInputTransferLow=upsInputTransferLow, upsConformance=upsConformance, upsInfoVendorID=upsInfoVendorID, upsDriverVersionData=upsDriverVersionData, upsInputFrequencyLow=upsInputFrequencyLow, upsBatteryType=upsBatteryType, synoUPS=synoUPS, upsDeviceSerial=upsDeviceSerial, upsDriverSnmpVersion=upsDriverSnmpVersion, upsOutputVoltageValue=upsOutputVoltageValue, upsInputVoltageFault=upsInputVoltageFault, upsInfoStartAuto=upsInfoStartAuto, upsInfoDelay=upsInfoDelay, upsCompliances=upsCompliances, upsBatteryRuntimeValue=upsBatteryRuntimeValue, upsServerInfo=upsServerInfo, upsInfoPowerValue=upsInfoPowerValue, upsInputTransferHighMin=upsInputTransferHighMin, upsAmbientHumidityLow=upsAmbientHumidityLow, upsServerVersion=upsServerVersion, upsInfoLoad=upsInfoLoad, upsBatteryVoltageValue=upsBatteryVoltageValue, upsInputFrequencyHigh=upsInputFrequencyHigh, upsInputFrequencyExtend=upsInputFrequencyExtend, upsInputCurrentNominal=upsInputCurrentNominal, upsDriverPollInterval=upsDriverPollInterval, upsBatteryVoltageLow=upsBatteryVoltageLow, upsInfoTimer=upsInfoTimer, upsAmbientTemperatureHigh=upsAmbientTemperatureHigh, upsInfoStart=upsInfoStart, upsInfoContacts=upsInfoContacts, upsOutputFrequencyNominal=upsOutputFrequencyNominal, upsInfoModel=upsInfoModel, upsInfoProductID=upsInfoProductID, upsBatteryChargeRestart=upsBatteryChargeRestart, upsInfoFirmwareName=upsInfoFirmwareName, upsInputTransferHighMax=upsInputTransferHighMax, upsInputTransferBoostHigh=upsInputTransferBoostHigh, upsCompliance=upsCompliance, upsBatteryDate=upsBatteryDate, upsInputCurrentValue=upsInputCurrentValue, upsDeviceModel=upsDeviceModel, upsInputVoltageNominal=upsInputVoltageNominal, upsInputTransfer=upsInputTransfer, upsInfoID=upsInfoID, upsOutputCurrentValue=upsOutputCurrentValue)
