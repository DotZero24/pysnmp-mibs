...
h3cMulticastObject=_H3cMulticastObject_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,50,1))
...
h3cMulticastEnable=_H3cMulticastEnable_Object((1,3,6,1,4,1,43,45,1,10,2,50,1,1),_H3cMulticastEnable_Type())
h3cMulticastEnable.setMaxAccess('read-write')
if mibBuilder.loadTexts:h3cMulticastEnable.setStatus(_A)
mibBuilder.exportSymbols('A3COM-HUAWEI-MULTICAST-MIB',**{_B:EnabledStatus,'h3cMulticast':h3cMulticast,'h3cMulticastObject':h3cMulticastObject,'h3cMulticastEnable':h3cMulticastEnable})