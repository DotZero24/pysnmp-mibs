...
mibBuilder.exportSymbols("CISCO-OPTICAL-MIB", coiOptThreshSecondOrderPMDEnableMax=coiOptThreshSecondOrderPMDEnableMax, coiOptIntervalChromaticDispersionMin=coiOptIntervalChromaticDispersionMin, coiOptCurrentPhaseNoiseMax=coiOptCurrentPhaseNoiseMax, coiOptIntervalOSNRMax=coiOptIntervalOSNRMax, coiOptIntervalDifferentialGroupDelayMin=coiOptIntervalDifferentialGroupDelayMin, coiOptIntervalSecondOrderPMDMax=coiOptIntervalSecondOrderPMDMax, coiOpticalThresholdGroup=coiOpticalThresholdGroup, coiOptThreshDifferentialGroupDelayEnableMin=coiOptThreshDifferentialGroupDelayEnableMin, coiOptThreshLBCEnableMin=coiOptThreshLBCEnableMin, coiOpticalControllerGroup=coiOpticalControllerGroup, coiOptThreshLBCMin=coiOptThreshLBCMin, coiOptIntervalChromaticDispersionMax=coiOptIntervalChromaticDispersionMax, coiOpticalCurrentEntry=coiOpticalCurrentEntry, coiOptThreshChromaticDispersionMax=coiOptThreshChromaticDispersionMax, CoiOptAlarmStatus=CoiOptAlarmStatus, coiOptIntervalOSNRAvg=coiOptIntervalOSNRAvg, coiOpticalControllerPerLanePolarizationChangeRate=coiOpticalControllerPerLanePolarizationChangeRate, coiOpticalControllerPerLanePhaseNoise=coiOpticalControllerPerLanePhaseNoise, coiOptThreshOSNREnableMin=coiOptThreshOSNREnableMin, coiOpticalControllerPortType=coiOpticalControllerPortType, coiOptThreshLBCEnableMax=coiOptThreshLBCEnableMax, coiOptCurrentPolarizationDependentLossAvg=coiOptCurrentPolarizationDependentLossAvg, PYSNMP_MODULE_ID=ciscoOpticalMIB, coiOptThreshPolarizationChangeRateEnableMin=coiOptThreshPolarizationChangeRateEnableMin, coiOptIntervalRXPowerMax=coiOptIntervalRXPowerMax, coiOptCurrentTXPowerAvg=coiOptCurrentTXPowerAvg, coiOpticalControllerPerLaneLBC=coiOpticalControllerPerLaneLBC, coiOptThreshPolarizationDependentLossEnableMin=coiOptThreshPolarizationDependentLossEnableMin, coiOptCurrentRXPowerMin=coiOptCurrentRXPowerMin, coiOpticalControllerRXLowThreshold=coiOpticalControllerRXLowThreshold, coiOptIntervalDifferentialGroupDelayMax=coiOptIntervalDifferentialGroupDelayMax, coiOptThreshDifferentialGroupDelayMin=coiOptThreshDifferentialGroupDelayMin, coiOptThreshLBCMax=coiOptThreshLBCMax, coiOptThreshPolarizationChangeRateMax=coiOptThreshPolarizationChangeRateMax, coiOptCurrentChromaticDispersionAvg=coiOptCurrentChromaticDispersionAvg, coiOptCurrentTXPowerMax=coiOptCurrentTXPowerMax, coiOpticalClientInfoTable=coiOpticalClientInfoTable, ciscoOpticalMIBObjects=ciscoOpticalMIBObjects, coiOptIntervalPhaseNoiseAvg=coiOptIntervalPhaseNoiseAvg, coiOptThreshTXPowerMin=coiOptThreshTXPowerMin, coiOpticalControllerTotalRXPower=coiOpticalControllerTotalRXPower, coiOptCurrentSecondOrderPMDMin=coiOptCurrentSecondOrderPMDMin, coiOptThreshIntervalType=coiOptThreshIntervalType, coiOptIntervalPolarizationChangeRateAvg=coiOptIntervalPolarizationChangeRateAvg, coiOpticalControllerPerLaneRXPower=coiOpticalControllerPerLaneRXPower, coiOpticalAlarmType=coiOpticalAlarmType, coiOptThreshPolarizationDependentLossEnableMax=coiOptThreshPolarizationDependentLossEnableMax, coiOpticalIntervalGroup=coiOpticalIntervalGroup, coiOpticalClientEthernetNeighbourMAC=coiOpticalClientEthernetNeighbourMAC, coiOptIntervalLane=coiOptIntervalLane, coiOptCurrentPolarizationChangeRateMin=coiOptCurrentPolarizationChangeRateMin, CoiIntervalType=CoiIntervalType, coiOptIntervalNum=coiOptIntervalNum, coiOptIntervalLBCMin=coiOptIntervalLBCMin, coiOpticalAlarmTimeStamp=coiOpticalAlarmTimeStamp, coiOptThreshDifferentialGroupDelayEnableMax=coiOptThreshDifferentialGroupDelayEnableMax, coiOptIntervalTXPowerMin=coiOptIntervalTXPowerMin, coiOptCurrentSecondOrderPMDAvg=coiOptCurrentSecondOrderPMDAvg, coiOpticalControllerFrequency=coiOpticalControllerFrequency, coiOptCurrentDifferentialGroupDelayMin=coiOptCurrentDifferentialGroupDelayMin, coiOptIntervalRXPowerAvg=coiOptIntervalRXPowerAvg, coiOptIntervalTXPowerAvg=coiOptIntervalTXPowerAvg, coiOptCurrentLane=coiOptCurrentLane, coiOpticalIntervalEntry=coiOpticalIntervalEntry, coiOptThreshOSNRMax=coiOptThreshOSNRMax, coiOpticalControllerTXHighThreshold=coiOpticalControllerTXHighThreshold, coiOptThreshSecondOrderPMDMin=coiOptThreshSecondOrderPMDMin, coiOptCurrentIntervalType=coiOptCurrentIntervalType, coiOpticalNotifStatusObjectGroup=coiOpticalNotifStatusObjectGroup, coiOpticalThresholdTable=coiOpticalThresholdTable, coiOpticalControllerWavelength=coiOpticalControllerWavelength, coiOptCurrentPolarizationDependentLossMin=coiOptCurrentPolarizationDependentLossMin, coiOpticalClientInfoGroup=coiOpticalClientInfoGroup, coiOpticalEquipmentAlarm=coiOpticalEquipmentAlarm, coiOpticalControllerPerLaneTXPower=coiOpticalControllerPerLaneTXPower, coiOpticalControllerStatus=coiOpticalControllerStatus, coiOpticalCurrentGroup=coiOpticalCurrentGroup, coiOptThreshPolarizationDependentLossMin=coiOptThreshPolarizationDependentLossMin, coiOpticalControllerTransmitPower=coiOpticalControllerTransmitPower, coiOptCurrentPhaseNoiseAvg=coiOptCurrentPhaseNoiseAvg, coiOpticalEquipmentAlarmGroup=coiOpticalEquipmentAlarmGroup, coiOptIntervalLBCAvg=coiOptIntervalLBCAvg, coiOpticalController=coiOpticalController, coiOptThreshOSNREnableMax=coiOptThreshOSNREnableMax, coiOpticalControllerPerLaneChromaticDispersion=coiOpticalControllerPerLaneChromaticDispersion, coiOpticalControllerPerLaneOSNR=coiOpticalControllerPerLaneOSNR, coiOptThreshDifferentialGroupDelayMax=coiOptThreshDifferentialGroupDelayMax, coiOpticalControllerRXHighThreshold=coiOpticalControllerRXHighThreshold, coiOptCurrentSecondOrderPMDMax=coiOptCurrentSecondOrderPMDMax, coiOpticalControllerEntry=coiOpticalControllerEntry, coiOptThreshPolarizationChangeRateEnableMax=coiOptThreshPolarizationChangeRateEnableMax, coiOptThreshPhaseNoiseMax=coiOptThreshPhaseNoiseMax, coiOpticalNotifGroup=coiOpticalNotifGroup, coiOptThreshPolarizationChangeRateMin=coiOptThreshPolarizationChangeRateMin, coiOpticalThresholdEntry=coiOpticalThresholdEntry, coiOptCurrentPolarizationDependentLossMax=coiOptCurrentPolarizationDependentLossMax, coiOptThreshRXPowerEnableMax=coiOptThreshRXPowerEnableMax, coiOptCurrentOSNRMin=coiOptCurrentOSNRMin, coiOptThreshPhaseNoiseMin=coiOptThreshPhaseNoiseMin, coiOptIntervalPhaseNoiseMax=coiOptIntervalPhaseNoiseMax, coiOptThreshRXPowerEnableMin=coiOptThreshRXPowerEnableMin, coiOptThreshChromaticDispersionMin=coiOptThreshChromaticDispersionMin, coiOptThreshTXPowerEnableMax=coiOptThreshTXPowerEnableMax, coiOptIntervalTXPowerMax=coiOptIntervalTXPowerMax, coiOptIntervalRXPowerMin=coiOptIntervalRXPowerMin, coiOptIntervalSecondOrderPMDAvg=coiOptIntervalSecondOrderPMDAvg, coiOptCurrentLBCAvg=coiOptCurrentLBCAvg, coiOptCurrentPolarizationChangeRateMax=coiOptCurrentPolarizationChangeRateMax, coiOptThreshChromaticDispersionEnableMax=coiOptThreshChromaticDispersionEnableMax, coiOptThreshTXPowerMax=coiOptThreshTXPowerMax, coiOpticalControllerPerLaneGroup=coiOpticalControllerPerLaneGroup, ciscoOpticalMIB=ciscoOpticalMIB, coiOptCurrentChromaticDispersionMin=coiOptCurrentChromaticDispersionMin, coiOptCurrentLBCMin=coiOptCurrentLBCMin, coiOptIntervalSecondOrderPMDMin=coiOptIntervalSecondOrderPMDMin, coiOpticalClientInfoEntry=coiOpticalClientInfoEntry, coiOptIntervalLBCMax=coiOptIntervalLBCMax, coiOptIntervalPolarizationChangeRateMin=coiOptIntervalPolarizationChangeRateMin, coiOpticalControllerLaserStatus=coiOpticalControllerLaserStatus, coiOptCurrentChromaticDispersionMax=coiOptCurrentChromaticDispersionMax, coiOpticalAlarmName=coiOpticalAlarmName, coiOptCurrentRXPowerAvg=coiOptCurrentRXPowerAvg, coiOptCurrentTimestamp=coiOptCurrentTimestamp, coiOpticalControllerTXLowThreshold=coiOpticalControllerTXLowThreshold, coiOptIntervalPolarizationDependentLossAvg=coiOptIntervalPolarizationDependentLossAvg, coiOptCurrentTXPowerMin=coiOptCurrentTXPowerMin, coiOpticalControllerTable=coiOpticalControllerTable, CoiOptAlarmServiceAffecting=CoiOptAlarmServiceAffecting, coiOptCurrentLBCMax=coiOptCurrentLBCMax, coiOptThreshSecondOrderPMDEnableMin=coiOptThreshSecondOrderPMDEnableMin, coiOptCurrentPolarizationChangeRateAvg=coiOptCurrentPolarizationChangeRateAvg, coiOptThreshOSNRMin=coiOptThreshOSNRMin, ciscoOpticalMIBComplianceRev1=ciscoOpticalMIBComplianceRev1, coiOptCurrentDifferentialGroupDelayAvg=coiOptCurrentDifferentialGroupDelayAvg, coiOptIntervalPolarizationChangeRateMax=coiOptIntervalPolarizationChangeRateMax, coiOptIntervalIntervalType=coiOptIntervalIntervalType, coiOpticalControllerPerLaneSecondOrderPMD=coiOpticalControllerPerLaneSecondOrderPMD, coiOpticalAlarmStatus=coiOpticalAlarmStatus, coiOptThreshPolarizationDependentLossMax=coiOptThreshPolarizationDependentLossMax, CoiOptAlarmType=CoiOptAlarmType, CoiOpticalWavelength=CoiOpticalWavelength, coiOptCurrentDifferentialGroupDelayMax=coiOptCurrentDifferentialGroupDelayMax, coiOptIntervalDifferentialGroupDelayAvg=coiOptIntervalDifferentialGroupDelayAvg, coiOptThreshPhaseNoiseEnableMin=coiOptThreshPhaseNoiseEnableMin, coiOpticalControllerLane=coiOpticalControllerLane, coiOpticalPowerGroup=coiOpticalPowerGroup, coiOpticalAlarmSeverity=coiOpticalAlarmSeverity, ciscoOpticalMIBCompliance=ciscoOpticalMIBCompliance, coiOptIntervalPolarizationDependentLossMin=coiOptIntervalPolarizationDependentLossMin, coiOpticalNotifEnabled=coiOpticalNotifEnabled, coiOptThreshPhaseNoiseEnableMax=coiOptThreshPhaseNoiseEnableMax, coiOpticsStatusChange=coiOpticsStatusChange, coiOpticalControllerOpticsType=coiOpticalControllerOpticsType, coiOptIntervalPhaseNoiseMin=coiOptIntervalPhaseNoiseMin, coiOpticalControllerTotalTXPower=coiOpticalControllerTotalTXPower, coiOptIntervalTimestamp=coiOptIntervalTimestamp, CoiOptAlarmSeverity=CoiOptAlarmSeverity, coiOptCurrentPhaseNoiseMin=coiOptCurrentPhaseNoiseMin, coiOpticalControllerLBCHighThreshold=coiOpticalControllerLBCHighThreshold, ciscoOpticalMIBNotifs=ciscoOpticalMIBNotifs, coiOptThreshTXPowerEnableMin=coiOptThreshTXPowerEnableMin, coiOpticalAlarmLocation=coiOpticalAlarmLocation, coiOptIntervalOSNRMin=coiOptIntervalOSNRMin, CoiOpticalPower=CoiOpticalPower, coiOptThreshChromaticDispersionEnableMin=coiOptThreshChromaticDispersionEnableMin, coiOpticalControllerPerLaneTable=coiOpticalControllerPerLaneTable, coiOpticalNotifEnableGroup=coiOpticalNotifEnableGroup, coiOptCurrentOSNRAvg=coiOptCurrentOSNRAvg, coiOptThreshRXPowerMax=coiOptThreshRXPowerMax, coiOptCurrentOSNRMax=coiOptCurrentOSNRMax, coiOptThreshSecondOrderPMDMax=coiOptThreshSecondOrderPMDMax, coiOpticalCurrentTable=coiOpticalCurrentTable, ciscoOpticalMIBCompliances=ciscoOpticalMIBCompliances, coiOpticalEquipmentAlarmInfoGroup=coiOpticalEquipmentAlarmInfoGroup, ciscoOpticalMIBConformance=ciscoOpticalMIBConformance, coiOpticalGroup=coiOpticalGroup, coiOpticalIntervalTable=coiOpticalIntervalTable, coiOpticalControllerChannelNumber=coiOpticalControllerChannelNumber, coiOpticalControllerPerLaneEntry=coiOpticalControllerPerLaneEntry, coiOpticalAlarmAdditionalInfo=coiOpticalAlarmAdditionalInfo, coiOptThreshRXPowerMin=coiOptThreshRXPowerMin, ciscoOpticalMIBGroups=ciscoOpticalMIBGroups, coiOptCurrentRXPowerMax=coiOptCurrentRXPowerMax, coiOpticalAlarmServiceAffecting=coiOpticalAlarmServiceAffecting, CoiPortType=CoiPortType, coiOpticalControllerPerLanePolarizationDependentLoss=coiOpticalControllerPerLanePolarizationDependentLoss, coiOptIntervalChromaticDispersionAvg=coiOptIntervalChromaticDispersionAvg, coiOptIntervalPolarizationDependentLossMax=coiOptIntervalPolarizationDependentLossMax, coiOpticalPerformanceMonitoring=coiOpticalPerformanceMonitoring, coiOpticalControllerPerLaneDifferentialGroupDelay=coiOpticalControllerPerLaneDifferentialGroupDelay)
