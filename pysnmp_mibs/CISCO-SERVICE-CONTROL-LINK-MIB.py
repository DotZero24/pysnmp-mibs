...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SERVICE-CONTROL-LINK-MIB
...
cServiceLinkMIBCompliance.setObjects(
      *(("CISCO-SERVICE-CONTROL-LINK-MIB", "cSCLinkMIBObjectGroup"),
        ("CISCO-SERVICE-CONTROL-LINK-MIB", "cSCLinkMIBNotificationGroup"),
        ("CISCO-SERVICE-CONTROL-LINK-MIB", "cSCLinkNotifControlGroup"))
)
if mibBuilder.loadTexts:
