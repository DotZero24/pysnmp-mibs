# SNMP MIB module (T6540-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T6540-MIB
...
trapTest.setObjects(
      *(("T6540-MIB", "sensorName"),
        ("T6540-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
