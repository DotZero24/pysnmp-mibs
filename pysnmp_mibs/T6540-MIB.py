#
# PySNMP MIB module T6540-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/comet/T6540-MIB
...
t6540 = MibIdentifier((1, 3, 6, 1, 4, 1, 22626, 1, 2))
...
historyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 22626, 1, 2, 6, 1, 1), ).setIndexNames((0, "T6540-MIB", "histTemp"))
...
trapTest = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,0)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapNTPError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,1)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapEmailErrLogin = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,2)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapEmailErrAuth = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,3)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapEmailErrSome = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,4)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapEmailErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,5)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapEmailErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,6)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapSOAPErrFile = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,7)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapSOAPErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,8)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapSOAPErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,9)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapSOAPErrDelivery = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,10)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"))
trapTempHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,11)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "temp"), ("T6540-MIB", "tempAlarmInt"))
trapHumHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,12)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "hum"), ("T6540-MIB", "humAlarmInt"))
trapCompValHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,13)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "compVal"), ("T6540-MIB", "compValAlarmInt"))
trapCo2HighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,14)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "co2"), ("T6540-MIB", "co2AlarmInt"))
trapTempLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,21)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "temp"), ("T6540-MIB", "tempAlarmInt"))
trapHumLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,22)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "hum"), ("T6540-MIB", "humAlarmInt"))
trapCompValLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,23)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "compVal"), ("T6540-MIB", "compValAlarmInt"))
trapCo2LowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,24)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "co2"), ("T6540-MIB", "co2AlarmInt"))
trapTempClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,31)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "temp"), ("T6540-MIB", "tempAlarmInt"))
trapHumClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,32)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "hum"), ("T6540-MIB", "humAlarmInt"))
trapCompValClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,33)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "compVal"), ("T6540-MIB", "compValAlarmInt"))
trapCo2ClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,34)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "co2"), ("T6540-MIB", "co2AlarmInt"))
trapTempError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,41)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "temp"), ("T6540-MIB", "tempAlarmInt"))
trapHumError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,42)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "hum"), ("T6540-MIB", "humAlarmInt"))
trapCompValError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,43)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "compVal"), ("T6540-MIB", "compValAlarmInt"))
trapCo2Error = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,44)).setObjects(("T6540-MIB", "sensorName"), ("T6540-MIB", "messageString"), ("T6540-MIB", "co2"), ("T6540-MIB", "co2AlarmInt"))
mibBuilder.exportSymbols("T6540-MIB", trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrFile=trapSOAPErrFile, trapCo2ClrAlarm=trapCo2ClrAlarm, DisplayString=DisplayString, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, humLowInt=humLowInt, trapHumClrAlarm=trapHumClrAlarm, co2HighInt=co2HighInt, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, compValHighInt=compValHighInt, tempUnit=tempUnit, tempDelayInt=tempDelayInt, compValAlarmInt=compValAlarmInt, historyTable=historyTable, tempLowInt=tempLowInt, humUnit=humUnit, compValInt=compValInt, settings=settings, humHystInt=humHystInt, trapCo2HighAlarm=trapCo2HighAlarm, trapEmailErrLogin=trapEmailErrLogin, co2LowInt=co2LowInt, trapHumError=trapHumError, tempHystInt=tempHystInt, compValLowInt=compValLowInt, trapCompValHighAlarm=trapCompValHighAlarm, co2=co2, humAlarm=humAlarm, histCO2=histCO2, trapEmailErrSocket=trapEmailErrSocket, trapTempClrAlarm=trapTempClrAlarm, co2AlarmInt=co2AlarmInt, trapCo2Error=trapCo2Error, compValUnit=compValUnit, comet=comet, co2Alarm=co2Alarm, co2DelayInt=co2DelayInt, tempMin=tempMin, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, historyEntry=historyEntry, products=products, co2HystInt=co2HystInt, hum=hum, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, trapCompValError=trapCompValError, humMax=humMax, humDelayInt=humDelayInt, compValAlarm=compValAlarm, humHighInt=humHighInt, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, messageString=messageString, serialNumber=serialNumber, co2Min=co2Min, valuesInt=valuesInt, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, deviceType=deviceType, histTemp=histTemp, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, histCompVal=histCompVal, tables=tables, trapEmailErrDNS=trapEmailErrDNS, co2Max=co2Max, tempMax=tempMax, compValMax=compValMax, t6540=t6540, histHum=histHum, humAlarmInt=humAlarmInt, compValMin=compValMin, trapNTPError=trapNTPError, values=values, tempHighInt=tempHighInt, humInt=humInt, traps=traps, trapCompValClrAlarm=trapCompValClrAlarm, sensorName=sensorName, tempAlarm=tempAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, trapCo2LowAlarm=trapCo2LowAlarm, trapTest=trapTest, compValDelayInt=compValDelayInt, compVal=compVal, co2Int=co2Int, co2Unit=co2Unit)
