...
_D='A3COM-HUAWEI-VOCALLACTIVE-MIB'
_C='Integer32'
_B='read-only'
_A='current'
...
h3cVoCallActiveObjects=_H3cVoCallActiveObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,6,1))
_H3cVoCallActiveTable_Object=MibTable
h3cVoCallActiveTable=_H3cVoCallActiveTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1))
if mibBuilder.loadTexts:h3cVoCallActiveTable.setStatus(_A)
_H3cVoCallActiveEntry_Object=MibTableRow
h3cVoCallActiveEntry=_H3cVoCallActiveEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1))
...
h3cVoCallActiveChannel=_H3cVoCallActiveChannel_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,1),_H3cVoCallActiveChannel_Type())
...
h3cVoCallActiveCallerNumber=_H3cVoCallActiveCallerNumber_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,2),_H3cVoCallActiveCallerNumber_Type())
...
h3cVoCallActiveCalledNumber=_H3cVoCallActiveCalledNumber_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,3),_H3cVoCallActiveCalledNumber_Type())
...
h3cVoCallActiveEncodeType=_H3cVoCallActiveEncodeType_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,4),_H3cVoCallActiveEncodeType_Type())
...
h3cVoCallActiveLocalAddressType=_H3cVoCallActiveLocalAddressType_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,5),_H3cVoCallActiveLocalAddressType_Type())
...
h3cVoCallActiveLocalAddress=_H3cVoCallActiveLocalAddress_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,6),_H3cVoCallActiveLocalAddress_Type())
...
h3cVoCallActivePeerAddressType=_H3cVoCallActivePeerAddressType_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,7),_H3cVoCallActivePeerAddressType_Type())
...
h3cVoCallActivePeerAddress=_H3cVoCallActivePeerAddress_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,8),_H3cVoCallActivePeerAddress_Type())
...
h3cVoCallActiveCallOrigin=_H3cVoCallActiveCallOrigin_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,9),_H3cVoCallActiveCallOrigin_Type())
...
h3cVoCallActiveIPSigType=_H3cVoCallActiveIPSigType_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,10),_H3cVoCallActiveIPSigType_Type())
...
h3cVoCallActivePSTNSigType=_H3cVoCallActivePSTNSigType_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,11),_H3cVoCallActivePSTNSigType_Type())
...
h3cVoCallActiveStatus=_H3cVoCallActiveStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,6,1,1,1,12),_H3cVoCallActiveStatus_Type())
