# SNMP MIB module (FS-NMS-EAPS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/fscom/FS-NMS-EAPS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:14:02 2025
...
nmsEAPSRingTableEntry = _NmsEAPSRingTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 2, 230, 4, 1)
)
nmsEAPSRingTableEntry.setIndexNames(
    (0, "FS-NMS-EAPS-MIB", "nmsEAPSRingID"),
)
if mibBuilder.loadTexts:
...
nmsEAPSRingPortTableEntry = _NmsEAPSRingPortTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 2, 230, 5, 1)
)
nmsEAPSRingPortTableEntry.setIndexNames(
    (0, "FS-NMS-EAPS-MIB", "nmsEAPSRingPortRingID"),
    (0, "FS-NMS-EAPS-MIB", "nmsEAPSRingPort"),
)
if mibBuilder.loadTexts:
...
nmsEAPSRingNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 52642, 2, 230, 6, 1)
)
nmsEAPSRingNotification.setObjects(
      *(("FS-NMS-EAPS-MIB", "nmsEAPSRingID"),
        ("FS-NMS-EAPS-MIB", "nmsEAPSRingNodeType"),
        ("FS-NMS-EAPS-MIB", "nmsEAPSRingState"))
)
if mibBuilder.loadTexts:
