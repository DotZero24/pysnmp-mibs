...
mibBuilder.exportSymbols("BIANCA-BRICK-SIF-MIB", ipSifPolicyChkDestIfIndex=ipSifPolicyChkDestIfIndex, ipSifAliasAddressGroupTable=ipSifAliasAddressGroupTable, ipSifExpectIfIndex=ipSifExpectIfIndex, ipSifAliasServiceSourcePort=ipSifAliasServiceSourcePort, ipSifAliasServiceType=ipSifAliasServiceType, ipSifAliasServiceEntry=ipSifAliasServiceEntry, ipSifSysloglevel=ipSifSysloglevel, ipSifAliasServiceGroupId=ipSifAliasServiceGroupId, ipSifAliasAddressGroupId=ipSifAliasAddressGroupId, ipSifPolicyChkAdminStatus=ipSifPolicyChkAdminStatus, ipSifPPTPTimeout=ipSifPPTPTimeout, ipSifAliasServicePort=ipSifAliasServicePort, ipSifAliasServiceGroupEntry=ipSifAliasServiceGroupEntry, ipSifAliasAddressAddress=ipSifAliasAddressAddress, ipSifAliasAddressMode=ipSifAliasAddressMode, ipSifMaxRejectTtl=ipSifMaxRejectTtl, ipSifAliasAddressGroupMode=ipSifAliasAddressGroupMode, ipSifAliasService=ipSifAliasService, ipSifAliasSource=ipSifAliasSource, ipSifAliasServiceGroupAlias=ipSifAliasServiceGroupAlias, ipSifRejectPortHigh=ipSifRejectPortHigh, ipSifExpectDestination=ipSifExpectDestination, ipSifPolicyChkCurrOperStatus=ipSifPolicyChkCurrOperStatus, ipSifExpectIndex=ipSifExpectIndex, ipSifAliasAddressGroupEntry=ipSifAliasAddressGroupEntry, ipSifAliasOrder=ipSifAliasOrder, ipSifStat=ipSifStat, ipSifUdpTimeout=ipSifUdpTimeout, ipSifAliasServiceGroup=ipSifAliasServiceGroup, ipSifAliasTable=ipSifAliasTable, ipSifAliasAddressGroup=ipSifAliasAddressGroup, ipSifAliasServiceGroupTable=ipSifAliasServiceGroupTable, ipSifExpectPriority=ipSifExpectPriority, ipSifRejectIndex=ipSifRejectIndex, ipSifDefaultTimeout=ipSifDefaultTimeout, ipSifAliasServiceAlias=ipSifAliasServiceAlias, ipSifAliasDestination=ipSifAliasDestination, ipSifExpectTable=ipSifExpectTable, ipSifAliasServiceRange=ipSifAliasServiceRange, ipSifExpectProtocol=ipSifExpectProtocol, ipSifPolicyChkResult=ipSifPolicyChkResult, ipSifAliasAddressTable=ipSifAliasAddressTable, ipSifAliasAddressRange=ipSifAliasAddressRange, ipSifPolicyChkTable=ipSifPolicyChkTable, ipSifPolicyChkOperStatus=ipSifPolicyChkOperStatus, ipSifRejectSource=ipSifRejectSource, ipSifAliasAddressGroupIndex=ipSifAliasAddressGroupIndex, ipSifInterfaceFilter=ipSifInterfaceFilter, ipSifPolicyChkDestination=ipSifPolicyChkDestination, ipSifRejectProtocol=ipSifRejectProtocol, ipSifPolicyChkEntry=ipSifPolicyChkEntry, ipSifStatTotalTcpSessions=ipSifStatTotalTcpSessions, ipSifAliasEntry=ipSifAliasEntry, ipSifRejectTable=ipSifRejectTable, ipSifAliasStatus=ipSifAliasStatus, ipSifAliasServiceIndex=ipSifAliasServiceIndex, bibo=bibo, ipSifLocalFilter=ipSifLocalFilter, ipSifStatCurrTcpSessions=ipSifStatCurrTcpSessions, ipSifRejectPortLo=ipSifRejectPortLo, ipSifPolicyChkState=ipSifPolicyChkState, ipSifTcpTimeout=ipSifTcpTimeout, ipSifAliasAddressMask=ipSifAliasAddressMask, ipSifStatCurrUdpSessions=ipSifStatCurrUdpSessions, ipSifStatCurrSessions=ipSifStatCurrSessions, ipSifExpectDestPort=ipSifExpectDestPort, ipSifPolicyChkDestPort=ipSifPolicyChkDestPort, ipSifStatCurrExpectedSessions=ipSifStatCurrExpectedSessions, ipSifAliasServiceIcmpType=ipSifAliasServiceIcmpType, ipSif=ipSif, ipSifInterfaceAliasAutoCreate=ipSifInterfaceAliasAutoCreate, ipSifAliasAddressGroupAlias=ipSifAliasAddressGroupAlias, biboip=biboip, ipSifAliasAddressInterface=ipSifAliasAddressInterface, ipSifAliasServiceIcmpCode=ipSifAliasServiceIcmpCode, ipSifStatTotalExpectedSessions=ipSifStatTotalExpectedSessions, ipSifPolicyChkSource=ipSifPolicyChkSource, ipSifAliasAddressIndex=ipSifAliasAddressIndex, ipSifStatCurrOtherSessions=ipSifStatCurrOtherSessions, ipSifPolicyChkRule=ipSifPolicyChkRule, ipSifAliasServiceGroupMode=ipSifAliasServiceGroupMode, ipSifPolicyChkRuleOrder=ipSifPolicyChkRuleOrder, ipSifPolicyChkSourceIfIndex=ipSifPolicyChkSourceIfIndex, ipSifExpectClassId=ipSifExpectClassId, ipSifAliasAddressEntry=ipSifAliasAddressEntry, ipSifAliasAction=ipSifAliasAction, ipSifAliasServiceProtocol=ipSifAliasServiceProtocol, ipSifAliasServiceGroupIndex=ipSifAliasServiceGroupIndex, ipSifRejectEntry=ipSifRejectEntry, ipSifRejectRejects=ipSifRejectRejects, ipSifStatTotalOtherSessions=ipSifStatTotalOtherSessions, ipSifAliasServiceTable=ipSifAliasServiceTable, ipSifStatTotalUdpSessions=ipSifStatTotalUdpSessions, ipSifRejectSilence=ipSifRejectSilence, ipSifExpectSourcePort=ipSifExpectSourcePort, ipSifMaxSessions=ipSifMaxSessions, ipSifAliasClassId=ipSifAliasClassId, ipSifAliasAddressAlias=ipSifAliasAddressAlias, bintec=bintec, ipSifRejectDestination=ipSifRejectDestination, ipSifMaxRejectEntries=ipSifMaxRejectEntries, ipSifExpectSource=ipSifExpectSource, ipSifPolicyChkProtocol=ipSifPolicyChkProtocol, ipSifAdminStatus=ipSifAdminStatus, ipSifAliasPriority=ipSifAliasPriority, ipSifAliasServiceSourceRange=ipSifAliasServiceSourceRange, ipSifExpectEntry=ipSifExpectEntry)
