...
mibBuilder.exportSymbols("LJ3200-MIB", dm=dm, DisplayString=DisplayString, fax_master_host=fax_master_host, copier_job_num_copies=copier_job_num_copies, prtmarkeraddressabilityunit=prtmarkeraddressabilityunit, prtoutputstatus=prtoutputstatus, fax_rx_disposition=fax_rx_disposition, prtmarkerdefaultindex=prtmarkerdefaultindex, hrdeviceindex=hrdeviceindex, faxjob_tx_type=faxjob_tx_type, error2_code=error2_code, destination_subsystem=destination_subsystem, prtcoverdescription=prtcoverdescription, job_info_attr_12=job_info_attr_12, prtInput=prtInput, prtinputmediadimxfeeddirdeclared=prtinputmediadimxfeeddirdeclared, interface=interface, faxjob_action_id=faxjob_action_id, prtMediaPathEntry=prtMediaPathEntry, prtconsoleontime=prtconsoleontime, prtOutputEntry=prtOutputEntry, hrmemorysize=hrmemorysize, fax_send=fax_send, prtOutput=prtOutput, job_info_pages_printed=job_info_pages_printed, prtMediaPathTable=prtMediaPathTable, error5_time_stamp=error5_time_stamp, device_cfg_upload_error=device_cfg_upload_error, job_info_physical_outbins_used=job_info_physical_outbins_used, on_off_line=on_off_line, status_scanner=status_scanner, fax_download_error=fax_download_error, download_timeout=download_timeout, settings_fax_job=settings_fax_job, settings_copier=settings_copier, fax_ring_volume=fax_ring_volume, pdl_pcl=pdl_pcl, print_internal_page=print_internal_page, hrstoragesize=hrstoragesize, scan_pad_image=scan_pad_image, intray=intray, prtgeneralcurrentlocalization=prtgeneralcurrentlocalization, prtmarkersuppliesmaxcapacity=prtmarkersuppliesmaxcapacity, faxjob_tx_error_1=faxjob_tx_error_1, fax_receive=fax_receive, default_vmi=default_vmi, hrstorageallocationunits=hrstorageallocationunits, prtchannelifindex=prtchannelifindex, device_name=device_name, simm3_capacity=simm3_capacity, status_fax_receive=status_fax_receive, channel_io_errors=channel_io_errors, hrDeviceTable=hrDeviceTable, faxjob_tx_status_1=faxjob_tx_status_1, fax_phone_pickup_enable=fax_phone_pickup_enable, channel_bytes_sent=channel_bytes_sent, settings_system=settings_system, prtInputTable=prtInputTable, scan_height=scan_height, hrdevicetype=hrdevicetype, prtinterpreterdefaultcharsetout=prtinterpreterdefaultcharsetout, prtdevicerefindex=prtdevicerefindex, fax_resolution=fax_resolution, fax_tx_phone_number=fax_tx_phone_number, hrDeviceEntry=hrDeviceEntry, hrstorageindex=hrstorageindex, form_feed_needed=form_feed_needed, copier_job_collation=copier_job_collation, fax_pstn_access_code=fax_pstn_access_code, default_ret=default_ret, prtinputmediadimxfeeddirchosen=prtinputmediadimxfeeddirchosen, prtmarkersuppliesdescription=prtmarkersuppliesdescription, custom_paper_feed_dim=custom_paper_feed_dim, error5_code=error5_code, fax_error_correction_mode=fax_error_correction_mode, prtmediapathminmediaxfeeddir=prtmediapathminmediaxfeeddir, fax_max_redials=fax_max_redials, prtinputcurrentlevel=prtinputcurrentlevel, prtalertgroup=prtalertgroup, fax_download_token=fax_download_token, fax_max_rings_pickup=fax_max_rings_pickup, scanner_jam_page_count=scanner_jam_page_count, prtChannelEntry=prtChannelEntry, prtinterpreterlangfamily=prtinterpreterlangfamily, copier_job=copier_job, device_redial=device_redial, error1=error1, error7=error7, simm=simm, tray1_fuser_temperature=tray1_fuser_temperature, prtalerttime=prtalerttime, fax_report_transmission=fax_report_transmission, settings_fax_send=settings_fax_send, device=device, prtchanneltype=prtchanneltype, error8_time_stamp=error8_time_stamp, prtoutputtype=prtoutputtype, fax_station_name=fax_station_name, prtConsoleLights=prtConsoleLights, fax_thumbnail_enable=fax_thumbnail_enable, faxjob_rx_duration=faxjob_rx_duration, prtconsolenumberofdisplaychars=prtconsolenumberofdisplaychars, prtmediapathminmediafeeddir=prtmediapathminmediafeeddir, error2=error2, faxjob_upload_id=faxjob_upload_id, active_print_jobs=active_print_jobs, pjl=pjl, scan_compression_factor=scan_compression_factor, error10_time_stamp=error10_time_stamp, channel_table=channel_table, prtalertlocation=prtalertlocation, device_cfg_upload=device_cfg_upload, scanner_button_status=scanner_button_status, scan_image_type=scan_image_type, prtinterpreterlangversion=prtinterpreterlangversion, cancel_job=cancel_job, prtgeneralreset=prtgeneralreset, prtinterpreterfeedaddressability=prtinterpreterfeedaddressability, prtAlert=prtAlert, copier_reduction=copier_reduction, hrdevicedescr=hrdevicedescr, prtconsoledisable=prtconsoledisable, prtgeneralserviceperson=prtgeneralserviceperson, scanner=scanner, io_switch=io_switch, error4_time_stamp=error4_time_stamp, fax_upload=fax_upload, scanner_adf_page_count=scanner_adf_page_count, hrprinterdetectederrorstate=hrprinterdetectederrorstate, custom_paper_dim_unit=custom_paper_dim_unit, fax_silent_detection=fax_silent_detection, hrPrinterTable=hrPrinterTable, prtinterpretertwoway=prtinterpretertwoway, dial_all_lines=dial_all_lines, prtinterpreterversion=prtinterpreterversion, hrstoragetype=hrstoragetype, prtinputdimunit=prtinputdimunit, prtmediapathtype=prtmediapathtype, copier=copier, wide_a4=wide_a4, error2_time_stamp=error2_time_stamp, scan_upload=scan_upload, prtinterpreterdescription=prtinterpreterdescription, device_cfg_upload_data_type=device_cfg_upload_data_type, device_config_token=device_config_token, prtinputname=prtinputname, error9=error9, fax_dial_tone_detection=fax_dial_tone_detection, scan_resolution_range=scan_resolution_range, default_media_size=default_media_size, prtmarkerspotcolorants=prtmarkerspotcolorants, error8=error8, prtInputEntry=prtInputEntry, fax_activity_log=fax_activity_log, settings_fax_receive=settings_fax_receive, source_subsystem=source_subsystem, prtmarkerprocesscolorants=prtmarkerprocesscolorants, hrdevicestatus=hrdevicestatus, printmib=printmib, device_cfg_download_error=device_cfg_download_error, prtGeneralTable=prtGeneralTable, default_lines_per_page=default_lines_per_page, prtinputversion=prtinputversion, prtmediapathmaxspeed=prtmediapathmaxspeed, prtconsoleofftime=prtconsoleofftime, prtmarkersuppliessupplyunit=prtmarkersuppliessupplyunit, not_ready_fax_receive=not_ready_fax_receive, default_copies=default_copies, faxjob_rx_current_page_1=faxjob_rx_current_page_1, prtMarkerTable=prtMarkerTable, prtmarkernorthmargin=prtmarkernorthmargin, status_fax_job=status_fax_job, prtmediapathdescription=prtmediapathdescription, prtalertdescription=prtalertdescription, prtconsolecolor=prtconsolecolor, date_display=date_display, job_info_attr_6=job_info_attr_6, job_info_attr_15=job_info_attr_15, dial=dial, prtmediapathdefaultindex=prtmediapathdefaultindex, prtmarkeraddressabilityfeeddir=prtmarkeraddressabilityfeeddir, install_date=install_date, faxjob_tx_duration_1=faxjob_tx_duration_1, scan_calibration=scan_calibration, copier_num_copies=copier_num_copies, fax_log_action=fax_log_action, error3=error3, error3_time_stamp=error3_time_stamp, prtInterpreterTable=prtInterpreterTable, status_prt_eng=status_prt_eng, not_ready_fax_send=not_ready_fax_send, id=id, job_info_change_id=job_info_change_id, prtmediapathstatus=prtmediapathstatus, auto_continue=auto_continue, prtalertcode=prtalertcode, fax_firmware_revision=fax_firmware_revision, prtinputserialnumber=prtinputserialnumber, hrStorage=hrStorage, prtMarker=prtMarker, error6_code=error6_code, prtchannelprotocolversion=prtchannelprotocolversion, faxjob_download_id=faxjob_download_id, hrdeviceid=hrdeviceid, pcl_default_font_height=pcl_default_font_height, tables=tables, channel_bytes_received=channel_bytes_received, faxjob_action=faxjob_action, prtinputsecurity=prtinputsecurity, prtmediapathmaxmediafeeddir=prtmediapathmaxmediafeeddir, scan_calibration_error=scan_calibration_error, upload_timeout=upload_timeout, simm3_type=simm3_type, error7_time_stamp=error7_time_stamp, copier_job_media_size=copier_job_media_size, faxjob_tx_id=faxjob_tx_id, fw_rom_datecode=fw_rom_datecode, faxjob_rx_status=faxjob_rx_status, io=io, prtmediapathmediasizeunit=prtmediapathmediasizeunit, pcl_default_font_width=pcl_default_font_width, scanner_scanline_statistics=scanner_scanline_statistics, faxjob_rx_id=faxjob_rx_id, fax_pixel_data_type=fax_pixel_data_type, error6_time_stamp=error6_time_stamp, cold_reset_media_size=cold_reset_media_size, scan_adf_page_count=scan_adf_page_count, prtAlertTable=prtAlertTable, faxjob_rx_current_page=faxjob_rx_current_page, transmit_fax=transmit_fax, settings_scanner=settings_scanner, prtStorageRefTable=prtStorageRefTable, current_job_parsing_id=current_job_parsing_id, error4_code=error4_code, override_media_size=override_media_size, fax_redial_time=fax_redial_time, errorlog=errorlog, hp=hp, job_info_attr_9=job_info_attr_9, prtstoragerefindex=prtstoragerefindex, job_info_stage=job_info_stage, prtinputmaxcapacity=prtinputmaxcapacity, fax_answer_mode=fax_answer_mode, simm2_capacity=simm2_capacity, status_fax_proc_sub=status_fax_proc_sub, job=job, default_bits_per_pixel=default_bits_per_pixel, status_pdl=status_pdl, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, job_info_attr_7=job_info_attr_7, total_engine_page_count=total_engine_page_count, settings_io=settings_io, scan_calibration_download=scan_calibration_download, sleep_mode=sleep_mode)
mibBuilder.exportSymbols("LJ3200-MIB", job_info_attr_5=job_info_attr_5, job_info=job_info, default_scanner_margin_right=default_scanner_margin_right, fax_ring_enable=fax_ring_enable, fax_local_phone_num=fax_local_phone_num, prtalertcriticalevents=prtalertcriticalevents, prtlocalizationcountry=prtlocalizationcountry, scan_token=scan_token, fax_receive_stamping_enable=fax_receive_stamping_enable, pysmi_continue=pysmi_continue, print_engine_jam_count=print_engine_jam_count, prtalertallevents=prtalertallevents, default_print_quality=default_print_quality, scan_subsample=scan_subsample, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, error_log_clear=error_log_clear, copier_collation=copier_collation, scan_calibration_target=scan_calibration_target, copier_quality=copier_quality, job_info_attr_3=job_info_attr_3, hrstorageallocationfailures=hrstorageallocationfailures, prtmarkersuppliestype=prtmarkersuppliestype, prtCoverTable=prtCoverTable, prtinterpreterlanglevel=prtinterpreterlanglevel, job_info_pages_processed=job_info_pages_processed, job_info_outcome=job_info_outcome, fax_upload_error=fax_upload_error, error6=error6, fax_country=fax_country, scan_contrast=scan_contrast, prtmarkersuppliescolorantindex=prtmarkersuppliescolorantindex, not_ready_source_scanner=not_ready_source_scanner, fax_forwarding_phone_num=fax_forwarding_phone_num, hrstorageused=hrstorageused, energy_star=energy_star, device_cfg_download_data_type=device_cfg_download_data_type, job_info_attr_8=job_info_attr_8, prtgeneralcurrentoperator=prtgeneralcurrentoperator, prtmarkerstatus=prtmarkerstatus, pcl_resource_saving_memory_size=pcl_resource_saving_memory_size, fax_rxscale=fax_rxscale, prtlocalizationcharacterset=prtlocalizationcharacterset, prtLocalization=prtLocalization, simm3=simm3, prtinputtype=prtinputtype, error9_code=error9_code, faxjob_tx_current_page_1=faxjob_tx_current_page_1, faxjob_tx_error=faxjob_tx_error, intray1=intray1, prtmarkersouthmargin=prtmarkersouthmargin, prtinputdescription=prtinputdescription, settings_pdl=settings_pdl, error1_time_stamp=error1_time_stamp, fax_log_reporting=fax_log_reporting, prtinputdefaultindex=prtinputdefaultindex, prtinterpreterdefaultcharsetin=prtinterpreterdefaultcharsetin, prtInterpreterEntry=prtInterpreterEntry, prtchannelinformation=prtchannelinformation, prtinterpreterxfeedaddressability=prtinterpreterxfeedaddressability, job_info_io_source=job_info_io_source, prtgeneralprintername=prtgeneralprintername, settings_fax_proc_sub=settings_fax_proc_sub, job_info_outbins_used=job_info_outbins_used, prtconsoledisplaybuffertext=prtconsoledisplaybuffertext, reprint=reprint, test=test, copier_token=copier_token, settings_prt_eng=settings_prt_eng, pdl=pdl, fax_beep_volume=fax_beep_volume, scan_pixel_data_type=scan_pixel_data_type, fax_proc_sub=fax_proc_sub, status_fax_send=status_fax_send, prtlocalizationlanguage=prtlocalizationlanguage, prtCover=prtCover, copier_job_contrast=copier_job_contrast, job_info_attribute=job_info_attribute, job_info_attr_13=job_info_attr_13, scan_control_descriptor=scan_control_descriptor, prtOutputTable=prtOutputTable, prtinputmediadimfeeddirchosen=prtinputmediadimfeeddirchosen, fax_noise_volume=fax_noise_volume, ui_select_option=ui_select_option, faxjob_tx_status=faxjob_tx_status, asset_number=asset_number, default_scanner_margin_left=default_scanner_margin_left, fax_contrast=fax_contrast, job_info_attr_16=job_info_attr_16, fax_job_control=fax_job_control, prtinputmediadimfeeddirdeclared=prtinputmediadimfeeddirdeclared, fax_additional_wait=fax_additional_wait, ui_add_option=ui_add_option, io_timeout=io_timeout, prtoutputremainingcapacity=prtoutputremainingcapacity, print_engine_mispick_count=print_engine_mispick_count, prtConsoleLightEntry=prtConsoleLightEntry, prtDeviceRefTable=prtDeviceRefTable, error1_code=error1_code, hrStorageEntry=hrStorageEntry, scan_upload_error=scan_upload_error, settings_intray=settings_intray, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, fax_min_rings_pickup=fax_min_rings_pickup, prtmarkereastmargin=prtmarkereastmargin, prtmarkerpoweroncount=prtmarkerpoweroncount, hrm=hrm, scanner_retrieve_scanline=scanner_retrieve_scanline, prtinputmedianame=prtinputmedianame, system=system, job_info_name1=job_info_name1, default_horizontal_black_resolution=default_horizontal_black_resolution, fax_upload_token=fax_upload_token, prtChannelTable=prtChannelTable, settings_faxlog=settings_faxlog, error5=error5, maximum_resource_saving_memory=maximum_resource_saving_memory, prtmarkersuppliesmarkerindex=prtmarkersuppliesmarkerindex, device_cfg_download=device_cfg_download, hrdeviceerrors=hrdeviceerrors, prtmarkercounterunit=prtmarkercounterunit, settings_job=settings_job, default_page_protect=default_page_protect, prtmarkerwestmargin=prtmarkerwestmargin, faxjob_rx_status_1=faxjob_rx_status_1, prtmarkersuppliesclass=prtmarkersuppliesclass, simm2=simm2, simm1_type=simm1_type, copier_print_page_count=copier_print_page_count, prtConsoleLightTable=prtConsoleLightTable, form_feed=form_feed, intrays=intrays, prtMediaPath=prtMediaPath, channel_entry=channel_entry, pjl_password=pjl_password, job_info_state=job_info_state, faxjob_tx_current_page=faxjob_tx_current_page, processing_subsystem=processing_subsystem, prtalertgroupindex=prtalertgroupindex, prtgeneralconfigchanges=prtgeneralconfigchanges, prtDeviceRefEntry=prtDeviceRefEntry, pcl_default_font_source=pcl_default_font_source, job_info_attr_14=job_info_attr_14, prtconsoledescription=prtconsoledescription, error3_code=error3_code, scan_resolution=scan_resolution, hrDevice=hrDevice, self_test=self_test, prtGeneral=prtGeneral, scan_gamma_correction=scan_gamma_correction, prtmarkeraddressabilityxfeeddir=prtmarkeraddressabilityxfeeddir, prtmarkerlifecount=prtmarkerlifecount, answer_all_lines=answer_all_lines, date_and_time=date_and_time, error7_code=error7_code, error10_code=error10_code, prtinputcapacityunit=prtinputcapacityunit, hrstoragedescr=hrstoragedescr, prtchannelstatus=prtchannelstatus, prtcoverstatus=prtcoverstatus, error9_time_stamp=error9_time_stamp, scan_compression=scan_compression, prtoutputdefaultindex=prtoutputdefaultindex, prtchannelstate=prtchannelstate, job_info_name2=job_info_name2, time_display=time_display, prtalerttraininglevel=prtalerttraininglevel, faxjob_tx_duration=faxjob_tx_duration, job_info_attr_1=job_info_attr_1, prtchanneldefaultpagedesclangindex=prtchanneldefaultpagedesclangindex, fax_line_interface_unit_id=fax_line_interface_unit_id, prtinputstatus=prtinputstatus, prtmarkermarktech=prtmarkermarktech, device_ring_type_pickup=device_ring_type_pickup, job_info_size=job_info_size, model_name=model_name, prtmarkersupplieslevel=prtmarkersupplieslevel, fax_allow_redials=fax_allow_redials, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertEntry=prtAlertEntry, prtinterpreterdefaultorientation=prtinterpreterdefaultorientation, prtoutputcapacityunit=prtoutputcapacityunit, ui_delete_option=ui_delete_option, prtStorageRefEntry=prtStorageRefEntry, default_vertical_black_resolution=default_vertical_black_resolution, job_info_attr_10=job_info_attr_10, error8_code=error8_code, hrprinterstatus=hrprinterstatus, hrStorageTable=hrStorageTable, channel_jobs_received=channel_jobs_received, print_engine=print_engine, faxjob_rx_duration_1=faxjob_rx_duration_1, prtmediapathmaxmediaxfeeddir=prtmediapathmaxmediaxfeeddir, prtLocalizationEntry=prtLocalizationEntry, prtinputmodel=prtinputmodel, copier_contrast=copier_contrast, fax_forwarding=fax_forwarding, job_being_parsed=job_being_parsed, prtconsolelocalization=prtconsolelocalization, prtmediapathmaxspeedprintunit=prtmediapathmaxspeedprintunit, hrPrinterEntry=hrPrinterEntry, collated_originals_support=collated_originals_support, prtchannelcurrentjobcntllangindex=prtchannelcurrentjobcntllangindex, pcl_default_font_number=pcl_default_font_number, prtCoverEntry=prtCoverEntry, answer=answer, prtChannel=prtChannel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMarkerEntry=prtMarkerEntry, copier_job_reduction=copier_job_reduction, prtgeneralserialnumber=prtgeneralserialnumber, prtinputvendorname=prtinputvendorname, imaging=imaging, service_password=service_password, fax_download=fax_download, faxjob=faxjob, prtMarkerSupplies=prtMarkerSupplies, prtconsolenumberofdisplaylines=prtconsolenumberofdisplaylines, scanner_motor_control=scanner_motor_control, error4=error4, dark_courier=dark_courier, job_info_attr_4=job_info_attr_4, fax_dial_mode=fax_dial_mode, prtInterpreter=prtInterpreter, copier_job_quality=copier_job_quality, simm1=simm1, simm2_type=simm2_type, error10=error10, prtalertseveritylevel=prtalertseveritylevel, device_cfg_param_command=device_cfg_param_command, serial_number=serial_number, fax_alarm_volume=fax_alarm_volume, print_density=print_density, prtoutputmaxcapacity=prtoutputmaxcapacity, job_info_attr_11=job_info_attr_11, device_location=device_location, copier_adf_page_count=copier_adf_page_count, phone=phone, custom_paper_xfeed_dim=custom_paper_xfeed_dim, simm1_capacity=simm1_capacity, fax_num_rings_pickup=fax_num_rings_pickup, status_system=status_system, fax_report_activity_log=fax_report_activity_log, prtGeneralEntry=prtGeneralEntry, prtLocalizationTable=prtLocalizationTable, job_info_attr_2=job_info_attr_2)
