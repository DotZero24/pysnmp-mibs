...
IpSlaReactVar, IpSlaOperType = mibBuilder.importSymbols("CISCO-IPSLA-TC-MIB", "IpSlaReactVar", "IpSlaOperType")
...
mibBuilder.exportSymbols("CISCO-IPSLA-AUTOMEASURE-MIB", cipslaReactThresholdCountY=cipslaReactThresholdCountY, cipslaReactTable=cipslaReactTable, cipslaAutoGroupEntry=cipslaAutoGroupEntry, cipslaAutoGroupDestIpAddrType=cipslaAutoGroupDestIpAddrType, ciscoIpSlaAutoGroupReactGroup=ciscoIpSlaAutoGroupReactGroup, cipslaAutoGroupDestEntry=cipslaAutoGroupDestEntry, ciscoIpSlaAutoMIBCompliance=ciscoIpSlaAutoMIBCompliance, cipslaAutoGroupSchedMinInterval=cipslaAutoGroupSchedMinInterval, cipslaAutoGroupSchedStorageType=cipslaAutoGroupSchedStorageType, cipslaAutoGroupName=cipslaAutoGroupName, cipslaAutoGroupOperTemplateName=cipslaAutoGroupOperTemplateName, cipslaAutoGroupDestTable=cipslaAutoGroupDestTable, cipslaAutoGroupSchedMaxInterval=cipslaAutoGroupSchedMaxInterval, cipslaReactThresholdCountX=cipslaReactThresholdCountX, cipslaAutoGroupDestName=cipslaAutoGroupDestName, cipslaReactRowStatus=cipslaReactRowStatus, cipslaAutoGroupDestRowStatus=cipslaAutoGroupDestRowStatus, cipslaAutoGroupADDestIPAgeout=cipslaAutoGroupADDestIPAgeout, cipslaReactThresholdFalling=cipslaReactThresholdFalling, ciscoIpSlaAutoMIBObjects=ciscoIpSlaAutoMIBObjects, cipslaReactThresholdRising=cipslaReactThresholdRising, cipslaAutoGroupStorageType=cipslaAutoGroupStorageType, cipslaAutoGroupSchedLife=cipslaAutoGroupSchedLife, cipslaReactThresholdType=cipslaReactThresholdType, cipslaAutoGroupDestIpAddr=cipslaAutoGroupDestIpAddr, ciscoIpSlaAutoMIBConform=ciscoIpSlaAutoMIBConform, cipslaReactActionType=cipslaReactActionType, cipslaReactStorageType=cipslaReactStorageType, cipslaReactConfigIndex=cipslaReactConfigIndex, ciscoIpSlaAutoGroupConfGroup=ciscoIpSlaAutoGroupConfGroup, PYSNMP_MODULE_ID=ciscoIpSlaAutoMIB, cipslaAutoGroupDestinationName=cipslaAutoGroupDestinationName, cipslaReactVar=cipslaReactVar, cipslaReactEntry=cipslaReactEntry, cipslaAutoGroupDescription=cipslaAutoGroupDescription, cipslaAutoGroupDestIPADEnable=cipslaAutoGroupDestIPADEnable, cipslaAutoGroupQoSEnable=cipslaAutoGroupQoSEnable, ciscoIpSlaAutoMIB=ciscoIpSlaAutoMIB, cipslaAutoGroupSchedEntry=cipslaAutoGroupSchedEntry, cipslaAutoGroupADDestPort=cipslaAutoGroupADDestPort, cipslaAutoGroupSchedPeriod=cipslaAutoGroupSchedPeriod, cipslaAutoGroupSchedTable=cipslaAutoGroupSchedTable, cipslaAutoGroupSchedRowStatus=cipslaAutoGroupSchedRowStatus, ciscoIpSlaAutoMIBCompliances=ciscoIpSlaAutoMIBCompliances, cipslaAutoGroupADMeasureRetry=cipslaAutoGroupADMeasureRetry, cipslaAutoGroupOperType=cipslaAutoGroupOperType, cipslaAutoGroupRowStatus=cipslaAutoGroupRowStatus, cipslaAutoGroupTable=cipslaAutoGroupTable, ciscoIpSlaAutoMIBNotifs=ciscoIpSlaAutoMIBNotifs, cipslaAutoGroupDestStorageType=cipslaAutoGroupDestStorageType, cipslaAutoGroupSchedStartTime=cipslaAutoGroupSchedStartTime, cipslaAutoGroupSchedId=cipslaAutoGroupSchedId, ciscoIpSlaAutoGroupSchedGroup=ciscoIpSlaAutoGroupSchedGroup, ciscoIpSlaAutoMIBGroups=ciscoIpSlaAutoMIBGroups, ciscoIpSlaAutoGroupDestGroup=ciscoIpSlaAutoGroupDestGroup, cipslaAutoGroupSchedAgeout=cipslaAutoGroupSchedAgeout, cipslaAutoGroupSchedulerId=cipslaAutoGroupSchedulerId, cipslaAutoGroupSchedInterval=cipslaAutoGroupSchedInterval, cipslaAutoGroupDestPort=cipslaAutoGroupDestPort)
