# SNMP MIB module (ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB
...
mirrorEntry.setIndexNames(
    (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"),
)
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    mirrorMirroringIfindex.setStatus("deprecated")
...
mirrorSrcEntry.setIndexNames(
    (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"),
    (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcMirroredIf"),
)
if mibBuilder.loadTexts:
...
mirrorDstTable = _MirrorDstTable_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 1, 3)
)
if mibBuilder.loadTexts:
    mirrorDstTable.setStatus("current")
_MirrorDstEntry_Object = MibTableRow
mirrorDstEntry = _MirrorDstEntry_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 1, 3, 1)
)
mirrorDstEntry.setIndexNames(
    (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"),
    (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDstMirroringIf"),
)
if mibBuilder.loadTexts:
    mirrorDstEntry.setStatus("current")
_MirrorDstMirroringIf_Type = InterfaceIndex
_MirrorDstMirroringIf_Object = MibTableColumn
mirrorDstMirroringIf = _MirrorDstMirroringIf_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 1, 3, 1, 1),
    _MirrorDstMirroringIf_Type()
)
mirrorDstMirroringIf.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    mirrorDstMirroringIf.setStatus("current")


class _MirrorDstOperStatus_Type(Integer32):
    """Custom type mirrorDstOperStatus based on Integer32"""
    defaultValue = 2
...
_MirrorDstOperStatus_Type.__name__ = "Integer32"
_MirrorDstOperStatus_Object = MibTableColumn
mirrorDstOperStatus = _MirrorDstOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 1, 3, 1, 2),
    _MirrorDstOperStatus_Type()
)
mirrorDstOperStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mirrorDstOperStatus.setStatus("current")


class _MirrorDstAdminStatus_Type(Integer32):
    """Custom type mirrorDstAdminStatus based on Integer32"""
    defaultValue = 2
...
_MirrorDstAdminStatus_Type.__name__ = "Integer32"
_MirrorDstAdminStatus_Object = MibTableColumn
mirrorDstAdminStatus = _MirrorDstAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 1, 3, 1, 3),
    _MirrorDstAdminStatus_Type()
)
mirrorDstAdminStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    mirrorDstAdminStatus.setStatus("current")
_MirrorDstRowStatus_Type = RowStatus
_MirrorDstRowStatus_Object = MibTableColumn
mirrorDstRowStatus = _MirrorDstRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 1, 3, 1, 4),
    _MirrorDstRowStatus_Type()
)
mirrorDstRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    mirrorDstRowStatus.setStatus("current")
...
monitorEntry.setIndexNames(
    (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSessionNumber"),
)
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    monitorIfindex.setStatus("deprecated")
...
monitorSrcTable = _MonitorSrcTable_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 2, 2)
)
if mibBuilder.loadTexts:
    monitorSrcTable.setStatus("current")
_MonitorSrcEntry_Object = MibTableRow
monitorSrcEntry = _MonitorSrcEntry_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 2, 2, 1)
)
monitorSrcEntry.setIndexNames(
    (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSessionNumber"),
    (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSrcIfindex"),
)
if mibBuilder.loadTexts:
    monitorSrcEntry.setStatus("current")
_MonitorSrcIfindex_Type = InterfaceIndex
_MonitorSrcIfindex_Object = MibTableColumn
monitorSrcIfindex = _MonitorSrcIfindex_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 2, 2, 1, 1),
    _MonitorSrcIfindex_Type()
)
monitorSrcIfindex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    monitorSrcIfindex.setStatus("current")


class _MonitorSrcStatus_Type(Integer32):
    """Custom type monitorSrcStatus based on Integer32"""
    defaultValue = 1
...
_MonitorSrcStatus_Type.__name__ = "Integer32"
_MonitorSrcStatus_Object = MibTableColumn
monitorSrcStatus = _MonitorSrcStatus_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 2, 2, 1, 2),
    _MonitorSrcStatus_Type()
)
monitorSrcStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    monitorSrcStatus.setStatus("current")


class _MonitorSrcDirection_Type(Integer32):
    """Custom type monitorSrcDirection based on Integer32"""
    defaultValue = 3
...
_MonitorSrcDirection_Type.__name__ = "Integer32"
_MonitorSrcDirection_Object = MibTableColumn
monitorSrcDirection = _MonitorSrcDirection_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 2, 2, 1, 3),
    _MonitorSrcDirection_Type()
)
monitorSrcDirection.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    monitorSrcDirection.setStatus("current")
_MonitorSrcRowStatus_Type = RowStatus
_MonitorSrcRowStatus_Object = MibTableColumn
monitorSrcRowStatus = _MonitorSrcRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 2, 2, 1, 4),
    _MonitorSrcRowStatus_Type()
)
monitorSrcRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    monitorSrcRowStatus.setStatus("current")
...
sFlowFsEntry.registerAugmentions(
    ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB",
     "alasFlowFsEntry")
)
...
portMirroringGroup.setObjects(
      *(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorMirroredIfindex"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorMirroringIfindex"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorUnblockedVLAN"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorRowStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDirection"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessOperStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcMirroredIf"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcDirection"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcRowStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcOperStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDstOperStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDstAdminStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDstRowStatus"))
)
if mibBuilder.loadTexts:
...
portMonitoringGroup.setObjects(
      *(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSessionNumber"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorIfindex"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileName"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileSize"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorScreenStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorScreenLine"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorTrafficType"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileOverWrite"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorDirection"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorTimeout"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorRowStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorCaptureType"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSrcStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSrcDirection"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSrcRowStatus"))
)
if mibBuilder.loadTexts:
...
portNotificationVarsGroup.setObjects(
      *(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimarySlot"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimaryPort"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirroringSlot"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirroringPort"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirMonSession"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirMonError"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirMonErrorNi"))
)
if mibBuilder.loadTexts:
...
sFlowAgentGroup.setObjects(
      *(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowAgentAddress"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowAgentAddressType"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowAgentConfigType"))
)
if mibBuilder.loadTexts:
...
portMirrorGroup.setObjects(
      *(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"),
        ...
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDirection"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessOperStatus"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorTaggedVLAN"))
)
if mibBuilder.loadTexts:
...
portSFlowCpGroup.setObjects(
    ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowCpDeleteEntry")
)
if mibBuilder.loadTexts:
...
portSFlowFsGroup.setObjects(
    ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowFsDeleteEntry")
)
if mibBuilder.loadTexts:
...
mirmonTrapsGroup.setObjects(
      *(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorConfigError"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorUnlikeNi"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileWritten"))
)
if mibBuilder.loadTexts:
...
alcatelIND1PortMirMonMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "portMirroringGroup"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "portMonitoringGroup"),
        ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "portNotificationVarsGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"MirMonErrorIds": MirMonErrorIds,
       ...
       "mirrorDstTable": mirrorDstTable,
       "mirrorDstEntry": mirrorDstEntry,
       "mirrorDstMirroringIf": mirrorDstMirroringIf,
       "mirrorDstOperStatus": mirrorDstOperStatus,
       ...
       "monitorSrcTable": monitorSrcTable,
       "monitorSrcEntry": monitorSrcEntry,
       "monitorSrcIfindex": monitorSrcIfindex,
       "monitorSrcStatus": monitorSrcStatus,
       "monitorSrcDirection": monitorSrcDirection,
       "monitorSrcRowStatus": monitorSrcRowStatus,
