#
# PySNMP MIB module ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB
...
mirrorEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 1, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"))
...
mirrorSrcEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 1, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"), (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcMirroredIf"))
...
mirrorDstEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 1, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"), (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDstMirroringIf"))
...
monitorEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 2, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSessionNumber"))
...
monitorSrcEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 1, 2, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSessionNumber"), (0, "ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSrcIfindex"))
...
mirrorConfigError = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 0, 1)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimarySlot"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimaryPort"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirroringSlot"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirroringPort"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirMonErrorNi"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirMonError"))
if mibBuilder.loadTexts: mirrorConfigError.setStatus('current')
monitorFileWritten = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 0, 2)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimarySlot"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimaryPort"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileName"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileSize"))
if mibBuilder.loadTexts: monitorFileWritten.setStatus('current')
mirrorUnlikeNi = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 0, 3)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimarySlot"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimaryPort"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirroringSlot"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirroringPort"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirMonErrorNi"))
...
sFlowFsEntry.registerAugmentions(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowFsEntry"))
...
sFlowCpEntry.registerAugmentions(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowCpEntry"))
...
alcatelIND1PortMirMonMIBCompliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 2, 2, 1)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "portMirroringGroup"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "portMonitoringGroup"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "portNotificationVarsGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alcatelIND1PortMirMonMIBCompliance = alcatelIND1PortMirMonMIBCompliance.setStatus('current')
portMirroringGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 2, 1, 1)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorMirroredIfindex"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorMirroringIfindex"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorUnblockedVLAN"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorRowStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDirection"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessOperStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcMirroredIf"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcDirection"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcRowStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSrcOperStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDstOperStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDstAdminStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDstRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    portMirroringGroup = portMirroringGroup.setStatus('current')
portMonitoringGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 2, 1, 2)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSessionNumber"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorIfindex"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileName"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileSize"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorScreenStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorScreenLine"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorTrafficType"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileOverWrite"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorDirection"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorTimeout"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorRowStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorCaptureType"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSrcStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSrcDirection"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorSrcRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    portMonitoringGroup = portMonitoringGroup.setStatus('current')
portNotificationVarsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 2, 1, 3)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimarySlot"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirmonPrimaryPort"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirroringSlot"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirroringPort"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirMonSession"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirMonError"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirMonErrorNi"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    portNotificationVarsGroup = portNotificationVarsGroup.setStatus('current')
mirmonTrapsGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 2, 1, 4)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorConfigError"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorUnlikeNi"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "monitorFileWritten"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    mirmonTrapsGroup = mirmonTrapsGroup.setStatus('current')
sFlowAgentGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 2, 1, 5)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowAgentAddress"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowAgentAddressType"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowAgentConfigType"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    sFlowAgentGroup = sFlowAgentGroup.setStatus('current')
portMirrorGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 2, 1, 6)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessionNumber"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorMirroredIfindex"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorMirroringIfindex"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorUnblockedVLAN"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorRowStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorDirection"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorSessOperStatus"), ("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "mirrorTaggedVLAN"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    portMirrorGroup = portMirrorGroup.setStatus('current')
portSFlowCpGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 2, 1, 7)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowCpDeleteEntry"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    portSFlowCpGroup = portSFlowCpGroup.setStatus('current')
portSFlowFsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 19, 1, 2, 1, 8)).setObjects(("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", "alasFlowFsDeleteEntry"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    portSFlowFsGroup = portSFlowFsGroup.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-PORT-MIRRORING-MONITORING-MIB", sFlowAgentGroup=sFlowAgentGroup, monitorStatus=monitorStatus, mirrorTable=mirrorTable, mirrorMirroredIfindex=mirrorMirroredIfindex, mirrorDstAdminStatus=mirrorDstAdminStatus, mirrorConfigError=mirrorConfigError, alcatelIND1PortMirMonMIBNotifications=alcatelIND1PortMirMonMIBNotifications, monitorSessionNumber=monitorSessionNumber, mirmonPrimaryPort=mirmonPrimaryPort, monitorCaptureType=monitorCaptureType, alcatelIND1PortMirMonMIBCompliance=alcatelIND1PortMirMonMIBCompliance, alasFlowFsDeleteEntry=alasFlowFsDeleteEntry, mirmonNotificationVars=mirmonNotificationVars, mirrorDstOperStatus=mirrorDstOperStatus, mirmonPrimarySlot=mirmonPrimarySlot, alasFlowFsEntry=alasFlowFsEntry, portNotificationVarsGroup=portNotificationVarsGroup, monitorTrafficType=monitorTrafficType, MirMonErrorIds=MirMonErrorIds, monitorTable=monitorTable, mirroringSlot=mirroringSlot, mirrorSrcEntry=mirrorSrcEntry, monitorFileWritten=monitorFileWritten, monitorDirection=monitorDirection, PYSNMP_MODULE_ID=alcatelIND1PortMirrorMonitoringMIB, mirrorStatus=mirrorStatus, mirmonMonitoring=mirmonMonitoring, mirrorSessOperStatus=mirrorSessOperStatus, alasFlowFsTable=alasFlowFsTable, mirmonSFlowObjects=mirmonSFlowObjects, monitorRowStatus=monitorRowStatus, alcatelIND1PortMirrorMonitoringMIB=alcatelIND1PortMirrorMonitoringMIB, monitorSrcTable=monitorSrcTable, mirMonError=mirMonError, mirrorSrcMirroredIf=mirrorSrcMirroredIf, mirrorSrcTable=mirrorSrcTable, portMirrorGroup=portMirrorGroup, mirrorSessionNumber=mirrorSessionNumber, monitorSrcRowStatus=monitorSrcRowStatus, alcatelIND1PortMirMonMIBConformance=alcatelIND1PortMirMonMIBConformance, monitorFileSize=monitorFileSize, alasFlowCpTable=alasFlowCpTable, alcatelIND1PortMirMonMIBObjects=alcatelIND1PortMirMonMIBObjects, mirmonMirroring=mirmonMirroring, mirmonTrapsGroup=mirmonTrapsGroup, mirrorDstRowStatus=mirrorDstRowStatus, alasFlowAgentAddressType=alasFlowAgentAddressType, mirrorDstTable=mirrorDstTable, alcatelIND1PortMirMonMIBCompliances=alcatelIND1PortMirMonMIBCompliances, mirrorSrcRowStatus=mirrorSrcRowStatus, mirMonSession=mirMonSession, mirrorRowStatus=mirrorRowStatus, monitorFileName=monitorFileName, mirrorSrcOperStatus=mirrorSrcOperStatus, mirrorMirroringIfindex=mirrorMirroringIfindex, mirrorSrcStatus=mirrorSrcStatus, portSFlowFsGroup=portSFlowFsGroup, mirrorUnblockedVLAN=mirrorUnblockedVLAN, monitorFileOverWrite=monitorFileOverWrite, alcatelIND1PortMirMonMIBGroups=alcatelIND1PortMirMonMIBGroups, monitorIfindex=monitorIfindex, monitorSrcIfindex=monitorSrcIfindex, monitorScreenStatus=monitorScreenStatus, alasFlowAgentAddress=alasFlowAgentAddress, portMirroringGroup=portMirroringGroup, mirrorTaggedVLAN=mirrorTaggedVLAN, mirrorEntry=mirrorEntry, portMonitoringGroup=portMonitoringGroup, monitorSrcStatus=monitorSrcStatus, alasFlowAgentConfigType=alasFlowAgentConfigType, monitorScreenLine=monitorScreenLine, mirrorUnlikeNi=mirrorUnlikeNi, monitorEntry=monitorEntry, monitorTimeout=monitorTimeout, mirrorSrcDirection=mirrorSrcDirection, monitorSrcDirection=monitorSrcDirection, alasFlowCpDeleteEntry=alasFlowCpDeleteEntry, monitorSrcEntry=monitorSrcEntry, mirrorDirection=mirrorDirection, monitorFileStatus=monitorFileStatus, portSFlowCpGroup=portSFlowCpGroup, alasFlowCpEntry=alasFlowCpEntry, mirrorDstEntry=mirrorDstEntry, mirMonErrorNi=mirMonErrorNi, mirrorDstMirroringIf=mirrorDstMirroringIf, mirroringPort=mirroringPort)
