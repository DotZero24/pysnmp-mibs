...
# Notes
# -----
# ASN.1 source file://mibs/rfc/VPLS-BGP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:24:49 2025
...
vplsBgpModuleFullCompliance.setObjects(
      *(("VPLS-BGP-MIB", "vplsBgpConfigGroup"),
        ("VPLS-BGP-MIB", "vplsBgpVEGroup"),
        ("VPLS-BGP-MIB", "vplsBgpPwBindGroup"))
)
if mibBuilder.loadTexts:
