#
# PySNMP MIB module ALCATEL-ENT1-TIMETRA-CHASSIS-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-TIMETRA-CHASSIS-MIB
...
TmnxAdminState, TmnxActionType, TmnxPortID, TNamedItem, TItemDescription, TmnxOperState, TNamedItemOrEmpty = mibBuilder.importSymbols("ALCATEL-ENT1-TIMETRA-TC-MIB", "TmnxAdminState", "TmnxActionType", "TmnxPortID", "TNamedItem", "TItemDescription", "TmnxOperState", "TNamedItemOrEmpty")
...
tmnxChassisEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 1, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"))
...
tmnxChassisFanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 1, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisFanIndex"))
...
tmnxChassisPowerSupplyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 1, 5, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyId"))
...
tmnxChassisTypeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 1, 6, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisTypeIndex"))
...
tmnxHwEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 1, 8, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwIndex"))
...
tmnxHwContainsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 1, 9, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwContainedIndex"))
...
tmnxCcmEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 1, 10, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcmIndex"))
...
tmnxCcmTypeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 1, 11, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcmTypeIndex"))
...
tmnxCardEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardSlotNum"))
...
tmnxCpmCardEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardSlotNum"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardNum"))
...
tmnxFabricEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 6, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxFabricSlotNum"))
...
tmnxCpmFlashEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 7, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardSlotNum"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmFlashId"))
...
tmnxMDAEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 8, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardSlotNum"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDASlotNum"))
...
tmnxCardTypeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 9, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardTypeIndex"))
...
tmnxMdaTypeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 10, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMdaTypeIndex"))
...
tmnxCpmCardEntry.registerAugmentions(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingEntry"))
...
tSyncIfTimingAdmEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 8, 2, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardSlotNum"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardNum"))
...
tmnxCcagEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 12, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagId"))
...
tmnxCcagPathEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 13, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagId"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathId"))
...
tmnxCcagPathCcEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 14, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagId"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathId"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcType"))
...
tmnxMcmEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 15, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisIndex"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardSlotNum"), (0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMcmSlotNum"))
...
tmnxMcmTypeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 2, 3, 16, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMcmTypeIndex"))
...
tmnxHwConfigChange = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 1)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxHwConfigChange.setStatus('obsolete')
tmnxEnvTempTooHigh = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 2)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwTemperature"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwTempThreshold"))
if mibBuilder.loadTexts: tmnxEnvTempTooHigh.setStatus('current')
tmnxEqPowerSupplyFailure = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 3)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyACStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyDCStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyTempStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyTempThreshold"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupply1Status"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupply2Status"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyInputStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyOutputStatus"))
if mibBuilder.loadTexts: tmnxEqPowerSupplyFailure.setStatus('current')
tmnxEqPowerSupplyInserted = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 4)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxEqPowerSupplyInserted.setStatus('current')
tmnxEqPowerSupplyRemoved = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 5)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxEqPowerSupplyRemoved.setStatus('current')
tmnxEqFanFailure = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 6)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisFanOperStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisFanSpeed"))
if mibBuilder.loadTexts: tmnxEqFanFailure.setStatus('current')
tmnxEqCardFailure = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 7)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwOperState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyCardFailureReason"))
if mibBuilder.loadTexts: tmnxEqCardFailure.setStatus('current')
tmnxEqCardInserted = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 8)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyCardName"))
if mibBuilder.loadTexts: tmnxEqCardInserted.setStatus('current')
tmnxEqCardRemoved = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 9)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyCardName"))
if mibBuilder.loadTexts: tmnxEqCardRemoved.setStatus('current')
tmnxEqWrongCard = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 10)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxEqWrongCard.setStatus('current')
tmnxEqCpuFailure = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 11)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxEqCpuFailure.setStatus('obsolete')
tmnxEqMemoryFailure = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 12)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxEqMemoryFailure.setStatus('obsolete')
tmnxEqBackdoorBusFailure = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 13)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyChassisId"))
if mibBuilder.loadTexts: tmnxEqBackdoorBusFailure.setStatus('obsolete')
tmnxPeSoftwareError = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 14)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxPeSoftwareError.setStatus('obsolete')
tmnxPeSoftwareAbnormalHalt = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 15)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxPeSoftwareAbnormalHalt.setStatus('obsolete')
tmnxPeSoftwareVersionMismatch = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 16)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyMismatchedVer"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSoftwareCodeVersion"))
if mibBuilder.loadTexts: tmnxPeSoftwareVersionMismatch.setStatus('current')
tmnxPeOutOfMemory = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 17)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxPeOutOfMemory.setStatus('obsolete')
tmnxPeConfigurationError = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 18)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxPeConfigurationError.setStatus('obsolete')
tmnxPeStorageProblem = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 19)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxPeStorageProblem.setStatus('obsolete')
tmnxPeCpuCyclesExceeded = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 20)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxPeCpuCyclesExceeded.setStatus('obsolete')
tmnxRedPrimaryCPMFail = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 21)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxRedPrimaryCPMFail.setStatus('current')
tmnxRedSecondaryCPMStatusChange = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 22)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxRedSecondaryCPMStatus"))
if mibBuilder.loadTexts: tmnxRedSecondaryCPMStatusChange.setStatus('obsolete')
tmnxRedRestoreSuccess = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 23)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxRedRestoreSuccess.setStatus('obsolete')
tmnxRedRestoreFail = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 24)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxRedRestoreFail.setStatus('obsolete')
tmnxChassisNotificationClear = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 25)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyOID"))
if mibBuilder.loadTexts: tmnxChassisNotificationClear.setStatus('current')
tmnxEqSyncIfTimingHoldover = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 26)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxEqSyncIfTimingHoldover.setStatus('current')
tmnxEqSyncIfTimingHoldoverClear = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 27)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxEqSyncIfTimingHoldoverClear.setStatus('current')
tmnxEqSyncIfTimingRef1Alarm = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 28)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingNotifyAlarm"))
if mibBuilder.loadTexts: tmnxEqSyncIfTimingRef1Alarm.setStatus('current')
tmnxEqSyncIfTimingRef1AlarmClear = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 29)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingNotifyAlarm"))
if mibBuilder.loadTexts: tmnxEqSyncIfTimingRef1AlarmClear.setStatus('current')
tmnxEqSyncIfTimingRef2Alarm = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 30)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingNotifyAlarm"))
if mibBuilder.loadTexts: tmnxEqSyncIfTimingRef2Alarm.setStatus('current')
tmnxEqSyncIfTimingRef2AlarmClear = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 31)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingNotifyAlarm"))
if mibBuilder.loadTexts: tmnxEqSyncIfTimingRef2AlarmClear.setStatus('current')
tmnxEqFlashDataLoss = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 32)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwOperState"))
if mibBuilder.loadTexts: tmnxEqFlashDataLoss.setStatus('current')
tmnxEqFlashDiskFull = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 33)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwOperState"))
if mibBuilder.loadTexts: tmnxEqFlashDiskFull.setStatus('current')
tmnxPeSoftwareLoadFailed = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 34)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifySoftwareLocation"))
if mibBuilder.loadTexts: tmnxPeSoftwareLoadFailed.setStatus('current')
tmnxPeBootloaderVersionMismatch = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 35)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyMismatchedVer"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSoftwareCodeVersion"))
if mibBuilder.loadTexts: tmnxPeBootloaderVersionMismatch.setStatus('current')
tmnxPeBootromVersionMismatch = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 36)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyMismatchedVer"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSoftwareCodeVersion"))
if mibBuilder.loadTexts: tmnxPeBootromVersionMismatch.setStatus('current')
tmnxPeFPGAVersionMismatch = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 37)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyMismatchedVer"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSoftwareCodeVersion"))
if mibBuilder.loadTexts: tmnxPeFPGAVersionMismatch.setStatus('current')
tmnxEqSyncIfTimingBITSAlarm = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 38)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingNotifyAlarm"))
if mibBuilder.loadTexts: tmnxEqSyncIfTimingBITSAlarm.setStatus('current')
tmnxEqSyncIfTimingBITSAlarmClear = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 39)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingNotifyAlarm"))
if mibBuilder.loadTexts: tmnxEqSyncIfTimingBITSAlarmClear.setStatus('current')
tmnxEqCardFirmwareUpgraded = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 40)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxEqCardFirmwareUpgraded.setStatus('current')
tmnxChassisUpgradeInProgress = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 41)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxChassisUpgradeInProgress.setStatus('current')
tmnxChassisUpgradeComplete = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 42)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxChassisUpgradeComplete.setStatus('current')
tmnxChassisHiBwMcastAlarm = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 43)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
if mibBuilder.loadTexts: tmnxChassisHiBwMcastAlarm.setStatus('current')
tmnxEqMdaCfgNotCompatible = NotificationType((1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 2, 1, 0, 44)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"))
...
tmnxChassisV4v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 1, 4)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAV4v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationV4v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisV4v0Compliance = tmnxChassisV4v0Compliance.setStatus('obsolete')
tmnxChassisV5v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 1, 6)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisV5v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAV4v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationV4v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisV5v0Compliance = tmnxChassisV5v0Compliance.setStatus('obsolete')
tmnxChassis7750V6v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 1, 7)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisV5v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAV4v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationV6v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnx77x0CESMDAV6v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV6v0NamedPoolPlcyGroup"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtV6v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassis7750V6v0Compliance = tmnxChassis7750V6v0Compliance.setStatus('current')
tmnxChassis7450V6v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 1, 8)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisV5v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAV4v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV6v0NamedPoolPlcyGroup"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationV6v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtV6v0Group"))
...
tmnxChassisComp7710V3v0 = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 1, 5, 1)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnx7710HwV3v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisComp7710V3v0 = tmnxChassisComp7710V3v0.setStatus('obsolete')
tmnxChassisComp7710V5v0 = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 1, 5, 2)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisV5v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAV4v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationV4v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnx7710HwV3v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisComp7710V5v0 = tmnxChassisComp7710V5v0.setStatus('obsolete')
tmnxChassisComp7710V6v0 = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 1, 5, 3)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisV5v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAV4v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationV6v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnx7710HwV3v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnx77x0CESMDAV6v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnx7710SETSRefSrcHwV6v0Group"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardV6v0NamedPoolPlcyGroup"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtV6v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisComp7710V6v0 = tmnxChassisComp7710V6v0.setStatus('current')
tmnxChassisNotifyObjsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 4)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqNotificationRow"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqTypeNotificationRow"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyChassisId"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxRedSecondaryCPMStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyOID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingNotifyAlarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyMismatchedVer"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifySoftwareLocation"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyCardFailureReason"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisNotifyObjsGroup = tmnxChassisNotifyObjsGroup.setStatus('current')
tmnxChassisNotifyObsoleteGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 7)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwConfigChange"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCpuFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqMemoryFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqBackdoorBusFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeSoftwareError"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeSoftwareAbnormalHalt"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeOutOfMemory"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeConfigurationError"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeStorageProblem"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeCpuCyclesExceeded"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxRedSecondaryCPMStatusChange"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxRedRestoreSuccess"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxRedRestoreFail"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisNotifyObsoleteGroup = tmnxChassisNotifyObsoleteGroup.setStatus('current')
tmnxChassisV3v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 9)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisTotalNumber"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisLastChange"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisRowStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisLocation"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisCoordinates"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumSlots"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumPorts"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumPwrSupplies"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumFanTrays"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumFans"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisCriticalLEDState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisMajorLEDState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisMinorLEDState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisBaseMacAddress"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisCLLICode"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisReboot"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpgrade"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisAdminMode"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisOperMode"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisModeForce"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpdateWaitTime"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpdateTimeLeft"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisFanOperStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisFanSpeed"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyACStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyDCStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyTempStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyTempThreshold"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupply1Status"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupply2Status"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyAssignedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisTypeName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisTypeDescription"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisTypeStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwLastChange"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwMfgString"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwMfgBoardNumber"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSerialNumber"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwManufactureDate"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwAlias"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwAssetID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwCLEI"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwIsFRU"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwContainedIn"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwParentRelPos"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwAdminState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwOperState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwTempSensor"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwTemperature"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwTempThreshold"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwBootCodeVersion"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSoftwareCodeVersion"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSwLastBoot"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwAlarmState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwLastAlarmEvent"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClearAlarms"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSwImageSource"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwMfgDeviations"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwBaseMacAddress"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwFailureReason"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwContainedIndex"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisV3v0Group = tmnxChassisV3v0Group.setStatus('obsolete')
tmnxMDAV3v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 10)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDASupportedTypes"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAAssignedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAEquippedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMaxPorts"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAEquippedPorts"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDATxTimingSelected"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDASyncIfTimingStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDANetworkIngQueues"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDACapabilities"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMinChannelization"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMaxChannelization"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMaxChannels"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAChannelsInUse"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDACcagId"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMdaTypeName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMdaTypeDescription"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMdaTypeStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagRowStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagDescription"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagAdminStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagOperStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagCcaRate"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagLastChanged"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagAccessAdaptQos"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathLastChanged"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathRate"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathRateOption"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathWeight"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcLastChanged"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcEgrPoolResvCbs"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcEgrPoolSlpPlcy"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcIngPoolResvCbs"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcIngPoolSlpPlcy"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcAcctPolicyId"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcCollectStats"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcQueuePlcy"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcMac"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcMtu"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcHwMac"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcUserAssignedMac"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxMDAV3v0Group = tmnxMDAV3v0Group.setStatus('obsolete')
tmnxChassisObsoleteGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 11)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSwState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardAllowedTypes"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardAllowedTypes"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAAllowedTypes"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisObsoleteGroup = tmnxChassisObsoleteGroup.setStatus('current')
tmnxCardV3v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 12)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardLastChange"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardTypeName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardTypeDescription"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardTypeStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardSupportedTypes"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardAssignedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardEquippedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardClockSource"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardNumMdaSlots"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardNumMdas"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardReboot"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardMemorySize"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardLastChange"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardSupportedTypes"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardAssignedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardEquippedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardBootOptionVersion"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardBootOptionLastModified"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardConfigBootedVersion"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardIndexBootedVersion"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardConfigLastModified"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardConfigLastSaved"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardRedundant"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardClockSource"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardNumCpus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardCpuType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardMemorySize"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardSwitchToRedundantCard"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardReboot"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardRereadBootOptions"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardConfigFileLastBooted"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardConfigFileLastSaved"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardConfigFileLastBootedHeader"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardIndexFileLastBootedHeader"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardBootOptionSource"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardConfigSource"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardBootOptionLastSaved"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxFabricLastChange"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxFabricAssignedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxFabricEquippedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxFabricHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmFlashOperStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmFlashSerialNumber"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmFlashFirmwareRevision"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmFlashModelNumber"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmFlashCapacity"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmFlashUsed"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmFlashHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRevert"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRefOrder1"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRefOrder2"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef1SrcPort"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef1AdminStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef1InUse"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef1Qualified"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef1Alarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef2SrcPort"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef2AdminStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef2InUse"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef2Qualified"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef2Alarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingFreqOffset"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRefOrder3"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingBITSIfType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingBITSAdminStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingBITSInUse"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingBITSQualified"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingBITSAlarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRevert"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRefOrder1"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRefOrder2"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRef1SrcPort"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRef1AdminStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRef2SrcPort"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRef2AdminStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmChanged"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRefOrder3"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmBITSIfType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmBITSAdminStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisAdminOwner"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisAdminControlApply"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisAdminLastSetTimer"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisAdminLastSetTimeout"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxCardV3v0Group = tmnxCardV3v0Group.setStatus('current')
tmnxMDAV4v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 13)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDASupportedTypes"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAAssignedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAEquippedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMaxPorts"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAEquippedPorts"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDATxTimingSelected"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDASyncIfTimingStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDANetworkIngQueues"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDACapabilities"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMinChannelization"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMaxChannelization"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMaxChannels"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAChannelsInUse"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDACcagId"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMdaTypeName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMdaTypeDescription"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMdaTypeStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAReboot"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagRowStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagDescription"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagAdminStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagOperStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagCcaRate"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagLastChanged"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagAccessAdaptQos"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathLastChanged"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathRate"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathRateOption"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathWeight"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcLastChanged"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcEgrPoolResvCbs"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcEgrPoolSlpPlcy"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcIngPoolResvCbs"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcIngPoolSlpPlcy"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcAcctPolicyId"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcCollectStats"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcQueuePlcy"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcMac"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcMtu"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcHwMac"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcagPathCcUserAssignedMac"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAHiBwMcastSource"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAHiBwMcastAlarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAHiBwMcastTapCount"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAHiBwMcastGroup"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxMDAV4v0Group = tmnxMDAV4v0Group.setStatus('current')
tmnxChassisNotificationV4v0Group = NotificationGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 14)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEnvTempTooHigh"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqPowerSupplyFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqPowerSupplyInserted"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqPowerSupplyRemoved"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqFanFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardInserted"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardRemoved"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqWrongCard"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeSoftwareVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxRedPrimaryCPMFail"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingHoldover"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingHoldoverClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef1Alarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef1AlarmClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef2Alarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef2AlarmClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqFlashDataLoss"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqFlashDiskFull"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeSoftwareLoadFailed"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeBootloaderVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeBootromVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeFPGAVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingBITSAlarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingBITSAlarmClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardFirmwareUpgraded"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpgradeInProgress"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpgradeComplete"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisHiBwMcastAlarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqMdaCfgNotCompatible"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisNotificationV4v0Group = tmnxChassisNotificationV4v0Group.setStatus('obsolete')
tmnx7710HwV3v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 15)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisOverTempState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCpmCardMasterSlaveRefState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcmOperStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcmHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcmEquippedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcmTypeName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcmTypeDescription"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCcmTypeStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMcmSupportedTypes"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMcmAssignedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMcmEquippedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMcmHwIndex"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMcmTypeName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMcmTypeDescription"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMcmTypeStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyInputStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyOutputStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAReboot"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnx7710HwV3v0Group = tmnx7710HwV3v0Group.setStatus('current')
tmnxChassisV5v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 16)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisTotalNumber"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisLastChange"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisRowStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisLocation"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisCoordinates"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumSlots"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumPorts"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumPwrSupplies"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumFanTrays"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNumFans"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisCriticalLEDState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisMajorLEDState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisMinorLEDState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisBaseMacAddress"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisCLLICode"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisReboot"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpgrade"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisAdminMode"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisOperMode"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisModeForce"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpdateTimeLeft"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisFanOperStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisFanSpeed"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyACStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyDCStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyTempStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyTempThreshold"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupply1Status"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupply2Status"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisPowerSupplyAssignedType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisTypeName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisTypeDescription"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisTypeStatus"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwLastChange"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwMfgString"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwMfgBoardNumber"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSerialNumber"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwManufactureDate"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClass"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwAlias"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwAssetID"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwCLEI"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwIsFRU"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwContainedIn"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwParentRelPos"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwAdminState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwOperState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwTempSensor"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwTemperature"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwTempThreshold"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwBootCodeVersion"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSoftwareCodeVersion"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSwLastBoot"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwAlarmState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwLastAlarmEvent"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwClearAlarms"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwSwImageSource"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwMfgDeviations"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwBaseMacAddress"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwFailureReason"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxHwContainedIndex"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisV5v0Group = tmnxChassisV5v0Group.setStatus('current')
tmnxChassisV5v0ObsoleteGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 17)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpdateWaitTime"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisV5v0ObsoleteGroup = tmnxChassisV5v0ObsoleteGroup.setStatus('current')
tmnx77x0CESMDAV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 18)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAClockMode"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDADiffTimestampFreq"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAIngNamedPoolPolicy"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAEgrNamedPoolPolicy"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnx77x0CESMDAV6v0Group = tmnx77x0CESMDAV6v0Group.setStatus('current')
tmnxChassisNotificationV3v0Group = NotificationGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 20)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEnvTempTooHigh"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqPowerSupplyFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqPowerSupplyInserted"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqPowerSupplyRemoved"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqFanFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardInserted"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardRemoved"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqWrongCard"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeSoftwareVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxRedPrimaryCPMFail"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingHoldover"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingHoldoverClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef1Alarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef1AlarmClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef2Alarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef2AlarmClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqFlashDataLoss"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqFlashDiskFull"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeSoftwareLoadFailed"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeBootloaderVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeBootromVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeFPGAVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingBITSAlarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingBITSAlarmClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardFirmwareUpgraded"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqMdaCfgNotCompatible"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisNotificationV3v0Group = tmnxChassisNotificationV3v0Group.setStatus('obsolete')
tmnxChassisNotificationV6v0Group = NotificationGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 21)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEnvTempTooHigh"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqPowerSupplyFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqPowerSupplyInserted"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqPowerSupplyRemoved"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqFanFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardFailure"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardInserted"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardRemoved"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqWrongCard"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeSoftwareVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxRedPrimaryCPMFail"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotificationClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingHoldover"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingHoldoverClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef1Alarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef1AlarmClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef2Alarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingRef2AlarmClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqFlashDataLoss"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqFlashDiskFull"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeSoftwareLoadFailed"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeBootloaderVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeBootromVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxPeFPGAVersionMismatch"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingBITSAlarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqSyncIfTimingBITSAlarmClear"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqCardFirmwareUpgraded"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpgradeInProgress"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisUpgradeComplete"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisHiBwMcastAlarm"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxEqMdaCfgNotCompatible"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisNotificationV6v0Group = tmnxChassisNotificationV6v0Group.setStatus('current')
tmnx7710SETSRefSrcHwV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 22)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef1SrcHw"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef1BITSIfType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef2SrcHw"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxSyncIfTimingRef2BITSIfType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRef1SrcHw"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRef1BITSIfType"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRef2SrcHw"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tSyncIfTimingAdmRef2BITSIfType"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnx7710SETSRefSrcHwV6v0Group = tmnx7710SETSRefSrcHwV6v0Group.setStatus('current')
tmnxMDAMcPathMgmtV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 24)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtBwPlcyName"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtPriPathLimit"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtSecPathLimit"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtAncPathLimit"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtAdminState"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtPriInUseBw"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtSecInUseBw"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtAncInUseBw"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxMDAMcPathMgmtBlkHoleInUseBw"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxMDAMcPathMgmtV6v0Group = tmnxMDAMcPathMgmtV6v0Group.setStatus('current')
tmnxCardV6v0NamedPoolPlcyGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 25)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardNamedPoolAdminMode"), ("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxCardNamedPoolOperMode"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxCardV6v0NamedPoolPlcyGroup = tmnxCardV6v0NamedPoolPlcyGroup.setStatus('current')
tmnxChassisNotifyObjsV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 2, 1, 2, 26)).setObjects(("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", "tmnxChassisNotifyCardName"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxChassisNotifyObjsV6v0Group = tmnxChassisNotifyObjsV6v0Group.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", tmnxMDASlotNum=tmnxMDASlotNum, tmnxCcmIndex=tmnxCcmIndex, tmnxChassisTotalNumber=tmnxChassisTotalNumber, tmnxCardLastChange=tmnxCardLastChange, TmnxAlarmState=TmnxAlarmState, tmnxChassisFanSpeed=tmnxChassisFanSpeed, tmnxEqPowerSupplyInserted=tmnxEqPowerSupplyInserted, tmnxCpmCardLastChange=tmnxCpmCardLastChange, tmnxCpmCardNumCpus=tmnxCpmCardNumCpus, tmnxHwClearAlarms=tmnxHwClearAlarms, tmnxChassisUpgrade=tmnxChassisUpgrade, tSyncIfTimingAdmRef1AdminStatus=tSyncIfTimingAdmRef1AdminStatus, tmnxCcagPathCcMtu=tmnxCcagPathCcMtu, tmnxCcagTable=tmnxCcagTable, tmnxMdaTypeTable=tmnxMdaTypeTable, tmnxRedPrimaryCPMFail=tmnxRedPrimaryCPMFail, tmnxCardTypeTable=tmnxCardTypeTable, tmnxCpmCardAssignedType=tmnxCpmCardAssignedType, tmnxChassisNotifyOID=tmnxChassisNotifyOID, tmnxCardNamedPoolOperMode=tmnxCardNamedPoolOperMode, tmnxEqFanFailure=tmnxEqFanFailure, tmnxPeSoftwareAbnormalHalt=tmnxPeSoftwareAbnormalHalt, tmnxChassisModeForce=tmnxChassisModeForce, tmnxEqPowerSupplyRemoved=tmnxEqPowerSupplyRemoved, tmnxPeBootloaderVersionMismatch=tmnxPeBootloaderVersionMismatch, TmnxHwIndexOrZero=TmnxHwIndexOrZero, tmnxSyncIfTimingRef1InUse=tmnxSyncIfTimingRef1InUse, tmnxCardSupportedTypes=tmnxCardSupportedTypes, tmnxCcagPathCcEgrPoolResvCbs=tmnxCcagPathCcEgrPoolResvCbs, tmnxCcagPathCcIngPoolResvCbs=tmnxCcagPathCcIngPoolResvCbs, tmnxSyncIfTimingRef2Alarm=tmnxSyncIfTimingRef2Alarm, tmnxCpmFlashId=tmnxCpmFlashId, tmnx77x0CESMDAV6v0Group=tmnx77x0CESMDAV6v0Group, TmnxSlotNum=TmnxSlotNum, tmnxChassisLastChange=tmnxChassisLastChange, tmnxMDAHiBwMcastAlarm=tmnxMDAHiBwMcastAlarm, tmnxChassisNumFans=tmnxChassisNumFans, tmnxSyncIfTimingNotifyAlarm=tmnxSyncIfTimingNotifyAlarm, tmnxChassisFanIndex=tmnxChassisFanIndex, TmnxCcmType=TmnxCcmType, tmnxSyncIfTimingRef1SrcPort=tmnxSyncIfTimingRef1SrcPort, tmnxHwSoftwareCodeVersion=tmnxHwSoftwareCodeVersion, tmnxCardTypeStatus=tmnxCardTypeStatus, tmnxCcagPathCcTable=tmnxCcagPathCcTable, tmnxCcagPathCcUserAssignedMac=tmnxCcagPathCcUserAssignedMac, TmnxChassisMode=TmnxChassisMode, tmnxEqFlashDataLoss=tmnxEqFlashDataLoss, tmnxMDADiffTimestampFreq=tmnxMDADiffTimestampFreq, tmnxMcmTypeStatus=tmnxMcmTypeStatus, tmnxPeSoftwareVersionMismatch=tmnxPeSoftwareVersionMismatch, tmnxChassisRowStatus=tmnxChassisRowStatus, tmnxMDAMaxChannels=tmnxMDAMaxChannels, tmnxMcmEquippedType=tmnxMcmEquippedType, tmnxMDAChannelsInUse=tmnxMDAChannelsInUse, tmnxMDAMcPathMgmtSecInUseBw=tmnxMDAMcPathMgmtSecInUseBw, TmnxMdaType=TmnxMdaType, tmnxSyncIfTimingRef1Qualified=tmnxSyncIfTimingRef1Qualified, tmnxCpmFlashUsed=tmnxCpmFlashUsed, tmnxFabricEntry=tmnxFabricEntry, tmnxMDAMcPathMgmtAdminState=tmnxMDAMcPathMgmtAdminState, tmnxChassisNotificationV6v0Group=tmnxChassisNotificationV6v0Group, tmnxCcagLastChanged=tmnxCcagLastChanged, tmnxCcmTypeName=tmnxCcmTypeName, tmnxMDANetworkIngQueues=tmnxMDANetworkIngQueues, tmnxChassisPowerSupplyTable=tmnxChassisPowerSupplyTable, tmnxHwMfgString=tmnxHwMfgString, tmnxHwSwState=tmnxHwSwState, tmnxChassisEntry=tmnxChassisEntry, tmnxHwSwLastBoot=tmnxHwSwLastBoot, tmnxCpmCardConfigFileLastBootedHeader=tmnxCpmCardConfigFileLastBootedHeader, tmnxSyncIfTimingRef2SrcHw=tmnxSyncIfTimingRef2SrcHw, tmnxChassisUpdateTimeLeft=tmnxChassisUpdateTimeLeft, tmnxChassisBaseMacAddress=tmnxChassisBaseMacAddress, tmnxCcagPathCcQueuePlcy=tmnxCcagPathCcQueuePlcy, tmnxCardTypeEntry=tmnxCardTypeEntry, tmnxCcmHwIndex=tmnxCcmHwIndex, tmnxCpmFlashHwIndex=tmnxCpmFlashHwIndex, tmnxSyncIfTimingBITSAlarm=tmnxSyncIfTimingBITSAlarm, tmnxMDAMcPathMgmtAncPathLimit=tmnxMDAMcPathMgmtAncPathLimit, tmnxSlotObjs=tmnxSlotObjs, tmnxMDASupportedTypes=tmnxMDASupportedTypes, tmnxCardSlotNum=tmnxCardSlotNum, tmnxChassisFanEntry=tmnxChassisFanEntry, tmnxChassisAdminMode=tmnxChassisAdminMode, tmnxHwObjs=tmnxHwObjs, tmnxCcagPathId=tmnxCcagPathId, tmnxCardAssignedType=tmnxCardAssignedType, tmnxSyncIfTimingBITSIfType=tmnxSyncIfTimingBITSIfType, tmnxChassisAdminLastSetTimeout=tmnxChassisAdminLastSetTimeout, tmnxSyncIfTimingRefOrder3=tmnxSyncIfTimingRefOrder3, tmnxHwLastChange=tmnxHwLastChange, tmnxFabricLastChange=tmnxFabricLastChange, TmnxMcmType=TmnxMcmType, tmnxSyncIfTimingRefOrder1=tmnxSyncIfTimingRefOrder1, tSyncIfTimingAdmRef1SrcHw=tSyncIfTimingAdmRef1SrcHw, tmnxCpmCardAllowedTypes=tmnxCpmCardAllowedTypes, tmnxMcmTypeEntry=tmnxMcmTypeEntry, tmnxEqFlashDiskFull=tmnxEqFlashDiskFull, tmnxHwBaseMacAddress=tmnxHwBaseMacAddress, tmnxChassisUpgradeComplete=tmnxChassisUpgradeComplete, tmnxCpmCardEquippedType=tmnxCpmCardEquippedType, tmnxChassisComp7710=tmnxChassisComp7710, tmnxChassisNotification=tmnxChassisNotification, tmnxChassisFanOperStatus=tmnxChassisFanOperStatus, tmnxCardAllowedTypes=tmnxCardAllowedTypes, tmnxCpmCardMemorySize=tmnxCpmCardMemorySize, tmnxCpmFlashSerialNumber=tmnxCpmFlashSerialNumber, tmnxMdaTypeStatus=tmnxMdaTypeStatus, tmnxMDAReboot=tmnxMDAReboot, tmnxChassisCompliances=tmnxChassisCompliances, tmnxHwManufactureDate=tmnxHwManufactureDate, tmnxRedRestoreFail=tmnxRedRestoreFail, tmnxChassisAdminLastSetTimer=tmnxChassisAdminLastSetTimer, tmnxCardMemorySize=tmnxCardMemorySize, tmnxMdaTypeEntry=tmnxMdaTypeEntry, tmnxCpmCardBootOptionLastModified=tmnxCpmCardBootOptionLastModified, tmnxCpmCardNum=tmnxCpmCardNum, tmnxCardEquippedType=tmnxCardEquippedType, tmnxChassisMIBModule=tmnxChassisMIBModule, tmnxCardHwIndex=tmnxCardHwIndex, tmnxChassisTypeStatus=tmnxChassisTypeStatus, tmnxMDASyncIfTimingStatus=tmnxMDASyncIfTimingStatus, tmnxChassisNotifyCardFailureReason=tmnxChassisNotifyCardFailureReason, tmnxCpmCardEntry=tmnxCpmCardEntry, tmnxChassisTypeEntry=tmnxChassisTypeEntry, TmnxSETSRefAlarm=TmnxSETSRefAlarm, tmnxChassisNotificationV4v0Group=tmnxChassisNotificationV4v0Group, tmnxFabricHwIndex=tmnxFabricHwIndex, tmnxChassisTable=tmnxChassisTable, tmnxMDAAllowedTypes=tmnxMDAAllowedTypes, tmnxHwParentRelPos=tmnxHwParentRelPos, tmnxChassisName=tmnxChassisName, tmnxRedRestoreSuccess=tmnxRedRestoreSuccess, tmnxCpmCardConfigFileLastBooted=tmnxCpmCardConfigFileLastBooted, tmnxPeSoftwareLoadFailed=tmnxPeSoftwareLoadFailed, tmnxChassisNotificationClear=tmnxChassisNotificationClear, tmnxEqWrongCard=tmnxEqWrongCard, tmnxChassisObsoleteGroup=tmnxChassisObsoleteGroup, tmnxChassisComp7710V6v0=tmnxChassisComp7710V6v0, tmnxCpmCardBootOptionSource=tmnxCpmCardBootOptionSource, tmnxHwCLEI=tmnxHwCLEI, tmnxChassisNumPorts=tmnxChassisNumPorts, TmnxMDAChanType=TmnxMDAChanType, tmnxHwContainsEntry=tmnxHwContainsEntry, tmnxCcmTypeDescription=tmnxCcmTypeDescription, tmnxMDATxTimingSelected=tmnxMDATxTimingSelected, tmnxHwConfigChange=tmnxHwConfigChange, tmnxChassisAdminCtrlObjs=tmnxChassisAdminCtrlObjs, tmnxChassisUpgradeInProgress=tmnxChassisUpgradeInProgress, tmnxChassisNotifyObjsV6v0Group=tmnxChassisNotifyObjsV6v0Group, tmnxMcmTypeIndex=tmnxMcmTypeIndex, tmnxHwTemperature=tmnxHwTemperature, tmnxEqSyncIfTimingRef2Alarm=tmnxEqSyncIfTimingRef2Alarm, tmnxMdaTypeDescription=tmnxMdaTypeDescription, tmnxChassisType=tmnxChassisType, tmnxMcmAssignedType=tmnxMcmAssignedType, tmnxMcmTable=tmnxMcmTable, tmnxMDAEntry=tmnxMDAEntry, tSyncIfTimingAdmRef2BITSIfType=tSyncIfTimingAdmRef2BITSIfType, TmnxSETSRefSource=TmnxSETSRefSource, tmnxEqSyncIfTimingRef1Alarm=tmnxEqSyncIfTimingRef1Alarm, tmnxCcagAdminStatus=tmnxCcagAdminStatus, tmnxChassisV5v0Compliance=tmnxChassisV5v0Compliance, tmnxSyncIfTimingEntry=tmnxSyncIfTimingEntry, tmnxChassisAdminControlApply=tmnxChassisAdminControlApply, tmnxPeSoftwareError=tmnxPeSoftwareError, tmnxChassisNotifyMismatchedVer=tmnxChassisNotifyMismatchedVer, tmnxHwSwImageSource=tmnxHwSwImageSource, tSyncIfTimingAdmRef1BITSIfType=tSyncIfTimingAdmRef1BITSIfType, tmnxMDACcagId=tmnxMDACcagId, tmnxRedSecondaryCPMStatusChange=tmnxRedSecondaryCPMStatusChange, tmnxChassisHiBwMcastAlarm=tmnxChassisHiBwMcastAlarm, TmnxSlotNumOrZero=TmnxSlotNumOrZero, TmnxPortAdminStatus=TmnxPortAdminStatus, tmnxCcmEntry=tmnxCcmEntry, tmnxCardNumMdas=tmnxCardNumMdas, tmnxMDAHiBwMcastGroup=tmnxMDAHiBwMcastGroup, tmnxSyncIfTimingStatus=tmnxSyncIfTimingStatus, tmnxCcmTable=tmnxCcmTable, tmnxMcmSlotNum=tmnxMcmSlotNum, tmnxHwLastAlarmEvent=tmnxHwLastAlarmEvent, tmnxMDAMcPathMgmtPriPathLimit=tmnxMDAMcPathMgmtPriPathLimit, tmnxChassisOperMode=tmnxChassisOperMode, tmnxCpmCardReboot=tmnxCpmCardReboot, tmnxCcagEntry=tmnxCcagEntry, tmnxChassisGroups=tmnxChassisGroups, tmnx7710SETSRefSrcHwV6v0Group=tmnx7710SETSRefSrcHwV6v0Group, tmnxSyncIfTimingRef2InUse=tmnxSyncIfTimingRef2InUse, TmnxChassisIndex=TmnxChassisIndex, tmnxMDAAssignedType=tmnxMDAAssignedType, tmnxHwAdminState=tmnxHwAdminState, tmnxSyncIfTimingFreqOffset=tmnxSyncIfTimingFreqOffset, tmnxCcagPathWeight=tmnxCcagPathWeight, tmnxMcmHwIndex=tmnxMcmHwIndex, tmnxCcagAccessAdaptQos=tmnxCcagAccessAdaptQos, tmnxCcagDescription=tmnxCcagDescription, tmnxMDAClockMode=tmnxMDAClockMode, tmnxFabricEquippedType=tmnxFabricEquippedType, tmnxCcagPathEntry=tmnxCcagPathEntry, tmnxCpmFlashFirmwareRevision=tmnxCpmFlashFirmwareRevision, tmnxCardObjs=tmnxCardObjs, tmnxMDAV3v0Group=tmnxMDAV3v0Group, tmnxChassis7750V6v0Compliance=tmnxChassis7750V6v0Compliance, tmnxChassisComp7710V5v0=tmnxChassisComp7710V5v0, tmnxCcmEquippedType=tmnxCcmEquippedType, tmnxMcmTypeName=tmnxMcmTypeName, tmnxCardTable=tmnxCardTable, tmnxEqBackdoorBusFailure=tmnxEqBackdoorBusFailure, tmnxHwTempThreshold=tmnxHwTempThreshold, tmnxEqSyncIfTimingHoldover=tmnxEqSyncIfTimingHoldover, tSyncIfTimingAdmRefOrder1=tSyncIfTimingAdmRefOrder1, tmnxChassisNotifyChassisId=tmnxChassisNotifyChassisId, tSyncIfTimingAdmTable=tSyncIfTimingAdmTable, tmnxMDAMcPathMgmtPriInUseBw=tmnxMDAMcPathMgmtPriInUseBw, tmnxCpmFlashModelNumber=tmnxCpmFlashModelNumber, tmnxChassisPowerSupply2Status=tmnxChassisPowerSupply2Status, tmnxHwEntry=tmnxHwEntry, tSyncIfTimingAdmBITSIfType=tSyncIfTimingAdmBITSIfType, tmnxCardV6v0NamedPoolPlcyGroup=tmnxCardV6v0NamedPoolPlcyGroup, tmnxHwAlias=tmnxHwAlias, tmnxMcmTypeTable=tmnxMcmTypeTable, tmnxCcagOperStatus=tmnxCcagOperStatus, TmnxCcagId=TmnxCcagId, tmnxChassisNotifyPrefix=tmnxChassisNotifyPrefix, tmnxCcagId=tmnxCcagId, TmnxHwClass=TmnxHwClass, tmnxHwMfgDeviations=tmnxHwMfgDeviations, tmnxChassisV5v0ObsoleteGroup=tmnxChassisV5v0ObsoleteGroup, tmnxCpmCardRedundant=tmnxCpmCardRedundant, tmnxHwConformance=tmnxHwConformance, tmnxPeFPGAVersionMismatch=tmnxPeFPGAVersionMismatch, tmnxEqSyncIfTimingBITSAlarm=tmnxEqSyncIfTimingBITSAlarm, tmnxEnvTempTooHigh=tmnxEnvTempTooHigh, tSyncIfTimingAdmRefOrder3=tSyncIfTimingAdmRefOrder3, tmnxCpmCardConfigSource=tmnxCpmCardConfigSource, tmnxCcmTypeStatus=tmnxCcmTypeStatus, tmnxMDAMaxChannelization=tmnxMDAMaxChannelization, tmnxCpmCardTable=tmnxCpmCardTable, tmnxChassisPowerSupplyTempStatus=tmnxChassisPowerSupplyTempStatus, tmnxCcagPathCcAcctPolicyId=tmnxCcagPathCcAcctPolicyId, tmnxHwContainsTable=tmnxHwContainsTable, tmnxEqCardInserted=tmnxEqCardInserted, tmnxChassisNumFanTrays=tmnxChassisNumFanTrays, TmnxCcagRateOption=TmnxCcagRateOption, tmnxCpmCardClockSource=tmnxCpmCardClockSource, tmnxEqCardFirmwareUpgraded=tmnxEqCardFirmwareUpgraded, tSyncIfTimingAdmEntry=tSyncIfTimingAdmEntry, tSyncIfTimingAdmChanged=tSyncIfTimingAdmChanged, tmnxEqTypeNotificationRow=tmnxEqTypeNotificationRow, tmnxCcagPathRateOption=tmnxCcagPathRateOption, tmnxCardReboot=tmnxCardReboot, tmnxCcagPathCcType=tmnxCcagPathCcType, tmnxMDAEquippedType=tmnxMDAEquippedType, tmnxMDAEquippedPorts=tmnxMDAEquippedPorts)
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-CHASSIS-MIB", tmnxMcmSupportedTypes=tmnxMcmSupportedTypes, tmnxSyncIfTimingRef1Alarm=tmnxSyncIfTimingRef1Alarm, tmnxSyncIfTimingRef2AdminStatus=tmnxSyncIfTimingRef2AdminStatus, tmnxCcagPathTable=tmnxCcagPathTable, tmnxChassisTypeIndex=tmnxChassisTypeIndex, tmnxSyncIfTimingRef2SrcPort=tmnxSyncIfTimingRef2SrcPort, tmnxSyncIfTimingRef2Qualified=tmnxSyncIfTimingRef2Qualified, tmnxCcagCcaRate=tmnxCcagCcaRate, tmnxMDAMinChannelization=tmnxMDAMinChannelization, tmnxFabricSlotNum=tmnxFabricSlotNum, tmnxMDAHiBwMcastTapCount=tmnxMDAHiBwMcastTapCount, tmnxMcmTypeDescription=tmnxMcmTypeDescription, tmnxCardClockSource=tmnxCardClockSource, tmnxCardNumMdaSlots=tmnxCardNumMdaSlots, tmnxEqSyncIfTimingRef1AlarmClear=tmnxEqSyncIfTimingRef1AlarmClear, tmnxChassisOverTempState=tmnxChassisOverTempState, tSyncIfTimingAdmRef1SrcPort=tSyncIfTimingAdmRef1SrcPort, tmnxChassisReboot=tmnxChassisReboot, tmnxCpmCardConfigLastSaved=tmnxCpmCardConfigLastSaved, tmnxChassisNotifySoftwareLocation=tmnxChassisNotifySoftwareLocation, TmnxBITSIfType=TmnxBITSIfType, tmnxHwSerialNumber=tmnxHwSerialNumber, tmnxCpmCardHwIndex=tmnxCpmCardHwIndex, tmnxChassisPowerSupplyACStatus=tmnxChassisPowerSupplyACStatus, tmnxChassisTypeName=tmnxChassisTypeName, tmnxHwTempSensor=tmnxHwTempSensor, tmnxMdaTypeName=tmnxMdaTypeName, tmnxEqPowerSupplyFailure=tmnxEqPowerSupplyFailure, tmnxChassisAdminOwner=tmnxChassisAdminOwner, tmnxChassisPowerSupply1Status=tmnxChassisPowerSupply1Status, tmnxChassisCriticalLEDState=tmnxChassisCriticalLEDState, tmnxEqSyncIfTimingHoldoverClear=tmnxEqSyncIfTimingHoldoverClear, tmnxCpmCardSlotNum=tmnxCpmCardSlotNum, tmnxCpmFlashCapacity=tmnxCpmFlashCapacity, tmnxSyncIfTimingBITSInUse=tmnxSyncIfTimingBITSInUse, tmnxCpmCardConfigFileLastSaved=tmnxCpmCardConfigFileLastSaved, tmnxEqSyncIfTimingRef2AlarmClear=tmnxEqSyncIfTimingRef2AlarmClear, tmnxHwContainedIn=tmnxHwContainedIn, tmnxSyncIfTimingRevert=tmnxSyncIfTimingRevert, tmnxCpmCardRereadBootOptions=tmnxCpmCardRereadBootOptions, tmnxChassisPowerSupplyEntry=tmnxChassisPowerSupplyEntry, TmnxChassisType=TmnxChassisType, tmnxCpmFlashEntry=tmnxCpmFlashEntry, tmnxMDAMcPathMgmtBwPlcyName=tmnxMDAMcPathMgmtBwPlcyName, tmnxHwAssetID=tmnxHwAssetID, tSyncIfTimingAdmRefOrder2=tSyncIfTimingAdmRefOrder2, tmnxMcmEntry=tmnxMcmEntry, PYSNMP_MODULE_ID=tmnxChassisMIBModule, TmnxDeviceState=TmnxDeviceState, tmnxChassisComp7710V3v0=tmnxChassisComp7710V3v0, tmnxCpmCardCpuType=tmnxCpmCardCpuType, TmnxSETSRefQualified=TmnxSETSRefQualified, tmnxSyncIfTimingRefOrder2=tmnxSyncIfTimingRefOrder2, tmnxHwIndex=tmnxHwIndex, tmnxChassisTypeTable=tmnxChassisTypeTable, tmnxFabricTable=tmnxFabricTable, tmnxCcagPathCcHwMac=tmnxCcagPathCcHwMac, tmnxMDAV4v0Group=tmnxMDAV4v0Group, tmnxChassisPowerSupplyAssignedType=tmnxChassisPowerSupplyAssignedType, tmnxCardNamedPoolAdminMode=tmnxCardNamedPoolAdminMode, tmnxCcagPathRate=tmnxCcagPathRate, tmnxCpmCardConfigLastModified=tmnxCpmCardConfigLastModified, tmnxHwNotification=tmnxHwNotification, tmnxChassisNotifyObjsGroup=tmnxChassisNotifyObjsGroup, tmnxSyncIfTimingRef1BITSIfType=tmnxSyncIfTimingRef1BITSIfType, tmnxEqCardFailure=tmnxEqCardFailure, tmnxEqNotificationRow=tmnxEqNotificationRow, tmnxMDAMcPathMgmtV6v0Group=tmnxMDAMcPathMgmtV6v0Group, tmnxCardEntry=tmnxCardEntry, tmnxCardTypeDescription=tmnxCardTypeDescription, tmnxEqMdaCfgNotCompatible=tmnxEqMdaCfgNotCompatible, tmnx7710HwV3v0Group=tmnx7710HwV3v0Group, tmnxHwOperState=tmnxHwOperState, tmnxChassisUpdateWaitTime=tmnxChassisUpdateWaitTime, tmnxCardTypeName=tmnxCardTypeName, tmnxCcagPathCcLastChanged=tmnxCcagPathCcLastChanged, tmnxChassisConformance=tmnxChassisConformance, tmnxChassisMinorLEDState=tmnxChassisMinorLEDState, tmnxRedSecondaryCPMStatus=tmnxRedSecondaryCPMStatus, tmnxPeBootromVersionMismatch=tmnxPeBootromVersionMismatch, tmnxChassisV3v0Group=tmnxChassisV3v0Group, TmnxCcagRate=TmnxCcagRate, tmnxCpmCardBootOptionVersion=tmnxCpmCardBootOptionVersion, tmnxChassisCoordinates=tmnxChassisCoordinates, tmnxMDAHiBwMcastSource=tmnxMDAHiBwMcastSource, tSyncIfTimingAdmBITSAdminStatus=tSyncIfTimingAdmBITSAdminStatus, tmnxMDAHwIndex=tmnxMDAHwIndex, tmnxChassisCLLICode=tmnxChassisCLLICode, tmnxSyncIfTimingRef2BITSIfType=tmnxSyncIfTimingRef2BITSIfType, tmnxHwAlarmState=tmnxHwAlarmState, tmnxCcagRowStatus=tmnxCcagRowStatus, tmnxCpmCardSupportedTypes=tmnxCpmCardSupportedTypes, tmnxCpmCardSwitchToRedundantCard=tmnxCpmCardSwitchToRedundantCard, tmnxCcagPathCcCollectStats=tmnxCcagPathCcCollectStats, tmnxCpmCardIndexBootedVersion=tmnxCpmCardIndexBootedVersion, tmnxMdaTypeIndex=tmnxMdaTypeIndex, tmnxChassisFanTable=tmnxChassisFanTable, TmnxMDASuppType=TmnxMDASuppType, tmnxChassisPowerSupplyDCStatus=tmnxChassisPowerSupplyDCStatus, tmnxHwID=tmnxHwID, tmnxCcmTypeTable=tmnxCcmTypeTable, tmnxChassisPowerSupplyInputStatus=tmnxChassisPowerSupplyInputStatus, TmnxCardType=TmnxCardType, tmnxCcagPathCcEntry=tmnxCcagPathCcEntry, tmnxMDAMaxPorts=tmnxMDAMaxPorts, tmnxChassisNotificationV3v0Group=tmnxChassisNotificationV3v0Group, tmnxCpmCardConfigBootedVersion=tmnxCpmCardConfigBootedVersion, tmnxHwName=tmnxHwName, tmnxChassisMajorLEDState=tmnxChassisMajorLEDState, tmnxChassisObjs=tmnxChassisObjs, tmnxPeStorageProblem=tmnxPeStorageProblem, tmnxSyncIfTimingRef1SrcHw=tmnxSyncIfTimingRef1SrcHw, tmnxEqMemoryFailure=tmnxEqMemoryFailure, tmnxSyncIfTimingRef1AdminStatus=tmnxSyncIfTimingRef1AdminStatus, tmnxEqCardRemoved=tmnxEqCardRemoved, tmnxPeOutOfMemory=tmnxPeOutOfMemory, tmnxHwIsFRU=tmnxHwIsFRU, tmnxMDAMcPathMgmtAncInUseBw=tmnxMDAMcPathMgmtAncInUseBw, tmnxCcagPathCcMac=tmnxCcagPathCcMac, tmnxChassisTypeDescription=tmnxChassisTypeDescription, tmnxCcagPathCcIngPoolSlpPlcy=tmnxCcagPathCcIngPoolSlpPlcy, tmnxChassisIndex=tmnxChassisIndex, tmnxEqSyncIfTimingBITSAlarmClear=tmnxEqSyncIfTimingBITSAlarmClear, tmnxEqCpuFailure=tmnxEqCpuFailure, tmnxChassisV4v0Compliance=tmnxChassisV4v0Compliance, tmnxHwClass=tmnxHwClass, tSyncIfTimingAdmRef2AdminStatus=tSyncIfTimingAdmRef2AdminStatus, tmnxCcagPathCcEgrPoolSlpPlcy=tmnxCcagPathCcEgrPoolSlpPlcy, tmnxFabricAssignedType=tmnxFabricAssignedType, tmnxMDAEgrNamedPoolPolicy=tmnxMDAEgrNamedPoolPolicy, tmnxChassisV5v0Group=tmnxChassisV5v0Group, tmnxHwBootCodeVersion=tmnxHwBootCodeVersion, tmnxChassisNotifyHwIndex=tmnxChassisNotifyHwIndex, tmnxChassisNotifyCardName=tmnxChassisNotifyCardName, tmnxSyncIfTimingBITSAdminStatus=tmnxSyncIfTimingBITSAdminStatus, tmnxMDAMcPathMgmtBlkHoleInUseBw=tmnxMDAMcPathMgmtBlkHoleInUseBw, tmnxChassis7450V6v0Compliance=tmnxChassis7450V6v0Compliance, tSyncIfTimingAdmRef2SrcPort=tSyncIfTimingAdmRef2SrcPort, tmnxChassisNumPwrSupplies=tmnxChassisNumPwrSupplies, tmnxCpmCardMasterSlaveRefState=tmnxCpmCardMasterSlaveRefState, tmnxChassisPowerSupplyOutputStatus=tmnxChassisPowerSupplyOutputStatus, tmnxChassisNumSlots=tmnxChassisNumSlots, tSyncIfTimingAdmRevert=tSyncIfTimingAdmRevert, tmnxCcmOperStatus=tmnxCcmOperStatus, tmnxHwContainedIndex=tmnxHwContainedIndex, tmnxMDACapabilities=tmnxMDACapabilities, tmnxHwMfgBoardNumber=tmnxHwMfgBoardNumber, tmnxPeConfigurationError=tmnxPeConfigurationError, tmnxChassisPowerSupplyTempThreshold=tmnxChassisPowerSupplyTempThreshold, tmnxCpmFlashTable=tmnxCpmFlashTable, tmnxCardTypeIndex=tmnxCardTypeIndex, tmnxMDATable=tmnxMDATable, TmnxLEDState=TmnxLEDState, TmnxHwIndex=TmnxHwIndex, tmnxHwFailureReason=tmnxHwFailureReason, tmnxMDAMcPathMgmtSecPathLimit=tmnxMDAMcPathMgmtSecPathLimit, tmnxCardV3v0Group=tmnxCardV3v0Group, tmnxChassisAdminObjects=tmnxChassisAdminObjects, tmnxCcagPathLastChanged=tmnxCcagPathLastChanged, tmnxCpmCardBootOptionLastSaved=tmnxCpmCardBootOptionLastSaved, tmnxCpmFlashOperStatus=tmnxCpmFlashOperStatus, tmnxChassisAdminValueObjs=tmnxChassisAdminValueObjs, tmnxCcmTypeEntry=tmnxCcmTypeEntry, tmnxPeCpuCyclesExceeded=tmnxPeCpuCyclesExceeded, tmnxSyncIfTimingBITSQualified=tmnxSyncIfTimingBITSQualified, tSyncIfTimingAdmRef2SrcHw=tSyncIfTimingAdmRef2SrcHw, tmnxChassisLocation=tmnxChassisLocation, tmnxCpmCardIndexFileLastBootedHeader=tmnxCpmCardIndexFileLastBootedHeader, tmnxSyncIfTimingTable=tmnxSyncIfTimingTable, tmnxChassisNotifyObsoleteGroup=tmnxChassisNotifyObsoleteGroup, tmnxChassisPowerSupplyId=tmnxChassisPowerSupplyId, tmnxCcmTypeIndex=tmnxCcmTypeIndex, tmnxMDAIngNamedPoolPolicy=tmnxMDAIngNamedPoolPolicy, tmnxChassisNotificationObjects=tmnxChassisNotificationObjects, tmnxHwTable=tmnxHwTable)
