...
mibBuilder.exportSymbols("CTRON-SFPS-PKTMGR-MIB", numBCPCPFaultedDrops=numBCPCPFaultedDrops, numHPMNullSFPSPktDrops=numHPMNullSFPSPktDrops, sfpsPktDispatchStatsVerb=sfpsPktDispatchStatsVerb, numBSFabricNghbrPortDrops=numBSFabricNghbrPortDrops, sfpsPacketMgrSwitchID=sfpsPacketMgrSwitchID, sfpsPacketMgrReInit=sfpsPacketMgrReInit, sfpsPacketSizeEntry=sfpsPacketSizeEntry, sfpsPacketListTable=sfpsPacketListTable, sfpsPacketSizeNotFound=sfpsPacketSizeNotFound, sfpsCSPPacketStatsPacketsSentBad=sfpsCSPPacketStatsPacketsSentBad, sfpsPacketMgrPktsUsed=sfpsPacketMgrPktsUsed, numBSNullCallDrops=numBSNullCallDrops, numBSNonHello81fdDrops=numBSNonHello81fdDrops, sfpsPacketMgrTable=sfpsPacketMgrTable, sfpsPacketQTable=sfpsPacketQTable, sfpsPacketListEntry=sfpsPacketListEntry, sfpsPacketMgrToCreate=sfpsPacketMgrToCreate, numBCPNullCallDrops=numBCPNullCallDrops, numBSInvSrcPortDrops=numBSInvSrcPortDrops, numBCPCallNotAcceptedDrops=numBCPCallNotAcceptedDrops, sfpsPacketListTotalPackets=sfpsPacketListTotalPackets, sfpsPacketSizeSize=sfpsPacketSizeSize, sfpsPacketSizeSwitchInstance=sfpsPacketSizeSwitchInstance, numHPM81ffThrottleDrops=numHPM81ffThrottleDrops, sfpsPacketListNotFound=sfpsPacketListNotFound, sfpsPacketMgrEntry=sfpsPacketMgrEntry, numBSStandbyPortDrops=numBSStandbyPortDrops, sfpsPacketQPriorityQ=sfpsPacketQPriorityQ, sfpsCSPPacketStatsPacketsReceivedBad=sfpsCSPPacketStatsPacketsReceivedBad, numHPM81fdThrottleDrops=numHPM81fdThrottleDrops, numBCPGleanFailDrops=numBCPGleanFailDrops, sfpsPacketQTotalPackets=sfpsPacketQTotalPackets, numBSCSPCtrlDisableDrops=numBSCSPCtrlDisableDrops, sfpsPacketQCurrent=sfpsPacketQCurrent, numHPM81fdNullPktDrops=numHPM81fdNullPktDrops, numBSGoingToAccessPortDrops=numBSGoingToAccessPortDrops, sfpsPacketListStatus=sfpsPacketListStatus, numBCPSwitchedBCADrops=numBCPSwitchedBCADrops, sfpsPacketMgrPktsAvailable=sfpsPacketMgrPktsAvailable, sfpsCSPPacketStatsPacketsSentGood=sfpsCSPPacketStatsPacketsSentGood, sfpsCSPPacketStatsPacketsReceivedGood=sfpsCSPPacketStatsPacketsReceivedGood, numBSSourceBlockDrops=numBSSourceBlockDrops, numHPMFilterMgtPortDrops=numHPMFilterMgtPortDrops, sfpsPacketSizeTable=sfpsPacketSizeTable, sfpsPacketListSize=sfpsPacketListSize, numBSNullBottomCPDrops=numBSNullBottomCPDrops, sfpsPacketMgrPacketType=sfpsPacketMgrPacketType, numBSInvPortTypeDrops=numBSInvPortTypeDrops, numBSUnknownPortDrops=numBSUnknownPortDrops, numHPMPhysToLogPortDrops=numHPMPhysToLogPortDrops, numBSInvCSPTypeDrops=numBSInvCSPTypeDrops, HexInteger=HexInteger, numBSViolationDrops=numBSViolationDrops, sfpsPacketMgrPktsInUse=sfpsPacketMgrPktsInUse, sfpsPacketMgrNotFound=sfpsPacketMgrNotFound, numBCPCPHaltedDrops=numBCPCPHaltedDrops, sfpsPacketQHighWater=sfpsPacketQHighWater, sfpsPacketSizePktsUsed=sfpsPacketSizePktsUsed, sfpsPacketMgrTooLarge=sfpsPacketMgrTooLarge, sfpsPacketListPktsLeft=sfpsPacketListPktsLeft, sfpsPacketListPktsInUse=sfpsPacketListPktsInUse, numBSCSPCtrlIndexDrops=numBSCSPCtrlIndexDrops, sfpsPacketQEntry=sfpsPacketQEntry, SfpsSwitchInstance=SfpsSwitchInstance, numHPM81fdHelloNullPktDrops=numHPM81fdHelloNullPktDrops, numHPMPhysStandbyMaskDrops=numHPMPhysStandbyMaskDrops, sfpsPacketListPktsUsed=sfpsPacketListPktsUsed, sfpsPacketListLowWater=sfpsPacketListLowWater, sfpsPacketMgrTotalPackets=sfpsPacketMgrTotalPackets, numHPMInvalidFrameTypeDrops=numHPMInvalidFrameTypeDrops, sfpsPacketListPacketType=sfpsPacketListPacketType)
