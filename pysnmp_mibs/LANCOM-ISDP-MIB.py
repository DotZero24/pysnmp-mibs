...
agentIsdpMIBObjects=_AgentIsdpMIBObjects_ObjectIdentity((1,3,6,1,4,1,2356,16,1,39,1))
_AgentIsdpGlobal_ObjectIdentity=ObjectIdentity
agentIsdpGlobal=_AgentIsdpGlobal_ObjectIdentity((1,3,6,1,4,1,2356,16,1,39,1,1))
_AgentIsdpClear_ObjectIdentity=ObjectIdentity
agentIsdpClear=_AgentIsdpClear_ObjectIdentity((1,3,6,1,4,1,2356,16,1,39,1,1,1))
...
agentIsdpClearStats=_AgentIsdpClearStats_Object((1,3,6,1,4,1,2356,16,1,39,1,1,1,1),_AgentIsdpClearStats_Type())
...
agentIsdpClearEntries=_AgentIsdpClearEntries_Object((1,3,6,1,4,1,2356,16,1,39,1,1,1,2),_AgentIsdpClearEntries_Type())
...
agentIsdpStatistics=_AgentIsdpStatistics_ObjectIdentity((1,3,6,1,4,1,2356,16,1,39,1,1,2))
_AgentIsdpStatisticsPduReceived_Type=Counter32
_AgentIsdpStatisticsPduReceived_Object=MibScalar
agentIsdpStatisticsPduReceived=_AgentIsdpStatisticsPduReceived_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,1),_AgentIsdpStatisticsPduReceived_Type())
...
agentIsdpStatisticsPduTransmit=_AgentIsdpStatisticsPduTransmit_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,2),_AgentIsdpStatisticsPduTransmit_Type())
...
agentIsdpStatisticsV1PduReceived=_AgentIsdpStatisticsV1PduReceived_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,3),_AgentIsdpStatisticsV1PduReceived_Type())
...
agentIsdpStatisticsV1PduTransmit=_AgentIsdpStatisticsV1PduTransmit_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,4),_AgentIsdpStatisticsV1PduTransmit_Type())
...
agentIsdpStatisticsV2PduReceived=_AgentIsdpStatisticsV2PduReceived_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,5),_AgentIsdpStatisticsV2PduReceived_Type())
...
agentIsdpStatisticsV2PduTransmit=_AgentIsdpStatisticsV2PduTransmit_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,6),_AgentIsdpStatisticsV2PduTransmit_Type())
...
agentIsdpStatisticsBadHeaderPduReceived=_AgentIsdpStatisticsBadHeaderPduReceived_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,7),_AgentIsdpStatisticsBadHeaderPduReceived_Type())
...
agentIsdpStatisticsChkSumErrorPduReceived=_AgentIsdpStatisticsChkSumErrorPduReceived_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,8),_AgentIsdpStatisticsChkSumErrorPduReceived_Type())
...
agentIsdpStatisticsFailurePduTransmit=_AgentIsdpStatisticsFailurePduTransmit_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,9),_AgentIsdpStatisticsFailurePduTransmit_Type())
...
agentIsdpStatisticsInvalidFormatPduReceived=_AgentIsdpStatisticsInvalidFormatPduReceived_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,10),_AgentIsdpStatisticsInvalidFormatPduReceived_Type())
...
agentIsdpStatisticsTableFull=_AgentIsdpStatisticsTableFull_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,11),_AgentIsdpStatisticsTableFull_Type())
...
agentIsdpStatisticsIpAddressTableFull=_AgentIsdpStatisticsIpAddressTableFull_Object((1,3,6,1,4,1,2356,16,1,39,1,1,2,12),_AgentIsdpStatisticsIpAddressTableFull_Type())
...
agentIsdpGlobalRun=_AgentIsdpGlobalRun_Object((1,3,6,1,4,1,2356,16,1,39,1,1,4),_AgentIsdpGlobalRun_Type())
...
agentIsdpGlobalMessageInterval=_AgentIsdpGlobalMessageInterval_Object((1,3,6,1,4,1,2356,16,1,39,1,1,5),_AgentIsdpGlobalMessageInterval_Type())
...
agentIsdpGlobalHoldTime=_AgentIsdpGlobalHoldTime_Object((1,3,6,1,4,1,2356,16,1,39,1,1,6),_AgentIsdpGlobalHoldTime_Type())
...
agentIsdpGlobalDeviceId=_AgentIsdpGlobalDeviceId_Object((1,3,6,1,4,1,2356,16,1,39,1,1,7),_AgentIsdpGlobalDeviceId_Type())
...
agentIsdpGlobalAdvertiseV2=_AgentIsdpGlobalAdvertiseV2_Object((1,3,6,1,4,1,2356,16,1,39,1,1,8),_AgentIsdpGlobalAdvertiseV2_Type())
...
agentIsdpGlobalDeviceIdFormatCpb=_AgentIsdpGlobalDeviceIdFormatCpb_Object((1,3,6,1,4,1,2356,16,1,39,1,1,9),_AgentIsdpGlobalDeviceIdFormatCpb_Type())
...
agentIsdpGlobalDeviceIdFormat=_AgentIsdpGlobalDeviceIdFormat_Object((1,3,6,1,4,1,2356,16,1,39,1,1,10),_AgentIsdpGlobalDeviceIdFormat_Type())
...
agentIsdpCache=_AgentIsdpCache_ObjectIdentity((1,3,6,1,4,1,2356,16,1,39,1,2))
_AgentIsdpCacheTable_Object=MibTable
agentIsdpCacheTable=_AgentIsdpCacheTable_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1))
if mibBuilder.loadTexts:agentIsdpCacheTable.setStatus(_A)
_AgentIsdpCacheEntry_Object=MibTableRow
agentIsdpCacheEntry=_AgentIsdpCacheEntry_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1))
...
agentIsdpCacheIfIndex=_AgentIsdpCacheIfIndex_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,1),_AgentIsdpCacheIfIndex_Type())
...
agentIsdpCacheIndex=_AgentIsdpCacheIndex_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,2),_AgentIsdpCacheIndex_Type())
...
agentIsdpCacheAddress=_AgentIsdpCacheAddress_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,3),_AgentIsdpCacheAddress_Type())
...
agentIsdpCacheLocalIntf=_AgentIsdpCacheLocalIntf_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,4),_AgentIsdpCacheLocalIntf_Type())
...
agentIsdpCacheVersion=_AgentIsdpCacheVersion_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,5),_AgentIsdpCacheVersion_Type())
...
agentIsdpCacheDeviceId=_AgentIsdpCacheDeviceId_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,6),_AgentIsdpCacheDeviceId_Type())
...
agentIsdpCacheDevicePort=_AgentIsdpCacheDevicePort_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,7),_AgentIsdpCacheDevicePort_Type())
...
agentIsdpCachePlatform=_AgentIsdpCachePlatform_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,8),_AgentIsdpCachePlatform_Type())
...
agentIsdpCacheCapabilities=_AgentIsdpCacheCapabilities_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,9),_AgentIsdpCacheCapabilities_Type())
...
agentIsdpCacheLastChange=_AgentIsdpCacheLastChange_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,10),_AgentIsdpCacheLastChange_Type())
...
agentIsdpCacheProtocolVersion=_AgentIsdpCacheProtocolVersion_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,11),_AgentIsdpCacheProtocolVersion_Type())
...
agentIsdpCacheHoldtime=_AgentIsdpCacheHoldtime_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,12),_AgentIsdpCacheHoldtime_Type())
...
agentIsdpCacheNativeVlan=_AgentIsdpCacheNativeVlan_Object((1,3,6,1,4,1,2356,16,1,39,1,2,1,1,13),_AgentIsdpCacheNativeVlan_Type())
...
agentIsdpInterface=_AgentIsdpInterface_ObjectIdentity((1,3,6,1,4,1,2356,16,1,39,1,3))
_AgentIsdpInterfaceTable_Object=MibTable
agentIsdpInterfaceTable=_AgentIsdpInterfaceTable_Object((1,3,6,1,4,1,2356,16,1,39,1,3,1))
if mibBuilder.loadTexts:agentIsdpInterfaceTable.setStatus(_A)
_AgentIsdpInterfaceEntry_Object=MibTableRow
agentIsdpInterfaceEntry=_AgentIsdpInterfaceEntry_Object((1,3,6,1,4,1,2356,16,1,39,1,3,1,1))
...
agentIsdpInterfaceIfIndex=_AgentIsdpInterfaceIfIndex_Object((1,3,6,1,4,1,2356,16,1,39,1,3,1,1,1),_AgentIsdpInterfaceIfIndex_Type())
...
agentIsdpInterfaceEnable=_AgentIsdpInterfaceEnable_Object((1,3,6,1,4,1,2356,16,1,39,1,3,1,1,2),_AgentIsdpInterfaceEnable_Type())
