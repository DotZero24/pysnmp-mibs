...
h3cVoAnalogIfCommonObjects=_H3cVoAnalogIfCommonObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,39,3,1))
_H3cVoAnalogIfCommonCfgTable_Object=MibTable
h3cVoAnalogIfCommonCfgTable=_H3cVoAnalogIfCommonCfgTable_Object((1,3,6,1,4,1,2011,10,2,39,3,1,1))
if mibBuilder.loadTexts:h3cVoAnalogIfCommonCfgTable.setStatus(_A)
_H3cVoAnalogIfCommonCfgEntry_Object=MibTableRow
h3cVoAnalogIfCommonCfgEntry=_H3cVoAnalogIfCommonCfgEntry_Object((1,3,6,1,4,1,2011,10,2,39,3,1,1,1))
...
h3cVoAIfCfgPortIndex=_H3cVoAIfCfgPortIndex_Object((1,3,6,1,4,1,2011,10,2,39,3,1,1,1,1),_H3cVoAIfCfgPortIndex_Type())
...
h3cVoAIfCfgPortType=_H3cVoAIfCfgPortType_Object((1,3,6,1,4,1,2011,10,2,39,3,1,1,1,2),_H3cVoAIfCfgPortType_Type())
...
h3cVoAIfCfgPortSubLine=_H3cVoAIfCfgPortSubLine_Object((1,3,6,1,4,1,2011,10,2,39,3,1,1,1,3),_H3cVoAIfCfgPortSubLine_Type())
...
h3cVoAnalogIfFXSObjects=_H3cVoAnalogIfFXSObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,39,3,2))
_H3cVoAnalogIfFXSCfgTable_Object=MibTable
h3cVoAnalogIfFXSCfgTable=_H3cVoAnalogIfFXSCfgTable_Object((1,3,6,1,4,1,2011,10,2,39,3,2,1))
if mibBuilder.loadTexts:h3cVoAnalogIfFXSCfgTable.setStatus(_A)
_H3cVoAnalogIfFXSCfgEntry_Object=MibTableRow
h3cVoAnalogIfFXSCfgEntry=_H3cVoAnalogIfFXSCfgEntry_Object((1,3,6,1,4,1,2011,10,2,39,3,2,1,1))
...
h3cVoAIfFXSCfgPortIndex=_H3cVoAIfFXSCfgPortIndex_Object((1,3,6,1,4,1,2011,10,2,39,3,2,1,1,1),_H3cVoAIfFXSCfgPortIndex_Type())
...
h3cVoAIfFXSCfgCidDisplay=_H3cVoAIfFXSCfgCidDisplay_Object((1,3,6,1,4,1,2011,10,2,39,3,2,1,1,3),_H3cVoAIfFXSCfgCidDisplay_Type())
...
h3cVoAIfFXSCfgCidSend=_H3cVoAIfFXSCfgCidSend_Object((1,3,6,1,4,1,2011,10,2,39,3,2,1,1,4),_H3cVoAIfFXSCfgCidSend_Type())
...
h3cVoAIfFXSCfgCidType=_H3cVoAIfFXSCfgCidType_Object((1,3,6,1,4,1,2011,10,2,39,3,2,1,1,5),_H3cVoAIfFXSCfgCidType_Type())
...
h3cVoAIfFXSCfgSubLine=_H3cVoAIfFXSCfgSubLine_Object((1,3,6,1,4,1,2011,10,2,39,3,2,1,1,6),_H3cVoAIfFXSCfgSubLine_Type())
...
h3cVoAnalogIfFXSTimerTable=_H3cVoAnalogIfFXSTimerTable_Object((1,3,6,1,4,1,2011,10,2,39,3,2,3))
if mibBuilder.loadTexts:h3cVoAnalogIfFXSTimerTable.setStatus(_A)
_H3cVoAnalogIfFXSTimerEntry_Object=MibTableRow
h3cVoAnalogIfFXSTimerEntry=_H3cVoAnalogIfFXSTimerEntry_Object((1,3,6,1,4,1,2011,10,2,39,3,2,3,1))
...
h3cVoAIfFXSTimerPortIndex=_H3cVoAIfFXSTimerPortIndex_Object((1,3,6,1,4,1,2011,10,2,39,3,2,3,1,1),_H3cVoAIfFXSTimerPortIndex_Type())
...
h3cVoAIfFXSTimerDialInterval=_H3cVoAIfFXSTimerDialInterval_Object((1,3,6,1,4,1,2011,10,2,39,3,2,3,1,4),_H3cVoAIfFXSTimerDialInterval_Type())
...
h3cVoAIfFXSTimerFirstDial=_H3cVoAIfFXSTimerFirstDial_Object((1,3,6,1,4,1,2011,10,2,39,3,2,3,1,5),_H3cVoAIfFXSTimerFirstDial_Type())
...
h3cVoAIfFXSTimerRingBack=_H3cVoAIfFXSTimerRingBack_Object((1,3,6,1,4,1,2011,10,2,39,3,2,3,1,6),_H3cVoAIfFXSTimerRingBack_Type())
...
h3cVoAIfFXSTimerSubLine=_H3cVoAIfFXSTimerSubLine_Object((1,3,6,1,4,1,2011,10,2,39,3,2,3,1,7),_H3cVoAIfFXSTimerSubLine_Type())
...
h3cVoAnalogIfFXOObjects=_H3cVoAnalogIfFXOObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,39,3,3))
_H3cVoAnalogIfFXOCfgTable_Object=MibTable
h3cVoAnalogIfFXOCfgTable=_H3cVoAnalogIfFXOCfgTable_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1))
if mibBuilder.loadTexts:h3cVoAnalogIfFXOCfgTable.setStatus(_A)
_H3cVoAnalogIfFXOCfgEntry_Object=MibTableRow
h3cVoAnalogIfFXOCfgEntry=_H3cVoAnalogIfFXOCfgEntry_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1,1))
...
h3cVoAIfFXOCfgPortIndex=_H3cVoAIfFXOCfgPortIndex_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1,1,1),_H3cVoAIfFXOCfgPortIndex_Type())
...
h3cVoAIfFXOCfgArea=_H3cVoAIfFXOCfgArea_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1,1,4),_H3cVoAIfFXOCfgArea_Type())
...
h3cVoAIfFXOPreDialDelay=_H3cVoAIfFXOPreDialDelay_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1,1,5),_H3cVoAIfFXOPreDialDelay_Type())
...
h3cVoAIfFXOCfgPortImpedance=_H3cVoAIfFXOCfgPortImpedance_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1,1,6),_H3cVoAIfFXOCfgPortImpedance_Type())
...
h3cVoAIfFXOCfgCidEnable=_H3cVoAIfFXOCfgCidEnable_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1,1,7),_H3cVoAIfFXOCfgCidEnable_Type())
...
h3cVoAnalogIfFXOCfgCidSend=_H3cVoAnalogIfFXOCfgCidSend_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1,1,8),_H3cVoAnalogIfFXOCfgCidSend_Type())
...
h3cVoAIfFXOCfgCidType=_H3cVoAIfFXOCfgCidType_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1,1,9),_H3cVoAIfFXOCfgCidType_Type())
...
h3cVoAIfFXOCfgSubLine=_H3cVoAIfFXOCfgSubLine_Object((1,3,6,1,4,1,2011,10,2,39,3,3,1,1,10),_H3cVoAIfFXOCfgSubLine_Type())
...
h3cVoAnalogIfFXOTimerTable=_H3cVoAnalogIfFXOTimerTable_Object((1,3,6,1,4,1,2011,10,2,39,3,3,3))
if mibBuilder.loadTexts:h3cVoAnalogIfFXOTimerTable.setStatus(_A)
_H3cVoAnalogIfFXOTimerEntry_Object=MibTableRow
h3cVoAnalogIfFXOTimerEntry=_H3cVoAnalogIfFXOTimerEntry_Object((1,3,6,1,4,1,2011,10,2,39,3,3,3,1))
...
h3cVoAIfFXOTimerPortIndex=_H3cVoAIfFXOTimerPortIndex_Object((1,3,6,1,4,1,2011,10,2,39,3,3,3,1,1),_H3cVoAIfFXOTimerPortIndex_Type())
...
h3cVoAIfFXOTimerDtmf=_H3cVoAIfFXOTimerDtmf_Object((1,3,6,1,4,1,2011,10,2,39,3,3,3,1,2),_H3cVoAIfFXOTimerDtmf_Type())
...
h3cVoAIfFXOTimerDtmfInterval=_H3cVoAIfFXOTimerDtmfInterval_Object((1,3,6,1,4,1,2011,10,2,39,3,3,3,1,3),_H3cVoAIfFXOTimerDtmfInterval_Type())
...
h3cVoAIfFXOTimerDialInterval=_H3cVoAIfFXOTimerDialInterval_Object((1,3,6,1,4,1,2011,10,2,39,3,3,3,1,4),_H3cVoAIfFXOTimerDialInterval_Type())
...
h3cVoAIfFXOTimerFirstDial=_H3cVoAIfFXOTimerFirstDial_Object((1,3,6,1,4,1,2011,10,2,39,3,3,3,1,5),_H3cVoAIfFXOTimerFirstDial_Type())
...
h3cVoAIfFXOTimerRingBack=_H3cVoAIfFXOTimerRingBack_Object((1,3,6,1,4,1,2011,10,2,39,3,3,3,1,6),_H3cVoAIfFXOTimerRingBack_Type())
...
h3cVoAIfFXOTimerSubLine=_H3cVoAIfFXOTimerSubLine_Object((1,3,6,1,4,1,2011,10,2,39,3,3,3,1,7),_H3cVoAIfFXOTimerSubLine_Type())
...
h3cVoAnalogIfEMObjects=_H3cVoAnalogIfEMObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,39,3,4))
_H3cVoAnalogIfEMCfgTable_Object=MibTable
h3cVoAnalogIfEMCfgTable=_H3cVoAnalogIfEMCfgTable_Object((1,3,6,1,4,1,2011,10,2,39,3,4,1))
if mibBuilder.loadTexts:h3cVoAnalogIfEMCfgTable.setStatus(_A)
_H3cVoAnalogIfEMCfgEntry_Object=MibTableRow
h3cVoAnalogIfEMCfgEntry=_H3cVoAnalogIfEMCfgEntry_Object((1,3,6,1,4,1,2011,10,2,39,3,4,1,1))
...
h3cVoAIfEMCfgPortIndex=_H3cVoAIfEMCfgPortIndex_Object((1,3,6,1,4,1,2011,10,2,39,3,4,1,1,1),_H3cVoAIfEMCfgPortIndex_Type())
...
h3cVoAIfEMCfgSignalMode=_H3cVoAIfEMCfgSignalMode_Object((1,3,6,1,4,1,2011,10,2,39,3,4,1,1,2),_H3cVoAIfEMCfgSignalMode_Type())
...
h3cVoAIfEMCfgPhyParm=_H3cVoAIfEMCfgPhyParm_Object((1,3,6,1,4,1,2011,10,2,39,3,4,1,1,3),_H3cVoAIfEMCfgPhyParm_Type())
...
h3cVoAIfEMCfgPhyType=_H3cVoAIfEMCfgPhyType_Object((1,3,6,1,4,1,2011,10,2,39,3,4,1,1,4),_H3cVoAIfEMCfgPhyType_Type())
...
h3cVoAIfEMCfgTimeoutRing=_H3cVoAIfEMCfgTimeoutRing_Object((1,3,6,1,4,1,2011,10,2,39,3,4,1,1,5),_H3cVoAIfEMCfgTimeoutRing_Type())
...
h3cVoAIfEMCfgTimeoutWaitDigit=_H3cVoAIfEMCfgTimeoutWaitDigit_Object((1,3,6,1,4,1,2011,10,2,39,3,4,1,1,6),_H3cVoAIfEMCfgTimeoutWaitDigit_Type())
...
h3cVoAIfEMCfgSubLine=_H3cVoAIfEMCfgSubLine_Object((1,3,6,1,4,1,2011,10,2,39,3,4,1,1,7),_H3cVoAIfEMCfgSubLine_Type())
...
h3cVoAnalogIfEMTimerTable=_H3cVoAnalogIfEMTimerTable_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3))
if mibBuilder.loadTexts:h3cVoAnalogIfEMTimerTable.setStatus(_A)
_H3cVoAnalogIfEMTimerEntry_Object=MibTableRow
h3cVoAnalogIfEMTimerEntry=_H3cVoAnalogIfEMTimerEntry_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1))
...
h3cVoAIfEMTimerPortIndex=_H3cVoAIfEMTimerPortIndex_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,1),_H3cVoAIfEMTimerPortIndex_Type())
...
h3cVoAIfEMTimerDtmf=_H3cVoAIfEMTimerDtmf_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,2),_H3cVoAIfEMTimerDtmf_Type())
...
h3cVoAIfEMTimerDtmfInterval=_H3cVoAIfEMTimerDtmfInterval_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,3),_H3cVoAIfEMTimerDtmfInterval_Type())
...
h3cVoAIfEMTimerSendWink=_H3cVoAIfEMTimerSendWink_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,5),_H3cVoAIfEMTimerSendWink_Type())
...
h3cVoAIfEMTimerWinkRising=_H3cVoAIfEMTimerWinkRising_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,6),_H3cVoAIfEMTimerWinkRising_Type())
...
h3cVoAIfEMTimerWinkHold=_H3cVoAIfEMTimerWinkHold_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,7),_H3cVoAIfEMTimerWinkHold_Type())
...
h3cVoAIfEMTimerDialoutDelay=_H3cVoAIfEMTimerDialoutDelay_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,8),_H3cVoAIfEMTimerDialoutDelay_Type())
...
h3cVoAIfEMTimerDelayRising=_H3cVoAIfEMTimerDelayRising_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,9),_H3cVoAIfEMTimerDelayRising_Type())
...
h3cVoAIfEMTimerDelayHold=_H3cVoAIfEMTimerDelayHold_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,10),_H3cVoAIfEMTimerDelayHold_Type())
...
h3cVoAIfEMTimerSubLine=_H3cVoAIfEMTimerSubLine_Object((1,3,6,1,4,1,2011,10,2,39,3,4,3,1,11),_H3cVoAIfEMTimerSubLine_Type())
