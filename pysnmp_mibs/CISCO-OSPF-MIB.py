...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-OSPF-MIB
...
ospfAreaEntry, ospfVirtIfEntry, ospfIfEntry, RouterID, PositiveInteger, UpToMaxAge, ospfLsdbRouterId, Metric, HelloRange, ospfLsdbAreaId, AreaID, ospfLsdbLsid = mibBuilder.importSymbols("OSPF-MIB", "ospfAreaEntry", "ospfVirtIfEntry", "ospfIfEntry", "RouterID", "PositiveInteger", "UpToMaxAge", "ospfLsdbRouterId", "Metric", "HelloRange", "ospfLsdbAreaId", "AreaID", "ospfLsdbLsid")
...
mibBuilder.exportSymbols("CISCO-OSPF-MIB", cospfShamLinkEntry=cospfShamLinkEntry, cospfCompliances=cospfCompliances, cospfShamLinksRetransInterval=cospfShamLinksRetransInterval, cospfAreaNssaTranslatorEvents=cospfAreaNssaTranslatorEvents, cospfCompliance=cospfCompliance, cospfVirtLocalLsdbTransitArea=cospfVirtLocalLsdbTransitArea, cospfShamLinkRetransInterval=cospfShamLinkRetransInterval, cospfVirtLocalLsdbRouterId=cospfVirtLocalLsdbRouterId, cospfShamLinkNbrLsRetransQLen=cospfShamLinkNbrLsRetransQLen, cospfShamLinksEntry=cospfShamLinksEntry, cospfShamLinkNbrTable=cospfShamLinkNbrTable, cospfShamLinkNbrEvents=cospfShamLinkNbrEvents, cospfLsdbEntry=cospfLsdbEntry, cospfShamLinkMetric=cospfShamLinkMetric, cospfShamLinkNbrArea=cospfShamLinkNbrArea, cospfLsdbType=cospfLsdbType, cospfVirtLocalLsdbSequence=cospfVirtLocalLsdbSequence, cospfLsdbAdvertisement=cospfLsdbAdvertisement, cospfLsdbGroup=cospfLsdbGroup, cospfVirtLocalLsdbTable=cospfVirtLocalLsdbTable, cospfShamLinksRtrDeadInterval=cospfShamLinksRtrDeadInterval, cospfAreaNssaTranslatorState=cospfAreaNssaTranslatorState, cospfVirtLocalLsdbLsid=cospfVirtLocalLsdbLsid, cospfVirtLocalLsdbGroup=cospfVirtLocalLsdbGroup, cospfLsdbTable=cospfLsdbTable, cospfShamLinksLocalIpAddr=cospfShamLinksLocalIpAddr, cospfLocalLsdbIpAddress=cospfLocalLsdbIpAddress, cospfVirtLocalLsdbType=cospfVirtLocalLsdbType, cospfIfEntry=cospfIfEntry, cospfOpaqueAreaLsaCksumSum=cospfOpaqueAreaLsaCksumSum, cospfOpaqueASLsaCksumSum=cospfOpaqueASLsaCksumSum, cospfShamLinksTable=cospfShamLinksTable, cospfIfGroup=cospfIfGroup, cospfAreaEntry=cospfAreaEntry, cospfGeneralGroup=cospfGeneralGroup, cospfShamLinksRemoteIpAddrType=cospfShamLinksRemoteIpAddrType, cospfShamLinksMetric=cospfShamLinksMetric, cospfShamLinksAreaId=cospfShamLinksAreaId, cospfIfLsaCksumSum=cospfIfLsaCksumSum, cospfShamLinksLocalIpAddrType=cospfShamLinksLocalIpAddrType, cospfShamLinkNbrRtrId=cospfShamLinkNbrRtrId, cospfVirtLocalLsdbChecksum=cospfVirtLocalLsdbChecksum, cospfShamLinkNbrOptions=cospfShamLinkNbrOptions, cospfShamLinksEvents=cospfShamLinksEvents, cospfLsdbAge=cospfLsdbAge, cospfVirtIfGroup=cospfVirtIfGroup, cospfIfLsaCount=cospfIfLsaCount, cospfLocalLsdbGroup=cospfLocalLsdbGroup, cospfShamLinkLocalIpAddress=cospfShamLinkLocalIpAddress, cospfShamLinkState=cospfShamLinkState, cospfLsdbChecksum=cospfLsdbChecksum, cospfVirtIfEntry=cospfVirtIfEntry, cospfVirtIfLsaCksumSum=cospfVirtIfLsaCksumSum, cospfLocalLsdbAddressLessIf=cospfLocalLsdbAddressLessIf, cospfLocalLsdbEntry=cospfLocalLsdbEntry, cospfLocalLsdbType=cospfLocalLsdbType, cospfShamLinkHelloInterval=cospfShamLinkHelloInterval, cospfVirtLocalLsdbAge=cospfVirtLocalLsdbAge, cospfShamLinksGroup=cospfShamLinksGroup, cospfShamLinksRemoteIpAddr=cospfShamLinksRemoteIpAddr, cospfShamLinkNbrIpAddrType=cospfShamLinkNbrIpAddrType, cospfVirtIfLsaCount=cospfVirtIfLsaCount, cospfTrafficEngineeringSupport=cospfTrafficEngineeringSupport, cospf=cospf, PYSNMP_MODULE_ID=cospf, cospfVirtIfTable=cospfVirtIfTable, cospfComplianceRev1=cospfComplianceRev1, cospfRFC1583Compatibility=cospfRFC1583Compatibility, cospfVirtLocalLsdbEntry=cospfVirtLocalLsdbEntry, cospfShamLinksHelloInterval=cospfShamLinksHelloInterval, cospfShamLinkNbrHelloSuppressed=cospfShamLinkNbrHelloSuppressed, cospfShamLinksState=cospfShamLinksState, cospfLocalLsdbAge=cospfLocalLsdbAge, cospfOpaqueASLsaCount=cospfOpaqueASLsaCount, cospfShamLinkNbrState=cospfShamLinkNbrState, cospfIfTable=cospfIfTable, cospfLocalLsdbLsid=cospfLocalLsdbLsid, cospfOpaqueAreaLsaCount=cospfOpaqueAreaLsaCount, cospfShamLinkNbrGroup=cospfShamLinkNbrGroup, cospfVirtLocalLsdbNeighbor=cospfVirtLocalLsdbNeighbor, cospfVirtLocalLsdbAdvertisement=cospfVirtLocalLsdbAdvertisement, cospfAreaGroup=cospfAreaGroup, cospfLocalLsdbRouterId=cospfLocalLsdbRouterId, cospfShamLinkNbrIpAddr=cospfShamLinkNbrIpAddr, cospfLocalLsdbChecksum=cospfLocalLsdbChecksum, cospfConformance=cospfConformance, cospfShamLinkAreaId=cospfShamLinkAreaId, cospfLsdbSequence=cospfLsdbSequence, cospfAreaNssaTranslatorRole=cospfAreaNssaTranslatorRole, cospfOpaqueLsaSupport=cospfOpaqueLsaSupport, cospfBasicGroup=cospfBasicGroup, cospfShamLinkEvents=cospfShamLinkEvents, cospfShamLinkGroup=cospfShamLinkGroup, cospfShamLinkNeighborId=cospfShamLinkNeighborId, cospfAreaTable=cospfAreaTable, cospfLocalLsdbAdvertisement=cospfLocalLsdbAdvertisement, cospfShamLinkNbrEntry=cospfShamLinkNbrEntry, cospfGroups=cospfGroups, cospfLocalLsdbTable=cospfLocalLsdbTable, cospfShamLinkRtrDeadInterval=cospfShamLinkRtrDeadInterval, cospfShamLinkTable=cospfShamLinkTable, cospfLocalLsdbSequence=cospfLocalLsdbSequence)
