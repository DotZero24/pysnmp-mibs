...
ospfAreaEntry, HelloRange, ospfVirtIfEntry, RouterID, Metric, AreaID, ospfIfEntry, PositiveInteger, UpToMaxAge, ospfLsdbAreaId, ospfLsdbRouterId, ospfLsdbLsid = mibBuilder.importSymbols("OSPF-MIB", "ospfAreaEntry", "HelloRange", "ospfVirtIfEntry", "RouterID", "Metric", "AreaID", "ospfIfEntry", "PositiveInteger", "UpToMaxAge", "ospfLsdbAreaId", "ospfLsdbRouterId", "ospfLsdbLsid")
...
mibBuilder.exportSymbols("CISCO-OSPF-MIB", cospfVirtIfTable=cospfVirtIfTable, cospfCompliances=cospfCompliances, cospfGeneralGroup=cospfGeneralGroup, cospfLsdbEntry=cospfLsdbEntry, cospfLsdbAdvertisement=cospfLsdbAdvertisement, cospfIfTable=cospfIfTable, cospfShamLinksState=cospfShamLinksState, cospfShamLinkNbrIpAddr=cospfShamLinkNbrIpAddr, cospfShamLinkNbrRtrId=cospfShamLinkNbrRtrId, cospfGroups=cospfGroups, cospfLocalLsdbAddressLessIf=cospfLocalLsdbAddressLessIf, cospfLsdbType=cospfLsdbType, cospfShamLinkNbrLsRetransQLen=cospfShamLinkNbrLsRetransQLen, cospfLocalLsdbLsid=cospfLocalLsdbLsid, cospfIfGroup=cospfIfGroup, cospfVirtLocalLsdbGroup=cospfVirtLocalLsdbGroup, cospfVirtLocalLsdbSequence=cospfVirtLocalLsdbSequence, cospfLocalLsdbRouterId=cospfLocalLsdbRouterId, cospfShamLinkNbrState=cospfShamLinkNbrState, cospfIfEntry=cospfIfEntry, cospfVirtLocalLsdbTable=cospfVirtLocalLsdbTable, cospfTrafficEngineeringSupport=cospfTrafficEngineeringSupport, cospfLsdbTable=cospfLsdbTable, cospfVirtLocalLsdbNeighbor=cospfVirtLocalLsdbNeighbor, cospfAreaNssaTranslatorRole=cospfAreaNssaTranslatorRole, cospfShamLinkNeighborId=cospfShamLinkNeighborId, cospfAreaGroup=cospfAreaGroup, cospfComplianceRev1=cospfComplianceRev1, cospfVirtLocalLsdbChecksum=cospfVirtLocalLsdbChecksum, PYSNMP_MODULE_ID=cospf, cospfLsdbSequence=cospfLsdbSequence, cospfShamLinksTable=cospfShamLinksTable, cospfShamLinksRtrDeadInterval=cospfShamLinksRtrDeadInterval, cospfVirtIfLsaCount=cospfVirtIfLsaCount, cospfAreaEntry=cospfAreaEntry, cospfShamLinkGroup=cospfShamLinkGroup, cospfLocalLsdbEntry=cospfLocalLsdbEntry, cospfShamLinkMetric=cospfShamLinkMetric, cospfShamLinkEvents=cospfShamLinkEvents, cospfLocalLsdbAge=cospfLocalLsdbAge, cospfVirtLocalLsdbEntry=cospfVirtLocalLsdbEntry, cospfShamLinksEvents=cospfShamLinksEvents, cospfLocalLsdbType=cospfLocalLsdbType, cospfIfLsaCksumSum=cospfIfLsaCksumSum, cospfVirtLocalLsdbAdvertisement=cospfVirtLocalLsdbAdvertisement, cospfShamLinkNbrEntry=cospfShamLinkNbrEntry, cospfShamLinkNbrTable=cospfShamLinkNbrTable, cospfShamLinkNbrOptions=cospfShamLinkNbrOptions, cospfLocalLsdbTable=cospfLocalLsdbTable, cospfShamLinkNbrHelloSuppressed=cospfShamLinkNbrHelloSuppressed, cospfShamLinkRetransInterval=cospfShamLinkRetransInterval, cospfVirtIfEntry=cospfVirtIfEntry, cospfLocalLsdbIpAddress=cospfLocalLsdbIpAddress, cospfShamLinkNbrArea=cospfShamLinkNbrArea, cospfShamLinkLocalIpAddress=cospfShamLinkLocalIpAddress, cospfShamLinksRemoteIpAddr=cospfShamLinksRemoteIpAddr, cospfLocalLsdbAdvertisement=cospfLocalLsdbAdvertisement, cospfShamLinksLocalIpAddrType=cospfShamLinksLocalIpAddrType, cospfAreaNssaTranslatorEvents=cospfAreaNssaTranslatorEvents, cospfOpaqueAreaLsaCksumSum=cospfOpaqueAreaLsaCksumSum, cospfOpaqueASLsaCount=cospfOpaqueASLsaCount, cospfAreaTable=cospfAreaTable, cospfShamLinkNbrGroup=cospfShamLinkNbrGroup, cospfConformance=cospfConformance, cospfShamLinksRemoteIpAddrType=cospfShamLinksRemoteIpAddrType, cospfOpaqueLsaSupport=cospfOpaqueLsaSupport, cospfCompliance=cospfCompliance, cospfVirtLocalLsdbLsid=cospfVirtLocalLsdbLsid, cospfShamLinkAreaId=cospfShamLinkAreaId, cospfShamLinksAreaId=cospfShamLinksAreaId, cospfOpaqueASLsaCksumSum=cospfOpaqueASLsaCksumSum, cospfShamLinkRtrDeadInterval=cospfShamLinkRtrDeadInterval, cospfShamLinkHelloInterval=cospfShamLinkHelloInterval, cospfLsdbGroup=cospfLsdbGroup, cospfShamLinkTable=cospfShamLinkTable, cospfShamLinkState=cospfShamLinkState, cospfAreaNssaTranslatorState=cospfAreaNssaTranslatorState, cospfShamLinkNbrEvents=cospfShamLinkNbrEvents, cospfVirtIfGroup=cospfVirtIfGroup, cospfShamLinksHelloInterval=cospfShamLinksHelloInterval, cospfOpaqueAreaLsaCount=cospfOpaqueAreaLsaCount, cospfShamLinkNbrIpAddrType=cospfShamLinkNbrIpAddrType, cospfShamLinksLocalIpAddr=cospfShamLinksLocalIpAddr, cospfBasicGroup=cospfBasicGroup, cospfVirtLocalLsdbAge=cospfVirtLocalLsdbAge, cospfVirtLocalLsdbType=cospfVirtLocalLsdbType, cospfShamLinksEntry=cospfShamLinksEntry, cospfLocalLsdbChecksum=cospfLocalLsdbChecksum, cospfVirtLocalLsdbRouterId=cospfVirtLocalLsdbRouterId, cospfLsdbChecksum=cospfLsdbChecksum, cospfLocalLsdbGroup=cospfLocalLsdbGroup, cospfShamLinksMetric=cospfShamLinksMetric, cospfRFC1583Compatibility=cospfRFC1583Compatibility, cospfLsdbAge=cospfLsdbAge, cospfVirtIfLsaCksumSum=cospfVirtIfLsaCksumSum, cospfIfLsaCount=cospfIfLsaCount, cospfVirtLocalLsdbTransitArea=cospfVirtLocalLsdbTransitArea, cospfShamLinkEntry=cospfShamLinkEntry, cospf=cospf, cospfShamLinksRetransInterval=cospfShamLinksRetransInterval, cospfShamLinksGroup=cospfShamLinksGroup, cospfLocalLsdbSequence=cospfLocalLsdbSequence)
