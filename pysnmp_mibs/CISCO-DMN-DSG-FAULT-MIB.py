...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-DMN-DSG-FAULT-MIB
...
mibBuilder.exportSymbols("CISCO-DMN-DSG-FAULT-MIB", awFaultSettingPriority=awFaultSettingPriority, awFaultStatusFaultNum=awFaultStatusFaultNum, faultSummaryClearAlarms=faultSummaryClearAlarms, awFaultStatusTable=awFaultStatusTable, awFaultSettingTextId=awFaultSettingTextId, awFaultHistoryDetails=awFaultHistoryDetails, faultSummaryNumActiveAlarms=faultSummaryNumActiveAlarms, awFaultStatusEntry=awFaultStatusEntry, awFaultSettingType=awFaultSettingType, faultSummary=faultSummary, awFaultActiveListSetDateTime=awFaultActiveListSetDateTime, awFaultHistoryEntry=awFaultHistoryEntry, awFaultActiveListType=awFaultActiveListType, awFaultHistoryTable=awFaultHistoryTable, awFaultSettingSeverity=awFaultSettingSeverity, awFaultHistoryState=awFaultHistoryState, awFaultStatusSeverity=awFaultStatusSeverity, faultAWTable=faultAWTable, faultSummaryClearWarnings=faultSummaryClearWarnings, awFaultStatusLastDateTime=awFaultStatusLastDateTime, awFaultHistoryResetDateTime=awFaultHistoryResetDateTime, PYSNMP_MODULE_ID=ciscoDSGFault, awFaultSettingName=awFaultSettingName, faultSummaryNumActiveWarnings=faultSummaryNumActiveWarnings, awFaultSettingTable=awFaultSettingTable, awFaultStatusDetails=awFaultStatusDetails, awFaultStatusName=awFaultStatusName, awFaultSettingEntry=awFaultSettingEntry, awFaultHistorySetDateTime=awFaultHistorySetDateTime, awFaultStatusTrapState=awFaultStatusTrapState, awFaultActiveListTextID=awFaultActiveListTextID, awFaultActiveListPriority=awFaultActiveListPriority, awFaultSettingEnable=awFaultSettingEnable, awFaultSettingRelay=awFaultSettingRelay, awFaultHistoryName=awFaultHistoryName, awFaultActiveListDetails=awFaultActiveListDetails, awFaultSettingTrap=awFaultSettingTrap, awFaultStatusType=awFaultStatusType, awFaultStatusTextId=awFaultStatusTextId, awFaultActiveListName=awFaultActiveListName, awFaultHistoryType=awFaultHistoryType, faultSummaryClearHistory=faultSummaryClearHistory, awFaultActiveListEntry=awFaultActiveListEntry, awFaultStatusPriority=awFaultStatusPriority, awFaultStatusRelay=awFaultStatusRelay, awFaultHistorySequence=awFaultHistorySequence, ciscoDSGFault=ciscoDSGFault, awFaultActiveListTable=awFaultActiveListTable)
