...
mibBuilder.exportSymbols("CISCO-DMN-DSG-FAULT-MIB", awFaultHistoryEntry=awFaultHistoryEntry, awFaultSettingPriority=awFaultSettingPriority, awFaultSettingTable=awFaultSettingTable, ciscoDSGFault=ciscoDSGFault, awFaultStatusLastDateTime=awFaultStatusLastDateTime, awFaultStatusName=awFaultStatusName, PYSNMP_MODULE_ID=ciscoDSGFault, awFaultSettingSeverity=awFaultSettingSeverity, faultSummaryNumActiveAlarms=faultSummaryNumActiveAlarms, awFaultStatusTextId=awFaultStatusTextId, awFaultStatusTable=awFaultStatusTable, awFaultActiveListPriority=awFaultActiveListPriority, awFaultActiveListType=awFaultActiveListType, awFaultSettingName=awFaultSettingName, faultSummary=faultSummary, awFaultHistoryTable=awFaultHistoryTable, awFaultHistoryResetDateTime=awFaultHistoryResetDateTime, faultSummaryClearWarnings=faultSummaryClearWarnings, awFaultSettingTextId=awFaultSettingTextId, awFaultSettingTrap=awFaultSettingTrap, awFaultActiveListTextID=awFaultActiveListTextID, awFaultHistoryType=awFaultHistoryType, awFaultActiveListSetDateTime=awFaultActiveListSetDateTime, awFaultHistoryDetails=awFaultHistoryDetails, awFaultActiveListEntry=awFaultActiveListEntry, faultAWTable=faultAWTable, awFaultHistoryName=awFaultHistoryName, faultSummaryNumActiveWarnings=faultSummaryNumActiveWarnings, awFaultHistorySequence=awFaultHistorySequence, awFaultHistorySetDateTime=awFaultHistorySetDateTime, awFaultStatusTrapState=awFaultStatusTrapState, awFaultSettingEntry=awFaultSettingEntry, awFaultStatusPriority=awFaultStatusPriority, awFaultSettingEnable=awFaultSettingEnable, awFaultSettingRelay=awFaultSettingRelay, awFaultStatusDetails=awFaultStatusDetails, awFaultHistoryState=awFaultHistoryState, awFaultStatusFaultNum=awFaultStatusFaultNum, awFaultStatusSeverity=awFaultStatusSeverity, awFaultStatusRelay=awFaultStatusRelay, awFaultSettingType=awFaultSettingType, awFaultActiveListDetails=awFaultActiveListDetails, awFaultActiveListName=awFaultActiveListName, awFaultStatusEntry=awFaultStatusEntry, faultSummaryClearAlarms=faultSummaryClearAlarms, awFaultActiveListTable=awFaultActiveListTable, faultSummaryClearHistory=faultSummaryClearHistory, awFaultStatusType=awFaultStatusType)
