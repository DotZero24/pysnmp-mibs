...
mibBuilder.exportSymbols("GBNPlatformOAM-MIB", nmInterfaceGateAddress=nmInterfaceGateAddress, portCarRateBpdu=portCarRateBpdu, cpuBusyAlarmEnable=cpuBusyAlarmEnable, loadExecuteStatus=loadExecuteStatus, gbnPlatformOAMSysIf=gbnPlatformOAMSysIf, manageUserAuthenRadiusName=manageUserAuthenRadiusName, portCarGlobalEnable=portCarGlobalEnable, gbnPlatformOAMIpAccessControl=gbnPlatformOAMIpAccessControl, clockTime=clockTime, vctAutoRunGlobalEnable=vctAutoRunGlobalEnable, ipAccessControlTable=ipAccessControlTable, musrTable=musrTable, snmpCommunityToViewTable=snmpCommunityToViewTable, gbnPlatformOAMMailalarm=gbnPlatformOAMMailalarm, gbnPlatformOAMSyslog=gbnPlatformOAMSyslog, bootromVersion=bootromVersion, writeConfig=writeConfig, manageUserAuthenType=manageUserAuthenType, vctRunEnable=vctRunEnable, sdramDescription=sdramDescription, discardBpdu=discardBpdu, snmpRemoteEngineID=snmpRemoteEngineID, gbnPlatformOAM=gbnPlatformOAM, cpuUnbusyTrap=cpuUnbusyTrap, vctRunPort=vctRunPort, portDiscardBpdu=portDiscardBpdu, gbnPlatformOAMSntpClient=gbnPlatformOAMSntpClient, sysIfIPNetMask=sysIfIPNetMask, sysIfManageVLANRowStatus=sysIfManageVLANRowStatus, snmpDeleteRemoteEngineTableRow=snmpDeleteRemoteEngineTableRow, portCarEnable=portCarEnable, softwareCompiledTimeE=softwareCompiledTimeE, timeZoneName=timeZoneName, musrType=musrType, loadTftpAddress=loadTftpAddress, manageUserAuthChallegeType=manageUserAuthChallegeType, snmpComm2ViewPermission=snmpComm2ViewPermission, vctRunResultErrorLocation=vctRunResultErrorLocation, cpuStatusTrap=cpuStatusTrap, sysIfIpAddress=sysIfIpAddress, musrRowStatus=musrRowStatus, loadExecute=loadExecute, VctRunResultTxRxPairNoType=VctRunResultTxRxPairNoType, snmpNotifyTypeEntry=snmpNotifyTypeEntry, snmpRemoteEngineTable=snmpRemoteEngineTable, gbnPlatformOAMPortCar=gbnPlatformOAMPortCar, snmpCommunityToViewEntry=snmpCommunityToViewEntry, snmpComm2ViewIndex=snmpComm2ViewIndex, hostName=hostName, sysIfManageVLANEntry=sysIfManageVLANEntry, controlTeminal=controlTeminal, sysIfIPStatus=sysIfIPStatus, snmpRemoteEngineEntry=snmpRemoteEngineEntry, vctRunTable=vctRunTable, memorySize=memorySize, offsetNegFlag=offsetNegFlag, portCarRate=portCarRate, manageUserTacacsAccount=manageUserTacacsAccount, portCarPort=portCarPort, sysIfManageVLANVid=sysIfManageVLANVid, controlIpAddress=controlIpAddress, cpuBusyThreshold=cpuBusyThreshold, manageUserTacacsAuthor=manageUserTacacsAuthor, snmpRemoteHostTAddr=snmpRemoteHostTAddr, portCarOpenTime=portCarOpenTime, sysIfBOOTPOnOff=sysIfBOOTPOnOff, hardwareVersion=hardwareVersion, controlIpMask=controlIpMask, memoryIdle=memoryIdle, snmpNotifyTypeStatus=snmpNotifyTypeStatus, snmpNotifyTypeSaveConfiguration=snmpNotifyTypeSaveConfiguration, cpuIdle=cpuIdle, musrPassword=musrPassword, gbnPlatformOAMMuser=gbnPlatformOAMMuser, portCarTable=portCarTable, gbnPlatformOAMSystem=gbnPlatformOAMSystem, gbnPlatformOAMWatchDog=gbnPlatformOAMWatchDog, loadFtpUserName=loadFtpUserName, saveNMInterfaceConfig=saveNMInterfaceConfig, systemClock=systemClock, vctRunResultEntry=vctRunResultEntry, softwareVersion=softwareVersion, VctRunResultStatusType=VctRunResultStatusType, gbnPlatformOAMVctRunResult=gbnPlatformOAMVctRunResult, musrEntry=musrEntry, loadFtpUserPassword=loadFtpUserPassword, vctRunResultTxRxPairNo=vctRunResultTxRxPairNo, nmInterfaceNetMask=nmInterfaceNetMask, cpuDescription=cpuDescription, vctAutoRunEnable=vctAutoRunEnable, sysIfManageVLANTbale=sysIfManageVLANTbale, portCarEntry=portCarEntry, writeNMInterfaceConifig=writeNMInterfaceConifig, softwareCompiledTimeC=softwareCompiledTimeC, cpuBusyStatus=cpuBusyStatus, musrName=musrName, controlStatus=controlStatus, snmpComm2ViewCommName=snmpComm2ViewCommName, systemReset=systemReset, gbnPlatformOAMSnmp=gbnPlatformOAMSnmp, snmpComm2ViewRowStatus=snmpComm2ViewRowStatus, musrIndex=musrIndex, loadType=loadType, gbnPlatformOAMVctRun=gbnPlatformOAMVctRun, nmInterfaceId=nmInterfaceId, prodSerialNo=prodSerialNo, cpuUnbusyThreshold=cpuUnbusyThreshold, sysIfDHCPOnOff=sysIfDHCPOnOff, ipAccessControlEntry=ipAccessControlEntry, gbnPlatformOAMSsh=gbnPlatformOAMSsh, snmpTrapSource=snmpTrapSource, PYSNMP_MODULE_ID=gbnPlatformOAM, sysIfMACAddr=sysIfMACAddr, loadFtpFileName=loadFtpFileName, loadFtpAddress=loadFtpAddress, timeZoneOffset=timeZoneOffset, softwarePlate=softwarePlate, gbnPlatformOAMUpDownLoad=gbnPlatformOAMUpDownLoad, gbnPlatformOAMSnmpNotifyType=gbnPlatformOAMSnmpNotifyType, nmInterfaceIpAddress=nmInterfaceIpAddress, cpuBusyTrap=cpuBusyTrap, snmpNotifyTypeTable=snmpNotifyTypeTable, vctRunEntry=vctRunEntry, snmpPrivateNotifyType=snmpPrivateNotifyType, softDogProxy=softDogProxy, vctRunResultStatus=vctRunResultStatus, flashDescription=flashDescription, vctRunResultPort=vctRunResultPort, snmpTrapSourceType=snmpTrapSourceType, vctRunResultTable=vctRunResultTable, productName=productName, snmpComm2ViewViewName=snmpComm2ViewViewName, sysIfIPGateAddress=sysIfIPGateAddress, writeNMInterfaceConifigStatus=writeNMInterfaceConifigStatus, loadTftpFileName=loadTftpFileName)
