...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/opengear/OG-STATUSv2-MIB
...
ogStatus2.setRevisions(('2020-11-10 00:00', '2017-02-03 00:00', '2016-08-26 00:00', '2014-01-28 00:00',))
if mibBuilder.loadTexts: ogStatus2.setLastUpdated('202011100000Z')
...
ogNetInterfaceFailoverState = MibTableColumn((1, 3, 6, 1, 4, 1, 25049, 17, 12, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("active", 1), ("failed", 2), ("dormant", 3), ("standby", 4)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: ogNetInterfaceFailoverState.setStatus('current')
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogHostIndex=ogHostIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdEntry=ogEmdEntry, ogUpsTable=ogUpsTable, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellTowerNotification=ogCellTowerNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostIpV6Address=ogHostIpV6Address, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdConnectType=ogEmdConnectType, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemModel=ogCellModemModel, ogSerialUserName=ogSerialUserName, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientTable=ogWifiClientTable, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletTable=ogRpcOutletTable, ogWifiApCounter=ogWifiApCounter, ogHostEntry=ogHostEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserName=ogWebUserName, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellMessageNotification=ogCellMessageNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmState=ogAlarmState, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioNotification=ogEmdDioNotification, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserTable=ogSerialUserTable, ogUpsHumidity=ogUpsHumidity, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientInterface=ogWifiClientInterface, ogEmdTable=ogEmdTable, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsDescription=ogUpsDescription, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmType=ogAlarmType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsName=ogUpsName, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmEventId=ogAlarmEventId, ogAlarmLogTable=ogAlarmLogTable, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2Compliance=ogStatus2Compliance, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmDevice=ogAlarmDevice, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortSpeed=ogSerialPortSpeed, ogHostUserEntry=ogHostUserEntry, ogUpsIndex=ogUpsIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserNotification=ogSerialUserNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortLabel=ogSerialPortLabel, ogHostName=ogHostName, ogRpcType=ogRpcType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioName=ogEmdDioName, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientAp=ogWifiApClientAp, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostPingNotification=ogHostPingNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceName=ogNetInterfaceName, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApInterface=ogWifiApInterface, ogCellModemCounter=ogCellModemCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmSummary=ogAlarmSummary, ogUpsState=ogUpsState, ogAlarmName=ogAlarmName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckTable=ogCheckTable, ogCellModemSessionTime=ogCellModemSessionTime, ogHostServiceType=ogHostServiceType, ogEmdDioEntry=ogEmdDioEntry, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogCellApnNotification=ogCellApnNotification, ogWebUserNotification=ogWebUserNotification, ogRpcOutletState=ogRpcOutletState, ogHostUserAddress=ogHostUserAddress, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWebUserEntry=ogWebUserEntry, ogHostServicePort=ogHostServicePort, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortParity=ogSerialPortParity, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSystem=ogSystem, ogEmdDioDirection=ogEmdDioDirection, ogUpsEntry=ogUpsEntry, ogEmdName=ogEmdName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApTable=ogWifiApTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserHostName=ogHostUserHostName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientCounter=ogWifiClientCounter, ogWifiApEntry=ogWifiApEntry, ogUpsNotification=ogUpsNotification, ogSerialPortRTS=ogSerialPortRTS, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserPort=ogSerialUserPort, ogHostTable=ogHostTable, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortMode=ogSerialPortMode, ogWifiClientEssid=ogWifiClientEssid, ogHostUserTable=ogHostUserTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmInstance=ogAlarmInstance, ogCheckIndex=ogCheckIndex, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortIndex=ogSerialPortIndex, ogHostUserName=ogHostUserName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceType=ogNetInterfaceType, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApSsid=ogWifiApSsid, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemTable=ogCellModemTable, ogRpcTable=ogRpcTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckType=ogCheckType, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdEnabled=ogEmdEnabled, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsTemperature=ogUpsTemperature, ogCellModemNetwork=ogCellModemNetwork, ogHostUserIndex=ogHostUserIndex, ogHostUserNotification=ogHostUserNotification, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDescription=ogEmdDescription, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceRef=ogCheckDeviceRef, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemEntry=ogCellModemEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityName=ogEmdHumidityName, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApEnabled=ogWifiApEnabled, ogRpcName=ogRpcName, ogCheckResolveActions=ogCheckResolveActions, ogWebUserIndex=ogWebUserIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcConnectType=ogRpcConnectType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemTower=ogCellModemTower, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceHost=ogHostServiceHost, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckEntry=ogCheckEntry, ogAlarmTime=ogAlarmTime, ogSerialPortEntry=ogSerialPortEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemApn=ogCellModemApn, ogUpsType=ogUpsType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletName=ogRpcOutletName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioState=ogEmdDioState, ogHostUserHost=ogHostUserHost, ogWebUserStartTime=ogWebUserStartTime, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApIndex=ogWifiApIndex, ogRpcEntry=ogRpcEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcCounter=ogRpcCounter, ogUpsCounter=ogUpsCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckName=ogCheckName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialNumber=ogSerialNumber, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApTxPower=ogWifiApTxPower, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceStatus=ogHostServiceStatus, ogCheckResetTimeout=ogCheckResetTimeout, ogStatus2Compliances=ogStatus2Compliances, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemConnected=ogCellModemConnected, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmUser=ogAlarmUser, ogCellModemVendor=ogCellModemVendor, ogNetInterfaceFailoverState=ogNetInterfaceFailoverState, ogAlarm=ogAlarm, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioTable=ogEmdDioTable, ogSerialUserLabel=ogSerialUserLabel, ogAlarmCheck=ogAlarmCheck, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcIndex=ogRpcIndex, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientRssi=ogWifiClientRssi, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientIndex=ogWifiClientIndex, ogEmdIndex=ogEmdIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioType=ogEmdDioType, ogRpcDescription=ogRpcDescription, ogMibNotifications=ogMibNotifications, ogStatus2=ogStatus2, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogCustomNotification=ogCustomNotification, ogEmdHumidityDescription=ogEmdHumidityDescription)
