...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemEntry=ogCellModemEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogStatus2Groups=ogStatus2Groups, ogCellModemApn=ogCellModemApn, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcCounter=ogRpcCounter, ogEmdIndex=ogEmdIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckType=ogCheckType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserName=ogWebUserName, ogWebUserIndex=ogWebUserIndex, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientTable=ogWifiApClientTable, ogRpcName=ogRpcName, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortMode=ogSerialPortMode, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellDataNotification=ogCellDataNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsEntry=ogUpsEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsState=ogUpsState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientRssi=ogWifiClientRssi, ogHostServicePort=ogHostServicePort, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletName=ogRpcOutletName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostIndex=ogHostIndex, ogHostUserTable=ogHostUserTable, ogSerialUserName=ogSerialUserName, ogStatus2=ogStatus2, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemModel=ogCellModemModel, ogCheckTable=ogCheckTable, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarm=ogAlarm, ogUpsNotification=ogUpsNotification, ogAlarmType=ogAlarmType, ogPowerSupplyName=ogPowerSupplyName, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioDirection=ogEmdDioDirection, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdName=ogEmdName, ogWifiApFrequency=ogWifiApFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckEntry=ogCheckEntry, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioState=ogEmdDioState, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsDescription=ogUpsDescription, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWebUserEntry=ogWebUserEntry, ogHostServiceTable=ogHostServiceTable, ogAlarmUser=ogAlarmUser, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortRTS=ogSerialPortRTS, ogCellModemTower=ogCellModemTower, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsConnectType=ogUpsConnectType, ogWifiApIndex=ogWifiApIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDescription=ogEmdDescription, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostIpV6Address=ogHostIpV6Address, PYSNMP_MODULE_ID=ogStatus2, ogWebUserNotification=ogWebUserNotification, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserHost=ogHostUserHost, ogHostEntry=ogHostEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserName=ogHostUserName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckIndex=ogCheckIndex, ogSystem=ogSystem, ogUpsType=ogUpsType, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserTable=ogSerialUserTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioIndex=ogEmdDioIndex, ogHostName=ogHostName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceStatus=ogHostServiceStatus, ogUpsHumidity=ogUpsHumidity, ogRpcDescription=ogRpcDescription, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostUserHostName=ogHostUserHostName, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryState=ogUpsBatteryState, ogNetInterfaceFailoverState=ogNetInterfaceFailoverState, ogCellModem3gRssi=ogCellModem3gRssi, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcEntry=ogRpcEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckName=ogCheckName, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApTable=ogWifiApTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortParity=ogSerialPortParity, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmName=ogAlarmName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemNetwork=ogCellModemNetwork, ogUpsTable=ogUpsTable, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApTxPower=ogWifiApTxPower, ogHostUserNotification=ogHostUserNotification, ogHostUserEntry=ogHostUserEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsTemperature=ogUpsTemperature, ogCellModemTable=ogCellModemTable, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryCharge=ogUpsBatteryCharge, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmEventId=ogAlarmEventId, ogEmdTable=ogEmdTable, ogCellModemCounter=ogCellModemCounter, ogEmdDioTable=ogEmdDioTable, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmTime=ogAlarmTime, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserStartTime=ogHostUserStartTime, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2Compliance=ogStatus2Compliance, ogAlarmState=ogAlarmState, ogHostUserAddress=ogHostUserAddress, ogWifiApSsid=ogWifiApSsid, ogSerialPortTable=ogSerialPortTable, ogStatus2Compliances=ogStatus2Compliances, ogCellTowerNotification=ogCellTowerNotification, ogHostUserIndex=ogHostUserIndex, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsCounter=ogUpsCounter, ogHostServiceType=ogHostServiceType, ogMibNotifications=ogMibNotifications, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcConnectType=ogRpcConnectType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputPower=ogUpsOutputPower, ogRpcIndex=ogRpcIndex, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortEntry=ogSerialPortEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostIpV4Address=ogHostIpV4Address, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdEntry=ogEmdEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogWebUserTable=ogWebUserTable, ogAlarmDevice=ogAlarmDevice, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApCounter=ogWifiApCounter, ogStatus2Conformance=ogStatus2Conformance, ogWifiApInterface=ogWifiApInterface, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioType=ogEmdDioType, ogRpcInputNotification=ogRpcInputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsIndex=ogUpsIndex, ogHostServiceIndex=ogHostServiceIndex, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdHumidityName=ogEmdHumidityName, ogCellModemEnabled=ogCellModemEnabled, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostTable=ogHostTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortCTS=ogSerialPortCTS, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcTable=ogRpcTable, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioName=ogEmdDioName, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmLogTable=ogAlarmLogTable, ogRpcType=ogRpcType, ogWifiClientMode=ogWifiClientMode, ogUpsName=ogUpsName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemRegistered=ogCellModemRegistered, ogSerialNumber=ogSerialNumber, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserStartTime=ogWebUserStartTime, ogAlarmCheck=ogAlarmCheck, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceName=ogNetInterfaceName, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletTable=ogRpcOutletTable, ogAlarmInstance=ogAlarmInstance, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdConnectType=ogEmdConnectType, ogWifiApEntry=ogWifiApEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmSummary=ogAlarmSummary, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientEnabled=ogWifiClientEnabled, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceTable=ogCheckDeviceTable, ogCustomNotification=ogCustomNotification, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserPort=ogSerialUserPort, ogEmdDioEmd=ogEmdDioEmd, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientInterface=ogWifiClientInterface)
