...
mibBuilder.exportSymbols("CTRON-BDG-MIB", bdgPortPriority=bdgPortPriority, bdgPortDesigPort=bdgPortDesigPort, pcLenErrs=pcLenErrs, acqCreate01=acqCreate01, bdgdeviceBdgPriority=bdgdeviceBdgPriority, bdgdeviceStatus=bdgdeviceStatus, bdgPort=bdgPort, bdgdeviceType=bdgdeviceType, bdgPortFrRx=bdgPortFrRx, bdgPortDisInb=bdgPortDisInb, acqDispType=acqDispType, bdgdeviceBdgMaxAge=bdgdeviceBdgMaxAge, pcIF=pcIF, pcSglColl=pcSglColl, pcMMACAddr=pcMMACAddr, bdgPortDesigCost=bdgPortDesigCost, bdgdeviceVersion=bdgdeviceVersion, bdgPortStatus=bdgPortStatus, pcBcastXmit=pcBcastXmit, acqDelete=acqDelete, bdgdeviceRestoreSettings=bdgdeviceRestoreSettings, trapTypes=trapTypes, acqMaxEntries=acqMaxEntries, pcOnboardMemory=pcOnboardMemory, acqDynEntries=acqDynEntries, bdgdeviceNumPorts=bdgdeviceNumPorts, bdgdeviceSwitchSetting=bdgdeviceSwitchSetting, bdgdeviceTimeTopChg=bdgdeviceTimeTopChg, pcDeferXmit=pcDeferXmit, pcMcastRec=pcMcastRec, specPort2=specPort2, specPort1=specPort1, pcBytesRec=pcBytesRec, pcCRCErrs=pcCRCErrs, specType=specType, bdgPortDisTDE=bdgPortDisTDE, pcBytesXmit=pcBytesXmit, bdgdeviceDisableBdg=bdgdeviceDisableBdg, pcTooLong=pcTooLong, bdgdeviceBridgeID=bdgdeviceBridgeID, bdgPortAddress=bdgPortAddress, acqEraseDatabase=acqEraseDatabase, pcMcastXmit=pcMcastXmit, acqStaticEntries=acqStaticEntries, bdgdeviceRestartBdg=bdgdeviceRestartBdg, bdgPortOowColl=bdgPortOowColl, specSrcAddress=specSrcAddress, acqDynAgeTime=acqDynAgeTime, permCreate20=permCreate20, bdgdeviceTypeFiltering=bdgdeviceTypeFiltering, permDispType=permDispType, permCreate21=permCreate21, bdgPortFwdOutb=bdgPortFwdOutb, bdgPortTxAbrt=bdgPortTxAbrt, pcMACAddr=pcMACAddr, bdgdeviceTopChg=bdgdeviceTopChg, specDestAddress=specDestAddress, bdgPortFrAlErr=bdgPortFrAlErr, permSrcAddress=permSrcAddress, pcTotXmitErrs=pcTotXmitErrs, specDataField=specDataField, permDB=permDB, bdgdeviceBdgFwdDly=bdgdeviceBdgFwdDly, pcFramesXmit=pcFramesXmit, bdgPortNetName=bdgPortNetName, specFilters=specFilters, lmcommon=lmcommon, pcAlignErrs=pcAlignErrs, pcIntRecErr=pcIntRecErr, permEraseDatabase=permEraseDatabase, bdgdeviceNumRestarts=bdgdeviceNumRestarts, pcTooShort=pcTooShort, bdgPortType=bdgPortType, pcBoardType=pcBoardType, acqSrcAddress=acqSrcAddress, permDelete=permDelete, specEnable=specEnable, bdgdeviceFrRx=bdgdeviceFrRx, pcApplication=pcApplication, acqStats=acqStats, pcSqeErr=pcSqeErr, bdgdeviceUptime=bdgdeviceUptime, bdgPortDisLOB=bdgPortDisLOB, bdgdeviceRootCost=bdgdeviceRootCost, pcLocation=pcLocation, ieee8023=ieee8023, specNextFilterNum=specNextFilterNum, bdgdeviceResetCounts=bdgdeviceResetCounts, pcIfRev=pcIfRev, pcXcessColls=pcXcessColls, acqCreate21=acqCreate21, bdgdeviceSTAProtocol=bdgdeviceSTAProtocol, bdgPortCRCErr=bdgPortCRCErr, acqStaticAgeTime=acqStaticAgeTime, bdgdeviceMaxAge=bdgdeviceMaxAge, bdgPortRuntPackets=bdgPortRuntPackets, permCurrEntries=permCurrEntries, specMaxEntries=specMaxEntries, pcFramesRec=pcFramesRec, pcTotRecErrs=pcTotRecErrs, bdgdeviceTrapType=bdgdeviceTrapType, bdgdeviceBdgHello=bdgdeviceBdgHello, acqDB=acqDB, pcMMACPort=pcMMACPort, permCreate00=permCreate00, pcBcastRec=pcBcastRec, bdgdeviceTopChgCnt=bdgdeviceTopChgCnt, pcMultiColl=pcMultiColl, bdgPortDesigRoot=bdgPortDesigRoot, pcOwnerName=pcOwnerName, bdgPortState=bdgPortState, acqDispOutp1=acqDispOutp1, bdgdeviceHelloTime=bdgdeviceHelloTime, bdgdeviceHoldTime=bdgdeviceHoldTime, bdgPortName=bdgPortName, specNumEntries=specNumEntries, acqOptions=acqOptions, bdgPortTopChgAck=bdgPortTopChgAck, permDispOutp2=permDispOutp2, bdgdeviceBdgName=bdgdeviceBdgName, bridgeRev1=bridgeRev1, bdgdeviceFrFwd=bdgdeviceFrFwd, pcComment=pcComment, bdgdeviceErr=bdgdeviceErr, permMaxEntries=permMaxEntries, permCreate01=permCreate01, acqCreate00=acqCreate00, bdgPortOversizePackets=bdgPortOversizePackets, pcMMACBoard=pcMMACBoard, bdgdeviceFwdDly=bdgdeviceFwdDly, bdgPortPathCost=bdgPortPathCost, bdgPortDesigBrdg=bdgPortDesigBrdg, bdgdeviceRootPort=bdgdeviceRootPort, bdgdeviceFrFlt=bdgdeviceFrFlt, acqCreate20=acqCreate20, bdgdevice=bdgdevice, pcDeviceName=pcDeviceName, permOptions=permOptions, mAC=mAC, specDeleteFilter=specDeleteFilter, pcDriverRev=pcDriverRev, acqTotalEntries=acqTotalEntries, pcCarrErr=pcCarrErr, filterDB=filterDB, pcLateColls=pcLateColls, permDispOutp1=permDispOutp1, acqDispOutp2=acqDispOutp2, bdgdeviceLocation=bdgdeviceLocation, specialDB=specialDB, bdgPortDisErr=bdgPortDisErr, bdgdeviceDesigRoot=bdgdeviceDesigRoot, permStats=permStats, bdgTables=bdgTables, bdgPortFrFilt=bdgPortFrFilt, specStats=specStats, bdgPortColl=bdgPortColl)
