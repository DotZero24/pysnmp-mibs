...
h3cL2VpnPwe3ScalarGroup=_H3cL2VpnPwe3ScalarGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,78,1))
class _H3cPwVcTrapOpen_Type(TruthValue):defaultValue=2
_H3cPwVcTrapOpen_Type.__name__=_I
_H3cPwVcTrapOpen_Object=MibScalar
h3cPwVcTrapOpen=_H3cPwVcTrapOpen_Object((1,3,6,1,4,1,2011,10,2,78,1,1),_H3cPwVcTrapOpen_Type())
...
h3cL2VpnPwe3Table=_H3cL2VpnPwe3Table_ObjectIdentity((1,3,6,1,4,1,2011,10,2,78,2))
_H3cPwVcTable_Object=MibTable
h3cPwVcTable=_H3cPwVcTable_Object((1,3,6,1,4,1,2011,10,2,78,2,1))
if mibBuilder.loadTexts:h3cPwVcTable.setStatus(_B)
_H3cPwVcEntry_Object=MibTableRow
h3cPwVcEntry=_H3cPwVcEntry_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1))
...
h3cPwVcIndex=_H3cPwVcIndex_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,1),_H3cPwVcIndex_Type())
...
h3cPwVcID=_H3cPwVcID_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,2),_H3cPwVcID_Type())
...
h3cPwVcType=_H3cPwVcType_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,3),_H3cPwVcType_Type())
...
h3cPwVcPeerAddr=_H3cPwVcPeerAddr_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,4),_H3cPwVcPeerAddr_Type())
...
h3cPwVcMtu=_H3cPwVcMtu_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,5),_H3cPwVcMtu_Type())
...
hwPwVcCfgType=_HwPwVcCfgType_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,6),_HwPwVcCfgType_Type())
...
h3cPwVcInboundLabel=_H3cPwVcInboundLabel_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,7),_H3cPwVcInboundLabel_Type())
...
h3cPwVcOutboundLabel=_H3cPwVcOutboundLabel_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,8),_H3cPwVcOutboundLabel_Type())
...
h3cPwVcIfIndex=_H3cPwVcIfIndex_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,9),_H3cPwVcIfIndex_Type())
...
h3cPwVcAcStatus=_H3cPwVcAcStatus_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,10),_H3cPwVcAcStatus_Type())
...
h3cPwVcStatus=_H3cPwVcStatus_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,11),_H3cPwVcStatus_Type())
...
h3cPwVcRowStatus=_H3cPwVcRowStatus_Object((1,3,6,1,4,1,2011,10,2,78,2,1,1,12),_H3cPwVcRowStatus_Type())
