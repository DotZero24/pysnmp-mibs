# SNMP MIB module (H3C-L2VPN-PWE3-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-L2VPN-PWE3-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:20:44 2025
...
h3cPwVcIndex = _H3cPwVcIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 1),
    _H3cPwVcIndex_Type()
)
...
h3cPwVcID = _H3cPwVcID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 2),
    _H3cPwVcID_Type()
)
...
h3cPwVcType = _H3cPwVcType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 3),
    _H3cPwVcType_Type()
)
...
h3cPwVcPeerAddr = _H3cPwVcPeerAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 4),
...
h3cPwVcMtu = _H3cPwVcMtu_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 5),
    _H3cPwVcMtu_Type()
)
...
hwPwVcCfgType = _HwPwVcCfgType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 6),
    _HwPwVcCfgType_Type()
)
...
h3cPwVcInboundLabel = _H3cPwVcInboundLabel_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 7),
...
h3cPwVcOutboundLabel = _H3cPwVcOutboundLabel_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 8),
...
h3cPwVcIfIndex = _H3cPwVcIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 9),
...
h3cPwVcAcStatus = _H3cPwVcAcStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 10),
...
h3cPwVcStatus = _H3cPwVcStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 11),
    _H3cPwVcStatus_Type()
)
...
h3cPwVcRowStatus = _H3cPwVcRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 2, 1, 1, 12),
...
h3cPwVcSwitchWtoP = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 78, 3, 1)
)
h3cPwVcSwitchWtoP.setObjects(
      *(("H3C-L2VPN-PWE3-MIB", "h3cPwVcID"),
        ("H3C-L2VPN-PWE3-MIB", "h3cPwVcType"),
        ("H3C-L2VPN-PWE3-MIB", "h3cPwVcPeerAddr"),
        ("H3C-L2VPN-PWE3-MIB", "h3cPwVcID"),
        ("H3C-L2VPN-PWE3-MIB", "h3cPwVcType"),
        ("H3C-L2VPN-PWE3-MIB", "h3cPwVcPeerAddr"))
)
