# SNMP MIB module (A3COM-HUAWEI-USER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-USER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:45:34 2025
...
h3cUserName = _H3cUserName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 1, 1, 1),
    _H3cUserName_Type()
)
...
h3cUserPassword = _H3cUserPassword_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 1, 1, 2),
...
h3cAuthMode = _H3cAuthMode_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 1, 1, 3),
    _H3cAuthMode_Type()
)
...
h3cUserLevel = _H3cUserLevel_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 1, 1, 4),
    _H3cUserLevel_Type()
)
...
h3cUserState = _H3cUserState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 1, 1, 5),
    _H3cUserState_Type()
)
...
h3cUserInfoRowStatus = _H3cUserInfoRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 1, 1, 6),
...
h3cUserIndex = _H3cUserIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 1, 1, 7),
    _H3cUserIndex_Type()
)
...
h3cUserAttributeTable = _H3cUserAttributeTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2)
)
if mibBuilder.loadTexts:
...
h3cUserAttributeEntry = _H3cUserAttributeEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1)
)
...
h3cAccessLimit = _H3cAccessLimit_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 1),
...
h3cIdleCut = _H3cIdleCut_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 2),
    _H3cIdleCut_Type()
)
...
h3cIPAddress = _H3cIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 3),
    _H3cIPAddress_Type()
)
...
h3cNasIPAddress = _H3cNasIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 4),
...
h3cSlotNum = _H3cSlotNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 5),
    _H3cSlotNum_Type()
)
...
h3cSubSlotNum = _H3cSubSlotNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 6),
    _H3cSubSlotNum_Type()
)
...
h3cPortNum = _H3cPortNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 7),
    _H3cPortNum_Type()
)
...
h3cMacAddress = _H3cMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 8),
    _H3cMacAddress_Type()
)
...
h3cVlan = _H3cVlan_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 9),
    _H3cVlan_Type()
)
...
h3cFtpService = _H3cFtpService_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 10),
    _H3cFtpService_Type()
)
...
h3cFtpDirectory = _H3cFtpDirectory_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 11),
...
h3cLanAccessService = _H3cLanAccessService_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 12),
...
h3cSshService = _H3cSshService_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 13),
    _H3cSshService_Type()
)
...
h3cTelnetService = _H3cTelnetService_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 14),
...
h3cTerminalService = _H3cTerminalService_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 15),
...
h3cExpirationDate = _H3cExpirationDate_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 16),
...
h3cUserGroup = _H3cUserGroup_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 17),
    _H3cUserGroup_Type()
)
...
h3cPortalService = _H3cPortalService_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 18),
...
h3cPPPService = _H3cPPPService_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 19),
    _H3cPPPService_Type()
)
...
h3cHttpService = _H3cHttpService_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 20),
...
h3cHttpsService = _H3cHttpsService_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 2, 1, 21),
...
h3cUserMaxNum = _H3cUserMaxNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 3),
    _H3cUserMaxNum_Type()
)
...
h3cUserCurrNum = _H3cUserCurrNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 4),
...
h3cUserIndexIndicator = _H3cUserIndexIndicator_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 5),
...
h3cUserRole = _H3cUserRole_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 6, 1, 1),
    _H3cUserRole_Type()
)
...
h3cUserRoleStatus = _H3cUserRoleStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 1, 6, 1, 2),
...
h3cUserGroupInfoEntry = _H3cUserGroupInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 2, 1, 1)
)
h3cUserGroupInfoEntry.setIndexNames(
    (0, "A3COM-HUAWEI-USER-MIB", "h3cUserGroupName"),
)
if mibBuilder.loadTexts:
...
h3cUserGroupName = _H3cUserGroupName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 2, 1, 1, 1),
...
h3cUserGroupInfoRowStatus = _H3cUserGroupInfoRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 12, 2, 1, 1, 2),
