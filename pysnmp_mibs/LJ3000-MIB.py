#
# PySNMP MIB module LJ3000-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/LJ3000-MIB
...
print_internal_page = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 5, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 7, 8, 9, 100, 101, 252, 253, 254, 255, 256, 258, 259, 260, 350, 450))).clone(namedValues=NamedValues(("eNotPrintingAnInternalPage", 1), ("ePrintingAnUnknownInternalPage", 2), ("eDeviceDemoPage1ConfigurationPage", 3), ("eDeviceDemoPage2", 4), ("eDeviceDemoPage5ErrorLog", 7), ("eDeviceDemoPage6FileSystemDirectoryListing", 8), ("eDeviceDemoPage7MenuMap", 9), ("ePrintUsagePage", 100), ("eSuppliesPage", 101), ("eDeviceAutoCleaningPage", 252), ("eDeviceCleaningPage", 253), ("eDevicePaperPathTest", 254), ("eDevicePageRegistrationPage", 255), ("ePrintQualityPages", 256), ("eColorPaletteRGBPage", 258), ("eColorPaletteCMYKPage", 259), ("eDevicePageDiagnosticsPage", 260), ("ePCLFontList1", 350), ("ePSFontList", 450)))).setLabel("print-internal-page").setMaxAccess("readwrite")
...
consumable_status_web_service_access_control = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 76), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1))).clone(namedValues=NamedValues(("eUserControlledAccess", 0), ("eForcedAccess", 1)))).setLabel("consumable-status-web-service-access-control").setMaxAccess("readonly")
...
mibBuilder.exportSymbols("LJ3000-MIB", pml=pml, mio1_type=mio1_type, media20=media20, DisplayString=DisplayString, media4_page_count=media4_page_count, error38_time_stamp=error38_time_stamp, simm3_bank1_type=simm3_bank1_type, media10_short_name=media10_short_name, error31_code=error31_code, media24_page_count=media24_page_count, error22=error22, postscript_total_page_count=postscript_total_page_count, media1=media1, simm4_bank=simm4_bank, media1_page_count=media1_page_count, error35_time_stamp=error35_time_stamp, media6_short_name=media6_short_name, media9=media9, error25_code=error25_code, error2_code=error2_code, destination_subsystem=destination_subsystem, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, web_server_url=web_server_url, error23_code=error23_code, clearable_warning=clearable_warning, job_info_attr_12=job_info_attr_12, firmware_download_write_status_supported=firmware_download_write_status_supported, service_id=service_id, north_edge_offset=north_edge_offset, channelprinteralert=channelprinteralert, error11=error11, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, interface=interface, mio1_ip_address=mio1_ip_address, error44_time_stamp=error44_time_stamp, held_job_security=held_job_security, error47_time_stamp=error47_time_stamp, error33_code=error33_code, error43=error43, simm4_bank1_type=simm4_bank1_type, speed_energy_usage=speed_energy_usage, settings_outbin=settings_outbin, tray3_media_size_loaded=tray3_media_size_loaded, media16_short_name=media16_short_name, print_meter=print_meter, firmware_download_name=firmware_download_name, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, media8=media8, held_job_delete=held_job_delete, job_info_pages_printed=job_info_pages_printed, error5_time_stamp=error5_time_stamp, usb_driver_name=usb_driver_name, usb_device_kind=usb_device_kind, tray2_phd=tray2_phd, job_info_physical_outbins_used=job_info_physical_outbins_used, media16_engine_media_mode=media16_engine_media_mode, cartridge_out_override_control=cartridge_out_override_control, on_off_line=on_off_line, error40_code=error40_code, media2_engine_media_mode=media2_engine_media_mode, error14_time_stamp=error14_time_stamp, media6_name=media6_name, simm2_bank1_capacity=simm2_bank1_capacity, pdl_pcl=pdl_pcl, print_internal_page=print_internal_page, simm5_bank2_capacity=simm5_bank2_capacity, supply_out_action_support=supply_out_action_support, job_info_accounting_black_dots=job_info_accounting_black_dots, override_media_name=override_media_name, spooler=spooler, intray=intray, consumable_pages_printed_with_supply=consumable_pages_printed_with_supply, rpc_bound_protocol_address=rpc_bound_protocol_address, simm3_bank1=simm3_bank1, default_vmi=default_vmi, consumable_string_information_reset=consumable_string_information_reset, marking_agent_highlights_density_setting=marking_agent_highlights_density_setting, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, simm3_capacity=simm3_capacity, device_name=device_name, error35=error35, mopy_mode=mopy_mode, job_input_auto_continue_mode=job_input_auto_continue_mode, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, error37_time_stamp=error37_time_stamp, error48=error48, simm1_bank1=simm1_bank1, settings_print_media=settings_print_media, mio1_manufacturing_info=mio1_manufacturing_info, media_info=media_info, media_names_available=media_names_available, media21_name=media21_name, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, media23_engine_media_mode=media23_engine_media_mode, settings_system=settings_system, error50=error50, usb_serial_number=usb_serial_number, autocleaning_page_frequency=autocleaning_page_frequency, printer_calibration_cpr=printer_calibration_cpr, error12_time_stamp=error12_time_stamp, form_feed_needed=form_feed_needed, upgradable_devices_version=upgradable_devices_version, simm3_bank2_type=simm3_bank2_type, marker_density_calibration=marker_density_calibration, ram_disk_mode=ram_disk_mode, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, held_job_pin=held_job_pin, custom_paper_feed_dim=custom_paper_feed_dim, error5_code=error5_code, media22_short_name=media22_short_name, settings_file_system=settings_file_system, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, media7_engine_media_mode=media7_engine_media_mode, media7_short_name=media7_short_name, media17_name=media17_name, error15=error15, error44=error44, resource_manager=resource_manager, error25_time_stamp=error25_time_stamp, simm5_bank2=simm5_bank2, control_panel_button_press=control_panel_button_press, tray1_media_size_loaded=tray1_media_size_loaded, engine_media_modes_supported1=engine_media_modes_supported1, media19_engine_media_mode=media19_engine_media_mode, simm5_capacity=simm5_capacity, error13_time_stamp=error13_time_stamp, error1=error1, consumables_life=consumables_life, error7=error7, job_input_auto_continue_timeout=job_input_auto_continue_timeout, print_engine_revision=print_engine_revision, usb=usb, simm=simm, media14=media14, settings_marking_agent=settings_marking_agent, device=device, error42=error42, mio1_model_name=mio1_model_name, error8_time_stamp=error8_time_stamp, error49_time_stamp=error49_time_stamp, mono_color_switching_mode=mono_color_switching_mode, held_job_user_name=held_job_user_name, printer_cal_cpr_page_count=printer_cal_cpr_page_count, mio4_ip_address=mio4_ip_address, media9_engine_media_mode=media9_engine_media_mode, finisher_image_rotation=finisher_image_rotation, background_message1=background_message1, error20=error20, operating_system=operating_system, job_info_accounting_finishing_options=job_info_accounting_finishing_options, port1_parallel_bidirectionality=port1_parallel_bidirectionality, total_color_page_count=total_color_page_count, media15_name=media15_name, error2=error2, active_print_jobs=active_print_jobs, pjl=pjl, status_mass_storage_bd=status_mass_storage_bd, error10_time_stamp=error10_time_stamp, error39_time_stamp=error39_time_stamp, error11_code=error11_code, mio4_manufacturing_info=mio4_manufacturing_info, simm1_bank2=simm1_bank2, media12_engine_media_mode=media12_engine_media_mode, simm5_bank2_type=simm5_bank2_type, web_server_security=web_server_security, error49_code=error49_code, cancel_job=cancel_job, held_job_print=held_job_print, control_panel_display_graphical_contents=control_panel_display_graphical_contents, outbin1=outbin1, media1_name=media1_name, consumables_status=consumables_status, timestamp=timestamp, media10=media10, error22_time_stamp=error22_time_stamp, media11_short_name=media11_short_name, consumable_status_web_service_access_control=consumable_status_web_service_access_control, job_output_auto_continue_timeout=job_output_auto_continue_timeout, simm3_bank2_capacity=simm3_bank2_capacity, error30=error30, media18=media18, error50_code=error50_code, marking_agent_midtones_density_setting=marking_agent_midtones_density_setting, simm3_bank1_capacity=simm3_bank1_capacity, io_switch=io_switch, error4_time_stamp=error4_time_stamp, error19_code=error19_code, error39_code=error39_code, mio4_model_name=mio4_model_name, tray1_phd=tray1_phd, error21=error21, media4=media4, remote_upgrade_enable=remote_upgrade_enable, file_systems=file_systems, error2_time_stamp=error2_time_stamp, error15_code=error15_code, consumable_status_web_service_access_data=consumable_status_web_service_access_data, consumable_reorder_url=consumable_reorder_url, simm4_bank2=simm4_bank2, duplex_page_count=duplex_page_count, media21_page_count=media21_page_count, media4_name=media4_name, usb_manufacturer_name=usb_manufacturer_name, device_system=device_system, media4_engine_media_mode=media4_engine_media_mode, upgradable_devices_current_state=upgradable_devices_current_state, media3_name=media3_name, simm4_bank2_type=simm4_bank2_type, media5_short_name=media5_short_name, media13_engine_media_mode=media13_engine_media_mode, color_supply_out_action=color_supply_out_action, error9=error9, mio=mio, media9_short_name=media9_short_name, settings_spooler=settings_spooler, default_media_size=default_media_size, usb_product_id=usb_product_id, media22_name=media22_name, file_system4_initialize_volume=file_system4_initialize_volume, file_system4=file_system4, error8=error8, error19_time_stamp=error19_time_stamp, hold_job_timeout=hold_job_timeout, firmware_download_version=firmware_download_version, media18_name=media18_name, consumable_status=consumable_status, held_job_enable=held_job_enable, source_subsystem=source_subsystem, media_modes=media_modes, outbin1_override_mode=outbin1_override_mode, printer_cal_dhalf_utc=printer_cal_dhalf_utc, background_message2=background_message2, settings_mass_storage_bd=settings_mass_storage_bd, background_status_msg_line2_part1=background_status_msg_line2_part1, simm2_bank1=simm2_bank1, default_lines_per_page=default_lines_per_page, socket_ping=socket_ping, media20_name=media20_name, job_info_requested_originals=job_info_requested_originals, display=display, mass_storage_resources=mass_storage_resources, error34=error34, job_info_accounting_media_type=job_info_accounting_media_type, simm5_bank1=simm5_bank1, media7=media7, held_job_quantity=held_job_quantity, error17_code=error17_code, default_copies=default_copies, simm5=simm5, printer_cal_cpr_data=printer_cal_cpr_data, media17=media17, error19=error19, job_info_attr_6=job_info_attr_6, error46_code=error46_code)
mibBuilder.exportSymbols("LJ3000-MIB", job_info_attr_15=job_info_attr_15, media14_page_count=media14_page_count, simm3_bank=simm3_bank, error43_time_stamp=error43_time_stamp, localization_languages_supported=localization_languages_supported, install_date=install_date, menus=menus, error3=error3, pcl_total_page_count=pcl_total_page_count, error3_time_stamp=error3_time_stamp, status_prt_eng=status_prt_eng, id=id, consumable_string_information=consumable_string_information, error37=error37, show_address=show_address, job_info_change_id=job_info_change_id, os_execute_file=os_execute_file, error36=error36, media20_short_name=media20_short_name, auto_continue=auto_continue, media3_engine_media_mode=media3_engine_media_mode, media21_engine_media_mode=media21_engine_media_mode, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, media2=media2, error26_time_stamp=error26_time_stamp, error16=error16, settings_webserver=settings_webserver, media12_name=media12_name, error45_time_stamp=error45_time_stamp, media18_short_name=media18_short_name, firmware_download_maximum_write_count=firmware_download_maximum_write_count, error6_code=error6_code, pcl_default_font_height=pcl_default_font_height, tables=tables, marking_agent_density=marking_agent_density, media10_engine_media_mode=media10_engine_media_mode, intray3=intray3, error27_code=error27_code, media9_name=media9_name, simm5_bank=simm5_bank, simm3_type=simm3_type, error7_time_stamp=error7_time_stamp, media_number_of_type_supported=media_number_of_type_supported, fw_rom_datecode=fw_rom_datecode, io=io, model_number=model_number, pcl_default_font_width=pcl_default_font_width, simm2_bank2_capacity=simm2_bank2_capacity, error29_code=error29_code, simm4=simm4, error6_time_stamp=error6_time_stamp, cold_reset_media_size=cold_reset_media_size, media1_short_name=media1_short_name, media24_short_name=media24_short_name, current_job_parsing_id=current_job_parsing_id, error4_code=error4_code, simm5_bank1_capacity=simm5_bank1_capacity, override_media_size=override_media_size, printer_calibration_dhalf=printer_calibration_dhalf, media5_name=media5_name, media13=media13, upgradable_devices=upgradable_devices, printer_cal_dhalf_page_count=printer_cal_dhalf_page_count, errorlog=errorlog, hp=hp, job_info_attr_9=job_info_attr_9, error37_code=error37_code, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, media24_engine_media_mode=media24_engine_media_mode, job_info_stage=job_info_stage, error26=error26, intray2=intray2, media14_name=media14_name, simm2_capacity=simm2_capacity, media5=media5, job=job, error33=error33, status_pdl=status_pdl, held_job_control=held_job_control, job_info_attr_7=job_info_attr_7, media6_engine_media_mode=media6_engine_media_mode, settings_io=settings_io, background_status_msg_line1_part1=background_status_msg_line1_part1, mass_storage_resource_change_counter=mass_storage_resource_change_counter, page_frame_memory_available=page_frame_memory_available, media15_page_count=media15_page_count, sleep_mode=sleep_mode, supply_after_out_state=supply_after_out_state, job_info_attr_5=job_info_attr_5, host_application_available_memory=host_application_available_memory, job_info=job_info, remote_procedure_call=remote_procedure_call, error28_code=error28_code, error21_time_stamp=error21_time_stamp, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, ram_disk_size=ram_disk_size, job_info_accounting_media_size=job_info_accounting_media_size, media13_page_count=media13_page_count, error42_code=error42_code, printer_cal_cpr_utc=printer_cal_cpr_utc, media13_short_name=media13_short_name, simm1_bank1_type=simm1_bank1_type, outbins=outbins, error45_code=error45_code, pysmi_continue=pysmi_continue, consumable_current_state=consumable_current_state, display_status=display_status, error29_time_stamp=error29_time_stamp, media20_page_count=media20_page_count, error20_code=error20_code, error_log_clear=error_log_clear, media3=media3, control_panel_display=control_panel_display, mio4=mio4, media2_short_name=media2_short_name, media6=media6, media11_engine_media_mode=media11_engine_media_mode, media6_page_count=media6_page_count, job_info_attr_3=job_info_attr_3, error31=error31, error35_code=error35_code, media14_engine_media_mode=media14_engine_media_mode, job_info_pages_processed=job_info_pages_processed, job_info_outcome=job_info_outcome, supplies_replace_action_at_setting=supplies_replace_action_at_setting, error6=error6, media17_engine_media_mode=media17_engine_media_mode, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, error47=error47, media16=media16, error38=error38, media14_short_name=media14_short_name, consumables_1=consumables_1, media_counts=media_counts, outbin=outbin, energy_star=energy_star, job_info_accounting_job_type=job_info_accounting_job_type, media17_short_name=media17_short_name, error18=error18, file_system=file_system, job_info_attr_8=job_info_attr_8, simm4_bank1=simm4_bank1, error41=error41, media16_name=media16_name, webserver_proc_sub=webserver_proc_sub, simm3=simm3, engine_parameter=engine_parameter, simm4_capacity=simm4_capacity, error41_code=error41_code, consumable_notification_status=consumable_notification_status, default_media_name=default_media_name, port1=port1, error9_code=error9_code, media2_page_count=media2_page_count, usb_interface=usb_interface, printer_cal_dhalf_data2=printer_cal_dhalf_data2, status_rpc=status_rpc, intray1=intray1, default_custom_paper_dim_unit=default_custom_paper_dim_unit, media1_engine_media_mode=media1_engine_media_mode, settings_pdl=settings_pdl, error22_code=error22_code, media23=media23, error12=error12, error1_time_stamp=error1_time_stamp, ports=ports, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, firmware_download_write_time=firmware_download_write_time, file_system2=file_system2, mio1=mio1, error24_time_stamp=error24_time_stamp, job_info_io_source=job_info_io_source, job_info_outbins_used=job_info_outbins_used, media12_short_name=media12_short_name, held_job_info=held_job_info, error13_code=error13_code, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, reprint=reprint, test=test, simm4_bank1_capacity=simm4_bank1_capacity, firmware_download=firmware_download, settings_prt_eng=settings_prt_eng, pdl=pdl, media22_engine_media_mode=media22_engine_media_mode, file_system_max_open_files=file_system_max_open_files, error38_code=error38_code, media_size=media_size, media20_engine_media_mode=media20_engine_media_mode, media19_page_count=media19_page_count, job_info_attribute=job_info_attribute, job_info_attr_13=job_info_attr_13, upgradable_devices_write_time=upgradable_devices_write_time, tray3_phd=tray3_phd, socket_ping_job_events_version=socket_ping_job_events_version, error27_time_stamp=error27_time_stamp, usb_product_description=usb_product_description, simm1_bank1_capacity=simm1_bank1_capacity, error48_code=error48_code, media9_page_count=media9_page_count, error50_time_stamp=error50_time_stamp, asset_number=asset_number, default_custom_paper_feed_dim=default_custom_paper_feed_dim, simm1_bank=simm1_bank, media17_page_count=media17_page_count, simm1_bank2_capacity=simm1_bank2_capacity, media3_page_count=media3_page_count, job_info_attr_16=job_info_attr_16, background_message=background_message, media10_name=media10_name, netPMLmgmt=netPMLmgmt, media19=media19, device_configure=device_configure, io_timeout=io_timeout, media_types=media_types, engine_self_diagnostic=engine_self_diagnostic, media11_page_count=media11_page_count, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, media7_name=media7_name, error30_code=error30_code, media22=media22, error31_time_stamp=error31_time_stamp, error36_time_stamp=error36_time_stamp, held_job_job_name=held_job_job_name, control_panel_display_contents_crc=control_panel_display_contents_crc, error14_code=error14_code, maximum_ram_disk_memory=maximum_ram_disk_memory, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, error17=error17, error1_code=error1_code, media19_short_name=media19_short_name, usb_host_supported=usb_host_supported, settings_intray=settings_intray, media8_name=media8_name, media13_name=media13_name, job_info_accounting=job_info_accounting, job_info_name1=job_info_name1, error27=error27, error5=error5, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, marking_agent_shadows_density_setting=marking_agent_shadows_density_setting, supply_out_device_state=supply_out_device_state, usb_vendor_id=usb_vendor_id, simm3_bank2=simm3_bank2, media24=media24, error49=error49, error45=error45, printer_average=printer_average, held_job_retention=held_job_retention, mass_storage_resource_changed=mass_storage_resource_changed, settings_job=settings_job, error24=error24, simm5_bank1_type=simm5_bank1_type, simm2_bank2=simm2_bank2)
mibBuilder.exportSymbols("LJ3000-MIB", simm2=simm2, error46=error46, simm1_type=simm1_type, error48_time_stamp=error48_time_stamp, error41_time_stamp=error41_time_stamp, error25=error25, form_feed=form_feed, media23_page_count=media23_page_count, consumable_life_low_threshold=consumable_life_low_threshold, intrays=intrays, firmware_download_write_count=firmware_download_write_count, media4_short_name=media4_short_name, consumables=consumables, error16_time_stamp=error16_time_stamp, perm_store_init_occurred=perm_store_init_occurred, job_info_state=job_info_state, error47_code=error47_code, media22_page_count=media22_page_count, processing_subsystem=processing_subsystem, pcl_default_font_source=pcl_default_font_source, job_info_attr_14=job_info_attr_14, error33_time_stamp=error33_time_stamp, error36_code=error36_code, pdl_postscript=pdl_postscript, printer_cal_dhalf_data1=printer_cal_dhalf_data1, print_media=print_media, error3_code=error3_code, upgradable_devices_write_count=upgradable_devices_write_count, media18_engine_media_mode=media18_engine_media_mode, simm4_bank2_capacity=simm4_bank2_capacity, simm5_type=simm5_type, media12_page_count=media12_page_count, error20_time_stamp=error20_time_stamp, simm1_bank2_type=simm1_bank2_type, self_test=self_test, held_job_set_queue_size=held_job_set_queue_size, postscript_print_errors=postscript_print_errors, mio4_type=mio4_type, media15_short_name=media15_short_name, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, media23_name=media23_name, error30_time_stamp=error30_time_stamp, printer_cal_dhalf_data=printer_cal_dhalf_data, firmware_download_current_state=firmware_download_current_state, error7_code=error7_code, marking_agent=marking_agent, simm2_bank=simm2_bank, error10_code=error10_code, overflow_bin=overflow_bin, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, simm2_bank1_type=simm2_bank1_type, rpc_bind_protocol_address=rpc_bind_protocol_address, error15_time_stamp=error15_time_stamp, error9_time_stamp=error9_time_stamp, error32_time_stamp=error32_time_stamp, error24_code=error24_code, error43_code=error43_code, direct_connect_ports_enable=direct_connect_ports_enable, error23_time_stamp=error23_time_stamp, media21_short_name=media21_short_name, port1_parallel_speed=port1_parallel_speed, file_system_delete_files=file_system_delete_files, error28=error28, held_job=held_job, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, media15=media15, job_info_name2=job_info_name2, error32_code=error32_code, upgradable_devices_name=upgradable_devices_name, media21=media21, upgradable_devices_max_write_count=upgradable_devices_max_write_count, formatter_serial_number=formatter_serial_number, channelnumberofchannels=channelnumberofchannels, file_system3=file_system3, localization_countries_supported=localization_countries_supported, job_info_attr_1=job_info_attr_1, file_system3_initialize_volume=file_system3_initialize_volume, job_info_size=job_info_size, media24_name=media24_name, model_name=model_name, job_info_pages_in_original=job_info_pages_in_original, error39=error39, error13=error13, error16_code=error16_code, media11_name=media11_name, media23_short_name=media23_short_name, error40=error40, fw_rom_revision=fw_rom_revision, device_configure_printer_parameters=device_configure_printer_parameters, media8_engine_media_mode=media8_engine_media_mode, job_info_attr_10=job_info_attr_10, simm4_type=simm4_type, error8_code=error8_code, error26_code=error26_code, autocleaning_page_size=autocleaning_page_size, error34_time_stamp=error34_time_stamp, print_engine=print_engine, media8_short_name=media8_short_name, input_tray_auto_select=input_tray_auto_select, error32=error32, job_info_printed_originals=job_info_printed_originals, job_being_parsed=job_being_parsed, collated_originals_support=collated_originals_support, control_panel_supplies_status_message=control_panel_supplies_status_message, media15_engine_media_mode=media15_engine_media_mode, pcl_default_font_number=pcl_default_font_number, media10_page_count=media10_page_count, supply_out_user_configured_override_limit=supply_out_user_configured_override_limit, consumable_string=consumable_string, media19_name=media19_name, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, mass_storage_block_driver=mass_storage_block_driver, error18_time_stamp=error18_time_stamp, media7_page_count=media7_page_count, error28_time_stamp=error28_time_stamp, tray2_media_size_loaded=tray2_media_size_loaded, media16_page_count=media16_page_count, error29=error29, error4=error4, file_system2_initialize_volume=file_system2_initialize_volume, configurable_low_threshold_setting=configurable_low_threshold_setting, job_info_attr_4=job_info_attr_4, error21_code=error21_code, error17_time_stamp=error17_time_stamp, non_assured_oht_page_count=non_assured_oht_page_count, simm1=simm1, media5_page_count=media5_page_count, simm2_type=simm2_type, error10=error10, error23=error23, error11_time_stamp=error11_time_stamp, error40_time_stamp=error40_time_stamp, error12_code=error12_code, error46_time_stamp=error46_time_stamp, serial_number=serial_number, media2_name=media2_name, media5_engine_media_mode=media5_engine_media_mode, channel=channel, consumable_life_usage_units=consumable_life_usage_units, error18_code=error18_code, job_info_attr_11=job_info_attr_11, device_location=device_location, media18_page_count=media18_page_count, custom_paper_xfeed_dim=custom_paper_xfeed_dim, error42_time_stamp=error42_time_stamp, error44_code=error44_code, job_info_page_count_current_original=job_info_page_count_current_original, simm1_capacity=simm1_capacity, simm2_bank2_type=simm2_bank2_type, job_info_accounting_color_usage_log=job_info_accounting_color_usage_log, status_system=status_system, error14=error14, settings_rpc=settings_rpc, media12=media12, media11=media11, media3_short_name=media3_short_name, job_info_attr_2=job_info_attr_2, error34_code=error34_code, media8_page_count=media8_page_count)
