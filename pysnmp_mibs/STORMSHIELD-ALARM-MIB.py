...
mibBuilder.exportSymbols("STORMSHIELD-ALARM-MIB", snsASif=snsASif, PYSNMP_MODULE_ID=snsAlarm, snsAicmpCode=snsAicmpCode, snsADif=snsADif, snsAicmpDaddr=snsAicmpDaddr, snsADname=snsADname, snsATime=snsATime, snsADaddr=snsADaddr, snsAicmpSname=snsAicmpSname, snsAicmpSaddr=snsAicmpSaddr, snsAEntry=snsAEntry, snsAicmpTime=snsAicmpTime, snsASname=snsASname, snsAicmpDname=snsAicmpDname, snsNotification=snsNotification, snsAProto=snsAProto, snsAicmpTable=snsAicmpTable, snsAMessage=snsAMessage, snsATable=snsATable, snsASaddr=snsASaddr, snsAicmpMessage=snsAicmpMessage, snsASport=snsASport, snsAicmpEntry=snsAicmpEntry, snsAIndex=snsAIndex, snsADport=snsADport, snsAlarm=snsAlarm, snsAicmpSif=snsAicmpSif, snsAicmpDif=snsAicmpDif, snsAicmpType=snsAicmpType, snsAicmpIndex=snsAicmpIndex)
