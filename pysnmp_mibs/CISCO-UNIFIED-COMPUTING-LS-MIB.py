...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-LS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:25:27 2025
...
cucsLsAgentPolicyLoadCatalog = _CucsLsAgentPolicyLoadCatalog_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 1, 1, 11),
    _CucsLsAgentPolicyLoadCatalog_Type()
)
cucsLsAgentPolicyLoadCatalog.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsAgentPolicyLoadCatalog.setStatus("current")
...
cucsLsBindingAdminAction = _CucsLsBindingAdminAction_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 2, 1, 12),
    _CucsLsBindingAdminAction_Type()
)
cucsLsBindingAdminAction.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsBindingAdminAction.setStatus("current")
_CucsLsBindingAdminActionTrigger_Type = CucsLsAdminActionTrigger
_CucsLsBindingAdminActionTrigger_Object = MibTableColumn
cucsLsBindingAdminActionTrigger = _CucsLsBindingAdminActionTrigger_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 2, 1, 13),
    _CucsLsBindingAdminActionTrigger_Type()
)
cucsLsBindingAdminActionTrigger.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsBindingAdminActionTrigger.setStatus("current")
...
cucsLsPowerSoftShutdownTimer = _CucsLsPowerSoftShutdownTimer_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 3, 1, 6),
    _CucsLsPowerSoftShutdownTimer_Type()
)
cucsLsPowerSoftShutdownTimer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsPowerSoftShutdownTimer.setStatus("current")
...
cucsLsRequirementAdminAction = _CucsLsRequirementAdminAction_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 4, 1, 14),
    _CucsLsRequirementAdminAction_Type()
)
cucsLsRequirementAdminAction.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsRequirementAdminAction.setStatus("current")
...
cucsLsRequirementAdminActionTrigger = _CucsLsRequirementAdminActionTrigger_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 4, 1, 15),
    _CucsLsRequirementAdminActionTrigger_Type()
)
cucsLsRequirementAdminActionTrigger.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsRequirementAdminActionTrigger.setStatus("current")
...
cucsLsServerOperPowerSyncPolicyName = _CucsLsServerOperPowerSyncPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 5, 1, 78),
    _CucsLsServerOperPowerSyncPolicyName_Type()
)
cucsLsServerOperPowerSyncPolicyName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsServerOperPowerSyncPolicyName.setStatus("current")
_CucsLsServerPowerSyncPolicyName_Type = SnmpAdminString
_CucsLsServerPowerSyncPolicyName_Object = MibTableColumn
cucsLsServerPowerSyncPolicyName = _CucsLsServerPowerSyncPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 5, 1, 79),
    _CucsLsServerPowerSyncPolicyName_Type()
)
cucsLsServerPowerSyncPolicyName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsServerPowerSyncPolicyName.setStatus("current")
_CucsLsServerGraphicsCardPolicyName_Type = SnmpAdminString
_CucsLsServerGraphicsCardPolicyName_Object = MibTableColumn
cucsLsServerGraphicsCardPolicyName = _CucsLsServerGraphicsCardPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 5, 1, 80),
    _CucsLsServerGraphicsCardPolicyName_Type()
)
cucsLsServerGraphicsCardPolicyName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsServerGraphicsCardPolicyName.setStatus("current")
...
cucsLsServerOperGraphicsCardPolicyName = _CucsLsServerOperGraphicsCardPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 5, 1, 81),
    _CucsLsServerOperGraphicsCardPolicyName_Type()
)
cucsLsServerOperGraphicsCardPolicyName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsServerOperGraphicsCardPolicyName.setStatus("current")
...
cucsLsServerExtensionAssetTag = _CucsLsServerExtensionAssetTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 18, 1, 8),
    _CucsLsServerExtensionAssetTag_Type()
)
cucsLsServerExtensionAssetTag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsServerExtensionAssetTag.setStatus("current")
...
cucsLsIdentityInfoWriteMode = _CucsLsIdentityInfoWriteMode_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 26, 21, 1, 5),
    _CucsLsIdentityInfoWriteMode_Type()
)
cucsLsIdentityInfoWriteMode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsIdentityInfoWriteMode.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsLsObjects": cucsLsObjects,
       ...
       "cucsLsAgentPolicyLoadCatalog": cucsLsAgentPolicyLoadCatalog,
       ...
       "cucsLsBindingAdminAction": cucsLsBindingAdminAction,
       "cucsLsBindingAdminActionTrigger": cucsLsBindingAdminActionTrigger,
       ...
       "cucsLsPowerSoftShutdownTimer": cucsLsPowerSoftShutdownTimer,
       ...
       "cucsLsRequirementAdminAction": cucsLsRequirementAdminAction,
       "cucsLsRequirementAdminActionTrigger": cucsLsRequirementAdminActionTrigger,
       ...
       "cucsLsServerOperPowerSyncPolicyName": cucsLsServerOperPowerSyncPolicyName,
       "cucsLsServerPowerSyncPolicyName": cucsLsServerPowerSyncPolicyName,
       "cucsLsServerGraphicsCardPolicyName": cucsLsServerGraphicsCardPolicyName,
       "cucsLsServerOperGraphicsCardPolicyName": cucsLsServerOperGraphicsCardPolicyName,
       ...
       "cucsLsServerExtensionAssetTag": cucsLsServerExtensionAssetTag,
