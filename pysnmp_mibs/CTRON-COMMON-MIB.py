...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cabletron/CTRON-COMMON-MIB
...
dl, commonRev1, subSysMMAC, subSysDevice, ups = mibBuilder.importSymbols("IRM-OIDS", "dl", "commonRev1", "subSysMMAC", "subSysDevice", "ups")
...
mibBuilder.exportSymbols("CTRON-COMMON-MIB", dlNetAddress=dlNetAddress, chassisAlarmEna=chassisAlarmEna, dlFileName=dlFileName, dlForceBootp=dlForceBootp, fnbPortConnectCompID=fnbPortConnectCompID, fnbConnectRight=fnbConnectRight, dlCommitRAMToFlash=dlCommitRAMToFlash, fPRedund=fPRedund, dlInitiateColdBoot=dlInitiateColdBoot, fPRedundAddrTable=fPRedundAddrTable, fnbPortChanges=fnbPortChanges, dlTftpServerGatewayIPAddress=dlTftpServerGatewayIPAddress, fPRedundEnable=fPRedundEnable, powerEntry=powerEntry, chassisAlarmState=chassisAlarmState, upsDisconnect=upsDisconnect, dlLastServerIPAddress=dlLastServerIPAddress, fnbTRIndex=fnbTRIndex, fnbBypass=fnbBypass, dlFirmwareTop=dlFirmwareTop, chassisFNB=chassisFNB, fnbCSMACDTable=fnbCSMACDTable, deviceDate=deviceDate, dlFirmwareStart=dlFirmwareStart, fPRedundAddrIPAddr=fPRedundAddrIPAddr, upsACLineVoltsIn=upsACLineVoltsIn, fnbPortConnectBoardIndex=fnbPortConnectBoardIndex, deviceTime=deviceTime, eMMEBoardMap=eMMEBoardMap, dlOperStatus=dlOperStatus, dlBootRev=dlBootRev, chassisSlots=chassisSlots, dlLastImageFilename=dlLastImageFilename, powerSupplyId=powerSupplyId, fPRedundNumAddr=fPRedundNumAddr, mRXI=mRXI, fnbRPBypass=fnbRPBypass, fPRedundReset=fPRedundReset, dlFirmwareBase=dlFirmwareBase, upsRevision=upsRevision, powerSupplyRedun=powerSupplyRedun, fnbCSMACDEntry=fnbCSMACDEntry, dlErrorString=dlErrorString, upsDisable=upsDisable, upsBatteryCapacity=upsBatteryCapacity, fnbPortConnectTable=fnbPortConnectTable, dlFlashCount=dlFlashCount, fnbConnect=fnbConnect, tRMMHWAddress=tRMMHWAddress, powerTable=powerTable, fPRedundAddrId=fPRedundAddrId, iRM3PortAssoc=iRM3PortAssoc, upsUpTime=upsUpTime, iRM3FWRev=iRM3FWRev, mRXIHWRev=mRXIHWRev, dlTFTPRequest=dlTFTPRequest, fnbTRTable=fnbTRTable, environment=environment, dlServerName=dlServerName, upsTest=upsTest, fPRedundancy=fPRedundancy, powerSupplyRemoteDisable=powerSupplyRemoteDisable, mRXIFWRev=mRXIFWRev, fPRedundActivePort=fPRedundActivePort, iRM3BPSupport=iRM3BPSupport, dlForceOnBoot=dlForceOnBoot, nB55=nB55, chassis=chassis, fnbCSMACD=fnbCSMACD, chassisType=chassisType, deviceType=deviceType, iRM3=iRM3, eMMEFWRev=eMMEFWRev, nB55HWRev=nB55HWRev, powerSupplyState=powerSupplyState, fnbPortConnectionChanges=fnbPortConnectionChanges, nB55FWRev=nB55FWRev, nB55HWAddress=nB55HWAddress, dlTFTPRequestHost=dlTFTPRequestHost, fnbTREntry=fnbTREntry, tRMMFWRev=tRMMFWRev, fnbPortConnectPortAssignment=fnbPortConnectPortAssignment, fnbPortConnectPortIndex=fnbPortConnectPortIndex, tRMMHWRev=tRMMHWRev, eMMEHWRev=eMMEHWRev, iRM3HWRev=iRM3HWRev, eMME=eMME, eMMEHWAddress=eMMEHWAddress, dlOnLineDownLoad=dlOnLineDownLoad, fPRedundAddAddr=fPRedundAddAddr, fnb2=fnb2, fPRedundDelAddr=fPRedundDelAddr, fnbPortConnect=fnbPortConnect, chassisHWRev=chassisHWRev, fnbPortConnectEntry=fnbPortConnectEntry, upsBatteryVoltsOut=upsBatteryVoltsOut, deviceName=deviceName, fPRedundRetrys=fPRedundRetrys, upsVersion=upsVersion, fnbCSMACDIndex=fnbCSMACDIndex, powerSupplyNum=powerSupplyNum, fPRedundAddrEntry=fPRedundAddrEntry, deviceIPAddress=deviceIPAddress, mRXIHWAddress=mRXIHWAddress, iRM3HWAddress=iRM3HWAddress, upsID=upsID, dlFlashSize=dlFlashSize, fnbTR=fnbTR, fnbConnectLeft=fnbConnectLeft, tRMM=tRMM, fPRedundPollInterval=fPRedundPollInterval)
