...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-CONFIGURATION-CHANGE-MIB
...
etsysConfigChangeCompliance.setObjects(
      *(("ENTERASYS-CONFIGURATION-CHANGE-MIB", "etsysConfigChangeNonVolatileGroup"),
        ("ENTERASYS-CONFIGURATION-CHANGE-MIB", "etsysConfigChangeVolatileGroup"),
        ("ENTERASYS-CONFIGURATION-CHANGE-MIB", "etsysConfigChangeFirmwareGroup"))
)
if mibBuilder.loadTexts:
