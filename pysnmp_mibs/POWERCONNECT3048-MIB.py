# SNMP MIB module (POWERCONNECT3048-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/POWERCONNECT3048-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:10 2025
...
commIndex = _CommIndex_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 1, 1, 1, 1),
    _CommIndex_Type()
)
...
commName = _CommName_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 1, 1, 1, 2),
    _CommName_Type()
)
...
commGet = _CommGet_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 1, 1, 1, 3),
    _CommGet_Type()
)
...
commSet = _CommSet_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 1, 1, 1, 4),
    _CommSet_Type()
)
...
commTrap = _CommTrap_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 1, 1, 1, 5),
    _CommTrap_Type()
)
...
commStatus = _CommStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 1, 1, 1, 6),
    _CommStatus_Type()
)
...
hostIndex = _HostIndex_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 2, 1, 1, 1),
    _HostIndex_Type()
)
...
hostName = _HostName_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 2, 1, 1, 2),
    _HostName_Type()
)
...
hostIP = _HostIP_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 2, 1, 1, 3),
    _HostIP_Type()
)
...
hostComm = _HostComm_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 2, 1, 1, 4),
    _HostComm_Type()
)
...
hostStatus = _HostStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 2, 1, 1, 5),
    _HostStatus_Type()
)
...
configPort = _ConfigPort_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 1),
    _ConfigPort_Type()
)
...
configPortDuplex = _ConfigPortDuplex_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 3),
...
configPortRuntFilt = _ConfigPortRuntFilt_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 4),
...
configPortSrcSecurity = _ConfigPortSrcSecurity_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 5),
...
configPortDataRate = _ConfigPortDataRate_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 6),
...
configPortDuplexOper = _ConfigPortDuplexOper_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 8),
...
configPortDataRateOper = _ConfigPortDataRateOper_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 9),
...
configPortStateOper = _ConfigPortStateOper_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 10),
...
configPortFlowControl = _ConfigPortFlowControl_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 11),
...
configPortDefaultVlanId = _ConfigPortDefaultVlanId_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 12),
...
configPortComments = _ConfigPortComments_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 13),
...
configPortAutoNegotiation = _ConfigPortAutoNegotiation_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 14),
...
configPortFlowControlOper = _ConfigPortFlowControlOper_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 16),
...
configPortGBIC = _ConfigPortGBIC_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 17),
...
configPortFastLink = _ConfigPortFastLink_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 18),
...
configPortPriority = _ConfigPortPriority_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 6, 1, 19),
...
configDiffServEntry = _ConfigDiffServEntry_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 31, 1)
)
configDiffServEntry.setIndexNames(
    (0, "POWERCONNECT3048-MIB", "configDiffServDSCP"),
)
if mibBuilder.loadTexts:
...
configDiffServDSCP = _ConfigDiffServDSCP_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 31, 1, 1),
...
configDiffServPriority = _ConfigDiffServPriority_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 31, 1, 2),
...
configIpFilterEntry = _ConfigIpFilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 36, 1)
)
configIpFilterEntry.setIndexNames(
    (0, "POWERCONNECT3048-MIB", "configIpFilterIpAddress"),
)
if mibBuilder.loadTexts:
...
configIpFilterIpAddress = _ConfigIpFilterIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 36, 1, 1),
...
configIpFilterStatus = _ConfigIpFilterStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 11, 36, 1, 2),
...
vlanId = _VlanId_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 13, 1, 1, 1),
    _VlanId_Type()
)
...
vlanName = _VlanName_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 13, 1, 1, 2),
    _VlanName_Type()
)
...
vlanStatus = _VlanStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 13, 1, 1, 3),
    _VlanStatus_Type()
)
...
vlanPortTable = _VlanPortTable_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 13, 2)
)
if mibBuilder.loadTexts:
    vlanPortTable.setStatus("mandatory")
_VlanPortEntry_Object = MibTableRow
vlanPortEntry = _VlanPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 13, 2, 1)
)
vlanPortEntry.setIndexNames(
    (0, "POWERCONNECT3048-MIB", "vlanPortPortId"),
    (0, "POWERCONNECT3048-MIB", "vlanPortVlanId"),
)
if mibBuilder.loadTexts:
...
vlanPortPortId = _VlanPortPortId_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 13, 2, 1, 1),
...
vlanPortVlanId = _VlanPortVlanId_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 13, 2, 1, 2),
...
vlanPortStatus = _VlanPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 13, 2, 1, 3),
...
vlanPortTaggedMode = _VlanPortTaggedMode_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 13, 2, 1, 4),
...
portTrunkId = _PortTrunkId_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 14, 1, 1, 1),
    _PortTrunkId_Type()
)
...
portTrunkMember = _PortTrunkMember_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 14, 1, 1, 2),
...
portTrunkMemberValue = _PortTrunkMemberValue_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5, 14, 1, 1, 3),
...
mibBuilder.exportSymbols(
    ...
    **{"OwnerString": OwnerString,
       ...
       "dellLan": dellLan,
       "powerconnect3048": powerconnect3048,
