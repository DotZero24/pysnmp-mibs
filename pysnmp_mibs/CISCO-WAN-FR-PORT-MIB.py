...
frPortServiceQueGrp, frPortCnt, frPort, frPortCnf = mibBuilder.importSymbols("BASIS-MIB", "frPortServiceQueGrp", "frPortCnt", "frPort", "frPortCnf")
...
mibBuilder.exportSymbols("CISCO-WAN-FR-PORT-MIB", ciscoWanFrPortSvcGroup=ciscoWanFrPortSvcGroup, rcvPortFramesTaggedFECN=rcvPortFramesTaggedFECN, portHeaderLen=portHeaderLen, frPortStateGrpTable=frPortStateGrpTable, rcvFramesDiscNoChan=rcvFramesDiscNoChan, ciscoWanFrPortConfGroup=ciscoWanFrPortConfGroup, ciscoWanFrPortStatsGroup=ciscoWanFrPortStatsGroup, frPortsUsedLineGrpEntry=frPortsUsedLineGrpEntry, cntPortNum=cntPortNum, frPortsUsedLine=frPortsUsedLine, portEgrSvcBandW=portEgrSvcBandW, portType=portType, portState=portState, rcvPortFramesBECN=rcvPortFramesBECN, portsUsedLine8=portsUsedLine8, ciscoWanFrPortCompliance=ciscoWanFrPortCompliance, portBytesDiscXceedDEThresh=portBytesDiscXceedDEThresh, portsUsedLine4=portsUsedLine4, portsUsedLine5=portsUsedLine5, rcvFramesDiscOverrun=rcvFramesDiscOverrun, xmtPortFramesDiscXceedDEThresh=xmtPortFramesDiscXceedDEThresh, xmtBufNotAvailable=xmtBufNotAvailable, rcvPortFramesDiscard=rcvPortFramesDiscard, frPortServiceQueGrpEntry=frPortServiceQueGrpEntry, xmtPortFramesDiscXceedQDepth=xmtPortFramesDiscXceedQDepth, rcvPortFramesTaggedDE=rcvPortFramesTaggedDE, portLineNum=portLineNum, rcvFramesDiscAlignmentError=rcvFramesDiscAlignmentError, portFileId=portFileId, rcvPortBytesDE=rcvPortBytesDE, portQBwInc=portQBwInc, PYSNMP_MODULE_ID=ciscoWanFrPortMIB, xmtPortBytesDiscXceedQDepth=xmtPortBytesDiscXceedQDepth, frPortStateGrpEntry=frPortStateGrpEntry, portNextAvailable=portNextAvailable, rcvPortKbpsAIR=rcvPortKbpsAIR, portRowStatus=portRowStatus, rcvPortFramesDE=rcvPortFramesDE, frPortCntPortGrp=frPortCntPortGrp, xmtPortBytes=xmtPortBytes, portEgrPercentUtil=portEgrPercentUtil, ciscoWanFrPortMIB=ciscoWanFrPortMIB, portNum=portNum, portIngrSvcBandW=portIngrSvcBandW, portsUsedLine7=portsUsedLine7, rcvPortFrames=rcvPortFrames, portAdmin=portAdmin, portsUsedLine2=portsUsedLine2, rcvPortFramesFECN=rcvPortFramesFECN, xmtPortBytesDE=xmtPortBytesDE, portSvcShareLcn=portSvcShareLcn, rcvFramesAbort=rcvFramesAbort, xmtPortFramesDE=xmtPortFramesDE, xmtPortFramesDuringLMIAlarm=xmtPortFramesDuringLMIAlarm, ciscoWanFrPortServiceQueueGroup=ciscoWanFrPortServiceQueueGroup, rcvFramesUnknownDLCI=rcvFramesUnknownDLCI, ciscoWanFrPortStateGroup=ciscoWanFrPortStateGroup, portsUsedLine1=portsUsedLine1, portSvcLcnLow=portSvcLcnLow, portServiceQueueNo=portServiceQueueNo, rcvBufNotAvailable=rcvBufNotAvailable, xmtFramesUnderrun=xmtFramesUnderrun, frPortsUsedLineIndex=frPortsUsedLineIndex, ciscoWanFrPortMIBConformance=ciscoWanFrPortMIBConformance, portClrButton=portClrButton, portEnhancedSIW=portEnhancedSIW, portBytesDiscXceedQueFull=portBytesDiscXceedQueFull, rcvFramesDiscCRCError=rcvFramesDiscCRCError, portSvcDlciLow=portSvcDlciLow, xmtPortBytesDiscXceedDEThresh=xmtPortBytesDiscXceedDEThresh, frPortServiceQueGrpTable=frPortServiceQueGrpTable, statePortNum=statePortNum, portIngrPercentUtil=portIngrPercentUtil, rcvPortBytes=rcvPortBytes, portEgresQDepth=portEgresQDepth, frServPortNum=frServPortNum, portFrameChkSumType=portFrameChkSumType, ciscoWanFrPortsUsedGroup=ciscoWanFrPortsUsedGroup, frPortCnfPortGrpTable=frPortCnfPortGrpTable, xmtPortKbpsAIR=xmtPortKbpsAIR, rcvPortFramesDiscXceedDEThresh=rcvPortFramesDiscXceedDEThresh, portDs0Speed=portDs0Speed, portDs0ConfigBitMap=portDs0ConfigBitMap, portSignallingState=portSignallingState, rcvPortFramesTaggedBECN=rcvPortFramesTaggedBECN, frPortCnfPortGrpEntry=frPortCnfPortGrpEntry, xmtPortFramesBECN=xmtPortFramesBECN, portEqueueServiceRatio=portEqueueServiceRatio, xmtPortFrames=xmtPortFrames, frPortsUsedLineGrpTable=frPortsUsedLineGrpTable, portBERTEnable=portBERTEnable, rcvFramesDiscIllegalLen=rcvFramesDiscIllegalLen, portDeleteSvcs=portDeleteSvcs, frPortCntPortGrpEntry=frPortCntPortGrpEntry, xmtPortFramesFECN=xmtPortFramesFECN, portEgresDEThresh=portEgresDEThresh, portOversubscribed=portOversubscribed, rcvFramesDiscIllegalHeader=rcvFramesDiscIllegalHeader, ciscoWanFrPortMIBCompliances=ciscoWanFrPortMIBCompliances, rcvLastUnknownDLCI=rcvLastUnknownDLCI, portFlagsBetweenFrames=portFlagsBetweenFrames, ciscoWanFrPortMIBGroups=ciscoWanFrPortMIBGroups, portSvcStatus=portSvcStatus, portOverSubEnable=portOverSubEnable, portSvcLcnHigh=portSvcLcnHigh, xmtPortBytesDuringLMIAlarm=xmtPortBytesDuringLMIAlarm, portM32EgrQueueThresh=portM32EgrQueueThresh, frPortCnfPortGrp=frPortCnfPortGrp, portSvcInUse=portSvcInUse, frPortStateGrp=frPortStateGrp, portSpeed=portSpeed, portsUsedLine3=portsUsedLine3, frPortCntPortGrpTable=frPortCntPortGrpTable, rcvPortBytesDiscXceedDEThresh=rcvPortBytesDiscXceedDEThresh, xmtFramesAbort=xmtFramesAbort, portsUsedLine6=portsUsedLine6, ciscoWanFrPortDs0InDs1Group=ciscoWanFrPortDs0InDs1Group, portEgresECNThresh=portEgresECNThresh, portSvcDlciHigh=portSvcDlciHigh)
