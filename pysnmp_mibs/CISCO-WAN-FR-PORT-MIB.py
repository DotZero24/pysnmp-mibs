...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-WAN-FR-PORT-MIB
...
frPortCnt, frPort, frPortCnf, frPortServiceQueGrp = mibBuilder.importSymbols("BASIS-MIB", "frPortCnt", "frPort", "frPortCnf", "frPortServiceQueGrp")
...
mibBuilder.exportSymbols("CISCO-WAN-FR-PORT-MIB", portFileId=portFileId, portSvcDlciLow=portSvcDlciLow, portDeleteSvcs=portDeleteSvcs, portAdmin=portAdmin, frServPortNum=frServPortNum, portEgresQDepth=portEgresQDepth, portOverSubEnable=portOverSubEnable, rcvFramesDiscAlignmentError=rcvFramesDiscAlignmentError, portsUsedLine6=portsUsedLine6, rcvFramesDiscCRCError=rcvFramesDiscCRCError, portType=portType, portRowStatus=portRowStatus, portQBwInc=portQBwInc, ciscoWanFrPortServiceQueueGroup=ciscoWanFrPortServiceQueueGroup, portNum=portNum, xmtPortFrames=xmtPortFrames, ciscoWanFrPortStatsGroup=ciscoWanFrPortStatsGroup, portBERTEnable=portBERTEnable, frPortCnfPortGrp=frPortCnfPortGrp, portsUsedLine1=portsUsedLine1, portsUsedLine3=portsUsedLine3, portHeaderLen=portHeaderLen, ciscoWanFrPortCompliance=ciscoWanFrPortCompliance, rcvPortKbpsAIR=rcvPortKbpsAIR, rcvPortBytes=rcvPortBytes, xmtPortBytesDuringLMIAlarm=xmtPortBytesDuringLMIAlarm, xmtPortKbpsAIR=xmtPortKbpsAIR, portSvcLcnLow=portSvcLcnLow, portState=portState, portsUsedLine2=portsUsedLine2, cntPortNum=cntPortNum, portSpeed=portSpeed, xmtPortBytesDE=xmtPortBytesDE, ciscoWanFrPortMIBGroups=ciscoWanFrPortMIBGroups, portM32EgrQueueThresh=portM32EgrQueueThresh, ciscoWanFrPortStateGroup=ciscoWanFrPortStateGroup, portsUsedLine4=portsUsedLine4, frPortCntPortGrp=frPortCntPortGrp, rcvFramesDiscOverrun=rcvFramesDiscOverrun, xmtPortBytes=xmtPortBytes, xmtPortFramesDE=xmtPortFramesDE, ciscoWanFrPortSvcGroup=ciscoWanFrPortSvcGroup, ciscoWanFrPortsUsedGroup=ciscoWanFrPortsUsedGroup, rcvPortFramesDiscXceedDEThresh=rcvPortFramesDiscXceedDEThresh, portsUsedLine7=portsUsedLine7, portFrameChkSumType=portFrameChkSumType, portEgresDEThresh=portEgresDEThresh, ciscoWanFrPortConfGroup=ciscoWanFrPortConfGroup, portIngrPercentUtil=portIngrPercentUtil, ciscoWanFrPortMIBConformance=ciscoWanFrPortMIBConformance, xmtPortFramesDuringLMIAlarm=xmtPortFramesDuringLMIAlarm, xmtPortFramesDiscXceedQDepth=xmtPortFramesDiscXceedQDepth, frPortsUsedLine=frPortsUsedLine, portsUsedLine8=portsUsedLine8, rcvPortFramesTaggedFECN=rcvPortFramesTaggedFECN, portFlagsBetweenFrames=portFlagsBetweenFrames, xmtPortBytesDiscXceedQDepth=xmtPortBytesDiscXceedQDepth, rcvPortFramesFECN=rcvPortFramesFECN, portEqueueServiceRatio=portEqueueServiceRatio, portSvcShareLcn=portSvcShareLcn, portNextAvailable=portNextAvailable, rcvPortFramesTaggedDE=rcvPortFramesTaggedDE, PYSNMP_MODULE_ID=ciscoWanFrPortMIB, frPortStateGrp=frPortStateGrp, xmtPortFramesFECN=xmtPortFramesFECN, portBytesDiscXceedQueFull=portBytesDiscXceedQueFull, frPortCntPortGrpTable=frPortCntPortGrpTable, rcvPortBytesDiscXceedDEThresh=rcvPortBytesDiscXceedDEThresh, frPortStateGrpTable=frPortStateGrpTable, portsUsedLine5=portsUsedLine5, xmtPortBytesDiscXceedDEThresh=xmtPortBytesDiscXceedDEThresh, rcvPortFramesBECN=rcvPortFramesBECN, rcvPortFrames=rcvPortFrames, portSvcStatus=portSvcStatus, rcvPortFramesTaggedBECN=rcvPortFramesTaggedBECN, portSvcInUse=portSvcInUse, portDs0Speed=portDs0Speed, frPortServiceQueGrpTable=frPortServiceQueGrpTable, frPortsUsedLineIndex=frPortsUsedLineIndex, portLineNum=portLineNum, xmtFramesAbort=xmtFramesAbort, frPortCntPortGrpEntry=frPortCntPortGrpEntry, ciscoWanFrPortMIB=ciscoWanFrPortMIB, rcvFramesDiscIllegalLen=rcvFramesDiscIllegalLen, portIngrSvcBandW=portIngrSvcBandW, rcvPortFramesDE=rcvPortFramesDE, rcvFramesDiscIllegalHeader=rcvFramesDiscIllegalHeader, rcvBufNotAvailable=rcvBufNotAvailable, portEgrPercentUtil=portEgrPercentUtil, frPortCnfPortGrpTable=frPortCnfPortGrpTable, rcvLastUnknownDLCI=rcvLastUnknownDLCI, frPortsUsedLineGrpEntry=frPortsUsedLineGrpEntry, rcvFramesAbort=rcvFramesAbort, ciscoWanFrPortMIBCompliances=ciscoWanFrPortMIBCompliances, xmtPortFramesBECN=xmtPortFramesBECN, frPortCnfPortGrpEntry=frPortCnfPortGrpEntry, rcvFramesUnknownDLCI=rcvFramesUnknownDLCI, portSvcDlciHigh=portSvcDlciHigh, rcvFramesDiscNoChan=rcvFramesDiscNoChan, portServiceQueueNo=portServiceQueueNo, portClrButton=portClrButton, portSignallingState=portSignallingState, xmtPortFramesDiscXceedDEThresh=xmtPortFramesDiscXceedDEThresh, portEgrSvcBandW=portEgrSvcBandW, portSvcLcnHigh=portSvcLcnHigh, frPortsUsedLineGrpTable=frPortsUsedLineGrpTable, ciscoWanFrPortDs0InDs1Group=ciscoWanFrPortDs0InDs1Group, rcvPortBytesDE=rcvPortBytesDE, portBytesDiscXceedDEThresh=portBytesDiscXceedDEThresh, xmtBufNotAvailable=xmtBufNotAvailable, portOversubscribed=portOversubscribed, rcvPortFramesDiscard=rcvPortFramesDiscard, xmtFramesUnderrun=xmtFramesUnderrun, portEgresECNThresh=portEgresECNThresh, portEnhancedSIW=portEnhancedSIW, statePortNum=statePortNum, frPortStateGrpEntry=frPortStateGrpEntry, portDs0ConfigBitMap=portDs0ConfigBitMap, frPortServiceQueGrpEntry=frPortServiceQueGrpEntry)
