...
# Notes
# -----
# ASN.1 source file://mibs/nortel/S5-ETH-MULTISEG-TOPOLOGY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:17:49 2025
...
s5EnMsTopNmmEnhancedTable = _S5EnMsTopNmmEnhancedTable_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4)
)
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedTable.setStatus("mandatory")
_S5EnMsTopNmmEnhancedEntry_Object = MibTableRow
s5EnMsTopNmmEnhancedEntry = _S5EnMsTopNmmEnhancedEntry_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1)
)
s5EnMsTopNmmEnhancedEntry.setIndexNames(
    (0, "S5-ETH-MULTISEG-TOPOLOGY-MIB", "s5EnMsTopNmmEnhancedSlot"),
    (0, "S5-ETH-MULTISEG-TOPOLOGY-MIB", "s5EnMsTopNmmEnhancedPort"),
    (0, "S5-ETH-MULTISEG-TOPOLOGY-MIB", "s5EnMsTopNmmEnhancedSubPort"),
    (0, "S5-ETH-MULTISEG-TOPOLOGY-MIB", "s5EnMsTopNmmEnhancedIpAddr"),
    (0, "S5-ETH-MULTISEG-TOPOLOGY-MIB", "s5EnMsTopNmmEnhancedSegId"),
)
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedEntry.setStatus("mandatory")


class _S5EnMsTopNmmEnhancedSlot_Type(Integer32):
    """Custom type s5EnMsTopNmmEnhancedSlot based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_S5EnMsTopNmmEnhancedSlot_Type.__name__ = "Integer32"
_S5EnMsTopNmmEnhancedSlot_Object = MibTableColumn
s5EnMsTopNmmEnhancedSlot = _S5EnMsTopNmmEnhancedSlot_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 1),
    _S5EnMsTopNmmEnhancedSlot_Type()
)
s5EnMsTopNmmEnhancedSlot.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedSlot.setStatus("mandatory")


class _S5EnMsTopNmmEnhancedPort_Type(Integer32):
    """Custom type s5EnMsTopNmmEnhancedPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_S5EnMsTopNmmEnhancedPort_Type.__name__ = "Integer32"
_S5EnMsTopNmmEnhancedPort_Object = MibTableColumn
s5EnMsTopNmmEnhancedPort = _S5EnMsTopNmmEnhancedPort_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 2),
    _S5EnMsTopNmmEnhancedPort_Type()
)
s5EnMsTopNmmEnhancedPort.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedPort.setStatus("mandatory")


class _S5EnMsTopNmmEnhancedSubPort_Type(Integer32):
    """Custom type s5EnMsTopNmmEnhancedSubPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_S5EnMsTopNmmEnhancedSubPort_Type.__name__ = "Integer32"
_S5EnMsTopNmmEnhancedSubPort_Object = MibTableColumn
s5EnMsTopNmmEnhancedSubPort = _S5EnMsTopNmmEnhancedSubPort_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 3),
    _S5EnMsTopNmmEnhancedSubPort_Type()
)
s5EnMsTopNmmEnhancedSubPort.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedSubPort.setStatus("mandatory")
_S5EnMsTopNmmEnhancedIpAddr_Type = IpAddress
_S5EnMsTopNmmEnhancedIpAddr_Object = MibTableColumn
s5EnMsTopNmmEnhancedIpAddr = _S5EnMsTopNmmEnhancedIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 4),
    _S5EnMsTopNmmEnhancedIpAddr_Type()
)
s5EnMsTopNmmEnhancedIpAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedIpAddr.setStatus("mandatory")


class _S5EnMsTopNmmEnhancedSegId_Type(Integer32):
    """Custom type s5EnMsTopNmmEnhancedSegId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 16777215),
    )
...
_S5EnMsTopNmmEnhancedSegId_Type.__name__ = "Integer32"
_S5EnMsTopNmmEnhancedSegId_Object = MibTableColumn
s5EnMsTopNmmEnhancedSegId = _S5EnMsTopNmmEnhancedSegId_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 5),
    _S5EnMsTopNmmEnhancedSegId_Type()
)
s5EnMsTopNmmEnhancedSegId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedSegId.setStatus("mandatory")
_S5EnMsTopNmmEnhancedMacAddr_Type = MacAddress
_S5EnMsTopNmmEnhancedMacAddr_Object = MibTableColumn
s5EnMsTopNmmEnhancedMacAddr = _S5EnMsTopNmmEnhancedMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 6),
    _S5EnMsTopNmmEnhancedMacAddr_Type()
)
s5EnMsTopNmmEnhancedMacAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedMacAddr.setStatus("mandatory")
_S5EnMsTopNmmEnhancedChassisType_Type = SnpxChassisType
_S5EnMsTopNmmEnhancedChassisType_Object = MibTableColumn
s5EnMsTopNmmEnhancedChassisType = _S5EnMsTopNmmEnhancedChassisType_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 7),
    _S5EnMsTopNmmEnhancedChassisType_Type()
)
s5EnMsTopNmmEnhancedChassisType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedChassisType.setStatus("mandatory")
_S5EnMsTopNmmEnhancedBkplType_Type = SnpxBackplaneType
_S5EnMsTopNmmEnhancedBkplType_Object = MibTableColumn
s5EnMsTopNmmEnhancedBkplType = _S5EnMsTopNmmEnhancedBkplType_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 8),
    _S5EnMsTopNmmEnhancedBkplType_Type()
)
s5EnMsTopNmmEnhancedBkplType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedBkplType.setStatus("mandatory")


class _S5EnMsTopNmmEnhancedLocalSeg_Type(Integer32):
    """Custom type s5EnMsTopNmmEnhancedLocalSeg based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_S5EnMsTopNmmEnhancedLocalSeg_Type.__name__ = "Integer32"
_S5EnMsTopNmmEnhancedLocalSeg_Object = MibTableColumn
s5EnMsTopNmmEnhancedLocalSeg = _S5EnMsTopNmmEnhancedLocalSeg_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 9),
    _S5EnMsTopNmmEnhancedLocalSeg_Type()
)
s5EnMsTopNmmEnhancedLocalSeg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedLocalSeg.setStatus("mandatory")


class _S5EnMsTopNmmEnhancedCurState_Type(Integer32):
    """Custom type s5EnMsTopNmmEnhancedCurState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_S5EnMsTopNmmEnhancedCurState_Type.__name__ = "Integer32"
_S5EnMsTopNmmEnhancedCurState_Object = MibTableColumn
s5EnMsTopNmmEnhancedCurState = _S5EnMsTopNmmEnhancedCurState_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 4, 1, 10),
    _S5EnMsTopNmmEnhancedCurState_Type()
)
s5EnMsTopNmmEnhancedCurState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedCurState.setStatus("mandatory")
_S5EnMsTopNmmEnhancedEosTable_Object = MibTable
s5EnMsTopNmmEnhancedEosTable = _S5EnMsTopNmmEnhancedEosTable_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 5)
)
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedEosTable.setStatus("mandatory")
_S5EnMsTopNmmEnhancedEosEntry_Object = MibTableRow
s5EnMsTopNmmEnhancedEosEntry = _S5EnMsTopNmmEnhancedEosEntry_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 5, 1)
)
s5EnMsTopNmmEnhancedEosEntry.setIndexNames(
    (0, "S5-ETH-MULTISEG-TOPOLOGY-MIB", "s5EnMsTopNmmEnhancedSlot"),
    (0, "S5-ETH-MULTISEG-TOPOLOGY-MIB", "s5EnMsTopNmmEnhancedPort"),
    (0, "S5-ETH-MULTISEG-TOPOLOGY-MIB", "s5EnMsTopNmmEnhancedSubPort"),
    (0, "S5-ETH-MULTISEG-TOPOLOGY-MIB", "s5EnMsTopNmmEnhancedIpAddr"),
...
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedEosEntry.setStatus("mandatory")


class _S5EnMsTopNmmEnhancedEos_Type(OctetString):
    """Custom type s5EnMsTopNmmEnhancedEos based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 1400),
    )
...
_S5EnMsTopNmmEnhancedEos_Type.__name__ = "OctetString"
_S5EnMsTopNmmEnhancedEos_Object = MibTableColumn
s5EnMsTopNmmEnhancedEos = _S5EnMsTopNmmEnhancedEos_Object(
    (1, 3, 6, 1, 4, 1, 45, 1, 6, 13, 2, 5, 1, 1),
    _S5EnMsTopNmmEnhancedEos_Type()
)
s5EnMsTopNmmEnhancedEos.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    s5EnMsTopNmmEnhancedEos.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"s5EthMultisegTopologyMib": s5EthMultisegTopologyMib,
       ...
       "s5EnMsTopNmmEnhancedTable": s5EnMsTopNmmEnhancedTable,
       "s5EnMsTopNmmEnhancedEntry": s5EnMsTopNmmEnhancedEntry,
       "s5EnMsTopNmmEnhancedSlot": s5EnMsTopNmmEnhancedSlot,
       "s5EnMsTopNmmEnhancedPort": s5EnMsTopNmmEnhancedPort,
       "s5EnMsTopNmmEnhancedSubPort": s5EnMsTopNmmEnhancedSubPort,
       "s5EnMsTopNmmEnhancedIpAddr": s5EnMsTopNmmEnhancedIpAddr,
       "s5EnMsTopNmmEnhancedSegId": s5EnMsTopNmmEnhancedSegId,
       "s5EnMsTopNmmEnhancedMacAddr": s5EnMsTopNmmEnhancedMacAddr,
       "s5EnMsTopNmmEnhancedChassisType": s5EnMsTopNmmEnhancedChassisType,
       "s5EnMsTopNmmEnhancedBkplType": s5EnMsTopNmmEnhancedBkplType,
       "s5EnMsTopNmmEnhancedLocalSeg": s5EnMsTopNmmEnhancedLocalSeg,
       "s5EnMsTopNmmEnhancedCurState": s5EnMsTopNmmEnhancedCurState,
       "s5EnMsTopNmmEnhancedEosTable": s5EnMsTopNmmEnhancedEosTable,
       "s5EnMsTopNmmEnhancedEosEntry": s5EnMsTopNmmEnhancedEosEntry,
       "s5EnMsTopNmmEnhancedEos": s5EnMsTopNmmEnhancedEos,
