...
mibBuilder.exportSymbols("S5-ETH-MULTISEG-TOPOLOGY-MIB", s5EnMsTopNmm=s5EnMsTopNmm, s5EnMsTopBdgEosSize=s5EnMsTopBdgEosSize, s5EnMsTopBdgEosTable=s5EnMsTopBdgEosTable, s5EnMsTopPortTable=s5EnMsTopPortTable, s5EnMsTopNmmEosTable=s5EnMsTopNmmEosTable, s5EnMsTopNmmSegId=s5EnMsTopNmmSegId, s5EnMsTopNmmEnhancedCurState=s5EnMsTopNmmEnhancedCurState, s5EnMsTopSrcMacSegId=s5EnMsTopSrcMacSegId, s5EnMsTopBdg=s5EnMsTopBdg, s5EnMsTopSrcMacAddrTable=s5EnMsTopSrcMacAddrTable, s5EnMsTopNmmEnhancedTable=s5EnMsTopNmmEnhancedTable, s5EnMsTopPortIfIndex=s5EnMsTopPortIfIndex, s5EnMsTopNmmCurNum=s5EnMsTopNmmCurNum, s5EnMsTopSrcMac=s5EnMsTopSrcMac, s5EnMsTopIpAddr=s5EnMsTopIpAddr, s5EnMsTopNmmEnhancedEos=s5EnMsTopNmmEnhancedEos, s5EnMsTopNmmEnhancedSlot=s5EnMsTopNmmEnhancedSlot, s5EnMsTopNmmEnhancedPort=s5EnMsTopNmmEnhancedPort, s5EnMsTopNmmEosEntry=s5EnMsTopNmmEosEntry, s5EnMsTopNmmEnhancedMacAddr=s5EnMsTopNmmEnhancedMacAddr, s5EnMsTopNmmMacAddr=s5EnMsTopNmmMacAddr, s5EnMsTopNmmEnhancedSegId=s5EnMsTopNmmEnhancedSegId, s5EnMsTopBdgHelloPortNum=s5EnMsTopBdgHelloPortNum, s5EnMsTopNmmEnhancedEosEntry=s5EnMsTopNmmEnhancedEosEntry, s5EnMsTopStatus=s5EnMsTopStatus, PYSNMP_MODULE_ID=s5EthMultisegTopologyMib, s5EnMsTopBdgLstChg=s5EnMsTopBdgLstChg, s5EnMsTopBdgMaxNum=s5EnMsTopBdgMaxNum, s5EnMsTopBdgTable=s5EnMsTopBdgTable, s5EnMsTopBdgType=s5EnMsTopBdgType, s5EnMsTopBdgEos=s5EnMsTopBdgEos, s5EnMsTopBdgStatus=s5EnMsTopBdgStatus, s5EnMsTopSrcMacAddrLstChg=s5EnMsTopSrcMacAddrLstChg, s5EnMsTopPort=s5EnMsTopPort, s5EnMsTopNmmBkplType=s5EnMsTopNmmBkplType, s5EnMsTopNmmCurState=s5EnMsTopNmmCurState, s5EnMsTopBdgCurNum=s5EnMsTopBdgCurNum, s5EnMsTopBdgCompBdgMac2=s5EnMsTopBdgCompBdgMac2, s5EnMsTopBdgCompBdgMac1=s5EnMsTopBdgCompBdgMac1, s5EnMsTopNmmEnhancedLocalSeg=s5EnMsTopNmmEnhancedLocalSeg, s5EnMsTopNmmTable=s5EnMsTopNmmTable, s5EnMsTopBdgNumPorts=s5EnMsTopBdgNumPorts, s5EnMsTopNmmMaxNum=s5EnMsTopNmmMaxNum, s5EnMsTopNmmEnhancedSubPort=s5EnMsTopNmmEnhancedSubPort, s5EnMsTopPortEntry=s5EnMsTopPortEntry, s5EnMsTopInfo=s5EnMsTopInfo, s5EnMsTopSrcMacAddr=s5EnMsTopSrcMacAddr, s5EnMsTopSrcMacAddrEntry=s5EnMsTopSrcMacAddrEntry, s5EnMsTopBdgIpAddr=s5EnMsTopBdgIpAddr, s5EnMsTopBdgEntry=s5EnMsTopBdgEntry, s5EnMsTopBdgSlotNum=s5EnMsTopBdgSlotNum, s5EnMsTopBdgHelloPortType=s5EnMsTopBdgHelloPortType, s5EnMsTopNmmEnhancedBkplType=s5EnMsTopNmmEnhancedBkplType, s5EnMsTopNmmPort=s5EnMsTopNmmPort, s5EnMsTopBdgHelloPortStatus=s5EnMsTopBdgHelloPortStatus, s5EnMsTopNmmEnhancedIpAddr=s5EnMsTopNmmEnhancedIpAddr, s5EnMsTopNmmLocalSeg=s5EnMsTopNmmLocalSeg, s5EnMsTopBdgPortNum=s5EnMsTopBdgPortNum, s5EnMsTopNmmIpAddr=s5EnMsTopNmmIpAddr, s5EnMsTopBdgNumber=s5EnMsTopBdgNumber, s5EnMsTopPortState=s5EnMsTopPortState, s5EnMsTopNmmEos=s5EnMsTopNmmEos, s5EthMultisegTopologyMib=s5EthMultisegTopologyMib, s5EnMsTopNmmLstChg=s5EnMsTopNmmLstChg, s5EnMsTopNmmEntry=s5EnMsTopNmmEntry, s5EnMsTopNmmSlot=s5EnMsTopNmmSlot, s5EnMsTopNmmChassisType=s5EnMsTopNmmChassisType, s5EnMsTopNmmEnhancedEntry=s5EnMsTopNmmEnhancedEntry, s5EnMsTopNmmEosSize=s5EnMsTopNmmEosSize, s5EnMsTopNmmEnhancedEosTable=s5EnMsTopNmmEnhancedEosTable, s5EnMsTopBdgEosEntry=s5EnMsTopBdgEosEntry, s5EnMsTopNmmEnhancedChassisType=s5EnMsTopNmmEnhancedChassisType, s5EnMsTopBdgMacAddr=s5EnMsTopBdgMacAddr)
