_B6='vStpBridgeGroup'
_B5='vStpRrstpRingBaseGroup'
_B4='vStpRrstpRingConfigGroup'
_B3='vStpNotificationGroup'
_B2='vStpPortConfigGroup'
_B1='vStpMstVlanAssignmentGroup'
_B0='vStpMstInstanceGroup'
_A_='vStpMstRegionGroup'
_Az='vStpInsPortGroup'
_Ay='vStpInsGroup'
_Ax='alaSTPLoopGuardRecovery'
_Aw='alaSTPLoopGuardError'
_Av='stpRootPortChange'
_Au='stpNewRoot'
_At='vStpBridgeModePVST'
_As='vStpBridgeAutoVlanContainment'
_Ar='vStpBridgePathCostMode'
_Aq='vStpBridgeLastChanged'
_Ap='vStpBridgeAddressId'
_Ao='vStpBridgeMode'
_An='vStpRrstpGlobalState'
_Am='vStpRrstpRingRowStatus'
_Al='vStpRrstpRingState'
_Ak='vStpRrstpRingVlanTag'
_Aj='vStpRrstpRingPort2'
_Ai='vStpRrstpRingPort1'
_Ah='vStpPortConfigLoopGuardNote'
_Ag='vStpPortConfigLoopGuard'
_Af='vStpPortConfigStatePVST'
_Ae='vStpPortConfigPVST'
_Ad='vStpPortConfigTenGigOs8800Opt'
_Ac='vStpMstRegionMaxHops'
_Ab='vStpMstRegionCistInstanceNumber'
_Aa='vStpMstRegionMstiList'
_AZ='vStpMstRegionConfigRevisionLevel'
_AY='vStpMstRegionConfigName'
_AX='vStpMstRegionConfigDigest'
_AW='vStpMstRegionConfigFormatSelector'
_AV='vStpMstVlanAssignmentMstiNumber'
_AU='vStpMstInstanceRowStatus'
_AT='vStpMstInstanceVlanBitmapState'
_AS='vStpMstInstanceVlanBitmapDeletion'
_AR='vStpMstInstanceVlanBitmapAddition'
_AQ='vStpMstInstanceName'
_AP='vStpInsPortRestrictedTcn'
_AO='vStpInsPortRestrictedRole'
_AN='vStpInsPortAutoEdge'
_AM='vStpInsPortAdminEdge'
_AL='vstpInsPortRcvdInternal'
_AK='vStpInsPortBridgeHelloTime'
_AJ='vStpInsPortHelloTime'
_AI='vStpInsPortCistPathCost'
_AH='vStpInsPortCistRegionRootId'
_AG='vStpInsPortOperConnectionType'
_AF='vStpInsPortAdminConnectionType'
_AE='vStpInsPortPrimaryPortNumber'
_AD='vStpInsPortRole'
_AC='vStpInsPortManualMode'
_AB='vStpInsPortForwardTransitions'
_AA='vStpInsPortDesignatedPtNumber'
_A9='vStpInsPortDesignatedPtPrio'
_A8='vStpInsPortDesignatedBridge'
_A7='vStpInsPortDesignatedCost'
_A6='vStpInsPortDesignatedRoot'
_A5='vStpInsPortPathCost'
_A4='vStpInsPortEnable'
_A3='vStpInsPortState'
_A2='vStpInsPortPriority'
_A1='vStpInsAdminState'
_A0='vStpInsBridgeTxHoldCount'
_z='vStpInsAutoVlanContainment'
_y='vStpInsMode'
_x='vStpInsMstiNumber'
_w='vStpIns1x1VlanNumber'
_v='vStpInsCistPathCost'
_u='vStpInsCistRegionalRootId'
_t='vStpInsBpduSwitching'
_s='vStpInsBridgeForwardDelay'
_r='vStpInsBridgeHelloTime'
_q='vStpInsBridgeMaxAge'
_p='vStpInsForwardDelay'
_o='vStpInsHoldTime'
_n='vStpInsHelloTime'
_m='vStpInsMaxAge'
_l='vStpInsNextBestRootPortNumber'
_k='vStpInsNextBestRootCost'
_j='vStpInsRootCost'
_i='vStpInsDesignatedRoot'
_h='vStpInsTopChanges'
_g='vStpInsTimeSinceTopologyChange'
_f='vStpInsBridgeAddress'
_e='vStpInsPriority'
_d='vStpInsProtocolSpecification'
_c='vStpRrstpRingId'
_b='vStpMstVlanAssignmentVlanNumber'
_a='vStpMstInstanceNumber'
_Z='edgeport'
_Y='pointtopoint'
_X='nopointtopoint'
_W='forwarding'
_V='blocking'
_U='vStpInsRootPortNumber'
_T='vStpMstRegionNumber'
_S='vStpInsPortNumber'
_R='enabled'
_Q='onePerVlan'
_P='flat'
_O='vStpInsBridgeMode'
_N='not-accessible'
...
_D='Integer32'
_C='read-only'
_B='ALCATEL-ENT1-VLAN-STP-MIB'
_A='current'
if'mibBuilder'not in globals():import sys;sys.stderr.write(__doc__);sys.exit(1)
Integer,OctetString,ObjectIdentifier=mibBuilder.importSymbols('ASN1','Integer','OctetString','ObjectIdentifier')
NamedValues,=mibBuilder.importSymbols('ASN1-ENUMERATION','NamedValues')
ConstraintsIntersection,ConstraintsUnion,SingleValueConstraint,ValueRangeConstraint,ValueSizeConstraint=mibBuilder.importSymbols('ASN1-REFINEMENT','ConstraintsIntersection','ConstraintsUnion','SingleValueConstraint','ValueRangeConstraint','ValueSizeConstraint')
softentIND1VlanStp,=mibBuilder.importSymbols('ALCATEL-ENT1-BASE','softentIND1VlanStp')
...
alcatelIND1VLANSTPMIB=ModuleIdentity((1,3,6,1,4,1,6486,801,1,2,1,12,1))
if mibBuilder.loadTexts:alcatelIND1VLANSTPMIB.setRevisions(('2010-05-13 00:00',))
...
alcatelIND1VLANSTPMIBNotifications=_AlcatelIND1VLANSTPMIBNotifications_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,12,1,0))
if mibBuilder.loadTexts:alcatelIND1VLANSTPMIBNotifications.setStatus(_A)
_AlcatelIND1VLANSTPMIBObjects_ObjectIdentity=ObjectIdentity
alcatelIND1VLANSTPMIBObjects=_AlcatelIND1VLANSTPMIBObjects_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,12,1,1))
if mibBuilder.loadTexts:alcatelIND1VLANSTPMIBObjects.setStatus(_A)
_VStpInfo_ObjectIdentity=ObjectIdentity
vStpInfo=_VStpInfo_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1))
_VStpInsTable_Object=MibTable
vStpInsTable=_VStpInsTable_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1))
if mibBuilder.loadTexts:vStpInsTable.setStatus(_A)
_VStpInsEntry_Object=MibTableRow
vStpInsEntry=_VStpInsEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1))
vStpInsEntry.setIndexNames((0,_B,_O),(0,_B,_I))
if mibBuilder.loadTexts:vStpInsEntry.setStatus(_A)
class _VStpInsBridgeMode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_P,1),(_Q,2)))
_VStpInsBridgeMode_Type.__name__=_D
_VStpInsBridgeMode_Object=MibTableColumn
vStpInsBridgeMode=_VStpInsBridgeMode_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,1),_VStpInsBridgeMode_Type())
vStpInsBridgeMode.setMaxAccess(_N)
if mibBuilder.loadTexts:vStpInsBridgeMode.setStatus(_A)
...
vStpInsNumber=_VStpInsNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,2),_VStpInsNumber_Type())
vStpInsNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsNumber.setStatus(_A)
class _VStpInsProtocolSpecification_Type(Integer32):defaultValue=3;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*(('unknown',1),('decLb100',2),('ieeeSTP',3),('ieeeRSTP',4),('ieeeMSTP',5)))
_VStpInsProtocolSpecification_Type.__name__=_D
_VStpInsProtocolSpecification_Object=MibTableColumn
vStpInsProtocolSpecification=_VStpInsProtocolSpecification_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,3),_VStpInsProtocolSpecification_Type())
vStpInsProtocolSpecification.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsProtocolSpecification.setStatus(_A)
...
vStpInsPriority=_VStpInsPriority_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,4),_VStpInsPriority_Type())
vStpInsPriority.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPriority.setStatus(_A)
_VStpInsBridgeAddress_Type=BridgeId
_VStpInsBridgeAddress_Object=MibTableColumn
vStpInsBridgeAddress=_VStpInsBridgeAddress_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,5),_VStpInsBridgeAddress_Type())
vStpInsBridgeAddress.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsBridgeAddress.setStatus(_A)
_VStpInsTimeSinceTopologyChange_Type=TimeTicks
_VStpInsTimeSinceTopologyChange_Object=MibTableColumn
vStpInsTimeSinceTopologyChange=_VStpInsTimeSinceTopologyChange_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,6),_VStpInsTimeSinceTopologyChange_Type())
vStpInsTimeSinceTopologyChange.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsTimeSinceTopologyChange.setStatus(_A)
_VStpInsTopChanges_Type=Counter32
_VStpInsTopChanges_Object=MibTableColumn
vStpInsTopChanges=_VStpInsTopChanges_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,7),_VStpInsTopChanges_Type())
vStpInsTopChanges.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsTopChanges.setStatus(_A)
_VStpInsDesignatedRoot_Type=BridgeId
_VStpInsDesignatedRoot_Object=MibTableColumn
vStpInsDesignatedRoot=_VStpInsDesignatedRoot_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,8),_VStpInsDesignatedRoot_Type())
vStpInsDesignatedRoot.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsDesignatedRoot.setStatus(_A)
_VStpInsRootCost_Type=Integer32
_VStpInsRootCost_Object=MibTableColumn
vStpInsRootCost=_VStpInsRootCost_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,9),_VStpInsRootCost_Type())
vStpInsRootCost.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsRootCost.setStatus(_A)
_VStpInsRootPortNumber_Type=Integer32
_VStpInsRootPortNumber_Object=MibTableColumn
vStpInsRootPortNumber=_VStpInsRootPortNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,10),_VStpInsRootPortNumber_Type())
vStpInsRootPortNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsRootPortNumber.setStatus(_A)
_VStpInsNextBestRootCost_Type=Integer32
_VStpInsNextBestRootCost_Object=MibTableColumn
vStpInsNextBestRootCost=_VStpInsNextBestRootCost_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,11),_VStpInsNextBestRootCost_Type())
vStpInsNextBestRootCost.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsNextBestRootCost.setStatus(_A)
_VStpInsNextBestRootPortNumber_Type=Integer32
_VStpInsNextBestRootPortNumber_Object=MibTableColumn
vStpInsNextBestRootPortNumber=_VStpInsNextBestRootPortNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,12),_VStpInsNextBestRootPortNumber_Type())
vStpInsNextBestRootPortNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsNextBestRootPortNumber.setStatus(_A)
_VStpInsMaxAge_Type=Timeout
_VStpInsMaxAge_Object=MibTableColumn
vStpInsMaxAge=_VStpInsMaxAge_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,13),_VStpInsMaxAge_Type())
vStpInsMaxAge.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsMaxAge.setStatus(_A)
_VStpInsHelloTime_Type=Timeout
_VStpInsHelloTime_Object=MibTableColumn
vStpInsHelloTime=_VStpInsHelloTime_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,14),_VStpInsHelloTime_Type())
vStpInsHelloTime.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsHelloTime.setStatus(_A)
_VStpInsHoldTime_Type=Integer32
_VStpInsHoldTime_Object=MibTableColumn
vStpInsHoldTime=_VStpInsHoldTime_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,15),_VStpInsHoldTime_Type())
vStpInsHoldTime.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsHoldTime.setStatus(_A)
_VStpInsForwardDelay_Type=Integer32
_VStpInsForwardDelay_Object=MibTableColumn
vStpInsForwardDelay=_VStpInsForwardDelay_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,16),_VStpInsForwardDelay_Type())
vStpInsForwardDelay.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsForwardDelay.setStatus(_A)
...
vStpInsBridgeMaxAge=_VStpInsBridgeMaxAge_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,17),_VStpInsBridgeMaxAge_Type())
vStpInsBridgeMaxAge.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsBridgeMaxAge.setStatus(_A)
...
vStpInsBridgeHelloTime=_VStpInsBridgeHelloTime_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,18),_VStpInsBridgeHelloTime_Type())
vStpInsBridgeHelloTime.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsBridgeHelloTime.setStatus(_A)
...
vStpInsBridgeForwardDelay=_VStpInsBridgeForwardDelay_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,19),_VStpInsBridgeForwardDelay_Type())
vStpInsBridgeForwardDelay.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsBridgeForwardDelay.setStatus(_A)
class _VStpInsBpduSwitching_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_R,1),(_L,2)))
_VStpInsBpduSwitching_Type.__name__=_D
_VStpInsBpduSwitching_Object=MibTableColumn
vStpInsBpduSwitching=_VStpInsBpduSwitching_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,20),_VStpInsBpduSwitching_Type())
vStpInsBpduSwitching.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsBpduSwitching.setStatus(_A)
_VStpInsCistRegionalRootId_Type=BridgeId
_VStpInsCistRegionalRootId_Object=MibTableColumn
vStpInsCistRegionalRootId=_VStpInsCistRegionalRootId_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,21),_VStpInsCistRegionalRootId_Type())
vStpInsCistRegionalRootId.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsCistRegionalRootId.setStatus(_A)
_VStpInsCistPathCost_Type=Integer32
_VStpInsCistPathCost_Object=MibTableColumn
vStpInsCistPathCost=_VStpInsCistPathCost_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,22),_VStpInsCistPathCost_Type())
vStpInsCistPathCost.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsCistPathCost.setStatus(_A)
_VStpIns1x1VlanNumber_Type=Integer32
_VStpIns1x1VlanNumber_Object=MibTableColumn
vStpIns1x1VlanNumber=_VStpIns1x1VlanNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,23),_VStpIns1x1VlanNumber_Type())
vStpIns1x1VlanNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpIns1x1VlanNumber.setStatus(_A)
_VStpInsMstiNumber_Type=Integer32
_VStpInsMstiNumber_Object=MibTableColumn
vStpInsMstiNumber=_VStpInsMstiNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,24),_VStpInsMstiNumber_Type())
vStpInsMstiNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsMstiNumber.setStatus(_A)
class _VStpInsMode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_P,1),(_Q,2)))
_VStpInsMode_Type.__name__=_D
_VStpInsMode_Object=MibTableColumn
vStpInsMode=_VStpInsMode_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,25),_VStpInsMode_Type())
vStpInsMode.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsMode.setStatus(_A)
class _VStpInsAutoVlanContainment_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpInsAutoVlanContainment_Type.__name__=_D
_VStpInsAutoVlanContainment_Object=MibTableColumn
vStpInsAutoVlanContainment=_VStpInsAutoVlanContainment_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,26),_VStpInsAutoVlanContainment_Type())
vStpInsAutoVlanContainment.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsAutoVlanContainment.setStatus(_A)
...
vStpInsBridgeTxHoldCount=_VStpInsBridgeTxHoldCount_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,27),_VStpInsBridgeTxHoldCount_Type())
vStpInsBridgeTxHoldCount.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsBridgeTxHoldCount.setStatus(_A)
class _VStpInsAdminState_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*(('notapplicable',0),(_R,1),(_L,2)))
_VStpInsAdminState_Type.__name__=_D
_VStpInsAdminState_Object=MibTableColumn
vStpInsAdminState=_VStpInsAdminState_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,1,1,28),_VStpInsAdminState_Type())
vStpInsAdminState.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsAdminState.setStatus(_A)
_VStpInsPortTable_Object=MibTable
vStpInsPortTable=_VStpInsPortTable_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2))
if mibBuilder.loadTexts:vStpInsPortTable.setStatus(_A)
_VStpInsPortEntry_Object=MibTableRow
vStpInsPortEntry=_VStpInsPortEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1))
vStpInsPortEntry.setIndexNames((0,_B,_O),(0,_B,_I),(0,_B,_S))
if mibBuilder.loadTexts:vStpInsPortEntry.setStatus(_A)
...
vStpInsPortNumber=_VStpInsPortNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,1),_VStpInsPortNumber_Type())
vStpInsPortNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortNumber.setStatus(_A)
...
vStpInsPortPriority=_VStpInsPortPriority_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,2),_VStpInsPortPriority_Type())
vStpInsPortPriority.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPortPriority.setStatus(_A)
class _VStpInsPortState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*((_L,1),(_V,2),('listening',3),('learning',4),(_W,5)))
_VStpInsPortState_Type.__name__=_D
_VStpInsPortState_Object=MibTableColumn
vStpInsPortState=_VStpInsPortState_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,3),_VStpInsPortState_Type())
vStpInsPortState.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortState.setStatus(_A)
class _VStpInsPortEnable_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_R,1),(_L,2)))
_VStpInsPortEnable_Type.__name__=_D
_VStpInsPortEnable_Object=MibTableColumn
vStpInsPortEnable=_VStpInsPortEnable_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,4),_VStpInsPortEnable_Type())
vStpInsPortEnable.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPortEnable.setStatus(_A)
...
vStpInsPortPathCost=_VStpInsPortPathCost_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,5),_VStpInsPortPathCost_Type())
vStpInsPortPathCost.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPortPathCost.setStatus(_A)
_VStpInsPortDesignatedRoot_Type=BridgeId
_VStpInsPortDesignatedRoot_Object=MibTableColumn
vStpInsPortDesignatedRoot=_VStpInsPortDesignatedRoot_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,6),_VStpInsPortDesignatedRoot_Type())
vStpInsPortDesignatedRoot.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortDesignatedRoot.setStatus(_A)
_VStpInsPortDesignatedCost_Type=Integer32
_VStpInsPortDesignatedCost_Object=MibTableColumn
vStpInsPortDesignatedCost=_VStpInsPortDesignatedCost_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,7),_VStpInsPortDesignatedCost_Type())
vStpInsPortDesignatedCost.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortDesignatedCost.setStatus(_A)
_VStpInsPortDesignatedBridge_Type=BridgeId
_VStpInsPortDesignatedBridge_Object=MibTableColumn
vStpInsPortDesignatedBridge=_VStpInsPortDesignatedBridge_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,8),_VStpInsPortDesignatedBridge_Type())
vStpInsPortDesignatedBridge.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortDesignatedBridge.setStatus(_A)
_VStpInsPortDesignatedPtPrio_Type=Integer32
_VStpInsPortDesignatedPtPrio_Object=MibTableColumn
vStpInsPortDesignatedPtPrio=_VStpInsPortDesignatedPtPrio_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,9),_VStpInsPortDesignatedPtPrio_Type())
vStpInsPortDesignatedPtPrio.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortDesignatedPtPrio.setStatus(_A)
_VStpInsPortDesignatedPtNumber_Type=Integer32
_VStpInsPortDesignatedPtNumber_Object=MibTableColumn
vStpInsPortDesignatedPtNumber=_VStpInsPortDesignatedPtNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,10),_VStpInsPortDesignatedPtNumber_Type())
vStpInsPortDesignatedPtNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortDesignatedPtNumber.setStatus(_A)
_VStpInsPortForwardTransitions_Type=Integer32
_VStpInsPortForwardTransitions_Object=MibTableColumn
vStpInsPortForwardTransitions=_VStpInsPortForwardTransitions_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,11),_VStpInsPortForwardTransitions_Type())
vStpInsPortForwardTransitions.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortForwardTransitions.setStatus(_A)
class _VStpInsPortManualMode_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('no',1),(_V,2),(_W,3)))
_VStpInsPortManualMode_Type.__name__=_D
_VStpInsPortManualMode_Object=MibTableColumn
vStpInsPortManualMode=_VStpInsPortManualMode_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,12),_VStpInsPortManualMode_Type())
vStpInsPortManualMode.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPortManualMode.setStatus(_A)
class _VStpInsPortRole_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6)));namedValues=NamedValues(*(('root',1),('designated',2),('alternate',3),('backup',4),(_L,5),('master',6)))
_VStpInsPortRole_Type.__name__=_D
_VStpInsPortRole_Object=MibTableColumn
vStpInsPortRole=_VStpInsPortRole_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,13),_VStpInsPortRole_Type())
vStpInsPortRole.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortRole.setStatus(_A)
_VStpInsPortPrimaryPortNumber_Type=Integer32
_VStpInsPortPrimaryPortNumber_Object=MibTableColumn
vStpInsPortPrimaryPortNumber=_VStpInsPortPrimaryPortNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,14),_VStpInsPortPrimaryPortNumber_Type())
vStpInsPortPrimaryPortNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortPrimaryPortNumber.setStatus(_A)
class _VStpInsPortAdminConnectionType_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_X,1),(_Y,2),('autopointtopoint',3),(_Z,4)))
_VStpInsPortAdminConnectionType_Type.__name__=_D
_VStpInsPortAdminConnectionType_Object=MibTableColumn
vStpInsPortAdminConnectionType=_VStpInsPortAdminConnectionType_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,15),_VStpInsPortAdminConnectionType_Type())
vStpInsPortAdminConnectionType.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPortAdminConnectionType.setStatus(_A)
class _VStpInsPortOperConnectionType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_X,1),(_Y,2),('nonsignificant',3),(_Z,4)))
_VStpInsPortOperConnectionType_Type.__name__=_D
_VStpInsPortOperConnectionType_Object=MibTableColumn
vStpInsPortOperConnectionType=_VStpInsPortOperConnectionType_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,16),_VStpInsPortOperConnectionType_Type())
vStpInsPortOperConnectionType.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortOperConnectionType.setStatus(_A)
_VStpInsPortCistRegionRootId_Type=BridgeId
_VStpInsPortCistRegionRootId_Object=MibTableColumn
vStpInsPortCistRegionRootId=_VStpInsPortCistRegionRootId_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,17),_VStpInsPortCistRegionRootId_Type())
vStpInsPortCistRegionRootId.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortCistRegionRootId.setStatus(_A)
_VStpInsPortCistPathCost_Type=Integer32
_VStpInsPortCistPathCost_Object=MibTableColumn
vStpInsPortCistPathCost=_VStpInsPortCistPathCost_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,18),_VStpInsPortCistPathCost_Type())
vStpInsPortCistPathCost.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortCistPathCost.setStatus(_A)
...
vStpInsPortHelloTime=_VStpInsPortHelloTime_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,19),_VStpInsPortHelloTime_Type())
vStpInsPortHelloTime.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortHelloTime.setStatus(_A)
...
vStpInsPortBridgeHelloTime=_VStpInsPortBridgeHelloTime_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,20),_VStpInsPortBridgeHelloTime_Type())
vStpInsPortBridgeHelloTime.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpInsPortBridgeHelloTime.setStatus(_A)
...
vstpInsPortRcvdInternal=_VstpInsPortRcvdInternal_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,21),_VstpInsPortRcvdInternal_Type())
vstpInsPortRcvdInternal.setMaxAccess(_C)
if mibBuilder.loadTexts:vstpInsPortRcvdInternal.setStatus(_A)
class _VStpInsPortAdminEdge_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpInsPortAdminEdge_Type.__name__=_D
_VStpInsPortAdminEdge_Object=MibTableColumn
vStpInsPortAdminEdge=_VStpInsPortAdminEdge_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,22),_VStpInsPortAdminEdge_Type())
vStpInsPortAdminEdge.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPortAdminEdge.setStatus(_A)
class _VStpInsPortAutoEdge_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpInsPortAutoEdge_Type.__name__=_D
_VStpInsPortAutoEdge_Object=MibTableColumn
vStpInsPortAutoEdge=_VStpInsPortAutoEdge_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,23),_VStpInsPortAutoEdge_Type())
vStpInsPortAutoEdge.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPortAutoEdge.setStatus(_A)
class _VStpInsPortRestrictedRole_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpInsPortRestrictedRole_Type.__name__=_D
_VStpInsPortRestrictedRole_Object=MibTableColumn
vStpInsPortRestrictedRole=_VStpInsPortRestrictedRole_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,24),_VStpInsPortRestrictedRole_Type())
vStpInsPortRestrictedRole.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPortRestrictedRole.setStatus(_A)
class _VStpInsPortRestrictedTcn_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpInsPortRestrictedTcn_Type.__name__=_D
_VStpInsPortRestrictedTcn_Object=MibTableColumn
vStpInsPortRestrictedTcn=_VStpInsPortRestrictedTcn_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,2,1,25),_VStpInsPortRestrictedTcn_Type())
vStpInsPortRestrictedTcn.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpInsPortRestrictedTcn.setStatus(_A)
_VStpBridge_ObjectIdentity=ObjectIdentity
vStpBridge=_VStpBridge_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,3))
class _VStpBridgeMode_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_P,1),(_Q,2)))
_VStpBridgeMode_Type.__name__=_D
_VStpBridgeMode_Object=MibScalar
vStpBridgeMode=_VStpBridgeMode_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,3,1),_VStpBridgeMode_Type())
vStpBridgeMode.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpBridgeMode.setStatus(_A)
_VStpBridgeAddressId_Type=MacAddress
_VStpBridgeAddressId_Object=MibScalar
vStpBridgeAddressId=_VStpBridgeAddressId_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,3,2),_VStpBridgeAddressId_Type())
vStpBridgeAddressId.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpBridgeAddressId.setStatus(_A)
_VStpBridgeLastChanged_Type=TimeTicks
_VStpBridgeLastChanged_Object=MibScalar
vStpBridgeLastChanged=_VStpBridgeLastChanged_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,3,3),_VStpBridgeLastChanged_Type())
vStpBridgeLastChanged.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpBridgeLastChanged.setStatus(_A)
...
vStpBridgePathCostMode=_VStpBridgePathCostMode_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,3,4),_VStpBridgePathCostMode_Type())
vStpBridgePathCostMode.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpBridgePathCostMode.setStatus(_A)
class _VStpBridgeAutoVlanContainment_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpBridgeAutoVlanContainment_Type.__name__=_D
_VStpBridgeAutoVlanContainment_Object=MibScalar
vStpBridgeAutoVlanContainment=_VStpBridgeAutoVlanContainment_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,3,5),_VStpBridgeAutoVlanContainment_Type())
vStpBridgeAutoVlanContainment.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpBridgeAutoVlanContainment.setStatus(_A)
class _VStpBridgeModePVST_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpBridgeModePVST_Type.__name__=_D
_VStpBridgeModePVST_Object=MibScalar
vStpBridgeModePVST=_VStpBridgeModePVST_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,3,6),_VStpBridgeModePVST_Type())
vStpBridgeModePVST.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpBridgeModePVST.setStatus(_A)
_VStpMstRegionTable_Object=MibTable
vStpMstRegionTable=_VStpMstRegionTable_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4))
if mibBuilder.loadTexts:vStpMstRegionTable.setStatus(_A)
_VStpMstRegionEntry_Object=MibTableRow
vStpMstRegionEntry=_VStpMstRegionEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4,1))
vStpMstRegionEntry.setIndexNames((0,_B,_T))
if mibBuilder.loadTexts:vStpMstRegionEntry.setStatus(_A)
...
vStpMstRegionNumber=_VStpMstRegionNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4,1,1),_VStpMstRegionNumber_Type())
vStpMstRegionNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpMstRegionNumber.setStatus(_A)
...
vStpMstRegionConfigFormatSelector=_VStpMstRegionConfigFormatSelector_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4,1,2),_VStpMstRegionConfigFormatSelector_Type())
vStpMstRegionConfigFormatSelector.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpMstRegionConfigFormatSelector.setStatus(_A)
_VStpMstRegionConfigDigest_Type=DigestId
_VStpMstRegionConfigDigest_Object=MibTableColumn
vStpMstRegionConfigDigest=_VStpMstRegionConfigDigest_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4,1,3),_VStpMstRegionConfigDigest_Type())
vStpMstRegionConfigDigest.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpMstRegionConfigDigest.setStatus(_A)
class _VStpMstRegionConfigName_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,31))
_VStpMstRegionConfigName_Type.__name__=_K
_VStpMstRegionConfigName_Object=MibTableColumn
vStpMstRegionConfigName=_VStpMstRegionConfigName_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4,1,4),_VStpMstRegionConfigName_Type())
vStpMstRegionConfigName.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpMstRegionConfigName.setStatus(_A)
...
vStpMstRegionConfigRevisionLevel=_VStpMstRegionConfigRevisionLevel_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4,1,5),_VStpMstRegionConfigRevisionLevel_Type())
vStpMstRegionConfigRevisionLevel.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpMstRegionConfigRevisionLevel.setStatus(_A)
class _VStpMstRegionMstiList_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,128))
_VStpMstRegionMstiList_Type.__name__=_K
_VStpMstRegionMstiList_Object=MibTableColumn
vStpMstRegionMstiList=_VStpMstRegionMstiList_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4,1,6),_VStpMstRegionMstiList_Type())
vStpMstRegionMstiList.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpMstRegionMstiList.setStatus(_A)
...
vStpMstRegionCistInstanceNumber=_VStpMstRegionCistInstanceNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4,1,7),_VStpMstRegionCistInstanceNumber_Type())
vStpMstRegionCistInstanceNumber.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpMstRegionCistInstanceNumber.setStatus(_A)
...
vStpMstRegionMaxHops=_VStpMstRegionMaxHops_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,4,1,8),_VStpMstRegionMaxHops_Type())
vStpMstRegionMaxHops.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpMstRegionMaxHops.setStatus(_A)
_VStpMstInstanceTable_Object=MibTable
vStpMstInstanceTable=_VStpMstInstanceTable_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,5))
if mibBuilder.loadTexts:vStpMstInstanceTable.setStatus(_A)
_VStpMstInstanceEntry_Object=MibTableRow
vStpMstInstanceEntry=_VStpMstInstanceEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,5,1))
vStpMstInstanceEntry.setIndexNames((0,_B,_a))
if mibBuilder.loadTexts:vStpMstInstanceEntry.setStatus(_A)
...
vStpMstInstanceNumber=_VStpMstInstanceNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,5,1,1),_VStpMstInstanceNumber_Type())
vStpMstInstanceNumber.setMaxAccess(_N)
if mibBuilder.loadTexts:vStpMstInstanceNumber.setStatus(_A)
class _VStpMstInstanceName_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,31))
_VStpMstInstanceName_Type.__name__=_K
_VStpMstInstanceName_Object=MibTableColumn
vStpMstInstanceName=_VStpMstInstanceName_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,5,1,2),_VStpMstInstanceName_Type())
vStpMstInstanceName.setMaxAccess(_H)
if mibBuilder.loadTexts:vStpMstInstanceName.setStatus(_A)
_VStpMstInstanceVlanBitmapAddition_Type=VlanBitmap
_VStpMstInstanceVlanBitmapAddition_Object=MibTableColumn
vStpMstInstanceVlanBitmapAddition=_VStpMstInstanceVlanBitmapAddition_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,5,1,3),_VStpMstInstanceVlanBitmapAddition_Type())
vStpMstInstanceVlanBitmapAddition.setMaxAccess(_H)
if mibBuilder.loadTexts:vStpMstInstanceVlanBitmapAddition.setStatus(_A)
_VStpMstInstanceVlanBitmapDeletion_Type=VlanBitmap
_VStpMstInstanceVlanBitmapDeletion_Object=MibTableColumn
vStpMstInstanceVlanBitmapDeletion=_VStpMstInstanceVlanBitmapDeletion_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,5,1,4),_VStpMstInstanceVlanBitmapDeletion_Type())
vStpMstInstanceVlanBitmapDeletion.setMaxAccess(_H)
if mibBuilder.loadTexts:vStpMstInstanceVlanBitmapDeletion.setStatus(_A)
_VStpMstInstanceVlanBitmapState_Type=VlanBitmap
_VStpMstInstanceVlanBitmapState_Object=MibTableColumn
vStpMstInstanceVlanBitmapState=_VStpMstInstanceVlanBitmapState_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,5,1,5),_VStpMstInstanceVlanBitmapState_Type())
vStpMstInstanceVlanBitmapState.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpMstInstanceVlanBitmapState.setStatus(_A)
_VStpMstInstanceRowStatus_Type=RowStatus
_VStpMstInstanceRowStatus_Object=MibTableColumn
vStpMstInstanceRowStatus=_VStpMstInstanceRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,5,1,6),_VStpMstInstanceRowStatus_Type())
vStpMstInstanceRowStatus.setMaxAccess(_H)
if mibBuilder.loadTexts:vStpMstInstanceRowStatus.setStatus(_A)
_VStpMstVlanAssignmentTable_Object=MibTable
vStpMstVlanAssignmentTable=_VStpMstVlanAssignmentTable_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,6))
if mibBuilder.loadTexts:vStpMstVlanAssignmentTable.setStatus(_A)
_VStpMstVlanAssignmentEntry_Object=MibTableRow
vStpMstVlanAssignmentEntry=_VStpMstVlanAssignmentEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,6,1))
vStpMstVlanAssignmentEntry.setIndexNames((0,_B,_b))
if mibBuilder.loadTexts:vStpMstVlanAssignmentEntry.setStatus(_A)
...
vStpMstVlanAssignmentVlanNumber=_VStpMstVlanAssignmentVlanNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,6,1,1),_VStpMstVlanAssignmentVlanNumber_Type())
vStpMstVlanAssignmentVlanNumber.setMaxAccess(_N)
if mibBuilder.loadTexts:vStpMstVlanAssignmentVlanNumber.setStatus(_A)
...
vStpMstVlanAssignmentMstiNumber=_VStpMstVlanAssignmentMstiNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,6,1,2),_VStpMstVlanAssignmentMstiNumber_Type())
vStpMstVlanAssignmentMstiNumber.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpMstVlanAssignmentMstiNumber.setStatus(_A)
_VStpPortConfigTable_Object=MibTable
vStpPortConfigTable=_VStpPortConfigTable_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,7))
if mibBuilder.loadTexts:vStpPortConfigTable.setStatus(_A)
_VStpPortConfigEntry_Object=MibTableRow
vStpPortConfigEntry=_VStpPortConfigEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,7,1))
vStpPortConfigEntry.setIndexNames((0,_B,_M))
if mibBuilder.loadTexts:vStpPortConfigEntry.setStatus(_A)
_VStpPortConfigIfIndex_Type=InterfaceIndex
_VStpPortConfigIfIndex_Object=MibTableColumn
vStpPortConfigIfIndex=_VStpPortConfigIfIndex_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,7,1,1),_VStpPortConfigIfIndex_Type())
vStpPortConfigIfIndex.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpPortConfigIfIndex.setStatus(_A)
class _VStpPortConfigTenGigOs8800Opt_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpPortConfigTenGigOs8800Opt_Type.__name__=_D
_VStpPortConfigTenGigOs8800Opt_Object=MibTableColumn
vStpPortConfigTenGigOs8800Opt=_VStpPortConfigTenGigOs8800Opt_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,7,1,2),_VStpPortConfigTenGigOs8800Opt_Type())
vStpPortConfigTenGigOs8800Opt.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpPortConfigTenGigOs8800Opt.setStatus(_A)
class _VStpPortConfigPVST_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('auto',1),(_F,2),(_G,3)))
_VStpPortConfigPVST_Type.__name__=_D
_VStpPortConfigPVST_Object=MibTableColumn
vStpPortConfigPVST=_VStpPortConfigPVST_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,7,1,3),_VStpPortConfigPVST_Type())
vStpPortConfigPVST.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpPortConfigPVST.setStatus(_A)
...
vStpPortConfigStatePVST=_VStpPortConfigStatePVST_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,7,1,4),_VStpPortConfigStatePVST_Type())
vStpPortConfigStatePVST.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpPortConfigStatePVST.setStatus(_A)
class _VStpPortConfigLoopGuard_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpPortConfigLoopGuard_Type.__name__=_D
_VStpPortConfigLoopGuard_Object=MibTableColumn
vStpPortConfigLoopGuard=_VStpPortConfigLoopGuard_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,7,1,5),_VStpPortConfigLoopGuard_Type())
vStpPortConfigLoopGuard.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpPortConfigLoopGuard.setStatus(_A)
class _VStpPortConfigLoopGuardNote_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,32))
_VStpPortConfigLoopGuardNote_Type.__name__=_K
_VStpPortConfigLoopGuardNote_Object=MibTableColumn
vStpPortConfigLoopGuardNote=_VStpPortConfigLoopGuardNote_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,7,1,6),_VStpPortConfigLoopGuardNote_Type())
vStpPortConfigLoopGuardNote.setMaxAccess(_C)
if mibBuilder.loadTexts:vStpPortConfigLoopGuardNote.setStatus(_A)
class _VStpRrstpGlobalState_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpRrstpGlobalState_Type.__name__=_D
_VStpRrstpGlobalState_Object=MibScalar
vStpRrstpGlobalState=_VStpRrstpGlobalState_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,8),_VStpRrstpGlobalState_Type())
vStpRrstpGlobalState.setMaxAccess(_E)
if mibBuilder.loadTexts:vStpRrstpGlobalState.setStatus(_A)
_VStpRrstpRingConfigTable_Object=MibTable
vStpRrstpRingConfigTable=_VStpRrstpRingConfigTable_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,9))
if mibBuilder.loadTexts:vStpRrstpRingConfigTable.setStatus(_A)
_VStpRrstpRingConfigEntry_Object=MibTableRow
vStpRrstpRingConfigEntry=_VStpRrstpRingConfigEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,9,1))
vStpRrstpRingConfigEntry.setIndexNames((0,_B,_c))
if mibBuilder.loadTexts:vStpRrstpRingConfigEntry.setStatus(_A)
...
vStpRrstpRingId=_VStpRrstpRingId_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,9,1,1),_VStpRrstpRingId_Type())
vStpRrstpRingId.setMaxAccess(_N)
if mibBuilder.loadTexts:vStpRrstpRingId.setStatus(_A)
_VStpRrstpRingPort1_Type=InterfaceIndex
_VStpRrstpRingPort1_Object=MibTableColumn
vStpRrstpRingPort1=_VStpRrstpRingPort1_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,9,1,2),_VStpRrstpRingPort1_Type())
vStpRrstpRingPort1.setMaxAccess(_H)
if mibBuilder.loadTexts:vStpRrstpRingPort1.setStatus(_A)
_VStpRrstpRingPort2_Type=InterfaceIndex
_VStpRrstpRingPort2_Object=MibTableColumn
vStpRrstpRingPort2=_VStpRrstpRingPort2_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,9,1,3),_VStpRrstpRingPort2_Type())
vStpRrstpRingPort2.setMaxAccess(_H)
if mibBuilder.loadTexts:vStpRrstpRingPort2.setStatus(_A)
...
vStpRrstpRingVlanTag=_VStpRrstpRingVlanTag_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,9,1,4),_VStpRrstpRingVlanTag_Type())
vStpRrstpRingVlanTag.setMaxAccess(_H)
if mibBuilder.loadTexts:vStpRrstpRingVlanTag.setStatus(_A)
class _VStpRrstpRingState_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),(_G,2)))
_VStpRrstpRingState_Type.__name__=_D
_VStpRrstpRingState_Object=MibTableColumn
vStpRrstpRingState=_VStpRrstpRingState_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,9,1,5),_VStpRrstpRingState_Type())
vStpRrstpRingState.setMaxAccess(_H)
if mibBuilder.loadTexts:vStpRrstpRingState.setStatus(_A)
_VStpRrstpRingRowStatus_Type=RowStatus
_VStpRrstpRingRowStatus_Object=MibTableColumn
vStpRrstpRingRowStatus=_VStpRrstpRingRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,12,1,1,1,9,1,6),_VStpRrstpRingRowStatus_Type())
vStpRrstpRingRowStatus.setMaxAccess(_H)
if mibBuilder.loadTexts:vStpRrstpRingRowStatus.setStatus(_A)
_AlcatelIND1VLANSTPMIBConformance_ObjectIdentity=ObjectIdentity
alcatelIND1VLANSTPMIBConformance=_AlcatelIND1VLANSTPMIBConformance_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,12,1,2))
if mibBuilder.loadTexts:alcatelIND1VLANSTPMIBConformance.setStatus(_A)
_AlcatelIND1VLANSTPMIBGroups_ObjectIdentity=ObjectIdentity
alcatelIND1VLANSTPMIBGroups=_AlcatelIND1VLANSTPMIBGroups_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1))
if mibBuilder.loadTexts:alcatelIND1VLANSTPMIBGroups.setStatus(_A)
_AlcatelIND1VLANSTPMIBCompliances_ObjectIdentity=ObjectIdentity
alcatelIND1VLANSTPMIBCompliances=_AlcatelIND1VLANSTPMIBCompliances_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,2))
if mibBuilder.loadTexts:alcatelIND1VLANSTPMIBCompliances.setStatus(_A)
vStpInsGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,1))
vStpInsGroup.setObjects(*((_B,_I),(_B,_d),(_B,_e),(_B,_f),(_B,_g),(_B,_h),(_B,_i),(_B,_j),(_B,_U),(_B,_k),(_B,_l),(_B,_m),(_B,_n),(_B,_o),(_B,_p),(_B,_q),(_B,_r),(_B,_s),(_B,_t),(_B,_u),(_B,_v),(_B,_w),(_B,_x),(_B,_y),(_B,_z),(_B,_A0),(_B,_A1)))
if mibBuilder.loadTexts:vStpInsGroup.setStatus(_A)
vStpInsPortGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,2))
vStpInsPortGroup.setObjects(*((_B,_S),(_B,_A2),(_B,_A3),(_B,_A4),(_B,_A5),(_B,_A6),(_B,_A7),(_B,_A8),(_B,_A9),(_B,_AA),(_B,_AB),(_B,_AC),(_B,_AD),(_B,_AE),(_B,_AF),(_B,_AG),(_B,_AH),(_B,_AI),(_B,_AJ),(_B,_AK),(_B,_AL),(_B,_AM),(_B,_AN),(_B,_AO),(_B,_AP)))
if mibBuilder.loadTexts:vStpInsPortGroup.setStatus(_A)
vStpMstInstanceGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,4))
vStpMstInstanceGroup.setObjects(*((_B,_AQ),(_B,_AR),(_B,_AS),(_B,_AT),(_B,_AU)))
if mibBuilder.loadTexts:vStpMstInstanceGroup.setStatus(_A)
vStpMstVlanAssignmentGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,5))
vStpMstVlanAssignmentGroup.setObjects((_B,_AV))
if mibBuilder.loadTexts:vStpMstVlanAssignmentGroup.setStatus(_A)
vStpMstRegionGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,6))
vStpMstRegionGroup.setObjects(*((_B,_T),(_B,_AW),(_B,_AX),(_B,_AY),(_B,_AZ),(_B,_Aa),(_B,_Ab),(_B,_Ac)))
if mibBuilder.loadTexts:vStpMstRegionGroup.setStatus(_A)
vStpPortConfigGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,7))
vStpPortConfigGroup.setObjects(*((_B,_M),(_B,_Ad),(_B,_Ae),(_B,_Af),(_B,_Ag),(_B,_Ah)))
if mibBuilder.loadTexts:vStpPortConfigGroup.setStatus(_A)
vStpRrstpRingConfigGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,8))
vStpRrstpRingConfigGroup.setObjects(*((_B,_Ai),(_B,_Aj),(_B,_Ak),(_B,_Al),(_B,_Am)))
if mibBuilder.loadTexts:vStpRrstpRingConfigGroup.setStatus(_A)
vStpRrstpRingBaseGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,9))
vStpRrstpRingBaseGroup.setObjects((_B,_An))
if mibBuilder.loadTexts:vStpRrstpRingBaseGroup.setStatus(_A)
vStpBridgeGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,10))
vStpBridgeGroup.setObjects(*((_B,_Ao),(_B,_Ap),(_B,_Aq),(_B,_Ar),(_B,_As),(_B,_At)))
if mibBuilder.loadTexts:vStpBridgeGroup.setStatus(_A)
stpNewRoot=NotificationType((1,3,6,1,4,1,6486,801,1,2,1,12,1,0,1))
stpNewRoot.setObjects((_B,_I))
if mibBuilder.loadTexts:stpNewRoot.setStatus(_A)
stpRootPortChange=NotificationType((1,3,6,1,4,1,6486,801,1,2,1,12,1,0,2))
stpRootPortChange.setObjects(*((_B,_I),(_B,_U)))
if mibBuilder.loadTexts:stpRootPortChange.setStatus(_A)
alaSTPLoopGuardError=NotificationType((1,3,6,1,4,1,6486,801,1,2,1,12,1,0,3))
alaSTPLoopGuardError.setObjects(*((_B,_M),(_B,_I)))
if mibBuilder.loadTexts:alaSTPLoopGuardError.setStatus(_A)
alaSTPLoopGuardRecovery=NotificationType((1,3,6,1,4,1,6486,801,1,2,1,12,1,0,4))
alaSTPLoopGuardRecovery.setObjects(*((_B,_M),(_B,_I)))
if mibBuilder.loadTexts:alaSTPLoopGuardRecovery.setStatus(_A)
vStpNotificationGroup=NotificationGroup((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,1,3))
vStpNotificationGroup.setObjects(*((_B,_Au),(_B,_Av),(_B,_Aw),(_B,_Ax)))
if mibBuilder.loadTexts:vStpNotificationGroup.setStatus(_A)
alcatelIND1VLANSTPMIBCompliance=ModuleCompliance((1,3,6,1,4,1,6486,801,1,2,1,12,1,2,2,1))
alcatelIND1VLANSTPMIBCompliance.setObjects(*((_B,_Ay),(_B,_Az),(_B,_A_),(_B,_B0),(_B,_B1),(_B,_B2),(_B,_B3),(_B,_B4),(_B,_B5),(_B,_B6)))
if mibBuilder.loadTexts:alcatelIND1VLANSTPMIBCompliance.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'VlanBitmap':VlanBitmap,'DigestId':DigestId,'alcatelIND1VLANSTPMIB':alcatelIND1VLANSTPMIB,'alcatelIND1VLANSTPMIBNotifications':alcatelIND1VLANSTPMIBNotifications,_Au:stpNewRoot,_Av:stpRootPortChange,_Aw:alaSTPLoopGuardError,_Ax:alaSTPLoopGuardRecovery,'alcatelIND1VLANSTPMIBObjects':alcatelIND1VLANSTPMIBObjects,'vStpInfo':vStpInfo,'vStpInsTable':vStpInsTable,'vStpInsEntry':vStpInsEntry,_O:vStpInsBridgeMode,_I:vStpInsNumber,_d:vStpInsProtocolSpecification,_e:vStpInsPriority,_f:vStpInsBridgeAddress,_g:vStpInsTimeSinceTopologyChange,_h:vStpInsTopChanges,_i:vStpInsDesignatedRoot,_j:vStpInsRootCost,_U:vStpInsRootPortNumber,_k:vStpInsNextBestRootCost,_l:vStpInsNextBestRootPortNumber,_m:vStpInsMaxAge,_n:vStpInsHelloTime,_o:vStpInsHoldTime,_p:vStpInsForwardDelay,_q:vStpInsBridgeMaxAge,_r:vStpInsBridgeHelloTime,_s:vStpInsBridgeForwardDelay,_t:vStpInsBpduSwitching,_u:vStpInsCistRegionalRootId,_v:vStpInsCistPathCost,_w:vStpIns1x1VlanNumber,_x:vStpInsMstiNumber,_y:vStpInsMode,_z:vStpInsAutoVlanContainment,_A0:vStpInsBridgeTxHoldCount,_A1:vStpInsAdminState,'vStpInsPortTable':vStpInsPortTable,'vStpInsPortEntry':vStpInsPortEntry,_S:vStpInsPortNumber,_A2:vStpInsPortPriority,_A3:vStpInsPortState,_A4:vStpInsPortEnable,_A5:vStpInsPortPathCost,_A6:vStpInsPortDesignatedRoot,_A7:vStpInsPortDesignatedCost,_A8:vStpInsPortDesignatedBridge,_A9:vStpInsPortDesignatedPtPrio,_AA:vStpInsPortDesignatedPtNumber,_AB:vStpInsPortForwardTransitions,_AC:vStpInsPortManualMode,_AD:vStpInsPortRole,_AE:vStpInsPortPrimaryPortNumber,_AF:vStpInsPortAdminConnectionType,_AG:vStpInsPortOperConnectionType,_AH:vStpInsPortCistRegionRootId,_AI:vStpInsPortCistPathCost,_AJ:vStpInsPortHelloTime,_AK:vStpInsPortBridgeHelloTime,_AL:vstpInsPortRcvdInternal,_AM:vStpInsPortAdminEdge,_AN:vStpInsPortAutoEdge,_AO:vStpInsPortRestrictedRole,_AP:vStpInsPortRestrictedTcn,'vStpBridge':vStpBridge,_Ao:vStpBridgeMode,_Ap:vStpBridgeAddressId,_Aq:vStpBridgeLastChanged,_Ar:vStpBridgePathCostMode,_As:vStpBridgeAutoVlanContainment,_At:vStpBridgeModePVST,'vStpMstRegionTable':vStpMstRegionTable,'vStpMstRegionEntry':vStpMstRegionEntry,_T:vStpMstRegionNumber,_AW:vStpMstRegionConfigFormatSelector,_AX:vStpMstRegionConfigDigest,_AY:vStpMstRegionConfigName,_AZ:vStpMstRegionConfigRevisionLevel,_Aa:vStpMstRegionMstiList,_Ab:vStpMstRegionCistInstanceNumber,_Ac:vStpMstRegionMaxHops,'vStpMstInstanceTable':vStpMstInstanceTable,'vStpMstInstanceEntry':vStpMstInstanceEntry,_a:vStpMstInstanceNumber,_AQ:vStpMstInstanceName,_AR:vStpMstInstanceVlanBitmapAddition,_AS:vStpMstInstanceVlanBitmapDeletion,_AT:vStpMstInstanceVlanBitmapState,_AU:vStpMstInstanceRowStatus,'vStpMstVlanAssignmentTable':vStpMstVlanAssignmentTable,'vStpMstVlanAssignmentEntry':vStpMstVlanAssignmentEntry,_b:vStpMstVlanAssignmentVlanNumber,_AV:vStpMstVlanAssignmentMstiNumber,'vStpPortConfigTable':vStpPortConfigTable,'vStpPortConfigEntry':vStpPortConfigEntry,_M:vStpPortConfigIfIndex,_Ad:vStpPortConfigTenGigOs8800Opt,_Ae:vStpPortConfigPVST,_Af:vStpPortConfigStatePVST,_Ag:vStpPortConfigLoopGuard,_Ah:vStpPortConfigLoopGuardNote,_An:vStpRrstpGlobalState,'vStpRrstpRingConfigTable':vStpRrstpRingConfigTable,'vStpRrstpRingConfigEntry':vStpRrstpRingConfigEntry,_c:vStpRrstpRingId,_Ai:vStpRrstpRingPort1,_Aj:vStpRrstpRingPort2,_Ak:vStpRrstpRingVlanTag,_Al:vStpRrstpRingState,_Am:vStpRrstpRingRowStatus,'alcatelIND1VLANSTPMIBConformance':alcatelIND1VLANSTPMIBConformance,'alcatelIND1VLANSTPMIBGroups':alcatelIND1VLANSTPMIBGroups,_Ay:vStpInsGroup,_Az:vStpInsPortGroup,_B3:vStpNotificationGroup,_B0:vStpMstInstanceGroup,_B1:vStpMstVlanAssignmentGroup,_A_:vStpMstRegionGroup,_B2:vStpPortConfigGroup,_B4:vStpRrstpRingConfigGroup,_B5:vStpRrstpRingBaseGroup,_B6:vStpBridgeGroup,'alcatelIND1VLANSTPMIBCompliances':alcatelIND1VLANSTPMIBCompliances,'alcatelIND1VLANSTPMIBCompliance':alcatelIND1VLANSTPMIBCompliance})