# SNMP MIB module (ALCATEL-ENT1-VLAN-STP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-VLAN-STP-MIB
...
vStpInsEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsBridgeMode"),
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsNumber"),
)
if mibBuilder.loadTexts:
...
vStpInsPortEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsBridgeMode"),
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsNumber"),
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortNumber"),
)
if mibBuilder.loadTexts:
...
vStpMstRegionEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionNumber"),
)
if mibBuilder.loadTexts:
...
vStpMstInstanceEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstInstanceNumber"),
)
if mibBuilder.loadTexts:
...
vStpMstVlanAssignmentEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstVlanAssignmentVlanNumber"),
)
if mibBuilder.loadTexts:
...
vStpPortConfigEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigIfIndex"),
)
if mibBuilder.loadTexts:
...
vStpPortConfigLoopGuard = _VStpPortConfigLoopGuard_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 12, 1, 1, 1, 7, 1, 5),
...
class _VStpPortConfigLoopGuardNote_Type(SnmpAdminString):
    """Custom type vStpPortConfigLoopGuardNote based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_VStpPortConfigLoopGuardNote_Type.__name__ = "SnmpAdminString"
_VStpPortConfigLoopGuardNote_Object = MibTableColumn
vStpPortConfigLoopGuardNote = _VStpPortConfigLoopGuardNote_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 12, 1, 1, 1, 7, 1, 6),
    _VStpPortConfigLoopGuardNote_Type()
)
vStpPortConfigLoopGuardNote.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vStpPortConfigLoopGuardNote.setStatus("current")
...
vStpRrstpRingConfigEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VLAN-STP-MIB", "vStpRrstpRingId"),
)
if mibBuilder.loadTexts:
...
vStpInsGroup.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsProtocolSpecification"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPriority"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsBridgeAddress"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsTimeSinceTopologyChange"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsTopChanges"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsDesignatedRoot"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsRootCost"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsRootPortNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsNextBestRootCost"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsNextBestRootPortNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsMaxAge"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsHelloTime"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsHoldTime"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsForwardDelay"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsBridgeMaxAge"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsBridgeHelloTime"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsBridgeForwardDelay"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsBpduSwitching"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsCistRegionalRootId"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsCistPathCost"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpIns1x1VlanNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsMstiNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsMode"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsAutoVlanContainment"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsBridgeTxHoldCount"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsAdminState"))
)
if mibBuilder.loadTexts:
...
vStpInsPortGroup.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortPriority"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortState"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortEnable"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortPathCost"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortDesignatedRoot"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortDesignatedCost"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortDesignatedBridge"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortDesignatedPtPrio"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortDesignatedPtNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortForwardTransitions"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortManualMode"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortRole"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortPrimaryPortNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortAdminConnectionType"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortOperConnectionType"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortCistRegionRootId"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortCistPathCost"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortHelloTime"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortBridgeHelloTime"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vstpInsPortRcvdInternal"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortAdminEdge"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortAutoEdge"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortRestrictedRole"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortRestrictedTcn"))
)
if mibBuilder.loadTexts:
...
vStpMstInstanceGroup.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstInstanceName"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstInstanceVlanBitmapAddition"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstInstanceVlanBitmapDeletion"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstInstanceVlanBitmapState"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstInstanceRowStatus"))
)
if mibBuilder.loadTexts:
...
vStpMstVlanAssignmentGroup.setObjects(
    ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstVlanAssignmentMstiNumber")
)
if mibBuilder.loadTexts:
...
vStpMstRegionGroup.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionConfigFormatSelector"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionConfigDigest"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionConfigName"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionConfigRevisionLevel"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionMstiList"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionCistInstanceNumber"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionMaxHops"))
)
if mibBuilder.loadTexts:
...
vStpPortConfigGroup.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigIfIndex"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigTenGigOs8800Opt"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigPVST"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigStatePVST"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigLoopGuard"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigLoopGuardNote"))
)
if mibBuilder.loadTexts:
...
vStpRrstpRingConfigGroup.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpRrstpRingPort1"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpRrstpRingPort2"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpRrstpRingVlanTag"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpRrstpRingState"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpRrstpRingRowStatus"))
)
if mibBuilder.loadTexts:
...
vStpRrstpRingBaseGroup.setObjects(
    ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpRrstpGlobalState")
)
if mibBuilder.loadTexts:
...
vStpBridgeGroup.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpBridgeMode"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpBridgeAddressId"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpBridgeLastChanged"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpBridgePathCostMode"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpBridgeAutoVlanContainment"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpBridgeModePVST"))
)
if mibBuilder.loadTexts:
...
alaSTPLoopGuardError = NotificationType(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 12, 1, 0, 3)
)
alaSTPLoopGuardError.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigIfIndex"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsNumber"))
)
if mibBuilder.loadTexts:
    alaSTPLoopGuardError.setStatus(
        "current"
    )

alaSTPLoopGuardRecovery = NotificationType(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 12, 1, 0, 4)
)
alaSTPLoopGuardRecovery.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigIfIndex"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsNumber"))
)
if mibBuilder.loadTexts:
    alaSTPLoopGuardRecovery.setStatus(
        "current"
    )
...
vStpNotificationGroup.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "stpNewRoot"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "stpRootPortChange"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "alaSTPLoopGuardError"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "alaSTPLoopGuardRecovery"))
)
if mibBuilder.loadTexts:
...
alcatelIND1VLANSTPMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsGroup"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpInsPortGroup"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstRegionGroup"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstInstanceGroup"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpMstVlanAssignmentGroup"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpPortConfigGroup"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpNotificationGroup"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpRrstpRingConfigGroup"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpRrstpRingBaseGroup"),
        ("ALCATEL-ENT1-VLAN-STP-MIB", "vStpBridgeGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"VlanBitmap": VlanBitmap,
       ...
       "alaSTPLoopGuardError": alaSTPLoopGuardError,
       "alaSTPLoopGuardRecovery": alaSTPLoopGuardRecovery,
       ...
       "vStpPortConfigLoopGuardNote": vStpPortConfigLoopGuardNote,
