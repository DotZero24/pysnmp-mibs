...
h3cVPMStatusTable=_H3cVPMStatusTable_Object((1,3,6,1,4,1,2011,10,2,89,1))
if mibBuilder.loadTexts:h3cVPMStatusTable.setStatus(_A)
_H3cVPMStatusEntry_Object=MibTableRow
h3cVPMStatusEntry=_H3cVPMStatusEntry_Object((1,3,6,1,4,1,2011,10,2,89,1,1))
...
h3cVPMIndex=_H3cVPMIndex_Object((1,3,6,1,4,1,2011,10,2,89,1,1,1),_H3cVPMIndex_Type())
...
h3cVPMEnPhysicalIndex=_H3cVPMEnPhysicalIndex_Object((1,3,6,1,4,1,2011,10,2,89,1,1,2),_H3cVPMEnPhysicalIndex_Type())
...
h3cVPMState=_H3cVPMState_Object((1,3,6,1,4,1,2011,10,2,89,1,1,3),_H3cVPMState_Type())
...
h3cVPMResourceUtilization=_H3cVPMResourceUtilization_Object((1,3,6,1,4,1,2011,10,2,89,1,1,4),_H3cVPMResourceUtilization_Type())
...
h3cVPMHiWaterUtilization=_H3cVPMHiWaterUtilization_Object((1,3,6,1,4,1,2011,10,2,89,1,1,5),_H3cVPMHiWaterUtilization_Type())
...
h3cVPMMaxChannel=_H3cVPMMaxChannel_Object((1,3,6,1,4,1,2011,10,2,89,1,1,6),_H3cVPMMaxChannel_Type())
h3cVPMMaxChannel.setMaxAccess(_B)
if mibBuilder.loadTexts:h3cVPMMaxChannel.setStatus(_A)
_H3cDSPStatusTable_Object=MibTable
h3cDSPStatusTable=_H3cDSPStatusTable_Object((1,3,6,1,4,1,2011,10,2,89,2))
if mibBuilder.loadTexts:h3cDSPStatusTable.setStatus(_A)
_H3cDSPStatusEntry_Object=MibTableRow
h3cDSPStatusEntry=_H3cDSPStatusEntry_Object((1,3,6,1,4,1,2011,10,2,89,2,1))
...
h3cDSPIndex=_H3cDSPIndex_Object((1,3,6,1,4,1,2011,10,2,89,2,1,1),_H3cDSPIndex_Type())
...
h3cDSPVPMIndex=_H3cDSPVPMIndex_Object((1,3,6,1,4,1,2011,10,2,89,2,1,2),_H3cDSPVPMIndex_Type())
...
h3cDSPEnPhysicalIndex=_H3cDSPEnPhysicalIndex_Object((1,3,6,1,4,1,2011,10,2,89,2,1,3),_H3cDSPEnPhysicalIndex_Type())
...
h3cDSPResetTime=_H3cDSPResetTime_Object((1,3,6,1,4,1,2011,10,2,89,2,1,4),_H3cDSPResetTime_Type())
...
h3cDSPMaxChannel=_H3cDSPMaxChannel_Object((1,3,6,1,4,1,2011,10,2,89,2,1,5),_H3cDSPMaxChannel_Type())
...
h3cDSPState=_H3cDSPState_Object((1,3,6,1,4,1,2011,10,2,89,2,1,6),_H3cDSPState_Type())
...
h3cDSPInUseChannel=_H3cDSPInUseChannel_Object((1,3,6,1,4,1,2011,10,2,89,2,1,7),_H3cDSPInUseChannel_Type())
...
h3cDSPTrap=_H3cDSPTrap_ObjectIdentity((1,3,6,1,4,1,2011,10,2,89,3))
_H3cDSPTrapPrex_ObjectIdentity=ObjectIdentity
h3cDSPTrapPrex=_H3cDSPTrapPrex_ObjectIdentity((1,3,6,1,4,1,2011,10,2,89,3,0))
h3cVPMStateChange=NotificationType((1,3,6,1,4,1,2011,10,2,89,3,0,1))
h3cVPMStateChange.setObjects(*((_C,_E),(_C,_J),(_C,_K)))
if mibBuilder.loadTexts:h3cVPMStateChange.setStatus(_A)
h3cDSPStateChange=NotificationType((1,3,6,1,4,1,2011,10,2,89,3,0,2))
