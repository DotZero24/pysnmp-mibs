...
# Notes
# -----
# ASN.1 source file://mibs/extreme/EXTREME-VM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:16:14 2025
...
if mibBuilder.loadTexts:
    extremeVMFTPPolicyDir.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMMappingIngressVPPName.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMMappingEgressVPPName.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMVPP2PolicyTable.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMVPP2PolicyEntry.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMVPP2PolicyVPPName.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMVPP2PolicyPolicyName.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMVPP2PolicyType.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMVPP2PolicyOrder.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMVPP2PolicyRowStatus.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMDetectedIngressVPPName.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    extremeVMDetectedEgressVPPName.setStatus("obsolete")
