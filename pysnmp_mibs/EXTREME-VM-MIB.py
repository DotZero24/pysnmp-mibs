...
mibBuilder.exportSymbols("EXTREME-VM-MIB", extremeVM=extremeVM, extremeVMDetectedVMVLANVRName=extremeVMDetectedVMVLANVRName, extremeVMVPPVLANTag=extremeVMVPPVLANTag, extremeVMMappingRowStatus=extremeVMMappingRowStatus, extremeVMVPPDetailEntry=extremeVMVPPDetailEntry, extremeVMMappingMAC=extremeVMMappingMAC, extremeVMMappingStatus=extremeVMMappingStatus, extremeVMFTPServerTable=extremeVMFTPServerTable, extremeVMSynchAdminState=extremeVMSynchAdminState, extremeVMVPP2PolicyPolicyName=extremeVMVPP2PolicyPolicyName, extremeVMDetectedVMVLANTag=extremeVMDetectedVMVLANTag, extremeVMFTPServerType=extremeVMFTPServerType, extremeVMDetectedIngErrPolicies=extremeVMDetectedIngErrPolicies, extremeVMDetectedTable=extremeVMDetectedTable, extremeVMVPPSyncFailed=extremeVMVPPSyncFailed, extremeVMVPP2PolicyVPPName=extremeVMVPP2PolicyVPPName, extremeVMFTPSynchInterval=extremeVMFTPSynchInterval, extremeVMNotificationPrefix=extremeVMNotificationPrefix, extremeVMPortConfigEntry=extremeVMPortConfigEntry, extremeVMDetectedEgrErrPolicies=extremeVMDetectedEgrErrPolicies, extremeVMVPP=extremeVMVPP, extremeVMVPPDetailPolicyName=extremeVMVPPDetailPolicyName, extremeVMNotifications=extremeVMNotifications, extremeVMLastSynchStatus=extremeVMLastSynchStatus, extremeVMMappingEgressVPPName=extremeVMMappingEgressVPPName, extremeVMDetectedIngressVPPName=extremeVMDetectedIngressVPPName, extremeVMFTPPassword=extremeVMFTPPassword, extremeVMMappingEntry=extremeVMMappingEntry, extremeVMMapped=extremeVMMapped, extremeVMDetectedResultIngress=extremeVMDetectedResultIngress, extremeVMVPPControl=extremeVMVPPControl, extremeVMVPP2PolicyOrder=extremeVMVPP2PolicyOrder, extremeVMSynchOperState=extremeVMSynchOperState, extremeVMFTPUsername=extremeVMFTPUsername, extremeVMVPPTable=extremeVMVPPTable, extremeVMFTPServer=extremeVMFTPServer, extremeVMMappingVLANTag=extremeVMMappingVLANTag, extremeVMVPP2PolicyRowStatus=extremeVMVPP2PolicyRowStatus, extremeVMVPPInvalid=extremeVMVPPInvalid, extremeVMUnDetectResult=extremeVMUnDetectResult, extremeVMFTPPolicyDir=extremeVMFTPPolicyDir, extremeVMFTPRowStatus=extremeVMFTPRowStatus, extremeVMVPPCounter=extremeVMVPPCounter, extremeVMVPPVLANVRName=extremeVMVPPVLANVRName, extremeVMVPPDetailVPPName=extremeVMVPPDetailVPPName, extremeVMGeneral=extremeVMGeneral, extremeVMDetectedResultEgress=extremeVMDetectedResultEgress, extremeVMDetectedEntry=extremeVMDetectedEntry, PYSNMP_MODULE_ID=extremeVM, extremeVMVPPType=extremeVMVPPType, extremeVMDetectedCounterInstallResult=extremeVMDetectedCounterInstallResult, extremeVMDetectedMAC=extremeVMDetectedMAC, extremeVMDetected=extremeVMDetected, extremeVMDetectedVPPName=extremeVMDetectedVPPName, extremeVMVPPDetailRowStatus=extremeVMVPPDetailRowStatus, extremeVMPortConfigVMTrackingEnabled=extremeVMPortConfigVMTrackingEnabled, extremeVMVPP2PolicyEntry=extremeVMVPP2PolicyEntry, extremeVMVPPEntry=extremeVMVPPEntry, extremeVMMappingVLANVRName=extremeVMMappingVLANVRName, extremeVMDetectedEgressVPPName=extremeVMDetectedEgressVPPName, extremeVMDetectedVMName=extremeVMDetectedVMName, extremeVMFTPAddrType=extremeVMFTPAddrType, extremeVMPortConfigTable=extremeVMPortConfigTable, extremeVMFTPServerEntry=extremeVMFTPServerEntry, extremeVMFTPPathName=extremeVMFTPPathName, extremeVMMappingVPPName=extremeVMMappingVPPName, extremeVMDetectedAdminStatus=extremeVMDetectedAdminStatus, extremeVMMappingTable=extremeVMMappingTable, VMVPPSynchType=VMVPPSynchType, extremeVMVPPDetailTable=extremeVMVPPDetailTable, extremeVMMappingType=extremeVMMappingType, extremeVMVPP2PolicyType=extremeVMVPP2PolicyType, extremeVMDetectResult=extremeVMDetectResult, CounterDirection=CounterDirection, extremeVMVPPSynchType=extremeVMVPPSynchType, extremeVMVPP2PolicyTable=extremeVMVPP2PolicyTable, extremeVMDetectedOperStatus=extremeVMDetectedOperStatus, extremeVMVPPDetailOrder=extremeVMVPPDetailOrder, extremeVMDetectedNumber=extremeVMDetectedNumber, extremeVMMappingIngressVPPName=extremeVMMappingIngressVPPName, extremeVMUnMapped=extremeVMUnMapped, extremeVMVPPDetailType=extremeVMVPPDetailType, extremeVMPortConfigIfIndex=extremeVMPortConfigIfIndex, extremeVMVPPName=extremeVMVPPName, extremeVMVPPDetailDirection=extremeVMVPPDetailDirection, extremeVMNotificationObjects=extremeVMNotificationObjects, extremeVMDetectedIfIndex=extremeVMDetectedIfIndex, extremeVMPortConfigVMTrackingDynVlanEnabled=extremeVMPortConfigVMTrackingDynVlanEnabled, extremeVMLastSynch=extremeVMLastSynch, extremeVMVPPRowStatus=extremeVMVPPRowStatus, extremeVMDetectedVPPResult=extremeVMDetectedVPPResult, extremeVMTrackingEnabled=extremeVMTrackingEnabled)
