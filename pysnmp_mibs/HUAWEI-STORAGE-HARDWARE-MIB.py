...
# Produced by pysmi-1.6.2 at Fri Oct 10 19:30:15 2025
...
_HwInfoDiskElectronicLabel_Type = OctetString
_HwInfoDiskElectronicLabel_Object = MibTableColumn
hwInfoDiskElectronicLabel = _HwInfoDiskElectronicLabel_Object(
    (1, 3, 6, 1, 4, 1, 34774, 4, 1, 23, 5, 1, 1, 26),
    _HwInfoDiskElectronicLabel_Type()
)
hwInfoDiskElectronicLabel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwInfoDiskElectronicLabel.setStatus("current")
...
_HwInfoPortPCIEBadDllp_Type = Unsigned32
_HwInfoPortPCIEBadDllp_Object = MibTableColumn
hwInfoPortPCIEBadDllp = _HwInfoPortPCIEBadDllp_Object(
    (1, 3, 6, 1, 4, 1, 34774, 4, 1, 23, 5, 11, 1, 11),
    _HwInfoPortPCIEBadDllp_Type()
)
hwInfoPortPCIEBadDllp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hwInfoPortPCIEBadDllp.setStatus("current")
...
currentObjectGroup.setObjects(
      *(("HUAWEI-STORAGE-HARDWARE-MIB", "hwInfoPortComID"),
        ...
        ("HUAWEI-STORAGE-HARDWARE-MIB", "hwInfoPortPCIEBadDllp"),
...
mibBuilder.exportSymbols(
    ...
    **{"NodeCodeString": NodeCodeString,
       ...
       "hwInfoDiskElectronicLabel": hwInfoDiskElectronicLabel,
       ...
       "hwInfoPortPCIEBadDllp": hwInfoPortPCIEBadDllp,
