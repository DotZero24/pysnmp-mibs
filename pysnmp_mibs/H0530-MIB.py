# SNMP MIB module (H0530-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/H0530-MIB
...
trapTest.setObjects(
      *(("H0530-MIB", "sensorName"),
        ("H0530-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
