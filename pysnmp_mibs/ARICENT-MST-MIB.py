# SNMP MIB module (ARICENT-MST-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MST-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:44:05 2025
...
fsMstMstiBridgeEntry = _FsMstMstiBridgeEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 38, 1)
)
fsMstMstiBridgeEntry.setIndexNames(
    (0, "ARICENT-MST-MIB", "fsMstMstiInstanceIndex"),
)
if mibBuilder.loadTexts:
...
fsMstVlanInstanceMappingEntry = _FsMstVlanInstanceMappingEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 39, 1)
)
fsMstVlanInstanceMappingEntry.setIndexNames(
    (0, "ARICENT-MST-MIB", "fsMstInstanceIndex"),
)
if mibBuilder.loadTexts:
...
fsMstCistPortRootGuard = _FsMstCistPortRootGuard_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 40, 1, 56),
    _FsMstCistPortRootGuard_Type()
)
fsMstCistPortRootGuard.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMstCistPortRootGuard.setStatus("current")


class _FsMstCistPortRootInconsistentState_Type(TruthValue):
    """Custom type fsMstCistPortRootInconsistentState based on TruthValue"""
    defaultValue = 2


_FsMstCistPortRootInconsistentState_Type.__name__ = "TruthValue"
_FsMstCistPortRootInconsistentState_Object = MibTableColumn
fsMstCistPortRootInconsistentState = _FsMstCistPortRootInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 40, 1, 57),
    _FsMstCistPortRootInconsistentState_Type()
)
fsMstCistPortRootInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsMstCistPortRootInconsistentState.setStatus("current")


class _FsMstCistPortErrorRecovery_Type(Timeout):
    """Custom type fsMstCistPortErrorRecovery based on Timeout"""
    defaultValue = 30000
...
_FsMstCistPortErrorRecovery_Type.__name__ = "Timeout"
_FsMstCistPortErrorRecovery_Object = MibTableColumn
fsMstCistPortErrorRecovery = _FsMstCistPortErrorRecovery_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 40, 1, 58),
    _FsMstCistPortErrorRecovery_Type()
)
fsMstCistPortErrorRecovery.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMstCistPortErrorRecovery.setStatus("current")
if mibBuilder.loadTexts:
    fsMstCistPortErrorRecovery.setUnits("centi-seconds")


class _FsMstPortBpduInconsistentState_Type(TruthValue):
    """Custom type fsMstPortBpduInconsistentState based on TruthValue"""
    defaultValue = 2


_FsMstPortBpduInconsistentState_Type.__name__ = "TruthValue"
_FsMstPortBpduInconsistentState_Object = MibTableColumn
fsMstPortBpduInconsistentState = _FsMstPortBpduInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 40, 1, 59),
    _FsMstPortBpduInconsistentState_Type()
)
fsMstPortBpduInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsMstPortBpduInconsistentState.setStatus("current")


class _FsMstPortBpduGuardAction_Type(Integer32):
    """Custom type fsMstPortBpduGuardAction based on Integer32"""
    defaultValue = 1
...
_FsMstPortBpduGuardAction_Type.__name__ = "Integer32"
_FsMstPortBpduGuardAction_Object = MibTableColumn
fsMstPortBpduGuardAction = _FsMstPortBpduGuardAction_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 40, 1, 60),
    _FsMstPortBpduGuardAction_Type()
)
fsMstPortBpduGuardAction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMstPortBpduGuardAction.setStatus("current")
_FsMstMstiPortTable_Object = MibTable
fsMstMstiPortTable = _FsMstMstiPortTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 41)
)
if mibBuilder.loadTexts:
    fsMstMstiPortTable.setStatus("current")
_FsMstMstiPortEntry_Object = MibTableRow
fsMstMstiPortEntry = _FsMstMstiPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 41, 1)
)
fsMstMstiPortEntry.setIndexNames(
    (0, "ARICENT-MST-MIB", "fsMstMstiPort"),
    (0, "ARICENT-MST-MIB", "fsMstInstanceIndex"),
)
if mibBuilder.loadTexts:
...
class _FsMstMstiPortRootInconsistentState_Type(TruthValue):
    """Custom type fsMstMstiPortRootInconsistentState based on TruthValue"""
    defaultValue = 2


_FsMstMstiPortRootInconsistentState_Type.__name__ = "TruthValue"
_FsMstMstiPortRootInconsistentState_Object = MibTableColumn
fsMstMstiPortRootInconsistentState = _FsMstMstiPortRootInconsistentState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 41, 1, 24),
    _FsMstMstiPortRootInconsistentState_Type()
)
fsMstMstiPortRootInconsistentState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsMstMstiPortRootInconsistentState.setStatus("current")
...
class _FsMstStpPerfStatus_Type(Integer32):
    """Custom type fsMstStpPerfStatus based on Integer32"""
    defaultValue = 2
...
_FsMstStpPerfStatus_Type.__name__ = "Integer32"
_FsMstStpPerfStatus_Object = MibScalar
fsMstStpPerfStatus = _FsMstStpPerfStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 1, 50),
    _FsMstStpPerfStatus_Type()
)
fsMstStpPerfStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMstStpPerfStatus.setStatus("current")
_Dot1sFsMstTrapsControl_ObjectIdentity = ObjectIdentity
dot1sFsMstTrapsControl = _Dot1sFsMstTrapsControl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 80, 2)
)
...
fsMstPortTrapNotificationEntry = _FsMstPortTrapNotificationEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 80, 2, 4, 1)
)
fsMstPortTrapNotificationEntry.setIndexNames(
    (0, "ARICENT-MST-MIB", "fsMstPortTrapIndex"),
)
if mibBuilder.loadTexts:
...
fsMstGenTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 1)
)
fsMstGenTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstGenTrapType"),
        ("ARICENT-MST-MIB", "fsMstInstanceUpCount"),
        ("ARICENT-MST-MIB", "fsMstInstanceDownCount"))
)
if mibBuilder.loadTexts:
...
fsMstErrTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 2)
)
fsMstErrTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstErrTrapType"))
)
if mibBuilder.loadTexts:
...
fsMstNewRootTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 3)
)
fsMstNewRootTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstOldDesignatedRoot"),
        ("ARICENT-MST-MIB", "fsMstMstiBridgeRegionalRoot"))
)
if mibBuilder.loadTexts:
...
fsMstTopologyChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 4)
)
fsMstTopologyChgTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstMstiTopChanges"))
)
if mibBuilder.loadTexts:
...
fsMstProtocolMigrationTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 5)
)
fsMstProtocolMigrationTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstForceProtocolVersion"),
        ("ARICENT-MST-MIB", "fsMstPortMigrationType"))
)
if mibBuilder.loadTexts:
...
fsMstInvalidBpduRxdTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 6)
)
fsMstInvalidBpduRxdTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstPktErrType"),
        ("ARICENT-MST-MIB", "fsMstPktErrVal"))
)
if mibBuilder.loadTexts:
...
fsMstRegionConfigChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 7)
)
fsMstRegionConfigChangeTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstMstiConfigIdSel"),
        ("ARICENT-MST-MIB", "fsMstMstiRegionName"),
        ("ARICENT-MST-MIB", "fsMstMstiRegionVersion"),
        ("ARICENT-MST-MIB", "fsMstMstiConfigDigest"))
)
if mibBuilder.loadTexts:
...
fsMstNewPortRoleTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 8)
)
fsMstNewPortRoleTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstPortRoleType"),
        ("ARICENT-MST-MIB", "fsMstOldRoleType"))
)
if mibBuilder.loadTexts:
...
fsMstCistHwFailureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 9)
)
fsMstCistHwFailureTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstCistPortState"))
)
if mibBuilder.loadTexts:
...
fsMstMstiHwFailureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 80, 3, 0, 10)
)
fsMstMstiHwFailureTrap.setObjects(
      *(("ARICENT-MST-MIB", "fsMstBrgAddress"),
        ("ARICENT-MST-MIB", "fsMstMstiPortState"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"VlanId": VlanId,
       ...
       "fsMstCistPortRootGuard": fsMstCistPortRootGuard,
       "fsMstCistPortRootInconsistentState": fsMstCistPortRootInconsistentState,
       "fsMstCistPortErrorRecovery": fsMstCistPortErrorRecovery,
       "fsMstPortBpduInconsistentState": fsMstPortBpduInconsistentState,
       "fsMstPortBpduGuardAction": fsMstPortBpduGuardAction,
       ...
       "fsMstMstiPortRootInconsistentState": fsMstMstiPortRootInconsistentState,
       ...
       "fsMstStpPerfStatus": fsMstStpPerfStatus,
