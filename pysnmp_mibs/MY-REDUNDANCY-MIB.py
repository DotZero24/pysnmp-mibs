# SNMP MIB module (MY-REDUNDANCY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-REDUNDANCY-MIB
...
myPluggableModuleInfoEntry.setIndexNames(
    (0, "MY-REDUNDANCY-MIB", "myPluggableModuleInfoDeviceIndex"),
    (0, "MY-REDUNDANCY-MIB", "myPluggableModuleInfoSlotIndex"),
)
if mibBuilder.loadTexts:
...
myRedundancyMIBGroup.setObjects(
      *(("MY-REDUNDANCY-MIB", "myRedundancyForceSwitchover"),
        ("MY-REDUNDANCY-MIB", "myMainCPU"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleInfoDeviceIndex"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleInfoSlotIndex"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleStatus"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleConfigType"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleConfigSwVer"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleOnlineSwVer"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleConfigInfoDescr"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleOnlineInfoDescr"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleConfigPortsNum"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleOnlinePortsNum"),
        ("MY-REDUNDANCY-MIB", "myPluggableModuleAction"))
)
if mibBuilder.loadTexts:
...
myRedundancyMIBCompliance.setObjects(
    ("MY-REDUNDANCY-MIB", "myRedundancyMIBGroup")
)
if mibBuilder.loadTexts:
