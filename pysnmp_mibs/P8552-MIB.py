# SNMP MIB module (P8552-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/P8552-MIB
...
trapTest.setObjects(
      *(("P8552-MIB", "sensorName"),
        ("P8552-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
