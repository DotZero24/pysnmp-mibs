...
mibBuilder.exportSymbols("BROTHER-MIB", brMultiIFcontrol=brMultiIFcontrol, mcScanner=mcScanner, brMultiIFtcpip=brMultiIFtcpip, brMultiIFServiceIndex=brMultiIFServiceIndex, brpsVerifyPhysAddress=brpsVerifyPhysAddress, brMultiIFServiceStringIndex=brMultiIFServiceStringIndex, brColorCalibrationReset=brColorCalibrationReset, brMultiIFAPIPAEntry=brMultiIFAPIPAEntry, brpsNetwareServicingQueueCount=brpsNetwareServicingQueueCount, brFontSymbolSet=brFontSymbolSet, brpsTmpAPOPEnable=brpsTmpAPOPEnable, brCapabilityResolutionCount=brCapabilityResolutionCount, brpsWLanCapabilityAuthModeSupported=brpsWLanCapabilityAuthModeSupported, brToner4Low=brToner4Low, brMultiIFIPv6AddressCount=brMultiIFIPv6AddressCount, brSNTPCSecondaryServerName=brSNTPCSecondaryServerName, lpd=lpd, brpsNetwareServicingServerName=brpsNetwareServicingServerName, brLCDString4=brLCDString4, brNetRegisterPcFaxInfo=brNetRegisterPcFaxInfo, brpsTCPIPAccessSubnetMask=brpsTCPIPAccessSubnetMask, brProxyEnable=brProxyEnable, brPageIBMAutoMask=brPageIBMAutoMask, brPrimaryDNSIPAddress=brPrimaryDNSIPAddress, margin_e=margin_e, brpsBanyanLoginName=brpsBanyanLoginName, brMultiIFServiceInfoEntry=brMultiIFServiceInfoEntry, brcontrol=brcontrol, brPrtAdvancedTonerLowPrint=brPrtAdvancedTonerLowPrint, brPushStatusSupported=brPushStatusSupported, brNetSKeySupported=brNetSKeySupported, brPrintersEmailaddress=brPrintersEmailaddress, brPfKitType=brPfKitType, wlInfo=wlInfo, brSNMPV3ContextName=brSNMPV3ContextName, brpsServiceStringCount=brpsServiceStringCount, brPJLInfoOuttrayconfigEntry=brPJLInfoOuttrayconfigEntry, brpsWLanWPSResult=brpsWLanWPSResult, brpsSNMPGetCommunity=brpsSNMPGetCommunity, brMultiIFServiceInfoTable=brMultiIFServiceInfoTable, brSNTPCEnable=brSNTPCEnable, brpsNetBEUIDomain=brpsNetBEUIDomain, brMultiIFWebServicesName=brMultiIFWebServicesName, brMultiIFServiceNDSContext=brMultiIFServiceNDSContext, brLdapServerAttrFAXNumber=brLdapServerAttrFAXNumber, brSNMPV3AuthPassword=brSNMPV3AuthPassword, brMultiIFconfig=brMultiIFconfig, brCapabilityMediatypeEntry=brCapabilityMediatypeEntry, broriginalSNMP=broriginalSNMP, brMultiIFAPIPAEnable=brMultiIFAPIPAEnable, brRegistrationXCyanRight=brRegistrationXCyanRight, brpsAPOPEnable=brpsAPOPEnable, pfkit=pfkit, brpsSNMPJetAdmin=brpsSNMPJetAdmin, brMultiIFDNSIPv6AddressTable=brMultiIFDNSIPv6AddressTable, wireless=wireless, brPJLInfoDXconfigEntry=brPJLInfoDXconfigEntry, net_printer=net_printer, brLdapServerAttrDetailEnable1=brLdapServerAttrDetailEnable1, wlAssociate=wlAssociate, brPagePCLTopMargin=brPagePCLTopMargin, brpsBootRevision=brpsBootRevision, brpsServiceProtocolDLC=brpsServiceProtocolDLC, autoff=autoff, brRegistrationYYellow=brRegistrationYYellow, brMediaFixTray3=brMediaFixTray3, broriginalSNTP=broriginalSNTP, brLdapTimeoutSupported=brLdapTimeoutSupported, brMultiIFAPIPATable=brMultiIFAPIPATable, brPhoneNumberLastFax=brPhoneNumberLastFax, brpsAvailableWLanEncryptMode=brpsAvailableWLanEncryptMode, brCapabilityCopiesMax=brCapabilityCopiesMax, brpsNetwareServerTable=brpsNetwareServerTable, brScanCountEntry=brScanCountEntry, brpsWLanCapabilitAuthModeIndex=brpsWLanCapabilitAuthModeIndex, brInfoEstimatedPagesRemaining=brInfoEstimatedPagesRemaining, brFuncLockPcLoginNameEntry=brFuncLockPcLoginNameEntry, brCapabilityCopiesMin=brCapabilityCopiesMin, catch_tray=catch_tray, prt_density=prt_density, brFindPort=brFindPort, brpsBanyanErrorLE=brpsBanyanErrorLE, brpsWLanWepKeyIndex=brpsWLanWepKeyIndex, brTrayPriorityEntry=brTrayPriorityEntry, destination_subsystem4=destination_subsystem4, brLdapServerAuth=brLdapServerAuth, brNotificationRuleTable=brNotificationRuleTable, brpsAdvancedTCPIPAccessEnable=brpsAdvancedTCPIPAccessEnable, wlGeneralInfo=wlGeneralInfo, brpsLATKeepAliveTimer=brpsLATKeepAliveTimer, brFuncLockAutoCountResetFrequency=brFuncLockAutoCountResetFrequency, brpsBanyanIPCConnectionInformation=brpsBanyanIPCConnectionInformation, brpsWLanAuthUserPass=brpsWLanAuthUserPass, brPrtAvoidMailboxFullGroup=brPrtAvoidMailboxFullGroup, brpsServiceNetwareServerCount=brpsServiceNetwareServerCount, brSupportedInfo=brSupportedInfo, brpsAppleTalkReadError=brpsAppleTalkReadError, brpsWLanAOSSIsRunnning=brpsWLanAOSSIsRunnning, brpsDLCLLCConnectHost=brpsDLCLLCConnectHost, brpsWLanAOSSSupported=brpsWLanAOSSSupported, brtray1size=brtray1size, brPageIBMTopMargin=brPageIBMTopMargin, brProxyServerName=brProxyServerName, brFuncLockAutoCountResetDate=brFuncLockAutoCountResetDate, brpsWLanCapabilityAuthEAPSupported=brpsWLanCapabilityAuthEAPSupported, panellock=panellock, brPrtAvoidMailboxFullEntry=brPrtAvoidMailboxFullEntry, broriginalftp=broriginalftp, cassette3=cassette3, brCapabilityPaperName=brCapabilityPaperName, brPictBridgePrintSetting=brPictBridgePrintSetting, brMultiIFIPv6UseMethod=brMultiIFIPv6UseMethod, brpsMIBMajor=brpsMIBMajor, brFuncLockUserPrintPageMax=brFuncLockUserPrintPageMax, autoc=autoc, brLAAMacAddress=brLAAMacAddress, manual=manual, brPrtAdvancedLowerLCD=brPrtAdvancedLowerLCD, brEmailReportsCount=brEmailReportsCount, brpsBanyanIPPacket=brpsBanyanIPPacket, brpsWLanCtsMode=brpsWLanCtsMode, brInfoHDDSlot2=brInfoHDDSlot2, brRegistrationPrintChart=brRegistrationPrintChart, brpsLATEnable=brpsLATEnable, brRawPortEnable=brRawPortEnable, brPageEPSONLeftMargin=brPageEPSONLeftMargin, brpsTCPIPAccessTable=brpsTCPIPAccessTable, brPriMailAddress=brPriMailAddress, generalDeviceStatus=generalDeviceStatus, brFuncLockUserIndex=brFuncLockUserIndex, brPrintPagesPaperTypeType=brPrintPagesPaperTypeType, brMultiIFServiceVines=brMultiIFServiceVines, brLdapServerAttrDetailEnable4=brLdapServerAttrDetailEnable4, brmanualfeed=brmanualfeed, brpsServiceNDSTree=brpsServiceNDSTree, brPrtAdvancedLCDDensity=brPrtAdvancedLCDDensity, brmpsize=brmpsize, brLCDString3=brLCDString3, brpsNetwarePasswordSet=brpsNetwarePasswordSet, jobend=jobend, brPJLInfoDXconfigTable=brPJLInfoDXconfigTable, brpsServiceNDSContext=brpsServiceNDSContext, brpsWLanCapabilityEncryptModeIndex=brpsWLanCapabilityEncryptModeIndex, brCommunicationErrorHistoryEntry=brCommunicationErrorHistoryEntry, netPML=netPML, brpsPortInfoTable=brpsPortInfoTable, brPrtMailboxProtect=brPrtMailboxProtect, brpsWLanLEAPTimeout=brpsWLanLEAPTimeout, cassette=cassette, brpsAppleTalkSupported=brpsAppleTalkSupported, brpsNetwareServerName=brpsNetwareServerName, wlGeneral=wlGeneral, brpsTCPIPAccessEntry=brpsTCPIPAccessEntry, brpsTmpPOP3Name=brpsTmpPOP3Name, brpsMainRevision=brpsMainRevision, brMultiIFDNSTable=brMultiIFDNSTable, brpapertype=brpapertype, brpsNodeName=brpsNodeName, brLdapServerAttrNameIndex=brLdapServerAttrNameIndex, brPrintPagesPaperSize=brPrintPagesPaperSize, colorcorrection=colorcorrection, brpsNtSendSupported=brpsNtSendSupported, brFuncLock=brFuncLock, broriginalKerberos=broriginalKerberos, brEmailReportsTable=brEmailReportsTable, brPrtAdvancedUseMPTrayFirst=brPrtAdvancedUseMPTrayFirst, brFTPSupported=brFTPSupported, brpsLATCircuitTimer=brpsLATCircuitTimer, brFontSwitchOff=brFontSwitchOff, brMultiIFIPv6StaticAddressIndex=brMultiIFIPv6StaticAddressIndex, brLdapServerName=brLdapServerName, brpsSNMPSetCommunity1=brpsSNMPSetCommunity1, brpsNetwareSNAPNetInfo=brpsNetwareSNAPNetInfo, brpsWLanWepKeySize=brpsWLanWepKeySize, brpsWLanCapabilityAuthModeDescription=brpsWLanCapabilityAuthModeDescription, speedDial=speedDial, brMultiIFServiceNetwareServerCount=brMultiIFServiceNetwareServerCount, brntsend=brntsend, npMultiCards=npMultiCards, brMultiIFTCPIPRARPNoSubnet=brMultiIFTCPIPRARPNoSubnet, brpsTmpPrintersEmailaddress=brpsTmpPrintersEmailaddress, destination_subsystem2=destination_subsystem2, traysize=traysize, brCarbonCopyMode=brCarbonCopyMode, wlAdvanced=wlAdvanced, brLPDEnable=brLPDEnable, brpsWLanCapabilityAuthEAPType=brpsWLanCapabilityAuthEAPType, brLdapServerBaseDN=brLdapServerBaseDN, brpsNetwarePollFreq=brpsNetwarePollFreq, brpsAppleTalkEnable=brpsAppleTalkEnable, brSNMPTrapEntry=brSNMPTrapEntry, brpsWLanCapabilityAuthEAPSupportAuthentication=brpsWLanCapabilityAuthEAPSupportAuthentication, brpsServiceAppleTalkType=brpsServiceAppleTalkType, brMediaFixTray1=brMediaFixTray1, brLCDMode1=brLCDMode1, brpsEmailTestResult=brpsEmailTestResult, brpsBanyanPassword=brpsBanyanPassword, eMailReports=eMailReports, brpsDLCLLCLastIFrame=brpsDLCLLCLastIFrame, brpsNDSSupported=brpsNDSSupported, brFuncLockUserPrintPageCountMonoLast=brFuncLockUserPrintPageCountMonoLast, auto_i=auto_i, userSetting=userSetting, brpsTCPIPMethod=brpsTCPIPMethod, brFuncLockUserPrintPageEntry=brFuncLockUserPrintPageEntry, destination_subsystem3=destination_subsystem3, brMultiIFServiceFilterCount=brMultiIFServiceFilterCount, brOneTouchDialCount=brOneTouchDialCount, brpsWLanNetSearchSupported=brpsWLanNetSearchSupported, brNotificationRuleIndex=brNotificationRuleIndex, brFuncLockPublicPrintLimitEnable=brFuncLockPublicPrintLimitEnable, brCapabilityMediatypeTable=brCapabilityMediatypeTable, brInfoHDDSize=brInfoHDDSize, brpsNetwarePassword=brpsNetwarePassword, status=status, copies=copies, brpsMIBMinor=brpsMIBMinor, brProxyServerInfoIndex=brProxyServerInfoIndex, brFuncLockPublicPrintPageCountColorLast=brFuncLockPublicPrintPageCountColorLast, simmkind0=simmkind0, printerinfomation=printerinfomation, brToner2Low=brToner2Low, npCard=npCard, brlat=brlat, brPageIBMLines=brPageIBMLines, brNetSKeyReceiverAddress=brNetSKeyReceiverAddress, brpsPassword=brpsPassword, brPriError=brPriError, brMultiIFLAATable=brMultiIFLAATable, brpsWLanNetworkKey=brpsWLanNetworkKey, tray=tray, brpsNetBIOSPrimaryWINSAddr=brpsNetBIOSPrimaryWINSAddr, brPrintPagesEntry=brPrintPagesEntry, wlWPS=wlWPS, brNotificationStatusGroup=brNotificationStatusGroup, brMultiIFServiceProtocolIPP=brMultiIFServiceProtocolIPP, brpsNetwareServerEntry=brpsNetwareServerEntry, carbonCopy=carbonCopy, brpsNetwareFrameType=brpsNetwareFrameType, brSecurityGeneralStatus=brSecurityGeneralStatus, brSecError=brSecError, brLdapServerInfoEntry=brLdapServerInfoEntry, brpsFirmwareReload=brpsFirmwareReload, brPrtGeneralFeeder=brPrtGeneralFeeder, broriginalJobTermination=broriginalJobTermination, brRegistrationXYellowRight=brRegistrationXYellowRight, controlpanel=controlpanel, brpsPit3WLanTestStatus=brpsPit3WLanTestStatus, advanced=advanced, brMultiIFWebServicesTable=brMultiIFWebServicesTable, brpsBanyanIPCSequenceError=brpsBanyanIPCSequenceError, brPJLInfoStorageconfigIndex=brPJLInfoStorageconfigIndex, netPMLmgmt=netPMLmgmt, npSet=npSet)
mibBuilder.exportSymbols("BROTHER-MIB", mcfNetFaxShare=mcfNetFaxShare, brsimmsize3=brsimmsize3, countinfo=countinfo, brCommunicationErrorHistoryDescription=brCommunicationErrorHistoryDescription, brtray3size=brtray3size, brFuncLockPublicFuncMember=brFuncLockPublicFuncMember, brMultiIFServiceStringInfoTable=brMultiIFServiceStringInfoTable, brttt1=brttt1, brMultiIFConfigureTable=brMultiIFConfigureTable, brPrtAvoidMailboxFullTable=brPrtAvoidMailboxFullTable, brMultiIFServiceStringCount=brMultiIFServiceStringCount, brorg=brorg, wlGeneralStatus=wlGeneralStatus, brpsServiceProtocolAppleTalk=brpsServiceProtocolAppleTalk, pen6=pen6, brpsWLanAuthEAP=brpsWLanAuthEAP, brPrtGeneralBinding=brPrtGeneralBinding, trayPriority=trayPriority, brNotificationRuleEntry=brNotificationRuleEntry, brpsWLanCapabilityEncryptModeType=brpsWLanCapabilityEncryptModeType, brPrintPages=brPrintPages, brpsWLanDataRetry=brpsWLanDataRetry, pushstatus=pushstatus, bio1_explanation=bio1_explanation, brpsWLanCapabilityAuthModeTable=brpsWLanCapabilityAuthModeTable, brpsSMTPTotalRecvFromFailure=brpsSMTPTotalRecvFromFailure, brMultiIFIPv6StaticAddressCount=brMultiIFIPv6StaticAddressCount, brMediaFixTray2=brMediaFixTray2, brLLTDEnable=brLLTDEnable, brScanCountIndex=brScanCountIndex, brDirectPrintPaperSize=brDirectPrintPaperSize, buzzer=buzzer, brMultiIFIPv6StaticAddress=brMultiIFIPv6StaticAddress, broriginalLLTD=broriginalLLTD, brCapabilityPaperIndex=brCapabilityPaperIndex, brpsAvailableWLanCount=brpsAvailableWLanCount, brFuncLockPublicFuncSupported=brFuncLockPublicFuncSupported, brPrtGeneralDuplex=brPrtGeneralDuplex, npMultiIFSet=npMultiIFSet, mcfGeneral=mcfGeneral, brPanelLock=brPanelLock, brFuncLockPublicFuncEnable=brFuncLockPublicFuncEnable, brPrtAdvancedLanguage=brPrtAdvancedLanguage, brPictBridgeOrientation=brPictBridgeOrientation, brCapabilityPaperCount=brCapabilityPaperCount, brStatusSleep=brStatusSleep, brPageEPSONAutoMask=brPageEPSONAutoMask, brTBD3=brTBD3, brpsSMTPTotalSendToFailure=brpsSMTPTotalSendToFailure, brMultiIFLAAEntry=brMultiIFLAAEntry, brMultiIFprotocol=brMultiIFprotocol, brcopies=brcopies, broriginaltelnet=broriginaltelnet, pagesetup=pagesetup, brErrorHistoryEntry=brErrorHistoryEntry, brpsBanyanIPNetworkID1=brpsBanyanIPNetworkID1, brIFaxSupported=brIFaxSupported, brPrtGeneralEmulationTimeout=brPrtGeneralEmulationTimeout, brDirectPrintOrientation=brDirectPrintOrientation, brpsPOP3TotalMessage=brpsPOP3TotalMessage, brpsAdvancedTCPIPAccessSetting=brpsAdvancedTCPIPAccessSetting, brmDNSSupported=brmDNSSupported, brpsTCPIPFastTimeoutEnable=brpsTCPIPFastTimeoutEnable, brPanelTestDemoPage=brPanelTestDemoPage, brPJLInfoIntrayconfigIndex=brPJLInfoIntrayconfigIndex, brServiceMode=brServiceMode, brpsWLanAvailableChannel=brpsWLanAvailableChannel, brNotificationTable=brNotificationTable, brLdapServerAttrDetail4=brLdapServerAttrDetail4, brFuncLockPublicFuncCount=brFuncLockPublicFuncCount, brPageIBMAutoLF=brPageIBMAutoLF, brMultiIFServiceName=brMultiIFServiceName, brpsNetware8023Count=brpsNetware8023Count, brNetRemoteSetUpEnable=brNetRemoteSetUpEnable, brpsAppleTalkWriteError=brpsAppleTalkWriteError, brSNMPV3Supported=brSNMPV3Supported, brMultiIFServicePort=brMultiIFServicePort, brpsEmailSendTestMail=brpsEmailSendTestMail, brpsFirmwareAdvancedAddress=brpsFirmwareAdvancedAddress, brLLTDSupported=brLLTDSupported, brEmailReportsSupported=brEmailReportsSupported, brPrtGeneralBuzzer=brPrtGeneralBuzzer, brpsBanyanTimeout=brpsBanyanTimeout, brFuncLockSetting=brFuncLockSetting, brPageEPSONLines=brPageEPSONLines, brorientation=brorientation, brInfoModelNumber=brInfoModelNumber, brPJLInfoStorageconfigTable=brPJLInfoStorageconfigTable, brOneTouchDialEntry=brOneTouchDialEntry, brpsBanyanSPPListen=brpsBanyanSPPListen, brLockMode=brLockMode, brPrintPagesMediaPlaceIndex=brPrintPagesMediaPlaceIndex, specification=specification, brRingDelayCount=brRingDelayCount, brsimmsize0=brsimmsize0, brpsTCPIPGateway=brpsTCPIPGateway, directprint=directprint, brPanelKeyJobCancel=brPanelKeyJobCancel, brPrtFinisher=brPrtFinisher, mcsNetSKy=mcsNetSKy, auto_e=auto_e, brpsTmpSMTPAUTHPassword=brpsTmpSMTPAUTHPassword, brpsSetDefault=brpsSetDefault, brpsTmpPOP3ServerName=brpsTmpPOP3ServerName, brpsWLanCapabilityAuthModeCount=brpsWLanCapabilityAuthModeCount, verify=verify, brpsNetwareRestart=brpsNetwareRestart, brpsIPPSupported=brpsIPPSupported, brpsNetBEUIEnable=brpsNetBEUIEnable, brnetbeui=brnetbeui, brMultiIFSecondaryDNSIPv6Address=brMultiIFSecondaryDNSIPv6Address, brPanelTestConfiguration=brPanelTestConfiguration, funclock=funclock, brFTPEnable=brFTPEnable, brPageGLPen6GrayLevel=brPageGLPen6GrayLevel, brCarbonCopyEntry=brCarbonCopyEntry, brMultiIFNetBIOSTable=brMultiIFNetBIOSTable, brENetModeSupported=brENetModeSupported, brpsPortQueueSize=brpsPortQueueSize, brLdapServerAttrNameCount=brLdapServerAttrNameCount, brNetScannerEnable=brNetScannerEnable, brSNTPCSyncMethod=brSNTPCSyncMethod, brpsSMTPAUTHPassword=brpsSMTPAUTHPassword, brUPnPEnable=brUPnPEnable, brIPv6Supported=brIPv6Supported, brSecMailAddress=brSecMailAddress, determined=determined, npTcp=npTcp, brInfoPrinterUStatus=brInfoPrinterUStatus, eNet=eNet, brPrintPagesMediaPlaceTable=brPrintPagesMediaPlaceTable, brAutoRegistSetInterval=brAutoRegistSetInterval, brPanelLockOff=brPanelLockOff, brpsPortDescriptionString=brpsPortDescriptionString, brPrtMailboxProtectGroup=brPrtMailboxProtectGroup, brtelnetSupported=brtelnetSupported, brPrtMailboxProtectEntry=brPrtMailboxProtectEntry, brHTTPSSupported=brHTTPSSupported, mfpgeneral_setup=mfpgeneral_setup, autodial=autodial, brPictBridgePrintQuality=brPictBridgePrintQuality, brpsNetBEUISupported=brpsNetBEUISupported, wlCapability=wlCapability, brpsWLanWepKeyEntry=brpsWLanWepKeyEntry, smallPaperSize=smallPaperSize, brDeviceNegotiationConfirmPassword=brDeviceNegotiationConfirmPassword, broriginalCIFS=broriginalCIFS, brSmallPaperSize4=brSmallPaperSize4, brPrtAdvancedYOffset=brPrtAdvancedYOffset, brPJLInfoFirmwareUpdateconfig=brPJLInfoFirmwareUpdateconfig, brLPDSupported=brLPDSupported, pen1=pen1, brPagesSentLastFax=brPagesSentLastFax, brMultiIFServiceTCPQueued=brMultiIFServiceTCPQueued, brpsWLanName=brpsWLanName, brPrtCatchTray=brPrtCatchTray, brpsMIBVersion=brpsMIBVersion, brMultiIFPrimaryInterface=brMultiIFPrimaryInterface, priadmin=priadmin, brMultiIFServiceProtocolNetware=brMultiIFServiceProtocolNetware, brMultiIFNodeType=brMultiIFNodeType, brappletalk=brappletalk, brTCPIPConnectTime=brTCPIPConnectTime, brPJLInfoDXconfig=brPJLInfoDXconfig, brPOP3ServerName=brPOP3ServerName, brMultiIFTCPIPMethod=brMultiIFTCPIPMethod, brMultiIFLAASupported=brMultiIFLAASupported, cassette2=cassette2, brnetware=brnetware, wlWEP=wlWEP, brpsPOP3Name=brpsPOP3Name, brMultiIFSupported=brMultiIFSupported, brLdapServerAttrDetail3=brLdapServerAttrDetail3, brMultiIFServiceProtocolLAT=brMultiIFServiceProtocolLAT, mcFax=mcFax, brPrtAdvancedAutoTimeout=brPrtAdvancedAutoTimeout, brPJLInfoStorageconfig=brPJLInfoStorageconfig, brPanelResetUser=brPanelResetUser, brLCDString16fix=brLCDString16fix, brPageGLPen5GrayLevel=brPageGLPen5GrayLevel, brPageEPSONRightMargin=brPageEPSONRightMargin, brDeviceNegotiationEncryptVer=brDeviceNegotiationEncryptVer, epson=epson, brPrintPagesMediaPlaceCounter=brPrintPagesMediaPlaceCounter, brCapabilityResolutionIndex=brCapabilityResolutionIndex, brInfoType=brInfoType, brpsTmpPOP3PortNumber=brpsTmpPOP3PortNumber, brpsServiceTCPQueued=brpsServiceTCPQueued, brnetConfig=brnetConfig, brPJLInfoOptionsEntry=brPJLInfoOptionsEntry, scanner_setup=scanner_setup, brpsDLCLLCState=brpsDLCLLCState, brpsWLanAuthMode=brpsWLanAuthMode, brCarbonCopyTray=brCarbonCopyTray, printerstatus=printerstatus, brLdapServerAttrNameEntry=brLdapServerAttrNameEntry, brPrtGeneralColor=brPrtGeneralColor, brpsSMTPServerAuthMethod=brpsSMTPServerAuthMethod, brPanelKeyOnline=brPanelKeyOnline, printersetup=printersetup, brMultiIFWebServicesEntry=brMultiIFWebServicesEntry, brPrtAdvancedXOffset=brPrtAdvancedXOffset, brAdvancedDNSSupported=brAdvancedDNSSupported, brMultiIFLAAMacAddress=brMultiIFLAAMacAddress, brpsNetwareServerIndex=brpsNetwareServerIndex, brErrorHistoryTable=brErrorHistoryTable, brLdapSupported=brLdapSupported, brFuncLockUserFuncEnable=brFuncLockUserFuncEnable, brtimeout=brtimeout, brPageGLPen6Size=brPageGLPen6Size, brMultiIFEnetMode=brMultiIFEnetMode, brMultiIFServiceProtocolAppleTalk=brMultiIFServiceProtocolAppleTalk, brSNMPTrapIndex=brSNMPTrapIndex, brNetRemoteSetUpSupported=brNetRemoteSetUpSupported, brSpeedDialIndex=brSpeedDialIndex, brpsWLanCtsRate=brpsWLanCtsRate, brtray2size=brtray2size, secret=secret, mcGeneral=mcGeneral, brMultiIForiginalLAA=brMultiIForiginalLAA, brpsFirmwareIPAddress=brpsFirmwareIPAddress, firmwareupdatekeyword=firmwareupdatekeyword, brFuncLockPcLoginNameTable=brFuncLockPcLoginNameTable, brMultiIFCount=brMultiIFCount, brFuncLockPcLoginNameAuthEnable=brFuncLockPcLoginNameAuthEnable, brFaxHeaderInfo=brFaxHeaderInfo, brLPDType=brLPDType, brFuncLockUserPassword=brFuncLockUserPassword, brtcpip=brtcpip, brPfKitIndexCount=brPfKitIndexCount, brMultiIFIPv6StaticAddressPrefixLength=brMultiIFIPv6StaticAddressPrefixLength, brNotificationRestoration=brNotificationRestoration, brPanelTestFontList=brPanelTestFontList, printPages=printPages, broriginalOtherSetting=broriginalOtherSetting, brMultiIFInterfaceInformation=brMultiIFInterfaceInformation, brPrtAdvancedJamRecovery=brPrtAdvancedJamRecovery, brpsPOP3TotalConnectFailure=brpsPOP3TotalConnectFailure, brpsServiceNetwareRemotePrinterNum=brpsServiceNetwareRemotePrinterNum, brEmailReportsNoRTCFrequency=brEmailReportsNoRTCFrequency, brNotificationAddress=brNotificationAddress, finisher=finisher, brMultiIFIPv6StaticAddressTable=brMultiIFIPv6StaticAddressTable, auto_p=auto_p, brPanelKeyGo=brPanelKeyGo, brLdapServerPasswordSet=brLdapServerPasswordSet, brLCDMode3=brLCDMode3, brpsPOP3TotalPasswordFailure=brpsPOP3TotalPasswordFailure, simm=simm, brpsServiceStringIndex=brpsServiceStringIndex, brMultiIFServiceStringInfoEntry=brMultiIFServiceStringInfoEntry, brPrintPagesFuncEntry=brPrintPagesFuncEntry, brFontPointSize=brFontPointSize, brMultiIFNodeName=brMultiIFNodeName)
mibBuilder.exportSymbols("BROTHER-MIB", brpsPortSNMPExtensions=brpsPortSNMPExtensions, brMultiIFServiceFilter=brMultiIFServiceFilter, brMultiIFServiceTCPPort=brMultiIFServiceTCPPort, brPageGLPen3GrayLevel=brPageGLPen3GrayLevel, brpsNtSendEnable=brpsNtSendEnable, brFirmwareUpdateKeywordIndex=brFirmwareUpdateKeywordIndex, broriginalupnp=broriginalupnp, brPfKitCount=brPfKitCount, brpsBanyanIPCListen=brpsBanyanIPCListen, brpsFirmwareFile=brpsFirmwareFile, brMultiIFdns=brMultiIFdns, brCarbonCopies=brCarbonCopies, brpsServiceVines=brpsServiceVines, brMultiIFIPv6AddressCountEntry=brMultiIFIPv6AddressCountEntry, brpsPortBinaryMode=brpsPortBinaryMode, brpsEmailSendTestSupported=brpsEmailSendTestSupported, brpsBanyanErrorPT=brpsBanyanErrorPT, brpsWLanOperatingName=brpsWLanOperatingName, brScanCountIndexCount=brScanCountIndexCount, brpsSMTPEnhancedAuthSupported=brpsSMTPEnhancedAuthSupported, brMultiIFAPIPASupported=brMultiIFAPIPASupported, brDirectPrintMediaType=brDirectPrintMediaType, brInfoSerialNumber=brInfoSerialNumber, brpsTmpSMTPAUTHUsername=brpsTmpSMTPAUTHUsername, brMultiIFServiceProtocolDLC=brMultiIFServiceProtocolDLC, brpsTCPIPRARPNoGateway=brpsTCPIPRARPNoGateway, ibm=ibm, brSmallPaperSizeMP=brSmallPaperSizeMP, brProxyServerPort=brProxyServerPort, brpsPortInfoEntry=brpsPortInfoEntry, brSecretMPRetry=brSecretMPRetry, test=test, brMultiIFWebServicesMetadataVersion=brMultiIFWebServicesMetadataVersion, brPanelResetFactory=brPanelResetFactory, brSMTPServerName=brSMTPServerName, brColorCalibration=brColorCalibration, brLdapServerPort=brLdapServerPort, brpsWLanSESSupported=brpsWLanSESSupported, brTBD2=brTBD2, brMultiIFActiveIF=brMultiIFActiveIF, brMultiIFServiceCount=brMultiIFServiceCount, brpsNetwareServicingServerCount=brpsNetwareServicingServerCount, brProxySupported=brProxySupported, npCtl=npCtl, brLCDMode5=brLCDMode5, brEWSSupported=brEWSSupported, brPrtAdvancedTrayPriority=brPrtAdvancedTrayPriority, brpsDLCPrintStatus=brpsDLCPrintStatus, brPageEPSONAutoLF=brPageEPSONAutoLF, brMultiIFTCPIPAddress=brMultiIFTCPIPAddress, brDirectPrintOutputColor=brDirectPrintOutputColor, brpsWLanMode=brpsWLanMode, brNetSKeyEnable=brNetSKeyEnable, brret=brret, brpsSNMPSetCommunity2=brpsSNMPSetCommunity2, brpsBanyanHopCount=brpsBanyanHopCount, prt_setup=prt_setup, brpsWLanAPSetupMode=brpsWLanAPSetupMode, brDNSIPSetup=brDNSIPSetup, brSNTPCSyncResult=brSNTPCSyncResult, brSecurePrintRAMSizeMax=brSecurePrintRAMSizeMax, brpsTestPage=brpsTestPage, brFuncLockUserPrintPageCountColorLast=brFuncLockUserPrintPageCountColorLast, etherN=etherN, brMultiIFServiceMatch=brMultiIFServiceMatch, brpsDLCLLCPortStatus=brpsDLCLLCPortStatus, brMultiIFHardwareType=brMultiIFHardwareType, brProxyServerCount=brProxyServerCount, brInfoSolutionsCenterURL=brInfoSolutionsCenterURL, brTrayPriorityMember=brTrayPriorityMember, brPrimaryDNSIP=brPrimaryDNSIP, brSecurePrintRAMSize=brSecurePrintRAMSize, brRegistrationXYellowLeft=brRegistrationXYellowLeft, brPageEPSONTopMargin=brPageEPSONTopMargin, brMultiIForiginalapipa=brMultiIForiginalapipa, brpsNetBIOSIPSupported=brpsNetBIOSIPSupported, fax_general=fax_general, brPrtAdvancedMPTrayFeed=brPrtAdvancedMPTrayFeed, brEWSEnable=brEWSEnable, broriginalmdns=broriginalmdns, brFirmwareUpdateKeyword=brFirmwareUpdateKeyword, brPageIBMAutoCR=brPageIBMAutoCR, brIPv6Enable=brIPv6Enable, brMultiIFNetBIOSEntry=brMultiIFNetBIOSEntry, brpsAvailableWLanAuthMode=brpsAvailableWLanAuthMode, brOneTouchDialTable=brOneTouchDialTable, brDNSSupported=brDNSSupported, brPanelKeyMode=brPanelKeyMode, brPrintPagesPaperTypeTable=brPrintPagesPaperTypeTable, brMultiIFTCPIPNetBIOSSecondaryWINSAddr=brMultiIFTCPIPNetBIOSSecondaryWINSAddr, brLdapEnable=brLdapEnable, brMultiIFControlTable=brMultiIFControlTable, funa=funa, brLdapServerPassword=brLdapServerPassword, brpersonality=brpersonality, brpsServiceInfoTable=brpsServiceInfoTable, brsimmtype0=brsimmtype0, brPrtAdvancedAutoFormFeed=brPrtAdvancedAutoFormFeed, brPrintPagesFuncIndex=brPrintPagesFuncIndex, brpsWLanCapabilityAuthModeType=brpsWLanCapabilityAuthModeType, brpsServiceProtocolIPP=brpsServiceProtocolIPP, brPagePCLBottomMargin=brPagePCLBottomMargin, brFuncLockUserFuncMember=brFuncLockUserFuncMember, brpsDLCEnable=brpsDLCEnable, dns=dns, brMultiIFServiceNetwareServerMode=brMultiIFServiceNetwareServerMode, brCapabilityPaperTable=brCapabilityPaperTable, brnetConfigOpt=brnetConfigOpt, brNetPcFaxRxEnable=brNetPcFaxRxEnable, brpsSMTPTotalConnectFailure=brpsSMTPTotalConnectFailure, brPageIBMBottomMargin=brPageIBMBottomMargin, brFuncLockUserPrintPageIndex=brFuncLockUserPrintPageIndex, brInfoLowerMIBVer=brInfoLowerMIBVer, brSNMPV3PrivPassword=brSNMPV3PrivPassword, brEWSRegularPortEnable=brEWSRegularPortEnable, wlSetup=wlSetup, brpowerstime=brpowerstime, destination_subsystem1=destination_subsystem1, brpsPortCount=brpsPortCount, brCIFSSupported=brCIFSSupported, brLCDString2=brLCDString2, brMultiIFNetBEUIDomain=brMultiIFNetBEUIDomain, brpsServiceStringLimit=brpsServiceStringLimit, tonerlow=tonerlow, brPageGLPen4GrayLevel=brPageGLPen4GrayLevel, brpsAvailableWLanScanWaitTime=brpsAvailableWLanScanWaitTime, brFuncLockPublicTable=brFuncLockPublicTable, npSys=npSys, brCapabilityPaperEntry=brCapabilityPaperEntry, brEmailReportsIndex=brEmailReportsIndex, brPrtMailbox=brPrtMailbox, print_engine=print_engine, brCapabilityOrientationCount=brCapabilityOrientationCount, brPrtMailboxOutbin=brPrtMailboxOutbin, brFindTime=brFindTime, brDeviceNegotiationGetChallenge=brDeviceNegotiationGetChallenge, brNotificationErrorRule=brNotificationErrorRule, brMultiIFType=brMultiIFType, brFuncLockPublicEntry=brFuncLockPublicEntry, brKerberosSupported=brKerberosSupported, brpsSMTPAUTHUsername=brpsSMTPAUTHUsername, brMultiIFTCPIPEntry=brMultiIFTCPIPEntry, brMultiIFTCPIPRARPNoGateway=brMultiIFTCPIPRARPNoGateway, ps=ps, broriginalIPv6=broriginalIPv6, brpsNetBIOSIPMethod=brpsNetBIOSIPMethod, brPanelKeySecure=brPanelKeySecure, broriginalLegacy=broriginalLegacy, brpsAvailableWLanScan=brpsAvailableWLanScan, mp=mp, brInfoReplaceTime=brInfoReplaceTime, brdensity=brdensity, brpsBanyanServerAddress2=brpsBanyanServerAddress2, brpsNetwareEtherIINetInfo=brpsNetwareEtherIINetInfo, brPrtAdvancedButtonRepeat=brPrtAdvancedButtonRepeat, brFuncLockPcLoginNameAuthIndex=brFuncLockPcLoginNameAuthIndex, brMultiIFServiceProtocolNetBEUI=brMultiIFServiceProtocolNetBEUI, brInfoDeviceSubRomVersion=brInfoDeviceSubRomVersion, onetouchDial=onetouchDial, system=system, brNotificationStatusID=brNotificationStatusID, brpsWLanCapabilityAuthEAPIndex=brpsWLanCapabilityAuthEAPIndex, brpsPortName=brpsPortName, brInfoNetVerUpStatus=brInfoNetVerUpStatus, brpsEmailEnable=brpsEmailEnable, brlines=brlines, pen2=pen2, brLCDString1=brLCDString1, brpsBanyanSupported=brpsBanyanSupported, brMultiIFIPv6AddressEntry=brMultiIFIPv6AddressEntry, brDialDataAllClear=brDialDataAllClear, brPrtMailboxProtectIndex=brPrtMailboxProtectIndex, brpsAvailableWLanIndex=brpsAvailableWLanIndex, brSNMPEnable=brSNMPEnable, brPageGLPen4Size=brPageGLPen4Size, brpsLATTimeout=brpsLATTimeout, brRegistrationYMagenta=brRegistrationYMagenta, brpsWLanAssociateResult=brpsWLanAssociateResult, mcfFaxInfomation=mcfFaxInfomation, brLdapServerCount=brLdapServerCount, brMultiIFTCPIPDNSIPSetup=brMultiIFTCPIPDNSIPSetup, brFirmwareUpdateKeywordTable=brFirmwareUpdateKeywordTable, brpsWLanTransmitPowerSetting=brpsWLanTransmitPowerSetting, brPrtAdvancedFFSuppress=brPrtAdvancedFFSuppress, brFontPitch=brFontPitch, simmkind1=simmkind1, brPanelKeyContinue=brPanelKeyContinue, brpsFirmwareHost=brpsFirmwareHost, brMultiIFServiceAppleTalkType=brMultiIFServiceAppleTalkType, brSNTPCSupported=brSNTPCSupported, brFuncLockUserPrintPageTable=brFuncLockUserPrintPageTable, brpsServiceFilterCount=brpsServiceFilterCount, brMultiIFTCPIPGateway=brMultiIFTCPIPGateway, brLdapServerAttrDetail1=brLdapServerAttrDetail1, npPort=npPort, brpsTCPIPTimeout=brpsTCPIPTimeout, pjlinfo=pjlinfo, brMultiIFInterfaceEnableImmediate=brMultiIFInterfaceEnableImmediate, brWebServicesSupported=brWebServicesSupported, brDirectPrintSetting=brDirectPrintSetting, brTCPIPServerAddress=brTCPIPServerAddress, brPagePCLAutoWrap=brPagePCLAutoWrap, brLdapServerAttrDetailEnable2=brLdapServerAttrDetailEnable2, brPrintPagesFuncCounter=brPrintPagesFuncCounter, brSpeedDialEntry=brSpeedDialEntry, brpsTCPIPBanner=brpsTCPIPBanner, brpsWLanAssociate=brpsWLanAssociate, brMultiIFTCPIPUseMethod=brMultiIFTCPIPUseMethod, brMultiIFIPv6AddressIndex=brMultiIFIPv6AddressIndex, brSmallPaperSize3=brSmallPaperSize3, npConfig=npConfig, brInfoNextCare=brInfoNextCare, brPageGLPen5Size=brPageGLPen5Size, brPrtAdvancedBuzzerVolume=brPrtAdvancedBuzzerVolume, brpsLATTransmitBufferMax=brpsLATTransmitBufferMax, brPrtAdvancedMessageScroll=brPrtAdvancedMessageScroll, brFuncLockUserName=brFuncLockUserName, pen4=pen4, brEmailReportsReportFormat=brEmailReportsReportFormat, mail=mail, brpsWLanCtsType=brpsWLanCtsType, brpsNetBIOSIPEnable=brpsNetBIOSIPEnable, brPJLInfoOptionsIndex=brPJLInfoOptionsIndex, margin_p=margin_p, brpsNetwareServicingQueueName=brpsNetwareServicingQueueName, brProxyServerType=brProxyServerType, brPJLInfoOuttrayconfigTable=brPJLInfoOuttrayconfigTable, brAPIPASupported=brAPIPASupported, brFuncLockPcLoginNameAuthCount=brFuncLockPcLoginNameAuthCount, brpsNetwareSupported=brpsNetwareSupported, brLdapServerUserDN=brLdapServerUserDN, brSecurityGeneralSetup=brSecurityGeneralSetup, brPageGLPen3Size=brPageGLPen3Size, brMultiIFWebServicesInstanceID=brMultiIFWebServicesInstanceID, brPrtAvoidMailboxFull=brPrtAvoidMailboxFull, brMultiIFAllSetDefault=brMultiIFAllSetDefault, brSNTPCSecondaryServerPort=brSNTPCSecondaryServerPort, brToner1Low=brToner1Low, brPanelKeyReprint=brPanelKeyReprint, brScanCountType=brScanCountType, brMultiIFServiceStringLimit=brMultiIFServiceStringLimit, brpsNetwareAdvFreq=brpsNetwareAdvFreq, brFirmwareUpdateKeywordEntry=brFirmwareUpdateKeywordEntry, brpsWLanDeviceType=brpsWLanDeviceType, brFontName=brFontName, brPrintPagesIndex=brPrintPagesIndex, brpsSMTPAUTHPasswordSet=brpsSMTPAUTHPasswordSet, brpsTmpSMTPServerName=brpsTmpSMTPServerName, brMultiIFIPv6AddressTable=brMultiIFIPv6AddressTable, brpsWLanWepKeyTable=brpsWLanWepKeyTable, brPictBridgeFileName=brPictBridgeFileName, brNetScannerSupported=brNetScannerSupported, clockfunction=clockfunction, simmkind2=simmkind2)
mibBuilder.exportSymbols("BROTHER-MIB", brInfoDeviceRomVersion=brInfoDeviceRomVersion, brEmailReportsDate=brEmailReportsDate, brpsServiceInfoEntry=brpsServiceInfoEntry, brCarbonCopyMacroID=brCarbonCopyMacroID, brPrtMailboxProtectTable=brPrtMailboxProtectTable, mediatype=mediatype, brpsTmpSMTPPortNumber=brpsTmpSMTPPortNumber, brpsFirmwareDescription=brpsFirmwareDescription, brFuncLockAutoCountResetTime=brFuncLockAutoCountResetTime, brpsWLanWPSSupported=brpsWLanWPSSupported, brMultiIFTCPIPBootTries=brMultiIFTCPIPBootTries, brpsPOP3Supported=brpsPOP3Supported, brpsWLanEncryptMode=brpsWLanEncryptMode, brpsEmailSendRecvTestCall=brpsEmailSendRecvTestCall, scanToInfo=scanToInfo, brClockFuncSummerTime=brClockFuncSummerTime, brpsPortHTTPExtensions=brpsPortHTTPExtensions, capability=capability, brpsEmailTestDestinationAddress=brpsEmailTestDestinationAddress, brbanyan=brbanyan, brSNMPV3UserName=brSNMPV3UserName, brIPPSSLPortEnable=brIPPSSLPortEnable, brpsEnetMode=brpsEnetMode, brpsAvailableWLanCommMode=brpsAvailableWLanCommMode, brProxyServerInfoTable=brProxyServerInfoTable, brpsPortType=brpsPortType, brpsServiceProtocolNetware=brpsServiceProtocolNetware, brpsTCPIPRARPNoSubnet=brpsTCPIPRARPNoSubnet, brsimmsize1=brsimmsize1, reset=reset, brLLMNREnable=brLLMNREnable, breconomode=breconomode, brservice=brservice, broriginalproxy=broriginalproxy, brpsWLanCapabilityEncryptModeSupported=brpsWLanCapabilityEncryptModeSupported, brPJLInfoOuttrayconfig=brPJLInfoOuttrayconfig, brMultiIFServiceString=brMultiIFServiceString, brpsDLCLLCRecvPacket=brpsDLCLLCRecvPacket, brpsLATGroup=brpsLATGroup, brFuncLockPublicPrintPageCountMonoLast=brFuncLockPublicPrintPageCountMonoLast, brtelnetEnable=brtelnetEnable, brpsPOP3TotalAPOPFailure=brpsPOP3TotalAPOPFailure, brpsPOP3Address=brpsPOP3Address, brpsAppleTalkPrintJob=brpsAppleTalkPrintJob, brpsBanyanErrorCS=brpsBanyanErrorCS, general=general, brNotificationMainRule=brNotificationMainRule, brMultiIFIPv6MethodServer=brMultiIFIPv6MethodServer, brMultiIFSetDefault=brMultiIFSetDefault, brpsBanyanServerAddress1=brpsBanyanServerAddress1, brClockFuncTimeZone=brClockFuncTimeZone, brLdapServerAttrNameTable=brLdapServerAttrNameTable, brLAASupported=brLAASupported, brMultiIFIPv6StaticAddressEntry=brMultiIFIPv6StaticAddressEntry, brpsServiceObsolete=brpsServiceObsolete, brPrintPagesPaperTypeIndex=brPrintPagesPaperTypeIndex, brCarbonCopyIndex=brCarbonCopyIndex, brPagePCLAutoSkip=brPagePCLAutoSkip, adminCapa=adminCapa, brpsWLanCapabilityEncryptModeEntry=brpsWLanCapabilityEncryptModeEntry, brpsWLanAssociateTestResult=brpsWLanAssociateTestResult, brpsWLanTransmitLevel=brpsWLanTransmitLevel, brPJLInfoFirmwareUpdateconfigEntry=brPJLInfoFirmwareUpdateconfigEntry, brFuncLockAdminPassword=brFuncLockAdminPassword, nm=nm, brLdapServerAttrDetail2=brLdapServerAttrDetail2, brPrtAdvancedPrintDensity=brPrtAdvancedPrintDensity, brpsPortInhibitDatagramSupport=brpsPortInhibitDatagramSupport, brpsWLanCapabilityAuthEAPDescription=brpsWLanCapabilityAuthEAPDescription, brTrayPriorityTable=brTrayPriorityTable, brEmailReportsEntry=brEmailReportsEntry, brMultiIFIPv6AddressCountTable=brMultiIFIPv6AddressCountTable, wlSES=wlSES, brInfoCoverage=brInfoCoverage, brpsWLanLengthThreshold=brpsWLanLengthThreshold, brEmailReportsTime=brEmailReportsTime, brLdapKerberosServerName=brLdapKerberosServerName, economy=economy, brpsSMTPTotalConnect=brpsSMTPTotalConnect, brFuncLockPublicPrintPageCountMono=brFuncLockPublicPrintPageCountMono, brMultiIFTCPIPConnectTime=brMultiIFTCPIPConnectTime, brFuncLockAutoCountResetWeek=brFuncLockAutoCountResetWeek, brSecretReprint=brSecretReprint, brFontSetting=brFontSetting, brTrayPriorityCount=brTrayPriorityCount, brmDNSPrinterName=brmDNSPrinterName, brFuncLockPublicPrintPageMax=brFuncLockPublicPrintPageMax, brpsWLanOperatingMode=brpsWLanOperatingMode, brCommunicationErrorHistoryCount=brCommunicationErrorHistoryCount, brLCDString5=brLCDString5, mediaFix=mediaFix, brEmailReportsSendReportNow=brEmailReportsSendReportNow, brdlc=brdlc, brPrintPagesPaperTypeEntry=brPrintPagesPaperTypeEntry, brpsServiceProtocolTCPIP=brpsServiceProtocolTCPIP, brCapabilityMediatypeName=brCapabilityMediatypeName, brpsNetware8023NetInfo=brpsNetware8023NetInfo, brpsWLanRSSLevel=brpsWLanRSSLevel, brNotificationVersion=brNotificationVersion, brMultiIFTCPIPMethodServer=brMultiIFTCPIPMethodServer, brMultiIFServiceEOT=brMultiIFServiceEOT, brInfoBlackPrint=brInfoBlackPrint, brpsTCPIPUseMethod=brpsTCPIPUseMethod, brIPPRegularPortEnable=brIPPRegularPortEnable, brIPPOriginalPortEnable=brIPPOriginalPortEnable, brNotificationIndex=brNotificationIndex, brEmailReportsWeek=brEmailReportsWeek, brFuncLockPublicPrintPageCountColor=brFuncLockPublicPrintPageCountColor, brSNMPV3AuthKey=brSNMPV3AuthKey, brDeviceNegotiationChangePassword=brDeviceNegotiationChangePassword, brMultiIFIPv6Address=brMultiIFIPv6Address, brCapabilityResolution=brCapabilityResolution, brSecondaryDNSIP=brSecondaryDNSIP, brPictBridgeDateTime=brPictBridgeDateTime, brpsPOP3TotalIOError=brpsPOP3TotalIOError, brMultiIFServiceEntry=brMultiIFServiceEntry, brpapertypeMP=brpapertypeMP, brPJLInfoStorageconfigEntry=brPJLInfoStorageconfigEntry, brpsWLanCommMode=brpsWLanCommMode, brMediaFixMP=brMediaFixMP, brBackLightColor=brBackLightColor, brieee1284id=brieee1284id, brPJLInfoFirmwareUpdateconfigIndex=brPJLInfoFirmwareUpdateconfigIndex, cassette4=cassette4, simmkind3=simmkind3, brpsNetBIOSPrintingSupported=brpsNetBIOSPrintingSupported, brPrtAdvancedSleepIndication=brPrtAdvancedSleepIndication, brpsTCPIPMaxWindow=brpsTCPIPMaxWindow, brMultiIFIPv6StaticAddressEnable=brMultiIFIPv6StaticAddressEnable, brPrtAdvancedAutoOnline=brPrtAdvancedAutoOnline, brPrintPagesFuncType=brPrintPagesFuncType, broriginalLLMNR=broriginalLLMNR, brBasicSettingConfigured=brBasicSettingConfigured, brFuncLockUserTable=brFuncLockUserTable, brPanelLockPasswd=brPanelLockPasswd, brWebServicesEnable=brWebServicesEnable, brpsWLanTKIPChangeInterval=brpsWLanTKIPChangeInterval, brpsLATReceiveBufferMax=brpsLATReceiveBufferMax, brpsTmpSMTPAUTHPasswordModified=brpsTmpSMTPAUTHPasswordModified, brDirectPrintPrintQuality=brDirectPrintPrintQuality, brpsTmpSMTPServerAuthMethod=brpsTmpSMTPServerAuthMethod, brpsServiceCount=brpsServiceCount, brpsFirmwareXModem=brpsFirmwareXModem, brCapabilityOrientationTable=brCapabilityOrientationTable, brMultiIFPrimaryDNSIPAddress=brMultiIFPrimaryDNSIPAddress, brpsServiceProtocolBanyan=brpsServiceProtocolBanyan, brMultiIFIPv6StaticAddressCountEntry=brMultiIFIPv6StaticAddressCountEntry, pjl=pjl, brPagePCLLeftMargin=brPagePCLLeftMargin, brpsAvailableWLanMode=brpsAvailableWLanMode, brPagePSKeepPCLFonts=brPagePSKeepPCLFonts, brCarbonCopyMacro=brCarbonCopyMacro, brpsPasswordVerify=brpsPasswordVerify, fontsetup=fontsetup, adminsetting=adminsetting, brInfoMaintenance=brInfoMaintenance, brCapabilityOrientationEntry=brCapabilityOrientationEntry, brTBD1=brTBD1, brCapabilityOrientationName=brCapabilityOrientationName, brPagePCLRightMargin=brPagePCLRightMargin, brMultiIFPrimaryDNSIPv6Address=brMultiIFPrimaryDNSIPv6Address, brNetFaxShareSupported=brNetFaxShareSupported, brpsAvailableWLanName=brpsAvailableWLanName, brAutoRegistRegistrate=brAutoRegistRegistrate, brProxyBypassServer=brProxyBypassServer, brFuncLockUserFuncTable=brFuncLockUserFuncTable, brpsTCPIPSupported=brpsTCPIPSupported, brEWSSSLPortEnable=brEWSSSLPortEnable, brpsWLanCapabilityAuthEAPTable=brpsWLanCapabilityAuthEAPTable, brUserPasswordVerify=brUserPasswordVerify, brpsServiceIndex=brpsServiceIndex, brSNMPV3PrivKey=brSNMPV3PrivKey, brENetMode=brENetMode, autocountreset=autocountreset, brMultiIFServiceNDSTree=brMultiIFServiceNDSTree, brPJLInfoOuttrayconfigIndex=brPJLInfoOuttrayconfigIndex, brDirectPrintPdfOption=brDirectPrintPdfOption, brpsServiceMatch=brpsServiceMatch, brpsTCPIPBootTries=brpsTCPIPBootTries, pictbridge=pictbridge, brMultiIFControlEntry=brMultiIFControlEntry, brpsEmailSendTestCall=brpsEmailSendTestCall, brpsAPOPSupported=brpsAPOPSupported, brNetPcFaxRxSupported=brNetPcFaxRxSupported, brPrtAdvancedInputBuffer=brPrtAdvancedInputBuffer, brDirectPrintPdfThumbnailType=brDirectPrintPdfThumbnailType, brTFTPSupported=brTFTPSupported, brpsServiceReceiveOnly=brpsServiceReceiveOnly, brnetMultiIFConfig=brnetMultiIFConfig, brDirectPrintCollate=brDirectPrintCollate, broriginalWebServices=broriginalWebServices, broriginalinternetsetting=broriginalinternetsetting, brPfKitEntry=brPfKitEntry, brpsNetwareEtherIICount=brpsNetwareEtherIICount, brPageIBMRightMargin=brPageIBMRightMargin, brpsAvailableWLanChannel=brpsAvailableWLanChannel, brMultiIFServiceProtocolTCPIP=brMultiIFServiceProtocolTCPIP, brSNMPV3KeyType=brSNMPV3KeyType, brpsPOP3PollFreq=brpsPOP3PollFreq, brpsSerialNumber=brpsSerialNumber, brWebServicesRegularPortEnable=brWebServicesRegularPortEnable, brProxyServerInfoEntry=brProxyServerInfoEntry, brFuncLockPcLoginName=brFuncLockPcLoginName, brInfoUpperMIBVer=brInfoUpperMIBVer, brMultiIFServiceProtocolBanyan=brMultiIFServiceProtocolBanyan, brPrtAdvancedErrorBuzzer=brPrtAdvancedErrorBuzzer, brpsPOP3Password=brpsPOP3Password, brFuncLockUserPrintPageCountMono=brFuncLockUserPrintPageCountMono, brpsFirmwareAdvancedAddressSupported=brpsFirmwareAdvancedAddressSupported, brpsPortAttribute=brpsPortAttribute, brInfoJamCountClear=brInfoJamCountClear, brpsTmpPOP3Password=brpsTmpPOP3Password, brTimestampLastFax=brTimestampLastFax, brPrintPagesTable=brPrintPagesTable, brSecurityDeviceNegotiation=brSecurityDeviceNegotiation, brpsDLCSupported=brpsDLCSupported, brLdapSetDefault=brLdapSetDefault, brSNMPCommMode=brSNMPCommMode, brpsNetBIOSSecondaryWINSAddr=brpsNetBIOSSecondaryWINSAddr, brconfig=brconfig, brCapabilityOrientationIndex=brCapabilityOrientationIndex, brpsServiceStringInfoEntry=brpsServiceStringInfoEntry, device=device, brPagePCLAutoLF=brPagePCLAutoLF, brTrayPriorityIndex=brTrayPriorityIndex, brpsBanyanRouter1=brpsBanyanRouter1, brPfKitIndex=brPfKitIndex, brpsBanyanIPNetworkID2=brpsBanyanIPNetworkID2, brsimmtype1=brsimmtype1, brpsFlashROMSize=brpsFlashROMSize, brpsWLanDestination=brpsWLanDestination, brsimmsize2=brsimmsize2, brpsServiceReplace=brpsServiceReplace, brInfoHDDSlot1=brInfoHDDSlot1, brpsWLanCapabilityAuthEAPEntry=brpsWLanCapabilityAuthEAPEntry, brprotocol=brprotocol, brSNTPCPrimaryServerPort=brSNTPCPrimaryServerPort, brpsPortInfoString=brpsPortInfoString, brShowIPAddressInfo=brShowIPAddressInfo, brPagePCLAutoCR=brPagePCLAutoCR, brNotificationRuleValue=brNotificationRuleValue, brAPIPAEnable=brAPIPAEnable, brCapabilityMediatypeIndex=brCapabilityMediatypeIndex, brEmailReportsAddress=brEmailReportsAddress, brMultiIFTCPIPTimeout=brMultiIFTCPIPTimeout, bremail=bremail, brpsTCPIPEnable=brpsTCPIPEnable, brMultiIForiginalWebServices=brMultiIForiginalWebServices, brInfoCounter=brInfoCounter, brpsNetwarePrintJob=brpsNetwarePrintJob, brInfoHDDInternal=brInfoHDDInternal, broriginalLPD=broriginalLPD, brPrtAdvancedPriority=brPrtAdvancedPriority, brInfoPConSupported=brInfoPConSupported)
mibBuilder.exportSymbols("BROTHER-MIB", brpsHardwareType=brpsHardwareType, brInfoStatus=brInfoStatus, brInfoReplaceCount=brInfoReplaceCount, brpsWLanChannel=brpsWLanChannel, brPanelTestTestPage=brPanelTestTestPage, brErrorHistoryDescription=brErrorHistoryDescription, brPrintPagesFuncTable=brPrintPagesFuncTable, errorHistory=errorHistory, brpsPOP3PasswordSet=brpsPOP3PasswordSet, brpsWLanOperatingChannel=brpsWLanOperatingChannel, wlStatus=wlStatus, brPJLInfoOptionsTable=brPJLInfoOptionsTable, brPfKitTable=brPfKitTable, brpsServiceFilter=brpsServiceFilter, brSNMPSupported=brSNMPSupported, brLPDBannerPage=brLPDBannerPage, brFuncLockUserPrintPageLimitEnable=brFuncLockUserPrintPageLimitEnable, brpsBanyanSPPSequenceError=brpsBanyanSPPSequenceError, brpaper=brpaper, brNetRemoteSetUpFileFormat=brNetRemoteSetUpFileFormat, brpsAvailableWLanEntry=brpsAvailableWLanEntry, brpsWLanOperatingWepKeyDefaultIndex=brpsWLanOperatingWepKeyDefaultIndex, brMediaFixTray4=brMediaFixTray4, brRawPortSupported=brRawPortSupported, brFuncLockUserPrintPageCountColor=brFuncLockUserPrintPageCountColor, resolution=resolution, brJamPlace=brJamPlace, brTFTPEnable=brTFTPEnable, brpsWLanWepKeyType=brpsWLanWepKeyType, brpsWLanCapabilityAuthEAPSupportEncryption=brpsWLanCapabilityAuthEAPSupportEncryption, brMultiIFservice=brMultiIFservice, brPictBridgePaperSize=brPictBridgePaperSize, brCapabilityResolutionEntry=brCapabilityResolutionEntry, brPageGLPen2Size=brPageGLPen2Size, brFuncLockPcLoginNameAuthID=brFuncLockPcLoginNameAuthID, brpsServerDescription=brpsServerDescription, brPagePSPrintPSError=brPagePSPrintPSError, brpsSMTPPortNumber=brpsSMTPPortNumber, broriginalEWS=broriginalEWS, brPageGLPen2GrayLevel=brPageGLPen2GrayLevel, bripp=bripp, brCapabilityMediatypeCount=brCapabilityMediatypeCount, brHTTPSEnable=brHTTPSEnable, brSpeedDialTable=brSpeedDialTable, brFuncLockUserFuncEntry=brFuncLockUserFuncEntry, brFontSwitchOn=brFontSwitchOn, brEmailReportsFrequency=brEmailReportsFrequency, broriginaltcpip=broriginaltcpip, brPageGLPen1GrayLevel=brPageGLPen1GrayLevel, broriginalSNMPTrap=broriginalSNMPTrap, broriginalSecurity=broriginalSecurity, brpsWLanCapabilityAuthEAPCount=brpsWLanCapabilityAuthEAPCount, brpsAvailableWLanPowerLevel=brpsAvailableWLanPowerLevel, brLdapServerAttrName=brLdapServerAttrName, wlNetSearch=wlNetSearch, brpsWLanRtsCtsThreshold=brpsWLanRtsCtsThreshold, brToner3Low=brToner3Low, brPanelKeyFormFeed=brPanelKeyFormFeed, brpsPOP3TotalConnect=brpsPOP3TotalConnect, brFuncLockSettingInit=brFuncLockSettingInit, brPJLInfoOptions=brPJLInfoOptions, brpsPOP3TotalUserFailure=brpsPOP3TotalUserFailure, brpsTCPIPSubnetMask=brpsTCPIPSubnetMask, brErrorHistoryAllClear=brErrorHistoryAllClear, pen3=pen3, brpsWLanCapabilityEncryptModeCount=brpsWLanCapabilityEncryptModeCount, brpsPOP3Timeout=brpsPOP3Timeout, brpsBanyanPasswordSet=brpsBanyanPasswordSet, brSNTPCServerMethod=brSNTPCServerMethod, brSmallPaperSize1=brSmallPaperSize1, brpsNetware8022NetInfo=brpsNetware8022NetInfo, brLCDMode2=brLCDMode2, brFuncLockUserCount=brFuncLockUserCount, brpsServicePort=brpsServicePort, brpsChangeSMTPPortSupported=brpsChangeSMTPPortSupported, brfirmware=brfirmware, brPrtGeneralPowerSave=brPrtGeneralPowerSave, brpsEmailRecvTestCall=brpsEmailRecvTestCall, brMultiIFDNSEntry=brMultiIFDNSEntry, brLegacyCompatible=brLegacyCompatible, brFuncLockUserPrintPageCounterReset=brFuncLockUserPrintPageCounterReset, gl=gl, brMultiIFTCPIPNetBIOSPrimaryWINSAddr=brMultiIFTCPIPNetBIOSPrimaryWINSAddr, pen5=pen5, brMultiIFTCPIPSubnetMask=brMultiIFTCPIPSubnetMask, brMultiIFnetbeui=brMultiIFnetbeui, brpsWLanCommSpeed=brpsWLanCommSpeed, brpsWLanWepKeyDefaultIndex=brpsWLanWepKeyDefaultIndex, brpsSMTPTotalMessage=brpsSMTPTotalMessage, brFuncLockPublicFuncIndex=brFuncLockPublicFuncIndex, brOneTouchDialIndex=brOneTouchDialIndex, brPageEPSONBottomMargin=brPageEPSONBottomMargin, brPrintPagesPaperTypeCounter=brPrintPagesPaperTypeCounter, brpsBanyanRouter2=brpsBanyanRouter2, brWebServicesSSLPortEnable=brWebServicesSSLPortEnable, brMultiIFConfigureEntry=brMultiIFConfigureEntry, brJobTerminationSupported=brJobTerminationSupported, brtray4size=brtray4size, brInfoAlertVersion=brInfoAlertVersion, brJobTerminationEnable=brJobTerminationEnable, broriginalTFTP=broriginalTFTP, brpsSMTPAddress=brpsSMTPAddress, brpsWLanCapabilityEncryptModeDescription=brpsWLanCapabilityEncryptModeDescription, brpsEmailRecvTestSupported=brpsEmailRecvTestSupported, brpsWLanCapabilityAuthModeEntry=brpsWLanCapabilityAuthModeEntry, brpsBanyanSPPConnectionInformation=brpsBanyanSPPConnectionInformation, brCommunicationErrorHistoryTable=brCommunicationErrorHistoryTable, brMultiIFServiceObsolete=brMultiIFServiceObsolete, brDirectPrintMultipulPage=brDirectPrintMultipulPage, brpsReset=brpsReset, broriginalapipa=broriginalapipa, brpsEmailSupported=brpsEmailSupported, brRegistrationXMagentaRight=brRegistrationXMagentaRight, brMultiIForiginalIPv6=brMultiIForiginalIPv6, brpsLATSupported=brpsLATSupported, brPrintPagesMediaPlaceType=brPrintPagesMediaPlaceType, brUnRegisterKeyInfo=brUnRegisterKeyInfo, version=version, brpsAppleTalkZone=brpsAppleTalkZone, brpsProtectPassword=brpsProtectPassword, brpsWLanAuthUserID=brpsWLanAuthUserID, brPrtAvoidMailboxFullIndex=brPrtAvoidMailboxFullIndex, brOwnFaxNumber=brOwnFaxNumber, brPJLInfoDXconfigIndex=brPJLInfoDXconfigIndex, broriginalldap=broriginalldap, brpsProtectModeEnable=brpsProtectModeEnable, brSNTPCIntervalMin=brSNTPCIntervalMin, mcfNetPcFaxRx=mcfNetPcFaxRx, brMultiIFServiceReplace=brMultiIFServiceReplace, brpsWLanOperatingAuthMode=brpsWLanOperatingAuthMode, brNetFaxShareEnable=brNetFaxShareEnable, brMultiIFNetBIOSIPMethod=brMultiIFNetBIOSIPMethod, brpsAdvancedTCPIPAccessAdministratorIPAddress=brpsAdvancedTCPIPAccessAdministratorIPAddress, brLdapTimeout=brLdapTimeout, paper=paper, net_peripheral=net_peripheral, brRegisterKeyInfo=brRegisterKeyInfo, brpsServiceBOT=brpsServiceBOT, pcl=pcl, sleep=sleep, brSpeedDialData=brSpeedDialData, brpsNetwareSNAPCount=brpsNetwareSNAPCount, brpsServerCertificateNum=brpsServerCertificateNum, brMultiIFSecondaryDNSIPAddress=brMultiIFSecondaryDNSIPAddress, printerjob=printerjob, brpsServiceTCPPort=brpsServiceTCPPort, brpsAppleTalkReadByte=brpsAppleTalkReadByte, scancount=scancount, brpsWLanAssociateTestSupported=brpsWLanAssociateTestSupported, brmDNSEnable=brmDNSEnable, brpsAppleTalkWriteByte=brpsAppleTalkWriteByte, brpsServiceProtocolNetBEUI=brpsServiceProtocolNetBEUI, brpsServiceProtocolLAT=brpsServiceProtocolLAT, brpsWLanCapabilityEncryptModeTable=brpsWLanCapabilityEncryptModeTable, brUPnPSupported=brUPnPSupported, brActivityReportSetting=brActivityReportSetting, banner=banner, brMultiIFDNSIPv6AddressEntry=brMultiIFDNSIPv6AddressEntry, brPJLInfoFirmwareUpdateconfigTable=brPJLInfoFirmwareUpdateconfigTable, brMultiIFServiceReceiveOnly=brMultiIFServiceReceiveOnly, brUserPassword=brUserPassword, brPrtAdvancedPanelBuzzer=brPrtAdvancedPanelBuzzer, net_MFP=net_MFP, orientation=orientation, brRegistrationXCyanLeft=brRegistrationXCyanLeft, brSNTPCPrimaryServerName=brSNTPCPrimaryServerName, brpsOEMString=brpsOEMString, brPJLInfoIntrayconfigEntry=brPJLInfoIntrayconfigEntry, brErrorHistoryIndex=brErrorHistoryIndex, brFaxReceiveMode=brFaxReceiveMode, brpsTCPIPAddress=brpsTCPIPAddress, brWlanSimpleWizardPassword=brWlanSimpleWizardPassword, brPagePSCAPTsetting=brPagePSCAPTsetting, brSNTPCInterval=brSNTPCInterval, brpsIPPEnable=brpsIPPEnable, brLdapServerAttrEMail=brLdapServerAttrEMail, brCapabilityResolutionTable=brCapabilityResolutionTable, brpsTCPIPMethodServer=brpsTCPIPMethodServer, brPanelLockOn=brPanelLockOn, brLdapKerberosServerPort=brLdapKerberosServerPort, brPJLInfoIntrayconfig=brPJLInfoIntrayconfig, brCIFSEnable=brCIFSEnable, brPrtAdvancedDestination=brPrtAdvancedDestination, broriginalHTTPS=broriginalHTTPS, brPageGLPen1Size=brPageGLPen1Size, brpsNetware8022Count=brpsNetware8022Count, brMultiIFTCPIPTable=brMultiIFTCPIPTable, brpsNetwareEnable=brpsNetwareEnable, brErrorHistoryCount=brErrorHistoryCount, brRegistrationYCyan=brRegistrationYCyan, brpsTCPIPAccessIndex=brpsTCPIPAccessIndex, brPageIBMLeftMargin=brPageIBMLeftMargin, brMultiIFConfigureIndex=brMultiIFConfigureIndex, brpsWLanWepKey=brpsWLanWepKey, brWlanSimpleWizardSupported=brWlanSimpleWizardSupported, brScanCountTable=brScanCountTable, broriginalprotocol=broriginalprotocol, brMultiIFDescription=brMultiIFDescription, brautocont=brautocont, brpapertype2=brpapertype2, interface=interface, brsimmtype3=brsimmtype3, wlTKIP=wlTKIP, brpsWLanDot11Supported=brpsWLanDot11Supported, brSpeedDialCount=brSpeedDialCount, brNotificationShowURLInfo=brNotificationShowURLInfo, brLdapServerInfoTable=brLdapServerInfoTable, brpsWLanOperatingCommMode=brpsWLanOperatingCommMode, brNotificationCount=brNotificationCount, key=key, brLdapServerAttrDetailEnable3=brLdapServerAttrDetailEnable3, brMultiIFInterfaceEnable=brMultiIFInterfaceEnable, brPagePCLLines=brPagePCLLines, brClockFuncTimeStyle=brClockFuncTimeStyle, brIPv6Priority=brIPv6Priority, brScanCountCounter=brScanCountCounter, wlWPA=wlWPA, brFuncLockUserFuncCount=brFuncLockUserFuncCount, brpsPOP3PortNumber=brpsPOP3PortNumber, brPrtAdvancedImageCompression=brPrtAdvancedImageCompression, mcgRemoteSetup=mcgRemoteSetup, brMultiIFTCPIPUpdate=brMultiIFTCPIPUpdate, brpageprotect=brpageprotect, brAdminCapability=brAdminCapability, brsimmtype2=brsimmtype2, brpsServiceString=brpsServiceString, brport=brport, brLCDMode4=brLCDMode4, brMultiIFIPv6StaticAddressCountTable=brMultiIFIPv6StaticAddressCountTable, status_prt_eng=status_prt_eng, wlLEAP=wlLEAP, mfpCapability=mfpCapability, brCommunicationErrorHistoryIndex=brCommunicationErrorHistoryIndex, brresolution=brresolution, panelinfo=panelinfo, brpsBanyanPrintServerStatus=brpsBanyanPrintServerStatus, brpsServiceName=brpsServiceName, brpsTmpPOP3PasswordModified=brpsTmpPOP3PasswordModified, wlSimpleWizard=wlSimpleWizard, mcsNetScanner=mcsNetScanner, brpsPortIndex=brpsPortIndex, brFuncLockUserFuncSupported=brFuncLockUserFuncSupported, brpsServiceNetwareServerMode=brpsServiceNetwareServerMode, brpsAvailableWLanTable=brpsAvailableWLanTable, prt_condition=prt_condition, brSecondaryDNSIPAddress=brSecondaryDNSIPAddress, brRegistrationXMagentaLeft=brRegistrationXMagentaLeft, broriginalRawPort=broriginalRawPort, brEmailReportsSendReportatPowerOn=brEmailReportsSendReportatPowerOn, brInfoJamCount=brInfoJamCount, brClockFuncZoneSet=brClockFuncZoneSet, brFaxSupported=brFaxSupported, brCarbonCopyTable=brCarbonCopyTable, brpsSmtpAUTHTimeout=brpsSmtpAUTHTimeout)
mibBuilder.exportSymbols("BROTHER-MIB", margin_i=margin_i, brpsChangePOP3PortSupported=brpsChangePOP3PortSupported, wlAOSS=wlAOSS, broriginalLAA=broriginalLAA, brpsPOPbeforeSMTPWait=brpsPOPbeforeSMTPWait, brpsTCPIPAccessNodeAddress=brpsTCPIPAccessNodeAddress, fax_setup=fax_setup, brpsPortStatusString=brpsPortStatusString, brLCDContrast=brLCDContrast, brMultiIFServiceTable=brMultiIFServiceTable, brNotificationEntry=brNotificationEntry, secadmin=secadmin, brFuncLockUserFuncIndex=brFuncLockUserFuncIndex, brpsBanyanEnable=brpsBanyanEnable, brPJLInfoIntrayconfigTable=brPJLInfoIntrayconfigTable, brpsPOP3TotalConnectionLost=brpsPOP3TotalConnectionLost, brpsPortProtocol=brpsPortProtocol, brpsAdvancedTCPIPAccessSupported=brpsAdvancedTCPIPAccessSupported, brFuncLockUserEntry=brFuncLockUserEntry, brPrintPagesMediaPlaceEntry=brPrintPagesMediaPlaceEntry, brpsServiceEOT=brpsServiceEOT, brpsTCPIPUpdate=brpsTCPIPUpdate, brSNMPTrapTable=brSNMPTrapTable, brLdapServerInfoIndex=brLdapServerInfoIndex, brFirmwareUpdateKeywordCount=brFirmwareUpdateKeywordCount, brpsServiceStringInfoTable=brpsServiceStringInfoTable, brMultiIFServiceBOT=brMultiIFServiceBOT, brpsWLanOperatingEncryptMode=brpsWLanOperatingEncryptMode, brSmallPaperSize2=brSmallPaperSize2, brOneTouchDialData=brOneTouchDialData, brpsTCPIPLPRRetryEnable=brpsTCPIPLPRRetryEnable, brpsPortStatus=brpsPortStatus, brMultiIFServiceNetwareRemotePrinterNum=brMultiIFServiceNetwareRemotePrinterNum, brother=brother)
