...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/brother/BROTHER-MIB
...
mibBuilder.exportSymbols("BROTHER-MIB", brpsSerialNumber=brpsSerialNumber, brpageprotect=brpageprotect, brpsServiceNetwareRemotePrinterNum=brpsServiceNetwareRemotePrinterNum, brWlanSimpleWizardPassword=brWlanSimpleWizardPassword, brNotificationRuleTable=brNotificationRuleTable, brpsServiceNDSContext=brpsServiceNDSContext, brpsSMTPTotalRecvFromFailure=brpsSMTPTotalRecvFromFailure, brpsEmailSendTestMail=brpsEmailSendTestMail, broriginalSNTP=broriginalSNTP, brpersonality=brpersonality, brPrtGeneralColor=brPrtGeneralColor, printersetup=printersetup, brToner4Low=brToner4Low, brpsPortName=brpsPortName, brpsSMTPAUTHPassword=brpsSMTPAUTHPassword, brMultiIFServiceBOT=brMultiIFServiceBOT, brCarbonCopyIndex=brCarbonCopyIndex, brpsProtectPassword=brpsProtectPassword, brpsWLanAuthEAP=brpsWLanAuthEAP, brPagePCLAutoLF=brPagePCLAutoLF, brpsSMTPTotalSendToFailure=brpsSMTPTotalSendToFailure, brpsTCPIPGateway=brpsTCPIPGateway, brpsWLanTKIPChangeInterval=brpsWLanTKIPChangeInterval, brProxyServerInfoIndex=brProxyServerInfoIndex, brmDNSPrinterName=brmDNSPrinterName, brCIFSSupported=brCIFSSupported, brservice=brservice, brPrintPagesFuncIndex=brPrintPagesFuncIndex, brAPIPAEnable=brAPIPAEnable, wlSimpleWizard=wlSimpleWizard, brpsWLanOperatingCommMode=brpsWLanOperatingCommMode, brInfoHDDSlot1=brInfoHDDSlot1, brpsPortType=brpsPortType, brSupportedInfo=brSupportedInfo, brpsPOPbeforeSMTPWait=brpsPOPbeforeSMTPWait, brPrtAdvancedErrorBuzzer=brPrtAdvancedErrorBuzzer, jobend=jobend, scanner_setup=scanner_setup, brCapabilityPaperEntry=brCapabilityPaperEntry, brsimmtype1=brsimmtype1, brPrintPagesFuncEntry=brPrintPagesFuncEntry, brMultiIFInterfaceEnableImmediate=brMultiIFInterfaceEnableImmediate, brMultiIFServiceName=brMultiIFServiceName, brFuncLockPublicFuncMember=brFuncLockPublicFuncMember, brDirectPrintPaperSize=brDirectPrintPaperSize, brDialDataAllClear=brDialDataAllClear, brpsBanyanHopCount=brpsBanyanHopCount, pictbridge=pictbridge, brMultiIFNodeName=brMultiIFNodeName, brpsServiceProtocolNetware=brpsServiceProtocolNetware, brFuncLockAutoCountResetTime=brFuncLockAutoCountResetTime, brpsNetwareSNAPNetInfo=brpsNetwareSNAPNetInfo, brMultiIFControlTable=brMultiIFControlTable, brMultiIFConfigureTable=brMultiIFConfigureTable, brpsWLanAOSSIsRunnning=brpsWLanAOSSIsRunnning, brMultiIFServiceStringInfoEntry=brMultiIFServiceStringInfoEntry, brFuncLockAutoCountResetFrequency=brFuncLockAutoCountResetFrequency, brFuncLockPcLoginNameAuthIndex=brFuncLockPcLoginNameAuthIndex, prt_density=prt_density, brpsTmpPOP3Password=brpsTmpPOP3Password, brMultiIFIPv6UseMethod=brMultiIFIPv6UseMethod, npTcp=npTcp, brPrtAdvancedImageCompression=brPrtAdvancedImageCompression, brPanelLockOn=brPanelLockOn, brpsAvailableWLanPowerLevel=brpsAvailableWLanPowerLevel, brInfoAlertVersion=brInfoAlertVersion, brPageIBMLines=brPageIBMLines, brnetConfigOpt=brnetConfigOpt, tonerlow=tonerlow, brPrtAdvancedLowerLCD=brPrtAdvancedLowerLCD, brpsVerifyPhysAddress=brpsVerifyPhysAddress, brPJLInfoOptionsIndex=brPJLInfoOptionsIndex, brPrintPagesEntry=brPrintPagesEntry, brorg=brorg, brSNMPV3ContextName=brSNMPV3ContextName, brpsWLanCapabilityEncryptModeIndex=brpsWLanCapabilityEncryptModeIndex, paper=paper, brPrintPagesFuncTable=brPrintPagesFuncTable, brPageIBMTopMargin=brPageIBMTopMargin, brInfoStatus=brInfoStatus, brPushStatusSupported=brPushStatusSupported, brpsTCPIPAddress=brpsTCPIPAddress, brFuncLockUserPrintPageMax=brFuncLockUserPrintPageMax, brpsEmailTestDestinationAddress=brpsEmailTestDestinationAddress, brMultiIFServiceCount=brMultiIFServiceCount, brpsDLCLLCPortStatus=brpsDLCLLCPortStatus, brFuncLockPublicFuncIndex=brFuncLockPublicFuncIndex, brpsWLanNetworkKey=brpsWLanNetworkKey, brMultiIFServiceNetwareRemotePrinterNum=brMultiIFServiceNetwareRemotePrinterNum, bripp=bripp, brFaxSupported=brFaxSupported, brpsLATTimeout=brpsLATTimeout, brPrtAvoidMailboxFullTable=brPrtAvoidMailboxFullTable, funa=funa, cassette4=cassette4, brpsNetBEUIDomain=brpsNetBEUIDomain, brpsAppleTalkReadError=brpsAppleTalkReadError, brLdapServerPasswordSet=brLdapServerPasswordSet, brMultiIFNodeType=brMultiIFNodeType, brFuncLockUserFuncSupported=brFuncLockUserFuncSupported, brpsAdvancedTCPIPAccessEnable=brpsAdvancedTCPIPAccessEnable, brPrtAdvancedAutoTimeout=brPrtAdvancedAutoTimeout, brpsSNMPGetCommunity=brpsSNMPGetCommunity, wlInfo=wlInfo, brpsNetBEUIEnable=brpsNetBEUIEnable, brPrtAdvancedLCDDensity=brPrtAdvancedLCDDensity, brpsPassword=brpsPassword, broriginalldap=broriginalldap, brDirectPrintMediaType=brDirectPrintMediaType, brEWSSSLPortEnable=brEWSSSLPortEnable, brTrayPriorityCount=brTrayPriorityCount, brMultiIFNetBIOSTable=brMultiIFNetBIOSTable, brFuncLockPublicPrintPageCountMonoLast=brFuncLockPublicPrintPageCountMonoLast, brPrintPagesPaperSize=brPrintPagesPaperSize, brMediaFixTray2=brMediaFixTray2, pcl=pcl, brMultiIFServiceInfoTable=brMultiIFServiceInfoTable, brFuncLockPublicPrintPageMax=brFuncLockPublicPrintPageMax, brieee1284id=brieee1284id, adminCapa=adminCapa, brCapabilityOrientationCount=brCapabilityOrientationCount, brpsTCPIPMethod=brpsTCPIPMethod, gl=gl, brmDNSEnable=brmDNSEnable, brMultiIFWebServicesTable=brMultiIFWebServicesTable, brUserPasswordVerify=brUserPasswordVerify, brPrtAdvancedLanguage=brPrtAdvancedLanguage, brIPv6Priority=brIPv6Priority, brpowerstime=brpowerstime, brPageGLPen1GrayLevel=brPageGLPen1GrayLevel, errorHistory=errorHistory, brpsMIBMinor=brpsMIBMinor, brpsWLanCapabilityEncryptModeCount=brpsWLanCapabilityEncryptModeCount, brpsWLanCtsMode=brpsWLanCtsMode, brSNMPTrapIndex=brSNMPTrapIndex, brpsNetwareAdvFreq=brpsNetwareAdvFreq, brMultiIFServiceProtocolNetware=brMultiIFServiceProtocolNetware, brPagePCLTopMargin=brPagePCLTopMargin, brPagePCLRightMargin=brPagePCLRightMargin, brMultiIFIPv6StaticAddressTable=brMultiIFIPv6StaticAddressTable, controlpanel=controlpanel, brFontPitch=brFontPitch, brPrtAdvancedAutoFormFeed=brPrtAdvancedAutoFormFeed, brpsBanyanIPCConnectionInformation=brpsBanyanIPCConnectionInformation, brpsChangePOP3PortSupported=brpsChangePOP3PortSupported, brpsServiceAppleTalkType=brpsServiceAppleTalkType, brpsWLanOperatingEncryptMode=brpsWLanOperatingEncryptMode, brPJLInfoDXconfigEntry=brPJLInfoDXconfigEntry, brFuncLockPcLoginNameEntry=brFuncLockPcLoginNameEntry, brFirmwareUpdateKeywordEntry=brFirmwareUpdateKeywordEntry, brPJLInfoOptions=brPJLInfoOptions, brFuncLockAdminPassword=brFuncLockAdminPassword, sleep=sleep, brSecurityGeneralSetup=brSecurityGeneralSetup, brLAASupported=brLAASupported, brPageGLPen4GrayLevel=brPageGLPen4GrayLevel, brpsWLanCapabilityEncryptModeSupported=brpsWLanCapabilityEncryptModeSupported, brFirmwareUpdateKeywordIndex=brFirmwareUpdateKeywordIndex, brpsWLanCapabilityEncryptModeEntry=brpsWLanCapabilityEncryptModeEntry, brLPDSupported=brLPDSupported, brMultiIFLAASupported=brMultiIFLAASupported, brPictBridgeDateTime=brPictBridgeDateTime, simmkind0=simmkind0, brInfoEstimatedPagesRemaining=brInfoEstimatedPagesRemaining, brFuncLockUserFuncIndex=brFuncLockUserFuncIndex, brLCDMode5=brLCDMode5, brPagePCLLeftMargin=brPagePCLLeftMargin, brPrtGeneralPowerSave=brPrtGeneralPowerSave, brpsBanyanPassword=brpsBanyanPassword, brFuncLockPublicFuncSupported=brFuncLockPublicFuncSupported, brMultiIFServiceReceiveOnly=brMultiIFServiceReceiveOnly, resolution=resolution, brpsAvailableWLanCount=brpsAvailableWLanCount, brCapabilityMediatypeEntry=brCapabilityMediatypeEntry, brpsNetwareEnable=brpsNetwareEnable, brpsWLanAuthUserID=brpsWLanAuthUserID, brInfoType=brInfoType, brpsServiceVines=brpsServiceVines, brpsTCPIPMethodServer=brpsTCPIPMethodServer, brfirmware=brfirmware, mcfNetFaxShare=mcfNetFaxShare, brPagePCLLines=brPagePCLLines, brPrtMailboxOutbin=brPrtMailboxOutbin, brSpeedDialIndex=brSpeedDialIndex, mfpCapability=mfpCapability, advanced=advanced, brpsWLanWepKeyTable=brpsWLanWepKeyTable, userSetting=userSetting, brCapabilityOrientationTable=brCapabilityOrientationTable, broriginalapipa=broriginalapipa, brPanelResetFactory=brPanelResetFactory, brProxyEnable=brProxyEnable, brDNSSupported=brDNSSupported, brPrintPagesPaperTypeType=brPrintPagesPaperTypeType, brInfoReplaceTime=brInfoReplaceTime, brMultiIFIPv6StaticAddressCountEntry=brMultiIFIPv6StaticAddressCountEntry, brLdapKerberosServerPort=brLdapKerberosServerPort, brToner1Low=brToner1Low, brpsTmpPOP3PasswordModified=brpsTmpPOP3PasswordModified, brProxyServerName=brProxyServerName, brLdapServerAttrDetailEnable4=brLdapServerAttrDetailEnable4, brCapabilityResolutionCount=brCapabilityResolutionCount, brEWSSupported=brEWSSupported, brpsServiceIndex=brpsServiceIndex, adminsetting=adminsetting, brSNMPTrapEntry=brSNMPTrapEntry, brCarbonCopyTable=brCarbonCopyTable, brUserPassword=brUserPassword, brpsServiceFilterCount=brpsServiceFilterCount, brPJLInfoOptionsEntry=brPJLInfoOptionsEntry, brMultiIFDNSIPv6AddressTable=brMultiIFDNSIPv6AddressTable, mcScanner=mcScanner, brSmallPaperSize3=brSmallPaperSize3, brPJLInfoStorageconfigIndex=brPJLInfoStorageconfigIndex, brpsServerDescription=brpsServerDescription, brpsWLanDot11Supported=brpsWLanDot11Supported, brLdapServerPassword=brLdapServerPassword, brSNTPCSecondaryServerPort=brSNTPCSecondaryServerPort, brMultiIForiginalWebServices=brMultiIForiginalWebServices, brMultiIFControlEntry=brMultiIFControlEntry, general=general, brpsWLanAuthUserPass=brpsWLanAuthUserPass, brMultiIFNetBIOSIPMethod=brMultiIFNetBIOSIPMethod, destination_subsystem4=destination_subsystem4, brRegistrationYCyan=brRegistrationYCyan, brNotificationRuleIndex=brNotificationRuleIndex, brMultiIFTCPIPBootTries=brMultiIFTCPIPBootTries, brMultiIFLAAMacAddress=brMultiIFLAAMacAddress, brpsServiceCount=brpsServiceCount, brpsEmailSendTestSupported=brpsEmailSendTestSupported, firmwareupdatekeyword=firmwareupdatekeyword, brpsBanyanIPNetworkID1=brpsBanyanIPNetworkID1, brMultiIFSupported=brMultiIFSupported, brpsSNMPJetAdmin=brpsSNMPJetAdmin, brLdapServerAttrEMail=brLdapServerAttrEMail, destination_subsystem2=destination_subsystem2, broriginalJobTermination=broriginalJobTermination, brPictBridgePrintQuality=brPictBridgePrintQuality, brpsPortProtocol=brpsPortProtocol, brpsWLanWepKeyIndex=brpsWLanWepKeyIndex, brPageIBMBottomMargin=brPageIBMBottomMargin, brpsNetwareServicingQueueName=brpsNetwareServicingQueueName, brNetRegisterPcFaxInfo=brNetRegisterPcFaxInfo, netPMLmgmt=netPMLmgmt, brPriError=brPriError, brtimeout=brtimeout, brMultiIFTCPIPTable=brMultiIFTCPIPTable, brColorCalibrationReset=brColorCalibrationReset, brRegistrationXYellowLeft=brRegistrationXYellowLeft, brLdapServerAuth=brLdapServerAuth, brCapabilityMediatypeIndex=brCapabilityMediatypeIndex, brEmailReportsSupported=brEmailReportsSupported, brFuncLockUserPrintPageCountColorLast=brFuncLockUserPrintPageCountColorLast, brCapabilityResolutionEntry=brCapabilityResolutionEntry)
mibBuilder.exportSymbols("BROTHER-MIB", brLdapServerInfoTable=brLdapServerInfoTable, brCapabilityCopiesMax=brCapabilityCopiesMax, brpsWLanWPSResult=brpsWLanWPSResult, brLCDMode1=brLCDMode1, brMultiIFServiceIndex=brMultiIFServiceIndex, wlLEAP=wlLEAP, brTFTPEnable=brTFTPEnable, colorcorrection=colorcorrection, pen2=pen2, brPrtCatchTray=brPrtCatchTray, brpsTCPIPEnable=brpsTCPIPEnable, brCapabilityOrientationEntry=brCapabilityOrientationEntry, brpsNetBEUISupported=brpsNetBEUISupported, brMultiIFdns=brMultiIFdns, brMultiIFServiceTCPPort=brMultiIFServiceTCPPort, brMultiIFTCPIPUseMethod=brMultiIFTCPIPUseMethod, brpsEmailEnable=brpsEmailEnable, brJamPlace=brJamPlace, brPrtAdvancedAutoOnline=brPrtAdvancedAutoOnline, brPanelKeyJobCancel=brPanelKeyJobCancel, brRegistrationYYellow=brRegistrationYYellow, brpsLATSupported=brpsLATSupported, brpsServiceEOT=brpsServiceEOT, margin_e=margin_e, brpsWLanEncryptMode=brpsWLanEncryptMode, wlWPS=wlWPS, brHTTPSSupported=brHTTPSSupported, brpsServiceString=brpsServiceString, brpsNetBIOSSecondaryWINSAddr=brpsNetBIOSSecondaryWINSAddr, brpsBanyanIPCSequenceError=brpsBanyanIPCSequenceError, brRegistrationXCyanRight=brRegistrationXCyanRight, brPJLInfoIntrayconfigIndex=brPJLInfoIntrayconfigIndex, brLLTDSupported=brLLTDSupported, brMultiIFServiceTCPQueued=brMultiIFServiceTCPQueued, brEWSEnable=brEWSEnable, brPageIBMAutoLF=brPageIBMAutoLF, brInfoModelNumber=brInfoModelNumber, brInfoCounter=brInfoCounter, brFuncLockPublicTable=brFuncLockPublicTable, brpsBanyanErrorLE=brpsBanyanErrorLE, brpsWLanDeviceType=brpsWLanDeviceType, brDirectPrintPrintQuality=brDirectPrintPrintQuality, brOneTouchDialIndex=brOneTouchDialIndex, brPJLInfoStorageconfig=brPJLInfoStorageconfig, brPrtMailboxProtectIndex=brPrtMailboxProtectIndex, brpsWLanOperatingAuthMode=brpsWLanOperatingAuthMode, printerinfomation=printerinfomation, brErrorHistoryIndex=brErrorHistoryIndex, brpsTCPIPAccessSubnetMask=brpsTCPIPAccessSubnetMask, brSNMPEnable=brSNMPEnable, brPictBridgeOrientation=brPictBridgeOrientation, brnetConfig=brnetConfig, brHTTPSEnable=brHTTPSEnable, brLCDMode4=brLCDMode4, brRegistrationPrintChart=brRegistrationPrintChart, brSNTPCEnable=brSNTPCEnable, dns=dns, brpsPortInfoEntry=brpsPortInfoEntry, brEmailReportsDate=brEmailReportsDate, brCapabilityResolutionIndex=brCapabilityResolutionIndex, brpsAvailableWLanAuthMode=brpsAvailableWLanAuthMode, brpsWLanCapabilityAuthModeCount=brpsWLanCapabilityAuthModeCount, brpsWLanCapabilityAuthEAPSupported=brpsWLanCapabilityAuthEAPSupported, brntsend=brntsend, brMultiIFIPv6AddressCount=brMultiIFIPv6AddressCount, brSNMPV3AuthPassword=brSNMPV3AuthPassword, npSet=npSet, brSNTPCSecondaryServerName=brSNTPCSecondaryServerName, brSNMPCommMode=brSNMPCommMode, brDeviceNegotiationChangePassword=brDeviceNegotiationChangePassword, brLdapServerInfoIndex=brLdapServerInfoIndex, brMultiIFAPIPASupported=brMultiIFAPIPASupported, brCapabilityCopiesMin=brCapabilityCopiesMin, brMultiIFHardwareType=brMultiIFHardwareType, brpsWLanCapabilityEncryptModeTable=brpsWLanCapabilityEncryptModeTable, brpsNetwareServerEntry=brpsNetwareServerEntry, brFuncLockUserPrintPageEntry=brFuncLockUserPrintPageEntry, brMultiIFIPv6StaticAddressPrefixLength=brMultiIFIPv6StaticAddressPrefixLength, brPrtAdvancedInputBuffer=brPrtAdvancedInputBuffer, brpsPortInfoString=brpsPortInfoString, brPagePCLBottomMargin=brPagePCLBottomMargin, brpaper=brpaper, brPJLInfoFirmwareUpdateconfigEntry=brPJLInfoFirmwareUpdateconfigEntry, brPrintPagesFuncCounter=brPrintPagesFuncCounter, brpsTCPIPBootTries=brpsTCPIPBootTries, brpsDLCPrintStatus=brpsDLCPrintStatus, brMultiIFConfigureIndex=brMultiIFConfigureIndex, brpsWLanWepKeyDefaultIndex=brpsWLanWepKeyDefaultIndex, brStatusSleep=brStatusSleep, wlAdvanced=wlAdvanced, brpsPortStatusString=brpsPortStatusString, net_printer=net_printer, brpsChangeSMTPPortSupported=brpsChangeSMTPPortSupported, brPJLInfoOuttrayconfigEntry=brPJLInfoOuttrayconfigEntry, brpsWLanWepKey=brpsWLanWepKey, brpsDLCLLCRecvPacket=brpsDLCLLCRecvPacket, broriginalWebServices=broriginalWebServices, brPrtAdvancedFFSuppress=brPrtAdvancedFFSuppress, trayPriority=trayPriority, brpsPOP3PortNumber=brpsPOP3PortNumber, brServiceMode=brServiceMode, brpsServiceProtocolLAT=brpsServiceProtocolLAT, brpsPortAttribute=brpsPortAttribute, brMultiIFServiceNetwareServerMode=brMultiIFServiceNetwareServerMode, brMultiIForiginalapipa=brMultiIForiginalapipa, brpsTCPIPBanner=brpsTCPIPBanner, brpsSNMPSetCommunity2=brpsSNMPSetCommunity2, brFuncLockPublicPrintPageCountColor=brFuncLockPublicPrintPageCountColor, brpsAvailableWLanEncryptMode=brpsAvailableWLanEncryptMode, brPageIBMRightMargin=brPageIBMRightMargin, brPrtAdvancedMessageScroll=brPrtAdvancedMessageScroll, brpsNetwareServicingServerName=brpsNetwareServicingServerName, brInfoLowerMIBVer=brInfoLowerMIBVer, brInfoDeviceSubRomVersion=brInfoDeviceSubRomVersion, brpsWLanLengthThreshold=brpsWLanLengthThreshold, brpsPasswordVerify=brpsPasswordVerify, brMultiIFLAATable=brMultiIFLAATable, brpsWLanRSSLevel=brpsWLanRSSLevel, brNetSKeyReceiverAddress=brNetSKeyReceiverAddress, brpsBanyanLoginName=brpsBanyanLoginName, brToner2Low=brToner2Low, brpsTCPIPRARPNoGateway=brpsTCPIPRARPNoGateway, brpsDLCSupported=brpsDLCSupported, brMultiIFServiceVines=brMultiIFServiceVines, brWebServicesSupported=brWebServicesSupported, brpsPOP3Address=brpsPOP3Address, brPanelKeyContinue=brPanelKeyContinue, brpsPOP3Name=brpsPOP3Name, brFuncLockPcLoginNameTable=brFuncLockPcLoginNameTable, brpsWLanCapabilityAuthModeTable=brpsWLanCapabilityAuthModeTable, brPrtMailbox=brPrtMailbox, brpsSNMPSetCommunity1=brpsSNMPSetCommunity1, brMultiIFServiceProtocolNetBEUI=brMultiIFServiceProtocolNetBEUI, brpsServiceTCPQueued=brpsServiceTCPQueued, brpsWLanTransmitPowerSetting=brpsWLanTransmitPowerSetting, brPagePCLAutoWrap=brPagePCLAutoWrap, brInfoReplaceCount=brInfoReplaceCount, brSNMPSupported=brSNMPSupported, brInfoHDDSlot2=brInfoHDDSlot2, brPJLInfoOuttrayconfigIndex=brPJLInfoOuttrayconfigIndex, brMultiIFTCPIPRARPNoGateway=brMultiIFTCPIPRARPNoGateway, brSecurityGeneralStatus=brSecurityGeneralStatus, brRegistrationXCyanLeft=brRegistrationXCyanLeft, brpsAvailableWLanIndex=brpsAvailableWLanIndex, brpsSMTPTotalConnectFailure=brpsSMTPTotalConnectFailure, brtray2size=brtray2size, brDNSIPSetup=brDNSIPSetup, brPageEPSONLines=brPageEPSONLines, brInfoHDDSize=brInfoHDDSize, brCarbonCopyEntry=brCarbonCopyEntry, brMultiIFConfigureEntry=brMultiIFConfigureEntry, brMultiIFServiceProtocolLAT=brMultiIFServiceProtocolLAT, destination_subsystem1=destination_subsystem1, brtcpip=brtcpip, brFuncLockUserPrintPageTable=brFuncLockUserPrintPageTable, version=version, brSNMPV3UserName=brSNMPV3UserName, scancount=scancount, broriginalprotocol=broriginalprotocol, pjlinfo=pjlinfo, device=device, brPageGLPen6GrayLevel=brPageGLPen6GrayLevel, pen1=pen1, brpsNetwareServerIndex=brpsNetwareServerIndex, fax_setup=fax_setup, brSecError=brSecError, brMultiIFIPv6StaticAddressIndex=brMultiIFIPv6StaticAddressIndex, brSpeedDialTable=brSpeedDialTable, brTrayPriorityMember=brTrayPriorityMember, brpsServiceProtocolDLC=brpsServiceProtocolDLC, brpsBanyanIPPacket=brpsBanyanIPPacket, brFuncLockUserPassword=brFuncLockUserPassword, brret=brret, brSpeedDialData=brSpeedDialData, brToner3Low=brToner3Low, brpsPit3WLanTestStatus=brpsPit3WLanTestStatus, brFaxHeaderInfo=brFaxHeaderInfo, brLdapServerName=brLdapServerName, brSNTPCIntervalMin=brSNTPCIntervalMin, eNet=eNet, brLPDEnable=brLPDEnable, npSys=npSys, brpsPortHTTPExtensions=brpsPortHTTPExtensions, brpsWLanAssociateTestResult=brpsWLanAssociateTestResult, brErrorHistoryTable=brErrorHistoryTable, brLdapServerAttrNameTable=brLdapServerAttrNameTable, brPrtMailboxProtectGroup=brPrtMailboxProtectGroup, brpsSMTPAUTHUsername=brpsSMTPAUTHUsername, brSNTPCSyncMethod=brSNTPCSyncMethod, brIPv6Enable=brIPv6Enable, brpsPOP3Supported=brpsPOP3Supported, brScanCountIndexCount=brScanCountIndexCount, brMultiIFTCPIPGateway=brMultiIFTCPIPGateway, brpsWLanAuthMode=brpsWLanAuthMode, brCapabilityMediatypeName=brCapabilityMediatypeName, brPictBridgeFileName=brPictBridgeFileName, brpsWLanOperatingChannel=brpsWLanOperatingChannel, brpsTCPIPMaxWindow=brpsTCPIPMaxWindow, brENetModeSupported=brENetModeSupported, brNotificationMainRule=brNotificationMainRule, brMultiIFServiceStringLimit=brMultiIFServiceStringLimit, brInfoDeviceRomVersion=brInfoDeviceRomVersion, brCapabilityOrientationIndex=brCapabilityOrientationIndex, brpsTmpSMTPAUTHPassword=brpsTmpSMTPAUTHPassword, brmDNSSupported=brmDNSSupported, brpsBootRevision=brpsBootRevision, brpsAdvancedTCPIPAccessSetting=brpsAdvancedTCPIPAccessSetting, brpsNetwareServerTable=brpsNetwareServerTable, broriginalTFTP=broriginalTFTP, brpsPortDescriptionString=brpsPortDescriptionString, brpsServiceObsolete=brpsServiceObsolete, brpsTmpSMTPPortNumber=brpsTmpSMTPPortNumber, brPanelLockPasswd=brPanelLockPasswd, brFontSwitchOff=brFontSwitchOff, brpsTCPIPFastTimeoutEnable=brpsTCPIPFastTimeoutEnable, brProxyServerType=brProxyServerType, brpsPOP3TotalUserFailure=brpsPOP3TotalUserFailure, brFuncLockUserPrintPageCountMono=brFuncLockUserPrintPageCountMono, auto_i=auto_i, brMultiIFWebServicesName=brMultiIFWebServicesName, brpsWLanCapabilityAuthModeType=brpsWLanCapabilityAuthModeType, brpsServiceStringInfoTable=brpsServiceStringInfoTable, brInfoNetVerUpStatus=brInfoNetVerUpStatus, brSmallPaperSize1=brSmallPaperSize1, brMediaFixTray1=brMediaFixTray1, brpsServiceMatch=brpsServiceMatch, brMultiIFIPv6StaticAddress=brMultiIFIPv6StaticAddress, brProxySupported=brProxySupported, brFindTime=brFindTime, brpsWLanMode=brpsWLanMode, brMultiIFServiceProtocolAppleTalk=brMultiIFServiceProtocolAppleTalk, brKerberosSupported=brKerberosSupported, finisher=finisher, brconfig=brconfig, brpsSMTPAddress=brpsSMTPAddress, brPJLInfoStorageconfigEntry=brPJLInfoStorageconfigEntry, brpsWLanCapabilityEncryptModeType=brpsWLanCapabilityEncryptModeType, brFontSetting=brFontSetting, broriginalLPD=broriginalLPD, broriginalftp=broriginalftp, brNotificationTable=brNotificationTable, brpsAvailableWLanTable=brpsAvailableWLanTable, brpsNetwareServicingQueueCount=brpsNetwareServicingQueueCount, brActivityReportSetting=brActivityReportSetting, brpsWLanTransmitLevel=brpsWLanTransmitLevel, brLCDString5=brLCDString5, brpsSMTPEnhancedAuthSupported=brpsSMTPEnhancedAuthSupported, brpsAvailableWLanMode=brpsAvailableWLanMode, brNotificationEntry=brNotificationEntry, brpsBanyanRouter1=brpsBanyanRouter1, brpsEnetMode=brpsEnetMode, brCarbonCopyMacro=brCarbonCopyMacro, brRegisterKeyInfo=brRegisterKeyInfo, brpsNetware8022NetInfo=brpsNetware8022NetInfo)
mibBuilder.exportSymbols("BROTHER-MIB", brpsNetBIOSIPEnable=brpsNetBIOSIPEnable, brpsFirmwareAdvancedAddress=brpsFirmwareAdvancedAddress, brpsMainRevision=brpsMainRevision, brAutoRegistRegistrate=brAutoRegistRegistrate, brpsNetwarePassword=brpsNetwarePassword, brLPDType=brLPDType, brLdapKerberosServerName=brLdapKerberosServerName, simmkind2=simmkind2, brMultiIFNetBEUIDomain=brMultiIFNetBEUIDomain, brInfoPrinterUStatus=brInfoPrinterUStatus, brSNMPTrapTable=brSNMPTrapTable, brFuncLockPcLoginName=brFuncLockPcLoginName, onetouchDial=onetouchDial, brMultiIFServiceNetwareServerCount=brMultiIFServiceNetwareServerCount, brErrorHistoryCount=brErrorHistoryCount, brMultiIFDescription=brMultiIFDescription, brInfoMaintenance=brInfoMaintenance, brLdapServerUserDN=brLdapServerUserDN, brpsTCPIPAccessTable=brpsTCPIPAccessTable, brMultiIFIPv6StaticAddressEnable=brMultiIFIPv6StaticAddressEnable, broriginalmdns=broriginalmdns, brTBD1=brTBD1, brpsWLanOperatingName=brpsWLanOperatingName, brInfoCoverage=brInfoCoverage, brPrintPagesPaperTypeCounter=brPrintPagesPaperTypeCounter, brEmailReportsCount=brEmailReportsCount, brFuncLockSetting=brFuncLockSetting, brSecretReprint=brSecretReprint, brCapabilityPaperCount=brCapabilityPaperCount, brpsAPOPSupported=brpsAPOPSupported, brCommunicationErrorHistoryCount=brCommunicationErrorHistoryCount, wlAOSS=wlAOSS, brDirectPrintSetting=brDirectPrintSetting, brCarbonCopyMacroID=brCarbonCopyMacroID, brpsWLanChannel=brpsWLanChannel, printerstatus=printerstatus, brMultiIFPrimaryInterface=brMultiIFPrimaryInterface, brpsTCPIPAccessIndex=brpsTCPIPAccessIndex, brWebServicesRegularPortEnable=brWebServicesRegularPortEnable, brPJLInfoOuttrayconfig=brPJLInfoOuttrayconfig, brMultiIFTCPIPConnectTime=brMultiIFTCPIPConnectTime, secret=secret, brpsWLanAssociateResult=brpsWLanAssociateResult, brPfKitEntry=brPfKitEntry, brpsWLanCtsType=brpsWLanCtsType, wlGeneralInfo=wlGeneralInfo, brpsBanyanServerAddress1=brpsBanyanServerAddress1, brNotificationIndex=brNotificationIndex, brpsPOP3Password=brpsPOP3Password, brScanCountIndex=brScanCountIndex, brpsNetBIOSPrimaryWINSAddr=brpsNetBIOSPrimaryWINSAddr, brLCDString2=brLCDString2, carbonCopy=carbonCopy, brpsAppleTalkSupported=brpsAppleTalkSupported, brScanCountType=brScanCountType, brTrayPriorityEntry=brTrayPriorityEntry, brMultiIFPrimaryDNSIPAddress=brMultiIFPrimaryDNSIPAddress, brEmailReportsIndex=brEmailReportsIndex, wlGeneralStatus=wlGeneralStatus, brpsServiceStringCount=brpsServiceStringCount, brMultiIFSecondaryDNSIPv6Address=brMultiIFSecondaryDNSIPv6Address, brFirmwareUpdateKeyword=brFirmwareUpdateKeyword, brFuncLockUserPrintPageCountColor=brFuncLockUserPrintPageCountColor, brFontPointSize=brFontPointSize, brpsAvailableWLanName=brpsAvailableWLanName, scanToInfo=scanToInfo, brpsServiceStringInfoEntry=brpsServiceStringInfoEntry, brpsServiceReceiveOnly=brpsServiceReceiveOnly, broriginalKerberos=broriginalKerberos, system=system, brpsMIBVersion=brpsMIBVersion, brProxyServerInfoTable=brProxyServerInfoTable, brPrintPagesMediaPlaceIndex=brPrintPagesMediaPlaceIndex, npCtl=npCtl, brPageEPSONRightMargin=brPageEPSONRightMargin, brJobTerminationEnable=brJobTerminationEnable, secadmin=secadmin, brappletalk=brappletalk, brLLTDEnable=brLLTDEnable, epson=epson, brpsWLanName=brpsWLanName, brJobTerminationSupported=brJobTerminationSupported, brRawPortEnable=brRawPortEnable, brLockMode=brLockMode, printerjob=printerjob, brPagePSKeepPCLFonts=brPagePSKeepPCLFonts, brMediaFixTray3=brMediaFixTray3, brpsTmpPOP3PortNumber=brpsTmpPOP3PortNumber, brmpsize=brmpsize, brpsWLanCapabilityAuthEAPSupportEncryption=brpsWLanCapabilityAuthEAPSupportEncryption, brpsSMTPTotalConnect=brpsSMTPTotalConnect, brpsTmpPOP3Name=brpsTmpPOP3Name, brdensity=brdensity, broriginalSNMP=broriginalSNMP, brLdapSetDefault=brLdapSetDefault, brSNMPV3KeyType=brSNMPV3KeyType, destination_subsystem3=destination_subsystem3, brNetScannerEnable=brNetScannerEnable, brFuncLockPublicFuncEnable=brFuncLockPublicFuncEnable, brProxyServerInfoEntry=brProxyServerInfoEntry, brFuncLockPublicPrintLimitEnable=brFuncLockPublicPrintLimitEnable, brpsBanyanSPPSequenceError=brpsBanyanSPPSequenceError, brFuncLockPcLoginNameAuthCount=brFuncLockPcLoginNameAuthCount, brpsEmailTestResult=brpsEmailTestResult, brFuncLockUserPrintPageIndex=brFuncLockUserPrintPageIndex, brPJLInfoOuttrayconfigTable=brPJLInfoOuttrayconfigTable, brSpeedDialEntry=brSpeedDialEntry, brFontName=brFontName, brLdapSupported=brLdapSupported, brNetSKeySupported=brNetSKeySupported, brPrtMailboxProtectTable=brPrtMailboxProtectTable, broriginalLLMNR=broriginalLLMNR, brpsServiceName=brpsServiceName, brpsMIBMajor=brpsMIBMajor, brFuncLockUserFuncMember=brFuncLockUserFuncMember, brEmailReportsNoRTCFrequency=brEmailReportsNoRTCFrequency, brMultiIFIPv6StaticAddressCountTable=brMultiIFIPv6StaticAddressCountTable, brClockFuncTimeZone=brClockFuncTimeZone, brpsNodeName=brpsNodeName, brpsServiceInfoTable=brpsServiceInfoTable, brErrorHistoryEntry=brErrorHistoryEntry, brLCDString4=brLCDString4, brLdapServerAttrDetail2=brLdapServerAttrDetail2, traysize=traysize, brFindPort=brFindPort, brLdapServerPort=brLdapServerPort, broriginalHTTPS=broriginalHTTPS, brsimmtype2=brsimmtype2, brCapabilityMediatypeTable=brCapabilityMediatypeTable, brpsTmpPrintersEmailaddress=brpsTmpPrintersEmailaddress, brpsEmailSendRecvTestCall=brpsEmailSendRecvTestCall, brpsFirmwareHost=brpsFirmwareHost, brPfKitTable=brPfKitTable, brPOP3ServerName=brPOP3ServerName, brpsNetwareSupported=brpsNetwareSupported, brLCDContrast=brLCDContrast, brFuncLockPublicPrintPageCountMono=brFuncLockPublicPrintPageCountMono, brAdvancedDNSSupported=brAdvancedDNSSupported, brPanelKeyMode=brPanelKeyMode, brLdapServerAttrNameCount=brLdapServerAttrNameCount, brPageGLPen5GrayLevel=brPageGLPen5GrayLevel, brPageEPSONTopMargin=brPageEPSONTopMargin, brpsReset=brpsReset, brMultiIFIPv6Address=brMultiIFIPv6Address, brBasicSettingConfigured=brBasicSettingConfigured, brPJLInfoIntrayconfig=brPJLInfoIntrayconfig, brpsTCPIPAccessEntry=brpsTCPIPAccessEntry, verify=verify, brPagePSPrintPSError=brPagePSPrintPSError, brPrtFinisher=brPrtFinisher, brpsNetBIOSIPSupported=brpsNetBIOSIPSupported, brLdapServerCount=brLdapServerCount, brpsWLanCapabilityAuthModeSupported=brpsWLanCapabilityAuthModeSupported, brpsAvailableWLanEntry=brpsAvailableWLanEntry, prt_setup=prt_setup, brPrtAdvancedMPTrayFeed=brPrtAdvancedMPTrayFeed, brPageEPSONBottomMargin=brPageEPSONBottomMargin, brPrtAdvancedSleepIndication=brPrtAdvancedSleepIndication, brInfoUpperMIBVer=brInfoUpperMIBVer, brbanyan=brbanyan, brOneTouchDialTable=brOneTouchDialTable, wlGeneral=wlGeneral, brDirectPrintCollate=brDirectPrintCollate, brpsFlashROMSize=brpsFlashROMSize, mcFax=mcFax, catch_tray=catch_tray, brPhoneNumberLastFax=brPhoneNumberLastFax, brSmallPaperSize4=brSmallPaperSize4, ps=ps, brFuncLockUserCount=brFuncLockUserCount, brpsServiceProtocolAppleTalk=brpsServiceProtocolAppleTalk, brFuncLockPcLoginNameAuthID=brFuncLockPcLoginNameAuthID, brpapertypeMP=brpapertypeMP, pen4=pen4, brpsSMTPServerAuthMethod=brpsSMTPServerAuthMethod, brNotificationAddress=brNotificationAddress, autoff=autoff, brLdapServerAttrFAXNumber=brLdapServerAttrFAXNumber, brSMTPServerName=brSMTPServerName, brPrtAdvancedTonerLowPrint=brPrtAdvancedTonerLowPrint, brPanelKeySecure=brPanelKeySecure, npMultiIFSet=npMultiIFSet, brIPPRegularPortEnable=brIPPRegularPortEnable, brPageEPSONAutoLF=brPageEPSONAutoLF, brSecondaryDNSIPAddress=brSecondaryDNSIPAddress, panelinfo=panelinfo, brOneTouchDialCount=brOneTouchDialCount, brpsAPOPEnable=brpsAPOPEnable, brDirectPrintOrientation=brDirectPrintOrientation, brPfKitIndexCount=brPfKitIndexCount, brpsBanyanErrorCS=brpsBanyanErrorCS, brCapabilityResolutionTable=brCapabilityResolutionTable, brnetMultiIFConfig=brnetMultiIFConfig, brPrtAdvancedTrayPriority=brPrtAdvancedTrayPriority, brLCDString1=brLCDString1, brpsEmailSendTestCall=brpsEmailSendTestCall, autodial=autodial, brpsTCPIPTimeout=brpsTCPIPTimeout, brtray1size=brtray1size, brpsAppleTalkEnable=brpsAppleTalkEnable, brPrtGeneralEmulationTimeout=brPrtGeneralEmulationTimeout, brpsTCPIPUpdate=brpsTCPIPUpdate, brEmailReportsTime=brEmailReportsTime, brMultiIFActiveIF=brMultiIFActiveIF, brpsDLCLLCState=brpsDLCLLCState, brpsWLanAssociateTestSupported=brpsWLanAssociateTestSupported, brFuncLockPublicEntry=brFuncLockPublicEntry, brLdapServerBaseDN=brLdapServerBaseDN, brFontSymbolSet=brFontSymbolSet, brLLMNREnable=brLLMNREnable, brEmailReportsSendReportNow=brEmailReportsSendReportNow, brPJLInfoFirmwareUpdateconfigIndex=brPJLInfoFirmwareUpdateconfigIndex, brMultiIFSetDefault=brMultiIFSetDefault, brpsServiceNDSTree=brpsServiceNDSTree, brtray4size=brtray4size, brNetPcFaxRxSupported=brNetPcFaxRxSupported, wlStatus=wlStatus, wlSES=wlSES, simm=simm, brLdapServerAttrNameEntry=brLdapServerAttrNameEntry, brPagePCLAutoSkip=brPagePCLAutoSkip, brNetRemoteSetUpSupported=brNetRemoteSetUpSupported, brErrorHistoryAllClear=brErrorHistoryAllClear, broriginalinternetsetting=broriginalinternetsetting, brSNTPCSupported=brSNTPCSupported, brNotificationStatusID=brNotificationStatusID, brpsPortSNMPExtensions=brpsPortSNMPExtensions, brpsAdvancedTCPIPAccessAdministratorIPAddress=brpsAdvancedTCPIPAccessAdministratorIPAddress, brPrtAdvancedBuzzerVolume=brPrtAdvancedBuzzerVolume, brPrintPagesIndex=brPrintPagesIndex, brpsTmpSMTPServerName=brpsTmpSMTPServerName, netPML=netPML, brNetScannerSupported=brNetScannerSupported, brMultiIFServiceStringIndex=brMultiIFServiceStringIndex, pjl=pjl, brpsBanyanSPPConnectionInformation=brpsBanyanSPPConnectionInformation, pen5=pen5, brCarbonCopies=brCarbonCopies, brresolution=brresolution, brFuncLockPublicFuncCount=brFuncLockPublicFuncCount, copies=copies, brMultiIFServicePort=brMultiIFServicePort, brpsPortInhibitDatagramSupport=brpsPortInhibitDatagramSupport, brCapabilityPaperName=brCapabilityPaperName, smallPaperSize=smallPaperSize, brprotocol=brprotocol, brMultiIFTCPIPNetBIOSSecondaryWINSAddr=brMultiIFTCPIPNetBIOSSecondaryWINSAddr, brMultiIFDNSEntry=brMultiIFDNSEntry, brpsPOP3TotalAPOPFailure=brpsPOP3TotalAPOPFailure, ibm=ibm, brNetRemoteSetUpEnable=brNetRemoteSetUpEnable, brCarbonCopyTray=brCarbonCopyTray, brTrayPriorityTable=brTrayPriorityTable, brSecondaryDNSIP=brSecondaryDNSIP)
mibBuilder.exportSymbols("BROTHER-MIB", brpsNetwareRestart=brpsNetwareRestart, brPictBridgePaperSize=brPictBridgePaperSize, brPageGLPen2Size=brPageGLPen2Size, brPageGLPen5Size=brPageGLPen5Size, brMultiIFIPv6AddressCountTable=brMultiIFIPv6AddressCountTable, mail=mail, brcopies=brcopies, brPagePCLAutoCR=brPagePCLAutoCR, mcsNetScanner=mcsNetScanner, brPrtAvoidMailboxFullEntry=brPrtAvoidMailboxFullEntry, brDirectPrintPdfThumbnailType=brDirectPrintPdfThumbnailType, margin_p=margin_p, brMultiIFprotocol=brMultiIFprotocol, reset=reset, brpsWLanAvailableChannel=brpsWLanAvailableChannel, brpsEmailRecvTestCall=brpsEmailRecvTestCall, brpsNetwareServerName=brpsNetwareServerName, brPrtGeneralBuzzer=brPrtGeneralBuzzer, brMultiIFIPv6MethodServer=brMultiIFIPv6MethodServer, brpsFirmwareIPAddress=brpsFirmwareIPAddress, cassette3=cassette3, brMultiIFconfig=brMultiIFconfig, brpsWLanRtsCtsThreshold=brpsWLanRtsCtsThreshold, brMultiIFIPv6AddressEntry=brMultiIFIPv6AddressEntry, broriginalLAA=broriginalLAA, brMultiIFServiceFilterCount=brMultiIFServiceFilterCount, brCommunicationErrorHistoryIndex=brCommunicationErrorHistoryIndex, brpsWLanLEAPTimeout=brpsWLanLEAPTimeout, brMultiIFWebServicesInstanceID=brMultiIFWebServicesInstanceID, brNotificationCount=brNotificationCount, brpsPortCount=brpsPortCount, brPrtGeneralFeeder=brPrtGeneralFeeder, pushstatus=pushstatus, brpsTmpSMTPServerAuthMethod=brpsTmpSMTPServerAuthMethod, status_prt_eng=status_prt_eng, brsimmtype3=brsimmtype3, brFuncLockUserPrintPageCountMonoLast=brFuncLockUserPrintPageCountMonoLast, mcsNetSKy=mcsNetSKy, brnetbeui=brnetbeui, brMultiIFcontrol=brMultiIFcontrol, directprint=directprint, brPrtAdvancedXOffset=brPrtAdvancedXOffset, brPrintPagesMediaPlaceEntry=brPrintPagesMediaPlaceEntry, brPanelResetUser=brPanelResetUser, brPrtMailboxProtectEntry=brPrtMailboxProtectEntry, brPageEPSONAutoMask=brPageEPSONAutoMask, brMultiIForiginalIPv6=brMultiIForiginalIPv6, brMultiIFTCPIPRARPNoSubnet=brMultiIFTCPIPRARPNoSubnet, brFuncLockPcLoginNameAuthEnable=brFuncLockPcLoginNameAuthEnable, npPort=npPort, npCard=npCard, brMultiIForiginalLAA=brMultiIForiginalLAA, brRegistrationYMagenta=brRegistrationYMagenta, brpsAppleTalkWriteByte=brpsAppleTalkWriteByte, brpsWLanCtsRate=brpsWLanCtsRate, brMultiIFServiceTable=brMultiIFServiceTable, brpsIPPEnable=brpsIPPEnable, brMultiIFServiceProtocolIPP=brMultiIFServiceProtocolIPP, brport=brport, brpsWLanCapabilityAuthEAPIndex=brpsWLanCapabilityAuthEAPIndex, brMultiIFInterfaceInformation=brMultiIFInterfaceInformation, brpsAdvancedTCPIPAccessSupported=brpsAdvancedTCPIPAccessSupported, brMultiIFLAAEntry=brMultiIFLAAEntry, npMultiCards=npMultiCards, brDirectPrintOutputColor=brDirectPrintOutputColor, brFuncLockUserFuncEntry=brFuncLockUserFuncEntry, brFirmwareUpdateKeywordTable=brFirmwareUpdateKeywordTable, brErrorHistoryDescription=brErrorHistoryDescription, brpsTmpPOP3ServerName=brpsTmpPOP3ServerName, brMultiIFServiceEntry=brMultiIFServiceEntry, brEmailReportsFrequency=brEmailReportsFrequency, brInfoSerialNumber=brInfoSerialNumber, brPrtAdvancedUseMPTrayFirst=brPrtAdvancedUseMPTrayFirst, brMultiIFServiceEOT=brMultiIFServiceEOT, brPanelTestDemoPage=brPanelTestDemoPage, brPrintPagesTable=brPrintPagesTable, brMultiIFIPv6AddressTable=brMultiIFIPv6AddressTable, brPanelTestFontList=brPanelTestFontList, brSNTPCPrimaryServerPort=brSNTPCPrimaryServerPort, brMultiIFTCPIPTimeout=brMultiIFTCPIPTimeout, brpsFirmwareReload=brpsFirmwareReload, brpsWLanSESSupported=brpsWLanSESSupported, brpsNetwarePrintJob=brpsNetwarePrintJob, brLCDMode2=brLCDMode2, brpsPOP3TotalIOError=brpsPOP3TotalIOError, brpsWLanWPSSupported=brpsWLanWPSSupported, brMultiIFAPIPAEnable=brMultiIFAPIPAEnable, brMultiIFServiceFilter=brMultiIFServiceFilter, broriginalEWS=broriginalEWS, broriginalproxy=broriginalproxy, brpsWLanCapabilityAuthEAPCount=brpsWLanCapabilityAuthEAPCount, brFuncLockUserIndex=brFuncLockUserIndex, brPanelLock=brPanelLock, brpsTCPIPUseMethod=brpsTCPIPUseMethod, brother=brother, brSecurityDeviceNegotiation=brSecurityDeviceNegotiation, brpsNetBIOSIPMethod=brpsNetBIOSIPMethod, brpsServiceTCPPort=brpsServiceTCPPort, brTFTPSupported=brTFTPSupported, brPrintPagesPaperTypeEntry=brPrintPagesPaperTypeEntry, brShowIPAddressInfo=brShowIPAddressInfo, brpsNtSendEnable=brpsNtSendEnable, brpsWLanWepKeyType=brpsWLanWepKeyType, brRegistrationXYellowRight=brRegistrationXYellowRight, brPJLInfoDXconfigIndex=brPJLInfoDXconfigIndex, brpsBanyanIPCListen=brpsBanyanIPCListen, brSmallPaperSizeMP=brSmallPaperSizeMP, brLdapServerAttrDetail3=brLdapServerAttrDetail3, brpsPOP3Timeout=brpsPOP3Timeout, brpsServiceProtocolNetBEUI=brpsServiceProtocolNetBEUI, brPageGLPen6Size=brPageGLPen6Size, generalDeviceStatus=generalDeviceStatus, brSecurePrintRAMSizeMax=brSecurePrintRAMSizeMax, brMultiIFTCPIPEntry=brMultiIFTCPIPEntry, brPrintPagesFuncType=brPrintPagesFuncType, brMultiIFTCPIPSubnetMask=brMultiIFTCPIPSubnetMask, brPJLInfoFirmwareUpdateconfigTable=brPJLInfoFirmwareUpdateconfigTable, brpsWLanCapabilityEncryptModeDescription=brpsWLanCapabilityEncryptModeDescription, brPrintPagesPaperTypeTable=brPrintPagesPaperTypeTable, brMultiIFServiceReplace=brMultiIFServiceReplace, brMultiIFIPv6AddressCountEntry=brMultiIFIPv6AddressCountEntry, mediaFix=mediaFix, funclock=funclock, brLegacyCompatible=brLegacyCompatible, brpsLATTransmitBufferMax=brpsLATTransmitBufferMax, brTBD2=brTBD2, brNotificationVersion=brNotificationVersion, brPJLInfoOptionsTable=brPJLInfoOptionsTable, brpsHardwareType=brpsHardwareType, brFuncLockUserFuncCount=brFuncLockUserFuncCount, brFontSwitchOn=brFontSwitchOn, brpsWLanAssociate=brpsWLanAssociate, brpsBanyanSupported=brpsBanyanSupported, orientation=orientation, brMultiIFServiceNDSContext=brMultiIFServiceNDSContext, cassette=cassette, brInfoSolutionsCenterURL=brInfoSolutionsCenterURL, brLdapServerAttrDetailEnable1=brLdapServerAttrDetailEnable1, brpsPOP3TotalConnectionLost=brpsPOP3TotalConnectionLost, brpsPOP3TotalConnect=brpsPOP3TotalConnect, brNotificationRestoration=brNotificationRestoration, brLCDMode3=brLCDMode3, brpsAppleTalkPrintJob=brpsAppleTalkPrintJob, speedDial=speedDial, brNotificationErrorRule=brNotificationErrorRule, brpsBanyanEnable=brpsBanyanEnable, brFuncLockPublicPrintPageCountColorLast=brFuncLockPublicPrintPageCountColorLast, priadmin=priadmin, brInfoNextCare=brInfoNextCare, brOneTouchDialData=brOneTouchDialData, brCommunicationErrorHistoryDescription=brCommunicationErrorHistoryDescription, brPrtAvoidMailboxFullIndex=brPrtAvoidMailboxFullIndex, brpsWLanAPSetupMode=brpsWLanAPSetupMode, wireless=wireless, autocountreset=autocountreset, brpsTmpAPOPEnable=brpsTmpAPOPEnable, brCapabilityMediatypeCount=brCapabilityMediatypeCount, brSNMPV3PrivKey=brSNMPV3PrivKey, brFuncLockAutoCountResetWeek=brFuncLockAutoCountResetWeek, wlSetup=wlSetup, brInfoJamCountClear=brInfoJamCountClear, brMultiIFIPv6AddressIndex=brMultiIFIPv6AddressIndex, pen6=pen6, brProxyServerPort=brProxyServerPort, npConfig=npConfig, brtelnetEnable=brtelnetEnable, brpsNDSSupported=brpsNDSSupported, broriginalCIFS=broriginalCIFS, brTrayPriorityIndex=brTrayPriorityIndex, brPrintersEmailaddress=brPrintersEmailaddress, brpsLATGroup=brpsLATGroup, pagesetup=pagesetup, brttt1=brttt1, brMultiIFTCPIPDNSIPSetup=brMultiIFTCPIPDNSIPSetup, brDeviceNegotiationGetChallenge=brDeviceNegotiationGetChallenge, brWebServicesEnable=brWebServicesEnable, wlTKIP=wlTKIP, brWebServicesSSLPortEnable=brWebServicesSSLPortEnable, brPrtGeneralBinding=brPrtGeneralBinding, brLdapServerInfoEntry=brLdapServerInfoEntry, banner=banner, brTimestampLastFax=brTimestampLastFax, status=status, brpapertype=brpapertype, brpsTmpSMTPAUTHUsername=brpsTmpSMTPAUTHUsername, brpsSMTPTotalMessage=brpsSMTPTotalMessage, autoc=autoc, brpsNetwareEtherIICount=brpsNetwareEtherIICount, brpsServiceProtocolBanyan=brpsServiceProtocolBanyan, simmkind1=simmkind1, broriginalSecurity=broriginalSecurity, brpsTCPIPLPRRetryEnable=brpsTCPIPLPRRetryEnable, brpsTCPIPSupported=brpsTCPIPSupported, brpsServiceStringIndex=brpsServiceStringIndex, brpsNetwareSNAPCount=brpsNetwareSNAPCount, brpsPortQueueSize=brpsPortQueueSize, brpsPOP3PasswordSet=brpsPOP3PasswordSet, brFuncLockSettingInit=brFuncLockSettingInit, brpsServiceFilter=brpsServiceFilter, brpsWLanCapabilityAuthEAPTable=brpsWLanCapabilityAuthEAPTable, brPageGLPen4Size=brPageGLPen4Size, brEmailReportsReportFormat=brEmailReportsReportFormat, brSNMPV3AuthKey=brSNMPV3AuthKey, brMultiIFtcpip=brMultiIFtcpip, brEmailReportsEntry=brEmailReportsEntry, brCommunicationErrorHistoryTable=brCommunicationErrorHistoryTable, brPfKitCount=brPfKitCount, brpsEmailSupported=brpsEmailSupported, brpsSMTPPortNumber=brpsSMTPPortNumber, print_engine=print_engine, brPrintPagesMediaPlaceCounter=brPrintPagesMediaPlaceCounter, brCapabilityResolution=brCapabilityResolution, brpsBanyanIPNetworkID2=brpsBanyanIPNetworkID2, brlat=brlat, brPageGLPen2GrayLevel=brPageGLPen2GrayLevel, brpsPOP3TotalConnectFailure=brpsPOP3TotalConnectFailure, brIPv6Supported=brIPv6Supported, brSNTPCServerMethod=brSNTPCServerMethod, brOneTouchDialEntry=brOneTouchDialEntry, brSecretMPRetry=brSecretMPRetry, brNotificationRuleEntry=brNotificationRuleEntry, brMultiIFTCPIPUpdate=brMultiIFTCPIPUpdate, brpsWLanCapabilityAuthModeEntry=brpsWLanCapabilityAuthModeEntry, brPrtAdvancedPriority=brPrtAdvancedPriority, brEmailReportsSendReportatPowerOn=brEmailReportsSendReportatPowerOn, brSNTPCSyncResult=brSNTPCSyncResult, simmkind3=simmkind3, brLdapServerAttrDetailEnable2=brLdapServerAttrDetailEnable2, brMediaFixMP=brMediaFixMP, brPrtAvoidMailboxFull=brPrtAvoidMailboxFull, broriginalLegacy=broriginalLegacy, brsimmsize1=brsimmsize1, brFuncLockUserPrintPageLimitEnable=brFuncLockUserPrintPageLimitEnable, brpsWLanWepKeyEntry=brpsWLanWepKeyEntry, fax_general=fax_general, brPrtAdvancedDestination=brPrtAdvancedDestination, brNotificationStatusGroup=brNotificationStatusGroup, brRingDelayCount=brRingDelayCount, brMultiIFservice=brMultiIFservice, brInfoJamCount=brInfoJamCount, panellock=panellock, breconomode=breconomode, brpsPortInfoTable=brpsPortInfoTable, brInfoPConSupported=brInfoPConSupported, brMultiIFServiceNDSTree=brMultiIFServiceNDSTree, auto_e=auto_e, brpsAvailableWLanCommMode=brpsAvailableWLanCommMode, brPageGLPen3Size=brPageGLPen3Size, brPfKitType=brPfKitType, brFTPEnable=brFTPEnable, brsimmsize0=brsimmsize0, brMultiIFPrimaryDNSIPv6Address=brMultiIFPrimaryDNSIPv6Address, brpsLATKeepAliveTimer=brpsLATKeepAliveTimer, brpsTCPIPSubnetMask=brpsTCPIPSubnetMask)
mibBuilder.exportSymbols("BROTHER-MIB", brNotificationShowURLInfo=brNotificationShowURLInfo, brMultiIFSecondaryDNSIPAddress=brMultiIFSecondaryDNSIPAddress, brFuncLockUserPrintPageCounterReset=brFuncLockUserPrintPageCounterReset, mp=mp, interface=interface, brpsBanyanRouter2=brpsBanyanRouter2, brMediaFixTray4=brMediaFixTray4, brPJLInfoIntrayconfigTable=brPJLInfoIntrayconfigTable, brFuncLockUserFuncEnable=brFuncLockUserFuncEnable, brAutoRegistSetInterval=brAutoRegistSetInterval, brpsNetBIOSPrintingSupported=brpsNetBIOSPrintingSupported, etherN=etherN, brDeviceNegotiationConfirmPassword=brDeviceNegotiationConfirmPassword, brTCPIPConnectTime=brTCPIPConnectTime, brpsNetwareFrameType=brpsNetwareFrameType, broriginalSNMPTrap=broriginalSNMPTrap, brLdapServerAttrDetail4=brLdapServerAttrDetail4, brNetPcFaxRxEnable=brNetPcFaxRxEnable, brPrintPagesMediaPlaceTable=brPrintPagesMediaPlaceTable, printPages=printPages, brpsNetwareServicingServerCount=brpsNetwareServicingServerCount, brEmailReportsWeek=brEmailReportsWeek, brpsLATCircuitTimer=brpsLATCircuitTimer, brpsAppleTalkWriteError=brpsAppleTalkWriteError, brCarbonCopyMode=brCarbonCopyMode, broriginalupnp=broriginalupnp, brClockFuncSummerTime=brClockFuncSummerTime, brpsServiceProtocolIPP=brpsServiceProtocolIPP, brMultiIFAllSetDefault=brMultiIFAllSetDefault, brpsWLanCapabilityAuthEAPEntry=brpsWLanCapabilityAuthEAPEntry, brPrimaryDNSIP=brPrimaryDNSIP, wlNetSearch=wlNetSearch, brMultiIFDNSTable=brMultiIFDNSTable, brMultiIFTCPIPAddress=brMultiIFTCPIPAddress, brLdapEnable=brLdapEnable, brpsAvailableWLanScanWaitTime=brpsAvailableWLanScanWaitTime, brEWSRegularPortEnable=brEWSRegularPortEnable, brMultiIFTCPIPNetBIOSPrimaryWINSAddr=brMultiIFTCPIPNetBIOSPrimaryWINSAddr, net_peripheral=net_peripheral, clockfunction=clockfunction, brAdminCapability=brAdminCapability, brPrtAdvancedPrintDensity=brPrtAdvancedPrintDensity, brRegistrationXMagentaLeft=brRegistrationXMagentaLeft, brInfoBlackPrint=brInfoBlackPrint, brWlanSimpleWizardSupported=brWlanSimpleWizardSupported, brpsAppleTalkReadByte=brpsAppleTalkReadByte, brPageGLPen3GrayLevel=brPageGLPen3GrayLevel, brpapertype2=brpapertype2, brRawPortSupported=brRawPortSupported, brpsEmailRecvTestSupported=brpsEmailRecvTestSupported, brScanCountCounter=brScanCountCounter, brpsNetwarePollFreq=brpsNetwarePollFreq, key=key, brpsPortStatus=brpsPortStatus, brpsWLanAOSSSupported=brpsWLanAOSSSupported, brpsLATReceiveBufferMax=brpsLATReceiveBufferMax, brLdapServerAttrDetailEnable3=brLdapServerAttrDetailEnable3, brpsServiceNetwareServerMode=brpsServiceNetwareServerMode, brpsFirmwareXModem=brpsFirmwareXModem, brNetRemoteSetUpFileFormat=brNetRemoteSetUpFileFormat, brorientation=brorientation, brNetFaxShareSupported=brNetFaxShareSupported, brpsWLanWepKeySize=brpsWLanWepKeySize, brpsFirmwareDescription=brpsFirmwareDescription, brpsSmtpAUTHTimeout=brpsSmtpAUTHTimeout, brScanCountEntry=brScanCountEntry, brpsPortBinaryMode=brpsPortBinaryMode, brpsAvailableWLanChannel=brpsAvailableWLanChannel, brMultiIFInterfaceEnable=brMultiIFInterfaceEnable, brMultiIFServiceStringInfoTable=brMultiIFServiceStringInfoTable, brpsNetware8022Count=brpsNetware8022Count, brpsNtSendSupported=brpsNtSendSupported, eMailReports=eMailReports, brMultiIFIPv6StaticAddressCount=brMultiIFIPv6StaticAddressCount, brMultiIFServiceProtocolDLC=brMultiIFServiceProtocolDLC, brMultiIFTCPIPMethod=brMultiIFTCPIPMethod, brtelnetSupported=brtelnetSupported, brPanelTestConfiguration=brPanelTestConfiguration, brmanualfeed=brmanualfeed, broriginalRawPort=broriginalRawPort, mcgRemoteSetup=mcgRemoteSetup, brPageIBMAutoCR=brPageIBMAutoCR, brLdapTimeout=brLdapTimeout, brClockFuncZoneSet=brClockFuncZoneSet, brNotificationRuleValue=brNotificationRuleValue, wlCapability=wlCapability, brpsBanyanServerAddress2=brpsBanyanServerAddress2, brpsServiceProtocolTCPIP=brpsServiceProtocolTCPIP, brpsServiceStringLimit=brpsServiceStringLimit, brPanelKeyGo=brPanelKeyGo, brLdapServerAttrDetail1=brLdapServerAttrDetail1, brpsWLanCommMode=brpsWLanCommMode, brSNTPCPrimaryServerName=brSNTPCPrimaryServerName, pfkit=pfkit, brCommunicationErrorHistoryEntry=brCommunicationErrorHistoryEntry, bremail=bremail, brPrtAvoidMailboxFullGroup=brPrtAvoidMailboxFullGroup, brMultiIFServiceInfoEntry=brMultiIFServiceInfoEntry, margin_i=margin_i, brUnRegisterKeyInfo=brUnRegisterKeyInfo, brPageEPSONLeftMargin=brPageEPSONLeftMargin, wlWPA=wlWPA, brDeviceNegotiationEncryptVer=brDeviceNegotiationEncryptVer, mcfNetPcFaxRx=mcfNetPcFaxRx, auto_p=auto_p, brMultiIFServiceMatch=brMultiIFServiceMatch, brFuncLockUserTable=brFuncLockUserTable, brLCDString3=brLCDString3, brDirectPrintPdfOption=brDirectPrintPdfOption, brpsWLanCommSpeed=brpsWLanCommSpeed, brENetMode=brENetMode, brMultiIFAPIPAEntry=brMultiIFAPIPAEntry, brPageIBMLeftMargin=brPageIBMLeftMargin, brPrintPagesMediaPlaceType=brPrintPagesMediaPlaceType, brpsNetwareEtherIINetInfo=brpsNetwareEtherIINetInfo, brPrtAdvancedJamRecovery=brPrtAdvancedJamRecovery, brMultiIFNetBIOSEntry=brMultiIFNetBIOSEntry, brpsPOP3TotalPasswordFailure=brpsPOP3TotalPasswordFailure, brPriMailAddress=brPriMailAddress, brpsDLCLLCConnectHost=brpsDLCLLCConnectHost, brpsTCPIPRARPNoSubnet=brpsTCPIPRARPNoSubnet, brProxyServerCount=brProxyServerCount, brMultiIFIPv6StaticAddressEntry=brMultiIFIPv6StaticAddressEntry, brdlc=brdlc, brFTPSupported=brFTPSupported, brFuncLockUserName=brFuncLockUserName, mediatype=mediatype, brpsAvailableWLanScan=brpsAvailableWLanScan, nm=nm, brpsDLCEnable=brpsDLCEnable, brMultiIFServiceString=brMultiIFServiceString, specification=specification, brCIFSEnable=brCIFSEnable, brOwnFaxNumber=brOwnFaxNumber, brsimmsize2=brsimmsize2, brProxyBypassServer=brProxyBypassServer, brpsWLanDestination=brpsWLanDestination, brFaxReceiveMode=brFaxReceiveMode, brScanCountTable=brScanCountTable, brTCPIPServerAddress=brTCPIPServerAddress, brPJLInfoFirmwareUpdateconfig=brPJLInfoFirmwareUpdateconfig, brPanelKeyFormFeed=brPanelKeyFormFeed, brMultiIFEnetMode=brMultiIFEnetMode, brUPnPSupported=brUPnPSupported, brpsProtectModeEnable=brpsProtectModeEnable, brPanelKeyReprint=brPanelKeyReprint, brNetSKeyEnable=brNetSKeyEnable, brPJLInfoDXconfig=brPJLInfoDXconfig, brMultiIFTCPIPMethodServer=brMultiIFTCPIPMethodServer, brMultiIFWebServicesMetadataVersion=brMultiIFWebServicesMetadataVersion, brcontrol=brcontrol, brpsServiceReplace=brpsServiceReplace, brpsPortIndex=brpsPortIndex, brpsBanyanErrorPT=brpsBanyanErrorPT, brpsBanyanSPPListen=brpsBanyanSPPListen, brDirectPrintMultipulPage=brDirectPrintMultipulPage, brpsNetware8023Count=brpsNetware8023Count, brPagePSCAPTsetting=brPagePSCAPTsetting, brpsAppleTalkZone=brpsAppleTalkZone, brpsWLanNetSearchSupported=brpsWLanNetSearchSupported, prt_condition=prt_condition, brsimmsize3=brsimmsize3, broriginalOtherSetting=broriginalOtherSetting, brpsWLanCapabilityAuthEAPDescription=brpsWLanCapabilityAuthEAPDescription, lpd=lpd, brBackLightColor=brBackLightColor, mcGeneral=mcGeneral, brPrimaryDNSIPAddress=brPrimaryDNSIPAddress, brNetFaxShareEnable=brNetFaxShareEnable, brPictBridgePrintSetting=brPictBridgePrintSetting, brpsTCPIPAccessNodeAddress=brpsTCPIPAccessNodeAddress, brPJLInfoDXconfigTable=brPJLInfoDXconfigTable, brpsWLanOperatingMode=brpsWLanOperatingMode, brpsDLCLLCLastIFrame=brpsDLCLLCLastIFrame, brMultiIFCount=brMultiIFCount, brFuncLockUserFuncTable=brFuncLockUserFuncTable, brMultiIFnetbeui=brMultiIFnetbeui, brSecMailAddress=brSecMailAddress, brSecurePrintRAMSize=brSecurePrintRAMSize, brMultiIFType=brMultiIFType, broriginaltcpip=broriginaltcpip, fontsetup=fontsetup, brpsTmpSMTPAUTHPasswordModified=brpsTmpSMTPAUTHPasswordModified, brSNMPV3PrivPassword=brSNMPV3PrivPassword, brLdapServerAttrNameIndex=brLdapServerAttrNameIndex, brFuncLock=brFuncLock, test=test, brClockFuncTimeStyle=brClockFuncTimeStyle, brpsServiceBOT=brpsServiceBOT, mcfGeneral=mcfGeneral, brLAAMacAddress=brLAAMacAddress, bio1_explanation=bio1_explanation, brCapabilityPaperIndex=brCapabilityPaperIndex, brPagesSentLastFax=brPagesSentLastFax, brPanelLockOff=brPanelLockOff, brPrtAdvancedPanelBuzzer=brPrtAdvancedPanelBuzzer, brpsBanyanPrintServerStatus=brpsBanyanPrintServerStatus, brCapabilityOrientationName=brCapabilityOrientationName, brMultiIFServiceStringCount=brMultiIFServiceStringCount, brnetware=brnetware, brpsServiceNetwareServerCount=brpsServiceNetwareServerCount, broriginalIPv6=broriginalIPv6, brLdapServerAttrName=brLdapServerAttrName, manual=manual, brpsWLanCapabilityAuthEAPSupportAuthentication=brpsWLanCapabilityAuthEAPSupportAuthentication, brEmailReportsAddress=brEmailReportsAddress, brFirmwareUpdateKeywordCount=brFirmwareUpdateKeywordCount, brSpeedDialCount=brSpeedDialCount, pen3=pen3, brpsWLanCapabilityAuthEAPType=brpsWLanCapabilityAuthEAPType, brIPPOriginalPortEnable=brIPPOriginalPortEnable, wlAssociate=wlAssociate, brpsWLanCapabilityAuthModeDescription=brpsWLanCapabilityAuthModeDescription, brPfKitIndex=brPfKitIndex, brpsFirmwareAdvancedAddressSupported=brpsFirmwareAdvancedAddressSupported, brPrtMailboxProtect=brPrtMailboxProtect, brMultiIFAPIPATable=brMultiIFAPIPATable, brautocont=brautocont, determined=determined, brpsServicePort=brpsServicePort, brMultiIFWebServicesEntry=brMultiIFWebServicesEntry, wlWEP=wlWEP, brPageIBMAutoMask=brPageIBMAutoMask, cassette2=cassette2, brIFaxSupported=brIFaxSupported, brpsNetware8023NetInfo=brpsNetware8023NetInfo, brPanelTestTestPage=brPanelTestTestPage, brLCDString16fix=brLCDString16fix, mcfFaxInfomation=mcfFaxInfomation, brTBD3=brTBD3, brpsNetwarePasswordSet=brpsNetwarePasswordSet, mfpgeneral_setup=mfpgeneral_setup, brSmallPaperSize2=brSmallPaperSize2, countinfo=countinfo, brpsServiceInfoEntry=brpsServiceInfoEntry, brPanelKeyOnline=brPanelKeyOnline, brpsSetDefault=brpsSetDefault, brFuncLockUserEntry=brFuncLockUserEntry, brpsFirmwareFile=brpsFirmwareFile, broriginalLLTD=broriginalLLTD, brpsWLanDataRetry=brpsWLanDataRetry, capability=capability, brPrintPagesPaperTypeIndex=brPrintPagesPaperTypeIndex, brSNMPV3Supported=brSNMPV3Supported, brpsServerCertificateNum=brpsServerCertificateNum, brMultiIFServiceProtocolBanyan=brMultiIFServiceProtocolBanyan, brpsBanyanTimeout=brpsBanyanTimeout, brpsWLanOperatingWepKeyDefaultIndex=brpsWLanOperatingWepKeyDefaultIndex, brIPPSSLPortEnable=brIPPSSLPortEnable, brpsBanyanPasswordSet=brpsBanyanPasswordSet, brMultiIFDNSIPv6AddressEntry=brMultiIFDNSIPv6AddressEntry, brtray3size=brtray3size, brpsWLanCapabilitAuthModeIndex=brpsWLanCapabilitAuthModeIndex, brsimmtype0=brsimmtype0)
mibBuilder.exportSymbols("BROTHER-MIB", brpsTestPage=brpsTestPage, brMultiIFServiceAppleTalkType=brMultiIFServiceAppleTalkType, brFuncLockAutoCountResetDate=brFuncLockAutoCountResetDate, brpsPOP3PollFreq=brpsPOP3PollFreq, brlines=brlines, brLPDBannerPage=brLPDBannerPage, brpsIPPSupported=brpsIPPSupported, brInfoHDDInternal=brInfoHDDInternal, economy=economy, brPrtGeneralDuplex=brPrtGeneralDuplex, brCapabilityPaperTable=brCapabilityPaperTable, brEmailReportsTable=brEmailReportsTable, brPJLInfoStorageconfigTable=brPJLInfoStorageconfigTable, brpsOEMString=brpsOEMString, brpsSMTPAUTHPasswordSet=brpsSMTPAUTHPasswordSet, brMultiIFServiceProtocolTCPIP=brMultiIFServiceProtocolTCPIP, net_MFP=net_MFP, brColorCalibration=brColorCalibration, brMultiIFServiceObsolete=brMultiIFServiceObsolete, brPrintPages=brPrintPages, brpsPOP3TotalMessage=brpsPOP3TotalMessage, buzzer=buzzer, brpsLATEnable=brpsLATEnable, brSNTPCInterval=brSNTPCInterval, brPrtAdvancedYOffset=brPrtAdvancedYOffset, broriginaltelnet=broriginaltelnet, brLdapTimeoutSupported=brLdapTimeoutSupported, tray=tray, brAPIPASupported=brAPIPASupported, brPageGLPen1Size=brPageGLPen1Size, brPrtAdvancedButtonRepeat=brPrtAdvancedButtonRepeat, brUPnPEnable=brUPnPEnable, brRegistrationXMagentaRight=brRegistrationXMagentaRight, brPJLInfoIntrayconfigEntry=brPJLInfoIntrayconfigEntry)
