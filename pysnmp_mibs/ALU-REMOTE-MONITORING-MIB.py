...
# Notes
# -----
# ASN.1 source file://mibs/nokia/ALU-REMOTE-MONITORING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:02:44 2025
...
aluRMTriggerRowStatus = _AluRMTriggerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 6, 1, 2, 2, 11, 1, 1, 1, 12),
    _AluRMTriggerRowStatus_Type()
)
aluRMTriggerRowStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    aluRMTriggerRowStatus.setStatus("current")
...
aluRMAuxTriggerGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 6, 1, 2, 1, 11, 11, 2, 5)
)
aluRMAuxTriggerGroup.setObjects(
    ("ALU-REMOTE-MONITORING-MIB", "aluRMTriggerRowStatus")
)
if mibBuilder.loadTexts:
    aluRMAuxTriggerGroup.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"AluRMAlias": AluRMAlias,
       ...
       "aluRMAuxTriggerGroup": aluRMAuxTriggerGroup,
       ...
       "aluRMTriggerRowStatus": aluRMTriggerRowStatus,
