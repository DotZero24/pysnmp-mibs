...
_E='read-only'
_D='read-create'
_C='A3COM-HUAWEI-MPLSOAM-PS-MIB'
_B='Integer32'
_A='current'
...
h3cMplsOamPsScalarGroup=_H3cMplsOamPsScalarGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,80,1))
...
h3cMplsOamPsTrapOpen=_H3cMplsOamPsTrapOpen_Object((1,3,6,1,4,1,43,45,1,10,2,80,1,1),_H3cMplsOamPsTrapOpen_Type())
...
h3cMplsOamPsTable=_H3cMplsOamPsTable_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,80,2))
_H3cMplsPsTable_Object=MibTable
h3cMplsPsTable=_H3cMplsPsTable_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1))
if mibBuilder.loadTexts:h3cMplsPsTable.setStatus(_A)
_H3cMplsPsEntry_Object=MibTableRow
h3cMplsPsEntry=_H3cMplsPsEntry_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1))
...
h3cMplsPsIndex=_H3cMplsPsIndex_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,1),_H3cMplsPsIndex_Type())
...
h3cMplsPsGroupID=_H3cMplsPsGroupID_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,2),_H3cMplsPsGroupID_Type())
...
h3cMplsPsWorkLspName=_H3cMplsPsWorkLspName_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,3),_H3cMplsPsWorkLspName_Type())
...
h3cMplsPsProtectLspName=_H3cMplsPsProtectLspName_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,4),_H3cMplsPsProtectLspName_Type())
...
h3cMplsPsRevertiveMode=_H3cMplsPsRevertiveMode_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,5),_H3cMplsPsRevertiveMode_Type())
...
h3cMplsPsWTR=_H3cMplsPsWTR_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,6),_H3cMplsPsWTR_Type())
...
h3cMplsPsHoldOff=_H3cMplsPsHoldOff_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,7),_H3cMplsPsHoldOff_Type())
...
h3cMplsPsSwitchCondition=_H3cMplsPsSwitchCondition_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,8),_H3cMplsPsSwitchCondition_Type())
...
h3cMplsPsWorkLspDetectState=_H3cMplsPsWorkLspDetectState_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,9),_H3cMplsPsWorkLspDetectState_Type())
...
h3cMplsPsWorkLspUpDownState=_H3cMplsPsWorkLspUpDownState_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,10),_H3cMplsPsWorkLspUpDownState_Type())
...
h3cMplsPsProtLspDetectState=_H3cMplsPsProtLspDetectState_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,11),_H3cMplsPsProtLspDetectState_Type())
...
h3cMplsPsProtLspUpDownState=_H3cMplsPsProtLspUpDownState_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,12),_H3cMplsPsProtLspUpDownState_Type())
...
h3cMplsPsSwitchResult=_H3cMplsPsSwitchResult_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,13),_H3cMplsPsSwitchResult_Type())
...
h3cMplsPsRowStatus=_H3cMplsPsRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,80,2,1,1,14),_H3cMplsPsRowStatus_Type())
...
h3cMplsOamPsNotifications=_H3cMplsOamPsNotifications_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,80,3))
h3cMplsPsSwitchPtoW=NotificationType((1,3,6,1,4,1,43,45,1,10,2,80,3,1))
h3cMplsPsSwitchPtoW.setObjects(*((_C,_F),(_C,_G),(_C,_H)))
if mibBuilder.loadTexts:h3cMplsPsSwitchPtoW.setStatus(_A)
h3cMplsPsSwitchWtoP=NotificationType((1,3,6,1,4,1,43,45,1,10,2,80,3,2))
