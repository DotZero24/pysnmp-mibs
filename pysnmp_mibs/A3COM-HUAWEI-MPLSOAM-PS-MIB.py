# SNMP MIB module (A3COM-HUAWEI-MPLSOAM-PS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-MPLSOAM-PS-MIB
...
h3cMplsPsIndex = _H3cMplsPsIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 1),
...
h3cMplsPsGroupID = _H3cMplsPsGroupID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 2),
...
h3cMplsPsWorkLspName = _H3cMplsPsWorkLspName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 3),
...
h3cMplsPsProtectLspName = _H3cMplsPsProtectLspName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 4),
...
h3cMplsPsRevertiveMode = _H3cMplsPsRevertiveMode_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 5),
...
h3cMplsPsWTR = _H3cMplsPsWTR_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 6),
    _H3cMplsPsWTR_Type()
)
...
h3cMplsPsHoldOff = _H3cMplsPsHoldOff_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 7),
...
h3cMplsPsSwitchCondition = _H3cMplsPsSwitchCondition_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 8),
...
h3cMplsPsWorkLspDetectState = _H3cMplsPsWorkLspDetectState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 9),
...
h3cMplsPsWorkLspUpDownState = _H3cMplsPsWorkLspUpDownState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 10),
...
h3cMplsPsProtLspDetectState = _H3cMplsPsProtLspDetectState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 11),
...
h3cMplsPsProtLspUpDownState = _H3cMplsPsProtLspUpDownState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 12),
...
h3cMplsPsSwitchResult = _H3cMplsPsSwitchResult_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 13),
...
h3cMplsPsRowStatus = _H3cMplsPsRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 2, 1, 1, 14),
...
h3cMplsPsSwitchPtoW = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 3, 1)
)
h3cMplsPsSwitchPtoW.setObjects(
      *(("A3COM-HUAWEI-MPLSOAM-PS-MIB", "h3cMplsPsWorkLspName"),
        ("A3COM-HUAWEI-MPLSOAM-PS-MIB", "h3cMplsPsProtectLspName"),
        ("A3COM-HUAWEI-MPLSOAM-PS-MIB", "h3cMplsPsSwitchResult"))
)
if mibBuilder.loadTexts:
...
h3cMplsPsSwitchWtoP = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 80, 3, 2)
)
