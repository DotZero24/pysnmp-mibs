...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/rfc/RTP-MIB
...
TDomain, RowStatus, TAddress, TextualConvention, TestAndIncr, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TDomain", "RowStatus", "TAddress", "TextualConvention", "TestAndIncr", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("RTP-MIB", rtpSenderTable=rtpSenderTable, rtpSenderEntry=rtpSenderEntry, rtpSessionIfIndex=rtpSessionIfIndex, rtpCompliances=rtpCompliances, rtpSenderInverseEntry=rtpSenderInverseEntry, rtpRcvrJitter=rtpRcvrJitter, rtpSessionInverseEntry=rtpSessionInverseEntry, rtpRcvrTool=rtpRcvrTool, rtpMIBObjects=rtpMIBObjects, rtpSenderAddr=rtpSenderAddr, rtpSenderPT=rtpSenderPT, rtpSenderStartTime=rtpSenderStartTime, rtpRcvrInverseTable=rtpRcvrInverseTable, rtpConformance=rtpConformance, rtpRcvrPT=rtpRcvrPT, rtpMIB=rtpMIB, rtpSessionRemAddr=rtpSessionRemAddr, rtpSenderPackets=rtpSenderPackets, rtpRcvrOctets=rtpRcvrOctets, rtpHostGroup=rtpHostGroup, rtpSessionByes=rtpSessionByes, rtpMonitorGroup=rtpMonitorGroup, rtpSessionReceiverJoins=rtpSessionReceiverJoins, rtpSessionLocAddr=rtpSessionLocAddr, rtpSessionMonitor=rtpSessionMonitor, rtpSenderCNAME=rtpSenderCNAME, rtpSessionRowStatus=rtpSessionRowStatus, rtpSenderInverseTable=rtpSenderInverseTable, rtpSenderOctets=rtpSenderOctets, rtpRcvrAddr=rtpRcvrAddr, rtpSenderSRs=rtpSenderSRs, rtpRcvrRRs=rtpRcvrRRs, rtpRcvrInverseStartTime=rtpRcvrInverseStartTime, rtpSessionDomain=rtpSessionDomain, PYSNMP_MODULE_ID=rtpMIB, rtpSessionTable=rtpSessionTable, rtpSessionIndex=rtpSessionIndex, rtpRcvrStartTime=rtpRcvrStartTime, rtpRcvrInverseEntry=rtpRcvrInverseEntry, rtpSessionInverseStartTime=rtpSessionInverseStartTime, rtpInverseGroup=rtpInverseGroup, rtpSessionSenderJoins=rtpSessionSenderJoins, rtpRcvrTable=rtpRcvrTable, rtpSessionEntry=rtpSessionEntry, rtpSenderInverseStartTime=rtpSenderInverseStartTime, rtpSessionNewIndex=rtpSessionNewIndex, rtpRcvrSSRC=rtpRcvrSSRC, rtpSessionInverseTable=rtpSessionInverseTable, rtpRcvrRRTime=rtpRcvrRRTime, rtpHostCompliance=rtpHostCompliance, rtpSessionStartTime=rtpSessionStartTime, rtpSenderSSRC=rtpSenderSSRC, rtpRcvrPackets=rtpRcvrPackets, rtpRcvrEntry=rtpRcvrEntry, rtpSystemGroup=rtpSystemGroup, rtpRcvrSRCSSRC=rtpRcvrSRCSSRC, rtpSenderSRTime=rtpSenderSRTime, rtpGroups=rtpGroups, rtpMonitorCompliance=rtpMonitorCompliance, rtpSenderTool=rtpSenderTool, rtpRcvrLostPackets=rtpRcvrLostPackets, rtpRcvrCNAME=rtpRcvrCNAME, rtpRcvrRTT=rtpRcvrRTT)
