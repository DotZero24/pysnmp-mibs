...
DisplayString, TDomain, TimeStamp, RowStatus, TAddress, TestAndIncr, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TDomain", "TimeStamp", "RowStatus", "TAddress", "TestAndIncr", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("RTP-MIB", PYSNMP_MODULE_ID=rtpMIB, rtpSessionIndex=rtpSessionIndex, rtpSenderStartTime=rtpSenderStartTime, rtpMIBObjects=rtpMIBObjects, rtpSessionInverseEntry=rtpSessionInverseEntry, rtpSessionSenderJoins=rtpSessionSenderJoins, rtpSenderEntry=rtpSenderEntry, rtpSenderCNAME=rtpSenderCNAME, rtpSessionByes=rtpSessionByes, rtpConformance=rtpConformance, rtpSessionInverseTable=rtpSessionInverseTable, rtpSenderSSRC=rtpSenderSSRC, rtpRcvrInverseStartTime=rtpRcvrInverseStartTime, rtpSenderSRs=rtpSenderSRs, rtpSessionIfIndex=rtpSessionIfIndex, rtpCompliances=rtpCompliances, rtpRcvrOctets=rtpRcvrOctets, rtpHostCompliance=rtpHostCompliance, rtpSessionMonitor=rtpSessionMonitor, rtpRcvrLostPackets=rtpRcvrLostPackets, rtpSessionNewIndex=rtpSessionNewIndex, rtpRcvrSRCSSRC=rtpRcvrSRCSSRC, rtpSenderOctets=rtpSenderOctets, rtpRcvrInverseEntry=rtpRcvrInverseEntry, rtpSenderPackets=rtpSenderPackets, rtpHostGroup=rtpHostGroup, rtpSenderTool=rtpSenderTool, rtpSenderPT=rtpSenderPT, rtpSessionRemAddr=rtpSessionRemAddr, rtpRcvrInverseTable=rtpRcvrInverseTable, rtpSessionTable=rtpSessionTable, rtpRcvrRRs=rtpRcvrRRs, rtpRcvrAddr=rtpRcvrAddr, rtpSenderInverseTable=rtpSenderInverseTable, rtpSenderAddr=rtpSenderAddr, rtpRcvrEntry=rtpRcvrEntry, rtpInverseGroup=rtpInverseGroup, rtpSenderTable=rtpSenderTable, rtpSessionInverseStartTime=rtpSessionInverseStartTime, rtpRcvrTable=rtpRcvrTable, rtpSessionReceiverJoins=rtpSessionReceiverJoins, rtpRcvrPackets=rtpRcvrPackets, rtpGroups=rtpGroups, rtpMonitorGroup=rtpMonitorGroup, rtpMonitorCompliance=rtpMonitorCompliance, rtpRcvrPT=rtpRcvrPT, rtpSystemGroup=rtpSystemGroup, rtpRcvrJitter=rtpRcvrJitter, rtpRcvrRRTime=rtpRcvrRRTime, rtpRcvrSSRC=rtpRcvrSSRC, rtpSenderInverseEntry=rtpSenderInverseEntry, rtpSenderSRTime=rtpSenderSRTime, rtpSessionRowStatus=rtpSessionRowStatus, rtpRcvrRTT=rtpRcvrRTT, rtpMIB=rtpMIB, rtpSessionEntry=rtpSessionEntry, rtpSessionStartTime=rtpSessionStartTime, rtpSenderInverseStartTime=rtpSenderInverseStartTime, rtpSessionLocAddr=rtpSessionLocAddr, rtpRcvrCNAME=rtpRcvrCNAME, rtpSessionDomain=rtpSessionDomain, rtpRcvrTool=rtpRcvrTool, rtpRcvrStartTime=rtpRcvrStartTime)
