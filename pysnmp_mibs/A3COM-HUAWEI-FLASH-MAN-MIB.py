# SNMP MIB module (A3COM-HUAWEI-FLASH-MAN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-FLASH-MAN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:12 2025
...
h3cFlhIndex = _H3cFlhIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 1),
    _H3cFlhIndex_Type()
)
...
h3cFlhSize = _H3cFlhSize_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 2),
    _H3cFlhSize_Type()
)
...
h3cFlhPos = _H3cFlhPos_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 3),
    _H3cFlhPos_Type()
)
...
h3cFlhName = _H3cFlhName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 4),
    _H3cFlhName_Type()
)
...
h3cFlhChipNum = _H3cFlhChipNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 5),
    _H3cFlhChipNum_Type()
)
...
h3cFlhDescr = _H3cFlhDescr_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 6),
    _H3cFlhDescr_Type()
)
...
h3cFlhInitTime = _H3cFlhInitTime_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 8),
...
h3cFlhRemovable = _H3cFlhRemovable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 9),
...
h3cFlhPartitionBool = _H3cFlhPartitionBool_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 11),
...
h3cFlhMinPartitionSize = _H3cFlhMinPartitionSize_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 12),
...
h3cFlhMaxPartitions = _H3cFlhMaxPartitions_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 13),
...
h3cFlhPartitionNum = _H3cFlhPartitionNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 14),
...
h3cFlhKbyteSize = _H3cFlhKbyteSize_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 2, 1, 15),
...
h3cFlhChipSerialNo = _H3cFlhChipSerialNo_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 3, 1, 1, 1),
...
h3cFlhChipID = _H3cFlhChipID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 3, 1, 1, 2),
    _H3cFlhChipID_Type()
)
...
h3cFlhChipDescr = _H3cFlhChipDescr_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 3, 1, 1, 3),
...
h3cFlhChipWriteTimesLimit = _H3cFlhChipWriteTimesLimit_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 3, 1, 1, 4),
...
h3cFlhChipWriteTimes = _H3cFlhChipWriteTimes_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 3, 1, 1, 5),
...
h3cFlhChipEraseTimesLimit = _H3cFlhChipEraseTimesLimit_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 3, 1, 1, 6),
...
h3cFlhChipEraseTimes = _H3cFlhChipEraseTimes_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 3, 1, 1, 7),
...
h3cFlhPartitionEntry = _H3cFlhPartitionEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1)
)
h3cFlhPartitionEntry.setIndexNames(
    (0, "A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhIndex"),
    (0, "A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartIndex"),
)
if mibBuilder.loadTexts:
...
h3cFlhPartIndex = _H3cFlhPartIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 1),
...
h3cFlhPartFirstChip = _H3cFlhPartFirstChip_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 2),
...
h3cFlhPartLastChip = _H3cFlhPartLastChip_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 3),
...
h3cFlhPartSpace = _H3cFlhPartSpace_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 4),
...
h3cFlhPartSpaceFree = _H3cFlhPartSpaceFree_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 5),
...
h3cFlhPartFileNum = _H3cFlhPartFileNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 6),
...
h3cFlhPartChecksumMethod = _H3cFlhPartChecksumMethod_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 7),
...
h3cFlhPartStatus = _H3cFlhPartStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 8),
...
h3cFlhPartUpgradeMode = _H3cFlhPartUpgradeMode_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 9),
...
h3cFlhPartName = _H3cFlhPartName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 10),
...
h3cFlhPartRequireErase = _H3cFlhPartRequireErase_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 11),
...
h3cFlhPartFileNameLen = _H3cFlhPartFileNameLen_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 1, 1, 12),
...
h3cFlhFileIndex = _H3cFlhFileIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 2, 1, 1, 1),
...
h3cFlhFileName = _H3cFlhFileName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 2, 1, 1, 2),
...
h3cFlhFileSize = _H3cFlhFileSize_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 2, 1, 1, 3),
...
h3cFlhFileStatus = _H3cFlhFileStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 2, 1, 1, 4),
...
h3cFlhFileChecksum = _H3cFlhFileChecksum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 1, 4, 2, 1, 1, 5),
...
h3cFlhOperIndex = _H3cFlhOperIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 1),
...
h3cFlhOperProtocol = _H3cFlhOperProtocol_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 3),
...
h3cFlhOperServerUser = _H3cFlhOperServerUser_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 5),
...
h3cFlhOperPassword = _H3cFlhOperPassword_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 6),
...
h3cFlhOperSourceFile = _H3cFlhOperSourceFile_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 7),
...
h3cFlhOperDestinationFile = _H3cFlhOperDestinationFile_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 8),
...
h3cFlhOperStatus = _H3cFlhOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 9),
...
h3cFlhOperProgress = _H3cFlhOperProgress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 11),
...
h3cFlhOperRowStatus = _H3cFlhOperRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 12),
...
h3cFlhOperServerPort = _H3cFlhOperServerPort_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 13),
...
h3cFlhOperFailReason = _H3cFlhOperFailReason_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 14),
...
h3cFlhOperSrvAddrType = _H3cFlhOperSrvAddrType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 15),
    _H3cFlhOperSrvAddrType_Type()
)
h3cFlhOperSrvAddrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cFlhOperSrvAddrType.setStatus("current")
_H3cFlhOperSrvAddrRev_Type = InetAddress
_H3cFlhOperSrvAddrRev_Object = MibTableColumn
h3cFlhOperSrvAddrRev = _H3cFlhOperSrvAddrRev_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 16),
    _H3cFlhOperSrvAddrRev_Type()
)
h3cFlhOperSrvAddrRev.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cFlhOperSrvAddrRev.setStatus("current")
_H3cFlhOperSrvVPNName_Type = DisplayString
_H3cFlhOperSrvVPNName_Object = MibTableColumn
h3cFlhOperSrvVPNName = _H3cFlhOperSrvVPNName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 2, 1, 1, 17),
    _H3cFlhOperSrvVPNName_Type()
)
h3cFlhOperSrvVPNName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cFlhOperSrvVPNName.setStatus("current")
_H3cFlashNotification_ObjectIdentity = ObjectIdentity
h3cFlashNotification = _H3cFlashNotification_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 1, 3)
)
_H3cFlashMIBConformance_ObjectIdentity = ObjectIdentity
h3cFlashMIBConformance = _H3cFlashMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2)
)
_H3cFlhMIBCompliances_ObjectIdentity = ObjectIdentity
h3cFlhMIBCompliances = _H3cFlhMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2, 1)
)
_H3cFlashMIBGroups_ObjectIdentity = ObjectIdentity
h3cFlashMIBGroups = _H3cFlashMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2, 2)
)

# Managed Objects groups

h3cFlhGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2, 2, 1)
)
h3cFlhGroup.setObjects(
      *(("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhSupportNum"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhSize"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPos"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhName"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhChipNum"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhDescr"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhInitTime"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhRemovable"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartitionBool"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhMinPartitionSize"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhMaxPartitions"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartitionNum"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhIndex"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhKbyteSize"))
)
if mibBuilder.loadTexts:
    h3cFlhGroup.setStatus("current")

h3cFlhChipGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2, 2, 3)
)
h3cFlhChipGroup.setObjects(
      *(("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhChipID"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhChipDescr"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhChipWriteTimesLimit"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhChipWriteTimes"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhChipEraseTimesLimit"),
...
h3cFlhPartitionGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2, 2, 4)
)
h3cFlhPartitionGroup.setObjects(
      *(("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartFirstChip"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartLastChip"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartSpace"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartSpaceFree"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartFileNum"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartChecksumMethod"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartStatus"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartUpgradeMode"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartName"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartRequireErase"),
...
h3cFlhFileGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2, 2, 5)
)
h3cFlhFileGroup.setObjects(
      *(("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhFileName"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhFileSize"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhFileStatus"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhFileChecksum"))
)
if mibBuilder.loadTexts:
    h3cFlhFileGroup.setStatus("current")

h3cFlhOperationGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2, 2, 6)
)
h3cFlhOperationGroup.setObjects(
      *(("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperType"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperProtocol"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperServerAddress"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperServerUser"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperPassword"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperSourceFile"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperDestinationFile"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperStatus"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperEndNotification"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperProgress"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperRowStatus"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperServerPort"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperFailReason"))
)
if mibBuilder.loadTexts:
...
h3cFlhNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2, 2, 7)
)
h3cFlhNotificationGroup.setObjects(
    ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperNotification")
)
if mibBuilder.loadTexts:
...
h3cFlhMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 9, 2, 1, 1)
)
h3cFlhMIBCompliance.setObjects(
      *(("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhGroup"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhPartitionGroup"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhFileGroup"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhOperationGroup"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhNotificationGroup"),
        ("A3COM-HUAWEI-FLASH-MAN-MIB", "h3cFlhChipGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"H3cFlashOperationStatus": H3cFlashOperationStatus,
       ...
       "h3cFlhOperSrvAddrType": h3cFlhOperSrvAddrType,
       "h3cFlhOperSrvAddrRev": h3cFlhOperSrvAddrRev,
       "h3cFlhOperSrvVPNName": h3cFlhOperSrvVPNName,
