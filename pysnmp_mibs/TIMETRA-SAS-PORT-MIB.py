...
pethPsePortIndex, pethPsePortEntry, pethPsePortDetectionStatus, pethPsePortPowerClassifications = mibBuilder.importSymbols("POWER-ETHERNET-MIB", "pethPsePortIndex", "pethPsePortEntry", "pethPsePortDetectionStatus", "pethPsePortPowerClassifications")
...
tmnxDS1Entry, tmnxPortPortID, tmnxPortEtherEntry, tmnxPortNotifyPortId, tmnxPortEntry, tmnxDS1PortEntry = mibBuilder.importSymbols("TIMETRA-PORT-MIB", "tmnxDS1Entry", "tmnxPortPortID", "tmnxPortEtherEntry", "tmnxPortNotifyPortId", "tmnxPortEntry", "tmnxDS1PortEntry")
...
TNetworkIngressMeterId, TmnxActionType, TmnxPortID, TNamedItem, TItemDescription, TFCName, TQueueId, TmnxOperState, TPortSchedulerCIR, TItemLongDescription, TPortSchedulerPIR, TNamedItemOrEmpty, TmnxEncapVal, TmnxServId = mibBuilder.importSymbols("TN-TC-MIB", "TNetworkIngressMeterId", "TmnxActionType", "TmnxPortID", "TNamedItem", "TItemDescription", "TFCName", "TQueueId", "TmnxOperState", "TPortSchedulerCIR", "TItemLongDescription", "TPortSchedulerPIR", "TNamedItemOrEmpty", "TmnxEncapVal", "TmnxServId")
...
mibBuilder.exportSymbols("TIMETRA-SAS-PORT-MIB", tmnxSASPortMIBModule=tmnxSASPortMIBModule, tmnxPortLoopbckSapEncapVal=tmnxPortLoopbckSapEncapVal, tmnxPortAccessEgressQueueStatsEntry=tmnxPortAccessEgressQueueStatsEntry, tmnxPortNetEgressQueueStatsOutProfDroPkts=tmnxPortNetEgressQueueStatsOutProfDroPkts, tmnxSASPortV4v0Group=tmnxSASPortV4v0Group, tmnxPortStatsQueue1PktsFwd=tmnxPortStatsQueue1PktsFwd, tmnxPortStatsQueue2PktsFwd=tmnxPortStatsQueue2PktsFwd, tmnxPortNetEgressQueueStatsEntry=tmnxPortNetEgressQueueStatsEntry, aluIntervalPhaseErrorMeanPpb=aluIntervalPhaseErrorMeanPpb, tmnxSASPortNetIngressStatsTable=tmnxSASPortNetIngressStatsTable, tmnxPortAccessEgressQueueStatsDroPkts=tmnxPortAccessEgressQueueStatsDroPkts, tmnxPortEtherDcommStatus=tmnxPortEtherDcommStatus, tmnxPortNetEgressQueueStatsDroPkts=tmnxPortNetEgressQueueStatsDroPkts, tmnxPortAccessEgressQueueStatsTable=tmnxPortAccessEgressQueueStatsTable, tmnxPortLldpTnlNrstBrdgeDstMac=tmnxPortLldpTnlNrstBrdgeDstMac, sasTmnxPortExtnEntry=sasTmnxPortExtnEntry, tmnxSASPortV6v0Group=tmnxSASPortV6v0Group, aluIntervalNumber=aluIntervalNumber, aluExtTmnxDS1PortEntry=aluExtTmnxDS1PortEntry, tmnxPortStatsQueue5PktsFwd=tmnxPortStatsQueue5PktsFwd, aluIntervalPhaseErrorStdDevNs=aluIntervalPhaseErrorStdDevNs, tmnxPortEtherNwAggRateLimit=tmnxPortEtherNwAggRateLimit, portShgRowStatus=portShgRowStatus, portShgName=portShgName, tmnxPortNetEgressQueueStatsInProfDroOcts=tmnxPortNetEgressQueueStatsInProfDroOcts, tmnxSASPortV3v0Group=tmnxSASPortV3v0Group, aluMaxShortIntervalMinutes=aluMaxShortIntervalMinutes, tmnxPortNetEgressQueueStatsFwdPkts=tmnxPortNetEgressQueueStatsFwdPkts, tmnxPortNetEgressQueueStatsInProfDroPkts=tmnxPortNetEgressQueueStatsInProfDroPkts, aluIntervalUpdateTime=aluIntervalUpdateTime, aluExtTmnxDS1Entry=aluExtTmnxDS1Entry, aluPortAcrClkStatsShortIntervalTable=aluPortAcrClkStatsShortIntervalTable, tmnxPortEtherDe1OutProfile=tmnxPortEtherDe1OutProfile, tmnxPortStatsQueue7PktsFwd=tmnxPortStatsQueue7PktsFwd, aluLastUpdateTime=aluLastUpdateTime, aluCurrent1MinPhaseErrorStdDevNs=aluCurrent1MinPhaseErrorStdDevNs, aluExtDS1SignalBitsState=aluExtDS1SignalBitsState, aluPortAcrClkStatsEntry=aluPortAcrClkStatsEntry, tmnxPortNetworkQoSPolicyId=tmnxPortNetworkQoSPolicyId, aluTotalMinutesIn24Hour=aluTotalMinutesIn24Hour, aluIntervalFreqOffsetMeanPpb=aluIntervalFreqOffsetMeanPpb, tmnxPortLoopbckSapPortId=tmnxPortLoopbckSapPortId, sasTmnxPortExtnTable=sasTmnxPortExtnTable, aluCurrent1MinValidData=aluCurrent1MinValidData, tmnxPortMonitorOperGrpName=tmnxPortMonitorOperGrpName, tmnxPortEtherClockConfig=tmnxPortEtherClockConfig, tmnxPortEtherEgrSchedMode=tmnxPortEtherEgrSchedMode, tmnxPortNetEgressQueueStatsOutProfDroOcts=tmnxPortNetEgressQueueStatsOutProfDroOcts, tmnxPortEtherNwAggRateLimitPir=tmnxPortEtherNwAggRateLimitPir, tmnxVirtualPortSpeed=tmnxVirtualPortSpeed, aluIntervalFreqOffsetStdDevPpb=aluIntervalFreqOffsetStdDevPpb, aluCurrent24HourFreqOffsetMeanPpb=aluCurrent24HourFreqOffsetMeanPpb, tmnxPortEtherIpMTU=tmnxPortEtherIpMTU, tmnxSASPortConformance=tmnxSASPortConformance, tmnxPortAccessEgressQueueStatsFwdOcts=tmnxPortAccessEgressQueueStatsFwdOcts, aluIntervalValidData=aluIntervalValidData, pethPsePortEventInfo=pethPsePortEventInfo, tmnxPortEtherLoopback=tmnxPortEtherLoopback, tmnxPortLoopbckDstMacAddr=tmnxPortLoopbckDstMacAddr, aluCurrent1MinFreqOffsetMeanPpb=aluCurrent1MinFreqOffsetMeanPpb, aluExtPethPsePortEntry=aluExtPethPsePortEntry, aluIntervalPhaseErrorMeanNs=aluIntervalPhaseErrorMeanNs, tmnxVirtualPortPortID=tmnxVirtualPortPortID, aluExtPethPsePortStatusChange=aluExtPethPsePortStatusChange, aluExtTmnxDS1Table=aluExtTmnxDS1Table, aluExtTmnxDS1PortTable=aluExtTmnxDS1PortTable, tmnxPortUseDei=tmnxPortUseDei, aluPortAcrClkStatsGroup=aluPortAcrClkStatsGroup, sasTmnxPortEtherExtnEntry=sasTmnxPortEtherExtnEntry, sasTmnxPortEtherExtnTable=sasTmnxPortEtherExtnTable, tmnxPortNetEgressQueueStatsIndex=tmnxPortNetEgressQueueStatsIndex, tmnxPortEtherMulticastIngress=tmnxPortEtherMulticastIngress, tmnxPortStatsQueue4PktsFwd=tmnxPortStatsQueue4PktsFwd, tmnxPortNetEgressQueueStatsDroOcts=tmnxPortNetEgressQueueStatsDroOcts, tmnxPortStatsQueue3PktsFwd=tmnxPortStatsQueue3PktsFwd, tmnxVirtualPortTable=tmnxVirtualPortTable, tmnxPortStatsQueue6PktsFwd=tmnxPortStatsQueue6PktsFwd, tmnxSASPortObjs=tmnxSASPortObjs, aluTotalShortIntervalMinutes=aluTotalShortIntervalMinutes, aluExtPethPsePortOperStatus=aluExtPethPsePortOperStatus, portShgInfoTable=portShgInfoTable, portShgInstanceId=portShgInstanceId, tmnxSASPortNetIngressFwdInProfOcts=tmnxSASPortNetIngressFwdInProfOcts, portShgInfoEntry=portShgInfoEntry, tmnxPortLoopbckServId=tmnxPortLoopbckServId, aluExtPethPsePortPowerLevel=aluExtPethPsePortPowerLevel, tmnxPortAccessEgressQueueStatsDroOcts=tmnxPortAccessEgressQueueStatsDroOcts, tmnxPortAccessEgressQoSPolicyId=tmnxPortAccessEgressQoSPolicyId, aluCurrent24HourFreqOffsetStdDevPpb=aluCurrent24HourFreqOffsetStdDevPpb, aluExtPethPsePortFaultReason=aluExtPethPsePortFaultReason, tmnxSASPortStatsObjs=tmnxSASPortStatsObjs, PYSNMP_MODULE_ID=tmnxSASPortMIBModule, tmnxPortAccessEgressQueueStatsIndex=tmnxPortAccessEgressQueueStatsIndex, tmnxPortShgName=tmnxPortShgName, aluExtPethPsePortTable=aluExtPethPsePortTable, portShgDescription=portShgDescription, tmnxPortNetEgressQueueStatsFwdOcts=tmnxPortNetEgressQueueStatsFwdOcts, tmnxPortNetEgressQueueStatsTable=tmnxPortNetEgressQueueStatsTable, tmnxSASPortV2v0Group=tmnxSASPortV2v0Group, tmnxPortOperGrpName=tmnxPortOperGrpName, tmnxSASPortGroups=tmnxSASPortGroups, tmnxVirtualPortEntry=tmnxVirtualPortEntry, aluCurrent1MinPhaseErrorMeanPpb=aluCurrent1MinPhaseErrorMeanPpb, tmnxSASPortNotificationObjects=tmnxSASPortNotificationObjects, tmnxSASPortNetIngressFwdOutProfOcts=tmnxSASPortNetIngressFwdOutProfOcts, aluExtDS1PortLineImpedance=aluExtDS1PortLineImpedance, tmnxSASPortCompliances=tmnxSASPortCompliances, tmnxVirtualPortInUse=tmnxVirtualPortInUse, tmnxSASPortV1v1Group=tmnxSASPortV1v1Group, tmnxPortUplinkMode=tmnxPortUplinkMode, tmnxPortAccessEgressQueueStatsFwdPkts=tmnxPortAccessEgressQueueStatsFwdPkts, tmnxSASPortNetIngressMeterIndex=tmnxSASPortNetIngressMeterIndex, tmnxSASPortNetIngressFwdInProfPkts=tmnxSASPortNetIngressFwdInProfPkts, tmnxPortEtherEgressMaxBurst=tmnxPortEtherEgressMaxBurst, aluPortAcrClkStatsTable=aluPortAcrClkStatsTable, tmnxSASPortNetIngressStatsEntry=tmnxSASPortNetIngressStatsEntry, aluCurrent1MinPhaseErrorMeanNs=aluCurrent1MinPhaseErrorMeanNs, portShgLastMgmtChange=portShgLastMgmtChange, tmnxSASPortV1v0Group=tmnxSASPortV1v0Group, tmnxPortEtherNwAggRateLimitCir=tmnxPortEtherNwAggRateLimitCir, tmnxPortAccEgrSapQosMarking=tmnxPortAccEgrSapQosMarking, aluPortAcrClkStatsShortIntervalEntry=aluPortAcrClkStatsShortIntervalEntry, tmnxSASPortV5v0Group=tmnxSASPortV5v0Group, tmnxSASPortNetIngressFwdOutProfPkts=tmnxSASPortNetIngressFwdOutProfPkts, tmnxPortLoopbckSrcMacAddr=tmnxPortLoopbckSrcMacAddr, aluCurrent1MinFreqOffsetStdDevPpb=aluCurrent1MinFreqOffsetStdDevPpb, tmnxPortStatsQueue8PktsFwd=tmnxPortStatsQueue8PktsFwd)
