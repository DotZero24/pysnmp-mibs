...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/adva/F3-EOMPLS-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 11:02:17 2025
...
PerfCounter64, VlanId, CmPmBinAction, VlanPriority, OperationalState, CmPmIntervalType, SecondaryState, AdminState = mibBuilder.importSymbols("CM-COMMON-MIB", "PerfCounter64", "VlanId", "CmPmBinAction", "VlanPriority", "OperationalState", "CmPmIntervalType", "SecondaryState", "AdminState")
neIndex, = mibBuilder.importSymbols("CM-ENTITY-MIB", "neIndex")
cmPrioMapV2PrioMappingCOSEntry, cmEthernetNetPortEntry, cmFlowEntry = mibBuilder.importSymbols("CM-FACILITY-MIB", "cmPrioMapV2PrioMappingCOSEntry", "cmEthernetNetPortEntry", "cmFlowEntry")
...
mibBuilder.exportSymbols("F3-EOMPLS-MIB", f3EoMplsPwTxTunnelExp=f3EoMplsPwTxTunnelExp, f3EoMplsPwStatsTable=f3EoMplsPwStatsTable, f3EoMplsPwOuterTagPriMappingControl=f3EoMplsPwOuterTagPriMappingControl, f3EoMplsPerformance=f3EoMplsPerformance, f3EoMplsPwThresholdValueHi=f3EoMplsPwThresholdValueHi, f3EoMplsGroups=f3EoMplsGroups, f3EoMplsConfigObjects=f3EoMplsConfigObjects, f3EoMplsPwTxVcLabelControl=f3EoMplsPwTxVcLabelControl, f3EoMplsPwTxVcTtl=f3EoMplsPwTxVcTtl, f3EoMplsPwRxVcExp=f3EoMplsPwRxVcExp, f3EoMplsPwDiscoverType=f3EoMplsPwDiscoverType, f3EoMplsPwEntry=f3EoMplsPwEntry, f3EoMplsPwTxTunnelTtl=f3EoMplsPwTxTunnelTtl, f3EoMplsPwOuterStagVlanPri=f3EoMplsPwOuterStagVlanPri, f3EoMplsPwMode=f3EoMplsPwMode, f3EoMplsPwThresholdVariable=f3EoMplsPwThresholdVariable, f3EoMplsPwDestMac=f3EoMplsPwDestMac, f3EoMplsPwEgressInterface=f3EoMplsPwEgressInterface, f3EoMplsPwOuterStagControl=f3EoMplsPwOuterStagControl, f3EoMplsPwRxTunnelTtl=f3EoMplsPwRxTunnelTtl, f3EoMplsPwThresholdTable=f3EoMplsPwThresholdTable, f3EoMplsPwHistoryEntry=f3EoMplsPwHistoryEntry, f3EoMplsPwTable=f3EoMplsPwTable, f3EoMplsPwStatsValid=f3EoMplsPwStatsValid, f3EoMplsConfigGroup=f3EoMplsConfigGroup, f3EoMplsMIB=f3EoMplsMIB, f3NetPortExtEoMplsSrcIp=f3NetPortExtEoMplsSrcIp, f3EoMplsPwIndex=f3EoMplsPwIndex, f3EoMplsPwTxVcLabel=f3EoMplsPwTxVcLabel, f3EoMplsPwRowStatus=f3EoMplsPwRowStatus, f3EoMplsPwStatsAction=f3EoMplsPwStatsAction, f3EoMplsPwInnerExpMappingControl=f3EoMplsPwInnerExpMappingControl, f3EoMplsPwHistoryAction=f3EoMplsPwHistoryAction, f3EoMplsPwOuterExpMappingControl=f3EoMplsPwOuterExpMappingControl, f3EoMplsPwStatsTtlEqual0Drop=f3EoMplsPwStatsTtlEqual0Drop, f3EoMplsPwOuterStagVlanId=f3EoMplsPwOuterStagVlanId, f3EoMplsPwDestIp=f3EoMplsPwDestIp, f3EoMplsNotifications=f3EoMplsNotifications, f3PrioMapV2PrioMappingCosInnerMplsExp=f3PrioMapV2PrioMappingCosInnerMplsExp, f3EoMplsPwStorageType=f3EoMplsPwStorageType, f3EoMplsPwStatsIntervalType=f3EoMplsPwStatsIntervalType, f3PrioMapV2PrioMappingCosExtEoMplsEntry=f3PrioMapV2PrioMappingCosExtEoMplsEntry, f3PrioMapV2PrioMappingCosOuterMplsExp=f3PrioMapV2PrioMappingCosOuterMplsExp, f3EoMplsPwThresholdIndex=f3EoMplsPwThresholdIndex, f3EoMplsPwThresholdInterval=f3EoMplsPwThresholdInterval, f3EoMplsCompliances=f3EoMplsCompliances, f3EoMplsConformance=f3EoMplsConformance, f3NetPortExtEoMplsEntry=f3NetPortExtEoMplsEntry, f3EoMplsPwThresholdMonValue=f3EoMplsPwThresholdMonValue, f3EoMplsPwAdminState=f3EoMplsPwAdminState, f3EoMplsPwRxTunnelExp=f3EoMplsPwRxTunnelExp, PYSNMP_MODULE_ID=f3EoMplsMIB, f3EoMplsPwTxTunnelLabel=f3EoMplsPwTxTunnelLabel, f3EoMplsPwRxTunnelLabel=f3EoMplsPwRxTunnelLabel, EoMplsMode=EoMplsMode, f3EoMplsPwThresholdEntry=f3EoMplsPwThresholdEntry, f3EoMplsPwRxVcLabel=f3EoMplsPwRxVcLabel, f3PrioMapV2PrioMappingCosExtEoMplsTable=f3PrioMapV2PrioMappingCosExtEoMplsTable, f3EoMplsPwThresholdValueLo=f3EoMplsPwThresholdValueLo, f3NetPortExtEoMplsTable=f3NetPortExtEoMplsTable, f3EoMplsPwHistoryIndex=f3EoMplsPwHistoryIndex, f3EoMplsPwHistoryTtlEqual0Drop=f3EoMplsPwHistoryTtlEqual0Drop, f3EoMplsPwHistoryTable=f3EoMplsPwHistoryTable, f3EoMplsPwRxVcTtl=f3EoMplsPwRxVcTtl, f3EoMplsPwHistoryValid=f3EoMplsPwHistoryValid, f3EoMplsPwTxVcExp=f3EoMplsPwTxVcExp, f3EoMplsCompliance=f3EoMplsCompliance, f3EoMplsPwStatsIndex=f3EoMplsPwStatsIndex, f3EoMplsPwRxVcLabelControl=f3EoMplsPwRxVcLabelControl, f3EoMplsPwOperationalState=f3EoMplsPwOperationalState, f3EoMplsPwStatsEntry=f3EoMplsPwStatsEntry, f3EoMplsPwSecondaryState=f3EoMplsPwSecondaryState, EoMplsDiscoveryType=EoMplsDiscoveryType, f3EoMplsPwThresholdCrossingAlert=f3EoMplsPwThresholdCrossingAlert, f3EoMplsPwHistoryTime=f3EoMplsPwHistoryTime)
