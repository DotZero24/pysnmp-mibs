# SNMP MIB module (LANCOM-LOGGING-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-LOGGING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:20:58 2025
...
agentLogInMemoryAdminStatus = _AgentLogInMemoryAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 1, 1),
...
agentLogInMemoryBehavior = _AgentLogInMemoryBehavior_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 1, 4),
...
agentLogConsoleAdminStatus = _AgentLogConsoleAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 2, 1),
...
agentLogConsoleSeverityFilter = _AgentLogConsoleSeverityFilter_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 2, 2),
...
agentLogPersistentAdminStatus = _AgentLogPersistentAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 3, 1),
...
agentLogPersistentSeverityFilter = _AgentLogPersistentSeverityFilter_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 3, 2),
...
agentLogPersistentLogFiles = _AgentLogPersistentLogFiles_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 3, 3),
    _AgentLogPersistentLogFiles_Type()
)
agentLogPersistentLogFiles.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agentLogPersistentLogFiles.setStatus("current")
...
agentLogSyslogAdminStatus = _AgentLogSyslogAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 1),
...
agentLogSyslogLocalPort = _AgentLogSyslogLocalPort_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 3),
...
agentLogSyslogMaxHosts = _AgentLogSyslogMaxHosts_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 4),
...
agentLogSyslogHostTable = _AgentLogSyslogHostTable_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5)
)
if mibBuilder.loadTexts:
...
agentLogSyslogHostEntry = _AgentLogSyslogHostEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1)
)
agentLogSyslogHostEntry.setIndexNames(
    (0, "LANCOM-LOGGING-MIB", "agentLogHostTableIndex"),
)
if mibBuilder.loadTexts:
...
agentLogHostTableIndex = _AgentLogHostTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1, 1),
...
agentLogHostTableIpAddressType = _AgentLogHostTableIpAddressType_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1, 2),
...
agentLogHostTableIpAddress = _AgentLogHostTableIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1, 3),
...
agentLogHostTablePort = _AgentLogHostTablePort_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1, 4),
...
agentLogHostTableSeverityFilter = _AgentLogHostTableSeverityFilter_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1, 5),
...
agentLogHostTableRowStatus = _AgentLogHostTableRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1, 7),
...
class _AgentLogHostTableTlsTransportMode_Type(Integer32):
    """Custom type agentLogHostTableTlsTransportMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AgentLogHostTableTlsTransportMode_Type.__name__ = "Integer32"
_AgentLogHostTableTlsTransportMode_Object = MibTableColumn
agentLogHostTableTlsTransportMode = _AgentLogHostTableTlsTransportMode_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1, 8),
    _AgentLogHostTableTlsTransportMode_Type()
)
agentLogHostTableTlsTransportMode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentLogHostTableTlsTransportMode.setStatus("current")


class _AgentLogHostTableTlsAuthenticationMode_Type(Integer32):
    """Custom type agentLogHostTableTlsAuthenticationMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentLogHostTableTlsAuthenticationMode_Type.__name__ = "Integer32"
_AgentLogHostTableTlsAuthenticationMode_Object = MibTableColumn
agentLogHostTableTlsAuthenticationMode = _AgentLogHostTableTlsAuthenticationMode_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1, 9),
    _AgentLogHostTableTlsAuthenticationMode_Type()
)
agentLogHostTableTlsAuthenticationMode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentLogHostTableTlsAuthenticationMode.setStatus("current")


class _AgentLogHostTableX509CertNum_Type(Unsigned32):
    """Custom type agentLogHostTableX509CertNum based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgentLogHostTableX509CertNum_Type.__name__ = "Unsigned32"
_AgentLogHostTableX509CertNum_Object = MibTableColumn
agentLogHostTableX509CertNum = _AgentLogHostTableX509CertNum_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 5, 1, 10),
    _AgentLogHostTableX509CertNum_Type()
)
agentLogHostTableX509CertNum.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentLogHostTableX509CertNum.setStatus("current")
...
agentLogSyslogSourceInterface = _AgentLogSyslogSourceInterface_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 6),
...
class _AgentLogSyslogServicePortSrcInterface_Type(Integer32):
    """Custom type agentLogSyslogServicePortSrcInterface based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentLogSyslogServicePortSrcInterface_Type.__name__ = "Integer32"
_AgentLogSyslogServicePortSrcInterface_Object = MibScalar
agentLogSyslogServicePortSrcInterface = _AgentLogSyslogServicePortSrcInterface_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 7),
    _AgentLogSyslogServicePortSrcInterface_Type()
)
agentLogSyslogServicePortSrcInterface.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentLogSyslogServicePortSrcInterface.setStatus("current")


class _AgentLogProtocolVersion_Type(Integer32):
    """Custom type agentLogProtocolVersion based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AgentLogProtocolVersion_Type.__name__ = "Integer32"
_AgentLogProtocolVersion_Object = MibScalar
agentLogProtocolVersion = _AgentLogProtocolVersion_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 4, 8),
    _AgentLogProtocolVersion_Type()
)
agentLogProtocolVersion.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentLogProtocolVersion.setStatus("current")
...
agentLogCliCommandsAdminStatus = _AgentLogCliCommandsAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 5, 1),
...
agentLogEmailAdminStatus = _AgentLogEmailAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 1),
...
agentLogEmailfromAddr = _AgentLogEmailfromAddr_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 2),
...
agentLogEmaillogDuration = _AgentLogEmaillogDuration_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 3),
...
agentLogEmailUrgentSeverity = _AgentLogEmailUrgentSeverity_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 4),
...
agentLogEmailNonUrgentSeverity = _AgentLogEmailNonUrgentSeverity_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 5),
...
agentLogEmailToAddrTable = _AgentLogEmailToAddrTable_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 7)
)
if mibBuilder.loadTexts:
...
agentLogEmailToAddrEntry = _AgentLogEmailToAddrEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 7, 1)
)
agentLogEmailToAddrEntry.setIndexNames(
    (0, "LANCOM-LOGGING-MIB", "agentLogEmailToAddrMessageType"),
    (0, "LANCOM-LOGGING-MIB", "agentLogEmailToAddr"),
)
if mibBuilder.loadTexts:
...
agentLogEmailToAddrMessageType = _AgentLogEmailToAddrMessageType_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 7, 1, 1),
...
agentLogEmailToAddr = _AgentLogEmailToAddr_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 7, 1, 2),
...
agentLogEmailToAddrEntryStatus = _AgentLogEmailToAddrEntryStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 7, 1, 3),
...
agentLogEmailSubjectTable = _AgentLogEmailSubjectTable_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 8)
)
if mibBuilder.loadTexts:
...
agentLogEmailSubjectEntry = _AgentLogEmailSubjectEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 8, 1)
)
agentLogEmailSubjectEntry.setIndexNames(
    (0, "LANCOM-LOGGING-MIB", "agentLogEmailSubjectMessageType"),
)
if mibBuilder.loadTexts:
...
agentLogEmailSubjectMessageType = _AgentLogEmailSubjectMessageType_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 8, 1, 1),
...
agentLogEmailSubject = _AgentLogEmailSubject_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 8, 1, 2),
...
agentLogEmailSubjectEntryStatus = _AgentLogEmailSubjectEntryStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 8, 1, 3),
...
agentLogEmailMailServerTable = _AgentLogEmailMailServerTable_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 9)
)
if mibBuilder.loadTexts:
...
agentLogEmailMailServerEntry = _AgentLogEmailMailServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 9, 1)
)
agentLogEmailMailServerEntry.setIndexNames(
    (0, "LANCOM-LOGGING-MIB", "agentLogEmailSmtpAddrType"),
    (0, "LANCOM-LOGGING-MIB", "agentLogEmailSmtpAddr"),
)
if mibBuilder.loadTexts:
...
agentLogEmailSmtpAddrType = _AgentLogEmailSmtpAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 9, 1, 1),
...
agentLogEmailSmtpAddr = _AgentLogEmailSmtpAddr_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 9, 1, 2),
...
agentLogEmailSmtpPort = _AgentLogEmailSmtpPort_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 9, 1, 3),
...
agentLogEmailSecurity = _AgentLogEmailSecurity_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 9, 1, 4),
...
agentLogEmailloginID = _AgentLogEmailloginID_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 9, 1, 5),
...
agentLogEmailPassword = _AgentLogEmailPassword_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 9, 1, 6),
...
agentLogEmailEntryStatus = _AgentLogEmailEntryStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 9, 1, 7),
...
agentLogEmailMailServerTableEx = _AgentLogEmailMailServerTableEx_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 150)
)
if mibBuilder.loadTexts:
    agentLogEmailMailServerTableEx.setStatus("current")
_AgentLogEmailMailServerExEntry_Object = MibTableRow
agentLogEmailMailServerExEntry = _AgentLogEmailMailServerExEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 150, 1)
)
agentLogEmailMailServerExEntry.setIndexNames(
    (0, "LANCOM-LOGGING-MIB", "agentLogEmailSmtpAddrAscii"),
)
if mibBuilder.loadTexts:
    agentLogEmailMailServerExEntry.setStatus("current")
_AgentLogEmailSmtpAddrAscii_Type = DisplayString
_AgentLogEmailSmtpAddrAscii_Object = MibTableColumn
agentLogEmailSmtpAddrAscii = _AgentLogEmailSmtpAddrAscii_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 150, 1, 1),
    _AgentLogEmailSmtpAddrAscii_Type()
)
agentLogEmailSmtpAddrAscii.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agentLogEmailSmtpAddrAscii.setStatus("current")
_AgentLogEmailSmtpPortEx_Type = InetPortNumber
_AgentLogEmailSmtpPortEx_Object = MibTableColumn
agentLogEmailSmtpPortEx = _AgentLogEmailSmtpPortEx_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 150, 1, 3),
    _AgentLogEmailSmtpPortEx_Type()
)
agentLogEmailSmtpPortEx.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentLogEmailSmtpPortEx.setStatus("current")


class _AgentLogEmailSecurityEx_Type(Integer32):
    """Custom type agentLogEmailSecurityEx based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgentLogEmailSecurityEx_Type.__name__ = "Integer32"
_AgentLogEmailSecurityEx_Object = MibTableColumn
agentLogEmailSecurityEx = _AgentLogEmailSecurityEx_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 150, 1, 4),
    _AgentLogEmailSecurityEx_Type()
)
agentLogEmailSecurityEx.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentLogEmailSecurityEx.setStatus("current")
_AgentLogEmailloginIDEx_Type = DisplayString
_AgentLogEmailloginIDEx_Object = MibTableColumn
agentLogEmailloginIDEx = _AgentLogEmailloginIDEx_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 150, 1, 5),
    _AgentLogEmailloginIDEx_Type()
)
agentLogEmailloginIDEx.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentLogEmailloginIDEx.setStatus("current")
_AgentLogEmailPasswordEx_Type = DisplayString
_AgentLogEmailPasswordEx_Object = MibTableColumn
agentLogEmailPasswordEx = _AgentLogEmailPasswordEx_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 150, 1, 6),
    _AgentLogEmailPasswordEx_Type()
)
agentLogEmailPasswordEx.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentLogEmailPasswordEx.setStatus("current")
_AgentLogEmailEntryStatusEx_Type = RowStatus
_AgentLogEmailEntryStatusEx_Object = MibTableColumn
agentLogEmailEntryStatusEx = _AgentLogEmailEntryStatusEx_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 6, 150, 1, 7),
    _AgentLogEmailEntryStatusEx_Type()
)
agentLogEmailEntryStatusEx.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agentLogEmailEntryStatusEx.setStatus("current")
_AgentLogWebConfigGroup_ObjectIdentity = ObjectIdentity
agentLogWebConfigGroup = _AgentLogWebConfigGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 7)
)
...
agentLogWebAdminStatus = _AgentLogWebAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 7, 1),
...
agentLogSnmpAdminStatus = _AgentLogSnmpAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 8, 1),
...
agentLogAuditAdminStatus = _AgentLogAuditAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 1, 9, 1),
...
agentLogEmailStatsemailsSentCount = _AgentLogEmailStatsemailsSentCount_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 2, 7, 1),
...
agentLogEmailStatsemailsFailureCount = _AgentLogEmailStatsemailsFailureCount_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 2, 7, 2),
...
agentLogEmailStatsTimeSinceLastEmailSent = _AgentLogEmailStatsTimeSinceLastEmailSent_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 2, 7, 3),
...
agentLogEmailStatsClear = _AgentLogEmailStatsClear_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 2, 7, 4),
...
agentLogInMemoryEntry = _AgentLogInMemoryEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 3, 2, 1)
)
agentLogInMemoryEntry.setIndexNames(
    (0, "LANCOM-LOGGING-MIB", "agentLogInMemoryMsgIndex"),
)
if mibBuilder.loadTexts:
...
agentLogInMemoryMsgIndex = _AgentLogInMemoryMsgIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 3, 2, 1, 1),
...
agentLogInMemoryMsgText = _AgentLogInMemoryMsgText_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 3, 2, 1, 2),
...
agentLogPersistentEntry = _AgentLogPersistentEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 4, 4, 1)
)
agentLogPersistentEntry.setIndexNames(
    (0, "LANCOM-LOGGING-MIB", "agentLogMsgPersistentMsgIndex"),
)
if mibBuilder.loadTexts:
...
agentLogMsgPersistentMsgIndex = _AgentLogMsgPersistentMsgIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 4, 4, 1, 1),
...
agentLogMsgPersistentMsgText = _AgentLogMsgPersistentMsgText_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 4, 4, 1, 2),
...
agentLogEmailSendFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 14, 5, 1, 1)
)
agentLogEmailSendFailed.setObjects(
    ("LANCOM-LOGGING-MIB", "agentLogEmailStatsemailsFailureCount")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"AgentLogFacility": AgentLogFacility,
       ...
       "agentLogPersistentLogFiles": agentLogPersistentLogFiles,
       ...
       "agentLogHostTableTlsTransportMode": agentLogHostTableTlsTransportMode,
       "agentLogHostTableTlsAuthenticationMode": agentLogHostTableTlsAuthenticationMode,
       "agentLogHostTableX509CertNum": agentLogHostTableX509CertNum,
       "agentLogSyslogSourceInterface": agentLogSyslogSourceInterface,
       "agentLogSyslogServicePortSrcInterface": agentLogSyslogServicePortSrcInterface,
       "agentLogProtocolVersion": agentLogProtocolVersion,
       ...
       "agentLogEmailMailServerTableEx": agentLogEmailMailServerTableEx,
       "agentLogEmailMailServerExEntry": agentLogEmailMailServerExEntry,
       "agentLogEmailSmtpAddrAscii": agentLogEmailSmtpAddrAscii,
       "agentLogEmailSmtpPortEx": agentLogEmailSmtpPortEx,
       "agentLogEmailSecurityEx": agentLogEmailSecurityEx,
       "agentLogEmailloginIDEx": agentLogEmailloginIDEx,
       "agentLogEmailPasswordEx": agentLogEmailPasswordEx,
       "agentLogEmailEntryStatusEx": agentLogEmailEntryStatusEx,
