...
mibBuilder.exportSymbols("LJ3015-MIB", error44=error44, error46_date_time=error46_date_time, error7_time_stamp=error7_time_stamp, total_mono_page_count=total_mono_page_count, error34_code=error34_code, error74=error74, control_panel_display=control_panel_display, printed_media_simplex_count=printed_media_simplex_count, default_lines_per_page=default_lines_per_page, held_job_control=held_job_control, held_job_security=held_job_security, error66=error66, error46=error46, consumables_1=consumables_1, destination_bin_usage_count=destination_bin_usage_count, fw_rom_revision=fw_rom_revision, error64_time_stamp=error64_time_stamp, error2_string=error2_string, error16_time_stamp=error16_time_stamp, error20=error20, error2_date_time=error2_date_time, error32_string=error32_string, fw_rom_datecode=fw_rom_datecode, error63_code=error63_code, job_info_attr_13=job_info_attr_13, settings_job=settings_job, error19_date_time=error19_date_time, error82=error82, error76_string=error76_string, error73_date_time=error73_date_time, error15_code=error15_code, simm1_bank2_capacity=simm1_bank2_capacity, job_info_size=job_info_size, mio1_manufacturing_info=mio1_manufacturing_info, autocleaning_page_enable=autocleaning_page_enable, error32=error32, error83_code=error83_code, firmware_download_write_status_supported=firmware_download_write_status_supported, held_job_delete=held_job_delete, errorlog=errorlog, settings_io=settings_io, error9_string=error9_string, printed_media_dimplex_count=printed_media_dimplex_count, error58_time_stamp=error58_time_stamp, error38_time_stamp=error38_time_stamp, error63_time_stamp=error63_time_stamp, error66_code=error66_code, accounting=accounting, error4=error4, error33_time_stamp=error33_time_stamp, error87_code=error87_code, custom_paper_feed_dim=custom_paper_feed_dim, print_meter=print_meter, error11_string=error11_string, printer_accounting=printer_accounting, error44_time_stamp=error44_time_stamp, error9=error9, error78=error78, destination_bin_accounting=destination_bin_accounting, job_info_requested_originals=job_info_requested_originals, rtc_time_zone=rtc_time_zone, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, error48_time_stamp=error48_time_stamp, consumable_string=consumable_string, error52_time_stamp=error52_time_stamp, error71_code=error71_code, tray5_media_size_loaded=tray5_media_size_loaded, device=device, pml=pml, error69_time_stamp=error69_time_stamp, consumable_last_pixels_printed_for_iso_page=consumable_last_pixels_printed_for_iso_page, marking_agent_density=marking_agent_density, error69=error69, error85_time_stamp=error85_time_stamp, error52=error52, error47=error47, finisher_image_rotation=finisher_image_rotation, usage_instructions_line3=usage_instructions_line3, error75=error75, job_info_attr_10=job_info_attr_10, default_horizontal_black_resolution=default_horizontal_black_resolution, simm2_bank2=simm2_bank2, printed_media_combined_duplex_count=printed_media_combined_duplex_count, error88_time_stamp=error88_time_stamp, error40=error40, web_server=web_server, source_subsystem=source_subsystem, error4_date_time=error4_date_time, error62_time_stamp=error62_time_stamp, error5_date_time=error5_date_time, error56_time_stamp=error56_time_stamp, error39_time_stamp=error39_time_stamp, automatic_daylight_savings=automatic_daylight_savings, error15=error15, error23_time_stamp=error23_time_stamp, tray5_phd=tray5_phd, job_info_attr_15=job_info_attr_15, error42_string=error42_string, error81=error81, error21_code=error21_code, error24_code=error24_code, error39_date_time=error39_date_time, error84_code=error84_code, held_job_pin=held_job_pin, background_status_msg_line1_part1=background_status_msg_line1_part1, form_feed_needed=form_feed_needed, job_info_attr_8=job_info_attr_8, error29_time_stamp=error29_time_stamp, error89_date_time=error89_date_time, error79_string=error79_string, tray3_phd=tray3_phd, error18_code=error18_code, upgradable_devices=upgradable_devices, error41_time_stamp=error41_time_stamp, error52_string=error52_string, printed_media_simplex_charge=printed_media_simplex_charge, tray_prompt=tray_prompt, error14_code=error14_code, date_display=date_display, error83_time_stamp=error83_time_stamp, error50_date_time=error50_date_time, error33_string=error33_string, error55_time_stamp=error55_time_stamp, destination_subsystem=destination_subsystem, error12_code=error12_code, start_engine_early_warmup=start_engine_early_warmup, error1_code=error1_code, daylight_savings_start=daylight_savings_start, error47_date_time=error47_date_time, ews_request_control_panel_supplies_status=ews_request_control_panel_supplies_status, on_off_line=on_off_line, error5=error5, error60=error60, job_info_accounting_black_dots=job_info_accounting_black_dots, error21=error21, error48=error48, error5_time_stamp=error5_time_stamp, error30_time_stamp=error30_time_stamp, intray1=intray1, job_info_outcome=job_info_outcome, error26=error26, model_name=model_name, error8_date_time=error8_date_time, job_info_attr_5=job_info_attr_5, consumables_life=consumables_life, source_tray_usage_total=source_tray_usage_total, error57=error57, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, printed_media_duplex_charge=printed_media_duplex_charge, error33_code=error33_code, error74_code=error74_code, mass_storage_resource_changed=mass_storage_resource_changed, usb_vendor_id=usb_vendor_id, overflow_bin=overflow_bin, auto_continue=auto_continue, webserver_proc_sub=webserver_proc_sub, printed_media_combined_simplex_total=printed_media_combined_simplex_total, error80_date_time=error80_date_time, pcl_default_font_number=pcl_default_font_number, error79=error79, error16_string=error16_string, settings_print_media=settings_print_media, consumable_status_tls_max_value=consumable_status_tls_max_value, error57_string=error57_string, usb_product_description=usb_product_description, error36_date_time=error36_date_time, error10_code=error10_code, error83=error83, error53_time_stamp=error53_time_stamp, form_feed=form_feed, hold_job_timeout=hold_job_timeout, simm2_capacity=simm2_capacity, error86_time_stamp=error86_time_stamp, error21_time_stamp=error21_time_stamp, os_execute_file=os_execute_file, pdf_print_errors=pdf_print_errors, consumable_pages_printed_with_supply=consumable_pages_printed_with_supply, error79_code=error79_code, pcl_default_font_source=pcl_default_font_source, job_info=job_info, error76_date_time=error76_date_time, error65_time_stamp=error65_time_stamp, mio4=mio4, device_name=device_name, cartridge_adaptive_gain=cartridge_adaptive_gain, error11=error11, error28_time_stamp=error28_time_stamp, error37_code=error37_code, consumable_status_web_service_access_data=consumable_status_web_service_access_data, error30_string=error30_string, error82_time_stamp=error82_time_stamp, status_system=status_system, error13=error13, simm2_type=simm2_type, settings_prt_eng=settings_prt_eng, intray3=intray3, error30_date_time=error30_date_time, asset_number=asset_number, error67=error67, settings_web_server=settings_web_server, consumables=consumables, error78_code=error78_code, error57_time_stamp=error57_time_stamp, remote_upgrade_version_checking_enable=remote_upgrade_version_checking_enable, error61=error61, device_configure=device_configure, default_bits_per_pixel=default_bits_per_pixel, mio1_type=mio1_type, error20_time_stamp=error20_time_stamp, error73=error73, error75_string=error75_string, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, device_system=device_system, simm2_bank=simm2_bank, media_modes=media_modes, usage_instructions_line1=usage_instructions_line1, error72=error72, print_media=print_media, error90_time_stamp=error90_time_stamp, postscript_print_errors=postscript_print_errors, error31=error31, error7_string=error7_string, error45_string=error45_string, error51_time_stamp=error51_time_stamp, job_info_name1=job_info_name1, collated_originals_support=collated_originals_support, error44_string=error44_string, error81_code=error81_code, usb_serial_number=usb_serial_number, error45_time_stamp=error45_time_stamp, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, error60_string=error60_string, upgradable_devices_write_time=upgradable_devices_write_time, error54_code=error54_code, error81_date_time=error81_date_time, tray1_media_size_loaded=tray1_media_size_loaded, error35_date_time=error35_date_time, error45_code=error45_code, error74_string=error74_string, error33=error33, error50=error50, job_info_accounting_finishing_options=job_info_accounting_finishing_options, upgradable_devices_name=upgradable_devices_name, pdl_pcl=pdl_pcl, io_timeout=io_timeout, error17=error17, device_configure_printer_parameters=device_configure_printer_parameters, error80_code=error80_code, error51_code=error51_code, error90_code=error90_code, consumable_status=consumable_status, error54_string=error54_string, ports=ports, error84_time_stamp=error84_time_stamp)
mibBuilder.exportSymbols("LJ3015-MIB", job_info_accounting_media_size=job_info_accounting_media_size, error41_code=error41_code, id=id, simm2=simm2, error18_time_stamp=error18_time_stamp, error67_code=error67_code, duplex_blank_pages=duplex_blank_pages, autocleaning_page_frequency=autocleaning_page_frequency, error85_code=error85_code, intrays=intrays, job_info_change_id=job_info_change_id, channel=channel, port1_parallel_speed=port1_parallel_speed, error54=error54, error26_code=error26_code, localization_countries_supported=localization_countries_supported, job_info_attr_12=job_info_attr_12, error10=error10, error38_string=error38_string, status_mass_storage_bd=status_mass_storage_bd, pcl_default_font_height=pcl_default_font_height, reprint=reprint, firmware_download_name=firmware_download_name, control_panel_display_contents_crc=control_panel_display_contents_crc, error31_time_stamp=error31_time_stamp, error19_time_stamp=error19_time_stamp, error83_string=error83_string, error16_code=error16_code, error55_code=error55_code, supply_after_out_state=supply_after_out_state, error60_date_time=error60_date_time, error89=error89, error30=error30, resource_manager=resource_manager, error23_date_time=error23_date_time, error49_code=error49_code, error83_date_time=error83_date_time, current_job_parsing_id=current_job_parsing_id, usb_host_supported=usb_host_supported, error22_code=error22_code, error75_code=error75_code, held_job=held_job, settings_intray=settings_intray, error37_date_time=error37_date_time, system_contact=system_contact, postscript_total_page_count=postscript_total_page_count, error28_string=error28_string, error16_date_time=error16_date_time, error87_date_time=error87_date_time, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, consumable_life_usage_units=consumable_life_usage_units, error44_code=error44_code, error59_code=error59_code, error82_date_time=error82_date_time, job_info_page_count_current_original=job_info_page_count_current_original, error34_time_stamp=error34_time_stamp, error80=error80, job_info_name2=job_info_name2, error28_code=error28_code, error82_string=error82_string, error65_date_time=error65_date_time, enable_engine_early_warmup=enable_engine_early_warmup, error69_string=error69_string, remote_upgrade_enable=remote_upgrade_enable, error7=error7, error67_time_stamp=error67_time_stamp, error28_date_time=error28_date_time, error62=error62, usb_driver_name=usb_driver_name, rpc_bind_protocol_address=rpc_bind_protocol_address, error69_code=error69_code, error39_code=error39_code, error68_code=error68_code, consumable_reorder_url=consumable_reorder_url, error34_string=error34_string, ph=ph, error57_date_time=error57_date_time, error36=error36, error37_time_stamp=error37_time_stamp, error74_time_stamp=error74_time_stamp, localization_languages_supported=localization_languages_supported, simm1_bank2_type=simm1_bank2_type, port1=port1, error25_time_stamp=error25_time_stamp, perm_store_init_occurred=perm_store_init_occurred, error87_string=error87_string, error43_date_time=error43_date_time, error25_string=error25_string, mio4_type=mio4_type, error1=error1, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, service_id=service_id, error19_string=error19_string, error42_date_time=error42_date_time, error23_string=error23_string, error38_code=error38_code, held_job_retention=held_job_retention, error46_code=error46_code, error85=error85, non_assured_oht_page_count=non_assured_oht_page_count, channelnumberofchannels=channelnumberofchannels, job_input_auto_continue_mode=job_input_auto_continue_mode, error29_string=error29_string, print_density=print_density, error76=error76, usb_manufacturer_name=usb_manufacturer_name, error32_time_stamp=error32_time_stamp, error31_string=error31_string, error8_code=error8_code, error33_date_time=error33_date_time, company_name=company_name, printed_modes_total_count=printed_modes_total_count, time_display=time_display, job_info_physical_outbins_used=job_info_physical_outbins_used, supply_out_device_state=supply_out_device_state, io_switch=io_switch, error80_string=error80_string, error32_code=error32_code, error13_string=error13_string, error41_date_time=error41_date_time, error16=error16, remote_procedure_call=remote_procedure_call, error68_time_stamp=error68_time_stamp, error51_string=error51_string, error77=error77, error24_string=error24_string, error19=error19, error31_date_time=error31_date_time, error76_code=error76_code, supplies_at_very_low_setting=supplies_at_very_low_setting, simm1_type=simm1_type, consumable_status_page_count_b5_executive=consumable_status_page_count_b5_executive, usb_device_kind=usb_device_kind, error35_code=error35_code, tables=tables, error20_string=error20_string, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, job_output_auto_continue_timeout=job_output_auto_continue_timeout, consumable_notification_status=consumable_notification_status, background_message2=background_message2, serial_number=serial_number, error42=error42, file_system_erase_mode=file_system_erase_mode, settings_file_system=settings_file_system, error29_date_time=error29_date_time, job_info_attr_14=job_info_attr_14, consumable_string_information_reset=consumable_string_information_reset, job_info_attr_11=job_info_attr_11, error36_time_stamp=error36_time_stamp, ram_disk_size=ram_disk_size, error50_code=error50_code, error39_string=error39_string, job_being_parsed=job_being_parsed, error58_code=error58_code, held_job_quantity=held_job_quantity, simm1_bank1_type=simm1_bank1_type, error30_code=error30_code, pysmi_continue=pysmi_continue, simm1_bank=simm1_bank, device_configure_quiet_mode_printing=device_configure_quiet_mode_printing, error29=error29, intray5=intray5, error1_string=error1_string, error27_string=error27_string, destination_bin_usage=destination_bin_usage, error59=error59, error43_string=error43_string, upgradable_devices_current_state=upgradable_devices_current_state, settings_ph=settings_ph, error3_string=error3_string, processing_subsystem=processing_subsystem, background_message1=background_message1, settings_rpc=settings_rpc, error86_string=error86_string, pdl_pdf=pdl_pdf, error1_time_stamp=error1_time_stamp, daylight_savings_end=daylight_savings_end, sleep_mode=sleep_mode, spooler=spooler, error8=error8, energy_star=energy_star, error68_string=error68_string, source_tray_usage=source_tray_usage, error11_time_stamp=error11_time_stamp, error24=error24, error25_date_time=error25_date_time, error52_code=error52_code, error66_date_time=error66_date_time, job_info_attr_7=job_info_attr_7, mio=mio, job_info_attribute=job_info_attribute, job_info_pages_in_original=job_info_pages_in_original, error90_date_time=error90_date_time, direct_connect_ports_enable=direct_connect_ports_enable, error50_string=error50_string, pdl_postscript=pdl_postscript, error70=error70, error22=error22, default_vmi=default_vmi, printed_modes_accounting=printed_modes_accounting, file_system3=file_system3, simm1_bank1=simm1_bank1, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, error71_time_stamp=error71_time_stamp, error72_date_time=error72_date_time, simm1=simm1, tray1_phd=tray1_phd, error74_date_time=error74_date_time, error35_string=error35_string, error34_date_time=error34_date_time, error65_code=error65_code, file_systems=file_systems, mass_storage_resource_change_counter=mass_storage_resource_change_counter, error34=error34, file_system3_initialize_volume=file_system3_initialize_volume, error29_code=error29_code, error25_code=error25_code, pcl_total_page_count=pcl_total_page_count, consumable_status_web_service_access_control=consumable_status_web_service_access_control, error17_time_stamp=error17_time_stamp, error85_string=error85_string, error70_time_stamp=error70_time_stamp, error88_string=error88_string, default_vertical_black_resolution=default_vertical_black_resolution, usage_instructions_line4=usage_instructions_line4, error51_date_time=error51_date_time, error24_time_stamp=error24_time_stamp, outbin1_override_mode=outbin1_override_mode, simm=simm, error62_code=error62_code, usage_instructions_line2=usage_instructions_line2, cancel_job=cancel_job, error3_code=error3_code, error50_time_stamp=error50_time_stamp, file_system2_initialize_volume=file_system2_initialize_volume, simm1_bank1_capacity=simm1_bank1_capacity, error53_date_time=error53_date_time, error27_date_time=error27_date_time, settings_outbin=settings_outbin, error85_date_time=error85_date_time, status_pdl=status_pdl, printer_average=printer_average, error53_code=error53_code, engine_media_modes_supported1=engine_media_modes_supported1, job_info_accounting=job_info_accounting, error18_date_time=error18_date_time, job_info_printed_originals=job_info_printed_originals, intray2=intray2, error12_string=error12_string, usage_printer_total_charge=usage_printer_total_charge, error43_code=error43_code, job_info_attr_16=job_info_attr_16, error14_string=error14_string, cartridge_adaptive_gain_reset=cartridge_adaptive_gain_reset)
mibBuilder.exportSymbols("LJ3015-MIB", error10_date_time=error10_date_time, simm2_bank2_type=simm2_bank2_type, custom_paper_xfeed_dim=custom_paper_xfeed_dim, error3=error3, error38_date_time=error38_date_time, tray3_media_size_loaded=tray3_media_size_loaded, ram_disk_mode=ram_disk_mode, error8_time_stamp=error8_time_stamp, error12_time_stamp=error12_time_stamp, error31_code=error31_code, error22_date_time=error22_date_time, error18=error18, rpc_bound_protocol_address=rpc_bound_protocol_address, error36_code=error36_code, error40_date_time=error40_date_time, job_info_io_source=job_info_io_source, error49_time_stamp=error49_time_stamp, error56_string=error56_string, error13_code=error13_code, error9_time_stamp=error9_time_stamp, error40_string=error40_string, error12_date_time=error12_date_time, mass_storage_block_driver=mass_storage_block_driver, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, error89_code=error89_code, error51=error51, error6_date_time=error6_date_time, error15_string=error15_string, error25=error25, error77_string=error77_string, web_server_security=web_server_security, consumable_current_pixels_printed_for_iso_page=consumable_current_pixels_printed_for_iso_page, firmware_download_current_state=firmware_download_current_state, error21_date_time=error21_date_time, file_system_external_access_capabilities=file_system_external_access_capabilities, upgradeable_devices_generic_name=upgradeable_devices_generic_name, display=display, error64=error64, error37_string=error37_string, mio4_model_name=mio4_model_name, default_page_protect=default_page_protect, error2_code=error2_code, error61_time_stamp=error61_time_stamp, error59_time_stamp=error59_time_stamp, error78_date_time=error78_date_time, error76_time_stamp=error76_time_stamp, pcl_default_font_width=pcl_default_font_width, channelprinteralert=channelprinteralert, host_application_available_memory=host_application_available_memory, error_log_clear=error_log_clear, error72_code=error72_code, error14_date_time=error14_date_time, error61_string=error61_string, job_info_attr_9=job_info_attr_9, total_kilo_pixels_per_cartridge=total_kilo_pixels_per_cartridge, error13_time_stamp=error13_time_stamp, error3_date_time=error3_date_time, active_print_jobs=active_print_jobs, error79_date_time=error79_date_time, error45_date_time=error45_date_time, media_counts=media_counts, error18_string=error18_string, ship_cartridge_installed_in_printer=ship_cartridge_installed_in_printer, pdl=pdl, intray=intray, simm1_capacity=simm1_capacity, error44_date_time=error44_date_time, error11_date_time=error11_date_time, error57_code=error57_code, file_system_delete_files=file_system_delete_files, error58_date_time=error58_date_time, error72_time_stamp=error72_time_stamp, error14_time_stamp=error14_time_stamp, simm2_bank1_capacity=simm2_bank1_capacity, printed_modes_usage=printed_modes_usage, error63_date_time=error63_date_time, mio1=mio1, error42_code=error42_code, mass_storage_resources=mass_storage_resources, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, job_info_accounting_media_type=job_info_accounting_media_type, settings_mass_storage_bd=settings_mass_storage_bd, error60_code=error60_code, printed_media_combined_duplex_total=printed_media_combined_duplex_total, settings_webserver=settings_webserver, error9_date_time=error9_date_time, clearable_warning=clearable_warning, error15_date_time=error15_date_time, job_info_stage=job_info_stage, error72_string=error72_string, control_panel_display_graphical_contents=control_panel_display_graphical_contents, error3_time_stamp=error3_time_stamp, input_tray_auto_select=input_tray_auto_select, daylight_savings_reset=daylight_savings_reset, error17_string=error17_string, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, settings_pdl=settings_pdl, error11_code=error11_code, status_rpc=status_rpc, error58=error58, error6_time_stamp=error6_time_stamp, error36_string=error36_string, error66_string=error66_string, error65_string=error65_string, error80_time_stamp=error80_time_stamp, mio1_model_name=mio1_model_name, printed_media_combined_simplex_count=printed_media_combined_simplex_count, menus=menus, error32_date_time=error32_date_time, error43_time_stamp=error43_time_stamp, background_message=background_message, error56_code=error56_code, job_info_attr_1=job_info_attr_1, error89_string=error89_string, error20_date_time=error20_date_time, held_job_info=held_job_info, error67_string=error67_string, outbin1=outbin1, error84_string=error84_string, mio1_ip_address=mio1_ip_address, error55_date_time=error55_date_time, interface=interface, error6_string=error6_string, error47_time_stamp=error47_time_stamp, error5_string=error5_string, control_panel_key_press=control_panel_key_press, destination_bin_usage_total=destination_bin_usage_total, error81_string=error81_string, error73_string=error73_string, device_location=device_location, error70_date_time=error70_date_time, error2=error2, error43=error43, operating_system=operating_system, job_info_pages_printed=job_info_pages_printed, job_info_accounting_job_type=job_info_accounting_job_type, consumable_status_printer_design_compatibility=consumable_status_printer_design_compatibility, error5_code=error5_code, hp=hp, error46_time_stamp=error46_time_stamp, error47_code=error47_code, error37=error37, default_media_size=default_media_size, error6=error6, error53=error53, simm1_bank2=simm1_bank2, error35=error35, file_system4_initialize_volume=file_system4_initialize_volume, file_system2=file_system2, postscript_defer_media=postscript_defer_media, error45=error45, error28=error28, held_job_job_name=held_job_job_name, consumable_current_state=consumable_current_state, upgradable_devices_version=upgradable_devices_version, error47_string=error47_string, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, error23=error23, job_input_auto_continue_timeout=job_input_auto_continue_timeout, error87=error87, tray2_phd=tray2_phd, supply_out_action_support=supply_out_action_support, print_engine_revision=print_engine_revision, north_edge_offset=north_edge_offset, usage_staple_count=usage_staple_count, error71_string=error71_string, error78_time_stamp=error78_time_stamp, install_date=install_date, error48_string=error48_string, error86=error86, error27_code=error27_code, file_system_wipe_disk=file_system_wipe_disk, DisplayString=DisplayString, error62_string=error62_string, firmware_download_version=firmware_download_version, consumable_string_information=consumable_string_information, outbins=outbins, background_status_msg_line2_part1=background_status_msg_line2_part1, mio4_ip_address=mio4_ip_address, error75_date_time=error75_date_time, error84=error84, display_status=display_status, error73_time_stamp=error73_time_stamp, error67_date_time=error67_date_time, default_copies=default_copies, autocleaning_page_size=autocleaning_page_size, error65=error65, job_info_attr_2=job_info_attr_2, error77_date_time=error77_date_time, error15_time_stamp=error15_time_stamp, settings_system=settings_system, error68=error68, error46_string=error46_string, error53_string=error53_string, simm2_bank1=simm2_bank1, error69_date_time=error69_date_time, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, error26_time_stamp=error26_time_stamp, error40_code=error40_code, error86_date_time=error86_date_time, consumable_life_low_threshold=consumable_life_low_threshold, status_prt_eng=status_prt_eng, held_job_user_name=held_job_user_name, error68_date_time=error68_date_time, consumables_status=consumables_status, error55_string=error55_string, error82_code=error82_code, error41_string=error41_string, simm2_bank2_capacity=simm2_bank2_capacity, error88_date_time=error88_date_time, media_sensor_calibration=media_sensor_calibration, error10_string=error10_string, error48_date_time=error48_date_time, held_job_enable=held_job_enable, job_info_attr_3=job_info_attr_3, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, cold_reset_media_size=cold_reset_media_size, error48_code=error48_code, io=io, error49_string=error49_string, error90_string=error90_string, printed_media_duplex_count=printed_media_duplex_count, error9_code=error9_code, error71=error71, printed_media_combined_total=printed_media_combined_total, error77_time_stamp=error77_time_stamp, pjl=pjl, error49_date_time=error49_date_time, error7_date_time=error7_date_time, error73_code=error73_code, error64_string=error64_string, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, usb_interface=usb_interface, error4_string=error4_string, file_system4=file_system4, job=job, error39=error39, error35_time_stamp=error35_time_stamp, error89_time_stamp=error89_time_stamp, maximum_ram_disk_memory=maximum_ram_disk_memory, duplex_page_count=duplex_page_count, error26_string=error26_string, error17_code=error17_code, error54_date_time=error54_date_time, source_tray_accounting=source_tray_accounting, error10_time_stamp=error10_time_stamp, error23_code=error23_code, mio4_manufacturing_info=mio4_manufacturing_info, printed_media_usage=printed_media_usage, error75_time_stamp=error75_time_stamp, error17_date_time=error17_date_time, error8_string=error8_string, job_info_attr_6=job_info_attr_6, error21_string=error21_string)
mibBuilder.exportSymbols("LJ3015-MIB", error14=error14, file_system_max_open_files=file_system_max_open_files, show_address=show_address, marking_agent_density_setting=marking_agent_density_setting, error63=error63, job_info_attr_4=job_info_attr_4, dfa_data_in_nvram=dfa_data_in_nvram, error13_date_time=error13_date_time, error90=error90, error61_date_time=error61_date_time, usb=usb, printed_modes_usage_total=printed_modes_usage_total, error1_date_time=error1_date_time, error22_string=error22_string, error56=error56, error41=error41, error64_code=error64_code, consumable_status_partnumber=consumable_status_partnumber, media_size_count=media_size_count, error60_time_stamp=error60_time_stamp, firmware_download=firmware_download, error59_date_time=error59_date_time, error49=error49, tray2_media_size_loaded=tray2_media_size_loaded, error70_code=error70_code, formatter_serial_number=formatter_serial_number, default_custom_paper_feed_dim=default_custom_paper_feed_dim, error56_date_time=error56_date_time, error78_string=error78_string, daylight_savings_offset=daylight_savings_offset, error52_date_time=error52_date_time, usb_product_id=usb_product_id, error2_time_stamp=error2_time_stamp, error61_code=error61_code, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, error42_time_stamp=error42_time_stamp, error19_code=error19_code, source_tray_usage_count=source_tray_usage_count, error63_string=error63_string, error38=error38, error7_code=error7_code, firmware_download_write_time=firmware_download_write_time, file_system=file_system, error24_date_time=error24_date_time, error27_time_stamp=error27_time_stamp, held_job_set_queue_size=held_job_set_queue_size, error55=error55, port1_parallel_bidirectionality=port1_parallel_bidirectionality, job_info_pages_processed=job_info_pages_processed, background_status_msg_higher_priority=background_status_msg_higher_priority, error4_time_stamp=error4_time_stamp, error84_date_time=error84_date_time, date_and_time=date_and_time, error6_code=error6_code, file_system_wipe_disk_status=file_system_wipe_disk_status, error59_string=error59_string, error20_code=error20_code, error87_time_stamp=error87_time_stamp, error54_time_stamp=error54_time_stamp, error70_string=error70_string, error58_string=error58_string, held_job_print=held_job_print, print_engine=print_engine, mopy_mode=mopy_mode, error62_date_time=error62_date_time, simm2_bank1_type=simm2_bank1_type, error12=error12, error66_time_stamp=error66_time_stamp, error27=error27, model_number=model_number, error40_time_stamp=error40_time_stamp, settings_spooler=settings_spooler, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, outbin=outbin, error77_code=error77_code, error88=error88, error79_time_stamp=error79_time_stamp, media_size=media_size, error4_code=error4_code, error71_date_time=error71_date_time, error26_date_time=error26_date_time, dm=dm, error86_code=error86_code, error64_date_time=error64_date_time, error88_code=error88_code, job_info_outbins_used=job_info_outbins_used, consumable_status_formatter_mono_page_count=consumable_status_formatter_mono_page_count, error81_time_stamp=error81_time_stamp, default_custom_paper_dim_unit=default_custom_paper_dim_unit, job_info_state=job_info_state, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, printed_media_total_charge=printed_media_total_charge, error22_time_stamp=error22_time_stamp, tray_disable_use_instead=tray_disable_use_instead, calibration_power_on_delay=calibration_power_on_delay)
