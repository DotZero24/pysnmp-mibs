# SNMP MIB module (LJ3015-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hp/LJ3015-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:35:54 2025
...
class _Device_configure_quiet_mode_printing_Type(Integer32):
    """Custom type device_configure_quiet_mode_printing based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Device_configure_quiet_mode_printing_Type.__name__ = "Integer32"
_Device_configure_quiet_mode_printing_Object = MibScalar
device_configure_quiet_mode_printing = _Device_configure_quiet_mode_printing_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 1, 32, 15),
    _Device_configure_quiet_mode_printing_Type()
)
device_configure_quiet_mode_printing.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    device_configure_quiet_mode_printing.setStatus("optional")
...
enable_engine_early_warmup.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    ship_cartridge_installed_in_printer.setStatus("optional")
...
class _Dfa_data_in_nvram_Type(Integer32):
    """Custom type dfa_data_in_nvram based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Dfa_data_in_nvram_Type.__name__ = "Integer32"
_Dfa_data_in_nvram_Object = MibScalar
dfa_data_in_nvram = _Dfa_data_in_nvram_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 2, 116),
    _Dfa_data_in_nvram_Type()
)
dfa_data_in_nvram.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dfa_data_in_nvram.setStatus("optional")
...
class _System_contact_Type(OctetString):
    """Custom type system_contact based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_System_contact_Type.__name__ = "OctetString"
...
if mibBuilder.loadTexts:
    system_contact.setStatus("optional")
...
class _Company_name_Type(OctetString):
    """Custom type company_name based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_Company_name_Type.__name__ = "OctetString"
_Company_name_Object = MibScalar
company_name = _Company_name_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 3, 22),
    _Company_name_Type()
)
company_name.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    company_name.setStatus("optional")
...
mio1_ip_address = _Mio1_ip_address_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 3, 1, 6),
    _Mio1_ip_address_Type()
)
mio1_ip_address.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mio1_ip_address.setStatus("optional")
...
mio4_ip_address = _Mio4_ip_address_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 3, 4, 6),
    _Mio4_ip_address_Type()
)
mio4_ip_address.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mio4_ip_address.setStatus("optional")
...
error1_string = _Error1_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 1, 4),
    _Error1_string_Type()
)
error1_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error1_string.setStatus("optional")
...
error2_string = _Error2_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 2, 4),
    _Error2_string_Type()
)
error2_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error2_string.setStatus("optional")
...
error3_string = _Error3_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 3, 4),
    _Error3_string_Type()
)
error3_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error3_string.setStatus("optional")
...
error4_string = _Error4_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 4, 4),
    _Error4_string_Type()
)
error4_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error4_string.setStatus("optional")
...
error5_string = _Error5_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 5, 4),
    _Error5_string_Type()
)
error5_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error5_string.setStatus("optional")
...
error6_string = _Error6_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 6, 4),
    _Error6_string_Type()
)
error6_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error6_string.setStatus("optional")
...
error7_string = _Error7_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 7, 4),
    _Error7_string_Type()
)
error7_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error7_string.setStatus("optional")
...
error8_string = _Error8_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 8, 4),
    _Error8_string_Type()
)
error8_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error8_string.setStatus("optional")
...
error9_string = _Error9_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 9, 4),
    _Error9_string_Type()
)
error9_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error9_string.setStatus("optional")
...
error10_string = _Error10_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 10, 4),
    _Error10_string_Type()
)
error10_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error10_string.setStatus("optional")
...
error11_string = _Error11_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 11, 4),
    _Error11_string_Type()
)
error11_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error11_string.setStatus("optional")
...
error12_string = _Error12_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 12, 4),
    _Error12_string_Type()
)
error12_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error12_string.setStatus("optional")
...
error13_string = _Error13_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 13, 4),
    _Error13_string_Type()
)
error13_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error13_string.setStatus("optional")
...
error14_string = _Error14_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 14, 4),
    _Error14_string_Type()
)
error14_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error14_string.setStatus("optional")
...
error15_string = _Error15_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 15, 4),
    _Error15_string_Type()
)
error15_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error15_string.setStatus("optional")
...
error16_string = _Error16_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 16, 4),
    _Error16_string_Type()
)
error16_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error16_string.setStatus("optional")
...
error17_string = _Error17_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 17, 4),
    _Error17_string_Type()
)
error17_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error17_string.setStatus("optional")
...
error18_string = _Error18_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 18, 4),
    _Error18_string_Type()
)
error18_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error18_string.setStatus("optional")
...
error19_string = _Error19_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 19, 4),
    _Error19_string_Type()
)
error19_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error19_string.setStatus("optional")
...
error20_string = _Error20_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 20, 4),
    _Error20_string_Type()
)
error20_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error20_string.setStatus("optional")
...
error21_string = _Error21_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 21, 4),
    _Error21_string_Type()
)
error21_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error21_string.setStatus("optional")
...
error22_string = _Error22_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 22, 4),
    _Error22_string_Type()
)
error22_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error22_string.setStatus("optional")
...
error23_string = _Error23_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 23, 4),
    _Error23_string_Type()
)
error23_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error23_string.setStatus("optional")
...
error24_string = _Error24_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 24, 4),
    _Error24_string_Type()
)
error24_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error24_string.setStatus("optional")
...
error25_string = _Error25_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 25, 4),
    _Error25_string_Type()
)
error25_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error25_string.setStatus("optional")
...
error26_string = _Error26_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 26, 4),
    _Error26_string_Type()
)
error26_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error26_string.setStatus("optional")
...
error27_string = _Error27_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 27, 4),
    _Error27_string_Type()
)
error27_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error27_string.setStatus("optional")
...
error28_string = _Error28_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 28, 4),
    _Error28_string_Type()
)
error28_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error28_string.setStatus("optional")
...
error29_string = _Error29_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 29, 4),
    _Error29_string_Type()
)
error29_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error29_string.setStatus("optional")
...
error30_string = _Error30_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 30, 4),
    _Error30_string_Type()
)
error30_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error30_string.setStatus("optional")
...
error31_string = _Error31_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 31, 4),
    _Error31_string_Type()
)
error31_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error31_string.setStatus("optional")
...
error32_string = _Error32_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 32, 4),
    _Error32_string_Type()
)
error32_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error32_string.setStatus("optional")
...
error33_string = _Error33_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 33, 4),
    _Error33_string_Type()
)
error33_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error33_string.setStatus("optional")
...
error34_string = _Error34_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 34, 4),
    _Error34_string_Type()
)
error34_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error34_string.setStatus("optional")
...
error35_string = _Error35_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 35, 4),
    _Error35_string_Type()
)
error35_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error35_string.setStatus("optional")
...
error36_string = _Error36_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 36, 4),
    _Error36_string_Type()
)
error36_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error36_string.setStatus("optional")
...
error37_string = _Error37_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 37, 4),
    _Error37_string_Type()
)
error37_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error37_string.setStatus("optional")
...
error38_string = _Error38_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 38, 4),
    _Error38_string_Type()
)
error38_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error38_string.setStatus("optional")
...
error39_string = _Error39_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 39, 4),
    _Error39_string_Type()
)
error39_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error39_string.setStatus("optional")
...
error40_string = _Error40_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 40, 4),
    _Error40_string_Type()
)
error40_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error40_string.setStatus("optional")
...
error41_string = _Error41_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 41, 4),
    _Error41_string_Type()
)
error41_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error41_string.setStatus("optional")
...
error42_string = _Error42_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 42, 4),
    _Error42_string_Type()
)
error42_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error42_string.setStatus("optional")
...
error43_string = _Error43_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 43, 4),
    _Error43_string_Type()
)
error43_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error43_string.setStatus("optional")
...
error44_string = _Error44_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 44, 4),
    _Error44_string_Type()
)
error44_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error44_string.setStatus("optional")
...
error45_string = _Error45_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 45, 4),
    _Error45_string_Type()
)
error45_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error45_string.setStatus("optional")
...
error46_string = _Error46_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 46, 4),
    _Error46_string_Type()
)
error46_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error46_string.setStatus("optional")
...
error47_string = _Error47_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 47, 4),
    _Error47_string_Type()
)
error47_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error47_string.setStatus("optional")
...
error48_string = _Error48_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 48, 4),
    _Error48_string_Type()
)
error48_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error48_string.setStatus("optional")
...
error49_string = _Error49_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 49, 4),
    _Error49_string_Type()
)
error49_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error49_string.setStatus("optional")
...
error50_string = _Error50_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 50, 4),
    _Error50_string_Type()
)
error50_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error50_string.setStatus("optional")
...
error51_time_stamp = _Error51_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 51, 1),
    _Error51_time_stamp_Type()
)
error51_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error51_time_stamp.setStatus("optional")
_Error51_code_Type = Integer32
_Error51_code_Object = MibScalar
error51_code = _Error51_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 51, 2),
    _Error51_code_Type()
)
error51_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error51_code.setStatus("optional")
_Error51_date_time_Type = OctetString
_Error51_date_time_Object = MibScalar
error51_date_time = _Error51_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 51, 3),
    _Error51_date_time_Type()
)
error51_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error51_date_time.setStatus("optional")
_Error51_string_Type = OctetString
_Error51_string_Object = MibScalar
error51_string = _Error51_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 51, 4),
    _Error51_string_Type()
)
error51_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error51_string.setStatus("optional")
...
error52_time_stamp = _Error52_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 52, 1),
    _Error52_time_stamp_Type()
)
error52_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error52_time_stamp.setStatus("optional")
_Error52_code_Type = Integer32
_Error52_code_Object = MibScalar
error52_code = _Error52_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 52, 2),
    _Error52_code_Type()
)
error52_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error52_code.setStatus("optional")
_Error52_date_time_Type = OctetString
_Error52_date_time_Object = MibScalar
error52_date_time = _Error52_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 52, 3),
    _Error52_date_time_Type()
)
error52_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error52_date_time.setStatus("optional")
_Error52_string_Type = OctetString
_Error52_string_Object = MibScalar
error52_string = _Error52_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 52, 4),
    _Error52_string_Type()
)
error52_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error52_string.setStatus("optional")
...
error53_time_stamp = _Error53_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 53, 1),
    _Error53_time_stamp_Type()
)
error53_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error53_time_stamp.setStatus("optional")
_Error53_code_Type = Integer32
_Error53_code_Object = MibScalar
error53_code = _Error53_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 53, 2),
    _Error53_code_Type()
)
error53_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error53_code.setStatus("optional")
_Error53_date_time_Type = OctetString
_Error53_date_time_Object = MibScalar
error53_date_time = _Error53_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 53, 3),
    _Error53_date_time_Type()
)
error53_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error53_date_time.setStatus("optional")
_Error53_string_Type = OctetString
_Error53_string_Object = MibScalar
error53_string = _Error53_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 53, 4),
    _Error53_string_Type()
)
error53_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error53_string.setStatus("optional")
...
error54_time_stamp = _Error54_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 54, 1),
    _Error54_time_stamp_Type()
)
error54_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error54_time_stamp.setStatus("optional")
_Error54_code_Type = Integer32
_Error54_code_Object = MibScalar
error54_code = _Error54_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 54, 2),
    _Error54_code_Type()
)
error54_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error54_code.setStatus("optional")
_Error54_date_time_Type = OctetString
_Error54_date_time_Object = MibScalar
error54_date_time = _Error54_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 54, 3),
    _Error54_date_time_Type()
)
error54_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error54_date_time.setStatus("optional")
_Error54_string_Type = OctetString
_Error54_string_Object = MibScalar
error54_string = _Error54_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 54, 4),
    _Error54_string_Type()
)
error54_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error54_string.setStatus("optional")
...
error55_time_stamp = _Error55_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 55, 1),
    _Error55_time_stamp_Type()
)
error55_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error55_time_stamp.setStatus("optional")
_Error55_code_Type = Integer32
_Error55_code_Object = MibScalar
error55_code = _Error55_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 55, 2),
    _Error55_code_Type()
)
error55_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error55_code.setStatus("optional")
_Error55_date_time_Type = OctetString
_Error55_date_time_Object = MibScalar
error55_date_time = _Error55_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 55, 3),
    _Error55_date_time_Type()
)
error55_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error55_date_time.setStatus("optional")
_Error55_string_Type = OctetString
_Error55_string_Object = MibScalar
error55_string = _Error55_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 55, 4),
    _Error55_string_Type()
)
error55_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error55_string.setStatus("optional")
...
error56_time_stamp = _Error56_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 56, 1),
    _Error56_time_stamp_Type()
)
error56_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error56_time_stamp.setStatus("optional")
_Error56_code_Type = Integer32
_Error56_code_Object = MibScalar
error56_code = _Error56_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 56, 2),
    _Error56_code_Type()
)
error56_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error56_code.setStatus("optional")
_Error56_date_time_Type = OctetString
_Error56_date_time_Object = MibScalar
error56_date_time = _Error56_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 56, 3),
    _Error56_date_time_Type()
)
error56_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error56_date_time.setStatus("optional")
_Error56_string_Type = OctetString
_Error56_string_Object = MibScalar
error56_string = _Error56_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 56, 4),
    _Error56_string_Type()
)
error56_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error56_string.setStatus("optional")
...
error57_time_stamp = _Error57_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 57, 1),
    _Error57_time_stamp_Type()
)
error57_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error57_time_stamp.setStatus("optional")
_Error57_code_Type = Integer32
_Error57_code_Object = MibScalar
error57_code = _Error57_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 57, 2),
    _Error57_code_Type()
)
error57_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error57_code.setStatus("optional")
_Error57_date_time_Type = OctetString
_Error57_date_time_Object = MibScalar
error57_date_time = _Error57_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 57, 3),
    _Error57_date_time_Type()
)
error57_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error57_date_time.setStatus("optional")
_Error57_string_Type = OctetString
_Error57_string_Object = MibScalar
error57_string = _Error57_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 57, 4),
    _Error57_string_Type()
)
error57_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error57_string.setStatus("optional")
...
error58_time_stamp = _Error58_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 58, 1),
    _Error58_time_stamp_Type()
)
error58_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error58_time_stamp.setStatus("optional")
_Error58_code_Type = Integer32
_Error58_code_Object = MibScalar
error58_code = _Error58_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 58, 2),
    _Error58_code_Type()
)
error58_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error58_code.setStatus("optional")
_Error58_date_time_Type = OctetString
_Error58_date_time_Object = MibScalar
error58_date_time = _Error58_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 58, 3),
    _Error58_date_time_Type()
)
error58_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error58_date_time.setStatus("optional")
_Error58_string_Type = OctetString
_Error58_string_Object = MibScalar
error58_string = _Error58_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 58, 4),
    _Error58_string_Type()
)
error58_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error58_string.setStatus("optional")
...
error59_time_stamp = _Error59_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 59, 1),
    _Error59_time_stamp_Type()
)
error59_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error59_time_stamp.setStatus("optional")
_Error59_code_Type = Integer32
_Error59_code_Object = MibScalar
error59_code = _Error59_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 59, 2),
    _Error59_code_Type()
)
error59_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error59_code.setStatus("optional")
_Error59_date_time_Type = OctetString
_Error59_date_time_Object = MibScalar
error59_date_time = _Error59_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 59, 3),
    _Error59_date_time_Type()
)
error59_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error59_date_time.setStatus("optional")
_Error59_string_Type = OctetString
_Error59_string_Object = MibScalar
error59_string = _Error59_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 59, 4),
    _Error59_string_Type()
)
error59_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error59_string.setStatus("optional")
...
error60_time_stamp = _Error60_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 60, 1),
    _Error60_time_stamp_Type()
)
error60_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error60_time_stamp.setStatus("optional")
_Error60_code_Type = Integer32
_Error60_code_Object = MibScalar
error60_code = _Error60_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 60, 2),
    _Error60_code_Type()
)
error60_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error60_code.setStatus("optional")
_Error60_date_time_Type = OctetString
_Error60_date_time_Object = MibScalar
error60_date_time = _Error60_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 60, 3),
    _Error60_date_time_Type()
)
error60_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error60_date_time.setStatus("optional")
_Error60_string_Type = OctetString
_Error60_string_Object = MibScalar
error60_string = _Error60_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 60, 4),
    _Error60_string_Type()
)
error60_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error60_string.setStatus("optional")
...
error61_time_stamp = _Error61_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 61, 1),
    _Error61_time_stamp_Type()
)
error61_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error61_time_stamp.setStatus("optional")
_Error61_code_Type = Integer32
_Error61_code_Object = MibScalar
error61_code = _Error61_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 61, 2),
    _Error61_code_Type()
)
error61_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error61_code.setStatus("optional")
_Error61_date_time_Type = OctetString
_Error61_date_time_Object = MibScalar
error61_date_time = _Error61_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 61, 3),
    _Error61_date_time_Type()
)
error61_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error61_date_time.setStatus("optional")
_Error61_string_Type = OctetString
_Error61_string_Object = MibScalar
error61_string = _Error61_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 61, 4),
    _Error61_string_Type()
)
error61_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error61_string.setStatus("optional")
...
error62_time_stamp = _Error62_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 62, 1),
    _Error62_time_stamp_Type()
)
error62_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error62_time_stamp.setStatus("optional")
_Error62_code_Type = Integer32
_Error62_code_Object = MibScalar
error62_code = _Error62_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 62, 2),
    _Error62_code_Type()
)
error62_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error62_code.setStatus("optional")
_Error62_date_time_Type = OctetString
_Error62_date_time_Object = MibScalar
error62_date_time = _Error62_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 62, 3),
    _Error62_date_time_Type()
)
error62_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error62_date_time.setStatus("optional")
_Error62_string_Type = OctetString
_Error62_string_Object = MibScalar
error62_string = _Error62_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 62, 4),
    _Error62_string_Type()
)
error62_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error62_string.setStatus("optional")
...
error63_time_stamp = _Error63_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 63, 1),
    _Error63_time_stamp_Type()
)
error63_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error63_time_stamp.setStatus("optional")
_Error63_code_Type = Integer32
_Error63_code_Object = MibScalar
error63_code = _Error63_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 63, 2),
    _Error63_code_Type()
)
error63_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error63_code.setStatus("optional")
_Error63_date_time_Type = OctetString
_Error63_date_time_Object = MibScalar
error63_date_time = _Error63_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 63, 3),
    _Error63_date_time_Type()
)
error63_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error63_date_time.setStatus("optional")
_Error63_string_Type = OctetString
_Error63_string_Object = MibScalar
error63_string = _Error63_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 63, 4),
    _Error63_string_Type()
)
error63_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error63_string.setStatus("optional")
...
error64_time_stamp = _Error64_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 64, 1),
    _Error64_time_stamp_Type()
)
error64_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error64_time_stamp.setStatus("optional")
_Error64_code_Type = Integer32
_Error64_code_Object = MibScalar
error64_code = _Error64_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 64, 2),
    _Error64_code_Type()
)
error64_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error64_code.setStatus("optional")
_Error64_date_time_Type = OctetString
_Error64_date_time_Object = MibScalar
error64_date_time = _Error64_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 64, 3),
    _Error64_date_time_Type()
)
error64_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error64_date_time.setStatus("optional")
_Error64_string_Type = OctetString
_Error64_string_Object = MibScalar
error64_string = _Error64_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 64, 4),
    _Error64_string_Type()
)
error64_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error64_string.setStatus("optional")
...
error65_time_stamp = _Error65_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 65, 1),
    _Error65_time_stamp_Type()
)
error65_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error65_time_stamp.setStatus("optional")
_Error65_code_Type = Integer32
_Error65_code_Object = MibScalar
error65_code = _Error65_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 65, 2),
    _Error65_code_Type()
)
error65_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error65_code.setStatus("optional")
_Error65_date_time_Type = OctetString
_Error65_date_time_Object = MibScalar
error65_date_time = _Error65_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 65, 3),
    _Error65_date_time_Type()
)
error65_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error65_date_time.setStatus("optional")
_Error65_string_Type = OctetString
_Error65_string_Object = MibScalar
error65_string = _Error65_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 65, 4),
    _Error65_string_Type()
)
error65_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error65_string.setStatus("optional")
...
error66_time_stamp = _Error66_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 66, 1),
    _Error66_time_stamp_Type()
)
error66_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error66_time_stamp.setStatus("optional")
_Error66_code_Type = Integer32
_Error66_code_Object = MibScalar
error66_code = _Error66_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 66, 2),
    _Error66_code_Type()
)
error66_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error66_code.setStatus("optional")
_Error66_date_time_Type = OctetString
_Error66_date_time_Object = MibScalar
error66_date_time = _Error66_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 66, 3),
    _Error66_date_time_Type()
)
error66_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error66_date_time.setStatus("optional")
_Error66_string_Type = OctetString
_Error66_string_Object = MibScalar
error66_string = _Error66_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 66, 4),
    _Error66_string_Type()
)
error66_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error66_string.setStatus("optional")
...
error67_time_stamp = _Error67_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 67, 1),
    _Error67_time_stamp_Type()
)
error67_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error67_time_stamp.setStatus("optional")
_Error67_code_Type = Integer32
_Error67_code_Object = MibScalar
error67_code = _Error67_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 67, 2),
    _Error67_code_Type()
)
error67_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error67_code.setStatus("optional")
_Error67_date_time_Type = OctetString
_Error67_date_time_Object = MibScalar
error67_date_time = _Error67_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 67, 3),
    _Error67_date_time_Type()
)
error67_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error67_date_time.setStatus("optional")
_Error67_string_Type = OctetString
_Error67_string_Object = MibScalar
error67_string = _Error67_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 67, 4),
    _Error67_string_Type()
)
error67_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error67_string.setStatus("optional")
...
error68_time_stamp = _Error68_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 68, 1),
    _Error68_time_stamp_Type()
)
error68_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error68_time_stamp.setStatus("optional")
_Error68_code_Type = Integer32
_Error68_code_Object = MibScalar
error68_code = _Error68_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 68, 2),
    _Error68_code_Type()
)
error68_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error68_code.setStatus("optional")
_Error68_date_time_Type = OctetString
_Error68_date_time_Object = MibScalar
error68_date_time = _Error68_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 68, 3),
    _Error68_date_time_Type()
)
error68_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error68_date_time.setStatus("optional")
_Error68_string_Type = OctetString
_Error68_string_Object = MibScalar
error68_string = _Error68_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 68, 4),
    _Error68_string_Type()
)
error68_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error68_string.setStatus("optional")
...
error69_time_stamp = _Error69_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 69, 1),
    _Error69_time_stamp_Type()
)
error69_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error69_time_stamp.setStatus("optional")
_Error69_code_Type = Integer32
_Error69_code_Object = MibScalar
error69_code = _Error69_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 69, 2),
    _Error69_code_Type()
)
error69_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error69_code.setStatus("optional")
_Error69_date_time_Type = OctetString
_Error69_date_time_Object = MibScalar
error69_date_time = _Error69_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 69, 3),
    _Error69_date_time_Type()
)
error69_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error69_date_time.setStatus("optional")
_Error69_string_Type = OctetString
_Error69_string_Object = MibScalar
error69_string = _Error69_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 69, 4),
    _Error69_string_Type()
)
error69_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error69_string.setStatus("optional")
...
error70_time_stamp = _Error70_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 70, 1),
    _Error70_time_stamp_Type()
)
error70_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error70_time_stamp.setStatus("optional")
_Error70_code_Type = Integer32
_Error70_code_Object = MibScalar
error70_code = _Error70_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 70, 2),
    _Error70_code_Type()
)
error70_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error70_code.setStatus("optional")
_Error70_date_time_Type = OctetString
_Error70_date_time_Object = MibScalar
error70_date_time = _Error70_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 70, 3),
    _Error70_date_time_Type()
)
error70_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error70_date_time.setStatus("optional")
_Error70_string_Type = OctetString
_Error70_string_Object = MibScalar
error70_string = _Error70_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 70, 4),
    _Error70_string_Type()
)
error70_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error70_string.setStatus("optional")
...
error71_time_stamp = _Error71_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 71, 1),
    _Error71_time_stamp_Type()
)
error71_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error71_time_stamp.setStatus("optional")
_Error71_code_Type = Integer32
_Error71_code_Object = MibScalar
error71_code = _Error71_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 71, 2),
    _Error71_code_Type()
)
error71_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error71_code.setStatus("optional")
_Error71_date_time_Type = OctetString
_Error71_date_time_Object = MibScalar
error71_date_time = _Error71_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 71, 3),
    _Error71_date_time_Type()
)
error71_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error71_date_time.setStatus("optional")
_Error71_string_Type = OctetString
_Error71_string_Object = MibScalar
error71_string = _Error71_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 71, 4),
    _Error71_string_Type()
)
error71_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error71_string.setStatus("optional")
...
error72_time_stamp = _Error72_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 72, 1),
    _Error72_time_stamp_Type()
)
error72_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error72_time_stamp.setStatus("optional")
_Error72_code_Type = Integer32
_Error72_code_Object = MibScalar
error72_code = _Error72_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 72, 2),
    _Error72_code_Type()
)
error72_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error72_code.setStatus("optional")
_Error72_date_time_Type = OctetString
_Error72_date_time_Object = MibScalar
error72_date_time = _Error72_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 72, 3),
    _Error72_date_time_Type()
)
error72_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error72_date_time.setStatus("optional")
_Error72_string_Type = OctetString
_Error72_string_Object = MibScalar
error72_string = _Error72_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 72, 4),
    _Error72_string_Type()
)
error72_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error72_string.setStatus("optional")
...
error73_time_stamp = _Error73_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 73, 1),
    _Error73_time_stamp_Type()
)
error73_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error73_time_stamp.setStatus("optional")
_Error73_code_Type = Integer32
_Error73_code_Object = MibScalar
error73_code = _Error73_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 73, 2),
    _Error73_code_Type()
)
error73_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error73_code.setStatus("optional")
_Error73_date_time_Type = OctetString
_Error73_date_time_Object = MibScalar
error73_date_time = _Error73_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 73, 3),
    _Error73_date_time_Type()
)
error73_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error73_date_time.setStatus("optional")
_Error73_string_Type = OctetString
_Error73_string_Object = MibScalar
error73_string = _Error73_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 73, 4),
    _Error73_string_Type()
)
error73_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error73_string.setStatus("optional")
...
error74_time_stamp = _Error74_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 74, 1),
    _Error74_time_stamp_Type()
)
error74_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error74_time_stamp.setStatus("optional")
_Error74_code_Type = Integer32
_Error74_code_Object = MibScalar
error74_code = _Error74_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 74, 2),
    _Error74_code_Type()
)
error74_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error74_code.setStatus("optional")
_Error74_date_time_Type = OctetString
_Error74_date_time_Object = MibScalar
error74_date_time = _Error74_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 74, 3),
    _Error74_date_time_Type()
)
error74_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error74_date_time.setStatus("optional")
_Error74_string_Type = OctetString
_Error74_string_Object = MibScalar
error74_string = _Error74_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 74, 4),
    _Error74_string_Type()
)
error74_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error74_string.setStatus("optional")
...
error75_time_stamp = _Error75_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 75, 1),
    _Error75_time_stamp_Type()
)
error75_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error75_time_stamp.setStatus("optional")
_Error75_code_Type = Integer32
_Error75_code_Object = MibScalar
error75_code = _Error75_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 75, 2),
    _Error75_code_Type()
)
error75_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error75_code.setStatus("optional")
_Error75_date_time_Type = OctetString
_Error75_date_time_Object = MibScalar
error75_date_time = _Error75_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 75, 3),
    _Error75_date_time_Type()
)
error75_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error75_date_time.setStatus("optional")
_Error75_string_Type = OctetString
_Error75_string_Object = MibScalar
error75_string = _Error75_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 75, 4),
    _Error75_string_Type()
)
error75_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error75_string.setStatus("optional")
...
error76_time_stamp = _Error76_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 76, 1),
    _Error76_time_stamp_Type()
)
error76_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error76_time_stamp.setStatus("optional")
_Error76_code_Type = Integer32
_Error76_code_Object = MibScalar
error76_code = _Error76_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 76, 2),
    _Error76_code_Type()
)
error76_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error76_code.setStatus("optional")
_Error76_date_time_Type = OctetString
_Error76_date_time_Object = MibScalar
error76_date_time = _Error76_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 76, 3),
    _Error76_date_time_Type()
)
error76_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error76_date_time.setStatus("optional")
_Error76_string_Type = OctetString
_Error76_string_Object = MibScalar
error76_string = _Error76_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 76, 4),
    _Error76_string_Type()
)
error76_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error76_string.setStatus("optional")
...
error77_time_stamp = _Error77_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 77, 1),
    _Error77_time_stamp_Type()
)
error77_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error77_time_stamp.setStatus("optional")
_Error77_code_Type = Integer32
_Error77_code_Object = MibScalar
error77_code = _Error77_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 77, 2),
    _Error77_code_Type()
)
error77_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error77_code.setStatus("optional")
_Error77_date_time_Type = OctetString
_Error77_date_time_Object = MibScalar
error77_date_time = _Error77_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 77, 3),
    _Error77_date_time_Type()
)
error77_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error77_date_time.setStatus("optional")
_Error77_string_Type = OctetString
_Error77_string_Object = MibScalar
error77_string = _Error77_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 77, 4),
    _Error77_string_Type()
)
error77_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error77_string.setStatus("optional")
...
error78_time_stamp = _Error78_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 78, 1),
    _Error78_time_stamp_Type()
)
error78_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error78_time_stamp.setStatus("optional")
_Error78_code_Type = Integer32
_Error78_code_Object = MibScalar
error78_code = _Error78_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 78, 2),
    _Error78_code_Type()
)
error78_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error78_code.setStatus("optional")
_Error78_date_time_Type = OctetString
_Error78_date_time_Object = MibScalar
error78_date_time = _Error78_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 78, 3),
    _Error78_date_time_Type()
)
error78_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error78_date_time.setStatus("optional")
_Error78_string_Type = OctetString
_Error78_string_Object = MibScalar
error78_string = _Error78_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 78, 4),
    _Error78_string_Type()
)
error78_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error78_string.setStatus("optional")
...
error79_time_stamp = _Error79_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 79, 1),
    _Error79_time_stamp_Type()
)
error79_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error79_time_stamp.setStatus("optional")
_Error79_code_Type = Integer32
_Error79_code_Object = MibScalar
error79_code = _Error79_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 79, 2),
    _Error79_code_Type()
)
error79_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error79_code.setStatus("optional")
_Error79_date_time_Type = OctetString
_Error79_date_time_Object = MibScalar
error79_date_time = _Error79_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 79, 3),
    _Error79_date_time_Type()
)
error79_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error79_date_time.setStatus("optional")
_Error79_string_Type = OctetString
_Error79_string_Object = MibScalar
error79_string = _Error79_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 79, 4),
    _Error79_string_Type()
)
error79_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error79_string.setStatus("optional")
...
error80_time_stamp = _Error80_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 80, 1),
    _Error80_time_stamp_Type()
)
error80_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error80_time_stamp.setStatus("optional")
_Error80_code_Type = Integer32
_Error80_code_Object = MibScalar
error80_code = _Error80_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 80, 2),
    _Error80_code_Type()
)
error80_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error80_code.setStatus("optional")
_Error80_date_time_Type = OctetString
_Error80_date_time_Object = MibScalar
error80_date_time = _Error80_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 80, 3),
    _Error80_date_time_Type()
)
error80_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error80_date_time.setStatus("optional")
_Error80_string_Type = OctetString
_Error80_string_Object = MibScalar
error80_string = _Error80_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 80, 4),
    _Error80_string_Type()
)
error80_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error80_string.setStatus("optional")
...
error81_time_stamp = _Error81_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 81, 1),
    _Error81_time_stamp_Type()
)
error81_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error81_time_stamp.setStatus("optional")
_Error81_code_Type = Integer32
_Error81_code_Object = MibScalar
error81_code = _Error81_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 81, 2),
    _Error81_code_Type()
)
error81_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error81_code.setStatus("optional")
_Error81_date_time_Type = OctetString
_Error81_date_time_Object = MibScalar
error81_date_time = _Error81_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 81, 3),
    _Error81_date_time_Type()
)
error81_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error81_date_time.setStatus("optional")
_Error81_string_Type = OctetString
_Error81_string_Object = MibScalar
error81_string = _Error81_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 81, 4),
    _Error81_string_Type()
)
error81_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error81_string.setStatus("optional")
...
error82_time_stamp = _Error82_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 82, 1),
    _Error82_time_stamp_Type()
)
error82_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error82_time_stamp.setStatus("optional")
_Error82_code_Type = Integer32
_Error82_code_Object = MibScalar
error82_code = _Error82_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 82, 2),
    _Error82_code_Type()
)
error82_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error82_code.setStatus("optional")
_Error82_date_time_Type = OctetString
_Error82_date_time_Object = MibScalar
error82_date_time = _Error82_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 82, 3),
    _Error82_date_time_Type()
)
error82_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error82_date_time.setStatus("optional")
_Error82_string_Type = OctetString
_Error82_string_Object = MibScalar
error82_string = _Error82_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 82, 4),
    _Error82_string_Type()
)
error82_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error82_string.setStatus("optional")
...
error83_time_stamp = _Error83_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 83, 1),
    _Error83_time_stamp_Type()
)
error83_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error83_time_stamp.setStatus("optional")
_Error83_code_Type = Integer32
_Error83_code_Object = MibScalar
error83_code = _Error83_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 83, 2),
    _Error83_code_Type()
)
error83_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error83_code.setStatus("optional")
_Error83_date_time_Type = OctetString
_Error83_date_time_Object = MibScalar
error83_date_time = _Error83_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 83, 3),
    _Error83_date_time_Type()
)
error83_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error83_date_time.setStatus("optional")
_Error83_string_Type = OctetString
_Error83_string_Object = MibScalar
error83_string = _Error83_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 83, 4),
    _Error83_string_Type()
)
error83_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error83_string.setStatus("optional")
...
error84_time_stamp = _Error84_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 84, 1),
    _Error84_time_stamp_Type()
)
error84_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error84_time_stamp.setStatus("optional")
_Error84_code_Type = Integer32
_Error84_code_Object = MibScalar
error84_code = _Error84_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 84, 2),
    _Error84_code_Type()
)
error84_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error84_code.setStatus("optional")
_Error84_date_time_Type = OctetString
_Error84_date_time_Object = MibScalar
error84_date_time = _Error84_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 84, 3),
    _Error84_date_time_Type()
)
error84_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error84_date_time.setStatus("optional")
_Error84_string_Type = OctetString
_Error84_string_Object = MibScalar
error84_string = _Error84_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 84, 4),
    _Error84_string_Type()
)
error84_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error84_string.setStatus("optional")
...
error85_time_stamp = _Error85_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 85, 1),
    _Error85_time_stamp_Type()
)
error85_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error85_time_stamp.setStatus("optional")
_Error85_code_Type = Integer32
_Error85_code_Object = MibScalar
error85_code = _Error85_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 85, 2),
    _Error85_code_Type()
)
error85_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error85_code.setStatus("optional")
_Error85_date_time_Type = OctetString
_Error85_date_time_Object = MibScalar
error85_date_time = _Error85_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 85, 3),
    _Error85_date_time_Type()
)
error85_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error85_date_time.setStatus("optional")
_Error85_string_Type = OctetString
_Error85_string_Object = MibScalar
error85_string = _Error85_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 85, 4),
    _Error85_string_Type()
)
error85_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error85_string.setStatus("optional")
...
error86_time_stamp = _Error86_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 86, 1),
    _Error86_time_stamp_Type()
)
error86_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error86_time_stamp.setStatus("optional")
_Error86_code_Type = Integer32
_Error86_code_Object = MibScalar
error86_code = _Error86_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 86, 2),
    _Error86_code_Type()
)
error86_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error86_code.setStatus("optional")
_Error86_date_time_Type = OctetString
_Error86_date_time_Object = MibScalar
error86_date_time = _Error86_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 86, 3),
    _Error86_date_time_Type()
)
error86_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error86_date_time.setStatus("optional")
_Error86_string_Type = OctetString
_Error86_string_Object = MibScalar
error86_string = _Error86_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 86, 4),
    _Error86_string_Type()
)
error86_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error86_string.setStatus("optional")
...
error87_time_stamp = _Error87_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 87, 1),
    _Error87_time_stamp_Type()
)
error87_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error87_time_stamp.setStatus("optional")
_Error87_code_Type = Integer32
_Error87_code_Object = MibScalar
error87_code = _Error87_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 87, 2),
    _Error87_code_Type()
)
error87_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error87_code.setStatus("optional")
_Error87_date_time_Type = OctetString
_Error87_date_time_Object = MibScalar
error87_date_time = _Error87_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 87, 3),
    _Error87_date_time_Type()
)
error87_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error87_date_time.setStatus("optional")
_Error87_string_Type = OctetString
_Error87_string_Object = MibScalar
error87_string = _Error87_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 87, 4),
    _Error87_string_Type()
)
error87_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error87_string.setStatus("optional")
...
error88_time_stamp = _Error88_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 88, 1),
    _Error88_time_stamp_Type()
)
error88_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error88_time_stamp.setStatus("optional")
_Error88_code_Type = Integer32
_Error88_code_Object = MibScalar
error88_code = _Error88_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 88, 2),
    _Error88_code_Type()
)
error88_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error88_code.setStatus("optional")
_Error88_date_time_Type = OctetString
_Error88_date_time_Object = MibScalar
error88_date_time = _Error88_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 88, 3),
    _Error88_date_time_Type()
)
error88_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error88_date_time.setStatus("optional")
_Error88_string_Type = OctetString
_Error88_string_Object = MibScalar
error88_string = _Error88_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 88, 4),
    _Error88_string_Type()
)
error88_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error88_string.setStatus("optional")
...
error89_time_stamp = _Error89_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 89, 1),
    _Error89_time_stamp_Type()
)
error89_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error89_time_stamp.setStatus("optional")
_Error89_code_Type = Integer32
_Error89_code_Object = MibScalar
error89_code = _Error89_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 89, 2),
    _Error89_code_Type()
)
error89_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error89_code.setStatus("optional")
_Error89_date_time_Type = OctetString
_Error89_date_time_Object = MibScalar
error89_date_time = _Error89_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 89, 3),
    _Error89_date_time_Type()
)
error89_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error89_date_time.setStatus("optional")
_Error89_string_Type = OctetString
_Error89_string_Object = MibScalar
error89_string = _Error89_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 89, 4),
    _Error89_string_Type()
)
error89_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error89_string.setStatus("optional")
...
error90_time_stamp = _Error90_time_stamp_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 90, 1),
    _Error90_time_stamp_Type()
)
error90_time_stamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error90_time_stamp.setStatus("optional")
_Error90_code_Type = Integer32
_Error90_code_Object = MibScalar
error90_code = _Error90_code_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 90, 2),
    _Error90_code_Type()
)
error90_code.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error90_code.setStatus("optional")
_Error90_date_time_Type = OctetString
_Error90_date_time_Object = MibScalar
error90_date_time = _Error90_date_time_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 90, 3),
    _Error90_date_time_Type()
)
error90_date_time.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error90_date_time.setStatus("optional")
_Error90_string_Type = OctetString
_Error90_string_Object = MibScalar
error90_string = _Error90_string_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 11, 90, 4),
    _Error90_string_Type()
)
error90_string.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    error90_string.setStatus("optional")
...
if mibBuilder.loadTexts:
    printed_media_combined_simplex_count.setStatus("optional")
...
if mibBuilder.loadTexts:
    printed_media_combined_duplex_count.setStatus("optional")
_Printed_media_combined_simplex_total_Type = Integer32
_Printed_media_combined_simplex_total_Object = MibScalar
printed_media_combined_simplex_total = _Printed_media_combined_simplex_total_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 16, 1, 1, 13),
    _Printed_media_combined_simplex_total_Type()
)
printed_media_combined_simplex_total.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    printed_media_combined_simplex_total.setStatus("optional")
_Printed_media_combined_duplex_total_Type = Integer32
_Printed_media_combined_duplex_total_Object = MibScalar
printed_media_combined_duplex_total = _Printed_media_combined_duplex_total_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 16, 1, 1, 14),
    _Printed_media_combined_duplex_total_Type()
)
printed_media_combined_duplex_total.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    printed_media_combined_duplex_total.setStatus("optional")
...
calibration_power_on_delay = _Calibration_power_on_delay_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 1, 21),
    _Calibration_power_on_delay_Type()
)
calibration_power_on_delay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    calibration_power_on_delay.setStatus("optional")
...
class _Media_sensor_calibration_Type(Integer32):
    """Custom type media_sensor_calibration based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            3
...
_Media_sensor_calibration_Type.__name__ = "Integer32"
_Media_sensor_calibration_Object = MibScalar
media_sensor_calibration = _Media_sensor_calibration_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 1, 35),
    _Media_sensor_calibration_Type()
)
media_sensor_calibration.setMaxAccess("write-only")
if mibBuilder.loadTexts:
    media_sensor_calibration.setStatus("optional")
_Cartridge_adaptive_gain_Type = OctetString
_Cartridge_adaptive_gain_Object = MibScalar
cartridge_adaptive_gain = _Cartridge_adaptive_gain_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 1, 36),
    _Cartridge_adaptive_gain_Type()
)
cartridge_adaptive_gain.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cartridge_adaptive_gain.setStatus("optional")


class _Cartridge_adaptive_gain_reset_Type(Integer32):
    """Custom type cartridge_adaptive_gain_reset based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Cartridge_adaptive_gain_reset_Type.__name__ = "Integer32"
_Cartridge_adaptive_gain_reset_Object = MibScalar
cartridge_adaptive_gain_reset = _Cartridge_adaptive_gain_reset_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 1, 37),
    _Cartridge_adaptive_gain_reset_Type()
)
cartridge_adaptive_gain_reset.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cartridge_adaptive_gain_reset.setStatus("optional")


class _Supplies_at_very_low_setting_Type(Integer32):
    """Custom type supplies_at_very_low_setting based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_Supplies_at_very_low_setting_Type.__name__ = "Integer32"
_Supplies_at_very_low_setting_Object = MibScalar
supplies_at_very_low_setting = _Supplies_at_very_low_setting_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 1, 38),
    _Supplies_at_very_low_setting_Type()
)
supplies_at_very_low_setting.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    supplies_at_very_low_setting.setStatus("optional")
...
consumable_status_partnumber = _Consumable_status_partnumber_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 56),
    _Consumable_status_partnumber_Type()
)
consumable_status_partnumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_partnumber.setStatus("optional")
_Consumable_status_web_service_access_data_Type = Integer32
_Consumable_status_web_service_access_data_Object = MibScalar
consumable_status_web_service_access_data = _Consumable_status_web_service_access_data_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 75),
    _Consumable_status_web_service_access_data_Type()
)
consumable_status_web_service_access_data.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_web_service_access_data.setStatus("optional")
...
consumable_status_web_service_access_control = _Consumable_status_web_service_access_control_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 76),
    _Consumable_status_web_service_access_control_Type()
)
consumable_status_web_service_access_control.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_web_service_access_control.setStatus("optional")
_Consumable_status_tls_max_value_Type = Integer32
_Consumable_status_tls_max_value_Object = MibScalar
consumable_status_tls_max_value = _Consumable_status_tls_max_value_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 96),
    _Consumable_status_tls_max_value_Type()
)
consumable_status_tls_max_value.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_tls_max_value.setStatus("optional")
...
consumable_status_printer_design_compatibility = _Consumable_status_printer_design_compatibility_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 97),
    _Consumable_status_printer_design_compatibility_Type()
)
consumable_status_printer_design_compatibility.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_printer_design_compatibility.setStatus("optional")
...
consumable_current_pixels_printed_for_iso_page = _Consumable_current_pixels_printed_for_iso_page_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 100),
    _Consumable_current_pixels_printed_for_iso_page_Type()
)
consumable_current_pixels_printed_for_iso_page.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_current_pixels_printed_for_iso_page.setStatus("optional")
_Consumable_last_pixels_printed_for_iso_page_Type = Integer32
_Consumable_last_pixels_printed_for_iso_page_Object = MibScalar
consumable_last_pixels_printed_for_iso_page = _Consumable_last_pixels_printed_for_iso_page_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 101),
    _Consumable_last_pixels_printed_for_iso_page_Type()
)
consumable_last_pixels_printed_for_iso_page.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_last_pixels_printed_for_iso_page.setStatus("optional")
_Consumable_status_formatter_mono_page_count_Type = Integer32
_Consumable_status_formatter_mono_page_count_Object = MibScalar
consumable_status_formatter_mono_page_count = _Consumable_status_formatter_mono_page_count_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 102),
    _Consumable_status_formatter_mono_page_count_Type()
)
consumable_status_formatter_mono_page_count.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_formatter_mono_page_count.setStatus("optional")
...
if mibBuilder.loadTexts:
    total_kilo_pixels_per_cartridge.setStatus("optional")
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "device-configure-quiet-mode-printing": device_configure_quiet_mode_printing,
       ...
       "dfa-data-in-nvram": dfa_data_in_nvram,
       "id": id,
       ...
       "error47-string": error47_string,
       "error48": error48,
       "error48-time-stamp": error48_time_stamp,
       "error48-code": error48_code,
       "error48-date-time": error48_date_time,
       "error48-string": error48_string,
       "error49": error49,
       "error49-time-stamp": error49_time_stamp,
       "error49-code": error49_code,
       "error49-date-time": error49_date_time,
       "error49-string": error49_string,
       "error50": error50,
       "error50-time-stamp": error50_time_stamp,
       "error50-code": error50_code,
       "error50-date-time": error50_date_time,
       "error50-string": error50_string,
       "error51": error51,
       "error51-time-stamp": error51_time_stamp,
       "error51-code": error51_code,
       "error51-date-time": error51_date_time,
       "error51-string": error51_string,
       "error52": error52,
       "error52-time-stamp": error52_time_stamp,
       "error52-code": error52_code,
       "error52-date-time": error52_date_time,
       "error52-string": error52_string,
       "error53": error53,
       "error53-time-stamp": error53_time_stamp,
       "error53-code": error53_code,
       "error53-date-time": error53_date_time,
       "error53-string": error53_string,
       "error54": error54,
       "error54-time-stamp": error54_time_stamp,
       "error54-code": error54_code,
       "error54-date-time": error54_date_time,
       "error54-string": error54_string,
       "error55": error55,
       "error55-time-stamp": error55_time_stamp,
       "error55-code": error55_code,
       "error55-date-time": error55_date_time,
       "error55-string": error55_string,
       "error56": error56,
       "error56-time-stamp": error56_time_stamp,
       "error56-code": error56_code,
       "error56-date-time": error56_date_time,
       "error56-string": error56_string,
       "error57": error57,
       "error57-time-stamp": error57_time_stamp,
       "error57-code": error57_code,
       "error57-date-time": error57_date_time,
       "error57-string": error57_string,
       "error58": error58,
       "error58-time-stamp": error58_time_stamp,
       "error58-code": error58_code,
       "error58-date-time": error58_date_time,
       "error58-string": error58_string,
       "error59": error59,
       "error59-time-stamp": error59_time_stamp,
       "error59-code": error59_code,
       "error59-date-time": error59_date_time,
       "error59-string": error59_string,
       "error60": error60,
       "error60-time-stamp": error60_time_stamp,
       "error60-code": error60_code,
       "error60-date-time": error60_date_time,
       "error60-string": error60_string,
       "error61": error61,
       "error61-time-stamp": error61_time_stamp,
       "error61-code": error61_code,
       "error61-date-time": error61_date_time,
       "error61-string": error61_string,
       "error62": error62,
       "error62-time-stamp": error62_time_stamp,
       "error62-code": error62_code,
       "error62-date-time": error62_date_time,
       "error62-string": error62_string,
       "error63": error63,
       "error63-time-stamp": error63_time_stamp,
       "error63-code": error63_code,
       "error63-date-time": error63_date_time,
       "error63-string": error63_string,
       "error64": error64,
       "error64-time-stamp": error64_time_stamp,
       "error64-code": error64_code,
       "error64-date-time": error64_date_time,
       "error64-string": error64_string,
       "error65": error65,
       "error65-time-stamp": error65_time_stamp,
       "error65-code": error65_code,
       "error65-date-time": error65_date_time,
       "error65-string": error65_string,
       "error66": error66,
       "error66-time-stamp": error66_time_stamp,
       "error66-code": error66_code,
       "error66-date-time": error66_date_time,
       "error66-string": error66_string,
       "error67": error67,
       "error67-time-stamp": error67_time_stamp,
       "error67-code": error67_code,
       "error67-date-time": error67_date_time,
       "error67-string": error67_string,
       "error68": error68,
       "error68-time-stamp": error68_time_stamp,
       "error68-code": error68_code,
       "error68-date-time": error68_date_time,
       "error68-string": error68_string,
       "error69": error69,
       "error69-time-stamp": error69_time_stamp,
       "error69-code": error69_code,
       "error69-date-time": error69_date_time,
       "error69-string": error69_string,
       "error70": error70,
       "error70-time-stamp": error70_time_stamp,
       "error70-code": error70_code,
       "error70-date-time": error70_date_time,
       "error70-string": error70_string,
       "error71": error71,
       "error71-time-stamp": error71_time_stamp,
       "error71-code": error71_code,
       "error71-date-time": error71_date_time,
       "error71-string": error71_string,
       "error72": error72,
       "error72-time-stamp": error72_time_stamp,
       "error72-code": error72_code,
       "error72-date-time": error72_date_time,
       "error72-string": error72_string,
       "error73": error73,
       "error73-time-stamp": error73_time_stamp,
       "error73-code": error73_code,
       "error73-date-time": error73_date_time,
       "error73-string": error73_string,
       "error74": error74,
       "error74-time-stamp": error74_time_stamp,
       "error74-code": error74_code,
       "error74-date-time": error74_date_time,
       "error74-string": error74_string,
       "error75": error75,
       "error75-time-stamp": error75_time_stamp,
       "error75-code": error75_code,
       "error75-date-time": error75_date_time,
       "error75-string": error75_string,
       "error76": error76,
       "error76-time-stamp": error76_time_stamp,
       "error76-code": error76_code,
       "error76-date-time": error76_date_time,
       "error76-string": error76_string,
       "error77": error77,
       "error77-time-stamp": error77_time_stamp,
       "error77-code": error77_code,
       "error77-date-time": error77_date_time,
       "error77-string": error77_string,
       "error78": error78,
       "error78-time-stamp": error78_time_stamp,
       "error78-code": error78_code,
       "error78-date-time": error78_date_time,
       "error78-string": error78_string,
       "error79": error79,
       "error79-time-stamp": error79_time_stamp,
       "error79-code": error79_code,
       "error79-date-time": error79_date_time,
       "error79-string": error79_string,
       "error80": error80,
       "error80-time-stamp": error80_time_stamp,
       "error80-code": error80_code,
       "error80-date-time": error80_date_time,
       "error80-string": error80_string,
       "error81": error81,
       "error81-time-stamp": error81_time_stamp,
       "error81-code": error81_code,
       "error81-date-time": error81_date_time,
       "error81-string": error81_string,
       "error82": error82,
       "error82-time-stamp": error82_time_stamp,
       "error82-code": error82_code,
       "error82-date-time": error82_date_time,
       "error82-string": error82_string,
       "error83": error83,
       "error83-time-stamp": error83_time_stamp,
       "error83-code": error83_code,
       "error83-date-time": error83_date_time,
       "error83-string": error83_string,
       "error84": error84,
       "error84-time-stamp": error84_time_stamp,
       "error84-code": error84_code,
       "error84-date-time": error84_date_time,
       "error84-string": error84_string,
       "error85": error85,
       "error85-time-stamp": error85_time_stamp,
       "error85-code": error85_code,
       "error85-date-time": error85_date_time,
       "error85-string": error85_string,
       "error86": error86,
       "error86-time-stamp": error86_time_stamp,
       "error86-code": error86_code,
       "error86-date-time": error86_date_time,
       "error86-string": error86_string,
       "error87": error87,
       "error87-time-stamp": error87_time_stamp,
       "error87-code": error87_code,
       "error87-date-time": error87_date_time,
       "error87-string": error87_string,
       "error88": error88,
       "error88-time-stamp": error88_time_stamp,
       "error88-code": error88_code,
       "error88-date-time": error88_date_time,
       "error88-string": error88_string,
       "error89": error89,
       "error89-time-stamp": error89_time_stamp,
       "error89-code": error89_code,
       "error89-date-time": error89_date_time,
       "error89-string": error89_string,
       "error90": error90,
       "error90-time-stamp": error90_time_stamp,
       "error90-code": error90_code,
       "error90-date-time": error90_date_time,
       "error90-string": error90_string,
       ...
       "printed-media-combined-simplex-total": printed_media_combined_simplex_total,
       "printed-media-combined-duplex-total": printed_media_combined_duplex_total,
       ...
       "calibration-power-on-delay": calibration_power_on_delay,
       "duplex-blank-pages": duplex_blank_pages,
       "finisher-image-rotation": finisher_image_rotation,
       "media-sensor-calibration": media_sensor_calibration,
       "cartridge-adaptive-gain": cartridge_adaptive_gain,
       "cartridge-adaptive-gain-reset": cartridge_adaptive_gain_reset,
       "supplies-at-very-low-setting": supplies_at_very_low_setting,
       ...
       "consumable-status-partnumber": consumable_status_partnumber,
       "consumable-status-web-service-access-data": consumable_status_web_service_access_data,
       "consumable-status-web-service-access-control": consumable_status_web_service_access_control,
       "consumable-status-tls-max-value": consumable_status_tls_max_value,
       "consumable-status-printer-design-compatibility": consumable_status_printer_design_compatibility,
       "consumable-current-pixels-printed-for-iso-page": consumable_current_pixels_printed_for_iso_page,
       "consumable-last-pixels-printed-for-iso-page": consumable_last_pixels_printed_for_iso_page,
       "consumable-status-formatter-mono-page-count": consumable_status_formatter_mono_page_count,
