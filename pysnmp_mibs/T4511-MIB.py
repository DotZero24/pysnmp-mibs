# SNMP MIB module (T4511-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T4511-MIB
...
trapTest.setObjects(
      *(("T4511-MIB", "sensorName"),
        ("T4511-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
