...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/comet/T4511-MIB
...
historyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 22626, 1, 2, 6, 1, 1), ).setIndexNames((0, "T4511-MIB", "histTemp"))
...
trapTest = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,0)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapNTPError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,1)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapEmailErrLogin = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,2)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapEmailErrAuth = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,3)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapEmailErrSome = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,4)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapEmailErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,5)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapEmailErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,6)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapSOAPErrFile = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,7)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapSOAPErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,8)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapSOAPErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,9)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapSOAPErrDelivery = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,10)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"))
trapTempHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,11)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"), ("T4511-MIB", "temp"), ("T4511-MIB", "tempAlarmInt"))
trapTempLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,21)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"), ("T4511-MIB", "temp"), ("T4511-MIB", "tempAlarmInt"))
trapTempClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,31)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"), ("T4511-MIB", "temp"), ("T4511-MIB", "tempAlarmInt"))
trapTempError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,41)).setObjects(("T4511-MIB", "sensorName"), ("T4511-MIB", "messageString"), ("T4511-MIB", "temp"), ("T4511-MIB", "tempAlarmInt"))
mibBuilder.exportSymbols("T4511-MIB", tempLowInt=tempLowInt, trapNTPError=trapNTPError, historyTable=historyTable, temp=temp, comet=comet, settings=settings, valuesInt=valuesInt, tempMax=tempMax, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrLogin=trapEmailErrLogin, t4511=t4511, historyEntry=historyEntry, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, trapTempError=trapTempError, traps=traps, tables=tables, messageString=messageString, tempInt=tempInt, tempAlarmInt=tempAlarmInt, values=values, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, trapTest=trapTest, tempDelayInt=tempDelayInt, products=products, pysmi_global=pysmi_global, tempUnit=tempUnit, histTemp=histTemp, DisplayString=DisplayString, trapSOAPErrFile=trapSOAPErrFile)
