...
devGpioConfigInput.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
devGpioConfigOutput.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
devGpioPinTable = _DevGpioPinTable_Object(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 9)
)
if mibBuilder.loadTexts:
    devGpioPinTable.setStatus("current")
_GpioPinEntry_Object = MibTableRow
gpioPinEntry = _GpioPinEntry_Object(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 9, 1)
)
gpioPinEntry.setIndexNames(
    (0, "WIPIPE-MIB", "pinIndex"),
)
if mibBuilder.loadTexts:
    gpioPinEntry.setStatus("current")
_PinIndex_Type = Integer32
_PinIndex_Object = MibTableColumn
pinIndex = _PinIndex_Object(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 9, 1, 1),
    _PinIndex_Type()
)
pinIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pinIndex.setStatus("current")


class _PinName_Type(DisplayString):
    """Custom type pinName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_PinName_Type.__name__ = "DisplayString"
_PinName_Object = MibTableColumn
pinName = _PinName_Object(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 9, 1, 2),
    _PinName_Type()
)
pinName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pinName.setStatus("current")


class _PinDirection_Type(DisplayString):
    """Custom type pinDirection based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_PinDirection_Type.__name__ = "DisplayString"
_PinDirection_Object = MibTableColumn
pinDirection = _PinDirection_Object(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 9, 1, 3),
    _PinDirection_Type()
)
pinDirection.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pinDirection.setStatus("current")


class _PinLocation_Type(DisplayString):
    """Custom type pinLocation based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_PinLocation_Type.__name__ = "DisplayString"
_PinLocation_Object = MibTableColumn
pinLocation = _PinLocation_Object(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 9, 1, 4),
    _PinLocation_Type()
)
pinLocation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pinLocation.setStatus("current")


class _PinValue_Type(DisplayString):
    """Custom type pinValue based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_PinValue_Type.__name__ = "DisplayString"
_PinValue_Object = MibTableColumn
pinValue = _PinValue_Object(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 9, 1, 5),
    _PinValue_Type()
)
pinValue.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pinValue.setStatus("current")


class _PinState_Type(DisplayString):
    """Custom type pinState based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_PinState_Type.__name__ = "DisplayString"
_PinState_Object = MibTableColumn
pinState = _PinState_Object(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 9, 1, 6),
    _PinState_Type()
)
pinState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pinState.setStatus("current")
_DevGpioPinTrap_ObjectIdentity = ObjectIdentity
devGpioPinTrap = _DevGpioPinTrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 10)
)
...
ibr650c = _Ibr650c_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 32)
)
_Ibr600c_ObjectIdentity = ObjectIdentity
ibr600c = _Ibr600c_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 33)
)
_Ibr1700_ObjectIdentity = ObjectIdentity
ibr1700 = _Ibr1700_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 34)
)
_Aer2200_ObjectIdentity = ObjectIdentity
aer2200 = _Aer2200_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 35)
)
_Aer2250_ObjectIdentity = ObjectIdentity
aer2250 = _Aer2250_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 36)
)
_Ap22_ObjectIdentity = ObjectIdentity
ap22 = _Ap22_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 37)
)
_Ibr200_ObjectIdentity = ObjectIdentity
ibr200 = _Ibr200_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 38)
)
_Ibr250_ObjectIdentity = ObjectIdentity
ibr250 = _Ibr250_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 39)
)
_Ibr900_fips_ObjectIdentity = ObjectIdentity
ibr900_fips = _Ibr900_fips_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 40)
)
_Ibr950_fips_ObjectIdentity = ObjectIdentity
ibr950_fips = _Ibr950_fips_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 41)
)
_Ibr1700_fips_ObjectIdentity = ObjectIdentity
ibr1700_fips = _Ibr1700_fips_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 42)
)
_Aer2200_fips_ObjectIdentity = ObjectIdentity
aer2200_fips = _Aer2200_fips_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 43)
)
_Aer2250_fips_ObjectIdentity = ObjectIdentity
aer2250_fips = _Aer2250_fips_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 44)
)
_Cr4250_ObjectIdentity = ObjectIdentity
cr4250 = _Cr4250_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 45)
)
_Cba550_ObjectIdentity = ObjectIdentity
cba550 = _Cba550_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 2, 46)
)
_WipipeEthernet_ObjectIdentity = ObjectIdentity
wipipeEthernet = _WipipeEthernet_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 3)
)
_WipipeSystem_ObjectIdentity = ObjectIdentity
wipipeSystem = _WipipeSystem_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 20992, 4)
)
...
gpioPinTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 20992, 1, 1, 10, 1)
)
gpioPinTrap.setObjects(
      *(("WIPIPE-MIB", "pinDescr"),
        ("WIPIPE-MIB", "pinValue"),
        ("WIPIPE-MIB", "pinDirection"),
        ("WIPIPE-MIB", "pinLocation"),
        ("WIPIPE-MIB", "pinName"),
        ("WIPIPE-MIB", "pinState"))
)
if mibBuilder.loadTexts:
    gpioPinTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "devGpioPinTable": devGpioPinTable,
       "gpioPinEntry": gpioPinEntry,
       "pinIndex": pinIndex,
       "pinName": pinName,
       ...
       "pinValue": pinValue,
       "pinState": pinState,
       "devGpioPinTrap": devGpioPinTrap,
       "gpioPinTrap": gpioPinTrap,
       ...
       "ibr200": ibr200,
       "ibr250": ibr250,
       "ibr900-fips": ibr900_fips,
       "ibr950-fips": ibr950_fips,
       "ibr1700-fips": ibr1700_fips,
       "aer2200-fips": aer2200_fips,
       "aer2250-fips": aer2250_fips,
       "cr4250": cr4250,
       "cba550": cba550,
       "wipipeEthernet": wipipeEthernet,
       "wipipeSystem": wipipeSystem}
)
