...
_Pepxim_ObjectIdentity=ObjectIdentity
pepxim=_Pepxim_ObjectIdentity((1,3,6,1,4,1,52467))
_ProductMib_ObjectIdentity=ObjectIdentity
productMib=_ProductMib_ObjectIdentity((1,3,6,1,4,1,52467,200))
_GeneralMib_ObjectIdentity=ObjectIdentity
generalMib=_GeneralMib_ObjectIdentity((1,3,6,1,4,1,52467,200,1))
_IptNetflowObjects_ObjectIdentity=ObjectIdentity
iptNetflowObjects=_IptNetflowObjects_ObjectIdentity((1,3,6,1,4,1,52467,200,1,15,1))
_IptNetflowModule_ObjectIdentity=ObjectIdentity
iptNetflowModule=_IptNetflowModule_ObjectIdentity((1,3,6,1,4,1,52467,200,1,15,1,1))
_Name_Type=DisplayString
_Name_Object=MibScalar
name=_Name_Object((1,3,6,1,4,1,52467,200,1,15,1,1,1),_Name_Type())
name.setMaxAccess(_C)
if mibBuilder.loadTexts:name.setStatus(_A)
_Version_Type=DisplayString
_Version_Object=MibScalar
version=_Version_Object((1,3,6,1,4,1,52467,200,1,15,1,1,2),_Version_Type())
...
srcversion=_Srcversion_Object((1,3,6,1,4,1,52467,200,1,15,1,1,3),_Srcversion_Type())
...
protocol=_Protocol_Object((1,3,6,1,4,1,52467,200,1,15,1,2,1),_Protocol_Type())
protocol.setMaxAccess(_D)
if mibBuilder.loadTexts:protocol.setStatus(_A)
_Hashsize_Type=Integer32
_Hashsize_Object=MibScalar
hashsize=_Hashsize_Object((1,3,6,1,4,1,52467,200,1,15,1,2,2),_Hashsize_Type())
...
maxflows=_Maxflows_Object((1,3,6,1,4,1,52467,200,1,15,1,2,3),_Maxflows_Type())
...
active_timeout=_Active_timeout_Object((1,3,6,1,4,1,52467,200,1,15,1,2,4),_Active_timeout_Type())
...
inactive_timeout=_Inactive_timeout_Object((1,3,6,1,4,1,52467,200,1,15,1,2,5),_Inactive_timeout_Type())
...
sndbuf=_Sndbuf_Object((1,3,6,1,4,1,52467,200,1,15,1,2,6),_Sndbuf_Type())
...
destination=_Destination_Object((1,3,6,1,4,1,52467,200,1,15,1,2,7),_Destination_Type())
...
aggregation=_Aggregation_Object((1,3,6,1,4,1,52467,200,1,15,1,2,8),_Aggregation_Type())
...
sampler=_Sampler_Object((1,3,6,1,4,1,52467,200,1,15,1,2,9),_Sampler_Type())
...
natevents=_Natevents_Object((1,3,6,1,4,1,52467,200,1,15,1,2,10),_Natevents_Type())
...
promisc=_Promisc_Object((1,3,6,1,4,1,52467,200,1,15,1,2,11),_Promisc_Type())
...
snmp_rules=_Snmp_rules_Object((1,3,6,1,4,1,52467,200,1,15,1,2,12),_Snmp_rules_Type())
...
scan_min=_Scan_min_Object((1,3,6,1,4,1,52467,200,1,15,1,2,13),_Scan_min_Type())
scan_min.setMaxAccess(_D)
if mibBuilder.loadTexts:scan_min.setStatus(_A)
_IptNetflowStatistics_ObjectIdentity=ObjectIdentity
iptNetflowStatistics=_IptNetflowStatistics_ObjectIdentity((1,3,6,1,4,1,52467,200,1,15,2))
_IptNetflowTotals_ObjectIdentity=ObjectIdentity
iptNetflowTotals=_IptNetflowTotals_ObjectIdentity((1,3,6,1,4,1,52467,200,1,15,2,1))
_InBitRate_Type=CounterBasedGauge64
_InBitRate_Object=MibScalar
inBitRate=_InBitRate_Object((1,3,6,1,4,1,52467,200,1,15,2,1,1),_InBitRate_Type())
...
inPacketRate=_InPacketRate_Object((1,3,6,1,4,1,52467,200,1,15,2,1,2),_InPacketRate_Type())
...
inFlows=_InFlows_Object((1,3,6,1,4,1,52467,200,1,15,2,1,3),_InFlows_Type())
...
inPackets=_InPackets_Object((1,3,6,1,4,1,52467,200,1,15,2,1,4),_InPackets_Type())
...
inBytes=_InBytes_Object((1,3,6,1,4,1,52467,200,1,15,2,1,5),_InBytes_Type())
...
hashMetric=_HashMetric_Object((1,3,6,1,4,1,52467,200,1,15,2,1,6),_HashMetric_Type())
...
hashMemory=_HashMemory_Object((1,3,6,1,4,1,52467,200,1,15,2,1,7),_HashMemory_Type())
...
hashFlows=_HashFlows_Object((1,3,6,1,4,1,52467,200,1,15,2,1,8),_HashFlows_Type())
...
hashPackets=_HashPackets_Object((1,3,6,1,4,1,52467,200,1,15,2,1,9),_HashPackets_Type())
...
hashBytes=_HashBytes_Object((1,3,6,1,4,1,52467,200,1,15,2,1,10),_HashBytes_Type())
...
dropPackets=_DropPackets_Object((1,3,6,1,4,1,52467,200,1,15,2,1,11),_DropPackets_Type())
...
dropBytes=_DropBytes_Object((1,3,6,1,4,1,52467,200,1,15,2,1,12),_DropBytes_Type())
...
outByteRate=_OutByteRate_Object((1,3,6,1,4,1,52467,200,1,15,2,1,13),_OutByteRate_Type())
...
outFlows=_OutFlows_Object((1,3,6,1,4,1,52467,200,1,15,2,1,14),_OutFlows_Type())
...
outPackets=_OutPackets_Object((1,3,6,1,4,1,52467,200,1,15,2,1,15),_OutPackets_Type())
...
outBytes=_OutBytes_Object((1,3,6,1,4,1,52467,200,1,15,2,1,16),_OutBytes_Type())
...
lostFlows=_LostFlows_Object((1,3,6,1,4,1,52467,200,1,15,2,1,17),_LostFlows_Type())
...
lostPackets=_LostPackets_Object((1,3,6,1,4,1,52467,200,1,15,2,1,18),_LostPackets_Type())
...
lostBytes=_LostBytes_Object((1,3,6,1,4,1,52467,200,1,15,2,1,19),_LostBytes_Type())
...
errTotal=_ErrTotal_Object((1,3,6,1,4,1,52467,200,1,15,2,1,20),_ErrTotal_Type())
...
sndbufPeak=_SndbufPeak_Object((1,3,6,1,4,1,52467,200,1,15,2,1,21),_SndbufPeak_Type())
...
iptNetflowCpuTable=_IptNetflowCpuTable_Object((1,3,6,1,4,1,52467,200,1,15,2,2))
if mibBuilder.loadTexts:iptNetflowCpuTable.setStatus(_A)
_IptNetflowCpuEntry_Object=MibTableRow
iptNetflowCpuEntry=_IptNetflowCpuEntry_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1))
...
cpuIndex=_CpuIndex_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,1),_CpuIndex_Type())
...
cpuInPacketRate=_CpuInPacketRate_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,2),_CpuInPacketRate_Type())
...
cpuInFlows=_CpuInFlows_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,3),_CpuInFlows_Type())
...
cpuInPackets=_CpuInPackets_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,4),_CpuInPackets_Type())
...
cpuInBytes=_CpuInBytes_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,5),_CpuInBytes_Type())
...
cpuHashMetric=_CpuHashMetric_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,6),_CpuHashMetric_Type())
...
cpuDropPackets=_CpuDropPackets_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,7),_CpuDropPackets_Type())
...
cpuDropBytes=_CpuDropBytes_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,8),_CpuDropBytes_Type())
...
cpuErrTrunc=_CpuErrTrunc_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,9),_CpuErrTrunc_Type())
...
cpuErrFrag=_CpuErrFrag_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,10),_CpuErrFrag_Type())
...
cpuErrAlloc=_CpuErrAlloc_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,11),_CpuErrAlloc_Type())
...
cpuErrMaxflows=_CpuErrMaxflows_Object((1,3,6,1,4,1,52467,200,1,15,2,2,1,12),_CpuErrMaxflows_Type())
cpuErrMaxflows.setMaxAccess(_C)
if mibBuilder.loadTexts:cpuErrMaxflows.setStatus(_A)
_IptNetflowSockTable_Object=MibTable
iptNetflowSockTable=_IptNetflowSockTable_Object((1,3,6,1,4,1,52467,200,1,15,2,3))
if mibBuilder.loadTexts:iptNetflowSockTable.setStatus(_A)
_IptNetflowSockEntry_Object=MibTableRow
iptNetflowSockEntry=_IptNetflowSockEntry_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1))
...
sockIndex=_SockIndex_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,1),_SockIndex_Type())
...
sockDestination=_SockDestination_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,2),_SockDestination_Type())
...
sockActive=_SockActive_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,3),_SockActive_Type())
...
sockErrConnect=_SockErrConnect_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,4),_SockErrConnect_Type())
...
sockErrFull=_SockErrFull_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,5),_SockErrFull_Type())
...
sockErrCberr=_SockErrCberr_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,6),_SockErrCberr_Type())
...
sockErrOther=_SockErrOther_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,7),_SockErrOther_Type())
...
sockSndbuf=_SockSndbuf_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,8),_SockSndbuf_Type())
...
sockSndbufFill=_SockSndbufFill_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,9),_SockSndbufFill_Type())
...
sockSndbufPeak=_SockSndbufPeak_Object((1,3,6,1,4,1,52467,200,1,15,2,3,1,10),_SockSndbufPeak_Type())
...
iptNetflowConformance=_IptNetflowConformance_ObjectIdentity((1,3,6,1,4,1,52467,200,1,15,3))
_IptNetflowCompliances_ObjectIdentity=ObjectIdentity
iptNetflowCompliances=_IptNetflowCompliances_ObjectIdentity((1,3,6,1,4,1,52467,200,1,15,3,1))
_IptNetflowGroups_ObjectIdentity=ObjectIdentity
iptNetflowGroups=_IptNetflowGroups_ObjectIdentity((1,3,6,1,4,1,52467,200,1,15,3,2))
iptNetflowModuleGroup=ObjectGroup((1,3,6,1,4,1,52467,200,1,15,3,2,1))
...
iptNetflowSysctlGroup=ObjectGroup((1,3,6,1,4,1,52467,200,1,15,3,2,2))
...
iptNetflowTotalsGroup=ObjectGroup((1,3,6,1,4,1,52467,200,1,15,3,2,3))
...
iptNetflowCpuGroup=ObjectGroup((1,3,6,1,4,1,52467,200,1,15,3,2,4))
...
iptNetflowSockGroup=ObjectGroup((1,3,6,1,4,1,52467,200,1,15,3,2,5))
...
iptNetflowCompliance=ModuleCompliance((1,3,6,1,4,1,52467,200,1,15,3,1,1))
