# SNMP MIB module (PEPXIM-IPT-NETFLOW-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/peplink/PEPXIM-IPT-NETFLOW-MIB
...
version = _Version_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 1, 2),
    _Version_Type()
)
...
srcversion = _Srcversion_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 1, 3),
    _Srcversion_Type()
)
...
loadTime = _LoadTime_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 1, 4),
    _LoadTime_Type()
)
...
refcnt = _Refcnt_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 1, 5),
    _Refcnt_Type()
)
...
iptNetflowSysctl = _IptNetflowSysctl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2)
)
...
protocol = _Protocol_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 1),
    _Protocol_Type()
)
...
hashsize = _Hashsize_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 2),
    _Hashsize_Type()
)
...
maxflows = _Maxflows_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 3),
    _Maxflows_Type()
)
...
active_timeout = _Active_timeout_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 4),
...
inactive_timeout = _Inactive_timeout_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 5),
...
sndbuf = _Sndbuf_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 6),
    _Sndbuf_Type()
)
...
destination = _Destination_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 7),
    _Destination_Type()
)
...
aggregation = _Aggregation_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 8),
    _Aggregation_Type()
)
...
sampler = _Sampler_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 9),
    _Sampler_Type()
)
...
natevents = _Natevents_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 10),
    _Natevents_Type()
)
...
promisc = _Promisc_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 11),
    _Promisc_Type()
)
...
snmp_rules = _Snmp_rules_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 12),
    _Snmp_rules_Type()
)
...
scan_min = _Scan_min_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 1, 2, 13),
    _Scan_min_Type()
)
...
inPacketRate = _InPacketRate_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 2),
    _InPacketRate_Type()
)
...
inFlows = _InFlows_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 3),
    _InFlows_Type()
)
...
inPackets = _InPackets_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 4),
    _InPackets_Type()
)
...
inBytes = _InBytes_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 5),
    _InBytes_Type()
)
...
hashMetric = _HashMetric_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 6),
    _HashMetric_Type()
)
...
hashMemory = _HashMemory_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 7),
    _HashMemory_Type()
)
...
hashFlows = _HashFlows_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 8),
    _HashFlows_Type()
)
...
hashPackets = _HashPackets_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 9),
    _HashPackets_Type()
)
...
hashBytes = _HashBytes_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 10),
    _HashBytes_Type()
)
...
dropPackets = _DropPackets_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 11),
    _DropPackets_Type()
)
...
dropBytes = _DropBytes_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 12),
    _DropBytes_Type()
)
...
outByteRate = _OutByteRate_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 13),
    _OutByteRate_Type()
)
...
outFlows = _OutFlows_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 14),
    _OutFlows_Type()
)
...
outPackets = _OutPackets_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 15),
    _OutPackets_Type()
)
...
outBytes = _OutBytes_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 16),
    _OutBytes_Type()
)
...
lostFlows = _LostFlows_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 17),
    _LostFlows_Type()
)
...
lostPackets = _LostPackets_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 18),
    _LostPackets_Type()
)
...
lostBytes = _LostBytes_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 19),
    _LostBytes_Type()
)
...
errTotal = _ErrTotal_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 20),
    _ErrTotal_Type()
)
...
sndbufPeak = _SndbufPeak_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 1, 21),
    _SndbufPeak_Type()
)
...
cpuIndex = _CpuIndex_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 1),
    _CpuIndex_Type()
)
...
cpuInPacketRate = _CpuInPacketRate_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 2),
...
cpuInFlows = _CpuInFlows_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 3),
    _CpuInFlows_Type()
)
...
cpuInPackets = _CpuInPackets_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 4),
    _CpuInPackets_Type()
)
...
cpuInBytes = _CpuInBytes_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 5),
    _CpuInBytes_Type()
)
...
cpuHashMetric = _CpuHashMetric_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 6),
    _CpuHashMetric_Type()
)
...
cpuDropPackets = _CpuDropPackets_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 7),
...
cpuDropBytes = _CpuDropBytes_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 8),
    _CpuDropBytes_Type()
)
...
cpuErrTrunc = _CpuErrTrunc_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 9),
    _CpuErrTrunc_Type()
)
...
cpuErrFrag = _CpuErrFrag_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 10),
    _CpuErrFrag_Type()
)
...
cpuErrAlloc = _CpuErrAlloc_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 11),
    _CpuErrAlloc_Type()
)
...
cpuErrMaxflows = _CpuErrMaxflows_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 2, 1, 12),
...
iptNetflowSockTable = _IptNetflowSockTable_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3)
)
if mibBuilder.loadTexts:
...
iptNetflowSockEntry = _IptNetflowSockEntry_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3, 1)
)
iptNetflowSockEntry.setIndexNames(
    (0, "PEPXIM-IPT-NETFLOW-MIB", "sockIndex"),
)
if mibBuilder.loadTexts:
...
sockIndex = _SockIndex_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3, 1, 1),
    _SockIndex_Type()
)
...
sockDestination = _SockDestination_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3, 1, 2),
...
sockErrConnect = _SockErrConnect_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3, 1, 4),
...
sockErrCberr = _SockErrCberr_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3, 1, 6),
    _SockErrCberr_Type()
)
...
sockErrOther = _SockErrOther_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3, 1, 7),
    _SockErrOther_Type()
)
...
sockSndbuf = _SockSndbuf_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3, 1, 8),
    _SockSndbuf_Type()
)
...
sockSndbufFill = _SockSndbufFill_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3, 1, 9),
...
sockSndbufPeak = _SockSndbufPeak_Object(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 2, 3, 1, 10),
...
iptNetflowConformance = _IptNetflowConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 3)
)
_IptNetflowCompliances_ObjectIdentity = ObjectIdentity
iptNetflowCompliances = _IptNetflowCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 3, 1)
)
_IptNetflowGroups_ObjectIdentity = ObjectIdentity
iptNetflowGroups = _IptNetflowGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 3, 2)
)

# Managed Objects groups

iptNetflowModuleGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 3, 2, 1)
)
iptNetflowModuleGroup.setObjects(
      *(("PEPXIM-IPT-NETFLOW-MIB", "name"),
        ("PEPXIM-IPT-NETFLOW-MIB", "version"),
        ("PEPXIM-IPT-NETFLOW-MIB", "srcversion"),
        ("PEPXIM-IPT-NETFLOW-MIB", "loadTime"),
        ("PEPXIM-IPT-NETFLOW-MIB", "refcnt"))
)
if mibBuilder.loadTexts:
    iptNetflowModuleGroup.setStatus("current")

iptNetflowSysctlGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 3, 2, 2)
)
iptNetflowSysctlGroup.setObjects(
      *(("PEPXIM-IPT-NETFLOW-MIB", "hashsize"),
        ("PEPXIM-IPT-NETFLOW-MIB", "maxflows"),
        ("PEPXIM-IPT-NETFLOW-MIB", "protocol"),
        ("PEPXIM-IPT-NETFLOW-MIB", "active-timeout"),
        ("PEPXIM-IPT-NETFLOW-MIB", "inactive-timeout"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sndbuf"),
        ("PEPXIM-IPT-NETFLOW-MIB", "destination"),
        ("PEPXIM-IPT-NETFLOW-MIB", "aggregation"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sampler"),
        ("PEPXIM-IPT-NETFLOW-MIB", "natevents"),
        ("PEPXIM-IPT-NETFLOW-MIB", "promisc"),
        ("PEPXIM-IPT-NETFLOW-MIB", "snmp-rules"),
        ("PEPXIM-IPT-NETFLOW-MIB", "scan-min"))
)
if mibBuilder.loadTexts:
    iptNetflowSysctlGroup.setStatus("current")

iptNetflowTotalsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 3, 2, 3)
)
iptNetflowTotalsGroup.setObjects(
      *(("PEPXIM-IPT-NETFLOW-MIB", "inBitRate"),
        ("PEPXIM-IPT-NETFLOW-MIB", "inPacketRate"),
        ("PEPXIM-IPT-NETFLOW-MIB", "inFlows"),
        ("PEPXIM-IPT-NETFLOW-MIB", "inPackets"),
        ("PEPXIM-IPT-NETFLOW-MIB", "inBytes"),
        ("PEPXIM-IPT-NETFLOW-MIB", "hashMetric"),
        ("PEPXIM-IPT-NETFLOW-MIB", "hashMemory"),
        ("PEPXIM-IPT-NETFLOW-MIB", "hashFlows"),
        ("PEPXIM-IPT-NETFLOW-MIB", "hashPackets"),
        ("PEPXIM-IPT-NETFLOW-MIB", "hashBytes"),
        ("PEPXIM-IPT-NETFLOW-MIB", "dropPackets"),
        ("PEPXIM-IPT-NETFLOW-MIB", "dropBytes"),
        ("PEPXIM-IPT-NETFLOW-MIB", "outByteRate"),
        ("PEPXIM-IPT-NETFLOW-MIB", "outFlows"),
        ("PEPXIM-IPT-NETFLOW-MIB", "outPackets"),
        ("PEPXIM-IPT-NETFLOW-MIB", "outBytes"),
        ("PEPXIM-IPT-NETFLOW-MIB", "lostFlows"),
        ("PEPXIM-IPT-NETFLOW-MIB", "lostPackets"),
        ("PEPXIM-IPT-NETFLOW-MIB", "lostBytes"),
        ("PEPXIM-IPT-NETFLOW-MIB", "errTotal"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sndbufPeak"))
)
if mibBuilder.loadTexts:
    iptNetflowTotalsGroup.setStatus("current")

iptNetflowCpuGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 3, 2, 4)
)
iptNetflowCpuGroup.setObjects(
      *(("PEPXIM-IPT-NETFLOW-MIB", "cpuIndex"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuInPacketRate"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuInFlows"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuInPackets"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuInBytes"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuHashMetric"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuDropPackets"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuDropBytes"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuErrTrunc"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuErrFrag"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuErrAlloc"),
        ("PEPXIM-IPT-NETFLOW-MIB", "cpuErrMaxflows"))
)
if mibBuilder.loadTexts:
    iptNetflowCpuGroup.setStatus("current")

iptNetflowSockGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 3, 2, 5)
)
iptNetflowSockGroup.setObjects(
      *(("PEPXIM-IPT-NETFLOW-MIB", "sockDestination"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sockActive"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sockErrConnect"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sockErrFull"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sockErrCberr"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sockErrOther"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sockSndbuf"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sockSndbufFill"),
        ("PEPXIM-IPT-NETFLOW-MIB", "sockSndbufPeak"))
)
if mibBuilder.loadTexts:
...
iptNetflowCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 52467, 200, 1, 15, 3, 1, 1)
)
iptNetflowCompliance.setObjects(
      *(("PEPXIM-IPT-NETFLOW-MIB", "iptNetflowModuleGroup"),
        ("PEPXIM-IPT-NETFLOW-MIB", "iptNetflowSysctlGroup"),
        ("PEPXIM-IPT-NETFLOW-MIB", "iptNetflowTotalsGroup"),
        ("PEPXIM-IPT-NETFLOW-MIB", "iptNetflowCpuGroup"),
        ("PEPXIM-IPT-NETFLOW-MIB", "iptNetflowSockGroup"))
)
if mibBuilder.loadTexts:
