...
mibBuilder.exportSymbols("FS-SMI", switch=switch, fsExperiment=fsExperiment, fsModules=fsModules, switchMib=switchMib, fsAgentCapability=fsAgentCapability, fsSwitchProducts=fsSwitchProducts, fsMgmt=fsMgmt, products=products, PYSNMP_MODULE_ID=switchMib, fs=fs)
