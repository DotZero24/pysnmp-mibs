# SNMP MIB module (ARICENT-MIFS-IPVX-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MIFS-IPVX-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:43:22 2025
...
fsMIIpvxAddrPrefixEntry = _FsMIIpvxAddrPrefixEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 34, 1, 1)
)
fsMIIpvxAddrPrefixEntry.setIndexNames(
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxAddrPrefixIfIndex"),
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxAddrPrefixAddrType"),
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxAddrPrefix"),
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxAddrPrefixLen"),
)
if mibBuilder.loadTexts:
...
fsMIIpvxTraceConfigEntry = _FsMIIpvxTraceConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 34, 2, 1)
)
fsMIIpvxTraceConfigEntry.setIndexNames(
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxTraceConfigIndex"),
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxTraceConfigAddrType"),
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxTraceConfigDest"),
)
if mibBuilder.loadTexts:
...
fsMIIpvxTraceTable = _FsMIIpvxTraceTable_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 34, 3)
)
if mibBuilder.loadTexts:
    fsMIIpvxTraceTable.setStatus("current")
_FsMIIpvxTraceEntry_Object = MibTableRow
fsMIIpvxTraceEntry = _FsMIIpvxTraceEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 34, 3, 1)
)
fsMIIpvxTraceEntry.setIndexNames(
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxTraceAddrType"),
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxTraceAddr"),
    (0, "ARICENT-MIFS-IPVX-MIB", "fsMIIpvxTraceHopCount"),
)
if mibBuilder.loadTexts:
