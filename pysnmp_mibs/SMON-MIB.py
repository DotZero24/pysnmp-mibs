...
# Notes
# -----
# ASN.1 source file://mibs/rfc/SMON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:18:44 2025
...
smonMIBCompliance.setObjects(
      *(("SMON-MIB", "dataSourceCapsGroup"),
        ("SMON-MIB", "smonVlanStatsGroup"),
        ("SMON-MIB", "smonPrioStatsGroup"),
        ("SMON-MIB", "portCopyConfigGroup"),
        ("SMON-MIB", "smonInformationGroup"),
        ("SMON-MIB", "smonHcTo100mbGroup"),
        ("SMON-MIB", "smonHc100mbPlusGroup"))
)
if mibBuilder.loadTexts:
...
smonMIBVlanStatsCompliance.setObjects(
      *(("SMON-MIB", "dataSourceCapsGroup"),
        ("SMON-MIB", "smonVlanStatsGroup"),
        ("SMON-MIB", "smonInformationGroup"),
        ("SMON-MIB", "hcVlanTo100mbGroup"),
        ("SMON-MIB", "hcVlan100mbPlusGroup"))
)
if mibBuilder.loadTexts:
...
smonMIBPrioStatsCompliance.setObjects(
      *(("SMON-MIB", "dataSourceCapsGroup"),
        ("SMON-MIB", "smonPrioStatsGroup"),
        ("SMON-MIB", "smonInformationGroup"),
        ("SMON-MIB", "hcPrioTo100mbGroup"),
        ("SMON-MIB", "hcPrio100mbPlusGroup"))
)
if mibBuilder.loadTexts:
