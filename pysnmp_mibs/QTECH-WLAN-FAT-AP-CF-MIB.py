# SNMP MIB module (QTECH-WLAN-FAT-AP-CF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-WLAN-FAT-AP-CF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:58:28 2025
...
apStandardSysTraps = _ApStandardSysTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0)
)
...
apCurrentIpAddr = _ApCurrentIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 1, 2),
...
apIpAddr = _ApIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 1, 3),
    _ApIpAddr_Type()
)
...
apTimeStamp = _ApTimeStamp_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 1, 4),
    _ApTimeStamp_Type()
)
...
apAPMac = _ApAPMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 1, 5),
    _ApAPMac_Type()
)
...
apSSIDKey = _ApSSIDKey_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 1, 6),
    _ApSSIDKey_Type()
)
...
apSSIDKeyConflict = _ApSSIDKeyConflict_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 1, 7),
...
apCyperIndex = _ApCyperIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 1, 8),
    _ApCyperIndex_Type()
)
...
apStandardRadioTraps = _ApStandardRadioTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2)
)
...
apWorkingAPRadioIfInfo = _ApWorkingAPRadioIfInfo_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 2),
...
apWorkingAPChannel = _ApWorkingAPChannel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 3),
...
apInterfAPChannel = _ApInterfAPChannel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 4),
...
apInterfAPBSSID = _ApInterfAPBSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 5),
...
apInterfStaMac = _ApInterfStaMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 6),
...
apPermitAssoUser = _ApPermitAssoUser_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 7),
...
apAssoFailReason = _ApAssoFailReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 8),
...
apChannelBeforeChange = _ApChannelBeforeChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 9),
...
apChannelAfterChange = _ApChannelAfterChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 10),
...
apChanChangeMode = _ApChanChangeMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 3, 11),
...
apStandardTerminalTraps = _ApStandardTerminalTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 4)
)
...
apWorkingAPSSID = _ApWorkingAPSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 5, 2),
...
apStaMacAddr = _ApStaMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 5, 3),
    _ApStaMacAddr_Type()
)
...
apAuthMode = _ApAuthMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 5, 4),
    _ApAuthMode_Type()
)
...
apAuthFailReason = _ApAuthFailReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 5, 5),
...
apSysNetID = _ApSysNetID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 1),
    _ApSysNetID_Type()
)
...
apSysHostName = _ApSysHostName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 2),
    _ApSysHostName_Type()
)
...
apSysDescr = _ApSysDescr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 3),
    _ApSysDescr_Type()
)
...
apManufacturer = _ApManufacturer_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 4),
...
apSerialNumber = _ApSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 5),
...
apSysModel = _ApSysModel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 6),
    _ApSysModel_Type()
)
...
apSysTime = _ApSysTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 7),
    _ApSysTime_Type()
)
...
apSysUpTime = _ApSysUpTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 8),
    _ApSysUpTime_Type()
)
...
apSysIPAddress = _ApSysIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 9),
...
apSysIPNetMask = _ApSysIPNetMask_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 10),
...
apSysGWAddr = _ApSysGWAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 11),
    _ApSysGWAddr_Type()
)
...
apPrimDNSServerIPAdd = _ApPrimDNSServerIPAdd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 12),
...
apSeconDNSServerIPAdd = _ApSeconDNSServerIPAdd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 13),
...
apSysMacAddress = _ApSysMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 14),
...
apReadCommunityName = _ApReadCommunityName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 15),
...
apWriteCommunityName = _ApWriteCommunityName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 16),
...
apStatWindowTime = _ApStatWindowTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 17),
...
apSampleTime = _ApSampleTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 18),
    _ApSampleTime_Type()
)
...
apSysRestart = _ApSysRestart_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 19),
    _ApSysRestart_Type()
)
...
apSysReset = _ApSysReset_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 20),
    _ApSysReset_Type()
)
...
apSoftwareName = _ApSoftwareName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 21),
...
apSoftwareVersion = _ApSoftwareVersion_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 22),
...
apSoftwareVendor = _ApSoftwareVendor_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 23),
...
apCPUType = _ApCPUType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 24),
    _ApCPUType_Type()
)
...
apMemoryType = _ApMemoryType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 25),
    _ApMemoryType_Type()
)
...
apMemorySize = _ApMemorySize_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 26),
    _ApMemorySize_Type()
)
...
apFlashSize = _ApFlashSize_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 1, 27),
    _ApFlashSize_Type()
)
...
apWiredInterfaceCfgTable = _ApWiredInterfaceCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2)
)
if mibBuilder.loadTexts:
...
apWiredInterfaceCfgEntry = _ApWiredInterfaceCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2, 1)
)
...
apIfDescr = _ApIfDescr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2, 1, 1),
    _ApIfDescr_Type()
)
...
apIfType = _ApIfType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2, 1, 2),
    _ApIfType_Type()
)
...
apIfMTU = _ApIfMTU_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2, 1, 3),
    _ApIfMTU_Type()
)
...
apIfSpeed = _ApIfSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2, 1, 4),
    _ApIfSpeed_Type()
)
...
apIfPhysAddress = _ApIfPhysAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2, 1, 5),
...
apIfAdminStatus = _ApIfAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2, 1, 6),
...
apIfOperStatus = _ApIfOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2, 1, 7),
...
apIfLastChange = _ApIfLastChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 2, 2, 1, 8),
...
apRadioInterfaceInfoEntry = _ApRadioInterfaceInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1)
)
...
apRadioIfDescr = _ApRadioIfDescr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 1),
...
apRadioIfType = _ApRadioIfType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 2),
    _ApRadioIfType_Type()
)
...
apRadioIfMTU = _ApRadioIfMTU_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 3),
    _ApRadioIfMTU_Type()
)
...
apRadioIfSpeed = _ApRadioIfSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 4),
...
apRadioIfMacAddress = _ApRadioIfMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 5),
...
apRadioIfDiversity = _ApRadioIfDiversity_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 6),
...
apRadioIfAdminStatus = _ApRadioIfAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 7),
...
apRadioIfOperStatus = _ApRadioIfOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 8),
...
apRadioIfLastChange = _ApRadioIfLastChange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 9),
...
apRadioChannelAutoSelectEnable = _ApRadioChannelAutoSelectEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 10),
...
apRadioChannelConfig = _ApRadioChannelConfig_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 11),
...
apRadioChannelUsing = _ApRadioChannelUsing_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 12),
...
apCurrRadioModeSupport = _ApCurrRadioModeSupport_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 13),
...
apRadioModeConfig = _ApRadioModeConfig_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 14),
...
apTransmitSpeedConfig = _ApTransmitSpeedConfig_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 15),
...
apMaxTxPwrLvl = _ApMaxTxPwrLvl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 16),
    _ApMaxTxPwrLvl_Type()
)
...
apTxPwr = _ApTxPwr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 17),
    _ApTxPwr_Type()
)
...
apPwrAttRange = _ApPwrAttRange_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 18),
    _ApPwrAttRange_Type()
)
...
apPwrAttValue = _ApPwrAttValue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 19),
    _ApPwrAttValue_Type()
)
...
apAntennaGain = _ApAntennaGain_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 20),
    _ApAntennaGain_Type()
)
...
apPowerMgmtEnable = _ApPowerMgmtEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 21),
...
apMaxStationNumPermitted = _ApMaxStationNumPermitted_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 22),
...
apAMPDUEnabled = _ApAMPDUEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 23),
...
apBWMode = _ApBWMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 24),
    _ApBWMode_Type()
)
...
apShortGIEnabled = _ApShortGIEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 25),
...
apIs11nOnly = _ApIs11nOnly_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 1, 1, 26),
    _ApIs11nOnly_Type()
)
...
apRadioInterfacePhyParaTable = _ApRadioInterfacePhyParaTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 2)
)
if mibBuilder.loadTexts:
...
apRadioInterfacePhyParaEntry = _ApRadioInterfacePhyParaEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 2, 1)
)
...
apBeaconIntvl = _ApBeaconIntvl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 2, 1, 1),
    _ApBeaconIntvl_Type()
)
...
apDtimIntvl = _ApDtimIntvl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 2, 1, 2),
    _ApDtimIntvl_Type()
)
...
apRtsThreshold = _ApRtsThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 2, 1, 3),
...
apFragThreshlod = _ApFragThreshlod_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 2, 1, 4),
...
apPreambleLen = _ApPreambleLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 3, 2, 1, 5),
    _ApPreambleLen_Type()
)
...
apRadioIfSSIDCfgTable = _ApRadioIfSSIDCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 2)
)
if mibBuilder.loadTexts:
...
apRadioIfSSIDCfgEntry = _ApRadioIfSSIDCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 2, 1)
)
apRadioIfSSIDCfgEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "QTECH-WLAN-FAT-AP-CF-MIB", "apWlanId"),
)
if mibBuilder.loadTexts:
...
apBSSID = _ApBSSID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 2, 1, 1),
    _ApBSSID_Type()
)
...
apWlanId = _ApWlanId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 1),
    _ApWlanId_Type()
)
...
apSSIDName = _ApSSIDName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 2),
    _ApSSIDName_Type()
)
...
apSSIDEnabled = _ApSSIDEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 3),
    _ApSSIDEnabled_Type()
)
...
apSSIDHidden = _ApSSIDHidden_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 4),
    _ApSSIDHidden_Type()
)
...
apStaIsolate = _ApStaIsolate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 5),
    _ApStaIsolate_Type()
)
...
apDot11Auth = _ApDot11Auth_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 6),
    _ApDot11Auth_Type()
)
...
apSecurity = _ApSecurity_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 7),
    _ApSecurity_Type()
)
...
apAuthenMode = _ApAuthenMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 8),
    _ApAuthenMode_Type()
)
...
apSecurityCiphers = _ApSecurityCiphers_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 9),
...
apVlanId = _ApVlanId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 10),
    _ApVlanId_Type()
)
...
apMaxSimultUsers = _ApMaxSimultUsers_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 11),
...
apStaUplinkMaxRate = _ApStaUplinkMaxRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 12),
...
apStaDwlinkMaxRate = _ApStaDwlinkMaxRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 13),
...
apSSIDCfgStatus = _ApSSIDCfgStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 4, 3, 1, 14),
...
apWEPCipherKeyIndex = _ApWEPCipherKeyIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 5, 1, 1, 1),
...
apWEPCipherKeyValue = _ApWEPCipherKeyValue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 5, 1, 1, 2),
...
apWEPCipherKeyCharType = _ApWEPCipherKeyCharType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 5, 1, 1, 3),
...
apPSKCipherKeyValue = _ApPSKCipherKeyValue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 5, 1, 1, 4),
...
apPSKCipherKeyCharType = _ApPSKCipherKeyCharType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 5, 1, 1, 5),
...
apWAPIASIPAddress = _ApWAPIASIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 5, 1, 1, 6),
...
apWAPIIsInstalledCer = _ApWAPIIsInstalledCer_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 5, 1, 1, 7),
...
apTerminalInfoEntry = _ApTerminalInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1)
)
apTerminalInfoEntry.setIndexNames(
    (0, "QTECH-WLAN-FAT-AP-CF-MIB", "apStaMAC"),
)
if mibBuilder.loadTexts:
...
apStaMAC = _ApStaMAC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 1),
    _ApStaMAC_Type()
)
...
apStaWMMAttr = _ApStaWMMAttr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 2),
    _ApStaWMMAttr_Type()
)
...
apStaIPAddress = _ApStaIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 3),
...
apStaRadioMode = _ApStaRadioMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 4),
...
apStaRadioChannel = _ApStaRadioChannel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 5),
...
apStaTxRates = _ApStaTxRates_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 6),
    _ApStaTxRates_Type()
)
...
apStaPowerSaveMode = _ApStaPowerSaveMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 7),
...
apStaVlanId = _ApStaVlanId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 8),
    _ApStaVlanId_Type()
)
...
apStaSSIDName = _ApStaSSIDName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 9),
    _ApStaSSIDName_Type()
)
...
apStaDot11Auth = _ApStaDot11Auth_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 10),
...
apStaSecurity = _ApStaSecurity_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 11),
    _ApStaSecurity_Type()
)
...
apStaAuthenMode = _ApStaAuthenMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 12),
...
apStaSecurityCiphers = _ApStaSecurityCiphers_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 6, 1, 1, 13),
...
apQosRadioIfCfgEntry = _ApQosRadioIfCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 1, 1)
)
apQosRadioIfCfgEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "QTECH-WLAN-FAT-AP-CF-MIB", "apQoSTrafficClassIndex"),
)
if mibBuilder.loadTexts:
...
apQoSTrafficClassIndex = _ApQoSTrafficClassIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 1, 1, 1),
...
apQosAIFS = _ApQosAIFS_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 1, 1, 2),
    _ApQosAIFS_Type()
)
...
apQoSCWmin = _ApQoSCWmin_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 1, 1, 3),
    _ApQoSCWmin_Type()
)
...
apQoSCWmax = _ApQoSCWmax_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 1, 1, 4),
    _ApQoSCWmax_Type()
)
...
apQoSTXOPLim = _ApQoSTXOPLim_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 1, 1, 5),
    _ApQoSTXOPLim_Type()
)
...
apQoSBaseTrafficClass = _ApQoSBaseTrafficClass_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 1),
...
apQoSEnabled = _ApQoSEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 2),
    _ApQoSEnabled_Type()
)
...
apQoSBW = _ApQoSBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 3),
    _ApQoSBW_Type()
)
...
apQoSResPercent = _ApQoSResPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 4),
...
apQoSsharedBW = _ApQoSsharedBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 5),
    _ApQoSsharedBW_Type()
)
...
apQoSsharedBWPercent = _ApQoSsharedBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 6),
...
apSchedAlgName = _ApSchedAlgName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 7),
...
apResPolicyEnabled = _ApResPolicyEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 8),
...
apResPolicyName = _ApResPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 9),
...
apBackgroundSvcAvgSpeed = _ApBackgroundSvcAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 10),
...
apBackgroundSvcMaxBurst = _ApBackgroundSvcMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 11),
...
apBackgroundSvcPriority = _ApBackgroundSvcPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 12),
...
apBackgroundSvcResPriority = _ApBackgroundSvcResPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 13),
...
apBestEffortSvcAvgSpeed = _ApBestEffortSvcAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 14),
...
apBestEffortSvcMaxBurst = _ApBestEffortSvcMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 15),
...
apBestEffortSvcPriority = _ApBestEffortSvcPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 16),
...
apBestEffortSvcResPriority = _ApBestEffortSvcResPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 17),
...
apVoiceSvcAvgSpeed = _ApVoiceSvcAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 18),
...
apVoiceSvcMaxBurst = _ApVoiceSvcMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 19),
...
apVoiceSvcPriority = _ApVoiceSvcPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 20),
...
apVoiceSvcResPriority = _ApVoiceSvcResPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 21),
...
apVideoSvcAvgSpeed = _ApVideoSvcAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 22),
...
apVideoSvcMaxBurst = _ApVideoSvcMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 23),
...
apVideoSvcPriority = _ApVideoSvcPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 24),
...
apVideoSvcResPriority = _ApVideoSvcResPriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 2, 1, 25),
...
apQosBackgroundCfgTable = _ApQosBackgroundCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 3)
)
if mibBuilder.loadTexts:
...
apQosBackgroundCfgEntry = _ApQosBackgroundCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 3, 1)
)
...
apBgMaxSvcCnt = _ApBgMaxSvcCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 3, 1, 1),
    _ApBgMaxSvcCnt_Type()
)
...
apBgSvcBW = _ApBgSvcBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 3, 1, 2),
    _ApBgSvcBW_Type()
)
...
apBgSvcBWPercent = _ApBgSvcBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 3, 1, 3),
...
apBgIsUseWREDAlg = _ApBgIsUseWREDAlg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 3, 1, 4),
...
apBgIsUseTrafficShaping = _ApBgIsUseTrafficShaping_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 3, 1, 5),
...
apQosBestEffortCfgTable = _ApQosBestEffortCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 4)
)
if mibBuilder.loadTexts:
...
apQosBestEffortCfgEntry = _ApQosBestEffortCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 4, 1)
)
...
apBeMaxSvcCnt = _ApBeMaxSvcCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 4, 1, 1),
    _ApBeMaxSvcCnt_Type()
)
...
apBeSvcBW = _ApBeSvcBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 4, 1, 2),
    _ApBeSvcBW_Type()
)
...
apBeSvcBWPercent = _ApBeSvcBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 4, 1, 3),
...
apBeIsUseWREDAlg = _ApBeIsUseWREDAlg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 4, 1, 4),
...
apBeIsUseTrafficShaping = _ApBeIsUseTrafficShaping_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 4, 1, 5),
...
apVoiceMaxSvcCnt = _ApVoiceMaxSvcCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 5, 1, 1),
...
apVoiceSvcBW = _ApVoiceSvcBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 5, 1, 2),
    _ApVoiceSvcBW_Type()
)
...
apVoiceSvcBWPercent = _ApVoiceSvcBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 5, 1, 3),
...
apVoiceIsUseStreamBasedQueue = _ApVoiceIsUseStreamBasedQueue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 5, 1, 4),
...
apVoiceStreamMaxQueueLen = _ApVoiceStreamMaxQueueLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 5, 1, 5),
...
apVoiceStreamAvgSpeed = _ApVoiceStreamAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 5, 1, 6),
...
apVoiceStreamMaxBurst = _ApVoiceStreamMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 5, 1, 7),
...
apVoiceIsUseWREDAlg = _ApVoiceIsUseWREDAlg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 5, 1, 8),
...
apVoiceIsUseTrafficShaping = _ApVoiceIsUseTrafficShaping_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 5, 1, 9),
...
apVedioMaxSvcCnt = _ApVedioMaxSvcCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 6, 1, 1),
...
apVedioSvcBW = _ApVedioSvcBW_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 6, 1, 2),
    _ApVedioSvcBW_Type()
)
...
apVedioSvcBWPercent = _ApVedioSvcBWPercent_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 6, 1, 3),
...
apVedioIsUseStreamBasedQueue = _ApVedioIsUseStreamBasedQueue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 6, 1, 4),
...
apVedioStreamMaxQueueLen = _ApVedioStreamMaxQueueLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 6, 1, 5),
...
apVedioStreamAvgSpeed = _ApVedioStreamAvgSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 6, 1, 6),
...
apVedioStreamMaxBurst = _ApVedioStreamMaxBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 6, 1, 7),
...
apVedioIsUseWREDAlg = _ApVedioIsUseWREDAlg_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 6, 1, 8),
...
apVedioIsUseTrafficShaping = _ApVedioIsUseTrafficShaping_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 7, 6, 1, 9),
...
apWapiProtocolCfgEntry = _ApWapiProtocolCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1)
)
...
apConfigVersion = _ApConfigVersion_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 1),
...
apControlledAuthControl = _ApControlledAuthControl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 2),
...
apControlledPortControl = _ApControlledPortControl_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 3),
...
apWapiOptionImplemented = _ApWapiOptionImplemented_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 4),
...
apWapiPreauthImplemented = _ApWapiPreauthImplemented_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 5),
...
apWapiEnabled = _ApWapiEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 6),
    _ApWapiEnabled_Type()
)
...
apWapiPreauthEnabled = _ApWapiPreauthEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 7),
...
apUnicastKeysSupported = _ApUnicastKeysSupported_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 8),
...
apUnicastRekeyMethod = _ApUnicastRekeyMethod_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 9),
...
apUnicastRekeyTime = _ApUnicastRekeyTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 10),
...
apUnicastRekeyPackets = _ApUnicastRekeyPackets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 11),
...
apMulticastCipher = _ApMulticastCipher_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 12),
...
apMulticastRekeyMethod = _ApMulticastRekeyMethod_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 13),
...
apMulticastRekeyTime = _ApMulticastRekeyTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 14),
...
apMulticastRekeyPackets = _ApMulticastRekeyPackets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 15),
...
apMulticastRekeyStrict = _ApMulticastRekeyStrict_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 16),
...
apPSKValue = _ApPSKValue_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 17),
    _ApPSKValue_Type()
)
...
apPSKPassPhrase = _ApPSKPassPhrase_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 18),
...
apCertificateUpdateCount = _ApCertificateUpdateCount_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 19),
...
apMulticastUpdateCount = _ApMulticastUpdateCount_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 20),
...
apUnicastUpdateCount = _ApUnicastUpdateCount_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 21),
...
apMulticastCipherSize = _ApMulticastCipherSize_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 22),
...
apBKLifetime = _ApBKLifetime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 23),
    _ApBKLifetime_Type()
)
...
apBKReauthThreshold = _ApBKReauthThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 24),
...
apSATimeout = _ApSATimeout_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 25),
    _ApSATimeout_Type()
)
...
apAuthSuiteSelected = _ApAuthSuiteSelected_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 26),
...
apUnicastCipherSelected = _ApUnicastCipherSelected_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 27),
...
apMulticastCipherSelected = _ApMulticastCipherSelected_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 28),
...
apBKIDUsed = _ApBKIDUsed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 29),
    _ApBKIDUsed_Type()
)
...
apAuthSuiteRequested = _ApAuthSuiteRequested_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 30),
...
apUnicastCipherRequested = _ApUnicastCipherRequested_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 31),
...
apMulticastCipherRequested = _ApMulticastCipherRequested_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 1, 1, 32),
...
apWapiUnicastCfgTable = _ApWapiUnicastCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 2)
)
if mibBuilder.loadTexts:
...
apWapiUnicastCfgEntry = _ApWapiUnicastCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 2, 1)
)
...
apUnicastCipher = _ApUnicastCipher_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 2, 1, 1),
...
apUnicastCipherEnabled = _ApUnicastCipherEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 2, 1, 2),
...
apUnicastCipherSize = _ApUnicastCipherSize_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 2, 1, 3),
...
apAuthenticationSuite = _ApAuthenticationSuite_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 3, 1, 1),
...
apAuthenticationSuiteEnabled = _ApAuthenticationSuiteEnabled_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 8, 3, 1, 2),
...
apSyslogReportEventLevel = _ApSyslogReportEventLevel_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 9, 2),
...
apSyslogSvrCfgTable = _ApSyslogSvrCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 9, 3)
)
if mibBuilder.loadTexts:
...
apSyslogSvrCfgEntry = _ApSyslogSvrCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 9, 3, 1)
)
apSyslogSvrCfgEntry.setIndexNames(
    (0, "QTECH-WLAN-FAT-AP-CF-MIB", "apSyslogSvrIndex"),
)
if mibBuilder.loadTexts:
...
apSyslogSvrIndex = _ApSyslogSvrIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 9, 3, 1, 1),
...
apSyslogServerAddr = _ApSyslogServerAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 9, 3, 1, 2),
...
apSyslogStatus = _ApSyslogStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 9, 3, 1, 3),
...
apFileName = _ApFileName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 10, 2),
    _ApFileName_Type()
)
...
apFileType = _ApFileType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 10, 3),
    _ApFileType_Type()
)
...
apTransProtocol = _ApTransProtocol_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 10, 4),
...
apServerAddr = _ApServerAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 10, 5),
    _ApServerAddr_Type()
)
...
apServerPort = _ApServerPort_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 10, 6),
    _ApServerPort_Type()
)
...
apServerUsername = _ApServerUsername_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 10, 7),
...
apServerPasswd = _ApServerPasswd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 10, 8),
...
apTransStatus = _ApTransStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 10, 9),
    _ApTransStatus_Type()
)
...
apFailReason = _ApFailReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 10, 10),
    _ApFailReason_Type()
)
...
apCfgFileFileName = _ApCfgFileFileName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 11, 2),
...
apCfgFileFileType = _ApCfgFileFileType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 11, 3),
...
apCfgFileTransProtocol = _ApCfgFileTransProtocol_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 11, 4),
...
apCfgFileServerAddr = _ApCfgFileServerAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 11, 5),
...
apCfgFileServerPort = _ApCfgFileServerPort_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 11, 6),
...
apCfgFileServerUsername = _ApCfgFileServerUsername_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 11, 7),
...
apCfgFileServerPasswd = _ApCfgFileServerPasswd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 11, 8),
...
apCfgFileTransStatus = _ApCfgFileTransStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 11, 9),
...
apCfgFileFailReason = _ApCfgFileFailReason_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 11, 10),
...
apTerminalPermitEntry = _ApTerminalPermitEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 12, 1, 1)
)
apTerminalPermitEntry.setIndexNames(
    (0, "QTECH-WLAN-FAT-AP-CF-MIB", "apWhiteListIndex"),
)
if mibBuilder.loadTexts:
...
apWhiteListIndex = _ApWhiteListIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 12, 1, 1, 1),
...
apPermitMAC = _ApPermitMAC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 12, 1, 1, 2),
    _ApPermitMAC_Type()
)
...
apWhiteListStatus = _ApWhiteListStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 12, 1, 1, 3),
...
apTerminalDeniedTable = _ApTerminalDeniedTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 12, 2)
)
if mibBuilder.loadTexts:
...
apTerminalDeniedEntry = _ApTerminalDeniedEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 12, 2, 1)
)
apTerminalDeniedEntry.setIndexNames(
    (0, "QTECH-WLAN-FAT-AP-CF-MIB", "apBlackListIndex"),
)
if mibBuilder.loadTexts:
...
apBlackListIndex = _ApBlackListIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 12, 2, 1, 1),
...
apAttackDeviceMAC = _ApAttackDeviceMAC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 12, 2, 1, 2),
...
apBlackListStatus = _ApBlackListStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 12, 2, 1, 3),
...
apTrapConfig = _ApTrapConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13)
)
...
apTrapResendWaitingTime = _ApTrapResendWaitingTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 1),
...
apCPUusageThreshhd = _ApCPUusageThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 2),
...
apMemUsageThreshhd = _ApMemUsageThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 3),
...
apAPCoInterfThreshhd = _ApAPCoInterfThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 4),
...
apAPNeiborInterfThreshhd = _ApAPNeiborInterfThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 5),
...
apStaInterfNumThreshhd = _ApStaInterfNumThreshhd_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 6),
...
apHeartbeatOnOff = _ApHeartbeatOnOff_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 7),
...
apHeartbeatPeriod = _ApHeartbeatPeriod_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 8),
...
apTrapDesAddrIndex = _ApTrapDesAddrIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 9, 1, 1),
...
apTrapDesIPAddress = _ApTrapDesIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 9, 1, 2),
...
apTrapAddrStatus = _ApTrapAddrStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 9, 1, 3),
...
apTrapEnabledIndex = _ApTrapEnabledIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 10, 1, 1),
...
apTrapName = _ApTrapName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 10, 1, 2),
    _ApTrapName_Type()
)
...
apTrapDescr = _ApTrapDescr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 10, 1, 3),
    _ApTrapDescr_Type()
)
...
apTrapOnOff = _ApTrapOnOff_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 13, 10, 1, 4),
    _ApTrapOnOff_Type()
)
...
apVlanCfgVlanId = _ApVlanCfgVlanId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 14, 10, 1, 1),
...
apVlanCfgStatus = _ApVlanCfgStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 8, 14, 10, 1, 2),
...
apCPUAvgUsage = _ApCPUAvgUsage_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 1, 2),
    _ApCPUAvgUsage_Type()
)
...
apMemRTUsage = _ApMemRTUsage_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 1, 3),
    _ApMemRTUsage_Type()
)
...
apMemAvgUsage = _ApMemAvgUsage_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 1, 4),
    _ApMemAvgUsage_Type()
)
...
apApStationOnlineSum = _ApApStationOnlineSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 2, 2),
...
apAssocTimes = _ApAssocTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 2, 3),
    _ApAssocTimes_Type()
)
...
apAssocFailTimes = _ApAssocFailTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 2, 4),
...
apReassocTimes = _ApReassocTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 2, 5),
...
apPreAssCannotShiftDeassocFailSum = _ApPreAssCannotShiftDeassocFailSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 2, 6),
...
apApStatsDisassociated = _ApApStatsDisassociated_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 2, 7),
...
apAssocRejectSum = _ApAssocRejectSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 2, 8),
...
apBSSNotSupportAssocFailSum = _ApBSSNotSupportAssocFailSum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 2, 9),
...
apWiredIfPfmStatEntry = _ApWiredIfPfmStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1)
)
...
apIfInUcastPkts = _ApIfInUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 1),
...
apIfInNUcastPkts = _ApIfInNUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 2),
...
apIfInOctets = _ApIfInOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 3),
    _ApIfInOctets_Type()
)
...
apIfInDiscardPkts = _ApIfInDiscardPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 4),
...
apIfInErrors = _ApIfInErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 5),
    _ApIfInErrors_Type()
)
...
apIfOutUcastPkts = _ApIfOutUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 6),
...
apIfOutNUcastPkts = _ApIfOutNUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 7),
...
apIfOutOctets = _ApIfOutOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 8),
    _ApIfOutOctets_Type()
)
...
apIfOutDiscardPkts = _ApIfOutDiscardPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 9),
...
apIfOutErrors = _ApIfOutErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 10),
    _ApIfOutErrors_Type()
)
...
apIfUpDwnTimes = _ApIfUpDwnTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 1, 1, 11),
...
apRadioIfPfmStatTable = _ApRadioIfPfmStatTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2)
)
if mibBuilder.loadTexts:
...
apRadioIfPfmStatEntry = _ApRadioIfPfmStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1)
)
...
apAvgRxSignalStrength = _ApAvgRxSignalStrength_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 1),
...
apHighestRxSignalStrength = _ApHighestRxSignalStrength_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 2),
...
apLowestRxSignalStrength = _ApLowestRxSignalStrength_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 3),
...
apUpdownTimes = _ApUpdownTimes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 4),
    _ApUpdownTimes_Type()
)
...
apTxDataPkts = _ApTxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 5),
    _ApTxDataPkts_Type()
)
...
apRxDataPkts = _ApRxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 6),
    _ApRxDataPkts_Type()
)
...
apUplinkDataOctets = _ApUplinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 7),
...
apDwlinkDataOctets = _ApDwlinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 8),
...
apChStatsDwlinkTotRetryPkts = _ApChStatsDwlinkTotRetryPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 9),
...
apChStatsPhyErrPkts = _ApChStatsPhyErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 10),
...
apChStatsMacFcsErrPkts = _ApChStatsMacFcsErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 11),
...
apChStatsMacMicErrPkts = _ApChStatsMacMicErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 12),
...
apChStatsMacDecryptErrPkts = _ApChStatsMacDecryptErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 13),
...
apChStatsTotalErrPkts = _ApChStatsTotalErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 14),
...
apRxMgmtFrameCnt = _ApRxMgmtFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 15),
...
apRxCtrlFrameCnt = _ApRxCtrlFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 16),
...
apRxDataFrameCnt = _ApRxDataFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 17),
...
apTxMgmtFrameCnt = _ApTxMgmtFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 18),
...
apTxCtrlFrameCnt = _ApTxCtrlFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 19),
...
apTxDataFrameCnt = _ApTxDataFrameCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 20),
...
apChStatsFrameErrorCnt = _ApChStatsFrameErrorCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 21),
...
apRetryCnt = _ApRetryCnt_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 22),
    _ApRetryCnt_Type()
)
...
apCurTxPwr = _ApCurTxPwr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 23),
    _ApCurTxPwr_Type()
)
...
apAPNeighborSSIDList = _ApAPNeighborSSIDList_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 24),
...
apChanStaNum = _ApChanStaNum_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 25),
    _ApChanStaNum_Type()
)
...
apChDownUnicastFrame = _ApChDownUnicastFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 26),
...
apChDownNonUnicastFrame = _ApChDownNonUnicastFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 27),
...
apChRxAuthFrame = _ApChRxAuthFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 28),
...
apChRxAssoFrame = _ApChRxAssoFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 29),
...
apChTxAuthFrame = _ApChTxAuthFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 30),
...
apChTxAssoFrame = _ApChTxAssoFrame_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 3, 2, 1, 31),
...
apSSIDTxDataPkts = _ApSSIDTxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 4, 1, 1, 1),
...
apSSIDRxDataPkts = _ApSSIDRxDataPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 4, 1, 1, 2),
...
apSSIDUplinkDataOctets = _ApSSIDUplinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 4, 1, 1, 3),
...
apSSIDDwlinkDataOctets = _ApSSIDDwlinkDataOctets_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 4, 1, 1, 4),
...
apSSIDChStatsDwlinkTotRetryPkts = _ApSSIDChStatsDwlinkTotRetryPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 4, 1, 1, 5),
...
apSSIDApChStatsNumStations = _ApSSIDApChStatsNumStations_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 4, 1, 1, 6),
...
apStaAddress = _ApStaAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 5, 1, 1, 1),
    _ApStaAddress_Type()
)
...
apStaUpTime = _ApStaUpTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 5, 1, 1, 2),
    _ApStaUpTime_Type()
)
...
apAPReceivedStaSignalStrength = _ApAPReceivedStaSignalStrength_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 5, 1, 1, 3),
...
apAPReceiveStaSNR = _ApAPReceiveStaSNR_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 5, 1, 1, 4),
...
apStaTxPkts = _ApStaTxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 5, 1, 1, 5),
    _ApStaTxPkts_Type()
)
...
apStaTxBytes = _ApStaTxBytes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 5, 1, 1, 6),
    _ApStaTxBytes_Type()
)
...
apStaRxPkts = _ApStaRxPkts_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 5, 1, 1, 7),
    _ApStaRxPkts_Type()
)
...
apStaRxBytes = _ApStaRxBytes_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 5, 1, 1, 8),
    _ApStaRxBytes_Type()
)
...
_ApSTAAddress_Object = MibTableColumn
apSTAAddress = _ApSTAAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 1),
    _ApSTAAddress_Type()
)
apSTAAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
apVersion = _ApVersion_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 2),
    _ApVersion_Type()
)
...
apControlledPortStatus = _ApControlledPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 3),
...
apSelectedUnicastCipher = _ApSelectedUnicastCipher_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 4),
...
apWPIReplayCounters = _ApWPIReplayCounters_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 5),
...
apWPIDecryptableErrors = _ApWPIDecryptableErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 6),
...
apWPIMICErrors = _ApWPIMICErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 7),
...
apWAISignatureErrors = _ApWAISignatureErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 8),
...
apWAIHMACErrors = _ApWAIHMACErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 9),
...
apWAIAuthResultFailures = _ApWAIAuthResultFailures_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 10),
...
apWAIDiscardCounters = _ApWAIDiscardCounters_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 11),
...
apWAITimeoutCounters = _ApWAITimeoutCounters_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 12),
...
apWAIFormatErrors = _ApWAIFormatErrors_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 13),
...
apWAICertificateHandshakeFailures = _ApWAICertificateHandshakeFailures_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 14),
...
apWAIUnicastHandshakeFailures = _ApWAIUnicastHandshakeFailures_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 15),
...
apWAIMulticastHandshakeFailures = _ApWAIMulticastHandshakeFailures_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 6, 1, 1, 16),
...
apQosBasePfmStatEntry = _ApQosBasePfmStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 1, 1)
)
...
apQoSSvcQueAvgLen = _ApQoSSvcQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 1, 1, 1),
...
apQoSSvcPktLossRatio = _ApQoSSvcPktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 1, 1, 2),
...
apAvgTransSpeed = _ApAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 1, 1, 3),
...
apBackgroundQosPfmStatTable = _ApBackgroundQosPfmStatTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 2)
)
if mibBuilder.loadTexts:
...
apBackgroundQosPfmStatEntry = _ApBackgroundQosPfmStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 2, 1)
)
...
apBgQueAvgLen = _ApBgQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 2, 1, 1),
    _ApBgQueAvgLen_Type()
)
...
apBgAvgBurst = _ApBgAvgBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 2, 1, 2),
    _ApBgAvgBurst_Type()
)
...
apBgPktLossRatio = _ApBgPktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 2, 1, 3),
...
apBgAvgTransSpeed = _ApBgAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 2, 1, 4),
...
apBgSvcLoss = _ApBgSvcLoss_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 2, 1, 5),
    _ApBgSvcLoss_Type()
)
...
apBestEffortQosPfmStatTable = _ApBestEffortQosPfmStatTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 3)
)
if mibBuilder.loadTexts:
...
apBestEffortQosPfmStatEntry = _ApBestEffortQosPfmStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 3, 1)
)
...
apBeQueAvgLen = _ApBeQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 3, 1, 1),
    _ApBeQueAvgLen_Type()
)
...
apBeAvgBurst = _ApBeAvgBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 3, 1, 2),
    _ApBeAvgBurst_Type()
)
...
apBePktLossRatio = _ApBePktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 3, 1, 3),
...
apBeAvgTransSpeed = _ApBeAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 3, 1, 4),
...
apBeSvcLoss = _ApBeSvcLoss_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 3, 1, 5),
    _ApBeSvcLoss_Type()
)
...
apVoiceQosPfmStatTable = _ApVoiceQosPfmStatTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4)
)
if mibBuilder.loadTexts:
...
apVoiceQosPfmStatEntry = _ApVoiceQosPfmStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4, 1)
)
...
apVoiceQueAvgLen = _ApVoiceQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4, 1, 1),
...
apVoiceAvgBurst = _ApVoiceAvgBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4, 1, 2),
...
apVoicePktLossRatio = _ApVoicePktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4, 1, 3),
...
apVoiceAvgTransSpeed = _ApVoiceAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4, 1, 4),
...
apVoicePutThroughRatio = _ApVoicePutThroughRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4, 1, 5),
...
apVoiceDropRatio = _ApVoiceDropRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4, 1, 6),
...
apVoiceSvcLoss = _ApVoiceSvcLoss_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4, 1, 7),
...
apVoiceExceedMaxUsersRequest = _ApVoiceExceedMaxUsersRequest_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 4, 1, 8),
...
apVedioQosPfmStatTable = _ApVedioQosPfmStatTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5)
)
if mibBuilder.loadTexts:
...
apVedioQosPfmStatEntry = _ApVedioQosPfmStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5, 1)
)
...
apVedioQueAvgLen = _ApVedioQueAvgLen_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5, 1, 1),
...
apVedioAvgBurst = _ApVedioAvgBurst_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5, 1, 2),
...
apVedioPktLossRatio = _ApVedioPktLossRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5, 1, 3),
...
apVedioAvgTransSpeed = _ApVedioAvgTransSpeed_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5, 1, 4),
...
apVedioPutThroughRatio = _ApVedioPutThroughRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5, 1, 5),
...
apVedioDropRatio = _ApVedioDropRatio_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5, 1, 6),
...
apVedioSvcLoss = _ApVedioSvcLoss_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5, 1, 7),
...
apVedioExceedMaxUsersRequest = _ApVedioExceedMaxUsersRequest_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 9, 7, 5, 1, 8),
...
apConfigurationErrorTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 1)
)
if mibBuilder.loadTexts:
...
apCPUusageTooHighTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 2)
)
if mibBuilder.loadTexts:
...
apCPUusageTooHighRecovTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 3)
)
if mibBuilder.loadTexts:
...
apMemUsageTooHighTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 4)
)
if mibBuilder.loadTexts:
...
apMemUsageTooHighRecovTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 5)
)
if mibBuilder.loadTexts:
...
apSystmColdStartTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 6)
)
if mibBuilder.loadTexts:
...
apIPAddrChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 7)
)
apIPAddrChangeTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apOriginalIpAddr"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apCurrentIpAddr"))
)
if mibBuilder.loadTexts:
...
apAPMtWorkModeChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 8)
)
if mibBuilder.loadTexts:
...
apAPSWUpdateFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 9)
)
if mibBuilder.loadTexts:
...
apSSIDkeyConflictTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 10)
)
apSSIDkeyConflictTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apAPMac"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apSSIDKey"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apSSIDKeyConflict"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apCyperIndex"))
)
if mibBuilder.loadTexts:
...
apFatAPHeartbeatTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 0, 11)
)
apFatAPHeartbeatTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apIpAddr"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apTimeStamp"))
)
if mibBuilder.loadTexts:
...
apAPCoInterfDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 1)
)
apAPCoInterfDetectedTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPChannel"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apInterfAPBSSID"))
)
if mibBuilder.loadTexts:
...
apAPCoInterfClearTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 2)
)
...
apAPNerborInterfDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 3)
)
apAPNerborInterfDetectedTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPChannel"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apInterfAPBSSID"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apInterfAPChannel"))
)
if mibBuilder.loadTexts:
...
apAPNeiborInterfClearTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 4)
)
...
apStaInterfDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 5)
)
apStaInterfDetectedTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPChannel"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apInterfStaMac"))
)
if mibBuilder.loadTexts:
...
apStaInterfClearTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 6)
)
...
apOtherDeviceInterfDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 7)
)
...
apOtherDevInterfClearTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 8)
)
...
apRadioDownTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 9)
)
apRadioDownTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apInterruptReason"))
)
if mibBuilder.loadTexts:
...
apRadioDownRecovTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 10)
)
...
apAPStaFullTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 11)
)
apAPStaFullTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apPermitAssoUser"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apAssoFailReason"))
)
if mibBuilder.loadTexts:
...
apAPStaFullRecoverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 12)
)
...
apAPMtRdoChanlChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 2, 13)
)
apAPMtRdoChanlChgTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apChannelBeforeChange"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apChannelAfterChange"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apChanChangeMode"))
)
if mibBuilder.loadTexts:
...
apStaAuthErrorTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 4, 1)
)
apStaAuthErrorTrap.setObjects(
      *(("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPRadioIfInfo"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPBSSID"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apWorkingAPSSID"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apStaMacAddr"),
        ("QTECH-WLAN-FAT-AP-CF-MIB", "apAuthMode"),
...
apStAssociationFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 4, 2)
)
...
apRadiusAuthServerUnavailableTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 6, 1)
)
if mibBuilder.loadTexts:
...
apRadiusAuthServerAvailableTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 6, 2)
)
if mibBuilder.loadTexts:
...
apRadioAccServerUnavailableTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 6, 3)
)
if mibBuilder.loadTexts:
...
apRadiusAccServerAvailableTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 6, 4)
)
if mibBuilder.loadTexts:
...
apUserWithInvalidCerficationInbreakNetworkTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 7, 1)
)
...
apStationRepititiveAttackTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 7, 2)
)
...
apTamperAttackTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 7, 3)
)
...
apLowSafeLevelAttackTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 7, 4)
)
...
apAddressRedirectionAttackTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 80, 7, 5)
)
