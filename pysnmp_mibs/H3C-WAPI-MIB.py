...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-WAPI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:20:22 2025
...
h3cwapiTrapInfoAPMacAddr = _H3cwapiTrapInfoAPMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 77, 4, 1, 5),
    _H3cwapiTrapInfoAPMacAddr_Type()
)
h3cwapiTrapInfoAPMacAddr.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cwapiTrapInfoAPMacAddr.setStatus("current")
...
h3cwapiUserwithInvalidCertificate.setObjects(
      *(("IF-MIB", "ifIndex"),
        ...
        ("H3C-WAPI-MIB", "h3cwapiTrapInfoAPMacAddr"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"h3cwapiMIB": h3cwapiMIB,
       ...
       "h3cwapiTrapInfoAPMacAddr": h3cwapiTrapInfoAPMacAddr}
)
