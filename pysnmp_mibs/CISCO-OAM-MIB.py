...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-OAM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:42:17 2025
...
_OamLoopbackPingTrapOnCompletion_Type.__name__ = "TruthValue"
...
ciscoOamPingMIBCompliance.setObjects(
    ("CISCO-OAM-MIB", "ciscoOamPingMIBGroup")
)
if mibBuilder.loadTexts:
...
ciscoOamPingMIBCompliance2.setObjects(
      *(("CISCO-OAM-MIB", "ciscoOamPing2MIBGroup"),
        ("CISCO-OAM-MIB", "oamLoopbackNotificationsGroup"),
        ("CISCO-OAM-MIB", "ciscoOamPingSegEndPointGroup"))
)
if mibBuilder.loadTexts:
...
ciscoOamPingMIBCompliance3.setObjects(
      *(("CISCO-OAM-MIB", "ciscoOamPingMIBGroupRev3"),
        ("CISCO-OAM-MIB", "oamLoopbackNotificationsGroup"),
        ("CISCO-OAM-MIB", "ciscoOamPingSegEndPointGroup"))
)
if mibBuilder.loadTexts:
