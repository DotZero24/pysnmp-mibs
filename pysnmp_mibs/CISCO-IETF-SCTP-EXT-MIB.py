...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-SCTP-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:15 2025
...
_CSctpAddressStateNotifEnabled_Type.__name__ = "TruthValue"
...
cSctpExtCompliance.setObjects(
      *(("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtStatGroup"),
        ("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtCtrlGroup"),
        ("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtAssocCtrlGroup"),
        ("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtAssocStatGroup"),
        ("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtAssocRemAddrGroup"))
)
if mibBuilder.loadTexts:
...
cSctpExtComplianceRev1.setObjects(
      *(("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtStatGroup"),
        ("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtAssocCtrlGroup"),
        ("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtAssocRemAddrGroup"),
        ("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtAssocNotificationsGroup"),
        ("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtCtrlGroupRev1"),
        ("CISCO-IETF-SCTP-EXT-MIB", "cSctpExtAssocStatGroupRev1"))
)
if mibBuilder.loadTexts:
