...
cSctpAssocRemAddressEntry, cSctpAssocEntry, cSctpAssocRemAddressStatus = mibBuilder.importSymbols("CISCO-IETF-SCTP-MIB", "cSctpAssocRemAddressEntry", "cSctpAssocEntry", "cSctpAssocRemAddressStatus")
...
mibBuilder.exportSymbols("CISCO-IETF-SCTP-EXT-MIB", cSctpAssocExtBundleTimeout=cSctpAssocExtBundleTimeout, cSctpAssocExtRtxChunksFast=cSctpAssocExtRtxChunksFast, cSctpAssocExtMTU=cSctpAssocExtMTU, cSctpAssocExtChunksSentControl=cSctpAssocExtChunksSentControl, cSctpAddressStateNotifEnabled=cSctpAddressStateNotifEnabled, cSctpAssocExtTable=cSctpAssocExtTable, cSctpStatDestAddressFailures=cSctpStatDestAddressFailures, cSctpExtDestAddressStateChange=cSctpExtDestAddressStateChange, cSctpExtCtrlGroup=cSctpExtCtrlGroup, cSctpCtrlMaxHeld=cSctpCtrlMaxHeld, cSctpAssocExtValCookieLife=cSctpAssocExtValCookieLife, cSctpAssocRemAddressFailedCnt=cSctpAssocRemAddressFailedCnt, cSctpAssocExtBundleFlag=cSctpAssocExtBundleFlag, cSctpExtTables=cSctpExtTables, cSctpExtAssocStatGroup=cSctpExtAssocStatGroup, cSctpExtConformance=cSctpExtConformance, cSctpAssocExtRtoMin=cSctpAssocExtRtoMin, cSctpAssocExtChunksSentUnOrdered=cSctpAssocExtChunksSentUnOrdered, cSctpExtAssocCtrlGroup=cSctpExtAssocCtrlGroup, cSctpExtGroups=cSctpExtGroups, cSctpAssocRemAddressSRTT=cSctpAssocRemAddressSRTT, cSctpAssocExtChunksRecOrdered=cSctpAssocExtChunksRecOrdered, cSctpAssocExtMaxInitRetr=cSctpAssocExtMaxInitRetr, cSctpExtCompliance=cSctpExtCompliance, cSctpExtAssocNotificationsGroup=cSctpExtAssocNotificationsGroup, cSctpExtCtrlGroupRev1=cSctpExtCtrlGroupRev1, cSctpAssocExtRtoMax=cSctpAssocExtRtoMax, cSctpAssocExtLocRecWnd=cSctpAssocExtLocRecWnd, cSctpAssocExtLocRecWndLowMark=cSctpAssocExtLocRecWndLowMark, cSctpAssocExtUlpQueued=cSctpAssocExtUlpQueued, cSctpAssocExtEntry=cSctpAssocExtEntry, cSctpStatRtxChucksFast=cSctpStatRtxChucksFast, cSctpAssocExtDatagramsRec=cSctpAssocExtDatagramsRec, cSctpAssocExtEffectiveAddrType=cSctpAssocExtEffectiveAddrType, cSctpAssocRemAddressExtEntry=cSctpAssocRemAddressExtEntry, cSctpAssocExtDatagramsSent=cSctpAssocExtDatagramsSent, cSctpAssocExtRtoInitial=cSctpAssocExtRtoInitial, cSctpExtCompliances=cSctpExtCompliances, cSctpStatRtxChucks=cSctpStatRtxChucks, cSctpAssocExtLocRecWndZeroCnt=cSctpAssocExtLocRecWndZeroCnt, cSctpAssocExtChunksRecUnOrdered=cSctpAssocExtChunksRecUnOrdered, cSctpAssocExtRemRecWndLowMark=cSctpAssocExtRemRecWndLowMark, cSctpExtStatGroup=cSctpExtStatGroup, cSctpAssocExtEffectiveAddress=cSctpAssocExtEffectiveAddress, cSctpExtComplianceRev1=cSctpExtComplianceRev1, cSctpAssocRemAddressExtTable=cSctpAssocRemAddressExtTable, cSctpExtMIB=cSctpExtMIB, cSctpAssocExtRemRecWnd=cSctpAssocExtRemRecWnd, cSctpAssocExtUlpQueuedRT=cSctpAssocExtUlpQueuedRT, cSctpExtAssocStatGroupRev1=cSctpExtAssocStatGroupRev1, cSctpAssocExtChunksRecControl=cSctpAssocExtChunksRecControl, cSctpExtNotifications=cSctpExtNotifications, cSctpScalarsExt=cSctpScalarsExt, cSctpAssocExtRemRecWndZeroCnt=cSctpAssocExtRemRecWndZeroCnt, cSctpCtrlPurgeTimeout=cSctpCtrlPurgeTimeout, cSctpExtAssocRemAddrGroup=cSctpExtAssocRemAddrGroup, cSctpExtObjects=cSctpExtObjects, cSctpAssocExtChunksSentOrdered=cSctpAssocExtChunksSentOrdered, PYSNMP_MODULE_ID=cSctpExtMIB, cSctpAssocExtUlpQueuedHW=cSctpAssocExtUlpQueuedHW)
