...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/zhone/ZHONE-SYSTEM-MIB
...
ipIfLgId, ipIfVci, ipIfVpi, ipIfAddr = mibBuilder.importSymbols("ZHONE-COM-IP-REC-MIB", "ipIfLgId", "ipIfVci", "ipIfVpi", "ipIfAddr")
pportNumber, zhoneSlotNumber, zhoneShelfNumber, subPortNumber = mibBuilder.importSymbols("ZHONE-INTERFACE-TRANSLATION-MIB", "pportNumber", "zhoneSlotNumber", "zhoneShelfNumber", "subPortNumber")
zhoneShelfIndex, zhoneSlotIndex, zhoneModules, zhone, zhoneSystem, zhoneTrapModules = mibBuilder.importSymbols("Zhone", "zhoneShelfIndex", "zhoneSlotIndex", "zhoneModules", "zhone", "zhoneSystem", "zhoneTrapModules")
ZhoneAlarmTypeId, ZhoneIfType, ZhoneCountryCode, ZhoneCardLineType, ZhoneCardType, ZhoneFileName, ZhoneSlotValue, ZhoneAlarmSeverity, ZhoneRowStatus, ZhoneAdminString, ZhoneShelfValue = mibBuilder.importSymbols("Zhone-TC", "ZhoneAlarmTypeId", "ZhoneIfType", "ZhoneCountryCode", "ZhoneCardLineType", "ZhoneCardType", "ZhoneFileName", "ZhoneSlotValue", "ZhoneAlarmSeverity", "ZhoneRowStatus", "ZhoneAdminString", "ZhoneShelfValue")
...
mibBuilder.exportSymbols("ZHONE-SYSTEM-MIB", zhoneSystemSecondaryClockSource=zhoneSystemSecondaryClockSource, zhoneAdminAccessListTable=zhoneAdminAccessListTable, zhoneFileName=zhoneFileName, zhoneTrapAlarmId=zhoneTrapAlarmId, zhoneUserTable=zhoneUserTable, zhoneUserPassword=zhoneUserPassword, zhoneVideoSystemConfigurationIndex=zhoneVideoSystemConfigurationIndex, zhoneConfigSyncUserName=zhoneConfigSyncUserName, zhoneTrapConfigSyncResetInterval=zhoneTrapConfigSyncResetInterval, zhoneConfigSyncOverflow=zhoneConfigSyncOverflow, zhoneUserAdmin=zhoneUserAdmin, zhoneVideoSystemConfigurationEpgType=zhoneVideoSystemConfigurationEpgType, zhoneCallDetailRecOperStatus=zhoneCallDetailRecOperStatus, zhoneSntpLocalTimeZone=zhoneSntpLocalTimeZone, zhoneSystemPersistentLogging=zhoneSystemPersistentLogging, zhoneSystemConfigurationNumShelves=zhoneSystemConfigurationNumShelves, zhoneSystemConsoleLogging=zhoneSystemConsoleLogging, zhoneGroups=zhoneGroups, zhoneCompliances=zhoneCompliances, zhoneConfigSyncPriority=zhoneConfigSyncPriority, zhoneSysCardRedundancyHoldActive=zhoneSysCardRedundancyHoldActive, zhoneFileName2=zhoneFileName2, zhoneTrapCpePollV2Traps=zhoneTrapCpePollV2Traps, zhoneTrapConfigSyncResetLastFtpTime=zhoneTrapConfigSyncResetLastFtpTime, ZhoneRedundancyWeight=ZhoneRedundancyWeight, zhoneZmsBlockCliChange=zhoneZmsBlockCliChange, zhoneSysCardLineVoltage=zhoneSysCardLineVoltage, zhoneSysCardVpiVciRange=zhoneSysCardVpiVciRange, zhoneSntpDaylightSavingTime=zhoneSntpDaylightSavingTime, zhoneTrapCpePoll=zhoneTrapCpePoll, zhoneSysSwPriLoadServer=zhoneSysSwPriLoadServer, zhoneSysCardAtmConfiguration=zhoneSysCardAtmConfiguration, zhoneZmsBlockCli=zhoneZmsBlockCli, zhoneTrapConfigSyncResetCount=zhoneTrapConfigSyncResetCount, zhoneBulkStatOID=zhoneBulkStatOID, zhoneUserLogins=zhoneUserLogins, zhoneBulkStatsSystemOperStatus=zhoneBulkStatsSystemOperStatus, zhoneSystemConfigurationShelvesArray=zhoneSystemConfigurationShelvesArray, zhoneSysCardSwType=zhoneSysCardSwType, zhoneTrapsDestination=zhoneTrapsDestination, zhoneFileName1=zhoneFileName1, zhoneTrapsCommunityName=zhoneTrapsCommunityName, zhoneUserIdNext=zhoneUserIdNext, zhoneSysCardUpgradeSwFileName=zhoneSysCardUpgradeSwFileName, zhoneSoftwareUpgradeTimeCompleted=zhoneSoftwareUpgradeTimeCompleted, zhoneTrapConfigSyncV2Traps=zhoneTrapConfigSyncV2Traps, zhoneAdminCommunityName=zhoneAdminCommunityName, zhoneSysSwSecLoadServer=zhoneSysSwSecLoadServer, zhoneTrapUtcTime=zhoneTrapUtcTime, zhoneTrapCpeConnectionUp=zhoneTrapCpeConnectionUp, zhoneSoftwareLoadEntry=zhoneSoftwareLoadEntry, zhoneVideoSystemConfigurationEpgServerAddress=zhoneVideoSystemConfigurationEpgServerAddress, zhoneSnmpErrorTime=zhoneSnmpErrorTime, zhoneSystemConfigurationOptions=zhoneSystemConfigurationOptions, zhoneSysCardRowStatus=zhoneSysCardRowStatus, zhoneTrapsAckedSequenceNumber=zhoneTrapsAckedSequenceNumber, zhoneSysCardSoftwareConfigEntry=zhoneSysCardSoftwareConfigEntry, zhoneVideoSystemConfigurationDefaultChannelAddress=zhoneVideoSystemConfigurationDefaultChannelAddress, zhoneTrapText=zhoneTrapText, zhoneNextAdminAccessIndex=zhoneNextAdminAccessIndex, zhoneBulkStatCollection=zhoneBulkStatCollection, zhoneFileLastModified=zhoneFileLastModified, zhoneSystemConfigurationDateAndTime=zhoneSystemConfigurationDateAndTime, zhoneSystemClockWeight=zhoneSystemClockWeight, zhoneSysSwRemoteFilePath=zhoneSysSwRemoteFilePath, zhoneAdminCommunityTable=zhoneAdminCommunityTable, zhoneSystemWebInterface=zhoneSystemWebInterface, zhoneSysRebootAdmin=zhoneSysRebootAdmin, zhoneSystemClockTxClockMode=zhoneSystemClockTxClockMode, zhoneBulkStatsSystemCollectionEnabled=zhoneBulkStatsSystemCollectionEnabled, zhoneFileDirectoryPath=zhoneFileDirectoryPath, zhoneVideoSystemConfigurationIndexNext=zhoneVideoSystemConfigurationIndexNext, zhoneCallDetailRecFtpPassword=zhoneCallDetailRecFtpPassword, zhoneTrapSnmpV2Traps=zhoneTrapSnmpV2Traps, zhoneSysCardSpecificSwFileName=zhoneSysCardSpecificSwFileName, zhoneSystemConfigurationAlternateIpAddress=zhoneSystemConfigurationAlternateIpAddress, zhonePrimaryClockSource=zhonePrimaryClockSource, zhoneSystemOutletTemperatureHighThreshold=zhoneSystemOutletTemperatureHighThreshold, zhoneAdminAccessListIpAddress=zhoneAdminAccessListIpAddress, zhoneSoftwareDownload=zhoneSoftwareDownload, zhoneBulkStatsSystemFtpDirPath=zhoneBulkStatsSystemFtpDirPath, zhoneSystemConfigurationIpAddress=zhoneSystemConfigurationIpAddress, nextBulkStatCollectionId=nextBulkStatCollectionId, zhoneSysCardRedundancyTable=zhoneSysCardRedundancyTable, zhoneTrapCpeConnectionDown=zhoneTrapCpeConnectionDown, zhoneEnhancedStatusIndex=zhoneEnhancedStatusIndex, zhoneSysSwAdmin=zhoneSysSwAdmin, zhoneTrapsAllowedCategories=zhoneTrapsAllowedCategories, zhoneSystemVoiceBandwidthCheck=zhoneSystemVoiceBandwidthCheck, zhoneTrapConfigSyncReset=zhoneTrapConfigSyncReset, zhoneBulkStatEnabled=zhoneBulkStatEnabled, zhoneSystemSecureFTP=zhoneSystemSecureFTP, zhoneVideoSystemConfigurationTable=zhoneVideoSystemConfigurationTable, zhoneTrapsSeverity=zhoneTrapsSeverity, zhoneAdminCommunityAccessListIndex=zhoneAdminCommunityAccessListIndex, zhoneFilePrivilege=zhoneFilePrivilege, zhoneSnmpErrorReqId=zhoneSnmpErrorReqId, zhoneZmsExists=zhoneZmsExists, zhoneTrapSnmpSATimeout=zhoneTrapSnmpSATimeout, zhoneVideoSystemConfiguration=zhoneVideoSystemConfiguration, zhoneSystemClockTable=zhoneSystemClockTable, zhoneVideoSystemConfigurationEntry=zhoneVideoSystemConfigurationEntry, zhoneTrapAlarmAction=zhoneTrapAlarmAction, zhoneUserName=zhoneUserName, zhoneSystemClockEntry=zhoneSystemClockEntry, zhoneVideoSystemConfigurationEpgPort=zhoneVideoSystemConfigurationEpgPort, zhoneSysCardRedundancyEntry=zhoneSysCardRedundancyEntry, zhoneCallDetailRecEnabled=zhoneCallDetailRecEnabled, zhoneTrapsAdminStatus=zhoneTrapsAdminStatus, zhoneSysCardWettingCurrent=zhoneSysCardWettingCurrent, zhoneAdminAccessRowStatus=zhoneAdminAccessRowStatus, zhoneCardRedundancyStatusChange=zhoneCardRedundancyStatusChange, zhoneEnhancedStatusCode=zhoneEnhancedStatusCode, zhoneFileSize=zhoneFileSize, zhoneVideoSystemConfigurationSettopBoxHeadEndServerAddress=zhoneVideoSystemConfigurationSettopBoxHeadEndServerAddress, zhoneTrapBulkStatistics=zhoneTrapBulkStatistics, zhoneUserTotalFailedLogins=zhoneUserTotalFailedLogins, zhoneBulkStatCollectionRowStatus=zhoneBulkStatCollectionRowStatus, zhoneTraps=zhoneTraps, zhoneTrapSlot=zhoneTrapSlot, zhoneSystemConfigurationCountryRegion=zhoneSystemConfigurationCountryRegion, zhoneSystemConfiguration=zhoneSystemConfiguration, zhoneBulkStatsCollectionInterval=zhoneBulkStatsCollectionInterval, zhoneSoftwareUpgradeStatus=zhoneSoftwareUpgradeStatus, zhoneDeprecatedTrapGroup=zhoneDeprecatedTrapGroup, zhoneSnmpErrorDisplayString=zhoneSnmpErrorDisplayString, zhoneSystemClockAvailabilityStatus=zhoneSystemClockAvailabilityStatus, zhoneTrapCardRedundancy=zhoneTrapCardRedundancy, zhoneSwLoadRowStatus=zhoneSwLoadRowStatus, zhoneSnmpErrorIpAddress=zhoneSnmpErrorIpAddress, zhoneTrapPortTypeExtension=zhoneTrapPortTypeExtension, zhoneSysCardSwSpecificVers=zhoneSysCardSwSpecificVers, zhoneConfigSyncAction=zhoneConfigSyncAction, zhoneEnhancedStatusText=zhoneEnhancedStatusText, zhoneBulkStatsSystemFtpPassword=zhoneBulkStatsSystemFtpPassword, zhoneSysCardInitString=zhoneSysCardInitString, zhoneSystemRadiusAuthIndex=zhoneSystemRadiusAuthIndex, zhoneAdminAccessListEntry=zhoneAdminAccessListEntry, zhoneCallDetailRecFtpDirPath=zhoneCallDetailRecFtpDirPath, zhoneTrapGroup=zhoneTrapGroup, zhoneSystemModule=zhoneSystemModule, zhoneAdminCommunityRowStatus=zhoneAdminCommunityRowStatus, zhoneSystemUserAuthMethod=zhoneSystemUserAuthMethod, zhoneSoftwareUpgradeAction=zhoneSoftwareUpgradeAction, zhoneBytesReservedForProvisioning=zhoneBytesReservedForProvisioning, cpeMgr=cpeMgr, zhoneSwCardSwFileName=zhoneSwCardSwFileName, zhoneSysCardRedundancyOperStatus=zhoneSysCardRedundancyOperStatus, zhoneSoftwareReboot=zhoneSoftwareReboot, zhoneSntpConfiguration=zhoneSntpConfiguration, zhoneUserPrompt=zhoneUserPrompt, zhoneSntpSecondaryServerIpAddr=zhoneSntpSecondaryServerIpAddr, zhoneCallDetailRecConfig=zhoneCallDetailRecConfig, zhoneSysCardLineType=zhoneSysCardLineType, zhoneTrapsSequenceNumber=zhoneTrapsSequenceNumber, zhoneSysCardRedundancyRowStatus=zhoneSysCardRedundancyRowStatus, zhoneAdmin=zhoneAdmin, zhoneSntpDaylightSavingStart=zhoneSntpDaylightSavingStart, zhoneVideoSystemConfigurationNoChannelAvailableAddress=zhoneVideoSystemConfigurationNoChannelAvailableAddress, zhoneDirectoryPath=zhoneDirectoryPath, zhoneBulkStatIncludeChildren=zhoneBulkStatIncludeChildren, zhoneVideoSystemConfigurationNtpServerAddress=zhoneVideoSystemConfigurationNtpServerAddress, zhoneEnhancedStatus=zhoneEnhancedStatus, zhoneUserRowStatus=zhoneUserRowStatus, zhoneAdslPotsMaxActiveBypassRelays=zhoneAdslPotsMaxActiveBypassRelays, zhoneSysCardSwEnable=zhoneSysCardSwEnable, zhoneSysCardRedundancyGroupId=zhoneSysCardRedundancyGroupId, PYSNMP_MODULE_ID=zhoneSystemModule, zhoneTrapsTable=zhoneTrapsTable, zhoneTrapsGatewayTrapServerAddress=zhoneTrapsGatewayTrapServerAddress, zhoneSysSwPassword=zhoneSysSwPassword, zhoneAlarmLevelsEnabled=zhoneAlarmLevelsEnabled, zhoneZms=zhoneZms, zhoneFileEntry=zhoneFileEntry, zhoneUserFailedLogins=zhoneUserFailedLogins, zhoneUserEntry=zhoneUserEntry, zhoneUserAccessLevel=zhoneUserAccessLevel, zhoneCallDetailRecSecFtpIpAddr=zhoneCallDetailRecSecFtpIpAddr, zhoneBulkStatCollectionTable=zhoneBulkStatCollectionTable, zhoneCardRedundancyV2Traps=zhoneCardRedundancyV2Traps, zhoneCallDetailRecPrimFtpIpAddr=zhoneCallDetailRecPrimFtpIpAddr, zhoneSystemClockEligibility=zhoneSystemClockEligibility, zhoneTrapConfigSync=zhoneTrapConfigSync, zhoneSysSwStatus=zhoneSysSwStatus, zhoneZmsIpAddress=zhoneZmsIpAddress, zhoneTrapsResendSequenceNumber=zhoneTrapsResendSequenceNumber, zhoneUser=zhoneUser, zhoneUserId=zhoneUserId, zhoneSystemOutletTemperatureLowThreshold=zhoneSystemOutletTemperatureLowThreshold, zhoneSntpDaylightSavingEnd=zhoneSntpDaylightSavingEnd, zhoneBulkStatCollectionId=zhoneBulkStatCollectionId, zhoneTrapConfigSyncChange=zhoneTrapConfigSyncChange, zhoneSnmpErrorEntry=zhoneSnmpErrorEntry, zhoneSystemRevertiveClockSource=zhoneSystemRevertiveClockSource, zhoneSysCardSoftwareConfigTable=zhoneSysCardSoftwareConfigTable, zhoneBulkStatisticsIntervalFailure=zhoneBulkStatisticsIntervalFailure, zhoneCardRedundancy=zhoneCardRedundancy, zhoneAdminCommunityAccess=zhoneAdminCommunityAccess, zhoneBulkStatsSystemFtpAddress=zhoneBulkStatsSystemFtpAddress, zhoneBulkStatInstance=zhoneBulkStatInstance, zhoneBulkStatsSystemConfiguration=zhoneBulkStatsSystemConfiguration, zhoneFileSystem=zhoneFileSystem, zhoneBulkStatsSystemFtpLogin=zhoneBulkStatsSystemFtpLogin, zhoneTrapProviderId=zhoneTrapProviderId, zhoneBulkStatisticsV2Traps=zhoneBulkStatisticsV2Traps, zhoneEnhancedStatusTable=zhoneEnhancedStatusTable, zhoneZmsConnectionStatus=zhoneZmsConnectionStatus, zhoneEnhancedStatusEntry=zhoneEnhancedStatusEntry, zhoneConfigSyncUserPassword=zhoneConfigSyncUserPassword, zhoneSystemSnmpVersion=zhoneSystemSnmpVersion, zhoneBulkStatCollectionEntry=zhoneBulkStatCollectionEntry, zhoneDirectoryBytesAvailable=zhoneDirectoryBytesAvailable, zhoneTrapsRowStatus=zhoneTrapsRowStatus, zhoneConfigSyncFileName=zhoneConfigSyncFileName, zhoneSystemConfigurationReservedVlanIdStart=zhoneSystemConfigurationReservedVlanIdStart, zhoneVideoSystemConfigurationRowStatus=zhoneVideoSystemConfigurationRowStatus, zhoneConfigSync=zhoneConfigSync, zhoneTrapSnmp=zhoneTrapSnmp, zhoneTrapShelf=zhoneTrapShelf, zhoneFileAction=zhoneFileAction, zhoneSysSwLogin=zhoneSysSwLogin, zhoneSoftwareLoadTable=zhoneSoftwareLoadTable, zhoneSystemCurrentClockSource=zhoneSystemCurrentClockSource, zhoneAdslPotsBypassRelayResetAll=zhoneAdslPotsBypassRelayResetAll, nextCardRedundancyGroupId=nextCardRedundancyGroupId, zhoneVideoSystemConfigurationEpgFtpAddress=zhoneVideoSystemConfigurationEpgFtpAddress, zhoneSystemConfigurationRingSource=zhoneSystemConfigurationRingSource, zhoneConfigSyncExists=zhoneConfigSyncExists, zhoneFileTable=zhoneFileTable, zhoneSystemConfigurationNumCards=zhoneSystemConfigurationNumCards, zhoneCallDetailRecCurrFtpServer=zhoneCallDetailRecCurrFtpServer, zhoneTrapSubPort=zhoneTrapSubPort, zhoneTrapsEntry=zhoneTrapsEntry, zhoneSoftwareUpgrade=zhoneSoftwareUpgrade, zhoneSnmpErrorTable=zhoneSnmpErrorTable, zhoneAdminCommunityEntry=zhoneAdminCommunityEntry, zhoneTrapPort=zhoneTrapPort, zhoneSntpPrimaryServerIpAddr=zhoneSntpPrimaryServerIpAddr, zhoneSysRebootCardType=zhoneSysRebootCardType, zhoneSysCardSwUpgradeEnable=zhoneSysCardSwUpgradeEnable, zhoneCallDetailRecFlushLog=zhoneCallDetailRecFlushLog, zhoneSystemConfigurationReservedVlanIdCount=zhoneSystemConfigurationReservedVlanIdCount, zhoneSystemGroup=zhoneSystemGroup, zhoneTrapVersion=zhoneTrapVersion, zhoneTrapFlags=zhoneTrapFlags, zhoneTrapConfigSyncResetCurrentTime=zhoneTrapConfigSyncResetCurrentTime, zhoneAdslPotsBypassRelay=zhoneAdslPotsBypassRelay, zhoneSysCardSwUpgradeVers=zhoneSysCardSwUpgradeVers, zhoneSysCardRedundancyWeight=zhoneSysCardRedundancyWeight, zhoneTrapPortType=zhoneTrapPortType, zhoneCardRedundancyUnsafe=zhoneCardRedundancyUnsafe, zhoneSoftwareUpgradeTimeStarted=zhoneSoftwareUpgradeTimeStarted, zhoneTrapZms=zhoneTrapZms, zhoneFileIndex=zhoneFileIndex)
mibBuilder.exportSymbols("ZHONE-SYSTEM-MIB", zhoneAdminAccessListIndex=zhoneAdminAccessListIndex, zhoneTrapZmsV2Traps=zhoneTrapZmsV2Traps, zhoneCallDetailRecFtpLogin=zhoneCallDetailRecFtpLogin, zhoneTrapAlarmSeverity=zhoneTrapAlarmSeverity, zhoneCallDetailRecRepPeriod=zhoneCallDetailRecRepPeriod, zhoneConfigSyncStatus=zhoneConfigSyncStatus, zhoneDeprecatedSystemGroup=zhoneDeprecatedSystemGroup, zhoneSysSwLocalFilePath=zhoneSysSwLocalFilePath, ZhoneLocalTimeZone=ZhoneLocalTimeZone, zhoneSwCardType=zhoneSwCardType)
