...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IPMROUTE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:58 2025
...
ciscoIpMRouteMIBCompliance.setObjects(
    ("CISCO-IPMROUTE-MIB", "ciscoIpMRouteMIBGroup")
)
if mibBuilder.loadTexts:
...
ciscoIpMRouteMIBComplianceV11R01.setObjects(
    ("CISCO-IPMROUTE-MIB", "ciscoIpMRouteMIBGroupV11R01")
)
if mibBuilder.loadTexts:
...
ciscoIpMRouteMIBComplianceV12R00S.setObjects(
    ("CISCO-IPMROUTE-MIB", "ciscoIpMRouteMIBGroupV12R00S")
)
if mibBuilder.loadTexts:
...
ciscoIpMRouteMIBComplianceV12R28S.setObjects(
      *(("CISCO-IPMROUTE-MIB", "ciscoIpMRouteMIBGroupV12R28S"),
        ("CISCO-IPMROUTE-MIB", "ciscoIpMRouteMIBIfGroup"))
)
if mibBuilder.loadTexts:
