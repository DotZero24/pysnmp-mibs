...
zhoneModules, zhoneCard, zhoneShelfIndex, zhoneSlotIndex = mibBuilder.importSymbols("Zhone", "zhoneModules", "zhoneCard", "zhoneShelfIndex", "zhoneSlotIndex")
...
mibBuilder.exportSymbols("ZHONE-CARD-RESOURCES-MIB", zhoneExternalRelayTable=zhoneExternalRelayTable, cardServicesTable=cardServicesTable, zhoneCardServices=zhoneCardServices, zrgResources=zrgResources, standbyServiceSlot=standbyServiceSlot, zhoneTrapCardMemGroup=zhoneTrapCardMemGroup, ZhoneServiceId=ZhoneServiceId, cardAtmManualAal2bw=cardAtmManualAal2bw, znidBatteryStatus=znidBatteryStatus, zhoneCardServicesStatusChange=zhoneCardServicesStatusChange, activeServiceShelf=activeServiceShelf, activeServiceChangeTime=activeServiceChangeTime, zrgBatterRelayTrapV2=zrgBatterRelayTrapV2, cardProcessorFrameworkUsage=cardProcessorFrameworkUsage, cardLineVoltage=cardLineVoltage, cardProcessorUsage=cardProcessorUsage, znidNotificationGroup=znidNotificationGroup, cardVpiVciRange=cardVpiVciRange, cardProcessorHighUsage=cardProcessorHighUsage, zhoneExternalAlarmTrapGroup=zhoneExternalAlarmTrapGroup, zrgBatteryRelayStatus=zrgBatteryRelayStatus, cardResourceTable=cardResourceTable, cardMfgRevisionCode=cardMfgRevisionCode, activeServicesEntry=activeServicesEntry, cardMfgSerialNumber=cardMfgSerialNumber, zrgTrapBatteryRelay=zrgTrapBatteryRelay, cardMfgBootRevision=cardMfgBootRevision, cardSwUpgradeVers=cardSwUpgradeVers, cardRuntimeEntry=cardRuntimeEntry, znidNotificationObjects=znidNotificationObjects, cardRuntimeTable=cardRuntimeTable, zhoneMxkAlarmInputTrap=zhoneMxkAlarmInputTrap, cardProcessorLowUsage=cardProcessorLowUsage, znidOjectGroup=znidOjectGroup, zhoneExternalRelayId=zhoneExternalRelayId, zhoneTrapCardServices=zhoneTrapCardServices, zhoneTrapCardServicesV2Traps=zhoneTrapCardServicesV2Traps, cardProcessorIdle=cardProcessorIdle, activeServiceSlot=activeServiceSlot, cardSwStatus=cardSwStatus, zhoneExternalRelayState=zhoneExternalRelayState, znidSerialNumber=znidSerialNumber, cardOperStatus=cardOperStatus, cardSwAdmin=cardSwAdmin, zhoneExternalRelayName=zhoneExternalRelayName, zhoneTrapExternalRelay=zhoneTrapExternalRelay, zhoneCardResourcesModule=zhoneCardResourcesModule, zhoneExternalRelayNormalState=zhoneExternalRelayNormalState, zhoneTrapCardMemV2Traps=zhoneTrapCardMemV2Traps, znidResources=znidResources, cardZhoneType=cardZhoneType, zhoneCardCompliances=zhoneCardCompliances, zhoneTrapExternalRelayV2Traps=zhoneTrapExternalRelayV2Traps, cardPortStatus=cardPortStatus, zhoneTrapCardMemStatus=zhoneTrapCardMemStatus, standbyServiceChangeTime=standbyServiceChangeTime, zhoneTrapProcessorUsage=zhoneTrapProcessorUsage, cardAdminStatus=cardAdminStatus, activeServicesTable=activeServicesTable, PYSNMP_MODULE_ID=zhoneCardResourcesModule, zhoneExternalRelayGroup=zhoneExternalRelayGroup, zhoneCardResourcesGroup=zhoneCardResourcesGroup, Kbytes=Kbytes, cardTotalMem=cardTotalMem, znidBatteryStatusNotification=znidBatteryStatusNotification, cardPeakMemUsage=cardPeakMemUsage, cardUpTime=cardUpTime, cardAtmManualAal2h=cardAtmManualAal2h, cardProcessorServicesUsage=cardProcessorServicesUsage, standbyServicesEntry=standbyServicesEntry, zhoneExternalRelayEntry=zhoneExternalRelayEntry, cardMfgCLEICode=cardMfgCLEICode, zhoneExternalRelayMappingTable=zhoneExternalRelayMappingTable, znidNotifications=znidNotifications, cardInterfaceType=cardInterfaceType, cardServiceInstance=cardServiceInstance, cardServiceId=cardServiceId, cardServiceChangeTime=cardServiceChangeTime, cardResourceEntry=cardResourceEntry, cardPostResults=cardPostResults, zrgBatteryRelayNotification=zrgBatteryRelayNotification, cardMemStatus=cardMemStatus, cardServiceStatus=cardServiceStatus, cardIdentification=cardIdentification, cardProcessorType=cardProcessorType, zhoneExternalRelay=zhoneExternalRelay, cardAdminStatsEnable=cardAdminStatsEnable, standbyServicesTable=standbyServicesTable, zhoneCardServicesStandbyReady=zhoneCardServicesStandbyReady, cardServicesEntry=cardServicesEntry, cardAvailMem=cardAvailMem, zhoneExternalAlarmTrap=zhoneExternalAlarmTrap, cardSoftwareTable=cardSoftwareTable, cardSwRunningVers=cardSwRunningVers, cardPweTimingMode=cardPweTimingMode, standbyServiceShelf=standbyServiceShelf, cardSoftwareEntry=cardSoftwareEntry, zhoneExternalRelayMappingEntry=zhoneExternalRelayMappingEntry, zhoneCardGroups=zhoneCardGroups)
