...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/zhone/ZHONE-CARD-RESOURCES-MIB
...
ZhoneAdminString, ZhoneDiagAction, ZhoneCardType = mibBuilder.importSymbols("Zhone-TC", "ZhoneAdminString", "ZhoneDiagAction", "ZhoneCardType")
...
mibBuilder.exportSymbols("ZHONE-CARD-RESOURCES-MIB", cardSoftwareEntry=cardSoftwareEntry, cardPostResults=cardPostResults, znidSerialNumber=znidSerialNumber, activeServiceChangeTime=activeServiceChangeTime, cardAdminStatus=cardAdminStatus, zrgBatteryRelayNotification=zrgBatteryRelayNotification, zhoneCardResourcesModule=zhoneCardResourcesModule, znidNotifications=znidNotifications, zhoneTrapCardServices=zhoneTrapCardServices, cardProcessorIdle=cardProcessorIdle, zhoneExternalRelayState=zhoneExternalRelayState, zrgTrapBatteryRelay=zrgTrapBatteryRelay, cardUpTime=cardUpTime, zrgResources=zrgResources, cardMfgCLEICode=cardMfgCLEICode, cardProcessorServicesUsage=cardProcessorServicesUsage, zhoneExternalRelayId=zhoneExternalRelayId, zhoneExternalRelayNormalState=zhoneExternalRelayNormalState, zrgBatteryRelayStatus=zrgBatteryRelayStatus, zhoneCardCompliances=zhoneCardCompliances, zhoneTrapCardServicesV2Traps=zhoneTrapCardServicesV2Traps, cardProcessorHighUsage=cardProcessorHighUsage, zhoneTrapCardMemStatus=zhoneTrapCardMemStatus, cardServiceStatus=cardServiceStatus, cardMfgSerialNumber=cardMfgSerialNumber, cardTotalMem=cardTotalMem, cardOperStatus=cardOperStatus, zrgBatterRelayTrapV2=zrgBatterRelayTrapV2, zhoneCardServicesStandbyReady=zhoneCardServicesStandbyReady, znidNotificationGroup=znidNotificationGroup, zhoneExternalRelayEntry=zhoneExternalRelayEntry, cardSoftwareTable=cardSoftwareTable, standbyServiceSlot=standbyServiceSlot, cardIdentification=cardIdentification, cardZhoneType=cardZhoneType, standbyServicesEntry=standbyServicesEntry, Kbytes=Kbytes, znidNotificationObjects=znidNotificationObjects, znidBatteryStatusNotification=znidBatteryStatusNotification, zhoneExternalAlarmTrap=zhoneExternalAlarmTrap, activeServiceShelf=activeServiceShelf, standbyServiceShelf=standbyServiceShelf, cardServiceInstance=cardServiceInstance, znidOjectGroup=znidOjectGroup, activeServicesEntry=activeServicesEntry, standbyServiceChangeTime=standbyServiceChangeTime, cardInterfaceType=cardInterfaceType, cardSwRunningVers=cardSwRunningVers, activeServiceSlot=activeServiceSlot, cardResourceEntry=cardResourceEntry, zhoneExternalRelayMappingEntry=zhoneExternalRelayMappingEntry, zhoneExternalRelayGroup=zhoneExternalRelayGroup, zhoneExternalRelayMappingTable=zhoneExternalRelayMappingTable, cardPeakMemUsage=cardPeakMemUsage, cardProcessorUsage=cardProcessorUsage, cardAtmManualAal2h=cardAtmManualAal2h, ZhoneServiceId=ZhoneServiceId, cardServiceChangeTime=cardServiceChangeTime, cardSwUpgradeVers=cardSwUpgradeVers, cardProcessorType=cardProcessorType, cardSwStatus=cardSwStatus, cardAdminStatsEnable=cardAdminStatsEnable, cardMemStatus=cardMemStatus, zhoneTrapCardMemGroup=zhoneTrapCardMemGroup, cardProcessorLowUsage=cardProcessorLowUsage, cardSwAdmin=cardSwAdmin, znidBatteryStatus=znidBatteryStatus, cardResourceTable=cardResourceTable, zhoneCardServicesStatusChange=zhoneCardServicesStatusChange, cardPweTimingMode=cardPweTimingMode, cardMfgRevisionCode=cardMfgRevisionCode, activeServicesTable=activeServicesTable, zhoneCardResourcesGroup=zhoneCardResourcesGroup, cardServicesEntry=cardServicesEntry, standbyServicesTable=standbyServicesTable, znidResources=znidResources, cardLineVoltage=cardLineVoltage, cardServicesTable=cardServicesTable, cardProcessorFrameworkUsage=cardProcessorFrameworkUsage, zhoneCardServices=zhoneCardServices, zhoneMxkAlarmInputTrap=zhoneMxkAlarmInputTrap, zhoneExternalRelayName=zhoneExternalRelayName, zhoneTrapExternalRelayV2Traps=zhoneTrapExternalRelayV2Traps, zhoneTrapExternalRelay=zhoneTrapExternalRelay, cardAvailMem=cardAvailMem, zhoneCardGroups=zhoneCardGroups, PYSNMP_MODULE_ID=zhoneCardResourcesModule, zhoneTrapProcessorUsage=zhoneTrapProcessorUsage, cardVpiVciRange=cardVpiVciRange, zhoneExternalAlarmTrapGroup=zhoneExternalAlarmTrapGroup, cardRuntimeEntry=cardRuntimeEntry, zhoneTrapCardMemV2Traps=zhoneTrapCardMemV2Traps, zhoneExternalRelayTable=zhoneExternalRelayTable, cardServiceId=cardServiceId, cardPortStatus=cardPortStatus, zhoneExternalRelay=zhoneExternalRelay, cardRuntimeTable=cardRuntimeTable, cardAtmManualAal2bw=cardAtmManualAal2bw, cardMfgBootRevision=cardMfgBootRevision)
