...
mibBuilder.exportSymbols("NMS-L2-PROTOCOL-TUNNEL-MIB", l2ptIntfStpTnl=l2ptIntfStpTnl, nmsL2ProtocolTunnelMIB=nmsL2ProtocolTunnelMIB, l2ptMIBObjects=l2ptMIBObjects, l2ptIntfTable=l2ptIntfTable, l2ptGlobal=l2ptGlobal, PYSNMP_MODULE_ID=nmsL2ProtocolTunnelMIB, l2ptIntfEntry=l2ptIntfEntry)
