# SNMP MIB module (ARICENT-OSPFV3-TEST-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-OSPFV3-TEST-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:42:40 2025
...
futOspfv3TestIfEntry = _FutOspfv3TestIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 301, 1, 1)
)
futOspfv3TestIfEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-TEST-MIB", "futOspfv3TestIfIndex"),
)
if mibBuilder.loadTexts:
...
futOspfv3ExtRouteEntry = _FutOspfv3ExtRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 301, 2, 1)
)
futOspfv3ExtRouteEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-TEST-MIB", "futOspfv3ExtRouteDestType"),
    (0, "ARICENT-OSPFV3-TEST-MIB", "futOspfv3ExtRouteDest"),
    (0, "ARICENT-OSPFV3-TEST-MIB", "futOspfv3ExtRoutePfxLength"),
    (0, "ARICENT-OSPFV3-TEST-MIB", "futOspfv3ExtRouteNextHopType"),
    (0, "ARICENT-OSPFV3-TEST-MIB", "futOspfv3ExtRouteNextHop"),
)
if mibBuilder.loadTexts:
