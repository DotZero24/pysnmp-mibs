...
if mibBuilder.loadTexts: fsClkIwfMIB.setOrganization('ARICENT COMMUNICATIONS SOFTWARE')
fsClkIwfObjects = MibIdentifier((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1))
fsClkIwfNotifications = MibIdentifier((1, 3, 6, 1, 4, 1, 29601, 2, 46, 2))
fsClkIwfGeneralGroup = MibIdentifier((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1))
class FsClkIwfTimeInterval(TextualConvention, OctetString):
    status = 'current'
    subtypeSpec = OctetString.subtypeSpec + ValueSizeConstraint(8, 8)
    fixedLength = 8

fsClkIwfClockVariance = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1, 1), Integer32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: fsClkIwfClockVariance.setStatus('current')
fsClkIwfClockClass = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1, 2), Integer32().clone(248)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: fsClkIwfClockClass.setStatus('current')
fsClkIwfClockAccuracy = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1, 3), Integer32().clone(254)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: fsClkIwfClockAccuracy.setStatus('current')
fsClkIwfClockTimeSource = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(16, 32, 64, 80, 160))).clone(namedValues=NamedValues(("atomicClock", 16), ("gps", 32), ("ptp", 64), ("ntp", 80), ("internalOscillator", 160))).clone('ptp')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: fsClkIwfClockTimeSource.setStatus('current')
fsClkIwfCurrentUtcOffset = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1, 5), FsClkIwfTimeInterval()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: fsClkIwfCurrentUtcOffset.setStatus('deprecated')
fsClkIwfARBTime = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1, 6), DisplayString()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: fsClkIwfARBTime.setStatus('current')
fsClkIwfHoldoverSpecification = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1, 7), TruthValue().clone('true')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: fsClkIwfHoldoverSpecification.setStatus('current')
fsClkIwfLostSync = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1, 8), TruthValue().clone('false')).setMaxAccess("readonly")
if mibBuilder.loadTexts: fsClkIwfLostSync.setStatus('current')
fsClkIwfUtcOffset = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 1, 1, 9), DisplayString()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: fsClkIwfUtcOffset.setStatus('current')
fsClkIwfTrap = MibIdentifier((1, 3, 6, 1, 4, 1, 29601, 2, 46, 2, 0))
fsClkIwfGlobalErrTrapType = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 2, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(("none", 0), ("memfail", 1), ("bufffail", 2), ("timesourcechange", 3), ("clockclasschange", 4), ("clockaccuracychange", 5), ("clockvariancechange", 6), ("holdovermodechange", 7)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: fsClkIwfGlobalErrTrapType.setStatus('current')
fsClkIwfNotification = MibScalar((1, 3, 6, 1, 4, 1, 29601, 2, 46, 2, 2), OctetString()).setMaxAccess("readwrite")
