...
nmsEAPS=_NmsEAPS_ObjectIdentity((1,3,6,1,4,1,3320,2,230))
_NmsEAPSRings_Type=Integer32
_NmsEAPSRings_Object=MibScalar
nmsEAPSRings=_NmsEAPSRings_Object((1,3,6,1,4,1,3320,2,230,1),_NmsEAPSRings_Type())
...
nmsEAPSPduRx=_NmsEAPSPduRx_Object((1,3,6,1,4,1,3320,2,230,2),_NmsEAPSPduRx_Type())
...
nmsEAPSPduTx=_NmsEAPSPduTx_Object((1,3,6,1,4,1,3320,2,230,3),_NmsEAPSPduTx_Type())
nmsEAPSPduTx.setMaxAccess(_B)
if mibBuilder.loadTexts:nmsEAPSPduTx.setStatus(_A)
_NmsEAPSRingTable_Object=MibTable
nmsEAPSRingTable=_NmsEAPSRingTable_Object((1,3,6,1,4,1,3320,2,230,4))
if mibBuilder.loadTexts:nmsEAPSRingTable.setStatus(_A)
_NmsEAPSRingTableEntry_Object=MibTableRow
nmsEAPSRingTableEntry=_NmsEAPSRingTableEntry_Object((1,3,6,1,4,1,3320,2,230,4,1))
...
nmsEAPSRingID=_NmsEAPSRingID_Object((1,3,6,1,4,1,3320,2,230,4,1,1),_NmsEAPSRingID_Type())
...
nmsEAPSRingNodeType=_NmsEAPSRingNodeType_Object((1,3,6,1,4,1,3320,2,230,4,1,2),_NmsEAPSRingNodeType_Type())
...
nmsEAPSRingControlVlan=_NmsEAPSRingControlVlan_Object((1,3,6,1,4,1,3320,2,230,4,1,3),_NmsEAPSRingControlVlan_Type())
...
nmsEAPSRingPorts=_NmsEAPSRingPorts_Object((1,3,6,1,4,1,3320,2,230,4,1,4),_NmsEAPSRingPorts_Type())
...
nmsEAPSRingState=_NmsEAPSRingState_Object((1,3,6,1,4,1,3320,2,230,4,1,5),_NmsEAPSRingState_Type())
...
nmsEAPSRingHealthCheck=_NmsEAPSRingHealthCheck_Object((1,3,6,1,4,1,3320,2,230,4,1,6),_NmsEAPSRingHealthCheck_Type())
...
nmsEAPSRingHelloTime=_NmsEAPSRingHelloTime_Object((1,3,6,1,4,1,3320,2,230,4,1,7),_NmsEAPSRingHelloTime_Type())
...
nmsEAPSRingFailTime=_NmsEAPSRingFailTime_Object((1,3,6,1,4,1,3320,2,230,4,1,8),_NmsEAPSRingFailTime_Type())
...
nmsEAPSRingPreforwardTime=_NmsEAPSRingPreforwardTime_Object((1,3,6,1,4,1,3320,2,230,4,1,9),_NmsEAPSRingPreforwardTime_Type())
...
nmsEAPSRingAdminStatus=_NmsEAPSRingAdminStatus_Object((1,3,6,1,4,1,3320,2,230,4,1,10),_NmsEAPSRingAdminStatus_Type())
...
nmsEAPSRingPrimaryPort=_NmsEAPSRingPrimaryPort_Object((1,3,6,1,4,1,3320,2,230,4,1,11),_NmsEAPSRingPrimaryPort_Type())
...
nmsEAPSRingPrimaryPortState=_NmsEAPSRingPrimaryPortState_Object((1,3,6,1,4,1,3320,2,230,4,1,12),_NmsEAPSRingPrimaryPortState_Type())
...
nmsEAPSRingPrimaryPortStatus=_NmsEAPSRingPrimaryPortStatus_Object((1,3,6,1,4,1,3320,2,230,4,1,13),_NmsEAPSRingPrimaryPortStatus_Type())
...
nmsEAPSRingSecondaryPort=_NmsEAPSRingSecondaryPort_Object((1,3,6,1,4,1,3320,2,230,4,1,14),_NmsEAPSRingSecondaryPort_Type())
...
nmsEAPSRingSecondaryPortState=_NmsEAPSRingSecondaryPortState_Object((1,3,6,1,4,1,3320,2,230,4,1,15),_NmsEAPSRingSecondaryPortState_Type())
...
nmsEAPSRingSecondaryPortStatus=_NmsEAPSRingSecondaryPortStatus_Object((1,3,6,1,4,1,3320,2,230,4,1,16),_NmsEAPSRingSecondaryPortStatus_Type())
...
nmsEAPSRingPortTable=_NmsEAPSRingPortTable_Object((1,3,6,1,4,1,3320,2,230,5))
if mibBuilder.loadTexts:nmsEAPSRingPortTable.setStatus(_A)
_NmsEAPSRingPortTableEntry_Object=MibTableRow
nmsEAPSRingPortTableEntry=_NmsEAPSRingPortTableEntry_Object((1,3,6,1,4,1,3320,2,230,5,1))
...
nmsEAPSRingPortRingID=_NmsEAPSRingPortRingID_Object((1,3,6,1,4,1,3320,2,230,5,1,1),_NmsEAPSRingPortRingID_Type())
...
nmsEAPSRingPort=_NmsEAPSRingPort_Object((1,3,6,1,4,1,3320,2,230,5,1,2),_NmsEAPSRingPort_Type())
...
nmsEAPSRingPortType=_NmsEAPSRingPortType_Object((1,3,6,1,4,1,3320,2,230,5,1,3),_NmsEAPSRingPortType_Type())
...
nmsEAPSRingPortState=_NmsEAPSRingPortState_Object((1,3,6,1,4,1,3320,2,230,5,1,4),_NmsEAPSRingPortState_Type())
...
nmsEAPSRingPortForwards=_NmsEAPSRingPortForwards_Object((1,3,6,1,4,1,3320,2,230,5,1,5),_NmsEAPSRingPortForwards_Type())
...
nmsEAPSRingPortRx=_NmsEAPSRingPortRx_Object((1,3,6,1,4,1,3320,2,230,5,1,6),_NmsEAPSRingPortRx_Type())
...
nmsEAPSRingPortTx=_NmsEAPSRingPortTx_Object((1,3,6,1,4,1,3320,2,230,5,1,7),_NmsEAPSRingPortTx_Type())
...
nmsEAPSRingPortStatus=_NmsEAPSRingPortStatus_Object((1,3,6,1,4,1,3320,2,230,5,1,8),_NmsEAPSRingPortStatus_Type())
...
nmsEAPSRingNotifications=_NmsEAPSRingNotifications_ObjectIdentity((1,3,6,1,4,1,3320,2,230,6))
nmsEAPSRingNotification=NotificationType((1,3,6,1,4,1,3320,2,230,6,1))
