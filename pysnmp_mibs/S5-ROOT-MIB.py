...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5reg=s5reg, s5FdTop=s5FdTop, PYSNMP_MODULE_ID=s5RootMib, s5Com=s5Com, remoteLoginTrap=remoteLoginTrap, s5EcellTrap=s5EcellTrap, s5TokTrap=s5TokTrap, s5EthTrap=s5EthTrap, s5ChaTrap=s5ChaTrap, bnLogMsg=bnLogMsg, s5IfExt=s5IfExt, s5RootMib=s5RootMib, s5Eth=s5Eth, s5Fddi=s5Fddi, s5Tok=s5Tok, s5FddTrap=s5FddTrap, atmTraps=atmTraps, s5Traps=s5Traps, s5EnTop=s5EnTop, stpChangeTrap=stpChangeTrap, s5Tcs=s5Tcs, s5ComTrap=s5ComTrap, s5TrTop=s5TrTop, s5EnMsTop=s5EnMsTop, s5AtmTop=s5AtmTop, s5Chassis=s5Chassis, s5Agent=s5Agent)
