...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TROPIC-PSD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:02:47 2025
...
class _TnPsdShelfIsdSwVersion_Type(SnmpAdminString):
    """Custom type tnPsdShelfIsdSwVersion based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TnPsdShelfIsdSwVersion_Type.__name__ = "SnmpAdminString"
_TnPsdShelfIsdSwVersion_Object = MibTableColumn
tnPsdShelfIsdSwVersion = _TnPsdShelfIsdSwVersion_Object(
    (1, 3, 6, 1, 4, 1, 7483, 2, 2, 7, 6, 1, 3, 1, 5),
    _TnPsdShelfIsdSwVersion_Type()
)
tnPsdShelfIsdSwVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnPsdShelfIsdSwVersion.setStatus("current")
...
tnPsdSoftwareGroup.setObjects(
      *(("TROPIC-PSD-MIB", "tnPsdSoftwareRemoteHostAddrType"),
        ...
        ("TROPIC-PSD-MIB", "tnPsdShelfIsdSwVersion"),
...
mibBuilder.exportSymbols(
    ...
    **{"TropicPsdAsapIndexType": TropicPsdAsapIndexType,
       ...
       "tnPsdShelfIsdSwVersion": tnPsdShelfIsdSwVersion,
