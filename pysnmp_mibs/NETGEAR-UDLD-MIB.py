...
fastPathUdld=ModuleIdentity((1,3,6,1,4,1,4526,10,54))
if mibBuilder.loadTexts:fastPathUdld.setRevisions(('2008-02-24 00:00',))
_AgentUdldMIBObjects_ObjectIdentity=ObjectIdentity
agentUdldMIBObjects=_AgentUdldMIBObjects_ObjectIdentity((1,3,6,1,4,1,4526,10,54,1))
_AgentUdldGlobal_ObjectIdentity=ObjectIdentity
agentUdldGlobal=_AgentUdldGlobal_ObjectIdentity((1,3,6,1,4,1,4526,10,54,1,1))
...
agentUdldGlobalMode=_AgentUdldGlobalMode_Object((1,3,6,1,4,1,4526,10,54,1,1,1),_AgentUdldGlobalMode_Type())
...
agentUdldMessageInterval=_AgentUdldMessageInterval_Object((1,3,6,1,4,1,4526,10,54,1,1,2),_AgentUdldMessageInterval_Type())
...
agentUdldTimeoutInterval=_AgentUdldTimeoutInterval_Object((1,3,6,1,4,1,4526,10,54,1,1,3),_AgentUdldTimeoutInterval_Type())
...
agentUdldReset=_AgentUdldReset_Object((1,3,6,1,4,1,4526,10,54,1,1,4),_AgentUdldReset_Type())
...
agentUdldInterface=_AgentUdldInterface_ObjectIdentity((1,3,6,1,4,1,4526,10,54,1,2))
_AgentUdldInterfaceTable_Object=MibTable
agentUdldInterfaceTable=_AgentUdldInterfaceTable_Object((1,3,6,1,4,1,4526,10,54,1,2,1))
if mibBuilder.loadTexts:agentUdldInterfaceTable.setStatus(_A)
_AgentUdldInterfaceEntry_Object=MibTableRow
agentUdldInterfaceEntry=_AgentUdldInterfaceEntry_Object((1,3,6,1,4,1,4526,10,54,1,2,1,1))
...
agentUdldInterfaceOperStatus=_AgentUdldInterfaceOperStatus_Object((1,3,6,1,4,1,4526,10,54,1,2,1,1,1),_AgentUdldInterfaceOperStatus_Type())
...
agentUdldInterfaceAdminMode=_AgentUdldInterfaceAdminMode_Object((1,3,6,1,4,1,4526,10,54,1,2,1,1,2),_AgentUdldInterfaceAdminMode_Type())
