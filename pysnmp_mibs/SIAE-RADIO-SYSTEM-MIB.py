...
# Notes
# -----
# ASN.1 source file://mibs/siaemic/SIAE-RADIO-SYSTEM-MIB
...
radioXpicAlarm = _RadioXpicAlarm_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 12, 1, 29),
    _RadioXpicAlarm_Type()
)
radioXpicAlarm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    radioXpicAlarm.setStatus("current")
...
radioEchoCancelerTable = _RadioEchoCancelerTable_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 40)
)
if mibBuilder.loadTexts:
    radioEchoCancelerTable.setStatus("current")
_RadioEchoCancelerEntry_Object = MibTableRow
radioEchoCancelerEntry = _RadioEchoCancelerEntry_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 40, 1)
)
radioEchoCancelerEntry.setIndexNames(
    (0, "SIAE-RADIO-SYSTEM-MIB", "radioIndex"),
)
if mibBuilder.loadTexts:
    radioEchoCancelerEntry.setStatus("current")


class _RadioEchoCancelerFunctionEn_Type(Integer32):
    """Custom type radioEchoCancelerFunctionEn based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_RadioEchoCancelerFunctionEn_Type.__name__ = "Integer32"
_RadioEchoCancelerFunctionEn_Object = MibTableColumn
radioEchoCancelerFunctionEn = _RadioEchoCancelerFunctionEn_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 40, 1, 1),
    _RadioEchoCancelerFunctionEn_Type()
)
radioEchoCancelerFunctionEn.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    radioEchoCancelerFunctionEn.setStatus("current")


class _RadioEchoCancelerCableLenMin_Type(Integer32):
    """Custom type radioEchoCancelerCableLenMin based on Integer32"""
    defaultValue = 0


_RadioEchoCancelerCableLenMin_Type.__name__ = "Integer32"
_RadioEchoCancelerCableLenMin_Object = MibTableColumn
radioEchoCancelerCableLenMin = _RadioEchoCancelerCableLenMin_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 40, 1, 2),
    _RadioEchoCancelerCableLenMin_Type()
)
radioEchoCancelerCableLenMin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    radioEchoCancelerCableLenMin.setStatus("current")


class _RadioEchoCancelerCableLenMax_Type(Integer32):
    """Custom type radioEchoCancelerCableLenMax based on Integer32"""
    defaultValue = 300


_RadioEchoCancelerCableLenMax_Type.__name__ = "Integer32"
_RadioEchoCancelerCableLenMax_Object = MibTableColumn
radioEchoCancelerCableLenMax = _RadioEchoCancelerCableLenMax_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 40, 1, 3),
    _RadioEchoCancelerCableLenMax_Type()
)
radioEchoCancelerCableLenMax.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    radioEchoCancelerCableLenMax.setStatus("current")


class _RadioEchoCancelerDelayLine1_Type(Integer32):
    """Custom type radioEchoCancelerDelayLine1 based on Integer32"""
    defaultValue = 0


_RadioEchoCancelerDelayLine1_Type.__name__ = "Integer32"
_RadioEchoCancelerDelayLine1_Object = MibTableColumn
radioEchoCancelerDelayLine1 = _RadioEchoCancelerDelayLine1_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 40, 1, 4),
    _RadioEchoCancelerDelayLine1_Type()
)
radioEchoCancelerDelayLine1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    radioEchoCancelerDelayLine1.setStatus("current")


class _RadioEchoCancelerDelayLine2_Type(Integer32):
    """Custom type radioEchoCancelerDelayLine2 based on Integer32"""
    defaultValue = 0


_RadioEchoCancelerDelayLine2_Type.__name__ = "Integer32"
_RadioEchoCancelerDelayLine2_Object = MibTableColumn
radioEchoCancelerDelayLine2 = _RadioEchoCancelerDelayLine2_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 40, 1, 5),
    _RadioEchoCancelerDelayLine2_Type()
)
radioEchoCancelerDelayLine2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    radioEchoCancelerDelayLine2.setStatus("current")


class _RadioEchoCancStatus_Type(Integer32):
    """Custom type radioEchoCancStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RadioEchoCancStatus_Type.__name__ = "Integer32"
_RadioEchoCancStatus_Object = MibTableColumn
radioEchoCancStatus = _RadioEchoCancStatus_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 40, 1, 6),
    _RadioEchoCancStatus_Type()
)
radioEchoCancStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    radioEchoCancStatus.setStatus("current")


class _RadioEchoCancStart_Type(Integer32):
    """Custom type radioEchoCancStart based on Integer32"""
    defaultValue = 0
...
_RadioEchoCancStart_Type.__name__ = "Integer32"
_RadioEchoCancStart_Object = MibTableColumn
radioEchoCancStart = _RadioEchoCancStart_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 40, 1, 7),
    _RadioEchoCancStart_Type()
)
radioEchoCancStart.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    radioEchoCancStart.setStatus("current")
...
class _RadioXpicAlarmSeverityCode_Type(AlarmSeverityCode):
    """Custom type radioXpicAlarmSeverityCode based on AlarmSeverityCode"""
    defaultValue = 5


_RadioXpicAlarmSeverityCode_Type.__name__ = "AlarmSeverityCode"
_RadioXpicAlarmSeverityCode_Object = MibScalar
radioXpicAlarmSeverityCode = _RadioXpicAlarmSeverityCode_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 80, 92),
    _RadioXpicAlarmSeverityCode_Type()
)
radioXpicAlarmSeverityCode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    radioXpicAlarmSeverityCode.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ChannelSpacing": ChannelSpacing,
       ...
       "radioEchoCancelerTable": radioEchoCancelerTable,
       "radioEchoCancelerEntry": radioEchoCancelerEntry,
       "radioEchoCancelerFunctionEn": radioEchoCancelerFunctionEn,
       "radioEchoCancelerCableLenMin": radioEchoCancelerCableLenMin,
       "radioEchoCancelerCableLenMax": radioEchoCancelerCableLenMax,
       "radioEchoCancelerDelayLine1": radioEchoCancelerDelayLine1,
       "radioEchoCancelerDelayLine2": radioEchoCancelerDelayLine2,
       "radioEchoCancStatus": radioEchoCancStatus,
       "radioEchoCancStart": radioEchoCancStart,
       ...
       "radioXpicAlarmSeverityCode": radioXpicAlarmSeverityCode}
)
