...
# Notes
# -----
# ASN.1 source file://mibs/tplink/TPLINK-LLDPCONFIG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:56:21 2025
...
class _LldpGlobalConfigForwardMessageEnable_Type(Integer32):
    """Custom type lldpGlobalConfigForwardMessageEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LldpGlobalConfigForwardMessageEnable_Type.__name__ = "Integer32"
_LldpGlobalConfigForwardMessageEnable_Object = MibScalar
lldpGlobalConfigForwardMessageEnable = _LldpGlobalConfigForwardMessageEnable_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 35, 1, 1, 1, 2),
    _LldpGlobalConfigForwardMessageEnable_Type()
)
lldpGlobalConfigForwardMessageEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lldpGlobalConfigForwardMessageEnable.setStatus("current")
...
lldpGlobalConfigFastCount = _LldpGlobalConfigFastCount_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 35, 1, 1, 1, 8),
...
class _LldpConfigPortManagementAddress_Type(OctetString):
    """Custom type lldpConfigPortManagementAddress based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_LldpConfigPortManagementAddress_Type.__name__ = "OctetString"
_LldpConfigPortManagementAddress_Object = MibTableColumn
lldpConfigPortManagementAddress = _LldpConfigPortManagementAddress_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 35, 1, 1, 2, 1, 16),
    _LldpConfigPortManagementAddress_Type()
)
lldpConfigPortManagementAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lldpConfigPortManagementAddress.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"MacAddress": MacAddress,
       ...
       "lldpGlobalConfigForwardMessageEnable": lldpGlobalConfigForwardMessageEnable,
       ...
       "lldpConfigPortManagementAddress": lldpConfigPortManagementAddress}
)
