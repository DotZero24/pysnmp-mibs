...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/junose/ATM-FORUM-SNMP-M4-MIB
...
atmVcCrossConnectEntry, atmVclVpi, atmVcCrossConnectL2HOperStatus, atmVpCrossConnectL2HOperStatus, atmVclVci, atmVpCrossConnectEntry, atmVplEntry, atmVpCrossConnectH2LOperStatus, atmVcCrossConnectH2LOperStatus, atmVclOperStatus, atmVplVpi, atmVclEntry, atmVplOperStatus = mibBuilder.importSymbols("ATM-MIB", "atmVcCrossConnectEntry", "atmVclVpi", "atmVcCrossConnectL2HOperStatus", "atmVpCrossConnectL2HOperStatus", "atmVclVci", "atmVpCrossConnectEntry", "atmVplEntry", "atmVpCrossConnectH2LOperStatus", "atmVcCrossConnectH2LOperStatus", "atmVclOperStatus", "atmVplVpi", "atmVclEntry", "atmVplOperStatus")
...
DisplayString, TimeInterval, TimeStamp, TruthValue, RowStatus, AutonomousType, TestAndIncr, DateAndTime, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeInterval", "TimeStamp", "TruthValue", "RowStatus", "AutonomousType", "TestAndIncr", "DateAndTime", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("ATM-FORUM-SNMP-M4-MIB", atmfM4EquipOperStatus=atmfM4EquipOperStatus, atmfM4VpXConnGroup=atmfM4VpXConnGroup, atmfM4VcUpcNpcHistSuspect=atmfM4VcUpcNpcHistSuspect, atmfM4HwStorageCapacityAlarm=atmfM4HwStorageCapacityAlarm, atmfM4VplXConnCreated=atmfM4VplXConnCreated, atmfM4EquipHolderTable=atmfM4EquipHolderTable, atmfM4TrapForwardingDest=atmfM4TrapForwardingDest, atmfM4CellProtoErrorGroup=atmfM4CellProtoErrorGroup, atmfM4IfPathTraceMismatchAlarm=atmfM4IfPathTraceMismatchAlarm, atmfM4VplSegEndPt=atmfM4VplSegEndPt, atmfM4VclSegEndPt=atmfM4VclSegEndPt, atmfM4EquipHolderGroup=atmfM4EquipHolderGroup, atmfM4EquipHolderAcceptableTypes=atmfM4EquipHolderAcceptableTypes, atmfM4HwInstalledSwSwIndex=atmfM4HwInstalledSwSwIndex, atmfM4HwExtIfDevProbAlarm=atmfM4HwExtIfDevProbAlarm, atmfM4CellProtoErrorVpi=atmfM4CellProtoErrorVpi, atmfM4VclXConnChanged=atmfM4VclXConnChanged, atmfM4VcUpcNpcCurrSuspect=atmfM4VcUpcNpcCurrSuspect, atmfM4VcUpcNpcCurrDiscardedClp0=atmfM4VcUpcNpcCurrDiscardedClp0, atmfM4VccTpDeleted=atmfM4VccTpDeleted, atmfM4NotificationsGroup=atmfM4NotificationsGroup, atmfM4HwInstalledSwIndex=atmfM4HwInstalledSwIndex, atmfM4PhysPathTpPortID=atmfM4PhysPathTpPortID, atmfM4VpUpcNpcCurrPassedClp0=atmfM4VpUpcNpcCurrPassedClp0, atmfM4VcUpcNpcCurrTable=atmfM4VcUpcNpcCurrTable, atmfM4HwFanFailAlarm=atmfM4HwFanFailAlarm, atmfM4LoggedTrapObject=atmfM4LoggedTrapObject, atmfM4ForwardAllTraps=atmfM4ForwardAllTraps, atmfM4=atmfM4, atmfM4VcUpcNpcCurrPassedClp0=atmfM4VcUpcNpcCurrPassedClp0, atmfM4HwMemoryMismatchAlarm=atmfM4HwMemoryMismatchAlarm, atmfM4NeVendor=atmfM4NeVendor, atmfM4IfRdiAlarm=atmfM4IfRdiAlarm, atmfM4TestTypes=atmfM4TestTypes, atmfM4TrapAlarmBUObject=atmfM4TrapAlarmBUObject, atmfM4TrapLogFullAction=atmfM4TrapLogFullAction, atmfM4CellProtoCurrGroup=atmfM4CellProtoCurrGroup, atmfM4VcTestCode=atmfM4VcTestCode, atmfM4TrapAlarmBackedUp=atmfM4TrapAlarmBackedUp, atmfM4TrapAlarmSpecificProb=atmfM4TrapAlarmSpecificProb, atmfM4VpTestGroup=atmfM4VpTestGroup, atmfM4LoggedAlarmGroup=atmfM4LoggedAlarmGroup, atmfM4TcAdapterEntry=atmfM4TcAdapterEntry, atmfM4VplEntry=atmfM4VplEntry, atmfM4TrapForwardingIndex=atmfM4TrapForwardingIndex, atmfM4TcProtoHistIndex=atmfM4TcProtoHistIndex, atmfM4VccTpRdiAlarm=atmfM4VccTpRdiAlarm, atmfM4HwFuseFailAlarm=atmfM4HwFuseFailAlarm, atmfM4VpTestTable=atmfM4VpTestTable, atmfM4HwInstalledSwEntry=atmfM4HwInstalledSwEntry, atmfM4VcXConnRecover=atmfM4VcXConnRecover, atmfM4PlugInUnitVendor=atmfM4PlugInUnitVendor, atmfM4HwInstalledSwHwIndex=atmfM4HwInstalledSwHwIndex, atmfM4HwCongestionAlarm=atmfM4HwCongestionAlarm, atmfM4AlarmSevProfileRowStatus=atmfM4AlarmSevProfileRowStatus, atmfM4EquipGroup=atmfM4EquipGroup, atmfM4HwSwEnvironAlarm=atmfM4HwSwEnvironAlarm, atmfM4TrapAlarmRepairAct=atmfM4TrapAlarmRepairAct, atmfM4LoggedAlarmSeverity=atmfM4LoggedAlarmSeverity, atmfM4VccTpAisAlarm=atmfM4VccTpAisAlarm, atmfM4VcUpcNpcHistDiscardedCells=atmfM4VcUpcNpcHistDiscardedCells, atmfM4HwLineCardAlarm=atmfM4HwLineCardAlarm, atmfM4InstalledSwDeleted=atmfM4InstalledSwDeleted, atmfM4TcProtoCurrGroup=atmfM4TcProtoCurrGroup, atmfM4VplXConnUp=atmfM4VplXConnUp, atmfM4AtmLayerEntry=atmfM4AtmLayerEntry, atmfM4VplXConnDown=atmfM4VplXConnDown, atmfM4VcNextVciTable=atmfM4VcNextVciTable, atmfM4CellProtoCurrEntry=atmfM4CellProtoCurrEntry, atmfM4CellProtoCurrSuspect=atmfM4CellProtoCurrSuspect, atmfM4PlugInUnitEntry=atmfM4PlugInUnitEntry, atmfM4EquipAlarmSeverityIndex=atmfM4EquipAlarmSeverityIndex, atmfM4HwInstalledSwTable=atmfM4HwInstalledSwTable, atmfM4TcProtoHistSuspect=atmfM4TcProtoHistSuspect, atmfM4EquipHolderType=atmfM4EquipHolderType, atmfM4PhysPathTpEntry=atmfM4PhysPathTpEntry, atmfM4TcProtoCurrSuspect=atmfM4TcProtoCurrSuspect, atmfM4VcUpcNpcHistElapsedTime=atmfM4VcUpcNpcHistElapsedTime, atmfM4VpTestType=atmfM4VpTestType, atmfM4VpXConnTable=atmfM4VpXConnTable, atmfM4LoggedAlarmSpecificProb=atmfM4LoggedAlarmSpecificProb, atmfM4MIBTrapPrefix=atmfM4MIBTrapPrefix, atmfM4LoggedAlarmBackedUp=atmfM4LoggedAlarmBackedUp, atmfM4HwUnitDeleted=atmfM4HwUnitDeleted, atmfM4TrapLogType=atmfM4TrapLogType, atmfM4AtmLayerGroup=atmfM4AtmLayerGroup, atmfM4HwRunningSwGroup=atmfM4HwRunningSwGroup, atmfM4CellProtoErrorCode=atmfM4CellProtoErrorCode, atmfM4TrapForwardingRowStatus=atmfM4TrapForwardingRowStatus, atmfM4VclTpAisAlarm=atmfM4VclTpAisAlarm, atmfM4VpcTpCreated=atmfM4VpcTpCreated, atmfM4TrapForwardingEntry=atmfM4TrapForwardingEntry, atmfM4HwMultiplexerAlarm=atmfM4HwMultiplexerAlarm, atmfM4PlugInUnitAlarmSeverityIndex=atmfM4PlugInUnitAlarmSeverityIndex, atmfM4IfChanged=atmfM4IfChanged, PYSNMP_MODULE_ID=atmfM4MIB, atmfM4ForwardedTrapId=atmfM4ForwardedTrapId, atmfM4VpTestOwner=atmfM4VpTestOwner, atmfM4VpUpcNpcCurrGroup=atmfM4VpUpcNpcCurrGroup, atmfM4TrapLogAdminStatus=atmfM4TrapLogAdminStatus, atmfM4VcUpcNpcCurrGroup=atmfM4VcUpcNpcCurrGroup, atmfM4LowestForwardedSeverity=atmfM4LowestForwardedSeverity, atmfM4VpTestId=atmfM4VpTestId, atmfM4AtmCellIfCreated=atmfM4AtmCellIfCreated, atmfM4VcUpcNpcHistDiscardedClp0=atmfM4VcUpcNpcHistDiscardedClp0, atmfM4EquipUserLabel=atmfM4EquipUserLabel, atmfM4Groups=atmfM4Groups, atmfM4HwSwAlarmSeverityIndex=atmfM4HwSwAlarmSeverityIndex, atmfM4VcUpcNpcCurrEntry=atmfM4VcUpcNpcCurrEntry, atmfM4LoggedTrapRowStatus=atmfM4LoggedTrapRowStatus, atmfM4PlugInUnitTable=atmfM4PlugInUnitTable, atmfM4VclXConnDown=atmfM4VclXConnDown, atmfM4TrapLogEntry=atmfM4TrapLogEntry, atmfM4VpUpcNpcCurrDiscardedCells=atmfM4VpUpcNpcCurrDiscardedCells, atmfM4TrapForwardingTable=atmfM4TrapForwardingTable, atmfM4CellProtoCurrProtoErrors=atmfM4CellProtoCurrProtoErrors, atmfM4VpTestEntry=atmfM4VpTestEntry, atmfM4HwTrunkCardAlarm=atmfM4HwTrunkCardAlarm, atmfM4AlarmSevProfileIndexNext=atmfM4AlarmSevProfileIndexNext, atmfM4EquipHolderEntry=atmfM4EquipHolderEntry, atmfM4CellProtoCurrTable=atmfM4CellProtoCurrTable, atmfM4VpUpcNpcHistEntry=atmfM4VpUpcNpcHistEntry, atmfM4VcUpcNpcCurrElapsedTime=atmfM4VcUpcNpcCurrElapsedTime, atmfM4CellProtoHistSuspect=atmfM4CellProtoHistSuspect, atmfM4VcUpcNpcHistSupprIntvls=atmfM4VcUpcNpcHistSupprIntvls, atmfM4VcUpcNpcHistPassedClp0=atmfM4VcUpcNpcHistPassedClp0, atmfM4IfLopAlarm=atmfM4IfLopAlarm, atmfM4CellProtoCurrElapsedTime=atmfM4CellProtoCurrElapsedTime, atmfM4HwRunningSwHwIndex=atmfM4HwRunningSwHwIndex, atmfM4VpUpcNpcHistSuspect=atmfM4VpUpcNpcHistSuspect, atmfM4HwPIUnitMismatchAlarm=atmfM4HwPIUnitMismatchAlarm, atmfM4TcProtoHistGroup=atmfM4TcProtoHistGroup, atmfM4HwInstalledSwGroup=atmfM4HwInstalledSwGroup, atmfM4LoggedTrapGroup=atmfM4LoggedTrapGroup, atmfM4VclTpRdiAlarm=atmfM4VclTpRdiAlarm, atmfM4VpTestResult=atmfM4VpTestResult, atmfM4VcUpcNpcHistEntry=atmfM4VcUpcNpcHistEntry, atmfM4HwSwDownloadFailAlarm=atmfM4HwSwDownloadFailAlarm, atmfM4TcProtoCurrDiscardHECViol=atmfM4TcProtoCurrDiscardHECViol, atmfM4TcProtoCurrTable=atmfM4TcProtoCurrTable, atmfM4VpUpcNpcCurrSupprIntvls=atmfM4VpUpcNpcCurrSupprIntvls, atmfM4AlarmSevTrapId=atmfM4AlarmSevTrapId, atmfM4HwDoorOpenAlarm=atmfM4HwDoorOpenAlarm, atmfM4CellProtoErrorTable=atmfM4CellProtoErrorTable, atmfM4ForwardedTrapObject=atmfM4ForwardedTrapObject, atmfM4VcXConnTable=atmfM4VcXConnTable, atmfM4VplTpAisAlarm=atmfM4VplTpAisAlarm, atmfM4TrapForwardingPort=atmfM4TrapForwardingPort, atmfM4AtmLayerTable=atmfM4AtmLayerTable, atmfM4CellProtoErrorEntry=atmfM4CellProtoErrorEntry, atmfM4TestOAMLoopbackE2E=atmfM4TestOAMLoopbackE2E, atmfM4VcTestTable=atmfM4VcTestTable, atmfM4HwReceiverFailAlarm=atmfM4HwReceiverFailAlarm, atmfM4VclTpChanged=atmfM4VclTpChanged, atmfM4SnmpNEView=atmfM4SnmpNEView, atmfM4AtmCellIfDeleted=atmfM4AtmCellIfDeleted, atmfM4EquipHolderSlotStatus=atmfM4EquipHolderSlotStatus, atmfM4TrapLogTable=atmfM4TrapLogTable, atmfM4TestOAMLoopbackSeg=atmfM4TestOAMLoopbackSeg, atmfM4VpcTpDeleted=atmfM4VpcTpDeleted, atmfM4TcACellScrambling=atmfM4TcACellScrambling, atmfM4PhysPathTpAlarmSeverityIndex=atmfM4PhysPathTpAlarmSeverityIndex, atmfM4General=atmfM4General, atmfM4IfFarEndCarrierNetwork=atmfM4IfFarEndCarrierNetwork, atmfM4CellProtoErrorVci=atmfM4CellProtoErrorVci, atmfM4InstalledSwChanged=atmfM4InstalledSwChanged, atmfM4TcProtoCurrElapsedTime=atmfM4TcProtoCurrElapsedTime, atmfM4HwCallEstErrAlarm=atmfM4HwCallEstErrAlarm, atmfM4VpTestStatus=atmfM4VpTestStatus, atmfM4TrapLogSrc=atmfM4TrapLogSrc, atmfM4VccTpCreated=atmfM4VccTpCreated, atmfM4VplXConnChanged=atmfM4VplXConnChanged, atmfM4TcProtoHistTable=atmfM4TcProtoHistTable, atmfM4HwPIUnitMissingAlarm=atmfM4HwPIUnitMissingAlarm, atmfM4EquipLocation=atmfM4EquipLocation, atmfM4CellProtoHistElapsedTime=atmfM4CellProtoHistElapsedTime, atmfM4VcNextVciGroup=atmfM4VcNextVciGroup, atmfM4VpcTpAisAlarm=atmfM4VpcTpAisAlarm, atmfM4MIBConformance=atmfM4MIBConformance, atmfM4TcProtoHistSupprIntvls=atmfM4TcProtoHistSupprIntvls, atmfM4MIB=atmfM4MIB, atmfM4HwRunningSwEntry=atmfM4HwRunningSwEntry, atmfM4VplTpUp=atmfM4VplTpUp, atmfM4TcProtoHistElapsedTime=atmfM4TcProtoHistElapsedTime, atmfM4EquipTable=atmfM4EquipTable, atmfM4AlarmSeverity=atmfM4AlarmSeverity, atmfM4VpNextVpiValue=atmfM4VpNextVpiValue, atmfM4VplTpRdiAlarm=atmfM4VplTpRdiAlarm, atmfM4VpNextVpiTable=atmfM4VpNextVpiTable, atmfM4VpUpcNpcCurrSuspect=atmfM4VpUpcNpcCurrSuspect, atmfM4VpUpcNpcHistPassedCells=atmfM4VpUpcNpcHistPassedCells, atmfM4HwUnitDown=atmfM4HwUnitDown, atmfM4VpUpcNpcCurrTable=atmfM4VpUpcNpcCurrTable, atmfM4VpUpcNpcCurrElapsedTime=atmfM4VpUpcNpcCurrElapsedTime, atmfM4VcTestStatus=atmfM4VcTestStatus, atmfM4HwCorruptDataAlarm=atmfM4HwCorruptDataAlarm, atmForum=atmForum, atmfM4AlarmSevDefault=atmfM4AlarmSevDefault, atmfM4EquipEntry=atmfM4EquipEntry, atmfM4HwXmitterFailAlarm=atmfM4HwXmitterFailAlarm, atmfM4VcTestObject=atmfM4VcTestObject, atmfM4IfSubscriberAddress=atmfM4IfSubscriberAddress, atmfM4VclXConnDeleted=atmfM4VclXConnDeleted, atmfM4CellProtoHistEntry=atmfM4CellProtoHistEntry, atmfM4VpXConnRecover=atmfM4VpXConnRecover, atmfM4PlugInUnitAvailStatus=atmfM4PlugInUnitAvailStatus, atmfM4PhysPathTpTable=atmfM4PhysPathTpTable, atmfM4HwHighTempAlarm=atmfM4HwHighTempAlarm, atmfM4IfLoopbackLocationCode=atmfM4IfLoopbackLocationCode, atmfM4VpNextVpiEntry=atmfM4VpNextVpiEntry, atmfM4AlarmSevProfileEntry=atmfM4AlarmSevProfileEntry, atmfM4IfPayloadMismatchAlarm=atmfM4IfPayloadMismatchAlarm, atmfM4VcTestOwner=atmfM4VcTestOwner, atmfM4IfLofAlarm=atmfM4IfLofAlarm, atmfM4IfPreferredCarrier=atmfM4IfPreferredCarrier, atmfM4LoggedTrapTime=atmfM4LoggedTrapTime, atmfM4IfXmissionErrAlarm=atmfM4IfXmissionErrAlarm, atmfM4AlarmSevProfileIndex=atmfM4AlarmSevProfileIndex, atmfM4HwBackPlaneAlarm=atmfM4HwBackPlaneAlarm, atmfM4VpUpcNpcCurrEntry=atmfM4VpUpcNpcCurrEntry, atmfM4VpUpcNpcHistTable=atmfM4VpUpcNpcHistTable, atmfM4InstalledSwCreated=atmfM4InstalledSwCreated, atmfM4HwPowerAlarm=atmfM4HwPowerAlarm, atmfM4HwRunningSwSwIndex=atmfM4HwRunningSwSwIndex, atmfM4SwVersionMismatchAlarm=atmfM4SwVersionMismatchAlarm, atmfM4TrapAlarmSeverity=atmfM4TrapAlarmSeverity, atmfM4VcXConnEntry=atmfM4VcXConnEntry, atmfM4HwRunningSwIndex=atmfM4HwRunningSwIndex, atmfM4IfType=atmfM4IfType, atmfM4VclTpUp=atmfM4VclTpUp, atmfM4VclXConnCreated=atmfM4VclXConnCreated, atmfM4HwUnitCreated=atmfM4HwUnitCreated, atmfM4VclGroup=atmfM4VclGroup, atmfM4VcXConnGroup=atmfM4VcXConnGroup, atmfM4NeAlarmSeverityIndex=atmfM4NeAlarmSeverityIndex, atmfM4CellProtoErrorTime=atmfM4CellProtoErrorTime, atmfM4VclTable=atmfM4VclTable, atmfM4VcUpcNpcHistGroup=atmfM4VcUpcNpcHistGroup, atmfM4TcAdapterGroup=atmfM4TcAdapterGroup, atmfM4VcUpcNpcCurrDiscardedCells=atmfM4VcUpcNpcCurrDiscardedCells, atmfM4PlugInUnitVersion=atmfM4PlugInUnitVersion, atmfM4TcProtoHistDiscardHECViol=atmfM4TcProtoHistDiscardHECViol, atmfM4VpUpcNpcHistDiscardedClp0=atmfM4VpUpcNpcHistDiscardedClp0, atmfM4VpcTpRdiAlarm=atmfM4VpcTpRdiAlarm, atmfM4CellProtoHistIndex=atmfM4CellProtoHistIndex, atmfM4VclEntry=atmfM4VclEntry, atmfM4VpUpcNpcCurrPassedCells=atmfM4VpUpcNpcCurrPassedCells, atmfM4AlarmSevGroup=atmfM4AlarmSevGroup, atmfM4VcTestType=atmfM4VcTestType, atmfM4IfAisAlarm=atmfM4IfAisAlarm, atmfM4PlugInUnitOperStatus=atmfM4PlugInUnitOperStatus, atmfM4TcAdapterTable=atmfM4TcAdapterTable, atmfM4VcTestId=atmfM4VcTestId, atmfM4TcProtoCurrEntry=atmfM4TcProtoCurrEntry)
mibBuilder.exportSymbols("ATM-FORUM-SNMP-M4-MIB", atmfM4VcUpcNpcHistIndex=atmfM4VcUpcNpcHistIndex, atmfM4LoggedAlarmRepairAct=atmfM4LoggedAlarmRepairAct, atmfM4VpUpcNpcHistGroup=atmfM4VpUpcNpcHistGroup, atmfM4HwUnitChanged=atmfM4HwUnitChanged, atmfM4IfSignalLabelMismatchAlarm=atmfM4IfSignalLabelMismatchAlarm, atmfM4CellProtoErrorReason=atmfM4CellProtoErrorReason, atmfM4AlarmSevEntry=atmfM4AlarmSevEntry, atmfM4AlarmSevTable=atmfM4AlarmSevTable, atmfM4LoggedTrapTable=atmfM4LoggedTrapTable, atmfM4VcUpcNpcCurrSupprIntvls=atmfM4VcUpcNpcCurrSupprIntvls, atmfM4VcTestResult=atmfM4VcTestResult, atmfM4VcNextVciEntry=atmfM4VcNextVciEntry, atmfM4HwProcessorAlarm=atmfM4HwProcessorAlarm, atmfM4LoggedTrapEntry=atmfM4LoggedTrapEntry, atmfM4VpXConnEntry=atmfM4VpXConnEntry, atmfM4LoggedTrapID=atmfM4LoggedTrapID, atmfM4VpUpcNpcHistElapsedTime=atmfM4VpUpcNpcHistElapsedTime, atmfM4CellProtoHistProtoErrors=atmfM4CellProtoHistProtoErrors, atmfM4LoggedTrapIndex=atmfM4LoggedTrapIndex, atmfM4VpUpcNpcHistPassedClp0=atmfM4VpUpcNpcHistPassedClp0, atmfM4TcProtoHistEntry=atmfM4TcProtoHistEntry, atmfM4LoggedAlarmEntry=atmfM4LoggedAlarmEntry, atmfM4LoggedAlarmBUObject=atmfM4LoggedAlarmBUObject, atmfM4LoggedAlarmTable=atmfM4LoggedAlarmTable, atmfM4VplTpDown=atmfM4VplTpDown, atmfM4VplTable=atmfM4VplTable, atmfM4TrapLogOperStatus=atmfM4TrapLogOperStatus, atmfM4VpTestObject=atmfM4VpTestObject, atmfM4VpUpcNpcHistSupprIntvls=atmfM4VpUpcNpcHistSupprIntvls, atmfM4ForwardedIndeterminate=atmfM4ForwardedIndeterminate, atmfM4NeVersion=atmfM4NeVersion, atmfM4EquipVendor=atmfM4EquipVendor, atmfM4CellProtoHistGroup=atmfM4CellProtoHistGroup, atmfM4HwProtectionPathAlarm=atmfM4HwProtectionPathAlarm, atmfM4VcUpcNpcHistTable=atmfM4VcUpcNpcHistTable, atmfM4HwVersionMismatchAlarm=atmfM4HwVersionMismatchAlarm, atmfM4PlugInUnitGroup=atmfM4PlugInUnitGroup, atmfM4TrapForwardingGroup=atmfM4TrapForwardingGroup, AtmfM4AlarmLogSeverity=AtmfM4AlarmLogSeverity, atmfM4EquipAdminStatus=atmfM4EquipAdminStatus, atmfM4TrapLogRowStatus=atmfM4TrapLogRowStatus, atmfM4HwPIUnitProbAlarm=atmfM4HwPIUnitProbAlarm, atmfM4VclXConnUp=atmfM4VclXConnUp, atmfM4CellProtoHistInOAMCells=atmfM4CellProtoHistInOAMCells, AtmfM4AlarmSeverity=AtmfM4AlarmSeverity, atmfM4TrapLogGroup=atmfM4TrapLogGroup, atmfM4AlarmSevProfileTable=atmfM4AlarmSevProfileTable, atmfM4HwTimingProbAlarm=atmfM4HwTimingProbAlarm, atmfM4VpUpcNpcHistDiscardedCells=atmfM4VpUpcNpcHistDiscardedCells, atmfM4VcUpcNpcCurrPassedCells=atmfM4VcUpcNpcCurrPassedCells, atmfM4HwUnitUp=atmfM4HwUnitUp, atmfM4PhysPathTpGroup=atmfM4PhysPathTpGroup, atmfM4Compliance=atmfM4Compliance, atmfM4VcTestGroup=atmfM4VcTestGroup, atmfM4VcTestEntry=atmfM4VcTestEntry, atmfM4CellProtoHistTable=atmfM4CellProtoHistTable, atmfM4VcNextVciValue=atmfM4VcNextVciValue, atmfM4NeStartTime=atmfM4NeStartTime, atmfM4VpUpcNpcHistIndex=atmfM4VpUpcNpcHistIndex, atmfM4NeSuppressZeroStats=atmfM4NeSuppressZeroStats, atmfM4MIBObjects=atmfM4MIBObjects, atmfM4PlugInUnitAdminStatus=atmfM4PlugInUnitAdminStatus, atmfM4MIBTraps=atmfM4MIBTraps, atmfM4VplXConnDeleted=atmfM4VplXConnDeleted, atmfM4TcAlarmSeverityIndex=atmfM4TcAlarmSeverityIndex, atmfM4VclTpDown=atmfM4VclTpDown, atmForumNetworkManagement=atmForumNetworkManagement, atmfM4CellProtoCurrInOAMCells=atmfM4CellProtoCurrInOAMCells, atmfM4VplGroup=atmfM4VplGroup, atmfM4HwRunningSwTable=atmfM4HwRunningSwTable, atmfM4CellProtoHistSupprIntvls=atmfM4CellProtoHistSupprIntvls, atmfM4VcUpcNpcHistPassedCells=atmfM4VcUpcNpcHistPassedCells, atmfM4VpNextVpiGroup=atmfM4VpNextVpiGroup, atmfM4Compliances=atmfM4Compliances, atmfM4IfLosAlarm=atmfM4IfLosAlarm, atmfM4VpUpcNpcCurrDiscardedClp0=atmfM4VpUpcNpcCurrDiscardedClp0, atmfM4CellProtoCurrSupprIntvls=atmfM4CellProtoCurrSupprIntvls, atmfM4EquipHolderSwLoad=atmfM4EquipHolderSwLoad, atmfM4VpTestCode=atmfM4VpTestCode, atmfM4EquipVersion=atmfM4EquipVersion, atmfM4PhysPathTpHwUnitIndex=atmfM4PhysPathTpHwUnitIndex, atmfM4TcProtoCurrSupprIntvls=atmfM4TcProtoCurrSupprIntvls, atmfM4IfLcdAlarm=atmfM4IfLcdAlarm, atmfM4VplTpChanged=atmfM4VplTpChanged)
