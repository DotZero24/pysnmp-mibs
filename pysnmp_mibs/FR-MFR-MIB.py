...
mibBuilder.exportSymbols("FR-MFR-MIB", mfrBundleTimerAck=mfrBundleTimerAck, mfrBundleNextIndex=mfrBundleNextIndex, mfrMibBundleLinkGroup=mfrMibBundleLinkGroup, mfrBundleLinkUnexpectedSequence=mfrBundleLinkUnexpectedSequence, mfrBundleLinkFramesControlInvalid=mfrBundleLinkFramesControlInvalid, mfrBundleLinkFarEndName=mfrBundleLinkFarEndName, mfrMibTrapGroup=mfrMibTrapGroup, mfrBundleThreshold=mfrBundleThreshold, mfrMib=mfrMib, mfrBundleLinkFramesControlTx=mfrBundleLinkFramesControlTx, MfrBundleLinkState=MfrBundleLinkState, mfrBundleMaxNumBundles=mfrBundleMaxNumBundles, mfrBundleIfIndex=mfrBundleIfIndex, mfrMibCompliances=mfrMibCompliances, mfrMibScalarObjects=mfrMibScalarObjects, mfrBundleTable=mfrBundleTable, mfrMibTrapsPrefix=mfrMibTrapsPrefix, mfrBundleRowStatus=mfrBundleRowStatus, mfrBundleEntry=mfrBundleEntry, mfrMibConformance=mfrMibConformance, mfrBundleFragmentation=mfrBundleFragmentation, mfrBundleMaxDiffDelay=mfrBundleMaxDiffDelay, mfrBundleFarEndName=mfrBundleFarEndName, mfrBundleLinkNearEndName=mfrBundleLinkNearEndName, mfrBundleLinkState=mfrBundleLinkState, mfrBundleLinkTable=mfrBundleLinkTable, mfrBundleLinkRowStatus=mfrBundleLinkRowStatus, mfrBundleIfIndexMappingIndex=mfrBundleIfIndexMappingIndex, mfrMibTrapBundleLinkMismatch=mfrMibTrapBundleLinkMismatch, mfrBundleCountMaxRetry=mfrBundleCountMaxRetry, mfrBundleLinkMismatch=mfrBundleLinkMismatch, mfrBundleLinksActive=mfrBundleLinksActive, mfrBundleLinkLoopbackSuspected=mfrBundleLinkLoopbackSuspected, mfrBundleIfIndexMappingTable=mfrBundleIfIndexMappingTable, mfrBundleLinksConfigured=mfrBundleLinksConfigured, mfrBundleLinkConfigBundleIndex=mfrBundleLinkConfigBundleIndex, mfrMibBundleObjects=mfrMibBundleObjects, mfrBundleLinkDelay=mfrBundleLinkDelay, mfrBundleTimerHello=mfrBundleTimerHello, mfrBundleBandwidth=mfrBundleBandwidth, mfrBundleActivationClass=mfrBundleActivationClass, mfrBundleLinkFramesControlRx=mfrBundleLinkFramesControlRx, mfrBundleSeqNumSize=mfrBundleSeqNumSize, mfrBundleIfIndexMappingEntry=mfrBundleIfIndexMappingEntry, PYSNMP_MODULE_ID=mfrMib, mfrMibTraps=mfrMibTraps, mfrBundleLinkFarEndBundleName=mfrBundleLinkFarEndBundleName, mfrMibBundleGroup=mfrMibBundleGroup, mfrBundleIndex=mfrBundleIndex, mfrMibGroups=mfrMibGroups, mfrBundleMaxFragSize=mfrBundleMaxFragSize, mfrBundleMaxBundleLinks=mfrBundleMaxBundleLinks, mfrBundleNearEndName=mfrBundleNearEndName, mfrBundleLinkTimerExpiredCount=mfrBundleLinkTimerExpiredCount, mfrMibCompliance=mfrMibCompliance, mfrBundleLinkEntry=mfrBundleLinkEntry, mfrBundleResequencingErrors=mfrBundleResequencingErrors, mfrMibBundleLinkObjects=mfrMibBundleLinkObjects)
