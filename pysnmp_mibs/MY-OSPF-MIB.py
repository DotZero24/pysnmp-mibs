# SNMP MIB module (MY-OSPF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-OSPF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:34:35 2025
...
myOspfAddressScopeEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfNetWorkAreaID"),
    (0, "MY-OSPF-MIB", "myOspfNetWorkAddress"),
    (0, "MY-OSPF-MIB", "myOspfNetWorkMask"),
)
if mibBuilder.loadTexts:
...
myOspfIfEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfIfIpAddress"),
    (0, "MY-OSPF-MIB", "myOspfAddressLessIf"),
)
if mibBuilder.loadTexts:
...
myOspfIfMd5AuthKeyEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfIfMd5AuthKeyIf"),
    (0, "MY-OSPF-MIB", "myOspfIfMd5AuthKeyId"),
)
if mibBuilder.loadTexts:
...
myOspfVirtEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfVirtIfAreaId"),
    (0, "MY-OSPF-MIB", "myOspfVirtIfNeighbor"),
)
if mibBuilder.loadTexts:
...
myOspfVirtIfMd5AuthKeyEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfVirtIfMd5AuthKeyAreaId"),
    (0, "MY-OSPF-MIB", "myOspfVirtIfMd5AuthKeyNeighbor"),
    (0, "MY-OSPF-MIB", "myOspfVirtIfMd5AuthKeyId"),
)
if mibBuilder.loadTexts:
...
myOspfLsdbEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfLsdbAreaId"),
    (0, "MY-OSPF-MIB", "myOspfLsdbType"),
    (0, "MY-OSPF-MIB", "myOspfLsdbLsid"),
    (0, "MY-OSPF-MIB", "myOspfLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
myOspfExtLsdbEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfExtLsdbType"),
    (0, "MY-OSPF-MIB", "myOspfExtLsdbLsid"),
    (0, "MY-OSPF-MIB", "myOspfExtLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
myOspfRouterLsaDetailEntry.setIndexNames(
    ...
    (0, "MY-OSPF-MIB", "myOspfLsdbLsid"),
    (0, "MY-OSPF-MIB", "myOspfLsdbRouterId"),
    (0, "MY-OSPF-MIB", "myOspfRouterLsaDetailLinkID"),
)
if mibBuilder.loadTexts:
...
myOspfNetWorkLsaDetailEntry.setIndexNames(
    ...
    (0, "MY-OSPF-MIB", "myOspfLsdbLsid"),
    (0, "MY-OSPF-MIB", "myOspfLsdbRouterId"),
    (0, "MY-OSPF-MIB", "myOspfNetWorkLsaDetailAttachedRouter"),
)
if mibBuilder.loadTexts:
...
myOspfAreaLsaDBSumEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfAreaLsaDBSumAreaId"),
    (0, "MY-OSPF-MIB", "myOspfAreaLsaDBSumLsaType"),
)
if mibBuilder.loadTexts:
...
myOspfLsaDBSumEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfLsaDBSumLsaType"),
)
if mibBuilder.loadTexts:
...
myOspfNeighborEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfNbrIpAddr"),
    (0, "MY-OSPF-MIB", "myOspfNbrAddressLessIndex"),
)
if mibBuilder.loadTexts:
...
myOspfRouteEntry.setIndexNames(
    (0, "MY-OSPF-MIB", "myOspfRouteDest"),
    (0, "MY-OSPF-MIB", "myOspfRouteArea"),
    (0, "MY-OSPF-MIB", "myOspfRouteNextHop"),
)
if mibBuilder.loadTexts:
...
myOspfBaseMIBGroup.setObjects(
      *(("MY-OSPF-MIB", "myOspfMiniLsaInterval"),
        ("MY-OSPF-MIB", "myOspfMiniLsaArrival"),
        ("MY-OSPF-MIB", "myOspfAreasNum"),
        ("MY-OSPF-MIB", "myOspfNormalAreasNum"),
        ("MY-OSPF-MIB", "myOspfStubAreasNum"),
        ("MY-OSPF-MIB", "myOspfNssaAreasNum"),
        ("MY-OSPF-MIB", "myOspfSpfDelay"),
        ("MY-OSPF-MIB", "myOspfSpfHoldTime"),
        ("MY-OSPF-MIB", "myOspfAutoCostRefBandWidthRef"),
        ("MY-OSPF-MIB", "myOspfLsaGroupPacing"),
        ("MY-OSPF-MIB", "myOspfInterDistance"),
        ("MY-OSPF-MIB", "myOspfIntraDistance"),
        ("MY-OSPF-MIB", "myOspfExternDistance"),
        ("MY-OSPF-MIB", "myOspfLogAdjChangeNotify"),
        ("MY-OSPF-MIB", "myOspfPassiveStatus"),
        ("MY-OSPF-MIB", "myOspfRFC1583Compatibility"),
        ("MY-OSPF-MIB", "myOspfRouteRedisDefMetricVal"))
)
if mibBuilder.loadTexts:
...
myOspfAreaMIBGroup.setObjects(
      *(("MY-OSPF-MIB", "myOspfAreaId"),
        ("MY-OSPF-MIB", "myOspfAuthType"),
        ("MY-OSPF-MIB", "myOspfImportAsExtern"),
        ("MY-OSPF-MIB", "myOspfSpfRuns"),
        ("MY-OSPF-MIB", "myOspfAreaBdrRtrCount"),
        ("MY-OSPF-MIB", "myOspfAsBdrRtrCount"),
        ("MY-OSPF-MIB", "myOspfAreaLsaCount"),
        ("MY-OSPF-MIB", "myOspfAreaLsaCksumSum"),
        ("MY-OSPF-MIB", "myOspfAreaSummary"),
        ("MY-OSPF-MIB", "myOspfAreaStatus"),
        ("MY-OSPF-MIB", "myOspfAreaInterfaceNum"),
        ("MY-OSPF-MIB", "myOspfAreaNssaIsRedistribution"),
        ("MY-OSPF-MIB", "myOspfAreaNssaIsDefInfoOriginate"),
        ("MY-OSPF-MIB", "myOspfNetWorkAreaID"),
        ("MY-OSPF-MIB", "myOspfNetWorkAddress"),
        ("MY-OSPF-MIB", "myOspfNetWorkMask"),
        ("MY-OSPF-MIB", "myOspfNetWorkStatus"))
)
if mibBuilder.loadTexts:
...
myOspfLsaMIBGroup.setObjects(
      *(("MY-OSPF-MIB", "myOspfLsdbAreaId"),
        ("MY-OSPF-MIB", "myOspfLsdbType"),
        ("MY-OSPF-MIB", "myOspfLsdbLsid"),
        ("MY-OSPF-MIB", "myOspfLsdbRouterId"),
        ("MY-OSPF-MIB", "myOspfLsdbSequence"),
        ("MY-OSPF-MIB", "myOspfLsdbAge"),
        ("MY-OSPF-MIB", "myOspfLsdbChecksum"),
        ("MY-OSPF-MIB", "myOspfLsdbAdvertisement"),
        ("MY-OSPF-MIB", "myOspfLsdbLinkNum"),
        ("MY-OSPF-MIB", "myOspfLsdbPacketLength"),
        ("MY-OSPF-MIB", "myOspfSummaryLsaNetworkMask"),
        ("MY-OSPF-MIB", "myOspfSummaryLsaTos0Metric"),
        ("MY-OSPF-MIB", "myOspfNssaLsaDetailMetricType"),
        ("MY-OSPF-MIB", "myOspfNssaLsaDetailForwardAddr"),
        ("MY-OSPF-MIB", "myOspfNssaLsaDetailRouteTag"),
        ("MY-OSPF-MIB", "myOspfLsdbOption"),
        ("MY-OSPF-MIB", "myOspfExtLsdbType"),
        ("MY-OSPF-MIB", "myOspfExtLsdbLsid"),
        ("MY-OSPF-MIB", "myOspfExtLsdbRouterId"),
        ("MY-OSPF-MIB", "myOspfExtLsdbSequence"),
        ("MY-OSPF-MIB", "myOspfExtLsdbAge"),
        ("MY-OSPF-MIB", "myOspfExtLsdbChecksum"),
        ("MY-OSPF-MIB", "myOspfExtLsdbAdvertisement"),
        ("MY-OSPF-MIB", "myOspfExtLsdbNetworkMask"),
        ("MY-OSPF-MIB", "myOspfExtLsdbMetricType"),
        ("MY-OSPF-MIB", "myOspfExtLsdbForwardAddr"),
        ("MY-OSPF-MIB", "myOspfExtLsdbRouteTag"),
        ("MY-OSPF-MIB", "myOspfExtLsdbMetric"),
        ("MY-OSPF-MIB", "myOspfExtLsdbOption"),
        ("MY-OSPF-MIB", "myOspfExtLsdbPacketLength"),
        ("MY-OSPF-MIB", "myOspfRouterLsaDetailLinkID"),
        ("MY-OSPF-MIB", "myOspfRouterLsaDetailLinkType"),
        ("MY-OSPF-MIB", "myOspfRouterLsaDetailLinkData"),
        ("MY-OSPF-MIB", "myOspfRouterLsaDetailTos0Metric"),
        ("MY-OSPF-MIB", "myOspfNetWorkLsaDetailAttachedRouter"),
        ("MY-OSPF-MIB", "myOspfNetWorkLsaDetailNetworkMask"),
        ("MY-OSPF-MIB", "myOspfAreaLsaDBSumAreaId"),
        ("MY-OSPF-MIB", "myOspfAreaLsaDBSumLsaType"),
        ("MY-OSPF-MIB", "myOspfAreaLsaDBSumCounts"),
        ("MY-OSPF-MIB", "myOspfAreaLsaDBSumDeletes"),
        ("MY-OSPF-MIB", "myOspfAreaLsaDBSumMaxage"),
        ("MY-OSPF-MIB", "myOspfLsaDBSumLsaType"),
        ("MY-OSPF-MIB", "myOspfLsaDBSumCounts"),
        ("MY-OSPF-MIB", "myOspfLsaDBSumDeletes"),
        ("MY-OSPF-MIB", "myOspfLsaDBSumMaxage"))
)
if mibBuilder.loadTexts:
...
myOspfIfMIBGroup.setObjects(
      *(("MY-OSPF-MIB", "myOspfIfIpAddress"),
        ("MY-OSPF-MIB", "myOspfAddressLessIf"),
        ("MY-OSPF-MIB", "myOspfIfAreaId"),
        ("MY-OSPF-MIB", "myOspfIfType"),
        ("MY-OSPF-MIB", "myOspfIfAdminStat"),
        ("MY-OSPF-MIB", "myOspfIfRtrPriority"),
        ("MY-OSPF-MIB", "myOspfIfTransitDelay"),
        ("MY-OSPF-MIB", "myOspfIfRetransInterval"),
        ("MY-OSPF-MIB", "myOspfIfHelloInterval"),
        ("MY-OSPF-MIB", "myOspfIfRtrDeadInterval"),
        ("MY-OSPF-MIB", "myOspfIfPollInterval"),
        ("MY-OSPF-MIB", "myOspfIfState"),
        ("MY-OSPF-MIB", "myOspfIfDesignatedRouter"),
        ("MY-OSPF-MIB", "myOspfIfBackupDesignatedRouter"),
        ("MY-OSPF-MIB", "myOspfIfEvents"),
        ("MY-OSPF-MIB", "myOspfIfAuthType"),
        ("MY-OSPF-MIB", "myOspfIfAuthKey"),
        ("MY-OSPF-MIB", "myOspfIfStatus"),
        ("MY-OSPF-MIB", "myOspfIfMulticastForwarding"),
        ("MY-OSPF-MIB", "myOspfIfDemand"),
        ("MY-OSPF-MIB", "myOspfIfDatabaseFilterAllOut"),
        ("MY-OSPF-MIB", "myOspfIfDesignateRouterId"),
        ("MY-OSPF-MIB", "myOspfIfBackupDesignateRouterId"),
        ("MY-OSPF-MIB", "myOspfIfWaitInternal"),
        ("MY-OSPF-MIB", "myOspfIfPassiveStatus"),
        ("MY-OSPF-MIB", "myOspfIfCurrentUsedMd5AuthKeyId"),
        ("MY-OSPF-MIB", "myOspfIfMd5AuthKeyIf"),
        ("MY-OSPF-MIB", "myOspfIfMd5AuthKeyId"),
        ("MY-OSPF-MIB", "myOspfIfMd5AuthKey"),
        ("MY-OSPF-MIB", "myOspfIfMd5AuthKeySt"))
)
if mibBuilder.loadTexts:
...
myOspfVirtMIBGroup.setObjects(
      *(("MY-OSPF-MIB", "myOspfVirtIfAreaId"),
        ("MY-OSPF-MIB", "myOspfVirtIfNeighbor"),
        ("MY-OSPF-MIB", "myOspfVirtIfTransitDelay"),
        ("MY-OSPF-MIB", "myOspfVirtIfRetransInterval"),
        ("MY-OSPF-MIB", "myOspfVirtIfHelloInterval"),
        ("MY-OSPF-MIB", "myOspfVirtIfRtrDeadInterval"),
        ("MY-OSPF-MIB", "myOspfVirtIfState"),
        ("MY-OSPF-MIB", "myOspfVirtIfEvents"),
        ("MY-OSPF-MIB", "myOspfVirtIfAuthType"),
        ("MY-OSPF-MIB", "myOspfVirtIfAuthKey"),
        ("MY-OSPF-MIB", "myOspfVirtIfStatus"),
        ("MY-OSPF-MIB", "myOspfVirtCost"),
        ("MY-OSPF-MIB", "myOspfVirtNativeIfIndex"),
        ("MY-OSPF-MIB", "myOspfVirtLinkState"),
        ("MY-OSPF-MIB", "myOspfVirtHelloDueIn"),
        ("MY-OSPF-MIB", "myOspfVirtIfMd5AuthKeyAreaId"),
        ("MY-OSPF-MIB", "myOspfVirtIfMd5AuthKeyNeighbor"),
        ("MY-OSPF-MIB", "myOspfVirtIfMd5AuthKeyId"),
        ("MY-OSPF-MIB", "myOspfVirtIfMd5AuthKey"),
        ("MY-OSPF-MIB", "myOspfVirtIfMd5AuthKeySt"),
        ("MY-OSPF-MIB", "myOspfVirtCurrentUsedMd5AuthKeyId"))
)
if mibBuilder.loadTexts:
...
myOspfNeighborMIBGroup.setObjects(
      *(("MY-OSPF-MIB", "myOspfNbrIpAddr"),
        ("MY-OSPF-MIB", "myOspfNbrAddressLessIndex"),
        ("MY-OSPF-MIB", "myOspfNbrRtrId"),
        ("MY-OSPF-MIB", "myOspfNbrOptions"),
        ("MY-OSPF-MIB", "myOspfNbrPriority"),
        ("MY-OSPF-MIB", "myOspfNbrState"),
        ("MY-OSPF-MIB", "myOspfNbrEvents"),
        ("MY-OSPF-MIB", "myOspfNbrLsRetransQLen"),
        ("MY-OSPF-MIB", "myOspfNbmaNbrStatus"),
        ("MY-OSPF-MIB", "myOspfNbmaNbrPermanence"),
        ("MY-OSPF-MIB", "myOspfNbrHelloSuppressed"),
        ("MY-OSPF-MIB", "myOspfNbrDeadTimeDueIn"),
        ("MY-OSPF-MIB", "myOspfNbrNeighborUpTime"),
        ("MY-OSPF-MIB", "myOspfNbrDR"),
        ("MY-OSPF-MIB", "myOspfNbrBDR"),
        ("MY-OSPF-MIB", "myOspfNbrArea"),
        ("MY-OSPF-MIB", "myOspfNbrRetransmissionNum"))
)
if mibBuilder.loadTexts:
...
myOspfRouteInfoMIBGroup.setObjects(
      *(("MY-OSPF-MIB", "myOspfRouteType"),
        ("MY-OSPF-MIB", "myOspfRouteDest"),
        ("MY-OSPF-MIB", "myOspfRouteNextHop"),
        ("MY-OSPF-MIB", "myOspfRouteCost"),
        ("MY-OSPF-MIB", "myOspfRouteDRType"),
        ("MY-OSPF-MIB", "myOspfRouteArea"),
        ("MY-OSPF-MIB", "myOspfRouteSpfNo"))
)
if mibBuilder.loadTexts:
...
myOspfMIBCompliance.setObjects(
      *(("MY-OSPF-MIB", "myOspfBaseMIBGroup"),
        ("MY-OSPF-MIB", "myOspfAreaMIBGroup"),
        ("MY-OSPF-MIB", "myOspfLsaMIBGroup"),
        ("MY-OSPF-MIB", "myOspfIfMIBGroup"),
        ("MY-OSPF-MIB", "myOspfVirtMIBGroup"),
        ("MY-OSPF-MIB", "myOspfNeighborMIBGroup"),
        ("MY-OSPF-MIB", "myOspfRouteInfoMIBGroup"))
)
if mibBuilder.loadTexts:
