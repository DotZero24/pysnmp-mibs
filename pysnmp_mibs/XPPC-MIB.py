...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/megatec/XPPC-MIB
...
upsThreePhaseBypassSourceVoltageR = MibScalar((1, 3, 6, 1, 4, 1, 935, 1, 1, 1, 8, 4, 2), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: upsThreePhaseBypassSourceVoltageR.setStatus('mandatory')
upsThreePhaseBypassSourceVoltageS = MibScalar((1, 3, 6, 1, 4, 1, 935, 1, 1, 1, 8, 4, 3), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: upsThreePhaseBypassSourceVoltageS.setStatus('mandatory')
upsThreePhaseBypassSourceVoltageT = MibScalar((1, 3, 6, 1, 4, 1, 935, 1, 1, 1, 8, 4, 4), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: upsThreePhaseBypassSourceVoltageT.setStatus('mandatory')
...
mibBuilder.exportSymbols("XPPC-MIB", upsBaseBatteryTimeOnBattery=upsBaseBatteryTimeOnBattery, upsBypassReturn=upsBypassReturn, upsTurnedOff=upsTurnedOff, upsSmartConfigReturnDelay=upsSmartConfigReturnDelay, upsBaseTest=upsBaseTest, upsBaseIdentUpsName=upsBaseIdentUpsName, lowBattery=lowBattery, ups=ups, upsThreePhaseUPSStatusManualBypassBreaker=upsThreePhaseUPSStatusManualBypassBreaker, upsIdentp=upsIdentp, powerRestored=powerRestored, envTemperatureNormal=envTemperatureNormal, upsBypassBreadkerOnShutdown=upsBypassBreadkerOnShutdown, upsTempNormal=upsTempNormal, upsControlp=upsControlp, upsSleeping=upsSleeping, envGasAbnormal=envGasAbnormal, ppc=ppc, upsSmartIdentFirmwareRevision=upsSmartIdentFirmwareRevision, upsEnvSecurity5=upsEnvSecurity5, upsSmartBatteryCurrent=upsSmartBatteryCurrent, upsThreePhaseFaultStatusHighDCShutdown=upsThreePhaseFaultStatusHighDCShutdown, upsSmartInputLineFailCause=upsSmartInputLineFailCause, upsBaseOutputPhase=upsBaseOutputPhase, upsEnvSecurity6=upsEnvSecurity6, upsBaseIdentModel=upsBaseIdentModel, upsTestp=upsTestp, upsThreePhaseRatingPower=upsThreePhaseRatingPower, upsThreePhaseBatteryTemperature=upsThreePhaseBatteryTemperature, upsEnvSmoke=upsEnvSmoke, upsThreePhaseBatteryCapacityPercentage=upsThreePhaseBatteryCapacityPercentage, upsBypassFreFail=upsBypassFreFail, upsSmartBatteryReplaceIndicator=upsSmartBatteryReplaceIndicator, upsEnvSetting=upsEnvSetting, upsRebootStarted=upsRebootStarted, upsThreePhaseDCandRectifierStatusInAndOut=upsThreePhaseDCandRectifierStatusInAndOut, severityLevel=severityLevel, upsSmartIdentAgentFirmwareRevision=upsSmartIdentAgentFirmwareRevision, upsSmartConfigAlarmTimer=upsSmartConfigAlarmTimer, upsBaseControlConserveBattery=upsBaseControlConserveBattery, upsSmartBatteryVoltage=upsSmartBatteryVoltage, upsEnvironment=upsEnvironment, upsThreePhaseBatteryTimeRemain=upsThreePhaseBatteryTimeRemain, upsSmartIdentDateOfManufacture=upsSmartIdentDateOfManufacture, upsThreePhaseDCandRectifierStatusRecOperating=upsThreePhaseDCandRectifierStatusRecOperating, upsOverLoadShutdown=upsOverLoadShutdown, upsSmartTestLastDiagnosticsDate=upsSmartTestLastDiagnosticsDate, upsEnvSecurity1=upsEnvSecurity1, buckOn=buckOn, upsThreePhaseRatingRectifierVoltage=upsThreePhaseRatingRectifierVoltage, envOverHumidity=envOverHumidity, envSecurity4=envSecurity4, upsSmartInput=upsSmartInput, upsThreePhaseInputVoltageT=upsThreePhaseInputVoltageT, upsTest=upsTest, upsEmergencyStop=upsEmergencyStop, upsSmartControlRebootUps=upsSmartControlRebootUps, upsSmartBatteryRunTimeRemaining=upsSmartBatteryRunTimeRemaining, upsThreePhaseBatteryGrp=upsThreePhaseBatteryGrp, hardware=hardware, upsThreePhaseInputVoltageS=upsThreePhaseInputVoltageS, ppcmgmt=ppcmgmt, upsSmartControlUpsOff=upsSmartControlUpsOff, upsSmartControlUpsSleep=upsSmartControlUpsSleep, upsSmartTestDiagnosticSchedule=upsSmartTestDiagnosticSchedule, mconfig=mconfig, upsThreePhaseFaultStatusShortCircuit=upsThreePhaseFaultStatusShortCircuit, returnFromLowBattery=returnFromLowBattery, upsSmartConfigAlarm=upsSmartConfigAlarm, indexOfDevice=indexOfDevice, upsThreePhaseBatteryCurrent=upsThreePhaseBatteryCurrent, envUnderTemperature=envUnderTemperature, upsBaseOutput=upsBaseOutput, upsOverTemperatureShutdown=upsOverTemperatureShutdown, upsSmartControl=upsSmartControl, upsSmartControlTurnOnUpsLoad=upsSmartControlTurnOnUpsLoad, upsSmartInputFrequency=upsSmartInputFrequency, upsLowBatteryShutdown=upsLowBatteryShutdown, envOverTemperature=envOverTemperature, upsSmartConfigSensitivity=upsSmartConfigSensitivity, upsBaseConfig=upsBaseConfig, upsSmartBatteryTemperature=upsSmartBatteryTemperature, upsThreePhaseBypassGrp=upsThreePhaseBypassGrp, upsEnvSecurity4=upsEnvSecurity4, upsThreePhaseOutputLoadPercentageR=upsThreePhaseOutputLoadPercentageR, upsSmartConfigRatedOutputVoltage=upsSmartConfigRatedOutputVoltage, upsThreePhaseOutputLoadPercentageS=upsThreePhaseOutputLoadPercentageS, upsBaseIdent=upsBaseIdent, upsThreePhaseDCandRectifierStatusBatteryStatus=upsThreePhaseDCandRectifierStatusBatteryStatus, upsThreePhaseInputGrp=upsThreePhaseInputGrp, upsThreePhaseInputVoltageR=upsThreePhaseInputVoltageR, upsThreePhaseUPSStatusBypassFreqFail=upsThreePhaseUPSStatusBypassFreqFail, upsEnvSecurity2=upsEnvSecurity2, upsInverterMode=upsInverterMode, upsCapacityNormal=upsCapacityNormal, upsBaseConfigNumDevices=upsBaseConfigNumDevices, upsThreePhaseBypassSourceFrequency=upsThreePhaseBypassSourceFrequency, upsBaseConfigDeviceTable=upsBaseConfigDeviceTable, upsSmartTest=upsSmartTest, upsThreePhaseOutputVoltageT=upsThreePhaseOutputVoltageT, upsSmartOutputLoad=upsSmartOutputLoad, upsInverterOutputFailShutdown=upsInverterOutputFailShutdown, upsSmartInputMaxLineVoltage=upsSmartInputMaxLineVoltage, upsOverLoad=upsOverLoad, envUnderHumidity=envUnderHumidity, upsBaseInputPhase=upsBaseInputPhase, upsSmartConfigUpsSleepTime=upsSmartConfigUpsSleepTime, upsSmartConfigSetEEPROMDefaults=upsSmartConfigSetEEPROMDefaults, upsEnvHumidity=upsEnvHumidity, envWaterAbnormal=envWaterAbnormal, upsOnBattery=upsOnBattery, upsThreePhaseBypassSourceVoltageR=upsThreePhaseBypassSourceVoltageR, upsDiagnosticsPassed=upsDiagnosticsPassed, upsCapacityUnderrun=upsCapacityUnderrun, upsSmartOutput=upsSmartOutput, mconfigTrapsReceiversNum=mconfigTrapsReceiversNum, upsBypass=upsBypass, upsThreePhaseUPSStatusGrp=upsThreePhaseUPSStatusGrp, upsBaseBatteryStatus=upsBaseBatteryStatus, returnFromBoost=returnFromBoost, upsSmartConfigShutoffDelay=upsSmartConfigShutoffDelay, upsInputp=upsInputp, trapsReceiverAddr=trapsReceiverAddr, upsWokeUp=upsWokeUp, upsBatteryp=upsBatteryp, upsSmartTestRuntimeCalibration=upsSmartTestRuntimeCalibration, upsThreePhaseFaultStatusGrp=upsThreePhaseFaultStatusGrp, upsThreePhaseRatingBypassVoltage=upsThreePhaseRatingBypassVoltage, upsEnvUnderTemperature=upsEnvUnderTemperature, upsSmartTestCalibrationDate=upsSmartTestCalibrationDate, upsSmartTestIndicators=upsSmartTestIndicators, upsThreePhaseBypassSourceVoltageT=upsThreePhaseBypassSourceVoltageT, upsThreePhaseInputFrequency=upsThreePhaseInputFrequency, upsSmartTestDiagnosticsResults=upsSmartTestDiagnosticsResults, upsThreePhaseRatingRectifierFrequency=upsThreePhaseRatingRectifierFrequency, upsSmartBatteryFullChargeVoltage=upsSmartBatteryFullChargeVoltage, upsSmartConfigLowBatteryRunTime=upsSmartConfigLowBatteryRunTime, upsEnvStatus=upsEnvStatus, upsRecroterror=upsRecroterror, upsThreePhaseOutputFrequency=upsThreePhaseOutputFrequency, returnFromBuck=returnFromBuck, upsThreePhaseFaultStatusBypassBreaker=upsThreePhaseFaultStatusBypassBreaker, envSecurity3=envSecurity3, receiverAccept=receiverAccept, upsBaseConfigDeviceEntry=upsBaseConfigDeviceEntry, upsLoadNormal=upsLoadNormal, upsThreePhaseFaultStatusOverLoad=upsThreePhaseFaultStatusOverLoad, upsThreePhase=upsThreePhase, upsEnvOverTemperature=upsEnvOverTemperature, upsEnvOverHumidity=upsEnvOverHumidity, envSecurityAbnormal=envSecurityAbnormal, upsThreePhaseOutputVoltageR=upsThreePhaseOutputVoltageR, upsSmartControlSimulatePowerFail=upsSmartControlSimulatePowerFail, envSecurity1=envSecurity1, upsThreePhaseRatingGrp=upsThreePhaseRatingGrp, upsThreePhaseFaultStatusEmergencyStop=upsThreePhaseFaultStatusEmergencyStop, deviceAccept=deviceAccept, upsThreePhaseRatingBypassFrequency=upsThreePhaseRatingBypassFrequency, envSecurity2=envSecurity2, envSecurity7=envSecurity7, upsBypassacnormal=upsBypassacnormal, upsShortCircuitShutdown=upsShortCircuitShutdown, upsSmartInputMinLineVoltage=upsSmartInputMinLineVoltage, communicationEstablished=communicationEstablished, communicationLost=communicationLost, upsBaseInput=upsBaseInput, upsSmartConfigMinReturnCapacity=upsSmartConfigMinReturnCapacity, upsEnvWater=upsEnvWater, envSecurity6=envSecurity6, upsConfigp=upsConfigp, upsSmartBatteryCapacity=upsSmartBatteryCapacity, vaRatingOfDevice=vaRatingOfDevice, upsSmartConfigHighTransferVolt=upsSmartConfigHighTransferVolt, upsSmartControlFlashAndBeep=upsSmartControlFlashAndBeep, upsSmartTestDiagnostics=upsSmartTestDiagnostics, upsThreePhaseOutputGrp=upsThreePhaseOutputGrp, upsBaseOutputStatus=upsBaseOutputStatus, upsThreePhaseBypassSourceVoltageS=upsThreePhaseBypassSourceVoltageS, upsThreePhaseDCandRectifierStatusLowBattery=upsThreePhaseDCandRectifierStatusLowBattery, upsThreePhaseRatingOutputVoltage=upsThreePhaseRatingOutputVoltage, upsSmartInputLineVoltage=upsSmartInputLineVoltage, upsDiagnosticsFailed=upsDiagnosticsFailed, mconfigTrapsReceiversTable=mconfigTrapsReceiversTable, upsScheduleShutdown=upsScheduleShutdown, envSecurity5=envSecurity5, upsEnvSecurity7=upsEnvSecurity7, upsThreePhaseRatingOutputFrequency=upsThreePhaseRatingOutputFrequency, nameOfDevice=nameOfDevice, upsBaseBatteryLastReplaceDate=upsBaseBatteryLastReplaceDate, upsThreePhaseDCandRectifierStatusGrp=upsThreePhaseDCandRectifierStatusGrp, envHumidityNormal=envHumidityNormal, upsBypassacabnormal=upsBypassacabnormal, upsSmartConfig=upsSmartConfig, upsEnvTemperature=upsEnvTemperature, upsHighDCShutdown=upsHighDCShutdown, boostOn=boostOn, upsThreePhaseUPSStaticSwitchMode=upsThreePhaseUPSStaticSwitchMode, upsThreePhaseUPSStatusACStatus=upsThreePhaseUPSStatusACStatus, upsThreePhaseDCandRectifierStatusChargeStatus=upsThreePhaseDCandRectifierStatusChargeStatus, upsEnvUnderHumidity=upsEnvUnderHumidity, upsThreePhaseOutputLoadPercentageT=upsThreePhaseOutputLoadPercentageT, envSmokeAbnormal=envSmokeAbnormal, upsBaseBattery=upsBaseBattery, receiverCommunityString=receiverCommunityString, upsOutputp=upsOutputp, upsSmartIdentUpsSerialNumber=upsSmartIdentUpsSerialNumber, upsThreePhaseOutputVoltageS=upsThreePhaseOutputVoltageS, upsSmartConfigLowTransferVolt=upsSmartConfigLowTransferVolt, upsThreePhaseFaultStatusOverTemperature=upsThreePhaseFaultStatusOverTemperature, upsThreePhaseRatingBatteryVoltage=upsThreePhaseRatingBatteryVoltage, upsThreePhaseDCandRectifierStatusLowBatteryShutdown=upsThreePhaseDCandRectifierStatusLowBatteryShutdown, upsEnvSecurity3=upsEnvSecurity3, upsThreePhaseDCandRectifierStatusRecRotError=upsThreePhaseDCandRectifierStatusRecRotError, upsThreePhaseUPSStatusInverterOperating=upsThreePhaseUPSStatusInverterOperating, upsBypassMode=upsBypassMode, upsTemp=upsTemp, upsBaseControl=upsBaseControl, upsThreePhaseBatteryVoltage=upsThreePhaseBatteryVoltage, upsSmartBattery=upsSmartBattery, products=products, mconfigTrapsReceiversEntry=mconfigTrapsReceiversEntry, trapsIndex=trapsIndex, upsSmartTestCalibrationResults=upsSmartTestCalibrationResults, upsSmartOutputFrequency=upsSmartOutputFrequency, upsSmartIdent=upsSmartIdent, upsThreePhaseFaultStatusInverterOutputFail=upsThreePhaseFaultStatusInverterOutputFail, envWaterNormal=envWaterNormal, upsSmartOutputVoltage=upsSmartOutputVoltage, upsDischarged=upsDischarged)
