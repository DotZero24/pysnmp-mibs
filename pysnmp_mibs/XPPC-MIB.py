...
mibBuilder.exportSymbols("XPPC-MIB", upsBypassacabnormal=upsBypassacabnormal, upsSmartControlSimulatePowerFail=upsSmartControlSimulatePowerFail, upsSmartIdentDateOfManufacture=upsSmartIdentDateOfManufacture, envSecurity1=envSecurity1, upsSmartTestIndicators=upsSmartTestIndicators, upsSmartConfig=upsSmartConfig, upsSmartControlUpsSleep=upsSmartControlUpsSleep, upsThreePhaseOutputFrequency=upsThreePhaseOutputFrequency, mconfigTrapsReceiversNum=mconfigTrapsReceiversNum, upsEnvSecurity4=upsEnvSecurity4, upsInverterMode=upsInverterMode, upsSmartControlTurnOnUpsLoad=upsSmartControlTurnOnUpsLoad, upsTempNormal=upsTempNormal, upsThreePhaseDCandRectifierStatusInAndOut=upsThreePhaseDCandRectifierStatusInAndOut, upsIdentp=upsIdentp, upsSmartConfigSetEEPROMDefaults=upsSmartConfigSetEEPROMDefaults, upsBaseControlConserveBattery=upsBaseControlConserveBattery, upsThreePhaseRatingPower=upsThreePhaseRatingPower, upsTemp=upsTemp, upsThreePhaseFaultStatusInverterOutputFail=upsThreePhaseFaultStatusInverterOutputFail, upsSmartTestDiagnosticsResults=upsSmartTestDiagnosticsResults, upsEnvironment=upsEnvironment, upsBatteryp=upsBatteryp, upsThreePhaseRatingBypassFrequency=upsThreePhaseRatingBypassFrequency, upsSmartControl=upsSmartControl, upsInputp=upsInputp, envSecurity6=envSecurity6, upsBaseInput=upsBaseInput, upsSmartConfigReturnDelay=upsSmartConfigReturnDelay, upsEnvSecurity6=upsEnvSecurity6, upsSmartConfigLowBatteryRunTime=upsSmartConfigLowBatteryRunTime, upsEnvUnderHumidity=upsEnvUnderHumidity, upsEnvOverHumidity=upsEnvOverHumidity, upsBypass=upsBypass, upsSmartIdent=upsSmartIdent, upsSmartControlUpsOff=upsSmartControlUpsOff, upsThreePhaseDCandRectifierStatusLowBatteryShutdown=upsThreePhaseDCandRectifierStatusLowBatteryShutdown, envOverHumidity=envOverHumidity, envSecurity7=envSecurity7, upsThreePhaseBatteryTimeRemain=upsThreePhaseBatteryTimeRemain, upsSmartConfigShutoffDelay=upsSmartConfigShutoffDelay, upsThreePhaseFaultStatusEmergencyStop=upsThreePhaseFaultStatusEmergencyStop, nameOfDevice=nameOfDevice, upsThreePhaseUPSStatusManualBypassBreaker=upsThreePhaseUPSStatusManualBypassBreaker, upsSmartBatteryReplaceIndicator=upsSmartBatteryReplaceIndicator, envOverTemperature=envOverTemperature, upsSmartConfigRatedOutputVoltage=upsSmartConfigRatedOutputVoltage, communicationEstablished=communicationEstablished, upsSmartControlFlashAndBeep=upsSmartControlFlashAndBeep, returnFromLowBattery=returnFromLowBattery, upsThreePhaseInputFrequency=upsThreePhaseInputFrequency, receiverCommunityString=receiverCommunityString, upsThreePhaseOutputVoltageS=upsThreePhaseOutputVoltageS, upsSmartIdentAgentFirmwareRevision=upsSmartIdentAgentFirmwareRevision, upsEnvUnderTemperature=upsEnvUnderTemperature, upsThreePhaseRatingBypassVoltage=upsThreePhaseRatingBypassVoltage, mconfigTrapsReceiversTable=mconfigTrapsReceiversTable, upsThreePhaseRatingRectifierVoltage=upsThreePhaseRatingRectifierVoltage, upsThreePhaseRatingGrp=upsThreePhaseRatingGrp, upsThreePhaseDCandRectifierStatusRecOperating=upsThreePhaseDCandRectifierStatusRecOperating, upsBypassFreFail=upsBypassFreFail, upsThreePhaseFaultStatusGrp=upsThreePhaseFaultStatusGrp, upsSmartIdentUpsSerialNumber=upsSmartIdentUpsSerialNumber, upsSmartBattery=upsSmartBattery, upsThreePhaseInputVoltageR=upsThreePhaseInputVoltageR, mconfigTrapsReceiversEntry=mconfigTrapsReceiversEntry, upsInverterOutputFailShutdown=upsInverterOutputFailShutdown, upsBaseTest=upsBaseTest, upsThreePhaseFaultStatusHighDCShutdown=upsThreePhaseFaultStatusHighDCShutdown, upsEnvSecurity7=upsEnvSecurity7, upsThreePhaseBypassSourceVoltageT=upsThreePhaseBypassSourceVoltageT, trapsIndex=trapsIndex, upsThreePhaseUPSStatusACStatus=upsThreePhaseUPSStatusACStatus, upsEnvSecurity5=upsEnvSecurity5, upsBypassMode=upsBypassMode, returnFromBoost=returnFromBoost, envUnderHumidity=envUnderHumidity, upsSmartIdentFirmwareRevision=upsSmartIdentFirmwareRevision, upsThreePhaseFaultStatusOverTemperature=upsThreePhaseFaultStatusOverTemperature, upsEnvWater=upsEnvWater, upsThreePhaseOutputGrp=upsThreePhaseOutputGrp, upsOverLoad=upsOverLoad, upsSmartOutputVoltage=upsSmartOutputVoltage, upsSmartBatteryRunTimeRemaining=upsSmartBatteryRunTimeRemaining, deviceAccept=deviceAccept, upsEnvStatus=upsEnvStatus, upsBaseIdentUpsName=upsBaseIdentUpsName, upsThreePhaseInputGrp=upsThreePhaseInputGrp, upsSmartInputLineFailCause=upsSmartInputLineFailCause, upsSmartOutputFrequency=upsSmartOutputFrequency, upsSmartConfigUpsSleepTime=upsSmartConfigUpsSleepTime, upsSmartConfigSensitivity=upsSmartConfigSensitivity, upsEnvSmoke=upsEnvSmoke, upsSmartConfigLowTransferVolt=upsSmartConfigLowTransferVolt, upsSmartBatteryVoltage=upsSmartBatteryVoltage, upsBaseOutputStatus=upsBaseOutputStatus, ppcmgmt=ppcmgmt, products=products, upsDiagnosticsPassed=upsDiagnosticsPassed, ups=ups, upsBaseOutputPhase=upsBaseOutputPhase, upsThreePhaseFaultStatusOverLoad=upsThreePhaseFaultStatusOverLoad, upsThreePhaseDCandRectifierStatusGrp=upsThreePhaseDCandRectifierStatusGrp, upsSmartInputMinLineVoltage=upsSmartInputMinLineVoltage, trapsReceiverAddr=trapsReceiverAddr, upsDiagnosticsFailed=upsDiagnosticsFailed, upsOverLoadShutdown=upsOverLoadShutdown, upsThreePhaseDCandRectifierStatusChargeStatus=upsThreePhaseDCandRectifierStatusChargeStatus, upsSmartBatteryCurrent=upsSmartBatteryCurrent, envUnderTemperature=envUnderTemperature, upsThreePhaseBypassGrp=upsThreePhaseBypassGrp, upsThreePhaseFaultStatusBypassBreaker=upsThreePhaseFaultStatusBypassBreaker, upsSmartTestLastDiagnosticsDate=upsSmartTestLastDiagnosticsDate, upsSmartTest=upsSmartTest, upsThreePhaseOutputLoadPercentageR=upsThreePhaseOutputLoadPercentageR, mconfig=mconfig, upsRebootStarted=upsRebootStarted, upsSmartConfigMinReturnCapacity=upsSmartConfigMinReturnCapacity, upsThreePhaseBatteryCapacityPercentage=upsThreePhaseBatteryCapacityPercentage, upsThreePhaseUPSStaticSwitchMode=upsThreePhaseUPSStaticSwitchMode, upsThreePhaseBatteryGrp=upsThreePhaseBatteryGrp, envTemperatureNormal=envTemperatureNormal, lowBattery=lowBattery, upsSmartOutput=upsSmartOutput, upsTest=upsTest, upsEnvOverTemperature=upsEnvOverTemperature, upsThreePhaseBypassSourceVoltageS=upsThreePhaseBypassSourceVoltageS, upsBaseConfigDeviceEntry=upsBaseConfigDeviceEntry, upsBypassBreadkerOnShutdown=upsBypassBreadkerOnShutdown, upsSmartBatteryCapacity=upsSmartBatteryCapacity, upsThreePhaseBatteryCurrent=upsThreePhaseBatteryCurrent, upsSmartTestDiagnostics=upsSmartTestDiagnostics, upsBypassReturn=upsBypassReturn, upsThreePhaseInputVoltageT=upsThreePhaseInputVoltageT, upsBaseBatteryTimeOnBattery=upsBaseBatteryTimeOnBattery, upsHighDCShutdown=upsHighDCShutdown, upsBaseInputPhase=upsBaseInputPhase, upsWokeUp=upsWokeUp, upsSmartInput=upsSmartInput, upsShortCircuitShutdown=upsShortCircuitShutdown, buckOn=buckOn, vaRatingOfDevice=vaRatingOfDevice, envGasAbnormal=envGasAbnormal, upsThreePhaseRatingRectifierFrequency=upsThreePhaseRatingRectifierFrequency, upsSmartInputLineVoltage=upsSmartInputLineVoltage, envSmokeAbnormal=envSmokeAbnormal, upsSmartTestDiagnosticSchedule=upsSmartTestDiagnosticSchedule, upsSmartInputFrequency=upsSmartInputFrequency, upsThreePhaseUPSStatusGrp=upsThreePhaseUPSStatusGrp, upsEmergencyStop=upsEmergencyStop, upsLoadNormal=upsLoadNormal, envSecurity5=envSecurity5, upsEnvSecurity3=upsEnvSecurity3, upsThreePhaseUPSStatusBypassFreqFail=upsThreePhaseUPSStatusBypassFreqFail, upsEnvHumidity=upsEnvHumidity, envSecurity3=envSecurity3, upsOutputp=upsOutputp, upsThreePhaseOutputLoadPercentageT=upsThreePhaseOutputLoadPercentageT, upsBaseConfigDeviceTable=upsBaseConfigDeviceTable, upsSmartTestCalibrationResults=upsSmartTestCalibrationResults, upsCapacityUnderrun=upsCapacityUnderrun, envHumidityNormal=envHumidityNormal, upsConfigp=upsConfigp, upsBaseIdent=upsBaseIdent, upsSmartBatteryFullChargeVoltage=upsSmartBatteryFullChargeVoltage, upsSmartConfigAlarm=upsSmartConfigAlarm, upsThreePhaseOutputVoltageT=upsThreePhaseOutputVoltageT, upsThreePhaseRatingOutputVoltage=upsThreePhaseRatingOutputVoltage, severityLevel=severityLevel, upsThreePhaseBatteryVoltage=upsThreePhaseBatteryVoltage, upsBaseBattery=upsBaseBattery, powerRestored=powerRestored, upsBaseConfig=upsBaseConfig, upsSmartOutputLoad=upsSmartOutputLoad, receiverAccept=receiverAccept, upsThreePhaseRatingBatteryVoltage=upsThreePhaseRatingBatteryVoltage, upsBaseBatteryStatus=upsBaseBatteryStatus, returnFromBuck=returnFromBuck, upsOverTemperatureShutdown=upsOverTemperatureShutdown, upsThreePhaseOutputVoltageR=upsThreePhaseOutputVoltageR, upsSmartConfigAlarmTimer=upsSmartConfigAlarmTimer, upsThreePhaseBatteryTemperature=upsThreePhaseBatteryTemperature, hardware=hardware, upsThreePhaseDCandRectifierStatusBatteryStatus=upsThreePhaseDCandRectifierStatusBatteryStatus, upsEnvTemperature=upsEnvTemperature, boostOn=boostOn, upsBaseBatteryLastReplaceDate=upsBaseBatteryLastReplaceDate, upsThreePhaseBypassSourceFrequency=upsThreePhaseBypassSourceFrequency, upsBaseOutput=upsBaseOutput, upsThreePhaseRatingOutputFrequency=upsThreePhaseRatingOutputFrequency, upsRecroterror=upsRecroterror, upsThreePhaseInputVoltageS=upsThreePhaseInputVoltageS, upsSleeping=upsSleeping, upsSmartInputMaxLineVoltage=upsSmartInputMaxLineVoltage, upsTestp=upsTestp, upsTurnedOff=upsTurnedOff, upsThreePhase=upsThreePhase, upsBaseControl=upsBaseControl, upsEnvSecurity1=upsEnvSecurity1, ppc=ppc, upsOnBattery=upsOnBattery, upsThreePhaseOutputLoadPercentageS=upsThreePhaseOutputLoadPercentageS, upsDischarged=upsDischarged, upsEnvSecurity2=upsEnvSecurity2, upsBaseIdentModel=upsBaseIdentModel, envWaterNormal=envWaterNormal, envSecurity4=envSecurity4, upsBypassacnormal=upsBypassacnormal, upsThreePhaseDCandRectifierStatusRecRotError=upsThreePhaseDCandRectifierStatusRecRotError, upsThreePhaseDCandRectifierStatusLowBattery=upsThreePhaseDCandRectifierStatusLowBattery, envWaterAbnormal=envWaterAbnormal, upsCapacityNormal=upsCapacityNormal, upsThreePhaseUPSStatusInverterOperating=upsThreePhaseUPSStatusInverterOperating, upsControlp=upsControlp, upsSmartBatteryTemperature=upsSmartBatteryTemperature, upsThreePhaseBypassSourceVoltageR=upsThreePhaseBypassSourceVoltageR, envSecurityAbnormal=envSecurityAbnormal, communicationLost=communicationLost, upsThreePhaseFaultStatusShortCircuit=upsThreePhaseFaultStatusShortCircuit, upsSmartTestCalibrationDate=upsSmartTestCalibrationDate, upsEnvSetting=upsEnvSetting, indexOfDevice=indexOfDevice, upsSmartTestRuntimeCalibration=upsSmartTestRuntimeCalibration, upsSmartControlRebootUps=upsSmartControlRebootUps, upsBaseConfigNumDevices=upsBaseConfigNumDevices, upsSmartConfigHighTransferVolt=upsSmartConfigHighTransferVolt, envSecurity2=envSecurity2, upsLowBatteryShutdown=upsLowBatteryShutdown, upsScheduleShutdown=upsScheduleShutdown)
