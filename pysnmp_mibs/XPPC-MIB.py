...
# Notes
# -----
# ASN.1 source file://mibs/megatec/XPPC-MIB
...
upsThreePhaseBypassSourceVoltageR = _UpsThreePhaseBypassSourceVoltageR_Object(
    (1, 3, 6, 1, 4, 1, 935, 1, 1, 1, 8, 4, 2),
    _UpsThreePhaseBypassSourceVoltageR_Type()
)
upsThreePhaseBypassSourceVoltageR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    upsThreePhaseBypassSourceVoltageR.setStatus("mandatory")
_UpsThreePhaseBypassSourceVoltageS_Type = Integer32
_UpsThreePhaseBypassSourceVoltageS_Object = MibScalar
upsThreePhaseBypassSourceVoltageS = _UpsThreePhaseBypassSourceVoltageS_Object(
    (1, 3, 6, 1, 4, 1, 935, 1, 1, 1, 8, 4, 3),
    _UpsThreePhaseBypassSourceVoltageS_Type()
)
upsThreePhaseBypassSourceVoltageS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    upsThreePhaseBypassSourceVoltageS.setStatus("mandatory")
_UpsThreePhaseBypassSourceVoltageT_Type = Integer32
_UpsThreePhaseBypassSourceVoltageT_Object = MibScalar
upsThreePhaseBypassSourceVoltageT = _UpsThreePhaseBypassSourceVoltageT_Object(
    (1, 3, 6, 1, 4, 1, 935, 1, 1, 1, 8, 4, 4),
    _UpsThreePhaseBypassSourceVoltageT_Type()
)
upsThreePhaseBypassSourceVoltageT.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    upsThreePhaseBypassSourceVoltageT.setStatus("mandatory")
...
buckOn = NotificationType(
    (1, 3, 6, 1, 4, 1, 935, 0, 68)
)
if mibBuilder.loadTexts:
    buckOn.setStatus(
        ""
...
returnFromBuck = NotificationType(
    (1, 3, 6, 1, 4, 1, 935, 0, 69)
)
if mibBuilder.loadTexts:
    returnFromBuck.setStatus(
        ""
    )

returnFromBoost = NotificationType(
    (1, 3, 6, 1, 4, 1, 935, 0, 70)
)
if mibBuilder.loadTexts:
    returnFromBoost.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"ppc": ppc,
       ...
       "buckOn": buckOn,
       "returnFromBuck": returnFromBuck,
       "returnFromBoost": returnFromBoost,
       "products": products,
       "hardware": hardware,
       "ups": ups,
       "upsIdentp": upsIdentp,
       ...
       "upsThreePhaseBypassSourceVoltageR": upsThreePhaseBypassSourceVoltageR,
       "upsThreePhaseBypassSourceVoltageS": upsThreePhaseBypassSourceVoltageS,
       "upsThreePhaseBypassSourceVoltageT": upsThreePhaseBypassSourceVoltageT,
