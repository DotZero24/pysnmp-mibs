...
mibBuilder.exportSymbols("EdgeSwitch-LOOPBACK-MIB", agentLoopbackIfIndex=agentLoopbackIfIndex, agentLoopbackStatus=agentLoopbackStatus, agentLoopbackID=agentLoopbackID, agentLoopbackIPSubnet=agentLoopbackIPSubnet, agentLoopbackTable=agentLoopbackTable, fastPathLoopback=fastPathLoopback, agentLoopbackIPAddress=agentLoopbackIPAddress, agentLoopbackEntry=agentLoopbackEntry, PYSNMP_MODULE_ID=fastPathLoopback, agentLoopbackGroup=agentLoopbackGroup)
