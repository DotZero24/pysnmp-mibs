# SNMP MIB module (EdgeSwitch-LOOPBACK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ubiquiti/EdgeSwitch-LOOPBACK-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:58:56 2025
...
agentLoopbackID = _AgentLoopbackID_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 22, 1, 1, 1, 1),
...
agentLoopbackIfIndex = _AgentLoopbackIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 22, 1, 1, 1, 2),
...
agentLoopbackIPAddress = _AgentLoopbackIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 22, 1, 1, 1, 3),
...
agentLoopbackIPSubnet = _AgentLoopbackIPSubnet_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 22, 1, 1, 1, 4),
...
agentLoopbackStatus = _AgentLoopbackStatus_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 22, 1, 1, 1, 5),
