...
mibBuilder.exportSymbols("EPPC-MIB", upsEBatteryTestStart=upsEBatteryTestStart, upsEReturnFromBypassPhaseError=upsEReturnFromBypassPhaseError, upsEBatteryStatus=upsEBatteryStatus, upsESystemInputTable=upsESystemInputTable, sensorHumidityTooHigh=sensorHumidityTooHigh, upsETrapsReceiversTable=upsETrapsReceiversTable, upsEInspectionInform=upsEInspectionInform, upsELoadSegment2AutoOnTimer=upsELoadSegment2AutoOnTimer, upsEModuleInserted=upsEModuleInserted, upsEBatteryOpen=upsEBatteryOpen, upsESystemBypassTable=upsESystemBypassTable, sensorTemperatureTooLow=sensorTemperatureTooLow, upsEIdentityManufacturer=upsEIdentityManufacturer, upsEEnvironmentHumidityHighSetPoint=upsEEnvironmentHumidityHighSetPoint, upsEReturnFromChargerfault=upsEReturnFromChargerfault, upsESystemOutputVA=upsESystemOutputVA, upsEReturnFromBatteryOverCharge=upsEReturnFromBatteryOverCharge, upsELoadSegment1State=upsELoadSegment1State, upsETemperatureHigh=upsETemperatureHigh, ppc=ppc, upsEBatteryTestSettingTime=upsEBatteryTestSettingTime, upsEEnvironmentContactType=upsEEnvironmentContactType, upsEGuaranteeInform=upsEGuaranteeInform, upsEControl=upsEControl, upsESystemInputNumPhases=upsESystemInputNumPhases, upsEEnvironmentHumidity=upsEEnvironmentHumidity, upsELoadSegment1AutoOffTimer=upsELoadSegment1AutoOffTimer, upsESpecialDayScheduleShutdownDay=upsESpecialDayScheduleShutdownDay, upsESpecialDayScheduleRestartDay=upsESpecialDayScheduleRestartDay, upsEBatteryLastReplacedDate=upsEBatteryLastReplacedDate, upsEBatteryTestScheduleTestWithTime=upsEBatteryTestScheduleTestWithTime, upsESpecialDayScheduleRestartTime=upsESpecialDayScheduleRestartTime, upsEBatterySystem=upsEBatterySystem, upsEReturnFromOverloadforewarning=upsEReturnFromOverloadforewarning, upsEReturnFromBatteryOverTemperature=upsEReturnFromBatteryOverTemperature, upsESystemOutputTable=upsESystemOutputTable, upsEOverloadWarning=upsEOverloadWarning, upsEReturnFromLowBattery=upsEReturnFromLowBattery, upsEFanLock=upsEFanLock, upsEReturnFromSystemOverCapacity=upsEReturnFromSystemOverCapacity, sensorHumidityNotHigh=sensorHumidityNotHigh, upsELoadSegment1On=upsELoadSegment1On, upsEShutdownEventsEntry=upsEShutdownEventsEntry, upsESystemBypassPhase=upsESystemBypassPhase, positiveChargeCurrent=positiveChargeCurrent, sensorHumidityNotLow=sensorHumidityNotLow, upsEOverloadforewarning=upsEOverloadforewarning, upsESleeping=upsESleeping, upsEEnvironmentTemperature=upsEEnvironmentTemperature, upsEModuleRemoved=upsEModuleRemoved, upsEWeeklyScheduleShutdownTime=upsEWeeklyScheduleShutdownTime, upsEGoingShutdown=upsEGoingShutdown, upsETrapControl=upsETrapControl, upsESystemConfigOutputLoadHighSetPoint=upsESystemConfigOutputLoadHighSetPoint, upsESystemInputLineBads=upsESystemInputLineBads, upsEControlWeeklyScheduleEntry=upsEControlWeeklyScheduleEntry, upsEModuleWorkingMode=upsEModuleWorkingMode, upsEBelowRemainTimeLimit=upsEBelowRemainTimeLimit, upsEEnvironmentHumidityHighStatus=upsEEnvironmentHumidityHighStatus, upsEEnvironmentContactState=upsEEnvironmentContactState, chargerModulesMode=chargerModulesMode, upsEEnvironmentContactEntry=upsEEnvironmentContactEntry, contactAlarm2Normal=contactAlarm2Normal, upsEOverLoad=upsEOverLoad, upsEOutlet1ShutdownCancelled=upsEOutlet1ShutdownCancelled, upsERedundancyloss=upsERedundancyloss, upsEShutdownWarningPeriodInterval=upsEShutdownWarningPeriodInterval, upsEIndentityUPSSerialNumber=upsEIndentityUPSSerialNumber, upsETrapType=upsETrapType, upsEModuleOutputWattS=upsEModuleOutputWattS, upsELoadSegment2AutoOffTimer=upsELoadSegment2AutoOffTimer, upsEEnvironmentCurrentHumidity=upsEEnvironmentCurrentHumidity, upsEModuleUnlock=upsEModuleUnlock, upsEReturnFromMain1phaseerror=upsEReturnFromMain1phaseerror, upsEModuleOutputCurrentT=upsEModuleOutputCurrentT, upsEBatteryABMStatus=upsEBatteryABMStatus, upsEModuleOutputVAS=upsEModuleOutputVAS, upsEEnvironmentContactTable=upsEEnvironmentContactTable, upsEReturnFromMaintaincoverisopen=upsEReturnFromMaintaincoverisopen, upsEReturnFromHotSwapActived=upsEReturnFromHotSwapActived, upsEEPOActive=upsEEPOActive, upsEControlWeeklyScheduleTable=upsEControlWeeklyScheduleTable, upsEIdentityDescription=upsEIdentityDescription, upsELoadSegment1AutoOnTimer=upsELoadSegment1AutoOnTimer, upsEShutdownEventAction=upsEShutdownEventAction, upsELoadSegment1OffDelay=upsELoadSegment1OffDelay, upsEReturnFromSitefault=upsEReturnFromSitefault, upsEBypassAbnormal=upsEBypassAbnormal, upsESystemWarningCode=upsESystemWarningCode, upsETraps=upsETraps, upsESystemOverCapacity=upsESystemOverCapacity, upsESystemConfigOutputVoltage=upsESystemConfigOutputVoltage, upsEBatteryTestResult=upsEBatteryTestResult, upsEBatteryTestScheduleEntry=upsEBatteryTestScheduleEntry, upsEOnline=upsEOnline, upsAgent=upsAgent, upsESitefault=upsESitefault, upsELoadSegment1OnDelay=upsELoadSegment1OnDelay, upsEReturnFromBatteryReverse=upsEReturnFromBatteryReverse, upsESystemOutputPhase=upsESystemOutputPhase, upsEControlSpecialDayScheduleEntry=upsEControlSpecialDayScheduleEntry, upsETemperatureLow=upsETemperatureLow, upsEBusCapacitanceMaintainInform=upsEBusCapacitanceMaintainInform, upsEIdentityAgentSoftwareVerison=upsEIdentityAgentSoftwareVerison, upsEEnvironment=upsEEnvironment, negativeChargeCurrent=negativeChargeCurrent, upsEBatteryTestStartTime=upsEBatteryTestStartTime, upsEBatteryOverCharge=upsEBatteryOverCharge, upsEFailed=upsEFailed, upsEBatteryReverse=upsEBatteryReverse, upsESystemOutputNumPhase=upsESystemOutputNumPhase, upsEReturnFromFanMaintainInform=upsEReturnFromFanMaintainInform, upsEWeeklyScheduleShutdownDay=upsEWeeklyScheduleShutdownDay, upsELoadSegment=upsELoadSegment, device=device, upsEModulesTable=upsEModulesTable, upsEBatteryTestElapsedTime=upsEBatteryTestElapsedTime, upsETrapsReceiversIndex=upsETrapsReceiversIndex, upsEModuleOutputLoadS=upsEModuleOutputLoadS, upsEModuleOutputVAR=upsEModuleOutputVAR, upsETrapReceiverDescription=upsETrapReceiverDescription, upsEModuleConfigOutputVA=upsEModuleConfigOutputVA, upsESystemBypassEntry=upsESystemBypassEntry, upsEBatteryEstimatedChargeRemaining=upsEBatteryEstimatedChargeRemaining, upsEOutlet2ShutdownCancelled=upsEOutlet2ShutdownCancelled, upsELoadSegment2OffDelay=upsELoadSegment2OffDelay, upsEBypassOn=upsEBypassOn, upsEFanMaintainInform=upsEFanMaintainInform, upsEReturnFromModuleUnlock=upsEReturnFromModuleUnlock, upsEBatteryTestScheduleTable=upsEBatteryTestScheduleTable, upsEChargerModulesTable=upsEChargerModulesTable, upsEControlOutputOffDelay=upsEControlOutputOffDelay, upsEReturnFromInternalwarning=upsEReturnFromInternalwarning, upsEMaintaincoverisopen=upsEMaintaincoverisopen, upsEIdentity=upsEIdentity, upsEBatteryTestScheduleDay=upsEBatteryTestScheduleDay, upsEShutdownEventsTable=upsEShutdownEventsTable, upsEChargerfault=upsEChargerfault, upsEModuleOutputCurrentS=upsEModuleOutputCurrentS, upsEModuleTemperature=upsEModuleTemperature, upsEEnvironmentTemperatureOffset=upsEEnvironmentTemperatureOffset, upsEBatteryEstimatedMinutesRemaining=upsEBatteryEstimatedMinutesRemaining, upsECommunicationLost=upsECommunicationLost, upsEShutdownCancelled=upsEShutdownCancelled, upsEShutdownwarningPeriodTime=upsEShutdownwarningPeriodTime, sensorTemperatureNotHigh=sensorTemperatureNotHigh, upsESystemConfigOutputFrequency=upsESystemConfigOutputFrequency, negativeChargeVoltage=negativeChargeVoltage, upsEReturnFromInspectionInform=upsEReturnFromInspectionInform, upsENegativeBatteryVoltage=upsENegativeBatteryVoltage, upsESystemOutputCurrent=upsESystemOutputCurrent, upsESystemBypassNumPhase=upsESystemBypassNumPhase, upsEControlOutputOnOffControl=upsEControlOutputOnOffControl, upsELoadSegment2On=upsELoadSegment2On, upsESystemInputPhase=upsESystemInputPhase, upsETurnonabnormal=upsETurnonabnormal, upsEReturnFromEPOActive=upsEReturnFromEPOActive, upsETrapsSeverityLevel=upsETrapsSeverityLevel, upsESystemConfigBelowRemainTimeLimit=upsESystemConfigBelowRemainTimeLimit, upsEEnvironmentHumidityOffset=upsEEnvironmentHumidityOffset, upsESystemOutputWatts=upsESystemOutputWatts, upsEModuleNegativeBusVolt=upsEModuleNegativeBusVolt, upsESystemInputEntry=upsESystemInputEntry, upsESystemBypassWatts=upsESystemBypassWatts, upsESystemOutputLoad=upsESystemOutputLoad, upsEBatteryTemperature=upsEBatteryTemperature, upsEReturnFromFanLock=upsEReturnFromFanLock, upsEModuleFaultCode=upsEModuleFaultCode, upsEReturnFromRedundancyloss=upsEReturnFromRedundancyloss, upsEReturnFromBusCapacitanceMaintainInform=upsEReturnFromBusCapacitanceMaintainInform, upsEEnvironmentTemperatureLowSetPoint=upsEEnvironmentTemperatureLowSetPoint, upsEIdentityModel=upsEIdentityModel, upsEBatteryTest=upsEBatteryTest, upsELoadSegment2State=upsELoadSegment2State, upsESystemConfigOutputVA=upsESystemConfigOutputVA, upsESystemInputVoltage=upsESystemInputVoltage, upsEReturnFromTemperatureHigh=upsEReturnFromTemperatureHigh, upsEWeeklyScheduleRestartDay=upsEWeeklyScheduleRestartDay, upsEIdentityUPSFirmwareVerison=upsEIdentityUPSFirmwareVerison, upsEPositiveBatteryVoltage=upsEPositiveBatteryVoltage, upsEControlSpecialDayScheduleTable=upsEControlSpecialDayScheduleTable, upsEReturnFromBatteryOpen=upsEReturnFromBatteryOpen, upsEHotSwapActived=upsEHotSwapActived, upsEBatteryOverTemperature=upsEBatteryOverTemperature, upsESystemTemperature=upsESystemTemperature, upsESystemInputCurrent=upsESystemInputCurrent, upsEBatteryInform=upsEBatteryInform, upsESystemConfigInputVoltage=upsESystemConfigInputVoltage, chargerModulesNum=chargerModulesNum, upsEOk=upsEOk, upsEPowerFail=upsEPowerFail, sensorTemperatureNotLow=sensorTemperatureNotLow, upsEBatteryCellNumber=upsEBatteryCellNumber, upsEIdentityAttachedDevices=upsEIdentityAttachedDevices, upsETrapsReceiversEntry=upsETrapsReceiversEntry, upsEEnvironmentHumidityLowStatus=upsEEnvironmentHumidityLowStatus, concactAlarm1Normal=concactAlarm1Normal, chargerModulesAddress=chargerModulesAddress, upsEBatteryTestScheduleType=upsEBatteryTestScheduleType, upsENotOnBattery=upsENotOnBattery, upsEModuleOutputCurrentR=upsEModuleOutputCurrentR, upsEReturnFromOverloadWarning=upsEReturnFromOverloadWarning, upsEShutdownEvent=upsEShutdownEvent, upsEEnvironmentTemperatureHighSetPoint=upsEEnvironmentTemperatureHighSetPoint, contactAlarm1Active=contactAlarm1Active, upsEModulePositiveBusVolt=upsEModulePositiveBusVolt, upsEReturnFromBypassAbnormal=upsEReturnFromBypassAbnormal, upsESystemConfigInputFrequence=upsESystemConfigInputFrequence, upsESystemMasterOffDelay=upsESystemMasterOffDelay, upsESystemConfigOverTemperatureSetPoint=upsESystemConfigOverTemperatureSetPoint, upsESystemConfigBelowCapacityLimit=upsESystemConfigBelowCapacityLimit, upsEReturnFromGuaranteeInform=upsEReturnFromGuaranteeInform, upsESystemStatus=upsESystemStatus, upsETestInProgress=upsETestInProgress, upsESystemFaultCode=upsESystemFaultCode, upsEModuleOutputWattT=upsEModuleOutputWattT, upsEControlOutputOnDelay=upsEControlOutputOnDelay, upsEChargerModulesEntry=upsEChargerModulesEntry, upsEPowerConverterSystem=upsEPowerConverterSystem, upsESystemConfigOutputPower=upsESystemConfigOutputPower, upsESystemSummary=upsESystemSummary, upsEBatteryTestScheduleSpecialDay=upsEBatteryTestScheduleSpecialDay, upsEMain1Neutralloss=upsEMain1Neutralloss, upsESystemInputFrequency=upsESystemInputFrequency, upsEModulesNum=upsEModulesNum, upsELoadSegment2OnDelay=upsELoadSegment2OnDelay, upsESecondsOnBattery=upsESecondsOnBattery, upsEModulelocationerror=upsEModulelocationerror, upsEControlWeeklyScheduleIndex=upsEControlWeeklyScheduleIndex, upsEEnvironmentTemperatureHighStatus=upsEEnvironmentTemperatureHighStatus, upsEBelowCapacityLimit=upsEBelowCapacityLimit, upsESystemInputWatts=upsESystemInputWatts, upsEControlSpecialDayScheduleIndex=upsEControlSpecialDayScheduleIndex, upsEModuleOutputWattR=upsEModuleOutputWattR, upsEReturnFromBatteryInform=upsEReturnFromBatteryInform, upsEBatteryTestScheduleIndex=upsEBatteryTestScheduleIndex, upsESystemMasterOnDelay=upsESystemMasterOnDelay, upsEOutlet1GoingShutdown=upsEOutlet1GoingShutdown, upsESystemBypassFrequency=upsESystemBypassFrequency, upsECommunicationEstablished=upsECommunicationEstablished, upsESystemInputSourceNum=upsESystemInputSourceNum, upsETrapsReceiverAddress=upsETrapsReceiverAddress, upsENotOverTemperature=upsENotOverTemperature, upsESystemOutputVoltage=upsESystemOutputVoltage, upsEEnvironmentTemperatureLowStatus=upsEEnvironmentTemperatureLowStatus, positiveChargeVotlage=positiveChargeVotlage, upsEWokeUp=upsEWokeUp, upsEModuleAddress=upsEModuleAddress, upsEEnvironmentCurrentTemperature=upsEEnvironmentCurrentTemperature, upsETestOver=upsETestOver, upsEInternalwarning=upsEInternalwarning, upsESystemBypassVoltage=upsESystemBypassVoltage, upsESpecialDayScheduleShutdownTime=upsESpecialDayScheduleShutdownTime, upsEOnBattery=upsEOnBattery)
mibBuilder.exportSymbols("EPPC-MIB", upsEModuleOutputVAT=upsEModuleOutputVAT, sensorHumidityTooLow=sensorHumidityTooLow, upsEUPSModulesNum=upsEUPSModulesNum, upsEModuleWarningCode=upsEModuleWarningCode, upsEReturnFromTurnonabnormal=upsEReturnFromTurnonabnormal, upsELoadSegment1Off=upsELoadSegment1Off, upsEEnvironmentContactDescription=upsEEnvironmentContactDescription, upsEReturnFromMain1Neutralloss=upsEReturnFromMain1Neutralloss, upsEModulesEntry=upsEModulesEntry, upsENotOverLoad=upsENotOverLoad, upsENotBelowRemainTimeLimit=upsENotBelowRemainTimeLimit, upsEChargerModulesNum=upsEChargerModulesNum, upsETrapState=upsETrapState, upsEWeeklyScheduleRestartTime=upsEWeeklyScheduleRestartTime, upsEOverTemperature=upsEOverTemperature, upsEModuleOutputLoadT=upsEModuleOutputLoadT, upsEOutlet2GoingShutdown=upsEOutlet2GoingShutdown, upsE=upsE, upsESystemOutputEntry=upsESystemOutputEntry, chargerModulesTemperature=chargerModulesTemperature, upsEEnvironmentContactIndex=upsEEnvironmentContactIndex, upsEMain1phaseerror=upsEMain1phaseerror, upsESystemOutputFrequency=upsESystemOutputFrequency, upsETrapReceiverCommunityString=upsETrapReceiverCommunityString, sensorTemperatureTooHigh=sensorTemperatureTooHigh, upsEReturnFromModulelocationerror=upsEReturnFromModulelocationerror, upsESystemBypassCurrent=upsESystemBypassCurrent, upsEEnvironmentContactsNum=upsEEnvironmentContactsNum, upsEBatteryTestScheduleTime=upsEBatteryTestScheduleTime, upsEPowerRestored=upsEPowerRestored, upsELoadSegment2Off=upsELoadSegment2Off, upsEEnvironmentHumidityLowSetPoint=upsEEnvironmentHumidityLowSetPoint, contactAlarm2Active=contactAlarm2Active, upsELowBattery=upsELowBattery, upsENotBelowCapacityLimit=upsENotBelowCapacityLimit, upsEModuleOutputLoadR=upsEModuleOutputLoadR, upsEReturnFromTemperatureLow=upsEReturnFromTemperatureLow, upsEModuleTrapState=upsEModuleTrapState, upsEBypassPhaseError=upsEBypassPhaseError)
