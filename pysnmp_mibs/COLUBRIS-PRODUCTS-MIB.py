...
# Notes
# -----
# ASN.1 source file://mibs/colubris/COLUBRIS-PRODUCTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:29:42 2025
...
colubrisMSM720 = _ColubrisMSM720_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8744, 1, 56)
)
_ColubrisMSM466R_ObjectIdentity = ObjectIdentity
colubrisMSM466R = _ColubrisMSM466R_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8744, 1, 58)
)
_ColubrisMSM775_ObjectIdentity = ObjectIdentity
colubrisMSM775 = _ColubrisMSM775_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8744, 1, 59)
)
_ColubrisHP425_ObjectIdentity = ObjectIdentity
colubrisHP425 = _ColubrisHP425_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8744, 1, 62)
)
_ColubrisHP517_ObjectIdentity = ObjectIdentity
colubrisHP517 = _ColubrisHP517_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8744, 1, 64)
)
_ColubrisHP560_ObjectIdentity = ObjectIdentity
colubrisHP560 = _ColubrisHP560_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8744, 1, 65)
)
_ColubrisMSM760B_ObjectIdentity = ObjectIdentity
colubrisMSM760B = _ColubrisMSM760B_ObjectIdentity(
...
mibBuilder.exportSymbols(
    ...
    **{"colubrisCN1000": colubrisCN1000,
       ...
       "colubrisMSM466R": colubrisMSM466R,
       "colubrisMSM775": colubrisMSM775,
       "colubrisHP425": colubrisHP425,
       "colubrisHP517": colubrisHP517,
       "colubrisHP560": colubrisHP560,
       "colubrisMSM760B": colubrisMSM760B,
