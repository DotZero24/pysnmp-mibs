...
# Notes
# -----
# ASN.1 source file://mibs/cabletron/CTRON-Q-BRIDGE-MIB-EXT
# Produced by pysmi-1.6.2 at Fri Oct 10 19:56:14 2025
...
_CtDot1qPortDiscardTagged_Type.__name__ = "EnabledStatus"
...
_CtDot1qPortReplaceTCI_Type.__name__ = "EnabledStatus"
...
_CtDot1qVlanDynamicEgressStatus_Type.__name__ = "EnabledStatus"
...
_CtDot1qTpFdbRemoveAddress_Type.__name__ = "TruthValue"
...
ctDot1qVlanGvrpRestrictedTable = _CtDot1qVlanGvrpRestrictedTable_Object(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 1, 6)
)
if mibBuilder.loadTexts:
    ctDot1qVlanGvrpRestrictedTable.setStatus("current")
_CtDot1qVlanGvrpRestrictedEntry_Object = MibTableRow
ctDot1qVlanGvrpRestrictedEntry = _CtDot1qVlanGvrpRestrictedEntry_Object(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 1, 6, 1)
)
ctDot1qVlanGvrpRestrictedEntry.setIndexNames(
    (0, "CTRON-Q-BRIDGE-MIB-EXT", "ctDot1qVlanGvrpRestrictedIndex"),
)
if mibBuilder.loadTexts:
    ctDot1qVlanGvrpRestrictedEntry.setStatus("current")
_CtDot1qVlanGvrpRestrictedIndex_Type = VlanIndex
_CtDot1qVlanGvrpRestrictedIndex_Object = MibTableColumn
ctDot1qVlanGvrpRestrictedIndex = _CtDot1qVlanGvrpRestrictedIndex_Object(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 1, 6, 1, 1),
    _CtDot1qVlanGvrpRestrictedIndex_Type()
)
ctDot1qVlanGvrpRestrictedIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    ctDot1qVlanGvrpRestrictedIndex.setStatus("current")


class _CtDot1qVlanGvrpRestrictedStatus_Type(EnabledStatus):
    """Custom type ctDot1qVlanGvrpRestrictedStatus based on EnabledStatus"""
    defaultValue = 2


_CtDot1qVlanGvrpRestrictedStatus_Type.__name__ = "EnabledStatus"
_CtDot1qVlanGvrpRestrictedStatus_Object = MibTableColumn
ctDot1qVlanGvrpRestrictedStatus = _CtDot1qVlanGvrpRestrictedStatus_Object(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 1, 6, 1, 2),
    _CtDot1qVlanGvrpRestrictedStatus_Type()
)
ctDot1qVlanGvrpRestrictedStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ctDot1qVlanGvrpRestrictedStatus.setStatus("current")
_CtDot1qPortVlanStaticEgressTable_Object = MibTable
ctDot1qPortVlanStaticEgressTable = _CtDot1qPortVlanStaticEgressTable_Object(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 1, 7)
)
if mibBuilder.loadTexts:
    ctDot1qPortVlanStaticEgressTable.setStatus("current")
_CtDot1qPortVlanStaticEgressEntry_Object = MibTableRow
ctDot1qPortVlanStaticEgressEntry = _CtDot1qPortVlanStaticEgressEntry_Object(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 1, 7, 1)
)
ctDot1qPortVlanStaticEgressEntry.setIndexNames(
    (0, "BRIDGE-MIB", "dot1dBasePort"),
    (0, "Q-BRIDGE-MIB", "dot1qVlanIndex"),
)
if mibBuilder.loadTexts:
    ctDot1qPortVlanStaticEgressEntry.setStatus("current")


class _CtDot1qPortVlanStaticEgressType_Type(Integer32):
    """Custom type ctDot1qPortVlanStaticEgressType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CtDot1qPortVlanStaticEgressType_Type.__name__ = "Integer32"
_CtDot1qPortVlanStaticEgressType_Object = MibTableColumn
ctDot1qPortVlanStaticEgressType = _CtDot1qPortVlanStaticEgressType_Object(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 1, 7, 1, 1),
    _CtDot1qPortVlanStaticEgressType_Type()
)
ctDot1qPortVlanStaticEgressType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ctDot1qPortVlanStaticEgressType.setStatus("current")
...
if mibBuilder.loadTexts:
    ctQBridgePortVlanEgressGroup.setStatus("deprecated")
...
ctQBridgeVlanGvrpGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 2, 1, 8)
)
ctQBridgeVlanGvrpGroup.setObjects(
    ("CTRON-Q-BRIDGE-MIB-EXT", "ctDot1qVlanGvrpRestrictedStatus")
)
if mibBuilder.loadTexts:
    ctQBridgeVlanGvrpGroup.setStatus("current")

ctQBridgePortVlanEgressGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 2, 1, 9)
)
ctQBridgePortVlanEgressGroup2.setObjects(
      *(("CTRON-Q-BRIDGE-MIB-EXT", "ctDot1qPortVlanEgressStatus"),
        ("CTRON-Q-BRIDGE-MIB-EXT", "ctDot1qPortVlanEgressType"),
        ("CTRON-Q-BRIDGE-MIB-EXT", "ctDot1qPortVlanStaticEgressType"))
)
if mibBuilder.loadTexts:
    ctQBridgePortVlanEgressGroup2.setStatus("current")
...
ctDot1qVlan.setObjects(
      *(("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgePortGroup"),
        ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgeVlanGroup"))
)
if mibBuilder.loadTexts:
...
ctDot1qVlan2.setObjects(
      *(("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgeVlanGroup"),
        ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgePortGroup2"),
        ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgePortReplaceTCIGroup"))
)
if mibBuilder.loadTexts:
...
ctDot1qVlanCurentCompliance.setObjects(
    ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgeVlanCurrentForbidGroup")
)
if mibBuilder.loadTexts:
...
ctDot1qPortVlanEgressCompliance.setObjects(
    ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgePortVlanEgressGroup")
)
if mibBuilder.loadTexts:
...
ctDot1qTpFdbTableExtCompliance.setObjects(
    ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgeTpFdbTableExtGroup")
)
if mibBuilder.loadTexts:
...
ctDot1qVlan3 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 2, 2, 6)
)
ctDot1qVlan3.setObjects(
      *(("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgeVlanGroup"),
        ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgePortGroup2"),
        ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgePortReplaceTCIGroup"),
        ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgeVlanGvrpGroup"))
)
if mibBuilder.loadTexts:
    ctDot1qVlan3.setStatus(
        "current"
    )

ctDot1qPortVlanEgressCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 16, 7, 2, 2, 7)
)
ctDot1qPortVlanEgressCompliance2.setObjects(
    ("CTRON-Q-BRIDGE-MIB-EXT", "ctQBridgePortVlanEgressGroup2")
)
if mibBuilder.loadTexts:
    ctDot1qPortVlanEgressCompliance2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"ctQBridgeMibExt": ctQBridgeMibExt,
       ...
       "ctDot1qVlanGvrpRestrictedTable": ctDot1qVlanGvrpRestrictedTable,
       "ctDot1qVlanGvrpRestrictedEntry": ctDot1qVlanGvrpRestrictedEntry,
       "ctDot1qVlanGvrpRestrictedIndex": ctDot1qVlanGvrpRestrictedIndex,
       "ctDot1qVlanGvrpRestrictedStatus": ctDot1qVlanGvrpRestrictedStatus,
       "ctDot1qPortVlanStaticEgressTable": ctDot1qPortVlanStaticEgressTable,
       "ctDot1qPortVlanStaticEgressEntry": ctDot1qPortVlanStaticEgressEntry,
       "ctDot1qPortVlanStaticEgressType": ctDot1qPortVlanStaticEgressType,
       ...
       "ctQBridgeVlanGvrpGroup": ctQBridgeVlanGvrpGroup,
       "ctQBridgePortVlanEgressGroup2": ctQBridgePortVlanEgressGroup2,
       ...
       "ctDot1qVlan3": ctDot1qVlan3,
       "ctDot1qPortVlanEgressCompliance2": ctDot1qPortVlanEgressCompliance2}
)
