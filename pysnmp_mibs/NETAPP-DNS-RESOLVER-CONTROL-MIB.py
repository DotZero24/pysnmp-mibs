...
_D='Integer32'
_C='read-write'
_B='NETAPP-DNS-RESOLVER-CONTROL-MIB'
_A='current'
...
fastPathDnsResControlMIB=ModuleIdentity((1,3,6,1,4,1,789,4413,1,1,37))
...
fastPathDnsResCtlMIBObjects=_FastPathDnsResCtlMIBObjects_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,37,1))
_AgentResCtlglobal_ObjectIdentity=ObjectIdentity
agentResCtlglobal=_AgentResCtlglobal_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,37,1,1))
_AgentResCtlAdminMode_Type=TruthValue
_AgentResCtlAdminMode_Object=MibScalar
agentResCtlAdminMode=_AgentResCtlAdminMode_Object((1,3,6,1,4,1,789,4413,1,1,37,1,1,1),_AgentResCtlAdminMode_Type())
agentResCtlAdminMode.setMaxAccess(_C)
...
agentResCtlDefDomainName=_AgentResCtlDefDomainName_Object((1,3,6,1,4,1,789,4413,1,1,37,1,1,2),_AgentResCtlDefDomainName_Type())
agentResCtlDefDomainName.setMaxAccess(_C)
...
agentResCtlCacheFlushStatus=_AgentResCtlCacheFlushStatus_Object((1,3,6,1,4,1,789,4413,1,1,37,1,1,3),_AgentResCtlCacheFlushStatus_Type())
agentResCtlCacheFlushStatus.setMaxAccess(_C)
...
agentResCtlRequestTimeout=_AgentResCtlRequestTimeout_Object((1,3,6,1,4,1,789,4413,1,1,37,1,1,4),_AgentResCtlRequestTimeout_Type())
agentResCtlRequestTimeout.setMaxAccess(_C)
...
agentResCtlRequestRetransmits=_AgentResCtlRequestRetransmits_Object((1,3,6,1,4,1,789,4413,1,1,37,1,1,5),_AgentResCtlRequestRetransmits_Type())
agentResCtlRequestRetransmits.setMaxAccess(_C)
if mibBuilder.loadTexts:agentResCtlRequestRetransmits.setStatus(_A)
_AgentResCtlDomainListTable_Object=MibTable
agentResCtlDomainListTable=_AgentResCtlDomainListTable_Object((1,3,6,1,4,1,789,4413,1,1,37,1,1,6))
if mibBuilder.loadTexts:agentResCtlDomainListTable.setStatus(_A)
_AgentResCtlDomainListEntry_Object=MibTableRow
agentResCtlDomainListEntry=_AgentResCtlDomainListEntry_Object((1,3,6,1,4,1,789,4413,1,1,37,1,1,6,1))
agentResCtlDomainListEntry.setIndexNames((0,_B,_I))
...
agentResCtlDomainListName=_AgentResCtlDomainListName_Object((1,3,6,1,4,1,789,4413,1,1,37,1,1,6,1,1),_AgentResCtlDomainListName_Type())
...
agentResCtlDomainListNameStatus=_AgentResCtlDomainListNameStatus_Object((1,3,6,1,4,1,789,4413,1,1,37,1,1,6,1,2),_AgentResCtlDomainListNameStatus_Type())
...
agentResCtlServConfig=_AgentResCtlServConfig_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,37,1,2))
_AgentResCtlServConfigTable_Object=MibTable
agentResCtlServConfigTable=_AgentResCtlServConfigTable_Object((1,3,6,1,4,1,789,4413,1,1,37,1,2,1))
if mibBuilder.loadTexts:agentResCtlServConfigTable.setStatus(_A)
_AgentResCtlConfigIPEntry_Object=MibTableRow
agentResCtlConfigIPEntry=_AgentResCtlConfigIPEntry_Object((1,3,6,1,4,1,789,4413,1,1,37,1,2,1,1))
agentResCtlConfigIPEntry.setIndexNames((0,_B,_J),(0,_B,_K))
...
agentResCtlDnsNameServerIPType=_AgentResCtlDnsNameServerIPType_Object((1,3,6,1,4,1,789,4413,1,1,37,1,2,1,1,1),_AgentResCtlDnsNameServerIPType_Type())
...
agentResCtlDnsNameServerIP=_AgentResCtlDnsNameServerIP_Object((1,3,6,1,4,1,789,4413,1,1,37,1,2,1,1,2),_AgentResCtlDnsNameServerIP_Type())
...
agentResCtlDnsNameServerStatus=_AgentResCtlDnsNameServerStatus_Object((1,3,6,1,4,1,789,4413,1,1,37,1,2,1,1,3),_AgentResCtlDnsNameServerStatus_Type())
...
agentResCtlStaticServConfig=_AgentResCtlStaticServConfig_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,37,1,3))
_AgentResCtlStaticServConfigTable_Object=MibTable
agentResCtlStaticServConfigTable=_AgentResCtlStaticServConfigTable_Object((1,3,6,1,4,1,789,4413,1,1,37,1,3,1))
if mibBuilder.loadTexts:agentResCtlStaticServConfigTable.setStatus(_A)
_AgentResCtlStaticServEntry_Object=MibTableRow
agentResCtlStaticServEntry=_AgentResCtlStaticServEntry_Object((1,3,6,1,4,1,789,4413,1,1,37,1,3,1,1))
agentResCtlStaticServEntry.setIndexNames((0,_B,_L),(0,_B,_M))
...
agentResCtlStaticHostName=_AgentResCtlStaticHostName_Object((1,3,6,1,4,1,789,4413,1,1,37,1,3,1,1,1),_AgentResCtlStaticHostName_Type())
...
agentResCtlStaticIPAddress=_AgentResCtlStaticIPAddress_Object((1,3,6,1,4,1,789,4413,1,1,37,1,3,1,1,2),_AgentResCtlStaticIPAddress_Type())
