...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/MPLS-VPN-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:55:26 2025
...
mibBuilder.exportSymbols("MPLS-VPN-MIB", mplsVpnActiveVrfs=mplsVpnActiveVrfs, mplsVpnVrfBgpPathAttrAggregatorAS=mplsVpnVrfBgpPathAttrAggregatorAS, mplsVpnPerf=mplsVpnPerf, mplsVpnVrfTable=mplsVpnVrfTable, mplsVpnVrfActiveInterfaces=mplsVpnVrfActiveInterfaces, mplsVpnVrfBgpPathAttrCalcLocalPref=mplsVpnVrfBgpPathAttrCalcLocalPref, mplsVpnScalarGroup=mplsVpnScalarGroup, mplsVpnVrfRouteDestAddrType=mplsVpnVrfRouteDestAddrType, mplsVpnVrfPerfEntry=mplsVpnVrfPerfEntry, mplsVpnVrfSecTable=mplsVpnVrfSecTable, mplsVpnNotifications=mplsVpnNotifications, mplsVpnSecGroup=mplsVpnSecGroup, mplsVpnVrfBgpPathAttrOrigin=mplsVpnVrfBgpPathAttrOrigin, mplsVpnPerfGroup=mplsVpnPerfGroup, mplsVpnVrfRouteTargetGroup=mplsVpnVrfRouteTargetGroup, mplsVpnVrfBgpPathAttrPeer=mplsVpnVrfBgpPathAttrPeer, mplsVpnVrfRouteMetric4=mplsVpnVrfRouteMetric4, mplsNumVrfRouteMaxThreshExceeded=mplsNumVrfRouteMaxThreshExceeded, mplsVpnVrfRouteNextHop=mplsVpnVrfRouteNextHop, mplsVpnConformance=mplsVpnConformance, mplsVpnVrfRouteRowStatus=mplsVpnVrfRouteRowStatus, mplsVrfIfDown=mplsVrfIfDown, mplsVpnConf=mplsVpnConf, mplsVpnVrfBgpNbrAddrEntry=mplsVpnVrfBgpNbrAddrEntry, mplsVpnVrfBgpNbrPrefixTable=mplsVpnVrfBgpNbrPrefixTable, mplsVpnVrfBgpNbrRowStatus=mplsVpnVrfBgpNbrRowStatus, mplsVpnVrfBgpPathAttrASPathSegment=mplsVpnVrfBgpPathAttrASPathSegment, mplsVpnVrfRouteTargetType=mplsVpnVrfRouteTargetType, mplsVpnVrfRouteTargetIndex=mplsVpnVrfRouteTargetIndex, mplsVpnVrfPerfTable=mplsVpnVrfPerfTable, mplsVpnInterfaceVpnClassification=mplsVpnInterfaceVpnClassification, mplsVpnVrfConfMaxPossibleRoutes=mplsVpnVrfConfMaxPossibleRoutes, mplsVpnVrfBgpPathAttrUnknown=mplsVpnVrfBgpPathAttrUnknown, mplsVpnVrfSecIllegalLabelViolations=mplsVpnVrfSecIllegalLabelViolations, mplsVpnVrfRouteDistinguisher=mplsVpnVrfRouteDistinguisher, mplsVpnVrfRouteTargetRowStatus=mplsVpnVrfRouteTargetRowStatus, mplsVpnVrfRouteAge=mplsVpnVrfRouteAge, mplsVpnRoute=mplsVpnRoute, mplsVpnVrfBgpPathAttrAggregatorAddr=mplsVpnVrfBgpPathAttrAggregatorAddr, mplsVpnCompliances=mplsVpnCompliances, mplsVpnVrfRouteStorageType=mplsVpnVrfRouteStorageType, mplsVpnVrfRouteProto=mplsVpnVrfRouteProto, mplsVpnVrfConfMaxRoutes=mplsVpnVrfConfMaxRoutes, mplsVpnVrfGroup=mplsVpnVrfGroup, mplsVpnVrfBgpPathAttrAtomicAggregate=mplsVpnVrfBgpPathAttrAtomicAggregate, mplsVpnVrfBgpPathAttrMultiExitDisc=mplsVpnVrfBgpPathAttrMultiExitDisc, mplsVpnScalars=mplsVpnScalars, mplsVpnVrfRouteGroup=mplsVpnVrfRouteGroup, mplsVpnVrfRouteMask=mplsVpnVrfRouteMask, mplsVpnVrfDescription=mplsVpnVrfDescription, mplsVpnVrfConfStorageType=mplsVpnVrfConfStorageType, mplsVpnVrfRouteTargetEntry=mplsVpnVrfRouteTargetEntry, mplsVpnConnectedInterfaces=mplsVpnConnectedInterfaces, mplsVpnInterfaceConfIndex=mplsVpnInterfaceConfIndex, mplsVpnVrfBgpPrefixGroup=mplsVpnVrfBgpPrefixGroup, mplsVpnVrfRouteEntry=mplsVpnVrfRouteEntry, mplsVpnVrfBgpPathAttrLocalPref=mplsVpnVrfBgpPathAttrLocalPref, mplsVpnVrfRouteMetric1=mplsVpnVrfRouteMetric1, mplsVpnVrfRouteIfIndex=mplsVpnVrfRouteIfIndex, mplsVpnVrfBgpPathAttrIpAddrPrefixLen=mplsVpnVrfBgpPathAttrIpAddrPrefixLen, mplsVpnVrfRouteTargetDescr=mplsVpnVrfRouteTargetDescr, mplsVpnNotificationGroup=mplsVpnNotificationGroup, mplsVpnVrfRouteNextHopAS=mplsVpnVrfRouteNextHopAS, mplsVpnVrfSecEntry=mplsVpnVrfSecEntry, mplsVpnVrfBgpNbrIndex=mplsVpnVrfBgpNbrIndex, mplsVpnNotificationEnable=mplsVpnNotificationEnable, mplsVpnVrfSecIllegalLabelRcvThresh=mplsVpnVrfSecIllegalLabelRcvThresh, mplsVpnVrfRouteTos=mplsVpnVrfRouteTos, mplsVpnObjects=mplsVpnObjects, mplsVpnVrfBgpNbrRole=mplsVpnVrfBgpNbrRole, PYSNMP_MODULE_ID=mplsVpnMIB, mplsVpnVrfRouteMetric3=mplsVpnVrfRouteMetric3, mplsVpnVrfPerfCurrNumRoutes=mplsVpnVrfPerfCurrNumRoutes, mplsVpnVrfRouteTargetTable=mplsVpnVrfRouteTargetTable, mplsVpnVrfBgpNbrType=mplsVpnVrfBgpNbrType, mplsNumVrfSecIllegalLabelThreshExceeded=mplsNumVrfSecIllegalLabelThreshExceeded, mplsVpnVrfBgpNbrAddrTable=mplsVpnVrfBgpNbrAddrTable, mplsVpnInterfaceConfStorageType=mplsVpnInterfaceConfStorageType, mplsVpnVrfOperStatus=mplsVpnVrfOperStatus, mplsVpnVrfRouteMetric2=mplsVpnVrfRouteMetric2, mplsNumVrfRouteMidThreshExceeded=mplsNumVrfRouteMidThreshExceeded, mplsVpnVrfRouteDest=mplsVpnVrfRouteDest, mplsVpnVrfRouteMaskAddrType=mplsVpnVrfRouteMaskAddrType, mplsVpnVrfBgpPathAttrIpAddrPrefix=mplsVpnVrfBgpPathAttrIpAddrPrefix, MplsVpnId=MplsVpnId, mplsVpnModuleCompliance=mplsVpnModuleCompliance, mplsVpnGroups=mplsVpnGroups, MplsVpnRouteDistinguisher=MplsVpnRouteDistinguisher, mplsVpnMIB=mplsVpnMIB, mplsVpnVrfBgpNbrAddr=mplsVpnVrfBgpNbrAddr, mplsVpnVrfCreationTime=mplsVpnVrfCreationTime, mplsVpnInterfaceConfRowStatus=mplsVpnInterfaceConfRowStatus, mplsVpnVrfPerfRoutesDeleted=mplsVpnVrfPerfRoutesDeleted, mplsVpnVrfConfHighRouteThreshold=mplsVpnVrfConfHighRouteThreshold, mplsVpnVrfBgpNbrStorageType=mplsVpnVrfBgpNbrStorageType, mplsVpnConfiguredVrfs=mplsVpnConfiguredVrfs, mplsVpnVrfBgpPathAttrBest=mplsVpnVrfBgpPathAttrBest, mplsVpnVrfRouteTable=mplsVpnVrfRouteTable, mplsVpnVrfRouteType=mplsVpnVrfRouteType, mplsVpnInterfaceGroup=mplsVpnInterfaceGroup, mplsVpnVrfRouteInfo=mplsVpnVrfRouteInfo, mplsVpnVrfEntry=mplsVpnVrfEntry, mplsVpnVrfConfMidRouteThreshold=mplsVpnVrfConfMidRouteThreshold, mplsVpnInterfaceConfTable=mplsVpnInterfaceConfTable, mplsVpnVrfBgpPathAttrNextHop=mplsVpnVrfBgpPathAttrNextHop, mplsVpnInterfaceVpnRouteDistProtocol=mplsVpnInterfaceVpnRouteDistProtocol, mplsVpnVrfPerfRoutesAdded=mplsVpnVrfPerfRoutesAdded, mplsVpnVrfRouteTarget=mplsVpnVrfRouteTarget, mplsVpnVrfName=mplsVpnVrfName, mplsVpnVrfBgpNbrGroup=mplsVpnVrfBgpNbrGroup, mplsVpnVrfAssociatedInterfaces=mplsVpnVrfAssociatedInterfaces, mplsVpnVrfRouteMetric5=mplsVpnVrfRouteMetric5, mplsVpnVrfConfLastChanged=mplsVpnVrfConfLastChanged, mplsVpnVrfConfRowStatus=mplsVpnVrfConfRowStatus, mplsVpnInterfaceLabelEdgeType=mplsVpnInterfaceLabelEdgeType, mplsVpnVrfRouteNextHopAddrType=mplsVpnVrfRouteNextHopAddrType, mplsVrfIfUp=mplsVrfIfUp, mplsVpnInterfaceConfEntry=mplsVpnInterfaceConfEntry, mplsVpnVrfBgpNbrPrefixEntry=mplsVpnVrfBgpNbrPrefixEntry)
