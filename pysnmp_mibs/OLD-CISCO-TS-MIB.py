...
mibBuilder.exportSymbols("OLD-CISCO-TS-MIB", tsLineSpeedout=tsLineSpeedout, tsLineModem=tsLineModem, tsLineType=tsLineType, tsMsgIntervaltim=tsMsgIntervaltim, tslineSesLine=tslineSesLine, tsLineTerm=tsLineTerm, tsMsgTmpBanner=tsMsgTmpBanner, ltsLineSessionEntry=ltsLineSessionEntry, tsLineUses=tsLineUses, tslineSesAddr=tslineSesAddr, tsMsgTtyLine=tsMsgTtyLine, tsLines=tsLines, tsLineSestmo=tsLineSestmo, tsLineNoise=tsLineNoise, tsLineScrlen=tsLineScrlen, tsLineActive=tsLineActive, tsLineTmo=tsLineTmo, tsLineNumber=tsLineNumber, tsLineFlow=tsLineFlow, tsLineRotary=tsLineRotary, lts=lts, tsLineEsc=tsLineEsc, tslineSesSession=tslineSesSession, tsClrTtyLine=tsClrTtyLine, tslineSesType=tslineSesType, tslineSesDir=tslineSesDir, tsLineUser=tsLineUser, tslineSesName=tslineSesName, tslineSesCur=tslineSesCur, ltsLineEntry=ltsLineEntry, tsLineNses=tsLineNses, tsLineTimeActive=tsLineTimeActive, tsMsgDuration=tsMsgDuration, ltsLineSessionTable=ltsLineSessionTable, tslineSesIdle=tslineSesIdle, tsLineScrwid=tsLineScrwid, tsLineSpeedin=tsLineSpeedin, tsMsgText=tsMsgText, tsLineLoc=tsLineLoc, tsMsgSend=tsMsgSend, ltsLineTable=ltsLineTable, tsLineAutobaud=tsLineAutobaud)
