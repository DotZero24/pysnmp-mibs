...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-BRIDGE-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:01:36 2025
...
pdnBridgeExtCompliance.setObjects(
      *(("PDN-BRIDGE-EXT-MIB", "pdnDot1dBasePortMaxFdbEntriesGroup"),
        ("PDN-BRIDGE-EXT-MIB", "pdnDot1dBasePortRoleGroup"),
        ("PDN-BRIDGE-EXT-MIB", "pdnDot1dBasePortUnknownMulticastForwardingModeGroup"),
        ("PDN-BRIDGE-EXT-MIB", "pdnDot1dTrafficProfileBasicGroup"),
        ("PDN-BRIDGE-EXT-MIB", "pdnDot1dTrafficProfileMaxRateGroup"),
