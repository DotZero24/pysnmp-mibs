...
_Iscom4002_1RF_ObjectIdentity = ObjectIdentity
iscom4002_1RF = _Iscom4002_1RF_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 65)
)
_Iscom4012_1RF_ObjectIdentity = ObjectIdentity
iscom4012_1RF = _Iscom4012_1RF_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 67)
)
_Iscom2128_I_ObjectIdentity = ObjectIdentity
iscom2128_I = _Iscom2128_I_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 68)
)
_Iscom2118_I_ObjectIdentity = ObjectIdentity
iscom2118_I = _Iscom2118_I_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 69)
)
_Iscom2110_I_ObjectIdentity = ObjectIdentity
iscom2110_I = _Iscom2110_I_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 70)
)
_Iscom1000EM_ObjectIdentity = ObjectIdentity
iscom1000EM = _Iscom1000EM_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 71)
)
_Iscom2110A_MA_PWR_Y_ObjectIdentity = ObjectIdentity
iscom2110A_MA_PWR_Y = _Iscom2110A_MA_PWR_Y_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 72)
)
_Iscom3024_AC_ObjectIdentity = ObjectIdentity
iscom3024_AC = _Iscom3024_AC_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 73)
)
_Iscom3048_AC_ObjectIdentity = ObjectIdentity
iscom3048_AC = _Iscom3048_AC_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 74)
)
_Iscom2118EA_MA_ObjectIdentity = ObjectIdentity
iscom2118EA_MA = _Iscom2118EA_MA_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 75)
)
_Iscom2110EA_MA_ObjectIdentity = ObjectIdentity
iscom2110EA_MA = _Iscom2110EA_MA_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 76)
)
_Iscom2126EA_MA_PWR_AC_ObjectIdentity = ObjectIdentity
iscom2126EA_MA_PWR_AC = _Iscom2126EA_MA_PWR_AC_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 77)
)
_Iscom2128EA_MA_ObjectIdentity = ObjectIdentity
iscom2128EA_MA = _Iscom2128EA_MA_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 78)
)
_Iscom2126EA_MA_B_ObjectIdentity = ObjectIdentity
iscom2126EA_MA_B = _Iscom2126EA_MA_B_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 79)
)
_Iscom2126EA_MA_PWR_ObjectIdentity = ObjectIdentity
iscom2126EA_MA_PWR = _Iscom2126EA_MA_PWR_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 80)
)
_Iscom2026F_ObjectIdentity = ObjectIdentity
iscom2026F = _Iscom2026F_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 81)
)
_Iscom2118EA_MA_PWR_ObjectIdentity = ObjectIdentity
iscom2118EA_MA_PWR = _Iscom2118EA_MA_PWR_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 82)
)
_Iscom2110EA_MA_PWR_ObjectIdentity = ObjectIdentity
iscom2110EA_MA_PWR = _Iscom2110EA_MA_PWR_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 83)
)
_Iscom2110A_MA_PWR_Z_ObjectIdentity = ObjectIdentity
iscom2110A_MA_PWR_Z = _Iscom2110A_MA_PWR_Z_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 84)
)
_Iscom2126EA_MA_PWR_Z_ObjectIdentity = ObjectIdentity
iscom2126EA_MA_PWR_Z = _Iscom2126EA_MA_PWR_Z_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 85)
)
_Iscom2118_MA_S_ObjectIdentity = ObjectIdentity
iscom2118_MA_S = _Iscom2118_MA_S_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 86)
)
_ISCOM2924GF_4C_ObjectIdentity = ObjectIdentity
iSCOM2924GF_4C = _ISCOM2924GF_4C_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 96)
)
_ISCOM2924GF_4GE_ObjectIdentity = ObjectIdentity
iSCOM2924GF_4GE = _ISCOM2924GF_4GE_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 97)
)
_RAX711_ObjectIdentity = ObjectIdentity
rAX711 = _RAX711_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 103)
)
...
_Rc953_8fe16e1_ObjectIdentity = ObjectIdentity
rc953_8fe16e1 = _Rc953_8fe16e1_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 12, 34)
)
_Rc953_8fe8e1_ObjectIdentity = ObjectIdentity
rc953_8fe8e1 = _Rc953_8fe8e1_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 12, 35)
)
_Rc951_2fe2e8rs232h_ObjectIdentity = ObjectIdentity
rc951_2fe2e8rs232h = _Rc951_2fe2e8rs232h_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 12, 36)
)
_Rc3000_15h_ObjectIdentity = ObjectIdentity
rc3000_15h = _Rc3000_15h_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 12, 37)
)
_Rcma5106_ObjectIdentity = ObjectIdentity
rcma5106 = _Rcma5106_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 12, 38)
)
_Rcma5115_ObjectIdentity = ObjectIdentity
rcma5115 = _Rcma5115_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 12, 39)
)
_Rc959b_4fe16e1_ObjectIdentity = ObjectIdentity
rc959b_4fe16e1 = _Rc959b_4fe16e1_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 12, 40)
)
...
_Rc551ES_4GE_ObjectIdentity = ObjectIdentity
rc551ES_4GE = _Rc551ES_4GE_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 16, 14)
)
...
_IPNSeries_ObjectIdentity = ObjectIdentity
iPNSeries = _IPNSeries_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 23)
)
_IPN201_ObjectIdentity = ObjectIdentity
iPN201 = _IPN201_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 23, 1)
)
...
mibBuilder.exportSymbols(
    ...
    **{"raisecom": raisecom,
       ...
       "iscom4002-1RF": iscom4002_1RF,
       "iscom4012-1RF": iscom4012_1RF,
       "iscom2128-I": iscom2128_I,
       "iscom2118-I": iscom2118_I,
       "iscom2110-I": iscom2110_I,
       "iscom1000EM": iscom1000EM,
       "iscom2110A-MA-PWR-Y": iscom2110A_MA_PWR_Y,
       "iscom3024-AC": iscom3024_AC,
       "iscom3048-AC": iscom3048_AC,
       "iscom2118EA-MA": iscom2118EA_MA,
       "iscom2110EA-MA": iscom2110EA_MA,
       "iscom2126EA-MA-PWR-AC": iscom2126EA_MA_PWR_AC,
       "iscom2128EA-MA": iscom2128EA_MA,
       "iscom2126EA-MA-B": iscom2126EA_MA_B,
       "iscom2126EA-MA-PWR": iscom2126EA_MA_PWR,
       "iscom2026F": iscom2026F,
       "iscom2118EA-MA-PWR": iscom2118EA_MA_PWR,
       "iscom2110EA-MA-PWR": iscom2110EA_MA_PWR,
       "iscom2110A-MA-PWR-Z": iscom2110A_MA_PWR_Z,
       "iscom2126EA-MA-PWR-Z": iscom2126EA_MA_PWR_Z,
       "iscom2118-MA-S": iscom2118_MA_S,
       "iSCOM2924GF-4C": iSCOM2924GF_4C,
       "iSCOM2924GF-4GE": iSCOM2924GF_4GE,
       "rAX711": rAX711,
       ...
       "rc953-8fe16e1": rc953_8fe16e1,
       "rc953-8fe8e1": rc953_8fe8e1,
       "rc951_2fe2e8rs232h": rc951_2fe2e8rs232h,
       "rc3000-15h": rc3000_15h,
       "rcma5106": rcma5106,
       "rcma5115": rcma5115,
       "rc959b-4fe16e1": rc959b_4fe16e1,
