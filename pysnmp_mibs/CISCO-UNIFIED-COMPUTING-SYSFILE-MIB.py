...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-SYSFILE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:36 2025
...
cucsSysfileDigestChecksum = _CucsSysfileDigestChecksum_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 48, 3, 1, 12),
    _CucsSysfileDigestChecksum_Type()
)
cucsSysfileDigestChecksum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsSysfileDigestChecksum.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsSysfileObjects": cucsSysfileObjects,
       ...
       "cucsSysfileDigestChecksum": cucsSysfileDigestChecksum,
