...
mibBuilder.exportSymbols("BIANCA-BRICK-TDRC-MIB", ipTdrcWindowScaling=ipTdrcWindowScaling, ipTdrcServices=ipTdrcServices, ipTdrcServiceAlias=ipTdrcServiceAlias, bintec=bintec, ipTdrcIfIndex=ipTdrcIfIndex, ipTdrcMss=ipTdrcMss, ipTdrcMode=ipTdrcMode, ipTdrcServiceIfIndex=ipTdrcServiceIfIndex, ipTdrcServiceStatus=ipTdrcServiceStatus, ipTdrcMaxRate=ipTdrcMaxRate, ipTdrcTable=ipTdrcTable, ipTdrcServiceEntry=ipTdrcServiceEntry, ipTdrcServiceTable=ipTdrcServiceTable, ipTdrcEntry=ipTdrcEntry, bibo=bibo, ipTdrcServicePort=ipTdrcServicePort, biboip=biboip)
