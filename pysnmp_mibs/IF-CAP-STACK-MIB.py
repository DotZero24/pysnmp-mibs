...
mibBuilder.exportSymbols("IF-CAP-STACK-MIB", ifCapStackCompliance=ifCapStackCompliance, ifCapStackStatus=ifCapStackStatus, ifInvCapStackTable=ifInvCapStackTable, ifCapStackTable=ifCapStackTable, ifCapStackConformance=ifCapStackConformance, ifInvCapStackStatus=ifInvCapStackStatus, ifCapStackGroups=ifCapStackGroups, ifCapStackMIB=ifCapStackMIB, ifCapStackCompliances=ifCapStackCompliances, ifCapStackGroup=ifCapStackGroup, PYSNMP_MODULE_ID=ifCapStackMIB, ifInvCapStackEntry=ifInvCapStackEntry, ifCapStackObjects=ifCapStackObjects, ifCapStackEntry=ifCapStackEntry)
