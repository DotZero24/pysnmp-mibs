...
# Notes
# -----
# ASN.1 source file://mibs/rfc/WWW-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:18:51 2025
...
_WwwDocCtrlLastNSize_Type.__name__ = "Unsigned32"
...
_WwwDocCtrlBuckets_Type.__name__ = "Unsigned32"
...
_WwwDocCtrlBucketTimeInterval_Type.__name__ = "TimeInterval"
...
_WwwDocCtrlTopNSize_Type.__name__ = "Unsigned32"
...
wwwMinimalCompliance.setObjects(
      *(("WWW-MIB", "wwwServiceGroup"),
        ("WWW-MIB", "wwwSummaryGroup"))
)
if mibBuilder.loadTexts:
...
wwwFullCompliance.setObjects(
      *(("WWW-MIB", "wwwServiceGroup"),
        ("WWW-MIB", "wwwSummaryGroup"),
        ("WWW-MIB", "wwwRequestInGroup"),
        ("WWW-MIB", "wwwResponseOutGroup"),
        ("WWW-MIB", "wwwRequestOutGroup"),
        ("WWW-MIB", "wwwResponseInGroup"),
        ("WWW-MIB", "wwwDocumentGroup"))
)
if mibBuilder.loadTexts:
