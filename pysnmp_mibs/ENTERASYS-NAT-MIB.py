...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/enterasys/ENTERASYS-NAT-MIB
...
mibBuilder.exportSymbols("ENTERASYS-NAT-MIB", etsysNatBindingForwardDstPort=etsysNatBindingForwardDstPort, etsysNatListRuleDirection=etsysNatListRuleDirection, etsysNatPoolHits=etsysNatPoolHits, etsysNatMIBNatStaticRuleTableGroup=etsysNatMIBNatStaticRuleTableGroup, etsysNatIpv4ConfigTcpTimeout=etsysNatIpv4ConfigTcpTimeout, etsysNatBindingRuleType=etsysNatBindingRuleType, etsysNatPoolName=etsysNatPoolName, etsysNatBindingReverseDstIp=etsysNatBindingReverseDstIp, etsysNatListRuleName=etsysNatListRuleName, etsysNatStaticRuleLocalPort=etsysNatStaticRuleLocalPort, etsysNatBindingFtpDataChannelCount=etsysNatBindingFtpDataChannelCount, etsysNatBindingId=etsysNatBindingId, etsysNatStaticRuleRowStatus=etsysNatStaticRuleRowStatus, etsysNatBindingIcmpFwdIdent=etsysNatBindingIcmpFwdIdent, etsysNatStatsStaticRulesUsed=etsysNatStatsStaticRulesUsed, etsysNatListRuleTable=etsysNatListRuleTable, etsysNatPoolConns=etsysNatPoolConns, etsysNatIpv4ConfigDnsTimeout=etsysNatIpv4ConfigDnsTimeout, etsysNatBindingState=etsysNatBindingState, etsysNatMIBGlobalIpv4ConfigGroup=etsysNatMIBGlobalIpv4ConfigGroup, etsysNatBindingIcmpRevIdent=etsysNatBindingIcmpRevIdent, etsysNatBindingIdleTime=etsysNatBindingIdleTime, etsysNatMIBNatBindingTableGroup=etsysNatMIBNatBindingTableGroup, etsysNatIpv4ConfigInspectDNS=etsysNatIpv4ConfigInspectDNS, etsysNatBindingPoolName=etsysNatBindingPoolName, etsysNatConformance=etsysNatConformance, etsysNatStatsBindingsMaxReached=etsysNatStatsBindingsMaxReached, etsysNatBindingCreationDate=etsysNatBindingCreationDate, etsysNatBindingProtocol=etsysNatBindingProtocol, etsysNatMIBNatPoolTableGroup=etsysNatMIBNatPoolTableGroup, etsysNatBindingExpireTime=etsysNatBindingExpireTime, etsysNatGlobal=etsysNatGlobal, etsysNatStaticRuleGlobalIpAddr=etsysNatStaticRuleGlobalIpAddr, etsysNatMIB=etsysNatMIB, etsysNatIpv4ConfigUdpTimeout=etsysNatIpv4ConfigUdpTimeout, etsysNatStaticRuleInsideVrfName=etsysNatStaticRuleInsideVrfName, etsysNatIpv4ConfigFtpTimeout=etsysNatIpv4ConfigFtpTimeout, etsysNatListRuleEntry=etsysNatListRuleEntry, etsysNatTranslationOneShot=etsysNatTranslationOneShot, etsysNatIpv4ConfigMaxEntries=etsysNatIpv4ConfigMaxEntries, etsysNatPoolLastIpAddr=etsysNatPoolLastIpAddr, etsysNatBindingReverseSrcIp=etsysNatBindingReverseSrcIp, PYSNMP_MODULE_ID=etsysNatMIB, etsysNatListRuleMatchType=etsysNatListRuleMatchType, etsysNatIpv4ConfigTimeout=etsysNatIpv4ConfigTimeout, etsysNatTranslationRowStatus=etsysNatTranslationRowStatus, etsysNatPoolAddrCount=etsysNatPoolAddrCount, etsysNatStatsBindingsExhausted=etsysNatStatsBindingsExhausted, etsysNatMIBGlobalStatsGroup=etsysNatMIBGlobalStatsGroup, etsysNatStatsBindingsNoFtpALG=etsysNatStatsBindingsNoFtpALG, etsysNatPoolAddrAlloc=etsysNatPoolAddrAlloc, etsysNatStaticRuleConns=etsysNatStaticRuleConns, etsysNatBindingHWConns=etsysNatBindingHWConns, etsysNatStatsClearDateAndTime=etsysNatStatsClearDateAndTime, etsysNatPoolOutOfAddrs=etsysNatPoolOutOfAddrs, etsysNatStatsBindingsNoPortmapPort=etsysNatStatsBindingsNoPortmapPort, etsysNatTranslationProtocolRulesTable=etsysNatTranslationProtocolRulesTable, etsysNatListRuleInetVersion=etsysNatListRuleInetVersion, etsysNatPoolEntry=etsysNatPoolEntry, etsysNatMIBGroups=etsysNatMIBGroups, etsysNatStatsMinTimeoutValue=etsysNatStatsMinTimeoutValue, etsysNatMIBNatListRuleTableGroup=etsysNatMIBNatListRuleTableGroup, etsysNatBindingExpirationDate=etsysNatBindingExpirationDate, etsysNatPoolPrefixLen=etsysNatPoolPrefixLen, etsysNatPoolOutOfPorts=etsysNatPoolOutOfPorts, etsysNatListRuleHits=etsysNatListRuleHits, etsysNatStatsPoolsUsed=etsysNatStatsPoolsUsed, etsysNatIpv4ConfigFinRstTimeout=etsysNatIpv4ConfigFinRstTimeout, etsysNatTranslationProtocol=etsysNatTranslationProtocol, etsysNatStaticRuleOverloaded=etsysNatStaticRuleOverloaded, etsysNatMIBTranslationProtocolRulesTableGroup=etsysNatMIBTranslationProtocolRulesTableGroup, etsysNatTables=etsysNatTables, etsysNatBindingReverseSrcPort=etsysNatBindingReverseSrcPort, etsysNatStaticRuleDirection=etsysNatStaticRuleDirection, etsysNatGlobalIpv4Config=etsysNatGlobalIpv4Config, etsysNatListRuleInsideVrfName=etsysNatListRuleInsideVrfName, etsysNatTranslationTimeout=etsysNatTranslationTimeout, etsysNatMIBCompliance=etsysNatMIBCompliance, etsysNatPoolListRulesCount=etsysNatPoolListRulesCount, etsysNatTranslationPort=etsysNatTranslationPort, etsysNatPoolAddressType=etsysNatPoolAddressType, etsysNatStatsBindingsTotal=etsysNatStatsBindingsTotal, etsysNatBindingForwardSrcPort=etsysNatBindingForwardSrcPort, etsysNatStatsMaxTimeoutValue=etsysNatStatsMaxTimeoutValue, etsysNatBindingForwardDstIp=etsysNatBindingForwardDstIp, etsysNatStaticRuleProtocol=etsysNatStaticRuleProtocol, etsysNatStaticRuleReservedBindingId=etsysNatStaticRuleReservedBindingId, etsysNatBindingClear=etsysNatBindingClear, etsysNatIpv4ConfigFinRstTimeoutHalfClosedStatus=etsysNatIpv4ConfigFinRstTimeoutHalfClosedStatus, etsysNatStaticRuleLocalIpAddr=etsysNatStaticRuleLocalIpAddr, etsysNatStatsListRulesUsed=etsysNatStatsListRulesUsed, etsysNatStatsTranslationProtocolRulesCount=etsysNatStatsTranslationProtocolRulesCount, etsysNatMIBCompliances=etsysNatMIBCompliances, etsysNatStatsPortMapsUsed=etsysNatStatsPortMapsUsed, etsysNatTranslationInetVersion=etsysNatTranslationInetVersion, etsysNatIpv4ConfigFtpCtrlPort=etsysNatIpv4ConfigFtpCtrlPort, etsysNatListRuleConns=etsysNatListRuleConns, etsysNatListRuleIfIndex=etsysNatListRuleIfIndex, etsysNatPoolPortAlloc=etsysNatPoolPortAlloc, etsysNatStaticRuleGlobalPort=etsysNatStaticRuleGlobalPort, etsysNatBindingReverseDstPort=etsysNatBindingReverseDstPort, etsysNatGlobalStats=etsysNatGlobalStats, etsysNatBindingTable=etsysNatBindingTable, etsysNatListRulePoolName=etsysNatListRulePoolName, etsysNatPoolTable=etsysNatPoolTable, etsysNatIpv4ConfigIcmpTimeout=etsysNatIpv4ConfigIcmpTimeout, etsysNatStatsBindingsHigh=etsysNatStatsBindingsHigh, etsysNatStatsBindingsPerSecond=etsysNatStatsBindingsPerSecond, etsysNatPoolFirstIpAddr=etsysNatPoolFirstIpAddr, etsysNatStaticRuleMatchType=etsysNatStaticRuleMatchType, etsysNatPoolRowStatus=etsysNatPoolRowStatus, etsysNatStatsBindingsCurrent=etsysNatStatsBindingsCurrent, etsysNatStatsBindingsNoIpAddr=etsysNatStatsBindingsNoIpAddr, etsysNatBindingForwardSrcIp=etsysNatBindingForwardSrcIp, etsysNatBindingEntry=etsysNatBindingEntry, etsysNatPoolAddrUsed=etsysNatPoolAddrUsed, etsysNatIpv4ConfigLogTranslations=etsysNatIpv4ConfigLogTranslations, etsysNatPoolLsnatVservers=etsysNatPoolLsnatVservers, etsysNatStatsClear=etsysNatStatsClear, etsysNatStaticRuleHits=etsysNatStaticRuleHits, etsysNatStaticRuleTable=etsysNatStaticRuleTable, etsysNatPoolNextIpAddr=etsysNatPoolNextIpAddr, etsysNatStaticRuleEntry=etsysNatStaticRuleEntry, etsysNatStatsBindingsDeleted=etsysNatStatsBindingsDeleted, etsysNatBindingAlgType=etsysNatBindingAlgType, etsysNatTranslationProtocolRulesEntry=etsysNatTranslationProtocolRulesEntry, etsysNatStatsAddressUsed=etsysNatStatsAddressUsed, etsysNatStaticRuleAddressType=etsysNatStaticRuleAddressType, etsysNatListRuleOverloaded=etsysNatListRuleOverloaded, etsysNatBindingAddressType=etsysNatBindingAddressType, etsysNatListRuleRowStatus=etsysNatListRuleRowStatus)
