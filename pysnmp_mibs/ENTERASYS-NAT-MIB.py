...
mibBuilder.exportSymbols("ENTERASYS-NAT-MIB", etsysNatBindingProtocol=etsysNatBindingProtocol, etsysNatTranslationTimeout=etsysNatTranslationTimeout, etsysNatListRuleRowStatus=etsysNatListRuleRowStatus, etsysNatStatsBindingsDeleted=etsysNatStatsBindingsDeleted, etsysNatStaticRuleMatchType=etsysNatStaticRuleMatchType, etsysNatGlobalIpv4Config=etsysNatGlobalIpv4Config, etsysNatMIBNatPoolTableGroup=etsysNatMIBNatPoolTableGroup, etsysNatListRuleTable=etsysNatListRuleTable, etsysNatStaticRuleRowStatus=etsysNatStaticRuleRowStatus, etsysNatListRuleConns=etsysNatListRuleConns, etsysNatPoolOutOfPorts=etsysNatPoolOutOfPorts, etsysNatStatsClearDateAndTime=etsysNatStatsClearDateAndTime, etsysNatListRuleIfIndex=etsysNatListRuleIfIndex, etsysNatBindingAlgType=etsysNatBindingAlgType, etsysNatGlobalStats=etsysNatGlobalStats, etsysNatStaticRuleReservedBindingId=etsysNatStaticRuleReservedBindingId, etsysNatPoolListRulesCount=etsysNatPoolListRulesCount, etsysNatPoolTable=etsysNatPoolTable, etsysNatStaticRuleGlobalPort=etsysNatStaticRuleGlobalPort, etsysNatIpv4ConfigUdpTimeout=etsysNatIpv4ConfigUdpTimeout, etsysNatIpv4ConfigFinRstTimeoutHalfClosedStatus=etsysNatIpv4ConfigFinRstTimeoutHalfClosedStatus, etsysNatStaticRuleEntry=etsysNatStaticRuleEntry, etsysNatStatsStaticRulesUsed=etsysNatStatsStaticRulesUsed, etsysNatBindingCreationDate=etsysNatBindingCreationDate, etsysNatBindingIcmpRevIdent=etsysNatBindingIcmpRevIdent, etsysNatGlobal=etsysNatGlobal, etsysNatMIB=etsysNatMIB, etsysNatPoolLsnatVservers=etsysNatPoolLsnatVservers, etsysNatListRuleHits=etsysNatListRuleHits, etsysNatIpv4ConfigFinRstTimeout=etsysNatIpv4ConfigFinRstTimeout, etsysNatListRuleInsideVrfName=etsysNatListRuleInsideVrfName, etsysNatTranslationOneShot=etsysNatTranslationOneShot, etsysNatTranslationProtocol=etsysNatTranslationProtocol, etsysNatBindingForwardSrcPort=etsysNatBindingForwardSrcPort, etsysNatPoolAddrAlloc=etsysNatPoolAddrAlloc, etsysNatStatsAddressUsed=etsysNatStatsAddressUsed, etsysNatPoolName=etsysNatPoolName, etsysNatTranslationRowStatus=etsysNatTranslationRowStatus, etsysNatBindingState=etsysNatBindingState, etsysNatMIBNatListRuleTableGroup=etsysNatMIBNatListRuleTableGroup, etsysNatBindingIdleTime=etsysNatBindingIdleTime, etsysNatPoolHits=etsysNatPoolHits, etsysNatStatsTranslationProtocolRulesCount=etsysNatStatsTranslationProtocolRulesCount, etsysNatStatsBindingsNoIpAddr=etsysNatStatsBindingsNoIpAddr, etsysNatListRuleMatchType=etsysNatListRuleMatchType, etsysNatPoolAddrCount=etsysNatPoolAddrCount, etsysNatIpv4ConfigLogTranslations=etsysNatIpv4ConfigLogTranslations, etsysNatIpv4ConfigIcmpTimeout=etsysNatIpv4ConfigIcmpTimeout, etsysNatBindingExpirationDate=etsysNatBindingExpirationDate, etsysNatStatsMaxTimeoutValue=etsysNatStatsMaxTimeoutValue, etsysNatIpv4ConfigTimeout=etsysNatIpv4ConfigTimeout, etsysNatPoolFirstIpAddr=etsysNatPoolFirstIpAddr, etsysNatStaticRuleLocalIpAddr=etsysNatStaticRuleLocalIpAddr, etsysNatBindingHWConns=etsysNatBindingHWConns, etsysNatStatsMinTimeoutValue=etsysNatStatsMinTimeoutValue, etsysNatStatsBindingsMaxReached=etsysNatStatsBindingsMaxReached, etsysNatBindingPoolName=etsysNatBindingPoolName, etsysNatIpv4ConfigMaxEntries=etsysNatIpv4ConfigMaxEntries, etsysNatStaticRuleInsideVrfName=etsysNatStaticRuleInsideVrfName, etsysNatBindingReverseDstIp=etsysNatBindingReverseDstIp, etsysNatPoolConns=etsysNatPoolConns, etsysNatStaticRuleProtocol=etsysNatStaticRuleProtocol, etsysNatPoolRowStatus=etsysNatPoolRowStatus, etsysNatStaticRuleLocalPort=etsysNatStaticRuleLocalPort, etsysNatMIBTranslationProtocolRulesTableGroup=etsysNatMIBTranslationProtocolRulesTableGroup, etsysNatMIBNatStaticRuleTableGroup=etsysNatMIBNatStaticRuleTableGroup, etsysNatTranslationInetVersion=etsysNatTranslationInetVersion, etsysNatBindingExpireTime=etsysNatBindingExpireTime, etsysNatMIBCompliance=etsysNatMIBCompliance, etsysNatStatsBindingsExhausted=etsysNatStatsBindingsExhausted, etsysNatPoolPrefixLen=etsysNatPoolPrefixLen, etsysNatIpv4ConfigTcpTimeout=etsysNatIpv4ConfigTcpTimeout, etsysNatMIBGroups=etsysNatMIBGroups, etsysNatListRuleInetVersion=etsysNatListRuleInetVersion, etsysNatListRuleName=etsysNatListRuleName, etsysNatBindingTable=etsysNatBindingTable, etsysNatTranslationPort=etsysNatTranslationPort, etsysNatStaticRuleGlobalIpAddr=etsysNatStaticRuleGlobalIpAddr, etsysNatStatsBindingsHigh=etsysNatStatsBindingsHigh, etsysNatIpv4ConfigInspectDNS=etsysNatIpv4ConfigInspectDNS, etsysNatListRuleDirection=etsysNatListRuleDirection, etsysNatTranslationProtocolRulesTable=etsysNatTranslationProtocolRulesTable, etsysNatBindingEntry=etsysNatBindingEntry, etsysNatBindingClear=etsysNatBindingClear, etsysNatStatsBindingsPerSecond=etsysNatStatsBindingsPerSecond, etsysNatStatsBindingsNoPortmapPort=etsysNatStatsBindingsNoPortmapPort, etsysNatPoolNextIpAddr=etsysNatPoolNextIpAddr, etsysNatMIBGlobalStatsGroup=etsysNatMIBGlobalStatsGroup, etsysNatStaticRuleAddressType=etsysNatStaticRuleAddressType, etsysNatBindingForwardDstPort=etsysNatBindingForwardDstPort, etsysNatBindingFtpDataChannelCount=etsysNatBindingFtpDataChannelCount, etsysNatBindingId=etsysNatBindingId, etsysNatPoolAddrUsed=etsysNatPoolAddrUsed, etsysNatStaticRuleHits=etsysNatStaticRuleHits, etsysNatPoolEntry=etsysNatPoolEntry, etsysNatStatsBindingsNoFtpALG=etsysNatStatsBindingsNoFtpALG, etsysNatBindingForwardSrcIp=etsysNatBindingForwardSrcIp, etsysNatPoolPortAlloc=etsysNatPoolPortAlloc, etsysNatBindingForwardDstIp=etsysNatBindingForwardDstIp, etsysNatStatsListRulesUsed=etsysNatStatsListRulesUsed, etsysNatStaticRuleDirection=etsysNatStaticRuleDirection, etsysNatPoolAddressType=etsysNatPoolAddressType, etsysNatPoolOutOfAddrs=etsysNatPoolOutOfAddrs, etsysNatStaticRuleOverloaded=etsysNatStaticRuleOverloaded, etsysNatStaticRuleTable=etsysNatStaticRuleTable, etsysNatBindingReverseSrcPort=etsysNatBindingReverseSrcPort, etsysNatMIBGlobalIpv4ConfigGroup=etsysNatMIBGlobalIpv4ConfigGroup, etsysNatListRuleOverloaded=etsysNatListRuleOverloaded, etsysNatConformance=etsysNatConformance, etsysNatBindingAddressType=etsysNatBindingAddressType, etsysNatStatsPortMapsUsed=etsysNatStatsPortMapsUsed, PYSNMP_MODULE_ID=etsysNatMIB, etsysNatBindingIcmpFwdIdent=etsysNatBindingIcmpFwdIdent, etsysNatStatsClear=etsysNatStatsClear, etsysNatBindingReverseDstPort=etsysNatBindingReverseDstPort, etsysNatIpv4ConfigFtpTimeout=etsysNatIpv4ConfigFtpTimeout, etsysNatIpv4ConfigFtpCtrlPort=etsysNatIpv4ConfigFtpCtrlPort, etsysNatMIBCompliances=etsysNatMIBCompliances, etsysNatMIBNatBindingTableGroup=etsysNatMIBNatBindingTableGroup, etsysNatStatsBindingsCurrent=etsysNatStatsBindingsCurrent, etsysNatListRuleEntry=etsysNatListRuleEntry, etsysNatListRulePoolName=etsysNatListRulePoolName, etsysNatBindingRuleType=etsysNatBindingRuleType, etsysNatBindingReverseSrcIp=etsysNatBindingReverseSrcIp, etsysNatStaticRuleConns=etsysNatStaticRuleConns, etsysNatStatsBindingsTotal=etsysNatStatsBindingsTotal, etsysNatTables=etsysNatTables, etsysNatStatsPoolsUsed=etsysNatStatsPoolsUsed, etsysNatPoolLastIpAddr=etsysNatPoolLastIpAddr, etsysNatTranslationProtocolRulesEntry=etsysNatTranslationProtocolRulesEntry, etsysNatIpv4ConfigDnsTimeout=etsysNatIpv4ConfigDnsTimeout)
