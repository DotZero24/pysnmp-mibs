...
mibBuilder.exportSymbols("VM-MIB", vmTableLastChange=vmTableLastChange, PYSNMP_MODULE_ID=vmMIB, vmNetworkEntry=vmNetworkEntry, vmCpuGroup=vmCpuGroup, vmStorageMediaType=vmStorageMediaType, vmMigrating=vmMigrating, vmMemUnit=vmMemUnit, vmCompliances=vmCompliances, vmCurMem=vmCurMem, vmPerVMNotificationsEnabled=vmPerVMNotificationsEnabled, VirtualMachineStorageAccess=VirtualMachineStorageAccess, vmHypervisorGroup=vmHypervisorGroup, vmAdminState=vmAdminState, vmCpuCoreTime=vmCpuCoreTime, vmCpuPhysIndex=vmCpuPhysIndex, vmBulkNotificationsEnabled=vmBulkNotificationsEnabled, vmNetworkParent=vmNetworkParent, vmResuming=vmResuming, VirtualMachineCpuIndex=VirtualMachineCpuIndex, vmStorageDefinedSize=vmStorageDefinedSize, VirtualMachineOperState=VirtualMachineOperState, vmBulkShuttingdown=vmBulkShuttingdown, vmBulkRunning=vmBulkRunning, vmStorageMediaTypeString=vmStorageMediaTypeString, vmBulkSuspended=vmBulkSuspended, vmStorageReadOctets=vmStorageReadOctets, VirtualMachineAutoStart=VirtualMachineAutoStart, vmOperState=vmOperState, vmNetworkModel=vmNetworkModel, vmCpuAffinityEntry=vmCpuAffinityEntry, vmVirtualMachineGroup=vmVirtualMachineGroup, vmGroups=vmGroups, vmUUID=vmUUID, VirtualMachineAdminState=VirtualMachineAdminState, vmBulkCrashed=vmBulkCrashed, vmCpuTable=vmCpuTable, vmTable=vmTable, vmStorageSourceType=vmStorageSourceType, vmObjects=vmObjects, vmHvObjectID=vmHvObjectID, vmShutdown=vmShutdown, VirtualMachineStorageIndex=VirtualMachineStorageIndex, vmStorageIndex=vmStorageIndex, vmNetworkPhysAddress=vmNetworkPhysAddress, vmUpTime=vmUpTime, VirtualMachineIndexOrZero=VirtualMachineIndexOrZero, vmStorageWriteOctets=vmStorageWriteOctets, vmFullCompliances=vmFullCompliances, vmStorageParent=vmStorageParent, VirtualMachineNetworkIndex=VirtualMachineNetworkIndex, vmStorageAccess=vmStorageAccess, vmPaused=vmPaused, vmOSType=vmOSType, vmStorageTable=vmStorageTable, vmNetworkIndex=vmNetworkIndex, VirtualMachineIndex=VirtualMachineIndex, vmSuspended=vmSuspended, vmNumber=vmNumber, vmPersistent=vmPersistent, VirtualMachineList=VirtualMachineList, vmStorageWriteLatency=vmStorageWriteLatency, vmDeleted=vmDeleted, vmBulkNotificationOptionalGroup=vmBulkNotificationOptionalGroup, vmStorageResourceID=vmStorageResourceID, vmStorageAllocatedSize=vmStorageAllocatedSize, vmMinCpuNumber=vmMinCpuNumber, vmShuttingdown=vmShuttingdown, vmMIB=vmMIB, vmStorageWriteIOs=vmStorageWriteIOs, vmBulkSuspending=vmBulkSuspending, vmHvVersion=vmHvVersion, vmStorageSizeUnit=vmStorageSizeUnit, vmBulkDeleted=vmBulkDeleted, vmAutoStart=vmAutoStart, vmCpuEntry=vmCpuEntry, vmCpuTime=vmCpuTime, vmCpuIndex=vmCpuIndex, vmSuspending=vmSuspending, vmCpuAffinityTable=vmCpuAffinityTable, vmStorageVmIndex=vmStorageVmIndex, vmRunning=vmRunning, vmMinMem=vmMinMem, vmEntry=vmEntry, vmMaxMem=vmMaxMem, vmStorageReadIOs=vmStorageReadIOs, vmCpuAffinity=vmCpuAffinity, vmStorageSourceTypeString=vmStorageSourceTypeString, vmName=vmName, vmStorageGroup=vmStorageGroup, vmHypervisor=vmHypervisor, vmStorageEntry=vmStorageEntry, vmHvSoftware=vmHvSoftware, vmBulkResuming=vmBulkResuming, vmBulkNotificationsVariablesGroup=vmBulkNotificationsVariablesGroup, vmNetworkGroup=vmNetworkGroup, vmNotifications=vmNotifications, vmMaxCpuNumber=vmMaxCpuNumber, vmPerVMNotificationOptionalGroup=vmPerVMNotificationOptionalGroup, vmStorageReadLatency=vmStorageReadLatency, vmCpuAffinityGroup=vmCpuAffinityGroup, vmHvUpTime=vmHvUpTime, vmNetworkIfIndex=vmNetworkIfIndex, vmReadOnlyCompliances=vmReadOnlyCompliances, vmCurCpuNumber=vmCurCpuNumber, vmBulkMigrating=vmBulkMigrating, vmNetworkTable=vmNetworkTable, vmAffectedVMs=vmAffectedVMs, vmBulkShutdown=vmBulkShutdown, vmBulkPaused=vmBulkPaused, VirtualMachineStorageSourceType=VirtualMachineStorageSourceType, VirtualMachinePersistent=VirtualMachinePersistent, vmConformance=vmConformance, vmIndex=vmIndex, vmCrashed=vmCrashed)
