...
mibBuilder.exportSymbols("CISCO-SYSLOG-EXT-MIB", cseSyslogLogFileName=cseSyslogLogFileName, cseSyslogLinecardMsgSeverity=cseSyslogLinecardMsgSeverity, cseSyslogConsoleMsgSeverity=cseSyslogConsoleMsgSeverity, cseSyslogServerIndex=cseSyslogServerIndex, cseSyslogLinecardEnable=cseSyslogLinecardEnable, SyslogExFacility=SyslogExFacility, cseSyslogMessageFacility=cseSyslogMessageFacility, cseSyslogConsoleEnable=cseSyslogConsoleEnable, cseSyslogTerminalMsgSeverity=cseSyslogTerminalMsgSeverity, cseSyslogTerminalEnable=cseSyslogTerminalEnable, cseSyslogServerTableMaxEntries=cseSyslogServerTableMaxEntries, cseSyslogServerStatus=cseSyslogServerStatus, ciscoSyslogExtMIBCompliances=ciscoSyslogExtMIBCompliances, cseSyslogMessageControlTable=cseSyslogMessageControlTable, ciscoSyslogExtMIBConformance=ciscoSyslogExtMIBConformance, cseSyslogConfigurationGroup=cseSyslogConfigurationGroup, ciscoSyslogExtMIB=ciscoSyslogExtMIB, ciscoSyslogExtMIBGroups=ciscoSyslogExtMIBGroups, cseSyslogLogFileMsgSeverity=cseSyslogLogFileMsgSeverity, ciscoSyslogExtGroup=ciscoSyslogExtGroup, cseSyslogServerAddress=cseSyslogServerAddress, cseSyslogServerProtocol=cseSyslogServerProtocol, cseSyslogServerFacility=cseSyslogServerFacility, SyslogProtocol=SyslogProtocol, PYSNMP_MODULE_ID=ciscoSyslogExtMIB, cseSyslogServerMsgSeverity=cseSyslogServerMsgSeverity, cseSyslogServerEntry=cseSyslogServerEntry, cseSyslogServerTable=cseSyslogServerTable, ciscoSyslogProtocolGroup=ciscoSyslogProtocolGroup, cseSyslogServerProtocolFallback=cseSyslogServerProtocolFallback, ciscoSyslogExtMIBObjects=ciscoSyslogExtMIBObjects, cseSyslogMessageControlEntry=cseSyslogMessageControlEntry, ciscoSyslogExtMIBCompliance=ciscoSyslogExtMIBCompliance, cseSyslogServerPort=cseSyslogServerPort, cseSyslogFileLoggingDisable=cseSyslogFileLoggingDisable, cseSyslogServerAddressType=cseSyslogServerAddressType, ciscoSyslogExtMIBComplianceRev2=ciscoSyslogExtMIBComplianceRev2, cseSyslogMessageSeverity=cseSyslogMessageSeverity, SyslogFacility=SyslogFacility)
