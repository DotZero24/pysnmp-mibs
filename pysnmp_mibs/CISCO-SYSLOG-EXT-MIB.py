...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-SYSLOG-EXT-MIB
...
ciscoSyslogExtMIB.setRevisions(('2019-04-02 00:00', '2019-03-18 00:00', '2015-06-08 00:00', '2015-03-02 00:00', '2014-11-05 00:00', '2014-08-13 00:00', '2014-06-02 00:00', '2014-05-30 00:00', '2013-11-23 00:00', '2013-09-11 00:00', '2013-06-14 00:00', '2013-06-11 00:00', '2013-01-08 00:00', '2012-08-24 00:00', '2011-06-09 00:00', '2011-06-08 00:00', '2011-05-20 00:00', '2010-02-05 00:00', '2009-08-16 00:00', '2009-07-01 00:00', '2009-06-17 00:00', '2009-06-08 00:00', '2008-04-28 00:00', '2006-11-09 00:00', '2005-01-30 00:00', '2004-09-20 00:00', '2003-12-15 00:00', '2002-11-13 00:00', '2002-10-04 00:00',))
if mibBuilder.loadTexts: ciscoSyslogExtMIB.setLastUpdated('201904020000Z')
...
mibBuilder.exportSymbols("CISCO-SYSLOG-EXT-MIB", cseSyslogServerAddressType=cseSyslogServerAddressType, cseSyslogServerTable=cseSyslogServerTable, SyslogFacility=SyslogFacility, cseSyslogServerProtocolFallback=cseSyslogServerProtocolFallback, cseSyslogLinecardMsgSeverity=cseSyslogLinecardMsgSeverity, cseSyslogFileLoggingDisable=cseSyslogFileLoggingDisable, cseSyslogTerminalEnable=cseSyslogTerminalEnable, ciscoSyslogExtMIBGroups=ciscoSyslogExtMIBGroups, ciscoSyslogExtMIB=ciscoSyslogExtMIB, cseSyslogServerStatus=cseSyslogServerStatus, cseSyslogServerMsgSeverity=cseSyslogServerMsgSeverity, ciscoSyslogExtMIBCompliances=ciscoSyslogExtMIBCompliances, cseSyslogMessageControlEntry=cseSyslogMessageControlEntry, PYSNMP_MODULE_ID=ciscoSyslogExtMIB, SyslogProtocol=SyslogProtocol, cseSyslogServerPort=cseSyslogServerPort, cseSyslogConsoleEnable=cseSyslogConsoleEnable, cseSyslogLogFileMsgSeverity=cseSyslogLogFileMsgSeverity, cseSyslogLogFileName=cseSyslogLogFileName, cseSyslogMessageSeverity=cseSyslogMessageSeverity, cseSyslogLinecardEnable=cseSyslogLinecardEnable, ciscoSyslogProtocolGroup=ciscoSyslogProtocolGroup, cseSyslogConfigurationGroup=cseSyslogConfigurationGroup, cseSyslogServerEntry=cseSyslogServerEntry, cseSyslogMessageFacility=cseSyslogMessageFacility, cseSyslogServerProtocol=cseSyslogServerProtocol, cseSyslogTerminalMsgSeverity=cseSyslogTerminalMsgSeverity, cseSyslogServerFacility=cseSyslogServerFacility, SyslogExFacility=SyslogExFacility, cseSyslogServerIndex=cseSyslogServerIndex, cseSyslogMessageControlTable=cseSyslogMessageControlTable, ciscoSyslogExtMIBCompliance=ciscoSyslogExtMIBCompliance, cseSyslogConsoleMsgSeverity=cseSyslogConsoleMsgSeverity, ciscoSyslogExtMIBComplianceRev2=ciscoSyslogExtMIBComplianceRev2, cseSyslogServerAddress=cseSyslogServerAddress, ciscoSyslogExtMIBConformance=ciscoSyslogExtMIBConformance, cseSyslogServerTableMaxEntries=cseSyslogServerTableMaxEntries, ciscoSyslogExtMIBObjects=ciscoSyslogExtMIBObjects, ciscoSyslogExtGroup=ciscoSyslogExtGroup)
