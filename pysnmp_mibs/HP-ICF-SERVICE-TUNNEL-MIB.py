...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-SERVICE-TUNNEL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:39:50 2025
...
hpicfServiceTunnelCompliance.setObjects(
      *(("HP-ICF-SERVICE-TUNNEL-MIB", "hpicfServiceScalarsGroup"),
        ("HP-ICF-SERVICE-TUNNEL-MIB", "hpicfServiceScalarsStatsGroup"),
        ("HP-ICF-SERVICE-TUNNEL-MIB", "hpicfServiceTunnelGroup"),
        ("HP-ICF-SERVICE-TUNNEL-MIB", "hpicfServiceTunnelStatsGroup"),
        ("HP-ICF-SERVICE-TUNNEL-MIB", "hpicfServiceTunnelNotificationGroup"),
        ("HP-ICF-SERVICE-TUNNEL-MIB", "hpicfServiceScalarsGroup1"),
        ("HP-ICF-SERVICE-TUNNEL-MIB", "hpicfServiceTunnelGroup1"))
)
if mibBuilder.loadTexts:
