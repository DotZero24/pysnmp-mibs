...
mibBuilder.exportSymbols("BASIS-SERIAL-MIB", serialInterface=serialInterface, serialInterfaceEntry=serialInterfaceEntry, basisSerialCompliance=basisSerialCompliance, serialInterfaceTable=serialInterfaceTable, serialPortNum=serialPortNum, serialPortbps=serialPortbps, basisSerialMIBConformance=basisSerialMIBConformance, basisSerialMIBGroups=basisSerialMIBGroups, basisSerialConfGroup=basisSerialConfGroup, basisSerialMIBCompliances=basisSerialMIBCompliances, serialPortType=serialPortType, basisSerialMIB=basisSerialMIB, serialPortEnable=serialPortEnable, PYSNMP_MODULE_ID=basisSerialMIB, serialPortNumOfValidEntries=serialPortNumOfValidEntries)
