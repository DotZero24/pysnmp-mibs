...
_J='Unsigned32'
_I='NETAPP-PORTSECURITY-PRIVATE-MIB'
_H='read-only'
_G='ifIndex'
_F='IF-MIB'
_E='disable'
...
fastPathPortSecurity=ModuleIdentity((1,3,6,1,4,1,789,4413,1,1,20))
...
agentPortSecurityGroup=_AgentPortSecurityGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,20,1))
...
agentGlobalPortSecurityMode=_AgentGlobalPortSecurityMode_Object((1,3,6,1,4,1,789,4413,1,1,20,1,1),_AgentGlobalPortSecurityMode_Type())
...
agentPortSecurityTable=_AgentPortSecurityTable_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2))
if mibBuilder.loadTexts:agentPortSecurityTable.setStatus(_A)
_AgentPortSecurityEntry_Object=MibTableRow
agentPortSecurityEntry=_AgentPortSecurityEntry_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1))
...
agentPortSecurityMode=_AgentPortSecurityMode_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,1),_AgentPortSecurityMode_Type())
...
agentPortSecurityDynamicLimit=_AgentPortSecurityDynamicLimit_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,2),_AgentPortSecurityDynamicLimit_Type())
...
agentPortSecurityStaticLimit=_AgentPortSecurityStaticLimit_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,3),_AgentPortSecurityStaticLimit_Type())
...
agentPortSecurityViolationTrapMode=_AgentPortSecurityViolationTrapMode_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,4),_AgentPortSecurityViolationTrapMode_Type())
...
agentPortSecurityStaticMACs=_AgentPortSecurityStaticMACs_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,6),_AgentPortSecurityStaticMACs_Type())
...
agentPortSecurityLastDiscardedMAC=_AgentPortSecurityLastDiscardedMAC_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,7),_AgentPortSecurityLastDiscardedMAC_Type())
...
agentPortSecurityMACAddressAdd=_AgentPortSecurityMACAddressAdd_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,8),_AgentPortSecurityMACAddressAdd_Type())
...
agentPortSecurityMACAddressRemove=_AgentPortSecurityMACAddressRemove_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,9),_AgentPortSecurityMACAddressRemove_Type())
...
agentPortSecurityMACAddressMove=_AgentPortSecurityMACAddressMove_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,10),_AgentPortSecurityMACAddressMove_Type())
...
agentPortSecurityStickyMode=_AgentPortSecurityStickyMode_Object((1,3,6,1,4,1,789,4413,1,1,20,1,2,1,11),_AgentPortSecurityStickyMode_Type())
...
agentPortSecurityDynamicTable=_AgentPortSecurityDynamicTable_Object((1,3,6,1,4,1,789,4413,1,1,20,1,3))
if mibBuilder.loadTexts:agentPortSecurityDynamicTable.setStatus(_A)
_AgentPortSecurityDynamicEntry_Object=MibTableRow
agentPortSecurityDynamicEntry=_AgentPortSecurityDynamicEntry_Object((1,3,6,1,4,1,789,4413,1,1,20,1,3,1))
...
agentPortSecurityDynamicVLANId=_AgentPortSecurityDynamicVLANId_Object((1,3,6,1,4,1,789,4413,1,1,20,1,3,1,1),_AgentPortSecurityDynamicVLANId_Type())
...
agentPortSecurityDynamicMACAddress=_AgentPortSecurityDynamicMACAddress_Object((1,3,6,1,4,1,789,4413,1,1,20,1,3,1,2),_AgentPortSecurityDynamicMACAddress_Type())
...
agentGlobalPortSecurityStickyMode=_AgentGlobalPortSecurityStickyMode_Object((1,3,6,1,4,1,789,4413,1,1,20,1,4),_AgentGlobalPortSecurityStickyMode_Type())
...
agentGlobalPortSecurityViolationTrapMode=_AgentGlobalPortSecurityViolationTrapMode_Object((1,3,6,1,4,1,789,4413,1,1,20,1,5),_AgentGlobalPortSecurityViolationTrapMode_Type())
...
agentPortSecurityTraps=_AgentPortSecurityTraps_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,20,2))
agentPortSecurityViolation=NotificationType((1,3,6,1,4,1,789,4413,1,1,20,2,1))
