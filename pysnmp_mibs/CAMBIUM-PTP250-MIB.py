...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cambium/CAMBIUM-PTP250-MIB
...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", searchState=searchState, snmpControl=snmpControl, wirelessLinkStatus=wirelessLinkStatus, extendedChannel=extendedChannel, pubStatsGroup=pubStatsGroup, ptpCompliance=ptpCompliance, maximumTransmitPower=maximumTransmitPower, regionCode=regionCode, installArmState=installArmState, transmitDataRate=transmitDataRate, sNMPCommunityTable=sNMPCommunityTable, channelBandwidth=channelBandwidth, currentChannel=currentChannel, tFTPServerIPAddress=tFTPServerIPAddress, licence=licence, pubStats=pubStats, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, versions=versions, ptp=ptp, cambium=cambium, transmitModulationMode=transmitModulationMode, ethernet=ethernet, linkLoss=linkLoss, band=band, remoteMACAddress=remoteMACAddress, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, noiseFloor=noiseFloor, sNMPCommunityTableEntry=sNMPCommunityTableEntry, currentFreqMHz=currentFreqMHz, nTPServerPortNumber=nTPServerPortNumber, dataPortStatus=dataPortStatus, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configuredModulationMode=configuredModulationMode, extendedFreqMHz=extendedFreqMHz, sNMPCommunityOid=sNMPCommunityOid, ptpTrapPrefix=ptpTrapPrefix, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelSelection=channelSelection, nTPLastSync=nTPLastSync, tFTPServerPortNumber=tFTPServerPortNumber, phyStatusGroup=phyStatusGroup, vlanId=vlanId, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, gatewayIPAddress=gatewayIPAddress, nTPState=nTPState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPSync=nTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, remoteIPAddress=remoteIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, hardwareVersion=hardwareVersion, receiveModulationMode=receiveModulationMode, configuration=configuration, antennaGain=antennaGain, cableLoss=cableLoss, ptpTraps=ptpTraps, smtp=smtp, dualPayload=dualPayload, measuredRange=measuredRange, fixedModMode=fixedModMode, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, ptpGroups=ptpGroups, alarms=alarms, sNMPCommunityTableIndex=sNMPCommunityTableIndex, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, licenceGroup=licenceGroup, sNMPCommunityAccess=sNMPCommunityAccess, configuredRange=configuredRange, productName=productName, siteName=siteName, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetGroup=ethernetGroup, masterSlaveMode=masterSlaveMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, bootVersion=bootVersion, notificationsGroup=notificationsGroup, phyStatus=phyStatus, linkStatusTrap=linkStatusTrap, versionsGroup=versionsGroup, receiveDataRate=receiveDataRate, transmitPower=transmitPower, systemClock=systemClock, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, ptp250=ptp250, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, ntp=ntp, vlanPriority=vlanPriority, ptmp=ptmp, linkName=linkName, vlanTagging=vlanTagging, sNMPTrapVersion=sNMPTrapVersion, radarDetectTrap=radarDetectTrap, nTPPollInterval=nTPPollInterval, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTable=sNMPTrapTable, management=management, configurationGroup=configurationGroup, softwareVersion=softwareVersion, ntpGroup=ntpGroup, sMTPEnabledMessages=sMTPEnabledMessages, alarmsGroup=alarmsGroup, receivePower=receivePower, timeZone=timeZone, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, radarDetectChannel=radarDetectChannel)
