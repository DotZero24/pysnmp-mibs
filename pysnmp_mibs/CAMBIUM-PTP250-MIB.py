...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanId=vlanId, sNMPCommunityTableEntry=sNMPCommunityTableEntry, configuredRange=configuredRange, transmitPower=transmitPower, vlanPriority=vlanPriority, sNMPTrapVersion=sNMPTrapVersion, radarDetectChannel=radarDetectChannel, extendedFreqMHz=extendedFreqMHz, pubStats=pubStats, radarDetectTrap=radarDetectTrap, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, linkName=linkName, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, currentChannel=currentChannel, fixedModMode=fixedModMode, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, sNMPCommunityOid=sNMPCommunityOid, sMTPEnabledMessages=sMTPEnabledMessages, PYSNMP_MODULE_ID=cambium, sNMPTrapTable=sNMPTrapTable, extendedChannel=extendedChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, channelSelection=channelSelection, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityAccess=sNMPCommunityAccess, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, ethernet=ethernet, nTPServerPortNumber=nTPServerPortNumber, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, nTPPollInterval=nTPPollInterval, timeZone=timeZone, siteName=siteName, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, installArmState=installArmState, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, band=band, alarmsGroup=alarmsGroup, phyStatus=phyStatus, subnetMask=subnetMask, channelBandwidth=channelBandwidth, sMTPServerIPAddress=sMTPServerIPAddress, versions=versions, sNMPTrapCommunity=sNMPTrapCommunity, systemClock=systemClock, softwareVersion=softwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp=ptp, regionCode=regionCode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dualPayload=dualPayload, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, nTPLastSync=nTPLastSync, snmpControl=snmpControl, ntpGroup=ntpGroup, linkLoss=linkLoss, versionsGroup=versionsGroup, ntp=ntp, phyStatusGroup=phyStatusGroup, remoteMACAddress=remoteMACAddress, alarms=alarms, currentFreqMHz=currentFreqMHz, noiseFloor=noiseFloor, licenceGroup=licenceGroup, linkStatusTrap=linkStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, measuredRange=measuredRange, configuredModulationMode=configuredModulationMode, nTPSync=nTPSync, ptpGroups=ptpGroups, vectorError=vectorError, cableLoss=cableLoss, ptmp=ptmp, pubStatsGroup=pubStatsGroup, smtp=smtp, licence=licence, vlanTagging=vlanTagging, ptp250=ptp250, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPServerIp=nTPServerIp, configuration=configuration, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, receivePower=receivePower, snmpControlGroup=snmpControlGroup, masterSlaveMode=masterSlaveMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatusTrap=dataPortStatusTrap, management=management, managementGroup=managementGroup, nTPState=nTPState, productName=productName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, searchState=searchState)
