...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-POLICY-GROUP-MIB
...
_CpgGroupIpMask_Type.__name__ = "InetAddress"
...
ciscoPolicyGroupMIBCompliance.setObjects(
      *(("CISCO-POLICY-GROUP-MIB", "ciscoCpgPolicyInfoGroup"),
        ("CISCO-POLICY-GROUP-MIB", "ciscoCpgGroupInfoGroup"),
        ("CISCO-POLICY-GROUP-MIB", "ciscoCpgGroupIpInfoGroup"),
        ("CISCO-POLICY-GROUP-MIB", "ciscoCpgPolicyGroupInfoGroup"))
)
if mibBuilder.loadTexts:
