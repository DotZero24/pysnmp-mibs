...
# Notes
# -----
# ASN.1 source file://mibs/rfc/SSPM-MIB
...
sspmGeneralCompliance.setObjects(
      *(("SSPM-MIB", "sspmGeneralGroup"),
        ("SSPM-MIB", "sspmSourceGroup"),
        ("SSPM-MIB", "sspmSinkGroup"),
        ("SSPM-MIB", "sspmUserPassGroup"))
)
if mibBuilder.loadTexts:
...
sspmSourceFullCompliance.setObjects(
      *(("SSPM-MIB", "sspmGeneralGroup"),
        ("SSPM-MIB", "sspmSourceGroup"),
        ("SSPM-MIB", "sspmUserPassGroup"))
)
...
sspmSinkFullCompliance.setObjects(
      *(("SSPM-MIB", "sspmGeneralGroup"),
        ("SSPM-MIB", "sspmSinkGroup"))
)
if mibBuilder.loadTexts:
