...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-WAN-BBIF-ATM-CONN-MIB
...
mibBuilder.exportSymbols("CISCO-WAN-BBIF-ATM-CONN-MIB", bbChanRemoteVpi=bbChanRemoteVpi, bbChanCnfNum=bbChanCnfNum, cwbAtmConnCompliance=cwbAtmConnCompliance, bbChanServiceType=bbChanServiceType, bbChanVpi=bbChanVpi, bbChanState=bbChanState, cwbAtmConnGeneralGroup=cwbAtmConnGeneralGroup, bbChanSvcConnId=bbChanSvcConnId, bbChanRtePriority=bbChanRtePriority, bbChanLocalNsapAddr=bbChanLocalNsapAddr, bbChanEgrSrvRate=bbChanEgrSrvRate, bbRemoteConnPCR=bbRemoteConnPCR, bbChanMaster=bbChanMaster, bbChanCnfGrpTable=bbChanCnfGrpTable, bbChanGcra1Action=bbChanGcra1Action, bbChanUpcCDVT=bbChanUpcCDVT, ciscoWanBbifAtmConnMIB=ciscoWanBbifAtmConnMIB, bbConnPercentUtil=bbConnPercentUtil, bbChanVpIdNextAvailable=bbChanVpIdNextAvailable, bbChanEgrXmtState=bbChanEgrXmtState, bbChanIngrRcvState=bbChanIngrRcvState, cwbAtmConnMIBConformance=cwbAtmConnMIBConformance, bbRemoteConnPercentUtil=bbRemoteConnPercentUtil, bbChanEgrPercentUtil=bbChanEgrPercentUtil, bbChanConnType=bbChanConnType, bbChanDiscardOption=bbChanDiscardOption, cwbAtmConnMIBCompliances=cwbAtmConnMIBCompliances, bbChanStateGrpTable=bbChanStateGrpTable, bbChanRemoteVci=bbChanRemoteVci, bbConnServiceType=bbConnServiceType, bbChanClpHiThreshold=bbChanClpHiThreshold, cwbAtmConnGroup=cwbAtmConnGroup, bbChanEfciThreshold=bbChanEfciThreshold, bbChanTestState=bbChanTestState, bbChanUpcEnable=bbChanUpcEnable, bbChanUpcMCR=bbChanUpcMCR, IfNsapAddress=IfNsapAddress, bbChanMaxCellMemThreshold=bbChanMaxCellMemThreshold, bbChanTestType=bbChanTestType, bbChanIfNum=bbChanIfNum, bbChanMaxCost=bbChanMaxCost, bbChanRemoteNsapAddr=bbChanRemoteNsapAddr, bbConnSCR=bbConnSCR, bbChanUpcPCR=bbChanUpcPCR, bbChanUpcMBS=bbChanUpcMBS, bbChanTestStateCPESide=bbChanTestStateCPESide, bbChanStateNum=bbChanStateNum, cwbAtmConnStateGroup=cwbAtmConnStateGroup, bbChanClpLoThreshold=bbChanClpLoThreshold, bbChanTestTypeCPESide=bbChanTestTypeCPESide, PYSNMP_MODULE_ID=ciscoWanBbifAtmConnMIB, bbChanSvcFlag=bbChanSvcFlag, bbChanFrmDiscardThreshold=bbChanFrmDiscardThreshold, bbChanRestrictTrkType=bbChanRestrictTrkType, bbChanNumNextAvailable=bbChanNumNextAvailable, bbChanTestResult=bbChanTestResult, bbChanOvrSubOvrRide=bbChanOvrSubOvrRide, bbChanGcra2Action=bbChanGcra2Action, bbConnVpcFlag=bbConnVpcFlag, bbRemoteConnSCR=bbRemoteConnSCR, cwbAtmConnMIBGroups=cwbAtmConnMIBGroups, bbConnPCR=bbConnPCR, bbChanUpcSCRPolicing=bbChanUpcSCRPolicing, bbChanConnDesc=bbChanConnDesc, bbChanUpcSCR=bbChanUpcSCR, bbChanCnfGrpEntry=bbChanCnfGrpEntry, bbChanIngrPercentUtil=bbChanIngrPercentUtil, bbChanLocalVpi=bbChanLocalVpi, bbChanRowStatus=bbChanRowStatus, bbChanStateGrpEntry=bbChanStateGrpEntry, bbChanLocalVci=bbChanLocalVci, bbChanCongstUpdateCode=bbChanCongstUpdateCode, bbChanVci=bbChanVci)
