...
mibBuilder.exportSymbols("CISCO-WAN-BBIF-ATM-CONN-MIB", bbConnServiceType=bbConnServiceType, bbChanLocalVpi=bbChanLocalVpi, bbChanVci=bbChanVci, bbChanDiscardOption=bbChanDiscardOption, bbChanRemoteVci=bbChanRemoteVci, bbChanServiceType=bbChanServiceType, bbChanTestTypeCPESide=bbChanTestTypeCPESide, bbConnSCR=bbConnSCR, ciscoWanBbifAtmConnMIB=ciscoWanBbifAtmConnMIB, bbChanEgrXmtState=bbChanEgrXmtState, bbChanMaxCost=bbChanMaxCost, bbChanCongstUpdateCode=bbChanCongstUpdateCode, bbChanNumNextAvailable=bbChanNumNextAvailable, cwbAtmConnMIBCompliances=cwbAtmConnMIBCompliances, cwbAtmConnGroup=cwbAtmConnGroup, bbChanEfciThreshold=bbChanEfciThreshold, bbChanTestType=bbChanTestType, bbChanTestState=bbChanTestState, bbChanUpcCDVT=bbChanUpcCDVT, bbChanRemoteNsapAddr=bbChanRemoteNsapAddr, bbConnPCR=bbConnPCR, bbChanSvcFlag=bbChanSvcFlag, bbChanClpLoThreshold=bbChanClpLoThreshold, bbChanEgrSrvRate=bbChanEgrSrvRate, bbChanState=bbChanState, bbChanCnfGrpEntry=bbChanCnfGrpEntry, bbChanMaxCellMemThreshold=bbChanMaxCellMemThreshold, bbRemoteConnSCR=bbRemoteConnSCR, bbChanUpcMCR=bbChanUpcMCR, bbChanUpcSCRPolicing=bbChanUpcSCRPolicing, cwbAtmConnStateGroup=cwbAtmConnStateGroup, bbChanCnfNum=bbChanCnfNum, bbChanEgrPercentUtil=bbChanEgrPercentUtil, bbChanStateGrpEntry=bbChanStateGrpEntry, bbChanVpIdNextAvailable=bbChanVpIdNextAvailable, bbChanStateNum=bbChanStateNum, bbChanRowStatus=bbChanRowStatus, bbChanGcra2Action=bbChanGcra2Action, bbChanSvcConnId=bbChanSvcConnId, bbChanGcra1Action=bbChanGcra1Action, bbChanIngrPercentUtil=bbChanIngrPercentUtil, cwbAtmConnCompliance=cwbAtmConnCompliance, bbConnVpcFlag=bbConnVpcFlag, cwbAtmConnGeneralGroup=cwbAtmConnGeneralGroup, PYSNMP_MODULE_ID=ciscoWanBbifAtmConnMIB, bbChanUpcEnable=bbChanUpcEnable, bbChanUpcPCR=bbChanUpcPCR, IfNsapAddress=IfNsapAddress, bbChanOvrSubOvrRide=bbChanOvrSubOvrRide, bbChanUpcMBS=bbChanUpcMBS, bbChanMaster=bbChanMaster, bbChanRtePriority=bbChanRtePriority, cwbAtmConnMIBConformance=cwbAtmConnMIBConformance, cwbAtmConnMIBGroups=cwbAtmConnMIBGroups, bbChanClpHiThreshold=bbChanClpHiThreshold, bbChanFrmDiscardThreshold=bbChanFrmDiscardThreshold, bbRemoteConnPCR=bbRemoteConnPCR, bbChanVpi=bbChanVpi, bbChanTestStateCPESide=bbChanTestStateCPESide, bbChanCnfGrpTable=bbChanCnfGrpTable, bbConnPercentUtil=bbConnPercentUtil, bbChanRemoteVpi=bbChanRemoteVpi, bbChanRestrictTrkType=bbChanRestrictTrkType, bbChanUpcSCR=bbChanUpcSCR, bbChanTestResult=bbChanTestResult, bbRemoteConnPercentUtil=bbRemoteConnPercentUtil, bbChanIngrRcvState=bbChanIngrRcvState, bbChanIfNum=bbChanIfNum, bbChanStateGrpTable=bbChanStateGrpTable, bbChanLocalNsapAddr=bbChanLocalNsapAddr, bbChanConnType=bbChanConnType, bbChanLocalVci=bbChanLocalVci, bbChanConnDesc=bbChanConnDesc)
