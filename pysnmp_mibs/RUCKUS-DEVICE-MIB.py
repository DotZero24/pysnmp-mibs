...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:13:57 2025
...
ruckusDeviceMacAddr = _RuckusDeviceMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 1, 4, 1, 1, 1, 11),
    _RuckusDeviceMacAddr_Type()
)
ruckusDeviceMacAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ruckusDeviceMacAddr.setStatus("current")
_RuckusDeviceLedCtrl_Type = TruthValue
_RuckusDeviceLedCtrl_Object = MibScalar
ruckusDeviceLedCtrl = _RuckusDeviceLedCtrl_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 1, 4, 1, 1, 1, 15),
    _RuckusDeviceLedCtrl_Type()
)
ruckusDeviceLedCtrl.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ruckusDeviceLedCtrl.setStatus("current")
...
ruckusDeviceWanEntry.setIndexNames(
    (0, "RUCKUS-DEVICE-MIB", "ruckusDeviceWanIPIndex"),
)
if mibBuilder.loadTexts:
...
ruckusDeviceWanIPIndex = _RuckusDeviceWanIPIndex_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 1, 4, 1, 1, 4, 1, 1, 200),
    _RuckusDeviceWanIPIndex_Type()
)
ruckusDeviceWanIPIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ruckusDeviceWanIPIndex.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ruckusDeviceMIB": ruckusDeviceMIB,
       ...
       "ruckusDeviceMacAddr": ruckusDeviceMacAddr,
       "ruckusDeviceLedCtrl": ruckusDeviceLedCtrl,
       ...
       "ruckusDeviceWanIPIndex": ruckusDeviceWanIPIndex,
