# SNMP MIB module (ARICENT-MI-TCP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MI-TCP-MIB
...
fsMITcpConnTable = _FsMITcpConnTable_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 76, 3)
)
if mibBuilder.loadTexts:
    fsMITcpConnTable.setStatus("current")
_FsMITcpConnEntry_Object = MibTableRow
fsMITcpConnEntry = _FsMITcpConnEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 76, 3, 1)
)
fsMITcpConnEntry.setIndexNames(
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpContextId"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpConnLocalAddress"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpConnLocalPort"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpConnRemAddress"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpConnRemPort"),
)
if mibBuilder.loadTexts:
...
fsMITcpAoConnTestEntry = _FsMITcpAoConnTestEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 76, 6, 1)
)
fsMITcpAoConnTestEntry.setIndexNames(
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpContextId"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpAoConnTestLclAdrType"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpAoConnTestLclAdress"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpAoConnTestLclPort"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpAoConnTestRmtAdrType"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpAoConnTestRmtAdress"),
    (0, "ARICENT-MI-TCP-MIB", "fsMITcpAoConnTestRmtPort"),
)
if mibBuilder.loadTexts:
...
fsMITcpAoAuthError = NotificationType(
    (1, 3, 6, 1, 4, 1, 29601, 2, 76, 5, 0, 1)
)
fsMITcpAoAuthError.setObjects(
      *(("ARICENT-MI-TCP-MIB", "fsMITcpAoContextId"),
        ("ARICENT-MI-TCP-MIB", "fsMITcpAoLocalAddressType"),
        ("ARICENT-MI-TCP-MIB", "fsMITcpAoLocalAddress"),
        ("ARICENT-MI-TCP-MIB", "fsMITcpAoLocalPort"),
        ("ARICENT-MI-TCP-MIB", "fsMITcpAoRemAddressType"),
        ("ARICENT-MI-TCP-MIB", "fsMITcpAoRemAddress"),
        ("ARICENT-MI-TCP-MIB", "fsMITcpAoRemPort"),
        ("ARICENT-MI-TCP-MIB", "fsMITcpConTcpAOConnErrCtr"))
)
if mibBuilder.loadTexts:
