...
rlPimBsrCandidateRPTable=_RlPimBsrCandidateRPTable_Object((1,3,6,1,4,1,89,220))
if mibBuilder.loadTexts:rlPimBsrCandidateRPTable.setStatus(_A)
_RlPimBsrCandidateRPEntry_Object=MibTableRow
rlPimBsrCandidateRPEntry=_RlPimBsrCandidateRPEntry_Object((1,3,6,1,4,1,89,220,1))
...
rlPimBsrCandidateRPAddressType=_RlPimBsrCandidateRPAddressType_Object((1,3,6,1,4,1,89,220,1,1),_RlPimBsrCandidateRPAddressType_Type())
...
rlPimBsrCandidateRPAddress=_RlPimBsrCandidateRPAddress_Object((1,3,6,1,4,1,89,220,1,2),_RlPimBsrCandidateRPAddress_Type())
...
rlPimBsrCandidateRPGroupPrefixList=_RlPimBsrCandidateRPGroupPrefixList_Object((1,3,6,1,4,1,89,220,1,3),_RlPimBsrCandidateRPGroupPrefixList_Type())
...
rlPimBsrCandidateRPBidir=_RlPimBsrCandidateRPBidir_Object((1,3,6,1,4,1,89,220,1,5),_RlPimBsrCandidateRPBidir_Type())
...
rlPimBsrCandidateRPAdvTimer=_RlPimBsrCandidateRPAdvTimer_Object((1,3,6,1,4,1,89,220,1,6),_RlPimBsrCandidateRPAdvTimer_Type())
...
rlPimBsrCandidateRPPriority=_RlPimBsrCandidateRPPriority_Object((1,3,6,1,4,1,89,220,1,7),_RlPimBsrCandidateRPPriority_Type())
...
rlPimBsrCandidateRPAdvInterval=_RlPimBsrCandidateRPAdvInterval_Object((1,3,6,1,4,1,89,220,1,8),_RlPimBsrCandidateRPAdvInterval_Type())
...
rlPimBsrCandidateRPHoldtime=_RlPimBsrCandidateRPHoldtime_Object((1,3,6,1,4,1,89,220,1,9),_RlPimBsrCandidateRPHoldtime_Type())
...
rlPimBsrCandidateRPStatus=_RlPimBsrCandidateRPStatus_Object((1,3,6,1,4,1,89,220,1,10),_RlPimBsrCandidateRPStatus_Type())
