# SNMP MIB module (Dell-VRTX-JUMBOFRAMES-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-VRTX-JUMBOFRAMES-MIB
