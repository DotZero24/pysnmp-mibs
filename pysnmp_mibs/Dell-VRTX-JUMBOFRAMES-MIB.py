...
mibBuilder.exportSymbols('Dell-VRTX-JUMBOFRAMES-MIB',**{'rlJumboFrames':rlJumboFrames,'rlJumboFramesCurrentStatus':rlJumboFramesCurrentStatus,'rlJumboFramesStatusAfterReset':rlJumboFramesStatusAfterReset})