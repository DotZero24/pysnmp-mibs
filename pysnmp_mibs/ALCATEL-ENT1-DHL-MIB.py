# SNMP MIB module (ALCATEL-ENT1-DHL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-DHL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:10:15 2025
...
alaDHLSessionEntry.setIndexNames(
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLSessionIndex"),
)
if mibBuilder.loadTexts:
...
alaDHLLinksEntry.setIndexNames(
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLSessionIndex"),
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLLinkslinkA"),
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLLinkslinkB"),
)
if mibBuilder.loadTexts:
...
alaDHLVpaEntry.setIndexNames(
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLSessionIndex"),
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLVpalink"),
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLVpaVlan"),
)
if mibBuilder.loadTexts:
...
alaDHLVlanMapEntry.setIndexNames(
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLSessionIndex"),
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLVlanMapVlanStart"),
    (0, "ALCATEL-ENT1-DHL-MIB", "alaDHLVlanMapVlanEnd"),
)
if mibBuilder.loadTexts:
...
alaDHLSessionGroup.setObjects(
      *(("ALCATEL-ENT1-DHL-MIB", "alaDHLSessionDescr"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLSessionAdminStatus"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLSessionOperStatus"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLSessionPreemptionTime"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLSessionAdminMacFlushing"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLSessionActiveMacFlushing"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLSessionRowStatus"))
)
if mibBuilder.loadTexts:
...
alaDHLLinksGroup.setObjects(
      *(("ALCATEL-ENT1-DHL-MIB", "alaDHLLinkslinkAOperStatus"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLLinkslinkBOperStatus"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLLinksRowStatus"))
)
if mibBuilder.loadTexts:
...
alaDHLVpaGroup.setObjects(
      *(("ALCATEL-ENT1-DHL-MIB", "alaDHLVpaVlanType"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLVpaActiveLink"))
)
if mibBuilder.loadTexts:
...
alaDHLVlanMapGroup.setObjects(
    ("ALCATEL-ENT1-DHL-MIB", "alaDHLVlanMapRowStatus")
)
if mibBuilder.loadTexts:
...
alaDHLNotificationObjectGroup.setObjects(
      *(("ALCATEL-ENT1-DHL-MIB", "alaDHLSessionID"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLPortFrom"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLPortTo"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLVlanMoveReason"))
)
if mibBuilder.loadTexts:
...
alaDHLNotificationGroup.setObjects(
    ("ALCATEL-ENT1-DHL-MIB", "alaDHLVlanMoveTrap")
)
if mibBuilder.loadTexts:
...
alcatelIND1DHLMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-DHL-MIB", "alaDHLSessionGroup"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLLinksGroup"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLVpaGroup"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLVlanMapGroup"),
        ("ALCATEL-ENT1-DHL-MIB", "alaDHLNotificationGroup"))
)
if mibBuilder.loadTexts:
