...
mibBuilder.exportSymbols("HPN-ICF-VSI-MIB", hpnicfVsiIfIndex=hpnicfVsiIfIndex, hpnicfVsiXconnectAccessMode=hpnicfVsiXconnectAccessMode, hpnicfVsiXconnectRowStatus=hpnicfVsiXconnectRowStatus, hpnicfMinmIsid=hpnicfMinmIsid, hpnicfVsiPwBindRowStatus=hpnicfVsiPwBindRowStatus, hpnicfVsi=hpnicfVsi, hpnicfVsiPerfTable=hpnicfVsiPerfTable, hpnicfVsiEntry=hpnicfVsiEntry, hpnicfVsiPerfInErrors=hpnicfVsiPerfInErrors, hpnicfVsiEnableHubSpoke=hpnicfVsiEnableHubSpoke, hpnicfVsiPerfOutOctets=hpnicfVsiPerfOutOctets, hpnicfVsiMode=hpnicfVsiMode, hpnicfVsiIfID=hpnicfVsiIfID, hpnicfVsiNextAvailableVsiIndex=hpnicfVsiNextAvailableVsiIndex, hpnicfVsiId=hpnicfVsiId, hpnicfVsiPwIndex=hpnicfVsiPwIndex, hpnicfVsiInterfaceID=hpnicfVsiInterfaceID, hpnicfVsiPwBindAttributes=hpnicfVsiPwBindAttributes, hpnicfVsiLocalMacTable=hpnicfVsiLocalMacTable, hpnicfVsiPerfOutErrors=hpnicfVsiPerfOutErrors, hpnicfVsiArpSuppression=hpnicfVsiArpSuppression, hpnicfVsiFloodMacTable=hpnicfVsiFloodMacTable, hpnicfVsiNextAvailableVsiIfID=hpnicfVsiNextAvailableVsiIfID, hpnicfVsiXconnectIfIndex=hpnicfVsiXconnectIfIndex, hpnicfVsiPerfOutPackets=hpnicfVsiPerfOutPackets, hpnicfVsiFloodMac=hpnicfVsiFloodMac, hpnicfVsiIfRowStatus=hpnicfVsiIfRowStatus, hpnicfVsiScalarGroup=hpnicfVsiScalarGroup, hpnicfVsiVxlanID=hpnicfVsiVxlanID, hpnicfVsiTransMode=hpnicfVsiTransMode, hpnicfVsiLocalMacEntry=hpnicfVsiLocalMacEntry, hpnicfVsiAdminState=hpnicfVsiAdminState, hpnicfVsiPerfInDiscards=hpnicfVsiPerfInDiscards, hpnicfVsiLocalMacAddr=hpnicfVsiLocalMacAddr, hpnicfVsiName=hpnicfVsiName, hpnicfVsiLocalMacIfIndex=hpnicfVsiLocalMacIfIndex, hpnicfVsiLocalMacSrvID=hpnicfVsiLocalMacSrvID, hpnicfVsiXconnectVsiName=hpnicfVsiXconnectVsiName, hpnicfVsiTable=hpnicfVsiTable, hpnicfVsiFloodMacRowStatus=hpnicfVsiFloodMacRowStatus, hpnicfVsiPerfInOctets=hpnicfVsiPerfInOctets, hpnicfVsiNvgreID=hpnicfVsiNvgreID, hpnicfVsiRowStatus=hpnicfVsiRowStatus, hpnicfVsiXconnectEntry=hpnicfVsiXconnectEntry, hpnicfVsiPerfOutDiscards=hpnicfVsiPerfOutDiscards, hpnicfVsiPwBindTable=hpnicfVsiPwBindTable, hpnicfVsiStatistics=hpnicfVsiStatistics, hpnicfVsiPwBindEntry=hpnicfVsiPwBindEntry, hpnicfVsiLocalMacCount=hpnicfVsiLocalMacCount, hpnicfVsiObjects=hpnicfVsiObjects, hpnicfVsiL2vpnStatus=hpnicfVsiL2vpnStatus, hpnicfVsiSpbIsid=hpnicfVsiSpbIsid, hpnicfVsiXconnectTable=hpnicfVsiXconnectTable, PYSNMP_MODULE_ID=hpnicfVsi, hpnicfVsiIndex=hpnicfVsiIndex, hpnicfVsiPerfInPackets=hpnicfVsiPerfInPackets, hpnicfVsiIfTable=hpnicfVsiIfTable, hpnicfVsiIfEntry=hpnicfVsiIfEntry, hpnicfVsiPerfEntry=hpnicfVsiPerfEntry, hpnicfVsiFlooding=hpnicfVsiFlooding, hpnicfVsiXconnectEvcSrvInstId=hpnicfVsiXconnectEvcSrvInstId, hpnicfVsiFloodMacEntry=hpnicfVsiFloodMacEntry, hpnicfVsiXconnectHubSpoke=hpnicfVsiXconnectHubSpoke)
