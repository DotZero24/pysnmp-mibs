...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:21:48 2025
...
fadcVirturalServerEntry.setIndexNames(
    (0, "FORTINET-FORTIADC-MIB", "fadcVirturalServerIndex"),
)
if mibBuilder.loadTexts:
    fadcVirturalServerEntry.setStatus("current")
_FadcVirturalServerIndex_Type = FnIndex
...
class _FadcVirturalServerThroughputKbps_Type(Integer32):
    """Custom type fadcVirturalServerThroughputKbps based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_FadcVirturalServerThroughputKbps_Type.__name__ = "Integer32"
_FadcVirturalServerThroughputKbps_Object = MibTableColumn
fadcVirturalServerThroughputKbps = _FadcVirturalServerThroughputKbps_Object(
    (1, 3, 6, 1, 4, 1, 12356, 112, 8, 2, 2, 1, 7),
    _FadcVirturalServerThroughputKbps_Type()
)
fadcVirturalServerThroughputKbps.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fadcVirturalServerThroughputKbps.setStatus("current")
...
_FadcClientSSLCacheUtilizTables_ObjectIdentity = ObjectIdentity
fadcClientSSLCacheUtilizTables = _FadcClientSSLCacheUtilizTables_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12356, 112, 8, 5, 20)
)
_FadcClientSSLCacheUtilizTable_Object = MibTable
fadcClientSSLCacheUtilizTable = _FadcClientSSLCacheUtilizTable_Object(
    (1, 3, 6, 1, 4, 1, 12356, 112, 8, 5, 20, 1)
)
if mibBuilder.loadTexts:
    fadcClientSSLCacheUtilizTable.setStatus("current")
_FadcClientSSLCacheUtilizEntry_Object = MibTableRow
fadcClientSSLCacheUtilizEntry = _FadcClientSSLCacheUtilizEntry_Object(
    (1, 3, 6, 1, 4, 1, 12356, 112, 8, 5, 20, 1, 1)
)
fadcClientSSLCacheUtilizEntry.setIndexNames(
    (0, "FORTINET-FORTIADC-MIB", "fadcSLBVSIndex"),
)
if mibBuilder.loadTexts:
    fadcClientSSLCacheUtilizEntry.setStatus("current")
...
fadcHardwareConformanceGroup.setObjects(
      *(("FORTINET-FORTIADC-MIB", "fadcCPUName"),
        ...
        ("FORTINET-FORTIADC-MIB", "fadcMoniterIntfCount"),
...
fadcApplicationConformanceGroup.setObjects(
      *(("FORTINET-FORTIADC-MIB", "fadcPoolNumber"),
        ...
        ("FORTINET-FORTIADC-MIB", "fadcVirturalServerNumber"),
        ("FORTINET-FORTIADC-MIB", "fadcVirturalServerName"),
        ("FORTINET-FORTIADC-MIB", "fadcVirturalServerStatus"),
        ("FORTINET-FORTIADC-MIB", "fadcVirturalServerHealth"),
        ("FORTINET-FORTIADC-MIB", "fadcVirturalServerNewConnections"),
        ("FORTINET-FORTIADC-MIB", "fadcVirturalServerConcurrent"),
        ("FORTINET-FORTIADC-MIB", "fadcVirturalServerThroughputKbps"),
        ("FORTINET-FORTIADC-MIB", "fadcVirturalServerVdom"),
        ("FORTINET-FORTIADC-MIB", "fadcVirturalServerWAF"),
...
fadcTrapSysLincenseExpiryNotif = NotificationType(
    (1, 3, 6, 1, 4, 1, 12356, 112, 0, 537)
)
fadcTrapSysLincenseExpiryNotif.setObjects(
    ("FORTINET-FORTIADC-MIB", "fadcSysSerial")
)
if mibBuilder.loadTexts:
    fadcTrapSysLincenseExpiryNotif.setStatus(
        "current"
    )
...
fadcTrapSysUpgeadeComplete = NotificationType(
    (1, 3, 6, 1, 4, 1, 12356, 112, 0, 540)
)
fadcTrapSysUpgeadeComplete.setObjects(
    ("FORTINET-FORTIADC-MIB", "fadcSysSerial")
)
if mibBuilder.loadTexts:
    fadcTrapSysUpgeadeComplete.setStatus(
        "current"
    )
...
fadcTrapsConformanceGroup.setObjects(
      *(("FORTINET-FORTIADC-MIB", "fadcTrapCpuHighThreshold"),
        ...
        ("FORTINET-FORTIADC-MIB", "fadcTrapReputaionViolateDetected"),
        ...
        ("FORTINET-FORTIADC-MIB", "fadcTrapSysLincenseExpiryNotif"),
        ("FORTINET-FORTIADC-MIB", "fadcTrapSysDeviceRebooted"),
        ("FORTINET-FORTIADC-MIB", "fadcTrapSysDeviceStarted"),
        ("FORTINET-FORTIADC-MIB", "fadcTrapSysUpgeadeComplete"),
        ...
        ("FORTINET-FORTIADC-MIB", "adcTrapGatewayHCDown"),
...
mibBuilder.exportSymbols(
    ...
    **{"FadcHAModeVal": FadcHAModeVal,
       ...
       "fadcTrapSysLincenseExpiryNotif": fadcTrapSysLincenseExpiryNotif,
       "fadcTrapSysDeviceRebooted": fadcTrapSysDeviceRebooted,
       "fadcTrapSysDeviceStarted": fadcTrapSysDeviceStarted,
       "fadcTrapSysUpgeadeComplete": fadcTrapSysUpgeadeComplete,
       ...
       "fadcVirturalServerThroughputKbps": fadcVirturalServerThroughputKbps,
       ...
       "fadcClientSSLCacheUtilizTables": fadcClientSSLCacheUtilizTables,
       "fadcClientSSLCacheUtilizTable": fadcClientSSLCacheUtilizTable,
       "fadcClientSSLCacheUtilizEntry": fadcClientSSLCacheUtilizEntry,
