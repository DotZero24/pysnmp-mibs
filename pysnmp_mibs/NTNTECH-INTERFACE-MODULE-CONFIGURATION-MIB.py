...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/zhone/NTNTECH-INTERFACE-MODULE-CONFIGURATION-MIB
...
mibBuilder.exportSymbols("NTNTECH-INTERFACE-MODULE-CONFIGURATION-MIB", ifCfgPortFltrIp2End=ifCfgPortFltrIp2End, ifCfgPortE1RxTxRate=ifCfgPortE1RxTxRate, ifCfgPortCircuitID=ifCfgPortCircuitID, ifCfgPortE1FrameType=ifCfgPortE1FrameType, ifCfgPortT1FrameType=ifCfgPortT1FrameType, ifCfgPortBkBoneEthType=ifCfgPortBkBoneEthType, ifCfgPortAdslSnrDn=ifCfgPortAdslSnrDn, ifCfgE1SlotIndex=ifCfgE1SlotIndex, ifCfgPortE1Table=ifCfgPortE1Table, PYSNMP_MODULE_ID=ntntechInterfaceModuleConfigurationMIB, ifCfgPortFltrIp1Start=ifCfgPortFltrIp1Start, ifCfgPortE1Entry=ifCfgPortE1Entry, ifCfgIfPortIndex=ifCfgIfPortIndex, ifCfgPortAdslEcFdm=ifCfgPortAdslEcFdm, ifCfgPortT1Table=ifCfgPortT1Table, ifCfgPortAdslFastBuffer=ifCfgPortAdslFastBuffer, ifCfgPortAdslSnrUp=ifCfgPortAdslSnrUp, ifCfgPortIdslEntry=ifCfgPortIdslEntry, ifCfgPortVLANTable=ifCfgPortVLANTable, ifCfgPortIpFltProtocol=ifCfgPortIpFltProtocol, ifCfgPortAdslActualStandardMde=ifCfgPortAdslActualStandardMde, ifCfgPortT1RxTxRate=ifCfgPortT1RxTxRate, prmCfgInterfacePort=prmCfgInterfacePort, ifCfgVLANIndex=ifCfgVLANIndex, ifCfgPortFltrIp2Start=ifCfgPortFltrIp2Start, ifCfgPortAdslActualDepthDn=ifCfgPortAdslActualDepthDn, ifCfgIdslSlotIndex=ifCfgIdslSlotIndex, ifCfgPortAdslDelayDn=ifCfgPortAdslDelayDn, ifCfgPortAdslStandardMde=ifCfgPortAdslStandardMde, ifCfgPortBackboneVlan=ifCfgPortBackboneVlan, ifCfgPortVLANEntry=ifCfgPortVLANEntry, ifCfgPortSdslEntry=ifCfgPortSdslEntry, ifCfgPortAdslCorrectionUp=ifCfgPortAdslCorrectionUp, ifCfgT1PortIndex=ifCfgT1PortIndex, ifCfgPortE1ClockSrc=ifCfgPortE1ClockSrc, ifCfgPortReset=ifCfgPortReset, ifCfgVLANIdStart=ifCfgVLANIdStart, ifCfgPortAdslTable=ifCfgPortAdslTable, ifCfgSdslPortIndex=ifCfgSdslPortIndex, ifCfgE1PortIndex=ifCfgE1PortIndex, ifCfgPortSdslTable=ifCfgPortSdslTable, ifCfgPortAdslVpi=ifCfgPortAdslVpi, ifCfgPortAdslVci=ifCfgPortAdslVci, ifCfgAdslSlotIndex=ifCfgAdslSlotIndex, ifCfgPortE1LineCode=ifCfgPortE1LineCode, ifCfgPortAdslActualDepthUp=ifCfgPortAdslActualDepthUp, ifCfgPortIndex=ifCfgPortIndex, ifCfgAdslPortIndex=ifCfgAdslPortIndex, ifCfgSdslSlotIndex=ifCfgSdslSlotIndex, ifCfgPortEntry=ifCfgPortEntry, ifCfgPortAdslCorrectionDn=ifCfgPortAdslCorrectionDn, ifCfgPortAdslFrameType=ifCfgPortAdslFrameType, ifCfgPortSdslRxTxRate=ifCfgPortSdslRxTxRate, ifCfgPortT1TxBuildOut=ifCfgPortT1TxBuildOut, ifCfgSlotIndex=ifCfgSlotIndex, ifCfgIdslPortIndex=ifCfgIdslPortIndex, ifCfgPortAdslActualRxRate=ifCfgPortAdslActualRxRate, ifCfgPortSdslLineCode=ifCfgPortSdslLineCode, ifCfgPortIdslTable=ifCfgPortIdslTable, ifCfgPortTable=ifCfgPortTable, ifCfgPortAdslRxRate=ifCfgPortAdslRxRate, ifCfgPortVlanPriority=ifCfgPortVlanPriority, ifCfgPortT1Entry=ifCfgPortT1Entry, ifCfgVLANIdEnd=ifCfgVLANIdEnd, ifModCfgMIBObjects=ifModCfgMIBObjects, ntntechInterfaceModuleConfigurationMIB=ntntechInterfaceModuleConfigurationMIB, ifCfgT1SlotIndex=ifCfgT1SlotIndex, ifCfgPortFloodMde=ifCfgPortFloodMde, ifCfgPortAdslTxRate=ifCfgPortAdslTxRate, ifCfgPortIdslRxTxRate=ifCfgPortIdslRxTxRate, prmCfgInterface=prmCfgInterface, ifCfgPortAdslPortMode=ifCfgPortAdslPortMode, ifCfgPortAdslVpiVciDetect=ifCfgPortAdslVpiVciDetect, ifCfgPortFltrIp1End=ifCfgPortFltrIp1End, ifCfgPortT1ClockSrc=ifCfgPortT1ClockSrc, ifCfgPortAdslDelayUp=ifCfgPortAdslDelayUp, ifModCfgParameterConfiguration=ifModCfgParameterConfiguration, ifCfgPortAdslEntry=ifCfgPortAdslEntry, ifCfgPortT1LineCode=ifCfgPortT1LineCode, ifCfgPortAdslActualTxRate=ifCfgPortAdslActualTxRate, ifCfgIfSlotIndex=ifCfgIfSlotIndex)
