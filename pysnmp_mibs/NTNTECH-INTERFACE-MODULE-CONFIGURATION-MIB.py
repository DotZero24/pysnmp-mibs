...
mibBuilder.exportSymbols("NTNTECH-INTERFACE-MODULE-CONFIGURATION-MIB", ifCfgIdslPortIndex=ifCfgIdslPortIndex, ifCfgT1PortIndex=ifCfgT1PortIndex, ifCfgPortT1TxBuildOut=ifCfgPortT1TxBuildOut, ifCfgPortIdslRxTxRate=ifCfgPortIdslRxTxRate, ifCfgPortSdslRxTxRate=ifCfgPortSdslRxTxRate, ifCfgPortAdslRxRate=ifCfgPortAdslRxRate, ifCfgPortFloodMde=ifCfgPortFloodMde, ifCfgPortT1ClockSrc=ifCfgPortT1ClockSrc, ifCfgPortFltrIp1Start=ifCfgPortFltrIp1Start, ifCfgPortCircuitID=ifCfgPortCircuitID, ifCfgPortAdslEntry=ifCfgPortAdslEntry, ifModCfgParameterConfiguration=ifModCfgParameterConfiguration, ifCfgPortE1Table=ifCfgPortE1Table, ifCfgPortAdslActualDepthDn=ifCfgPortAdslActualDepthDn, ifCfgPortT1RxTxRate=ifCfgPortT1RxTxRate, ifCfgPortEntry=ifCfgPortEntry, ifCfgPortAdslStandardMde=ifCfgPortAdslStandardMde, ifCfgPortAdslTxRate=ifCfgPortAdslTxRate, ifCfgE1PortIndex=ifCfgE1PortIndex, ifCfgPortAdslDelayDn=ifCfgPortAdslDelayDn, ifCfgPortFltrIp2End=ifCfgPortFltrIp2End, ifCfgPortAdslTable=ifCfgPortAdslTable, PYSNMP_MODULE_ID=ntntechInterfaceModuleConfigurationMIB, ifCfgPortFltrIp2Start=ifCfgPortFltrIp2Start, ifCfgPortAdslActualRxRate=ifCfgPortAdslActualRxRate, ifCfgAdslPortIndex=ifCfgAdslPortIndex, ifCfgPortAdslVci=ifCfgPortAdslVci, ifCfgAdslSlotIndex=ifCfgAdslSlotIndex, ifCfgVLANIndex=ifCfgVLANIndex, ifCfgPortE1Entry=ifCfgPortE1Entry, ifCfgPortFltrIp1End=ifCfgPortFltrIp1End, ifCfgE1SlotIndex=ifCfgE1SlotIndex, ifCfgPortAdslCorrectionUp=ifCfgPortAdslCorrectionUp, ifCfgPortIpFltProtocol=ifCfgPortIpFltProtocol, ifCfgPortVLANTable=ifCfgPortVLANTable, ifCfgPortSdslEntry=ifCfgPortSdslEntry, ifCfgPortAdslActualTxRate=ifCfgPortAdslActualTxRate, ifCfgPortBkBoneEthType=ifCfgPortBkBoneEthType, ifCfgPortAdslSnrDn=ifCfgPortAdslSnrDn, ifCfgPortAdslActualDepthUp=ifCfgPortAdslActualDepthUp, ifCfgPortE1LineCode=ifCfgPortE1LineCode, ifCfgSlotIndex=ifCfgSlotIndex, ifCfgPortAdslPortMode=ifCfgPortAdslPortMode, ifCfgPortSdslLineCode=ifCfgPortSdslLineCode, ifCfgPortAdslActualStandardMde=ifCfgPortAdslActualStandardMde, ifCfgVLANIdEnd=ifCfgVLANIdEnd, ifCfgPortT1Table=ifCfgPortT1Table, ifCfgPortAdslFastBuffer=ifCfgPortAdslFastBuffer, ifCfgPortTable=ifCfgPortTable, ifCfgPortReset=ifCfgPortReset, prmCfgInterface=prmCfgInterface, ntntechInterfaceModuleConfigurationMIB=ntntechInterfaceModuleConfigurationMIB, ifCfgVLANIdStart=ifCfgVLANIdStart, ifCfgPortT1FrameType=ifCfgPortT1FrameType, ifCfgPortAdslCorrectionDn=ifCfgPortAdslCorrectionDn, ifCfgPortT1LineCode=ifCfgPortT1LineCode, ifCfgPortIndex=ifCfgPortIndex, ifCfgPortAdslEcFdm=ifCfgPortAdslEcFdm, ifCfgPortBackboneVlan=ifCfgPortBackboneVlan, prmCfgInterfacePort=prmCfgInterfacePort, ifCfgPortIdslEntry=ifCfgPortIdslEntry, ifCfgPortIdslTable=ifCfgPortIdslTable, ifCfgPortAdslFrameType=ifCfgPortAdslFrameType, ifCfgPortE1RxTxRate=ifCfgPortE1RxTxRate, ifCfgSdslPortIndex=ifCfgSdslPortIndex, ifCfgPortAdslSnrUp=ifCfgPortAdslSnrUp, ifCfgIfPortIndex=ifCfgIfPortIndex, ifCfgPortE1FrameType=ifCfgPortE1FrameType, ifCfgIfSlotIndex=ifCfgIfSlotIndex, ifCfgT1SlotIndex=ifCfgT1SlotIndex, ifModCfgMIBObjects=ifModCfgMIBObjects, ifCfgPortAdslVpi=ifCfgPortAdslVpi, ifCfgPortVlanPriority=ifCfgPortVlanPriority, ifCfgIdslSlotIndex=ifCfgIdslSlotIndex, ifCfgSdslSlotIndex=ifCfgSdslSlotIndex, ifCfgPortE1ClockSrc=ifCfgPortE1ClockSrc, ifCfgPortAdslDelayUp=ifCfgPortAdslDelayUp, ifCfgPortAdslVpiVciDetect=ifCfgPortAdslVpiVciDetect, ifCfgPortT1Entry=ifCfgPortT1Entry, ifCfgPortVLANEntry=ifCfgPortVLANEntry, ifCfgPortSdslTable=ifCfgPortSdslTable)
