# SNMP MIB module (ARICENT-MPLS-TP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MPLS-TP-MIB
...
fsMplsTpNodeMapEntry = _FsMplsTpNodeMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 13, 8, 1, 3, 1)
)
fsMplsTpNodeMapEntry.setIndexNames(
    (0, "ARICENT-MPLS-TP-MIB", "fsMplsTpContextId"),
    (0, "ARICENT-MPLS-TP-MIB", "fsMplsTpNodeMapLocalNum"),
)
if mibBuilder.loadTexts:
