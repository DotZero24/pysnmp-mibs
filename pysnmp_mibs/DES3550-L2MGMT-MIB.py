...
swL2DevMgmt=_SwL2DevMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,1))
_SwL2DevInfo_ObjectIdentity=ObjectIdentity
swL2DevInfo=_SwL2DevInfo_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,1,1))
_SwDevInfoSystemUpTime_Type=TimeTicks
_SwDevInfoSystemUpTime_Object=MibScalar
swDevInfoSystemUpTime=_SwDevInfoSystemUpTime_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,1),_SwDevInfoSystemUpTime_Type())
...
swDevInfoTotalNumOfPort=_SwDevInfoTotalNumOfPort_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,2),_SwDevInfoTotalNumOfPort_Type())
...
swDevInfoNumOfPortInUse=_SwDevInfoNumOfPortInUse_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,3),_SwDevInfoNumOfPortInUse_Type())
...
swDevInfoConsoleInUse=_SwDevInfoConsoleInUse_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,4),_SwDevInfoConsoleInUse_Type())
...
swDevInfoModuleType=_SwDevInfoModuleType_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,5),_SwDevInfoModuleType_Type())
...
swDevInfoPowerTable=_SwDevInfoPowerTable_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,8))
if mibBuilder.loadTexts:swDevInfoPowerTable.setStatus(_A)
_SwDevInfoPowerEntry_Object=MibTableRow
swDevInfoPowerEntry=_SwDevInfoPowerEntry_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,8,1))
...
swDevInfoPowerUnitIndex=_SwDevInfoPowerUnitIndex_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,8,1,1),_SwDevInfoPowerUnitIndex_Type())
...
swDevInfoPowerID=_SwDevInfoPowerID_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,8,1,2),_SwDevInfoPowerID_Type())
...
swDevInfoPowerStatus=_SwDevInfoPowerStatus_Object((1,3,6,1,4,1,171,11,64,2,2,1,1,8,1,3),_SwDevInfoPowerStatus_Type())
...
swL2DevCtrl=_SwL2DevCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,1,2))
...
swL2DevCtrlStpState=_SwL2DevCtrlStpState_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,1),_SwL2DevCtrlStpState_Type())
...
swL2DevCtrlIGMPSnooping=_SwL2DevCtrlIGMPSnooping_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,2),_SwL2DevCtrlIGMPSnooping_Type())
...
swL2DevCtrlRmonState=_SwL2DevCtrlRmonState_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,3),_SwL2DevCtrlRmonState_Type())
...
swL2DevCtrlCleanAllStatisticCounter=_SwL2DevCtrlCleanAllStatisticCounter_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,8),_SwL2DevCtrlCleanAllStatisticCounter_Type())
...
swL2DevCtrlVlanIdOfFDBTbl=_SwL2DevCtrlVlanIdOfFDBTbl_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,9),_SwL2DevCtrlVlanIdOfFDBTbl_Type())
...
swL2MACNotifyState=_SwL2MACNotifyState_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,10),_SwL2MACNotifyState_Type())
...
swL2MACNotifyHistorySize=_SwL2MACNotifyHistorySize_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,11),_SwL2MACNotifyHistorySize_Type())
...
swL2MACNotifyInterval=_SwL2MACNotifyInterval_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,12),_SwL2MACNotifyInterval_Type())
...
swL2DevCtrlAsymVlanState=_SwL2DevCtrlAsymVlanState_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,13),_SwL2DevCtrlAsymVlanState_Type())
...
swL2DevCtrlManagementVlanId=_SwL2DevCtrlManagementVlanId_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,14),_SwL2DevCtrlManagementVlanId_Type())
...
swL2DevCtrlTelnet=_SwL2DevCtrlTelnet_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,1,2,15))
...
swL2DevCtrlTelnetState=_SwL2DevCtrlTelnetState_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,15,1),_SwL2DevCtrlTelnetState_Type())
...
swL2DevCtrlTelnetTcpPort=_SwL2DevCtrlTelnetTcpPort_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,15,2),_SwL2DevCtrlTelnetTcpPort_Type())
...
swL2DevCtrlLLDPState=_SwL2DevCtrlLLDPState_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,16),_SwL2DevCtrlLLDPState_Type())
...
swL2DevCtrlWeb=_SwL2DevCtrlWeb_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,1,2,17))
...
swL2DevCtrlWebState=_SwL2DevCtrlWebState_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,17,1),_SwL2DevCtrlWebState_Type())
...
swL2DevCtrlWebTcpPort=_SwL2DevCtrlWebTcpPort_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,17,2),_SwL2DevCtrlWebTcpPort_Type())
...
swL2DevCtrlLLDPForwardMessageState=_SwL2DevCtrlLLDPForwardMessageState_Object((1,3,6,1,4,1,171,11,64,2,2,1,2,18),_SwL2DevCtrlLLDPForwardMessageState_Type())
...
swL2DevAlarm=_SwL2DevAlarm_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,1,3))
...
swL2DevAlarmNewRoot=_SwL2DevAlarmNewRoot_Object((1,3,6,1,4,1,171,11,64,2,2,1,3,1),_SwL2DevAlarmNewRoot_Type())
...
swL2DevAlarmTopologyChange=_SwL2DevAlarmTopologyChange_Object((1,3,6,1,4,1,171,11,64,2,2,1,3,2),_SwL2DevAlarmTopologyChange_Type())
...
swL2DevAlarmLinkChange=_SwL2DevAlarmLinkChange_Object((1,3,6,1,4,1,171,11,64,2,2,1,3,3),_SwL2DevAlarmLinkChange_Type())
...
swL2VlanMgmt=_SwL2VlanMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,3))
_SwL2VlanAdvertisementTable_Object=MibTable
swL2VlanAdvertisementTable=_SwL2VlanAdvertisementTable_Object((1,3,6,1,4,1,171,11,64,2,2,3,1))
if mibBuilder.loadTexts:swL2VlanAdvertisementTable.setStatus(_A)
_SwL2VlanAdvertisementEntry_Object=MibTableRow
swL2VlanAdvertisementEntry=_SwL2VlanAdvertisementEntry_Object((1,3,6,1,4,1,171,11,64,2,2,3,1,1))
...
swL2VlanIndex=_SwL2VlanIndex_Object((1,3,6,1,4,1,171,11,64,2,2,3,1,1,1),_SwL2VlanIndex_Type())
...
swL2VlanName=_SwL2VlanName_Object((1,3,6,1,4,1,171,11,64,2,2,3,1,1,2),_SwL2VlanName_Type())
...
swL2VlanAdvertiseState=_SwL2VlanAdvertiseState_Object((1,3,6,1,4,1,171,11,64,2,2,3,1,1,3),_SwL2VlanAdvertiseState_Type())
...
swL2PortMgmt=_SwL2PortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,4))
_SwL2PortInfoTable_Object=MibTable
swL2PortInfoTable=_SwL2PortInfoTable_Object((1,3,6,1,4,1,171,11,64,2,2,4,1))
if mibBuilder.loadTexts:swL2PortInfoTable.setStatus(_I)
_SwL2PortInfoEntry_Object=MibTableRow
swL2PortInfoEntry=_SwL2PortInfoEntry_Object((1,3,6,1,4,1,171,11,64,2,2,4,1,1))
...
swL2PortInfoPortIndex=_SwL2PortInfoPortIndex_Object((1,3,6,1,4,1,171,11,64,2,2,4,1,1,1),_SwL2PortInfoPortIndex_Type())
...
swL2PortInfoUnitIndex=_SwL2PortInfoUnitIndex_Object((1,3,6,1,4,1,171,11,64,2,2,4,1,1,2),_SwL2PortInfoUnitIndex_Type())
...
swL2PortInfoType=_SwL2PortInfoType_Object((1,3,6,1,4,1,171,11,64,2,2,4,1,1,3),_SwL2PortInfoType_Type())
...
swL2PortInfoLinkStatus=_SwL2PortInfoLinkStatus_Object((1,3,6,1,4,1,171,11,64,2,2,4,1,1,4),_SwL2PortInfoLinkStatus_Type())
...
swL2PortInfoNwayStatus=_SwL2PortInfoNwayStatus_Object((1,3,6,1,4,1,171,11,64,2,2,4,1,1,5),_SwL2PortInfoNwayStatus_Type())
...
swL2PortInfoModuleType=_SwL2PortInfoModuleType_Object((1,3,6,1,4,1,171,11,64,2,2,4,1,1,6),_SwL2PortInfoModuleType_Type())
...
swL2PortInfoErrorDisabled=_SwL2PortInfoErrorDisabled_Object((1,3,6,1,4,1,171,11,64,2,2,4,1,1,7),_SwL2PortInfoErrorDisabled_Type())
...
swL2PortCtrlTable=_SwL2PortCtrlTable_Object((1,3,6,1,4,1,171,11,64,2,2,4,2))
if mibBuilder.loadTexts:swL2PortCtrlTable.setStatus(_I)
_SwL2PortCtrlEntry_Object=MibTableRow
swL2PortCtrlEntry=_SwL2PortCtrlEntry_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1))
...
swL2PortCtrlPortIndex=_SwL2PortCtrlPortIndex_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1,1),_SwL2PortCtrlPortIndex_Type())
...
swL2PortCtrlUnitIndex=_SwL2PortCtrlUnitIndex_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1,2),_SwL2PortCtrlUnitIndex_Type())
...
swL2PortCtrlAdminState=_SwL2PortCtrlAdminState_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1,3),_SwL2PortCtrlAdminState_Type())
...
swL2PortCtrlNwayState=_SwL2PortCtrlNwayState_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1,4),_SwL2PortCtrlNwayState_Type())
...
swL2PortCtrlFlowCtrlState=_SwL2PortCtrlFlowCtrlState_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1,5),_SwL2PortCtrlFlowCtrlState_Type())
...
swL2PortCtrlLockState=_SwL2PortCtrlLockState_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1,6),_SwL2PortCtrlLockState_Type())
...
swL2PortCtrlMACNotifyState=_SwL2PortCtrlMACNotifyState_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1,7),_SwL2PortCtrlMACNotifyState_Type())
...
swL2PortCtrlMulticastfilter=_SwL2PortCtrlMulticastfilter_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1,8),_SwL2PortCtrlMulticastfilter_Type())
...
swL2PortCtrlMdixState=_SwL2PortCtrlMdixState_Object((1,3,6,1,4,1,171,11,64,2,2,4,2,1,11),_SwL2PortCtrlMdixState_Type())
...
swL2PortInformationTable=_SwL2PortInformationTable_Object((1,3,6,1,4,1,171,11,64,2,2,4,4))
if mibBuilder.loadTexts:swL2PortInformationTable.setStatus(_A)
_SwL2PortInformationEntry_Object=MibTableRow
swL2PortInformationEntry=_SwL2PortInformationEntry_Object((1,3,6,1,4,1,171,11,64,2,2,4,4,1))
...
swL2PortInformationPortIndex=_SwL2PortInformationPortIndex_Object((1,3,6,1,4,1,171,11,64,2,2,4,4,1,1),_SwL2PortInformationPortIndex_Type())
...
swL2PortInformationMediumType=_SwL2PortInformationMediumType_Object((1,3,6,1,4,1,171,11,64,2,2,4,4,1,2),_SwL2PortInformationMediumType_Type())
...
swL2PortInformationUnitID=_SwL2PortInformationUnitID_Object((1,3,6,1,4,1,171,11,64,2,2,4,4,1,3),_SwL2PortInformationUnitID_Type())
...
swL2PortInformationType=_SwL2PortInformationType_Object((1,3,6,1,4,1,171,11,64,2,2,4,4,1,4),_SwL2PortInformationType_Type())
...
swL2PortInformationLinkStatus=_SwL2PortInformationLinkStatus_Object((1,3,6,1,4,1,171,11,64,2,2,4,4,1,5),_SwL2PortInformationLinkStatus_Type())
...
swL2PortInformationNwayStatus=_SwL2PortInformationNwayStatus_Object((1,3,6,1,4,1,171,11,64,2,2,4,4,1,6),_SwL2PortInformationNwayStatus_Type())
...
swL2PortInformationModuleType=_SwL2PortInformationModuleType_Object((1,3,6,1,4,1,171,11,64,2,2,4,4,1,7),_SwL2PortInformationModuleType_Type())
...
swL2PortInformationErrorDisabled=_SwL2PortInformationErrorDisabled_Object((1,3,6,1,4,1,171,11,64,2,2,4,4,1,8),_SwL2PortInformationErrorDisabled_Type())
...
swL2PortControlTable=_SwL2PortControlTable_Object((1,3,6,1,4,1,171,11,64,2,2,4,5))
if mibBuilder.loadTexts:swL2PortControlTable.setStatus(_A)
_SwL2PortControlEntry_Object=MibTableRow
swL2PortControlEntry=_SwL2PortControlEntry_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1))
...
swL2PortControlPortIndex=_SwL2PortControlPortIndex_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,1),_SwL2PortControlPortIndex_Type())
...
swL2PortControlMediumType=_SwL2PortControlMediumType_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,2),_SwL2PortControlMediumType_Type())
...
swL2PortControlUnitIndex=_SwL2PortControlUnitIndex_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,3),_SwL2PortControlUnitIndex_Type())
...
swL2PortControlAdminState=_SwL2PortControlAdminState_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,4),_SwL2PortControlAdminState_Type())
...
swL2PortControlNwayState=_SwL2PortControlNwayState_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,5),_SwL2PortControlNwayState_Type())
...
swL2PortControlFlowCtrlState=_SwL2PortControlFlowCtrlState_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,6),_SwL2PortControlFlowCtrlState_Type())
...
swL2PortControlLockState=_SwL2PortControlLockState_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,7),_SwL2PortControlLockState_Type())
...
swL2PortControlMACNotifyState=_SwL2PortControlMACNotifyState_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,8),_SwL2PortControlMACNotifyState_Type())
...
swL2PortControlMulticastfilter=_SwL2PortControlMulticastfilter_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,9),_SwL2PortControlMulticastfilter_Type())
...
swL2PortControlMdixState=_SwL2PortControlMdixState_Object((1,3,6,1,4,1,171,11,64,2,2,4,5,1,11),_SwL2PortControlMdixState_Type())
...
swL2LimitedMulticastMgmt=_SwL2LimitedMulticastMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,5))
_SwL2MulticastRangeTable_Object=MibTable
swL2MulticastRangeTable=_SwL2MulticastRangeTable_Object((1,3,6,1,4,1,171,11,64,2,2,5,1))
if mibBuilder.loadTexts:swL2MulticastRangeTable.setStatus(_A)
_SwL2MulticastRangeEntry_Object=MibTableRow
swL2MulticastRangeEntry=_SwL2MulticastRangeEntry_Object((1,3,6,1,4,1,171,11,64,2,2,5,1,1))
...
swL2MulticastRangeName=_SwL2MulticastRangeName_Object((1,3,6,1,4,1,171,11,64,2,2,5,1,1,1),_SwL2MulticastRangeName_Type())
...
swL2MulticastRangeFromIp=_SwL2MulticastRangeFromIp_Object((1,3,6,1,4,1,171,11,64,2,2,5,1,1,2),_SwL2MulticastRangeFromIp_Type())
...
swL2MulticastRangeToIp=_SwL2MulticastRangeToIp_Object((1,3,6,1,4,1,171,11,64,2,2,5,1,1,3),_SwL2MulticastRangeToIp_Type())
...
swL2MulticastRangeRowStatus=_SwL2MulticastRangeRowStatus_Object((1,3,6,1,4,1,171,11,64,2,2,5,1,1,4),_SwL2MulticastRangeRowStatus_Type())
...
swL2LimitedMulticastPortInfo=_SwL2LimitedMulticastPortInfo_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,5,2))
_SwL2LimitedMulticastStatusTable_Object=MibTable
swL2LimitedMulticastStatusTable=_SwL2LimitedMulticastStatusTable_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,1))
if mibBuilder.loadTexts:swL2LimitedMulticastStatusTable.setStatus(_A)
_SwL2LimitedMulticastStatusEntry_Object=MibTableRow
swL2LimitedMulticastStatusEntry=_SwL2LimitedMulticastStatusEntry_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,1,1))
...
swL2LimitedMulticastPort=_SwL2LimitedMulticastPort_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,1,1,1),_SwL2LimitedMulticastPort_Type())
...
swL2LimitedMulticastAccess=_SwL2LimitedMulticastAccess_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,1,1,2),_SwL2LimitedMulticastAccess_Type())
...
swL2LimitedMulticastState=_SwL2LimitedMulticastState_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,1,1,3),_SwL2LimitedMulticastState_Type())
...
swL2LimitedMulticastRangeTable=_SwL2LimitedMulticastRangeTable_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,2))
if mibBuilder.loadTexts:swL2LimitedMulticastRangeTable.setStatus(_A)
_SwL2LimitedMulticastRangeEntry_Object=MibTableRow
swL2LimitedMulticastRangeEntry=_SwL2LimitedMulticastRangeEntry_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,2,1))
...
swL2LimitedMulticastID=_SwL2LimitedMulticastID_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,2,1,1),_SwL2LimitedMulticastID_Type())
...
swL2LimitedMulticastRangeName=_SwL2LimitedMulticastRangeName_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,2,1,2),_SwL2LimitedMulticastRangeName_Type())
...
swL2LimitedMulticastFromIp=_SwL2LimitedMulticastFromIp_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,2,1,3),_SwL2LimitedMulticastFromIp_Type())
...
swL2LimitedMulticastToIp=_SwL2LimitedMulticastToIp_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,2,1,4),_SwL2LimitedMulticastToIp_Type())
...
swL2LimitedMulticastRowStatus=_SwL2LimitedMulticastRowStatus_Object((1,3,6,1,4,1,171,11,64,2,2,5,2,2,1,5),_SwL2LimitedMulticastRowStatus_Type())
...
swL2QOSMgmt=_SwL2QOSMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,6))
_SwL2QOSBandwidthControlTable_Object=MibTable
swL2QOSBandwidthControlTable=_SwL2QOSBandwidthControlTable_Object((1,3,6,1,4,1,171,11,64,2,2,6,1))
if mibBuilder.loadTexts:swL2QOSBandwidthControlTable.setStatus(_A)
_SwL2QOSBandwidthControlEntry_Object=MibTableRow
swL2QOSBandwidthControlEntry=_SwL2QOSBandwidthControlEntry_Object((1,3,6,1,4,1,171,11,64,2,2,6,1,1))
...
swL2QOSBandwidthPortIndex=_SwL2QOSBandwidthPortIndex_Object((1,3,6,1,4,1,171,11,64,2,2,6,1,1,1),_SwL2QOSBandwidthPortIndex_Type())
...
swL2QOSBandwidthRxRate=_SwL2QOSBandwidthRxRate_Object((1,3,6,1,4,1,171,11,64,2,2,6,1,1,2),_SwL2QOSBandwidthRxRate_Type())
...
swL2QOSBandwidthTxRate=_SwL2QOSBandwidthTxRate_Object((1,3,6,1,4,1,171,11,64,2,2,6,1,1,3),_SwL2QOSBandwidthTxRate_Type())
...
swL2QOSBandwidthRadiusRxRate=_SwL2QOSBandwidthRadiusRxRate_Object((1,3,6,1,4,1,171,11,64,2,2,6,1,1,4),_SwL2QOSBandwidthRadiusRxRate_Type())
...
swL2QOSBandwidthRadiusTxRate=_SwL2QOSBandwidthRadiusTxRate_Object((1,3,6,1,4,1,171,11,64,2,2,6,1,1,5),_SwL2QOSBandwidthRadiusTxRate_Type())
...
swL2QOSSchedulingTable=_SwL2QOSSchedulingTable_Object((1,3,6,1,4,1,171,11,64,2,2,6,2))
if mibBuilder.loadTexts:swL2QOSSchedulingTable.setStatus(_A)
_SwL2QOSSchedulingEntry_Object=MibTableRow
swL2QOSSchedulingEntry=_SwL2QOSSchedulingEntry_Object((1,3,6,1,4,1,171,11,64,2,2,6,2,1))
...
swL2QOSSchedulingClassIndex=_SwL2QOSSchedulingClassIndex_Object((1,3,6,1,4,1,171,11,64,2,2,6,2,1,1),_SwL2QOSSchedulingClassIndex_Type())
...
swL2QOSSchedulingMaxPkts=_SwL2QOSSchedulingMaxPkts_Object((1,3,6,1,4,1,171,11,64,2,2,6,2,1,2),_SwL2QOSSchedulingMaxPkts_Type())
...
swL2QOSSchedulingMaxLatency=_SwL2QOSSchedulingMaxLatency_Object((1,3,6,1,4,1,171,11,64,2,2,6,2,1,3),_SwL2QOSSchedulingMaxLatency_Type())
...
swL2QOS8021pUserPriorityTable=_SwL2QOS8021pUserPriorityTable_Object((1,3,6,1,4,1,171,11,64,2,2,6,3))
if mibBuilder.loadTexts:swL2QOS8021pUserPriorityTable.setStatus(_A)
_SwL2QOS8021pUserPriorityEntry_Object=MibTableRow
swL2QOS8021pUserPriorityEntry=_SwL2QOS8021pUserPriorityEntry_Object((1,3,6,1,4,1,171,11,64,2,2,6,3,1))
...
swL2QOS8021pUserPriorityIndex=_SwL2QOS8021pUserPriorityIndex_Object((1,3,6,1,4,1,171,11,64,2,2,6,3,1,1),_SwL2QOS8021pUserPriorityIndex_Type())
...
swL2QOS8021pUserPriorityClass=_SwL2QOS8021pUserPriorityClass_Object((1,3,6,1,4,1,171,11,64,2,2,6,3,1,2),_SwL2QOS8021pUserPriorityClass_Type())
...
swL2QOS8021pDefaultPriorityTable=_SwL2QOS8021pDefaultPriorityTable_Object((1,3,6,1,4,1,171,11,64,2,2,6,4))
...
swL2QOS8021pDefaultPriorityEntry=_SwL2QOS8021pDefaultPriorityEntry_Object((1,3,6,1,4,1,171,11,64,2,2,6,4,1))
...
swL2QOS8021pDefaultPriorityIndex=_SwL2QOS8021pDefaultPriorityIndex_Object((1,3,6,1,4,1,171,11,64,2,2,6,4,1,1),_SwL2QOS8021pDefaultPriorityIndex_Type())
...
swL2QOS8021pDefaultPriority=_SwL2QOS8021pDefaultPriority_Object((1,3,6,1,4,1,171,11,64,2,2,6,4,1,2),_SwL2QOS8021pDefaultPriority_Type())
...
swL2QOS8021pRadiusPriority=_SwL2QOS8021pRadiusPriority_Object((1,3,6,1,4,1,171,11,64,2,2,6,4,1,3),_SwL2QOS8021pRadiusPriority_Type())
...
swL2IpMacBindingMgmt=_SwL2IpMacBindingMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,7))
_SwL2IpMacBindingPortTable_Object=MibTable
swL2IpMacBindingPortTable=_SwL2IpMacBindingPortTable_Object((1,3,6,1,4,1,171,11,64,2,2,7,1))
if mibBuilder.loadTexts:swL2IpMacBindingPortTable.setStatus(_A)
_SwL2IpMacBindingPortEntry_Object=MibTableRow
swL2IpMacBindingPortEntry=_SwL2IpMacBindingPortEntry_Object((1,3,6,1,4,1,171,11,64,2,2,7,1,1))
...
swL2IpMacBindingPortIndex=_SwL2IpMacBindingPortIndex_Object((1,3,6,1,4,1,171,11,64,2,2,7,1,1,1),_SwL2IpMacBindingPortIndex_Type())
...
swL2IpMacBindingPortState=_SwL2IpMacBindingPortState_Object((1,3,6,1,4,1,171,11,64,2,2,7,1,1,2),_SwL2IpMacBindingPortState_Type())
...
swL2IpMacBindingPortAllowZeroIp=_SwL2IpMacBindingPortAllowZeroIp_Object((1,3,6,1,4,1,171,11,64,2,2,7,1,1,3),_SwL2IpMacBindingPortAllowZeroIp_Type())
...
swL2IpMacBindingPortForwardDhcpPkt=_SwL2IpMacBindingPortForwardDhcpPkt_Object((1,3,6,1,4,1,171,11,64,2,2,7,1,1,4),_SwL2IpMacBindingPortForwardDhcpPkt_Type())
...
swL2IpMacBindingPortDHCPSnoopMaxEntry=_SwL2IpMacBindingPortDHCPSnoopMaxEntry_Object((1,3,6,1,4,1,171,11,64,2,2,7,1,1,5),_SwL2IpMacBindingPortDHCPSnoopMaxEntry_Type())
...
swL2IpMacBindingPortDHCPSnoopEntryClearAction=_SwL2IpMacBindingPortDHCPSnoopEntryClearAction_Object((1,3,6,1,4,1,171,11,64,2,2,7,1,1,6),_SwL2IpMacBindingPortDHCPSnoopEntryClearAction_Type())
...
swL2IpMacBindingTable=_SwL2IpMacBindingTable_Object((1,3,6,1,4,1,171,11,64,2,2,7,2))
if mibBuilder.loadTexts:swL2IpMacBindingTable.setStatus(_A)
_SwL2IpMacBindingEntry_Object=MibTableRow
swL2IpMacBindingEntry=_SwL2IpMacBindingEntry_Object((1,3,6,1,4,1,171,11,64,2,2,7,2,1))
...
swL2IpMacBindingIpIndex=_SwL2IpMacBindingIpIndex_Object((1,3,6,1,4,1,171,11,64,2,2,7,2,1,1),_SwL2IpMacBindingIpIndex_Type())
...
swL2IpMacBindingMac=_SwL2IpMacBindingMac_Object((1,3,6,1,4,1,171,11,64,2,2,7,2,1,2),_SwL2IpMacBindingMac_Type())
...
swL2IpMacBindingStatus=_SwL2IpMacBindingStatus_Object((1,3,6,1,4,1,171,11,64,2,2,7,2,1,3),_SwL2IpMacBindingStatus_Type())
...
swL2IpMacBindingPorts=_SwL2IpMacBindingPorts_Object((1,3,6,1,4,1,171,11,64,2,2,7,2,1,4),_SwL2IpMacBindingPorts_Type())
...
swL2IpMacBindingAction=_SwL2IpMacBindingAction_Object((1,3,6,1,4,1,171,11,64,2,2,7,2,1,5),_SwL2IpMacBindingAction_Type())
...
swL2IpMacBindingMode=_SwL2IpMacBindingMode_Object((1,3,6,1,4,1,171,11,64,2,2,7,2,1,6),_SwL2IpMacBindingMode_Type())
...
swL2IpMacBindingBlockedTable=_SwL2IpMacBindingBlockedTable_Object((1,3,6,1,4,1,171,11,64,2,2,7,3))
if mibBuilder.loadTexts:swL2IpMacBindingBlockedTable.setStatus(_A)
_SwL2IpMacBindingBlockedEntry_Object=MibTableRow
swL2IpMacBindingBlockedEntry=_SwL2IpMacBindingBlockedEntry_Object((1,3,6,1,4,1,171,11,64,2,2,7,3,1))
...
swL2IpMacBindingBlockedVID=_SwL2IpMacBindingBlockedVID_Object((1,3,6,1,4,1,171,11,64,2,2,7,3,1,1),_SwL2IpMacBindingBlockedVID_Type())
...
swL2IpMacBindingBlockedMac=_SwL2IpMacBindingBlockedMac_Object((1,3,6,1,4,1,171,11,64,2,2,7,3,1,2),_SwL2IpMacBindingBlockedMac_Type())
...
swL2IpMacBindingBlockedVlanName=_SwL2IpMacBindingBlockedVlanName_Object((1,3,6,1,4,1,171,11,64,2,2,7,3,1,3),_SwL2IpMacBindingBlockedVlanName_Type())
...
swL2IpMacBindingBlockedPort=_SwL2IpMacBindingBlockedPort_Object((1,3,6,1,4,1,171,11,64,2,2,7,3,1,4),_SwL2IpMacBindingBlockedPort_Type())
...
swL2IpMacBindingBlockedType=_SwL2IpMacBindingBlockedType_Object((1,3,6,1,4,1,171,11,64,2,2,7,3,1,5),_SwL2IpMacBindingBlockedType_Type())
...
swL2IpMacBindingAllPortState=_SwL2IpMacBindingAllPortState_Object((1,3,6,1,4,1,171,11,64,2,2,7,4),_SwL2IpMacBindingAllPortState_Type())
...
swL2IpMacBindingTrapLogState=_SwL2IpMacBindingTrapLogState_Object((1,3,6,1,4,1,171,11,64,2,2,7,5),_SwL2IpMacBindingTrapLogState_Type())
...
swL2IpMacBindingACLMode=_SwL2IpMacBindingACLMode_Object((1,3,6,1,4,1,171,11,64,2,2,7,6),_SwL2IpMacBindingACLMode_Type())
...
swL2IpMacBindingDHCPSnoopState=_SwL2IpMacBindingDHCPSnoopState_Object((1,3,6,1,4,1,171,11,64,2,2,7,7),_SwL2IpMacBindingDHCPSnoopState_Type())
...
swL2IpMacBindingDHCPSnoopEntryClearAllState=_SwL2IpMacBindingDHCPSnoopEntryClearAllState_Object((1,3,6,1,4,1,171,11,64,2,2,7,8),_SwL2IpMacBindingDHCPSnoopEntryClearAllState_Type())
...
swL2IpMacBindingDHCPSnoopTable=_SwL2IpMacBindingDHCPSnoopTable_Object((1,3,6,1,4,1,171,11,64,2,2,7,9))
if mibBuilder.loadTexts:swL2IpMacBindingDHCPSnoopTable.setStatus(_A)
_SwL2IpMacBindingDHCPSnoopEntry_Object=MibTableRow
swL2IpMacBindingDHCPSnoopEntry=_SwL2IpMacBindingDHCPSnoopEntry_Object((1,3,6,1,4,1,171,11,64,2,2,7,9,1))
...
swL2IpMacBindingDHCPSnoopIpIndex=_SwL2IpMacBindingDHCPSnoopIpIndex_Object((1,3,6,1,4,1,171,11,64,2,2,7,9,1,1),_SwL2IpMacBindingDHCPSnoopIpIndex_Type())
...
swL2IpMacBindingDHCPSnoopMac=_SwL2IpMacBindingDHCPSnoopMac_Object((1,3,6,1,4,1,171,11,64,2,2,7,9,1,2),_SwL2IpMacBindingDHCPSnoopMac_Type())
...
swL2IpMacBindingDHCPSnoopLeaseTime=_SwL2IpMacBindingDHCPSnoopLeaseTime_Object((1,3,6,1,4,1,171,11,64,2,2,7,9,1,3),_SwL2IpMacBindingDHCPSnoopLeaseTime_Type())
...
swL2IpMacBindingDHCPSnoopPort=_SwL2IpMacBindingDHCPSnoopPort_Object((1,3,6,1,4,1,171,11,64,2,2,7,9,1,4),_SwL2IpMacBindingDHCPSnoopPort_Type())
...
swL2IpMacBindingDHCPSnoopStatus=_SwL2IpMacBindingDHCPSnoopStatus_Object((1,3,6,1,4,1,171,11,64,2,2,7,9,1,5),_SwL2IpMacBindingDHCPSnoopStatus_Type())
...
swL2IpMacBindingPermitIPPoolTable=_SwL2IpMacBindingPermitIPPoolTable_Object((1,3,6,1,4,1,171,11,64,2,2,7,10))
...
swL2IpMacBindingPermitIPPoolEntry=_SwL2IpMacBindingPermitIPPoolEntry_Object((1,3,6,1,4,1,171,11,64,2,2,7,10,1))
...
swL2IpMacBindingPermitIPPoolStartIP=_SwL2IpMacBindingPermitIPPoolStartIP_Object((1,3,6,1,4,1,171,11,64,2,2,7,10,1,1),_SwL2IpMacBindingPermitIPPoolStartIP_Type())
...
swL2IpMacBindingPermitIPPoolEndIP=_SwL2IpMacBindingPermitIPPoolEndIP_Object((1,3,6,1,4,1,171,11,64,2,2,7,10,1,2),_SwL2IpMacBindingPermitIPPoolEndIP_Type())
...
swL2IpMacBindingPermitIPPoolPorts=_SwL2IpMacBindingPermitIPPoolPorts_Object((1,3,6,1,4,1,171,11,64,2,2,7,10,1,3),_SwL2IpMacBindingPermitIPPoolPorts_Type())
...
swL2IpMacBindingPermitIPPoolStatus=_SwL2IpMacBindingPermitIPPoolStatus_Object((1,3,6,1,4,1,171,11,64,2,2,7,10,1,4),_SwL2IpMacBindingPermitIPPoolStatus_Type())
...
swL2TrunkMgmt=_SwL2TrunkMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,8))
...
swL2TrunkMaxSupportedEntries=_SwL2TrunkMaxSupportedEntries_Object((1,3,6,1,4,1,171,11,64,2,2,8,1),_SwL2TrunkMaxSupportedEntries_Type())
...
swL2TrunkCurrentNumEntries=_SwL2TrunkCurrentNumEntries_Object((1,3,6,1,4,1,171,11,64,2,2,8,2),_SwL2TrunkCurrentNumEntries_Type())
...
swL2TrunkCtrlTable=_SwL2TrunkCtrlTable_Object((1,3,6,1,4,1,171,11,64,2,2,8,3))
if mibBuilder.loadTexts:swL2TrunkCtrlTable.setStatus(_A)
_SwL2TrunkCtrlEntry_Object=MibTableRow
swL2TrunkCtrlEntry=_SwL2TrunkCtrlEntry_Object((1,3,6,1,4,1,171,11,64,2,2,8,3,1))
...
swL2TrunkIndex=_SwL2TrunkIndex_Object((1,3,6,1,4,1,171,11,64,2,2,8,3,1,1),_SwL2TrunkIndex_Type())
...
swL2TrunkName=_SwL2TrunkName_Object((1,3,6,1,4,1,171,11,64,2,2,8,3,1,2),_SwL2TrunkName_Type())
...
swL2TrunkMasterPort=_SwL2TrunkMasterPort_Object((1,3,6,1,4,1,171,11,64,2,2,8,3,1,3),_SwL2TrunkMasterPort_Type())
...
swL2TrunkMember=_SwL2TrunkMember_Object((1,3,6,1,4,1,171,11,64,2,2,8,3,1,4),_SwL2TrunkMember_Type())
...
swL2TrunkFloodingPort=_SwL2TrunkFloodingPort_Object((1,3,6,1,4,1,171,11,64,2,2,8,3,1,5),_SwL2TrunkFloodingPort_Type())
...
swL2TrunkType=_SwL2TrunkType_Object((1,3,6,1,4,1,171,11,64,2,2,8,3,1,6),_SwL2TrunkType_Type())
...
swL2TrunkState=_SwL2TrunkState_Object((1,3,6,1,4,1,171,11,64,2,2,8,3,1,7),_SwL2TrunkState_Type())
...
swL2TrunkAlgorithm=_SwL2TrunkAlgorithm_Object((1,3,6,1,4,1,171,11,64,2,2,8,4),_SwL2TrunkAlgorithm_Type())
...
swL2MirrorMgmt=_SwL2MirrorMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,9))
...
swL2MirrorLogicTargetPort=_SwL2MirrorLogicTargetPort_Object((1,3,6,1,4,1,171,11,64,2,2,9,1),_SwL2MirrorLogicTargetPort_Type())
...
swL2MirrorPortSourceIngress=_SwL2MirrorPortSourceIngress_Object((1,3,6,1,4,1,171,11,64,2,2,9,2),_SwL2MirrorPortSourceIngress_Type())
...
swL2MirrorPortSourceEgress=_SwL2MirrorPortSourceEgress_Object((1,3,6,1,4,1,171,11,64,2,2,9,3),_SwL2MirrorPortSourceEgress_Type())
...
swL2MirrorPortState=_SwL2MirrorPortState_Object((1,3,6,1,4,1,171,11,64,2,2,9,4),_SwL2MirrorPortState_Type())
...
swL2IGMPMgmt=_SwL2IGMPMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,10))
...
swL2IGMPMaxSupportedVlans=_SwL2IGMPMaxSupportedVlans_Object((1,3,6,1,4,1,171,11,64,2,2,10,1),_SwL2IGMPMaxSupportedVlans_Type())
...
swL2IGMPCtrlTable=_SwL2IGMPCtrlTable_Object((1,3,6,1,4,1,171,11,64,2,2,10,3))
if mibBuilder.loadTexts:swL2IGMPCtrlTable.setStatus(_A)
_SwL2IGMPCtrlEntry_Object=MibTableRow
swL2IGMPCtrlEntry=_SwL2IGMPCtrlEntry_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1))
...
swL2IGMPCtrlVid=_SwL2IGMPCtrlVid_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,1),_SwL2IGMPCtrlVid_Type())
...
swL2IGMPQueryInterval=_SwL2IGMPQueryInterval_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,2),_SwL2IGMPQueryInterval_Type())
...
swL2IGMPMaxResponseTime=_SwL2IGMPMaxResponseTime_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,3),_SwL2IGMPMaxResponseTime_Type())
...
swL2IGMPRobustness=_SwL2IGMPRobustness_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,4),_SwL2IGMPRobustness_Type())
...
swL2IGMPLastMemberQueryInterval=_SwL2IGMPLastMemberQueryInterval_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,5),_SwL2IGMPLastMemberQueryInterval_Type())
...
swL2IGMPHostTimeout=_SwL2IGMPHostTimeout_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,6),_SwL2IGMPHostTimeout_Type())
...
swL2IGMPRouteTimeout=_SwL2IGMPRouteTimeout_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,7),_SwL2IGMPRouteTimeout_Type())
...
swL2IGMPLeaveTimer=_SwL2IGMPLeaveTimer_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,8),_SwL2IGMPLeaveTimer_Type())
...
swL2IGMPQueryState=_SwL2IGMPQueryState_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,9),_SwL2IGMPQueryState_Type())
...
swL2IGMPCurrentState=_SwL2IGMPCurrentState_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,10),_SwL2IGMPCurrentState_Type())
...
swL2IGMPCtrlState=_SwL2IGMPCtrlState_Object((1,3,6,1,4,1,171,11,64,2,2,10,3,1,11),_SwL2IGMPCtrlState_Type())
...
swL2IGMPQueryInfoTable=_SwL2IGMPQueryInfoTable_Object((1,3,6,1,4,1,171,11,64,2,2,10,4))
if mibBuilder.loadTexts:swL2IGMPQueryInfoTable.setStatus(_A)
_SwL2IGMPQueryInfoEntry_Object=MibTableRow
swL2IGMPQueryInfoEntry=_SwL2IGMPQueryInfoEntry_Object((1,3,6,1,4,1,171,11,64,2,2,10,4,1))
...
swL2IGMPInfoVid=_SwL2IGMPInfoVid_Object((1,3,6,1,4,1,171,11,64,2,2,10,4,1,1),_SwL2IGMPInfoVid_Type())
...
swL2IGMPInfoQueryCount=_SwL2IGMPInfoQueryCount_Object((1,3,6,1,4,1,171,11,64,2,2,10,4,1,2),_SwL2IGMPInfoQueryCount_Type())
...
swL2IGMPInfoTxQueryCount=_SwL2IGMPInfoTxQueryCount_Object((1,3,6,1,4,1,171,11,64,2,2,10,4,1,3),_SwL2IGMPInfoTxQueryCount_Type())
...
swL2IGMPInfoTable=_SwL2IGMPInfoTable_Object((1,3,6,1,4,1,171,11,64,2,2,10,5))
if mibBuilder.loadTexts:swL2IGMPInfoTable.setStatus(_A)
_SwL2IGMPInfoEntry_Object=MibTableRow
swL2IGMPInfoEntry=_SwL2IGMPInfoEntry_Object((1,3,6,1,4,1,171,11,64,2,2,10,5,1))
...
swL2IGMPVid=_SwL2IGMPVid_Object((1,3,6,1,4,1,171,11,64,2,2,10,5,1,1),_SwL2IGMPVid_Type())
...
swL2IGMPGroupIpAddr=_SwL2IGMPGroupIpAddr_Object((1,3,6,1,4,1,171,11,64,2,2,10,5,1,2),_SwL2IGMPGroupIpAddr_Type())
...
swL2IGMPMacAddr=_SwL2IGMPMacAddr_Object((1,3,6,1,4,1,171,11,64,2,2,10,5,1,3),_SwL2IGMPMacAddr_Type())
...
swL2IGMPPortMap=_SwL2IGMPPortMap_Object((1,3,6,1,4,1,171,11,64,2,2,10,5,1,4),_SwL2IGMPPortMap_Type())
...
swL2IGMPIpGroupReportCount=_SwL2IGMPIpGroupReportCount_Object((1,3,6,1,4,1,171,11,64,2,2,10,5,1,5),_SwL2IGMPIpGroupReportCount_Type())
...
swL2IGMPMulticastVlanTable=_SwL2IGMPMulticastVlanTable_Object((1,3,6,1,4,1,171,11,64,2,2,10,6))
if mibBuilder.loadTexts:swL2IGMPMulticastVlanTable.setStatus(_A)
_SwL2IGMPMulticastVlanEntry_Object=MibTableRow
swL2IGMPMulticastVlanEntry=_SwL2IGMPMulticastVlanEntry_Object((1,3,6,1,4,1,171,11,64,2,2,10,6,1))
...
swL2IGMPMulticastVlanid=_SwL2IGMPMulticastVlanid_Object((1,3,6,1,4,1,171,11,64,2,2,10,6,1,1),_SwL2IGMPMulticastVlanid_Type())
...
swL2IGMPMulticastVlanName=_SwL2IGMPMulticastVlanName_Object((1,3,6,1,4,1,171,11,64,2,2,10,6,1,2),_SwL2IGMPMulticastVlanName_Type())
...
swL2IGMPMulticastVlanSourcePort=_SwL2IGMPMulticastVlanSourcePort_Object((1,3,6,1,4,1,171,11,64,2,2,10,6,1,3),_SwL2IGMPMulticastVlanSourcePort_Type())
...
swL2IGMPMulticastVlanMemberPort=_SwL2IGMPMulticastVlanMemberPort_Object((1,3,6,1,4,1,171,11,64,2,2,10,6,1,4),_SwL2IGMPMulticastVlanMemberPort_Type())
...
swL2IGMPMulticastVlanRowStatus=_SwL2IGMPMulticastVlanRowStatus_Object((1,3,6,1,4,1,171,11,64,2,2,10,6,1,5),_SwL2IGMPMulticastVlanRowStatus_Type())
...
swL2IGMPMulticastVlanReplaceSourceIP=_SwL2IGMPMulticastVlanReplaceSourceIP_Object((1,3,6,1,4,1,171,11,64,2,2,10,6,1,6),_SwL2IGMPMulticastVlanReplaceSourceIP_Type())
...
swL2IGMPRouterPortTable=_SwL2IGMPRouterPortTable_Object((1,3,6,1,4,1,171,11,64,2,2,10,7))
if mibBuilder.loadTexts:swL2IGMPRouterPortTable.setStatus(_A)
_SwL2IGMPRouterPortEntry_Object=MibTableRow
swL2IGMPRouterPortEntry=_SwL2IGMPRouterPortEntry_Object((1,3,6,1,4,1,171,11,64,2,2,10,7,1))
...
swL2IGMPRouterPortVlanid=_SwL2IGMPRouterPortVlanid_Object((1,3,6,1,4,1,171,11,64,2,2,10,7,1,1),_SwL2IGMPRouterPortVlanid_Type())
...
swL2IGMPRouterPortVlanName=_SwL2IGMPRouterPortVlanName_Object((1,3,6,1,4,1,171,11,64,2,2,10,7,1,2),_SwL2IGMPRouterPortVlanName_Type())
...
swL2IGMPRouterPortStaticPortList=_SwL2IGMPRouterPortStaticPortList_Object((1,3,6,1,4,1,171,11,64,2,2,10,7,1,3),_SwL2IGMPRouterPortStaticPortList_Type())
...
swL2IGMPRouterPortDynamicPortList=_SwL2IGMPRouterPortDynamicPortList_Object((1,3,6,1,4,1,171,11,64,2,2,10,7,1,4),_SwL2IGMPRouterPortDynamicPortList_Type())
...
swL2IGMPRouterPortForbiddenPortList=_SwL2IGMPRouterPortForbiddenPortList_Object((1,3,6,1,4,1,171,11,64,2,2,10,7,1,5),_SwL2IGMPRouterPortForbiddenPortList_Type())
...
swL2DhcpRelayMgmt=_SwL2DhcpRelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,11))
...
swL2DhcpRelayState=_SwL2DhcpRelayState_Object((1,3,6,1,4,1,171,11,64,2,2,11,1),_SwL2DhcpRelayState_Type())
...
swL2DhcpRelayHopCount=_SwL2DhcpRelayHopCount_Object((1,3,6,1,4,1,171,11,64,2,2,11,2),_SwL2DhcpRelayHopCount_Type())
...
swL2DhcpRelayTimeThreshold=_SwL2DhcpRelayTimeThreshold_Object((1,3,6,1,4,1,171,11,64,2,2,11,3),_SwL2DhcpRelayTimeThreshold_Type())
...
swL2DhcpRelayOption82State=_SwL2DhcpRelayOption82State_Object((1,3,6,1,4,1,171,11,64,2,2,11,4),_SwL2DhcpRelayOption82State_Type())
...
swL2DhcpRelayOption82Check=_SwL2DhcpRelayOption82Check_Object((1,3,6,1,4,1,171,11,64,2,2,11,5),_SwL2DhcpRelayOption82Check_Type())
...
swL2DhcpRelayOption82Policy=_SwL2DhcpRelayOption82Policy_Object((1,3,6,1,4,1,171,11,64,2,2,11,6),_SwL2DhcpRelayOption82Policy_Type())
...
swL2DhcpRelayCtrlTable=_SwL2DhcpRelayCtrlTable_Object((1,3,6,1,4,1,171,11,64,2,2,11,7))
if mibBuilder.loadTexts:swL2DhcpRelayCtrlTable.setStatus(_I)
_SwL2DhcpRelayCtrlEntry_Object=MibTableRow
swL2DhcpRelayCtrlEntry=_SwL2DhcpRelayCtrlEntry_Object((1,3,6,1,4,1,171,11,64,2,2,11,7,1))
...
swL2DhcpRelayCtrlInterfaceName=_SwL2DhcpRelayCtrlInterfaceName_Object((1,3,6,1,4,1,171,11,64,2,2,11,7,1,1),_SwL2DhcpRelayCtrlInterfaceName_Type())
...
swL2DhcpRelayCtrlServer=_SwL2DhcpRelayCtrlServer_Object((1,3,6,1,4,1,171,11,64,2,2,11,7,1,2),_SwL2DhcpRelayCtrlServer_Type())
...
swL2DhcpRelayCtrlState=_SwL2DhcpRelayCtrlState_Object((1,3,6,1,4,1,171,11,64,2,2,11,7,1,3),_SwL2DhcpRelayCtrlState_Type())
...
swL2LoopDetectMgmt=_SwL2LoopDetectMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,12))
_SwL2LoopDetectCtrl_ObjectIdentity=ObjectIdentity
swL2LoopDetectCtrl=_SwL2LoopDetectCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,12,1))
...
swL2LoopDetectAdminState=_SwL2LoopDetectAdminState_Object((1,3,6,1,4,1,171,11,64,2,2,12,1,1),_SwL2LoopDetectAdminState_Type())
...
swL2LoopDetectInterval=_SwL2LoopDetectInterval_Object((1,3,6,1,4,1,171,11,64,2,2,12,1,2),_SwL2LoopDetectInterval_Type())
...
swL2LoopDetectRecoverTime=_SwL2LoopDetectRecoverTime_Object((1,3,6,1,4,1,171,11,64,2,2,12,1,3),_SwL2LoopDetectRecoverTime_Type())
...
swL2LoopDetectMode=_SwL2LoopDetectMode_Object((1,3,6,1,4,1,171,11,64,2,2,12,1,4),_SwL2LoopDetectMode_Type())
...
swL2LoopDetectPortMgmt=_SwL2LoopDetectPortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,12,2))
_SwL2LoopDetectPortTable_Object=MibTable
swL2LoopDetectPortTable=_SwL2LoopDetectPortTable_Object((1,3,6,1,4,1,171,11,64,2,2,12,2,1))
if mibBuilder.loadTexts:swL2LoopDetectPortTable.setStatus(_A)
_SwL2LoopDetectPortEntry_Object=MibTableRow
swL2LoopDetectPortEntry=_SwL2LoopDetectPortEntry_Object((1,3,6,1,4,1,171,11,64,2,2,12,2,1,1))
...
swL2LoopDetectPortIndex=_SwL2LoopDetectPortIndex_Object((1,3,6,1,4,1,171,11,64,2,2,12,2,1,1,1),_SwL2LoopDetectPortIndex_Type())
...
swL2LoopDetectPortState=_SwL2LoopDetectPortState_Object((1,3,6,1,4,1,171,11,64,2,2,12,2,1,1,2),_SwL2LoopDetectPortState_Type())
...
swL2LoopDetectPortLoopVLAN=_SwL2LoopDetectPortLoopVLAN_Object((1,3,6,1,4,1,171,11,64,2,2,12,2,1,1,3),_SwL2LoopDetectPortLoopVLAN_Type())
...
swL2LoopDetectPortLoopStatus=_SwL2LoopDetectPortLoopStatus_Object((1,3,6,1,4,1,171,11,64,2,2,12,2,1,1,4),_SwL2LoopDetectPortLoopStatus_Type())
...
swL2TrafficSegMgmt=_SwL2TrafficSegMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,13))
_SwL2TrafficSegTable_Object=MibTable
swL2TrafficSegTable=_SwL2TrafficSegTable_Object((1,3,6,1,4,1,171,11,64,2,2,13,1))
if mibBuilder.loadTexts:swL2TrafficSegTable.setStatus(_A)
_SwL2TrafficSegEntry_Object=MibTableRow
swL2TrafficSegEntry=_SwL2TrafficSegEntry_Object((1,3,6,1,4,1,171,11,64,2,2,13,1,1))
...
swL2TrafficSegPort=_SwL2TrafficSegPort_Object((1,3,6,1,4,1,171,11,64,2,2,13,1,1,1),_SwL2TrafficSegPort_Type())
...
swL2TrafficSegForwardPorts=_SwL2TrafficSegForwardPorts_Object((1,3,6,1,4,1,171,11,64,2,2,13,1,1,2),_SwL2TrafficSegForwardPorts_Type())
...
swL2PortSecurityMgmt=_SwL2PortSecurityMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,14))
_SwL2PortSecurityControlTable_Object=MibTable
swL2PortSecurityControlTable=_SwL2PortSecurityControlTable_Object((1,3,6,1,4,1,171,11,64,2,2,14,1))
if mibBuilder.loadTexts:swL2PortSecurityControlTable.setStatus(_A)
_SwL2PortSecurityControlEntry_Object=MibTableRow
swL2PortSecurityControlEntry=_SwL2PortSecurityControlEntry_Object((1,3,6,1,4,1,171,11,64,2,2,14,1,1))
...
swL2PortSecurityPortIndex=_SwL2PortSecurityPortIndex_Object((1,3,6,1,4,1,171,11,64,2,2,14,1,1,1),_SwL2PortSecurityPortIndex_Type())
...
swL2PortSecurityMaxLernAddr=_SwL2PortSecurityMaxLernAddr_Object((1,3,6,1,4,1,171,11,64,2,2,14,1,1,2),_SwL2PortSecurityMaxLernAddr_Type())
...
swL2PortSecurityMode=_SwL2PortSecurityMode_Object((1,3,6,1,4,1,171,11,64,2,2,14,1,1,3),_SwL2PortSecurityMode_Type())
...
swL2PortSecurityAdmState=_SwL2PortSecurityAdmState_Object((1,3,6,1,4,1,171,11,64,2,2,14,1,1,4),_SwL2PortSecurityAdmState_Type())
...
swL2PortSecurityTrapLogState=_SwL2PortSecurityTrapLogState_Object((1,3,6,1,4,1,171,11,64,2,2,14,2),_SwL2PortSecurityTrapLogState_Type())
...
swL2MgmtMIBTraps=_SwL2MgmtMIBTraps_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,15))
_SwL2MgmtMIBTrapPrefix_ObjectIdentity=ObjectIdentity
swL2MgmtMIBTrapPrefix=_SwL2MgmtMIBTrapPrefix_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,15,0))
_Swl2NotificationBidings_ObjectIdentity=ObjectIdentity
swl2NotificationBidings=_Swl2NotificationBidings_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,15,1))
...
swL2macNotifyInfo=_SwL2macNotifyInfo_Object((1,3,6,1,4,1,171,11,64,2,2,15,1,1),_SwL2macNotifyInfo_Type())
...
swl2NotifyPortSecurity=_Swl2NotifyPortSecurity_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,15,2))
_SwL2PortSecurityViolationMac_Type=MacAddress
_SwL2PortSecurityViolationMac_Object=MibScalar
swL2PortSecurityViolationMac=_SwL2PortSecurityViolationMac_Object((1,3,6,1,4,1,171,11,64,2,2,15,2,1),_SwL2PortSecurityViolationMac_Type())
...
swl2NotifyIpMacBinding=_Swl2NotifyIpMacBinding_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,15,3))
_SwL2IpMacBindingViolationIP_Type=MacAddress
_SwL2IpMacBindingViolationIP_Object=MibScalar
swL2IpMacBindingViolationIP=_SwL2IpMacBindingViolationIP_Object((1,3,6,1,4,1,171,11,64,2,2,15,3,1),_SwL2IpMacBindingViolationIP_Type())
...
swL2IpMacBindingViolationMac=_SwL2IpMacBindingViolationMac_Object((1,3,6,1,4,1,171,11,64,2,2,15,3,2),_SwL2IpMacBindingViolationMac_Type())
...
swl2NotifyLoopDetect=_Swl2NotifyLoopDetect_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,15,4))
_SwL2VlanLoopDetectVID_Type=Integer32
_SwL2VlanLoopDetectVID_Object=MibScalar
swL2VlanLoopDetectVID=_SwL2VlanLoopDetectVID_Object((1,3,6,1,4,1,171,11,64,2,2,15,4,1),_SwL2VlanLoopDetectVID_Type())
...
swL2DhcpLocalRelayMgmt=_SwL2DhcpLocalRelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,64,2,2,24))
...
swL2DhcpLocalRelayState=_SwL2DhcpLocalRelayState_Object((1,3,6,1,4,1,171,11,64,2,2,24,1),_SwL2DhcpLocalRelayState_Type())
...
swL2DhcpLocalRelayVLANTable=_SwL2DhcpLocalRelayVLANTable_Object((1,3,6,1,4,1,171,11,64,2,2,24,2))
if mibBuilder.loadTexts:swL2DhcpLocalRelayVLANTable.setStatus(_A)
_SwL2DhcpLocalRelayVLANEntry_Object=MibTableRow
swL2DhcpLocalRelayVLANEntry=_SwL2DhcpLocalRelayVLANEntry_Object((1,3,6,1,4,1,171,11,64,2,2,24,2,1))
...
swL2DhcpLocalRelayVLANID=_SwL2DhcpLocalRelayVLANID_Object((1,3,6,1,4,1,171,11,64,2,2,24,2,1,1),_SwL2DhcpLocalRelayVLANID_Type())
