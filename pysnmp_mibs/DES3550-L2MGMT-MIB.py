...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/d-link/DES3550-L2MGMT-MIB
...
if mibBuilder.loadTexts: swL2MgmtMIB.setLastUpdated('0805190000Z')
...
swL2PortInfoErrorDisabled = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 64, 2, 2, 4, 1, 1, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3))).clone(namedValues=NamedValues(("none", 0), ("storm", 1), ("lbd", 2), ("unknow", 3)))).setMaxAccess("readonly")
...
swL2PortInformationErrorDisabled = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 64, 2, 2, 4, 4, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3))).clone(namedValues=NamedValues(("none", 0), ("storm", 1), ("lbd", 2), ("unknow", 3)))).setMaxAccess("readonly")
...
swL2PortSecurityViolationTrap = NotificationType((1, 3, 6, 1, 4, 1, 171, 11, 64, 2, 2, 15, 2, 2)).setObjects(("DES3550-L2MGMT-MIB", "swL2PortSecurityPortIndex"), ("DES3550-L2MGMT-MIB", "swL2PortSecurityViolationMac"))
...
swL2IpMacBindingViolationTrap = NotificationType((1, 3, 6, 1, 4, 1, 171, 11, 64, 2, 2, 15, 3, 3)).setObjects(("DES3550-L2MGMT-MIB", "swL2IpMacBindingPortIndex"), ("DES3550-L2MGMT-MIB", "swL2IpMacBindingViolationIP"), ("DES3550-L2MGMT-MIB", "swL2IpMacBindingViolationMac"))
...
swL2PortLoopOccurred = NotificationType((1, 3, 6, 1, 4, 1, 171, 11, 64, 2, 2, 15, 4, 2)).setObjects(("DES3550-L2MGMT-MIB", "swL2LoopDetectPortIndex"))
if mibBuilder.loadTexts: swL2PortLoopOccurred.setStatus('current')
swL2PortLoopRestart = NotificationType((1, 3, 6, 1, 4, 1, 171, 11, 64, 2, 2, 15, 4, 3)).setObjects(("DES3550-L2MGMT-MIB", "swL2LoopDetectPortIndex"))
if mibBuilder.loadTexts: swL2PortLoopRestart.setStatus('current')
swL2VlanLoopOccurred = NotificationType((1, 3, 6, 1, 4, 1, 171, 11, 64, 2, 2, 15, 4, 4)).setObjects(("DES3550-L2MGMT-MIB", "swL2LoopDetectPortIndex"), ("DES3550-L2MGMT-MIB", "swL2VlanLoopDetectVID"))
if mibBuilder.loadTexts: swL2VlanLoopOccurred.setStatus('current')
swL2VlanLoopRestart = NotificationType((1, 3, 6, 1, 4, 1, 171, 11, 64, 2, 2, 15, 4, 5)).setObjects(("DES3550-L2MGMT-MIB", "swL2LoopDetectPortIndex"), ("DES3550-L2MGMT-MIB", "swL2VlanLoopDetectVID"))
if mibBuilder.loadTexts: swL2VlanLoopRestart.setStatus('current')
mibBuilder.exportSymbols("DES3550-L2MGMT-MIB", swL2DhcpLocalRelayMgmt=swL2DhcpLocalRelayMgmt, swL2LoopDetectPortTable=swL2LoopDetectPortTable, swL2DevInfo=swL2DevInfo, swL2LimitedMulticastFromIp=swL2LimitedMulticastFromIp, swL2IGMPRouterPortEntry=swL2IGMPRouterPortEntry, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swl2NotificationBidings=swl2NotificationBidings, swL2PortLoopOccurred=swL2PortLoopOccurred, swL2IGMPRouterPortForbiddenPortList=swL2IGMPRouterPortForbiddenPortList, swL2LoopDetectAdminState=swL2LoopDetectAdminState, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry, swL2IpMacBindingDHCPSnoopPort=swL2IpMacBindingDHCPSnoopPort, swL2IpMacBindingBlockedPort=swL2IpMacBindingBlockedPort, swL2VlanMgmt=swL2VlanMgmt, swL2LoopDetectInterval=swL2LoopDetectInterval, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2TrunkName=swL2TrunkName, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swDevInfoPowerTable=swDevInfoPowerTable, swL2IpMacBindingStatus=swL2IpMacBindingStatus, swL2DhcpRelayOption82Policy=swL2DhcpRelayOption82Policy, swL2IGMPMacAddr=swL2IGMPMacAddr, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2DhcpRelayCtrlInterfaceName=swL2DhcpRelayCtrlInterfaceName, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swL2TrafficSegPort=swL2TrafficSegPort, swL2DhcpRelayOption82State=swL2DhcpRelayOption82State, swL2TrafficSegTable=swL2TrafficSegTable, swL2MulticastRangeToIp=swL2MulticastRangeToIp, swL2DhcpRelayCtrlServer=swL2DhcpRelayCtrlServer, swL2DhcpRelayMgmt=swL2DhcpRelayMgmt, swL2DhcpLocalRelayVLANEntry=swL2DhcpLocalRelayVLANEntry, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2PortCtrlMdixState=swL2PortCtrlMdixState, swL2IpMacBindingPorts=swL2IpMacBindingPorts, swL2IpMacBindingBlockedVID=swL2IpMacBindingBlockedVID, swL2MgmtMIBTrapPrefix=swL2MgmtMIBTrapPrefix, swL2IpMacBindingPortState=swL2IpMacBindingPortState, swL2IpMacBindingDHCPSnoopStatus=swL2IpMacBindingDHCPSnoopStatus, swL2TrunkState=swL2TrunkState, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2LimitedMulticastState=swL2LimitedMulticastState, swL2IpMacBindingAllPortState=swL2IpMacBindingAllPortState, swL2IpMacBindingAction=swL2IpMacBindingAction, swL2PortInformationMediumType=swL2PortInformationMediumType, swL2IpMacBindingACLMode=swL2IpMacBindingACLMode, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2QOSSchedulingMaxLatency=swL2QOSSchedulingMaxLatency, swl2NotifyLoopDetect=swl2NotifyLoopDetect, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2VlanLoopDetectVID=swL2VlanLoopDetectVID, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2IpMacBindingPortDHCPSnoopEntryClearAction=swL2IpMacBindingPortDHCPSnoopEntryClearAction, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2PortInformationPortIndex=swL2PortInformationPortIndex, swL2IGMPQueryInterval=swL2IGMPQueryInterval, swl2NotifyPortSecurity=swl2NotifyPortSecurity, swL2LimitedMulticastRangeName=swL2LimitedMulticastRangeName, swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swL2IpMacBindingDHCPSnoopState=swL2IpMacBindingDHCPSnoopState, swL2MulticastRangeName=swL2MulticastRangeName, swL2PortControlMACNotifyState=swL2PortControlMACNotifyState, swL2IGMPCtrlVid=swL2IGMPCtrlVid, swL2DhcpRelayHopCount=swL2DhcpRelayHopCount, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2DhcpLocalRelayVLANState=swL2DhcpLocalRelayVLANState, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2LimitedMulticastRowStatus=swL2LimitedMulticastRowStatus, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swDevInfoPowerEntry=swDevInfoPowerEntry, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2IpMacBindingViolationMac=swL2IpMacBindingViolationMac, swDevInfoModuleType=swDevInfoModuleType, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2IGMPMulticastVlanReplaceSourceIP=swL2IGMPMulticastVlanReplaceSourceIP, swL2LoopDetectPortEntry=swL2LoopDetectPortEntry, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2IpMacBindingBlockedEntry=swL2IpMacBindingBlockedEntry, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2LimitedMulticastRangeEntry=swL2LimitedMulticastRangeEntry, VlanId=VlanId, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2TrunkMember=swL2TrunkMember, swL2DhcpLocalRelayVLANTable=swL2DhcpLocalRelayVLANTable, swL2IpMacBindingDHCPSnoopIpIndex=swL2IpMacBindingDHCPSnoopIpIndex, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2DhcpRelayCtrlEntry=swL2DhcpRelayCtrlEntry, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2IpMacBindingMode=swL2IpMacBindingMode, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2IGMPRouterPortStaticPortList=swL2IGMPRouterPortStaticPortList, swL2MirrorPortState=swL2MirrorPortState, swL2IGMPCurrentState=swL2IGMPCurrentState, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swL2LoopDetectMgmt=swL2LoopDetectMgmt, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2IpMacBindingEntry=swL2IpMacBindingEntry, swL2IpMacBindingMac=swL2IpMacBindingMac, swL2LoopDetectMode=swL2LoopDetectMode, swL2MulticastRangeFromIp=swL2MulticastRangeFromIp, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2LoopDetectPortLoopStatus=swL2LoopDetectPortLoopStatus, swL2PortInformationUnitID=swL2PortInformationUnitID, swL2MulticastRangeTable=swL2MulticastRangeTable, swL2DhcpRelayCtrlState=swL2DhcpRelayCtrlState, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2IGMPMgmt=swL2IGMPMgmt, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2IpMacBindingDHCPSnoopEntryClearAllState=swL2IpMacBindingDHCPSnoopEntryClearAllState, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swL2DhcpLocalRelayVLANID=swL2DhcpLocalRelayVLANID, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2LoopDetectCtrl=swL2LoopDetectCtrl, swL2IpMacBindingBlockedTable=swL2IpMacBindingBlockedTable, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2PortInformationEntry=swL2PortInformationEntry, swL2IpMacBindingTrapLogState=swL2IpMacBindingTrapLogState, swL2IGMPVid=swL2IGMPVid, PYSNMP_MODULE_ID=swL2MgmtMIB, swPowerStatusChg=swPowerStatusChg, swL2DevAlarm=swL2DevAlarm, swL2IpMacBindingPermitIPPoolTable=swL2IpMacBindingPermitIPPoolTable, VlanIndex=VlanIndex, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, swPowerFailure=swPowerFailure, swL2IGMPQueryState=swL2IGMPQueryState, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swL2PortInformationLinkStatus=swL2PortInformationLinkStatus, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2IpMacBindingPermitIPPoolEndIP=swL2IpMacBindingPermitIPPoolEndIP, swL2DhcpRelayState=swL2DhcpRelayState, swL2PortInfoEntry=swL2PortInfoEntry, swL2VlanLoopRestart=swL2VlanLoopRestart, swL2macNotification=swL2macNotification, swL2PortCtrlLockState=swL2PortCtrlLockState, swL2PortControlPortIndex=swL2PortControlPortIndex, swL2PortInfoModuleType=swL2PortInfoModuleType, swL2IpMacBindingDHCPSnoopLeaseTime=swL2IpMacBindingDHCPSnoopLeaseTime, swL2LimitedMulticastAccess=swL2LimitedMulticastAccess, swL2LimitedMulticastPort=swL2LimitedMulticastPort, swl2NotifyIpMacBinding=swl2NotifyIpMacBinding, swL2PortInformationTable=swL2PortInformationTable, swL2LoopDetectPortLoopVLAN=swL2LoopDetectPortLoopVLAN, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2IpMacBindingPortForwardDhcpPkt=swL2IpMacBindingPortForwardDhcpPkt, swL2TrunkType=swL2TrunkType, swL2MgmtMIB=swL2MgmtMIB, swL2PortInformationModuleType=swL2PortInformationModuleType, swL2IGMPRouterPortVlanName=swL2IGMPRouterPortVlanName, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2DevCtrlRmonState=swL2DevCtrlRmonState, swL2LoopDetectPortIndex=swL2LoopDetectPortIndex, swL2IGMPInfoVid=swL2IGMPInfoVid, swL2PortControlTable=swL2PortControlTable, swL2porttypechgNotification=swL2porttypechgNotification, swL2DhcpRelayTimeThreshold=swL2DhcpRelayTimeThreshold, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2QOSMgmt=swL2QOSMgmt, swL2LimitedMulticastPortInfo=swL2LimitedMulticastPortInfo, swL2MirrorMgmt=swL2MirrorMgmt, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2PortControlUnitIndex=swL2PortControlUnitIndex, swL2IpMacBindingPermitIPPoolStartIP=swL2IpMacBindingPermitIPPoolStartIP, swL2IpMacBindingPermitIPPoolEntry=swL2IpMacBindingPermitIPPoolEntry, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2PortInfoType=swL2PortInfoType, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2VlanIndex=swL2VlanIndex, swL2PortMgmt=swL2PortMgmt, swL2PortControlLockState=swL2PortControlLockState, swL2IpMacBindingPortTable=swL2IpMacBindingPortTable, swL2MACNotifyState=swL2MACNotifyState, swL2PortControlAdminState=swL2PortControlAdminState, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2PortInfoTable=swL2PortInfoTable, swL2IpMacBindingMgmt=swL2IpMacBindingMgmt, swL2PortInformationNwayStatus=swL2PortInformationNwayStatus, swL2LimitedMulticastToIp=swL2LimitedMulticastToIp, swL2IpMacBindingDHCPSnoopEntry=swL2IpMacBindingDHCPSnoopEntry, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swDevInfoConsoleInUse=swDevInfoConsoleInUse, swL2IpMacBindingPortAllowZeroIp=swL2IpMacBindingPortAllowZeroIp, swL2PortControlMediumType=swL2PortControlMediumType, swL2VlanAdvertisementTable=swL2VlanAdvertisementTable, swPowerRecover=swPowerRecover, swL2TrunkMgmt=swL2TrunkMgmt, swL2IGMPPortMap=swL2IGMPPortMap, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2MulticastRangeRowStatus=swL2MulticastRangeRowStatus, swDevInfoPowerID=swDevInfoPowerID, swL2PortCtrlTable=swL2PortCtrlTable, swL2DhcpLocalRelayState=swL2DhcpLocalRelayState, swL2IpMacBindingViolationTrap=swL2IpMacBindingViolationTrap, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2IGMPRouterPortTable=swL2IGMPRouterPortTable, swL2LimitedMulticastStatusEntry=swL2LimitedMulticastStatusEntry, swL2PortCtrlMulticastfilter=swL2PortCtrlMulticastfilter, swL2PortControlMulticastfilter=swL2PortControlMulticastfilter, swL2LimitedMulticastStatusTable=swL2LimitedMulticastStatusTable, swL2macNotifyInfo=swL2macNotifyInfo, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swDevInfoPowerUnitIndex=swDevInfoPowerUnitIndex, swL2IpMacBindingIpIndex=swL2IpMacBindingIpIndex, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2LoopDetectPortState=swL2LoopDetectPortState, PortList=PortList, swL2IpMacBindingDHCPSnoopMac=swL2IpMacBindingDHCPSnoopMac, swL2DhcpRelayCtrlTable=swL2DhcpRelayCtrlTable, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2IpMacBindingPermitIPPoolPorts=swL2IpMacBindingPermitIPPoolPorts, swL2VlanName=swL2VlanName, swL2VlanLoopOccurred=swL2VlanLoopOccurred, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2VlanAdvertiseState=swL2VlanAdvertiseState, swL2LimitedMulticastID=swL2LimitedMulticastID, swL2LoopDetectPortMgmt=swL2LoopDetectPortMgmt, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2MulticastRangeEntry=swL2MulticastRangeEntry, swL2IpMacBindingBlockedType=swL2IpMacBindingBlockedType, swL2IpMacBindingDHCPSnoopTable=swL2IpMacBindingDHCPSnoopTable, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2VlanAdvertisementEntry=swL2VlanAdvertisementEntry, swDevInfoSystemUpTime=swDevInfoSystemUpTime, swL2DevCtrl=swL2DevCtrl, swL2IGMPRouterPortDynamicPortList=swL2IGMPRouterPortDynamicPortList, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, swL2PortInformationErrorDisabled=swL2PortInformationErrorDisabled, swL2IpMacBindingBlockedVlanName=swL2IpMacBindingBlockedVlanName, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate)
mibBuilder.exportSymbols("DES3550-L2MGMT-MIB", swL2IpMacBindingTable=swL2IpMacBindingTable, swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2DhcpRelayOption82Check=swL2DhcpRelayOption82Check, swL2IpMacBindingPortEntry=swL2IpMacBindingPortEntry, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swL2PortControlMdixState=swL2PortControlMdixState, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2LimitedMulticastRangeTable=swL2LimitedMulticastRangeTable, swL2IpMacBindingPortIndex=swL2IpMacBindingPortIndex, swL2PortControlFlowCtrlState=swL2PortControlFlowCtrlState, swL2IpMacBindingPortDHCPSnoopMaxEntry=swL2IpMacBindingPortDHCPSnoopMaxEntry, swL2LimitedMulticastMgmt=swL2LimitedMulticastMgmt, swL2PortControlNwayState=swL2PortControlNwayState, swL2IpMacBindingPermitIPPoolStatus=swL2IpMacBindingPermitIPPoolStatus, swDevInfoPowerStatus=swDevInfoPowerStatus, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2IGMPRobustness=swL2IGMPRobustness, swL2PortLoopRestart=swL2PortLoopRestart, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2TrunkIndex=swL2TrunkIndex, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swL2PortSecurityMode=swL2PortSecurityMode, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2PortControlEntry=swL2PortControlEntry, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2PortInfoUnitIndex=swL2PortInfoUnitIndex, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swL2LoopDetectRecoverTime=swL2LoopDetectRecoverTime, swL2IpMacBindingViolationIP=swL2IpMacBindingViolationIP, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2DevMgmt=swL2DevMgmt, swL2IpMacBindingBlockedMac=swL2IpMacBindingBlockedMac, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2PortSecurityTrapLogState=swL2PortSecurityTrapLogState, swL2PortInformationType=swL2PortInformationType, swL2IGMPRouterPortVlanid=swL2IGMPRouterPortVlanid, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState)
