...
# Notes
# -----
# ASN.1 source file://mibs/rfc/TE-MIB
...
_TeNotificationEnable_Type.__name__ = "TruthValue"
...
_TePathBandwidth_Type.__name__ = "MplsBitRate"
...
_TePathIncludeAny_Type.__name__ = "Unsigned32"
...
_TePathIncludeAll_Type.__name__ = "Unsigned32"
...
_TePathExclude_Type.__name__ = "Unsigned32"
...
teModuleReadOnlyCompliance.setObjects(
      *(("TE-MIB", "teTrafficEngineeringGroup"),
        ("TE-MIB", "teNotificationGroup"))
)
if mibBuilder.loadTexts:
...
teModuleFullCompliance.setObjects(
      *(("TE-MIB", "teTrafficEngineeringGroup"),
        ("TE-MIB", "teNotificationGroup"))
)
if mibBuilder.loadTexts:
...
teModuleServerReadOnlyCompliance.setObjects(
      *(("TE-MIB", "teTrafficEngineeringGroup"),
        ("TE-MIB", "teNotificationGroup"))
)
if mibBuilder.loadTexts:
...
teModuleServerFullCompliance.setObjects(
      *(("TE-MIB", "teTrafficEngineeringGroup"),
        ("TE-MIB", "teNotificationGroup"))
)
if mibBuilder.loadTexts:
