# SNMP MIB module (Dell-LLDP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-LLDP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:21 2025
...
rlLldpAutoAdvLocPortManAddrEntry.setIndexNames(
    (0, "Dell-LLDP-MIB", "rlLldpAutoAdvLocPortNum"),
)
if mibBuilder.loadTexts:
...
rlLldpXMedLocMediaPolicyContainerEntry.setIndexNames(
    (0, "Dell-LLDP-MIB", "rlLldpXMedLocMediaPolicyContainerIndex"),
)
if mibBuilder.loadTexts:
...
rlLldpTLVsTxOverloadingEntry.setIndexNames(
    (0, "Dell-LLDP-MIB", "rlLldpTxOverloadingPortNum"),
    (0, "Dell-LLDP-MIB", "rlLldpTxOverloadingIndex"),
)
if mibBuilder.loadTexts:
