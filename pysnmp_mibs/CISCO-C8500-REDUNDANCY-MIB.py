...
mibBuilder.exportSymbols("CISCO-C8500-REDUNDANCY-MIB", ccrSwitchStatusChange=ccrSwitchStatusChange, ccrMIBNotifications=ccrMIBNotifications, ciscoC8500RedundancyMIBObjects=ciscoC8500RedundancyMIBObjects, ccrCpuSwitchoverTime=ccrCpuSwitchoverTime, RedundancyStatus=RedundancyStatus, ccrCpuStatus=ccrCpuStatus, ciscoC8500RedundancyMIBConformance=ciscoC8500RedundancyMIBConformance, ccrVcCounterSyncFreq=ccrVcCounterSyncFreq, PYSNMP_MODULE_ID=ciscoC8500RedundancyMIB, ciscoC8500RedundancyMIBNotificationPrefix=ciscoC8500RedundancyMIBNotificationPrefix, ccrForceCounterSync=ccrForceCounterSync, ccrCpuMode=ccrCpuMode, ccrCpuEntry=ccrCpuEntry, ccrSwitchMode=ccrSwitchMode, ccrSwitchBw=ccrSwitchBw, ccrCpuMibGroup=ccrCpuMibGroup, ccrCpuStandbyEnableMode=ccrCpuStandbyEnableMode, ccrSwitchSlotIndex=ccrSwitchSlotIndex, ciscoC8500RedundancyMIBComplianceRev1=ciscoC8500RedundancyMIBComplianceRev1, ccrDesiredSwitchBw=ccrDesiredSwitchBw, ccrCpuMibGroup1=ccrCpuMibGroup1, ciscoC8500RedundancyMIBCompliance=ciscoC8500RedundancyMIBCompliance, ciscoC8500RedundancyMIBGroups=ciscoC8500RedundancyMIBGroups, RedundancySlotIndex=RedundancySlotIndex, ccrCpu=ccrCpu, ccrCpuStatusChange=ccrCpuStatusChange, ccrSwitchEntry=ccrSwitchEntry, ccrSwitchLastSwitchoverTime=ccrSwitchLastSwitchoverTime, ccrSyncConfigOnSet=ccrSyncConfigOnSet, ccrSwitchTable=ccrSwitchTable, ccrSwitchStatus=ccrSwitchStatus, ccrCpuTable=ccrCpuTable, ciscoC8500RedundancyMIBCompliances=ciscoC8500RedundancyMIBCompliances, ccrCpuSlotIndex=ccrCpuSlotIndex, RedundancyMode=RedundancyMode, ccrNotificationsGroup=ccrNotificationsGroup, ccrSwitchModeChange=ccrSwitchModeChange, ccrSigCounterSyncEnable=ccrSigCounterSyncEnable, ccrSwitchMibGroup=ccrSwitchMibGroup, ciscoC8500RedundancyMIB=ciscoC8500RedundancyMIB, ccrSwitch=ccrSwitch, ccrSwitchLastSwitchoverReason=ccrSwitchLastSwitchoverReason, ccrIfCounterSyncFreq=ccrIfCounterSyncFreq)
