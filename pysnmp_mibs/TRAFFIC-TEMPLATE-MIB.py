...
# Notes
# -----
# ASN.1 source file://mibs/hp/TRAFFIC-TEMPLATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:32:20 2025
...
hpicfTrafficTemplateCompliance.setObjects(
      *(("TRAFFIC-TEMPLATE-MIB", "hpicfTrafficTemplateScalarGroup"),
        ("TRAFFIC-TEMPLATE-MIB", "hpicfTrafficTemplateGroup"),
        ("TRAFFIC-TEMPLATE-MIB", "hpicfTrafficGroup"))
)
if mibBuilder.loadTexts:
...
hpicfTrafficTemplateCompliance2.setObjects(
      *(("TRAFFIC-TEMPLATE-MIB", "hpicfTrafficTemplateScalarGroup"),
        ("TRAFFIC-TEMPLATE-MIB", "hpicfTrafficTemplateGroup2"),
        ("TRAFFIC-TEMPLATE-MIB", "hpicfTrafficGroup2"))
)
if mibBuilder.loadTexts:
