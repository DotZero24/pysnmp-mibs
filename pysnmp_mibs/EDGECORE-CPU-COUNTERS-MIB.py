# SNMP MIB module (EDGECORE-CPU-COUNTERS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/edgecore/EDGECORE-CPU-COUNTERS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:53:04 2025
...
rlCpuCountersTarget = _RlCpuCountersTarget_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 1, 1, 1),
...
rlCpuCountersTxBC = _RlCpuCountersTxBC_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 1, 1, 2),
...
rlCpuCountersTxMC = _RlCpuCountersTxMC_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 1, 1, 3),
...
rlCpuCountersTxUC = _RlCpuCountersTxUC_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 1, 1, 4),
...
rlCpuCountersTxOctets = _RlCpuCountersTxOctets_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 1, 1, 5),
...
rlCpuCountersRxBC = _RlCpuCountersRxBC_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 1, 1, 6),
...
rlCpuCountersRxMC = _RlCpuCountersRxMC_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 1, 1, 7),
...
rlCpuCountersRxUC = _RlCpuCountersRxUC_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 1, 1, 8),
...
rlCpuCountersRxOctets = _RlCpuCountersRxOctets_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 1, 1, 9),
...
rlCpuCountersReset = _RlCpuCountersReset_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 2),
...
rlCpuCountersEnabled = _RlCpuCountersEnabled_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 124, 3),
