...
rlCpuCounters=ModuleIdentity((1,3,6,1,4,1,259,10,1,14,89,124))
if mibBuilder.loadTexts:rlCpuCounters.setRevisions(('2007-05-15 00:00',))
_RlCpuCountersTable_Object=MibTable
rlCpuCountersTable=_RlCpuCountersTable_Object((1,3,6,1,4,1,259,10,1,14,89,124,1))
if mibBuilder.loadTexts:rlCpuCountersTable.setStatus(_A)
_RlCpuCountersEntry_Object=MibTableRow
rlCpuCountersEntry=_RlCpuCountersEntry_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1))
...
rlCpuCountersTarget=_RlCpuCountersTarget_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1,1),_RlCpuCountersTarget_Type())
...
rlCpuCountersTxBC=_RlCpuCountersTxBC_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1,2),_RlCpuCountersTxBC_Type())
...
rlCpuCountersTxMC=_RlCpuCountersTxMC_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1,3),_RlCpuCountersTxMC_Type())
...
rlCpuCountersTxUC=_RlCpuCountersTxUC_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1,4),_RlCpuCountersTxUC_Type())
...
rlCpuCountersTxOctets=_RlCpuCountersTxOctets_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1,5),_RlCpuCountersTxOctets_Type())
...
rlCpuCountersRxBC=_RlCpuCountersRxBC_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1,6),_RlCpuCountersRxBC_Type())
...
rlCpuCountersRxMC=_RlCpuCountersRxMC_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1,7),_RlCpuCountersRxMC_Type())
...
rlCpuCountersRxUC=_RlCpuCountersRxUC_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1,8),_RlCpuCountersRxUC_Type())
...
rlCpuCountersRxOctets=_RlCpuCountersRxOctets_Object((1,3,6,1,4,1,259,10,1,14,89,124,1,1,9),_RlCpuCountersRxOctets_Type())
...
rlCpuCountersReset=_RlCpuCountersReset_Object((1,3,6,1,4,1,259,10,1,14,89,124,2),_RlCpuCountersReset_Type())
...
rlCpuCountersEnabled=_RlCpuCountersEnabled_Object((1,3,6,1,4,1,259,10,1,14,89,124,3),_RlCpuCountersEnabled_Type())
