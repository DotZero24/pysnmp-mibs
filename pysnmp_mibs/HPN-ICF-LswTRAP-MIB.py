...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-LswTRAP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:32:49 2025
...
hpnicfCpuRemoved = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 12, 1, 25)
)
hpnicfCpuRemoved.setObjects(
      *(("HPN-ICF-LSW-DEV-ADM-MIB", "hpnicfLswFrameIndex"),
        ("HPN-ICF-LSW-DEV-ADM-MIB", "hpnicfLswSlotIndex"),
        ("HPN-ICF-LSW-DEV-ADM-MIB", "hpnicfLswCpuIndex"))
)
if mibBuilder.loadTexts:
    hpnicfCpuRemoved.setStatus(
        "current"
    )

hpnicfCpuFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 12, 1, 26)
)
hpnicfCpuFailure.setObjects(
      *(("HPN-ICF-LSW-DEV-ADM-MIB", "hpnicfLswFrameIndex"),
        ("HPN-ICF-LSW-DEV-ADM-MIB", "hpnicfLswSlotIndex"),
        ("HPN-ICF-LSW-DEV-ADM-MIB", "hpnicfLswCpuIndex"))
)
if mibBuilder.loadTexts:
    hpnicfCpuFailure.setStatus(
        "current"
    )

hpnicfCpuNormal = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 12, 1, 27)
)
hpnicfCpuNormal.setObjects(
      *(("HPN-ICF-LSW-DEV-ADM-MIB", "hpnicfLswFrameIndex"),
        ("HPN-ICF-LSW-DEV-ADM-MIB", "hpnicfLswSlotIndex"),
        ("HPN-ICF-LSW-DEV-ADM-MIB", "hpnicfLswCpuIndex"))
)
if mibBuilder.loadTexts:
    hpnicfCpuNormal.setStatus(
        "current"
    )

hpnicfPowerIncompatible = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 12, 1, 28)
)
hpnicfPowerIncompatible.setObjects(
    ("HPN-ICF-LswDEVM-MIB", "hpnicfDevMPowerNum")
)
if mibBuilder.loadTexts:
    hpnicfPowerIncompatible.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpnicfLswTrapMib": hpnicfLswTrapMib,
       ...
       "hpnicfCpuRemoved": hpnicfCpuRemoved,
       "hpnicfCpuFailure": hpnicfCpuFailure,
       "hpnicfCpuNormal": hpnicfCpuNormal,
       "hpnicfPowerIncompatible": hpnicfPowerIncompatible,
