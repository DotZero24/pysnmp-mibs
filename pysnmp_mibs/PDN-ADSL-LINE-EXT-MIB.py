...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-ADSL-LINE-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:01:44 2025
...
class PdnAdslTransmissionModeType(TextualConvention, Bits):
    ...
    namedValues = NamedValues(
        *(("ansit1413", 0),
          ...
          ("q9923ReachExtOverPotsMode3L", 36),
          ("q9923ReachExtOverPotsMode4L", 37),
...
pdnAdslLineExtMIBCompliance.setObjects(
      *(("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineExtGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineSpectrumGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslModeSpecificPsdGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslPsdGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslCarMaskGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineL2AtprtGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineStatusLineAtnGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineStatusSignalAtnGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineStatusSnrMgnGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineStatusMaxattainableLineRateGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineStatusActAtpGroup"),
        ...
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineSubCarStatusSnrGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineSubCarStatusBitsGroup"),
        ("PDN-ADSL-LINE-EXT-MIB", "pdnAdslLineSubCarStatusHlogGroup"))
)
if mibBuilder.loadTexts:
