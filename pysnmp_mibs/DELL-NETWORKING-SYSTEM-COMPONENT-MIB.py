...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/dell/DELL-NETWORKING-SYSTEM-COMPONENT-MIB
...
camUsageL2Entry = MibTableRow((1, 3, 6, 1, 4, 1, 6027, 3, 7, 1, 1, 2, 1), ).setIndexNames((0, "DELL-NETWORKING-SYSTEM-COMPONENT-MIB", "camUsageL2Slot"), (0, "DELL-NETWORKING-SYSTEM-COMPONENT-MIB", "camUsageL2PipeId"), (0, "DELL-NETWORKING-SYSTEM-COMPONENT-MIB", "camUsageL2PipeLine"))
...
camUsageL2PipeLine = MibTableColumn((1, 3, 6, 1, 4, 1, 6027, 3, 7, 1, 1, 2, 1, 11), Integer32())
if mibBuilder.loadTexts: camUsageL2PipeLine.setStatus('current')
camUsageL3Table = MibTable((1, 3, 6, 1, 4, 1, 6027, 3, 7, 1, 1, 3), )
if mibBuilder.loadTexts: camUsageL3Table.setStatus('current')
camUsageL3Entry = MibTableRow((1, 3, 6, 1, 4, 1, 6027, 3, 7, 1, 1, 3, 1), ).setIndexNames((0, "DELL-NETWORKING-SYSTEM-COMPONENT-MIB", "camUsageL3Slot"), (0, "DELL-NETWORKING-SYSTEM-COMPONENT-MIB", "camUsageL3PipeId"), (0, "DELL-NETWORKING-SYSTEM-COMPONENT-MIB", "camUsageL3PipeLine"))
...
camUsageL3PipeLine = MibTableColumn((1, 3, 6, 1, 4, 1, 6027, 3, 7, 1, 1, 3, 1, 19), Integer32())
if mibBuilder.loadTexts: camUsageL3PipeLine.setStatus('current')
...
mibBuilder.exportSymbols("DELL-NETWORKING-SYSTEM-COMPONENT-MIB", camUsageL2PipeId=camUsageL2PipeId, camUsageL3IngMcastFibUsed=camUsageL3IngMcastFibUsed, camUsageL2IngAclUsed=camUsageL2IngAclUsed, camUsageL3ExtEntry=camUsageL3ExtEntry, camUsageL3ExtHostTotal=camUsageL3ExtHostTotal, dellNetSysComponentObjects=dellNetSysComponentObjects, PYSNMP_MODULE_ID=dellNetSysComponentMib, camUsageL3IngPbrUsed=camUsageL3IngPbrUsed, camUsageL3ExtTable=camUsageL3ExtTable, camUsageL3IngPbrTotal=camUsageL3IngPbrTotal, camUsageL3Slot=camUsageL3Slot, camUsageL3ExtSlot=camUsageL3ExtSlot, sysCompAlarmVarString=sysCompAlarmVarString, sysCompAlarmVariable=sysCompAlarmVariable, camUsageL3IngTrcListTotal=camUsageL3IngTrcListTotal, camIsFull=camIsFull, sysCompAlarmLevel=sysCompAlarmLevel, camUsageL3Entry=camUsageL3Entry, camUsageL2IngFibTotal=camUsageL2IngFibTotal, camUsageL2IngFibUsed=camUsageL2IngFibUsed, sysCompSlotId=sysCompSlotId, sysCompAlarmMibNotifications=sysCompAlarmMibNotifications, camUsageL3IngQosUsed=camUsageL3IngQosUsed, camUsageL3IngFibUsed=camUsageL3IngFibUsed, camUsagePipeNum=camUsagePipeNum, camUsageUsed=camUsageUsed, camUsageTable=camUsageTable, camUsageL2IngAclTotal=camUsageL2IngAclTotal, camUsageL3IngAclUsed=camUsageL3IngAclUsed, camUsageL3EgrAclTotal=camUsageL3EgrAclTotal, camUsageL3EgrAclUsed=camUsageL3EgrAclUsed, camUsagePartId=camUsagePartId, sysCompCamPartId=sysCompCamPartId, dellNetSysComponentTrap=dellNetSysComponentTrap, camUsageL2Table=camUsageL2Table, camUsagePartDesc=camUsagePartDesc, camUsageEntry=camUsageEntry, camUsageTotal=camUsageTotal, camUsageThresholdExceed=camUsageThresholdExceed, camUsageSlot=camUsageSlot, camUsageL2EgrAclTotal=camUsageL2EgrAclTotal, camUsageL3ExtHostUsed=camUsageL3ExtHostUsed, camUsageL3IngSysFlowTotal=camUsageL3IngSysFlowTotal, camUsageL3IngQosTotal=camUsageL3IngQosTotal, camUsageL3Table=camUsageL3Table, camUsageL3PipeLine=camUsageL3PipeLine, camUsageL2Slot=camUsageL2Slot, dellNetCamEntries=dellNetCamEntries, camUsageL2EgrAclUsed=camUsageL2EgrAclUsed, camUsageL3IngFibTotal=camUsageL3IngFibTotal, camAuditError=camAuditError, camUsageL3IngTrcListUsed=camUsageL3IngTrcListUsed, sysCompPortPipe=sysCompPortPipe, camUsageL2Entry=camUsageL2Entry, camUsageL2PipeLine=camUsageL2PipeLine, camUsageL3ExtPipeId=camUsageL3ExtPipeId, camUsageL3ExtLPMUsed=camUsageL3ExtLPMUsed, camUsageL3PipeId=camUsageL3PipeId, camUsageL3ExtLPMTotal=camUsageL3ExtLPMTotal, camUsageL3IngMcastFibTotal=camUsageL3IngMcastFibTotal, dellNetSysComponentMib=dellNetSysComponentMib, camUsageL3IngSysFlowUsed=camUsageL3IngSysFlowUsed, camUsageL3IngAclTotal=camUsageL3IngAclTotal)
