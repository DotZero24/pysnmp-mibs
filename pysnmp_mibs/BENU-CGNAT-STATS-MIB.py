...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:38:45 2025
...
mibBuilder.exportSymbols("BENU-CGNAT-STATS-MIB", bCgnatAuthNonTcpSynPortAllocDrop=bCgnatAuthNonTcpSynPortAllocDrop, bCgnatAuthTcpPortReleaseFailureCount=bCgnatAuthTcpPortReleaseFailureCount, bCgnatAuthFlowDeleteFindFailure=bCgnatAuthFlowDeleteFindFailure, bCgnatUnauthDomainNoFreePortCount=bCgnatUnauthDomainNoFreePortCount, bCgnatAuthFlowDeletedSessionEnded=bCgnatAuthFlowDeletedSessionEnded, bCgnatUnauthUnsupportedL4DropCount=bCgnatUnauthUnsupportedL4DropCount, bCgnatMIBObjects=bCgnatMIBObjects, bCgnatUnauthTcpPortAllocSuccessCount=bCgnatUnauthTcpPortAllocSuccessCount, bCgnatAuthPortUtilIndex=bCgnatAuthPortUtilIndex, bCgnatAuthFlowAddFailureCount=bCgnatAuthFlowAddFailureCount, bCgnatAuthNatFlowDelErrSubIdMismatch=bCgnatAuthNatFlowDelErrSubIdMismatch, bCgnatAuthUnsupportedActionIdRcvd=bCgnatAuthUnsupportedActionIdRcvd, bCgnatAuthPortUtilTable=bCgnatAuthPortUtilTable, bCgnatAuthIcmpIdAllocSuccessCount=bCgnatAuthIcmpIdAllocSuccessCount, bCgnatAuthTcpPortReleaseSuccessCount=bCgnatAuthTcpPortReleaseSuccessCount, bCgnatAuthDnsFlowAllocFailureCount=bCgnatAuthDnsFlowAllocFailureCount, bCgnatUnauthStatsEntry=bCgnatUnauthStatsEntry, bCgnatTunnelPortBlocksUsedHighThreshold=bCgnatTunnelPortBlocksUsedHighThreshold, bCgnatAuthPortRisingThresholdCrossedSubCount=bCgnatAuthPortRisingThresholdCrossedSubCount, bCgnatAuthUnsupportedPrivatePortDropCount=bCgnatAuthUnsupportedPrivatePortDropCount, bCgnatUnauthUnsupportedPrivatePortDropCount=bCgnatUnauthUnsupportedPrivatePortDropCount, bCgnatUnauthIcmpIdReleaseFailureCount=bCgnatUnauthIcmpIdReleaseFailureCount, bCgnatUnauthNatflowSyncFailureCount=bCgnatUnauthNatflowSyncFailureCount, bCgnatPortBlocksUsedLowThreshold=bCgnatPortBlocksUsedLowThreshold, bCgnatAuthDomainPublicIpZeroCount=bCgnatAuthDomainPublicIpZeroCount, bCgnatAuthPortsThresholdExceededInt=bCgnatAuthPortsThresholdExceededInt, bCgnatPortBlocksUsedHighThreshold=bCgnatPortBlocksUsedHighThreshold, bCgnatAuthProfileName=bCgnatAuthProfileName, bCgnatAuthNatFlowDelErrValidFlagNotSet=bCgnatAuthNatFlowDelErrValidFlagNotSet, bCgnatUnauthStatsIndex=bCgnatUnauthStatsIndex, bCgnatUnauthFlowDeleteFailureCount=bCgnatUnauthFlowDeleteFailureCount, bCgnatAuthStatsTable=bCgnatAuthStatsTable, bCgnatAuthPortsThresholdExceededRcvd=bCgnatAuthPortsThresholdExceededRcvd, bCgnatAuthSubscriberPortsFree=bCgnatAuthSubscriberPortsFree, bCgnatSubscriberMac=bCgnatSubscriberMac, bDslitePortBlockRisingThresholdCrossedTunCount=bDslitePortBlockRisingThresholdCrossedTunCount, bCgnatAuthUdpPortAllocFailureCount=bCgnatAuthUdpPortAllocFailureCount, bCgnatAuthUdpPortAllocSuccessCount=bCgnatAuthUdpPortAllocSuccessCount, bCgnatAuthNatflowSyncFailureCount=bCgnatAuthNatflowSyncFailureCount, bCgnatAuthMaxCgnatPortsExceeded=bCgnatAuthMaxCgnatPortsExceeded, bCgnatUnauthUdpPortAllocFailureCount=bCgnatUnauthUdpPortAllocFailureCount, bCgnatUnauthDnsFlowRelease=bCgnatUnauthDnsFlowRelease, bCgnatUnauthTimerAllocFailureCount=bCgnatUnauthTimerAllocFailureCount, bCgnatAuthPortsThresholdExceededSent=bCgnatAuthPortsThresholdExceededSent, bCgnatAuthDomainNoFreePortCount=bCgnatAuthDomainNoFreePortCount, bCgnatAuthPortsThresholdExceededErr=bCgnatAuthPortsThresholdExceededErr, bCgnatUnauthIcmpIdAllocFailureCount=bCgnatUnauthIcmpIdAllocFailureCount, bCgnatUnauthDomainPublicIpZeroCount=bCgnatUnauthDomainPublicIpZeroCount, bCgnatUnauthStatsTable=bCgnatUnauthStatsTable, bCgnatUnauthUdpPortReleaseSuccessCount=bCgnatUnauthUdpPortReleaseSuccessCount, bCgnatAuthFlowDeletedTimer=bCgnatAuthFlowDeletedTimer, bCgnatOddPortsForTunnel=bCgnatOddPortsForTunnel, bCgnatUnauthDnsFlowAlloc=bCgnatUnauthDnsFlowAlloc, bCgnatAuthFlowDeleteSent=bCgnatAuthFlowDeleteSent, bCgnatAuthUdpPortReleaseSuccessCount=bCgnatAuthUdpPortReleaseSuccessCount, bCgnatAuthTcpPortAllocFailureCount=bCgnatAuthTcpPortAllocFailureCount, bCgnatAuthFlowDeleteSuccessCount=bCgnatAuthFlowDeleteSuccessCount, bCgnatAuthTcpPortAllocSuccessCount=bCgnatAuthTcpPortAllocSuccessCount, bCgnatAuthUnsupportedL4DropCount=bCgnatAuthUnsupportedL4DropCount, bCgnatUnauthDnsFlowAllocFailureCount=bCgnatUnauthDnsFlowAllocFailureCount, bCgnatUnauthIcmpIdReleaseSuccessCount=bCgnatUnauthIcmpIdReleaseSuccessCount, bCgnatUnauthMaxCgnatPortsExceeded=bCgnatUnauthMaxCgnatPortsExceeded, bCgnatUnauthProfileName=bCgnatUnauthProfileName, bCgnatAuthFlowDeleteRcvd=bCgnatAuthFlowDeleteRcvd, bCgnatAuthDnsFlowAllocSuccessCount=bCgnatAuthDnsFlowAllocSuccessCount, bCgnatNotifObjects=bCgnatNotifObjects, bCgnatUnauthDnsFlowReleaseFailureCount=bCgnatUnauthDnsFlowReleaseFailureCount, bCgnatTunnelPortBlocksUsedLowThresholdReached=bCgnatTunnelPortBlocksUsedLowThresholdReached, PYSNMP_MODULE_ID=benuCgnatStatsMIB, bCgnatAuthFlowDeleteFailureCount=bCgnatAuthFlowDeleteFailureCount, bCgnatTotalPortBlocksPerSubscriber=bCgnatTotalPortBlocksPerSubscriber, bCgnatUnauthFlowDeleteSuccessCount=bCgnatUnauthFlowDeleteSuccessCount, bCgnatUnauthTcpPortAllocFailureCount=bCgnatUnauthTcpPortAllocFailureCount, bCgnatAuthIcmpPortUnreachableSent=bCgnatAuthIcmpPortUnreachableSent, bCgnatAuthMaxIcmpIdsExceeded=bCgnatAuthMaxIcmpIdsExceeded, bCgnatUnauthPortsThresholdExceededSent=bCgnatUnauthPortsThresholdExceededSent, bCgnatUnauthIcmpIdAllocSuccessCount=bCgnatUnauthIcmpIdAllocSuccessCount, bCgnatTunnelPortBlocksUsedHighThresholdReached=bCgnatTunnelPortBlocksUsedHighThresholdReached, bCgnatUnauthFlowAddSuccessCount=bCgnatUnauthFlowAddSuccessCount, bCgnatUnauthNatFlowDelErrValidFlagNotSet=bCgnatUnauthNatFlowDelErrValidFlagNotSet, bCgnatUnauthUnsupportedActionIdRcvd=bCgnatUnauthUnsupportedActionIdRcvd, bCgnatUnauthPortsThresholdExceededErr=bCgnatUnauthPortsThresholdExceededErr, bCgnatAuthDnsFlowReleaseFailureCount=bCgnatAuthDnsFlowReleaseFailureCount, bCgnatUnauthNonTcpSynPortAllocDrop=bCgnatUnauthNonTcpSynPortAllocDrop, bCgnatUnauthFlowDeletedSessionEnded=bCgnatUnauthFlowDeletedSessionEnded, bCgnatUnauthPortsThresholdExceededInt=bCgnatUnauthPortsThresholdExceededInt, bCgnatTunnelPortBlocksUsedLowThreshold=bCgnatTunnelPortBlocksUsedLowThreshold, bCgnatPortParity=bCgnatPortParity, bCgnatUnauthFlowDeletedSubClear=bCgnatUnauthFlowDeletedSubClear, bCgnatPortBlocksUsedLowThresholdReached=bCgnatPortBlocksUsedLowThresholdReached, benuCgnatStatsMIB=benuCgnatStatsMIB, bCgnatNotifications=bCgnatNotifications, bCgnatAuthDnsFlowRelease=bCgnatAuthDnsFlowRelease, bCgnatPortBlocksUsedHighThresholdReached=bCgnatPortBlocksUsedHighThresholdReached, bCgnatAuthIcmpIdAllocFailureCount=bCgnatAuthIcmpIdAllocFailureCount, bCgnatUnauthUdpPortReleaseFailureCount=bCgnatUnauthUdpPortReleaseFailureCount, bCgnatAuthStatsEntry=bCgnatAuthStatsEntry, bCgnatAuthIcmpIdReleaseFailureCount=bCgnatAuthIcmpIdReleaseFailureCount, bCgnatUnauthFlowDeleteRcvd=bCgnatUnauthFlowDeleteRcvd, bCgnatThresholdTunnelId=bCgnatThresholdTunnelId, bCgnatUnauthPortsThresholdExceededRcvd=bCgnatUnauthPortsThresholdExceededRcvd, bCgnatAuthFlowDeletedSubClear=bCgnatAuthFlowDeletedSubClear, bCgnatUnauthDnsFlowAllocSuccessCount=bCgnatUnauthDnsFlowAllocSuccessCount, bCgnatAuthFlowAddSuccessCount=bCgnatAuthFlowAddSuccessCount, bCgnatUnauthTcpPortReleaseSuccessCount=bCgnatUnauthTcpPortReleaseSuccessCount, bCgnatAuthSubscriberMac=bCgnatAuthSubscriberMac, bCgnatAuthIcmpIdReleaseSuccessCount=bCgnatAuthIcmpIdReleaseSuccessCount, bCgnatUnauthNatFlowDelErrSubIdMismatch=bCgnatUnauthNatFlowDelErrSubIdMismatch, bCgnatUnauthDnsFlowReleaseSuccessCount=bCgnatUnauthDnsFlowReleaseSuccessCount, bCgnatAuthDnsFlowReleaseSuccessCount=bCgnatAuthDnsFlowReleaseSuccessCount, bCgnatAuthPortsNotAvailableDrop=bCgnatAuthPortsNotAvailableDrop, bCgnatAuthStatsIndex=bCgnatAuthStatsIndex, bCgnatEvenPortsForTunnel=bCgnatEvenPortsForTunnel, bCgnatUnauthMaxIcmpIdsExceeded=bCgnatUnauthMaxIcmpIdsExceeded, bCgnatUnauthFlowDeleteSent=bCgnatUnauthFlowDeleteSent, bCgnatUnauthFlowDeleteFindFailure=bCgnatUnauthFlowDeleteFindFailure, bCgnatUnauthTcpPortReleaseFailureCount=bCgnatUnauthTcpPortReleaseFailureCount, bCgnatUnauthFlowAddFailureCount=bCgnatUnauthFlowAddFailureCount, bCgnatAuthDnsFlowAlloc=bCgnatAuthDnsFlowAlloc, bCgnatUnauthUdpPortAllocSuccessCount=bCgnatUnauthUdpPortAllocSuccessCount, bCgnatUnauthIcmpPortUnreachableSent=bCgnatUnauthIcmpPortUnreachableSent, bCgnatAuthTimerAllocFailureCount=bCgnatAuthTimerAllocFailureCount, bCgnatUnauthFlowDeletedTimer=bCgnatUnauthFlowDeletedTimer, bCgnatAuthUdpPortReleaseFailureCount=bCgnatAuthUdpPortReleaseFailureCount, bCgnatUnauthPortsNotAvailableDrop=bCgnatUnauthPortsNotAvailableDrop, bCgnatAuthPortUtilEntry=bCgnatAuthPortUtilEntry)
