...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/benu/BENU-CGNAT-STATS-MIB
...
mibBuilder.exportSymbols("BENU-CGNAT-STATS-MIB", bCgnatAuthSubscriberPortsFree=bCgnatAuthSubscriberPortsFree, bCgnatAuthIcmpPortUnreachableSent=bCgnatAuthIcmpPortUnreachableSent, bCgnatAuthMaxIcmpIdsExceeded=bCgnatAuthMaxIcmpIdsExceeded, bCgnatUnauthUdpPortReleaseSuccessCount=bCgnatUnauthUdpPortReleaseSuccessCount, bCgnatAuthPortUtilTable=bCgnatAuthPortUtilTable, bCgnatPortBlocksUsedHighThreshold=bCgnatPortBlocksUsedHighThreshold, bCgnatAuthFlowDeletedSubClear=bCgnatAuthFlowDeletedSubClear, bCgnatUnauthStatsIndex=bCgnatUnauthStatsIndex, bCgnatAuthDnsFlowRelease=bCgnatAuthDnsFlowRelease, bCgnatUnauthFlowDeletedTimer=bCgnatUnauthFlowDeletedTimer, bCgnatAuthFlowAddSuccessCount=bCgnatAuthFlowAddSuccessCount, bCgnatOddPortsForTunnel=bCgnatOddPortsForTunnel, bCgnatPortBlocksUsedHighThresholdReached=bCgnatPortBlocksUsedHighThresholdReached, bCgnatUnauthPortsThresholdExceededRcvd=bCgnatUnauthPortsThresholdExceededRcvd, bCgnatAuthDomainPublicIpZeroCount=bCgnatAuthDomainPublicIpZeroCount, bCgnatAuthIcmpIdReleaseSuccessCount=bCgnatAuthIcmpIdReleaseSuccessCount, bCgnatUnauthFlowDeletedSubClear=bCgnatUnauthFlowDeletedSubClear, bCgnatTunnelPortBlocksUsedHighThreshold=bCgnatTunnelPortBlocksUsedHighThreshold, bCgnatUnauthProfileName=bCgnatUnauthProfileName, bCgnatUnauthFlowDeleteRcvd=bCgnatUnauthFlowDeleteRcvd, bCgnatAuthDomainNoFreePortCount=bCgnatAuthDomainNoFreePortCount, bCgnatAuthFlowDeleteFailureCount=bCgnatAuthFlowDeleteFailureCount, bCgnatTunnelPortBlocksUsedHighThresholdReached=bCgnatTunnelPortBlocksUsedHighThresholdReached, bCgnatUnauthFlowAddSuccessCount=bCgnatUnauthFlowAddSuccessCount, bCgnatAuthPortsThresholdExceededInt=bCgnatAuthPortsThresholdExceededInt, bCgnatUnauthTcpPortReleaseSuccessCount=bCgnatUnauthTcpPortReleaseSuccessCount, bCgnatAuthTcpPortAllocFailureCount=bCgnatAuthTcpPortAllocFailureCount, bCgnatAuthStatsIndex=bCgnatAuthStatsIndex, bCgnatAuthPortRisingThresholdCrossedSubCount=bCgnatAuthPortRisingThresholdCrossedSubCount, bCgnatAuthFlowDeleteRcvd=bCgnatAuthFlowDeleteRcvd, bCgnatUnauthMaxCgnatPortsExceeded=bCgnatUnauthMaxCgnatPortsExceeded, bCgnatAuthSubscriberMac=bCgnatAuthSubscriberMac, bCgnatAuthFlowDeletedTimer=bCgnatAuthFlowDeletedTimer, bCgnatUnauthFlowDeleteFailureCount=bCgnatUnauthFlowDeleteFailureCount, bCgnatUnauthPortsThresholdExceededSent=bCgnatUnauthPortsThresholdExceededSent, bCgnatMIBObjects=bCgnatMIBObjects, bCgnatAuthUnsupportedPrivatePortDropCount=bCgnatAuthUnsupportedPrivatePortDropCount, bCgnatTunnelPortBlocksUsedLowThreshold=bCgnatTunnelPortBlocksUsedLowThreshold, bCgnatUnauthFlowDeleteSuccessCount=bCgnatUnauthFlowDeleteSuccessCount, bCgnatUnauthPortsThresholdExceededInt=bCgnatUnauthPortsThresholdExceededInt, bCgnatUnauthTcpPortAllocSuccessCount=bCgnatUnauthTcpPortAllocSuccessCount, bCgnatAuthNatflowSyncFailureCount=bCgnatAuthNatflowSyncFailureCount, bCgnatAuthDnsFlowAlloc=bCgnatAuthDnsFlowAlloc, bCgnatAuthMaxCgnatPortsExceeded=bCgnatAuthMaxCgnatPortsExceeded, bCgnatPortBlocksUsedLowThresholdReached=bCgnatPortBlocksUsedLowThresholdReached, bCgnatAuthNatFlowDelErrSubIdMismatch=bCgnatAuthNatFlowDelErrSubIdMismatch, bCgnatAuthTcpPortReleaseFailureCount=bCgnatAuthTcpPortReleaseFailureCount, bCgnatUnauthFlowDeleteFindFailure=bCgnatUnauthFlowDeleteFindFailure, bCgnatAuthNatFlowDelErrValidFlagNotSet=bCgnatAuthNatFlowDelErrValidFlagNotSet, bCgnatUnauthNonTcpSynPortAllocDrop=bCgnatUnauthNonTcpSynPortAllocDrop, bCgnatUnauthIcmpIdAllocFailureCount=bCgnatUnauthIcmpIdAllocFailureCount, bCgnatUnauthTimerAllocFailureCount=bCgnatUnauthTimerAllocFailureCount, bCgnatUnauthPortsThresholdExceededErr=bCgnatUnauthPortsThresholdExceededErr, bCgnatAuthUdpPortReleaseFailureCount=bCgnatAuthUdpPortReleaseFailureCount, bCgnatAuthProfileName=bCgnatAuthProfileName, bCgnatAuthFlowDeleteSent=bCgnatAuthFlowDeleteSent, bCgnatAuthUdpPortReleaseSuccessCount=bCgnatAuthUdpPortReleaseSuccessCount, bCgnatAuthFlowDeleteSuccessCount=bCgnatAuthFlowDeleteSuccessCount, bCgnatUnauthUnsupportedL4DropCount=bCgnatUnauthUnsupportedL4DropCount, bCgnatUnauthStatsTable=bCgnatUnauthStatsTable, bCgnatPortParity=bCgnatPortParity, bCgnatAuthPortUtilIndex=bCgnatAuthPortUtilIndex, bCgnatThresholdTunnelId=bCgnatThresholdTunnelId, bCgnatAuthStatsEntry=bCgnatAuthStatsEntry, bCgnatUnauthUdpPortAllocFailureCount=bCgnatUnauthUdpPortAllocFailureCount, bCgnatUnauthDomainPublicIpZeroCount=bCgnatUnauthDomainPublicIpZeroCount, bCgnatUnauthIcmpIdReleaseSuccessCount=bCgnatUnauthIcmpIdReleaseSuccessCount, bCgnatUnauthIcmpIdReleaseFailureCount=bCgnatUnauthIcmpIdReleaseFailureCount, bCgnatUnauthIcmpIdAllocSuccessCount=bCgnatUnauthIcmpIdAllocSuccessCount, bCgnatUnauthTcpPortAllocFailureCount=bCgnatUnauthTcpPortAllocFailureCount, bCgnatAuthIcmpIdReleaseFailureCount=bCgnatAuthIcmpIdReleaseFailureCount, bCgnatUnauthMaxIcmpIdsExceeded=bCgnatUnauthMaxIcmpIdsExceeded, bCgnatTunnelPortBlocksUsedLowThresholdReached=bCgnatTunnelPortBlocksUsedLowThresholdReached, bCgnatUnauthDomainNoFreePortCount=bCgnatUnauthDomainNoFreePortCount, bCgnatAuthTimerAllocFailureCount=bCgnatAuthTimerAllocFailureCount, bCgnatAuthDnsFlowAllocSuccessCount=bCgnatAuthDnsFlowAllocSuccessCount, bCgnatAuthPortsThresholdExceededErr=bCgnatAuthPortsThresholdExceededErr, bCgnatUnauthNatFlowDelErrValidFlagNotSet=bCgnatUnauthNatFlowDelErrValidFlagNotSet, bCgnatAuthUdpPortAllocFailureCount=bCgnatAuthUdpPortAllocFailureCount, bCgnatUnauthNatflowSyncFailureCount=bCgnatUnauthNatflowSyncFailureCount, bCgnatAuthUnsupportedL4DropCount=bCgnatAuthUnsupportedL4DropCount, bCgnatUnauthPortsNotAvailableDrop=bCgnatUnauthPortsNotAvailableDrop, bCgnatAuthDnsFlowAllocFailureCount=bCgnatAuthDnsFlowAllocFailureCount, bCgnatUnauthStatsEntry=bCgnatUnauthStatsEntry, bCgnatAuthTcpPortReleaseSuccessCount=bCgnatAuthTcpPortReleaseSuccessCount, bCgnatUnauthDnsFlowReleaseSuccessCount=bCgnatUnauthDnsFlowReleaseSuccessCount, bCgnatAuthFlowDeletedSessionEnded=bCgnatAuthFlowDeletedSessionEnded, bCgnatAuthIcmpIdAllocFailureCount=bCgnatAuthIcmpIdAllocFailureCount, bCgnatUnauthUnsupportedPrivatePortDropCount=bCgnatUnauthUnsupportedPrivatePortDropCount, bCgnatAuthNonTcpSynPortAllocDrop=bCgnatAuthNonTcpSynPortAllocDrop, bCgnatUnauthNatFlowDelErrSubIdMismatch=bCgnatUnauthNatFlowDelErrSubIdMismatch, bCgnatUnauthUdpPortReleaseFailureCount=bCgnatUnauthUdpPortReleaseFailureCount, bCgnatAuthPortsThresholdExceededRcvd=bCgnatAuthPortsThresholdExceededRcvd, bCgnatAuthFlowDeleteFindFailure=bCgnatAuthFlowDeleteFindFailure, bCgnatUnauthFlowDeleteSent=bCgnatUnauthFlowDeleteSent, bCgnatAuthTcpPortAllocSuccessCount=bCgnatAuthTcpPortAllocSuccessCount, bCgnatUnauthDnsFlowRelease=bCgnatUnauthDnsFlowRelease, bDslitePortBlockRisingThresholdCrossedTunCount=bDslitePortBlockRisingThresholdCrossedTunCount, bCgnatAuthDnsFlowReleaseFailureCount=bCgnatAuthDnsFlowReleaseFailureCount, benuCgnatStatsMIB=benuCgnatStatsMIB, bCgnatUnauthDnsFlowReleaseFailureCount=bCgnatUnauthDnsFlowReleaseFailureCount, bCgnatUnauthDnsFlowAllocFailureCount=bCgnatUnauthDnsFlowAllocFailureCount, bCgnatEvenPortsForTunnel=bCgnatEvenPortsForTunnel, bCgnatPortBlocksUsedLowThreshold=bCgnatPortBlocksUsedLowThreshold, bCgnatAuthUdpPortAllocSuccessCount=bCgnatAuthUdpPortAllocSuccessCount, bCgnatAuthFlowAddFailureCount=bCgnatAuthFlowAddFailureCount, bCgnatAuthStatsTable=bCgnatAuthStatsTable, bCgnatUnauthUnsupportedActionIdRcvd=bCgnatUnauthUnsupportedActionIdRcvd, bCgnatAuthDnsFlowReleaseSuccessCount=bCgnatAuthDnsFlowReleaseSuccessCount, bCgnatUnauthDnsFlowAlloc=bCgnatUnauthDnsFlowAlloc, bCgnatTotalPortBlocksPerSubscriber=bCgnatTotalPortBlocksPerSubscriber, bCgnatSubscriberMac=bCgnatSubscriberMac, bCgnatUnauthFlowAddFailureCount=bCgnatUnauthFlowAddFailureCount, bCgnatAuthUnsupportedActionIdRcvd=bCgnatAuthUnsupportedActionIdRcvd, PYSNMP_MODULE_ID=benuCgnatStatsMIB, bCgnatNotifications=bCgnatNotifications, bCgnatUnauthUdpPortAllocSuccessCount=bCgnatUnauthUdpPortAllocSuccessCount, bCgnatAuthPortUtilEntry=bCgnatAuthPortUtilEntry, bCgnatAuthPortsThresholdExceededSent=bCgnatAuthPortsThresholdExceededSent, bCgnatAuthIcmpIdAllocSuccessCount=bCgnatAuthIcmpIdAllocSuccessCount, bCgnatUnauthIcmpPortUnreachableSent=bCgnatUnauthIcmpPortUnreachableSent, bCgnatUnauthTcpPortReleaseFailureCount=bCgnatUnauthTcpPortReleaseFailureCount, bCgnatAuthPortsNotAvailableDrop=bCgnatAuthPortsNotAvailableDrop, bCgnatUnauthDnsFlowAllocSuccessCount=bCgnatUnauthDnsFlowAllocSuccessCount, bCgnatNotifObjects=bCgnatNotifObjects, bCgnatUnauthFlowDeletedSessionEnded=bCgnatUnauthFlowDeletedSessionEnded)
