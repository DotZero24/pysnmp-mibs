...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/radlan/RADLAN-SNMP-MIB
...
rlEventsDefaultPollingInterval = MibScalar((1, 3, 6, 1, 4, 1, 89, 98, 7, 2), TimeTicks()).setMaxAccess("readwrite")
...
rlEventsPollingControlPollingInterval = MibTableColumn((1, 3, 6, 1, 4, 1, 89, 98, 7, 6, 1, 2), TimeTicks()).setMaxAccess("readcreate")
