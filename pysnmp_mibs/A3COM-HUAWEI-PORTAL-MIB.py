# SNMP MIB module (A3COM-HUAWEI-PORTAL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-PORTAL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:11 2025
...
h3cPortalServerEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORTAL-MIB", "h3cPortalServerName"),
)
if mibBuilder.loadTexts:
...
h3cPortalIfServerEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORTAL-MIB", "h3cPortalIfServerIndex"),
)
if mibBuilder.loadTexts:
...
h3cPortalIfVlanNasIDEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORTAL-MIB", "h3cPortalIfVlanNasIDIfIndex"),
    (0, "A3COM-HUAWEI-PORTAL-MIB", "h3cPortalIfVlanNasIDVlanID"),
)
if mibBuilder.loadTexts:
...
h3cPortalSSIDFreeRuleEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORTAL-MIB", "h3cPortalSSIDFreeRuleIndex"),
)
if mibBuilder.loadTexts:
...
h3cPortalMacTriggerSrvEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORTAL-MIB", "h3cPortalMacTriggerSrvIndex"),
)
if mibBuilder.loadTexts:
...
h3cPortalMacTriggerOnIfEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORTAL-MIB", "h3cPortalMacTriggerOnIfIfIndex"),
)
if mibBuilder.loadTexts:
...
h3cPortalFreeRuleEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORTAL-MIB", "h3cPortalFreeRuleIndex"),
)
if mibBuilder.loadTexts:
...
h3cPortalForbiddenRuleEntry.setIndexNames(
    (0, "A3COM-HUAWEI-PORTAL-MIB", "h3cPortalForbiddenRuleIndex"),
)
if mibBuilder.loadTexts:
...
h3cPortalServerLost.setObjects(
      *(("A3COM-HUAWEI-PORTAL-MIB", "h3cPortalServerName"),
        ("A3COM-HUAWEI-PORTAL-MIB", "h3cPortalFirstTrapTime"))
)
if mibBuilder.loadTexts:
