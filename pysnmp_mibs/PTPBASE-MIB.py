...
mibBuilder.exportSymbols("PTPBASE-MIB", ptpbaseClockPortDSTable=ptpbaseClockPortDSTable, ptpbaseClockParentDSGMClockPriority1=ptpbaseClockParentDSGMClockPriority1, ptpbaseClockRunningState=ptpbaseClockRunningState, ptpbaseClockTransDefaultDSTable=ptpbaseClockTransDefaultDSTable, ptpbaseClockPortAssociateInErrors=ptpbaseClockPortAssociateInErrors, PtpClockPortState=PtpClockPortState, ptpbaseMIBClockTranparentDSGroup=ptpbaseMIBClockTranparentDSGroup, PtpClockInstanceType=PtpClockInstanceType, ptpbaseClockTransDefaultDSDelay=ptpbaseClockTransDefaultDSDelay, ptpbaseClockPortAssociateAddress=ptpbaseClockPortAssociateAddress, ptpbaseSystemTable=ptpbaseSystemTable, ptpbaseClockTimePropertiesDSLeap61=ptpbaseClockTimePropertiesDSLeap61, ptpbaseClockDefaultDSTable=ptpbaseClockDefaultDSTable, PtpClockTimeSourceType=PtpClockTimeSourceType, ptpbaseClockRunningPacketsReceived=ptpbaseClockRunningPacketsReceived, PtpClockDomainType=PtpClockDomainType, ptpbaseSystemProfile=ptpbaseSystemProfile, ptpbaseClockDefaultDSClockIdentity=ptpbaseClockDefaultDSClockIdentity, ptpbaseClockDefaultDSQualityOffset=ptpbaseClockDefaultDSQualityOffset, ptpbaseClockPortDSClockTypeIndex=ptpbaseClockPortDSClockTypeIndex, ptpbaseClockPortDSAnnounceRctTimeout=ptpbaseClockPortDSAnnounceRctTimeout, ptpbaseClockTimePropertiesDSCurrentUTCOffsetValid=ptpbaseClockTimePropertiesDSCurrentUTCOffsetValid, ptpbaseMIBCompliancesClockInfo=ptpbaseMIBCompliancesClockInfo, ptpbaseMIBClockRunningGroup=ptpbaseMIBClockRunningGroup, PtpClockTimeInterval=PtpClockTimeInterval, ptpbaseClockPortTransDSlogMinPdelayReqInt=ptpbaseClockPortTransDSlogMinPdelayReqInt, ptpbaseClockPortTransDSPortIdentity=ptpbaseClockPortTransDSPortIdentity, ptpbaseClockPortName=ptpbaseClockPortName, ptpbaseMIBClockTimepropertiesGroup=ptpbaseMIBClockTimepropertiesGroup, ptpbaseClockPortRunningRole=ptpbaseClockPortRunningRole, ptpbaseClockPortRunningState=ptpbaseClockPortRunningState, ptpbaseClockPortAssociateTable=ptpbaseClockPortAssociateTable, ptpbaseClockCurrentDSMeanPathDelay=ptpbaseClockCurrentDSMeanPathDelay, ptpbaseClockParentDSDomainIndex=ptpbaseClockParentDSDomainIndex, ptpbaseClockRunningDomainIndex=ptpbaseClockRunningDomainIndex, ptpbaseClockPortRunningPortNumberIndex=ptpbaseClockPortRunningPortNumberIndex, ptpbaseClockPortRunningClockTypeIndex=ptpbaseClockPortRunningClockTypeIndex, ptpbaseClockPortRunningPacketsReceived=ptpbaseClockPortRunningPacketsReceived, ptpbaseClockPortTransDSDomainIndex=ptpbaseClockPortTransDSDomainIndex, ptpbaseMIBCompliancesTransparentClockInfo=ptpbaseMIBCompliancesTransparentClockInfo, PtpClockPortTransportTypeAddress=PtpClockPortTransportTypeAddress, ptpbaseClockPortRunningEncapsulationType=ptpbaseClockPortRunningEncapsulationType, ptpbaseClockPortAssociatePortIndex=ptpbaseClockPortAssociatePortIndex, PtpClockProfileType=PtpClockProfileType, ptpbaseClockDefaultDSQualityAccuracy=ptpbaseClockDefaultDSQualityAccuracy, ptpbaseMIB=ptpbaseMIB, ptpbaseClockParentDSParentStats=ptpbaseClockParentDSParentStats, ptpbaseSystemDomainEntry=ptpbaseSystemDomainEntry, ptpbaseClockTransDefaultDSInstanceIndex=ptpbaseClockTransDefaultDSInstanceIndex, ptpbaseTransportTypeIPversion4=ptpbaseTransportTypeIPversion4, ptpbaseClockPortAssociatePacketsSent=ptpbaseClockPortAssociatePacketsSent, ptpbaseMIBClockPortRunningGroup=ptpbaseMIBClockPortRunningGroup, ptpbaseClockParentDSGMClockPriority2=ptpbaseClockParentDSGMClockPriority2, ptpbaseMIBClockPortGroup=ptpbaseMIBClockPortGroup, ptpbaseClockParentDSOffset=ptpbaseClockParentDSOffset, ptpbaseMIBGroups=ptpbaseMIBGroups, ptpbaseClockTimePropertiesDSLeap59=ptpbaseClockTimePropertiesDSLeap59, ptpbaseClockPortDSDelayMech=ptpbaseClockPortDSDelayMech, ptpbaseClockPortRole=ptpbaseClockPortRole, ptpbaseClockPortDSName=ptpbaseClockPortDSName, ptpbaseClockPortDSMinDelayReqInterval=ptpbaseClockPortDSMinDelayReqInterval, ptpbaseClockTimePropertiesDSInstanceIndex=ptpbaseClockTimePropertiesDSInstanceIndex, ptpbaseClockPortAssociatePacketsReceived=ptpbaseClockPortAssociatePacketsReceived, ptpbaseClockRunningInstanceIndex=ptpbaseClockRunningInstanceIndex, ptpbaseClockDefaultDSInstanceIndex=ptpbaseClockDefaultDSInstanceIndex, ptpbaseClockParentDSInstanceIndex=ptpbaseClockParentDSInstanceIndex, ptpbaseClockPortDSlogSyncInterval=ptpbaseClockPortDSlogSyncInterval, ptpbaseClockTimePropertiesDSCurrentUTCOffset=ptpbaseClockTimePropertiesDSCurrentUTCOffset, ptpbaseClockCurrentDSOffsetFromMaster=ptpbaseClockCurrentDSOffsetFromMaster, ptpbaseClockPortRunningTxMode=ptpbaseClockPortRunningTxMode, ptpbaseSystemDomainTable=ptpbaseSystemDomainTable, ptpbaseClockRunningPacketsSent=ptpbaseClockRunningPacketsSent, ptpbaseClockDefaultDSEntry=ptpbaseClockDefaultDSEntry, PtpClockStateType=PtpClockStateType, ptpClockPortCurrentClockInstanceIndex=ptpClockPortCurrentClockInstanceIndex, ptpbaseTransportTypeEthernet=ptpbaseTransportTypeEthernet, ptpbaseClockPortRunningTable=ptpbaseClockPortRunningTable, ptpbaseClockPortTable=ptpbaseClockPortTable, ptpbaseClockPortRunningRxMode=ptpbaseClockPortRunningRxMode, ptpbaseMIBClockPortAssociateGroup=ptpbaseMIBClockPortAssociateGroup, PtpClockMechanismType=PtpClockMechanismType, PtpClockIntervalBase2=PtpClockIntervalBase2, ptpDomainIndex=ptpDomainIndex, ptpbaseWellKnownTransportTypes=ptpbaseWellKnownTransportTypes, ptpClockPortCurrentPortNumberIndex=ptpClockPortCurrentPortNumberIndex, ptpbaseMIBClockInfo=ptpbaseMIBClockInfo, ptpbaseClockTransDefaultDSPrimaryDomain=ptpbaseClockTransDefaultDSPrimaryDomain, ptpbaseClockPortCurrentPeerAddress=ptpbaseClockPortCurrentPeerAddress, ptpbaseClockPortDSDomainIndex=ptpbaseClockPortDSDomainIndex, ptpbaseClockPortDomainIndex=ptpbaseClockPortDomainIndex, ptpbaseEncapsulationTypeVLAN=ptpbaseEncapsulationTypeVLAN, ptpInstanceIndex=ptpInstanceIndex, ptpbaseClockParentDSGMClockQualityAccuracy=ptpbaseClockParentDSGMClockQualityAccuracy, ptpbaseEncapsulationTypePWUDPIPLSP=ptpbaseEncapsulationTypePWUDPIPLSP, ptpbaseMIBCompliancesSystemInfo=ptpbaseMIBCompliancesSystemInfo, ptpbaseClockParentDSClockTypeIndex=ptpbaseClockParentDSClockTypeIndex, ptpbaseClockParentDSGMClockIdentity=ptpbaseClockParentDSGMClockIdentity, ptpbaseClockPortRunningEntry=ptpbaseClockPortRunningEntry, PtpClockType=PtpClockType, ptpbaseMIBCompliances=ptpbaseMIBCompliances, ptpDomainClockPortsTotal=ptpDomainClockPortsTotal, ptpbaseClockPortRunningTransport=ptpbaseClockPortRunningTransport, PYSNMP_MODULE_ID=ptpbaseMIB, ptpbaseMIBSystemInfo=ptpbaseMIBSystemInfo, ptpbaseClockTimePropertiesDSPTPTimescale=ptpbaseClockTimePropertiesDSPTPTimescale, ptpbaseClockPortTransDSEntry=ptpbaseClockPortTransDSEntry, ptpbaseClockPortTransDSPeerMeanPathDelay=ptpbaseClockPortTransDSPeerMeanPathDelay, ptpbaseTransportTypeControlNET=ptpbaseTransportTypeControlNET, ptpbaseClockParentDSGMClockQualityClass=ptpbaseClockParentDSGMClockQualityClass, ptpbaseMIBNotifs=ptpbaseMIBNotifs, ptpbaseClockTransDefaultDSEntry=ptpbaseClockTransDefaultDSEntry, ptpbaseMIBClockParentDSGroup=ptpbaseMIBClockParentDSGroup, ptpbaseClockPortDSClockInstanceIndex=ptpbaseClockPortDSClockInstanceIndex, ptpbaseClockTransDefaultDSDomainIndex=ptpbaseClockTransDefaultDSDomainIndex, ptpbaseMIBClockPortTransDSGroup=ptpbaseMIBClockPortTransDSGroup, ptpbaseClockDefaultDSSlaveOnly=ptpbaseClockDefaultDSSlaveOnly, ptpbaseClockRunningClockTypeIndex=ptpbaseClockRunningClockTypeIndex, ptpbaseClockPortAssociateAddressType=ptpbaseClockPortAssociateAddressType, ptpbaseMIBCompliancesClockPortInfo=ptpbaseMIBCompliancesClockPortInfo, ptpbaseClockDefaultDSTwoStepFlag=ptpbaseClockDefaultDSTwoStepFlag, ptpbaseClockTimePropertiesDSEntry=ptpbaseClockTimePropertiesDSEntry, ptpbaseClockParentDSTable=ptpbaseClockParentDSTable, ptpbaseClockPortAssociateOutErrors=ptpbaseClockPortAssociateOutErrors, ptpbaseClockCurrentDSStepsRemoved=ptpbaseClockCurrentDSStepsRemoved, ptpbaseClockParentDSParentPortIdentity=ptpbaseClockParentDSParentPortIdentity, ptpbaseClockPortDSEntry=ptpbaseClockPortDSEntry, ptpbaseClockParentDSGMClockQualityOffset=ptpbaseClockParentDSGMClockQualityOffset, ptpbaseClockDefaultDSPriority1=ptpbaseClockDefaultDSPriority1, ptpClockPortCurrentDomainIndex=ptpClockPortCurrentDomainIndex, ptpbaseMIBObjects=ptpbaseMIBObjects, PtpClockRoleType=PtpClockRoleType, ptpbaseSystemEntry=ptpbaseSystemEntry, ptpbaseClockPortRunningName=ptpbaseClockPortRunningName, ptpbaseClockCurrentDSTable=ptpbaseClockCurrentDSTable, ptpbaseClockTimePropertiesDSTable=ptpbaseClockTimePropertiesDSTable, ptpbaseClockPortTransDSFaultyFlag=ptpbaseClockPortTransDSFaultyFlag, ptpbaseClockParentDSEntry=ptpbaseClockParentDSEntry, ptpbaseClockPortDSPTPVersion=ptpbaseClockPortDSPTPVersion, ptpbaseClockPortDSPortIdentity=ptpbaseClockPortDSPortIdentity, ptpbaseClockPortTransDSPortNumberIndex=ptpbaseClockPortTransDSPortNumberIndex, ptpbaseClockPortEntry=ptpbaseClockPortEntry, ptpbaseClockTransDefaultDSClockIdentity=ptpbaseClockTransDefaultDSClockIdentity, ptpbaseClockTimePropertiesDSClockTypeIndex=ptpbaseClockTimePropertiesDSClockTypeIndex, ptpbaseClockPortNumOfAssociatedPorts=ptpbaseClockPortNumOfAssociatedPorts, PtpClockTxModeType=PtpClockTxModeType, ptpbaseClockCurrentDSInstanceIndex=ptpbaseClockCurrentDSInstanceIndex, ptpbaseClockPortRunningClockInstanceIndex=ptpbaseClockPortRunningClockInstanceIndex, ptpbaseClockPortRunningInterfaceIndex=ptpbaseClockPortRunningInterfaceIndex, ptpbaseClockPortRunningPacketsSent=ptpbaseClockPortRunningPacketsSent, ptpbaseWellKnownEncapsulationTypes=ptpbaseWellKnownEncapsulationTypes, ptpbaseClockPortDSPeerDelayReqInterval=ptpbaseClockPortDSPeerDelayReqInterval, ptpbaseMIBClockDefaultDSGroup=ptpbaseMIBClockDefaultDSGroup, ptpbaseClockDefaultDSClockTypeIndex=ptpbaseClockDefaultDSClockTypeIndex, ptpbaseClockTimePropertiesDSTimeTraceable=ptpbaseClockTimePropertiesDSTimeTraceable, ptpbaseClockPortDSPortNumberIndex=ptpbaseClockPortDSPortNumberIndex, ptpbaseClockRunningTable=ptpbaseClockRunningTable, ptpbaseMIBClockPortDSGroup=ptpbaseMIBClockPortDSGroup, ptpbaseClockDefaultDSDomainIndex=ptpbaseClockDefaultDSDomainIndex, ptpbaseClockPortClockInstanceIndex=ptpbaseClockPortClockInstanceIndex, PtpClockQualityAccuracyType=PtpClockQualityAccuracyType, ptpClockPortCurrentClockTypeIndex=ptpClockPortCurrentClockTypeIndex, PtpClockIdentity=PtpClockIdentity, ptpbaseClockTimePropertiesDSFreqTraceable=ptpbaseClockTimePropertiesDSFreqTraceable, ptpbaseEncapsulationTypeUDPIPLSP=ptpbaseEncapsulationTypeUDPIPLSP, ptpbaseMIBClockCurrentDSGroup=ptpbaseMIBClockCurrentDSGroup, ptpbaseClockRunningEntry=ptpbaseClockRunningEntry, ptpbaseClockTimePropertiesDSDomainIndex=ptpbaseClockTimePropertiesDSDomainIndex, ptpbaseClockPortTablePortNumberIndex=ptpbaseClockPortTablePortNumberIndex, ptpbaseClockTimePropertiesDSSource=ptpbaseClockTimePropertiesDSSource, ptpbaseClockDefaultDSPriority2=ptpbaseClockDefaultDSPriority2, ptpbaseClockParentDSClockPhChRate=ptpbaseClockParentDSClockPhChRate, ptpbaseSystemDomainClockTypeIndex=ptpbaseSystemDomainClockTypeIndex, ptpbaseMIBSystemInfoGroup=ptpbaseMIBSystemInfoGroup, ptpbaseMIBConformance=ptpbaseMIBConformance, ptpbaseClockPortCurrentPeerAddressType=ptpbaseClockPortCurrentPeerAddressType, ptpbaseClockCurrentDSDomainIndex=ptpbaseClockCurrentDSDomainIndex, ptpbaseClockPortRunningDomainIndex=ptpbaseClockPortRunningDomainIndex, ptpbaseEncapsulationTypePWEthernetLSP=ptpbaseEncapsulationTypePWEthernetLSP, ptpbaseEncapsulationTypeEthernet=ptpbaseEncapsulationTypeEthernet, PtpClockQualityClassType=PtpClockQualityClassType, ptpbaseTransportTypeIPversion6=ptpbaseTransportTypeIPversion6, PtpClockPortNumber=PtpClockPortNumber, ptpbaseClockDefaultDSQualityClass=ptpbaseClockDefaultDSQualityClass, ptpbaseTransportTypeIEC61158=ptpbaseTransportTypeIEC61158, ptpbaseClockPortDSlogAnnouncementInterval=ptpbaseClockPortDSlogAnnouncementInterval, ptpbaseSystemDomainTotals=ptpbaseSystemDomainTotals, ptpbaseClockPortSyncTwoStep=ptpbaseClockPortSyncTwoStep, ptpbaseClockPortTransDSInstanceIndex=ptpbaseClockPortTransDSInstanceIndex, ptpbaseClockPortDSPeerMeanPathDelay=ptpbaseClockPortDSPeerMeanPathDelay, ptpbaseClockPortAssociateEntry=ptpbaseClockPortAssociateEntry, ptpbaseClockCurrentDSClockTypeIndex=ptpbaseClockCurrentDSClockTypeIndex, ptpbaseClockPortDSGrantDuration=ptpbaseClockPortDSGrantDuration, ptpbaseClockPortTransDSTable=ptpbaseClockPortTransDSTable, ptpbaseClockTransDefaultDSNumOfPorts=ptpbaseClockTransDefaultDSNumOfPorts, ptpbaseClockCurrentDSEntry=ptpbaseClockCurrentDSEntry, ptpbaseClockPortClockTypeIndex=ptpbaseClockPortClockTypeIndex, ptpbaseTransportTypeDeviceNET=ptpbaseTransportTypeDeviceNET)
