...
mibBuilder.exportSymbols("AT-PTP-MIB", ptpTransportTypeControlNET=ptpTransportTypeControlNET, ptpClockDefaultDSQualityClass=ptpClockDefaultDSQualityClass, ptpClockPortDSPeerDelayReqInterval=ptpClockPortDSPeerDelayReqInterval, ptpMIBClockTranparentDSGroup=ptpMIBClockTranparentDSGroup, ptpMIBClockParentDSGroup=ptpMIBClockParentDSGroup, ptpClockPortDSClockInstanceIndex=ptpClockPortDSClockInstanceIndex, PtpClockPortState=PtpClockPortState, ptpClockPortDSPortNumberIndex=ptpClockPortDSPortNumberIndex, ptpClockParentDSGMClockIdentity=ptpClockParentDSGMClockIdentity, PYSNMP_MODULE_ID=atPtpMIB, PtpClockInstanceType=PtpClockInstanceType, ptpClockRunningPacketsReceived=ptpClockRunningPacketsReceived, PtpClockTimeSourceType=PtpClockTimeSourceType, PtpClockDomainType=PtpClockDomainType, ptpSystemEntry=ptpSystemEntry, ptpClockPortRunningInterfaceIndex=ptpClockPortRunningInterfaceIndex, ptpClockPortTablePortNumberIndex=ptpClockPortTablePortNumberIndex, ptpClockPortAssociateOutErrors=ptpClockPortAssociateOutErrors, ptpClockTimePropertiesDSTimeTraceable=ptpClockTimePropertiesDSTimeTraceable, PtpClockTimeInterval=PtpClockTimeInterval, ptpClockPortAssociatePortIndex=ptpClockPortAssociatePortIndex, ptpClockParentDSGMClockQualityOffset=ptpClockParentDSGMClockQualityOffset, ptpClockPortTransDSFaultyFlag=ptpClockPortTransDSFaultyFlag, ptpMIBNotifs=ptpMIBNotifs, ptpClockPortRunningClockInstanceIndex=ptpClockPortRunningClockInstanceIndex, ptpClockPortNumOfAssociatedPorts=ptpClockPortNumOfAssociatedPorts, ptpClockPortTransDSPortNumberIndex=ptpClockPortTransDSPortNumberIndex, ptpClockPortDSlogSyncInterval=ptpClockPortDSlogSyncInterval, ptpClockParentDSInstanceIndex=ptpClockParentDSInstanceIndex, ptpClockPortTable=ptpClockPortTable, ptpEncapsulationTypeEthernet=ptpEncapsulationTypeEthernet, ptpClockPortDSClockTypeIndex=ptpClockPortDSClockTypeIndex, ptpClockPortDSPeerMeanPathDelay=ptpClockPortDSPeerMeanPathDelay, ptpSystemDomainTable=ptpSystemDomainTable, ptpClockPortDSName=ptpClockPortDSName, PtpClockPortTransportTypeAddress=PtpClockPortTransportTypeAddress, ptpClockParentDSGMClockQualityClass=ptpClockParentDSGMClockQualityClass, ptpMIBCompliancesClockInfo=ptpMIBCompliancesClockInfo, ptpMIBClockInfo=ptpMIBClockInfo, ptpClockDefaultDSQualityOffset=ptpClockDefaultDSQualityOffset, ptpClockPortAssociatePacketsReceived=ptpClockPortAssociatePacketsReceived, ptpClockPortDSlogAnnouncementInterval=ptpClockPortDSlogAnnouncementInterval, ptpClockCurrentDSClockTypeIndex=ptpClockCurrentDSClockTypeIndex, ptpClockTimePropertiesDSPTPTimescale=ptpClockTimePropertiesDSPTPTimescale, PtpClockProfileType=PtpClockProfileType, ptpClockDefaultDSDomainIndex=ptpClockDefaultDSDomainIndex, ptpClockDefaultDSQualityAccuracy=ptpClockDefaultDSQualityAccuracy, ptpMIBClockPortRunningGroup=ptpMIBClockPortRunningGroup, ptpClockPortDSAnnounceRctTimeout=ptpClockPortDSAnnounceRctTimeout, ptpClockPortRunningState=ptpClockPortRunningState, ptpEncapsulationTypeVLAN=ptpEncapsulationTypeVLAN, ptpClockPortAssociateTable=ptpClockPortAssociateTable, ptpClockParentDSEntry=ptpClockParentDSEntry, ptpClockParentDSGMClockPriority1=ptpClockParentDSGMClockPriority1, ptpClockPortAssociatePacketsSent=ptpClockPortAssociatePacketsSent, ptpMIBCompliances=ptpMIBCompliances, ptpClockPortCurrentPeerAddress=ptpClockPortCurrentPeerAddress, ptpClockCurrentDSInstanceIndex=ptpClockCurrentDSInstanceIndex, ptpClockParentDSParentPortIdentity=ptpClockParentDSParentPortIdentity, ptpClockParentDSClockPhChRate=ptpClockParentDSClockPhChRate, ptpClockTimePropertiesDSDomainIndex=ptpClockTimePropertiesDSDomainIndex, ptpClockParentDSOffset=ptpClockParentDSOffset, ptpClockRunningTable=ptpClockRunningTable, ptpTransportTypeIEC61158=ptpTransportTypeIEC61158, ptpClockRunningDomainIndex=ptpClockRunningDomainIndex, ptpClockPortTransDSTable=ptpClockPortTransDSTable, ptpClockPortDSDelayMech=ptpClockPortDSDelayMech, ptpClockPortRunningDomainIndex=ptpClockPortRunningDomainIndex, PtpClockStateType=PtpClockStateType, ptpClockPortCurrentClockInstanceIndex=ptpClockPortCurrentClockInstanceIndex, ptpMIBCompliancesTransparentClockInfo=ptpMIBCompliancesTransparentClockInfo, ptpMIBCompliancesSystemInfo=ptpMIBCompliancesSystemInfo, ptpTransportTypeEthernet=ptpTransportTypeEthernet, PtpClockMechanismType=PtpClockMechanismType, ptpClockTimePropertiesDSSource=ptpClockTimePropertiesDSSource, PtpClockIntervalBase2=PtpClockIntervalBase2, ptpDomainIndex=ptpDomainIndex, ptpClockTransDefaultDSClockIdentity=ptpClockTransDefaultDSClockIdentity, ptpClockParentDSTable=ptpClockParentDSTable, ptpClockPortCurrentPortNumberIndex=ptpClockPortCurrentPortNumberIndex, ptpClockTimePropertiesDSCurrentUTCOffset=ptpClockTimePropertiesDSCurrentUTCOffset, ptpClockPortRunningEntry=ptpClockPortRunningEntry, ptpClockPortTransDSDomainIndex=ptpClockPortTransDSDomainIndex, ptpClockPortRunningRxMode=ptpClockPortRunningRxMode, ptpMIBCompliancesClockPortInfo=ptpMIBCompliancesClockPortInfo, ptpEncapsulationTypePWEthernetLSP=ptpEncapsulationTypePWEthernetLSP, ptpClockPortDomainIndex=ptpClockPortDomainIndex, ptpClockPortRunningPacketsReceived=ptpClockPortRunningPacketsReceived, ptpClockPortRunningEncapsulationType=ptpClockPortRunningEncapsulationType, ptpClockTransDefaultDSDomainIndex=ptpClockTransDefaultDSDomainIndex, ptpInstanceIndex=ptpInstanceIndex, ptpClockPortTransDSPortIdentity=ptpClockPortTransDSPortIdentity, ptpMIBGroups=ptpMIBGroups, ptpClockRunningState=ptpClockRunningState, ptpClockPortAssociateEntry=ptpClockPortAssociateEntry, ptpTransportTypeIPversion4=ptpTransportTypeIPversion4, ptpClockPortAssociateAddress=ptpClockPortAssociateAddress, PtpClockType=PtpClockType, ptpClockTransDefaultDSEntry=ptpClockTransDefaultDSEntry, ptpDomainClockPortsTotal=ptpDomainClockPortsTotal, ptpEncapsulationTypePWUDPIPLSP=ptpEncapsulationTypePWUDPIPLSP, ptpClockPortRunningClockTypeIndex=ptpClockPortRunningClockTypeIndex, ptpClockRunningInstanceIndex=ptpClockRunningInstanceIndex, ptpTransportTypeIPversion6=ptpTransportTypeIPversion6, ptpClockTransDefaultDSDelay=ptpClockTransDefaultDSDelay, ptpClockPortEntry=ptpClockPortEntry, ptpClockTransDefaultDSNumOfPorts=ptpClockTransDefaultDSNumOfPorts, ptpClockPortRunningTxMode=ptpClockPortRunningTxMode, ptpClockPortDSMinDelayReqInterval=ptpClockPortDSMinDelayReqInterval, ptpClockTimePropertiesDSClockTypeIndex=ptpClockTimePropertiesDSClockTypeIndex, ptpClockTimePropertiesDSLeap61=ptpClockTimePropertiesDSLeap61, ptpClockParentDSGMClockQualityAccuracy=ptpClockParentDSGMClockQualityAccuracy, ptpClockPortTransDSPeerMeanPathDelay=ptpClockPortTransDSPeerMeanPathDelay, ptpClockCurrentDSStepsRemoved=ptpClockCurrentDSStepsRemoved, ptpClockTimePropertiesDSLeap59=ptpClockTimePropertiesDSLeap59, ptpClockTimePropertiesDSFreqTraceable=ptpClockTimePropertiesDSFreqTraceable, ptpClockParentDSGMClockPriority2=ptpClockParentDSGMClockPriority2, ptpMIBClockCurrentDSGroup=ptpMIBClockCurrentDSGroup, ptpClockDefaultDSInstanceIndex=ptpClockDefaultDSInstanceIndex, ptpClockDefaultDSSlaveOnly=ptpClockDefaultDSSlaveOnly, ptpClockPortDSTable=ptpClockPortDSTable, ptpSystemDomainTotals=ptpSystemDomainTotals, ptpClockRunningEntry=ptpClockRunningEntry, ptpClockPortAssociateAddressType=ptpClockPortAssociateAddressType, ptpClockPortCurrentDomainIndex=ptpClockPortCurrentDomainIndex, ptpClockPortSyncTwoStep=ptpClockPortSyncTwoStep, ptpClockPortRunningPacketsSent=ptpClockPortRunningPacketsSent, ptpMIBClockPortAssociateGroup=ptpMIBClockPortAssociateGroup, ptpClockCurrentDSOffsetFromMaster=ptpClockCurrentDSOffsetFromMaster, ptpEncapsulationTypeUDPIPLSP=ptpEncapsulationTypeUDPIPLSP, PtpClockRoleType=PtpClockRoleType, ptpClockDefaultDSTable=ptpClockDefaultDSTable, ptpClockPortRunningName=ptpClockPortRunningName, ptpClockDefaultDSClockTypeIndex=ptpClockDefaultDSClockTypeIndex, ptpMIBConformance=ptpMIBConformance, ptpClockPortDSEntry=ptpClockPortDSEntry, ptpClockParentDSParentStats=ptpClockParentDSParentStats, ptpClockTransDefaultDSInstanceIndex=ptpClockTransDefaultDSInstanceIndex, ptpClockPortTransDSEntry=ptpClockPortTransDSEntry, atPtpMIB=atPtpMIB, ptpSystemDomainEntry=ptpSystemDomainEntry, ptpClockPortDSDomainIndex=ptpClockPortDSDomainIndex, ptpMIBClockPortGroup=ptpMIBClockPortGroup, ptpClockPortRunningPortNumberIndex=ptpClockPortRunningPortNumberIndex, ptpClockDefaultDSPriority1=ptpClockDefaultDSPriority1, ptpClockPortRole=ptpClockPortRole, ptpClockPortClockInstanceIndex=ptpClockPortClockInstanceIndex, ptpClockTimePropertiesDSCurrentUTCOffsetValid=ptpClockTimePropertiesDSCurrentUTCOffsetValid, ptpClockCurrentDSTable=ptpClockCurrentDSTable, ptpClockPortDSGrantDuration=ptpClockPortDSGrantDuration, PtpClockTxModeType=PtpClockTxModeType, ptpMIBSystemInfoGroup=ptpMIBSystemInfoGroup, ptpClockRunningPacketsSent=ptpClockRunningPacketsSent, ptpWellKnownEncapsulationTypes=ptpWellKnownEncapsulationTypes, ptpClockParentDSClockTypeIndex=ptpClockParentDSClockTypeIndex, ptpClockPortDSPortIdentity=ptpClockPortDSPortIdentity, ptpMIBClockTimepropertiesGroup=ptpMIBClockTimepropertiesGroup, PtpClockQualityAccuracyType=PtpClockQualityAccuracyType, ptpClockPortAssociateInErrors=ptpClockPortAssociateInErrors, ptpClockCurrentDSDomainIndex=ptpClockCurrentDSDomainIndex, PtpClockIdentity=PtpClockIdentity, ptpClockPortCurrentClockTypeIndex=ptpClockPortCurrentClockTypeIndex, ptpClockDefaultDSTwoStepFlag=ptpClockDefaultDSTwoStepFlag, ptpMIBClockPortTransDSGroup=ptpMIBClockPortTransDSGroup, ptpClockPortName=ptpClockPortName, ptpSystemTable=ptpSystemTable, ptpClockPortRunningRole=ptpClockPortRunningRole, ptpClockParentDSDomainIndex=ptpClockParentDSDomainIndex, ptpMIBClockPortDSGroup=ptpMIBClockPortDSGroup, ptpClockPortRunningTransport=ptpClockPortRunningTransport, ptpClockPortTransDSlogMinPdelayReqInt=ptpClockPortTransDSlogMinPdelayReqInt, ptpClockTimePropertiesDSEntry=ptpClockTimePropertiesDSEntry, ptpClockRunningClockTypeIndex=ptpClockRunningClockTypeIndex, ptpClockPortDSPTPVersion=ptpClockPortDSPTPVersion, ptpClockDefaultDSEntry=ptpClockDefaultDSEntry, ptpClockPortTransDSInstanceIndex=ptpClockPortTransDSInstanceIndex, PtpClockQualityClassType=PtpClockQualityClassType, ptpClockDefaultDSClockIdentity=ptpClockDefaultDSClockIdentity, ptpClockTimePropertiesDSTable=ptpClockTimePropertiesDSTable, ptpSystemProfile=ptpSystemProfile, PtpClockPortNumber=PtpClockPortNumber, ptpClockTransDefaultDSTable=ptpClockTransDefaultDSTable, ptpMIBClockRunningGroup=ptpMIBClockRunningGroup, ptpSystemDomainClockTypeIndex=ptpSystemDomainClockTypeIndex, ptpClockDefaultDSPriority2=ptpClockDefaultDSPriority2, ptpClockCurrentDSEntry=ptpClockCurrentDSEntry, ptpClockTimePropertiesDSInstanceIndex=ptpClockTimePropertiesDSInstanceIndex, ptpMIBObjects=ptpMIBObjects, ptpMIBClockDefaultDSGroup=ptpMIBClockDefaultDSGroup, ptpMIBSystemInfo=ptpMIBSystemInfo, ptpWellKnownTransportTypes=ptpWellKnownTransportTypes, ptpClockPortRunningTable=ptpClockPortRunningTable, ptpClockTransDefaultDSPrimaryDomain=ptpClockTransDefaultDSPrimaryDomain, ptpClockPortClockTypeIndex=ptpClockPortClockTypeIndex, ptpTransportTypeDeviceNET=ptpTransportTypeDeviceNET, ptpClockCurrentDSMeanPathDelay=ptpClockCurrentDSMeanPathDelay, ptpClockPortCurrentPeerAddressType=ptpClockPortCurrentPeerAddressType)
