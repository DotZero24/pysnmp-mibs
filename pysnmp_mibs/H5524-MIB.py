# SNMP MIB module (H5524-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/H5524-MIB
...
trapTest.setObjects(
      *(("H5524-MIB", "sensorName"),
        ("H5524-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
