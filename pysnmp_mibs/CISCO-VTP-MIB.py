...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-VTP-MIB
...
DisplayString, TimeStamp, RowStatus, TestAndIncr, DateAndTime, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowStatus", "TestAndIncr", "DateAndTime", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vtpStatus=vtpStatus, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vlanTrunkPortEntry=vlanTrunkPortEntry, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, vlanStatsInternalVlans=vlanStatsInternalVlans, vtpVlanEditRingNumber=vtpVlanEditRingNumber, managementDomainPruningStateOper=managementDomainPruningStateOper, vtpMIBCompliance12=vtpMIBCompliance12, vtpAuthGroup=vtpAuthGroup, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vtpAuthEntry=vtpAuthEntry, vtpVlanApplyStatus=vtpVlanApplyStatus, managementDomainConfigFile=managementDomainConfigFile, vtpVlanEditState=vtpVlanEditState, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpMIBObjects=vtpMIBObjects, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vtpAuthentication=vtpAuthentication, vtpInternalVlanOwner=vtpInternalVlanOwner, vtpVlanBridgeType=vtpVlanBridgeType, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vtpVlanEditDot10Said=vtpVlanEditDot10Said, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, vtpDatabaseEntry=vtpDatabaseEntry, vtpVlanLocalShutdownTable=vtpVlanLocalShutdownTable, vtpVlanDeleted=vtpVlanDeleted, vtpDatabaseTable=vtpDatabaseTable, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpStats=vtpStats, vtpVlanAreHopCount=vtpVlanAreHopCount, vtpInAdvertRequests=vtpInAdvertRequests, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, ManagementDomainIndex=ManagementDomainIndex, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, VlanTypeExt=VlanTypeExt, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, VlanIndex=VlanIndex, vtpEditControlEntry=vtpEditControlEntry, vtpConfigRevNumberError=vtpConfigRevNumberError, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vtpDiscoverAction=vtpDiscoverAction, vtpTrunkPortGroup=vtpTrunkPortGroup, vtpVlanState=vtpVlanState, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpVlanCreated=vtpVlanCreated, vtpMIBCompliance15=vtpMIBCompliance15, vtpTrunkPortGroup2=vtpTrunkPortGroup2, internalVlanInfo=internalVlanInfo, vtpVlanEditIndex=vtpVlanEditIndex, vtpMIBCompliance5=vtpMIBCompliance5, vtpNotificationsPrefix=vtpNotificationsPrefix, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, vtpVlanEditBridgeType=vtpVlanEditBridgeType, vtpStatsTable=vtpStatsTable, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, managementDomainSourceOnlyMode=managementDomainSourceOnlyMode, vtpVersionInUseChanged=vtpVersionInUseChanged, vtpVlanRingNumber=vtpVlanRingNumber, vtpVlanEditMtu=vtpVlanEditMtu, vtpVlanName=vtpVlanName, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpLocalModeChanged=vtpLocalModeChanged, vtpDiscoverEntry=vtpDiscoverEntry, PYSNMP_MODULE_ID=ciscoVtpMIB, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vtpMIBCompliance4=vtpMIBCompliance4, vtpMIBCompliance7=vtpMIBCompliance7, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vtpNotificationsObjects=vtpNotificationsObjects, vtpMIBCompliance6=vtpMIBCompliance6, vtpMIBCompliance16=vtpMIBCompliance16, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vtpTrunkPruningGroup3=vtpTrunkPruningGroup3, vtpMIBCompliance13=vtpMIBCompliance13, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vtpDatabaseIndex=vtpDatabaseIndex, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpVlanIfIndex=vtpVlanIfIndex, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vtpMtuTooBig=vtpMtuTooBig, vtpSourceInterfaceGroup=vtpSourceInterfaceGroup, managementDomainPruningState=managementDomainPruningState, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, vtpVlanEntry=vtpVlanEntry, vtpVlanEditStpType=vtpVlanEditStpType, vlanTrunkPortActiveVlansGroup=vlanTrunkPortActiveVlansGroup, vtpNotificationsEnabled=vtpNotificationsEnabled, vtpStatsEntry=vtpStatsEntry, vtpVlanDot10Said=vtpVlanDot10Said, managementDomainRowStatus=managementDomainRowStatus, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vtpVlanLocalShutdownEntry=vtpVlanLocalShutdownEntry, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vtpVlanInfoGroup=vtpVlanInfoGroup, managementDomainLastUpdater=managementDomainLastUpdater, vtpMIBGroups=vtpMIBGroups, vtpVersion=vtpVersion, managementDomainLocalUpdater=managementDomainLocalUpdater, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vtp4kVlanGroup=vtp4kVlanGroup, vlanTrunkPorts=vlanTrunkPorts, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vtpMIBCompliances=vtpMIBCompliances, vtpVlanType=vtpVlanType, managementDomainAdminSrcIf=managementDomainAdminSrcIf, vlanStatistics=vlanStatistics, managementDomainEntry=managementDomainEntry, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vtpServerDisabled=vtpServerDisabled, vtpDiscover=vtpDiscover, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, vtpVlanEditType=vtpVlanEditType, vtpVlanTypeExt=vtpVlanTypeExt, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vtpDiscoverGroup=vtpDiscoverGroup, vlanManagementDomains=vlanManagementDomains, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vtpVlanEditTable=vtpVlanEditTable, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, managementDomainTftpServer=managementDomainTftpServer, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpMIBCompliance11=vtpMIBCompliance11, vtpInternalVlanGrp=vtpInternalVlanGrp, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vtpDatabaseName=vtpDatabaseName, vtpMIBCompliance=vtpMIBCompliance, vtpMIBCompliance8=vtpMIBCompliance8, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vtpVlanSteHopCount=vtpVlanSteHopCount, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, managementDomainTable=managementDomainTable, vtpVlanLocalShutdown=vtpVlanLocalShutdown, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpDeviceIdGroup=vtpDeviceIdGroup, vlanTrunkPortTable=vlanTrunkPortTable, vlanInfo=vlanInfo, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, vtpDatabase=vtpDatabase, vtpVlanParentVlan=vtpVlanParentVlan, managementDomainOperSrcIf=managementDomainOperSrcIf, vtpMIBCompliance14=vtpMIBCompliance14, vtpVersion2BasicGroup=vtpVersion2BasicGroup, vtpOutAdvertRequests=vtpOutAdvertRequests, managementDomainLocalMode=managementDomainLocalMode, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpVlanEditOperation=vtpVlanEditOperation, vtpAuthSecretKey=vtpAuthSecretKey, vtpMIBConformance=vtpMIBConformance, vlanStatsFreeVlans=vlanStatsFreeVlans, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vtpDiscoverTable=vtpDiscoverTable, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vtpVlanIndex=vtpVlanIndex, vtpPruningStateOperChange=vtpPruningStateOperChange, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, vlanTrunkPortVlansActiveFirst2k=vlanTrunkPortVlansActiveFirst2k, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vtpBasicGroup=vtpBasicGroup, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, vtpAuthPassword=vtpAuthPassword, vtpInSubsetAdverts=vtpInSubsetAdverts, vtpVlanTable=vtpVlanTable, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, vlanEdit=vlanEdit, vtpDatabaseGroup=vtpDatabaseGroup, managementDomainConfigRevNumber=managementDomainConfigRevNumber, managementDomainDeviceID=managementDomainDeviceID, vtpInternalVlanTable=vtpInternalVlanTable, vtpInternalVlanEntry=vtpInternalVlanEntry, vtpMIBCompliance9=vtpMIBCompliance9, managementDomainLocalUpdaterType=managementDomainLocalUpdaterType, vtpMaxVlanStorage=vtpMaxVlanStorage, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, vtpConfigNotificationsGroup7=vtpConfigNotificationsGroup7, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpAuthenticationTable=vtpAuthenticationTable, managementDomainName=managementDomainName, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vlanStatsGroup=vlanStatsGroup, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpDiscoverStatus=vtpDiscoverStatus, vtpConfigNotificationsGroup6=vtpConfigNotificationsGroup6, managementDomainVersionInUse=managementDomainVersionInUse, vtpVlanEditEntry=vtpVlanEditEntry, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vtpMIBCompliance3=vtpMIBCompliance3, vtpConfigDigestError=vtpConfigDigestError, vlanTrunkPortVlansActiveSecond2k=vlanTrunkPortVlansActiveSecond2k, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, managementDomainLastChange=managementDomainLastChange, vtpEditControlTable=vtpEditControlTable, vtpStatsGroup=vtpStatsGroup, vtpLocalUpdaterGroup=vtpLocalUpdaterGroup, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vtpConfigFileGroup=vtpConfigFileGroup, vtpVlanStpType=vtpVlanStpType, managementDomainIndex=managementDomainIndex, vlanStatsExtendedVlans=vlanStatsExtendedVlans, vtpMIBCompliance10=vtpMIBCompliance10, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, ciscoVtpMIB=ciscoVtpMIB, vtpVlanLocalShutdownGroup=vtpVlanLocalShutdownGroup, vtpConfigNotificationsGroup8=vtpConfigNotificationsGroup8, vlanStatsVlans=vlanStatsVlans, VlanType=VlanType, vtpVlanMtu=vtpVlanMtu, vtpVlanEditName=vtpVlanEditName, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpNotifications=vtpNotifications, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpMIBCompliance2=vtpMIBCompliance2, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpAuthPasswordType=vtpAuthPasswordType, managementDomainTftpPathname=managementDomainTftpPathname, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2)
