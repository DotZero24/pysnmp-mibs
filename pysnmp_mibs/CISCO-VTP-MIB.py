...
RowStatus, DateAndTime, TextualConvention, TestAndIncr, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TextualConvention", "TestAndIncr", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vtpStats=vtpStats, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpVlanEditTable=vtpVlanEditTable, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vlanStatsFreeVlans=vlanStatsFreeVlans, managementDomainEntry=managementDomainEntry, vlanStatsGroup=vlanStatsGroup, vtpAuthPassword=vtpAuthPassword, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vtpVlanLocalShutdownEntry=vtpVlanLocalShutdownEntry, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vlanTrunkPortEntry=vlanTrunkPortEntry, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vtpVlanIfIndex=vtpVlanIfIndex, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, managementDomainConfigRevNumber=managementDomainConfigRevNumber, vtpMIBCompliance9=vtpMIBCompliance9, managementDomainAdminSrcIf=managementDomainAdminSrcIf, vtpInternalVlanEntry=vtpInternalVlanEntry, vlanStatsExtendedVlans=vlanStatsExtendedVlans, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpAuthSecretKey=vtpAuthSecretKey, vtpBasicGroup=vtpBasicGroup, vtpVlanEditEntry=vtpVlanEditEntry, vtpMIBCompliance15=vtpMIBCompliance15, vtpMIBCompliance13=vtpMIBCompliance13, vtpVlanState=vtpVlanState, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vtpStatsEntry=vtpStatsEntry, vtpConfigNotificationsGroup7=vtpConfigNotificationsGroup7, vtpVlanDot10Said=vtpVlanDot10Said, vtpLocalUpdaterGroup=vtpLocalUpdaterGroup, managementDomainLocalMode=managementDomainLocalMode, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, vtpMIBCompliance10=vtpMIBCompliance10, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, managementDomainDeviceID=managementDomainDeviceID, vtpVlanEditIndex=vtpVlanEditIndex, vtpDiscoverEntry=vtpDiscoverEntry, managementDomainConfigFile=managementDomainConfigFile, vtpEditControlEntry=vtpEditControlEntry, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vtpMIBCompliances=vtpMIBCompliances, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpAuthGroup=vtpAuthGroup, vtpMIBCompliance=vtpMIBCompliance, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, managementDomainName=managementDomainName, VlanTypeExt=VlanTypeExt, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, vtpVersion=vtpVersion, vtpMIBCompliance2=vtpMIBCompliance2, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vtpTrunkPortGroup=vtpTrunkPortGroup, managementDomainLastUpdater=managementDomainLastUpdater, managementDomainOperSrcIf=managementDomainOperSrcIf, vtpVlanEntry=vtpVlanEntry, vtpAuthentication=vtpAuthentication, vtpMIBCompliance3=vtpMIBCompliance3, vtp4kVlanGroup=vtp4kVlanGroup, vtpTrunkPruningGroup3=vtpTrunkPruningGroup3, vtpLocalModeChanged=vtpLocalModeChanged, vtpVlanEditStpType=vtpVlanEditStpType, vtpStatsTable=vtpStatsTable, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, managementDomainLocalUpdaterType=managementDomainLocalUpdaterType, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vtpMIBGroups=vtpMIBGroups, vtpEditControlTable=vtpEditControlTable, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vtpDatabaseIndex=vtpDatabaseIndex, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vlanManagementDomains=vlanManagementDomains, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vtpTrunkPortGroup2=vtpTrunkPortGroup2, vlanInfo=vlanInfo, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vtpDiscoverTable=vtpDiscoverTable, vtpAuthPasswordType=vtpAuthPasswordType, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vtpVlanEditRingNumber=vtpVlanEditRingNumber, vtpAuthEntry=vtpAuthEntry, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vlanTrunkPortVlansActiveSecond2k=vlanTrunkPortVlansActiveSecond2k, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vtpInternalVlanOwner=vtpInternalVlanOwner, vtpVlanLocalShutdownGroup=vtpVlanLocalShutdownGroup, vtpVlanParentVlan=vtpVlanParentVlan, vtpMaxVlanStorage=vtpMaxVlanStorage, VlanIndex=VlanIndex, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vlanTrunkPortVlansActiveFirst2k=vlanTrunkPortVlansActiveFirst2k, vtpDeviceIdGroup=vtpDeviceIdGroup, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, vtpVlanDeleted=vtpVlanDeleted, vlanTrunkPorts=vlanTrunkPorts, vtpDiscover=vtpDiscover, vtpMIBCompliance11=vtpMIBCompliance11, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpServerDisabled=vtpServerDisabled, vtpVlanEditBridgeType=vtpVlanEditBridgeType, vtpVlanAreHopCount=vtpVlanAreHopCount, vtpVersion2BasicGroup=vtpVersion2BasicGroup, managementDomainLocalUpdater=managementDomainLocalUpdater, vtpStatus=vtpStatus, vtpVlanIndex=vtpVlanIndex, managementDomainPruningStateOper=managementDomainPruningStateOper, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vtpVlanLocalShutdown=vtpVlanLocalShutdown, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, vtpDatabaseName=vtpDatabaseName, vtpMtuTooBig=vtpMtuTooBig, vtpInternalVlanTable=vtpInternalVlanTable, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vtpVlanBridgeType=vtpVlanBridgeType, vtpVlanRingNumber=vtpVlanRingNumber, vtpVlanEditDot10Said=vtpVlanEditDot10Said, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vlanStatsVlans=vlanStatsVlans, managementDomainSourceOnlyMode=managementDomainSourceOnlyMode, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, vtpVlanApplyStatus=vtpVlanApplyStatus, vtpVlanInfoGroup=vtpVlanInfoGroup, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpDiscoverStatus=vtpDiscoverStatus, vlanTrunkPortTable=vlanTrunkPortTable, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpInAdvertRequests=vtpInAdvertRequests, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vtpMIBCompliance5=vtpMIBCompliance5, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, vtpVlanEditType=vtpVlanEditType, vtpVlanType=vtpVlanType, vtpDiscoverGroup=vtpDiscoverGroup, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpDatabaseEntry=vtpDatabaseEntry, vtpPruningStateOperChange=vtpPruningStateOperChange, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vtpConfigRevNumberError=vtpConfigRevNumberError, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vtpVlanEditState=vtpVlanEditState, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtpMIBObjects=vtpMIBObjects, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, ciscoVtpMIB=ciscoVtpMIB, managementDomainTable=managementDomainTable, vtpConfigDigestError=vtpConfigDigestError, managementDomainLastChange=managementDomainLastChange, managementDomainPruningState=managementDomainPruningState, vtpNotifications=vtpNotifications, vtpVlanStpType=vtpVlanStpType, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpDatabaseGroup=vtpDatabaseGroup, vtpNotificationsEnabled=vtpNotificationsEnabled, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vtpMIBCompliance8=vtpMIBCompliance8, vtpMIBCompliance12=vtpMIBCompliance12, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vlanTrunkPortActiveVlansGroup=vlanTrunkPortActiveVlansGroup, vtpStatsGroup=vtpStatsGroup, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vtpVlanEditOperation=vtpVlanEditOperation, managementDomainTftpPathname=managementDomainTftpPathname, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vtpMIBConformance=vtpMIBConformance, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpVlanTable=vtpVlanTable, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vtpVlanSteHopCount=vtpVlanSteHopCount, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vtpVlanLocalShutdownTable=vtpVlanLocalShutdownTable, PYSNMP_MODULE_ID=ciscoVtpMIB, vtpInSubsetAdverts=vtpInSubsetAdverts, managementDomainTftpServer=managementDomainTftpServer, vtpVersionInUseChanged=vtpVersionInUseChanged, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, managementDomainRowStatus=managementDomainRowStatus, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vtpConfigNotificationsGroup8=vtpConfigNotificationsGroup8, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vtpAuthenticationTable=vtpAuthenticationTable, vtpVlanMtu=vtpVlanMtu, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpDatabaseTable=vtpDatabaseTable, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vtpVlanCreated=vtpVlanCreated, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vtpMIBCompliance14=vtpMIBCompliance14, vtpSourceInterfaceGroup=vtpSourceInterfaceGroup, vtpOutAdvertRequests=vtpOutAdvertRequests, vlanStatsInternalVlans=vlanStatsInternalVlans, internalVlanInfo=internalVlanInfo, vtpDatabase=vtpDatabase, vtpMIBCompliance6=vtpMIBCompliance6, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vtpVlanTypeExt=vtpVlanTypeExt, vtpNotificationsPrefix=vtpNotificationsPrefix, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, managementDomainIndex=managementDomainIndex, vtpConfigFileGroup=vtpConfigFileGroup, vtpMIBCompliance4=vtpMIBCompliance4, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, vtpVlanName=vtpVlanName, vtpDiscoverAction=vtpDiscoverAction, vtpMIBCompliance7=vtpMIBCompliance7, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, vtpNotificationsObjects=vtpNotificationsObjects, vtpMIBCompliance16=vtpMIBCompliance16, vtpConfigNotificationsGroup6=vtpConfigNotificationsGroup6, vtpVlanEditName=vtpVlanEditName, vlanEdit=vlanEdit, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpVlanEditMtu=vtpVlanEditMtu, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, VlanType=VlanType, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vlanStatistics=vlanStatistics, vtpInternalVlanGrp=vtpInternalVlanGrp, managementDomainVersionInUse=managementDomainVersionInUse, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, ManagementDomainIndex=ManagementDomainIndex)
