...
_D='Integer32'
_C='read-only'
_B='NETGEAR-AUTHENTICATION-MANAGER-MIB'
_A='current'
...
fastPathAuthMgr=ModuleIdentity((1,3,6,1,4,1,4526,10,61))
if mibBuilder.loadTexts:fastPathAuthMgr.setRevisions(('2012-12-28 00:00',))
_FastpathAuthMgrTraps_ObjectIdentity=ObjectIdentity
fastpathAuthMgrTraps=_FastpathAuthMgrTraps_ObjectIdentity((1,3,6,1,4,1,4526,10,61,0))
_AgentAuthMgrGlobalConfigGroup_ObjectIdentity=ObjectIdentity
agentAuthMgrGlobalConfigGroup=_AgentAuthMgrGlobalConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,61,1))
...
agentAuthMgrAdminMode=_AgentAuthMgrAdminMode_Object((1,3,6,1,4,1,4526,10,61,1,1),_AgentAuthMgrAdminMode_Type())
...
agentAuthMgrInterfaceConfigGroup=_AgentAuthMgrInterfaceConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,61,2))
_AgentAuthMgrInterfaceConfigMethodTable_Object=MibTable
agentAuthMgrInterfaceConfigMethodTable=_AgentAuthMgrInterfaceConfigMethodTable_Object((1,3,6,1,4,1,4526,10,61,2,1))
...
agentAuthMgrInterfaceConfigMethodEntry=_AgentAuthMgrInterfaceConfigMethodEntry_Object((1,3,6,1,4,1,4526,10,61,2,1,1))
...
agentAuthMgrIfIndex=_AgentAuthMgrIfIndex_Object((1,3,6,1,4,1,4526,10,61,2,1,1,1),_AgentAuthMgrIfIndex_Type())
...
methodIndex=_MethodIndex_Object((1,3,6,1,4,1,4526,10,61,2,1,1,2),_MethodIndex_Type())
...
agentAuthMgrMethodOrder=_AgentAuthMgrMethodOrder_Object((1,3,6,1,4,1,4526,10,61,2,1,1,3),_AgentAuthMgrMethodOrder_Type())
...
agentAuthMgrMethodPriority=_AgentAuthMgrMethodPriority_Object((1,3,6,1,4,1,4526,10,61,2,1,1,4),_AgentAuthMgrMethodPriority_Type())
...
agentAuthMgrInterfaceConfigTimerTable=_AgentAuthMgrInterfaceConfigTimerTable_Object((1,3,6,1,4,1,4526,10,61,2,2))
...
agentAuthMgrInterfaceConfigTimerEntry=_AgentAuthMgrInterfaceConfigTimerEntry_Object((1,3,6,1,4,1,4526,10,61,2,2,1))
...
agentAuthMgrTimerIfIndex=_AgentAuthMgrTimerIfIndex_Object((1,3,6,1,4,1,4526,10,61,2,2,1,1),_AgentAuthMgrTimerIfIndex_Type())
agentAuthMgrTimerIfIndex.setMaxAccess(_I)
if mibBuilder.loadTexts:agentAuthMgrTimerIfIndex.setStatus(_A)
class _AgentAuthMgrRestart_Type(Unsigned32):defaultValue=300;subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(300,65535))
_AgentAuthMgrRestart_Type.__name__=_Q
_AgentAuthMgrRestart_Object=MibTableColumn
agentAuthMgrRestart=_AgentAuthMgrRestart_Object((1,3,6,1,4,1,4526,10,61,2,2,1,2),_AgentAuthMgrRestart_Type())
...
agentAuthMgrInterfaceStatusGroup=_AgentAuthMgrInterfaceStatusGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,61,3))
_AgentAuthMgrInterfaceStatusTable_Object=MibTable
agentAuthMgrInterfaceStatusTable=_AgentAuthMgrInterfaceStatusTable_Object((1,3,6,1,4,1,4526,10,61,3,1))
...
agentAuthMgrInterfaceStatusEntry=_AgentAuthMgrInterfaceStatusEntry_Object((1,3,6,1,4,1,4526,10,61,3,1,1))
...
agentAuthMgrStatusMethodOrder=_AgentAuthMgrStatusMethodOrder_Object((1,3,6,1,4,1,4526,10,61,3,1,1,1),_AgentAuthMgrStatusMethodOrder_Type())
...
agentAuthMgrStatusMethodPriority=_AgentAuthMgrStatusMethodPriority_Object((1,3,6,1,4,1,4526,10,61,3,1,1,2),_AgentAuthMgrStatusMethodPriority_Type())
...
agentAuthMgrClientStatusGroup=_AgentAuthMgrClientStatusGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,61,4))
_AgentAuthMgrClientStatusTable_Object=MibTable
agentAuthMgrClientStatusTable=_AgentAuthMgrClientStatusTable_Object((1,3,6,1,4,1,4526,10,61,4,1))
if mibBuilder.loadTexts:agentAuthMgrClientStatusTable.setStatus(_A)
_AgentAuthMgrClientStatusEntry_Object=MibTableRow
agentAuthMgrClientStatusEntry=_AgentAuthMgrClientStatusEntry_Object((1,3,6,1,4,1,4526,10,61,4,1,1))
...
agentAuthMgrClientMacAddress=_AgentAuthMgrClientMacAddress_Object((1,3,6,1,4,1,4526,10,61,4,1,1,1),_AgentAuthMgrClientMacAddress_Type())
...
agentAuthMgrLogicalPort=_AgentAuthMgrLogicalPort_Object((1,3,6,1,4,1,4526,10,61,4,1,1,2),_AgentAuthMgrLogicalPort_Type())
...
agentAuthMgrInterface=_AgentAuthMgrInterface_Object((1,3,6,1,4,1,4526,10,61,4,1,1,3),_AgentAuthMgrInterface_Type())
...
agentAuthMgrClientAuthstatus=_AgentAuthMgrClientAuthstatus_Object((1,3,6,1,4,1,4526,10,61,4,1,1,4),_AgentAuthMgrClientAuthstatus_Type())
...
agentAuthMgrClientAuthMethod=_AgentAuthMgrClientAuthMethod_Object((1,3,6,1,4,1,4526,10,61,4,1,1,5),_AgentAuthMgrClientAuthMethod_Type())
...
agentAuthMgrAuthHistoryResultsGroup=_AgentAuthMgrAuthHistoryResultsGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,61,5))
_AgentAuthMgrPortAuthHistoryResultTable_Object=MibTable
agentAuthMgrPortAuthHistoryResultTable=_AgentAuthMgrPortAuthHistoryResultTable_Object((1,3,6,1,4,1,4526,10,61,5,1))
...
agentAuthMgrPortAuthHistoryResultEntry=_AgentAuthMgrPortAuthHistoryResultEntry_Object((1,3,6,1,4,1,4526,10,61,5,1,1))
...
agentAuthMgrAuthHistoryResultIfaceIndex=_AgentAuthMgrAuthHistoryResultIfaceIndex_Object((1,3,6,1,4,1,4526,10,61,5,1,1,1),_AgentAuthMgrAuthHistoryResultIfaceIndex_Type())
...
agentAuthMgrAuthHistoryResultIndex=_AgentAuthMgrAuthHistoryResultIndex_Object((1,3,6,1,4,1,4526,10,61,5,1,1,2),_AgentAuthMgrAuthHistoryResultIndex_Type())
...
agentAuthMgrAuthHistoryResultTimeStamp=_AgentAuthMgrAuthHistoryResultTimeStamp_Object((1,3,6,1,4,1,4526,10,61,5,1,1,3),_AgentAuthMgrAuthHistoryResultTimeStamp_Type())
...
agentAuthMgrAuthHistoryResultMacAddress=_AgentAuthMgrAuthHistoryResultMacAddress_Object((1,3,6,1,4,1,4526,10,61,5,1,1,4),_AgentAuthMgrAuthHistoryResultMacAddress_Type())
...
agentAuthMgrAuthHistoryResultAuthMethod=_AgentAuthMgrAuthHistoryResultAuthMethod_Object((1,3,6,1,4,1,4526,10,61,5,1,1,5),_AgentAuthMgrAuthHistoryResultAuthMethod_Type())
...
agentAuthMgrAuthHistoryResultAuthStatus=_AgentAuthMgrAuthHistoryResultAuthStatus_Object((1,3,6,1,4,1,4526,10,61,5,1,1,6),_AgentAuthMgrAuthHistoryResultAuthStatus_Type())
...
agentAuthMgrPortAuthHistoryResultClearTable=_AgentAuthMgrPortAuthHistoryResultClearTable_Object((1,3,6,1,4,1,4526,10,61,5,3))
...
agentAuthMgrPortAuthHistoryResultClearEntry=_AgentAuthMgrPortAuthHistoryResultClearEntry_Object((1,3,6,1,4,1,4526,10,61,5,3,1))
...
agentAuthMgrAuthHistoryResultIfIndex=_AgentAuthMgrAuthHistoryResultIfIndex_Object((1,3,6,1,4,1,4526,10,61,5,3,1,1),_AgentAuthMgrAuthHistoryResultIfIndex_Type())
...
agentAuthMgrPortAuthHistoryResultsClear=_AgentAuthMgrPortAuthHistoryResultsClear_Object((1,3,6,1,4,1,4526,10,61,5,3,1,2),_AgentAuthMgrPortAuthHistoryResultsClear_Type())
...
agentAuthMgrAuthStatsGroup=_AgentAuthMgrAuthStatsGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,61,6))
_AgentAuthMgrPortStatsTable_Object=MibTable
agentAuthMgrPortStatsTable=_AgentAuthMgrPortStatsTable_Object((1,3,6,1,4,1,4526,10,61,6,1))
if mibBuilder.loadTexts:agentAuthMgrPortStatsTable.setStatus(_A)
_AgentAuthMgrPortStatsEntry_Object=MibTableRow
agentAuthMgrPortStatsEntry=_AgentAuthMgrPortStatsEntry_Object((1,3,6,1,4,1,4526,10,61,6,1,1))
...
agentAuthMgrPortIfaceIndex=_AgentAuthMgrPortIfaceIndex_Object((1,3,6,1,4,1,4526,10,61,6,1,1,1),_AgentAuthMgrPortIfaceIndex_Type())
...
agentAuthMgrPortMethodIndex=_AgentAuthMgrPortMethodIndex_Object((1,3,6,1,4,1,4526,10,61,6,1,1,2),_AgentAuthMgrPortMethodIndex_Type())
...
agentAuthMgrPortStatsAttempts=_AgentAuthMgrPortStatsAttempts_Object((1,3,6,1,4,1,4526,10,61,6,1,1,3),_AgentAuthMgrPortStatsAttempts_Type())
...
agentAuthMgrPortStatsFailedAttempts=_AgentAuthMgrPortStatsFailedAttempts_Object((1,3,6,1,4,1,4526,10,61,6,1,1,4),_AgentAuthMgrPortStatsFailedAttempts_Type())
...
agentAuthMgrPortStatsClearTable=_AgentAuthMgrPortStatsClearTable_Object((1,3,6,1,4,1,4526,10,61,6,2))
if mibBuilder.loadTexts:agentAuthMgrPortStatsClearTable.setStatus(_A)
_AgentAuthMgrPortStatsClearEntry_Object=MibTableRow
agentAuthMgrPortStatsClearEntry=_AgentAuthMgrPortStatsClearEntry_Object((1,3,6,1,4,1,4526,10,61,6,2,1))
...
agentAuthMgrPortStatsClear=_AgentAuthMgrPortStatsClear_Object((1,3,6,1,4,1,4526,10,61,6,2,1,2),_AgentAuthMgrPortStatsClear_Type())
...
agentAuthMgrTrapsConfigGroup=_AgentAuthMgrTrapsConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,61,7))
...
authMgrTrapMode=_AuthMgrTrapMode_Object((1,3,6,1,4,1,4526,10,61,7,1),_AuthMgrTrapMode_Type())
authMgrTrapMode.setMaxAccess(_H)
if mibBuilder.loadTexts:authMgrTrapMode.setStatus(_A)
agentAuthMgrClientAuthStatusTrap=NotificationType((1,3,6,1,4,1,4526,10,61,0,1))
