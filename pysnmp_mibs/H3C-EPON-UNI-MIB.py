# SNMP MIB module (H3C-EPON-UNI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-EPON-UNI-MIB
...
h3cEponUni = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5)
)
if mibBuilder.loadTexts:
    h3cEponUni.setRevisions(
        ("2017-06-06 11:45",
         "2017-03-06 11:45")
    )
...
h3cEponUniSysManEntry = _H3cEponUniSysManEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1)
)
h3cEponUniSysManEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
)
if mibBuilder.loadTexts:
...
h3cEponUniIndex = _H3cEponUniIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 1),
...
h3cEponUniDescr = _H3cEponUniDescr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 2),
...
h3cEponUniAdminStatus = _H3cEponUniAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 3),
...
h3cEponUniMdi = _H3cEponUniMdi_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 4),
    _H3cEponUniMdi_Type()
)
...
h3cEponUniPriority = _H3cEponUniPriority_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 5),
...
h3cEponUniVlanType = _H3cEponUniVlanType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 6),
...
h3cEponUniAccessVlan = _H3cEponUniAccessVlan_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 7),
...
h3cEponUniTrunkPvid = _H3cEponUniTrunkPvid_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 8),
...
h3cEponUniVLANTrunkAllowListLow = _H3cEponUniVLANTrunkAllowListLow_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 9),
...
h3cEponUniVLANTrunkAllowListHigh = _H3cEponUniVLANTrunkAllowListHigh_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 10),
...
h3cEponUniInboundLineRate = _H3cEponUniInboundLineRate_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 11),
...
h3cEponUniOutboundLineRate = _H3cEponUniOutboundLineRate_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 12),
...
h3cEponUniFlowControl = _H3cEponUniFlowControl_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 13),
...
h3cEponUniSpeed = _H3cEponUniSpeed_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 14),
...
h3cEponUniDuplex = _H3cEponUniDuplex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 15),
...
h3cEponUniVlanVPNStatus = _H3cEponUniVlanVPNStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 16),
...
h3cEponUniCountReset = _H3cEponUniCountReset_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 17),
...
h3cEponUniPortIsolate = _H3cEponUniPortIsolate_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 18),
...
h3cEponUniVlanConfiguration = _H3cEponUniVlanConfiguration_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 23),
...
h3cEponUniAutoNegotiation = _H3cEponUniAutoNegotiation_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 25),
...
h3cEponUniRestartAutoNeg = _H3cEponUniRestartAutoNeg_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 26),
...
h3cEponUniLinkStatus = _H3cEponUniLinkStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 29),
...
h3cEponUniInterfaceType = _H3cEponUniInterfaceType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 30),
...
h3cEponUniVitualCableTest = _H3cEponUniVitualCableTest_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 31),
...
h3cEponUniVCTCableStatus = _H3cEponUniVCTCableStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 32),
...
h3cEponUniVCTCableLength = _H3cEponUniVCTCableLength_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 33),
...
h3cEponUniVCTImpedanceMismatch = _H3cEponUniVCTImpedanceMismatch_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 34),
...
h3cEponUniVCTPairSkew = _H3cEponUniVCTPairSkew_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 35),
...
h3cEponUniVCTPairSwap = _H3cEponUniVCTPairSwap_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 36),
...
h3cEponUniVCTPolaritySwap = _H3cEponUniVCTPolaritySwap_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 37),
...
h3cEponUniVCTInsertionLoss = _H3cEponUniVCTInsertionLoss_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 38),
...
h3cEponUniVCTReturnLoss = _H3cEponUniVCTReturnLoss_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 39),
...
h3cEponUniVCTNearendCrosstalk = _H3cEponUniVCTNearendCrosstalk_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 40),
...
h3cEponUniVlan = _H3cEponUniVlan_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 41),
    _H3cEponUniVlan_Type()
)
h3cEponUniVlan.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cEponUniVlan.setStatus("current")


class _H3cEponUniMacMax_Type(Integer32):
    """Custom type h3cEponUniMacMax based on Integer32"""
    defaultValue = 65535


_H3cEponUniMacMax_Type.__name__ = "Integer32"
_H3cEponUniMacMax_Object = MibTableColumn
h3cEponUniMacMax = _H3cEponUniMacMax_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 1, 1, 42),
    _H3cEponUniMacMax_Type()
)
h3cEponUniMacMax.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cEponUniMacMax.setStatus("current")
_H3cEponUniCountTable_Object = MibTable
h3cEponUniCountTable = _H3cEponUniCountTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2)
)
if mibBuilder.loadTexts:
...
h3cEponUniCountEntry = _H3cEponUniCountEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1)
)
...
h3cEponUniInStatsPkts = _H3cEponUniInStatsPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 1),
...
h3cEponUniInStatsUnicastPkts = _H3cEponUniInStatsUnicastPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 2),
...
h3cEponUniInStatsBroadcastPkts = _H3cEponUniInStatsBroadcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 3),
...
h3cEponUniInStatsMulticastPkts = _H3cEponUniInStatsMulticastPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 4),
...
h3cEponUniInPausePkts = _H3cEponUniInPausePkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 5),
...
h3cEponUniInTotalErrors = _H3cEponUniInTotalErrors_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 6),
...
h3cEponUniInStatsCRCAlignErrors = _H3cEponUniInStatsCRCAlignErrors_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 7),
...
h3cEponUniInStatsUndersizePkts = _H3cEponUniInStatsUndersizePkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 8),
...
h3cEponUniInStatsOversizePkts = _H3cEponUniInStatsOversizePkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 9),
...
h3cEponUniInErrorbyOther = _H3cEponUniInErrorbyOther_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 10),
...
h3cEponUniOutStatsPkts = _H3cEponUniOutStatsPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 11),
...
h3cEponUniOutStatsUnicastPkts = _H3cEponUniOutStatsUnicastPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 12),
...
h3cEponUniOutStatsBroadcastPkts = _H3cEponUniOutStatsBroadcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 13),
...
h3cEponUniOutStatsMulticastPkts = _H3cEponUniOutStatsMulticastPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 14),
...
h3cEponUniOutStatsPausePkts = _H3cEponUniOutStatsPausePkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 15),
...
h3cEponUniOutTotalErrors = _H3cEponUniOutTotalErrors_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 16),
...
h3cEponUniOutStatsCollisions = _H3cEponUniOutStatsCollisions_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 17),
...
h3cEponUniOutDelayExceededDiscards = _H3cEponUniOutDelayExceededDiscards_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 18),
...
h3cEponUniOutErrorbyOther = _H3cEponUniOutErrorbyOther_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 19),
...
h3cEponUniOutDroppedFrames = _H3cEponUniOutDroppedFrames_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 2, 1, 20),
...
h3cEponUniIgmpInfoTable = _H3cEponUniIgmpInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 3)
)
if mibBuilder.loadTexts:
...
h3cEponUniIgmpInfoEntry = _H3cEponUniIgmpInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 3, 1)
)
h3cEponUniIgmpInfoEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniMacIndex"),
)
if mibBuilder.loadTexts:
...
h3cEponUniMacIndex = _H3cEponUniMacIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 3, 1, 1),
...
h3cEponUniIgmpMacAddress = _H3cEponUniIgmpMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 3, 1, 2),
...
h3cEponUniIgmpVlanId = _H3cEponUniIgmpVlanId_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 3, 1, 3),
...
h3cEponUniParaMan = _H3cEponUniParaMan_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 4)
)
...
h3cEponUniLineRateMax = _H3cEponUniLineRateMax_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 4, 1),
...
h3cEponUniLineRateStep = _H3cEponUniLineRateStep_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 4, 2),
...
h3cEponUniNumberOnOnu = _H3cEponUniNumberOnOnu_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 4, 3),
...
h3cEponUniPortPolicyEntry = _H3cEponUniPortPolicyEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 6, 1)
)
...
h3cEponUniPortPolicyStatus = _H3cEponUniPortPolicyStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 6, 1, 1),
...
_H3cEponUniPortPolicyBucketDepth_Type.__name__ = "Integer32"
...
h3cEponUniPortPolicyBucketDepth = _H3cEponUniPortPolicyBucketDepth_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 6, 1, 3),
...
_H3cEponUniPortPolicyExtraBurst_Type.__name__ = "Integer32"
...
h3cEponUniPortPolicyExtraBurst = _H3cEponUniPortPolicyExtraBurst_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 6, 1, 4),
...
h3cEponUniPortPolicyInboundCir = _H3cEponUniPortPolicyInboundCir_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 6, 1, 5),
...
_H3cEponUniPortPolicyInboundBucketDepth_Type.__name__ = "Integer32"
...
h3cEponUniPortPolicyInboundBucketDepth = _H3cEponUniPortPolicyInboundBucketDepth_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 6, 1, 6),
...
_H3cEponUniPortPolicyInboundExtraBurst_Type.__name__ = "Integer32"
...
h3cEponUniPortPolicyInboundExtraBurst = _H3cEponUniPortPolicyInboundExtraBurst_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 6, 1, 7),
...
h3cEponUniPortPolicyOutboundCir = _H3cEponUniPortPolicyOutboundCir_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 6, 1, 8),
...
h3cEponUniPortPolicyOutboundPir = _H3cEponUniPortPolicyOutboundPir_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 6, 1, 9),
...
h3cEponUniMulticastTable = _H3cEponUniMulticastTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 7)
)
if mibBuilder.loadTexts:
...
h3cEponUniMulticastEntry = _H3cEponUniMulticastEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 7, 1)
)
...
_H3cEponUniMulticastGroupNumber_Type.__name__ = "Integer32"
...
h3cEponUniMulticastGroupNumber = _H3cEponUniMulticastGroupNumber_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 7, 1, 1),
...
h3cEponUniMulticastVlanList = _H3cEponUniMulticastVlanList_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 7, 1, 2),
...
h3cEponUniMulticastStripStatus = _H3cEponUniMulticastStripStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 7, 1, 3),
...
h3cEponUniTechAbilityTable = _H3cEponUniTechAbilityTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 8)
)
if mibBuilder.loadTexts:
...
h3cEponUniTechAbilityEntry = _H3cEponUniTechAbilityEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 8, 1)
)
...
h3cEponUniLocalTechAbility = _H3cEponUniLocalTechAbility_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 8, 1, 1),
...
h3cEponUniAdvertisedTechAbility = _H3cEponUniAdvertisedTechAbility_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 8, 1, 2),
...
h3cEponUniMulticastControlTable = _H3cEponUniMulticastControlTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9)
)
if mibBuilder.loadTexts:
...
h3cEponUniMulticastControlEntry = _H3cEponUniMulticastControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1)
)
h3cEponUniMulticastControlEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniMulticastIndex"),
)
if mibBuilder.loadTexts:
...
h3cEponUniMulticastVlanIndex = _H3cEponUniMulticastVlanIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 1),
...
h3cEponUniMulticastAddressList = _H3cEponUniMulticastAddressList_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 2),
...
h3cEponUniMulticastAccessRule = _H3cEponUniMulticastAccessRule_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 3),
...
h3cEponUniMulticastChannelLimit = _H3cEponUniMulticastChannelLimit_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 4),
...
h3cEponUniMulticastPreTimeSlice = _H3cEponUniMulticastPreTimeSlice_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 5),
...
h3cEponUniMulticastPreTimes = _H3cEponUniMulticastPreTimes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 6),
...
h3cEponUniMulticastPreInterval = _H3cEponUniMulticastPreInterval_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 7),
...
h3cEponUniMulticastRowStatus = _H3cEponUniMulticastRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 8),
...
h3cEponUniMulticastIndex = _H3cEponUniMulticastIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 9),
...
h3cEponUniMulticastSourceIpList = _H3cEponUniMulticastSourceIpList_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 10),
...
h3cEponUniMulticastResetInterval = _H3cEponUniMulticastResetInterval_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 9, 1, 11),
...
h3cEponUniQosIndexNextTable = _H3cEponUniQosIndexNextTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 10)
)
if mibBuilder.loadTexts:
...
h3cEponUniQosIndexNextEntry = _H3cEponUniQosIndexNextEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 10, 1)
)
...
h3cEponUniQosConfIndexNext = _H3cEponUniQosConfIndexNext_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 10, 1, 1),
...
h3cEponUniQosConfTable = _H3cEponUniQosConfTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 11)
)
if mibBuilder.loadTexts:
...
h3cEponUniQosConfEntry = _H3cEponUniQosConfEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 11, 1)
)
h3cEponUniQosConfEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniQosConfIndex"),
)
if mibBuilder.loadTexts:
...
h3cEponUniQosConfIndex = _H3cEponUniQosConfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 11, 1, 1),
...
h3cEponUniQosConfRuleIndexNext = _H3cEponUniQosConfRuleIndexNext_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 11, 1, 2),
...
h3cEponUniQosConfMappedQueue = _H3cEponUniQosConfMappedQueue_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 11, 1, 3),
...
h3cEponUniQosConfMarkedPriority = _H3cEponUniQosConfMarkedPriority_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 11, 1, 4),
...
h3cEponUniQosConfRowStatus = _H3cEponUniQosConfRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 11, 1, 5),
...
h3cEponUniQosRuleTable = _H3cEponUniQosRuleTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 12)
)
if mibBuilder.loadTexts:
...
h3cEponUniQosRuleEntry = _H3cEponUniQosRuleEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 12, 1)
)
h3cEponUniQosRuleEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniQosConfIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniQosRuleIndex"),
)
if mibBuilder.loadTexts:
...
h3cEponUniQosRuleIndex = _H3cEponUniQosRuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 12, 1, 1),
...
h3cEponUniQosRuleSelector = _H3cEponUniQosRuleSelector_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 12, 1, 2),
...
h3cEponUniQosRuleValue = _H3cEponUniQosRuleValue_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 12, 1, 3),
...
h3cEponUniQosRuleMacAddress = _H3cEponUniQosRuleMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 12, 1, 4),
...
h3cEponUniQosRuleOperator = _H3cEponUniQosRuleOperator_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 12, 1, 5),
...
h3cEponUniQosRuleRowStatus = _H3cEponUniQosRuleRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 12, 1, 6),
...
h3cEponUniMirrorGroupTable = _H3cEponUniMirrorGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 13)
)
if mibBuilder.loadTexts:
...
h3cEponUniMirrorGroupEntry = _H3cEponUniMirrorGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 13, 1)
)
h3cEponUniMirrorGroupEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniMirrorGroupID"),
)
if mibBuilder.loadTexts:
...
h3cEponUniMirrorGroupID = _H3cEponUniMirrorGroupID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 13, 1, 1),
...
h3cEponUniMirrorInboundPortList = _H3cEponUniMirrorInboundPortList_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 13, 1, 2),
...
h3cEponUniMirrorOutboundPortList = _H3cEponUniMirrorOutboundPortList_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 13, 1, 3),
...
h3cEponUniMonitorPort = _H3cEponUniMonitorPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 13, 1, 4),
...
h3cEponUniMirrorRowStatus = _H3cEponUniMirrorRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 13, 1, 5),
...
h3cEponUniMirrorGroupIdNextTable = _H3cEponUniMirrorGroupIdNextTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 14)
)
if mibBuilder.loadTexts:
...
h3cEponUniMirrorGroupIdNextEntry = _H3cEponUniMirrorGroupIdNextEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 14, 1)
)
...
h3cEponUniMirrorGroupIDNext = _H3cEponUniMirrorGroupIDNext_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 14, 1, 1),
...
h3cEponUniMulticastCtrlInfoTable = _H3cEponUniMulticastCtrlInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 15)
)
if mibBuilder.loadTexts:
...
h3cEponUniMulticastCtrlInfoEntry = _H3cEponUniMulticastCtrlInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 15, 1)
)
h3cEponUniMulticastCtrlInfoEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniMultActVlan"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniMultActAddress"),
)
if mibBuilder.loadTexts:
...
h3cEponUniMultActVlan = _H3cEponUniMultActVlan_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 15, 1, 1),
...
h3cEponUniMultActAddress = _H3cEponUniMultActAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 15, 1, 2),
...
h3cEponUniMultActAccessRule = _H3cEponUniMultActAccessRule_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 15, 1, 3),
...
h3cEponUniMultActPreTimes = _H3cEponUniMultActPreTimes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 15, 1, 4),
...
h3cEponUniMultActPreRemain = _H3cEponUniMultActPreRemain_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 15, 1, 5),
...
h3cEponUniMulticastIndexNextTable = _H3cEponUniMulticastIndexNextTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 16)
)
if mibBuilder.loadTexts:
...
h3cEponUniMulticastIndexNextEntry = _H3cEponUniMulticastIndexNextEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 16, 1)
)
...
h3cEponUniMulticastConfIndexNext = _H3cEponUniMulticastConfIndexNext_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 16, 1, 1),
...
h3cEponCTCAlarmTable = _H3cEponCTCAlarmTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 17)
)
if mibBuilder.loadTexts:
    h3cEponCTCAlarmTable.setStatus("current")
_H3cEponCTCAlarmEntry_Object = MibTableRow
h3cEponCTCAlarmEntry = _H3cEponCTCAlarmEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 17, 1)
)
h3cEponCTCAlarmEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponCTCAlarmID"),
)
if mibBuilder.loadTexts:
    h3cEponCTCAlarmEntry.setStatus("current")


class _H3cEponCTCAlarmID_Type(Integer32):
    """Custom type h3cEponCTCAlarmID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cEponCTCAlarmID_Type.__name__ = "Integer32"
_H3cEponCTCAlarmID_Object = MibTableColumn
h3cEponCTCAlarmID = _H3cEponCTCAlarmID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 17, 1, 1),
    _H3cEponCTCAlarmID_Type()
)
h3cEponCTCAlarmID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEponCTCAlarmID.setStatus("current")


class _H3cEponCTCAlarmProtocol_Type(Integer32):
    """Custom type h3cEponCTCAlarmProtocol based on Integer32"""
    defaultValue = 0
...
_H3cEponCTCAlarmProtocol_Type.__name__ = "Integer32"
_H3cEponCTCAlarmProtocol_Object = MibTableColumn
h3cEponCTCAlarmProtocol = _H3cEponCTCAlarmProtocol_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 17, 1, 2),
    _H3cEponCTCAlarmProtocol_Type()
)
h3cEponCTCAlarmProtocol.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cEponCTCAlarmProtocol.setStatus("current")
_H3cEponCTCAlarmEnable_Type = TruthValue
_H3cEponCTCAlarmEnable_Object = MibTableColumn
h3cEponCTCAlarmEnable = _H3cEponCTCAlarmEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 17, 1, 3),
    _H3cEponCTCAlarmEnable_Type()
)
h3cEponCTCAlarmEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cEponCTCAlarmEnable.setStatus("current")
_H3cEponCTCAlarmTriggerThresVal_Type = OctetString
_H3cEponCTCAlarmTriggerThresVal_Object = MibTableColumn
h3cEponCTCAlarmTriggerThresVal = _H3cEponCTCAlarmTriggerThresVal_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 17, 1, 4),
    _H3cEponCTCAlarmTriggerThresVal_Type()
)
h3cEponCTCAlarmTriggerThresVal.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cEponCTCAlarmTriggerThresVal.setStatus("current")
_H3cEponCTCAlarmClearThresVal_Type = OctetString
_H3cEponCTCAlarmClearThresVal_Object = MibTableColumn
h3cEponCTCAlarmClearThresVal = _H3cEponCTCAlarmClearThresVal_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 17, 1, 5),
    _H3cEponCTCAlarmClearThresVal_Type()
)
h3cEponCTCAlarmClearThresVal.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cEponCTCAlarmClearThresVal.setStatus("current")
_H3cEponUniErrorInfo_ObjectIdentity = ObjectIdentity
h3cEponUniErrorInfo = _H3cEponUniErrorInfo_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 18)
)
_H3cEponCTCAlarmInfo_Type = OctetString
_H3cEponCTCAlarmInfo_Object = MibScalar
h3cEponCTCAlarmInfo = _H3cEponCTCAlarmInfo_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 18, 1),
    _H3cEponCTCAlarmInfo_Type()
)
h3cEponCTCAlarmInfo.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cEponCTCAlarmInfo.setStatus("current")
_H3cUniStatisticsTable_Object = MibTable
h3cUniStatisticsTable = _H3cUniStatisticsTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 19)
)
if mibBuilder.loadTexts:
    h3cUniStatisticsTable.setStatus("current")
_H3cUniStatisticsEntry_Object = MibTableRow
h3cUniStatisticsEntry = _H3cUniStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 19, 1)
)
h3cUniStatisticsEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
)
if mibBuilder.loadTexts:
    h3cUniStatisticsEntry.setStatus("current")
_H3cUniStatisticsPeriodVal_Type = Unsigned32
_H3cUniStatisticsPeriodVal_Object = MibTableColumn
h3cUniStatisticsPeriodVal = _H3cUniStatisticsPeriodVal_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 19, 1, 1),
    _H3cUniStatisticsPeriodVal_Type()
)
h3cUniStatisticsPeriodVal.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cUniStatisticsPeriodVal.setStatus("current")
_H3cUniStatisticsEnable_Type = TruthValue
_H3cUniStatisticsEnable_Object = MibTableColumn
h3cUniStatisticsEnable = _H3cUniStatisticsEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 1, 19, 1, 2),
    _H3cUniStatisticsEnable_Type()
)
h3cUniStatisticsEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cUniStatisticsEnable.setStatus("current")
_H3cEponUniTrap_ObjectIdentity = ObjectIdentity
h3cEponUniTrap = _H3cEponUniTrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 2)
)
_H3cEponUniTrapPrefix_ObjectIdentity = ObjectIdentity
h3cEponUniTrapPrefix = _H3cEponUniTrapPrefix_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 2, 0)
)
...
h3cEponUniLinkUpTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 2, 0, 1)
)
h3cEponUniLinkUpTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniDescr"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniAdminStatus"))
)
if mibBuilder.loadTexts:
...
h3cEponUniLinkDownTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 2, 0, 2)
)
...
h3cEponUniLoopBackDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 2, 0, 3)
)
h3cEponUniLoopBackDetectedTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniDescr"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniVlan"))
)
if mibBuilder.loadTexts:
    h3cEponUniLoopBackDetectedTrap.setStatus(
        "current"
    )

h3cEponUniLoopBackRecoveredTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 2, 0, 4)
)
h3cEponUniLoopBackRecoveredTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniDescr"),
...
if mibBuilder.loadTexts:
    h3cEponUniLoopBackRecoveredTrap.setStatus(
        "current"
    )

h3cEponCTCAlarmTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 2, 0, 5)
)
h3cEponCTCAlarmTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-EPON-UNI-MIB", "h3cEponCTCAlarmID"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniDescr"),
        ("H3C-EPON-UNI-MIB", "h3cEponCTCAlarmInfo"))
)
if mibBuilder.loadTexts:
    h3cEponCTCAlarmTrap.setStatus(
        "current"
    )

h3cEponCTCAlarmRecoverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 42, 5, 2, 0, 6)
)
h3cEponCTCAlarmRecoverTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-EPON-UNI-MIB", "h3cEponCTCAlarmID"),
        ("H3C-EPON-UNI-MIB", "h3cEponUniIndex"),
...
if mibBuilder.loadTexts:
    h3cEponCTCAlarmRecoverTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"h3cEponUni": h3cEponUni,
       ...
       "h3cEponUniVlan": h3cEponUniVlan,
       "h3cEponUniMacMax": h3cEponUniMacMax,
       ...
       "h3cEponCTCAlarmTable": h3cEponCTCAlarmTable,
       "h3cEponCTCAlarmEntry": h3cEponCTCAlarmEntry,
       "h3cEponCTCAlarmID": h3cEponCTCAlarmID,
       "h3cEponCTCAlarmProtocol": h3cEponCTCAlarmProtocol,
       "h3cEponCTCAlarmEnable": h3cEponCTCAlarmEnable,
       "h3cEponCTCAlarmTriggerThresVal": h3cEponCTCAlarmTriggerThresVal,
       "h3cEponCTCAlarmClearThresVal": h3cEponCTCAlarmClearThresVal,
       "h3cEponUniErrorInfo": h3cEponUniErrorInfo,
       "h3cEponCTCAlarmInfo": h3cEponCTCAlarmInfo,
       "h3cUniStatisticsTable": h3cUniStatisticsTable,
       "h3cUniStatisticsEntry": h3cUniStatisticsEntry,
       "h3cUniStatisticsPeriodVal": h3cUniStatisticsPeriodVal,
       "h3cUniStatisticsEnable": h3cUniStatisticsEnable,
       ...
       "h3cEponUniLoopBackDetectedTrap": h3cEponUniLoopBackDetectedTrap,
       "h3cEponUniLoopBackRecoveredTrap": h3cEponUniLoopBackRecoveredTrap,
       "h3cEponCTCAlarmTrap": h3cEponCTCAlarmTrap,
       "h3cEponCTCAlarmRecoverTrap": h3cEponCTCAlarmRecoverTrap}
)
