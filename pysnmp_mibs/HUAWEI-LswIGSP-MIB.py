...
hwLswIgmpsnoopingMibObject=_HwLswIgmpsnoopingMibObject_ObjectIdentity((1,3,6,1,4,1,2011,2,23,1,7,1))
_HwIgmpSnoopingStatus_Type=EnabledStatus
_HwIgmpSnoopingStatus_Object=MibScalar
hwIgmpSnoopingStatus=_HwIgmpSnoopingStatus_Object((1,3,6,1,4,1,2011,2,23,1,7,1,1),_HwIgmpSnoopingStatus_Type())
...
hwIgmpSnoopingRouterPortAge=_HwIgmpSnoopingRouterPortAge_Object((1,3,6,1,4,1,2011,2,23,1,7,1,2),_HwIgmpSnoopingRouterPortAge_Type())
...
hwIgmpSnoopingResponseTime=_HwIgmpSnoopingResponseTime_Object((1,3,6,1,4,1,2011,2,23,1,7,1,3),_HwIgmpSnoopingResponseTime_Type())
...
hwIgmpSnoopingHostTime=_HwIgmpSnoopingHostTime_Object((1,3,6,1,4,1,2011,2,23,1,7,1,4),_HwIgmpSnoopingHostTime_Type())
...
hwIgmpSnoopingGroupLimitTable=_HwIgmpSnoopingGroupLimitTable_Object((1,3,6,1,4,1,2011,2,23,1,7,1,5))
if mibBuilder.loadTexts:hwIgmpSnoopingGroupLimitTable.setStatus(_A)
_HwIgmpSnoopingGroupLimitEntry_Object=MibTableRow
hwIgmpSnoopingGroupLimitEntry=_HwIgmpSnoopingGroupLimitEntry_Object((1,3,6,1,4,1,2011,2,23,1,7,1,5,1))
...
hwIgmpSnoopingGroupIfIndex=_HwIgmpSnoopingGroupIfIndex_Object((1,3,6,1,4,1,2011,2,23,1,7,1,5,1,1),_HwIgmpSnoopingGroupIfIndex_Type())
...
hwIgmpSnoopingGroupLimitNumber=_HwIgmpSnoopingGroupLimitNumber_Object((1,3,6,1,4,1,2011,2,23,1,7,1,5,1,2),_HwIgmpSnoopingGroupLimitNumber_Type())
...
hwIgmpSnoopingFastLeaveTable=_HwIgmpSnoopingFastLeaveTable_Object((1,3,6,1,4,1,2011,2,23,1,7,1,6))
if mibBuilder.loadTexts:hwIgmpSnoopingFastLeaveTable.setStatus(_A)
_HwIgmpSnoopingFastLeaveEntry_Object=MibTableRow
hwIgmpSnoopingFastLeaveEntry=_HwIgmpSnoopingFastLeaveEntry_Object((1,3,6,1,4,1,2011,2,23,1,7,1,6,1))
...
hwIgmpSnoopingFastLeaveIfIndex=_HwIgmpSnoopingFastLeaveIfIndex_Object((1,3,6,1,4,1,2011,2,23,1,7,1,6,1,1),_HwIgmpSnoopingFastLeaveIfIndex_Type())
...
hwIgmpSnoopingFastLeaveStatus=_HwIgmpSnoopingFastLeaveStatus_Object((1,3,6,1,4,1,2011,2,23,1,7,1,6,1,2),_HwIgmpSnoopingFastLeaveStatus_Type())
...
hwIgmpSnoopingGroupPolicyTable=_HwIgmpSnoopingGroupPolicyTable_Object((1,3,6,1,4,1,2011,2,23,1,7,1,7))
if mibBuilder.loadTexts:hwIgmpSnoopingGroupPolicyTable.setStatus(_A)
_HwIgmpSnoopingGroupPolicyEntry_Object=MibTableRow
hwIgmpSnoopingGroupPolicyEntry=_HwIgmpSnoopingGroupPolicyEntry_Object((1,3,6,1,4,1,2011,2,23,1,7,1,7,1))
...
hwIgmpSnoopingGroupPolicyIfIndex=_HwIgmpSnoopingGroupPolicyIfIndex_Object((1,3,6,1,4,1,2011,2,23,1,7,1,7,1,1),_HwIgmpSnoopingGroupPolicyIfIndex_Type())
...
hwIgmpSnoopingGroupPolicyVlanID=_HwIgmpSnoopingGroupPolicyVlanID_Object((1,3,6,1,4,1,2011,2,23,1,7,1,7,1,2),_HwIgmpSnoopingGroupPolicyVlanID_Type())
...
hwIgmpSnoopingGroupPolicyParameter=_HwIgmpSnoopingGroupPolicyParameter_Object((1,3,6,1,4,1,2011,2,23,1,7,1,7,1,3),_HwIgmpSnoopingGroupPolicyParameter_Type())
...
hwIgmpSnoopingGroupPolicyStatus=_HwIgmpSnoopingGroupPolicyStatus_Object((1,3,6,1,4,1,2011,2,23,1,7,1,7,1,4),_HwIgmpSnoopingGroupPolicyStatus_Type())
...
hwIgmpSnoopingNonFloodingStatus=_HwIgmpSnoopingNonFloodingStatus_Object((1,3,6,1,4,1,2011,2,23,1,7,1,8),_HwIgmpSnoopingNonFloodingStatus_Type())
...
hwIgmpSnoopingVlanStatusTable=_HwIgmpSnoopingVlanStatusTable_Object((1,3,6,1,4,1,2011,2,23,1,7,1,9))
if mibBuilder.loadTexts:hwIgmpSnoopingVlanStatusTable.setStatus(_A)
_HwIgmpSnoopingVlanStatusEntry_Object=MibTableRow
hwIgmpSnoopingVlanStatusEntry=_HwIgmpSnoopingVlanStatusEntry_Object((1,3,6,1,4,1,2011,2,23,1,7,1,9,1))
...
hwIgmpSnoopingVlanID=_HwIgmpSnoopingVlanID_Object((1,3,6,1,4,1,2011,2,23,1,7,1,9,1,1),_HwIgmpSnoopingVlanID_Type())
...
hwIgmpSnoopingVlanEnabled=_HwIgmpSnoopingVlanEnabled_Object((1,3,6,1,4,1,2011,2,23,1,7,1,9,1,2),_HwIgmpSnoopingVlanEnabled_Type())
...
hwIgmpSnoopingStatsObjects=_HwIgmpSnoopingStatsObjects_ObjectIdentity((1,3,6,1,4,1,2011,2,23,1,7,1,10))
_HwRecvIGMPGQueryNum_Type=Counter32
_HwRecvIGMPGQueryNum_Object=MibScalar
hwRecvIGMPGQueryNum=_HwRecvIGMPGQueryNum_Object((1,3,6,1,4,1,2011,2,23,1,7,1,10,1),_HwRecvIGMPGQueryNum_Type())
...
hwRecvIGMPSQueryNum=_HwRecvIGMPSQueryNum_Object((1,3,6,1,4,1,2011,2,23,1,7,1,10,2),_HwRecvIGMPSQueryNum_Type())
...
hwRecvIGMPV1ReportNum=_HwRecvIGMPV1ReportNum_Object((1,3,6,1,4,1,2011,2,23,1,7,1,10,3),_HwRecvIGMPV1ReportNum_Type())
...
hwRecvIGMPV2ReportNum=_HwRecvIGMPV2ReportNum_Object((1,3,6,1,4,1,2011,2,23,1,7,1,10,4),_HwRecvIGMPV2ReportNum_Type())
...
hwRecvIGMPLeaveNum=_HwRecvIGMPLeaveNum_Object((1,3,6,1,4,1,2011,2,23,1,7,1,10,5),_HwRecvIGMPLeaveNum_Type())
...
hwRecvErrorIGMPPacketNum=_HwRecvErrorIGMPPacketNum_Object((1,3,6,1,4,1,2011,2,23,1,7,1,10,6),_HwRecvErrorIGMPPacketNum_Type())
...
hwSentIGMPSQueryNum=_HwSentIGMPSQueryNum_Object((1,3,6,1,4,1,2011,2,23,1,7,1,10,7),_HwSentIGMPSQueryNum_Type())
...
hwIgmpSnoopingClearStats=_HwIgmpSnoopingClearStats_Object((1,3,6,1,4,1,2011,2,23,1,7,1,10,8),_HwIgmpSnoopingClearStats_Type())
