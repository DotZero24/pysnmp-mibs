...
rlPortCopyMibVersion=_RlPortCopyMibVersion_Object((1,3,6,1,4,1,171,10,94,89,89,84,1),_RlPortCopyMibVersion_Type())
...
rlPortCopySupport=_RlPortCopySupport_Object((1,3,6,1,4,1,171,10,94,89,89,84,2),_RlPortCopySupport_Type())
...
rlPortCopyVlanTaggingTable=_RlPortCopyVlanTaggingTable_Object((1,3,6,1,4,1,171,10,94,89,89,84,3))
if mibBuilder.loadTexts:rlPortCopyVlanTaggingTable.setStatus(_A)
_RlPortCopyVlanTaggingEntry_Object=MibTableRow
rlPortCopyVlanTaggingEntry=_RlPortCopyVlanTaggingEntry_Object((1,3,6,1,4,1,171,10,94,89,89,84,3,1))
...
rlPortCopyVlanTagging=_RlPortCopyVlanTagging_Object((1,3,6,1,4,1,171,10,94,89,89,84,3,1,1),_RlPortCopyVlanTagging_Type())
