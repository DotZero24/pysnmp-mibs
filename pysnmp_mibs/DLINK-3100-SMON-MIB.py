# SNMP MIB module (DLINK-3100-SMON-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-3100-SMON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:46:55 2025
...
rlPortCopyMibVersion = _RlPortCopyMibVersion_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 84, 1),
...
rlPortCopySupport = _RlPortCopySupport_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 84, 2),
...
rlPortCopyVlanTaggingTable = _RlPortCopyVlanTaggingTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 84, 3)
)
if mibBuilder.loadTexts:
...
rlPortCopyVlanTaggingEntry = _RlPortCopyVlanTaggingEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 84, 3, 1)
)
...
rlPortCopyVlanTagging = _RlPortCopyVlanTagging_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 84, 3, 1, 1),
...
rlPortCopyMode = _RlPortCopyMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 84, 4),
