...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/watchguard/IPSEC-ISAKMP-IKE-DOI-TC
...
ModuleIdentity, Counter64, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, TimeTicks, MibIdentifier, experimental, Integer32, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "TimeTicks", "MibIdentifier", "experimental", "Integer32", "Bits", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("IPSEC-ISAKMP-IKE-DOI-TC", IpsecDoiAuthAlgorithm=IpsecDoiAuthAlgorithm, IsakmpExchangeType=IsakmpExchangeType, IsakmpDOI=IsakmpDOI, IkeEncryptionAlgorithm=IkeEncryptionAlgorithm, ipsecIsakmpIkeDoiTC=ipsecIsakmpIkeDoiTC, IpsecDoiEspTransform=IpsecDoiEspTransform, IpsecDoiSituation=IpsecDoiSituation, IpsecDoiIpcompTransform=IpsecDoiIpcompTransform, IkeAuthMethod=IkeAuthMethod, IpsecDoiAhTransform=IpsecDoiAhTransform, IpsecDoiIdentType=IpsecDoiIdentType, IkeNotifyMessageType=IkeNotifyMessageType, IpsecDoiTransformIdent=IpsecDoiTransformIdent, IkeExchangeType=IkeExchangeType, IpsecDoiSecProtocolId=IpsecDoiSecProtocolId, IpsecDoiEncapsulationMode=IpsecDoiEncapsulationMode, PYSNMP_MODULE_ID=ipsecIsakmpIkeDoiTC, IkeGroupDescription=IkeGroupDescription, IsakmpCertificateEncoding=IsakmpCertificateEncoding, IsakmpNotifyMessageType=IsakmpNotifyMessageType, IkeHashAlgorithm=IkeHashAlgorithm, IkeGroupType=IkeGroupType, IkePrf=IkePrf)
