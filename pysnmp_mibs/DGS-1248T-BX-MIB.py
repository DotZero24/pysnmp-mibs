...
_Dgs_1248tbx_ObjectIdentity=ObjectIdentity
dgs_1248tbx=_Dgs_1248tbx_ObjectIdentity((1,3,6,1,4,1,171,10,76,6))
...
configBootTftpOperation=_ConfigBootTftpOperation_Object((1,3,6,1,4,1,171,10,76,6,11,3),_ConfigBootTftpOperation_Type())
...
configBootTftpServerIp=_ConfigBootTftpServerIp_Object((1,3,6,1,4,1,171,10,76,6,11,4),_ConfigBootTftpServerIp_Type())
...
configBootImageFileName=_ConfigBootImageFileName_Object((1,3,6,1,4,1,171,10,76,6,11,5),_ConfigBootImageFileName_Type())
...
configTftpServerIpAddress=_ConfigTftpServerIpAddress_Object((1,3,6,1,4,1,171,10,76,6,11,32),_ConfigTftpServerIpAddress_Type())
...
configTftpServerFileName=_ConfigTftpServerFileName_Object((1,3,6,1,4,1,171,10,76,6,11,33),_ConfigTftpServerFileName_Type())
...
configTftpOperation=_ConfigTftpOperation_Object((1,3,6,1,4,1,171,10,76,6,11,34),_ConfigTftpOperation_Type())
...
configJumboEnable=_ConfigJumboEnable_Object((1,3,6,1,4,1,171,10,76,6,11,43),_ConfigJumboEnable_Type())
...
configSafeguardEnable=_ConfigSafeguardEnable_Object((1,3,6,1,4,1,171,10,76,6,11,44),_ConfigSafeguardEnable_Type())
...
configPowerSavingEnable=_ConfigPowerSavingEnable_Object((1,3,6,1,4,1,171,10,76,6,11,45),_ConfigPowerSavingEnable_Type())
...
tvlanManagementOnOff=_TvlanManagementOnOff_Object((1,3,6,1,4,1,171,10,76,6,13,2),_TvlanManagementOnOff_Type())
...
tvlanManagementid=_TvlanManagementid_Object((1,3,6,1,4,1,171,10,76,6,13,3),_TvlanManagementid_Type())
tvlanManagementid.setMaxAccess(_B)
if mibBuilder.loadTexts:tvlanManagementid.setStatus(_A)
_TvlanPortTable_Object=MibTable
tvlanPortTable=_TvlanPortTable_Object((1,3,6,1,4,1,171,10,76,6,13,4))
if mibBuilder.loadTexts:tvlanPortTable.setStatus(_A)
_TvlanPortEntry_Object=MibTableRow
tvlanPortEntry=_TvlanPortEntry_Object((1,3,6,1,4,1,171,10,76,6,13,4,1))
...
tvlanPortPortId=_TvlanPortPortId_Object((1,3,6,1,4,1,171,10,76,6,13,4,1,1),_TvlanPortPortId_Type())
...
tvlanPortVlanId=_TvlanPortVlanId_Object((1,3,6,1,4,1,171,10,76,6,13,4,1,2),_TvlanPortVlanId_Type())
...
tvlanAsyOnOff=_TvlanAsyOnOff_Object((1,3,6,1,4,1,171,10,76,6,13,5),_TvlanAsyOnOff_Type())
...
igsQuerierStateOnOff=_IgsQuerierStateOnOff_Object((1,3,6,1,4,1,171,10,76,6,22,1,18),_IgsQuerierStateOnOff_Type())
...
companyQoSGroup=_CompanyQoSGroup_ObjectIdentity((1,3,6,1,4,1,171,10,76,6,26))
...
qosMode=_QosMode_Object((1,3,6,1,4,1,171,10,76,6,26,1),_QosMode_Type())
...
queuingMechanism=_QueuingMechanism_Object((1,3,6,1,4,1,171,10,76,6,26,2),_QueuingMechanism_Type())
queuingMechanism.setMaxAccess(_B)
if mibBuilder.loadTexts:queuingMechanism.setStatus(_A)
_Dot1pPortTable_Object=MibTable
dot1pPortTable=_Dot1pPortTable_Object((1,3,6,1,4,1,171,10,76,6,26,3))
if mibBuilder.loadTexts:dot1pPortTable.setStatus(_A)
_Dot1pPortEntry_Object=MibTableRow
dot1pPortEntry=_Dot1pPortEntry_Object((1,3,6,1,4,1,171,10,76,6,26,3,1))
...
dot1pPortIndex=_Dot1pPortIndex_Object((1,3,6,1,4,1,171,10,76,6,26,3,1,1),_Dot1pPortIndex_Type())
...
dot1pPortPriority=_Dot1pPortPriority_Object((1,3,6,1,4,1,171,10,76,6,26,3,1,2),_Dot1pPortPriority_Type())
dot1pPortPriority.setMaxAccess(_B)
if mibBuilder.loadTexts:dot1pPortPriority.setStatus(_A)
_DscpTable_Object=MibTable
dscpTable=_DscpTable_Object((1,3,6,1,4,1,171,10,76,6,26,4))
if mibBuilder.loadTexts:dscpTable.setStatus(_A)
_DscpEntry_Object=MibTableRow
dscpEntry=_DscpEntry_Object((1,3,6,1,4,1,171,10,76,6,26,4,1))
...
dscpIndex=_DscpIndex_Object((1,3,6,1,4,1,171,10,76,6,26,4,1,1),_DscpIndex_Type())
...
dscpPriority=_DscpPriority_Object((1,3,6,1,4,1,171,10,76,6,26,4,1,2),_DscpPriority_Type())
...
companyTrafficMgmt=_CompanyTrafficMgmt_ObjectIdentity((1,3,6,1,4,1,171,10,76,6,27))
_BroadcastStormCtrlSettings_ObjectIdentity=ObjectIdentity
broadcastStormCtrlSettings=_BroadcastStormCtrlSettings_ObjectIdentity((1,3,6,1,4,1,171,10,76,6,27,3))
...
broadcastStormCtrlGlobalOnOff=_BroadcastStormCtrlGlobalOnOff_Object((1,3,6,1,4,1,171,10,76,6,27,3,1),_BroadcastStormCtrlGlobalOnOff_Type())
...
broadcastStormGlobalThreshold=_BroadcastStormGlobalThreshold_Object((1,3,6,1,4,1,171,10,76,6,27,3,2),_BroadcastStormGlobalThreshold_Type())
...
companySecurity=_CompanySecurity_ObjectIdentity((1,3,6,1,4,1,171,10,76,6,28))
_TrustedHostSettings_ObjectIdentity=ObjectIdentity
trustedHostSettings=_TrustedHostSettings_ObjectIdentity((1,3,6,1,4,1,171,10,76,6,28,1))
...
trustedHostOnOff=_TrustedHostOnOff_Object((1,3,6,1,4,1,171,10,76,6,28,1,1),_TrustedHostOnOff_Type())
trustedHostOnOff.setMaxAccess(_B)
if mibBuilder.loadTexts:trustedHostOnOff.setStatus(_A)
_TrustedHostTable_Object=MibTable
trustedHostTable=_TrustedHostTable_Object((1,3,6,1,4,1,171,10,76,6,28,1,2))
if mibBuilder.loadTexts:trustedHostTable.setStatus(_A)
_TrustedHostEntry_Object=MibTableRow
trustedHostEntry=_TrustedHostEntry_Object((1,3,6,1,4,1,171,10,76,6,28,1,2,1))
...
trustedHostID=_TrustedHostID_Object((1,3,6,1,4,1,171,10,76,6,28,1,2,1,1),_TrustedHostID_Type())
...
trustedHostIpAddress=_TrustedHostIpAddress_Object((1,3,6,1,4,1,171,10,76,6,28,1,2,1,2),_TrustedHostIpAddress_Type())
...
trustedHostIpMask=_TrustedHostIpMask_Object((1,3,6,1,4,1,171,10,76,6,28,1,2,1,3),_TrustedHostIpMask_Type())
...
trustedHostStatus=_TrustedHostStatus_Object((1,3,6,1,4,1,171,10,76,6,28,1,2,1,4),_TrustedHostStatus_Type())
