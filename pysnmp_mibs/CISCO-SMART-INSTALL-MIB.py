...
mibBuilder.exportSymbols("CISCO-SMART-INSTALL-MIB", ciscoSmartInstallNotificationsGroup=ciscoSmartInstallNotificationsGroup, ciscoSmartInstallNotifyVarsGroup=ciscoSmartInstallNotifyVarsGroup, csiMatchProductId=csiMatchProductId, ciscoSmartInstallGlobalConfigGroup=ciscoSmartInstallGlobalConfigGroup, ciscoSmartInstallMIBNotifs=ciscoSmartInstallMIBNotifs, csiHostnamePrefix=csiHostnamePrefix, csiProfile=csiProfile, csiNotifObjects=csiNotifObjects, csiJoinWindowPeriodStorageType=csiJoinWindowPeriodStorageType, ciscoSmartInstallProfileGroup=ciscoSmartInstallProfileGroup, csiBackup=csiBackup, csiJoinWindowPeriodInterval=csiJoinWindowPeriodInterval, csiProfileTable=csiProfileTable, ciscoSmartInstallMIB=ciscoSmartInstallMIB, csiDeviceName=csiDeviceName, csiDeviceNum=csiDeviceNum, csiFileLoadFailed=csiFileLoadFailed, csiJoinWindowPeriodRowStatus=csiJoinWindowPeriodRowStatus, csiDeviceImageVersion=csiDeviceImageVersion, csiDeviceAddressType=csiDeviceAddressType, csiProfileRowStatus=csiProfileRowStatus, csiImageFileUrl=csiImageFileUrl, csiDeviceAddress=csiDeviceAddress, ciscoSmartInstallMIBConform=ciscoSmartInstallMIBConform, csiJoinWindowPeriodIndex=csiJoinWindowPeriodIndex, csiJoinWindowPeriodEntry=csiJoinWindowPeriodEntry, csiDeviceBackupConfigFileName=csiDeviceBackupConfigFileName, PYSNMP_MODULE_ID=ciscoSmartInstallMIB, csiDeviceSerialNum=csiDeviceSerialNum, csiManagementVlansSecond2K=csiManagementVlansSecond2K, csiNotifOperationResult=csiNotifOperationResult, csiProfileNextFreeIndex=csiProfileNextFreeIndex, csiConfigFileUrl=csiConfigFileUrl, csiMatchSwitchNum=csiMatchSwitchNum, csiManagementVlansFirst2K=csiManagementVlansFirst2K, csiMatchHostAddress=csiMatchHostAddress, csiNotifOperationType=csiNotifOperationType, csiManagementVlan=csiManagementVlan, csiMatchMacAddress=csiMatchMacAddress, ciscoSmartInstallCompliance=ciscoSmartInstallCompliance, csiNotifEnable=csiNotifEnable, csiProfileEntry=csiProfileEntry, csiJoinWindowConfigOperationMode=csiJoinWindowConfigOperationMode, csiMatchSwitchProductId=csiMatchSwitchProductId, csiDeviceTable=csiDeviceTable, csiJoinWindowPeriodExpirationDate=csiJoinWindowPeriodExpirationDate, csiDeviceInfo=csiDeviceInfo, csiDeviceLost=csiDeviceLost, csiProfileGroupName=csiProfileGroupName, csiMatchTable=csiMatchTable, csiMatchHostAddressType=csiMatchHostAddressType, csiMatchGroupType=csiMatchGroupType, csiJoinWindowPeriodStartTime=csiJoinWindowPeriodStartTime, csiProfileConfigUrl=csiProfileConfigUrl, csiProfileStorageType=csiProfileStorageType, csiDeviceMacAddress=csiDeviceMacAddress, csiGlobalConfig=csiGlobalConfig, csiOperationModeChange=csiOperationModeChange, csiMatchHostInterface=csiMatchHostInterface, ciscoSmartInstallCompliances=ciscoSmartInstallCompliances, csiMatchStorageType=csiMatchStorageType, csiDirectorIpAddress=csiDirectorIpAddress, ciscoSmartInstallMIBObjects=ciscoSmartInstallMIBObjects, csiBackupHostUrl=csiBackupHostUrl, csiOperationMode=csiOperationMode, csiJoinWindowPeriodTable=csiJoinWindowPeriodTable, csiDeviceAdded=csiDeviceAdded, csiDevicePlatform=csiDevicePlatform, csiDeviceStatus=csiDeviceStatus, csiMatchIndex=csiMatchIndex, csiJoinWindowPeriodNextFreeIndex=csiJoinWindowPeriodNextFreeIndex, ciscoSmartInstallJoinWindowGroup=ciscoSmartInstallJoinWindowGroup, csiBackupEnable=csiBackupEnable, csiJoinWindow=csiJoinWindow, csiProfileImageTwoUrl=csiProfileImageTwoUrl, csiJoinWindowPeriodRecurrencePattern=csiJoinWindowPeriodRecurrencePattern, ciscoSmartInstallNotificationEnableGroup=ciscoSmartInstallNotificationEnableGroup, csiDeviceEntry=csiDeviceEntry, ciscoSmartInstallDeviceInformationGroup=ciscoSmartInstallDeviceInformationGroup, ciscoSmartInstallGroups=ciscoSmartInstallGroups, csiProfileImageUrl=csiProfileImageUrl, csiMatchEntry=csiMatchEntry, ciscoSmartInstallConfigBackupGroup=ciscoSmartInstallConfigBackupGroup, csiDirectorIpAddressType=csiDirectorIpAddressType, csiProfileIndex=csiProfileIndex, csiMatchRowStatus=csiMatchRowStatus)
