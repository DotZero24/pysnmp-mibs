...
VirtualOperChassisId, virtualChassisOperChasId = mibBuilder.importSymbols("ALCATEL-ENT1-VIRTUAL-CHASSIS-MIB", "VirtualOperChassisId", "virtualChassisOperChasId")
...
mibBuilder.exportSymbols("ALCATEL-ENT1-SYSTEM-MIB", systemMicrocodePackageEntry=systemMicrocodePackageEntry, systemServicesAction=systemServicesAction, systemMicrocodePackageTable=systemMicrocodePackageTable, systemHardwareFlashSize=systemHardwareFlashSize, systemMicrocodeLoadedIndex=systemMicrocodeLoadedIndex, systemSwitchLoggingHostv6VrfName=systemSwitchLoggingHostv6VrfName, systemSwitchLoggingFlash=systemSwitchLoggingFlash, systemServicesTimezoneOffset=systemServicesTimezoneOffset, alcatelIND1SystemMIBTraps=alcatelIND1SystemMIBTraps, systemHardwareJumperForceUartDefaults=systemHardwareJumperForceUartDefaults, systemServicesKtraceLevelEntry=systemServicesKtraceLevelEntry, systemSwitchLoggingClear=systemSwitchLoggingClear, systemSwitchLoggingHostStatus=systemSwitchLoggingHostStatus, systemServicesBluetoothStatus=systemServicesBluetoothStatus, systemHardwareProdRegId=systemHardwareProdRegId, alcatelIND1SystemMIBGroups=alcatelIND1SystemMIBGroups, systemServicesKtraceEnable=systemServicesKtraceEnable, CommandPercentComplete=CommandPercentComplete, systemServicesUsbMounted=systemServicesUsbMounted, systemVcHardwareUbootVersion=systemVcHardwareUbootVersion, systemSwitchLoggingLevel=systemSwitchLoggingLevel, systemMicrocodeLoadedSize=systemMicrocodeLoadedSize, systemBootNetworkNetmask=systemBootNetworkNetmask, systemServices=systemServices, systemServicesKtraceLevelTable=systemServicesKtraceLevelTable, systemFipsGroup=systemFipsGroup, systemMicrocodeLoadedTable=systemMicrocodeLoadedTable, systemSwitchLoggingSocketIpAddr=systemSwitchLoggingSocketIpAddr, systemSwitchLoggingLevelEntry=systemSwitchLoggingLevelEntry, systemVcHardwareMemoryMfg=systemVcHardwareMemoryMfg, systemFileSystemFileIndex=systemFileSystemFileIndex, systemServicesTimezoneEndMonth=systemServicesTimezoneEndMonth, systemServicesArg4=systemServicesArg4, PYSNMP_MODULE_ID=alcatelIND1SystemMIB, systemHardwareFpgaVersion=systemHardwareFpgaVersion, systemHardwareXfpId=systemHardwareXfpId, systemFileSystemFreeSpace=systemFileSystemFreeSpace, systemHardwareJumperInterruptBoot=systemHardwareJumperInterruptBoot, systemHardwareMemoryMfg=systemHardwareMemoryMfg, systemServicesArg5=systemServicesArg5, systemSwitchLoggingApplicationSubAppVrfLevelIndex=systemSwitchLoggingApplicationSubAppVrfLevelIndex, systemSwitchLoggingHostVrfName=systemSwitchLoggingHostVrfName, systemSwitchLoggingSubAppNbr=systemSwitchLoggingSubAppNbr, systemServicesUsbAutoCopyEnable=systemServicesUsbAutoCopyEnable, systemBootNetworkGateway=systemBootNetworkGateway, systemSwitchLoggingAppName=systemSwitchLoggingAppName, systemHardwareRevisionRegister=systemHardwareRevisionRegister, systemSwitchLoggingHostv6IpAddr=systemSwitchLoggingHostv6IpAddr, systemSwitchLoggingDgHostEntry=systemSwitchLoggingDgHostEntry, systemSwitchLoggingHostPort=systemSwitchLoggingHostPort, systemFileSystem=systemFileSystem, alcatelIND1SystemMIBCompliance=alcatelIND1SystemMIBCompliance, systemFipsAdminState=systemFipsAdminState, systemMicrocodePackageStatus=systemMicrocodePackageStatus, systemDNS=systemDNS, systemSwitchLoggingHostv6Status=systemSwitchLoggingHostv6Status, systemHardwareJumperSpare=systemHardwareJumperSpare, systemServicesTimezone=systemServicesTimezone, systemSwitchLoggingApplicationSubAppName=systemSwitchLoggingApplicationSubAppName, systemFileSystemFileName=systemFileSystemFileName, systemServicesArchiveName=systemServicesArchiveName, FileSystemIndex=FileSystemIndex, systemMicrocodePackageSize=systemMicrocodePackageSize, alcatelIND1SystemMIBObjects=alcatelIND1SystemMIBObjects, systemDNSNsIPv6Addr2=systemDNSNsIPv6Addr2, systemHardwareUbootVersion=systemHardwareUbootVersion, systemSwitchLoggingHostv6Table=systemSwitchLoggingHostv6Table, systemUpdateStatusTable=systemUpdateStatusTable, systemMicrocodeLoadedDirectory=systemMicrocodeLoadedDirectory, systemServicesArchiveIndex=systemServicesArchiveIndex, systemHardware=systemHardware, systemVcHardwareCpuModel=systemVcHardwareCpuModel, systemServicesMemMonitorEnable=systemServicesMemMonitorEnable, systemMicrocodePackageDirectory=systemMicrocodePackageDirectory, systemServicesTime=systemServicesTime, systemBlueToothServicesGroup=systemBlueToothServicesGroup, systemBootParamsGroup=systemBootParamsGroup, systemMicrocode=systemMicrocode, systemSwitchLoggingPreamble=systemSwitchLoggingPreamble, systemSwitchLoggingLoopback0=systemSwitchLoggingLoopback0, systemServicesUsbEnable=systemServicesUsbEnable, systemServicesKtraceLevelAppId=systemServicesKtraceLevelAppId, systemVcHardwareFlashSize=systemVcHardwareFlashSize, systemMicrocodeLoadedVersion=systemMicrocodeLoadedVersion, systemServicesSystraceLevelAppId=systemServicesSystraceLevelAppId, systemSwlogSizeTrap=systemSwlogSizeTrap, systemServicesActionPercentComplete=systemServicesActionPercentComplete, systemHardwareFpgaVersionEntry=systemHardwareFpgaVersionEntry, systemServicesSystraceLevel=systemServicesSystraceLevel, systemFileSystemEntry=systemFileSystemEntry, systemSwitchLoggingHostUserCommandHost=systemSwitchLoggingHostUserCommandHost, systemVcHardwareCFMsPresent=systemVcHardwareCFMsPresent, systemHardwareNVRAMBatteryLow=systemHardwareNVRAMBatteryLow, systemServicesKtraceLevel=systemServicesKtraceLevel, systemSwitchLoggingConsole=systemSwitchLoggingConsole, systemUpdateIndex=systemUpdateIndex, systemDNSNsAddr1=systemDNSNsAddr1, systemServicesTimezoneStartWeek=systemServicesTimezoneStartWeek, systemServicesSystraceLevelTable=systemServicesSystraceLevelTable, systemServicesSystraceEnable=systemServicesSystraceEnable, systemServicesArchiveSize=systemServicesArchiveSize, alcatelIND1SystemMIBTrapObjects=alcatelIND1SystemMIBTrapObjects, systemFileSystemDirectoryDateTime=systemFileSystemDirectoryDateTime, systemSwitchLoggingGroup=systemSwitchLoggingGroup, systemHardwareMinorFpgaVersion=systemHardwareMinorFpgaVersion, systemSwitchLoggingHostIpAddr=systemSwitchLoggingHostIpAddr, systemSwitchLoggingApplicationSubAppVrfLevelString=systemSwitchLoggingApplicationSubAppVrfLevelString, systemSwitchLoggingHashAgeLimit=systemSwitchLoggingHashAgeLimit, systemServicesTtyLines=systemServicesTtyLines, systemSwitchLoggingSocket=systemSwitchLoggingSocket, alcatelIND1SystemMIBCompliances=alcatelIND1SystemMIBCompliances, systemSwitchLogging=systemSwitchLogging, systemSwitchLoggingDgHostIndex=systemSwitchLoggingDgHostIndex, systemServicesArg6=systemServicesArg6, systemBootParams=systemBootParams, systemServicesWorkingDirectory=systemServicesWorkingDirectory, systemServicesTimezoneStartMonth=systemServicesTimezoneStartMonth, systemServicesArg1=systemServicesArg1, systemDNSNsIPv6Addr1=systemDNSNsIPv6Addr1, systemFileSystemFileTable=systemFileSystemFileTable, systemServicesArchiveEntry=systemServicesArchiveEntry, systemMicrocodePackageDirectoryIndex=systemMicrocodePackageDirectoryIndex, systemSwitchLoggingHostv6UserCommandHost=systemSwitchLoggingHostv6UserCommandHost, AgeLimit=AgeLimit, systemSwitchLoggingApplicationAppId=systemSwitchLoggingApplicationAppId, systemSwitchLoggingHostTable=systemSwitchLoggingHostTable, systemVcHardwareFanTraysPresent=systemVcHardwareFanTraysPresent, systemSwitchLoggingTty=systemSwitchLoggingTty, systemServicesDate=systemServicesDate, systemServicesTimezoneEndWeek=systemServicesTimezoneEndWeek, systemUpdateErrorCode=systemUpdateErrorCode, systemFileSystemFileDateTime=systemFileSystemFileDateTime, systemSwitchLoggingDebug=systemSwitchLoggingDebug, systemSwitchLoggingDgHostTable=systemSwitchLoggingDgHostTable, systemVcHardwareMemorySize=systemVcHardwareMemorySize, systemSwitchLoggingEnable=systemSwitchLoggingEnable, systemSwitchLoggingHostv6Entry=systemSwitchLoggingHostv6Entry, systemMicrocodeLoadedDescription=systemMicrocodeLoadedDescription, systemServicesArchiveType=systemServicesArchiveType, systemServicesArg2=systemServicesArg2, systemServicesCurrentArchivePathName=systemServicesCurrentArchivePathName, SysLogFacilityId=SysLogFacilityId, systemMicrocodeLoadedName=systemMicrocodeLoadedName, systemSwitchLoggingDuplicateDetect=systemSwitchLoggingDuplicateDetect, systemServicesEnableDST=systemServicesEnableDST, systemSwitchLoggingHostEntry=systemSwitchLoggingHostEntry, systemSwitchLoggingApplicationSubAppId=systemSwitchLoggingApplicationSubAppId, systemServicesBluetoothTable=systemServicesBluetoothTable, systemFips=systemFips, VrfId=VrfId, systemServicesSystraceLevelEntry=systemServicesSystraceLevelEntry, systemDNSDomainName=systemDNSDomainName, systemFileSystemDirectoryName=systemFileSystemDirectoryName, systemVcHardwareGroup=systemVcHardwareGroup, systemNotificationGroup=systemNotificationGroup, systemSwitchLoggingHostv6Port=systemSwitchLoggingHostv6Port, systemServicesGroup=systemServicesGroup, alcatelIND1SystemMIBConformance=alcatelIND1SystemMIBConformance, systemServicesBluetoothEntry=systemServicesBluetoothEntry, SwitchLoggingIndex=SwitchLoggingIndex, systemUpdateStatusEntry=systemUpdateStatusEntry, systemSwitchLoggingLibraryName=systemSwitchLoggingLibraryName, systemDNSNsAddr2=systemDNSNsAddr2, systemVcHardwareTable=systemVcHardwareTable, systemHardwareBackupMiniBootVersion=systemHardwareBackupMiniBootVersion, systemDNSNsAddr3=systemDNSNsAddr3, systemHardwareBootCpuType=systemHardwareBootCpuType, systemServicesTimezoneStartTime=systemServicesTimezoneStartTime, systemHardwareDefaultMiniBootVersion=systemHardwareDefaultMiniBootVersion, systemSwitchLoggingSysLogFacilityId=systemSwitchLoggingSysLogFacilityId, systemUpdateStatus=systemUpdateStatus, systemFileSystemName=systemFileSystemName, systemMicrocodePackageName=systemMicrocodePackageName, SeverityLevel=SeverityLevel, systemFileSystemTable=systemFileSystemTable, systemMicrocodePackageIndex=systemMicrocodePackageIndex, systemFipsOperState=systemFipsOperState, systemMicrocodeGroup=systemMicrocodeGroup, systemServicesResultString=systemServicesResultString, systemDNSNsIPv6Addr3=systemDNSNsIPv6Addr3, systemFileSystemFileAttr=systemFileSystemFileAttr, systemHardwareFlashMfg=systemHardwareFlashMfg, systemServicesTimezoneEndDay=systemServicesTimezoneEndDay, systemServicesTtyColumns=systemServicesTtyColumns, systemVcHardwarePowerSuppliesPresent=systemVcHardwarePowerSuppliesPresent, systemVcHardware=systemVcHardware, systemSwitchLoggingIndex=systemSwitchLoggingIndex, systemServicesArchiveTable=systemServicesArchiveTable, systemSwitchLoggingConsoleLevel=systemSwitchLoggingConsoleLevel, systemServicesTimezoneEndTime=systemServicesTimezoneEndTime, systemSwitchLoggingFileSize=systemSwitchLoggingFileSize, systemVcHardwareFpga2Version=systemVcHardwareFpga2Version, systemMicrocodePackageDescription=systemMicrocodePackageDescription, systemServicesArchiveAttr=systemServicesArchiveAttr, systemSwitchLoggingVrf=systemSwitchLoggingVrf, systemHardwareBootRomVersion=systemHardwareBootRomVersion, systemVcHardwareCpuVendor=systemVcHardwareCpuVendor, systemServicesTimezoneStartDay=systemServicesTimezoneStartDay, systemVcHardwareEntry=systemVcHardwareEntry, systemHardwareUbootMinibootVersion=systemHardwareUbootMinibootVersion, systemServicesArg7=systemServicesArg7, systemBlueToothServices=systemBlueToothServices, systemServicesResultCode=systemServicesResultCode, systemSwitchLoggingHostCount=systemSwitchLoggingHostCount, Enable=Enable, systemSwitchLoggingUserCommandStatus=systemSwitchLoggingUserCommandStatus, systemServicesBluetoothChassisId=systemServicesBluetoothChassisId, systemServicesBluetoothEnable=systemServicesBluetoothEnable, systemFileSystemFileSize=systemFileSystemFileSize, systemMicrocodePackageVersion=systemMicrocodePackageVersion, systemHardwareCpldVersion=systemHardwareCpldVersion, systemFileSystemFileType=systemFileSystemFileType, systemFileSystemGroup=systemFileSystemGroup, systemHardwareMemorySize=systemHardwareMemorySize, systemDNSGroup=systemDNSGroup, systemHardwareGroup=systemHardwareGroup, systemMicrocodeLoadedEntry=systemMicrocodeLoadedEntry, systemSwitchLoggingApplicationAppName=systemSwitchLoggingApplicationAppName, systemVcHardwareFpga1Version=systemVcHardwareFpga1Version, alcatelIND1SystemMIB=alcatelIND1SystemMIB, systemSwitchLoggingApplicationTable=systemSwitchLoggingApplicationTable, systemDNSEnableDnsResolver=systemDNSEnableDnsResolver, SystemFileType=SystemFileType, systemServicesBluetoothTxPower=systemServicesBluetoothTxPower, systemServicesArg3=systemServicesArg3, systemServicesArg8=systemServicesArg8, systemSwitchLoggingDgHostIpAddr=systemSwitchLoggingDgHostIpAddr, systemBootNetwork=systemBootNetwork, systemSwlogGroup=systemSwlogGroup, systemServicesArg9=systemServicesArg9, systemFileSystemIndex=systemFileSystemIndex, systemFileSystemFileEntry=systemFileSystemFileEntry, AppIdIndex=AppIdIndex, systemVcHardwareNisPresent=systemVcHardwareNisPresent, systemHardwareFpgaVersionTable=systemHardwareFpgaVersionTable, systemSwitchLoggingDgHostIpType=systemSwitchLoggingDgHostIpType, systemHardwareJumperRunExtendedMemoryDiagnostics=systemHardwareJumperRunExtendedMemoryDiagnostics, systemSwitchLoggingApplicationSubAppLevel=systemSwitchLoggingApplicationSubAppLevel, systemVcHardwareFlashMfg=systemVcHardwareFlashMfg, systemSwlogName=systemSwlogName, systemHardwareFpgaVersionIndex=systemHardwareFpgaVersionIndex)
