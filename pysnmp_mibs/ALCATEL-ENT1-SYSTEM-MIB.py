#
# PySNMP MIB module ALCATEL-ENT1-SYSTEM-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-SYSTEM-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 09:57:59 2025
# On host macmini.vegmond.io platform Darwin version 24.6.0 by user rob
# Using Python version 3.12.8 (main, Dec  3 2024, 18:42:41) [Clang 16.0.0 (clang-1600.0.26.4)]
#
hardentIND1System, = mibBuilder.importSymbols("ALCATEL-ENT1-BASE", "hardentIND1System")
virtualChassisOperChasId, VirtualOperChassisId = mibBuilder.importSymbols("ALCATEL-ENT1-VIRTUAL-CHASSIS-MIB", "virtualChassisOperChasId", "VirtualOperChassisId")
...
systemMicrocodePackageEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 1, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodePackageDirectoryIndex"), (0, "ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodePackageDirectory"), (0, "ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodePackageIndex"))
...
systemMicrocodeLoadedEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 1, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodeLoadedIndex"))
...
systemHardwareFpgaVersionEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 3, 11, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareFpgaVersionIndex"))
...
systemServicesKtraceLevelEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 5, 32, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemServicesKtraceLevelAppId"))
...
systemServicesSystraceLevelEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 5, 33, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemServicesSystraceLevelAppId"))
...
systemUpdateStatusEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 5, 34, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemUpdateIndex"))
...
systemServicesArchiveEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 5, 37, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArchiveIndex"))
...
systemFileSystemEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 4, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemIndex"))
...
systemFileSystemFileEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 4, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemFileIndex"))
...
systemSwitchLoggingLevelEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 6, 7, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationAppId"), (0, "ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationSubAppId"), (0, "ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationSubAppVrfLevelIndex"))
...
systemSwitchLoggingHostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 6, 10, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostIpAddr"))
...
systemSwitchLoggingHostv6Entry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 6, 11, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostv6IpAddr"))
...
systemSwitchLoggingDgHostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 6, 27, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingDgHostIndex"))
...
systemServicesBluetoothEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 8, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-SYSTEM-MIB", "systemServicesBluetoothChassisId"))
...
systemVcHardwareEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 1, 10, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-VIRTUAL-CHASSIS-MIB", "virtualChassisOperChasId"))
...
systemSwlogSizeTrap = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 4, 0, 1)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemSwlogName"))
if mibBuilder.loadTexts: systemSwlogSizeTrap.setStatus('current')
alcatelIND1SystemMIBCompliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 2, 1)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodeGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemBootParamsGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemDNSGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemBlueToothServicesGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFipsGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareGroup"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemNotificationGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alcatelIND1SystemMIBCompliance = alcatelIND1SystemMIBCompliance.setStatus('current')
systemMicrocodeGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 1)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodePackageVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodePackageName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodePackageDescription"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodePackageStatus"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodePackageSize"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodeLoadedDirectory"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodeLoadedVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodeLoadedName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodeLoadedDescription"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemMicrocodeLoadedSize"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemMicrocodeGroup = systemMicrocodeGroup.setStatus('current')
systemBootParamsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 2)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemBootNetwork"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemBootNetworkGateway"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemBootNetworkNetmask"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemBootParamsGroup = systemBootParamsGroup.setStatus('current')
systemHardwareGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 3)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareFlashMfg"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareFlashSize"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareMemoryMfg"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareMemorySize"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareNVRAMBatteryLow"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareBootCpuType"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareJumperInterruptBoot"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareJumperForceUartDefaults"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareJumperRunExtendedMemoryDiagnostics"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareJumperSpare"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareFpgaVersionIndex"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareFpgaVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareBootRomVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareDefaultMiniBootVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareBackupMiniBootVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareCpldVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareMinorFpgaVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareProdRegId"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareRevisionRegister"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareUbootMinibootVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareUbootVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemHardwareXfpId"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemHardwareGroup = systemHardwareGroup.setStatus('current')
systemServicesGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 4)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesDate"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTime"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezone"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezoneStartWeek"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezoneStartDay"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezoneStartMonth"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezoneStartTime"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezoneOffset"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezoneEndWeek"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezoneEndDay"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezoneEndMonth"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTimezoneEndTime"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesEnableDST"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesWorkingDirectory"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArg1"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArg2"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArg3"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArg4"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArg5"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArg6"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArg7"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArg8"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArg9"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesAction"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesResultCode"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesResultString"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesKtraceEnable"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesSystraceEnable"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTtyLines"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesTtyColumns"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesMemMonitorEnable"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesKtraceLevelAppId"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesKtraceLevel"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesSystraceLevelAppId"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesSystraceLevel"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemUpdateStatus"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemUpdateErrorCode"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesActionPercentComplete"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArchiveName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArchiveType"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArchiveSize"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArchiveAttr"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesUsbEnable"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesUsbAutoCopyEnable"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesUsbMounted"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesArchiveIndex"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesCurrentArchivePathName"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemServicesGroup = systemServicesGroup.setStatus('current')
systemFileSystemGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 5)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemIndex"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemFreeSpace"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemDirectoryName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemDirectoryDateTime"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemFileIndex"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemFileName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemFileType"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemFileSize"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemFileAttr"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFileSystemFileDateTime"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemFileSystemGroup = systemFileSystemGroup.setStatus('current')
systemSwitchLoggingGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 6)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingIndex"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingEnable"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingFlash"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingSocket"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingSocketIpAddr"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingConsole"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingClear"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingFileSize"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingLevel"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationAppId"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationAppName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationSubAppId"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationSubAppName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationSubAppLevel"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationSubAppVrfLevelIndex"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingApplicationSubAppVrfLevelString"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingAppName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingDuplicateDetect"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingPreamble"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingDebug"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingVrf"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHashAgeLimit"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingTty"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingSubAppNbr"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingLibraryName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingLoopback0"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingConsoleLevel"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostCount"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingUserCommandStatus"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingSysLogFacilityId"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostIpAddr"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostPort"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostStatus"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostUserCommandHost"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostVrfName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostv6IpAddr"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostv6Port"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostv6Status"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostv6UserCommandHost"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingHostv6VrfName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingDgHostIpType"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemSwitchLoggingDgHostIpAddr"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemSwitchLoggingGroup = systemSwitchLoggingGroup.setStatus('current')
systemDNSGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 7)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemDNSEnableDnsResolver"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemDNSDomainName"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemDNSNsAddr1"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemDNSNsAddr2"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemDNSNsAddr3"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemDNSNsIPv6Addr1"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemDNSNsIPv6Addr2"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemDNSNsIPv6Addr3"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemDNSGroup = systemDNSGroup.setStatus('current')
systemBlueToothServicesGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 8)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesBluetoothEnable"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesBluetoothTxPower"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesBluetoothStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemBlueToothServicesGroup = systemBlueToothServicesGroup.setStatus('current')
systemFipsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 9)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemFipsAdminState"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemFipsOperState"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemFipsGroup = systemFipsGroup.setStatus('current')
systemVcHardwareGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 10)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareCpuVendor"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareCpuModel"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareFlashMfg"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareFlashSize"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareMemoryMfg"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareMemorySize"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareUbootVersion"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareFpga1Version"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareFpga2Version"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwarePowerSuppliesPresent"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareNisPresent"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareCFMsPresent"), ("ALCATEL-ENT1-SYSTEM-MIB", "systemVcHardwareFanTraysPresent"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemVcHardwareGroup = systemVcHardwareGroup.setStatus('current')
systemSwlogGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 11)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemSwlogName"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemSwlogGroup = systemSwlogGroup.setStatus('current')
systemNotificationGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 2, 1, 2, 1, 12)).setObjects(("ALCATEL-ENT1-SYSTEM-MIB", "systemSwlogSizeTrap"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    systemNotificationGroup = systemNotificationGroup.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-SYSTEM-MIB", AppIdIndex=AppIdIndex, systemServicesUsbEnable=systemServicesUsbEnable, systemSwitchLoggingApplicationSubAppId=systemSwitchLoggingApplicationSubAppId, alcatelIND1SystemMIBGroups=alcatelIND1SystemMIBGroups, systemBootParamsGroup=systemBootParamsGroup, systemFileSystemFileDateTime=systemFileSystemFileDateTime, systemBootNetworkGateway=systemBootNetworkGateway, systemServicesArg7=systemServicesArg7, systemHardwareUbootVersion=systemHardwareUbootVersion, systemServicesArchiveName=systemServicesArchiveName, systemVcHardware=systemVcHardware, systemDNSNsAddr2=systemDNSNsAddr2, systemVcHardwareMemorySize=systemVcHardwareMemorySize, alcatelIND1SystemMIBTrapObjects=alcatelIND1SystemMIBTrapObjects, alcatelIND1SystemMIBTraps=alcatelIND1SystemMIBTraps, systemHardwareMinorFpgaVersion=systemHardwareMinorFpgaVersion, systemServicesArg6=systemServicesArg6, systemVcHardwareCFMsPresent=systemVcHardwareCFMsPresent, systemVcHardwareGroup=systemVcHardwareGroup, systemHardwareJumperForceUartDefaults=systemHardwareJumperForceUartDefaults, systemSwitchLoggingHostStatus=systemSwitchLoggingHostStatus, systemHardwareFlashSize=systemHardwareFlashSize, systemServicesArg4=systemServicesArg4, systemHardwareJumperRunExtendedMemoryDiagnostics=systemHardwareJumperRunExtendedMemoryDiagnostics, systemFileSystemFileName=systemFileSystemFileName, systemSwitchLoggingDgHostTable=systemSwitchLoggingDgHostTable, systemSwitchLoggingHostEntry=systemSwitchLoggingHostEntry, systemVcHardwareTable=systemVcHardwareTable, systemServicesWorkingDirectory=systemServicesWorkingDirectory, systemSwitchLoggingClear=systemSwitchLoggingClear, systemHardwareFpgaVersionIndex=systemHardwareFpgaVersionIndex, systemServicesTimezoneOffset=systemServicesTimezoneOffset, systemSwlogSizeTrap=systemSwlogSizeTrap, systemFileSystemDirectoryName=systemFileSystemDirectoryName, systemServicesTimezone=systemServicesTimezone, systemVcHardwareEntry=systemVcHardwareEntry, systemServicesBluetoothTxPower=systemServicesBluetoothTxPower, systemHardwareProdRegId=systemHardwareProdRegId, systemServices=systemServices, systemHardwareBackupMiniBootVersion=systemHardwareBackupMiniBootVersion, systemServicesArg3=systemServicesArg3, systemServicesSystraceEnable=systemServicesSystraceEnable, systemSwitchLoggingLevel=systemSwitchLoggingLevel, systemFileSystemGroup=systemFileSystemGroup, systemHardwareMemoryMfg=systemHardwareMemoryMfg, systemVcHardwareUbootVersion=systemVcHardwareUbootVersion, systemServicesArg5=systemServicesArg5, systemSwitchLoggingHostCount=systemSwitchLoggingHostCount, systemFileSystemEntry=systemFileSystemEntry, systemHardwareBootRomVersion=systemHardwareBootRomVersion, systemServicesSystraceLevel=systemServicesSystraceLevel, systemSwitchLoggingApplicationSubAppVrfLevelString=systemSwitchLoggingApplicationSubAppVrfLevelString, systemDNSNsIPv6Addr1=systemDNSNsIPv6Addr1, systemServicesKtraceLevelEntry=systemServicesKtraceLevelEntry, systemServicesArg2=systemServicesArg2, systemBlueToothServices=systemBlueToothServices, systemServicesKtraceLevel=systemServicesKtraceLevel, systemHardwareFpgaVersionEntry=systemHardwareFpgaVersionEntry, systemMicrocodePackageVersion=systemMicrocodePackageVersion, systemServicesSystraceLevelEntry=systemServicesSystraceLevelEntry, systemMicrocodeLoadedName=systemMicrocodeLoadedName, systemSwitchLoggingConsoleLevel=systemSwitchLoggingConsoleLevel, systemHardwareJumperInterruptBoot=systemHardwareJumperInterruptBoot, systemServicesBluetoothEntry=systemServicesBluetoothEntry, systemFileSystemTable=systemFileSystemTable, alcatelIND1SystemMIBCompliance=alcatelIND1SystemMIBCompliance, systemHardwareRevisionRegister=systemHardwareRevisionRegister, systemSwitchLoggingApplicationTable=systemSwitchLoggingApplicationTable, systemServicesArg9=systemServicesArg9, FileSystemIndex=FileSystemIndex, systemDNSNsAddr1=systemDNSNsAddr1, systemVcHardwareCpuVendor=systemVcHardwareCpuVendor, systemSwitchLoggingDuplicateDetect=systemSwitchLoggingDuplicateDetect, systemSwitchLoggingAppName=systemSwitchLoggingAppName, systemDNSNsIPv6Addr3=systemDNSNsIPv6Addr3, systemFileSystemFileAttr=systemFileSystemFileAttr, systemVcHardwareFpga1Version=systemVcHardwareFpga1Version, alcatelIND1SystemMIB=alcatelIND1SystemMIB, systemMicrocodePackageEntry=systemMicrocodePackageEntry, systemServicesTimezoneEndDay=systemServicesTimezoneEndDay, systemVcHardwareCpuModel=systemVcHardwareCpuModel, systemMicrocodePackageDirectoryIndex=systemMicrocodePackageDirectoryIndex, systemBlueToothServicesGroup=systemBlueToothServicesGroup, systemServicesGroup=systemServicesGroup, systemServicesTimezoneEndTime=systemServicesTimezoneEndTime, systemSwitchLoggingApplicationSubAppVrfLevelIndex=systemSwitchLoggingApplicationSubAppVrfLevelIndex, systemDNSNsAddr3=systemDNSNsAddr3, systemHardwareMemorySize=systemHardwareMemorySize, systemServicesEnableDST=systemServicesEnableDST, PYSNMP_MODULE_ID=alcatelIND1SystemMIB, systemFips=systemFips, systemServicesArchiveTable=systemServicesArchiveTable, alcatelIND1SystemMIBCompliances=alcatelIND1SystemMIBCompliances, systemMicrocodePackageDescription=systemMicrocodePackageDescription, systemVcHardwarePowerSuppliesPresent=systemVcHardwarePowerSuppliesPresent, systemServicesResultString=systemServicesResultString, systemSwitchLoggingTty=systemSwitchLoggingTty, systemServicesTtyLines=systemServicesTtyLines, systemFileSystemFileSize=systemFileSystemFileSize, systemVcHardwareNisPresent=systemVcHardwareNisPresent, systemServicesTimezoneStartDay=systemServicesTimezoneStartDay, systemSwitchLoggingSocket=systemSwitchLoggingSocket, systemMicrocodePackageName=systemMicrocodePackageName, systemServicesUsbMounted=systemServicesUsbMounted, systemFipsOperState=systemFipsOperState, systemSwlogName=systemSwlogName, systemBootNetwork=systemBootNetwork, systemVcHardwareFpga2Version=systemVcHardwareFpga2Version, systemSwitchLoggingLoopback0=systemSwitchLoggingLoopback0, systemSwitchLoggingDgHostIpType=systemSwitchLoggingDgHostIpType, systemMicrocodePackageIndex=systemMicrocodePackageIndex, systemMicrocodeLoadedEntry=systemMicrocodeLoadedEntry, systemFileSystemIndex=systemFileSystemIndex, systemDNSEnableDnsResolver=systemDNSEnableDnsResolver, systemSwitchLoggingHostv6Status=systemSwitchLoggingHostv6Status, systemDNS=systemDNS, systemMicrocodeGroup=systemMicrocodeGroup, systemServicesKtraceEnable=systemServicesKtraceEnable, systemFipsAdminState=systemFipsAdminState, systemSwitchLoggingPreamble=systemSwitchLoggingPreamble, VrfId=VrfId, systemFileSystemDirectoryDateTime=systemFileSystemDirectoryDateTime, systemServicesSystraceLevelTable=systemServicesSystraceLevelTable, systemFileSystem=systemFileSystem, systemServicesResultCode=systemServicesResultCode, systemSwitchLoggingSysLogFacilityId=systemSwitchLoggingSysLogFacilityId, systemFileSystemFileIndex=systemFileSystemFileIndex, systemMicrocodePackageDirectory=systemMicrocodePackageDirectory, systemHardwareBootCpuType=systemHardwareBootCpuType, systemVcHardwareMemoryMfg=systemVcHardwareMemoryMfg, systemServicesArg1=systemServicesArg1, systemBootParams=systemBootParams, systemSwitchLoggingIndex=systemSwitchLoggingIndex, systemMicrocodeLoadedSize=systemMicrocodeLoadedSize, systemSwitchLoggingHostUserCommandHost=systemSwitchLoggingHostUserCommandHost, systemMicrocodePackageSize=systemMicrocodePackageSize, systemSwitchLoggingApplicationSubAppName=systemSwitchLoggingApplicationSubAppName, systemSwitchLoggingDebug=systemSwitchLoggingDebug, systemServicesTimezoneStartWeek=systemServicesTimezoneStartWeek, systemHardwareUbootMinibootVersion=systemHardwareUbootMinibootVersion, systemMicrocodePackageStatus=systemMicrocodePackageStatus, SystemFileType=SystemFileType, systemHardwareFlashMfg=systemHardwareFlashMfg, systemSwitchLoggingApplicationAppName=systemSwitchLoggingApplicationAppName, systemServicesBluetoothStatus=systemServicesBluetoothStatus, systemHardware=systemHardware, systemSwitchLoggingConsole=systemSwitchLoggingConsole, systemServicesBluetoothTable=systemServicesBluetoothTable, systemBootNetworkNetmask=systemBootNetworkNetmask, systemServicesArchiveSize=systemServicesArchiveSize, systemServicesArchiveIndex=systemServicesArchiveIndex, systemSwitchLoggingDgHostIpAddr=systemSwitchLoggingDgHostIpAddr, systemHardwareGroup=systemHardwareGroup, systemMicrocodeLoadedVersion=systemMicrocodeLoadedVersion, systemMicrocodeLoadedDescription=systemMicrocodeLoadedDescription, systemServicesKtraceLevelAppId=systemServicesKtraceLevelAppId, systemUpdateErrorCode=systemUpdateErrorCode, alcatelIND1SystemMIBConformance=alcatelIND1SystemMIBConformance, systemServicesActionPercentComplete=systemServicesActionPercentComplete, systemSwitchLoggingFlash=systemSwitchLoggingFlash, systemHardwareXfpId=systemHardwareXfpId, systemNotificationGroup=systemNotificationGroup, systemServicesTime=systemServicesTime, systemFipsGroup=systemFipsGroup, systemSwitchLoggingHostTable=systemSwitchLoggingHostTable, systemServicesAction=systemServicesAction, systemServicesArchiveType=systemServicesArchiveType, systemSwitchLoggingUserCommandStatus=systemSwitchLoggingUserCommandStatus, systemServicesTimezoneEndWeek=systemServicesTimezoneEndWeek, systemSwitchLoggingHostv6Table=systemSwitchLoggingHostv6Table, Enable=Enable, SeverityLevel=SeverityLevel, systemServicesTimezoneStartTime=systemServicesTimezoneStartTime, systemSwitchLoggingHostPort=systemSwitchLoggingHostPort, systemSwitchLoggingHashAgeLimit=systemSwitchLoggingHashAgeLimit, systemSwitchLoggingLibraryName=systemSwitchLoggingLibraryName, systemUpdateStatusEntry=systemUpdateStatusEntry, systemServicesSystraceLevelAppId=systemServicesSystraceLevelAppId, systemServicesArchiveEntry=systemServicesArchiveEntry, systemSwitchLoggingHostv6Port=systemSwitchLoggingHostv6Port, AgeLimit=AgeLimit, systemSwitchLoggingApplicationAppId=systemSwitchLoggingApplicationAppId, systemServicesTimezoneStartMonth=systemServicesTimezoneStartMonth, systemMicrocodeLoadedTable=systemMicrocodeLoadedTable, SysLogFacilityId=SysLogFacilityId, systemMicrocodeLoadedDirectory=systemMicrocodeLoadedDirectory, systemSwitchLoggingDgHostIndex=systemSwitchLoggingDgHostIndex, systemServicesBluetoothEnable=systemServicesBluetoothEnable, systemSwitchLoggingHostv6UserCommandHost=systemSwitchLoggingHostv6UserCommandHost, SwitchLoggingIndex=SwitchLoggingIndex, systemSwitchLoggingVrf=systemSwitchLoggingVrf, systemDNSNsIPv6Addr2=systemDNSNsIPv6Addr2, systemSwitchLoggingGroup=systemSwitchLoggingGroup, systemHardwareNVRAMBatteryLow=systemHardwareNVRAMBatteryLow, systemSwitchLoggingLevelEntry=systemSwitchLoggingLevelEntry, systemSwitchLoggingHostIpAddr=systemSwitchLoggingHostIpAddr, systemUpdateIndex=systemUpdateIndex, systemSwitchLoggingDgHostEntry=systemSwitchLoggingDgHostEntry, systemFileSystemName=systemFileSystemName, alcatelIND1SystemMIBObjects=alcatelIND1SystemMIBObjects, systemMicrocodePackageTable=systemMicrocodePackageTable, systemServicesArg8=systemServicesArg8, systemServicesUsbAutoCopyEnable=systemServicesUsbAutoCopyEnable, systemFileSystemFileType=systemFileSystemFileType, systemSwitchLoggingEnable=systemSwitchLoggingEnable, systemServicesTimezoneEndMonth=systemServicesTimezoneEndMonth, systemSwitchLogging=systemSwitchLogging, systemFileSystemFileTable=systemFileSystemFileTable, systemSwitchLoggingHostv6VrfName=systemSwitchLoggingHostv6VrfName, systemDNSDomainName=systemDNSDomainName, systemServicesTtyColumns=systemServicesTtyColumns, systemHardwareFpgaVersion=systemHardwareFpgaVersion, systemUpdateStatusTable=systemUpdateStatusTable, systemHardwareCpldVersion=systemHardwareCpldVersion, systemMicrocode=systemMicrocode, systemSwitchLoggingHostVrfName=systemSwitchLoggingHostVrfName, systemMicrocodeLoadedIndex=systemMicrocodeLoadedIndex, systemFileSystemFreeSpace=systemFileSystemFreeSpace, systemVcHardwareFlashSize=systemVcHardwareFlashSize, systemDNSGroup=systemDNSGroup, systemServicesCurrentArchivePathName=systemServicesCurrentArchivePathName, systemHardwareJumperSpare=systemHardwareJumperSpare, systemSwitchLoggingHostv6IpAddr=systemSwitchLoggingHostv6IpAddr, systemServicesBluetoothChassisId=systemServicesBluetoothChassisId, CommandPercentComplete=CommandPercentComplete, systemSwitchLoggingSubAppNbr=systemSwitchLoggingSubAppNbr, systemServicesArchiveAttr=systemServicesArchiveAttr, systemServicesKtraceLevelTable=systemServicesKtraceLevelTable, systemSwitchLoggingHostv6Entry=systemSwitchLoggingHostv6Entry, systemHardwareFpgaVersionTable=systemHardwareFpgaVersionTable, systemSwitchLoggingSocketIpAddr=systemSwitchLoggingSocketIpAddr, systemServicesDate=systemServicesDate, systemHardwareDefaultMiniBootVersion=systemHardwareDefaultMiniBootVersion, systemServicesMemMonitorEnable=systemServicesMemMonitorEnable, systemUpdateStatus=systemUpdateStatus, systemSwlogGroup=systemSwlogGroup, systemVcHardwareFlashMfg=systemVcHardwareFlashMfg, systemFileSystemFileEntry=systemFileSystemFileEntry, systemSwitchLoggingApplicationSubAppLevel=systemSwitchLoggingApplicationSubAppLevel, systemVcHardwareFanTraysPresent=systemVcHardwareFanTraysPresent, systemSwitchLoggingFileSize=systemSwitchLoggingFileSize)
