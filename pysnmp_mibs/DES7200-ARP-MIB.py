...
myArpMIBObjects=_MyArpMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,2,1))
_MyArpTable_Object=MibTable
myArpTable=_MyArpTable_Object((1,3,6,1,4,1,171,10,97,2,2,1,1))
if mibBuilder.loadTexts:myArpTable.setStatus(_A)
_MyArpEntry_Object=MibTableRow
myArpEntry=_MyArpEntry_Object((1,3,6,1,4,1,171,10,97,2,2,1,1,1))
...
myArpIfIndex=_MyArpIfIndex_Object((1,3,6,1,4,1,171,10,97,2,2,1,1,1,1),_MyArpIfIndex_Type())
...
myArpPhysAddress=_MyArpPhysAddress_Object((1,3,6,1,4,1,171,10,97,2,2,1,1,1,2),_MyArpPhysAddress_Type())
...
myArpNetAddress=_MyArpNetAddress_Object((1,3,6,1,4,1,171,10,97,2,2,1,1,1,3),_MyArpNetAddress_Type())
...
myArpRemainAge=_MyArpRemainAge_Object((1,3,6,1,4,1,171,10,97,2,2,1,1,1,4),_MyArpRemainAge_Type())
...
myArpType=_MyArpType_Object((1,3,6,1,4,1,171,10,97,2,2,1,1,1,5),_MyArpType_Type())
...
myArpEntryType=_MyArpEntryType_Object((1,3,6,1,4,1,171,10,97,2,2,1,1,1,6),_MyArpEntryType_Type())
...
myArpStatus=_MyArpStatus_Object((1,3,6,1,4,1,171,10,97,2,2,1,1,1,7),_MyArpStatus_Type())
myArpStatus.setMaxAccess('read-create')
if mibBuilder.loadTexts:myArpStatus.setStatus(_A)
_MyArpIfTable_Object=MibTable
myArpIfTable=_MyArpIfTable_Object((1,3,6,1,4,1,171,10,97,2,2,1,2))
if mibBuilder.loadTexts:myArpIfTable.setStatus(_A)
_MyArpIfEntry_Object=MibTableRow
myArpIfEntry=_MyArpIfEntry_Object((1,3,6,1,4,1,171,10,97,2,2,1,2,1))
...
myArpIfIfIndex=_MyArpIfIfIndex_Object((1,3,6,1,4,1,171,10,97,2,2,1,2,1,1),_MyArpIfIfIndex_Type())
...
myArpIfCacheTimeOut=_MyArpIfCacheTimeOut_Object((1,3,6,1,4,1,171,10,97,2,2,1,2,1,2),_MyArpIfCacheTimeOut_Type())
...
myArpCurrentTotalNumber=_MyArpCurrentTotalNumber_Object((1,3,6,1,4,1,171,10,97,2,2,1,3),_MyArpCurrentTotalNumber_Type())
...
myArpCurrentUnresolveNumber=_MyArpCurrentUnresolveNumber_Object((1,3,6,1,4,1,171,10,97,2,2,1,4),_MyArpCurrentUnresolveNumber_Type())
...
myArpMIBConformance=_MyArpMIBConformance_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,2,2))
_MyArpMIBCompliances_ObjectIdentity=ObjectIdentity
myArpMIBCompliances=_MyArpMIBCompliances_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,2,2,1))
_MyArpMIBGroups_ObjectIdentity=ObjectIdentity
myArpMIBGroups=_MyArpMIBGroups_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,2,2,2))
myArpMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,2,2,2,1))
...
myArpMIBCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,97,2,2,2,1,1))
