...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/nortel/NORTEL-NETWORKS-RAPID-SPANNING-TREE-MIB
...
dot1dBaseBridgeAddress, Timeout, dot1dStpPort, BridgeId, dot1dStpDesignatedRoot = mibBuilder.importSymbols("BRIDGE-MIB", "dot1dBaseBridgeAddress", "Timeout", "dot1dStpPort", "BridgeId", "dot1dStpDesignatedRoot")
...
nnRapidSpanningTreeMib.setRevisions(('2014-07-29 00:00', '2004-02-24 00:00',))
if mibBuilder.loadTexts: nnRapidSpanningTreeMib.setLastUpdated('201407290000Z')
...
nnRstDot1wPortForwardTransitions = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 5, 4, 1, 2, 2, 1, 21), Counter32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: nnRstDot1wPortForwardTransitions.setStatus('current')
...
mibBuilder.exportSymbols("NORTEL-NETWORKS-RAPID-SPANNING-TREE-MIB", nnRstDot1wNewRootIdCount=nnRstDot1wNewRootIdCount, nnRstDot1dStpPathCostDefault=nnRstDot1dStpPathCostDefault, nnRstDot1w=nnRstDot1w, nnRstDot1wPortRxConfigBpduCount=nnRstDot1wPortRxConfigBpduCount, nnRstDot1dStpPortAdminPointToPoint=nnRstDot1dStpPortAdminPointToPoint, nnRstDot1wPortRole=nnRstDot1wPortRole, nnRstDot1wPortEffectivePortState=nnRstDot1wPortEffectivePortState, nnRstPortNotificationTable=nnRstPortNotificationTable, nnRstNotificationControlScalars=nnRstNotificationControlScalars, nnRstDot1wPortTxSmState=nnRstDot1wPortTxSmState, nnRstDot1wPortTxConfigBpduCount=nnRstDot1wPortTxConfigBpduCount, nnRstPortNotificationPktErrType=nnRstPortNotificationPktErrType, nnRapidSpanningTreeMib=nnRapidSpanningTreeMib, nnRstDot1wPortStateTransSmState=nnRstDot1wPortStateTransSmState, nnRstDot1dStpPortTable=nnRstDot1dStpPortTable, nnRstDot1wPort=nnRstDot1wPort, nnRstDot1wPortRxTcnBpduCount=nnRstDot1wPortRxTcnBpduCount, nnRstDot1dStpPortAdminEdgePort=nnRstDot1dStpPortAdminEdgePort, nnRstNotifications=nnRstNotifications, nnRstDot1dStpTxHoldCount=nnRstDot1dStpTxHoldCount, nnRstDot1wPortInvalidTcnBpduRxCount=nnRstDot1wPortInvalidTcnBpduRxCount, nnRstDot1dStpVersion=nnRstDot1dStpVersion, nnRstDot1wPortRoleSelSmState=nnRstDot1wPortRoleSelSmState, nnRstObjects=nnRstObjects, nnRstDot1wPortInvalidConfigBpduRxCount=nnRstDot1wPortInvalidConfigBpduRxCount, nnRstDot1dStpPortProtocolMigration=nnRstDot1dStpPortProtocolMigration, nnRstDot1wPortProtocolMigrationCount=nnRstDot1wPortProtocolMigrationCount, nnRstGeneralEvent=nnRstGeneralEvent, nnRstErrNotificationType=nnRstErrNotificationType, nnRstDot1wPortRoleTransSmState=nnRstDot1wPortRoleTransSmState, nnRstDot1wRstpDownCount=nnRstDot1wRstpDownCount, nnRstDot1wPortOperVersion=nnRstDot1wPortOperVersion, nnRstDot1wPortTxRstBpduCount=nnRstDot1wPortTxRstBpduCount, nnRstPortNotificationPktErrVal=nnRstPortNotificationPktErrVal, nnRstGenNotificationType=nnRstGenNotificationType, nnRstDot1wPortEntry=nnRstDot1wPortEntry, nnRstDot1dStpPortEntry=nnRstDot1dStpPortEntry, nnRstErrorEvent=nnRstErrorEvent, nnRstDot1d=nnRstDot1d, nnRstProtocolMigration=nnRstProtocolMigration, nnRstDot1wPortTable=nnRstDot1wPortTable, nnRstDot1wPortInvalidRstBpduRxCount=nnRstDot1wPortInvalidRstBpduRxCount, nnRstDot1wPortForwardTransitions=nnRstDot1wPortForwardTransitions, nnRstPortNotificationMigrationType=nnRstPortNotificationMigrationType, nnRstDot1wPortRxRstBpduCount=nnRstDot1wPortRxRstBpduCount, nnRstDot1dScalars=nnRstDot1dScalars, nnRstDot1wPortTxTcnBpduCount=nnRstDot1wPortTxTcnBpduCount, nnRstNotificationControl=nnRstNotificationControl, nnRstSetNotifications=nnRstSetNotifications, nnRstDot1wRstpUpCount=nnRstDot1wRstpUpCount, nnRstPortNotificationEntry=nnRstPortNotificationEntry, nnRstTopologyChange=nnRstTopologyChange, nnRstPortNotificationIndex=nnRstPortNotificationIndex, nnRstDot1wScalars=nnRstDot1wScalars, nnRstNewRoot=nnRstNewRoot, nnRstDot1wPortMigSmState=nnRstDot1wPortMigSmState, nnRstDot1wOldDesignatedRoot=nnRstDot1wOldDesignatedRoot, nnRstDot1dStpPortParticipating=nnRstDot1dStpPortParticipating, PYSNMP_MODULE_ID=nnRapidSpanningTreeMib, nnRstDot1dStpPortOperEdgePort=nnRstDot1dStpPortOperEdgePort, nnRstDot1dStpPortOperPointToPoint=nnRstDot1dStpPortOperPointToPoint, nnRstDot1wPortInfoSmState=nnRstDot1wPortInfoSmState, nnRstDot1wPortTopoChSmState=nnRstDot1wPortTopoChSmState)
