...
# Notes
# -----
# ASN.1 source file://mibs/nortel/NORTEL-NETWORKS-RAPID-SPANNING-TREE-MIB
...
nnRstDot1wPortForwardTransitions = _NnRstDot1wPortForwardTransitions_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 4, 1, 2, 2, 1, 21),
    _NnRstDot1wPortForwardTransitions_Type()
)
nnRstDot1wPortForwardTransitions.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnRstDot1wPortForwardTransitions.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"nnRapidSpanningTreeMib": nnRapidSpanningTreeMib,
       ...
       "nnRstDot1wPortForwardTransitions": nnRstDot1wPortForwardTransitions,
