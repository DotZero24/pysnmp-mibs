...
# Notes
# -----
# ASN.1 source file://mibs/eaton/EATON-PXG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:56:28 2025
...
tkSimpleCompliance.setObjects(
      *(("EATON-PXG-MIB", "tkEventGroup"),
        ("EATON-PXG-MIB", "tkEventNotifyGroup"))
)
if mibBuilder.loadTexts:
...
tkAlarmsTableCompliance.setObjects(
      *(("EATON-PXG-MIB", "tkEventGroup"),
        ("EATON-PXG-MIB", "tkAlarmTableGroup"),
        ("EATON-PXG-MIB", "tkEventNotifyGroup"),
        ("EATON-PXG-MIB", "tkAlarmNotifyGroup"))
)
if mibBuilder.loadTexts:
