...
mibBuilder.exportSymbols("HPN-ICF-EVB-MIB", hpnicfFlex10RemSchDesFormat=hpnicfFlex10RemSchDesFormat, hpnicfFlex10RemSchPir=hpnicfFlex10RemSchPir, hpnicfEvbVSIVlanId=hpnicfEvbVSIVlanId, hpnicfEvbMacLearningStatus=hpnicfEvbMacLearningStatus, hpnicfFlex10Objects=hpnicfFlex10Objects, hpnicfEvbSchannelConfigTable=hpnicfEvbSchannelConfigTable, hpnicfEvbVSIMac=hpnicfEvbVSIMac, hpnicfFlex10RemoteSchannelEntry=hpnicfFlex10RemoteSchannelEntry, hpnicfEvbRRStatus=hpnicfEvbRRStatus, hpnicfEvbPortConfigTable=hpnicfEvbPortConfigTable, hpnicfFlex10PortConfigTable=hpnicfFlex10PortConfigTable, hpnicfEvbSchannelID=hpnicfEvbSchannelID, hpnicfFlex10PortConfigEntry=hpnicfFlex10PortConfigEntry, hpnicfFlex10RemSchTerminationType=hpnicfFlex10RemSchTerminationType, hpnicfEvbSysObjects=hpnicfEvbSysObjects, hpnicfEvbVSIConfigEntry=hpnicfEvbVSIConfigEntry, hpnicfEvbManagerIndex=hpnicfEvbManagerIndex, hpnicfEvbGroupID=hpnicfEvbGroupID, hpnicfEvbVSIFilterRowStatus=hpnicfEvbVSIFilterRowStatus, hpnicfFlex10SchannelSVID=hpnicfFlex10SchannelSVID, hpnicfFlex10SchannelLocalStatus=hpnicfFlex10SchannelLocalStatus, hpnicfEvb=hpnicfEvb, hpnicfEvbManagerID=hpnicfEvbManagerID, hpnicfEvbSetResult=hpnicfEvbSetResult, hpnicfEvbDefaultManagerTable=hpnicfEvbDefaultManagerTable, hpnicfEvbVSIRowStatus=hpnicfEvbVSIRowStatus, hpnicfEvbPortNumber=hpnicfEvbPortNumber, hpnicfFlex10RemSchTerminationCap=hpnicfFlex10RemSchTerminationCap, PYSNMP_MODULE_ID=hpnicfEvb, hpnicfFlex10RemSchTrafficClass=hpnicfFlex10RemSchTrafficClass, hpnicfFlex10RemSchConnectionID=hpnicfFlex10RemSchConnectionID, hpnicfEvbSchannelRowStatus=hpnicfEvbSchannelRowStatus, hpnicfEvbManagerPort=hpnicfEvbManagerPort, hpnicfFlex10SchannelRemoteStatus=hpnicfFlex10SchannelRemoteStatus, hpnicfFlex10RemSchCir=hpnicfFlex10RemSchCir, hpnicfEvbVSICommand=hpnicfEvbVSICommand, hpnicfEvbVSILocalID=hpnicfEvbVSILocalID, hpnicfEvbVSIFilterConfigTable=hpnicfEvbVSIFilterConfigTable, hpnicfFlex10PortEnableStatus=hpnicfFlex10PortEnableStatus, hpnicfEvbRKA=hpnicfEvbRKA, hpnicfEvbSBPPortNumber=hpnicfEvbSBPPortNumber, hpnicfFlex10SchannelLinkCtlEntry=hpnicfFlex10SchannelLinkCtlEntry, hpnicfEvbSchannelConfigEntry=hpnicfEvbSchannelConfigEntry, hpnicfEvbVSIConfigTable=hpnicfEvbVSIConfigTable, hpnicfEvbVSIFilterConfigEntry=hpnicfEvbVSIFilterConfigEntry, hpnicfFlex10RemoteSchannelTable=hpnicfFlex10RemoteSchannelTable, hpnicfFlex10SchannelLinkCtlTable=hpnicfFlex10SchannelLinkCtlTable, hpnicfEvbPortObjects=hpnicfEvbPortObjects, hpnicfFlex10PortNumber=hpnicfFlex10PortNumber, hpnicfEvbManagerType=hpnicfEvbManagerType, hpnicfEvbPortConfigEntry=hpnicfEvbPortConfigEntry, hpnicfEvbRWD=hpnicfEvbRWD, hpnicfEvbSchannelSVLAN=hpnicfEvbSchannelSVLAN, hpnicfEvbDefaultManagerEntry=hpnicfEvbDefaultManagerEntry, hpnicfEvbVSIIsActive=hpnicfEvbVSIIsActive, hpnicfEvbManagerRowStatus=hpnicfEvbManagerRowStatus, hpnicfEvbVSIIfIndex=hpnicfEvbVSIIfIndex)
