...
mibBuilder.exportSymbols("HPNSAHOTSWAPSUBSYSTEM-MIB", hpnsaHSDevIndex=hpnsaHSDevIndex, hpnsaHSDevExistence=hpnsaHSDevExistence, hpnsaHSModuleTable=hpnsaHSModuleTable, hpnsaHSPwrAlertDelay=hpnsaHSPwrAlertDelay, hpnsaHSModuleTempStatus=hpnsaHSModuleTempStatus, hpnsaHSAgent=hpnsaHSAgent, hpnsaHSModuleMiddleDrvAddr=hpnsaHSModuleMiddleDrvAddr, hpnsaHSModuleEntry=hpnsaHSModuleEntry, hp=hp, nm=nm, hpnsaHSDev=hpnsaHSDev, hpnsaHSDevScsiAddr=hpnsaHSDevScsiAddr, hpnsaHSDevEntry=hpnsaHSDevEntry, hpnsaHSAgentDate=hpnsaHSAgentDate, hpnsaHSDevTable=hpnsaHSDevTable, hpnsaHSAgentIndex=hpnsaHSAgentIndex, hpnsaHotSwap=hpnsaHotSwap, hpnsaHSMibRev=hpnsaHSMibRev, hpnsaHSModuleDeviceStartup=hpnsaHSModuleDeviceStartup, hpnsaHSModuleHi8ScsiAddr=hpnsaHSModuleHi8ScsiAddr, hpnsaHSMibRevMinor=hpnsaHSMibRevMinor, hpnsaHSDevModuleIndex=hpnsaHSDevModuleIndex, hpnsaHSModuleSwitchState=hpnsaHSModuleSwitchState, hpnsaHSAgentName=hpnsaHSAgentName, hpnsaHSAgentTable=hpnsaHSAgentTable, hpnsaHSDevPowerStatus=hpnsaHSDevPowerStatus, hpnsaHSAgentEntry=hpnsaHSAgentEntry, hpnsaHSModuleScsiCableType=hpnsaHSModuleScsiCableType, hpnsaHSMibRevMajor=hpnsaHSMibRevMajor, hpnsaHSModuleIndex=hpnsaHSModuleIndex, hpnsa=hpnsa, hpnsaHSAgentVersion=hpnsaHSAgentVersion, hpnsaHSModule=hpnsaHSModule)
