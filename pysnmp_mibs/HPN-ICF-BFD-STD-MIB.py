...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/HPN-ICF-BFD-STD-MIB
...
mibBuilder.exportSymbols("HPN-ICF-BFD-STD-MIB", hpnicfBfdSessPerfLastUpTime=hpnicfBfdSessPerfLastUpTime, hpnicfBfdSysInitMode=hpnicfBfdSysInitMode, hpnicfBfdSessLocalDiscr=hpnicfBfdSessLocalDiscr, hpnicfBfdSessAddrType=hpnicfBfdSessAddrType, hpnicfBfdSessStatDownCount=hpnicfBfdSessStatDownCount, BfdSessIndexTC=BfdSessIndexTC, BfdDiag=BfdDiag, hpnicfBfdSessLocalDiag=hpnicfBfdSessLocalDiag, PYSNMP_MODULE_ID=hpnicfBfdMIB, hpnicfBfdSessStatTable=hpnicfBfdSessStatTable, hpnicfBfdIfDetectMult=hpnicfBfdIfDetectMult, hpnicfBfdSessAuthFail=hpnicfBfdSessAuthFail, hpnicfBfdSessStatEntry=hpnicfBfdSessStatEntry, hpnicfBfdIfIndex=hpnicfBfdIfIndex, hpnicfBfdObjects=hpnicfBfdObjects, hpnicfBfdSessAppSupportId=hpnicfBfdSessAppSupportId, hpnicfBfdMIB=hpnicfBfdMIB, hpnicfBfdSessPerfCreatTime=hpnicfBfdSessPerfCreatTime, hpnicfBfdIfDesiredMinTxInterval=hpnicfBfdIfDesiredMinTxInterval, hpnicfBfdSessStatPktDiscard=hpnicfBfdSessStatPktDiscard, hpnicfBfdSessOperMode=hpnicfBfdSessOperMode, hpnicfBfdSessReachLimit=hpnicfBfdSessReachLimit, hpnicfBfdSessIfIndex=hpnicfBfdSessIfIndex, hpnicfBfdSessDstPort=hpnicfBfdSessDstPort, hpnicfBfdSessRemoteDiscr=hpnicfBfdSessRemoteDiscr, hpnicfBfdSessStatPktInHC=hpnicfBfdSessStatPktInHC, hpnicfBfdSessStateDown=hpnicfBfdSessStateDown, hpnicfBfdSessStateChange=hpnicfBfdSessStateChange, hpnicfBfdIfTable=hpnicfBfdIfTable, hpnicfBfdGlobalObjects=hpnicfBfdGlobalObjects, hpnicfBfdSessStatPktLost=hpnicfBfdSessStatPktLost, hpnicfBfdSessRemoteAddr=hpnicfBfdSessRemoteAddr, hpnicfBfdSessDemandModeFlag=hpnicfBfdSessDemandModeFlag, hpnicfBfdSessNumberLimit=hpnicfBfdSessNumberLimit, hpnicfBfdSessPerfLastDownTime=hpnicfBfdSessPerfLastDownTime, hpnicfBfdSessControlPlanIndepFlag=hpnicfBfdSessControlPlanIndepFlag, hpnicfBfdSessTable=hpnicfBfdSessTable, hpnicfBfdSessEntry=hpnicfBfdSessEntry, hpnicfBfdSessPerfTable=hpnicfBfdSessPerfTable, hpnicfBfdVersionNumber=hpnicfBfdVersionNumber, hpnicfBfdSessAuthFlag=hpnicfBfdSessAuthFlag, hpnicfBfdSessStatPktOutHC=hpnicfBfdSessStatPktOutHC, hpnicfBfdSessPerfEntry=hpnicfBfdSessPerfEntry, BfdInterval=BfdInterval, hpnicfBfdSessIndex=hpnicfBfdSessIndex, hpnicfBfdNotifications=hpnicfBfdNotifications, hpnicfBfdSessStateUp=hpnicfBfdSessStateUp, hpnicfBfdConformance=hpnicfBfdConformance, hpnicfBfdSessLocalAddr=hpnicfBfdSessLocalAddr, hpnicfBfdIfDesiredMinRxInterval=hpnicfBfdIfDesiredMinRxInterval, hpnicfBfdIfEntry=hpnicfBfdIfEntry, hpnicfBfdSessNotificationsEnable=hpnicfBfdSessNotificationsEnable, hpnicfBfdIfAuthType=hpnicfBfdIfAuthType, hpnicfBfdSessState=hpnicfBfdSessState)
