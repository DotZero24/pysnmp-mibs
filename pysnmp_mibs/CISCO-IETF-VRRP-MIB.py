...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-VRRP-MIB
...
_CVrrpOperationsPreemptMode_Type.__name__ = "TruthValue"
...
_CVrrpOperationsAcceptMode_Type.__name__ = "TruthValue"
...
cVrrpMIBCompliance2.setObjects(
      *(("CISCO-IETF-VRRP-MIB", "cVrrpOperationsGroup"),
        ("CISCO-IETF-VRRP-MIB", "cVrrpStatisticsGroup"),
        ("CISCO-IETF-VRRP-MIB", "cVrrpNotificationInfoGroup"),
        ("CISCO-IETF-VRRP-MIB", "cVrrpNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
cVrrpMIBReadOnlyCompliance.setObjects(
      *(("CISCO-IETF-VRRP-MIB", "cVrrpOperationsGroup"),
        ("CISCO-IETF-VRRP-MIB", "cVrrpStatisticsGroup"),
        ("CISCO-IETF-VRRP-MIB", "cVrrpNotificationInfoGroup"),
        ("CISCO-IETF-VRRP-MIB", "cVrrpNotificationsGroup"))
