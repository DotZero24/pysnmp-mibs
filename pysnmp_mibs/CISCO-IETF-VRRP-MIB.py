...
mibBuilder.exportSymbols("CISCO-IETF-VRRP-MIB", cVrrpRouterStatisticsTable=cVrrpRouterStatisticsTable, cVrrpRouterStatisticsEntry=cVrrpRouterStatisticsEntry, cVrrpStatisticsRefreshRate=cVrrpStatisticsRefreshRate, cVrrpStatisticsPriZeroPktsRcvd=cVrrpStatisticsPriZeroPktsRcvd, cVrrpNotificationNewMasterReason=cVrrpNotificationNewMasterReason, cVrrpStatisticsInvalidAuthType=cVrrpStatisticsInvalidAuthType, cVrrpNotificationInfoGroup=cVrrpNotificationInfoGroup, cVrrpStatisticsIpTtlErrors=cVrrpStatisticsIpTtlErrors, cVrrpNotificationsGroup=cVrrpNotificationsGroup, cVrrpOperationsTable=cVrrpOperationsTable, cVrrpOperationsPriority=cVrrpOperationsPriority, cVrrpOperationsVirtualMacAddr=cVrrpOperationsVirtualMacAddr, cVrrpOperationsInetAddrType=cVrrpOperationsInetAddrType, cVrrpOperationsPreemptMode=cVrrpOperationsPreemptMode, cVrrpOperationsGroup=cVrrpOperationsGroup, cVrrpOperationsPrimaryIpAddr=cVrrpOperationsPrimaryIpAddr, cVrrpOperationsAdvInterval=cVrrpOperationsAdvInterval, PYSNMP_MODULE_ID=ciscoVrrpMIB, cVrrpNotificationProtoError=cVrrpNotificationProtoError, cVrrpNotificationProtoErrReason=cVrrpNotificationProtoErrReason, cVrrpStatisticsInvldTypePktsRcvd=cVrrpStatisticsInvldTypePktsRcvd, cVrrpStatisticsPriZeroPktsSent=cVrrpStatisticsPriZeroPktsSent, cVrrpNotifications=cVrrpNotifications, cVrrpRouterChecksumErrors=cVrrpRouterChecksumErrors, cVrrpAssociatedIpAddrRowStatus=cVrrpAssociatedIpAddrRowStatus, cVrrpStatisticsAdvertiseRcvd=cVrrpStatisticsAdvertiseRcvd, cVrrpOperationsAddrCount=cVrrpOperationsAddrCount, cVrrpRouterVersionErrors=cVrrpRouterVersionErrors, cVrrpStatisticsDiscontinuityTime=cVrrpStatisticsDiscontinuityTime, cVrrpAssociatedIpAddrTable=cVrrpAssociatedIpAddrTable, cVrrpStatisticsAddressListErrors=cVrrpStatisticsAddressListErrors, cVrrpOperationsState=cVrrpOperationsState, cVrrpAssociatedIpAddr=cVrrpAssociatedIpAddr, cVrrpStatisticsPacketLengthErrors=cVrrpStatisticsPacketLengthErrors, CVrId=CVrId, cVrrpMIBReadOnlyCompliance=cVrrpMIBReadOnlyCompliance, cVrrpOperationsAcceptMode=cVrrpOperationsAcceptMode, cVrrpStatisticsAdvIntervalErrors=cVrrpStatisticsAdvIntervalErrors, cVrrpStatisticsBecomeMaster=cVrrpStatisticsBecomeMaster, cVrrpOperationsVrId=cVrrpOperationsVrId, ciscoVrrpMIB=ciscoVrrpMIB, cVrrpOperationsRowStatus=cVrrpOperationsRowStatus, cVrrpAssociatedIpAddrEntry=cVrrpAssociatedIpAddrEntry, cVrrpRouterVrIdErrors=cVrrpRouterVrIdErrors, cVrrpStatisticsGroup=cVrrpStatisticsGroup, cVrrpOperations=cVrrpOperations, cVrrpAssociatedInetAddrType=cVrrpAssociatedInetAddrType, cVrrpMIBCompliance2=cVrrpMIBCompliance2, cVrrpOperationsUpTime=cVrrpOperationsUpTime, cVrrpStatistics=cVrrpStatistics, cVrrpNotificationNewMaster=cVrrpNotificationNewMaster, cVrrpMIBCompliances=cVrrpMIBCompliances, cVrrpOperationsVersion=cVrrpOperationsVersion, cVrrpConformance=cVrrpConformance, cVrrpMIBGroups=cVrrpMIBGroups, cVrrpNotificationCntl=cVrrpNotificationCntl, cVrrpOperationsEntry=cVrrpOperationsEntry, cVrrpOperationsMasterIpAddr=cVrrpOperationsMasterIpAddr)
