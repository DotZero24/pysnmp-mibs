# SNMP MIB module (A3COM-HUAWEI-ENTITY-EXT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-ENTITY-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:45:40 2025
...
h3cEntityExtStateEntry = _H3cEntityExtStateEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1)
)
h3cEntityExtStateEntry.setIndexNames(
    (0, "A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
)
if mibBuilder.loadTexts:
...
h3cEntityExtPhysicalIndex = _H3cEntityExtPhysicalIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 1),
...
h3cEntityExtAdminStatus = _H3cEntityExtAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 2),
...
h3cEntityExtOperStatus = _H3cEntityExtOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 3),
...
h3cEntityExtStandbyStatus = _H3cEntityExtStandbyStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 4),
...
h3cEntityExtAlarmLight = _H3cEntityExtAlarmLight_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 5),
...
h3cEntityExtCpuUsage = _H3cEntityExtCpuUsage_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 6),
...
h3cEntityExtCpuUsageThreshold = _H3cEntityExtCpuUsageThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 7),
...
h3cEntityExtMemUsage = _H3cEntityExtMemUsage_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 8),
...
h3cEntityExtMemUsageThreshold = _H3cEntityExtMemUsageThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 9),
...
h3cEntityExtMemSize = _H3cEntityExtMemSize_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 10),
...
h3cEntityExtUpTime = _H3cEntityExtUpTime_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 11),
...
h3cEntityExtTemperatureThreshold = _H3cEntityExtTemperatureThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 13),
...
h3cEntityExtVoltage = _H3cEntityExtVoltage_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 14),
...
h3cEntityExtVoltageLowThreshold = _H3cEntityExtVoltageLowThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 15),
...
h3cEntityExtVoltageHighThreshold = _H3cEntityExtVoltageHighThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 16),
...
h3cEntityExtCriticalTemperatureThreshold = _H3cEntityExtCriticalTemperatureThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 17),
...
h3cEntityExtMacAddress = _H3cEntityExtMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 18),
...
h3cEntityExtErrorStatus = _H3cEntityExtErrorStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 19),
...
h3cEntityExtCpuMaxUsage = _H3cEntityExtCpuMaxUsage_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 20),
...
h3cEntityExtLowerTemperatureThreshold = _H3cEntityExtLowerTemperatureThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 21),
...
h3cEntityExtShutdownTemperatureThreshold = _H3cEntityExtShutdownTemperatureThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 22),
...
h3cEntityExtPhyMemSize = _H3cEntityExtPhyMemSize_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 23),
...
h3cEntityExtPhyCpuFrequency = _H3cEntityExtPhyCpuFrequency_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 24),
...
h3cEntityExtFirstUsedDate = _H3cEntityExtFirstUsedDate_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 25),
...
h3cEntityExtCpuAvgUsage = _H3cEntityExtCpuAvgUsage_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 26),
...
h3cEntityExtMemAvgUsage = _H3cEntityExtMemAvgUsage_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 27),
...
h3cEntityExtMemType = _H3cEntityExtMemType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 28),
...
h3cEntityExtCriticalLowerTemperatureThreshold = _H3cEntityExtCriticalLowerTemperatureThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 29),
...
h3cEntityExtShutdownLowerTemperatureThreshold = _H3cEntityExtShutdownLowerTemperatureThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 30),
...
class _H3cEntityExtCpuUsageRecoverThreshold_Type(Integer32):
    """Custom type h3cEntityExtCpuUsageRecoverThreshold based on Integer32"""
    defaultValue = 100
...
_H3cEntityExtCpuUsageRecoverThreshold_Type.__name__ = "Integer32"
_H3cEntityExtCpuUsageRecoverThreshold_Object = MibTableColumn
h3cEntityExtCpuUsageRecoverThreshold = _H3cEntityExtCpuUsageRecoverThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 1, 1, 1, 31),
    _H3cEntityExtCpuUsageRecoverThreshold_Type()
)
h3cEntityExtCpuUsageRecoverThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cEntityExtCpuUsageRecoverThreshold.setStatus("current")
_H3cEntityExtManu_ObjectIdentity = ObjectIdentity
h3cEntityExtManu = _H3cEntityExtManu_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 2)
)
_H3cEntityExtManuTable_Object = MibTable
h3cEntityExtManuTable = _H3cEntityExtManuTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 2, 1)
)
if mibBuilder.loadTexts:
...
h3cEntityExtManuEntry = _H3cEntityExtManuEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 2, 1, 1)
)
h3cEntityExtManuEntry.setIndexNames(
    (0, "A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtManuPhysicalIndex"),
)
if mibBuilder.loadTexts:
...
h3cEntityExtManuPhysicalIndex = _H3cEntityExtManuPhysicalIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 2, 1, 1, 1),
...
h3cEntityExtManuSerialNum = _H3cEntityExtManuSerialNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 2, 1, 1, 2),
...
h3cEntityExtManuBuildInfo = _H3cEntityExtManuBuildInfo_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 2, 1, 1, 3),
...
h3cEntityExtManuBOM = _H3cEntityExtManuBOM_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 2, 1, 1, 4),
...
h3cEntityExtMacAddressCount = _H3cEntityExtMacAddressCount_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 2, 1, 1, 5),
...
h3cEntityExtPowerEntry = _H3cEntityExtPowerEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 3, 1, 1)
)
h3cEntityExtPowerEntry.setIndexNames(
    (0, "A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPowerPhysicalIndex"),
)
if mibBuilder.loadTexts:
...
h3cEntityExtPowerPhysicalIndex = _H3cEntityExtPowerPhysicalIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 3, 1, 1, 1),
...
h3cEntityExtNominalPower = _H3cEntityExtNominalPower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 3, 1, 1, 2),
...
h3cEntityExtCurrentPower = _H3cEntityExtCurrentPower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 3, 1, 1, 3),
...
h3cEntityExtAveragePower = _H3cEntityExtAveragePower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 3, 1, 1, 4),
...
h3cEntityExtPeakPower = _H3cEntityExtPeakPower_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 3, 1, 1, 5),
...
h3cProcessID = _H3cProcessID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 4, 1, 1, 1),
    _H3cProcessID_Type()
)
...
h3cProcessName = _H3cProcessName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 4, 1, 1, 2),
...
h3cProcessUtil5Min = _H3cProcessUtil5Min_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 1, 4, 1, 1, 3),
...
h3cEntityExtTrapDescription = _H3cEntityExtTrapDescription_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 1, 1),
...
h3cEntityExtECCParityAlarmStatus = _H3cEntityExtECCParityAlarmStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 1, 2),
...
h3cEntityExtSFPInvalidInDays = _H3cEntityExtSFPInvalidInDays_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 1, 3),
...
h3cEntityExtGroup.setObjects(
      *(("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ...
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtOperStatus"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtStandbyStatus"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtAlarmLight"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCpuUsage"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCpuUsageThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMemUsage"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMemUsageThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMemSize"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtUpTime"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtTemperature"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtTemperatureThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtVoltage"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtVoltageLowThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtVoltageHighThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCriticalTemperatureThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMacAddress"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtErrorStatus"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCpuMaxUsage"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtLowerTemperatureThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtShutdownTemperatureThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPhyMemSize"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPhyCpuFrequency"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtFirstUsedDate"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCpuAvgUsage"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMemAvgUsage"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMemType"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCriticalLowerTemperatureThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtShutdownLowerTemperatureThreshold"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCpuUsageRecoverThreshold"))
)
if mibBuilder.loadTexts:
    h3cEntityExtGroup.setStatus("current")

h3cEntityExtManuGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 3, 2, 3)
)
h3cEntityExtManuGroup.setObjects(
      *(("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtManuPhysicalIndex"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtManuSerialNum"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtManuBuildInfo"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtManuBOM"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMacAddressCount"))
)
if mibBuilder.loadTexts:
    h3cEntityExtManuGroup.setStatus("current")

h3cEntityExtPowerGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 3, 2, 4)
)
h3cEntityExtPowerGroup.setObjects(
      *(("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPowerPhysicalIndex"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtNominalPower"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCurrentPower"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtAveragePower"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPeakPower"))
)
if mibBuilder.loadTexts:
...
h3cEntityExtTemperatureThresholdNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 1)
)
...
h3cEntityExtVoltageLowThresholdNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 2)
)
...
h3cEntityExtVoltageHighThresholdNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 3)
)
...
h3cEntityExtCpuUsageThresholdNotfication = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 4)
)
...
h3cEntityExtMemUsageThresholdNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 5)
)
...
h3cEntityExtOperEnabled = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 6)
)
...
h3cEntityExtOperDisabled = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 7)
)
...
h3cEntityExtCriticalTemperatureThresholdNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 8)
)
...
h3cEntityExtSFPAlarmOn = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 9)
)
...
h3cEntityExtSFPAlarmOff = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 10)
)
...
h3cEntityExtSFPPhony = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 11)
)
...
h3cEntityInsert = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 12)
)
...
h3cEntityRemove = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 13)
)
...
h3cEntityExtForcedPowerOff = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 14)
)
...
h3cEntityExtForcedPowerOn = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 15)
)
...
h3cEntityExtFaultAlarmOn = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 16)
)
...
h3cEntityExtFaultAlarmOff = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 17)
)
...
h3cEntityExtResourceLack = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 18)
)
...
h3cEntityExtResourceEnough = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 19)
)
...
h3cEntityExtTemperatureLower = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 20)
)
...
h3cEntityExtTemperatureTooUp = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 21)
)
...
h3cEntityExtTemperatureNormal = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 22)
)
...
h3cEntityExternalAlarmOccur = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 23)
)
...
h3cEntityExternalAlarmRecover = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 24)
)
...
h3cEntityExtCpuUsageThresholdRecover = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 25)
)
...
h3cEntityExtMemUsageThresholdRecover = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 26)
)
...
h3cEntityExtMemAllocatedFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 27)
)
h3cEntityExtMemAllocatedFailed.setObjects(
      *(("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtTrapDescription"))
)
if mibBuilder.loadTexts:
...
h3cEntityExtECCParityAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 28)
)
h3cEntityExtECCParityAlarm.setObjects(
      *(("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtECCParityAlarmStatus"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtTrapDescription"))
)
if mibBuilder.loadTexts:
...
h3cEntityExtCritLowerTempThresholdNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 29)
)
...
h3cEntityExtTemperatureTooLow = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 30)
)
...
h3cEntityExtFanDirectionNotPreferred = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 31)
)
...
h3cEntityExtFanDirectionNotAccord = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 32)
)
...
h3cEntityExtSFPInvalid = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 33)
)
h3cEntityExtSFPInvalid.setObjects(
      *(("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("ENTITY-MIB", "entPhysicalName"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtSFPInvalidInDays"))
)
if mibBuilder.loadTexts:
...
h3cEntityExtSFPInvalidNow = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 2, 0, 34)
)
...
h3cEntityExtNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 3, 2, 2)
)
h3cEntityExtNotificationGroup.setObjects(
      *(("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtTemperatureThresholdNotification"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtVoltageLowThresholdNotification"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtVoltageHighThresholdNotification"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCpuUsageThresholdNotfication"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMemUsageThresholdNotification"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtOperEnabled"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtOperDisabled"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCriticalTemperatureThresholdNotification"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtSFPAlarmOn"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtSFPAlarmOff"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtSFPPhony"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityInsert"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityRemove"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtForcedPowerOff"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtForcedPowerOn"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtFaultAlarmOn"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtFaultAlarmOff"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtResourceLack"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtResourceEnough"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtTemperatureLower"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtTemperatureTooUp"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtTemperatureNormal"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExternalAlarmOccur"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExternalAlarmRecover"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCpuUsageThresholdRecover"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMemUsageThresholdRecover"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtMemAllocatedFailed"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtECCParityAlarm"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtCritLowerTempThresholdNotification"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtTemperatureTooLow"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtFanDirectionNotPreferred"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtFanDirectionNotAccord"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtSFPInvalid"),
...
h3cEntityExtCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 6, 3, 1, 1)
)
h3cEntityExtCompliance.setObjects(
      *(("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtGroup"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtNotificationGroup"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtManuGroup"),
        ("A3COM-HUAWEI-ENTITY-EXT-MIB", "h3cEntityExtPowerGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"H3cAdminState": H3cAdminState,
       ...
       "h3cEntityExtFirstTrapTime": h3cEntityExtFirstTrapTime,
