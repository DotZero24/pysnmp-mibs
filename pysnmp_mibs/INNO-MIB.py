...
mibBuilder.exportSymbols("INNO-MIB", innoIsdnFailure=innoIsdnFailure, l1PriErrCrc4=l1PriErrCrc4, voiceIfNumber=voiceIfNumber, voiceIfProduct=voiceIfProduct, innovaphone=innovaphone, trapIntegerParm=trapIntegerParm, innoAuthenticationFailure=innoAuthenticationFailure, l1PriErrFrameAlignmentLoss=l1PriErrFrameAlignmentLoss, l3NumBchan=l3NumBchan, trapDummyGroup=trapDummyGroup, l1PriEntry=l1PriEntry, innoLinkDown=innoLinkDown, l1PriTable=l1PriTable, l3CallsBoot=l3CallsBoot, voiceIfEntry=voiceIfEntry, l3Label=l3Label, voiceIfAddr=voiceIfAddr, l2Table=l2Table, innoColdStart=innoColdStart, innoLinkUp=innoLinkUp, l1PriErrSigLoss=l1PriErrSigLoss, l1PriErrSlip=l1PriErrSlip, voiceIfName=voiceIfName, l3Table=l3Table, l1BriLabel=l1BriLabel, voiceIfGwName=voiceIfGwName, l1Label=l1Label, voiceIfTable=voiceIfTable, l1PriState=l1PriState, l1BriTable=l1BriTable, l1PriLabel=l1PriLabel, voiceIfState=voiceIfState, l2State=l2State, l2Label=l2Label, isdn=isdn, innoWarmStart=innoWarmStart, l2Entry=l2Entry, l2Mode=l2Mode, l3Protocol=l3Protocol, l3NumBchanActive=l3NumBchanActive, gateway=gateway, l1PriTest=l1PriTest, l1BriState=l1BriState, voiceIfAliasIndex=voiceIfAliasIndex, l1BriEntry=l1BriEntry, voiceIfType=voiceIfType, l1PriErrFrameAlignmentTOut=l1PriErrFrameAlignmentTOut, l1PriErrAlarmInd=l1PriErrAlarmInd, gatekeeper=gatekeeper, voiceIfIndex=voiceIfIndex, trapDisplayStringParm=trapDisplayStringParm, l1PriErrRemAlarmInd=l1PriErrRemAlarmInd, DisplayString=DisplayString, l3Entry=l3Entry)
