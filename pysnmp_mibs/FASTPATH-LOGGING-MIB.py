...
mibBuilder.exportSymbols("FASTPATH-LOGGING-MIB", agentLogMessagesReceived=agentLogMessagesReceived, agentLogSyslogMessagesIgnored=agentLogSyslogMessagesIgnored, agentLogInMemoryLogCount=agentLogInMemoryLogCount, PYSNMP_MODULE_ID=fastPathLogging, agentLogPersistentAdminStatus=agentLogPersistentAdminStatus, AgentLogSeverity=AgentLogSeverity, agentLogHostTableIndex=agentLogHostTableIndex, agentLogConsoleAdminStatus=agentLogConsoleAdminStatus, agentLogInMemoryEntry=agentLogInMemoryEntry, agentLogMessagesDropped=agentLogMessagesDropped, agentLogMessageReceivedTime=agentLogMessageReceivedTime, agentLogMsgPersistentMsgIndex=agentLogMsgPersistentMsgIndex, agentLogPersistentGroup=agentLogPersistentGroup, agentLogMsgPersistentMsgText=agentLogMsgPersistentMsgText, agentLogSyslogAdminStatus=agentLogSyslogAdminStatus, AgentLogFacility=AgentLogFacility, agentLogInMemoryMsgIndex=agentLogInMemoryMsgIndex, agentLogPersistentLogCount=agentLogPersistentLogCount, agentLogSyslogLocalPort=agentLogSyslogLocalPort, agentLogHostTableIpAddress=agentLogHostTableIpAddress, agentLogPersistentEntry=agentLogPersistentEntry, agentLogInMemoryBehavior=agentLogInMemoryBehavior, agentLogSyslogHostEntry=agentLogSyslogHostEntry, agentLogHostTableIpAddressType=agentLogHostTableIpAddressType, fastPathLogging=fastPathLogging, agentLogHostTableRowStatus=agentLogHostTableRowStatus, agentLogSyslogMaxHosts=agentLogSyslogMaxHosts, agentLogInMemoryGroup=agentLogInMemoryGroup, agentLogCliCommandsAdminStatus=agentLogCliCommandsAdminStatus, agentLogSyslogMessageDeliveredTime=agentLogSyslogMessageDeliveredTime, agentLogConsoleSeverityFilter=agentLogConsoleSeverityFilter, agentLogSysLogConfigGroup=agentLogSysLogConfigGroup, agentLogPersistentSeverityFilter=agentLogPersistentSeverityFilter, agentLogCliCommandsConfigGroup=agentLogCliCommandsConfigGroup, agentLogSyslogHostTable=agentLogSyslogHostTable, agentLogInMemoryTable=agentLogInMemoryTable, agentLogHostTableSeverityFilter=agentLogHostTableSeverityFilter, agentLogInMemoryMsgText=agentLogInMemoryMsgText, agentLogConsoleConfigGroup=agentLogConsoleConfigGroup, agentLogHostTablePort=agentLogHostTablePort, agentLogSyslogMessagesRelayed=agentLogSyslogMessagesRelayed, agentLogPersistentConfigGroup=agentLogPersistentConfigGroup, agentLogInMemoryConfigGroup=agentLogInMemoryConfigGroup, agentLogStatisticsGroup=agentLogStatisticsGroup, agentLogInMemoryAdminStatus=agentLogInMemoryAdminStatus, agentLogPersistentTable=agentLogPersistentTable, agentLogConfigGroup=agentLogConfigGroup)
