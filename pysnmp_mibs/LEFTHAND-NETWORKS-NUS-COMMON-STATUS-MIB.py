# SNMP MIB module (LEFTHAND-NETWORKS-NUS-COMMON-STATUS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hp/LEFTHAND-NETWORKS-NUS-COMMON-STATUS-MIB
...
(lhnNusCommonStatus,) = mibBuilder.importSymbols(
...
lhnNusCommonStatusModule = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 9804, 1, 1, 99)
)
...
mibBuilder.exportSymbols(
    "LEFTHAND-NETWORKS-NUS-COMMON-STATUS-MIB",
    **{"lhnNusCommonStatusModule": lhnNusCommonStatusModule,
       "status": status,
