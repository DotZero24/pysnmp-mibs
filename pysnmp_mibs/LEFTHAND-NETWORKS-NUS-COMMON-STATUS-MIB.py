...
mibBuilder.exportSymbols("LEFTHAND-NETWORKS-NUS-COMMON-STATUS-MIB", status=status, statusMessage=statusMessage, PYSNMP_MODULE_ID=lhnNusCommonStatusModule, lhnNusCommonStatusModule=lhnNusCommonStatusModule)
