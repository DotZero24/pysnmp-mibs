# SNMP MIB module (ARICENT-SYSLOG-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/siaemic/ARICENT-SYSLOG-MIB
...
fsSyslogConfigEntry = _FsSyslogConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 89, 1, 6, 1)
)
fsSyslogConfigEntry.setIndexNames(
    (0, "ARICENT-SYSLOG-MIB", "fsSyslogConfigModule"),
)
if mibBuilder.loadTexts:
...
fsSyslogFwdTable = _FsSyslogFwdTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 89, 2, 3)
)
if mibBuilder.loadTexts:
    fsSyslogFwdTable.setStatus("current")
_FsSyslogFwdEntry_Object = MibTableRow
fsSyslogFwdEntry = _FsSyslogFwdEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 89, 2, 3, 1)
)
fsSyslogFwdEntry.setIndexNames(
    (0, "ARICENT-SYSLOG-MIB", "fsSyslogFwdPriority"),
    (0, "ARICENT-SYSLOG-MIB", "fsSyslogFwdAddressType"),
    (0, "ARICENT-SYSLOG-MIB", "fsSyslogFwdServerIP"),
)
if mibBuilder.loadTexts:
...
fsSyslogMailTable = _FsSyslogMailTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 89, 3, 4)
)
if mibBuilder.loadTexts:
    fsSyslogMailTable.setStatus("current")
_FsSyslogMailEntry_Object = MibTableRow
fsSyslogMailEntry = _FsSyslogMailEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 89, 3, 4, 1)
)
fsSyslogMailEntry.setIndexNames(
    (0, "ARICENT-SYSLOG-MIB", "fsSyslogMailPriority"),
    (0, "ARICENT-SYSLOG-MIB", "fsSyslogMailServAddType"),
    (0, "ARICENT-SYSLOG-MIB", "fsSyslogMailServAdd"),
)
if mibBuilder.loadTexts:
...
sysLogSrvrUnreachable = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 89, 4, 0, 1)
)
sysLogSrvrUnreachable.setObjects(
      *(("ARICENT-SYSLOG-MIB", "sysLogSrvrUnreachEventTime"),
        ("ARICENT-SYSLOG-MIB", "sysLogSrvrUnreachMessage"))
)
if mibBuilder.loadTexts:
