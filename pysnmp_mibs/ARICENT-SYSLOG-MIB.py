...
fsSyslog=ModuleIdentity((1,3,6,1,4,1,2076,89))
if mibBuilder.loadTexts:fsSyslog.setRevisions(('2012-09-05 00:00',))
_FsSyslogGeneralGroup_ObjectIdentity=ObjectIdentity
fsSyslogGeneralGroup=_FsSyslogGeneralGroup_ObjectIdentity((1,3,6,1,4,1,2076,89,1))
...
fsSyslogLogging=_FsSyslogLogging_Object((1,3,6,1,4,1,2076,89,1,1),_FsSyslogLogging_Type())
...
fsSyslogTimeStamp=_FsSyslogTimeStamp_Object((1,3,6,1,4,1,2076,89,1,2),_FsSyslogTimeStamp_Type())
fsSyslogTimeStamp.setMaxAccess(_B)
if mibBuilder.loadTexts:fsSyslogTimeStamp.setStatus(_I)
class _FsSyslogConsoleLog_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_G,1),(_H,2)))
_FsSyslogConsoleLog_Type.__name__=_C
_FsSyslogConsoleLog_Object=MibScalar
fsSyslogConsoleLog=_FsSyslogConsoleLog_Object((1,3,6,1,4,1,2076,89,1,3),_FsSyslogConsoleLog_Type())
...
fsSyslogSysBuffers=_FsSyslogSysBuffers_Object((1,3,6,1,4,1,2076,89,1,4),_FsSyslogSysBuffers_Type())
...
fsSyslogClearLog=_FsSyslogClearLog_Object((1,3,6,1,4,1,2076,89,1,5),_FsSyslogClearLog_Type())
...
fsSyslogConfigTable=_FsSyslogConfigTable_Object((1,3,6,1,4,1,2076,89,1,6))
if mibBuilder.loadTexts:fsSyslogConfigTable.setStatus(_A)
_FsSyslogConfigEntry_Object=MibTableRow
fsSyslogConfigEntry=_FsSyslogConfigEntry_Object((1,3,6,1,4,1,2076,89,1,6,1))
...
fsSyslogConfigModule=_FsSyslogConfigModule_Object((1,3,6,1,4,1,2076,89,1,6,1,1),_FsSyslogConfigModule_Type())
...
fsSyslogConfigLogLevel=_FsSyslogConfigLogLevel_Object((1,3,6,1,4,1,2076,89,1,6,1,2),_FsSyslogConfigLogLevel_Type())
...
fsSyslogFacility=_FsSyslogFacility_Object((1,3,6,1,4,1,2076,89,1,7),_FsSyslogFacility_Type())
...
fsSyslogRole=_FsSyslogRole_Object((1,3,6,1,4,1,2076,89,1,8),_FsSyslogRole_Type())
...
fsSyslogLogFile=_FsSyslogLogFile_Object((1,3,6,1,4,1,2076,89,1,9),_FsSyslogLogFile_Type())
...
fsSyslogMail=_FsSyslogMail_Object((1,3,6,1,4,1,2076,89,1,10),_FsSyslogMail_Type())
...
fsSyslogProfile=_FsSyslogProfile_Object((1,3,6,1,4,1,2076,89,1,11),_FsSyslogProfile_Type())
fsSyslogProfile.setMaxAccess(_B)
if mibBuilder.loadTexts:fsSyslogProfile.setStatus(_A)
class _FsSyslogRelayPort_Type(Integer32):defaultValue=514;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,65535))
_FsSyslogRelayPort_Type.__name__=_C
_FsSyslogRelayPort_Object=MibScalar
fsSyslogRelayPort=_FsSyslogRelayPort_Object((1,3,6,1,4,1,2076,89,1,12),_FsSyslogRelayPort_Type())
...
fsSyslogRelayTransType=_FsSyslogRelayTransType_Object((1,3,6,1,4,1,2076,89,1,13),_FsSyslogRelayTransType_Type())
fsSyslogRelayTransType.setMaxAccess(_B)
if mibBuilder.loadTexts:fsSyslogRelayTransType.setStatus(_A)
class _FsSyslogFileNameOne_Type(DisplayString):subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,32))
_FsSyslogFileNameOne_Type.__name__=_E
_FsSyslogFileNameOne_Object=MibScalar
fsSyslogFileNameOne=_FsSyslogFileNameOne_Object((1,3,6,1,4,1,2076,89,1,14),_FsSyslogFileNameOne_Type())
fsSyslogFileNameOne.setMaxAccess(_B)
if mibBuilder.loadTexts:fsSyslogFileNameOne.setStatus(_A)
class _FsSyslogFileNameTwo_Type(DisplayString):subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,32))
_FsSyslogFileNameTwo_Type.__name__=_E
_FsSyslogFileNameTwo_Object=MibScalar
fsSyslogFileNameTwo=_FsSyslogFileNameTwo_Object((1,3,6,1,4,1,2076,89,1,15),_FsSyslogFileNameTwo_Type())
fsSyslogFileNameTwo.setMaxAccess(_B)
if mibBuilder.loadTexts:fsSyslogFileNameTwo.setStatus(_A)
class _FsSyslogFileNameThree_Type(DisplayString):subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,32))
_FsSyslogFileNameThree_Type.__name__=_E
_FsSyslogFileNameThree_Object=MibScalar
fsSyslogFileNameThree=_FsSyslogFileNameThree_Object((1,3,6,1,4,1,2076,89,1,16),_FsSyslogFileNameThree_Type())
...
fsSyslogFileTable=_FsSyslogFileTable_Object((1,3,6,1,4,1,2076,89,1,17))
if mibBuilder.loadTexts:fsSyslogFileTable.setStatus(_A)
_FsSyslogFileEntry_Object=MibTableRow
fsSyslogFileEntry=_FsSyslogFileEntry_Object((1,3,6,1,4,1,2076,89,1,17,1))
...
fsSyslogFilePriority=_FsSyslogFilePriority_Object((1,3,6,1,4,1,2076,89,1,17,1,1),_FsSyslogFilePriority_Type())
...
fsSyslogFileName=_FsSyslogFileName_Object((1,3,6,1,4,1,2076,89,1,17,1,2),_FsSyslogFileName_Type())
...
fsSyslogFileRowStatus=_FsSyslogFileRowStatus_Object((1,3,6,1,4,1,2076,89,1,17,1,3),_FsSyslogFileRowStatus_Type())
...
fsSyslogServerUpDownTrap=_FsSyslogServerUpDownTrap_Object((1,3,6,1,4,1,2076,89,1,18),_FsSyslogServerUpDownTrap_Type())
...
fsSyslogLogs=_FsSyslogLogs_ObjectIdentity((1,3,6,1,4,1,2076,89,2))
_FsSyslogLogSrvAddr_Type=IpAddress
_FsSyslogLogSrvAddr_Object=MibScalar
fsSyslogLogSrvAddr=_FsSyslogLogSrvAddr_Object((1,3,6,1,4,1,2076,89,2,1),_FsSyslogLogSrvAddr_Type())
...
fsSyslogLogNoLogServer=_FsSyslogLogNoLogServer_Object((1,3,6,1,4,1,2076,89,2,2),_FsSyslogLogNoLogServer_Type())
...
fsSyslogFwdTable=_FsSyslogFwdTable_Object((1,3,6,1,4,1,2076,89,2,3))
if mibBuilder.loadTexts:fsSyslogFwdTable.setStatus(_A)
_FsSyslogFwdEntry_Object=MibTableRow
fsSyslogFwdEntry=_FsSyslogFwdEntry_Object((1,3,6,1,4,1,2076,89,2,3,1))
...
fsSyslogFwdPriority=_FsSyslogFwdPriority_Object((1,3,6,1,4,1,2076,89,2,3,1,1),_FsSyslogFwdPriority_Type())
...
fsSyslogFwdAddressType=_FsSyslogFwdAddressType_Object((1,3,6,1,4,1,2076,89,2,3,1,2),_FsSyslogFwdAddressType_Type())
fsSyslogFwdAddressType.setMaxAccess(_F)
if mibBuilder.loadTexts:fsSyslogFwdAddressType.setStatus(_A)
_FsSyslogFwdServerIP_Type=InetAddress
_FsSyslogFwdServerIP_Object=MibTableColumn
fsSyslogFwdServerIP=_FsSyslogFwdServerIP_Object((1,3,6,1,4,1,2076,89,2,3,1,3),_FsSyslogFwdServerIP_Type())
fsSyslogFwdServerIP.setMaxAccess(_F)
if mibBuilder.loadTexts:fsSyslogFwdServerIP.setStatus(_A)
class _FsSyslogFwdPort_Type(Integer32):defaultValue=514;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,65535))
_FsSyslogFwdPort_Type.__name__=_C
_FsSyslogFwdPort_Object=MibTableColumn
fsSyslogFwdPort=_FsSyslogFwdPort_Object((1,3,6,1,4,1,2076,89,2,3,1,4),_FsSyslogFwdPort_Type())
...
fsSyslogFwdTransType=_FsSyslogFwdTransType_Object((1,3,6,1,4,1,2076,89,2,3,1,5),_FsSyslogFwdTransType_Type())
...
fsSyslogFwdRowStatus=_FsSyslogFwdRowStatus_Object((1,3,6,1,4,1,2076,89,2,3,1,6),_FsSyslogFwdRowStatus_Type())
...
fsSyslogSmtp=_FsSyslogSmtp_ObjectIdentity((1,3,6,1,4,1,2076,89,3))
_FsSyslogSmtpSrvAddr_Type=IpAddress
_FsSyslogSmtpSrvAddr_Object=MibScalar
fsSyslogSmtpSrvAddr=_FsSyslogSmtpSrvAddr_Object((1,3,6,1,4,1,2076,89,3,1),_FsSyslogSmtpSrvAddr_Type())
...
fsSyslogSmtpRcvrMailId=_FsSyslogSmtpRcvrMailId_Object((1,3,6,1,4,1,2076,89,3,2),_FsSyslogSmtpRcvrMailId_Type())
...
fsSyslogSmtpSenderMailId=_FsSyslogSmtpSenderMailId_Object((1,3,6,1,4,1,2076,89,3,3),_FsSyslogSmtpSenderMailId_Type())
...
fsSyslogMailTable=_FsSyslogMailTable_Object((1,3,6,1,4,1,2076,89,3,4))
if mibBuilder.loadTexts:fsSyslogMailTable.setStatus(_A)
_FsSyslogMailEntry_Object=MibTableRow
fsSyslogMailEntry=_FsSyslogMailEntry_Object((1,3,6,1,4,1,2076,89,3,4,1))
...
fsSyslogMailPriority=_FsSyslogMailPriority_Object((1,3,6,1,4,1,2076,89,3,4,1,1),_FsSyslogMailPriority_Type())
...
fsSyslogMailServAddType=_FsSyslogMailServAddType_Object((1,3,6,1,4,1,2076,89,3,4,1,2),_FsSyslogMailServAddType_Type())
...
fsSyslogMailServAdd=_FsSyslogMailServAdd_Object((1,3,6,1,4,1,2076,89,3,4,1,3),_FsSyslogMailServAdd_Type())
...
fsSyslogRxMailId=_FsSyslogRxMailId_Object((1,3,6,1,4,1,2076,89,3,4,1,4),_FsSyslogRxMailId_Type())
...
fsSyslogMailRowStatus=_FsSyslogMailRowStatus_Object((1,3,6,1,4,1,2076,89,3,4,1,5),_FsSyslogMailRowStatus_Type())
...
fsSyslogMailServUserName=_FsSyslogMailServUserName_Object((1,3,6,1,4,1,2076,89,3,4,1,6),_FsSyslogMailServUserName_Type())
...
fsSyslogMailServPassword=_FsSyslogMailServPassword_Object((1,3,6,1,4,1,2076,89,3,4,1,7),_FsSyslogMailServPassword_Type())
...
fsSyslogSmtpAuthMethod=_FsSyslogSmtpAuthMethod_Object((1,3,6,1,4,1,2076,89,3,5),_FsSyslogSmtpAuthMethod_Type())
...
fsSyslogSrvrUnreachableNotifications=_FsSyslogSrvrUnreachableNotifications_ObjectIdentity((1,3,6,1,4,1,2076,89,4))
_SysLogTraps_ObjectIdentity=ObjectIdentity
sysLogTraps=_SysLogTraps_ObjectIdentity((1,3,6,1,4,1,2076,89,4,0))
_SysLogTrapObjects_ObjectIdentity=ObjectIdentity
sysLogTrapObjects=_SysLogTrapObjects_ObjectIdentity((1,3,6,1,4,1,2076,89,4,1))
...
sysLogSrvrUnreachEventTime=_SysLogSrvrUnreachEventTime_Object((1,3,6,1,4,1,2076,89,4,1,1),_SysLogSrvrUnreachEventTime_Type())
...
sysLogSrvrUnreachMessage=_SysLogSrvrUnreachMessage_Object((1,3,6,1,4,1,2076,89,4,1,2),_SysLogSrvrUnreachMessage_Type())
sysLogSrvrUnreachMessage.setMaxAccess(_U)
if mibBuilder.loadTexts:sysLogSrvrUnreachMessage.setStatus(_A)
sysLogSrvrUnreachable=NotificationType((1,3,6,1,4,1,2076,89,4,0,1))
