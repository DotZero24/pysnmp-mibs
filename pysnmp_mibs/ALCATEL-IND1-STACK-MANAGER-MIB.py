...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/alcatel/ALCATEL-IND1-STACK-MANAGER-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 11:06:33 2025
...
alcatelIND1StackMgrMIB.setRevisions(('2009-02-06 00:00', '2009-02-06 00:00', '2007-04-03 00:00', '2005-07-15 00:00', '2004-07-01 00:00', '2004-04-23 00:00', '2004-04-08 00:00', '2004-04-04 00:00', '2004-03-22 00:00', '2004-03-08 00:00', '2001-08-27 00:00',))
...
alaStackMgrChassisTable = MibTable((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 1), )
if mibBuilder.loadTexts: alaStackMgrChassisTable.setStatus('current')
alaStackMgrChassisEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 1, 1), ).setIndexNames((0, "ALCATEL-IND1-STACK-MANAGER-MIB", "alaStackMgrSlotNINumber"))
...
alaStackMgrStatsTable = MibTable((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 2), )
if mibBuilder.loadTexts: alaStackMgrStatsTable.setStatus('current')
alaStackMgrStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 2, 1), ).setIndexNames((0, "ALCATEL-IND1-STACK-MANAGER-MIB", "alaStackMgrSlotNINumber"), (0, "ALCATEL-IND1-STACK-MANAGER-MIB", "alaStackMgrStatLinkNumber"))
...
alaStackMgrStackModeTable = MibTable((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 7), )
if mibBuilder.loadTexts: alaStackMgrStackModeTable.setStatus('current')
alaStackMgrStackModeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 7, 1), ).setIndexNames((0, "ALCATEL-IND1-STACK-MANAGER-MIB", "alaStackMgrStackModeIndex"))
if mibBuilder.loadTexts: alaStackMgrStackModeEntry.setStatus('current')
alaStackMgrStackModeIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 7, 1, 1), AlaStackMgrNINumber())
...
alaSspHelperqAggregateTable = MibTable((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 10), )
if mibBuilder.loadTexts: alaSspHelperqAggregateTable.setStatus('current')
alaSspHelperqAggregateEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 10, 1), ).setIndexNames((0, "ALCATEL-IND1-STACK-MANAGER-MIB", "alaSspHelperAggregateId"))
...
alaSSPStateTable = MibTable((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 8), )
if mibBuilder.loadTexts: alaSSPStateTable.setStatus('current')
alaSSPStateEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 24, 1, 1, 8, 1), ).setIndexNames((0, "ALCATEL-IND1-STACK-MANAGER-MIB", "alaSSPTableSlotNINumber"))
...
mibBuilder.exportSymbols("ALCATEL-IND1-STACK-MANAGER-MIB", alaStackMgrStackModeTable=alaStackMgrStackModeTable, alaStackMgrStackStatus=alaStackMgrStackStatus, alaStackMgrStackModeIndex=alaStackMgrStackModeIndex, alaStackMgrSavedSlotNINumber=alaStackMgrSavedSlotNINumber, AlaStackMgrStackMode=AlaStackMgrStackMode, alaStackMgrStaticRouteEntry=alaStackMgrStaticRouteEntry, alaStackMgrRemoteNISlotB=alaStackMgrRemoteNISlotB, alaStackMgrStaticRouteStatus=alaStackMgrStaticRouteStatus, alaSSPStateEntry=alaSSPStateEntry, AlaStackMgrLinkStatus=AlaStackMgrLinkStatus, alaSSPTableSlotNINumber=alaSSPTableSlotNINumber, alaStackMgrOperStackMode=alaStackMgrOperStackMode, alaSspHelperqAggregateTable=alaSspHelperqAggregateTable, AlaStackMgrNINumber=AlaStackMgrNINumber, alaStackMgrChasRole=alaStackMgrChasRole, PYSNMP_MODULE_ID=alcatelIND1StackMgrMIB, alaStackMgrStatsEntry=alaStackMgrStatsEntry, alaStackMgrCommandStatus=alaStackMgrCommandStatus, alaStackMgrMIBObjectsGroup=alaStackMgrMIBObjectsGroup, alaStackMgrStaticRoutePortState=alaStackMgrStaticRoutePortState, alaStackSplitProtectionGroup=alaStackSplitProtectionGroup, alaStackMgrCfgMgrGroup=alaStackMgrCfgMgrGroup, alcatelIND1StackMgrMIBCompliance=alcatelIND1StackMgrMIBCompliance, alaStackMgrLocalLinkStateB=alaStackMgrLocalLinkStateB, alaStackMgrCmdAction=alaStackMgrCmdAction, alaStackMgrStatPktsTx=alaStackMgrStatPktsTx, alaStackMgrClearedSlotTrap=alaStackMgrClearedSlotTrap, alaSspConfigStatus=alaSspConfigStatus, alaStackMgrStaticRouteSrcStartIf=alaStackMgrStaticRouteSrcStartIf, alaStackSplitProtectionTrap=alaStackSplitProtectionTrap, alaStackMgrStaticRouteSrcEndIf=alaStackMgrStaticRouteSrcEndIf, alaStackMgrSlotCMMNumber=alaStackMgrSlotCMMNumber, AlaStackMgrStackStatus=AlaStackMgrStackStatus, AlaStackMgrCommandAction=AlaStackMgrCommandAction, alaSSPHelperGlobalConfig=alaSSPHelperGlobalConfig, alaStackMgrRemoteLinkA=alaStackMgrRemoteLinkA, alaStackMgrRemoteLinkB=alaStackMgrRemoteLinkB, alaStackMgrTraps=alaStackMgrTraps, alaStackMgrTokensUsed=alaStackMgrTokensUsed, alaStackMgrPrimary=alaStackMgrPrimary, alcatelIND1StackMgrMIB=alcatelIND1StackMgrMIB, AlaStackMgrCommandStatus=AlaStackMgrCommandStatus, alaStackMgrIncompatibleLicenseTrap=alaStackMgrIncompatibleLicenseTrap, alaStackMgrStaticRouteRowStatus=alaStackMgrStaticRouteRowStatus, alaStackMgrStackModeGroup=alaStackMgrStackModeGroup, alaStackMgrStatPktsRx=alaStackMgrStatPktsRx, alaSspStateUpTime=alaSspStateUpTime, alaStackMgrCommandAction=alaStackMgrCommandAction, alaStackMgrStaticRouteTable=alaStackMgrStaticRouteTable, AlaSSPTableSlotNINumber=AlaSSPTableSlotNINumber, alaStackMgrOutOfPassThruSlotsTrap=alaStackMgrOutOfPassThruSlotsTrap, alaStackMgrStatGroup=alaStackMgrStatGroup, alaStackMgrTrapGroup=alaStackMgrTrapGroup, AlaStackMgrSlotRole=AlaStackMgrSlotRole, alcatelIND1StackMgrTrapObjects=alcatelIND1StackMgrTrapObjects, alaSspHelperStatus=alaSspHelperStatus, alaSspGuardTimer=alaSspGuardTimer, alaStackMgrTokensAvailable=alaStackMgrTokensAvailable, alaStackMgrChassisTable=alaStackMgrChassisTable, alaStackMgrStaticRouteDstEndIf=alaStackMgrStaticRouteDstEndIf, alaStackMgrLocalLinkStateA=alaStackMgrLocalLinkStateA, AlaSSPTableSspOpStatus=AlaSSPTableSspOpStatus, alaStackMgrAdminStackingMode=alaStackMgrAdminStackingMode, alcatelIND1StackMgrMIBObjects=alcatelIND1StackMgrMIBObjects, alaStackMgrStatErrorsTx=alaStackMgrStatErrorsTx, AlaStackMgrLinkNumber=AlaStackMgrLinkNumber, alaStackMgrStatErrorsRx=alaStackMgrStatErrorsRx, alaSspHelperqAggregateEntry=alaSspHelperqAggregateEntry, alaSSPStateTable=alaSSPStateTable, alaStackMgrRoleChangeTrap=alaStackMgrRoleChangeTrap, alaStackMgrStatsTable=alaStackMgrStatsTable, alaStackMgrTrapLinkNumber=alaStackMgrTrapLinkNumber, alaStackMgrStaticRoutePort=alaStackMgrStaticRoutePort, alcatelIND1StackMgrMIBGroups=alcatelIND1StackMgrMIBGroups, alaStackMgrChassisEntry=alaStackMgrChassisEntry, alaSspHelperAggregateStatus=alaSspHelperAggregateStatus, alaStackMgrStatDelayFromLastMsg=alaStackMgrStatDelayFromLastMsg, alaSSPConfigInfo=alaSSPConfigInfo, alaStackMgrStaticRouteGroup=alaStackMgrStaticRouteGroup, alaStackMgrSlotNINumber=alaStackMgrSlotNINumber, alaStackMgrNeighborChangeTrap=alaStackMgrNeighborChangeTrap, alaSSPTableSspOpStatus=alaSSPTableSspOpStatus, alaSspHelperAggregateId=alaSspHelperAggregateId, AlaStackMgrLicenseType=AlaStackMgrLicenseType, alaStackMgrBadMixTrap=alaStackMgrBadMixTrap, alaSspLinkaggId=alaSspLinkaggId, AlaStackMgrStackingMode=AlaStackMgrStackingMode, alaStackMgrOutOfSlotsTrap=alaStackMgrOutOfSlotsTrap, alaStackSplitRecoveryTrap=alaStackSplitRecoveryTrap, alaStackMgrDuplicateRoleTrap=alaStackMgrDuplicateRoleTrap, alaSspUpTime=alaSspUpTime, alaStackMgrRemoteNISlotA=alaStackMgrRemoteNISlotA, alcatelIND1StackMgrMIBConformance=alcatelIND1StackMgrMIBConformance, alaStackMgrPrimaryLicense=alaStackMgrPrimaryLicense, AlaStackMgrSlotState=AlaStackMgrSlotState, alaStackMgrStackModeEntry=alaStackMgrStackModeEntry, alaStackMgrOperStackingMode=alaStackMgrOperStackingMode, alaStackMgrChasState=alaStackMgrChasState, alaStackMgrOutOfTokensTrap=alaStackMgrOutOfTokensTrap, alaStackMgrSecondary=alaStackMgrSecondary, alaStackMgrAdminStackMode=alaStackMgrAdminStackMode, alaStackMgrStaticRouteDstStartIf=alaStackMgrStaticRouteDstStartIf, alaStackMgrStatLinkNumber=alaStackMgrStatLinkNumber, alaStackMgrNotificationGroup=alaStackMgrNotificationGroup, alaStackMgrDuplicateSlotTrap=alaStackMgrDuplicateSlotTrap, alcatelIND1StackMgrMIBCompliances=alcatelIND1StackMgrMIBCompliances)
