...
h3cVoiceCallHistoryObjects=_H3cVoiceCallHistoryObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,39,16,1))
_H3cCallHistoryTable_Object=MibTable
h3cCallHistoryTable=_H3cCallHistoryTable_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1))
if mibBuilder.loadTexts:h3cCallHistoryTable.setStatus(_A)
_H3cCallHistoryEntry_Object=MibTableRow
h3cCallHistoryEntry=_H3cCallHistoryEntry_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1))
...
h3cCallHistoryIndex=_H3cCallHistoryIndex_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,1),_H3cCallHistoryIndex_Type())
...
h3cCallHistorySetupTime=_H3cCallHistorySetupTime_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,2),_H3cCallHistorySetupTime_Type())
...
h3cCallHistoryConnectTime=_H3cCallHistoryConnectTime_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,3),_H3cCallHistoryConnectTime_Type())
...
h3cCallHistoryTerminateTime=_H3cCallHistoryTerminateTime_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,4),_H3cCallHistoryTerminateTime_Type())
...
h3cCallHistoryPeerAddress=_H3cCallHistoryPeerAddress_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,5),_H3cCallHistoryPeerAddress_Type())
...
h3cCallHistoryPeerId=_H3cCallHistoryPeerId_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,6),_H3cCallHistoryPeerId_Type())
...
h3cCallHistoryLogicalIfIndex=_H3cCallHistoryLogicalIfIndex_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,7),_H3cCallHistoryLogicalIfIndex_Type())
...
h3cCallHistoryCallOrigin=_H3cCallHistoryCallOrigin_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,8),_H3cCallHistoryCallOrigin_Type())
...
h3cCallHistoryChargedUnits=_H3cCallHistoryChargedUnits_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,9),_H3cCallHistoryChargedUnits_Type())
...
h3cCallHistoryInfoType=_H3cCallHistoryInfoType_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,10),_H3cCallHistoryInfoType_Type())
...
h3cCallHistoryTransmitPackets=_H3cCallHistoryTransmitPackets_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,11),_H3cCallHistoryTransmitPackets_Type())
...
h3cCallHistoryTransmitBytes=_H3cCallHistoryTransmitBytes_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,12),_H3cCallHistoryTransmitBytes_Type())
...
h3cCallHistoryReceivePackets=_H3cCallHistoryReceivePackets_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,13),_H3cCallHistoryReceivePackets_Type())
...
h3cCallHistoryReceiveBytes=_H3cCallHistoryReceiveBytes_Object((1,3,6,1,4,1,2011,10,2,39,16,1,1,1,14),_H3cCallHistoryReceiveBytes_Type())
...
h3cVoiceCallHistoryTable=_H3cVoiceCallHistoryTable_Object((1,3,6,1,4,1,2011,10,2,39,16,1,2))
if mibBuilder.loadTexts:h3cVoiceCallHistoryTable.setStatus(_A)
_H3cVoiceCallHistoryEntry_Object=MibTableRow
h3cVoiceCallHistoryEntry=_H3cVoiceCallHistoryEntry_Object((1,3,6,1,4,1,2011,10,2,39,16,1,2,1))
...
h3cVoCallHistoryConnectionId=_H3cVoCallHistoryConnectionId_Object((1,3,6,1,4,1,2011,10,2,39,16,1,2,1,1),_H3cVoCallHistoryConnectionId_Type())
...
h3cVoCallHistoryTxDuration=_H3cVoCallHistoryTxDuration_Object((1,3,6,1,4,1,2011,10,2,39,16,1,2,1,2),_H3cVoCallHistoryTxDuration_Type())
...
h3cVoCallHistoryVoiceTxDuration=_H3cVoCallHistoryVoiceTxDuration_Object((1,3,6,1,4,1,2011,10,2,39,16,1,2,1,3),_H3cVoCallHistoryVoiceTxDuration_Type())
...
h3cVoCallHistoryFaxTxDuration=_H3cVoCallHistoryFaxTxDuration_Object((1,3,6,1,4,1,2011,10,2,39,16,1,2,1,4),_H3cVoCallHistoryFaxTxDuration_Type())
...
h3cVoCallHistoryCoderType=_H3cVoCallHistoryCoderType_Object((1,3,6,1,4,1,2011,10,2,39,16,1,2,1,5),_H3cVoCallHistoryCoderType_Type())
...
h3cVoCallHistoryImgPageCount=_H3cVoCallHistoryImgPageCount_Object((1,3,6,1,4,1,2011,10,2,39,16,1,2,1,6),_H3cVoCallHistoryImgPageCount_Type())
...
h3cVoiceVoIPCallHistoryTable=_H3cVoiceVoIPCallHistoryTable_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3))
if mibBuilder.loadTexts:h3cVoiceVoIPCallHistoryTable.setStatus(_A)
_H3cVoiceVoIPCallHistoryEntry_Object=MibTableRow
h3cVoiceVoIPCallHistoryEntry=_H3cVoiceVoIPCallHistoryEntry_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1))
...
h3cVoVoIPCallHistoryConnectionId=_H3cVoVoIPCallHistoryConnectionId_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1,1),_H3cVoVoIPCallHistoryConnectionId_Type())
...
h3cVoVoIPCallHistoryRemSigIPType=_H3cVoVoIPCallHistoryRemSigIPType_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1,2),_H3cVoVoIPCallHistoryRemSigIPType_Type())
...
h3cVoVoIPCallHistoryRemSigIPAddr=_H3cVoVoIPCallHistoryRemSigIPAddr_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1,3),_H3cVoVoIPCallHistoryRemSigIPAddr_Type())
...
h3cVoVoIPCallHistoryRemSigPort=_H3cVoVoIPCallHistoryRemSigPort_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1,4),_H3cVoVoIPCallHistoryRemSigPort_Type())
...
h3cVoVoIPCallHistoryRemMedIPType=_H3cVoVoIPCallHistoryRemMedIPType_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1,5),_H3cVoVoIPCallHistoryRemMedIPType_Type())
...
h3cVoVoIPCallHistoryRemMedIPAddr=_H3cVoVoIPCallHistoryRemMedIPAddr_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1,6),_H3cVoVoIPCallHistoryRemMedIPAddr_Type())
...
h3cVoVoIPCallHistoryRemMedPort=_H3cVoVoIPCallHistoryRemMedPort_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1,7),_H3cVoVoIPCallHistoryRemMedPort_Type())
...
h3cVoVoIPCallHistorySessProtocol=_H3cVoVoIPCallHistorySessProtocol_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1,8),_H3cVoVoIPCallHistorySessProtocol_Type())
...
h3cVoVoIPCallHistoryCoderType=_H3cVoVoIPCallHistoryCoderType_Object((1,3,6,1,4,1,2011,10,2,39,16,1,3,1,9),_H3cVoVoIPCallHistoryCoderType_Type())
