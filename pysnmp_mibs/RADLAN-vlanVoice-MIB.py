# SNMP MIB module (RADLAN-vlanVoice-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-vlanVoice-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:11:59 2025
...
vlanVoiceUcDeviceEntry = _VlanVoiceUcDeviceEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 48, 54, 10, 1)
)
vlanVoiceUcDeviceEntry.setIndexNames(
    (0, "RADLAN-vlanVoice-MIB", "vlanVoiceUcDeviceType"),
    (0, "RADLAN-vlanVoice-MIB", "vlanVoiceUcDeviceMacAddress"),
    (0, "RADLAN-vlanVoice-MIB", "vlanVoiceUcDeviceInterface"),
)
if mibBuilder.loadTexts:
...
vlanVoiceOUIBasedEntry = _VlanVoiceOUIBasedEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 48, 54, 12, 4, 1)
)
vlanVoiceOUIBasedEntry.setIndexNames(
    (0, "RADLAN-vlanVoice-MIB", "vlanVoiceOUIBasedPrefix"),
)
if mibBuilder.loadTexts:
