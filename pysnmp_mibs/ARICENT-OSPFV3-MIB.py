# SNMP MIB module (ARICENT-OSPFV3-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-OSPFV3-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:42:53 2025
...
class _FutOspfv3BfdStatus_Type(Integer32):
    """Custom type futOspfv3BfdStatus based on Integer32"""
    defaultValue = 2
...
_FutOspfv3BfdStatus_Type.__name__ = "Integer32"
_FutOspfv3BfdStatus_Object = MibScalar
futOspfv3BfdStatus = _FutOspfv3BfdStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 1, 23),
    _FutOspfv3BfdStatus_Type()
)
futOspfv3BfdStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3BfdStatus.setStatus("current")


class _FutOspfv3BfdAllIfState_Type(Integer32):
    """Custom type futOspfv3BfdAllIfState based on Integer32"""
    defaultValue = 2
...
_FutOspfv3BfdAllIfState_Type.__name__ = "Integer32"
_FutOspfv3BfdAllIfState_Object = MibScalar
futOspfv3BfdAllIfState = _FutOspfv3BfdAllIfState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 1, 24),
    _FutOspfv3BfdAllIfState_Type()
)
futOspfv3BfdAllIfState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3BfdAllIfState.setStatus("current")
_FutOspfv3IfTable_Object = MibTable
futOspfv3IfTable = _FutOspfv3IfTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 2)
)
if mibBuilder.loadTexts:
    futOspfv3IfTable.setStatus("current")
_FutOspfv3IfEntry_Object = MibTableRow
futOspfv3IfEntry = _FutOspfv3IfEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 2, 1)
)
futOspfv3IfEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3IfIndex"),
)
if mibBuilder.loadTexts:
...
class _FutOspfv3IfBfdState_Type(Integer32):
    """Custom type futOspfv3IfBfdState based on Integer32"""
    defaultValue = 2
...
_FutOspfv3IfBfdState_Type.__name__ = "Integer32"
_FutOspfv3IfBfdState_Object = MibTableColumn
futOspfv3IfBfdState = _FutOspfv3IfBfdState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 2, 1, 22),
    _FutOspfv3IfBfdState_Type()
)
futOspfv3IfBfdState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3IfBfdState.setStatus("current")


class _FutOspfv3IfCryptoAuthType_Type(Integer32):
    """Custom type futOspfv3IfCryptoAuthType based on Integer32"""
    defaultValue = 6
...
_FutOspfv3IfCryptoAuthType_Type.__name__ = "Integer32"
_FutOspfv3IfCryptoAuthType_Object = MibTableColumn
futOspfv3IfCryptoAuthType = _FutOspfv3IfCryptoAuthType_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 2, 1, 23),
    _FutOspfv3IfCryptoAuthType_Type()
)
futOspfv3IfCryptoAuthType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3IfCryptoAuthType.setStatus("current")


class _FutOspfv3IfCryptoAuthMode_Type(Integer32):
    """Custom type futOspfv3IfCryptoAuthMode based on Integer32"""
    defaultValue = 3
...
_FutOspfv3IfCryptoAuthMode_Type.__name__ = "Integer32"
_FutOspfv3IfCryptoAuthMode_Object = MibTableColumn
futOspfv3IfCryptoAuthMode = _FutOspfv3IfCryptoAuthMode_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 2, 1, 24),
    _FutOspfv3IfCryptoAuthMode_Type()
)
futOspfv3IfCryptoAuthMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3IfCryptoAuthMode.setStatus("current")
_FutOspfv3IfAuthTxed_Type = Counter32
_FutOspfv3IfAuthTxed_Object = MibTableColumn
futOspfv3IfAuthTxed = _FutOspfv3IfAuthTxed_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 2, 1, 25),
    _FutOspfv3IfAuthTxed_Type()
)
futOspfv3IfAuthTxed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    futOspfv3IfAuthTxed.setStatus("current")
_FutOspfv3IfAuthRcvd_Type = Counter32
_FutOspfv3IfAuthRcvd_Object = MibTableColumn
futOspfv3IfAuthRcvd = _FutOspfv3IfAuthRcvd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 2, 1, 26),
    _FutOspfv3IfAuthRcvd_Type()
)
futOspfv3IfAuthRcvd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    futOspfv3IfAuthRcvd.setStatus("current")
_FutOspfv3IfAuthDisd_Type = Counter32
_FutOspfv3IfAuthDisd_Object = MibTableColumn
futOspfv3IfAuthDisd = _FutOspfv3IfAuthDisd_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 2, 1, 27),
    _FutOspfv3IfAuthDisd_Type()
)
futOspfv3IfAuthDisd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    futOspfv3IfAuthDisd.setStatus("current")
_FutOspfv3RoutingTable_Object = MibTable
futOspfv3RoutingTable = _FutOspfv3RoutingTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 3)
)
if mibBuilder.loadTexts:
...
futOspfv3RoutingEntry = _FutOspfv3RoutingEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 3, 1)
)
futOspfv3RoutingEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3RouteDestType"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3RouteDest"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3RoutePfxLength"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3RouteNextHopType"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3RouteNextHop"),
)
if mibBuilder.loadTexts:
...
futOspfv3AsExternalAggregationEntry = _FutOspfv3AsExternalAggregationEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 4, 1)
)
futOspfv3AsExternalAggregationEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3AsExternalAggregationNetType"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3AsExternalAggregationNet"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3AsExternalAggregationPfxLength"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3AsExternalAggregationAreaId"),
)
if mibBuilder.loadTexts:
...
futOspfv3BRRouteEntry = _FutOspfv3BRRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 5, 1)
)
futOspfv3BRRouteEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3BRRouteDest"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3BRRouteNextHopType"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3BRRouteNextHop"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3BRRouteDestType"),
)
if mibBuilder.loadTexts:
...
futOspfv3RedistRouteCfgEntry = _FutOspfv3RedistRouteCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 6, 1)
)
futOspfv3RedistRouteCfgEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3RedistRouteDestType"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3RedistRouteDest"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3RedistRoutePfxLength"),
)
if mibBuilder.loadTexts:
...
futOspfv3DistInOutRouteMapEntry = _FutOspfv3DistInOutRouteMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 8, 1, 1)
)
futOspfv3DistInOutRouteMapEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3DistInOutRouteMapName"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3DistInOutRouteMapType"),
)
if mibBuilder.loadTexts:
...
futOspfv3NeighborBfdGroup = _FutOspfv3NeighborBfdGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 90, 11)
)
_FutOspfv3NeighborBfdTable_Object = MibTable
futOspfv3NeighborBfdTable = _FutOspfv3NeighborBfdTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 11, 1)
)
if mibBuilder.loadTexts:
    futOspfv3NeighborBfdTable.setStatus("current")
_FutOspfv3NeighborBfdEntry_Object = MibTableRow
futOspfv3NeighborBfdEntry = _FutOspfv3NeighborBfdEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 11, 1, 1)
)
if mibBuilder.loadTexts:
    futOspfv3NeighborBfdEntry.setStatus("current")


class _FutOspfv3NbrBfdState_Type(Integer32):
    """Custom type futOspfv3NbrBfdState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_FutOspfv3NbrBfdState_Type.__name__ = "Integer32"
_FutOspfv3NbrBfdState_Object = MibTableColumn
futOspfv3NbrBfdState = _FutOspfv3NbrBfdState_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 11, 1, 1, 1),
    _FutOspfv3NbrBfdState_Type()
)
futOspfv3NbrBfdState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    futOspfv3NbrBfdState.setStatus("current")
_FutOspfv3IfAuthTable_Object = MibTable
futOspfv3IfAuthTable = _FutOspfv3IfAuthTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12)
)
if mibBuilder.loadTexts:
    futOspfv3IfAuthTable.setStatus("current")
_FutOspfv3IfAuthEntry_Object = MibTableRow
futOspfv3IfAuthEntry = _FutOspfv3IfAuthEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12, 1)
)
futOspfv3IfAuthEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3IfAuthIfIndex"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3IfAuthKeyId"),
)
if mibBuilder.loadTexts:
    futOspfv3IfAuthEntry.setStatus("current")


class _FutOspfv3IfAuthIfIndex_Type(InterfaceIndex):
    """Custom type futOspfv3IfAuthIfIndex based on InterfaceIndex"""
...
_FutOspfv3IfAuthIfIndex_Type.__name__ = "InterfaceIndex"
_FutOspfv3IfAuthIfIndex_Object = MibTableColumn
futOspfv3IfAuthIfIndex = _FutOspfv3IfAuthIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12, 1, 1),
    _FutOspfv3IfAuthIfIndex_Type()
)
futOspfv3IfAuthIfIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    futOspfv3IfAuthIfIndex.setStatus("current")


class _FutOspfv3IfAuthKeyId_Type(Integer32):
    """Custom type futOspfv3IfAuthKeyId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_FutOspfv3IfAuthKeyId_Type.__name__ = "Integer32"
_FutOspfv3IfAuthKeyId_Object = MibTableColumn
futOspfv3IfAuthKeyId = _FutOspfv3IfAuthKeyId_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12, 1, 2),
    _FutOspfv3IfAuthKeyId_Type()
)
futOspfv3IfAuthKeyId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    futOspfv3IfAuthKeyId.setStatus("current")


class _FutOspfv3IfAuthKey_Type(OctetString):
    """Custom type futOspfv3IfAuthKey based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_FutOspfv3IfAuthKey_Type.__name__ = "OctetString"
_FutOspfv3IfAuthKey_Object = MibTableColumn
futOspfv3IfAuthKey = _FutOspfv3IfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12, 1, 3),
    _FutOspfv3IfAuthKey_Type()
)
futOspfv3IfAuthKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3IfAuthKey.setStatus("current")
_FutOspfv3IfAuthKeyStartAccept_Type = DateAndTime
_FutOspfv3IfAuthKeyStartAccept_Object = MibTableColumn
futOspfv3IfAuthKeyStartAccept = _FutOspfv3IfAuthKeyStartAccept_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12, 1, 4),
    _FutOspfv3IfAuthKeyStartAccept_Type()
)
futOspfv3IfAuthKeyStartAccept.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3IfAuthKeyStartAccept.setStatus("current")
_FutOspfv3IfAuthKeyStartGenerate_Type = DateAndTime
_FutOspfv3IfAuthKeyStartGenerate_Object = MibTableColumn
futOspfv3IfAuthKeyStartGenerate = _FutOspfv3IfAuthKeyStartGenerate_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12, 1, 5),
    _FutOspfv3IfAuthKeyStartGenerate_Type()
)
futOspfv3IfAuthKeyStartGenerate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3IfAuthKeyStartGenerate.setStatus("current")
_FutOspfv3IfAuthKeyStopGenerate_Type = DateAndTime
_FutOspfv3IfAuthKeyStopGenerate_Object = MibTableColumn
futOspfv3IfAuthKeyStopGenerate = _FutOspfv3IfAuthKeyStopGenerate_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12, 1, 6),
    _FutOspfv3IfAuthKeyStopGenerate_Type()
)
futOspfv3IfAuthKeyStopGenerate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3IfAuthKeyStopGenerate.setStatus("current")
_FutOspfv3IfAuthKeyStopAccept_Type = DateAndTime
_FutOspfv3IfAuthKeyStopAccept_Object = MibTableColumn
futOspfv3IfAuthKeyStopAccept = _FutOspfv3IfAuthKeyStopAccept_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12, 1, 7),
    _FutOspfv3IfAuthKeyStopAccept_Type()
)
futOspfv3IfAuthKeyStopAccept.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3IfAuthKeyStopAccept.setStatus("current")
_FutOspfv3IfAuthKeyStatus_Type = RowStatus
_FutOspfv3IfAuthKeyStatus_Object = MibTableColumn
futOspfv3IfAuthKeyStatus = _FutOspfv3IfAuthKeyStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 12, 1, 8),
    _FutOspfv3IfAuthKeyStatus_Type()
)
futOspfv3IfAuthKeyStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3IfAuthKeyStatus.setStatus("current")
_FutOspfv3VirtIfAuthTable_Object = MibTable
futOspfv3VirtIfAuthTable = _FutOspfv3VirtIfAuthTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13)
)
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthTable.setStatus("current")
_FutOspfv3VirtIfAuthEntry_Object = MibTableRow
futOspfv3VirtIfAuthEntry = _FutOspfv3VirtIfAuthEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1)
)
futOspfv3VirtIfAuthEntry.setIndexNames(
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3VirtIfAuthAreaId"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3VirtIfAuthNeighbor"),
    (0, "ARICENT-OSPFV3-MIB", "futOspfv3VirtIfAuthKeyId"),
)
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthEntry.setStatus("current")
_FutOspfv3VirtIfAuthAreaId_Type = AreaID
_FutOspfv3VirtIfAuthAreaId_Object = MibTableColumn
futOspfv3VirtIfAuthAreaId = _FutOspfv3VirtIfAuthAreaId_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1, 1),
    _FutOspfv3VirtIfAuthAreaId_Type()
)
futOspfv3VirtIfAuthAreaId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthAreaId.setStatus("current")
_FutOspfv3VirtIfAuthNeighbor_Type = RouterID
_FutOspfv3VirtIfAuthNeighbor_Object = MibTableColumn
futOspfv3VirtIfAuthNeighbor = _FutOspfv3VirtIfAuthNeighbor_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1, 2),
    _FutOspfv3VirtIfAuthNeighbor_Type()
)
futOspfv3VirtIfAuthNeighbor.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthNeighbor.setStatus("current")


class _FutOspfv3VirtIfAuthKeyId_Type(Integer32):
    """Custom type futOspfv3VirtIfAuthKeyId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_FutOspfv3VirtIfAuthKeyId_Type.__name__ = "Integer32"
_FutOspfv3VirtIfAuthKeyId_Object = MibTableColumn
futOspfv3VirtIfAuthKeyId = _FutOspfv3VirtIfAuthKeyId_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1, 3),
    _FutOspfv3VirtIfAuthKeyId_Type()
)
futOspfv3VirtIfAuthKeyId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthKeyId.setStatus("current")


class _FutOspfv3VirtIfAuthKey_Type(OctetString):
    """Custom type futOspfv3VirtIfAuthKey based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_FutOspfv3VirtIfAuthKey_Type.__name__ = "OctetString"
_FutOspfv3VirtIfAuthKey_Object = MibTableColumn
futOspfv3VirtIfAuthKey = _FutOspfv3VirtIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1, 4),
    _FutOspfv3VirtIfAuthKey_Type()
)
futOspfv3VirtIfAuthKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthKey.setStatus("current")
_FutOspfv3VirtIfAuthKeyStartAccept_Type = DateAndTime
_FutOspfv3VirtIfAuthKeyStartAccept_Object = MibTableColumn
futOspfv3VirtIfAuthKeyStartAccept = _FutOspfv3VirtIfAuthKeyStartAccept_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1, 5),
    _FutOspfv3VirtIfAuthKeyStartAccept_Type()
)
futOspfv3VirtIfAuthKeyStartAccept.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthKeyStartAccept.setStatus("current")
_FutOspfv3VirtIfAuthKeyStartGenerate_Type = DateAndTime
_FutOspfv3VirtIfAuthKeyStartGenerate_Object = MibTableColumn
futOspfv3VirtIfAuthKeyStartGenerate = _FutOspfv3VirtIfAuthKeyStartGenerate_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1, 6),
    _FutOspfv3VirtIfAuthKeyStartGenerate_Type()
)
futOspfv3VirtIfAuthKeyStartGenerate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthKeyStartGenerate.setStatus("current")
_FutOspfv3VirtIfAuthKeyStopGenerate_Type = DateAndTime
_FutOspfv3VirtIfAuthKeyStopGenerate_Object = MibTableColumn
futOspfv3VirtIfAuthKeyStopGenerate = _FutOspfv3VirtIfAuthKeyStopGenerate_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1, 7),
    _FutOspfv3VirtIfAuthKeyStopGenerate_Type()
)
futOspfv3VirtIfAuthKeyStopGenerate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthKeyStopGenerate.setStatus("current")
_FutOspfv3VirtIfAuthKeyStopAccept_Type = DateAndTime
_FutOspfv3VirtIfAuthKeyStopAccept_Object = MibTableColumn
futOspfv3VirtIfAuthKeyStopAccept = _FutOspfv3VirtIfAuthKeyStopAccept_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1, 8),
    _FutOspfv3VirtIfAuthKeyStopAccept_Type()
)
futOspfv3VirtIfAuthKeyStopAccept.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthKeyStopAccept.setStatus("current")
_FutOspfv3VirtIfAuthKeyStatus_Type = RowStatus
_FutOspfv3VirtIfAuthKeyStatus_Object = MibTableColumn
futOspfv3VirtIfAuthKeyStatus = _FutOspfv3VirtIfAuthKeyStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 13, 1, 9),
    _FutOspfv3VirtIfAuthKeyStatus_Type()
)
futOspfv3VirtIfAuthKeyStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3VirtIfAuthKeyStatus.setStatus("current")
_FutOspfv3VirtIfCryptoAuthTable_Object = MibTable
futOspfv3VirtIfCryptoAuthTable = _FutOspfv3VirtIfCryptoAuthTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 14)
)
if mibBuilder.loadTexts:
    futOspfv3VirtIfCryptoAuthTable.setStatus("current")
_FutOspfv3VirtIfCryptoAuthEntry_Object = MibTableRow
futOspfv3VirtIfCryptoAuthEntry = _FutOspfv3VirtIfCryptoAuthEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 14, 1)
)
if mibBuilder.loadTexts:
    futOspfv3VirtIfCryptoAuthEntry.setStatus("current")


class _FutOspfv3VirtIfCryptoAuthType_Type(Integer32):
    """Custom type futOspfv3VirtIfCryptoAuthType based on Integer32"""
    defaultValue = 6
...
_FutOspfv3VirtIfCryptoAuthType_Type.__name__ = "Integer32"
_FutOspfv3VirtIfCryptoAuthType_Object = MibTableColumn
futOspfv3VirtIfCryptoAuthType = _FutOspfv3VirtIfCryptoAuthType_Object(
    (1, 3, 6, 1, 4, 1, 2076, 90, 14, 1, 1),
    _FutOspfv3VirtIfCryptoAuthType_Type()
)
futOspfv3VirtIfCryptoAuthType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    futOspfv3VirtIfCryptoAuthType.setStatus("current")


class _FutOspfv3VirtIfCryptoAuthMode_Type(Integer32):
    """Custom type futOspfv3VirtIfCryptoAuthMode based on Integer32"""
    defaultValue = 3
...
ospfv3VirtIfEntry.registerAugmentions(
    ("ARICENT-OSPFV3-MIB",
     "futOspfv3VirtIfCryptoAuthEntry")
)
...
futOspfv3NbrRestartHelperStatusChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 90, 101, 0, 2)
)
futOspfv3NbrRestartHelperStatusChange.setObjects(
      *(("OSPFV3-MIB", "ospfv3RouterId"),
        ("ARICENT-OSPFV3-MIB", "futOspfv3TrapNbrIfIndex"),
        ("ARICENT-OSPFV3-MIB", "futOspfv3TrapNbrRtrId"),
...
futOspfv3VirtNbrRestartHelperStatusChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 90, 101, 0, 3)
)
futOspfv3VirtNbrRestartHelperStatusChange.setObjects(
      *(("OSPFV3-MIB", "ospfv3RouterId"),
        ("ARICENT-OSPFV3-MIB", "futOspfv3TrapVirtNbrArea"),
        ("ARICENT-OSPFV3-MIB", "futOspfv3TrapVirtNbrRtrId"),
...
futOspfv3HotStandbyStateChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 90, 101, 0, 4)
)
futOspfv3HotStandbyStateChgTrap.setObjects(
      *(("OSPFV3-MIB", "ospfv3RouterId"),
        ("ARICENT-OSPFV3-MIB", "futOspfv3HotStandbyState"))
)
if mibBuilder.loadTexts:
...
futOspfv3HotStandbyBulkUpdAbortTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 90, 101, 0, 5)
)
futOspfv3HotStandbyBulkUpdAbortTrap.setObjects(
      *(("OSPFV3-MIB", "ospfv3RouterId"),
        ("ARICENT-OSPFV3-MIB", "futOspfv3DynamicBulkUpdStatus"),
        ("ARICENT-OSPFV3-MIB", "futOspfv3TrapBulkUpdAbortReason"))
)
if mibBuilder.loadTexts:
...
futOspfv3AuthSequenceNumWrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 90, 101, 0, 6)
)
futOspfv3AuthSequenceNumWrap.setObjects(
    ("OSPFV3-MIB", "ospfv3RouterId")
)
if mibBuilder.loadTexts:
    futOspfv3AuthSequenceNumWrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"futospfv3": futospfv3,
       ...
       "futOspfv3BfdStatus": futOspfv3BfdStatus,
       "futOspfv3BfdAllIfState": futOspfv3BfdAllIfState,
       ...
       "futOspfv3IfBfdState": futOspfv3IfBfdState,
       "futOspfv3IfCryptoAuthType": futOspfv3IfCryptoAuthType,
       "futOspfv3IfCryptoAuthMode": futOspfv3IfCryptoAuthMode,
       "futOspfv3IfAuthTxed": futOspfv3IfAuthTxed,
       "futOspfv3IfAuthRcvd": futOspfv3IfAuthRcvd,
       "futOspfv3IfAuthDisd": futOspfv3IfAuthDisd,
       ...
       "futOspfv3NeighborBfdGroup": futOspfv3NeighborBfdGroup,
       "futOspfv3NeighborBfdTable": futOspfv3NeighborBfdTable,
       "futOspfv3NeighborBfdEntry": futOspfv3NeighborBfdEntry,
       "futOspfv3NbrBfdState": futOspfv3NbrBfdState,
       "futOspfv3IfAuthTable": futOspfv3IfAuthTable,
       "futOspfv3IfAuthEntry": futOspfv3IfAuthEntry,
       "futOspfv3IfAuthIfIndex": futOspfv3IfAuthIfIndex,
       "futOspfv3IfAuthKeyId": futOspfv3IfAuthKeyId,
       "futOspfv3IfAuthKey": futOspfv3IfAuthKey,
       "futOspfv3IfAuthKeyStartAccept": futOspfv3IfAuthKeyStartAccept,
       "futOspfv3IfAuthKeyStartGenerate": futOspfv3IfAuthKeyStartGenerate,
       "futOspfv3IfAuthKeyStopGenerate": futOspfv3IfAuthKeyStopGenerate,
       "futOspfv3IfAuthKeyStopAccept": futOspfv3IfAuthKeyStopAccept,
       "futOspfv3IfAuthKeyStatus": futOspfv3IfAuthKeyStatus,
       "futOspfv3VirtIfAuthTable": futOspfv3VirtIfAuthTable,
       "futOspfv3VirtIfAuthEntry": futOspfv3VirtIfAuthEntry,
       "futOspfv3VirtIfAuthAreaId": futOspfv3VirtIfAuthAreaId,
       "futOspfv3VirtIfAuthNeighbor": futOspfv3VirtIfAuthNeighbor,
       "futOspfv3VirtIfAuthKeyId": futOspfv3VirtIfAuthKeyId,
       "futOspfv3VirtIfAuthKey": futOspfv3VirtIfAuthKey,
       "futOspfv3VirtIfAuthKeyStartAccept": futOspfv3VirtIfAuthKeyStartAccept,
       "futOspfv3VirtIfAuthKeyStartGenerate": futOspfv3VirtIfAuthKeyStartGenerate,
       "futOspfv3VirtIfAuthKeyStopGenerate": futOspfv3VirtIfAuthKeyStopGenerate,
       "futOspfv3VirtIfAuthKeyStopAccept": futOspfv3VirtIfAuthKeyStopAccept,
       "futOspfv3VirtIfAuthKeyStatus": futOspfv3VirtIfAuthKeyStatus,
       "futOspfv3VirtIfCryptoAuthTable": futOspfv3VirtIfCryptoAuthTable,
       "futOspfv3VirtIfCryptoAuthEntry": futOspfv3VirtIfCryptoAuthEntry,
       "futOspfv3VirtIfCryptoAuthType": futOspfv3VirtIfCryptoAuthType,
       "futOspfv3VirtIfCryptoAuthMode": futOspfv3VirtIfCryptoAuthMode,
       ...
       "futOspfv3AuthSequenceNumWrap": futOspfv3AuthSequenceNumWrap,
