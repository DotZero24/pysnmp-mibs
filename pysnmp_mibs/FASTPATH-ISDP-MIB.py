# SNMP MIB module (FASTPATH-ISDP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-ISDP-MIB
...
agentIsdpCacheEntry.setIndexNames(
    (0, "FASTPATH-ISDP-MIB", "agentIsdpCacheIfIndex"),
    (0, "FASTPATH-ISDP-MIB", "agentIsdpCacheIndex"),
)
if mibBuilder.loadTexts:
...
agentIsdpInterfaceEntry.setIndexNames(
    (0, "FASTPATH-ISDP-MIB", "agentIsdpInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
