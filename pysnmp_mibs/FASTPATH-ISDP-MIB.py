...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/broadcom/FASTPATH-ISDP-MIB
...
agentIsdpInterfaceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 39, 1, 3, 1, 1), ).setIndexNames((0, "FASTPATH-ISDP-MIB", "agentIsdpInterfaceIfIndex"))
...
agentIsdpCacheEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 39, 1, 2, 1, 1), ).setIndexNames((0, "FASTPATH-ISDP-MIB", "agentIsdpCacheIfIndex"), (0, "FASTPATH-ISDP-MIB", "agentIsdpCacheIndex"))
...
agentIsdpClearStats = MibScalar((1, 3, 6, 1, 4, 1, 4413, 1, 1, 39, 1, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1))).clone(namedValues=NamedValues(("clear", 1)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: agentIsdpClearStats.setStatus('current')
agentIsdpClearEntries = MibScalar((1, 3, 6, 1, 4, 1, 4413, 1, 1, 39, 1, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1))).clone(namedValues=NamedValues(("clear", 1)))).setMaxAccess("readwrite")
