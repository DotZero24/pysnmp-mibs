_P='agentIsdpInterfaceIfIndex'
_O='agentIsdpCacheIndex'
_N='agentIsdpCacheIfIndex'
_M='hostName'
_L='macAddress'
_K='serialNumber'
_J='not-accessible'
...
if mibBuilder.loadTexts:fastPathIsdp.setRevisions(('2010-01-11 00:00','2007-12-03 00:00'))
_AgentIsdpMIBObjects_ObjectIdentity=ObjectIdentity
agentIsdpMIBObjects=_AgentIsdpMIBObjects_ObjectIdentity((1,3,6,1,4,1,4413,1,1,39,1))
_AgentIsdpGlobal_ObjectIdentity=ObjectIdentity
agentIsdpGlobal=_AgentIsdpGlobal_ObjectIdentity((1,3,6,1,4,1,4413,1,1,39,1,1))
_AgentIsdpClear_ObjectIdentity=ObjectIdentity
agentIsdpClear=_AgentIsdpClear_ObjectIdentity((1,3,6,1,4,1,4413,1,1,39,1,1,1))
class _AgentIsdpClearStats_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(1));namedValues=NamedValues(('clear',1))
_AgentIsdpClearStats_Type.__name__=_C
_AgentIsdpClearStats_Object=MibScalar
agentIsdpClearStats=_AgentIsdpClearStats_Object((1,3,6,1,4,1,4413,1,1,39,1,1,1,1),_AgentIsdpClearStats_Type())
agentIsdpClearStats.setMaxAccess(_E)
if mibBuilder.loadTexts:agentIsdpClearStats.setStatus(_A)
class _AgentIsdpClearEntries_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(1));namedValues=NamedValues(('clear',1))
_AgentIsdpClearEntries_Type.__name__=_C
_AgentIsdpClearEntries_Object=MibScalar
agentIsdpClearEntries=_AgentIsdpClearEntries_Object((1,3,6,1,4,1,4413,1,1,39,1,1,1,2),_AgentIsdpClearEntries_Type())
...
agentIsdpStatistics=_AgentIsdpStatistics_ObjectIdentity((1,3,6,1,4,1,4413,1,1,39,1,1,2))
_AgentIsdpStatisticsPduReceived_Type=Counter32
_AgentIsdpStatisticsPduReceived_Object=MibScalar
agentIsdpStatisticsPduReceived=_AgentIsdpStatisticsPduReceived_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,1),_AgentIsdpStatisticsPduReceived_Type())
...
agentIsdpStatisticsPduTransmit=_AgentIsdpStatisticsPduTransmit_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,2),_AgentIsdpStatisticsPduTransmit_Type())
...
agentIsdpStatisticsV1PduReceived=_AgentIsdpStatisticsV1PduReceived_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,3),_AgentIsdpStatisticsV1PduReceived_Type())
...
agentIsdpStatisticsV1PduTransmit=_AgentIsdpStatisticsV1PduTransmit_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,4),_AgentIsdpStatisticsV1PduTransmit_Type())
...
agentIsdpStatisticsV2PduReceived=_AgentIsdpStatisticsV2PduReceived_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,5),_AgentIsdpStatisticsV2PduReceived_Type())
...
agentIsdpStatisticsV2PduTransmit=_AgentIsdpStatisticsV2PduTransmit_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,6),_AgentIsdpStatisticsV2PduTransmit_Type())
...
agentIsdpStatisticsBadHeaderPduReceived=_AgentIsdpStatisticsBadHeaderPduReceived_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,7),_AgentIsdpStatisticsBadHeaderPduReceived_Type())
...
agentIsdpStatisticsChkSumErrorPduReceived=_AgentIsdpStatisticsChkSumErrorPduReceived_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,8),_AgentIsdpStatisticsChkSumErrorPduReceived_Type())
...
agentIsdpStatisticsFailurePduTransmit=_AgentIsdpStatisticsFailurePduTransmit_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,9),_AgentIsdpStatisticsFailurePduTransmit_Type())
...
agentIsdpStatisticsInvalidFormatPduReceived=_AgentIsdpStatisticsInvalidFormatPduReceived_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,10),_AgentIsdpStatisticsInvalidFormatPduReceived_Type())
...
agentIsdpStatisticsTableFull=_AgentIsdpStatisticsTableFull_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,11),_AgentIsdpStatisticsTableFull_Type())
...
agentIsdpStatisticsIpAddressTableFull=_AgentIsdpStatisticsIpAddressTableFull_Object((1,3,6,1,4,1,4413,1,1,39,1,1,2,12),_AgentIsdpStatisticsIpAddressTableFull_Type())
...
agentIsdpGlobalRun=_AgentIsdpGlobalRun_Object((1,3,6,1,4,1,4413,1,1,39,1,1,4),_AgentIsdpGlobalRun_Type())
...
agentIsdpGlobalMessageInterval=_AgentIsdpGlobalMessageInterval_Object((1,3,6,1,4,1,4413,1,1,39,1,1,5),_AgentIsdpGlobalMessageInterval_Type())
...
agentIsdpGlobalHoldTime=_AgentIsdpGlobalHoldTime_Object((1,3,6,1,4,1,4413,1,1,39,1,1,6),_AgentIsdpGlobalHoldTime_Type())
...
agentIsdpGlobalDeviceId=_AgentIsdpGlobalDeviceId_Object((1,3,6,1,4,1,4413,1,1,39,1,1,7),_AgentIsdpGlobalDeviceId_Type())
...
agentIsdpGlobalAdvertiseV2=_AgentIsdpGlobalAdvertiseV2_Object((1,3,6,1,4,1,4413,1,1,39,1,1,8),_AgentIsdpGlobalAdvertiseV2_Type())
agentIsdpGlobalAdvertiseV2.setMaxAccess(_E)
if mibBuilder.loadTexts:agentIsdpGlobalAdvertiseV2.setStatus(_A)
class _AgentIsdpGlobalDeviceIdFormatCpb_Type(Bits):namedValues=NamedValues(*((_K,1),(_L,2),('other',4),(_M,8)))
_AgentIsdpGlobalDeviceIdFormatCpb_Type.__name__='Bits'
_AgentIsdpGlobalDeviceIdFormatCpb_Object=MibScalar
agentIsdpGlobalDeviceIdFormatCpb=_AgentIsdpGlobalDeviceIdFormatCpb_Object((1,3,6,1,4,1,4413,1,1,39,1,1,9),_AgentIsdpGlobalDeviceIdFormatCpb_Type())
agentIsdpGlobalDeviceIdFormatCpb.setMaxAccess(_B)
if mibBuilder.loadTexts:agentIsdpGlobalDeviceIdFormatCpb.setStatus(_A)
class _AgentIsdpGlobalDeviceIdFormat_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_K,1),(_L,2),('other',3),(_M,4)))
_AgentIsdpGlobalDeviceIdFormat_Type.__name__=_C
_AgentIsdpGlobalDeviceIdFormat_Object=MibScalar
agentIsdpGlobalDeviceIdFormat=_AgentIsdpGlobalDeviceIdFormat_Object((1,3,6,1,4,1,4413,1,1,39,1,1,10),_AgentIsdpGlobalDeviceIdFormat_Type())
...
agentIsdpCache=_AgentIsdpCache_ObjectIdentity((1,3,6,1,4,1,4413,1,1,39,1,2))
_AgentIsdpCacheTable_Object=MibTable
agentIsdpCacheTable=_AgentIsdpCacheTable_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1))
if mibBuilder.loadTexts:agentIsdpCacheTable.setStatus(_A)
_AgentIsdpCacheEntry_Object=MibTableRow
agentIsdpCacheEntry=_AgentIsdpCacheEntry_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1))
agentIsdpCacheEntry.setIndexNames((0,_F,_N),(0,_F,_O))
...
agentIsdpCacheIfIndex=_AgentIsdpCacheIfIndex_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,1),_AgentIsdpCacheIfIndex_Type())
...
agentIsdpCacheIndex=_AgentIsdpCacheIndex_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,2),_AgentIsdpCacheIndex_Type())
...
agentIsdpCacheAddress=_AgentIsdpCacheAddress_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,3),_AgentIsdpCacheAddress_Type())
...
agentIsdpCacheLocalIntf=_AgentIsdpCacheLocalIntf_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,4),_AgentIsdpCacheLocalIntf_Type())
...
agentIsdpCacheVersion=_AgentIsdpCacheVersion_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,5),_AgentIsdpCacheVersion_Type())
...
agentIsdpCacheDeviceId=_AgentIsdpCacheDeviceId_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,6),_AgentIsdpCacheDeviceId_Type())
...
agentIsdpCacheDevicePort=_AgentIsdpCacheDevicePort_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,7),_AgentIsdpCacheDevicePort_Type())
...
agentIsdpCachePlatform=_AgentIsdpCachePlatform_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,8),_AgentIsdpCachePlatform_Type())
...
agentIsdpCacheCapabilities=_AgentIsdpCacheCapabilities_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,9),_AgentIsdpCacheCapabilities_Type())
...
agentIsdpCacheLastChange=_AgentIsdpCacheLastChange_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,10),_AgentIsdpCacheLastChange_Type())
...
agentIsdpCacheProtocolVersion=_AgentIsdpCacheProtocolVersion_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,11),_AgentIsdpCacheProtocolVersion_Type())
...
agentIsdpCacheHoldtime=_AgentIsdpCacheHoldtime_Object((1,3,6,1,4,1,4413,1,1,39,1,2,1,1,12),_AgentIsdpCacheHoldtime_Type())
...
agentIsdpInterface=_AgentIsdpInterface_ObjectIdentity((1,3,6,1,4,1,4413,1,1,39,1,3))
_AgentIsdpInterfaceTable_Object=MibTable
agentIsdpInterfaceTable=_AgentIsdpInterfaceTable_Object((1,3,6,1,4,1,4413,1,1,39,1,3,1))
if mibBuilder.loadTexts:agentIsdpInterfaceTable.setStatus(_A)
_AgentIsdpInterfaceEntry_Object=MibTableRow
agentIsdpInterfaceEntry=_AgentIsdpInterfaceEntry_Object((1,3,6,1,4,1,4413,1,1,39,1,3,1,1))
agentIsdpInterfaceEntry.setIndexNames((0,_F,_P))
...
agentIsdpInterfaceIfIndex=_AgentIsdpInterfaceIfIndex_Object((1,3,6,1,4,1,4413,1,1,39,1,3,1,1,1),_AgentIsdpInterfaceIfIndex_Type())
