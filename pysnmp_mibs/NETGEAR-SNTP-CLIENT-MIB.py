# SNMP MIB module (NETGEAR-SNTP-CLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-SNTP-CLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:28:09 2025
...
agentSntpClientUcastServerEntry = _AgentSntpClientUcastServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 17, 1, 2, 6, 1)
)
agentSntpClientUcastServerEntry.setIndexNames(
    (0, "NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerIndex"),
)
if mibBuilder.loadTexts:
...
agentSntpClientUcastServerVersion = _AgentSntpClientUcastServerVersion_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 17, 1, 2, 6, 1, 5),
...
agentSntpClientCompliances = _AgentSntpClientCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 10, 17, 2, 2)
)

# Managed Objects groups

agentSntpClientDeviceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 4526, 10, 17, 2, 1, 1)
)
agentSntpClientDeviceGroup.setObjects(
      *(("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientVersion"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientSupportedMode"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientMode"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientLastUpdateTime"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientLastAttemptTime"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientLastAttemptStatus"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientServerAddressType"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientServerAddress"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientServerMode"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientServerStratum"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientServerRefClkId"))
)
if mibBuilder.loadTexts:
    agentSntpClientDeviceGroup.setStatus("current")

agentSntpClientUnicastGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 4526, 10, 17, 2, 1, 2)
)
agentSntpClientUnicastGroup.setObjects(
      *(("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUnicastPollInterval"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUnicastPollTimeout"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUnicastPollRetry"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerMaxEntries"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerCurrEntries"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerAddress"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerAddressType"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerPrecedence"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerLastUpdateTime"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerLastAttemptTime"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerLastAttemptStatus"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerNumRequests"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerNumFailedRequests"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUcastServerRowStatus"))
)
if mibBuilder.loadTexts:
    agentSntpClientUnicastGroup.setStatus("current")

agentSntpClientBroadcastGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 4526, 10, 17, 2, 1, 3)
)
agentSntpClientBroadcastGroup.setObjects(
      *(("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientBroadcastCount"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientBroadcastInterval"))
)
if mibBuilder.loadTexts:
...
agentSntpClientCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 4526, 10, 17, 2, 2, 1)
)
agentSntpClientCompliance.setObjects(
      *(("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientDeviceGroup"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientUnicastGroup"),
        ("NETGEAR-SNTP-CLIENT-MIB", "agentSntpClientBroadcastGroup"))
)
if mibBuilder.loadTexts:
