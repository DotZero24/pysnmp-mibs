# SNMP MIB module (Dell-SYSLOG-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-SYSLOG-MIB
...
rlSyslogLogEntry.setIndexNames(
    (0, "Dell-SYSLOG-MIB", "rlSyslogLogCounter"),
)
if mibBuilder.loadTexts:
...
rlSyslogLogCacheEntry.setIndexNames(
    (0, "Dell-SYSLOG-MIB", "rlSyslogLogCacheCounter"),
)
if mibBuilder.loadTexts:
...
rlSyslogCountersPerSeverityEntry.setIndexNames(
    (0, "Dell-SYSLOG-MIB", "rlSyslogCountersPerSeverityIndex"),
)
if mibBuilder.loadTexts:
...
rlSyslogLastIndexPerSeverityEntry = _RlSyslogLastIndexPerSeverityEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 82, 2, 22, 1)
)
rlSyslogLastIndexPerSeverityEntry.setIndexNames(
    (0, "Dell-SYSLOG-MIB", "rlSyslogLastIndexPerSeverityIndex"),
)
if mibBuilder.loadTexts:
