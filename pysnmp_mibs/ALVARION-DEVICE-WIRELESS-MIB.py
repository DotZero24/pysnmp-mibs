...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-DEVICE-WIRELESS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:07:07 2025
...
_CoDevWirSNRLevelNotificationEnabled_Type.__name__ = "AlvarionNotificationEnable"
...
_CoDevWirAssociationNotificationEnabled_Type.__name__ = "AlvarionNotificationEnable"
...
alvarionDeviceWirelessMIBCompliance.setObjects(
      *(("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceWirelessConfigMIBGroup"),
        ("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceWirelessIfStatusMIBGroup"),
        ("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceWirelessIfStatsMIBGroup"),
        ("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceVscStatusMIBGroup"),
        ("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceVscStatsMIBGroup"),
        ("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceWirelessClientStatusMIBGroup"),
        ("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceWirelessClientStatsMIBGroup"),
        ("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceWirelessClientStatsRatesMIBGroup"),
        ("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceWirelessDetectedAPMIBGroup"),
        ("ALVARION-DEVICE-WIRELESS-MIB", "alvarionDeviceWirelessNotificationGroup"))
)
if mibBuilder.loadTexts:
