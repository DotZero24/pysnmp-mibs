...
AlvarionSSIDOrNone, AlvarionRadioType, AlvarionNotificationEnable = mibBuilder.importSymbols("ALVARION-TC", "AlvarionSSIDOrNone", "AlvarionRadioType", "AlvarionNotificationEnable")
...
mibBuilder.exportSymbols("ALVARION-DEVICE-WIRELESS-MIB", coDevWirCliStsPktsTxRate18=coDevWirCliStsPktsTxRate18, coDevWirCliStaPowerSavingMode=coDevWirCliStaPowerSavingMode, alvarionDeviceWirelessDetectedAPMIBGroup=alvarionDeviceWirelessDetectedAPMIBGroup, coDevWirCliStaTransmitRate=coDevWirCliStaTransmitRate, coDevWirVscStsTKIPCounterMeasure=coDevWirVscStsTKIPCounterMeasure, coDevWirIfStsTransmittedFragmentCount=coDevWirIfStsTransmittedFragmentCount, alvarionDeviceWirelessIfStatsMIBGroup=alvarionDeviceWirelessIfStatsMIBGroup, coDevWirCliStaIndex=coDevWirCliStaIndex, coDevWirCliStsPktsRxRate9=coDevWirCliStsPktsRxRate9, coDeviceWirelessDetectedAPGroup=coDeviceWirelessDetectedAPGroup, coDevWirSNRLevelNotificationEnabled=coDevWirSNRLevelNotificationEnabled, coDevWirCliStsPktsTxRate24=coDevWirCliStsPktsTxRate24, coDevWirApSSID=coDevWirApSSID, coDevWirApSecurity=coDevWirApSecurity, coDevWirVscStaCurrentNumberOfUsers=coDevWirVscStaCurrentNumberOfUsers, coDevWirCliStsPktsTxRate1=coDevWirCliStsPktsTxRate1, coDeviceWirelessVscStatusEntry=coDeviceWirelessVscStatusEntry, coDeviceWirelessDetectedAPEntry=coDeviceWirelessDetectedAPEntry, coDevWirVscStaAverageSNR=coDevWirVscStaAverageSNR, coDevWirApPHYType=coDevWirApPHYType, PYSNMP_MODULE_ID=alvarionDeviceWirelessMIB, coDevWirCliStsPktsRxRate5dot5=coDevWirCliStsPktsRxRate5dot5, coDevWirCliStaPreviousAPAddress=coDevWirCliStaPreviousAPAddress, alvarionDeviceWirelessMIBNotificationPrefix=alvarionDeviceWirelessMIBNotificationPrefix, alvarionDeviceWirelessClientStatsMIBGroup=alvarionDeviceWirelessClientStatsMIBGroup, coDeviceWirelessClientStatsTable=coDeviceWirelessClientStatsTable, coDevWirCliStsPktsTxRate6=coDevWirCliStsPktsTxRate6, coDeviceWirelessClientStatusTable=coDeviceWirelessClientStatusTable, coDeviceWirelessIfStatsGroup=coDeviceWirelessIfStatsGroup, coDevWirVscStsAESError=coDevWirVscStsAESError, coDevWirCliStaConnectTime=coDevWirCliStaConnectTime, coDevWirVscStsTKIPMICError=coDevWirVscStsTKIPMICError, coDevWirCliStsPktsTxRate12=coDevWirCliStsPktsTxRate12, coDevWirCliStsOutPkts=coDevWirCliStsOutPkts, coDevWirCliStsPktsRxRate24=coDevWirCliStsPktsRxRate24, coDeviceWirelessVscStatsGroup=coDeviceWirelessVscStatsGroup, coDevWirIfStsRTSFailureCount=coDevWirIfStsRTSFailureCount, coDevWirCliStsInOctets=coDevWirCliStsInOctets, coDeviceWirelessIfQosGroup=coDeviceWirelessIfQosGroup, coDeviceWirelessInterfaceStatsTable=coDeviceWirelessInterfaceStatsTable, coDevWirCliStaSignalLevel=coDevWirCliStaSignalLevel, coDevWirCliStsOutOctets=coDevWirCliStsOutOctets, alvarionDeviceWirelessMIBObjects=alvarionDeviceWirelessMIBObjects, coDevWirApSNR=coDevWirApSNR, coDeviceWirelessIfStatusGroup=coDeviceWirelessIfStatusGroup, coDeviceWirelessVscStatsEntry=coDeviceWirelessVscStatsEntry, coDeviceWirelessAssociationNotification=coDeviceWirelessAssociationNotification, coDeviceWirelessInterfaceStatusTable=coDeviceWirelessInterfaceStatusTable, coDevWirCliStsPktsRxRate1=coDevWirCliStsPktsRxRate1, coDevWirIfStaOperatingChannel=coDevWirIfStaOperatingChannel, coDeviceWirelessConfigGroup=coDeviceWirelessConfigGroup, coDeviceWirelessClientStatsRatesTable=coDeviceWirelessClientStatsRatesTable, coDevWirCliStsPktsRxRate36=coDevWirCliStsPktsRxRate36, coDevWirCliStsPktsRxRate18=coDevWirCliStsPktsRxRate18, coDevWirIfStsMultipleRetryCount=coDevWirIfStsMultipleRetryCount, coDevWirVscStaDefaultVLAN=coDevWirVscStaDefaultVLAN, coDevWirIfStaIfIndex=coDevWirIfStaIfIndex, coDevWirCliStaMACAddress=coDevWirCliStaMACAddress, coDevWirCliStaMACAuthenticated=coDevWirCliStaMACAuthenticated, coDevWirIfStaAutoPowerInterval=coDevWirIfStaAutoPowerInterval, alvarionDeviceWirelessMIBNotifications=alvarionDeviceWirelessMIBNotifications, coDevWirIfStsFailedCount=coDevWirIfStsFailedCount, coDevWirVscStsWEPICVError=coDevWirVscStsWEPICVError, coDevWirApSignalLevel=coDevWirApSignalLevel, coDevWirVscStaMscVscIndex=coDevWirVscStaMscVscIndex, coDevWirCliStaIpAddress=coDevWirCliStaIpAddress, coDevWirIfStaAutoPowerEnabled=coDevWirIfStaAutoPowerEnabled, coDevWirCliStaWME=coDevWirCliStaWME, coDevWirCliStaResetStats=coDevWirCliStaResetStats, coDevWirCliStsPktsTxRate36=coDevWirCliStsPktsTxRate36, alvarionDeviceVscStatsMIBGroup=alvarionDeviceVscStatsMIBGroup, coDeviceWirelessVscStatsTable=coDeviceWirelessVscStatsTable, coDevWirCliStaNoiseLevel=coDevWirCliStaNoiseLevel, alvarionDeviceWirelessClientStatusMIBGroup=alvarionDeviceWirelessClientStatusMIBGroup, coDevWirCliStsPktsRxRate2=coDevWirCliStsPktsRxRate2, coDevWirCliStsPktsRxRate54=coDevWirCliStsPktsRxRate54, coDevWirVscStsAESReplay=coDevWirVscStsAESReplay, coDevWirIfStaRadioMode=coDevWirIfStaRadioMode, coDeviceWirelessVscStatusGroup=coDeviceWirelessVscStatusGroup, coDevWirVscStaBSSID=coDevWirVscStaBSSID, coDevWirCliStaVLAN=coDevWirCliStaVLAN, coDevWirCliStsPktsTxRate54=coDevWirCliStsPktsTxRate54, coDeviceWirelessInterfaceStatusEntry=coDeviceWirelessInterfaceStatusEntry, coDevWirIfStaOperatingMode=coDevWirIfStaOperatingMode, coDevWirVscStaVscIndex=coDevWirVscStaVscIndex, coDevWirAssociationNotificationEnabled=coDevWirAssociationNotificationEnabled, coDevWirCliStsPktsRxRate48=coDevWirCliStsPktsRxRate48, alvarionDeviceVscStatusMIBGroup=alvarionDeviceVscStatusMIBGroup, coDevWirSNRLevelNotificationInterval=coDevWirSNRLevelNotificationInterval, coDevWirCliStaSNR=coDevWirCliStaSNR, coDevWirVscStaMaximumNumberOfUsers=coDevWirVscStaMaximumNumberOfUsers, coDevWirIfStaRadioOperState=coDevWirIfStaRadioOperState, coDeviceWirelessClientStatsEntry=coDeviceWirelessClientStatsEntry, alvarionDeviceWirelessMIBGroups=alvarionDeviceWirelessMIBGroups, coDevWirApNoiseLevel=coDevWirApNoiseLevel, coDeviceWirelessVscStatusTable=coDeviceWirelessVscStatusTable, alvarionDeviceWirelessConfigMIBGroup=alvarionDeviceWirelessConfigMIBGroup, coDevWirIfStaResetStats=coDevWirIfStaResetStats, coDevWirIfStaAutoChannelInterval=coDevWirIfStaAutoChannelInterval, alvarionDeviceWirelessIfStatusMIBGroup=alvarionDeviceWirelessIfStatusMIBGroup, coDevWirVscStsTKIPICVError=coDevWirVscStsTKIPICVError, coDevWirIfStaRadioType=coDevWirIfStaRadioType, coDevWirIfStsReceivedFragmentCount=coDevWirIfStsReceivedFragmentCount, alvarionDeviceWirelessMIBCompliances=alvarionDeviceWirelessMIBCompliances, coDevWirCliStsPktsTxRate11=coDevWirCliStsPktsTxRate11, coDeviceWirelessClientStatusEntry=coDeviceWirelessClientStatusEntry, coDevWirIfStaTransmitPower=coDevWirIfStaTransmitPower, coDevWirVscStsRxSecurityFilter=coDevWirVscStsRxSecurityFilter, coDevWirCliStaTrafficAuthorized=coDevWirCliStaTrafficAuthorized, coDevWirCliStsPktsRxRate12=coDevWirCliStsPktsRxRate12, coDevWirCliStsPktsTxRate9=coDevWirCliStsPktsTxRate9, coDevWirIfStsMulticastTransmittedFrameCount=coDevWirIfStsMulticastTransmittedFrameCount, coDevWirApIndex=coDevWirApIndex, coDevWirVscStsTKIPReplay=coDevWirVscStsTKIPReplay, coDevWirIfStaNumberOfClient=coDevWirIfStaNumberOfClient, alvarionDeviceWirelessMIBCompliance=alvarionDeviceWirelessMIBCompliance, coDevWirApRadioIndex=coDevWirApRadioIndex, coDevWirApChannel=coDevWirApChannel, coDevWirCliStsPktsTxRate5dot5=coDevWirCliStsPktsTxRate5dot5, coDevWirIfStsRetryCount=coDevWirIfStsRetryCount, coDevWirVscStaResetStats=coDevWirVscStaResetStats, coDevWirIfStaRadioIndex=coDevWirIfStaRadioIndex, coDeviceWirelessDetectedAPTable=coDeviceWirelessDetectedAPTable, coDeviceWirelessClientStatusGroup=coDeviceWirelessClientStatusGroup, coDevWirIfStsRTSSuccessCount=coDevWirIfStsRTSSuccessCount, coDevWirIfStsMulticastReceivedFrameCount=coDevWirIfStsMulticastReceivedFrameCount, alvarionDeviceWirelessClientStatsRatesMIBGroup=alvarionDeviceWirelessClientStatsRatesMIBGroup, coDevWirCliStaWPAType=coDevWirCliStaWPAType, coDeviceWirelessClientRatesGroup=coDeviceWirelessClientRatesGroup, coDevWirCliStsPktsTxRate2=coDevWirCliStsPktsTxRate2, coDevWirIfStaAutoChannelEnabled=coDevWirIfStaAutoChannelEnabled, coDevWirIfStsFCSErrorCount=coDevWirIfStsFCSErrorCount, coDevWirCliStsPktsRxRate11=coDevWirCliStsPktsRxRate11, coDevWirCliStaReceiveRate=coDevWirCliStaReceiveRate, alvarionDeviceWirelessMIB=alvarionDeviceWirelessMIB, coDevWirCliStaPhyType=coDevWirCliStaPhyType, alvarionDeviceWirelessMIBConformance=alvarionDeviceWirelessMIBConformance, coDeviceWirelessClientStatsRatesEntry=coDeviceWirelessClientStatsRatesEntry, coDevWirCliStaVscIndex=coDevWirCliStaVscIndex, coDevWirCliStsInPkts=coDevWirCliStsInPkts, coDevWirMinimumSNRLevel=coDevWirMinimumSNRLevel, alvarionDeviceWirelessNotificationGroup=alvarionDeviceWirelessNotificationGroup, coDeviceWirelessInterfaceStatsEntry=coDeviceWirelessInterfaceStatsEntry, coDeviceWirelessSNRLevelNotification=coDeviceWirelessSNRLevelNotification, coDevWirApBSSID=coDevWirApBSSID, coDevWirCliSta8021xAuthenticated=coDevWirCliSta8021xAuthenticated, coDevWirCliStaMACFiltered=coDevWirCliStaMACFiltered, coDeviceWirelessClientStatsGroup=coDeviceWirelessClientStatsGroup, coDevWirIfStsACKFailureCount=coDevWirIfStsACKFailureCount, coDevWirCliStsPktsTxRate48=coDevWirCliStsPktsTxRate48, coDevWirIfStsFrameDuplicateCount=coDevWirIfStsFrameDuplicateCount, coDevWirVscStsWEPExcluded=coDevWirVscStsWEPExcluded, coDevWirVscStsTxSecurityFilter=coDevWirVscStsTxSecurityFilter, coDevWirCliStsPktsRxRate6=coDevWirCliStsPktsRxRate6)
