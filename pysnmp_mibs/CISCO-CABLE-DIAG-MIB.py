...
mibBuilder.exportSymbols("CISCO-CABLE-DIAG-MIB", ccdTdrObjects=ccdTdrObjects, ciscoCableDiagMIBConform=ciscoCableDiagMIBConform, ccdTdrIfResultTable=ccdTdrIfResultTable, ccdTdrIfResultPairStatus=ccdTdrIfResultPairStatus, ccdPrbsIfTestErrorsMaxValue=ccdPrbsIfTestErrorsMaxValue, ccdTdrIfAction=ccdTdrIfAction, ccdTdrIfResultPairLengthUnit=ccdTdrIfResultPairLengthUnit, ccdPrbsGroup=ccdPrbsGroup, ccdPrbsIfTestErrorsResetTime=ccdPrbsIfTestErrorsResetTime, ccdTdrIfEntry=ccdTdrIfEntry, ccdTdrIfResultPairIndex=ccdTdrIfResultPairIndex, ciscoCableDiagMIBGroups=ciscoCableDiagMIBGroups, ciscoCableDiagMIB=ciscoCableDiagMIB, ccdTdrIfActionStatus=ccdTdrIfActionStatus, ccdTdrIfResultPairDistToFault=ccdTdrIfResultPairDistToFault, ccdTdrIfResultPairLenAccuracy=ccdTdrIfResultPairLenAccuracy, ciscoCableDiagMIBCompliances=ciscoCableDiagMIBCompliances, ccdTdrIfResultValid=ccdTdrIfResultValid, ccdTdrIfResultPairLength=ccdTdrIfResultPairLength, ccdTdrIfTable=ccdTdrIfTable, ccdTdrGroup=ccdTdrGroup, ccdPrbsIfActionStatus=ccdPrbsIfActionStatus, ccdTdrIfLastTestTime=ccdTdrIfLastTestTime, ciscoCableDiagMIBNotifs=ciscoCableDiagMIBNotifs, ccdPrbsIfAction=ccdPrbsIfAction, PYSNMP_MODULE_ID=ciscoCableDiagMIB, ccdPrbsIfTable=ccdPrbsIfTable, ccdPrbsIfEntry=ccdPrbsIfEntry, ccdTdrIfResultPairChannel=ccdTdrIfResultPairChannel, ccdTdrIfResultPairDistAccuracy=ccdTdrIfResultPairDistAccuracy, ciscoCableDiagMIBComplianceRev1=ciscoCableDiagMIBComplianceRev1, ccdTdrIfResultEntry=ccdTdrIfResultEntry, ciscoCableDiagMIBObjects=ciscoCableDiagMIBObjects, ccdPrbsObjects=ccdPrbsObjects, ccdPrbsIfTestErrors=ccdPrbsIfTestErrors)
