...
# Produced by pysmi-1.6.2 at Fri Oct 10 19:22:20 2025
...
forwardAddrUSMUserName = _ForwardAddrUSMUserName_Object(
    (1, 3, 6, 1, 4, 1, 34774, 4, 1, 2, 1, 1, 8),
    _ForwardAddrUSMUserName_Type()
)
forwardAddrUSMUserName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    forwardAddrUSMUserName.setStatus("current")
...
currentObjectGroup.setObjects(
      *(("ISM-TRAP-MIB", "forwardAddrIndex"),
        ...
        ("ISM-TRAP-MIB", "forwardAddrUSMUserName"),
...
mibBuilder.exportSymbols(
    ...
    **{"NodeCodeString": NodeCodeString,
       ...
       "forwardAddrUSMUserName": forwardAddrUSMUserName,
       "event": event,
