_i='boxsTemperatureStatusPreviousEvent'
_h='boxsTemperatureStatusCurrentEvent'
_g='boxServicesThermalShutdownTemperature'
_f='boxServicesThermalShutdownSensor'
_e='boxsTemperatureChangeEvent'
_d='obsolete'
_c='boxServicesUnitIndex'
_b='boxServicesPowerSuppUnitIndex'
_a='incompatible'
_Z='notpowering'
_Y='nopower'
_X='powering'
...
_E='read-write'
_D='Integer32'
_C='EdgeSwitch-BOXSERVICES-PRIVATE-MIB'
_B='read-only'
_A='current'
...
boxServicesNormalTempRangeMin.setMaxAccess(_B)
...
boxServicesNormalTempRangeMax.setMaxAccess(_B)
...
boxServicesFansEntry.setIndexNames((0,_C,_U),(0,_C,_J))
...
boxServicesFanUnitIndex=_BoxServicesFanUnitIndex_Object((1,3,6,1,4,1,4413,1,1,43,1,6,1,6),_BoxServicesFanUnitIndex_Type())
...
boxServicesPowSuppliesEntry.setIndexNames((0,_C,_b),(0,_C,_Q))
...
boxServicesPowerSuppUnitIndex=_BoxServicesPowerSuppUnitIndex_Object((1,3,6,1,4,1,4413,1,1,43,1,7,1,4),_BoxServicesPowerSuppUnitIndex_Type())
...
boxServicesTempSensorsEntry.setIndexNames((0,_C,_c),(0,_C,_R))
...
boxServicesUnitIndex=_BoxServicesUnitIndex_Object((1,3,6,1,4,1,4413,1,1,43,1,8,1,1),_BoxServicesUnitIndex_Type())
...
boxServicesTempSensorIndex=_BoxServicesTempSensorIndex_Object((1,3,6,1,4,1,4413,1,1,43,1,8,1,2),_BoxServicesTempSensorIndex_Type())
...
boxServicesTempSensorType=_BoxServicesTempSensorType_Object((1,3,6,1,4,1,4413,1,1,43,1,8,1,3),_BoxServicesTempSensorType_Type())
...
boxServicesTempSensorState=_BoxServicesTempSensorState_Object((1,3,6,1,4,1,4413,1,1,43,1,8,1,4),_BoxServicesTempSensorState_Type())
boxServicesTempSensorState.setMaxAccess(_B)
if mibBuilder.loadTexts:boxServicesTempSensorState.setStatus(_d)
_BoxServicesTempSensorTemperature_Type=Integer32
_BoxServicesTempSensorTemperature_Object=MibTableColumn
boxServicesTempSensorTemperature=_BoxServicesTempSensorTemperature_Object((1,3,6,1,4,1,4413,1,1,43,1,8,1,5),_BoxServicesTempSensorTemperature_Type())
...
boxServicesThermalShutdownSensor=_BoxServicesThermalShutdownSensor_Object((1,3,6,1,4,1,4413,1,1,43,1,13),_BoxServicesThermalShutdownSensor_Type())
...
boxServicesThermalShutdownTemperature=_BoxServicesThermalShutdownTemperature_Object((1,3,6,1,4,1,4413,1,1,43,1,14),_BoxServicesThermalShutdownTemperature_Type())
...
boxServicesTempUnitTable=_BoxServicesTempUnitTable_Object((1,3,6,1,4,1,4413,1,1,43,1,15))
if mibBuilder.loadTexts:boxServicesTempUnitTable.setStatus(_A)
_BoxServicesTempUnitEntry_Object=MibTableRow
boxServicesTempUnitEntry=_BoxServicesTempUnitEntry_Object((1,3,6,1,4,1,4413,1,1,43,1,15,1))
boxServicesTempUnitEntry.setIndexNames((0,_C,_S))
...
boxServicesTempUnitIndex=_BoxServicesTempUnitIndex_Object((1,3,6,1,4,1,4413,1,1,43,1,15,1,1),_BoxServicesTempUnitIndex_Type())
...
boxServicesTempUnitState=_BoxServicesTempUnitState_Object((1,3,6,1,4,1,4413,1,1,43,1,15,1,2),_BoxServicesTempUnitState_Type())
...
boxServicesTempUnitTemperature=_BoxServicesTempUnitTemperature_Object((1,3,6,1,4,1,4413,1,1,43,1,15,1,3),_BoxServicesTempUnitTemperature_Type())
...
boxsTemperatureStatusCurrentEvent=_BoxsTemperatureStatusCurrentEvent_Object((1,3,6,1,4,1,4413,1,1,43,2,3),_BoxsTemperatureStatusCurrentEvent_Type())
...
boxsTemperatureStatusPreviousEvent=_BoxsTemperatureStatusPreviousEvent_Object((1,3,6,1,4,1,4413,1,1,43,2,4),_BoxsTemperatureStatusPreviousEvent_Type())
...
boxsLocatorLedConfigGroup=_BoxsLocatorLedConfigGroup_ObjectIdentity((1,3,6,1,4,1,4413,1,1,43,4))
_BoxsLocatorLedUnit_Type=Integer32
_BoxsLocatorLedUnit_Object=MibScalar
boxsLocatorLedUnit=_BoxsLocatorLedUnit_Object((1,3,6,1,4,1,4413,1,1,43,4,1),_BoxsLocatorLedUnit_Type())
...
boxsLocatorLedTime=_BoxsLocatorLedTime_Object((1,3,6,1,4,1,4413,1,1,43,4,2),_BoxsLocatorLedTime_Type())
...
boxsLocatorLedEnable=_BoxsLocatorLedEnable_Object((1,3,6,1,4,1,4413,1,1,43,4,3),_BoxsLocatorLedEnable_Type())
...
boxsFanStateChange.setObjects(*((_C,_J),(_C,_T)))
...
boxsPowSupplyStateChange.setObjects(*((_C,_Q),(_C,_T)))
...
boxsTemperatureChange.setObjects(*((_C,_R),(_C,_e)))
if mibBuilder.loadTexts:boxsTemperatureChange.setStatus(_d)
boxsThermalShutdown=NotificationType((1,3,6,1,4,1,4413,1,1,43,0,4))
boxsThermalShutdown.setObjects(*((_C,_f),(_C,_g)))
if mibBuilder.loadTexts:boxsThermalShutdown.setStatus(_A)
boxsTemperatureStateChange=NotificationType((1,3,6,1,4,1,4413,1,1,43,0,5))
boxsTemperatureStateChange.setObjects(*((_C,_S),(_C,_h),(_C,_i)))
if mibBuilder.loadTexts:boxsTemperatureStateChange.setStatus(_A)
mibBuilder.exportSymbols(_C,**{'BoxsTemperatureStatus':BoxsTemperatureStatus,'fastPathBoxServices':fastPathBoxServices,'fastPathBoxServicesTraps':fastPathBoxServicesTraps,'boxsFanStateChange':boxsFanStateChange,'boxsPowSupplyStateChange':boxsPowSupplyStateChange,'boxsTemperatureChange':boxsTemperatureChange,'boxsThermalShutdown':boxsThermalShutdown,'boxsTemperatureStateChange':boxsTemperatureStateChange,'boxServicesGroup':boxServicesGroup,'boxServicesNormalTempRangeMin':boxServicesNormalTempRangeMin,'boxServicesNormalTempRangeMax':boxServicesNormalTempRangeMax,'boxServicesTemperatureTrapEnable':boxServicesTemperatureTrapEnable,'boxServicesPSMStateTrapEnable':boxServicesPSMStateTrapEnable,'boxServicesFanStateTrapEnable':boxServicesFanStateTrapEnable,'boxServicesFansTable':boxServicesFansTable,'boxServicesFansEntry':boxServicesFansEntry,_J:boxServicesFansIndex,'boxServicesFanItemType':boxServicesFanItemType,'boxServicesFanItemState':boxServicesFanItemState,'boxServicesFanSpeed':boxServicesFanSpeed,'boxServicesFanDutyLevel':boxServicesFanDutyLevel,_U:boxServicesFanUnitIndex,'boxServicesPowSuppliesTable':boxServicesPowSuppliesTable,'boxServicesPowSuppliesEntry':boxServicesPowSuppliesEntry,_Q:boxServicesPowSupplyIndex,'boxServicesPowSupplyItemType':boxServicesPowSupplyItemType,'boxServicesPowSupplyItemState':boxServicesPowSupplyItemState,_b:boxServicesPowerSuppUnitIndex,'boxServicesTempSensorsTable':boxServicesTempSensorsTable,'boxServicesTempSensorsEntry':boxServicesTempSensorsEntry,_c:boxServicesUnitIndex,_R:boxServicesTempSensorIndex,'boxServicesTempSensorType':boxServicesTempSensorType,'boxServicesTempSensorState':boxServicesTempSensorState,'boxServicesTempSensorTemperature':boxServicesTempSensorTemperature,_f:boxServicesThermalShutdownSensor,_g:boxServicesThermalShutdownTemperature,'boxServicesTempUnitTable':boxServicesTempUnitTable,'boxServicesTempUnitEntry':boxServicesTempUnitEntry,_S:boxServicesTempUnitIndex,'boxServicesTempUnitState':boxServicesTempUnitState,'boxServicesTempUnitTemperature':boxServicesTempUnitTemperature,'boxServicesNotificationsGroup':boxServicesNotificationsGroup,_T:boxsItemStateChangeEvent,_e:boxsTemperatureChangeEvent,_h:boxsTemperatureStatusCurrentEvent,_i:boxsTemperatureStatusPreviousEvent,'boxsLocatorLedConfigGroup':boxsLocatorLedConfigGroup,'boxsLocatorLedUnit':boxsLocatorLedUnit,'boxsLocatorLedTime':boxsLocatorLedTime,'boxsLocatorLedEnable':boxsLocatorLedEnable})