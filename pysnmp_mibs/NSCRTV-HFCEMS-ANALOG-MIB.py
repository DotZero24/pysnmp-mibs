# SNMP MIB module (NSCRTV-HFCEMS-ANALOG-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/nscrtv/NSCRTV-HFCEMS-ANALOG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:21:42 2025
...
analogPropertyEntry.setIndexNames(
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "analogParameterOID"),
)
if mibBuilder.loadTexts:
...
discretePropertyEntry.setIndexNames(
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "discreteParameterOID"),
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "discreteAlarmValue"),
)
if mibBuilder.loadTexts:
...
currentAlarmEntry.setIndexNames(
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "currentAlarmOID"),
)
if mibBuilder.loadTexts:
...
alarmLogEntry.setIndexNames(
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "alarmLogIndex"),
)
if mibBuilder.loadTexts:
...
commonMulticastAddressEntry.setIndexNames(
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "commonMulticastAddressIndex"),
)
if mibBuilder.loadTexts:
...
commonAgentTrapEntry.setIndexNames(
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "commonAgentTrapIndex"),
)
if mibBuilder.loadTexts:
...
commonDeviceInfoEntry.setIndexNames(
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "commonDeviceSlot"),
)
if mibBuilder.loadTexts:
...
oswIdent = _OswIdent_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15)
)
_OswVendorOID_Type = ObjectIdentifier
_OswVendorOID_Object = MibScalar
oswVendorOID = _OswVendorOID_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 1),
    _OswVendorOID_Type()
)
oswVendorOID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswVendorOID.setStatus("optional")


class _OswMode_Type(Integer32):
    """Custom type oswMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_OswMode_Type.__name__ = "Integer32"
_OswMode_Object = MibScalar
oswMode = _OswMode_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 2),
    _OswMode_Type()
)
oswMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    oswMode.setStatus("mandatory")


class _OswSwitch_Type(Integer32):
    """Custom type oswSwitch based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_OswSwitch_Type.__name__ = "Integer32"
_OswSwitch_Object = MibScalar
oswSwitch = _OswSwitch_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 3),
    _OswSwitch_Type()
)
oswSwitch.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    oswSwitch.setStatus("mandatory")
_OswChannelTable_Object = MibTable
oswChannelTable = _OswChannelTable_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 4)
)
if mibBuilder.loadTexts:
    oswChannelTable.setStatus("mandatory")
_OswChannelEntry_Object = MibTableRow
oswChannelEntry = _OswChannelEntry_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 4, 1)
)
oswChannelEntry.setIndexNames(
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "oswIndex"),
)
if mibBuilder.loadTexts:
    oswChannelEntry.setStatus("mandatory")
_OswUnitTemp_Type = Integer32
_OswUnitTemp_Object = MibTableColumn
oswUnitTemp = _OswUnitTemp_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 4, 1, 1),
    _OswUnitTemp_Type()
)
oswUnitTemp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswUnitTemp.setStatus("mandatory")


class _OswInputA_Type(Integer32):
    """Custom type oswInputA based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-128, 127),
    )
...
_OswInputA_Type.__name__ = "Integer32"
_OswInputA_Object = MibTableColumn
oswInputA = _OswInputA_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 4, 1, 2),
    _OswInputA_Type()
)
oswInputA.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswInputA.setStatus("mandatory")


class _OswInputB_Type(Integer32):
    """Custom type oswInputB based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-128, 127),
    )
...
_OswInputB_Type.__name__ = "Integer32"
_OswInputB_Object = MibTableColumn
oswInputB = _OswInputB_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 4, 1, 3),
    _OswInputB_Type()
)
oswInputB.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswInputB.setStatus("mandatory")


class _OswOutput1_Type(Integer32):
    """Custom type oswOutput1 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_OswOutput1_Type.__name__ = "Integer32"
_OswOutput1_Object = MibTableColumn
oswOutput1 = _OswOutput1_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 4, 1, 4),
    _OswOutput1_Type()
)
oswOutput1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswOutput1.setStatus("mandatory")


class _OswOutput2_Type(Integer32):
    """Custom type oswOutput2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_OswOutput2_Type.__name__ = "Integer32"
_OswOutput2_Object = MibTableColumn
oswOutput2 = _OswOutput2_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 4, 1, 5),
    _OswOutput2_Type()
)
oswOutput2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswOutput2.setStatus("mandatory")


class _OswNumberDCPowerSupply_Type(Integer32):
    """Custom type oswNumberDCPowerSupply based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_OswNumberDCPowerSupply_Type.__name__ = "Integer32"
_OswNumberDCPowerSupply_Object = MibScalar
oswNumberDCPowerSupply = _OswNumberDCPowerSupply_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 5),
    _OswNumberDCPowerSupply_Type()
)
oswNumberDCPowerSupply.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswNumberDCPowerSupply.setStatus("mandatory")


class _OswDCPowerSupplyMode_Type(Integer32):
    """Custom type oswDCPowerSupplyMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_OswDCPowerSupplyMode_Type.__name__ = "Integer32"
_OswDCPowerSupplyMode_Object = MibScalar
oswDCPowerSupplyMode = _OswDCPowerSupplyMode_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 6),
    _OswDCPowerSupplyMode_Type()
)
oswDCPowerSupplyMode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswDCPowerSupplyMode.setStatus("optional")
_OswDCPowerTable_Object = MibTable
oswDCPowerTable = _OswDCPowerTable_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 7)
)
if mibBuilder.loadTexts:
    oswDCPowerTable.setStatus("mandatory")
_OswDCPowerEntry_Object = MibTableRow
oswDCPowerEntry = _OswDCPowerEntry_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 7, 1)
)
oswDCPowerEntry.setIndexNames(
    (0, "NSCRTV-HFCEMS-ANALOG-MIB", "oswDCPowerIndex"),
)
if mibBuilder.loadTexts:
    oswDCPowerEntry.setStatus("mandatory")
_OswDCPowerIndex_Type = Integer32
_OswDCPowerIndex_Object = MibTableColumn
oswDCPowerIndex = _OswDCPowerIndex_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 7, 1, 1),
    _OswDCPowerIndex_Type()
)
oswDCPowerIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswDCPowerIndex.setStatus("mandatory")


class _OswDCPowerVoltage_Type(Integer32):
    """Custom type oswDCPowerVoltage based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_OswDCPowerVoltage_Type.__name__ = "Integer32"
_OswDCPowerVoltage_Object = MibTableColumn
oswDCPowerVoltage = _OswDCPowerVoltage_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 7, 1, 2),
    _OswDCPowerVoltage_Type()
)
oswDCPowerVoltage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswDCPowerVoltage.setStatus("mandatory")


class _OswDCPowerCurrent_Type(Integer32):
    """Custom type oswDCPowerCurrent based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_OswDCPowerCurrent_Type.__name__ = "Integer32"
_OswDCPowerCurrent_Object = MibTableColumn
oswDCPowerCurrent = _OswDCPowerCurrent_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 7, 1, 3),
    _OswDCPowerCurrent_Type()
)
oswDCPowerCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswDCPowerCurrent.setStatus("mandatory")
_OswDCPowerName_Type = DisplayString
_OswDCPowerName_Object = MibTableColumn
oswDCPowerName = _OswDCPowerName_Object(
    (1, 3, 6, 1, 4, 1, 17409, 1, 15, 7, 1, 4),
    _OswDCPowerName_Type()
)
oswDCPowerName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    oswDCPowerName.setStatus("mandatory")
...
hfcColdStart.setObjects(
      *(("NSCRTV-HFCEMS-ANALOG-MIB", "commonPhysAddress"),
        ("NSCRTV-HFCEMS-ANALOG-MIB", "commonNELogicalID"))
)
if mibBuilder.loadTexts:
...
hfcAlarmEvent.setObjects(
      *(("NSCRTV-HFCEMS-ANALOG-MIB", "commonPhysAddress"),
        ("NSCRTV-HFCEMS-ANALOG-MIB", "commonNELogicalID"),
        ("NSCRTV-HFCEMS-ANALOG-MIB", "alarmLogInformation"),
        ("NSCRTV-HFCEMS-ANALOG-MIB", "alarmText"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"nscrtvRoot": nscrtvRoot,
       ...
       "oswIdent": oswIdent,
       "oswVendorOID": oswVendorOID,
       "oswMode": oswMode,
       "oswSwitch": oswSwitch,
       "oswChannelTable": oswChannelTable,
       "oswChannelEntry": oswChannelEntry,
       "oswUnitTemp": oswUnitTemp,
       "oswInputA": oswInputA,
       "oswInputB": oswInputB,
       "oswOutput1": oswOutput1,
       "oswOutput2": oswOutput2,
       "oswNumberDCPowerSupply": oswNumberDCPowerSupply,
       "oswDCPowerSupplyMode": oswDCPowerSupplyMode,
       "oswDCPowerTable": oswDCPowerTable,
       "oswDCPowerEntry": oswDCPowerEntry,
       "oswDCPowerIndex": oswDCPowerIndex,
       "oswDCPowerVoltage": oswDCPowerVoltage,
       "oswDCPowerCurrent": oswDCPowerCurrent,
       "oswDCPowerName": oswDCPowerName}
)
