...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-EPM-NOTIFICATION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:42:00 2025
...
ciscoEpmNotificationMIBCompliance.setObjects(
      *(("CISCO-EPM-NOTIFICATION-MIB", "ciscoEpmNotificationObjectsGroup"),
        ("CISCO-EPM-NOTIFICATION-MIB", "ciscoEpmNotificationAlarmGroup"),
        ("CISCO-EPM-NOTIFICATION-MIB", "ciscoEpmAlarmConfigGroup"))
)
if mibBuilder.loadTexts:
...
ciscoEpmNotificationMIBComplianceRev1.setObjects(
      *(("CISCO-EPM-NOTIFICATION-MIB", "ciscoEpmNotificationObjectsGroupRev1"),
        ("CISCO-EPM-NOTIFICATION-MIB", "ciscoEpmNotificationAlarmGroupRev1"),
        ("CISCO-EPM-NOTIFICATION-MIB", "ciscoEpmAlarmConfigGroup"))
)
if mibBuilder.loadTexts:
