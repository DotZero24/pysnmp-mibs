...
mibBuilder.exportSymbols("MIMOSA-NETWORKS-PTMP-MIB", mimosaPtmpClientAssociatedTime=mimosaPtmpClientAssociatedTime, mimosaPtmpApStatsRxBytes=mimosaPtmpApStatsRxBytes, mimosaPtmpChannelExclusionEnd=mimosaPtmpChannelExclusionEnd, mimosaPtmpClientAssocBW=mimosaPtmpClientAssocBW, mimosaPtmpChannelExclusionTable=mimosaPtmpChannelExclusionTable, mimosaPtmpClientIPAddress=mimosaPtmpClientIPAddress, mimosaPtmpMgmtVlanId=mimosaPtmpMgmtVlanId, mimosaPtmpClientInfoEntry=mimosaPtmpClientInfoEntry, mimosaPtmpChPwrTxPowerCur=mimosaPtmpChPwrTxPowerCur, mimosaPtmpChPwrPrimChannelCur=mimosaPtmpChPwrPrimChannelCur, mimosaPtmpMgmtInfo=mimosaPtmpMgmtInfo, mimosaPtmpAutoChannelEnabled=mimosaPtmpAutoChannelEnabled, mimosaPtmpMgmtIpAddress=mimosaPtmpMgmtIpAddress, mimosaPtmpChannelPower=mimosaPtmpChannelPower, mimosaPtmpSsidEnabled=mimosaPtmpSsidEnabled, mimosaPtmpSsidTable=mimosaPtmpSsidTable, mimosaPtmpChannelPowerEntry=mimosaPtmpChannelPowerEntry, mimosaPtmpClientInfoTable=mimosaPtmpClientInfoTable, mimosaPtmpChPwrChWidthCfg=mimosaPtmpChPwrChWidthCfg, mimosaPtmpMgmtIpNetmask=mimosaPtmpMgmtIpNetmask, mimosaPtmpClientStatsTable=mimosaPtmpClientStatsTable, mimosaPtmpWirelessTrafficSplit=mimosaPtmpWirelessTrafficSplit, mimosaPtmpChannelExclusionEntry=mimosaPtmpChannelExclusionEntry, mimosaPtmpClientStatsGroup=mimosaPtmpClientStatsGroup, mimosaPtmpChannelPowerGroup=mimosaPtmpChannelPowerGroup, mimosaPtmpChPwrCntrFreqCur=mimosaPtmpChPwrCntrFreqCur, mimosaPtmpClientInfoMacAddress=mimosaPtmpClientInfoMacAddress, mimosaPtmpMgmtEthernetMac=mimosaPtmpMgmtEthernetMac, mimosaPtmpSsidType=mimosaPtmpSsidType, mimosaPtmpClientStatsEntry=mimosaPtmpClientStatsEntry, mimosaPtmpClientPlanName=mimosaPtmpClientPlanName, mimosaPtmpClientInfoIndex=mimosaPtmpClientInfoIndex, mimosaPtmpSsidIndex=mimosaPtmpSsidIndex, mimosaPtmpChPwrMinRxPower=mimosaPtmpChPwrMinRxPower, mimosaPtmp=mimosaPtmp, mimosaPtmpApStatsRxPkts=mimosaPtmpApStatsRxPkts, mimosaPtmpClientInfoLastUpdated=mimosaPtmpClientInfoLastUpdated, mimosaPtmpMgmtVlanPassthrough=mimosaPtmpMgmtVlanPassthrough, mimosaPtmpClientRxBytes=mimosaPtmpClientRxBytes, mimosaPtmpMgmtSecondaryDNS=mimosaPtmpMgmtSecondaryDNS, mimosaPtmpLinkInfoGroup=mimosaPtmpLinkInfoGroup, mimosaPtmpApStatsTxPer=mimosaPtmpApStatsTxPer, mimosaPtmpMgmtIpGateway=mimosaPtmpMgmtIpGateway, mimosaPtmpChannelPowerTable=mimosaPtmpChannelPowerTable, mimosaPtmpCompliances=mimosaPtmpCompliances, mimosaPtmpClientDlPeak=mimosaPtmpClientDlPeak, mimosaPtmpChannelExclusionStart=mimosaPtmpChannelExclusionStart, mimosaPtmpSsidGroup=mimosaPtmpSsidGroup, mimosaPtmpSsidEntry=mimosaPtmpSsidEntry, mimosaPtmpAntennaGain=mimosaPtmpAntennaGain, mimosaPtmpChPwrAgcMode=mimosaPtmpChPwrAgcMode, mimosaPtmpClientTxPhyRate=mimosaPtmpClientTxPhyRate, mimosaPtmpWirelessWindowLength=mimosaPtmpWirelessWindowLength, mimosaPtmpApStatsTxBytes=mimosaPtmpApStatsTxBytes, mimosaPtmpClientInfo=mimosaPtmpClientInfo, mimosaPtmpChPwrPrimChannelCfg=mimosaPtmpChPwrPrimChannelCfg, mimosaPtmpApStatsLastUpdated=mimosaPtmpApStatsLastUpdated, mimosaPtmpClientName=mimosaPtmpClientName, mimosaPtmpChPwrRadioIndex=mimosaPtmpChPwrRadioIndex, mimosaPtmpClientStats=mimosaPtmpClientStats, mimosaPtmpClientStatsLastUpdated=mimosaPtmpClientStatsLastUpdated, mimosaPtmpLinkInfo=mimosaPtmpLinkInfo, mimosaPtmpChPwrRadioName=mimosaPtmpChPwrRadioName, mimosaPtmpClientInfoGroup=mimosaPtmpClientInfoGroup, mimosaPtmpChPwrCntrFreqCfg=mimosaPtmpChPwrCntrFreqCfg, mimosaPtmpSsidName=mimosaPtmpSsidName, mimosaPtmpClientTxAvgPer=mimosaPtmpClientTxAvgPer, mimosaPtmpClientStatsMacAddress=mimosaPtmpClientStatsMacAddress, mimosaPtmpSsidBroadcastEnabled=mimosaPtmpSsidBroadcastEnabled, mimosaPtmpClientRxPkts=mimosaPtmpClientRxPkts, mimosaPtmpClientStatsIndex=mimosaPtmpClientStatsIndex, mimosaPtmpWirelessMode=mimosaPtmpWirelessMode, mimosaPtmpClientDlCommitted=mimosaPtmpClientDlCommitted, PYSNMP_MODULE_ID=mimosaPtmp, mimosaPtmpSsid=mimosaPtmpSsid, mimosaPtmpWirelessGender=mimosaPtmpWirelessGender, mimosaPtmpClientFWVersion=mimosaPtmpClientFWVersion, mimosaPtmpClientRxPhyRate=mimosaPtmpClientRxPhyRate, mimosaPtmpApStatsTxPkts=mimosaPtmpApStatsTxPkts, mimosaPtmpClientUlPeak=mimosaPtmpClientUlPeak, mimosaPtmpChPwrChWidthCur=mimosaPtmpChPwrChWidthCur, mimosaPtmpSsidIsolationEnabled=mimosaPtmpSsidIsolationEnabled, mimosaPtmpApStatsGroup=mimosaPtmpApStatsGroup, mimosaPtmpConformance=mimosaPtmpConformance, mimosaPtmpMgmtIpMode=mimosaPtmpMgmtIpMode, mimosaPtmpClientTxPkts=mimosaPtmpClientTxPkts, mimosaPtmpGroups=mimosaPtmpGroups, mimosaPtmpChannelExclusionIndex=mimosaPtmpChannelExclusionIndex, mimosaPtmpClientRssiAvg=mimosaPtmpClientRssiAvg, mimosaPtmpClientUlCommitted=mimosaPtmpClientUlCommitted, mimosaPtmpMgmtVlanStatus=mimosaPtmpMgmtVlanStatus, mimosaPtmpChPwrTxPowerCfg=mimosaPtmpChPwrTxPowerCfg, mimosaPtmpMgmtInfoGroup=mimosaPtmpMgmtInfoGroup, mimosaPtmpCompliance=mimosaPtmpCompliance, mimosaPtmpApStats=mimosaPtmpApStats, mimosaPtmpClientTxBytes=mimosaPtmpClientTxBytes, mimosaPtmpMgmtPrimaryDNS=mimosaPtmpMgmtPrimaryDNS)
