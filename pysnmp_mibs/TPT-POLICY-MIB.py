...
mibBuilder.exportSymbols("TPT-POLICY-MIB", tptPolicyNotifySslInspCert=tptPolicyNotifySslInspCert, alertsByZoneEntry=alertsByZoneEntry, policyHitCount=policyHitCount, alertsByProtocolTable=alertsByProtocolTable, tptPolicyNotifyDestNetPort=tptPolicyNotifyDestNetPort, tptPolicyNotifyAlertType=tptPolicyNotifyAlertType, tptPolicyLogNotifyNumber=tptPolicyLogNotifyNumber, policyPacketsPermitted=policyPacketsPermitted, tptPolicyNotifyTraceBucket=tptPolicyNotifyTraceBucket, policyPacketsDropped=policyPacketsDropped, policyPacketsTrusted64=policyPacketsTrusted64, topTenHitsByPolicyTable=topTenHitsByPolicyTable, p2pSlot=p2pSlot, permitsByZoneEntry=permitsByZoneEntry, PolicyFrameSize=PolicyFrameSize, policyPacketsOutgoing64=policyPacketsOutgoing64, szpInPackets=szpInPackets, policyPacketsOutgoing=policyPacketsOutgoing, policyPacketsBlocked=policyPacketsBlocked, tpt_policy=tpt_policy, packetsByProtocolEntry=packetsByProtocolEntry, policyPacketsBlocked64=policyPacketsBlocked64, tptPolicyNotifySignatureID=tptPolicyNotifySignatureID, tptPolicyNotifyMetadata=tptPolicyNotifyMetadata, tptPolicyNotifySslInspPolicy=tptPolicyNotifySslInspPolicy, alertsByProtocolEntry=alertsByProtocolEntry, tptPolicyNotifyDestNetAddrV6=tptPolicyNotifyDestNetAddrV6, tptPolicyNotifyVlanTag=tptPolicyNotifyVlanTag, topTenHitsByPolicyEntry=topTenHitsByPolicyEntry, tptPolicyNotifySrcNetAddrV6=tptPolicyNotifySrcNetAddrV6, protocolAlertCount=protocolAlertCount, zoneAlertCount=zoneAlertCount, tptPolicyNotifySrcNetAddr=tptPolicyNotifySrcNetAddr, SslInspAction=SslInspAction, tptPolicyLogNotifyTrigger=tptPolicyLogNotifyTrigger, policyPacketsInvalid=policyPacketsInvalid, policyCountPackets=policyCountPackets, alertPort=alertPort, blockPort=blockPort, blocksByZoneTable=blocksByZoneTable, policyName=policyName, portName=portName, tptPolicyNotifyPacketTrace=tptPolicyNotifyPacketTrace, packetsByProtocolTable=packetsByProtocolTable, policyPacketsDropped64=policyPacketsDropped64, policyCountBytes=policyCountBytes, tptPolicyNotifyFlowControl=tptPolicyNotifyFlowControl, policyCreationTime=policyCreationTime, tptPolicySslInspNotify=tptPolicySslInspNotify, policyCounterEntry=policyCounterEntry, framesByTypeEntry=framesByTypeEntry, p2psByZoneEntry=p2psByZoneEntry, policyByNumberEntry=policyByNumberEntry, tptPolicyNotifyHitCount=tptPolicyNotifyHitCount, portVlanTranslations=portVlanTranslations, szpOutZoneUUID=szpOutZoneUUID, policyDVVersion=policyDVVersion, policyCounterTable=policyCounterTable, tptPolicyNotifyStartTimeSec=tptPolicyNotifyStartTimeSec, PolicyFrameType=PolicyFrameType, tptPolicyNotifySslInspCltSslVer=tptPolicyNotifySslInspCltSslVer, PYSNMP_MODULE_ID=tpt_policy, szpPermits=szpPermits, tptPolicyNotifyAlertTimeNano=tptPolicyNotifyAlertTimeNano, blockSlot=blockSlot, tptPolicyNotifyComponentID=tptPolicyNotifyComponentID, PolicyAction=PolicyAction, tptPolicyLogNotifySequence=tptPolicyLogNotifySequence, tptPolicyNotifyZonePair=tptPolicyNotifyZonePair, tptPolicyNotifyDestNetAddr=tptPolicyNotifyDestNetAddr, SslInspectedFlag=SslInspectedFlag, tptPolicyNotifySslInspEventType=tptPolicyNotifySslInspEventType, szpPrecedence=szpPrecedence, szpName=szpName, policyPacketsInvalid64=policyPacketsInvalid64, zonePermitCount=zonePermitCount, szpInZoneName=szpInZoneName, permitSlot=permitSlot, numberDesc=numberDesc, policyPacketsIncoming64=policyPacketsIncoming64, PolicySeverity=PolicySeverity, blocksByZoneEntry=blocksByZoneEntry, tptPolicyNotifyActionSetID=tptPolicyNotifyActionSetID, SslProtocol=SslProtocol, tptPolicyNotifyTraceBegin=tptPolicyNotifyTraceBegin, policyGlobalID=policyGlobalID, portNumber=portNumber, policyByNumberTable=policyByNumberTable, tptPolicyNotifySslInspCltIF=tptPolicyNotifySslInspCltIF, alertsBySeverityEntry=alertsBySeverityEntry, securityZonePairTable=securityZonePairTable, policyPacketsIncoming=policyPacketsIncoming, PolicyProtocol=PolicyProtocol, tptPolicyNotifyProtocol=tptPolicyNotifyProtocol, alertSlot=alertSlot, typeFrameCount=typeFrameCount, tptPolicyNotifyTraceEnd=tptPolicyNotifyTraceEnd, policyNumber=policyNumber, tptPolicyNotifySslInspAction=tptPolicyNotifySslInspAction, protocolPacketCount=protocolPacketCount, tptPolicyNotifyDeviceID=tptPolicyNotifyDeviceID, tptPolicyNotifyRate=tptPolicyNotifyRate, portStatsEntry=portStatsEntry, tptPolicyNotifyVirtualSegment=tptPolicyNotifyVirtualSegment, tptPolicyNotifySegmentName=tptPolicyNotifySegmentName, tptPolicyNotifySequence=tptPolicyNotifySequence, permitsByZoneTable=permitsByZoneTable, tptPolicyNotifyConfigAction=tptPolicyNotifyConfigAction, tptPolicyNotifyActionSetName=tptPolicyNotifyActionSetName, frameType=frameType, zoneBlockCount=zoneBlockCount, p2pPort=p2pPort, policyDVObjs=policyDVObjs, policyPacketsPermitted64=policyPacketsPermitted64, szpOutZoneName=szpOutZoneName, tptPolicyLogNotifyDeviceID=tptPolicyLogNotifyDeviceID, tptPolicyNotify=tptPolicyNotify, szpUUID=szpUUID, zoneP2pCount=zoneP2pCount, szpBlocks=szpBlocks, numberName=numberName, tptPolicyNotifyClientip=tptPolicyNotifyClientip, szpInZoneUUID=szpInZoneUUID, szpAlerts=szpAlerts, frameSize=frameSize, alertProtocol=alertProtocol, tptPolicyNotifyMessageParams=tptPolicyNotifyMessageParams, tptPolicyNotifyAlertTimeSec=tptPolicyNotifyAlertTimeSec, severityAlertCount=severityAlertCount, tptPolicyNotifySslInspSrvSslVer=tptPolicyNotifySslInspSrvSslVer, sizeFrameCount=sizeFrameCount, alertsByZoneTable=alertsByZoneTable, topTenRank=topTenRank, tptPolicyNotifySslInspSrvIF=tptPolicyNotifySslInspSrvIF, szpInOctets=szpInOctets, policyUUID=policyUUID, securityZonePairEntry=securityZonePairEntry, alertSeverity=alertSeverity, tptPolicyNotifyAggregationPeriod=tptPolicyNotifyAggregationPeriod, permitPort=permitPort, tptPolicyNotifyAlertAction=tptPolicyNotifyAlertAction, tptPolicyNotifySslInspDetails=tptPolicyNotifySslInspDetails, tptPolicyNotifyInputMphy=tptPolicyNotifyInputMphy, policyDescriptiveName=policyDescriptiveName, PolicyComponent=PolicyComponent, tptPolicyLogNotifyComponentID=tptPolicyLogNotifyComponentID, tptPolicyLogNotify=tptPolicyLogNotify, framesBySizeEntry=framesBySizeEntry, framesBySizeTable=framesBySizeTable, tptPolicyNotifySeverity=tptPolicyNotifySeverity, tptPolicyNotifySslInspected=tptPolicyNotifySslInspected, tptPolicyNotifyPolicyID=tptPolicyNotifyPolicyID, packetProtocol=packetProtocol, tptPolicyNotifySslInspSrvCrypto=tptPolicyNotifySslInspSrvCrypto, tptPolicyNotifySrcNetPort=tptPolicyNotifySrcNetPort, alertsBySeverityTable=alertsBySeverityTable, tptPolicyNotifyStartTimeNano=tptPolicyNotifyStartTimeNano, framesByTypeTable=framesByTypeTable, policyPacketsRateLimited64=policyPacketsRateLimited64, SslInspEventType=SslInspEventType, tptPolicyNotifySslInspCltCrypto=tptPolicyNotifySslInspCltCrypto, p2psByZoneTable=p2psByZoneTable, portStatsTable=portStatsTable)
