...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/trendmicro/TPT-POLICY-MIB
...
mibBuilder.exportSymbols("TPT-POLICY-MIB", tptPolicyNotifyActionSetID=tptPolicyNotifyActionSetID, szpInPackets=szpInPackets, SslInspAction=SslInspAction, SslInspectedFlag=SslInspectedFlag, tptPolicyNotifyAlertTimeSec=tptPolicyNotifyAlertTimeSec, policyCountPackets=policyCountPackets, policyPacketsOutgoing=policyPacketsOutgoing, numberName=numberName, tptPolicyLogNotifyDeviceID=tptPolicyLogNotifyDeviceID, alertSeverity=alertSeverity, tptPolicyNotifyPolicyID=tptPolicyNotifyPolicyID, szpPrecedence=szpPrecedence, tptPolicyNotifyVlanTag=tptPolicyNotifyVlanTag, policyDVObjs=policyDVObjs, policyDVVersion=policyDVVersion, tptPolicyLogNotifySequence=tptPolicyLogNotifySequence, p2pSlot=p2pSlot, tptPolicyNotifySslInspDetails=tptPolicyNotifySslInspDetails, alertsByProtocolEntry=alertsByProtocolEntry, framesBySizeTable=framesBySizeTable, szpPermits=szpPermits, tptPolicyNotifyAlertTimeNano=tptPolicyNotifyAlertTimeNano, PolicyComponent=PolicyComponent, tptPolicyNotifyTraceEnd=tptPolicyNotifyTraceEnd, tptPolicyNotifySrcNetAddrV6=tptPolicyNotifySrcNetAddrV6, tptPolicyNotifySslInspPolicy=tptPolicyNotifySslInspPolicy, tptPolicyNotifyClientip=tptPolicyNotifyClientip, PolicyFrameType=PolicyFrameType, frameType=frameType, typeFrameCount=typeFrameCount, policyPacketsInvalid64=policyPacketsInvalid64, tptPolicyNotifySslInspCert=tptPolicyNotifySslInspCert, tptPolicyNotifySslInspected=tptPolicyNotifySslInspected, SslInspEventType=SslInspEventType, severityAlertCount=severityAlertCount, blocksByZoneEntry=blocksByZoneEntry, tptPolicyNotifyStartTimeNano=tptPolicyNotifyStartTimeNano, p2psByZoneTable=p2psByZoneTable, policyName=policyName, policyUUID=policyUUID, frameSize=frameSize, tptPolicyNotifyInputMphy=tptPolicyNotifyInputMphy, policyPacketsBlocked64=policyPacketsBlocked64, policyPacketsOutgoing64=policyPacketsOutgoing64, tptPolicyNotifyMessageParams=tptPolicyNotifyMessageParams, sizeFrameCount=sizeFrameCount, securityZonePairTable=securityZonePairTable, alertSlot=alertSlot, tptPolicyNotifyDestNetPort=tptPolicyNotifyDestNetPort, policyPacketsPermitted=policyPacketsPermitted, alertsByZoneTable=alertsByZoneTable, tptPolicyNotifySslInspSrvIF=tptPolicyNotifySslInspSrvIF, tptPolicyNotifySslInspCltIF=tptPolicyNotifySslInspCltIF, permitSlot=permitSlot, policyCounterTable=policyCounterTable, PolicyAction=PolicyAction, packetsByProtocolEntry=packetsByProtocolEntry, tptPolicyNotifyAggregationPeriod=tptPolicyNotifyAggregationPeriod, topTenHitsByPolicyTable=topTenHitsByPolicyTable, szpBlocks=szpBlocks, alertsByZoneEntry=alertsByZoneEntry, tptPolicyNotifySslInspEventType=tptPolicyNotifySslInspEventType, portNumber=portNumber, tptPolicyNotifySequence=tptPolicyNotifySequence, alertPort=alertPort, tptPolicyNotifyComponentID=tptPolicyNotifyComponentID, policyPacketsInvalid=policyPacketsInvalid, policyPacketsPermitted64=policyPacketsPermitted64, tptPolicyNotifyDestNetAddrV6=tptPolicyNotifyDestNetAddrV6, alertsByProtocolTable=alertsByProtocolTable, tptPolicyNotifyHitCount=tptPolicyNotifyHitCount, tptPolicyLogNotifyTrigger=tptPolicyLogNotifyTrigger, framesBySizeEntry=framesBySizeEntry, zoneAlertCount=zoneAlertCount, policyByNumberTable=policyByNumberTable, securityZonePairEntry=securityZonePairEntry, tptPolicyNotifyProtocol=tptPolicyNotifyProtocol, tptPolicyNotifySslInspAction=tptPolicyNotifySslInspAction, permitsByZoneEntry=permitsByZoneEntry, permitPort=permitPort, p2pPort=p2pPort, szpName=szpName, policyPacketsBlocked=policyPacketsBlocked, szpUUID=szpUUID, framesByTypeTable=framesByTypeTable, tptPolicyNotifyTraceBegin=tptPolicyNotifyTraceBegin, packetProtocol=packetProtocol, tptPolicyNotifyAlertType=tptPolicyNotifyAlertType, tptPolicySslInspNotify=tptPolicySslInspNotify, alertsBySeverityTable=alertsBySeverityTable, policyPacketsIncoming64=policyPacketsIncoming64, tptPolicyNotifySslInspCltSslVer=tptPolicyNotifySslInspCltSslVer, tptPolicyNotifyConfigAction=tptPolicyNotifyConfigAction, tptPolicyNotifyPacketTrace=tptPolicyNotifyPacketTrace, portVlanTranslations=portVlanTranslations, PolicyProtocol=PolicyProtocol, permitsByZoneTable=permitsByZoneTable, framesByTypeEntry=framesByTypeEntry, numberDesc=numberDesc, tptPolicyNotifyMetadata=tptPolicyNotifyMetadata, protocolPacketCount=protocolPacketCount, tptPolicyNotifySrcNetAddr=tptPolicyNotifySrcNetAddr, tptPolicyNotifySslInspSrvCrypto=tptPolicyNotifySslInspSrvCrypto, tptPolicyNotify=tptPolicyNotify, policyPacketsTrusted64=policyPacketsTrusted64, policyPacketsIncoming=policyPacketsIncoming, protocolAlertCount=protocolAlertCount, tptPolicyNotifyVirtualSegment=tptPolicyNotifyVirtualSegment, zonePermitCount=zonePermitCount, tptPolicyNotifyStartTimeSec=tptPolicyNotifyStartTimeSec, topTenRank=topTenRank, tptPolicyNotifySegmentName=tptPolicyNotifySegmentName, PYSNMP_MODULE_ID=tpt_policy, tptPolicyNotifyRate=tptPolicyNotifyRate, tptPolicyNotifySslInspCltCrypto=tptPolicyNotifySslInspCltCrypto, tptPolicyNotifyZonePair=tptPolicyNotifyZonePair, policyDescriptiveName=policyDescriptiveName, policyHitCount=policyHitCount, blockSlot=blockSlot, tptPolicyNotifySslInspSrvSslVer=tptPolicyNotifySslInspSrvSslVer, packetsByProtocolTable=packetsByProtocolTable, tptPolicyNotifyDestNetAddr=tptPolicyNotifyDestNetAddr, policyNumber=policyNumber, tptPolicyNotifyActionSetName=tptPolicyNotifyActionSetName, policyPacketsDropped=policyPacketsDropped, portStatsTable=portStatsTable, PolicyFrameSize=PolicyFrameSize, zoneP2pCount=zoneP2pCount, tptPolicyNotifyTraceBucket=tptPolicyNotifyTraceBucket, tptPolicyNotifyDeviceID=tptPolicyNotifyDeviceID, policyPacketsRateLimited64=policyPacketsRateLimited64, alertsBySeverityEntry=alertsBySeverityEntry, szpInZoneUUID=szpInZoneUUID, blocksByZoneTable=blocksByZoneTable, tptPolicyLogNotify=tptPolicyLogNotify, szpOutZoneUUID=szpOutZoneUUID, policyGlobalID=policyGlobalID, tptPolicyNotifySrcNetPort=tptPolicyNotifySrcNetPort, szpAlerts=szpAlerts, topTenHitsByPolicyEntry=topTenHitsByPolicyEntry, szpInOctets=szpInOctets, portName=portName, PolicySeverity=PolicySeverity, SslProtocol=SslProtocol, tptPolicyNotifyFlowControl=tptPolicyNotifyFlowControl, tptPolicyNotifySignatureID=tptPolicyNotifySignatureID, policyCountBytes=policyCountBytes, tptPolicyNotifyAlertAction=tptPolicyNotifyAlertAction, tptPolicyLogNotifyNumber=tptPolicyLogNotifyNumber, szpOutZoneName=szpOutZoneName, policyPacketsDropped64=policyPacketsDropped64, policyCreationTime=policyCreationTime, zoneBlockCount=zoneBlockCount, p2psByZoneEntry=p2psByZoneEntry, tpt_policy=tpt_policy, alertProtocol=alertProtocol, policyByNumberEntry=policyByNumberEntry, portStatsEntry=portStatsEntry, tptPolicyNotifySeverity=tptPolicyNotifySeverity, szpInZoneName=szpInZoneName, policyCounterEntry=policyCounterEntry, blockPort=blockPort, tptPolicyLogNotifyComponentID=tptPolicyLogNotifyComponentID)
