...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ZS-EXT-MIB
...
ciscoZsExtMIBCompliance.setObjects(
    ("CISCO-ZS-EXT-MIB", "ciscoZsExtConfigGroup")
)
if mibBuilder.loadTexts:
...
ciscoZsExtMIBComplianceRev1.setObjects(
      *(("CISCO-ZS-EXT-MIB", "ciscoZsExtConfigGroup"),
        ("CISCO-ZS-EXT-MIB", "ciscoZsExtConfigGroupSup1"))
)
if mibBuilder.loadTexts:
