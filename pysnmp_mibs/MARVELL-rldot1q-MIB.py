...
rlq_bridge_mib=ModuleIdentity((1,3,6,1,4,1,89,57,8))
if mibBuilder.loadTexts:rlq_bridge_mib.setRevisions(('2008-11-25 00:00',))
_Rldot1q_ObjectIdentity=ObjectIdentity
rldot1q=_Rldot1q_ObjectIdentity((1,3,6,1,4,1,89,57,8))
_Rldot1qStaticUnicastTable_Object=MibTable
rldot1qStaticUnicastTable=_Rldot1qStaticUnicastTable_Object((1,3,6,1,4,1,89,57,8,1))
if mibBuilder.loadTexts:rldot1qStaticUnicastTable.setStatus(_A)
_Rldot1qStaticUnicastEntry_Object=MibTableRow
rldot1qStaticUnicastEntry=_Rldot1qStaticUnicastEntry_Object((1,3,6,1,4,1,89,57,8,1,1))
...
rldot1qStaticUnicastAddressOwner=_Rldot1qStaticUnicastAddressOwner_Object((1,3,6,1,4,1,89,57,8,1,1,1),_Rldot1qStaticUnicastAddressOwner_Type())
...
rldot1qTpFdbTable=_Rldot1qTpFdbTable_Object((1,3,6,1,4,1,89,57,8,2))
if mibBuilder.loadTexts:rldot1qTpFdbTable.setStatus(_A)
_Rldot1qTpFdbEntry_Object=MibTableRow
rldot1qTpFdbEntry=_Rldot1qTpFdbEntry_Object((1,3,6,1,4,1,89,57,8,2,1))
...
rldot1qTpFdbSubStatus=_Rldot1qTpFdbSubStatus_Object((1,3,6,1,4,1,89,57,8,2,1,1),_Rldot1qTpFdbSubStatus_Type())
...
rldot1qTpFdbCountTable=_Rldot1qTpFdbCountTable_Object((1,3,6,1,4,1,89,57,8,3))
if mibBuilder.loadTexts:rldot1qTpFdbCountTable.setStatus(_A)
_Rldot1qTpFdbCountEntry_Object=MibTableRow
rldot1qTpFdbCountEntry=_Rldot1qTpFdbCountEntry_Object((1,3,6,1,4,1,89,57,8,3,1))
...
rldot1qTpFdbCountVlanTag=_Rldot1qTpFdbCountVlanTag_Object((1,3,6,1,4,1,89,57,8,3,1,1),_Rldot1qTpFdbCountVlanTag_Type())
...
rldot1qTpFdbCountPort=_Rldot1qTpFdbCountPort_Object((1,3,6,1,4,1,89,57,8,3,1,2),_Rldot1qTpFdbCountPort_Type())
rldot1qTpFdbCountPort.setMaxAccess(_D)
if mibBuilder.loadTexts:rldot1qTpFdbCountPort.setStatus(_A)
class _Rldot1qTpFdbCountType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*(('other',1),('invalid',2),(_E,3),('self',4),('mgmt',5)))
_Rldot1qTpFdbCountType_Type.__name__=_C
_Rldot1qTpFdbCountType_Object=MibTableColumn
rldot1qTpFdbCountType=_Rldot1qTpFdbCountType_Object((1,3,6,1,4,1,89,57,8,3,1,3),_Rldot1qTpFdbCountType_Type())
...
rldot1qTpFdbCountCount=_Rldot1qTpFdbCountCount_Object((1,3,6,1,4,1,89,57,8,3,1,4),_Rldot1qTpFdbCountCount_Type())
