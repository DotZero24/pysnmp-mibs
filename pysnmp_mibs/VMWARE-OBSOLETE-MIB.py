...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/vmware/VMWARE-OBSOLETE-MIB
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetShares=vmwNetShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmwNetName=vmwNetName, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmwNetTable=vmwNetTable, vmwCpuEntry=vmwCpuEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsTx=vmwNetHCPktsTx, vmkLoaded=vmkLoaded, vpxdTrapType=vpxdTrapType, vmwNetPktsTx=vmwNetPktsTx, vmwCpuShares=vmwCpuShares, vmwMemTable=vmwMemTable, vmwHBATable=vmwHBATable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBAEntry=vmwHBAEntry, vmwNetKbRx=vmwNetKbRx, vmwNetPktsRx=vmwNetPktsRx, vpxdVMName=vpxdVMName, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdNewStatus=vpxdNewStatus, vmwCpuVMID=vmwCpuVMID, vmwCpuTable=vmwCpuTable, vmwNetIdx=vmwNetIdx, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbRx=vmwNetHCKbRx, vpxdObjValue=vpxdObjValue, vmHBDetected=vmHBDetected, vmwMemVMID=vmwMemVMID, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmPoweredOff=vmPoweredOff, vmwNumReads=vmwNumReads, vmwMemEntry=vmwMemEntry, vmwDiskShares=vmwDiskShares, vmwNumWrites=vmwNumWrites, vmwKbWritten=vmwKbWritten, vmwCpuUtil=vmwCpuUtil, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, vmSuspended=vmSuspended, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares)
