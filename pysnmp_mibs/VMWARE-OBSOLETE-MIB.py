...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdTrapType=vpxdTrapType, vmkLoaded=vmkLoaded, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbRx=vmwNetKbRx, vmwNetTable=vmwNetTable, vmwNetIfAddr=vmwNetIfAddr, vmwHbaIdx=vmwHbaIdx, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbRead=vmwKbRead, vmHBLost=vmHBLost, vmwHbaName=vmwHbaName, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOn=vmPoweredOn, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable, vmwNumWrites=vmwNumWrites, vmwNetVMID=vmwNetVMID, vpxdHostName=vpxdHostName, vmwObsoleteMIB=vmwObsoleteMIB, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmwMemEntry=vmwMemEntry, vmwHbaVMID=vmwHbaVMID, vmwNetName=vmwNetName, vmwHBATable=vmwHBATable, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdOldStatus=vpxdOldStatus, vmwObsoleteGroup=vmwObsoleteGroup, vpxdObjValue=vpxdObjValue, vmwHBAEntry=vmwHBAEntry, vmwKbWritten=vmwKbWritten, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vmwNetIdx=vmwNetIdx, vmwMemShares=vmwMemShares, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vpxdTrap=vpxdTrap, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetShares=vmwNetShares, vmwCpuUtil=vmwCpuUtil, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetEntry=vmwNetEntry, vmwCpuVMID=vmwCpuVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx)
