...
_SataRaidCard4_ObjectIdentity=ObjectIdentity
sataRaidCard4=_SataRaidCard4_ObjectIdentity((1,3,6,1,4,1,18928,1,4))
_SystemInformation_ObjectIdentity=ObjectIdentity
systemInformation=_SystemInformation_ObjectIdentity((1,3,6,1,4,1,18928,1,4,1))
_SiVendor_Type=OctetString
_SiVendor_Object=MibScalar
siVendor=_SiVendor_Object((1,3,6,1,4,1,18928,1,4,1,1),_SiVendor_Type())
siVendor.setMaxAccess(_D)
if mibBuilder.loadTexts:siVendor.setStatus(_C)
_SiModel_Type=OctetString
_SiModel_Object=MibScalar
siModel=_SiModel_Object((1,3,6,1,4,1,18928,1,4,1,2),_SiModel_Type())
siModel.setMaxAccess(_D)
if mibBuilder.loadTexts:siModel.setStatus(_C)
_SiSerial_Type=OctetString
_SiSerial_Object=MibScalar
siSerial=_SiSerial_Object((1,3,6,1,4,1,18928,1,4,1,3),_SiSerial_Type())
...
siFirmVer=_SiFirmVer_Object((1,3,6,1,4,1,18928,1,4,1,4),_SiFirmVer_Type())
...
siBootVer=_SiBootVer_Object((1,3,6,1,4,1,18928,1,4,1,5),_SiBootVer_Type())
...
siMbrVer=_SiMbrVer_Object((1,3,6,1,4,1,18928,1,4,1,6),_SiMbrVer_Type())
...
siProcessor=_SiProcessor_Object((1,3,6,1,4,1,18928,1,4,1,7),_SiProcessor_Type())
...
siCpuSpeed=_SiCpuSpeed_Object((1,3,6,1,4,1,18928,1,4,1,8),_SiCpuSpeed_Type())
...
siICache=_SiICache_Object((1,3,6,1,4,1,18928,1,4,1,9),_SiICache_Type())
...
siDCache=_SiDCache_Object((1,3,6,1,4,1,18928,1,4,1,10),_SiDCache_Type())
...
siSCache=_SiSCache_Object((1,3,6,1,4,1,18928,1,4,1,11),_SiSCache_Type())
siSCache.setMaxAccess(_D)
if mibBuilder.loadTexts:siSCache.setStatus(_C)
_SiMemory_Type=Integer32
_SiMemory_Object=MibScalar
siMemory=_SiMemory_Object((1,3,6,1,4,1,18928,1,4,1,12),_SiMemory_Type())
...
siMemSpeed=_SiMemSpeed_Object((1,3,6,1,4,1,18928,1,4,1,13),_SiMemSpeed_Type())
...
siEcc=_SiEcc_Object((1,3,6,1,4,1,18928,1,4,1,14),_SiEcc_Type())
siEcc.setMaxAccess(_D)
if mibBuilder.loadTexts:siEcc.setStatus(_C)
_SiHosts_Type=Integer32
_SiHosts_Object=MibScalar
siHosts=_SiHosts_Object((1,3,6,1,4,1,18928,1,4,1,15),_SiHosts_Type())
...
siHddSlots=_SiHddSlots_Object((1,3,6,1,4,1,18928,1,4,1,16),_SiHddSlots_Type())
...
siRaidSets=_SiRaidSets_Object((1,3,6,1,4,1,18928,1,4,1,17),_SiRaidSets_Type())
...
siVolumeSets=_SiVolumeSets_Object((1,3,6,1,4,1,18928,1,4,1,18),_SiVolumeSets_Type())
...
siRaid6=_SiRaid6_Object((1,3,6,1,4,1,18928,1,4,1,22),_SiRaid6_Type())
...
siDhcp=_SiDhcp_Object((1,3,6,1,4,1,18928,1,4,1,23),_SiDhcp_Type())
...
siBeeper=_SiBeeper_Object((1,3,6,1,4,1,18928,1,4,1,24),_SiBeeper_Type())
...
siUsage=_SiUsage_Object((1,3,6,1,4,1,18928,1,4,1,25),_SiUsage_Type())
...
siMaxATA=_SiMaxATA_Object((1,3,6,1,4,1,18928,1,4,1,26),_SiMaxATA_Type())
...
siRebuildRate=_SiRebuildRate_Object((1,3,6,1,4,1,18928,1,4,1,27),_SiRebuildRate_Type())
...
siBaudRate=_SiBaudRate_Object((1,3,6,1,4,1,18928,1,4,1,28),_SiBaudRate_Type())
siBaudRate.setMaxAccess(_D)
if mibBuilder.loadTexts:siBaudRate.setStatus(_C)
_HwMonitor_ObjectIdentity=ObjectIdentity
hwMonitor=_HwMonitor_ObjectIdentity((1,3,6,1,4,1,18928,1,4,2))
_HwControllerBoardInstalled_Type=Integer32
_HwControllerBoardInstalled_Object=MibScalar
hwControllerBoardInstalled=_HwControllerBoardInstalled_Object((1,3,6,1,4,1,18928,1,4,2,1),_HwControllerBoardInstalled_Type())
...
hwControllerBoardDescription=_HwControllerBoardDescription_Object((1,3,6,1,4,1,18928,1,4,2,2),_HwControllerBoardDescription_Type())
...
hwControllerBoardNumberOfPower=_HwControllerBoardNumberOfPower_Object((1,3,6,1,4,1,18928,1,4,2,3),_HwControllerBoardNumberOfPower_Type())
...
hwControllerBoardNumberOfVol=_HwControllerBoardNumberOfVol_Object((1,3,6,1,4,1,18928,1,4,2,4),_HwControllerBoardNumberOfVol_Type())
...
hwControllerBoardNumberOfFan=_HwControllerBoardNumberOfFan_Object((1,3,6,1,4,1,18928,1,4,2,5),_HwControllerBoardNumberOfFan_Type())
...
hwControllerBoardNumberOfTemp=_HwControllerBoardNumberOfTemp_Object((1,3,6,1,4,1,18928,1,4,2,6),_HwControllerBoardNumberOfTemp_Type())
...
hwControllerBoardPowerTable=_HwControllerBoardPowerTable_Object((1,3,6,1,4,1,18928,1,4,2,7))
if mibBuilder.loadTexts:hwControllerBoardPowerTable.setStatus(_C)
_HwControllerBoardPowerEntry_Object=MibTableRow
hwControllerBoardPowerEntry=_HwControllerBoardPowerEntry_Object((1,3,6,1,4,1,18928,1,4,2,7,1))
...
hwControllerBoardPowerIndex=_HwControllerBoardPowerIndex_Object((1,3,6,1,4,1,18928,1,4,2,7,1,1),_HwControllerBoardPowerIndex_Type())
...
hwControllerBoardPowerDesc=_HwControllerBoardPowerDesc_Object((1,3,6,1,4,1,18928,1,4,2,7,1,2),_HwControllerBoardPowerDesc_Type())
...
hwControllerBoardPowerState=_HwControllerBoardPowerState_Object((1,3,6,1,4,1,18928,1,4,2,7,1,3),_HwControllerBoardPowerState_Type())
...
hwControllerBoardVolTable=_HwControllerBoardVolTable_Object((1,3,6,1,4,1,18928,1,4,2,8))
if mibBuilder.loadTexts:hwControllerBoardVolTable.setStatus(_C)
_HwControllerBoardVolEntry_Object=MibTableRow
hwControllerBoardVolEntry=_HwControllerBoardVolEntry_Object((1,3,6,1,4,1,18928,1,4,2,8,1))
...
hwControllerBoardVolIndex=_HwControllerBoardVolIndex_Object((1,3,6,1,4,1,18928,1,4,2,8,1,1),_HwControllerBoardVolIndex_Type())
...
hwControllerBoardVolDesc=_HwControllerBoardVolDesc_Object((1,3,6,1,4,1,18928,1,4,2,8,1,2),_HwControllerBoardVolDesc_Type())
...
hwControllerBoardVolValue=_HwControllerBoardVolValue_Object((1,3,6,1,4,1,18928,1,4,2,8,1,3),_HwControllerBoardVolValue_Type())
...
hwControllerBoardFanTable=_HwControllerBoardFanTable_Object((1,3,6,1,4,1,18928,1,4,2,9))
if mibBuilder.loadTexts:hwControllerBoardFanTable.setStatus(_C)
_HwControllerBoardFanEntry_Object=MibTableRow
hwControllerBoardFanEntry=_HwControllerBoardFanEntry_Object((1,3,6,1,4,1,18928,1,4,2,9,1))
...
hwControllerBoardFanIndex=_HwControllerBoardFanIndex_Object((1,3,6,1,4,1,18928,1,4,2,9,1,1),_HwControllerBoardFanIndex_Type())
...
hwControllerBoardFanDesc=_HwControllerBoardFanDesc_Object((1,3,6,1,4,1,18928,1,4,2,9,1,2),_HwControllerBoardFanDesc_Type())
...
hwControllerBoardFanSpeed=_HwControllerBoardFanSpeed_Object((1,3,6,1,4,1,18928,1,4,2,9,1,3),_HwControllerBoardFanSpeed_Type())
...
hwControllerBoardTempTable=_HwControllerBoardTempTable_Object((1,3,6,1,4,1,18928,1,4,2,10))
if mibBuilder.loadTexts:hwControllerBoardTempTable.setStatus(_C)
_HwControllerBoardTempEntry_Object=MibTableRow
hwControllerBoardTempEntry=_HwControllerBoardTempEntry_Object((1,3,6,1,4,1,18928,1,4,2,10,1))
...
hwControllerBoardTempIndex=_HwControllerBoardTempIndex_Object((1,3,6,1,4,1,18928,1,4,2,10,1,1),_HwControllerBoardTempIndex_Type())
...
hwControllerBoardTempDesc=_HwControllerBoardTempDesc_Object((1,3,6,1,4,1,18928,1,4,2,10,1,2),_HwControllerBoardTempDesc_Type())
...
hwControllerBoardTempValue=_HwControllerBoardTempValue_Object((1,3,6,1,4,1,18928,1,4,2,10,1,3),_HwControllerBoardTempValue_Type())
...
hddInformation=_HddInformation_ObjectIdentity((1,3,6,1,4,1,18928,1,4,3))
_HddInfoTable_Object=MibTable
hddInfoTable=_HddInfoTable_Object((1,3,6,1,4,1,18928,1,4,3,1))
if mibBuilder.loadTexts:hddInfoTable.setStatus(_C)
_HddInfoEntry_Object=MibTableRow
hddInfoEntry=_HddInfoEntry_Object((1,3,6,1,4,1,18928,1,4,3,1,1))
...
hddSlots=_HddSlots_Object((1,3,6,1,4,1,18928,1,4,3,1,1,1),_HddSlots_Type())
...
hddName=_HddName_Object((1,3,6,1,4,1,18928,1,4,3,1,1,2),_HddName_Type())
...
hddSerial=_HddSerial_Object((1,3,6,1,4,1,18928,1,4,3,1,1,3),_HddSerial_Type())
...
hddFirmVer=_HddFirmVer_Object((1,3,6,1,4,1,18928,1,4,3,1,1,4),_HddFirmVer_Type())
...
hddCapacity=_HddCapacity_Object((1,3,6,1,4,1,18928,1,4,3,1,1,5),_HddCapacity_Type())
...
hddPio=_HddPio_Object((1,3,6,1,4,1,18928,1,4,3,1,1,6),_HddPio_Type())
hddPio.setMaxAccess(_D)
if mibBuilder.loadTexts:hddPio.setStatus(_C)
_HddCudma_Type=Integer32
_HddCudma_Object=MibTableColumn
hddCudma=_HddCudma_Object((1,3,6,1,4,1,18928,1,4,3,1,1,7),_HddCudma_Type())
...
hddSudma=_HddSudma_Object((1,3,6,1,4,1,18928,1,4,3,1,1,8),_HddSudma_Type())
...
hddState=_HddState_Object((1,3,6,1,4,1,18928,1,4,3,1,1,9),_HddState_Type())
hddState.setMaxAccess(_D)
if mibBuilder.loadTexts:hddState.setStatus(_C)
_RaidsetInformation_ObjectIdentity=ObjectIdentity
raidsetInformation=_RaidsetInformation_ObjectIdentity((1,3,6,1,4,1,18928,1,4,4))
_RaidInfoTable_Object=MibTable
raidInfoTable=_RaidInfoTable_Object((1,3,6,1,4,1,18928,1,4,4,1))
if mibBuilder.loadTexts:raidInfoTable.setStatus(_C)
_RaidInfoEntry_Object=MibTableRow
raidInfoEntry=_RaidInfoEntry_Object((1,3,6,1,4,1,18928,1,4,4,1,1))
...
raidNumber=_RaidNumber_Object((1,3,6,1,4,1,18928,1,4,4,1,1,1),_RaidNumber_Type())
...
raidName=_RaidName_Object((1,3,6,1,4,1,18928,1,4,4,1,1,2),_RaidName_Type())
...
raidDisks=_RaidDisks_Object((1,3,6,1,4,1,18928,1,4,4,1,1,3),_RaidDisks_Type())
...
raidState=_RaidState_Object((1,3,6,1,4,1,18928,1,4,4,1,1,4),_RaidState_Type())
...
raidTotalCapacity=_RaidTotalCapacity_Object((1,3,6,1,4,1,18928,1,4,4,1,1,5),_RaidTotalCapacity_Type())
...
raidFreeCapacity=_RaidFreeCapacity_Object((1,3,6,1,4,1,18928,1,4,4,1,1,6),_RaidFreeCapacity_Type())
...
raidMemberDiskCapacity=_RaidMemberDiskCapacity_Object((1,3,6,1,4,1,18928,1,4,4,1,1,7),_RaidMemberDiskCapacity_Type())
...
raidMemberDiskChannels=_RaidMemberDiskChannels_Object((1,3,6,1,4,1,18928,1,4,4,1,1,8),_RaidMemberDiskChannels_Type())
...
volumesetInformation=_VolumesetInformation_ObjectIdentity((1,3,6,1,4,1,18928,1,4,5))
_VolInfoTable_Object=MibTable
volInfoTable=_VolInfoTable_Object((1,3,6,1,4,1,18928,1,4,5,1))
if mibBuilder.loadTexts:volInfoTable.setStatus(_C)
_VolInfoEntry_Object=MibTableRow
volInfoEntry=_VolInfoEntry_Object((1,3,6,1,4,1,18928,1,4,5,1,1))
...
volNumber=_VolNumber_Object((1,3,6,1,4,1,18928,1,4,5,1,1,1),_VolNumber_Type())
...
volName=_VolName_Object((1,3,6,1,4,1,18928,1,4,5,1,1,2),_VolName_Type())
...
volRaidName=_VolRaidName_Object((1,3,6,1,4,1,18928,1,4,5,1,1,3),_VolRaidName_Type())
...
volCapacity=_VolCapacity_Object((1,3,6,1,4,1,18928,1,4,5,1,1,4),_VolCapacity_Type())
...
volState=_VolState_Object((1,3,6,1,4,1,18928,1,4,5,1,1,5),_VolState_Type())
...
volProgress=_VolProgress_Object((1,3,6,1,4,1,18928,1,4,5,1,1,6),_VolProgress_Type())
...
volCluster=_VolCluster_Object((1,3,6,1,4,1,18928,1,4,5,1,1,7),_VolCluster_Type())
...
volChannel=_VolChannel_Object((1,3,6,1,4,1,18928,1,4,5,1,1,8),_VolChannel_Type())
...
volSCSIID=_VolSCSIID_Object((1,3,6,1,4,1,18928,1,4,5,1,1,9),_VolSCSIID_Type())
...
volSCSILUN=_VolSCSILUN_Object((1,3,6,1,4,1,18928,1,4,5,1,1,10),_VolSCSILUN_Type())
...
volRaidLevel=_VolRaidLevel_Object((1,3,6,1,4,1,18928,1,4,5,1,1,11),_VolRaidLevel_Type())
...
volStripes=_VolStripes_Object((1,3,6,1,4,1,18928,1,4,5,1,1,12),_VolStripes_Type())
...
volDisks=_VolDisks_Object((1,3,6,1,4,1,18928,1,4,5,1,1,13),_VolDisks_Type())
...
volCache=_VolCache_Object((1,3,6,1,4,1,18928,1,4,5,1,1,14),_VolCache_Type())
...
volTag=_VolTag_Object((1,3,6,1,4,1,18928,1,4,5,1,1,15),_VolTag_Type())
...
volMaxSpeed=_VolMaxSpeed_Object((1,3,6,1,4,1,18928,1,4,5,1,1,16),_VolMaxSpeed_Type())
...
volCurrentSpeed=_VolCurrentSpeed_Object((1,3,6,1,4,1,18928,1,4,5,1,1,17),_VolCurrentSpeed_Type())
...
eventInformation=_EventInformation_ObjectIdentity((1,3,6,1,4,1,18928,1,4,6))
_EventInfoTable_Object=MibTable
eventInfoTable=_EventInfoTable_Object((1,3,6,1,4,1,18928,1,4,6,1))
if mibBuilder.loadTexts:eventInfoTable.setStatus(_C)
_EventInfoEntry_Object=MibTableRow
eventInfoEntry=_EventInfoEntry_Object((1,3,6,1,4,1,18928,1,4,6,1,1))
...
eventNumber=_EventNumber_Object((1,3,6,1,4,1,18928,1,4,6,1,1,1),_EventNumber_Type())
...
eventString=_EventString_Object((1,3,6,1,4,1,18928,1,4,6,1,1,2),_EventString_Type())
