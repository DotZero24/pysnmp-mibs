...
nmsERPS=_NmsERPS_ObjectIdentity((1,3,6,1,4,1,52642,2,231))
_NmsERPSRings_Type=Integer32
_NmsERPSRings_Object=MibScalar
nmsERPSRings=_NmsERPSRings_Object((1,3,6,1,4,1,52642,2,231,1),_NmsERPSRings_Type())
...
nmsERPSInconsistenceCheck=_NmsERPSInconsistenceCheck_Object((1,3,6,1,4,1,52642,2,231,2),_NmsERPSInconsistenceCheck_Type())
...
nmsERPSPduRx=_NmsERPSPduRx_Object((1,3,6,1,4,1,52642,2,231,3),_NmsERPSPduRx_Type())
...
nmsERPSPduRxDropped=_NmsERPSPduRxDropped_Object((1,3,6,1,4,1,52642,2,231,4),_NmsERPSPduRxDropped_Type())
...
nmsERPSPduTx=_NmsERPSPduTx_Object((1,3,6,1,4,1,52642,2,231,5),_NmsERPSPduTx_Type())
nmsERPSPduTx.setMaxAccess(_B)
if mibBuilder.loadTexts:nmsERPSPduTx.setStatus(_A)
_NmsERPSRingTable_Object=MibTable
nmsERPSRingTable=_NmsERPSRingTable_Object((1,3,6,1,4,1,52642,2,231,6))
if mibBuilder.loadTexts:nmsERPSRingTable.setStatus(_A)
_NmsERPSRingTableEntry_Object=MibTableRow
nmsERPSRingTableEntry=_NmsERPSRingTableEntry_Object((1,3,6,1,4,1,52642,2,231,6,1))
...
nmsERPSRingID=_NmsERPSRingID_Object((1,3,6,1,4,1,52642,2,231,6,1,1),_NmsERPSRingID_Type())
...
nmsERPSRingNodeID=_NmsERPSRingNodeID_Object((1,3,6,1,4,1,52642,2,231,6,1,2),_NmsERPSRingNodeID_Type())
...
nmsERPSRingPorts=_NmsERPSRingPorts_Object((1,3,6,1,4,1,52642,2,231,6,1,3),_NmsERPSRingPorts_Type())
...
nmsERPSRingRole=_NmsERPSRingRole_Object((1,3,6,1,4,1,52642,2,231,6,1,4),_NmsERPSRingRole_Type())
...
nmsERPSRingState=_NmsERPSRingState_Object((1,3,6,1,4,1,52642,2,231,6,1,5),_NmsERPSRingState_Type())
...
nmsERPSRingWTR=_NmsERPSRingWTR_Object((1,3,6,1,4,1,52642,2,231,6,1,6),_NmsERPSRingWTR_Type())
...
nmsERPSRingWtrWhile=_NmsERPSRingWtrWhile_Object((1,3,6,1,4,1,52642,2,231,6,1,7),_NmsERPSRingWtrWhile_Type())
...
nmsERPSRingSignalFail=_NmsERPSRingSignalFail_Object((1,3,6,1,4,1,52642,2,231,6,1,8),_NmsERPSRingSignalFail_Type())
...
nmsERPSRingSending=_NmsERPSRingSending_Object((1,3,6,1,4,1,52642,2,231,6,1,9),_NmsERPSRingSending_Type())
...
nmsERPSRingRplOwnerID=_NmsERPSRingRplOwnerID_Object((1,3,6,1,4,1,52642,2,231,6,1,10),_NmsERPSRingRplOwnerID_Type())
...
nmsERPSRingRplOwnerMAC=_NmsERPSRingRplOwnerMAC_Object((1,3,6,1,4,1,52642,2,231,6,1,11),_NmsERPSRingRplOwnerMAC_Type())
...
nmsERPSRingDiscovering=_NmsERPSRingDiscovering_Object((1,3,6,1,4,1,52642,2,231,6,1,12),_NmsERPSRingDiscovering_Type())
...
nmsERPSRingDiscoverWhile=_NmsERPSRingDiscoverWhile_Object((1,3,6,1,4,1,52642,2,231,6,1,13),_NmsERPSRingDiscoverWhile_Type())
...
nmsERPSRingPriorityValue=_NmsERPSRingPriorityValue_Object((1,3,6,1,4,1,52642,2,231,6,1,14),_NmsERPSRingPriorityValue_Type())
...
nmsERPSRingWtrTime=_NmsERPSRingWtrTime_Object((1,3,6,1,4,1,52642,2,231,6,1,15),_NmsERPSRingWtrTime_Type())
...
nmsERPSRingGuardTime=_NmsERPSRingGuardTime_Object((1,3,6,1,4,1,52642,2,231,6,1,16),_NmsERPSRingGuardTime_Type())
...
nmsERPSRingSendTime=_NmsERPSRingSendTime_Object((1,3,6,1,4,1,52642,2,231,6,1,17),_NmsERPSRingSendTime_Type())
...
nmsERPSRingDiscoveryTime=_NmsERPSRingDiscoveryTime_Object((1,3,6,1,4,1,52642,2,231,6,1,18),_NmsERPSRingDiscoveryTime_Type())
...
nmsERPSRingDpduInterval=_NmsERPSRingDpduInterval_Object((1,3,6,1,4,1,52642,2,231,6,1,19),_NmsERPSRingDpduInterval_Type())
...
nmsERPSRingDiscoveryCount=_NmsERPSRingDiscoveryCount_Object((1,3,6,1,4,1,52642,2,231,6,1,20),_NmsERPSRingDiscoveryCount_Type())
...
nmsERPSRingDiscoveryLastDuration=_NmsERPSRingDiscoveryLastDuration_Object((1,3,6,1,4,1,52642,2,231,6,1,21),_NmsERPSRingDiscoveryLastDuration_Type())
...
nmsERPSRingDiscoveryLastElapsed=_NmsERPSRingDiscoveryLastElapsed_Object((1,3,6,1,4,1,52642,2,231,6,1,22),_NmsERPSRingDiscoveryLastElapsed_Type())
...
nmsERPSRingAdminStatus=_NmsERPSRingAdminStatus_Object((1,3,6,1,4,1,52642,2,231,6,1,23),_NmsERPSRingAdminStatus_Type())
...
nmsERPSRingPort1=_NmsERPSRingPort1_Object((1,3,6,1,4,1,52642,2,231,6,1,24),_NmsERPSRingPort1_Type())
...
nmsERPSRingPort1AdminType=_NmsERPSRingPort1AdminType_Object((1,3,6,1,4,1,52642,2,231,6,1,25),_NmsERPSRingPort1AdminType_Type())
...
nmsERPSRingPort1OperType=_NmsERPSRingPort1OperType_Object((1,3,6,1,4,1,52642,2,231,6,1,26),_NmsERPSRingPort1OperType_Type())
...
nmsERPSRingPort1State=_NmsERPSRingPort1State_Object((1,3,6,1,4,1,52642,2,231,6,1,27),_NmsERPSRingPort1State_Type())
...
nmsERPSRingPort1Status=_NmsERPSRingPort1Status_Object((1,3,6,1,4,1,52642,2,231,6,1,28),_NmsERPSRingPort1Status_Type())
...
nmsERPSRingPort2=_NmsERPSRingPort2_Object((1,3,6,1,4,1,52642,2,231,6,1,29),_NmsERPSRingPort2_Type())
...
nmsERPSRingPort2AdminType=_NmsERPSRingPort2AdminType_Object((1,3,6,1,4,1,52642,2,231,6,1,30),_NmsERPSRingPort2AdminType_Type())
...
nmsERPSRingPort2OperType=_NmsERPSRingPort2OperType_Object((1,3,6,1,4,1,52642,2,231,6,1,31),_NmsERPSRingPort2OperType_Type())
...
nmsERPSRingPort2State=_NmsERPSRingPort2State_Object((1,3,6,1,4,1,52642,2,231,6,1,32),_NmsERPSRingPort2State_Type())
...
nmsERPSRingPort2Status=_NmsERPSRingPort2Status_Object((1,3,6,1,4,1,52642,2,231,6,1,33),_NmsERPSRingPort2Status_Type())
...
nmsERPSRingPortTable=_NmsERPSRingPortTable_Object((1,3,6,1,4,1,52642,2,231,7))
if mibBuilder.loadTexts:nmsERPSRingPortTable.setStatus(_A)
_NmsERPSRingPortTableEntry_Object=MibTableRow
nmsERPSRingPortTableEntry=_NmsERPSRingPortTableEntry_Object((1,3,6,1,4,1,52642,2,231,7,1))
...
nmsERPSRingPortRingID=_NmsERPSRingPortRingID_Object((1,3,6,1,4,1,52642,2,231,7,1,1),_NmsERPSRingPortRingID_Type())
...
nmsERPSRingPort=_NmsERPSRingPort_Object((1,3,6,1,4,1,52642,2,231,7,1,2),_NmsERPSRingPort_Type())
...
nmsERPSRingPortAdminType=_NmsERPSRingPortAdminType_Object((1,3,6,1,4,1,52642,2,231,7,1,3),_NmsERPSRingPortAdminType_Type())
...
nmsERPSRingPortOperType=_NmsERPSRingPortOperType_Object((1,3,6,1,4,1,52642,2,231,7,1,4),_NmsERPSRingPortOperType_Type())
...
nmsERPSRingPortState=_NmsERPSRingPortState_Object((1,3,6,1,4,1,52642,2,231,7,1,5),_NmsERPSRingPortState_Type())
...
nmsERPSRingPortStatus=_NmsERPSRingPortStatus_Object((1,3,6,1,4,1,52642,2,231,7,1,6),_NmsERPSRingPortStatus_Type())
...
nmsERPSRingPortForwards=_NmsERPSRingPortForwards_Object((1,3,6,1,4,1,52642,2,231,7,1,7),_NmsERPSRingPortForwards_Type())
...
nmsERPSRingPortForwardLastElapsed=_NmsERPSRingPortForwardLastElapsed_Object((1,3,6,1,4,1,52642,2,231,7,1,8),_NmsERPSRingPortForwardLastElapsed_Type())
...
nmsERPSRingPortRx=_NmsERPSRingPortRx_Object((1,3,6,1,4,1,52642,2,231,7,1,9),_NmsERPSRingPortRx_Type())
...
nmsERPSRingPortTx=_NmsERPSRingPortTx_Object((1,3,6,1,4,1,52642,2,231,7,1,10),_NmsERPSRingPortTx_Type())
...
nmsERPSRingNotifications=_NmsERPSRingNotifications_ObjectIdentity((1,3,6,1,4,1,52642,2,231,8))
nmsERPSRingRoleChange=NotificationType((1,3,6,1,4,1,52642,2,231,8,1))
nmsERPSRingRoleChange.setObjects(*((_D,_I),(_D,_Q),(_D,_R)))
if mibBuilder.loadTexts:nmsERPSRingRoleChange.setStatus(_U)
nmsERPSRingStateChange=NotificationType((1,3,6,1,4,1,52642,2,231,8,2))
