...
mibBuilder.exportSymbols("HPN-ICF-EPON-UNI-MIB", hpnicfEponUniInStatsUndersizePkts=hpnicfEponUniInStatsUndersizePkts, hpnicfEponUniQosIndexNextEntry=hpnicfEponUniQosIndexNextEntry, hpnicfEponUniMulticastAccessRule=hpnicfEponUniMulticastAccessRule, hpnicfEponUniTrapPrefix=hpnicfEponUniTrapPrefix, hpnicfEponUniInStatsMulticastPkts=hpnicfEponUniInStatsMulticastPkts, hpnicfEponUniMulticastGroupNumber=hpnicfEponUniMulticastGroupNumber, hpnicfEponUniFlowControl=hpnicfEponUniFlowControl, hpnicfEponUniMdi=hpnicfEponUniMdi, hpnicfEponUniQosRuleEntry=hpnicfEponUniQosRuleEntry, hpnicfEponUniPortPolicyTable=hpnicfEponUniPortPolicyTable, hpnicfEponUniVLANTrunkAllowListLow=hpnicfEponUniVLANTrunkAllowListLow, hpnicfEponUniOutStatsPausePkts=hpnicfEponUniOutStatsPausePkts, hpnicfEponUniOutTotalErrors=hpnicfEponUniOutTotalErrors, hpnicfEponUniMirrorOutboundPortList=hpnicfEponUniMirrorOutboundPortList, hpnicfEponUniAdminStatus=hpnicfEponUniAdminStatus, hpnicfEponUniQosRuleOperator=hpnicfEponUniQosRuleOperator, hpnicfEponUniLoopBackDetectedTrap=hpnicfEponUniLoopBackDetectedTrap, hpnicfEponUniScalarGroup=hpnicfEponUniScalarGroup, hpnicfEponUniPortIsolate=hpnicfEponUniPortIsolate, hpnicfEponUniSysManEntry=hpnicfEponUniSysManEntry, hpnicfEponUniDuplex=hpnicfEponUniDuplex, hpnicfEponUniVCTNearendCrosstalk=hpnicfEponUniVCTNearendCrosstalk, hpnicfEponUniQosRuleRowStatus=hpnicfEponUniQosRuleRowStatus, hpnicfEponUniOutDelayExceededDiscards=hpnicfEponUniOutDelayExceededDiscards, hpnicfEponUniInTotalErrors=hpnicfEponUniInTotalErrors, hpnicfEponUniInPausePkts=hpnicfEponUniInPausePkts, hpnicfEponUniLinkStatus=hpnicfEponUniLinkStatus, hpnicfEponUniInStatsOversizePkts=hpnicfEponUniInStatsOversizePkts, hpnicfEponUniInErrorbyOther=hpnicfEponUniInErrorbyOther, hpnicfEponUniQosConfMappedQueue=hpnicfEponUniQosConfMappedQueue, hpnicfEponUniMulticastResetInterval=hpnicfEponUniMulticastResetInterval, hpnicfEponUniPortPolicyInboundCir=hpnicfEponUniPortPolicyInboundCir, hpnicfEponUniMulticastFastleave=hpnicfEponUniMulticastFastleave, hpnicfEponUniMulticastChannelLimit=hpnicfEponUniMulticastChannelLimit, hpnicfEponUni=hpnicfEponUni, hpnicfEponUniMulticastSourceIpList=hpnicfEponUniMulticastSourceIpList, hpnicfEponUniParaMan=hpnicfEponUniParaMan, hpnicfEponUniInStatsCRCAlignErrors=hpnicfEponUniInStatsCRCAlignErrors, hpnicfEponUniMacIndex=hpnicfEponUniMacIndex, hpnicfEponUniQosConfTable=hpnicfEponUniQosConfTable, hpnicfEponUniVlanVPNStatus=hpnicfEponUniVlanVPNStatus, hpnicfEponUniMulticastVlanIndex=hpnicfEponUniMulticastVlanIndex, hpnicfEponUniIgmpInfoTable=hpnicfEponUniIgmpInfoTable, hpnicfEponUniQosIndexNextTable=hpnicfEponUniQosIndexNextTable, hpnicfEponUniIndex=hpnicfEponUniIndex, hpnicfEponUniMulticastPreTimes=hpnicfEponUniMulticastPreTimes, hpnicfEponUniSpeed=hpnicfEponUniSpeed, hpnicfEponUniVCTImpedanceMismatch=hpnicfEponUniVCTImpedanceMismatch, hpnicfEponUniOutboundLineRate=hpnicfEponUniOutboundLineRate, hpnicfEponUniVCTCableLength=hpnicfEponUniVCTCableLength, hpnicfEponUniIgmpMacAddress=hpnicfEponUniIgmpMacAddress, hpnicfEponUniInStatsPkts=hpnicfEponUniInStatsPkts, hpnicfEponUniOutDroppedFrames=hpnicfEponUniOutDroppedFrames, hpnicfEponUniPortPolicyOutboundPir=hpnicfEponUniPortPolicyOutboundPir, hpnicfEponUniMulticastStripStatus=hpnicfEponUniMulticastStripStatus, hpnicfEponUniTechAbilityEntry=hpnicfEponUniTechAbilityEntry, hpnicfEponUniMulticastControlTable=hpnicfEponUniMulticastControlTable, hpnicfEponUniMulticastControlEntry=hpnicfEponUniMulticastControlEntry, hpnicfEponUniLineRateMax=hpnicfEponUniLineRateMax, hpnicfEponUniPortPolicyBucketDepth=hpnicfEponUniPortPolicyBucketDepth, hpnicfEponUniPortPolicyCir=hpnicfEponUniPortPolicyCir, hpnicfEponUniVCTCableStatus=hpnicfEponUniVCTCableStatus, hpnicfEponUniPortPolicyStatus=hpnicfEponUniPortPolicyStatus, hpnicfEponUniMirrorGroupEntry=hpnicfEponUniMirrorGroupEntry, hpnicfEponUniOutErrorbyOther=hpnicfEponUniOutErrorbyOther, hpnicfEponUniPortPolicyEntry=hpnicfEponUniPortPolicyEntry, hpnicfEponUniLinkUpTrap=hpnicfEponUniLinkUpTrap, hpnicfEponUniVlan=hpnicfEponUniVlan, hpnicfEponUniPortPolicyInboundExtraBurst=hpnicfEponUniPortPolicyInboundExtraBurst, hpnicfEponUniLinkDownTrap=hpnicfEponUniLinkDownTrap, hpnicfEponUniQosConfRowStatus=hpnicfEponUniQosConfRowStatus, hpnicfEponUniMultActAccessRule=hpnicfEponUniMultActAccessRule, hpnicfEponUniMulticastCtrlInfoTable=hpnicfEponUniMulticastCtrlInfoTable, hpnicfEponUniVCTPolaritySwap=hpnicfEponUniVCTPolaritySwap, hpnicfEponUniMulticastIndexNextTable=hpnicfEponUniMulticastIndexNextTable, hpnicfEponUniOutStatsBroadcastPkts=hpnicfEponUniOutStatsBroadcastPkts, hpnicfEponUniMulticastRowStatus=hpnicfEponUniMulticastRowStatus, hpnicfEponUniMulticastIndex=hpnicfEponUniMulticastIndex, hpnicfEponUniPortPolicyOutboundCir=hpnicfEponUniPortPolicyOutboundCir, hpnicfEponUniMirrorGroupTable=hpnicfEponUniMirrorGroupTable, hpnicfEponUniQosRuleValue=hpnicfEponUniQosRuleValue, hpnicfEponUniMirrorInboundPortList=hpnicfEponUniMirrorInboundPortList, hpnicfEponUniMulticastConfIndexNext=hpnicfEponUniMulticastConfIndexNext, hpnicfEponUniVCTReturnLoss=hpnicfEponUniVCTReturnLoss, hpnicfEponUniSysMan=hpnicfEponUniSysMan, hpnicfEponUniLocalTechAbility=hpnicfEponUniLocalTechAbility, hpnicfEponUniNumberOnOnu=hpnicfEponUniNumberOnOnu, hpnicfEponUniMulticastCtrlInfoEntry=hpnicfEponUniMulticastCtrlInfoEntry, hpnicfEponUniVLANTrunkAllowListHigh=hpnicfEponUniVLANTrunkAllowListHigh, hpnicfEponUniMulticastVlanList=hpnicfEponUniMulticastVlanList, hpnicfEponUniRestartAutoNeg=hpnicfEponUniRestartAutoNeg, hpnicfEponUniAccessVlan=hpnicfEponUniAccessVlan, hpnicfEponUniIgmpInfoEntry=hpnicfEponUniIgmpInfoEntry, hpnicfEponUniQosConfMarkedPriority=hpnicfEponUniQosConfMarkedPriority, hpnicfEponUniMirrorRowStatus=hpnicfEponUniMirrorRowStatus, hpnicfEponUniMulticastEntry=hpnicfEponUniMulticastEntry, hpnicfEponUniCountTable=hpnicfEponUniCountTable, hpnicfEponUniMirrorGroupIdNextEntry=hpnicfEponUniMirrorGroupIdNextEntry, hpnicfEponUniLineRateStep=hpnicfEponUniLineRateStep, hpnicfEponUniQosRuleIndex=hpnicfEponUniQosRuleIndex, hpnicfEponUniCountReset=hpnicfEponUniCountReset, hpnicfEponUniOutStatsPkts=hpnicfEponUniOutStatsPkts, hpnicfEponUniAutoNegotiation=hpnicfEponUniAutoNegotiation, hpnicfEponUniQosConfIndexNext=hpnicfEponUniQosConfIndexNext, hpnicfEponUniInboundLineRate=hpnicfEponUniInboundLineRate, hpnicfEponUniOutStatsMulticastPkts=hpnicfEponUniOutStatsMulticastPkts, hpnicfEponUniPriority=hpnicfEponUniPriority, hpnicfEponUniMulticastTable=hpnicfEponUniMulticastTable, hpnicfEponUniMultActVlan=hpnicfEponUniMultActVlan, hpnicfEponUniMulticastPreTimeSlice=hpnicfEponUniMulticastPreTimeSlice, hpnicfEponUniMulticastIndexNextEntry=hpnicfEponUniMulticastIndexNextEntry, hpnicfEponUniVCTPairSwap=hpnicfEponUniVCTPairSwap, hpnicfEponUniVCTPairSkew=hpnicfEponUniVCTPairSkew, hpnicfEponUniInterfaceType=hpnicfEponUniInterfaceType, hpnicfEponUniQosRuleSelector=hpnicfEponUniQosRuleSelector, hpnicfEponUniMultActAddress=hpnicfEponUniMultActAddress, hpnicfEponUniAdvertisedTechAbility=hpnicfEponUniAdvertisedTechAbility, hpnicfEponUniQosRuleMacAddress=hpnicfEponUniQosRuleMacAddress, hpnicfEponUniVlanType=hpnicfEponUniVlanType, hpnicfEponUniMirrorGroupIdNextTable=hpnicfEponUniMirrorGroupIdNextTable, hpnicfEponUniPortPolicyInboundBucketDepth=hpnicfEponUniPortPolicyInboundBucketDepth, hpnicfEponUniMulticastPreInterval=hpnicfEponUniMulticastPreInterval, hpnicfEponUniMultActPreRemain=hpnicfEponUniMultActPreRemain, hpnicfEponUniLoopBackRecoveredTrap=hpnicfEponUniLoopBackRecoveredTrap, hpnicfEponUniOutStatsCollisions=hpnicfEponUniOutStatsCollisions, hpnicfEponUniSysManTable=hpnicfEponUniSysManTable, hpnicfEponUniMultActPreTimes=hpnicfEponUniMultActPreTimes, PYSNMP_MODULE_ID=hpnicfEponUni, hpnicfEponUniVlanConfiguration=hpnicfEponUniVlanConfiguration, hpnicfEponUniIgmpVlanId=hpnicfEponUniIgmpVlanId, hpnicfEponUniMirrorGroupIDNext=hpnicfEponUniMirrorGroupIDNext, hpnicfEponUniTrap=hpnicfEponUniTrap, hpnicfEponUniVCTInsertionLoss=hpnicfEponUniVCTInsertionLoss, hpnicfEponUniCountEntry=hpnicfEponUniCountEntry, hpnicfEponUniTechAbilityTable=hpnicfEponUniTechAbilityTable, hpnicfEponUniQosConfIndex=hpnicfEponUniQosConfIndex, hpnicfEponUniMonitorPort=hpnicfEponUniMonitorPort, hpnicfEponUniDescr=hpnicfEponUniDescr, hpnicfEponUniInStatsUnicastPkts=hpnicfEponUniInStatsUnicastPkts, hpnicfEponUniInStatsBroadcastPkts=hpnicfEponUniInStatsBroadcastPkts, hpnicfEponUniMulticastAddressList=hpnicfEponUniMulticastAddressList, hpnicfEponUniTrunkPvid=hpnicfEponUniTrunkPvid, hpnicfEponUniQosConfEntry=hpnicfEponUniQosConfEntry, hpnicfEponUniQosConfRuleIndexNext=hpnicfEponUniQosConfRuleIndexNext, hpnicfEponUniQosRuleTable=hpnicfEponUniQosRuleTable, hpnicfEponUniVitualCableTest=hpnicfEponUniVitualCableTest, hpnicfEponUniMirrorGroupID=hpnicfEponUniMirrorGroupID, hpnicfEponUniOutStatsUnicastPkts=hpnicfEponUniOutStatsUnicastPkts, hpnicfEponUniPortPolicyExtraBurst=hpnicfEponUniPortPolicyExtraBurst)
