...
mibBuilder.exportSymbols("FS-NMS-SMI", PYSNMP_MODULE_ID=nms, nmslocal=nmslocal, nmsModules=nmsModules, nmsEPONGroup=nmsEPONGroup, nmstemporary=nmstemporary, nmsPolicyAuto=nmsPolicyAuto, nmsProducts=nmsProducts, nmsPTNGroup=nmsPTNGroup, nmsMgmt=nmsMgmt, nmsPibToMib=nmsPibToMib, nms=nms, nmsWorkGroup=nmsWorkGroup, nmsWlanGroup=nmsWlanGroup)
