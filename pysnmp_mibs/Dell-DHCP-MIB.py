# SNMP MIB module (Dell-DHCP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-DHCP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:15 2025
...
rlDhcpRelayNextServerEntry.setIndexNames(
    (0, "Dell-DHCP-MIB", "rlDhcpRelayNextServerIpAddr"),
)
if mibBuilder.loadTexts:
...
rlDhcpRelayInterfaceEntry = _RlDhcpRelayInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 38, 28, 1)
)
rlDhcpRelayInterfaceEntry.setIndexNames(
    (0, "Dell-DHCP-MIB", "rlDhcpRelayInterfaceIfindex"),
)
if mibBuilder.loadTexts:
...
rlDhcpRelayInterfaceListEntry = _RlDhcpRelayInterfaceListEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 38, 29, 1)
)
rlDhcpRelayInterfaceListEntry.setIndexNames(
    (0, "Dell-DHCP-MIB", "rlDhcpRelayInterfaceListIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpSrvIpAddrEntry.setIndexNames(
    (0, "Dell-DHCP-MIB", "rlDhcpSrvIpAddrIpAddr"),
)
if mibBuilder.loadTexts:
...
rlDhcpSrvDynamicEntry.setIndexNames(
    (0, "Dell-DHCP-MIB", "rlDhcpSrvDynamicPoolName"),
)
if mibBuilder.loadTexts:
...
rlDhcpSrvConfParamsEntry.setIndexNames(
    (0, "Dell-DHCP-MIB", "rlDhcpSrvConfParamsName"),
)
if mibBuilder.loadTexts:
...
rlDhcpSrvOptionParamsEntry = _RlDhcpSrvOptionParamsEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 38, 57, 1)
)
rlDhcpSrvOptionParamsEntry.setIndexNames(
    (0, "Dell-DHCP-MIB", "rlDhcpSrvOptionParamsName"),
    (0, "Dell-DHCP-MIB", "rlDhcpSrvOptionParamsCode"),
)
if mibBuilder.loadTexts:
...
rlDhcpSrvAuxOptionEntry = _RlDhcpSrvAuxOptionEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 38, 58, 1)
)
rlDhcpSrvAuxOptionEntry.setIndexNames(
    (0, "Dell-DHCP-MIB", "rlDhcpSrvAuxOptionCode"),
    (0, "Dell-DHCP-MIB", "rlDhcpSrvAuxOptionType"),
)
if mibBuilder.loadTexts:
