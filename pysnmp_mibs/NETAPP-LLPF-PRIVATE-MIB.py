...
agentSwitchLlpfGroup=_AgentSwitchLlpfGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,48,1))
_AgentSwitchLlpfPortConfigTable_Object=MibTable
agentSwitchLlpfPortConfigTable=_AgentSwitchLlpfPortConfigTable_Object((1,3,6,1,4,1,789,4413,1,1,48,1,1))
if mibBuilder.loadTexts:agentSwitchLlpfPortConfigTable.setStatus(_A)
_AgentSwitchLlpfPortConfigEntry_Object=MibTableRow
agentSwitchLlpfPortConfigEntry=_AgentSwitchLlpfPortConfigEntry_Object((1,3,6,1,4,1,789,4413,1,1,48,1,1,1))
...
agentSwitchLlpfProtocolType=_AgentSwitchLlpfProtocolType_Object((1,3,6,1,4,1,789,4413,1,1,48,1,1,1,1),_AgentSwitchLlpfProtocolType_Type())
...
agentSwitchLlpfPortBlockMode=_AgentSwitchLlpfPortBlockMode_Object((1,3,6,1,4,1,789,4413,1,1,48,1,1,1,2),_AgentSwitchLlpfPortBlockMode_Type())
