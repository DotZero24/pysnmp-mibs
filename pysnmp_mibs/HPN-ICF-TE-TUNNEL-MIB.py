...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-TE-TUNNEL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:36:48 2025
...
hpnicfTeTunnelCompliance.setObjects(
      *(("HPN-ICF-TE-TUNNEL-MIB", "hpnicfTeTunnelNotificationsGroup"),
        ("HPN-ICF-TE-TUNNEL-MIB", "hpnicfTeTunnelScalarsGroup"),
        ("HPN-ICF-TE-TUNNEL-MIB", "hpnicfTeTunnelStaticCrlspGroup"),
        ("HPN-ICF-TE-TUNNEL-MIB", "hpnicfTeTunnelCorouteGroup"),
        ("HPN-ICF-TE-TUNNEL-MIB", "hpnicfTeTunnelPsGroup"))
)
if mibBuilder.loadTexts:
