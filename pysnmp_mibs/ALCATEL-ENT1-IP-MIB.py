#
# PySNMP MIB module ALCATEL-ENT1-IP-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-IP-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 09:57:47 2025
# On host macmini.vegmond.io platform Darwin version 24.6.0 by user rob
# Using Python version 3.12.8 (main, Dec  3 2024, 18:42:41) [Clang 16.0.0 (clang-1600.0.26.4)]
#
softentIND1Ip, = mibBuilder.importSymbols("ALCATEL-ENT1-BASE", "softentIND1Ip")
...
alaDoSEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 3, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaDoSType"))
...
alaDoSArpPoisonEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 3, 11, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaDoSArpPoisonIpAddr"))
...
alaDoSAntiSpoofEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 3, 13, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofIPAddressType"), (0, "ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofIPAddress"))
...
ipNetToMediaEntry.registerAugmentions(("ALCATEL-ENT1-IP-MIB", "ipNetToMediaAugEntry"))
...
alaDoSTrap = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 0, 1)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDoSType"), ("ALCATEL-ENT1-IP-MIB", "alaDoSDetected"), ("ALCATEL-ENT1-IP-MIB", "alaDoSIp"), ("ALCATEL-ENT1-IP-MIB", "alaDoSMac"), ("ALCATEL-ENT1-IP-MIB", "alaDoSSlot"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPort"), ("ALCATEL-ENT1-IP-MIB", "alaDoSChassisId"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPortIfindex"))
...
pktDrop = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 0, 2)).setObjects(("ALCATEL-ENT1-IP-MIB", "pktDropType"), ("ALCATEL-ENT1-IP-MIB", "pktDropIfIndex"), ("ALCATEL-ENT1-IP-MIB", "pktDropCount"), ("ALCATEL-ENT1-IP-MIB", "pktDropFrag"))
...
ipCidrRouteEntry.registerAugmentions(("ALCATEL-ENT1-IP-MIB", "ipCidrRouteAugEntry"))
...
alaIcmpCtrlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 7, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaIcmpCtrlType"), (0, "ALCATEL-ENT1-IP-MIB", "alaIcmpCtrlCode"))
...
alaIpRouteSumEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 9, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaIpRouteProtocol"))
...
alaIpArpFilterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 11, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaIpArpFilterIpAddr"), (0, "ALCATEL-ENT1-IP-MIB", "alaIpArpFilterIpMask"), (0, "ALCATEL-ENT1-IP-MIB", "alaIpArpFilterVlan"), (0, "ALCATEL-ENT1-IP-MIB", "alaIpArpFilterType"))
...
alaIpServiceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 12, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaIpServiceType"))
...
alaIpPortServiceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 13, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaIpPortServicePort"))
...
alaIpItfConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 15, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaIpItfConfigName"))
...
alaIpNetToMediaDpaEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 24, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaDpaVlan"))
...
alaIpCompliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 1, 1)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpConfigGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaGroup"), ("ALCATEL-ENT1-IP-MIB", "alaDoSGroup"), ("ALCATEL-ENT1-IP-MIB", "alaPortScanGroup"), ("ALCATEL-ENT1-IP-MIB", "alaArpPingGroup"), ("ALCATEL-ENT1-IP-MIB", "alaArpPoisonGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaAugGroup"), ("ALCATEL-ENT1-IP-MIB", "alaPktDropGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpCidrAugGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIcmpCtrlGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpRouteSumGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpArpFilterGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpServiceTypeGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpPortServiceTypeGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpItfGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpNotificationGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpDhcpHostIdentifierGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpServiceSourceIpGroup"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaDpGroup"), ("ALCATEL-ENT1-IP-MIB", "alaAntiSpoofGlobalGroup"), ("ALCATEL-ENT1-IP-MIB", "alaAntiSpoofGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpCompliance = alaIpCompliance.setStatus('current')
alaIpConfigGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 1)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpClearArpCache"), ("ALCATEL-ENT1-IP-MIB", "alaIpDirectedBroadcast"), ("ALCATEL-ENT1-IP-MIB", "alaIpClearArpFilter"), ("ALCATEL-ENT1-IP-MIB", "alaIpDistributedArp"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpConfigGroup = alaIpConfigGroup.setStatus('current')
alaIpNetToMediaGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 2)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaPhysAddress"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaProxy"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaVrrp"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaAuth"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaName"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaStaticIntfRt"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpNetToMediaGroup = alaIpNetToMediaGroup.setStatus('current')
alaDoSGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 3)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDoSType"), ("ALCATEL-ENT1-IP-MIB", "alaDoSDetected"), ("ALCATEL-ENT1-IP-MIB", "alaDoSIp"), ("ALCATEL-ENT1-IP-MIB", "alaDoSMac"), ("ALCATEL-ENT1-IP-MIB", "alaDoSSlot"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPort"), ("ALCATEL-ENT1-IP-MIB", "alaDoSStatus"), ("ALCATEL-ENT1-IP-MIB", "alaDoSChassisId"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPortIfindex"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDoSGroup = alaDoSGroup.setStatus('current')
alaPortScanGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 4)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDoSPortScanClosePortPenalty"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPortScanTcpOpenPortPenalty"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPortScanUdpOpenPortPenalty"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPortScanTotalPenalty"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPortScanThreshold"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPortScanDecay"), ("ALCATEL-ENT1-IP-MIB", "alaDoSTrapCntl"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaPortScanGroup = alaPortScanGroup.setStatus('current')
alaArpPingGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 5)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDoSARPRate"), ("ALCATEL-ENT1-IP-MIB", "alaDoSPingRate"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaArpPingGroup = alaArpPingGroup.setStatus('current')
alaArpPoisonGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 6)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDoSArpPoisonDetected"), ("ALCATEL-ENT1-IP-MIB", "alaDoSArpPoisonRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaArpPoisonGroup = alaArpPoisonGroup.setStatus('current')
alaIpNetToMediaAugGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 7)).setObjects(("ALCATEL-ENT1-IP-MIB", "ipNetToMediaSlot"), ("ALCATEL-ENT1-IP-MIB", "ipNetToMediaPort"), ("ALCATEL-ENT1-IP-MIB", "ipNetToMediaName"), ("ALCATEL-ENT1-IP-MIB", "ipNetToMediaChassisId"), ("ALCATEL-ENT1-IP-MIB", "ipNetToMediaPortIfindex"), ("ALCATEL-ENT1-IP-MIB", "ipNetToMediaSubId"), ("ALCATEL-ENT1-IP-MIB", "ipNetToMediaSubType"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpNetToMediaAugGroup = alaIpNetToMediaAugGroup.setStatus('current')
alaPktDropGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 8)).setObjects(("ALCATEL-ENT1-IP-MIB", "pktDropType"), ("ALCATEL-ENT1-IP-MIB", "pktDropIfIndex"), ("ALCATEL-ENT1-IP-MIB", "pktDropCount"), ("ALCATEL-ENT1-IP-MIB", "pktDropFrag"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaPktDropGroup = alaPktDropGroup.setStatus('current')
alaIpCidrAugGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 9)).setObjects(("ALCATEL-ENT1-IP-MIB", "ipCidrRouteScope"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpCidrAugGroup = alaIpCidrAugGroup.setStatus('current')
alaIcmpCtrlGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 10)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIcmpCtrlType"), ("ALCATEL-ENT1-IP-MIB", "alaIcmpCtrlCode"), ("ALCATEL-ENT1-IP-MIB", "alaIcmpCtrlStatus"), ("ALCATEL-ENT1-IP-MIB", "alaIcmpCtrlPktGap"), ("ALCATEL-ENT1-IP-MIB", "alaIcmpAllMsgStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIcmpCtrlGroup = alaIcmpCtrlGroup.setStatus('current')
alaIpRouteSumGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 11)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpRouteProtocol"), ("ALCATEL-ENT1-IP-MIB", "alaIpRouteCount"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpRouteSumGroup = alaIpRouteSumGroup.setStatus('current')
alaIpArpFilterGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 12)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpArpFilterMode"), ("ALCATEL-ENT1-IP-MIB", "alaIpArpFilterRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpArpFilterGroup = alaIpArpFilterGroup.setStatus('current')
alaIpServiceTypeGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 13)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpServiceType"), ("ALCATEL-ENT1-IP-MIB", "alaIpServicePort"), ("ALCATEL-ENT1-IP-MIB", "alaIpServiceStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpServiceTypeGroup = alaIpServiceTypeGroup.setStatus('current')
alaIpPortServiceTypeGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 14)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpPortServicePort"), ("ALCATEL-ENT1-IP-MIB", "alaIpPortServiceStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpPortServiceTypeGroup = alaIpPortServiceTypeGroup.setStatus('current')
alaIpInterfaceGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 15)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceName"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceAddress"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceMask"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceAdminState"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceDeviceType"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceVlanID"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceIpForward"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceEncap"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceMtu"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceLocalProxyArp"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfacePrimCfg"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceOperState"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceOperReason"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceRouterMac"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceBcastAddr"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfacePrimAct"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceRemoteAddr"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceTunnelSrcAddressType"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceTunnelSrc"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceTunnelDstAddressType"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceTunnelDst"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceVipAddress"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceDhcpStatus"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceDhcpIpRelease"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceDhcpIpRenew"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceDhcpOption60String"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceChassisId"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceSlot"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfacePort"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceTag"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceArpCount"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceArpNiChassis"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceArpNiSlot"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceArpNiDevice"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfacePortIfindex"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceDhcpVsiAcceptFilterString"), ("ALCATEL-ENT1-IP-MIB", "alaIpInterfaceServiceID"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpInterfaceGroup = alaIpInterfaceGroup.setStatus('current')
alaIpItfGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 16)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpItfConfigName"), ("ALCATEL-ENT1-IP-MIB", "alaIpItfConfigIfIndex"), ("ALCATEL-ENT1-IP-MIB", "alaIpItfConfigRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpItfGroup = alaIpItfGroup.setStatus('current')
alaIpFtpGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 17)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpFtpAdminStatus"), ("ALCATEL-ENT1-IP-MIB", "alaIpFtpPort"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpFtpGroup = alaIpFtpGroup.setStatus('current')
alaIpSshGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 18)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpSshAdminStatus"), ("ALCATEL-ENT1-IP-MIB", "alaIpSshPort"), ("ALCATEL-ENT1-IP-MIB", "alaIpSshPubKeyEnforceAdminStatus"), ("ALCATEL-ENT1-IP-MIB", "alaIpSshStrongCiphersAdminStatus"), ("ALCATEL-ENT1-IP-MIB", "alaIpSshStrongHmacsAdminStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpSshGroup = alaIpSshGroup.setStatus('current')
alaIpTelnetGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 19)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpTelnetAdminStatus"), ("ALCATEL-ENT1-IP-MIB", "alaIpTelnetPort"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpTelnetGroup = alaIpTelnetGroup.setStatus('current')
alaIpNotificationGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 20)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDoSTrap"), ("ALCATEL-ENT1-IP-MIB", "pktDrop"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpItfChange"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiThreshold"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpNotificationGroup = alaIpNotificationGroup.setStatus('current')
alaIpDhcpHostIdentifierGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 21)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpDhcpServerAddressType"), ("ALCATEL-ENT1-IP-MIB", "alaIpDhcpServerAddress"), ("ALCATEL-ENT1-IP-MIB", "alaIpDhcpRouterAddressType"), ("ALCATEL-ENT1-IP-MIB", "alaIpDhcpRouterAddress"), ("ALCATEL-ENT1-IP-MIB", "alaIpDhcpHostName"), ("ALCATEL-ENT1-IP-MIB", "alaIpDhcpClientLeaseObtained"), ("ALCATEL-ENT1-IP-MIB", "alaIpDhcpClientLeaseExpires"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpDhcpHostIdentifierGroup = alaIpDhcpHostIdentifierGroup.setStatus('current')
alaIpNtpGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 22)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpNtpVrfName"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpNtpGroup = alaIpNtpGroup.setStatus('current')
alaIpNetToMediaDpGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 26)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaDpaPhysAddress"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaDpaIpType"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaDpaIp"), ("ALCATEL-ENT1-IP-MIB", "alaIpNetToMediaDpaIfIndex"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIpNetToMediaDpGroup = alaIpNetToMediaDpGroup.setStatus('current')
alaAntiSpoofGlobalGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 27)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofGlobalCountReset"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaAntiSpoofGlobalGroup = alaAntiSpoofGlobalGroup.setStatus('current')
alaAntiSpoofGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 28)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofStatus"), ("ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofMacAddress"), ("ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofIfIndex"), ("ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofVlan"), ("ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofCount"), ("ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofCountReset"), ("ALCATEL-ENT1-IP-MIB", "alaDoSAntiSpoofRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
alaDistArpNiEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 21, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaDistArpNiChassis"), (0, "ALCATEL-ENT1-IP-MIB", "alaDistArpNiSlot"), (0, "ALCATEL-ENT1-IP-MIB", "alaDistArpNiDevice"))
...
alaDistArpNiGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 23)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDistArpNiChassis"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiSlot"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiDevice"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiMaxCount"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiCount"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDistArpNiGroup = alaDistArpNiGroup.setStatus('current')
alaIpServiceSourceIpGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 24)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaIpServiceSourceIpName"), ("ALCATEL-ENT1-IP-MIB", "alaIpServiceSourceIpRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
alaIpServiceSourceIpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 22, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaIpServiceSourceIpAppIndex"))
...
alaDistArpItfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 1, 23, 1), ).setIndexNames((0, "ALCATEL-ENT1-IP-MIB", "alaDistArpNiChassis"), (0, "ALCATEL-ENT1-IP-MIB", "alaDistArpNiSlot"), (0, "ALCATEL-ENT1-IP-MIB", "alaDistArpNiDevice"), (0, "ALCATEL-ENT1-IP-MIB", "alaDistArpItfIfIndex"))
...
alaDistArpItfGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 2, 2, 25)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDistArpItfIfIndex"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpItfCount"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDistArpItfGroup = alaDistArpItfGroup.setStatus('current')
alaDistArpItfChange = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 0, 3)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDistArpItfIfIndex"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiChassis"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiSlot"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiDevice"))
if mibBuilder.loadTexts: alaDistArpItfChange.setStatus('current')
alaDistArpNiThreshold = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 23, 1, 0, 4)).setObjects(("ALCATEL-ENT1-IP-MIB", "alaDistArpNiChassis"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiSlot"), ("ALCATEL-ENT1-IP-MIB", "alaDistArpNiDevice"))
if mibBuilder.loadTexts: alaDistArpNiThreshold.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-IP-MIB", alaIpArpFilterIpMask=alaIpArpFilterIpMask, alaIpInterfacePrimCfg=alaIpInterfacePrimCfg, ipNetToMediaSubType=ipNetToMediaSubType, alaDistArpItfGroup=alaDistArpItfGroup, pktDropFrag=pktDropFrag, alcatelIND1IPMIBNotifications=alcatelIND1IPMIBNotifications, alaDoSAntiSpoofStatus=alaDoSAntiSpoofStatus, ipCidrRouteAugEntry=ipCidrRouteAugEntry, ipNetToMediaSubId=ipNetToMediaSubId, ipCidrRouteAugTable=ipCidrRouteAugTable, pktDrop=pktDrop, alaDoSTrap=alaDoSTrap, alaIpFtpPort=alaIpFtpPort, alaIpNetToMediaDpGroup=alaIpNetToMediaDpGroup, alaIpPortServiceTypeGroup=alaIpPortServiceTypeGroup, alaIpInterfaceDhcpStatus=alaIpInterfaceDhcpStatus, alaIpItfConfigRowStatus=alaIpItfConfigRowStatus, alaIpSshPubKeyEnforceAdminStatus=alaIpSshPubKeyEnforceAdminStatus, alaIpNetToMediaDpaIfIndex=alaIpNetToMediaDpaIfIndex, alaIpInterfaceDhcpIpRelease=alaIpInterfaceDhcpIpRelease, alaDoSPortScanClosePortPenalty=alaDoSPortScanClosePortPenalty, alaDoSAntiSpoofRowStatus=alaDoSAntiSpoofRowStatus, alaIpInterfaceRouterMac=alaIpInterfaceRouterMac, alaDoSAntiSpoofVlan=alaDoSAntiSpoofVlan, alaIpDhcpRouterAddressType=alaIpDhcpRouterAddressType, alaIpSshStrongCiphersAdminStatus=alaIpSshStrongCiphersAdminStatus, alaIpInterfaceRemoteAddr=alaIpInterfaceRemoteAddr, alaIpDhcpServerAddress=alaIpDhcpServerAddress, alaIpTelnetConfig=alaIpTelnetConfig, alaDoSAntiSpoofCount=alaDoSAntiSpoofCount, alaIpNetToMediaGroup=alaIpNetToMediaGroup, alaDoSAntiSpoofIPAddressType=alaDoSAntiSpoofIPAddressType, PYSNMP_MODULE_ID=alcatelIND1IPMIB, alaDoSPort=alaDoSPort, alaIpDhcpClientLeaseExpires=alaIpDhcpClientLeaseExpires, alaIpNetToMediaDpaVlan=alaIpNetToMediaDpaVlan, alaIpItfGroup=alaIpItfGroup, alaIpCompliance=alaIpCompliance, alaIpInterfaceTunnelDstAddressType=alaIpInterfaceTunnelDstAddressType, alaIpNetToMediaDpaIp=alaIpNetToMediaDpaIp, alaDoSPortScanTcpOpenPortPenalty=alaDoSPortScanTcpOpenPortPenalty, alaIpArpFilterVlan=alaIpArpFilterVlan, alaDoSAntiSpoofIfIndex=alaDoSAntiSpoofIfIndex, alaIpNotificationGroup=alaIpNotificationGroup, alaIpNetToMediaDpaEntry=alaIpNetToMediaDpaEntry, alaDoSArpPoisonIpAddr=alaDoSArpPoisonIpAddr, alaIpNtpConfig=alaIpNtpConfig, alaIpRouteSumGroup=alaIpRouteSumGroup, alaDistArpNiSlot=alaDistArpNiSlot, alaIpRouteSumEntry=alaIpRouteSumEntry, alaDoSStatus=alaDoSStatus, alaIpServiceStatus=alaIpServiceStatus, alaIpItfConfigName=alaIpItfConfigName, alaDoSAntiSpoofEntry=alaDoSAntiSpoofEntry, alaIpInterfaceServiceID=alaIpInterfaceServiceID, alaIpInterfaceVlanID=alaIpInterfaceVlanID, alaIpConfig=alaIpConfig, alaIpInterfacePort=alaIpInterfacePort, alcatelIND1IPMIBConformance=alcatelIND1IPMIBConformance, alaDistArpNiCount=alaDistArpNiCount, alcatelIND1IPMIBCompliances=alcatelIND1IPMIBCompliances, alaDistArpNiThreshold=alaDistArpNiThreshold, alaDoSARPRate=alaDoSARPRate, alaIcmpAllMsgStatus=alaIcmpAllMsgStatus, alaDoSAntiSpoofTable=alaDoSAntiSpoofTable, alaIpInterfaceArpNiDevice=alaIpInterfaceArpNiDevice, alaIpTelnetPort=alaIpTelnetPort, alaDoSTrapCntl=alaDoSTrapCntl, alaIpInterfaceArpNiSlot=alaIpInterfaceArpNiSlot, alaDoSGroup=alaDoSGroup, alaDoSArpPoisonTable=alaDoSArpPoisonTable, alaIpNetToMediaPhysAddress=alaIpNetToMediaPhysAddress, pktDropType=pktDropType, alaIcmpCtrlCode=alaIcmpCtrlCode, alaIpInterfaceMtu=alaIpInterfaceMtu, alaIpInterfaceArpCount=alaIpInterfaceArpCount, alaIpSshAdminStatus=alaIpSshAdminStatus, alaDoSType=alaDoSType, alaIpPortServiceStatus=alaIpPortServiceStatus, alaDoSConfig=alaDoSConfig, alaIcmpCtrlStatus=alaIcmpCtrlStatus, alaDoSArpPoisonDetected=alaDoSArpPoisonDetected, alaIpDhcpHostIdentifierObjects=alaIpDhcpHostIdentifierObjects, alaIpPortServicePort=alaIpPortServicePort, alaIcmpCtrl=alaIcmpCtrl, alaIpNtpVrfName=alaIpNtpVrfName, alaIpNetToMediaName=alaIpNetToMediaName, alaIpInterfaceAdminState=alaIpInterfaceAdminState, alaDistArpNiEntry=alaDistArpNiEntry, alaIpServiceTable=alaIpServiceTable, alaIcmpCtrlType=alaIcmpCtrlType, alaDistArpNiGroup=alaDistArpNiGroup, alaIpInterfaceOperReason=alaIpInterfaceOperReason, alaIpInterfaceTable=alaIpInterfaceTable, alaIpInterfacePortIfindex=alaIpInterfacePortIfindex, alaIpSshPort=alaIpSshPort, alaIpArpFilterType=alaIpArpFilterType, alaIpInterfaceVipAddress=alaIpInterfaceVipAddress, alaIpFtpAdminStatus=alaIpFtpAdminStatus, alcatelIND1IPMIBGroups=alcatelIND1IPMIBGroups, alaIpDhcpHostIdentifierGroup=alaIpDhcpHostIdentifierGroup, alaIpInterfaceGroup=alaIpInterfaceGroup, alaIpServiceType=alaIpServiceType, alaIpConfigGroup=alaIpConfigGroup, alaDistArpNiMaxCount=alaDistArpNiMaxCount, ipNetToMediaName=ipNetToMediaName, alaIpInterfaceSlot=alaIpInterfaceSlot, alaIpFtpGroup=alaIpFtpGroup, alaIpServiceSourceIpAppIndex=alaIpServiceSourceIpAppIndex, alaIpInterfaceChassisId=alaIpInterfaceChassisId, ipNetToMediaPort=ipNetToMediaPort, alaDistArpItfCount=alaDistArpItfCount, alaIpDhcpServerAddressType=alaIpDhcpServerAddressType, alaIpDistributedArp=alaIpDistributedArp, AlaIpServiceSourceIpAppIndex=AlaIpServiceSourceIpAppIndex, alaIpItfConfigEntry=alaIpItfConfigEntry, alaIpSshConfig=alaIpSshConfig, alaIcmpCtrlGroup=alaIcmpCtrlGroup, alaDistArpNiDevice=alaDistArpNiDevice, trafficEventTrapObjs=trafficEventTrapObjs, alaDoSPortScanDecay=alaDoSPortScanDecay, alaDoSPortScanTotalPenalty=alaDoSPortScanTotalPenalty, alaIpArpFilterIpAddr=alaIpArpFilterIpAddr, alaDoSAntiSpoofGlobalCountReset=alaDoSAntiSpoofGlobalCountReset, alaDoSSlot=alaDoSSlot, alaIpInterfaceDhcpVsiAcceptFilterString=alaIpInterfaceDhcpVsiAcceptFilterString, alaIpInterfaceMask=alaIpInterfaceMask, alaIpNetToMediaAuth=alaIpNetToMediaAuth, alaIpNetToMediaDpaTable=alaIpNetToMediaDpaTable, alaIpInterfaceTag=alaIpInterfaceTag, alaIpDirectedBroadcast=alaIpDirectedBroadcast, alaDistArpItfChange=alaDistArpItfChange, alaIpNetToMediaDpaPhysAddress=alaIpNetToMediaDpaPhysAddress, alaIpTelnetAdminStatus=alaIpTelnetAdminStatus, alaIpRouteSumTable=alaIpRouteSumTable, alaDistArpItfTable=alaDistArpItfTable, alaIpTelnetGroup=alaIpTelnetGroup, alaIpServicePort=alaIpServicePort, alaArpPingGroup=alaArpPingGroup, alaIpInterfaceDhcpIpRenew=alaIpInterfaceDhcpIpRenew, alaIpInterfaceBcastAddr=alaIpInterfaceBcastAddr, alaIpNetToMediaStaticIntfRt=alaIpNetToMediaStaticIntfRt, alaDoSAntiSpoofMacAddress=alaDoSAntiSpoofMacAddress, alaIpNetToMediaVrrp=alaIpNetToMediaVrrp, ipNetToMediaChassisId=ipNetToMediaChassisId, alaIpClearArpCache=alaIpClearArpCache, alaIpArpFilterMode=alaIpArpFilterMode, alaDoSChassisId=alaDoSChassisId, alaIpInterfaceDhcpOption60String=alaIpInterfaceDhcpOption60String, alaIpInterfaceName=alaIpInterfaceName, alaIpItfConfigIfIndex=alaIpItfConfigIfIndex, alaIpServiceSourceIpName=alaIpServiceSourceIpName, ipNetToMediaAugTable=ipNetToMediaAugTable, alaIpInterfaceEncap=alaIpInterfaceEncap, alaIcmpCtrlEntry=alaIcmpCtrlEntry, ipNetToMediaSlot=ipNetToMediaSlot, alaDoSPortScanThreshold=alaDoSPortScanThreshold, alaIpFtpConfig=alaIpFtpConfig, alaDoSDetected=alaDoSDetected, alaPortScanGroup=alaPortScanGroup, alaDistArpNiTable=alaDistArpNiTable, alaDoSPortScanUdpOpenPortPenalty=alaDoSPortScanUdpOpenPortPenalty, alaIpArpFilterTable=alaIpArpFilterTable, alaAntiSpoofGlobalGroup=alaAntiSpoofGlobalGroup, pktDropCount=pktDropCount, alaIpInterfaceTunnelSrcAddressType=alaIpInterfaceTunnelSrcAddressType, ipCidrRouteScope=ipCidrRouteScope, alaDoSArpPoisonRowStatus=alaDoSArpPoisonRowStatus, alaDistArpNiChassis=alaDistArpNiChassis, alcatelIND1IPMIBObjects=alcatelIND1IPMIBObjects, ipNetToMediaAugEntry=ipNetToMediaAugEntry, alaIpNetToMediaTable=alaIpNetToMediaTable, alaIpPortServiceEntry=alaIpPortServiceEntry, alaIpInterfaceTunnelSrc=alaIpInterfaceTunnelSrc, alaIpCidrAugGroup=alaIpCidrAugGroup, alaIpServiceSourceIpRowStatus=alaIpServiceSourceIpRowStatus, alaIpArpFilterEntry=alaIpArpFilterEntry, alaIcmpCtrlTable=alaIcmpCtrlTable, alaIpServiceSourceIpGroup=alaIpServiceSourceIpGroup, alaIcmpCtrlPktGap=alaIcmpCtrlPktGap, alaIpDhcpHostName=alaIpDhcpHostName, alaIpRouteCount=alaIpRouteCount, alaIpInterfacePrimAct=alaIpInterfacePrimAct, alaIpClearArpFilter=alaIpClearArpFilter, alaIpNetToMediaEntry=alaIpNetToMediaEntry, alaPktDropGroup=alaPktDropGroup, alaDistArpItfEntry=alaDistArpItfEntry, alaIpPortServiceTable=alaIpPortServiceTable, alaIpInterfaceLocalProxyArp=alaIpInterfaceLocalProxyArp, alaIpInterfaceIpForward=alaIpInterfaceIpForward, alaDoSMac=alaDoSMac, alaIpNtpGroup=alaIpNtpGroup, alaDoSAntiSpoofIPAddress=alaDoSAntiSpoofIPAddress, alaIpServiceSourceIpTable=alaIpServiceSourceIpTable, alaIpNetToMediaDpaIpType=alaIpNetToMediaDpaIpType, alaDoSIp=alaDoSIp, alaIpArpFilterRowStatus=alaIpArpFilterRowStatus, alaDistArpItfIfIndex=alaDistArpItfIfIndex, pktDropIfIndex=pktDropIfIndex, alaIpSshGroup=alaIpSshGroup, alaIpNetToMediaAugGroup=alaIpNetToMediaAugGroup, alaDoSPingRate=alaDoSPingRate, alaIpServiceEntry=alaIpServiceEntry, alaIpNetToMediaProxy=alaIpNetToMediaProxy, alaIpRouteProtocol=alaIpRouteProtocol, alaDoSTable=alaDoSTable, alaDoSAntiSpoofCountReset=alaDoSAntiSpoofCountReset, alaIpServiceSourceIpEntry=alaIpServiceSourceIpEntry, alaDoSEntry=alaDoSEntry, alaIpItfConfigTable=alaIpItfConfigTable, alaIpServiceTypeGroup=alaIpServiceTypeGroup, alaIpInterfaceAddress=alaIpInterfaceAddress, alaIpInterfaceDeviceType=alaIpInterfaceDeviceType, alaAntiSpoofGroup=alaAntiSpoofGroup, alaIpArpFilterGroup=alaIpArpFilterGroup, alaIpInterfaceOperState=alaIpInterfaceOperState, alaDoSPortIfindex=alaDoSPortIfindex, alaIpInterfaceEntry=alaIpInterfaceEntry, ipNetToMediaPortIfindex=ipNetToMediaPortIfindex, alaDoSArpPoisonEntry=alaDoSArpPoisonEntry, alaIpInterfaceTunnelDst=alaIpInterfaceTunnelDst, alaIpInterfaceArpNiChassis=alaIpInterfaceArpNiChassis, alcatelIND1IPMIB=alcatelIND1IPMIB, alaIpDhcpRouterAddress=alaIpDhcpRouterAddress, alaIpSshStrongHmacsAdminStatus=alaIpSshStrongHmacsAdminStatus, alaArpPoisonGroup=alaArpPoisonGroup, alaIpDhcpClientLeaseObtained=alaIpDhcpClientLeaseObtained)
