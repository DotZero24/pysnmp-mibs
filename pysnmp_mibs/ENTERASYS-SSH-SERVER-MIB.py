...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-SSH-SERVER-MIB
...
_EtsysSshEnabled_Type.__name__ = "TruthValue"
...
etsysSshCompliance.setObjects(
      *(("ENTERASYS-SSH-SERVER-MIB", "etsysSshBaseGroup"),
        ("ENTERASYS-SSH-SERVER-MIB", "etsysSshAdvancedGroup"),
        ("ENTERASYS-SSH-SERVER-MIB", "etsysSshEventLogGroup"))
)
if mibBuilder.loadTexts:
