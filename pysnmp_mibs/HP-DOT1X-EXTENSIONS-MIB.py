...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hp/HP-DOT1X-EXTENSIONS-MIB
...
dot1xPaePortEntry, dot1xSuppConfigEntry, dot1xAuthConfigEntry, dot1xPaePortNumber = mibBuilder.importSymbols("IEEE8021-PAE-MIB", "dot1xPaePortEntry", "dot1xSuppConfigEntry", "dot1xAuthConfigEntry", "dot1xPaePortNumber")
...
hpicfDot1xMIB.setRevisions(('2021-06-21 00:00', '2018-10-30 00:00', '2018-06-06 00:00', '2017-10-12 00:00', '2017-09-28 00:00', '2017-09-13 00:00', '2016-02-25 00:00', '2016-01-21 00:00', '2013-06-12 00:00', '2013-01-10 00:00', '2012-11-15 00:00', '2011-08-29 00:00', '2011-07-21 00:00', '2011-02-12 00:00', '2010-04-15 00:00', '2009-07-08 00:00', '2009-07-02 00:00', '2007-02-02 00:00', '2005-09-21 00:00', '2005-08-05 00:00', '2004-08-06 00:00',))
if mibBuilder.loadTexts: hpicfDot1xMIB.setLastUpdated('202106210000Z')
...
hpicfAuthMaxEapReq = MibTableColumn((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 1, 2, 1, 1, 9), Unsigned32().clone(2)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hpicfAuthMaxEapReq.setStatus('current')
hpicfDot1xAuthUnauthVidLLDPNwkPolicy = MibTableColumn((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 1, 2, 1, 1, 11), TruthValue().clone('false')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hpicfDot1xAuthUnauthVidLLDPNwkPolicy.setStatus('current')
...
hpicfDot1xAuthEapTlsFragmentSize = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 1, 2, 10), Unsigned32().subtype(subtypeSpec=ConstraintsUnion(ValueRangeConstraint(0, 0), ValueRangeConstraint(576, 3072), ))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hpicfDot1xAuthEapTlsFragmentSize.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xAuthConfigGroup5 = hpicfDot1xAuthConfigGroup5.setStatus('deprecated')
...
hpicfDot1xPaePortEapRetriesGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 2, 1, 22)).setObjects(("HP-DOT1X-EXTENSIONS-MIB", "hpicfAuthMaxEapReq"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xPaePortEapRetriesGroup = hpicfDot1xPaePortEapRetriesGroup.setStatus('current')
hpicfDot1xAuthConfigGroup7 = ObjectGroup((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 2, 1, 23)).setObjects(("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthAuthVid"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthUnauthVid"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthUnauthPeriod"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthLogoffPeriod"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthClientLimit2"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthAllowGvrpVlans"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthCachedReauthPeriod"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthCachedReauthDelay"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xAuthConfigGroup7 = hpicfDot1xAuthConfigGroup7.setStatus('deprecated')
hpicfDot1xAuthConfigGroup8 = ObjectGroup((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 2, 1, 24)).setObjects(("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthAuthVid"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthUnauthVid"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthUnauthPeriod"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthLogoffPeriod"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthClientLimit2"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthAllowGvrpVlans"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthCachedReauthPeriod"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthCachedReauthDelay"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthEnforceCacheReauth"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthUnauthVidLLDPNwkPolicy"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xAuthConfigGroup8 = hpicfDot1xAuthConfigGroup8.setStatus('deprecated')
hpicfDot1xAuthConfigGroup10 = ObjectGroup((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 2, 1, 26)).setObjects(("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthAuthVid"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthUnauthVid"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthUnauthPeriod"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthLogoffPeriod"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthClientLimit2"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthAllowGvrpVlans"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthCachedReauthPeriod"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthCachedReauthDelay"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthEnforceCacheReauth"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthUnauthVidLLDPNwkPolicy"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthEapTlsFragmentSize"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xAuthConfigGroup10 = hpicfDot1xAuthConfigGroup10.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xCompliance13 = hpicfDot1xCompliance13.setStatus('deprecated')
...
hpicfDot1xCompliance15 = ModuleCompliance((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 2, 2, 15)).setObjects(("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xPaePortEapRetriesGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xCompliance15 = hpicfDot1xCompliance15.setStatus('current')
hpicfDot1xCompliance16 = ModuleCompliance((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 2, 2, 16)).setObjects(("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xPaePortGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthConfigGroup7"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xSMAuthConfigGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthStatsGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthSessionStatsGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xSuppConfigGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xCompliance16 = hpicfDot1xCompliance16.setStatus('deprecated')
hpicfDot1xCompliance17 = ModuleCompliance((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 2, 2, 17)).setObjects(("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xPaePortGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthConfigGroup8"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xSMAuthConfigGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthStatsGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthSessionStatsGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xSuppConfigGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xCompliance17 = hpicfDot1xCompliance17.setStatus('deprecated')
hpicfDot1xCompliance19 = ModuleCompliance((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 25, 2, 2, 19)).setObjects(("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xPaePortGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthConfigGroup10"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xSMAuthConfigGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthStatsGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xAuthSessionStatsGroup"), ("HP-DOT1X-EXTENSIONS-MIB", "hpicfDot1xSuppConfigGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfDot1xCompliance19 = hpicfDot1xCompliance19.setStatus('current')
mibBuilder.exportSymbols("HP-DOT1X-EXTENSIONS-MIB", hpicfDot1xAuthEapTlsFragmentSize=hpicfDot1xAuthEapTlsFragmentSize, hpicfDot1xAuthDiagTable=hpicfDot1xAuthDiagTable, hpicfDot1xCompliance16=hpicfDot1xCompliance16, hpicfDot1xSMAuthReAuthEnabled=hpicfDot1xSMAuthReAuthEnabled, hpicfDot1xAuthConfigGroup8=hpicfDot1xAuthConfigGroup8, hpicfDot1xSystem=hpicfDot1xSystem, hpicfDot1xAuthEapolFramesRx=hpicfDot1xAuthEapolFramesRx, hpicfDot1xPaePortEntry=hpicfDot1xPaePortEntry, hpicfDot1xCompliance=hpicfDot1xCompliance, hpicfDot1xAuthSessionVid=hpicfDot1xAuthSessionVid, hpicfDot1xAuthConfigEntry=hpicfDot1xAuthConfigEntry, hpicfDot1xAuthUnauthVid=hpicfDot1xAuthUnauthVid, hpicfDot1xPaePortCritAuthDataVid=hpicfDot1xPaePortCritAuthDataVid, hpicfDot1xPaePortOpenAuthUserRole=hpicfDot1xPaePortOpenAuthUserRole, hpicfDot1xSMAuthPaeState=hpicfDot1xSMAuthPaeState, hpicfDot1xSuppConfigIdentity=hpicfDot1xSuppConfigIdentity, hpicfDot1xCompliance17=hpicfDot1xCompliance17, hpicfDot1xGroups=hpicfDot1xGroups, hpicfDot1xCompliance7=hpicfDot1xCompliance7, hpicfDot1xSMAuthConfigGroup=hpicfDot1xSMAuthConfigGroup, hpicfDot1xAuthSessionTerminateCause=hpicfDot1xAuthSessionTerminateCause, hpicfDot1xPaeAuthSessionGroup=hpicfDot1xPaeAuthSessionGroup, hpicfDot1xCompliance19=hpicfDot1xCompliance19, hpicfDot1xPaePortGroup1=hpicfDot1xPaePortGroup1, hpicfDot1xCompliance2=hpicfDot1xCompliance2, hpicfDot1xPaePortEapRetriesGroup=hpicfDot1xPaePortEapRetriesGroup, hpicfDot1xAuthNumberOfFailedAuthentication=hpicfDot1xAuthNumberOfFailedAuthentication, hpicfDot1xSupplicant=hpicfDot1xSupplicant, hpicfDot1xSMAuthBackendAuthState=hpicfDot1xSMAuthBackendAuthState, hpicfDot1xAuthCachedReauthDelay=hpicfDot1xAuthCachedReauthDelay, hpicfDot1xAuthStatsTable=hpicfDot1xAuthStatsTable, hpicfDot1xAuthConfigGroup4=hpicfDot1xAuthConfigGroup4, hpicfDot1xPaePortAuth=hpicfDot1xPaePortAuth, hpicfDot1xAuthEapolFramesTx=hpicfDot1xAuthEapolFramesTx, hpicfDot1xAuthSessionFramesRx=hpicfDot1xAuthSessionFramesRx, hpicfDot1xAuthEapLengthErrorFramesRx=hpicfDot1xAuthEapLengthErrorFramesRx, hpicfDot1xCompliance15=hpicfDot1xCompliance15, hpicfDot1xAuthSessionUserName=hpicfDot1xAuthSessionUserName, hpicfDot1xConformance=hpicfDot1xConformance, hpicfDot1xSuppConfigPassword=hpicfDot1xSuppConfigPassword, hpicfDot1xPaeAuthSessionGroup1=hpicfDot1xPaeAuthSessionGroup1, hpicfDot1xAuthUnauthPeriod=hpicfDot1xAuthUnauthPeriod, hpicfDot1xAuthAuthVid=hpicfDot1xAuthAuthVid, hpicfDot1xSuppConfigEntry=hpicfDot1xSuppConfigEntry, hpicfDot1xAuthEapolLogoffFramesRx=hpicfDot1xAuthEapolLogoffFramesRx, hpicfDot1xCompliance11=hpicfDot1xCompliance11, PYSNMP_MODULE_ID=hpicfDot1xMIB, hpicfDot1xAuthSessionFramesTx=hpicfDot1xAuthSessionFramesTx, hpicfDot1xAuthClientLimit=hpicfDot1xAuthClientLimit, hpicfDot1xPaePortTable=hpicfDot1xPaePortTable, hpicfDot1xAuthSessionRoleName=hpicfDot1xAuthSessionRoleName, hpicfDot1xSMAuthSessionTimeout=hpicfDot1xSMAuthSessionTimeout, hpicfDot1xAuthConfigGroup7=hpicfDot1xAuthConfigGroup7, hpicfDot1xAuthLogoffPeriod=hpicfDot1xAuthLogoffPeriod, hpicfDot1xSMAuthPaePort=hpicfDot1xSMAuthPaePort, hpicfDot1xAuthSessionStatsEntry=hpicfDot1xAuthSessionStatsEntry, hpicfDot1xAuthEapolRespFramesRx=hpicfDot1xAuthEapolRespFramesRx, hpicfDot1xAuthSessionStatsGroup=hpicfDot1xAuthSessionStatsGroup, hpicfDot1xPaePortInitialRole=hpicfDot1xPaePortInitialRole, hpicfDot1xAuthConfigGroup10=hpicfDot1xAuthConfigGroup10, hpicfDot1xAuthSessionOctetsTx=hpicfDot1xAuthSessionOctetsTx, hpicfDot1xCompliance8=hpicfDot1xCompliance8, hpicfDot1xMIBObjects=hpicfDot1xMIBObjects, hpicfDot1xPaePortCritAuthUserRole=hpicfDot1xPaePortCritAuthUserRole, hpicfDot1xAuthNumberOfSuccessAuthentication=hpicfDot1xAuthNumberOfSuccessAuthentication, hpicfDot1xSMAuthReauthenticate=hpicfDot1xSMAuthReauthenticate, hpicfDot1xCompliance4=hpicfDot1xCompliance4, hpicfDot1xCompliance6=hpicfDot1xCompliance6, hpicfDot1xAuthUnauthVidLLDPNwkPolicy=hpicfDot1xAuthUnauthVidLLDPNwkPolicy, hpicfDot1xMIB=hpicfDot1xMIB, hpicfDot1xAuthConfigGroup3=hpicfDot1xAuthConfigGroup3, hpicfDot1xAuthClientLimit2=hpicfDot1xAuthClientLimit2, hpicfDot1xAuthenticator=hpicfDot1xAuthenticator, hpicfDot1xAuthSessionInactiveTime=hpicfDot1xAuthSessionInactiveTime, hpicfDot1xAuthConfigGroup=hpicfDot1xAuthConfigGroup, hpicfDot1xPaePortMBV=hpicfDot1xPaePortMBV, hpicfDot1xPaePortMixed=hpicfDot1xPaePortMixed, hpicfDot1xAuthStatsGroup=hpicfDot1xAuthStatsGroup, hpicfDot1xSMAuthConfigEntry=hpicfDot1xSMAuthConfigEntry, hpicfDot1xAuthLastEapolFrameVersion=hpicfDot1xAuthLastEapolFrameVersion, hpicfDot1xSMAuthMacAddr=hpicfDot1xSMAuthMacAddr, hpicfDot1xAuthConfigGroup2=hpicfDot1xAuthConfigGroup2, hpicfDot1xAuthEnforceCacheReauth=hpicfDot1xAuthEnforceCacheReauth, hpicfDot1xAuthConfigTable=hpicfDot1xAuthConfigTable, hpicfDot1xPaePortOpenAuthVoiceVid=hpicfDot1xPaePortOpenAuthVoiceVid, hpicfDot1xSMAuthSessionTimeoutGroup=hpicfDot1xSMAuthSessionTimeoutGroup, hpicfDot1xAuthCachedReauthPeriod=hpicfDot1xAuthCachedReauthPeriod, hpicfDot1xAuthSessionId=hpicfDot1xAuthSessionId, hpicfDot1xAuthSessionIsForwarding=hpicfDot1xAuthSessionIsForwarding, hpicfDot1xAuthLastEapolFrameSource=hpicfDot1xAuthLastEapolFrameSource, hpicfDot1xAuthDiagEntry=hpicfDot1xAuthDiagEntry, hpicfDot1xPaePortSupp=hpicfDot1xPaePortSupp, hpicfDot1xSuppConfigPasswordEncrypted=hpicfDot1xSuppConfigPasswordEncrypted, hpicfDot1xSMAuthInitialize=hpicfDot1xSMAuthInitialize, hpicfDot1xAuthEapolReqIdFramesTx=hpicfDot1xAuthEapolReqIdFramesTx, hpicfDot1xAuthConfigGroup5=hpicfDot1xAuthConfigGroup5, hpicfDot1xCompliance5=hpicfDot1xCompliance5, hpicfDot1xSMAuthReAuthPeriod=hpicfDot1xSMAuthReAuthPeriod, hpicfDot1xCompliance13=hpicfDot1xCompliance13, hpicfDot1xCompliances=hpicfDot1xCompliances, hpicfDot1xPaePortSpeedVSA=hpicfDot1xPaePortSpeedVSA, hpicfDot1xAuthSessionStatsTable=hpicfDot1xAuthSessionStatsTable, hpicfDot1xPaePortOpenAuthDataVid=hpicfDot1xPaePortOpenAuthDataVid, hpicfDot1xAuthSessionStartTime=hpicfDot1xAuthSessionStartTime, hpicfDot1xSuppConfigGroup=hpicfDot1xSuppConfigGroup, hpicfAuthMaxEapReq=hpicfAuthMaxEapReq, hpicfDot1xAuthEapolStartFramesRx=hpicfDot1xAuthEapolStartFramesRx, hpicfDot1xAuthEapolReqFramesTx=hpicfDot1xAuthEapolReqFramesTx, hpicfDot1xAuthStatsEntry=hpicfDot1xAuthStatsEntry, hpicfDot1xSMAuthConfigTable=hpicfDot1xSMAuthConfigTable, hpicfDot1xAuthEapolRespIdFramesRx=hpicfDot1xAuthEapolRespIdFramesRx, hpicfDot1xAuthDiagGroup=hpicfDot1xAuthDiagGroup, hpicfDot1xCompliance12=hpicfDot1xCompliance12, hpicfDot1xSuppConfigTable=hpicfDot1xSuppConfigTable, hpicfDot1xAuthInvalidEapolFramesRx=hpicfDot1xAuthInvalidEapolFramesRx, hpicfDot1xSystemGroup=hpicfDot1xSystemGroup, hpicfDot1x2010=hpicfDot1x2010, hpicfDot1xAuthSessionAuthenticMethod=hpicfDot1xAuthSessionAuthenticMethod, hpicfDot1xAuthSessionTime=hpicfDot1xAuthSessionTime, hpicfDot1xPaePortCritAuthVoiceVid=hpicfDot1xPaePortCritAuthVoiceVid, hpicfDot1xCompliance9=hpicfDot1xCompliance9, hpicfDot1xAuthSessionOctetsRx=hpicfDot1xAuthSessionOctetsRx, hpicfDot1xAuthAllowGvrpVlans=hpicfDot1xAuthAllowGvrpVlans, hpicfDot1xCompliance14=hpicfDot1xCompliance14, hpicfDot1xAuthSessionStatsGroup1=hpicfDot1xAuthSessionStatsGroup1, hpicfDot1xAuthSessionPerPAECountersEnabled=hpicfDot1xAuthSessionPerPAECountersEnabled, hpicfDot1xPaePortGroup=hpicfDot1xPaePortGroup, hpicfDot1xCompliance3=hpicfDot1xCompliance3, hpicfDot1xAuthSessionStopTime=hpicfDot1xAuthSessionStopTime)
