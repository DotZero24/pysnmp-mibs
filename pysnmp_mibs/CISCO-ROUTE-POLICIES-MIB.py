...
mibBuilder.exportSymbols("CISCO-ROUTE-POLICIES-MIB", crpPolicyIfIndex=crpPolicyIfIndex, ciscoRoutePoliciesMIBNotifs=ciscoRoutePoliciesMIBNotifs, PYSNMP_MODULE_ID=ciscoRoutePoliciesMIB, ciscoRoutePoliciesMIBConform=ciscoRoutePoliciesMIBConform, ciscoRoutePoliciesMIB=ciscoRoutePoliciesMIB, ciscoRoutePoliciesMIBObjects=ciscoRoutePoliciesMIBObjects, crpPolicies=crpPolicies)
