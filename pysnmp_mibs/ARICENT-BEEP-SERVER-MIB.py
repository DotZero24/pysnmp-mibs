...
fsBeepServerScalars=_FsBeepServerScalars_ObjectIdentity((1,3,6,1,4,1,29601,2,18,1))
...
fsBeepServerAdminStatus=_FsBeepServerAdminStatus_Object((1,3,6,1,4,1,29601,2,18,1,1),_FsBeepServerAdminStatus_Type())
...
fsBeepServerRawProfile=_FsBeepServerRawProfile_Object((1,3,6,1,4,1,29601,2,18,1,2),_FsBeepServerRawProfile_Type())
...
fsBeepServerIpv4PortNum=_FsBeepServerIpv4PortNum_Object((1,3,6,1,4,1,29601,2,18,1,3),_FsBeepServerIpv4PortNum_Type())
