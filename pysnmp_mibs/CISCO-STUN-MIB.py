...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-STUN-MIB
...
stunMibCompliance.setObjects(
      *(("CISCO-STUN-MIB", "stunGlobalGroup"),
        ("CISCO-STUN-MIB", "stunGroupGroup"),
        ("CISCO-STUN-MIB", "stunPortGroup"),
        ("CISCO-STUN-MIB", "stunRouteGroup"))
)
if mibBuilder.loadTexts:
