...
_E='Bits'
_D='h3cFTGroupIndex'
_C='A3COM-HUAWEI-FLOWTEMPLATE-MIB'
_B='read-create'
_A='current'
...
h3cFlowTemplateMibObject=_H3cFlowTemplateMibObject_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,64,1))
_H3cFTConfigGroup_ObjectIdentity=ObjectIdentity
h3cFTConfigGroup=_H3cFTConfigGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,64,1,1))
_H3cFTGroupNextIndex_Type=Integer32
_H3cFTGroupNextIndex_Object=MibScalar
h3cFTGroupNextIndex=_H3cFTGroupNextIndex_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,1),_H3cFTGroupNextIndex_Type())
...
h3cFTGroupTable=_H3cFTGroupTable_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,2))
if mibBuilder.loadTexts:h3cFTGroupTable.setStatus(_A)
_H3cFTGroupEntry_Object=MibTableRow
h3cFTGroupEntry=_H3cFTGroupEntry_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,2,1))
...
h3cFTGroupIndex=_H3cFTGroupIndex_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,2,1,1),_H3cFTGroupIndex_Type())
...
h3cFTGroupName=_H3cFTGroupName_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,2,1,2),_H3cFTGroupName_Type())
...
h3cFTGroupType=_H3cFTGroupType_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,2,1,3),_H3cFTGroupType_Type())
...
h3cFTGroupRowStatus=_H3cFTGroupRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,2,1,4),_H3cFTGroupRowStatus_Type())
...
h3cFTBasicGroupTable=_H3cFTBasicGroupTable_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,3))
if mibBuilder.loadTexts:h3cFTBasicGroupTable.setStatus(_A)
_H3cFTBasicGroupEntry_Object=MibTableRow
h3cFTBasicGroupEntry=_H3cFTBasicGroupEntry_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,3,1))
...
h3cFTBasicGroupAddressType=_H3cFTBasicGroupAddressType_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,3,1,1),_H3cFTBasicGroupAddressType_Type())
...
h3cFTBasicGroupPriorityType=_H3cFTBasicGroupPriorityType_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,3,1,2),_H3cFTBasicGroupPriorityType_Type())
...
h3cFTBasicGroupProtocolType=_H3cFTBasicGroupProtocolType_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,3,1,3),_H3cFTBasicGroupProtocolType_Type())
...
h3cFTBasicGroupSMacWildCard=_H3cFTBasicGroupSMacWildCard_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,3,1,4),_H3cFTBasicGroupSMacWildCard_Type())
...
h3cFTBasicGroupDMacWildCard=_H3cFTBasicGroupDMacWildCard_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,3,1,5),_H3cFTBasicGroupDMacWildCard_Type())
...
h3cFTBasicGroupRowStatus=_H3cFTBasicGroupRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,3,1,6),_H3cFTBasicGroupRowStatus_Type())
...
h3cFTExtendGroupTable=_H3cFTExtendGroupTable_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,4))
if mibBuilder.loadTexts:h3cFTExtendGroupTable.setStatus(_A)
_H3cFTExtendGroupEntry_Object=MibTableRow
h3cFTExtendGroupEntry=_H3cFTExtendGroupEntry_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,4,1))
...
h3cFTExtendGroupOffsetType=_H3cFTExtendGroupOffsetType_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,4,1,1),_H3cFTExtendGroupOffsetType_Type())
...
h3cFTExtendGroupOffsetMaxValue=_H3cFTExtendGroupOffsetMaxValue_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,4,1,2),_H3cFTExtendGroupOffsetMaxValue_Type())
...
h3cFTExtendGroupLengthMaxValue=_H3cFTExtendGroupLengthMaxValue_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,4,1,3),_H3cFTExtendGroupLengthMaxValue_Type())
...
h3cFTExtendGroupRowStatus=_H3cFTExtendGroupRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,1,4,1,4),_H3cFTExtendGroupRowStatus_Type())
...
h3cFTApplyGroup=_H3cFTApplyGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,64,1,2))
_H3cFTIfApplyTable_Object=MibTable
h3cFTIfApplyTable=_H3cFTIfApplyTable_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,2,1))
if mibBuilder.loadTexts:h3cFTIfApplyTable.setStatus(_A)
_H3cFTIfApplyEntry_Object=MibTableRow
h3cFTIfApplyEntry=_H3cFTIfApplyEntry_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,2,1,1))
...
h3cFTIfApplyGroupName=_H3cFTIfApplyGroupName_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,2,1,1,1),_H3cFTIfApplyGroupName_Type())
...
h3cFTIfApplyRowStatus=_H3cFTIfApplyRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,64,1,2,1,1,2),_H3cFTIfApplyRowStatus_Type())
