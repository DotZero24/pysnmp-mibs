...
# Notes
# -----
# ASN.1 source file://mibs/hp/SAVEPOWER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:34:58 2025
...
_HpicfSavepowerEnabledPorts_Type.__name__ = "Unsigned32"
...
hpicfSavepowerComplianceInfo.setObjects(
      *(("SAVEPOWER-MIB", "hpicfSavepowerScalarsGroup"),
        ("SAVEPOWER-MIB", "hpicfSavepowerLEDScalarsGroup"),
        ("SAVEPOWER-MIB", "hpicfSavepowerGreenFeaturesGroup"),
        ("SAVEPOWER-MIB", "hpicfSavepowerPHYGroup"),
        ("SAVEPOWER-MIB", "hpicfSavepowerGroup"),
        ("SAVEPOWER-MIB", "hpicfSavepowerGroup"))
)
if mibBuilder.loadTexts:
...
hpicfPHYComplianceInfo.setObjects(
      *(("SAVEPOWER-MIB", "hpicfSavepowerEntPHYGroup"),
        ("SAVEPOWER-MIB", "hpicfPHYGroups"))
)
if mibBuilder.loadTexts:
