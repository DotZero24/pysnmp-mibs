...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-POWER-ETH-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:17:59 2025
...
if mibBuilder.loadTexts:
    h3cPowerEthernetExt.setRevisions(
        ("2015-07-25 00:00",)
    )
...
h3cPsePDNotificationGroup = NotificationGroup(
...
if mibBuilder.loadTexts:
    h3cPsePDNotificationGroup.setStatus(
        "current"
    )
...
h3cPseCompliance.setObjects(
      *(("H3C-POWER-ETH-EXT-MIB", "h3cPsePortGroup"),
        ("H3C-POWER-ETH-EXT-MIB", "h3cMainPseGroup"),
        ("H3C-POWER-ETH-EXT-MIB", "h3cPseScalarGroup"),
        ("H3C-POWER-ETH-EXT-MIB", "h3cPsePDNotificationGroup"),
        ("H3C-POWER-ETH-EXT-MIB", "h3cPseProfilesGroup"))
)
if mibBuilder.loadTexts:
