...
EntPhysicalIndexOrZero,=mibBuilder.importSymbols('NMS-TC','EntPhysicalIndexOrZero')
...
nmsProcessMIB=ModuleIdentity((1,3,6,1,4,1,3320,9,109))
if mibBuilder.loadTexts:nmsProcessMIB.setRevisions(('2003-10-16 00:00',))
_NmsProcessMIBObjects_ObjectIdentity=ObjectIdentity
nmsProcessMIBObjects=_NmsProcessMIBObjects_ObjectIdentity((1,3,6,1,4,1,3320,9,109,1))
_NmspmCPU_ObjectIdentity=ObjectIdentity
nmspmCPU=_NmspmCPU_ObjectIdentity((1,3,6,1,4,1,3320,9,109,1,1))
_NmspmCPUTotalTable_Object=MibTable
nmspmCPUTotalTable=_NmspmCPUTotalTable_Object((1,3,6,1,4,1,3320,9,109,1,1,1))
if mibBuilder.loadTexts:nmspmCPUTotalTable.setStatus(_A)
_NmspmCPUTotalEntry_Object=MibTableRow
nmspmCPUTotalEntry=_NmspmCPUTotalEntry_Object((1,3,6,1,4,1,3320,9,109,1,1,1,1))
...
nmspmCPUTotalIndex=_NmspmCPUTotalIndex_Object((1,3,6,1,4,1,3320,9,109,1,1,1,1,1),_NmspmCPUTotalIndex_Type())
...
nmspmCPUTotalPhysicalIndex=_NmspmCPUTotalPhysicalIndex_Object((1,3,6,1,4,1,3320,9,109,1,1,1,1,2),_NmspmCPUTotalPhysicalIndex_Type())
...
nmspmCPUTotal5sec=_NmspmCPUTotal5sec_Object((1,3,6,1,4,1,3320,9,109,1,1,1,1,3),_NmspmCPUTotal5sec_Type())
...
nmspmCPUTotal1min=_NmspmCPUTotal1min_Object((1,3,6,1,4,1,3320,9,109,1,1,1,1,4),_NmspmCPUTotal1min_Type())
...
nmspmCPUTotal5min=_NmspmCPUTotal5min_Object((1,3,6,1,4,1,3320,9,109,1,1,1,1,5),_NmspmCPUTotal5min_Type())
...
nmspmCPUMaxUtilization=_NmspmCPUMaxUtilization_Object((1,3,6,1,4,1,3320,9,109,1,1,2),_NmspmCPUMaxUtilization_Type())
...
nmspmCPUClearMaxUtilization=_NmspmCPUClearMaxUtilization_Object((1,3,6,1,4,1,3320,9,109,1,1,3),_NmspmCPUClearMaxUtilization_Type())
...
nmspmProcess=_NmspmProcess_ObjectIdentity((1,3,6,1,4,1,3320,9,109,1,2))
_NmspmProcessTable_Object=MibTable
nmspmProcessTable=_NmspmProcessTable_Object((1,3,6,1,4,1,3320,9,109,1,2,1))
if mibBuilder.loadTexts:nmspmProcessTable.setStatus(_A)
_NmspmProcessEntry_Object=MibTableRow
nmspmProcessEntry=_NmspmProcessEntry_Object((1,3,6,1,4,1,3320,9,109,1,2,1,1))
...
nmspmProcessPID=_NmspmProcessPID_Object((1,3,6,1,4,1,3320,9,109,1,2,1,1,1),_NmspmProcessPID_Type())
...
nmspmProcessName=_NmspmProcessName_Object((1,3,6,1,4,1,3320,9,109,1,2,1,1,2),_NmspmProcessName_Type())
...
nmspmProcessPriority=_NmspmProcessPriority_Object((1,3,6,1,4,1,3320,9,109,1,2,1,1,3),_NmspmProcessPriority_Type())
...
nmspmProcessTimeCreated=_NmspmProcessTimeCreated_Object((1,3,6,1,4,1,3320,9,109,1,2,1,1,4),_NmspmProcessTimeCreated_Type())
...
nmsProcessMIBNotifPrefix=_NmsProcessMIBNotifPrefix_ObjectIdentity((1,3,6,1,4,1,3320,9,109,2))
_NmsProcessMIBNotifs_ObjectIdentity=ObjectIdentity
nmsProcessMIBNotifs=_NmsProcessMIBNotifs_ObjectIdentity((1,3,6,1,4,1,3320,9,109,2,0))
_NmsProcessMIBConformance_ObjectIdentity=ObjectIdentity
nmsProcessMIBConformance=_NmsProcessMIBConformance_ObjectIdentity((1,3,6,1,4,1,3320,9,109,3))
_NmspmCompliances_ObjectIdentity=ObjectIdentity
nmspmCompliances=_NmspmCompliances_ObjectIdentity((1,3,6,1,4,1,3320,9,109,3,1))
_NmspmGroups_ObjectIdentity=ObjectIdentity
nmspmGroups=_NmspmGroups_ObjectIdentity((1,3,6,1,4,1,3320,9,109,3,2))
