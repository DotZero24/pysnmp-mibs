...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/ubiquiti/EdgeSwitch-SWITCHING-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 09:56:57 2025
...
agentLagSummaryLocalPreferenceMode = MibScalar((1, 3, 6, 1, 4, 1, 4413, 1, 1, 1, 2, 2, 2, 1, 14), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2)))).setMaxAccess("readwrite")
...
agentDynamicAuthorizationClientEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 1, 2, 28, 8, 1), ).setIndexNames((0, "EdgeSwitch-SWITCHING-MIB", "agentDynamicAuthorizationClientAddress"))
...
loginSessionStartStopTrap = NotificationType((1, 3, 6, 1, 4, 1, 4413, 1, 1, 1, 0, 29)).setObjects(("EdgeSwitch-SWITCHING-MIB", "agentLoginSessionIndex"), ("EdgeSwitch-SWITCHING-MIB", "agentLoginSessionUserName"), ("EdgeSwitch-SWITCHING-MIB", "agentLoginSessionConnectionType"), ("EdgeSwitch-SWITCHING-MIB", "agentLoginSessionInetAddress"), ("EdgeSwitch-SWITCHING-MIB", "agentLoginSessionStatus"))
if mibBuilder.loadTexts: loginSessionStartStopTrap.setStatus('current')
agentSwitchStormControlTrap = NotificationType((1, 3, 6, 1, 4, 1, 4413, 1, 1, 1, 0, 31)).setObjects(("IF-MIB", "ifIndex"), ("EdgeSwitch-SWITCHING-MIB", "agentSwitchStormControlType"), ("EdgeSwitch-SWITCHING-MIB", "agentSwitchStormControlAction"))
...
agentLinkDependencyGroupEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 1, 2, 27, 1, 1), ).setIndexNames((0, "EdgeSwitch-SWITCHING-MIB", "agentLinkDependencyGroupIndex"))
