...
mibBuilder.exportSymbols("IP-FORWARD-MIB", PYSNMP_MODULE_ID=ipForward, inetCidrRouteMetric5=inetCidrRouteMetric5, ipForwardReadOnlyCompliance=ipForwardReadOnlyCompliance, ipForwardNumber=ipForwardNumber, ipCidrRouteEntry=ipCidrRouteEntry, ipCidrRouteMask=ipCidrRouteMask, ipForwardCompliance=ipForwardCompliance, ipForwardEntry=ipForwardEntry, ipCidrRouteNumber=ipCidrRouteNumber, ipCidrRouteDest=ipCidrRouteDest, ipForwardPolicy=ipForwardPolicy, inetCidrRouteNextHop=inetCidrRouteNextHop, ipForwardInfo=ipForwardInfo, inetCidrRouteNextHopAS=inetCidrRouteNextHopAS, inetCidrRouteMetric2=inetCidrRouteMetric2, inetCidrRouteMetric3=inetCidrRouteMetric3, ipForwardFullCompliance=ipForwardFullCompliance, inetCidrRouteEntry=inetCidrRouteEntry, ipCidrRouteMetric1=ipCidrRouteMetric1, ipForwardConformance=ipForwardConformance, ipForwardCompliances=ipForwardCompliances, ipForwardMetric5=ipForwardMetric5, inetCidrRouteIfIndex=inetCidrRouteIfIndex, ipCidrRouteNextHopAS=ipCidrRouteNextHopAS, ipCidrRouteIfIndex=ipCidrRouteIfIndex, inetCidrRoutePolicy=inetCidrRoutePolicy, ipForwardIfIndex=ipForwardIfIndex, ipCidrRouteMetric3=ipCidrRouteMetric3, ipCidrRouteTos=ipCidrRouteTos, inetCidrRouteProto=inetCidrRouteProto, ipForwardType=ipForwardType, inetCidrRouteMetric4=inetCidrRouteMetric4, inetCidrRouteMetric1=inetCidrRouteMetric1, ipForwardNextHop=ipForwardNextHop, ipCidrRouteType=ipCidrRouteType, ipCidrRouteStatus=ipCidrRouteStatus, ipCidrRouteMetric5=ipCidrRouteMetric5, ipForwardMetric4=ipForwardMetric4, inetCidrRouteAge=inetCidrRouteAge, ipForwardMetric2=ipForwardMetric2, ipForwardDest=ipForwardDest, ipForwardMask=ipForwardMask, ipForwardProto=ipForwardProto, ipForwardCidrRouteGroup=ipForwardCidrRouteGroup, inetCidrRouteDest=inetCidrRouteDest, ipForwardAge=ipForwardAge, ipCidrRouteAge=ipCidrRouteAge, ipForwardMetric1=ipForwardMetric1, ipForwardTable=ipForwardTable, ipForwardMetric3=ipForwardMetric3, inetCidrRouteNextHopType=inetCidrRouteNextHopType, ipCidrRouteNextHop=ipCidrRouteNextHop, inetCidrRouteType=inetCidrRouteType, ipForward=ipForward, inetCidrRouteNumber=inetCidrRouteNumber, inetForwardCidrRouteGroup=inetForwardCidrRouteGroup, ipCidrRouteProto=ipCidrRouteProto, inetCidrRouteDiscards=inetCidrRouteDiscards, inetCidrRouteTable=inetCidrRouteTable, ipForwardMultiPathGroup=ipForwardMultiPathGroup, inetCidrRouteStatus=inetCidrRouteStatus, ipForwardGroups=ipForwardGroups, ipCidrRouteTable=ipCidrRouteTable, ipForwardOldCompliance=ipForwardOldCompliance, ipCidrRouteInfo=ipCidrRouteInfo, ipCidrRouteMetric4=ipCidrRouteMetric4, inetCidrRouteDestType=inetCidrRouteDestType, ipCidrRouteMetric2=ipCidrRouteMetric2, inetCidrRoutePfxLen=inetCidrRoutePfxLen, ipForwardNextHopAS=ipForwardNextHopAS)
