# SNMP MIB module (NETGEAR-RADLAN-MIR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-MIR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:40 2025
...
rlMirInterfaceEntry = _RlMirInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 61, 5, 1)
)
rlMirInterfaceEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-MIR-MIB", "rlMirInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
rlMirVlanBaseReservedPortsEntry = _RlMirVlanBaseReservedPortsEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 61, 6, 1)
)
rlMirVlanBaseReservedPortsEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-MIR-MIB", "rlMirVlanBaseReservedPortsIfIndex"),
)
if mibBuilder.loadTexts:
...
rlMirVlanBaseLogicalPortsEntry = _RlMirVlanBaseLogicalPortsEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 61, 7, 1)
)
rlMirVlanBaseLogicalPortsEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-MIR-MIB", "rlMirVlanBaseLogicalPortsIfIndex"),
)
if mibBuilder.loadTexts:
