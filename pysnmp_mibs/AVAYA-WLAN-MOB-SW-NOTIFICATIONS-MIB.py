...
mibBuilder.exportSymbols("AVAYA-WLAN-MOB-SW-NOTIFICATIONS-MIB", avWlanSwitchPeerDeviceConnectionEstablished=avWlanSwitchPeerDeviceConnectionEstablished, avWlanNotifAuxInetAddressType=avWlanNotifAuxInetAddressType, avWlanNotifAuxVlanState=avWlanNotifAuxVlanState, avWlanSwitchPeerDeviceLostConnection=avWlanSwitchPeerDeviceLostConnection, avWlanSwitchVlanRoleChanged=avWlanSwitchVlanRoleChanged, avWlanNotifAuxMSTDownloadEntries=avWlanNotifAuxMSTDownloadEntries, avWlanSwitchVlanGenNumberMismatch=avWlanSwitchVlanGenNumberMismatch, avWlanNotifAuxMobilityVlanName=avWlanNotifAuxMobilityVlanName, avayaWlanMobSwitchNotificationsMib=avayaWlanMobSwitchNotificationsMib, avWlanNotifAuxRemoveReason=avWlanNotifAuxRemoveReason, avWlanSwitchLostConnectionToVlanServer=avWlanSwitchLostConnectionToVlanServer, avWlanSwitchIgmpControlFrameReceived=avWlanSwitchIgmpControlFrameReceived, avWlanNotifAuxStateChangeReason=avWlanNotifAuxStateChangeReason, avWlanSwitchNotifAuxAuxLimitsReached=avWlanSwitchNotifAuxAuxLimitsReached, avWlanSwitchVlanMapRemoved=avWlanSwitchVlanMapRemoved, avWlanNotifAuxOldState=avWlanNotifAuxOldState, avWlanSwitchVlanServerElected=avWlanSwitchVlanServerElected, avWlanSwitchMCPConnectionEstablished=avWlanSwitchMCPConnectionEstablished, avWlanNotifAuxPeerDeviceAddress=avWlanNotifAuxPeerDeviceAddress, avWlanMobSwNotificationAuxObjects=avWlanMobSwNotificationAuxObjects, avWlanNotifAuxMobilityControllerInetAddress=avWlanNotifAuxMobilityControllerInetAddress, avWlanMobSwNotifications=avWlanMobSwNotifications, avWlanNotifAuxInetAddress=avWlanNotifAuxInetAddress, avWlanSwitchNotifications=avWlanSwitchNotifications, avWlanSwitchIgmpSnoopingDisabled=avWlanSwitchIgmpSnoopingDisabled, avWlanSwitchIgmpSnoopingEnabled=avWlanSwitchIgmpSnoopingEnabled, avWlanSwitchMSTDownload=avWlanSwitchMSTDownload, avWlanMobSwNotificationObjects=avWlanMobSwNotificationObjects, PYSNMP_MODULE_ID=avayaWlanMobSwitchNotificationsMib, avWlanNotifAuxVlanServerAddress=avWlanNotifAuxVlanServerAddress, avWlanNotifAuxControlFrameType=avWlanNotifAuxControlFrameType, avWlanNotifAuxVlanServerInetAddress=avWlanNotifAuxVlanServerInetAddress, avWlanSwitchMCPLostConnection=avWlanSwitchMCPLostConnection, avWlanSwitchVlanTrackAffected=avWlanSwitchVlanTrackAffected, avWlanNotifAuxMobilityVlanPeerGenerationNumber=avWlanNotifAuxMobilityVlanPeerGenerationNumber, avWlanNotifAuxNewVlanRole=avWlanNotifAuxNewVlanRole, avWlanNotifAuxMobilityControllerInetAddressType=avWlanNotifAuxMobilityControllerInetAddressType, avWlanNotifAuxOldVlanRole=avWlanNotifAuxOldVlanRole, avWlanNotifAuxVlanServerInetAddressType=avWlanNotifAuxVlanServerInetAddressType, avWlanNotifAuxNewState=avWlanNotifAuxNewState, avWlanSwitchVlanMapStateChanged=avWlanSwitchVlanMapStateChanged, avWlanNotifAuxMobilityVlanSelfGenerationNumber=avWlanNotifAuxMobilityVlanSelfGenerationNumber, avWlanNotifAuxPeerDeviceInetAddress=avWlanNotifAuxPeerDeviceInetAddress, avWlanSwitchMVTDownload=avWlanSwitchMVTDownload, avWlanNotifAuxConnectionFailureReason=avWlanNotifAuxConnectionFailureReason, avWlanNotifAuxNumberOfVlanEntries=avWlanNotifAuxNumberOfVlanEntries, avWlanNotifAuxPeerDeviceType=avWlanNotifAuxPeerDeviceType, avWlanNotifAuxRoleChangeReason=avWlanNotifAuxRoleChangeReason, avWlanSwitchLimitsReached=avWlanSwitchLimitsReached, avWlanNotifAuxPeerDeviceInetAddressType=avWlanNotifAuxPeerDeviceInetAddressType)
