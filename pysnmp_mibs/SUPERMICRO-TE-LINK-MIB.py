...
fstlm=ModuleIdentity((1,3,6,1,4,1,10876,101,2,67))
if mibBuilder.loadTexts:fstlm.setRevisions(('2012-09-17 00:00',))
_FsTlmSystem_ObjectIdentity=ObjectIdentity
fsTlmSystem=_FsTlmSystem_ObjectIdentity((1,3,6,1,4,1,10876,101,2,67,1))
...
fsTeLinkTraceOption=_FsTeLinkTraceOption_Object((1,3,6,1,4,1,10876,101,2,67,1,1),_FsTeLinkTraceOption_Type())
...
fsTeLinkModuleStatus=_FsTeLinkModuleStatus_Object((1,3,6,1,4,1,10876,101,2,67,1,2),_FsTeLinkModuleStatus_Type())
...
fsTeLinkConfigObjects=_FsTeLinkConfigObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,2,67,2))
_FsTeLinkTable_Object=MibTable
fsTeLinkTable=_FsTeLinkTable_Object((1,3,6,1,4,1,10876,101,2,67,2,1))
if mibBuilder.loadTexts:fsTeLinkTable.setStatus(_A)
_FsTeLinkEntry_Object=MibTableRow
fsTeLinkEntry=_FsTeLinkEntry_Object((1,3,6,1,4,1,10876,101,2,67,2,1,1))
...
fsTeLinkName=_FsTeLinkName_Object((1,3,6,1,4,1,10876,101,2,67,2,1,1,1),_FsTeLinkName_Type())
...
fsTeLinkRemoteRtrId=_FsTeLinkRemoteRtrId_Object((1,3,6,1,4,1,10876,101,2,67,2,1,1,2),_FsTeLinkRemoteRtrId_Type())
...
fsTeLinkMaximumBandwidth=_FsTeLinkMaximumBandwidth_Object((1,3,6,1,4,1,10876,101,2,67,2,1,1,3),_FsTeLinkMaximumBandwidth_Type())
...
fsTeLinkType=_FsTeLinkType_Object((1,3,6,1,4,1,10876,101,2,67,2,1,1,4),_FsTeLinkType_Type())
...
fsTeLinkInfoType=_FsTeLinkInfoType_Object((1,3,6,1,4,1,10876,101,2,67,2,1,1,5),_FsTeLinkInfoType_Type())
...
fsTeLinkIfType=_FsTeLinkIfType_Object((1,3,6,1,4,1,10876,101,2,67,2,1,1,6),_FsTeLinkIfType_Type())
...
fsTeLinkIsAdvertise=_FsTeLinkIsAdvertise_Object((1,3,6,1,4,1,10876,101,2,67,2,1,1,7),_FsTeLinkIsAdvertise_Type())
...
fsTeLinkBwThresholdTable=_FsTeLinkBwThresholdTable_Object((1,3,6,1,4,1,10876,101,2,67,2,2))
if mibBuilder.loadTexts:fsTeLinkBwThresholdTable.setStatus(_A)
_FsTeLinkBwThresholdEntry_Object=MibTableRow
fsTeLinkBwThresholdEntry=_FsTeLinkBwThresholdEntry_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1))
...
fsTeLinkBwThresholdIndex=_FsTeLinkBwThresholdIndex_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,1),_FsTeLinkBwThresholdIndex_Type())
...
fsTeLinkBwThreshold0=_FsTeLinkBwThreshold0_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,2),_FsTeLinkBwThreshold0_Type())
...
fsTeLinkBwThreshold1=_FsTeLinkBwThreshold1_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,3),_FsTeLinkBwThreshold1_Type())
...
fsTeLinkBwThreshold2=_FsTeLinkBwThreshold2_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,4),_FsTeLinkBwThreshold2_Type())
...
fsTeLinkBwThreshold3=_FsTeLinkBwThreshold3_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,5),_FsTeLinkBwThreshold3_Type())
...
fsTeLinkBwThreshold4=_FsTeLinkBwThreshold4_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,6),_FsTeLinkBwThreshold4_Type())
...
fsTeLinkBwThreshold5=_FsTeLinkBwThreshold5_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,7),_FsTeLinkBwThreshold5_Type())
...
fsTeLinkBwThreshold6=_FsTeLinkBwThreshold6_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,8),_FsTeLinkBwThreshold6_Type())
...
fsTeLinkBwThreshold7=_FsTeLinkBwThreshold7_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,9),_FsTeLinkBwThreshold7_Type())
...
fsTeLinkBwThreshold8=_FsTeLinkBwThreshold8_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,10),_FsTeLinkBwThreshold8_Type())
...
fsTeLinkBwThreshold9=_FsTeLinkBwThreshold9_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,11),_FsTeLinkBwThreshold9_Type())
...
fsTeLinkBwThreshold10=_FsTeLinkBwThreshold10_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,12),_FsTeLinkBwThreshold10_Type())
...
fsTeLinkBwThreshold11=_FsTeLinkBwThreshold11_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,13),_FsTeLinkBwThreshold11_Type())
...
fsTeLinkBwThreshold12=_FsTeLinkBwThreshold12_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,14),_FsTeLinkBwThreshold12_Type())
...
fsTeLinkBwThreshold13=_FsTeLinkBwThreshold13_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,15),_FsTeLinkBwThreshold13_Type())
...
fsTeLinkBwThreshold14=_FsTeLinkBwThreshold14_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,16),_FsTeLinkBwThreshold14_Type())
...
fsTeLinkBwThreshold15=_FsTeLinkBwThreshold15_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,17),_FsTeLinkBwThreshold15_Type())
...
fsTeLinkBwThresholdRowStatus=_FsTeLinkBwThresholdRowStatus_Object((1,3,6,1,4,1,10876,101,2,67,2,2,1,18),_FsTeLinkBwThresholdRowStatus_Type())
...
fsTeLinkBwThresholdForceOption=_FsTeLinkBwThresholdForceOption_Object((1,3,6,1,4,1,10876,101,2,67,2,3),_FsTeLinkBwThresholdForceOption_Type())
