...
mySysStpReset=_MySysStpReset_Object((1,3,6,1,4,1,4881,1,1,10,2,16,1,2),_MySysStpReset_Type())
mySysStpReset.setMaxAccess(_D)
if mibBuilder.loadTexts:mySysStpReset.setStatus(_A)
_MyStpExtPortTable_Object=MibTable
myStpExtPortTable=_MyStpExtPortTable_Object((1,3,6,1,4,1,4881,1,1,10,2,16,1,3))
if mibBuilder.loadTexts:myStpExtPortTable.setStatus(_A)
_MyStpExtPortEntry_Object=MibTableRow
myStpExtPortEntry=_MyStpExtPortEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,16,1,3,1))
...
myStpPortIfIndex=_MyStpPortIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,16,1,3,1,1),_MyStpPortIfIndex_Type())
...
myStpPortAdminPathCost=_MyStpPortAdminPathCost_Object((1,3,6,1,4,1,4881,1,1,10,2,16,1,3,1,2),_MyStpPortAdminPathCost_Type())
...
myStpPortOperPathCost=_MyStpPortOperPathCost_Object((1,3,6,1,4,1,4881,1,1,10,2,16,1,3,1,3),_MyStpPortOperPathCost_Type())
...
myStpPortRole=_MyStpPortRole_Object((1,3,6,1,4,1,4881,1,1,10,2,16,1,3,1,4),_MyStpPortRole_Type())
...
myRstpMIBObjects=_MyRstpMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,2))
...
myStpVersion=_MyStpVersion_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,1),_MyStpVersion_Type())
...
myStpTxHoldCount=_MyStpTxHoldCount_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,2),_MyStpTxHoldCount_Type())
...
myStpPathCostDefault=_MyStpPathCostDefault_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,3),_MyStpPathCostDefault_Type())
...
myRstpExtPortTable=_MyRstpExtPortTable_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4))
if mibBuilder.loadTexts:myRstpExtPortTable.setStatus(_A)
_MyRstpExtPortEntry_Object=MibTableRow
myRstpExtPortEntry=_MyRstpExtPortEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4,1))
...
myRstpExtPortIfIndex=_MyRstpExtPortIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4,1,1),_MyRstpExtPortIfIndex_Type())
...
myStpPortProtocolMigration=_MyStpPortProtocolMigration_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4,1,2),_MyStpPortProtocolMigration_Type())
...
myStpPortAdminEdgePort=_MyStpPortAdminEdgePort_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4,1,3),_MyStpPortAdminEdgePort_Type())
...
myStpPortOperEdgePort=_MyStpPortOperEdgePort_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4,1,4),_MyStpPortOperEdgePort_Type())
...
myStpPortAdminPointToPoint=_MyStpPortAdminPointToPoint_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4,1,5),_MyStpPortAdminPointToPoint_Type())
...
myStpPortOperPointToPoint=_MyStpPortOperPointToPoint_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4,1,6),_MyStpPortOperPointToPoint_Type())
...
myStpPortBpduGuard=_MyStpPortBpduGuard_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4,1,7),_MyStpPortBpduGuard_Type())
...
myStpPortBpduFilter=_MyStpPortBpduFilter_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,4,1,8),_MyStpPortBpduFilter_Type())
...
myStpBpduGuard=_MyStpBpduGuard_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,5),_MyStpBpduGuard_Type())
...
myStpBpduFilter=_MyStpBpduFilter_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,6),_MyStpBpduFilter_Type())
...
myStpCistRegionRoot=_MyStpCistRegionRoot_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,7),_MyStpCistRegionRoot_Type())
...
myStpCistPathCost=_MyStpCistPathCost_Object((1,3,6,1,4,1,4881,1,1,10,2,16,2,8),_MyStpCistPathCost_Type())
...
myMstpMIBObjects=_MyMstpMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,3))
_MyStpMstiMaxInstanceNumber_Type=Integer32
_MyStpMstiMaxInstanceNumber_Object=MibScalar
myStpMstiMaxInstanceNumber=_MyStpMstiMaxInstanceNumber_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,1),_MyStpMstiMaxInstanceNumber_Type())
...
myStpMstiRegionName=_MyStpMstiRegionName_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,2),_MyStpMstiRegionName_Type())
...
myStpMstiRegionRevision=_MyStpMstiRegionRevision_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,3),_MyStpMstiRegionRevision_Type())
...
myStpMstiMaxHopNumber=_MyStpMstiMaxHopNumber_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,4),_MyStpMstiMaxHopNumber_Type())
...
myStpMstiInstanceTable=_MyStpMstiInstanceTable_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5))
if mibBuilder.loadTexts:myStpMstiInstanceTable.setStatus(_A)
_MyStpMstiInstanceEntry_Object=MibTableRow
myStpMstiInstanceEntry=_MyStpMstiInstanceEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1))
...
myStpMstiInstanceIndex=_MyStpMstiInstanceIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,1),_MyStpMstiInstanceIndex_Type())
...
myStpMstiInstanceVlansAddMapped=_MyStpMstiInstanceVlansAddMapped_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,2),_MyStpMstiInstanceVlansAddMapped_Type())
...
myStpMstiInstanceVlansDeleteMapped=_MyStpMstiInstanceVlansDeleteMapped_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,3),_MyStpMstiInstanceVlansDeleteMapped_Type())
...
myStpMstiInstanceVlansGetMapped=_MyStpMstiInstanceVlansGetMapped_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,4),_MyStpMstiInstanceVlansGetMapped_Type())
...
myStpMstiInstanceRemainingHopCount=_MyStpMstiInstanceRemainingHopCount_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,5),_MyStpMstiInstanceRemainingHopCount_Type())
...
myStpMstiPriority=_MyStpMstiPriority_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,6),_MyStpMstiPriority_Type())
...
myStpMstiTimeSinceTopologyChange=_MyStpMstiTimeSinceTopologyChange_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,7),_MyStpMstiTimeSinceTopologyChange_Type())
...
myStpMstiTopChanges=_MyStpMstiTopChanges_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,8),_MyStpMstiTopChanges_Type())
...
myStpMstiDesignatedRoot=_MyStpMstiDesignatedRoot_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,9),_MyStpMstiDesignatedRoot_Type())
...
myStpMstiRootCost=_MyStpMstiRootCost_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,10),_MyStpMstiRootCost_Type())
...
myStpMstiRootPort=_MyStpMstiRootPort_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,11),_MyStpMstiRootPort_Type())
...
myStpMstiInstanceEntryStatus=_MyStpMstiInstanceEntryStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,5,1,12),_MyStpMstiInstanceEntryStatus_Type())
...
myStpPortMstiInstanceTable=_MyStpPortMstiInstanceTable_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6))
if mibBuilder.loadTexts:myStpPortMstiInstanceTable.setStatus(_A)
_MyStpPortMstiInstanceEntry_Object=MibTableRow
myStpPortMstiInstanceEntry=_MyStpPortMstiInstanceEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1))
...
myStpPortMstiIndex=_MyStpPortMstiIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,1),_MyStpPortMstiIndex_Type())
...
myStpPortMstiState=_MyStpPortMstiState_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,2),_MyStpPortMstiState_Type())
...
myStpPortMstiAdminPathCost=_MyStpPortMstiAdminPathCost_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,3),_MyStpPortMstiAdminPathCost_Type())
...
myStpPortMstiOperPathCost=_MyStpPortMstiOperPathCost_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,4),_MyStpPortMstiOperPathCost_Type())
...
myStpPortMstiPriority=_MyStpPortMstiPriority_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,5),_MyStpPortMstiPriority_Type())
...
myStpPortMstiDesignatedRoot=_MyStpPortMstiDesignatedRoot_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,6),_MyStpPortMstiDesignatedRoot_Type())
...
myStpPortMstiDesignatedCost=_MyStpPortMstiDesignatedCost_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,7),_MyStpPortMstiDesignatedCost_Type())
...
myStpPortMstiDesignatedBridge=_MyStpPortMstiDesignatedBridge_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,8),_MyStpPortMstiDesignatedBridge_Type())
...
myStpPortMstiDesignatedPort=_MyStpPortMstiDesignatedPort_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,9),_MyStpPortMstiDesignatedPort_Type())
...
myStpPortMstiPortRole=_MyStpPortMstiPortRole_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,10),_MyStpPortMstiPortRole_Type())
...
myStpPortMstiPortForwardTransitions=_MyStpPortMstiPortForwardTransitions_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,6,1,11),_MyStpPortMstiPortForwardTransitions_Type())
...
myStpMstiReset=_MyStpMstiReset_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,7),_MyStpMstiReset_Type())
...
myStpCistVlansAddMapped=_MyStpCistVlansAddMapped_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,8),_MyStpCistVlansAddMapped_Type())
...
myStpCistVlansGetMapped=_MyStpCistVlansGetMapped_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,9),_MyStpCistVlansGetMapped_Type())
...
myStpCistRemainingHopCount=_MyStpCistRemainingHopCount_Object((1,3,6,1,4,1,4881,1,1,10,2,16,3,10),_MyStpCistRemainingHopCount_Type())
...
stpExternConformance=_StpExternConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,4))
_StpExternGroups_ObjectIdentity=ObjectIdentity
stpExternGroups=_StpExternGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,4,1))
_RstpConformance_ObjectIdentity=ObjectIdentity
rstpConformance=_RstpConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,5))
_RstpGroups_ObjectIdentity=ObjectIdentity
rstpGroups=_RstpGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,5,1))
_RstpCompliances_ObjectIdentity=ObjectIdentity
rstpCompliances=_RstpCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,5,2))
_MstpConformance_ObjectIdentity=ObjectIdentity
mstpConformance=_MstpConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,6))
_MstpGroups_ObjectIdentity=ObjectIdentity
mstpGroups=_MstpGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,6,1))
_MstpCompliances_ObjectIdentity=ObjectIdentity
mstpCompliances=_MstpCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,16,6,2))
stpExternGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,16,4,1,1))
stpExternGroup.setObjects(*((_B,_U),(_B,_V),(_B,_I),(_B,_W),(_B,_X),(_B,_Y)))
if mibBuilder.loadTexts:stpExternGroup.setStatus(_A)
rstpBridgeGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,16,5,1,1))
rstpBridgeGroup.setObjects(*((_B,_Z),(_B,_a),(_B,_b),(_B,_c)))
if mibBuilder.loadTexts:rstpBridgeGroup.setStatus(_A)
rstpDefaultPathCostGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,16,5,1,2))
rstpDefaultPathCostGroup.setObjects((_B,_d))
if mibBuilder.loadTexts:rstpDefaultPathCostGroup.setStatus(_A)
rstpPortGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,16,5,1,3))
...
mstpBridgeRegionGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,16,6,1,1))
mstpBridgeRegionGroup.setObjects(*((_B,_n),(_B,_o),(_B,_p),(_B,_q)))
if mibBuilder.loadTexts:mstpBridgeRegionGroup.setStatus(_A)
mstpMstiBridgeGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,16,6,1,2))
...
mstpMstiPortGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,16,6,1,3))
...
rstpCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,16,5,2,1))
rstpCompliance.setObjects(*((_B,_AC),(_B,_L),(_B,_AD),(_B,_L)))
if mibBuilder.loadTexts:rstpCompliance.setStatus(_A)
mstpCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,16,6,2,1))
