# SNMP MIB module (MY-RSTP-MSTP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-RSTP-MSTP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:35:07 2025
...
myStpExtPortEntry.setIndexNames(
    (0, "MY-RSTP-MSTP-MIB", "myStpPortIfIndex"),
)
if mibBuilder.loadTexts:
...
myRstpExtPortEntry.setIndexNames(
    (0, "MY-RSTP-MSTP-MIB", "myRstpExtPortIfIndex"),
)
if mibBuilder.loadTexts:
...
myStpMstiInstanceEntry.setIndexNames(
    (0, "MY-RSTP-MSTP-MIB", "myStpMstiInstanceIndex"),
)
if mibBuilder.loadTexts:
...
myStpPortMstiInstanceEntry.setIndexNames(
    (0, "MY-RSTP-MSTP-MIB", "myStpMstiInstanceIndex"),
    (0, "MY-RSTP-MSTP-MIB", "myStpPortMstiIndex"),
)
if mibBuilder.loadTexts:
...
stpExternGroup.setObjects(
      *(("MY-RSTP-MSTP-MIB", "mySysStpStatus"),
        ("MY-RSTP-MSTP-MIB", "mySysStpReset"),
        ("MY-RSTP-MSTP-MIB", "myStpPortIfIndex"),
        ("MY-RSTP-MSTP-MIB", "myStpPortAdminPathCost"),
        ("MY-RSTP-MSTP-MIB", "myStpPortOperPathCost"),
        ("MY-RSTP-MSTP-MIB", "myStpPortRole"))
)
if mibBuilder.loadTexts:
...
rstpBridgeGroup.setObjects(
      *(("MY-RSTP-MSTP-MIB", "myStpVersion"),
        ("MY-RSTP-MSTP-MIB", "myStpTxHoldCount"),
        ("MY-RSTP-MSTP-MIB", "myStpBpduGuard"),
        ("MY-RSTP-MSTP-MIB", "myStpBpduFilter"))
)
if mibBuilder.loadTexts:
...
rstpDefaultPathCostGroup.setObjects(
    ("MY-RSTP-MSTP-MIB", "myStpPathCostDefault")
)
if mibBuilder.loadTexts:
...
rstpPortGroup.setObjects(
      *(("MY-RSTP-MSTP-MIB", "myRstpExtPortIfIndex"),
        ("MY-RSTP-MSTP-MIB", "myStpPortProtocolMigration"),
        ("MY-RSTP-MSTP-MIB", "myStpPortAdminEdgePort"),
        ("MY-RSTP-MSTP-MIB", "myStpPortOperEdgePort"),
        ("MY-RSTP-MSTP-MIB", "myStpPortAdminPointToPoint"),
        ("MY-RSTP-MSTP-MIB", "myStpPortOperPointToPoint"),
        ("MY-RSTP-MSTP-MIB", "myStpPortBpduGuard"),
        ("MY-RSTP-MSTP-MIB", "myStpPortBpduFilter"),
        ("MY-RSTP-MSTP-MIB", "myStpCistRegionRoot"),
        ("MY-RSTP-MSTP-MIB", "myStpCistPathCost"))
)
if mibBuilder.loadTexts:
...
mstpBridgeRegionGroup.setObjects(
      *(("MY-RSTP-MSTP-MIB", "myStpMstiMaxInstanceNumber"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiRegionName"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiRegionRevision"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiMaxHopNumber"))
)
if mibBuilder.loadTexts:
...
mstpMstiBridgeGroup.setObjects(
      *(("MY-RSTP-MSTP-MIB", "myStpMstiInstanceIndex"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiInstanceVlansAddMapped"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiInstanceVlansDeleteMapped"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiInstanceVlansGetMapped"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiInstanceRemainingHopCount"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiPriority"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiTimeSinceTopologyChange"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiTopChanges"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiDesignatedRoot"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiRootCost"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiRootPort"),
        ("MY-RSTP-MSTP-MIB", "myStpMstiInstanceEntryStatus"))
)
if mibBuilder.loadTexts:
...
mstpMstiPortGroup.setObjects(
      *(("MY-RSTP-MSTP-MIB", "myStpPortMstiIndex"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiState"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiAdminPathCost"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiOperPathCost"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiPriority"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiDesignatedRoot"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiDesignatedCost"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiDesignatedBridge"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiDesignatedPort"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiPortRole"),
        ("MY-RSTP-MSTP-MIB", "myStpPortMstiPortForwardTransitions"))
)
if mibBuilder.loadTexts:
...
rstpCompliance.setObjects(
      *(("MY-RSTP-MSTP-MIB", "rstpBridgeGroup"),
        ("MY-RSTP-MSTP-MIB", "rstpDefaultPathCostGroup"),
        ("MY-RSTP-MSTP-MIB", "rstpPortGroup"),
        ("MY-RSTP-MSTP-MIB", "rstpDefaultPathCostGroup"))
)
if mibBuilder.loadTexts:
...
mstpCompliance.setObjects(
      *(("MY-RSTP-MSTP-MIB", "mstpBridgeRegionGroup"),
        ("MY-RSTP-MSTP-MIB", "mstpMstiBridgeGroup"),
        ("MY-RSTP-MSTP-MIB", "mstpMstiPortGroup"))
)
if mibBuilder.loadTexts:
