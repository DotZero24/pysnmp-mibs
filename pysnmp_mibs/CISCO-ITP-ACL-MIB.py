...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-ITP-ACL-MIB
...
CItpTcNAI, CItpTcNumberingPlan, CItpTcPointCode, CItpTcSubSystemNumber, CItpTcSubSystemNumberMask, CItpTcGlobalTitleSelector, CItpTcServiceIndicator, CItpTcTranslationType, CItpTcPointCodeMask, CItpTcEncodingSchemeValue, CItpTcAclId = mibBuilder.importSymbols("CISCO-ITP-TC-MIB", "CItpTcNAI", "CItpTcNumberingPlan", "CItpTcPointCode", "CItpTcSubSystemNumber", "CItpTcSubSystemNumberMask", "CItpTcGlobalTitleSelector", "CItpTcServiceIndicator", "CItpTcTranslationType", "CItpTcPointCodeMask", "CItpTcEncodingSchemeValue", "CItpTcAclId")
...
mibBuilder.exportSymbols("CISCO-ITP-ACL-MIB", cItpAclDpc=cItpAclDpc, cItpAclMIBCompliance=cItpAclMIBCompliance, cItpAclGtiNai=cItpAclGtiNai, cItpAclMIBGroups=cItpAclMIBGroups, cItpAclGtiTranslateType=cItpAclGtiTranslateType, cItpAclCdpaMask=cItpAclCdpaMask, cItpAclEntryNumber=cItpAclEntryNumber, cItpAclOpc=cItpAclOpc, cItpAclGtiSelector=cItpAclGtiSelector, cItpAclRowStatus=cItpAclRowStatus, cItpAclCgpaMask=cItpAclCgpaMask, cItpAclConfig=cItpAclConfig, cItpAclAft=cItpAclAft, cItpAclMIBObjects=cItpAclMIBObjects, cItpAclCgpa=cItpAclCgpa, cItpAclDpcMask=cItpAclDpcMask, cItpAclScalarGroup=cItpAclScalarGroup, cItpAclAccessListGroup=cItpAclAccessListGroup, cItpAclGtiNumberingPlan=cItpAclGtiNumberingPlan, cItpAclConfigLastChanged=cItpAclConfigLastChanged, cItpAclScalars=cItpAclScalars, cItpAclTable=cItpAclTable, cItpAclAftSsnMask=cItpAclAftSsnMask, cItpAclMIBNotifs=cItpAclMIBNotifs, cItpAclCdpa=cItpAclCdpa, CItpAclAction=CItpAclAction, cItpAclEntryType=cItpAclEntryType, cItpAclGtiEsv=cItpAclGtiEsv, cItpAclAction=cItpAclAction, cItpAclAftMask=cItpAclAftMask, cItpAclAftSsn=cItpAclAftSsn, cItpAclOpcMask=cItpAclOpcMask, cItpAclComment=cItpAclComment, cItpAclCdpaSsn=cItpAclCdpaSsn, cItpAclParameters=cItpAclParameters, cItpAclOffset=cItpAclOffset, ciscoItpAclMIB=ciscoItpAclMIB, cItpAclSi=cItpAclSi, cItpAclCdpaSsnMask=cItpAclCdpaSsnMask, cItpAclMIBCompliances=cItpAclMIBCompliances, cItpAclPattern=cItpAclPattern, PYSNMP_MODULE_ID=ciscoItpAclMIB, cItpAclCgpaSsnMask=cItpAclCgpaSsnMask, cItpAclCgpaSsn=cItpAclCgpaSsn, cItpAclId=cItpAclId, cItpAclMIBConformance=cItpAclMIBConformance, cItpAclTableEntry=cItpAclTableEntry)
