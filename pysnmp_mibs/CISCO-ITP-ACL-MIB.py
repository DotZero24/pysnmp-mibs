...
CItpTcPointCodeMask, CItpTcPointCode, CItpTcSubSystemNumber, CItpTcSubSystemNumberMask, CItpTcEncodingSchemeValue, CItpTcGlobalTitleSelector, CItpTcNAI, CItpTcTranslationType, CItpTcAclId, CItpTcNumberingPlan, CItpTcServiceIndicator = mibBuilder.importSymbols("CISCO-ITP-TC-MIB", "CItpTcPointCodeMask", "CItpTcPointCode", "CItpTcSubSystemNumber", "CItpTcSubSystemNumberMask", "CItpTcEncodingSchemeValue", "CItpTcGlobalTitleSelector", "CItpTcNAI", "CItpTcTranslationType", "CItpTcAclId", "CItpTcNumberingPlan", "CItpTcServiceIndicator")
...
mibBuilder.exportSymbols("CISCO-ITP-ACL-MIB", cItpAclGtiEsv=cItpAclGtiEsv, ciscoItpAclMIB=ciscoItpAclMIB, cItpAclScalarGroup=cItpAclScalarGroup, cItpAclMIBObjects=cItpAclMIBObjects, cItpAclGtiSelector=cItpAclGtiSelector, cItpAclCdpaSsnMask=cItpAclCdpaSsnMask, cItpAclAftMask=cItpAclAftMask, cItpAclEntryType=cItpAclEntryType, cItpAclSi=cItpAclSi, cItpAclAft=cItpAclAft, cItpAclOpc=cItpAclOpc, cItpAclTable=cItpAclTable, cItpAclMIBConformance=cItpAclMIBConformance, cItpAclMIBCompliance=cItpAclMIBCompliance, cItpAclAftSsn=cItpAclAftSsn, cItpAclRowStatus=cItpAclRowStatus, cItpAclScalars=cItpAclScalars, cItpAclCdpaMask=cItpAclCdpaMask, cItpAclPattern=cItpAclPattern, cItpAclOffset=cItpAclOffset, cItpAclParameters=cItpAclParameters, cItpAclAccessListGroup=cItpAclAccessListGroup, cItpAclMIBNotifs=cItpAclMIBNotifs, cItpAclCgpaMask=cItpAclCgpaMask, cItpAclGtiTranslateType=cItpAclGtiTranslateType, cItpAclDpcMask=cItpAclDpcMask, PYSNMP_MODULE_ID=ciscoItpAclMIB, cItpAclTableEntry=cItpAclTableEntry, cItpAclCgpaSsn=cItpAclCgpaSsn, cItpAclMIBGroups=cItpAclMIBGroups, cItpAclGtiNumberingPlan=cItpAclGtiNumberingPlan, cItpAclComment=cItpAclComment, cItpAclMIBCompliances=cItpAclMIBCompliances, cItpAclConfig=cItpAclConfig, cItpAclCdpa=cItpAclCdpa, cItpAclGtiNai=cItpAclGtiNai, cItpAclId=cItpAclId, CItpAclAction=CItpAclAction, cItpAclEntryNumber=cItpAclEntryNumber, cItpAclCdpaSsn=cItpAclCdpaSsn, cItpAclConfigLastChanged=cItpAclConfigLastChanged, cItpAclDpc=cItpAclDpc, cItpAclCgpa=cItpAclCgpa, cItpAclAftSsnMask=cItpAclAftSsnMask, cItpAclAction=cItpAclAction, cItpAclCgpaSsnMask=cItpAclCgpaSsnMask, cItpAclOpcMask=cItpAclOpcMask)
