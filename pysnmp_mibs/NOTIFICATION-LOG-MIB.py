...
Gauge32, MibIdentifier, NotificationType, Integer32, Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, TimeTicks, Counter64, mib_2, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "NotificationType", "Integer32", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "TimeTicks", "Counter64", "mib-2", "Opaque")
TDomain, RowStatus, DateAndTime, TAddress, TextualConvention, StorageType, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TDomain", "RowStatus", "DateAndTime", "TAddress", "TextualConvention", "StorageType", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("NOTIFICATION-LOG-MIB", nlmLogTable=nlmLogTable, nlmLogVariableOpaqueVal=nlmLogVariableOpaqueVal, nlmConfigLogEntry=nlmConfigLogEntry, nlmLogNotificationID=nlmLogNotificationID, nlmLogVariableEntry=nlmLogVariableEntry, nlmLogVariableOctetStringVal=nlmLogVariableOctetStringVal, nlmLogVariableID=nlmLogVariableID, nlmLogEngineTAddress=nlmLogEngineTAddress, nlmStats=nlmStats, nlmConfigLogFilterName=nlmConfigLogFilterName, nlmConfigLogAdminStatus=nlmConfigLogAdminStatus, nlmLogTime=nlmLogTime, nlmLogVariableCounter64Val=nlmLogVariableCounter64Val, notificationLogStatsGroup=notificationLogStatsGroup, nlmLogContextEngineID=nlmLogContextEngineID, nlmLogName=nlmLogName, nlmStatsLogEntry=nlmStatsLogEntry, nlmLogEngineID=nlmLogEngineID, nlmConfigGlobalEntryLimit=nlmConfigGlobalEntryLimit, nlmLogVariableValueType=nlmLogVariableValueType, notificationLogMIBCompliances=notificationLogMIBCompliances, nlmLogVariableOidVal=nlmLogVariableOidVal, nlmConfig=nlmConfig, notificationLogMIB=notificationLogMIB, nlmStatsLogNotificationsBumped=nlmStatsLogNotificationsBumped, notificationLogMIBGroups=notificationLogMIBGroups, nlmLogVariableTimeTicksVal=nlmLogVariableTimeTicksVal, notificationLogMIBCompliance=notificationLogMIBCompliance, nlmLog=nlmLog, notificationLogLogGroup=notificationLogLogGroup, notificationLogDateGroup=notificationLogDateGroup, nlmLogVariableUnsigned32Val=nlmLogVariableUnsigned32Val, nlmLogVariableTable=nlmLogVariableTable, nlmLogEngineTDomain=nlmLogEngineTDomain, nlmLogVariableIpAddressVal=nlmLogVariableIpAddressVal, nlmLogIndex=nlmLogIndex, nlmConfigLogOperStatus=nlmConfigLogOperStatus, notificationLogMIBObjects=notificationLogMIBObjects, nlmLogVariableInteger32Val=nlmLogVariableInteger32Val, notificationLogConfigGroup=notificationLogConfigGroup, nlmLogVariableCounter32Val=nlmLogVariableCounter32Val, nlmConfigLogStorageType=nlmConfigLogStorageType, nlmStatsLogTable=nlmStatsLogTable, nlmLogDateAndTime=nlmLogDateAndTime, nlmConfigLogEntryLimit=nlmConfigLogEntryLimit, nlmStatsLogNotificationsLogged=nlmStatsLogNotificationsLogged, nlmLogEntry=nlmLogEntry, notificationLogMIBConformance=notificationLogMIBConformance, nlmConfigLogTable=nlmConfigLogTable, nlmLogContextName=nlmLogContextName, nlmLogVariableIndex=nlmLogVariableIndex, nlmStatsGlobalNotificationsLogged=nlmStatsGlobalNotificationsLogged, PYSNMP_MODULE_ID=notificationLogMIB, nlmStatsGlobalNotificationsBumped=nlmStatsGlobalNotificationsBumped, nlmConfigLogEntryStatus=nlmConfigLogEntryStatus, nlmConfigGlobalAgeOut=nlmConfigGlobalAgeOut)
