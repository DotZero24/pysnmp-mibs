...
ModuleIdentity, Counter64, Integer32, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Opaque, iso, NotificationType, MibIdentifier, TimeTicks, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Opaque", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "Bits", "mib-2", "IpAddress")
DisplayString, TDomain, TimeStamp, RowStatus, TAddress, TextualConvention, DateAndTime, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TDomain", "TimeStamp", "RowStatus", "TAddress", "TextualConvention", "DateAndTime", "StorageType")
...
mibBuilder.exportSymbols("NOTIFICATION-LOG-MIB", nlmLogVariableCounter64Val=nlmLogVariableCounter64Val, nlmLogIndex=nlmLogIndex, nlmLogName=nlmLogName, nlmStats=nlmStats, nlmStatsGlobalNotificationsLogged=nlmStatsGlobalNotificationsLogged, nlmConfigGlobalAgeOut=nlmConfigGlobalAgeOut, nlmLogVariableInteger32Val=nlmLogVariableInteger32Val, nlmLogVariableUnsigned32Val=nlmLogVariableUnsigned32Val, nlmLogContextName=nlmLogContextName, nlmLogEngineID=nlmLogEngineID, nlmStatsLogTable=nlmStatsLogTable, nlmConfigLogEntryLimit=nlmConfigLogEntryLimit, nlmLogVariableTable=nlmLogVariableTable, notificationLogMIB=notificationLogMIB, notificationLogDateGroup=notificationLogDateGroup, nlmStatsLogNotificationsLogged=nlmStatsLogNotificationsLogged, nlmLogEntry=nlmLogEntry, notificationLogMIBCompliances=notificationLogMIBCompliances, nlmStatsLogEntry=nlmStatsLogEntry, nlmConfig=nlmConfig, PYSNMP_MODULE_ID=notificationLogMIB, nlmLogVariableOctetStringVal=nlmLogVariableOctetStringVal, nlmConfigLogOperStatus=nlmConfigLogOperStatus, notificationLogMIBObjects=notificationLogMIBObjects, nlmLog=nlmLog, nlmConfigGlobalEntryLimit=nlmConfigGlobalEntryLimit, nlmConfigLogEntryStatus=nlmConfigLogEntryStatus, nlmLogVariableIndex=nlmLogVariableIndex, nlmLogEngineTDomain=nlmLogEngineTDomain, notificationLogMIBCompliance=notificationLogMIBCompliance, nlmLogTime=nlmLogTime, notificationLogStatsGroup=notificationLogStatsGroup, nlmConfigLogStorageType=nlmConfigLogStorageType, notificationLogConfigGroup=notificationLogConfigGroup, notificationLogMIBGroups=notificationLogMIBGroups, nlmLogVariableValueType=nlmLogVariableValueType, nlmLogVariableOidVal=nlmLogVariableOidVal, nlmLogVariableTimeTicksVal=nlmLogVariableTimeTicksVal, nlmLogTable=nlmLogTable, nlmLogVariableIpAddressVal=nlmLogVariableIpAddressVal, nlmLogDateAndTime=nlmLogDateAndTime, nlmStatsGlobalNotificationsBumped=nlmStatsGlobalNotificationsBumped, nlmLogContextEngineID=nlmLogContextEngineID, nlmLogNotificationID=nlmLogNotificationID, nlmConfigLogEntry=nlmConfigLogEntry, nlmLogVariableOpaqueVal=nlmLogVariableOpaqueVal, notificationLogLogGroup=notificationLogLogGroup, nlmLogVariableID=nlmLogVariableID, nlmConfigLogAdminStatus=nlmConfigLogAdminStatus, nlmLogEngineTAddress=nlmLogEngineTAddress, notificationLogMIBConformance=notificationLogMIBConformance, nlmLogVariableCounter32Val=nlmLogVariableCounter32Val, nlmConfigLogTable=nlmConfigLogTable, nlmConfigLogFilterName=nlmConfigLogFilterName, nlmLogVariableEntry=nlmLogVariableEntry, nlmStatsLogNotificationsBumped=nlmStatsLogNotificationsBumped)
