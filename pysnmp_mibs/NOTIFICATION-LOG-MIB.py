...
# Notes
# -----
# ASN.1 source file:///usr/share/snmp/mibs/NOTIFICATION-LOG-MIB.txt
# Produced by pysmi-1.6.2 at Fri Oct 10 21:23:38 2025
...
class _NlmConfigGlobalEntryLimit_Type(Unsigned32):
    """Custom type nlmConfigGlobalEntryLimit based on Unsigned32"""
    defaultValue = 0


_NlmConfigGlobalEntryLimit_Type.__name__ = "Unsigned32"
...
class _NlmConfigGlobalAgeOut_Type(Unsigned32):
    """Custom type nlmConfigGlobalAgeOut based on Unsigned32"""
    defaultValue = 1440


_NlmConfigGlobalAgeOut_Type.__name__ = "Unsigned32"
...
_NlmConfigLogEntryLimit_Type.__name__ = "Unsigned32"
...
notificationLogMIBCompliance.setObjects(
      *(("NOTIFICATION-LOG-MIB", "notificationLogConfigGroup"),
        ("NOTIFICATION-LOG-MIB", "notificationLogStatsGroup"),
        ("NOTIFICATION-LOG-MIB", "notificationLogLogGroup"))
)
if mibBuilder.loadTexts:
