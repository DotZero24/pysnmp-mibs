...
# Notes
# -----
# ASN.1 source file://mibs/rfc/NHDP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:22:29 2025
...
_NhdpNbrStateChangeWindow_Type.__name__ = "TimeTicks"
...
_Nhdp2HopNbrStateChangeWindow_Type.__name__ = "TimeTicks"
...
_NhdpIfStatus_Type.__name__ = "TruthValue"
...
_NhdpHelloInterval_Type.__name__ = "Unsigned32"
...
_NhdpHelloMinInterval_Type.__name__ = "Unsigned32"
...
_NhdpRefreshInterval_Type.__name__ = "Unsigned32"
...
_NhdpLHoldTime_Type.__name__ = "Unsigned32"
...
_NhdpHHoldTime_Type.__name__ = "Unsigned32"
...
_NhdpInitialPending_Type.__name__ = "TruthValue"
...
_NhdpHpMaxJitter_Type.__name__ = "Unsigned32"
...
_NhdpHtMaxJitter_Type.__name__ = "Unsigned32"
...
_NhdpIfRowStatus_Type.__name__ = "RowStatus"
...
_NhdpNHoldTime_Type.__name__ = "Unsigned32"
...
_NhdpIHoldTime_Type.__name__ = "Unsigned32"
...
_NhdpLibLocalIfSetRowStatus_Type.__name__ = "RowStatus"
...
nhdpIib2HopSetN2Lost = _NhdpIib2HopSetN2Lost_Object(
    (1, 3, 6, 1, 2, 1, 213, 1, 2, 5, 1, 6),
    _NhdpIib2HopSetN2Lost_Type()
)
nhdpIib2HopSetN2Lost.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nhdpIib2HopSetN2Lost.setStatus("current")
...
nhdpIfPerfCounterDiscontinuityTime = _NhdpIfPerfCounterDiscontinuityTime_Object(
    (1, 3, 6, 1, 2, 1, 213, 1, 3, 1, 1, 10),
    _NhdpIfPerfCounterDiscontinuityTime_Type()
)
nhdpIfPerfCounterDiscontinuityTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nhdpIfPerfCounterDiscontinuityTime.setStatus("current")
...
if mibBuilder.loadTexts:
    nhdpStateGroup.setStatus("deprecated")
...
nhdpPerformanceGroup.setObjects(
      *(("NHDP-MIB", "nhdpIfHelloMessageXmits"),
        ...
        ("NHDP-MIB", "nhdpIfPerfCounterDiscontinuityTime"),
...
nhdpStateGroup2 = ObjectGroup(
    (1, 3, 6, 1, 2, 1, 213, 2, 2, 7)
)
nhdpStateGroup2.setObjects(
      *(("NHDP-MIB", "nhdpUpTime"),
        ("NHDP-MIB", "nhdpIfStateUpTime"),
        ("NHDP-MIB", "nhdpDiscRouterIndex"),
        ("NHDP-MIB", "nhdpDiscIfIndex"),
        ...
        ("NHDP-MIB", "nhdpIib2HopSet1HopIfIndex"),
        ("NHDP-MIB", "nhdpIib2HopSetN2Time"),
        ("NHDP-MIB", "nhdpIib2HopSetN2Lost"),
        ("NHDP-MIB", "nhdpNibNeighborSetNSymmetric"),
        ("NHDP-MIB", "nhdpNibLostNeighborSetNLTime"))
)
if mibBuilder.loadTexts:
    nhdpStateGroup2.setStatus("current")
...
nhdpBasicCompliance.setObjects(
    ("NHDP-MIB", "nhdpConfigurationGroup")
)
if mibBuilder.loadTexts:
...
nhdpFullCompliance.setObjects(
      *(("NHDP-MIB", "nhdpConfigurationGroup"),
        ("NHDP-MIB", "nhdpStateGroup"),
        ("NHDP-MIB", "nhdpNotificationObjectGroup"),
        ("NHDP-MIB", "nhdpNotificationGroup"),
        ("NHDP-MIB", "nhdpPerformanceGroup"))
)
if mibBuilder.loadTexts:
...
nhdpFullCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 2, 1, 213, 2, 1, 3)
)
nhdpFullCompliance2.setObjects(
      *(("NHDP-MIB", "nhdpConfigurationGroup"),
        ("NHDP-MIB", "nhdpStateGroup2"),
        ("NHDP-MIB", "nhdpNotificationObjectGroup"),
        ("NHDP-MIB", "nhdpNotificationGroup"),
        ("NHDP-MIB", "nhdpPerformanceGroup"))
)
if mibBuilder.loadTexts:
    nhdpFullCompliance2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"NeighborIfIndex": NeighborIfIndex,
       ...
       "nhdpIib2HopSetN2Lost": nhdpIib2HopSetN2Lost,
       ...
       "nhdpFullCompliance2": nhdpFullCompliance2,
       ...
       "nhdpStateGroup2": nhdpStateGroup2}
)
