...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IP-PROTOCOL-FILTER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:22:51 2025
...
_CippfIpFilterSrcAddress_Type.__name__ = "InetAddress"
...
_CippfIpFilterSrcMask_Type.__name__ = "InetAddress"
...
_CippfIpFilterDestAddress_Type.__name__ = "InetAddress"
...
_CippfIpFilterDestMask_Type.__name__ = "InetAddress"
...
_CippfIpFilterSrcPortLow_Type.__name__ = "InetPortNumber"
...
_CippfIpFilterSrcPortHigh_Type.__name__ = "InetPortNumber"
...
_CippfIpFilterDestPortLow_Type.__name__ = "InetPortNumber"
...
_CippfIpFilterDestPortHigh_Type.__name__ = "InetPortNumber"
...
_CippfIpFilterLogEnabled_Type.__name__ = "TruthValue"
...
_CippfIpFilterTCPEstablished_Type.__name__ = "TruthValue"
...
_CippfIpFilterFragments_Type.__name__ = "TruthValue"
...
class _CippfIpFilterSrcIPGroupName_Type(CfgFilterGroupName):
    """Custom type cippfIpFilterSrcIPGroupName based on CfgFilterGroupName"""
    defaultValue = OctetString("")


_CippfIpFilterSrcIPGroupName_Type.__name__ = "CfgFilterGroupName"
...
class _CippfIpFilterDstIPGroupName_Type(CfgFilterGroupName):
    """Custom type cippfIpFilterDstIPGroupName based on CfgFilterGroupName"""
    defaultValue = OctetString("")


_CippfIpFilterDstIPGroupName_Type.__name__ = "CfgFilterGroupName"
...
class _CippfIpFilterProtocolGroupName_Type(CfgFilterGroupName):
    """Custom type cippfIpFilterProtocolGroupName based on CfgFilterGroupName"""
    defaultValue = OctetString("")


_CippfIpFilterProtocolGroupName_Type.__name__ = "CfgFilterGroupName"
...
class _CippfIpFilterSrcServiceGroupName_Type(CfgFilterGroupName):
    """Custom type cippfIpFilterSrcServiceGroupName based on CfgFilterGroupName"""
    defaultValue = OctetString("")


_CippfIpFilterSrcServiceGroupName_Type.__name__ = "CfgFilterGroupName"
...
class _CippfIpFilterDstServiceGroupName_Type(CfgFilterGroupName):
    """Custom type cippfIpFilterDstServiceGroupName based on CfgFilterGroupName"""
    defaultValue = OctetString("")


_CippfIpFilterDstServiceGroupName_Type.__name__ = "CfgFilterGroupName"
...
class _CippfIpFilterICMPGroupName_Type(CfgFilterGroupName):
    """Custom type cippfIpFilterICMPGroupName based on CfgFilterGroupName"""
    defaultValue = OctetString("")


_CippfIpFilterICMPGroupName_Type.__name__ = "CfgFilterGroupName"
...
class _CippfIpFilterExtDescription_Type(SnmpAdminString):
    """Custom type cippfIpFilterExtDescription based on SnmpAdminString"""
    defaultValue = OctetString("")


_CippfIpFilterExtDescription_Type.__name__ = "SnmpAdminString"
...
_CippfIpFilterExtLogLevel_Type.__name__ = "SyslogSeverity"
...
_CippfIpFilterExtLogInterval_Type.__name__ = "Unsigned32"
...
ciscoIpProtocolMIBCompliance.setObjects(
    ("CISCO-IP-PROTOCOL-FILTER-MIB", "ciscoIpProtocolFilteringGroup")
)
if mibBuilder.loadTexts:
...
ciscoIpProtocolMIBComplianceRev1.setObjects(
      *(("CISCO-IP-PROTOCOL-FILTER-MIB", "ciscoIpProtocolFilteringGroup"),
        ("CISCO-IP-PROTOCOL-FILTER-MIB", "ciscoIpProtocolFilterGroup2"))
)
if mibBuilder.loadTexts:
...
ciscoIpProtocolMIBComplianceRev2.setObjects(
      *(("CISCO-IP-PROTOCOL-FILTER-MIB", "ciscoIpProtocolFilteringGroup"),
        ("CISCO-IP-PROTOCOL-FILTER-MIB", "ciscoIpProtocolFilterStatsGroup"))
)
if mibBuilder.loadTexts:
