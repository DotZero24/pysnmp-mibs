...
# Notes
# -----
# ASN.1 source file://mibs/rfc/PKTC-EN-SIG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:19:02 2025
...
pktcEnNcsEndPntFaxDetection.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
pktcEnNcsEndPntStatusReportCtrl.setMaxAccess("read-write")
if mibBuilder.loadTexts:
