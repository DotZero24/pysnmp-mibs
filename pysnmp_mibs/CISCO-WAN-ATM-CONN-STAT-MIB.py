...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-ATM-CONN-STAT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:51 2025
...
_CwacsStatsClear_Type.__name__ = "TruthValue"
...
_CwaConnStatsClear_Type.__name__ = "TruthValue"
...
ciscoWanAtmConnStatMIBCompliance.setObjects(
    ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsGroup")
)
if mibBuilder.loadTexts:
...
ciscoWanAtmConnStatMIBCompliance2.setObjects(
      *(("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsGroup"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwaConnStatsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoWanAtmConnStatMIBCompliance3.setObjects(
      *(("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsGroup1"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwaConnStatsGroup"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsHCGroup"))
)
if mibBuilder.loadTexts:
...
ciscoWanAtmConnStatMIBCompliance4.setObjects(
      *(("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsGroup1"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwaConnStatsGroup"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsHCGroup"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsAal2Group"))
)
if mibBuilder.loadTexts:
...
ciscoWanAtmConnStatMIBCompliance5.setObjects(
      *(("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsGroup1"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwaConnStatsGroup"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsHCGroup"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsAal2GroupRev1"))
)
if mibBuilder.loadTexts:
...
ciscoWanAtmConnStatMIBCompliance6.setObjects(
      *(("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsGroup1"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwaConnStatsGroup"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsHCGroup"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsAal2GroupRev1"),
        ("CISCO-WAN-ATM-CONN-STAT-MIB", "cwacsBearerPVCGroup"))
)
if mibBuilder.loadTexts:
