...
mibBuilder.exportSymbols("CISCO-DMN-DSG-SDI-MIB", sdiAudioSlotAud=sdiAudioSlotAud, vancServiceStatusLinesMAX=vancServiceStatusLinesMAX, vancServiceStatusDataAvg=vancServiceStatusDataAvg, vancServiceStatusTable=vancServiceStatusTable, sdiTable=sdiTable, vancCfgTable=vancCfgTable, vancGlobalStatusInterlaced=vancGlobalStatusInterlaced, sdiAudioSlotGroup=sdiAudioSlotGroup, vancGlobalStatusSwitch=vancGlobalStatusSwitch, sdiVii=sdiVii, sdiInfo=sdiInfo, vancServiceStatusACTLineF2=vancServiceStatusACTLineF2, vancGlobalStatusLast=vancGlobalStatusLast, vancServiceStatusACTLineF1=vancServiceStatusACTLineF1, vancServiceStatusPacketsDroppedAvg=vancServiceStatusPacketsDroppedAvg, vancServiceStatusEntry=vancServiceStatusEntry, vancCfgSvcID=vancCfgSvcID, vancGlobalStatusLines=vancGlobalStatusLines, vancGlobalStatusMultiLine=vancGlobalStatusMultiLine, PYSNMP_MODULE_ID=ciscoDSGSDI, sdiAudioSlotPosition=sdiAudioSlotPosition, sdiAudioSlotChan=sdiAudioSlotChan, ciscoDSGSDI=ciscoDSGSDI, vancCfgEnable=vancCfgEnable, vancCfgOffset=vancCfgOffset, vancGlobalStatusFrames=vancGlobalStatusFrames, vancServiceStatusServiceID=vancServiceStatusServiceID, sdiAudioSlotEntry=sdiAudioSlotEntry, vancGlobalStatusFirst=vancGlobalStatusFirst, vancServiceStatusPacketsOKAvg=vancServiceStatusPacketsOKAvg, vancServiceStatusActive=vancServiceStatusActive, vancServiceStatusADJLine=vancServiceStatusADJLine, sdiAudioSlotTable=sdiAudioSlotTable, vancCfgEntry=vancCfgEntry, vancGlobalStatusWords=vancGlobalStatusWords)
