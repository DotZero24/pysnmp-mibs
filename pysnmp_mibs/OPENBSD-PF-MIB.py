...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/bsd/OPENBSD-PF-MIB
...
pfMIBObjects.setRevisions(('2021-03-23 19:33', '2015-06-09 17:28', '2013-08-31 04:46', '2013-02-24 20:33', '2012-01-26 00:00',))
if mibBuilder.loadTexts: pfMIBObjects.setLastUpdated('202103231933Z')
...
pfLogIfName = MibScalar((1, 3, 6, 1, 4, 1, 30155, 1, 4, 1), DisplayString()).setMaxAccess("readonly")
...
pfIfDescr = MibTableColumn((1, 3, 6, 1, 4, 1, 30155, 1, 8, 128, 1, 2), DisplayString()).setMaxAccess("readonly")
...
pfTblName = MibTableColumn((1, 3, 6, 1, 4, 1, 30155, 1, 9, 128, 1, 2), SnmpAdminString()).setMaxAccess("readonly")
...
pfLabelName = MibTableColumn((1, 3, 6, 1, 4, 1, 30155, 1, 10, 128, 1, 2), SnmpAdminString()).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("OPENBSD-PF-MIB", pfTimeoutTcpFirst=pfTimeoutTcpFirst, pfTblName=pfTblName, pfLabelName=pfLabelName, pfLimitMaxTables=pfLimitMaxTables, pfTblAddrTblIndex=pfTblAddrTblIndex, pfTblStatsCleared=pfTblStatsCleared, pfIfOut6BlockPkts=pfIfOut6BlockPkts, pfTblOutPassBytes=pfTblOutPassBytes, pfLabelTotalStates=pfLabelTotalStates, pfTblInXPassPkts=pfTblInXPassPkts, pfCntCongestion=pfCntCongestion, pfTimeoutOtherSingle=pfTimeoutOtherSingle, pfIfIn4BlockPkts=pfIfIn4BlockPkts, pfSrcTracking=pfSrcTracking, pfIfRules=pfIfRules, pfIfIn6PassBytes=pfIfIn6PassBytes, pfTblAddrInPassPkts=pfTblAddrInPassPkts, pfLogInterface=pfLogInterface, pfTables=pfTables, pfsyncPktDiscardsForBadLength=pfsyncPktDiscardsForBadLength, pfIfOut6PassPkts=pfIfOut6PassPkts, pfTimeoutAdaptiveStart=pfTimeoutAdaptiveStart, pfTblInPassBytes=pfTblInPassBytes, pfTimeoutTcpFinWait=pfTimeoutTcpFinWait, pfsyncPktDiscardsForBadInterface=pfsyncPktDiscardsForBadInterface, pfTblNumber=pfTblNumber, pfTblInBlockBytes=pfTblInBlockBytes, pfsyncIp6PktsRecv=pfsyncIp6PktsRecv, pfCntNormalize=pfCntNormalize, pfIfOut6BlockBytes=pfIfOut6BlockBytes, pfTblInPassPkts=pfTblInPassPkts, pfTblAddrInBlockPkts=pfTblAddrInBlockPkts, pfTimeoutTcpClosed=pfTimeoutTcpClosed, pfIfIndex=pfIfIndex, pfTimeoutUdpFirst=pfTimeoutUdpFirst, pfTimeouts=pfTimeouts, pfIfIn4PassBytes=pfIfIn4PassBytes, pfLimitMaxTableEntries=pfLimitMaxTableEntries, pfCntSrcLimit=pfCntSrcLimit, pfTblOutBlockPkts=pfTblOutBlockPkts, pfSrcTrackInserts=pfSrcTrackInserts, pfLogIfIpPktsInDrop=pfLogIfIpPktsInDrop, pfTblInXPassBytes=pfTblInXPassBytes, pfLimitFragments=pfLimitFragments, pfLimits=pfLimits, pfCntBadOffset=pfCntBadOffset, pfIfOut6PassBytes=pfIfOut6PassBytes, pfTblEvalsMatch=pfTblEvalsMatch, pfTblOutPassPkts=pfTblOutPassPkts, pfsyncPktDiscardsForBadAuth=pfsyncPktDiscardsForBadAuth, pfsyncIp6PktsSent=pfsyncIp6PktsSent, pfsyncPktDiscardsForBadValues=pfsyncPktDiscardsForBadValues, pfTblTable=pfTblTable, pfHostid=pfHostid, pfIfOut4PassPkts=pfIfOut4PassPkts, pfLogIfIp6PktsOutPass=pfLogIfIp6PktsOutPass, pfsyncNoMemory=pfsyncNoMemory, pfTblAddresses=pfTblAddresses, pfLogIfIp6PktsOutDrop=pfLogIfIp6PktsOutDrop, pfsyncPktShorterThanHeader=pfsyncPktShorterThanHeader, pfSrcTrackRemovals=pfSrcTrackRemovals, pfLimitSourceNodes=pfLimitSourceNodes, pfTblAddrInBlockBytes=pfTblAddrInBlockBytes, pfsyncStats=pfsyncStats, pfCntTranslate=pfCntTranslate, pfTblAddrNet=pfTblAddrNet, pfStateCount=pfStateCount, pfLogIfIp6BytesOut=pfLogIfIp6BytesOut, pfLabelInBytes=pfLabelInBytes, pfTblAddrOutBlockPkts=pfTblAddrOutBlockPkts, pfLogIfIpPktsOutDrop=pfLogIfIpPktsOutDrop, pfTblInBlockPkts=pfTblInBlockPkts, pfIfTable=pfIfTable, pfSrcTrackSearches=pfSrcTrackSearches, pfStateSearches=pfStateSearches, pfTimeoutTcpOpening=pfTimeoutTcpOpening, pfCounters=pfCounters, pfCntStateInsert=pfCntStateInsert, pfLabelEntry=pfLabelEntry, pfLabelIndex=pfLabelIndex, pfTblEvalsNoMatch=pfTblEvalsNoMatch, pfTblOutXPassBytes=pfTblOutXPassBytes, pfTimeoutTcpEstablished=pfTimeoutTcpEstablished, pfTimeoutUdpMultiple=pfTimeoutUdpMultiple, pfLogIfName=pfLogIfName, pfIfRefs=pfIfRefs, pfTimeoutSrcTrack=pfTimeoutSrcTrack, pfStateInserts=pfStateInserts, pfStateTable=pfStateTable, pfsyncPktDiscardsForBadVersion=pfsyncPktDiscardsForBadVersion, pfsyncPktDiscardsForStaleState=pfsyncPktDiscardsForStaleState, pfCntSynproxy=pfCntSynproxy, pfCntMatch=pfCntMatch, pfRunning=pfRunning, pfCntTimestamp=pfCntTimestamp, pfLogIfIp6BytesIn=pfLogIfIp6BytesIn, pfIfIn4BlockBytes=pfIfIn4BlockBytes, pfTblEntry=pfTblEntry, pfLogIfIpPktsInPass=pfLogIfIpPktsInPass, pfLabelEvals=pfLabelEvals, pfIfEntry=pfIfEntry, pfCntFragment=pfCntFragment, pfIfIn6BlockBytes=pfIfIn6BlockBytes, pfDebug=pfDebug, pfCntIpOption=pfCntIpOption, pfTimeoutUdpSingle=pfTimeoutUdpSingle, pfTimeoutAdaptiveEnd=pfTimeoutAdaptiveEnd, pfIfIn6PassPkts=pfIfIn6PassPkts, pfIfOut4PassBytes=pfIfOut4PassBytes, pfTblOutXPassPkts=pfTblOutXPassPkts, pfTimeoutInterval=pfTimeoutInterval, pfInterfaces=pfInterfaces, pfTblAddrEntry=pfTblAddrEntry, pfLabelPkts=pfLabelPkts, pfTblAddrOutMatchBytes=pfTblAddrOutMatchBytes, pfsyncPktDiscardsForBadState=pfsyncPktDiscardsForBadState, pfLabelOutPkts=pfLabelOutPkts, pfsyncPktDiscardsForBadAction=pfsyncPktDiscardsForBadAction, pfTimeoutIcmpFirst=pfTimeoutIcmpFirst, pfInfo=pfInfo, pfLogIfIpPktsOutPass=pfLogIfIpPktsOutPass, pfLabelOutBytes=pfLabelOutBytes, pfLogIfIpBytesIn=pfLogIfIpBytesIn, pfCntMemory=pfCntMemory, pfIfNumber=pfIfNumber, pfTblAddrInPassBytes=pfTblAddrInPassBytes, pfRuntime=pfRuntime, pfLogIfIpBytesOut=pfLogIfIpBytesOut, pfTblAddrOutPassBytes=pfTblAddrOutPassBytes, pfsyncOutputErrors=pfsyncOutputErrors, pfTblRuleRefs=pfTblRuleRefs, pfLabels=pfLabels, pfTblAddrInMatchBytes=pfTblAddrInMatchBytes, pfsyncPktDiscardsForBadTtl=pfsyncPktDiscardsForBadTtl, pfTblAddrMask=pfTblAddrMask, pfTblAddrCleared=pfTblAddrCleared, pfCntShort=pfCntShort, pfTblAnchorRefs=pfTblAnchorRefs, pfIfDescr=pfIfDescr, pfTimeoutIcmpError=pfTimeoutIcmpError, pfTimeoutOtherFirst=pfTimeoutOtherFirst, pfLimitStates=pfLimitStates, pfStateRemovals=pfStateRemovals, pfTimeoutTcpClosing=pfTimeoutTcpClosing, pfTblAddrInMatchPkts=pfTblAddrInMatchPkts, pfTblInMatchBytes=pfTblInMatchBytes, pfCntStateMismatch=pfCntStateMismatch, pfMIBObjects=pfMIBObjects, pfTblAddrOutPassPkts=pfTblAddrOutPassPkts, pfsyncIpPktsRecv=pfsyncIpPktsRecv, pfTblAddrTable=pfTblAddrTable, pfTimeoutOtherMultiple=pfTimeoutOtherMultiple, pfCntNoRoute=pfCntNoRoute, pfSrcTrackCount=pfSrcTrackCount, pfTblOutMatchBytes=pfTblOutMatchBytes, pfTblIndex=pfTblIndex, pfLabelNumber=pfLabelNumber, pfIfType=pfIfType, PYSNMP_MODULE_ID=pfMIBObjects, pfIfOut4BlockBytes=pfIfOut4BlockBytes, pfLogIfIp6PktsInPass=pfLogIfIp6PktsInPass, pfTblOutMatchPkts=pfTblOutMatchPkts, pfsyncIpPktsSent=pfsyncIpPktsSent, pfTblInMatchPkts=pfTblInMatchPkts, pfTblAddrOutBlockBytes=pfTblAddrOutBlockBytes, pfCntStateLimit=pfCntStateLimit, pfIfIn4PassPkts=pfIfIn4PassPkts, pfIfIn6BlockPkts=pfIfIn6BlockPkts, pfLogIfIp6PktsInDrop=pfLogIfIp6PktsInDrop, pfTimeoutFragment=pfTimeoutFragment, pfIfOut4BlockPkts=pfIfOut4BlockPkts, pfTblAddrOutMatchPkts=pfTblAddrOutMatchPkts, pfTblOutBlockBytes=pfTblOutBlockBytes, pfLabelTable=pfLabelTable, pfLabelInPkts=pfLabelInPkts, pfCntProtoCksum=pfCntProtoCksum, pfLabelBytes=pfLabelBytes)
