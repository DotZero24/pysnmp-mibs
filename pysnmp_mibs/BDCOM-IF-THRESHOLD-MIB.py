...
# Notes
# -----
# ASN.1 source file://mibs/bdcom/BDCOM-IF-THRESHOLD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:05:17 2025
...
_BdifthThresholdApsSwitchover_Type.__name__ = "TruthValue"
...
bdIfThresholdMIBCompliance.setObjects(
      *(("BDCOM-IF-THRESHOLD-MIB", "bdIfThresholdTemplateGroup"),
        ("BDCOM-IF-THRESHOLD-MIB", "bdIfThresholdFiredGroup"),
        ("BDCOM-IF-THRESHOLD-MIB", "bdIfThresholdNotifsGroup"))
)
if mibBuilder.loadTexts:
