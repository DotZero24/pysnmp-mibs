...
mibBuilder.exportSymbols("Juniper-TC", PYSNMP_MODULE_ID=juniTextualConventions, JuniLogSeverity=JuniLogSeverity, JuniTimeSlotMap=JuniTimeSlotMap, JuniSetMap=JuniSetMap, JuniInterfaceLocationType=JuniInterfaceLocationType, JuniVrfName=JuniVrfName, JuniTimeFilter=JuniTimeFilter, JuniName=JuniName, juniTextualConventions=juniTextualConventions, JuniNextIfIndex=JuniNextIfIndex, JuniIpAddrLessIf=JuniIpAddrLessIf, JuniInterfaceLocation=JuniInterfaceLocation, JuniInterfaceLocationValue=JuniInterfaceLocationValue, JuniInterfaceDescrFormat=JuniInterfaceDescrFormat, JuniAcctngAdminType=JuniAcctngAdminType, JuniNibbleConfig=JuniNibbleConfig, JuniVrfGroupName=JuniVrfGroupName, JuniEnable=JuniEnable, JuniAcctngOperType=JuniAcctngOperType)
