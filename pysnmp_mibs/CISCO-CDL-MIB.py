...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CDL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:29 2025
...
_CoCdlForceEndOfHop_Type.__name__ = "TruthValue"
...
coCdlMIBCompliance.setObjects(
      *(("CISCO-CDL-MIB", "coCdlMIBBaseGroup"),
        ("CISCO-CDL-MIB", "coCdlDIAggMandatoryGroup"),
        ("CISCO-CDL-MIB", "coCdlDIAggNotifGroup"))
)
if mibBuilder.loadTexts:
...
coCdlMIBCompliance2.setObjects(
      *(("CISCO-CDL-MIB", "coCdlMIBBaseGroup"),
        ("CISCO-CDL-MIB", "coCdlDIAggMandatoryGroup"),
        ("CISCO-CDL-MIB", "coCdlDIAggNotifGroup"))
)
