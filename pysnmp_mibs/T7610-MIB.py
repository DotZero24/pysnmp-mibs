# SNMP MIB module (T7610-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T7610-MIB
...
trapTest.setObjects(
      *(("T7610-MIB", "sensorName"),
        ("T7610-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
