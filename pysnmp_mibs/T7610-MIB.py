#
# PySNMP MIB module T7610-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/comet/T7610-MIB
...
t7610 = MibIdentifier((1, 3, 6, 1, 4, 1, 22626, 1, 2))
...
historyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 22626, 1, 2, 6, 1, 1), ).setIndexNames((0, "T7610-MIB", "histTemp"))
...
trapTest = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,0)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapNTPError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,1)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapEmailErrLogin = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,2)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapEmailErrAuth = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,3)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapEmailErrSome = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,4)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapEmailErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,5)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapEmailErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,6)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapSOAPErrFile = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,7)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapSOAPErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,8)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapSOAPErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,9)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapSOAPErrDelivery = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,10)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"))
trapTempHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,11)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "temp"), ("T7610-MIB", "tempAlarmInt"))
trapHumHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,12)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "hum"), ("T7610-MIB", "humAlarmInt"))
trapCompValHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,13)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "compVal"), ("T7610-MIB", "compValAlarmInt"))
trapPressHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,14)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "press"), ("T7610-MIB", "pressAlarmInt"))
trapTempLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,21)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "temp"), ("T7610-MIB", "tempAlarmInt"))
trapHumLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,22)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "hum"), ("T7610-MIB", "humAlarmInt"))
trapCompValLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,23)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "compVal"), ("T7610-MIB", "compValAlarmInt"))
trapPressLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,24)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "press"), ("T7610-MIB", "pressAlarmInt"))
trapTempClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,31)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "temp"), ("T7610-MIB", "tempAlarmInt"))
trapHumClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,32)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "hum"), ("T7610-MIB", "humAlarmInt"))
trapCompValClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,33)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "compVal"), ("T7610-MIB", "compValAlarmInt"))
trapPressClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,34)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "press"), ("T7610-MIB", "pressAlarmInt"))
trapTempError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,41)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "temp"), ("T7610-MIB", "tempAlarmInt"))
trapHumError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,42)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "hum"), ("T7610-MIB", "humAlarmInt"))
trapCompValError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,43)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "compVal"), ("T7610-MIB", "compValAlarmInt"))
trapPressError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,44)).setObjects(("T7610-MIB", "sensorName"), ("T7610-MIB", "messageString"), ("T7610-MIB", "press"), ("T7610-MIB", "pressAlarmInt"))
mibBuilder.exportSymbols("T7610-MIB", historyTable=historyTable, press=press, humHystInt=humHystInt, comet=comet, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm, humUnit=humUnit, compValMin=compValMin, compValInt=compValInt, pressLowInt=pressLowInt, messageString=messageString, compVal=compVal, humMax=humMax, compValLowInt=compValLowInt, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, compValHystInt=compValHystInt, trapTempHighAlarm=trapTempHighAlarm, compValHighInt=compValHighInt, tempDelayInt=tempDelayInt, pressHystInt=pressHystInt, trapCompValClrAlarm=trapCompValClrAlarm, DisplayString=DisplayString, temp=temp, pressAlarm=pressAlarm, trapPressHighAlarm=trapPressHighAlarm, humInt=humInt, humMin=humMin, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, sensorName=sensorName, trapHumError=trapHumError, tempMin=tempMin, trapTempError=trapTempError, traps=traps, pressHighInt=pressHighInt, humDelayInt=humDelayInt, pressAlarmInt=pressAlarmInt, trapPressLowAlarm=trapPressLowAlarm, pressMax=pressMax, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, pressDelayInt=pressDelayInt, trapTest=trapTest, tempUnit=tempUnit, histTemp=histTemp, settings=settings, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, humHighInt=humHighInt, tempMax=tempMax, historyEntry=historyEntry, humAlarm=humAlarm, hum=hum, humAlarmInt=humAlarmInt, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, compValUnit=compValUnit, trapPressError=trapPressError, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, pysmi_global=pysmi_global, trapHumLowAlarm=trapHumLowAlarm, pressInt=pressInt, tempLowInt=tempLowInt, trapNTPError=trapNTPError, t7610=t7610, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, compValAlarmInt=compValAlarmInt, trapPressClrAlarm=trapPressClrAlarm, trapEmailErrAuth=trapEmailErrAuth, tables=tables, compValDelayInt=compValDelayInt, histPress=histPress, pressMin=pressMin, tempInt=tempInt, tempAlarmInt=tempAlarmInt, values=values, humLowInt=humLowInt, pressUnit=pressUnit, tempHighInt=tempHighInt, trapCompValError=trapCompValError, trapTempLowAlarm=trapTempLowAlarm, products=products, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile)
