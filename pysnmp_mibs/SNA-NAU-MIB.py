...
# Notes
# -----
# ASN.1 source file://mibs/rfc/SNA-NAU-MIB
...
snanauCompliance.setObjects(
      *(("SNA-NAU-MIB", "snaNodeGroup"),
        ("SNA-NAU-MIB", "snaLuGroup"),
        ("SNA-NAU-MIB", "snaSessionGroup"),
        ("SNA-NAU-MIB", "snaPu20Group"),
        ("SNA-NAU-MIB", "snaMgtToolsRtmGroup"))
)
if mibBuilder.loadTexts:
