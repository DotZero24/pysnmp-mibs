...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/SNA-NAU-MIB
...
DisplayString, TimeStamp, RowStatus, InstancePointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowStatus", "InstancePointer", "TextualConvention")
...
mibBuilder.exportSymbols("SNA-NAU-MIB", snaLuAdminTable=snaLuAdminTable, snaLuOperEntry=snaLuOperEntry, snaNodeOperState=snaNodeOperState, snaLuOperTable=snaLuOperTable, snaLuSessnRemoteLuName=snaLuSessnRemoteLuName, snaNodeAdminBlockNum=snaNodeAdminBlockNum, snanauCompliances=snanauCompliances, snaNodeOperLastStateChange=snaNodeOperLastStateChange, snaNodeLinkAdminTableLastChange=snaNodeLinkAdminTableLastChange, snaLuSessnSenseData=snaLuSessnSenseData, snaNodeAdminMaxLu=snaNodeAdminMaxLu, snaNodeLinkOperTableLastChange=snaNodeLinkOperTableLastChange, snaNodeAdminStopMethod=snaNodeAdminStopMethod, snaLuRtmEntry=snaLuRtmEntry, snaLuRtmBoundary1=snaLuRtmBoundary1, snaNodeOperIdNum=snaNodeOperIdNum, snaLuSessnStatsEntry=snaLuSessnStatsEntry, snaNode=snaNode, snaLuSessnStatsReceivedNegativeResps=snaLuSessnStatsReceivedNegativeResps, snaLuOperName=snaLuOperName, snaLuOperState=snaLuOperState, snaLuRtmBoundary4=snaLuRtmBoundary4, snaLuRtmNumTrans=snaLuRtmNumTrans, snaNodeAdminEnablingMethod=snaNodeAdminEnablingMethod, snaLuSessnTerminationRu=snaLuSessnTerminationRu, snaNodeOperXidFormat=snaNodeOperXidFormat, snaLu=snaLu, snaNodeOperStartTime=snaNodeOperStartTime, snaLuRtmLuIndex=snaLuRtmLuIndex, snaNodeAdminTable=snaNodeAdminTable, snaNodeOperLuTermDefault=snaNodeOperLuTermDefault, snaLuSessnRcvPacingSize=snaLuSessnRcvPacingSize, snanauGroups=snanauGroups, snaNodeOperName=snaNodeOperName, snaLuOperDepType=snaLuOperDepType, snaNodeAdminIndex=snaNodeAdminIndex, snaLuRtmLastRspTime=snaLuRtmLastRspTime, snaLuOperType=snaLuOperType, snaLuAdminDisplayModel=snaLuAdminDisplayModel, snaNodeLinkOperEntry=snaNodeLinkOperEntry, snaNodeAdminRowStatus=snaNodeAdminRowStatus, snaLuRtmState=snaLuRtmState, snaLuSessnUnbindType=snaLuSessnUnbindType, snaLuSessnRluIndex=snaLuSessnRluIndex, snaLuSessnOperState=snaLuSessnOperState, snaLuSessnStatsSentRus=snaLuSessnStatsSentRus, snaLuRtmCounter1=snaLuRtmCounter1, snaLuRtmObjRange=snaLuRtmObjRange, snaPu20StatsSentPius=snaPu20StatsSentPius, snaNodeOperHostSscpId=snaNodeOperHostSscpId, snaNodeOperEntry=snaNodeOperEntry, snaLuSessnLocalApplName=snaLuSessnLocalApplName, snaNodeOperEnablingMethod=snaNodeOperEnablingMethod, snaLuOperLocalAddress=snaLuOperLocalAddress, snaPu20StatsActLus=snaPu20StatsActLus, snaLuGroup=snaLuGroup, snaLuOperSnaName=snaLuOperSnaName, snaNodeTraps=snaNodeTraps, snaPu20StatsEntry=snaPu20StatsEntry, snaLuRtmCounter2=snaLuRtmCounter2, snaLuSessnMaxSndRuSize=snaLuSessnMaxSndRuSize, snaLuAdminLocalAddress=snaLuAdminLocalAddress, snaNodeActFailTrap=snaNodeActFailTrap, snaLuAdminDepType=snaLuAdminDepType, snaPu20StatsReceivedNegativeResps=snaPu20StatsReceivedNegativeResps, snaLuSessnTable=snaLuSessnTable, snaPu20StatsReceivedBytes=snaPu20StatsReceivedBytes, snaLuAdminRowStatus=snaLuAdminRowStatus, snaLuSessnStatsReceivedBytes=snaLuSessnStatsReceivedBytes, snaLuSessnBindFailTrap=snaLuSessnBindFailTrap, snanauObjects=snanauObjects, snaLuRtmObjPercent=snaLuRtmObjPercent, snaLuOperDisplayModel=snaLuOperDisplayModel, snaLuSessnStatsSentBytes=snaLuSessnStatsSentBytes, snaLuRtmBoundary2=snaLuRtmBoundary2, snaLuRtmDef=snaLuRtmDef, snaNodeLinkAdminRowStatus=snaNodeLinkAdminRowStatus, snanauMIB=snanauMIB, snaNodeAdminState=snaNodeAdminState, snaNodeAdminName=snaNodeAdminName, snaNodeLinkOperTable=snaNodeLinkOperTable, snaNodeAdminEntry=snaNodeAdminEntry, snaLuSessnAdminState=snaLuSessnAdminState, snaSessionGroup=snaSessionGroup, snaLuRtmCounter4=snaLuRtmCounter4, snaNodeOperTable=snaNodeOperTable, snaNodeAdminType=snaNodeAdminType, snaNodeLinkAdminSpecific=snaNodeLinkAdminSpecific, snaLuSessnStatsReceivedRus=snaLuSessnStatsReceivedRus, snaPu20StatsInActLus=snaPu20StatsInActLus, snaNodeOperHostDescription=snaNodeOperHostDescription, snaNodeOperActFailures=snaNodeOperActFailures, snaNodeLinkAdminIndex=snaNodeLinkAdminIndex, snaLuSessnSndPacingSize=snaLuSessnSndPacingSize, snaLuRtmStateTime=snaLuRtmStateTime, snaPu20StatsBindLus=snaPu20StatsBindLus, snaLuRtmPuIndex=snaLuRtmPuIndex, snaNodeLinkOperSpecific=snaNodeLinkOperSpecific, snanauConformance=snanauConformance, snaNodeAdminHostDescription=snaNodeAdminHostDescription, snaLuSessnIndex=snaLuSessnIndex, snaLuStateChangeTrap=snaLuStateChangeTrap, PYSNMP_MODULE_ID=snanauMIB, snaNodeOperType=snaNodeOperType, snaPu20StatsTable=snaPu20StatsTable, snaNodeLinkAdminMaxPiu=snaNodeLinkAdminMaxPiu, snaLuOperSessnCount=snaLuOperSessnCount, snaLuSessnMaxRcvRuSize=snaLuSessnMaxRcvRuSize, snanauCompliance=snanauCompliance, snaLuSessnStatsTable=snaLuSessnStatsTable, snaLuSessnStatsSentNegativeResps=snaLuSessnStatsSentNegativeResps, snaLuRtmTable=snaLuRtmTable, snaLuTraps=snaLuTraps, snaNodeLinkAdminEntry=snaNodeLinkAdminEntry, snaLuRtmCounter3=snaLuRtmCounter3, snaLuRtmAvgRspTime=snaLuRtmAvgRspTime, snaNodeAdminLuTermDefault=snaNodeAdminLuTermDefault, snaNodeLinkAdminTable=snaNodeLinkAdminTable, snaNodeAdminTableLastChange=snaNodeAdminTableLastChange, snaLuRtmOverFlows=snaLuRtmOverFlows, snaNodeOperStopMethod=snaNodeOperStopMethod, snaLuAdminType=snaLuAdminType, snaPu20StatsSentBytes=snaPu20StatsSentBytes, snaNodeOperBlockNum=snaNodeOperBlockNum, snaNodeAdminXidFormat=snaNodeAdminXidFormat, snaLuSessnEntry=snaLuSessnEntry, snaLuSessnActiveTime=snaLuSessnActiveTime, snaMgtTools=snaMgtTools, snaNodeOperActFailureReason=snaNodeOperActFailureReason, snaNodeOperTableLastChange=snaNodeOperTableLastChange, snaPu20StatsReceivedPius=snaPu20StatsReceivedPius, snaLuAdminName=snaLuAdminName, snaLuAdminSnaName=snaLuAdminSnaName, snaNodeStateChangeTrap=snaNodeStateChangeTrap, snaNodeLinkOperMaxPiu=snaNodeLinkOperMaxPiu, snaLuAdminEntry=snaLuAdminEntry, snaPu20Group=snaPu20Group, snaLuOperTerm=snaLuOperTerm, snaLuAdminTerm=snaLuAdminTerm, snaLuSessnLinkIndex=snaLuSessnLinkIndex, snaNodeGroup=snaNodeGroup, snaNodeAdminIdNum=snaNodeAdminIdNum, snaNodeOperMaxLu=snaNodeOperMaxLu, snaLuAdminLuIndex=snaLuAdminLuIndex, snaMgtToolsRtmGroup=snaMgtToolsRtmGroup, snaPu20StatsSentNegativeResps=snaPu20StatsSentNegativeResps, snaLuRtmBoundary3=snaLuRtmBoundary3)
