...
RowStatus, TextualConvention, InstancePointer, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "InstancePointer", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SNA-NAU-MIB", snaLuAdminTerm=snaLuAdminTerm, snaNodeLinkOperSpecific=snaNodeLinkOperSpecific, snaLuAdminRowStatus=snaLuAdminRowStatus, snaPu20StatsSentPius=snaPu20StatsSentPius, snaLuOperState=snaLuOperState, snaNodeAdminTable=snaNodeAdminTable, snaLuRtmNumTrans=snaLuRtmNumTrans, snaLuAdminName=snaLuAdminName, snaLuRtmBoundary1=snaLuRtmBoundary1, snaLuSessnEntry=snaLuSessnEntry, snaNodeActFailTrap=snaNodeActFailTrap, snaNodeAdminLuTermDefault=snaNodeAdminLuTermDefault, snaLuOperTable=snaLuOperTable, snanauConformance=snanauConformance, snaLuRtmCounter3=snaLuRtmCounter3, snaNodeAdminRowStatus=snaNodeAdminRowStatus, snaNodeStateChangeTrap=snaNodeStateChangeTrap, snaNodeOperName=snaNodeOperName, snanauGroups=snanauGroups, snaLuRtmTable=snaLuRtmTable, snaNodeOperType=snaNodeOperType, snaNodeAdminEnablingMethod=snaNodeAdminEnablingMethod, snaNodeLinkAdminRowStatus=snaNodeLinkAdminRowStatus, snaLuRtmOverFlows=snaLuRtmOverFlows, snaLuRtmStateTime=snaLuRtmStateTime, snaLuOperSessnCount=snaLuOperSessnCount, snaLuStateChangeTrap=snaLuStateChangeTrap, snaLuSessnStatsReceivedNegativeResps=snaLuSessnStatsReceivedNegativeResps, snaNodeOperActFailures=snaNodeOperActFailures, snaNodeOperTable=snaNodeOperTable, snaLuSessnRcvPacingSize=snaLuSessnRcvPacingSize, snaNodeOperLastStateChange=snaNodeOperLastStateChange, snaPu20StatsInActLus=snaPu20StatsInActLus, snaLuAdminSnaName=snaLuAdminSnaName, snaNodeAdminTableLastChange=snaNodeAdminTableLastChange, snaPu20StatsReceivedNegativeResps=snaPu20StatsReceivedNegativeResps, snaPu20StatsSentNegativeResps=snaPu20StatsSentNegativeResps, snaLuGroup=snaLuGroup, snaLu=snaLu, snaNodeOperHostDescription=snaNodeOperHostDescription, snaLuSessnTable=snaLuSessnTable, snaNodeAdminXidFormat=snaNodeAdminXidFormat, snaNodeOperState=snaNodeOperState, snaNodeOperBlockNum=snaNodeOperBlockNum, snaLuAdminType=snaLuAdminType, snaPu20StatsActLus=snaPu20StatsActLus, snaSessionGroup=snaSessionGroup, snaLuOperName=snaLuOperName, snaLuSessnStatsSentNegativeResps=snaLuSessnStatsSentNegativeResps, snaLuSessnLocalApplName=snaLuSessnLocalApplName, snaLuSessnMaxRcvRuSize=snaLuSessnMaxRcvRuSize, snaPu20StatsReceivedPius=snaPu20StatsReceivedPius, snaNodeLinkAdminSpecific=snaNodeLinkAdminSpecific, snaNodeAdminState=snaNodeAdminState, snaLuRtmObjPercent=snaLuRtmObjPercent, snaLuSessnStatsReceivedBytes=snaLuSessnStatsReceivedBytes, snaNode=snaNode, snaLuRtmBoundary3=snaLuRtmBoundary3, snaLuRtmBoundary4=snaLuRtmBoundary4, snaNodeLinkOperTable=snaNodeLinkOperTable, snaNodeAdminName=snaNodeAdminName, snaLuAdminDepType=snaLuAdminDepType, snaLuSessnActiveTime=snaLuSessnActiveTime, snaNodeAdminStopMethod=snaNodeAdminStopMethod, snaLuOperSnaName=snaLuOperSnaName, snaLuRtmState=snaLuRtmState, snaLuOperDepType=snaLuOperDepType, snaNodeOperEntry=snaNodeOperEntry, snaLuSessnSndPacingSize=snaLuSessnSndPacingSize, PYSNMP_MODULE_ID=snanauMIB, snaNodeOperLuTermDefault=snaNodeOperLuTermDefault, snaLuSessnIndex=snaLuSessnIndex, snaPu20StatsBindLus=snaPu20StatsBindLus, snaLuSessnUnbindType=snaLuSessnUnbindType, snaNodeLinkOperEntry=snaNodeLinkOperEntry, snaLuSessnLinkIndex=snaLuSessnLinkIndex, snaLuOperEntry=snaLuOperEntry, snaLuTraps=snaLuTraps, snaNodeOperActFailureReason=snaNodeOperActFailureReason, snaLuAdminLuIndex=snaLuAdminLuIndex, snaNodeAdminBlockNum=snaNodeAdminBlockNum, snaNodeOperHostSscpId=snaNodeOperHostSscpId, snaLuSessnRluIndex=snaLuSessnRluIndex, snaLuSessnRemoteLuName=snaLuSessnRemoteLuName, snaPu20StatsTable=snaPu20StatsTable, snaNodeGroup=snaNodeGroup, snaNodeLinkAdminEntry=snaNodeLinkAdminEntry, snaNodeAdminEntry=snaNodeAdminEntry, snaLuAdminEntry=snaLuAdminEntry, snaLuSessnStatsEntry=snaLuSessnStatsEntry, snaLuSessnStatsSentBytes=snaLuSessnStatsSentBytes, snaLuSessnStatsSentRus=snaLuSessnStatsSentRus, snaLuRtmCounter4=snaLuRtmCounter4, snaNodeLinkAdminMaxPiu=snaNodeLinkAdminMaxPiu, snaNodeOperStartTime=snaNodeOperStartTime, snaLuRtmObjRange=snaLuRtmObjRange, snaLuRtmLastRspTime=snaLuRtmLastRspTime, snaLuRtmLuIndex=snaLuRtmLuIndex, snaNodeOperIdNum=snaNodeOperIdNum, snaPu20Group=snaPu20Group, snaMgtToolsRtmGroup=snaMgtToolsRtmGroup, snaNodeAdminType=snaNodeAdminType, snaNodeLinkOperMaxPiu=snaNodeLinkOperMaxPiu, snaLuRtmPuIndex=snaLuRtmPuIndex, snaPu20StatsSentBytes=snaPu20StatsSentBytes, snaLuAdminTable=snaLuAdminTable, snaNodeAdminIndex=snaNodeAdminIndex, snaLuAdminDisplayModel=snaLuAdminDisplayModel, snaLuSessnStatsReceivedRus=snaLuSessnStatsReceivedRus, snaMgtTools=snaMgtTools, snaLuSessnTerminationRu=snaLuSessnTerminationRu, snaPu20StatsEntry=snaPu20StatsEntry, snaLuAdminLocalAddress=snaLuAdminLocalAddress, snaLuOperTerm=snaLuOperTerm, snaNodeLinkAdminTableLastChange=snaNodeLinkAdminTableLastChange, snaLuSessnMaxSndRuSize=snaLuSessnMaxSndRuSize, snaLuOperLocalAddress=snaLuOperLocalAddress, snaNodeTraps=snaNodeTraps, snaLuSessnBindFailTrap=snaLuSessnBindFailTrap, snanauObjects=snanauObjects, snaLuRtmDef=snaLuRtmDef, snaLuRtmCounter2=snaLuRtmCounter2, snaLuRtmCounter1=snaLuRtmCounter1, snaLuRtmBoundary2=snaLuRtmBoundary2, snaLuOperType=snaLuOperType, snaNodeLinkAdminTable=snaNodeLinkAdminTable, snaLuRtmEntry=snaLuRtmEntry, snaNodeAdminIdNum=snaNodeAdminIdNum, snaNodeOperStopMethod=snaNodeOperStopMethod, snaLuSessnAdminState=snaLuSessnAdminState, snaLuRtmAvgRspTime=snaLuRtmAvgRspTime, snaLuOperDisplayModel=snaLuOperDisplayModel, snaNodeOperXidFormat=snaNodeOperXidFormat, snaNodeLinkAdminIndex=snaNodeLinkAdminIndex, snaPu20StatsReceivedBytes=snaPu20StatsReceivedBytes, snaNodeOperTableLastChange=snaNodeOperTableLastChange, snaLuSessnSenseData=snaLuSessnSenseData, snaNodeAdminMaxLu=snaNodeAdminMaxLu, snaNodeAdminHostDescription=snaNodeAdminHostDescription, snaNodeOperEnablingMethod=snaNodeOperEnablingMethod, snaNodeOperMaxLu=snaNodeOperMaxLu, snaLuSessnOperState=snaLuSessnOperState, snanauMIB=snanauMIB, snanauCompliance=snanauCompliance, snanauCompliances=snanauCompliances, snaLuSessnStatsTable=snaLuSessnStatsTable, snaNodeLinkOperTableLastChange=snaNodeLinkOperTableLastChange)
