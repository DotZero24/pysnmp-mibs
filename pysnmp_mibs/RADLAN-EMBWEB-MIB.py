# SNMP MIB module (RADLAN-EMBWEB-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-EMBWEB-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:18 2025
...
rlEmWebSecurityEntry = _RlEmWebSecurityEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 66, 3, 1)
)
rlEmWebSecurityEntry.setIndexNames(
    (0, "RADLAN-EMBWEB-MIB", "rlEmWebSecurityUserName"),
)
if mibBuilder.loadTexts:
...
rlEmWebServiceEntry = _RlEmWebServiceEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 66, 30, 1)
)
rlEmWebServiceEntry.setIndexNames(
    (0, "RADLAN-EMBWEB-MIB", "rlEmWebServiceId"),
)
if mibBuilder.loadTexts:
