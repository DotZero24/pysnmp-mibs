...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DNS-CLIENT-MIB
...
_CdcDNSServerAddrType_Type.__name__ = "InetAddressType"
...
ciscoDNSClientMIBCompliance.setObjects(
      *(("CISCO-DNS-CLIENT-MIB", "ciscoDNSServerConfigGroup"),
        ("CISCO-DNS-CLIENT-MIB", "ciscoDNSDomainNameConfigGroup"))
)
if mibBuilder.loadTexts:
