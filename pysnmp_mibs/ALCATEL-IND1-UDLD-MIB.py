...
_e='alaUdldGlobalConfigUdldProbeIntervalTimer'
_d='alaUdldGlobalConfigUdldMode'
_c='alaUdldGlobalConfigUdldDetectionPeriodTimer'
...
DisplayString,MacAddress,PhysAddress,TextualConvention=mibBuilder.importSymbols('SNMPv2-TC',_Q,'MacAddress','PhysAddress','TextualConvention')
...
alcatelIND1UDLDMIBObjects=_AlcatelIND1UDLDMIBObjects_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,44,1,1))
...
alaUdldGlobalStatus=_AlaUdldGlobalStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,1),_AlaUdldGlobalStatus_Type())
...
alaUdldGlobalClearStats=_AlaUdldGlobalClearStats_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,2),_AlaUdldGlobalClearStats_Type())
...
alaUdldGlobalConfigUdldMode=_AlaUdldGlobalConfigUdldMode_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,3),_AlaUdldGlobalConfigUdldMode_Type())
...
alaUdldGlobalConfigUdldProbeIntervalTimer=_AlaUdldGlobalConfigUdldProbeIntervalTimer_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,4),_AlaUdldGlobalConfigUdldProbeIntervalTimer_Type())
...
alaUdldGlobalConfigUdldDetectionPeriodTimer=_AlaUdldGlobalConfigUdldDetectionPeriodTimer_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,5),_AlaUdldGlobalConfigUdldDetectionPeriodTimer_Type())
...
udldPortConfig=_UdldPortConfig_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,6))
_AlaUdldPortConfigTable_Object=MibTable
alaUdldPortConfigTable=_AlaUdldPortConfigTable_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,6,1))
if mibBuilder.loadTexts:alaUdldPortConfigTable.setStatus(_A)
_AlaUdldPortConfigEntry_Object=MibTableRow
alaUdldPortConfigEntry=_AlaUdldPortConfigEntry_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,6,1,1))
...
alaUdldPortConfigIfIndex=_AlaUdldPortConfigIfIndex_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,6,1,1,1),_AlaUdldPortConfigIfIndex_Type())
...
alaUdldPortConfigUdldStatus=_AlaUdldPortConfigUdldStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,6,1,1,2),_AlaUdldPortConfigUdldStatus_Type())
...
alaUdldPortConfigUdldMode=_AlaUdldPortConfigUdldMode_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,6,1,1,3),_AlaUdldPortConfigUdldMode_Type())
...
alaUdldPortConfigUdldProbeIntervalTimer=_AlaUdldPortConfigUdldProbeIntervalTimer_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,6,1,1,4),_AlaUdldPortConfigUdldProbeIntervalTimer_Type())
...
alaUdldPortConfigUdldDetectionPeriodTimer=_AlaUdldPortConfigUdldDetectionPeriodTimer_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,6,1,1,5),_AlaUdldPortConfigUdldDetectionPeriodTimer_Type())
...
alaUdldPortConfigUdldOperationalStatus=_AlaUdldPortConfigUdldOperationalStatus_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,6,1,1,6),_AlaUdldPortConfigUdldOperationalStatus_Type())
...
udldPortStats=_UdldPortStats_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7))
_AlaUdldPortStatsTable_Object=MibTable
alaUdldPortStatsTable=_AlaUdldPortStatsTable_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7,1))
if mibBuilder.loadTexts:alaUdldPortStatsTable.setStatus(_A)
_AlaUdldPortStatsEntry_Object=MibTableRow
alaUdldPortStatsEntry=_AlaUdldPortStatsEntry_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7,1,1))
...
alaUdldPortStatsIfIndex=_AlaUdldPortStatsIfIndex_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7,1,1,1),_AlaUdldPortStatsIfIndex_Type())
...
alaUdldNumUDLDNeighbors=_AlaUdldNumUDLDNeighbors_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7,1,1,2),_AlaUdldNumUDLDNeighbors_Type())
...
alaUdldPortStatsClear=_AlaUdldPortStatsClear_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7,1,1,3),_AlaUdldPortStatsClear_Type())
...
alaUdldPortNumProbeSent=_AlaUdldPortNumProbeSent_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7,1,1,4),_AlaUdldPortNumProbeSent_Type())
...
alaUdldPortNumEchoSent=_AlaUdldPortNumEchoSent_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7,1,1,5),_AlaUdldPortNumEchoSent_Type())
...
alaUdldPortNumInvalidRcvd=_AlaUdldPortNumInvalidRcvd_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7,1,1,6),_AlaUdldPortNumInvalidRcvd_Type())
...
alaUdldPortNumFlushRcvd=_AlaUdldPortNumFlushRcvd_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,7,1,1,7),_AlaUdldPortNumFlushRcvd_Type())
...
udldPortNeighborStats=_UdldPortNeighborStats_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,8))
_AlaUdldPortNeighborStatsTable_Object=MibTable
alaUdldPortNeighborStatsTable=_AlaUdldPortNeighborStatsTable_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,8,1))
if mibBuilder.loadTexts:alaUdldPortNeighborStatsTable.setStatus(_A)
_AlaUdldPortNeighborStatsEntry_Object=MibTableRow
alaUdldPortNeighborStatsEntry=_AlaUdldPortNeighborStatsEntry_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,8,1,1))
...
alaUdldPortNeighborStatsIfIndex=_AlaUdldPortNeighborStatsIfIndex_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,8,1,1,1),_AlaUdldPortNeighborStatsIfIndex_Type())
...
alaUdldNeighborIfIndex=_AlaUdldNeighborIfIndex_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,8,1,1,2),_AlaUdldNeighborIfIndex_Type())
alaUdldNeighborIfIndex.setMaxAccess(_H)
if mibBuilder.loadTexts:alaUdldNeighborIfIndex.setStatus(_A)
class _AlaUdldNeighborName_Type(DisplayString):defaultValue=OctetString('');subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,255))
_AlaUdldNeighborName_Type.__name__=_Q
_AlaUdldNeighborName_Object=MibTableColumn
alaUdldNeighborName=_AlaUdldNeighborName_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,8,1,1,3),_AlaUdldNeighborName_Type())
...
alaUdldNumHelloRcvd=_AlaUdldNumHelloRcvd_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,8,1,1,4),_AlaUdldNumHelloRcvd_Type())
...
alaUdldNumEchoRcvd=_AlaUdldNumEchoRcvd_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,8,1,1,5),_AlaUdldNumEchoRcvd_Type())
...
alaUdldPrevState=_AlaUdldPrevState_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,9),_AlaUdldPrevState_Type())
...
alaUdldCurrentState=_AlaUdldCurrentState_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,10),_AlaUdldCurrentState_Type())
...
alaUdldPortIfIndex=_AlaUdldPortIfIndex_Object((1,3,6,1,4,1,6486,800,1,2,1,44,1,1,11),_AlaUdldPortIfIndex_Type())
...
alcatelIND1UDLDMIBConformance=_AlcatelIND1UDLDMIBConformance_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,44,1,2))
...
alcatelIND1UDLDMIBGroups=_AlcatelIND1UDLDMIBGroups_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,44,1,2,1))
...
alcatelIND1UDLDMIBCompliances=_AlcatelIND1UDLDMIBCompliances_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,44,1,2,2))
if mibBuilder.loadTexts:alcatelIND1UDLDMIBCompliances.setStatus(_A)
_AlaUdldEvents_ObjectIdentity=ObjectIdentity
alaUdldEvents=_AlaUdldEvents_ObjectIdentity((1,3,6,1,4,1,6486,800,1,2,1,44,1,3))
udldPortBaseGroup=ObjectGroup((1,3,6,1,4,1,6486,800,1,2,1,44,1,2,1,1))
udldPortBaseGroup.setObjects(*((_B,_a),(_B,_b),(_B,_N),(_B,_O),(_B,_P),(_B,_c),(_B,_d),(_B,_e)))
if mibBuilder.loadTexts:udldPortBaseGroup.setStatus(_A)
udldPortConfigGroup=ObjectGroup((1,3,6,1,4,1,6486,800,1,2,1,44,1,2,1,2))
udldPortConfigGroup.setObjects(*((_B,_f),(_B,_g),(_B,_h),(_B,_i),(_B,_j)))
if mibBuilder.loadTexts:udldPortConfigGroup.setStatus(_A)
udldPortStatsGroup=ObjectGroup((1,3,6,1,4,1,6486,800,1,2,1,44,1,2,1,3))
udldPortStatsGroup.setObjects(*((_B,_k),(_B,_l),(_B,_m),(_B,_n),(_B,_o),(_B,_p)))
if mibBuilder.loadTexts:udldPortStatsGroup.setStatus(_A)
udldPortNeighborStatsGroup=ObjectGroup((1,3,6,1,4,1,6486,800,1,2,1,44,1,2,1,4))
udldPortNeighborStatsGroup.setObjects(*((_B,_q),(_B,_r),(_B,_s)))
if mibBuilder.loadTexts:udldPortNeighborStatsGroup.setStatus(_A)
udldStateChange=NotificationType((1,3,6,1,4,1,6486,800,1,2,1,44,1,3,0,1))
udldStateChange.setObjects(*((_B,_P),(_B,_N),(_B,_O)))
if mibBuilder.loadTexts:udldStateChange.setStatus(_A)
udldPortTrapGroup=NotificationGroup((1,3,6,1,4,1,6486,800,1,2,1,44,1,2,1,5))
udldPortTrapGroup.setObjects((_B,_t))
if mibBuilder.loadTexts:udldPortTrapGroup.setStatus(_A)
alcatelIND1UDLDMIBCompliance=ModuleCompliance((1,3,6,1,4,1,6486,800,1,2,1,44,1,2,2,1))
