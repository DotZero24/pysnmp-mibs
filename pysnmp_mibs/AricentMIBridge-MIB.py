...
futureMIBridgeMIB=ModuleIdentity((1,3,6,1,4,1,2076,117))
...
fsMIDot1dFutureBridge=_FsMIDot1dFutureBridge_ObjectIdentity((1,3,6,1,4,1,2076,117,1))
_FsMIDot1dFutureBase_ObjectIdentity=ObjectIdentity
fsMIDot1dFutureBase=_FsMIDot1dFutureBase_ObjectIdentity((1,3,6,1,4,1,2076,117,1,1))
_FsMIDot1dFutureBaseTable_Object=MibTable
fsMIDot1dFutureBaseTable=_FsMIDot1dFutureBaseTable_Object((1,3,6,1,4,1,2076,117,1,1,1))
if mibBuilder.loadTexts:fsMIDot1dFutureBaseTable.setStatus(_A)
_FsMIDot1dFutureBaseEntry_Object=MibTableRow
fsMIDot1dFutureBaseEntry=_FsMIDot1dFutureBaseEntry_Object((1,3,6,1,4,1,2076,117,1,1,1,1))
...
fsMIDot1dFutureBaseContextId=_FsMIDot1dFutureBaseContextId_Object((1,3,6,1,4,1,2076,117,1,1,1,1,1),_FsMIDot1dFutureBaseContextId_Type())
...
fsMIDot1dBridgeSystemControl=_FsMIDot1dBridgeSystemControl_Object((1,3,6,1,4,1,2076,117,1,1,1,1,2),_FsMIDot1dBridgeSystemControl_Type())
...
fsMIDot1dBaseBridgeStatus=_FsMIDot1dBaseBridgeStatus_Object((1,3,6,1,4,1,2076,117,1,1,1,1,3),_FsMIDot1dBaseBridgeStatus_Type())
...
fsMIDot1dBaseBridgeCRCStatus=_FsMIDot1dBaseBridgeCRCStatus_Object((1,3,6,1,4,1,2076,117,1,1,1,1,4),_FsMIDot1dBaseBridgeCRCStatus_Type())
...
fsMIDot1dBaseBridgeDebug=_FsMIDot1dBaseBridgeDebug_Object((1,3,6,1,4,1,2076,117,1,1,1,1,5),_FsMIDot1dBaseBridgeDebug_Type())
...
fsMIDot1dBaseBridgeTrace=_FsMIDot1dBaseBridgeTrace_Object((1,3,6,1,4,1,2076,117,1,1,1,1,6),_FsMIDot1dBaseBridgeTrace_Type())
...
fsMIDot1dBaseBridgeMaxFwdDbEntries=_FsMIDot1dBaseBridgeMaxFwdDbEntries_Object((1,3,6,1,4,1,2076,117,1,1,1,1,7),_FsMIDot1dBaseBridgeMaxFwdDbEntries_Type())
...
fsMIDot1dFutureBasePortTable=_FsMIDot1dFutureBasePortTable_Object((1,3,6,1,4,1,2076,117,1,1,2))
if mibBuilder.loadTexts:fsMIDot1dFutureBasePortTable.setStatus(_A)
_FsMIDot1dFutureBasePortEntry_Object=MibTableRow
fsMIDot1dFutureBasePortEntry=_FsMIDot1dFutureBasePortEntry_Object((1,3,6,1,4,1,2076,117,1,1,2,1))
...
fsMIDot1dFutureBasePort=_FsMIDot1dFutureBasePort_Object((1,3,6,1,4,1,2076,117,1,1,2,1,1),_FsMIDot1dFutureBasePort_Type())
...
fsMIDot1dBasePortAdminStatus=_FsMIDot1dBasePortAdminStatus_Object((1,3,6,1,4,1,2076,117,1,1,2,1,2),_FsMIDot1dBasePortAdminStatus_Type())
...
fsMIDot1dBasePortOperStatus=_FsMIDot1dBasePortOperStatus_Object((1,3,6,1,4,1,2076,117,1,1,2,1,3),_FsMIDot1dBasePortOperStatus_Type())
...
fsMIDot1dBasePortBcastStatus=_FsMIDot1dBasePortBcastStatus_Object((1,3,6,1,4,1,2076,117,1,1,2,1,4),_FsMIDot1dBasePortBcastStatus_Type())
...
fsMIDot1dBasePortFilterNumber=_FsMIDot1dBasePortFilterNumber_Object((1,3,6,1,4,1,2076,117,1,1,2,1,5),_FsMIDot1dBasePortFilterNumber_Type())
...
fsMIDot1dBasePortMcastNumber=_FsMIDot1dBasePortMcastNumber_Object((1,3,6,1,4,1,2076,117,1,1,2,1,6),_FsMIDot1dBasePortMcastNumber_Type())
...
fsMIDot1dBasePortBcastOutFrames=_FsMIDot1dBasePortBcastOutFrames_Object((1,3,6,1,4,1,2076,117,1,1,2,1,7),_FsMIDot1dBasePortBcastOutFrames_Type())
...
fsMIDot1dBasePortMcastOutFrames=_FsMIDot1dBasePortMcastOutFrames_Object((1,3,6,1,4,1,2076,117,1,1,2,1,8),_FsMIDot1dBasePortMcastOutFrames_Type())
...
fsMIDot1dFutureTp=_FsMIDot1dFutureTp_ObjectIdentity((1,3,6,1,4,1,2076,117,1,2))
_FsMIDot1dFutureTpPortTable_Object=MibTable
fsMIDot1dFutureTpPortTable=_FsMIDot1dFutureTpPortTable_Object((1,3,6,1,4,1,2076,117,1,2,1))
if mibBuilder.loadTexts:fsMIDot1dFutureTpPortTable.setStatus(_A)
_FsMIDot1dFutureTpPortEntry_Object=MibTableRow
fsMIDot1dFutureTpPortEntry=_FsMIDot1dFutureTpPortEntry_Object((1,3,6,1,4,1,2076,117,1,2,1,1))
...
fsMIDot1dFutureTpPort=_FsMIDot1dFutureTpPort_Object((1,3,6,1,4,1,2076,117,1,2,1,1,1),_FsMIDot1dFutureTpPort_Type())
...
fsMIDot1dTpPortInProtoDiscards=_FsMIDot1dTpPortInProtoDiscards_Object((1,3,6,1,4,1,2076,117,1,2,1,1,2),_FsMIDot1dTpPortInProtoDiscards_Type())
...
fsMIDot1dTpPortInFilterDiscards=_FsMIDot1dTpPortInFilterDiscards_Object((1,3,6,1,4,1,2076,117,1,2,1,1,3),_FsMIDot1dTpPortInFilterDiscards_Type())
...
fsMIDot1dTpPortProtocolFilterMask=_FsMIDot1dTpPortProtocolFilterMask_Object((1,3,6,1,4,1,2076,117,1,2,1,1,4),_FsMIDot1dTpPortProtocolFilterMask_Type())
...
fsMIDot1dFilter=_FsMIDot1dFilter_ObjectIdentity((1,3,6,1,4,1,2076,117,1,3))
_FsMIDot1dFilterTable_Object=MibTable
fsMIDot1dFilterTable=_FsMIDot1dFilterTable_Object((1,3,6,1,4,1,2076,117,1,3,1))
if mibBuilder.loadTexts:fsMIDot1dFilterTable.setStatus(_A)
_FsMIDot1dFilterEntry_Object=MibTableRow
fsMIDot1dFilterEntry=_FsMIDot1dFilterEntry_Object((1,3,6,1,4,1,2076,117,1,3,1,1))
...
fsMIDot1dFilterNumber=_FsMIDot1dFilterNumber_Object((1,3,6,1,4,1,2076,117,1,3,1,1,1),_FsMIDot1dFilterNumber_Type())
...
fsMIDot1dFilterSrcAddress=_FsMIDot1dFilterSrcAddress_Object((1,3,6,1,4,1,2076,117,1,3,1,1,2),_FsMIDot1dFilterSrcAddress_Type())
...
fsMIDot1dFilterSrcMask=_FsMIDot1dFilterSrcMask_Object((1,3,6,1,4,1,2076,117,1,3,1,1,3),_FsMIDot1dFilterSrcMask_Type())
...
fsMIDot1dFilterDstAddress=_FsMIDot1dFilterDstAddress_Object((1,3,6,1,4,1,2076,117,1,3,1,1,4),_FsMIDot1dFilterDstAddress_Type())
...
fsMIDot1dFilterDstMask=_FsMIDot1dFilterDstMask_Object((1,3,6,1,4,1,2076,117,1,3,1,1,5),_FsMIDot1dFilterDstMask_Type())
...
fsMIDot1dFilterPermiss=_FsMIDot1dFilterPermiss_Object((1,3,6,1,4,1,2076,117,1,3,1,1,6),_FsMIDot1dFilterPermiss_Type())
...
fsMIDot1dMcast=_FsMIDot1dMcast_ObjectIdentity((1,3,6,1,4,1,2076,117,1,4))
_FsMIDot1dMcastTable_Object=MibTable
fsMIDot1dMcastTable=_FsMIDot1dMcastTable_Object((1,3,6,1,4,1,2076,117,1,4,1))
if mibBuilder.loadTexts:fsMIDot1dMcastTable.setStatus(_A)
_FsMIDot1dMcastEntry_Object=MibTableRow
fsMIDot1dMcastEntry=_FsMIDot1dMcastEntry_Object((1,3,6,1,4,1,2076,117,1,4,1,1))
...
fsMIDot1dMlistNumber=_FsMIDot1dMlistNumber_Object((1,3,6,1,4,1,2076,117,1,4,1,1,1),_FsMIDot1dMlistNumber_Type())
...
fsMIDot1dMcastMacaddress=_FsMIDot1dMcastMacaddress_Object((1,3,6,1,4,1,2076,117,1,4,1,1,2),_FsMIDot1dMcastMacaddress_Type())
...
fsMIDot1dMcastPermiss=_FsMIDot1dMcastPermiss_Object((1,3,6,1,4,1,2076,117,1,4,1,1,3),_FsMIDot1dMcastPermiss_Type())
