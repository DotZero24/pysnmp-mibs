...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/nortel/ALTEON-CS-PHYSICAL-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 11:07:12 2025
...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortEdge=stpInfoPortEdge, PYSNMP_MODULE_ID=layer2, lacpNewSystemName=lacpNewSystemName, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, fdbStatsHiwat=fdbStatsHiwat, lacpCurSystemPriority=lacpCurSystemPriority, fdbLearnedPort=fdbLearnedPort, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanCurCfgShared=vlanCurCfgShared, vlanNewCfgShared=vlanNewCfgShared, vlanCurCfgRlTime=vlanCurCfgRlTime, vlanInfoTableVADC=vlanInfoTableVADC, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamCurCfgIndex=portTeamCurCfgIndex, fdbSrcPort=fdbSrcPort, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgOFlag=vlanCurCfgOFlag, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamInfoState=portTeamInfoState, vlanNewCfgIpv6LlaGen=vlanNewCfgIpv6LlaGen, vlanNewCfgMinIntBwAdv=vlanNewCfgMinIntBwAdv, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vadcVlanCurCfgOFlag=vadcVlanCurCfgOFlag, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCfg=stgCfg, layer2Stats=layer2Stats, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortPathCost=stpInfoPortPathCost, cistRoot=cistRoot, vadcVlanCurCfgPlTime=vadcVlanCurCfgPlTime, vlanCurCfgMaxIntBwAdv=vlanCurCfgMaxIntBwAdv, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, lacpInfoPortTable=lacpInfoPortTable, vlanCurCfgRTime=vlanCurCfgRTime, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgCurHopLimit=vlanCurCfgCurHopLimit, vadcVlanCurCfgCurHopLimit=vadcVlanCurCfgCurHopLimit, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, cistInfoPortLinkType=cistInfoPortLinkType, cistGeneralInfo=cistGeneralInfo, vadcVlanNewCfgVlanId=vadcVlanNewCfgVlanId, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpCurPortState=lacpCurPortState, fdbStats=fdbStats, vadcVlanCurCfgApInfo=vadcVlanCurCfgApInfo, portTeamNewCfgTable=portTeamNewCfgTable, stgNewCfgTable=stgNewCfgTable, fdbStatsCurrent=fdbStatsCurrent, fdbStatsLookups=fdbStatsLookups, fdbClear=fdbClear, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoPortsState=portTeamInfoPortsState, vadcVlanCurCfgTableEntry=vadcVlanCurCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stpInfo=stpInfo, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfoRootPort=stpInfoRootPort, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vadcVlanNewCfgNonIp=vadcVlanNewCfgNonIp, vlanNewCfgRlTime=vlanNewCfgRlTime, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, lacpInfo=lacpInfo, stpInfoPortRole=stpInfoPortRole, layer2Oper=layer2Oper, mirroring=mirroring, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbEntry=fdbEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgStatsPortIndex=stgStatsPortIndex, fdbStatsOverflows=fdbStatsOverflows, vadcVlanCurCfgTable=vadcVlanCurCfgTable, cistInfoPortPathCost=cistInfoPortPathCost, mstCurCfgRegionName=mstCurCfgRegionName, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanInfoStatus=vlanInfoStatus, cistInfoPortState=cistInfoPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortIndex=stgCurCfgPortIndex, vadcVlanNewCfgTableEntry=vadcVlanNewCfgTableEntry, vlanNewCfgMtu=vlanNewCfgMtu, vlanInfoIdx=vlanInfoIdx, fdbStatsFindFails=fdbStatsFindFails, fdbStatsFinds=fdbStatsFinds, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgStatsStpIndex=stgStatsStpIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgIpv6LlaGen=vlanCurCfgIpv6LlaGen, mstNewCfgState=mstNewCfgState, fdbStatsCreates=fdbStatsCreates, mirrPortMirr=mirrPortMirr, cistBridgeForwardDelay=cistBridgeForwardDelay, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, vadcVlanCurCfgReTransInt=vadcVlanCurCfgReTransInt, stgNewCfgPortEdge=stgNewCfgPortEdge, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamCurCfgState=portTeamCurCfgState, vadcVlanNewCfgVlTime=vadcVlanNewCfgVlTime, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgName=trunkGroupNewCfgName, stgCurCfgState=stgCurCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoTable=stpInfoTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbMacAddr=fdbMacAddr, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgVlanName=vlanNewCfgVlanName, stgStatsPortTableEntry=stgStatsPortTableEntry, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, portTeamInfoTableEntry=portTeamInfoTableEntry, vadcVlanCurCfgNonIp=vadcVlanCurCfgNonIp, vadcVlanNewCfgOpInfo=vadcVlanNewCfgOpInfo, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortMoved=lacpInfoPortMoved, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portTeamInfoIndex=portTeamInfoIndex, vlanInfoTable=vlanInfoTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanInfoLearn=vlanInfoLearn, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, vlanNewCfgLearn=vlanNewCfgLearn, stgCurCfgTable=stgCurCfgTable, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbVlan=fdbVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vadcVlanCurCfgRouterAdv=vadcVlanCurCfgRouterAdv, vlanCurCfgVlanId=vlanCurCfgVlanId, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vadcVlan=vadcVlan, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, vadcVlanCurCfgIpv6LlaGen=vadcVlanCurCfgIpv6LlaGen, vadcVlanNewCfgPlTime=vadcVlanNewCfgPlTime, vlanNewCfgRouterAdv=vlanNewCfgRouterAdv, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, vlanInfoTableVADCEntry=vlanInfoTableVADCEntry, vlanCurCfgState=vlanCurCfgState, stgCurCfgPriority=stgCurCfgPriority, vlanNewCfgPorts=vlanNewCfgPorts, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, lacpInfoPortNtt=lacpInfoPortNtt, vlanCurCfgOpInfo=vlanCurCfgOpInfo, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgState=stgNewCfgState, vlanInfoId=vlanInfoId, vadcVlanCurCfgMtu=vadcVlanCurCfgMtu, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stgNewCfgIndex=stgNewCfgIndex, vadcVlanCurCfgVlanId=vadcVlanCurCfgVlanId, layer2Info=layer2Info, vadcVlanNewCfgRTime=vadcVlanNewCfgRTime, vadcVlanNewCfgMFlag=vadcVlanNewCfgMFlag, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vadcVlanNewCfgReTransInt=vadcVlanNewCfgReTransInt, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgPlTime=vlanNewCfgPlTime, layer2Configs=layer2Configs, vadcVlanNewCfgRlTime=vadcVlanNewCfgRlTime, vlanNewCfgOFlag=vlanNewCfgOFlag, stpInfoRootCost=stpInfoRootCost, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, portTeamNewCfgDelete=portTeamNewCfgDelete, cistBridgeHelloTime=cistBridgeHelloTime, portTeamInfoTrunks=portTeamInfoTrunks, stpStats=stpStats, portTeamNewCfgState=portTeamNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, vlanNewCfgVlTime=vlanNewCfgVlTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgOpInfo=vlanNewCfgOpInfo, lacpNewPortCfgTableId=lacpNewPortCfgTableId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, vadcVlanNewCfgApInfo=vadcVlanNewCfgApInfo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanInfoVADC=vlanInfoVADC, stpInfoPortStpIndex=stpInfoPortStpIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanCurCfgStg=vlanCurCfgStg, mstCurCfgStpMode=mstCurCfgStpMode, portTeamCurCfgTrunks=portTeamCurCfgTrunks, fdbInfo=fdbInfo, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, mstCistCfg=mstCistCfg, lacpInfoPortIndex=lacpInfoPortIndex, fdbState=fdbState, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgIndex=portTeamNewCfgIndex, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanMaxEnt=vlanMaxEnt, pmCurCfgPortMirrState=pmCurCfgPortMirrState, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfo=vlanInfo, vlanCurCfgApInfo=vlanCurCfgApInfo, vadcVlanCurCfgRlTime=vadcVlanCurCfgRlTime, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanMaxVlanID=vlanMaxVlanID, vadcVlanNewCfgMinIntBwAdv=vadcVlanNewCfgMinIntBwAdv, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoPortLinkType=stpInfoPortLinkType, fdbStatsDeletes=fdbStatsDeletes, vlanCurCfgVlTime=vlanCurCfgVlTime, vlanInfoBwmContract=vlanInfoBwmContract, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgMFlag=vlanCurCfgMFlag, stgCurCfgPortEdge=stgCurCfgPortEdge, vadcVlanCurCfgMaxIntBwAdv=vadcVlanCurCfgMaxIntBwAdv, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vadcVlanCurCfgVlTime=vadcVlanCurCfgVlTime, stpInfoHoldTime=stpInfoHoldTime, cistBridgeMaxAge=cistBridgeMaxAge, vadcVlanNewCfgIpv6LlaGen=vadcVlanNewCfgIpv6LlaGen, lacpInfoPortReadyN=lacpInfoPortReadyN, cistInfoPortTable=cistInfoPortTable, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCfg=portTeamCfg, stpInfoMaxAge=stpInfoMaxAge, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbRefSps=fdbRefSps, stpInfoPortState=stpInfoPortState, cistInfo=cistInfo, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vadcVlanNewCfgMaxIntBwAdv=vadcVlanNewCfgMaxIntBwAdv)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgDelete=vlanNewCfgDelete, mstCfg=mstCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, vadcVlanNewCfgBwmCont=vadcVlanNewCfgBwmCont, portTeamInfoPorts=portTeamInfoPorts, lacpCurPortCfgTable=lacpCurPortCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgReTransInt=vlanNewCfgReTransInt, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbTable=fdbTable, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, cistRootPort=cistRootPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stpInfoIndex=stpInfoIndex, vlanInfoPorts=vlanInfoPorts, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamCurCfgName=portTeamCurCfgName, mstGeneralCfg=mstGeneralCfg, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgStatsPortTable=stgStatsPortTable, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgStg=vlanNewCfgStg, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanNewCfgApInfo=vlanNewCfgApInfo, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, portTeamCurCfgTable=portTeamCurCfgTable, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanCurCfgMinIntBwAdv=vlanCurCfgMinIntBwAdv, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, cistRegionalPathCost=cistRegionalPathCost, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vadcVlanCurCfgOpInfo=vadcVlanCurCfgOpInfo, trunkgroup=trunkgroup, lacpCurSystemName=lacpCurSystemName, vadcVlanCurCfgMFlag=vadcVlanCurCfgMFlag, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, fdbSrcTrunk=fdbSrcTrunk, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vadcVlanNewCfgOFlag=vadcVlanNewCfgOFlag, vlanCurCfgReTransInt=vlanCurCfgReTransInt, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoTable=portTeamInfoTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgPorts=vlanCurCfgPorts, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistBridgeCfg=mstCistBridgeCfg, stpInfoPortTable=stpInfoPortTable, vlanNewCfgRTime=vlanNewCfgRTime, cistRegionalRoot=cistRegionalRoot, vadcVlanNewCfgCurHopLimit=vadcVlanNewCfgCurHopLimit, portTeamInfo=portTeamInfo, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgTable=vlanCurCfgTable, vlan=vlan, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, cistRootPathCost=cistRootPathCost, portTeamInfoTrunksState=portTeamInfoTrunksState, vadcVlanCurCfgRTime=vadcVlanCurCfgRTime, layer2=layer2, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpCurPortCfgTableId=lacpCurPortCfgTableId, stpInfoTableEntry=stpInfoTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stpInfoHelloTime=stpInfoHelloTime, stpInfoForwardDelay=stpInfoForwardDelay, stpInfoTopChanges=stpInfoTopChanges, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanInfoJumbo=vlanInfoJumbo, vlanInfoName=vlanInfoName, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgState=vlanNewCfgState, vadcVlanNewCfgRouterAdv=vadcVlanNewCfgRouterAdv, cistInfoPortRole=cistInfoPortRole, portTeamNewCfgName=portTeamNewCfgName, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupCurCfgName=trunkGroupCurCfgName, lacp=lacp, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mstCurCfgState=mstCurCfgState, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamInfoMaster=portTeamInfoMaster, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamTableMaxSize=portTeamTableMaxSize, vadcVlanCurCfgBwmCont=vadcVlanCurCfgBwmCont, vlanNewCfgMFlag=vlanNewCfgMFlag, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, vadcVlanNewCfgTable=vadcVlanNewCfgTable, vlanCurCfgMtu=vlanCurCfgMtu, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, vlanNewCfgCurHopLimit=vlanNewCfgCurHopLimit, stgNewCfgPriority=stgNewCfgPriority, vlanCurCfgRouterAdv=vlanCurCfgRouterAdv, vlanCurCfgPlTime=vlanCurCfgPlTime, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortState=stgCurCfgPortState, vadcVlanCurCfgMinIntBwAdv=vadcVlanCurCfgMinIntBwAdv, vadcVlanNewCfgMtu=vadcVlanNewCfgMtu, lacpNewPortState=lacpNewPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, vlanNewCfgMaxIntBwAdv=vlanNewCfgMaxIntBwAdv, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete)
