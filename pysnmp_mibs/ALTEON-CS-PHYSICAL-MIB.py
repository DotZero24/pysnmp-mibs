...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgReTransInt=vlanCurCfgReTransInt, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stgCfg=stgCfg, trunkgroup=trunkgroup, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgRlTime=vlanNewCfgRlTime, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stpInfoHelloTime=stpInfoHelloTime, lacpInfoPortSelected=lacpInfoPortSelected, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, cistInfoPortLinkType=cistInfoPortLinkType, portTeamCurCfgPorts=portTeamCurCfgPorts, lacpNewSystemPriority=lacpNewSystemPriority, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbStatsLookupFails=fdbStatsLookupFails, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stgStatsPortTable=stgStatsPortTable, vadcVlanNewCfgMinIntBwAdv=vadcVlanNewCfgMinIntBwAdv, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, vlanCurCfgStg=vlanCurCfgStg, mstCistCfg=mstCistCfg, fdbMacAddr=fdbMacAddr, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stpInfoPortLinkType=stpInfoPortLinkType, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, vadcVlanCurCfgMtu=vadcVlanCurCfgMtu, portTeamInfoTable=portTeamInfoTable, vlanInfo=vlanInfo, vlanCurCfgOFlag=vlanCurCfgOFlag, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgNewCfgPortPriority=stgNewCfgPortPriority, vadcVlanNewCfgBwmCont=vadcVlanNewCfgBwmCont, vlanNewCfgTable=vlanNewCfgTable, portTeamInfoPortsState=portTeamInfoPortsState, vadcVlanCurCfgTableEntry=vadcVlanCurCfgTableEntry, stpInfoTable=stpInfoTable, fdbInfo=fdbInfo, vlanNewCfgShared=vlanNewCfgShared, vlanNewCfgMFlag=vlanNewCfgMFlag, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgPlTime=vlanCurCfgPlTime, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stpStats=stpStats, cistInfoPortRole=cistInfoPortRole, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgVlTime=vlanNewCfgVlTime, layer2Info=layer2Info, stgCurCfgPortState=stgCurCfgPortState, fdbEntry=fdbEntry, vlanMaxEnt=vlanMaxEnt, cistBridgeMaxAge=cistBridgeMaxAge, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanCurCfgPorts=vlanCurCfgPorts, mstNewCfgStpMode=mstNewCfgStpMode, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgPlTime=vlanNewCfgPlTime, layer2Configs=layer2Configs, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgShared=vlanCurCfgShared, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanInfoTableVADCEntry=vlanInfoTableVADCEntry, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vadcVlanNewCfgMtu=vadcVlanNewCfgMtu, stpInfoIndex=stpInfoIndex, vlanInfoPorts=vlanInfoPorts, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, vlanCurCfgMtu=vlanCurCfgMtu, vadcVlanNewCfgVlTime=vadcVlanNewCfgVlTime, portTeamCurCfgTable=portTeamCurCfgTable, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCurCfgStpMode=mstCurCfgStpMode, vadcVlanNewCfgNonIp=vadcVlanNewCfgNonIp, vlanNewCfgOpInfo=vlanNewCfgOpInfo, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, vlanNewCfgApInfo=vlanNewCfgApInfo, stgNewCfgStgIndex=stgNewCfgStgIndex, portTeamNewCfgTable=portTeamNewCfgTable, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoDesignatedRoot=stpInfoDesignatedRoot, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mstGeneralCfg=mstGeneralCfg, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, vlanCurCfgOpInfo=vlanCurCfgOpInfo, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgApInfo=vlanCurCfgApInfo, portTeamInfo=portTeamInfo, portTeamInfoState=portTeamInfoState, portTeamCfg=portTeamCfg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoRootPort=stpInfoRootPort, vlanInfoTable=vlanInfoTable, vlanNewCfgDelete=vlanNewCfgDelete, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanInfoId=vlanInfoId, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpNewPortState=lacpNewPortState, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, fdbStats=fdbStats, stpInfoPortPathCost=stpInfoPortPathCost, stpInfoHoldTime=stpInfoHoldTime, vlanInfoVADC=vlanInfoVADC, vadcVlanCurCfgVlTime=vadcVlanCurCfgVlTime, stgCurCfgPortLink=stgCurCfgPortLink, vadcVlanNewCfgRouterAdv=vadcVlanNewCfgRouterAdv, vlanInfoTableEntry=vlanInfoTableEntry, portTeamCurCfgName=portTeamCurCfgName, cistGeneralInfo=cistGeneralInfo, lacpInfo=lacpInfo, vadcVlanNewCfgMaxIntBwAdv=vadcVlanNewCfgMaxIntBwAdv, vlanInfoIdx=vlanInfoIdx, cistInfoPortTableEntry=cistInfoPortTableEntry, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vadcVlanCurCfgIpv6LlaGen=vadcVlanCurCfgIpv6LlaGen, cistRegionalRoot=cistRegionalRoot, vadcVlanNewCfgRTime=vadcVlanNewCfgRTime, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgState=stgCurCfgState, vadcVlanNewCfgTableEntry=vadcVlanNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, cistInfo=cistInfo, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPriority=stgCurCfgPriority, mstNewCfgState=mstNewCfgState, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbStatsFinds=fdbStatsFinds, stpInfoMaxAge=stpInfoMaxAge, vlanCurCfgMFlag=vlanCurCfgMFlag, stpInfoPortEdge=stpInfoPortEdge, vadcVlanNewCfgOpInfo=vadcVlanNewCfgOpInfo, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgVlanBmap=stgCurCfgVlanBmap, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRootPathCost=cistRootPathCost, vlanNewCfgState=vlanNewCfgState, vadcVlanCurCfgRouterAdv=vadcVlanCurCfgRouterAdv, vadcVlanCurCfgMaxIntBwAdv=vadcVlanCurCfgMaxIntBwAdv, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgPortPathCost=stgNewCfgPortPathCost, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgPorts=portTeamNewCfgPorts, portTeamNewCfgName=portTeamNewCfgName, vlanInfoJumbo=vlanInfoJumbo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgRouterAdv=vlanNewCfgRouterAdv, fdbStatsHiwat=fdbStatsHiwat, lacpCurPortCfgTable=lacpCurPortCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstNewCfgRegionName=mstNewCfgRegionName, vadcVlanCurCfgRlTime=vadcVlanCurCfgRlTime, portTeamNewCfgIndex=portTeamNewCfgIndex, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCfg=mstCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mstCurCfgRegionName=mstCurCfgRegionName, cistRegionalPathCost=cistRegionalPathCost, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgRouterAdv=vlanCurCfgRouterAdv, vadcVlanCurCfgApInfo=vadcVlanCurCfgApInfo, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, stgCurCfgPortPriority=stgCurCfgPortPriority, trunkGroupCurCfgName=trunkGroupCurCfgName, mstCurCfgState=mstCurCfgState, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgMaxIntBwAdv=vlanNewCfgMaxIntBwAdv, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistBridgeHelloTime=cistBridgeHelloTime, lacpCurSystemPriority=lacpCurSystemPriority, vadcVlanCurCfgMFlag=vadcVlanCurCfgMFlag, lacpCurPortState=lacpCurPortState, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, vlanNewCfgRTime=vlanNewCfgRTime, vlanNewCfgMtu=vlanNewCfgMtu, lacpInfoPortReadyN=lacpInfoPortReadyN, vadcVlanCurCfgNonIp=vadcVlanCurCfgNonIp, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpNewPortCfgTable=lacpNewPortCfgTable, trunkGroupNewCfgName=trunkGroupNewCfgName, mstCistBridgeCfg=mstCistBridgeCfg, mstCistCurCfgPortTable=mstCistCurCfgPortTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, fdbSrcPort=fdbSrcPort, stgStatsPortTableEntry=stgStatsPortTableEntry, fdbStatsOverflows=fdbStatsOverflows, vadcVlanCurCfgOpInfo=vadcVlanCurCfgOpInfo, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, vadcVlanNewCfgTable=vadcVlanNewCfgTable, cistInfoPortTable=cistInfoPortTable, vlanNewCfgOFlag=vlanNewCfgOFlag, vlanNewCfgPorts=vlanNewCfgPorts, stpInfoRootCost=stpInfoRootCost, lacp=lacp, vlanInfoLearn=vlanInfoLearn, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vadcVlanNewCfgCurHopLimit=vadcVlanNewCfgCurHopLimit, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanMaxVlanID=vlanMaxVlanID, vadcVlanNewCfgIpv6LlaGen=vadcVlanNewCfgIpv6LlaGen, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, lacpInfoPortIndex=lacpInfoPortIndex, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, cistRootPort=cistRootPort, layer2Stats=layer2Stats, vadcVlanNewCfgVlanId=vadcVlanNewCfgVlanId, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgRTime=vlanCurCfgRTime, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgCurHopLimit=vlanNewCfgCurHopLimit, fdbStatsCurrent=fdbStatsCurrent, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortLink=stgNewCfgPortLink, stgNewCfgTableEntry=stgNewCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vadcVlanNewCfgPlTime=vadcVlanNewCfgPlTime, portTeamInfoTrunksState=portTeamInfoTrunksState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgCurHopLimit=vlanCurCfgCurHopLimit, stgNewCfgAddVlan=stgNewCfgAddVlan, vadcVlanCurCfgTable=vadcVlanCurCfgTable, portTeamInfoIndex=portTeamInfoIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgMaxIntBwAdv=vlanCurCfgMaxIntBwAdv, portTeamCurCfgState=portTeamCurCfgState, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mstCistDefaultCfg=mstCistDefaultCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, vadcVlanCurCfgOFlag=vadcVlanCurCfgOFlag, fdbStatsCreates=fdbStatsCreates, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, layer2Oper=layer2Oper, stgNewCfgPortEdge=stgNewCfgPortEdge, mirroring=mirroring, fdbLearnedPort=fdbLearnedPort, vlanCurCfgMinIntBwAdv=vlanCurCfgMinIntBwAdv, vadcVlanCurCfgVlanId=vadcVlanCurCfgVlanId, cistRoot=cistRoot, lacpNewSystemName=lacpNewSystemName, fdbState=fdbState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortIndex=stgStatsPortIndex, portTeamInfoMaster=portTeamInfoMaster, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPriority=stgNewCfgPriority, vadcVlanNewCfgApInfo=vadcVlanNewCfgApInfo, stgStatsStpIndex=stgStatsStpIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortIndex=stpInfoPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoTrunks=portTeamInfoTrunks, cistInfoPortState=cistInfoPortState, vadcVlanNewCfgOFlag=vadcVlanNewCfgOFlag, vadcVlanCurCfgReTransInt=vadcVlanCurCfgReTransInt, vlanNewCfgLearn=vlanNewCfgLearn, vlanNewCfgIpv6LlaGen=vlanNewCfgIpv6LlaGen, portTeamNewCfgState=portTeamNewCfgState, fdbStatsFindFails=fdbStatsFindFails, lacpInfoPortTable=lacpInfoPortTable, vlanNewCfgVlanId=vlanNewCfgVlanId, PYSNMP_MODULE_ID=layer2, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanInfoTableVADC=vlanInfoTableVADC, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbStatsLookups=fdbStatsLookups, cistInfoPortIndex=cistInfoPortIndex, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stpInfoTableEntry=stpInfoTableEntry, vadcVlan=vadcVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vadcVlanNewCfgRlTime=vadcVlanNewCfgRlTime, vlanCurCfgRlTime=vlanCurCfgRlTime, vlan=vlan, stpInfoPortTable=stpInfoPortTable, vadcVlanNewCfgReTransInt=vadcVlanNewCfgReTransInt, fdbClear=fdbClear, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortStpIndex=stpInfoPortStpIndex, vadcVlanCurCfgMinIntBwAdv=vadcVlanCurCfgMinIntBwAdv, stgNewCfgTable=stgNewCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanInfoBwmContract=vlanInfoBwmContract, lacpInfoPortNtt=lacpInfoPortNtt, vadcVlanCurCfgPlTime=vadcVlanCurCfgPlTime, mstCistNewCfgPortTable=mstCistNewCfgPortTable, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, lacpCurSystemName=lacpCurSystemName, vadcVlanCurCfgRTime=vadcVlanCurCfgRTime, fdbTable=fdbTable, stpInfoPortState=stpInfoPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgReTransInt=vlanNewCfgReTransInt, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, fdbRefSps=fdbRefSps, vadcVlanCurCfgCurHopLimit=vadcVlanCurCfgCurHopLimit, trunkGroupTableMaxSize=trunkGroupTableMaxSize, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, vlanCurCfgIpv6LlaGen=vlanCurCfgIpv6LlaGen, stpInfo=stpInfo, fdbVlan=fdbVlan, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortRole=stpInfoPortRole, cistInfoPortPriority=cistInfoPortPriority, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vadcVlanNewCfgMFlag=vadcVlanNewCfgMFlag, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortTableEntry=stpInfoPortTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, layer2=layer2, vlanCurCfgVlTime=vlanCurCfgVlTime, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, fdbSrcTrunk=fdbSrcTrunk, vlanNewCfgMinIntBwAdv=vlanNewCfgMinIntBwAdv, vadcVlanCurCfgBwmCont=vadcVlanCurCfgBwmCont, vlanInfoName=vlanInfoName, vlanCurCfgTable=vlanCurCfgTable, vlanInfoStatus=vlanInfoStatus, vlanNewCfgStg=vlanNewCfgStg)
