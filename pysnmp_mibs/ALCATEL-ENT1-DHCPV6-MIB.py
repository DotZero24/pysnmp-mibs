#
# PySNMP MIB module ALCATEL-ENT1-DHCPV6-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-DHCPV6-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 09:59:48 2025
...
alaDHCPv6RelayDestinationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 2, 1, 4, 1), ).setIndexNames((0, "IPV6-MIB", "ipv6IfIndex"), (0, "ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6RelayDestinationAddressType"), (0, "ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6RelayDestinationAddress"))
...
alaDHCPv6SrvLeaseEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 2, 1, 5, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvLeaseIpv6Address"))
...
alaDHCPv6SrvLeaseUtilizationThresholdTrap = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 2, 0, 1)).setObjects(("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvLeaseThresholdStatus"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvSubnetDescriptor"))
...
alaDHCPv6Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 2, 2, 1, 1)).setObjects(("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6RelayGroup"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvGroup"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvNotificationsGroup"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvLeaseUtilizationThresholdGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDHCPv6Compliance = alaDHCPv6Compliance.setStatus('current')
alaDHCPv6RelayGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 2, 2, 2, 1)).setObjects(("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6RelayAdminStatus"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6RelayInterfaceAdminStatus"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6RelayDestinationRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDHCPv6RelayGroup = alaDHCPv6RelayGroup.setStatus('current')
alaDHCPv6SrvGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 2, 2, 2, 2)).setObjects(("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvGlobalConfigStatus"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvGlobalRestart"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvGlobalClearStat"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvLeaseLeaseGrant"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvLeasePrefLeaseExpiry"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvLeaseValidLeaseExpiry"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvLeaseType"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDHCPv6SrvGroup = alaDHCPv6SrvGroup.setStatus('current')
alaDHCPv6SrvNotificationsGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 2, 2, 2, 3)).setObjects(("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvLeaseUtilizationThresholdTrap"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDHCPv6SrvNotificationsGroup = alaDHCPv6SrvNotificationsGroup.setStatus('current')
alaDHCPv6SrvLeaseUtilizationThresholdGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 2, 2, 2, 4)).setObjects(("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvLeaseThresholdStatus"), ("ALCATEL-ENT1-DHCPV6-MIB", "alaDHCPv6SrvSubnetDescriptor"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaDHCPv6SrvLeaseUtilizationThresholdGroup = alaDHCPv6SrvLeaseUtilizationThresholdGroup.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-DHCPV6-MIB", alaDHCPv6SrvLeaseThresholdStatus=alaDHCPv6SrvLeaseThresholdStatus, alaDHCPv6RelayDestinationTable=alaDHCPv6RelayDestinationTable, alaDHCPv6RelayConfig=alaDHCPv6RelayConfig, alaDHCPv6RelayDestinationRowStatus=alaDHCPv6RelayDestinationRowStatus, alaDHCPv6SrvLeasePrefLeaseExpiry=alaDHCPv6SrvLeasePrefLeaseExpiry, alcatelIND1DHCPv6MIBConformance=alcatelIND1DHCPv6MIBConformance, alaDHCPv6SrvLeaseType=alaDHCPv6SrvLeaseType, alaDHCPv6Compliance=alaDHCPv6Compliance, alaDHCPv6SrvLeaseIpv6Address=alaDHCPv6SrvLeaseIpv6Address, alaDHCPv6SrvGroup=alaDHCPv6SrvGroup, alaDHCPv6RelayGroup=alaDHCPv6RelayGroup, alaDHCPv6RelayInterfaceAdminStatus=alaDHCPv6RelayInterfaceAdminStatus, alaDHCPv6RelayDestinationEntry=alaDHCPv6RelayDestinationEntry, alcatelIND1DHCPv6MIB=alcatelIND1DHCPv6MIB, alaDHCPv6SrvGlobalConfigStatus=alaDHCPv6SrvGlobalConfigStatus, alaDHCPv6SrvLease=alaDHCPv6SrvLease, alaDHCPv6RelayDestinationAddressType=alaDHCPv6RelayDestinationAddressType, alaDHCPv6SrvGlobalRestart=alaDHCPv6SrvGlobalRestart, alaDHCPv6SrvLeaseEntry=alaDHCPv6SrvLeaseEntry, alcatelIND1DHCPv6MIBGroups=alcatelIND1DHCPv6MIBGroups, alaDHCPv6SrvGlobalClearStat=alaDHCPv6SrvGlobalClearStat, alaDHCPv6SrvLeaseTable=alaDHCPv6SrvLeaseTable, alaDHCPv6SrvLeaseUtilizationThresholdGroup=alaDHCPv6SrvLeaseUtilizationThresholdGroup, alaDHCPv6SrvTrapsObj=alaDHCPv6SrvTrapsObj, alaDHCPv6SrvConfig=alaDHCPv6SrvConfig, alaDHCPv6SrvNotificationsGroup=alaDHCPv6SrvNotificationsGroup, alaDHCPv6SrvLeaseLeaseGrant=alaDHCPv6SrvLeaseLeaseGrant, PYSNMP_MODULE_ID=alcatelIND1DHCPv6MIB, alaDHCPv6SrvSubnetDescriptor=alaDHCPv6SrvSubnetDescriptor, alaDHCPv6SrvLeaseUtilizationThresholdTrap=alaDHCPv6SrvLeaseUtilizationThresholdTrap, alaDHCPv6RelayAdminStatus=alaDHCPv6RelayAdminStatus, alaDHCPv6RelayInterfaceTable=alaDHCPv6RelayInterfaceTable, alcatelIND1DHCPv6MIBNotifications=alcatelIND1DHCPv6MIBNotifications, alaDHCPv6RelayDestinationAddress=alaDHCPv6RelayDestinationAddress, alaDHCPv6RelayInterfaceEntry=alaDHCPv6RelayInterfaceEntry, alcatelIND1DHCPv6MIBCompliances=alcatelIND1DHCPv6MIBCompliances, alaDHCPv6SrvLeaseValidLeaseExpiry=alaDHCPv6SrvLeaseValidLeaseExpiry, alcatelIND1DHCPv6MIBObjects=alcatelIND1DHCPv6MIBObjects)
