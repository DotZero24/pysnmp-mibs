...
mibBuilder.exportSymbols("CISCO-DLR-MIB", ciscoDlrMIB=ciscoDlrMIB, DlrGatewayDeviceStatus=DlrGatewayDeviceStatus, ciscoDlrRingTable=ciscoDlrRingTable, ciscoDlrMIBMainObjectGroup=ciscoDlrMIBMainObjectGroup, ciscoDlrMIBConform=ciscoDlrMIBConform, ciscoDlrRingSupervisorStatus=ciscoDlrRingSupervisorStatus, ciscoDlrMIBModuleCompliance=ciscoDlrMIBModuleCompliance, ciscoDlrMIBNotifs=ciscoDlrMIBNotifs, ciscoDlrRingGatewayDeviceState=ciscoDlrRingGatewayDeviceState, ciscoDlrRingName=ciscoDlrRingName, ciscoDlrRingEntry=ciscoDlrRingEntry, ciscoDlrRingStatus=ciscoDlrRingStatus, ciscoDlrMIBNotifyGroup=ciscoDlrMIBNotifyGroup, DlrNetworkStatus=DlrNetworkStatus, ciscoDlrMIBGroups=ciscoDlrMIBGroups, ciscoDlrRingIndex=ciscoDlrRingIndex, DlrGatewayDeviceState=DlrGatewayDeviceState, ciscoDlrRingDeviceState=ciscoDlrRingDeviceState, PYSNMP_MODULE_ID=ciscoDlrMIB, ciscoDlrRingGatewayDeviceStatus=ciscoDlrRingGatewayDeviceStatus, ciscoDlrMIBCompliances=ciscoDlrMIBCompliances, ciscoDlrRingID=ciscoDlrRingID, DlrDeviceState=DlrDeviceState, ciscoDlrRingNetworkStatus=ciscoDlrRingNetworkStatus, ciscoDlrMIBObjects=ciscoDlrMIBObjects, ciscoDlrRingGatewayStatus=ciscoDlrRingGatewayStatus)
