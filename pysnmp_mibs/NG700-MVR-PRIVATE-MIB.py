# SNMP MIB module (NG700-MVR-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NG700-MVR-PRIVATE-MIB
...
class _MvrMulticastVlanId_Type(Integer32):
    """Custom type mvrMulticastVlanId based on Integer32"""
    defaultValue = 1
...
mvrPortMembershipEntry = _MvrPortMembershipEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 11, 50, 4, 1)
)
mvrPortMembershipEntry.setIndexNames(
    (0, "NG700-MVR-PRIVATE-MIB", "mvrPortMembershipGroupIPAddress"),
    (0, "NG700-MVR-PRIVATE-MIB", "mvrPortMembershipPortIfIndex"),
)
if mibBuilder.loadTexts:
