_M='mvrPortMembershipPortIfIndex'
_L='mvrPortMembershipGroupIPAddress'
_K='mvrGroupIPAddress'
_J='TimeInterval'
_I='ifIndex'
_H='IF-MIB'
_G='NG700-MVR-PRIVATE-MIB'
_F='TruthValue'
_E='read-create'
_D='Integer32'
_C='read-write'
...
DisplayString,PhysAddress,RowStatus,TextualConvention,TimeInterval,TruthValue=mibBuilder.importSymbols('SNMPv2-TC','DisplayString','PhysAddress','RowStatus','TextualConvention',_J,_F)
fastpathMvr=ModuleIdentity((1,3,6,1,4,1,4526,11,50))
...
mvrGlobalConfig=_MvrGlobalConfig_ObjectIdentity((1,3,6,1,4,1,4526,11,50,1))
class _MvrAdminMode_Type(TruthValue):defaultValue=2
_MvrAdminMode_Type.__name__=_F
_MvrAdminMode_Object=MibScalar
mvrAdminMode=_MvrAdminMode_Object((1,3,6,1,4,1,4526,11,50,1,1),_MvrAdminMode_Type())
...
mvrModeType=_MvrModeType_Object((1,3,6,1,4,1,4526,11,50,1,2),_MvrModeType_Type())
mvrModeType.setMaxAccess(_C)
if mibBuilder.loadTexts:mvrModeType.setStatus(_A)
class _MvrMulticastVlanId_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,4094))
_MvrMulticastVlanId_Type.__name__=_D
_MvrMulticastVlanId_Object=MibScalar
mvrMulticastVlanId=_MvrMulticastVlanId_Object((1,3,6,1,4,1,4526,11,50,1,3),_MvrMulticastVlanId_Type())
...
mvrMaxMulticastGroupsCount=_MvrMaxMulticastGroupsCount_Object((1,3,6,1,4,1,4526,11,50,1,4),_MvrMaxMulticastGroupsCount_Type())
...
mvrCurrentMulticastGroupsCount=_MvrCurrentMulticastGroupsCount_Object((1,3,6,1,4,1,4526,11,50,1,5),_MvrCurrentMulticastGroupsCount_Type())
...
_MvrQueryTime_Type.__name__=_J
_MvrQueryTime_Object=MibScalar
mvrQueryTime=_MvrQueryTime_Object((1,3,6,1,4,1,4526,11,50,1,6),_MvrQueryTime_Type())
mvrQueryTime.setMaxAccess(_C)
if mibBuilder.loadTexts:mvrQueryTime.setStatus(_A)
_MvrPortTable_Object=MibTable
mvrPortTable=_MvrPortTable_Object((1,3,6,1,4,1,4526,11,50,2))
if mibBuilder.loadTexts:mvrPortTable.setStatus(_A)
_MvrPortEntry_Object=MibTableRow
mvrPortEntry=_MvrPortEntry_Object((1,3,6,1,4,1,4526,11,50,2,1))
...
mvrPortMvrEnabled=_MvrPortMvrEnabled_Object((1,3,6,1,4,1,4526,11,50,2,1,1),_MvrPortMvrEnabled_Type())
...
mvrPortType=_MvrPortType_Object((1,3,6,1,4,1,4526,11,50,2,1,2),_MvrPortType_Type())
...
mvrPortImmediateLeaveMode=_MvrPortImmediateLeaveMode_Object((1,3,6,1,4,1,4526,11,50,2,1,3),_MvrPortImmediateLeaveMode_Type())
...
mvrPortStatus=_MvrPortStatus_Object((1,3,6,1,4,1,4526,11,50,2,1,4),_MvrPortStatus_Type())
mvrPortStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:mvrPortStatus.setStatus(_A)
_MvrGroupsTable_Object=MibTable
mvrGroupsTable=_MvrGroupsTable_Object((1,3,6,1,4,1,4526,11,50,3))
if mibBuilder.loadTexts:mvrGroupsTable.setStatus(_A)
_MvrGroupEntry_Object=MibTableRow
mvrGroupEntry=_MvrGroupEntry_Object((1,3,6,1,4,1,4526,11,50,3,1))
mvrGroupEntry.setIndexNames((0,_G,_K))
...
mvrGroupIPAddress=_MvrGroupIPAddress_Object((1,3,6,1,4,1,4526,11,50,3,1,1),_MvrGroupIPAddress_Type())
...
mvrGroupStatus=_MvrGroupStatus_Object((1,3,6,1,4,1,4526,11,50,3,1,2),_MvrGroupStatus_Type())
...
mvrGroupRowStatus=_MvrGroupRowStatus_Object((1,3,6,1,4,1,4526,11,50,3,1,3),_MvrGroupRowStatus_Type())
...
mvrPortMembershipTable=_MvrPortMembershipTable_Object((1,3,6,1,4,1,4526,11,50,4))
if mibBuilder.loadTexts:mvrPortMembershipTable.setStatus(_A)
_MvrPortMembershipEntry_Object=MibTableRow
mvrPortMembershipEntry=_MvrPortMembershipEntry_Object((1,3,6,1,4,1,4526,11,50,4,1))
mvrPortMembershipEntry.setIndexNames((0,_G,_L),(0,_G,_M))
...
mvrPortMembershipGroupIPAddress=_MvrPortMembershipGroupIPAddress_Object((1,3,6,1,4,1,4526,11,50,4,1,1),_MvrPortMembershipGroupIPAddress_Type())
...
mvrPortMembershipPortIfIndex=_MvrPortMembershipPortIfIndex_Object((1,3,6,1,4,1,4526,11,50,4,1,2),_MvrPortMembershipPortIfIndex_Type())
...
mvrPortMembershipRowStatus=_MvrPortMembershipRowStatus_Object((1,3,6,1,4,1,4526,11,50,4,1,3),_MvrPortMembershipRowStatus_Type())
...
mvrStatistics=_MvrStatistics_ObjectIdentity((1,3,6,1,4,1,4526,11,50,5))
_MvrIGMPQueryReceived_Type=Unsigned32
_MvrIGMPQueryReceived_Object=MibScalar
mvrIGMPQueryReceived=_MvrIGMPQueryReceived_Object((1,3,6,1,4,1,4526,11,50,5,1),_MvrIGMPQueryReceived_Type())
...
mvrIGMPReportV1Received=_MvrIGMPReportV1Received_Object((1,3,6,1,4,1,4526,11,50,5,2),_MvrIGMPReportV1Received_Type())
...
mvrIGMPReportV2Received=_MvrIGMPReportV2Received_Object((1,3,6,1,4,1,4526,11,50,5,3),_MvrIGMPReportV2Received_Type())
...
mvrIGMPLeaveReceived=_MvrIGMPLeaveReceived_Object((1,3,6,1,4,1,4526,11,50,5,4),_MvrIGMPLeaveReceived_Type())
...
mvrIGMPQueryTransmitted=_MvrIGMPQueryTransmitted_Object((1,3,6,1,4,1,4526,11,50,5,5),_MvrIGMPQueryTransmitted_Type())
...
mvrIGMPReportV1Transmitted=_MvrIGMPReportV1Transmitted_Object((1,3,6,1,4,1,4526,11,50,5,6),_MvrIGMPReportV1Transmitted_Type())
...
mvrIGMPReportV2Transmitted=_MvrIGMPReportV2Transmitted_Object((1,3,6,1,4,1,4526,11,50,5,7),_MvrIGMPReportV2Transmitted_Type())
...
mvrIGMPLeaveTransmitted=_MvrIGMPLeaveTransmitted_Object((1,3,6,1,4,1,4526,11,50,5,8),_MvrIGMPLeaveTransmitted_Type())
...
mvrIGMPPacketReceiveFailures=_MvrIGMPPacketReceiveFailures_Object((1,3,6,1,4,1,4526,11,50,5,9),_MvrIGMPPacketReceiveFailures_Type())
