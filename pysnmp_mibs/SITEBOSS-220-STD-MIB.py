# SNMP MIB module (SITEBOSS-220-STD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/asentria/SITEBOSS-220-STD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:19:47 2025
...
esPointEntry.setIndexNames(
    (0, "SITEBOSS-220-STD-MIB", "esIndexES"),
    (0, "SITEBOSS-220-STD-MIB", "esIndexPC"),
    (0, "SITEBOSS-220-STD-MIB", "esIndexPoint"),
)
if mibBuilder.loadTexts:
...
esPointConfigTempEntry.setIndexNames(
    (0, "SITEBOSS-220-STD-MIB", "espcTempIndexES"),
    (0, "SITEBOSS-220-STD-MIB", "espcTempIndexPoint"),
)
if mibBuilder.loadTexts:
...
esPointConfigCCEntry.setIndexNames(
    (0, "SITEBOSS-220-STD-MIB", "espcCCIndexES"),
    (0, "SITEBOSS-220-STD-MIB", "espcCCIndexPoint"),
)
if mibBuilder.loadTexts:
...
esPointConfigHumidEntry.setIndexNames(
    (0, "SITEBOSS-220-STD-MIB", "espcHumidIndexES"),
    (0, "SITEBOSS-220-STD-MIB", "espcHumidIndexPoint"),
)
if mibBuilder.loadTexts:
...
esPointConfigRelayEntry.setIndexNames(
    (0, "SITEBOSS-220-STD-MIB", "espcRelayIndexES"),
    (0, "SITEBOSS-220-STD-MIB", "espcRelayIndexPoint"),
)
if mibBuilder.loadTexts:
...
snmpServerEntry.setIndexNames(
    (0, "SITEBOSS-220-STD-MIB", "snmpServerIndex"),
)
if mibBuilder.loadTexts:
...
emailEntry.setIndexNames(
    (0, "SITEBOSS-220-STD-MIB", "emailIndex"),
)
if mibBuilder.loadTexts:
...
s220PowerUpTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 43, 20000)
)
s220PowerUpTrap.setObjects(
      *(("SITEBOSS-220-STD-MIB", "thisTrapText"),
        ("SITEBOSS-220-STD-MIB", "sysSitename"))
)
if mibBuilder.loadTexts:
    s220PowerUpTrap.setStatus(
        "current"
    )

s220ContactTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 43, 20001)
)
s220ContactTrap.setObjects(
      *(("SITEBOSS-220-STD-MIB", "thisTrapText"),
        ("SITEBOSS-220-STD-MIB", "sysSitename"))
)
if mibBuilder.loadTexts:
    s220ContactTrap.setStatus(
        "current"
    )

s220TempTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 43, 20010)
)
s220TempTrap.setObjects(
      *(("SITEBOSS-220-STD-MIB", "thisTrapText"),
        ("SITEBOSS-220-STD-MIB", "sysSitename"))
)
if mibBuilder.loadTexts:
    s220TempTrap.setStatus(
        "current"
    )

s220HumidTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 43, 20020)
)
s220HumidTrap.setObjects(
      *(("SITEBOSS-220-STD-MIB", "thisTrapText"),
        ("SITEBOSS-220-STD-MIB", "sysSitename"))
)
if mibBuilder.loadTexts:
    s220HumidTrap.setStatus(
        "current"
    )

s220TestTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 43, 22000)
)
s220TestTrap.setObjects(
      *(("SITEBOSS-220-STD-MIB", "thisTrapText"),
        ("SITEBOSS-220-STD-MIB", "sysSitename"))
)
if mibBuilder.loadTexts:
    s220TestTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"s220": s220,
       ...
       "s220PowerUpTrap": s220PowerUpTrap,
       "s220ContactTrap": s220ContactTrap,
       "s220TempTrap": s220TempTrap,
       "s220HumidTrap": s220HumidTrap,
       "s220TestTrap": s220TestTrap}
)
