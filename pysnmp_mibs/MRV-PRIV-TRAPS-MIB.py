...
mibBuilder.exportSymbols("MRV-PRIV-TRAPS-MIB", mrvDevLosGrPrimaryPort=mrvDevLosGrPrimaryPort, mrvPrivateTraps=mrvPrivateTraps, mrvPrivateGenTraps=mrvPrivateGenTraps, mrvPrivateTrapsNotifGrp=mrvPrivateTrapsNotifGrp, mrvPortLinkDown=mrvPortLinkDown, nbase=nbase, mrvFANUnitUp=mrvFANUnitUp, nbPrivTraps=nbPrivTraps, mrvEthOamMaIndex=mrvEthOamMaIndex, mrvPortProtectionPrimary=mrvPortProtectionPrimary, mrvDevLosGrActionCause=mrvDevLosGrActionCause, mrvPrivateTrapsConformance=mrvPrivateTrapsConformance, mrvPortReflectionLinkUp=mrvPortReflectionLinkUp, mrvPrivateTrapsMandatoryGroup=mrvPrivateTrapsMandatoryGroup, mrvPortProtectionBackup=mrvPortProtectionBackup, PYSNMP_MODULE_ID=nbPrivTraps, mrvDeviceTemperatureNormal=mrvDeviceTemperatureNormal, mrvDevLosGrSecondaryPort=mrvDevLosGrSecondaryPort, NbEthOamMDLevel=NbEthOamMDLevel, mrvPrivateSpecTrapPrefix=mrvPrivateSpecTrapPrefix, mrvPrivateGenTrapPrefix=mrvPrivateGenTrapPrefix, NbEthOamMepId=NbEthOamMepId, mrvDevFANIndex=mrvDevFANIndex, mrvAuthenticationFailure=mrvAuthenticationFailure, mrvDot1agCfmRecovery=mrvDot1agCfmRecovery, mrvElementID=mrvElementID, TCEventClass=TCEventClass, mrvEventClass=mrvEventClass, mrvPrivateTrapsMIBGroups=mrvPrivateTrapsMIBGroups, mrvDevPSIndex=mrvDevPSIndex, mrvPrivateTrapsMIBCompliances=mrvPrivateTrapsMIBCompliances, mrvPrivateSpecTraps=mrvPrivateSpecTraps, TCEventLevel=TCEventLevel, mrvDot1agCfmFault=mrvDot1agCfmFault, mrvPortReflectionLinkDown=mrvPortReflectionLinkDown, nbSwitchG1=nbSwitchG1, mrvDeviceTemperatureHigh=mrvDeviceTemperatureHigh, NbEthOamCcmHighestDefectPri=NbEthOamCcmHighestDefectPri, mrvEthOamTrapCcmHighestPrDefect=mrvEthOamTrapCcmHighestPrDefect, mrvPowerSupplyDown=mrvPowerSupplyDown, mrvPortLinActionCause=mrvPortLinActionCause, mrvPortLinkUp=mrvPortLinkUp, mrvDevLosGrActivePortNumber=mrvDevLosGrActivePortNumber, mrvPowerSupplyUp=mrvPowerSupplyUp, mrvEthOamMdLevel=mrvEthOamMdLevel, mrvFANUnitDown=mrvFANUnitDown, mrvPortIndex=mrvPortIndex, mrvTrapParameters=mrvTrapParameters, mrvEventLevel=mrvEventLevel, mrvColdStart=mrvColdStart, mrvWarmStart=mrvWarmStart, mrvEventDescription=mrvEventDescription, mrvPortLinSlavePorts=mrvPortLinSlavePorts, nbSwitchG1Il=nbSwitchG1Il, mrvPrivateTrapsMIBCompliance=mrvPrivateTrapsMIBCompliance, mrvEthOamMepIdentifier=mrvEthOamMepIdentifier)
