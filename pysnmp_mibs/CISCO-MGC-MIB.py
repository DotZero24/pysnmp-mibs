...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MGC-MIB
...
_CMgcIpAddressType_Type.__name__ = "InetAddressType"
...
_CMgcGrpStateChangeNtfy_Type.__name__ = "TruthValue"
...
_CMgcGrpMgcUdpPort_Type.__name__ = "CiscoPort"
...
cMgcMIBCompliance.setObjects(
      *(("CISCO-MGC-MIB", "cMgcMIBGroup"),
        ("CISCO-MGC-MIB", "cMgcIpMIBGroup"),
        ("CISCO-MGC-MIB", "cMgcGrpParamGroup"),
        ("CISCO-MGC-MIB", "cMgcGrpGroup"),
        ("CISCO-MGC-MIB", "cMgcGrpProtocolGroup"))
)
if mibBuilder.loadTexts:
