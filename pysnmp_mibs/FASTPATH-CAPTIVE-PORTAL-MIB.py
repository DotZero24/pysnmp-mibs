# SNMP MIB module (FASTPATH-CAPTIVE-PORTAL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-CAPTIVE-PORTAL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:08:09 2025
...
cpCaptivePortalEntry = _CpCaptivePortalEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 2, 1, 1)
)
cpCaptivePortalEntry.setIndexNames(
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalInstanceId"),
)
if mibBuilder.loadTexts:
...
cpLocalUserGroupEntry = _CpLocalUserGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 3, 1, 1)
)
cpLocalUserGroupEntry.setIndexNames(
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpLocalUserGroupIndex"),
)
if mibBuilder.loadTexts:
...
cpLocalUserGroupAssociationEntry = _CpLocalUserGroupAssociationEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 3, 3, 1)
)
cpLocalUserGroupAssociationEntry.setIndexNames(
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpLocalUserGroupAssociationUserIndex"),
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpLocalUserGroupAssociationGroupIndex"),
)
if mibBuilder.loadTexts:
...
cpInterfaceAssociationEntry = _CpInterfaceAssociationEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 1, 4, 1, 1)
)
cpInterfaceAssociationEntry.setIndexNames(
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpIntfAssociationCPID"),
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpIntfAssociationIfIndex"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalAuthenUserCurrentCount = _CpCaptivePortalAuthenUserCurrentCount_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 1, 10),
...
cpCaptivePortalInstanceStatusEntry = _CpCaptivePortalInstanceStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 2, 1, 1)
)
...
cpCaptivePortalIntfStatusEntry = _CpCaptivePortalIntfStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 3, 1, 1)
)
cpCaptivePortalIntfStatusEntry.setIndexNames(
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalInstanceId"),
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalIntfIfIndex"),
)
if mibBuilder.loadTexts:
...
class _CpCaptivePortalIntfOperStatus_Type(Integer32):
    """Custom type cpCaptivePortalIntfOperStatus based on Integer32"""
    defaultValue = 2
...
_CpCaptivePortalIntfOperStatus_Type.__name__ = "Integer32"
_CpCaptivePortalIntfOperStatus_Object = MibTableColumn
cpCaptivePortalIntfOperStatus = _CpCaptivePortalIntfOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 3, 1, 1, 2),
    _CpCaptivePortalIntfOperStatus_Type()
)
cpCaptivePortalIntfOperStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpCaptivePortalIntfOperStatus.setStatus("current")


class _CpCaptivePortalIntfOperDisabledReason_Type(Integer32):
    """Custom type cpCaptivePortalIntfOperDisabledReason based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_CpCaptivePortalIntfOperDisabledReason_Type.__name__ = "Integer32"
_CpCaptivePortalIntfOperDisabledReason_Object = MibTableColumn
cpCaptivePortalIntfOperDisabledReason = _CpCaptivePortalIntfOperDisabledReason_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 3, 1, 1, 3),
    _CpCaptivePortalIntfOperDisabledReason_Type()
)
cpCaptivePortalIntfOperDisabledReason.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpCaptivePortalIntfOperDisabledReason.setStatus("current")
...
cpCaptivePortalIntfDatabaseEntry = _CpCaptivePortalIntfDatabaseEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 4, 1, 1)
)
...
cpCaptivePortalClientStatusEntry = _CpCaptivePortalClientStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 1, 1)
)
cpCaptivePortalClientStatusEntry.setIndexNames(
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientMacAddress"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalClientAuthFailureConnectionAttempts = _CpCaptivePortalClientAuthFailureConnectionAttempts_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 5, 1, 1, 13),
    _CpCaptivePortalClientAuthFailureConnectionAttempts_Type()
)
cpCaptivePortalClientAuthFailureConnectionAttempts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpCaptivePortalClientAuthFailureConnectionAttempts.setStatus("current")
...
cpCaptivePortalIntfClientAssocEntry = _CpCaptivePortalIntfClientAssocEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 6, 1, 1)
)
cpCaptivePortalIntfClientAssocEntry.setIndexNames(
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalIntfClientIfIndex"),
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalIntfClientAssocMacAddress"),
)
if mibBuilder.loadTexts:
...
cpCaptivePortalInstanceClientAssocEntry = _CpCaptivePortalInstanceClientAssocEntry_Object(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 2, 7, 1, 1)
)
cpCaptivePortalInstanceClientAssocEntry.setIndexNames(
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalInstanceClientAssocInstanceId"),
    (0, "FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalInstanceClientAssocMacAddress"),
)
if mibBuilder.loadTexts:
...
cpClientAuthenticationFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 4, 1)
)
cpClientAuthenticationFailure.setObjects(
      *(("FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientMacAddress"),
        ("FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientIpAddress"),
        ("FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientCPID"),
        ("FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientAssocIfIndex"),
        ("FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientUserName"),
        ("FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientAuthFailureConnectionAttempts"))
)
if mibBuilder.loadTexts:
...
cpClientConnect = NotificationType(
    (1, 3, 6, 1, 4, 1, 4413, 1, 1, 38, 4, 2)
)
cpClientConnect.setObjects(
      *(("FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalClientMacAddress"),
        ("FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalIntfClientIfIndex"),
        ("FASTPATH-CAPTIVE-PORTAL-MIB", "cpCaptivePortalInstanceClientAssocInstanceId"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"CpCaptivePortalIntfCapabilitiesMap": CpCaptivePortalIntfCapabilitiesMap,
       ...
       "cpCaptivePortalIntfOperStatus": cpCaptivePortalIntfOperStatus,
       "cpCaptivePortalIntfOperDisabledReason": cpCaptivePortalIntfOperDisabledReason,
       ...
       "cpCaptivePortalClientAuthFailureConnectionAttempts": cpCaptivePortalClientAuthFailureConnectionAttempts,
