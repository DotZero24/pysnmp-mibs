...
CiscoGslbAnswerAdminState, CiscoGslbAnswerType, CiscoGslbBalanceMethod, CiscoGslbAnswerStatus = mibBuilder.importSymbols("CISCO-GSLB-TC-MIB", "CiscoGslbAnswerAdminState", "CiscoGslbAnswerType", "CiscoGslbBalanceMethod", "CiscoGslbAnswerStatus")
...
mibBuilder.exportSymbols("CISCO-GSLB-DNS-MIB", cgdDnsQueryRateCurrent=cgdDnsQueryRateCurrent, cgdSourceAddressId=cgdSourceAddressId, cgdDomainStorageType=cgdDomainStorageType, cgdSourceAddressRate5Min=cgdSourceAddressRate5Min, cgdAnswerPrevStatus=cgdAnswerPrevStatus, ciscoGslbDnsGlobalNotifStatsGroup=ciscoGslbDnsGlobalNotifStatsGroup, cgdDnsUnmatchedQueries=cgdDnsUnmatchedQueries, cgdSourceAddressTable=cgdSourceAddressTable, cgdDomainListRowStatus=cgdDomainListRowStatus, cgdDnsRuleSuccesses=cgdDnsRuleSuccesses, cgdAnswerGroupTable=cgdAnswerGroupTable, cgdAnswerAddressType=cgdAnswerAddressType, cgdAnswerTable=cgdAnswerTable, cgdDomainListHits=cgdDomainListHits, cgdDnsRuleHits=cgdDnsRuleHits, cgdNotifControl=cgdNotifControl, cgdClauseAnsGrpName=cgdClauseAnsGrpName, ciscoGslbDnsMIBNotifs=ciscoGslbDnsMIBNotifs, ciscoGslbDnsDomainGroup=ciscoGslbDnsDomainGroup, ciscoGslbDnsMIB=ciscoGslbDnsMIB, cgdNSFwdRcvdResps=cgdNSFwdRcvdResps, cgdAnswerAddress=cgdAnswerAddress, cgdClauseStorageType=cgdClauseStorageType, cgdSourceAddressRate30Min=cgdSourceAddressRate30Min, cgdDroppedDnsClauseNotifs=cgdDroppedDnsClauseNotifs, cgdDnsDroppedQueries=cgdDnsDroppedQueries, cgdSourceAdd=cgdSourceAdd, cgdDnsAnswerNotifEnable=cgdDnsAnswerNotifEnable, cgdAnsTrapRateLimit=cgdAnsTrapRateLimit, cgdClauseHits=cgdClauseHits, ciscoGslbDnsMIBCompliance=ciscoGslbDnsMIBCompliance, cgdClauseRowStatus=cgdClauseRowStatus, cgdAnswerType=cgdAnswerType, cgdDnsRuleRowStatus=cgdDnsRuleRowStatus, cgdDnsRcvdHostAddrQueries=cgdDnsRcvdHostAddrQueries, cgdDomainRate30Min=cgdDomainRate30Min, cgdAnswerStorageType=cgdAnswerStorageType, cgdDomainName=cgdDomainName, cgdAnswerGroupType=cgdAnswerGroupType, cgdDnsRcvdQueries=cgdDnsRcvdQueries, cgdDomainListName=cgdDomainListName, cgdTotalAnswers=cgdTotalAnswers, cgdAnswerRate30Min=cgdAnswerRate30Min, cgdClauseId=cgdClauseId, cgdDomainList=cgdDomainList, cgdSecondClauseId=cgdSecondClauseId, ciscoGslbDnsEventClause=ciscoGslbDnsEventClause, cgdDroppedAnsNotifs=cgdDroppedAnsNotifs, cgdSourceAddressList=cgdSourceAddressList, cgdDomainTable=cgdDomainTable, cgdTotalSourceAddressLists=cgdTotalSourceAddressLists, ciscoGslbDnsNotifControlGroup=ciscoGslbDnsNotifControlGroup, cgdNSFwdSentQueries=cgdNSFwdSentQueries, cgdAnswerRate1Min=cgdAnswerRate1Min, cgdDnsQueryRatePeak=cgdDnsQueryRatePeak, cgdProxLkupRcvdResps=cgdProxLkupRcvdResps, cgdDomainListEntry=cgdDomainListEntry, ciscoGslbAnswerEventStatusChange=ciscoGslbAnswerEventStatusChange, cgdSourceAddressRate1Min=cgdSourceAddressRate1Min, cgdDomainRowStatus=cgdDomainRowStatus, ciscoGslbDnsNotifObjectsGroup=ciscoGslbDnsNotifObjectsGroup, cgdSourceAddressEntry=cgdSourceAddressEntry, cgdDnsRuleEntry=cgdDnsRuleEntry, cgdDomainRate4Hr=cgdDomainRate4Hr, cgdSourceAddressListHits=cgdSourceAddressListHits, cgdDnsRuleTable=cgdDnsRuleTable, ciscoGslbDnsMIBObjects=ciscoGslbDnsMIBObjects, cgdAnswerRowStatus=cgdAnswerRowStatus, cgdDnsClauseNotifEnable=cgdDnsClauseNotifEnable, cgdDomainListStorageType=cgdDomainListStorageType, cgdSourceAddressListEntry=cgdSourceAddressListEntry, cgdSourceAddressPrefixLength=cgdSourceAddressPrefixLength, cgdAnswerRate5Min=cgdAnswerRate5Min, cgdTotalSourceAddresses=cgdTotalSourceAddresses, cgdAnswerAdminState=cgdAnswerAdminState, ciscoGslbDnsSourceAddGroup=ciscoGslbDnsSourceAddGroup, cgdAnswerStatus=cgdAnswerStatus, cgdDnsRuleName=cgdDnsRuleName, ciscoGslbDnsGlobalGroup=ciscoGslbDnsGlobalGroup, ciscoGslbDnsNotifGroup=ciscoGslbDnsNotifGroup, cgdDomainHits=cgdDomainHits, cgdSourceAddressAddressType=cgdSourceAddressAddressType, cgdAnswerGroupStorageType=cgdAnswerGroupStorageType, cgdAnswer=cgdAnswer, cgdNotifObjects=cgdNotifObjects, cgdAnswerGroupRowStatus=cgdAnswerGroupRowStatus, cgdAnswerGroupEntry=cgdAnswerGroupEntry, cgdSourceAddressListRowStatus=cgdSourceAddressListRowStatus, cgdSourceAddressHits=cgdSourceAddressHits, cgdAnswerId=cgdAnswerId, cgdDomainRate5Min=cgdDomainRate5Min, ciscoGslbDnsMIBCompliances=ciscoGslbDnsMIBCompliances, cgdTotalDomainLists=cgdTotalDomainLists, cgdAnswerGrpName=cgdAnswerGrpName, ciscoGslbDnsMIBConform=ciscoGslbDnsMIBConform, cgdSourceAddressRate4Hr=cgdSourceAddressRate4Hr, ciscoGslbDnsMIBGroups=ciscoGslbDnsMIBGroups, cgdDnsUdpSrcPortErrs=cgdDnsUdpSrcPortErrs, cgdAnswerName=cgdAnswerName, cgdDomainRate1Min=cgdDomainRate1Min, cgdDnsRule=cgdDnsRule, cgdTotalDomains=cgdTotalDomains, cgdDomainEntry=cgdDomainEntry, cgdDNSRuleDomainList=cgdDNSRuleDomainList, ciscoGslbDnsAnswerGroup=ciscoGslbDnsAnswerGroup, cgdGlobalStats=cgdGlobalStats, cgdSourceAddressAddress=cgdSourceAddressAddress, cgdSourceAddressRowStatus=cgdSourceAddressRowStatus, cgdAnswerEntry=cgdAnswerEntry, cgdClauseBalanceMethod=cgdClauseBalanceMethod, cgdDnsClauseTrapRateLimit=cgdDnsClauseTrapRateLimit, cgdDnsPollSockErrs=cgdDnsPollSockErrs, cgdBoomServSentReqs=cgdBoomServSentReqs, cgdClauseEntry=cgdClauseEntry, cgdDnsRuleStorageType=cgdDnsRuleStorageType, ciscoGslbDnsRuleGroup=ciscoGslbDnsRuleGroup, cgdAnswerRate4Hr=cgdAnswerRate4Hr, cgdTotalRules=cgdTotalRules, cgdDomain=cgdDomain, cgdThirdClauseId=cgdThirdClauseId, cgdTotalAnswerGroups=cgdTotalAnswerGroups, ciscoGslbDnsGlobalStatsGroup=ciscoGslbDnsGlobalStatsGroup, cgdAnswerGroupName=cgdAnswerGroupName, cgdSourceAddressStorageType=cgdSourceAddressStorageType, cgdDomainListTable=cgdDomainListTable, cgdDnsTcpSrcPortErrs=cgdDnsTcpSrcPortErrs, cgdDomainId=cgdDomainId, cgdAnswerHits=cgdAnswerHits, cgdSourceAddressListName=cgdSourceAddressListName, cgdProxLkupSentReqs=cgdProxLkupSentReqs, PYSNMP_MODULE_ID=ciscoGslbDnsMIB, cgdClauseTable=cgdClauseTable, cgdSourceAddressListStorageType=cgdSourceAddressListStorageType, cgdAnswerGroupHits=cgdAnswerGroupHits, cgdFirstClauseId=cgdFirstClauseId, ciscoGslbDnsGlobalRateLimitGroup=ciscoGslbDnsGlobalRateLimitGroup, cgdGlobal=cgdGlobal, cgdSourceAddressListTable=cgdSourceAddressListTable, cgdSourceAddList=cgdSourceAddList)
