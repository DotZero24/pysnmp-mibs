...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/ciena/WWP-VOICE-GATEWAY-MIB
...
mibBuilder.exportSymbols("WWP-VOICE-GATEWAY-MIB", wwpVoiceGatewaySipDialTimerLong=wwpVoiceGatewaySipDialTimerLong, wwpVoiceGatewaySipUserName=wwpVoiceGatewaySipUserName, wwpVoiceGatewayOctetsTx=wwpVoiceGatewayOctetsTx, wwpVoiceGatewayConfigNotifEntityCache=wwpVoiceGatewayConfigNotifEntityCache, wwpVoiceGatewayIntervalJitter=wwpVoiceGatewayIntervalJitter, wwpVoiceGatewayMGCP=wwpVoiceGatewayMGCP, wwpVoiceGatewayResetStatCounters=wwpVoiceGatewayResetStatCounters, wwpVoiceGatewaySipUserPassword=wwpVoiceGatewaySipUserPassword, wwpVoiceGatewayPacketizationMaxPeriod=wwpVoiceGatewayPacketizationMaxPeriod, wwpVoiceGatewayEndpoint=wwpVoiceGatewayEndpoint, wwpVoiceGatewaySIPDtmfEventHandling=wwpVoiceGatewaySIPDtmfEventHandling, wwpVoiceGatewayHookFlashEnable=wwpVoiceGatewayHookFlashEnable, wwpVoiceGatewayRsipKeepAliveEnable=wwpVoiceGatewayRsipKeepAliveEnable, wwpVoiceGatewayPacketizationMinPeriod=wwpVoiceGatewayPacketizationMinPeriod, wwpVoiceReset=wwpVoiceReset, wwpVoiceGatewaySipProxyAddr=wwpVoiceGatewaySipProxyAddr, wwpVoiceNotifEntCache=wwpVoiceNotifEntCache, wwpVoiceCallAgentEgressEvent=wwpVoiceCallAgentEgressEvent, wwpVoiceJitterOptionState=wwpVoiceJitterOptionState, wwpVoiceGatewayConfigFax=wwpVoiceGatewayConfigFax, wwpVoiceGatewayEndPointId=wwpVoiceGatewayEndPointId, wwpVoiceGateway=wwpVoiceGateway, wwpVoiceAccess=wwpVoiceAccess, wwpVoiceGatewaySIPRegistrarServers=wwpVoiceGatewaySIPRegistrarServers, wwpVoiceGatewaySipSyslogLogLevel=wwpVoiceGatewaySipSyslogLogLevel, wwpVoiceGatewayCountry=wwpVoiceGatewayCountry, wwpVoiceGatewayMIBGroups=wwpVoiceGatewayMIBGroups, wwpVoiceGatewaySipPhoneLineEntry=wwpVoiceGatewaySipPhoneLineEntry, wwpVoiceGatewayCallAgentAddr=wwpVoiceGatewayCallAgentAddr, wwpVoiceGatewayCodecOverride=wwpVoiceGatewayCodecOverride, wwpVoiceGatewaySIP=wwpVoiceGatewaySIP, wwpVoiceGatewayConfigJitterBufferTargetPeriod=wwpVoiceGatewayConfigJitterBufferTargetPeriod, wwpVoiceJitterBufferTargetPeriod=wwpVoiceJitterBufferTargetPeriod, wwpVoiceGatewayPktsRx=wwpVoiceGatewayPktsRx, wwpVoiceGatewayConfigJitterBuffer=wwpVoiceGatewayConfigJitterBuffer, wwpVoiceGatewayConfigJitterBufferMinPeriod=wwpVoiceGatewayConfigJitterBufferMinPeriod, wwpVoiceGatewayPktsLost=wwpVoiceGatewayPktsLost, wwpVoiceGatewaySipPhoneLineTimerTable=wwpVoiceGatewaySipPhoneLineTimerTable, wwpVoiceGatewaySIPProxyServers=wwpVoiceGatewaySIPProxyServers, wwpVoiceGatewaySupportMessagePiggybacking=wwpVoiceGatewaySupportMessagePiggybacking, wwpVoiceGatewayConfigProtocolEnable=wwpVoiceGatewayConfigProtocolEnable, wwpVoiceGatewayReset=wwpVoiceGatewayReset, wwpVoiceGatewayConfigCodecOverride=wwpVoiceGatewayConfigCodecOverride, wwpVoiceCallAgentOtaModes=wwpVoiceCallAgentOtaModes, wwpVoiceGatewaySipLineId=wwpVoiceGatewaySipLineId, wwpVoiceGatewayEchoCancellation=wwpVoiceGatewayEchoCancellation, wwpVoiceGatewayConfigJitterBufferMaxPeriod=wwpVoiceGatewayConfigJitterBufferMaxPeriod, wwpVoiceGatewaySquelchInbandDtmfAudio=wwpVoiceGatewaySquelchInbandDtmfAudio, wwpVoiceGatewayStats=wwpVoiceGatewayStats, wwpVoiceGatewayMIBNotificationPrefix=wwpVoiceGatewayMIBNotificationPrefix, wwpVoiceEndPointName=wwpVoiceEndPointName, wwpVoiceGatewaySipPhoneNumber=wwpVoiceGatewaySipPhoneNumber, wwpVoiceGatewaySIPPreferredCodec=wwpVoiceGatewaySIPPreferredCodec, wwpVoiceGatewaySipTimerLineId=wwpVoiceGatewaySipTimerLineId, wwpVoiceGatewayEndPointEntry=wwpVoiceGatewayEndPointEntry, wwpVoiceGatewayTestServerConnection=wwpVoiceGatewayTestServerConnection, wwpVoiceGatewayConfigTestServerConnection=wwpVoiceGatewayConfigTestServerConnection, wwpVoiceGatewaySipDialPlan=wwpVoiceGatewaySipDialPlan, wwpVoiceGatewaySipUserDisplayName=wwpVoiceGatewaySipUserDisplayName, wwpVoiceSec=wwpVoiceSec, wwpVoiceGatewayMIBConformance=wwpVoiceGatewayMIBConformance, wwpVoiceGatewayOctetsRx=wwpVoiceGatewayOctetsRx, wwpVoiceCallAgentPotsLine=wwpVoiceCallAgentPotsLine, wwpVoiceAutonomousFaxState=wwpVoiceAutonomousFaxState, wwpVoiceGatewaySipPhoneLineTable=wwpVoiceGatewaySipPhoneLineTable, wwpVoiceGatewayNumResets=wwpVoiceGatewayNumResets, wwpVoiceGatewayConfigCallAgent=wwpVoiceGatewayConfigCallAgent, wwpVoiceGatewaySipForceQuotesState=wwpVoiceGatewaySipForceQuotesState, wwpVoiceGatewayAudio=wwpVoiceGatewayAudio, wwpVoiceGatewayCallAgentProtocol=wwpVoiceGatewayCallAgentProtocol, wwpVoiceGatewayMIBNotifications=wwpVoiceGatewayMIBNotifications, wwpVoiceGatewaySIPCallFeatures=wwpVoiceGatewaySIPCallFeatures, wwpVoiceGatewaySendEventsViaRFC2833=wwpVoiceGatewaySendEventsViaRFC2833, wwpVoiceGatewayComplexCodec=wwpVoiceGatewayComplexCodec, wwpVoiceGatewaySIPLogServers=wwpVoiceGatewaySIPLogServers, wwpVoiceGatewaySipSyslogAddr=wwpVoiceGatewaySipSyslogAddr, wwpVoiceGatewayProtocolEnable=wwpVoiceGatewayProtocolEnable, wwpVoiceGatewayDropVoicePktsDuringEvents=wwpVoiceGatewayDropVoicePktsDuringEvents, wwpVoiceGatewaySipRegisterTimeoutPeriod=wwpVoiceGatewaySipRegisterTimeoutPeriod, wwpVoiceGatewaySipProxyPort=wwpVoiceGatewaySipProxyPort, wwpVoiceGatewaySipPhoneLineTimerEntry=wwpVoiceGatewaySipPhoneLineTimerEntry, wwpVoiceGatewayMIB=wwpVoiceGatewayMIB, wwpVoiceGatewayConfigProtocolType=wwpVoiceGatewayConfigProtocolType, wwpVoiceGatewayConfigPots=wwpVoiceGatewayConfigPots, wwpVoiceGatewayLatency=wwpVoiceGatewayLatency, wwpVoiceGatewaySipRegistrarPort=wwpVoiceGatewaySipRegistrarPort, wwpVoiceJitterBufferMaxPeriod=wwpVoiceJitterBufferMaxPeriod, wwpVoiceGatewayEndPointTable=wwpVoiceGatewayEndPointTable, wwpVoiceGatewayCodec=wwpVoiceGatewayCodec, wwpVoiceGatewaySilenceSuppression=wwpVoiceGatewaySilenceSuppression, wwpVoiceGatewayMIBObjects=wwpVoiceGatewayMIBObjects, wwpVoiceJitterBufferMinPeriod=wwpVoiceJitterBufferMinPeriod, wwpMgmtAccess=wwpMgmtAccess, wwpVoiceGatewayCountryCodes=wwpVoiceGatewayCountryCodes, wwpVoiceGatewayCallAgentUDPPort=wwpVoiceGatewayCallAgentUDPPort, wwpVoiceGatewaySipRegistrarAddr=wwpVoiceGatewaySipRegistrarAddr, wwpVoiceGatewaySIPServers=wwpVoiceGatewaySIPServers, wwpVoiceGatewayConfigEndPoint=wwpVoiceGatewayConfigEndPoint, wwpVoiceGatewayProtocolType=wwpVoiceGatewayProtocolType, wwpVoiceGatewayMIBCompliances=wwpVoiceGatewayMIBCompliances, wwpVoiceGatewayPayloadType=wwpVoiceGatewayPayloadType, wwpVoiceGatewayConfigLastServerResponseTime=wwpVoiceGatewayConfigLastServerResponseTime, wwpVoiceGatewayRsipKeepAliveInterval=wwpVoiceGatewayRsipKeepAliveInterval, wwpVoiceGatewayLastServerResponseTime=wwpVoiceGatewayLastServerResponseTime, wwpVoiceGatewayPktsTx=wwpVoiceGatewayPktsTx, wwpVoiceGatewaySipSyslogPort=wwpVoiceGatewaySipSyslogPort, PYSNMP_MODULE_ID=wwpVoiceGatewayMIB, wwpVoiceGatewaySipSessionTimeoutPeriod=wwpVoiceGatewaySipSessionTimeoutPeriod)
