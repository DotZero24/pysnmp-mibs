...
mibBuilder.exportSymbols("WWP-VOICE-GATEWAY-MIB", wwpVoiceGatewayEndPointId=wwpVoiceGatewayEndPointId, wwpVoiceGatewayHookFlashEnable=wwpVoiceGatewayHookFlashEnable, wwpVoiceNotifEntCache=wwpVoiceNotifEntCache, wwpVoiceGatewayMGCP=wwpVoiceGatewayMGCP, wwpVoiceGatewaySIPCallFeatures=wwpVoiceGatewaySIPCallFeatures, wwpVoiceGatewaySipPhoneLineTable=wwpVoiceGatewaySipPhoneLineTable, wwpVoiceGatewaySipProxyAddr=wwpVoiceGatewaySipProxyAddr, wwpVoiceGatewayConfigFax=wwpVoiceGatewayConfigFax, wwpVoiceGatewayPacketizationMinPeriod=wwpVoiceGatewayPacketizationMinPeriod, wwpVoiceGatewayProtocolEnable=wwpVoiceGatewayProtocolEnable, wwpVoiceGatewayConfigCodecOverride=wwpVoiceGatewayConfigCodecOverride, wwpVoiceCallAgentPotsLine=wwpVoiceCallAgentPotsLine, wwpVoiceGatewaySipRegisterTimeoutPeriod=wwpVoiceGatewaySipRegisterTimeoutPeriod, wwpVoiceGatewayIntervalJitter=wwpVoiceGatewayIntervalJitter, wwpVoiceGatewayMIBNotificationPrefix=wwpVoiceGatewayMIBNotificationPrefix, wwpVoiceGatewayPktsTx=wwpVoiceGatewayPktsTx, wwpVoiceGatewayConfigEndPoint=wwpVoiceGatewayConfigEndPoint, wwpVoiceAccess=wwpVoiceAccess, wwpVoiceGatewayCountry=wwpVoiceGatewayCountry, wwpVoiceGatewayDropVoicePktsDuringEvents=wwpVoiceGatewayDropVoicePktsDuringEvents, wwpVoiceGatewayConfigCallAgent=wwpVoiceGatewayConfigCallAgent, wwpVoiceJitterOptionState=wwpVoiceJitterOptionState, wwpVoiceGatewayPktsRx=wwpVoiceGatewayPktsRx, wwpVoiceGatewayCodecOverride=wwpVoiceGatewayCodecOverride, wwpVoiceGatewaySIPServers=wwpVoiceGatewaySIPServers, wwpVoiceGatewaySipSyslogAddr=wwpVoiceGatewaySipSyslogAddr, wwpVoiceGatewaySipPhoneNumber=wwpVoiceGatewaySipPhoneNumber, wwpVoiceGatewaySipUserPassword=wwpVoiceGatewaySipUserPassword, wwpVoiceGatewaySIPProxyServers=wwpVoiceGatewaySIPProxyServers, wwpVoiceGatewaySipDialTimerLong=wwpVoiceGatewaySipDialTimerLong, PYSNMP_MODULE_ID=wwpVoiceGatewayMIB, wwpVoiceGatewayEndpoint=wwpVoiceGatewayEndpoint, wwpVoiceGatewaySipPhoneLineTimerTable=wwpVoiceGatewaySipPhoneLineTimerTable, wwpVoiceEndPointName=wwpVoiceEndPointName, wwpVoiceGatewayPayloadType=wwpVoiceGatewayPayloadType, wwpVoiceGatewayLastServerResponseTime=wwpVoiceGatewayLastServerResponseTime, wwpVoiceGatewayEndPointEntry=wwpVoiceGatewayEndPointEntry, wwpVoiceGatewayProtocolType=wwpVoiceGatewayProtocolType, wwpVoiceGatewaySipUserDisplayName=wwpVoiceGatewaySipUserDisplayName, wwpVoiceGatewayStats=wwpVoiceGatewayStats, wwpVoiceGatewayCallAgentAddr=wwpVoiceGatewayCallAgentAddr, wwpVoiceGatewaySipRegistrarAddr=wwpVoiceGatewaySipRegistrarAddr, wwpVoiceGatewayConfigJitterBufferMaxPeriod=wwpVoiceGatewayConfigJitterBufferMaxPeriod, wwpVoiceGatewaySipSyslogPort=wwpVoiceGatewaySipSyslogPort, wwpVoiceGatewaySIPLogServers=wwpVoiceGatewaySIPLogServers, wwpVoiceGatewayMIBGroups=wwpVoiceGatewayMIBGroups, wwpVoiceGatewayMIB=wwpVoiceGatewayMIB, wwpVoiceGatewaySipPhoneLineEntry=wwpVoiceGatewaySipPhoneLineEntry, wwpVoiceCallAgentEgressEvent=wwpVoiceCallAgentEgressEvent, wwpVoiceGatewayTestServerConnection=wwpVoiceGatewayTestServerConnection, wwpVoiceGatewayRsipKeepAliveEnable=wwpVoiceGatewayRsipKeepAliveEnable, wwpVoiceGateway=wwpVoiceGateway, wwpVoiceGatewaySipSessionTimeoutPeriod=wwpVoiceGatewaySipSessionTimeoutPeriod, wwpVoiceGatewaySipTimerLineId=wwpVoiceGatewaySipTimerLineId, wwpVoiceGatewayPacketizationMaxPeriod=wwpVoiceGatewayPacketizationMaxPeriod, wwpVoiceGatewayNumResets=wwpVoiceGatewayNumResets, wwpVoiceJitterBufferMinPeriod=wwpVoiceJitterBufferMinPeriod, wwpVoiceGatewayConfigTestServerConnection=wwpVoiceGatewayConfigTestServerConnection, wwpVoiceReset=wwpVoiceReset, wwpVoiceGatewaySipSyslogLogLevel=wwpVoiceGatewaySipSyslogLogLevel, wwpVoiceGatewayOctetsTx=wwpVoiceGatewayOctetsTx, wwpVoiceGatewayMIBNotifications=wwpVoiceGatewayMIBNotifications, wwpMgmtAccess=wwpMgmtAccess, wwpVoiceGatewaySIPRegistrarServers=wwpVoiceGatewaySIPRegistrarServers, wwpVoiceGatewayConfigLastServerResponseTime=wwpVoiceGatewayConfigLastServerResponseTime, wwpVoiceGatewayAudio=wwpVoiceGatewayAudio, wwpVoiceAutonomousFaxState=wwpVoiceAutonomousFaxState, wwpVoiceGatewayConfigNotifEntityCache=wwpVoiceGatewayConfigNotifEntityCache, wwpVoiceGatewaySendEventsViaRFC2833=wwpVoiceGatewaySendEventsViaRFC2833, wwpVoiceGatewayPktsLost=wwpVoiceGatewayPktsLost, wwpVoiceGatewayRsipKeepAliveInterval=wwpVoiceGatewayRsipKeepAliveInterval, wwpVoiceGatewayReset=wwpVoiceGatewayReset, wwpVoiceGatewayMIBCompliances=wwpVoiceGatewayMIBCompliances, wwpVoiceGatewaySipRegistrarPort=wwpVoiceGatewaySipRegistrarPort, wwpVoiceGatewaySIPPreferredCodec=wwpVoiceGatewaySIPPreferredCodec, wwpVoiceGatewayResetStatCounters=wwpVoiceGatewayResetStatCounters, wwpVoiceGatewaySipPhoneLineTimerEntry=wwpVoiceGatewaySipPhoneLineTimerEntry, wwpVoiceJitterBufferMaxPeriod=wwpVoiceJitterBufferMaxPeriod, wwpVoiceGatewayEndPointTable=wwpVoiceGatewayEndPointTable, wwpVoiceGatewaySipLineId=wwpVoiceGatewaySipLineId, wwpVoiceGatewayConfigPots=wwpVoiceGatewayConfigPots, wwpVoiceGatewaySquelchInbandDtmfAudio=wwpVoiceGatewaySquelchInbandDtmfAudio, wwpVoiceGatewayConfigProtocolType=wwpVoiceGatewayConfigProtocolType, wwpVoiceJitterBufferTargetPeriod=wwpVoiceJitterBufferTargetPeriod, wwpVoiceGatewaySipProxyPort=wwpVoiceGatewaySipProxyPort, wwpVoiceGatewayConfigJitterBuffer=wwpVoiceGatewayConfigJitterBuffer, wwpVoiceGatewayEchoCancellation=wwpVoiceGatewayEchoCancellation, wwpVoiceGatewayCodec=wwpVoiceGatewayCodec, wwpVoiceGatewaySilenceSuppression=wwpVoiceGatewaySilenceSuppression, wwpVoiceGatewaySIP=wwpVoiceGatewaySIP, wwpVoiceGatewayConfigJitterBufferMinPeriod=wwpVoiceGatewayConfigJitterBufferMinPeriod, wwpVoiceGatewaySupportMessagePiggybacking=wwpVoiceGatewaySupportMessagePiggybacking, wwpVoiceGatewayCallAgentProtocol=wwpVoiceGatewayCallAgentProtocol, wwpVoiceGatewayLatency=wwpVoiceGatewayLatency, wwpVoiceGatewayComplexCodec=wwpVoiceGatewayComplexCodec, wwpVoiceGatewayMIBObjects=wwpVoiceGatewayMIBObjects, wwpVoiceGatewayCallAgentUDPPort=wwpVoiceGatewayCallAgentUDPPort, wwpVoiceGatewayCountryCodes=wwpVoiceGatewayCountryCodes, wwpVoiceGatewaySipForceQuotesState=wwpVoiceGatewaySipForceQuotesState, wwpVoiceSec=wwpVoiceSec, wwpVoiceGatewaySIPDtmfEventHandling=wwpVoiceGatewaySIPDtmfEventHandling, wwpVoiceGatewayConfigProtocolEnable=wwpVoiceGatewayConfigProtocolEnable, wwpVoiceCallAgentOtaModes=wwpVoiceCallAgentOtaModes, wwpVoiceGatewayConfigJitterBufferTargetPeriod=wwpVoiceGatewayConfigJitterBufferTargetPeriod, wwpVoiceGatewayMIBConformance=wwpVoiceGatewayMIBConformance, wwpVoiceGatewaySipDialPlan=wwpVoiceGatewaySipDialPlan, wwpVoiceGatewaySipUserName=wwpVoiceGatewaySipUserName, wwpVoiceGatewayOctetsRx=wwpVoiceGatewayOctetsRx)
