...
_L='MacAddressNC'
_K='OctetString'
_J='A3COM-HUAWEI-SNA-DLSW-EXT-MIB'
_I='ifIndex'
_H='IF-MIB'
_G='seconds'
_F='milliseconds'
...
h3cDlswExt=ModuleIdentity((1,3,6,1,4,1,43,45,1,10,2,62))
if mibBuilder.loadTexts:h3cDlswExt.setRevisions(('2005-07-20 19:00',))
_H3cDlswExtMIBObjects_ObjectIdentity=ObjectIdentity
h3cDlswExtMIBObjects=_H3cDlswExtMIBObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1))
_H3cdeNode_ObjectIdentity=ObjectIdentity
h3cdeNode=_H3cdeNode_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,1))
...
h3cdeNodeVendorID=_H3cdeNodeVendorID_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,1),_H3cdeNodeVendorID_Type())
...
h3cdeNodeIpAddrType=_H3cdeNodeIpAddrType_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,2),_H3cdeNodeIpAddrType_Type())
...
h3cdeNodeLocalAddr=_H3cdeNodeLocalAddr_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,3),_H3cdeNodeLocalAddr_Type())
...
h3cdeNodePriority=_H3cdeNodePriority_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,4),_H3cdeNodePriority_Type())
...
h3cdeNodeInitPacingWindow=_H3cdeNodeInitPacingWindow_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,5),_H3cdeNodeInitPacingWindow_Type())
...
h3cdeNodeMaxPacingWindow=_H3cdeNodeMaxPacingWindow_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,6),_H3cdeNodeMaxPacingWindow_Type())
...
h3cdeNodeKeepAliveInterval=_H3cdeNodeKeepAliveInterval_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,7),_H3cdeNodeKeepAliveInterval_Type())
...
h3cdeNodePermitDynamic=_H3cdeNodePermitDynamic_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,8),_H3cdeNodePermitDynamic_Type())
...
h3cdeNodeConnTimeout=_H3cdeNodeConnTimeout_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,9),_H3cdeNodeConnTimeout_Type())
...
h3cdeNodeLocalPendTimeout=_H3cdeNodeLocalPendTimeout_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,10),_H3cdeNodeLocalPendTimeout_Type())
...
h3cdeNodeRemotePendTimeout=_H3cdeNodeRemotePendTimeout_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,11),_H3cdeNodeRemotePendTimeout_Type())
...
h3cdeNodeSnaCacheTimeout=_H3cdeNodeSnaCacheTimeout_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,12),_H3cdeNodeSnaCacheTimeout_Type())
...
h3cdeNodeExplorerTimeout=_H3cdeNodeExplorerTimeout_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,13),_H3cdeNodeExplorerTimeout_Type())
...
h3cdeNodeExplorerWaitTimeout=_H3cdeNodeExplorerWaitTimeout_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,14),_H3cdeNodeExplorerWaitTimeout_Type())
...
h3cdeNodeConfigSapList=_H3cdeNodeConfigSapList_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,15),_H3cdeNodeConfigSapList_Type())
...
h3cdeNodeMaxTransmission=_H3cdeNodeMaxTransmission_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,16),_H3cdeNodeMaxTransmission_Type())
...
h3cdeNodeMulticastStatus=_H3cdeNodeMulticastStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,17),_H3cdeNodeMulticastStatus_Type())
...
h3cdeNodeMulticastAddress=_H3cdeNodeMulticastAddress_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,18),_H3cdeNodeMulticastAddress_Type())
...
h3cdeNodeResetTcpAll=_H3cdeNodeResetTcpAll_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,19),_H3cdeNodeResetTcpAll_Type())
...
h3cdeNodeStCapTcpNum=_H3cdeNodeStCapTcpNum_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,20),_H3cdeNodeStCapTcpNum_Type())
...
h3cdeNodeTcpQueueMax=_H3cdeNodeTcpQueueMax_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,1,21),_H3cdeNodeTcpQueueMax_Type())
...
h3cdeTConn=_H3cdeTConn_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,2))
_H3cdeTConnConfigTable_Object=MibTable
h3cdeTConnConfigTable=_H3cdeTConnConfigTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,1))
if mibBuilder.loadTexts:h3cdeTConnConfigTable.setStatus(_A)
_H3cdeTConnConfigEntry_Object=MibTableRow
h3cdeTConnConfigEntry=_H3cdeTConnConfigEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,1,1))
...
h3cdeTConnConfigVersion=_H3cdeTConnConfigVersion_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,1,1,1),_H3cdeTConnConfigVersion_Type())
...
h3cdeTConnConfigPriority=_H3cdeTConnConfigPriority_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,1,1,2),_H3cdeTConnConfigPriority_Type())
...
h3cdeTConnConfigLfSize=_H3cdeTConnConfigLfSize_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,1,1,3),_H3cdeTConnConfigLfSize_Type())
...
h3cdeTConnConfigKeepaliveIntval=_H3cdeTConnConfigKeepaliveIntval_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,1,1,4),_H3cdeTConnConfigKeepaliveIntval_Type())
...
h3cdeTConnConfigBackup=_H3cdeTConnConfigBackup_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,1,1,5),_H3cdeTConnConfigBackup_Type())
...
h3cdeTConnConfigBackupTAddr=_H3cdeTConnConfigBackupTAddr_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,1,1,6),_H3cdeTConnConfigBackupTAddr_Type())
...
h3cdeTConnConfigBackupLinger=_H3cdeTConnConfigBackupLinger_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,1,1,7),_H3cdeTConnConfigBackupLinger_Type())
...
h3cdeTConnOperTable=_H3cdeTConnOperTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2))
if mibBuilder.loadTexts:h3cdeTConnOperTable.setStatus(_A)
_H3cdeTConnOperEntry_Object=MibTableRow
h3cdeTConnOperEntry=_H3cdeTConnOperEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1))
...
h3cdeTConnOperPeerType=_H3cdeTConnOperPeerType_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1,1),_H3cdeTConnOperPeerType_Type())
...
h3cdeTConnOperVendorID=_H3cdeTConnOperVendorID_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1,2),_H3cdeTConnOperVendorID_Type())
...
h3cdeTConnOperVersionString=_H3cdeTConnOperVersionString_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1,3),_H3cdeTConnOperVersionString_Type())
...
h3cdeTConnOperUpTime=_H3cdeTConnOperUpTime_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1,4),_H3cdeTConnOperUpTime_Type())
...
h3cdeTConnOperMulticastAddress=_H3cdeTConnOperMulticastAddress_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1,5),_H3cdeTConnOperMulticastAddress_Type())
...
h3cdeTConnOperStCapTcpNumber=_H3cdeTConnOperStCapTcpNumber_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1,6),_H3cdeTConnOperStCapTcpNumber_Type())
...
h3cdeTConnOperRecvPkts=_H3cdeTConnOperRecvPkts_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1,7),_H3cdeTConnOperRecvPkts_Type())
...
h3cdeTConnOperSendPkts=_H3cdeTConnOperSendPkts_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1,8),_H3cdeTConnOperSendPkts_Type())
...
h3cdeTConnOperDropPkts=_H3cdeTConnOperDropPkts_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,2,1,9),_H3cdeTConnOperDropPkts_Type())
...
h3cdeTConnTcpConfigTable=_H3cdeTConnTcpConfigTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,3))
if mibBuilder.loadTexts:h3cdeTConnTcpConfigTable.setStatus(_A)
_H3cdeTConnTcpConfigEntry_Object=MibTableRow
h3cdeTConnTcpConfigEntry=_H3cdeTConnTcpConfigEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,3,1))
...
h3cdeTConnTcpConfigQueueMax=_H3cdeTConnTcpConfigQueueMax_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,2,3,1,1),_H3cdeTConnTcpConfigQueueMax_Type())
...
h3cdeBridge=_H3cdeBridge_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,3))
_H3cdeBridgeTable_Object=MibTable
h3cdeBridgeTable=_H3cdeBridgeTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,3,1))
if mibBuilder.loadTexts:h3cdeBridgeTable.setStatus(_A)
_H3cdeBridgeEntry_Object=MibTableRow
h3cdeBridgeEntry=_H3cdeBridgeEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,3,1,1))
...
h3cdeBridgeNumIndex=_H3cdeBridgeNumIndex_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,3,1,1,1),_H3cdeBridgeNumIndex_Type())
...
h3cdeBridgeRowStatus=_H3cdeBridgeRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,3,1,1,2),_H3cdeBridgeRowStatus_Type())
...
h3cdeBridgeIfTable=_H3cdeBridgeIfTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,3,2))
if mibBuilder.loadTexts:h3cdeBridgeIfTable.setStatus(_A)
_H3cdeBridgeIfEntry_Object=MibTableRow
h3cdeBridgeIfEntry=_H3cdeBridgeIfEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,3,2,1))
...
h3cdeBridgeIfBrgGrp=_H3cdeBridgeIfBrgGrp_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,3,2,1,1),_H3cdeBridgeIfBrgGrp_Type())
...
h3cdeBridgeIfRowStatus=_H3cdeBridgeIfRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,3,2,1,2),_H3cdeBridgeIfRowStatus_Type())
...
h3cdeQllc=_H3cdeQllc_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,4))
_H3cdeQllcTable_Object=MibTable
h3cdeQllcTable=_H3cdeQllcTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,4,1))
if mibBuilder.loadTexts:h3cdeQllcTable.setStatus(_A)
_H3cdeQllcEntry_Object=MibTableRow
h3cdeQllcEntry=_H3cdeQllcEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,4,1,1))
...
h3cQllcX121Address=_H3cQllcX121Address_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,4,1,1,1),_H3cQllcX121Address_Type())
...
h3cQllcLocalMac=_H3cQllcLocalMac_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,4,1,1,2),_H3cQllcLocalMac_Type())
...
h3cQllcLocalSap=_H3cQllcLocalSap_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,4,1,1,3),_H3cQllcLocalSap_Type())
...
h3cQllcRemoteMac=_H3cQllcRemoteMac_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,4,1,1,4),_H3cQllcRemoteMac_Type())
...
h3cQllcRemoteSap=_H3cQllcRemoteSap_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,4,1,1,5),_H3cQllcRemoteSap_Type())
...
h3cQllcRowStatus=_H3cQllcRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,4,1,1,6),_H3cQllcRowStatus_Type())
...
h3cdeSdlc=_H3cdeSdlc_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,5))
_H3cdeSdlcPortTable_Object=MibTable
h3cdeSdlcPortTable=_H3cdeSdlcPortTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1))
if mibBuilder.loadTexts:h3cdeSdlcPortTable.setStatus(_A)
_H3cdeSdlcPortEntry_Object=MibTableRow
h3cdeSdlcPortEntry=_H3cdeSdlcPortEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1))
...
h3cdeSdlcPortRole=_H3cdeSdlcPortRole_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,1),_H3cdeSdlcPortRole_Type())
...
h3cdeSdlcPortSendWindow=_H3cdeSdlcPortSendWindow_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,2),_H3cdeSdlcPortSendWindow_Type())
...
h3cdeSdlcPortModulo=_H3cdeSdlcPortModulo_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,3),_H3cdeSdlcPortModulo_Type())
...
h3cdeSdlcPortMaxPdu=_H3cdeSdlcPortMaxPdu_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,4),_H3cdeSdlcPortMaxPdu_Type())
...
h3cdeSdlcPortMaxSendQueue=_H3cdeSdlcPortMaxSendQueue_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,5),_H3cdeSdlcPortMaxSendQueue_Type())
...
h3cdeSdlcPortMaxTransmission=_H3cdeSdlcPortMaxTransmission_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,6),_H3cdeSdlcPortMaxTransmission_Type())
...
h3cdeSdlcPortSimultaneousEnable=_H3cdeSdlcPortSimultaneousEnable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,7),_H3cdeSdlcPortSimultaneousEnable_Type())
...
h3cdeSdlcPortTimerACK=_H3cdeSdlcPortTimerACK_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,8),_H3cdeSdlcPortTimerACK_Type())
...
h3cdeSdlcPortTimerLifeTime=_H3cdeSdlcPortTimerLifeTime_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,9),_H3cdeSdlcPortTimerLifeTime_Type())
...
h3cdeSdlcPortTimerPollPause=_H3cdeSdlcPortTimerPollPause_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,10),_H3cdeSdlcPortTimerPollPause_Type())
...
h3cdeSdlcPortRowStatus=_H3cdeSdlcPortRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,5,1,1,11),_H3cdeSdlcPortRowStatus_Type())
...
h3cdeLlc2=_H3cdeLlc2_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,6))
_H3cdeLlc2PortTable_Object=MibTable
h3cdeLlc2PortTable=_H3cdeLlc2PortTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1))
if mibBuilder.loadTexts:h3cdeLlc2PortTable.setStatus(_A)
_H3cdeLlc2PortEntry_Object=MibTableRow
h3cdeLlc2PortEntry=_H3cdeLlc2PortEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1))
...
h3cdeLlc2PortMaxAck=_H3cdeLlc2PortMaxAck_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,1),_H3cdeLlc2PortMaxAck_Type())
...
h3cdeLlc2PortMaxPdu=_H3cdeLlc2PortMaxPdu_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,2),_H3cdeLlc2PortMaxPdu_Type())
...
h3cdeLlc2PortMaxSendQueue=_H3cdeLlc2PortMaxSendQueue_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,3),_H3cdeLlc2PortMaxSendQueue_Type())
...
h3cdeLlc2PortMaxTransmission=_H3cdeLlc2PortMaxTransmission_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,4),_H3cdeLlc2PortMaxTransmission_Type())
...
h3cdeLlc2PortModulo=_H3cdeLlc2PortModulo_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,5),_H3cdeLlc2PortModulo_Type())
...
h3cdeLlc2PortReceiveWindow=_H3cdeLlc2PortReceiveWindow_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,6),_H3cdeLlc2PortReceiveWindow_Type())
...
h3cdeLlc2PortTimerAck=_H3cdeLlc2PortTimerAck_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,7),_H3cdeLlc2PortTimerAck_Type())
...
h3cdeLlc2PortTimerAckDelay=_H3cdeLlc2PortTimerAckDelay_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,8),_H3cdeLlc2PortTimerAckDelay_Type())
...
h3cdeLlc2PortTimerDetect=_H3cdeLlc2PortTimerDetect_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,9),_H3cdeLlc2PortTimerDetect_Type())
...
h3cdeLlc2PortTimerBusy=_H3cdeLlc2PortTimerBusy_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,10),_H3cdeLlc2PortTimerBusy_Type())
...
h3cdeLlc2PortTimerPoll=_H3cdeLlc2PortTimerPoll_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,11),_H3cdeLlc2PortTimerPoll_Type())
...
h3cdeLlc2PortTimerReject=_H3cdeLlc2PortTimerReject_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,12),_H3cdeLlc2PortTimerReject_Type())
...
h3cdeLlc2PortRowStatus=_H3cdeLlc2PortRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,6,1,1,13),_H3cdeLlc2PortRowStatus_Type())
...
h3cdeReachableCache=_H3cdeReachableCache_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,7))
_H3cdeRchCacheStat_ObjectIdentity=ObjectIdentity
h3cdeRchCacheStat=_H3cdeRchCacheStat_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,7,1))
_H3cdeRchCacheMaxIndex_Type=Integer32
_H3cdeRchCacheMaxIndex_Object=MibScalar
h3cdeRchCacheMaxIndex=_H3cdeRchCacheMaxIndex_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,1,1),_H3cdeRchCacheMaxIndex_Type())
...
h3cdeRchCacheNextIndex=_H3cdeRchCacheNextIndex_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,1,2),_H3cdeRchCacheNextIndex_Type())
...
h3cdeRchCacheTable=_H3cdeRchCacheTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,3))
if mibBuilder.loadTexts:h3cdeRchCacheTable.setStatus(_A)
_H3cdeRchCacheEntry_Object=MibTableRow
h3cdeRchCacheEntry=_H3cdeRchCacheEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,3,1))
...
h3cdeRchCacheIndex=_H3cdeRchCacheIndex_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,3,1,1),_H3cdeRchCacheIndex_Type())
...
h3cdeRchCacheStatus=_H3cdeRchCacheStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,3,1,2),_H3cdeRchCacheStatus_Type())
...
h3cdeRchCacheRemainTime=_H3cdeRchCacheRemainTime_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,3,1,3),_H3cdeRchCacheRemainTime_Type())
...
h3cdeRchCacheMac=_H3cdeRchCacheMac_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,3,1,4),_H3cdeRchCacheMac_Type())
...
h3cdeRchCacheRemoteIpAddrType=_H3cdeRchCacheRemoteIpAddrType_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,3,1,5),_H3cdeRchCacheRemoteIpAddrType_Type())
...
h3cdeRchCacheRemoteIp=_H3cdeRchCacheRemoteIp_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,3,1,6),_H3cdeRchCacheRemoteIp_Type())
...
h3cdeRchCacheRowStatus=_H3cdeRchCacheRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,7,3,1,7),_H3cdeRchCacheRowStatus_Type())
...
h3cdeEthernetBackup=_H3cdeEthernetBackup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,8))
_H3cdeEBMacMapStat_ObjectIdentity=ObjectIdentity
h3cdeEBMacMapStat=_H3cdeEBMacMapStat_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,62,1,8,1))
_H3cdeEBMacMapMaxIndex_Type=Integer32
_H3cdeEBMacMapMaxIndex_Object=MibScalar
h3cdeEBMacMapMaxIndex=_H3cdeEBMacMapMaxIndex_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,1,1),_H3cdeEBMacMapMaxIndex_Type())
...
h3cdeEBMacMapNextIndex=_H3cdeEBMacMapNextIndex_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,1,2),_H3cdeEBMacMapNextIndex_Type())
...
h3cdeEBIfTable=_H3cdeEBIfTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,3))
if mibBuilder.loadTexts:h3cdeEBIfTable.setStatus(_A)
_H3cdeEBIfEntry_Object=MibTableRow
h3cdeEBIfEntry=_H3cdeEBIfEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,3,1))
...
h3cdeEBMulticastMac=_H3cdeEBMulticastMac_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,3,1,1),_H3cdeEBMulticastMac_Type())
...
h3cdeEBPriority=_H3cdeEBPriority_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,3,1,2),_H3cdeEBPriority_Type())
...
h3cdeEBtimer=_H3cdeEBtimer_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,3,1,3),_H3cdeEBtimer_Type())
...
h3cdeEBRowStatus=_H3cdeEBRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,3,1,4),_H3cdeEBRowStatus_Type())
h3cdeEBRowStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:h3cdeEBRowStatus.setStatus(_A)
_H3cdeEBMacMapTable_Object=MibTable
h3cdeEBMacMapTable=_H3cdeEBMacMapTable_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,4))
if mibBuilder.loadTexts:h3cdeEBMacMapTable.setStatus(_A)
_H3cdeEBMacMapEntry_Object=MibTableRow
h3cdeEBMacMapEntry=_H3cdeEBMacMapEntry_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,4,1))
...
h3cdeEBMacMapIndex=_H3cdeEBMacMapIndex_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,4,1,1),_H3cdeEBMacMapIndex_Type())
...
h3cdeEBMacMapLocalMac=_H3cdeEBMacMapLocalMac_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,4,1,2),_H3cdeEBMacMapLocalMac_Type())
...
h3cdeEBMacMapRemoteMac=_H3cdeEBMacMapRemoteMac_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,4,1,3),_H3cdeEBMacMapRemoteMac_Type())
...
h3cdeEBMacMapNeighbour=_H3cdeEBMacMapNeighbour_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,4,1,4),_H3cdeEBMacMapNeighbour_Type())
...
h3cdeEBMacMapRowStatus=_H3cdeEBMacMapRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,62,1,8,4,1,5),_H3cdeEBMacMapRowStatus_Type())
