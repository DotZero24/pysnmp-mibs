...
mibBuilder.exportSymbols("Juniper-MROUTER-MIB", juniMcastRouteStaticDest=juniMcastRouteStaticDest, juniMcastRpfDisable=juniMcastRpfDisable, juniMRouteQosBwAdaptive=juniMRouteQosBwAdaptive, juniMRouteRpfDisabled=juniMRouteRpfDisabled, juniMcastCompliance=juniMcastCompliance, juniMcastConformance=juniMcastConformance, juniMRoutePortBwReceded=juniMRoutePortBwReceded, juniMRoutePortBwExceded=juniMRoutePortBwExceded, juniMcastNotifyObject=juniMcastNotifyObject, juniMRoutePortConfGroup=juniMRoutePortConfGroup, juniMcastRpfRouteEntry=juniMcastRpfRouteEntry, juniMroutePortLocationType=juniMroutePortLocationType, juniMRoutePortAdmittedBw=juniMRoutePortAdmittedBw, juniMcastCompliance3=juniMcastCompliance3, juniMRouteInterfaceEntry=juniMRouteInterfaceEntry, juniMRouteOifCnt=juniMRouteOifCnt, juniMcastRouteStaticRpfHop=juniMcastRouteStaticRpfHop, juniMRouteQosBw=juniMRouteQosBw, juniMRoutePortTable=juniMRoutePortTable, juniMRouteOwnerProtoType=juniMRouteOwnerProtoType, juniMcastNotificationObjects=juniMcastNotificationObjects, juniMRoutePortLocationIndex=juniMRoutePortLocationIndex, juniMcastCompliance4=juniMcastCompliance4, juniMRoutePortSGCount=juniMRoutePortSGCount, juniMRoutePortPriorityBw=juniMRoutePortPriorityBw, juniMcastObjects=juniMcastObjects, juniMRouteIsEcmp=juniMRouteIsEcmp, juniMRoutePktFwd=juniMRoutePktFwd, juniMRouterMIBObject=juniMRouterMIBObject, juniMRouteTable=juniMRouteTable, juniMRoutePortPriorityBwExceded=juniMRoutePortPriorityBwExceded, juniMRouteIfLocIndex=juniMRouteIfLocIndex, juniMRouteAdmBw=juniMRouteAdmBw, juniMRouteInterfaceActiveGroups=juniMRouteInterfaceActiveGroups, juniMcastRpfRouteTable=juniMcastRpfRouteTable, juniMcastRouteStaticMask=juniMcastRouteStaticMask, juniMRouteInterfaceBlockedGroups=juniMRouteInterfaceBlockedGroups, juniMRoutePortHysteresis=juniMRoutePortHysteresis, juniMRoutePortPriorityBwReceded=juniMRoutePortPriorityBwReceded, juniMcastRouteStaticTag=juniMcastRouteStaticTag, juniMRouteInterfaceTable=juniMRouteInterfaceTable, juniMRouteEntry=juniMRouteEntry, juniMcastTraps=juniMcastTraps, juniMcastCompliance2=juniMcastCompliance2, juniMRouteConfGroup=juniMRouteConfGroup, juniMcastRpfRouteConfGroup=juniMcastRpfRouteConfGroup, juniMRouterMIB=juniMRouterMIB, juniMcastRouteStaticRtPreference=juniMcastRouteStaticRtPreference, PYSNMP_MODULE_ID=juniMRouterMIB, juniMcastRouteStaticRowStatus=juniMcastRouteStaticRowStatus, juniMRoutePortMaxBw=juniMRoutePortMaxBw, juniMcastCompliances=juniMcastCompliances, juniMcastConfGroups=juniMcastConfGroups, juniMcastGlobalConfGroup=juniMcastGlobalConfGroup, juniMRouteAdmBwAdaptive=juniMRouteAdmBwAdaptive, juniMRoutePortEntry=juniMRoutePortEntry, juniMRoutePortLimit=juniMRoutePortLimit)
