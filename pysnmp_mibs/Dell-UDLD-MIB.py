# SNMP MIB module (Dell-UDLD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-UDLD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:09:26 2025
...
rlUdldPortEntry.setIndexNames(
    (0, "Dell-UDLD-MIB", "rlUdldPortIfIndex"),
)
if mibBuilder.loadTexts:
...
rlUdldNeighborEntry.setIndexNames(
    (0, "Dell-UDLD-MIB", "rlUdldNeighborPortIfIndex"),
    (0, "Dell-UDLD-MIB", "rlUdldNeighborDeviceID"),
    (0, "Dell-UDLD-MIB", "rlUdldNeighborPortID"),
)
if mibBuilder.loadTexts:
