_Z='fsMplsRsvpTeIfStatsEntry'
_Y='recoveryPathSRefresh'
_X='recoveryPathReceive'
_W='recoveryPathTransmit'
_V='fsMplsRsvpTeNbrIfAddr'
_U='notSupported'
_T='not-accessible'
_S='disable'
_R='enable'
...
_L='StorageType'
_K='Bits'
_J='SUPERMICRO-MPLS-RSVP-TE-MIB'
_I='disabled'
_H='enabled'
_G='TruthValue'
_F='Unsigned32'
...
fsMplsRsvpTeObjects=_FsMplsRsvpTeObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,1,13,2,1))
_FsMplsRsvpTeIfTable_Object=MibTable
fsMplsRsvpTeIfTable=_FsMplsRsvpTeIfTable_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1))
if mibBuilder.loadTexts:fsMplsRsvpTeIfTable.setStatus(_A)
_FsMplsRsvpTeIfEntry_Object=MibTableRow
fsMplsRsvpTeIfEntry=_FsMplsRsvpTeIfEntry_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1))
...
fsMplsRsvpTeIfIndex=_FsMplsRsvpTeIfIndex_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,1),_FsMplsRsvpTeIfIndex_Type())
fsMplsRsvpTeIfIndex.setMaxAccess(_T)
...
_FsMplsRsvpTeIfLblSpace_Type.__name__=_C
_FsMplsRsvpTeIfLblSpace_Object=MibTableColumn
fsMplsRsvpTeIfLblSpace=_FsMplsRsvpTeIfLblSpace_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,2),_FsMplsRsvpTeIfLblSpace_Type())
...
_FsMplsRsvpTeIfLblType_Type.__name__=_C
_FsMplsRsvpTeIfLblType_Object=MibTableColumn
fsMplsRsvpTeIfLblType=_FsMplsRsvpTeIfLblType_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,3),_FsMplsRsvpTeIfLblType_Type())
fsMplsRsvpTeIfLblType.setMaxAccess(_E)
if mibBuilder.loadTexts:fsMplsRsvpTeIfLblType.setStatus(_A)
class _FsMplsRsvpTeAtmMergeCap_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,2)));namedValues=NamedValues(*((_U,0),('vcMerge',2)))
_FsMplsRsvpTeAtmMergeCap_Type.__name__=_C
_FsMplsRsvpTeAtmMergeCap_Object=MibTableColumn
fsMplsRsvpTeAtmMergeCap=_FsMplsRsvpTeAtmMergeCap_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,4),_FsMplsRsvpTeAtmMergeCap_Type())
...
_FsMplsRsvpTeAtmVcDirection_Type.__name__=_C
_FsMplsRsvpTeAtmVcDirection_Object=MibTableColumn
fsMplsRsvpTeAtmVcDirection=_FsMplsRsvpTeAtmVcDirection_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,5),_FsMplsRsvpTeAtmVcDirection_Type())
...
fsMplsRsvpTeAtmMinVpi=_FsMplsRsvpTeAtmMinVpi_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,6),_FsMplsRsvpTeAtmMinVpi_Type())
...
fsMplsRsvpTeAtmMinVci=_FsMplsRsvpTeAtmMinVci_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,7),_FsMplsRsvpTeAtmMinVci_Type())
...
fsMplsRsvpTeAtmMaxVpi=_FsMplsRsvpTeAtmMaxVpi_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,8),_FsMplsRsvpTeAtmMaxVpi_Type())
...
fsMplsRsvpTeAtmMaxVci=_FsMplsRsvpTeAtmMaxVci_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,9),_FsMplsRsvpTeAtmMaxVci_Type())
...
_FsMplsRsvpTeIfMtu_Type.__name__=_C
_FsMplsRsvpTeIfMtu_Object=MibTableColumn
fsMplsRsvpTeIfMtu=_FsMplsRsvpTeIfMtu_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,10),_FsMplsRsvpTeIfMtu_Type())
...
fsMplsRsvpTeIfUdpNbrs=_FsMplsRsvpTeIfUdpNbrs_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,11),_FsMplsRsvpTeIfUdpNbrs_Type())
...
fsMplsRsvpTeIfIpNbrs=_FsMplsRsvpTeIfIpNbrs_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,12),_FsMplsRsvpTeIfIpNbrs_Type())
...
fsMplsRsvpTeIfNbrs=_FsMplsRsvpTeIfNbrs_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,13),_FsMplsRsvpTeIfNbrs_Type())
...
_FsMplsRsvpTeIfRefreshMultiple_Type.__name__=_C
_FsMplsRsvpTeIfRefreshMultiple_Object=MibTableColumn
fsMplsRsvpTeIfRefreshMultiple=_FsMplsRsvpTeIfRefreshMultiple_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,14),_FsMplsRsvpTeIfRefreshMultiple_Type())
...
_FsMplsRsvpTeIfTTL_Type.__name__=_C
_FsMplsRsvpTeIfTTL_Object=MibTableColumn
fsMplsRsvpTeIfTTL=_FsMplsRsvpTeIfTTL_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,15),_FsMplsRsvpTeIfTTL_Type())
...
fsMplsRsvpTeIfRefreshInterval=_FsMplsRsvpTeIfRefreshInterval_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,16),_FsMplsRsvpTeIfRefreshInterval_Type())
...
fsMplsRsvpTeIfRouteDelay=_FsMplsRsvpTeIfRouteDelay_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,17),_FsMplsRsvpTeIfRouteDelay_Type())
...
fsMplsRsvpTeIfUdpRequired=_FsMplsRsvpTeIfUdpRequired_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,18),_FsMplsRsvpTeIfUdpRequired_Type())
...
fsMplsRsvpTeIfHelloSupported=_FsMplsRsvpTeIfHelloSupported_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,19),_FsMplsRsvpTeIfHelloSupported_Type())
fsMplsRsvpTeIfHelloSupported.setMaxAccess(_E)
if mibBuilder.loadTexts:fsMplsRsvpTeIfHelloSupported.setStatus(_A)
class _FsMplsRsvpTeIfLinkAttr_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,65535))
_FsMplsRsvpTeIfLinkAttr_Type.__name__=_C
_FsMplsRsvpTeIfLinkAttr_Object=MibTableColumn
fsMplsRsvpTeIfLinkAttr=_FsMplsRsvpTeIfLinkAttr_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,20),_FsMplsRsvpTeIfLinkAttr_Type())
...
fsMplsRsvpTeIfStatus=_FsMplsRsvpTeIfStatus_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,21),_FsMplsRsvpTeIfStatus_Type())
...
fsMplsRsvpTeIfPlrId=_FsMplsRsvpTeIfPlrId_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,22),_FsMplsRsvpTeIfPlrId_Type())
...
fsMplsRsvpTeIfAvoidNodeId=_FsMplsRsvpTeIfAvoidNodeId_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,23),_FsMplsRsvpTeIfAvoidNodeId_Type())
...
fsMplsRsvpTeIfStorageType=_FsMplsRsvpTeIfStorageType_Object((1,3,6,1,4,1,10876,101,1,13,2,1,1,1,24),_FsMplsRsvpTeIfStorageType_Type())
...
fsMplsRsvpTeIfStatsTable=_FsMplsRsvpTeIfStatsTable_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2))
if mibBuilder.loadTexts:fsMplsRsvpTeIfStatsTable.setStatus(_A)
_FsMplsRsvpTeIfStatsEntry_Object=MibTableRow
fsMplsRsvpTeIfStatsEntry=_FsMplsRsvpTeIfStatsEntry_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1))
...
fsMplsRsvpTeIfNumTnls=_FsMplsRsvpTeIfNumTnls_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,1),_FsMplsRsvpTeIfNumTnls_Type())
...
fsMplsRsvpTeIfNumMsgSent=_FsMplsRsvpTeIfNumMsgSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,2),_FsMplsRsvpTeIfNumMsgSent_Type())
...
fsMplsRsvpTeIfNumMsgRcvd=_FsMplsRsvpTeIfNumMsgRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,3),_FsMplsRsvpTeIfNumMsgRcvd_Type())
...
fsMplsRsvpTeIfNumHelloSent=_FsMplsRsvpTeIfNumHelloSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,4),_FsMplsRsvpTeIfNumHelloSent_Type())
...
fsMplsRsvpTeIfNumHelloRcvd=_FsMplsRsvpTeIfNumHelloRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,5),_FsMplsRsvpTeIfNumHelloRcvd_Type())
...
fsMplsRsvpTeIfNumPathErrSent=_FsMplsRsvpTeIfNumPathErrSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,6),_FsMplsRsvpTeIfNumPathErrSent_Type())
...
fsMplsRsvpTeIfNumPathErrRcvd=_FsMplsRsvpTeIfNumPathErrRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,7),_FsMplsRsvpTeIfNumPathErrRcvd_Type())
...
fsMplsRsvpTeIfNumPathTearSent=_FsMplsRsvpTeIfNumPathTearSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,8),_FsMplsRsvpTeIfNumPathTearSent_Type())
...
fsMplsRsvpTeIfNumPathTearRcvd=_FsMplsRsvpTeIfNumPathTearRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,9),_FsMplsRsvpTeIfNumPathTearRcvd_Type())
...
fsMplsRsvpTeIfNumResvErrSent=_FsMplsRsvpTeIfNumResvErrSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,10),_FsMplsRsvpTeIfNumResvErrSent_Type())
...
fsMplsRsvpTeIfNumResvErrRcvd=_FsMplsRsvpTeIfNumResvErrRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,11),_FsMplsRsvpTeIfNumResvErrRcvd_Type())
...
fsMplsRsvpTeIfNumResvTearSent=_FsMplsRsvpTeIfNumResvTearSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,12),_FsMplsRsvpTeIfNumResvTearSent_Type())
...
fsMplsRsvpTeIfNumResvTearRcvd=_FsMplsRsvpTeIfNumResvTearRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,13),_FsMplsRsvpTeIfNumResvTearRcvd_Type())
...
fsMplsRsvpTeIfNumResvConfSent=_FsMplsRsvpTeIfNumResvConfSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,14),_FsMplsRsvpTeIfNumResvConfSent_Type())
...
fsMplsRsvpTeIfNumResvConfRcvd=_FsMplsRsvpTeIfNumResvConfRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,15),_FsMplsRsvpTeIfNumResvConfRcvd_Type())
...
fsMplsRsvpTeIfNumBundleMsgSent=_FsMplsRsvpTeIfNumBundleMsgSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,16),_FsMplsRsvpTeIfNumBundleMsgSent_Type())
...
fsMplsRsvpTeIfNumBundleMsgRcvd=_FsMplsRsvpTeIfNumBundleMsgRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,17),_FsMplsRsvpTeIfNumBundleMsgRcvd_Type())
...
fsMplsRsvpTeIfNumSRefreshMsgSent=_FsMplsRsvpTeIfNumSRefreshMsgSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,18),_FsMplsRsvpTeIfNumSRefreshMsgSent_Type())
...
fsMplsRsvpTeIfNumSRefreshMsgRcvd=_FsMplsRsvpTeIfNumSRefreshMsgRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,19),_FsMplsRsvpTeIfNumSRefreshMsgRcvd_Type())
...
fsMplsRsvpTeIfNumPathSent=_FsMplsRsvpTeIfNumPathSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,20),_FsMplsRsvpTeIfNumPathSent_Type())
...
fsMplsRsvpTeIfNumPathRcvd=_FsMplsRsvpTeIfNumPathRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,21),_FsMplsRsvpTeIfNumPathRcvd_Type())
...
fsMplsRsvpTeIfNumResvSent=_FsMplsRsvpTeIfNumResvSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,22),_FsMplsRsvpTeIfNumResvSent_Type())
...
fsMplsRsvpTeIfNumResvRcvd=_FsMplsRsvpTeIfNumResvRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,23),_FsMplsRsvpTeIfNumResvRcvd_Type())
...
fsMplsRsvpTeIfNumNotifyMsgSent=_FsMplsRsvpTeIfNumNotifyMsgSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,24),_FsMplsRsvpTeIfNumNotifyMsgSent_Type())
...
fsMplsRsvpTeIfNumNotifyMsgRcvd=_FsMplsRsvpTeIfNumNotifyMsgRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,25),_FsMplsRsvpTeIfNumNotifyMsgRcvd_Type())
...
fsMplsRsvpTeIfNumRecoveryPathSent=_FsMplsRsvpTeIfNumRecoveryPathSent_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,26),_FsMplsRsvpTeIfNumRecoveryPathSent_Type())
...
fsMplsRsvpTeIfNumRecoveryPathRcvd=_FsMplsRsvpTeIfNumRecoveryPathRcvd_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,27),_FsMplsRsvpTeIfNumRecoveryPathRcvd_Type())
...
fsMplsRsvpTeIfNumPathSentWithRecoveryLbl=_FsMplsRsvpTeIfNumPathSentWithRecoveryLbl_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,28),_FsMplsRsvpTeIfNumPathSentWithRecoveryLbl_Type())
...
fsMplsRsvpTeIfNumPathRcvdWithRecoveryLbl=_FsMplsRsvpTeIfNumPathRcvdWithRecoveryLbl_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,29),_FsMplsRsvpTeIfNumPathRcvdWithRecoveryLbl_Type())
...
fsMplsRsvpTeIfNumPathSentWithSuggestedLbl=_FsMplsRsvpTeIfNumPathSentWithSuggestedLbl_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,30),_FsMplsRsvpTeIfNumPathSentWithSuggestedLbl_Type())
...
fsMplsRsvpTeIfNumPathRcvdWithSuggestedLbl=_FsMplsRsvpTeIfNumPathRcvdWithSuggestedLbl_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,31),_FsMplsRsvpTeIfNumPathRcvdWithSuggestedLbl_Type())
...
fsMplsRsvpTeIfNumHelloSentWithRestartCap=_FsMplsRsvpTeIfNumHelloSentWithRestartCap_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,32),_FsMplsRsvpTeIfNumHelloSentWithRestartCap_Type())
...
fsMplsRsvpTeIfNumHelloRcvdWithRestartCap=_FsMplsRsvpTeIfNumHelloRcvdWithRestartCap_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,33),_FsMplsRsvpTeIfNumHelloRcvdWithRestartCap_Type())
...
fsMplsRsvpTeIfNumHelloSentWithCapability=_FsMplsRsvpTeIfNumHelloSentWithCapability_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,34),_FsMplsRsvpTeIfNumHelloSentWithCapability_Type())
...
fsMplsRsvpTeIfNumHelloRcvdWithCapability=_FsMplsRsvpTeIfNumHelloRcvdWithCapability_Object((1,3,6,1,4,1,10876,101,1,13,2,1,2,1,35),_FsMplsRsvpTeIfNumHelloRcvdWithCapability_Type())
...
fsMplsRsvpTeNbrTable=_FsMplsRsvpTeNbrTable_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3))
if mibBuilder.loadTexts:fsMplsRsvpTeNbrTable.setStatus(_A)
_FsMplsRsvpTeNbrEntry_Object=MibTableRow
fsMplsRsvpTeNbrEntry=_FsMplsRsvpTeNbrEntry_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1))
fsMplsRsvpTeNbrEntry.setIndexNames((0,_J,_N),(0,_J,_V))
...
fsMplsRsvpTeNbrIfAddr=_FsMplsRsvpTeNbrIfAddr_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,1),_FsMplsRsvpTeNbrIfAddr_Type())
fsMplsRsvpTeNbrIfAddr.setMaxAccess(_T)
...
_FsMplsRsvpTeNbrRRCapable_Type.__name__=_C
_FsMplsRsvpTeNbrRRCapable_Object=MibTableColumn
fsMplsRsvpTeNbrRRCapable=_FsMplsRsvpTeNbrRRCapable_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,2),_FsMplsRsvpTeNbrRRCapable_Type())
...
_FsMplsRsvpTeNbrRRState_Type.__name__=_C
_FsMplsRsvpTeNbrRRState_Object=MibTableColumn
fsMplsRsvpTeNbrRRState=_FsMplsRsvpTeNbrRRState_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,3),_FsMplsRsvpTeNbrRRState_Type())
...
_FsMplsRsvpTeNbrRMDCapable_Type.__name__=_C
_FsMplsRsvpTeNbrRMDCapable_Object=MibTableColumn
fsMplsRsvpTeNbrRMDCapable=_FsMplsRsvpTeNbrRMDCapable_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,4),_FsMplsRsvpTeNbrRMDCapable_Type())
...
_FsMplsRsvpTeNbrEncapsType_Type.__name__=_C
_FsMplsRsvpTeNbrEncapsType_Object=MibTableColumn
fsMplsRsvpTeNbrEncapsType=_FsMplsRsvpTeNbrEncapsType_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,5),_FsMplsRsvpTeNbrEncapsType_Type())
...
_FsMplsRsvpTeNbrHelloSupport_Type.__name__=_C
_FsMplsRsvpTeNbrHelloSupport_Object=MibTableColumn
fsMplsRsvpTeNbrHelloSupport=_FsMplsRsvpTeNbrHelloSupport_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,6),_FsMplsRsvpTeNbrHelloSupport_Type())
fsMplsRsvpTeNbrHelloSupport.setMaxAccess(_E)
if mibBuilder.loadTexts:fsMplsRsvpTeNbrHelloSupport.setStatus(_A)
class _FsMplsRsvpTeNbrHelloState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3)));namedValues=NamedValues(*(('unknown',0),('supported',1),(_U,2),('supportReset',3)))
_FsMplsRsvpTeNbrHelloState_Type.__name__=_C
_FsMplsRsvpTeNbrHelloState_Object=MibTableColumn
fsMplsRsvpTeNbrHelloState=_FsMplsRsvpTeNbrHelloState_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,7),_FsMplsRsvpTeNbrHelloState_Type())
...
_FsMplsRsvpTeNbrHelloRelation_Type.__name__=_C
_FsMplsRsvpTeNbrHelloRelation_Object=MibTableColumn
fsMplsRsvpTeNbrHelloRelation=_FsMplsRsvpTeNbrHelloRelation_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,8),_FsMplsRsvpTeNbrHelloRelation_Type())
...
fsMplsRsvpTeNbrSrcInstInfo=_FsMplsRsvpTeNbrSrcInstInfo_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,9),_FsMplsRsvpTeNbrSrcInstInfo_Type())
...
fsMplsRsvpTeNbrDestInstInfo=_FsMplsRsvpTeNbrDestInstInfo_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,10),_FsMplsRsvpTeNbrDestInstInfo_Type())
...
fsMplsRsvpTeNbrCreationTime=_FsMplsRsvpTeNbrCreationTime_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,11),_FsMplsRsvpTeNbrCreationTime_Type())
...
fsMplsRsvpTeNbrLclRprDetectionTime=_FsMplsRsvpTeNbrLclRprDetectionTime_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,12),_FsMplsRsvpTeNbrLclRprDetectionTime_Type())
...
fsMplsRsvpTeNbrNumTunnels=_FsMplsRsvpTeNbrNumTunnels_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,13),_FsMplsRsvpTeNbrNumTunnels_Type())
...
fsMplsRsvpTeNbrStatus=_FsMplsRsvpTeNbrStatus_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,14),_FsMplsRsvpTeNbrStatus_Type())
fsMplsRsvpTeNbrStatus.setMaxAccess(_E)
if mibBuilder.loadTexts:fsMplsRsvpTeNbrStatus.setStatus(_A)
class _FsMplsRsvpTeNbrGrRecoveryPathCapability_Type(Bits):namedValues=NamedValues(*((_W,0),(_X,1),(_Y,2)))
_FsMplsRsvpTeNbrGrRecoveryPathCapability_Type.__name__=_K
_FsMplsRsvpTeNbrGrRecoveryPathCapability_Object=MibTableColumn
fsMplsRsvpTeNbrGrRecoveryPathCapability=_FsMplsRsvpTeNbrGrRecoveryPathCapability_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,15),_FsMplsRsvpTeNbrGrRecoveryPathCapability_Type())
...
fsMplsRsvpTeNbrGrRestartTime=_FsMplsRsvpTeNbrGrRestartTime_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,16),_FsMplsRsvpTeNbrGrRestartTime_Type())
...
fsMplsRsvpTeNbrGrRecoveryTime=_FsMplsRsvpTeNbrGrRecoveryTime_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,17),_FsMplsRsvpTeNbrGrRecoveryTime_Type())
...
fsMplsRsvpTeNbrGrProgressStatus=_FsMplsRsvpTeNbrGrProgressStatus_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,18),_FsMplsRsvpTeNbrGrProgressStatus_Type())
...
fsMplsRsvpTeNbrStorageType=_FsMplsRsvpTeNbrStorageType_Object((1,3,6,1,4,1,10876,101,1,13,2,1,3,1,19),_FsMplsRsvpTeNbrStorageType_Type())
...
fsMplsRsvpTeGenObjects=_FsMplsRsvpTeGenObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,1,13,2,2))
_FsMplsRsvpTeLsrID_Type=MplsLsrIdentifier
_FsMplsRsvpTeLsrID_Object=MibScalar
fsMplsRsvpTeLsrID=_FsMplsRsvpTeLsrID_Object((1,3,6,1,4,1,10876,101,1,13,2,2,1),_FsMplsRsvpTeLsrID_Type())
fsMplsRsvpTeLsrID.setMaxAccess(_D)
...
_FsMplsRsvpTeMaxTnls_Type.__name__=_C
_FsMplsRsvpTeMaxTnls_Object=MibScalar
fsMplsRsvpTeMaxTnls=_FsMplsRsvpTeMaxTnls_Object((1,3,6,1,4,1,10876,101,1,13,2,2,2),_FsMplsRsvpTeMaxTnls_Type())
fsMplsRsvpTeMaxTnls.setMaxAccess(_D)
...
_FsMplsRsvpTeMaxErhopsPerTnl_Type.__name__=_C
_FsMplsRsvpTeMaxErhopsPerTnl_Object=MibScalar
fsMplsRsvpTeMaxErhopsPerTnl=_FsMplsRsvpTeMaxErhopsPerTnl_Object((1,3,6,1,4,1,10876,101,1,13,2,2,3),_FsMplsRsvpTeMaxErhopsPerTnl_Type())
fsMplsRsvpTeMaxErhopsPerTnl.setMaxAccess(_D)
...
_FsMplsRsvpTeMaxActRoutePerTnl_Type.__name__=_C
_FsMplsRsvpTeMaxActRoutePerTnl_Object=MibScalar
fsMplsRsvpTeMaxActRoutePerTnl=_FsMplsRsvpTeMaxActRoutePerTnl_Object((1,3,6,1,4,1,10876,101,1,13,2,2,4),_FsMplsRsvpTeMaxActRoutePerTnl_Type())
fsMplsRsvpTeMaxActRoutePerTnl.setMaxAccess(_D)
...
_FsMplsRsvpTeMaxIfaces_Type.__name__=_C
_FsMplsRsvpTeMaxIfaces_Object=MibScalar
fsMplsRsvpTeMaxIfaces=_FsMplsRsvpTeMaxIfaces_Object((1,3,6,1,4,1,10876,101,1,13,2,2,5),_FsMplsRsvpTeMaxIfaces_Type())
fsMplsRsvpTeMaxIfaces.setMaxAccess(_D)
...
_FsMplsRsvpTeMaxNbrs_Type.__name__=_C
_FsMplsRsvpTeMaxNbrs_Object=MibScalar
fsMplsRsvpTeMaxNbrs=_FsMplsRsvpTeMaxNbrs_Object((1,3,6,1,4,1,10876,101,1,13,2,2,6),_FsMplsRsvpTeMaxNbrs_Type())
fsMplsRsvpTeMaxNbrs.setMaxAccess(_D)
...
fsMplsRsvpTeSockSupprtd=_FsMplsRsvpTeSockSupprtd_Object((1,3,6,1,4,1,10876,101,1,13,2,2,7),_FsMplsRsvpTeSockSupprtd_Type())
fsMplsRsvpTeSockSupprtd.setMaxAccess(_D)
...
fsMplsRsvpTeHelloSupprtd=_FsMplsRsvpTeHelloSupprtd_Object((1,3,6,1,4,1,10876,101,1,13,2,2,8),_FsMplsRsvpTeHelloSupprtd_Type())
fsMplsRsvpTeHelloSupprtd.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMplsRsvpTeHelloSupprtd.setStatus(_A)
class _FsMplsRsvpTeHelloIntervalTime_Type(Integer32):defaultValue=10;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(10,30000))
_FsMplsRsvpTeHelloIntervalTime_Type.__name__=_C
_FsMplsRsvpTeHelloIntervalTime_Object=MibScalar
fsMplsRsvpTeHelloIntervalTime=_FsMplsRsvpTeHelloIntervalTime_Object((1,3,6,1,4,1,10876,101,1,13,2,2,9),_FsMplsRsvpTeHelloIntervalTime_Type())
fsMplsRsvpTeHelloIntervalTime.setMaxAccess(_D)
...
_FsMplsRsvpTeRRCapable_Type.__name__=_C
_FsMplsRsvpTeRRCapable_Object=MibScalar
fsMplsRsvpTeRRCapable=_FsMplsRsvpTeRRCapable_Object((1,3,6,1,4,1,10876,101,1,13,2,2,10),_FsMplsRsvpTeRRCapable_Type())
fsMplsRsvpTeRRCapable.setMaxAccess(_D)
...
_FsMplsRsvpTeMsgIdCapable_Type.__name__=_C
_FsMplsRsvpTeMsgIdCapable_Object=MibScalar
fsMplsRsvpTeMsgIdCapable=_FsMplsRsvpTeMsgIdCapable_Object((1,3,6,1,4,1,10876,101,1,13,2,2,11),_FsMplsRsvpTeMsgIdCapable_Type())
fsMplsRsvpTeMsgIdCapable.setMaxAccess(_D)
...
fsMplsRsvpTeRMDPolicyObject=_FsMplsRsvpTeRMDPolicyObject_Object((1,3,6,1,4,1,10876,101,1,13,2,2,12),_FsMplsRsvpTeRMDPolicyObject_Type())
fsMplsRsvpTeRMDPolicyObject.setMaxAccess(_D)
...
_FsMplsRsvpTeGenLblSpaceMinLbl_Type.__name__=_C
_FsMplsRsvpTeGenLblSpaceMinLbl_Object=MibScalar
fsMplsRsvpTeGenLblSpaceMinLbl=_FsMplsRsvpTeGenLblSpaceMinLbl_Object((1,3,6,1,4,1,10876,101,1,13,2,2,13),_FsMplsRsvpTeGenLblSpaceMinLbl_Type())
fsMplsRsvpTeGenLblSpaceMinLbl.setMaxAccess(_D)
...
_FsMplsRsvpTeGenLblSpaceMaxLbl_Type.__name__=_C
_FsMplsRsvpTeGenLblSpaceMaxLbl_Object=MibScalar
fsMplsRsvpTeGenLblSpaceMaxLbl=_FsMplsRsvpTeGenLblSpaceMaxLbl_Object((1,3,6,1,4,1,10876,101,1,13,2,2,14),_FsMplsRsvpTeGenLblSpaceMaxLbl_Type())
fsMplsRsvpTeGenLblSpaceMaxLbl.setMaxAccess(_D)
...
fsMplsRsvpTeGenDebugFlag=_FsMplsRsvpTeGenDebugFlag_Object((1,3,6,1,4,1,10876,101,1,13,2,2,15),_FsMplsRsvpTeGenDebugFlag_Type())
fsMplsRsvpTeGenDebugFlag.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMplsRsvpTeGenDebugFlag.setStatus(_A)
class _FsMplsRsvpTeGenPduDumpLevel_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,4)));namedValues=NamedValues(*((_Q,0),('min',1),('max',2),('hdr',4)))
_FsMplsRsvpTeGenPduDumpLevel_Type.__name__=_C
_FsMplsRsvpTeGenPduDumpLevel_Object=MibScalar
fsMplsRsvpTeGenPduDumpLevel=_FsMplsRsvpTeGenPduDumpLevel_Object((1,3,6,1,4,1,10876,101,1,13,2,2,16),_FsMplsRsvpTeGenPduDumpLevel_Type())
fsMplsRsvpTeGenPduDumpLevel.setMaxAccess(_D)
...
fsMplsRsvpTeGenPduDumpMsgType=_FsMplsRsvpTeGenPduDumpMsgType_Object((1,3,6,1,4,1,10876,101,1,13,2,2,17),_FsMplsRsvpTeGenPduDumpMsgType_Type())
fsMplsRsvpTeGenPduDumpMsgType.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMplsRsvpTeGenPduDumpMsgType.setStatus(_A)
class _FsMplsRsvpTeGenPduDumpDirection_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3)));namedValues=NamedValues(*((_Q,0),('in',1),('out',2),('inout',3)))
_FsMplsRsvpTeGenPduDumpDirection_Type.__name__=_C
_FsMplsRsvpTeGenPduDumpDirection_Object=MibScalar
fsMplsRsvpTeGenPduDumpDirection=_FsMplsRsvpTeGenPduDumpDirection_Object((1,3,6,1,4,1,10876,101,1,13,2,2,18),_FsMplsRsvpTeGenPduDumpDirection_Type())
fsMplsRsvpTeGenPduDumpDirection.setMaxAccess(_D)
...
_FsMplsRsvpTeOperStatus_Type.__name__=_C
_FsMplsRsvpTeOperStatus_Object=MibScalar
fsMplsRsvpTeOperStatus=_FsMplsRsvpTeOperStatus_Object((1,3,6,1,4,1,10876,101,1,13,2,2,19),_FsMplsRsvpTeOperStatus_Type())
fsMplsRsvpTeOperStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMplsRsvpTeOperStatus.setStatus(_A)
class _FsMplsRsvpTeOverRideOption_Type(TruthValue):defaultValue=2
_FsMplsRsvpTeOverRideOption_Type.__name__=_G
_FsMplsRsvpTeOverRideOption_Object=MibScalar
fsMplsRsvpTeOverRideOption=_FsMplsRsvpTeOverRideOption_Object((1,3,6,1,4,1,10876,101,1,13,2,2,20),_FsMplsRsvpTeOverRideOption_Type())
fsMplsRsvpTeOverRideOption.setMaxAccess(_D)
...
fsMplsRsvpTeMinTnlsWithMsgId=_FsMplsRsvpTeMinTnlsWithMsgId_Object((1,3,6,1,4,1,10876,101,1,13,2,2,21),_FsMplsRsvpTeMinTnlsWithMsgId_Type())
fsMplsRsvpTeMinTnlsWithMsgId.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMplsRsvpTeMinTnlsWithMsgId.setStatus(_A)
class _FsMplsRsvpTeNotificationEnabled_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_R,1),(_S,2)))
_FsMplsRsvpTeNotificationEnabled_Type.__name__=_C
_FsMplsRsvpTeNotificationEnabled_Object=MibScalar
fsMplsRsvpTeNotificationEnabled=_FsMplsRsvpTeNotificationEnabled_Object((1,3,6,1,4,1,10876,101,1,13,2,2,22),_FsMplsRsvpTeNotificationEnabled_Type())
fsMplsRsvpTeNotificationEnabled.setMaxAccess(_D)
...
fsMplsRsvpTeNotifyMsgRetransmitIntvl=_FsMplsRsvpTeNotifyMsgRetransmitIntvl_Object((1,3,6,1,4,1,10876,101,1,13,2,2,23),_FsMplsRsvpTeNotifyMsgRetransmitIntvl_Type())
fsMplsRsvpTeNotifyMsgRetransmitIntvl.setMaxAccess(_D)
...
fsMplsRsvpTeNotifyMsgRetransmitDecay=_FsMplsRsvpTeNotifyMsgRetransmitDecay_Object((1,3,6,1,4,1,10876,101,1,13,2,2,24),_FsMplsRsvpTeNotifyMsgRetransmitDecay_Type())
fsMplsRsvpTeNotifyMsgRetransmitDecay.setMaxAccess(_D)
...
fsMplsRsvpTeNotifyMsgRetransmitLimit=_FsMplsRsvpTeNotifyMsgRetransmitLimit_Object((1,3,6,1,4,1,10876,101,1,13,2,2,25),_FsMplsRsvpTeNotifyMsgRetransmitLimit_Type())
fsMplsRsvpTeNotifyMsgRetransmitLimit.setMaxAccess(_D)
...
fsMplsRsvpTeAdminStatusTimeIntvl=_FsMplsRsvpTeAdminStatusTimeIntvl_Object((1,3,6,1,4,1,10876,101,1,13,2,2,26),_FsMplsRsvpTeAdminStatusTimeIntvl_Type())
fsMplsRsvpTeAdminStatusTimeIntvl.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMplsRsvpTeAdminStatusTimeIntvl.setStatus(_A)
class _FsMplsRsvpTePathStateRemovedSupport_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_R,1),(_S,2)))
_FsMplsRsvpTePathStateRemovedSupport_Type.__name__=_C
_FsMplsRsvpTePathStateRemovedSupport_Object=MibScalar
fsMplsRsvpTePathStateRemovedSupport=_FsMplsRsvpTePathStateRemovedSupport_Object((1,3,6,1,4,1,10876,101,1,13,2,2,27),_FsMplsRsvpTePathStateRemovedSupport_Type())
fsMplsRsvpTePathStateRemovedSupport.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMplsRsvpTePathStateRemovedSupport.setStatus(_A)
class _FsMplsRsvpTeLabelSetEnabled_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_R,1),(_S,2)))
_FsMplsRsvpTeLabelSetEnabled_Type.__name__=_C
_FsMplsRsvpTeLabelSetEnabled_Object=MibScalar
fsMplsRsvpTeLabelSetEnabled=_FsMplsRsvpTeLabelSetEnabled_Object((1,3,6,1,4,1,10876,101,1,13,2,2,28),_FsMplsRsvpTeLabelSetEnabled_Type())
fsMplsRsvpTeLabelSetEnabled.setMaxAccess(_D)
...
_FsMplsRsvpTeAdminStatusCapability_Type.__name__=_C
_FsMplsRsvpTeAdminStatusCapability_Object=MibScalar
fsMplsRsvpTeAdminStatusCapability=_FsMplsRsvpTeAdminStatusCapability_Object((1,3,6,1,4,1,10876,101,1,13,2,2,29),_FsMplsRsvpTeAdminStatusCapability_Type())
fsMplsRsvpTeAdminStatusCapability.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMplsRsvpTeAdminStatusCapability.setStatus(_A)
class _FsMplsRsvpTeGrCapability_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_Q,1),('full',2),('helper',3)))
_FsMplsRsvpTeGrCapability_Type.__name__=_C
_FsMplsRsvpTeGrCapability_Object=MibScalar
fsMplsRsvpTeGrCapability=_FsMplsRsvpTeGrCapability_Object((1,3,6,1,4,1,10876,101,1,13,2,2,30),_FsMplsRsvpTeGrCapability_Type())
fsMplsRsvpTeGrCapability.setMaxAccess(_D)
if mibBuilder.loadTexts:fsMplsRsvpTeGrCapability.setStatus(_A)
class _FsMplsRsvpTeGrRecoveryPathCapability_Type(Bits):defaultHexValue='';namedValues=NamedValues(*((_W,0),(_X,1),(_Y,2)))
_FsMplsRsvpTeGrRecoveryPathCapability_Type.__name__=_K
_FsMplsRsvpTeGrRecoveryPathCapability_Object=MibScalar
fsMplsRsvpTeGrRecoveryPathCapability=_FsMplsRsvpTeGrRecoveryPathCapability_Object((1,3,6,1,4,1,10876,101,1,13,2,2,31),_FsMplsRsvpTeGrRecoveryPathCapability_Type())
fsMplsRsvpTeGrRecoveryPathCapability.setMaxAccess(_D)
...
_FsMplsRsvpTeGrRestartTime_Type.__name__=_C
_FsMplsRsvpTeGrRestartTime_Object=MibScalar
fsMplsRsvpTeGrRestartTime=_FsMplsRsvpTeGrRestartTime_Object((1,3,6,1,4,1,10876,101,1,13,2,2,32),_FsMplsRsvpTeGrRestartTime_Type())
fsMplsRsvpTeGrRestartTime.setMaxAccess(_D)
...
_FsMplsRsvpTeGrRecoveryTime_Type.__name__=_C
_FsMplsRsvpTeGrRecoveryTime_Object=MibScalar
fsMplsRsvpTeGrRecoveryTime=_FsMplsRsvpTeGrRecoveryTime_Object((1,3,6,1,4,1,10876,101,1,13,2,2,33),_FsMplsRsvpTeGrRecoveryTime_Type())
fsMplsRsvpTeGrRecoveryTime.setMaxAccess(_D)
