...
# Notes
# -----
# ASN.1 source file://mibs/cisco/EXPRESSION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:41:56 2025
...
class _ExpExpressionComment_Type(DisplayString):
    """Custom type expExpressionComment based on DisplayString"""
    defaultValue = OctetString("")


_ExpExpressionComment_Type.__name__ = "DisplayString"
...
_ExpObjectIDWildcard_Type.__name__ = "TruthValue"
...
_ExpObjectDeltaDiscontinuityID_Type.__name__ = "ObjectIdentifier"
...
_ExpObjectDiscontinuityIDWildcard_Type.__name__ = "TruthValue"
...
_ExpObjectConditional_Type.__name__ = "ObjectIdentifier"
...
_ExpObjectConditionalWildcard_Type.__name__ = "TruthValue"
...
expressionMIBCompliance.setObjects(
      *(("EXPRESSION-MIB", "expressionResourceGroup"),
        ("EXPRESSION-MIB", "expressionDefinitionGroup"),
        ("EXPRESSION-MIB", "expressionValueGroup"))
)
if mibBuilder.loadTexts:
