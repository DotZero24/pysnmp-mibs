...
mibBuilder.exportSymbols("SOCOMECUPS-MIB", upsTestId=upsTestId, upsAlarmOutputOverload=upsAlarmOutputOverload, network=network, upsWellKnownTests=upsWellKnownTests, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsControlEcoModeStartTime=upsControlEcoModeStartTime, upsTrapEmdTempNotHigh=upsTrapEmdTempNotHigh, upsControlSpecialShutdownDay=upsControlSpecialShutdownDay, upsInputVoltageMax=upsInputVoltageMax, upsDevicesTable=upsDevicesTable, upsAlarmPeriodicServiceCheck=upsAlarmPeriodicServiceCheck, upsAlarmOutputOver=upsAlarmOutputOver, upsControlWeeklyRestartDay=upsControlWeeklyRestartDay, upsTrapEmdTempNotLow=upsTrapEmdTempNotLow, upsTrapEmdSecondInputRestored=upsTrapEmdSecondInputRestored, upsOutput=upsOutput, upsTrapEmdTempLow=upsTrapEmdTempLow, upsAlarmBatteryCircuitOpen=upsAlarmBatteryCircuitOpen, upsAgentDhcpStatus=upsAgentDhcpStatus, timeOfConnection=timeOfConnection, upsAlarmTable=upsAlarmTable, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsControlEcoModeIndex=upsControlEcoModeIndex, upsAlarmRecRedundancy=upsAlarmRecRedundancy, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTrapUpsNormal=upsTrapUpsNormal, upsBatteryVoltage=upsBatteryVoltage, upsAlarmAutoTransferDisabled=upsAlarmAutoTransferDisabled, upsInputVoltage=upsInputVoltage, upsOutputCurrent=upsOutputCurrent, upsTrapOnBatteryPower=upsTrapOnBatteryPower, upsOutputKva=upsOutputKva, upsAlarmPhaseRotationFault=upsAlarmPhaseRotationFault, upsAgentTelnetStatus=upsAgentTelnetStatus, upsAlarmBatteryGeneralAlarm=upsAlarmBatteryGeneralAlarm, upsTrapRedoundancyLost=upsTrapRedoundancyLost, upsControlSpecialScheduleTable=upsControlSpecialScheduleTable, upsAlarmModule8Alarm=upsAlarmModule8Alarm, upsAlarmModule6Alarm=upsAlarmModule6Alarm, upsControlEventStatus=upsControlEventStatus, accessCommunityString=accessCommunityString, upsControlSpecialIndex=upsControlSpecialIndex, upsAlarmTime=upsAlarmTime, upsAlarmA63=upsAlarmA63, upsAlarmShortCircuit=upsAlarmShortCircuit, upsControlWeeklyIndex=upsControlWeeklyIndex, upsAlarmBatteryTemperature=upsAlarmBatteryTemperature, severityOfConnection=severityOfConnection, upsControlStatusControl=upsControlStatusControl, upsAlarmShutdownPending=upsAlarmShutdownPending, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsControlSpecialRestartTime=upsControlSpecialRestartTime, upsTrapEmdHumidityLow=upsTrapEmdHumidityLow, upsIdentModel=upsIdentModel, upsAlarmGenSetGeneral=upsAlarmGenSetGeneral, upsAlarmImproperCondition=upsAlarmImproperCondition, upsAlarmModule2Alarm=upsAlarmModule2Alarm, upsAlarmTempBad=upsAlarmTempBad, upsAgentAccessControlTable=upsAgentAccessControlTable, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigInputVoltage=upsConfigInputVoltage, emdStatus=emdStatus, upsAgentResetToDefault=upsAgentResetToDefault, upsAgentTime=upsAgentTime, upsAgentNtpTimeZone=upsAgentNtpTimeZone, upsAlarmInsufficientResources=upsAlarmInsufficientResources, upsOutputLineIndex=upsOutputLineIndex, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsControlEcoModeScheduleTable=upsControlEcoModeScheduleTable, upsAlarmPowerSupplyFault=upsAlarmPowerSupplyFault, upsTest=upsTest, upsBypassEntry=upsBypassEntry, upsAgentMibVersion=upsAgentMibVersion, upsIdentUPSFirmwareVersion=upsIdentUPSFirmwareVersion, upsInputNumLines=upsInputNumLines, upsTrapEmdTempHigh=upsTrapEmdTempHigh, emdSatatusHumidity=emdSatatusHumidity, upsControlWeeklyScheduleEntry=upsControlWeeklyScheduleEntry, upsAlarmAuxMainFail=upsAlarmAuxMainFail, upsAlarmExternalAlarm3=upsAlarmExternalAlarm3, upsControlWeeklyRestartTime=upsControlWeeklyRestartTime, upsAgentClearAgentLog=upsAgentClearAgentLog, upsAgent=upsAgent, upsAlarmModule4Alarm=upsAlarmModule4Alarm, indexOfDevice=indexOfDevice, upsAlarmInverterOverCurrent=upsAlarmInverterOverCurrent, accessControlMode=accessControlMode, upsAlarmControlSystemFailure=upsAlarmControlSystemFailure, upsAlarmManualBypass=upsAlarmManualBypass, upsOutputSource=upsOutputSource, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsDevicesEntry=upsDevicesEntry, receiverNmstype=receiverNmstype, upsAlarmExternalAlarm1=upsAlarmExternalAlarm1, upsAlarmInputBad=upsAlarmInputBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestResultsSummary=upsTestResultsSummary, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestNoTestsInitiated=upsTestNoTestsInitiated, NonNegativeInteger=NonNegativeInteger, upsTrapOverTemperature=upsTrapOverTemperature, upsAgentExtHistoryLogFrequency=upsAgentExtHistoryLogFrequency, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmEmergencyStopActive=upsAlarmEmergencyStopActive, upsTrapOverload=upsTrapOverload, upsControlEcoModeStartDay=upsControlEcoModeStartDay, upsAlarmModule3Alarm=upsAlarmModule3Alarm, upsIdent=upsIdent, upsAlarmGenSetFault=upsAlarmGenSetFault, upsTraps=upsTraps, upsAlarmAllTransferDisabled=upsAlarmAllTransferDisabled, upsShutdownDelay=upsShutdownDelay, upsAlarmParallelModuleFault=upsAlarmParallelModuleFault, upsControlSpecialScheduleEntry=upsControlSpecialScheduleEntry, upsAlarmModule7Alarm=upsAlarmModule7Alarm, upsAlarmImminentStop=upsAlarmImminentStop, upsInputTable=upsInputTable, software=software, upsAlarmId=upsAlarmId, upsAlarmExternalAlarm2=upsAlarmExternalAlarm2, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigInputFreq=upsConfigInputFreq, upsControlWeeklyScheduleTable=upsControlWeeklyScheduleTable, upsTestElapsedTime=upsTestElapsedTime, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmInverterDistorsion=upsAlarmInverterDistorsion, upsAlarmBatteryRoom=upsAlarmBatteryRoom, upsTestStartTime=upsTestStartTime, upsBypassNumLines=upsBypassNumLines, upsAlarmPrechargeVoltageFail=upsAlarmPrechargeVoltageFail, upsControlDelay=upsControlDelay, upsAlarmOutputUnder=upsAlarmOutputUnder, upsBypassTable=upsBypassTable, upsControlWarningInterval=upsControlWarningInterval, upsAgentTrapsReceiversTable=upsAgentTrapsReceiversTable, upsAlarmOnBypass=upsAlarmOnBypass, upsAgentClearHistoryLog=upsAgentClearHistoryLog, upsBatteryTemperature=upsBatteryTemperature, upsDeepBatteryCalibration=upsDeepBatteryCalibration, upsControlEcoModeEndDay=upsControlEcoModeEndDay, upsBypass=upsBypass, upsAlarmBoostTooLow=upsAlarmBoostTooLow, upsAgentClearExtHistoryLog=upsAgentClearExtHistoryLog, upsAgentSubnetMask=upsAgentSubnetMask, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputEntry=upsInputEntry, upsAlarmOptionalBoards=upsAlarmOptionalBoards, trapsReceiverAddr=trapsReceiverAddr, upsIdentUpsSerialNumber=upsIdentUpsSerialNumber, upsAlarmStopForOverload=upsAlarmStopForOverload, upsAgentAccessControlEntry=upsAgentAccessControlEntry, upsAlarmBatteryDischarged=upsAlarmBatteryDischarged, upsBypassLineIndex=upsBypassLineIndex, upsBypassCurrent=upsBypassCurrent, upsConfig=upsConfig, upsAgentTftpStatus=upsAgentTftpStatus, upsAgentRestart=upsAgentRestart, upsControlShutdownParametersTable=upsControlShutdownParametersTable, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmInvRedundancy=upsAlarmInvRedundancy, upsControlSpecialShutdownTime=upsControlSpecialShutdownTime, upsTrapOnMains=upsTrapOnMains, upsTrapEmdSecondInputActive=upsTrapEmdSecondInputActive, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmBypassFault=upsAlarmBypassFault, addrOfDevice=addrOfDevice, upsAlarmRedundancyLost=upsAlarmRedundancyLost, accessControlAddr=accessControlAddr, upsAlarmExtDes=upsAlarmExtDes, upsControlEventDescr=upsControlEventDescr, upsTestSpinLock=upsTestSpinLock, upsOutputTable=upsOutputTable, upsOutputFrequency=upsOutputFrequency, upsAlarmDataCorrupted=upsAlarmDataCorrupted, upsInputFrequency=upsInputFrequency, upsAlarmOnBattery=upsAlarmOnBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, statusOfConnection=statusOfConnection, upsObjects=upsObjects, upsAlarmBoostTooHigh=upsAlarmBoostTooHigh, upsOutputNumLines=upsOutputNumLines, upsAgentNtpTimeServer=upsAgentNtpTimeServer, upsBatteryStatus=upsBatteryStatus, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmFuseFailure=upsAlarmFuseFailure, upsControlSpecialRestartDay=upsControlSpecialRestartDay, accessIndex=accessIndex, upsTrapEmdHumidityHigh=upsTrapEmdHumidityHigh, upsAlarmModule5Alarm=upsAlarmModule5Alarm, upsTrapPowerRestored=upsTrapPowerRestored, socomecSicon=socomecSicon, upsAlarmDescr=upsAlarmDescr, upsAgentTrapString=upsAgentTrapString, upsTrapImminentStop=upsTrapImminentStop, upsOutputEntry=upsOutputEntry, upsAlarmCommunicationLost=upsAlarmCommunicationLost, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInput=upsInput, upsControlEcoModeScheduleEntry=upsControlEcoModeScheduleEntry, upsTrapOnBattery=upsTrapOnBattery, upsTrapUpsBattTestFailed=upsTrapUpsBattTestFailed, upsWellKnownAlarms=upsWellKnownAlarms, upsAgentTrapsReceiversEntry=upsAgentTrapsReceiversEntry, upsAlarmRectifierGeneralAlarm=upsAlarmRectifierGeneralAlarm, upsControlWeeklyShutdownTime=upsControlWeeklyShutdownTime, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTrapEmdHumidityNotHigh=upsTrapEmdHumidityNotHigh, upsBypassVoltage=upsBypassVoltage, upsAlarmPllFault=upsAlarmPllFault, upsInputLineIndex=upsInputLineIndex, upsInputCurrent=upsInputCurrent, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmOverloadTimeout=upsAlarmOverloadTimeout, upsAlarmBypassGeneralAlarm=upsAlarmBypassGeneralAlarm, upsBypassFrequency=upsBypassFrequency, upsAlarmBatteryTooHigh=upsAlarmBatteryTooHigh, upsTurnOffAfterShutdown=upsTurnOffAfterShutdown, upsAlarmInverterFault=upsAlarmInverterFault, upsAlarmRectifierFault=upsAlarmRectifierFault, upsConfigOutputFreq=upsConfigOutputFreq, upsControlFirstWarning=upsControlFirstWarning, upsOutputVoltage=upsOutputVoltage, nameOfDevice=nameOfDevice, upsAgentIpaddress=upsAgentIpaddress, upsTrapEmdHumidityNotLow=upsTrapEmdHumidityNotLow, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTrapBatteryLow=upsTrapBatteryLow, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmBatteryChargerFailure=upsAlarmBatteryChargerFailure, upsAlarmEntry=upsAlarmEntry, upsAlarmInputGeneralAlarm=upsAlarmInputGeneralAlarm, upsInputVoltageMin=upsInputVoltageMin, upsAlarmBoostFault=upsAlarmBoostFault, upsBattery=upsBattery, upsAlarmInverterGeneralAlarm=upsAlarmInverterGeneralAlarm, emdSatatusTemperature=emdSatatusTemperature, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmExternalAlarm4=upsAlarmExternalAlarm4, receiverCommunityString=receiverCommunityString, upsTrapTurnedOff=upsTrapTurnedOff, upsAlarmShutdownImminent=upsAlarmShutdownImminent, netvision=netvision, upsControl=upsControl, upsAlarmBoostGeneralAlarm=upsAlarmBoostGeneralAlarm, upsAlarmManualBypassClose=upsAlarmManualBypassClose, shutdownParametersEntry=shutdownParametersEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmFansFailure=upsAlarmFansFailure, upsTestResultsDetail=upsTestResultsDetail, upsControlEcoModeEndTime=upsControlEcoModeEndTime, upsAlarm=upsAlarm)
mibBuilder.exportSymbols("SOCOMECUPS-MIB", upsAgentDate=upsAgentDate, upsAgentHistoryLogFrequency=upsAgentHistoryLogFrequency, PositiveInteger=PositiveInteger, upsAgentBaudRate=upsAgentBaudRate, upsTrapEmdFirstInputRestored=upsTrapEmdFirstInputRestored, upsAgentGateway=upsAgentGateway, upsAlarmEService=upsAlarmEService, trapsIndex=trapsIndex, upsAlarmModule1Alarm=upsAlarmModule1Alarm, upsAgentPollRate=upsAgentPollRate, upsControlWeeklyShutdownDay=upsControlWeeklyShutdownDay, upsAgentClearEventLog=upsAgentClearEventLog, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapEmdFirstInputActive=upsTrapEmdFirstInputActive)
