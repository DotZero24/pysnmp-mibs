...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/socomec/SOCOMECUPS-MIB
...
upsBatteryStatus = MibScalar((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 2, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(("unknown", 1), ("batteryNormal", 2), ("batteryLow", 3), ("batteryDepleted", 4), ("batteryDischarging", 5), ("batteryFailure", 6), ("batteryDisconnected", 7)))).setMaxAccess("readonly")
...
upsAlarmBypassFault = MibScalar((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 6, 3, 81), Integer32()).setMaxAccess("readonly")
...
upsAlarmModule7Alarm = MibScalar((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 6, 3, 83), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: upsAlarmModule7Alarm.setStatus('mandatory')
upsAlarmModule8Alarm = MibScalar((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 6, 3, 84), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: upsAlarmModule8Alarm.setStatus('mandatory')
upsAlarmBatteryTemperature = MibScalar((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 6, 3, 85), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: upsAlarmBatteryTemperature.setStatus('mandatory')
upsAlarmRecRedundancy = MibScalar((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 6, 3, 86), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: upsAlarmRecRedundancy.setStatus('mandatory')
upsAlarmInvRedundancy = MibScalar((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 6, 3, 87), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: upsAlarmInvRedundancy.setStatus('mandatory')
...
receiverNmstype = MibTableColumn((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 10, 21, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("none", 1), ("netVision-trap", 2), ("rfc1628-trap", 3)))).setMaxAccess("readwrite")
...
upsTrapEmdTempNotLow = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,17)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdTempHigh = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,18)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdTempNotHigh = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,19)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdHumidityLow = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,20)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdHumidityNotLow = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,21)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdHumidityHigh = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,22)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdHumidityNotHigh = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,23)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdFirstInputActive = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,24)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdFirstInputRestored = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,25)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdSecondInputActive = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,26)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
upsTrapEmdSecondInputRestored = NotificationType((1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 2) + (0,27)).setObjects(("SOCOMECUPS-MIB", "upsAgentTrapString"))
mibBuilder.exportSymbols("SOCOMECUPS-MIB", upsAgentTrapsReceiversEntry=upsAgentTrapsReceiversEntry, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassVoltage=upsBypassVoltage, upsAgentTime=upsAgentTime, upsInput=upsInput, upsAlarmManualBypass=upsAlarmManualBypass, upsAlarmOptionalBoards=upsAlarmOptionalBoards, upsControl=upsControl, upsAlarmBypassBad=upsAlarmBypassBad, PositiveInteger=PositiveInteger, upsControlSpecialScheduleEntry=upsControlSpecialScheduleEntry, upsControlSpecialRestartDay=upsControlSpecialRestartDay, upsAlarmBypassFault=upsAlarmBypassFault, upsBattery=upsBattery, upsAlarmTime=upsAlarmTime, upsTurnOffAfterShutdown=upsTurnOffAfterShutdown, upsAgentRestart=upsAgentRestart, upsBatteryVoltage=upsBatteryVoltage, upsAlarmInputBad=upsAlarmInputBad, upsSecondsOnBattery=upsSecondsOnBattery, upsAgentGateway=upsAgentGateway, upsTrapOnBattery=upsTrapOnBattery, upsIdent=upsIdent, upsBatteryStatus=upsBatteryStatus, upsControlEventDescr=upsControlEventDescr, timeOfConnection=timeOfConnection, accessCommunityString=accessCommunityString, upsDevicesEntry=upsDevicesEntry, upsTrapEmdSecondInputActive=upsTrapEmdSecondInputActive, upsTestStartTime=upsTestStartTime, upsOutputVoltage=upsOutputVoltage, upsControlSpecialScheduleTable=upsControlSpecialScheduleTable, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmModule5Alarm=upsAlarmModule5Alarm, upsControlEcoModeStartDay=upsControlEcoModeStartDay, statusOfConnection=statusOfConnection, upsBypass=upsBypass, upsAlarmModule7Alarm=upsAlarmModule7Alarm, upsAlarmFuseFailure=upsAlarmFuseFailure, upsControlSpecialRestartTime=upsControlSpecialRestartTime, upsAgentTrapsReceiversTable=upsAgentTrapsReceiversTable, NonNegativeInteger=NonNegativeInteger, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmOutputUnder=upsAlarmOutputUnder, upsTrapEmdHumidityHigh=upsTrapEmdHumidityHigh, upsTrapUpsNormal=upsTrapUpsNormal, upsWellKnownTests=upsWellKnownTests, upsAlarmEmergencyStopActive=upsAlarmEmergencyStopActive, upsInputVoltage=upsInputVoltage, upsBypassLineIndex=upsBypassLineIndex, socomecSicon=socomecSicon, upsAlarmGenSetGeneral=upsAlarmGenSetGeneral, nameOfDevice=nameOfDevice, receiverNmstype=receiverNmstype, upsControlWeeklyScheduleTable=upsControlWeeklyScheduleTable, upsTrapOnBatteryPower=upsTrapOnBatteryPower, upsOutput=upsOutput, upsAlarmPrechargeVoltageFail=upsAlarmPrechargeVoltageFail, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmEService=upsAlarmEService, upsAlarmModule8Alarm=upsAlarmModule8Alarm, upsAlarmModule4Alarm=upsAlarmModule4Alarm, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAgentAccessControlTable=upsAgentAccessControlTable, upsAlarmAuxMainFail=upsAlarmAuxMainFail, upsAlarmExtDes=upsAlarmExtDes, upsBypassCurrent=upsBypassCurrent, upsTrapEmdHumidityNotLow=upsTrapEmdHumidityNotLow, receiverCommunityString=receiverCommunityString, upsAlarmBatteryTooHigh=upsAlarmBatteryTooHigh, upsControlEcoModeIndex=upsControlEcoModeIndex, upsTrapEmdTempHigh=upsTrapEmdTempHigh, upsOutputEntry=upsOutputEntry, upsAgentSubnetMask=upsAgentSubnetMask, emdStatus=emdStatus, upsShutdownDelay=upsShutdownDelay, upsAgent=upsAgent, upsInputTable=upsInputTable, upsControlShutdownParametersTable=upsControlShutdownParametersTable, upsDevicesTable=upsDevicesTable, upsAgentMibVersion=upsAgentMibVersion, upsIdentUPSFirmwareVersion=upsIdentUPSFirmwareVersion, upsAlarmRectifierGeneralAlarm=upsAlarmRectifierGeneralAlarm, upsTestResultsSummary=upsTestResultsSummary, upsOutputTable=upsOutputTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTrapRedoundancyLost=upsTrapRedoundancyLost, upsAlarmBatteryCircuitOpen=upsAlarmBatteryCircuitOpen, upsControlWeeklyIndex=upsControlWeeklyIndex, software=software, upsTestQuickBatteryTest=upsTestQuickBatteryTest, trapsIndex=trapsIndex, upsTrapEmdTempNotHigh=upsTrapEmdTempNotHigh, upsOutputLineIndex=upsOutputLineIndex, upsAlarmA63=upsAlarmA63, upsInputCurrent=upsInputCurrent, upsAgentTelnetStatus=upsAgentTelnetStatus, upsAgentClearAgentLog=upsAgentClearAgentLog, upsAlarmBoostTooLow=upsAlarmBoostTooLow, upsAgentHistoryLogFrequency=upsAgentHistoryLogFrequency, upsTrapEmdTempNotLow=upsTrapEmdTempNotLow, upsAlarmBoostGeneralAlarm=upsAlarmBoostGeneralAlarm, upsTrapOnMains=upsTrapOnMains, upsControlSpecialIndex=upsControlSpecialIndex, upsInputFrequency=upsInputFrequency, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassFrequency=upsBypassFrequency, upsAlarmLowBattery=upsAlarmLowBattery, upsAgentExtHistoryLogFrequency=upsAgentExtHistoryLogFrequency, upsAlarm=upsAlarm, upsControlEcoModeScheduleTable=upsControlEcoModeScheduleTable, upsControlEcoModeScheduleEntry=upsControlEcoModeScheduleEntry, upsOutputCurrent=upsOutputCurrent, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsControlEcoModeStartTime=upsControlEcoModeStartTime, upsAlarmInverterGeneralAlarm=upsAlarmInverterGeneralAlarm, upsTestElapsedTime=upsTestElapsedTime, upsControlWarningInterval=upsControlWarningInterval, upsAgentIpaddress=upsAgentIpaddress, trapsReceiverAddr=trapsReceiverAddr, upsControlWeeklyShutdownTime=upsControlWeeklyShutdownTime, emdSatatusHumidity=emdSatatusHumidity, upsAlarmOutputOver=upsAlarmOutputOver, upsAlarmRecRedundancy=upsAlarmRecRedundancy, upsAlarmShortCircuit=upsAlarmShortCircuit, upsOutputFrequency=upsOutputFrequency, upsAlarmBoostFault=upsAlarmBoostFault, upsAlarmModule1Alarm=upsAlarmModule1Alarm, upsAlarmOverloadTimeout=upsAlarmOverloadTimeout, upsAlarmEntry=upsAlarmEntry, upsInputVoltageMax=upsInputVoltageMax, accessControlAddr=accessControlAddr, upsAlarmModule3Alarm=upsAlarmModule3Alarm, upsControlSpecialShutdownDay=upsControlSpecialShutdownDay, upsTest=upsTest, upsAgentResetToDefault=upsAgentResetToDefault, upsAlarmPhaseRotationFault=upsAlarmPhaseRotationFault, upsTrapOverTemperature=upsTrapOverTemperature, upsObjects=upsObjects, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapEmdHumidityLow=upsTrapEmdHumidityLow, severityOfConnection=severityOfConnection, upsControlWeeklyScheduleEntry=upsControlWeeklyScheduleEntry, upsAlarmRectifierFault=upsAlarmRectifierFault, upsInputEntry=upsInputEntry, upsAlarmExternalAlarm2=upsAlarmExternalAlarm2, upsTrapEmdHumidityNotHigh=upsTrapEmdHumidityNotHigh, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOnBypass=upsAlarmOnBypass, upsAgentDate=upsAgentDate, upsAgentNtpTimeServer=upsAgentNtpTimeServer, upsOutputNumLines=upsOutputNumLines, upsBypassTable=upsBypassTable, upsOutputSource=upsOutputSource, network=network, upsBypassEntry=upsBypassEntry, upsAlarmAllTransferDisabled=upsAlarmAllTransferDisabled, shutdownParametersEntry=shutdownParametersEntry, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmBoostTooHigh=upsAlarmBoostTooHigh, upsBatteryTemperature=upsBatteryTemperature, upsControlWeeklyShutdownDay=upsControlWeeklyShutdownDay, upsAlarmGenSetFault=upsAlarmGenSetFault, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTrapPowerRestored=upsTrapPowerRestored, upsInputVoltageMin=upsInputVoltageMin, upsAlarmBatteryGeneralAlarm=upsAlarmBatteryGeneralAlarm, upsTrapEmdFirstInputActive=upsTrapEmdFirstInputActive, upsAlarmInverterFault=upsAlarmInverterFault, upsAlarmStopForOverload=upsAlarmStopForOverload, upsAlarmParallelModuleFault=upsAlarmParallelModuleFault, upsAlarmModule6Alarm=upsAlarmModule6Alarm, upsDeepBatteryCalibration=upsDeepBatteryCalibration, upsTestSpinLock=upsTestSpinLock, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAgentClearEventLog=upsAgentClearEventLog, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmModule2Alarm=upsAlarmModule2Alarm, upsAgentAccessControlEntry=upsAgentAccessControlEntry, upsAgentClearExtHistoryLog=upsAgentClearExtHistoryLog, upsTrapTurnedOff=upsTrapTurnedOff, upsAlarmBatteryTemperature=upsAlarmBatteryTemperature, upsAlarmId=upsAlarmId, upsAlarmBatteryChargerFailure=upsAlarmBatteryChargerFailure, upsControlSpecialShutdownTime=upsControlSpecialShutdownTime, upsIdentUpsSerialNumber=upsIdentUpsSerialNumber, upsTraps=upsTraps, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmTempBad=upsAlarmTempBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAgentTftpStatus=upsAgentTftpStatus, upsTrapImminentStop=upsTrapImminentStop, emdSatatusTemperature=emdSatatusTemperature, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmPowerSupplyFault=upsAlarmPowerSupplyFault, upsAlarmOnBattery=upsAlarmOnBattery, accessIndex=accessIndex, upsAlarmBatteryRoom=upsAlarmBatteryRoom, upsControlFirstWarning=upsControlFirstWarning, upsInputNumLines=upsInputNumLines, upsAlarmInverterOverCurrent=upsAlarmInverterOverCurrent, upsAlarmImminentStop=upsAlarmImminentStop, upsIdentModel=upsIdentModel, upsAgentDhcpStatus=upsAgentDhcpStatus, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmPeriodicServiceCheck=upsAlarmPeriodicServiceCheck, upsAlarmExternalAlarm3=upsAlarmExternalAlarm3, upsAlarmFanFailure=upsAlarmFanFailure, upsTrapUpsBattTestFailed=upsTrapUpsBattTestFailed, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAgentClearHistoryLog=upsAgentClearHistoryLog, upsAlarmFansFailure=upsAlarmFansFailure, upsAlarmExternalAlarm4=upsAlarmExternalAlarm4, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassNumLines=upsBypassNumLines, upsAlarmTable=upsAlarmTable, upsAlarmInputGeneralAlarm=upsAlarmInputGeneralAlarm, upsInputLineIndex=upsInputLineIndex, upsControlDelay=upsControlDelay, accessControlMode=accessControlMode, upsAlarmsPresent=upsAlarmsPresent, upsAlarmExternalAlarm1=upsAlarmExternalAlarm1, upsTrapEmdFirstInputRestored=upsTrapEmdFirstInputRestored, upsAlarmTestInProgress=upsAlarmTestInProgress, upsControlStatusControl=upsControlStatusControl, upsAlarmImproperCondition=upsAlarmImproperCondition, upsAlarmBatteryDischarged=upsAlarmBatteryDischarged, upsControlEcoModeEndTime=upsControlEcoModeEndTime, upsAlarmDataCorrupted=upsAlarmDataCorrupted, upsAgentPollRate=upsAgentPollRate, upsAlarmManualBypassClose=upsAlarmManualBypassClose, upsAlarmInsufficientResources=upsAlarmInsufficientResources, upsControlWeeklyRestartTime=upsControlWeeklyRestartTime, upsAgentTrapString=upsAgentTrapString, upsTrapEmdTempLow=upsTrapEmdTempLow, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputKva=upsOutputKva, upsAlarmInverterDistorsion=upsAlarmInverterDistorsion, upsAlarmAutoTransferDisabled=upsAlarmAutoTransferDisabled, upsControlEcoModeEndDay=upsControlEcoModeEndDay, upsAlarmInvRedundancy=upsAlarmInvRedundancy, upsTestResultsDetail=upsTestResultsDetail, upsControlWeeklyRestartDay=upsControlWeeklyRestartDay, addrOfDevice=addrOfDevice, upsControlEventStatus=upsControlEventStatus, upsAlarmDescr=upsAlarmDescr, indexOfDevice=indexOfDevice, upsTrapOverload=upsTrapOverload, upsAlarmCommunicationLost=upsAlarmCommunicationLost)
mibBuilder.exportSymbols("SOCOMECUPS-MIB", upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmPllFault=upsAlarmPllFault, upsTrapBatteryLow=upsTrapBatteryLow, upsAlarmRedundancyLost=upsAlarmRedundancyLost, upsTestId=upsTestId, upsConfig=upsConfig, upsTrapTestCompleted=upsTrapTestCompleted, upsAgentNtpTimeZone=upsAgentNtpTimeZone, netvision=netvision, upsAlarmBypassGeneralAlarm=upsAlarmBypassGeneralAlarm, upsConfigInputFreq=upsConfigInputFreq, upsTrapEmdSecondInputRestored=upsTrapEmdSecondInputRestored, upsAgentBaudRate=upsAgentBaudRate, upsAlarmControlSystemFailure=upsAlarmControlSystemFailure)
