...
upsAlarmRecRedundancy = _UpsAlarmRecRedundancy_Object(
    (1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 6, 3, 86),
    _UpsAlarmRecRedundancy_Type()
)
upsAlarmRecRedundancy.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    upsAlarmRecRedundancy.setStatus("mandatory")
_UpsAlarmInvRedundancy_Type = Integer32
_UpsAlarmInvRedundancy_Object = MibScalar
upsAlarmInvRedundancy = _UpsAlarmInvRedundancy_Object(
    (1, 3, 6, 1, 4, 1, 4555, 1, 1, 1, 1, 6, 3, 87),
    _UpsAlarmInvRedundancy_Type()
)
upsAlarmInvRedundancy.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    upsAlarmInvRedundancy.setStatus("mandatory")
...
upsTrapEmdTempNotLow.setObjects(
    ("SOCOMECUPS-MIB", "upsAgentTrapString")
)
if mibBuilder.loadTexts:
...
upsTrapEmdTempNotHigh.setObjects(
    ("SOCOMECUPS-MIB", "upsAgentTrapString")
)
if mibBuilder.loadTexts:
...
upsTrapEmdHumidityNotLow.setObjects(
    ("SOCOMECUPS-MIB", "upsAgentTrapString")
)
if mibBuilder.loadTexts:
...
upsTrapEmdHumidityNotHigh.setObjects(
    ("SOCOMECUPS-MIB", "upsAgentTrapString")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"PositiveInteger": PositiveInteger,
       ...
       "upsAlarmRecRedundancy": upsAlarmRecRedundancy,
       "upsAlarmInvRedundancy": upsAlarmInvRedundancy,
       "upsTest": upsTest,
       "upsTestId": upsTestId,
