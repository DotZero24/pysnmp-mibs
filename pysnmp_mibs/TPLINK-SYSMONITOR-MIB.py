...
# Notes
# -----
# ASN.1 source file://mibs/tplink/TPLINK-SYSMONITOR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:56:00 2025
...
class _TpSysMonitorTemperature_Type(OctetString):
    """Custom type tpSysMonitorTemperature based on OctetString"""
...
_TpSysMonitorTemperature_Type.__name__ = "OctetString"
_TpSysMonitorTemperature_Object = MibScalar
tpSysMonitorTemperature = _TpSysMonitorTemperature_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 4, 1, 3),
    _TpSysMonitorTemperature_Type()
)
tpSysMonitorTemperature.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tpSysMonitorTemperature.setStatus("current")


class _TpSysMonitorVoltage_Type(OctetString):
    """Custom type tpSysMonitorVoltage based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_TpSysMonitorVoltage_Type.__name__ = "OctetString"
_TpSysMonitorVoltage_Object = MibScalar
tpSysMonitorVoltage = _TpSysMonitorVoltage_Object(
    (1, 3, 6, 1, 4, 1, 11863, 6, 4, 1, 4),
    _TpSysMonitorVoltage_Type()
)
tpSysMonitorVoltage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tpSysMonitorVoltage.setStatus("current")
...
tpSysMonitorTemperatureOverLoading = NotificationType(
    (1, 3, 6, 1, 4, 1, 11863, 6, 4, 2, 3)
)
if mibBuilder.loadTexts:
    tpSysMonitorTemperatureOverLoading.setStatus(
        "current"
    )

tpSysMonitorVoltageOverLoading = NotificationType(
    (1, 3, 6, 1, 4, 1, 11863, 6, 4, 2, 4)
)
if mibBuilder.loadTexts:
    tpSysMonitorVoltageOverLoading.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"tplinkSysMonitorMIB": tplinkSysMonitorMIB,
       ...
       "tpSysMonitorTemperature": tpSysMonitorTemperature,
       "tpSysMonitorVoltage": tpSysMonitorVoltage,
       ...
       "tpSysMonitorTemperatureOverLoading": tpSysMonitorTemperatureOverLoading,
       "tpSysMonitorVoltageOverLoading": tpSysMonitorVoltageOverLoading}
)
