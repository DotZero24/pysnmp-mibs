...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CABLE-AVAILABILITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:26:59 2025
...
_CcaHCCPOnOffNotificationEnable_Type.__name__ = "TruthValue"
...
ciscoCableAvailabilityCompliance.setObjects(
      *(("CISCO-CABLE-AVAILABILITY-MIB", "ccaHCCPGroup"),
        ("CISCO-CABLE-AVAILABILITY-MIB", "ccaHCCPMemberGroup"),
        ("CISCO-CABLE-AVAILABILITY-MIB", "ccaHCCPNotificationGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCableAvailabilityComplianceRev1.setObjects(
      *(("CISCO-CABLE-AVAILABILITY-MIB", "ccaHCCPGroup"),
        ("CISCO-CABLE-AVAILABILITY-MIB", "ccaHCCPMemberGroup"),
        ("CISCO-CABLE-AVAILABILITY-MIB", "ccaHCCPNotificationGroup"))
)
