...
# Notes
# -----
# ASN.1 source file://mibs/rfc/FC-MGMT-MIB
...
fcmgmtCompliance.setObjects(
      *(("FC-MGMT-MIB", "fcmInstanceBasicGroup"),
        ("FC-MGMT-MIB", "fcmPortBasicGroup"),
        ("FC-MGMT-MIB", "fcmPortErrorsGroup"),
        ("FC-MGMT-MIB", "fcmPortStatsGroup"),
        ("FC-MGMT-MIB", "fcmPortClass23StatsGroup"),
        ("FC-MGMT-MIB", "fcmPortClassFStatsGroup"),
        ("FC-MGMT-MIB", "fcmPortLcStatsGroup"),
        ("FC-MGMT-MIB", "fcmSwitchBasicGroup"),
        ("FC-MGMT-MIB", "fcmSwitchPortGroup"),
        ("FC-MGMT-MIB", "fcmSwitchLoginGroup"),
        ("FC-MGMT-MIB", "fcmLinkBasicGroup"))
)
if mibBuilder.loadTexts:
