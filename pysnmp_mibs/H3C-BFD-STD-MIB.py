...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-BFD-STD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:19:27 2025
...
class _H3cBfdSessNumberLimit_Type(Unsigned32):
    """Custom type h3cBfdSessNumberLimit based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_H3cBfdSessNumberLimit_Type.__name__ = "Unsigned32"
_H3cBfdSessNumberLimit_Object = MibScalar
h3cBfdSessNumberLimit = _H3cBfdSessNumberLimit_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 72, 1, 1, 4),
    _H3cBfdSessNumberLimit_Type()
)
h3cBfdSessNumberLimit.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cBfdSessNumberLimit.setStatus("current")
...
h3cBfdSessIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
h3cBfdSessStateUp = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 72, 0, 3)
)
h3cBfdSessStateUp.setObjects(
      *(("H3C-BFD-STD-MIB", "h3cBfdSessIfIndex"),
        ("H3C-BFD-STD-MIB", "h3cBfdSessIndex"),
        ("H3C-BFD-STD-MIB", "h3cBfdSessState"))
)
if mibBuilder.loadTexts:
    h3cBfdSessStateUp.setStatus(
        "current"
    )

h3cBfdSessStateDown = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 72, 0, 4)
)
h3cBfdSessStateDown.setObjects(
      *(("H3C-BFD-STD-MIB", "h3cBfdSessIfIndex"),
        ("H3C-BFD-STD-MIB", "h3cBfdSessIndex"),
        ("H3C-BFD-STD-MIB", "h3cBfdSessState"))
)
if mibBuilder.loadTexts:
    h3cBfdSessStateDown.setStatus(
        "current"
    )

h3cBfdSessReachLimit = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 72, 0, 5)
)
h3cBfdSessReachLimit.setObjects(
    ("H3C-BFD-STD-MIB", "h3cBfdSessNumberLimit")
)
if mibBuilder.loadTexts:
    h3cBfdSessReachLimit.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"BfdSessIndexTC": BfdSessIndexTC,
       ...
       "h3cBfdSessStateUp": h3cBfdSessStateUp,
       "h3cBfdSessStateDown": h3cBfdSessStateDown,
       "h3cBfdSessReachLimit": h3cBfdSessReachLimit,
       ...
       "h3cBfdSessNumberLimit": h3cBfdSessNumberLimit,
