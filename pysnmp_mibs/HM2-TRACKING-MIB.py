...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-TRACKING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:55:28 2025
...
_Hm2TrackSendStateChangeTrap_Type.__name__ = "HmEnabledStatus"
...
_Hm2TrackIfNumber_Type.__name__ = "InterfaceIndexOrZero"
...
_Hm2TrackPingIfNumber_Type.__name__ = "InterfaceIndexOrZero"
...
hm2TrackingSNMPExtensionGroup = _Hm2TrackingSNMPExtensionGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 115, 1, 7)
)
_Hm2TrackingInvalidTrackID_ObjectIdentity = ObjectIdentity
hm2TrackingInvalidTrackID = _Hm2TrackingInvalidTrackID_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 115, 1, 7, 1)
)
if mibBuilder.loadTexts:
    hm2TrackingInvalidTrackID.setStatus("current")
_Hm2TrackingTrackNameRegistrationErrorReturn_ObjectIdentity = ObjectIdentity
hm2TrackingTrackNameRegistrationErrorReturn = _Hm2TrackingTrackNameRegistrationErrorReturn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 115, 1, 7, 2)
)
if mibBuilder.loadTexts:
    hm2TrackingTrackNameRegistrationErrorReturn.setStatus("current")
_Hm2TrackingTrackNameDeregisterationErrorReturn_ObjectIdentity = ObjectIdentity
hm2TrackingTrackNameDeregisterationErrorReturn = _Hm2TrackingTrackNameDeregisterationErrorReturn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 115, 1, 7, 3)
)
if mibBuilder.loadTexts:
    hm2TrackingTrackNameDeregisterationErrorReturn.setStatus("current")
_Hm2TrackingInterfaceStatusGroup_ObjectIdentity = ObjectIdentity
hm2TrackingInterfaceStatusGroup = _Hm2TrackingInterfaceStatusGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 115, 1, 8)
)
_Hm2TrackInterfaceStatusTable_Object = MibTable
hm2TrackInterfaceStatusTable = _Hm2TrackInterfaceStatusTable_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 115, 1, 8, 1)
)
if mibBuilder.loadTexts:
    hm2TrackInterfaceStatusTable.setStatus("current")
_Hm2TrackInterfaceStatusEntry_Object = MibTableRow
hm2TrackInterfaceStatusEntry = _Hm2TrackInterfaceStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 115, 1, 8, 1, 1)
)
if mibBuilder.loadTexts:
    hm2TrackInterfaceStatusEntry.setStatus("current")
_Hm2TrackInterfaceStatusTrackId_Type = SnmpAdminString
_Hm2TrackInterfaceStatusTrackId_Object = MibTableColumn
hm2TrackInterfaceStatusTrackId = _Hm2TrackInterfaceStatusTrackId_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 115, 1, 8, 1, 1, 1),
    _Hm2TrackInterfaceStatusTrackId_Type()
)
hm2TrackInterfaceStatusTrackId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2TrackInterfaceStatusTrackId.setStatus("current")


class _Hm2TrackInterfaceStatusTrackState_Type(Integer32):
    """Custom type hm2TrackInterfaceStatusTrackState based on Integer32"""
    defaultValue = 3
...
_Hm2TrackInterfaceStatusTrackState_Type.__name__ = "Integer32"
_Hm2TrackInterfaceStatusTrackState_Object = MibTableColumn
hm2TrackInterfaceStatusTrackState = _Hm2TrackInterfaceStatusTrackState_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 115, 1, 8, 1, 1, 2),
    _Hm2TrackInterfaceStatusTrackState_Type()
)
hm2TrackInterfaceStatusTrackState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2TrackInterfaceStatusTrackState.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hm2TrackingMib": hm2TrackingMib,
       ...
       "hm2TrackingSNMPExtensionGroup": hm2TrackingSNMPExtensionGroup,
       "hm2TrackingInvalidTrackID": hm2TrackingInvalidTrackID,
       "hm2TrackingTrackNameRegistrationErrorReturn": hm2TrackingTrackNameRegistrationErrorReturn,
       "hm2TrackingTrackNameDeregisterationErrorReturn": hm2TrackingTrackNameDeregisterationErrorReturn,
       "hm2TrackingInterfaceStatusGroup": hm2TrackingInterfaceStatusGroup,
       "hm2TrackInterfaceStatusTable": hm2TrackInterfaceStatusTable,
       "hm2TrackInterfaceStatusEntry": hm2TrackInterfaceStatusEntry,
       "hm2TrackInterfaceStatusTrackId": hm2TrackInterfaceStatusTrackId,
       "hm2TrackInterfaceStatusTrackState": hm2TrackInterfaceStatusTrackState}
)
