...
# Notes
# -----
# ASN.1 source file://mibs/zyxel/ZYXEL-DHCP-CLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:02:57 2025
...
zyDhcpClientOption60State = _ZyDhcpClientOption60State_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 103, 1, 2, 1, 3),
    _ZyDhcpClientOption60State_Type()
)
zyDhcpClientOption60State.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDhcpClientOption60State.setStatus("current")
_ZyDhcpClientOption60ClassId_Type = DisplayString
_ZyDhcpClientOption60ClassId_Object = MibTableColumn
zyDhcpClientOption60ClassId = _ZyDhcpClientOption60ClassId_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 103, 1, 2, 1, 4),
    _ZyDhcpClientOption60ClassId_Type()
)
zyDhcpClientOption60ClassId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDhcpClientOption60ClassId.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"zyxelDhcpClient": zyxelDhcpClient,
       ...
       "zyDhcpClientOption60State": zyDhcpClientOption60State,
       "zyDhcpClientOption60ClassId": zyDhcpClientOption60ClassId,
