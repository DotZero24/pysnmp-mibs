...
mibBuilder.exportSymbols("ORAINTERCHANGE-MIB", oraPumpFailedAddressEntry=oraPumpFailedAddressEntry, oraCmanagerCurrentConnectionsInUse=oraCmanagerCurrentConnectionsInUse, oraInterchgTable=oraInterchgTable, oraCmanagerListenAddressEntry=oraCmanagerListenAddressEntry, oraCmanagerFailedAddress=oraCmanagerFailedAddress, oraPumpMaximumConnectDuration=oraPumpMaximumConnectDuration, oraNavigatorRouteAddressEntry=oraNavigatorRouteAddressEntry, oraCmanagerMaximumConnectionsPerPump=oraCmanagerMaximumConnectionsPerPump, oraConnectionSourceAddress=oraConnectionSourceAddress, oraCmanagerAverageConnectTime=oraCmanagerAverageConnectTime, oraPumpMaximumBuffers=oraPumpMaximumBuffers, oraNavigatorState=oraNavigatorState, oraPumpFailedAddress=oraPumpFailedAddress, oraCmanagerErrorMessage=oraCmanagerErrorMessage, oraCmanagerRunningTime=oraCmanagerRunningTime, oraInterchangeObjects=oraInterchangeObjects, oraInterchangeMIB=oraInterchangeMIB, oraPumpActiveTime=oraPumpActiveTime, oraNavigatorRunningTime=oraNavigatorRunningTime, oraInterchgConfigDirectory=oraInterchgConfigDirectory, oraPumpSuccessfulConnections=oraPumpSuccessfulConnections, oraCmanagerPumpStrategy=oraCmanagerPumpStrategy, oracle=oracle, oraCmanagerListenAddressTable=oraCmanagerListenAddressTable, oraPumpFailedAddressTable=oraPumpFailedAddressTable, oraConnectionDuration=oraConnectionDuration, oraPumpEntry=oraPumpEntry, oraNavigatorRouteAddressTable=oraNavigatorRouteAddressTable, oraNavigatorRouteAddress=oraNavigatorRouteAddress, oraNavigatorErrors=oraNavigatorErrors, oraCmanagerStoppable=oraCmanagerStoppable, oraPumpMinimumConnectTime=oraPumpMinimumConnectTime, oraPumpBufferUtilization=oraPumpBufferUtilization, oraPumpCurrentBytesPerSecond=oraPumpCurrentBytesPerSecond, oraCmanagerTraceFile=oraCmanagerTraceFile, oraNavigatorListenAddress=oraNavigatorListenAddress, oraInterchgTraps=oraInterchgTraps, oraCmanagerMaximumPumps=oraCmanagerMaximumPumps, oraPumpActiveConnections=oraPumpActiveConnections, oraCmanagerMaximumConnectDuration=oraCmanagerMaximumConnectDuration, oraConnectionIdleTime=oraConnectionIdleTime, oraConnectionTable=oraConnectionTable, oraNavigatorLogging=oraNavigatorLogging, oraCmanagerTraceLevel=oraCmanagerTraceLevel, oraNavigatorListenAddressIndex=oraNavigatorListenAddressIndex, oraNavigatorFailedAddress=oraNavigatorFailedAddress, oraNavigatorLogFile=oraNavigatorLogFile, oraCmanagerImmediateAverageBytes=oraCmanagerImmediateAverageBytes, oraCmanagerFailedAddressTable=oraCmanagerFailedAddressTable, oraCmanagerListenAddressIndex=oraCmanagerListenAddressIndex, oraPumpFailedAddressIndex=oraPumpFailedAddressIndex, oraNavigatorFailedAddressEntry=oraNavigatorFailedAddressEntry, oraConnectionEntry=oraConnectionEntry, oraPumpAverageConnectTime=oraPumpAverageConnectTime, oraPumpTraceFile=oraPumpTraceFile, oraNavigatorAccumulatedSuccessfulRequests=oraNavigatorAccumulatedSuccessfulRequests, oraNavigatorErrorMessage=oraNavigatorErrorMessage, oraCmanagerMinimumConnectTime=oraCmanagerMinimumConnectTime, oraCmanagerTable=oraCmanagerTable, oraPumpListenAddress=oraPumpListenAddress, oraCmanagerLogFile=oraCmanagerLogFile, oraNavigatorTable=oraNavigatorTable, oraCmanagerListenAddress=oraCmanagerListenAddress, oraPumpIndex=oraPumpIndex, oraPumpListenAddressIndex=oraPumpListenAddressIndex, oraPumpTraceLevel=oraPumpTraceLevel, oraConnectionIndex=oraConnectionIndex, oraPumpListenAddressEntry=oraPumpListenAddressEntry, oraCmanagerAccumulatedSuccessfulConnections=oraCmanagerAccumulatedSuccessfulConnections, oraCmanagerActivePumps=oraCmanagerActivePumps, oraNavigatorTraceFile=oraNavigatorTraceFile, oraNavigatorRouteAddressIndex=oraNavigatorRouteAddressIndex, oraNavigatorListenAddressEntry=oraNavigatorListenAddressEntry, oraNavigatorListenAddressTable=oraNavigatorListenAddressTable, oraCmanagerState=oraCmanagerState, oraNavigatorFailedAddressIndex=oraNavigatorFailedAddressIndex, oraPumpErrors=oraPumpErrors, oraConnectionDestinationAddress=oraConnectionDestinationAddress, oraCmanagerMaximumConnectTime=oraCmanagerMaximumConnectTime, oraPumpFailedConnections=oraPumpFailedConnections, oraCmanagerFailedAddressEntry=oraCmanagerFailedAddressEntry, oraPumpMaximumAverageBytes=oraPumpMaximumAverageBytes, oraPumpMaximumConnectTime=oraPumpMaximumConnectTime, oraCmanagerFailedAddressIndex=oraCmanagerFailedAddressIndex, oraNavigatorAccumulatedFailedRequests=oraNavigatorAccumulatedFailedRequests, oraPumpErrorMessage=oraPumpErrorMessage, oraPumpTable=oraPumpTable, oraCmanagerEntry=oraCmanagerEntry, oraCmanagerAccumulatedFailedConnections=oraCmanagerAccumulatedFailedConnections, oraPumpListenAddressTable=oraPumpListenAddressTable, oraPumpImmediateAverageBytes=oraPumpImmediateAverageBytes, oraNavigatorLoggingLevel=oraNavigatorLoggingLevel, oraPumpAccumulatedBytesSent=oraPumpAccumulatedBytesSent, oraInterchgContactInfo=oraInterchgContactInfo, oraCmanagerLogging=oraCmanagerLogging, oraNavigatorStoppable=oraNavigatorStoppable, oraConnectionPumpID=oraConnectionPumpID, oraInterchgEntry=oraInterchgEntry, oraCmanagerMaximumConnections=oraCmanagerMaximumConnections, oraCmanagerErrors=oraCmanagerErrors, oraNavigatorEntry=oraNavigatorEntry, oraNavigatorFailedAddressTable=oraNavigatorFailedAddressTable, oraNavigatorStateChange=oraNavigatorStateChange, oraNavigatorTraceLevel=oraNavigatorTraceLevel, oraCmanagerStateChange=oraCmanagerStateChange, oraCmanagerStartTime=oraCmanagerStartTime)
