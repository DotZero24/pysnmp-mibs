# SNMP MIB module (CISCOSB-MACRO-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-MACRO-MIB
...
rlMacro = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 140)
)
if mibBuilder.loadTexts:
    rlMacro.setRevisions(
        ("2008-07-30 00:00",)
    )
...
rlSmartPortsMacroManageEntry.setIndexNames(
    (1, "CISCOSB-MACRO-MIB", "rlSmartPortsMacroName"),
)
if mibBuilder.loadTexts:
...
rlSmartPortsMacroContentEntry.setIndexNames(
    (0, "CISCOSB-MACRO-MIB", "rlSmartPortsMacroIndex"),
    (0, "CISCOSB-MACRO-MIB", "rlSmartPortsMacroOctetIndex"),
)
if mibBuilder.loadTexts:
...
rlSmartPortsMacroDescriptionEntry.setIndexNames(
    (0, "CISCOSB-MACRO-MIB", "rlSmartPortsMacroDescriptionIndex"),
)
if mibBuilder.loadTexts:
