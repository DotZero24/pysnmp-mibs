...
mibBuilder.exportSymbols("CISCOSB-MACRO-MIB", rlSmartPortsMacroOctetIndex=rlSmartPortsMacroOctetIndex, rlSmartPortsMacroManageTable=rlSmartPortsMacroManageTable, rlSmartPortsMacroKeywords=rlSmartPortsMacroKeywords, rlSmartPortsMacroDescriptionTable=rlSmartPortsMacroDescriptionTable, rlSmartPortsDiagMacroName=rlSmartPortsDiagMacroName, rlSmartPortsMacroStatus=rlSmartPortsMacroStatus, rlSmartPortsMacroDescriptionIndex=rlSmartPortsMacroDescriptionIndex, rlSmartPortsMacroContentTable=rlSmartPortsMacroContentTable, rlSmartPortsFreeIndexes=rlSmartPortsFreeIndexes, rlSmartPortsDiagLineNumber=rlSmartPortsDiagLineNumber, rlSmartPortsMacroIndex=rlSmartPortsMacroIndex, rlSmartPortsMacroDescriptionEntry=rlSmartPortsMacroDescriptionEntry, rlSmartPortsMacroText=rlSmartPortsMacroText, rlSmartPortsMacroDesc2=rlSmartPortsMacroDesc2, rlSmartPortsMacroDescriptionText=rlSmartPortsMacroDescriptionText, RlSmartPortsMacroNameOrZero=RlSmartPortsMacroNameOrZero, PYSNMP_MODULE_ID=rlMacro, rlSmartPortsCondenseMode=rlSmartPortsCondenseMode, rlSmartPortsMacroManageEntry=rlSmartPortsMacroManageEntry, rlSmartPortsDiagCommandLine=rlSmartPortsDiagCommandLine, rlSmartPortsMacroDesc1=rlSmartPortsMacroDesc1, rlSmartPortsMacroDescriptionStatus=rlSmartPortsMacroDescriptionStatus, rlSmartPortsMacroContentEntry=rlSmartPortsMacroContentEntry, rlSmartPortsMacroName=rlSmartPortsMacroName, MacroType=MacroType, rlSmartPortsMacroType=rlSmartPortsMacroType, rlMacro=rlMacro, RlSmartPortsMacroName=RlSmartPortsMacroName)
