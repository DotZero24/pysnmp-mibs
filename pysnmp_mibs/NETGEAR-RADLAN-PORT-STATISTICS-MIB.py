...
_E='DisplayString'
_D='not-accessible'
_C='NETGEAR-RADLAN-PORT-STATISTICS-MIB'
_B='read-only'
_A='current'
...
rlPortStatEnabledPorts=_RlPortStatEnabledPorts_Object((1,3,6,1,4,1,4526,17,223,1),_RlPortStatEnabledPorts_Type())
...
rlPortStatClearPorts=_RlPortStatClearPorts_Object((1,3,6,1,4,1,4526,17,223,2),_RlPortStatClearPorts_Type())
...
rlPortStatSampleTable=_RlPortStatSampleTable_Object((1,3,6,1,4,1,4526,17,223,3))
if mibBuilder.loadTexts:rlPortStatSampleTable.setStatus(_A)
_RlPortStatSampleEntry_Object=MibTableRow
rlPortStatSampleEntry=_RlPortStatSampleEntry_Object((1,3,6,1,4,1,4526,17,223,3,1))
...
rlPortStatSampleIfIndex=_RlPortStatSampleIfIndex_Object((1,3,6,1,4,1,4526,17,223,3,1,1),_RlPortStatSampleIfIndex_Type())
...
rlPortStatSampleStatSubType=_RlPortStatSampleStatSubType_Object((1,3,6,1,4,1,4526,17,223,3,1,2),_RlPortStatSampleStatSubType_Type())
...
rlPortStatSampleCounterName=_RlPortStatSampleCounterName_Object((1,3,6,1,4,1,4526,17,223,3,1,3),_RlPortStatSampleCounterName_Type())
...
rlPortStatSampleStatID=_RlPortStatSampleStatID_Object((1,3,6,1,4,1,4526,17,223,3,1,4),_RlPortStatSampleStatID_Type())
...
rlPortStatSampleCollectionInterval=_RlPortStatSampleCollectionInterval_Object((1,3,6,1,4,1,4526,17,223,3,1,5),_RlPortStatSampleCollectionInterval_Type())
...
rlPortStatSampleSystemCollectionTime=_RlPortStatSampleSystemCollectionTime_Object((1,3,6,1,4,1,4526,17,223,3,1,6),_RlPortStatSampleSystemCollectionTime_Type())
...
rlPortStatSampleCollectionTime=_RlPortStatSampleCollectionTime_Object((1,3,6,1,4,1,4526,17,223,3,1,7),_RlPortStatSampleCollectionTime_Type())
...
rlPortStatSampleCollectionTimeStr=_RlPortStatSampleCollectionTimeStr_Object((1,3,6,1,4,1,4526,17,223,3,1,8),_RlPortStatSampleCollectionTimeStr_Type())
...
rlPortStatSampleCounterValue=_RlPortStatSampleCounterValue_Object((1,3,6,1,4,1,4526,17,223,3,1,9),_RlPortStatSampleCounterValue_Type())
...
rlPortStatSamplePartialFlag=_RlPortStatSamplePartialFlag_Object((1,3,6,1,4,1,4526,17,223,3,1,10),_RlPortStatSamplePartialFlag_Type())
...
rlPortStatSampleClockSource=_RlPortStatSampleClockSource_Object((1,3,6,1,4,1,4526,17,223,3,1,11),_RlPortStatSampleClockSource_Type())
...
rlPortStatLastSampleTable=_RlPortStatLastSampleTable_Object((1,3,6,1,4,1,4526,17,223,4))
if mibBuilder.loadTexts:rlPortStatLastSampleTable.setStatus(_A)
_RlPortStatLastSampleEntry_Object=MibTableRow
rlPortStatLastSampleEntry=_RlPortStatLastSampleEntry_Object((1,3,6,1,4,1,4526,17,223,4,1))
...
rlPortStatLastSampleIfIndex=_RlPortStatLastSampleIfIndex_Object((1,3,6,1,4,1,4526,17,223,4,1,1),_RlPortStatLastSampleIfIndex_Type())
...
rlPortStatLastSampleStatSubType=_RlPortStatLastSampleStatSubType_Object((1,3,6,1,4,1,4526,17,223,4,1,2),_RlPortStatLastSampleStatSubType_Type())
...
rlPortStatLastSampleCounterName=_RlPortStatLastSampleCounterName_Object((1,3,6,1,4,1,4526,17,223,4,1,3),_RlPortStatLastSampleCounterName_Type())
...
rlPortStatLastSampleStatID=_RlPortStatLastSampleStatID_Object((1,3,6,1,4,1,4526,17,223,4,1,4),_RlPortStatLastSampleStatID_Type())
...
rlPortStatLastSampleCollectionInterval=_RlPortStatLastSampleCollectionInterval_Object((1,3,6,1,4,1,4526,17,223,4,1,5),_RlPortStatLastSampleCollectionInterval_Type())
...
rlPortStatLastSampleSystemCollectionTime=_RlPortStatLastSampleSystemCollectionTime_Object((1,3,6,1,4,1,4526,17,223,4,1,6),_RlPortStatLastSampleSystemCollectionTime_Type())
...
rlPortStatLastSampleCollectionTime=_RlPortStatLastSampleCollectionTime_Object((1,3,6,1,4,1,4526,17,223,4,1,7),_RlPortStatLastSampleCollectionTime_Type())
...
rlPortStatLastSampleCollectionTimeStr=_RlPortStatLastSampleCollectionTimeStr_Object((1,3,6,1,4,1,4526,17,223,4,1,8),_RlPortStatLastSampleCollectionTimeStr_Type())
...
rlPortStatLastSampleCounterValue=_RlPortStatLastSampleCounterValue_Object((1,3,6,1,4,1,4526,17,223,4,1,9),_RlPortStatLastSampleCounterValue_Type())
...
rlPortStatLastSamplePartialFlag=_RlPortStatLastSamplePartialFlag_Object((1,3,6,1,4,1,4526,17,223,4,1,10),_RlPortStatLastSamplePartialFlag_Type())
...
rlPortStatLastSampleClockSource=_RlPortStatLastSampleClockSource_Object((1,3,6,1,4,1,4526,17,223,4,1,11),_RlPortStatLastSampleClockSource_Type())
...
rlPortStatLastEventTable=_RlPortStatLastEventTable_Object((1,3,6,1,4,1,4526,17,223,5))
if mibBuilder.loadTexts:rlPortStatLastEventTable.setStatus(_A)
_RlPortStatLastEventEntry_Object=MibTableRow
rlPortStatLastEventEntry=_RlPortStatLastEventEntry_Object((1,3,6,1,4,1,4526,17,223,5,1))
...
rlPortStatLastEventIfIndex=_RlPortStatLastEventIfIndex_Object((1,3,6,1,4,1,4526,17,223,5,1,1),_RlPortStatLastEventIfIndex_Type())
...
rlPortStatLastEventCounterName=_RlPortStatLastEventCounterName_Object((1,3,6,1,4,1,4526,17,223,5,1,2),_RlPortStatLastEventCounterName_Type())
...
rlPortStatLastEventSystemTime=_RlPortStatLastEventSystemTime_Object((1,3,6,1,4,1,4526,17,223,5,1,3),_RlPortStatLastEventSystemTime_Type())
...
rlPortStatLastEventPosixTime=_RlPortStatLastEventPosixTime_Object((1,3,6,1,4,1,4526,17,223,5,1,4),_RlPortStatLastEventPosixTime_Type())
...
rlPortStatLastEventTimeStr=_RlPortStatLastEventTimeStr_Object((1,3,6,1,4,1,4526,17,223,5,1,5),_RlPortStatLastEventTimeStr_Type())
...
rlPortStatLastEventCounter=_RlPortStatLastEventCounter_Object((1,3,6,1,4,1,4526,17,223,5,1,6),_RlPortStatLastEventCounter_Type())
...
rlPortStatLastEventCounterValue=_RlPortStatLastEventCounterValue_Object((1,3,6,1,4,1,4526,17,223,5,1,7),_RlPortStatLastEventCounterValue_Type())
