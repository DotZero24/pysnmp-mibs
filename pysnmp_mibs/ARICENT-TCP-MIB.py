# SNMP MIB module (ARICENT-TCP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-TCP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:42:08 2025
...
(tcpConnectionEntry,
 tcpConnectionRemPort) = mibBuilder.importSymbols(
    "TCP-MIB",
    "tcpConnectionEntry",
...
fsTcpConnTable = _FsTcpConnTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 18, 7)
)
if mibBuilder.loadTexts:
    fsTcpConnTable.setStatus("current")
_FsTcpConnEntry_Object = MibTableRow
fsTcpConnEntry = _FsTcpConnEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 18, 7, 1)
)
fsTcpConnEntry.setIndexNames(
    (0, "ARICENT-TCP-MIB", "fsTcpConnLocalAddress"),
    (0, "ARICENT-TCP-MIB", "fsTcpConnLocalPort"),
    (0, "ARICENT-TCP-MIB", "fsTcpConnRemAddress"),
    (0, "ARICENT-TCP-MIB", "fsTcpConnRemPort"),
)
if mibBuilder.loadTexts:
...
fsTcpAoConnTestEntry = _FsTcpAoConnTestEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 18, 12, 1)
)
fsTcpAoConnTestEntry.setIndexNames(
    (0, "ARICENT-TCP-MIB", "fsTcpAoConnTestLclAdrType"),
    (0, "ARICENT-TCP-MIB", "fsTcpAoConnTestLclAdress"),
    (0, "ARICENT-TCP-MIB", "fsTcpAoConnTestLclPort"),
    (0, "ARICENT-TCP-MIB", "fsTcpAoConnTestRmtAdrType"),
    (0, "ARICENT-TCP-MIB", "fsTcpAoConnTestRmtAdress"),
...
fstcpAoAuthError = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 18, 11, 0, 1)
)
fstcpAoAuthError.setObjects(
      *(("ARICENT-TCP-MIB", "fstcpAoLocalAddressType"),
        ("ARICENT-TCP-MIB", "fstcpAoLocalAddress"),
        ("ARICENT-TCP-MIB", "fstcpAoLocalPort"),
        ("ARICENT-TCP-MIB", "fstcpAoRemAddressType"),
        ("ARICENT-TCP-MIB", "fstcpAoRemAddress"),
        ("TCP-MIB", "tcpConnectionRemPort"),
