...
mibBuilder.exportSymbols("F10-LINK-AGGREGATION-MIB", dot3aAggConfigTable=dot3aAggConfigTable, dot3aAggFdbStatus=dot3aAggFdbStatus, dot3aCurAggFdbIndex=dot3aCurAggFdbIndex, dot3aCurAggMacAddr=dot3aCurAggMacAddr, dot3adAggPortIndex=dot3adAggPortIndex, f10dot3dAgg=f10dot3dAgg, dot3aAggFdbIndex=dot3aAggFdbIndex, dot3aAggFdbDistributedPort=dot3aAggFdbDistributedPort, f10Dot3adAggNotifications=f10Dot3adAggNotifications, dot3aAggIndex=dot3aAggIndex, dot3aAggCfgIfIndex=dot3aAggCfgIfIndex, f10LinkAggMibCompliance=f10LinkAggMibCompliance, dot3aAggCfgLacpSupported=dot3aAggCfgLacpSupported, f10LinkAggMibCompliances=f10LinkAggMibCompliances, dot3aAggStaticTable=dot3aAggStaticTable, dot3aCurAggFdbTable=dot3aCurAggFdbTable, dot3aCurAggStaticTable=dot3aCurAggStaticTable, dot3aCurAggFdbStatus=dot3aCurAggFdbStatus, dot3adAggPortTable=dot3adAggPortTable, dot3aAggStaticEntry=dot3aAggStaticEntry, dot3aAggCfgMacAddr=dot3aAggCfgMacAddr, dot3aAggConfigEntry=dot3aAggConfigEntry, dot3adAggPortActorOperKey=dot3adAggPortActorOperKey, dot3aAggStatus=dot3aAggStatus, dot3aClearFdb=dot3aClearFdb, dot3aAggCfgPortListString=dot3aAggCfgPortListString, f10LinkAggMibConformance=f10LinkAggMibConformance, dot3aCommonAggFdbIndex=dot3aCommonAggFdbIndex, dot3adAggPortPartnerOperKey=dot3adAggPortPartnerOperKey, f10LinkAggAlarmObjectGroup=f10LinkAggAlarmObjectGroup, dot3aCurAggIndex=dot3aCurAggIndex, dot3adAggPortPartnerOperState=dot3adAggPortPartnerOperState, f10LinkAggCommonGroup=f10LinkAggCommonGroup, dot3aCommonAggFdbStatus=dot3aCommonAggFdbStatus, dot3adAggPortEntry=dot3adAggPortEntry, dot3aAggFdbVlanId=dot3aAggFdbVlanId, f10LinkAggCommonGroupRev1=f10LinkAggCommonGroupRev1, f10LinkAggObjects=f10LinkAggObjects, dot3aCurAggFdbEntry=dot3aCurAggFdbEntry, f10LinkAggMibGroups=f10LinkAggMibGroups, f10LinkAggMib=f10LinkAggMib, f10LinkAggMgmt=f10LinkAggMgmt, dot3aAggFdbTable=dot3aAggFdbTable, dot3aAggMacAddr=dot3aAggMacAddr, f10LinkAggMibComplianceRev1=f10LinkAggMibComplianceRev1, dot3aCommonAggFdbTagConfig=dot3aCommonAggFdbTagConfig, dot3aAggFdbEntry=dot3aAggFdbEntry, dot3aCurAggFdbMacAddr=dot3aCurAggFdbMacAddr, dot3aAggFdbMacAddr=dot3aAggFdbMacAddr, linkBundleImbalance=linkBundleImbalance, dot3aCurAggStatus=dot3aCurAggStatus, dot3aCommonAggFdbVlanId=dot3aCommonAggFdbVlanId, F10LacpKey=F10LacpKey, f10LinkAggNotificationGroup=f10LinkAggNotificationGroup, dot3adAggPortPartnerAdminState=dot3adAggPortPartnerAdminState, dot3aAggCfgOperStatus=dot3aAggCfgOperStatus, dot3aAggCfgId=dot3aAggCfgId, f10LinkBundleNotifications=f10LinkBundleNotifications, F10LacpState=F10LacpState, dot3aCurAggStaticEntry=dot3aCurAggStaticEntry, f10LinkAggPortGroup=f10LinkAggPortGroup, dot3aAggCfgNumPorts=dot3aAggCfgNumPorts, dot3aCurAggFdbVlanId=dot3aCurAggFdbVlanId, dot3aCommonAggFdbEntry=dot3aCommonAggFdbEntry, dot3adAggLacpStateChange=dot3adAggLacpStateChange, dot3adAggPortActorAdminState=dot3adAggPortActorAdminState, dot3aCurAggVlanId=dot3aCurAggVlanId, linkBundleType=linkBundleType, linkBundleNumber=linkBundleNumber, linkBundleImbalanceClear=linkBundleImbalanceClear, dot3aAggDistributedPort=dot3aAggDistributedPort, dot3aCommonAggFdbTable=dot3aCommonAggFdbTable, dot3aAggVlanId=dot3aAggVlanId, PYSNMP_MODULE_ID=f10LinkAggMib, dot3adAggPortActorOperState=dot3adAggPortActorOperState, dot3aAggCfgPortList=dot3aAggCfgPortList, f10LinkAggAlarms=f10LinkAggAlarms)
