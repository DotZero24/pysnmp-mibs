...
# Notes
# -----
# ASN.1 source file://mibs/junose/Juniper-ACCOUNTING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:06:30 2025
...
_JuniAcctngSelectionMaxIfStackLevels_Type.__name__ = "Integer32"
...
_JuniAcctngSelectionPolicyType_Type.__name__ = "JuniPolicyAttachmentType"
...
_JuniAcctngSelectionIfCreateDeleteStats_Type.__name__ = "JuniEnable"
...
juniAcctngCompliance.setObjects(
    ("Juniper-ACCOUNTING-MIB", "juniAcctngBasicGroup")
)
if mibBuilder.loadTexts:
...
juniAcctngCompliance2.setObjects(
    ("Juniper-ACCOUNTING-MIB", "juniAcctngBasicGroup2")
)
if mibBuilder.loadTexts:
...
juniAcctngCompliance3.setObjects(
    ("Juniper-ACCOUNTING-MIB", "juniAcctngBasicGroup3")
)
if mibBuilder.loadTexts:
...
juniAcctngCompliance4.setObjects(
    ("Juniper-ACCOUNTING-MIB", "juniAcctngBasicGroup4")
)
if mibBuilder.loadTexts:
...
juniAcctngCompliance5.setObjects(
    ("Juniper-ACCOUNTING-MIB", "juniAcctngBasicGroup5")
)
if mibBuilder.loadTexts:
...
juniAcctngCompliance6.setObjects(
    ("Juniper-ACCOUNTING-MIB", "juniAcctngBasicGroup6")
)
if mibBuilder.loadTexts:
