...
atmfLanEmulation, LecDataFrameSize, VpiInteger, VciInteger, LecDataFrameFormat = mibBuilder.importSymbols("LAN-EMULATION-CLIENT-MIB", "atmfLanEmulation", "LecDataFrameSize", "VpiInteger", "VciInteger", "LecDataFrameFormat")
...
mibBuilder.exportSymbols("LAN-EMULATION-ELAN-MIB", elanLecFrameSize=elanLecFrameSize, elanConfMaxFrameSize=elanConfMaxFrameSize, lecsOperStatus=lecsOperStatus, elanPolicyTable=elanPolicyTable, lecsVccVci=lecsVccVci, AtmLaneMask=AtmLaneMask, byElanName=byElanName, lecsLastInitialized=lecsLastInitialized, lecsTlvSelectorIndex=lecsTlvSelectorIndex, lecsTlvTag=lecsTlvTag, elanLecsGroup=elanLecsGroup, lecsConfEntry=lecsConfEntry, lecsVccRowStatus=lecsVccRowStatus, elanLecRdBridgeNum=elanLecRdBridgeNum, lecsTlvVal=lecsTlvVal, RowStatus=RowStatus, elanConfNextId=elanConfNextId, elanLecAtmAddrEntry=elanLecAtmAddrEntry, lecsConfTable=lecsConfTable, elanLecAtmMask=elanLecAtmMask, byAtmAddr=byAtmAddr, lecsVccTable=lecsVccTable, elanLecAtmRowStatus=elanLecAtmRowStatus, lecsStatInvalidAddr=lecsStatInvalidAddr, lecsErrLogErrCode=lecsErrLogErrCode, elanLecNameEntry=elanLecNameEntry, elanLecNameRowStatus=elanLecNameRowStatus, elanPolicySelectorIndex=elanPolicySelectorIndex, lecsAdminStatus=lecsAdminStatus, lecsVccIfIndex=lecsVccIfIndex, elanConfName=elanConfName, elanLesTable=elanLesTable, lecsErrLogAtmAddr=lecsErrLogAtmAddr, lecsStatInBadFrames=lecsStatInBadFrames, elanLecsStatGroup=elanLecsStatGroup, elanConfEntry=elanConfEntry, elanPolicyPriority=elanPolicyPriority, byPktSize=byPktSize, lecsTlvTable=lecsTlvTable, lecsVccEntry=lecsVccEntry, lecsVccVpi=lecsVccVpi, elanLecRdSegId=elanLecRdSegId, lecsErrLogTable=lecsErrLogTable, MacAddress=MacAddress, elanMIB=elanMIB, lecsAtmIfIndex=lecsAtmIfIndex, byRouteDescriptor=byRouteDescriptor, elanPolicyType=elanPolicyType, elanLecMacAddrTable=elanLecMacAddrTable, elanLecMacAddrEntry=elanLecMacAddrEntry, elanAdminPolicyVal=elanAdminPolicyVal, elanLecElanName=elanLecElanName, elanConfIndex=elanConfIndex, elanConfLanType=elanConfLanType, lecsErrCtlTable=lecsErrCtlTable, elanLesEntry=elanLesEntry, PolicySelectorIndexType=PolicySelectorIndexType, byMacAddr=byMacAddr, lecsStatsEntry=lecsStatsEntry, elanLesRowStatus=elanLesRowStatus, elanConfGroup=elanConfGroup, TIMESTAMP=TIMESTAMP, lecsErrCtlEntry=lecsErrCtlEntry, lecsStatsTable=lecsStatsTable, lecsStatInsufRes=lecsStatInsufRes, elanLecPktSizeTable=elanLecPktSizeTable, elanLesIndex=elanLesIndex, elanLecRdTable=elanLecRdTable, lecsPolicySelIndex=lecsPolicySelIndex, elanLecRdEntry=elanLecRdEntry, lecsStatInvalidReq=lecsStatInvalidReq, lecsStatInvalidParam=lecsStatInvalidParam, lecsRowStatus=lecsRowStatus, lecsElanEntry=lecsElanEntry, elanPolicyIndex=elanPolicyIndex, elanLecNameTable=elanLecNameTable, elanLesAtmAddress=elanLesAtmAddress, lecsErrCtlClearLog=lecsErrCtlClearLog, lecsStatNoConf=lecsStatNoConf, AtmLaneAddress=AtmLaneAddress, lecsAtmAddrMask=lecsAtmAddrMask, elanLecAtmAddrTable=elanLecAtmAddrTable, byLanType=byLanType, lecsErrLogTime=lecsErrLogTime, lecsAtmAddrSpec=lecsAtmAddrSpec, lecsStatInsufInfo=lecsStatInsufInfo, AutonomousType=AutonomousType, lecsConfIndex=lecsConfIndex, elanLecAtmAddress=elanLecAtmAddress, lecsStatAccDenied=lecsStatAccDenied, elanPolicyRowStatus=elanPolicyRowStatus, elanLecMacAddress=elanLecMacAddress, lecsElanTable=lecsElanTable, lecsElanRowStatus=lecsElanRowStatus, lecsTlvRowStatus=lecsTlvRowStatus, lecsErrLogEntry=lecsErrLogEntry, lecsStatConfError=lecsStatConfError, lecsErrLogIndex=lecsErrLogIndex, Integer=Integer, elanLecPktSizeRowStatus=elanLecPktSizeRowStatus, lecsTlvIndex=lecsTlvIndex, lecsErrCtlOperStatus=lecsErrCtlOperStatus, lecsErrCtlMaxEntries=lecsErrCtlMaxEntries, elanLecMacRowStatus=elanLecMacRowStatus, lecsStatSuccessful=lecsStatSuccessful, lecsErrCtlLastEntry=lecsErrCtlLastEntry, elanConfRowStatus=elanConfRowStatus, elanLecRdRowStatus=elanLecRdRowStatus, elanAdminGroup=elanAdminGroup, elanLecsConfGroup=elanLecsConfGroup, elanConfTlvIndex=elanConfTlvIndex, IfIndexOrZero=IfIndexOrZero, elanPolicyEntry=elanPolicyEntry, elanConfTable=elanConfTable, lecsTlvEntry=lecsTlvEntry, lecsStatInvalidDest=lecsStatInvalidDest, elanLecPktSizeEntry=elanLecPktSizeEntry, elanLecsFaultGroup=elanLecsFaultGroup, lecsAtmAddrActual=lecsAtmAddrActual, TlvSelectorIndexType=TlvSelectorIndexType, ElanLocalIndex=ElanLocalIndex, lecsErrCtlAdminStatus=lecsErrCtlAdminStatus, LecsErrLogIndexType=LecsErrLogIndexType, lecsConfNextId=lecsConfNextId)
