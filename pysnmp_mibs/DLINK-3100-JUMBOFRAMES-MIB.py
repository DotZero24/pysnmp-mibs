# SNMP MIB module (DLINK-3100-JUMBOFRAMES-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-3100-JUMBOFRAMES-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:50:53 2025
...
rlJumboFramesCurrentStatus = _RlJumboFramesCurrentStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 91, 1),
...
rlJumboFramesStatusAfterReset = _RlJumboFramesStatusAfterReset_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 91, 2),
