...
mibBuilder.exportSymbols("DLINK-3100-JUMBOFRAMES-MIB", rlJumboFramesCurrentStatus=rlJumboFramesCurrentStatus, PYSNMP_MODULE_ID=rlJumboFrames, rlJumboFrames=rlJumboFrames, rlJumboFramesStatusAfterReset=rlJumboFramesStatusAfterReset)
