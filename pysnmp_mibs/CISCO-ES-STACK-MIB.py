...
mibBuilder.exportSymbols("CISCO-ES-STACK-MIB", ciscoEsVLANPortEntry=ciscoEsVLANPortEntry, ciscoEsVLANInfoName=ciscoEsVLANInfoName, ciscoEsPortRcvLocalFrames=ciscoEsPortRcvLocalFrames, ciscoEsOptPortStaTable=ciscoEsOptPortStaTable, ciscoEsPortRuntlessMode=ciscoEsPortRuntlessMode, ciscoEsVLANStpTimeSinceTopologyChange=ciscoEsVLANStpTimeSinceTopologyChange, ciscoEsVLANInfoEntry=ciscoEsVLANInfoEntry, ciscoEsPortSWHandledFrames=ciscoEsPortSWHandledFrames, cisco=cisco, ciscoEsStackStatus=ciscoEsStackStatus, ciscoEsTrapRcvrStatus=ciscoEsTrapRcvrStatus, ciscoEsVLANs=ciscoEsVLANs, ciscoEsVLANStationTable=ciscoEsVLANStationTable, ciscoEsRouterOpState=ciscoEsRouterOpState, ciscoEsPortStnLocation=ciscoEsPortStnLocation, ciscoEsDmns=ciscoEsDmns, ciscoEsPortRcvMcasts=ciscoEsPortRcvMcasts, ciscoEsOptVLANStaPos=ciscoEsOptVLANStaPos, ciscoEsPortInBufOverflows=ciscoEsPortInBufOverflows, ciscoEsPortStnDestnBytes=ciscoEsPortStnDestnBytes, workgroup=workgroup, ciscoEsVLANStpBridgeForwardDelay=ciscoEsVLANStpBridgeForwardDelay, ciscoEsFilterStationAddress=ciscoEsFilterStationAddress, ciscoEsStackSwitchOutTotalReqs=ciscoEsStackSwitchOutTotalReqs, ciscoEsVLANInfoIpDefaultGateway=ciscoEsVLANInfoIpDefaultGateway, ciscoEsStackSwitchAgingTime=ciscoEsStackSwitchAgingTime, ciscoEsVLANStpPriority=ciscoEsVLANStpPriority, ciscoEsVLANInfoMaxStations=ciscoEsVLANInfoMaxStations, ciscoEsPortDuplex=ciscoEsPortDuplex, ciscoEsStackSwitchBufferOverruns=ciscoEsStackSwitchBufferOverruns, ciscoEsPortPktsInErrors=ciscoEsPortPktsInErrors, ciscoEsStackSwitchFwVersion=ciscoEsStackSwitchFwVersion, ciscoEsVLANStpHelloTime=ciscoEsVLANStpHelloTime, ciscoEsFilterEntry=ciscoEsFilterEntry, ciscoEsFilterTable=ciscoEsFilterTable, ciscoEsDefaultGateway=ciscoEsDefaultGateway, ciscoEsTrapRcvrVLANs=ciscoEsTrapRcvrVLANs, ciscoEsPortStnEntry=ciscoEsPortStnEntry, ciscoEsVLANStpVLANIndex=ciscoEsVLANStpVLANIndex, ciscoEsOptVLANStaEntry=ciscoEsOptVLANStaEntry, ciscoEsOptPortStaPos=ciscoEsOptPortStaPos, ciscoEsPortSwitchNumber=ciscoEsPortSwitchNumber, ciscoEsPortRcvBcasts=ciscoEsPortRcvBcasts, ciscoEsPortMostStations=ciscoEsPortMostStations, ciscoEsVLANStationTraffic=ciscoEsVLANStationTraffic, ciscoEsPortNumber=ciscoEsPortNumber, ciscoEsIpAddr=ciscoEsIpAddr, ciscoEsConfiguration=ciscoEsConfiguration, ciscoEsPortOutBufOverflows=ciscoEsPortOutBufOverflows, ciscoEsPortTableOverflows=ciscoEsPortTableOverflows, ciscoEsStackTable=ciscoEsStackTable, ciscoEsVLANInfoBaseAddr=ciscoEsVLANInfoBaseAddr, ciscoEsModNumber=ciscoEsModNumber, ciscoEsVLANStpRootPort=ciscoEsVLANStpRootPort, ciscoEsModState=ciscoEsModState, ciscoEsPortInOctets=ciscoEsPortInOctets, ciscoEsVLANPortSwitchNumber=ciscoEsVLANPortSwitchNumber, ciscoEsECPorts=ciscoEsECPorts, ciscoEsEtherChannelFailed=ciscoEsEtherChannelFailed, ciscoEsNumMatrixModules=ciscoEsNumMatrixModules, ciscoEsStackSwitchInLongFrames=ciscoEsStackSwitchInLongFrames, ciscoEsPortResetStats=ciscoEsPortResetStats, ciscoEsVLANInfoState=ciscoEsVLANInfoState, ciscoEsTftpServer=ciscoEsTftpServer, ciscoEsStackSwitchInShortFrames=ciscoEsStackSwitchInShortFrames, ciscoEsPortTable=ciscoEsPortTable, ciscoEsStackSwitchAddr=ciscoEsStackSwitchAddr, ciscoEsStackSwitchOutTotalFrames=ciscoEsStackSwitchOutTotalFrames, ciscoEsRouter=ciscoEsRouter, ciscoEsPortLongFrames=ciscoEsPortLongFrames, ciscoEsPortStnPortOfExit=ciscoEsPortStnPortOfExit, ciscoEsRouterTable=ciscoEsRouterTable, ciscoEsTrapRcvrIndex=ciscoEsTrapRcvrIndex, ciscoEsPortMdiMdix=ciscoEsPortMdiMdix, ciscoEsPortDemandAgingLevel=ciscoEsPortDemandAgingLevel, ciscoEsStackSwitchInNoSpaceFrames=ciscoEsStackSwitchInNoSpaceFrames, MacAddr=MacAddr, ciscoEsFilterRemotePort=ciscoEsFilterRemotePort, ciscoEsRouterEntry=ciscoEsRouterEntry, ciscoEsTrapRcvrIpAddress=ciscoEsTrapRcvrIpAddress, ciscoEsVLANStpBridgeMaxAge=ciscoEsVLANStpBridgeMaxAge, ciscoEsTransitedVLANs=ciscoEsTransitedVLANs, ciscoEsPortShortFrames=ciscoEsPortShortFrames, ciscoEsModTable=ciscoEsModTable, ciscoEsNetMask=ciscoEsNetMask, ciscoEsPortAddrAgingTime=ciscoEsPortAddrAgingTime, ciscoEsPortErrThreshold=ciscoEsPortErrThreshold, ciscoEsFilterSwitchNumber=ciscoEsFilterSwitchNumber, ciscoEsStackSwitchPorts=ciscoEsStackSwitchPorts, ciscoEsVLANInfoVLANNumber=ciscoEsVLANInfoVLANNumber, ciscoEsPortActiveMode=ciscoEsPortActiveMode, ciscoEsTftpServerDomain=ciscoEsTftpServerDomain, ciscoEsVLANInfoIpAddress=ciscoEsVLANInfoIpAddress, ciscoEsVLANInfoStp=ciscoEsVLANInfoStp, ciscoEsStack=ciscoEsStack, ciscoEsVLANInfoIpState=ciscoEsVLANInfoIpState, ciscoEsEChannel=ciscoEsEChannel, ciscoEsOptPortStaVal=ciscoEsOptPortStaVal, esStack=esStack, ciscoEsVLANInfoIpSubnetMask=ciscoEsVLANInfoIpSubnetMask, ciscoEsTransitedConfiguredVLANs=ciscoEsTransitedConfiguredVLANs, ciscoEsModRevision=ciscoEsModRevision, ciscoEsStackSwitchProbe=ciscoEsStackSwitchProbe, ciscoEsVLANStationBoxNum=ciscoEsVLANStationBoxNum, ciscoEsVLANStationAddress=ciscoEsVLANStationAddress, ciscoEsMain=ciscoEsMain, ciscoEsVLANStpEntry=ciscoEsVLANStpEntry, ciscoEsStackSwitchLongestHashChain=ciscoEsStackSwitchLongestHashChain, ciscoEsPortEntry=ciscoEsPortEntry, ciscoEsPortStnSrcFrames=ciscoEsPortStnSrcFrames, ciscoEsPort=ciscoEsPort, BridgeId=BridgeId, ciscoEsStackSwitchInErrFrames=ciscoEsStackSwitchInErrFrames, ciscoEsPortFastPort=ciscoEsPortFastPort, ciscoEsPortRemoteStations=ciscoEsPortRemoteStations, ciscoEsRouterPort=ciscoEsRouterPort, ciscoEsPortResetAddrs=ciscoEsPortResetAddrs, ciscoEsStackSwitchProbeDirection=ciscoEsStackSwitchProbeDirection, ciscoEsVLANInfoNumStations=ciscoEsVLANInfoNumStations, ciscoEsPortStrNFwdEntry=ciscoEsPortStrNFwdEntry, ciscoEsVLANStationEntry=ciscoEsVLANStationEntry, ciscoEsPortISLOperStatus=ciscoEsPortISLOperStatus, ciscoEsVLANPortVLANNumber=ciscoEsVLANPortVLANNumber, ciscoEsPortIfIndex=ciscoEsPortIfIndex, ciscoEsVLANPortTable=ciscoEsVLANPortTable, ciscoEsPortOprStatus=ciscoEsPortOprStatus, ciscoEsModUptime=ciscoEsModUptime, ciscoEsSysCurTime=ciscoEsSysCurTime, ciscoEsECTable=ciscoEsECTable, ciscoEsPortLocalStations=ciscoEsPortLocalStations, ciscoEsPortLinkState=ciscoEsPortLinkState, ciscoEsVLANStpRootCost=ciscoEsVLANStpRootCost, ciscoEsStackSwitchHwVersion=ciscoEsStackSwitchHwVersion, ciscoEsVLANStpForwardDelay=ciscoEsVLANStpForwardDelay, ciscoEsStackSwitchId=ciscoEsStackSwitchId, ciscoEsRouterBox=ciscoEsRouterBox, ciscoEsVLANTopologyChange=ciscoEsVLANTopologyChange, ciscoEsStackSwitchFeatureKey=ciscoEsStackSwitchFeatureKey, ciscoEsPortResetTimer=ciscoEsPortResetTimer, ciscoEsFilterMask=ciscoEsFilterMask, ciscoEsStackProStackMatrixChange=ciscoEsStackProStackMatrixChange, ciscoEsModule=ciscoEsModule, ciscoEsPortMaxStations=ciscoEsPortMaxStations, ciscoEsProStackMatrixStatus=ciscoEsProStackMatrixStatus, ciscoEsPortHashOverflows=ciscoEsPortHashOverflows, ciscoEsECSwitchNumber=ciscoEsECSwitchNumber, ciscoEsTrapRcvrEntry=ciscoEsTrapRcvrEntry, ciscoEsStackSwitchMemory=ciscoEsStackSwitchMemory, ciscoEsStackSwitchTemperature=ciscoEsStackSwitchTemperature, ciscoEsModSwitchNumber=ciscoEsModSwitchNumber, ciscoEsPortStnTable=ciscoEsPortStnTable, ciscoEsOptPortStaEntry=ciscoEsOptPortStaEntry, ciscoEsPortStnSwitchNumber=ciscoEsPortStnSwitchNumber, ciscoEsECNumber=ciscoEsECNumber, ciscoEsPortStnSrcBytes=ciscoEsPortStnSrcBytes, ciscoEsStackSwitchNumber=ciscoEsStackSwitchNumber, ciscoEsPortOutFrames=ciscoEsPortOutFrames, ciscoEsVLANStpTopChanges=ciscoEsVLANStpTopChanges, ciscoEsVLANStpBridgeHelloTime=ciscoEsVLANStpBridgeHelloTime, ciscoEsFilterType=ciscoEsFilterType, ciscoEsOptVLANStaTable=ciscoEsOptVLANStaTable, ciscoEsFilter=ciscoEsFilter, ciscoEsVLANPortPorts=ciscoEsVLANPortPorts, ciscoEsPortLearningState=ciscoEsPortLearningState, ciscoEsModEntry=ciscoEsModEntry, ciscoEsRouterRev=ciscoEsRouterRev, ciscoEsModType=ciscoEsModType, ciscoEsModNumPorts=ciscoEsModNumPorts, ciscoEsPortCfgMode=ciscoEsPortCfgMode, ciscoEsPortCDPTimeToLive=ciscoEsPortCDPTimeToLive, ciscoEsFilterPorts=ciscoEsFilterPorts, ciscoEsPortInFrames=ciscoEsPortInFrames, ciscoEsPortUnknownStaFrames=ciscoEsPortUnknownStaFrames, ciscoEsVLANStpHoldTime=ciscoEsVLANStpHoldTime, ciscoEsStackSwitchAgingLevel=ciscoEsStackSwitchAgingLevel, ciscoEsStackEntry=ciscoEsStackEntry, ciscoEsStackSwitchUptime=ciscoEsStackSwitchUptime, ciscoEsPortISLAdminStatus=ciscoEsPortISLAdminStatus, ciscoEsStackSwitchDplxCtrl=ciscoEsStackSwitchDplxCtrl, ciscoEsPortStnDestnFrames=ciscoEsPortStnDestnFrames, ciscoEsSetLock=ciscoEsSetLock, ciscoEsStackSwitchOutDroppedFrames=ciscoEsStackSwitchOutDroppedFrames, ciscoEsVLANStpMaxAge=ciscoEsVLANStpMaxAge, ciscoEsVLANNewRoot=ciscoEsVLANNewRoot, ciscoEsTftpFileLoc=ciscoEsTftpFileLoc, ciscoEsVLANInfoTable=ciscoEsVLANInfoTable, ciscoEsPortSwitchedFrames=ciscoEsPortSwitchedFrames, ciscoEsRouterBoardId=ciscoEsRouterBoardId, ciscoEsPortType=ciscoEsPortType, ciscoEsVLANStpTable=ciscoEsVLANStpTable, ciscoEsVLANInfoIfIndex=ciscoEsVLANInfoIfIndex, ciscoEsConfig=ciscoEsConfig, ciscoEsRouterNetAddr=ciscoEsRouterNetAddr, ciscoEsTrapRcvrComm=ciscoEsTrapRcvrComm, ciscoEsStackSwitchSoftwareFrames=ciscoEsStackSwitchSoftwareFrames, ciscoEsLLPortDsbld=ciscoEsLLPortDsbld, ciscoEsFilterStatus=ciscoEsFilterStatus, ciscoEsStackSwitchFeatureStatus=ciscoEsStackSwitchFeatureStatus, ciscoEsPortStnPortNum=ciscoEsPortStnPortNum, ciscoEsPortStnAddress=ciscoEsPortStnAddress, ciscoEsStackCfgChange=ciscoEsStackCfgChange, ciscoEsVLANStationPort=ciscoEsVLANStationPort, ciscoEsStackSwitchHashTableFulls=ciscoEsStackSwitchHashTableFulls, ciscoEsStackSwitchStatus=ciscoEsStackSwitchStatus, ciscoEsTrapRcvrTable=ciscoEsTrapRcvrTable, ciscoEsNumSwitches=ciscoEsNumSwitches, ciscoEsPortModNumber=ciscoEsPortModNumber, ciscoEsPortForwardedFrames=ciscoEsPortForwardedFrames, ciscoEsVLANStationVLANIndex=ciscoEsVLANStationVLANIndex, ciscoEsVLANStpDesignatedRoot=ciscoEsVLANStpDesignatedRoot, ciscoEsECEntry=ciscoEsECEntry, ciscoEsPortOutOctets=ciscoEsPortOutOctets, ciscoEsStackTempChange=ciscoEsStackTempChange, ciscoEsFilterRemoteSwitch=ciscoEsFilterRemoteSwitch, ciscoEsOptVLANStaVal=ciscoEsOptVLANStaVal)
