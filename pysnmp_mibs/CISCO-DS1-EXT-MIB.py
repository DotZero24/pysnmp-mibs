...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DS1-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:32:24 2025
...
_Cds1LoopbackCodeDetection_Type.__name__ = "TruthValue"
...
_Cds1Repetition_Type.__name__ = "ConfigIterator"
...
_Cds1CallTrunkConditionEnable_Type.__name__ = "TruthValue"
...
ciscoDs1MIBCompliance.setObjects(
      *(("CISCO-DS1-EXT-MIB", "ciscoDs1ConfMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1CurrentMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1AlarmConfigGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1Alarm15MinThreshGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1Alarm24HrThreshGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1Current24HrMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1Previous24HrMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1IntervalMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1TotalMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1StatsMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1FarEndStatsMIBGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDs1MIBComplianceRev1.setObjects(
      *(("CISCO-DS1-EXT-MIB", "ciscoDs1ConfMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1CurrentMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1AlarmConfigGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1Alarm15MinThreshGroup"),
        ...
        ("CISCO-DS1-EXT-MIB", "ciscoDs1StatsMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1FarEndStatsMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1BulkConfGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDs1MIBComplianceRev2.setObjects(
      *(("CISCO-DS1-EXT-MIB", "ciscoDs1ConfMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1CurrentMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1AlarmConfigGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1AlarmThreshGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1Alarm15MinThreshGroupRev1"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1Alarm24HrThreshGroupRev1"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1Current24HrMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1Previous24HrMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1IntervalMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1TotalMIBGroup"),
...
ciscoDs1MIBComplianceRev3.setObjects(
      *(("CISCO-DS1-EXT-MIB", "ciscoDs1ConfMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1CurrentMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1AlarmConfigGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1AlarmThreshGroup"),
        ...
        ("CISCO-DS1-EXT-MIB", "ciscoDs1FarEndStatsMIBGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1BulkConfGroup"),
        ("CISCO-DS1-EXT-MIB", "ciscoDs1CallGroup"),
        ("CISCO-DS1-EXT-MIB", "cds1NEOptionalNotificationsGroup"))
)
if mibBuilder.loadTexts:
