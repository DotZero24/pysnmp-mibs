...
fastPathTimeZonePrivate=ModuleIdentity((1,3,6,1,4,1,789,4413,1,1,42))
...
agentSystemTimeGroup=_AgentSystemTimeGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,42,1))
_AgentSystemTime_Type=DisplayString
_AgentSystemTime_Object=MibScalar
agentSystemTime=_AgentSystemTime_Object((1,3,6,1,4,1,789,4413,1,1,42,1,1),_AgentSystemTime_Type())
...
agentSystemDate=_AgentSystemDate_Object((1,3,6,1,4,1,789,4413,1,1,42,1,2),_AgentSystemDate_Type())
...
agentSystemTimeZoneAcronym=_AgentSystemTimeZoneAcronym_Object((1,3,6,1,4,1,789,4413,1,1,42,1,3),_AgentSystemTimeZoneAcronym_Type())
...
agentSystemTimeSource=_AgentSystemTimeSource_Object((1,3,6,1,4,1,789,4413,1,1,42,1,4),_AgentSystemTimeSource_Type())
...
agentSystemSummerTimeState=_AgentSystemSummerTimeState_Object((1,3,6,1,4,1,789,4413,1,1,42,1,5),_AgentSystemSummerTimeState_Type())
...
agentTimeZoneGroup=_AgentTimeZoneGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,42,2))
...
agentTimeZoneHoursOffset=_AgentTimeZoneHoursOffset_Object((1,3,6,1,4,1,789,4413,1,1,42,2,1),_AgentTimeZoneHoursOffset_Type())
...
agentTimeZoneMinutesOffset=_AgentTimeZoneMinutesOffset_Object((1,3,6,1,4,1,789,4413,1,1,42,2,2),_AgentTimeZoneMinutesOffset_Type())
...
agentTimeZoneAcronym=_AgentTimeZoneAcronym_Object((1,3,6,1,4,1,789,4413,1,1,42,2,3),_AgentTimeZoneAcronym_Type())
...
agentSummerTimeGroup=_AgentSummerTimeGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,42,3))
...
agentSummerTimeMode=_AgentSummerTimeMode_Object((1,3,6,1,4,1,789,4413,1,1,42,3,1),_AgentSummerTimeMode_Type())
...
agentSummerTimeRecurringGroup=_AgentSummerTimeRecurringGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,42,3,2))
...
agentStRecurringStartingWeek=_AgentStRecurringStartingWeek_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,1),_AgentStRecurringStartingWeek_Type())
...
agentStRecurringStartingDay=_AgentStRecurringStartingDay_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,2),_AgentStRecurringStartingDay_Type())
...
agentStRecurringStartingMonth=_AgentStRecurringStartingMonth_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,3),_AgentStRecurringStartingMonth_Type())
...
agentStRecurringStartingTime=_AgentStRecurringStartingTime_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,4),_AgentStRecurringStartingTime_Type())
...
agentStRecurringEndingWeek=_AgentStRecurringEndingWeek_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,5),_AgentStRecurringEndingWeek_Type())
...
agentStRecurringEndingDay=_AgentStRecurringEndingDay_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,6),_AgentStRecurringEndingDay_Type())
...
agentStRecurringEndingMonth=_AgentStRecurringEndingMonth_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,7),_AgentStRecurringEndingMonth_Type())
...
agentStRecurringEndingTime=_AgentStRecurringEndingTime_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,8),_AgentStRecurringEndingTime_Type())
...
agentStRecurringZoneAcronym=_AgentStRecurringZoneAcronym_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,9),_AgentStRecurringZoneAcronym_Type())
...
agentStRecurringZoneOffset=_AgentStRecurringZoneOffset_Object((1,3,6,1,4,1,789,4413,1,1,42,3,2,10),_AgentStRecurringZoneOffset_Type())
...
agentSummerTimeNonRecurringGroup=_AgentSummerTimeNonRecurringGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,42,3,3))
...
agentStNonRecurringStartingDay=_AgentStNonRecurringStartingDay_Object((1,3,6,1,4,1,789,4413,1,1,42,3,3,1),_AgentStNonRecurringStartingDay_Type())
...
agentStNonRecurringStartingMonth=_AgentStNonRecurringStartingMonth_Object((1,3,6,1,4,1,789,4413,1,1,42,3,3,2),_AgentStNonRecurringStartingMonth_Type())
...
agentStNonRecurringStartingYear=_AgentStNonRecurringStartingYear_Object((1,3,6,1,4,1,789,4413,1,1,42,3,3,3),_AgentStNonRecurringStartingYear_Type())
...
agentStNonRecurringStartingTime=_AgentStNonRecurringStartingTime_Object((1,3,6,1,4,1,789,4413,1,1,42,3,3,4),_AgentStNonRecurringStartingTime_Type())
...
agentStNonRecurringEndingDay=_AgentStNonRecurringEndingDay_Object((1,3,6,1,4,1,789,4413,1,1,42,3,3,5),_AgentStNonRecurringEndingDay_Type())
...
agentStNonRecurringEndingMonth=_AgentStNonRecurringEndingMonth_Object((1,3,6,1,4,1,789,4413,1,1,42,3,3,6),_AgentStNonRecurringEndingMonth_Type())
...
agentStNonRecurringEndingYear=_AgentStNonRecurringEndingYear_Object((1,3,6,1,4,1,789,4413,1,1,42,3,3,7),_AgentStNonRecurringEndingYear_Type())
...
agentStNonRecurringEndingTime=_AgentStNonRecurringEndingTime_Object((1,3,6,1,4,1,789,4413,1,1,42,3,3,8),_AgentStNonRecurringEndingTime_Type())
...
agentStNonRecurringZoneOffset=_AgentStNonRecurringZoneOffset_Object((1,3,6,1,4,1,789,4413,1,1,42,3,3,9),_AgentStNonRecurringZoneOffset_Type())
