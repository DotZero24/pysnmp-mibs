...
logServer=_LogServer_ObjectIdentity((1,3,6,1,4,1,3320,2,235))
_LogServerTable_Object=MibTable
logServerTable=_LogServerTable_Object((1,3,6,1,4,1,3320,2,235,1))
if mibBuilder.loadTexts:logServerTable.setStatus(_A)
_LogServerTableEntry_Object=MibTableRow
logServerTableEntry=_LogServerTableEntry_Object((1,3,6,1,4,1,3320,2,235,1,1))
...
logServerLevel=_LogServerLevel_Object((1,3,6,1,4,1,3320,2,235,1,1,1),_LogServerLevel_Type())
...
logServerAddr=_LogServerAddr_Object((1,3,6,1,4,1,3320,2,235,1,1,2),_LogServerAddr_Type())
...
logServerRowStatus=_LogServerRowStatus_Object((1,3,6,1,4,1,3320,2,235,1,1,3),_LogServerRowStatus_Type())
...
logServerOff=_LogServerOff_Object((1,3,6,1,4,1,3320,2,235,2),_LogServerOff_Type())
logServerOff.setMaxAccess(_D)
if mibBuilder.loadTexts:logServerOff.setStatus(_A)
_LogTrapTable_Object=MibTable
logTrapTable=_LogTrapTable_Object((1,3,6,1,4,1,3320,2,235,3))
if mibBuilder.loadTexts:logTrapTable.setStatus(_A)
_LogTrapTableEntry_Object=MibTableRow
logTrapTableEntry=_LogTrapTableEntry_Object((1,3,6,1,4,1,3320,2,235,3,1))
...
logTrapAddr=_LogTrapAddr_Object((1,3,6,1,4,1,3320,2,235,3,1,1),_LogTrapAddr_Type())
...
logTrapRowStatus=_LogTrapRowStatus_Object((1,3,6,1,4,1,3320,2,235,3,1,2),_LogTrapRowStatus_Type())
...
logTrapRfcVer=_LogTrapRfcVer_Object((1,3,6,1,4,1,3320,2,235,3,1,3),_LogTrapRfcVer_Type())
...
logTrapLevel=_LogTrapLevel_Object((1,3,6,1,4,1,3320,2,235,4),_LogTrapLevel_Type())
