...
_C='TruthValue'
_B='current'
_A='ARICENT-MPLS-NOTIFICATION-MIB'
...
fsMplsNotifications=_FsMplsNotifications_ObjectIdentity((1,3,6,1,4,1,2076,13,10,0))
...
fsMplsPwNotifStatusStr=_FsMplsPwNotifStatusStr_Object((1,3,6,1,4,1,2076,13,10,0,1),_FsMplsPwNotifStatusStr_Type())
...
fsMplsPwIndex=_FsMplsPwIndex_Object((1,3,6,1,4,1,2076,13,10,0,2),_FsMplsPwIndex_Type())
...
fsMplsNotifConfig=_FsMplsNotifConfig_ObjectIdentity((1,3,6,1,4,1,2076,13,10,1))
...
fsMplsPwStatusNotifEnable=_FsMplsPwStatusNotifEnable_Object((1,3,6,1,4,1,2076,13,10,1,1),_FsMplsPwStatusNotifEnable_Type())
...
fsMplsPwOAMStatusNotifEnable=_FsMplsPwOAMStatusNotifEnable_Object((1,3,6,1,4,1,2076,13,10,1,2),_FsMplsPwOAMStatusNotifEnable_Type())
fsMplsPwOAMStatusNotifEnable.setMaxAccess(_H)
if mibBuilder.loadTexts:fsMplsPwOAMStatusNotifEnable.setStatus(_I)
fsMplsPwOamStatus=NotificationType((1,3,6,1,4,1,2076,13,10,0,3))
fsMplsPwOamStatus.setObjects(*((_A,_D),(_A,_E)))
if mibBuilder.loadTexts:fsMplsPwOamStatus.setStatus(_I)
fsMplsPwStatus=NotificationType((1,3,6,1,4,1,2076,13,10,0,4))
