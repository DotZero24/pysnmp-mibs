...
mibBuilder.exportSymbols("LIEBERT-GP-ENVIRONMENTAL-MIB", lgpEnvConfigSupplyTempLowLimitDegC=lgpEnvConfigSupplyTempLowLimitDegC, lgpEnvMinDesiredRoomAirTemperature=lgpEnvMinDesiredRoomAirTemperature, lgpEnvConfigSleepModeDeadbandRangeDegF=lgpEnvConfigSleepModeDeadbandRangeDegF, lgpEnvReturnAirTemperature=lgpEnvReturnAirTemperature, lgpAcDcConverterTemperature=lgpAcDcConverterTemperature, lgpEnvExternalAirSensorB=lgpEnvExternalAirSensorB, lgpEnvTemperatureHighThresholdTenthsDegC=lgpEnvTemperatureHighThresholdTenthsDegC, lgpEnvStateHeatingUnit1=lgpEnvStateHeatingUnit1, lgpEnvStateFreeCooling=lgpEnvStateFreeCooling, lgpEnvTemperatureMeasurementDegF=lgpEnvTemperatureMeasurementDegF, lgpEnvDewPointTemperature=lgpEnvDewPointTemperature, lgpEnvHotWaterPoint=lgpEnvHotWaterPoint, lgpEnvExternalAirSensorBDewPoint=lgpEnvExternalAirSensorBDewPoint, lgpEnvTemperatureFahrenheit=lgpEnvTemperatureFahrenheit, lgpEnvTemperatureDeadbandRangeDegF=lgpEnvTemperatureDeadbandRangeDegF, lgpEnvTemperatureSetPointTenthsDegF=lgpEnvTemperatureSetPointTenthsDegF, lgpEnvStateDehumidifying=lgpEnvStateDehumidifying, lgpEnvSleepTimeStartHour=lgpEnvSleepTimeStartHour, lgpEnvStatisticsFanRunHr=lgpEnvStatisticsFanRunHr, lgpEnvHumidityDailyHighTimeMinute=lgpEnvHumidityDailyHighTimeMinute, lgpEnvSupplyAirHumidity=lgpEnvSupplyAirHumidity, lgpEnvConfigHumidityControl=lgpEnvConfigHumidityControl, lgpEnvHours=lgpEnvHours, lgpEnvInletDewPointTemperature=lgpEnvInletDewPointTemperature, lgpEnvComponentStateTable=lgpEnvComponentStateTable, lgpEnvStateOperatingEfficiency=lgpEnvStateOperatingEfficiency, lgpEnvTempDailyLowTimeMinuteDegF=lgpEnvTempDailyLowTimeMinuteDegF, lgpEnvTemperatureMeasurementTenthsDegC=lgpEnvTemperatureMeasurementTenthsDegC, lgpEnvHumidityTableRel=lgpEnvHumidityTableRel, lgpEnvStatistics=lgpEnvStatistics, lgpEnvControlStartupAfterDelay=lgpEnvControlStartupAfterDelay, lgpEnvHumidityDailyHighTimeSecond=lgpEnvHumidityDailyHighTimeSecond, lgpEnvTempHeatingPropBandTenthsDegC=lgpEnvTempHeatingPropBandTenthsDegC, lgpEnvRemoteSensorStatisticPoints=lgpEnvRemoteSensorStatisticPoints, lgpEnvState=lgpEnvState, lgpDigitalScrollCompressorTemperature=lgpDigitalScrollCompressorTemperature, lgpEnvHumidityDeadbandRange=lgpEnvHumidityDeadbandRange, lgpEnvTemperatureSettingDegF=lgpEnvTemperatureSettingDegF, lgpEnvHumidityHighThresholdRel=lgpEnvHumidityHighThresholdRel, lgpEnvTemperature=lgpEnvTemperature, lgpEnvSupplyAirTemperature=lgpEnvSupplyAirTemperature, lgpEnvStateDehumidifyingCapacity=lgpEnvStateDehumidifyingCapacity, lgpEnvTempDailyLowTimeHourDegF=lgpEnvTempDailyLowTimeHourDegF, lgpEnvTemperatureLowThresholdTenthsDegC=lgpEnvTemperatureLowThresholdTenthsDegC, lgpEnvStateElectricHeater=lgpEnvStateElectricHeater, lgpEnvEnclosureTemperatureSensors=lgpEnvEnclosureTemperatureSensors, lgpEnvValueAmbientHumidity=lgpEnvValueAmbientHumidity, lgpEnvControlTemperature=lgpEnvControlTemperature, lgpEnvHumidityDescrRel=lgpEnvHumidityDescrRel, lgpEnvConfigMaxFanSpeed=lgpEnvConfigMaxFanSpeed, lgpEnvConfigRestartDelay=lgpEnvConfigRestartDelay, lgpEnvConfigDisableSensorOffsetDegF=lgpEnvConfigDisableSensorOffsetDegF, lgpEnvTemperatureDescrDegF=lgpEnvTemperatureDescrDegF, lgpEnvHumidityDailyLowTimeMinute=lgpEnvHumidityDailyLowTimeMinute, lgpEnvConfigSupplyTempLowLimitDegF=lgpEnvConfigSupplyTempLowLimitDegF, lgpEnvTemperatureMeasurementTenthsDegF=lgpEnvTemperatureMeasurementTenthsDegF, lgpEnvOperationTimeValue=lgpEnvOperationTimeValue, lgpEnvRemoteSensorMinimumPoint=lgpEnvRemoteSensorMinimumPoint, lgpLocal3Temperature=lgpLocal3Temperature, lgpEnvTemperatureSettingDegC=lgpEnvTemperatureSettingDegC, lgpEnvTempCoolingPropBandTenthsDegC=lgpEnvTempCoolingPropBandTenthsDegC, lgpEnvRemoteSensorId=lgpEnvRemoteSensorId, lgpEnvConfigHumLockout=lgpEnvConfigHumLockout, lgpEnvStatisticsComp1RunHr=lgpEnvStatisticsComp1RunHr, lgpEnvTempDailyLowTimeSecondDegC=lgpEnvTempDailyLowTimeSecondDegC, lgpEnvReturnFluidTemperature=lgpEnvReturnFluidTemperature, lgpEnvConfigFanSpeedControlSensor=lgpEnvConfigFanSpeedControlSensor, lgpLocalTemperature=lgpLocalTemperature, lgpEnvHumidifierPoint=lgpEnvHumidifierPoint, lgpEnvPumpPoints=lgpEnvPumpPoints, lgpEnvValveTable=lgpEnvValveTable, lgpEnvRemoteSensorAveragePoint=lgpEnvRemoteSensorAveragePoint, lgpEnvTemperatureLowThresholdDegC=lgpEnvTemperatureLowThresholdDegC, lgpEnvStateGeneralAlarmOutput=lgpEnvStateGeneralAlarmOutput, lgpEnvStateCoolingUnit1=lgpEnvStateCoolingUnit1, lgpEnvPump1Point=lgpEnvPump1Point, lgpEnvTemperatureIdDegC=lgpEnvTemperatureIdDegC, lgpEnvTempDailyHighTimeSecondDegC=lgpEnvTempDailyHighTimeSecondDegC, lgpEnvHumidifyPropBand=lgpEnvHumidifyPropBand, lgpEnvTemperatureControlMode=lgpEnvTemperatureControlMode, lgpEnvHotGasPoint=lgpEnvHotGasPoint, lgpLocal2Temperature=lgpLocal2Temperature, lgpEnvStatisticsComp3RunHr=lgpEnvStatisticsComp3RunHr, lgpEnvTemperatureEntryDegC=lgpEnvTemperatureEntryDegC, lgpEnvExternalAirSensorA=lgpEnvExternalAirSensorA, lgpEnvHumidityHighThresholdRelTenths=lgpEnvHumidityHighThresholdRelTenths, lgpEnvSleepAllDayEnabled=lgpEnvSleepAllDayEnabled, lgpEnvTemperatureDailyHighDegC=lgpEnvTemperatureDailyHighDegC, lgpAmbientTemperature=lgpAmbientTemperature, lgpEnvConfigFanSpeedPropBandDegF=lgpEnvConfigFanSpeedPropBandDegF, lgpEnvTemperatureSetPointDegF=lgpEnvTemperatureSetPointDegF, lgpEnvTempHeatingPropBandTenthsDegF=lgpEnvTempHeatingPropBandTenthsDegF, lgpEnvSupplyFluidTemperature=lgpEnvSupplyFluidTemperature, lgpEnvRemoteSensorCalc=lgpEnvRemoteSensorCalc, lgpEnvConfigMinFanSpeed=lgpEnvConfigMinFanSpeed, lgpEnvDehumidifyPropBand=lgpEnvDehumidifyPropBand, lgpEnvHumidityLowThresholdRelTenths=lgpEnvHumidityLowThresholdRelTenths, lgpEnvHumidityDeadBand=lgpEnvHumidityDeadBand, lgpEnvRemoteSensorUsrLabel=lgpEnvRemoteSensorUsrLabel, lgpEnvConfigSleepMode=lgpEnvConfigSleepMode, lgpEnvSleepTimeStartMinute=lgpEnvSleepTimeStartMinute, lgpEnvSleepDayEntry=lgpEnvSleepDayEntry, lgpEnvStateHotWater=lgpEnvStateHotWater, lgpEnvStatisticsReheat3RunHr=lgpEnvStatisticsReheat3RunHr, lgpEnvSleepDayTable=lgpEnvSleepDayTable, lgpEnvSupplyRefrigerantTemperature=lgpEnvSupplyRefrigerantTemperature, lgpEnvStatisticsHumidifyModeHrs=lgpEnvStatisticsHumidifyModeHrs, lgpEnvConfigChillWaterControl=lgpEnvConfigChillWaterControl, lgpEnvConfigDisableSensorOffsetDegC=lgpEnvConfigDisableSensorOffsetDegC, lgpEnvTemperatureHighThresholdDegC=lgpEnvTemperatureHighThresholdDegC, lgpEnvStateOperatingMode=lgpEnvStateOperatingMode, lgpEnvPump2Point=lgpEnvPump2Point, lgpEnvStatisticsHotWaterRunHr=lgpEnvStatisticsHotWaterRunHr, lgpEnvCompressor2Point=lgpEnvCompressor2Point, lgpEnvDewPointTemperatures=lgpEnvDewPointTemperatures, lgpEnvTemperatureCelsius=lgpEnvTemperatureCelsius, lgpEnvConfigFanSpeedPropBandDegC=lgpEnvConfigFanSpeedPropBandDegC, lgpEnvControl=lgpEnvControl, lgpEnvOperationTimeSubID=lgpEnvOperationTimeSubID, lgpEnvHotGasValve1Point=lgpEnvHotGasValve1Point, lgpEnvStateCoolingUnit2=lgpEnvStateCoolingUnit2, lgpEnvConfigFreecoolingDeltaDegF=lgpEnvConfigFreecoolingDeltaDegF, lgpEnvTemperatureSetPointTenthsDegC=lgpEnvTemperatureSetPointTenthsDegC, lgpEnvStateCooling=lgpEnvStateCooling, lgpEnvComponentStateEntry=lgpEnvComponentStateEntry, lgpEnvSleepTimeStopMinute=lgpEnvSleepTimeStopMinute, lgpEnvConfigFilterServiceInterval=lgpEnvConfigFilterServiceInterval, lgpEnvStateHeatingUnit4=lgpEnvStateHeatingUnit4, lgpEnvConfigReheatAndHumidifierLockout=lgpEnvConfigReheatAndHumidifierLockout, lgpEnvTempDailyLowTimeSecondDegF=lgpEnvTempDailyLowTimeSecondDegF, lgpEnvCompressorPoint=lgpEnvCompressorPoint, lgpEnvElectricHeaterPoint=lgpEnvElectricHeaterPoint, lgpEnvTemperatureToleranceDegC=lgpEnvTemperatureToleranceDegC, lgpEnvTemperatureWellKnown=lgpEnvTemperatureWellKnown, lgpEnvStatisticsReheat2RunHr=lgpEnvStatisticsReheat2RunHr, lgpEnvHumidityWellKnown=lgpEnvHumidityWellKnown, lgpEnvRemoteSensorMode=lgpEnvRemoteSensorMode, lgpEnvTemperatureIdDegF=lgpEnvTemperatureIdDegF, lgpEnvConfigCoolingServiceInterval=lgpEnvConfigCoolingServiceInterval, lgpEnvOperationalTimeTable=lgpEnvOperationalTimeTable, lgpEnvConfigSensorEventsStandard=lgpEnvConfigSensorEventsStandard, lgpCoolantTemperature=lgpCoolantTemperature, lgpEnvStateOperatingReason=lgpEnvStateOperatingReason, lgpEnvValveDescr=lgpEnvValveDescr, lgpEnvValvePositionTenths=lgpEnvValvePositionTenths, lgpEnvConfigSensorEvents1=lgpEnvConfigSensorEvents1, lgpEnvWellKnownUnits=lgpEnvWellKnownUnits, lgpEnvSleepIntervalTimeEntry=lgpEnvSleepIntervalTimeEntry, lgpEnvValueAmbientRoomTemperature=lgpEnvValueAmbientRoomTemperature, lgpDigitalScrollCompressor2Temperature=lgpDigitalScrollCompressor2Temperature, lgpEnvTemperatureToleranceDegF=lgpEnvTemperatureToleranceDegF, lgpEnvSleepDayIndex=lgpEnvSleepDayIndex, lgpEnvTemperatureTableDegC=lgpEnvTemperatureTableDegC, lgpEnvHumidityIdRel=lgpEnvHumidityIdRel, lgpEnvAdjustedTemperature=lgpEnvAdjustedTemperature, lgpEnvTemperatureEntryDegF=lgpEnvTemperatureEntryDegF, lgpEnvStateCoolingUnit3=lgpEnvStateCoolingUnit3, lgpEnvTemperatureDescrDegC=lgpEnvTemperatureDescrDegC, lgpEnvConfigBmsResetTimer=lgpEnvConfigBmsResetTimer, lgpEnvPoints=lgpEnvPoints, lgpEnvConfigLocalTemperatureUnit=lgpEnvConfigLocalTemperatureUnit, lgpEnvStateHumidifying=lgpEnvStateHumidifying, lgpEnvTempDailyHighTimeHourDegC=lgpEnvTempDailyHighTimeHourDegC, lgpEnvTemperatureLowThresholdDegF=lgpEnvTemperatureLowThresholdDegF, lgpEnvHumidityDailyLow=lgpEnvHumidityDailyLow, lgpEnvComponentStateIndex=lgpEnvComponentStateIndex, lgpEnvHumidityDailyLowTimeSecond=lgpEnvHumidityDailyLowTimeSecond, lgpEnvCompressor2APoint=lgpEnvCompressor2APoint, lgpEnvStateHeatingCapacity=lgpEnvStateHeatingCapacity, lgpEnvHumidityEntryRel=lgpEnvHumidityEntryRel, lgpEnvConfigInfaredFlushRate=lgpEnvConfigInfaredFlushRate, lgpEnvConfigTempControlAlgorithm=lgpEnvConfigTempControlAlgorithm, lgpEnvHotGasValve2Point=lgpEnvHotGasValve2Point, lgpEnvConfigHumidityIntegTime=lgpEnvConfigHumidityIntegTime, lgpEnvConfigFanSpeedCapacity=lgpEnvConfigFanSpeedCapacity, lgpEnvTemperatureLowThresholdTenthsDegF=lgpEnvTemperatureLowThresholdTenthsDegF, lgpEnvTemperatureDailyLowDegC=lgpEnvTemperatureDailyLowDegC, lgpEnvStatisticsCoolingModeHrs=lgpEnvStatisticsCoolingModeHrs, lgpChillWaterTemperature=lgpChillWaterTemperature, lgpEnvTemperatureHighThresholdTenthsDegF=lgpEnvTemperatureHighThresholdTenthsDegF, lgpEnvOperationTimeIndex=lgpEnvOperationTimeIndex, lgpEnvEnclosureTemperatureSensor4=lgpEnvEnclosureTemperatureSensor4, lgpEnvChilledWaterPoint=lgpEnvChilledWaterPoint, lgpEnvStateHeatingUnits=lgpEnvStateHeatingUnits, lgpEnvTempDailyHighTimeMinuteDegC=lgpEnvTempDailyHighTimeMinuteDegC, lgpEnvRemoteSensorTempMeasurementDegC=lgpEnvRemoteSensorTempMeasurementDegC, lgpEnvHumidity=lgpEnvHumidity, lgpEnvTempDailyHighTimeMinuteDegF=lgpEnvTempDailyHighTimeMinuteDegF, lgpEnvTempDailyHighTimeSecondDegF=lgpEnvTempDailyHighTimeSecondDegF, lgpInverterTemperature=lgpInverterTemperature, lgpPfcTemperature=lgpPfcTemperature, lgpEnvHumiditySettingRel=lgpEnvHumiditySettingRel, lgpEnvComponentStateDescr=lgpEnvComponentStateDescr, lgpEnvStateCoolingCapacity=lgpEnvStateCoolingCapacity, lgpEnvConfigAirTemperatureControlSensor=lgpEnvConfigAirTemperatureControlSensor, lgpEnvSleepIntervalTimeTable=lgpEnvSleepIntervalTimeTable, lgpEnvConfigCompressorLockout=lgpEnvConfigCompressorLockout, lgpEnvSleepTimeSubID=lgpEnvSleepTimeSubID, lgpEnvStatisticsComp4RunHr=lgpEnvStatisticsComp4RunHr, lgpEnvDehumidifierPoint=lgpEnvDehumidifierPoint, lgpEnvSleepTimeIndex=lgpEnvSleepTimeIndex, lgpEnvTemperatureHighThresholdDegF=lgpEnvTemperatureHighThresholdDegF, lgpEnvSleepDay=lgpEnvSleepDay, lgpEnvHumidityLowThresholdRel=lgpEnvHumidityLowThresholdRel, lgpEnvBatteryCabinetPoint=lgpEnvBatteryCabinetPoint, lgpEnvOperationalTimeEntry=lgpEnvOperationalTimeEntry, lgpEnvConfigSleepModeDeadbandRange=lgpEnvConfigSleepModeDeadbandRange, lgpEnvReturnAirHumidity=lgpEnvReturnAirHumidity, lgpEnvValveEntry=lgpEnvValveEntry, lgpEnvFreeCoolingPoint=lgpEnvFreeCoolingPoint, lgpEnvValvePoints=lgpEnvValvePoints, lgpEnvStateHeatingUnit3=lgpEnvStateHeatingUnit3, lgpEnvConfigSupplyTempLowLimit=lgpEnvConfigSupplyTempLowLimit, lgpEnvWellKnownPoints=lgpEnvWellKnownPoints, lgpEnvStateFanCapacity=lgpEnvStateFanCapacity, lgpEnvEnclosureTemperatureSensor1=lgpEnvEnclosureTemperatureSensor1, lgpEnvRemoteSensorTempMeasurementDegF=lgpEnvRemoteSensorTempMeasurementDegF, lgpEnvStateHumidifyingCapacity=lgpEnvStateHumidifyingCapacity, lgpEnvStateAudibleAlarm=lgpEnvStateAudibleAlarm, lgpEnvStateCoolingUnit4=lgpEnvStateCoolingUnit4, lgpEnvStateFan=lgpEnvStateFan, lgpEnvConfigDeltaGlycolType=lgpEnvConfigDeltaGlycolType, lgpEnvConfigFreecoolingDeltaDegC=lgpEnvConfigFreecoolingDeltaDegC, lgpEnvOperationTimeHighWarning=lgpEnvOperationTimeHighWarning, lgpEnvStatisticsComp2RunHr=lgpEnvStatisticsComp2RunHr, lgpEnvHumidityMeasurementRel=lgpEnvHumidityMeasurementRel, lgpEnvCompressorPoints=lgpEnvCompressorPoints, lgpEnvRemoteSensorTable=lgpEnvRemoteSensorTable, lgpEnvCompressor1Point=lgpEnvCompressor1Point, liebertGlobalProductsEnvironmentalModule=liebertGlobalProductsEnvironmentalModule, lgpEnvTempDailyLowTimeMinuteDegC=lgpEnvTempDailyLowTimeMinuteDegC, lgpEnvStatisticsHotGasRunHr=lgpEnvStatisticsHotGasRunHr, lgpEnvConfigSleepModeDeadbandRangeDegC=lgpEnvConfigSleepModeDeadbandRangeDegC, lgpEnvStatisticsFreeCoolRunHr=lgpEnvStatisticsFreeCoolRunHr, lgpEnvTemperatureDeadBandTenthsDegC=lgpEnvTemperatureDeadBandTenthsDegC, lgpEnvValveIndex=lgpEnvValveIndex, lgpEnvRemoteSensorIndex=lgpEnvRemoteSensorIndex, lgpEnvHumidityToleranceRel=lgpEnvHumidityToleranceRel, lgpEnvHumidityDailyLowTimeHour=lgpEnvHumidityDailyLowTimeHour, lgpEnvStatisticsHumRunHr=lgpEnvStatisticsHumRunHr, lgpEnvCompressor1BPoint=lgpEnvCompressor1BPoint, lgpEnvStateEconoCycle=lgpEnvStateEconoCycle, lgpEnvCompressor2BPoint=lgpEnvCompressor2BPoint, lgpEnvRemoteSensorMaximumPoint=lgpEnvRemoteSensorMaximumPoint, lgpEnvStateCoolingUnits=lgpEnvStateCoolingUnits, lgpEnvConfigFanSpeedMode=lgpEnvConfigFanSpeedMode, lgpEnvExternalSensors=lgpEnvExternalSensors, lgpEnvEnclosureTemperature=lgpEnvEnclosureTemperature, lgpEnvStateHeatingUnit2=lgpEnvStateHeatingUnit2, lgpEnvOperationTimeUnit=lgpEnvOperationTimeUnit, lgpLocal1Temperature=lgpLocal1Temperature, lgpEnvConfigTemperatureIntegTime=lgpEnvConfigTemperatureIntegTime, lgpEnvStatisticsHeatingModeHrs=lgpEnvStatisticsHeatingModeHrs, lgpEnvTemperatureDailyHighDegF=lgpEnvTemperatureDailyHighDegF)
mibBuilder.exportSymbols("LIEBERT-GP-ENVIRONMENTAL-MIB", lgpEnvRemoteSensorEntry=lgpEnvRemoteSensorEntry, lgpEnvHumidityMeasurementRelTenths=lgpEnvHumidityMeasurementRelTenths, lgpEnvCompressor1APoint=lgpEnvCompressor1APoint, lgpEnvExternalAirSensorADewPoint=lgpEnvExternalAirSensorADewPoint, lgpEnvConfigAutoConfiguration=lgpEnvConfigAutoConfiguration, lgpEnvHumidityDailyHigh=lgpEnvHumidityDailyHigh, lgpEnvStateHeating=lgpEnvStateHeating, lgpEnvStateFreeCoolingCapacity=lgpEnvStateFreeCoolingCapacity, lgpEnvComponentState=lgpEnvComponentState, lgpEnvControlHumidity=lgpEnvControlHumidity, lgpDigitalScrollCompressor1Temperature=lgpDigitalScrollCompressor1Temperature, lgpEnvConfigReheatLockout=lgpEnvConfigReheatLockout, lgpEnvHumidityRelative=lgpEnvHumidityRelative, lgpEnvUnits=lgpEnvUnits, lgpEnvOperationTimePoint=lgpEnvOperationTimePoint, lgpEnvConfigRemoteShutdown=lgpEnvConfigRemoteShutdown, lgpEnvControlShutdownAfterDelay=lgpEnvControlShutdownAfterDelay, lgpEnvStatisticsDehumidifyModeHrs=lgpEnvStatisticsDehumidifyModeHrs, lgpEnvRemoteSensors=lgpEnvRemoteSensors, lgpEnvFanPoint=lgpEnvFanPoint, lgpEnvSleepTimeStopHour=lgpEnvSleepTimeStopHour, lgpEnvTemperatureTableDegF=lgpEnvTemperatureTableDegF, lgpEnvStateSystem=lgpEnvStateSystem, lgpEnvEnclosureTemperatureSensor3=lgpEnvEnclosureTemperatureSensor3, lgpEnvTempDailyLowTimeHourDegC=lgpEnvTempDailyLowTimeHourDegC, lgpEnvTemperatureDailyLowDegF=lgpEnvTemperatureDailyLowDegF, lgpEnvHumiditySetPoint=lgpEnvHumiditySetPoint, lgpEnvStatisticsReheat1RunHr=lgpEnvStatisticsReheat1RunHr, lgpTransformerTemperature=lgpTransformerTemperature, lgpEnvConfig=lgpEnvConfig, lgpEnvConfigHumidifierServiceInterval=lgpEnvConfigHumidifierServiceInterval, lgpBatteryTempterature=lgpBatteryTempterature, lgpEnvEnclosureTemperatureSensor2=lgpEnvEnclosureTemperatureSensor2, lgpEnvTemperatureMeasurementDegC=lgpEnvTemperatureMeasurementDegC, lgpEnvTempCoolingPropBandTenthsDegF=lgpEnvTempCoolingPropBandTenthsDegF, lgpEnvTemperatureDeadBandTenthsDegF=lgpEnvTemperatureDeadBandTenthsDegF, PYSNMP_MODULE_ID=liebertGlobalProductsEnvironmentalModule, lgpEnvTemperatureDeadbandRangeDegC=lgpEnvTemperatureDeadbandRangeDegC, lgpEnvHumidityDailyHighTimeHour=lgpEnvHumidityDailyHighTimeHour, lgpEnvTempDailyHighTimeHourDegF=lgpEnvTempDailyHighTimeHourDegF, lgpEnvConfigCabinetSensorAlarms=lgpEnvConfigCabinetSensorAlarms, lgpEnvValveState=lgpEnvValveState, lgpEnvTemperatureSetPointDegC=lgpEnvTemperatureSetPointDegC)
