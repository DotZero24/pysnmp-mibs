...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/liebert/LIEBERT-GP-ENVIRONMENTAL-MIB
...
lgpEnvReturnFluidTemperature = ObjectIdentity((1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 4, 1, 1, 24))
if mibBuilder.loadTexts: lgpEnvReturnFluidTemperature.setStatus('current')
...
mibBuilder.exportSymbols("LIEBERT-GP-ENVIRONMENTAL-MIB", lgpEnvTemperatureSetPointTenthsDegC=lgpEnvTemperatureSetPointTenthsDegC, lgpEnvConfig=lgpEnvConfig, lgpEnvStatisticsHotWaterRunHr=lgpEnvStatisticsHotWaterRunHr, lgpEnvTemperatureLowThresholdDegF=lgpEnvTemperatureLowThresholdDegF, lgpEnvReturnAirHumidity=lgpEnvReturnAirHumidity, lgpEnvConfigReheatAndHumidifierLockout=lgpEnvConfigReheatAndHumidifierLockout, lgpDigitalScrollCompressor2Temperature=lgpDigitalScrollCompressor2Temperature, lgpEnvEnclosureTemperatureSensor2=lgpEnvEnclosureTemperatureSensor2, lgpEnvTempDailyLowTimeSecondDegF=lgpEnvTempDailyLowTimeSecondDegF, lgpEnvExternalAirSensorA=lgpEnvExternalAirSensorA, lgpEnvConfigDisableSensorOffsetDegC=lgpEnvConfigDisableSensorOffsetDegC, lgpEnvHumidityDailyLowTimeHour=lgpEnvHumidityDailyLowTimeHour, lgpEnvTemperature=lgpEnvTemperature, lgpEnvStatistics=lgpEnvStatistics, lgpEnvTemperatureTableDegF=lgpEnvTemperatureTableDegF, lgpLocal2Temperature=lgpLocal2Temperature, lgpEnvConfigSleepModeDeadbandRangeDegC=lgpEnvConfigSleepModeDeadbandRangeDegC, liebertGlobalProductsEnvironmentalModule=liebertGlobalProductsEnvironmentalModule, lgpEnvTemperatureTableDegC=lgpEnvTemperatureTableDegC, lgpEnvTemperatureDailyHighDegC=lgpEnvTemperatureDailyHighDegC, lgpEnvTemperatureSettingDegF=lgpEnvTemperatureSettingDegF, lgpEnvConfigFilterServiceInterval=lgpEnvConfigFilterServiceInterval, lgpEnvPump1Point=lgpEnvPump1Point, lgpEnvHotGasValve1Point=lgpEnvHotGasValve1Point, lgpEnvTemperatureDailyLowDegF=lgpEnvTemperatureDailyLowDegF, lgpEnvSupplyAirHumidity=lgpEnvSupplyAirHumidity, lgpEnvCompressor1APoint=lgpEnvCompressor1APoint, lgpEnvSleepDayIndex=lgpEnvSleepDayIndex, lgpEnvTemperatureMeasurementTenthsDegF=lgpEnvTemperatureMeasurementTenthsDegF, lgpEnvTemperatureLowThresholdDegC=lgpEnvTemperatureLowThresholdDegC, lgpEnvStateHeatingUnit3=lgpEnvStateHeatingUnit3, lgpEnvTemperatureLowThresholdTenthsDegC=lgpEnvTemperatureLowThresholdTenthsDegC, lgpEnvTemperatureHighThresholdDegF=lgpEnvTemperatureHighThresholdDegF, lgpEnvFreeCoolingPoint=lgpEnvFreeCoolingPoint, lgpEnvConfigSupplyTempLowLimitDegF=lgpEnvConfigSupplyTempLowLimitDegF, lgpEnvCompressor2APoint=lgpEnvCompressor2APoint, lgpEnvStatisticsFreeCoolRunHr=lgpEnvStatisticsFreeCoolRunHr, lgpEnvTemperatureDeadbandRangeDegC=lgpEnvTemperatureDeadbandRangeDegC, lgpEnvStateOperatingMode=lgpEnvStateOperatingMode, lgpEnvStateCoolingUnits=lgpEnvStateCoolingUnits, lgpEnvConfigFanSpeedCapacity=lgpEnvConfigFanSpeedCapacity, lgpEnvConfigSensorEvents1=lgpEnvConfigSensorEvents1, lgpEnvHumidityWellKnown=lgpEnvHumidityWellKnown, lgpEnvCompressor2BPoint=lgpEnvCompressor2BPoint, lgpEnvConfigCompressorLockout=lgpEnvConfigCompressorLockout, lgpEnvTemperatureSetPointDegF=lgpEnvTemperatureSetPointDegF, lgpEnvElectricHeaterPoint=lgpEnvElectricHeaterPoint, lgpEnvValveTable=lgpEnvValveTable, lgpEnvControl=lgpEnvControl, lgpEnvOperationalTimeEntry=lgpEnvOperationalTimeEntry, lgpEnvHumidityDailyHighTimeMinute=lgpEnvHumidityDailyHighTimeMinute, lgpDigitalScrollCompressor1Temperature=lgpDigitalScrollCompressor1Temperature, lgpEnvReturnFluidTemperature=lgpEnvReturnFluidTemperature, lgpEnvChilledWaterPoint=lgpEnvChilledWaterPoint, lgpEnvStatisticsComp1RunHr=lgpEnvStatisticsComp1RunHr, lgpEnvConfigHumidityIntegTime=lgpEnvConfigHumidityIntegTime, lgpEnvComponentStateIndex=lgpEnvComponentStateIndex, lgpEnvStateFreeCooling=lgpEnvStateFreeCooling, lgpEnvTempHeatingPropBandTenthsDegF=lgpEnvTempHeatingPropBandTenthsDegF, lgpEnvStateFanCapacity=lgpEnvStateFanCapacity, lgpEnvRemoteSensorId=lgpEnvRemoteSensorId, lgpEnvValveState=lgpEnvValveState, lgpEnvRemoteSensorUsrLabel=lgpEnvRemoteSensorUsrLabel, lgpEnvStateHeating=lgpEnvStateHeating, lgpLocalTemperature=lgpLocalTemperature, lgpEnvOperationTimeSubID=lgpEnvOperationTimeSubID, lgpEnvConfigSupplyTempLowLimit=lgpEnvConfigSupplyTempLowLimit, lgpEnvConfigDisableSensorOffsetDegF=lgpEnvConfigDisableSensorOffsetDegF, lgpAmbientTemperature=lgpAmbientTemperature, lgpEnvStateCoolingUnit1=lgpEnvStateCoolingUnit1, lgpEnvTemperatureToleranceDegF=lgpEnvTemperatureToleranceDegF, lgpEnvTempDailyLowTimeSecondDegC=lgpEnvTempDailyLowTimeSecondDegC, lgpEnvConfigMinFanSpeed=lgpEnvConfigMinFanSpeed, lgpEnvCompressor1BPoint=lgpEnvCompressor1BPoint, lgpEnvStateSystem=lgpEnvStateSystem, PYSNMP_MODULE_ID=liebertGlobalProductsEnvironmentalModule, lgpEnvHumidityHighThresholdRel=lgpEnvHumidityHighThresholdRel, lgpEnvRemoteSensorMode=lgpEnvRemoteSensorMode, lgpEnvStateDehumidifyingCapacity=lgpEnvStateDehumidifyingCapacity, lgpEnvTemperatureEntryDegF=lgpEnvTemperatureEntryDegF, lgpEnvTempDailyHighTimeMinuteDegF=lgpEnvTempDailyHighTimeMinuteDegF, lgpEnvTemperatureDeadBandTenthsDegC=lgpEnvTemperatureDeadBandTenthsDegC, lgpEnvHumidityDeadBand=lgpEnvHumidityDeadBand, lgpEnvTempCoolingPropBandTenthsDegF=lgpEnvTempCoolingPropBandTenthsDegF, lgpEnvStateOperatingReason=lgpEnvStateOperatingReason, lgpEnvStateCoolingUnit3=lgpEnvStateCoolingUnit3, lgpEnvValveDescr=lgpEnvValveDescr, lgpEnvSleepTimeSubID=lgpEnvSleepTimeSubID, lgpEnvConfigTempControlAlgorithm=lgpEnvConfigTempControlAlgorithm, lgpEnvStatisticsHumidifyModeHrs=lgpEnvStatisticsHumidifyModeHrs, lgpEnvValveEntry=lgpEnvValveEntry, lgpEnvSleepIntervalTimeEntry=lgpEnvSleepIntervalTimeEntry, lgpEnvReturnAirTemperature=lgpEnvReturnAirTemperature, lgpEnvHumidityIdRel=lgpEnvHumidityIdRel, lgpEnvHumidityDailyHighTimeSecond=lgpEnvHumidityDailyHighTimeSecond, lgpTransformerTemperature=lgpTransformerTemperature, lgpEnvEnclosureTemperatureSensor1=lgpEnvEnclosureTemperatureSensor1, lgpEnvOperationTimeValue=lgpEnvOperationTimeValue, lgpEnvSleepTimeStopHour=lgpEnvSleepTimeStopHour, lgpEnvSleepAllDayEnabled=lgpEnvSleepAllDayEnabled, lgpInverterTemperature=lgpInverterTemperature, lgpEnvTempDailyLowTimeHourDegF=lgpEnvTempDailyLowTimeHourDegF, lgpEnvConfigTemperatureIntegTime=lgpEnvConfigTemperatureIntegTime, lgpEnvTemperatureHighThresholdDegC=lgpEnvTemperatureHighThresholdDegC, lgpEnvConfigReheatLockout=lgpEnvConfigReheatLockout, lgpEnvValvePoints=lgpEnvValvePoints, lgpEnvControlHumidity=lgpEnvControlHumidity, lgpEnvOperationTimeIndex=lgpEnvOperationTimeIndex, lgpEnvConfigFreecoolingDeltaDegC=lgpEnvConfigFreecoolingDeltaDegC, lgpEnvConfigInfaredFlushRate=lgpEnvConfigInfaredFlushRate, lgpEnvHumidifierPoint=lgpEnvHumidifierPoint, lgpEnvStateFan=lgpEnvStateFan, lgpEnvStatisticsComp2RunHr=lgpEnvStatisticsComp2RunHr, lgpEnvSupplyAirTemperature=lgpEnvSupplyAirTemperature, lgpEnvConfigSleepModeDeadbandRangeDegF=lgpEnvConfigSleepModeDeadbandRangeDegF, lgpEnvSleepTimeIndex=lgpEnvSleepTimeIndex, lgpEnvControlTemperature=lgpEnvControlTemperature, lgpEnvStateHotWater=lgpEnvStateHotWater, lgpEnvHours=lgpEnvHours, lgpEnvStateHeatingUnit2=lgpEnvStateHeatingUnit2, lgpEnvHumidityTableRel=lgpEnvHumidityTableRel, lgpEnvValueAmbientHumidity=lgpEnvValueAmbientHumidity, lgpEnvTempDailyLowTimeMinuteDegC=lgpEnvTempDailyLowTimeMinuteDegC, lgpEnvTemperatureSetPointDegC=lgpEnvTemperatureSetPointDegC, lgpEnvHumiditySetPoint=lgpEnvHumiditySetPoint, lgpEnvConfigHumLockout=lgpEnvConfigHumLockout, lgpEnvTempDailyHighTimeSecondDegF=lgpEnvTempDailyHighTimeSecondDegF, lgpEnvHumidityMeasurementRelTenths=lgpEnvHumidityMeasurementRelTenths, lgpEnvRemoteSensorCalc=lgpEnvRemoteSensorCalc, lgpEnvConfigHumidityControl=lgpEnvConfigHumidityControl, lgpEnvTemperatureDailyLowDegC=lgpEnvTemperatureDailyLowDegC, lgpEnvTemperatureControlMode=lgpEnvTemperatureControlMode, lgpEnvSleepDay=lgpEnvSleepDay, lgpEnvUnits=lgpEnvUnits, lgpEnvSleepIntervalTimeTable=lgpEnvSleepIntervalTimeTable, lgpEnvStatisticsHotGasRunHr=lgpEnvStatisticsHotGasRunHr, lgpEnvWellKnownUnits=lgpEnvWellKnownUnits, lgpEnvConfigMaxFanSpeed=lgpEnvConfigMaxFanSpeed, lgpEnvExternalAirSensorADewPoint=lgpEnvExternalAirSensorADewPoint, lgpEnvStatisticsFanRunHr=lgpEnvStatisticsFanRunHr, lgpEnvTemperatureEntryDegC=lgpEnvTemperatureEntryDegC, lgpEnvMinDesiredRoomAirTemperature=lgpEnvMinDesiredRoomAirTemperature, lgpEnvHumiditySettingRel=lgpEnvHumiditySettingRel, lgpEnvHumidityDailyLowTimeMinute=lgpEnvHumidityDailyLowTimeMinute, lgpEnvTemperatureDeadBandTenthsDegF=lgpEnvTemperatureDeadBandTenthsDegF, lgpEnvConfigDeltaGlycolType=lgpEnvConfigDeltaGlycolType, lgpEnvRemoteSensorIndex=lgpEnvRemoteSensorIndex, lgpEnvRemoteSensorTempMeasurementDegF=lgpEnvRemoteSensorTempMeasurementDegF, lgpEnvConfigSensorEventsStandard=lgpEnvConfigSensorEventsStandard, lgpEnvComponentState=lgpEnvComponentState, lgpEnvRemoteSensorMaximumPoint=lgpEnvRemoteSensorMaximumPoint, lgpEnvStatisticsDehumidifyModeHrs=lgpEnvStatisticsDehumidifyModeHrs, lgpEnvTemperatureCelsius=lgpEnvTemperatureCelsius, lgpEnvValueAmbientRoomTemperature=lgpEnvValueAmbientRoomTemperature, lgpEnvSupplyRefrigerantTemperature=lgpEnvSupplyRefrigerantTemperature, lgpEnvStateEconoCycle=lgpEnvStateEconoCycle, lgpEnvConfigFanSpeedMode=lgpEnvConfigFanSpeedMode, lgpEnvHumidityDescrRel=lgpEnvHumidityDescrRel, lgpEnvStateCooling=lgpEnvStateCooling, lgpEnvOperationTimePoint=lgpEnvOperationTimePoint, lgpEnvHumidityDailyHigh=lgpEnvHumidityDailyHigh, lgpEnvConfigAutoConfiguration=lgpEnvConfigAutoConfiguration, lgpEnvTemperatureMeasurementDegC=lgpEnvTemperatureMeasurementDegC, lgpDigitalScrollCompressorTemperature=lgpDigitalScrollCompressorTemperature, lgpEnvExternalSensors=lgpEnvExternalSensors, lgpEnvStateHumidifyingCapacity=lgpEnvStateHumidifyingCapacity, lgpEnvConfigAirTemperatureControlSensor=lgpEnvConfigAirTemperatureControlSensor, lgpEnvTemperatureSetPointTenthsDegF=lgpEnvTemperatureSetPointTenthsDegF, lgpEnvEnclosureTemperatureSensor3=lgpEnvEnclosureTemperatureSensor3, lgpEnvStateHumidifying=lgpEnvStateHumidifying, lgpEnvFanPoint=lgpEnvFanPoint, lgpEnvTemperatureHighThresholdTenthsDegC=lgpEnvTemperatureHighThresholdTenthsDegC, lgpEnvConfigSleepMode=lgpEnvConfigSleepMode, lgpEnvStateAudibleAlarm=lgpEnvStateAudibleAlarm, lgpEnvDehumidifierPoint=lgpEnvDehumidifierPoint, lgpEnvConfigLocalTemperatureUnit=lgpEnvConfigLocalTemperatureUnit, lgpEnvTemperatureMeasurementDegF=lgpEnvTemperatureMeasurementDegF, lgpEnvRemoteSensorEntry=lgpEnvRemoteSensorEntry, lgpEnvHumidityDailyLow=lgpEnvHumidityDailyLow, lgpEnvTempDailyHighTimeMinuteDegC=lgpEnvTempDailyHighTimeMinuteDegC, lgpEnvCompressorPoints=lgpEnvCompressorPoints, lgpBatteryTempterature=lgpBatteryTempterature, lgpEnvExternalAirSensorB=lgpEnvExternalAirSensorB, lgpEnvConfigCabinetSensorAlarms=lgpEnvConfigCabinetSensorAlarms, lgpEnvHumidity=lgpEnvHumidity, lgpEnvSupplyFluidTemperature=lgpEnvSupplyFluidTemperature, lgpEnvTempCoolingPropBandTenthsDegC=lgpEnvTempCoolingPropBandTenthsDegC, lgpEnvStateDehumidifying=lgpEnvStateDehumidifying, lgpEnvStatisticsComp3RunHr=lgpEnvStatisticsComp3RunHr, lgpEnvEnclosureTemperature=lgpEnvEnclosureTemperature, lgpCoolantTemperature=lgpCoolantTemperature, lgpEnvStatisticsComp4RunHr=lgpEnvStatisticsComp4RunHr, lgpEnvCompressorPoint=lgpEnvCompressorPoint, lgpEnvTempDailyHighTimeSecondDegC=lgpEnvTempDailyHighTimeSecondDegC, lgpEnvRemoteSensorAveragePoint=lgpEnvRemoteSensorAveragePoint, lgpEnvConfigRemoteShutdown=lgpEnvConfigRemoteShutdown, lgpEnvSleepTimeStartMinute=lgpEnvSleepTimeStartMinute, lgpEnvStateGeneralAlarmOutput=lgpEnvStateGeneralAlarmOutput, lgpEnvHumidityDeadbandRange=lgpEnvHumidityDeadbandRange, lgpEnvStateFreeCoolingCapacity=lgpEnvStateFreeCoolingCapacity, lgpEnvConfigChillWaterControl=lgpEnvConfigChillWaterControl, lgpEnvComponentStateEntry=lgpEnvComponentStateEntry, lgpEnvHotGasValve2Point=lgpEnvHotGasValve2Point, lgpEnvOperationTimeUnit=lgpEnvOperationTimeUnit, lgpEnvRemoteSensorMinimumPoint=lgpEnvRemoteSensorMinimumPoint, lgpEnvTemperatureIdDegF=lgpEnvTemperatureIdDegF, lgpEnvStatisticsReheat2RunHr=lgpEnvStatisticsReheat2RunHr, lgpEnvConfigSupplyTempLowLimitDegC=lgpEnvConfigSupplyTempLowLimitDegC, lgpEnvOperationalTimeTable=lgpEnvOperationalTimeTable, lgpEnvTemperatureWellKnown=lgpEnvTemperatureWellKnown, lgpEnvValveIndex=lgpEnvValveIndex, lgpEnvBatteryCabinetPoint=lgpEnvBatteryCabinetPoint, lgpChillWaterTemperature=lgpChillWaterTemperature, lgpEnvStateHeatingUnit4=lgpEnvStateHeatingUnit4, lgpEnvTemperatureDescrDegC=lgpEnvTemperatureDescrDegC, lgpEnvCompressor2Point=lgpEnvCompressor2Point, lgpEnvEnclosureTemperatureSensors=lgpEnvEnclosureTemperatureSensors, lgpEnvTempDailyHighTimeHourDegC=lgpEnvTempDailyHighTimeHourDegC, lgpEnvHumidityLowThresholdRelTenths=lgpEnvHumidityLowThresholdRelTenths, lgpEnvState=lgpEnvState, lgpEnvCompressor1Point=lgpEnvCompressor1Point, lgpEnvSleepTimeStopMinute=lgpEnvSleepTimeStopMinute, lgpEnvStateCoolingCapacity=lgpEnvStateCoolingCapacity, lgpEnvStatisticsReheat1RunHr=lgpEnvStatisticsReheat1RunHr, lgpPfcTemperature=lgpPfcTemperature, lgpEnvTemperatureHighThresholdTenthsDegF=lgpEnvTemperatureHighThresholdTenthsDegF, lgpEnvStateCoolingUnit2=lgpEnvStateCoolingUnit2, lgpEnvStatisticsHeatingModeHrs=lgpEnvStatisticsHeatingModeHrs, lgpEnvHotGasPoint=lgpEnvHotGasPoint, lgpEnvDewPointTemperatures=lgpEnvDewPointTemperatures, lgpEnvHumidityHighThresholdRelTenths=lgpEnvHumidityHighThresholdRelTenths, lgpEnvSleepDayTable=lgpEnvSleepDayTable, lgpEnvStateHeatingUnit1=lgpEnvStateHeatingUnit1, lgpEnvConfigFanSpeedPropBandDegC=lgpEnvConfigFanSpeedPropBandDegC, lgpLocal3Temperature=lgpLocal3Temperature, lgpEnvStatisticsReheat3RunHr=lgpEnvStatisticsReheat3RunHr, lgpEnvTempDailyLowTimeHourDegC=lgpEnvTempDailyLowTimeHourDegC, lgpEnvValvePositionTenths=lgpEnvValvePositionTenths, lgpEnvRemoteSensorTable=lgpEnvRemoteSensorTable, lgpEnvTemperatureFahrenheit=lgpEnvTemperatureFahrenheit, lgpEnvControlStartupAfterDelay=lgpEnvControlStartupAfterDelay, lgpEnvConfigCoolingServiceInterval=lgpEnvConfigCoolingServiceInterval, lgpEnvPumpPoints=lgpEnvPumpPoints, lgpEnvConfigRestartDelay=lgpEnvConfigRestartDelay, lgpEnvRemoteSensors=lgpEnvRemoteSensors, lgpEnvSleepDayEntry=lgpEnvSleepDayEntry, lgpEnvRemoteSensorStatisticPoints=lgpEnvRemoteSensorStatisticPoints, lgpEnvExternalAirSensorBDewPoint=lgpEnvExternalAirSensorBDewPoint, lgpEnvTempDailyHighTimeHourDegF=lgpEnvTempDailyHighTimeHourDegF, lgpEnvTemperatureIdDegC=lgpEnvTemperatureIdDegC, lgpAcDcConverterTemperature=lgpAcDcConverterTemperature, lgpEnvTemperatureDeadbandRangeDegF=lgpEnvTemperatureDeadbandRangeDegF, lgpEnvHotWaterPoint=lgpEnvHotWaterPoint, lgpEnvStateOperatingEfficiency=lgpEnvStateOperatingEfficiency)
mibBuilder.exportSymbols("LIEBERT-GP-ENVIRONMENTAL-MIB", lgpEnvComponentStateDescr=lgpEnvComponentStateDescr, lgpEnvPump2Point=lgpEnvPump2Point, lgpEnvTemperatureSettingDegC=lgpEnvTemperatureSettingDegC, lgpEnvDewPointTemperature=lgpEnvDewPointTemperature, lgpEnvControlShutdownAfterDelay=lgpEnvControlShutdownAfterDelay, lgpEnvStateCoolingUnit4=lgpEnvStateCoolingUnit4, lgpEnvHumidityToleranceRel=lgpEnvHumidityToleranceRel, lgpEnvTemperatureDescrDegF=lgpEnvTemperatureDescrDegF, lgpEnvOperationTimeHighWarning=lgpEnvOperationTimeHighWarning, lgpEnvTemperatureToleranceDegC=lgpEnvTemperatureToleranceDegC, lgpEnvHumidityDailyLowTimeSecond=lgpEnvHumidityDailyLowTimeSecond, lgpEnvSleepTimeStartHour=lgpEnvSleepTimeStartHour, lgpEnvWellKnownPoints=lgpEnvWellKnownPoints, lgpEnvConfigBmsResetTimer=lgpEnvConfigBmsResetTimer, lgpEnvRemoteSensorTempMeasurementDegC=lgpEnvRemoteSensorTempMeasurementDegC, lgpEnvStatisticsCoolingModeHrs=lgpEnvStatisticsCoolingModeHrs, lgpEnvTemperatureDailyHighDegF=lgpEnvTemperatureDailyHighDegF, lgpEnvHumidityLowThresholdRel=lgpEnvHumidityLowThresholdRel, lgpEnvConfigHumidifierServiceInterval=lgpEnvConfigHumidifierServiceInterval, lgpEnvInletDewPointTemperature=lgpEnvInletDewPointTemperature, lgpEnvHumidityMeasurementRel=lgpEnvHumidityMeasurementRel, lgpEnvTemperatureMeasurementTenthsDegC=lgpEnvTemperatureMeasurementTenthsDegC, lgpEnvEnclosureTemperatureSensor4=lgpEnvEnclosureTemperatureSensor4, lgpEnvStateHeatingUnits=lgpEnvStateHeatingUnits, lgpEnvHumidifyPropBand=lgpEnvHumidifyPropBand, lgpEnvStatisticsHumRunHr=lgpEnvStatisticsHumRunHr, lgpEnvConfigFanSpeedControlSensor=lgpEnvConfigFanSpeedControlSensor, lgpEnvHumidityRelative=lgpEnvHumidityRelative, lgpEnvDehumidifyPropBand=lgpEnvDehumidifyPropBand, lgpEnvStateElectricHeater=lgpEnvStateElectricHeater, lgpEnvTempHeatingPropBandTenthsDegC=lgpEnvTempHeatingPropBandTenthsDegC, lgpEnvPoints=lgpEnvPoints, lgpEnvConfigSleepModeDeadbandRange=lgpEnvConfigSleepModeDeadbandRange, lgpEnvComponentStateTable=lgpEnvComponentStateTable, lgpEnvStateHeatingCapacity=lgpEnvStateHeatingCapacity, lgpEnvTempDailyLowTimeMinuteDegF=lgpEnvTempDailyLowTimeMinuteDegF, lgpEnvAdjustedTemperature=lgpEnvAdjustedTemperature, lgpEnvConfigFreecoolingDeltaDegF=lgpEnvConfigFreecoolingDeltaDegF, lgpEnvTemperatureLowThresholdTenthsDegF=lgpEnvTemperatureLowThresholdTenthsDegF, lgpLocal1Temperature=lgpLocal1Temperature, lgpEnvConfigFanSpeedPropBandDegF=lgpEnvConfigFanSpeedPropBandDegF, lgpEnvHumidityDailyHighTimeHour=lgpEnvHumidityDailyHighTimeHour, lgpEnvHumidityEntryRel=lgpEnvHumidityEntryRel)
