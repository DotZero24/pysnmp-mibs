...
sonetLineCurrentStatus, sonetVTCurrentStatus, sonetPathCurrentStatus, sonetSectionCurrentStatus, sonetPathCurrentEntry = mibBuilder.importSymbols("SONET-MIB", "sonetLineCurrentStatus", "sonetVTCurrentStatus", "sonetPathCurrentStatus", "sonetSectionCurrentStatus", "sonetPathCurrentEntry")
...
mibBuilder.exportSymbols("CISCO-SONET-MIB", cssTraceFailure=cssTraceFailure, ciscoSonetPathConfMIBGroup=ciscoSonetPathConfMIBGroup, cssTotalSESs=cssTotalSESs, cslTotalCVs=cslTotalCVs, ciscoSonetMIBConformance=ciscoSonetMIBConformance, csApsConfig=csApsConfig, csApsDirection=csApsDirection, ciscoSonetLineNotifGroup=ciscoSonetLineNotifGroup, cspTraceFailure=cspTraceFailure, csTributaryType=csTributaryType, cspSignallingTransportMode=cspSignallingTransportMode, ciscoSonetStatsMIBGroup=ciscoSonetStatsMIBGroup, csTributaryGroupingType=csTributaryGroupingType, cspTotalCVs=cspTotalCVs, csAu4Tug3ConfigEntry=csAu4Tug3ConfigEntry, csConfigFrameScramble=csConfigFrameScramble, csApsLineSwitchReason=csApsLineSwitchReason, cslFarEndTotalUASs=cslFarEndTotalUASs, ciscoSonetSectionNotifGroup=ciscoSonetSectionNotifGroup, csNotificationsEnabled=csNotificationsEnabled, csConfig=csConfig, csApsConfigTable=csApsConfigTable, cspFarEndTotalTable=cspFarEndTotalTable, ciscoSonetTraceMIBGroup=ciscoSonetTraceMIBGroup, csNotifications=csNotifications, cspTraceToExpect=cspTraceToExpect, CsApsLineFailureCode=CsApsLineFailureCode, cspConfig=cspConfig, ciscoSonetMIB=ciscoSonetMIB, ciscoSonetLineStatusChange=ciscoSonetLineStatusChange, cslAISs=cslAISs, csConfigEntry=csConfigEntry, cspTraceEntry=cspTraceEntry, ciscoSonetMIBCompliance3=ciscoSonetMIBCompliance3, csApsWorkingIndex=csApsWorkingIndex, cspFarEndTotalUASs=cspFarEndTotalUASs, csApsSigFaultBER=csApsSigFaultBER, cspTributaryGroupingType=cspTributaryGroupingType, cspTotalEntry=cspTotalEntry, cspFarEndTotalCVs=cspFarEndTotalCVs, cssLOFs=cssLOFs, cslFarEndTotalSESs=cslFarEndTotalSESs, csApsEnable=csApsEnable, cspTributaryMappingType=cspTributaryMappingType, ciscoSonetVTConfMIBGroup=ciscoSonetVTConfMIBGroup, csConfigRDIVType=csConfigRDIVType, csLine=csLine, csApsSigDegradeBER=csApsSigDegradeBER, ciscoSonetNotifEnableGroup=ciscoSonetNotifEnableGroup, cspTotalTable=cspTotalTable, cspConfigEntry=cspConfigEntry, cslTotalSESs=cslTotalSESs, CsApsLineFailureStatus=CsApsLineFailureStatus, cspConfigTable=cspConfigTable, csAu4Tug3=csAu4Tug3, ciscoSonetVTStatusChange=ciscoSonetVTStatusChange, ciscoSonetVTNotifGroup=ciscoSonetVTNotifGroup, csConfigLoopbackType=csConfigLoopbackType, cssLOSs=cssLOSs, CsApsLineSwitchReason=CsApsLineSwitchReason, ciscoSonetMIBCompliance1=ciscoSonetMIBCompliance1, csApsRevertive=csApsRevertive, ciscoSonetMIBCompliance2=ciscoSonetMIBCompliance2, csApsWaitToRestore=csApsWaitToRestore, cssTraceReceived=cssTraceReceived, csStats=csStats, csAu4Tug3Payload=csAu4Tug3Payload, cslRFIs=cslRFIs, cslFarEndTotalESs=cslFarEndTotalESs, cspTraceReceived=cspTraceReceived, csPath=csPath, csApsArchModeOperational=csApsArchModeOperational, ciscoSonetMIBCompliances=ciscoSonetMIBCompliances, ciscoSonetAu4Tug3Group=ciscoSonetAu4Tug3Group, cslFarEndTotalTable=cslFarEndTotalTable, cslTotalEntry=cslTotalEntry, csApsDirectionOperational=csApsDirectionOperational, cspTotalSESs=cspTotalSESs, cssTotalEntry=cssTotalEntry, cspTotalESs=cspTotalESs, cssTraceTable=cssTraceTable, cspTraceToTransmit=cspTraceToTransmit, ciscoSonetConfMIBGroup1=ciscoSonetConfMIBGroup1, ciscoSonetPathConfMIBGroup1=ciscoSonetPathConfMIBGroup1, cslTotalTable=cslTotalTable, cspSonetPathPayload=cspSonetPathPayload, csApsConfigEntry=csApsConfigEntry, csApsProtectionIndex=csApsProtectionIndex, csApsFailureStatus=csApsFailureStatus, csConfigType=csConfigType, PYSNMP_MODULE_ID=ciscoSonetMIB, csVTConfigEntry=csVTConfigEntry, cspRFIs=cspRFIs, ciscoSonetSectionStatusChange=ciscoSonetSectionStatusChange, csApsActiveLine=csApsActiveLine, ciscoSonetApsMIBGroup=ciscoSonetApsMIBGroup, csApsPrimarySection=csApsPrimarySection, csTributaryFramingType=csTributaryFramingType, cssTotalSEFSs=cssTotalSEFSs, cssTraceToExpect=cssTraceToExpect, csConfigXmtClockSource=csConfigXmtClockSource, csApsArchMode=csApsArchMode, csVTConfigTable=csVTConfigTable, cssTraceEntry=cssTraceEntry, ciscoSonetMIBNotifs=ciscoSonetMIBNotifs, ciscoSonetApsMIBGroup1=ciscoSonetApsMIBGroup1, ciscoSonetPathNotifGroup=ciscoSonetPathNotifGroup, ciscoSonetPathStatusChange=ciscoSonetPathStatusChange, cssTotalCVs=cssTotalCVs, cspTotalUASs=cspTotalUASs, csApsChannelProtocol=csApsChannelProtocol, ciscoSonetConfMIBGroup=ciscoSonetConfMIBGroup, csSection=csSection, csStatsEntry=csStatsEntry, cspFarEndTotalEntry=cspFarEndTotalEntry, cssTraceToTransmit=cssTraceToTransmit, csStatsTable=csStatsTable, ciscoSonetMIBCompliance=ciscoSonetMIBCompliance, ciscoSonetMIBObjects=ciscoSonetMIBObjects, cspTraceTable=cspTraceTable, csSignallingTransportMode=csSignallingTransportMode, csConfigRDIPType=csConfigRDIPType, csAu4Tug3Config=csAu4Tug3Config, cssTotalTable=cssTotalTable, cslFarEndTotalEntry=cslFarEndTotalEntry, csTributaryMappingType=csTributaryMappingType, cslTotalESs=cslTotalESs, cspFarEndTotalSESs=cspFarEndTotalSESs, ciscoSonetMIBGroups=ciscoSonetMIBGroups, cssTotalESs=cssTotalESs, csConfigTable=csConfigTable, cslTotalUASs=cslTotalUASs, cslFarEndTotalCVs=cslFarEndTotalCVs, csApsLineFailureCode=csApsLineFailureCode, csApsSwitchReason=csApsSwitchReason, cspFarEndTotalESs=cspFarEndTotalESs, cspAISs=cspAISs, csAu4Tug3ConfigTable=csAu4Tug3ConfigTable)
