...
# Notes
# -----
# ASN.1 source file://mibs/nortel/NTN-QOS-POLICY-AUX-MIB
...
_NtnQosInterfaceIdStorageType_Type.__name__ = "StorageType"
...
_NtnQosConfigAllowPacketReordering_Type.__name__ = "TruthValue"
...
_NtnQosConfigMaintainPolicingStats_Type.__name__ = "TruthValue"
...
ntnQosCompliance.setObjects(
      *(("NTN-QOS-POLICY-AUX-MIB", "ntnQosConfigGroup"),
        ("NTN-QOS-POLICY-AUX-MIB", "ntnQosInterfaceIdGroup"))
)
if mibBuilder.loadTexts:
