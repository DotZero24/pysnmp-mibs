...
mplsVpnObjects=_MplsVpnObjects_ObjectIdentity((1,3,6,1,4,1,2011,5,12,3,1))
_MplsVpnScalars_ObjectIdentity=ObjectIdentity
mplsVpnScalars=_MplsVpnScalars_ObjectIdentity((1,3,6,1,4,1,2011,5,12,3,1,1))
_MplsVpnConfiguredVrfs_Type=Unsigned32
_MplsVpnConfiguredVrfs_Object=MibScalar
mplsVpnConfiguredVrfs=_MplsVpnConfiguredVrfs_Object((1,3,6,1,4,1,2011,5,12,3,1,1,1),_MplsVpnConfiguredVrfs_Type())
...
mplsVpnActiveVrfs=_MplsVpnActiveVrfs_Object((1,3,6,1,4,1,2011,5,12,3,1,1,2),_MplsVpnActiveVrfs_Type())
...
mplsVpnConf=_MplsVpnConf_ObjectIdentity((1,3,6,1,4,1,2011,5,12,3,1,2))
_MplsVpnInterfaceConfTable_Object=MibTable
mplsVpnInterfaceConfTable=_MplsVpnInterfaceConfTable_Object((1,3,6,1,4,1,2011,5,12,3,1,2,1))
if mibBuilder.loadTexts:mplsVpnInterfaceConfTable.setStatus(_A)
_MplsVpnInterfaceConfEntry_Object=MibTableRow
mplsVpnInterfaceConfEntry=_MplsVpnInterfaceConfEntry_Object((1,3,6,1,4,1,2011,5,12,3,1,2,1,1))
...
mplsVpnInterfaceConfIndex=_MplsVpnInterfaceConfIndex_Object((1,3,6,1,4,1,2011,5,12,3,1,2,1,1,1),_MplsVpnInterfaceConfIndex_Type())
...
mplsVpnInterfaceLabelEdgeType=_MplsVpnInterfaceLabelEdgeType_Object((1,3,6,1,4,1,2011,5,12,3,1,2,1,1,2),_MplsVpnInterfaceLabelEdgeType_Type())
...
mplsVpnInterfaceVpnClassification=_MplsVpnInterfaceVpnClassification_Object((1,3,6,1,4,1,2011,5,12,3,1,2,1,1,3),_MplsVpnInterfaceVpnClassification_Type())
...
mplsVpnInterfaceIpAddress=_MplsVpnInterfaceIpAddress_Object((1,3,6,1,4,1,2011,5,12,3,1,2,1,1,4),_MplsVpnInterfaceIpAddress_Type())
...
mplsVpnInterfaceIpAddressMask=_MplsVpnInterfaceIpAddressMask_Object((1,3,6,1,4,1,2011,5,12,3,1,2,1,1,5),_MplsVpnInterfaceIpAddressMask_Type())
...
mplsVpnInterfaceConfRowStatus=_MplsVpnInterfaceConfRowStatus_Object((1,3,6,1,4,1,2011,5,12,3,1,2,1,1,6),_MplsVpnInterfaceConfRowStatus_Type())
...
mplsVpnVrfConfTable=_MplsVpnVrfConfTable_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2))
if mibBuilder.loadTexts:mplsVpnVrfConfTable.setStatus(_A)
_MplsVpnVrfConfEntry_Object=MibTableRow
mplsVpnVrfConfEntry=_MplsVpnVrfConfEntry_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1))
...
mplsVpnVrfName=_MplsVpnVrfName_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,1),_MplsVpnVrfName_Type())
...
mplsVpnVrfRouteDistinguisher=_MplsVpnVrfRouteDistinguisher_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,2),_MplsVpnVrfRouteDistinguisher_Type())
...
mplsVpnVrfNetPrefixType=_MplsVpnVrfNetPrefixType_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,3),_MplsVpnVrfNetPrefixType_Type())
...
mplsVpnVrfNetPrefix=_MplsVpnVrfNetPrefix_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,4),_MplsVpnVrfNetPrefix_Type())
...
mplsVpnVrfIpRouteRedistributeConn=_MplsVpnVrfIpRouteRedistributeConn_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,5),_MplsVpnVrfIpRouteRedistributeConn_Type())
...
mplsVpnVrfIpRouteRedistributeStatic=_MplsVpnVrfIpRouteRedistributeStatic_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,6),_MplsVpnVrfIpRouteRedistributeStatic_Type())
...
mplsVpnVrfIpRouteRedistributeRip=_MplsVpnVrfIpRouteRedistributeRip_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,7),_MplsVpnVrfIpRouteRedistributeRip_Type())
...
mplsVpnVrfConfHighRouteThreshold=_MplsVpnVrfConfHighRouteThreshold_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,8),_MplsVpnVrfConfHighRouteThreshold_Type())
...
mplsVpnVrfConfIsWarnOnly=_MplsVpnVrfConfIsWarnOnly_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,9),_MplsVpnVrfConfIsWarnOnly_Type())
...
mplsVpnVrfConfMaxRoutes=_MplsVpnVrfConfMaxRoutes_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,10),_MplsVpnVrfConfMaxRoutes_Type())
...
mplsVpnVrfConfRowStatus=_MplsVpnVrfConfRowStatus_Object((1,3,6,1,4,1,2011,5,12,3,1,2,2,1,11),_MplsVpnVrfConfRowStatus_Type())
...
mplsVpnVrfRouteTargetTable=_MplsVpnVrfRouteTargetTable_Object((1,3,6,1,4,1,2011,5,12,3,1,2,3))
if mibBuilder.loadTexts:mplsVpnVrfRouteTargetTable.setStatus(_A)
_MplsVpnVrfRouteTargetEntry_Object=MibTableRow
mplsVpnVrfRouteTargetEntry=_MplsVpnVrfRouteTargetEntry_Object((1,3,6,1,4,1,2011,5,12,3,1,2,3,1))
...
mplsVpnVrfRouteTarget=_MplsVpnVrfRouteTarget_Object((1,3,6,1,4,1,2011,5,12,3,1,2,3,1,1),_MplsVpnVrfRouteTarget_Type())
...
mplsVpnVrfRouteTargetType=_MplsVpnVrfRouteTargetType_Object((1,3,6,1,4,1,2011,5,12,3,1,2,3,1,2),_MplsVpnVrfRouteTargetType_Type())
...
mplsVpnVrfRouteTargetRowStatus=_MplsVpnVrfRouteTargetRowStatus_Object((1,3,6,1,4,1,2011,5,12,3,1,2,3,1,3),_MplsVpnVrfRouteTargetRowStatus_Type())
...
mplsVpnVrfBgpNbrAddrTable=_MplsVpnVrfBgpNbrAddrTable_Object((1,3,6,1,4,1,2011,5,12,3,1,2,4))
if mibBuilder.loadTexts:mplsVpnVrfBgpNbrAddrTable.setStatus(_A)
_MplsVpnVrfBgpNbrAddrEntry_Object=MibTableRow
mplsVpnVrfBgpNbrAddrEntry=_MplsVpnVrfBgpNbrAddrEntry_Object((1,3,6,1,4,1,2011,5,12,3,1,2,4,1))
...
mplsVpnVrfBgpNbrAddr=_MplsVpnVrfBgpNbrAddr_Object((1,3,6,1,4,1,2011,5,12,3,1,2,4,1,1),_MplsVpnVrfBgpNbrAddr_Type())
...
mplsVpnVrfBgpNbrRole=_MplsVpnVrfBgpNbrRole_Object((1,3,6,1,4,1,2011,5,12,3,1,2,4,1,2),_MplsVpnVrfBgpNbrRole_Type())
...
mplsVpnVrfBgpNbrType=_MplsVpnVrfBgpNbrType_Object((1,3,6,1,4,1,2011,5,12,3,1,2,4,1,3),_MplsVpnVrfBgpNbrType_Type())
...
mplsVpnVrfBgpNbrAsNumber=_MplsVpnVrfBgpNbrAsNumber_Object((1,3,6,1,4,1,2011,5,12,3,1,2,4,1,4),_MplsVpnVrfBgpNbrAsNumber_Type())
...
mplsVpnVrfBgpNbrAdminStatus=_MplsVpnVrfBgpNbrAdminStatus_Object((1,3,6,1,4,1,2011,5,12,3,1,2,4,1,5),_MplsVpnVrfBgpNbrAdminStatus_Type())
...
mplsVpnVrfBgpNbrRowStatus=_MplsVpnVrfBgpNbrRowStatus_Object((1,3,6,1,4,1,2011,5,12,3,1,2,4,1,6),_MplsVpnVrfBgpNbrRowStatus_Type())
...
mplsVpnRoute=_MplsVpnRoute_ObjectIdentity((1,3,6,1,4,1,2011,5,12,3,1,3))
_MplsVpnVrfRouteTable_Object=MibTable
mplsVpnVrfRouteTable=_MplsVpnVrfRouteTable_Object((1,3,6,1,4,1,2011,5,12,3,1,3,1))
if mibBuilder.loadTexts:mplsVpnVrfRouteTable.setStatus(_A)
_MplsVpnVrfRouteEntry_Object=MibTableRow
mplsVpnVrfRouteEntry=_MplsVpnVrfRouteEntry_Object((1,3,6,1,4,1,2011,5,12,3,1,3,1,1))
...
mplsVpnVrfRouteDest=_MplsVpnVrfRouteDest_Object((1,3,6,1,4,1,2011,5,12,3,1,3,1,1,1),_MplsVpnVrfRouteDest_Type())
...
mplsVpnVrfRouteMask=_MplsVpnVrfRouteMask_Object((1,3,6,1,4,1,2011,5,12,3,1,3,1,1,2),_MplsVpnVrfRouteMask_Type())
...
mplsVpnVrfRouteNextHop=_MplsVpnVrfRouteNextHop_Object((1,3,6,1,4,1,2011,5,12,3,1,3,1,1,3),_MplsVpnVrfRouteNextHop_Type())
...
mplsVpnVrfRouteIfIndex=_MplsVpnVrfRouteIfIndex_Object((1,3,6,1,4,1,2011,5,12,3,1,3,1,1,4),_MplsVpnVrfRouteIfIndex_Type())
...
mplsVpnVrfRouteProto=_MplsVpnVrfRouteProto_Object((1,3,6,1,4,1,2011,5,12,3,1,3,1,1,5),_MplsVpnVrfRouteProto_Type())
...
mplsVpnVrfRouteRowStatus=_MplsVpnVrfRouteRowStatus_Object((1,3,6,1,4,1,2011,5,12,3,1,3,1,1,6),_MplsVpnVrfRouteRowStatus_Type())
