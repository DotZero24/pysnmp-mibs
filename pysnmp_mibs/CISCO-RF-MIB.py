...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-RF-MIB
...
ciscoRFMIB.setRevisions(('2023-07-13 00:00', '2005-09-01 00:00', '2004-04-01 00:00', '2004-02-04 00:00', '2003-10-02 00:00', '2002-01-07 00:00', '2001-07-20 00:00', '2001-06-26 00:00', '2001-04-03 09:45',))
if mibBuilder.loadTexts: ciscoRFMIB.setLastUpdated('202307130000Z')
...
class RFSwactReasonType(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("unsupported", 1), ("none", 2), ("notKnown", 3), ("userInitiated", 4), ("userForced", 5), ("activeUnitFailed", 6), ("activeUnitRemoved", 7), ("activeGWdown", 8), ("activeRMIportdown", 9))
...
mibBuilder.exportSymbols("CISCO-RF-MIB", ciscoRFMIBCompliance=ciscoRFMIBCompliance, cRFStatusRFModeCapsEntry=cRFStatusRFModeCapsEntry, ciscoRFNotifGroup=ciscoRFNotifGroup, RFSwactReasonType=RFSwactReasonType, RFIssuStateRev1=RFIssuStateRev1, cRFHistoryStandByAvailTime=cRFHistoryStandByAvailTime, ciscoRFSwactNotif=ciscoRFSwactNotif, cRFCfgAdminAction=cRFCfgAdminAction, cRFHistorySwitchOverReason=cRFHistorySwitchOverReason, cRFStatusUnitState=cRFStatusUnitState, RFState=RFState, ciscoRFMIBCompliances=ciscoRFMIBCompliances, ciscoRFMIBComplianceRev2=ciscoRFMIBComplianceRev2, cRFStatusPeerUnitId=cRFStatusPeerUnitId, cRFStatusRFClientEntry=cRFStatusRFClientEntry, cRFCfgKeepaliveTimerMax=cRFCfgKeepaliveTimerMax, cRFStatusPeerUnitState=cRFStatusPeerUnitState, cRFCfgKeepaliveThreshMax=cRFCfgKeepaliveThreshMax, ciscoRFStatusGroup=ciscoRFStatusGroup, cRFStatusRFClientStatus=cRFStatusRFClientStatus, RFAction=RFAction, cRFCfgNotifTimerMax=cRFCfgNotifTimerMax, ciscoRFConfigGroupRev1=ciscoRFConfigGroupRev1, cRFStatusIssuToVersion=cRFStatusIssuToVersion, cRFCfgRedundancyOperMode=cRFCfgRedundancyOperMode, cRFStatusIssuStateRev1=cRFStatusIssuStateRev1, ciscoRFHistoryGroup=ciscoRFHistoryGroup, cRFStatusUnitId=cRFStatusUnitId, ciscoRFMIBConformance=ciscoRFMIBConformance, ciscoRFMIBNotifications=ciscoRFMIBNotifications, cRFCfgKeepaliveTimerMin=cRFCfgKeepaliveTimerMin, PYSNMP_MODULE_ID=ciscoRFMIB, ciscoRFMIBObjects=ciscoRFMIBObjects, cRFStatusRFClientSeq=cRFStatusRFClientSeq, cRFStatus=cRFStatus, cRFCfgNotifTimerMin=cRFCfgNotifTimerMin, cRFStatusFailoverTime=cRFStatusFailoverTime, ciscoRFConfigGroup=ciscoRFConfigGroup, cRFHistorySwitchOverTable=cRFHistorySwitchOverTable, cRFCfgNotifTimer=cRFCfgNotifTimer, cRFHistoryCurrActiveUnitId=cRFHistoryCurrActiveUnitId, cRFStatusIssuState=cRFStatusIssuState, cRFHistorySwitchOverIndex=cRFHistorySwitchOverIndex, ciscoRFMIBComplianceRev3=ciscoRFMIBComplianceRev3, cRFStatusRFClientRedTime=cRFStatusRFClientRedTime, cRFStatusPeerStandByEntryTime=cRFStatusPeerStandByEntryTime, cRFCfgSplitMode=cRFCfgSplitMode, ciscoRFIssuStateNotifGroupRev1=ciscoRFIssuStateNotifGroupRev1, cRFStatusRFModeCapsTable=cRFStatusRFModeCapsTable, cRFCfg=cRFCfg, cRFHistoryTableMaxLength=cRFHistoryTableMaxLength, RFIssuState=RFIssuState, ciscoRFStatusRFModeCapsGroup=ciscoRFStatusRFModeCapsGroup, cRFStatusPrimaryMode=cRFStatusPrimaryMode, cRFHistoryPrevActiveUnitId=cRFHistoryPrevActiveUnitId, cRFStatusRFModeCapsModeDescr=cRFStatusRFModeCapsModeDescr, RFMode=RFMode, cRFStatusRFClientDescr=cRFStatusRFClientDescr, cRFHistory=cRFHistory, cRFCfgMaintenanceMode=cRFCfgMaintenanceMode, ciscoRFStatusGroupRev1=ciscoRFStatusGroupRev1, cRFStatusRFClientID=cRFStatusRFClientID, cRFStatusRFModeCapsMode=cRFStatusRFModeCapsMode, cRFStatusLastSwactReasonCode=cRFStatusLastSwactReasonCode, ciscoRFIssuStateObjGroupRev1=ciscoRFIssuStateObjGroupRev1, ciscoRFMIBComplianceRev4=ciscoRFMIBComplianceRev4, RFClientStatus=RFClientStatus, cRFHistorySwactTime=cRFHistorySwactTime, RFUnitIdentifier=RFUnitIdentifier, ciscoRFMIBComplianceRev1=ciscoRFMIBComplianceRev1, cRFClient=cRFClient, ciscoRFIssuStateNotifGroup=ciscoRFIssuStateNotifGroup, ciscoRFMIB=ciscoRFMIB, cRFStatusDuplexMode=cRFStatusDuplexMode, cRFCfgKeepaliveThreshMin=cRFCfgKeepaliveThreshMin, ciscoRFStatusClientGroup=ciscoRFStatusClientGroup, cRFStatusRFClientTable=cRFStatusRFClientTable, ciscoRFIssuStateNotif=ciscoRFIssuStateNotif, ciscoRFMIBNotificationsPrefix=ciscoRFMIBNotificationsPrefix, cRFStatusManualSwactInhibit=cRFStatusManualSwactInhibit, cRFHistorySwitchOverEntry=cRFHistorySwitchOverEntry, cRFStatusIssuFromVersion=cRFStatusIssuFromVersion, ciscoRFMIBComplianceRev5=ciscoRFMIBComplianceRev5, ciscoRFIssuStateNotifRev1=ciscoRFIssuStateNotifRev1, cRFCfgNotifsEnabled=cRFCfgNotifsEnabled, cRFCfgKeepaliveThresh=cRFCfgKeepaliveThresh, ciscoRFIssuStateObjGroup=ciscoRFIssuStateObjGroup, ciscoRFMIBGroups=ciscoRFMIBGroups, ciscoRFProgressionNotif=ciscoRFProgressionNotif, cRFCfgKeepaliveTimer=cRFCfgKeepaliveTimer, cRFHistoryColdStarts=cRFHistoryColdStarts, cRFCfgRedundancyMode=cRFCfgRedundancyMode, cRFCfgRedundancyModeDescr=cRFCfgRedundancyModeDescr, ciscoRFConfigRFOperModeGroup=ciscoRFConfigRFOperModeGroup)
