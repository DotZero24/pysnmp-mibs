...
mibBuilder.exportSymbols("CISCO-RF-MIB", cRFStatusRFModeCapsModeDescr=cRFStatusRFModeCapsModeDescr, cRFCfgMaintenanceMode=cRFCfgMaintenanceMode, ciscoRFConfigGroup=ciscoRFConfigGroup, ciscoRFStatusGroupRev1=ciscoRFStatusGroupRev1, cRFStatusLastSwactReasonCode=cRFStatusLastSwactReasonCode, cRFCfgRedundancyOperMode=cRFCfgRedundancyOperMode, ciscoRFMIB=ciscoRFMIB, RFIssuState=RFIssuState, cRFStatusRFModeCapsMode=cRFStatusRFModeCapsMode, ciscoRFIssuStateObjGroupRev1=ciscoRFIssuStateObjGroupRev1, cRFStatusRFClientEntry=cRFStatusRFClientEntry, cRFStatusManualSwactInhibit=cRFStatusManualSwactInhibit, cRFClient=cRFClient, ciscoRFMIBComplianceRev4=ciscoRFMIBComplianceRev4, cRFStatusIssuToVersion=cRFStatusIssuToVersion, ciscoRFMIBCompliances=ciscoRFMIBCompliances, cRFCfgKeepaliveThreshMin=cRFCfgKeepaliveThreshMin, ciscoRFMIBGroups=ciscoRFMIBGroups, cRFHistorySwitchOverEntry=cRFHistorySwitchOverEntry, cRFHistorySwitchOverTable=cRFHistorySwitchOverTable, ciscoRFMIBConformance=ciscoRFMIBConformance, PYSNMP_MODULE_ID=ciscoRFMIB, cRFStatusRFClientStatus=cRFStatusRFClientStatus, ciscoRFMIBObjects=ciscoRFMIBObjects, cRFCfgAdminAction=cRFCfgAdminAction, ciscoRFIssuStateNotifRev1=ciscoRFIssuStateNotifRev1, RFIssuStateRev1=RFIssuStateRev1, cRFStatusIssuState=cRFStatusIssuState, cRFStatus=cRFStatus, ciscoRFIssuStateNotifGroup=ciscoRFIssuStateNotifGroup, cRFStatusDuplexMode=cRFStatusDuplexMode, RFUnitIdentifier=RFUnitIdentifier, cRFCfgRedundancyModeDescr=cRFCfgRedundancyModeDescr, cRFStatusPeerUnitId=cRFStatusPeerUnitId, cRFStatusUnitId=cRFStatusUnitId, cRFHistorySwitchOverReason=cRFHistorySwitchOverReason, cRFCfgKeepaliveThreshMax=cRFCfgKeepaliveThreshMax, cRFStatusIssuStateRev1=cRFStatusIssuStateRev1, ciscoRFSwactNotif=ciscoRFSwactNotif, cRFStatusRFClientRedTime=cRFStatusRFClientRedTime, cRFCfgKeepaliveTimer=cRFCfgKeepaliveTimer, cRFHistoryColdStarts=cRFHistoryColdStarts, RFAction=RFAction, cRFStatusRFClientDescr=cRFStatusRFClientDescr, cRFCfgSplitMode=cRFCfgSplitMode, ciscoRFMIBComplianceRev5=ciscoRFMIBComplianceRev5, cRFCfgKeepaliveTimerMax=cRFCfgKeepaliveTimerMax, cRFHistoryTableMaxLength=cRFHistoryTableMaxLength, ciscoRFMIBComplianceRev2=ciscoRFMIBComplianceRev2, cRFStatusUnitState=cRFStatusUnitState, ciscoRFMIBNotifications=ciscoRFMIBNotifications, ciscoRFMIBNotificationsPrefix=ciscoRFMIBNotificationsPrefix, ciscoRFNotifGroup=ciscoRFNotifGroup, cRFHistorySwactTime=cRFHistorySwactTime, cRFCfgNotifsEnabled=cRFCfgNotifsEnabled, cRFStatusPeerUnitState=cRFStatusPeerUnitState, cRFStatusIssuFromVersion=cRFStatusIssuFromVersion, RFMode=RFMode, cRFStatusRFClientTable=cRFStatusRFClientTable, cRFStatusRFModeCapsTable=cRFStatusRFModeCapsTable, cRFHistorySwitchOverIndex=cRFHistorySwitchOverIndex, ciscoRFIssuStateNotif=ciscoRFIssuStateNotif, cRFStatusRFModeCapsEntry=cRFStatusRFModeCapsEntry, cRFCfgKeepaliveTimerMin=cRFCfgKeepaliveTimerMin, RFState=RFState, RFSwactReasonType=RFSwactReasonType, ciscoRFProgressionNotif=ciscoRFProgressionNotif, cRFStatusRFClientID=cRFStatusRFClientID, ciscoRFMIBCompliance=ciscoRFMIBCompliance, ciscoRFMIBComplianceRev3=ciscoRFMIBComplianceRev3, ciscoRFIssuStateNotifGroupRev1=ciscoRFIssuStateNotifGroupRev1, ciscoRFStatusClientGroup=ciscoRFStatusClientGroup, cRFCfgNotifTimerMin=cRFCfgNotifTimerMin, ciscoRFConfigRFOperModeGroup=ciscoRFConfigRFOperModeGroup, cRFCfgNotifTimerMax=cRFCfgNotifTimerMax, ciscoRFStatusGroup=ciscoRFStatusGroup, ciscoRFIssuStateObjGroup=ciscoRFIssuStateObjGroup, ciscoRFHistoryGroup=ciscoRFHistoryGroup, cRFHistory=cRFHistory, cRFHistoryCurrActiveUnitId=cRFHistoryCurrActiveUnitId, ciscoRFMIBComplianceRev1=ciscoRFMIBComplianceRev1, cRFStatusFailoverTime=cRFStatusFailoverTime, cRFCfgNotifTimer=cRFCfgNotifTimer, cRFCfgRedundancyMode=cRFCfgRedundancyMode, cRFCfg=cRFCfg, cRFStatusPrimaryMode=cRFStatusPrimaryMode, cRFStatusPeerStandByEntryTime=cRFStatusPeerStandByEntryTime, cRFHistoryStandByAvailTime=cRFHistoryStandByAvailTime, cRFCfgKeepaliveThresh=cRFCfgKeepaliveThresh, ciscoRFStatusRFModeCapsGroup=ciscoRFStatusRFModeCapsGroup, ciscoRFConfigGroupRev1=ciscoRFConfigGroupRev1, cRFStatusRFClientSeq=cRFStatusRFClientSeq, cRFHistoryPrevActiveUnitId=cRFHistoryPrevActiveUnitId, RFClientStatus=RFClientStatus)
