...
# Notes
# -----
# ASN.1 source file://mibs/racktivity/ES-RACKTIVITY-MIB
...
esRacktivityConpliance.setObjects(
      *(("ES-RACKTIVITY-MIB", "esRacktivityMIBGroup"),
        ("ES-RACKTIVITY-MIB", "esRacktivityNotificationGroup"))
)
if mibBuilder.loadTexts:
