...
mibBuilder.exportSymbols("CISCO-ATM-IF-MIB", ciscoAtmIfAddressType=ciscoAtmIfAddressType, ciscoAtmIfMIBGroup8=ciscoAtmIfMIBGroup8, ciscoAtmIfMIBObjects=ciscoAtmIfMIBObjects, ciscoAtmIfMIBGroup9=ciscoAtmIfMIBGroup9, ciscoAtmIfMIBConformance=ciscoAtmIfMIBConformance, ciscoAtmIfIlmiAccessFilter=ciscoAtmIfIlmiAccessFilter, ciscoAtmIfWellKnownVcMode=ciscoAtmIfWellKnownVcMode, ciscoAtmIfMIBGroup10=ciscoAtmIfMIBGroup10, ciscoAtmIfMIBCompliance3=ciscoAtmIfMIBCompliance3, ciscoAtmIfActiveSVCs=ciscoAtmIfActiveSVCs, ciscoAtmIfIlmiUpDownChanges=ciscoAtmIfIlmiUpDownChanges, ciscoAtmIfSscopUpDownChanges=ciscoAtmIfSscopUpDownChanges, ciscoAtmIfMIBCompliance7=ciscoAtmIfMIBCompliance7, ciscoAtmIfMIBGroup5=ciscoAtmIfMIBGroup5, ciscoAtmIfIlmiAccessGlobalDefaultFilter=ciscoAtmIfIlmiAccessGlobalDefaultFilter, ciscoAtmIfSvcUpcIntent=ciscoAtmIfSvcUpcIntent, ciscoAtmIfIlmiKeepAlive=ciscoAtmIfIlmiKeepAlive, ciscoAtmIfIlmiAddressRegistration=ciscoAtmIfIlmiAddressRegistration, ciscoAtmIfCdLed=ciscoAtmIfCdLed, ciscoAtmIfMIBGroup3=ciscoAtmIfMIBGroup3, ciscoAtmIfConfVplIf=ciscoAtmIfConfVplIf, ciscoAtmIfType=ciscoAtmIfType, ciscoAtmIfMIBGroups=ciscoAtmIfMIBGroups, PYSNMP_MODULE_ID=ciscoAtmIfMIB, ciscoAtmIfXmitLed=ciscoAtmIfXmitLed, ciscoAtmIfMIBCompliance8=ciscoAtmIfMIBCompliance8, ciscoAtmIfPVPs=ciscoAtmIfPVPs, ciscoAtmIfMIBGroup6=ciscoAtmIfMIBGroup6, ciscoAtmIfXmitCells=ciscoAtmIfXmitCells, ciscoAtmIfNotifsEnabled=ciscoAtmIfNotifsEnabled, ciscoAtmIfMIB=ciscoAtmIfMIB, ciscoAtmIfSoftVcDestAddress=ciscoAtmIfSoftVcDestAddress, ciscoAtmIfSvcUpcIntentAbr=ciscoAtmIfSvcUpcIntentAbr, ciscoAtmIfIlmiFSMState=ciscoAtmIfIlmiFSMState, ciscoAtmIfDerivedAESA=ciscoAtmIfDerivedAESA, NsapAtmAddr=NsapAtmAddr, ciscoAtmIfSvcUpcIntentUbr=ciscoAtmIfSvcUpcIntentUbr, ciscoAtmIfNotifyGroup=ciscoAtmIfNotifyGroup, ciscoAtmIfUniSignallingVersion=ciscoAtmIfUniSignallingVersion, ciscoAtmIfRxCellUpcViolations=ciscoAtmIfRxCellUpcViolations, ciscoAtmIfActiveSVPs=ciscoAtmIfActiveSVPs, ciscoAtmIfEntry=ciscoAtmIfEntry, ciscoAtmIfRxCellDiscards=ciscoAtmIfRxCellDiscards, ciscoAtmIfIlmiAutoConfiguration=ciscoAtmIfIlmiAutoConfiguration, ciscoAtmIfEvent=ciscoAtmIfEvent, ciscoAtmIfMIBGroup4=ciscoAtmIfMIBGroup4, ciscoAtmIfE164AutoConversionOnly=ciscoAtmIfE164AutoConversionOnly, ciscoAtmIfMIBCompliance2=ciscoAtmIfMIBCompliance2, ciscoAtmIfSscopFSMState=ciscoAtmIfSscopFSMState, ciscoAtmIfRecvLed=ciscoAtmIfRecvLed, ciscoAtmIfAddress=ciscoAtmIfAddress, ciscoAtmIfSide=ciscoAtmIfSide, ciscoAtmIfSvcUpcIntentVbrNrt=ciscoAtmIfSvcUpcIntentVbrNrt, ciscoAtmIfSignallingAdminStatus=ciscoAtmIfSignallingAdminStatus, ciscoAtmIfMIBCompliance4=ciscoAtmIfMIBCompliance4, ciscoAtmIfMIBCompliance6=ciscoAtmIfMIBCompliance6, ciscoAtmIfMIBGroup7=ciscoAtmIfMIBGroup7, ciscoAtmIfMIBNotifications=ciscoAtmIfMIBNotifications, ciscoAtmIfSvcUpcIntentCbr=ciscoAtmIfSvcUpcIntentCbr, ciscoAtmIfRecvCells=ciscoAtmIfRecvCells, ciscoAtmIfMIBCompliances=ciscoAtmIfMIBCompliances, ciscoAtmIfPortType=ciscoAtmIfPortType, ciscoAtmIfIlmiConfiguration=ciscoAtmIfIlmiConfiguration, ciscoAtmIfSvcUpcIntentVbrRt=ciscoAtmIfSvcUpcIntentVbrRt, ciscoAtmIfMIBGroup=ciscoAtmIfMIBGroup, UpcMethod=UpcMethod, ciscoAtmIfTable=ciscoAtmIfTable, ciscoAtmIfMIBCompliance=ciscoAtmIfMIBCompliance, ciscoAtmIfE164Address=ciscoAtmIfE164Address, ciscoAtmIfMIBCompliance5=ciscoAtmIfMIBCompliance5, ciscoAtmIfConfigAESA=ciscoAtmIfConfigAESA, ciscoAtmIfSvcMinVci=ciscoAtmIfSvcMinVci, ciscoAtmIfUniType=ciscoAtmIfUniType, ciscoAtmIfMIBGroup2=ciscoAtmIfMIBGroup2, ciscoAtmIfTotalConnections=ciscoAtmIfTotalConnections, ciscoAtmIfPVCs=ciscoAtmIfPVCs, AtmAddr=AtmAddr)
