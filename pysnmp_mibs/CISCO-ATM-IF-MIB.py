...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-ATM-IF-MIB
...
mibBuilder.exportSymbols("CISCO-ATM-IF-MIB", ciscoAtmIfAddressType=ciscoAtmIfAddressType, ciscoAtmIfSvcUpcIntentVbrRt=ciscoAtmIfSvcUpcIntentVbrRt, ciscoAtmIfPortType=ciscoAtmIfPortType, ciscoAtmIfUniType=ciscoAtmIfUniType, ciscoAtmIfIlmiFSMState=ciscoAtmIfIlmiFSMState, ciscoAtmIfMIBGroup8=ciscoAtmIfMIBGroup8, ciscoAtmIfSvcUpcIntentUbr=ciscoAtmIfSvcUpcIntentUbr, ciscoAtmIfIlmiAutoConfiguration=ciscoAtmIfIlmiAutoConfiguration, ciscoAtmIfRecvLed=ciscoAtmIfRecvLed, PYSNMP_MODULE_ID=ciscoAtmIfMIB, ciscoAtmIfSignallingAdminStatus=ciscoAtmIfSignallingAdminStatus, ciscoAtmIfMIBCompliance4=ciscoAtmIfMIBCompliance4, ciscoAtmIfIlmiAccessGlobalDefaultFilter=ciscoAtmIfIlmiAccessGlobalDefaultFilter, ciscoAtmIfMIBGroups=ciscoAtmIfMIBGroups, ciscoAtmIfMIBCompliance8=ciscoAtmIfMIBCompliance8, ciscoAtmIfIlmiKeepAlive=ciscoAtmIfIlmiKeepAlive, ciscoAtmIfMIBCompliance=ciscoAtmIfMIBCompliance, ciscoAtmIfE164AutoConversionOnly=ciscoAtmIfE164AutoConversionOnly, ciscoAtmIfNotifyGroup=ciscoAtmIfNotifyGroup, ciscoAtmIfWellKnownVcMode=ciscoAtmIfWellKnownVcMode, ciscoAtmIfSvcUpcIntentCbr=ciscoAtmIfSvcUpcIntentCbr, ciscoAtmIfDerivedAESA=ciscoAtmIfDerivedAESA, ciscoAtmIfMIBGroup7=ciscoAtmIfMIBGroup7, ciscoAtmIfSscopUpDownChanges=ciscoAtmIfSscopUpDownChanges, ciscoAtmIfMIBGroup9=ciscoAtmIfMIBGroup9, ciscoAtmIfMIBGroup=ciscoAtmIfMIBGroup, ciscoAtmIfNotifsEnabled=ciscoAtmIfNotifsEnabled, ciscoAtmIfSscopFSMState=ciscoAtmIfSscopFSMState, ciscoAtmIfActiveSVPs=ciscoAtmIfActiveSVPs, ciscoAtmIfActiveSVCs=ciscoAtmIfActiveSVCs, ciscoAtmIfXmitLed=ciscoAtmIfXmitLed, ciscoAtmIfConfigAESA=ciscoAtmIfConfigAESA, ciscoAtmIfMIBCompliance6=ciscoAtmIfMIBCompliance6, ciscoAtmIfMIBObjects=ciscoAtmIfMIBObjects, ciscoAtmIfMIB=ciscoAtmIfMIB, ciscoAtmIfMIBGroup6=ciscoAtmIfMIBGroup6, ciscoAtmIfPVPs=ciscoAtmIfPVPs, ciscoAtmIfSvcUpcIntentVbrNrt=ciscoAtmIfSvcUpcIntentVbrNrt, ciscoAtmIfType=ciscoAtmIfType, ciscoAtmIfSvcUpcIntent=ciscoAtmIfSvcUpcIntent, ciscoAtmIfMIBCompliance2=ciscoAtmIfMIBCompliance2, ciscoAtmIfXmitCells=ciscoAtmIfXmitCells, ciscoAtmIfIlmiAddressRegistration=ciscoAtmIfIlmiAddressRegistration, ciscoAtmIfEntry=ciscoAtmIfEntry, ciscoAtmIfAddress=ciscoAtmIfAddress, ciscoAtmIfMIBCompliance7=ciscoAtmIfMIBCompliance7, ciscoAtmIfTable=ciscoAtmIfTable, ciscoAtmIfSide=ciscoAtmIfSide, ciscoAtmIfIlmiAccessFilter=ciscoAtmIfIlmiAccessFilter, ciscoAtmIfMIBConformance=ciscoAtmIfMIBConformance, ciscoAtmIfMIBGroup4=ciscoAtmIfMIBGroup4, AtmAddr=AtmAddr, ciscoAtmIfRxCellDiscards=ciscoAtmIfRxCellDiscards, ciscoAtmIfMIBGroup5=ciscoAtmIfMIBGroup5, ciscoAtmIfMIBGroup2=ciscoAtmIfMIBGroup2, ciscoAtmIfMIBCompliance3=ciscoAtmIfMIBCompliance3, ciscoAtmIfSvcMinVci=ciscoAtmIfSvcMinVci, ciscoAtmIfMIBGroup10=ciscoAtmIfMIBGroup10, ciscoAtmIfSoftVcDestAddress=ciscoAtmIfSoftVcDestAddress, ciscoAtmIfCdLed=ciscoAtmIfCdLed, UpcMethod=UpcMethod, NsapAtmAddr=NsapAtmAddr, ciscoAtmIfMIBCompliance5=ciscoAtmIfMIBCompliance5, ciscoAtmIfE164Address=ciscoAtmIfE164Address, ciscoAtmIfTotalConnections=ciscoAtmIfTotalConnections, ciscoAtmIfMIBGroup3=ciscoAtmIfMIBGroup3, ciscoAtmIfMIBNotifications=ciscoAtmIfMIBNotifications, ciscoAtmIfIlmiConfiguration=ciscoAtmIfIlmiConfiguration, ciscoAtmIfRxCellUpcViolations=ciscoAtmIfRxCellUpcViolations, ciscoAtmIfEvent=ciscoAtmIfEvent, ciscoAtmIfUniSignallingVersion=ciscoAtmIfUniSignallingVersion, ciscoAtmIfPVCs=ciscoAtmIfPVCs, ciscoAtmIfRecvCells=ciscoAtmIfRecvCells, ciscoAtmIfSvcUpcIntentAbr=ciscoAtmIfSvcUpcIntentAbr, ciscoAtmIfIlmiUpDownChanges=ciscoAtmIfIlmiUpDownChanges, ciscoAtmIfConfVplIf=ciscoAtmIfConfVplIf, ciscoAtmIfMIBCompliances=ciscoAtmIfMIBCompliances)
