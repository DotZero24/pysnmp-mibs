...
myProcessMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,36))
if mibBuilder.loadTexts:myProcessMIB.setRevisions(('2003-10-14 00:00','2019-10-09 00:00'))
...
myCPUMIBObjects=_MyCPUMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,36,1))
_MyCpuGeneralMibsGroup_ObjectIdentity=ObjectIdentity
myCpuGeneralMibsGroup=_MyCpuGeneralMibsGroup_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,36,1,1))
_MyCPUUtilization5Sec_Type=Percent
_MyCPUUtilization5Sec_Object=MibScalar
myCPUUtilization5Sec=_MyCPUUtilization5Sec_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,1,1),_MyCPUUtilization5Sec_Type())
...
myCPUUtilization1Min=_MyCPUUtilization1Min_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,1,2),_MyCPUUtilization1Min_Type())
...
myCPUUtilization5Min=_MyCPUUtilization5Min_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,1,3),_MyCPUUtilization5Min_Type())
...
myCPUUtilizationWarning=_MyCPUUtilizationWarning_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,1,4),_MyCPUUtilizationWarning_Type())
...
myCPUUtilizationCritical=_MyCPUUtilizationCritical_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,1,5),_MyCPUUtilizationCritical_Type())
...
myNodeCPUTotalTable=_MyNodeCPUTotalTable_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,2))
if mibBuilder.loadTexts:myNodeCPUTotalTable.setStatus(_A)
_MyNodeCPUTotalEntry_Object=MibTableRow
myNodeCPUTotalEntry=_MyNodeCPUTotalEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,2,1))
...
myNodeCPUTotalIndex=_MyNodeCPUTotalIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,2,1,1),_MyNodeCPUTotalIndex_Type())
...
myNodeCPUTotalName=_MyNodeCPUTotalName_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,2,1,2),_MyNodeCPUTotalName_Type())
...
myNodeCPUTotal5sec=_MyNodeCPUTotal5sec_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,2,1,3),_MyNodeCPUTotal5sec_Type())
...
myNodeCPUTotal1min=_MyNodeCPUTotal1min_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,2,1,4),_MyNodeCPUTotal1min_Type())
...
myNodeCPUTotal5min=_MyNodeCPUTotal5min_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,2,1,5),_MyNodeCPUTotal5min_Type())
...
myNodeCPUTotalWarning=_MyNodeCPUTotalWarning_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,2,1,6),_MyNodeCPUTotalWarning_Type())
...
myNodeCPUTotalCritical=_MyNodeCPUTotalCritical_Object((1,3,6,1,4,1,4881,1,1,10,2,36,1,2,1,7),_MyNodeCPUTotalCritical_Type())
...
myProcessMIBConformance=_MyProcessMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,36,2))
_MyProcessMIBCompliances_ObjectIdentity=ObjectIdentity
myProcessMIBCompliances=_MyProcessMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,36,2,1))
_MyProcessMIBGroups_ObjectIdentity=ObjectIdentity
myProcessMIBGroups=_MyProcessMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,36,2,2))
myCPUUtilizationMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,36,2,2,1))
myCPUUtilizationMIBGroup.setObjects(*((_B,_F),(_B,_G),(_B,_H)))
if mibBuilder.loadTexts:myCPUUtilizationMIBGroup.setStatus(_A)
myNodeCPUTotalGroups=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,36,2,2,2))
...
myProcessMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,36,2,1,1))
