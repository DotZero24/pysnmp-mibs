...
mibBuilder.exportSymbols("DES-1526-MIB", portTrunkEnable=portTrunkEnable, configMirrorStatus=configMirrorStatus, tvlanUntaggedPorts=tvlanUntaggedPorts, commTrapStatus=commTrapStatus, swTPAbnormalTXError=swTPAbnormalTXError, configPortOperStatus=configPortOperStatus, dlink_products=dlink_products, commSetTable=commSetTable, commTrapIpAddress=commTrapIpAddress, configMirrorMode=configMirrorMode, tvlanPortPortId=tvlanPortPortId, configPortSpeed=configPortSpeed, configNetMask=configNetMask, commTrapTrapAbnormalTPTXError=commTrapTrapAbnormalTPTXError, RowStatus=RowStatus, configVerHwChipSet=configVerHwChipSet, companyMiscGroup=companyMiscGroup, commTrapSNMPTPLinkUpDown=commTrapSNMPTPLinkUpDown, commTrapTrapPOEPortOvercurrent=commTrapTrapPOEPortOvercurrent, tvlanId=tvlanId, commTrapEntry=commTrapEntry, commTrapVlanId=commTrapVlanId, tvlanTable=tvlanTable, commTrapTrapAbnormalFiberRXError=commTrapTrapAbnormalFiberRXError, configMirrorMon=configMirrorMon, commGetIndex=commGetIndex, commTrapTrapAbnormalTPRXError=commTrapTrapAbnormalTPRXError, configPortTable=configPortTable, swFiberInsert=swFiberInsert, commGetStatus=commGetStatus, configPasswordAdmin=configPasswordAdmin, swFiberAbnormalTXError=swFiberAbnormalTXError, configPortFlowControl=configPortFlowControl, commTrapIndex=commTrapIndex, MacAddress=MacAddress, DES_1526=DES_1526, companyTVlanGroup=companyTVlanGroup, commTrapTrapPOEPowerFail=commTrapTrapPOEPowerFail, configMirrorId=configMirrorId, configSave=configSave, commTrapTable=commTrapTable, commTrapTrapAbnormalFiberTXError=commTrapTrapAbnormalFiberTXError, commGetTable=commGetTable, configMirrorEntry=configMirrorEntry, tvlanStatus=tvlanStatus, configMirrorTable=configMirrorTable, configSNMPEnable=configSNMPEnable, configPhysAddress=configPhysAddress, configMirrorSrc=configMirrorSrc, configGateway=configGateway, dlink_DES1526SeriesProd=dlink_DES1526SeriesProd, configIpAssignmentMode=configIpAssignmentMode, configPortPriority=configPortPriority, d_link=d_link, portTrunkTable=portTrunkTable, tvlanPortVlanId=tvlanPortVlanId, companyPortTrunkGroup=companyPortTrunkGroup, portTrunkMemberValue=portTrunkMemberValue, commSetEntry=commSetEntry, miscStatisticsReset=miscStatisticsReset, swTPAbnormalRXError=swTPAbnormalRXError, PortList=PortList, companyConfigGroup=companyConfigGroup, commGetName=commGetName, commSetIndex=commSetIndex, companyCommGroup=companyCommGroup, commTrapSNMPFiberLinkUpDown=commTrapSNMPFiberLinkUpDown, configVerSwPrimary=configVerSwPrimary, configIpAddress=configIpAddress, tvlanMember=tvlanMember, commSetName=commSetName, OwnerString=OwnerString, commTrapName=commTrapName, tvlanEntry=tvlanEntry, configRestoreDefaults=configRestoreDefaults, configPort=configPort, commGetEntry=commGetEntry, configPortEntry=configPortEntry, commTrapTrapPOEPortShort=commTrapTrapPOEPortShort, swFiberAbnormalRXError=swFiberAbnormalRXError, commSetStatus=commSetStatus, portTrunkEntry=portTrunkEntry, commTrapSNMPBootup=commTrapSNMPBootup, portTrunkId=portTrunkId, tvlanPortTable=tvlanPortTable, tvlanPortEntry=tvlanPortEntry, swFiberRemove=swFiberRemove, configPortFlowControlOper=configPortFlowControlOper, portTrunkMember=portTrunkMember)
