...
_J='radius'
_I='default'
_H='NETGEAR-DOT1X-ADVANCED-FEATURES-MIB'
_G='Unsigned32'
_F='disable'
_E='enable'
_D='read-write'
...
agentDot1xEnhancementConfigGroup=_AgentDot1xEnhancementConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,36,1))
...
agentDot1xRadiusVlanAssignment=_AgentDot1xRadiusVlanAssignment_Object((1,3,6,1,4,1,4526,10,36,1,1),_AgentDot1xRadiusVlanAssignment_Type())
...
agentDot1xDynamicVlanCreationMode=_AgentDot1xDynamicVlanCreationMode_Object((1,3,6,1,4,1,4526,10,36,1,2),_AgentDot1xDynamicVlanCreationMode_Type())
...
agentDot1xEapolFloodMode=_AgentDot1xEapolFloodMode_Object((1,3,6,1,4,1,4526,10,36,1,3),_AgentDot1xEapolFloodMode_Type())
...
agentDot1xPortConfigGroup=_AgentDot1xPortConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,36,2))
_AgentDot1xPortConfigTable_Object=MibTable
agentDot1xPortConfigTable=_AgentDot1xPortConfigTable_Object((1,3,6,1,4,1,4526,10,36,2,1))
if mibBuilder.loadTexts:agentDot1xPortConfigTable.setStatus(_A)
_AgentDot1xPortConfigEntry_Object=MibTableRow
agentDot1xPortConfigEntry=_AgentDot1xPortConfigEntry_Object((1,3,6,1,4,1,4526,10,36,2,1,1))
...
agentDot1xPortControlMode=_AgentDot1xPortControlMode_Object((1,3,6,1,4,1,4526,10,36,2,1,1,1),_AgentDot1xPortControlMode_Type())
...
agentDot1xGuestVlanId=_AgentDot1xGuestVlanId_Object((1,3,6,1,4,1,4526,10,36,2,1,1,2),_AgentDot1xGuestVlanId_Type())
...
agentDot1xGuestVlanPeriod=_AgentDot1xGuestVlanPeriod_Object((1,3,6,1,4,1,4526,10,36,2,1,1,3),_AgentDot1xGuestVlanPeriod_Type())
...
agentDot1xUnauthenticatedVlan=_AgentDot1xUnauthenticatedVlan_Object((1,3,6,1,4,1,4526,10,36,2,1,1,4),_AgentDot1xUnauthenticatedVlan_Type())
...
agentDot1xMaxUsers=_AgentDot1xMaxUsers_Object((1,3,6,1,4,1,4526,10,36,2,1,1,5),_AgentDot1xMaxUsers_Type())
...
agentDot1xPortVlanAssigned=_AgentDot1xPortVlanAssigned_Object((1,3,6,1,4,1,4526,10,36,2,1,1,6),_AgentDot1xPortVlanAssigned_Type())
...
agentDot1xPortVlanAssignedReason=_AgentDot1xPortVlanAssignedReason_Object((1,3,6,1,4,1,4526,10,36,2,1,1,7),_AgentDot1xPortVlanAssignedReason_Type())
...
agentDot1xPortSessionTimeout=_AgentDot1xPortSessionTimeout_Object((1,3,6,1,4,1,4526,10,36,2,1,1,8),_AgentDot1xPortSessionTimeout_Type())
...
agentDot1xPortTerminationAction=_AgentDot1xPortTerminationAction_Object((1,3,6,1,4,1,4526,10,36,2,1,1,9),_AgentDot1xPortTerminationAction_Type())
...
agentDot1xPortMABenabled=_AgentDot1xPortMABenabled_Object((1,3,6,1,4,1,4526,10,36,2,1,1,10),_AgentDot1xPortMABenabled_Type())
...
agentDot1xPortMABenabledOperational=_AgentDot1xPortMABenabledOperational_Object((1,3,6,1,4,1,4526,10,36,2,1,1,11),_AgentDot1xPortMABenabledOperational_Type())
...
agentDot1xClientConfigGroup=_AgentDot1xClientConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,36,3))
_AgentDot1xClientConfigTable_Object=MibTable
agentDot1xClientConfigTable=_AgentDot1xClientConfigTable_Object((1,3,6,1,4,1,4526,10,36,3,1))
if mibBuilder.loadTexts:agentDot1xClientConfigTable.setStatus(_A)
_AgentDot1xClientConfigEntry_Object=MibTableRow
agentDot1xClientConfigEntry=_AgentDot1xClientConfigEntry_Object((1,3,6,1,4,1,4526,10,36,3,1,1))
...
agentDot1xClientMacAddress=_AgentDot1xClientMacAddress_Object((1,3,6,1,4,1,4526,10,36,3,1,1,1),_AgentDot1xClientMacAddress_Type())
...
agentDot1xLogicalPort=_AgentDot1xLogicalPort_Object((1,3,6,1,4,1,4526,10,36,3,1,1,2),_AgentDot1xLogicalPort_Type())
...
agentDot1xInterface=_AgentDot1xInterface_Object((1,3,6,1,4,1,4526,10,36,3,1,1,3),_AgentDot1xInterface_Type())
...
agentDot1xClientAuthPAEstate=_AgentDot1xClientAuthPAEstate_Object((1,3,6,1,4,1,4526,10,36,3,1,1,4),_AgentDot1xClientAuthPAEstate_Type())
...
agentDot1xClientBackendState=_AgentDot1xClientBackendState_Object((1,3,6,1,4,1,4526,10,36,3,1,1,5),_AgentDot1xClientBackendState_Type())
...
agentDot1xClientUserName=_AgentDot1xClientUserName_Object((1,3,6,1,4,1,4526,10,36,3,1,1,6),_AgentDot1xClientUserName_Type())
...
agentDot1xClientSessionTime=_AgentDot1xClientSessionTime_Object((1,3,6,1,4,1,4526,10,36,3,1,1,7),_AgentDot1xClientSessionTime_Type())
...
agentDot1xClientFilterID=_AgentDot1xClientFilterID_Object((1,3,6,1,4,1,4526,10,36,3,1,1,8),_AgentDot1xClientFilterID_Type())
...
agentDot1xClientVlanAssigned=_AgentDot1xClientVlanAssigned_Object((1,3,6,1,4,1,4526,10,36,3,1,1,9),_AgentDot1xClientVlanAssigned_Type())
...
agentDot1xClientVlanAssignedReason=_AgentDot1xClientVlanAssignedReason_Object((1,3,6,1,4,1,4526,10,36,3,1,1,10),_AgentDot1xClientVlanAssignedReason_Type())
...
agentDot1xClientSessionTimeout=_AgentDot1xClientSessionTimeout_Object((1,3,6,1,4,1,4526,10,36,3,1,1,11),_AgentDot1xClientSessionTimeout_Type())
...
agentDot1xClientTerminationAction=_AgentDot1xClientTerminationAction_Object((1,3,6,1,4,1,4526,10,36,3,1,1,12),_AgentDot1xClientTerminationAction_Type())
...
agentDot1xMonitorModeConfigGroup=_AgentDot1xMonitorModeConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,36,4))
...
agentDot1xMonitorModeEnabled=_AgentDot1xMonitorModeEnabled_Object((1,3,6,1,4,1,4526,10,36,4,1),_AgentDot1xMonitorModeEnabled_Type())
...
agentDot1xMonitorModeClients=_AgentDot1xMonitorModeClients_Object((1,3,6,1,4,1,4526,10,36,4,2),_AgentDot1xMonitorModeClients_Type())
...
agentDot1xNonMonitorModeClients=_AgentDot1xNonMonitorModeClients_Object((1,3,6,1,4,1,4526,10,36,4,3),_AgentDot1xNonMonitorModeClients_Type())
...
agentDot1xAuthHistoryResultsGroup=_AgentDot1xAuthHistoryResultsGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,36,5))
_AgentDot1xPortAuthHistoryResultTable_Object=MibTable
agentDot1xPortAuthHistoryResultTable=_AgentDot1xPortAuthHistoryResultTable_Object((1,3,6,1,4,1,4526,10,36,5,1))
...
agentDot1xPortAuthHistoryResultEntry=_AgentDot1xPortAuthHistoryResultEntry_Object((1,3,6,1,4,1,4526,10,36,5,1,1))
...
agentDot1xAuthHistoryResultIfaceIndex=_AgentDot1xAuthHistoryResultIfaceIndex_Object((1,3,6,1,4,1,4526,10,36,5,1,1,1),_AgentDot1xAuthHistoryResultIfaceIndex_Type())
...
agentDot1xAuthHistoryResultIndex=_AgentDot1xAuthHistoryResultIndex_Object((1,3,6,1,4,1,4526,10,36,5,1,1,2),_AgentDot1xAuthHistoryResultIndex_Type())
...
agentDot1xAuthHistoryResultTimeStamp=_AgentDot1xAuthHistoryResultTimeStamp_Object((1,3,6,1,4,1,4526,10,36,5,1,1,3),_AgentDot1xAuthHistoryResultTimeStamp_Type())
...
agentDot1xAuthHistoryResultAge=_AgentDot1xAuthHistoryResultAge_Object((1,3,6,1,4,1,4526,10,36,5,1,1,4),_AgentDot1xAuthHistoryResultAge_Type())
...
agentDot1xAuthHistoryResultMacAddress=_AgentDot1xAuthHistoryResultMacAddress_Object((1,3,6,1,4,1,4526,10,36,5,1,1,5),_AgentDot1xAuthHistoryResultMacAddress_Type())
...
agentDot1xAuthHistoryResultVlanId=_AgentDot1xAuthHistoryResultVlanId_Object((1,3,6,1,4,1,4526,10,36,5,1,1,6),_AgentDot1xAuthHistoryResultVlanId_Type())
...
agentDot1xAuthHistoryResultAuthStatus=_AgentDot1xAuthHistoryResultAuthStatus_Object((1,3,6,1,4,1,4526,10,36,5,1,1,7),_AgentDot1xAuthHistoryResultAuthStatus_Type())
...
agentDot1xAuthHistoryResultAccessStatus=_AgentDot1xAuthHistoryResultAccessStatus_Object((1,3,6,1,4,1,4526,10,36,5,1,1,8),_AgentDot1xAuthHistoryResultAccessStatus_Type())
...
agentDot1xAuthHistoryResultFilterID=_AgentDot1xAuthHistoryResultFilterID_Object((1,3,6,1,4,1,4526,10,36,5,1,1,9),_AgentDot1xAuthHistoryResultFilterID_Type())
...
agentDot1xAuthHistoryResultVlanAssigned=_AgentDot1xAuthHistoryResultVlanAssigned_Object((1,3,6,1,4,1,4526,10,36,5,1,1,10),_AgentDot1xAuthHistoryResultVlanAssigned_Type())
...
agentDot1xAuthHistoryResultVlanAssignedType=_AgentDot1xAuthHistoryResultVlanAssignedType_Object((1,3,6,1,4,1,4526,10,36,5,1,1,11),_AgentDot1xAuthHistoryResultVlanAssignedType_Type())
...
agentDot1xAuthHistoryResultReasonCode=_AgentDot1xAuthHistoryResultReasonCode_Object((1,3,6,1,4,1,4526,10,36,5,1,1,12),_AgentDot1xAuthHistoryResultReasonCode_Type())
...
agentDot1xAuthHistoryResultsClear=_AgentDot1xAuthHistoryResultsClear_Object((1,3,6,1,4,1,4526,10,36,5,2),_AgentDot1xAuthHistoryResultsClear_Type())
...
agentDot1xPortAuthHistoryResultClearTable=_AgentDot1xPortAuthHistoryResultClearTable_Object((1,3,6,1,4,1,4526,10,36,5,3))
...
agentDot1xPortAuthHistoryResultClearEntry=_AgentDot1xPortAuthHistoryResultClearEntry_Object((1,3,6,1,4,1,4526,10,36,5,3,1))
...
agentDot1xAuthHistoryResultIfIndex=_AgentDot1xAuthHistoryResultIfIndex_Object((1,3,6,1,4,1,4526,10,36,5,3,1,1),_AgentDot1xAuthHistoryResultIfIndex_Type())
...
agentDot1xPortAuthHistoryResultsClear=_AgentDot1xPortAuthHistoryResultsClear_Object((1,3,6,1,4,1,4526,10,36,5,3,1,2),_AgentDot1xPortAuthHistoryResultsClear_Type())
