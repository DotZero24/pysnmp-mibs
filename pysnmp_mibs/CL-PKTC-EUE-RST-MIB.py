...
# Notes
# -----
# ASN.1 source file://mibs/rfc/CL-PKTC-EUE-RST-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:21:24 2025
...
pktcEUERSTEuroCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 4491, 2, 2, 8, 2, 2, 1, 3)
)
pktcEUERSTEuroCompliance.setObjects(
      *(("CL-PKTC-EUE-RST-MIB", "pktcEUERSTProfileGroup"),
        ("CL-PKTC-EUE-RST-MIB", "pktcEUERSTBasicCallGroup"),
        ("CL-PKTC-EUE-RST-MIB", "pktcEUERSTUEStGroup"),
        ("CL-PKTC-EUE-RST-MIB", "pktcEUERSTNoAnsGroup"),
...
if mibBuilder.loadTexts:
    pktcEUERSTEuroCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"PktcRSTTCFeatID": PktcRSTTCFeatID,
       ...
       "pktcEUERSTEuroCompliance": pktcEUERSTEuroCompliance,
