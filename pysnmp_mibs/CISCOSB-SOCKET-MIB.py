...
rlSocketMibVersion=_RlSocketMibVersion_Object((1,3,6,1,4,1,9,6,1,101,85,1),_RlSocketMibVersion_Type())
rlSocketMibVersion.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSocketMibVersion.setStatus(_A)
_RlSocketTable_Object=MibTable
rlSocketTable=_RlSocketTable_Object((1,3,6,1,4,1,9,6,1,101,85,2))
if mibBuilder.loadTexts:rlSocketTable.setStatus(_A)
_RlSocketEntry_Object=MibTableRow
rlSocketEntry=_RlSocketEntry_Object((1,3,6,1,4,1,9,6,1,101,85,2,1))
...
rlSocketId=_RlSocketId_Object((1,3,6,1,4,1,9,6,1,101,85,2,1,1),_RlSocketId_Type())
...
rlSocketType=_RlSocketType_Object((1,3,6,1,4,1,9,6,1,101,85,2,1,2),_RlSocketType_Type())
...
rlSocketState=_RlSocketState_Object((1,3,6,1,4,1,9,6,1,101,85,2,1,3),_RlSocketState_Type())
...
rlSocketBlockMode=_RlSocketBlockMode_Object((1,3,6,1,4,1,9,6,1,101,85,2,1,4),_RlSocketBlockMode_Type())
...
rlSocketUpTime=_RlSocketUpTime_Object((1,3,6,1,4,1,9,6,1,101,85,2,1,5),_RlSocketUpTime_Type())
