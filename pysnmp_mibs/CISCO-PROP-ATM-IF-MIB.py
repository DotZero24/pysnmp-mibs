...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-PROP-ATM-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:28:34 2025
...
cpAtmIfMIBCompliance.setObjects(
      *(("CISCO-PROP-ATM-IF-MIB", "cpAtmIfConfigGroup"),
        ("CISCO-PROP-ATM-IF-MIB", "cpAtmIfEgressStatMIBGroup"),
        ("CISCO-PROP-ATM-IF-MIB", "cpAtmIfEgressIntervalMIBGroup"),
        ("CISCO-PROP-ATM-IF-MIB", "cpAtmIfIngressStatMIBGroup"),
        ("CISCO-PROP-ATM-IF-MIB", "cpAtmIfHCEgressStatMIBGroup"),
        ("CISCO-PROP-ATM-IF-MIB", "cpAtmIfHCEgressIntervalMIBGroup"),
        ("CISCO-PROP-ATM-IF-MIB", "cpAtmIfHCIngressStatMIBGroup"))
)
if mibBuilder.loadTexts:
