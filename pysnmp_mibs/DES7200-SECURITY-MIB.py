...
mibBuilder.exportSymbols("DES7200-SECURITY-MIB", mySecurityMIB=mySecurityMIB, myPortSecurityStatus=myPortSecurityStatus, myTelnetHostIpEntry=myTelnetHostIpEntry, myPortSecurityAddrAge=myPortSecurityAddrAge, myBindAddressEntry=myBindAddressEntry, myBindAddressTable=myBindAddressTable, myPortSecurityTable=myPortSecurityTable, myEnableTelnet=myEnableTelnet, myWebHostIpTable=myWebHostIpTable, myTelnetHostIpAddress=myTelnetHostIpAddress, mySecurityAddressMIBGroup=mySecurityAddressMIBGroup, myPortSecurityIpDistrMode=myPortSecurityIpDistrMode, mySecurityAddressTable=mySecurityAddressTable, mySecurityAddressPort=mySecurityAddressPort, myPortSecurityAddrNum=myPortSecurityAddrNum, myPortSecurityPortIndex=myPortSecurityPortIndex, myWebHostIpAddress=myWebHostIpAddress, myWebHostIpEnable=myWebHostIpEnable, myTelnetHostIpEnable=myTelnetHostIpEnable, myTelnetHostIpTable=myTelnetHostIpTable, myBindMacAddress=myBindMacAddress, mySecurityMIBGroups=mySecurityMIBGroups, myEnableWeb=myEnableWeb, mySecurityAddressFdbId=mySecurityAddressFdbId, myBindAddressIpAddr=myBindAddressIpAddr, portSecurityViolate=portSecurityViolate, mySecurityMIBConformance=mySecurityMIBConformance, myPortSecrrityObjects=myPortSecrrityObjects, myUserManageMIBGroup=myUserManageMIBGroup, mySecurityAddressIpAddr=mySecurityAddressIpAddr, myPortSecurViolationType=myPortSecurViolationType, myWebHostIpEntry=myWebHostIpEntry, myUserManagementObjects=myUserManagementObjects, myPortStaticSecurAddrCurrentNum=myPortStaticSecurAddrCurrentNum, mySecurityAddressObjects=mySecurityAddressObjects, mySecurityMIBObjects=mySecurityMIBObjects, myBindAddressStatus=myBindAddressStatus, mySecurityAddressStatus=mySecurityAddressStatus, myEnableSnmpAgent=myEnableSnmpAgent, myPortSecurityMIBGroup=myPortSecurityMIBGroup, mySecurityMIBCompliance=mySecurityMIBCompliance, mySecurityMIBCompliances=mySecurityMIBCompliances, mySecurityAddressType=mySecurityAddressType, myPortSecurityEntry=myPortSecurityEntry, mySecurityAddressAddress=mySecurityAddressAddress, myPortStaticSecurAddrIfAge=myPortStaticSecurAddrIfAge, mySecurityAddressEntry=mySecurityAddressEntry, myPortSecurityAddressCurrentNum=myPortSecurityAddressCurrentNum, mySecurityTraps=mySecurityTraps, mySecurityAddressIfBindIp=mySecurityAddressIfBindIp, mySecurityAddressRemainAge=mySecurityAddressRemainAge, PYSNMP_MODULE_ID=mySecurityMIB)
