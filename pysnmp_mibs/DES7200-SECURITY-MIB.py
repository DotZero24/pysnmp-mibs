...
_T='myBindAddressIpAddr'
_S='read-create'
_R='mySecurityAddressIpAddr'
_Q='mySecurityAddressPort'
_P='mySecurityAddressAddress'
_O='mySecurityAddressFdbId'
_N='myWebHostIpAddress'
_M='disable'
_L='enable'
_K='myTelnetHostIpAddress'
_J='EnabledStatus'
_I='ifIndex'
_H='IF-MIB'
_G='myPortSecurityPortIndex'
_F='not-accessible'
_E='Integer32'
_D='read-only'
_C='read-write'
_B='DES7200-SECURITY-MIB'
_A='current'
...
mySecurityMIBObjects=_MySecurityMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,6,1))
_MyUserManagementObjects_ObjectIdentity=ObjectIdentity
myUserManagementObjects=_MyUserManagementObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,6,1,1))
_MyEnableSnmpAgent_Type=EnabledStatus
_MyEnableSnmpAgent_Object=MibScalar
myEnableSnmpAgent=_MyEnableSnmpAgent_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,1),_MyEnableSnmpAgent_Type())
...
myEnableWeb=_MyEnableWeb_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,2),_MyEnableWeb_Type())
...
myEnableTelnet=_MyEnableTelnet_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,3),_MyEnableTelnet_Type())
myEnableTelnet.setMaxAccess(_C)
if mibBuilder.loadTexts:myEnableTelnet.setStatus(_A)
_MyTelnetHostIpTable_Object=MibTable
myTelnetHostIpTable=_MyTelnetHostIpTable_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,4))
if mibBuilder.loadTexts:myTelnetHostIpTable.setStatus(_A)
_MyTelnetHostIpEntry_Object=MibTableRow
myTelnetHostIpEntry=_MyTelnetHostIpEntry_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,4,1))
myTelnetHostIpEntry.setIndexNames((0,_B,_K))
...
myTelnetHostIpAddress=_MyTelnetHostIpAddress_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,4,1,1),_MyTelnetHostIpAddress_Type())
myTelnetHostIpAddress.setMaxAccess(_D)
if mibBuilder.loadTexts:myTelnetHostIpAddress.setStatus(_A)
class _MyTelnetHostIpEnable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_L,1),(_M,2)))
_MyTelnetHostIpEnable_Type.__name__=_E
_MyTelnetHostIpEnable_Object=MibTableColumn
myTelnetHostIpEnable=_MyTelnetHostIpEnable_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,4,1,2),_MyTelnetHostIpEnable_Type())
...
myWebHostIpTable=_MyWebHostIpTable_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,5))
if mibBuilder.loadTexts:myWebHostIpTable.setStatus(_A)
_MyWebHostIpEntry_Object=MibTableRow
myWebHostIpEntry=_MyWebHostIpEntry_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,5,1))
myWebHostIpEntry.setIndexNames((0,_B,_N))
...
myWebHostIpAddress=_MyWebHostIpAddress_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,5,1,1),_MyWebHostIpAddress_Type())
myWebHostIpAddress.setMaxAccess(_D)
if mibBuilder.loadTexts:myWebHostIpAddress.setStatus(_A)
class _MyWebHostIpEnable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_L,1),(_M,2)))
_MyWebHostIpEnable_Type.__name__=_E
_MyWebHostIpEnable_Object=MibTableColumn
myWebHostIpEnable=_MyWebHostIpEnable_Object((1,3,6,1,4,1,171,10,97,2,6,1,1,5,1,2),_MyWebHostIpEnable_Type())
...
mySecurityAddressObjects=_MySecurityAddressObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,6,1,2))
_MySecurityAddressTable_Object=MibTable
mySecurityAddressTable=_MySecurityAddressTable_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1))
if mibBuilder.loadTexts:mySecurityAddressTable.setStatus(_A)
_MySecurityAddressEntry_Object=MibTableRow
mySecurityAddressEntry=_MySecurityAddressEntry_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1,1))
mySecurityAddressEntry.setIndexNames((0,_B,_O),(0,_B,_P),(0,_B,_Q),(0,_B,_R))
...
mySecurityAddressFdbId=_MySecurityAddressFdbId_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1,1,1),_MySecurityAddressFdbId_Type())
...
mySecurityAddressAddress=_MySecurityAddressAddress_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1,1,2),_MySecurityAddressAddress_Type())
...
mySecurityAddressPort=_MySecurityAddressPort_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1,1,3),_MySecurityAddressPort_Type())
...
mySecurityAddressIpAddr=_MySecurityAddressIpAddr_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1,1,4),_MySecurityAddressIpAddr_Type())
...
mySecurityAddressIfBindIp=_MySecurityAddressIfBindIp_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1,1,5),_MySecurityAddressIfBindIp_Type())
...
mySecurityAddressRemainAge=_MySecurityAddressRemainAge_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1,1,6),_MySecurityAddressRemainAge_Type())
...
mySecurityAddressType=_MySecurityAddressType_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1,1,7),_MySecurityAddressType_Type())
...
mySecurityAddressStatus=_MySecurityAddressStatus_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,1,1,8),_MySecurityAddressStatus_Type())
mySecurityAddressStatus.setMaxAccess(_S)
if mibBuilder.loadTexts:mySecurityAddressStatus.setStatus(_A)
_MyBindAddressTable_Object=MibTable
myBindAddressTable=_MyBindAddressTable_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,2))
if mibBuilder.loadTexts:myBindAddressTable.setStatus(_A)
_MyBindAddressEntry_Object=MibTableRow
myBindAddressEntry=_MyBindAddressEntry_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,2,1))
myBindAddressEntry.setIndexNames((0,_B,_T))
...
myBindAddressIpAddr=_MyBindAddressIpAddr_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,2,1,1),_MyBindAddressIpAddr_Type())
...
myBindMacAddress=_MyBindMacAddress_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,2,1,2),_MyBindMacAddress_Type())
myBindMacAddress.setMaxAccess(_S)
...
myBindAddressStatus=_MyBindAddressStatus_Object((1,3,6,1,4,1,171,10,97,2,6,1,2,2,1,3),_MyBindAddressStatus_Type())
...
myPortSecrrityObjects=_MyPortSecrrityObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,6,1,3))
_MyPortSecurityTable_Object=MibTable
myPortSecurityTable=_MyPortSecurityTable_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1))
if mibBuilder.loadTexts:myPortSecurityTable.setStatus(_A)
_MyPortSecurityEntry_Object=MibTableRow
myPortSecurityEntry=_MyPortSecurityEntry_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1))
myPortSecurityEntry.setIndexNames((0,_B,_G))
...
myPortSecurityPortIndex=_MyPortSecurityPortIndex_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1,1),_MyPortSecurityPortIndex_Type())
...
_MyPortSecurityStatus_Type.__name__=_J
_MyPortSecurityStatus_Object=MibTableColumn
myPortSecurityStatus=_MyPortSecurityStatus_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1,2),_MyPortSecurityStatus_Type())
...
myPortSecurViolationType=_MyPortSecurViolationType_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1,3),_MyPortSecurViolationType_Type())
...
myPortSecurityAddrNum=_MyPortSecurityAddrNum_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1,4),_MyPortSecurityAddrNum_Type())
...
myPortSecurityAddrAge=_MyPortSecurityAddrAge_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1,5),_MyPortSecurityAddrAge_Type())
...
myPortStaticSecurAddrIfAge=_MyPortStaticSecurAddrIfAge_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1,6),_MyPortStaticSecurAddrIfAge_Type())
...
myPortSecurityAddressCurrentNum=_MyPortSecurityAddressCurrentNum_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1,7),_MyPortSecurityAddressCurrentNum_Type())
...
myPortStaticSecurAddrCurrentNum=_MyPortStaticSecurAddrCurrentNum_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1,8),_MyPortStaticSecurAddrCurrentNum_Type())
...
myPortSecurityIpDistrMode=_MyPortSecurityIpDistrMode_Object((1,3,6,1,4,1,171,10,97,2,6,1,3,1,1,9),_MyPortSecurityIpDistrMode_Type())
...
mySecurityTraps=_MySecurityTraps_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,6,2))
_MySecurityMIBConformance_ObjectIdentity=ObjectIdentity
mySecurityMIBConformance=_MySecurityMIBConformance_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,6,3))
_MySecurityMIBCompliances_ObjectIdentity=ObjectIdentity
mySecurityMIBCompliances=_MySecurityMIBCompliances_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,6,3,1))
_MySecurityMIBGroups_ObjectIdentity=ObjectIdentity
mySecurityMIBGroups=_MySecurityMIBGroups_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,6,3,2))
myUserManageMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,6,3,2,1))
myUserManageMIBGroup.setObjects(*((_B,_U),(_B,_V),(_B,_W)))
if mibBuilder.loadTexts:myUserManageMIBGroup.setStatus(_A)
mySecurityAddressMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,6,3,2,2))
mySecurityAddressMIBGroup.setObjects(*((_B,_X),(_B,_Y),(_B,_Z),(_B,_a),(_B,_b),(_B,_c)))
if mibBuilder.loadTexts:mySecurityAddressMIBGroup.setStatus(_A)
myPortSecurityMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,6,3,2,3))
myPortSecurityMIBGroup.setObjects(*((_B,_G),(_B,_d),(_B,_e),(_B,_f),(_B,_g),(_B,_h),(_B,_i),(_B,_j),(_B,_k)))
if mibBuilder.loadTexts:myPortSecurityMIBGroup.setStatus(_A)
portSecurityViolate=NotificationType((1,3,6,1,4,1,171,10,97,2,6,2,1))
portSecurityViolate.setObjects((_H,_I))
if mibBuilder.loadTexts:portSecurityViolate.setStatus(_A)
mySecurityMIBCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,97,2,6,3,1,1))
mySecurityMIBCompliance.setObjects(*((_B,_l),(_B,_m),(_B,_n)))
if mibBuilder.loadTexts:mySecurityMIBCompliance.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'mySecurityMIB':mySecurityMIB,'mySecurityMIBObjects':mySecurityMIBObjects,'myUserManagementObjects':myUserManagementObjects,_U:myEnableSnmpAgent,_V:myEnableWeb,_W:myEnableTelnet,'myTelnetHostIpTable':myTelnetHostIpTable,'myTelnetHostIpEntry':myTelnetHostIpEntry,_K:myTelnetHostIpAddress,'myTelnetHostIpEnable':myTelnetHostIpEnable,'myWebHostIpTable':myWebHostIpTable,'myWebHostIpEntry':myWebHostIpEntry,_N:myWebHostIpAddress,'myWebHostIpEnable':myWebHostIpEnable,'mySecurityAddressObjects':mySecurityAddressObjects,'mySecurityAddressTable':mySecurityAddressTable,'mySecurityAddressEntry':mySecurityAddressEntry,_O:mySecurityAddressFdbId,_P:mySecurityAddressAddress,_Q:mySecurityAddressPort,_R:mySecurityAddressIpAddr,_X:mySecurityAddressIfBindIp,_Y:mySecurityAddressRemainAge,_Z:mySecurityAddressType,_a:mySecurityAddressStatus,'myBindAddressTable':myBindAddressTable,'myBindAddressEntry':myBindAddressEntry,_T:myBindAddressIpAddr,_b:myBindMacAddress,_c:myBindAddressStatus,'myPortSecrrityObjects':myPortSecrrityObjects,'myPortSecurityTable':myPortSecurityTable,'myPortSecurityEntry':myPortSecurityEntry,_G:myPortSecurityPortIndex,_d:myPortSecurityStatus,_e:myPortSecurViolationType,_f:myPortSecurityAddrNum,_g:myPortSecurityAddrAge,_h:myPortStaticSecurAddrIfAge,_i:myPortSecurityAddressCurrentNum,_j:myPortStaticSecurAddrCurrentNum,_k:myPortSecurityIpDistrMode,'mySecurityTraps':mySecurityTraps,'portSecurityViolate':portSecurityViolate,'mySecurityMIBConformance':mySecurityMIBConformance,'mySecurityMIBCompliances':mySecurityMIBCompliances,'mySecurityMIBCompliance':mySecurityMIBCompliance,'mySecurityMIBGroups':mySecurityMIBGroups,_l:myUserManageMIBGroup,_m:mySecurityAddressMIBGroup,_n:myPortSecurityMIBGroup})