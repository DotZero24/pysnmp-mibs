# SNMP MIB module (DES7200-SECURITY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-SECURITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:52:24 2025
...
myTelnetHostIpEntry.setIndexNames(
    (0, "DES7200-SECURITY-MIB", "myTelnetHostIpAddress"),
)
if mibBuilder.loadTexts:
...
myWebHostIpEntry.setIndexNames(
    (0, "DES7200-SECURITY-MIB", "myWebHostIpAddress"),
)
if mibBuilder.loadTexts:
...
mySecurityAddressEntry.setIndexNames(
    (0, "DES7200-SECURITY-MIB", "mySecurityAddressFdbId"),
    (0, "DES7200-SECURITY-MIB", "mySecurityAddressAddress"),
    (0, "DES7200-SECURITY-MIB", "mySecurityAddressPort"),
    (0, "DES7200-SECURITY-MIB", "mySecurityAddressIpAddr"),
)
if mibBuilder.loadTexts:
...
myBindAddressEntry.setIndexNames(
    (0, "DES7200-SECURITY-MIB", "myBindAddressIpAddr"),
)
if mibBuilder.loadTexts:
...
myPortSecurityEntry.setIndexNames(
    (0, "DES7200-SECURITY-MIB", "myPortSecurityPortIndex"),
)
if mibBuilder.loadTexts:
...
_MyPortSecurityStatus_Type.__name__ = "EnabledStatus"
...
myUserManageMIBGroup.setObjects(
      *(("DES7200-SECURITY-MIB", "myEnableSnmpAgent"),
        ("DES7200-SECURITY-MIB", "myEnableWeb"),
        ("DES7200-SECURITY-MIB", "myEnableTelnet"))
)
if mibBuilder.loadTexts:
...
mySecurityAddressMIBGroup.setObjects(
      *(("DES7200-SECURITY-MIB", "mySecurityAddressIfBindIp"),
        ("DES7200-SECURITY-MIB", "mySecurityAddressRemainAge"),
        ("DES7200-SECURITY-MIB", "mySecurityAddressType"),
        ("DES7200-SECURITY-MIB", "mySecurityAddressStatus"),
        ("DES7200-SECURITY-MIB", "myBindMacAddress"),
        ("DES7200-SECURITY-MIB", "myBindAddressStatus"))
)
if mibBuilder.loadTexts:
...
myPortSecurityMIBGroup.setObjects(
      *(("DES7200-SECURITY-MIB", "myPortSecurityPortIndex"),
        ("DES7200-SECURITY-MIB", "myPortSecurityStatus"),
        ("DES7200-SECURITY-MIB", "myPortSecurViolationType"),
        ("DES7200-SECURITY-MIB", "myPortSecurityAddrNum"),
        ("DES7200-SECURITY-MIB", "myPortSecurityAddrAge"),
        ("DES7200-SECURITY-MIB", "myPortStaticSecurAddrIfAge"),
        ("DES7200-SECURITY-MIB", "myPortSecurityAddressCurrentNum"),
        ("DES7200-SECURITY-MIB", "myPortStaticSecurAddrCurrentNum"),
...
mySecurityMIBCompliance.setObjects(
      *(("DES7200-SECURITY-MIB", "myUserManageMIBGroup"),
        ("DES7200-SECURITY-MIB", "mySecurityAddressMIBGroup"),
        ("DES7200-SECURITY-MIB", "myPortSecurityMIBGroup"))
)
if mibBuilder.loadTexts:
