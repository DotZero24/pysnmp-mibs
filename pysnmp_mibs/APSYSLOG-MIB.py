...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/acme/APSYSLOG-MIB
...
apSyslogModule.setRevisions(('2012-07-16 00:00',))
if mibBuilder.loadTexts: apSyslogModule.setLastUpdated('201207160000Z')
...
mibBuilder.exportSymbols("APSYSLOG-MIB", apSyslogHistoryTable=apSyslogHistoryTable, apSyslogModule=apSyslogModule, apSyslogBasic=apSyslogBasic, apSyslogMIBNotificationPrefix=apSyslogMIBNotificationPrefix, PYSNMP_MODULE_ID=apSyslogModule, apSyslogHistoryEntry=apSyslogHistoryEntry, apSyslogMIBObjects=apSyslogMIBObjects, apSyslogHistContent=apSyslogHistContent, apSyslogMIBNotifications=apSyslogMIBNotifications, apSyslogHistTimestamp=apSyslogHistTimestamp, apSyslogMsgDrops=apSyslogMsgDrops, apSyslogMessageGenerated=apSyslogMessageGenerated, apSyslogMaxLevel=apSyslogMaxLevel, apSyslogNotificationsSent=apSyslogNotificationsSent, apSyslogHistTableMaxLength=apSyslogHistTableMaxLength, apSyslogHistory=apSyslogHistory, apSyslogHistLevel=apSyslogHistLevel, apSyslogNotificationsEnabled=apSyslogNotificationsEnabled, apSyslogMIBCompliances=apSyslogMIBCompliances, apSyslogMIBGroups=apSyslogMIBGroups, apSyslogHistMsgsFlushed=apSyslogHistMsgsFlushed, SyslogLevel=SyslogLevel, apSyslogHistIndex=apSyslogHistIndex, apSyslogHistType=apSyslogHistType, apSyslogGroup=apSyslogGroup, apSyslogMIBConformance=apSyslogMIBConformance, apSyslogHistFrom=apSyslogHistFrom, apSyslogNotificationsGroup=apSyslogNotificationsGroup, apSyslogMsgIgnores=apSyslogMsgIgnores)
