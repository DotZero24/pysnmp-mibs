...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/d-link/DGS-3420-52P-L2MGMT-MIB
...
swL2IGMPMgmt = MibIdentifier((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 11))
...
swL2PortInfoErrorDisabled = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 1, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(("none", 0), ("storm", 1), ("stp-lbd", 2), ("ctp-lbd", 3), ("ddm", 4), ("bpdu-protection", 5), ("unknow", 6), ("power-saving", 7)))).setMaxAccess("readonly")
...
swL2PortSfpInfoTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11), )
if mibBuilder.loadTexts: swL2PortSfpInfoTable.setStatus('current')
swL2PortSfpInfoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1), ).setIndexNames((0, "DGS-3420-52P-L2MGMT-MIB", "swL2PortSfpInfoPortIndex"))
if mibBuilder.loadTexts: swL2PortSfpInfoEntry.setStatus('current')
swL2PortSfpInfoPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoPortIndex.setStatus('current')
swL2PortSfpInfoConnectType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 2), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 8))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoConnectType.setStatus('current')
swL2PortSfpInfoVendorName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 3), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 16))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoVendorName.setStatus('current')
swL2PortSfpInfoVendorPN = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 4), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 16))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoVendorPN.setStatus('current')
swL2PortSfpInfoVendorSN = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 5), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 16))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoVendorSN.setStatus('current')
swL2PortSfpInfoVendorOUI = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 6), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 6))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoVendorOUI.setStatus('current')
swL2PortSfpInfoVendorRev = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 7), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 4))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoVendorRev.setStatus('current')
swL2PortSfpInfoDateCode = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 8), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 8))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoDateCode.setStatus('current')
swL2PortSfpInfoFiberType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 9), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 16))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoFiberType.setStatus('current')
swL2PortSfpInfoBaudRate = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 10), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2PortSfpInfoBaudRate.setStatus('current')
swL2PortSfpInfoWavelength = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 3, 11, 1, 11), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
...
swL2IGMPAccessAuthTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 11, 13), )
if mibBuilder.loadTexts: swL2IGMPAccessAuthTable.setStatus('current')
swL2IGMPAccessAuthEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 11, 13, 1), ).setIndexNames((0, "DGS-3420-52P-L2MGMT-MIB", "swL2IGMPAccessAuthPort"))
if mibBuilder.loadTexts: swL2IGMPAccessAuthEntry.setStatus('current')
swL2IGMPAccessAuthPort = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 11, 13, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL2IGMPAccessAuthPort.setStatus('current')
swL2IGMPAccessAuthState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 5, 2, 11, 13, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2), ("auth_only", 3), ("accounting_only", 4)))).setMaxAccess("readwrite")
