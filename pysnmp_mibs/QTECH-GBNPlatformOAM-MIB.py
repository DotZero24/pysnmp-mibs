# SNMP MIB module (QTECH-GBNPlatformOAM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-GBNPlatformOAM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:57:53 2025
...
sysIfManageVLANEntry = _SysIfManageVLANEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 1, 9, 1)
)
sysIfManageVLANEntry.setIndexNames(
    (0, "QTECH-GBNPlatformOAM-MIB", "sysIfManageVLANVid"),
)
if mibBuilder.loadTexts:
...
sysIfManageVLANVid = _SysIfManageVLANVid_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 1, 9, 1, 1),
...
sysIfManageVLANRowStatus = _SysIfManageVLANRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 1, 9, 1, 2),
...
class _SoftwareCompliedTimeE_Type(DisplayString):
    """Custom type softwareCompliedTimeE based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 100),
    )
...
_SoftwareCompliedTimeE_Type.__name__ = "DisplayString"
_SoftwareCompliedTimeE_Object = MibScalar
softwareCompliedTimeE = _SoftwareCompliedTimeE_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 3),
    _SoftwareCompliedTimeE_Type()
)
softwareCompliedTimeE.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    softwareCompliedTimeE.setStatus("current")


class _SoftwareCompliedTimeC_Type(DisplayString):
    """Custom type softwareCompliedTimeC based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 100),
    )
...
_SoftwareCompliedTimeC_Type.__name__ = "DisplayString"
_SoftwareCompliedTimeC_Object = MibScalar
softwareCompliedTimeC = _SoftwareCompliedTimeC_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 4),
    _SoftwareCompliedTimeC_Type()
)
softwareCompliedTimeC.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    softwareCompliedTimeC.setStatus("current")


class _CpuDescrition_Type(DisplayString):
    """Custom type cpuDescrition based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 100),
    )
...
_CpuDescrition_Type.__name__ = "DisplayString"
_CpuDescrition_Object = MibScalar
cpuDescrition = _CpuDescrition_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 5),
    _CpuDescrition_Type()
)
cpuDescrition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpuDescrition.setStatus("current")


class _SdramDescrition_Type(DisplayString):
    """Custom type sdramDescrition based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 100),
    )
...
_SdramDescrition_Type.__name__ = "DisplayString"
_SdramDescrition_Object = MibScalar
sdramDescrition = _SdramDescrition_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 6),
    _SdramDescrition_Type()
)
sdramDescrition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    sdramDescrition.setStatus("current")


class _FlashDescrition_Type(DisplayString):
    """Custom type flashDescrition based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 100),
    )
...
_FlashDescrition_Type.__name__ = "DisplayString"
_FlashDescrition_Object = MibScalar
flashDescrition = _FlashDescrition_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 7),
    _FlashDescrition_Type()
)
flashDescrition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    flashDescrition.setStatus("current")
...
hostName = _HostName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 10),
    _HostName_Type()
)
...
cpuIdle = _CpuIdle_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 11),
    _CpuIdle_Type()
)
...
memorySize = _MemorySize_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 12),
    _MemorySize_Type()
)
...
memoryIdle = _MemoryIdle_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 13),
    _MemoryIdle_Type()
)
...
timeZoneName = _TimeZoneName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 14, 2),
    _TimeZoneName_Type()
)
...
timeZoneOffset = _TimeZoneOffset_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 14, 3),
...
offsetNegFlag = _OffsetNegFlag_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 14, 4),
    _OffsetNegFlag_Type()
)
...
productName = _ProductName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 15),
    _ProductName_Type()
)
...
saveNMInterfaceConfig = _SaveNMInterfaceConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 18)
)
...
nmInterfaceId = _NmInterfaceId_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 18, 1),
    _NmInterfaceId_Type()
)
...
nmInterfaceIpAddress = _NmInterfaceIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 18, 2),
...
nmInterfaceNetMask = _NmInterfaceNetMask_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 18, 3),
...
nmInterfaceGateAddress = _NmInterfaceGateAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 18, 4),
...
prodSerialNo = _ProdSerialNo_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 19),
    _ProdSerialNo_Type()
)
...
cpuBusyStatus = _CpuBusyStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 20),
    _CpuBusyStatus_Type()
)
...
cpuBusyAlarmEnable = _CpuBusyAlarmEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 21),
...
cpuBusyThreshold = _CpuBusyThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 22),
...
cpuUnbusyThreshold = _CpuUnbusyThreshold_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 23),
...
cpuStatusTrap = _CpuStatusTrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 24)
)
...
ipAccessControlEntry = _IpAccessControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 3, 1, 1)
)
ipAccessControlEntry.setIndexNames(
    (0, "QTECH-GBNPlatformOAM-MIB", "controlIpAddress"),
    (0, "QTECH-GBNPlatformOAM-MIB", "controlIpMask"),
    (0, "QTECH-GBNPlatformOAM-MIB", "controlTeminal"),
)
if mibBuilder.loadTexts:
...
controlIpAddress = _ControlIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 3, 1, 1, 1),
...
controlIpMask = _ControlIpMask_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 3, 1, 1, 2),
    _ControlIpMask_Type()
)
...
controlTeminal = _ControlTeminal_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 3, 1, 1, 3),
...
controlStatus = _ControlStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 3, 1, 1, 4),
    _ControlStatus_Type()
)
...
musrIndex = _MusrIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 5, 1, 1, 1),
    _MusrIndex_Type()
)
...
musrName = _MusrName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 5, 1, 1, 2),
    _MusrName_Type()
)
...
musrPassword = _MusrPassword_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 5, 1, 1, 3),
    _MusrPassword_Type()
)
...
musrType = _MusrType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 5, 1, 1, 4),
    _MusrType_Type()
)
...
musrRowStatus = _MusrRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 5, 1, 1, 5),
    _MusrRowStatus_Type()
)
...
snmpCommunityToViewEntry = _SnmpCommunityToViewEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 1, 1)
)
snmpCommunityToViewEntry.setIndexNames(
    (0, "QTECH-GBNPlatformOAM-MIB", "snmpComm2ViewIndex"),
)
if mibBuilder.loadTexts:
...
snmpComm2ViewIndex = _SnmpComm2ViewIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 1, 1, 1),
...
snmpComm2ViewCommName = _SnmpComm2ViewCommName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 1, 1, 2),
...
snmpComm2ViewViewName = _SnmpComm2ViewViewName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 1, 1, 3),
...
snmpComm2ViewPermission = _SnmpComm2ViewPermission_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 1, 1, 4),
...
snmpComm2ViewRowStatus = _SnmpComm2ViewRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 1, 1, 5),
...
snmpNotifyTypeEntry = _SnmpNotifyTypeEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 2, 1)
)
snmpNotifyTypeEntry.setIndexNames(
    (0, "QTECH-GBNPlatformOAM-MIB", "snmpPrivateNotifyType"),
)
if mibBuilder.loadTexts:
...
snmpPrivateNotifyType = _SnmpPrivateNotifyType_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 2, 1, 1),
...
snmpNotifyTypeStatus = _SnmpNotifyTypeStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 2, 1, 2),
...
snmpRemoteEngineEntry = _SnmpRemoteEngineEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 5, 1)
)
snmpRemoteEngineEntry.setIndexNames(
    (0, "QTECH-GBNPlatformOAM-MIB", "snmpRemoteEngineID"),
)
if mibBuilder.loadTexts:
...
snmpRemoteEngineID = _SnmpRemoteEngineID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 5, 1, 1),
...
snmpRemoteHostTAddr = _SnmpRemoteHostTAddr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 5, 1, 2),
...
snmpDeleteRemoteEngineTableRow = _SnmpDeleteRemoteEngineTableRow_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 5, 1, 3),
...
_PortCarPort_Type.__name__ = "Integer32"
_PortCarPort_Object = MibTableColumn
portCarPort = _PortCarPort_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 10, 1, 1, 1),
    _PortCarPort_Type()
)
...
portCarEnable = _PortCarEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 10, 1, 1, 2),
    _PortCarEnable_Type()
)
...
portCarGlobalEnable = _PortCarGlobalEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 10, 2),
...
portCarOpenTime = _PortCarOpenTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 10, 3),
...
discardBpdu = _DiscardBpdu_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 10, 4),
    _DiscardBpdu_Type()
)
...
portCarRate = _PortCarRate_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 10, 5),
    _PortCarRate_Type()
)
...
cpuBusyTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 24, 1)
)
if mibBuilder.loadTexts:
...
cpuUnbusyTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 2, 24, 2)
)
if mibBuilder.loadTexts:
...
snmpNotifyTypeSaveConfiguration = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 2, 1, 1, 7, 3, 1)
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"gbnPlatformOAM": gbnPlatformOAM,
       ...
       "softwareCompliedTimeE": softwareCompliedTimeE,
       "softwareCompliedTimeC": softwareCompliedTimeC,
       "cpuDescrition": cpuDescrition,
       "sdramDescrition": sdramDescrition,
       "flashDescrition": flashDescrition,
