# SNMP MIB module (HUAWEI-AR46-DEV-ADM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/HUAWEI-AR46-DEV-ADM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:17:45 2025
...
hw8060FrameEntry.setIndexNames(
    (0, "HUAWEI-AR46-DEV-ADM-MIB", "hw8060FrameIndex"),
)
if mibBuilder.loadTexts:
...
hw8060SlotEntry.setIndexNames(
    (0, "HUAWEI-AR46-DEV-ADM-MIB", "hw8060SlotIndex"),
)
if mibBuilder.loadTexts:
...
hw8060SubslotEntry.setIndexNames(
    (0, "HUAWEI-AR46-DEV-ADM-MIB", "hw8060SlotIndex"),
    (0, "HUAWEI-AR46-DEV-ADM-MIB", "hw8060SubslotIndex"),
)
if mibBuilder.loadTexts:
...
hw8060PortEntry.setIndexNames(
    (0, "HUAWEI-AR46-DEV-ADM-MIB", "hw8060SlotIndex"),
    (0, "HUAWEI-AR46-DEV-ADM-MIB", "hw8060SubslotIndex"),
    (0, "HUAWEI-AR46-DEV-ADM-MIB", "hw8060PortIndex"),
)
if mibBuilder.loadTexts:
...
dev8060MPowerStatusEntry.setIndexNames(
    (0, "HUAWEI-AR46-DEV-ADM-MIB", "dev8060MPowerNum"),
)
if mibBuilder.loadTexts:
...
dev8060MFanStatusEntry.setIndexNames(
    (0, "HUAWEI-AR46-DEV-ADM-MIB", "dev8060MFanNum"),
)
if mibBuilder.loadTexts:
...
hwSlotReset.setObjects(
    ("HUAWEI-AR46-DEV-ADM-MIB", "hw8060SlotIndex")
)
if mibBuilder.loadTexts:
...
hwSlotIntReportErr.setObjects(
    ("HUAWEI-AR46-DEV-ADM-MIB", "hw8060SubslotIndex")
)
if mibBuilder.loadTexts:
...
hwPowerUnitFail.setObjects(
    ("HUAWEI-AR46-DEV-ADM-MIB", "dev8060MPowerNum")
)
if mibBuilder.loadTexts:
...
hwFanUnitFail.setObjects(
    ("HUAWEI-AR46-DEV-ADM-MIB", "dev8060MFanNum")
)
if mibBuilder.loadTexts:
