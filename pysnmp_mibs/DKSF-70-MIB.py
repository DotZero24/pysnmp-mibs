...
mibBuilder.exportSymbols("DKSF-70-MIB", npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayTrapAllEvents=npRelayTrapAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTable=npCurLoopTable, npExtRelayFlip=npExtRelayFlip, npVoltageTrapPeak=npVoltageTrapPeak, npInputAnalogWorkRangeHigh=npInputAnalogWorkRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npInputAnalogTrapResistance=npInputAnalogTrapResistance, npThermo=npThermo, npInputAnalogTrapSafeRangeHigh=npInputAnalogTrapSafeRangeHigh, npInputAnalogTrapWorkRangeHigh=npInputAnalogTrapWorkRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npVoltageStatus=npVoltageStatus, npRelHumTrapDataN=npRelHumTrapDataN, npExtRelayTrapDateTime=npExtRelayTrapDateTime, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapValue=npThermoTrapValue, npInputAnalogEntry=npInputAnalogEntry, npInputAnalogSafeRangeHigh=npInputAnalogSafeRangeHigh, npInputAnalogSafeRangeLow=npInputAnalogSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npVoltageTrapFreq=npVoltageTrapFreq, npRelayTrapOn=npRelayTrapOn, npIoTrapMemo=npIoTrapMemo, npVoltageTrap=npVoltageTrap, npInputAnalog=npInputAnalog, npVoltageTraps=npVoltageTraps, npInputAnalogResistance=npInputAnalogResistance, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npRelHumMemo=npRelHumMemo, npRelHumTrapFail=npRelHumTrapFail, npVoltageFreqStatus=npVoltageFreqStatus, npExtRelayTable=npExtRelayTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapData=npRelHumTrapData, npGsmTrapPrefix=npGsmTrapPrefix, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, npVoltageTrapStatus=npVoltageTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npVoltageSagCounter=npVoltageSagCounter, npExtRelayMode=npExtRelayMode, npVoltageEntry=npVoltageEntry, npVoltageTrapPrefix=npVoltageTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrapUnparsedSms=npGsmTrapUnparsedSms, npGsmTraps=npGsmTraps, npInputAnalogTrapWorkRangeLow=npInputAnalogTrapWorkRangeLow, npInputAnalogVoltage=npInputAnalogVoltage, npInputAnalogReset=npInputAnalogReset, npExtRelayTrapCmdSrc=npExtRelayTrapCmdSrc, npRelHumTable=npRelHumTable, npIrCtrl=npIrCtrl, npRelayTrapAllChannels=npRelayTrapAllChannels, npThermoLow=npThermoLow, npThermoTrapLow=npThermoTrapLow, npIoLineN=npIoLineN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npVoltageSagBigThreshold=npVoltageSagBigThreshold, npExtRelayStartReset=npExtRelayStartReset, npRelayTrapN=npRelayTrapN, npIrReset=npIrReset, npInputAnalogPower=npInputAnalogPower, npGsmUnparsedRxSms=npGsmUnparsedRxSms, npExtRelayTrapN=npExtRelayTrapN, npThermoTrapMemo=npThermoTrapMemo, npRelayTrapData=npRelayTrapData, npIoSinglePulseDuration=npIoSinglePulseDuration, npVoltageSagSmallThreshold=npVoltageSagSmallThreshold, npExtRelayTrapState=npExtRelayTrapState, npVoltageN=npVoltageN, npExtRelayN=npExtRelayN, npVoltageFreq=npVoltageFreq, npRelayN=npRelayN, npRelHumidity=npRelHumidity, npInputAnalogTrapPrefix=npInputAnalogTrapPrefix, npInputAnalogTrap=npInputAnalogTrap, npInputAnalogTrapMemo=npInputAnalogTrapMemo, npIoTrap=npIoTrap, npExtRelayEntry=npExtRelayEntry, npCurLoopN=npCurLoopN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayTrapState=npRelayTrapState, npGsmUnparsedRxSmsUtf8=npGsmUnparsedRxSmsUtf8, npCurLoopStatus=npCurLoopStatus, npInputAnalogTrapPower=npInputAnalogTrapPower, npInputAnalogTrapSensorN=npInputAnalogTrapSensorN, npGsm=npGsm, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npInputAnalogWorkRangeLow=npInputAnalogWorkRangeLow, npRelayTrapReset=npRelayTrapReset, npInputAnalogTable=npInputAnalogTable, npVoltageTrapSagCounter=npVoltageTrapSagCounter, npGsmTrap=npGsmTrap, npCurLoopV=npCurLoopV, npVoltageTrapFreqStatus=npVoltageTrapFreqStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayState=npRelayState, npExtRelayTrapOff=npExtRelayTrapOff, npExtRelayTrapMemo=npExtRelayTrapMemo, npVoltagePeakStatus=npVoltagePeakStatus, npVoltageRMS=npVoltageRMS, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, FixedPoint1000=FixedPoint1000, npRelayStartReset=npRelayStartReset, npInputAnalogTrapStatus=npInputAnalogTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayTrapOff=npRelayTrapOff, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempValue=npRelHumTempValue, npVoltageTable=npVoltageTable, npExtRelayTrapOn=npExtRelayTrapOn, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapSensorN=npThermoTrapSensorN, npVoltageStandard=npVoltageStandard, npRelHumStatus=npRelHumStatus, npExtRelayState=npExtRelayState, npRelayMemo=npRelayMemo, npRelayTrapMode=npRelayTrapMode, npVoltage=npVoltage, npRelayFlip=npRelayFlip, npCurLoopTrap=npCurLoopTrap, npCurLoopPower=npCurLoopPower, npTrapEmailTo=npTrapEmailTo, npIrStatus=npIrStatus, npVoltageSagMediumThreshold=npVoltageSagMediumThreshold, npCurLoopR=npCurLoopR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npVoltageTrapRMS=npVoltageTrapRMS, npExtRelay=npExtRelay, npRelHumN=npRelHumN, npVoltageTrapMemo=npVoltageTrapMemo, npExtRelayTrapModeChange=npExtRelayTrapModeChange, npExtRelayMemo=npExtRelayMemo, npInputAnalogTrapVoltage=npInputAnalogTrapVoltage, npIoTrapLineN=npIoTrapLineN, npIoTable=npIoTable, npRelHumTrapTemp=npRelHumTrapTemp, npInputAnalogCurrent=npInputAnalogCurrent, npVoltageMemo=npVoltageMemo, npRelHumTrapSafe=npRelHumTrapSafe, npExtRelayTrapMode=npExtRelayTrapMode, npGsmRegistration=npGsmRegistration, npThermoStatus=npThermoStatus, npCurLoopTrapI=npCurLoopTrapI, npVoltageTrapPeakStatus=npVoltageTrapPeakStatus, npThermoValuePrecise=npThermoValuePrecise, npVoltageSagStatus=npVoltageSagStatus, npInputAnalogMemo=npInputAnalogMemo, npRelayTrap=npRelayTrap, npCurLoopI=npCurLoopI, npGsmStrength=npGsmStrength, npInputAnalogTrapSafeRangeLow=npInputAnalogTrapSafeRangeLow, npRelHumValue=npRelHumValue, npRelayTrapCmdSrc=npRelayTrapCmdSrc, npCurLoop=npCurLoop, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayTable=npRelayTable, npVoltageTrapN=npVoltageTrapN, npRelayTrapDateTime=npRelayTrapDateTime, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapV=npCurLoopTrapV, npThermoTable=npThermoTable, npExtRelayTrap=npExtRelayTrap, npThermoTraps=npThermoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npExtRelayTrapAllChannels=npExtRelayTrapAllChannels, npIr=npIr, npExtRelayTrapReset=npExtRelayTrapReset, npThermoSensorN=npThermoSensorN, npRelayTrapMemo=npRelayTrapMemo, npVoltageTrapSagStatus=npVoltageTrapSagStatus, npRelayTrapModeChange=npRelayTrapModeChange, npRelHumTrapTempFail=npRelHumTrapTempFail, npResetStack=npResetStack, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelay=npRelay, npInputAnalogTrapCurrent=npInputAnalogTrapCurrent, npInputAnalogTraps=npInputAnalogTraps, npIoLevelIn=npIoLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npIoEntry=npIoEntry, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npInputAnalogSensorN=npInputAnalogSensorN, npThermoMemo=npThermoMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoHigh=npThermoHigh, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmFailed=npGsmFailed, npReboot=npReboot, npThermoTrap=npThermoTrap, npExtRelayTrapAllEvents=npExtRelayTrapAllEvents, npVoltagePeak=npVoltagePeak, lightcom=lightcom, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMode=npRelayMode, npInputAnalogStatus=npInputAnalogStatus, npThermoTrapPrefix=npThermoTrapPrefix, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npExtRelayTrapData=npExtRelayTrapData, npGsmUnparsedRxSmsFrom=npGsmUnparsedRxSmsFrom, npIo=npIo, npIrPlayCmd=npIrPlayCmd, npGsmInfo=npGsmInfo, npThermoTrapHigh=npThermoTrapHigh)
