...
ifRcvAddressStatus, ifGeneralGroup, ifOutBroadcastPkts, ifHCOutBroadcastPkts, ifConnectorPresent, ifTestOwner, ifHCInOctets, ifNumber, ifHCOutUcastPkts, ifInBroadcastPkts, ifStackLowerLayer, ifRcvAddressType, ifTestGroup, ifTestStatus, ifHighSpeed, ifHCOutMulticastPkts, ifStackLastChange, ifHCPacketGroup, ifTestId, ifFixedLengthGroup, ifGeneralInformationGroup, ifHCInBroadcastPkts, ifCompliance2, ifHCInUcastPkts, ifStackGroup2, ifInMulticastPkts, ifName, ifTableLastChange, ifStackHigherLayer, ifRcvAddressGroup, ifHCOutOctets, ifHCInMulticastPkts, ifCounterDiscontinuityTime, ifVHCPacketGroup, ifOldObjectsGroup, ifAlias, ifRcvAddressAddress, ifPromiscuousMode, ifTestResult, ifTestType, ifCompliance, ifStackStatus, ifCounterDiscontinuityGroup, ifLinkUpDownTrapEnable, ifTestCode, ifHCFixedLengthGroup, ifPacketGroup, ifOutMulticastPkts, ifIndex, ifStackGroup = mibBuilder.importSymbols("IF-MIB", "ifRcvAddressStatus", "ifGeneralGroup", "ifOutBroadcastPkts", "ifHCOutBroadcastPkts", "ifConnectorPresent", "ifTestOwner", "ifHCInOctets", "ifNumber", "ifHCOutUcastPkts", "ifInBroadcastPkts", "ifStackLowerLayer", "ifRcvAddressType", "ifTestGroup", "ifTestStatus", "ifHighSpeed", "ifHCOutMulticastPkts", "ifStackLastChange", "ifHCPacketGroup", "ifTestId", "ifFixedLengthGroup", "ifGeneralInformationGroup", "ifHCInBroadcastPkts", "ifCompliance2", "ifHCInUcastPkts", "ifStackGroup2", "ifInMulticastPkts", "ifName", "ifTableLastChange", "ifStackHigherLayer", "ifRcvAddressGroup", "ifHCOutOctets", "ifHCInMulticastPkts", "ifCounterDiscontinuityTime", "ifVHCPacketGroup", "ifOldObjectsGroup", "ifAlias", "ifRcvAddressAddress", "ifPromiscuousMode", "ifTestResult", "ifTestType", "ifCompliance", "ifStackStatus", "ifCounterDiscontinuityGroup", "ifLinkUpDownTrapEnable", "ifTestCode", "ifHCFixedLengthGroup", "ifPacketGroup", "ifOutMulticastPkts", "ifIndex", "ifStackGroup")
...
zhoneZedge, sechtor300, zhonePhysical, zhoneOcx, zhoneRegPls, zhoneVoice, zhoneConsole, zhoneModules, zhoneMasterAgent, zhoneMalc, zhoneRegWtn, zhoneDsl, zhoneCard, zhoneInterfaceGroup, zhoneDsx, sipTC, zhoneRadio, zhoneShelfSlotGroup, zhoneSystem, zhoneShelfIndex, apsMIB, zhoneRegCpe, zhoneShelfSlotCompliance, zhonePls, zhoneVoiceStats, zhoneBridge, zhoneSonet, zhoneWtn, zhoneZAP, zhoneShelf, sechtor100, zhoneLineTypes, zhoneDrafts, zhoneGroups, zhoneRegSechtor, zhoneDs3Ext, zhoneRegMux, zhoneSlotIndex, zhoneRegMalc, sipUAMIB, zhoneVoip, zhoneEnet, zhoneZplex, zhoneInterfaceTranslation, zhoneAtm, zhoneZmsProduct, zhoneIma, zhoneGenWtn, zhonePpp, sipCommonMIB, zhoneIp, zhoneSubscriber, zhoneTrapModules = mibBuilder.importSymbols("Zhone", "zhoneZedge", "sechtor300", "zhonePhysical", "zhoneOcx", "zhoneRegPls", "zhoneVoice", "zhoneConsole", "zhoneModules", "zhoneMasterAgent", "zhoneMalc", "zhoneRegWtn", "zhoneDsl", "zhoneCard", "zhoneInterfaceGroup", "zhoneDsx", "sipTC", "zhoneRadio", "zhoneShelfSlotGroup", "zhoneSystem", "zhoneShelfIndex", "apsMIB", "zhoneRegCpe", "zhoneShelfSlotCompliance", "zhonePls", "zhoneVoiceStats", "zhoneBridge", "zhoneSonet", "zhoneWtn", "zhoneZAP", "zhoneShelf", "sechtor100", "zhoneLineTypes", "zhoneDrafts", "zhoneGroups", "zhoneRegSechtor", "zhoneDs3Ext", "zhoneRegMux", "zhoneSlotIndex", "zhoneRegMalc", "sipUAMIB", "zhoneVoip", "zhoneEnet", "zhoneZplex", "zhoneInterfaceTranslation", "zhoneAtm", "zhoneZmsProduct", "zhoneIma", "zhoneGenWtn", "zhonePpp", "sipCommonMIB", "zhoneIp", "zhoneSubscriber", "zhoneTrapModules")
...
mibBuilder.exportSymbols("ZhoneAPON-MIB", zhoneOnuStatusAlarmPEE=zhoneOnuStatusAlarmPEE, zhoneOltOnuConfigEntry=zhoneOltOnuConfigEntry, zhoneOltLineStatusChangeTrap=zhoneOltLineStatusChangeTrap, zhoneOltOnuStatusPonAlarmSUF=zhoneOltOnuStatusPonAlarmSUF, zhoneOnuStatusAlarmOAML=zhoneOnuStatusAlarmOAML, zhoneAponMIB=zhoneAponMIB, zhoneOltTrafficContainerEntry=zhoneOltTrafficContainerEntry, zhoneOnuLineStatusChangeTrap=zhoneOnuLineStatusChangeTrap, zhoneOltTrafficContainerGuaranteedBW=zhoneOltTrafficContainerGuaranteedBW, zhoneOnuStatusAlarmMEM=zhoneOnuStatusAlarmMEM, zhoneOnuStatusLoopback=zhoneOnuStatusLoopback, zhoneOltOnuStatusPonAlarmSD=zhoneOltOnuStatusPonAlarmSD, zhoneOltTrafficContainerCbrCompensate=zhoneOltTrafficContainerCbrCompensate, zhoneOltConfigMaxPonDistance=zhoneOltConfigMaxPonDistance, zhoneOnuConfigNetworkRefClk=zhoneOnuConfigNetworkRefClk, zhoneOltOnuStatusPonAlarmLOA=zhoneOltOnuStatusPonAlarmLOA, zhoneOltConfigCellScrambling=zhoneOltConfigCellScrambling, zhoneOltOnuStatusPonAlarmOAML=zhoneOltOnuStatusPonAlarmOAML, zhoneOltOnuStatusPonAlarmRXINH=zhoneOltOnuStatusPonAlarmRXINH, zhoneOltConfigCpeLimit=zhoneOltConfigCpeLimit, zhoneOltConfigHecRxBypass=zhoneOltConfigHecRxBypass, zhoneOltConfigLcdAlpha=zhoneOltConfigLcdAlpha, zhoneOnuStatusLastChange=zhoneOnuStatusLastChange, zhoneOltStatusPonAlarmTF=zhoneOltStatusPonAlarmTF, zhoneOnuStatusAlarmDACT=zhoneOnuStatusAlarmDACT, zhoneAponOltOnuStatusGroup=zhoneAponOltOnuStatusGroup, zhoneOltConfigTxSyncBytes=zhoneOltConfigTxSyncBytes, zhoneOnuStatusAlarmSD=zhoneOnuStatusAlarmSD, zhoneAPONV2Traps=zhoneAPONV2Traps, zhoneAponOnuConfigGroup=zhoneAponOnuConfigGroup, zhoneOltOnuStatusPonAlarmLOS=zhoneOltOnuStatusPonAlarmLOS, PYSNMP_MODULE_ID=zhoneAponMIB, zhoneOltTrafficContainerIndexNext=zhoneOltTrafficContainerIndexNext, zhoneOnuStatusOperStatus=zhoneOnuStatusOperStatus, zhoneOltConfigCdrActiveHigh=zhoneOltConfigCdrActiveHigh, zhoneOltStatusPonAlarmCPE=zhoneOltStatusPonAlarmCPE, zhoneOltStatusPonAlarmLPHY=zhoneOltStatusPonAlarmLPHY, zhoneOltConfigAutoLearn=zhoneOltConfigAutoLearn, zhoneOnuConfigHEC=zhoneOnuConfigHEC, zhoneAponOnuStatusGroup=zhoneAponOnuStatusGroup, zhoneAponOltOnuConfigGroup=zhoneAponOltOnuConfigGroup, zhoneOltOnuStatusPonAlarmERR=zhoneOltOnuStatusPonAlarmERR, zhoneOltTrafficContainerMaximumBW=zhoneOltTrafficContainerMaximumBW, zhoneOltConfigCrcRx=zhoneOltConfigCrcRx, zhoneOnuConfigEntry=zhoneOnuConfigEntry, zhoneOltConfigSyncBytesClkDivisor=zhoneOltConfigSyncBytesClkDivisor, zhoneOnuStatusAlarmERR=zhoneOnuStatusAlarmERR, zhoneOltTrafficContainerTable=zhoneOltTrafficContainerTable, zhoneOnuStatusAlarmMIS=zhoneOnuStatusAlarmMIS, zhoneOltOnuStatusPonAlarmPEE=zhoneOltOnuStatusPonAlarmPEE, zhoneOltConfigCdrLocation=zhoneOltConfigCdrLocation, zhoneOnuConfigPassword=zhoneOnuConfigPassword, zhoneOltConfigBip8=zhoneOltConfigBip8, zhoneOltConfigLcdLimit=zhoneOltConfigLcdLimit, zhoneOltConfigHec=zhoneOltConfigHec, zhoneOltOnuStatusPonAlarmMEM=zhoneOltOnuStatusPonAlarmMEM, zhoneAponOltTrafficContainerGroup=zhoneAponOltTrafficContainerGroup, zhoneOltConfigUtopiaDiscard=zhoneOltConfigUtopiaDiscard, zhoneOltStatusPonAlarmLCD=zhoneOltStatusPonAlarmLCD, zhoneOltOnuConfigSerialNum=zhoneOltOnuConfigSerialNum, zhoneOltStatusLoopback=zhoneOltStatusLoopback, zhoneOltStatusPonAlarmPEE=zhoneOltStatusPonAlarmPEE, zhoneOnuConfigTable=zhoneOnuConfigTable, zhoneOnuStatusAlarmLCD=zhoneOnuStatusAlarmLCD, zhoneOnuConfigRfVideo=zhoneOnuConfigRfVideo, zhoneOltConfigTable=zhoneOltConfigTable, zhoneOltStatusState=zhoneOltStatusState, zhoneOltConfigOverheadSize=zhoneOltConfigOverheadSize, zhoneOnuStatusTable=zhoneOnuStatusTable, zhoneOnuStatusEntry=zhoneOnuStatusEntry, zhoneAponTraps=zhoneAponTraps, zhoneOltOnuConfigLineStatusChangeTrapEnable=zhoneOltOnuConfigLineStatusChangeTrapEnable, zhoneOltConfigLineStatusChangeTrapEnable=zhoneOltConfigLineStatusChangeTrapEnable, zhoneOnuStatusAlarmDIS=zhoneOnuStatusAlarmDIS, zhoneOltStatusTable=zhoneOltStatusTable, zhoneOnuStatusAlarmLOS=zhoneOnuStatusAlarmLOS, zhoneOltStatusPonAlarmOAML=zhoneOltStatusPonAlarmOAML, zhoneOltConfigLcdDelta=zhoneOltConfigLcdDelta, zhoneOltOnuConfigTable=zhoneOltOnuConfigTable, zhoneOltOnuConfigPassword=zhoneOltOnuConfigPassword, zhoneOnuStatusAlarmSUF=zhoneOnuStatusAlarmSUF, zhoneOltOnuConfigChurnkey=zhoneOltOnuConfigChurnkey, zhoneOltStatusPonAlarmLOS=zhoneOltStatusPonAlarmLOS, zhoneOnuConfigLoopback=zhoneOnuConfigLoopback, zhoneAponOltStatusGroup=zhoneAponOltStatusGroup, zhoneOltTrafficContainerCBR=zhoneOltTrafficContainerCBR, zhoneOltConfigEntry=zhoneOltConfigEntry, zhoneOltOnuStatusPonAlarmREI=zhoneOltOnuStatusPonAlarmREI, zhoneOltStatusLastChange=zhoneOltStatusLastChange, zhoneOltOnuStatusTable=zhoneOltOnuStatusTable, zhoneOltStatusEntry=zhoneOltStatusEntry, zhoneOnuConfigOverheadSize=zhoneOnuConfigOverheadSize, zhoneOnuConfigSerialNumber=zhoneOnuConfigSerialNumber, zhoneApon=zhoneApon, zhoneOltConfigDelimiterPattern=zhoneOltConfigDelimiterPattern, zhoneOltConfigCdrPattern=zhoneOltConfigCdrPattern, zhoneOltTrafficContainerRowStatus=zhoneOltTrafficContainerRowStatus, zhoneOnuStatusAlarmFRML=zhoneOnuStatusAlarmFRML, zhoneOltTrafficContainerIndex=zhoneOltTrafficContainerIndex, zhoneOnuStatusAlarmTF=zhoneOnuStatusAlarmTF, zhoneAponOltConfigGroup=zhoneAponOltConfigGroup, zhoneOltStatusPonAlarmSUF=zhoneOltStatusPonAlarmSUF, zhoneOltOnuStatusEntry=zhoneOltOnuStatusEntry, zhoneAponTrapsGroup=zhoneAponTrapsGroup, zhoneOltConfigTxDiscardNonMatchingVpi=zhoneOltConfigTxDiscardNonMatchingVpi, zhoneOltConfigDelimiterSize=zhoneOltConfigDelimiterSize, zhoneOltConfigLoopback=zhoneOltConfigLoopback, zhoneOltOnuStatusPonAlarmLCD=zhoneOltOnuStatusPonAlarmLCD)
