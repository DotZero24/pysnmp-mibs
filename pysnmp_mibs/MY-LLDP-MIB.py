# SNMP MIB module (MY-LLDP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-LLDP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:35:00 2025
...
lldpSuppressEntry.setIndexNames(
    (0, "MY-LLDP-MIB", "lldpSuppressPortIfIndex"),
)
if mibBuilder.loadTexts:
...
lldpStatsEntry.setIndexNames(
    (0, "MY-LLDP-MIB", "lldpStatsPortIfIndex"),
)
if mibBuilder.loadTexts:
...
lldpRcvEntry.setIndexNames(
    (0, "MY-LLDP-MIB", "lldpRcvIfIndex"),
    (0, "MY-LLDP-MIB", "lldpRcvDeviceID"),
)
if mibBuilder.loadTexts:
...
lldpConfigGroup.setObjects(
      *(("MY-LLDP-MIB", "lldpAdminStatus"),
        ("MY-LLDP-MIB", "lldpOperStatus"),
        ("MY-LLDP-MIB", "lldpMessageTxInterval"),
        ("MY-LLDP-MIB", "lldpMessageTxHoldTime"),
        ("MY-LLDP-MIB", "lldpSuppressTable"))
)
if mibBuilder.loadTexts:
...
lldpStatsGroup.setObjects(
      *(("MY-LLDP-MIB", "lldpStatsInGoodPkts"),
        ("MY-LLDP-MIB", "lldpStatsInErrors"),
        ("MY-LLDP-MIB", "lldpStatsOutPkts"))
)
if mibBuilder.loadTexts:
...
lldpCompliances.setObjects(
      *(("MY-LLDP-MIB", "lldpConfigGroup"),
        ("MY-LLDP-MIB", "lldpStatsGroup"))
)
if mibBuilder.loadTexts:
