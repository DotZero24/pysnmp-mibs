...
_V='lldpConfigGroup'
_U='lldpStatsOutPkts'
_T='lldpStatsInErrors'
_S='lldpStatsInGoodPkts'
_R='lldpSuppressTable'
...
DisplayString,MacAddress,PhysAddress,RowStatus,TextualConvention,TimeStamp=mibBuilder.importSymbols('SNMPv2-TC',_F,'MacAddress','PhysAddress','RowStatus','TextualConvention','TimeStamp')
myLldpMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,32))
if mibBuilder.loadTexts:myLldpMIB.setRevisions(('2003-04-01 00:00',))
_LldpMibObjects_ObjectIdentity=ObjectIdentity
lldpMibObjects=_LldpMibObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,32,1))
_LldpConfig_ObjectIdentity=ObjectIdentity
lldpConfig=_LldpConfig_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,32,1,1))
...
lldpAdminStatus=_LldpAdminStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,1,1),_LldpAdminStatus_Type())
...
lldpOperStatus=_LldpOperStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,1,2),_LldpOperStatus_Type())
lldpOperStatus.setMaxAccess(_C)
...
lldpMessageTxInterval=_LldpMessageTxInterval_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,1,3),_LldpMessageTxInterval_Type())
...
lldpMessageTxHoldTime=_LldpMessageTxHoldTime_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,1,4),_LldpMessageTxHoldTime_Type())
...
lldpDeviceID=_LldpDeviceID_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,1,5),_LldpDeviceID_Type())
lldpDeviceID.setMaxAccess(_C)
if mibBuilder.loadTexts:lldpDeviceID.setStatus(_A)
_LldpSuppressTable_Object=MibTable
lldpSuppressTable=_LldpSuppressTable_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,1,6))
if mibBuilder.loadTexts:lldpSuppressTable.setStatus(_A)
_LldpSuppressEntry_Object=MibTableRow
lldpSuppressEntry=_LldpSuppressEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,1,6,1))
lldpSuppressEntry.setIndexNames((0,_B,_J))
...
lldpSuppressPortIfIndex=_LldpSuppressPortIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,1,6,1,1),_LldpSuppressPortIfIndex_Type())
...
lldpSuppressPortStatus=_LldpSuppressPortStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,1,6,1,2),_LldpSuppressPortStatus_Type())
...
lldpStats=_LldpStats_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,32,1,2))
_LldpStatsTable_Object=MibTable
lldpStatsTable=_LldpStatsTable_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,2,1))
if mibBuilder.loadTexts:lldpStatsTable.setStatus(_A)
_LldpStatsEntry_Object=MibTableRow
lldpStatsEntry=_LldpStatsEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,2,1,1))
lldpStatsEntry.setIndexNames((0,_B,_K))
...
lldpStatsPortIfIndex=_LldpStatsPortIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,2,1,1,1),_LldpStatsPortIfIndex_Type())
...
lldpStatsInGoodPkts=_LldpStatsInGoodPkts_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,2,1,1,2),_LldpStatsInGoodPkts_Type())
lldpStatsInGoodPkts.setMaxAccess(_C)
...
lldpStatsInErrors=_LldpStatsInErrors_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,2,1,1,3),_LldpStatsInErrors_Type())
lldpStatsInErrors.setMaxAccess(_C)
...
lldpStatsOutPkts=_LldpStatsOutPkts_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,2,1,1,4),_LldpStatsOutPkts_Type())
lldpStatsOutPkts.setMaxAccess(_C)
if mibBuilder.loadTexts:lldpStatsOutPkts.setStatus(_A)
_LldpStatsClear_Type=Integer32
_LldpStatsClear_Object=MibTableColumn
lldpStatsClear=_LldpStatsClear_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,2,1,1,5),_LldpStatsClear_Type())
...
lldpRcvObjects=_LldpRcvObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,32,1,3))
_LldpRcvTable_Object=MibTable
lldpRcvTable=_LldpRcvTable_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1))
if mibBuilder.loadTexts:lldpRcvTable.setStatus(_A)
_LldpRcvEntry_Object=MibTableRow
lldpRcvEntry=_LldpRcvEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1))
lldpRcvEntry.setIndexNames((0,_B,_L),(0,_B,_M))
if mibBuilder.loadTexts:lldpRcvEntry.setStatus(_A)
_LldpRcvIfIndex_Type=IfIndex
_LldpRcvIfIndex_Object=MibTableColumn
lldpRcvIfIndex=_LldpRcvIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,1),_LldpRcvIfIndex_Type())
...
lldpRcvDeviceID=_LldpRcvDeviceID_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,2),_LldpRcvDeviceID_Type())
lldpRcvDeviceID.setMaxAccess(_C)
...
lldpRcvMgmtAddress=_LldpRcvMgmtAddress_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,3),_LldpRcvMgmtAddress_Type())
lldpRcvMgmtAddress.setMaxAccess(_C)
...
lldpRcvPortIDSubtype=_LldpRcvPortIDSubtype_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,4),_LldpRcvPortIDSubtype_Type())
lldpRcvPortIDSubtype.setMaxAccess(_C)
...
lldpRcvPortInfo=_LldpRcvPortInfo_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,5),_LldpRcvPortInfo_Type())
lldpRcvPortInfo.setMaxAccess(_C)
...
lldpRcvClusterMode=_LldpRcvClusterMode_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,6),_LldpRcvClusterMode_Type())
lldpRcvClusterMode.setMaxAccess(_C)
...
lldpRcvClusterStatus=_LldpRcvClusterStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,7),_LldpRcvClusterStatus_Type())
lldpRcvClusterStatus.setMaxAccess(_C)
...
lldpRcvClusterName=_LldpRcvClusterName_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,8),_LldpRcvClusterName_Type())
lldpRcvClusterName.setMaxAccess(_C)
...
lldpRcvHostName=_LldpRcvHostName_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,9),_LldpRcvHostName_Type())
lldpRcvHostName.setMaxAccess(_C)
...
lldpRcvCommandAddress=_LldpRcvCommandAddress_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,1,1,10),_LldpRcvCommandAddress_Type())
lldpRcvCommandAddress.setMaxAccess(_C)
...
lldpRcvTableClear=_LldpRcvTableClear_Object((1,3,6,1,4,1,4881,1,1,10,2,32,1,3,2),_LldpRcvTableClear_Type())
...
lldpMIBConformance=_LldpMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,32,2))
_LldpMIBCompliances_ObjectIdentity=ObjectIdentity
lldpMIBCompliances=_LldpMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,32,2,1))
_LldpMIBGroups_ObjectIdentity=ObjectIdentity
lldpMIBGroups=_LldpMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,32,2,2))
lldpConfigGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,32,2,2,1))
lldpConfigGroup.setObjects(*((_B,_N),(_B,_O),(_B,_P),(_B,_Q),(_B,_R)))
if mibBuilder.loadTexts:lldpConfigGroup.setStatus(_A)
lldpStatsGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,32,2,2,2))
lldpStatsGroup.setObjects(*((_B,_S),(_B,_T),(_B,_U)))
if mibBuilder.loadTexts:lldpStatsGroup.setStatus(_A)
lldpCompliances=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,32,2,1,1))
lldpCompliances.setObjects(*((_B,_V),(_B,_W)))
if mibBuilder.loadTexts:lldpCompliances.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'myLldpMIB':myLldpMIB,'lldpMibObjects':lldpMibObjects,'lldpConfig':lldpConfig,_N:lldpAdminStatus,_O:lldpOperStatus,_P:lldpMessageTxInterval,_Q:lldpMessageTxHoldTime,'lldpDeviceID':lldpDeviceID,_R:lldpSuppressTable,'lldpSuppressEntry':lldpSuppressEntry,_J:lldpSuppressPortIfIndex,'lldpSuppressPortStatus':lldpSuppressPortStatus,'lldpStats':lldpStats,'lldpStatsTable':lldpStatsTable,'lldpStatsEntry':lldpStatsEntry,_K:lldpStatsPortIfIndex,_S:lldpStatsInGoodPkts,_T:lldpStatsInErrors,_U:lldpStatsOutPkts,'lldpStatsClear':lldpStatsClear,'lldpRcvObjects':lldpRcvObjects,'lldpRcvTable':lldpRcvTable,'lldpRcvEntry':lldpRcvEntry,_L:lldpRcvIfIndex,_M:lldpRcvDeviceID,'lldpRcvMgmtAddress':lldpRcvMgmtAddress,'lldpRcvPortIDSubtype':lldpRcvPortIDSubtype,'lldpRcvPortInfo':lldpRcvPortInfo,'lldpRcvClusterMode':lldpRcvClusterMode,'lldpRcvClusterStatus':lldpRcvClusterStatus,'lldpRcvClusterName':lldpRcvClusterName,'lldpRcvHostName':lldpRcvHostName,'lldpRcvCommandAddress':lldpRcvCommandAddress,'lldpRcvTableClear':lldpRcvTableClear,'lldpMIBConformance':lldpMIBConformance,'lldpMIBCompliances':lldpMIBCompliances,'lldpCompliances':lldpCompliances,'lldpMIBGroups':lldpMIBGroups,_V:lldpConfigGroup,_W:lldpStatsGroup})