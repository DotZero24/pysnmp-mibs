_AE='swL2FloodMacDetectedMacAddress'
_AD='swL2FloodMacDetectedMacVid'
_AC='swL2macNotifyInfo'
_AB='swL2PortSecurityViolationMac'
_AA='swL2DhcpLocalRelayVLANID'
_A9='swL2VlanIndex'
_A8='swL2McastFilterPortInfoPortIndex'
_A7='swL2McastFilterPortMaxGroupPortIndex'
_A6='swL2McastFilterPortGroupPortIndex'
_A5='swL2McastFilterProfileIndex'
_A4='accessible-for-notify'
_A3='swL2DhcpRelayCtrlServer'
_A2='swL2DhcpRelayCtrlInterfaceName'
_A1='swL2CosDscpPRIIndex'
_A0='swL2CosTosPRIIndex'
_z='invalid'
_y='swL2CosPriorityPort'
_x='swL2TrafficSegPort'
_w='swIGMPSnoopingHostIp'
_v='swIGMPSnoopingHostPort'
_u='swIGMPSnoopingHostGroup'
_t='swIGMPSnoopingHostVid'
_s='swL2IGMPMulticastVlanGroupToIp'
_r='swL2IGMPMulticastVlanGroupFromIp'
_q='swL2IGMPMulticastVlanGroupVid'
_p='swL2IGMPMulticastVlanid'
_o='swL2IGMPAccessAuthPort'
_n='swL2IGMPRouterPortVlanid'
_m='swL2IGMPInfoVid'
_l='swL2IGMPCtrlVid'
_k='swL2TrunkVLANPort'
_j='swL2TrunkLACPPortIndex'
_i='swPortTrunkIndex'
_h='swL2QOS8021pDefaultPriorityIndex'
_g='swL2QOS8021pUserPriorityIndex'
_f='weightfair'
_e='strict'
_d='swL2QOSSchedulingClassIndex'
_c='swL2QOSBandwidthPortIndex'
_b='swL2PortErrPortIndex'
_a='swL2PortCtrlPortMediumType'
_Z='swL2PortCtrlPortIndex'
_Y='copper'
_X='swL2PortInfoMediumType'
_W='swL2PortInfoPortIndex'
_V='active'
_U='SnmpAdminString'
...
swL2MgmtMIB=ModuleIdentity((1,3,6,1,4,1,171,11,116,2,2))
...
swL2DevMgmt=_SwL2DevMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,1))
_SwL2DevInfo_ObjectIdentity=ObjectIdentity
swL2DevInfo=_SwL2DevInfo_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,1,1))
...
swL2DevInfoFrontPanelLedStatus=_SwL2DevInfoFrontPanelLedStatus_Object((1,3,6,1,4,1,171,11,116,2,2,1,1,5),_SwL2DevInfoFrontPanelLedStatus_Type())
...
swL2DevCtrl=_SwL2DevCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,1,2))
...
swL2DevCtrlSystemReboot=_SwL2DevCtrlSystemReboot_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,1),_SwL2DevCtrlSystemReboot_Type())
...
swL2DevCtrlSystemIP=_SwL2DevCtrlSystemIP_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,2),_SwL2DevCtrlSystemIP_Type())
...
swL2DevCtrlSubnetMask=_SwL2DevCtrlSubnetMask_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,3),_SwL2DevCtrlSubnetMask_Type())
...
swL2DevCtrlDefaultGateway=_SwL2DevCtrlDefaultGateway_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,4),_SwL2DevCtrlDefaultGateway_Type())
...
swL2DevCtrlManagementVlanId=_SwL2DevCtrlManagementVlanId_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,5),_SwL2DevCtrlManagementVlanId_Type())
...
swL2DevCtrlIGMPSnooping=_SwL2DevCtrlIGMPSnooping_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,7),_SwL2DevCtrlIGMPSnooping_Type())
swL2DevCtrlIGMPSnooping.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2DevCtrlIGMPSnooping.setStatus(_A)
class _SwL2DevCtrlCleanAllStatisticCounter_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_R,1),(_V,2)))
_SwL2DevCtrlCleanAllStatisticCounter_Type.__name__=_B
_SwL2DevCtrlCleanAllStatisticCounter_Object=MibScalar
swL2DevCtrlCleanAllStatisticCounter=_SwL2DevCtrlCleanAllStatisticCounter_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,12),_SwL2DevCtrlCleanAllStatisticCounter_Type())
...
swL2DevCtrlSnmpEnableAuthenTraps=_SwL2DevCtrlSnmpEnableAuthenTraps_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,13),_SwL2DevCtrlSnmpEnableAuthenTraps_Type())
...
swL2DevCtrlRmonState=_SwL2DevCtrlRmonState_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,16),_SwL2DevCtrlRmonState_Type())
...
swL2DevCtrlIpAutoConfig=_SwL2DevCtrlIpAutoConfig_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,17),_SwL2DevCtrlIpAutoConfig_Type())
...
swL2MACNotifyState=_SwL2MACNotifyState_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,19),_SwL2MACNotifyState_Type())
...
swL2MACNotifyHistorySize=_SwL2MACNotifyHistorySize_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,20),_SwL2MACNotifyHistorySize_Type())
...
swL2MACNotifyInterval=_SwL2MACNotifyInterval_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,21),_SwL2MACNotifyInterval_Type())
...
swL2DevCtrlLLDPState=_SwL2DevCtrlLLDPState_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,22),_SwL2DevCtrlLLDPState_Type())
...
swL2DevCtrlLLDPForwardMessageState=_SwL2DevCtrlLLDPForwardMessageState_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,23),_SwL2DevCtrlLLDPForwardMessageState_Type())
...
swL2DevCtrlAsymVlanState=_SwL2DevCtrlAsymVlanState_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,24),_SwL2DevCtrlAsymVlanState_Type())
...
swL2IGMPSnoopingMulticastVlanState=_SwL2IGMPSnoopingMulticastVlanState_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,25),_SwL2IGMPSnoopingMulticastVlanState_Type())
...
swL2DevCtrlVLANTrunkState=_SwL2DevCtrlVLANTrunkState_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,26),_SwL2DevCtrlVLANTrunkState_Type())
swL2DevCtrlVLANTrunkState.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2DevCtrlVLANTrunkState.setStatus(_A)
class _SwL2DevArpAgingTime_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,65535))
_SwL2DevArpAgingTime_Type.__name__=_B
_SwL2DevArpAgingTime_Object=MibScalar
swL2DevArpAgingTime=_SwL2DevArpAgingTime_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,27),_SwL2DevArpAgingTime_Type())
swL2DevArpAgingTime.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2DevArpAgingTime.setStatus(_A)
class _SwL2DevPasswordEncryptionState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_H,1),(_G,2)))
_SwL2DevPasswordEncryptionState_Type.__name__=_B
_SwL2DevPasswordEncryptionState_Object=MibScalar
swL2DevPasswordEncryptionState=_SwL2DevPasswordEncryptionState_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,28),_SwL2DevPasswordEncryptionState_Type())
swL2DevPasswordEncryptionState.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2DevPasswordEncryptionState.setStatus(_A)
_SwL2DevCtrlWeb_ObjectIdentity=ObjectIdentity
swL2DevCtrlWeb=_SwL2DevCtrlWeb_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,1,2,30))
...
swL2DevCtrlWebState=_SwL2DevCtrlWebState_Object((1,3,6,1,4,1,171,11,116,2,2,1,2,30,1),_SwL2DevCtrlWebState_Type())
...
swL2DevAlarm=_SwL2DevAlarm_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,1,3))
...
swL2DevAlarmNewRoot=_SwL2DevAlarmNewRoot_Object((1,3,6,1,4,1,171,11,116,2,2,1,3,1),_SwL2DevAlarmNewRoot_Type())
...
swL2DevAlarmTopologyChange=_SwL2DevAlarmTopologyChange_Object((1,3,6,1,4,1,171,11,116,2,2,1,3,2),_SwL2DevAlarmTopologyChange_Type())
...
swL2DevAlarmLinkChange=_SwL2DevAlarmLinkChange_Object((1,3,6,1,4,1,171,11,116,2,2,1,3,3),_SwL2DevAlarmLinkChange_Type())
...
swL2PortMgmt=_SwL2PortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,2))
_SwL2PortInfoTable_Object=MibTable
swL2PortInfoTable=_SwL2PortInfoTable_Object((1,3,6,1,4,1,171,11,116,2,2,2,1))
if mibBuilder.loadTexts:swL2PortInfoTable.setStatus(_A)
_SwL2PortInfoEntry_Object=MibTableRow
swL2PortInfoEntry=_SwL2PortInfoEntry_Object((1,3,6,1,4,1,171,11,116,2,2,2,1,1))
swL2PortInfoEntry.setIndexNames((0,_E,_W),(0,_E,_X))
...
swL2PortInfoPortIndex=_SwL2PortInfoPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,2,1,1,1),_SwL2PortInfoPortIndex_Type())
swL2PortInfoPortIndex.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2PortInfoPortIndex.setStatus(_A)
class _SwL2PortInfoMediumType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(100,101)));namedValues=NamedValues(*((_Y,100),('fiber',101)))
_SwL2PortInfoMediumType_Type.__name__=_B
_SwL2PortInfoMediumType_Object=MibTableColumn
swL2PortInfoMediumType=_SwL2PortInfoMediumType_Object((1,3,6,1,4,1,171,11,116,2,2,2,1,1,2),_SwL2PortInfoMediumType_Type())
...
swL2PortInfoLinkStatus=_SwL2PortInfoLinkStatus_Object((1,3,6,1,4,1,171,11,116,2,2,2,1,1,4),_SwL2PortInfoLinkStatus_Type())
swL2PortInfoLinkStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2PortInfoLinkStatus.setStatus(_A)
class _SwL2PortInfoNwayStatus_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,7)));namedValues=NamedValues(*(('auto',1),('half-10Mbps',2),('full-10Mbps',3),('half-100Mbps',4),('full-100Mbps',5),('full-1Gigabps',7)))
_SwL2PortInfoNwayStatus_Type.__name__=_B
_SwL2PortInfoNwayStatus_Object=MibTableColumn
swL2PortInfoNwayStatus=_SwL2PortInfoNwayStatus_Object((1,3,6,1,4,1,171,11,116,2,2,2,1,1,5),_SwL2PortInfoNwayStatus_Type())
swL2PortInfoNwayStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2PortInfoNwayStatus.setStatus(_A)
class _SwL2PortInfoFlowCtrlOperStatus_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_L,1),('ieee8023x',2),('backPressure',3)))
_SwL2PortInfoFlowCtrlOperStatus_Type.__name__=_B
_SwL2PortInfoFlowCtrlOperStatus_Object=MibTableColumn
swL2PortInfoFlowCtrlOperStatus=_SwL2PortInfoFlowCtrlOperStatus_Object((1,3,6,1,4,1,171,11,116,2,2,2,1,1,10),_SwL2PortInfoFlowCtrlOperStatus_Type())
swL2PortInfoFlowCtrlOperStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2PortInfoFlowCtrlOperStatus.setStatus(_A)
_SwL2PortCtrlTable_Object=MibTable
swL2PortCtrlTable=_SwL2PortCtrlTable_Object((1,3,6,1,4,1,171,11,116,2,2,2,2))
if mibBuilder.loadTexts:swL2PortCtrlTable.setStatus(_A)
_SwL2PortCtrlEntry_Object=MibTableRow
swL2PortCtrlEntry=_SwL2PortCtrlEntry_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1))
swL2PortCtrlEntry.setIndexNames((0,_E,_Z),(0,_E,_a))
...
swL2PortCtrlPortIndex=_SwL2PortCtrlPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,1),_SwL2PortCtrlPortIndex_Type())
swL2PortCtrlPortIndex.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2PortCtrlPortIndex.setStatus(_A)
class _SwL2PortCtrlPortMediumType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(100,101)));namedValues=NamedValues(*((_Y,100),('fiber',101)))
_SwL2PortCtrlPortMediumType_Type.__name__=_B
_SwL2PortCtrlPortMediumType_Object=MibTableColumn
swL2PortCtrlPortMediumType=_SwL2PortCtrlPortMediumType_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,2),_SwL2PortCtrlPortMediumType_Type())
swL2PortCtrlPortMediumType.setMaxAccess(_D)
...
swL2PortCtrlAdminState=_SwL2PortCtrlAdminState_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,3),_SwL2PortCtrlAdminState_Type())
...
swL2PortCtrlNwayState=_SwL2PortCtrlNwayState_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,4),_SwL2PortCtrlNwayState_Type())
...
swL2PortCtrlFlowCtrlState=_SwL2PortCtrlFlowCtrlState_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,5),_SwL2PortCtrlFlowCtrlState_Type())
...
swL2PortCtrlDescription=_SwL2PortCtrlDescription_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,6),_SwL2PortCtrlDescription_Type())
...
swL2PortCtrlAddressLearning=_SwL2PortCtrlAddressLearning_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,7),_SwL2PortCtrlAddressLearning_Type())
...
swL2PortCtrlMACNotifyState=_SwL2PortCtrlMACNotifyState_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,8),_SwL2PortCtrlMACNotifyState_Type())
...
swL2PortCtrlMulticastfilter=_SwL2PortCtrlMulticastfilter_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,9),_SwL2PortCtrlMulticastfilter_Type())
swL2PortCtrlMulticastfilter.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2PortCtrlMulticastfilter.setStatus(_A)
class _SwL2PortCtrlMDIXState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*(('auto',1),(_R,2),('cross',3),(_F,4)))
_SwL2PortCtrlMDIXState_Type.__name__=_B
_SwL2PortCtrlMDIXState_Object=MibTableColumn
swL2PortCtrlMDIXState=_SwL2PortCtrlMDIXState_Object((1,3,6,1,4,1,171,11,116,2,2,2,2,1,10),_SwL2PortCtrlMDIXState_Type())
...
swL2PortErrTable=_SwL2PortErrTable_Object((1,3,6,1,4,1,171,11,116,2,2,2,3))
if mibBuilder.loadTexts:swL2PortErrTable.setStatus(_A)
_SwL2PortErrEntry_Object=MibTableRow
swL2PortErrEntry=_SwL2PortErrEntry_Object((1,3,6,1,4,1,171,11,116,2,2,2,3,1))
swL2PortErrEntry.setIndexNames((0,_E,_b))
...
swL2PortErrPortIndex=_SwL2PortErrPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,2,3,1,1),_SwL2PortErrPortIndex_Type())
...
swL2PortErrPortState=_SwL2PortErrPortState_Object((1,3,6,1,4,1,171,11,116,2,2,2,3,1,2),_SwL2PortErrPortState_Type())
...
swL2PortErrPortStatus=_SwL2PortErrPortStatus_Object((1,3,6,1,4,1,171,11,116,2,2,2,3,1,3),_SwL2PortErrPortStatus_Type())
swL2PortErrPortStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2PortErrPortStatus.setStatus(_A)
class _SwL2PortErrPortReason_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3,4,5)));namedValues=NamedValues(*((_L,0),('stp-lbd',1),('storm-control',2),('storm-control-lbd',3),('loopdetect',4),('duld',5)))
_SwL2PortErrPortReason_Type.__name__=_B
_SwL2PortErrPortReason_Object=MibTableColumn
swL2PortErrPortReason=_SwL2PortErrPortReason_Object((1,3,6,1,4,1,171,11,116,2,2,2,3,1,4),_SwL2PortErrPortReason_Type())
...
swL2PortErrDescription=_SwL2PortErrDescription_Object((1,3,6,1,4,1,171,11,116,2,2,2,3,1,5),_SwL2PortErrDescription_Type())
swL2PortErrDescription.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2PortErrDescription.setStatus(_A)
class _SwL2PortCtrlJumboFrame_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_H,1),(_G,2)))
_SwL2PortCtrlJumboFrame_Type.__name__=_B
_SwL2PortCtrlJumboFrame_Object=MibScalar
swL2PortCtrlJumboFrame=_SwL2PortCtrlJumboFrame_Object((1,3,6,1,4,1,171,11,116,2,2,2,4),_SwL2PortCtrlJumboFrame_Type())
...
swL2PortCtrlJumboFrameMaxSize=_SwL2PortCtrlJumboFrameMaxSize_Object((1,3,6,1,4,1,171,11,116,2,2,2,5),_SwL2PortCtrlJumboFrameMaxSize_Type())
...
swL2QOSMgmt=_SwL2QOSMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,3))
_SwL2QOSBandwidthControlTable_Object=MibTable
swL2QOSBandwidthControlTable=_SwL2QOSBandwidthControlTable_Object((1,3,6,1,4,1,171,11,116,2,2,3,1))
if mibBuilder.loadTexts:swL2QOSBandwidthControlTable.setStatus(_A)
_SwL2QOSBandwidthControlEntry_Object=MibTableRow
swL2QOSBandwidthControlEntry=_SwL2QOSBandwidthControlEntry_Object((1,3,6,1,4,1,171,11,116,2,2,3,1,1))
swL2QOSBandwidthControlEntry.setIndexNames((0,_E,_c))
...
swL2QOSBandwidthPortIndex=_SwL2QOSBandwidthPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,3,1,1,1),_SwL2QOSBandwidthPortIndex_Type())
...
swL2QOSBandwidthRxRate=_SwL2QOSBandwidthRxRate_Object((1,3,6,1,4,1,171,11,116,2,2,3,1,1,2),_SwL2QOSBandwidthRxRate_Type())
...
swL2QOSBandwidthTxRate=_SwL2QOSBandwidthTxRate_Object((1,3,6,1,4,1,171,11,116,2,2,3,1,1,3),_SwL2QOSBandwidthTxRate_Type())
...
swL2QOSBandwidthRadiusRxRate=_SwL2QOSBandwidthRadiusRxRate_Object((1,3,6,1,4,1,171,11,116,2,2,3,1,1,4),_SwL2QOSBandwidthRadiusRxRate_Type())
...
swL2QOSBandwidthRadiusTxRate=_SwL2QOSBandwidthRadiusTxRate_Object((1,3,6,1,4,1,171,11,116,2,2,3,1,1,5),_SwL2QOSBandwidthRadiusTxRate_Type())
...
swL2QOSSchedulingTable=_SwL2QOSSchedulingTable_Object((1,3,6,1,4,1,171,11,116,2,2,3,2))
if mibBuilder.loadTexts:swL2QOSSchedulingTable.setStatus(_A)
_SwL2QOSSchedulingEntry_Object=MibTableRow
swL2QOSSchedulingEntry=_SwL2QOSSchedulingEntry_Object((1,3,6,1,4,1,171,11,116,2,2,3,2,1))
swL2QOSSchedulingEntry.setIndexNames((0,_E,_d))
...
swL2QOSSchedulingClassIndex=_SwL2QOSSchedulingClassIndex_Object((1,3,6,1,4,1,171,11,116,2,2,3,2,1,1),_SwL2QOSSchedulingClassIndex_Type())
...
swL2QOSSchedulingMaxWeight=_SwL2QOSSchedulingMaxWeight_Object((1,3,6,1,4,1,171,11,116,2,2,3,2,1,4),_SwL2QOSSchedulingMaxWeight_Type())
swL2QOSSchedulingMaxWeight.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2QOSSchedulingMaxWeight.setStatus(_A)
class _SwL2QOSSchedulingMechanism_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_e,1),('roundrobin',2),(_f,3)))
_SwL2QOSSchedulingMechanism_Type.__name__=_B
_SwL2QOSSchedulingMechanism_Object=MibTableColumn
swL2QOSSchedulingMechanism=_SwL2QOSSchedulingMechanism_Object((1,3,6,1,4,1,171,11,116,2,2,3,2,1,5),_SwL2QOSSchedulingMechanism_Type())
...
swL2QOS8021pUserPriorityTable=_SwL2QOS8021pUserPriorityTable_Object((1,3,6,1,4,1,171,11,116,2,2,3,3))
if mibBuilder.loadTexts:swL2QOS8021pUserPriorityTable.setStatus(_A)
_SwL2QOS8021pUserPriorityEntry_Object=MibTableRow
swL2QOS8021pUserPriorityEntry=_SwL2QOS8021pUserPriorityEntry_Object((1,3,6,1,4,1,171,11,116,2,2,3,3,1))
swL2QOS8021pUserPriorityEntry.setIndexNames((0,_E,_g))
...
swL2QOS8021pUserPriorityIndex=_SwL2QOS8021pUserPriorityIndex_Object((1,3,6,1,4,1,171,11,116,2,2,3,3,1,1),_SwL2QOS8021pUserPriorityIndex_Type())
...
swL2QOS8021pUserPriorityClass=_SwL2QOS8021pUserPriorityClass_Object((1,3,6,1,4,1,171,11,116,2,2,3,3,1,2),_SwL2QOS8021pUserPriorityClass_Type())
...
swL2QOS8021pDefaultPriorityTable=_SwL2QOS8021pDefaultPriorityTable_Object((1,3,6,1,4,1,171,11,116,2,2,3,4))
...
swL2QOS8021pDefaultPriorityEntry=_SwL2QOS8021pDefaultPriorityEntry_Object((1,3,6,1,4,1,171,11,116,2,2,3,4,1))
swL2QOS8021pDefaultPriorityEntry.setIndexNames((0,_E,_h))
...
swL2QOS8021pDefaultPriorityIndex=_SwL2QOS8021pDefaultPriorityIndex_Object((1,3,6,1,4,1,171,11,116,2,2,3,4,1,1),_SwL2QOS8021pDefaultPriorityIndex_Type())
...
swL2QOS8021pDefaultPriority=_SwL2QOS8021pDefaultPriority_Object((1,3,6,1,4,1,171,11,116,2,2,3,4,1,2),_SwL2QOS8021pDefaultPriority_Type())
...
swL2QOS8021pRadiusPriority=_SwL2QOS8021pRadiusPriority_Object((1,3,6,1,4,1,171,11,116,2,2,3,4,1,3),_SwL2QOS8021pRadiusPriority_Type())
swL2QOS8021pRadiusPriority.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2QOS8021pRadiusPriority.setStatus(_A)
class _SwL2QOSSchedulingMechanismCtrl_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_e,1),(_f,2),(_L,3)))
_SwL2QOSSchedulingMechanismCtrl_Type.__name__=_B
_SwL2QOSSchedulingMechanismCtrl_Object=MibScalar
swL2QOSSchedulingMechanismCtrl=_SwL2QOSSchedulingMechanismCtrl_Object((1,3,6,1,4,1,171,11,116,2,2,3,5),_SwL2QOSSchedulingMechanismCtrl_Type())
...
swL2TrunkMgmt=_SwL2TrunkMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,4))
_SwPortTrunkMaxEntries_Type=Integer32
_SwPortTrunkMaxEntries_Object=MibScalar
swPortTrunkMaxEntries=_SwPortTrunkMaxEntries_Object((1,3,6,1,4,1,171,11,116,2,2,4,1),_SwPortTrunkMaxEntries_Type())
...
swPortTrunkMaxPortMembers=_SwPortTrunkMaxPortMembers_Object((1,3,6,1,4,1,171,11,116,2,2,4,2),_SwPortTrunkMaxPortMembers_Type())
...
swPortTrunkTable=_SwPortTrunkTable_Object((1,3,6,1,4,1,171,11,116,2,2,4,3))
if mibBuilder.loadTexts:swPortTrunkTable.setStatus(_A)
_SwPortTrunkEntry_Object=MibTableRow
swPortTrunkEntry=_SwPortTrunkEntry_Object((1,3,6,1,4,1,171,11,116,2,2,4,3,1))
swPortTrunkEntry.setIndexNames((0,_E,_i))
...
swPortTrunkIndex=_SwPortTrunkIndex_Object((1,3,6,1,4,1,171,11,116,2,2,4,3,1,1),_SwPortTrunkIndex_Type())
...
swPortTrunkMasterPort=_SwPortTrunkMasterPort_Object((1,3,6,1,4,1,171,11,116,2,2,4,3,1,2),_SwPortTrunkMasterPort_Type())
...
swPortTrunkPortList=_SwPortTrunkPortList_Object((1,3,6,1,4,1,171,11,116,2,2,4,3,1,3),_SwPortTrunkPortList_Type())
...
swPortTrunkType=_SwPortTrunkType_Object((1,3,6,1,4,1,171,11,116,2,2,4,3,1,4),_SwPortTrunkType_Type())
...
swPortTrunkActivePort=_SwPortTrunkActivePort_Object((1,3,6,1,4,1,171,11,116,2,2,4,3,1,5),_SwPortTrunkActivePort_Type())
...
swPortTrunkState=_SwPortTrunkState_Object((1,3,6,1,4,1,171,11,116,2,2,4,3,1,6),_SwPortTrunkState_Type())
...
swPortTrunkFloodingPort=_SwPortTrunkFloodingPort_Object((1,3,6,1,4,1,171,11,116,2,2,4,3,1,7),_SwPortTrunkFloodingPort_Type())
...
swL2TrunkAlgorithm=_SwL2TrunkAlgorithm_Object((1,3,6,1,4,1,171,11,116,2,2,4,4),_SwL2TrunkAlgorithm_Type())
...
swL2TrunkLACPPortTable=_SwL2TrunkLACPPortTable_Object((1,3,6,1,4,1,171,11,116,2,2,4,5))
if mibBuilder.loadTexts:swL2TrunkLACPPortTable.setStatus(_A)
_SwL2TrunkLACPPortEntry_Object=MibTableRow
swL2TrunkLACPPortEntry=_SwL2TrunkLACPPortEntry_Object((1,3,6,1,4,1,171,11,116,2,2,4,5,1))
swL2TrunkLACPPortEntry.setIndexNames((0,_E,_j))
...
swL2TrunkLACPPortIndex=_SwL2TrunkLACPPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,4,5,1,1),_SwL2TrunkLACPPortIndex_Type())
swL2TrunkLACPPortIndex.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2TrunkLACPPortIndex.setStatus(_A)
class _SwL2TrunkLACPPortState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_V,1),('passive',2)))
_SwL2TrunkLACPPortState_Type.__name__=_B
_SwL2TrunkLACPPortState_Object=MibTableColumn
swL2TrunkLACPPortState=_SwL2TrunkLACPPortState_Object((1,3,6,1,4,1,171,11,116,2,2,4,5,1,2),_SwL2TrunkLACPPortState_Type())
...
swL2TrunkVLANTable=_SwL2TrunkVLANTable_Object((1,3,6,1,4,1,171,11,116,2,2,4,6))
if mibBuilder.loadTexts:swL2TrunkVLANTable.setStatus(_A)
_SwL2TrunkVLANEntry_Object=MibTableRow
swL2TrunkVLANEntry=_SwL2TrunkVLANEntry_Object((1,3,6,1,4,1,171,11,116,2,2,4,6,1))
swL2TrunkVLANEntry.setIndexNames((0,_E,_k))
...
swL2TrunkVLANPort=_SwL2TrunkVLANPort_Object((1,3,6,1,4,1,171,11,116,2,2,4,6,1,1),_SwL2TrunkVLANPort_Type())
...
swL2TrunkVLANState=_SwL2TrunkVLANState_Object((1,3,6,1,4,1,171,11,116,2,2,4,6,1,2),_SwL2TrunkVLANState_Type())
...
swPortMirrorPackage=_SwPortMirrorPackage_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,6))
_SwPortMirrorRxPortList_Type=PortList
_SwPortMirrorRxPortList_Object=MibScalar
swPortMirrorRxPortList=_SwPortMirrorRxPortList_Object((1,3,6,1,4,1,171,11,116,2,2,6,2),_SwPortMirrorRxPortList_Type())
...
swPortMirrorTxPortList=_SwPortMirrorTxPortList_Object((1,3,6,1,4,1,171,11,116,2,2,6,3),_SwPortMirrorTxPortList_Type())
...
swPortMirrorTargetPort=_SwPortMirrorTargetPort_Object((1,3,6,1,4,1,171,11,116,2,2,6,4),_SwPortMirrorTargetPort_Type())
...
swPortMirrorState=_SwPortMirrorState_Object((1,3,6,1,4,1,171,11,116,2,2,6,5),_SwPortMirrorState_Type())
...
swIGMPPackage=_SwIGMPPackage_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,7))
...
swL2IGMPMaxSupportedVlans=_SwL2IGMPMaxSupportedVlans_Object((1,3,6,1,4,1,171,11,116,2,2,7,1),_SwL2IGMPMaxSupportedVlans_Type())
...
swL2IGMPMaxIpGroupNumPerVlan=_SwL2IGMPMaxIpGroupNumPerVlan_Object((1,3,6,1,4,1,171,11,116,2,2,7,2),_SwL2IGMPMaxIpGroupNumPerVlan_Type())
...
swL2IGMPCtrlTable=_SwL2IGMPCtrlTable_Object((1,3,6,1,4,1,171,11,116,2,2,7,3))
if mibBuilder.loadTexts:swL2IGMPCtrlTable.setStatus(_A)
_SwL2IGMPCtrlEntry_Object=MibTableRow
swL2IGMPCtrlEntry=_SwL2IGMPCtrlEntry_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1))
swL2IGMPCtrlEntry.setIndexNames((0,_E,_l))
...
swL2IGMPCtrlVid=_SwL2IGMPCtrlVid_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,1),_SwL2IGMPCtrlVid_Type())
...
swL2IGMPQueryInterval=_SwL2IGMPQueryInterval_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,2),_SwL2IGMPQueryInterval_Type())
...
swL2IGMPMaxResponseTime=_SwL2IGMPMaxResponseTime_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,3),_SwL2IGMPMaxResponseTime_Type())
...
swL2IGMPRobustness=_SwL2IGMPRobustness_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,4),_SwL2IGMPRobustness_Type())
...
swL2IGMPLastMemberQueryInterval=_SwL2IGMPLastMemberQueryInterval_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,5),_SwL2IGMPLastMemberQueryInterval_Type())
...
swL2IGMPQueryState=_SwL2IGMPQueryState_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,9),_SwL2IGMPQueryState_Type())
...
swL2IGMPCurrentState=_SwL2IGMPCurrentState_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,10),_SwL2IGMPCurrentState_Type())
swL2IGMPCurrentState.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2IGMPCurrentState.setStatus(_A)
class _SwL2IGMPCtrlState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_F,1),(_M,2),(_O,3)))
_SwL2IGMPCtrlState_Type.__name__=_B
_SwL2IGMPCtrlState_Object=MibTableColumn
swL2IGMPCtrlState=_SwL2IGMPCtrlState_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,11),_SwL2IGMPCtrlState_Type())
swL2IGMPCtrlState.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2IGMPCtrlState.setStatus(_A)
class _SwL2IGMPFastLeave_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_F,1),(_M,2),(_O,3)))
_SwL2IGMPFastLeave_Type.__name__=_B
_SwL2IGMPFastLeave_Object=MibTableColumn
swL2IGMPFastLeave=_SwL2IGMPFastLeave_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,12),_SwL2IGMPFastLeave_Type())
...
swL2IGMPDynIPMultVlanAge=_SwL2IGMPDynIPMultVlanAge_Object((1,3,6,1,4,1,171,11,116,2,2,7,3,1,14),_SwL2IGMPDynIPMultVlanAge_Type())
...
swL2IGMPQueryInfoTable=_SwL2IGMPQueryInfoTable_Object((1,3,6,1,4,1,171,11,116,2,2,7,4))
if mibBuilder.loadTexts:swL2IGMPQueryInfoTable.setStatus(_A)
_SwL2IGMPQueryInfoEntry_Object=MibTableRow
swL2IGMPQueryInfoEntry=_SwL2IGMPQueryInfoEntry_Object((1,3,6,1,4,1,171,11,116,2,2,7,4,1))
swL2IGMPQueryInfoEntry.setIndexNames((0,_E,_m))
...
swL2IGMPInfoVid=_SwL2IGMPInfoVid_Object((1,3,6,1,4,1,171,11,116,2,2,7,4,1,1),_SwL2IGMPInfoVid_Type())
...
swL2IGMPInfoQueryCount=_SwL2IGMPInfoQueryCount_Object((1,3,6,1,4,1,171,11,116,2,2,7,4,1,2),_SwL2IGMPInfoQueryCount_Type())
...
swL2IGMPInfoTxQueryCount=_SwL2IGMPInfoTxQueryCount_Object((1,3,6,1,4,1,171,11,116,2,2,7,4,1,3),_SwL2IGMPInfoTxQueryCount_Type())
...
swL2IGMPRouterPortTable=_SwL2IGMPRouterPortTable_Object((1,3,6,1,4,1,171,11,116,2,2,7,6))
if mibBuilder.loadTexts:swL2IGMPRouterPortTable.setStatus(_A)
_SwL2IGMPRouterPortEntry_Object=MibTableRow
swL2IGMPRouterPortEntry=_SwL2IGMPRouterPortEntry_Object((1,3,6,1,4,1,171,11,116,2,2,7,6,1))
swL2IGMPRouterPortEntry.setIndexNames((0,_E,_n))
...
swL2IGMPRouterPortVlanid=_SwL2IGMPRouterPortVlanid_Object((1,3,6,1,4,1,171,11,116,2,2,7,6,1,1),_SwL2IGMPRouterPortVlanid_Type())
...
_SwL2IGMPRouterPortVlanName_Type.__name__=_U
_SwL2IGMPRouterPortVlanName_Object=MibTableColumn
swL2IGMPRouterPortVlanName=_SwL2IGMPRouterPortVlanName_Object((1,3,6,1,4,1,171,11,116,2,2,7,6,1,2),_SwL2IGMPRouterPortVlanName_Type())
...
swL2IGMPRouterPortStaticPortList=_SwL2IGMPRouterPortStaticPortList_Object((1,3,6,1,4,1,171,11,116,2,2,7,6,1,3),_SwL2IGMPRouterPortStaticPortList_Type())
...
swL2IGMPRouterPortDynamicPortList=_SwL2IGMPRouterPortDynamicPortList_Object((1,3,6,1,4,1,171,11,116,2,2,7,6,1,4),_SwL2IGMPRouterPortDynamicPortList_Type())
...
swL2IGMPRouterPortForbiddenPortList=_SwL2IGMPRouterPortForbiddenPortList_Object((1,3,6,1,4,1,171,11,116,2,2,7,6,1,5),_SwL2IGMPRouterPortForbiddenPortList_Type())
...
swL2IGMPAccessAuthTable=_SwL2IGMPAccessAuthTable_Object((1,3,6,1,4,1,171,11,116,2,2,7,7))
if mibBuilder.loadTexts:swL2IGMPAccessAuthTable.setStatus(_A)
_SwL2IGMPAccessAuthEntry_Object=MibTableRow
swL2IGMPAccessAuthEntry=_SwL2IGMPAccessAuthEntry_Object((1,3,6,1,4,1,171,11,116,2,2,7,7,1))
swL2IGMPAccessAuthEntry.setIndexNames((0,_E,_o))
...
swL2IGMPAccessAuthPort=_SwL2IGMPAccessAuthPort_Object((1,3,6,1,4,1,171,11,116,2,2,7,7,1,1),_SwL2IGMPAccessAuthPort_Type())
...
swL2IGMPAccessAuthState=_SwL2IGMPAccessAuthState_Object((1,3,6,1,4,1,171,11,116,2,2,7,7,1,2),_SwL2IGMPAccessAuthState_Type())
...
swL2IGMPMulticastVlanTable=_SwL2IGMPMulticastVlanTable_Object((1,3,6,1,4,1,171,11,116,2,2,7,8))
if mibBuilder.loadTexts:swL2IGMPMulticastVlanTable.setStatus(_A)
_SwL2IGMPMulticastVlanEntry_Object=MibTableRow
swL2IGMPMulticastVlanEntry=_SwL2IGMPMulticastVlanEntry_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1))
swL2IGMPMulticastVlanEntry.setIndexNames((0,_E,_p))
...
swL2IGMPMulticastVlanid=_SwL2IGMPMulticastVlanid_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,1),_SwL2IGMPMulticastVlanid_Type())
...
swL2IGMPMulticastVlanName=_SwL2IGMPMulticastVlanName_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,2),_SwL2IGMPMulticastVlanName_Type())
...
swL2IGMPMulticastVlanSourcePort=_SwL2IGMPMulticastVlanSourcePort_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,3),_SwL2IGMPMulticastVlanSourcePort_Type())
...
swL2IGMPMulticastVlanMemberPort=_SwL2IGMPMulticastVlanMemberPort_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,4),_SwL2IGMPMulticastVlanMemberPort_Type())
...
swL2IGMPMulticastVlanTagMemberPort=_SwL2IGMPMulticastVlanTagMemberPort_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,5),_SwL2IGMPMulticastVlanTagMemberPort_Type())
...
swL2IGMPMulticastVlanState=_SwL2IGMPMulticastVlanState_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,6),_SwL2IGMPMulticastVlanState_Type())
...
swL2IGMPMulticastVlanReplaceSourceIp=_SwL2IGMPMulticastVlanReplaceSourceIp_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,7),_SwL2IGMPMulticastVlanReplaceSourceIp_Type())
...
swL2IGMPMulticastVlanRowStatus=_SwL2IGMPMulticastVlanRowStatus_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,8),_SwL2IGMPMulticastVlanRowStatus_Type())
...
swL2IGMPMulticastVlanUntagSourcePort=_SwL2IGMPMulticastVlanUntagSourcePort_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,9),_SwL2IGMPMulticastVlanUntagSourcePort_Type())
swL2IGMPMulticastVlanUntagSourcePort.setMaxAccess(_I)
if mibBuilder.loadTexts:swL2IGMPMulticastVlanUntagSourcePort.setStatus(_A)
class _SwL2IGMPMulticastVlanRemapPriority_Type(Integer32):defaultValue=-1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(-1,-1),ValueRangeConstraint(0,7))
_SwL2IGMPMulticastVlanRemapPriority_Type.__name__=_B
_SwL2IGMPMulticastVlanRemapPriority_Object=MibTableColumn
swL2IGMPMulticastVlanRemapPriority=_SwL2IGMPMulticastVlanRemapPriority_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,10),_SwL2IGMPMulticastVlanRemapPriority_Type())
...
class _SwL2IGMPMulticastVlanReplacePriority_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_H,1),(_G,2)))
_SwL2IGMPMulticastVlanReplacePriority_Type.__name__=_B
_SwL2IGMPMulticastVlanReplacePriority_Object=MibTableColumn
swL2IGMPMulticastVlanReplacePriority=_SwL2IGMPMulticastVlanReplacePriority_Object((1,3,6,1,4,1,171,11,116,2,2,7,8,1,11),_SwL2IGMPMulticastVlanReplacePriority_Type())
...
swL2IGMPMulticastVlanGroupTable=_SwL2IGMPMulticastVlanGroupTable_Object((1,3,6,1,4,1,171,11,116,2,2,7,9))
if mibBuilder.loadTexts:swL2IGMPMulticastVlanGroupTable.setStatus(_A)
_SwL2IGMPMulticastVlanGroupEntry_Object=MibTableRow
swL2IGMPMulticastVlanGroupEntry=_SwL2IGMPMulticastVlanGroupEntry_Object((1,3,6,1,4,1,171,11,116,2,2,7,9,1))
swL2IGMPMulticastVlanGroupEntry.setIndexNames((0,_E,_q),(0,_E,_r),(0,_E,_s))
...
swL2IGMPMulticastVlanGroupVid=_SwL2IGMPMulticastVlanGroupVid_Object((1,3,6,1,4,1,171,11,116,2,2,7,9,1,1),_SwL2IGMPMulticastVlanGroupVid_Type())
...
swL2IGMPMulticastVlanGroupFromIp=_SwL2IGMPMulticastVlanGroupFromIp_Object((1,3,6,1,4,1,171,11,116,2,2,7,9,1,2),_SwL2IGMPMulticastVlanGroupFromIp_Type())
...
swL2IGMPMulticastVlanGroupToIp=_SwL2IGMPMulticastVlanGroupToIp_Object((1,3,6,1,4,1,171,11,116,2,2,7,9,1,3),_SwL2IGMPMulticastVlanGroupToIp_Type())
...
swL2IGMPMulticastVlanGroupStatus=_SwL2IGMPMulticastVlanGroupStatus_Object((1,3,6,1,4,1,171,11,116,2,2,7,9,1,4),_SwL2IGMPMulticastVlanGroupStatus_Type())
...
swL2IGMPDynIpMultMgmt=_SwL2IGMPDynIpMultMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,7,12))
_SwL2IGMPDynIPMultMaxEntry_Type=Integer32
_SwL2IGMPDynIPMultMaxEntry_Object=MibScalar
swL2IGMPDynIPMultMaxEntry=_SwL2IGMPDynIPMultMaxEntry_Object((1,3,6,1,4,1,171,11,116,2,2,7,12,1),_SwL2IGMPDynIPMultMaxEntry_Type())
...
swL2IGMPSnoopingClearDynIpMult=_SwL2IGMPSnoopingClearDynIpMult_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,7,12,2))
_SwL2IGMPSnoopingClearDynIpMultVID_Type=VlanId
_SwL2IGMPSnoopingClearDynIpMultVID_Object=MibScalar
swL2IGMPSnoopingClearDynIpMultVID=_SwL2IGMPSnoopingClearDynIpMultVID_Object((1,3,6,1,4,1,171,11,116,2,2,7,12,2,1),_SwL2IGMPSnoopingClearDynIpMultVID_Type())
...
swL2IGMPSnoopingClearDynIpMultIP=_SwL2IGMPSnoopingClearDynIpMultIP_Object((1,3,6,1,4,1,171,11,116,2,2,7,12,2,2),_SwL2IGMPSnoopingClearDynIpMultIP_Type())
...
swL2IGMPSnoopingClearDynIpMultAction=_SwL2IGMPSnoopingClearDynIpMultAction_Object((1,3,6,1,4,1,171,11,116,2,2,7,12,2,3),_SwL2IGMPSnoopingClearDynIpMultAction_Type())
...
swIGMPSnoopingHostTable=_SwIGMPSnoopingHostTable_Object((1,3,6,1,4,1,171,11,116,2,2,7,13))
if mibBuilder.loadTexts:swIGMPSnoopingHostTable.setStatus(_A)
_SwIGMPSnoopingHostEntry_Object=MibTableRow
swIGMPSnoopingHostEntry=_SwIGMPSnoopingHostEntry_Object((1,3,6,1,4,1,171,11,116,2,2,7,13,1))
swIGMPSnoopingHostEntry.setIndexNames((0,_E,_t),(0,_E,_u),(0,_E,_v),(0,_E,_w))
if mibBuilder.loadTexts:swIGMPSnoopingHostEntry.setStatus(_A)
_SwIGMPSnoopingHostVid_Type=VlanId
_SwIGMPSnoopingHostVid_Object=MibTableColumn
swIGMPSnoopingHostVid=_SwIGMPSnoopingHostVid_Object((1,3,6,1,4,1,171,11,116,2,2,7,13,1,1),_SwIGMPSnoopingHostVid_Type())
swIGMPSnoopingHostVid.setMaxAccess(_D)
if mibBuilder.loadTexts:swIGMPSnoopingHostVid.setStatus(_A)
_SwIGMPSnoopingHostGroup_Type=IpAddress
_SwIGMPSnoopingHostGroup_Object=MibTableColumn
swIGMPSnoopingHostGroup=_SwIGMPSnoopingHostGroup_Object((1,3,6,1,4,1,171,11,116,2,2,7,13,1,2),_SwIGMPSnoopingHostGroup_Type())
swIGMPSnoopingHostGroup.setMaxAccess(_D)
if mibBuilder.loadTexts:swIGMPSnoopingHostGroup.setStatus(_A)
_SwIGMPSnoopingHostPort_Type=Integer32
_SwIGMPSnoopingHostPort_Object=MibTableColumn
swIGMPSnoopingHostPort=_SwIGMPSnoopingHostPort_Object((1,3,6,1,4,1,171,11,116,2,2,7,13,1,3),_SwIGMPSnoopingHostPort_Type())
swIGMPSnoopingHostPort.setMaxAccess(_D)
if mibBuilder.loadTexts:swIGMPSnoopingHostPort.setStatus(_A)
_SwIGMPSnoopingHostIp_Type=IpAddress
_SwIGMPSnoopingHostIp_Object=MibTableColumn
swIGMPSnoopingHostIp=_SwIGMPSnoopingHostIp_Object((1,3,6,1,4,1,171,11,116,2,2,7,13,1,4),_SwIGMPSnoopingHostIp_Type())
swIGMPSnoopingHostIp.setMaxAccess(_D)
if mibBuilder.loadTexts:swIGMPSnoopingHostIp.setStatus(_A)
_SwL2TrafficSegMgmt_ObjectIdentity=ObjectIdentity
swL2TrafficSegMgmt=_SwL2TrafficSegMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,12))
_SwL2TrafficSegTable_Object=MibTable
swL2TrafficSegTable=_SwL2TrafficSegTable_Object((1,3,6,1,4,1,171,11,116,2,2,12,1))
if mibBuilder.loadTexts:swL2TrafficSegTable.setStatus(_A)
_SwL2TrafficSegEntry_Object=MibTableRow
swL2TrafficSegEntry=_SwL2TrafficSegEntry_Object((1,3,6,1,4,1,171,11,116,2,2,12,1,1))
swL2TrafficSegEntry.setIndexNames((0,_E,_x))
...
swL2TrafficSegPort=_SwL2TrafficSegPort_Object((1,3,6,1,4,1,171,11,116,2,2,12,1,1,1),_SwL2TrafficSegPort_Type())
...
swL2TrafficSegForwardPorts=_SwL2TrafficSegForwardPorts_Object((1,3,6,1,4,1,171,11,116,2,2,12,1,1,2),_SwL2TrafficSegForwardPorts_Type())
...
swL2PortSecurityMgmt=_SwL2PortSecurityMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,15))
_SwL2PortSecurityControlTable_Object=MibTable
swL2PortSecurityControlTable=_SwL2PortSecurityControlTable_Object((1,3,6,1,4,1,171,11,116,2,2,15,1))
if mibBuilder.loadTexts:swL2PortSecurityControlTable.setStatus(_A)
_SwL2PortSecurityControlEntry_Object=MibTableRow
swL2PortSecurityControlEntry=_SwL2PortSecurityControlEntry_Object((1,3,6,1,4,1,171,11,116,2,2,15,1,1))
...
swL2PortSecurityPortIndex=_SwL2PortSecurityPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,15,1,1,1),_SwL2PortSecurityPortIndex_Type())
...
swL2PortSecurityMaxLernAddr=_SwL2PortSecurityMaxLernAddr_Object((1,3,6,1,4,1,171,11,116,2,2,15,1,1,2),_SwL2PortSecurityMaxLernAddr_Type())
...
swL2PortSecurityMode=_SwL2PortSecurityMode_Object((1,3,6,1,4,1,171,11,116,2,2,15,1,1,3),_SwL2PortSecurityMode_Type())
swL2PortSecurityMode.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2PortSecurityMode.setStatus(_A)
class _SwL2PortSecurityAdmState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_F,1),(_O,2),(_M,3)))
_SwL2PortSecurityAdmState_Type.__name__=_B
_SwL2PortSecurityAdmState_Object=MibTableColumn
swL2PortSecurityAdmState=_SwL2PortSecurityAdmState_Object((1,3,6,1,4,1,171,11,116,2,2,15,1,1,4),_SwL2PortSecurityAdmState_Type())
swL2PortSecurityAdmState.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2PortSecurityAdmState.setStatus(_A)
class _SwL2PortSecurityEntryClearCtrl_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_F,1),('start',2)))
_SwL2PortSecurityEntryClearCtrl_Type.__name__=_B
_SwL2PortSecurityEntryClearCtrl_Object=MibTableColumn
swL2PortSecurityEntryClearCtrl=_SwL2PortSecurityEntryClearCtrl_Object((1,3,6,1,4,1,171,11,116,2,2,15,1,1,5),_SwL2PortSecurityEntryClearCtrl_Type())
swL2PortSecurityEntryClearCtrl.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2PortSecurityEntryClearCtrl.setStatus(_A)
class _SwL2PortSecurityTrapLogState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_F,1),(_O,2),(_M,3)))
_SwL2PortSecurityTrapLogState_Type.__name__=_B
_SwL2PortSecurityTrapLogState_Object=MibScalar
swL2PortSecurityTrapLogState=_SwL2PortSecurityTrapLogState_Object((1,3,6,1,4,1,171,11,116,2,2,15,2),_SwL2PortSecurityTrapLogState_Type())
...
swL2PortSecurityDelCtrl=_SwL2PortSecurityDelCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,15,3))
...
swL2PortSecurityDelVlanName=_SwL2PortSecurityDelVlanName_Object((1,3,6,1,4,1,171,11,116,2,2,15,3,1),_SwL2PortSecurityDelVlanName_Type())
...
swL2PortSecurityDelPort=_SwL2PortSecurityDelPort_Object((1,3,6,1,4,1,171,11,116,2,2,15,3,2),_SwL2PortSecurityDelPort_Type())
...
swL2PortSecurityDelMacAddress=_SwL2PortSecurityDelMacAddress_Object((1,3,6,1,4,1,171,11,116,2,2,15,3,3),_SwL2PortSecurityDelMacAddress_Type())
swL2PortSecurityDelMacAddress.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2PortSecurityDelMacAddress.setStatus(_A)
class _SwL2PortSecurityDelActivity_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_L,1),('start',2)))
_SwL2PortSecurityDelActivity_Type.__name__=_B
_SwL2PortSecurityDelActivity_Object=MibScalar
swL2PortSecurityDelActivity=_SwL2PortSecurityDelActivity_Object((1,3,6,1,4,1,171,11,116,2,2,15,3,4),_SwL2PortSecurityDelActivity_Type())
...
swL2CosMgmt=_SwL2CosMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,17))
_SwL2CosPriorityCtrl_ObjectIdentity=ObjectIdentity
swL2CosPriorityCtrl=_SwL2CosPriorityCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,17,3))
_SwL2CosPriorityTable_Object=MibTable
swL2CosPriorityTable=_SwL2CosPriorityTable_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,1))
if mibBuilder.loadTexts:swL2CosPriorityTable.setStatus(_A)
_SwL2CosPriorityEntry_Object=MibTableRow
swL2CosPriorityEntry=_SwL2CosPriorityEntry_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,1,1))
swL2CosPriorityEntry.setIndexNames((0,_E,_y))
...
swL2CosPriorityPort=_SwL2CosPriorityPort_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,1,1,1),_SwL2CosPriorityPort_Type())
swL2CosPriorityPort.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2CosPriorityPort.setStatus(_A)
class _SwL2CosPriorityEtherPRI_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_M,1),('ether8021p',2),('macBase',3)))
_SwL2CosPriorityEtherPRI_Type.__name__=_B
_SwL2CosPriorityEtherPRI_Object=MibTableColumn
swL2CosPriorityEtherPRI=_SwL2CosPriorityEtherPRI_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,1,1,3),_SwL2CosPriorityEtherPRI_Type())
swL2CosPriorityEtherPRI.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2CosPriorityEtherPRI.setStatus(_A)
class _SwL2CosPriorityIpPRI_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_M,1),('tos',2),('dscp',3)))
_SwL2CosPriorityIpPRI_Type.__name__=_B
_SwL2CosPriorityIpPRI_Object=MibTableColumn
swL2CosPriorityIpPRI=_SwL2CosPriorityIpPRI_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,1,1,4),_SwL2CosPriorityIpPRI_Type())
swL2CosPriorityIpPRI.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2CosPriorityIpPRI.setStatus(_A)
class _SwL2CosPriorityNone_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('valid',1),(_z,2)))
_SwL2CosPriorityNone_Type.__name__=_B
_SwL2CosPriorityNone_Object=MibTableColumn
swL2CosPriorityNone=_SwL2CosPriorityNone_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,1,1,5),_SwL2CosPriorityNone_Type())
...
swL2CosTosPRITable=_SwL2CosTosPRITable_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,4))
if mibBuilder.loadTexts:swL2CosTosPRITable.setStatus(_A)
_SwL2CosTosPRIEntry_Object=MibTableRow
swL2CosTosPRIEntry=_SwL2CosTosPRIEntry_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,4,1))
swL2CosTosPRIEntry.setIndexNames((0,_E,_A0))
...
swL2CosTosPRIIndex=_SwL2CosTosPRIIndex_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,4,1,1),_SwL2CosTosPRIIndex_Type())
...
swL2CosTosPRIClass=_SwL2CosTosPRIClass_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,4,1,2),_SwL2CosTosPRIClass_Type())
...
swL2CosDscpPRITable=_SwL2CosDscpPRITable_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,5))
if mibBuilder.loadTexts:swL2CosDscpPRITable.setStatus(_A)
_SwL2CosDscpPRIEntry_Object=MibTableRow
swL2CosDscpPRIEntry=_SwL2CosDscpPRIEntry_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,5,1))
swL2CosDscpPRIEntry.setIndexNames((0,_E,_A1))
...
swL2CosDscpPRIIndex=_SwL2CosDscpPRIIndex_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,5,1,1),_SwL2CosDscpPRIIndex_Type())
...
swL2CosDscpPRIClass=_SwL2CosDscpPRIClass_Object((1,3,6,1,4,1,171,11,116,2,2,17,3,5,1,2),_SwL2CosDscpPRIClass_Type())
...
swL2DhcpRelayMgmt=_SwL2DhcpRelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,18))
...
swL2DhcpRelayState=_SwL2DhcpRelayState_Object((1,3,6,1,4,1,171,11,116,2,2,18,1),_SwL2DhcpRelayState_Type())
...
swL2DhcpRelayHopCount=_SwL2DhcpRelayHopCount_Object((1,3,6,1,4,1,171,11,116,2,2,18,2),_SwL2DhcpRelayHopCount_Type())
...
swL2DhcpRelayTimeThreshold=_SwL2DhcpRelayTimeThreshold_Object((1,3,6,1,4,1,171,11,116,2,2,18,3),_SwL2DhcpRelayTimeThreshold_Type())
...
swL2DhcpRelayOption82State=_SwL2DhcpRelayOption82State_Object((1,3,6,1,4,1,171,11,116,2,2,18,4),_SwL2DhcpRelayOption82State_Type())
...
swL2DhcpRelayOption82Check=_SwL2DhcpRelayOption82Check_Object((1,3,6,1,4,1,171,11,116,2,2,18,5),_SwL2DhcpRelayOption82Check_Type())
...
swL2DhcpRelayOption82Policy=_SwL2DhcpRelayOption82Policy_Object((1,3,6,1,4,1,171,11,116,2,2,18,6),_SwL2DhcpRelayOption82Policy_Type())
...
swL2DhcpRelayCtrlTable=_SwL2DhcpRelayCtrlTable_Object((1,3,6,1,4,1,171,11,116,2,2,18,7))
if mibBuilder.loadTexts:swL2DhcpRelayCtrlTable.setStatus(_J)
_SwL2DhcpRelayCtrlEntry_Object=MibTableRow
swL2DhcpRelayCtrlEntry=_SwL2DhcpRelayCtrlEntry_Object((1,3,6,1,4,1,171,11,116,2,2,18,7,1))
swL2DhcpRelayCtrlEntry.setIndexNames((0,_E,_A2),(0,_E,_A3))
...
swL2DhcpRelayCtrlInterfaceName=_SwL2DhcpRelayCtrlInterfaceName_Object((1,3,6,1,4,1,171,11,116,2,2,18,7,1,1),_SwL2DhcpRelayCtrlInterfaceName_Type())
...
swL2DhcpRelayCtrlServer=_SwL2DhcpRelayCtrlServer_Object((1,3,6,1,4,1,171,11,116,2,2,18,7,1,2),_SwL2DhcpRelayCtrlServer_Type())
swL2DhcpRelayCtrlServer.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2DhcpRelayCtrlServer.setStatus(_J)
class _SwL2DhcpRelayCtrlState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_F,1),(_z,2),('valid',3)))
_SwL2DhcpRelayCtrlState_Type.__name__=_B
_SwL2DhcpRelayCtrlState_Object=MibTableColumn
swL2DhcpRelayCtrlState=_SwL2DhcpRelayCtrlState_Object((1,3,6,1,4,1,171,11,116,2,2,18,7,1,3),_SwL2DhcpRelayCtrlState_Type())
...
swL2MgmtMIBTraps=_SwL2MgmtMIBTraps_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,20))
_SwL2MgmtMIBTrapPrefix_ObjectIdentity=ObjectIdentity
swL2MgmtMIBTrapPrefix=_SwL2MgmtMIBTrapPrefix_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,20,0))
_Swl2PortSecurityBindings_ObjectIdentity=ObjectIdentity
swl2PortSecurityBindings=_Swl2PortSecurityBindings_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,20,1))
_SwL2PortSecurityViolationMac_Type=MacAddress
_SwL2PortSecurityViolationMac_Object=MibScalar
swL2PortSecurityViolationMac=_SwL2PortSecurityViolationMac_Object((1,3,6,1,4,1,171,11,116,2,2,20,1,1),_SwL2PortSecurityViolationMac_Type())
swL2PortSecurityViolationMac.setMaxAccess(_A4)
if mibBuilder.loadTexts:swL2PortSecurityViolationMac.setStatus(_A)
_Swl2NotificationBindings_ObjectIdentity=ObjectIdentity
swl2NotificationBindings=_Swl2NotificationBindings_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,20,2))
...
_SwL2macNotifyInfo_Type.__name__=_Q
_SwL2macNotifyInfo_Object=MibScalar
swL2macNotifyInfo=_SwL2macNotifyInfo_Object((1,3,6,1,4,1,171,11,116,2,2,20,2,1),_SwL2macNotifyInfo_Type())
...
swL2VlanLoopDetectVID=_SwL2VlanLoopDetectVID_Object((1,3,6,1,4,1,171,11,116,2,2,20,2,2),_SwL2VlanLoopDetectVID_Type())
swL2VlanLoopDetectVID.setMaxAccess(_A4)
...
swL2FloodMacDetectedMacVid=_SwL2FloodMacDetectedMacVid_Object((1,3,6,1,4,1,171,11,116,2,2,20,2,3),_SwL2FloodMacDetectedMacVid_Type())
...
swL2FloodMacDetectedMacAddress=_SwL2FloodMacDetectedMacAddress_Object((1,3,6,1,4,1,171,11,116,2,2,20,2,4),_SwL2FloodMacDetectedMacAddress_Type())
...
swL2LoopDetectMgmt=_SwL2LoopDetectMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,21))
_SwL2LoopDetectCtrl_ObjectIdentity=ObjectIdentity
swL2LoopDetectCtrl=_SwL2LoopDetectCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,21,1))
...
swL2LoopDetectAdminState=_SwL2LoopDetectAdminState_Object((1,3,6,1,4,1,171,11,116,2,2,21,1,1),_SwL2LoopDetectAdminState_Type())
...
swL2LoopDetectInterval=_SwL2LoopDetectInterval_Object((1,3,6,1,4,1,171,11,116,2,2,21,1,2),_SwL2LoopDetectInterval_Type())
...
swL2LoopDetectRecoverTime=_SwL2LoopDetectRecoverTime_Object((1,3,6,1,4,1,171,11,116,2,2,21,1,3),_SwL2LoopDetectRecoverTime_Type())
...
swL2LoopDetectMode=_SwL2LoopDetectMode_Object((1,3,6,1,4,1,171,11,116,2,2,21,1,4),_SwL2LoopDetectMode_Type())
...
swL2LoopDetectTrapMode=_SwL2LoopDetectTrapMode_Object((1,3,6,1,4,1,171,11,116,2,2,21,1,5),_SwL2LoopDetectTrapMode_Type())
...
swL2LoopDetectPortMgmt=_SwL2LoopDetectPortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,21,2))
_SwL2LoopDetectPortTable_Object=MibTable
swL2LoopDetectPortTable=_SwL2LoopDetectPortTable_Object((1,3,6,1,4,1,171,11,116,2,2,21,2,1))
if mibBuilder.loadTexts:swL2LoopDetectPortTable.setStatus(_A)
_SwL2LoopDetectPortEntry_Object=MibTableRow
swL2LoopDetectPortEntry=_SwL2LoopDetectPortEntry_Object((1,3,6,1,4,1,171,11,116,2,2,21,2,1,1))
...
swL2LoopDetectPortIndex=_SwL2LoopDetectPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,21,2,1,1,1),_SwL2LoopDetectPortIndex_Type())
...
swL2LoopDetectPortState=_SwL2LoopDetectPortState_Object((1,3,6,1,4,1,171,11,116,2,2,21,2,1,1,2),_SwL2LoopDetectPortState_Type())
...
swL2LoopDetectPortLoopVLAN=_SwL2LoopDetectPortLoopVLAN_Object((1,3,6,1,4,1,171,11,116,2,2,21,2,1,1,3),_SwL2LoopDetectPortLoopVLAN_Type())
swL2LoopDetectPortLoopVLAN.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2LoopDetectPortLoopVLAN.setStatus(_A)
class _SwL2LoopDetectPortLoopStatus_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4)));namedValues=NamedValues(*((_R,1),('loop',2),('error',3),(_L,4)))
_SwL2LoopDetectPortLoopStatus_Type.__name__=_B
_SwL2LoopDetectPortLoopStatus_Object=MibTableColumn
swL2LoopDetectPortLoopStatus=_SwL2LoopDetectPortLoopStatus_Object((1,3,6,1,4,1,171,11,116,2,2,21,2,1,1,4),_SwL2LoopDetectPortLoopStatus_Type())
...
swL2MultiFilter=_SwL2MultiFilter_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,22))
_SwL2McastFilterTable_Object=MibTable
swL2McastFilterTable=_SwL2McastFilterTable_Object((1,3,6,1,4,1,171,11,116,2,2,22,2))
if mibBuilder.loadTexts:swL2McastFilterTable.setStatus(_A)
_SwL2McastFilterEntry_Object=MibTableRow
swL2McastFilterEntry=_SwL2McastFilterEntry_Object((1,3,6,1,4,1,171,11,116,2,2,22,2,1))
swL2McastFilterEntry.setIndexNames((0,_E,_A5))
...
swL2McastFilterProfileIndex=_SwL2McastFilterProfileIndex_Object((1,3,6,1,4,1,171,11,116,2,2,22,2,1,1),_SwL2McastFilterProfileIndex_Type())
...
swL2McastFilterProfileName=_SwL2McastFilterProfileName_Object((1,3,6,1,4,1,171,11,116,2,2,22,2,1,2),_SwL2McastFilterProfileName_Type())
swL2McastFilterProfileName.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2McastFilterProfileName.setStatus(_A)
class _SwL2McastFilterAddOrDelState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_L,1),('add',2),(_P,3)))
_SwL2McastFilterAddOrDelState_Type.__name__=_B
_SwL2McastFilterAddOrDelState_Object=MibTableColumn
swL2McastFilterAddOrDelState=_SwL2McastFilterAddOrDelState_Object((1,3,6,1,4,1,171,11,116,2,2,22,2,1,3),_SwL2McastFilterAddOrDelState_Type())
...
swL2McastFilterGroupList=_SwL2McastFilterGroupList_Object((1,3,6,1,4,1,171,11,116,2,2,22,2,1,4),_SwL2McastFilterGroupList_Type())
...
swL2McastFilterStatus=_SwL2McastFilterStatus_Object((1,3,6,1,4,1,171,11,116,2,2,22,2,1,5),_SwL2McastFilterStatus_Type())
...
swL2McastFilterPortTable=_SwL2McastFilterPortTable_Object((1,3,6,1,4,1,171,11,116,2,2,22,3))
if mibBuilder.loadTexts:swL2McastFilterPortTable.setStatus(_A)
_SwL2McastFilterPortEntry_Object=MibTableRow
swL2McastFilterPortEntry=_SwL2McastFilterPortEntry_Object((1,3,6,1,4,1,171,11,116,2,2,22,3,1))
swL2McastFilterPortEntry.setIndexNames((0,_E,_A6))
...
swL2McastFilterPortGroupPortIndex=_SwL2McastFilterPortGroupPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,22,3,1,1),_SwL2McastFilterPortGroupPortIndex_Type())
swL2McastFilterPortGroupPortIndex.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2McastFilterPortGroupPortIndex.setStatus(_A)
class _SwL2McastFilterPortProfileAddOrDelState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_L,1),('add',2),(_P,3)))
_SwL2McastFilterPortProfileAddOrDelState_Type.__name__=_B
_SwL2McastFilterPortProfileAddOrDelState_Object=MibTableColumn
swL2McastFilterPortProfileAddOrDelState=_SwL2McastFilterPortProfileAddOrDelState_Object((1,3,6,1,4,1,171,11,116,2,2,22,3,1,2),_SwL2McastFilterPortProfileAddOrDelState_Type())
...
swL2McastFilterPortProfileID=_SwL2McastFilterPortProfileID_Object((1,3,6,1,4,1,171,11,116,2,2,22,3,1,3),_SwL2McastFilterPortProfileID_Type())
swL2McastFilterPortProfileID.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2McastFilterPortProfileID.setStatus(_A)
class _SwL2McastFilterPortAccess_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_L,0),('permit',1),('deny',2)))
_SwL2McastFilterPortAccess_Type.__name__=_B
_SwL2McastFilterPortAccess_Object=MibTableColumn
swL2McastFilterPortAccess=_SwL2McastFilterPortAccess_Object((1,3,6,1,4,1,171,11,116,2,2,22,3,1,4),_SwL2McastFilterPortAccess_Type())
swL2McastFilterPortAccess.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2McastFilterPortAccess.setStatus(_A)
_SwL2McastFilterPortMaxGroupTable_Object=MibTable
swL2McastFilterPortMaxGroupTable=_SwL2McastFilterPortMaxGroupTable_Object((1,3,6,1,4,1,171,11,116,2,2,22,4))
...
swL2McastFilterPortMaxGroupEntry=_SwL2McastFilterPortMaxGroupEntry_Object((1,3,6,1,4,1,171,11,116,2,2,22,4,1))
swL2McastFilterPortMaxGroupEntry.setIndexNames((0,_E,_A7))
...
swL2McastFilterPortMaxGroupPortIndex=_SwL2McastFilterPortMaxGroupPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,22,4,1,1),_SwL2McastFilterPortMaxGroupPortIndex_Type())
...
swL2McastFilterPortMaxGroup=_SwL2McastFilterPortMaxGroup_Object((1,3,6,1,4,1,171,11,116,2,2,22,4,1,2),_SwL2McastFilterPortMaxGroup_Type())
...
swL2McastFilterPortInfoTable=_SwL2McastFilterPortInfoTable_Object((1,3,6,1,4,1,171,11,116,2,2,22,5))
if mibBuilder.loadTexts:swL2McastFilterPortInfoTable.setStatus(_A)
_SwL2McastFilterPortInfoEntry_Object=MibTableRow
swL2McastFilterPortInfoEntry=_SwL2McastFilterPortInfoEntry_Object((1,3,6,1,4,1,171,11,116,2,2,22,5,1))
swL2McastFilterPortInfoEntry.setIndexNames((0,_E,_A8))
...
swL2McastFilterPortInfoPortIndex=_SwL2McastFilterPortInfoPortIndex_Object((1,3,6,1,4,1,171,11,116,2,2,22,5,1,1),_SwL2McastFilterPortInfoPortIndex_Type())
...
swL2McastFilterPortInfoProfileID=_SwL2McastFilterPortInfoProfileID_Object((1,3,6,1,4,1,171,11,116,2,2,22,5,1,2),_SwL2McastFilterPortInfoProfileID_Type())
swL2McastFilterPortInfoProfileID.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2McastFilterPortInfoProfileID.setStatus(_A)
class _SwL2McastFilterPortInfoAccess_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('permit',1),('deny',2)))
_SwL2McastFilterPortInfoAccess_Type.__name__=_B
_SwL2McastFilterPortInfoAccess_Object=MibTableColumn
swL2McastFilterPortInfoAccess=_SwL2McastFilterPortInfoAccess_Object((1,3,6,1,4,1,171,11,116,2,2,22,5,1,3),_SwL2McastFilterPortInfoAccess_Type())
swL2McastFilterPortInfoAccess.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2McastFilterPortInfoAccess.setStatus(_A)
_SwL2VlanMgmt_ObjectIdentity=ObjectIdentity
swL2VlanMgmt=_SwL2VlanMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,23))
_SwL2VlanAdvertisementTable_Object=MibTable
swL2VlanAdvertisementTable=_SwL2VlanAdvertisementTable_Object((1,3,6,1,4,1,171,11,116,2,2,23,1))
if mibBuilder.loadTexts:swL2VlanAdvertisementTable.setStatus(_A)
_SwL2VlanAdvertisementEntry_Object=MibTableRow
swL2VlanAdvertisementEntry=_SwL2VlanAdvertisementEntry_Object((1,3,6,1,4,1,171,11,116,2,2,23,1,1))
swL2VlanAdvertisementEntry.setIndexNames((0,_E,_A9))
...
swL2VlanIndex=_SwL2VlanIndex_Object((1,3,6,1,4,1,171,11,116,2,2,23,1,1,1),_SwL2VlanIndex_Type())
...
swL2VlanName=_SwL2VlanName_Object((1,3,6,1,4,1,171,11,116,2,2,23,1,1,2),_SwL2VlanName_Type())
...
swL2VlanAdvertiseState=_SwL2VlanAdvertiseState_Object((1,3,6,1,4,1,171,11,116,2,2,23,1,1,3),_SwL2VlanAdvertiseState_Type())
...
swL2VlanMultiplyMgmt=_SwL2VlanMultiplyMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,23,2))
...
swL2VlanMultiplyVlanList=_SwL2VlanMultiplyVlanList_Object((1,3,6,1,4,1,171,11,116,2,2,23,2,1),_SwL2VlanMultiplyVlanList_Type())
...
swL2VlanMultiplyAdvertisement=_SwL2VlanMultiplyAdvertisement_Object((1,3,6,1,4,1,171,11,116,2,2,23,2,2),_SwL2VlanMultiplyAdvertisement_Type())
...
swL2VlanMultiplyPortList=_SwL2VlanMultiplyPortList_Object((1,3,6,1,4,1,171,11,116,2,2,23,2,3),_SwL2VlanMultiplyPortList_Type())
...
swL2VlanMultiplyPortListAction=_SwL2VlanMultiplyPortListAction_Object((1,3,6,1,4,1,171,11,116,2,2,23,2,4),_SwL2VlanMultiplyPortListAction_Type())
...
swL2VlanMultiplyAction=_SwL2VlanMultiplyAction_Object((1,3,6,1,4,1,171,11,116,2,2,23,2,5),_SwL2VlanMultiplyAction_Type())
...
swL2PVIDAutoAssignmentState=_SwL2PVIDAutoAssignmentState_Object((1,3,6,1,4,1,171,11,116,2,2,23,3),_SwL2PVIDAutoAssignmentState_Type())
...
swL2DhcpLocalRelayMgmt=_SwL2DhcpLocalRelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,116,2,2,24))
...
swL2DhcpLocalRelayState=_SwL2DhcpLocalRelayState_Object((1,3,6,1,4,1,171,11,116,2,2,24,1),_SwL2DhcpLocalRelayState_Type())
...
swL2DhcpLocalRelayVLANTable=_SwL2DhcpLocalRelayVLANTable_Object((1,3,6,1,4,1,171,11,116,2,2,24,2))
if mibBuilder.loadTexts:swL2DhcpLocalRelayVLANTable.setStatus(_A)
_SwL2DhcpLocalRelayVLANEntry_Object=MibTableRow
swL2DhcpLocalRelayVLANEntry=_SwL2DhcpLocalRelayVLANEntry_Object((1,3,6,1,4,1,171,11,116,2,2,24,2,1))
swL2DhcpLocalRelayVLANEntry.setIndexNames((0,_E,_AA))
...
swL2DhcpLocalRelayVLANID=_SwL2DhcpLocalRelayVLANID_Object((1,3,6,1,4,1,171,11,116,2,2,24,2,1,1),_SwL2DhcpLocalRelayVLANID_Type())
...
swL2DhcpLocalRelayVLANState=_SwL2DhcpLocalRelayVLANState_Object((1,3,6,1,4,1,171,11,116,2,2,24,2,1,2),_SwL2DhcpLocalRelayVLANState_Type())
swL2DhcpLocalRelayVLANState.setMaxAccess(_C)
if mibBuilder.loadTexts:swL2DhcpLocalRelayVLANState.setStatus(_A)
swL2PortSecurityViolationTrap=NotificationType((1,3,6,1,4,1,171,11,116,2,2,20,0,1))
swL2PortSecurityViolationTrap.setObjects(*((_E,_S),(_E,_AB)))
if mibBuilder.loadTexts:swL2PortSecurityViolationTrap.setStatus(_A)
swL2macNotification=NotificationType((1,3,6,1,4,1,171,11,116,2,2,20,0,2))
swL2macNotification.setObjects((_E,_AC))
if mibBuilder.loadTexts:swL2macNotification.setStatus(_A)
swL2PortLoopOccurred=NotificationType((1,3,6,1,4,1,171,11,116,2,2,20,0,3))
swL2PortLoopOccurred.setObjects((_E,_N))
if mibBuilder.loadTexts:swL2PortLoopOccurred.setStatus(_A)
swL2PortLoopRestart=NotificationType((1,3,6,1,4,1,171,11,116,2,2,20,0,4))
swL2PortLoopRestart.setObjects((_E,_N))
if mibBuilder.loadTexts:swL2PortLoopRestart.setStatus(_A)
swL2VlanLoopOccurred=NotificationType((1,3,6,1,4,1,171,11,116,2,2,20,0,5))
swL2VlanLoopOccurred.setObjects(*((_E,_N),(_E,_T)))
if mibBuilder.loadTexts:swL2VlanLoopOccurred.setStatus(_A)
swL2VlanLoopRestart=NotificationType((1,3,6,1,4,1,171,11,116,2,2,20,0,6))
swL2VlanLoopRestart.setObjects(*((_E,_N),(_E,_T)))
if mibBuilder.loadTexts:swL2VlanLoopRestart.setStatus(_A)
swL2FloodMacDetectedTrap=NotificationType((1,3,6,1,4,1,171,11,116,2,2,20,0,7))
swL2FloodMacDetectedTrap.setObjects(*((_E,_AD),(_E,_AE)))
if mibBuilder.loadTexts:swL2FloodMacDetectedTrap.setStatus(_A)
mibBuilder.exportSymbols(_E,**{'VlanId':VlanId,'PortList':PortList,'MacAddress':MacAddress,'swL2MgmtMIB':swL2MgmtMIB,'swL2DevMgmt':swL2DevMgmt,'swL2DevInfo':swL2DevInfo,'swL2DevInfoFrontPanelLedStatus':swL2DevInfoFrontPanelLedStatus,'swL2DevCtrl':swL2DevCtrl,'swL2DevCtrlSystemReboot':swL2DevCtrlSystemReboot,'swL2DevCtrlSystemIP':swL2DevCtrlSystemIP,'swL2DevCtrlSubnetMask':swL2DevCtrlSubnetMask,'swL2DevCtrlDefaultGateway':swL2DevCtrlDefaultGateway,'swL2DevCtrlManagementVlanId':swL2DevCtrlManagementVlanId,'swL2DevCtrlIGMPSnooping':swL2DevCtrlIGMPSnooping,'swL2DevCtrlCleanAllStatisticCounter':swL2DevCtrlCleanAllStatisticCounter,'swL2DevCtrlSnmpEnableAuthenTraps':swL2DevCtrlSnmpEnableAuthenTraps,'swL2DevCtrlRmonState':swL2DevCtrlRmonState,'swL2DevCtrlIpAutoConfig':swL2DevCtrlIpAutoConfig,'swL2MACNotifyState':swL2MACNotifyState,'swL2MACNotifyHistorySize':swL2MACNotifyHistorySize,'swL2MACNotifyInterval':swL2MACNotifyInterval,'swL2DevCtrlLLDPState':swL2DevCtrlLLDPState,'swL2DevCtrlLLDPForwardMessageState':swL2DevCtrlLLDPForwardMessageState,'swL2DevCtrlAsymVlanState':swL2DevCtrlAsymVlanState,'swL2IGMPSnoopingMulticastVlanState':swL2IGMPSnoopingMulticastVlanState,'swL2DevCtrlVLANTrunkState':swL2DevCtrlVLANTrunkState,'swL2DevArpAgingTime':swL2DevArpAgingTime,'swL2DevPasswordEncryptionState':swL2DevPasswordEncryptionState,'swL2DevCtrlWeb':swL2DevCtrlWeb,'swL2DevCtrlWebState':swL2DevCtrlWebState,'swL2DevAlarm':swL2DevAlarm,'swL2DevAlarmNewRoot':swL2DevAlarmNewRoot,'swL2DevAlarmTopologyChange':swL2DevAlarmTopologyChange,'swL2DevAlarmLinkChange':swL2DevAlarmLinkChange,'swL2PortMgmt':swL2PortMgmt,'swL2PortInfoTable':swL2PortInfoTable,'swL2PortInfoEntry':swL2PortInfoEntry,_W:swL2PortInfoPortIndex,_X:swL2PortInfoMediumType,'swL2PortInfoLinkStatus':swL2PortInfoLinkStatus,'swL2PortInfoNwayStatus':swL2PortInfoNwayStatus,'swL2PortInfoFlowCtrlOperStatus':swL2PortInfoFlowCtrlOperStatus,'swL2PortCtrlTable':swL2PortCtrlTable,'swL2PortCtrlEntry':swL2PortCtrlEntry,_Z:swL2PortCtrlPortIndex,_a:swL2PortCtrlPortMediumType,'swL2PortCtrlAdminState':swL2PortCtrlAdminState,'swL2PortCtrlNwayState':swL2PortCtrlNwayState,'swL2PortCtrlFlowCtrlState':swL2PortCtrlFlowCtrlState,'swL2PortCtrlDescription':swL2PortCtrlDescription,'swL2PortCtrlAddressLearning':swL2PortCtrlAddressLearning,'swL2PortCtrlMACNotifyState':swL2PortCtrlMACNotifyState,'swL2PortCtrlMulticastfilter':swL2PortCtrlMulticastfilter,'swL2PortCtrlMDIXState':swL2PortCtrlMDIXState,'swL2PortErrTable':swL2PortErrTable,'swL2PortErrEntry':swL2PortErrEntry,_b:swL2PortErrPortIndex,'swL2PortErrPortState':swL2PortErrPortState,'swL2PortErrPortStatus':swL2PortErrPortStatus,'swL2PortErrPortReason':swL2PortErrPortReason,'swL2PortErrDescription':swL2PortErrDescription,'swL2PortCtrlJumboFrame':swL2PortCtrlJumboFrame,'swL2PortCtrlJumboFrameMaxSize':swL2PortCtrlJumboFrameMaxSize,'swL2QOSMgmt':swL2QOSMgmt,'swL2QOSBandwidthControlTable':swL2QOSBandwidthControlTable,'swL2QOSBandwidthControlEntry':swL2QOSBandwidthControlEntry,_c:swL2QOSBandwidthPortIndex,'swL2QOSBandwidthRxRate':swL2QOSBandwidthRxRate,'swL2QOSBandwidthTxRate':swL2QOSBandwidthTxRate,'swL2QOSBandwidthRadiusRxRate':swL2QOSBandwidthRadiusRxRate,'swL2QOSBandwidthRadiusTxRate':swL2QOSBandwidthRadiusTxRate,'swL2QOSSchedulingTable':swL2QOSSchedulingTable,'swL2QOSSchedulingEntry':swL2QOSSchedulingEntry,_d:swL2QOSSchedulingClassIndex,'swL2QOSSchedulingMaxWeight':swL2QOSSchedulingMaxWeight,'swL2QOSSchedulingMechanism':swL2QOSSchedulingMechanism,'swL2QOS8021pUserPriorityTable':swL2QOS8021pUserPriorityTable,'swL2QOS8021pUserPriorityEntry':swL2QOS8021pUserPriorityEntry,_g:swL2QOS8021pUserPriorityIndex,'swL2QOS8021pUserPriorityClass':swL2QOS8021pUserPriorityClass,'swL2QOS8021pDefaultPriorityTable':swL2QOS8021pDefaultPriorityTable,'swL2QOS8021pDefaultPriorityEntry':swL2QOS8021pDefaultPriorityEntry,_h:swL2QOS8021pDefaultPriorityIndex,'swL2QOS8021pDefaultPriority':swL2QOS8021pDefaultPriority,'swL2QOS8021pRadiusPriority':swL2QOS8021pRadiusPriority,'swL2QOSSchedulingMechanismCtrl':swL2QOSSchedulingMechanismCtrl,'swL2TrunkMgmt':swL2TrunkMgmt,'swPortTrunkMaxEntries':swPortTrunkMaxEntries,'swPortTrunkMaxPortMembers':swPortTrunkMaxPortMembers,'swPortTrunkTable':swPortTrunkTable,'swPortTrunkEntry':swPortTrunkEntry,_i:swPortTrunkIndex,'swPortTrunkMasterPort':swPortTrunkMasterPort,'swPortTrunkPortList':swPortTrunkPortList,'swPortTrunkType':swPortTrunkType,'swPortTrunkActivePort':swPortTrunkActivePort,'swPortTrunkState':swPortTrunkState,'swPortTrunkFloodingPort':swPortTrunkFloodingPort,'swL2TrunkAlgorithm':swL2TrunkAlgorithm,'swL2TrunkLACPPortTable':swL2TrunkLACPPortTable,'swL2TrunkLACPPortEntry':swL2TrunkLACPPortEntry,_j:swL2TrunkLACPPortIndex,'swL2TrunkLACPPortState':swL2TrunkLACPPortState,'swL2TrunkVLANTable':swL2TrunkVLANTable,'swL2TrunkVLANEntry':swL2TrunkVLANEntry,_k:swL2TrunkVLANPort,'swL2TrunkVLANState':swL2TrunkVLANState,'swPortMirrorPackage':swPortMirrorPackage,'swPortMirrorRxPortList':swPortMirrorRxPortList,'swPortMirrorTxPortList':swPortMirrorTxPortList,'swPortMirrorTargetPort':swPortMirrorTargetPort,'swPortMirrorState':swPortMirrorState,'swIGMPPackage':swIGMPPackage,'swL2IGMPMaxSupportedVlans':swL2IGMPMaxSupportedVlans,'swL2IGMPMaxIpGroupNumPerVlan':swL2IGMPMaxIpGroupNumPerVlan,'swL2IGMPCtrlTable':swL2IGMPCtrlTable,'swL2IGMPCtrlEntry':swL2IGMPCtrlEntry,_l:swL2IGMPCtrlVid,'swL2IGMPQueryInterval':swL2IGMPQueryInterval,'swL2IGMPMaxResponseTime':swL2IGMPMaxResponseTime,'swL2IGMPRobustness':swL2IGMPRobustness,'swL2IGMPLastMemberQueryInterval':swL2IGMPLastMemberQueryInterval,'swL2IGMPQueryState':swL2IGMPQueryState,'swL2IGMPCurrentState':swL2IGMPCurrentState,'swL2IGMPCtrlState':swL2IGMPCtrlState,'swL2IGMPFastLeave':swL2IGMPFastLeave,'swL2IGMPDynIPMultVlanAge':swL2IGMPDynIPMultVlanAge,'swL2IGMPQueryInfoTable':swL2IGMPQueryInfoTable,'swL2IGMPQueryInfoEntry':swL2IGMPQueryInfoEntry,_m:swL2IGMPInfoVid,'swL2IGMPInfoQueryCount':swL2IGMPInfoQueryCount,'swL2IGMPInfoTxQueryCount':swL2IGMPInfoTxQueryCount,'swL2IGMPRouterPortTable':swL2IGMPRouterPortTable,'swL2IGMPRouterPortEntry':swL2IGMPRouterPortEntry,_n:swL2IGMPRouterPortVlanid,'swL2IGMPRouterPortVlanName':swL2IGMPRouterPortVlanName,'swL2IGMPRouterPortStaticPortList':swL2IGMPRouterPortStaticPortList,'swL2IGMPRouterPortDynamicPortList':swL2IGMPRouterPortDynamicPortList,'swL2IGMPRouterPortForbiddenPortList':swL2IGMPRouterPortForbiddenPortList,'swL2IGMPAccessAuthTable':swL2IGMPAccessAuthTable,'swL2IGMPAccessAuthEntry':swL2IGMPAccessAuthEntry,_o:swL2IGMPAccessAuthPort,'swL2IGMPAccessAuthState':swL2IGMPAccessAuthState,'swL2IGMPMulticastVlanTable':swL2IGMPMulticastVlanTable,'swL2IGMPMulticastVlanEntry':swL2IGMPMulticastVlanEntry,_p:swL2IGMPMulticastVlanid,'swL2IGMPMulticastVlanName':swL2IGMPMulticastVlanName,'swL2IGMPMulticastVlanSourcePort':swL2IGMPMulticastVlanSourcePort,'swL2IGMPMulticastVlanMemberPort':swL2IGMPMulticastVlanMemberPort,'swL2IGMPMulticastVlanTagMemberPort':swL2IGMPMulticastVlanTagMemberPort,'swL2IGMPMulticastVlanState':swL2IGMPMulticastVlanState,'swL2IGMPMulticastVlanReplaceSourceIp':swL2IGMPMulticastVlanReplaceSourceIp,'swL2IGMPMulticastVlanRowStatus':swL2IGMPMulticastVlanRowStatus,'swL2IGMPMulticastVlanUntagSourcePort':swL2IGMPMulticastVlanUntagSourcePort,'swL2IGMPMulticastVlanRemapPriority':swL2IGMPMulticastVlanRemapPriority,'swL2IGMPMulticastVlanReplacePriority':swL2IGMPMulticastVlanReplacePriority,'swL2IGMPMulticastVlanGroupTable':swL2IGMPMulticastVlanGroupTable,'swL2IGMPMulticastVlanGroupEntry':swL2IGMPMulticastVlanGroupEntry,_q:swL2IGMPMulticastVlanGroupVid,_r:swL2IGMPMulticastVlanGroupFromIp,_s:swL2IGMPMulticastVlanGroupToIp,'swL2IGMPMulticastVlanGroupStatus':swL2IGMPMulticastVlanGroupStatus,'swL2IGMPDynIpMultMgmt':swL2IGMPDynIpMultMgmt,'swL2IGMPDynIPMultMaxEntry':swL2IGMPDynIPMultMaxEntry,'swL2IGMPSnoopingClearDynIpMult':swL2IGMPSnoopingClearDynIpMult,'swL2IGMPSnoopingClearDynIpMultVID':swL2IGMPSnoopingClearDynIpMultVID,'swL2IGMPSnoopingClearDynIpMultIP':swL2IGMPSnoopingClearDynIpMultIP,'swL2IGMPSnoopingClearDynIpMultAction':swL2IGMPSnoopingClearDynIpMultAction,'swIGMPSnoopingHostTable':swIGMPSnoopingHostTable,'swIGMPSnoopingHostEntry':swIGMPSnoopingHostEntry,_t:swIGMPSnoopingHostVid,_u:swIGMPSnoopingHostGroup,_v:swIGMPSnoopingHostPort,_w:swIGMPSnoopingHostIp,'swL2TrafficSegMgmt':swL2TrafficSegMgmt,'swL2TrafficSegTable':swL2TrafficSegTable,'swL2TrafficSegEntry':swL2TrafficSegEntry,_x:swL2TrafficSegPort,'swL2TrafficSegForwardPorts':swL2TrafficSegForwardPorts,'swL2PortSecurityMgmt':swL2PortSecurityMgmt,'swL2PortSecurityControlTable':swL2PortSecurityControlTable,'swL2PortSecurityControlEntry':swL2PortSecurityControlEntry,_S:swL2PortSecurityPortIndex,'swL2PortSecurityMaxLernAddr':swL2PortSecurityMaxLernAddr,'swL2PortSecurityMode':swL2PortSecurityMode,'swL2PortSecurityAdmState':swL2PortSecurityAdmState,'swL2PortSecurityEntryClearCtrl':swL2PortSecurityEntryClearCtrl,'swL2PortSecurityTrapLogState':swL2PortSecurityTrapLogState,'swL2PortSecurityDelCtrl':swL2PortSecurityDelCtrl,'swL2PortSecurityDelVlanName':swL2PortSecurityDelVlanName,'swL2PortSecurityDelPort':swL2PortSecurityDelPort,'swL2PortSecurityDelMacAddress':swL2PortSecurityDelMacAddress,'swL2PortSecurityDelActivity':swL2PortSecurityDelActivity,'swL2CosMgmt':swL2CosMgmt,'swL2CosPriorityCtrl':swL2CosPriorityCtrl,'swL2CosPriorityTable':swL2CosPriorityTable,'swL2CosPriorityEntry':swL2CosPriorityEntry,_y:swL2CosPriorityPort,'swL2CosPriorityEtherPRI':swL2CosPriorityEtherPRI,'swL2CosPriorityIpPRI':swL2CosPriorityIpPRI,'swL2CosPriorityNone':swL2CosPriorityNone,'swL2CosTosPRITable':swL2CosTosPRITable,'swL2CosTosPRIEntry':swL2CosTosPRIEntry,_A0:swL2CosTosPRIIndex,'swL2CosTosPRIClass':swL2CosTosPRIClass,'swL2CosDscpPRITable':swL2CosDscpPRITable,'swL2CosDscpPRIEntry':swL2CosDscpPRIEntry,_A1:swL2CosDscpPRIIndex,'swL2CosDscpPRIClass':swL2CosDscpPRIClass,'swL2DhcpRelayMgmt':swL2DhcpRelayMgmt,'swL2DhcpRelayState':swL2DhcpRelayState,'swL2DhcpRelayHopCount':swL2DhcpRelayHopCount,'swL2DhcpRelayTimeThreshold':swL2DhcpRelayTimeThreshold,'swL2DhcpRelayOption82State':swL2DhcpRelayOption82State,'swL2DhcpRelayOption82Check':swL2DhcpRelayOption82Check,'swL2DhcpRelayOption82Policy':swL2DhcpRelayOption82Policy,'swL2DhcpRelayCtrlTable':swL2DhcpRelayCtrlTable,'swL2DhcpRelayCtrlEntry':swL2DhcpRelayCtrlEntry,_A2:swL2DhcpRelayCtrlInterfaceName,_A3:swL2DhcpRelayCtrlServer,'swL2DhcpRelayCtrlState':swL2DhcpRelayCtrlState,'swL2MgmtMIBTraps':swL2MgmtMIBTraps,'swL2MgmtMIBTrapPrefix':swL2MgmtMIBTrapPrefix,'swL2PortSecurityViolationTrap':swL2PortSecurityViolationTrap,'swL2macNotification':swL2macNotification,'swL2PortLoopOccurred':swL2PortLoopOccurred,'swL2PortLoopRestart':swL2PortLoopRestart,'swL2VlanLoopOccurred':swL2VlanLoopOccurred,'swL2VlanLoopRestart':swL2VlanLoopRestart,'swL2FloodMacDetectedTrap':swL2FloodMacDetectedTrap,'swl2PortSecurityBindings':swl2PortSecurityBindings,_AB:swL2PortSecurityViolationMac,'swl2NotificationBindings':swl2NotificationBindings,_AC:swL2macNotifyInfo,_T:swL2VlanLoopDetectVID,_AD:swL2FloodMacDetectedMacVid,_AE:swL2FloodMacDetectedMacAddress,'swL2LoopDetectMgmt':swL2LoopDetectMgmt,'swL2LoopDetectCtrl':swL2LoopDetectCtrl,'swL2LoopDetectAdminState':swL2LoopDetectAdminState,'swL2LoopDetectInterval':swL2LoopDetectInterval,'swL2LoopDetectRecoverTime':swL2LoopDetectRecoverTime,'swL2LoopDetectMode':swL2LoopDetectMode,'swL2LoopDetectTrapMode':swL2LoopDetectTrapMode,'swL2LoopDetectPortMgmt':swL2LoopDetectPortMgmt,'swL2LoopDetectPortTable':swL2LoopDetectPortTable,'swL2LoopDetectPortEntry':swL2LoopDetectPortEntry,_N:swL2LoopDetectPortIndex,'swL2LoopDetectPortState':swL2LoopDetectPortState,'swL2LoopDetectPortLoopVLAN':swL2LoopDetectPortLoopVLAN,'swL2LoopDetectPortLoopStatus':swL2LoopDetectPortLoopStatus,'swL2MultiFilter':swL2MultiFilter,'swL2McastFilterTable':swL2McastFilterTable,'swL2McastFilterEntry':swL2McastFilterEntry,_A5:swL2McastFilterProfileIndex,'swL2McastFilterProfileName':swL2McastFilterProfileName,'swL2McastFilterAddOrDelState':swL2McastFilterAddOrDelState,'swL2McastFilterGroupList':swL2McastFilterGroupList,'swL2McastFilterStatus':swL2McastFilterStatus,'swL2McastFilterPortTable':swL2McastFilterPortTable,'swL2McastFilterPortEntry':swL2McastFilterPortEntry,_A6:swL2McastFilterPortGroupPortIndex,'swL2McastFilterPortProfileAddOrDelState':swL2McastFilterPortProfileAddOrDelState,'swL2McastFilterPortProfileID':swL2McastFilterPortProfileID,'swL2McastFilterPortAccess':swL2McastFilterPortAccess,'swL2McastFilterPortMaxGroupTable':swL2McastFilterPortMaxGroupTable,'swL2McastFilterPortMaxGroupEntry':swL2McastFilterPortMaxGroupEntry,_A7:swL2McastFilterPortMaxGroupPortIndex,'swL2McastFilterPortMaxGroup':swL2McastFilterPortMaxGroup,'swL2McastFilterPortInfoTable':swL2McastFilterPortInfoTable,'swL2McastFilterPortInfoEntry':swL2McastFilterPortInfoEntry,_A8:swL2McastFilterPortInfoPortIndex,'swL2McastFilterPortInfoProfileID':swL2McastFilterPortInfoProfileID,'swL2McastFilterPortInfoAccess':swL2McastFilterPortInfoAccess,'swL2VlanMgmt':swL2VlanMgmt,'swL2VlanAdvertisementTable':swL2VlanAdvertisementTable,'swL2VlanAdvertisementEntry':swL2VlanAdvertisementEntry,_A9:swL2VlanIndex,'swL2VlanName':swL2VlanName,'swL2VlanAdvertiseState':swL2VlanAdvertiseState,'swL2VlanMultiplyMgmt':swL2VlanMultiplyMgmt,'swL2VlanMultiplyVlanList':swL2VlanMultiplyVlanList,'swL2VlanMultiplyAdvertisement':swL2VlanMultiplyAdvertisement,'swL2VlanMultiplyPortList':swL2VlanMultiplyPortList,'swL2VlanMultiplyPortListAction':swL2VlanMultiplyPortListAction,'swL2VlanMultiplyAction':swL2VlanMultiplyAction,'swL2PVIDAutoAssignmentState':swL2PVIDAutoAssignmentState,'swL2DhcpLocalRelayMgmt':swL2DhcpLocalRelayMgmt,'swL2DhcpLocalRelayState':swL2DhcpLocalRelayState,'swL2DhcpLocalRelayVLANTable':swL2DhcpLocalRelayVLANTable,'swL2DhcpLocalRelayVLANEntry':swL2DhcpLocalRelayVLANEntry,_AA:swL2DhcpLocalRelayVLANID,'swL2DhcpLocalRelayVLANState':swL2DhcpLocalRelayVLANState})