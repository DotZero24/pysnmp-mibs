...
mibBuilder.exportSymbols("FS-SMARTCLASS-SMI", smartclassMib=smartclassMib, fsSmartClassProducts=fsSmartClassProducts, smartclass=smartclass, PYSNMP_MODULE_ID=smartclassMib)
