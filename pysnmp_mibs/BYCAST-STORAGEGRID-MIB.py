# SNMP MIB module (BYCAST-STORAGEGRID-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netapp/BYCAST-STORAGEGRID-MIB
...
common = _Common_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 28669, 1, 0)
)
_Nmsmi_ObjectIdentity = ObjectIdentity
nmsmi = _Nmsmi_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 28669, 1, 0, 1)
)
_System_ObjectIdentity = ObjectIdentity
system = _System_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 28669, 1, 0, 1, 1)
)
...
label.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    label.setStatus("current")
