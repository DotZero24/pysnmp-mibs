...
mibBuilder.exportSymbols("HPN-ICF-MPLS-BGP-VPN-MIB", hpnicfmplsVpnVrfConfTable=hpnicfmplsVpnVrfConfTable, hpnicfmplsVpnScalars=hpnicfmplsVpnScalars, hpnicfmplsVpnInterfaceConfTable=hpnicfmplsVpnInterfaceConfTable, hpnicfmplsVpnVrfRouteTargetTable=hpnicfmplsVpnVrfRouteTargetTable, hpnicfmplsVpnVrfBgpNbrRowStatus=hpnicfmplsVpnVrfBgpNbrRowStatus, hpnicfmplsVpnInterfaceIpAddressMask=hpnicfmplsVpnInterfaceIpAddressMask, hpnicfmplsVpnVrfRouteRowStatus=hpnicfmplsVpnVrfRouteRowStatus, hpnicfmplsVpnVrfIpRouteRedistributeRip=hpnicfmplsVpnVrfIpRouteRedistributeRip, hpnicfmplsVpnVrfBgpNbrAddrTable=hpnicfmplsVpnVrfBgpNbrAddrTable, hpnicfmplsVpnVrfBgpNbrAddrEntry=hpnicfmplsVpnVrfBgpNbrAddrEntry, hpnicfmplsVpnVrfConfHighRouteThreshold=hpnicfmplsVpnVrfConfHighRouteThreshold, PYSNMP_MODULE_ID=hpnicfMplsVpn, hpnicfmplsVpnVrfBgpNbrRole=hpnicfmplsVpnVrfBgpNbrRole, hpnicfmplsVpnVrfRouteTable=hpnicfmplsVpnVrfRouteTable, HpnicfMplsVpnRouteDistinguisher=HpnicfMplsVpnRouteDistinguisher, hpnicfmplsVpnVrfRouteIfIndex=hpnicfmplsVpnVrfRouteIfIndex, hpnicfmplsVpnRoute=hpnicfmplsVpnRoute, hpnicfmplsVpnInterfaceIpAddress=hpnicfmplsVpnInterfaceIpAddress, hpnicfmplsVpnVrfNetPrefix=hpnicfmplsVpnVrfNetPrefix, hpnicfmplsVpnVrfConfMaxRoutes=hpnicfmplsVpnVrfConfMaxRoutes, hpnicfMplsVpn=hpnicfMplsVpn, hpnicfmplsVpnVrfConfEntry=hpnicfmplsVpnVrfConfEntry, hpnicfmplsVpnVrfBgpNbrAddr=hpnicfmplsVpnVrfBgpNbrAddr, hpnicfmplsVpnActiveVrfs=hpnicfmplsVpnActiveVrfs, hpnicfmplsVpnVrfConfIsWarnOnly=hpnicfmplsVpnVrfConfIsWarnOnly, hpnicfmplsVpnVrfRouteTargetRowStatus=hpnicfmplsVpnVrfRouteTargetRowStatus, hpnicfmplsVpnObjects=hpnicfmplsVpnObjects, hpnicfmplsVpnVrfRouteTargetType=hpnicfmplsVpnVrfRouteTargetType, hpnicfmplsVpnVrfRouteMask=hpnicfmplsVpnVrfRouteMask, hpnicfmplsVpnVrfConfRowStatus=hpnicfmplsVpnVrfConfRowStatus, hpnicfmplsVpnVrfRouteDest=hpnicfmplsVpnVrfRouteDest, hpnicfmplsVpnInterfaceConfRowStatus=hpnicfmplsVpnInterfaceConfRowStatus, hpnicfmplsVpnVrfRouteDistinguisher=hpnicfmplsVpnVrfRouteDistinguisher, hpnicfmplsVpnVrfBgpNbrAdminStatus=hpnicfmplsVpnVrfBgpNbrAdminStatus, hpnicfmplsVpnVrfRouteEntry=hpnicfmplsVpnVrfRouteEntry, hpnicfmplsVpnInterfaceConfEntry=hpnicfmplsVpnInterfaceConfEntry, hpnicfmplsVpnVrfRouteTarget=hpnicfmplsVpnVrfRouteTarget, hpnicfmplsVpnVrfIpRouteRedistributeConn=hpnicfmplsVpnVrfIpRouteRedistributeConn, hpnicfmplsVpnVrfRouteProto=hpnicfmplsVpnVrfRouteProto, hpnicfmplsVpnVrfName=hpnicfmplsVpnVrfName, hpnicfmplsVpnVrfIpRouteRedistributeStatic=hpnicfmplsVpnVrfIpRouteRedistributeStatic, hpnicfmplsVpnInterfaceConfIndex=hpnicfmplsVpnInterfaceConfIndex, hpnicfmplsVpnInterfaceLabelEdgeType=hpnicfmplsVpnInterfaceLabelEdgeType, HpnicfMplsVpnId=HpnicfMplsVpnId, hpnicfmplsVpnConfiguredVrfs=hpnicfmplsVpnConfiguredVrfs, hpnicfmplsVpnInterfaceVpnClassification=hpnicfmplsVpnInterfaceVpnClassification, hpnicfmplsVpnVrfNetPrefixType=hpnicfmplsVpnVrfNetPrefixType, hpnicfmplsVpnVrfBgpNbrAsNumber=hpnicfmplsVpnVrfBgpNbrAsNumber, hpnicfmplsVpnVrfBgpNbrType=hpnicfmplsVpnVrfBgpNbrType, hpnicfmplsVpnConf=hpnicfmplsVpnConf, hpnicfmplsVpnVrfRouteNextHop=hpnicfmplsVpnVrfRouteNextHop, hpnicfmplsVpnVrfRouteTargetEntry=hpnicfmplsVpnVrfRouteTargetEntry)
