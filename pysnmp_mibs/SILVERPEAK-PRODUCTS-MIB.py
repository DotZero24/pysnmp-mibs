...
_SpsECSP_ObjectIdentity = ObjectIdentity
spsECSP = _SpsECSP_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 23867, 1, 2, 59)
)
_SpsECLH_ObjectIdentity = ObjectIdentity
spsECLH = _SpsECLH_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 23867, 1, 2, 60)
)
_SpsECXLH_ObjectIdentity = ObjectIdentity
spsECXLH = _SpsECXLH_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 23867, 1, 2, 61)
)
_SpsECXLH10G_ObjectIdentity = ObjectIdentity
spsECXLH10G = _SpsECXLH10G_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 23867, 1, 2, 62)
)
