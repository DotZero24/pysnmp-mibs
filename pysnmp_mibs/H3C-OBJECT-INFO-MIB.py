# SNMP MIB module (H3C-OBJECT-INFO-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-OBJECT-INFO-MIB
...
h3cObjectInfoType = _H3cObjectInfoType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 55, 1, 1, 1, 2),
...
h3cObjectInfoTypeExtension = _H3cObjectInfoTypeExtension_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 55, 1, 1, 1, 3),
...
h3cObjectInfoValue = _H3cObjectInfoValue_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 55, 1, 1, 1, 4),
...
h3cObjectInfoMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 55, 2, 1, 1)
)
h3cObjectInfoMIBCompliance.setObjects(
    ("H3C-OBJECT-INFO-MIB", "h3cObjectInfoTableGroup")
)
if mibBuilder.loadTexts:
