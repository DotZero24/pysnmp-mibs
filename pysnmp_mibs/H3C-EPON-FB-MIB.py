...
h3cEponFBMIB=_H3cEponFBMIB_ObjectIdentity((1,3,6,1,4,1,2011,10,2,42,6,1))
_H3cEponFBMIBTable_Object=MibTable
h3cEponFBMIBTable=_H3cEponFBMIBTable_Object((1,3,6,1,4,1,2011,10,2,42,6,1,1))
if mibBuilder.loadTexts:h3cEponFBMIBTable.setStatus(_A)
_H3cEponFBMIBEntry_Object=MibTableRow
h3cEponFBMIBEntry=_H3cEponFBMIBEntry_Object((1,3,6,1,4,1,2011,10,2,42,6,1,1,1))
...
h3cEponFBGroupIndex=_H3cEponFBGroupIndex_Object((1,3,6,1,4,1,2011,10,2,42,6,1,1,1,1),_H3cEponFBGroupIndex_Type())
...
h3cEponFBGroupRowStatus=_H3cEponFBGroupRowStatus_Object((1,3,6,1,4,1,2011,10,2,42,6,1,1,1,2),_H3cEponFBGroupRowStatus_Type())
...
h3cEponFBMasterPort=_H3cEponFBMasterPort_Object((1,3,6,1,4,1,2011,10,2,42,6,1,1,1,3),_H3cEponFBMasterPort_Type())
...
h3cEponFBSlavePort=_H3cEponFBSlavePort_Object((1,3,6,1,4,1,2011,10,2,42,6,1,1,1,4),_H3cEponFBSlavePort_Type())
...
h3cEponFBMasterPortStatus=_H3cEponFBMasterPortStatus_Object((1,3,6,1,4,1,2011,10,2,42,6,1,1,1,5),_H3cEponFBMasterPortStatus_Type())
...
h3cEponFBSlavePortStatus=_H3cEponFBSlavePortStatus_Object((1,3,6,1,4,1,2011,10,2,42,6,1,1,1,6),_H3cEponFBSlavePortStatus_Type())
...
h3cEponFBSwitchover=_H3cEponFBSwitchover_Object((1,3,6,1,4,1,2011,10,2,42,6,1,1,1,7),_H3cEponFBSwitchover_Type())
