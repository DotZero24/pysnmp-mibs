...
agentLoopbackGroup=_AgentLoopbackGroup_ObjectIdentity((1,3,6,1,4,1,7244,2,22,1))
_AgentLoopbackTable_Object=MibTable
agentLoopbackTable=_AgentLoopbackTable_Object((1,3,6,1,4,1,7244,2,22,1,1))
if mibBuilder.loadTexts:agentLoopbackTable.setStatus(_A)
_AgentLoopbackEntry_Object=MibTableRow
agentLoopbackEntry=_AgentLoopbackEntry_Object((1,3,6,1,4,1,7244,2,22,1,1,1))
...
agentLoopbackID=_AgentLoopbackID_Object((1,3,6,1,4,1,7244,2,22,1,1,1,1),_AgentLoopbackID_Type())
...
agentLoopbackIfIndex=_AgentLoopbackIfIndex_Object((1,3,6,1,4,1,7244,2,22,1,1,1,2),_AgentLoopbackIfIndex_Type())
...
agentLoopbackIPAddress=_AgentLoopbackIPAddress_Object((1,3,6,1,4,1,7244,2,22,1,1,1,3),_AgentLoopbackIPAddress_Type())
...
agentLoopbackIPSubnet=_AgentLoopbackIPSubnet_Object((1,3,6,1,4,1,7244,2,22,1,1,1,4),_AgentLoopbackIPSubnet_Type())
