# SNMP MIB module (LOOPBACK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/quanta/LOOPBACK-MIB
...
loopback = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 22)
)
