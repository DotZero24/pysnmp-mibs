...
mibBuilder.exportSymbols("LOOPBACK-MIB", agentLoopbackIPSubnet=agentLoopbackIPSubnet, agentLoopbackID=agentLoopbackID, agentLoopbackIfIndex=agentLoopbackIfIndex, agentLoopbackStatus=agentLoopbackStatus, PYSNMP_MODULE_ID=loopback, agentLoopbackTable=agentLoopbackTable, agentLoopbackEntry=agentLoopbackEntry, agentLoopbackIPAddress=agentLoopbackIPAddress, agentLoopbackGroup=agentLoopbackGroup, loopback=loopback)
