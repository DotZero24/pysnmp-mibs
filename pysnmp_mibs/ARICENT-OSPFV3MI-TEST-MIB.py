# SNMP MIB module (ARICENT-OSPFV3MI-TEST-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-OSPFV3MI-TEST-MIB
...
fsMIOspfv3TestIfEntry = _FsMIOspfv3TestIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 1, 1)
)
fsMIOspfv3TestIfEntry.setIndexNames(
    (0, "ARICENT-OSPFV3MI-TEST-MIB", "fsMIOspfv3TestIfIndex"),
)
if mibBuilder.loadTexts:
...
fsMIOspfv3TestIfIndex = _FsMIOspfv3TestIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 1, 1, 1),
...
fsMIOspfv3TestDemandTraffic = _FsMIOspfv3TestDemandTraffic_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 1, 1, 2),
...
fsMIOspfv3TestIfContextId = _FsMIOspfv3TestIfContextId_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 1, 1, 3),
...
fsMIOspfv3ExtRouteEntry = _FsMIOspfv3ExtRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 2, 1)
)
fsMIOspfv3ExtRouteEntry.setIndexNames(
    (0, "ARICENT-MISTDOSPFV3-MIB", "fsMIStdOspfv3ContextId"),
    (0, "ARICENT-OSPFV3MI-TEST-MIB", "fsMIOspfv3ExtRouteDestType"),
    (0, "ARICENT-OSPFV3MI-TEST-MIB", "fsMIOspfv3ExtRouteDest"),
    (0, "ARICENT-OSPFV3MI-TEST-MIB", "fsMIOspfv3ExtRoutePfxLength"),
    (0, "ARICENT-OSPFV3MI-TEST-MIB", "fsMIOspfv3ExtRouteNextHopType"),
    (0, "ARICENT-OSPFV3MI-TEST-MIB", "fsMIOspfv3ExtRouteNextHop"),
)
if mibBuilder.loadTexts:
...
fsMIOspfv3ExtRouteDestType = _FsMIOspfv3ExtRouteDestType_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 2, 1, 1),
...
fsMIOspfv3ExtRouteDest = _FsMIOspfv3ExtRouteDest_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 2, 1, 2),
...
fsMIOspfv3ExtRoutePfxLength = _FsMIOspfv3ExtRoutePfxLength_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 2, 1, 3),
...
fsMIOspfv3ExtRouteNextHopType = _FsMIOspfv3ExtRouteNextHopType_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 2, 1, 4),
...
fsMIOspfv3ExtRouteNextHop = _FsMIOspfv3ExtRouteNextHop_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 2, 1, 5),
...
fsMIOspfv3ExtRouteStatus = _FsMIOspfv3ExtRouteStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 2, 24, 100, 2, 1, 6),
