...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ITP-GACT-MIB
...
ciscoGactMIBCompliance.setObjects(
      *(("CISCO-ITP-GACT-MIB", "ciscoGactMtp3Group"),
        ("CISCO-ITP-GACT-MIB", "ciscoGactGttGroup"))
)
if mibBuilder.loadTexts:
...
ciscoGactMIBComplianceRev1.setObjects(
      *(("CISCO-ITP-GACT-MIB", "ciscoGactMtp3Group"),
        ("CISCO-ITP-GACT-MIB", "ciscoGactGttGroupRev1"))
)
if mibBuilder.loadTexts:
