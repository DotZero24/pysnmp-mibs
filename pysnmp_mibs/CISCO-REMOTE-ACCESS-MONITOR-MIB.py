...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-REMOTE-ACCESS-MONITOR-MIB
...
ModuleIdentity, Integer32, Gauge32, Unsigned32, zeroDotZero, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, ObjectIdentity, MibIdentifier, Counter64, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Gauge32", "Unsigned32", "zeroDotZero", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "Counter64", "Bits", "TimeTicks", "IpAddress")
...
if mibBuilder.loadTexts: ciscoRemoteAccessMonitorMIB.setLastUpdated('202010040000Z')
...
mibBuilder.exportSymbols("CISCO-REMOTE-ACCESS-MONITOR-MIB", ciscoRasMonitorMIBNotifs=ciscoRasMonitorMIBNotifs, crasNumUsers=crasNumUsers, crasSessFailLocalAddrType=crasSessFailLocalAddrType, crasGlobalBwUsage=crasGlobalBwUsage, crasDHCPServer=crasDHCPServer, ciscoRasNotificationCntlGroup=ciscoRasNotificationCntlGroup, crasNumDisabledAccounts=crasNumDisabledAccounts, crasISPAddress=crasISPAddress, crasSecurity=crasSecurity, crasSVCCumulateSessions=crasSVCCumulateSessions, crasSessionOutDropPkts=crasSessionOutDropPkts, crasL2LNumSessions=crasL2LNumSessions, crasIPSecNumSessions=crasIPSecNumSessions, crasSessionOutOctets=crasSessionOutOctets, crasNotifCntl=crasNotifCntl, crasSessFailGroupname=crasSessFailGroupname, crasGlobalOutPkts=crasGlobalOutPkts, crasPrimWINSServer=crasPrimWINSServer, ciscoRasActivityGroupRev1=ciscoRasActivityGroupRev1, crasResourceUsage=crasResourceUsage, ciscoRasTooManySessions=ciscoRasTooManySessions, crasCntlTooManyFailedAuths=crasCntlTooManyFailedAuths, crasFailures=crasFailures, crasGrpFailTable=crasGrpFailTable, crasGrpFailNumResourceFailures=crasGrpFailNumResourceFailures, crasMaxUsersSupportable=crasMaxUsersSupportable, crasSecDNSServerAddrType=crasSecDNSServerAddrType, crasPrimWINSServerAddrType=crasPrimWINSServerAddrType, ciscoRasMandatoryFailureGroup=ciscoRasMandatoryFailureGroup, SessionStatus=SessionStatus, crasSessionCompressionAlgo=crasSessionCompressionAlgo, crasSessionInPkts=crasSessionInPkts, crasFailuresGlobals=crasFailuresGlobals, crasGroup=crasGroup, crasDHCPServerAddrType=crasDHCPServerAddrType, crasThrMaxSessions=crasThrMaxSessions, crasCntlTooManySessions=crasCntlTooManySessions, crasPrimDNSServer=crasPrimDNSServer, crasNumSetupFailInsufResources=crasNumSetupFailInsufResources, UserAuthenMethod=UserAuthenMethod, crasGlobalInOctets=crasGlobalInOctets, crasGrpFailNumDeclined=crasGrpFailNumDeclined, ciscoRemoteAccessMonitorMIB=ciscoRemoteAccessMonitorMIB, crasISPAddressType=crasISPAddressType, crasClientOSVendorString=crasClientOSVendorString, crasSessionPktAuthenAlgo=crasSessionPktAuthenAlgo, crasSessFailTime=crasSessFailTime, crasActGrpOutPkts=crasActGrpOutPkts, crasNumAbortedSessions=crasNumAbortedSessions, crasFailTableSize=crasFailTableSize, ciscoRasActivityGroup=ciscoRasActivityGroup, crasActGrpName=crasActGrpName, SessionIndex=SessionIndex, crasSessionIndex=crasSessionIndex, crasSecDNSServer=crasSecDNSServer, crasNumTotalFailures=crasNumTotalFailures, ciscoRasOptionalFailureGroup=ciscoRasOptionalFailureGroup, ciscoRasGrpActivityGroup=ciscoRasGrpActivityGroup, crasGlobalOutUncompOctets=crasGlobalOutUncompOctets, ciscoRasMonitorMIBComplianceRev1=ciscoRasMonitorMIBComplianceRev1, crasActGrpOutDropPkts=crasActGrpOutDropPkts, crasNumPrevSessions=crasNumPrevSessions, crasLBPeakConcurrentSessions=crasLBPeakConcurrentSessions, crasNumGroups=crasNumGroups, crasAuthorMethod=crasAuthorMethod, crasSecWINSServer=crasSecWINSServer, crasActGrpInOctets=crasActGrpInOctets, crasNumCryptoAccelerators=crasNumCryptoAccelerators, crasCapacity=crasCapacity, SessionAuthAlgo=SessionAuthAlgo, ciscoRasNotificationsGroup=ciscoRasNotificationsGroup, crasSessFailLocalAddr=crasSessFailLocalAddr, crasActGroupEntry=crasActGroupEntry, crasThrMaxFailedAuths=crasThrMaxFailedAuths, crasGrpFailEntry=crasGrpFailEntry, ciscoRasTooManyFailedAuths=ciscoRasTooManyFailedAuths, crasMaxSessionsSupportable=crasMaxSessionsSupportable, crasNumPeakSessions=crasNumPeakSessions, crasEmailNumSessions=crasEmailNumSessions, crasSVCPeakConcurrentSessions=crasSVCPeakConcurrentSessions, SessionEncrAlgo=SessionEncrAlgo, crasHeartbeatInterval=crasHeartbeatInterval, crasSessFailEntry=crasSessFailEntry, crasClientVersionString=crasClientVersionString, crasGlobalInDecompOctets=crasGlobalInDecompOctets, crasFailLastFailIndex=crasFailLastFailIndex, crasEmailPeakConcurrentSessions=crasEmailPeakConcurrentSessions, crasSessionEncryptionAlgo=crasSessionEncryptionAlgo, crasSessFailSessionIndex=crasSessFailSessionIndex, crasWebvpnCumulateSessions=crasWebvpnCumulateSessions, crasSessionInDropPkts=crasSessionInDropPkts, crasGrpFailNumFailAuths=crasGrpFailNumFailAuths, ciscoRasCapacityGroup=ciscoRasCapacityGroup, crasSecWINSServerAddrType=crasSecWINSServerAddrType, crasSessionOutPkts=crasSessionOutPkts, ciscoRasResourceUsageGroup=ciscoRasResourceUsageGroup, ciscoRasThresholdsGroup=ciscoRasThresholdsGroup, crasLocalAddress=crasLocalAddress, ciscoRasTooHighThroughput=ciscoRasTooHighThroughput, crasMaxGroupsSupportable=crasMaxGroupsSupportable, crasSecurityGlobals=crasSecurityGlobals, crasGrpFailNumTerminatedOther=crasGrpFailNumTerminatedOther, crasGlobalOutOctets=crasGlobalOutOctets, crasSessFailures=crasSessFailures, crasNumDeclinedSessions=crasNumDeclinedSessions, crasActGrpInPkts=crasActGrpInPkts, crasCntlTooHighThroughput=crasCntlTooHighThroughput, crasSessFailReason=crasSessFailReason, ciscoRasMonitorMIBGroups=ciscoRasMonitorMIBGroups, crasWebvpnNumSessions=crasWebvpnNumSessions, crasGrpFailGroupname=crasGrpFailGroupname, crasGlobalInPkts=crasGlobalInPkts, ciscoRasSecurityGroup=ciscoRasSecurityGroup, crasSessionProtocol=crasSessionProtocol, FailureRecordIndex=FailureRecordIndex, UserAuthorMethod=UserAuthorMethod, SessionCompressionAlgo=SessionCompressionAlgo, crasSessionInOctets=crasSessionInOctets, crasActGrNumUsers=crasActGrNumUsers, crasIPSecCumulateSessions=crasIPSecCumulateSessions, crasLBNumSessions=crasLBNumSessions, crasThrMaxThroughput=crasThrMaxThroughput, crasL2LCumulateSessions=crasL2LCumulateSessions, crasSessionTable=crasSessionTable, crasSessionDuration=crasSessionDuration, crasSessFailISPAddr=crasSessFailISPAddr, crasSessFailUsername=crasSessFailUsername, crasActGrpOutOctets=crasActGrpOutOctets, crasProtocolElement=crasProtocolElement, crasSessFailIndex=crasSessFailIndex, crasSessFailISPAddrType=crasSessFailISPAddrType, crasGlobalInDropPkts=crasGlobalInDropPkts, PYSNMP_MODULE_ID=ciscoRemoteAccessMonitorMIB, crasAuthenMethod=crasAuthenMethod, ciscoRasMonitorMIBConform=ciscoRasMonitorMIBConform, crasUsername=crasUsername, crasIPSecPeakConcurrentSessions=crasIPSecPeakConcurrentSessions, crasFailGlobalCntl=crasFailGlobalCntl, crasSVCNumSessions=crasSVCNumSessions, crasGroupFailures=crasGroupFailures, crasGrpFailNumTerminatedMgmt=crasGrpFailNumTerminatedMgmt, crasThresholds=crasThresholds, crasActGrpInDropPkts=crasActGrpInDropPkts, crasL2LPeakConcurrentSessions=crasL2LPeakConcurrentSessions, crasSessionEntry=crasSessionEntry, crasActivity=crasActivity, crasClientOSVersionString=crasClientOSVersionString, crasNumSessions=crasNumSessions, crasEmailCumulateSessions=crasEmailCumulateSessions, crasLBCumulateSessions=crasLBCumulateSessions, crasClientVendorString=crasClientVendorString, crasSessionState=crasSessionState, crasPrimDNSServerAddrType=crasPrimDNSServerAddrType, crasSessFailTable=crasSessFailTable, ciscoRasMonitorMIBCompliances=ciscoRasMonitorMIBCompliances, crasSessFailType=crasSessFailType, crasActGroupTable=crasActGroupTable, ciscoRasMonitorMIBCompliance=ciscoRasMonitorMIBCompliance, crasGlobalOutDropPkts=crasGlobalOutDropPkts, RasProtocol=RasProtocol, ciscoRasMonitorMIBObjects=ciscoRasMonitorMIBObjects, crasLocalAddressType=crasLocalAddressType, crasWebvpnPeakConcurrentSessions=crasWebvpnPeakConcurrentSessions)
