# SNMP MIB module (DES7200-DHCP-SNOOPING-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-DHCP-SNOOPING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:49:03 2025
...
mySNDhcpFeatureEnable = _MySNDhcpFeatureEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 1, 1),
...
mySNDhcpDatabaseUpdateInterval = _MySNDhcpDatabaseUpdateInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 1, 2),
...
mySNDhcpRelayAgentInfoOptEnable = _MySNDhcpRelayAgentInfoOptEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 1, 3),
...
mySNDhcpMatchMacAddressEnable = _MySNDhcpMatchMacAddressEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 1, 4),
...
mySNDhcpIfTrustEntry = _MySNDhcpIfTrustEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 1, 1)
)
mySNDhcpIfTrustEntry.setIndexNames(
    (0, "DES7200-DHCP-SNOOPING-MIB", "mySNDhcpIfTrustIndex"),
)
if mibBuilder.loadTexts:
...
mySNDhcpIfTrustIndex = _MySNDhcpIfTrustIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 1, 1, 1),
...
mySNDhcpIfTrustEnable = _MySNDhcpIfTrustEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 1, 1, 2),
...
mySNDhcpIfSuppressionTable = _MySNDhcpIfSuppressionTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 2)
)
if mibBuilder.loadTexts:
...
mySNDhcpIfSuppressionEntry = _MySNDhcpIfSuppressionEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 2, 1)
)
mySNDhcpIfSuppressionEntry.setIndexNames(
    (0, "DES7200-DHCP-SNOOPING-MIB", "mySNDhcpIfSuppressionIndex"),
)
if mibBuilder.loadTexts:
...
mySNDhcpIfSuppressionIndex = _MySNDhcpIfSuppressionIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 2, 1, 1),
...
mySNDhcpIfSuppressionEnable = _MySNDhcpIfSuppressionEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 2, 1, 2),
...
mySNDhcpAddressBindTable = _MySNDhcpAddressBindTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 3)
)
if mibBuilder.loadTexts:
...
mySNDhcpAddressBindEntry = _MySNDhcpAddressBindEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 3, 1)
)
mySNDhcpAddressBindEntry.setIndexNames(
    (0, "DES7200-DHCP-SNOOPING-MIB", "mySNDhcpAddressBindIndex"),
)
if mibBuilder.loadTexts:
...
mySNDhcpAddressBindIndex = _MySNDhcpAddressBindIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 3, 1, 1),
...
mySNDhcpAddressBindEnable = _MySNDhcpAddressBindEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 2, 3, 1, 2),
...
mySNDhcpBindingsEntry = _MySNDhcpBindingsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 3, 1, 1)
)
mySNDhcpBindingsEntry.setIndexNames(
    (0, "DES7200-DHCP-SNOOPING-MIB", "mySNDhcpBindingsVlan"),
    (0, "DES7200-DHCP-SNOOPING-MIB", "mySNDhcpBindingsMacAddress"),
    (0, "DES7200-DHCP-SNOOPING-MIB", "mySNDhcpBindingsAddrType"),
)
if mibBuilder.loadTexts:
...
mySNDhcpBindingsVlan = _MySNDhcpBindingsVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 3, 1, 1, 1),
...
mySNDhcpBindingsMacAddress = _MySNDhcpBindingsMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 3, 1, 1, 2),
...
mySNDhcpBindingsAddrType = _MySNDhcpBindingsAddrType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 3, 1, 1, 3),
...
mySNDhcpBindingsIpAddress = _MySNDhcpBindingsIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 3, 1, 1, 4),
...
mySNDhcpBindingsInterface = _MySNDhcpBindingsInterface_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 3, 1, 1, 5),
...
mySNDhcpBindingsLeasedTime = _MySNDhcpBindingsLeasedTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 3, 1, 1, 6),
...
mySNDhcpBindingsStatus = _MySNDhcpBindingsStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 1, 3, 1, 1, 7),
...
myDhcpSnoopingMIBCompliances = _MyDhcpSnoopingMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 2, 1)
)
_MyDhcpSnoopingMIBGroups_ObjectIdentity = ObjectIdentity
myDhcpSnoopingMIBGroups = _MyDhcpSnoopingMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 2, 2)
)

# Managed Objects groups

myDhcpSnoopingMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 2, 2, 1)
)
myDhcpSnoopingMIBGroup.setObjects(
      *(("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpFeatureEnable"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpDatabaseUpdateInterval"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpRelayAgentInfoOptEnable"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpMatchMacAddressEnable"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpIfTrustEnable"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpIfSuppressionEnable"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpAddressBindEnable"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpBindingsVlan"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpBindingsMacAddress"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpBindingsIpAddress"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpBindingsInterface"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpBindingsLeasedTime"),
        ("DES7200-DHCP-SNOOPING-MIB", "mySNDhcpBindingsStatus"))
)
if mibBuilder.loadTexts:
...
myDhcpSnoopingMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 42, 2, 1, 1)
)
myDhcpSnoopingMIBCompliance.setObjects(
    ("DES7200-DHCP-SNOOPING-MIB", "myDhcpSnoopingMIBGroup")
)
if mibBuilder.loadTexts:
