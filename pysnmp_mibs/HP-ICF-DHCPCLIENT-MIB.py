...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-DHCPCLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:41:15 2025
...
hpicfDhcpClientCompliance.setObjects(
    ("HP-ICF-DHCPCLIENT-MIB", "hpicfDhcpClientOptionsGroup")
)
if mibBuilder.loadTexts:
...
hpicfDhcpClientVendorSpecOptionsCompliance.setObjects(
    ("HP-ICF-DHCPCLIENT-MIB", "hpicfDhcpClientVendorSpecOptionsGroup")
)
if mibBuilder.loadTexts:
...
hpicfDhcpClientAuthCompliance.setObjects(
    ("HP-ICF-DHCPCLIENT-MIB", "hpicfDhcpClientAuthGroup")
)
if mibBuilder.loadTexts:
...
hpicfDhcpv6ClientCompliance.setObjects(
    ("HP-ICF-DHCPCLIENT-MIB", "hpicfDhcpv6ClientGroup")
)
if mibBuilder.loadTexts:
...
hpicfDhcpClientTR069OptionsCompliance.setObjects(
    ("HP-ICF-DHCPCLIENT-MIB", "hpicfDhcpClientTR069OptionsGroup")
)
if mibBuilder.loadTexts:
