...
agentOutboundTelnetGroup=_AgentOutboundTelnetGroup_ObjectIdentity((1,3,6,1,4,1,7244,2,19,1))
...
agentOutboundTelnetAdminMode=_AgentOutboundTelnetAdminMode_Object((1,3,6,1,4,1,7244,2,19,1,1),_AgentOutboundTelnetAdminMode_Type())
...
agentOutboundTelnetMaxNoOfSessions=_AgentOutboundTelnetMaxNoOfSessions_Object((1,3,6,1,4,1,7244,2,19,1,2),_AgentOutboundTelnetMaxNoOfSessions_Type())
...
agentOutboundTelnetTimeout=_AgentOutboundTelnetTimeout_Object((1,3,6,1,4,1,7244,2,19,1,3),_AgentOutboundTelnetTimeout_Type())
agentOutboundTelnetTimeout.setMaxAccess(_B)
if mibBuilder.loadTexts:agentOutboundTelnetTimeout.setStatus(_C)
mibBuilder.exportSymbols('OUTBOUNDTELNET-PRIVATE-MIB',**{'outboundTelnetPrivate':outboundTelnetPrivate,'agentOutboundTelnetGroup':agentOutboundTelnetGroup,'agentOutboundTelnetAdminMode':agentOutboundTelnetAdminMode,'agentOutboundTelnetMaxNoOfSessions':agentOutboundTelnetMaxNoOfSessions,'agentOutboundTelnetTimeout':agentOutboundTelnetTimeout})