...
mibBuilder.exportSymbols("OUTBOUNDTELNET-PRIVATE-MIB", agentOutboundTelnetGroup=agentOutboundTelnetGroup, agentOutboundTelnetTimeout=agentOutboundTelnetTimeout, agentOutboundTelnetMaxNoOfSessions=agentOutboundTelnetMaxNoOfSessions, agentOutboundTelnetAdminMode=agentOutboundTelnetAdminMode, PYSNMP_MODULE_ID=outboundTelnetPrivate, outboundTelnetPrivate=outboundTelnetPrivate)
