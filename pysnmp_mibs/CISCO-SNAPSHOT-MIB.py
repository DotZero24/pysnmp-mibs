...
mibBuilder.exportSymbols("CISCO-SNAPSHOT-MIB", ciscoSnapshotSourceProtocol=ciscoSnapshotSourceProtocol, ciscoSnapshotDialer=ciscoSnapshotDialer, ciscoSnapshotInterfaceTable=ciscoSnapshotInterfaceTable, ciscoSnapshotMIBGroup=ciscoSnapshotMIBGroup, ciscoSnapshotActivityState=ciscoSnapshotActivityState, ciscoSnapshotMIBCompliances=ciscoSnapshotMIBCompliances, ciscoSnapshotMIBCompliance=ciscoSnapshotMIBCompliance, ciscoSnapshotClient=ciscoSnapshotClient, PYSNMP_MODULE_ID=ciscoSnapshotMIB, ciscoSnapshotMIB=ciscoSnapshotMIB, ciscoSnapshotActiveInterval=ciscoSnapshotActiveInterval, ciscoSnapshotMIBObjects=ciscoSnapshotMIBObjects, ciscoSnapshotActivityTable=ciscoSnapshotActivityTable, ciscoSnapshotActivityIndex=ciscoSnapshotActivityIndex, ciscoSnapshotSourceAddress=ciscoSnapshotSourceAddress, ciscoSnapshotActivityTimer=ciscoSnapshotActivityTimer, ciscoSnapshotIfIndex=ciscoSnapshotIfIndex, ciscoSnapshotQuietInterval=ciscoSnapshotQuietInterval, ciscoSnapshotIfUpAction=ciscoSnapshotIfUpAction, ciscoSnapshotProtocolsExchanged=ciscoSnapshotProtocolsExchanged, ciscoSnapshotRetryInterval=ciscoSnapshotRetryInterval, ciscoSnapshotRowStatus=ciscoSnapshotRowStatus, ciscoSnapshotExchangeTimer=ciscoSnapshotExchangeTimer, ciscoSnapshotDialerMap=ciscoSnapshotDialerMap, ciscoSnapshotForceActive=ciscoSnapshotForceActive, ciscoSnapshotMIBGroups=ciscoSnapshotMIBGroups, ciscoSnapshotMIBConformance=ciscoSnapshotMIBConformance, ciscoSnapshotActivityEntry=ciscoSnapshotActivityEntry, ciscoSnapshotInterfaceEntry=ciscoSnapshotInterfaceEntry)
