...
lumModules, lumBackupMIB = mibBuilder.importSymbols("LUM-REG", "lumModules", "lumBackupMIB")
...
mibBuilder.exportSymbols("LUM-BACKUP-MIB", backupCommandResult=backupCommandResult, backupGeneral=backupGeneral, backupUploadResult=backupUploadResult, lumBackupBasicComplV11=lumBackupBasicComplV11, backupFileDescr=backupFileDescr, backupFileUrl=backupFileUrl, backupUploadAction=backupUploadAction, backupPersistentFileIndex=backupPersistentFileIndex, backupUploadServerPath=backupUploadServerPath, backupGeneralMibSpecVersion=backupGeneralMibSpecVersion, backupPersistentFileGroup=backupPersistentFileGroup, backupUploadUploadNow=backupUploadUploadNow, backupGeneralGroupV7=backupGeneralGroupV7, backupCommandAction=backupCommandAction, backupCommandDescr=backupCommandDescr, backupSftpUploadBackupEntityCrc=backupSftpUploadBackupEntityCrc, backupCommandGroup=backupCommandGroup, backupSftpUpload=backupSftpUpload, backupFileAdminStatus=backupFileAdminStatus, lumBackupBasicComplV6=lumBackupBasicComplV6, backupGeneralTestAndIncr=backupGeneralTestAndIncr, backupFileIndex=backupFileIndex, backupGeneralPrimaryFileName=backupGeneralPrimaryFileName, backupPersistentFileTable=backupPersistentFileTable, backupFileGroup=backupFileGroup, lumBackupBasicComplV8=lumBackupBasicComplV8, backupUploadFailure=backupUploadFailure, backupFileTable=backupFileTable, backupGeneralWarnUnsavedDelay=backupGeneralWarnUnsavedDelay, backupSftpUploadBackupEntityFilePath=backupSftpUploadBackupEntityFilePath, backupUploadLastChangeTime=backupUploadLastChangeTime, backupGeneralBackupScheme=backupGeneralBackupScheme, backupSftpUploadGroup=backupSftpUploadGroup, lumBackupBasicComplV2=lumBackupBasicComplV2, backupGeneralGroupV5=backupGeneralGroupV5, backupFileGroupV2=backupFileGroupV2, lumBackupMinimalCompl=lumBackupMinimalCompl, backupSftpUploadRestoreEntityRestoreNow=backupSftpUploadRestoreEntityRestoreNow, lumBackupConfs=lumBackupConfs, backupSftpUploadMinimalGroupV1=backupSftpUploadMinimalGroupV1, backupGeneralGroupV4=backupGeneralGroupV4, lumBackupMinimalComplV3=lumBackupMinimalComplV3, backupPersistentFileDescr=backupPersistentFileDescr, backupUploadGroupV2=backupUploadGroupV2, lumBackupBasicComplV9=lumBackupBasicComplV9, backupGeneralGroupV3=backupGeneralGroupV3, lumBackupBasicComplV3=lumBackupBasicComplV3, backupGeneralInstallConfigFile=backupGeneralInstallConfigFile, lumBackupBasicComplV4=lumBackupBasicComplV4, backupFileEntry=backupFileEntry, lumBackupBasicComplV10=lumBackupBasicComplV10, backupGeneralGroupV8=backupGeneralGroupV8, lumBackupMinimalComplV1=lumBackupMinimalComplV1, lumBackupBasicComplV1=lumBackupBasicComplV1, backupSftpUploadBackupEntityCompressionTimestamp=backupSftpUploadBackupEntityCompressionTimestamp, lumBackupBasicComplV12=lumBackupBasicComplV12, lumBackupBasicComplV7=lumBackupBasicComplV7, lumBackupCompl=lumBackupCompl, backupGeneralFileTableSize=backupGeneralFileTableSize, backupCommandName=backupCommandName, backupPersistentFileList=backupPersistentFileList, lumBackupBasicComplV5=lumBackupBasicComplV5, backupFileLastChangeTime=backupFileLastChangeTime, backupGeneralGroupV9=backupGeneralGroupV9, backupFileList=backupFileList, backupUploadNextTime=backupUploadNextTime, backupGeneralLastChangeTime=backupGeneralLastChangeTime, backupGeneralMibImplVersion=backupGeneralMibImplVersion, backupUploadGroup=backupUploadGroup, backupSftpUploadBackupEntityAvailability=backupSftpUploadBackupEntityAvailability, backupUploadTimeHour=backupUploadTimeHour, backupGeneralGroupV2=backupGeneralGroupV2, backupGeneralPersistentFileTableSize=backupGeneralPersistentFileTableSize, lumBackupBasicComplV13=lumBackupBasicComplV13, backupGeneralMinimalGroupV1=backupGeneralMinimalGroupV1, backupGeneralWarnForUnsaved=backupGeneralWarnForUnsaved, backupPersistentFileName=backupPersistentFileName, backupPersistentFileEntry=backupPersistentFileEntry, backupSftpUploadGroupV2=backupSftpUploadGroupV2, backupGeneralUnsavedChanges=backupGeneralUnsavedChanges, backupGeneralGroupV6=backupGeneralGroupV6, backupFileOperStatus=backupFileOperStatus, backupUploadInstallUploadFile=backupUploadInstallUploadFile, backupGeneralUnsavedChangesAlarm=backupGeneralUnsavedChangesAlarm, backupUploadStatus=backupUploadStatus, backupFileName=backupFileName, backupSftpUploadMinimalGroupV2=backupSftpUploadMinimalGroupV2, backupSftpUploadRestoreEntityAction=backupSftpUploadRestoreEntityAction, backupGeneralSavedConfigurationGenerationId=backupGeneralSavedConfigurationGenerationId, lumBackupBasicComplV14=lumBackupBasicComplV14, PYSNMP_MODULE_ID=lumBackupMIBModule, backupGeneralGroup=backupGeneralGroup, lumBackupMinimalGroups=lumBackupMinimalGroups, backupUpload=backupUpload, lumBackupMinimalComplV4=lumBackupMinimalComplV4, backupCommand=backupCommand, backupGeneralGlobalStateLastChangeTime=backupGeneralGlobalStateLastChangeTime, backupGeneralGlobalConfigLastChangeTime=backupGeneralGlobalConfigLastChangeTime, backupCommandAdminStatus=backupCommandAdminStatus, backupUploadLocalFile=backupUploadLocalFile, lumBackupMinimalComplV2=lumBackupMinimalComplV2, lumBackupMIBModule=lumBackupMIBModule, backupFileRowStatus=backupFileRowStatus, backupUploadGroupV3=backupUploadGroupV3, lumBackupGroups=lumBackupGroups, backupGeneralConfigLastChangeTime=backupGeneralConfigLastChangeTime, backupUploadServerAddr=backupUploadServerAddr, backupSftpUploadRestoreEntityFilePath=backupSftpUploadRestoreEntityFilePath, backupUploadMinimalGroupV1=backupUploadMinimalGroupV1, lumBackupMIBObjects=lumBackupMIBObjects)
