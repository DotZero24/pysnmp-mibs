...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:16:58 2025
...
mibBuilder.exportSymbols("LanMgr-Mib-II-MIB", svSvcCanBePaused=svSvcCanBePaused, useRemote=useRemote, svDescription=svDescription, svSesState=svSesState, svPrintQName=svPrintQName, svStatPermErrors=svStatPermErrors, svStatAvResponse=svStatAvResponse, svShareName=svShareName, svSessionTable=svSessionTable, svUsers=svUsers, svAuditLogSize=svAuditLogSize, svPrintQNumber=svPrintQNumber, wkstaStatUses=wkstaStatUses, domLogonNumber=domLogonNumber, svStatBigBufsNeeded=svStatBigBufsNeeded, svSharePath=svSharePath, svShareEntry=svShareEntry, svStatDevOpens=svStatDevOpens, domServerTable=domServerTable, svSessionNumber=svSessionNumber, comStatStart=comStatStart, wkstaStatSessFails=wkstaStatSessFails, domLogonMachine=domLogonMachine, domOtherDomainNumber=domOtherDomainNumber, domOtherDomainTable=domOtherDomainTable, svStatReqBufsNeeded=svStatReqBufsNeeded, svAutoDisconnects=svAutoDisconnects, lanmanager=lanmanager, svStatSOpens=svStatSOpens, domOtherDomainEntry=domOtherDomainEntry, svPrintQTable=svPrintQTable, svSesClientType=svSesClientType, svShareTable=svShareTable, comStatFiNetIOs=comStatFiNetIOs, svSvcEntry=svSvcEntry, svUserNumber=svUserNumber, svUserEntry=svUserEntry, svSecurityMode=svSecurityMode, domLogonUser=domLogonUser, wkstaStatSessStarts=wkstaStatSessStarts, wkstaUseTable=wkstaUseTable, svStatSysErrors=svStatSysErrors, svStatRcvdBytes=svStatRcvdBytes, svUserName=svUserName, svPrintQEntry=svPrintQEntry, wkstaStatUseFails=wkstaStatUseFails, comStatNumNetIOs=comStatNumNetIOs, domServerName=domServerName, svStatQueuedJobs=svStatQueuedJobs, domServerNumber=domServerNumber, svSvcCanBeUninstalled=svSvcCanBeUninstalled, svShareNumber=svShareNumber, comVersionMin=comVersionMin, svSesClientName=svSesClientName, svSesNumOpens=svSesNumOpens, svSvcInstalledState=svSvcInstalledState, svStatOpens=svStatOpens, wkstaStatAutoRecs=wkstaStatAutoRecs, wkstaUseNumber=wkstaUseNumber, svStatErrorOuts=svStatErrorOuts, domLogonEntry=domLogonEntry, svShareComment=svShareComment, comStatFcNetIOs=comStatFcNetIOs, svSvcName=svSvcName, common=common, svSvcOperatingState=svSvcOperatingState, wkstaErrorLogSize=wkstaErrorLogSize, domain=domain, wkstaUseEntry=wkstaUseEntry, svSvcTable=svSvcTable, svStatSentBytes=svStatSentBytes, workstation=workstation, svSvcNumber=svSvcNumber, svDisConTime=svDisConTime, domPrimaryDomain=domPrimaryDomain, svStatPwErrors=svStatPwErrors, server=server, domLogonDomain=domLogonDomain, svSesIdleTime=svSesIdleTime, domOtherName=domOtherName, useLocalName=useLocalName, svSesTime=svSesTime, svSesUserName=svSesUserName, lanmgr_2=lanmgr_2, domLogonTable=domLogonTable, svUserTable=svUserTable, svPrintQNumJobs=svPrintQNumJobs, svSessionEntry=svSessionEntry, comVersionMaj=comVersionMaj, useStatus=useStatus, comType=comType, domServerEntry=domServerEntry)
