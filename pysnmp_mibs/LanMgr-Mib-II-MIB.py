...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/microsoft/LanMgr-Mib-II-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:07:45 2025
...
mibBuilder.exportSymbols("LanMgr-Mib-II-MIB", common=common, lanmanager=lanmanager, svUserEntry=svUserEntry, svStatDevOpens=svStatDevOpens, svSvcTable=svSvcTable, lanmgr_2=lanmgr_2, svSvcName=svSvcName, svSesState=svSesState, comType=comType, useRemote=useRemote, domLogonDomain=domLogonDomain, svPrintQNumJobs=svPrintQNumJobs, server=server, svShareEntry=svShareEntry, svUserName=svUserName, workstation=workstation, svPrintQName=svPrintQName, comVersionMaj=comVersionMaj, svStatSOpens=svStatSOpens, svStatPermErrors=svStatPermErrors, svSvcInstalledState=svSvcInstalledState, svShareName=svShareName, svStatAvResponse=svStatAvResponse, wkstaUseNumber=wkstaUseNumber, svShareComment=svShareComment, svPrintQTable=svPrintQTable, svStatRcvdBytes=svStatRcvdBytes, svPrintQNumber=svPrintQNumber, useLocalName=useLocalName, svDisConTime=svDisConTime, domServerEntry=domServerEntry, svSvcOperatingState=svSvcOperatingState, wkstaStatAutoRecs=wkstaStatAutoRecs, domServerName=domServerName, svAutoDisconnects=svAutoDisconnects, domLogonUser=domLogonUser, svSvcCanBeUninstalled=svSvcCanBeUninstalled, svSesNumOpens=svSesNumOpens, svPrintQEntry=svPrintQEntry, comStatFcNetIOs=comStatFcNetIOs, domLogonEntry=domLogonEntry, domServerNumber=domServerNumber, svStatSentBytes=svStatSentBytes, svSesClientType=svSesClientType, comStatNumNetIOs=comStatNumNetIOs, domLogonNumber=domLogonNumber, comVersionMin=comVersionMin, svSesUserName=svSesUserName, wkstaStatUses=wkstaStatUses, svUserTable=svUserTable, wkstaStatSessStarts=wkstaStatSessStarts, svSecurityMode=svSecurityMode, wkstaUseTable=wkstaUseTable, domOtherDomainNumber=domOtherDomainNumber, svShareTable=svShareTable, wkstaStatUseFails=wkstaStatUseFails, svStatPwErrors=svStatPwErrors, wkstaStatSessFails=wkstaStatSessFails, domOtherDomainTable=domOtherDomainTable, svStatBigBufsNeeded=svStatBigBufsNeeded, svSesTime=svSesTime, domOtherDomainEntry=domOtherDomainEntry, domLogonTable=domLogonTable, domain=domain, svSesClientName=svSesClientName, domServerTable=domServerTable, svDescription=svDescription, wkstaErrorLogSize=wkstaErrorLogSize, svUserNumber=svUserNumber, svShareNumber=svShareNumber, wkstaUseEntry=wkstaUseEntry, domOtherName=domOtherName, svSessionEntry=svSessionEntry, svSvcCanBePaused=svSvcCanBePaused, svSessionNumber=svSessionNumber, svSessionTable=svSessionTable, useStatus=useStatus, svAuditLogSize=svAuditLogSize, domLogonMachine=domLogonMachine, svStatReqBufsNeeded=svStatReqBufsNeeded, comStatStart=comStatStart, svStatErrorOuts=svStatErrorOuts, svSvcEntry=svSvcEntry, svSvcNumber=svSvcNumber, svSharePath=svSharePath, svStatOpens=svStatOpens, svStatQueuedJobs=svStatQueuedJobs, domPrimaryDomain=domPrimaryDomain, svSesIdleTime=svSesIdleTime, svStatSysErrors=svStatSysErrors, svUsers=svUsers, comStatFiNetIOs=comStatFiNetIOs)
