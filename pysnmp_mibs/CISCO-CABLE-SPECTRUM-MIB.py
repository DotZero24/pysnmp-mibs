...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CABLE-SPECTRUM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:56 2025
...
_CcsSpectrumRequestMacAddr_Type.__name__ = "MacAddress"
...
_CcsSpectrumRequestLowFreq_Type.__name__ = "CCSFrequency"
...
_CcsSpectrumRequestUpperFreq_Type.__name__ = "CCSFrequency"
...
_CcsSpectrumRequestOperation_Type.__name__ = "CCSRequestOperation"
...
_CcsSNRRequestOperation_Type.__name__ = "CCSRequestOperation"
...
_CcsUpSpecMgmtSpecGroup_Type.__name__ = "Unsigned32"
...
_CcsUpSpecMgmtSharedSpectrum_Type.__name__ = "Unsigned32"
...
ccsCompliance.setObjects(
    ("CISCO-CABLE-SPECTRUM-MIB", "ccsFlapGroup")
)
if mibBuilder.loadTexts:
...
ccsCompliance2.setObjects(
      *(("CISCO-CABLE-SPECTRUM-MIB", "ccsFlapGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsSpectrumGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsUpSpecMgmtGroup"))
)
if mibBuilder.loadTexts:
...
ccsCompliance3.setObjects(
      *(("CISCO-CABLE-SPECTRUM-MIB", "ccsFlapGroupRev1"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsSpectrumGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsUpSpecMgmtGroup"))
)
if mibBuilder.loadTexts:
...
ccsCompliance4.setObjects(
      *(("CISCO-CABLE-SPECTRUM-MIB", "ccsFlapGroupRev1"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsSpectrumGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsNotificationGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsUpSpecMgmtGroupRev1"))
)
if mibBuilder.loadTexts:
...
ccsCompliance5.setObjects(
      *(("CISCO-CABLE-SPECTRUM-MIB", "ccsFlapGroupRev2"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsSpectrumGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsNotificationGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsUpSpecMgmtGroupRev2"))
)
if mibBuilder.loadTexts:
...
ccsCompliance6.setObjects(
      *(("CISCO-CABLE-SPECTRUM-MIB", "ccsFlapGroupRev2"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsSpectrumGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsNotificationGroupRev1"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsUpSpecMgmtGroupRev3"))
)
if mibBuilder.loadTexts:
...
ccsCompliance7.setObjects(
      *(("CISCO-CABLE-SPECTRUM-MIB", "ccsFlapGroupRev2"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsSpectrumGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsNotificationGroupRev1"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsUpSpecMgmtGroupRev4"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsSpecGroupFreqGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsUpInSpecGroupGroup"),
        ("CISCO-CABLE-SPECTRUM-MIB", "ccsUpInFiberNodeGroup"))
)
if mibBuilder.loadTexts:
