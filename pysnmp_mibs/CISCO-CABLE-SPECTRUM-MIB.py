...
mibBuilder.exportSymbols("CISCO-CABLE-SPECTRUM-MIB", ccsSpecMgmtNotification=ccsSpecMgmtNotification, ccsUpSpecMgmtToCenterFreq=ccsUpSpecMgmtToCenterFreq, ccsSpectrumRequestUpperFreq=ccsSpectrumRequestUpperFreq, ccsSNRRequestIndex=ccsSNRRequestIndex, ccsSpecGroupFreqEntry=ccsSpecGroupFreqEntry, ccsUpSpecMgmtSharedSpectrum=ccsUpSpecMgmtSharedSpectrum, ccsUpInSpecGroupTable=ccsUpInSpecGroupTable, ccsUpSpecMgmtSnrThres1=ccsUpSpecMgmtSnrThres1, ccsSpectrumGroup=ccsSpectrumGroup, ccsCmFlapLastFlapTime=ccsCmFlapLastFlapTime, ccsFiberNodeNumber=ccsFiberNodeNumber, ccsCompliance6=ccsCompliance6, ccsCompliance3=ccsCompliance3, ccsSNRRequestStartTime=ccsSNRRequestStartTime, ccsSpecGroupUpstreamStorage=ccsSpecGroupUpstreamStorage, ciscoCableSpectrumMIB=ciscoCableSpectrumMIB, ccsUpSpecMgmtCnrThres2=ccsUpSpecMgmtCnrThres2, ccsSpectrumObjects=ccsSpectrumObjects, ccsSpecGroupStorage=ccsSpecGroupStorage, ccsSpecGroupUpstreamIfIndex=ccsSpecGroupUpstreamIfIndex, ccsFlapListMaxSize=ccsFlapListMaxSize, ccsCmFlapTable=ccsCmFlapTable, ccsCompliance=ccsCompliance, ccsSpecGroupFreqUpper=ccsSpecGroupFreqUpper, ccsFlapGroup=ccsFlapGroup, ccsSNRRequestStatus=ccsSNRRequestStatus, ccsUpInFiberNodeEntry=ccsUpInFiberNodeEntry, ccsCompliance7=ccsCompliance7, ccsCmFlapRowStatus=ccsCmFlapRowStatus, ccsFlapDownstreamIfIndex=ccsFlapDownstreamIfIndex, ccsUpSpecMgmtToBandWidth=ccsUpSpecMgmtToBandWidth, ccsUpSpecMgmtGroup=ccsUpSpecMgmtGroup, ccsSpecGroupFreqLower=ccsSpecGroupFreqLower, ccsNotificationGroupRev1=ccsNotificationGroupRev1, ccsFlapGroupRev1=ccsFlapGroupRev1, ccsUpSpecMgmtHopPeriod=ccsUpSpecMgmtHopPeriod, ccsSpectrumDataPower=ccsSpectrumDataPower, ccsFlapAging=ccsFlapAging, ccsFlapHits=ccsFlapHits, ccsSpectrumRequestMacAddr=ccsSpectrumRequestMacAddr, ccsFlapMissNum=ccsFlapMissNum, ccsCompliance4=ccsCompliance4, ccsSNRRequestOperState=ccsSNRRequestOperState, ccsFlapCrcErrorNum=ccsFlapCrcErrorNum, ccsSNRRequestSNR=ccsSNRRequestSNR, ccsFlapInsertionFailNum=ccsFlapInsertionFailNum, ccsSpectrumRequestOperation=ccsSpectrumRequestOperation, ccsCompliance5=ccsCompliance5, ccsUpInSpecGroupEntry=ccsUpInSpecGroupEntry, ccsUpSpecMgmtSpecGroup=ccsUpSpecMgmtSpecGroup, ccsFlapMisses=ccsFlapMisses, ccsUpSpecMgmtCNR=ccsUpSpecMgmtCNR, ccsSpectrumRequestEntry=ccsSpectrumRequestEntry, ccsUpSpecMgmtFecCorrectThres1=ccsUpSpecMgmtFecCorrectThres1, ccsMIBNotifications=ccsMIBNotifications, ccsSpectrumDataTable=ccsSpectrumDataTable, ccsFlapUpstreamIfIndex=ccsFlapUpstreamIfIndex, ccsSpecGroupNumber=ccsSpecGroupNumber, ccsUpSpecMgmtHopPriority=ccsUpSpecMgmtHopPriority, ccsSpectrumRequestResolution=ccsSpectrumRequestResolution, ccsFlapLastClearTime=ccsFlapLastClearTime, ccsSpecGroupFreqIndex=ccsSpecGroupFreqIndex, ccsFlapPowerAdjustThreshold=ccsFlapPowerAdjustThreshold, ccsUpSpecMgmtFromBandWidth=ccsUpSpecMgmtFromBandWidth, ccsCmFlapCreateTime=ccsCmFlapCreateTime, ccsUpSpecMgmtToModProfile=ccsUpSpecMgmtToModProfile, ccsSpectrumDataEntry=ccsSpectrumDataEntry, ccsUpSpecMgmtHopCondition=ccsUpSpecMgmtHopCondition, ccsFlapClearAll=ccsFlapClearAll, ccsUpSpecMgmtGroupRev2=ccsUpSpecMgmtGroupRev2, ccsCmFlapCrcErrorNum=ccsCmFlapCrcErrorNum, ccsFiberNodeUpstreamRowStatus=ccsFiberNodeUpstreamRowStatus, ccsNotificationGroup=ccsNotificationGroup, ccsFiberNodeUpstreamIfIndex=ccsFiberNodeUpstreamIfIndex, ccsCmFlapMissNum=ccsCmFlapMissNum, ccsFlapTable=ccsFlapTable, ccsUpSpecMgmtSnrPollPeriod=ccsUpSpecMgmtSnrPollPeriod, ccsUpSpecMgmtGroupRev3=ccsUpSpecMgmtGroupRev3, CCSRequestOperState=CCSRequestOperState, ccsFlapEntry=ccsFlapEntry, ccsUpSpecMgmtFecUnCorrectThres2=ccsUpSpecMgmtFecUnCorrectThres2, ccsSpectrumRequestIndex=ccsSpectrumRequestIndex, ccsUpSpecMgmtSnrThres2=ccsUpSpecMgmtSnrThres2, ccsSNRRequestStoppedTime=ccsSNRRequestStoppedTime, ccsUpSpecMgmtTable=ccsUpSpecMgmtTable, ccsCmFlapUpstreamIfIndex=ccsCmFlapUpstreamIfIndex, ccsCmFlapLastResetTime=ccsCmFlapLastResetTime, ccsUpSpecMgmtCnrThres1=ccsUpSpecMgmtCnrThres1, ccsUpInSpecGroupGroup=ccsUpInSpecGroupGroup, ccsFlapLastResetTime=ccsFlapLastResetTime, ccsUpSpecMgmtFecUnCorrectThres1=ccsUpSpecMgmtFecUnCorrectThres1, ciscoCableSpectrumMIBConformance=ciscoCableSpectrumMIBConformance, ccsCmFlapPowerAdjustmentNum=ccsCmFlapPowerAdjustmentNum, ccsUpInFiberNodeTable=ccsUpInFiberNodeTable, ccsSpecGroupUpstreamRowStatus=ccsSpecGroupUpstreamRowStatus, ccsSpectrumRequestStoppedTime=ccsSpectrumRequestStoppedTime, ccsUpSpecMgmtGroupRev1=ccsUpSpecMgmtGroupRev1, ciscoCableSpectrumMIBObjects=ciscoCableSpectrumMIBObjects, ciscoCableSpectrumMIBGroups=ciscoCableSpectrumMIBGroups, ccsUpSpecMgmtMissedMaintMsgThres=ccsUpSpecMgmtMissedMaintMsgThres, ccsFlapCrcErrors=ccsFlapCrcErrors, ccsUpSpecMgmtGroupRev4=ccsUpSpecMgmtGroupRev4, ccsSpecGroupFreqTable=ccsSpecGroupFreqTable, ccsSNRRequestTable=ccsSNRRequestTable, ccsFlapObjects=ccsFlapObjects, ccsCmFlapInsertionFailNum=ccsCmFlapInsertionFailNum, ccsUpSpecMgmtSNR=ccsUpSpecMgmtSNR, ccsFlapResetAll=ccsFlapResetAll, PYSNMP_MODULE_ID=ciscoCableSpectrumMIB, ccsCompliance2=ccsCompliance2, ccsCmFlapMacAddr=ccsCmFlapMacAddr, ccsFiberNodeUpstreamStorage=ccsFiberNodeUpstreamStorage, ccsSNRRequestMacAddr=ccsSNRRequestMacAddr, ccsSpecGroupFreqType=ccsSpecGroupFreqType, ccsSpectrumRequestLowFreq=ccsSpectrumRequestLowFreq, ccsFlapTotalNum=ccsFlapTotalNum, ccsSNRRequestEntry=ccsSNRRequestEntry, ccsCmFlapTotalNum=ccsCmFlapTotalNum, ccsUpSpecMgmtFromCenterFreq=ccsUpSpecMgmtFromCenterFreq, ccsFlapLastFlapTime=ccsFlapLastFlapTime, ccsFlapGroupRev2=ccsFlapGroupRev2, ccsSpectrumRequestStatus=ccsSpectrumRequestStatus, ccsSpectrumRequestIfIndex=ccsSpectrumRequestIfIndex, ccsFlapRowStatus=ccsFlapRowStatus, ccsSpectrumRequestTable=ccsSpectrumRequestTable, ccsUpSpecMgmtEntry=ccsUpSpecMgmtEntry, ccsConfigObjects=ccsConfigObjects, ccsFlapListCurrentSize=ccsFlapListCurrentSize, ccsUpSpecMgmtFromModProfile=ccsUpSpecMgmtFromModProfile, ccsFlapResetNow=ccsFlapResetNow, ccsCmFlapHitNum=ccsCmFlapHitNum, ccsCmFlapEntry=ccsCmFlapEntry, ccsSpectrumDataFreq=ccsSpectrumDataFreq, CCSMeasuredFrequency=CCSMeasuredFrequency, ccsCmFlapDownstreamIfIndex=ccsCmFlapDownstreamIfIndex, ccsFlapPowerAdjustmentNum=ccsFlapPowerAdjustmentNum, ccsFlapTotal=ccsFlapTotal, ccsCmFlapResetNow=ccsCmFlapResetNow, ccsFlapCreateTime=ccsFlapCreateTime, CCSFrequency=CCSFrequency, ccsUpSpecMgmtCriteria=ccsUpSpecMgmtCriteria, ccsSNRRequestOperation=ccsSNRRequestOperation, ciscoCableSpectrumMIBNotificationPrefix=ciscoCableSpectrumMIBNotificationPrefix, ccsFlapHitNum=ccsFlapHitNum, ccsFlapMissThreshold=ccsFlapMissThreshold, ccsSpecGroupRowStatus=ccsSpecGroupRowStatus, ccsSpecGroupFreqGroup=ccsSpecGroupFreqGroup, ccsSpectrumRequestOperState=ccsSpectrumRequestOperState, ccsUpInFiberNodeGroup=ccsUpInFiberNodeGroup, ccsHoppingNotification=ccsHoppingNotification, ccsUpSpecMgmtUpperBoundFreq=ccsUpSpecMgmtUpperBoundFreq, ccsFlapInsertionTime=ccsFlapInsertionTime, CCSRequestOperation=CCSRequestOperation, ccsUpSpecMgmtFecCorrectThres2=ccsUpSpecMgmtFecCorrectThres2, ccsFlapPowerAdjustments=ccsFlapPowerAdjustments, ciscoCableSpectrumMIBCompliances=ciscoCableSpectrumMIBCompliances, ccsFlapInsertionFails=ccsFlapInsertionFails, ccsSpectrumRequestStartTime=ccsSpectrumRequestStartTime, ccsFlapMacAddr=ccsFlapMacAddr)
