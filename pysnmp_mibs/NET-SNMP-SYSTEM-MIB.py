...
mibBuilder.exportSymbols("NET-SNMP-SYSTEM-MIB", netSnmpSystemMIB=netSnmpSystemMIB, nsLoad=nsLoad, nsSwap=nsSwap, nsDiskIO=nsDiskIO, PYSNMP_MODULE_ID=netSnmpSystemMIB, nsCPU=nsCPU, nsMemory=nsMemory)
