...
# Notes
# -----
# ASN.1 source file://mibs/dell/DNOS-PORTSECURITY-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:07:37 2025
...
class _AgentPortSecurityAgingTime_Type(Unsigned32):
    """Custom type agentPortSecurityAgingTime based on Unsigned32"""
    defaultValue = 5
...
_AgentPortSecurityAgingTime_Type.__name__ = "Unsigned32"
_AgentPortSecurityAgingTime_Object = MibTableColumn
agentPortSecurityAgingTime = _AgentPortSecurityAgingTime_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 20, 1, 2, 1, 12),
    _AgentPortSecurityAgingTime_Type()
)
agentPortSecurityAgingTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agentPortSecurityAgingTime.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"fastPathPortSecurity": fastPathPortSecurity,
       ...
       "agentPortSecurityAgingTime": agentPortSecurityAgingTime,
