...
_J='DNOS-PORTSECURITY-PRIVATE-MIB'
_I='read-only'
_H='Unsigned32'
_G='ifIndex'
_F='IF-MIB'
...
if mibBuilder.loadTexts:fastPathPortSecurity.setRevisions(('2021-12-14 00:00','2011-01-26 00:00','2007-05-23 00:00'))
_AgentPortSecurityGroup_ObjectIdentity=ObjectIdentity
agentPortSecurityGroup=_AgentPortSecurityGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1))
...
agentGlobalPortSecurityMode=_AgentGlobalPortSecurityMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,1),_AgentGlobalPortSecurityMode_Type())
...
agentPortSecurityTable=_AgentPortSecurityTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2))
if mibBuilder.loadTexts:agentPortSecurityTable.setStatus(_A)
_AgentPortSecurityEntry_Object=MibTableRow
agentPortSecurityEntry=_AgentPortSecurityEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1))
...
agentPortSecurityMode=_AgentPortSecurityMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,1),_AgentPortSecurityMode_Type())
...
_AgentPortSecurityDynamicLimit_Type.__name__=_H
_AgentPortSecurityDynamicLimit_Object=MibTableColumn
agentPortSecurityDynamicLimit=_AgentPortSecurityDynamicLimit_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,2),_AgentPortSecurityDynamicLimit_Type())
...
_AgentPortSecurityStaticLimit_Type.__name__=_H
_AgentPortSecurityStaticLimit_Object=MibTableColumn
agentPortSecurityStaticLimit=_AgentPortSecurityStaticLimit_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,3),_AgentPortSecurityStaticLimit_Type())
...
agentPortSecurityViolationTrapMode=_AgentPortSecurityViolationTrapMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,4),_AgentPortSecurityViolationTrapMode_Type())
...
agentPortSecurityStaticMACs=_AgentPortSecurityStaticMACs_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,6),_AgentPortSecurityStaticMACs_Type())
agentPortSecurityStaticMACs.setMaxAccess(_I)
...
agentPortSecurityLastDiscardedMAC=_AgentPortSecurityLastDiscardedMAC_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,7),_AgentPortSecurityLastDiscardedMAC_Type())
agentPortSecurityLastDiscardedMAC.setMaxAccess(_I)
...
agentPortSecurityMACAddressAdd=_AgentPortSecurityMACAddressAdd_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,8),_AgentPortSecurityMACAddressAdd_Type())
...
agentPortSecurityMACAddressRemove=_AgentPortSecurityMACAddressRemove_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,9),_AgentPortSecurityMACAddressRemove_Type())
...
agentPortSecurityMACAddressMove=_AgentPortSecurityMACAddressMove_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,10),_AgentPortSecurityMACAddressMove_Type())
...
agentPortSecurityStickyMode=_AgentPortSecurityStickyMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,11),_AgentPortSecurityStickyMode_Type())
agentPortSecurityStickyMode.setMaxAccess(_B)
if mibBuilder.loadTexts:agentPortSecurityStickyMode.setStatus(_A)
class _AgentPortSecurityAgingTime_Type(Unsigned32):defaultValue=5;subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,1440))
_AgentPortSecurityAgingTime_Type.__name__=_H
_AgentPortSecurityAgingTime_Object=MibTableColumn
agentPortSecurityAgingTime=_AgentPortSecurityAgingTime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,2,1,12),_AgentPortSecurityAgingTime_Type())
agentPortSecurityAgingTime.setMaxAccess(_B)
if mibBuilder.loadTexts:agentPortSecurityAgingTime.setStatus(_A)
_AgentPortSecurityDynamicTable_Object=MibTable
agentPortSecurityDynamicTable=_AgentPortSecurityDynamicTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,3))
if mibBuilder.loadTexts:agentPortSecurityDynamicTable.setStatus(_A)
_AgentPortSecurityDynamicEntry_Object=MibTableRow
agentPortSecurityDynamicEntry=_AgentPortSecurityDynamicEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,3,1))
agentPortSecurityDynamicEntry.setIndexNames((0,_F,_G),(0,_J,_K),(0,_J,_L))
...
agentPortSecurityDynamicVLANId=_AgentPortSecurityDynamicVLANId_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,3,1,1),_AgentPortSecurityDynamicVLANId_Type())
agentPortSecurityDynamicVLANId.setMaxAccess(_I)
...
agentPortSecurityDynamicMACAddress=_AgentPortSecurityDynamicMACAddress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,3,1,2),_AgentPortSecurityDynamicMACAddress_Type())
agentPortSecurityDynamicMACAddress.setMaxAccess(_I)
...
agentGlobalPortSecurityStickyMode=_AgentGlobalPortSecurityStickyMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,4),_AgentGlobalPortSecurityStickyMode_Type())
...
agentGlobalPortSecurityViolationTrapMode=_AgentGlobalPortSecurityViolationTrapMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,20,1,5),_AgentGlobalPortSecurityViolationTrapMode_Type())
