...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/dell/DNOS-PORTSECURITY-PRIVATE-MIB
...
fastPathPortSecurity.setRevisions(('2021-12-14 00:00', '2011-01-26 00:00', '2007-05-23 00:00',))
if mibBuilder.loadTexts: fastPathPortSecurity.setLastUpdated('202112140000Z')
if mibBuilder.loadTexts: fastPathPortSecurity.setOrganization('Dell')
...
agentPortSecurityStaticLimit = MibTableColumn((1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 20, 1, 2, 1, 3), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 20)).clone(20)).setMaxAccess("readwrite")
...
agentPortSecurityAgingTime = MibTableColumn((1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 20, 1, 2, 1, 12), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 1440)).clone(5)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: agentPortSecurityAgingTime.setStatus('current')
