...
mibBuilder.exportSymbols("CTRON-SSR-CAPACITY-MIB", capMemoryFree=capMemoryFree, memory=memory, capChassisSFRedundancy=capChassisSFRedundancy, capMemoryBlockSize=capMemoryBlockSize, capCPUMaxThreshold=capCPUMaxThreshold, capCPUEntry=capCPUEntry, capCPUL3Learned=capCPUL3Learned, capMemorySize=capMemorySize, capConformance=capConformance, tasks=tasks, capCompliances=capCompliances, capTaskName=capTaskName, capComplianceV10=capComplianceV10, capComplianceV20=capComplianceV20, capCPUNIAReceived=capCPUNIAReceived, capChassisPSRedundancy=capChassisPSRedundancy, capTaskModuleIndex=capTaskModuleIndex, capMemoryTable=capMemoryTable, capChassisCPURedundancy=capChassisCPURedundancy, capTaskUsed=capTaskUsed, capMemoryIndex=capMemoryIndex, capMemoryDescr=capMemoryDescr, capCPUL3Aged=capCPUL3Aged, capacityMIB=capacityMIB, capConfGroupV20=capConfGroupV20, capCPUTable=capCPUTable, SSRCapabilityType=SSRCapabilityType, capCPUNIATransmitted=capCPUNIATransmitted, capChassisSlotsFree=capChassisSlotsFree, capMemoryRemovable=capMemoryRemovable, capGroups=capGroups, capMemoryUsed=capMemoryUsed, capMemoryType=capMemoryType, capCPUMinThreshold=capCPUMinThreshold, capTaskEntry=capTaskEntry, capTaskShed=capTaskShed, capCPUL2Aged=capCPUL2Aged, capTaskIndex=capTaskIndex, capMemoryFailures=capMemoryFailures, capCPUModuleIndex=capCPUModuleIndex, capCPUL2Learned=capCPUL2Learned, capConfGroupV10=capConfGroupV10, capCPUCurrentUtilization=capCPUCurrentUtilization, SSRStatusType=SSRStatusType, capChassisSlotsUsed=capChassisSlotsUsed, capMemoryEntry=capMemoryEntry, chassisCap=chassisCap, capChassisSlotCount=capChassisSlotCount, SSRMemoryType=SSRMemoryType, cpu=cpu, capTaskStatus=capTaskStatus, PYSNMP_MODULE_ID=capacityMIB, capTaskTable=capTaskTable)
