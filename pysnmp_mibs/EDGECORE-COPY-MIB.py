...
_X='rlCopyInetIndex'
_W='not-accessible'
_V='rlCopyMessagesMessageIndex'
_U='rlCopyMessagesCopyIndex'
_T='rlCopyHistoryHistoryIndex'
_S='rlCopyIndex'
_R='serial'
_Q='TruthValue'
_P='DisplayString'
...
_L='copyTimedout'
_K='copyFailed'
_J='downloadInProgress'
_I='uploadInProgress'
_H='rndErrorSeverity'
_G='rndErrorDesc'
_F='EDGECORE-COPY-MIB'
_E='EDGECORE-DEVICEPARAMS-MIB'
_D='Integer32'
_C='read-only'
_B='read-write'
_A='current'
...
rnd,rndNotifications=mibBuilder.importSymbols('EDGECORE-MIB','rnd','rndNotifications')
...
rlCopy=ModuleIdentity((1,3,6,1,4,1,259,10,1,14,89,87))
if mibBuilder.loadTexts:rlCopy.setRevisions(('2010-05-11 00:00','2010-02-17 00:00','2009-08-10 00:00','2006-02-02 00:00','2003-09-22 00:00'))
class RlCopyApplicationType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6)));namedValues=NamedValues(*(('mcli',1),('cli',2),('ewb',3),('nms',4),('initerm',5),(_R,6)))
class RlCopyLocationType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6)));namedValues=NamedValues(*(('local',1),('anotherUnit',2),('tftp',3),('xmodem',4),('scp',5),(_R,6)))
...
rlCopyMibVersion=_RlCopyMibVersion_Object((1,3,6,1,4,1,259,10,1,14,89,87,1),_RlCopyMibVersion_Type())
rlCopyMibVersion.setMaxAccess(_C)
if mibBuilder.loadTexts:rlCopyMibVersion.setStatus(_A)
_RlCopyTable_Object=MibTable
rlCopyTable=_RlCopyTable_Object((1,3,6,1,4,1,259,10,1,14,89,87,2))
if mibBuilder.loadTexts:rlCopyTable.setStatus(_A)
_RlCopyEntry_Object=MibTableRow
rlCopyEntry=_RlCopyEntry_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1))
rlCopyEntry.setIndexNames((0,_F,_S))
if mibBuilder.loadTexts:rlCopyEntry.setStatus(_A)
_RlCopyIndex_Type=Integer32
_RlCopyIndex_Object=MibTableColumn
rlCopyIndex=_RlCopyIndex_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,1),_RlCopyIndex_Type())
...
rlCopyApplicationId=_RlCopyApplicationId_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,2),_RlCopyApplicationId_Type())
...
rlCopySourceLocation=_RlCopySourceLocation_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,3),_RlCopySourceLocation_Type())
...
rlCopySourceIpAddress=_RlCopySourceIpAddress_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,4),_RlCopySourceIpAddress_Type())
...
rlCopySourceUnitNumber=_RlCopySourceUnitNumber_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,5),_RlCopySourceUnitNumber_Type())
...
rlCopySourceFileName=_RlCopySourceFileName_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,6),_RlCopySourceFileName_Type())
...
rlCopySourceFileType=_RlCopySourceFileType_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,7),_RlCopySourceFileType_Type())
...
rlCopyDestinationLocation=_RlCopyDestinationLocation_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,8),_RlCopyDestinationLocation_Type())
...
rlCopyDestinationIpAddress=_RlCopyDestinationIpAddress_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,9),_RlCopyDestinationIpAddress_Type())
...
rlCopyDestinationUnitNumber=_RlCopyDestinationUnitNumber_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,10),_RlCopyDestinationUnitNumber_Type())
...
rlCopyDestinationFileName=_RlCopyDestinationFileName_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,11),_RlCopyDestinationFileName_Type())
...
rlCopyDestinationFileType=_RlCopyDestinationFileType_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,12),_RlCopyDestinationFileType_Type())
...
rlCopyUpTime=_RlCopyUpTime_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,13),_RlCopyUpTime_Type())
rlCopyUpTime.setMaxAccess(_C)
if mibBuilder.loadTexts:rlCopyUpTime.setStatus(_A)
class _RlCopyOperationState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*((_I,1),(_J,2),(_K,3),(_L,4),(_M,5)))
_RlCopyOperationState_Type.__name__=_D
_RlCopyOperationState_Object=MibTableColumn
rlCopyOperationState=_RlCopyOperationState_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,14),_RlCopyOperationState_Type())
...
rlCopyBytesTransferred=_RlCopyBytesTransferred_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,15),_RlCopyBytesTransferred_Type())
rlCopyBytesTransferred.setMaxAccess(_C)
if mibBuilder.loadTexts:rlCopyBytesTransferred.setStatus(_A)
class _RlCopyInBackground_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_N,1),(_O,2)))
_RlCopyInBackground_Type.__name__=_D
_RlCopyInBackground_Object=MibTableColumn
rlCopyInBackground=_RlCopyInBackground_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,16),_RlCopyInBackground_Type())
...
rlCopyRowStatus=_RlCopyRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,17),_RlCopyRowStatus_Type())
...
rlCopyHistoryIndex=_RlCopyHistoryIndex_Object((1,3,6,1,4,1,259,10,1,14,89,87,2,1,18),_RlCopyHistoryIndex_Type())
...
rlCopyFreeHistoryIndex=_RlCopyFreeHistoryIndex_Object((1,3,6,1,4,1,259,10,1,14,89,87,3),_RlCopyFreeHistoryIndex_Type())
...
rlCopyHistoryTable=_RlCopyHistoryTable_Object((1,3,6,1,4,1,259,10,1,14,89,87,4))
if mibBuilder.loadTexts:rlCopyHistoryTable.setStatus(_A)
_RlCopyHistoryEntry_Object=MibTableRow
rlCopyHistoryEntry=_RlCopyHistoryEntry_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1))
rlCopyHistoryEntry.setIndexNames((0,_F,_T))
...
rlCopyHistoryHistoryIndex=_RlCopyHistoryHistoryIndex_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,1),_RlCopyHistoryHistoryIndex_Type())
...
rlCopyHistoryApplicationId=_RlCopyHistoryApplicationId_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,2),_RlCopyHistoryApplicationId_Type())
...
rlCopyHistorySourceLocation=_RlCopyHistorySourceLocation_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,3),_RlCopyHistorySourceLocation_Type())
...
rlCopyHistorySourceIpAddress=_RlCopyHistorySourceIpAddress_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,4),_RlCopyHistorySourceIpAddress_Type())
...
rlCopyHistorySourceUnitNumber=_RlCopyHistorySourceUnitNumber_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,5),_RlCopyHistorySourceUnitNumber_Type())
...
rlCopyHistorySourceFileName=_RlCopyHistorySourceFileName_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,6),_RlCopyHistorySourceFileName_Type())
...
rlCopyHistorySourceFileType=_RlCopyHistorySourceFileType_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,7),_RlCopyHistorySourceFileType_Type())
...
rlCopyHistoryDestinationLocation=_RlCopyHistoryDestinationLocation_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,8),_RlCopyHistoryDestinationLocation_Type())
...
rlCopyHistoryDestinationIpAddress=_RlCopyHistoryDestinationIpAddress_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,9),_RlCopyHistoryDestinationIpAddress_Type())
...
rlCopyHistoryDestinationUnitNumber=_RlCopyHistoryDestinationUnitNumber_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,10),_RlCopyHistoryDestinationUnitNumber_Type())
...
rlCopyHistoryDestinationFileName=_RlCopyHistoryDestinationFileName_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,11),_RlCopyHistoryDestinationFileName_Type())
...
rlCopyHistoryDestinationFileType=_RlCopyHistoryDestinationFileType_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,12),_RlCopyHistoryDestinationFileType_Type())
...
rlCopyHistoryUpTime=_RlCopyHistoryUpTime_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,13),_RlCopyHistoryUpTime_Type())
rlCopyHistoryUpTime.setMaxAccess(_C)
if mibBuilder.loadTexts:rlCopyHistoryUpTime.setStatus(_A)
class _RlCopyHistoryOperationState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*((_I,1),(_J,2),(_K,3),(_L,4),(_M,5)))
_RlCopyHistoryOperationState_Type.__name__=_D
_RlCopyHistoryOperationState_Object=MibTableColumn
rlCopyHistoryOperationState=_RlCopyHistoryOperationState_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,14),_RlCopyHistoryOperationState_Type())
...
rlCopyHistoryBytesTransferred=_RlCopyHistoryBytesTransferred_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,15),_RlCopyHistoryBytesTransferred_Type())
rlCopyHistoryBytesTransferred.setMaxAccess(_C)
if mibBuilder.loadTexts:rlCopyHistoryBytesTransferred.setStatus(_A)
class _RlCopyHistoryInBackground_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_N,1),(_O,2)))
_RlCopyHistoryInBackground_Type.__name__=_D
_RlCopyHistoryInBackground_Object=MibTableColumn
rlCopyHistoryInBackground=_RlCopyHistoryInBackground_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,16),_RlCopyHistoryInBackground_Type())
...
rlCopyHistoryRowStatus=_RlCopyHistoryRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,17),_RlCopyHistoryRowStatus_Type())
...
rlCopyHistoryErrorMessage=_RlCopyHistoryErrorMessage_Object((1,3,6,1,4,1,259,10,1,14,89,87,4,1,18),_RlCopyHistoryErrorMessage_Type())
...
rlCopyAuditingEnable=_RlCopyAuditingEnable_Object((1,3,6,1,4,1,259,10,1,14,89,87,5),_RlCopyAuditingEnable_Type())
...
rlCopyMessagesTable=_RlCopyMessagesTable_Object((1,3,6,1,4,1,259,10,1,14,89,87,6))
if mibBuilder.loadTexts:rlCopyMessagesTable.setStatus(_A)
_RlCopyMessagesEntry_Object=MibTableRow
rlCopyMessagesEntry=_RlCopyMessagesEntry_Object((1,3,6,1,4,1,259,10,1,14,89,87,6,1))
rlCopyMessagesEntry.setIndexNames((0,_F,_U),(0,_F,_V))
...
rlCopyMessagesCopyIndex=_RlCopyMessagesCopyIndex_Object((1,3,6,1,4,1,259,10,1,14,89,87,6,1,1),_RlCopyMessagesCopyIndex_Type())
rlCopyMessagesCopyIndex.setMaxAccess(_W)
...
rlCopyMessagesMessageIndex=_RlCopyMessagesMessageIndex_Object((1,3,6,1,4,1,259,10,1,14,89,87,6,1,2),_RlCopyMessagesMessageIndex_Type())
rlCopyMessagesMessageIndex.setMaxAccess(_W)
...
rlCopyMessagesMessageText=_RlCopyMessagesMessageText_Object((1,3,6,1,4,1,259,10,1,14,89,87,6,1,3),_RlCopyMessagesMessageText_Type())
...
rlCopyMessagesStatus=_RlCopyMessagesStatus_Object((1,3,6,1,4,1,259,10,1,14,89,87,6,1,4),_RlCopyMessagesStatus_Type())
...
rlCopyMessagesTableRemoveEntries=_RlCopyMessagesTableRemoveEntries_Object((1,3,6,1,4,1,259,10,1,14,89,87,7),_RlCopyMessagesTableRemoveEntries_Type())
...
rlCopyInetTable=_RlCopyInetTable_Object((1,3,6,1,4,1,259,10,1,14,89,87,8))
if mibBuilder.loadTexts:rlCopyInetTable.setStatus(_A)
_RlCopyInetEntry_Object=MibTableRow
rlCopyInetEntry=_RlCopyInetEntry_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1))
...
rlCopyInetIndex=_RlCopyInetIndex_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,1),_RlCopyInetIndex_Type())
...
rlCopyInetApplicationId=_RlCopyInetApplicationId_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,2),_RlCopyInetApplicationId_Type())
...
rlCopyInetSourceLocation=_RlCopyInetSourceLocation_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,3),_RlCopyInetSourceLocation_Type())
...
rlCopyInetSourceIpAddressType=_RlCopyInetSourceIpAddressType_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,4),_RlCopyInetSourceIpAddressType_Type())
...
rlCopyInetSourceIpAddress=_RlCopyInetSourceIpAddress_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,5),_RlCopyInetSourceIpAddress_Type())
...
rlCopyInetSourceUnitNumber=_RlCopyInetSourceUnitNumber_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,6),_RlCopyInetSourceUnitNumber_Type())
...
rlCopyInetSourceFileName=_RlCopyInetSourceFileName_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,7),_RlCopyInetSourceFileName_Type())
...
rlCopyInetSourceFileType=_RlCopyInetSourceFileType_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,8),_RlCopyInetSourceFileType_Type())
...
rlCopyInetDestinationLocation=_RlCopyInetDestinationLocation_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,9),_RlCopyInetDestinationLocation_Type())
...
rlCopyInetDestinationIpAddressType=_RlCopyInetDestinationIpAddressType_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,10),_RlCopyInetDestinationIpAddressType_Type())
...
rlCopyInetDestinationIpAddress=_RlCopyInetDestinationIpAddress_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,11),_RlCopyInetDestinationIpAddress_Type())
...
rlCopyInetDestinationUnitNumber=_RlCopyInetDestinationUnitNumber_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,12),_RlCopyInetDestinationUnitNumber_Type())
...
rlCopyInetDestinationFileName=_RlCopyInetDestinationFileName_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,13),_RlCopyInetDestinationFileName_Type())
...
rlCopyInetDestinationFileType=_RlCopyInetDestinationFileType_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,14),_RlCopyInetDestinationFileType_Type())
...
rlCopyInetUpTime=_RlCopyInetUpTime_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,15),_RlCopyInetUpTime_Type())
rlCopyInetUpTime.setMaxAccess(_C)
if mibBuilder.loadTexts:rlCopyInetUpTime.setStatus(_A)
class _RlCopyInetOperationState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*((_I,1),(_J,2),(_K,3),(_L,4),(_M,5)))
_RlCopyInetOperationState_Type.__name__=_D
_RlCopyInetOperationState_Object=MibTableColumn
rlCopyInetOperationState=_RlCopyInetOperationState_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,16),_RlCopyInetOperationState_Type())
...
rlCopyInetBytesTransferred=_RlCopyInetBytesTransferred_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,17),_RlCopyInetBytesTransferred_Type())
rlCopyInetBytesTransferred.setMaxAccess(_C)
if mibBuilder.loadTexts:rlCopyInetBytesTransferred.setStatus(_A)
class _RlCopyInetInBackground_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_N,1),(_O,2)))
_RlCopyInetInBackground_Type.__name__=_D
_RlCopyInetInBackground_Object=MibTableColumn
rlCopyInetInBackground=_RlCopyInetInBackground_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,18),_RlCopyInetInBackground_Type())
...
rlCopyInetRowStatus=_RlCopyInetRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,19),_RlCopyInetRowStatus_Type())
...
rlCopyInetHistoryIndex=_RlCopyInetHistoryIndex_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,20),_RlCopyInetHistoryIndex_Type())
...
rlCopyInetDestinationUnitList=_RlCopyInetDestinationUnitList_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,21),_RlCopyInetDestinationUnitList_Type())
...
rlCopyInetUnitStatusList=_RlCopyInetUnitStatusList_Object((1,3,6,1,4,1,259,10,1,14,89,87,8,1,22),_RlCopyInetUnitStatusList_Type())
...
rlCopyHistoryInetTable=_RlCopyHistoryInetTable_Object((1,3,6,1,4,1,259,10,1,14,89,87,9))
if mibBuilder.loadTexts:rlCopyHistoryInetTable.setStatus(_A)
_RlCopyHistoryInetEntry_Object=MibTableRow
rlCopyHistoryInetEntry=_RlCopyHistoryInetEntry_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1))
...
rlCopyHistoryInetHistoryIndex=_RlCopyHistoryInetHistoryIndex_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,1),_RlCopyHistoryInetHistoryIndex_Type())
...
rlCopyHistoryInetApplicationId=_RlCopyHistoryInetApplicationId_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,2),_RlCopyHistoryInetApplicationId_Type())
...
rlCopyHistoryInetSourceLocation=_RlCopyHistoryInetSourceLocation_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,3),_RlCopyHistoryInetSourceLocation_Type())
...
rlCopyHistoryInetSourceIpAddressType=_RlCopyHistoryInetSourceIpAddressType_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,4),_RlCopyHistoryInetSourceIpAddressType_Type())
...
rlCopyHistoryInetSourceIpAddress=_RlCopyHistoryInetSourceIpAddress_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,5),_RlCopyHistoryInetSourceIpAddress_Type())
...
rlCopyHistoryInetSourceUnitNumber=_RlCopyHistoryInetSourceUnitNumber_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,6),_RlCopyHistoryInetSourceUnitNumber_Type())
...
rlCopyHistoryInetSourceFileName=_RlCopyHistoryInetSourceFileName_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,7),_RlCopyHistoryInetSourceFileName_Type())
...
rlCopyHistoryInetSourceFileType=_RlCopyHistoryInetSourceFileType_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,8),_RlCopyHistoryInetSourceFileType_Type())
...
rlCopyHistoryInetDestinationLocation=_RlCopyHistoryInetDestinationLocation_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,9),_RlCopyHistoryInetDestinationLocation_Type())
...
rlCopyHistoryInetDestinationIpAddressType=_RlCopyHistoryInetDestinationIpAddressType_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,10),_RlCopyHistoryInetDestinationIpAddressType_Type())
...
rlCopyHistoryInetDestinationIpAddress=_RlCopyHistoryInetDestinationIpAddress_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,11),_RlCopyHistoryInetDestinationIpAddress_Type())
...
rlCopyHistoryInetDestinationUnitNumber=_RlCopyHistoryInetDestinationUnitNumber_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,12),_RlCopyHistoryInetDestinationUnitNumber_Type())
...
rlCopyHistoryInetDestinationFileName=_RlCopyHistoryInetDestinationFileName_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,13),_RlCopyHistoryInetDestinationFileName_Type())
...
rlCopyHistoryInetDestinationFileType=_RlCopyHistoryInetDestinationFileType_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,14),_RlCopyHistoryInetDestinationFileType_Type())
...
rlCopyHistoryInetUpTime=_RlCopyHistoryInetUpTime_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,15),_RlCopyHistoryInetUpTime_Type())
rlCopyHistoryInetUpTime.setMaxAccess(_C)
if mibBuilder.loadTexts:rlCopyHistoryInetUpTime.setStatus(_A)
class _RlCopyHistoryInetOperationState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*((_I,1),(_J,2),(_K,3),(_L,4),(_M,5)))
_RlCopyHistoryInetOperationState_Type.__name__=_D
_RlCopyHistoryInetOperationState_Object=MibTableColumn
rlCopyHistoryInetOperationState=_RlCopyHistoryInetOperationState_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,16),_RlCopyHistoryInetOperationState_Type())
...
rlCopyHistoryInetBytesTransferred=_RlCopyHistoryInetBytesTransferred_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,17),_RlCopyHistoryInetBytesTransferred_Type())
rlCopyHistoryInetBytesTransferred.setMaxAccess(_C)
if mibBuilder.loadTexts:rlCopyHistoryInetBytesTransferred.setStatus(_A)
class _RlCopyHistoryInetInBackground_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_N,1),(_O,2)))
_RlCopyHistoryInetInBackground_Type.__name__=_D
_RlCopyHistoryInetInBackground_Object=MibTableColumn
rlCopyHistoryInetInBackground=_RlCopyHistoryInetInBackground_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,18),_RlCopyHistoryInetInBackground_Type())
...
rlCopyHistoryInetRowStatus=_RlCopyHistoryInetRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,19),_RlCopyHistoryInetRowStatus_Type())
...
rlCopyHistoryInetErrorMessage=_RlCopyHistoryInetErrorMessage_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,20),_RlCopyHistoryInetErrorMessage_Type())
...
rlCopyHistoryInetDestinationUnitList=_RlCopyHistoryInetDestinationUnitList_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,21),_RlCopyHistoryInetDestinationUnitList_Type())
...
rlCopyHistoryInetUnitStatusList=_RlCopyHistoryInetUnitStatusList_Object((1,3,6,1,4,1,259,10,1,14,89,87,9,1,22),_RlCopyHistoryInetUnitStatusList_Type())
...
rlCopyUnitsList=_RlCopyUnitsList_Object((1,3,6,1,4,1,259,10,1,14,89,87,10),_RlCopyUnitsList_Type())
