...
rlJumboFramesCurrentStatus=_RlJumboFramesCurrentStatus_Object((1,3,6,1,4,1,4526,17,91,1),_RlJumboFramesCurrentStatus_Type())
...
rlJumboFramesStatusAfterReset=_RlJumboFramesStatusAfterReset_Object((1,3,6,1,4,1,4526,17,91,2),_RlJumboFramesStatusAfterReset_Type())
rlJumboFramesStatusAfterReset.setMaxAccess('read-write')
if mibBuilder.loadTexts:rlJumboFramesStatusAfterReset.setStatus(_D)
mibBuilder.exportSymbols('NETGEAR-RADLAN-JUMBOFRAMES-MIB',**{'rlJumboFrames':rlJumboFrames,'rlJumboFramesCurrentStatus':rlJumboFramesCurrentStatus,'rlJumboFramesStatusAfterReset':rlJumboFramesStatusAfterReset})