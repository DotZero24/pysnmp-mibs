...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-ETHER-CFM-MIB
...
mibBuilder.exportSymbols("CISCO-ETHER-CFM-MIB", PYSNMP_MODULE_ID=ciscoEtherCfmMIB, cEtherCfmEventLclMepCount=cEtherCfmEventLclMepCount, cEtherCfmEventDomainName=cEtherCfmEventDomainName, cEtherCfmCcMepDown=cEtherCfmCcMepDown, cEtherCfmCcConfigError=cEtherCfmCcConfigError, cEtherCfmCcCrossconnect=cEtherCfmCcCrossconnect, ciscoEtherCfmMIBEventGroup=ciscoEtherCfmMIBEventGroup, cEtherCfmEventType=cEtherCfmEventType, cEtherCfmMaxEventIndex=cEtherCfmMaxEventIndex, cEtherCfmXCheckServiceUp=cEtherCfmXCheckServiceUp, cEtherCfmEventRmtMepid=cEtherCfmEventRmtMepid, cEtherCfmCcLoop=cEtherCfmCcLoop, cEtherCfmEventDomainIndex=cEtherCfmEventDomainIndex, cEtherCfmEventRmtPortState=cEtherCfmEventRmtPortState, cEtherCfmEventRmtMacAddress=cEtherCfmEventRmtMacAddress, cEtherCfmEventDeleteRow=cEtherCfmEventDeleteRow, cEtherCfmEventEntry=cEtherCfmEventEntry, cEtherCfmEventLastChange=cEtherCfmEventLastChange, ciscoEtherCfmNotificationPrefix=ciscoEtherCfmNotificationPrefix, cEtherCfmXCheckMissing=cEtherCfmXCheckMissing, ciscoEtherCfmMIBCompliances=ciscoEtherCfmMIBCompliances, ciscoEtherCfmMIBNotifGroup=ciscoEtherCfmMIBNotifGroup, cEtherCfmEventCode=cEtherCfmEventCode, cEtherCfmEventIndex=cEtherCfmEventIndex, cEtherCfmEventTable=cEtherCfmEventTable, cEtherCfmEventSvlan=cEtherCfmEventSvlan, ciscoEtherCfmMIBConform=ciscoEtherCfmMIBConform, ciscoEtherCfmMIBObjects=ciscoEtherCfmMIBObjects, ciscoEtherCfmMIBGroups=ciscoEtherCfmMIBGroups, cEtherCfmEventLclMepid=cEtherCfmEventLclMepid, cEtherCfmEventLclMacAddress=cEtherCfmEventLclMacAddress, cEtherCfmEventServiceId=cEtherCfmEventServiceId, cEtherCfmCcMepUp=cEtherCfmCcMepUp, cEtherCfmEventLclIfCount=cEtherCfmEventLclIfCount, cecCfmEvents=cecCfmEvents, cEtherCfmXCheckUnknown=cEtherCfmXCheckUnknown, ciscoEtherCfmMIBCompliance=ciscoEtherCfmMIBCompliance, CfmMepid=CfmMepid, ciscoEtherCfmMIBNotifs=ciscoEtherCfmMIBNotifs, cEtherCfmEventRmtServiceId=cEtherCfmEventRmtServiceId, ciscoEtherCfmMIB=ciscoEtherCfmMIB)
