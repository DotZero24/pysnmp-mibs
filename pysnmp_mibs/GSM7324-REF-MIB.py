# SNMP MIB module (GSM7324-REF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/GSM7324-REF-MIB
...
gsm7324 = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7)
)
if mibBuilder.loadTexts:
    gsm7324.setRevisions(
        ("2003-05-06 12:00",)
    )
