...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-IPMROUTE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:11 2025
...
_CIpMRouteScopeNameDefault_Type.__name__ = "TruthValue"
...
cIpMRouteMIBCompliance.setObjects(
      *(("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBBasicGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBRouteGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBBoundaryGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBHCInterfaceGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBHopCountGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBPktsOutGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBPktsGroup"))
)
if mibBuilder.loadTexts:
...
cIpMRouteMIBComplianceRev1.setObjects(
      *(("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBBasicGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBRouteGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBBoundaryGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBHCInterfaceGroup"),
        ...
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBPktsOutGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBPktsGroup"),
        ("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteMIBHCInterfaceGroupSup1"))
)
if mibBuilder.loadTexts:
