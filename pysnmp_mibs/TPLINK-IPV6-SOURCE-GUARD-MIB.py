...
mibBuilder.exportSymbols("TPLINK-IPV6-SOURCE-GUARD-MIB", tpIpv6SourceGuardConfigType=tpIpv6SourceGuardConfigType, tpIpv6SourceGuardConfig=tpIpv6SourceGuardConfig, tpIpv6SourceGuardConfigEntry=tpIpv6SourceGuardConfigEntry, tpIpv6SourceGuardConfigPort=tpIpv6SourceGuardConfigPort, tplinkIpv6SourceGuardNotifications=tplinkIpv6SourceGuardNotifications, tpIpv6SourceGuardConfigTable=tpIpv6SourceGuardConfigTable, tplinkIpv6SourceGuardMIBObjects=tplinkIpv6SourceGuardMIBObjects, tpIpv6SourceGuardConfigPortLag=tpIpv6SourceGuardConfigPortLag, PYSNMP_MODULE_ID=tplinkIpv6SourceGuardMIB, tplinkIpv6SourceGuardMIB=tplinkIpv6SourceGuardMIB)
