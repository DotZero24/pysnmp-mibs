...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-IKE-CONFIGURATION-MIB
...
CIKELifetime, CIPsecPhase1PeerIdentityType, CIPsecIkeAuthMethod, CIPsecControlProtocol, CIPsecEncryptAlgorithm, CIKELifesize, CIPsecIkePRFAlgorithm, CIPsecIkeHashAlgorithm, CIPsecDiffHellmanGrp, CIKEIsakmpDoi = mibBuilder.importSymbols("CISCO-IPSEC-TC", "CIKELifetime", "CIPsecPhase1PeerIdentityType", "CIPsecIkeAuthMethod", "CIPsecControlProtocol", "CIPsecEncryptAlgorithm", "CIKELifesize", "CIPsecIkePRFAlgorithm", "CIPsecIkeHashAlgorithm", "CIPsecDiffHellmanGrp", "CIKEIsakmpDoi")
...
mibBuilder.exportSymbols("CISCO-IKE-CONFIGURATION-MIB", ciscoIkeConfigMIB=ciscoIkeConfigMIB, cicIkeCfgMIBGroups=cicIkeCfgMIBGroups, cicIkeCfgPskRemIdentity=cicIkeCfgPskRemIdentity, cicIkeCfgPolicyEncr=cicIkeCfgPolicyEncr, cicIkeCfgServiceControl=cicIkeCfgServiceControl, cicIkeCfgPskStatus=cicIkeCfgPskStatus, cicIkeCfgNotificationGroup=cicIkeCfgNotificationGroup, cicIkeCfgPolicies=cicIkeCfgPolicies, cicIkeCfgPolicyLifetime=cicIkeCfgPolicyLifetime, cicIkeCfgPskNextAvailEntry=cicIkeCfgPskNextAvailEntry, cicIkeCfgPolicyPRF=cicIkeCfgPolicyPRF, cicIkeCfgInitiatorTable=cicIkeCfgInitiatorTable, cicIkeCfgFailureRecovConfigTable=cicIkeCfgFailureRecovConfigTable, cicIkeCfgPskRemIdAddrOrRg1OrSn=cicIkeCfgPskRemIdAddrOrRg1OrSn, PYSNMP_MODULE_ID=ciscoIkeConfigMIB, cicIkeCfgInitiatorPAddrType=cicIkeCfgInitiatorPAddrType, cicIkeKeepAliveEnabled=cicIkeKeepAliveEnabled, cicIkeCfgPskKey=cicIkeCfgPskKey, cicIkeCfgPskIndex=cicIkeCfgPskIndex, ciscoIkeConfigPskAdded=ciscoIkeConfigPskAdded, cicIkeCfgIdentityEntry=cicIkeCfgIdentityEntry, cicIkeAggressModeEnabled=cicIkeAggressModeEnabled, cicIkeCfgIdentitiesGroup=cicIkeCfgIdentitiesGroup, cicIkeInvalidSpiNotify=cicIkeInvalidSpiNotify, cicIkeCfgInitiatorNextAvailIndex=cicIkeCfgInitiatorNextAvailIndex, cicIkeKeepAliveInterval=cicIkeKeepAliveInterval, CicIkeConfigPskIndex=CicIkeConfigPskIndex, cicIkeCfgPskRemIdentTypeStand=cicIkeCfgPskRemIdentTypeStand, cicIkeConfigMIBConform=cicIkeConfigMIBConform, cicIkeCfgOperations=cicIkeCfgOperations, CicIkeConfigInitiatorIndex=CicIkeConfigInitiatorIndex, cicIkeCfgPolicyStatus=cicIkeCfgPolicyStatus, cicIkeCfgMIBCompliances=cicIkeCfgMIBCompliances, cicIkeCfgOperGroup=cicIkeCfgOperGroup, cicIkeCfgIdentities=cicIkeCfgIdentities, cicIkeCfgPolicyLifesize=cicIkeCfgPolicyLifesize, cicIkeCfgQoSControl=cicIkeCfgQoSControl, cicNotifCntlIkePskDeleted=cicNotifCntlIkePskDeleted, cicIkeConfigMIBNotifs=cicIkeConfigMIBNotifs, cicIkeCfgPkiAuthConfig=cicIkeCfgPkiAuthConfig, cicIkeCfgPolicyTable=cicIkeCfgPolicyTable, cicIkeCfgPskRemIdAddrRange2=cicIkeCfgPskRemIdAddrRange2, cicIkeCfgInitiatorNextAvailTable=cicIkeCfgInitiatorNextAvailTable, cicIkeCfgPskTable=cicIkeCfgPskTable, cicIkeConfigMIBObjects=cicIkeConfigMIBObjects, ciscoIkeConfigPolicyDeleted=ciscoIkeConfigPolicyDeleted, cicIkeCfgIdentityDoi=cicIkeCfgIdentityDoi, cicIkeCfgFailureRecovery=cicIkeCfgFailureRecovery, cicIkeCfgPolicyGroup=cicIkeCfgPolicyGroup, cicIkeCfgInitiatorEntry=cicIkeCfgInitiatorEntry, cicIkeCfgPskNextAvailTable=cicIkeCfgPskNextAvailTable, ciscoIkeConfigPskDeleted=ciscoIkeConfigPskDeleted, cicIkeCfgInitiatorIndex=cicIkeCfgInitiatorIndex, cicNotifCntlIkeOperStateChanged=cicNotifCntlIkeOperStateChanged, cicIkeConfigMibNotifCntl=cicIkeConfigMibNotifCntl, cicIkeEnabled=cicIkeEnabled, cicNotifCntlIkePskAdded=cicNotifCntlIkePskAdded, cicIkeCfgPolicyAuth=cicIkeCfgPolicyAuth, cicIkeCfgNonceAuthConfig=cicIkeCfgNonceAuthConfig, cicIkeCfgPskNextAvailIndex=cicIkeCfgPskNextAvailIndex, cicNotifCntlIkeAllNotifs=cicNotifCntlIkeAllNotifs, cicIkeCfgPolicyDHGroup=cicIkeCfgPolicyDHGroup, cicIkeCfgInitiatorStatus=cicIkeCfgInitiatorStatus, cicIkeCfgCallAdmssionnCtrl=cicIkeCfgCallAdmssionnCtrl, ciscoIkeConfigPolicyAdded=ciscoIkeConfigPolicyAdded, ciscoIkeConfigOperStateChanged=ciscoIkeConfigOperStateChanged, cicIkeCfgIdentityTable=cicIkeCfgIdentityTable, cicIkeCfgPeerAuth=cicIkeCfgPeerAuth, cicIkeCfgPolicyPriority=cicIkeCfgPolicyPriority, cicIkeCfgPskAuthConfig=cicIkeCfgPskAuthConfig, cicIkeKeepAliveRetryInterval=cicIkeKeepAliveRetryInterval, cicIkeCfgInitiatorPAddr=cicIkeCfgInitiatorPAddr, cicIkeCfgNotifCntlGroup=cicIkeCfgNotifCntlGroup, cicIkeCfgMIBCompliance=cicIkeCfgMIBCompliance, cicIkeCfgPskAuthGroup=cicIkeCfgPskAuthGroup, cicIkeCfgPskRemIdSubnetMask=cicIkeCfgPskRemIdSubnetMask, cicNotifCntlIkePolicyAdded=cicNotifCntlIkePolicyAdded, cicIkeCfgPskEntry=cicIkeCfgPskEntry, cicIkeCfgPskRemIdentType=cicIkeCfgPskRemIdentType, cicNotifCntlIkePolicyDeleted=cicNotifCntlIkePolicyDeleted, cicIkeCfgIdentityType=cicIkeCfgIdentityType, cicIkeCfgPolicyHash=cicIkeCfgPolicyHash, cicIkeCfgOptionalPolicyGroup=cicIkeCfgOptionalPolicyGroup, cicIkeCfgInitiatorNextAvailEntry=cicIkeCfgInitiatorNextAvailEntry, cicIkeCfgFailureRecovConfigEntry=cicIkeCfgFailureRecovConfigEntry, cicIkeCfgFailureRecoveryGroup=cicIkeCfgFailureRecoveryGroup, cicIkeCfgInitiatorVer=cicIkeCfgInitiatorVer, cicIkeKeepAliveType=cicIkeKeepAliveType, cicIkeCfgPolicyEntry=cicIkeCfgPolicyEntry)
