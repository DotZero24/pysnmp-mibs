...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cambium/CAMBIUM-PTP600-MIB
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelBCableLength=channelBCableLength, tDDControlGroup=tDDControlGroup, managementPortDisabledWarning=managementPortDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, ptp600=ptp600, sNTPState=sNTPState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, automaticTxPowerControl=automaticTxPowerControl, sNMPv3Enable=sNMPv3Enable, telecomsChannelAStatus=telecomsChannelAStatus, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapVersion=sNMPTrapVersion, sNTPServerIPAddress=sNTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, sntp=sntp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStats=pubStats, aAAControl=aAAControl, telecomGroup=telecomGroup, phyControlGroup=phyControlGroup, managementMode=managementMode, rawReceivePower=rawReceivePower, channelACableLength=channelACableLength, transmitModulationMode=transmitModulationMode, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetPortNumber=telnetPortNumber, sNMPPortNumber=sNMPPortNumber, iPv4Address=iPv4Address, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, cambium=cambium, dfsGroup=dfsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, accessMethod=accessMethod, linkName=linkName, tFTPServerPortNumber=tFTPServerPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, longitude=longitude, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, sMTPEnabledMessages=sMTPEnabledMessages, PYSNMP_MODULE_ID=cambium, receiveChannel=receiveChannel, sNMPTrapTable=sNMPTrapTable, dfsTableNumber=dfsTableNumber, dSCPManagementPriority=dSCPManagementPriority, userTableEntry=userTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, unitOutOfCalibration=unitOutOfCalibration, sNTPSync=sNTPSync, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortStatus=dataPortStatus, installStatus=installStatus, daylightSaving=daylightSaving, smtpGroup=smtpGroup, bootVersion=bootVersion, userTableIndex=userTableIndex, secureModeAlarm=secureModeAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userPassword=userPassword, ptpTrapPrefix=ptpTrapPrefix, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDDSynchronizationMode=tDDSynchronizationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, channelALoopbackTrap=channelALoopbackTrap, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, targetMACAddress=targetMACAddress, txColorCode=txColorCode, rxColorCode=rxColorCode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPPollInterval=sNTPPollInterval, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogStateTrap=syslogStateTrap, syslogClient=syslogClient, installStatusTrap=installStatusTrap, syslogControl=syslogControl, sNTPSyncTrap=sNTPSyncTrap, remoteRxTargetPower=remoteRxTargetPower, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, supplementary=supplementary, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, telecomsChannelBStatus=telecomsChannelBStatus, siteName=siteName, timeZone=timeZone, sNMPTrapInternetAddress=sNMPTrapInternetAddress, securityLevel=securityLevel, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControl=phyControl, remoteInternetAddress=remoteInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, sNTPServerInternetAddress=sNTPServerInternetAddress, supplementaryGroup=supplementaryGroup, installArmState=installArmState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelBLoopbackTrap=channelBLoopbackTrap, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, sntpGroup=sntpGroup, userRole=userRole, dfsTableEntry=dfsTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarmsGroup=alarmsGroup, dfsPeaks=dfsPeaks, tDDControl=tDDControl, phyStatus=phyStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqMHz=receiveFreqMHz, userName=userName, channelALineCode=channelALineCode, frequencyVariant=frequencyVariant, telecomsInterface=telecomsInterface, managementPortStatus=managementPortStatus, aAAControlGroup=aAAControlGroup, sMTPEmailAlert=sMTPEmailAlert, subnetMask=subnetMask, channelBandwidth=channelBandwidth, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, iPv6PrefixLength=iPv6PrefixLength, encryptionAlgorithm=encryptionAlgorithm, versions=versions, dataPortAutoMdix=dataPortAutoMdix, systemClock=systemClock, softwareVersion=softwareVersion, ethernetPriorityTable=ethernetPriorityTable, iPVersion=iPVersion, channelBLineCode=channelBLineCode, dfsMeans=dfsMeans, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerTable=sNTPServerTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTimeout=sNTPServerTimeout, userTableNumber=userTableNumber, ptp=ptp, regionCode=regionCode, targetRange=targetRange, transmitFreqKHz=transmitFreqKHz, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, gatewayIPAddress=gatewayIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, latitude=latitude, encryptionGroup=encryptionGroup, syslogClientTrap=syslogClientTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitDataRate=transmitDataRate, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ptpCompliance=ptpCompliance, hAZLOCConfiguration=hAZLOCConfiguration, channelChangeTrap=channelChangeTrap, snmpControl=snmpControl, bridgeGroup=bridgeGroup, channelBLoopback=channelBLoopback, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkLoss=linkLoss, transmitChannel=transmitChannel, versionsGroup=versionsGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelALoopback=channelALoopback, phyStatusGroup=phyStatusGroup, ethernetFiberSupport=ethernetFiberSupport, syslogState=syslogState, l2CPPriorityTable=l2CPPriorityTable, systemReset=systemReset, rangingMode=rangingMode, alarms=alarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortStatusTrap=managementPortStatusTrap, syslogControlGroup=syslogControlGroup, qOSPriorityScheme=qOSPriorityScheme, dfsTableIndex=dfsTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfs=dfs, licenceGroup=licenceGroup, sNTPServerRetries=sNTPServerRetries, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, range=range, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqKHz=receiveFreqKHz, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, ptpGroups=ptpGroups, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTable=userTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, vectorError=vectorError, cableLoss=cableLoss, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptmp=ptmp, telecom=telecom, pubStatsGroup=pubStatsGroup, localPacketFiltering=localPacketFiltering, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, eIRP=eIRP, altitude=altitude, bandwidthVariant=bandwidthVariant, incompatibleRegionCodes=incompatibleRegionCodes, smtp=smtp, groupID=groupID, licence=licence)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortFiberStatus=dataPortFiberStatus, sNTPServerTableNumber=sNTPServerTableNumber, reset=reset, hTTPSPortNumber=hTTPSPortNumber, searchState=searchState, sNTPServerStatus=sNTPServerStatus, userEnabled=userEnabled, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTableEntry=sNTPServerTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, configuration=configuration, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsTable=dfsTable, wirelessLinkStatus=wirelessLinkStatus, iPv6Address=iPv6Address, receivePower=receivePower, encryption=encryption, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, masterSlaveMode=masterSlaveMode, telecomsChannelSelection=telecomsChannelSelection, sNTPLastSync=sNTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, management=management, bridge=bridge, managementGroup=managementGroup, productName=productName, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteIPAddress=remoteIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress)
