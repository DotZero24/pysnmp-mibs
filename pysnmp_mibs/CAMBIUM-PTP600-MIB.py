...
# Produced by pysmi-1.1.12 at Wed Oct  8 11:06:22 2025
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installStatus=installStatus, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableIndex=l2CPPriorityTableIndex, snmpControl=snmpControl, searchState=searchState, aAAControlGroup=aAAControlGroup, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, sntpGroup=sntpGroup, pubStatsGroup=pubStatsGroup, accessMethod=accessMethod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userEnabled=userEnabled, syslogClientTrap=syslogClientTrap, dfsTableNumber=dfsTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqMHz=transmitFreqMHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpCompliance=ptpCompliance, txColorCode=txColorCode, maximumTransmitPower=maximumTransmitPower, dfs=dfs, regionCode=regionCode, installArmState=installArmState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitDataRate=transmitDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, altitude=altitude, secondarySoftwareVersion=secondarySoftwareVersion, channelBandwidth=channelBandwidth, aAAControl=aAAControl, tFTPServerIPAddress=tFTPServerIPAddress, licence=licence, pubStats=pubStats, telnetPortNumber=telnetPortNumber, installArmStateTrap=installArmStateTrap, userPassword=userPassword, rawReceivePower=rawReceivePower, dfsMeans=dfsMeans, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogControl=syslogControl, sNMPTrapTableIndex=sNMPTrapTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, versions=versions, ptp=ptp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, cambium=cambium, telecomsChannelSelection=telecomsChannelSelection, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, ethernet=ethernet, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, linkLoss=linkLoss, sntp=sntp, dfsTable=dfsTable, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, remoteInternetAddressType=remoteInternetAddressType, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, PYSNMP_MODULE_ID=cambium, dataPortFiberStatus=dataPortFiberStatus, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, supplementaryGroup=supplementaryGroup, sNTPLastSync=sNTPLastSync, channelALoopbackTrap=channelALoopbackTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, regionCodeTrap=regionCodeTrap, unitOutOfCalibration=unitOutOfCalibration, dataPortStatus=dataPortStatus, reset=reset, productVariant=productVariant, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryption=encryption, sNTPServerTableNumber=sNTPServerTableNumber, userTableIndex=userTableIndex, rxColorCode=rxColorCode, managementMode=managementMode, sNTPServerRetries=sNTPServerRetries, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsChannelBStatus=telecomsChannelBStatus, ptpTrapPrefix=ptpTrapPrefix, longitude=longitude, hAZLOCConfiguration=hAZLOCConfiguration, channelBLineCode=channelBLineCode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, range=range, iPv6Address=iPv6Address, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, encryptionAlgorithm=encryptionAlgorithm, supplementary=supplementary, tDDControl=tDDControl, dfsTableIndex=dfsTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, gatewayIPAddress=gatewayIPAddress, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, sNTPSync=sNTPSync, sNTPServerStatus=sNTPServerStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyControlGroup=phyControlGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, localPacketFiltering=localPacketFiltering, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telecom=telecom, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, encryptionGroup=encryptionGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userRole=userRole, remoteIPAddress=remoteIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelACableLength=channelACableLength, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, bridgeGroup=bridgeGroup, qOSPriorityScheme=qOSPriorityScheme, targetRange=targetRange, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hardwareVersion=hardwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationMode=receiveModulationMode, configuration=configuration, syslogStateTrap=syslogStateTrap, eIRP=eIRP, dfsPeaks=dfsPeaks, antennaGain=antennaGain, sNTPServerPortNumber=sNTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsInterface=telecomsInterface, cableLoss=cableLoss, transmitFreqKHz=transmitFreqKHz, latitude=latitude, ptpTraps=ptpTraps, smtp=smtp, receiveFreqMHz=receiveFreqMHz, resetGroup=resetGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, dataPortAutoMdix=dataPortAutoMdix, ptpGroups=ptpGroups, alarms=alarms, channelBLoopbackTrap=channelBLoopbackTrap, signalStrengthRatio=signalStrengthRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vectorError=vectorError, licenceGroup=licenceGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPollInterval=sNTPPollInterval, rangingMode=rangingMode, tDDSynchronizationMode=tDDSynchronizationMode, syslogState=syslogState, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPState=sNTPState, linkSymmetry=linkSymmetry, sNTPServerTimeout=sNTPServerTimeout, productName=productName, incompatibleRegionCodes=incompatibleRegionCodes, siteName=siteName, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetGroup=ethernetGroup, masterSlaveMode=masterSlaveMode, sNTPServerInternetAddress=sNTPServerInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, notificationsGroup=notificationsGroup, bootVersion=bootVersion, phyStatus=phyStatus, phyControl=phyControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userName=userName, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, versionsGroup=versionsGroup, receiveDataRate=receiveDataRate, bridge=bridge, l2CPPriorityTable=l2CPPriorityTable, frequencyVariant=frequencyVariant, channelBCableLength=channelBCableLength, tDDControlGroup=tDDControlGroup, transmitPower=transmitPower, telecomsChannelAStatus=telecomsChannelAStatus, systemClock=systemClock, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelALineCode=channelALineCode, sNTPServerTableIndex=sNTPServerTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelALoopback=channelALoopback, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, secureModeAlarmTrap=secureModeAlarmTrap, ptp600=ptp600, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv4Address=iPv4Address, automaticTxPowerControl=automaticTxPowerControl, sMTPServerPortNumber=sMTPServerPortNumber, userTable=userTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANManagementVID=vLANManagementVID, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, receiveModulationModeDetail=receiveModulationModeDetail, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteRxTargetPower=remoteRxTargetPower, mPLSTCPriorityTable=mPLSTCPriorityTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptmp=ptmp, iPVersion=iPVersion, transmitChannel=transmitChannel, dfsGroup=dfsGroup, sNMPv3Enable=sNMPv3Enable, securityLevel=securityLevel, installStatusTrap=installStatusTrap, linkName=linkName, receiveChannel=receiveChannel, sNMPTrapVersion=sNMPTrapVersion, sNTPServerIPAddress=sNTPServerIPAddress, telecomGroup=telecomGroup, remoteInternetAddress=remoteInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortDisabledWarning=dataPortDisabledWarning, ethernetBridgingStatus=ethernetBridgingStatus, secureModeAlarm=secureModeAlarm, managementPortStatus=managementPortStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, byteErrorRatio=byteErrorRatio, iPv6PrefixLength=iPv6PrefixLength, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, targetMACAddress=targetMACAddress, bandwidthVariant=bandwidthVariant, linkModeOptimisation=linkModeOptimisation, management=management, sNTPServerInternetAddressType=sNTPServerInternetAddressType, configurationGroup=configurationGroup, managementPortStatusTrap=managementPortStatusTrap, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, syslogClient=syslogClient, systemReset=systemReset, alarmsGroup=alarmsGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBLoopback=channelBLoopback, receivePower=receivePower, timeZone=timeZone, sNTPServerTable=sNTPServerTable, userTableNumber=userTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving)
