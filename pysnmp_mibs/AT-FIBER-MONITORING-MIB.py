...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/allied/AT-FIBER-MONITORING-MIB
...
atFiberMon.setRevisions(('2020-06-16 00:00', '2015-09-08 00:00',))
if mibBuilder.loadTexts: atFiberMon.setLastUpdated('202006160000Z')
...
atFiberMonLastReading = MibTableColumn((1, 3, 6, 1, 4, 1, 207, 8, 4, 4, 3, 27, 3, 1, 9), Integer32().subtype(subtypeSpec=ValueRangeConstraint(-1, 65535))).setMaxAccess("readonly")
if mibBuilder.loadTexts: atFiberMonLastReading.setStatus('current')
mibBuilder.exportSymbols("AT-FIBER-MONITORING-MIB", atFiberMonNotifications=atFiberMonNotifications, atFiberMonEnable=atFiberMonEnable, atFiberMonReadingHistory=atFiberMonReadingHistory, atFiberMonTrapVariable=atFiberMonTrapVariable, atFiberMonStateTable=atFiberMonStateTable, atFiberMonAlarmAction=atFiberMonAlarmAction, atFiberMonConfigTable=atFiberMonConfigTable, atFiberMonThreshold=atFiberMonThreshold, atFiberMonMinReading=atFiberMonMinReading, atFiberMonConfigEntry=atFiberMonConfigEntry, atFiberMon=atFiberMon, atFiberMonAlarmClearedNotify=atFiberMonAlarmClearedNotify, atFiberMonSensitivity=atFiberMonSensitivity, atFiberMonMaxReading=atFiberMonMaxReading, atFiberMonlIfDescription=atFiberMonlIfDescription, atFiberMonLastReading=atFiberMonLastReading, atFiberMonReading=atFiberMonReading, atFiberMonChannel=atFiberMonChannel, atFiberMonBaseline=atFiberMonBaseline, atFiberMonActualBaseline=atFiberMonActualBaseline, PYSNMP_MODULE_ID=atFiberMon, atFiberMonIfname=atFiberMonIfname, atFiberMonInterval=atFiberMonInterval, atFiberMonAlarmSetNotify=atFiberMonAlarmSetNotify, atFiberMonStateEntry=atFiberMonStateEntry, atFiberMonIfindex=atFiberMonIfindex)
