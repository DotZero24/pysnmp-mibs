...
# Notes
# -----
# ASN.1 source file://mibs/allied/AT-FIBER-MONITORING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:23:47 2025
...
class _AtFiberMonLastReading_Type(Integer32):
    """Custom type atFiberMonLastReading based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AtFiberMonLastReading_Type.__name__ = "Integer32"
_AtFiberMonLastReading_Object = MibTableColumn
atFiberMonLastReading = _AtFiberMonLastReading_Object(
    (1, 3, 6, 1, 4, 1, 207, 8, 4, 4, 3, 27, 3, 1, 9),
    _AtFiberMonLastReading_Type()
)
atFiberMonLastReading.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    atFiberMonLastReading.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"atFiberMon": atFiberMon,
       ...
       "atFiberMonLastReading": atFiberMonLastReading}
)
