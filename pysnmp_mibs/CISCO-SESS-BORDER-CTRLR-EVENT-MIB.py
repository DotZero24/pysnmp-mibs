...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SESS-BORDER-CTRLR-EVENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:29:02 2025
...
csbCompliance.setObjects(
      *(("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbSourceAlertGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbDynamicBlackListGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbNotificationGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbNotificationManadatoryParams"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbAdjacencyGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbSBCServiceGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbSLAGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbRadiusConnectionGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbDiameterConnectionGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbH248StatusGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbCongestionGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbNotifEnabledGroup"))
)
if mibBuilder.loadTexts:
...
csbComplianceRev1.setObjects(
      *(("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbSourceAlertGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbDynamicBlackListGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbNotificationGroupRev1"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbNotificationManadatoryParams"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbAdjacencyGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbSBCServiceGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbSLAGroupRev1"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbRadiusConnectionGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbDiameterConnectionGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbH248StatusGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbCongestionGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbNotifEnabledGroupRev1"))
)
if mibBuilder.loadTexts:
...
csbComplianceRev2.setObjects(
      *(("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbSourceAlertGroup"),
        ...
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbCongestionGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbNotifEnabledGroupRev1"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbQOSAlertGroup"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbNotificationGroupSup1"),
        ("CISCO-SESS-BORDER-CTRLR-EVENT-MIB", "csbNotifEnabledGroupSup1"))
)
if mibBuilder.loadTexts:
