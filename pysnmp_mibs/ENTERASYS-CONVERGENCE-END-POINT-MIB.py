...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-CONVERGENCE-END-POINT-MIB
...
_EtsysConvEndPointGlobalConfigEnable_Type.__name__ = "EnabledStatus"
...
_EtsysConvEndPointProtocolEnable_Type.__name__ = "EnabledStatus"
...
class _EtsysConvEndPointGlobalConfigAccountEnable_Type(EnabledStatus):
    """Custom type etsysConvEndPointGlobalConfigAccountEnable based on EnabledStatus"""
    defaultValue = 2


_EtsysConvEndPointGlobalConfigAccountEnable_Type.__name__ = "EnabledStatus"
_EtsysConvEndPointGlobalConfigAccountEnable_Object = MibScalar
etsysConvEndPointGlobalConfigAccountEnable = _EtsysConvEndPointGlobalConfigAccountEnable_Object(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 40, 1, 1, 4),
    _EtsysConvEndPointGlobalConfigAccountEnable_Type()
)
etsysConvEndPointGlobalConfigAccountEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    etsysConvEndPointGlobalConfigAccountEnable.setStatus("current")
...
_EtsysConvEndPointConnMacInetAddressType_Type.__name__ = "InetAddressType"
...
class _EtsysConvEndPointConnMacInetAddress_Type(InetAddress):
    """Custom type etsysConvEndPointConnMacInetAddress based on InetAddress"""
    defaultValue = OctetString("")


_EtsysConvEndPointConnMacInetAddress_Type.__name__ = "InetAddress"
...
_EtsysCEPConnMacInetAddressType_Type.__name__ = "InetAddressType"
...
class _EtsysCEPConnMacInetAddress_Type(InetAddress):
    """Custom type etsysCEPConnMacInetAddress based on InetAddress"""
    defaultValue = OctetString("")


_EtsysCEPConnMacInetAddress_Type.__name__ = "InetAddress"
...
_EtsysConvEndPointDetectionAddrType_Type.__name__ = "InetAddressType"
...
class _EtsysConvEndPointDetectionAddr_Type(InetAddress):
    """Custom type etsysConvEndPointDetectionAddr based on InetAddress"""
    defaultValue = OctetString("")


_EtsysConvEndPointDetectionAddr_Type.__name__ = "InetAddress"
...
_EtsysConvEndPointDetectionAddrMaskType_Type.__name__ = "InetAddressType"
...
class _EtsysConvEndPointDetectionAddrMask_Type(InetAddress):
    """Custom type etsysConvEndPointDetectionAddrMask based on InetAddress"""
    defaultValue = OctetString("")


_EtsysConvEndPointDetectionAddrMask_Type.__name__ = "InetAddress"
...
_EtsysCEPPortClearUsers_Type.__name__ = "TruthValue"
...
if mibBuilder.loadTexts:
    etsysConvEndPointGlobalConfigGroup.setStatus("deprecated")
...
etsysConvEndPointGlobalConfigGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 40, 2, 1, 9)
)
etsysConvEndPointGlobalConfigGroup2.setObjects(
      *(("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointGlobalConfigEnable"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointGlobalDefaultPolicyIndex"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointGlobalConfigAccountEnable"))
)
if mibBuilder.loadTexts:
    etsysConvEndPointGlobalConfigGroup2.setStatus("current")
...
etsysConvEndPointCompliance.setObjects(
      *(("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointGlobalConfigGroup"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointStatusGroup"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointConfigGroup"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointDetectionGroup"))
)
if mibBuilder.loadTexts:
...
etsysConvEndPointCompliance2.setObjects(
      *(("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointGlobalConfigGroup"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointStatusGroup2"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointConfigGroup"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointDetectionGroup2"))
)
if mibBuilder.loadTexts:
...
etsysConvEndPointPortConfigCompliance.setObjects(
    ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointPortConfigGroup")
)
if mibBuilder.loadTexts:
...
etsysConvEndPointCiscoVoiceVLANCompliance.setObjects(
    ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointCiscoVoiceVLANGroup")
)
if mibBuilder.loadTexts:
...
etsysConvEndPointCompliance3 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5624, 1, 2, 40, 2, 2, 5)
)
etsysConvEndPointCompliance3.setObjects(
      *(("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointGlobalConfigGroup2"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointStatusGroup2"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointConfigGroup"),
        ("ENTERASYS-CONVERGENCE-END-POINT-MIB", "etsysConvEndPointDetectionGroup2"))
)
if mibBuilder.loadTexts:
    etsysConvEndPointCompliance3.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"ConvEndPointTypes": ConvEndPointTypes,
       ...
       "etsysConvEndPointGlobalConfigGroup2": etsysConvEndPointGlobalConfigGroup2,
