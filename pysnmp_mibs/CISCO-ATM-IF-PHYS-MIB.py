...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-ATM-IF-PHYS-MIB
...
mibBuilder.exportSymbols("CISCO-ATM-IF-PHYS-MIB", ciscoAtmIfPhysMIBCommonGroup=ciscoAtmIfPhysMIBCommonGroup, ciscoAtmIfPhysClockSourceStatus=ciscoAtmIfPhysClockSourceStatus, ciscoAtmIfPhysMIBDs1E1Group=ciscoAtmIfPhysMIBDs1E1Group, ciscoAtmIfPhysLineBuildOut=ciscoAtmIfPhysLineBuildOut, ciscoAtmIfPhysMIBConformance=ciscoAtmIfPhysMIBConformance, ciscoAtmIfPhysStsStreamScrambling=ciscoAtmIfPhysStsStreamScrambling, ciscoAtmIfPhysMIBDs3E3Group=ciscoAtmIfPhysMIBDs3E3Group, ciscoAtmIfPhysMIBSonetGroup=ciscoAtmIfPhysMIBSonetGroup, ciscoAtmIfPhysTable=ciscoAtmIfPhysTable, ciscoAtmIfPhysClockSourcePriority=ciscoAtmIfPhysClockSourcePriority, ciscoAtmIfPhysMIBCompliance=ciscoAtmIfPhysMIBCompliance, ciscoAtmIfPhysPlcpBipViolations=ciscoAtmIfPhysPlcpBipViolations, ciscoAtmIfPhysMIBE1Group=ciscoAtmIfPhysMIBE1Group, ciscoAtmIfPhysStatus=ciscoAtmIfPhysStatus, ciscoAtmIfPhysMIBDs3Group=ciscoAtmIfPhysMIBDs3Group, ciscoAtmIfPhysLcvErrors=ciscoAtmIfPhysLcvErrors, ciscoAtmIfPhysFramingMode=ciscoAtmIfPhysFramingMode, ciscoAtmIfPhysMIBCompliance3=ciscoAtmIfPhysMIBCompliance3, ciscoAtmIfPhysPBitParityErrors=ciscoAtmIfPhysPBitParityErrors, ciscoAtmIfPhysLineFebeErrors=ciscoAtmIfPhysLineFebeErrors, ciscoAtmIfPhysPathFebeErrors=ciscoAtmIfPhysPathFebeErrors, ciscoAtmIfPhysLineParityErrors=ciscoAtmIfPhysLineParityErrors, ciscoAtmIfPhysSectionParityErrors=ciscoAtmIfPhysSectionParityErrors, ciscoAtmIfPhysMIBCompliances=ciscoAtmIfPhysMIBCompliances, ciscoAtmIfPhysLoopbackConfig=ciscoAtmIfPhysLoopbackConfig, ciscoAtmIfPhysDS1BitErrors=ciscoAtmIfPhysDS1BitErrors, ciscoAtmIfPhysTransmitClockSource=ciscoAtmIfPhysTransmitClockSource, ciscoAtmIfPhysE1CrcErrors=ciscoAtmIfPhysE1CrcErrors, ciscoAtmIfPhysCBitParityErrors=ciscoAtmIfPhysCBitParityErrors, ciscoAtmIfPhysMIBSonetGroup2=ciscoAtmIfPhysMIBSonetGroup2, ciscoAtmIfPhysEntry=ciscoAtmIfPhysEntry, PYSNMP_MODULE_ID=ciscoAtmIfPhysMIB, ciscoAtmIfPhysMIBObjects=ciscoAtmIfPhysMIBObjects, ciscoAtmIfPhysLineCode=ciscoAtmIfPhysLineCode, ciscoAtmIfPhysPathParityErrors=ciscoAtmIfPhysPathParityErrors, ciscoAtmIfPhysMIBCompliance2=ciscoAtmIfPhysMIBCompliance2, ciscoAtmIfPhysMIB=ciscoAtmIfPhysMIB, ciscoAtmIfPhysCellPayloadScrambling=ciscoAtmIfPhysCellPayloadScrambling, ciscoAtmIfPhysMIBGroups=ciscoAtmIfPhysMIBGroups, ciscoAtmIfPhysMIBCommonGroup2=ciscoAtmIfPhysMIBCommonGroup2, ciscoAtmIfPhysMIBDs1Group=ciscoAtmIfPhysMIBDs1Group)
