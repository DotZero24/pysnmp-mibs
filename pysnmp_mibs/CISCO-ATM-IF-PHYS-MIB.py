...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ATM-IF-PHYS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:25:33 2025
...
ciscoAtmIfPhysMIBCompliance.setObjects(
    ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBCommonGroup")
)
if mibBuilder.loadTexts:
...
ciscoAtmIfPhysMIBCompliance2.setObjects(
      *(("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBCommonGroup"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBCommonGroup2"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBSonetGroup"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBSonetGroup2"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBDs3E3Group"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBDs3Group"))
)
if mibBuilder.loadTexts:
...
ciscoAtmIfPhysMIBCompliance3.setObjects(
      *(("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBCommonGroup"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBCommonGroup2"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBSonetGroup"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBSonetGroup2"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBDs3E3Group"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBDs3Group"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBDs1E1Group"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBDs1Group"),
        ("CISCO-ATM-IF-PHYS-MIB", "ciscoAtmIfPhysMIBE1Group"))
)
if mibBuilder.loadTexts:
