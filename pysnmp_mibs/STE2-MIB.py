...
ste2=_Ste2_ObjectIdentity((1,3,6,1,4,1,21796,4,9))
_InpTable_Object=MibTable
inpTable=_InpTable_Object((1,3,6,1,4,1,21796,4,9,1))
if mibBuilder.loadTexts:inpTable.setStatus(_A)
_InpEntry_Object=MibTableRow
inpEntry=_InpEntry_Object((1,3,6,1,4,1,21796,4,9,1,1))
...
inpAlarmState=_InpAlarmState_Object((1,3,6,1,4,1,21796,4,9,1,1,4),_InpAlarmState_Type())
inpAlarmState.setMaxAccess(_B)
if mibBuilder.loadTexts:inpAlarmState.setStatus(_A)
_SensTable_Object=MibTable
sensTable=_SensTable_Object((1,3,6,1,4,1,21796,4,9,3))
if mibBuilder.loadTexts:sensTable.setStatus(_A)
_SensEntry_Object=MibTableRow
sensEntry=_SensEntry_Object((1,3,6,1,4,1,21796,4,9,3,1))
...
sensIndex=_SensIndex_Object((1,3,6,1,4,1,21796,4,9,3,1,1),_SensIndex_Type())
...
sensName=_SensName_Object((1,3,6,1,4,1,21796,4,9,3,1,2),_SensName_Type())
...
sensState=_SensState_Object((1,3,6,1,4,1,21796,4,9,3,1,3),_SensState_Type())
...
sensString=_SensString_Object((1,3,6,1,4,1,21796,4,9,3,1,4),_SensString_Type())
...
sensValue=_SensValue_Object((1,3,6,1,4,1,21796,4,9,3,1,5),_SensValue_Type())
