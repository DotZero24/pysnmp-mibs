# SNMP MIB module (FSM7326-REF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/FSM7326-REF-MIB
...
fsm7326 = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 1, 9)
)
if mibBuilder.loadTexts:
    fsm7326.setRevisions(
        ("2003-05-06 12:00",)
    )
