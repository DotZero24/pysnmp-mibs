...
AdminStatus, OperStatus, NpgOperStatus, MjStatus, NumericIndex, SjStatus = mibBuilder.importSymbols("DC-MASTER-TC", "AdminStatus", "OperStatus", "NpgOperStatus", "MjStatus", "NumericIndex", "SjStatus")
...
mibBuilder.exportSymbols("DC-L2VPN-MIB", l2vmBgpRTCfgRT=l2vmBgpRTCfgRT, L2vmMjIfId=L2vmMjIfId, l2vmSjPartnerIndex=l2vmSjPartnerIndex, l2vmMjInterfaceId=l2vmMjInterfaceId, l2vmEntityVpnNotifEnable=l2vmEntityVpnNotifEnable, l2vmSjEntry=l2vmSjEntry, l2vmBgpRTCfgOperStatus=l2vmBgpRTCfgOperStatus, l2vmEntityAdminStatus=l2vmEntityAdminStatus, L2vpnADType=L2vpnADType, l2vmBgpRTCfgVpnIndex=l2vmBgpRTCfgVpnIndex, l2vmBgpRTCfgRowStatus=l2vmBgpRTCfgRowStatus, l2vmSjInterfaceId=l2vmSjInterfaceId, l2vmEntityTable=l2vmEntityTable, l2vmBgpRTCfgType=l2vmBgpRTCfgType, l2vmEntityRetryInterval=l2vmEntityRetryInterval, l2vmSjPartnerType=l2vmSjPartnerType, l2vmEntityRowStatus=l2vmEntityRowStatus, L2vpnPwBindType=L2vpnPwBindType, L2vpnVeIdOrZero=L2vpnVeIdOrZero, l2vmSjJoinStatus=l2vmSjJoinStatus, BgpExtendedCommunity=BgpExtendedCommunity, l2vmEntityRestartDuration=l2vmEntityRestartDuration, l2vmEntityOperStatus=l2vmEntityOperStatus, l2vmMjPartnerType=l2vmMjPartnerType, l2vmMjOperStatus=l2vmMjOperStatus, l2vmMjEntry=l2vmMjEntry, l2vmEntitySupportVpls=l2vmEntitySupportVpls, l2vmBgpRTCfgVpnType=l2vmBgpRTCfgVpnType, l2vmMjSubIndex=l2vmMjSubIndex, l2vmBgpRTCfgIndex=l2vmBgpRTCfgIndex, l2vmEntityRpiFailTimeout=l2vmEntityRpiFailTimeout, l2vmBgpADGroup=l2vmBgpADGroup, l2vmBgpRTCfgTable=l2vmBgpRTCfgTable, l2vpnObjects=l2vpnObjects, L2vpnType=L2vpnType, l2vpnConformance=l2vpnConformance, BgpRouteTargetType=BgpRouteTargetType, l2vmEntityTimerGranularity=l2vmEntityTimerGranularity, l2vmEntityPvpiBufferPoolSize=l2vmEntityPvpiBufferPoolSize, L2vpnSiteId=L2vpnSiteId, l2vmMjPartnerIndex=l2vmMjPartnerIndex, l2vmMjAdminStatus=l2vmMjAdminStatus, l2vpnFrameworkGroup=l2vpnFrameworkGroup, l2vpnFrameworkCompliance=l2vpnFrameworkCompliance, l2vmBgpADCompliance=l2vmBgpADCompliance, l2vmBgpRTCfgAdminStatus=l2vmBgpRTCfgAdminStatus, l2vmEntityNbasePriority=l2vmEntityNbasePriority, l2vmEntityBdpiBufferPoolSize=l2vmEntityBdpiBufferPoolSize, l2vmSjSubIndex=l2vmSjSubIndex, PYSNMP_MODULE_ID=l2vpnMib, BgpRouteDistinguisher=BgpRouteDistinguisher, l2vmEntityEntry=l2vmEntityEntry, l2vmMjJoinStatus=l2vmMjJoinStatus, l2vpnGroups=l2vpnGroups, l2vmEntityVpwsIndexNext=l2vmEntityVpwsIndexNext, L2vpnSigType=L2vpnSigType, L2vmSjIfId=L2vmSjIfId, l2vmEntityVpnNotifBufferPoolSize=l2vmEntityVpnNotifBufferPoolSize, l2vmBgpRTCfgEntry=l2vmBgpRTCfgEntry, l2vmMjTable=l2vmMjTable, l2vmEntityVplsIndexNext=l2vmEntityVplsIndexNext, l2vmEntityRpiBufferPoolSize=l2vmEntityRpiBufferPoolSize, l2vpnCompliances=l2vpnCompliances, l2vmEntityIndex=l2vmEntityIndex, l2vmEntityRescheduleLimit=l2vmEntityRescheduleLimit, l2vmSjTable=l2vmSjTable, l2vpnMib=l2vpnMib, l2vmMjRowStatus=l2vmMjRowStatus)
