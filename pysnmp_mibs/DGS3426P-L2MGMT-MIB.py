...
swL2MgmtMIB=ModuleIdentity((1,3,6,1,4,1,171,11,70,7,2))
...
swL2DevMgmt=_SwL2DevMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,1))
_SwL2DevInfo_ObjectIdentity=ObjectIdentity
swL2DevInfo=_SwL2DevInfo_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,1,1))
...
swDevInfoTotalNumOfPort=_SwDevInfoTotalNumOfPort_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,1),_SwDevInfoTotalNumOfPort_Type())
...
swDevInfoNumOfPortInUse=_SwDevInfoNumOfPortInUse_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,2),_SwDevInfoNumOfPortInUse_Type())
...
swDevModuleInfoTable=_SwDevModuleInfoTable_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,3))
if mibBuilder.loadTexts:swDevModuleInfoTable.setStatus(_A)
_SwDevModuleInfoEntry_Object=MibTableRow
swDevModuleInfoEntry=_SwDevModuleInfoEntry_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,3,1))
...
swDevModuleInfoUnitID=_SwDevModuleInfoUnitID_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,3,1,1),_SwDevModuleInfoUnitID_Type())
...
swDevModuleInfoModuleID=_SwDevModuleInfoModuleID_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,3,1,2),_SwDevModuleInfoModuleID_Type())
...
swDevModuleInfoModuleName=_SwDevModuleInfoModuleName_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,3,1,3),_SwDevModuleInfoModuleName_Type())
...
swDevModuleInfoReversion=_SwDevModuleInfoReversion_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,3,1,4),_SwDevModuleInfoReversion_Type())
...
swDevModuleInfoSerial=_SwDevModuleInfoSerial_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,3,1,5),_SwDevModuleInfoSerial_Type())
...
swDevModuleInfoDescription=_SwDevModuleInfoDescription_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,3,1,6),_SwDevModuleInfoDescription_Type())
...
swDevInfoBootPromVersion=_SwDevInfoBootPromVersion_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,4),_SwDevInfoBootPromVersion_Type())
...
swDevInfoFirmwareVersion=_SwDevInfoFirmwareVersion_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,5),_SwDevInfoFirmwareVersion_Type())
...
swDevInfoFrontPanelLedStatus=_SwDevInfoFrontPanelLedStatus_Object((1,3,6,1,4,1,171,11,70,7,2,1,1,6),_SwDevInfoFrontPanelLedStatus_Type())
...
swL2DevCtrl=_SwL2DevCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,1,2))
...
swL2DevCtrlStpState=_SwL2DevCtrlStpState_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,1),_SwL2DevCtrlStpState_Type())
...
swL2DevCtrlIGMPSnooping=_SwL2DevCtrlIGMPSnooping_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,2),_SwL2DevCtrlIGMPSnooping_Type())
...
swL2DevCtrlIGMPSnoopingMcstRTOnly=_SwL2DevCtrlIGMPSnoopingMcstRTOnly_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,3),_SwL2DevCtrlIGMPSnoopingMcstRTOnly_Type())
...
swL2DevCtrlRmonState=_SwL2DevCtrlRmonState_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,4),_SwL2DevCtrlRmonState_Type())
...
swL2DevCtrlCleanAllStatisticCounter=_SwL2DevCtrlCleanAllStatisticCounter_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,5),_SwL2DevCtrlCleanAllStatisticCounter_Type())
...
swL2DevCtrlVlanIdOfFDBTbl=_SwL2DevCtrlVlanIdOfFDBTbl_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,6),_SwL2DevCtrlVlanIdOfFDBTbl_Type())
...
swL2DevCtrlManagementVlanId=_SwL2DevCtrlManagementVlanId_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,7),_SwL2DevCtrlManagementVlanId_Type())
...
swL2MACNotifyState=_SwL2MACNotifyState_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,8),_SwL2MACNotifyState_Type())
...
swL2MACNotifyHistorySize=_SwL2MACNotifyHistorySize_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,9),_SwL2MACNotifyHistorySize_Type())
...
swL2MACNotifyInterval=_SwL2MACNotifyInterval_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,10),_SwL2MACNotifyInterval_Type())
...
swL2DevCtrlWeb=_SwL2DevCtrlWeb_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,1,2,13))
...
swL2DevCtrlWebState=_SwL2DevCtrlWebState_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,13,1),_SwL2DevCtrlWebState_Type())
...
swL2DevCtrlWebTcpPort=_SwL2DevCtrlWebTcpPort_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,13,2),_SwL2DevCtrlWebTcpPort_Type())
...
swL2DevCtrlTelnet=_SwL2DevCtrlTelnet_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,1,2,14))
...
swL2DevCtrlTelnetState=_SwL2DevCtrlTelnetState_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,14,1),_SwL2DevCtrlTelnetState_Type())
...
swL2DevCtrlTelnetTcpPort=_SwL2DevCtrlTelnetTcpPort_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,14,2),_SwL2DevCtrlTelnetTcpPort_Type())
...
swL2DevCtrlIpAutoconfig=_SwL2DevCtrlIpAutoconfig_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,15),_SwL2DevCtrlIpAutoconfig_Type())
...
swL2DevCtrlClipagingState=_SwL2DevCtrlClipagingState_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,17),_SwL2DevCtrlClipagingState_Type())
...
swL2DevCtrlLLDPState=_SwL2DevCtrlLLDPState_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,18),_SwL2DevCtrlLLDPState_Type())
...
swL2DevCtrlLLDPForwardMessageState=_SwL2DevCtrlLLDPForwardMessageState_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,19),_SwL2DevCtrlLLDPForwardMessageState_Type())
...
swL2DevCtrlVLANTrunkState=_SwL2DevCtrlVLANTrunkState_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,22),_SwL2DevCtrlVLANTrunkState_Type())
...
swL2DevCtrlIGMPSnoopingMaxDataDrivenLearningCount=_SwL2DevCtrlIGMPSnoopingMaxDataDrivenLearningCount_Object((1,3,6,1,4,1,171,11,70,7,2,1,2,23),_SwL2DevCtrlIGMPSnoopingMaxDataDrivenLearningCount_Type())
...
swL2DevAlarm=_SwL2DevAlarm_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,1,3))
...
swL2DevAlarmNewRoot=_SwL2DevAlarmNewRoot_Object((1,3,6,1,4,1,171,11,70,7,2,1,3,1),_SwL2DevAlarmNewRoot_Type())
...
swL2DevAlarmTopologyChange=_SwL2DevAlarmTopologyChange_Object((1,3,6,1,4,1,171,11,70,7,2,1,3,2),_SwL2DevAlarmTopologyChange_Type())
...
swL2DevAlarmLinkChange=_SwL2DevAlarmLinkChange_Object((1,3,6,1,4,1,171,11,70,7,2,1,3,3),_SwL2DevAlarmLinkChange_Type())
...
swL2MultiFilter=_SwL2MultiFilter_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,2))
_SwL2MultiFilterTable_Object=MibTable
swL2MultiFilterTable=_SwL2MultiFilterTable_Object((1,3,6,1,4,1,171,11,70,7,2,2,1))
if mibBuilder.loadTexts:swL2MultiFilterTable.setStatus(_A)
_SwL2MultiFilterEntry_Object=MibTableRow
swL2MultiFilterEntry=_SwL2MultiFilterEntry_Object((1,3,6,1,4,1,171,11,70,7,2,2,1,1))
...
swL2MultiFilterVid=_SwL2MultiFilterVid_Object((1,3,6,1,4,1,171,11,70,7,2,2,1,1,1),_SwL2MultiFilterVid_Type())
...
swL2MultiFilterMode=_SwL2MultiFilterMode_Object((1,3,6,1,4,1,171,11,70,7,2,2,1,1,2),_SwL2MultiFilterMode_Type())
...
swL2PortMgmt=_SwL2PortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,3))
_SwL2PortInfoTable_Object=MibTable
swL2PortInfoTable=_SwL2PortInfoTable_Object((1,3,6,1,4,1,171,11,70,7,2,3,1))
if mibBuilder.loadTexts:swL2PortInfoTable.setStatus(_A)
_SwL2PortInfoEntry_Object=MibTableRow
swL2PortInfoEntry=_SwL2PortInfoEntry_Object((1,3,6,1,4,1,171,11,70,7,2,3,1,1))
...
swL2PortInfoPortIndex=_SwL2PortInfoPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,3,1,1,1),_SwL2PortInfoPortIndex_Type())
...
swL2PortInfoMediumType=_SwL2PortInfoMediumType_Object((1,3,6,1,4,1,171,11,70,7,2,3,1,1,2),_SwL2PortInfoMediumType_Type())
...
swL2PortInfoUnitID=_SwL2PortInfoUnitID_Object((1,3,6,1,4,1,171,11,70,7,2,3,1,1,3),_SwL2PortInfoUnitID_Type())
...
swL2PortInfoType=_SwL2PortInfoType_Object((1,3,6,1,4,1,171,11,70,7,2,3,1,1,4),_SwL2PortInfoType_Type())
...
swL2PortInfoLinkStatus=_SwL2PortInfoLinkStatus_Object((1,3,6,1,4,1,171,11,70,7,2,3,1,1,5),_SwL2PortInfoLinkStatus_Type())
...
swL2PortInfoNwayStatus=_SwL2PortInfoNwayStatus_Object((1,3,6,1,4,1,171,11,70,7,2,3,1,1,6),_SwL2PortInfoNwayStatus_Type())
...
swL2PortInfoErrDisReason=_SwL2PortInfoErrDisReason_Object((1,3,6,1,4,1,171,11,70,7,2,3,1,1,7),_SwL2PortInfoErrDisReason_Type())
...
swL2PortCtrlTable=_SwL2PortCtrlTable_Object((1,3,6,1,4,1,171,11,70,7,2,3,2))
if mibBuilder.loadTexts:swL2PortCtrlTable.setStatus(_A)
_SwL2PortCtrlEntry_Object=MibTableRow
swL2PortCtrlEntry=_SwL2PortCtrlEntry_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1))
...
swL2PortCtrlPortIndex=_SwL2PortCtrlPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,1),_SwL2PortCtrlPortIndex_Type())
...
swL2PortCtrlMediumType=_SwL2PortCtrlMediumType_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,2),_SwL2PortCtrlMediumType_Type())
...
swL2PortCtrlUnitIndex=_SwL2PortCtrlUnitIndex_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,3),_SwL2PortCtrlUnitIndex_Type())
...
swL2PortCtrlAdminState=_SwL2PortCtrlAdminState_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,4),_SwL2PortCtrlAdminState_Type())
...
swL2PortCtrlNwayState=_SwL2PortCtrlNwayState_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,5),_SwL2PortCtrlNwayState_Type())
...
swL2PortCtrlFlowCtrlState=_SwL2PortCtrlFlowCtrlState_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,6),_SwL2PortCtrlFlowCtrlState_Type())
...
swL2PortCtrlLockState=_SwL2PortCtrlLockState_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,7),_SwL2PortCtrlLockState_Type())
...
swL2PortCtrlMACNotifyState=_SwL2PortCtrlMACNotifyState_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,8),_SwL2PortCtrlMACNotifyState_Type())
...
swL2PortCtrlAutoNegRestart=_SwL2PortCtrlAutoNegRestart_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,11),_SwL2PortCtrlAutoNegRestart_Type())
...
swL2PortCtrlAutoNegCapAdvertisedBits=_SwL2PortCtrlAutoNegCapAdvertisedBits_Object((1,3,6,1,4,1,171,11,70,7,2,3,2,1,12),_SwL2PortCtrlAutoNegCapAdvertisedBits_Type())
...
swL2PortCtrlJumboFrame=_SwL2PortCtrlJumboFrame_Object((1,3,6,1,4,1,171,11,70,7,2,3,3),_SwL2PortCtrlJumboFrame_Type())
...
swL2PortCtrlJumboFrameMaxSize=_SwL2PortCtrlJumboFrameMaxSize_Object((1,3,6,1,4,1,171,11,70,7,2,3,4),_SwL2PortCtrlJumboFrameMaxSize_Type())
...
swL2PortCounterCtrlTable=_SwL2PortCounterCtrlTable_Object((1,3,6,1,4,1,171,11,70,7,2,3,6))
if mibBuilder.loadTexts:swL2PortCounterCtrlTable.setStatus(_A)
_SwL2PortCounterCtrlEntry_Object=MibTableRow
swL2PortCounterCtrlEntry=_SwL2PortCounterCtrlEntry_Object((1,3,6,1,4,1,171,11,70,7,2,3,6,1))
...
swL2PortCounterCtrlPortIndex=_SwL2PortCounterCtrlPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,3,6,1,1),_SwL2PortCounterCtrlPortIndex_Type())
...
swL2PortCounterClearCtrl=_SwL2PortCounterClearCtrl_Object((1,3,6,1,4,1,171,11,70,7,2,3,6,1,2),_SwL2PortCounterClearCtrl_Type())
...
swL2PortAutoNegInfoTable=_SwL2PortAutoNegInfoTable_Object((1,3,6,1,4,1,171,11,70,7,2,3,8))
if mibBuilder.loadTexts:swL2PortAutoNegInfoTable.setStatus(_A)
_SwL2PortAutoNegInfoEntry_Object=MibTableRow
swL2PortAutoNegInfoEntry=_SwL2PortAutoNegInfoEntry_Object((1,3,6,1,4,1,171,11,70,7,2,3,8,1))
...
swL2PortAutoNegInfoPortIndex=_SwL2PortAutoNegInfoPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,3,8,1,1),_SwL2PortAutoNegInfoPortIndex_Type())
...
swL2PortAutoNegInfoAdminStatus=_SwL2PortAutoNegInfoAdminStatus_Object((1,3,6,1,4,1,171,11,70,7,2,3,8,1,2),_SwL2PortAutoNegInfoAdminStatus_Type())
...
swL2PortAutoNegInfoCapabilityBits=_SwL2PortAutoNegInfoCapabilityBits_Object((1,3,6,1,4,1,171,11,70,7,2,3,8,1,3),_SwL2PortAutoNegInfoCapabilityBits_Type())
...
swL2PortAutoNegInfoCapAdvertisedBits=_SwL2PortAutoNegInfoCapAdvertisedBits_Object((1,3,6,1,4,1,171,11,70,7,2,3,8,1,4),_SwL2PortAutoNegInfoCapAdvertisedBits_Type())
...
swL2PortAutoNegInfoCapReceivedBits=_SwL2PortAutoNegInfoCapReceivedBits_Object((1,3,6,1,4,1,171,11,70,7,2,3,8,1,5),_SwL2PortAutoNegInfoCapReceivedBits_Type())
...
swL2PortDropCounterTable=_SwL2PortDropCounterTable_Object((1,3,6,1,4,1,171,11,70,7,2,3,9))
if mibBuilder.loadTexts:swL2PortDropCounterTable.setStatus(_A)
_SwL2PortDropCounterEntry_Object=MibTableRow
swL2PortDropCounterEntry=_SwL2PortDropCounterEntry_Object((1,3,6,1,4,1,171,11,70,7,2,3,9,1))
...
swL2PortDropCounterPortIndex=_SwL2PortDropCounterPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,3,9,1,1),_SwL2PortDropCounterPortIndex_Type())
...
swL2PortBufferFullDrops=_SwL2PortBufferFullDrops_Object((1,3,6,1,4,1,171,11,70,7,2,3,9,1,2),_SwL2PortBufferFullDrops_Type())
...
swL2PortACLDrops=_SwL2PortACLDrops_Object((1,3,6,1,4,1,171,11,70,7,2,3,9,1,3),_SwL2PortACLDrops_Type())
...
swL2PortMulticastDrops=_SwL2PortMulticastDrops_Object((1,3,6,1,4,1,171,11,70,7,2,3,9,1,4),_SwL2PortMulticastDrops_Type())
...
swL2PortVLANIngressDrops=_SwL2PortVLANIngressDrops_Object((1,3,6,1,4,1,171,11,70,7,2,3,9,1,5),_SwL2PortVLANIngressDrops_Type())
...
swL2PortStatisTable=_SwL2PortStatisTable_Object((1,3,6,1,4,1,171,11,70,7,2,3,10))
if mibBuilder.loadTexts:swL2PortStatisTable.setStatus(_A)
_SwL2PortStatisEntry_Object=MibTableRow
swL2PortStatisEntry=_SwL2PortStatisEntry_Object((1,3,6,1,4,1,171,11,70,7,2,3,10,1))
...
swL2PortStatisPortIndex=_SwL2PortStatisPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,3,10,1,1),_SwL2PortStatisPortIndex_Type())
...
swL2PortStatisPkts1519to1522Octets=_SwL2PortStatisPkts1519to1522Octets_Object((1,3,6,1,4,1,171,11,70,7,2,3,10,1,2),_SwL2PortStatisPkts1519to1522Octets_Type())
...
swL2PortStatisPkts1519to2047Octets=_SwL2PortStatisPkts1519to2047Octets_Object((1,3,6,1,4,1,171,11,70,7,2,3,10,1,3),_SwL2PortStatisPkts1519to2047Octets_Type())
...
swL2PortStatisPkts2048to4095Octets=_SwL2PortStatisPkts2048to4095Octets_Object((1,3,6,1,4,1,171,11,70,7,2,3,10,1,4),_SwL2PortStatisPkts2048to4095Octets_Type())
...
swL2PortStatisPkts4096to9216Octets=_SwL2PortStatisPkts4096to9216Octets_Object((1,3,6,1,4,1,171,11,70,7,2,3,10,1,5),_SwL2PortStatisPkts4096to9216Octets_Type())
...
swL2PortSfpInfoTable=_SwL2PortSfpInfoTable_Object((1,3,6,1,4,1,171,11,70,7,2,3,11))
if mibBuilder.loadTexts:swL2PortSfpInfoTable.setStatus(_A)
_SwL2PortSfpInfoEntry_Object=MibTableRow
swL2PortSfpInfoEntry=_SwL2PortSfpInfoEntry_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1))
...
swL2PortSfpInfoPortIndex=_SwL2PortSfpInfoPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,1),_SwL2PortSfpInfoPortIndex_Type())
...
swL2PortSfpInfoConnectType=_SwL2PortSfpInfoConnectType_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,2),_SwL2PortSfpInfoConnectType_Type())
...
swL2PortSfpInfoVendorName=_SwL2PortSfpInfoVendorName_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,3),_SwL2PortSfpInfoVendorName_Type())
...
swL2PortSfpInfoVendorPN=_SwL2PortSfpInfoVendorPN_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,4),_SwL2PortSfpInfoVendorPN_Type())
...
swL2PortSfpInfoVendorSN=_SwL2PortSfpInfoVendorSN_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,5),_SwL2PortSfpInfoVendorSN_Type())
...
swL2PortSfpInfoVendorOUI=_SwL2PortSfpInfoVendorOUI_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,6),_SwL2PortSfpInfoVendorOUI_Type())
...
swL2PortSfpInfoVendorRev=_SwL2PortSfpInfoVendorRev_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,7),_SwL2PortSfpInfoVendorRev_Type())
...
swL2PortSfpInfoDateCode=_SwL2PortSfpInfoDateCode_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,8),_SwL2PortSfpInfoDateCode_Type())
...
swL2PortSfpInfoFiberType=_SwL2PortSfpInfoFiberType_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,9),_SwL2PortSfpInfoFiberType_Type())
...
swL2PortSfpInfoBaudRate=_SwL2PortSfpInfoBaudRate_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,10),_SwL2PortSfpInfoBaudRate_Type())
...
swL2PortSfpInfoWavelength=_SwL2PortSfpInfoWavelength_Object((1,3,6,1,4,1,171,11,70,7,2,3,11,1,11),_SwL2PortSfpInfoWavelength_Type())
...
swL2QOSMgmt=_SwL2QOSMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,6))
_SwL2QOSBandwidthControlTable_Object=MibTable
swL2QOSBandwidthControlTable=_SwL2QOSBandwidthControlTable_Object((1,3,6,1,4,1,171,11,70,7,2,6,1))
if mibBuilder.loadTexts:swL2QOSBandwidthControlTable.setStatus(_A)
_SwL2QOSBandwidthControlEntry_Object=MibTableRow
swL2QOSBandwidthControlEntry=_SwL2QOSBandwidthControlEntry_Object((1,3,6,1,4,1,171,11,70,7,2,6,1,1))
...
swL2QOSBandwidthPortIndex=_SwL2QOSBandwidthPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,6,1,1,1),_SwL2QOSBandwidthPortIndex_Type())
...
swL2QOSBandwidthRxRate=_SwL2QOSBandwidthRxRate_Object((1,3,6,1,4,1,171,11,70,7,2,6,1,1,2),_SwL2QOSBandwidthRxRate_Type())
...
swL2QOSBandwidthTxRate=_SwL2QOSBandwidthTxRate_Object((1,3,6,1,4,1,171,11,70,7,2,6,1,1,3),_SwL2QOSBandwidthTxRate_Type())
...
swL2QOSBandwidthRadiusRxRate=_SwL2QOSBandwidthRadiusRxRate_Object((1,3,6,1,4,1,171,11,70,7,2,6,1,1,4),_SwL2QOSBandwidthRadiusRxRate_Type())
...
swL2QOSBandwidthRadiusTxRate=_SwL2QOSBandwidthRadiusTxRate_Object((1,3,6,1,4,1,171,11,70,7,2,6,1,1,5),_SwL2QOSBandwidthRadiusTxRate_Type())
...
swL2QOSSchedulingTable=_SwL2QOSSchedulingTable_Object((1,3,6,1,4,1,171,11,70,7,2,6,2))
if mibBuilder.loadTexts:swL2QOSSchedulingTable.setStatus(_A)
_SwL2QOSSchedulingEntry_Object=MibTableRow
swL2QOSSchedulingEntry=_SwL2QOSSchedulingEntry_Object((1,3,6,1,4,1,171,11,70,7,2,6,2,1))
...
swL2QOSSchedulingPort=_SwL2QOSSchedulingPort_Object((1,3,6,1,4,1,171,11,70,7,2,6,2,1,1),_SwL2QOSSchedulingPort_Type())
...
swL2QOSSchedulingClassID=_SwL2QOSSchedulingClassID_Object((1,3,6,1,4,1,171,11,70,7,2,6,2,1,2),_SwL2QOSSchedulingClassID_Type())
...
swL2QOSSchedulingMaxPkts=_SwL2QOSSchedulingMaxPkts_Object((1,3,6,1,4,1,171,11,70,7,2,6,2,1,3),_SwL2QOSSchedulingMaxPkts_Type())
...
swL2QOSSchedulingMechanism=_SwL2QOSSchedulingMechanism_Object((1,3,6,1,4,1,171,11,70,7,2,6,2,1,4),_SwL2QOSSchedulingMechanism_Type())
...
swL2QOSSchedulingMechanismEffec=_SwL2QOSSchedulingMechanismEffec_Object((1,3,6,1,4,1,171,11,70,7,2,6,2,1,5),_SwL2QOSSchedulingMechanismEffec_Type())
...
swL2QOS8021pUserPriorityTable=_SwL2QOS8021pUserPriorityTable_Object((1,3,6,1,4,1,171,11,70,7,2,6,3))
if mibBuilder.loadTexts:swL2QOS8021pUserPriorityTable.setStatus(_A)
_SwL2QOS8021pUserPriorityEntry_Object=MibTableRow
swL2QOS8021pUserPriorityEntry=_SwL2QOS8021pUserPriorityEntry_Object((1,3,6,1,4,1,171,11,70,7,2,6,3,1))
...
swL2QOS8021pUserPriorityIndex=_SwL2QOS8021pUserPriorityIndex_Object((1,3,6,1,4,1,171,11,70,7,2,6,3,1,1),_SwL2QOS8021pUserPriorityIndex_Type())
...
swL2QOS8021pUserPriorityClass=_SwL2QOS8021pUserPriorityClass_Object((1,3,6,1,4,1,171,11,70,7,2,6,3,1,2),_SwL2QOS8021pUserPriorityClass_Type())
...
swL2QOS8021pDefaultPriorityTable=_SwL2QOS8021pDefaultPriorityTable_Object((1,3,6,1,4,1,171,11,70,7,2,6,4))
...
swL2QOS8021pDefaultPriorityEntry=_SwL2QOS8021pDefaultPriorityEntry_Object((1,3,6,1,4,1,171,11,70,7,2,6,4,1))
...
swL2QOS8021pDefaultPriorityIndex=_SwL2QOS8021pDefaultPriorityIndex_Object((1,3,6,1,4,1,171,11,70,7,2,6,4,1,1),_SwL2QOS8021pDefaultPriorityIndex_Type())
...
swL2QOS8021pDefaultPriority=_SwL2QOS8021pDefaultPriority_Object((1,3,6,1,4,1,171,11,70,7,2,6,4,1,2),_SwL2QOS8021pDefaultPriority_Type())
...
swL2QOS8021pRadiusPriority=_SwL2QOS8021pRadiusPriority_Object((1,3,6,1,4,1,171,11,70,7,2,6,4,1,3),_SwL2QOS8021pRadiusPriority_Type())
...
swL2QOSSchedulingMechanismCtrl=_SwL2QOSSchedulingMechanismCtrl_Object((1,3,6,1,4,1,171,11,70,7,2,6,5),_SwL2QOSSchedulingMechanismCtrl_Type())
...
swL2QOSHolPreventionCtrl=_SwL2QOSHolPreventionCtrl_Object((1,3,6,1,4,1,171,11,70,7,2,6,6),_SwL2QOSHolPreventionCtrl_Type())
...
swCosBandwidthControlTable=_SwCosBandwidthControlTable_Object((1,3,6,1,4,1,171,11,70,7,2,6,7))
if mibBuilder.loadTexts:swCosBandwidthControlTable.setStatus(_A)
_SwCosBandwidthControlEntry_Object=MibTableRow
swCosBandwidthControlEntry=_SwCosBandwidthControlEntry_Object((1,3,6,1,4,1,171,11,70,7,2,6,7,1))
...
swCosBandwidthPort=_SwCosBandwidthPort_Object((1,3,6,1,4,1,171,11,70,7,2,6,7,1,1),_SwCosBandwidthPort_Type())
...
swCosBandwidthClassID=_SwCosBandwidthClassID_Object((1,3,6,1,4,1,171,11,70,7,2,6,7,1,2),_SwCosBandwidthClassID_Type())
...
swCosBandwidthMinRate=_SwCosBandwidthMinRate_Object((1,3,6,1,4,1,171,11,70,7,2,6,7,1,3),_SwCosBandwidthMinRate_Type())
...
swCosBandwidthMaxRate=_SwCosBandwidthMaxRate_Object((1,3,6,1,4,1,171,11,70,7,2,6,7,1,4),_SwCosBandwidthMaxRate_Type())
...
swQosDscpTrustPortCtrlTable=_SwQosDscpTrustPortCtrlTable_Object((1,3,6,1,4,1,171,11,70,7,2,6,8))
if mibBuilder.loadTexts:swQosDscpTrustPortCtrlTable.setStatus(_A)
_SwQosDscpTrustPortCtrlEntry_Object=MibTableRow
swQosDscpTrustPortCtrlEntry=_SwQosDscpTrustPortCtrlEntry_Object((1,3,6,1,4,1,171,11,70,7,2,6,8,1))
...
swQosDscpTrustPortCtrlPortIndex=_SwQosDscpTrustPortCtrlPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,6,8,1,1),_SwQosDscpTrustPortCtrlPortIndex_Type())
...
swQosDscpTrustPortCtrlState=_SwQosDscpTrustPortCtrlState_Object((1,3,6,1,4,1,171,11,70,7,2,6,8,1,2),_SwQosDscpTrustPortCtrlState_Type())
...
swQosDscpMapGlobalCtrlTable=_SwQosDscpMapGlobalCtrlTable_Object((1,3,6,1,4,1,171,11,70,7,2,6,9))
if mibBuilder.loadTexts:swQosDscpMapGlobalCtrlTable.setStatus(_A)
_SwQosDscpMapGlobalCtrlEntry_Object=MibTableRow
swQosDscpMapGlobalCtrlEntry=_SwQosDscpMapGlobalCtrlEntry_Object((1,3,6,1,4,1,171,11,70,7,2,6,9,1))
...
swQosDscpMapGlobalCtrlDscpIndex=_SwQosDscpMapGlobalCtrlDscpIndex_Object((1,3,6,1,4,1,171,11,70,7,2,6,9,1,1),_SwQosDscpMapGlobalCtrlDscpIndex_Type())
...
swQosDscpMapGlobalCtrl8021pPriority=_SwQosDscpMapGlobalCtrl8021pPriority_Object((1,3,6,1,4,1,171,11,70,7,2,6,9,1,2),_SwQosDscpMapGlobalCtrl8021pPriority_Type())
...
swQosDscpMapGlobalCtrlNewDscp=_SwQosDscpMapGlobalCtrlNewDscp_Object((1,3,6,1,4,1,171,11,70,7,2,6,9,1,3),_SwQosDscpMapGlobalCtrlNewDscp_Type())
...
swL2PortSecurityMgmt=_SwL2PortSecurityMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,7))
_SwL2PortSecurityControlTable_Object=MibTable
swL2PortSecurityControlTable=_SwL2PortSecurityControlTable_Object((1,3,6,1,4,1,171,11,70,7,2,7,1))
if mibBuilder.loadTexts:swL2PortSecurityControlTable.setStatus(_A)
_SwL2PortSecurityControlEntry_Object=MibTableRow
swL2PortSecurityControlEntry=_SwL2PortSecurityControlEntry_Object((1,3,6,1,4,1,171,11,70,7,2,7,1,1))
...
swL2PortSecurityPortIndex=_SwL2PortSecurityPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,7,1,1,1),_SwL2PortSecurityPortIndex_Type())
...
swL2PortSecurityMaxLernAddr=_SwL2PortSecurityMaxLernAddr_Object((1,3,6,1,4,1,171,11,70,7,2,7,1,1,2),_SwL2PortSecurityMaxLernAddr_Type())
...
swL2PortSecurityMode=_SwL2PortSecurityMode_Object((1,3,6,1,4,1,171,11,70,7,2,7,1,1,3),_SwL2PortSecurityMode_Type())
...
swL2PortSecurityAdmState=_SwL2PortSecurityAdmState_Object((1,3,6,1,4,1,171,11,70,7,2,7,1,1,4),_SwL2PortSecurityAdmState_Type())
...
swL2PortSecurityDelCtrl=_SwL2PortSecurityDelCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,7,2))
...
swL2PortSecurityDelVlanName=_SwL2PortSecurityDelVlanName_Object((1,3,6,1,4,1,171,11,70,7,2,7,2,1),_SwL2PortSecurityDelVlanName_Type())
...
swL2PortSecurityDelPort=_SwL2PortSecurityDelPort_Object((1,3,6,1,4,1,171,11,70,7,2,7,2,2),_SwL2PortSecurityDelPort_Type())
...
swL2PortSecurityDelMacAddress=_SwL2PortSecurityDelMacAddress_Object((1,3,6,1,4,1,171,11,70,7,2,7,2,3),_SwL2PortSecurityDelMacAddress_Type())
...
swL2PortSecurityDelActivity=_SwL2PortSecurityDelActivity_Object((1,3,6,1,4,1,171,11,70,7,2,7,2,4),_SwL2PortSecurityDelActivity_Type())
...
swL2TrunkMgmt=_SwL2TrunkMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,9))
...
swL2TrunkMaxSupportedEntries=_SwL2TrunkMaxSupportedEntries_Object((1,3,6,1,4,1,171,11,70,7,2,9,1),_SwL2TrunkMaxSupportedEntries_Type())
...
swL2TrunkCurrentNumEntries=_SwL2TrunkCurrentNumEntries_Object((1,3,6,1,4,1,171,11,70,7,2,9,2),_SwL2TrunkCurrentNumEntries_Type())
...
swL2TrunkCtrlTable=_SwL2TrunkCtrlTable_Object((1,3,6,1,4,1,171,11,70,7,2,9,3))
if mibBuilder.loadTexts:swL2TrunkCtrlTable.setStatus(_A)
_SwL2TrunkCtrlEntry_Object=MibTableRow
swL2TrunkCtrlEntry=_SwL2TrunkCtrlEntry_Object((1,3,6,1,4,1,171,11,70,7,2,9,3,1))
...
swL2TrunkIndex=_SwL2TrunkIndex_Object((1,3,6,1,4,1,171,11,70,7,2,9,3,1,1),_SwL2TrunkIndex_Type())
...
swL2TrunkName=_SwL2TrunkName_Object((1,3,6,1,4,1,171,11,70,7,2,9,3,1,2),_SwL2TrunkName_Type())
...
swL2TrunkMasterPort=_SwL2TrunkMasterPort_Object((1,3,6,1,4,1,171,11,70,7,2,9,3,1,3),_SwL2TrunkMasterPort_Type())
...
swL2TrunkMember=_SwL2TrunkMember_Object((1,3,6,1,4,1,171,11,70,7,2,9,3,1,4),_SwL2TrunkMember_Type())
...
swL2TrunkFloodingPort=_SwL2TrunkFloodingPort_Object((1,3,6,1,4,1,171,11,70,7,2,9,3,1,5),_SwL2TrunkFloodingPort_Type())
...
swL2TrunkType=_SwL2TrunkType_Object((1,3,6,1,4,1,171,11,70,7,2,9,3,1,6),_SwL2TrunkType_Type())
...
swL2TrunkState=_SwL2TrunkState_Object((1,3,6,1,4,1,171,11,70,7,2,9,3,1,7),_SwL2TrunkState_Type())
...
swL2TrunkActivePorts=_SwL2TrunkActivePorts_Object((1,3,6,1,4,1,171,11,70,7,2,9,3,1,8),_SwL2TrunkActivePorts_Type())
...
swL2TrunkAlgorithm=_SwL2TrunkAlgorithm_Object((1,3,6,1,4,1,171,11,70,7,2,9,4),_SwL2TrunkAlgorithm_Type())
...
swL2TrunkLACPPortTable=_SwL2TrunkLACPPortTable_Object((1,3,6,1,4,1,171,11,70,7,2,9,5))
if mibBuilder.loadTexts:swL2TrunkLACPPortTable.setStatus(_A)
_SwL2TrunkLACPPortEntry_Object=MibTableRow
swL2TrunkLACPPortEntry=_SwL2TrunkLACPPortEntry_Object((1,3,6,1,4,1,171,11,70,7,2,9,5,1))
...
swL2TrunkLACPPortIndex=_SwL2TrunkLACPPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,9,5,1,1),_SwL2TrunkLACPPortIndex_Type())
...
swL2TrunkLACPPortState=_SwL2TrunkLACPPortState_Object((1,3,6,1,4,1,171,11,70,7,2,9,5,1,2),_SwL2TrunkLACPPortState_Type())
...
swL2TrunkVLANTable=_SwL2TrunkVLANTable_Object((1,3,6,1,4,1,171,11,70,7,2,9,6))
if mibBuilder.loadTexts:swL2TrunkVLANTable.setStatus(_A)
_SwL2TrunkVLANEntry_Object=MibTableRow
swL2TrunkVLANEntry=_SwL2TrunkVLANEntry_Object((1,3,6,1,4,1,171,11,70,7,2,9,6,1))
...
swL2TrunkVLANPort=_SwL2TrunkVLANPort_Object((1,3,6,1,4,1,171,11,70,7,2,9,6,1,1),_SwL2TrunkVLANPort_Type())
...
swL2TrunkVLANState=_SwL2TrunkVLANState_Object((1,3,6,1,4,1,171,11,70,7,2,9,6,1,2),_SwL2TrunkVLANState_Type())
...
swL2MirrorMgmt=_SwL2MirrorMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,10))
...
swL2MirrorLogicTargetPort=_SwL2MirrorLogicTargetPort_Object((1,3,6,1,4,1,171,11,70,7,2,10,1),_SwL2MirrorLogicTargetPort_Type())
...
swL2MirrorPortSourceIngress=_SwL2MirrorPortSourceIngress_Object((1,3,6,1,4,1,171,11,70,7,2,10,2),_SwL2MirrorPortSourceIngress_Type())
...
swL2MirrorPortSourceEgress=_SwL2MirrorPortSourceEgress_Object((1,3,6,1,4,1,171,11,70,7,2,10,3),_SwL2MirrorPortSourceEgress_Type())
...
swL2MirrorPortState=_SwL2MirrorPortState_Object((1,3,6,1,4,1,171,11,70,7,2,10,4),_SwL2MirrorPortState_Type())
...
swL2MirrorGroupTable=_SwL2MirrorGroupTable_Object((1,3,6,1,4,1,171,11,70,7,2,10,5))
if mibBuilder.loadTexts:swL2MirrorGroupTable.setStatus(_A)
_SwL2MirrorGroupEntry_Object=MibTableRow
swL2MirrorGroupEntry=_SwL2MirrorGroupEntry_Object((1,3,6,1,4,1,171,11,70,7,2,10,5,1))
...
swL2MirrorGroupID=_SwL2MirrorGroupID_Object((1,3,6,1,4,1,171,11,70,7,2,10,5,1,1),_SwL2MirrorGroupID_Type())
...
swL2MirrorGroupRowStatus=_SwL2MirrorGroupRowStatus_Object((1,3,6,1,4,1,171,11,70,7,2,10,5,1,2),_SwL2MirrorGroupRowStatus_Type())
...
swL2MirrorGroupState=_SwL2MirrorGroupState_Object((1,3,6,1,4,1,171,11,70,7,2,10,5,1,3),_SwL2MirrorGroupState_Type())
...
swL2MirrorGroupLogicTargetPort=_SwL2MirrorGroupLogicTargetPort_Object((1,3,6,1,4,1,171,11,70,7,2,10,5,1,4),_SwL2MirrorGroupLogicTargetPort_Type())
...
swL2MirrorGroupPortSourceIngress=_SwL2MirrorGroupPortSourceIngress_Object((1,3,6,1,4,1,171,11,70,7,2,10,5,1,5),_SwL2MirrorGroupPortSourceIngress_Type())
...
swL2MirrorGroupPortSourceEngress=_SwL2MirrorGroupPortSourceEngress_Object((1,3,6,1,4,1,171,11,70,7,2,10,5,1,6),_SwL2MirrorGroupPortSourceEngress_Type())
...
swL2IGMPMgmt=_SwL2IGMPMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,11))
...
swL2IGMPMaxSupportedVlans=_SwL2IGMPMaxSupportedVlans_Object((1,3,6,1,4,1,171,11,70,7,2,11,1),_SwL2IGMPMaxSupportedVlans_Type())
...
swL2IGMPMaxIpGroupNumPerVlan=_SwL2IGMPMaxIpGroupNumPerVlan_Object((1,3,6,1,4,1,171,11,70,7,2,11,2),_SwL2IGMPMaxIpGroupNumPerVlan_Type())
...
swL2IGMPCtrlTable=_SwL2IGMPCtrlTable_Object((1,3,6,1,4,1,171,11,70,7,2,11,3))
if mibBuilder.loadTexts:swL2IGMPCtrlTable.setStatus(_A)
_SwL2IGMPCtrlEntry_Object=MibTableRow
swL2IGMPCtrlEntry=_SwL2IGMPCtrlEntry_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1))
...
swL2IGMPCtrlVid=_SwL2IGMPCtrlVid_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,1),_SwL2IGMPCtrlVid_Type())
...
swL2IGMPQueryInterval=_SwL2IGMPQueryInterval_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,2),_SwL2IGMPQueryInterval_Type())
...
swL2IGMPMaxResponseTime=_SwL2IGMPMaxResponseTime_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,3),_SwL2IGMPMaxResponseTime_Type())
...
swL2IGMPRobustness=_SwL2IGMPRobustness_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,4),_SwL2IGMPRobustness_Type())
...
swL2IGMPLastMemberQueryInterval=_SwL2IGMPLastMemberQueryInterval_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,5),_SwL2IGMPLastMemberQueryInterval_Type())
...
swL2IGMPHostTimeout=_SwL2IGMPHostTimeout_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,6),_SwL2IGMPHostTimeout_Type())
...
swL2IGMPRouteTimeout=_SwL2IGMPRouteTimeout_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,7),_SwL2IGMPRouteTimeout_Type())
...
swL2IGMPLeaveTimer=_SwL2IGMPLeaveTimer_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,8),_SwL2IGMPLeaveTimer_Type())
...
swL2IGMPQueryState=_SwL2IGMPQueryState_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,9),_SwL2IGMPQueryState_Type())
...
swL2IGMPCurrentState=_SwL2IGMPCurrentState_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,10),_SwL2IGMPCurrentState_Type())
...
swL2IGMPCtrlState=_SwL2IGMPCtrlState_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,11),_SwL2IGMPCtrlState_Type())
...
swL2IGMPFastLeaveState=_SwL2IGMPFastLeaveState_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,12),_SwL2IGMPFastLeaveState_Type())
...
swL2IGMPQueryVersion=_SwL2IGMPQueryVersion_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,13),_SwL2IGMPQueryVersion_Type())
...
swL2IGMPReportSuppression=_SwL2IGMPReportSuppression_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,15),_SwL2IGMPReportSuppression_Type())
...
swL2IGMPDataDrivenLearningState=_SwL2IGMPDataDrivenLearningState_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,16),_SwL2IGMPDataDrivenLearningState_Type())
...
swL2IGMPDataDrivenLearningAgedOutState=_SwL2IGMPDataDrivenLearningAgedOutState_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,17),_SwL2IGMPDataDrivenLearningAgedOutState_Type())
...
swL2IGMPDataDrivenGroupExpiryTime=_SwL2IGMPDataDrivenGroupExpiryTime_Object((1,3,6,1,4,1,171,11,70,7,2,11,3,1,18),_SwL2IGMPDataDrivenGroupExpiryTime_Type())
...
swL2IGMPQueryInfoTable=_SwL2IGMPQueryInfoTable_Object((1,3,6,1,4,1,171,11,70,7,2,11,4))
if mibBuilder.loadTexts:swL2IGMPQueryInfoTable.setStatus(_A)
_SwL2IGMPQueryInfoEntry_Object=MibTableRow
swL2IGMPQueryInfoEntry=_SwL2IGMPQueryInfoEntry_Object((1,3,6,1,4,1,171,11,70,7,2,11,4,1))
...
swL2IGMPInfoVid=_SwL2IGMPInfoVid_Object((1,3,6,1,4,1,171,11,70,7,2,11,4,1,1),_SwL2IGMPInfoVid_Type())
...
swL2IGMPInfoQueryCount=_SwL2IGMPInfoQueryCount_Object((1,3,6,1,4,1,171,11,70,7,2,11,4,1,2),_SwL2IGMPInfoQueryCount_Type())
...
swL2IGMPInfoTxQueryCount=_SwL2IGMPInfoTxQueryCount_Object((1,3,6,1,4,1,171,11,70,7,2,11,4,1,3),_SwL2IGMPInfoTxQueryCount_Type())
...
swL2IGMPInfoTable=_SwL2IGMPInfoTable_Object((1,3,6,1,4,1,171,11,70,7,2,11,5))
if mibBuilder.loadTexts:swL2IGMPInfoTable.setStatus(_A)
_SwL2IGMPInfoEntry_Object=MibTableRow
swL2IGMPInfoEntry=_SwL2IGMPInfoEntry_Object((1,3,6,1,4,1,171,11,70,7,2,11,5,1))
...
swL2IGMPVid=_SwL2IGMPVid_Object((1,3,6,1,4,1,171,11,70,7,2,11,5,1,1),_SwL2IGMPVid_Type())
...
swL2IGMPGroupIpAddr=_SwL2IGMPGroupIpAddr_Object((1,3,6,1,4,1,171,11,70,7,2,11,5,1,2),_SwL2IGMPGroupIpAddr_Type())
...
swL2IGMPMacAddr=_SwL2IGMPMacAddr_Object((1,3,6,1,4,1,171,11,70,7,2,11,5,1,3),_SwL2IGMPMacAddr_Type())
...
swL2IGMPPortMap=_SwL2IGMPPortMap_Object((1,3,6,1,4,1,171,11,70,7,2,11,5,1,4),_SwL2IGMPPortMap_Type())
...
swL2IGMPIpGroupReportCount=_SwL2IGMPIpGroupReportCount_Object((1,3,6,1,4,1,171,11,70,7,2,11,5,1,5),_SwL2IGMPIpGroupReportCount_Type())
...
swL2IGMPRouterPortsTable=_SwL2IGMPRouterPortsTable_Object((1,3,6,1,4,1,171,11,70,7,2,11,6))
if mibBuilder.loadTexts:swL2IGMPRouterPortsTable.setStatus(_A)
_SwL2IGMPRouterPortsEntry_Object=MibTableRow
swL2IGMPRouterPortsEntry=_SwL2IGMPRouterPortsEntry_Object((1,3,6,1,4,1,171,11,70,7,2,11,6,1))
...
swL2IGMPRouterPortsVid=_SwL2IGMPRouterPortsVid_Object((1,3,6,1,4,1,171,11,70,7,2,11,6,1,1),_SwL2IGMPRouterPortsVid_Type())
...
swL2IGMPRouterStaticPortList=_SwL2IGMPRouterStaticPortList_Object((1,3,6,1,4,1,171,11,70,7,2,11,6,1,2),_SwL2IGMPRouterStaticPortList_Type())
...
swL2IGMPRouterDynamicPortList=_SwL2IGMPRouterDynamicPortList_Object((1,3,6,1,4,1,171,11,70,7,2,11,6,1,3),_SwL2IGMPRouterDynamicPortList_Type())
...
swL2IGMPRouterForbiddenPortList=_SwL2IGMPRouterForbiddenPortList_Object((1,3,6,1,4,1,171,11,70,7,2,11,6,1,4),_SwL2IGMPRouterForbiddenPortList_Type())
...
swL2IGMPMulticastVlanTable=_SwL2IGMPMulticastVlanTable_Object((1,3,6,1,4,1,171,11,70,7,2,11,7))
if mibBuilder.loadTexts:swL2IGMPMulticastVlanTable.setStatus(_A)
_SwL2IGMPMulticastVlanEntry_Object=MibTableRow
swL2IGMPMulticastVlanEntry=_SwL2IGMPMulticastVlanEntry_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1))
...
swL2IGMPMulticastVlanid=_SwL2IGMPMulticastVlanid_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,1),_SwL2IGMPMulticastVlanid_Type())
...
swL2IGMPMulticastVlanName=_SwL2IGMPMulticastVlanName_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,2),_SwL2IGMPMulticastVlanName_Type())
...
swL2IGMPMulticastVlanSourcePort=_SwL2IGMPMulticastVlanSourcePort_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,3),_SwL2IGMPMulticastVlanSourcePort_Type())
...
swL2IGMPMulticastVlanMemberPort=_SwL2IGMPMulticastVlanMemberPort_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,4),_SwL2IGMPMulticastVlanMemberPort_Type())
...
swL2IGMPMulticastVlanTagMemberPort=_SwL2IGMPMulticastVlanTagMemberPort_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,5),_SwL2IGMPMulticastVlanTagMemberPort_Type())
...
swL2IGMPMulticastVlanState=_SwL2IGMPMulticastVlanState_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,6),_SwL2IGMPMulticastVlanState_Type())
...
swL2IGMPMulticastVlanReplaceSourceIp=_SwL2IGMPMulticastVlanReplaceSourceIp_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,7),_SwL2IGMPMulticastVlanReplaceSourceIp_Type())
...
swL2IGMPMulticastVlanRowStatus=_SwL2IGMPMulticastVlanRowStatus_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,8),_SwL2IGMPMulticastVlanRowStatus_Type())
...
swL2IGMPMulticastVlanRemoveAllMcastAddrListAction=_SwL2IGMPMulticastVlanRemoveAllMcastAddrListAction_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,9),_SwL2IGMPMulticastVlanRemoveAllMcastAddrListAction_Type())
...
swL2IGMPMulticastVlanUntagSourcePort=_SwL2IGMPMulticastVlanUntagSourcePort_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,10),_SwL2IGMPMulticastVlanUntagSourcePort_Type())
...
swL2IGMPMulticastVlanRemapPriority=_SwL2IGMPMulticastVlanRemapPriority_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,11),_SwL2IGMPMulticastVlanRemapPriority_Type())
...
swL2IGMPMulticastVlanReplacePriority=_SwL2IGMPMulticastVlanReplacePriority_Object((1,3,6,1,4,1,171,11,70,7,2,11,7,1,12),_SwL2IGMPMulticastVlanReplacePriority_Type())
...
swL2IGMPMulticastVlanGroupTable=_SwL2IGMPMulticastVlanGroupTable_Object((1,3,6,1,4,1,171,11,70,7,2,11,8))
if mibBuilder.loadTexts:swL2IGMPMulticastVlanGroupTable.setStatus(_A)
_SwL2IGMPMulticastVlanGroupEntry_Object=MibTableRow
swL2IGMPMulticastVlanGroupEntry=_SwL2IGMPMulticastVlanGroupEntry_Object((1,3,6,1,4,1,171,11,70,7,2,11,8,1))
...
swL2IGMPMulticastVlanGroupVid=_SwL2IGMPMulticastVlanGroupVid_Object((1,3,6,1,4,1,171,11,70,7,2,11,8,1,1),_SwL2IGMPMulticastVlanGroupVid_Type())
...
swL2IGMPMulticastVlanGroupFromIp=_SwL2IGMPMulticastVlanGroupFromIp_Object((1,3,6,1,4,1,171,11,70,7,2,11,8,1,2),_SwL2IGMPMulticastVlanGroupFromIp_Type())
...
swL2IGMPMulticastVlanGroupToIp=_SwL2IGMPMulticastVlanGroupToIp_Object((1,3,6,1,4,1,171,11,70,7,2,11,8,1,3),_SwL2IGMPMulticastVlanGroupToIp_Type())
...
swL2IGMPMulticastVlanGroupStatus=_SwL2IGMPMulticastVlanGroupStatus_Object((1,3,6,1,4,1,171,11,70,7,2,11,8,1,4),_SwL2IGMPMulticastVlanGroupStatus_Type())
...
swIGMPSnoopingGroupTable=_SwIGMPSnoopingGroupTable_Object((1,3,6,1,4,1,171,11,70,7,2,11,11))
if mibBuilder.loadTexts:swIGMPSnoopingGroupTable.setStatus(_A)
_SwIGMPSnoopingGroupEntry_Object=MibTableRow
swIGMPSnoopingGroupEntry=_SwIGMPSnoopingGroupEntry_Object((1,3,6,1,4,1,171,11,70,7,2,11,11,1))
...
swIGMPSnoopingGroupVid=_SwIGMPSnoopingGroupVid_Object((1,3,6,1,4,1,171,11,70,7,2,11,11,1,1),_SwIGMPSnoopingGroupVid_Type())
...
swIGMPSnoopingGroupGroupAddr=_SwIGMPSnoopingGroupGroupAddr_Object((1,3,6,1,4,1,171,11,70,7,2,11,11,1,2),_SwIGMPSnoopingGroupGroupAddr_Type())
...
swIGMPSnoopingGroupSourceAddr=_SwIGMPSnoopingGroupSourceAddr_Object((1,3,6,1,4,1,171,11,70,7,2,11,11,1,3),_SwIGMPSnoopingGroupSourceAddr_Type())
...
swIGMPSnoopingGroupIncludePortMap=_SwIGMPSnoopingGroupIncludePortMap_Object((1,3,6,1,4,1,171,11,70,7,2,11,11,1,4),_SwIGMPSnoopingGroupIncludePortMap_Type())
...
swIGMPSnoopingGroupExcludePortMap=_SwIGMPSnoopingGroupExcludePortMap_Object((1,3,6,1,4,1,171,11,70,7,2,11,11,1,5),_SwIGMPSnoopingGroupExcludePortMap_Type())
...
swL2IGMPSnoopingStaticGroupTable=_SwL2IGMPSnoopingStaticGroupTable_Object((1,3,6,1,4,1,171,11,70,7,2,11,16))
...
swL2IGMPSnoopingStaticGroupEntry=_SwL2IGMPSnoopingStaticGroupEntry_Object((1,3,6,1,4,1,171,11,70,7,2,11,16,1))
...
swL2IGMPSnoopingStaticGroupVID=_SwL2IGMPSnoopingStaticGroupVID_Object((1,3,6,1,4,1,171,11,70,7,2,11,16,1,1),_SwL2IGMPSnoopingStaticGroupVID_Type())
...
swL2IGMPSnoopingStaticGroupIPaddress=_SwL2IGMPSnoopingStaticGroupIPaddress_Object((1,3,6,1,4,1,171,11,70,7,2,11,16,1,2),_SwL2IGMPSnoopingStaticGroupIPaddress_Type())
...
swL2IGMPSnoopingStaticGroupMemberPortList=_SwL2IGMPSnoopingStaticGroupMemberPortList_Object((1,3,6,1,4,1,171,11,70,7,2,11,16,1,3),_SwL2IGMPSnoopingStaticGroupMemberPortList_Type())
...
swL2IGMPSnoopingStaticGroupRowStatus=_SwL2IGMPSnoopingStaticGroupRowStatus_Object((1,3,6,1,4,1,171,11,70,7,2,11,16,1,4),_SwL2IGMPSnoopingStaticGroupRowStatus_Type())
...
swL2IGMPSnoopingDataDrivenLearningGroupTable=_SwL2IGMPSnoopingDataDrivenLearningGroupTable_Object((1,3,6,1,4,1,171,11,70,7,2,11,20))
...
swL2IGMPSnoopingDataDrivenLearningGroupEntry=_SwL2IGMPSnoopingDataDrivenLearningGroupEntry_Object((1,3,6,1,4,1,171,11,70,7,2,11,20,1))
...
swL2IGMPSnoopingDataDrivenLearningGrpVID=_SwL2IGMPSnoopingDataDrivenLearningGrpVID_Object((1,3,6,1,4,1,171,11,70,7,2,11,20,1,1),_SwL2IGMPSnoopingDataDrivenLearningGrpVID_Type())
...
swL2IGMPSnoopingDataDrivenLearningGrpGrpAddr=_SwL2IGMPSnoopingDataDrivenLearningGrpGrpAddr_Object((1,3,6,1,4,1,171,11,70,7,2,11,20,1,2),_SwL2IGMPSnoopingDataDrivenLearningGrpGrpAddr_Type())
...
swL2IGMPSnoopingDataDrivenLearningGrpRouterPorts=_SwL2IGMPSnoopingDataDrivenLearningGrpRouterPorts_Object((1,3,6,1,4,1,171,11,70,7,2,11,20,1,3),_SwL2IGMPSnoopingDataDrivenLearningGrpRouterPorts_Type())
...
swL2IGMPSnoopingDataDrivenLearningGrpClearGrp=_SwL2IGMPSnoopingDataDrivenLearningGrpClearGrp_Object((1,3,6,1,4,1,171,11,70,7,2,11,20,1,100),_SwL2IGMPSnoopingDataDrivenLearningGrpClearGrp_Type())
...
swL2TrafficSegMgmt=_SwL2TrafficSegMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,14))
_SwL2TrafficSegTable_Object=MibTable
swL2TrafficSegTable=_SwL2TrafficSegTable_Object((1,3,6,1,4,1,171,11,70,7,2,14,1))
if mibBuilder.loadTexts:swL2TrafficSegTable.setStatus(_A)
_SwL2TrafficSegEntry_Object=MibTableRow
swL2TrafficSegEntry=_SwL2TrafficSegEntry_Object((1,3,6,1,4,1,171,11,70,7,2,14,1,1))
...
swL2TrafficSegPort=_SwL2TrafficSegPort_Object((1,3,6,1,4,1,171,11,70,7,2,14,1,1,1),_SwL2TrafficSegPort_Type())
...
swL2TrafficSegForwardPorts=_SwL2TrafficSegForwardPorts_Object((1,3,6,1,4,1,171,11,70,7,2,14,1,1,2),_SwL2TrafficSegForwardPorts_Type())
...
swL2IpLimitedMulticastMgmt=_SwL2IpLimitedMulticastMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,15))
_SwL2IpLimitedMulticastTable_Object=MibTable
swL2IpLimitedMulticastTable=_SwL2IpLimitedMulticastTable_Object((1,3,6,1,4,1,171,11,70,7,2,15,1))
if mibBuilder.loadTexts:swL2IpLimitedMulticastTable.setStatus(_A)
_SwL2IpLimitedMulticastEntry_Object=MibTableRow
swL2IpLimitedMulticastEntry=_SwL2IpLimitedMulticastEntry_Object((1,3,6,1,4,1,171,11,70,7,2,15,1,1))
...
swL2IpLimitedMulticastPortIndex=_SwL2IpLimitedMulticastPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,15,1,1,1),_SwL2IpLimitedMulticastPortIndex_Type())
...
swL2IpLimitedMulticastHead=_SwL2IpLimitedMulticastHead_Object((1,3,6,1,4,1,171,11,70,7,2,15,1,1,2),_SwL2IpLimitedMulticastHead_Type())
...
swL2IpLimitedMulticastTail=_SwL2IpLimitedMulticastTail_Object((1,3,6,1,4,1,171,11,70,7,2,15,1,1,3),_SwL2IpLimitedMulticastTail_Type())
...
swL2IpLimitedMulticastAccess=_SwL2IpLimitedMulticastAccess_Object((1,3,6,1,4,1,171,11,70,7,2,15,1,1,4),_SwL2IpLimitedMulticastAccess_Type())
...
swL2IpLimitedMulticastState=_SwL2IpLimitedMulticastState_Object((1,3,6,1,4,1,171,11,70,7,2,15,1,1,5),_SwL2IpLimitedMulticastState_Type())
...
swL2IpLimitedMulticastDelState=_SwL2IpLimitedMulticastDelState_Object((1,3,6,1,4,1,171,11,70,7,2,15,1,1,6),_SwL2IpLimitedMulticastDelState_Type())
...
swL2MgmtMIBTraps=_SwL2MgmtMIBTraps_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,16))
_SwL2Notify_ObjectIdentity=ObjectIdentity
swL2Notify=_SwL2Notify_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,16,1))
_SwL2NotifyPrefix_ObjectIdentity=ObjectIdentity
swL2NotifyPrefix=_SwL2NotifyPrefix_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,16,1,2))
_SwL2NotifFirmware_ObjectIdentity=ObjectIdentity
swL2NotifFirmware=_SwL2NotifFirmware_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,16,1,2,0))
_SwL2LoopDetectedNotify_ObjectIdentity=ObjectIdentity
swL2LoopDetectedNotify=_SwL2LoopDetectedNotify_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,16,1,2,0,0))
_Swl2NotificationBidings_ObjectIdentity=ObjectIdentity
swl2NotificationBidings=_Swl2NotificationBidings_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,16,1,2,1))
...
swL2macNotifyInfo=_SwL2macNotifyInfo_Object((1,3,6,1,4,1,171,11,70,7,2,16,1,2,1,1),_SwL2macNotifyInfo_Type())
...
swL2VlanLoopDetectVID=_SwL2VlanLoopDetectVID_Object((1,3,6,1,4,1,171,11,70,7,2,16,1,2,1,3),_SwL2VlanLoopDetectVID_Type())
...
swL2VlanMgmt=_SwL2VlanMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,17))
_SwL2VlanTable_Object=MibTable
swL2VlanTable=_SwL2VlanTable_Object((1,3,6,1,4,1,171,11,70,7,2,17,1))
if mibBuilder.loadTexts:swL2VlanTable.setStatus(_A)
_SwL2VlanEntry_Object=MibTableRow
swL2VlanEntry=_SwL2VlanEntry_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1))
...
swL2VlanIndex=_SwL2VlanIndex_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,1),_SwL2VlanIndex_Type())
...
swL2VlanName=_SwL2VlanName_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,2),_SwL2VlanName_Type())
...
swL2VlanType=_SwL2VlanType_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,3),_SwL2VlanType_Type())
...
swL2VlanMemberPorts=_SwL2VlanMemberPorts_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,4),_SwL2VlanMemberPorts_Type())
...
swL2VlanStaticPorts=_SwL2VlanStaticPorts_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,5),_SwL2VlanStaticPorts_Type())
...
swL2VlanStaticTaggedPorts=_SwL2VlanStaticTaggedPorts_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,6),_SwL2VlanStaticTaggedPorts_Type())
...
swL2VlanStaticUntaggedPorts=_SwL2VlanStaticUntaggedPorts_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,7),_SwL2VlanStaticUntaggedPorts_Type())
...
swL2VlanForbiddenPorts=_SwL2VlanForbiddenPorts_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,8),_SwL2VlanForbiddenPorts_Type())
...
swL2VlanCurrentTaggedPorts=_SwL2VlanCurrentTaggedPorts_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,9),_SwL2VlanCurrentTaggedPorts_Type())
...
swL2VlanCurrentUntaggedPorts=_SwL2VlanCurrentUntaggedPorts_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,10),_SwL2VlanCurrentUntaggedPorts_Type())
...
swL2VlanAdvertisementState=_SwL2VlanAdvertisementState_Object((1,3,6,1,4,1,171,11,70,7,2,17,1,1,11),_SwL2VlanAdvertisementState_Type())
...
swL2PVIDAutoAssignmentState=_SwL2PVIDAutoAssignmentState_Object((1,3,6,1,4,1,171,11,70,7,2,17,2),_SwL2PVIDAutoAssignmentState_Type())
...
swL2LoopDetectMgmt=_SwL2LoopDetectMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,18))
_SwL2LoopDetectCtrl_ObjectIdentity=ObjectIdentity
swL2LoopDetectCtrl=_SwL2LoopDetectCtrl_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,18,1))
...
swL2LoopDetectAdminState=_SwL2LoopDetectAdminState_Object((1,3,6,1,4,1,171,11,70,7,2,18,1,1),_SwL2LoopDetectAdminState_Type())
...
swL2LoopDetectInterval=_SwL2LoopDetectInterval_Object((1,3,6,1,4,1,171,11,70,7,2,18,1,2),_SwL2LoopDetectInterval_Type())
...
swL2LoopDetectRecoverTime=_SwL2LoopDetectRecoverTime_Object((1,3,6,1,4,1,171,11,70,7,2,18,1,3),_SwL2LoopDetectRecoverTime_Type())
...
swL2LoopDetectMode=_SwL2LoopDetectMode_Object((1,3,6,1,4,1,171,11,70,7,2,18,1,4),_SwL2LoopDetectMode_Type())
...
swL2LoopDetectTrapMode=_SwL2LoopDetectTrapMode_Object((1,3,6,1,4,1,171,11,70,7,2,18,1,5),_SwL2LoopDetectTrapMode_Type())
...
swL2LoopDetectPortMgmt=_SwL2LoopDetectPortMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,18,2))
_SwL2LoopDetectPortTable_Object=MibTable
swL2LoopDetectPortTable=_SwL2LoopDetectPortTable_Object((1,3,6,1,4,1,171,11,70,7,2,18,2,1))
if mibBuilder.loadTexts:swL2LoopDetectPortTable.setStatus(_A)
_SwL2LoopDetectPortEntry_Object=MibTableRow
swL2LoopDetectPortEntry=_SwL2LoopDetectPortEntry_Object((1,3,6,1,4,1,171,11,70,7,2,18,2,1,1))
...
swL2LoopDetectPortIndex=_SwL2LoopDetectPortIndex_Object((1,3,6,1,4,1,171,11,70,7,2,18,2,1,1,1),_SwL2LoopDetectPortIndex_Type())
...
swL2LoopDetectPortState=_SwL2LoopDetectPortState_Object((1,3,6,1,4,1,171,11,70,7,2,18,2,1,1,2),_SwL2LoopDetectPortState_Type())
...
swL2LoopDetectPortLoopVLAN=_SwL2LoopDetectPortLoopVLAN_Object((1,3,6,1,4,1,171,11,70,7,2,18,2,1,1,3),_SwL2LoopDetectPortLoopVLAN_Type())
...
swL2LoopDetectPortLoopStatus=_SwL2LoopDetectPortLoopStatus_Object((1,3,6,1,4,1,171,11,70,7,2,18,2,1,1,4),_SwL2LoopDetectPortLoopStatus_Type())
...
swL2DhcpLocalRelayMgmt=_SwL2DhcpLocalRelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,70,7,2,24))
...
swL2DhcpLocalRelayState=_SwL2DhcpLocalRelayState_Object((1,3,6,1,4,1,171,11,70,7,2,24,1),_SwL2DhcpLocalRelayState_Type())
...
swL2DhcpLocalRelayVLANTable=_SwL2DhcpLocalRelayVLANTable_Object((1,3,6,1,4,1,171,11,70,7,2,24,2))
if mibBuilder.loadTexts:swL2DhcpLocalRelayVLANTable.setStatus(_A)
_SwL2DhcpLocalRelayVLANEntry_Object=MibTableRow
swL2DhcpLocalRelayVLANEntry=_SwL2DhcpLocalRelayVLANEntry_Object((1,3,6,1,4,1,171,11,70,7,2,24,2,1))
...
swL2DhcpLocalRelayVLANID=_SwL2DhcpLocalRelayVLANID_Object((1,3,6,1,4,1,171,11,70,7,2,24,2,1,1),_SwL2DhcpLocalRelayVLANID_Type())
...
swL2DhcpLocalRelayVLANState=_SwL2DhcpLocalRelayVLANState_Object((1,3,6,1,4,1,171,11,70,7,2,24,2,1,2),_SwL2DhcpLocalRelayVLANState_Type())
swL2DhcpLocalRelayVLANState.setMaxAccess(_D)
if mibBuilder.loadTexts:swL2DhcpLocalRelayVLANState.setStatus(_A)
swL2PortLoopOccurred=NotificationType((1,3,6,1,4,1,171,11,70,7,2,16,1,2,0,0,3))
swL2PortLoopOccurred.setObjects((_E,_K))
if mibBuilder.loadTexts:swL2PortLoopOccurred.setStatus(_A)
swL2PortLoopRestart=NotificationType((1,3,6,1,4,1,171,11,70,7,2,16,1,2,0,0,4))
swL2PortLoopRestart.setObjects((_E,_K))
if mibBuilder.loadTexts:swL2PortLoopRestart.setStatus(_A)
swL2VlanLoopOccurred=NotificationType((1,3,6,1,4,1,171,11,70,7,2,16,1,2,0,0,5))
swL2VlanLoopOccurred.setObjects(*((_E,_K),(_E,_S)))
if mibBuilder.loadTexts:swL2VlanLoopOccurred.setStatus(_A)
swL2VlanLoopRestart=NotificationType((1,3,6,1,4,1,171,11,70,7,2,16,1,2,0,0,6))
swL2VlanLoopRestart.setObjects(*((_E,_K),(_E,_S)))
if mibBuilder.loadTexts:swL2VlanLoopRestart.setStatus(_A)
swL2macNotification=NotificationType((1,3,6,1,4,1,171,11,70,7,2,16,1,2,0,1))
