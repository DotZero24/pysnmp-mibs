...
# Produced by pysmi-1.1.12 at Wed Oct  8 11:04:53 2025
...
mibBuilder.exportSymbols("ATM-FORUM-ILMI40-MIB", atmfSrvcRegPort=atmfSrvcRegPort, atmfVccOperStatus=atmfVccOperStatus, atmfVpcChange=atmfVpcChange, atmfMediaTypes=atmfMediaTypes, atmfVpcAbrTransmitCrm=atmfVpcAbrTransmitCrm, atmfVpcReceiveTrafficDescriptorParam2=atmfVpcReceiveTrafficDescriptorParam2, atmfE1=atmfE1, atmfVpcTransmitTrafficDescriptorParam4=atmfVpcTransmitTrafficDescriptorParam4, atmfVpcTransmitQoSClass=atmfVpcTransmitQoSClass, atmfSrvcRegTable=atmfSrvcRegTable, atmfVpcOperStatus=atmfVpcOperStatus, atmfNoClpScr=atmfNoClpScr, atmfMediaUnknownType=atmfMediaUnknownType, atmfVccTable=atmfVccTable, atmfVpcQoSCategory=atmfVpcQoSCategory, atmfE3=atmfE3, atmfVpcAbrVpi=atmfVpcAbrVpi, atmfPortMediaType=atmfPortMediaType, atmfAtmLayerMinSvccVci=atmfAtmLayerMinSvccVci, atmfAddressPort=atmfAddressPort, atmfVccAbrTransmitIcr=atmfVccAbrTransmitIcr, atmfVccEntry=atmfVccEntry, TruthValue=TruthValue, atmfDs3=atmfDs3, atmfVccTransmitTrafficDescriptorParam5=atmfVccTransmitTrafficDescriptorParam5, atmfPortTransmissionType=atmfPortTransmissionType, atmfMyIpNmAddress=atmfMyIpNmAddress, atmfVpcReceiveTrafficDescriptorParam5=atmfVpcReceiveTrafficDescriptorParam5, atmfClpNoTaggingScr=atmfClpNoTaggingScr, atmfAtmStatsTransmittedCells=atmfAtmStatsTransmittedCells, atmfVpcGroup=atmfVpcGroup, AtmAddress=AtmAddress, atmfVccQoSCategory=atmfVccQoSCategory, atmfVccTransmitTrafficDescriptorType=atmfVccTransmitTrafficDescriptorType, atmfSrvcRegEntry=atmfSrvcRegEntry, atmfVccVci=atmfVccVci, atmfVpcAbrTransmitRdf=atmfVpcAbrTransmitRdf, AtmServiceCategory=AtmServiceCategory, atmfVccAbrPortIndex=atmfVccAbrPortIndex, atmfVccPortIndex=atmfVccPortIndex, atmfAddressGroup=atmfAddressGroup, atmfMediaCoaxCable=atmfMediaCoaxCable, atmfClpNoTaggingNoScr=atmfClpNoTaggingNoScr, atmfAddressRegistrationAdminEntry=atmfAddressRegistrationAdminEntry, atmfT1=atmfT1, atmfMediaSingleMode=atmfMediaSingleMode, atmfNoClpNoScr=atmfNoClpNoScr, atmfAtmStatsEntry=atmfAtmStatsEntry, atmfAtmStatsIndex=atmfAtmStatsIndex, atmfVccReceiveTrafficDescriptorParam5=atmfVccReceiveTrafficDescriptorParam5, atmfVpcTransmitTrafficDescriptorParam2=atmfVpcTransmitTrafficDescriptorParam2, atmfVccAbrVci=atmfVccAbrVci, atmfAddressRegistrationAdminIndex=atmfAddressRegistrationAdminIndex, atmfAtmLayerDeviceType=atmfAtmLayerDeviceType, atmfVccAbrTransmitAdtf=atmfVccAbrTransmitAdtf, atmfMediaUtp=atmfMediaUtp, atmfAtmStatsTable=atmfAtmStatsTable, atmfVpcReceiveTrafficDescriptorParam3=atmfVpcReceiveTrafficDescriptorParam3, atmfVpcTransmitTrafficDescriptorParam1=atmfVpcTransmitTrafficDescriptorParam1, atmfAtmLayerMaxSvccVpi=atmfAtmLayerMaxSvccVpi, atmfSonetSTS12c=atmfSonetSTS12c, atmfAtmLayerEntry=atmfAtmLayerEntry, atmfVpcPortIndex=atmfVpcPortIndex, atmfVpcAbrTransmitTrm=atmfVpcAbrTransmitTrm, atmfVccAbrTransmitNrm=atmfVccAbrTransmitNrm, atmfVccAbrTransmitRif=atmfVccAbrTransmitRif, atmfUnknownType=atmfUnknownType, atmfNetPrefixGroup=atmfNetPrefixGroup, atmfAddressRegistrationAdminStatus=atmfAddressRegistrationAdminStatus, atmfVccTransmitTrafficDescriptorParam4=atmfVccTransmitTrafficDescriptorParam4, atmfAtmLayerMaxSvpcVpi=atmfAtmLayerMaxSvpcVpi, atmfVccTransmitTrafficDescriptorParam2=atmfVccTransmitTrafficDescriptorParam2, atmfVccReceiveFrameDiscard=atmfVccReceiveFrameDiscard, atmfTrafficDescrTypes=atmfTrafficDescrTypes, atmfAtmLayerUniType=atmfAtmLayerUniType, atmfAtmLayerIlmiVersion=atmfAtmLayerIlmiVersion, atmfVccAbrTransmitCrm=atmfVccAbrTransmitCrm, atmfVccReceiveQoSClass=atmfVccReceiveQoSClass, atmfVpcAbrTransmitAdtf=atmfVpcAbrTransmitAdtf, atmfClpTaggingNoScr=atmfClpTaggingNoScr, atmfVpcAbrTransmitCdf=atmfVpcAbrTransmitCdf, atmfVpcAbrTransmitNrm=atmfVpcAbrTransmitNrm, atmfAddressRegistrationAdminGroup=atmfAddressRegistrationAdminGroup, atmfVccReceiveTrafficDescriptorParam1=atmfVccReceiveTrafficDescriptorParam1, atmfVpcAbrPortIndex=atmfVpcAbrPortIndex, atmfVccBestEffortIndicator=atmfVccBestEffortIndicator, atmfNoDescriptor=atmfNoDescriptor, atmfVccReceiveTrafficDescriptorParam4=atmfVccReceiveTrafficDescriptorParam4, atmfVccTransmitTrafficDescriptorParam3=atmfVccTransmitTrafficDescriptorParam3, ClnpAddress=ClnpAddress, atmfPhysicalGroup=atmfPhysicalGroup, atmfVpcAbrTransmitRif=atmfVpcAbrTransmitRif, atmfVccTransmitFrameDiscard=atmfVccTransmitFrameDiscard, atmfAtmLayerMaxVciBits=atmfAtmLayerMaxVciBits, atmForumUni=atmForumUni, atmForumAdmin=atmForumAdmin, atmfMyOsiNmNsapAddress=atmfMyOsiNmNsapAddress, atmfAtmLayerConfiguredVPCs=atmfAtmLayerConfiguredVPCs, atmfVpcReceiveTrafficDescriptorType=atmfVpcReceiveTrafficDescriptorType, atmfVccTransmitTrafficDescriptorParam1=atmfVccTransmitTrafficDescriptorParam1, atmfSrvcRegAns=atmfSrvcRegAns, atmfVccAbrTransmitRdf=atmfVccAbrTransmitRdf, atmfAtmLayerGroup=atmfAtmLayerGroup, atmfVccAbrTransmitCdf=atmfVccAbrTransmitCdf, atmfPortMyIfName=atmfPortMyIfName, atmfAtmLayerNniSigVersion=atmfAtmLayerNniSigVersion, atmfAtmLayerIndex=atmfAtmLayerIndex, atmForum=atmForum, atmfVpcAbrEntry=atmfVpcAbrEntry, atmfVpcAbrTable=atmfVpcAbrTable, atmfVccAbrGroup=atmfVccAbrGroup, atmfVpcTable=atmfVpcTable, atmfMediaMultiMode=atmfMediaMultiMode, atmfPortEntry=atmfPortEntry, atmfAddressStatus=atmfAddressStatus, atmfAtmStatsDroppedReceivedCells=atmfAtmStatsDroppedReceivedCells, atmfVccReceiveTrafficDescriptorType=atmfVccReceiveTrafficDescriptorType, atmfClpTaggingScr=atmfClpTaggingScr, atmfVccReceiveTrafficDescriptorParam3=atmfVccReceiveTrafficDescriptorParam3, atmf4B5B=atmf4B5B, atmfAtmLayerMaxVPCs=atmfAtmLayerMaxVPCs, atmfVccChange=atmfVccChange, atmfPortOperStatus=atmfPortOperStatus, atmfAtmLayerMaxVCCs=atmfAtmLayerMaxVCCs, atmfSrvcRegAddressIndex=atmfSrvcRegAddressIndex, atmfSrvcRegParm1=atmfSrvcRegParm1, atmfPeakRate=atmfPeakRate, atmfVpcServiceCategory=atmfVpcServiceCategory, atmfPortTable=atmfPortTable, atmfAtmLayerUniVersion=atmfAtmLayerUniVersion, atmfVpcTransmitTrafficDescriptorParam3=atmfVpcTransmitTrafficDescriptorParam3, atmfAddressTable=atmfAddressTable, atmfVpcReceiveQoSClass=atmfVpcReceiveQoSClass, atmfSrvcRegLecs=atmfSrvcRegLecs, atmfPortAddress=atmfPortAddress, atmfVccGroup=atmfVccGroup, atmfSonetSTS3c=atmfSonetSTS3c, atmfAddressOrgScope=atmfAddressOrgScope, atmfPortSpecific=atmfPortSpecific, atmfAtmStatsGroup=atmfAtmStatsGroup, atmfAddressAtmAddress=atmfAddressAtmAddress, atmfVccAbrVpi=atmfVccAbrVpi, atmfVpcAbrTransmitIcr=atmfVpcAbrTransmitIcr, atmfVpcReceiveTrafficDescriptorParam1=atmfVpcReceiveTrafficDescriptorParam1, atmfVccVpi=atmfVccVpi, atmfVpcReceiveTrafficDescriptorParam4=atmfVpcReceiveTrafficDescriptorParam4, atmfAtmLayerTable=atmfAtmLayerTable, atmfVpcEntry=atmfVpcEntry, atmfAddressEntry=atmfAddressEntry, atmfMediaStp=atmfMediaStp, atmfMySystemIdentifier=atmfMySystemIdentifier, atmfAtmStatsReceivedCells=atmfAtmStatsReceivedCells, atmfVpcVpi=atmfVpcVpi, atmfVpcBestEffortIndicator=atmfVpcBestEffortIndicator, atmfTransmissionTypes=atmfTransmissionTypes, atmfAddressRegistrationAdminTable=atmfAddressRegistrationAdminTable, atmfVccServiceCategory=atmfVccServiceCategory, atmfPortMyIfIdentifier=atmfPortMyIfIdentifier, atmfSrvcRegServiceID=atmfSrvcRegServiceID, atmfAtmLayerMaxVpiBits=atmfAtmLayerMaxVpiBits, atmfAtmLayerConfiguredVCCs=atmfAtmLayerConfiguredVCCs, atmfSrvcRegTypes=atmfSrvcRegTypes, atmf8B10B=atmf8B10B, atmfVccTransmitQoSClass=atmfVccTransmitQoSClass, atmfVpcTransmitTrafficDescriptorParam5=atmfVpcTransmitTrafficDescriptorParam5, atmfClpNoTaggingMcr=atmfClpNoTaggingMcr, atmfSrvcRegATMAddress=atmfSrvcRegATMAddress, atmfPortIndex=atmfPortIndex, atmfVpcAbrGroup=atmfVpcAbrGroup, atmfVpcTransmitTrafficDescriptorType=atmfVpcTransmitTrafficDescriptorType, atmfSrvcRegistryGroup=atmfSrvcRegistryGroup, atmfVccAbrTable=atmfVccAbrTable, atmfVccReceiveTrafficDescriptorParam2=atmfVccReceiveTrafficDescriptorParam2, atmfVccAbrTransmitTrm=atmfVccAbrTransmitTrm, atmfVccAbrEntry=atmfVccAbrEntry)
