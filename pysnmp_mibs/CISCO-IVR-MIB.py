...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-IVR-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:30:38 2025
...
DomainId, VsanIndex, FcNameId, FcAddressId = mibBuilder.importSymbols("CISCO-ST-TC", "DomainId", "VsanIndex", "FcNameId", "FcAddressId")
...
mibBuilder.exportSymbols("CISCO-IVR-MIB", civrTopologyConfigSwitchWwn=civrTopologyConfigSwitchWwn, civrEnabledDeviceAutoFabricId=civrEnabledDeviceAutoFabricId, civrNotificationGroupRev2=civrNotificationGroupRev2, PYSNMP_MODULE_ID=ciscoIvrMIB, civrTopologyMisConfigReason=civrTopologyMisConfigReason, civrZoneEnforcedZoneReadOnly=civrZoneEnforcedZoneReadOnly, civrZoneMemberRowStatus=civrZoneMemberRowStatus, civrZoneMemberID=civrZoneMemberID, civrTopologyActiveAutoFabricId=civrTopologyActiveAutoFabricId, civrAfidMisConfigVsan=civrAfidMisConfigVsan, civrZoneSetName=civrZoneSetName, civrZoneMemberList=civrZoneMemberList, civrZoneEnforcedZoneMemberAFId=civrZoneEnforcedZoneMemberAFId, civrAddIvrVirtualDomainsVsans4k=civrAddIvrVirtualDomainsVsans4k, civrZoneServerMIBGroups=civrZoneServerMIBGroups, cimIvrZoneset=cimIvrZoneset, civrZoneMemberType=civrZoneMemberType, civrTopologyConfigAutoFabricId=civrTopologyConfigAutoFabricId, civrTopologyActiveSwitchWwn=civrTopologyActiveSwitchWwn, ciscoIvrMIBConformance=ciscoIvrMIBConformance, civrZoneSetEntry=civrZoneSetEntry, civrStatsGroup=civrStatsGroup, civrZoneEnforcedZoneSetActvtTime=civrZoneEnforcedZoneSetActvtTime, CIvrAutonomousFabricId=CIvrAutonomousFabricId, civrZoneMemberVsan=civrZoneMemberVsan, civrTopologyClearConfigured=civrTopologyClearConfigured, civrTopologyDefaultAfidTable=civrTopologyDefaultAfidTable, civrTopologyAfidConfSwitchVsan4k=civrTopologyAfidConfSwitchVsan4k, cimIvrTopology=cimIvrTopology, CIvrZoneMemberType=CIvrZoneMemberType, civrZoneSetActivate=civrZoneSetActivate, civrVsanTopologyAutoDisc=civrVsanTopologyAutoDisc, civrTopologyAfidConfigChecksum=civrTopologyAfidConfigChecksum, civrZoneMemberNumber=civrZoneMemberNumber, cimIvrZoneMember=cimIvrZoneMember, civrTopologyIvrSrvGrpVsan4k=civrTopologyIvrSrvGrpVsan4k, civrTopologyDefaultAfidId=civrTopologyDefaultAfidId, civrZoneTable=civrZoneTable, civrZoneSetActDeactPartialSucss=civrZoneSetActDeactPartialSucss, civrZoneSetActvatDeactvatResult=civrZoneSetActvatDeactvatResult, civrZoneMemberTable=civrZoneMemberTable, civrZoneEnforcedZoneQosPriority=civrZoneEnforcedZoneQosPriority, civrZoneMemberEntry=civrZoneMemberEntry, civrZoneEnforcedZoneMemberEntry=civrZoneEnforcedZoneMemberEntry, civrEnabledDeviceEntry=civrEnabledDeviceEntry, civrTopologyConfigSwitchVsan4k=civrTopologyConfigSwitchVsan4k, civrTopologyActiveEntry=civrTopologyActiveEntry, civrZoneServerMIBCompliance=civrZoneServerMIBCompliance, civrZoneSetStatusTable=civrZoneSetStatusTable, civrTopologyAfidConfSwitchVsan2k=civrTopologyAfidConfSwitchVsan2k, civrZoneServerMIBCompliances=civrZoneServerMIBCompliances, civrZoneSetLastChange=civrZoneSetLastChange, civDomainIdConflictVsan=civDomainIdConflictVsan, civrTopologyActiveSwitchVsan4k=civrTopologyActiveSwitchVsan4k, civrZoneClearFullZoneDb=civrZoneClearFullZoneDb, civrTopologyDefaultAfidEntry=civrTopologyDefaultAfidEntry, civrTopologyAfidConfSwitchWwn=civrTopologyAfidConfSwitchWwn, civrZoneEnforcedZoneTable=civrZoneEnforcedZoneTable, civrZoneTableNextIndex=civrZoneTableNextIndex, civrTopologyAfidConfRowStatus=civrTopologyAfidConfRowStatus, civrTopologyDefaultAfidStatus=civrTopologyDefaultAfidStatus, civrGenericGroup=civrGenericGroup, cimIvrZone=cimIvrZone, civrFcidNatMode=civrFcidNatMode, civrAfidMisConfigRemoteAfid=civrAfidMisConfigRemoteAfid, civrZoneMemberIndex=civrZoneMemberIndex, civrZoneName=civrZoneName, civrZoneEntry=civrZoneEntry, civrTopologyAfidConfId=civrTopologyAfidConfId, civrDomainConflictNotify=civrDomainConflictNotify, civrZoneMemberParentIndex=civrZoneMemberParentIndex, cimIvrConfiguration=cimIvrConfiguration, civrZoneEnforcedZoneSetName=civrZoneEnforcedZoneSetName, civrZoneMemberLunID=civrZoneMemberLunID, civrZoneSetDeActivate=civrZoneSetDeActivate, ciscoIvrMIBNotifications=ciscoIvrMIBNotifications, civrZoneEnforcedZoneMemberList=civrZoneEnforcedZoneMemberList, civrTopologyActiveSwitchVsan2k=civrTopologyActiveSwitchVsan2k, civrAfidConfigNotify=civrAfidConfigNotify, civrZoneSetRowStatus=civrZoneSetRowStatus, civrTopologyActiveTable=civrTopologyActiveTable, civrZoneReadOnly=civrZoneReadOnly, civrTopologyIvrSrvGrpTable=civrTopologyIvrSrvGrpTable, civrAddIvrVirtualDomainsVsans2k=civrAddIvrVirtualDomainsVsans2k, civrEnabledDeviceCapability=civrEnabledDeviceCapability, civrEnabledDeviceSwitchWwn=civrEnabledDeviceSwitchWwn, civrTopologyActivateTime=civrTopologyActivateTime, civrZoneIndex=civrZoneIndex, civrTopologyClearAfidConfig=civrTopologyClearAfidConfig, civrZoneSetIndex=civrZoneSetIndex, civrZoneNumber=civrZoneNumber, civrAfidMisConfigLocalSWwn=civrAfidMisConfigLocalSWwn, civrZoneEnforcedZoneMemberType=civrZoneEnforcedZoneMemberType, civrTopologyAfidConfTable=civrTopologyAfidConfTable, civrZoneConfigurationGroupRev2=civrZoneConfigurationGroupRev2, civrZoneLastChange=civrZoneLastChange, civrAfidMisConfigLocalAfid=civrAfidMisConfigLocalAfid, civrZoneEnforcedZoneSetZoneList=civrZoneEnforcedZoneSetZoneList, civrZoneEnforcedZoneName=civrZoneEnforcedZoneName, civrTopologyAfidConfEntry=civrTopologyAfidConfEntry, civrTopologyConfiguredChecksum=civrTopologyConfiguredChecksum, civrZoneEnforcedZoneEntry=civrZoneEnforcedZoneEntry, civrTopologyConfigRowStatus=civrTopologyConfigRowStatus, civrZoneDeactivationDoneNotify=civrZoneDeactivationDoneNotify, ciscoIvrMIBObjects=ciscoIvrMIBObjects, civrZoneEnforcedZoneMemberTable=civrZoneEnforcedZoneMemberTable, civrTopologyGroup=civrTopologyGroup, civrVirtualDomainsGroup=civrVirtualDomainsGroup, civrTopologyCopyActiveToConfig=civrTopologyCopyActiveToConfig, civrZoneServerMIBComplianceRev2=civrZoneServerMIBComplianceRev2, civrActiveZonesetChecksum=civrActiveZonesetChecksum, civrTopologyIvrSrvGrpRowStatus=civrTopologyIvrSrvGrpRowStatus, ciscoIvrMIB=ciscoIvrMIB, civrZoneQosPriority=civrZoneQosPriority, civrZoneMemberAFId=civrZoneMemberAFId, civrTopologyDefaultAfidChecksum=civrTopologyDefaultAfidChecksum, civrZoneSetStatus=civrZoneSetStatus, civrZoneActivationDoneNotify=civrZoneActivationDoneNotify, civrEnabledDeviceTable=civrEnabledDeviceTable, civrTopologyActiveChecksum=civrTopologyActiveChecksum, civrZoneRowStatus=civrZoneRowStatus, CIvrChecksum=CIvrChecksum, civrZoneServerMIBComplianceRev1=civrZoneServerMIBComplianceRev1, cimIvrGeneric=cimIvrGeneric, civrTopologyConfigEntry=civrTopologyConfigEntry, civrZoneConfigurationGroup=civrZoneConfigurationGroup, civrTopologyActive=civrTopologyActive, civrAfidMisConfigRemoteSWwn=civrAfidMisConfigRemoteSWwn, civrTopologyIvrSrvGrpName=civrTopologyIvrSrvGrpName, civrTopologyConfigTable=civrTopologyConfigTable, civrZoneEnforcedZoneMemberID=civrZoneEnforcedZoneMemberID, cimIvrStats=cimIvrStats, civrZoneEnforcedZoneNumber=civrZoneEnforcedZoneNumber, cimIvrVirtualDomains=cimIvrVirtualDomains, civrZonesetDbChecksum=civrZonesetDbChecksum, civrZoneSetTableNextIndex=civrZoneSetTableNextIndex, civrZoneSetNumber=civrZoneSetNumber, civrTopologyIvrSrvGrpEntry=civrTopologyIvrSrvGrpEntry, civrZoneEnforcedZoneMemberNumber=civrZoneEnforcedZoneMemberNumber, civrZonesetActivateForce=civrZonesetActivateForce, civrZoneMemberFabricId=civrZoneMemberFabricId, civrZoneSetChecksum=civrZoneSetChecksum, civrZoneEnforcedZoneMemberVsan=civrZoneEnforcedZoneMemberVsan, civrTopologyIvrSrvGrpVsan2k=civrTopologyIvrSrvGrpVsan2k, civrZoneSetStatusEntry=civrZoneSetStatusEntry, civrEnabledDeviceDomainId=civrEnabledDeviceDomainId, civrTopologyDefaultAfidSwitchWwn=civrTopologyDefaultAfidSwitchWwn, civrZoneCopyZoneSetEnforcdToFull=civrZoneCopyZoneSetEnforcdToFull, civrTopologyConfigSwitchVsan2k=civrTopologyConfigSwitchVsan2k, civrZoneEnforcedZoneMemberLunID=civrZoneEnforcedZoneMemberLunID, civrTopologyActivate=civrTopologyActivate, civrNotificationGroup=civrNotificationGroup, civrEnabledDeviceVsan=civrEnabledDeviceVsan, civrTopologyGroupRev2=civrTopologyGroupRev2, civrZoneSetZoneList=civrZoneSetZoneList, civrZoneSetTable=civrZoneSetTable)
