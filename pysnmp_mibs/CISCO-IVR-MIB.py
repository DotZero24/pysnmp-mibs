...
DomainId, FcNameId, FcAddressId, VsanIndex = mibBuilder.importSymbols("CISCO-ST-TC", "DomainId", "FcNameId", "FcAddressId", "VsanIndex")
...
mibBuilder.exportSymbols("CISCO-IVR-MIB", civrTopologyGroup=civrTopologyGroup, civrZoneMemberID=civrZoneMemberID, civrZoneSetRowStatus=civrZoneSetRowStatus, civrTopologyDefaultAfidEntry=civrTopologyDefaultAfidEntry, civrTopologyActiveAutoFabricId=civrTopologyActiveAutoFabricId, civrZoneConfigurationGroupRev2=civrZoneConfigurationGroupRev2, civrTopologyActivateTime=civrTopologyActivateTime, civrTopologyDefaultAfidId=civrTopologyDefaultAfidId, civrZoneTable=civrZoneTable, civrTopologyActiveTable=civrTopologyActiveTable, civrTopologyDefaultAfidTable=civrTopologyDefaultAfidTable, civrEnabledDeviceAutoFabricId=civrEnabledDeviceAutoFabricId, civrZoneNumber=civrZoneNumber, civrNotificationGroupRev2=civrNotificationGroupRev2, civrZoneEnforcedZoneMemberLunID=civrZoneEnforcedZoneMemberLunID, civrTopologyConfigSwitchVsan2k=civrTopologyConfigSwitchVsan2k, civrZoneClearFullZoneDb=civrZoneClearFullZoneDb, civrTopologyAfidConfigChecksum=civrTopologyAfidConfigChecksum, civrTopologyConfiguredChecksum=civrTopologyConfiguredChecksum, civrZoneEnforcedZoneQosPriority=civrZoneEnforcedZoneQosPriority, civrZoneEnforcedZoneMemberNumber=civrZoneEnforcedZoneMemberNumber, civrZoneServerMIBGroups=civrZoneServerMIBGroups, civrZoneSetTableNextIndex=civrZoneSetTableNextIndex, civrTopologyAfidConfSwitchWwn=civrTopologyAfidConfSwitchWwn, civrTopologyIvrSrvGrpName=civrTopologyIvrSrvGrpName, civrZoneActivationDoneNotify=civrZoneActivationDoneNotify, ciscoIvrMIBConformance=ciscoIvrMIBConformance, ciscoIvrMIB=ciscoIvrMIB, civrFcidNatMode=civrFcidNatMode, civrTopologyIvrSrvGrpRowStatus=civrTopologyIvrSrvGrpRowStatus, civrZoneSetZoneList=civrZoneSetZoneList, civrZoneMemberParentIndex=civrZoneMemberParentIndex, civrZoneMemberType=civrZoneMemberType, civrTopologyClearAfidConfig=civrTopologyClearAfidConfig, civrZoneEntry=civrZoneEntry, civrTopologyDefaultAfidStatus=civrTopologyDefaultAfidStatus, cimIvrZoneMember=cimIvrZoneMember, civrTopologyIvrSrvGrpEntry=civrTopologyIvrSrvGrpEntry, civrDomainConflictNotify=civrDomainConflictNotify, civrGenericGroup=civrGenericGroup, civrZoneQosPriority=civrZoneQosPriority, civrZoneMemberLunID=civrZoneMemberLunID, cimIvrZoneset=cimIvrZoneset, civrZoneMemberEntry=civrZoneMemberEntry, ciscoIvrMIBObjects=ciscoIvrMIBObjects, cimIvrConfiguration=cimIvrConfiguration, civrStatsGroup=civrStatsGroup, civrZoneSetActDeactPartialSucss=civrZoneSetActDeactPartialSucss, civrZoneConfigurationGroup=civrZoneConfigurationGroup, civrTopologyActiveChecksum=civrTopologyActiveChecksum, civrZoneIndex=civrZoneIndex, civrTopologyActive=civrTopologyActive, cimIvrStats=cimIvrStats, civrTopologyConfigRowStatus=civrTopologyConfigRowStatus, civrAddIvrVirtualDomainsVsans2k=civrAddIvrVirtualDomainsVsans2k, civrTopologyAfidConfId=civrTopologyAfidConfId, civrZoneSetIndex=civrZoneSetIndex, civrZoneMemberNumber=civrZoneMemberNumber, civrTopologyAfidConfEntry=civrTopologyAfidConfEntry, civrZoneMemberList=civrZoneMemberList, civrAfidMisConfigRemoteSWwn=civrAfidMisConfigRemoteSWwn, CIvrChecksum=CIvrChecksum, civrTopologyAfidConfSwitchVsan4k=civrTopologyAfidConfSwitchVsan4k, civrZoneSetStatus=civrZoneSetStatus, CIvrZoneMemberType=CIvrZoneMemberType, civrZoneLastChange=civrZoneLastChange, civrZoneEnforcedZoneSetZoneList=civrZoneEnforcedZoneSetZoneList, civrZoneCopyZoneSetEnforcdToFull=civrZoneCopyZoneSetEnforcdToFull, civrZoneEnforcedZoneTable=civrZoneEnforcedZoneTable, civrTopologyIvrSrvGrpVsan4k=civrTopologyIvrSrvGrpVsan4k, civrZoneSetTable=civrZoneSetTable, civrZoneDeactivationDoneNotify=civrZoneDeactivationDoneNotify, civrTopologyDefaultAfidChecksum=civrTopologyDefaultAfidChecksum, civrVsanTopologyAutoDisc=civrVsanTopologyAutoDisc, civrTopologyConfigTable=civrTopologyConfigTable, cimIvrGeneric=cimIvrGeneric, civrZoneSetLastChange=civrZoneSetLastChange, civrZoneMemberFabricId=civrZoneMemberFabricId, civrTopologyActiveSwitchWwn=civrTopologyActiveSwitchWwn, civrZoneServerMIBComplianceRev1=civrZoneServerMIBComplianceRev1, civrAfidMisConfigLocalAfid=civrAfidMisConfigLocalAfid, civrZoneSetDeActivate=civrZoneSetDeActivate, civrZoneServerMIBCompliances=civrZoneServerMIBCompliances, civrAfidMisConfigVsan=civrAfidMisConfigVsan, civrEnabledDeviceCapability=civrEnabledDeviceCapability, civrZoneReadOnly=civrZoneReadOnly, civrTopologyConfigEntry=civrTopologyConfigEntry, civDomainIdConflictVsan=civDomainIdConflictVsan, civrZoneMemberTable=civrZoneMemberTable, civrZonesetActivateForce=civrZonesetActivateForce, civrZoneSetStatusEntry=civrZoneSetStatusEntry, civrTopologyIvrSrvGrpVsan2k=civrTopologyIvrSrvGrpVsan2k, civrTopologyGroupRev2=civrTopologyGroupRev2, civrZoneSetName=civrZoneSetName, civrAfidMisConfigRemoteAfid=civrAfidMisConfigRemoteAfid, civrTopologyAfidConfSwitchVsan2k=civrTopologyAfidConfSwitchVsan2k, civrZoneTableNextIndex=civrZoneTableNextIndex, civrTopologyActivate=civrTopologyActivate, cimIvrVirtualDomains=cimIvrVirtualDomains, civrEnabledDeviceDomainId=civrEnabledDeviceDomainId, civrZoneEnforcedZoneMemberID=civrZoneEnforcedZoneMemberID, civrAddIvrVirtualDomainsVsans4k=civrAddIvrVirtualDomainsVsans4k, civrZoneSetChecksum=civrZoneSetChecksum, civrTopologyActiveSwitchVsan2k=civrTopologyActiveSwitchVsan2k, civrZoneEnforcedZoneReadOnly=civrZoneEnforcedZoneReadOnly, civrTopologyMisConfigReason=civrTopologyMisConfigReason, civrTopologyDefaultAfidSwitchWwn=civrTopologyDefaultAfidSwitchWwn, cimIvrZone=cimIvrZone, civrTopologyAfidConfTable=civrTopologyAfidConfTable, civrActiveZonesetChecksum=civrActiveZonesetChecksum, civrTopologyActiveEntry=civrTopologyActiveEntry, civrZoneEnforcedZoneMemberEntry=civrZoneEnforcedZoneMemberEntry, civrZoneEnforcedZoneEntry=civrZoneEnforcedZoneEntry, cimIvrTopology=cimIvrTopology, civrEnabledDeviceEntry=civrEnabledDeviceEntry, civrAfidConfigNotify=civrAfidConfigNotify, civrZoneMemberVsan=civrZoneMemberVsan, civrNotificationGroup=civrNotificationGroup, civrZoneEnforcedZoneMemberType=civrZoneEnforcedZoneMemberType, civrZoneEnforcedZoneNumber=civrZoneEnforcedZoneNumber, civrTopologyConfigSwitchVsan4k=civrTopologyConfigSwitchVsan4k, CIvrAutonomousFabricId=CIvrAutonomousFabricId, civrTopologyCopyActiveToConfig=civrTopologyCopyActiveToConfig, civrZoneServerMIBComplianceRev2=civrZoneServerMIBComplianceRev2, civrZoneRowStatus=civrZoneRowStatus, civrZoneSetStatusTable=civrZoneSetStatusTable, civrZoneMemberRowStatus=civrZoneMemberRowStatus, civrZoneEnforcedZoneMemberTable=civrZoneEnforcedZoneMemberTable, civrZoneServerMIBCompliance=civrZoneServerMIBCompliance, civrTopologyActiveSwitchVsan4k=civrTopologyActiveSwitchVsan4k, civrZoneSetActivate=civrZoneSetActivate, civrZoneEnforcedZoneSetName=civrZoneEnforcedZoneSetName, civrEnabledDeviceSwitchWwn=civrEnabledDeviceSwitchWwn, civrZoneSetEntry=civrZoneSetEntry, PYSNMP_MODULE_ID=ciscoIvrMIB, civrTopologyClearConfigured=civrTopologyClearConfigured, civrEnabledDeviceTable=civrEnabledDeviceTable, civrZoneName=civrZoneName, civrEnabledDeviceVsan=civrEnabledDeviceVsan, civrZoneEnforcedZoneSetActvtTime=civrZoneEnforcedZoneSetActvtTime, civrZoneSetActvatDeactvatResult=civrZoneSetActvatDeactvatResult, civrZoneMemberIndex=civrZoneMemberIndex, ciscoIvrMIBNotifications=ciscoIvrMIBNotifications, civrZoneMemberAFId=civrZoneMemberAFId, civrZonesetDbChecksum=civrZonesetDbChecksum, civrZoneEnforcedZoneName=civrZoneEnforcedZoneName, civrZoneEnforcedZoneMemberList=civrZoneEnforcedZoneMemberList, civrZoneEnforcedZoneMemberVsan=civrZoneEnforcedZoneMemberVsan, civrZoneEnforcedZoneMemberAFId=civrZoneEnforcedZoneMemberAFId, civrTopologyConfigSwitchWwn=civrTopologyConfigSwitchWwn, civrTopologyAfidConfRowStatus=civrTopologyAfidConfRowStatus, civrTopologyIvrSrvGrpTable=civrTopologyIvrSrvGrpTable, civrVirtualDomainsGroup=civrVirtualDomainsGroup, civrZoneSetNumber=civrZoneSetNumber, civrTopologyConfigAutoFabricId=civrTopologyConfigAutoFabricId, civrAfidMisConfigLocalSWwn=civrAfidMisConfigLocalSWwn)
