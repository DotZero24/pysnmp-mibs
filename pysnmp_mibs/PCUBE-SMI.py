...
mibBuilder.exportSymbols("PCUBE-SMI", pcube=pcube, PYSNMP_MODULE_ID=pcube, pcubeProducts=pcubeProducts, pcubeMgmt=pcubeMgmt, pcubeWorkgroup=pcubeWorkgroup, pcubeModules=pcubeModules)
