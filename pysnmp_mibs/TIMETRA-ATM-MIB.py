...
atmVclVci, atmVclVpi, atmVplVpi, atmInterfaceCurrentMaxVpiBits, atmInterfaceDs3PlcpAlarmState, atmInterfaceConfVccs, atmInterfaceTCEntry, atmVclEntry, atmInterfaceMaxActiveVpiBits, atmInterfaceCurrentMaxVciBits, atmInterfaceTCAlarmState, aal5VccEntry, atmInterfaceConfEntry, atmInterfaceMaxActiveVciBits, atmVplEntry, atmInterfaceConfVpcs = mibBuilder.importSymbols("ATM-MIB", "atmVclVci", "atmVclVpi", "atmVplVpi", "atmInterfaceCurrentMaxVpiBits", "atmInterfaceDs3PlcpAlarmState", "atmInterfaceConfVccs", "atmInterfaceTCEntry", "atmVclEntry", "atmInterfaceMaxActiveVpiBits", "atmInterfaceCurrentMaxVciBits", "atmInterfaceTCAlarmState", "aal5VccEntry", "atmInterfaceConfEntry", "atmInterfaceMaxActiveVciBits", "atmVplEntry", "atmInterfaceConfVpcs")
AtmVorXLastChange, AtmVorXOperStatus, AtmConnKind, AtmVcIdentifier, AtmTrafficDescrParamIndex, AtmVpIdentifier, AtmVorXAdminStatus, AtmConnCastType = mibBuilder.importSymbols("ATM-TC-MIB", "AtmVorXLastChange", "AtmVorXOperStatus", "AtmConnKind", "AtmVcIdentifier", "AtmTrafficDescrParamIndex", "AtmVpIdentifier", "AtmVorXAdminStatus", "AtmConnCastType")
...
mibBuilder.exportSymbols("TIMETRA-ATM-MIB", tAtmIlmiLinkNeighborMaxVciBits=tAtmIlmiLinkNeighborMaxVciBits, tAtmVplInfoOwner=tAtmVplInfoOwner, tAtmIntfStatsTotalUnknCellsDrp=tAtmIntfStatsTotalUnknCellsDrp, tAtmVclInfoEntry=tAtmVclInfoEntry, tAtmVclInfoOamStatus=tAtmVclInfoOamStatus, tAtmCpStatsClp0CellsTxd=tAtmCpStatsClp0CellsTxd, tAal5VccStatsDrpPacketsRxd=tAal5VccStatsDrpPacketsRxd, tAtmIntfLastUnknVpi=tAtmIntfLastUnknVpi, tAtmCellVclStatsDrpClp0CellsTxd=tAtmCellVclStatsDrpClp0CellsTxd, tAtmIntfStatsTable=tAtmIntfStatsTable, tAtmCpStatsClp0CellsTxdLo=tAtmCpStatsClp0CellsTxdLo, tAtmPlcpSubLayerDown=tAtmPlcpSubLayerDown, tAtmVtlStatisticsTable=tAtmVtlStatisticsTable, tAtmVtlStatsDrpClp0CellsRxd=tAtmVtlStatsDrpClp0CellsRxd, tAtmVtlStatsDrpCellsRxd=tAtmVtlStatsDrpCellsRxd, tmnxAtmVtlInfoGroup=tmnxAtmVtlInfoGroup, tAtmIntfAal5StatsTable=tAtmIntfAal5StatsTable, tAtmIfcStatsDrpCellsRxd=tAtmIfcStatsDrpCellsRxd, tAtmOamVplStatsCrc10Errors=tAtmOamVplStatsCrc10Errors, tAtmCpStatisticsTable=tAtmCpStatisticsTable, tmnxAtmVtlStatisticsGroup=tmnxAtmVtlStatisticsGroup, AtmIlmiLinkUniType=AtmIlmiLinkUniType, tAtmVtlCastType=tAtmVtlCastType, tmnxAtmIfcStatisticsGroup=tmnxAtmIfcStatisticsGroup, tmnxAtmIlmiStatisticsGroup=tmnxAtmIlmiStatisticsGroup, tAtmIntfAal5StatsTotalPktsDrpTxd=tAtmIntfAal5StatsTotalPktsDrpTxd, tAtmIfcLastChange=tAtmIfcLastChange, tAtmIfcReceiveTrafficDescrIndex=tAtmIfcReceiveTrafficDescrIndex, tAtmIlmiLinkReceiveTrafficDescrIndex=tAtmIlmiLinkReceiveTrafficDescrIndex, tAtmOamVclStatsRDICellsTxd=tAtmOamVclStatsRDICellsTxd, tmnxAtmVplInfoGroup=tmnxAtmVplInfoGroup, tAtmIlmiLinkDeviceType=tAtmIlmiLinkDeviceType, tAtmMIBConformance=tAtmMIBConformance, tAtmCellVclStatisticsEntry=tAtmCellVclStatisticsEntry, tAtmPlcpSubLayerClear=tAtmPlcpSubLayerClear, tAtmVtlEndVpi=tAtmVtlEndVpi, tAtmVtlStatsDrpClp0CellsTxd=tAtmVtlStatsDrpClp0CellsTxd, tAtmIntfTotalEgrRtVbrBandwidth=tAtmIntfTotalEgrRtVbrBandwidth, tmnxAtmIfcInfoGroup=tmnxAtmIfcInfoGroup, tAtmVclInfoRxTrafficDescrIdOvr=tAtmVclInfoRxTrafficDescrIdOvr, tAtmTrafficDescObjs=tAtmTrafficDescObjs, tAtmIlmiLinkEstablishConPollIntvl=tAtmIlmiLinkEstablishConPollIntvl, tAtmIlmiLinkOutNoSuchNameErrors=tAtmIlmiLinkOutNoSuchNameErrors, tAtmIlmiLinkOutGetResponsePdus=tAtmIlmiLinkOutGetResponsePdus, tAtmOamVclStatsLoopbackCellsRxd=tAtmOamVclStatsLoopbackCellsRxd, tAtmCpStatsClp0CellsTxdHi=tAtmCpStatsClp0CellsTxdHi, tAtmVtlStatsTotalCellsRxd=tAtmVtlStatsTotalCellsRxd, tAtmSysOamRetryDown=tAtmSysOamRetryDown, tAtmIlmiLinkNeighborSystemIdentifier=tAtmIlmiLinkNeighborSystemIdentifier, tAtmVtlConnKind=tAtmVtlConnKind, tAtmIlmiLinkNeighborMaxVpcs=tAtmIlmiLinkNeighborMaxVpcs, tAtmCpStatsDrpCellsRxd=tAtmCpStatsDrpCellsRxd, tAtmVplObjs=tAtmVplObjs, tAtmIlmiLinkInReadOnlyErrors=tAtmIlmiLinkInReadOnlyErrors, tAtmMaxPeerVccsExceeded=tAtmMaxPeerVccsExceeded, tAal5VccStatsPacketsTxd=tAal5VccStatsPacketsTxd, tAtmIlmiLinkInTrapPdus=tAtmIlmiLinkInTrapPdus, tAtmVplStatisticsEntry=tAtmVplStatisticsEntry, tAtmIlmiLinkRowStatus=tAtmIlmiLinkRowStatus, tAtmIlmiLinkNeighborVersion=tAtmIlmiLinkNeighborVersion, tAtmIfcConnKind=tAtmIfcConnKind, tAtmVplStatsTotalCellsTxd=tAtmVplStatsTotalCellsTxd, tAtmVplStatsTagCells=tAtmVplStatsTagCells, tAtmCellVclStatsDrpCellsRxd=tAtmCellVclStatsDrpCellsRxd, tAtmVtlStartVpi=tAtmVtlStartVpi, tAtmIntfStatsTotalBytesTxd=tAtmIntfStatsTotalBytesTxd, tAtmIlmiLinkStatisticsTable=tAtmIlmiLinkStatisticsTable, tAtmVplInfoEntry=tAtmVplInfoEntry, tAtmOamVclStatsAISCellsRxd=tAtmOamVclStatsAISCellsRxd, tAtmIntfStatsTotalHecErrFixed=tAtmIntfStatsTotalHecErrFixed, tmnxAtmVclStatisticsGroup=tmnxAtmVclStatisticsGroup, tmnxAtmSysConfV4v0Group=tmnxAtmSysConfV4v0Group, tAtmIntfConfIfcs=tAtmIntfConfIfcs, tAtmMdaInfoTable=tAtmMdaInfoTable, tAtmOamVplStatsRDICellsRxd=tAtmOamVplStatsRDICellsRxd, tAtmVtlStatsTotalClp0CellsRxd=tAtmVtlStatsTotalClp0CellsRxd, tAtmOamVplStatsAISCellsRxd=tAtmOamVplStatsAISCellsRxd, tAtmIlmiLinkTable=tAtmIlmiLinkTable, tAtmCpStatsDrpClp0CellsRxd=tAtmCpStatsDrpClp0CellsRxd, tAtmIlmiLinkUniType=tAtmIlmiLinkUniType, tAtmMdaMaxSupportedVccs=tAtmMdaMaxSupportedVccs, tAtmIlmiLinkNeighborDeviceType=tAtmIlmiLinkNeighborDeviceType, tAtmIfcTransmitTrafficDescrIndex=tAtmIfcTransmitTrafficDescrIndex, tAtmVclStatisticsTable=tAtmVclStatisticsTable, tAtmIntfCurrentMaxVccs=tAtmIntfCurrentMaxVccs, AtmIlmiStatus=AtmIlmiStatus, tAtmIlmiLinkOutGetNextRequestPdus=tAtmIlmiLinkOutGetNextRequestPdus, tAtmIlmiLinkOutReadOnlyErrors=tAtmIlmiLinkOutReadOnlyErrors, tAtmIlmiLinkEntry=tAtmIlmiLinkEntry, tAtmIfcInfoEntry=tAtmIfcInfoEntry, tAtmOamVplStatsLoopbackCellsTxd=tAtmOamVplStatsLoopbackCellsTxd, tAtmTCSublayerTable=tAtmTCSublayerTable, tmnxAtmIntfConfV4v0Group=tmnxAtmIntfConfV4v0Group, tAtmIlmiLinkOutTooBigErrors=tAtmIlmiLinkOutTooBigErrors, tAtmOamVclStatsOtherCellsRxd=tAtmOamVclStatsOtherCellsRxd, tAal5VccStatisticsTable=tAal5VccStatisticsTable, timetraATMMIBModule=timetraATMMIBModule, tAtmIlmiLinkLastChanged=tAtmIlmiLinkLastChanged, tAtmIlmiLinkInInvalidSnmpCommunityStringPdus=tAtmIlmiLinkInInvalidSnmpCommunityStringPdus, tAtmIlmiLinkInPdus=tAtmIlmiLinkInPdus, tmnxAtmMIBGroups=tmnxAtmMIBGroups, tAtmVtlStatisticsEntry=tAtmVtlStatisticsEntry, tAtmIntfOperStatus=tAtmIntfOperStatus, tAtmIntfTotalIngrUbrBandwidth=tAtmIntfTotalIngrUbrBandwidth, tAtmIntfAal5StatsTotalCrc32Err=tAtmIntfAal5StatsTotalCrc32Err, tAtmVplStatsDrpClp0CellsRxd=tAtmVplStatsDrpClp0CellsRxd, tAtmVtlObjs=tAtmVtlObjs, tAtmIntfTotalIngrRtVbrBandwidth=tAtmIntfTotalIngrRtVbrBandwidth, tAtmIlmiLinkVersion=tAtmIlmiLinkVersion, tmnxAtmNotificationsR4r0Group=tmnxAtmNotificationsR4r0Group, tAtmVtlStatsTotalBytesRxd=tAtmVtlStatsTotalBytesRxd, tAtmIntfTotalEgrNrtVbrBandwidth=tAtmIntfTotalEgrNrtVbrBandwidth, tAtmIlmiLinkOutGeneralErrors=tAtmIlmiLinkOutGeneralErrors, tAtmIlmiLinkNeighborMaxVpiBits=tAtmIlmiLinkNeighborMaxVpiBits, tAtmTCSublayerHecErrors=tAtmTCSublayerHecErrors, tAtmIlmiLinkInGetNextRequestPdus=tAtmIlmiLinkInGetNextRequestPdus, tAtmVclObjs=tAtmVclObjs, tAtmObjs=tAtmObjs, tAtmIfcRowStatus=tAtmIfcRowStatus, tAtmSysOamLoopbackPeriod=tAtmSysOamLoopbackPeriod, tmnxAtmCellVclStatisticsGroup=tmnxAtmCellVclStatisticsGroup, tAtmVplStatsDrpClp0CellsTxd=tAtmVplStatsDrpClp0CellsTxd, tAtmIntfStatsEntry=tAtmIntfStatsEntry, tAtmMdaInfoEntry=tAtmMdaInfoEntry, tAtmIlmiLinkInSetRequestPdus=tAtmIlmiLinkInSetRequestPdus, tAtmIlmiLinkAdminStatus=tAtmIlmiLinkAdminStatus, tAtmCellVclStatsClp0CellsTxd=tAtmCellVclStatsClp0CellsTxd, tAtmIlmiLinkNeighborUniType=tAtmIlmiLinkNeighborUniType, tAtmCpStatsTotalCellsRxdHi=tAtmCpStatsTotalCellsRxdHi, tAtmMdaConfiguredVccs=tAtmMdaConfiguredVccs, tAtmEpOutOfPeerVpiOrVciRange=tAtmEpOutOfPeerVpiOrVciRange, AtmIlmiLinkDeviceType=AtmIlmiLinkDeviceType, tAtmVtlStatsTotalClp0CellsTxd=tAtmVtlStatsTotalClp0CellsTxd, tAtmCpStatsTagCells=tAtmCpStatsTagCells, tAtmIlmiLinkInBadValueErrors=tAtmIlmiLinkInBadValueErrors, tmnxAtmObsoleteV4v0Group=tmnxAtmObsoleteV4v0Group, tAtmOamVclStatsLoopbackCellsTxd=tAtmOamVclStatsLoopbackCellsTxd, tAtmOamVplStatsLoopbackCellsRxd=tAtmOamVplStatsLoopbackCellsRxd, tAtmTCSublayerObjs=tAtmTCSublayerObjs, tAtmVtlLastChange=tAtmVtlLastChange, tAtmCellVclStatisticsTable=tAtmCellVclStatisticsTable, tAtmIfcOperStatus=tAtmIfcOperStatus, tAtmIlmiLinkTransmitTrafficDescrIndex=tAtmIlmiLinkTransmitTrafficDescrIndex, tAtmIlmiLinkOutTrapPdus=tAtmIlmiLinkOutTrapPdus, tmnxAtmTCSublayerGroup=tmnxAtmTCSublayerGroup, tAtmCellVclStatsClp0CellsRxd=tAtmCellVclStatsClp0CellsRxd, tAtmVtlReceiveTrafficDescrIndex=tAtmVtlReceiveTrafficDescrIndex, tAtmMaxPeerVpcsExceeded=tAtmMaxPeerVpcsExceeded, tAtmMdaObjs=tAtmMdaObjs, tAtmIlmiLinkOperStatus=tAtmIlmiLinkOperStatus, tAtmCpStatsClp0CellsRxd=tAtmCpStatsClp0CellsRxd, tAtmOamVclStatsCrc10Err=tAtmOamVclStatsCrc10Err, tAal5VccStatisticsEntry=tAal5VccStatisticsEntry, tAtmIfcCastType=tAtmIfcCastType, tAtmVtlOperStatus=tAtmVtlOperStatus, tAtmNotifications=tAtmNotifications, tAtmIfcAdminStatus=tAtmIfcAdminStatus, AtmIlmiLinkImeType=AtmIlmiLinkImeType, tAtmVclInfoTable=tAtmVclInfoTable, tAtmVclStatsTotalCellsTxd=tAtmVclStatsTotalCellsTxd, tAtmVclStatsTotalBytesRxd=tAtmVclStatsTotalBytesRxd, tAtmIntfShapedBandwidth=tAtmIntfShapedBandwidth, tAtmCpStatsTotalCellsTxdLo=tAtmCpStatsTotalCellsTxdLo, tAtmMIBV9v0Compliance=tAtmMIBV9v0Compliance, tAtmTcSubLayerClear=tAtmTcSubLayerClear, tAtmIntfAal5StatsEntry=tAtmIntfAal5StatsEntry, tAtmOamVclStatisticsEntry=tAtmOamVclStatisticsEntry, tAtmVplStatsTotalBytesTxd=tAtmVplStatsTotalBytesTxd, tAtmIlmiLinkNegotiatedImeType=tAtmIlmiLinkNegotiatedImeType, tAtmIntfAal5StatsTotalPktsDrpRxd=tAtmIntfAal5StatsTotalPktsDrpRxd, tAtmIntfTotalEgrUbrBandwidth=tAtmIntfTotalEgrUbrBandwidth, tAtmCpStatisticsEntry=tAtmCpStatisticsEntry, tmnxAtmNotifyPrefix=tmnxAtmNotifyPrefix, tAtmIlmiLinkStatusChange=tAtmIlmiLinkStatusChange, tAtmSystemObjs=tAtmSystemObjs, tAtmVplStatisticsTable=tAtmVplStatisticsTable, tAtmVtlInfoEntry=tAtmVtlInfoEntry, tAtmVtlAdminStatus=tAtmVtlAdminStatus, tAtmIntfAal5StatsTotalPktsRxd=tAtmIntfAal5StatsTotalPktsRxd, tAtmIntfLastUnknVci=tAtmIntfLastUnknVci, tAal5VccStatsPacketsRxd=tAal5VccStatsPacketsRxd, tmnxAtmMIBCompliances=tmnxAtmMIBCompliances, tmnxAtmVclInfoGroup=tmnxAtmVclInfoGroup, tAtmIlmiLinkOutSetRequestPdus=tAtmIlmiLinkOutSetRequestPdus, tAtmVtlStatsTagCells=tAtmVtlStatsTagCells, tAtmIntfTotalIngrNrtVbrBandwidth=tAtmIntfTotalIngrNrtVbrBandwidth, tAtmVtlInfoTable=tAtmVtlInfoTable, tAtmMdaConfiguredVpcs=tAtmMdaConfiguredVpcs, tAtmOamVclStatsRDICellsRxd=tAtmOamVclStatsRDICellsRxd, tAtmIlmiLinkObjs=tAtmIlmiLinkObjs, tAtmMIBV4v0Compliance=tAtmMIBV4v0Compliance, tmnxAtmIntfStatsV4v0Group=tmnxAtmIntfStatsV4v0Group, tAtmIntfStatsTotalCellsTxd=tAtmIntfStatsTotalCellsTxd, tAtmVtlStatsTotalBytesTxd=tAtmVtlStatsTotalBytesTxd, tAtmIntfStatsTotalCellsRxd=tAtmIntfStatsTotalCellsRxd, tAtmIntfConfEntry=tAtmIntfConfEntry, tAtmTCSublayerEntry=tAtmTCSublayerEntry, tAtmIntfStatsTotalBytesRxd=tAtmIntfStatsTotalBytesRxd, tAtmIfcStatsTotalCellsTxd=tAtmIfcStatsTotalCellsTxd, tAtmIfcStatsTotalBytesTxd=tAtmIfcStatsTotalBytesTxd, tAtmVplStatsTotalClp0CellsTxd=tAtmVplStatsTotalClp0CellsTxd, tmnxAtmVplStatisticsGroup=tmnxAtmVplStatisticsGroup, tAtmIntfTotalEgrCbrBandwidth=tAtmIntfTotalEgrCbrBandwidth, tAtmIntfObjs=tAtmIntfObjs, tAtmVtlStatsTotalCellsTxd=tAtmVtlStatsTotalCellsTxd, tAtmCpStatsDrpClp0CellsTxd=tAtmCpStatsDrpClp0CellsTxd, tAtmCpStatsClp0CellsRxdHi=tAtmCpStatsClp0CellsRxdHi, AtmIlmiLinkVersion=AtmIlmiLinkVersion, tAal5VccObjs=tAal5VccObjs, tAtmIlmiLinkInGetRequestPdus=tAtmIlmiLinkInGetRequestPdus, tAtmVtlRowStatus=tAtmVtlRowStatus, tAtmVtlTransmitTrafficDescrIndex=tAtmVtlTransmitTrafficDescrIndex, tAtmVclInfoIlmiStatus=tAtmVclInfoIlmiStatus, AtmLlid=AtmLlid, tAtmCpStatsTotalCellsRxd=tAtmCpStatsTotalCellsRxd, tAtmIfcStatisticsTable=tAtmIfcStatisticsTable, tAtmIfcStatsTotalBytesRxd=tAtmIfcStatsTotalBytesRxd, tAtmOamVclStatisticsTable=tAtmOamVclStatisticsTable, PYSNMP_MODULE_ID=timetraATMMIBModule, tAtmOamVplStatisticsTable=tAtmOamVplStatisticsTable, tAal5VccStatsDrpPacketsTxd=tAal5VccStatsDrpPacketsTxd, tAtmVplStatsTotalBytesRxd=tAtmVplStatsTotalBytesRxd, tAtmOamVplStatsOtherCellsRxd=tAtmOamVplStatsOtherCellsRxd, tAtmCpStatsTotalCellsTxdHi=tAtmCpStatsTotalCellsTxdHi, tAtmSysLlid=tAtmSysLlid, tmnxAtmIlmiLinkGroup=tmnxAtmIlmiLinkGroup, tmnxAtmCpStatisticsGroup=tmnxAtmCpStatisticsGroup, tAtmOamVplStatsAISCellsTxd=tAtmOamVplStatsAISCellsTxd, tAtmIfcStatsTotalClp0CellsTxd=tAtmIfcStatsTotalClp0CellsTxd, tAtmVplStatsTotalClp0CellsRxd=tAtmVplStatsTotalClp0CellsRxd, tAtmIntfCurrentMaxVpcs=tAtmIntfCurrentMaxVpcs, tAtmIfcStatsTagCells=tAtmIfcStatsTagCells, tAtmIfcStatsTotalClp0CellsRxd=tAtmIfcStatsTotalClp0CellsRxd, tAtmIfcStatsTotalCellsRxd=tAtmIfcStatsTotalCellsRxd, tAtmCpStatsClp0CellsRxdLo=tAtmCpStatsClp0CellsRxdLo, tAtmIlmiLinkInGetResponsePdus=tAtmIlmiLinkInGetResponsePdus, tAtmIfcInfoTable=tAtmIfcInfoTable, tAtmVplInfoTable=tAtmVplInfoTable, tAtmIlmiLinkNeighborIfIdentifier=tAtmIlmiLinkNeighborIfIdentifier, tAtmVplInfoIlmiStatus=tAtmVplInfoIlmiStatus, tAtmIlmiLinkConPollInactFactor=tAtmIlmiLinkConPollInactFactor, tAtmIfcStatisticsEntry=tAtmIfcStatisticsEntry, tAtmIlmiLinkVci=tAtmIlmiLinkVci, tAtmVplStatsDrpCellsRxd=tAtmVplStatsDrpCellsRxd, tAtmIlmiLinkOutPdus=tAtmIlmiLinkOutPdus, tAtmIlmiLinkFsmState=tAtmIlmiLinkFsmState, tAtmOamVplStatisticsEntry=tAtmOamVplStatisticsEntry, tAtmIlmiLinkInTooBigErrors=tAtmIlmiLinkInTooBigErrors, tAtmIlmiLinkOutGetRequestPdus=tAtmIlmiLinkOutGetRequestPdus, tAtmCpStatsTotalCellsRxdLo=tAtmCpStatsTotalCellsRxdLo, tAtmVtlInfoOwner=tAtmVtlInfoOwner, tAtmIlmiLinkNeighborMaxVccs=tAtmIlmiLinkNeighborMaxVccs, tAtmCellVclStatsDrpClp0CellsRxd=tAtmCellVclStatsDrpClp0CellsRxd, tAtmIfcStatsDrpClp0CellsRxd=tAtmIfcStatsDrpClp0CellsRxd)
mibBuilder.exportSymbols("TIMETRA-ATM-MIB", tAtmIlmiLinkInInvalidSnmpVersionPdus=tAtmIlmiLinkInInvalidSnmpVersionPdus, tmnxAtmObsoleteV3v0Group=tmnxAtmObsoleteV3v0Group, tAtmVclInfoTxTrafficDescrIdOvr=tAtmVclInfoTxTrafficDescrIdOvr, tAtmCpObjs=tAtmCpObjs, tAtmMdaMaxSupportedVpcs=tAtmMdaMaxSupportedVpcs, tAtmVclStatsTotalBytesTxd=tAtmVclStatsTotalBytesTxd, tAtmIntfStatsTotalHecErr=tAtmIntfStatsTotalHecErr, tAtmIntfBandwidth=tAtmIntfBandwidth, tAtmIlmiLinkCheckConPollIntvl=tAtmIlmiLinkCheckConPollIntvl, tAtmIlmiLinkInInvalidSnmpFormatPdus=tAtmIlmiLinkInInvalidSnmpFormatPdus, tAtmIntfAal5StatsTotalPktsTxd=tAtmIntfAal5StatsTotalPktsTxd, AtmOamStatus=AtmOamStatus, tAtmCellVclStatsTagCells=tAtmCellVclStatsTagCells, tAtmIlmiLinkStatisticsEntry=tAtmIlmiLinkStatisticsEntry, tAtmIlmiLinkInGeneralErrors=tAtmIlmiLinkInGeneralErrors, tAtmTcSubLayerDown=tAtmTcSubLayerDown, tAtmIfcStatsDrpClp0CellsTxd=tAtmIfcStatsDrpClp0CellsTxd, AtmConnectionOwner=AtmConnectionOwner, tAtmIlmiLinkInNoSuchNameErrors=tAtmIlmiLinkInNoSuchNameErrors, tAtmSysOamRetryUp=tAtmSysOamRetryUp, tAtmIntfConfTable=tAtmIntfConfTable, tAtmOamVclStatsAISCellsTxd=tAtmOamVclStatsAISCellsTxd, tmnxAtmAal5VccStatisticsGroup=tmnxAtmAal5VccStatisticsGroup, tAtmIlmiLinkVpi=tAtmIlmiLinkVpi, tAtmVclStatsTotalCellsRxd=tAtmVclStatsTotalCellsRxd, tAtmIntfTotalIngrCbrBandwidth=tAtmIntfTotalIngrCbrBandwidth, tAtmVplStatsTotalCellsRxd=tAtmVplStatsTotalCellsRxd, tAtmIlmiLinkNegotiatedVersion=tAtmIlmiLinkNegotiatedVersion, tAtmVplInfoOamStatus=tAtmVplInfoOamStatus, tAtmVclInfoOwner=tAtmVclInfoOwner, tmnxAtmVclInfoGroupV9v0=tmnxAtmVclInfoGroupV9v0, tAtmIlmiLinkImeType=tAtmIlmiLinkImeType, tAtmIntfConfVtcs=tAtmIntfConfVtcs, tAtmVclStatisticsEntry=tAtmVclStatisticsEntry, tAtmIlmiLinkOutBadValueErrors=tAtmIlmiLinkOutBadValueErrors, tAtmCellVclObjs=tAtmCellVclObjs, tAtmIfcInfoOwner=tAtmIfcInfoOwner, tAtmOamVplStatsRDICellsTxd=tAtmOamVplStatsRDICellsTxd, tAtmCpStatsTotalCellsTxd=tAtmCpStatsTotalCellsTxd, tAtmTCSublayerHecErrorsFixed=tAtmTCSublayerHecErrorsFixed)
