...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-ATM-MIB
...
_TAtmVtlCastType_Type.__name__ = "AtmConnCastType"
...
tAtmSysLlid.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
tAtmSysOamRetryUp.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
tAtmSysOamRetryDown.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
tAtmSysOamLoopbackPeriod.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
_TAtmIlmiLinkVpi_Type.__name__ = "AtmVpIdentifier"
...
_TAtmIlmiLinkVci_Type.__name__ = "AtmVcIdentifier"
...
_TAtmIlmiLinkReceiveTrafficDescrIndex_Type.__name__ = "AtmTrafficDescrParamIndex"
...
_TAtmIlmiLinkTransmitTrafficDescrIndex_Type.__name__ = "AtmTrafficDescrParamIndex"
...
_TAtmIlmiLinkVersion_Type.__name__ = "AtmIlmiLinkVersion"
...
_TAtmIlmiLinkImeType_Type.__name__ = "AtmIlmiLinkImeType"
...
_TAtmIlmiLinkNeighborUniType_Type.__name__ = "AtmIlmiLinkUniType"
...
_TAtmIlmiLinkNeighborDeviceType_Type.__name__ = "AtmIlmiLinkDeviceType"
...
_TAtmIlmiLinkNeighborVersion_Type.__name__ = "AtmIlmiLinkVersion"
...
tAtmMIBV4v0Compliance.setObjects(
      *(("TIMETRA-ATM-MIB", "tmnxAtmIntfConfV4v0Group"),
        ("TIMETRA-ATM-MIB", "tmnxAtmIntfStatsV4v0Group"),
        ("TIMETRA-ATM-MIB", "tmnxAtmIfcInfoGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVclInfoGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVclStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmAal5VccStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmCellVclStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVplInfoGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVplStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVtlInfoGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVtlStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmIfcStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmSysConfV4v0Group"),
        ("TIMETRA-ATM-MIB", "tmnxAtmIlmiLinkGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmIlmiStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmTCSublayerGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmNotificationsR4r0Group"))
)
if mibBuilder.loadTexts:
...
tAtmMIBV9v0Compliance.setObjects(
      *(("TIMETRA-ATM-MIB", "tmnxAtmIntfConfV4v0Group"),
        ("TIMETRA-ATM-MIB", "tmnxAtmIntfStatsV4v0Group"),
        ("TIMETRA-ATM-MIB", "tmnxAtmIfcInfoGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVclInfoGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVclInfoGroupV9v0"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVclStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmAal5VccStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmCellVclStatisticsGroup"),
        ("TIMETRA-ATM-MIB", "tmnxAtmVplInfoGroup"),
