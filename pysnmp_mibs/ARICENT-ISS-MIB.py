...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-ISS-MIB
...
issDownloadStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    issLoginAuthentication.setStatus("deprecated")
...
class _IssHardwareSerialNumber_Type(DisplayString):
    """Custom type issHardwareSerialNumber based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 15),
    )
...
_IssHardwareSerialNumber_Type.__name__ = "DisplayString"
_IssHardwareSerialNumber_Object = MibScalar
issHardwareSerialNumber = _IssHardwareSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 1, 120),
    _IssHardwareSerialNumber_Type()
)
issHardwareSerialNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    issHardwareSerialNumber.setStatus("current")
...
issSwitchFanIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
issZtp = _IssZtp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 81, 18)
)


class _IssZtpConfigStatus_Type(Integer32):
    """Custom type issZtpConfigStatus based on Integer32"""
    defaultValue = 2
...
_IssZtpConfigStatus_Type.__name__ = "Integer32"
_IssZtpConfigStatus_Object = MibScalar
issZtpConfigStatus = _IssZtpConfigStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 18, 1),
    _IssZtpConfigStatus_Type()
)
issZtpConfigStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issZtpConfigStatus.setStatus("current")


class _IssZtpCurrentStatus_Type(Integer32):
    """Custom type issZtpCurrentStatus based on Integer32"""
    defaultValue = 1
...
_IssZtpCurrentStatus_Type.__name__ = "Integer32"
_IssZtpCurrentStatus_Object = MibScalar
issZtpCurrentStatus = _IssZtpCurrentStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 18, 2),
    _IssZtpCurrentStatus_Type()
)
issZtpCurrentStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    issZtpCurrentStatus.setStatus("current")
_IssRunConfig_ObjectIdentity = ObjectIdentity
issRunConfig = _IssRunConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19)
)


class _IssRunConfigFileTransferMode_Type(Integer32):
    """Custom type issRunConfigFileTransferMode based on Integer32"""
    defaultValue = 1
...
_IssRunConfigFileTransferMode_Type.__name__ = "Integer32"
_IssRunConfigFileTransferMode_Object = MibScalar
issRunConfigFileTransferMode = _IssRunConfigFileTransferMode_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 1),
    _IssRunConfigFileTransferMode_Type()
)
issRunConfigFileTransferMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issRunConfigFileTransferMode.setStatus("current")
_IssRunConfigIpAddrType_Type = InetAddressType
_IssRunConfigIpAddrType_Object = MibScalar
issRunConfigIpAddrType = _IssRunConfigIpAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 2),
    _IssRunConfigIpAddrType_Type()
)
issRunConfigIpAddrType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issRunConfigIpAddrType.setStatus("current")
_IssRunConfigIpAddr_Type = InetAddress
_IssRunConfigIpAddr_Object = MibScalar
issRunConfigIpAddr = _IssRunConfigIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 3),
    _IssRunConfigIpAddr_Type()
)
issRunConfigIpAddr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issRunConfigIpAddr.setStatus("current")


class _IssRunConfigUserName_Type(DisplayString):
    """Custom type issRunConfigUserName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_IssRunConfigUserName_Type.__name__ = "DisplayString"
_IssRunConfigUserName_Object = MibScalar
issRunConfigUserName = _IssRunConfigUserName_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 4),
    _IssRunConfigUserName_Type()
)
issRunConfigUserName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issRunConfigUserName.setStatus("current")


class _IssRunConfigPassword_Type(DisplayString):
    """Custom type issRunConfigPassword based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 20),
    )
...
_IssRunConfigPassword_Type.__name__ = "DisplayString"
_IssRunConfigPassword_Object = MibScalar
issRunConfigPassword = _IssRunConfigPassword_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 5),
    _IssRunConfigPassword_Type()
)
issRunConfigPassword.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issRunConfigPassword.setStatus("current")


class _IssRunConfigFileName_Type(DisplayString):
    """Custom type issRunConfigFileName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 128),
    )
...
_IssRunConfigFileName_Type.__name__ = "DisplayString"
_IssRunConfigFileName_Object = MibScalar
issRunConfigFileName = _IssRunConfigFileName_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 6),
    _IssRunConfigFileName_Type()
)
issRunConfigFileName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issRunConfigFileName.setStatus("current")


class _IssApplyConfigToRunningConfig_Type(TruthValue):
    """Custom type issApplyConfigToRunningConfig based on TruthValue"""
    defaultValue = 2


_IssApplyConfigToRunningConfig_Type.__name__ = "TruthValue"
_IssApplyConfigToRunningConfig_Object = MibScalar
issApplyConfigToRunningConfig = _IssApplyConfigToRunningConfig_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 7),
    _IssApplyConfigToRunningConfig_Type()
)
issApplyConfigToRunningConfig.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issApplyConfigToRunningConfig.setStatus("current")


class _IssConfigToRunningConfigStatus_Type(Integer32):
    """Custom type issConfigToRunningConfigStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_IssConfigToRunningConfigStatus_Type.__name__ = "Integer32"
_IssConfigToRunningConfigStatus_Object = MibScalar
issConfigToRunningConfigStatus = _IssConfigToRunningConfigStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 8),
    _IssConfigToRunningConfigStatus_Type()
)
issConfigToRunningConfigStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    issConfigToRunningConfigStatus.setStatus("current")


class _IssInitiateRunningConfig_Type(TruthValue):
    """Custom type issInitiateRunningConfig based on TruthValue"""
    defaultValue = 2


_IssInitiateRunningConfig_Type.__name__ = "TruthValue"
_IssInitiateRunningConfig_Object = MibScalar
issInitiateRunningConfig = _IssInitiateRunningConfig_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 9),
    _IssInitiateRunningConfig_Type()
)
issInitiateRunningConfig.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issInitiateRunningConfig.setStatus("current")


class _IssCopyStartupConfig_Type(TruthValue):
    """Custom type issCopyStartupConfig based on TruthValue"""
    defaultValue = 2


_IssCopyStartupConfig_Type.__name__ = "TruthValue"
_IssCopyStartupConfig_Object = MibScalar
issCopyStartupConfig = _IssCopyStartupConfig_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 10),
    _IssCopyStartupConfig_Type()
)
issCopyStartupConfig.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issCopyStartupConfig.setStatus("current")


class _IssStartupToRunningConfig_Type(TruthValue):
    """Custom type issStartupToRunningConfig based on TruthValue"""
    defaultValue = 2


_IssStartupToRunningConfig_Type.__name__ = "TruthValue"
_IssStartupToRunningConfig_Object = MibScalar
issStartupToRunningConfig = _IssStartupToRunningConfig_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 19, 11),
    _IssStartupToRunningConfig_Type()
)
issStartupToRunningConfig.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    issStartupToRunningConfig.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"PortList": PortList,
       ...
       "issHardwareSerialNumber": issHardwareSerialNumber,
       ...
       "issZtp": issZtp,
       "issZtpConfigStatus": issZtpConfigStatus,
       "issZtpCurrentStatus": issZtpCurrentStatus,
       "issRunConfig": issRunConfig,
       "issRunConfigFileTransferMode": issRunConfigFileTransferMode,
       "issRunConfigIpAddrType": issRunConfigIpAddrType,
       "issRunConfigIpAddr": issRunConfigIpAddr,
       "issRunConfigUserName": issRunConfigUserName,
       "issRunConfigPassword": issRunConfigPassword,
       "issRunConfigFileName": issRunConfigFileName,
       "issApplyConfigToRunningConfig": issApplyConfigToRunningConfig,
       "issConfigToRunningConfigStatus": issConfigToRunningConfigStatus,
       "issInitiateRunningConfig": issInitiateRunningConfig,
       "issCopyStartupConfig": issCopyStartupConfig,
       "issStartupToRunningConfig": issStartupToRunningConfig}
)
