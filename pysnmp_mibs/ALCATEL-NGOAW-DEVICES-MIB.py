...
# Notes
# -----
# ASN.1 source file://mibs/alcatel/ALCATEL-NGOAW-DEVICES-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:08:01 2025
...
deviceNGOAWAp1251RWB = _DeviceNGOAWAp1251RWB_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 18)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1251RWB.setStatus("current")
_DeviceNGOAWAp1301_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1301 = _DeviceNGOAWAp1301_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 19)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1301.setStatus("current")
_DeviceNGOAWAp1311_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1311 = _DeviceNGOAWAp1311_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 20)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1311.setStatus("current")
_DeviceNGOAWAp1341E_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1341E = _DeviceNGOAWAp1341E_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 21)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1341E.setStatus("current")
_DeviceNGOAWAp1351_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1351 = _DeviceNGOAWAp1351_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 22)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1351.setStatus("current")
_DeviceNGOAWAp1331_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1331 = _DeviceNGOAWAp1331_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 23)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1331.setStatus("current")
_DeviceNGOAWAp1301H_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1301H = _DeviceNGOAWAp1301H_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 24)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1301H.setStatus("current")
_DeviceNGOAWAp1261RWB_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1261RWB = _DeviceNGOAWAp1261RWB_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 25)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1261RWB.setStatus("current")
_DeviceNGOAWAp1261_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1261 = _DeviceNGOAWAp1261_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 26)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1261.setStatus("current")
_DeviceNGOAWAp1451_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1451 = _DeviceNGOAWAp1451_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 27)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1451.setStatus("current")
_DeviceNGOAWAp1431_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1431 = _DeviceNGOAWAp1431_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 28)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1431.setStatus("current")
_DeviceNGOAWAp1362T_ObjectIdentity = ObjectIdentity
deviceNGOAWAp1362T = _DeviceNGOAWAp1362T_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 802, 1, 1, 2, 1, 2, 29)
)
if mibBuilder.loadTexts:
    deviceNGOAWAp1362T.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"alcatelNGOAWDevicesMIB": alcatelNGOAWDevicesMIB,
       ...
       "deviceNGOAWAp1251RWB": deviceNGOAWAp1251RWB,
       "deviceNGOAWAp1301": deviceNGOAWAp1301,
       "deviceNGOAWAp1311": deviceNGOAWAp1311,
       "deviceNGOAWAp1341E": deviceNGOAWAp1341E,
       "deviceNGOAWAp1351": deviceNGOAWAp1351,
       "deviceNGOAWAp1331": deviceNGOAWAp1331,
       "deviceNGOAWAp1301H": deviceNGOAWAp1301H,
       "deviceNGOAWAp1261RWB": deviceNGOAWAp1261RWB,
       "deviceNGOAWAp1261": deviceNGOAWAp1261,
       "deviceNGOAWAp1451": deviceNGOAWAp1451,
       "deviceNGOAWAp1431": deviceNGOAWAp1431,
       "deviceNGOAWAp1362T": deviceNGOAWAp1362T}
)
