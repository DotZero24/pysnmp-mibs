...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-PING-MIB
...
_CiscoPingPacketSize_Type.__name__ = "Integer32"
...
_CiscoPingTrapOnCompletion_Type.__name__ = "TruthValue"
...
ciscoPingMIBCompliance.setObjects(
    ("CISCO-PING-MIB", "ciscoPingMIBGroup")
)
if mibBuilder.loadTexts:
...
ciscoPingMIBComplianceVpn.setObjects(
    ("CISCO-PING-MIB", "ciscoPingMIBGroupVpn")
)
if mibBuilder.loadTexts:
