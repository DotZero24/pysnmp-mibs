# SNMP MIB module (SUPERMICRO-DHCPv6-CLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-DHCPv6-CLIENT-MIB
...
fsDhcp6ClntListenPort = _FsDhcp6ClntListenPort_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 43, 1, 4),
...
fsDhcp6ClntTransmitPort = _FsDhcp6ClntTransmitPort_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 43, 1, 5),
...
fsDhcp6ClntOptionTable = _FsDhcp6ClntOptionTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 43, 2, 2)
)
if mibBuilder.loadTexts:
...
fsDhcp6ClntOptionEntry = _FsDhcp6ClntOptionEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 43, 2, 2, 1)
)
fsDhcp6ClntOptionEntry.setIndexNames(
    (0, "SUPERMICRO-DHCPv6-CLIENT-MIB", "fsDhcp6ClntIfIndex"),
    (0, "SUPERMICRO-DHCPv6-CLIENT-MIB", "fsDhcp6ClntOptionType"),
)
if mibBuilder.loadTexts:
...
fsDhcp6ClntInvalidPacketTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 43, 0, 1)
)
fsDhcp6ClntInvalidPacketTrap.setObjects(
    ("SUPERMICRO-DHCPv6-CLIENT-MIB", "fsDhcp6ClntIfInvalidPktIn")
)
if mibBuilder.loadTexts:
...
fsDhcp6ClntHmacAuthenticationFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 43, 0, 2)
)
fsDhcp6ClntHmacAuthenticationFailTrap.setObjects(
    ("SUPERMICRO-DHCPv6-CLIENT-MIB", "fsDhcp6ClntIfHmacFailCount")
)
if mibBuilder.loadTexts:
