...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DOT11-CONTEXT-SERVICES-MANAGER-MIB
...
ciscoDot11CsMgrMIBCompliance.setObjects(
    ("CISCO-DOT11-CONTEXT-SERVICES-MANAGER-MIB", "ciscoDot11CsMgrClientGroup")
)
if mibBuilder.loadTexts:
