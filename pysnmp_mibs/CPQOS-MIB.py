...
mibBuilder.exportSymbols("CPQOS-MIB", cpqOsLogicalDisk=cpqOsLogicalDisk, cpqOsCacheCopyReadHitsDegraded=cpqOsCacheCopyReadHitsDegraded, cpqOsMibRev=cpqOsMibRev, cpqOsTcpCondition=cpqOsTcpCondition, cpqOsPhysicalDiskReadBytesPersec=cpqOsPhysicalDiskReadBytesPersec, cpqOsServerLogonErrors=cpqOsServerLogonErrors, cpqOsServerTotalNetworkUtilizationBytesPerSec=cpqOsServerTotalNetworkUtilizationBytesPerSec, cpqOsProcessTable=cpqOsProcessTable, cpqOsMemPagesInputPerSec=cpqOsMemPagesInputPerSec, cpqOsPhysicalDiskEntry=cpqOsPhysicalDiskEntry, cpqOsPhysicalDisk=cpqOsPhysicalDisk, cpqOsCacheStatus=cpqOsCacheStatus, cpqOsCacheEntry=cpqOsCacheEntry, cpqOsNetworkInterfaceCondition=cpqOsNetworkInterfaceCondition, cpqOsMemory=cpqOsMemory, cpqOsCpuInterruptsPerSec=cpqOsCpuInterruptsPerSec, cpqOsTcpActiveConnections=cpqOsTcpActiveConnections, cpqOsSysRegistryInUsePercent=cpqOsSysRegistryInUsePercent, cpqOsCommonPollFreq=cpqOsCommonPollFreq, cpqOsNetworkOutputQueueLength=cpqOsNetworkOutputQueueLength, cpqOsPageFileUsageDegraded=cpqOsPageFileUsageDegraded, cpqOsNetworkInterfaceTable=cpqOsNetworkInterfaceTable, cpqOsNetworkInterfaceStatus=cpqOsNetworkInterfaceStatus, cpqOsCriLogicalDiskBusyTimePercent=cpqOsCriLogicalDiskBusyTimePercent, cpqOsTcpEstablishedConections=cpqOsTcpEstablishedConections, cpqOsCacheInstance=cpqOsCacheInstance, cpqOsLogicalDiskStatus=cpqOsLogicalDiskStatus, cpqOsProcessorTable=cpqOsProcessorTable, cpqOsNetworkCurrentBandWidth=cpqOsNetworkCurrentBandWidth, cpqOsNetworkPacketsSentPersecx1000=cpqOsNetworkPacketsSentPersecx1000, cpqOsMemPageWritesPerSecx1000=cpqOsMemPageWritesPerSecx1000, cpqOsWarCpuTimePercent=cpqOsWarCpuTimePercent, cpqOsMemCacheFaultsPerSec=cpqOsMemCacheFaultsPerSec, cpqOsPhysicalDiskCondition=cpqOsPhysicalDiskCondition, cpqOsPhysicalDiskBytesPersec=cpqOsPhysicalDiskBytesPersec, cpqOsMemAvailableKBytes=cpqOsMemAvailableKBytes, cpqOsPagingFileInstance=cpqOsPagingFileInstance, cpqOsCommon=cpqOsCommon, cpqOsTcpInstance=cpqOsTcpInstance, cpqOsPagingFile=cpqOsPagingFile, cpqOsPhysicalDiskTransfersPersecx1000=cpqOsPhysicalDiskTransfersPersecx1000, cpqOsTcpRetransmittedSegmentsPerSec=cpqOsTcpRetransmittedSegmentsPerSec, cpqOsNetworkPktReceiveErrors=cpqOsNetworkPktReceiveErrors, cpqOsTcpSegmentsPerSec=cpqOsTcpSegmentsPerSec, cpqOsProcessPageFileBytes=cpqOsProcessPageFileBytes, cpqOsPhysicalDiskIndex=cpqOsPhysicalDiskIndex, cpqOsPhysicalDiskTable=cpqOsPhysicalDiskTable, cpqOsPhysicalDiskAvgDisksecPerReadx10000=cpqOsPhysicalDiskAvgDisksecPerReadx10000, cpqOsProcessor=cpqOsProcessor, cpqOsPageFileUsagePercent=cpqOsPageFileUsagePercent, cpqOsPageFileUsageFailed=cpqOsPageFileUsageFailed, cpqWinOsMgmt=cpqWinOsMgmt, cpqOsTcpConnectionFailures=cpqOsTcpConnectionFailures, cpqOsPhysicalDiskReadsPersecx1000=cpqOsPhysicalDiskReadsPersecx1000, cpqOsCpuTimeFailed=cpqOsCpuTimeFailed, cpqOsMibRevMinor=cpqOsMibRevMinor, cpqOsNetworkBytesSentPersec=cpqOsNetworkBytesSentPersec, cpqOsMemPoolNonpagedBytes=cpqOsMemPoolNonpagedBytes, cpqOsWarLogicalDiskBusyTimePercent=cpqOsWarLogicalDiskBusyTimePercent, cpqOsNetworkPktOutboundErrors=cpqOsNetworkPktOutboundErrors, cpqOsMibRevMajor=cpqOsMibRevMajor, cpqOsCriCacheCopyReadHitsPercent=cpqOsCriCacheCopyReadHitsPercent, cpqOsSysCpuQueueLength=cpqOsSysCpuQueueLength, cpqOsCpuPercentInterruptTime=cpqOsCpuPercentInterruptTime, cpqOsTcpEntry=cpqOsTcpEntry, cpqOsLogicalDiskFreeSpaceMBytes=cpqOsLogicalDiskFreeSpaceMBytes, cpqOsPagingFileIndex=cpqOsPagingFileIndex, cpqOsPhysicalDiskWriteBytesPersec=cpqOsPhysicalDiskWriteBytesPersec, cpqOsProcessCpuTimePercent=cpqOsProcessCpuTimePercent, cpqOsServer=cpqOsServer, cpqOsPhysicalDiskBusyTimePercent=cpqOsPhysicalDiskBusyTimePercent, cpqOsProcessorStatus=cpqOsProcessorStatus, cpqOsServerAccessGrantedErrors=cpqOsServerAccessGrantedErrors, cpqOsProcessInstance=cpqOsProcessInstance, cpqOsPagingFileEntry=cpqOsPagingFileEntry, cpqOsNetworkInterface=cpqOsNetworkInterface, cpqOsLogicalDiskCondition=cpqOsLogicalDiskCondition, cpqOsServerContextBlocksQueuePerSec=cpqOsServerContextBlocksQueuePerSec, cpqOsNetworkInterfaceIndex=cpqOsNetworkInterfaceIndex, cpqOsProcess=cpqOsProcess, cpqOsCacheCopyReadHitsPercent=cpqOsCacheCopyReadHitsPercent, cpqOsProcessStatus=cpqOsProcessStatus, cpqOsNetworkPacketsReceivedPersecx1000=cpqOsNetworkPacketsReceivedPersecx1000, cpqOsLogicalDiskIndex=cpqOsLogicalDiskIndex, cpqOsCpuPercentDPCTime=cpqOsCpuPercentDPCTime, cpqOsNetworkTotalBytesPerSec=cpqOsNetworkTotalBytesPerSec, cpqOsSystemUpTime=cpqOsSystemUpTime, cpqOsProcessThreadCount=cpqOsProcessThreadCount, cpqOsSystemStatus=cpqOsSystemStatus, cpqOsCpuPrivilegedTimePercent=cpqOsCpuPrivilegedTimePercent, cpqOsLogicalDiskFreeSpacePercent=cpqOsLogicalDiskFreeSpacePercent, cpqOsLogicalDiskBusyTimePercent=cpqOsLogicalDiskBusyTimePercent, cpqOsLogicalDiskTable=cpqOsLogicalDiskTable, cpqOsMemPageFaultsPerSec=cpqOsMemPageFaultsPerSec, cpqOsWarCacheCopyReadHitsPercent=cpqOsWarCacheCopyReadHitsPercent, cpqOsNetworkPacketsPerSec=cpqOsNetworkPacketsPerSec, cpqOsProcessPageFaultsPerSec=cpqOsProcessPageFaultsPerSec, cpqOsProcessPrivilegedTimePercent=cpqOsProcessPrivilegedTimePercent, cpqOsPhysicalDiskAvgDisksecPerWritex10000=cpqOsPhysicalDiskAvgDisksecPerWritex10000, cpqOsPagingFileOSManaged=cpqOsPagingFileOSManaged, cpqOsCriCpuTimePercent=cpqOsCriCpuTimePercent, cpqOsServerAccessPermissionErrors=cpqOsServerAccessPermissionErrors, cpqOsMibCondition=cpqOsMibCondition, cpqOsMemPagesOutputPerSec=cpqOsMemPagesOutputPerSec, cpqOsMemoryStatus=cpqOsMemoryStatus, cpqOsProcessEntry=cpqOsProcessEntry, cpqOsInterface=cpqOsInterface, cpqOsComponent=cpqOsComponent, cpqOsLogicalDiskInstance=cpqOsLogicalDiskInstance, cpqOsLogicalDiskQueueLength=cpqOsLogicalDiskQueueLength, cpqOsServerSessionsErroredOut=cpqOsServerSessionsErroredOut, cpqOsTcpIndex=cpqOsTcpIndex, cpqOsCpuTimePercent=cpqOsCpuTimePercent, cpqOsCacheCondition=cpqOsCacheCondition, cpqOsTcp=cpqOsTcp, cpqOsSysContextSwitchesPersec=cpqOsSysContextSwitchesPersec, cpqOsTcpStatus=cpqOsTcpStatus, cpqOsPagingFileCondition=cpqOsPagingFileCondition, cpqOsCpuInstance=cpqOsCpuInstance, cpqOsPhysicalDiskWritesPersecx1000=cpqOsPhysicalDiskWritesPersecx1000, cpqOsMemPageReadsPerSecx1000=cpqOsMemPageReadsPerSecx1000, cpqOsSystemThreads=cpqOsSystemThreads, cpqOsCpuCondition=cpqOsCpuCondition, cpqOsSystem=cpqOsSystem, cpqOsCpuIndex=cpqOsCpuIndex, cpqOsPhysicalDiskCurrentDiskQueueLength=cpqOsPhysicalDiskCurrentDiskQueueLength, cpqOsCacheTable=cpqOsCacheTable, cpqOsSysProcesses=cpqOsSysProcesses, cpqOsCacheCopyReadsPerSec=cpqOsCacheCopyReadsPerSec, cpqOsPagingFileTable=cpqOsPagingFileTable, cpqOsCpuUserTimePercent=cpqOsCpuUserTimePercent, cpqOsCpuTimeDegraded=cpqOsCpuTimeDegraded, cpqOsProcessPrivateBytes=cpqOsProcessPrivateBytes, cpqOsPagingFileStatus=cpqOsPagingFileStatus, cpqOsCacheIndex=cpqOsCacheIndex, cpqOsNetworkInterfaceEntry=cpqOsNetworkInterfaceEntry, cpqOsTcpTable=cpqOsTcpTable, cpqOsMemCacheBytes=cpqOsMemCacheBytes, cpqOsNetworkBytesReceivedPersec=cpqOsNetworkBytesReceivedPersec, cpqOsProcessCondition=cpqOsProcessCondition, cpqOsProcessWorkingSet=cpqOsProcessWorkingSet, cpqOsLogicalDiskEntry=cpqOsLogicalDiskEntry, cpqOsProcessorEntry=cpqOsProcessorEntry, cpqOsMemPagesPerSec=cpqOsMemPagesPerSec, cpqOsLogicalDiskBusyTimeDegraded=cpqOsLogicalDiskBusyTimeDegraded, cpqOsServerStatus=cpqOsServerStatus, cpqOsServerSessions=cpqOsServerSessions, cpqOsCacheCopyReadHitsFailed=cpqOsCacheCopyReadHitsFailed, cpqOsPhysicalDiskInstance=cpqOsPhysicalDiskInstance, cpqOsCriPageFileUsagePercent=cpqOsCriPageFileUsagePercent, cpqOsProcessIndex=cpqOsProcessIndex, cpqOsWarPageFileUsagePercent=cpqOsWarPageFileUsagePercent, cpqOsCache=cpqOsCache, cpqOsPhysicalDiskStatus=cpqOsPhysicalDiskStatus, cpqOsLogicalDiskBusyTimeFailed=cpqOsLogicalDiskBusyTimeFailed, cpqOsPhysicalDiskQueueLength=cpqOsPhysicalDiskQueueLength, cpqOsNetworkInterfaceInstance=cpqOsNetworkInterfaceInstance)
