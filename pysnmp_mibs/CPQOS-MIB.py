...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hp/CPQOS-MIB
...
cpqOsPagingFileOSManaged = MibScalar((1, 3, 6, 1, 4, 1, 232, 19, 2, 6, 3), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cpqOsPagingFileOSManaged.setStatus('mandatory')
...
mibBuilder.exportSymbols("CPQOS-MIB", cpqOsPagingFileCondition=cpqOsPagingFileCondition, cpqOsServerSessionsErroredOut=cpqOsServerSessionsErroredOut, cpqOsCpuPercentDPCTime=cpqOsCpuPercentDPCTime, cpqOsServerAccessGrantedErrors=cpqOsServerAccessGrantedErrors, cpqOsProcessStatus=cpqOsProcessStatus, cpqOsLogicalDiskQueueLength=cpqOsLogicalDiskQueueLength, cpqOsNetworkCurrentBandWidth=cpqOsNetworkCurrentBandWidth, cpqOsPhysicalDiskBusyTimePercent=cpqOsPhysicalDiskBusyTimePercent, cpqOsWarLogicalDiskBusyTimePercent=cpqOsWarLogicalDiskBusyTimePercent, cpqOsMemory=cpqOsMemory, cpqOsServerSessions=cpqOsServerSessions, cpqOsTcpRetransmittedSegmentsPerSec=cpqOsTcpRetransmittedSegmentsPerSec, cpqOsLogicalDiskBusyTimeDegraded=cpqOsLogicalDiskBusyTimeDegraded, cpqOsPhysicalDiskEntry=cpqOsPhysicalDiskEntry, cpqOsProcessThreadCount=cpqOsProcessThreadCount, cpqOsTcpInstance=cpqOsTcpInstance, cpqOsProcessPrivateBytes=cpqOsProcessPrivateBytes, cpqOsPageFileUsageDegraded=cpqOsPageFileUsageDegraded, cpqOsProcessor=cpqOsProcessor, cpqOsCacheEntry=cpqOsCacheEntry, cpqOsSystem=cpqOsSystem, cpqOsSystemUpTime=cpqOsSystemUpTime, cpqOsCacheCopyReadHitsFailed=cpqOsCacheCopyReadHitsFailed, cpqOsPagingFileEntry=cpqOsPagingFileEntry, cpqWinOsMgmt=cpqWinOsMgmt, cpqOsServer=cpqOsServer, cpqOsServerContextBlocksQueuePerSec=cpqOsServerContextBlocksQueuePerSec, cpqOsMibRev=cpqOsMibRev, cpqOsNetworkOutputQueueLength=cpqOsNetworkOutputQueueLength, cpqOsLogicalDiskIndex=cpqOsLogicalDiskIndex, cpqOsNetworkInterfaceEntry=cpqOsNetworkInterfaceEntry, cpqOsSysRegistryInUsePercent=cpqOsSysRegistryInUsePercent, cpqOsLogicalDiskBusyTimePercent=cpqOsLogicalDiskBusyTimePercent, cpqOsLogicalDiskTable=cpqOsLogicalDiskTable, cpqOsComponent=cpqOsComponent, cpqOsCpuPrivilegedTimePercent=cpqOsCpuPrivilegedTimePercent, cpqOsNetworkInterface=cpqOsNetworkInterface, cpqOsCriCacheCopyReadHitsPercent=cpqOsCriCacheCopyReadHitsPercent, cpqOsProcessIndex=cpqOsProcessIndex, cpqOsPhysicalDisk=cpqOsPhysicalDisk, cpqOsTcpTable=cpqOsTcpTable, cpqOsMemPageFaultsPerSec=cpqOsMemPageFaultsPerSec, cpqOsMibRevMinor=cpqOsMibRevMinor, cpqOsMemPageWritesPerSecx1000=cpqOsMemPageWritesPerSecx1000, cpqOsLogicalDiskFreeSpacePercent=cpqOsLogicalDiskFreeSpacePercent, cpqOsServerStatus=cpqOsServerStatus, cpqOsProcessPrivilegedTimePercent=cpqOsProcessPrivilegedTimePercent, cpqOsPageFileUsageFailed=cpqOsPageFileUsageFailed, cpqOsServerAccessPermissionErrors=cpqOsServerAccessPermissionErrors, cpqOsMemPoolNonpagedBytes=cpqOsMemPoolNonpagedBytes, cpqOsTcpActiveConnections=cpqOsTcpActiveConnections, cpqOsCriCpuTimePercent=cpqOsCriCpuTimePercent, cpqOsTcpEntry=cpqOsTcpEntry, cpqOsProcessInstance=cpqOsProcessInstance, cpqOsPhysicalDiskBytesPersec=cpqOsPhysicalDiskBytesPersec, cpqOsProcessPageFaultsPerSec=cpqOsProcessPageFaultsPerSec, cpqOsCacheInstance=cpqOsCacheInstance, cpqOsWarCpuTimePercent=cpqOsWarCpuTimePercent, cpqOsCpuInterruptsPerSec=cpqOsCpuInterruptsPerSec, cpqOsProcessPageFileBytes=cpqOsProcessPageFileBytes, cpqOsSystemStatus=cpqOsSystemStatus, cpqOsSystemThreads=cpqOsSystemThreads, cpqOsCacheCopyReadsPerSec=cpqOsCacheCopyReadsPerSec, cpqOsCriLogicalDiskBusyTimePercent=cpqOsCriLogicalDiskBusyTimePercent, cpqOsCpuTimeDegraded=cpqOsCpuTimeDegraded, cpqOsLogicalDisk=cpqOsLogicalDisk, cpqOsProcess=cpqOsProcess, cpqOsPhysicalDiskCurrentDiskQueueLength=cpqOsPhysicalDiskCurrentDiskQueueLength, cpqOsProcessorTable=cpqOsProcessorTable, cpqOsCacheCondition=cpqOsCacheCondition, cpqOsNetworkInterfaceIndex=cpqOsNetworkInterfaceIndex, cpqOsNetworkPacketsSentPersecx1000=cpqOsNetworkPacketsSentPersecx1000, cpqOsPagingFileIndex=cpqOsPagingFileIndex, cpqOsTcpIndex=cpqOsTcpIndex, cpqOsPagingFileOSManaged=cpqOsPagingFileOSManaged, cpqOsLogicalDiskEntry=cpqOsLogicalDiskEntry, cpqOsServerLogonErrors=cpqOsServerLogonErrors, cpqOsCpuIndex=cpqOsCpuIndex, cpqOsPhysicalDiskTransfersPersecx1000=cpqOsPhysicalDiskTransfersPersecx1000, cpqOsCpuUserTimePercent=cpqOsCpuUserTimePercent, cpqOsMemPageReadsPerSecx1000=cpqOsMemPageReadsPerSecx1000, cpqOsTcpEstablishedConections=cpqOsTcpEstablishedConections, cpqOsLogicalDiskCondition=cpqOsLogicalDiskCondition, cpqOsNetworkInterfaceInstance=cpqOsNetworkInterfaceInstance, cpqOsWarCacheCopyReadHitsPercent=cpqOsWarCacheCopyReadHitsPercent, cpqOsMemCacheBytes=cpqOsMemCacheBytes, cpqOsPhysicalDiskAvgDisksecPerWritex10000=cpqOsPhysicalDiskAvgDisksecPerWritex10000, cpqOsNetworkPacketsReceivedPersecx1000=cpqOsNetworkPacketsReceivedPersecx1000, cpqOsCpuTimeFailed=cpqOsCpuTimeFailed, cpqOsNetworkBytesSentPersec=cpqOsNetworkBytesSentPersec, cpqOsCpuCondition=cpqOsCpuCondition, cpqOsPhysicalDiskReadBytesPersec=cpqOsPhysicalDiskReadBytesPersec, cpqOsCacheStatus=cpqOsCacheStatus, cpqOsPhysicalDiskCondition=cpqOsPhysicalDiskCondition, cpqOsPagingFileInstance=cpqOsPagingFileInstance, cpqOsTcpStatus=cpqOsTcpStatus, cpqOsLogicalDiskInstance=cpqOsLogicalDiskInstance, cpqOsCacheIndex=cpqOsCacheIndex, cpqOsCommon=cpqOsCommon, cpqOsNetworkInterfaceTable=cpqOsNetworkInterfaceTable, cpqOsProcessCondition=cpqOsProcessCondition, cpqOsCpuPercentInterruptTime=cpqOsCpuPercentInterruptTime, cpqOsPhysicalDiskTable=cpqOsPhysicalDiskTable, cpqOsPhysicalDiskQueueLength=cpqOsPhysicalDiskQueueLength, cpqOsCpuInstance=cpqOsCpuInstance, cpqOsMemAvailableKBytes=cpqOsMemAvailableKBytes, cpqOsNetworkInterfaceCondition=cpqOsNetworkInterfaceCondition, cpqOsTcpCondition=cpqOsTcpCondition, cpqOsCriPageFileUsagePercent=cpqOsCriPageFileUsagePercent, cpqOsProcessorStatus=cpqOsProcessorStatus, cpqOsMibCondition=cpqOsMibCondition, cpqOsPhysicalDiskIndex=cpqOsPhysicalDiskIndex, cpqOsPhysicalDiskAvgDisksecPerReadx10000=cpqOsPhysicalDiskAvgDisksecPerReadx10000, cpqOsNetworkBytesReceivedPersec=cpqOsNetworkBytesReceivedPersec, cpqOsCommonPollFreq=cpqOsCommonPollFreq, cpqOsMemCacheFaultsPerSec=cpqOsMemCacheFaultsPerSec, cpqOsCacheCopyReadHitsDegraded=cpqOsCacheCopyReadHitsDegraded, cpqOsCacheCopyReadHitsPercent=cpqOsCacheCopyReadHitsPercent, cpqOsCache=cpqOsCache, cpqOsSysProcesses=cpqOsSysProcesses, cpqOsNetworkInterfaceStatus=cpqOsNetworkInterfaceStatus, cpqOsPagingFile=cpqOsPagingFile, cpqOsNetworkPktReceiveErrors=cpqOsNetworkPktReceiveErrors, cpqOsPageFileUsagePercent=cpqOsPageFileUsagePercent, cpqOsLogicalDiskFreeSpaceMBytes=cpqOsLogicalDiskFreeSpaceMBytes, cpqOsProcessWorkingSet=cpqOsProcessWorkingSet, cpqOsPhysicalDiskStatus=cpqOsPhysicalDiskStatus, cpqOsPagingFileTable=cpqOsPagingFileTable, cpqOsPhysicalDiskReadsPersecx1000=cpqOsPhysicalDiskReadsPersecx1000, cpqOsMemoryStatus=cpqOsMemoryStatus, cpqOsLogicalDiskStatus=cpqOsLogicalDiskStatus, cpqOsNetworkTotalBytesPerSec=cpqOsNetworkTotalBytesPerSec, cpqOsPagingFileStatus=cpqOsPagingFileStatus, cpqOsInterface=cpqOsInterface, cpqOsLogicalDiskBusyTimeFailed=cpqOsLogicalDiskBusyTimeFailed, cpqOsPhysicalDiskInstance=cpqOsPhysicalDiskInstance, cpqOsCacheTable=cpqOsCacheTable, cpqOsPhysicalDiskWritesPersecx1000=cpqOsPhysicalDiskWritesPersecx1000, cpqOsNetworkPacketsPerSec=cpqOsNetworkPacketsPerSec, cpqOsMemPagesInputPerSec=cpqOsMemPagesInputPerSec, cpqOsTcpConnectionFailures=cpqOsTcpConnectionFailures, cpqOsMibRevMajor=cpqOsMibRevMajor, cpqOsSysCpuQueueLength=cpqOsSysCpuQueueLength, cpqOsProcessorEntry=cpqOsProcessorEntry, cpqOsPhysicalDiskWriteBytesPersec=cpqOsPhysicalDiskWriteBytesPersec, cpqOsSysContextSwitchesPersec=cpqOsSysContextSwitchesPersec, cpqOsMemPagesPerSec=cpqOsMemPagesPerSec, cpqOsWarPageFileUsagePercent=cpqOsWarPageFileUsagePercent, cpqOsServerTotalNetworkUtilizationBytesPerSec=cpqOsServerTotalNetworkUtilizationBytesPerSec, cpqOsTcp=cpqOsTcp, cpqOsNetworkPktOutboundErrors=cpqOsNetworkPktOutboundErrors, cpqOsCpuTimePercent=cpqOsCpuTimePercent, cpqOsTcpSegmentsPerSec=cpqOsTcpSegmentsPerSec, cpqOsProcessEntry=cpqOsProcessEntry, cpqOsProcessTable=cpqOsProcessTable, cpqOsMemPagesOutputPerSec=cpqOsMemPagesOutputPerSec, cpqOsProcessCpuTimePercent=cpqOsProcessCpuTimePercent)
