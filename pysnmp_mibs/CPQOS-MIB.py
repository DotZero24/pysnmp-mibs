...
# Notes
# -----
# ASN.1 source file://mibs/hp/CPQOS-MIB
...
cpqOsPagingFileOSManaged = _CpqOsPagingFileOSManaged_Object(
    (1, 3, 6, 1, 4, 1, 232, 19, 2, 6, 3),
    _CpqOsPagingFileOSManaged_Type()
)
cpqOsPagingFileOSManaged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqOsPagingFileOSManaged.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"cpqOsCpuTimeDegraded": cpqOsCpuTimeDegraded,
       ...
       "cpqOsPagingFileOSManaged": cpqOsPagingFileOSManaged,
